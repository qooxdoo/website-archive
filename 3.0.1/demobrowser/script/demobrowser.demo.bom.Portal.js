...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.cd0a46d012cd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="groupBoxes",b="demobrowser.demo.bom.portal.box.Manager",c="boxData",d="qx.event.type.Event",e="boxes",f="demobrowser.demo.bom.portal.box.Box",g="_applyActiveBox",h="loaded",m="singleton";qx.Class.define(b,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__PH=[];this.__PI=[];this.__PJ={};}
,statics:{dataKeyRoot:c,dataKeyGroupBoxes:a,dataKeyBoxes:e},events:{"loaded":d},properties:{activeBox:{init:null,check:f,apply:g}},members:{__PH:null,__PI:null,__PJ:null,_applyActiveBox:function(o,n){if(n!=null){n.setActive(false);}
;o.setActive(true);}
,load:function(){this.__et(window[demobrowser.demo.bom.portal.box.Manager.dataKeyRoot]);qx.event.Registration.fireEvent(this,h);}
,__et:function(t){var s,w,u,v,x,t;var p=t[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var r=t[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in p){s=p[w];u=s.boxes;w=s.id;v={id:w,element:document.getElementById(w)};this.__PI.push(v);this.__PJ[w]=[];for(var k=0,l=u.length;k<l;k++ ){t=r[u[k]];var q=document.getElementById(t.id);var x=new demobrowser.demo.bom.portal.box.Box(t,q,null,w);this.__PH.push(x);this.__PJ[w].push(x);}
;}
;}
,getBoxes:function(){return this.__PH;}
,getGroupBoxes:function(){return this.__PI;}
,updateGroupBoxMembers:function(A,B,y){var z=qx.dom.Hierarchy.getElementIndex(y.getElement());qx.lang.Array.remove(this.__PJ[B],y);qx.lang.Array.insertAt(this.__PJ[A],y,z);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__PI.length,D;i<j;i++ ){D=this.__PJ[this.__PI[i].id];for(var k=0,l=D.length;k<l;k++ ){if(D[k].getId()===C){return this.__PI[i];}
;}
;}
;return null;}
...
(function(){var a="click",b="Boolean",c="1px solid #444444",d="height",f="position",g="zIndex",h="_applyActive",i="width",j="box_content",k=" It does contain no UI widget code at all.",l="<br/><br/>",m="relative",n="demobrowser.demo.bom.portal.box.Box",o="1px solid orange",p="This is a demo application showing the low-level capabilities.",q="div",r="String",s="border";qx.Class.define(n,{extend:qx.core.Object,construct:function(v,x,t,u){qx.core.Object.call(this);this.__PK=v;this.__co=v.id;if(x!=null){qx.bom.element.Style.set(x,i,v.width);qx.bom.element.Style.set(x,d,v.height);this.__PN(x,t);}
;this.setElement(x);this.setGroupBoxId(u);this.__PL=null;this.__PM=null;if(v.resizable){this.setResizable(true);var w={minWidth:parseInt(v.minWidth),minHeight:parseInt(v.minHeight),maxWidth:parseInt(v.maxWidth),maxHeight:parseInt(v.maxHeight),handles:v.resizeHandles};this.__PL=new demobrowser.demo.bom.portal.box.Resizable(this,w);}
;if(v.draggable){this.setDraggable(true);this.__PM=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__PO();}
,properties:{element:{init:null},groupBoxId:{init:null,check:r},active:{check:b,init:false,apply:h},resizable:{check:b,init:false},draggable:{check:b,init:false}},members:{__co:null,__PK:null,__PM:null,__PL:null,_applyActive:function(z,y){if(z){qx.bom.element.Style.set(this.getElement(),s,o);}
else {qx.bom.element.Style.set(this.getElement(),s,c);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__PK;}
,getDraggableComponent:function(){return this.__PM;}
,getResizableComponent:function(){return this.__PL;}
,__PN:function(C,A){if(A){for(var B in A){qx.bom.element.Style.set(B,A[B]);}
;}
;qx.bom.element.Style.set(C,f,m);qx.bom.element.Style.set(C,g,0);qx.bom.Element.addListener(C,a,this.__PP,this,true);}
,__PO:function(){var E=p+k;E=E+l+E+l+E;var D=qx.dom.Element.create(q,{"class":j});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__PP:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__PK=this.__PL=this.__PM=null;}
});}
)();
...
(function(){var a="south",b="mouseup",c="mousedown",d='px',f="width",g="visibility",h="_",i="height",j="mouseover",k="mouseout",l="px",m="east",n="visible",o="hidden",p="mousemove",q="div",r="orientation",s="demobrowser.demo.bom.portal.box.Resizable",t="southeast",u="Handle";qx.Class.define(s,{extend:qx.core.Object,construct:function(v,w){qx.core.Object.call(this);this.__PQ=v;this.__go=this.__PQ.getElement();this.__PR={};this.__PS=false;this.__PT={orientation:null,lastCoord:{left:null,top:null}};this.__PU={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__PU){if(w[name]){this.__PU[name]=w[name];}
;}
;this.__PN();}
,members:{__PT:null,__PQ:null,__go:null,__PR:null,__PU:null,__PS:false,getBox:function(){return this.__PQ;}
,__PN:function(){switch(this.__PU.handles){case 1:this.__PR.east=null;break;case 2:this.__PR.south=null;break;case 3:this.__PR.south=null;this.__PR.southeast=null;this.__PR.east=null;break;};for(var y in this.__PR){var x=this.__PR[y]=qx.dom.Element.create(q);qx.bom.element.Attribute.set(x,r,y);qx.dom.Element.insertEnd(x,this.__go);if(this.__go.id){x.id=this.__go.id+h+y;}
;this.__PV(y);this.__PW(y);}
;}
,__PV:function(z){qx.bom.element.Class.add(this.__PR[z],z+u);qx.bom.element.Style.set(this.__PR[z],g,this.__PU.autoHide?o:n);}
,__PW:function(B){var C=qx.event.Registration;var A=this.__PR[B];C.addListener(A,c,this.__Qa,this);C.addListener(document,b,this.__Qb,this);if(this.__PU.autoHide){C.addListener(this.__PQ.getElement(),j,this.__PX,this);C.addListener(this.__PQ.getElement(),k,this.__PY,this);}
;}
,__PX:function(e){for(var D in this.__PR){qx.bom.element.Style.set(this.__PR[D],g,n);}
;}
,__PY:function(e){if(!this.__PS){for(var E in this.__PR){qx.bom.element.Style.set(this.__PR[E],g,o);}
;}
;}
,__Qa:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,p,this.__Qc,this,true);this.__PS=true;var F=e.getTarget();this.__PT.orientation=qx.bom.element.Attribute.get(F,r);this.__PT.lastCoord.left=e.getDocumentLeft();this.__PT.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__go);}
;}
,__Qb:function(e){e.stopPropagation();if(this.__PS){qx.event.Registration.removeListener(document,p,this.__Qc,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__go);if(this.__PU.autoHide){for(var G in this.__PR){qx.bom.element.Style.set(this.__PR[G],g,o);}
;}
;this.__PS=false;qx.bom.Selection.clear(document.body);}
;}
,__Qc:function(e){e.stopPropagation();if(this.__PS){var H={left:null,top:null};switch(this.__PT.orientation){case a:H.top=e.getDocumentTop();break;case t:H.top=e.getDocumentTop();H.left=e.getDocumentLeft();break;case m:H.left=e.getDocumentLeft();break;};this.__Qd(H,this.__PT.lastCoord);this.__PT.lastCoord.left=e.getDocumentLeft();this.__PT.lastCoord.top=e.getDocumentTop();}
;}
,__Qd:function(K,L){var Q=qx.bom.element.Dimension;var N=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__PQ.getId());var P=Q.getContentSize(N.element);if(K.left){var M=K.left-L.left;if(M!==0){var J=Q.getContentWidth(this.__go)+M;var O=Q.getWidth(this.__go)+M;if((this.__PU.minWidth==null||J>this.__PU.minWidth)&&(this.__PU.maxWidth==null||J<=this.__PU.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__go,f,J+d);this.__PQ.getData().width=J;}
;}
;}
;}
;if(K.top){var M=K.top-L.top;if(M!==0){var I=Q.getContentHeight(this.__go)+M;if((this.__PU.minHeight==null||I>this.__PU.minHeight)&&(this.__PU.maxHeight==null||I<=this.__PU.maxHeight)){qx.bom.element.Style.set(this.__go,i,I+l);}
;}
;}
;}
},destruct:function(){if(this.__PU.autoHide){qx.event.Registration.removeListener(this.__PQ.getElement(),j,this.__PX,this);qx.event.Registration.removeListener(this.__PQ.getElement(),k,this.__PY,this);}
;this.__PQ=this.__PU=this.__go=this.__PR=null;this.__PT=null;}
});}
)();
...
(function(){var a="zIndex",b="auto",c="demobrowser.demo.bom.portal.box.Util";qx.Class.define(c,{statics:{__Qe:1000,bringToFront:function(e){var d=qx.bom.element.Style.get(e,a);d=d==b?0:d;qx.bom.element.Style.set(e,a,d+this.__Qe);}
,sendToBack:function(g){var f=qx.bom.element.Style.get(g,a);qx.bom.element.Style.set(g,a,f-this.__Qe);}
}});}
)();
...
(function(){var a="mousemove",b="engine.name",c="mouseup",d="mousedown",f="dragstart",g="mouseover",h="drag",i="dragend",j="div",k="move",l="dragHandle",m="demobrowser.demo.bom.portal.box.Draggable",n="cursor",o="html";qx.Class.define(m,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.__PQ=p;this.__go=p.getElement();this.__Qf=null;this.__Qg=null;this.__PN();}
,members:{__PQ:null,__go:null,__Qf:null,__Qg:null,getBox:function(){return this.__PQ;}
,getElement:function(){return this.__go;}
,__PN:function(){this.__Qh();this.__PW();}
,__Qh:function(){this.__Qf=qx.dom.Element.create(j);qx.bom.element.Class.add(this.__Qf,l);qx.dom.Element.insertBegin(this.__Qf,this.__go);}
,__PW:function(){qx.bom.Element.addListener(this.__Qf,d,this.__ln,this);qx.bom.Element.addListener(this.__Qf,g,function(e){qx.bom.element.Style.set(this,n,k);}
,this.__Qf);qx.bom.Element.addListener(this.__Qf,f,this.__MK,this);qx.bom.Element.addListener(this.__Qf,i,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__Qf,h,this.__Qk,this);}
,__ln:function(e){if(e.isLeftPressed()){this.__Qg={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__go),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__go)};qx.bom.Element.addListener(document.body,c,this.__Qj,this,true);this.__Qi();qx.event.Registration.fireEvent(this.__Qf,f,qx.event.type.Event);}
;}
,__Qi:qx.core.Environment.select(b,{"mshtml":function(){var r=this;var q=qx.lang.Function.bind(this.__Qj,r);document.getElementsByTagName(o)[0].onmouseleave=q;}
,"default":(function(){}
)}),__Qj:function(e){try{e.stopPropagation();}
catch(s){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,a,this.__Qk,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,c,this.__Qj,this,true);}
,__MK:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__PQ);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__PQ);qx.event.Registration.addListener(document.body,a,this.__Qk,this,true);}
,__Qk:function(e){e.stopPropagation();var t=e.getDocumentLeft()-this.__Qg.left;var top=e.getDocumentTop()-this.__Qg.top;qx.event.Timer.once(function(){this.checkGroupBox(t,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,t);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__PQ=this.__Qf=this.__go=this.__Qg=null;}
});}
)();
(function(){var a="width:",b="top",c="Boolean",d="px",f="border",g="left",h="demobrowser.demo.bom.portal.dragdrop.Manager",k="height:",l="paddingTop",m="opacity:0.5;margin:0;position:absolute;",n="end",o="left:",p="div",q="demobrowser.demo.bom.portal.box.Box",r="px;",s="paddingBottom",t="1px dashed red",u="ease-out",v="singleton",w="top:";qx.Class.define(h,{type:v,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Ql={top:null,height:null};this.__Qm={top:0,left:0};}
,properties:{activeBox:{check:q,init:null,nullable:true},sessionActive:{check:c,init:false}},members:{__Ql:null,__Qn:null,__Qo:false,__Qm:null,__Qp:null,__Qq:null,startSession:function(y){this.setSessionActive(true);this.setActiveBox(y);this.__Qn=y.getGroupBoxId();this.__Qr();if(this.__Qp==null){this.__Qp={};var x=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=x.length;i<j;i++ ){this.__Qp[x[i].element.id]={left:qx.bom.element.Location.getLeft(x[i].element),right:qx.bom.element.Location.getLeft(x[i].element)+qx.bom.element.Dimension.getWidth(x[i].element)};}
;}
;}
,__Qr:function(){if(!this.__Qq){this.__Qq=qx.dom.Element.create(p);}
;var B=this.getActiveBox().getElement();var z=qx.bom.element.Dimension.getContentSize(B);this.__Qs(B,this.__Qq);qx.bom.element.Class.add(this.__Qq,qx.bom.element.Class.get(B));var A=m+w+qx.bom.element.Location.getTop(B)+r+o+qx.bom.element.Location.getLeft(B)+r+a+z.width+r+k+z.height+d;qx.bom.element.Style.setCss(this.__Qq,A);qx.bom.element.Style.set(B,f,t);qx.dom.Node.getBodyElement(B).appendChild(this.__Qq);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__Qq);}
,__Qs:function(C,D){while(C.firstChild){D.appendChild(C.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var I=this.getActiveBox();var G=I.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(I.getGroupBoxId(),this.__Qn,I);I.setGroupBoxId(this.__Qn);var F={left:qx.bom.element.Location.getLeft(this.__Qq)+d,top:qx.bom.element.Location.getTop(this.__Qq)+d};var H={left:qx.bom.element.Location.getLeft(G)+d,top:qx.bom.element.Location.getTop(G)+d};var J={timing:u,duration:300,keep:100,keyFrames:{'0':F,'100':H}};var E=qx.bom.element.Animation.animate(this.__Qq,J);E.addListener(n,function(){this.__Qs(this.__Qq,G);qx.bom.element.Style.reset(G,f);this.__Qq.parentNode.removeChild(this.__Qq);if(I.isActive()){I._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(I);}
;}
,this);}
,onDragMove:function(top,M){if(this.__Qm.left!=M){qx.bom.element.Style.set(this.__Qq,g,M+d);}
;if(this.__Qm.top!=top){qx.bom.element.Style.set(this.__Qq,b,top+d);}
;var K=this.getActiveBox().getElement();if(this.__Ql.top==null){this.__Ql.top=qx.bom.element.Location.getTop(K);}
;if(this.__Ql.height==null){this.__Ql.height=qx.bom.element.Dimension.getHeight(K);}
;if(this.__Qo==false&&top>=this.__Ql.top&&top<=(this.__Ql.top+this.__Ql.height)){return;}
;var L;if(this.__Qo){L=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__Qn));while(L!=null){if(this.__Qt(true,top,K,L)){this.__Qo=false;return;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {L=K;}
;if(top-this.__Qm.top>0){L=qx.dom.Hierarchy.getNextElementSibling(L);while(L!=null){if(L){if(this.__Qt(true,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {var L=qx.dom.Hierarchy.getPreviousElementSibling(L);while(L!=null){if(L){if(this.__Qt(false,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getPreviousElementSibling(L);}
;}
;this.__Qm.left=M;this.__Qm.top=top;}
,__Qt:function(P,top,S,Q){var O=qx.bom.element.Location.getTop(Q);var T=parseInt(qx.bom.element.Style.get(Q,l));var N=parseInt(qx.bom.element.Style.get(Q,s));var U=qx.bom.element.Dimension.getContentHeight(Q)+N+T;var R;if(P){if(top>=(O+(U/3))){R=qx.dom.Hierarchy.getNextElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertAfter(S,Q);this.__Ql.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
else {if(top<=(O+U*2/3)){R=qx.dom.Hierarchy.getPreviousElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertBefore(S,Q);this.__Ql.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
;return false;}
,checkGroupBox:function(X,W){if(this.__Qp[this.__Qn].left<=X&&this.__Qp[this.__Qn].right>=X){return;}
;for(var V in this.__Qp){if(V!=this.__Qn){if(this.__Qp[V].left<=X+W&&this.__Qp[V].right>=X){this.__Qn=V;this.__Qo=true;return;}
;}
;}
;}
},destruct:function(){this.__Ql=this.__Qm=this.__Qn=null;this.__Qu=this.__Qq=this.__Qp=null;}
});}
)();
