...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.f7f1ebc3ca87.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="__ju",b="Window: ",c="interval",d=")",e="Done! (Registry: ",f="Label: ",g=" (Registry: ",h="demobrowser.demo.test.Destructor",j="Round: ";qx.Class.define(h,{extend:qx.application.Standalone,members:{__cN:null,__Rk:0,__ju:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cN=[];this.currentTest=this.testWindows;this.__ju=new qx.event.Timer(1000);this.__ju.addListener(c,this.runTest,this);this.__ju.start();}
,runTest:function(){this.__Rk++ ;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(j+this.__Rk+g+m+d);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cN;for(var i=0,l=k.length;i<l;i++ ){k[i].destroy();}
