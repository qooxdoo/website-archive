...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event.907e3ff4ca06.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="Shift-Meta-F1",c="keyinput: ",d="keydown",f=" 1: ",g="execute",h="Ctrl-A",i="inner",j="keyinput",k="scroll:",l="input",m="demobrowser.demo.event.Event",n="keydown: ",o=": ",p="logger",q="juhu",r=" (inner): ",s="mouseover",t="mouse out",u="mouseout",v="click",w="Events",x=" 2: ",y="prevent default ",z="mouse over",A="contextmenu",B="Resize:",C="scroll";qx.Class.define(m,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([w],document.getElementById(p),50);qx.event.Registration.addListener(window,a,this._onResize,this);var D=new qx.ui.core.Command(b);D.addListener(g,function(){this.debug(D.toString());}
,this);var E=new qx.ui.core.Command(h);E.addListener(g,function(){this.debug(E.toString());}
,this);this._juhu=document.getElementById(q);this._inner=document.getElementById(i);qx.event.Registration.addListener(this._juhu,A,this._preventDefault,this);qx.event.Registration.addListener(this._inner,v,this._stopPropagation,this);qx.event.Registration.addListener(this._juhu,v,this._onclick1,this);qx.event.Registration.addListener(this._juhu,v,this._onclick2,this);qx.event.Registration.addListener(this._juhu,d,this._onclick2,this);qx.event.Registration.addListener(this._juhu,s,this._onmouseover,this);qx.event.Registration.addListener(this._juhu,u,this._onmouseout,this);qx.event.Registration.addListener(document.getElementById(l),d,this._onKeydown,this);qx.event.Registration.addListener(document.getElementById(l),j,this._onKeyinput,this);qx.event.Registration.addListener(document.getElementById(C),C,this._scroll,this);}
,_onResize:function(e){this._log([B+e]);}
,_onKeydown:function(e){this._log([n+e.getKeyIdentifier()]);}
,_onKeyinput:function(e){this._log([c+e.getCharCode()]);}
,_onmouseover:function(e){this._log([z]);}
,_onmouseout:function(e){this._log([t]);}
,_scroll:function(e){this._log([k+e.getTarget()]);}
,_preventDefault:function(e){this._log([y+e.getType()+o+e]);e.preventDefault();}
,_stopPropagation:function(e){this._log([e.getType()+r+e]);e.stopPropagation();}
,_onclick1:function(e){this._log([e.getType()+f+e]);qx.event.Registration.removeListener(this._juhu,v,this._onclick1);}
,_onclick2:function(e){this._log([e.getType()+x+e]);}
