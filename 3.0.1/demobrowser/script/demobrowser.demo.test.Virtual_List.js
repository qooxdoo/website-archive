...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.6998603a431b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Julian",b="Moritz",c="Jannis",d="one",f="Kevin",g="Tim",h="Felix",j="Vincent",k="Erik",l="Additive Selection",m="/places/folder.png",n="changeValue",o="Nils",p="Nick",q="Leon",r="Jannick",s="Linus",t="Configurable",u="Marc",v="icon/16/places/folder.png",w="demobrowser.demo.test.Virtual_List",x="addaptive",y="value",z="Colin",A="Lennard",B="Quick selection is only available for the modes multi or additive",C="Jason",D="Tobias",E="Florian",F="16",G="Jonas",H="icon/",I="Maximilian",J="Jakob",K="Enable drag selection",L="Joel",M="David",N="multi",O="changeSelection",P="48",Q="Marlon",R="Tom",S="Lukas",T="Luca",U="Julius",V="Fabian",W="single",X="Drag selection is only available for the modes multi or additive",Y="Justin",bN="Single Selection",bO="Simon",bP="additive",bJ="Luis",bK="Johannes",bL="Nico",bM="Alexander",bT="Jan",bU="bold",bV="Dominic",ck="Noah",bQ="Robin",bR="Enable quick selection",bS="Daniel",bF="Paul",bY="Philipp",bI="Niclas",ca="Max",cb="One Selection",bH="Additive selection",bW="Jonathan",cj="Item No ",bX="Value: ",cc="Finn",cd="Ben",ce="on",cg="One as selection mode",ch="Elias",ci="Mika",bG="Multi Selection",cf="Marvin";qx.Class.define(w,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var cw=new qx.ui.basic.Label(t);cw.setFont(bU);this.getRoot().add(cw,{left:20,top:20});var cm=new demobrowser.demo.virtual.list.List();cm.setScrollbarX(ce);cm.set({height:280,width:150,selectionMode:N});var cu;for(var i=1;i<=2500;i++ ){cu=new demobrowser.demo.virtual.list.ListItem(cj+i,H+((i%4)?F:P)+m);if(i%4==0){cu.setHeight(56);}
;cm.add(cu);if(i==20){cm.setSelected(cu);}
;}
;cm.addListener(n,function(e){this.debug(bX+e.getData());}
);this.getRoot().add(cm,{left:20,top:40});var cp=new qx.ui.form.RadioButton(bN);var cs=new qx.ui.form.RadioButton(bG);var cn=new qx.ui.form.RadioButton(l);var cl=new qx.ui.form.RadioButton(cb);cp.setUserData(y,W);cs.setUserData(y,N);cn.setUserData(y,bP);cl.setUserData(y,d);cs.setValue(true);this.getRoot().add(cp,{left:180,top:40});this.getRoot().add(cs,{left:180,top:60});this.getRoot().add(cn,{left:180,top:80});this.getRoot().add(cl,{left:180,top:100});var co=new qx.ui.form.RadioGroup(cp,cs,cn,cl);var ct=new qx.ui.form.CheckBox(K);var cx=new qx.ui.form.CheckBox(bR).set({enabled:false});this.getRoot().add(ct,{left:180,top:220});this.getRoot().add(cx,{left:180,top:240});ct.addListener(n,function(e){if(e.getData()){var cA=cm.getSelectionMode();if(cA==W||cA==d){this.debug(X);}
;}
;cm.setDragSelection(e.getData());}
);cx.addListener(n,function(e){if(e.getData()){var cB=cm.getSelectionMode();if(cB==N||cB==bP){this.debug(B);}
;}
;cm.setQuickSelection(e.getData());}
);co.addListener(O,function(e){var cC=e.getData()[0].getUserData(y);cm.setSelectionMode(cC);if(cC==W||cC==d){ct.setEnabled(false);cx.setEnabled(true);}
else if(cC==N||cC==x){ct.setEnabled(true);cx.setEnabled(false);}
;}
);var cz=new qx.ui.basic.Label(cg);cz.setFont(bU);this.getRoot().add(cz,{left:330,top:20});var cv=new demobrowser.demo.virtual.list.List();cv.set({height:280,width:150,selectionMode:d});var cu;for(var i=1;i<=25;i++ ){cu=new demobrowser.demo.virtual.list.ListItem(cj+i,v);cv.add(cu);if(i==16){cv.setSelected(cu);}
;}
;this.getRoot().add(cv,{left:330,top:40});var cw=new qx.ui.basic.Label(bH);cw.setFont(bU);this.getRoot().add(cw,{left:520,top:20});var cy=new demobrowser.demo.virtual.list.List;var cq;cy.set({width:150,selectionMode:bP});var cr=[q,S,T,cc,g,h,G,bJ,I,a,ca,bF,bI,bT,cd,ch,r,bY,ck,R,b,bL,M,o,bO,V,k,Y,bM,J,E,p,s,ci,C,bS,A,cf,c,D,bV,Q,u,bK,bW,U,z,L,f,j,bQ];for(var i=0;i<cr.length;i++ ){cq=new demobrowser.demo.virtual.list.ListItem(cr[i]);cy.add(cq);if(i==10||i==12||i==16){cy.addToSelection(cq);}
;}
;this.getRoot().add(cy,{left:520,top:40});}
}});}
)();
...
(function(){var a="Boolean",b="one",c="selected",d="_applySpacing",f="qx.event.type.Data",g="Integer",h="_applyDragSelection",k="changeSelection",m="String",n="resize",o="demobrowser.demo.virtual.list.List",p="list",q="multi",r="row",s="_applyQuickSelection",t="single",u="_applyItemHeight",v="_applySelectionMode",w="additive",x="changeName",y="Number",z="addItem",A="removeItem",B="changeHeight",C=",";qx.Class.define(o,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__Ru=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__Ru);this.getPane().addListener(n,this._onResize,this);this.__rx=[];this.__cM=[];this.__uI=new qx.ui.virtual.selection.Row(this.getPane());this.__uI.addListener(k,this._onChangeSelection,this);this.__uI.attachMouseEvents();this.__uI.attachKeyEvents(this);this.__uI.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:f,removeItem:f,changeValue:f,changeSelection:f},properties:{appearance:{refine:true,init:p},focusable:{refine:true,init:true},spacing:{check:g,init:0,apply:d,themeable:true},enableInlineFind:{check:a,init:true},name:{check:m,nullable:true,event:x},itemHeight:{init:24,themeable:true,check:y,apply:u},selectionMode:{check:[t,q,w,b],init:t,apply:v},dragSelection:{check:a,init:false,apply:h},quickSelection:{check:a,init:false,apply:s}},members:{__rx:null,__cM:null,__uI:null,__Ru:null,syncWidget:function(){this.update();}
,update:function(){var D=this.getPane().getRowConfig();D.setItemCount(this.__rx.length);D.resetItemSizes();for(var i=0;i<this.__rx.length;i++ ){var E=this.__rx[i].getHeight();if(E!==null){D.setItemSize(i,E);}
;}
;}
,updateSelection:function(){var F=this.__Ru.getChildren();for(var i=0;i<F.length;i++ ){var G=F[i];var H=G.getUserData(r);if(this.__uI.isItemSelected(H)){G.addState(c);}
else {G.removeState(c);}
;}
;}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(k,this.__Ry(e.getData()));}
,getCellWidget:function(L,I){var K=this.__rx[L];if(!K){return null;}
;var J=this.__cM.pop()||new qx.ui.form.ListItem();J.set({label:K.getLabel(),icon:K.getIcon()});if(this.__uI.isItemSelected(L)){J.addState(c);}
else {J.removeState(c);}
;J.setUserData(r,L);return J;}
,poolCellWidget:function(M){this.__cM.push(M);}
,getValue:function(){var N=this.getSelection();var P=[];var O;for(var i=0,l=N.length;i<l;i++ ){O=N[i].getValue();if(O==null){O=N[i].getLabel();}
;P.push(O);}
;return P.join(C);}
,setValue:function(Q){var T=Q.split(C);var S=[];var R;for(var i=0,l=T.length;i<l;i++ ){R=this.findItem(T[i]);if(R){S.push(R);}
;}
;this.setSelection(S);}
,getChildren:function(){return this.__rx;}
,hasChildren:function(){return this.__rx.length>0;}
,_addHelper:function(U){this.fireDataEvent(z,U);U.addListener(B,this._onChangeItemHeight,this);qx.ui.core.queue.Widget.add(this);}
,_removeHelper:function(V){this.fireDataEvent(A,V);V.removeListener(B,this._onChangeItemHeight,this);qx.ui.core.queue.Widget.add(this);}
,add:function(W){this.__rx.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__rx,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__rx.length;i<j;i++ ){this._removeHelper(this.__rx[i]);}
;this.__rx=[];}
,indexOf:function(Y){return this.__rx.indexOf(Y);}
,addAt:function(bb,ba){qx.lang.Array.insertAt(this.__rx,bb,ba);this._addHelper(bb);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__rx,bc,bd);this._addHelper(bc);}
,addAfter:function(bf,be){qx.lang.Array.insertAfter(this.__rx,bf,be);this._addHelper(bf);}
,removeAt:function(bg){this.__rx.splice(bg,1);this._removeHelper(this.__rx[bg]);}
,__Rv:function(bh){var bi=this.__rx.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__Rw:function(bk){var bj=this.__rx[bk];return bj;}
,__Rx:function(bl){var bm=[];for(var i=0;i<bl.length;i++ ){bm.push(this.__Rv(bl[i]));}
;return bm;}
,__Ry:function(bo){var bn=[];for(var i=0;i<bo.length;i++ ){bn.push(this.__rx[bo[i]]);}
;return bn;}
,selectAll:function(){this.__uI.selectAll();}
,setSelected:function(bp){this.__uI.selectItem(this.__Rv(bp));}
,isSelected:function(bq){return this.__uI.isItemSelected(this.__Rv(bq));}
,addToSelection:function(br){this.__uI.addItem(this.__Rv(br));}
,removeFromSelection:function(bs){this.__uI.removeItem(this.__Rv(bs));}
,selectRange:function(bt,bu){this.__uI.selectItemRange(this.__Rv(bt),this.__Rv(bu));}
,resetSelection:function(){this.__uI.clearSelection();}
,setSelection:function(bv){this.__uI.replaceSelection(this.__Rx(bv));}
,getSelectedItem:function(){return this.__rx[this.getSelected()];}
,getSelected:function(){return this.__rx[this.__uI.getSelectedItem()];}
,getSelection:function(){return this.__Ry(this.__uI.getSelection());}
,getSortedSelection:function(){return this.__Ry(this.__uI.getSortedSelection());}
,isSelectionEmpty:function(){return this.__uI.isSelectionEmpty();}
,getSelectionContext:function(){return this.__uI.getSelectionContext();}
,getSelectables:function(){return this.__Ry(this.__uI.getSelectables());}
,_applySelectionMode:function(bx,bw){this.__uI.setMode(bx);}
,_applyDragSelection:function(bz,by){this.__uI.setDrag(bz);}
,_applyQuickSelection:function(bB,bA){this.__uI.setQuick(bB);}
}});}
)();
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:b}},members:{__HF:null,__HG:null,__ju:null,__HH:null,__HI:null,setPrefetchX:function(o,r,p,q){this.__HF=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__HG=[v,u,t,s];}
,_onInterval:function(){var w=this.__HF;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__HG;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__HH){y.getChildControl(j).removeListenerById(this.__HH);}
;if(this.__HI){y.getChildControl(l).removeListenerById(this.__HI);}
;}
...
;this.__HH=z.getChildControl(j).addListener(g,this.__ju.restart,this.__ju);this.__HI=z.getChildControl(l).addListener(g,this.__ju.restart,this.__ju);}
else {this.__ju.stop();}
;}
,_applyInterval:function(B,A){this.__ju.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__HF=this.__HG=null;this._disposeObjects(a);}
});}
)();
...
(function(){var a="changeWidth",b="qx.ui.form.RadioGroup",c="_applyManager",d="changeHeight",e="qx.event.type.Event",f="changeValue",g="Integer",h="demobrowser.demo.virtual.list.ListItem",i="String";qx.Class.define(h,{extend:qx.core.Object,construct:function(j,l,k){qx.core.Object.call(this);if(j!=null){this.setLabel(j);}
;if(l!=null){this.setIcon(l);}
;if(k!=null){this.setValue(k);}
;}
,events:{"action":e},properties:{label:{nullable:true,dereference:true,check:i},icon:{check:i,nullable:true},manager:{check:b,nullable:true,apply:c},value:{check:i,nullable:true,event:f},width:{check:g,nullable:true,event:a,init:null},height:{check:g,nullable:true,event:d,init:null}},members:{_applyManager:function(n,m){if(m){m.remove(this);}
;if(n){n.add(this);}
;}
