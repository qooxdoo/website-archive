...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Environment.db36e5156a61.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<tr><td>",b="demobrowser.demo.bom.Environment",c="</td><td>",d="<tr><td colspan='2'>&nbsp;</td></tr>",e="",f="<tr><td colspan='2'><h2>Asynchronous checks</h2></td></tr>",g="<h2>Synchronous checks</h2>",h="output",j="<tr><td colspan='2'><b>",k="</table>",l=".",m="<table border='0'>",n="</td></tr>",o="</b></td></tr>";qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var u=new qx.util.StringBuilder();u.add(g);u.add(m);var q=qx.core.Environment.getChecks();var r=Object.keys(q);r.sort();var w=e;for(var i=0;i<r.length;i++ ){var t=r[i];var s=t.split(l)[0];if(s!=w){w=s;u.add(d);u.add(j+s+o);}
;u.add(a,t,c,qx.lang.Json.stringify(qx.core.Environment.get(t),null,2),n);}
;u.add(f);q=qx.core.Environment.getAsyncChecks();var p=qx.lang.Object.getLength(q);r=Object.keys(q);if(p){for(var i=0;i<r.length;i++ ){var t=r[i];qx.core.Environment.getAsync(t,function(x){u.add(a,this,c,qx.lang.Json.stringify(x,null,2),n);p-- ;if(p===0){u.add(k);var y=document.getElementById(h);y.innerHTML=u.get();}
;}
,t);}
;}
else {u.add(k);var v=document.getElementById(h);v.innerHTML=u.get();}
;}
}});}
)();
...
;var G=qx.bom.client.OperatingSystem.getName();return (G==l||G==h)&&qx.bom.client.Flash.__zs(q,H);}
,getStrictSecurityModel:function(){var I=qx.bom.client.Flash.getVersion();if(I==k){return false;}
;var J=I.split(v);if(J[0]<10){return qx.bom.client.Flash.__zs(s,I);}
else {return qx.bom.client.Flash.__zs(j,I);}
;}
,_cachedSupportsVersion:{},__zs:function(O,L){var K=O.split(v);var M=L||qx.bom.client.Flash.getVersion();M=M.split(v);for(var i=0;i<K.length;i++ ){var N=parseInt(M[i],10)-parseInt(K[i],10);if(N>0){return true;}
