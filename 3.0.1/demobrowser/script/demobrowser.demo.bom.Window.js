...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.960ec78d830f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="click",c="Open Native Modal Window",d="demobrowser.demo.bom.Window",f="Modal Window closed?",g="http://sourceforge.net",h="window1",i="window3",j="http://slashdot.org",k="Window closed?",l="http://qooxdoo.org",m="demobrowser/demo/html/ModalWindow.html",n="Open Faked Native Modal Window",o="window2",p="#eee",q="button";qx.Class.define(d,{extend:qx.application.Native,members:{__sq:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__sq=[l,g,j,r.toUri(m)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,b,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__sq[0],h,x);}
,this);var t=qx.bom.Input.create(q);qx.bom.Input.setValue(t,k);document.body.appendChild(t);qx.event.Registration.addListener(t,b,function(e){alert(qx.bom.Window.isClosed(this.window1));}
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,c);document.body.appendChild(s);qx.event.Registration.addListener(s,b,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__sq[3],o,y,true);}
,this);var w=qx.bom.Input.create(q);qx.bom.Input.setValue(w,f);document.body.appendChild(w);qx.event.Registration.addListener(w,b,function(e){alert(qx.bom.Window.isClosed(this.window2));}
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,b,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(p);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__sq[0],i,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__nb:null,__IJ:null,__ju:null,__IK:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__IL:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__IM:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__IN(H,E&&A);if(E){if(this.__IM()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__ju==null){this.__ju=new qx.event.Timer(500);this.__ju.addListener(f,this.__IO,this);}
;this.__IJ=window.open(z,name,G);this.__ju.restart();C=this.__IJ;}
;}
...
;return C;}
,__IN:function(K,O){var M;var J;var N=[];if(O&&this.__IM()){for(var L in K){if(qx.bom.Window.__IK[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__IK[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__IL[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__IO:function(){if(this.isClosed(this.__IJ)){this.getBlocker().unblock();this.__ju.stop();}
;}
,getBlocker:function(){if(this.__nb==null){this.__nb=new qx.bom.Blocker;}
;return this.__nb;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__et();}
,members:{__IP:null,__ww:null,__IQ:null,__IR:false,__IS:10000,__IT:0,__IU:f,block:function(r){if(!this.__IR){this.__IQ=r;var q=this.__IX();this.__IY(q);this.__IR=true;}
;}
,unblock:function(){if(this.__IR){this.__Ja();this.__IR=false;}
;}
,isBlocked:function(){return this.__IR;}
,getBlockerElement:function(){return this.__ww;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__ww,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__ww,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__ww,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__ww);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__ww,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__ww,h);}
,__et:function(){this.__IV();if((qx.core.Environment.get(j)==b)){this.__IW();}
;qx.event.Registration.addListener(window,a,this.__zd,this);}
,__IV:function(){this.__ww=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__ww,{display:d,opacity:this.__IT,backgroundColor:this.__IU});this.setBlockerZIndex(this.__IS);}
,__IW:function(){this.__IP=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__IP,l,false);qx.bom.element.Attribute.set(this.__IP,i,n);qx.bom.element.Style.setStyles(this.__IP,{display:d,opacity:this.__IT});}
,__IX:function(){var v={position:p};if(this.__Jc()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__IQ)+g;v.height=qx.bom.element.Dimension.getHeight(this.__IQ)+g;v.left=qx.bom.element.Location.getLeft(this.__IQ)+g;v.top=qx.bom.element.Location.getTop(this.__IQ)+g;}
;return v;}
,__IY:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__ww,w);qx.dom.Element.insertEnd(this.__ww,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__IP,w);qx.dom.Element.insertEnd(this.__IP,document.body);}
;}
,__Ja:function(){qx.dom.Element.remove(this.__ww);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__IP);}
;}
,__zd:function(e){if(this.__Jc()){this.__Jb({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Jb(y);}
,this,0);}
;}
,__Jb:function(z){qx.bom.element.Style.setStyles(this.__ww,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__IP,z);}
;}
,__Jc:function(){return (this.__IQ==null||qx.dom.Node.isWindow(this.__IQ)||qx.dom.Node.isDocument(this.__IQ));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__zd,this);this.__IP=this.__ww=this.__IQ=null;}
});}
)();
