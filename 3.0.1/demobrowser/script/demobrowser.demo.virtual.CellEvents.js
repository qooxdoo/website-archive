...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.58f14690ffb1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=b+e.getRow()+i+e.getColumn()+h;this.__RE(q);}
,_onContextMenu:function(e){var r=f+e.getRow()+i+e.getColumn()+h;this.__RE(r);}
,_onDblclickPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__RE(s);}
,__RE:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
