...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Application.75dc6fc8f73b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="yellow",b="red",c="demobrowser.demo.root.Application",d="green",e="main",f="blue";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.core.Widget().set({backgroundColor:b,decorator:e,padding:10});var j=new qx.ui.core.Widget().set({backgroundColor:f,decorator:e});var g=new qx.ui.core.Widget().set({backgroundColor:d,decorator:e});var h=new qx.ui.core.Widget().set({backgroundColor:a,decorator:e});var i=new qx.ui.container.Composite(new qx.ui.layout.HBox());i.setDecorator(e);i.add(k);i.add(j);i.add(g);i.add(h);this.getRoot().add(i,{edge:0});}
}});}
)();
