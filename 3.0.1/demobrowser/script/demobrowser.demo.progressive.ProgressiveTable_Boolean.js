...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean.a7babc675062.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Boolean",b="end",c="row",d="demobrowser.demo.progressive.ProgressiveTable_Boolean",e="Id";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var o=0;var k=function(r){var s=[];for(var t=0;t<r;t++ ){s.push({renderer:c,location:b,data:[o++ ,(Math.floor(Math.random()*2)==0?false:true)]});}
;return s;}
;var n=new qx.ui.progressive.renderer.table.Widths(2);n.setWidth(0,100);n.setWidth(1,100);var i=[e,a];var j=new qx.ui.progressive.headfoot.TableHeading(n,i);var h=new qx.ui.progressive.headfoot.Progress(n,i);var m=new qx.ui.progressive.structure.Default(j,h);var g=new qx.ui.progressive.Progressive(m);var q=new qx.ui.progressive.model.Default();var l=k(20);q.addElements(l);g.setDataModel(q);var p=new qx.ui.progressive.renderer.table.Row(n);g.addRenderer(c,p);var f=new qx.ui.progressive.renderer.table.cell.Boolean();f.setAllowToggle(true);p.addRenderer(1,f);g.set({width:200+qx.bom.element.Scroll.getScrollbarWidth(),maxWidth:200+qx.bom.element.Scroll.getScrollbarWidth()});this.getRoot().add(g,{left:50,top:50,bottom:50});g.render();}
}});}
)();
(function(){var a="Column number out of range",b="Unrecognized key: ",c="qx.ui.progressive.renderer.table.Widths",d="minWidth",e="width",f="maxWidth";qx.Class.define(c,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__Ho=[];for(var i=0;i<g;i++ ){this.__Ho[i]=new qx.ui.core.ColumnData();}
;}
,members:{__Ho:null,getData:function(){return this.__Ho;}
,set:function(h,j){for(var k in j){switch(k){case e:this.setWidth(h,j[k]);break;case d:this.setMinWidth(h,j[k]);break;case f:this.setMaxWidth(h,j[k]);break;default:throw new Error(b+k);};}
;}
,setWidth:function(l,m){if(l>this.__Ho.length-1||l<0){throw new Error(a);}
;this.__Ho[l].setColumnWidth(m);}
,setMinWidth:function(n,o){if(n>this.__Ho.length-1||n<0){throw new Error(a);}
;this.__Ho[n].setMinWidth(o);}
,setMaxWidth:function(p,q){if(p>this.__Ho.length-1||p<0){throw new Error(a);}
;this.__Ho[p].setMaxWidth(q);}
}});}
)();
(function(){var a="string",b="number",c="auto",d="*",e="qx.ui.core.ColumnData";qx.Class.define(e,{extend:qx.ui.core.LayoutItem,construct:function(){qx.ui.core.LayoutItem.call(this);this.setColumnWidth(c);}
,members:{__ul:null,renderLayout:function(g,top,f,h){this.__ul=f;}
,getComputedWidth:function(){return this.__ul;}
,getFlex:function(){return this.getLayoutProperties().flex||0;}
,setColumnWidth:function(l,i){var i=i||0;var j=null;if(typeof l==b){this.setWidth(l);}
else if(typeof l==a){if(l==c){i=1;}
else {var k=l.match(/^[0-9]+(?:\.[0-9]+)?([%\*])$/);if(k){if(k[1]==d){i=parseFloat(l);}
else {j=l;}
;}
;}
;}
;this.setLayoutProperties({flex:i,width:j});}
},environment:{"qx.tableResizeDebug":false}});}
)();
(function(){var a="qx.ui.progressive.headfoot.Abstract",b="abstract";qx.Class.define(a,{type:b,extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this,new qx.ui.layout.HBox());}
,members:{__EF:null,join:function(c){this.__EF=c;}
},destruct:function(){this.__EF=null;}
});}
)();
(function(){var a="progressive-table-header-cell",b="resize",c="progressive-table-header",d="_layout",f="qx.ui.progressive.headfoot.TableHeading";qx.Class.define(f,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(l,k){qx.ui.progressive.headfoot.Abstract.call(this);this.__EX=l;var j=l.getData();this.__EY=[];for(var i=0;i<j.length;i++ ){var g=new qx.ui.basic.Atom(k[i]);g.setAppearance(a);this.add(g);this.__EY[i]=g;}
;var h=new qx.ui.core.Widget();h.set({height:16,appearance:a,minWidth:0,width:0});this.add(h,{flex:1});this.addListener(b,this._resizeColumns,this);this.__qO=new qx.ui.layout.HBox();this.__qO.connectToWidget(this);}
,properties:{appearance:{refine:true,init:c}},members:{__EX:null,__Fa:null,__EY:null,__qO:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__Fa){return this.__EX.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var p=this.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();this.__Fa=true;var n={top:this.getPaddingTop(),right:this.getPaddingRight(),bottom:this.getPaddingBottom(),left:this.getPaddingLeft()};this.__qO.renderLayout(p,100,n);this.__Fa=false;var o=this.__EX.getData();for(var i=0;i<o.length;i++ ){this.__EY[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__EX=this.__EY=null;this._disposeObjects(d);}
});}
)();
(function(){var a="progressive-progressbar-indicator-undone",b="__GF",c="progress",d="%",f="progressive-progressbar-indicator-done",g="progressive-progressbar-percent-text",h="renderStart",i="progressive-progressbar-background",j="0%",k="qx.ui.progressive.headfoot.Progress",l="__GE",m="progressive-progressbar-percent-background",n="renderEnd";qx.Class.define(k,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,q){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__FE={};this.__FI();this.set({backgroundColor:this.__FE.background});this.__GE=new qx.ui.core.Widget();this.__GE.set({width:0,backgroundColor:this.__FE.indicatorDone});this.add(this.__GE);var p=new qx.ui.core.Widget();p.set({backgroundColor:this.__FE.indicatorUndone});this.add(p,{flex:1});this.__GF=new qx.ui.basic.Atom(j);this.__GF.set({width:100,backgroundColor:this.__FE.percentBackground,textColor:this.__FE.percentText});this.add(this.__GF);this.exclude();}
,members:{__GG:null,__FE:null,__GE:null,__GF:null,_onChangeTheme:function(){qx.ui.progressive.headfoot.Abstract.prototype._onChangeTheme.call(this);this.__FI();}
,__FI:function(){var r=qx.theme.manager.Color.getInstance();this.__FE.background=r.resolve(i);this.__FE.indicatorDone=r.resolve(f);this.__FE.indicatorUndone=r.resolve(a);this.__FE.percentBackground=r.resolve(m);this.__FE.percentText=r.resolve(g);}
,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(h,function(e){this.__GG=e.getData().initial;this.show();}
,this);s.addListener(c,function(e){var u=1.0-(e.getData().remaining/this.__GG);var w=this.getBounds();if(w){var v=Math.floor((w.width-this.__GF.getBounds().width)*u);var t=Math.floor(u*100)+d;if(!isNaN(v)){this.__GE.setMinWidth(v);this.__GF.setLabel(t);}
;}
;}
,this);s.addListener(n,function(e){this.exclude();}
,this);}
},destruct:function(){this.__FE=null;this._disposeObjects(l,b);}
});}
)();
(function(){var a="applyStructure() is abstract",b="abstract",c="qx.ui.progressive.structure.Abstract",d="overflowY",e="auto";qx.Class.define(c,{type:b,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__EB=new qx.ui.core.Widget();this.__xn=this.__EB;}
else {this.__EB=null;this.__xn=f;}
;this.__xn.getContentElement().setStyle(d,e);}
,members:{__EB:null,__xn:null,applyStructure:function(g){throw new Error(a);}
,getPane:function(){return this.__xn;}
},destruct:function(){if(this.__EB){this.__EB.dispose();}
;this.__EB=this.__xn=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,d,c){qx.ui.progressive.structure.Abstract.call(this,c);if(!b){this.__EC=new qx.ui.progressive.headfoot.Null();this.__nB=this.__EC;}
else {this.__EC=null;this.__nB=b;}
;if(!d){this.__ED=new qx.ui.progressive.headfoot.Null();this.__EE=this.__ED;}
else {this.__ED=null;this.__EE=d;}
;}
,members:{__nB:null,__EE:null,__EC:null,__ED:null,applyStructure:function(e){this.__nB.join(e);this.__EE.join(e);e.add(this.__nB);e.add(this.getPane(),{flex:1});e.add(this.__EE);}
,getHeader:function(){return this.__nB;}
,getFooter:function(){return this.__EE;}
},destruct:function(){if(this.__EC){this.__EC.dispose();this.__EC=null;}
;if(this.__ED){this.__ED.dispose();this.__ED=null;}
;this.__nB=this.__EE=null;}
});}
)();
...
(function(){var a="dataAvailable",b="_applyDataModel",c="Boolean",d="Render time: ",f="qx.ui.progressive.model.Abstract",g="renderStart",h="ms",j="progress",k="white",l="No existing renderer named ",m="qx.ui.progressive.Progressive",n="progressDetail",o="Integer",p="renderEnd",q="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.container.Composite,construct:function(r){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__FJ={};this.set({backgroundColor:k});if(!r){r=new qx.ui.progressive.structure.Default();}
;this.__FK=r;r.applyStructure(this);this.__FL=false;this.__FM=false;this.__FN=0;}
,events:{"renderStart":q,"renderEnd":q,"progress":q,"progressDetail":q},properties:{dataModel:{check:f,apply:b},batchSize:{check:o,init:20},flushWidgetQueueAfterBatch:{check:c,init:false},interElementTimeout:{check:o,init:0}},members:{__FJ:null,__FM:null,__FO:null,__FN:null,__FL:null,__FK:null,getStructure:function(){return this.__FK;}
,addRenderer:function(name,s){this.__FJ[name]=s;s.join(this,name);}
,removeRenderer:function(name){if(!this.__FJ[name]){throw new Error(l+name);}
;delete this.__FJ[name];}
,render:function(){if(this.__FM){return;}
;this.__FM=true;var t=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__FK.getPane(),batchSize:this.getBatchSize(),rendererData:this.__FQ(),userData:{}});this.__FO=new Date();if(this.__FL){this.__FN=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__FN});this.__FP(t);}
else {qx.event.Timer.once(function(){this.__FN=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__FN});this.__FP(t);this.__FL=true;}
,this,10);}
;}
,_applyDataModel:function(v,u){if(u){u.removeListener(a,this.__FR,this);u.dispose();}
;v.addListener(a,this.__FR,this);}
,__FP:function(x){var w;var z;var y;for(var i=x.getBatchSize();i>0;i-- ){w=x.getModel().getNextElement();if(!w){this.debug(d+(new Date()-this.__FO)+h);this.__FM=false;this.fireDataEvent(p,x);x.dispose();return;}
;z=w.element;y=this.__FJ[z.renderer];y.render(x,z);this.fireDataEvent(n,{initial:this.__FN,remaining:w.remaining,element:z});}
;this.fireDataEvent(j,{initial:this.__FN,remaining:w.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__FP(x);}
,this,this.getInterElementTimeout());}
,__FQ:function(){var A={};for(var name in this.__FJ){A[name]={};}
;return A;}
,__FR:function(e){this.__FN=e.getData();this.render();}
},destruct:function(){for(var name in this.__FJ){this.__FJ[name].dispose();}
;this.__FO=this.__FJ=this.__FK=null;}
});}
)();
...
(function(){var a="getElementCount() is abstract",b="abstract",c="qx.ui.progressive.model.Abstract",d="getNextElement() is abstract",e="qx.event.type.Data";qx.Class.define(c,{type:b,extend:qx.core.Object,events:{"dataAvailable":e},members:{getElementCount:function(){throw new Error(a);}
,getNextElement:function(){throw new Error(d);}
}});}
)();
(function(){var a="dataAvailable",b="qx.ui.progressive.model.Default";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__pg=[];}
,members:{__pg:null,addElements:function(c){this.__pg=this.__pg.concat(c);this.fireDataEvent(a,this.__pg.length);}
,addElement:function(d){this.__pg.push(d);this.fireDataEvent(a,this.__pg.length);}
,getElementCount:function(){return this.__pg.length;}
,getNextElement:function(){if(this.__pg.length>0){return ({element:this.__pg.shift(),remaining:this.__pg.length});}
;return null;}
},destruct:function(){this.__pg=null;}
});}
)();
(function(){var a="qx.ui.progressive.renderer.Abstract",b="render() is abstract",c="abstract";qx.Class.define(a,{type:c,extend:qx.core.Object,members:{render:function(d,e){throw new Error(b);}
,join:function(f,name){}
}});}
)();
(function(){var a="resize",b="__FD",c="content",d="px",f="  font-size: 11px;",g=")",h="px ",j=';',k='',l="padding: ",m="end",n="div",o="  position: absolute;",p="qx.tableResizeDebug",q="changeTheme",r="-col-",s="__columnData",t="css.userselect",u="Renderer is already joined to a Progressive.",v="css.boxmodel",w="css.textoverflow",x="  top: 0px;",y="  width : 100%;",z="  overflow:hidden;",A=" {",B="}",C="  border-right:1px solid #f2f2f2;",D="Invalid location: ",E="  cursor:default;",F="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",G="-row {",H="-row",I="qx.debug",J="qx.dyntheme",K="start",L="relative",M="",N=": width=",O=':ellipsis;',P=':',Q="  white-space:nowrap;",R="  padding : 0px 6px 0px 6px;",S="qx.ui.progressive.renderer.table.Row",T="width: ",U=" out of range (max: ",V="px;",W="0px ",X="progressive-table-row-background-odd",Y=".qx-progressive-",bo="  height: 100%;",bp="qx-progressive-",bq="__qO",bk="progressive-table-row-background-even",bl="col ",bm="  border-bottom:1px solid #eeeeee;",bn="left: ",br="No existing renderer for column ",bs="css.userselect.none",bt="Column ";qx.Class.define(S,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bu){qx.ui.progressive.renderer.Abstract.call(this);this.__EX=bu;this.__FC={};this.__FD=new qx.ui.progressive.renderer.table.cell.Default();this.__EF=null;this.__FE={};this.__FI();this.__qO=new qx.ui.layout.HBox();this.__qO.connectToWidget(this);if(qx.core.Environment.get(J)){qx.theme.manager.Color.getInstance().addListener(q,this.__FI,this);}
;}
,statics:{__tN:null,__FF:6,__FG:o+x+bo+z+(qx.core.Environment.get(w)?qx.bom.Style.getCssName(qx.core.Environment.get(w))+O:M)+Q+C+bm+R+E+f+F+(qx.core.Environment.get(t)?qx.bom.Style.getCssName(qx.core.Environment.get(t))+P+qx.core.Environment.get(bs)+j:k)},properties:{defaultRowHeight:{init:16}},members:{__EF:null,__sw:null,__FH:null,__EX:null,__FC:null,__FD:null,__FE:null,__qO:null,__FI:function(){var bv=qx.theme.manager.Color.getInstance();this.__FE.bgcol=[];this.__FE.bgcol[0]=bv.resolve(bk);this.__FE.bgcol[1]=bv.resolve(X);}
,join:function(bx,name){if(this.__EF){throw new Error(u);}
;this.__EF=bx;this.__sw=name;var by=qx.ui.progressive.renderer.table.Row;if(!by.__tN){by.__tN={};}
;var bw=bx.toHashCode();if(!by.__tN[bw]){by.__tN[bw]={rowstylesheet:null,cellstylesheet:[]};var bz=Y+bw+G+y+B;by.__tN[bw].rowstylesheet=qx.bom.Stylesheet.createElement(bz);var bA=this.__EX.getData();for(var i=0;i<bA.length;i++ ){var bz=Y+bw+r+i+A+by.__FG+B;by.__tN[bw].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bz);}
;this.__FH=bw;var bB=bx.getStructure().getPane();bB.addListener(a,this._resizeColumns,this);}
;}
,addRenderer:function(bC,bE){var bD=this.__EX.getData();if(bC<0||bC>=bD.length){throw new Error(bt+bC+U+(bD.length-1)+g);}
;this.__FC[bC]=bE;}
,removeRenderer:function(bF){var bG=this.__EX.getData();if(bF<0||bF>=bG.length){throw new Error(bt+bF+U+(bG.length-1)+g);}
;if(!this.__FC[bF]){throw new Error(br+bF);}
;delete this.__FC[bF];}
,render:function(bI,bR){var bS=bR.data;var bM=[];var bO;var bN;var bK=0;if(bI.getRendererData()[this.__sw].end===undefined){bI.getRendererData()[this.__sw]={end:0,start:1,rows:0,totalHeight:0};}
;var bQ=document.createElement(n);for(var i=0;i<bS.length;i++ ){var bL=bp+this.__FH+r+i;bN=this.__FC[i]||this.__FD;bO={state:bI,rowDiv:bQ,stylesheet:bL,element:bR,dataIndex:i,cellData:bS[i],height:bK};bM.push(bN.render(bO));if(bO.height>bK){bK=bO.height;}
;}
;bK=(bK>0?bK:this.getDefaultRowHeight());var bP=bI.getRendererData()[this.__sw];bP.totalHeight+=bK;bQ.style.position=L;bQ.style.height=bK+d;bQ.className=bp+this.__FH+H;bQ.innerHTML=bM.join(M);switch(bR.location){case m:var bH=bP.end||0;bQ.style.backgroundColor=this.__FE.bgcol[bH];bP.end=(bH==0?1:0);bI.getPane().getContentElement().getDomElement().appendChild(bQ);break;case K:var bJ=bI.getPane().getContentElement().getDomElement();var bT=bJ.childNodes;if(bT.length>0){var bH=bP.start;bQ.style.backgroundColor=this.__FE.bgcol[bH];bP.start=(bH==0?1:0);bJ.insertBefore(bQ,bT[0]);break;}
else {bJ.appendChild(bQ);}
;break;default:throw new Error(D+bR.location);}; ++bP.rows;}
,getLayoutChildren:function(){return this.__EX.getData();}
,_resizeColumns:function(e){var cc=this.__EF.getStructure().getPane();var bY=cc.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();var bW=Y+this.__FH+H;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__tN[this.__FH].rowstylesheet,bW);var bX=T+bY+V;qx.bom.Stylesheet.addRule(bV.__tN[this.__FH].rowstylesheet,bW,bX);this.__qO.renderLayout(bY,100,{top:0,right:0,bottom:0,left:0});var cb=this.__EX.getData();for(var i=0,ce=0;i<cb.length;i++ ,ce+=bY){var bW=Y+this.__FH+r+i;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__tN[this.__FH].cellstylesheet[i],bW);bY=cb[i].getComputedWidth();if(qx.core.Environment.get(I)){if(qx.core.Environment.get(p)){this.debug(bl+i+N+bY);}
;}
;var ca;if(qx.core.Environment.get(v)==c){ca=qx.ui.progressive.renderer.table.Row.__FF*2;}
else {ca=-1;}
;var cf=(bY-ca)+V;var cd=W+qx.ui.progressive.renderer.table.Row.__FF+h+W+qx.ui.progressive.renderer.table.Row.__FF+V;var bU=ce+V;var bX=bV.__FG+T+cf+bn+bU+l+cd;qx.bom.Stylesheet.addRule(bV.__tN[this.__FH].cellstylesheet[i],bW,bX);}
;}
},destruct:function(){qx.theme.manager.Color.getInstance().removeListener(q,this.__FI,this);var name;for(name in this.__FC){this.__FC[name]=null;}
;var ch=qx.ui.progressive.renderer.table.Row;var cg=this.__EF.toHashCode();if(ch.__tN&&ch.__tN[cg]){if(ch.__tN[cg].rowstylesheet){var cj=Y+this.__FH+H;var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ch.__tN[this.__FH].rowstylesheet,cj);}
;if(ch.__tN[cg].cellstylesheet){for(var i=ch.__tN[cg].cellstylesheet.length-1;i>=0;i-- ){var cj=Y+this.__FH+r+i;var ci=ch.__tN[this.__FH].cellstylesheet[i];var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ci,cj);}
;}
;}
;if(this.__EF&&this.__EF.getRendererData){var ck=this.__EF.getRendererData();if(ck&&ck[this.__sw]&&ck[this.__sw].end!==undefined){ck[this.__sw]=null;}
;}
;this.__FE=this.__FC=this.__EF=this.__EX=null;this._disposeObjects(bq,b,s);}
});}
)();
(function(){var a="'",b="abstract",c="",d=">",e="</div>",f="<div ",g="' ",h="style='",i="qx.ui.progressive.renderer.table.cell.Abstract",j="class='";qx.Class.define(i,{type:b,extend:qx.core.Object,members:{_getCellStyle:function(k){return c;}
,_getCellExtras:function(l){return c;}
,_getContentHtml:function(m){return m.cellData||c;}
,render:function(n){var p=[];var o=this._getCellStyle(n);p.push(f,j,n.stylesheet,g);if(o){p.push(h,o,a);}
;p.push(this._getCellExtras(n),d,this._getContentHtml(n),e);return p.join(c);}
}});}
)();
(function(){var a="number",b="qx.ui.progressive.renderer.table.cell.Default",c="",d="string";qx.Class.define(b,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);}
,members:{_getContentHtml:function(e){return qx.bom.String.escape(this._formatValue(e.cellData));}
,_formatValue:function(f){var g;if(f==null){return c;}
;if(typeof f==d){return f;}
else if(typeof f==a){if(!qx.ui.progressive.renderer.table.Row._numberFormat){var h=new qx.util.format.NumberFormat();h.setMaximumFractionDigits(2);qx.ui.progressive.renderer.table.Row._numberFormat=h;}
;g=qx.ui.progressive.renderer.table.Row._numberFormat.format(f);}
else if(f instanceof Date){g=qx.util.format.DateFormat.getDateInstance().format(f);}
else {g=f;}
;return g;}
}});}
)();
...
;if(this.getGroupingUsed()){var z=E;E=l;var H;for(H=z.length;H>3;H-=3){E=l+qx.locale.Number.getGroupSeparator(this.__kk)+z.substring(H-3,H)+E;}
;E=z.substring(0,H)+E;}
;var B=this.getPrefix()?this.getPrefix():l;var y=this.getPostfix()?this.getPostfix():l;var F=B+(A?a:l)+E;if(D.length>0){F+=l+qx.locale.Number.getDecimalSeparator(this.__kk)+D;}
;F+=y;return F;}
,parse:function(R){var N=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__kk)+l);var L=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__kk)+l);var J=new RegExp(c+qx.lang.String.escapeRegexpChars(this.getPrefix())+o+m+N+k+h+L+s+qx.lang.String.escapeRegexpChars(this.getPostfix())+q);var M=J.exec(R);if(M==null){throw new Error(d+R+e);}
...
(function(){var a="-",b="QQQ",c='W',d="qqqq",e="h",f="KK",g='L',h=" is not supported",m="Z",n="Date string '",o="GGGGG",p='abbreviated',q="Y+",r=". Wildcard ",s="eeeee",t="(\\d\\d?)",u="LL",v="abbreviated",w="EEEE",x="^",y=":",z='y',A="quoted_literal",B="weekOfYear",C='3rd quarter',D="SSS",E='a',F="day",G="(-*",H="qqq",I="locale",J="K",K='q',L="Provided date is invalid",M="pm",N="Error parsing date '",O='Anno Domini',P='G',Q="a",R='2nd quarter',S="yyyy-MM-dd'T'HH:mm:ss",T="GMT",U="HH:mm:ss",V="dd",W="+",X="qx.util.format.DateFormat",Y='weekDay',en="am",ei="eee",eo="quarter",ek="ee",el="q",eh="QQQQ",em="HHmmss",es="ww",et="H",eu='Y+',ev="wide",ep='wide',eq="(\\d\\d\\d?)",ej="(GMT[\\+\\-]\\d\\d:\\d\\d)",er="_applyLocale",ez="Q",fd="c",eA="(",eB="weekOfMonth",ew="ccc",ex="long",ge="Malformed date format: ",ey="EEEEE",eC='Y',eD="EE",eE="GGG",eJ='-',eK="w",eL="mm",eF='h',eG="S",eH='s',eI='A',eQ="yyyy-MM-dd",eR="G",eS='z',eT="GG",eM=")",eN="kk",eO="ss",eP="([\\+\\-]\\d\\d\\d\\d)",eX="default",eY='BC',gi='H',fa='S',eU='1st quarter',eV="stand-alone",gg="0",eW="MMMM",fb='c',fc="d",fo='Q',fn='Q1',fm="eeee",fs="QQ",fr="LLLLL",fq="HH",fp='k',fh="m",fg="DDD",ff="D",fe='D',fl="LLLL",fk="(\\d\\d*?)",fj='e',fi="': the value for day or month is too large",fz="literal",fy='K',fx="L",fw="hh",fD="ms",fC="(\\d\\d?\\d?)",fB="cccc",fA="e",fv='y+',fu="|",ft="W",fO="dayOfYear",fN="GGGG",fM='Q2',fS='B',fR="MM",fQ='Q4',fP="y+",fH='narrow',fG="ccccc",fF="E",fE="wildcard",fL='',fK="' does not match the date format: ",fJ="short",fI='d',fY="unkown",fX="narrow",fW="\\d?",fV="'",gd="k",gc='Before Christ',gb='Z',ga="qx.debug",fU='m',fT=" ",dQ="yyyy-MM-dd'T'HH:mm:ss'Z'",dP="String",gj='Q3',dN="z",dO="DD",dM="min",gh="",dK='M',dL="sec",dJ='isoUtcDateTime',gf='4th quarter',dH="(\\d?)",dI="SS",dG="MMM",ea="s",eb="M",dX='w',dY="EEE",dV="$",dW="?",dU='AD',dF="\\d",dS="+?",dT="hour",dR="MMMMM",eg='E',ee='month',ef="LLL",ec="qq",ed="format";qx.Class.define(X,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(gl,gk){qx.core.Object.call(this);if(!gk){this.__kk=qx.locale.Manager.getInstance().getLocale();this.__tr=qx.locale.Manager.getInstance().bind(I,this,I);}
else {this.__kk=gk;this.setLocale(gk);}
;this.__ts=this.__kk;if(gl!=null){this.__tt=gl.toString();if(this.__tt in qx.util.format.DateFormat.ISO_MASKS){if(this.__tt===dJ){this.__tu=true;}
;this.__tt=qx.util.format.DateFormat.ISO_MASKS[this.__tt];}
;}
else {this.__tt=qx.locale.Date.getDateFormat(ex,this.__kk)+fT+qx.locale.Date.getDateTimeFormat(em,U,this.__kk);}
;}
,properties:{locale:{apply:er,nullable:true,check:dP}},statics:{getDateInstance:function(){var gm=qx.util.format.DateFormat;var gn=qx.locale.Date.getDateFormat(fJ)+gh;if(gm._dateInstance==null||gm._dateInstance.__tt!=gn){gm._dateInstance=new gm(gn);}
;return gm._dateInstance;}
,getDateTimeInstance:function(){var go=qx.util.format.DateFormat;var gp=qx.locale.Date.getDateFormat(ex)+fT+qx.locale.Date.getDateTimeFormat(em,U);if(go._dateTimeInstance==null||go._dateTimeInstance.__tt!=gp){go._dateTimeInstance=new go(gp);}
;return go._dateTimeInstance;}
,ASSUME_YEAR_2000_THRESHOLD:30,ISO_MASKS:{isoDate:eQ,isoTime:U,isoDateTime:S,isoUtcDateTime:dQ},AM_MARKER:en,PM_MARKER:M},members:{__tr:null,__kk:null,__ts:null,__tt:null,__tv:null,__tw:null,__tx:null,__tu:null,__ty:function(gr,gq){var gs=gh+(gr<0?((-1)*gr):gr);while(gs.length<gq){gs=gg+gs;}
;return gr<0?a+gs:gs;}
,__tz:function(gt){var gu=new Date(gt.getTime());var gv=gu.getDate();while(gu.getMonth()!=0){gu.setDate(-1);gv+=gu.getDate()+1;}
;return gv;}
,__tA:function(gw){return new Date(gw.getTime()+(3-((gw.getDay()+6)%7))*86400000);}
,__tB:function(gx){var gz=this.__tA(gx);var gA=gz.getFullYear();var gy=this.__tA(new Date(gA,0,4));return Math.floor(1.5+(gz.getTime()-gy.getTime())/86400000/7);}
,__tC:function(gB){var gD=this.__tA(gB);var gC=this.__tA(new Date(gB.getFullYear(),gB.getMonth(),4));return Math.floor(1.5+(gD.getTime()-gC.getTime())/86400000/7);}
,__tD:function(gE){var gF=this.__tA(gE);return gF.getFullYear();}
,__tE:function(gH){var gG=new Date(gH,2,1);gG.setDate(-1);return gG.getDate()+1===29;}
,__tF:function(gM,gN){var gL=0;var gO=0;if(!gN){gN=1971;}
...
,__tG:function(gS,gQ,gP){var gR;switch(gQ){case 11:gR=gS-1;if(gS!=this.__tD(new Date(gR,gQ,gP))){gR=gS;}
;break;case 0:gR=gS+1;if(gS!=this.__tD(new Date(gR,gQ,gP))){gR=gS;}
;break;default:gR=gS;};return gR;}
,_applyLocale:function(gU,gT){this.__kk=gU===null?this.setLocale(this.__ts):gU;}
,format:function(hl){if(hl==null){return null;}
;if(isNaN(hl.getTime())){if(qx.core.Environment.get(ga)){qx.log.Logger.error(L);}
;return null;}
;if(this.__tu){hl=new Date(hl.getUTCFullYear(),hl.getUTCMonth(),hl.getUTCDate(),hl.getUTCHours(),hl.getUTCMinutes(),hl.getUTCSeconds(),hl.getUTCMilliseconds());}
;var gX=this.__kk;var hd=hl.getFullYear();var gY=hl.getMonth();var hc=hl.getDate();var hg=hl.getDay();var hj=hl.getHours();var hq=hl.getMinutes();var hh=hl.getSeconds();var ho=hl.getMilliseconds();var hf=hl.getTimezoneOffset();var hk=hf>0?1:-1;var gV=Math.floor(Math.abs(hf)/60);var hn=Math.abs(hf)%60;this.__tH();var hp=gh;for(var i=0;i<this.__tx.length;i++ ){var he=this.__tx[i];if(he.type==fz){hp+=he.text;}
else {var gW=he.character;var hi=he.size;var hr=dW;switch(gW){case z:if(hi==2){hr=this.__ty(hd%100,2);}
else {var ha=Math.abs(hd);hr=ha+gh;if(hi>hr.length){for(var j=hr.length;j<hi;j++ ){hr=gg+hr;}
;}
;if(hd<0){hr=a+hr;}
;}
;break;case eC:hr=this.__tD(hl)+gh;var ha=hr.replace(eJ,fL);if(hi>hr.length){for(var j=ha.length;j<hi;j++ ){ha=gg+ha;}
;}
;hr=hr.indexOf(a)!=-1?a+ha:ha;break;case P:if(hi>=1&&hi<=3){hr=hd>0?dU:eY;}
else if(hi==4){hr=hd>0?O:gc;}
else if(hi==5){hr=hd>0?eI:fS;}
;break;case fo:if(hi==1||hi==2){hr=this.__ty(parseInt(gY/4)+1,hi);}
;if(hi==3){hr=fo+(parseInt(gY/4)+1);}
;break;case K:if(hi==1||hi==2){hr=this.__ty(parseInt(gY/4)+1,hi);}
;if(hi==3){hr=fo+(parseInt(gY/4)+1);}
;break;case fe:hr=this.__ty(this.__tz(hl),hi);break;case fI:hr=this.__ty(hc,hi);break;case dX:hr=this.__ty(this.__tB(hl),hi);break;case c:hr=this.__tC(hl);break;case eg:if(hi>=1&&hi<=3){hr=qx.locale.Date.getDayName(v,hg,gX,ed,true);}
else if(hi==4){hr=qx.locale.Date.getDayName(ev,hg,gX,ed,true);}
else if(hi==5){hr=qx.locale.Date.getDayName(fX,hg,gX,ed,true);}
;break;case fj:var hb=qx.locale.Date.getWeekStart(gX);var hm=1+((hg-hb>=0)?(hg-hb):7+(hg-hb));if(hi>=1&&hi<=2){hr=this.__ty(hm,hi);}
...
;break;case dK:if(hi==1||hi==2){hr=this.__ty(gY+1,hi);}
...
;break;case g:if(hi==1||hi==2){hr=this.__ty(gY+1,hi);}
...
;break;case E:hr=(hj<12)?qx.locale.Date.getAmMarker(gX):qx.locale.Date.getPmMarker(gX);break;case gi:hr=this.__ty(hj,hi);break;case fp:hr=this.__ty((hj==0)?24:hj,hi);break;case fy:hr=this.__ty(hj%12,hi);break;case eF:hr=this.__ty(((hj%12)==0)?12:(hj%12),hi);break;case fU:hr=this.__ty(hq,hi);break;case eH:hr=this.__ty(hh,hi);break;case fa:hr=this.__ty(ho,3);if(hi<hr.length){hr=hr.substr(0,hi);}
else {while(hi>hr.length){hr+=gg;}
;}
;break;case eS:if(hi>=1&&hi<=4){hr=T+((hk>0)?a:W)+this.__ty(Math.abs(gV),2)+y+this.__ty(hn,2);}
;break;case gb:if(hi>=1&&hi<=3){hr=((hk>0)?a:W)+this.__ty(Math.abs(gV),2)+this.__ty(hn,2);}
else {hr=T+((hk>0)?a:W)+this.__ty(Math.abs(gV),2)+y+this.__ty(hn,2);}
;break;};hp+=hr;}
;}
;return hp;}
,parse:function(hy){this.__tI();var hB=this.__tv.regex.exec(hy);if(hB==null){throw new Error(n+hy+fK+this.__tt);}
;var hs={era:1,year:1970,quarter:1,month:0,day:1,dayOfYear:1,hour:0,ispm:false,weekDay:4,weekYear:1970,weekOfMonth:1,weekOfYear:1,min:0,sec:0,ms:0};var hw=1;var ht=false;var hu=false;for(var i=0;i<this.__tv.usedRules.length;i++ ){var hv=this.__tv.usedRules[i];var hx=hB[hw];if(hv.field!=null){hs[hv.field]=parseInt(hx,10);}
else {hv.manipulator(hs,hx,hv.pattern);}
;if(hv.pattern==q){var hz=false;for(var k=0;k<this.__tv.usedRules.length;k++ ){if(this.__tv.usedRules[k].pattern==fv){hz=true;break;}
;}
;if(!hz){ht=true;}
;}
;if(hv.pattern.indexOf(ff)!=-1){var hD=false;for(var k=0;k<this.__tv.usedRules.length;k++ ){if(this.__tv.usedRules[k].pattern.indexOf(fc)!=-1){hD=true;break;}
;}
;if(!hD){hu=true;}
;}
;hw+=(hv.groups==null)?1:hv.groups;}
;if(ht){hs.year=this.__tG(hs.weekYear,hs.month,hs.day);}
;if(hu){var hC=this.__tF(hs.dayOfYear,hs.year);hs.month=hC.month;hs.day=hC.day;}
;if(hs.era<0&&(hs.year*hs.era<0)){hs.year=hs.year*hs.era;}
;var hA=new Date(hs.year,hs.month,hs.day,(hs.ispm)?(hs.hour+12):hs.hour,hs.min,hs.sec,hs.ms);if(this.__tu){hA=new Date(hA.getUTCFullYear(),hA.getUTCMonth(),hA.getUTCDate(),hA.getUTCHours(),hA.getUTCMinutes(),hA.getUTCSeconds(),hA.getUTCMilliseconds());}
;if(hs.month!=hA.getMonth()||hs.year!=hA.getFullYear()){throw new Error(N+hy+fi);}
;return hA;}
,__tH:function(){if(this.__tx!=null){return;}
;this.__tx=[];var hI;var hG=0;var hK=gh;var hE=this.__tt;var hH=eX;var i=0;while(i<hE.length){var hJ=hE.charAt(i);switch(hH){case A:if(hJ==fV){if(i+1>=hE.length){i++ ;break;}
;var hF=hE.charAt(i+1);if(hF==fV){hK+=hJ;i++ ;}
else {i++ ;hH=fY;}
;}
else {hK+=hJ;i++ ;}
;break;case fE:if(hJ==hI){hG++ ;i++ ;}
else {this.__tx.push({type:fE,character:hI,size:hG});hI=null;hG=0;hH=eX;}
;break;default:if((hJ>=E&&hJ<=eS)||(hJ>=eI&&hJ<=gb)){hI=hJ;hH=fE;}
else if(hJ==fV){if(i+1>=hE.length){hK+=hJ;i++ ;break;}
;var hF=hE.charAt(i+1);if(hF==fV){hK+=hJ;i++ ;}
;i++ ;hH=A;}
else {hH=eX;}
;if(hH!=eX){if(hK.length>0){this.__tx.push({type:fz,text:hK});hK=gh;}
;}
else {hK+=hJ;i++ ;}
;break;};}
;if(hI!=null){this.__tx.push({type:fE,character:hI,size:hG});}
else if(hK.length>0){this.__tx.push({type:fz,text:hK});}
;}
,__tI:function(){if(this.__tv!=null){return;}
;var hO=this.__tt;this.__tK();this.__tH();var hU=[];var hP=x;for(var hM=0;hM<this.__tx.length;hM++ ){var hV=this.__tx[hM];if(hV.type==fz){hP+=qx.lang.String.escapeRegexpChars(hV.text);}
else {var hN=hV.character;var hQ=hV.size;var hS;for(var hW=0;hW<this.__tw.length;hW++ ){var hR=this.__tw[hW];if(this.__tJ(hR,hN,hQ)){hS=hR;break;}
;}
...
;this.__tv={regex:hL,"usedRules":hU,pattern:hP};}
,__tJ:function(hY,ia,ib){if(ia===z&&hY.pattern===fv){hY.regex=hY.regexFunc(ib);return true;}
else if(ia===eC&&hY.pattern===eu){hY.regex=hY.regexFunc(ib);return true;}
else {return ia==hY.pattern.charAt(0)&&ib==hY.pattern.length;}
;}
,__tK:function(){var ir=qx.util.format.DateFormat;var iu=qx.lang.String;if(this.__tw!=null){return;}
;var is=this.__tw=[];var im=qx.locale.Date.getAmMarker(this.__kk).toString()||ir.AM_MARKER;var iB=qx.locale.Date.getPmMarker(this.__kk).toString()||ir.PM_MARKER;var id=this.__kk;var ij=function(iE,iF){iF=parseInt(iF,10);if(iF>0){if(iF<ir.ASSUME_YEAR_2000_THRESHOLD){iF+=2000;}
...
},destruct:function(){if(this.__tr!=null){qx.locale.Manager.getInstance().removeBinding(this.__tr);}
;this.__tx=this.__tv=this.__tw=null;}
});}
)();
(function(){var a='format',b="short",c="HH:mm",d='_',e="stand-alone",f="HHmmsszz",g="cldr_date_format_",h="HHmm",j="narrow",k="HHmmss",l="qx.debug",m="This case should never happen.",n="cldr_time_format_",o="sat",p="abbreviated",q="wide",r="HH:mm:ss zz",s="full",t="cldr_pm",u="cldr_day_",v="_",w="cldr_month_",x="long",y="wed",z="medium",A="fri",B="cldr_am",C="tue",D="qx.locale.Date",E="mon",F="cldr_date_time_format_",G="sun",H="format",I="thu",J="HH:mm:ss",K='stand-alone';qx.Class.define(D,{statics:{__tL:qx.locale.Manager.getInstance(),getAmMarker:function(L){return this.__tL.localize(B,[],L);}
,getPmMarker:function(M){return this.__tL.localize(t,[],M);}
...
;var Q=[G,E,C,y,I,A,o];var R=[];for(var i=0;i<Q.length;i++ ){var N=u+S+v+length+v+Q[i];R.push(P?this.__tM(S,S===a?K:a,N,O):this.__tL.localize(N,[],O));}
;return R;}
...
;var W=[G,E,C,y,I,A,o];var T=u+U+v+length+v+W[Y];return X?this.__tM(U,U===a?K:a,T,V):this.__tL.localize(T,[],V);}
...
;var bd=[];for(var i=0;i<12;i++ ){var ba=w+be+v+length+v+(i+1);bd.push(bc?this.__tM(be,be===a?K:a,ba,bb):this.__tL.localize(ba,[],bb));}
;return bd;}
...
;var bf=w+bg+v+length+v+(bi+1);return bj?this.__tM(bg,bg===a?K:a,bf,bh):this.__tL.localize(bf,[],bh);}
,getDateFormat:function(bm,bk){if(qx.core.Environment.get(l)){qx.core.Assert.assertInArray(bm,[b,z,x,s]);}
;var bl=g+bm;return this.__tL.localize(bl,[],bk);}
,getDateTimeFormat:function(br,bp,bn){var bq=F+br;var bo=this.__tL.localize(bq,[],bn);if(bo==bq){bo=bp;}
;return bo;}
,getTimeFormat:function(bv,bs){if(qx.core.Environment.get(l)){qx.core.Assert.assertInArray(bv,[b,z,x,s]);}
;var bu=n+bv;var bt=this.__tL.localize(bu,[],bs);if(bt!=bu){return bt;}
...
else {bK=this.__tL.getTerritory()||this.__tL.getLanguage();}
;return bK.toUpperCase();}
,__tM:function(bN,bM,bQ,bP){var bO=this.__tL.localize(bQ,[],bP);if(bO==bQ){var bL=bQ.replace(d+bN+d,d+bM+d);return this.__tL.localize(bL,[],bP);}
else {return bO;}
;}
}});}
)();
(function(){var a='" ',b="qx.ui.progressive.renderer.table.cell.Icon",c="string",d="vertical-align:middle;",e="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",f='<img ',g=">",h="css.alphaimageloaderneeded",i=" style='padding-top:2px;'",j="text-align:center;",k="",l=" title='",m="'",n='src="',o=" width='",p="abstract",q='" style="filter:',r=" height='",s="_identifyImage() is abstract",t="px'",u="qx/static/blank.gif",v="',sizingMethod='scale')";qx.Class.define(b,{type:p,extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);var w=qx.util.AliasManager.getInstance();var x=qx.util.ResourceManager.getInstance();var y=w.resolve(u);this.__yC=x.toUri(y);}
,members:{__yC:null,getBlankImage:function(){return this.__yC;}
,_identifyImage:function(z){throw new Error(s);}
,_getCellStyle:function(A){var B=qx.ui.progressive.renderer.table.cell.Abstract.prototype._getCellStyle.call(this,A)+j+d;return B;}
,_getContentHtml:function(C){var D=[];var E=this.__yD(C);D.push(f);if(qx.core.Environment.get(h)&&/\.png$/i.test(E.url)){D.push(n,this.__yC,q,e,E.url,v,a);}
else {D.push(n,E.url,a);}
;if(E.imageWidth){D.push(o,E.imageWidth,t);}
;if(E.imageHeight){D.push(r,E.imageHeight,t);}
;D.push(i);if(E.tooltip){D.push(l,E.tooltip,m);}
;if(E.extras){D.push(E.extras);}
;D.push(g);return D.join(k);}
,__yD:function(F){var G=this._identifyImage(F);if(G==null||typeof G==c){G={url:G,tooltip:null};}
;if(G.url==null){G.url=this.__yC;}
;return G;}
}});}
)();
(function(){var a="\"",b="  var filters = this.filters.item(loader); ",c="Boolean",d="  this.attributes.setNamedItem(namedItem); ",e="} catch (e) { ",f="var node = this.attributes.getNamedItem('celldata'); ",g="changeTheme",h="qx.ui.progressive.renderer.table.cell.Boolean",i="decoration/table/boolean-true.png",j="var value = node.nodeValue; ",k="}",l="css.alphaimageloaderneeded",m="decoration/table/boolean-false.png",n="{",o="celldata='1' ",p="  node.nodeValue='0'; ",q="'; ",r="qx.dyntheme",s="  this.attributes.setNamedItem(node); ",t="  var loader = 'DXImageTransform.Microsoft.AlphaImageLoader'; ",u="if (value == '0') ",v="celldata='0' ",w="  node.nodeValue='1'; ",x="  this.src='",y="onclick=\"",z="  filters.sizingMethod = 'scale'; ",A="  namedItem.value = node.nodeValue; ",B="var src; ",C="try { ",D="  filters.src='",E="  var namedItem = document.createAttribute('celldata'); ",F="} ",G="else ";qx.Class.define(h,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(){qx.ui.progressive.renderer.table.cell.Icon.call(this);this.__Hj();if(qx.core.Environment.get(r)){qx.theme.manager.Decoration.getInstance().addListener(g,this.__Hj,this);}
;}
,properties:{allowToggle:{check:c,init:false}},members:{__Hh:null,__Hi:null,__wa:null,__wc:null,__wd:null,__we:null,__wf:null,__wg:null,__Hj:function(){var J=qx.util.AliasManager.getInstance();var K=qx.util.ResourceManager.getInstance();var I=J.resolve(i);var H=J.resolve(m);this.__Hh=K.toUri(I);this.__Hi=K.toUri(H);}
,_identifyImage:function(L){var M={imageWidth:11,imageHeight:11};switch(L.cellData){case true:M.url=this.__Hh;M.extras=o;break;case false:M.url=this.__Hi;M.extras=v;break;default:M.url=null;break;};if(this.getAllowToggle()){M.extras+=y+f+j+B+u+n;if(qx.core.Environment.get(l)&&/\.png$/i.test(this.__Hh)){M.extras+=x+this.getBlankImage()+q+t+b+D+this.__Hh+q+z;}
else {M.extras+=x+this.__Hh+q;}
;M.extras+=w+F+G+n;if(qx.core.Environment.get(l)&&/\.png$/i.test(this.__Hi)){M.extras+=x+this.getBlankImage()+q+t+b+D+this.__Hi+q+z;}
else {M.extras+=x+this.__Hi+q;}
;M.extras+=p+k;M.extras+=C+s+e+E+A+d+k+a;}
;return M;}
,_getCellStyle:function(N){var O=qx.ui.progressive.renderer.table.cell.Icon.prototype._getCellStyle.call(this,N);return O;}
},destruct:function(){this.__Hh=this.__Hi=null;if(qx.core.Environment.get(r)){qx.theme.manager.Decoration.getInstance().removeListener(g,this.__Hj,this);}
;}
});}
)();
