...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Separator.88b5570e17e7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="separator-vertical",b="yellow",c="center",d="demobrowser.demo.layout.VBox_Separator",e="green",f="left",g="right",h="main";qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});scroll.add(i);i.add(this.getBox1());i.add(this.getBox2());i.add(this.getBox3());}
,getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,a)).set({decorator:h,backgroundColor:b,allowGrowY:false});j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:e}));j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:e}));j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:e}));return j;}
,getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,a)).set({decorator:h,backgroundColor:b,minWidth:60,allowGrowY:false});k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:e,maxWidth:40,alignX:f}));k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:e,maxWidth:40,alignX:c}));k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:e,maxWidth:40,alignX:g}));return k;}
,getBox3:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,a)).set({decorator:h,backgroundColor:b,allowGrowY:false});var o=new qx.ui.core.Widget().set({decorator:h,backgroundColor:e,marginBottom:10});var n=new qx.ui.core.Widget().set({decorator:h,backgroundColor:e,marginBottom:10,marginTop:20});var m=new qx.ui.core.Widget().set({decorator:h,backgroundColor:e,marginBottom:10});l.add(o);l.add(n);l.add(m);return l;}
}});}
)();
