...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.11e126aa0711.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Se:4,__Sf:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Sf/this.__Se),column:this.__Sf%this.__Se});this.__Sf+=1;}
