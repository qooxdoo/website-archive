...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Flash","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.42c4694827fa.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__cx",c="Flash Player Version",d="right",f="qooxdoo is the best!",g="Message from Flash:",h="execute",i="Simple demo with FlashVars",j="bgcolor",k="demobrowser.demo.widget.Flash",l="demobrowser/demo/flash/TestFlash.swf",m="1) no pop-up or advertising blocker is activated.\n",n="Send to Flash",o="demobrowser/demo/flash/FlashVersion.swf",p="No message.",q="Flash:",r="<b>qooxdoo:</b>",s="__RU",t="__RT",u="__RS",v="demobrowser.demo.widget.Flash.sendMessage",w="demobrowser.demo.widget.Flash.flashReady",x="Couldn't connect to Flash Player! Please make sure that:\n",y="__Fg",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(k,{extend:qx.application.Standalone,members:{__cx:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(i);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cx=this.createWindow();G.add(this.__cx,{top:20,left:20});}
,createWindow:function(){var K=new qx.ui.window.Window(c).set({width:300,height:200,contentPadding:[0,0,0,0]});K.setLayout(new qx.ui.layout.Canvas());K.add(new qx.ui.embed.Flash(o),{edge:0});return K;}
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:A};var M=new qx.ui.embed.Flash(z).set({scale:E,variables:L});M.getContentElement().setParam(j,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(h,function(){this.__cx.open();}
,this);N.add(O);return N;}
,__Fg:null,__RS:null,__RT:null,__RU:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(r).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__RS=new qx.ui.form.TextArea(p);this.__RS.setEnabled(false);Q.add(this.__RS,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__RT=new qx.ui.form.TextArea(f);Q.add(this.__RT,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,d));this.__RU=new qx.ui.form.Button(n);this.__RU.setEnabled(false);this.__RU.addListener(h,function(e){this.__Fg.getFlashElement().sendMessage(this.__RT.getValue());}
,this);S.add(this.__RU);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(q).set({rich:true}));this.__Fg=new qx.ui.embed.Flash(l);this.__Fg.setVariables({init:w});P.add(this.__Fg,{flex:1});return R;}
,sendMessage:function(T){this.__RS.setValue(T);}
,initFlash:function(){if(this.__Fg.getFlashElement().setup){this.__Fg.getFlashElement().setup(v);this.__RU.setEnabled(true);}
else {alert(x+m+a);}
;}
},statics:{__RV:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__RV=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__RV.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__RV.initFlash();}
},destruct:function(){this._disposeObjects(u,t,s,y,b);}
});}
)();
...
(function(){var a="bottom",b="__sX",c="button",d="qx.event.type.Data",f="lastTab",g="barRight",h="beforeChangeSelection",j="qx.debug",k="horizontal",m="changeSelection",n="bar",o="close-button",p="Index should be less than : ",q="tabview",r="vertical",s="page",t="Incompatible child for TabView: ",u="close",v="_applyBarPosition",w="barLeft",x="top",y="right",z="qx.ui.tabview.TabView",A="barTop",B="barBottom",C="pane",D="left",E="firstTab";qx.Class.define(z,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(G){qx.ui.core.Widget.call(this);this.__Dg={top:A,right:g,bottom:B,left:w};this._createChildControl(n);this._createChildControl(C);var F=this.__sX=new qx.ui.form.RadioGroup;F.setWrap(false);F.addListener(m,this._onChangeSelection,this);if(G!=null){this.setBarPosition(G);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":d},properties:{appearance:{refine:true,init:q},barPosition:{check:[D,y,x,a],init:x,apply:v}},members:{__sX:null,_createChildControlImpl:function(J,I){var H;switch(J){case n:H=new qx.ui.container.SlideBar();H.setZIndex(10);this._add(H);break;case C:H=new qx.ui.container.Stack;H.setZIndex(5);this._add(H,{flex:1});break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,J);}
,_getContentPaddingTarget:function(){return this.getChildControl(C);}
,add:function(O){if(qx.core.Environment.get(j)){if(!(O instanceof qx.ui.tabview.Page)){throw new Error(t+O);}
;}
;var K=O.getButton();var L=this.getChildControl(n);var N=this.getChildControl(C);O.exclude();L.add(K);N.add(O);this.__sX.add(K);O.addState(this.__Dg[this.getBarPosition()]);O.addState(f);var M=this.getChildren();if(M[0]==O){O.addState(E);}
else {M[M.length-2].removeState(f);}
;O.addListener(u,this._onPageClose,this);}
,addAt:function(U,P){if(qx.core.Environment.get(j)){if(!(U instanceof qx.ui.tabview.Page)){throw new Error(t+U);}
;}
;var S=this.getChildren();if(!(P==null)&&P>S.length){throw new Error(p+S.length);}
;if(P==null){P=S.length;}
;var R=U.getButton();var Q=this.getChildControl(n);var T=this.getChildControl(C);U.exclude();Q.addAt(R,P);T.addAt(U,P);this.__sX.add(R);U.addState(this.__Dg[this.getBarPosition()]);S=this.getChildren();if(P==S.length-1){U.addState(f);}
;if(S[0]==U){U.addState(E);}
else {S[S.length-2].removeState(f);}
;U.addListener(u,this._onPageClose,this);}
,remove:function(Y){var ba=this.getChildControl(C);var W=this.getChildControl(n);var X=Y.getButton();var bb=ba.getChildren();if(this.getSelection()[0]==Y){var V=bb.indexOf(Y);if(V==0){if(bb[1]){this.setSelection([bb[1]]);}
else {this.resetSelection();}
;}
else {this.setSelection([bb[V-1]]);}
;}
;W.remove(X);ba.remove(Y);this.__sX.remove(X);Y.removeState(this.__Dg[this.getBarPosition()]);if(Y.hasState(E)){Y.removeState(E);if(bb[0]){bb[0].addState(E);}
;}
;if(Y.hasState(f)){Y.removeState(f);if(bb.length>0){bb[bb.length-1].addState(f);}
;}
;Y.removeListener(u,this._onPageClose,this);}
...
,__Dg:null,_applyBarPosition:function(bg,bi){var bd=this.getChildControl(n);var bj=this.getChildControl(C);var bl=bg==D||bg==y;var bm=bg==y||bg==a;var bk=bl?qx.ui.layout.HBox:qx.ui.layout.VBox;var bn=this._getLayout();if(bn&&bn instanceof bk){}
else {this._setLayout(bn=new bk);}
;bn.setReversed(bm);bd.setOrientation(bl?r:k);var bh=this.getChildren();if(bi){var bf=this.__Dg[bi];bd.removeState(bf);bj.removeState(bf);for(var i=0,l=bh.length;i<l;i++ ){bh[i].removeState(bf);}
;}
;if(bg){var be=this.__Dg[bg];bd.addState(be);bj.addState(be);for(var i=0,l=bh.length;i<l;i++ ){bh[i].addState(be);}
;}
;}
,getSelection:function(){var bo=this.__sX.getSelection();var bp=[];for(var i=0;i<bo.length;i++ ){bp.push(bo[i].getUserData(s));}
;return bp;}
,setSelection:function(br){var bq=[];for(var i=0;i<br.length;i++ ){bq.push(br[i].getChildControl(c));}
;this.__sX.setSelection(bq);}
,resetSelection:function(){this.__sX.resetSelection();}
,isSelected:function(bs){var bt=bs.getChildControl(c);return this.__sX.isSelected(bt);}
,isSelectionEmpty:function(){return this.__sX.isSelectionEmpty();}
,getSelectables:function(bv){var bu=this.__sX.getSelectables(bv);var bw=[];for(var i=0;i<bu.length;i++ ){bw.push(bu[i].getUserData(s));}
;return bw;}
,_onChangeSelection:function(e){var bB=this.getChildControl(C);var by=e.getData()[0];var bA=e.getOldData()[0];var bz=[];var bx=[];if(by){bz=[by.getUserData(s)];bB.setSelection(bz);by.focus();this.scrollChildIntoView(by,null,null,false);}
else {bB.resetSelection();}
;if(bA){bx=[bA.getUserData(s)];}
;this.fireDataEvent(m,bz,bx);}
,_onBeforeChangeSelection:function(e){if(!this.fireNonBubblingEvent(h,qx.event.type.Event,[false,true])){e.preventDefault();}
;}
,_onRadioChangeSelection:function(e){var bC=e.getData()[0];if(bC){this.setSelection([bC.getUserData(s)]);}
else {this.resetSelection();}
;}
,_onPageClose:function(e){var bE=e.getTarget();var bD=bE.getButton().getChildControl(o);bD.reset();this.remove(bE);}
},destruct:function(){this._disposeObjects(b);this.__Dg=null;}
});}
)();
...
,__oS:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
(function(){var a="sameDomain",b="Boolean",c="quality",d="_applyVariables",e="low",f="_applyLoop",g="opaque",h="scale",i="_applyAllowScriptAccess",j="showall",k="Map",l="_applyLiveConnect",m="wmode",n="Integer",o="_applyMenu",p="loaded",q="window",r="_applyPlay",s="loop",t="allowScriptAccess",u="qx.debug",v="menu",w="noborder",x="loading",y="qx.event.type.Event",z="swLiveConnect",A="Timeout after: ",B="qx.ui.embed.Flash",C="String",D="_applyId",E="high",F="",G="transparent",H="exactfit",I="play",J="autohigh",K="_applySource",L="appear",M="$$widget",N="medium",O="Invalid parameter 'source'.",P="timeout",Q="_applyMayScript",R="best",S="_applyQuality",T="never",U="_applyScale",V="flash",W="always",X="Invalid parameter 'id'.",Y="noscale",bf="undefined",bg="_applyWmode",bh="autolow",be="mayscript";qx.Class.define(B,{extend:qx.ui.core.Widget,construct:function(bi,bj){qx.ui.core.Widget.call(this);if(qx.core.Environment.get(u)){qx.core.Assert.assertString(bi,O);if(bj){qx.core.Assert.assertString(bj,X);}
;}
;this.setSource(bi);if(bj){this.setId(bj);}
else {this.setId(V+this.toHashCode());}
;this.initQuality();this.initWmode();this.initAllowScriptAccess();this.initLiveConnect();this.addListenerOnce(L,function(){this._checkLoading();this.getContentElement().createFlash();}
,this);}
,events:{"loading":y,"loaded":y,"timeout":y},properties:{source:{check:C,apply:K},id:{check:C,apply:D},quality:{check:[e,bh,J,N,E,R],init:R,nullable:true,apply:S},scale:{check:[j,w,H,Y],nullable:true,apply:U},wmode:{check:[q,g,G],init:g,nullable:true,apply:bg},play:{check:b,nullable:true,apply:r},loop:{check:b,nullable:true,apply:f},mayScript:{check:b,nullable:false,apply:Q},menu:{check:b,nullable:true,apply:o},allowScriptAccess:{check:[a,W,T],init:a,nullable:true,apply:i},liveConnect:{check:b,init:true,nullable:true,apply:l},variables:{init:{},check:k,apply:d},loadTimeout:{check:n,init:10000}},members:{__Fb:null,getFlashElement:function(){var bk=this.getContentElement();if(bk){return bk.getFlashElement();}
else {return null;}
;}
,isLoaded:function(){return this.getPercentLoaded()===100;}
,getPercentLoaded:function(){var bl=this.getFlashElement();if(typeof (bl)!=bf&&bl!=null){try{return bl.PercentLoaded();}
catch(bm){return 0;}
;}
else {return 0;}
;}
,_createContentElement:function(){var bn=new qx.html.Flash();bn.setAttribute(M,this.toHashCode());return bn;}
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__Fb){this.__Fb=new Date().getTime();}
;var bp=new Date().getTime()-this.__Fb;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__Fb=null;}
;}
else {this.fireEvent(p);this.__Fb=null;}
;}
;}
,_applySource:function(bt,bs){var br=qx.util.ResourceManager.getInstance().toUri(bt);this.getContentElement().setSource(br);qx.ui.core.queue.Layout.add(this);}
,_applyId:function(bv,bu){this.getContentElement().setId(bv);qx.ui.core.queue.Layout.add(this);}
,_applyVariables:function(bx,bw){this.getContentElement().setVariables(bx);qx.ui.core.queue.Layout.add(this);}
,_applyMayScript:function(bz,by){this.getContentElement().setAttribute(be,bz?F:false);qx.ui.core.queue.Layout.add(this);}
,_applyQuality:function(bB,bA){this.__Fc(c,bB);}
,_applyScale:function(bD,bC){this.__Fc(h,bD);}
,_applyWmode:function(bF,bE){this.__Fc(m,bF);}
,_applyPlay:function(bH,bG){this.__Fc(I,bH);}
,_applyLoop:function(bJ,bI){this.__Fc(s,bJ);}
,_applyMenu:function(bL,bK){this.__Fc(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__Fc(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__Fc(z,bP);}
,__Fc:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__Fd={};this.__Fe={};this.__Ff={};}
,members:{__Fd:null,__Ff:null,__Fe:null,__Fg:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__Fg=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Fe,this.__Fd);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__Fg){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__Fg){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__Fe;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__Fg){throw new Error(d);}
;this.__Fe=t;}
,getAttributes:function(){return this.__Ff;}
,setAttribute:function(u,v){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(u,g);if(arguments.length>1&&v!==null){if(!qx.lang.Type.isBoolean(v)&&!qx.lang.Type.isString(v)){throw new Error(m);}
;}
;}
;if(u==f||u.indexOf(a)===0){qx.html.Element.prototype.setAttribute.call(this,u,v);}
else if(this.__Fg){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Ff[u];}
else {this.__Ff[u]=v;}
;}
,getParams:function(){return this.__Fd;}
,setParam:function(w,x){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(w,g);if(arguments.length>1&&x!==null){if(!qx.lang.Type.isBoolean(x)&&!qx.lang.Type.isString(x)){throw new Error(m);}
;}
;}
;if(this.__Fg){throw new Error(l);}
;if(x===null||x===undefined){delete this.__Fd[w];}
else {this.__Fd[w]=x;}
;}
,getFlashElement:function(){return this.__Fg;}
},destruct:function(){if(this.__Fg){qx.bom.Flash.destroy(this.__Fg);}
;this.__Fd=this.__Fe=this.__Ff=null;}
});}
)();
(function(){var a="Invalid parameter 'element'.",b="function",c="application/x-shockwave-flash",d='" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" $$widget="',e="param",f='</object>',g="$$widget",h="Invalid parameter 'attributes'.",j="qx.bom.Flash",k="100%",l="Invalid attribute 'movie'.",m='<param name="',n="qx.debug",o="type",p="load",q="name",r="data",s="Invalid attribute 'id'.",t="",u="mshtml",v='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" $$widget="',w='">',x="movie",y="DOM element is null or undefined!",z="DOM element has or is not a flash object!",A="value",B="&",C="engine.name",D='" />',E="beforeunload",F="The parent DOM element isn't in DOM! The External Interface doesn't work in IE!",G='<object id="',H="=",I='" value="',J="undefined",K="object";qx.Class.define(j,{statics:{_flashObjects:{},create:function(O,Q,M,P,L){if(!L){L=window;}
;if(qx.core.Environment.get(n)){qx.core.Assert.assertElement(O,a);qx.core.Assert.assertMap(Q,h);qx.core.Assert.assertString(Q.movie,l);qx.core.Assert.assertString(Q.id,s);if(!qx.dom.Element.isInDom(O,L)){qx.log.Logger.warn(this,F);}
;}
;if(!Q.width){Q.width=k;}
;if(!Q.height){Q.height=k;}
;P=P?qx.lang.Object.clone(P):{};if(!P[x]){P[x]=Q.movie;}
;Q[r]=Q.movie;delete Q.movie;if(M){for(var name in M){if(typeof P.flashvars!=J){P.flashvars+=B+name+H+M[name];}
else {P.flashvars=name+H+M[name];}
;}
;}
;var N=this.__Fm(O,Q,P,L);this._flashObjects[Q.id]=N;return N;}
,destroy:qx.core.Environment.select(C,{"mshtml":function(S,R){S=this.__Fh(S);if(S.readyState==4){this.__Fi(S);}
else {if(!R){R=window;}
;qx.bom.Event.addNativeListener(R,p,function(){qx.bom.Flash.__Fi(S);}
);}
;}
,"default":function(U,T){U=this.__Fh(U);if(U.parentNode){U.parentNode.removeChild(U);}
;delete this._flashObjects[U.id];}
}),__Fh:function(V){if(!V){throw new Error(y);}
;if(V.tagName.toLowerCase()!==K){V=V.firstChild;}
;if(!V||V.tagName.toLowerCase()!==K){throw new Error(z);}
;return V;}
,__Fi:qx.core.Environment.select(C,{"mshtml":qx.event.GlobalError.observeMethod(function(W){for(var i in W){if(typeof W[i]==b){W[i]=null;}
;}
;if(W.parentNode){W.parentNode.removeChild(W);}
;delete this._flashObjects[W.id];}
),"default":null}),__Fj:qx.event.GlobalError.observeMethod(function(){for(var X in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[X]);}
;window.__Fk=function(){}
;window.__Fl=function(){}
;qx.bom.Event.removeNativeListener(window,E,qx.bom.Flash.__Fj);}
),__Fm:qx.core.Environment.select(C,{"mshtml":function(bb,bd,bc,Y){bc.movie=bd.data;delete bd.data;delete bd.classid;var ba=t;for(name in bc){ba+=m+name+I+bc[name]+D;}
;if(bd.id){bb.innerHTML=G+bd.id+d+bd.$$widget+w+ba+f;delete bd.id;}
else {bb.innerHTML=v+bd.$$widget+w+ba+f;}
;for(var name in bd){if(name!=g){bb.firstChild.setAttribute(name,bd[name]);}
;}
;return bb.firstChild;}
,"default":function(bj,bi,bh,be){delete bi.classid;delete bh.movie;var bg=qx.dom.Element.create(K,bi,be);bg.setAttribute(o,c);var bf;for(var name in bh){bf=qx.dom.Element.create(e,{},be);bf.setAttribute(q,name);bf.setAttribute(A,bh[name]);bg.appendChild(bf);}
;bj.appendChild(bg);return bg;}
})},defer:function(bk){if(qx.core.Environment.get(C)==u){qx.bom.Event.addNativeListener(window,E,bk.__Fj);}
;}
});}
)();
(function(){var a="qx.util.TimerManager",b="interval",c="singleton";qx.Class.define(a,{extend:qx.core.Object,type:c,statics:{__Fn:[],__Fo:{},__rS:0},members:{__Fp:false,start:function(g,f,h,d,j){if(!j){j=f||0;}
;var e=(new Date()).getTime()+j;this.self(arguments).__Fo[ ++this.self(arguments).__rS]={callback:g,userData:d||null,expireAt:e,recurTime:f,context:h||this};this.__Fq(e,this.self(arguments).__rS);return this.self(arguments).__rS;}
,stop:function(k){var l=this.self(arguments).__Fn;var length=l.length;for(var i=0;i<length;i++ ){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__Fo[k];if(l.length==0&&this.__Fp){qx.event.Idle.getInstance().removeListener(b,this.__Fr,this);this.__Fp=false;}
;}
,__Fq:function(m,p){var o=this.self(arguments).__Fn;var n=this.self(arguments).__Fo;var length=o.length;for(var i=0;i<length;i++ ){if(n[o[i]].expireAt>m){o.splice(i,0,p);break;}
;}
;if(o.length==length){o.push(p);}
;if(!this.__Fp){qx.event.Idle.getInstance().addListener(b,this.__Fr,this);this.__Fp=true;}
;}
,__Fr:function(){var r=(new Date()).getTime();var t=this.self(arguments).__Fn;var s=this.self(arguments).__Fo;while(t.length>0&&s[t[0]].expireAt<=r){var v=t.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__Fq(q.expireAt,v);}
else {delete s[v];}
;}
;if(t.length==0&&this.__Fp){qx.event.Idle.getInstance().removeListener(b,this.__Fr,this);this.__Fp=false;}
;}
}});}
)();
...
,properties:{wrap:{check:a,init:true,apply:d},appearance:{refine:true,init:i},singleStep:{check:h,init:20},minimalLineHeight:{check:h,apply:g,init:4},autoSize:{check:a,apply:w,init:false}},members:{__oD:null,__oE:null,__oF:null,setValue:function(M){M=qx.ui.form.AbstractField.prototype.setValue.call(this,M);this.__oG();return M;}
...
;}
,__oG:function(){if(this.isAutoSize()){var R=this.__oH();if(R&&this.getBounds()){this.__oF=this.__oF||this._getAreaHeight();var T=this._getScrolledAreaHeight();if(this.getMaxHeight()){var P=this.getInsets();var Q=-P.top+this.getMaxHeight()-P.bottom;if(T>Q){this.getContentElement().setStyle(H,j);}
else {this.getContentElement().setStyle(H,G);}
;}
;var S=Math.max(T,this.__oF);this._setAreaHeight(S);}
else {this.getContentElement().addListenerOnce(x,function(){this.__oG();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(U){if(this._getAreaHeight()!==U){this.__oE=U;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__oK();}
;}
,_getScrolledAreaHeight:function(){var W=this.__oH();var V=W.getDomElement();if(V){if(!V.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;this.__oJ(W);if(qx.core.Environment.get(C)==B&&qx.core.Environment.get(s)==8){if(!V.scrollTop){qx.html.Element.flush();}
;}
;return V.scrollTop;}
;}
,__oH:function(){this.__oD=this.__oD||this.__oI();return this.__oD;}
,__oI:function(){var ba,Y,bb,X;ba=this.getContentElement();if(!ba.getDomElement()){return null;}
;bb=qx.bom.Element.clone(ba.getDomElement());X=new qx.html.Input(i);X.useElement(bb);Y=X;Y.setStyles({position:K,top:0,left:n,height:0,overflow:G},true);Y.removeAttribute(F);Y.removeAttribute(z);Y.setAttribute(y,f);Y.setValue(ba.getValue()||t);Y.insertBefore(ba);this.__oJ(Y);return Y;}
,__oJ:function(bc){bc=bc.getDomElement();if(bc){bc.scrollTop=10000;}
;}
...
,_applyAutoSize:function(bh,bg){if(qx.core.Environment.get(J)){this.__oL();}
;if(bh){this.__oG();this.addListener(o,this.__oG,this);if(!this.getBounds()){this.addListenerOnce(x,function(){this.getContentElement().setStyle(H,G);}
);}
else {this.getContentElement().setStyle(H,G);}
;}
else {this.removeListener(o,this.__oG);this.getContentElement().setStyle(H,j);}
;}
,_applyDimension:function(bi){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(J)){this.__oL();}
;if(bi===this.getMaxHeight()){this.__oG();}
;}
,__oK:function(){var content=this.getContentElement();var bk=content.getDomElement();var bj=content.getStyle(u);content.setStyle(u,parseInt(bj,10)+1000+b,true);if(bk){qx.bom.element.Dimension.getWidth(bk);}
;content.setStyle(u,bj,true);}
,__oL:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(m+I+v);}
;}
,_getContentHint:function(){var bl=qx.ui.form.AbstractField.prototype._getContentHint.call(this);bl.height=bl.height*this.getMinimalLineHeight();bl.width=this._getTextSize().width*20;if(this.isAutoSize()){bl.height=this.__oE||bl.height;}
;return bl;}
},destruct:function(){this.setAutoSize(false);if(this.__oD){this.__oD.dispose();}
;}
});}
)();
