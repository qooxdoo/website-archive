...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover.267cb2d6db39.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(p,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(M){M.__QX=qx.bom.element.Style.get(M,q);M.style.color=b;M.parentNode.style.height=32;M.__QY=M.innerHTML;var N=Date.parse(M.attributes.getNamedItem(c).nodeValue);var L=new Date(N);M.innerHTML=L.toUTCString()+k+L.toString();}
,onmouseout:function(O){O.style.color=O.__QX;O.parentNode.style.height=16;O.innerHTML=O.__QY;}
