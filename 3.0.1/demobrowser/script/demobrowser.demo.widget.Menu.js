...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu.801f2a443600.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Online Forum",b="__Ck",c="New",d="icon/16/actions/edit-cut.png",f="icon/16/actions/format-justify-fill.png",g="Search in files",h="C",j="changeValue",k="Left aligned",l="Undo",m="Perl",n="View",o="C Dialect",p="changeSelection",q="Info...",r="Save as...",s="Show line numbers",t="icon/16/actions/document-save.png",u="Quickstart",v="icon/16/actions/contact-new.png",w="Ctrl+N",x="__Sc",y="__RW",z="icon/16/actions/edit-paste.png",A="Actions",B="Show console",C="Search",D="Help",E="Redo",F="Show status bar",G="icon/16/actions/format-justify-left.png",H="__Cr",I="ANSI to OEM",J="Centered",K="Website 3",L="icon/22/apps/preferences-users.png",M="Edit",N="icon/16/actions/format-justify-center.png",O="Ctrl+O",P="icon/16/actions/document-print.png",Q="__Sb",R="icon/16/actions/go-previous.png",S="icon/16/actions/document-open.png",T="C Sharp",U="icon/16/actions/edit-undo.png",V="Close",W="Split Button",X="Website 2",Y="icon/16/actions/document-save-as.png",cM="Python",cN="icon/16/apps/utilities-help.png",cO="Show tree",cI="Options",cJ="Spaces to tabs",cK="Right aligned",cL="Action 1",cT="OEM to ANSI",cU="Line 431",cV="JavaScript",cW="icon",cP="Action 2",cQ="Folder ",cR="XML",cS="Line 313",db="Save",dD="Paragraph",er="demobrowser.demo.widget.Menu",dc="icon/16/actions/application-exit.png",cX="C Plus Plus",cY="Line 26",en="Item ",da="ASCII table",dd="__Sa",de="Option 1",df="Search next...",dk="Line 12",dl="Action 3",dm="Replace in files",dg="Uppercase",dh="Ctrl+P",di="Topics",dj="Panes",dr="Justified",ds="Ctrl+X",dt="icon/16/actions/edit-redo.png",du="Search previous...",dn="Change selection: ",dp="Back",eo="main",dq="Copy",dy=" = ",dz="Paste",eq="Execute command: ",dA="Show ruler",dv="icon/16/actions/format-justify-right.png",dw="icon/16/actions/go-next.png",ep="Ctrl+Z",dx="command ",dB="Option 3",dC="Next",dO="Ctrl+R",dN="Show macros",dM="Show tags",dS="Capitals",dR="Execute button: ",dQ="Format",dP="File",dH="Change checked: ",dG="Show tabs",dF="__RX",dE="Print",dL="execute",dK="icon/16/actions/edit-copy.png",dJ="Cut",dI="Tabs to spaces",ea="Search...",dY="Line 1039",dX="Option 2",dW="Open",ee="Objective C",ed="Exit",ec="move to",eb="icon/16/actions/system-search.png",dV="Ctrl+S",dU="Syntax",dT="Ctrl+C",ei="Website 1",eh="Menu Button",eg="icon/16/actions/document-new.png",em="Line 30",el="Lowercase",ek="Replace",ej="__RY",ef="HTML";qx.Class.define(er,{extend:qx.application.Standalone,members:{__RW:null,__RX:null,__RY:null,__Ck:null,__Cr:null,__Sa:null,__Sb:null,__Sc:null,main:function(){qx.application.Standalone.prototype.main.call(this);var et=new qx.ui.container.Scroll();var es=new qx.ui.container.Composite(new qx.ui.layout.Canvas);es.setPadding(20);es.setAllowStretchX(false);et.add(es);this.getRoot().add(et,{edge:0});this.createCommands();es.add(this.getMenuButton(),{left:20,top:20});es.add(this.getSplitButton(),{left:150,top:20});es.add(this.getMenuBar(),{left:20,top:100});es.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
...
;eu.add(new qx.ui.menu.Button(ec,null,null,ev));eu.add(new qx.ui.menu.Separator());for(var i=0;i<7;i++ ){eu.add(new qx.ui.menu.Button(dx+(i+1)));}
;return eu;}
,debugRadio:function(e){this.debug(dn+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(eq+this.getShortcut());}
,debugButton:function(e){this.debug(dR+this.getLabel());}
,debugCheckBox:function(e){this.debug(dH+this.getLabel()+dy+e.getData());}
,createCommands:function(){this.__RW=new qx.ui.core.Command(w);this.__RW.addListener(dL,this.debugCommand);this.__RX=new qx.ui.core.Command(O);this.__RX.addListener(dL,this.debugCommand);this.__RY=new qx.ui.core.Command(dV);this.__RY.addListener(dL,this.debugCommand);this.__Ck=new qx.ui.core.Command(ep);this.__Ck.addListener(dL,this.debugCommand);this.__Cr=new qx.ui.core.Command(dO);this.__Cr.addListener(dL,this.debugCommand);this.__Sa=new qx.ui.core.Command(ds);this.__Sa.addListener(dL,this.debugCommand);this.__Sb=new qx.ui.core.Command(dT);this.__Sb.addListener(dL,this.debugCommand);this.__Sc=new qx.ui.core.Command(dh);this.__Sc.addListener(dL,this.debugCommand);this.__Sc.setEnabled(false);}
,getMenuButton:function(){var ew=new qx.ui.menu.Menu;ew.add(new qx.ui.menu.RadioButton(de));ew.add(new qx.ui.menu.RadioButton(dX));ew.add(new qx.ui.menu.RadioButton(dB));var eE=new qx.ui.menu.Menu;eE.add(new qx.ui.menu.RadioButton(cL));eE.add(new qx.ui.menu.RadioButton(cP));eE.add(new qx.ui.menu.RadioButton(dl));var eD=new qx.ui.form.RadioGroup;eD.add.apply(eD,ew.getChildren());eD.addListener(p,this.debugRadio);var eB=new qx.ui.form.RadioGroup;eB.add.apply(eB,eE.getChildren());eB.addListener(p,this.debugRadio);var ez=new qx.ui.menu.Menu();var eC=new qx.ui.menu.Button(l,U,this.__Ck);var eJ=new qx.ui.menu.Button(E,dt,this.__Cr);var ey=new qx.ui.menu.Button(dJ,d,this.__Sa);var eG=new qx.ui.menu.Button(dq,dK,this.__Sb);var eA=new qx.ui.menu.Button(dz,z,this.__Sc);var ex=new qx.ui.menu.Button(cI,eb,null,ew);var eH=new qx.ui.menu.Button(A,v,null,eE);var eF=new qx.ui.menu.Button(dE,P);eC.addListener(dL,this.debugButton);eJ.addListener(dL,this.debugButton);ey.addListener(dL,this.debugButton);eG.addListener(dL,this.debugButton);eA.addListener(dL,this.debugButton);ex.addListener(dL,this.debugButton);eH.addListener(dL,this.debugButton);eF.addListener(dL,this.debugButton);ez.add(eC);ez.add(eJ);ez.addSeparator();ez.add(ey);ez.add(eG);ez.add(eA);ez.addSeparator();ez.add(ex);ez.add(eH);ez.addSeparator();ez.add(eF);var eI=new qx.ui.form.MenuButton(eh,L,ez);return eI;}
,getSplitButton:function(){var eK=new qx.ui.menu.Menu;var eO=new qx.ui.menu.Button(ei);var eM=new qx.ui.menu.Button(X);var eN=new qx.ui.menu.Button(K);eK.setMinWidth(120);eO.addListener(dL,this.debugButton);eM.addListener(dL,this.debugButton);eN.addListener(dL,this.debugButton);eK.add(eO);eK.add(eM);eK.add(eN);var eL=new qx.ui.form.SplitButton(W,L,eK);eL.addListener(dL,this.debugButton);return eL;}
,getMenuBar:function(){var eS=new qx.ui.container.Composite(new qx.ui.layout.Grow);eS.setDecorator(eo);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);eS.add(toolbar);var fc=new qx.ui.toolbar.Part;var eR=new qx.ui.toolbar.Part;var eV=new qx.ui.toolbar.Part;toolbar.add(fc);toolbar.add(eR);toolbar.addSpacer();toolbar.add(eV);var fb=new qx.ui.toolbar.SplitButton(dp,R,this.getBackMenu());var fe=new qx.ui.toolbar.SplitButton(dC,dw,this.getForwardMenu());var eW=new qx.ui.toolbar.Button(c,eg,this.__RW);var eU=new qx.ui.toolbar.Button(dW,S,this.__RX);var fa=new qx.ui.toolbar.Button(db,t,this.__RY);fb.addListener(dL,this.debugButton);fe.addListener(dL,this.debugButton);eW.addListener(dL,this.debugButton);eU.addListener(dL,this.debugButton);fa.addListener(dL,this.debugButton);fc.add(fb);fc.add(fe);fc.addSeparator();fc.add(eW);fc.add(eU);fc.add(fa);fc.setShow(cW);var eT=new qx.ui.toolbar.MenuButton(dP);var eP=new qx.ui.toolbar.MenuButton(M);var eQ=new qx.ui.toolbar.MenuButton(C);var fd=new qx.ui.toolbar.MenuButton(n);var eY=new qx.ui.toolbar.MenuButton(dQ);eT.setMenu(this.getFileMenu());eP.setMenu(this.getEditMenu());eQ.setMenu(this.getSearchMenu());fd.setMenu(this.getViewMenu());eY.setMenu(this.getFormatMenu());eR.add(eT);eR.add(eP);eR.add(eQ);eR.add(fd);eR.add(eY);var eX=new qx.ui.toolbar.MenuButton(D);eX.setMenu(this.getHelpMenu());eV.add(eX);return eS;}
,getBackMenu:function(){var fg=new qx.ui.menu.Menu;var fh=new qx.ui.menu.Button(cS);var fj=new qx.ui.menu.Button(dY);var ff=new qx.ui.menu.Button(dk);var fi=new qx.ui.menu.Button(cY);fh.addListener(dL,this.debugButton);fj.addListener(dL,this.debugButton);ff.addListener(dL,this.debugButton);fi.addListener(dL,this.debugButton);fg.add(fh);fg.add(fj);fg.add(ff);fg.add(fi);return fg;}
...
,getFileMenu:function(){var fp=new qx.ui.menu.Menu;var fn=new qx.ui.menu.Button(c,eg,this.__RW);var fr=new qx.ui.menu.Button(dW,S,this.__RX);var fq=new qx.ui.menu.Button(V);var fu=new qx.ui.menu.Button(db,t,this.__RY);var ft=new qx.ui.menu.Button(r,Y);var fo=new qx.ui.menu.Button(dE,P);var fs=new qx.ui.menu.Button(ed,dc);fn.addListener(dL,this.debugButton);fr.addListener(dL,this.debugButton);fq.addListener(dL,this.debugButton);fu.addListener(dL,this.debugButton);ft.addListener(dL,this.debugButton);fo.addListener(dL,this.debugButton);fs.addListener(dL,this.debugButton);fp.add(fn);fp.add(fr);fp.add(fq);fp.add(fu);fp.add(ft);fp.add(fo);fp.add(fs);return fp;}
,getEditMenu:function(){var fw=new qx.ui.menu.Menu;var fz=new qx.ui.menu.Button(l,U,this.__Ck);var fy=new qx.ui.menu.Button(E,dt,this.__Cr);var fv=new qx.ui.menu.Button(dJ,d,this.__Sa);var fA=new qx.ui.menu.Button(dq,dK,this.__Sb);var fx=new qx.ui.menu.Button(dz,z,this.__Sc);fz.addListener(dL,this.debugButton);fy.addListener(dL,this.debugButton);fv.addListener(dL,this.debugButton);fA.addListener(dL,this.debugButton);fx.addListener(dL,this.debugButton);fw.add(fz);fw.add(fy);fw.addSeparator();fw.add(fv);fw.add(fA);fw.add(fx);return fw;}
...
,getViewMenu:function(){var fI=new qx.ui.menu.Menu;var fK=new qx.ui.menu.Button(dj,null,null,this.getPanesMenu());var fN=new qx.ui.menu.Button(dU,null,null,this.getSyntaxMenu());var fM=new qx.ui.menu.CheckBox(dA);var fL=new qx.ui.menu.CheckBox(s);var fJ=new qx.ui.menu.Button(da);fM.addListener(j,this.debugCheckBox);fL.addListener(j,this.debugCheckBox);fJ.addListener(dL,this.debugButton);fI.add(fK);fI.add(fN);fI.addSeparator();fI.add(fM);fI.add(fL);fI.addSeparator();fI.add(fJ);return fI;}
,getPanesMenu:function(){var fP=new qx.ui.menu.Menu;var fR=new qx.ui.menu.CheckBox(dG);var fO=new qx.ui.menu.CheckBox(F);var fU=new qx.ui.menu.CheckBox(cO);var fQ=new qx.ui.menu.CheckBox(dN);var fS=new qx.ui.menu.CheckBox(dM);var fT=new qx.ui.menu.CheckBox(B);fR.setValue(true);fO.setValue(true);fQ.setValue(true);fR.addListener(j,this.debugCheckBox);fO.addListener(j,this.debugCheckBox);fU.addListener(j,this.debugCheckBox);fQ.addListener(j,this.debugCheckBox);fS.addListener(j,this.debugCheckBox);fT.addListener(j,this.debugCheckBox);fP.add(fO);fP.add(fR);fP.addSeparator();fP.add(fU);fP.add(fQ);fP.add(fS);fP.add(fT);return fP;}
,getSyntaxMenu:function(){var ga=new qx.ui.menu.Menu;var fV=new qx.ui.menu.RadioButton(ef);var fX=new qx.ui.menu.RadioButton(cR);var fW=new qx.ui.menu.RadioButton(cV);var fY=new qx.ui.menu.Button(o,null,null,this.getSyntaxCMenu());var gd=new qx.ui.menu.RadioButton(m);var gb=new qx.ui.menu.RadioButton(cM);ga.add(fV);ga.add(fX);ga.add(fW);ga.add(fY);ga.add(gd);ga.add(gb);var gc=new qx.ui.form.RadioGroup;gc.add(fV,fX,fW,gd,gb);gc.add.apply(gc,fY.getMenu().getChildren());gc.addListener(p,this.debugRadio);return ga;}
,getSyntaxCMenu:function(){var gf=new qx.ui.menu.Menu;var ge=new qx.ui.menu.RadioButton(h);var gi=new qx.ui.menu.RadioButton(T);var gg=new qx.ui.menu.RadioButton(ee);var gh=new qx.ui.menu.RadioButton(cX);gf.add(ge);gf.add(gi);gf.add(gg);gf.add(gh);return gf;}
,getFormatMenu:function(){var gm=new qx.ui.menu.Menu;var gl=new qx.ui.menu.Button(dD,null,null,this.getParagraphMenu());var go=new qx.ui.menu.Button(dI);var gp=new qx.ui.menu.Button(cJ);var gk=new qx.ui.menu.Button(dg);var gn=new qx.ui.menu.Button(el);var gj=new qx.ui.menu.Button(dS);var gr=new qx.ui.menu.Button(cT);var gq=new qx.ui.menu.Button(I);go.addListener(dL,this.debugButton);gp.addListener(dL,this.debugButton);gk.addListener(dL,this.debugButton);gn.addListener(dL,this.debugButton);gj.addListener(dL,this.debugButton);gr.addListener(dL,this.debugButton);gq.addListener(dL,this.debugButton);gm.add(gl);gm.add(go);gm.add(gp);gm.addSeparator();gm.add(gk);gm.add(gn);gm.add(gj);gm.addSeparator();gm.add(gr);gm.add(gq);return gm;}
,getParagraphMenu:function(){var gs=new qx.ui.menu.Menu;var gw=new qx.ui.menu.Button(k,G);var gv=new qx.ui.menu.Button(cK,dv);var gt=new qx.ui.menu.Button(J,N);var gu=new qx.ui.menu.Button(dr,f);gw.addListener(dL,this.debugButton);gv.addListener(dL,this.debugButton);gt.addListener(dL,this.debugButton);gu.addListener(dL,this.debugButton);gs.add(gw);gs.add(gv);gs.add(gt);gs.add(gu);return gs;}
,getHelpMenu:function(){var gx=new qx.ui.menu.Menu;var gz=new qx.ui.menu.Button(di,cN);var gB=new qx.ui.menu.Button(u);var gA=new qx.ui.menu.Button(a);var gy=new qx.ui.menu.Button(q);gz.addListener(dL,this.debugButton);gB.addListener(dL,this.debugButton);gA.addListener(dL,this.debugButton);gy.addListener(dL,this.debugButton);gx.add(gz);gx.add(gB);gx.addSeparator();gx.add(gA);gx.addSeparator();gx.add(gy);return gx;}
,getList:function(){var gC=new qx.ui.form.List;gC.setContextMenu(this.getContextMenu());for(var i=0;i<20;i++ ){gC.add(new qx.ui.form.ListItem(en+i));}
;return gC;}
,getContextMenu:function(){var gD=new qx.ui.menu.Menu;var gF=new qx.ui.menu.Button(dJ,d,this.__Sa);var gG=new qx.ui.menu.Button(dq,dK,this.__Sb);var gE=new qx.ui.menu.Button(dz,z,this.__Sc);gF.addListener(dL,this.debugButton);gG.addListener(dL,this.debugButton);gE.addListener(dL,this.debugButton);gD.add(gF);gD.add(gG);gD.add(gE);return gD;}
},destruct:function(){this._disposeObjects(y,dF,ej,b,H,dd,Q,x);}
});}
)();
...
;this.__sJ();}
,__sJ:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__sK:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(o,this.__sK,this);return;}
...
;this.__sI=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__sI){this.__sI.call(this);delete this.__sI;}
;}
...
;this.__sK();}
;}
,_onMouseOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__sH=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__sH){bt.cancelOpen(this.__sH);this.__sH=null;}
;}
;}
...
;if(this.__sH){bw.cancelOpen(this.__sH);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__sL:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__sL=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__sL||null;}
...
(function(){var a="blur",b="mousedown",c="Enter",d="__ll",f="Escape",g="Space",h="keydown",j="Left",k="Down",l="Up",m="singleton",n="mousewheel",o="interval",p="event.touch",q="__sD",r="Object is no menu: ",s="__sC",t="qx.ui.menu.Manager",u="keyup",v="keypress",w="Right",x="qx.debug";qx.Class.define(t,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__ll=[];var y=document.body;var z=qx.event.Registration;z.addListener(window.document.documentElement,b,this._onMouseDown,this,true);z.addListener(y,n,this._onMouseWheel,this,true);z.addListener(y,h,this._onKeyUpDown,this,true);z.addListener(y,u,this._onKeyUpDown,this,true);z.addListener(y,v,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__sC=new qx.event.Timer;this.__sC.addListener(o,this._onOpenInterval,this);this.__sD=new qx.event.Timer;this.__sD.addListener(o,this._onCloseInterval,this);}
,members:{__sE:null,__sF:null,__sC:null,__sD:null,__ll:null,_getChild:function(A,C,B,F){var E=A.getChildren();var length=E.length;var D;for(var i=C;i<length&&i>=0;i+=B){D=E[i];if(D.isEnabled()&&!D.isAnonymous()&&D.isVisible()){return D;}
;}
...
;G=G.getLayoutParent();}
;return false;}
,_isMenuOpener:function(I){var H=this.__ll;for(var i=0;i<H.length;i++ ){if(H[i].getOpener()===I){return true;}
;}
;return false;}
,_getMenuButton:function(J){while(J){if(J instanceof qx.ui.menu.AbstractButton){return J;}
;J=J.getLayoutParent();}
;return null;}
,add:function(K){if(qx.core.Environment.get(x)){if(!(K instanceof qx.ui.menu.Menu)){throw new Error(r+K);}
;}
;var L=this.__ll;L.push(K);K.setZIndex(1e6+L.length);}
,remove:function(M){if(qx.core.Environment.get(x)){if(!(M instanceof qx.ui.menu.Menu)){throw new Error(r+M);}
;}
;var N=this.__ll;if(N){qx.lang.Array.remove(N,M);}
;}
,hideAll:function(){var O=this.__ll;if(O){for(var i=O.length-1;i>=0;i-- ){O[i].exclude();}
;}
;}
,getActiveMenu:function(){var P=this.__ll;return P.length>0?P[P.length-1]:null;}
,scheduleOpen:function(Q){this.cancelClose(Q);if(Q.isVisible()){if(this.__sE){this.cancelOpen(this.__sE);}
;}
else if(this.__sE!=Q){this.__sE=Q;this.__sC.restartWith(Q.getOpenInterval());}
;}
,scheduleClose:function(R){this.cancelOpen(R);if(!R.isVisible()){if(this.__sF){this.cancelClose(this.__sF);}
;}
else if(this.__sF!=R){this.__sF=R;this.__sD.restartWith(R.getCloseInterval());}
;}
,cancelOpen:function(S){if(this.__sE==S){this.__sC.stop();this.__sE=null;}
;}
,cancelClose:function(T){if(this.__sF==T){this.__sD.stop();this.__sF=null;}
;}
,_onOpenInterval:function(e){this.__sC.stop();this.__sE.open();this.__sE=null;}
,_onCloseInterval:function(e){this.__sD.stop();this.__sF.exclude();this.__sF=null;}
...
;if(this.__ll.length>0&&!this._isInMenu(U)){this.hideAll();}
;}
,__sG:{"Enter":1,"Space":1},__pK:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var V=this.getActiveMenu();if(!V){return;}
;var W=e.getKeyIdentifier();if(this.__pK[W]||(this.__sG[W]&&V.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var ba=this.getActiveMenu();if(!ba){return;}
;var X=e.getKeyIdentifier();var bc=this.__pK[X];var Y=this.__sG[X];if(bc){switch(X){case l:this._onKeyPressUp(ba);break;case k:this._onKeyPressDown(ba);break;case j:this._onKeyPressLeft(ba);break;case w:this._onKeyPressRight(ba);break;case f:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(Y){var bb=ba.getSelectedButton();if(bb){switch(X){case c:this._onKeyPressEnter(ba,bb,e);break;case g:this._onKeyPressSpace(ba,bb,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
...
;var x=this.__sM(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__sM:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__sU(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__sR.length>0){do {var Q=this.__sR[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__sR.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__sT(Q);G+=I;if(E&&this.__sR.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__sR.length>0);}
;}
,__sT:function(R){R.setVisibility(o);this.__sR.shift();this.fireDataEvent(m,R);}
,__sU:function(S){if(!S){return;}
;this.__sR.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__sS.length-1;i>=0;i-- ){var T=this.__sS[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__sS[W]!=undefined){throw new Error(v);}
;this.__sS[W]=X;}
...
;for(var i=0;i<this.__sR.length;i++ ){this.__sR[i].setVisibility(o);}
;this.__sR=[];}
;}
...
;bf.setVisibility(y);}
;}
,__sV:false,_setAllowMenuOpenHover:function(bg){this.__sV=bg;}
,_isAllowMenuOpenHover:function(){return this.__sV;}
...
,properties:{appearance:{refine:true,init:p},show:{init:o,check:[o,e,d],inheritable:true,event:m},spacing:{nullable:true,check:a,themeable:true,apply:n}},members:{_createChildControlImpl:function(t,s){var r;switch(t){case f:r=new qx.ui.basic.Image();r.setAlignY(b);this._add(r);break;case h:r=new qx.ui.toolbar.PartContainer();r.addListener(j,this.__sW,this);this._add(r);break;};return r||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,t);}
,getChildrenContainer:function(){return this.getChildControl(h);}
,_applySpacing:function(w,u){var v=this.getChildControl(h).getLayout();w==null?v.resetSpacing():v.setSpacing(w);}
,__sW:function(){var x=this.getChildrenContainer().getChildren();x=x.filter(function(y){return y.getVisibility()==k;}
);for(var i=0;i<x.length;i++ ){if(i==0&&i!=x.length-1){x[i].addState(g);x[i].removeState(q);x[i].removeState(b);}
else if(i==x.length-1&&i!=0){x[i].addState(q);x[i].removeState(g);x[i].removeState(b);}
else if(i==0&&i==x.length-1){x[i].removeState(g);x[i].removeState(b);x[i].removeState(q);}
else {x[i].addState(b);x[i].removeState(q);x[i].removeState(g);}
;}
;}
,addSeparator:function(){this.add(new qx.ui.toolbar.Separator);}
...
(function(){var a="toolbar/part/container",b="icon",c="changeShow",d="qx.ui.toolbar.PartContainer",e="label",f="both";qx.Class.define(d,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this._setLayout(new qx.ui.layout.HBox);}
,properties:{appearance:{refine:true,init:a},show:{init:f,check:[f,e,b],inheritable:true,event:c}}});}
)();
...
(function(){var a="__ju",b="hovered",c="hover-button",d="interval",f="mouseover",g="mouseout",h="qx.ui.form.HoverButton",i="Integer";qx.Class.define(h,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(f,this._onMouseOver,this);this.addListener(g,this._onMouseOut,this);this.__ju=new qx.event.AcceleratingTimer();this.__ju.addListener(d,this._onInterval,this);}
,properties:{appearance:{refine:true,init:c},interval:{check:i,init:80},firstInterval:{check:i,init:200},minTimer:{check:i,init:20},timerDecrease:{check:i,init:2}},members:{__ju:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__ju.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(b);}
,_onMouseOut:function(e){this.__ju.stop();this.removeState(b);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
(function(){var b="-",c="PageUp",d="Escape",f="Boolean",g="+",h="qx.event.type.Data",j="_applyShortcut",k="PrintScreen",l="NumLock",m="short",n="keydown",o="5",p="8",q="execute",r="Meta",s="0",t="",u="2",v="Control",w="Shift",x="You can only specify one non modifier key!",y="3",z="Unidentified",A="/",B="Delete",C="String",D="changeEnabled",E="*",F="qx.bom.Shortcut",G="6",H="4",I="1",J="Alt",K="Not a valid key name for a shortcut: ",L="PageDown",M="Whitespaces are not allowed within shortcuts",N="_applyEnabled",O="keypress",P="7",Q="a",R="z",S="9";qx.Class.define(F,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__zI={};this.__zJ=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":h},properties:{enabled:{init:true,check:f,event:D,apply:N},shortcut:{check:C,apply:j,nullable:true},autoRepeat:{check:f,init:false}},members:{__zI:t,__zJ:t,execute:function(U){this.fireDataEvent(q,U);}
,__zK:function(event){if(this.getEnabled()&&this.__zL(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__ik:function(event){if(this.getEnabled()&&this.__zL(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(W,V){if(W){qx.event.Registration.addListener(document.documentElement,n,this.__zK,this);qx.event.Registration.addListener(document.documentElement,O,this.__ik,this);}
else {qx.event.Registration.removeListener(document.documentElement,n,this.__zK,this);qx.event.Registration.removeListener(document.documentElement,O,this.__ik,this);}
;}
,_applyShortcut:function(bb,Y){if(bb){if(bb.search(/[\s]+/)!=-1){var bc=M;this.error(bc);throw new Error(bc);}
;this.__zI={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__zJ=null;var X;var a=[];while(bb.length>0&&X!=-1){X=bb.search(/[-+]+/);a.push((bb.length==1||X==-1)?bb:bb.substring(0,X));bb=bb.substring(X+1);}
;var ba=a.length;for(var i=0;i<ba;i++ ){var bd=this.__zN(a[i]);switch(bd){case v:case w:case r:case J:this.__zI[bd]=true;break;case z:var bc=K+a[i];this.error(bc);throw bc;default:if(this.__zJ){var bc=x;this.error(bc);throw bc;}
;this.__zJ=bd;};}
;}
;return true;}
,__zL:function(e){var be=this.__zJ;if(!be){return false;}
;if((!this.__zI.Shift&&e.isShiftPressed())||(this.__zI.Shift&&!e.isShiftPressed())||(!this.__zI.Control&&e.isCtrlPressed())||(this.__zI.Control&&!e.isCtrlPressed())||(!this.__zI.Meta&&e.isMetaPressed())||(this.__zI.Meta&&!e.isMetaPressed())||(!this.__zI.Alt&&e.isAltPressed())||(this.__zI.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__zM:{esc:d,ctrl:v,print:k,del:B,pageup:c,pagedown:L,numlock:l,numpad_0:s,numpad_1:I,numpad_2:u,numpad_3:y,numpad_4:H,numpad_5:o,numpad_6:G,numpad_7:P,numpad_8:p,numpad_9:S,numpad_divide:A,numpad_multiply:E,numpad_minus:b,numpad_plus:g},__zN:function(bg){var bf=qx.event.util.Keyboard;var bh=z;if(bf.isValidKeyIdentifier(bg)){return bg;}
;if(bg.length==1&&bg>=Q&&bg<=R){return bg.toUpperCase();}
;bg=bg.toLowerCase();var bh=this.__zM[bg]||qx.lang.String.firstUp(bg);if(bf.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bj=this.__zJ;var bk=[];for(var bi in this.__zI){if(this.__zI[bi]){bk.push(qx.locale.Key.getKeyName(m,bi));}
;}
;if(bj){bk.push(qx.locale.Key.getKeyName(m,bj));}
;return bk.join(g);}
},destruct:function(){this.setEnabled(false);this.__zI=this.__zJ=null;}
});}
)();
...
(function(){var a=" array contains ",b="qx.ui.core.MSingleSelectionHandling",c=" items!",d="changeSelection",f="__ge",g="changeSelected",h="Could only select one item, but the selection",i="qx.event.type.Data";qx.Mixin.define(b,{events:{"changeSelection":i},members:{__ge:null,getSelection:function(){var j=this.__oM().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__oM().setSelected(k[0]);break;default:throw new Error(h+a+k.length+c);};}
,resetSelection:function(){this.__oM().resetSelected();}
,isSelected:function(l){return this.__oM().isSelected(l);}
,isSelectionEmpty:function(){return this.__oM().isSelectionEmpty();}
,getSelectables:function(m){return this.__oM().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(d,o,n);}
,__oM:function(){if(this.__ge==null){var p=this;this.__ge=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
,isItemSelectable:function(q){if(p._isItemSelectable){return p._isItemSelectable(q);}
else {return q.isVisible();}
;}
});this.__ge.addListener(g,this._onChangeSelected,this);}
;this.__ge.setAllowEmptySelection(this._isAllowEmptySelection());return this.__ge;}
},destruct:function(){this._disposeObjects(f);}
});}
)();
(function(){var a=", because it is not a child element!",b="__oN",c=" because it is not a child element!",d="Boolean",e="__oO",f="qx.ui.core.SingleSelectionManager",g="qx.debug",h="Invalid selectionProvider!",j="Could not check if ",k=" is selected,",l="Could not select ",m="changeSelected",n="qx.event.type.Data",o="__oP";qx.Class.define(f,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(g)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,h);}
;this.__oN=p;}
,events:{"changeSelected":n},properties:{allowEmptySelection:{check:d,init:true,apply:o}},members:{__oO:null,__oN:null,getSelected:function(){return this.__oO;}
,setSelected:function(q){if(!this.__oR(q)){throw new Error(l+q+a);}
;this.__oQ(q);}
,resetSelected:function(){this.__oQ(null);}
,isSelected:function(r){if(!this.__oR(r)){throw new Error(j+r+k+c);}
;return this.__oO===r;}
,isSelectionEmpty:function(){return this.__oO==null;}
,getSelectables:function(t){var s=this.__oN.getItems();var u=[];for(var i=0;i<s.length;i++ ){if(this.__oN.isItemSelectable(s[i])){u.push(s[i]);}
;}
;if(!t){for(var i=u.length-1;i>=0;i-- ){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__oP:function(w,v){if(!w){this.__oQ(this.__oO);}
;}
,__oQ:function(x){var A=this.__oO;var y=x;if(y!=null&&A===y){return;}
;if(!this.isAllowEmptySelection()&&y==null){var z=this.getSelectables(true)[0];if(z){y=z;}
;}
;this.__oO=y;this.fireDataEvent(m,y,A);}
,__oR:function(B){var C=this.__oN.getItems();for(var i=0;i<C.length;i++ ){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__oN.toHashCode){this._disposeObjects(b);}
else {this.__oN=null;}
...
(function(){var a="Could not set the model selection. Maybe your models are not unique? ",b="__pi",c="qx.ui.form.MModelSelection",d="Please use an array as parameter.",f="change",g="qx.debug",h="changeSelection",k="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this.__pi=new qx.data.Array();this.__pi.addListener(f,this.__pl,this);this.addListener(h,this.__pk,this);}
,events:{changeModelSelection:k},members:{__pi:null,__pj:false,__pk:function(){if(this.__pj){return;}
...
;}
;}
,__pl:function(){this.__pj=true;var r=this.getSelectables(true);var s=[];var q=this.__pi.toArray();for(var i=0;i<q.length;i++ ){var u=q[i];for(var j=0;j<r.length;j++ ){var v=r[j];var p=v.getModel?v.getModel():null;if(u===p){s.push(v);break;}
;}
;}
;this.setSelection(s);this.__pj=false;var t=this.getSelection();if(!qx.lang.Array.equals(t,s)){this.__pk();}
;}
,getModelSelection:function(){return this.__pi;}
,setModelSelection:function(w){if(!w){this.__pi.removeAll();return;}
;if(qx.core.Environment.get(g)){this.assertArray(w,d);}
;w.unshift(this.__pi.getLength());w.unshift(0);var x=this.__pi.splice.apply(this.__pi,w);x.dispose();}
},destruct:function(){this._disposeObjects(b);}
});}
)();
...
;}
,remove:function(w){var x=this.__rx;if(qx.lang.Array.contains(x,w)){qx.lang.Array.remove(x,w);if(w.getGroup()===this){w.resetGroup();}
...
;}
,_applyInvalidMessage:function(A,z){for(var i=0;i<this.__rx.length;i++ ){this.__rx[i].setInvalidMessage(A);}
;}
,_applyValid:function(C,B){for(var i=0;i<this.__rx.length;i++ ){this.__rx[i].setValid(C);}
;}
,_applyEnabled:function(F,E){var D=this.__rx;if(F==null){for(var i=0,l=D.length;i<l;i++ ){D[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var J=this.getSelection()[0];var K=this.__rx;var I=K.indexOf(J);if(I==-1){return;}
...
,selectPrevious:function(){var M=this.getSelection()[0];var N=this.__rx;var L=N.indexOf(M);if(L==-1){return;}
...
,_isItemSelectable:function(O){return this.__rx.indexOf(O)!=-1;}
,__oS:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
...
;}
,properties:{appearance:{refine:true,init:a},focusable:{refine:true,init:true},label:{apply:z,nullable:true,check:p},icon:{check:p,apply:v,nullable:true,themeable:true},show:{init:k,check:[k,w,q],themeable:true,inheritable:true,apply:x,event:f},menu:{check:u,nullable:true,apply:n,event:y}},members:{__sB:null,_createChildControlImpl:function(H,G){var F;switch(H){case l:F=new qx.ui.form.Button;F.addListener(m,this._onButtonExecute,this);F.setFocusable(false);this._addAt(F,0,{flex:1});break;case o:F=new qx.ui.form.MenuButton;F.setFocusable(false);this._addAt(F,1);break;};return F||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
...
,_onMouseOver:function(e){e.stopPropagation();this.addState(b);delete this.__sB;}
...
;var T=this.getMenu();if(T&&T.isVisible()){this.__sB=true;return;}
;this.removeState(b);}
...
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__sB){this.removeState(b);}
;}
}});}
)();
...
(function(){var a="vertical",b="under",c="above",d="qx.ui.core.selection.Widget",e="left",f="right";qx.Class.define(d,{extend:qx.ui.core.selection.Abstract,construct:function(g){qx.ui.core.selection.Abstract.call(this);this.__lo=g;}
,members:{__lo:null,_isSelectable:function(h){return this._isItemSelectable(h)&&h.getLayoutParent()===this.__lo;}
,_selectableToHashCode:function(j){return j.$$hash;}
,_styleSelectable:function(k,m,n){n?k.addState(m):k.removeState(m);}
,_capture:function(){this.__lo.capture();}
,_releaseCapture:function(){this.__lo.releaseCapture();}
,_isItemSelectable:function(o){if(this._userInteraction){return o.isVisible()&&o.isEnabled();}
else {return o.isVisible();}
;}
,_getWidget:function(){return this.__lo;}
,_getLocation:function(){var p=this.__lo.getContentElement().getDomElement();return p?qx.bom.element.Location.get(p):null;}
,_getDimension:function(){return this.__lo.getInnerSize();}
...
,_scrollItemIntoView:function(w){this.__lo.scrollChildIntoView(w);}
,getSelectables:function(x){var y=false;if(!x){y=this._userInteraction;this._userInteraction=true;}
;var B=this.__lo.getChildren();var z=[];var A;for(var i=0,l=B.length;i<l;i++ ){A=B[i];if(this._isItemSelectable(A)){z.push(A);}
;}
;this._userInteraction=y;return z;}
,_getSelectableRange:function(C,D){if(C===D){return [C];}
;var H=this.__lo.getChildren();var E=[];var G=false;var F;for(var i=0,l=H.length;i<l;i++ ){F=H[i];if(F===C||F===D){if(G){E.push(F);break;}
else {G=true;}
;}
;if(G&&this._isItemSelectable(F)){E.push(F);}
;}
;return E;}
,_getFirstSelectable:function(){var I=this.__lo.getChildren();for(var i=0,l=I.length;i<l;i++ ){if(this._isItemSelectable(I[i])){return I[i];}
;}
;return null;}
,_getLastSelectable:function(){var J=this.__lo.getChildren();for(var i=J.length-1;i>0;i-- ){if(this._isItemSelectable(J[i])){return J[i];}
;}
;return null;}
,_getRelatedSelectable:function(N,O){var L=this.__lo.getOrientation()===a;var P=this.__lo.getChildren();var K=P.indexOf(N);var M;if((L&&O===c)||(!L&&O===e)){for(var i=K-1;i>=0;i-- ){M=P[i];if(this._isItemSelectable(M)){return M;}
;}
;}
...
(function(){var a="mousedown",b="Boolean",c="one",d="qx.event.type.Data",f=", because it is not a child element!",g="_applyDragSelection",h="Could not add + ",j="mousemove",k="changeSelection",l="Could not test if ",m="Could not remove ",n="addItem",o=" from selection, because it is not a child element!",p="multi",q="_applyQuickSelection",r="single",s="mouseover",t="__ge",u=" is selected, because it is not a child element!",v="_applySelectionMode",w="additive",x="mouseup",y="keypress",z="losecapture",A="Could not select ",B="removeItem",C=" to selection, because it is not a child element!",D="qx.ui.core.MMultiSelectionHandling";qx.Mixin.define(D,{construct:function(){var F=this.SELECTION_MANAGER;var E=this.__ge=new F(this);this.addListener(a,E.handleMouseDown,E);this.addListener(x,E.handleMouseUp,E);this.addListener(s,E.handleMouseOver,E);this.addListener(j,E.handleMouseMove,E);this.addListener(z,E.handleLoseCapture,E);this.addListener(y,E.handleKeyPress,E);this.addListener(n,E.handleAddItem,E);this.addListener(B,E.handleRemoveItem,E);E.addListener(k,this._onSelectionChange,this);}
,events:{"changeSelection":d},properties:{selectionMode:{check:[r,p,w,c],init:r,apply:v},dragSelection:{check:b,init:false,apply:g},quickSelection:{check:b,init:false,apply:q}},members:{__ge:null,selectAll:function(){this.__ge.selectAll();}
,isSelected:function(G){if(!qx.ui.core.Widget.contains(this,G)){throw new Error(l+G+u);}
;return this.__ge.isItemSelected(G);}
...
;this.__ge.removeItem(I);}
,selectRange:function(J,K){this.__ge.selectItemRange(J,K);}
,resetSelection:function(){this.__ge.clearSelection();}
...
else {var M=this.getSelection();if(!qx.lang.Array.equals(M,L)){this.__ge.replaceSelection(L);}
;}
;}
,getSelection:function(){return this.__ge.getSelection();}
,getSortedSelection:function(){return this.__ge.getSortedSelection();}
,isSelectionEmpty:function(){return this.__ge.isSelectionEmpty();}
,getSelectionContext:function(){return this.__ge.getSelectionContext();}
,_getManager:function(){return this.__ge;}
,getSelectables:function(N){return this.__ge.getSelectables(N);}
,invertSelection:function(){this.__ge.invertSelection();}
,_getLeadItem:function(){var O=this.__ge.getMode();if(O===r||O===c){return this.__ge.getSelectedItem();}
else {return this.__ge.getLeadItem();}
;}
,_applySelectionMode:function(Q,P){this.__ge.setMode(Q);}
,_applyDragSelection:function(S,R){this.__ge.setDrag(S);}
,_applyQuickSelection:function(U,T){this.__ge.setQuick(U);}
...
(function(){var a="qx.ui.form.List",b="text",c="Boolean",d="one",f="addChildWidget",g="_applySpacing",h="Enter",j="Integer",k="action",m="keyinput",n="qx.event.type.Data",o="addItem",p="vertical",q="removeChildWidget",r="",s="_applyOrientation",t="single",u="keypress",v="list",w="horizontal",x="label",y="pane",z="removeItem",A="__pM";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__pM=this._createListItemContainer();this.__pM.addListener(f,this._onAddChild,this);this.__pM.addListener(q,this._onRemoveChild,this);this.getChildControl(y).add(this.__pM);if(B){this.setOrientation(w);}
else {this.initOrientation();}
;this.addListener(u,this._onKeyPress);this.addListener(m,this._onKeyInput);this.__pN=r;}
,events:{addItem:n,removeItem:n},properties:{appearance:{refine:true,init:v},focusable:{refine:true,init:true},orientation:{check:[w,p],init:p,apply:s},spacing:{check:j,init:0,apply:g,themeable:true},enableInlineFind:{check:c,init:true}},members:{__pN:null,__pO:null,__pM:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__pM;}
...
,_applyOrientation:function(F,C){var D=F===w;var E=D?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__pM;content.setLayout(E);content.setAllowGrowX(!D);content.setAllowGrowY(D);this._applySpacing(this.getSpacing());}
,_applySpacing:function(H,G){this.__pM.getLayout().setSpacing(H);}
...
;if(((new Date).valueOf()-this.__pO)>1000){this.__pN=r;}
;this.__pN+=e.getChar();var K=this.findItemByLabelFuzzy(this.__pN);if(K){this.setSelection([K]);}
;this.__pO=(new Date).valueOf();}
