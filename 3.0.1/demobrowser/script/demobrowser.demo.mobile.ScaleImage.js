...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.e44241ce5c6c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="touchmove",b="height",c="px",d="url(",f=")",g="green",h="div",i="deg) scale(",j="200px",k="30px",l="qx.debug",m="12px",n="event.touch",o="-webkit-transform",p="touchend",q="width",r='Lucida Grande',s="50px",t="innerHTML",u="demobrowser.demo.mobile.ScaleImage",v="59px",w="engine.name",x="demobrowser/demo/mobile/qooxdoo-logo.png",y="20px",z="rotate(",A="webkit",B="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",C="absolute";qx.Class.define(u,{extend:qx.application.Native,members:{__zT:null,__JV:1,__JW:0,__JX:0,__JY:0,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(l)){qx.log.appender.Native;qx.log.appender.Console;}
;var F=new qx.html.Element(h);F.useElement(document.body);F.setRoot(true);if(qx.core.Environment.get(w)!=A||!qx.core.Environment.get(n)){var E={"color":g,"position":C,"font-family":r,"font-size":m,"left":k,"top":y};var H=new qx.html.Element(h,E);F.add(H);H.setAttribute(t,B);return;}
;var G=qx.util.ResourceManager.getInstance().toUri(x);var D={"width":j,"height":v,"position":C,"left":s,"top":s,"background":d+G+f};this.__zT=new qx.html.Element(h,D);this.__zT.addListener(a,this.__hR,this);this.__zT.addListener(p,this.__hS,this);F.add(this.__zT);}
,__hR:function(e){if(e.isMultiTouch()){this.__JX=e.getRotation()+this.__JW;this.__JY=e.getScale()*this.__JV;this.__zT.setStyle(o,z+this.__JX+i+this.__JY+f);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__zT.getStyle(q))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__zT.getStyle(b))/2);this.__zT.setStyles({"left":I+c,"top":top+c});}
;}
,__hS:function(e){if(e.isMultiTouch()){this.__JW=this.__JX;this.__JV=this.__JY;}
;}
}});}
)();
