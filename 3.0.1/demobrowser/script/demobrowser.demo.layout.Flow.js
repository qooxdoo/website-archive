...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow.9309d0875939.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var x=new qx.ui.layout.LineSizeIterator(D,this.getSpacingX());var B=z.top;while(x.hasMoreLines()){var C=x.computeNextLine(A);this.__Ft(C,B,A,z);B+=C.height+this.getSpacingY();}
;}
,__Ft:function(L,K,I,E){var H=qx.ui.layout.Util;var F=E.left;if(this.getAlignX()!=l){F=E.left+I-L.width;if(this.getAlignX()==j){F=E.left+Math.round((I-L.width)/2);}
;}
...
;}
,_computeSizeHint:function(){return this.__Fu(Infinity);}
,hasHeightForWidth:function(){return true;}
,getHeightForWidth:function(P){return this.__Fu(P).height;}
...
;return S;}
,__Fu:function(T){var U=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());var V=0;var W=0;var X=0;while(U.hasMoreLines()){var Y=U.computeNextLine(T);X+=1;W=Math.max(W,Y.width);V+=Y.height;}
;return {width:W,height:V+this.getSpacingY()*(X-1)};}
}});}
)();
(function(){var a="No more lines to compute",b="qx.ui.layout.LineSizeIterator";qx.Class.define(b,{extend:Object,construct:function(d,c){this.__gA=d;this.__Di=c;this.__Dj=d.length>0;this.__Dk=0;}
,members:{__gA:null,__Di:null,__Dj:null,__Dk:null,computeNextLine:function(k){var k=k||Infinity;if(!this.__Dj){throw new Error(a);}
;var p=this.__gA;var n=0;var f=0;var o=[];var j=[];for(var i=this.__Dk;i<p.length;i++ ){var m=p[i];var q=m.getSizeHint();var g=this.__Dl(i);var h=q.width+g;var e=i==this.__Dk;if(!e&&f+h>k){this.__Dk=i;break;}
...
,__Dl:function(r){var s=r==this.__Dk;if(s){return this.__gA[r].getMarginLeft();}
else {return Math.max(this.__gA[r-1].getMarginRight(),this.__gA[r].getMarginLeft(),this.__Di);}
;}
