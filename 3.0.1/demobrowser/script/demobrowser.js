...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.2cda02136b4b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bb=this.getInnerOpacity();if(bb<1){this.__dx(bc,bb);}
...
;}
;}
,__dx:function(bg,bd){if(!qx.core.Environment.get(E)){if(qx.core.Environment.get(l)){qx.log.Logger.warn(z);}
;return;}
...
else if(qx.core.Environment.get(R)&&!qx.core.Environment.get(N)&&qx.core.Environment.get(e)){if(!this.__dC){this.__dC=document.createElement(L);}
;var bk=this.getOrientation()==F;var bq=this.__dD();var bn=bk?200:1;var bp=bk?1:200;this.__dC.width=bp;this.__dC.height=bn;var bl=this.__dC.getContext(U);if(bk){var bw=bl.createLinearGradient(0,0,0,bn);}
else {var bw=bl.createLinearGradient(0,0,bp,0);}
;bw.addColorStop(this.getStartColorPosition()/100,bq.start);bw.addColorStop(this.getEndColorPosition()/100,bq.end);bl.fillStyle=bw;bl.fillRect(0,0,bp,bn);var bm=v+this.__dC.toDataURL()+g;bg[h]=bm;bg[l]=A;}
else if(qx.core.Environment.get(R)&&!qx.core.Environment.get(N)){var bq=this.__dD();var bv=this.getOrientation()==S?1:0;var bu=bq.start;var bo=bq.end;if(!qx.util.ColorUtil.isHex6String(bu)){bu=qx.util.ColorUtil.stringToRgb(bu);bu=qx.util.ColorUtil.rgbToHexString(bu);}
...
;}
;}
,__dD:function(){{var bz=qx.theme.manager.Color.getInstance();var bB=bz.resolve(this.getStartColor());var bA=bz.resolve(this.getEndColor());}
;return {start:bB,end:bA};}
,_getContent:function(){if(qx.core.Environment.get(R)&&!qx.core.Environment.get(N)){var bE=this.__dD();var bH=this.getOrientation()==S?1:0;var bG=qx.util.ColorUtil.hex3StringToHex6String(bE.start);var bD=qx.util.ColorUtil.hex3StringToHex6String(bE.end);bG=bG.substring(1,bG.length);bD=bD.substring(1,bD.length);var bF=G;if(this.classname.indexOf(D)!=-1){var bC={};this._styleBoxShadow(bC);bF=j+qx.bom.element.Style.compile(bC)+n;}
...
(function(){var a="-",b='</span>',c="src",d="Demos",f='</div>',g="Simple Theme",h="modelLink",n="^.*",o="filled",p="changeValue",q="node",v="Display HTML source",w="?qxenv:demobrowser.withTests:true",x="browser.name",y="dblclick",z="icon/22/actions/media-playback-start.png",A="Open the qooxdoo Manual",B="_runbutton",C="_leftComposite",D="value",E="app-header",F="demobrowser.DemoBrowser",G="HTML Code",H="load",I="_infosplit",J='</span>=<span class="string">',K="Run previous demo",L="changeSelection",M="enabled",N="//",O='_cmdObjectSummary',P="icon/22/actions/media-seek-forward.png",Q="ie",R="icon/22/actions/help-contents.png",S="__Pi",T="icon/22/apps/utilities-color-chooser.png",U="_status",V="Ctrl+N",W="Previous",X='.html',Y='execute',ba="Run",bb='<span class="html-tag-name">',bc="tags",bd="Demo loaded: ",be="__OP",bf="<div class='script'>The sample source will be displayed here.</div>",bg="_searchTextField",bh="Open demo in the playground",bi="tree1",bj="icon/22/actions/help-about.png",bk="f1",bl="white",bm="Debug",bn="Display log file",bo="id",bp="script/demobrowser.demo",bq="Run the selected demo",br="icon/22/apps/utilities-log-viewer.png",bs="Ctrl+O",bt="Log File",bu='changeSelection',bv=".src.js",bw="_blank",bx=" Demo Browser ",by="qx.theme.Classic",bz='value',bA="auto",bB="execute",bC="Get Demo Link",bD='<div class="script">',bE="logappender",bF="<pre class='script'>",bG="Choose theme",bH="Demo has been disposed.",bI=".html",bJ="icon/22/apps/internet-web-browser.png",bK="#",bL="f2",bM="visibility",bN="visible",bO="JS Code",bP="icon/22/mimetypes/executable.png",bQ="ig",bR="success",bS="Unable to access namespace. Maybe no demo loaded.",bT="html",bU="noPlayground",bV="<script",bW="Hide/Show Tests Demos",bX='excluded',bY='"}',ca="_urlWindow",cb="icon/22/actions/edit-redo.png",cc='_cmdDisposeSample',cd="qx.theme.Modern",ce="__Pd",cf='{"code": "',cg="demobrowser.withTests",ch="toolbar",ci="icon/22/apps/office-spreadsheet.png",cj="horizontal",ck="To Playground",cl="?qxenv:qx.theme:",cm="~",cn="demo/welcome.html",co='_cmdSampleInOwnWindow',cp=".*",cq="__Pc",cr="right-top",cs="app-splitpane",ct="</pre>",cu="hideItem",cv="Open the qooxdoo API Viewer",cx="javascript",cy="default",cz="Debugging options",cA="index.html",cB="file:",cC="Filter...",cD="Manual",cE="qx.theme.Indigo",cF="showItem",cG='js',cH="<pre ><div class='script'>",cI="Demo Browser",cJ="Dispose Demo",cK="changeState",cL="Classic Theme",cM="toolbar-button",cN='html',cO="__Pb",cP='log',cQ="icon/16/actions/edit-find.png",cR="Couldn't load file: ",cS="__Jz",cT="treeview.flat",cU="qooxdoo ",cV="http://manual.qooxdoo.org/",cW="Own Window",cX="right",cY="main",da='http://demo.qooxdoo.org/3.0.1/playground/',db="__OU",dc="qx_srcview",dd="Info",de="js",df="\n",dg="__Pe",dh="_prevButton",di='/',dj="/demo/",dk="__JD",dl='_cmdNextSample',dm="_history",dn="Indigo Theme",dp='&gt;',dq='http://demo.qooxdoo.org/3.0.1/apiviewer/',dr="Unable to access application.",ds="outputviews.sourcepage.html.page",dt=".",du="Run next demo",dv='_cmdPrevSample',dw=" Start",dx="\"",dy="Ctrl+Left",dz="demo-tree",dA="Display JavaScript source",dB='_cmdRunSample',dC="Next",dD="widget",dE="excluded",dF="F5",dG="__Pf",dH="__OT",dI="_demoView",dJ="icon/22/actions/application-exit.png",dK="Modern Theme",dL="Open demo in new window",dM="interval",dN="bottom-left",dO="string",dP="icon/22/mimetypes/text-html.png",dQ="API Viewer",dR=" ",dS="runbutton",dT='Failed to load demo data from the file system.\n\nThe security settings of your browser may prohibit AJAX when using the file protocol. Please try the http protocol instead.',dU="/",dV="outputviews.sourcepage.js.page",dW="<div class='script'>The sample JS source will be displayed here.</div>",dX="__Pa",dY="",ea="Ctrl+Right",eb="_navPart",ec="textfield",ed="_tree",ee="Ctrl+D",ef="mainsplit",eg="Could not open the Playground.",eh="icon/22/actions/go-previous.png",ei="Object Summary",ej='\n',ek='label',el="_nextButton",em='demo/',en='3.0.1',eo="?",ep=' <span class="keyword">',eq="</div></pre>",er="__Pg",es="monospace",et="fail",eu="left",ew="icon/22/actions/go-next.png",ey="Demo Link",ez="qx.theme.Simple",eA="Theme",eB="log",eC="_iframe";qx.Class.define(F,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__Jz={};var eG=new qx.ui.layout.VBox;this.setLayout(eG);this.add(this._createHeader());this.widgets={};this.tests={};this.__OO=cE;this.__Pj();this.__OP=this.__Pq();this.add(this.__OP);var eE=new qx.ui.splitpane.Pane(cj);eE.setAppearance(cs);this.mainsplit=eE;var eH=new qx.ui.splitpane.Pane(cj);eH.setDecorator(null);this._infosplit=eH;this.add(eE,{flex:1});var eJ=this._leftComposite=new qx.ui.container.Composite();eJ.setLayout(new qx.ui.layout.VBox(3));eE.add(eJ,0);{}
;var eF=new qx.ui.container.Composite();eF.setLayout(new qx.ui.layout.HBox(3));eF.setAppearance(ec);eJ.add(eF);var eN=new qx.ui.basic.Image(cQ);eF.add(eN);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(dD);this._searchTextField.setPlaceholder(cC);var eL=new qx.event.Timer(500);eL.addListener(dM,function(eO){this.filter(this._searchTextField.getValue());eL.stop();}
,this);this._searchTextField.addListener(p,function(eP){eL.restart();}
,this);eF.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(dY);this._status.setAppearance(dD);this._status.setWidth(80);this._status.setTextAlign(cX);eF.add(this._status);eE.add(eH,1);this._tree=this.__Pu();eJ.add(this._tree,{flex:1});this.__Pv();this._demoView=this.__Pr();{eH.add(this._demoView,2);}
;var eD=this.__OQ=this.__Ps();var eK=this.__OR=this.__Pt();var eI=this.__OS=new qxc.ui.logpane.LogView();eI.setDecorator(null);var eM=this.__cb=new qx.ui.container.Stack();eM.setDecorator(cY);eM.add(eD);eM.add(eK);eM.add(eI);eH.add(eM,1);eM.resetSelection();eM.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(cK,function(e){var eQ=e.getData().replace(cm,dU);if(this._currentSample!=eQ){this.setCurrentSample(eQ);}
;}
,this);this.__OT=[this.__Pa,this.__Pb,this.__Pe];{this.__OT.push(this.__OX);this.__OT.push(this.__Pc);this.__OT.push(this.__Pg);}
;this.__OU=new qx.event.Timer(250);this.__OU.addListener(dM,this.__Px,this);this.__OU.start();this.__OV=new demobrowser.InfoWindow(this.tr(dd));this.__OV.setAutoCenter(true);}
,members:{_iframe:null,__OO:null,__OU:null,__OW:null,_tree:null,_status:null,_searchTextField:null,__OX:null,__OY:null,__OT:null,_versionFilter:null,_navPart:null,__Pa:null,__Pb:null,__Pc:null,__Pd:null,__Pe:null,__Pf:null,__Pg:null,__OP:null,_leftComposite:null,_infosplit:null,_demoView:null,__JD:null,__Jz:null,__Ph:null,_urlWindow:null,__OV:null,__cb:null,__OQ:null,__OR:null,__OS:null,__Pi:null,defaultUrl:cn,playgroundUrl:da,__Pj:function(){this._cmdObjectSummary=new qx.ui.core.Command(bs);this._cmdObjectSummary.addListener(bB,this.__Pl,this);this._cmdRunSample=new qx.ui.core.Command(dF);this._cmdRunSample.addListener(bB,this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command(dy);this._cmdPrevSample.addListener(bB,this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command(ea);this._cmdNextSample.addListener(bB,this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command(V);this._cmdSampleInOwnWindow.addListener(bB,this.__Pm,this);this._cmdDisposeSample=new qx.ui.core.Command(ee);this._cmdDisposeSample.addListener(bB,this.__Pp,this);}
,__Pk:function(e){var eR=e.getTarget()===this.__Pi?this.__Ph:this.__Pi;var eS=e.getData()[0];if(eR&&eS){eR.setModelSelection([eS.getModel()]);}
;var eT=eS!=null?eS.getUserData(D):dY;switch(eT){case bT:this.__cb.setSelection([this.__OQ]);this.__cb.show();break;case de:this.__cb.setSelection([this.__OR]);this.__cb.show();break;case eB:this.__cb.setSelection([this.__OS]);this.__cb.show();break;default:this.__cb.resetSelection();this.__cb.exclude();};}
,__Pl:function(){var eV=this._iframe.getWindow();var eU;if(eV&&eV.qx){eU=eV.qx.dev.ObjectSummary.getInfo();}
else {eU=bS;}
;var eW=new qx.ui.form.TextArea(eU);eW.setDecorator(null);eW.setAutoSize(true);eW.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__OV.setContent(eW);this.__OV.setWidth(400);this.__OV.show();}
,__Pm:function(){var eX=this._iframe.getSource();eX=eX.substr(0,eX.indexOf(eo));{eX+=cl+this.__OO;}
;window.open(eX,bw);}
,__Pn:function(fa){var eY=!!fa;var fb=this._tree.getSelection()[0].getUserData(bc);if(fb){eY=eY&&!qx.lang.Array.contains(fb,bU);}
;this.__OX.setEnabled(eY);this.__OY=fa;}
,__Po:function(){if(this.__OY){var fe=this.__OY;var fd=cf+encodeURIComponent(fe)+bY;var fc=this.playgroundUrl+bK+encodeURIComponent(fd);window.open(fc,bw);}
else {var ff=new qx.ui.basic.Label(this.tr(eg));this.__OV.setContent(ff);this.__OV.setWidth(200);this.__OV.show();}
;}
,__Mh:function(){window.open(dq);}
,__Mi:function(){var fg=(en.split(a)[0]);window.open(cV+fg);}
,_onHideShowTests:function(event){var fi=window.location.search;var fj=window.location.hash;var fh=cA;if(fi==dY){fh+=w;}
;fh+=fj;location.replace(fh);}
,__Pp:function(e){var fl=this._iframe.getWindow();var fk;if(fl&&fl.qx){fl.qx.core.ObjectRegistry.shutdown();fk=this.tr(bH);}
else {fk=this.tr(dr);}
;var fm=new qx.ui.basic.Label(fk);fm.setRich(true);fm.setWrap(true);this.__OV.setContent(fm);this.__OV.setWidth(350);this.__OV.show();}
,__Pq:function(){var fJ=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr(ba),z);this._runbutton.addListener(bB,this.runSample,this);this._runbutton.setToolTipText(bq);fJ.add(this._runbutton);var fM=new qx.ui.toolbar.Part();fJ.add(fM);var fv=new qx.ui.toolbar.Button(this.tr(W),eh);fv.addListener(bB,this.playPrev,this);fv.setToolTipText(K);fM.add(fv);this._prevButton=fv;var fH=new qx.ui.toolbar.Button(this.tr(dC),ew);fH.addListener(bB,this.playNext,this);fH.setToolTipText(du);fM.add(fH);this._nextButton=fH;var fy={converter:function(fR){return fR==bN;}
};qx.data.SingleValueBinding.bind(this._runbutton,bM,fv,M,fy);qx.data.SingleValueBinding.bind(this._runbutton,bM,fH,M,fy);var fw=this._navPart=new qx.ui.toolbar.Part();fJ.add(fw);var fQ=new qx.ui.toolbar.Button(this.tr(cW),cb);fQ.addListener(bB,this.__Pm,this);fQ.setToolTipText(dL);this.__Pa=fQ;fw.add(fQ);{var fE=new qx.ui.toolbar.Button(this.tr(ck),dJ);fE.addListener(bB,this.__Po,this);fE.setToolTipText(bh);fE.setEnabled(false);if(qx.core.Environment.get(x)==Q){fE.exclude();}
;this.__OX=fE;fw.add(fE);var fq=new qx.ui.toolbar.Part();fJ.add(fq);var fC=new qx.ui.toolbar.Button(this.tr(dQ),R);fq.add(fC);fC.setToolTipText(this.tr(cv));fC.addListener(bB,this.__Mh,this);var fo=new qx.ui.toolbar.Button(this.tr(cD),bj);fq.add(fo);fo.setToolTipText(this.tr(A));fo.addListener(bB,this.__Mi,this);}
;var fK=new qx.ui.toolbar.Part;fJ.add(fK);{var fG=new qx.ui.menu.Menu;this.__Pd=fG;var fP=new qx.ui.menu.RadioButton(dK);var fN=new qx.ui.menu.RadioButton(cL);var fO=new qx.ui.menu.RadioButton(g);var fL=new qx.ui.menu.RadioButton(dn);fP.setUserData(D,cd);fN.setUserData(D,by);fO.setUserData(D,ez);fL.setUserData(D,cE);fL.setValue(true);var fz=new qx.ui.form.RadioGroup(fP,fN,fO,fL);fz.addListener(L,this.__PB,this);fG.add(fL);fG.add(fP);fG.add(fN);fG.add(fO);var fx=new qx.ui.toolbar.MenuButton(this.tr(eA),T,fG);this.__Pc=fK;fx.setToolTipText(bG);fK.add(fx);}
;var fA=new qx.ui.menu.Menu;{var fB=new qx.ui.menu.Button(this.tr(ei));this.__Pg=fB;fB.setCommand(this._cmdObjectSummary);fA.add(fB);}
;var ft=new qx.ui.menu.Button(this.tr(cJ));this.__Pe=ft;ft.setCommand(this._cmdDisposeSample);fA.add(ft);{fA.addSeparator();var fr=new qx.ui.menu.CheckBox(this.tr(bW));fr.setValue(!!qx.core.Environment.get(cg));fr.addListener(p,this._onHideShowTests,this);fA.add(fr);}
;var fu=new qx.ui.toolbar.MenuButton(this.tr(bm),ci,fA);this.__Pf=fu;fu.setToolTipText(cz);fK.add(fu);var fD=new qx.ui.toolbar.Part;this.__Pb=fD;fJ.addSpacer();fJ.add(fD);{var fI=new qx.ui.toolbar.RadioButton(G,bJ);fI.setToolTipText(v);fI.setModel(cN);var fs=new qx.ui.toolbar.RadioButton(bO,bP);fs.setToolTipText(dA);fs.setModel(cG);fI.setUserData(D,bT);fs.setUserData(D,de);fD.add(fI);fD.add(fs);}
;var fF=new qx.ui.toolbar.RadioButton(bt,br);fF.setToolTipText(bn);fF.setUserData(D,eB);fF.setModel(cP);fD.add(fF);var fn=this.__Pi=new qx.ui.form.RadioGroup;fn.setAllowEmptySelection(true);fn.add(fF);fn.addListener(bu,this.__Pk,this);{fn.add(fI,fs);}
;fJ.setOverflowHandling(true);var fp=new qx.ui.toolbar.MenuButton(null,P);fp.setAppearance(cM);fJ.add(fp);fJ.setOverflowIndicator(fp);fJ.setRemovePriority(fD,6);fJ.setRemovePriority(fK,5);fJ.setRemovePriority(fq,4);fJ.setRemovePriority(fw,3);fJ.setRemovePriority(fM,2);fJ.setRemovePriority(this._navPart,1);this.__JD=new qx.ui.menu.Menu();fp.setMenu(this.__JD);fJ.addListener(cu,this._onHideItem,this);fJ.addListener(cF,this._onShowItem,this);return fJ;}
,_onHideItem:function(e){var fT=e.getData();var fS=this._getMenuItems(fT);for(var i=0,l=fS.length;i<l;i++ ){fS[i].setVisibility(bN);if(fT===this.__Pc&&!(fS[i] instanceof qx.ui.menu.Separator)){fS[i].getMenu().setPosition(cr);}
;}
;}
,_onShowItem:function(e){var fV=e.getData();var fU=this._getMenuItems(fV);for(var i=0,l=fU.length;i<l;i++ ){fU[i].setVisibility(dE);}
;if(fV===this.__Pc){var fW=fV.getMenuButtons();for(var i=0,l=fW.length;i<l;i++ ){fW[i].getMenu().setPosition(dN);}
;}
;}
,_getMenuItems:function(gf){var fY=[];if(gf instanceof qx.ui.toolbar.Part){var ge=gf.getChildren();var gd=null;var fX=false;var ga=this.__JD.getChildren();if(gf!=this.__Pb){gd=this.__Jz[gf.toHashCode()];if(!gd){gd=new qx.ui.menu.Separator();this.__JD.addBefore(gd,ga[0]);this.__Jz[gf.toHashCode()]=gd;}
;fY.push(gd);}
else {fX=true;}
;for(var i=0,l=ge.length;i<l;i++ ){if(ge[i].getVisibility()==bX){continue;}
;var gb=this.__Jz[ge[i].toHashCode()];if(!gb){if(ge[i] instanceof qx.ui.toolbar.RadioButton){gb=new qx.ui.menu.RadioButton(ge[i].getLabel());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());gb.setUserData(bz,ge[i].getUserData(bz));gb.setModel(ge[i].getModel());ge[i].bind(M,gb,M);ge[i].bind(D,gb,D);gb.bind(D,ge[i],D);if(!this.__Ph){this.__Ph=new qx.ui.form.RadioGroup();this.__Ph.setAllowEmptySelection(true);this.__Ph.addListener(bu,this.__Pk,this);}
;this.__Ph.add(gb);}
else if(ge[i] instanceof qx.ui.toolbar.MenuButton){gb=new qx.ui.menu.Button(ge[i].getLabel().translate(),ge[i].getIcon(),ge[i].getCommand(),ge[i].getMenu());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());ge[i].bind(M,gb,M);}
else if(ge[i] instanceof qx.ui.toolbar.Button){gb=new qx.ui.menu.Button(ge[i].getLabel().translate(),ge[i].getIcon());gb.getChildControl(ek,false).setRich(true);gb.setTextColor(ge[i].getTextColor());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());ge[i].bind(M,gb,M);var gc=qx.event.Registration.getManager(ge[i]).getListeners(ge[i],Y);if(gc&&gc.length>0){for(var j=0,k=gc.length;j<k;j++ ){gb.addListener(Y,qx.lang.Function.bind(gc[j].handler,gc[j].context));}
;}
;}
else if(ge[i] instanceof qx.ui.toolbar.CheckBox){gb=new qx.ui.menu.CheckBox(ge[i].getLabel());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());ge[i].bind(M,gb,M);}
else {gb=new qx.ui.menu.Separator();}
;if(fX){this.__JD.add(gb);}
else {this.__JD.addBefore(gb,gd);}
;this.__Jz[ge[i].toHashCode()]=gb;}
;fY.push(gb);}
;}
;return fY;}
,__Pr:function(){var gg=new qx.ui.embed.Iframe().set({nativeContextMenu:true});gg.addListener(H,this.__Pw,this);this._iframe=gg;return gg;}
,__Ps:function(){var gh=new qx.ui.embed.Html(bf);gh.setOverflow(bA,bA);gh.setFont(es);gh.setBackgroundColor(bl);this.widgets[ds]=gh;gh.getContentElement().setAttribute(bo,dc);return gh;}
,__Pt:function(){var gi=new qx.ui.embed.Html(dW);gi.setOverflow(bA,bA);gi.setFont(es);gi.setBackgroundColor(bl);this.widgets[dV]=gi;gi.getContentElement().setAttribute(bo,dc);return gi;}
,__Pu:function(){var gk=new qx.ui.tree.Tree();var gj=new qx.ui.tree.TreeFolder(d);gk.setAppearance(dz);gk.setRoot(gj);this.tree=this.widgets[cT]=gk;gk.addListener(L,this.treeGetSelection,this);gk.addListener(y,function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return gk;}
,__Pv:function(){var gl=new qx.ui.window.Window(this.tr(ey),dP);gl.setLayout(new qx.ui.layout.VBox(10));gl.setAllowMaximize(false);gl.setAllowMinimize(false);var go=new qx.ui.basic.Label(dY);go.setSelectable(true);go.setNativeContextMenu(true);gl.add(go);this._urlWindow=gl;var gp=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(gp<0){gp=0;}
;var top=Math.ceil((qx.bom.Viewport.getHeight()/2)-25);if(top<0){top=0;}
;gl.moveTo(gp,top);this.getApplicationRoot().add(gl);var gm=new qx.ui.menu.Menu();var gn=new qx.ui.menu.Button(this.tr(bC),dP);gn.addListener(bB,function(e){var gr=this.tree.getSelection()[0];var gt=gr.getUserData(h);var gq=this.tests.handler.getFullName(gt);{gq=gq.replace(dt,cm);}
;var gs=location.protocol+N+location.host+location.pathname+bK+encodeURIComponent(gq);this._urlWindow.getChildren()[0].setValue(gs);this._urlWindow.open();}
,this);gm.add(gn);this._tree.setContextMenu(gm);}
,treeGetSelection:function(e){var gu=this.tree.getSelection()[0];this._runbutton.setEnabled(!gu.hasChildren());var gv=gu.getUserData(h);this.tests.selected=this.tests.handler.getFullName(gv);}
...
;}
;function gD(gI,gF){var gK=gF.getChildren();var t;for(var i=0;i<gK.length;i++ ){var gG=gK[i];if(gG.hasChildren()){t=new qx.ui.tree.TreeFolder(gy.polish(gG.label));t.setUserData(o,false);t.setUserData(q,gG);gD(t,t.getUserData(q));if(gG.label==gC){gE=t;t.setOpen(true);}
;}
else {if(!gG.type){continue;}
;t=new qx.ui.tree.TreeFile(gy.polish(gG.label));var gJ=gG.pwd().slice(1).join(dU)+dU+gG.label;if(gG.tags){t.setUserData(bc,gG.tags);{var j,m,gH;}
;}
;gw[gJ]=t;}
;gI.add(t);t.setUserData(h,gG);gG.widgetLinkFull=t;}
;}
;var gA=this.tests.handler.ttree;var gy=this;this.tree.setUserData(h,gA);this.tree.getRoot().setOpen(true);gD(this.tree.getRoot(),gA);{}
;if(gE!=null){this.tree.setSelection([gE]);}
else {this.tree.setSelection([this.tree.getRoot()]);}
;}
,runSample:function(e){if(this.tests.selected&&this.tests.selected!=dY){var gL=this.tests.selected.replace(dt,dU);this.setCurrentSample(gL);}
else {this.playNext();}
;}
,setCurrentSample:function(gP){if(!gP){return;}
;if(!this._sampleToTreeNodeMap){return;}
;var gM;var gO=this._sampleToTreeNodeMap[gP];if(gO){gO.getTree().setSelection([gO]);gM=em+gP;{gM+=cl+this.__OO;}
;var gN=gO.getUserData(bc);if(gN){this.__OX.setEnabled(!qx.lang.Array.contains(gN,bU));}
;}
else {gM=this.defaultUrl;}
;if(this._iframe.getSource()==gM){this._iframe.reload();}
else {this.__OW=false;this.__Pc.getChildren()[0].setEnabled(false);this.__Pc.getChildren()[1].setEnabled(false);this._iframe.setSource(gM);this._iframe.addListener(H,function(){window.setTimeout(function(){var gQ=this._iframe.getWindow();if(gQ&&gQ.qx&&gQ.qx.theme&&gQ.qx.theme.manager&&gQ.qx.theme.manager.Meta){this.__Pc.getChildren()[0].setEnabled(true);this.__Pc.getChildren()[1].setEnabled(true);}
;}
.bind(this),333);}
,this);}
...
,__Pw:function(){var gV=this._iframe.getWindow();var gS=this._iframe.getSource();if(gS!=null&&gS!=this.defaultUrl){var gU;try{gU=gV.location.href;}
catch(hd){gU=window.location.href;var hc=gU.lastIndexOf(dU);if(hc!=-1){gU=gU.substring(0,hc+1);}
;gU+=gS;}
;var ha=gU.indexOf(dj)+6;var gW=gU.indexOf(eo);gW=gW==-1?gU.length:gW;var gX=gU.substring(ha,gW).split(dU);var hb=String.fromCharCode(187);if(gX.length==2){var gR=gX[0];gR=gR.charAt(0).toUpperCase()+gR.substring(1);var gY=gX[1].replace(bI,dY).replace(/_/g,dR);gY=gY.charAt(0).toUpperCase()+gY.substring(1);var gT=cU+hb+bx+hb+dR+gR+dR+hb+dR+gY;}
else {var gT=cU+hb+bx+hb+dw;}
;document.title=gT;}
;}
,__Px:function(e){var he=this._iframe.getWindow();try{if(he&&he.qx&&he.qx.log&&he.qx.log.appender){if(!this.__OW){this.__OW=true;this.debug(bd+this._currentSample);this.__OS.clear();try{this.__OS.fetch(he.qx.log.Logger);}
catch(hf){return;}
;this._history.addToHistory(this._currentSample.replace(dU,cm),document.title);if(this._currentSampleUrl!=this.defaultUrl){this.__Py(this._currentSampleUrl);}
;}
;}
else {this.__OW=false;}
;}
catch(hg){this.__OW=false;}
;}
,filter:function(hj){var hp=new RegExp(n+hj+cp,bQ);var hn=this._tree.getRoot().getItems(true,true);var ho=0;var hh=0;for(var i=0;i<hn.length;i++ ){var hq=hn[i];var parent=hq.getParent();var hm=hq.getUserData(bc);var hi=false;if(hm!=null){for(var j=0;j<hm.length;j++ ){hi=!!hm[j].match(hp);if(hi){break;}
;}
;}
...
;}
;if(hj==dY){var hl=this._tree.getRoot().getItems(false,true);var hk=this._tree.getSelection();for(var i=0;i<hl.length;i++ ){if(hl[i]==hk[0]||hl[i]==hk[0].getParent()){continue;}
;hl[i].setOpen(false);}
;}
;this._status.setValue(ho+dU+hh);}
,__Py:function(hr){if(typeof (hr)!=dO){return;}
;var hs=new qx.io.request.Xhr(hr);hs.setTimeout(180000);hs.addListener(bR,function(hB){var content=hB.getTarget().getResponse();if(content){{var hv=content.indexOf(bV,content.indexOf(bV)+7);var hC=content.indexOf(c,hv);var hu=content.indexOf(dx,hC+5);var hw=content.substring(hC+5,hu);var hz=hw.substring(4,hw.length-3)+bv;var u=bp;var hy=hr.split(di);var hx=hy[1];var hA=hy[2];hA=hA.substr(0,hA.indexOf(X));u+=dt+hx+dt+hA+bv;hz=u;var ht=new qx.io.request.Xhr(hz);ht.setTimeout(18000);ht.addListener(bR,function(){var hD=ht.getResponse();this.__Pn(hD);if(hD){this.widgets[dV].setHtml(this.__Pz(hD,cx));}
;}
,this);ht.addListener(et,function(){this.error(cR+hr);}
,this);ht.send();this.widgets[ds].setHtml(this.__Pz(content));}
;}
;}
,this);hs.addListener(et,function(hE){this.error(cR+hr);}
,this);hs.send();}
,dataLoader:function(url){var req=new qx.io.request.Xhr(url);req.setTimeout(180000);req.addListener(bR,function(evt){var content=evt.getTarget().getResponse();if(!content){if(window.location.protocol==cB){alert(dT);}
;return;}
;var treeData=eval(content);qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(treeData);this.leftReloadTree();var hF=this._history.getState();if(hF){this.setCurrentSample(hF.replace(cm,dU));}
else {this.setCurrentSample(this.defaultUrl);}
;}
,this,0);}
,this);req.addListener(et,function(hG){this.error(cR+url);}
,this);req.send();}
...
;}
;}
,__Pz:function(hP,hU){var hO=new qx.util.StringBuilder(bF);var hR=[];var hS=new qx.util.StringBuilder();var hT=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var hQ=/^\s*<\/script>\s*$/i;hP=hP.replace(/\r\n/g,df).replace(/\r/g,df);var hR=hP.split(ej);if(hU==cx){return cH+qx.dev.Tokenizer.javaScriptToHtml(hP)+eq;}
;for(var i=0;i<hR.length;i++ ){if(hT.exec(hR[i])){hO.add(this.__PA(qx.bom.String.escape(hS.get()+hR[i])));hS.clear();}
else if(hQ.exec(hR[i])){var hV=qx.dev.Tokenizer.javaScriptToHtml(hS.get());hO.add(bD,hV,f);hS.clear();hS.add(hR[i],ej);}
else {hS.add(hR[i],ej);}
;}
;hO.add(this.__PA(qx.bom.String.escape(hS.get())),ct);return hO.get();}
,disableMenuButtons:function(){var hW=this.__OT;for(var i=0;i<hW.length;i++ ){hW[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var hX=this.__OT;for(var i=0;i<hX.length;i++ ){hX[i].setEnabled(true);}
;}
,__PA:function(ib){var ia=ib;function hY(ie){var s=new qx.util.StringBuilder(arguments[1],bb,arguments[2],b);var ic;var id=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++ ){ic=arguments[i];if(ic==dU){id=true;break;}
else {var m=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;var r;while((r=m.exec(ic))!=null){s.add(ep,r[1],J,r[2].replace(/\s*$/,dY),b);}
;}
;}
;s.add((id?dU:dY));}
;s.add(dp);return s.get();}
;ia=ia.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,hY);return ia;}
,polish:function(ig){return ig.replace(bI,dY).replace(/_/g,dR);}
,__PB:function(e){this.__OO=e.getData()[0].getUserData(D);var ii=this._iframe.getWindow();var ih=ii.qx.Theme.getByName(this.__OO);if(ih&&ii.qx.theme.manager&&ii.qx.theme.manager.Meta){ii.qx.theme.manager.Meta.getInstance().setTheme(ih);}
;}
,_createHeader:function(){var il=new qx.ui.layout.HBox();var ij=new qx.ui.container.Composite(il);ij.setAppearance(E);var im=new qx.ui.basic.Label(cI);var ik=new qxc.ui.versionlabel.VersionLabel();ik.setFont(cy);ij.add(im);ij.add(new qx.ui.core.Spacer,{flex:1});ij.add(ik);return ij;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(ef,bi,eu,dS,ch,bk,bL,dm,bE,O,dB,dv,dl,co,cc,dg,dG,eb,B,dX,cq,ce,cO,S,be,I,bg,U,ed,eC,dI,dH,er,db,C,ca,el,dh,cS,dk);}
});}
)();
(function(){var a="separator-vertical",b="_applyShowLogLevel",c="__Mv",d="Boolean",f="qxc.ui.logpane.LogView",g="warn",h='',j="Debug",k="Log",m="auto",n="execute",o="error",p="icon/16/actions/edit-clear.png",q="Clear",r="DIV",s="middle",t="icon/16/status/dialog-information.png",u="Warning",v="info",w="Log Level",x="Error",y="appear",z="main",A="changeLogLevel",B="Info",C="bold",D="model",E="icon/16/categories/system.png",F="icon/16/status/dialog-error.png",G="monospace",H="icon/16/status/dialog-warning.png",I="debug",J="white",K="scroll";qx.Class.define(f,{extend:qx.ui.container.Composite,construct:function(){this.__Mu=[[I,j,E],[v,B,t],[g,u,H],[o,x,F]];var O=new qx.ui.layout.VBox();O.setSeparator(a);qx.ui.container.Composite.call(this,O);this.setDecorator(z);var M=new qx.ui.basic.Label(this.tr(k)).set({font:C,padding:10,alignY:s,allowGrowX:true,allowGrowY:true});this.__Km=new qx.ui.toolbar.ToolBar();this.__Km.add(M);this.__Km.addSpacer();this.__Km.setBackgroundColor(J);var L=new qx.ui.toolbar.Button(this.tr(q),p);L.addListener(n,function(e){this.clear();}
,this);this.__Km.add(L);this.add(this.__Km);var N=new qx.ui.embed.Html(h);N.set({backgroundColor:J,overflowY:K,overflowX:m,font:G,padding:3});this.add(N,{flex:1});this.__Mv=new qx.log.appender.Element();qx.log.Logger.unregister(this.__Mv);this.__Mw=document.createElement(r);this.__Mv.setElement(this.__Mw);N.addListenerOnce(y,function(){N.getContentElement().getDomElement().appendChild(this.__Mw);}
,this);}
,properties:{showLogLevel:{check:d,apply:b,init:false},logLevel:{check:[I,v,g,o],init:I,event:A}},members:{__Mw:null,__Mv:null,__Mu:null,__Mx:null,__Km:null,clear:function(){this.__Mv.clear();}
,fetch:function(P){if(!P){P=qx.log.Logger;}
;P.register(this.__Mv);P.clear();}
,getAppenderElement:function(){return this.__Mw;}
,_applyShowLogLevel:function(R,Q){if(!this.__Mx){this.__Mx=this.__My();this.__Km.add(this.__Mx);}
;if(R){this.__Mx.show();}
else {this.__Mx.exclude();}
;}
,__My:function(){var S=new qx.ui.menu.Menu();var V=new qx.ui.toolbar.MenuButton(w,E);V.setMenu(S);for(var i=0,l=this.__Mu.length;i<l;i++ ){var U=this.__Mu[i];var T=new qx.ui.menu.Button(U[1],U[2]);T.setUserData(D,U[0]);T.addListener(n,function(W){var X=W.getTarget();this.setLogLevel(X.getUserData(D));V.setIcon(X.getIcon());}
,this);S.add(T);}
;return V;}
},destruct:function(){this._disposeObjects(c);this.__Mw=null;}
});}
)();
...
,members:{__go:null,setElement:function(t){this.clear();if(t){qx.bom.element.Class.add(t,h);}
;this.__go=t;}
,clear:function(){var u=this.__go;if(u){u.innerHTML=b;}
;}
,process:function(v){var w=this.__go;if(!w){return;}
...
(function(){var a="resize",b="demobrowser.InfoWindow",c="Boolean",d="_applyContent",e="center",f="OK",g="execute";qx.Class.define(b,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);this.setLayout(new qx.ui.layout.VBox(10));this.setMinWidth(200);this.setMaxWidth(qx.bom.Viewport.getWidth()-10);this.setMaxHeight(qx.bom.Viewport.getHeight()-10);this.setShowMinimize(false);this.setShowMaximize(false);this.add(this._getContentContainer(),{flex:1});this.add(this._makeOkButton(),{flex:0});this.addListener(a,this.__PC,this);}
,properties:{content:{apply:d},autoCenter:{check:c,init:false}},members:{__NH:null,_getContentContainer:function(){if(!this.__NH){this.__NH=new qx.ui.container.Composite(new qx.ui.layout.Canvas());this.__NH.setMinHeight(20);}
;return this.__NH;}
...
,__PC:function(){if(this.getAutoCenter()){this.center();}
;}
}});}
)();
...
,events:{"request":p},statics:{SUPPORTS_HASH_CHANGE_EVENT:qx.core.Environment.get(j),getInstance:function(){var q=!(window==window.top);if(!this.$$instance){if(q&&qx.core.Environment.get(o)==9){this.$$instance=new qx.bom.HashHistory();}
else if(q&&qx.core.Environment.get(c)==b&&qx.core.Environment.get(o)<9){this.$$instance=new qx.bom.IframeHistory();}
...
;}
;return this.$$instance;}
},properties:{title:{check:n,event:d,nullable:true,apply:k},state:{check:n,event:l,nullable:true,apply:h}},members:{_titles:null,_applyState:function(s,r){this._writeState(s);}
...
;return f;}
,_applyTitle:function(v){if(v!=null){document.title=v||f;}
;}
,addToHistory:function(x,w){if(!qx.lang.Type.isString(x)){x=x+f;}
;if(qx.lang.Type.isString(w)){this.setTitle(w);this._titles[x]=w;}
...
,this,100);}
,_onHistoryLoad:function(y){this.setState(y);this.fireDataEvent(a,y);if(this._titles[y]!=null){this.setTitle(this._titles[y]);}
;}
,_readState:function(){throw new Error(i);}
,_writeState:function(){throw new Error(i);}
,_setHash:function(B){var z=this._baseUrl+(B||f);var A=window.location;if(z!=A.href){A.href=z;}
;}
,_getHash:function(){var C=/#(.*)$/.exec(window.location.href);return C&&C[1]?C[1]:f;}
},destruct:function(){this._titles=null;}
});}
)();
(function(){var a="qx.blankpage",b="undefined",c="",d="interval",e="#",f="-1000px",g="hidden",h="can't initialize iframe",i="qx.bom.HashHistory",j="absolute";qx.Class.define(i,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this._baseUrl=null;this.__rf();}
,members:{__rc:null,__rd:null,__re:false,addToHistory:function(l,k){if(!qx.lang.Type.isString(l)){l=l+c;}
;if(qx.lang.Type.isString(k)){this.setTitle(k);this._titles[l]=k;}
;if(this.getState()!==l){this._writeState(l);}
;}
,__rf:function(){this.__rd=this.__rg();document.body.appendChild(this.__rd);this.__rh(function(){this._baseUrl=this.__rd.contentWindow.document.location.href;this.__ri();}
,this);}
,__rg:function(){var m=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(a))+e});m.style.visibility=g;m.style.position=j;m.style.left=f;m.style.top=f;return m;}
,__rh:function(n,p,o){if(typeof o===b){o=0;}
;if(!this.__rd.contentWindow||!this.__rd.contentWindow.document){if(o>20){throw new Error(h);}
;qx.event.Timer.once(function(){this.__rh(n,p, ++o);}
,this,10);return;}
;this.__re=true;n.call(p||window);}
,__ri:function(){qx.event.Idle.getInstance().addListener(d,this.__rk,this);}
,__rj:function(){qx.event.Idle.getInstance().removeListener(d,this.__rk,this);}
,__rk:function(){var q=this._readState();if(qx.lang.Type.isString(q)&&q!=this.getState()){this._onHistoryLoad(q);}
;}
,_readState:function(){var r=!this._getHash()?c:this._getHash().substr(1);return this._decode(r);}
,_getHash:function(){if(!this.__re){return null;}
;return this.__rd.contentWindow.document.location.hash;}
,_writeState:function(s){this._setHash(this._encode(s));}
,_setHash:function(u){if(!this.__rd||!this._baseUrl){return;}
;var t=!this.__rd.contentWindow.document.location.hash?c:this.__rd.contentWindow.document.location.hash.substr(1);if(u!=t){this.__rd.contentWindow.document.location.hash=u;}
;}
},destruct:function(){this.__rj();this.__rd=null;}
});}
)();
...
(function(){var a="request",b="qx.bom.IframeHistory",c="engine.name",d="can't initialize iframe",f="",g="mshtml",h="interval",i="state",j='<html><body><div id="state">',k="-1000px",l="browser.version",m="hidden",n="qx.blankpage",o="undefined",p='</div></body></html>',q="absolute";qx.Class.define(b,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__rq();}
,members:{__rd:null,__re:false,__rm:null,__rn:null,__ro:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);this.__ro=this._getHash();}
,_setHash:function(r){qx.bom.History.prototype._setHash.call(this,r);this.__ro=this._encode(r);}
...
;}
,_setState:function(v){this.__rn=true;this.setState(v);this.__rn=false;}
,_applyState:function(x,w){if(this.__rn){return;}
;this._writeState(x);}
,_readState:function(){if(!this.__re){return this._decode(this._getHash());}
;var y=this.__rd.contentWindow.document;var z=y.getElementById(i);return z?this._decode(z.innerText):f;}
,_writeState:function(B){if(!this.__re){this.__rp();this.__rm=qx.event.Timer.once(function(){this._writeState(B);}
,this,50);return;}
;this.__rp();var B=this._encode(B);if(qx.core.Environment.get(c)==g&&qx.core.Environment.get(l)!=8){this._setHash(B);}
;var A=this.__rd.contentWindow.document;A.open();A.write(j+B+p);A.close();}
,__rp:function(){if(this.__rm){this.__rm.stop();this.__rm.dispose();}
;}
,__rq:function(){this.__rf(function(){qx.event.Idle.getInstance().addListener(h,this.__rk,this);}
);}
,__rk:function(e){var D=null;var C=this._getHash();if(!this.__rs(C)){D=this.__rr(C);}
else {D=this._readState();}
;if(qx.lang.Type.isString(D)&&D!=this.getState()){this._onHistoryLoad(D);}
;}
,__rr:function(E){E=this._decode(E);this._writeState(E);return E;}
,__rs:function(F){return qx.lang.Type.isString(F)&&F==this.__ro;}
,__rf:function(G){this.__rd=this.__rg();document.body.appendChild(this.__rd);this.__rh(function(){this._writeState(this.getState());if(G){G.call(this);}
;}
,this);}
,__rg:function(){var H=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(n))});H.style.visibility=m;H.style.position=q;H.style.left=k;H.style.top=k;return H;}
,__rh:function(I,K,J){if(typeof J===o){J=0;}
;if(!this.__rd.contentWindow||!this.__rd.contentWindow.document){if(J>20){throw new Error(d);}
;qx.event.Timer.once(function(){this.__rh(I,K, ++J);}
,this,10);return;}
;this.__re=true;I.call(K||window);}
},destruct:function(){this.__rd=null;if(this.__rm){this.__rm.dispose();this.__rm=null;}
;qx.event.Idle.getInstance().removeListener(h,this.__rk,this);}
});}
)();
(function(){var a="qx.bom.NativeHistory",b="hashchange",c="engine.name",d="interval";qx.Class.define(a,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__ri();}
,members:{__rc:null,__ri:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){var e=qx.lang.Function.bind(this.__rk,this);this.__rc=qx.event.GlobalError.observeMethod(e);qx.bom.Event.addNativeListener(window,b,this.__rc);}
else {qx.event.Idle.getInstance().addListener(d,this.__rk,this);}
;}
,__rj:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,b,this.__rc);}
else {qx.event.Idle.getInstance().removeListener(d,this.__rk,this);}
;}
,__rk:function(){var f=this._readState();if(qx.lang.Type.isString(f)&&f!=this.getState()){this._onHistoryLoad(f);}
;}
...
(function(){var c="No target to insert tests",d="",e="^",f="demobrowser.TreeDataHandler",g="ttree",h="All",l="\\.[^\\.]+$",m=".",n="test",o="demobrowser.withTests",p="depth";qx.Class.define(f,{extend:qx.core.Object,construct:function(q){qx.core.Object.call(this);this.tmap=q;this.ttree=this.__PD(q);}
,members:{__PD:function(u){var s=u;function r(B,x){var y=x.classname;var A=y.split(m);function z(parent,G){if(!G.length){return parent;}
...
(function(){var a="qxc.ui.versionlabel.VersionLabel",b="versionLabel.name",c='3.0.1',d="",e='',f="versionLabel.version",g=" ",h="qooxdoo";qx.Class.define(a,{extend:qx.ui.basic.Label,construct:function(j,i){if(j==undefined){j=qx.core.Environment.get(b);}
