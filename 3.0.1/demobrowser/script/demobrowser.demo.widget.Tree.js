...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Tree","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tree.b2e785c7f31d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Windows (C:)",b="icon/22/places/user-desktop.png",c="Documents (D:)",d="Inbox",f="changeValue",g="Desktop",h="Trash",j="execute",k="root",l="Open mode:",m="Presets",n="Hide Root Node",o="Network",p="Control",q=" items",r="changeSelection",s="Sent",t="Files",u="Show Open Items",v="",w="mode",x="multi",y="g",z="Workspace",A="Enable drag selection",B="single",C="Selection: ",D="Junk #",E="demobrowser.demo.widget.Tree",F="Data",G="click",H="Show root open button",I="\n",J="none",K="Enable multi selection",L="double click",M="Selection:",N="Show Selected Items",O="Root node:",P="Toggle Height",Q=",",R="Edit",S="Show Items";qx.Class.define(E,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var W=new qx.ui.layout.HBox();W.set({spacing:20});var V=new qx.ui.container.Composite(W);this.getRoot().add(V);var T=this.getTree();V.add(T);var U=this.getCommandFrame(T);V.add(U);}
,getTree:function(){var bh=new qx.ui.tree.Tree().set({width:200,height:400});var bm=new qx.ui.tree.TreeFolder(k);bm.setOpen(true);bh.setRoot(bm);var bk=new qx.ui.tree.TreeFolder(g);bk.setOpen(true);bk.setIcon(b);bm.add(bk);var bc=new qx.ui.tree.TreeFolder(t);var ba=new qx.ui.tree.TreeFolder(z);var bb=new qx.ui.tree.TreeFolder(o);var Y=new qx.ui.tree.TreeFolder(h);bk.add(bc,ba,bb,Y);var bi=new qx.ui.tree.TreeFile(a);var X=new qx.ui.tree.TreeFile(c);ba.add(bi,X);var bl=new qx.ui.tree.TreeFolder(d);var bd=new qx.ui.tree.TreeFolder(m);var bg=new qx.ui.tree.TreeFolder(s);var bf=new qx.ui.tree.TreeFolder(h);for(var i=0;i<30;i++ ){bf.add(new qx.ui.tree.TreeFile(D+i));}
;var bj=new qx.ui.tree.TreeFolder(F);var be=new qx.ui.tree.TreeFolder(R);bl.add(bd,bg,bf,bj,be);bm.add(bl);return bh;}
,getCommandFrame:function(bt){var bC=new qx.ui.groupbox.GroupBox(p);var bu=4;bC.setLayout(new qx.ui.layout.Grid(5,3));var bE=0;bC.add(new qx.ui.basic.Label(C).set({paddingTop:4}),{row:bE,column:0});var bA=new qx.ui.form.TextField().set({readOnly:true});bC.add(bA,{row:bE++ ,column:1});bt.addListener(r,function(e){var bF=e.getData();if(bF.length>0){if(this.getSelectionMode()===x){bA.setValue(bF.length+q);}
else {bA.setValue(bF[0].getLabel());}
;}
else {bA.setValue(v);}
;}
);bC.add(new qx.ui.core.Spacer(bu,bu),{row:bE++ ,column:0});bC.add(new qx.ui.basic.Label(l),{row:bE,column:0});var bp={"click":G,"dblclick":L,"none":J};var bo=new qx.ui.form.RadioGroup();for(var by in bp){var bw=new qx.ui.form.RadioButton(bp[by]).set({value:by==bt.getOpenMode()});bw.setUserData(w,by);bo.add(bw);bC.add(bw,{row:bE++ ,column:1});}
;bo.addListener(r,function(e){bt.setOpenMode(e.getData()[0].getUserData(w));}
);bC.add(new qx.ui.core.Spacer(bu,bu),{row:bE++ ,column:0});bC.add(new qx.ui.basic.Label(M),{row:bE,column:0});var bz=new qx.ui.form.CheckBox(K);bC.add(bz,{row:bE++ ,column:1});bz.addListener(f,function(e){var bG=e.getData();bt.setSelectionMode(bG?x:B);}
);var bs=new qx.ui.form.CheckBox(A);bC.add(bs,{row:bE++ ,column:1});bs.addListener(f,function(e){var bH=e.getData();bt.setDragSelection(bH);if(!bz.getValue()){bz.setValue(true);}
;}
);bC.add(new qx.ui.core.Spacer(bu,bu),{row:bE++ ,column:0});bC.add(new qx.ui.basic.Label(O),{row:bE,column:0});var bB=new qx.ui.form.CheckBox(n);bC.add(bB,{row:bE++ ,column:1});bB.addListener(f,function(e){bt.setHideRoot(e.getData());}
);var bq=new qx.ui.form.CheckBox(H);bC.add(bq,{row:bE++ ,column:1});bq.addListener(f,function(e){bt.setRootOpenClose(e.getData());}
);bC.add(new qx.ui.core.Spacer(bu,bu),{row:bE++ ,column:0});var br=new qx.ui.form.Button(S);bC.add(br,{row:bE++ ,column:1});br.addListener(j,function(e){alert((v+bt.getItems()).replace(Q,I,y));}
);var bn=new qx.ui.form.Button(u);bC.add(bn,{row:bE++ ,column:1});bn.addListener(j,function(e){alert((v+bt.getItems(true,false)).replace(Q,I,y));}
);var bx=new qx.ui.form.Button(N);bC.add(bx,{row:bE++ ,column:1});bx.addListener(j,function(e){if(this.getSelectionMode()===B){alert(this.getSelection());}
else {alert(this.getSelection().toString().replace(Q,I,y));}
;}
,bt);var bv=new qx.ui.form.Button(P);bC.add(bv,{row:bE++ ,column:1});var bD=true;bv.addListener(j,function(e){bt.setHeight(bD?600:400);bD=!bD;}
);return bC;}
}});}
)();
...
,addSpacer:function(){if(!this.__yT){this.__yT=new qx.ui.core.Spacer();}
else {this._remove(this.__yT);}
;this._add(this.__yT);}
,addOpenButton:function(){this._add(this.getChildControl(l));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var L=this.getChildControl(s);if(this.__yS){this._remove(L);}
;this._add(L);this.__yS=true;}
,addLabel:function(M){var N=this.getChildControl(D);if(this.__yR){this._remove(N);}
;if(M){this.setLabel(M);}
else {N.setValue(this.getLabel());}
;this._add(N);this.__yR=true;}
,_applyIcon:function(P,O){if(!this.__yV()){this.__yW(P);}
else if(!this.isOpen()){this.__yW(P);}
;}
,_applyIconOpened:function(R,Q){if(this.isOpen()){if(this.__yU()&&this.__yV()){this.__yW(R);}
else if(!this.__yU()&&this.__yV()){this.__yW(R);}
;}
;}
...
;var X;if(W){X=this.__yV()?this.getIconOpened():null;}
else {X=this.getIcon();}
;if(X){this.__yW(X);}
;W?this.addState(t):this.removeState(t);}
,__yU:function(){return qx.util.PropertyUtil.getUserValue(this,s);}
,__yV:function(){return qx.util.PropertyUtil.getUserValue(this,v);}
,__yW:function(Y){var ba=this.getChildControl(s,true);if(ba){ba.setSource(Y);}
;}
...
;}
;if(this.__yT){this.__yT.setWidth((this.getLevel()+1)*this.getIndent()-bf);}
;}
...
(function(){var a="open",b="abstract",c="__ql",d="qx.debug",e="'. It is not a child of this tree item.",f="addItem",g="visible",h="excluded",j="removeItem",k="Invalid child index: ",m="Cannot remove treeitem '",n="__gA",o="qx.ui.tree.core.AbstractTreeItem";qx.Class.define(o,{extend:qx.ui.tree.core.AbstractItem,type:b,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__gA=[];}
,properties:{parent:{check:o,nullable:true}},members:{__gA:null,__ql:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
;}
;}
,getChildrenContainer:function(){if(!this.__ql){this.__ql=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?g:h});}
;return this.__ql;}
,hasChildrenContainer:function(){return this.__ql;}
,getParentChildrenContainer:function(){if(this.getParent()){return this.getParent().getChildrenContainer();}
else if(this.getLayoutParent()){return this.getLayoutParent();}
else {return null;}
;}
,getChildren:function(){return this.__gA;}
,hasChildren:function(){return this.__gA?this.__gA.length>0:false;}
...
;}
,__GI:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);}
;}
...
;this.__gA.push(Q);if(!N){this.__GI();}
;if(P){Q.recursiveAddToWidgetQueue();P.fireNonBubblingEvent(f,qx.event.type.Data,[Q]);}
;}
;if(P){qx.ui.core.queue.Widget.add(this);}
;}
,addAt:function(X,T){if(qx.core.Environment.get(d)){this.assert(T<=this.__gA.length&&T>=0,k+T);}
;if(T==this.__gA.length){this.add(X);return;}
;var W=X.getParent();if(W){W.remove(X);}
;var U=this.getChildrenContainer();X.setParent(this);var V=this.hasChildren();var S=this.__gA[T];U.addBefore(X,S);if(X.hasChildren()){U.addAfter(X.getChildrenContainer(),X);}
;qx.lang.Array.insertAt(this.__gA,X,T);if(!V){this.__GI();}
;if(this.getTree()){X.recursiveAddToWidgetQueue();qx.ui.core.queue.Widget.add(this);}
;}
,addBefore:function(Y,bb){if(qx.core.Environment.get(d)){this.assert(this.__gA.indexOf(bb)>=0);}
;var ba=Y.getParent();if(ba){ba.remove(Y);}
;this.addAt(Y,this.__gA.indexOf(bb));}
,addAfter:function(bd,bc){if(qx.core.Environment.get(d)){this.assert(this.__gA.indexOf(bc)>=0);}
;var be=bd.getParent();if(be){be.remove(bd);}
;this.addAt(bd,this.__gA.indexOf(bc)+1);}
,addAtBegin:function(bf){this.addAt(bf,0);}
,remove:function(bk){for(var i=0,l=arguments.length;i<l;i++ ){var bj=arguments[i];if(this.__gA.indexOf(bj)==-1){this.warn(m+bj+e);return;}
...
;}
;qx.lang.Array.remove(this.__gA,bj);bj.setParent(null);bg.remove(bj);}
;var bh=this.getTree();if(bh){bh.fireNonBubblingEvent(j,qx.event.type.Data,[bj]);}
;qx.ui.core.queue.Widget.add(this);}
,removeAt:function(bl){var bm=this.__gA[bl];if(bm){this.remove(bm);}
;}
,removeAll:function(){var bn=this.__gA.concat();for(var i=this.__gA.length-1;i>=0;i-- ){this.remove(this.__gA[i]);}
;return bn;}
...
(function(){var a="Boolean",b="_applyOpenMode",c="excluded",d="Space",f="Left",g="Enter",h="dblclick",j="changeOpenMode",k="_applyRootOpenClose",l="visible",m="changeSelection",n="qx.ui.tree.Tree",o="qx.event.type.Data",p="qx.ui.tree.core.AbstractTreeItem",q="tree",r="_applyHideRoot",s="changeRoot",t="_applyRoot",u="click",v="keypress",w="none",x="pane",y="Right",z="__pM";qx.Class.define(n,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__pM=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(x).add(this.__pM);this.initOpenMode();this.initRootOpenClose();this.addListener(m,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:o,removeItem:o},properties:{openMode:{check:[u,h,w],init:h,apply:b,event:j,themeable:true},root:{check:p,init:null,nullable:true,event:s,apply:t},hideRoot:{check:a,init:false,apply:r},rootOpenClose:{check:a,init:false,apply:k},appearance:{refine:true,init:q},focusable:{refine:true,init:true}},members:{__pM:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__pM;}
...
,_getContentPaddingTarget:function(){return this.__pM;}
...
;return null;}
,_applyOpenMode:function(be,bd){if(bd==u){this.removeListener(u,this._onOpen,this);}
else if(bd==h){this.removeListener(h,this._onOpen,this);}
;if(be==u){this.addListener(u,this._onOpen,this);}
