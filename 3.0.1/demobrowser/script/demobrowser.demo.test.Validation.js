...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Validation.ba2703424d09.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.test.Validation",b="<b>Setting the age ",c="property to 27</b><br>",d="- name: Name is validated to a minimum length of two.<br/>",e="<br>old name: ",f=")",g="age:",h="new name: ",i="new gender: ",j="fmale",k="<br><b>Setting the name to 'Hans'</b><br>",l="property to 'female'</b><br>",m="<br><b>Setting the gender ",n="must be longer than one characters. (",o="<b>Testing the gender ",p="<br>old gender: ",q="male",r="<br><b>Setting the age ",s="- age: Age is validated to be a number.<br/>",t="<b>Initial property values</b><br>",u="female",v="",w="<b>Setting the name to ''</b><br>",x="demobrowser.demo.test.Person",y="property to 'true'</b><br>",z="- gender: Gender is validated to be either male or female.",A="property to 'fmale'</b><br>",B="<font color='red'>GENDER NOT SET</font>",C="gender:",D="<br>old age: ",E="Hans",F="The demo creates an internal class containing three properties:<br/>",G="new age: ",H="Validation Error: Name ",I="<font color='red'>AGE NOT SET</font>",J="My name",K="<font color='red'>NAME NOT SET</font>",L="<br>",M="white",N="name:",O="<b>Description</b><br/>",P="__Rt";qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var Q=new demobrowser.demo.test.Person();var R=new qx.ui.embed.Html();R.setBackgroundColor(M);R.set({padding:10,width:250,height:360});this.getRoot().add(R,{left:10,top:10});R.setHtml(t);R.setHtml(R.getHtml()+N+Q.getName()+L);R.setHtml(R.getHtml()+g+Q.getAge()+L);R.setHtml(R.getHtml()+C+Q.getGender()+L);R.setHtml(R.getHtml()+k);Q.setName(E);R.setHtml(R.getHtml()+h+Q.getName()+L);R.setHtml(R.getHtml()+w);try{Q.setName(v);R.setHtml(R.getHtml()+h+Q.getName()+L);}
catch(T){R.setHtml(R.getHtml()+K+e+Q.getName()+L);}
;R.setHtml(R.getHtml()+r+c);Q.setAge(27);R.setHtml(R.getHtml()+G+Q.getAge()+L);R.setHtml(R.getHtml()+b+y);try{Q.setAge(true);R.setHtml(R.getHtml()+G+Q.getAge()+L);}
catch(U){R.setHtml(R.getHtml()+I+D+Q.getAge()+L);}
;R.setHtml(R.getHtml()+m+l);Q.setGender(u);R.setHtml(R.getHtml()+i+Q.getGender()+L);R.setHtml(R.getHtml()+o+A);try{Q.setAge(j);R.setHtml(R.getHtml()+i+Q.getGender()+L);}
catch(V){R.setHtml(R.getHtml()+B+p+Q.getGender()+L);}
;var S=new qx.ui.basic.Label();S.setRich(true);S.setWidth(250);S.setValue(O+F+d+s+z);this.getRoot().add(S,{left:280,top:10});}
}});qx.Class.define(x,{extend:qx.core.Object,properties:{name:{init:J,validate:P},age:{init:18,validate:qx.util.Validate.number()},gender:{init:q,validate:qx.util.Validate.inArray([q,u])}},members:{__Rt:function(W){if(W.length<2){throw new qx.core.ValidationError(H+n+W+f);}
;}
}});}
)();
