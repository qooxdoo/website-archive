...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.10b268137328.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__Jd=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__rS=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__rS:null,__Jd:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__rS!=null){i.stop(this.__rS);this.__rS=null;}
;this.__rS=i.start(function(){this.__Jd.update();this.__rS=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__Jd=null;}
});}
)();
