...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager.4952f105dbf7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Stopping recurrent 2-second timer",b="Recurrent 2-second timer with limit 3:",c="\n",d="One-shot 1-second timer: ",e=" ",f="demobrowser.demo.test.TimerManager",g="Recurrent 5-second timer: ",h="Start timers",i="execute",j="__op";qx.Class.define(f,{extend:qx.application.Standalone,members:{__op:null,startTimers:function(){var k=qx.util.TimerManager.getInstance();k.start(function(l,m){this.__Rl(g+m);}
,5000,this,null,0);k.start(function(n,o){this.__Rl(d+o);}
,0,this,null,1000);k.start(function(p,q){this.__Rl(b+q);if( ++p.count==3){this.__Rl(a);k.stop(q);}
;}
,2000,this,{count:0},2000);}
,__Rl:function(r){r=Date.parse(new Date)+e+r+c;this.__op.setValue(this.__op.getValue()+r);}
,main:function(){qx.application.Standalone.prototype.main.call(this);var s=new qx.ui.layout.VBox(5);var t=new qx.ui.container.Composite(s);var u=new qx.ui.form.Button(h);u.set({allowGrowX:false,allowGrowY:false});u.addListener(i,function(){u.setEnabled(false);this.startTimers();}
,this);var v=new qx.ui.form.TextArea();v.set({width:400,height:300});this.__op=v;t.add(v);t.add(u);this.getRoot().add(t,{left:20,top:10});}
