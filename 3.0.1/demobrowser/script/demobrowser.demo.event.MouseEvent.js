...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent.68db14c537ac.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.bom.Element.addListener(F,A,this.__QC,this);}
...
,this);}
,__QC:function(e){var K=e.getTarget().id.split(q)[1];var I=e.getTarget().checked;var J=document.getElementById(h);if(I){qx.bom.Element.addListener(J,K,this.logMouseEvent,this);}
