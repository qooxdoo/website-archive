...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_Compare.8494ed20827f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Reverse",b="demobrowser.demo.animation.Animation_Compare",c="1%",d="10%",f="JavaScript Animation",g="infinite",j="#124589",k="end",l="2em",m="div",n="rotate(359deg)",o="60px",p="auto",q="0",r="20%",s="CSS3 Animation",t="ease",u="30px",v="0px",w="-10px",x="200px",y="Pause",z="h1",A="10px",B="Waiting 2s",C="linear",D="1em",E="0.3",F="start",G="button",H="100px",I="Stop",J="400px",K="5px",L="50px",M="Play",N="iteration",O="2",P="click",Q="1",R="Ended",S="ease-in-out",T="none",U="red",V="#00FF00",W="Running",X="rotate(0deg)",Y="20px",bf="ease-in",bg="-50px",bh="ease-out",be="40px";qx.Class.define(b,{extend:qx.application.Native,members:{createButton:function(name,bl){var bj=[];for(var i=0;i<this.aniClasses.length;i++ ){var bi=document.createElement(m);bi.innerHTML=name;bi.className=G;bj[i]=bi;}
;var bk=(function(bm,name){return function(e){if(name.indexOf(a)!=-1){qx.bom.element.AnimationCss.animateReverse(bj[0],bm);qx.bom.element.AnimationJs.animateReverse(bj[1],bm);}
else {qx.bom.element.AnimationCss.animate(bj[0],bm);qx.bom.element.AnimationJs.animate(bj[1],bm);}
;}
;}
)(bl,name);qx.bom.Event.addNativeListener(bj[0],P,bk);qx.bom.Event.addNativeListener(bj[1],P,bk);return bj;}
,main:function(){qx.application.Native.prototype.main.call(this);this.aniClasses=[qx.bom.element.AnimationCss,qx.bom.element.AnimationJs];var bE={duration:1000,keyFrames:{'0':{"width":H},'70':{"width":x},'100':{"width":H}}};var bu={duration:1000,keyFrames:{'0':{"height":be},'70':{"height":o},'100':{"height":be}}};var bF={duration:500,keyFrames:{'0':{"opacity":1},'50':{"opacity":0},'100':{"opacity":1}}};var bN={duration:500,keep:100,keyFrames:{'0':{"opacity":1},'100':{"opacity":0,display:T}}};var bt={duration:500,keyFrames:{'0':{"left":v,"top":v},'80':{"left":L,"top":H},'100':{"left":v,"top":v}}};var bw={duration:500,keyFrames:{'0':{"left":v},'30':{"left":w},'60':{"left":A},'80':{"left":w},'100':{"left":v}}};var bq={duration:500,keyFrames:{'0':{"left":v,"top":v},'30':{"left":w,"top":w},'60':{"left":A,"top":w},'80':{"left":w,"top":A},'100':{"left":v,"top":v}}};var bV={duration:1000,keep:70,keyFrames:{'0':{"top":v},'70':{"top":K},'100':{"top":u}}};var bH={duration:1000,keyFrames:{'0':{"line-height":Q},'88':{"line-height":O},'100':{"line-height":E}}};var bn={duration:2000,keyFrames:{'0':{"font-size":D},'88':{"font-size":l},'100':{"font-size":D}}};var br={duration:1000,keyFrames:{'0':{"width":d},'40':{"width":r},'100':{"width":c}}};var bS={duration:1000,keyFrames:{'0':{"color":U},'50':{"color":j},'100':{"color":V}}};var bW={duration:500,repeat:2,keyFrames:{'0':{"top":v},'50':{"top":w},'100':{"top":v}}};var bB={duration:500,alternate:true,repeat:2,keyFrames:{'0':{"top":v},'100':{"top":bg}}};var bo={duration:1000,timing:bf,keep:100,keyFrames:{'0':{"left":v},'100':{"left":J}}};var bI=qx.lang.Object.clone(bo);bI.timing=bh;var bL=qx.lang.Object.clone(bo);bL.timing=C;var bA=qx.lang.Object.clone(bo);bA.timing=t;var bC=qx.lang.Object.clone(bo);bC.timing=S;var bM={duration:1000,keyFrames:{'0':{},'50':{"opacity":0},'100':{}}};var bp={duration:500,alternate:true,repeat:2,keep:100,keyFrames:{'0':{"top":v},'100':{"top":L}}};var bz={duration:1000,keep:100,keyFrames:{'0':{"top":v},'100':{"top":L}}};var bG={duration:500,alternate:true,repeat:3,keep:100,keyFrames:{'0':{"top":v},'100':{"top":Y}}};var bv={duration:1000,keyFrames:{'0':{"transform":X},'100':{"transform":n}}};var bJ={"Width":bE,"Height":bu,"Fade":bF,"FadeOut":bN,"Move":bt,"Shake":bw,"Dance":bq,"Dance Reverse":bq,"Keep":bV,"Keep (Alt.)":bp,"Keep (Reverse)":bz,"Keep (Reverse/Alt)":bG,"Font-Size":bn,"Line Height":bH,"Percent Width":br,"Color":bS,"Twice":bW,"Alternate":bB,"Ease In":bo,"Ease Out":bI,"Linear":bL,"Ease":bA,"Ease In Out":bC,"Missing Values":bM,"Transform":bv};var h=document.createElement(z);h.innerHTML=s;document.body.appendChild(h);var bs=document.createElement(m);document.body.appendChild(bs);h=document.createElement(z);h.innerHTML=f;document.body.appendChild(h);var ca=document.createElement(m);document.body.appendChild(ca);for(var bP in bJ){var bD=this.createButton(bP,bJ[bP]);bs.appendChild(bD[0]);ca.appendChild(bD[1]);}
;var bR={duration:500,alternate:true,repeat:g,keyFrames:{'0':{left:v},'100':{left:A}}};var bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bU=document.createElement(m);bU.innerHTML=I;bU.className=G;bD[i]=bU;}
;var bQ=(function(cb){return function(e){for(var i=0;i<bK.length;i++ ){bK[i].stop();}
;}
;}
)(bR);qx.bom.Event.addNativeListener(bD[0],P,bQ);qx.bom.Event.addNativeListener(bD[1],P,bQ);var bK=[];bK.push(qx.bom.element.AnimationCss.animate(bD[0],bR));bK.push(qx.bom.element.AnimationJs.animate(bD[1],bR));bs.appendChild(bD[0]);ca.appendChild(bD[1]);bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bU=document.createElement(m);bU.innerHTML=y;bU.className=G;bD[i]=bU;}
;var bQ=(function(cc){return function(e){for(var i=0;i<bK.length;i++ ){if(bY[i].el){if(bY[i].isPlaying()){bY[i].pause();bY[i].el.innerHTML=M;}
else {bY[i].play();bY[i].el.innerHTML=y;}
;}
;}
;}
;}
)(bR);qx.bom.Event.addNativeListener(bD[0],P,bQ);qx.bom.Event.addNativeListener(bD[1],P,bQ);var bY=[];bY.push(qx.bom.element.AnimationCss.animate(bD[0],bR));bY.push(qx.bom.element.AnimationJs.animate(bD[1],bR));bs.appendChild(bD[0]);ca.appendChild(bD[1]);bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bU=document.createElement(m);bU.innerHTML=q;bU.className=G;bD[i]=bU;bU.style.cursor=p;}
;var bx=function(e){e.innerHTML=parseInt(e.innerHTML)+1;}
;qx.bom.element.AnimationCss.animate(bD[0],bR).on(N,bx);qx.bom.element.AnimationJs.animate(bD[1],bR).on(N,bx);bs.appendChild(bD[0]);ca.appendChild(bD[1]);var by={duration:500,repeat:10,delay:2000,alternate:true,keyFrames:{'0':{left:v},'100':{left:A}}};bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bU=document.createElement(m);bU.innerHTML=B;bU.className=G;bD[i]=bU;bU.style.cursor=p;}
;var bO=function(e){e.innerHTML=W;}
;var bT=function(e){e.innerHTML=R;}
;var bX=[];bX.push(qx.bom.element.AnimationCss.animate(bD[0],by));bX.push(qx.bom.element.AnimationJs.animate(bD[1],by));for(var i=0;i<bX.length;i++ ){bX[i].on(F,bO);bX[i].on(k,bT);}
;bs.appendChild(bD[0]);ca.appendChild(bD[1]);}
}});}
)();
