...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.9b8e05626fae.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__SG:4,__SH:0,add:function(B){this.container.add(B,{row:Math.floor(this.__SH/this.__SG),column:this.__SH%this.__SG});this.__SH+=1;}
