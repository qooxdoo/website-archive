...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.f253f33486f4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="_applySearchString",c="demobrowser.demo.data.filter.SearchAsYouTypeFilter",b="String",a="";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__JT=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__qY=null;}
,properties:{searchString:{check:b,apply:d,init:a}},members:{__qY:null,__JT:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();if(this.__qY!=null){i.stop(this.__qY);this.__qY=null;}
;this.__qY=i.start(function(){this.__JT.update();this.__qY=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__JT=null;}
});}
)();
