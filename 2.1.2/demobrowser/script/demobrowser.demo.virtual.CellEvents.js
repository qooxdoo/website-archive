...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.52d95b71971d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=m+e.getRow()+b+e.getColumn()+c;this.__Sh(q);}
,_onContextMenu:function(e){var r=j+e.getRow()+b+e.getColumn()+c;this.__Sh(r);}
,_onDblclickPane:function(e){var s=i+e.getRow()+b+e.getColumn()+c;this.__Sh(s);}
,__Sh:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
