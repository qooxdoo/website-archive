...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.fbf356e859c7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="#333",j="border-left",i="green",h="demobrowser.demo.mobile.PingPong",g="0",f="qx.debug",d="interval",c="0px",b="12px",a="15em",L="center",K='Lucida Grande',J="Arial",I="<b>This demo is supposed to be run in a WebKit-based browser.</b>",H="engine.name",G="webkit",F="border-right",E="touchmove",D="black",C="200px",r="30px",s="100px",p="1px solid white",q="top",n="right",o="50%",l="none",m="white",t="px",u="innerHTML",w="20px",v="absolute",A="100%",z="div",B="left";qx.Class.define(h,{extend:qx.application.Native,members:{__Rj:null,__Rk:null,__Rl:null,__Rm:null,__Rn:5,__Ro:1,__Rp:1,__Rq:null,__Rr:null,__Rs:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(f)){qx.log.appender.Native;qx.log.appender.Console;}
...
;var M=this.__Rw(B);R.add(M);var N=this.__Rw(n);R.add(N);this.__Rk=this.__Rx(B);M.add(this.__Rk);M.addListener(E,qx.lang.Function.bind(this.__or,this,this.__Rk),this);this.__Rj=this.__Rx(n);N.add(this.__Rj);N.addListener(E,qx.lang.Function.bind(this.__or,this,this.__Rj),this);this.__Rl=this.__Ry();R.add(this.__Rl);this.__Rr=this.__Rz();M.add(this.__Rr);this.__Rs=this.__Rz();N.add(this.__Rs);this.__Rq=[0,0];this.__Rt();}
,__Rt:function(){this.__Rl.setStyles({"left":C,"top":C});this.__Rm=new qx.event.Timer(40);this.__Rm.addListener(d,function(){var x=(parseInt(this.__Rl.getStyle(B))+this.__Rn*this.__Ro);var y=(parseInt(this.__Rl.getStyle(q))+this.__Rn*this.__Rp);this.__Rl.setStyle(B,x+t);this.__Rl.setStyle(q,y+t);this.__Rv();}
,this);this.__Rm.start();}
,__Ru:function(S){this.__Rm.stop();this.__Rm.dispose();this.__Rn=5;this.__Rq[S]=this.__Rq[S]+1;this.__Rr.setAttribute(u,this.__Rq[0]);this.__Rs.setAttribute(u,this.__Rq[1]);this.__Rt();}
,__Rv:function(){var U=this.getBoundsFor(this.__Rl);if(U.top<=0){this.__Rp=1;}
;if(U.bottom>=window.innerHeight-5){this.__Rp=-1;}
;if(U.left<=0||U.right>=window.innerWidth){this.__Ru(U.left<=0?1:0);}
;var V=this.getBoundsFor(this.__Rk);if(U.left<=V.right&&U.bottom>=V.top&&U.top<=V.bottom){this.__Ro=1;this.__Rn=Math.min(this.__Rn+1,20);}
;var T=this.getBoundsFor(this.__Rj);if(U.right>=T.left&&U.bottom>=T.top&&U.top<=T.bottom){this.__Ro=-1;this.__Rn=Math.min(this.__Rn+1,20);}
;}
,__or:function(W,e){W.setStyles({"top":(e.getDocumentTop()-50)+t});}
,getBoundsFor:function(X){return qx.bom.element.Location.get(X.getDomElement());}
,__Rw:function(Y){var ba={"width":o,"height":A,"position":v,"backgroundColor":D};if(Y==B){ba[F]=p;}
else {ba[B]=o;ba[j]=p;}
;return new qx.html.Element(z,ba);}
,__Rx:function(bb){var bc={"width":r,"height":s,"top":s,"position":v,"backgroundColor":m};bc[bb]=w;return new qx.html.Element(z,bc);}
,__Ry:function(){var bd={"width":w,"height":w,"position":v,"backgroundColor":m,"userSelect":l};return new qx.html.Element(z,bd);}
,__Rz:function(){var be={"width":A,"height":A,"textAlign":L,"fontSize":a,"color":k,"fontFamily":J};var bf=new qx.html.Element(z,be);bf.setAttribute(u,g);return bf;}
}});}
)();
