...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Touch.1a1b2b5cb9f1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="engine.name",s="Two",r="20px",q="30px",p="qx.debug",o="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",n="webkit",m="12px",l="innerHTML",k="qx.mobile.emulatetouch",c="event.touch",j='Lucida Grande',g="One",b="demobrowser.demo.test.Touch",a="blue",f="absolute",d="div",h="green";qx.Class.define(b,{extend:qx.application.Native,members:{__RO:null,__RP:null,main:function(){qx.application.Native.prototype.main.call(this);if((qx.core.Environment.get(p))){qx.log.appender.Native;qx.log.appender.Console;}
...
;v.add(this.__RQ(10,10,h,g));v.add(this.__RQ(110,10,a,s));this.__RO=this.__RR(10,110);v.add(this.__RO);this.__RP=this.__RR(110,110);v.add(this.__RP);v.add(this.__RS(210,10));}
,__RQ:function(x,y,z,A){var B={"position":"absolute","left":x+"px","top":y+"px","width":"90px","height":"90px","backgroundColor":z,"fontFamily":"Arial","fontSize":"12px"};var C=new qx.html.Element("div",B,{"id":A});C.setAttribute("innerHTML","<b>Touch me:<br>"+A+"</b>");C.addListener("touchstart",this.__RT,this);C.addListener("touchmove",this.__RT,this);C.addListener("touchend",this.__RT,this);C.addListener("touchcancel",this.__RT,this);return C;}
,__RR:function(x,y){var D={"position":"absolute","left":x+"px","top":y+"px","width":"90px","fontFamily":"Arial","fontSize":"9px"};return new qx.html.Element("div",D);}
,__RS:function(x,y){var E={"position":"absolute","left":x+"px","top":y+"px","width":"55px","height":"55px","backgroundColor":"red","fontFamily":"Arial","fontSize":"12px"};var F=new qx.html.Element("div",E);F.setAttribute("innerHTML","<b>Cancel Touch</b>");F.addListener("click",function(){window.setTimeout(function(){alert("Touch canceled");}
,0);}
,this);return F;}
,__RT:function(e){var G=[];G.push("Type: "+e.getType());G.push("==============");G.push("Is Multi-Touch: "+e.isMultiTouch());G.push("All Touches: "+e.getAllTouches().length);G.push("Target Touches: "+e.getTargetTouches().length);G.push("Changed Target Touches: "+e.getChangedTargetTouches().length);G.push("==============");G.push("Document: Left = "+e.getDocumentLeft()+" / Top = "+e.getDocumentTop());G.push("Screen: Left = "+e.getScreenLeft()+" / Top = "+e.getScreenTop());G.push("Viewport: Left = "+e.getViewportLeft()+" / Top = "+e.getViewportTop());G.push("Identifier: "+e.getIdentifier());var I=e.getTarget();var H=false;var K=e.getTargetTouches().length>0?e.getTargetTouches():e.getChangedTargetTouches();for(var i=0;i<K.length;i++ ){H=K[0].target==I;if(!H){break;}
;}
