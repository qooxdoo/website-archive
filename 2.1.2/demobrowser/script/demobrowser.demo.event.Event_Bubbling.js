...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling.2b7bd687b17a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(n,o,p){this.__Rb=f+n.join(j)+l;this.__Rc=p||50;this.__Rd=o;this._clearLog();}
,_clearLog:function(){this.__Rd.innerHTML=this.__Rb+a;this.__Re=[];}
,_log:function(q){this.__Re.unshift(q);this.__Re=this.__Re.slice(0,this.__Rc);var r=[this.__Rb];for(var i=0;i<this.__Re.length;i++ ){r.push(e,this.__Re[i].join(g),b);}
;r.push(a);this.__Rd.innerHTML=r.join(h);this.__Rd.scrollTop=0;}
,__Rb:null,__Rc:null,__Rd:null,__Re:null},destruct:function(){this.__Rd=this.__Re=null;}
});}
)();
