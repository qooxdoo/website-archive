...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean.5b2d856eb9fb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="\"",i="Boolean",h="  this.attributes.setNamedItem(namedItem); ",g="} catch (e) { ",f="var node = this.attributes.getNamedItem('celldata'); ",e="qx.ui.progressive.renderer.table.cell.Boolean",d="if (value == '0') ",c="celldata='1' ",b="  node.nodeValue='0'; ",a="  this.attributes.setNamedItem(node); ",C="var value = node.nodeValue; ",B="celldata='0' ",A="  node.nodeValue='1'; ",z="onclick=\"",y="  namedItem.value = node.nodeValue; ",x="var src; ",w="try { ",v="  var namedItem = document.createAttribute('celldata'); ",u="} ",t="else ",q="  var filters = this.filters.item(loader); ",r="changeTheme",o="}",p="{",m="  var loader = 'DXImageTransform.Microsoft.AlphaImageLoader'; ",n="  filters.sizingMethod = 'scale'; ",k="  filters.src='",l="  this.src='",s="'; ";qx.Class.define(e,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(){qx.ui.progressive.renderer.table.cell.Icon.call(this);this.__HN();qx.theme.manager.Appearance.getInstance().addListener(r,this.__HN,this);}
,properties:{allowToggle:{check:i,init:false}},members:{__HL:null,__HM:null,__Fm:null,__Fo:null,__Fp:null,__Fq:null,__Fr:null,__Fs:null,__HN:function(){var F=qx.util.AliasManager.getInstance();var G=qx.util.ResourceManager.getInstance();var E=F.resolve("decoration/table/boolean-true.png");var D=F.resolve("decoration/table/boolean-false.png");this.__HL=G.toUri(E);this.__HM=G.toUri(D);}
,_identifyImage:function(H){var I={imageWidth:11,imageHeight:11};switch(H.cellData){case true:I.url=this.__HL;I.extras=c;break;case false:I.url=this.__HM;I.extras=B;break;default:I.url=null;break;};if(this.getAllowToggle()){I.extras+=z+f+C+x+d+p;if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__HL)){I.extras+=l+this.getBlankImage()+s+m+q+k+this.__HL+s+n;}
else {I.extras+=l+this.__HL+s;}
;I.extras+=A+u+t+p;if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__HM)){I.extras+=l+this.getBlankImage()+s+m+q+k+this.__HM+s+n;}
else {I.extras+=l+this.__HM+s;}
;I.extras+=b+o;I.extras+=w+a+g+v+y+h+o+j;}
;return I;}
,_getCellStyle:function(J){var K=qx.ui.progressive.renderer.table.cell.Icon.prototype._getCellStyle.call(this,J);return K;}
},destruct:function(){this.__HL=this.__HM=null;qx.theme.manager.Appearance.getInstance().removeListener(r,this.__HN,this);}
});}
)();
