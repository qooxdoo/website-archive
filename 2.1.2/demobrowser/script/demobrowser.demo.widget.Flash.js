...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.ae3b95eaeca2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="Flash Player Version",j="__FS",i="right",h="qooxdoo is the best!",g="Message from Flash:",f="__Sx",d="__Sw",c="Simple demo with FlashVars",b="bgcolor",a="demobrowser.demo.widget.Flash",C="demobrowser/demo/flash/TestFlash.swf",B="Send to Flash",A="demobrowser/demo/flash/FlashVersion.swf",z="No message.",y="Flash:",x="<b>qooxdoo:</b>",w="__cf",v="demobrowser.demo.widget.Flash.sendMessage",u="demobrowser.demo.widget.Flash.flashReady",t="demobrowser/demo/flash/fo_tester.swf",r="this is passed in via FlashVars",s="Two way communication (ActionScript <-> JavaScript)",p="Message to Flash:",q="__Sv",n="Show Flash Player version",o="noscale",l="#FF6600",m="execute";qx.Class.define(a,{extend:qx.application.Standalone,members:{__cf:null,main:function(){qx.application.Standalone.prototype.main.call(this);var D=new qx.ui.tabview.TabView();D.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(D,{edge:0});var E=new qx.ui.tabview.Page(c);E.setLayout(new qx.ui.layout.Canvas());E.add(this.createFlashDemo1(),{edge:0});D.add(E);var F=new qx.ui.tabview.Page(s);F.setLayout(new qx.ui.layout.Canvas());F.add(this.createFlashDemo2(),{edge:0});D.add(F);this.__cf=this.createWindow();G.add(this.__cf,{top:20,left:20});}
,createWindow:function(){var H=new qx.ui.window.Window(k).set({width:300,height:200,contentPadding:[0,0,0,0]});H.setLayout(new qx.ui.layout.Canvas());H.add(new qx.ui.embed.Flash(A),{edge:0});return H;}
,createFlashDemo1:function(){var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var I={flashVarText:r};var J=new qx.ui.embed.Flash(t).set({scale:o,variables:I});J.getContentElement().setParam(b,l);K.add(J,{flex:1});var L=new qx.ui.form.Button(n);L.addListener(m,function(){this.__cf.open();}
,this);K.add(L);return K;}
,__FS:null,__Sv:null,__Sw:null,__Sx:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var O=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));O.add(N,{flex:1});N.add(new qx.ui.basic.Label(x).set({rich:true}));N.add(new qx.ui.basic.Label(g));this.__Sv=new qx.ui.form.TextArea(z);this.__Sv.setEnabled(false);N.add(this.__Sv,{flex:1});N.add(new qx.ui.basic.Label(p));this.__Sw=new qx.ui.form.TextArea(h);N.add(this.__Sw,{flex:1});var P=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,i));this.__Sx=new qx.ui.form.Button(B);this.__Sx.setEnabled(false);this.__Sx.addListener(m,function(e){this.__FS.getFlashElement().sendMessage(this.__Sw.getValue());}
,this);P.add(this.__Sx);N.add(P);var M=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));O.add(M,{flex:1});M.add(new qx.ui.basic.Label(y).set({rich:true}));this.__FS=new qx.ui.embed.Flash(C);this.__FS.setVariables({init:u});M.add(this.__FS,{flex:1});return O;}
,sendMessage:function(Q){this.__Sv.setValue(Q);}
,initFlash:function(){if(this.__FS.getFlashElement().setup){this.__FS.getFlashElement().setup(v);this.__Sx.setEnabled(true);}
else {alert("Couldn't connect to Flash Player! Please make sure that:\n"+"1) no pop-up or advertising blocker is activated.\n"+"2) this html page is not loaded from the file system, but a webserver.");}
;}
},statics:{__Sy:null,setCallBackInstance:function(R){demobrowser.demo.widget.Flash.__Sy=R;}
,sendMessage:function(S){demobrowser.demo.widget.Flash.__Sy.sendMessage(S);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Sy.initFlash();}
},destruct:function(){this._disposeObjects(q,d,f,j,w);}
});}
)();
...
(function(){var m="__sB",k="qx.event.type.Data",j="barRight",h="beforeChangeSelection",g="close-button",f="tabview",d="vertical",c="_applyBarPosition",b="barLeft",a="horizontal",C="qx.ui.tabview.TabView",B="barTop",A="barBottom",z="bottom",y="button",x="qx.debug",w="changeSelection",v="top",u="left",t="close",r="right",s="page",p="firstTab",q="bar",n="lastTab",o="pane";qx.Class.define(C,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(D){qx.ui.core.Widget.call(this);this.__Dw={top:B,right:j,bottom:A,left:b};this._createChildControl(q);this._createChildControl(o);var E=this.__sB=new qx.ui.form.RadioGroup;E.setWrap(false);E.addListener(w,this._onChangeSelection,this);if(D!=null){this.setBarPosition(D);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":k},properties:{appearance:{refine:true,init:f},barPosition:{check:[u,r,v,z],init:v,apply:c}},members:{__sB:null,_createChildControlImpl:function(F,G){var H;switch(F){case q:H=new qx.ui.container.SlideBar();H.setZIndex(10);this._add(H);break;case o:H=new qx.ui.container.Stack;H.setZIndex(5);this._add(H,{flex:1});break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);}
,_getContentPaddingTarget:function(){return this.getChildControl(o);}
,add:function(I){if(qx.core.Environment.get(x)){if(!(I instanceof qx.ui.tabview.Page)){throw new Error("Incompatible child for TabView: "+I);}
;}
;var J=I.getButton();var K=this.getChildControl(q);var M=this.getChildControl(o);I.exclude();K.add(J);M.add(I);this.__sB.add(J);I.addState(this.__Dw[this.getBarPosition()]);I.addState(n);var L=this.getChildren();if(L[0]==I){I.addState(p);}
else {L[L.length-2].removeState(n);}
;I.addListener(t,this._onPageClose,this);}
,addAt:function(N,O){if(qx.core.Environment.get(x)){if(!(N instanceof qx.ui.tabview.Page)){throw new Error("Incompatible child for TabView: "+N);}
;}
;var R=this.getChildren();if(!(O==null)&&O>R.length){throw new Error("Index should be less than : "+R.length);}
;if(O==null){O=R.length;}
;var P=N.getButton();var Q=this.getChildControl(q);var S=this.getChildControl(o);N.exclude();Q.addAt(P,O);S.addAt(N,O);this.__sB.add(P);N.addState(this.__Dw[this.getBarPosition()]);R=this.getChildren();if(O==R.length-1){N.addState(n);}
;if(R[0]==N){N.addState(p);}
else {R[R.length-2].removeState(n);}
;N.addListener(t,this._onPageClose,this);}
,remove:function(T){var Y=this.getChildControl(o);var W=this.getChildControl(q);var V=T.getButton();var X=Y.getChildren();if(this.getSelection()[0]==T){var U=X.indexOf(T);if(U==0){if(X[1]){this.setSelection([X[1]]);}
else {this.resetSelection();}
;}
else {this.setSelection([X[U-1]]);}
;}
;W.remove(V);Y.remove(T);this.__sB.remove(V);T.removeState(this.__Dw[this.getBarPosition()]);if(T.hasState(p)){T.removeState(p);if(X[0]){X[0].addState(p);}
;}
;if(T.hasState(n)){T.removeState(n);if(X.length>0){X[X.length-1].addState(n);}
;}
;T.removeListener(t,this._onPageClose,this);}
,getChildren:function(){return this.getChildControl(o).getChildren();}
,indexOf:function(ba){return this.getChildControl(o).indexOf(ba);}
,__Dw:null,_applyBarPosition:function(bb,bc){var bd=this.getChildControl(q);var bi=bb==u||bb==r;var bg=bb==r||bb==z;var bh=bi?qx.ui.layout.HBox:qx.ui.layout.VBox;var bk=this._getLayout();if(bk&&bk instanceof bh){}
else {this._setLayout(bk=new bh);}
;bk.setReversed(bg);bd.setOrientation(bi?d:a);var bj=this.getChildren();if(bc){var be=this.__Dw[bc];bd.removeState(be);for(var i=0,l=bj.length;i<l;i++ ){bj[i].removeState(be);}
;}
;if(bb){var bf=this.__Dw[bb];bd.addState(bf);for(var i=0,l=bj.length;i<l;i++ ){bj[i].addState(bf);}
;}
;}
,getSelection:function(){var bl=this.__sB.getSelection();var bm=[];for(var i=0;i<bl.length;i++ ){bm.push(bl[i].getUserData(s));}
;return bm;}
,setSelection:function(bn){var bo=[];for(var i=0;i<bn.length;i++ ){bo.push(bn[i].getChildControl(y));}
;this.__sB.setSelection(bo);}
,resetSelection:function(){this.__sB.resetSelection();}
,isSelected:function(bp){var bq=bp.getChildControl(y);return this.__sB.isSelected(bq);}
,isSelectionEmpty:function(){return this.__sB.isSelectionEmpty();}
,getSelectables:function(br){var bs=this.__sB.getSelectables(br);var bt=[];for(var i=0;i<bs.length;i++ ){bt.push(bs[i].getUserData(s));}
;return bt;}
,_onChangeSelection:function(e){var by=this.getChildControl(o);var bv=e.getData()[0];var bx=e.getOldData()[0];var bu=[];var bw=[];if(bv){bu=[bv.getUserData(s)];by.setSelection(bu);bv.focus();this.scrollChildIntoView(bv,null,null,false);}
else {by.resetSelection();}
;if(bx){bw=[bx.getUserData(s)];}
;this.fireDataEvent(w,bu,bw);}
,_onBeforeChangeSelection:function(e){if(!this.fireNonBubblingEvent(h,qx.event.type.Event,[false,true])){e.preventDefault();}
;}
,_onRadioChangeSelection:function(e){var bz=e.getData()[0];if(bz){this.setSelection([bz.getUserData(s)]);}
else {this.resetSelection();}
;}
,_onPageClose:function(e){var bB=e.getTarget();var bA=bB.getButton().getChildControl(g);bA.reset();this.remove(bB);}
},destruct:function(){this._disposeObjects(m);this.__Dw=null;}
});}
)();
...
,__nC:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
(function(){var j="quality",i="_applyVariables",h="low",g="_applyLoop",f="scale",e="_applyAllowScriptAccess",d="showall",c="Map",b="_applyLiveConnect",a="wmode",bb="Integer",ba="_applyMenu",Y="loaded",X="window",W="_applyPlay",V="loop",U="allowScriptAccess",T="menu",S="noborder",R="loading",q="swLiveConnect",r="qx.ui.embed.Flash",o="_applyId",p="high",m="transparent",n="exactfit",k="play",l="autohigh",u="_applySource",v="appear",D="medium",B="Invalid parameter 'source'.",J="timeout",F="_applyMayScript",N="_applyQuality",L="never",x="_applyScale",Q="flash",P="always",O="Invalid parameter 'id'.",w="noscale",z="_applyWmode",A="autolow",C="mayscript",E="sameDomain",G="opaque",K="qx.debug",M="String",s="",t="best",y="undefined",I="qx.event.type.Event",H="Boolean";qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(bc,bd){qx.ui.core.Widget.call(this);if(qx.core.Environment.get(K)){qx.core.Assert.assertString(bc,B);if(bd){qx.core.Assert.assertString(bd,O);}
;}
;this.setSource(bc);if(bd){this.setId(bd);}
else {this.setId(Q+this.toHashCode());}
;this.initQuality();this.initWmode();this.initAllowScriptAccess();this.initLiveConnect();this.addListenerOnce(v,function(){this._checkLoading();this.getContentElement().createFlash();}
,this);}
,events:{"loading":I,"loaded":I,"timeout":I},properties:{source:{check:M,apply:u},id:{check:M,apply:o},quality:{check:[h,A,l,D,p,t],init:t,nullable:true,apply:N},scale:{check:[d,S,n,w],nullable:true,apply:x},wmode:{check:[X,G,m],init:G,nullable:true,apply:z},play:{check:H,nullable:true,apply:W},loop:{check:H,nullable:true,apply:g},mayScript:{check:H,nullable:false,apply:F},menu:{check:H,nullable:true,apply:ba},allowScriptAccess:{check:[E,P,L],init:E,nullable:true,apply:e},liveConnect:{check:H,init:true,nullable:true,apply:b},variables:{init:{},check:c,apply:i},loadTimeout:{check:bb,init:10000}},members:{__FN:null,getFlashElement:function(){var be=this.getContentElement();if(be){return be.getFlashElement();}
else {return null;}
;}
,isLoaded:function(){return this.getPercentLoaded()===100;}
,getPercentLoaded:function(){var bf=this.getFlashElement();if(typeof (bf)!=y&&bf!=null){try{return bf.PercentLoaded();}
catch(bg){return 0;}
;}
else {return 0;}
;}
,_createContentElement:function(){return new qx.html.Flash();}
,_checkLoading:function(){var bh=this.getSource();if(bh!=s&&bh!=null&&bh!=y){if(!this.isLoaded()){if(!this.__FN){this.__FN=new Date().getTime();}
;var bi=new Date().getTime()-this.__FN;if(this.getLoadTimeout()>bi){var bj=qx.util.TimerManager.getInstance();bj.start(this._checkLoading,0,this,null,10);this.fireEvent(R);}
else {if(qx.core.Environment.get(K)){this.debug("Timeout after: "+bi);}
;this.fireEvent(J);this.__FN=null;}
;}
else {this.fireEvent(Y);this.__FN=null;}
;}
;}
,_applySource:function(bk,bl){var bm=qx.util.ResourceManager.getInstance().toUri(bk);this.getContentElement().setSource(bm);qx.ui.core.queue.Layout.add(this);}
,_applyId:function(bn,bo){this.getContentElement().setId(bn);qx.ui.core.queue.Layout.add(this);}
,_applyVariables:function(bp,bq){this.getContentElement().setVariables(bp);qx.ui.core.queue.Layout.add(this);}
,_applyMayScript:function(br,bs){this.getContentElement().setAttribute(C,br?s:false);qx.ui.core.queue.Layout.add(this);}
,_applyQuality:function(bt,bu){this.__FO(j,bt);}
,_applyScale:function(bv,bw){this.__FO(f,bv);}
,_applyWmode:function(bx,by){this.__FO(a,bx);}
,_applyPlay:function(bz,bA){this.__FO(k,bz);}
,_applyLoop:function(bB,bC){this.__FO(V,bB);}
,_applyMenu:function(bD,bE){this.__FO(T,bD);}
,_applyAllowScriptAccess:function(bF,bG){this.__FO(U,bF);}
,_applyLiveConnect:function(bH,bI){this.__FO(q,bH);}
,__FO:function(bJ,bK){this.getContentElement().setParam(bJ,bK);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var g="movie",f="id",e="qx.html.Flash",d="Invalid attribute 'key'.",c="div",b="Invalid attribute 'value'.",a="qx.debug";qx.Class.define(e,{extend:qx.html.Element,construct:function(h,i){qx.html.Element.call(this,c,h,i);this.__FP={};this.__FQ={};this.__FR={};}
,members:{__FP:null,__FR:null,__FQ:null,__FS:null,_createDomElement:function(){return qx.dom.Element.create(c);}
,createFlash:function(){this.__FS=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__FQ,this.__FP);}
,setSource:function(j){if(qx.core.Environment.get(a)){qx.core.Assert.assertString(j,b);}
;if(this.__FS){throw new Error("The source cannot be modified after initial creation");}
;this.setAttribute(g,j);}
,setId:function(k){if(qx.core.Environment.get(a)){qx.core.Assert.assertString(k,b);}
;if(this.__FS){throw new Error("The id cannot be modified after initial creation");}
;this.setAttribute(f,k);}
,getVariables:function(){return this.__FQ;}
,setVariables:function(l){if(qx.core.Environment.get(a)){qx.core.Assert.assertMap(l,b);}
;if(this.__FS){throw new Error("The variables cannot be modified after initial creation");}
;this.__FQ=l;}
,getAttributes:function(){return this.__FR;}
,setAttribute:function(m,n){if(qx.core.Environment.get(a)){qx.core.Assert.assertString(m,d);if(arguments.length>1&&n!==null){if(!qx.lang.Type.isBoolean(n)&&!qx.lang.Type.isString(n)){throw new Error("Invalid attribute 'value' expected String, Boolean or null.");}
;}
;}
;if(this.__FS){throw new Error("The attributes cannot be modified after initial creation");}
;if(n===null||n===undefined){delete this.__FR[m];}
else {this.__FR[m]=n;}
;}
,getParams:function(){return this.__FP;}
,setParam:function(o,p){if(qx.core.Environment.get(a)){qx.core.Assert.assertString(o,d);if(arguments.length>1&&p!==null){if(!qx.lang.Type.isBoolean(p)&&!qx.lang.Type.isString(p)){throw new Error("Invalid attribute 'value' expected String, Boolean or null.");}
;}
;}
;if(this.__FS){throw new Error("The params cannot be modified after initial creation");}
;if(p===null||p===undefined){delete this.__FP[o];}
else {this.__FP[o]=p;}
;}
,getFlashElement:function(){return this.__FS;}
},destruct:function(){if(this.__FS){qx.bom.Flash.destroy(this.__FS);}
;this.__FP=this.__FQ=this.__FR=null;}
});}
)();
(function(){var q="Invalid parameter 'element'.",p="&",o="Invalid attribute 'id'.",n="mshtml",m="qx.debug",l="beforeunload",k="data",j="load",h="Invalid attribute 'movie'.",g="Invalid parameter 'attributes'.",c="qx.bom.Flash",f="undefined",e="movie",b="=",a="100%",d="engine.name";qx.Class.define(c,{statics:{_flashObjects:{},create:function(r,s,t,u,v){if(!v){v=window;}
;if(qx.core.Environment.get(m)){qx.core.Assert.assertElement(r,q);qx.core.Assert.assertMap(s,g);qx.core.Assert.assertString(s.movie,h);qx.core.Assert.assertString(s.id,o);if(!qx.dom.Element.isInDom(r,v)){qx.log.Logger.warn(this,"The parent DOM element isn't in DOM! The External Interface doesn't work in IE!");}
;}
;if(!s.width){s.width=a;}
;if(!s.height){s.height=a;}
;u=u?qx.lang.Object.clone(u):{};if(!u[e]){u[e]=s.movie;}
;s[k]=s.movie;delete s.movie;if(t){for(var name in t){if(typeof u.flashvars!=f){u.flashvars+=p+name+b+t[name];}
else {u.flashvars=name+b+t[name];}
;}
;}
;var w=this.__FY(r,s,u,v);this._flashObjects[s.id]=w;return w;}
,destroy:qx.core.Environment.select(d,{"mshtml":function(x,y){x=this.__FT(x);if(x.readyState==4){this.__FU(x);}
else {if(!y){y=window;}
;qx.bom.Event.addNativeListener(y,j,function(){qx.bom.Flash.__FU(x);}
);}
;}
,"default":function(z,A){z=this.__FT(z);if(z.parentNode){z.parentNode.removeChild(z);}
;delete this._flashObjects[z.id];}
}),__FT:function(B){if(!B){throw new Error("DOM element is null or undefined!");}
;if(B.tagName.toLowerCase()!=="object"){B=B.firstChild;}
;if(!B||B.tagName.toLowerCase()!=="object"){throw new Error("DOM element has or is not a flash object!");}
;return B;}
,__FU:qx.core.Environment.select("engine.name",{"mshtml":qx.event.GlobalError.observeMethod(function(C){for(var i in C){if(typeof C[i]=="function"){C[i]=null;}
;}
;if(C.parentNode){C.parentNode.removeChild(C);}
;delete this._flashObjects[C.id];}
),"default":null}),__FV:qx.event.GlobalError.observeMethod(function(){for(var D in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[D]);}
;window.__FW=function(){}
;window.__FX=function(){}
;qx.bom.Event.removeNativeListener(window,"beforeunload",qx.bom.Flash.__FV);}
),__FY:qx.core.Environment.select("engine.name",{"mshtml":function(E,F,G,H){G.movie=F.data;delete F.data;delete F.classid;var I="";for(name in G){I+='<param name="'+name+'" value="'+G[name]+'" />';}
;if(F.id){E.innerHTML='<object id="'+F.id+'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">'+I+'</object>';delete F.id;}
else {E.innerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">'+I+'</object>';}
;for(var name in F){E.firstChild.setAttribute(name,F[name]);}
;return E.firstChild;}
,"default":function(J,K,L,M){delete K.classid;delete L.movie;var O=qx.dom.Element.create("object",K,M);O.setAttribute("type","application/x-shockwave-flash");var N;for(var name in L){N=qx.dom.Element.create("param",{},M);N.setAttribute("name",name);N.setAttribute("value",L[name]);O.appendChild(N);}
;J.appendChild(O);return O;}
})},defer:function(P){if((qx.core.Environment.get(d)==n)){qx.bom.Event.addNativeListener(window,l,P.__FV);}
;}
});}
)();
(function(){var c="qx.util.TimerManager",b="singleton",a="interval";qx.Class.define(c,{extend:qx.core.Object,type:b,statics:{__Ga:[],__Gb:{},__qY:0},members:{__Gc:false,start:function(d,e,f,g,h){if(!h){h=e||0;}
;var j=(new Date()).getTime()+h;this.self(arguments).__Gb[ ++this.self(arguments).__qY]={callback:d,userData:g||null,expireAt:j,recurTime:e,context:f||this};this.__Gd(j,this.self(arguments).__qY);return this.self(arguments).__qY;}
,stop:function(k){var l=this.self(arguments).__Ga;var length=l.length;for(var i=0;i<length;i++ ){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__Gb[k];if(l.length==0&&this.__Gc){qx.event.Idle.getInstance().removeListener(a,this.__Ge,this);this.__Gc=false;}
;}
,__Gd:function(m,n){var p=this.self(arguments).__Ga;var o=this.self(arguments).__Gb;var length=p.length;for(var i=0;i<length;i++ ){if(o[p[i]].expireAt>m){p.splice(i,0,n);break;}
;}
;if(p.length==length){p.push(n);}
;if(!this.__Gc){qx.event.Idle.getInstance().addListener(a,this.__Ge,this);this.__Gc=true;}
;}
,__Ge:function(){var t=(new Date()).getTime();var r=this.self(arguments).__Ga;var s=this.self(arguments).__Gb;while(r.length>0&&s[r[0]].expireAt<=t){var v=r.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__Gd(q.expireAt,v);}
else {delete s[v];}
;}
;if(r.length==0&&this.__Gc){qx.event.Idle.getInstance().removeListener(a,this.__Ge,this);this.__Gc=false;}
;}
}});}
)();
...
,properties:{wrap:{check:x,init:true,apply:i},appearance:{refine:true,init:n},singleStep:{check:w,init:20},minimalLineHeight:{check:w,apply:g,init:4},autoSize:{check:x,apply:E,init:false}},members:{__nn:null,__no:null,__np:null,setValue:function(G){G=qx.ui.form.AbstractField.prototype.setValue.call(this,G);this.__nq();return G;}
...
;}
,__nq:function(){if(this.isAutoSize()){var L=this.__nr();if(L){this.__np=this.__np||this._getAreaHeight();var N=this._getScrolledAreaHeight();if(this.getMaxHeight()){var J=this.getInsets();var K=-J.top+this.getMaxHeight()-J.bottom;if(N>K){this.getContentElement().setStyle(u,l);}
else {this.getContentElement().setStyle(u,t);}
;}
;var M=Math.max(N,this.__np);this._setAreaHeight(M);}
else {this.getContentElement().addListenerOnce(r,function(){this.__nq();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(O){if(this._getAreaHeight()!==O){this.__no=O;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__nu();}
;}
,_getScrolledAreaHeight:function(){var Q=this.__nr();var P=Q.getDomElement();if(P){if(!P.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;Q.setValue(this.getValue());this.__nt(Q);if(qx.core.Environment.get(m)==s){if(!P.scrollTop){qx.html.Element.flush();}
;return P.scrollTop+this._getTextSize().height;}
;return P.scrollTop;}
;}
,__nr:function(){this.__nn=this.__nn||this.__ns();return this.__nn;}
,__ns:function(){var U,S,R,T;U=this.getContentElement();if(!U.getDomElement()){return null;}
;R=qx.bom.Element.clone(U.getDomElement());T=new qx.html.Input(n);T.useElement(R);S=T;S.setStyles({position:y,top:0,left:-9999,height:0,overflow:t},true);S.removeAttribute(z);S.removeAttribute(C);S.setAttribute(D,h);S.setValue(U.getValue());S.insertBefore(U);this.__nt(S);return S;}
,__nt:function(V){V=V.getDomElement();if(V){V.scrollTop=10000;}
;}
...
,_applyAutoSize:function(ba,bb){if(qx.core.Environment.get(q)){this.__nv();}
;if(ba){this.__nq();this.addListener(v,this.__nq,this);this.addListenerOnce(r,function(){this.getContentElement().setStyle(u,t);}
);}
else {this.removeListener(v,this.__nq);this.getContentElement().setStyle(u,l);}
;}
,_applyDimension:function(bc){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(q)){this.__nv();}
;if(bc===this.getMaxHeight()){this.__nq();}
;}
,__nu:function(){var content=this.getContentElement();var be=content.getDomElement();var bd=content.getStyle(o);content.setStyle(o,parseInt(bd,10)+1000+k,true);if(be){qx.bom.element.Dimension.getWidth(be);}
;content.setStyle(o,bd,true);}
,__nv:function(){if(this.isAutoSize()&&this.getHeight()){this.warn("autoSize is ignored when the height property is set. "+"If you want to set an initial height, use the minHeight "+"property instead.");}
;}
,_getContentHint:function(){var bf=qx.ui.form.AbstractField.prototype._getContentHint.call(this);bf.height=bf.height*this.getMinimalLineHeight();bf.width=this._getTextSize().width*20;if(this.isAutoSize()){bf.height=this.__no||bf.height;}
;return bf;}
}});}
)();
