...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SettingsList.12e8e1d2c242.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="group.checked",o="#ddd",n="Fruits",m="Apple",l="Carrot",k="Vegetables",j="demobrowser.demo.virtual.SettingsList",h="changeValue",g="Orange",f="Potato",b="name",d="label",c="checked",a="value";qx.Class.define(j,{extend:qx.application.Standalone,members:{__cS:null,main:function(){qx.application.Standalone.prototype.main.call(this);var r=[];var s=[m,g,f,l];for(var i=0;i<s.length;i++ ){r[i]={name:s[i],checked:i<2,group:null};}
;this.__cS=qx.data.marshal.Json.createModel(r,true);var t=[];for(var i=0;i<2;i++ ){t[i]={name:null,checked:false};}
;t=qx.data.marshal.Json.createModel(t,true);t.getItem(0).setName(n);t.getItem(1).setName(k);this.__cS.toArray().forEach(function(u,v){v=v<2?0:1;u.setGroup(t.getItem(v));}
);var q=new qx.ui.list.List();q.setWidth(150);this.getRoot().add(q,{left:20,top:20});q.setDelegate(this);q.setModel(this.__cS);}
...
;var y=e.getData();this.__cS.forEach(function(z){if(x.getLabel()==z.getGroup().getName()){z.setChecked(y);}
;}
);}
,this);}
,bindItem:function(A,B,C){A.bindProperty(b,d,null,B,C);A.bindProperty(c,a,null,B,C);A.bindPropertyReverse(c,a,null,B,C);var D=this.__cS;A.bindPropertyReverse(p,a,{converter:function(E,F){var H=F.getItem(C);var J=H.getGroup();var G=D.toArray().filter(function(L){return L.getGroup()==J;}
