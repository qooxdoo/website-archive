...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellSpan","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellSpan.768657234e89.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j=" / ",i="Widget Cells",h="__Si",g="demobrowser.demo.virtual.CellSpan",f="HTML Cells",e="x",d="yellow",c="bold",b="table-scroller-header",a="green";qx.Class.define(g,{extend:qx.application.Standalone,members:{__Si:null,main:function(){qx.application.Standalone.prototype.main.call(this);var l=new qx.ui.layout.Grid(5,0);l.setRowFlex(1,1);l.setColumnFlex(0,1);l.setColumnFlex(1,1);var k=new qx.ui.container.Composite(l);this.getRoot().add(k,{edge:0});k.add(new qx.ui.basic.Label(f).set({font:c,decorator:b,padding:3,allowGrowX:true}),{row:0,column:0});var m=this.getHtmlCellSpanScroller();k.add(m,{row:1,column:0});k.add(new qx.ui.basic.Label(i).set({font:c,decorator:b,padding:3,allowGrowX:true}),{row:0,column:1});var m=this.getWidgetCellSpanScroller();k.add(m,{row:1,column:1});this.__Si=new qx.ui.virtual.cell.Cell();}
,getHtmlCellSpanScroller:function(){var p=new qx.ui.virtual.core.Scroller(1000,100,50,120);var o=p.getPane();var n=new qx.ui.virtual.layer.HtmlCellSpan(this,o.getRowConfig(),o.getColumnConfig());n.setCellSpan(1,1,2,2);n.setCellSpan(1,5,3,3);n.setCellSpan(7,4,2,4);n.setCellSpan(6,0,10,2);n.setCellSpan(10,9,10,5);n.setCellSpan(11,3,6,3);p.getPane().addLayer(n);return p;}
,getCellProperties:function(q,r){var s=(q+r)%2==0?d:a;this.__Si.setBackgroundColor(s);return this.__Si.getCellProperties(q+j+r);}
,getWidgetCellSpanScroller:function(){var v=new qx.ui.virtual.core.Scroller(1000,100,50,120);var u=v.getPane();var t=new qx.ui.virtual.layer.WidgetCellSpan(this,u.getRowConfig(),u.getColumnConfig());t.setCellSpan(1,1,2,2);t.setCellSpan(1,5,3,3);t.setCellSpan(7,4,2,4);t.setCellSpan(6,0,10,2);t.setCellSpan(10,9,10,5);t.setCellSpan(11,3,6,3);v.getPane().addLayer(t);this._pool=[];return v;}
,getCellWidget:function(w,x){var y=this._pool.pop()||new qx.ui.basic.Label().set({allowGrowX:true});y.set({backgroundColor:(w+x)%2==0?d:a,value:w+e+x,padding:3});return y;}
,poolCellWidget:function(z){this._pool.push(z);}
},destruct:function(){this._disposeObjects(h);this._pool=null;}
});}
)();
...
(function(){var o="-",n="}",m="qx.ui.virtual.cell.CellStylesheet",l="none",k="qx-cell-",j="default",i="ellipsis",h="hidden",g="} ",f=".",c="css.boxsizing",e="content-box",d="singleton",b="absolute",a=".qx-cell {";qx.Class.define(m,{extend:qx.core.Object,type:d,construct:function(){qx.core.Object.call(this);var p=a+qx.bom.element.Style.compile({position:b,overflow:h,cursor:j,textOverflow:i,userSelect:l})+g;if(qx.core.Environment.get(c)){p+=a+qx.bom.element.BoxSizing.compile(e)+n;}
;this.__ee=qx.bom.Stylesheet.createElement(p);this.__sC={};this.__ld={};}
,members:{__ee:null,__sC:null,__ld:null,getStylesheet:function(){return this.__ee;}
,getCssClass:function(q){return this.__sC[q]||null;}
,computeClassForStyles:function(r,s){var t=this.__ld[s];if(!t){var t=this.__sD();qx.bom.Stylesheet.addRule(this.__ee,f+t,s);this.__ld[s]=t;}
;this.__sC[r]=t;return t;}
,__sD:function(){return k+this.toHashCode()+o+(this.__sE++ );}
,__sE:0},destruct:function(){this.__ee=this.__sC=this.__ld=null;}
});}
)();
(function(){var k="-",j="backgroundColor",h="_applyTextAlign",g="px",f="_applyFont",e="_applyBackgroundColor",d="cell",c="center",b="font",a=":",J="shorthand",I="String",H="_applyAppearance",G="background-color:",F="textAlign",E="qx-cell ",D="left",C="textColor",B="text-align:",A="Font",r="right",s="_applyTextColor",p="justify",q="color:",n=" ",o="qx.ui.virtual.cell.Cell",l="paddingLeft",m="Color",t="",u="paddingBottom",w="paddingTop",v="paddingRight",y=";",x="Integer",z="_applyPadding";qx.Class.define(o,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__ee=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__sF={};this.__sG={};this.__sH={};this.__sI={};this.__ju={};this.__sJ={};this.initAppearance();this.__sN();}
,properties:{appearance:{check:I,init:d,apply:H},backgroundColor:{nullable:true,check:m,apply:e,themeable:true},textColor:{nullable:true,check:m,apply:s,themeable:true},textAlign:{check:[D,c,r,p],nullable:true,themeable:true,apply:h},font:{nullable:true,apply:f,check:A,themeable:true},paddingTop:{check:x,init:0,apply:z,themeable:true},paddingRight:{check:x,nullable:true,apply:z,themeable:true},paddingBottom:{check:x,nullable:true,apply:z,themeable:true},paddingLeft:{check:x,nullable:true,apply:z,themeable:true},padding:{group:[w,v,u,l],mode:J,themeable:true}},members:{__sK:null,__sL:null,__ju:null,__sJ:null,__sG:null,__sF:null,__sH:null,__sI:null,__sM:false,__ee:null,__sN:function(){var M=qx.util.PropertyUtil;var O=qx.lang.Object.fromArray(this._getCssProperties());this.__sK=[];var L=this.constructor;while(L){var N=M.getProperties(L);for(var K in N){if(!O[K]){this.__sK.push(K);}
;}
;L=L.superclass;}
;}
,_getCssProperties:function(){return [j,C,b,F,w,v,u,l];}
,_applyAppearance:function(P,Q){if(Q){this.__sG={};}
;}
,_getValue:function(R){if(this.__sM){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(S,T){var U;if(this.__sM){U=this.__sG;}
else {U=this.__sF;}
...
;}
,_applyPadding:function(bf,bg,name){var bf=this._getValue(name);if(this.__sM){var bi=this.__sI;}
else {bi=this.__sH;}
;if(bf===null){delete bi[name];}
else {bi[name]=bf;}
;if(bf===null){this._storeStyle(name,null);}
else {var bh=qx.bom.Style.getCssName(name);this._storeStyle(name,bh+a+bf+g);}
;}
,getCellProperties:function(bj,bk){this.__sO(bk);return {classes:this.getCssClasses(bj,bk),style:this.getStyles(bj,bk),attributes:this.getAttributes(bj,bk),content:this.getContent(bj,bk),insets:this.getInsets(bj,bk)};}
,getAttributes:function(bl,bm){return t;}
,getContent:function(bn,bo){return bn;}
,getCssClasses:function(bp,bq){var br=this.__ee.getCssClass(this.__sL)||t;return E+br;}
,__sO:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+k+Object.keys(bs).sort().join(n);if(this.__sL==bt){return;}
;this.__sL=bt;var bv=this.__ju[this.__sL];if(!bv){this.__sP();this.__sQ(bs);this.__sR(bs);this.__sS();this.__ju[this.__sL]=1;}
;this.__sT();}
,__sP:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__sQ:function(by){this.__sG={};this.__sM=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var bz=qx.theme.manager.Appearance.getInstance().styleFrom(bB,by);for(var bC in bz){if(bz[bC]!==undefined){bA.setThemed(this,bC,bz[bC]);}
;}
;this.__sM=false;}
,__sR:function(){var bD=qx.lang.Object.getValues(this.__sG).join(y);this.__ee.computeClassForStyles(this.__sL,bD);}
,__sS:function(){var bI=this.__sK;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__sJ[this.__sL]=bG;}
,__sT:function(){var bK=qx.util.PropertyUtil;var bJ=this.__sJ[this.__sL]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bM,bN){return qx.lang.Object.getValues(this.__sF).join(y);}
,getInsets:function(bO,bP){var bT=this.__sH;var bS=this.__sI;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bQ=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bR=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bQ,top+bR];}
},destruct:function(){this.__ee=this.__sF=this.__sG=this.__sH=this.__sI=this.__ju=this.__sJ=this.__sK=null;}
});}
)();
...
(function(){var p="</div>",o="top:",n=">",m="_spanManager",k="<div ",j="qx.ui.virtual.layer.HtmlCellSpan",h="style='",g="class='",f="x",e="left:",b="html",d="' ",c="px;",a="";qx.Class.define(j,{extend:qx.ui.virtual.layer.HtmlCell,construct:function(q,r,s){qx.ui.virtual.layer.HtmlCell.call(this,q);this._spanManager=new qx.ui.virtual.layer.CellSpanManager(r,s);}
,members:{setCellSpan:function(t,u,v,w){var z=t+f+u;this._spanManager.removeCell(z);if(v>1||w>1){this._spanManager.addCell(z,t,u,v,w);}
;qx.ui.core.queue.Widget.add(this);}
,__In:function(A,B,C,D,top,E,F){var H=this._cellProvider.getCellProperties(B,C);var G=H.insets||[0,0];A.push(k,h,e,D,c,o,top,c,this._getCellSizeStyle(E,F,G[0],G[1]),H.style||a,d,g,H.classes||a,d,H.attributes||a,n,H.content||a,p);}
,_fullUpdate:function(I,J,K,L){var U=[];var Q=this._spanManager.findCellsInWindow(I,J,K.length,L.length);if(Q.length>0){var R=this._spanManager.getCellBounds(Q,I,J);var O=this._spanManager.computeCellSpanMap(Q,I,J,K.length,L.length);for(var i=0,l=Q.length;i<l;i++ ){var S=Q[i];var W=R[i];this.__In(U,S.firstRow,S.firstColumn,W.left,W.top,W.width,W.height);}
;}
else {O=[];for(var i=0;i<K.length;i++ ){O[I+i]=[];}
;}
;var V=0;var top=0;var N=I;var T=J;for(var x=0;x<K.length;x++ ){var V=0;var T=J;var M=K[x];for(var y=0;y<L.length;y++ ){var P=L[y];if(!O[N][T]){this.__In(U,N,T,V,top,P,M);}
;T++ ;V+=P;}
;top+=M;N++ ;}
;this.getContentElement().setAttribute(b,U.join(a));}
},destruct:function(){this._disposeObjects(m);}
});}
)();
(function(){var k="lastColumn",j="qx.debug",h="firstColumn",g="firstRow",f="qx.ui.virtual.layer.CellSpanManager",d="lastRow",c="change";qx.Class.define(f,{extend:qx.core.Object,construct:function(m,n){qx.core.Object.call(this);if(qx.core.Environment.get(j)){this.assertInstance(m,qx.ui.virtual.core.Axis);this.assertInstance(n,qx.ui.virtual.core.Axis);}
;this._cells={};this._invalidateSortCache();this._invalidatePositionCache();m.addListener(c,this._onRowConfigChange,this);n.addListener(c,this._onColumnConfigChange,this);this._rowConfig=m;this._columnConfig=n;}
,members:{addCell:function(o,p,q,r,s){this._cells[o]={firstRow:p,lastRow:p+r-1,firstColumn:q,lastColumn:q+s-1,id:o};this._invalidateSortCache();}
,removeCell:function(t){delete (this._cells[t]);this._invalidateSortCache();}
,_invalidateSortCache:function(){this._sorted={};}
,_getSortedCells:function(u){if(this._sorted[u]){return this._sorted[u];}
;var v=this._sorted[u]=qx.lang.Object.getValues(this._cells);v.sort(function(a,b){return a[u]<b[u]?-1:1;}
);return v;}
,_findCellsInRange:function(w,x,y){var A=this._getSortedCells(w);if(A.length==0){return {};}
;var C=0;var z=A.length-1;while(true){var E=C+((z-C)>>1);var B=A[E];if(B[w]>=x&&(E==0||A[E-1][w]<x)){break;}
;if(B[w]>=x){z=E-1;}
else {C=E+1;}
;if(C>z){return {};}
;}
;var D={};var B=A[E];while(B&&B[w]>=x&&B[w]<=y){D[B.id]=B;B=A[E++ ];}
;return D;}
,findCellsInWindow:function(F,G,H,I){var M={};if(H>0){var K=F+H-1;qx.lang.Object.mergeWith(M,this._findCellsInRange(g,F,K));qx.lang.Object.mergeWith(M,this._findCellsInRange(d,F,K));}
;var J={};if(I>0){var L=G+I-1;qx.lang.Object.mergeWith(J,this._findCellsInRange(h,G,L));qx.lang.Object.mergeWith(J,this._findCellsInRange(k,G,L));}
;return this.__zu(J,M);}
,__zu:function(N,O){var P=[];for(var Q in N){if(O[Q]){P.push(O[Q]);}
;}
;return P;}
,_onRowConfigChange:function(e){this._rowPos=[];}
,_onColumnConfigChange:function(e){this._columnPos=[];}
,_invalidatePositionCache:function(){this._rowPos=[];this._columnPos=[];}
,_getRowPosition:function(R){var S=this._rowPos[R];if(S!==undefined){return S;}
;S=this._rowPos[R]=this._rowConfig.getItemPosition(R);return S;}
,_getColumnPosition:function(T){var U=this._columnPos[T];if(U!==undefined){return U;}
;U=this._columnPos[T]=this._columnConfig.getItemPosition(T);return U;}
,_getSingleCellBounds:function(V,W,X){var Y={left:0,top:0,width:0,height:0};Y.height=this._getRowPosition(V.lastRow)+this._rowConfig.getItemSize(V.lastRow)-this._getRowPosition(V.firstRow);Y.top=this._getRowPosition(V.firstRow)-this._getRowPosition(W);Y.width=this._getColumnPosition(V.lastColumn)+this._columnConfig.getItemSize(V.lastColumn)-this._getColumnPosition(V.firstColumn);Y.left=this._getColumnPosition(V.firstColumn)-this._getColumnPosition(X);return Y;}
,getCellBounds:function(ba,bb,bc){var bd=[];for(var i=0,l=ba.length;i<l;i++ ){bd.push(this._getSingleCellBounds(ba[i],bb,bc));}
;return bd;}
,computeCellSpanMap:function(be,bf,bg,bh,bi){var bj=[];if(bh<=0){return bj;}
;var bs=bf+bh-1;for(var i=bf;i<=bs;i++ ){bj[i]=[];}
;if(bi<=0){return bj;}
;var bl=bg+bi-1;for(var i=0,l=be.length;i<l;i++ ){var bo=be[i];var bm=Math.max(bf,bo.firstRow);var bn=Math.min(bs,bo.lastRow);var bt;for(var bp=bm;bp<=bn;bp++ ){bt=bj[bp];var bk=Math.max(bg,bo.firstColumn);var br=Math.min(bl,bo.lastColumn);for(var bq=bk;bq<=br;bq++ ){bt[bq]=1;}
;}
;}
;return bj;}
},destruct:function(){this._rowConfig.removeListener(c,this._onRowConfigChange,this);this._columnConfig.removeListener(c,this._onColumnConfigChange,this);this._cells=this._sorted=this._rowPos=this._columnPos=this._rowConfig=this._columnConfig=null;}
});}
)();
(function(){var j="x",h="qx.ui.virtual.layer.WidgetCellSpan",g="_spanManager",f="_cellLayer",e="cell.rowspan",d="cell.column",c="cell.colspan",b="cell.row",a="cell.spanning";qx.Class.define(h,{extend:qx.ui.virtual.layer.Abstract,include:[qx.ui.core.MChildrenHandling],construct:function(k,m,n){qx.ui.virtual.layer.Abstract.call(this);this.setZIndex(2);this._spanManager=new qx.ui.virtual.layer.CellSpanManager(m,n);this._cellProvider=k;this.__xj=[];this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__Ig());this._cellLayer.setZIndex(0);this._setLayout(new qx.ui.layout.Grow());this._add(this._cellLayer);}
,properties:{anonymous:{refine:true,init:false}},members:{getRenderedCellWidget:function(o,p){var q=this._cellLayer.getRenderedCellWidget(o,p);if(!q||q.getUserData(a)){var t=this._getChildren();for(var i=0,l=t.length;i<l;i++ ){var s=t[i];if(s==this._cellLayer){continue;}
;var r={row:s.getUserData(b),column:s.getUserData(d),rowSpan:s.getUserData(e),colSpan:s.getUserData(c)};if(r.row<=o&&o<r.row+r.rowSpan&&r.column<=p&&p<r.column+r.colSpan){return s;}
;}
;return null;}
;return q;}
,__xj:null,setCellSpan:function(u,v,w,x){var y=u+j+v;this._spanManager.removeCell(y);if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);}
;qx.ui.core.queue.Widget.add(this);}
,__Ig:function(){var self=this;var B=this._cellProvider;var A=this.__xj;var z={getCellWidget:function(C,D){if(!self._spanMap[C][D]){var E=B.getCellWidget(C,D);}
else {var E=A.pop();if(!E){E=new qx.ui.core.Spacer();E.setUserData(a,1);}
;}
;return E;}
,poolCellWidget:function(F){if(F.getUserData(a)){A.push(F);}
else {B.poolCellWidget(F);}
;}
};return z;}
,__Ih:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);if(this._cells.length>0){this._bounds=this._spanManager.getCellBounds(this._cells,G,H);this._spanMap=this._spanManager.computeCellSpanMap(this._cells,G,H,I,J);}
else {this._bounds=[];this._spanMap=[];for(var i=0;i<I;i++ ){this._spanMap[G+i]=[];}
;}
;}
,__Ii:function(){var O=this.getChildren();for(var i=O.length-1;i>=0;i-- ){var N=O[i];if(N!==this._cellLayer){this._cellProvider.poolCellWidget(N);this._remove(N);}
;}
;for(var i=0,l=this._cells.length;i<l;i++ ){var M=this._cells[i];var K=this._bounds[i];var L=this._cellProvider.getCellWidget(M.firstRow,M.firstColumn);if(L){L.setUserBounds(K.left,K.top,K.width,K.height);L.setUserData(b,M.firstRow);L.setUserData(d,M.firstColumn);L.setUserData(e,M.lastRow-M.firstRow+1);L.setUserData(c,M.lastColumn-M.firstColumn+1);this._add(L);}
;}
;}
,_fullUpdate:function(P,Q,R,S){this.__Ih(P,Q,R.length,S.length);this.__Ii();this._cellLayer.fullUpdate(P,Q,R,S);}
,_updateLayerWindow:function(T,U,V,W){this.__Ih(T,U,V.length,W.length);this.__Ii();this._cellLayer.updateLayerWindow(T,U,V,W);}
},destruct:function(){var X=this._getChildren();for(var i=0;i<X.length;i++ ){X[i].dispose();}
;this._disposeObjects(g,f);this._cellProvider=this.__xj=this._cells=this._bounds=this._spanMap=null;}
});}
)();
