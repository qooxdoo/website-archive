...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.showcase.Browser","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Browser.4907ad23dce1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="demobrowser.demo.showcase.Browser",n="separator-vertical",m="icon/16/actions/go-previous.png",l="keypress",k="Enter",j="icon/16/actions/go-next.png",i="Web Browser",h="icon/16/actions/media-playback-start.png",g="http://qooxdoo.org",f="icon/16/categories/internet.png",b="middle",d="This feature is currently not supported.",c="http://",a="execute";qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.getRoot().add(this._createBrowser(),{left:40,top:30});}
,_createBrowser:function(){var r=new qx.ui.window.Window(i,f);var p=new qx.ui.layout.VBox();p.setSeparator(n);r.setLayout(p);r.setAllowClose(false);r.setContentPadding(0);r.open();var toolbar=new qx.ui.toolbar.ToolBar();r.add(toolbar);var s=new qx.ui.toolbar.Button(null,m);s.addListener(a,function(e){this.iframe.getWindow().history.back();}
,this);toolbar.add(s);var t=new qx.ui.toolbar.Button(null,j);t.addListener(a,function(e){this.iframe.getWindow().history.forward();}
,this);toolbar.add(t);t.setEnabled(false);s.setEnabled(false);t.setToolTipText(d);s.setToolTipText(d);this.txtUrl=new qx.ui.form.TextField().set({marginLeft:1,value:g,padding:2,alignY:b});this.txtUrl.addListener(l,function(e){if(e.getKeyIdentifier()==k){this.surfTo(this.txtUrl.getValue());}
;}
,this);toolbar.add(this.txtUrl,{flex:1});var q=new qx.ui.toolbar.Button(null,h);q.addListener(a,function(e){this.surfTo(this.txtUrl.getValue());}
,this);toolbar.add(q);this.iframe=new qx.ui.embed.Iframe().set({width:400,height:300,minWidth:200,minHeight:150,source:this.txtUrl.getValue(),decorator:null});r.add(this.iframe,{flex:1});return r;}
,surfTo:function(u){if(u.indexOf(c)!==0){u=c+u;this.txtUrl.setValue(u);}
;this.iframe.setSource(u);}
}});}
)();
...
(function(){var b="__pF",a="qx.ui.window.Manager";qx.Class.define(a,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__pF:null,setDesktop:function(c){this.__pF=c;this.updateStack();}
...
,syncWidget:function(){this.__pF.forceUnblockContent();var f=this.__pF.getWindows();var h=this._minZIndex;var m=h+f.length*2;var j=h+f.length*4;var k=null;for(var i=0,l=f.length;i<l;i++ ){var g=f[i];if(!g.isVisible()){continue;}
;k=k||g;if(g.isModal()){g.setZIndex(j);this.__pF.blockContent(j-1);j+=2;k=g;}
else if(g.isAlwaysOnTop()){g.setZIndex(m);m+=2;}
else {g.setZIndex(h);h+=2;}
;if(!k.isModal()&&g.isActive()||g.getZIndex()>k.getZIndex()){k=g;}
;}
;this.__pF.setActiveWindow(k);}
,bringToFront:function(n){var o=this.__pF.getWindows();var p=qx.lang.Array.remove(o,n);if(p){o.push(n);this.updateStack();}
;}
,sendToBack:function(q){var r=this.__pF.getWindows();var s=qx.lang.Array.remove(r,q);if(s){r.unshift(q);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(b);}
});}
)();
(function(){var l="__pH",k="mouseup",j="mousedown",i="losecapture",h="qx.ui.core.MMovable",g="__pI",f="mousemove",d="maximized",c="move-frame",b="Boolean",a="move";qx.Mixin.define(h,{properties:{movable:{check:b,init:true},useMoveFrame:{check:b,init:false}},members:{__pH:null,__pI:null,__pJ:null,__pK:null,__pL:null,__pM:null,__pN:null,__pO:false,__pP:null,__pQ:0,_activateMoveHandle:function(m){if(this.__pH){throw new Error("The move handle could not be redefined!");}
;this.__pH=m;m.addListener(j,this._onMoveMouseDown,this);m.addListener(k,this._onMoveMouseUp,this);m.addListener(f,this._onMoveMouseMove,this);m.addListener(i,this.__pU,this);}
,__pR:function(){var n=this.__pI;if(!n){n=this.__pI=new qx.ui.core.Widget();n.setAppearance(c);n.exclude();qx.core.Init.getApplication().getRoot().add(n);}
;return n;}
,__pS:function(){var location=this.getContainerLocation();var p=this.getBounds();var o=this.__pR();o.setUserBounds(location.left,location.top,p.width,p.height);o.show();o.setZIndex(this.getZIndex()+1);}
,__pT:function(e){var r=this.__pJ;var u=Math.max(r.left,Math.min(r.right,e.getDocumentLeft()));var t=Math.max(r.top,Math.min(r.bottom,e.getDocumentTop()));var q=this.__pK+u;var s=this.__pL+t;return {viewportLeft:q,viewportTop:s,parentLeft:q-this.__pM,parentTop:s-this.__pN};}
,_onMoveMouseDown:function(e){if(!this.getMovable()||this.hasState(d)){return;}
;var parent=this.getLayoutParent();var w=parent.getContentLocation();var x=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isContentBlocked()){this.__pP=parent.getBlockerColor();this.__pQ=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__pO=true;}
;}
;this.__pJ={left:w.left,top:w.top,right:w.left+x.width,bottom:w.top+x.height};var v=this.getContainerLocation();this.__pM=w.left;this.__pN=w.top;this.__pK=v.left-e.getDocumentLeft();this.__pL=v.top-e.getDocumentTop();this.addState(a);this.__pH.capture();if(this.getUseMoveFrame()){this.__pS();}
;e.stop();}
,_onMoveMouseMove:function(e){if(!this.hasState(a)){return;}
;var y=this.__pT(e);if(this.getUseMoveFrame()){this.__pR().setDomPosition(y.viewportLeft,y.viewportTop);}
else {this.setDomPosition(y.parentLeft,y.parentTop);}
;e.stopPropagation();}
,_onMoveMouseUp:function(e){if(!this.hasState(a)){return;}
;this.removeState(a);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__pO){parent.unblockContent();parent.setBlockerColor(this.__pP);parent.setBlockerOpacity(this.__pQ);this.__pP=null;this.__pQ=0;this.__pO=false;}
;}
;this.__pH.releaseCapture();var z=this.__pT(e);this.setLayoutProperties({left:z.parentLeft,top:z.parentTop});if(this.getUseMoveFrame()){this.__pR().exclude();}
;e.stopPropagation();}
,__pU:function(e){if(!this.hasState(a)){return;}
;this.removeState(a);if(this.getUseMoveFrame()){this.__pR().exclude();}
;}
},destruct:function(){this._disposeObjects(g,l);this.__pJ=null;}
});}
)();
...
(function(){var k="mousedown",j="w-resize",i="sw-resize",h="n-resize",g="resizableRight",f="ne-resize",d="se-resize",c="Integer",b="e-resize",a="resizableLeft",z="mousemove",y="move",x="shorthand",w="maximized",v="nw-resize",u="mouseout",t="qx.ui.core.MResizable",s="mouseup",r="losecapture",q="resize-frame",o="resizableBottom",p="s-resize",m="resizableTop",n="Boolean",l="resize";qx.Mixin.define(t,{construct:function(){var A=this.getContainerElement();A.addListener(k,this.__qj,this,true);A.addListener(s,this.__qk,this);A.addListener(z,this.__qm,this);A.addListener(u,this.__qn,this);A.addListener(r,this.__ql,this);var B=this.getContainerElement().getDomElement();if(B==null){B=window;}
;this.__pV=qx.event.Registration.getManager(B).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:n,init:true},resizableRight:{check:n,init:true},resizableBottom:{check:n,init:true},resizableLeft:{check:n,init:true},resizable:{group:[m,g,o,a],mode:x},resizeSensitivity:{check:c,init:5},useResizeFrame:{check:n,init:true}},members:{__pV:null,__pW:null,__pX:null,__pY:null,__qa:null,__qb:null,__qc:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var C=this.__pW;if(!C){C=this.__pW=new qx.ui.core.Widget();C.setAppearance(q);C.exclude();qx.core.Init.getApplication().getRoot().add(C);}
;return C;}
,__qd:function(){var location=this.__qg();var D=this._getResizeFrame();D.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);D.show();D.setZIndex(this.getZIndex()+1);}
,__qe:function(e){var F=this.__pX;var G=this.getSizeHint();var K=this.__qc;var J=this.__qb;var E=J.width;var I=J.height;var H=J.containerWidth;var M=J.containerHeight;var N=J.left;var top=J.top;var L;if((F&this.RESIZE_TOP)||(F&this.RESIZE_BOTTOM)){L=Math.max(K.top,Math.min(K.bottom,e.getDocumentTop()))-this.__qa;if(F&this.RESIZE_TOP){I-=L;M-=L;}
else {I+=L;M+=L;}
...
;}
;if((F&this.RESIZE_LEFT)||(F&this.RESIZE_RIGHT)){L=Math.max(K.left,Math.min(K.right,e.getDocumentLeft()))-this.__pY;if(F&this.RESIZE_LEFT){E-=L;H-=L;}
else {E+=L;H+=L;}
...
,__qf:{'1':h,'2':p,'4':j,'8':b,'5':v,'6':i,'9':f,'10':d},__qg:function(){var O=this.getDecoratorElement();if(O&&O.getDomElement()){return qx.bom.element.Location.get(O.getDomElement());}
else {return this.getContentLocation();}
;}
,__qh:function(e){var location=this.__qg();var P=this.getResizeSensitivity();var S=e.getDocumentLeft();var R=e.getDocumentTop();var Q=this.__qi(location,S,R,P);if(Q>0){Q=Q|this.__qi(location,S,R,P*2);}
;this.__pX=Q;}
,__qi:function(location,T,U,V){var W=0;if(this.getResizableTop()&&Math.abs(location.top-U)<V&&T>location.left-V&&T<location.right+V){W+=this.RESIZE_TOP;}
...
;return W;}
,__qj:function(e){if(!this.__pX||!this.getEnabled()){return;}
;this.addState(l);this.__pY=e.getDocumentLeft();this.__qa=e.getDocumentTop();var bb=this.getContainerLocation();var X=this.__qg();var ba=this.getBounds();this.__qb={top:X.top,left:X.left,containerWidth:bb.right-bb.left,containerHeight:bb.bottom-bb.top,width:X.right-X.left,height:X.bottom-X.top,bounds:qx.lang.Object.clone(ba)};var parent=this.getLayoutParent();var bc=parent.getContentLocation();var Y=parent.getBounds();this.__qc={left:bc.left,top:bc.top,right:bc.left+Y.width,bottom:bc.top+Y.height};if(this.getUseResizeFrame()){this.__qd();}
;this.capture();e.stop();}
,__qk:function(e){if(!this.hasState(l)||!this.getEnabled()){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var bd=this.__qe(e);this.setWidth(bd.containerWidth);this.setHeight(bd.containerHeight);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:bd.parentLeft,top:bd.parentTop});}
;this.__pX=0;this.removeState(l);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__ql:function(e){if(!this.__pX){return;}
...
;}
,__qm:function(e){if(!this.getEnabled()){return;}
;if(this.hasState(l)){var bh=this.__qe(e);if(this.getUseResizeFrame()){var bf=this._getResizeFrame();bf.setUserBounds(bh.viewportLeft,bh.viewportTop,bh.width,bh.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(w)&&!this.__pV.isSessionActive()){this.__qh(e);var bi=this.__pX;var bg=this.getApplicationRoot();if(bi){var be=this.__qf[bi];this.setCursor(be);bg.setGlobalCursor(be);}
else if(this.getCursor()){this.resetCursor();bg.resetGlobalCursor();}
;}
;}
,__qn:function(e){if(this.getCursor()&&!this.hasState(l)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__pW!=null&&!qx.core.ObjectRegistry.inShutDown){this.__pW.destroy();this.__pW=null;}
;this.__pV=null;}
});}
)();
...
;var bm=this.getLayoutProperties();this.__qp=bm.left===undefined?0:bm.left;this.__qo=bm.top===undefined?0:bm.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(z);this._updateCaptionBar();this.fireEvent(p);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(j,qx.event.type.Event,[false,true])){var bn=this.getLayoutProperties();this.__qp=bn.left===undefined?0:bn.left;this.__qo=bn.top===undefined?0:bn.top;this.removeState(z);this.hide();this.fireEvent(V);}
;}
...
;var bo=this.__qp;var top=this.__qo;this.setLayoutProperties({edge:null,left:bo,top:top});this.removeState(z);this._updateCaptionBar();this.fireEvent(q);}
;}
...
;var N=L.getMarginLeft()+L.getMarginRight();N=Math.max(N,this.getSpacing());var I=L.getSizeHint().width+N;this.__sy(L);D-=I;if(E&&E.getVisibility()!=o){E.setVisibility(o);D+=K;var G=E.getMarginLeft()+E.getMarginRight();D+=Math.max(G,this.getSpacing());}
;}
while(D>C);}
else if(this.__sv.length>0){do {var O=this.__sv[0];if(O){var N=O.getMarginLeft()+O.getMarginRight();N=Math.max(N,this.getSpacing());if(O.getDecoratorElement()==null){O.syncAppearance();O.invalidateLayoutCache();}
;var H=O.getSizeHint().width;var M=false;if(this.__sv.length==1&&K>0){var F=N-this.getSpacing();var J=D-K+H+F;M=C>J;}
;if(C>D+H+N||M){this.__sx(O);D+=H;if(E&&this.__sv.length==0){E.setVisibility(n);}
;}
else {return;}
;}
;}
while(C>=D&&this.__sv.length>0);}
;}
,__sx:function(P){P.setVisibility(o);this.__sv.shift();this.fireDataEvent(c,P);}
,__sy:function(Q){if(!Q){return;}
;this.__sv.unshift(Q);Q.setVisibility(n);this.fireDataEvent(t,Q);}
,_getNextToHide:function(){for(var i=this.__sw.length-1;i>=0;i-- ){var R=this.__sw[i];if(R&&R.getVisibility&&R.getVisibility()==o){return R;}
;}
...
;}
;}
,setRemovePriority:function(U,V,W){if(!W&&this.__sw[V]!=undefined){throw new Error("Priority already in use!");}
;this.__sw[V]=U;}
...
;for(var i=0;i<this.__sv.length;i++ ){this.__sv[i].setVisibility(o);}
;this.__sv=[];}
;}
...
;bc.setVisibility(n);}
;}
,__sz:false,_setAllowMenuOpenHover:function(be){this.__sz=be;}
,_isAllowMenuOpenHover:function(){return this.__sz;}
...
(function(){var w="__kP",v="blur",u="Enter",t="__sg",s="__sh",r="mousewheel",q="Up",p="Space",o="Escape",n="event.touch",f="qx.ui.menu.Manager",m="Left",j="Down",c="Right",b="singleton",h="mousedown",g="interval",k="keydown",a="keyup",l="qx.debug",d="keypress";qx.Class.define(f,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__kP=[];var x=document.body;var y=qx.event.Registration;y.addListener(window.document.documentElement,h,this._onMouseDown,this,true);y.addListener(x,r,this._onMouseWheel,this,true);y.addListener(x,k,this._onKeyUpDown,this,true);y.addListener(x,a,this._onKeyUpDown,this,true);y.addListener(x,d,this._onKeyPress,this,true);if(!qx.core.Environment.get(n)){qx.bom.Element.addListener(window,v,this.hideAll,this);}
;this.__sg=new qx.event.Timer;this.__sg.addListener(g,this._onOpenInterval,this);this.__sh=new qx.event.Timer;this.__sh.addListener(g,this._onCloseInterval,this);}
,members:{__si:null,__sj:null,__sg:null,__sh:null,__kP:null,_getChild:function(z,A,B,C){var D=z.getChildren();var length=D.length;var E;for(var i=A;i<length&&i>=0;i+=B){E=D[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
...
;}
;var I=this.__kP;I.push(H);H.setZIndex(1e6+I.length);}
,remove:function(J){if(qx.core.Environment.get(l)){if(!(J instanceof qx.ui.menu.Menu)){throw new Error("Object is no menu: "+J);}
;}
;var K=this.__kP;if(K){qx.lang.Array.remove(K,J);}
;}
,hideAll:function(){var L=this.__kP;if(L){for(var i=L.length-1;i>=0;i-- ){L[i].exclude();}
;}
;}
,getActiveMenu:function(){var M=this.__kP;return M.length>0?M[M.length-1]:null;}
,scheduleOpen:function(N){this.cancelClose(N);if(N.isVisible()){if(this.__si){this.cancelOpen(this.__si);}
;}
else if(this.__si!=N){this.__si=N;this.__sg.restartWith(N.getOpenInterval());}
;}
,scheduleClose:function(O){this.cancelOpen(O);if(!O.isVisible()){if(this.__sj){this.cancelClose(this.__sj);}
;}
else if(this.__sj!=O){this.__sj=O;this.__sh.restartWith(O.getCloseInterval());}
;}
,cancelOpen:function(P){if(this.__si==P){this.__sg.stop();this.__si=null;}
;}
,cancelClose:function(Q){if(this.__sj==Q){this.__sh.stop();this.__sj=null;}
;}
,_onOpenInterval:function(e){this.__sg.stop();this.__si.open();this.__si=null;}
,_onCloseInterval:function(e){this.__sh.stop();this.__sj.exclude();this.__sj=null;}
...
;if(this.__kP.length>0&&!this._isInMenu(R)){this.hideAll();}
;}
,__sk:{"Enter":1,"Space":1},__rY:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var S=this.getActiveMenu();if(!S){return;}
;var T=e.getKeyIdentifier();if(this.__rY[T]||(this.__sk[T]&&S.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var U=this.getActiveMenu();if(!U){return;}
;var V=e.getKeyIdentifier();var X=this.__rY[V];var W=this.__sk[V];if(X){switch(V){case q:this._onKeyPressUp(U);break;case j:this._onKeyPressDown(U);break;case m:this._onKeyPressLeft(U);break;case c:this._onKeyPressRight(U);break;case o:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
...
;}
,_onMouseWheel:function(e){var bF=e.getTarget();bF=qx.ui.core.Widget.getWidgetByElement(bF,true);if(this.__kP.length>0&&!this._isInMenu(bF)){this.hideAll();}
;}
...
;this.__sn();}
,__sn:function(){if(this.isVisible()){if(this.getBlockBackground()){var S=this.getZIndex();this._blocker.blockContent(S-1);}
;}
...
,__so:function(){var bk=this._getMenuBounds();if(!bk){this.addListenerOnce(o,this.__so,this);return;}
...
;this.__sm=bm;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bn){this.getChildControl(m);if(this.__sm){this.__sm.call(this);delete this.__sm;}
;}
...
;this.__so();}
;}
,_onMouseOver:function(e){var bq=qx.ui.menu.Manager.getInstance();bq.cancelClose(this);var br=e.getTarget();if(br.isEnabled()&&br instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(br);var bp=br.getMenu&&br.getMenu();if(bp){bp.setOpener(br);bq.scheduleOpen(bp);this.__sl=bp;}
else {var bs=this.getOpenedButton();if(bs){bq.scheduleClose(bs.getMenu());}
;if(this.__sl){bq.cancelOpen(this.__sl);this.__sl=null;}
;}
;}
...
;if(this.__sl){bt.cancelOpen(this.__sl);}
;}
;}
...
(function(){var c="qx.ui.menu.Layout",b="Integer",a="_applyLayoutChange";qx.Class.define(c,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:a},spanColumn:{check:b,init:1,nullable:true,apply:a},iconColumnWidth:{check:b,init:0,themeable:true,apply:a},arrowColumnWidth:{check:b,init:0,themeable:true,apply:a}},members:{__sp:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,j;var e=this.getSpanColumn();var h=this.__sp=[0,0,0,0];var m=this.getColumnSpacing();var k=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__sp||null;}
...
;var u=this.__sq(w[0]);var x=u.getColumnSizes();var r=u.getSpacingX();var q=qx.lang.Array.sum(x)+r*(x.length-1);if(q<k){x[1]+=k-q;}
...
;}
;}
,__sq:function(z){while(!(z instanceof qx.ui.menu.Menu)){z=z.getLayoutParent();}
;return z;}
...
(function(){var i="hover-button",h="__ks",g="interval",f="mouseover",d="mouseout",c="qx.ui.form.HoverButton",b="hovered",a="Integer";qx.Class.define(c,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(f,this._onMouseOver,this);this.addListener(d,this._onMouseOut,this);this.__ks=new qx.event.AcceleratingTimer();this.__ks.addListener(g,this._onInterval,this);}
,properties:{appearance:{refine:true,init:i},interval:{check:a,init:80},firstInterval:{check:a,init:200},minTimer:{check:a,init:20},timerDecrease:{check:a,init:2}},members:{__ks:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__ks.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(b);}
,_onMouseOut:function(e){this.__ks.stop();this.removeState(b);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
,__sA:function(){var x=this.getChildrenContainer().getChildren();x=x.filter(function(y){return y.getVisibility()==k;}
...
(function(){var k="qx.ui.embed.AbstractIframe",j="name",i="",h="about:blank",g="_applySource",f="qx.event.type.Event",d="_applyFrameName",c="qx.event.type.Data",b="navigate",a="String";qx.Class.define(k,{extend:qx.ui.core.Widget,construct:function(l){qx.ui.core.Widget.call(this);if(l){this.setSource(l);}
;this._getIframeElement().addListener(b,this.__wB,this);}
,events:{"load":f,"navigate":c},properties:{source:{check:a,apply:g,init:h},frameName:{check:a,init:i,apply:d}},members:{_getIframeElement:function(){throw new Error("Abstract method call");}
...
,__wB:function(e){var q=e.getData();if(q){this.setSource(q);}
;this.fireDataEvent(b,q);}
}});}
)();
(function(){var k="no",j="Boolean",i="px",h="event.help",g="gecko",f="auto",d="_applyScrollbar",c="qx.debug",b="DOMNodeInserted",a="__wF",B="_applyNativeHelp",A="yes",z="scrolling",y="/",x="appear",w="engine.name",v="block",u="qx.ui.embed.Iframe",t="iframe",s="mousedown",q="load",r="help",o="mouseup",p="losecapture",m="contextmenu",n="none",l="display";qx.Class.define(u,{extend:qx.ui.embed.AbstractIframe,construct:function(C){if(C!=null){this.__wE=C;}
;qx.ui.embed.AbstractIframe.call(this,C);qx.event.Registration.addListener(document.body,s,this.block,this,true);qx.event.Registration.addListener(document.body,o,this.release,this,true);qx.event.Registration.addListener(document.body,p,this.release,this,true);this.__wF=this._createBlockerElement();this.getContainerElement().add(this.__wF);if((qx.core.Environment.get(w)==g)){this.addListenerOnce(x,function(e){var D=this.getContainerElement().getDomElement();qx.bom.Event.addNativeListener(D,b,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:t},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:j,init:false,apply:B},scrollbar:{check:[f,k,A],nullable:true,themeable:true,apply:d}},members:{__wE:null,__wF:null,renderLayout:function(E,top,F,G){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,E,top,F,G);var I=i;var H=this.getInsets();this.__wF.setStyles({"left":H.left+I,"top":H.top+I,"width":(F-H.left-H.right)+I,"height":(G-H.top-H.bottom)+I});}
,_createContentElement:function(){var J=new qx.html.Iframe(this.__wE);J.addListener(q,this._onIframeLoad,this);return J;}
...
,block:function(){this.__wF.setStyle(l,v);}
,release:function(){this.__wF.setStyle(l,n);}
...
;}
;}
,_syncSourceAfterDOMMove:function(){var S=this.getContentElement().getDomElement();var R=S.src;if(R.charAt(R.length-1)==y){R=R.substring(0,R.length-1);}
;if(R!=this.getSource()){qx.bom.Iframe.getWindow(S).stop();S.src=this.getSource();}
;}
,_applyScrollbar:function(T){this.getContentElement().setAttribute(z,T);}
},destruct:function(){this._disposeObjects(a);qx.event.Registration.removeListener(document.body,s,this.block,this,true);qx.event.Registration.removeListener(document.body,o,this.release,this,true);qx.event.Registration.removeListener(document.body,p,this.release,this,true);}
});}
)();
(function(){var i="element",h="qx.event.type.Event",g="iframe",f="qx.html.Iframe",d="navigate",c="qx.event.type.Data",b="name",a="source";qx.Class.define(f,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,g,k,l);this.setSource(j);this.addListener(d,this.__wB,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(i);}
...
;}
,__wB:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
...
;return h;}
,__px:function(F){var G=function(){qx.bom.Event.removeNativeListener(F,a,G);F.$$url=qx.bom.Iframe.queryCurrentUrl(F);}
