...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration.b19d82814f20.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,addFromDefinition:function(C){var D=this.getRoot();this.__Fb(D,C);}
,__Fb:function(E,F){var G=new F.clazz();var K=qx.lang.Object.clone(F);delete K.clazz;delete K.layout;delete K.children;delete K.id;delete K.listeners;G.set(K);if(F.id!=null){this[F.id]=G;}
;if(F.layout!=null){var H=new F.layout.clazz();var K=qx.lang.Object.clone(F.layout);delete K.clazz;H.set(K);G.setLayout(H);}
;var J=F.children;if(J!=null){for(var i=0;i<J.length;i++ ){if(G instanceof qx.ui.form.Form){this.__RU(G,J[i]);}
else {this.__Fb(G,J[i]);}
;}
;}
...
;}
;}
,__RU:function(L,M){if(M.type==="Header"){L.addGroupHeader(M.label);return;}
