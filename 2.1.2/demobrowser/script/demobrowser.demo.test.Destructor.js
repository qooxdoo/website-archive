...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.f7a956078f33.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="Window: ",d="interval",c="Label: ",b="__ks",a="demobrowser.demo.test.Destructor";qx.Class.define(a,{extend:qx.application.Standalone,members:{__cS:null,__RM:0,__ks:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cS=[];this.currentTest=this.testWindows;this.__ks=new qx.event.Timer(1000);this.__ks.addListener(d,this.runTest,this);this.__ks.start();}
,runTest:function(){this.__RM++ ;var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug("Round: "+this.__RM+" (Registry: "+g+")");this.currentTest();qx.ui.core.queue.Manager.flush();var f=this.__cS;for(var i=0,l=f.length;i<l;i++ ){f[i].destroy();}
;f.length=0;qx.ui.core.queue.Manager.flush();var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug("Done! (Registry: "+g+")");}
,testLabels:function(){for(var i=0;i<250;i++ ){var h=new qx.ui.basic.Label(c+i);this.getRoot().add(h,{left:50,top:50+i*20});this.__cS.push(h);}
;}
,testWindows:function(){for(var i=0;i<5;i++ ){var j=new qx.ui.window.Window(e+i);j.open();this.__cS.push(j);}
;}
