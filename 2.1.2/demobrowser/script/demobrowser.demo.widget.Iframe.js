...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.57a65fb64885.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:n},scrollbarX:{check:[j,f,c],init:j,themeable:true,apply:k},scrollbarY:{check:[j,f,c],init:j,themeable:true,apply:k},scrollbar:{group:[p,o]}},members:{__wC:null,__wD:null,_getIframeElement:function(){return this.getChildControl(a).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__wD){this._stopIframeObserver();}
;var E=qx.event.Idle.getInstance();this.__wD=E.addListener(t,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__wC=null;if(!this.__wD){return;}
;var F=qx.event.Idle.getInstance();F.removeListenerById(this.__wD);}
,_onIframeObserverInterval:function(){var G=this._getIframeSize();if(!G){this._disableScollbars();return;}
;if(this.__wC&&G.width==this.__wC.width&&G.height==this.__wC.height){return;}
;this.__wC=G;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var J=this.__wC;var M=this.getChildControl(a).getBounds();var K=this.getChildControl(a).getInnerSize();if(!J||!K||!K){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__wC=null;}
});}
)();
