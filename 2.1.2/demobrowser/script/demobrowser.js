...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.f0835ae93c75.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="qx.core.BaseInit",f="engine.name",d="os.name",c="engine.version",b='demobrowser.Application',a="";qx.Class.define(g,{statics:{__cU:null,getApplication:function(){return this.__cU||null;}
,ready:function(){if(this.__cU){return;}
;if(qx.core.Environment.get(f)==a){qx.log.Logger.warn("Could not detect engine!");}
;if(qx.core.Environment.get(c)==a){qx.log.Logger.warn("Could not detect the version of the engine!");}
;if(qx.core.Environment.get(d)==a){qx.log.Logger.warn("Could not detect operating system!");}
;qx.log.Logger.debug(this,"Load runtime: "+(new Date-qx.Bootstrap.LOADSTART)+"ms");var i=b;var j=qx.Class.getByName(i);if(j){this.__cU=new j;var h=new Date;this.__cU.main();qx.log.Logger.debug(this,"Main runtime: "+(new Date-h)+"ms");var h=new Date;this.__cU.finalize();qx.log.Logger.debug(this,"Finalize runtime: "+(new Date-h)+"ms");}
...
(function(){var cd="_leftComposite",cc='</div>',cb="__PG",ca="^.*",bY="filled",bX="changeValue",bW="?qxenv:demobrowser.withTests:true",bV="demobrowser.DemoBrowser",bU="load",bT="_infosplit",bC='</span>=<span class="string">',bB="_history",bA="_status",bz='.html',by='<span class="html-tag-name">',bx="_searchTextField",bw="__Px",bv="f1",bu="_prevButton",bt="script/demobrowser.demo",ck="noPlayground",cl='changeSelection',ci="string",cj="__PH",cg='<div class="script">',ch="logappender",ce="_runbutton",cf=".html",cm="_tree",cn="f2",bM="<pre class='script'>",bL="visible",bO="__Ku",bN="ig",bQ="</div></pre>",bP='excluded',bS="_urlWindow",bR='_cmdDisposeSample',bK="toolbar",bJ="__Pw",a="__PI",b="tree1",c="?qxenv:qx.theme:",d="outputviews.sourcepage.html.page",f="demo/welcome.html",g='_cmdSampleInOwnWindow',h=".*",n=" ",o='demo/',p="</pre>",cr="default",cq="__PC",cp="index.html",co="Filter...",cv="__Ps",cu="qx.theme.Indigo",ct="<pre ><div class='script'>",cs='label',cy='http://demo.qooxdoo.org/2.1.2/playground/',cx="changeState",S="__PD",T="icon/16/actions/edit-find.png",Q="right",R="main",W='_cmdObjectSummary',X="Info",U="__PK",V='/',O="file:",P='_cmdNextSample',B='&gt;',A="left",D='_cmdPrevSample',C="\"",x="__PE",w='_cmdRunSample',z="excluded",y="_nextButton",v="src",q="bottom-left",bd="right-top",be="runbutton",bf="__Kq",bg="outputviews.sourcepage.js.page",Y="__PF",ba="_demoView",bb="_navPart",bc="textfield",bh="mainsplit",bi="app-header",L="Demo Browser",K="app-splitpane",J=' <span class="keyword">',I="_iframe",H='</span>',G="interval",F="node",E='execute',N="<script",M=".src.js",bj='value',bk="javascript",bl="\n",bm="widget",bn="horizontal",bo="modelLink",bp="tags",bq="success",br=".",bs="~",bG='\n',bF="fail",bE="value",bD="",bI="enabled",bH="/";qx.Class.define(bV,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__Kq={};var cC=new qx.ui.layout.VBox;this.setLayout(cC);this.add(this._createHeader());this.widgets={};this.tests={};this.__Pr=cu;this.__PL();this.__Ps=this.__PS();this.add(this.__Ps);var cG=new qx.ui.splitpane.Pane(bn);cG.setAppearance(K);this.mainsplit=cG;var cD=new qx.ui.splitpane.Pane(bn);cD.setDecorator(null);this._infosplit=cD;this.add(cG,{flex:1});var cI=this._leftComposite=new qx.ui.container.Composite();cI.setLayout(new qx.ui.layout.VBox(3));cG.add(cI,0);{}
;var cB=new qx.ui.container.Composite();cB.setLayout(new qx.ui.layout.HBox(3));cB.setAppearance(bc);cI.add(cB);var cJ=new qx.ui.basic.Image(T);cB.add(cJ);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(bm);this._searchTextField.setPlaceholder(co);var cH=new qx.event.Timer(500);cH.addListener(G,function(cK){this.filter(this._searchTextField.getValue());cH.stop();}
,this);this._searchTextField.addListener(bX,function(cL){cH.restart();}
,this);cB.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(bD);this._status.setAppearance(bm);this._status.setWidth(80);this._status.setTextAlign(Q);cB.add(this._status);cG.add(cD,1);this._tree=this.__PW();cI.add(this._tree,{flex:1});this.__PX();this._demoView=this.__PT();{cD.add(this._demoView,2);}
;var cz=this.__Pt=this.__PU();var cA=this.__Pu=this.__PV();var cE=this.__Pv=new qxc.ui.logpane.LogView();cE.setDecorator(null);var cF=this.__cH=new qx.ui.container.Stack();cF.setDecorator(R);cF.add(cz);cF.add(cA);cF.add(cE);cD.add(cF,1);cF.resetSelection();cF.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(cx,function(e){var cM=e.getData().replace(bs,bH);if(this._currentSample!=cM){this.setCurrentSample(cM);}
;}
,this);this.__Pw=[this.__PC,this.__PD,this.__PG];{this.__Pw.push(this.__PA);this.__Pw.push(this.__PE);this.__Pw.push(this.__PI);}
;this.__Px=new qx.event.Timer(250);this.__Px.addListener(G,this.__Qa,this);this.__Px.start();this.__Py=new demobrowser.InfoWindow(this.tr(X));this.__Py.setAutoCenter(true);}
,members:{_iframe:null,__Pr:null,__Px:null,__Pz:null,_tree:null,_status:null,_searchTextField:null,__PA:null,__PB:null,__Pw:null,_versionFilter:null,_navPart:null,__PC:null,__PD:null,__PE:null,__PF:null,__PG:null,__PH:null,__PI:null,__Ps:null,_leftComposite:null,_infosplit:null,_demoView:null,__Ku:null,__Kq:null,__PJ:null,_urlWindow:null,__Py:null,__cH:null,__Pt:null,__Pu:null,__Pv:null,__PK:null,defaultUrl:f,playgroundUrl:cy,__PL:function(){this._cmdObjectSummary=new qx.ui.core.Command("Ctrl+O");this._cmdObjectSummary.addListener("execute",this.__PN,this);this._cmdRunSample=new qx.ui.core.Command("F5");this._cmdRunSample.addListener("execute",this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command("Ctrl+Left");this._cmdPrevSample.addListener("execute",this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command("Ctrl+Right");this._cmdNextSample.addListener("execute",this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command("Ctrl+N");this._cmdSampleInOwnWindow.addListener("execute",this.__PO,this);this._cmdDisposeSample=new qx.ui.core.Command("Ctrl+D");this._cmdDisposeSample.addListener("execute",this.__PR,this);}
,__PM:function(e){var cP=e.getTarget()===this.__PK?this.__PJ:this.__PK;var cO=e.getData()[0];if(cP&&cO){cP.setModelSelection([cO.getModel()]);}
;var cN=cO!=null?cO.getUserData("value"):"";switch(cN){case "html":this.__cH.setSelection([this.__Pt]);this.__cH.show();break;case "js":this.__cH.setSelection([this.__Pu]);this.__cH.show();break;case "log":this.__cH.setSelection([this.__Pv]);this.__cH.show();break;default:this.__cH.resetSelection();this.__cH.exclude();};}
,__PN:function(){var cR=this._iframe.getWindow();var cQ;if(cR&&cR.qx){cQ=cR.qx.dev.ObjectSummary.getInfo();}
else {cQ="Unable to access namespace. Maybe no demo loaded.";}
;var cS=new qx.ui.form.TextArea(cQ);cS.setDecorator(null);cS.setAutoSize(true);cS.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__Py.setContent(cS);this.__Py.setWidth(400);this.__Py.show();}
,__PO:function(){var cT=this._iframe.getSource();cT=cT.substr(0,cT.indexOf("?"));{cT+="?qxenv:qx.theme:"+this.__Pr;}
;window.open(cT,"_blank");}
,__PP:function(cU){var cV=!!cU;var cW=this._tree.getSelection()[0].getUserData("tags");if(cW){cV=cV&&!qx.lang.Array.contains(cW,"noPlayground");}
;this.__PA.setEnabled(cV);this.__PB=cU;}
,__PQ:function(){if(this.__PB){var da=this.__PB;var cY='{"code": '+'"'+encodeURIComponent(da)+'"}';var cX=this.playgroundUrl+"#"+encodeURIComponent(cY);window.open(cX,"_blank");}
else {var db=new qx.ui.basic.Label(this.tr("Could not open the Playground."));this.__Py.setContent(db);this.__Py.setWidth(200);this.__Py.show();}
;}
,__MI:function(){window.open('http://demo.qooxdoo.org/2.1.2/apiviewer/');}
,__MJ:function(){var dc=('2.1.2'.split("-")[0]);window.open("http://manual.qooxdoo.org/"+dc);}
,_onHideShowTests:function(event){var de=window.location.search;var df=window.location.hash;var dd=cp;if(de==bD){dd+=bW;}
;dd+=df;location.replace(dd);}
,__PR:function(e){var dh=this._iframe.getWindow();var dg;if(dh&&dh.qx){dh.qx.core.ObjectRegistry.shutdown();dg=this.tr("Demo has been disposed.");}
else {dg=this.tr("Unable to access application.");}
;var di=new qx.ui.basic.Label(dg);di.setRich(true);di.setWrap(true);this.__Py.setContent(di);this.__Py.setWidth(350);this.__Py.show();}
,__PS:function(){var dG=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr("Run"),"icon/22/actions/media-playback-start.png");this._runbutton.addListener("execute",this.runSample,this);this._runbutton.setToolTipText("Run the selected demo");dG.add(this._runbutton);var dJ=new qx.ui.toolbar.Part();dG.add(dJ);var ds=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");ds.addListener("execute",this.playPrev,this);ds.setToolTipText("Run previous demo");dJ.add(ds);this._prevButton=ds;var dE=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");dE.addListener("execute",this.playNext,this);dE.setToolTipText("Run next demo");dJ.add(dE);this._nextButton=dE;var dv={converter:function(dO){return dO=="visible";}
};qx.data.SingleValueBinding.bind(this._runbutton,"visibility",ds,"enabled",dv);qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dE,"enabled",dv);var dM=this._navPart=new qx.ui.toolbar.Part();dG.add(dM);var dN=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");dN.addListener("execute",this.__PO,this);dN.setToolTipText("Open demo in new window");this.__PC=dN;dM.add(dN);{var dB=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");dB.addListener("execute",this.__PQ,this);dB.setToolTipText("Open demo in the playground");dB.setEnabled(false);if(qx.core.Environment.get("browser.name")=="ie"){dB.exclude();}
;this.__PA=dB;dM.add(dB);var dm=new qx.ui.toolbar.Part();dG.add(dm);var dz=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");dm.add(dz);dz.setToolTipText(this.tr("Open the qooxdoo API Viewer"));dz.addListener("execute",this.__MI,this);var dk=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");dm.add(dk);dk.setToolTipText(this.tr("Open the qooxdoo Manual"));dk.addListener("execute",this.__MJ,this);}
;var dH=new qx.ui.toolbar.Part;dG.add(dH);{var dD=new qx.ui.menu.Menu;this.__PF=dD;var dt=new qx.ui.menu.RadioButton("Modern Theme");var dK=new qx.ui.menu.RadioButton("Classic Theme");var dL=new qx.ui.menu.RadioButton("Simple Theme");var dI=new qx.ui.menu.RadioButton("Indigo Theme");dt.setUserData("value","qx.theme.Modern");dK.setUserData("value","qx.theme.Classic");dL.setUserData("value","qx.theme.Simple");dI.setUserData("value","qx.theme.Indigo");dI.setValue(true);var dw=new qx.ui.form.RadioGroup(dt,dK,dL,dI);dw.addListener("changeSelection",this.__Qe,this);dD.add(dI);dD.add(dt);dD.add(dK);dD.add(dL);var du=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dD);this.__PE=dH;du.setToolTipText("Choose theme");dH.add(du);}
;var dx=new qx.ui.menu.Menu;{var dy=new qx.ui.menu.Button(this.tr("Object Summary"));this.__PI=dy;dy.setCommand(this._cmdObjectSummary);dx.add(dy);}
;var dq=new qx.ui.menu.Button(this.tr("Dispose Demo"));this.__PG=dq;dq.setCommand(this._cmdDisposeSample);dx.add(dq);{dx.addSeparator();var dn=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));dn.setValue(!!qx.core.Environment.get("demobrowser.withTests"));dn.addListener("changeValue",this._onHideShowTests,this);dx.add(dn);}
;var dr=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",dx);this.__PH=dr;dr.setToolTipText("Debugging options");dH.add(dr);var dA=new qx.ui.toolbar.Part;this.__PD=dA;dG.addSpacer();dG.add(dA);{var dF=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");dF.setToolTipText("Display HTML source");dF.setModel('html');var dp=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");dp.setToolTipText("Display JavaScript source");dp.setModel('js');dF.setUserData("value","html");dp.setUserData("value","js");dA.add(dF);dA.add(dp);}
;var dC=new qx.ui.toolbar.RadioButton("Log File","icon/22/apps/utilities-log-viewer.png");dC.setToolTipText("Display log file");dC.setUserData("value","log");dC.setModel('log');dA.add(dC);var dj=this.__PK=new qx.ui.form.RadioGroup;dj.setAllowEmptySelection(true);dj.add(dC);dj.addListener('changeSelection',this.__PM,this);{dj.add(dF,dp);}
;dG.setOverflowHandling(true);var dl=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");dl.setAppearance("toolbar-button");dG.add(dl);dG.setOverflowIndicator(dl);dG.setRemovePriority(dA,6);dG.setRemovePriority(dH,5);dG.setRemovePriority(dm,4);dG.setRemovePriority(dM,3);dG.setRemovePriority(dJ,2);dG.setRemovePriority(this._navPart,1);this.__Ku=new qx.ui.menu.Menu();dl.setMenu(this.__Ku);dG.addListener("hideItem",this._onHideItem,this);dG.addListener("showItem",this._onShowItem,this);return dG;}
,_onHideItem:function(e){var dP=e.getData();var dQ=this._getMenuItems(dP);for(var i=0,l=dQ.length;i<l;i++ ){dQ[i].setVisibility(bL);if(dP===this.__PE&&!(dQ[i] instanceof qx.ui.menu.Separator)){dQ[i].getMenu().setPosition(bd);}
;}
;}
,_onShowItem:function(e){var dR=e.getData();var dT=this._getMenuItems(dR);for(var i=0,l=dT.length;i<l;i++ ){dT[i].setVisibility(z);}
;if(dR===this.__PE){var dS=dR.getMenuButtons();for(var i=0,l=dS.length;i<l;i++ ){dS[i].getMenu().setPosition(q);}
;}
;}
,_getMenuItems:function(dU){var dW=[];if(dU instanceof qx.ui.toolbar.Part){var ec=dU.getChildren();var eb=null;var dV=false;var dX=this.__Ku.getChildren();if(dU!=this.__PD){eb=this.__Kq[dU.toHashCode()];if(!eb){eb=new qx.ui.menu.Separator();this.__Ku.addBefore(eb,dX[0]);this.__Kq[dU.toHashCode()]=eb;}
;dW.push(eb);}
else {dV=true;}
;for(var i=0,l=ec.length;i<l;i++ ){if(ec[i].getVisibility()==bP){continue;}
;var dY=this.__Kq[ec[i].toHashCode()];if(!dY){if(ec[i] instanceof qx.ui.toolbar.RadioButton){dY=new qx.ui.menu.RadioButton(ec[i].getLabel());dY.setToolTipText(ec[i].getToolTipText());dY.setEnabled(ec[i].getEnabled());dY.setUserData(bj,ec[i].getUserData(bj));dY.setModel(ec[i].getModel());ec[i].bind(bI,dY,bI);ec[i].bind(bE,dY,bE);dY.bind(bE,ec[i],bE);if(!this.__PJ){this.__PJ=new qx.ui.form.RadioGroup();this.__PJ.setAllowEmptySelection(true);this.__PJ.addListener(cl,this.__PM,this);}
;this.__PJ.add(dY);}
else if(ec[i] instanceof qx.ui.toolbar.MenuButton){dY=new qx.ui.menu.Button(ec[i].getLabel().translate(),ec[i].getIcon(),ec[i].getCommand(),ec[i].getMenu());dY.setToolTipText(ec[i].getToolTipText());dY.setEnabled(ec[i].getEnabled());ec[i].bind(bI,dY,bI);}
else if(ec[i] instanceof qx.ui.toolbar.Button){dY=new qx.ui.menu.Button(ec[i].getLabel().translate(),ec[i].getIcon());dY.getChildControl(cs,false).setRich(true);dY.setTextColor(ec[i].getTextColor());dY.setToolTipText(ec[i].getToolTipText());dY.setEnabled(ec[i].getEnabled());ec[i].bind(bI,dY,bI);var ea=qx.event.Registration.getManager(ec[i]).getListeners(ec[i],E);if(ea&&ea.length>0){for(var j=0,k=ea.length;j<k;j++ ){dY.addListener(E,qx.lang.Function.bind(ea[j].handler,ea[j].context));}
;}
;}
else if(ec[i] instanceof qx.ui.toolbar.CheckBox){dY=new qx.ui.menu.CheckBox(ec[i].getLabel());dY.setToolTipText(ec[i].getToolTipText());dY.setEnabled(ec[i].getEnabled());ec[i].bind(bI,dY,bI);}
else {dY=new qx.ui.menu.Separator();}
;if(dV){this.__Ku.add(dY);}
else {this.__Ku.addBefore(dY,eb);}
;this.__Kq[ec[i].toHashCode()]=dY;}
;dW.push(dY);}
;}
;return dW;}
,__PT:function(){var ed=new qx.ui.embed.Iframe().set({nativeContextMenu:true});ed.addListener("load",this.__PY,this);this._iframe=ed;return ed;}
,__PU:function(){var ee=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");ee.setOverflow("auto","auto");ee.setFont("monospace");ee.setBackgroundColor("white");this.widgets["outputviews.sourcepage.html.page"]=ee;ee.getContentElement().setAttribute("id","qx_srcview");return ee;}
,__PV:function(){var ef=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");ef.setOverflow("auto","auto");ef.setFont("monospace");ef.setBackgroundColor("white");this.widgets["outputviews.sourcepage.js.page"]=ef;ef.getContentElement().setAttribute("id","qx_srcview");return ef;}
,__PW:function(){var eh=new qx.ui.tree.Tree();var eg=new qx.ui.tree.TreeFolder("Demos");eh.setAppearance("demo-tree");eh.setRoot(eg);this.tree=this.widgets["treeview.flat"]=eh;eh.addListener("changeSelection",this.treeGetSelection,this);eh.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return eh;}
,__PX:function(){var ei=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");ei.setLayout(new qx.ui.layout.VBox(10));ei.setAllowMaximize(false);ei.setAllowMinimize(false);var el=new qx.ui.basic.Label("");el.setSelectable(true);el.setNativeContextMenu(true);ei.add(el);this._urlWindow=ei;var em=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(em<0){em=0;}
;var top=Math.ceil((qx.bom.Viewport.getHeight()/2)-25);if(top<0){top=0;}
;ei.moveTo(em,top);this.getApplicationRoot().add(ei);var ej=new qx.ui.menu.Menu();var ek=new qx.ui.menu.Button(this.tr("Get Demo Link"),"icon/22/mimetypes/text-html.png");ek.addListener("execute",function(e){var eo=this.tree.getSelection()[0];var eq=eo.getUserData("modelLink");var en=this.tests.handler.getFullName(eq);en=en.replace(".","~");var ep=location.protocol+"//"+location.host+location.pathname+"#"+en;this._urlWindow.getChildren()[0].setValue(ep);this._urlWindow.open();}
,this);ej.add(ek);this._tree.setContextMenu(ej);}
,treeGetSelection:function(e){var er=this.tree.getSelection()[0];this._runbutton.setEnabled(!er.hasChildren());var es=er.getUserData(bo);this.tests.selected=this.tests.handler.getFullName(es);}
,leftReloadTree:function(e){this._sampleToTreeNodeMap={};var et=this._sampleToTreeNodeMap;var eB=null;var eD=null;var eA=this._history.getState();var ey=eA.match(/([^~]+)~/);if(ey){eB=ey[1];}
else {var eu=eA.match(/([^~][\w]*)/);if(eu){eB=eu[1];}
;}
;function eC(eE,eF){var eJ=eF.getChildren();var t;for(var i=0;i<eJ.length;i++ ){var eG=eJ[i];if(eG.hasChildren()){t=new qx.ui.tree.TreeFolder(ew.polish(eG.label));t.setUserData(bY,false);t.setUserData(F,eG);eC(t,t.getUserData(F));if(eG.label==eB){eD=t;t.setOpen(true);}
;}
else {if(!eG.type){continue;}
;t=new qx.ui.tree.TreeFile(ew.polish(eG.label));var eI=eG.pwd().slice(1).join(bH)+bH+eG.label;if(eG.tags){var j,m,eH;t.setUserData(bp,eG.tags);{}
;}
;et[eI]=t;}
;eE.add(t);t.setUserData(bo,eG);eG.widgetLinkFull=t;}
;}
;var ez=this.tests.handler.ttree;var ew=this;this.tree.setUserData(bo,ez);this.tree.getRoot().setOpen(true);eC(this.tree.getRoot(),ez);{}
;if(eD!=null){this.tree.setSelection([eD]);}
else {this.tree.setSelection([this.tree.getRoot()]);}
;}
,runSample:function(e){if(this.tests.selected&&this.tests.selected!=bD){var eK=this.tests.selected.replace(br,bH);this.setCurrentSample(eK);}
else {this.playNext();}
;}
,setCurrentSample:function(eL){if(!eL){return;}
;if(!this._sampleToTreeNodeMap){return;}
;var eM;var eO=this._sampleToTreeNodeMap[eL];if(eO){eO.getTree().setSelection([eO]);eM=o+eL;{eM+=c+this.__Pr;}
;var eN=eO.getUserData(bp);if(eN){this.__PA.setEnabled(!qx.lang.Array.contains(eN,ck));}
;}
else {eM=this.defaultUrl;}
;if(this._iframe.getSource()==eM){this._iframe.reload();}
else {this.__Pz=false;this.__PE.getChildren()[0].setEnabled(false);this.__PE.getChildren()[1].setEnabled(false);this._iframe.setSource(eM);this._iframe.addListener(bU,function(){window.setTimeout(function(){var eP=this._iframe.getWindow();if(eP&&eP.qx&&eP.qx.theme&&eP.qx.theme.manager&&eP.qx.theme.manager.Meta){this.__PE.getChildren()[0].setEnabled(true);this.__PE.getChildren()[1].setEnabled(true);}
;}
.bind(this),333);}
,this);}
...
,__PY:function(){var eT=this._iframe.getWindow();var fa=this._iframe.getSource();if(fa!=null&&fa!=this.defaultUrl){var eS;try{eS=eT.location.href;}
catch(fc){eS=window.location.href;var fb=eS.lastIndexOf("/");if(fb!=-1){eS=eS.substring(0,fb+1);}
;eS+=fa;}
;var eX=eS.indexOf("/demo/")+6;var eU=eS.indexOf("?");eU=eU==-1?eS.length:eU;var eV=eS.substring(eX,eU).split("/");var eY=String.fromCharCode(187);if(eV.length==2){var eQ=eV[0];eQ=eQ.charAt(0).toUpperCase()+eQ.substring(1);var eW=eV[1].replace(".html","").replace(/_/g," ");eW=eW.charAt(0).toUpperCase()+eW.substring(1);var eR="qooxdoo "+eY+" Demo Browser "+eY+" "+eQ+" "+eY+" "+eW;}
else {var eR="qooxdoo "+eY+" Demo Browser "+eY+" Start";}
;document.title=eR;}
;}
,__Qa:function(e){var fd=this._iframe.getWindow();try{if(fd&&fd.qx&&fd.qx.log&&fd.qx.log.appender){if(!this.__Pz){this.__Pz=true;this.debug("Demo loaded: "+this._currentSample);this.__Pv.clear();try{this.__Pv.fetch(fd.qx.log.Logger);}
catch(fe){return;}
;this._history.addToHistory(this._currentSample.replace(bH,bs),document.title);if(this._currentSampleUrl!=this.defaultUrl){this.__Qb(this._currentSampleUrl);}
;}
;}
else {this.__Pz=false;}
;}
catch(ff){this.__Pz=false;}
;}
,filter:function(fg){var fo=new RegExp(ca+fg+h,bN);var fm=this._tree.getRoot().getItems(true,true);var fn=0;var fh=0;for(var i=0;i<fm.length;i++ ){var fp=fm[i];var parent=fp.getParent();var fl=fp.getUserData(bp);var fi=false;if(fl!=null){for(var j=0;j<fl.length;j++ ){fi=!!fl[j].match(fo);if(fi){break;}
;}
;}
;if(fp.getChildren().length==0){fh++ ;}
;if((fi||(fp.getLabel().search(fo)!=-1)||(parent.getLabel().search(fo)!=-1))){if(fp.getChildren().length==0){fn++ ;}
;fp.show();fp.getParent().setOpen(true);fp.getParent().show();}
else {fp.exclude();}
;}
;if(fg==bD){var fk=this._tree.getRoot().getItems(false,true);var fj=this._tree.getSelection();for(var i=0;i<fk.length;i++ ){if(fk[i]==fj[0]||fk[i]==fj[0].getParent()){continue;}
;fk[i].setOpen(false);}
;}
;this._status.setValue(fn+bH+fh);}
,__Qb:function(fq){if(typeof (fq)!=ci){return;}
;var fr=new qx.io.request.Xhr(fq);fr.setTimeout(180000);fr.addListener(bq,function(fs){var content=fs.getTarget().getResponse();if(content){{var fv=content.indexOf(N,content.indexOf(N)+7);var fB=content.indexOf(v,fv);var fu=content.indexOf(C,fB+5);var fw=content.substring(fB+5,fu);var fz=fw.substring(4,fw.length-3)+M;var u=bt;var fy=fq.split(V);var fx=fy[1];var fA=fy[2];fA=fA.substr(0,fA.indexOf(bz));u+=br+fx+br+fA+M;fz=u;var ft=new qx.io.request.Xhr(fz);ft.setTimeout(18000);ft.addListener(bq,function(){var fC=ft.getResponse();this.__PP(fC);if(fC){this.widgets[bg].setHtml(this.__Qc(fC,bk));}
;}
,this);ft.addListener(bF,function(){this.error("Couldn't load file: "+fq);}
,this);ft.send();this.widgets[d].setHtml(this.__Qc(content));}
;}
;}
,this);fr.addListener(bF,function(fD){this.error("Couldn't load file: "+fq);}
,this);fr.send();}
,dataLoader:function(fE){var fF=new qx.io.request.Xhr(fE);fF.setTimeout(180000);fF.addListener(bq,function(fG){var content=fG.getTarget().getResponse();if(!content){if(window.location.protocol==O){alert("Failed to load demo data from the file system.\n\n"+"The security settings of your browser may prohibit AJAX "+"when using the file protocol. Please try the http protocol "+"instead.");}
;return;}
;var fH=eval(content);qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(fH);this.leftReloadTree();var fI=this._history.getState();if(fI){this.setCurrentSample(fI.replace(bs,bH));}
else {this.setCurrentSample(this.defaultUrl);}
;}
,this,0);}
,this);fF.addListener(bF,function(fJ){this.error("Couldn't load file: "+fE);}
,this);fF.send();}
,playPrev:function(e){var fN=this.tree.getSelection()[0];if(fN){var fK=this.tree.getPreviousNodeOf(fN,false);if(!fK||fK==this.tree.getRoot()){return;}
;while(fK.isVisible&&!fK.isVisible()){fK=this.tree.getPreviousNodeOf(fK,false);}
;if(fK.getParent()==this.tree.getRoot()){var fM=this.tree.getPreviousNodeOf(fK,false);while(fM.isVisible&&!fM.isVisible()){fM=this.tree.getPreviousNodeOf(fM,false);}
;if(fM.getParent()==this.tree.getRoot()){fM.setOpen(true);var fL=this.tree.getPreviousNodeOf(fK,false);while(fL.isVisible&&!fL.isVisible()){fL=this.tree.getPreviousNodeOf(fL,false);}
;if(fM!==fL){fK=fL;}
;}
else {fK=fM;}
;}
;if(!fK||fK===fN){return;}
else {this.tree.setSelection([fK]);this.runSample();}
;}
;}
,playNext:function(e){this._nextButton.setEnabled(true);this._prevButton.setEnabled(true);var fQ=this.tree.getSelection()[0];if(fQ){var fO=this.tree.getNextNodeOf(fQ);if(!fO){return;}
;if(fO.getParent()==this.tree.getRoot()){fO.setOpen(true);fO=this.tree.getNextNodeOf(fO);}
;if(!fO){return;}
;while(!fO.isVisible()){var fP=this.tree.getNextNodeOf(fO);if(!fP){return;}
;if(fP.getParent()==this.tree.getRoot()){fO.setOpen(true);var fP=this.tree.getNextNodeOf(fP);}
;fO=fP;}
;if(fO){this.tree.setSelection([fO]);this.runSample();}
;}
;}
,__Qc:function(fR,fS){var fT=new qx.util.StringBuilder(bM);var fV=[];var fW=new qx.util.StringBuilder();var fX=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var fU=/^\s*<\/script>\s*$/i;fR=fR.replace(/\r\n/g,bl).replace(/\r/g,bl);var fV=fR.split(bG);if(fS==bk){return ct+qx.dev.Tokenizer.javaScriptToHtml(fR)+bQ;}
;for(var i=0;i<fV.length;i++ ){if(fX.exec(fV[i])){fT.add(this.__Qd(qx.bom.String.escape(fW.get()+fV[i])));fW.clear();}
else if(fU.exec(fV[i])){var fY=qx.dev.Tokenizer.javaScriptToHtml(fW.get());fT.add(cg,fY,cc);fW.clear();fW.add(fV[i],bG);}
else {fW.add(fV[i],bG);}
;}
;fT.add(this.__Qd(qx.bom.String.escape(fW.get())),p);return fT.get();}
,disableMenuButtons:function(){var ga=this.__Pw;for(var i=0;i<ga.length;i++ ){ga[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var gb=this.__Pw;for(var i=0;i<gb.length;i++ ){gb[i].setEnabled(true);}
;}
,__Qd:function(gc){var ge=gc;function gd(gf){var s=new qx.util.StringBuilder(arguments[1],by,arguments[2],H);var gg;var gh=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++ ){gg=arguments[i];if(gg==bH){gh=true;break;}
else {var m=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;var r;while((r=m.exec(gg))!=null){s.add(J,r[1],bC,r[2].replace(/\s*$/,bD),H);}
;}
;}
;s.add((gh?bH:bD));}
;s.add(B);return s.get();}
;ge=ge.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,gd);return ge;}
,polish:function(gi){return gi.replace(cf,bD).replace(/_/g,n);}
,__Qe:function(e){this.__Pr=e.getData()[0].getUserData(bE);var gk=this._iframe.getWindow();var gj=gk.qx.Theme.getByName(this.__Pr);if(gj&&gk.qx.theme.manager&&gk.qx.theme.manager.Meta){gk.qx.theme.manager.Meta.getInstance().setTheme(gj);}
;}
,_createHeader:function(){var gn=new qx.ui.layout.HBox();var gl=new qx.ui.container.Composite(gn);gl.setAppearance(bi);var go=new qx.ui.basic.Label(L);var gm=new qxc.ui.versionlabel.VersionLabel();gm.setFont(cr);gl.add(go);gl.add(new qx.ui.core.Spacer,{flex:1});gl.add(gm);return gl;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(bh,b,A,be,bK,bv,cn,bB,ch,W,w,D,P,g,bR,cb,cj,bb,ce,cq,x,Y,S,U,cv,bT,bx,bA,cm,I,ba,bJ,a,bw,cd,bS,y,bu,bf,bO);}
});}
)();
...
;this.__lk.addListener(k,this._onMouseDown,this);this.__lk.addListener(w,this._onMouseUp,this);this.__lk.addListener(g,this._onMouseMove,this);this.__lk.addListener(j,this._onMouseOut,this);this.__lk.addListener(t,this._onMouseUp,this);}
,properties:{appearance:{refine:true,init:C},offset:{check:i,init:6,apply:D},orientation:{init:m,check:[m,o],apply:a}},members:{__mt:null,__mu:false,__mv:null,__mw:null,__mx:null,__my:null,__mz:null,__gk:null,__lk:null,_createChildControlImpl:function(F,G){var H;switch(F){case n:H=new qx.ui.splitpane.Slider(this);H.exclude();this._add(H,{type:F});break;case l:H=new qx.ui.splitpane.Splitter(this);this._add(H,{type:F});H.addListener(f,this.__mA,this);break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);}
,__mA:function(e){this.__mC(e.getData());}
,__mB:function(I){this.__lk=new qx.ui.splitpane.Blocker(I);this.getContentElement().add(this.__lk);var J=this.getChildControl(l);var K=J.getWidth();if(!K){J.addListenerOnce(u,function(){this.__mC();}
,this);}
;J.addListener(c,function(e){var L=e.getData();if(L.height==0||L.width==0){this.__lk.hide();}
else {this.__lk.show();}
;}
,this);}
,getBlocker:function(){return this.__lk;}
,_applyOrientation:function(M,N){var O=this.getChildControl(n);var R=this.getChildControl(l);this.__mx=M===m;if(!this.__lk){this.__mB(M);}
;this.__lk.setOrientation(M);var Q=this._getLayout();if(Q){Q.dispose();}
;var P=M===o?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;this._setLayout(P);R.removeState(N);R.addState(M);R.getChildControl(p).removeState(N);R.getChildControl(p).addState(M);O.removeState(N);O.addState(M);qx.ui.core.queue.Manager.flush();this.__mC();}
,_applyOffset:function(S,T){this.__mC();}
,__mC:function(U){var V=this.getChildControl(l);var ba=this.getOffset();var bb=V.getBounds();var Y=V.getContainerElement().getDomElement();if(!Y){return;}
;if(this.__mx){var X=null;if(U){X=U.width;}
else if(bb){X=bb.width;}
;var bc=U&&U.left;if(X){if(isNaN(bc)){bc=qx.bom.element.Location.getPosition(Y).left;}
;this.__lk.setWidth(ba,X);this.__lk.setLeft(ba,bc);}
;}
...
;this.__lk.setHeight(ba,W);this.__lk.setTop(ba,top);}
;}
;}
...
;var bg=this.getChildControl(l);var bi=bg.getContainerLocation();var bh=this.getContentLocation();this.__mt=this.__mx?e.getDocumentLeft()-bi.left+bh.left:e.getDocumentTop()-bi.top+bh.top;var bk=this.getChildControl(n);var bj=bg.getBounds();bk.setUserBounds(bj.left,bj.top,bj.width,bj.height);bk.setZIndex(bg.getZIndex()+1);bk.show();this.__mu=true;this.__lk.capture();e.stop();}
,_onMouseMove:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__mu){this.__mD();var bl=this.getChildControl(n);var bm=this.__my;if(this.__mx){bl.setDomLeft(bm);this.__lk.setStyle(s,(bm-this.getOffset())+r);}
else {bl.setDomTop(bm);this.__lk.setStyle(A,(bm-this.getOffset())+r);}
;e.stop();}
;}
...
;this._finalizeSizes();var bn=this.getChildControl(n);bn.exclude();this.__mu=false;this.releaseCapture();e.stop();}
,_finalizeSizes:function(){var br=this.__my;var bo=this.__mz;if(br==null){return;}
...
else {if(this.__mx){bs.setWidth(br);bp.setWidth(bo);}
else {bs.setHeight(br);bp.setHeight(bo);}
;}
;}
,__mD:function(){if(this.__mx){var bx=v,bE=b,by=q,bC=this.__mv;}
else {var bx=z,bE=h,by=d,bC=this.__mw;}
;var bD=this._getChildren();var bv=bD[2].getSizeHint();var bA=bD[3].getSizeHint();var bB=bD[2].getBounds()[bE]+bD[3].getBounds()[bE];var bz=bC-this.__mt;var bw=bB-bz;if(bz<bv[bx]){bw-=bv[bx]-bz;bz=bv[bx];}
else if(bw<bA[bx]){bz-=bA[bx]-bw;bw=bA[bx];}
;if(bz>bv[by]){bw+=bz-bv[by];bz=bv[by];}
else if(bw>bA[by]){bz+=bw-bA[by];bw=bA[by];}
;this.__my=bz;this.__mz=bw;}
,_isActiveDragSession:function(){return this.__mu;}
,_setLastMousePosition:function(x,y){this.__mv=x;this.__mw=y;}
...
(function(){var m="separator-vertical",k="_applyShowLogLevel",j="Boolean",h="qxc.ui.logpane.LogView",g='',f="Debug",d="__Nb",c="Log",b="auto",a="icon/16/actions/edit-clear.png",K="Clear",J="DIV",I="middle",H="icon/16/status/dialog-information.png",G="Warning",F="Log Level",E="Error",D="appear",C="main",B="changeLogLevel",t="Info",u="bold",r="icon/16/status/dialog-error.png",s="monospace",p="icon/16/status/dialog-warning.png",q="scroll",n="warn",o="execute",v="error",w="info",y="model",x="icon/16/categories/system.png",A="white",z="debug";qx.Class.define(h,{extend:qx.ui.container.Composite,construct:function(){this.__Na=[[z,f,x],[w,t,H],[n,G,p],[v,E,r]];var O=new qx.ui.layout.VBox();O.setSeparator(m);qx.ui.container.Composite.call(this,O);this.setDecorator(C);var M=new qx.ui.basic.Label(this.tr(c)).set({font:u,padding:10,alignY:I,allowGrowX:true,allowGrowY:true});this.__La=new qx.ui.toolbar.ToolBar();this.__La.add(M);this.__La.addSpacer();this.__La.setBackgroundColor(A);var L=new qx.ui.toolbar.Button(this.tr(K),a);L.addListener(o,function(e){this.clear();}
,this);this.__La.add(L);this.add(this.__La);var N=new qx.ui.embed.Html(g);N.set({backgroundColor:A,overflowY:q,overflowX:b,font:s,padding:3});this.add(N,{flex:1});this.__Nb=new qx.log.appender.Element();qx.log.Logger.unregister(this.__Nb);this.__Nc=document.createElement(J);this.__Nb.setElement(this.__Nc);N.addListenerOnce(D,function(){N.getContentElement().getDomElement().appendChild(this.__Nc);}
,this);}
,properties:{showLogLevel:{check:j,apply:k,init:false},logLevel:{check:[z,w,n,v],init:z,event:B}},members:{__Nc:null,__Nb:null,__Na:null,__Nd:null,__La:null,clear:function(){this.__Nb.clear();}
,fetch:function(P){if(!P){P=qx.log.Logger;}
;P.register(this.__Nb);P.clear();}
,getAppenderElement:function(){return this.__Nc;}
,_applyShowLogLevel:function(Q,R){if(!this.__Nd){this.__Nd=this.__Ne();this.__La.add(this.__Nd);}
;if(Q){this.__Nd.show();}
else {this.__Nd.exclude();}
;}
,__Ne:function(){var S=new qx.ui.menu.Menu();var V=new qx.ui.toolbar.MenuButton(F,x);V.setMenu(S);for(var i=0,l=this.__Na.length;i<l;i++ ){var U=this.__Na[i];var T=new qx.ui.menu.Button(U[1],U[2]);T.setUserData(y,U[0]);T.addListener(o,function(W){var X=W.getTarget();this.setLogLevel(X.getUserData(y));V.setIcon(X.getIcon());}
,this);S.add(T);}
;return V;}
},destruct:function(){this._disposeObjects(d);this.__Nc=null;}
});}
)();
...
,members:{__fX:null,setElement:function(t){this.clear();if(t){qx.bom.element.Class.add(t,k);}
;this.__fX=t;}
,clear:function(){var u=this.__fX;if(u){u.innerHTML=d;}
;}
,process:function(v){var w=this.__fX;if(!w){return;}
...
(function(){var n="request",m="changeTitle",l="abstract",k="_applyState",j="_applyTitle",i="changeState",h="qx.bom.History",g="browser.documentmode",f="qx.event.type.Data",e='#',b="String",d="mshtml",c="engine.name",a="";qx.Class.define(h,{extend:qx.core.Object,type:l,construct:function(){qx.core.Object.call(this);this._baseUrl=window.location.href.split(e)[0]+e;this._titles={};this._setInitialState();}
,events:{"request":f},statics:{SUPPORTS_HASH_CHANGE_EVENT:qx.core.Environment.get("event.hashchange"),getInstance:function(){if(!this.$$instance){if(!(window==window.top)&&qx.core.Environment.get(c)==d&&qx.core.Environment.get(g)>=9){this.$$instance=new qx.bom.HashHistory();}
...
;}
;return this.$$instance;}
},properties:{title:{check:b,event:m,nullable:true,apply:j},state:{check:b,event:i,nullable:true,apply:k}},members:{_titles:null,_applyState:function(o,p){this._writeState(o);}
...
(function(){var i="qx.blankpage",h="undefined",g="#",f="hidden",e="qx.bom.HashHistory",d="absolute",c="interval",b="-1000px",a="";qx.Class.define(e,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this._baseUrl=null;this.__pr();}
,members:{__po:null,__pp:null,__pq:false,addToHistory:function(j,k){if(!qx.lang.Type.isString(j)){j=j+a;}
;if(qx.lang.Type.isString(k)){this.setTitle(k);this._titles[j]=k;}
;if(this.getState()!==j){this._writeState(j);}
;}
,__pr:function(){this.__pp=this.__ps();document.body.appendChild(this.__pp);this.__pt(function(){this._baseUrl=this.__pp.contentWindow.document.location.href;this.__pu();}
,this);}
,__ps:function(){var l=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(i))+g});l.style.visibility=f;l.style.position=d;l.style.left=b;l.style.top=b;return l;}
,__pt:function(m,n,o){if(typeof o===h){o=0;}
;if(!this.__pp.contentWindow||!this.__pp.contentWindow.document){if(o>20){throw new Error("can't initialize iframe");}
;qx.event.Timer.once(function(){this.__pt(m,n, ++o);}
,this,10);return;}
;this.__pq=true;m.call(n||window);}
,__pu:function(){qx.event.Idle.getInstance().addListener(c,this.__pw,this);}
,__pv:function(){qx.event.Idle.getInstance().removeListener(c,this.__pw,this);}
,__pw:function(){var p=this._readState();if(qx.lang.Type.isString(p)&&p!=this.getState()){this._onHistoryLoad(p);}
;}
,_readState:function(){var q=!this._getHash()?a:this._getHash().substr(1);return this._decode(q);}
,_getHash:function(){if(!this.__pq){return null;}
;return this.__pp.contentWindow.document.location.hash;}
,_writeState:function(r){this._setHash(this._encode(r));}
,_setHash:function(s){if(!this.__pp||!this._baseUrl){return;}
;var t=!this.__pp.contentWindow.document.location.hash?a:this.__pp.contentWindow.document.location.hash.substr(1);if(s!=t){this.__pp.contentWindow.document.location.hash=s;}
;}
},destruct:function(){this.__pv();this.__pp=null;}
});}
)();
...
(function(){var p="qx.bom.IframeHistory",o="engine.name",n="mshtml",m="state",l='<html><body><div id="state">',k="browser.version",j="hidden",i="qx.blankpage",h="undefined",g='</div></body></html>',c="absolute",f="request",d="",b="interval",a="-1000px";qx.Class.define(p,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__pC();}
,members:{__pp:null,__pq:false,__py:null,__pz:null,__pA:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);this.__pA=this._getHash();}
,_setHash:function(q){qx.bom.History.prototype._setHash.call(this,q);this.__pA=this._encode(q);}
...
;}
,_setState:function(u){this.__pz=true;this.setState(u);this.__pz=false;}
,_applyState:function(v,w){if(this.__pz){return;}
;this._writeState(v);}
,_readState:function(){if(!this.__pq){return this._decode(this._getHash());}
;var x=this.__pp.contentWindow.document;var y=x.getElementById(m);return y?this._decode(y.innerText):d;}
,_writeState:function(z){if(!this.__pq){this.__pB();this.__py=qx.event.Timer.once(function(){this._writeState(z);}
,this,50);return;}
;this.__pB();var z=this._encode(z);if(qx.core.Environment.get(o)==n&&qx.core.Environment.get(k)!=8){this._setHash(z);}
;var A=this.__pp.contentWindow.document;A.open();A.write(l+z+g);A.close();}
,__pB:function(){if(this.__py){this.__py.stop();this.__py.dispose();}
;}
,__pC:function(){this.__pr(function(){qx.event.Idle.getInstance().addListener(b,this.__pw,this);}
);}
,__pw:function(e){var C=null;var B=this._getHash();if(!this.__pE(B)){C=this.__pD(B);}
else {C=this._readState();}
;if(qx.lang.Type.isString(C)&&C!=this.getState()){this._onHistoryLoad(C);}
;}
,__pD:function(D){D=this._decode(D);this._writeState(D);return D;}
,__pE:function(E){return qx.lang.Type.isString(E)&&E==this.__pA;}
,__pr:function(F){this.__pp=this.__ps();document.body.appendChild(this.__pp);this.__pt(function(){this._writeState(this.getState());if(F){F.call(this);}
;}
,this);}
,__ps:function(){var G=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(i))});G.style.visibility=j;G.style.position=c;G.style.left=a;G.style.top=a;return G;}
,__pt:function(H,I,J){if(typeof J===h){J=0;}
;if(!this.__pp.contentWindow||!this.__pp.contentWindow.document){if(J>20){throw new Error("can't initialize iframe");}
;qx.event.Timer.once(function(){this.__pt(H,I, ++J);}
,this,10);return;}
;this.__pq=true;H.call(I||window);}
},destruct:function(){this.__pp=null;if(this.__py){this.__py.dispose();this.__py=null;}
;qx.event.Idle.getInstance().removeListener(b,this.__pw,this);}
});}
)();
(function(){var d="qx.bom.NativeHistory",c="engine.name",b="hashchange",a="interval";qx.Class.define(d,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__pu();}
,members:{__po:null,__pu:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__po=qx.lang.Function.bind(this.__pw,this);qx.bom.Event.addNativeListener(window,b,this.__po);}
else {qx.event.Idle.getInstance().addListener(a,this.__pw,this);}
;}
,__pv:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,b,this.__po);}
else {qx.event.Idle.getInstance().removeListener(a,this.__pw,this);}
;}
,__pw:function(){var e=this._readState();if(qx.lang.Type.isString(e)&&e!=this.getState()){this._onHistoryLoad(e);}
;}
...
(function(){var g="resize",f="demobrowser.InfoWindow",e="Boolean",d="_applyContent",c="center",b="OK",a="execute";qx.Class.define(f,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);this.setLayout(new qx.ui.layout.VBox(10));this.setMinWidth(200);this.setMaxWidth(qx.bom.Viewport.getWidth()-10);this.setMaxHeight(qx.bom.Viewport.getHeight()-10);this.setShowMinimize(false);this.setShowMaximize(false);this.add(this._getContentContainer(),{flex:1});this.add(this._makeOkButton(),{flex:0});this.addListener(g,this.__Qf,this);}
,properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__Oj:null,_getContentContainer:function(){if(!this.__Oj){this.__Oj=new qx.ui.container.Composite(new qx.ui.layout.Canvas());this.__Oj.setMinHeight(20);}
;return this.__Oj;}
...
,__Qf:function(){if(this.getAutoCenter()){this.center();}
;}
}});}
)();
...
(function(){var m="-",l="PageUp",k="Escape",j="qx.event.type.Data",h="_applyShortcut",g="PrintScreen",f="NumLock",d="5",c="8",b="execute",S="Meta",R="0",Q="2",P="Shift",O="You can only specify one non modifier key!",N="3",M="/",L="Delete",K="String",J="changeEnabled",t="*",u="qx.bom.Shortcut",r="6",s="4",p="1",q="Alt",n="Not a valid key name for a shortcut: ",o="PageDown",v="Whitespaces are not allowed within shortcuts",w="_applyEnabled",B="7",A="a",D="z",C="9",F="Boolean",E="+",y="short",I="keydown",H="",G="Control",x="keypress",z="Unidentified";qx.Class.define(u,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__zW={};this.__zX=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":j},properties:{enabled:{init:true,check:F,event:J,apply:w},shortcut:{check:K,apply:h,nullable:true},autoRepeat:{check:F,init:false}},members:{__zW:H,__zX:H,execute:function(U){this.fireDataEvent(b,U);}
,__zY:function(event){if(this.getEnabled()&&this.__Aa(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__gW:function(event){if(this.getEnabled()&&this.__Aa(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(V,W){if(V){qx.event.Registration.addListener(document.documentElement,I,this.__zY,this);qx.event.Registration.addListener(document.documentElement,x,this.__gW,this);}
else {qx.event.Registration.removeListener(document.documentElement,I,this.__zY,this);qx.event.Registration.removeListener(document.documentElement,x,this.__gW,this);}
;}
,_applyShortcut:function(X,Y){if(X){if(X.search(/[\s]+/)!=-1){var bc=v;this.error(bc);throw new Error(bc);}
;this.__zW={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__zX=null;var ba;var a=[];while(X.length>0&&ba!=-1){ba=X.search(/[-+]+/);a.push((X.length==1||ba==-1)?X:X.substring(0,ba));X=X.substring(ba+1);}
;var bb=a.length;for(var i=0;i<bb;i++ ){var bd=this.__Ac(a[i]);switch(bd){case G:case P:case S:case q:this.__zW[bd]=true;break;case z:var bc=n+a[i];this.error(bc);throw bc;default:if(this.__zX){var bc=O;this.error(bc);throw bc;}
;this.__zX=bd;};}
;}
;return true;}
,__Aa:function(e){var be=this.__zX;if(!be){return false;}
;if((!this.__zW.Shift&&e.isShiftPressed())||(this.__zW.Shift&&!e.isShiftPressed())||(!this.__zW.Control&&e.isCtrlPressed())||(this.__zW.Control&&!e.isCtrlPressed())||(!this.__zW.Meta&&e.isMetaPressed())||(this.__zW.Meta&&!e.isMetaPressed())||(!this.__zW.Alt&&e.isAltPressed())||(this.__zW.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__Ab:{esc:k,ctrl:G,print:g,del:L,pageup:l,pagedown:o,numlock:f,numpad_0:R,numpad_1:p,numpad_2:Q,numpad_3:N,numpad_4:s,numpad_5:d,numpad_6:r,numpad_7:B,numpad_8:c,numpad_9:C,numpad_divide:M,numpad_multiply:t,numpad_minus:m,numpad_plus:E},__Ac:function(bf){var bg=qx.event.util.Keyboard;var bh=z;if(bg.isValidKeyIdentifier(bf)){return bf;}
;if(bf.length==1&&bf>=A&&bf<=D){return bf.toUpperCase();}
;bf=bf.toLowerCase();var bh=this.__Ab[bf]||qx.lang.String.firstUp(bf);if(bg.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bk=this.__zX;var bj=[];for(var bi in this.__zW){if(this.__zW[bi]){bj.push(qx.locale.Key.getKeyName(y,bi));}
;}
;if(bk){bj.push(qx.locale.Key.getKeyName(y,bk));}
;return bj.join(E);}
},destruct:function(){this.setEnabled(false);this.__zW=this.__zX=null;}
});}
)();
...
(function(){var o="^",n="demobrowser.TreeDataHandler",m="ttree",l="\\.[^\\.]+$",h="demobrowser.withTests",g="depth",f="All",e=".",d="",c="test";qx.Class.define(n,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.tmap=p;this.ttree=this.__Qg(p);}
,members:{__Qg:function(q){var s=q;function r(w,x){var A=x.classname;var y=A.split(e);function z(parent,C){if(!C.length){return parent;}
...
(function(){var h="qxc.ui.versionlabel.VersionLabel",g="qooxdoo",f="",e='2.1.2',d='',c=" ",b="versionLabel.name",a="versionLabel.version";qx.Class.define(h,{extend:qx.ui.basic.Label,construct:function(i,j){if(i==undefined){i=qx.core.Environment.get(b);}
;if(j==undefined){j=qx.core.Environment.get(a);if(j==null){j=d;if(j==f){j=e;}
;}
;}
;qx.ui.basic.Label.call(this,i+c+j);}
,defer:function(){qx.core.Environment.add(b,g);qx.core.Environment.add(a,null);}
});}
)();
...
;}
,__wk:function(){{var bh=qx.theme.manager.Color.getInstance();var bj=bh.resolve(this.getStartColor());var bi=bh.resolve(this.getEndColor());}
;return {start:bj,end:bi};}
,_getContent:function(){if(qx.core.Environment.get(E)&&!qx.core.Environment.get(u)){var bm=this.__wk();var bp=this.getOrientation()==z?1:0;var bo=bm.start;var bl=bm.end;if(!qx.util.ColorUtil.isHex6String(bo)){bo=qx.util.ColorUtil.stringToRgb(bo);bo=qx.util.ColorUtil.rgbToHexString(bo);}
;if(!qx.util.ColorUtil.isHex6String(bl)){bl=qx.util.ColorUtil.stringToRgb(bl);bl=qx.util.ColorUtil.rgbToHexString(bl);}
;bo=bo.substring(1,bo.length);bl=bl.substring(1,bl.length);var bn=G;if(this.classname.indexOf(M)!=-1){var bk={};this._styleBoxShadow(bk);bn=e+qx.bom.element.Style.compile(bk)+b;}
...
(function(){var j="innerWidthRight",i="innerColorBottom",h="engine.version",g="innerWidthTop",f="innerColorRight",e="innerColorTop",d="innerColorLeft",c="browser.documentmode",b="relative",a="",F="qx.ui.decoration.MDoubleBorder",E="left",D="box-shadow",C="top",B="innerWidthBottom",A="innerWidthLeft",z="position",y="absolute",x="qx.debug",w="shorthand",q="line-height",r="engine.name",o="mshtml",p="border-top",m="border-left",n="Color",k="border-bottom",l="Number",s="border-right",t='',v="px ",u=" ";qx.Mixin.define(F,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__wp;this._resizeBorder=this.__wo;this._styleBorder=this.__wm;this._generateMarkup=this.__wn;}
,properties:{innerWidthTop:{check:l,init:0},innerWidthRight:{check:l,init:0},innerWidthBottom:{check:l,init:0},innerWidthLeft:{check:l,init:0},innerWidth:{group:[g,j,B,A],mode:w},innerColorTop:{nullable:true,check:n},innerColorRight:{nullable:true,check:n},innerColorBottom:{nullable:true,check:n},innerColorLeft:{nullable:true,check:n},innerColor:{group:[e,f,i,d],mode:w}},members:{__wl:null,__wm:function(G){var M,J,H,L;{var I=qx.theme.manager.Color.getInstance();M=I.resolve(this.getColorTop());J=I.resolve(this.getColorRight());H=I.resolve(this.getColorBottom());L=I.resolve(this.getColorLeft());}
;var K=this.getWidthTop();if(K>0){G[p]=K+v+this.getStyleTop()+u+M;}
;K=this.getWidthRight();if(K>0){G[s]=K+v+this.getStyleRight()+u+J;}
;K=this.getWidthBottom();if(K>0){G[k]=K+v+this.getStyleBottom()+u+H;}
;K=this.getWidthLeft();if(K>0){G[m]=K+v+this.getStyleLeft()+u+L;}
;G[q]=0;if((qx.core.Environment.get(r)==o&&parseFloat(qx.core.Environment.get(h))<8)||(qx.core.Environment.get(r)==o&&qx.core.Environment.get(c)<8)){G[q]=t;}
;G[z]=y;G[C]=0;G[E]=0;if(qx.core.Environment.get(x)){if(!G[p]&&!G[s]&&!G[k]&&!G[m]){throw new Error("Invalid Double decorator (zero outer border width). Use qx.ui.decoration.Single instead!");}
;}
;}
,__wn:function(N){var V,R,P,U;{var Q=qx.theme.manager.Color.getInstance();V=Q.resolve(this.getInnerColorTop());R=Q.resolve(this.getInnerColorRight());P=Q.resolve(this.getInnerColorBottom());U=Q.resolve(this.getInnerColorLeft());}
;var W=qx.lang.Object.clone(N);for(var O in W){if(O.indexOf(D)!=-1){delete W[O];}
;}
;W.position=b;var T=this.getInnerWidthTop();if(T>0){W[p]=T+v+this.getStyleTop()+u+V;}
;T=this.getInnerWidthRight();if(T>0){W[s]=T+v+this.getStyleRight()+u+R;}
;T=this.getInnerWidthBottom();if(T>0){W[k]=T+v+this.getStyleBottom()+u+P;}
;T=this.getInnerWidthLeft();if(T>0){W[m]=T+v+this.getStyleLeft()+u+U;}
;if(qx.core.Environment.get(x)){if(W[p]==t&&W[s]==t&&W[k]==t&&W[m]==t){throw new Error("Invalid Double decorator (zero inner border width). Use qx.ui.decoration.Single instead!");}
;}
;var S=this._generateBackgroundMarkup(W,this._getContent?this._getContent():a);return this.__wl=this._generateBackgroundMarkup(N,S);}
,__wo:function(X,Y,ba){var bb=this.getInsets();Y-=bb.left+bb.right;ba-=bb.top+bb.bottom;var bc=bb.left-this.getWidthLeft()-this.getInnerWidthLeft();var top=bb.top-this.getWidthTop()-this.getInnerWidthTop();return {left:bc,top:top,width:Y,height:ba,elementToApplyDimensions:X.firstChild};}
