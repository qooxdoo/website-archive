...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow.006498725d84.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var x=new qx.ui.layout.LineSizeIterator(A,this.getSpacingX());var y=0;while(x.hasMoreLines()){var z=x.computeNextLine(v);this.__Go(z,y,v);y+=z.height+this.getSpacingY();}
;}
,__Go:function(B,C,D){var F=qx.ui.layout.Util;var I=0;if(this.getAlignX()!=c){I=D-B.width;if(this.getAlignX()==e){I=Math.round(I/2);}
;}
...
;}
,_computeSizeHint:function(){return this.__Gp(Infinity);}
,hasHeightForWidth:function(){return true;}
,getHeightForWidth:function(K){return this.__Gp(K).height;}
,__Gp:function(L){var M=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());var Q=0;var N=0;var O=0;while(M.hasMoreLines()){var P=M.computeNextLine(L);O+=1;N=Math.max(N,P.width);Q+=P.height;}
;return {width:N,height:Q+this.getSpacingY()*(O-1)};}
}});}
)();
(function(){var a="qx.ui.layout.LineSizeIterator";qx.Class.define(a,{extend:Object,construct:function(b,c){this.__gk=b;this.__DB=c;this.__DC=b.length>0;this.__DD=0;}
,members:{__gk:null,__DB:null,__DC:null,__DD:null,computeNextLine:function(d){var d=d||Infinity;if(!this.__DC){throw new Error("No more lines to compute");}
;var o=this.__gk;var m=0;var f=0;var n=[];var j=[];for(var i=this.__DD;i<o.length;i++ ){var l=o[i];var p=l.getSizeHint();var h=this.__DE(i);var g=p.width+h;var e=i==this.__DD;if(!e&&f+g>d){this.__DD=i;break;}
;var k=p.height+l.getMarginTop()+l.getMarginBottom();n.push(l);j.push(h);f+=g;m=Math.max(m,k);if(l.getLayoutProperties().lineBreak){this.__DD=i+1;break;}
;}
;if(i>=o.length){this.__DC=false;}
;return {height:m,width:f,children:n,gapsBefore:j};}
,__DE:function(q){var r=q==this.__DD;if(r){return this.__gk[q].getMarginLeft();}
else {return Math.max(this.__gk[q-1].getMarginRight(),this.__gk[q].getMarginLeft(),this.__DB);}
;}
,hasMoreLines:function(){return this.__DC;}
}});}
)();
