...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.3c3b3f24581f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(u);var D={"width":f,"height":w,"position":l,"left":o,"top":o,"background":i+G+n};this.__Ah=new qx.html.Element(m,D);this.__Ah.addListener(k,this.__or,this);this.__Ah.addListener(B,this.__oq,this);F.add(this.__Ah);}
,__or:function(e){if(e.isMultiTouch()){this.__KN=e.getRotation()+this.__KM;this.__KO=e.getScale()*this.__KL;this.__Ah.setStyle(C,r+this.__KN+g+this.__KO+n);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__Ah.getStyle(A))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__Ah.getStyle(j))/2);this.__Ah.setStyles({"left":I+q,"top":top+q});}
;}
,__oq:function(e){if(e.isMultiTouch()){this.__KM=this.__KN;this.__KL=this.__KO;}
;}
}});}
)();
