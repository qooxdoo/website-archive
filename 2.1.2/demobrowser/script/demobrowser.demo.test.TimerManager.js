...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager.6c2fc8093082.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="__mX",e="One-shot 1-second timer: ",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";qx.Class.define(d,{extend:qx.application.Standalone,members:{__mX:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();i.start(function(j,k){this.__RN(c+k);}
,5000,this,null,0);i.start(function(l,m){this.__RN(e+m);}
,0,this,null,1000);i.start(function(n,o){this.__RN(g+o);if( ++n.count==3){this.__RN(h);i.stop(o);}
;}
,2000,this,{count:0},2000);}
,__RN:function(p){p=Date.parse(new Date)+" "+p+"\n";this.__mX.setValue(this.__mX.getValue()+p);}
,main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.layout.VBox(5);var q=new qx.ui.container.Composite(r);var s=new qx.ui.form.Button(b);s.set({allowGrowX:false,allowGrowY:false});s.addListener(a,function(){s.setEnabled(false);this.startTimers();}
,this);var t=new qx.ui.form.TextArea();t.set({width:400,height:300});this.__mX=t;q.add(t);q.add(s);this.getRoot().add(q,{left:20,top:10});}
