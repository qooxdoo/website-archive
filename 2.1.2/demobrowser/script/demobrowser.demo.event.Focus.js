...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Focus.da5e22bc2747.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="demobrowser.demo.event.Focus",n="mshtml",m="blur",l="focusout",k="webkit",j="focus",i="#E8ECF6",h="deactivate",g="activate",f="1px solid black",b="focusin",d="engine.name",c="",a="1px dotted red";qx.Class.define(o,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.event.Registration.addListener(document.documentElement,g,this._onActivate,this,true);qx.event.Registration.addListener(document.documentElement,h,this._onDeactivate,this,true);qx.event.Registration.addListener(document.documentElement,b,this._onFocusIn,this);qx.event.Registration.addListener(document.documentElement,l,this._onFocusOut,this);qx.event.Registration.addListener(window,j,this._onWindowFocus,this);qx.event.Registration.addListener(window,m,this._onWindowBlur,this);}
,_onWindowFocus:function(e){this.debug("Window focussed");}
,_onWindowBlur:function(e){this.debug("Window blurred");}
,_onActivate:function(e){this.debug("Activate: "+e.getTarget());e.getTarget().style.background=i;}
,_onDeactivate:function(e){this.debug("Deactivate: "+e.getTarget());e.getTarget().style.background=c;}
,_onFocusIn:function(e){this.debug("FocusIn: "+e.getTarget());if(qx.core.Environment.get(d)==k){e.getTarget().style.border=a;}
else {e.getTarget().style.outline=a;}
;}
,_onFocusOut:function(e){this.debug("FocusOut: "+e.getTarget());if(qx.core.Environment.get(d)==n){e.getTarget().style.border=f;}
else {e.getTarget().style.outline=c;}
;}
}});}
)();
