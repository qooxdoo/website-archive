...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ResizeEvent.4352fb4fd77c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="resize",d="demobrowser.demo.test.ResizeEvent",c="red",b="click",a="blue";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.core.Widget().set({backgroundColor:c,width:80});var g=new qx.ui.core.Widget().set({backgroundColor:a});this.getRoot().add(h,{left:10,top:10});this.getRoot().add(g,{left:10,top:110});h.addListener(f,function(e){this.debug("Resize red");g.setWidth(e.getData().width);}
