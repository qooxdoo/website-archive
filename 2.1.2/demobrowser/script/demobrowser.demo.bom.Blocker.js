...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker.97b725fa7363.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__JG:null,__wF:null,__JH:null,__JI:false,__JJ:10000,__JK:0,__JL:"transparent",block:function(j){if(!this.__JI){this.__JH=j;var k=this.__JO();this.__JP(k);this.__JI=true;}
;}
,unblock:function(){if(this.__JI){this.__JQ();this.__JI=false;}
;}
,isBlocked:function(){return this.__JI;}
,getBlockerElement:function(){return this.__wF;}
,setBlockerColor:function(l){qx.bom.element.Style.set(this.__wF,d,l);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wF,d);}
,setBlockerOpacity:function(m){qx.bom.element.Opacity.set(this.__wF,m);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wF);}
,setBlockerZIndex:function(n){qx.bom.element.Style.set(this.__wF,b,n);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wF,b);}
,__bf:function(){this.__JM();if((qx.core.Environment.get(h)==i)){this.__JN();}
;qx.event.Registration.addListener(window,f,this.__lr,this);}
,__JM:function(){this.__wF=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(this.__wF,{display:"block",opacity:this.__JK,backgroundColor:this.__JL});this.setBlockerZIndex(this.__JJ);}
,__JN:function(){this.__JG=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__JG,"allowTransparency",false);qx.bom.element.Attribute.set(this.__JG,"src","javascript:false;");qx.bom.element.Style.setStyles(this.__JG,{display:"block",opacity:this.__JK});}
,__JO:function(){var o={position:"absolute"};if(this.__JS()){o.left="0px";o.top="0px";o.right=null;o.bottom=null;o.width=qx.bom.Document.getWidth()+"px";o.height=qx.bom.Document.getHeight()+"px";}
else {o.width=qx.bom.element.Dimension.getWidth(this.__JH)+"px";o.height=qx.bom.element.Dimension.getHeight(this.__JH)+"px";o.left=qx.bom.element.Location.getLeft(this.__JH)+"px";o.top=qx.bom.element.Location.getTop(this.__JH)+"px";}
;return o;}
,__JP:function(p){var q=document.body;qx.bom.element.Style.setStyles(this.__wF,p);qx.dom.Element.insertEnd(this.__wF,q);if((qx.core.Environment.get("engine.name")=="mshtml")){p.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__JG,p);qx.dom.Element.insertEnd(this.__JG,document.body);}
;}
,__JQ:function(){qx.dom.Element.remove(this.__wF);if((qx.core.Environment.get("engine.name")=="mshtml")){qx.dom.Element.remove(this.__JG);}
;}
,__lr:function(e){if(this.__JS()){this.__JR({width:a,height:a});qx.event.Timer.once(function(){var r={width:qx.bom.Document.getWidth()+c,height:qx.bom.Document.getHeight()+c};this.__JR(r);}
,this,0);}
;}
,__JR:function(s){qx.bom.element.Style.setStyles(this.__wF,s);if((qx.core.Environment.get("engine.name")=="mshtml")){qx.bom.element.Style.setStyles(this.__JG,s);}
;}
,__JS:function(){return (this.__JH==null||qx.dom.Node.isWindow(this.__JH)||qx.dom.Node.isDocument(this.__JH));}
},destruct:function(){qx.event.Registration.removeListener(window,f,this.__lr,this);this.__JG=this.__wF=this.__JH=null;}
});}
)();
