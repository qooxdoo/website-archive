...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Validation.bf62238166d4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(E,{extend:qx.core.Object,properties:{name:{init:s,validate:d},age:{init:18,validate:qx.util.Validate.number()},gender:{init:z,validate:qx.util.Validate.inArray([z,u])}},members:{__RV:function(T){if(T.length<2){throw new qx.core.ValidationError("Validation Error: Name "+"must be longer than one characters. ("+T+")");}
;}
}});}
)();
