...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight.78a152c2fdbe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="small icon",u="This, too, is tall.",t="No attributes specified.",s="1*",q="demobrowser/demo/icons/",p="",o="TALL ICON",n="I am tall.",m="red",l="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",d="format-justify-left.png",k="I am small.",g="end",c="multimedia-player.png",b="This, too, is small.",f="Id",e="Image",h="Note variable row heights in this table.",a="row";qx.Class.define(l,{extend:qx.application.Standalone,members:{__RC:null,main:function(){qx.application.Standalone.prototype.main.call(this);var A=q;this.imageData=[{url:A+d,height:4,tooltip:v},{url:A+c,height:4,tooltip:o},p];this.__RC=0;var y=qx.util.AliasManager.getInstance();var x=qx.util.ResourceManager.getInstance();var w;var z;for(var i=0;i<this.imageData.length;i++ ){if(!this.imageData[i]){continue;}
;w=y.resolve(this.imageData[i].url);z=x.toUri(w);this.imageData[i].url=z; ++this.__RC;qx.io.ImageLoader.load(z,function(B,C){this.info("Searching for ["+B+"]");for(var j=0;j<this.imageData.length;j++ ){if(this.imageData[j].url==B){this.imageData[j].height=C.height; --this.__RC;this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__RC+", end="+this.imageData.length);if(this.__RC==0){this.doLoad();}
;return;}
;}
;throw new Error("Image data for "+B+" not found");}
,this);}
;if(this.__RC==0){this.doLoad();}
;}
...
,members:{__yJ:null,getBlankImage:function(){return this.__yJ;}
...
,_getContentHtml:function(A){var B=[];var C=this.__yK(A);B.push(o);if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(C.url)){B.push(i,this.__yJ,n,c,C.url,e,a);}
...
,__yK:function(D){var E=this._identifyImage(D);if(E==null||typeof E==f){E={url:E,tooltip:null};}
;if(E.url==null){E.url=this.__yJ;}
;return E;}
}});}
)();
(function(){var c="qx.ui.progressive.renderer.table.cell.Image",b="string",a="";qx.Class.define(c,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(d,e){qx.ui.progressive.renderer.table.cell.Icon.call(this);if(d===undefined){this.__yL=d;}
else {this.__yL=16;}
;if(e===undefined){this.__yM=e;}
else {this.__yM=16;}
;}
,members:{__yL:null,__yM:null,_identifyImage:function(f){var j={imageWidth:this.__yL,imageHeight:this.__yM};var k;if(typeof (f.cellData)==b){j.url=f.cellData;}
