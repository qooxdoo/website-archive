...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional.b6f17c9d1727.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Fo.push({condition:z,align:B,color:C,style:D,weight:E,value1:A,target:F});}
,addBetweenCondition:function(G,H,I,J,K,L,M,N){if(!qx.lang.Array.contains(this.__Fn,G)||H==null||I==null){throw new Error("Condition not recognized or value1/value2 is null!");}
;this.__Fo.push({condition:G,align:J,color:K,style:L,weight:M,value1:H,value2:I,target:N});}
,addRegex:function(O,P,Q,R,S,T){if(!O){throw new Error("regex cannot be null!");}
;this.__Fo.push({condition:h,align:P,color:Q,style:R,weight:S,regex:O,target:T});}
,_getCellStyle:function(U){if(this.__Fo.length==0){return U.style||g;}
;var i;var Y;var V;var X={"text-align":this.__Fp,"color":this.__Fq,"font-style":this.__Fr,"font-weight":this.__Fs};for(i=0;i<this.__Fo.length;i++ ){var bc=this.__Fo[i];Y=false;if(qx.lang.Array.contains(this.__Fm,bc.condition)){if(bc.target==null){V=U.cellData;}
...
;break;};}
else if(qx.lang.Array.contains(this.__Fn,bc.condition)){if(bc.target==null){V=U.cellData;}
else {V=U.element.data[bc.target];}
...
;}
;return ba.join(g);}
},destruct:function(){this.__Fm=this.__Fn=this.__Fo=null;}
});}
)();
