...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.SelectBox_EdgeCases.fcc7120844a5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__nC:function(e){var E=e.getData()[0];var D=this.getChildControl(l);if(D.getSelection()[0]!=E){if(E){D.setSelection([E]);}
else {D.resetSelection();}
;}
;this.__DF();this.__DG();}
,__DF:function(){var G=this.getChildControl("list").getSelection()[0];var H=this.getChildControl("atom");var F=G?G.getIcon():"";F==null?H.resetIcon():H.setIcon(F);}
,__DG:function(){var K=this.getChildControl("list").getSelection()[0];var L=this.getChildControl("atom");var J=K?K.getLabel():"";var I=this.getFormat();if(I!=null){J=I.call(this,K);}
...
;var N=e.getWheelDelta(b)>0?1:-1;var P=this.getSelectables();var O=this.getSelection()[0];if(!O){if(!P[0]){return;}
;O=P[0];}
...
;}
,_onListChangeSelection:function(e){var T=e.getData();var W=e.getOldData();if(W&&W.length>0){W[0].removeListener(s,this.__DF,this);W[0].removeListener(t,this.__DG,this);}
...
;T[0].addListener(s,this.__DF,this);T[0].addListener(t,this.__DG,this);}
