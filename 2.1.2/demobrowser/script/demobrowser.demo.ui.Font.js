...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Font.ceb9b9ed9cdd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="demobrowser.demo.ui.Font",n="24px sans-serif",m="red",l="Serif, 16px",k="24px serif",j="16px serif",i="Hello World",h="Sans Serif, 24px",g="Sans Serif, 16px",f="Sans Serif, 24px bold",c="24px sans-serif bold",e="solid",d="Serif, 24px",b="16px sans-serif",a="execute";qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var q=new qx.ui.basic.Label(i).set({decorator:new qx.ui.decoration.Single(1,e,m)});this.getRoot().add(q,{left:20,top:20});var p=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:10}));this.getRoot().add(p,{left:200,top:20});var t=new qx.ui.form.Button(l);p.add(t);var u=new qx.ui.form.Button(d);p.add(u);var v=new qx.ui.form.Button(g);p.add(v);var r=new qx.ui.form.Button(h);p.add(r);var s=new qx.ui.form.Button(f);p.add(s);t.addListener(a,function(){q.setFont(qx.bom.Font.fromString(j));}
);u.addListener(a,function(){q.setFont(qx.bom.Font.fromString(k));}
);v.addListener(a,function(){q.setFont(qx.bom.Font.fromString(b));}
);r.addListener(a,function(){q.setFont(qx.bom.Font.fromString(n));}
);s.addListener(a,function(){q.setFont(qx.bom.Font.fromString(c));}
);}
}});}
)();
