...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Timing.022c985ac2f8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="#91C9E8",p="div",o="#B4DCED",n="ease-in-out",m="ease",l="100px",k="demobrowser.demo.animation.Timing",j="#E8F8FF",h="linear",g="#3399CC",c="bar",f=".bar",e="#67B8DE",b="ease-in",a="ease-out",d="700px";qx.Class.define(k,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var v=[m,h,b,a,n];var t=[g,e,r,o,j];for(var i=0;i<v.length;i++ ){var s=v[i];var u=document.createElement(p);u.innerHTML=s;u.className=c;u.style.backgroundColor=t[i%t.length];document.body.appendChild(u);}
;this.start();window.setInterval(this.start,3000);}
,start:function(){q(f).forEach(function(w){var x=w.innerHTML;q(w).animate({timing:x,duration:2000,keep:100,keyFrames:{'0':{width:l},'100':{width:d}}});}
);}
}});}
)();
