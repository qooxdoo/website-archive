...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Form.91bd3f95fe39.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="changeModel",g="qx.core.Object",f="qx.data.controller.Object",e="get",d="reset",c="_applyModel",b="last",a="[";qx.Class.define(f,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bg={};this.__gw=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:g,event:h,apply:c,nullable:true,dereference:true}},members:{__gw:null,__bg:null,_applyModel:function(k,l){for(var i=0;i<this.__gw.length;i++ ){var t=this.__gw[i][0];var q=this.__gw[i][1];var o=this.__gw[i][2];var r=this.__gw[i][3];var s=this.__gw[i][4];var n=this.__gw[i][5];if(l!=undefined&&!l.isDisposed()){this.__Gw(t,q,o,l);}
;if(k!=undefined){this.__Gv(t,q,o,r,s,n);}
...
;}
;}
,addTarget:function(u,v,w,x,y,z){this.__gw.push([u,v,w,x,y,z]);this.__Gv(u,v,w,x,y,z);}
,__Gv:function(A,B,C,D,E,F){if(this.getModel()==null){return;}
...
,removeTarget:function(J,K,L){this.__Gw(J,K,L,this.getModel());for(var i=0;i<this.__gw.length;i++ ){if(this.__gw[i][0]==J&&this.__gw[i][1]==K&&this.__gw[i][2]==L){this.__gw.splice(i,1);}
;}
;}
,__Gw:function(M,N,O,P){if(!(M instanceof qx.core.Object)){return;}
