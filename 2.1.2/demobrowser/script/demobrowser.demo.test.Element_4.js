...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_4.182887959c4b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="el2",h="el5",g="el1",f="demobrowser.demo.test.Element_4",e="el3",d="el4",c="test",b="doc",a="id";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);this.info("Create document");var j=new qx.html.Root(document.getElementById(c));j.setAttribute(a,b);this.info("Create five elements (2 hidden)");var m=new qx.html.Element;m.setAttribute(a,g);var k=new qx.html.Element;k.setAttribute(a,i);var l=new qx.html.Element;l.setAttribute(a,e);var n=new qx.html.Element;n.setAttribute(a,d);var o=new qx.html.Element;o.setAttribute(a,h);j.add(m,k,l,n,o);k.hide();n.hide();qx.html.Element.flush();this.info("Show one of the two hidden elements");k.show();qx.html.Element.flush();this.info("Hide a rendered element");l.hide();qx.html.Element.flush();this.info("Exclude & show together");l.exclude();l.show();qx.html.Element.flush();this.info("Include one and hide another element");l.include();k.hide();qx.html.Element.flush();}
}});}
)();
