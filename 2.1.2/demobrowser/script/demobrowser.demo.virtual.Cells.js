...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells.1a517f13fe73.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,testStringCell:function(){var J={value:[v,s,u,null],states:[{},{selected:1}]};var I=new qx.ui.virtual.cell.String;qx.util.Permutation.permute(J,function(K){var L=this.__In(I,K.value,K.states);this.container.add(L);}
,this);}
...
;var P=this.__In(N,O.value,O.states);this.container.add(P);}
,this);}
...
;var T=this.__In(R,S.value,S.states);this.container.add(T);}
,this);}
,testHtmlCell:function(){var U={value:[v,s,u,null],states:[{},{selected:1}]};var V=new qx.ui.virtual.cell.Html;qx.util.Permutation.permute(U,function(W){var X=this.__In(V,W.value,W.states);this.container.add(X);}
,this);}
,testImageCell:function(){var Y={value:[{url:p,tooltip:n},{url:w,tooltip:y},null],states:[{},{selected:1}]};var ba=new qx.ui.virtual.cell.Image;qx.util.Permutation.permute(Y,function(bb){var bc=this.__In(ba,bb.value,bb.states);this.container.add(bc);}
,this);}
,testBooleanCell:function(){var bd={value:[true,false,null],states:[{},{selected:1}]};var be=new qx.ui.virtual.cell.Boolean;qx.util.Permutation.permute(bd,function(bf){var bg=this.__In(be,bf.value,bf.states);this.container.add(bg);}
,this);}
,testBooleanCellCustomImage:function(){var bh={value:[true,false,null],states:[{},{selected:1}]};var bi=new qx.ui.virtual.cell.Boolean;bi.setIconFalse(o);bi.setIconTrue(m);qx.util.Permutation.permute(bh,function(bj){var bk=this.__In(bi,bj.value,bj.states);this.container.add(bk);}
,this);}
,__In:function(bl,bm,bn){var br=100;var bp=30;var bt=new qx.ui.embed.Html().set({width:br,height:bp,decorator:bn.selected?null:r});var bo=bl.getCellProperties(bm,bn);var bq=bo.insets;var bs=[g,k,this._getCellSizeStyle(br,bp,bq[0],bq[1]),bo.style,l,e,bo.classes,l,bo.attributes,F,bo.content,h].join(u);bt.setHtml(bs);return bt;}
...
(function(){var j="qx.ui.virtual.cell.AbstractImage",i="engine.version",h="string",g="static",f='"',e='<div style="',d='/>',c='<img src="',b='title="',a='></div>',v="img",u="top",t="gecko",s="engine.name",r='" style="',q="abstract",p="inline-block",o="-moz-inline-box",n="px",m='" ',k="no-repeat",l="";qx.Class.define(j,{extend:qx.ui.virtual.cell.Cell,type:q,construct:function(){qx.ui.virtual.cell.Cell.call(this);this._aliasManager=qx.util.AliasManager.getInstance();}
,members:{__zA:16,__zB:16,_aliasManager:null,__zD:function(w){var z=qx.util.ResourceManager.getInstance();var y=qx.io.ImageLoader;var x,A;if(z.has(w)){x=z.getImageWidth(w),A=z.getImageHeight(w);}
else if(y.isLoaded(w)){x=y.getWidth(w);A=y.getHeight(w);}
else {x=this.__zA;A=this.__zB;}
;return {width:x,height:A};}
,__Dy:function(B){if(typeof (B)==h){B={url:B};}
...
(function(){var e="_applyIconFalse",d="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",b="cell-boolean",a="String";qx.Class.define(d,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__FI=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:b},iconTrue:{check:a,themeable:true,apply:c},iconFalse:{check:a,themeable:true,apply:e}},members:{__FJ:null,__FK:null,__FI:null,_applyIconTrue:function(f){this.__FJ=this.__FI.resolve(f);}
