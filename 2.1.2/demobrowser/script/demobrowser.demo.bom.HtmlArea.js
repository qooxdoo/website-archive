...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea.ca890d3a8aea.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var x="FontSize: ",w="white",v="",u="350px",t='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',s="demobrowser.demo.bom.HtmlArea",r="traditional web pages / single-page applications.<br/> ",p="innerHTML",o="<p>This low-level widget can be used separately at ",n="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",d="blank.html",m="20px 20px",h="You can play around with this widget by hitting the ",c="<h1>HtmlArea low-level widget</h1>",b="buttons at the toolbar.</p>",g="It is the foundation for the UI widget component.</p>",f="1px solid #AAA",k="840px",a="div",l="0px";qx.Class.define(s,{extend:qx.application.Native,members:{__Fi:null,__Qh:null,__Qi:null,__NN:null,__kS:null,main:function(){qx.application.Native.prototype.main.call(this);this.__Fi=qx.dom.Element.create(a);qx.bom.element.Style.setStyles(this.__Fi,{margin:m});var A=qx.dom.Element.create(a);qx.bom.element.Style.setStyles(A,{width:k,padding:l,margin:l});var z=c+o+r+g+n+h+b;qx.bom.element.Attribute.set(A,p,z);this.__Qh=qx.dom.Element.create(a);qx.bom.element.Style.setStyles(this.__Qh,{width:k,padding:l,margin:l,lineHeight:l,border:f});this.__Qi=qx.dom.Element.create(a);qx.bom.element.Style.setStyles(this.__Qi,{width:k,height:u,border:f,borderTop:l,backgroundColor:w});qx.dom.Element.insertEnd(this.__Qi,this.__Fi);var y=t;this.__NN=new qx.bom.htmlarea.HtmlArea(this.__Qi,y,null,d);this.__NX();qx.dom.Element.insertBegin(this.__Qh,this.__Fi);qx.dom.Element.insertBegin(A,this.__Fi);qx.dom.Element.insertBegin(this.__Fi,document.body);}
,__Qj:function(e){var B=window.prompt(x,v);this.setFontSize(parseInt(B));}
,__NO:function(e){var C=window.prompt("Color (Hex): ","#");this.setTextColor(C);}
,__NP:function(e){var D=window.prompt("BgColor (Hex): ","#");this.setTextBackgroundColor(D);}
,__NQ:function(e){var E={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};this.insertImage(E);}
,__NR:function(e){var F="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";this.insertHtml(F);}
,__NS:function(e){var G=window.prompt("Link: ","http://");this.insertHyperLink(G);}
,__NT:function(e){var H=window.prompt("HTML Code:","");this.insertHtml(H);}
,__NU:function(){var J=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(J,{"float":"left"});var L;var K=qx.dom.Element.create("select",{title:"Change font family"});if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(K,"hideFocus","true");}
else {qx.bom.element.Style.set(K,"outline","none");}
;L=q.create("<option value=''></option>");qx.dom.Element.insertEnd(L[0],K);var M=["Tahoma","Verdana","Times New Roman","Arial","Arial Black","Courier New","Courier","Georgia","Impact","Comic Sans MS","Lucida Console"];var I;var N;for(var i=0,j=M.length;i<j;i++ ){I="<option qxKeepFocus='on' qxSelectable='off'"+"value='"+M[i]+"'>"+M[i]+"</option>";N=q.create(I);if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(N[0],"hideFocus","true");}
else {qx.bom.element.Style.set(N[0],"outline","none");}
;qx.dom.Element.insertEnd(N[0],K);}
;qx.event.Registration.addListener(K,"change",function(e){var O=e.getTarget();var P=O.selectedIndex;if(P!=0){this.setFontFamily(O.options[P].value);O.options[0].selected=true;}
;}
,this.__NN);qx.dom.Element.insertBegin(K,J);return J;}
,__NV:function(){var R=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(R,{"marginRight":"16px","float":"left"});var T;var S=qx.dom.Element.create("select",{title:"Change font size"});if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(S,"hideFocus","true");}
else {qx.bom.element.Style.set(S,"outline","none");}
;T=q.create("<option value=''></option>");qx.dom.Element.insertEnd(T[0],S);var U;var Q;for(var i=1;i<=7;i++ ){Q="<option qxKeepFocus='on' qxSelectable='off' "+"value='"+i+"'>"+i+"</option>";U=q.create(Q);if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(U[0],"hideFocus","true");}
else {qx.bom.element.Style.set(U[0],"outline","none");}
;qx.dom.Element.insertEnd(U[0],S);}
;qx.event.Registration.addListener(S,"change",function(e){var V=e.getTarget();var W=V.selectedIndex;if(W!=0){this.setFontSize(V.options[W].value);V.options[0].selected=true;}
;}
,this.__NN);qx.dom.Element.insertBegin(S,R);return R;}
,__NX:function(){var Y=[{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__NN.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__NN.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__NN.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__NN.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__NN.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__NN.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__NN.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__NN.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__NN.setJustifyFull}},{fontFamily:{custom:this.__NU},fontSize:{custom:this.__NV},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__NO},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__NP}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__NN.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__NN.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__NQ},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__NR},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__NS},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__NT},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__NN.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__NN.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__NN.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__NN.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__NN.redo}}];var bb,bf,X,bd;for(var i=0,j=Y.length;i<j;i++ ){bf={};bf["marginRight"]=i==j-1?"0px":"16px";bf["float"]="left";bb=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(bb,bf);for(var bc in Y[i]){var be=Y[i][bc];if(be.custom){X=be.custom.call(this);}
else {var ba=qx.util.AliasManager.getInstance().resolve(be.image);bd={type:"image",src:qx.util.ResourceManager.getInstance().toUri(ba),title:be.text,qxKeepFocus:"on",qxSelectable:"off"};X=qx.dom.Element.create("input",bd);qx.bom.element.Style.setStyles(X,{width:"16px",height:"16px",padding:"4px"});if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(X,"hideFocus","true");}
else {qx.bom.element.Style.set(X,"outline","none");}
;qx.event.Registration.addListener(X,"click",be.action,this.__NN);}
;qx.dom.Element.insertEnd(X,bb);}
;qx.dom.Element.insertEnd(bb,this.__Qh);}
;qx.dom.Element.insertEnd(qx.dom.Element.create("br",{style:"clear:both"}),this.__Qh);}
}});}
)();
(function(){var dp="qx.blankpage",dn='</span>',dm="backgroundColor",dl="li",dk='undo',dj="<br class='webkit-block-placeholder' />",di="div",dh="textbackgroundcolor",dg="Function",df="fontSize",cf="textcolor",ce="home",cd="marginBottom",cc="focused",cb="fontFamily",ca="load",bY="__AJ",bX='<font ',bW='id="__elementToFocus__"',bV="setUnderline",dw="backgroundPosition",dx=' size="',du='/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',dv="'>",ds='underline',dt='bold',dq="ul",dr="readyAfterInvalid",dy="style",dz="setBold",cN="<P>&nbsp;</P>",cM="paddingLeft",cP="inserthorizontalrule",cO='<p>',cR="//text()[string-length(normalize-space(.))>0]",cQ="Please use the method 'qx.dom.Node.isBlockNode' instead.",cT="backgroundRepeat",cS="insertimage",cL="a",cK="cursorContext",o="removeformat",p="marginLeft",q="ready",r="<p>&nbsp;</p>",t='DOCTYPE html PUBLIC "-/',u="outline",v=" html, body {overflow-x: visible; } ",w="paddingTop",x="insertorderedlist",y='body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } ',dN="styleWithCSS",dM="hideFocus",dL="none",dK='/DTD XHTML 1.0 Transitional/',dR='<html xmlns="http:/',dQ="browser.version",dP="setItalic",dO="font-style",dT="xhtml",dS="focusOut",bl='</p>',bm='<body>',bj='</font>',bk='<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',bp="Control",bq='<span style="font-family:',bn='/W3C/',bo="justifyleft",bh='size',bi="backgroundImage",Q="marginTop",P="> ",S="font-weight",R="LI",M='italic',L='<!',O="\ufeff",N="marginRight",K="STYLE",J="justifyfull",bv="inserthyperlink",bw="<br />",bx='html { margin:0px; padding:0px; } ',by="<br>",br="justifycenter",bs="<br /><div id='placeholder'></div>",bt="useCSS",bu="strikethrough",bz="text/html",bA="true",bc="1.9",bb='',ba="indent",Y="messengerContent",X="Integer",W="insertunorderedlist",V="Text",U="_moz_dirty",bg='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>',bf='<br/><div class="placeholder"></div>',bB="selectall",bC="transparent",bD=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",bE="justifyright",bF='/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',bG="ol",bH="outdent",bI="about:blank",bJ="<body style='",bK="qx.bom.htmlarea.HtmlArea",co="paddingBottom",cn="Verdana",cl='/EN" "http:/',ck="paddingRight",cs='html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } ',cr="Off",cq='p { margin:0px; padding:0px; }',cp='body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ',cv="pageup",cu="backgroundcolor",cG="end",cH='On',cE="redo",cF="i",cC="backspace",cD="bold",cA="mouseup",cB="y",cI="down",cJ="keydown",cX="backgroundimage",cW="100%",da='</head>',cY='<head>',dc="k",db='redo',de='Off',dd='">',cV="font-family",cU="keypress",dG="fontsize",dH="undo",dI="pagedown",dJ="justify",dC="center",dD="p",dE='</style>',dF="u",dA="focus",dB="control",n="click",m='<style type="text/css">',l="up",k="text-decoration",h="blur",g="font-size",f="None",d="delete",c='</body></html>',b="line-through",B="String",C="z",z="fontfamily",A="keyup",F="focusout",G=" ",D="engine.version",E="inserthtml",H="id",I="italic",cw="body",ct="underline",cz="br",cx="contextmenu",ci="b",cg="loadingError",T="enter",cj="left",be="text-align",bd="right",bN="__elementToFocus__",bO="qx.bom.htmlarea.HtmlArea.debug",bP="qx.event.type.Data",bQ="opera",bR="qx.event.type.Event",bS="Boolean",bT="qx.debug",bU="webkit",bL="gecko",bM="mshtml",ch="",cy="engine.name";qx.Class.define(bK,{extend:qx.core.Object,construct:function(dU,dV,dW,dX){qx.core.Object.call(this);var dY=dX||qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(dp));this.__Bb(dU);this.__Bc();this._createAndAddIframe(dY);this._addIframeLoadListener();this.__AI=qx.bom.htmlarea.HtmlArea.__AK(dW);if(qx.lang.Type.isString(dV)){this.__Au=dV;}
;this.__AJ=this.__Bo();}
,events:{"load":bR,"loadingError":bP,"messengerContent":bP,"cursorContext":bP,"ready":bR,"readyAfterInvalid":bR,"focused":bR,"focusOut":bR,"contextmenu":bP,"undoRedoState":bP},statics:{simpleLinebreak:by,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:dz},italic:{method:dP},underline:{method:bV},undo:{method:dH},redo:{method:cE}},__AK:function(ea){if(ea==null||ea==""){return "";}
else if(typeof ea=="object"){var eb="";for(var i in ea){eb+=i+" { "+ea[i]+" }";}
;return eb;}
else {return ea;}
;}
,__AL:function(ec){var ed={};var a=ec.split(";");var i;for(i=0;i<a.length;i++ ){var ee=a[i],ef=ee.indexOf(":");if(ef===-1){continue;}
;var name=ee.substring(0,ef).trim();var eg=ee.substring(ef+1,ee.length).trim();if(name&&eg){ed[name]=eg;}
;}
;return ed;}
,__AM:function(eh,ei,ej,ek){var eq=[];switch(eh.nodeType){case 1:case 11:var i;var eo=eh.tagName.toLowerCase();var es={};var em={};var closed=(!(eh.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__AN(eh)));if(ei){if((qx.core.Environment.get("engine.name")=="mshtml")){if(eo=="div"&&eh.className&&eh.className=="placeholder"){for(i=eh.firstChild;i;i=i.nextSibling){eq.push(qx.bom.htmlarea.HtmlArea.__AM(i,true,ej,ek));}
;return eq.join("");}
;}
;var er=eh.attributes;var ep=er.length;var a;if((qx.core.Environment.get("engine.name")=="gecko")){if(eo=="span"&&ep==1&&er[0].name=="_moz_dirty"&&eh.childNodes.length==0){return "";}
;}
;for(i=0;i<ep;i++ ){a=er[i];if(!a.specified){continue;}
;var name=qx.dom.Node.getName(a);var et=a.nodeValue;if(/(_moz|contenteditable)/.test(name)){continue;}
;if(name!="style"){if(qx.core.Environment.get("engine.name")=="mshtml"){if(name=="id"&&eh.getAttribute("old_id")){et=eh.getAttribute("old_id");}
else if(!isNaN(et)){et=eh.getAttribute(name);}
else {et=a.nodeValue;}
;}
else {et=a.nodeValue;}
;}
else {et=eh.style.cssText;}
;if(/(_moz|^$)/.test(et)){continue;}
;if(name=="old_id"){continue;}
;if(!et){continue;}
;if(name=="id"&&et=="__elementToFocus__"){continue;}
;if(name.charAt(0)==="$"){continue;}
;es[name]=et;}
;if(es.style!==undefined){em=qx.bom.htmlarea.HtmlArea.__AL(es.style);delete es.style;}
;if(ek){var en={domElement:eh,tag:eo,attributes:es,styles:em};ek(en);en.domElement=null;eo=en.tag;}
;if(eo){eq.push("<",eo);for(var name in es){var et=es[name];eq.push(" ",name,'="',et.toString().replace(new RegExp('"',"g"),"'"),'"');}
;if(!qx.lang.Object.isEmpty(em)){eq.push(' style="');for(var name in em){var et=em[name];eq.push(name,":",et.toString().replace(new RegExp('"',"g"),"'"),";");}
;eq.push('"');}
;eq.push(closed?" />":">");}
;}
;for(i=eh.firstChild;i;i=i.nextSibling){eq.push(qx.bom.htmlarea.HtmlArea.__AM(i,true,ej,ek));}
;if(ei&&!closed&&eo){eq.push("</",eo,">");}
;break;case 3:eq.push(ej?eh.data:qx.bom.htmlarea.HtmlArea.__AO(eh.data));break;case 8:eq.push("<!--",eh.data,"-->");break;};return eq.join("");}
,closingTags:bD,__AN:function(eu){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(" "+eu.tagName+" ")!=-1);}
,__AO:function(s){s=s.replace(/&/ig,"&amp;");s=s.replace(/</ig,"&lt;");s=s.replace(/>/ig,"&gt;");s=s.replace(/\x22/ig,"&quot;");s=s.replace(/\xA9/ig,"&copy;");return s;}
,isBlockNode:function(ev){var ew=qx.bom.htmlarea.HtmlArea.isBlockNode;var ey=cQ;qx.log.Logger.deprecatedMethodWarning(ew,ey);return qx.dom.Node.isBlockNode(ev);}
,isParagraphParent:function(ez){if(!qx.dom.Node.isElement(ez)){return false;}
;ez=qx.dom.Node.getName(ez);return /^(body|td|th|caption|fieldset|div)$/.test(ez);}
,isHeadlineNode:function(eA){if(!qx.dom.Node.isElement(eA)){return false;}
;var eB=qx.dom.Node.getName(eA);return /^h[1-6]$/.test(eB);}
},properties:{contentType:{check:B,init:dT},messengerMode:{check:bS,init:false},insertParagraphOnLinebreak:{check:bS,init:true},insertLinebreakOnCtrlEnter:{check:bS,init:true},postProcess:{check:dg,nullable:true,init:null},useUndoRedo:{check:bS,init:true},nativeContextMenu:{check:bS,init:false},defaultFontFamily:{check:B,init:cn},defaultFontSize:{check:X,init:4}},members:{__kS:null,__dd:false,__AP:false,__AQ:false,__AR:false,__AS:false,__AJ:null,__AT:null,__AU:null,__AV:null,__pp:null,__AI:null,__AW:null,__AX:null,__AY:false,__Ba:false,__Bb:function(eC){if(qx.dom.Node.isElement(eC)&&qx.dom.Node.isNodeName(eC,di)){this.__kS=eC;}
;}
,_createAndAddIframe:function(eD){this.__pp=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__pp,eD);if((qx.core.Environment.get(cy)==bM)){qx.bom.element.Attribute.set(this.__pp,dM,bA);}
else {qx.bom.element.Style.set(this.__pp,u,dL);}
;qx.bom.element.Style.setStyles(this.__pp,{width:cW,height:cW});qx.dom.Element.insertBegin(this.__pp,this.__kS);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__pp);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__pp);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__pp,ca,this._loaded,this);}
,__Bc:function(){this.__AW={"xhtml":{doctype:L+t+bn+dK+cl+bF,html:dR+du,meta:bk,style:qx.core.Environment.select(cy,{"mshtml":bx+cp,"default":cs+y}),contentStyle:cq,body:bm,footer:c}};}
,__Au:ch,getIframeObject:function(){return this.__pp;}
,getCommandManager:function(){return this.__AJ;}
,setValue:function(eE){if(qx.lang.Type.isString(eE)){this.__Au=eE;var eF=this._getIframeDocument();if(eF&&eF.body){eF.body.innerHTML=this.__Bd(eE);}
;}
;}
,__Bd:function(eG){var eJ=ch;if((qx.core.Environment.get(cy)==bL)){if(qx.core.Environment.get(dQ)<=2){eJ+=bg;}
;}
;var eK=eG.length==0?O:ch;var eI=qx.core.Environment.get(cy)==bL||qx.core.Environment.get(cy)==bU?bW:bb;var eH=cO+bq+this.getDefaultFontFamily()+dd+bX+eI+dx+this.getDefaultFontSize()+dd+eJ+eG+eK+bj+dn+bl;return eH;}
,getValue:function(){return this.__Au;}
,getComputedValue:function(eL){return this.getHtml(eL);}
,getCompleteHtml:function(){var eN=this.__AW[this.getContentType()];var eM=eN.html+cY+eN.meta+m+eN.contentStyle+dE+da;eM+=bJ+this.__Be()+dv;eM+=this.getHtml()+c;return eM;}
,__Be:function(){var eQ=[dm,bi,cT,dw,cb,df,Q,cd,p,N,w,co,cM,ck];var eP=qx.bom.element.Style;var eO=this.getContentBody();var eT={};var eS,eU;var eR=qx.core.Environment.get(cy)==bM?2:1;for(var i=0,j=eQ.length;i<j;i++ ){eS=eQ[i];eU=eP.get(eO,eS,eR);if(eU!==undefined&&eU!=ch){eT[eS]=eU;}
;}
;return qx.bom.element.Style.compile(eT);}
,getContentDocument:function(){if(this.__dd){return this._getIframeDocument();}
;}
,getContentBody:function(){if(this.__dd){return this._getIframeDocument().body;}
;}
,getContentWindow:function(){if(this.__dd){return this._getIframeWindow();}
;}
,getWords:function(eV){if(!eV){eV=this.getContentBody();}
;if(!eV){return [];}
;var eX=eV.cloneNode(true);var fa=eX.innerHTML;fa=fa.replace(/>/gi,P);fa=fa.replace(/\n/gi,G);fa=fa.replace(/<!--.*-->/gi,ch);eX.innerHTML=fa;var eW=qx.core.Environment.get(cy)==bM||qx.core.Environment.get(cy)==bQ?eX.innerText:eX.textContent;var eY=eW.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);return !eY?[]:eY;}
,getWordsWithElement:function(){var fc=this.getTextNodes();var fg={};var i,j,fh,fd,fb;for(var i=0,ff=fc.length;i<ff; ++i){fd=fc[i];fh=fd.nodeValue.split(G);for(var j=0,fe=fh.length;j<fe; ++j){fb=this._cleanupWord(fh[j]);if(fb!=null&&fb.length>1){if(!fg[fb]){fg[fb]=[];}
;fg[fb].push(fd);}
;}
;}
;return fg;}
,_cleanupWord:function(fi){if(!fi){return null;}
;return fi.replace(qx.bom.htmlarea.HtmlArea.CleanupWordsRegExp,ch);}
,getTextNodes:function(){return this._fetchTextNodes(this.getContentBody());}
,_fetchTextNodes:function(fj){var fl=[];var fk;if(fj.hasChildNodes){for(var i=0;i<fj.childNodes.length;i++ ){fk=this._fetchTextNodes(fj.childNodes[i]);qx.lang.Array.append(fl,fk);}
;}
;if(fj.nodeType==3){if(fj.nodeValue.length>1){fl.push(fj);}
;}
;return fl;}
,__Bf:0,__Bg:function(){var fm=this._getIframeDocument();if(!fm){this.__Bf++ ;if(this.__Bf>5){this.error('cant load HtmlArea. Document is not available. '+fm);this.fireDataEvent(cg);}
else {if(qx.core.Environment.get(bT)){this.error('document not available, try again...');}
;qx.event.Timer.once(function(){this.__Bg();}
,this,0);}
;}
else {this.__Bf=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__AQ){return;}
;if(this.__AP){this.__Bh();return;}
;if((qx.core.Environment.get(cy)==bM)){this.__Bg();}
else {this._onDocumentIsReady();}
;}
,isReady:function(){return this.__dd;}
,_onDocumentIsReady:function(){var fn=new qx.bom.htmlarea.manager.Command(this);if(this.getUseUndoRedo()){fn=new qx.bom.htmlarea.manager.UndoRedo(fn,this);}
;this.__AQ=true;if((qx.core.Environment.get(cy)==bM)){this.setEditable(true);}
;this.__Bk();if(!(qx.core.Environment.get(cy)==bQ)){this.__zx();}
;if(!(qx.core.Environment.get(cy)==bM)){this.setEditable(true);}
;this.__dd=true;this.__AJ=fn;fn.setContentDocument(this._getIframeDocument());this.__Bp();if((qx.core.Environment.get(cy)==bQ)){this.__zx();}
;this.fireEvent(q);}
,forceEditable:qx.core.Environment.select(cy,{"gecko":function(){var fo=this._getIframeDocument();if(fo){if(parseFloat(qx.core.Environment.get(D))>=bc){fo.designMode=cr;fo.body.contentEditable=false;fo.body.contentEditable=true;}
else {fo.body.contentEditable=true;this.__Bq(true);}
;}
;}
,"default":(function(){}
)}),invalidateEditor:qx.core.Environment.select(cy,{"gecko":function(){this.__AQ=false;this.__dd=false;this.__AP=true;}
,"default":function(){}
}),__Bh:qx.core.Environment.select(cy,{"gecko":function(){this.__Bk();this.__zx();this.__AJ.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__AQ=true;this.__dd=true;this.__AP=false;this.fireEvent(dr);}
,"default":function(){}
}),__Bi:function(fp){var fr=ch;if(!fp){return fr;}
;try{var fq=fp.getAttribute(dy);if(!fq){return fr;}
;if((qx.core.Environment.get(cy)==bM)){fr=fq.cssText;}
else {fr=fq;}
;}
catch(fs){this.error("can't extract style from elem. ");}
;return fr;}
,__Bj:function(ft){var fu=qx.core.Environment.get(cy)==bL?v:ch;var fv=this.__AW[this.getContentType()];var fw=cY+fv.meta+m+fu+fv.style+fv.contentStyle+this.__AI+dE+da;var content=fv.body+ft;return fv.html+fw+content+fv.footer;}
,__Bk:function(){var fy=this.__Bd(this.getValue());if(qx.lang.Type.isString(fy)){var fx=this._getIframeDocument();try{fx.open(bz,true);fx.write(this.__Bj(fy));fx.close();}
catch(e){this.error("cant open document on source '"+qx.bom.Iframe.queryCurrentUrl(this.__pp)+"'",e);this.fireDataEvent(cg,e);}
;}
;}
,__zx:function(){this.__Bl();this.__Bn();this.__Bm();}
,__Bl:function(){var fA=qx.event.Registration;var fz=this._getIframeDocument();fA.addListener(fz.body,cU,this._handleKeyPress,this);fA.addListener(fz.body,A,this._handleKeyUp,this);fA.addListener(fz.body,cJ,this._handleKeyDown,this);}
,__Bm:function(){var fD=qx.event.Registration;var fB=this._getIframeDocument();var fC=qx.core.Environment.get(cy)==bU?this._getIframeWindow():fB.body;fD.addListener(fC,dA,this._handleFocusEvent,this);fD.addListener(fC,h,this._handleBlurEvent,this);fD.addListener(fB,F,this._handleFocusOutEvent,this);}
,__Bn:function(){var fG=qx.event.Registration;var fF=this._getIframeDocument();var fE=qx.core.Environment.get(cy)==bM?n:cA;fG.addListener(fF.body,fE,this._handleMouseUpOnBody,this);fG.addListener(fF.documentElement,fE,this._handleMouseUpOnDocument,this);fG.addListener(fF.documentElement,cx,this._handleContextMenuEvent,this);}
,__Bo:function(){if(this.__AT==null){this.__AT={execute:function(fH,fI){this.stackedCommands=true;this.commandStack.push({command:fH,value:fI});}
,commandStack:[],stackedCommands:false};}
;this.__AT.stackedCommands=false;return this.__AT;}
,__Bp:function(){var fJ=this.__AT;if(fJ!=null&&fJ.stackedCommands){var fK=fJ.commandStack;if(fK!=null){for(var i=0,j=fK.length;i<j;i++ ){this.__AJ.execute(fK[i].command,fK[i].value);}
;}
;}
;}
,__Bq:function(fL){var fM=this._getIframeDocument();if(this.__AQ&&fM){try{if((qx.core.Environment.get(cy)==bL)){fM.designMode=(fL!==false)?de:cH;}
;fM.designMode=(fL!==false)?cH:de;}
catch(e){}
;}
;}
,setEditable:function(fN){if(this.__AQ){this.__Bq(true);if((qx.core.Environment.get(cy)==bL)){try{var fO=this._getIframeDocument();fO.execCommand(dN,false,true);}
catch(fP){try{var fO=this._getIframeDocument();fO.execCommand(bt,false,false);}
catch(fQ){if(!this.__dd){this.error("Failed to enable rich edit functionality");this.fireDataEvent(cg,fQ);}
...
;this.__AR=fN;}
;}
,getEditable:function(){return this.__AR;}
,isEditable:function(){return this.__AR;}
,__Br:false,_handleKeyUp:function(e){var fR=e.getKeyIdentifier().toLowerCase();this.__AU=e;if((qx.core.Environment.get(bT))&&qx.core.Environment.get(bO)){this.debug(e.getType()+" | "+fR);}
;if(qx.core.Environment.get(cy)==bM||qx.core.Environment.get(cy)==bU){if(this.__Br){switch(fR){case T:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(cy)==bU)){this.__Bs();e.preventDefault();e.stopPropagation();}
else {var fS=this.__BC(this.getSelection());if(fS){fS.collapse(true);fS.pasteHTML(bf);}
;}
;this.__Bx();}
;break;case dB:this.__Br=false;return;break;};}
;}
else if((qx.core.Environment.get(cy)==bL)){switch(fR){case cj:case bd:case l:case cI:case cv:case dI:case d:case cG:case cC:this.__AS=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__Bs:function(){var fT=this.getSelection();var fU=ch;if(fT&&(fT.focusNode.textContent==ch||fT.focusNode.parentElement.tagName==R)){fU=dj;}
;this.__AJ.execute(E,fU+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
,_handleKeyDown:qx.core.Environment.select(cy,{"mshtml|webkit":function(e){var fV=e.getKeyIdentifier().toLowerCase();if((qx.core.Environment.get(bT))&&qx.core.Environment.get(bO)){}
;if(this.__Br&&(fV==C||fV==cB||fV==ci||fV==dF||fV==cF||fV==dc)){e.preventDefault();e.stopPropagation();}
;if(fV==dB){this.__Br=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var gb=this.getContentDocument();var fW=e.getKeyIdentifier().toLowerCase();var fY=e.isCtrlPressed();var ga=e.isShiftPressed();this.__AU=e;if((qx.core.Environment.get(bT))&&qx.core.Environment.get(bO)){this.debug(e.getType()+" | "+fW);}
;if(this.__AY){var gh=!((qx.core.Environment.get(cy)==bM)&&fW==T)||!((qx.core.Environment.get(cy)==bL)&&fW==T);if(gh){this.__Bx();this.__AY=false;}
;}
;switch(fW){case T:if(!ga&&!fY&&this.getMessengerMode()){e.preventDefault();e.stopPropagation();this.fireDataEvent(Y,this.getComputedValue());this.resetHtml();}
;if(fY){if(!this.getInsertLinebreakOnCtrlEnter()){return;}
;e.preventDefault();e.stopPropagation();if((qx.core.Environment.get(cy)==bL)){if(this.__BA()){this.insertHtml(bw);this.__Bx();return;}
;this.insertHtml(bs);}
else if((qx.core.Environment.get(cy)==bQ)){var gg=this.getSelection();var gc=this.__BC(gg);if(gg&&gc){var gd=gb.createElement(cz);gc.collapse(true);gc.insertNode(gd);gc.collapse(true);gc.selectNode(gd);gg.addRange(gc);gc.collapse(true);}
;}
;this.__Bx();}
;if((qx.core.Environment.get(cy)==bM)){if(!this.getInsertParagraphOnLinebreak()){if(this.__AJ.execute(E,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__Bx();e.preventDefault();e.stopPropagation();}
;}
;}
else if((qx.core.Environment.get(cy)==bL)){if(this.getInsertParagraphOnLinebreak()&&!ga&&!fY){var gg=this.getSelection();if(gg){var fX=gg.focusNode;if(this.__BA()){this.__Bx();return;}
;if(this.__BB()){this.__Bx();return;}
;while(!qx.dom.Node.isNodeName(fX,cw)){if(qx.dom.Node.isNodeName(fX,dl)){this.__Bx();return;}
;fX=fX.parentNode;}
;}
;this.__AJ.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__Bx();this.__AY=true;}
;}
else if((qx.core.Environment.get(cy)==bU)){if(this.getInsertParagraphOnLinebreak()&&ga){this.__Bs();e.preventDefault();e.stopPropagation();this.__Bx();}
;}
;break;case l:if(qx.core.Environment.get(cy)==bL&&qx.core.Environment.get(D)<1.9&&ga){var gg=this.getSelection();if(gg&&gg.focusNode==gb.body.firstChild){if(this.__AS){if(gg.focusOffset!=0){gg.extend(gg.focusNode,0);}
;}
;}
;}
;this.__Bx();break;case ce:if(qx.core.Environment.get(cy)==bL&&qx.core.Environment.get(D)<1.9){if(fY){var gg=this.getSelection();if(ga){if(gg&&(gg.focusOffset!=0)||(gg.focusNode!=gb.body.firstChild)){gg.extend(gb.body.firstChild,0);}
;}
else {var ge=null;var gf;if(gb){ge=gb.evaluate(cR,gb.body,null,XPathResult.ANY_TYPE,null);}
;if(ge&&gg){while(gf=ge.iterateNext()){if(gf&&gf.parentNode&&gf.parentNode.tagName!=K){try{gg.extend(gf,0);if(!this.isSelectionCollapsed()){gg.collapseToStart();}
;}
catch(gi){}
;break;}
;}
...
;}
;}
;this.__Bx();break;case cj:case bd:case cI:case cv:case dI:case d:case cG:case cC:this.__Bx();break;case ci:if(fY){this.__Bt(dt,true);}
;break;case cF:case dc:if(fY){this.__Bt(M,true);}
;break;case dF:if(fY){this.__Bt(ds,true);}
;break;case C:if(fY&&!ga){this.__Bt(dk,true);}
else if(fY&&ga){this.__Bt(db,true);}
;break;case cB:if(fY){this.__Bt(db,true);}
;break;case cL:if(fY){this.selectAll();}
;break;};this.__AU=null;}
,__Bt:function(gj,gk){var gm=null;var gl=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(gl[gj]){gm=gl[gj].method;}
;if(gm!=null&&this[gm]){this[gm]();if(gk){this.__AU.preventDefault();this.__AU.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__AY=true;}
;this.__Bx();}
;}
,_handleFocusEvent:function(e){this.__AV=null;if(qx.core.Environment.get(cy)==bL||qx.core.Environment.get(cy)==bU){var gn=this.getContentDocument().getElementById(bN);if(gn){qx.bom.element.Attribute.reset(gn,H);}
;}
;this.fireEvent(cc);}
,_handleBlurEvent:function(e){this.__Au=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__Br=false;if(this.__AV==null){this.__AV=this.getSelectedHtml();}
;this.fireEvent(dS);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(bT))&&qx.core.Environment.get(bO)){this.debug("handleMouse "+e.getType());}
;this.__Ba=true;this.__Bx();}
,_handleMouseUpOnDocument:qx.core.Environment.select(cy,{"mshtml":(function(){}
),"default":function(e){if(!this.__Ba){qx.bom.Element.activate(this.getContentBody());}
;this.__Ba=false;}
}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var gq=e.getViewportLeft();var gp=e.getViewportTop();var gr=qx.bom.element.Location.getLeft(this.__kS)+gq;var gs=qx.bom.element.Location.getTop(this.__kS)+gp;var go={x:gr,y:gs,relX:gq,relY:gp,target:e.getTarget()};e.preventDefault();e.stopPropagation();qx.event.Timer.once(function(){this.fireDataEvent(cx,go);}
,this,0);}
;}
,isLoaded:function(){return this.__AQ;}
,insertHtml:function(gt){return this.__AJ.execute(E,gt);}
,removeFormat:function(){var gu=this.__AJ.execute(o);this.__AJ.execute(dG,this.getDefaultFontSize());this.__AJ.execute(z,this.getDefaultFontFamily());return gu;}
,setBold:function(){return this.__AJ.execute(cD);}
,setItalic:function(){return this.__AJ.execute(I);}
,setUnderline:function(){return this.__AJ.execute(ct);}
,setStrikeThrough:function(){return this.__AJ.execute(bu);}
,setFontSize:function(gv){return this.__AJ.execute(dG,gv);}
,setFontFamily:function(gw){return this.__AJ.execute(z,gw);}
,setTextColor:function(gx){return this.__AJ.execute(cf,gx);}
,setTextBackgroundColor:function(gy){return this.__AJ.execute(dh,gy);}
,setJustifyLeft:function(){return this.__AJ.execute(bo);}
,setJustifyCenter:function(){return this.__AJ.execute(br);}
,setJustifyRight:function(){return this.__AJ.execute(bE);}
,setJustifyFull:function(){return this.__AJ.execute(J);}
,insertIndent:function(){return this.__AJ.execute(ba);}
,insertOutdent:function(){return this.__AJ.execute(bH);}
,insertOrderedList:function(){return this.__AJ.execute(x);}
,insertUnorderedList:function(){return this.__AJ.execute(W);}
,insertHorizontalRuler:function(){return this.__AJ.execute(cP);}
,insertImage:function(gz){return this.__AJ.execute(cS,gz);}
,insertHyperLink:function(gA){return this.__AJ.execute(bv,gA);}
,removeBackgroundColor:function(){return this.__AJ.execute(cu,bC);}
,setBackgroundColor:function(gB){return this.__AJ.execute(cu,gB);}
,removeBackgroundImage:function(){return this.__AJ.execute(cX);}
,setBackgroundImage:function(gC,gD,gE){return this.__AJ.execute(cX,[gC,gD,gE]);}
,selectAll:function(){return this.__AJ.execute(bB);}
,undo:function(){if(this.getUseUndoRedo()){return this.__AJ.execute(dH);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__AJ.execute(cE);}
else {return true;}
;}
,resetHtml:function(){var gF=this._getIframeDocument();while(gF.body.firstChild){gF.body.removeChild(gF.body.firstChild);}
;if(qx.core.Environment.get(cy)==bL){gF.body.innerHTML=r;}
else if(qx.core.Environment.get(cy)==bU){var gG=this.getSelection();var gH=gF.createRange();if(gH&&gG){gG.addRange(gH);}
;}
;}
,getHtml:function(gI){var gJ=this._getIframeDocument();if(gJ==null){return null;}
;return qx.bom.htmlarea.HtmlArea.__AM(gJ.body,false,gI,this.getPostProcess());}
,containsOnlyPlaceholder:qx.core.Environment.select(cy,{"mshtml":function(){var gK=this._getIframeDocument();return (gK.body.innerHTML==cN);}
,"default":(function(){return false;}
)}),_selectElement:function(gL){var gN=this.getContentWindow().getSelection();var gM=this.getContentDocument().createRange();gM.setStart(gL,0);gN.removeAllRanges();gN.addRange(gM);}
,focusContent:qx.core.Environment.select(cy,{"gecko":function(){var gP=this.getContentDocument();var gO=gP.getElementById(bN);this.getContentWindow().focus();qx.bom.Element.focus(this.getContentBody());if(gO){this._selectElement(gO);}
else {this.__Bu();}
;}
,"webkit":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());var gQ=this.getContentDocument().getElementById(bN);if(gQ){qx.bom.element.Attribute.reset(gQ,H);}
;this.__Bu();}
,"opera":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());this.__Bu();}
,"default":function(){qx.bom.Element.focus(this.getContentBody());this.__Bu();}
}),__Bu:function(){if(!this.__Bv()){this.__Bw();}
;}
,__Bv:qx.core.Environment.select(cy,{"gecko":function(){var gR=this.getContentBody().childNodes;if(gR.length==0){return false;}
else if(gR.length==1){return !(gR[0]&&qx.dom.Node.isNodeName(gR[0],cz)&&qx.bom.element.Attribute.get(gR[0],U)!=null);}
else {return true;}
;}
,"webkit":function(){var gS=this.getContentBody().childNodes;if(gS.length==0){return false;}
else if(gS.length==1){return !(gS[0]&&qx.dom.Node.isNodeName(gS[0],cz));}
else {return true;}
;}
,"default":function(){var gT=this.getContentBody().childNodes;if(gT.length==0){return false;}
else if(gT.length==1){return !(gT[0]&&qx.dom.Node.isNodeName(gT[0],dD)&&gT[0].firstChild==null);}
else {return true;}
;}
}),__Bw:qx.core.Environment.select(cy,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__Bd(ch);var gU=this.getContentDocument().getElementById(bN);qx.bom.element.Attribute.reset(gU,H);this._selectElement(gU);}
,"default":function(){var gV=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());if(qx.dom.Node.isNodeName(gV,dD)){qx.bom.element.Style.set(gV,cV,this.getDefaultFontFamily());qx.bom.element.Style.set(gV,g,this.getDefaultFontSize());}
;}
}),getContextInformation:function(){return this.__By();}
,__Bx:function(){qx.event.Timer.once(function(e){var gW=this.__By();this.fireDataEvent(cK,gW);}
,this,200);}
,__By:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return null;}
;this._processingExamineCursorContext=true;if(!this.__Bv()){this.__Bw();}
;var hb=this.getFocusNode();if(hb==null){return null;}
;if(qx.dom.Node.isText(hb)){hb=hb.parentNode;}
;var hf=this._getIframeDocument();var ho=(qx.core.Environment.get(cy)==bM)?hb.currentStyle:hf.defaultView.getComputedStyle(hb,null);var hi=false;var gX=false;var hd=false;var hc=false;var hj=false;var hn=false;var he=false;var hp=false;var ha=false;var hl=false;var hm=null;var hq=null;var hh=null;if(ho!=null){if((qx.core.Environment.get(cy)==bM)){gX=ho.fontStyle==I;hd=ho.textDecoration.indexOf(ct)!==-1;hc=ho.textDecoration.indexOf(b)!==-1;hm=ho.fontSize;hh=ho.fontFamily;he=ho.textAlign==cj;hp=ho.textAlign==dC;ha=ho.textAlign==bd;hl=ho.textAlign==dJ;}
else {gX=ho.getPropertyValue(dO)==I;hd=ho.getPropertyValue(k).indexOf(ct)!==-1;hc=ho.getPropertyValue(k).indexOf(b)!==-1;hm=ho.getPropertyValue(g);hh=ho.getPropertyValue(cV);he=ho.getPropertyValue(be)==cj;hp=ho.getPropertyValue(be)==dC;ha=ho.getPropertyValue(be)==bd;hl=ho.getPropertyValue(be)==dJ;}
;if(qx.core.Environment.get(cy)==bM||qx.core.Environment.get(cy)==bQ){hi=ho.fontWeight==700;}
else {hi=ho.getPropertyValue(S)==cD||qx.dom.Node.isNodeName(hb,ci);}
;}
;var gY=hb;if(gY!=null&&gY.parentNode!=null&&!qx.dom.Node.isDocument(gY.parentNode)){while(gY!=null&&!qx.dom.Node.isNodeName(gY,cw)){var hg=qx.dom.Node.getName(gY);if(hg==bG){hn=true;break;}
else if(hg==dq){hj=true;break;}
;if(hq==null||hq==ch){hq=qx.bom.element.Attribute.get(gY,bh);}
;gY=gY.parentNode;}
;}
;var hk={bold:hi?1:0,italic:gX?1:0,underline:hd?1:0,strikethrough:hc?1:0,fontSize:(hq==null)?hm:hq,fontFamily:hh,insertUnorderedList:hj?1:0,insertOrderedList:hn?1:0,justifyLeft:he?1:0,justifyCenter:hp?1:0,justifyRight:ha?1:0,justifyFull:hl?1:0};this._processingExamineCursorContext=false;return hk;}
...
}),isSelectionCollapsed:qx.core.Environment.select(cy,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==f;}
,"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;}
}),getSelectedText:qx.core.Environment.select(cy,{"mshtml":function(){return this.getRange()?this.getRange().text:ch;}
,"default":function(){return this.getRange()?this.getRange().toString():ch;}
}),getSelectedHtml:function(){if(this.__AV!=null){return this.__AV;}
;var hr=this.getRange();if(!hr){return ch;}
else {return this.__Bz(hr);}
;}
,__Bz:qx.core.Environment.select(cy,{"mshtml":function(hs){if(!hs){return ch;}
;return hs.item?hs.item(0).outerHTML:hs.htmlText;}
,"default":function(ht){var hu=this._getIframeDocument();if(hu&&ht){try{var hv=hu.createElement(cw);hv.appendChild(ht.cloneContents());return hv.innerHTML;}
catch(hw){}
;return ht+ch;}
;return ch;}
}),clearSelection:qx.core.Environment.select(cy,{"mshtml":function(){var hx=this.getSelection();if(hx){hx.empty();}
;}
,"default":function(){var hy=this.getSelection();if(hy){hy.collapseToStart();}
;}
}),__BA:qx.core.Environment.select("engine.name",{"gecko":function(){var hz=this.getSelection();var hA=this.getFocusNode();return hz&&this.isSelectionCollapsed()&&hA!=null&&qx.dom.Node.isText(hA)&&hz.anchorOffset<hA.length;}
,"default":function(){return false;}
}),__BB:qx.core.Environment.select("engine.name",{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());}
,"default":function(){return false;}
}),getRange:function(){return this.__BC(this.getSelection());}
,__BC:qx.core.Environment.select("engine.name",{"mshtml":function(hB){var hC=this._getIframeDocument();if(hB){try{return hB.createRange();}
catch(hD){return hC?hC.body.createTextRange():null;}
;}
else {return hC?hC.body.createTextRange():null;}
;}
,"default":function(hE){var hF=this._getIframeDocument();if(hE){try{return hE.getRangeAt(0);}
catch(hG){return hF?hF.createRange():null;}
;}
else {return hF?hF.createRange():null;}
;}
}),saveRange:qx.core.Environment.select(cy,{"mshtml":function(){this.__AX=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(cy,{"mshtml":function(){return this.__AX;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(cy,{"mshtml":function(){this.__AX=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(cy,{"mshtml":function(){var hH=this.getSelection();var hI;switch(hH.type){case V:case f:hI=this.__BC(hH);if(hI){hI.collapse(false);return hI.parentElement();}
else {return null;}
;break;case bp:hI=this.__BC(hH);if(hI){try{hI.collapse(false);}
catch(hJ){}
;return hI.item(0);}
else {return null;}
;break;default:return this._getIframeDocument().body;};}
,"default":function(){var hK=this.getSelection();if(hK&&hK.focusNode){return hK.focusNode;}
;return this._getIframeDocument().body;}
})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var hM=this._getIframeDocument();var hO=qx.event.Registration;hO.removeListener(hM.body,cU,this._handleKeyPress,this);hO.removeListener(hM.body,A,this._handleKeyUp,this);hO.removeListener(hM.body,cJ,this._handleKeyDown,this);var hN=qx.core.Environment.get(cy)==bU?this._getIframeWindow():hM.body;hO.removeListener(hN,dA,this._handleFocusEvent);hO.removeListener(hN,h,this._handleBlurEvent);hO.removeListener(hM,F,this._handleFocusOutEvent);var hL=qx.core.Environment.get(cy)==bM?n:cA;hO.removeListener(hM.body,hL,this._handleMouseUpOnBody,this);hO.removeListener(hM.documentElement,hL,this._handleMouseUpOnDocument,this);hO.removeListener(hM.documentElement,cx,this._handleContextMenuEvent,this);if((qx.core.Environment.get(cy)==bM)){qx.bom.Iframe.setSource(this.__pp,bI);}
;}
catch(hP){}
;if(this.__AJ instanceof qx.core.Object){this._disposeObjects(bY);}
else {this.__AJ=null;}
;this.__AW=this.__pp=this.__kS=this.__AT=null;}
});}
)();
...
(function(){var s="OL",r="backgroundColor",q="_moz",p="top",o="webkit",n='" ',m="qx.bom.htmlarea.manager.Command",h='</p>',g="insertParagraph",f="<hr />",bJ='"></span>',bI="UL",bH="'><br class='webkit-block-placeholder' />",bG="<span></span>",bF="FONT",bE="_moz_dirty",bD='<font style="',bC="color",bB="size",bA="no-repeat",z="type",A="font",x=":",y="fontWeight",v="<p style='",w="italic",t="line-through",u="__paragraph__",H='<p id="',I="fontStyle",bb="LI",W="__placeholder__",bj='>',be="url(",bv="outdent",bp='<span id="',P="p",bz='" size="',bx=';',bw=':',N="HiliteColor",S='<span style="',U="br",Y=")",bc="</span>",bf='',bl="bold",br="none",B="indent",C=";",R="underline",bi="body",bh="child",bg="font-size",bn="</font>",bm="FontSize",bd="string",bk="backgroundRepeat",a="backgroundImage",bq="px",D="backgroundPosition",E="BODY",X='|',b='">',d="textDecoration",M="background-color",F=" ",G="span",K="undefined",ba="id",bt="qx.debug",bs="BackColor",T='text-decoration',bu="transparent",O="gecko",bo="inserthtml",J='color',L="text-decoration",c="mshtml",V="",Q="legacy-font-size",by="engine.name";qx.Class.define(m,{extend:qx.core.Object,construct:function(bK){qx.core.Object.call(this);this.__BD=bK;this.__lP=null;this._commands=null;this.__BK();this.__BE={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__BF=[10,12,16,18,24,32,48];this.__BG=0;}
,statics:{__BH:"|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",__BI:"repeat repeat-x repeat-y no-repeat"},members:{__lP:null,__BD:null,__BJ:false,__BE:null,__BF:null,__BG:null,setContentDocument:function(bL){this.__lP=bL;}
,getCommandObject:function(bM){if(this._commands[bM]){return this._commands[bM];}
else {return null;}
;}
,__BK:function(){this._commands={bold:{useBuiltin:false,identifier:"Bold",method:"__Cq"},italic:{useBuiltin:false,identifier:"Italic",method:"__Cr"},underline:{useBuiltin:false,identifier:"Underline",method:"__Cs"},strikethrough:{useBuiltin:false,identifier:"StrikeThrough",method:"__Ct"},fontfamily:{useBuiltin:true,identifier:"FontName",method:null},fontsize:{useBuiltin:false,identifier:"FontSize",method:"__Ci"},textcolor:{useBuiltin:true,identifier:"ForeColor",method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:"__Cj"},backgroundcolor:{useBuiltin:false,identifier:null,method:"__Ck"},backgroundimage:{useBuiltin:false,identifier:null,method:"__Cl"},justifyleft:{useBuiltin:false,identifier:"JustifyLeft",method:"__BT"},justifyright:{useBuiltin:false,identifier:"JustifyRight",method:"__BT"},justifycenter:{useBuiltin:false,identifier:"JustifyCenter",method:"__BT"},justifyfull:{useBuiltin:false,identifier:"JustifyFull",method:"__BT"},indent:{useBuiltin:true,identifier:"Indent",method:null},outdent:{useBuiltin:true,identifier:"Outdent",method:null},copy:{useBuiltin:true,identifier:"Copy",method:null},cut:{useBuiltin:true,identifier:"Cut",method:null},paste:{useBuiltin:true,identifier:"Paste",method:null},insertorderedlist:{useBuiltin:false,identifier:"InsertOrderedList",method:"__BU"},insertunorderedlist:{useBuiltin:false,identifier:"InsertUnorderedList",method:"__BU"},inserthorizontalrule:{useBuiltin:false,identifier:"InsertHtml",method:"__Ca"},insertimage:{useBuiltin:false,identifier:"InsertImage",method:"__BW"},inserthyperlink:{useBuiltin:false,identifier:"CreateLink",method:"__BY"},selectall:{useBuiltin:false,identifier:"SelectAll",method:"__Cm"},selectedtext:{useBuiltin:false,identifier:null,method:"__Cn"},selectedhtml:{useBuiltin:false,identifier:null,method:"__Co"},inserthtml:{useBuiltin:false,identifier:"InsertHtml",method:"__BP"},resethtml:{useBuiltin:false,identifier:null,method:"__resetHtml"},gethtml:{useBuiltin:false,identifier:null,method:"__getHtml"},removeformat:{useBuiltin:true,identifier:"RemoveFormat",method:null}};}
,execute:function(bN,bO){if(!this.__BD.isReady()){this.error("editor not ready! '"+bN+"':'"+bO+"'");return false;}
;bN=bN.toLowerCase();bO=bO!=null?bO:null;if(this._commands[bN]){var bP;var bQ=this._commands[bN];if(!((qx.core.Environment.get(by)==o)&&(bN==B||bN==bv))){if(this.__BL()){this.__BM();}
;}
;if(bQ.useBuiltin){bP=this.__BN(bQ.identifier,false,bO);}
...
;}
;this.__BD.resetSavedRange();return bP;}
else {this.error("Command "+bN+" is currently not supported!");}
;}
,__BL:function(){var Node=qx.dom.Node;var bR=this.__BD.getFocusNode();var bU=false;var bS=false;if(bR){if(Node.isText(bR)){var bT=qx.dom.Hierarchy.getAncestors(bR);for(var i=0,j=bT.length;i<j;i++ ){if(Node.isNodeName(bT[i],"p")||qx.bom.htmlarea.HtmlArea.isHeadlineNode(bT[i])){bU=true;break;}
;}
;}
else if(Node.isNodeName(bR,"body")){bS=true;}
;}
;return bS||!bU;}
,__BM:function(){this.__BN("formatBlock",false,"p");}
,__BN:function(bV,bW,bX){try{var cb=this.__lP;var bY=false;var ca=this.__BD.getRange();this.__lP.body.focus();if((qx.core.Environment.get("engine.name")=="mshtml")){if(bV!="selectall"){ca.select();if(((ca.text)&&(ca.text.length>0))||((ca.length==1)&&(ca.item(0))&&(ca.item(0).tagName=="IMG"))){cb=ca;}
else {cb=this.__lP;}
;}
;if(((qx.core.Environment.get("engine.name")=="mshtml"))&&(this.__BE[bV])){if(ca.text==""){bY=true;}
;}
;}
;var cc=cb.execCommand(bV,bW,bX);if(bY&&ca.text!=""){ca.collapse();}
;if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("execCommand "+bV+" with value "+bX+" succeded");}
;this.__BJ=false;}
catch(cd){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("execCommand "+bV+" with value "+bX+" failed");}
;return false;}
;return cc;}
,__BO:qx.core.Environment.select("engine.name",{"mshtml":function(){var cf=this.__BD;var ce=cf.getSavedRange()!=null?cf.getSavedRange():cf.getRange();return ce;}
,"default":function(){return this.__BD.getRange();}
}),__BP:qx.core.Environment.select("engine.name",{"mshtml":function(cg,ch){var ck;if(cg==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__BS();}
else {this.__lP.body.focus();var cj=this.__BD.getSelection();var ci=this.__BO();if(ci&&cj&&cj.type!="Control"){try{ci.pasteHTML(cg);ci.collapse(false);ci.select();ck=true;}
catch(e){}
;}
else {ck=false;}
;this.__BD.resetSavedRange();return ck;}
;}
,"default":function(cl,cm){this.__lP.body.focus();return this.__lP.execCommand(cm.identifier,false,cl);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(by,{"gecko":function(){var cu=this.__Cd();var cy=this.__BQ(cu);var cq=this.__Cb(cu);var cv=W+Date.parse(new Date());var cw=u+Date.parse(new Date());var co=bf;var cs=bp+cv+bJ;co+=cs;co+=H+cw+n+cy+bj;co+=cq+h;this.__BD.getCommandManager().addUndoStep(bo,g,this.getCommandObject(bo));this.execute(bo,co);this.__BR();qx.bom.element.Attribute.reset(this.__lP.getElementById(cv),ba);var ct=this.__lP.getElementById(cw);if(ct.previousSibling.innerHTML==cs){var cn=this.__Cc();var cr=this.__lP.createElement(U);var cp=this.__lP.createAttribute(bE);cp.nodeValue=V;cr.setAttributeNode(cp);var cx=this.__lP.createAttribute(z);cx.nodeValue=q;cr.setAttributeNode(cx);ct.previousSibling.appendChild(cn);ct.previousSibling.appendChild(cr);}
;qx.bom.element.Attribute.reset(ct,ba);return true;}
,"webkit":function(){var cz=this.getCurrentStyles();var cA=V;var cC={"background-color":true,"text-align":true};for(var cB in cz){if(cC[cB]){cA+=cB+x+cz[cB]+C;}
;}
;this.__BD.insertHtml(v+cA+bH);}
,"default":(function(){}
)}),__BQ:qx.core.Environment.select("engine.name",{"gecko":function(cD){var cI='style="';var cH=cD.child;if(cH["text-align"]){cI+='text-align:'+cH["text-align"]+';';delete cD.child["text-align"];}
;if(cH["font-family"]){cI+='font-family:'+cH["font-family"]+';';delete cD.child["font-family"];}
;var cG={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};var cE={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};for(var cF in cH){if(cG[cF]||cE[cF]){cI+=cF+':'+cH[cF]+';';delete cD.child[cF];}
;}
;cI+='"';return cI;}
,"default":function(){return "";}
}),__BR:qx.core.Environment.select("engine.name",{"gecko":function(){var cQ=this.__BD.getSelection();if(!cQ||!cQ.focusNode){return;}
;var cJ=cQ.focusNode;var cO=cQ.focusNode;while(!qx.dom.Node.isNodeName(cO,"p")){cO=cO.parentNode;}
;var cN=cO.previousSibling.id;var cR=cO.nextSibling?cO.nextSibling.id:null;if(qx.lang.String.startsWith(cN,"__paragraph__")&&cN==cR){var cP=cO.nextSibling;var cL=this.__BD.getRange();cL.selectNode(cP);cQ.addRange(cL);var cK=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__BD.getCommandManager().addUndoStep("inserthtml",cK,this.getCommandObject("inserthtml"));this.execute("inserthtml",cK);var cM=this.__BD.getRange();if(cJ){while(cJ&&cJ.firstChild&&qx.dom.Node.isElement(cJ.firstChild)){cJ=cJ.firstChild;}
;}
;cM.selectNode(cJ);cQ.addRange(cM);cM.collapse(true);}
;}
,"default":(function(){}
)}),__BS:qx.core.Environment.select("engine.name",{"mshtml":function(){var cS=this.__BD.getRange();if(cS&&!qx.dom.Node.isNodeName(cS.parentElement(),"li")){cS.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);cS.collapse(false);cS.select();return true;}
;return false;}
,"default":function(){return false;}
}),__BT:function(cT,cU){var cV=(qx.core.Environment.get("engine.name")=="mshtml")?this.__BD.getRange():this.__lP;return cV.execCommand(cU.identifier,false,cT);}
,__BU:function(cW,cX){if((qx.core.Environment.get("engine.name")=="mshtml")){var cY=this.__BD.getFocusNode();this.__BV(cY);}
;this.__lP.body.focus();var da=this.__lP.execCommand(cX.identifier,false,cW);if((qx.core.Environment.get("engine.name")=="webkit")){var cY=this.__BD.getFocusNode();this.__BV(cY.parentNode);}
;return da;}
,__BV:function(db){var dc=[];var parent=db.parentNode;while(qx.dom.Node.isNodeName(parent,"blockquote")){dc.push(parent);parent=parent.parentNode;}
;if(dc.length>0){parent.appendChild(db);parent.removeChild(dc[dc.length-1]);}
;}
,__BW:qx.core.Environment.select("engine.name",{"gecko":function(dd,de){if(dd.src){this.__lP.execCommand(de.identifier,false,dd.src);delete dd.src;var ds=this.__BD.getSelection();if(ds){var dr=ds.anchorNode;var dl=ds.anchorOffset;var di=dr.childNodes[dl-1];var dp;for(var dk in dd){dp=this.__lP.createAttribute(dk);dp.nodeValue=dd[dk];di.setAttributeNode(dp);}
;var dj={"font":true,"span":true};var dg=null;var dn=true;if(qx.dom.Node.isElement(di.previousSibling)&&dj[qx.dom.Node.getName(di.previousSibling)]){dg=di.previousSibling;}
else if(dj[qx.dom.Node.getName(di.parentNode)]){dg=di.parentNode;dn=false;}
;var dh=this.__lP.createDocumentFragment();var dt;if(dn&&dg!=null){var dj=this.__BX(dg);dh.appendChild(dj.root);dt=dj.inline;}
else {dt=this.__lP.createElement("span");dh.appendChild(dt);}
;var dq=this.__lP.createTextNode("");dt.appendChild(dq);var dm=di.parentNode;if(di==dm.lastChild){dm.appendChild(dh);}
else {dm.insertBefore(dh,di.nextSibling);}
;var df=this.__BD.getRange();df.selectNodeContents(dt);}
;return true;}
else {return false;}
;}
,"mshtml":function(du,dv){var dz=false;var dA="<img ";for(var dw in du){dA+=dw+"='"+du[dw]+"' ";}
;dA+="/>";var dx=this.__BD.getSelection();var dy=this.__BO();if(dx&&dx.type!="Control"){try{dy.select();dy.pasteHTML(dA);dz=true;}
catch(e){}
;}
;this.__BD.resetSavedRange();return dz;}
,"default":function(dB,dC){if(dB.src){var dE="<img ";for(var dD in dB){dE+=dD+"='"+dB[dD]+"' ";}
;dE+="/>";return this.__lP.execCommand("InsertHtml",false,dE);}
else {return false;}
;}
}),__BX:function(dF){while(dF.firstChild&&dF.firstChild.nodeType==1){dF=dF.firstChild;}
;var dJ=this.__Cd(dF);var dN,dH,dL;var dG="";var parent=null;var dM=null;var dK=dJ.child;while(dK){dM=this.__lP.createElement(dK["legacy-font-size"]?"font":"span");dH=this.__lP.createAttribute("style");dM.setAttributeNode(dH);for(var dI in dK){if(dI!="child"&&dI!="legacy-font-size"){dG+=dI+":"+dK[dI]+";";}
else if(dI=="legacy-font-size"){dL=this.__lP.createAttribute("size");dL.nodeValue=dK[dI];dM.setAttributeNode(dL);}
;}
;dH.nodeValue=dG;if(parent!=null){parent.appendChild(dM);}
else {dN=dM;}
;parent=dM;dK=dK.child;dG="";}
;return {root:dN,inline:dM};}
,__BY:qx.core.Environment.select("engine.name",{"gecko|opera":function(dO,dP){var dV=this.__BD.getSelection();var dS=this.__BD.getRange();if(dV.isCollapsed){var dR="qx_link"+( ++this.__BG);var dW=this.__lP.createElement("a");var dT=this.__lP.createAttribute("href");var dQ=this.__lP.createAttribute("id");var dU=this.__lP.createTextNode(dO);dQ.nodeValue=dR;dW.setAttributeNode(dQ);dT.nodeValue=dO;dW.setAttributeNode(dT);dW.appendChild(dU);dS.insertNode(dW);dS.selectNode(dW);dV.collapseToEnd();return true;}
else {return this.__lP.execCommand(dP.identifier,false,dO);}
;}
,"mshtml":function(dX,dY){try{var eb;var ea=this.__BO();var ec=this.__BD;var ea=ec.getSavedRange()!=null?ec.getSavedRange():ec.getRange();if(ea!=null&&ea.text!=""){eb=ea.execCommand(dY.identifier,false,dX);}
else {eb=this.__BP(' <a href="'+dX+'">'+dX+'</a> ',dY);}
;this.__BD.resetSavedRange();return eb;}
catch(e){if(qx.core.Environment.get("qx.debug")){this.error("inserthyperlink failed!");}
;return false;}
;}
,"default":function(ed,ee){return this.__lP.execCommand(ee.identifier,false,ed);}
}),__Ca:function(ef,eg){var eh=f;if((qx.core.Environment.get(by)==O)){eh+=this.__Cb();}
;return this.__BP(eh,eg);}
,__Cb:function(ei){var em=V;var el=S;var ek=[];var ep=typeof ei!==K?ei:this.__Cd();var en=ep.child;var eo=false;if(qx.lang.Object.isEmpty(en)){return V;}
;while(en){eo=en[Q]!=null;em+=eo?bD:el;for(var ej in en){em+=(ej!=bh&&ej!=Q)?ej+bw+en[ej]+bx:V;}
;em+=eo?bz+en[Q]+b:b;ek.unshift(eo?bn:bc);en=en.child;}
;if(ek.length==1&&ek[0]==bn){em+=bG;}
;for(var i=0,j=ek.length;i<j;i++ ){em+=ek[i];}
;return em;}
,__Cc:function(){var er=this.__lP.createDocumentFragment();var ew=this.__Cd();var parent=er;var eu=ew.child;var es;var ev=false;while(eu){ev=eu[Q]!=null;es=this.__lP.createElement(ev?A:G);parent.appendChild(es);for(var eq in eu){if(eq!=bh&&eq!=Q){qx.bom.element.Style.set(es,eq,eu[eq]);}
;}
;if(ev){var et=this.__lP.createAttribute(bB);et.nodeValue=eu[Q];es.setAttributeNode(et);}
;parent=es;eu=eu.child;}
;return er;}
,__Cd:function(ey){var eA={};var eB=null;var eC=this.getCurrentStyles(ey);eB=eA.child={};for(var ez in eC){if(ez!=L){eB[ez]=eC[ez];}
;}
;if(eC[L]){var eD=eC[L];for(var i=0,j=eD.length;i<j;i++ ){if(eB==null){eB=eA.child={};}
else {eB=eB.child={};}
;eB[J]=eD[i][J];eB[T]=eD[i][T];}
;}
;if(eC[J]&&eC[T]){eB=eB.child={};eB[J]=eC[J];}
;return eA;}
,getCurrentStyles:function(eE){if(eE==null){var eG=this.__BD.getSelection();if(!eG||eG.focusNode==null){return {};}
;eE=(eG.focusNode.nodeType==3)?eG.focusNode.parentNode:eG.focusNode;}
;var eH=qx.dom.Hierarchy.getAncestors(eE);var eJ=qx.lang.Array.insertBefore(eH,eE,eH[0]);var eF=this.__Ce(eJ);var eI=this.__Cf(eF,eJ);return eI;}
,__Ce:function(eK){var eN={};var eL,eM;for(var i=0,j=eK.length;i<j;i++ ){eM=eK[i];for(var k=0,l=eM.style.length;k<l;k++ ){eL=eM.style[k];if(eL.length>0&&typeof eN[eL]===K){eN[eL]=eM.style.getPropertyValue(eL);}
;}
;if(eM.tagName.toUpperCase()==bF&&eM.size&&eN[Q]===undefined){eN[Q]=eM.size;}
;}
;if(eN[Q]&&eN[bg]){delete eN[bg];}
;return eN;}
,__Cf:function(eO,eP){var eU=eP[0];var eS=this.__BD.getContentWindow().getComputedStyle(eU,null);var eQ;var eT={};for(var eR in eO){if(eR!=Q){eQ=eS.getPropertyValue(eR);}
else {eQ=eO[eR];}
;if(eR==M&&eQ==bu){eT[eR]=this.__Ch(eP);}
else if(eR==L){eT[eR]=this.__Cg(eP);}
else {eT[eR]=eQ;}
;}
;return eT;}
,__Cg:function(eV){var eY,fb,eW;var fa=[];var eX=this.__BD.getContentWindow();for(var i=0,j=eV.length;i<j;i++ ){eW=eX.getComputedStyle(eV[i],null);eY=eW.getPropertyValue(L);fb=eW.getPropertyValue(bC);if(eY!=br){fa.push({'text-decoration':eY,'color':fb});}
;}
;return fa;}
,__Ch:function(fc){var fe,fd,ff;for(var i=0;i<fc.length;i++ ){fe=fc[i];fd=this.__BD.getContentWindow().getComputedStyle(fe,null);ff=fd.getPropertyValue(M);if(ff!=bu){return ff;}
;}
;}
,__Ci:function(fg,fh){var ft=this.__BD.getSelection();var fo=((qx.core.Environment.get(by)==c))?this.__BD.getRange():fo=ft.getRangeAt(0);var fp=[];var fs;var fn=[s,bI];var fi,i,j,fq;fq=((qx.core.Environment.get(by)==c))?fo.parentElement():fo.commonAncestorContainer;if(fq.tagName==E){for(var i=0;i<fn.length;i++ ){fi=fq.getElementsByTagName(fn[i]);for(var j=0;j<fi.length;j++ ){if(fi[j]){fp.push(fi[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(fn,fq.tagName)){fp.push(fq);}
;if(fp.length>0){for(var i=0;i<fp.length;i++ ){var fk=fp[i];fs=((qx.core.Environment.get(by)==c))?((fk==fq)||(fq.tagName==E)):ft.containsNode(fk,false);for(j=0;j<fk.childNodes.length;j++ ){var fm=fk.childNodes[j];if(fs||(ft.focusNode.nodeValue&&qx.dom.Hierarchy.contains(fm,ft.focusNode)&&(ft.focusOffset==ft.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(fm,ft.anchorNode)&&(ft.anchorOffset==0))||(ft.containsNode(fm,false))){fm.style.fontSize=(this.__BF[fg]||fg)+bq;}
;}
;}
;}
else {var fl=((qx.core.Environment.get(by)==c))?fq:ft.focusNode;var fr=qx.dom.Hierarchy.getAncestors(fl);for(i=0;i<fr.length;i++ ){if(fr[i].tagName==bb){if((((qx.core.Environment.get(by)==O))&&((ft.anchorOffset==0)&&(ft.focusNode.nodeValue&&(ft.focusOffset==ft.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(fr[i].firstChild,ft.anchorNode)&&qx.dom.Hierarchy.contains(fr[i].lastChild,ft.focusNode)))||(((qx.core.Environment.get(by)==c))&&(fo.htmlText==fr[i].innerHTML))){fr[i].style.fontSize=(this.__BF[fg]||fg)+bq;}
;break;}
;}
;}
;if((qx.core.Environment.get(by)==c)){this.__lP.body.focus();this.__BD.getRange().select();return this.__lP.execCommand(bm,false,fg);}
else if((qx.core.Environment.get(by)==O)){var parent=fo.commonAncestorContainer;if(parent.nodeType===1){var fj=parent.getElementsByTagName(G);for(i=0;i<fj.length;i++ ){if(fj[i].style.fontSize){fj[i].style.fontSize=null;}
;}
;}
;}
;return this.__lP.execCommand(bm,false,fg);}
,__Cj:qx.core.Environment.select(by,{"mshtml":function(fu,fv){this.__lP.body.focus();return this.__lP.execCommand(bs,false,fu);}
,"gecko|opera":function(fw,fx){this.__lP.body.focus();return this.__lP.execCommand(N,false,fw);}
,"webkit":function(fy,fz){var fA=this.__BD.getSelection();var fB=this.__BD.getRange();if(!fA||!fA.isCollapsed){this.__lP.body.focus();this.__lP.execCommand(bs,false,fy);if(fA){fA.collapseToEnd();}
;return true;}
else {var fD=fA.anchorOffset;var fE=fA.anchorOffset;var fB=fA.getRangeAt(0);var fC=fA.anchorNode;while(fE>0){if(fC.nodeValue.charCodeAt(fE)==160||fC.nodeValue.charCodeAt(fE)==32){break;}
else {fE-- ;}
;}
;while(fD<fC.nodeValue.length){if(fC.nodeValue.charCodeAt(fD)==160||fC.nodeValue.charCodeAt(fD)==32){break;}
else {fD++ ;}
;}
;fB.setStart(fA.anchorNode,fA.anchorNode.nodeValue.charAt(fE)==F?fE+1:fE);fB.setEnd(fA.anchorNode,fD);fA.addRange(fB);this.__lP.body.focus();this.__lP.execCommand(bs,false,fy);fA.collapseToEnd();return true;}
;}
}),__Ck:function(fF,fG){fF=fF!=null&&typeof fF==bd?fF:bu;qx.bom.element.Style.set(this.__lP.body,r,fF);return true;}
,__Cl:function(fH,fI){var fJ,fL,fK;var fM=qx.bom.htmlarea.manager.Command;if(fH==null){fJ=null;}
else {fJ=fH[0];fL=fH[1];fK=fH[2];}
;if(fJ==null||typeof fJ!=bd){qx.bom.element.Style.set(this.__lP.body,a,V);qx.bom.element.Style.set(this.__lP.body,bk,V);qx.bom.element.Style.set(this.__lP.body,D,V);return true;}
else {if(fJ.search(/^url.*\(/)==-1){fJ=be+fJ+Y;}
;}
;if(fL!=null&&!qx.lang.String.contains(fM.__BI,fL)){if(qx.core.Environment.get(bt)){this.error("The value '"+fL+"' is not allowed for parameter 'repeat'. Possible values are '"+fM.__BI+"'");}
;return false;}
else {fL=bA;}
;if(fK!=null){if(qx.lang.Type.isString(fK)&&!qx.lang.String.contains(fM.__BH,X+fK+X)){if(qx.core.Environment.get(bt)){this.error("The value '"+fK+"' is not allowed for parameter 'position'. Possible values are '"+fM.__BH+"'");}
;return false;}
else {if(qx.lang.Type.isArray(fK)&&fK.length==2){fK=fK[0]+F+fK[1];}
else {if(qx.core.Environment.get(bt)){this.error("If an array is provided for parameter 'position' it has to define two elements!");}
;return false;}
;}
;}
else {fK=p;}
;qx.bom.element.Style.set(this.__lP.body,a,fJ);qx.bom.element.Style.set(this.__lP.body,bk,fL);qx.bom.element.Style.set(this.__lP.body,D,fK);return true;}
,__Cm:qx.core.Environment.select(by,{"mshtml":function(fN,fO){var fP=this.__lP.body.createTextRange();fP.select();return true;}
,"default":function(fQ,fR){return this.__BN(fR.identifier,false,fQ);}
}),__Cn:function(){return this.__BD.getSelectedText();}
,__Co:function(){return this.__BD.getSelectedHtml();}
,__Cp:function(fS,fT){var fX=this.__BD.getFocusNode();if(fX.textContent==V){var fV=qx.dom.Hierarchy.getAncestors(fX);fV.unshift(fX);var Node=qx.dom.Node;var fU=qx.bom.element.Style;var fW=fV.shift();while(fV.length>0){if(Node.getName(fW)==P||Node.getName(fW)==bi){break;}
;if(fU.get(fW,fS,fU.LOCAL_MODE)==fT){fU.reset(fW,fS);return true;}
;fW=fV.shift();}
;}
;return false;}
,__Cq:qx.core.Environment.select(by,{"gecko":function(fY,ga){if(this.__Cp(y,bl)){return true;}
else {return this.__BN(ga.identifier,false,fY);}
;}
,"default":function(gb,gc){return this.__BN(gc.identifier,false,gb);}
}),__Cr:qx.core.Environment.select(by,{"gecko":function(gd,ge){if(this.__Cp(I,w)){return true;}
else {return this.__BN(ge.identifier,false,gd);}
;}
,"default":function(gf,gg){return this.__BN(gg.identifier,false,gf);}
}),__Cs:qx.core.Environment.select(by,{"gecko":function(gh,gi){if(this.__Cp(d,R)){return true;}
else {return this.__BN(gi.identifier,false,gh);}
;}
,"default":function(gj,gk){return this.__BN(gk.identifier,false,gj);}
}),__Ct:qx.core.Environment.select(by,{"gecko":function(gl,gm){if(this.__Cp(d,t)){return true;}
else {return this.__BN(gm.identifier,false,gl);}
;}
,"default":function(gn,go){return this.__BN(go.identifier,false,gn);}
})},destruct:function(){this.__lP=this.__BD=this._commands=null;this.__BE=this.__BF=null;}
});}
)();
(function(){var m="undo",l="pageup",k="b",h="control",g="shift",f="end",d="pagedown",c="qx.debug",b="home",a="__AJ",O="y",N="redo",M="k",L="qx.bom.htmlarea.manager.UndoRedo",K="i",J="u",I="right",H="enter",G="qx.bom.htmlarea.HtmlArea.debug",F="a",t="z",u="left",r="undoRedoState",s="down",p="up",q="mousedown",n="Command",o="Content",v="table",w="Custom",z="td",y="img",B="mouseup",A="keypress",D="webkit",C="Internal",x="mshtml",E="engine.name";qx.Class.define(L,{extend:qx.core.Object,construct:function(P,Q){qx.core.Object.call(this);this.__AJ=P;this.__BD=Q;this.__Cu=[];this.__Cv=[];this._commands=null;this.__lP=null;this.__Cw={};this.__Cx={command:true,content:true,custom:true};this.__BK();this.__Cy=qx.lang.Function.bind(this._handleKeyPress,this);this.__Cz=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(E)==x)){this.__CA=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__CB:false,__CC:false,__CD:false,__Cx:null,__Cw:null,__AJ:null,__lP:null,__Cu:null,__Cv:null,__BD:null,__Cy:null,__Cz:null,__CA:null,__CE:null,setContentDocument:function(R){this.__lP=R;this.__AJ.setContentDocument(R);qx.event.Registration.addListener(R.body,A,this.__Cy,this);qx.event.Registration.addListener(R.body,B,this.__Cz,this);if((qx.core.Environment.get(E)==x)){qx.event.Registration.addListener(R.body,q,this.__CA,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__AJ.insertParagraphOnLinebreak();}
,execute:function(S,T){var U;S=S.toLowerCase();if(this._commands[S]){if(this._commands[S].passthrough){U=this.__AJ.execute(S,T);}
else {U=this[S].call(this);}
;}
else {if((qx.core.Environment.get(E)==x)||(qx.core.Environment.get(E)==D)){this.__CV(S,T,this.__AJ.getCommandObject(S));U=this.__AJ.execute(S,T);if(!U){this.__Cu.pop();}
;}
else {U=this.__AJ.execute(S,T);if(U){this.__CV(S,T,this.__AJ.getCommandObject(S));}
;}
;if(S==m&&this.__Cu.length==0){this.__CC=false;this.__De();}
else if(S==N&&this.__Cv.length==0){this.__CB=false;this.__De();}
;}
;this.__CD=false;return U;}
,addUndoStep:function(V,W,X){this.__CV(V,W,X);}
,registerHandler:function(Y,ba,bb,bc){this.__Cw[Y]={undo:ba,redo:bb,context:bc};}
,isUndoPossible:function(){return this.__CC;}
,undo:function(){var bf;if(this.__CD){this.__CX();}
;if(this.__Cu.length>0){var be=this.__Cu.pop();if(this.__Cx[be.actionType.toLowerCase()]){switch(be.actionType){case n:bf=this.__CG(be);break;case o:bf=this.__CK(be);break;case C:bf=this.__CJ(be);break;case w:bf=this.__CF(be);break;};}
else if(this.__Cw[be.actionType]){var bd=this.__Cw[be.actionType];bf=bd.undo.call(bd.context?bd.context:this,be);this.__Da(be);}
else {this.error("actionType "+be.actionType+" is not managed! Please provide a handler method!");}
;this.__CB=true;this.__De();return bf;}
;}
,__CF:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bg){var bh=this.__lP.body.innerHTML;var bj=bg.content;this.__lP.body.innerHTML=bj;var bi=bg;bi.content=bh;this.__Da(bi);return true;}
,"default":function(bk){var bo=bk;var bn=qx.bom.element.Style;switch(bk.command){case "backgroundcolor":bo.parameter=[bn.get(this.__lP.body,"backgroundColor")];break;case "backgroundimage":bo.parameter=[bn.get(this.__lP.body,"backgroundImage"),bn.get(this.__lP.body,"backgroundRepeat"),bn.get(this.__lP.body,"backgroundPosition")];break;};this.__Da(bo);if(bk.command=="inserthyperlink"){if((qx.core.Environment.get("engine.name")=="gecko")){var bm="qx_link"+this.__AJ.__hyperLinkId;var bl=this.__lP.getElementById(bm);if(bl){bl.parentNode.removeChild(bl);return true;}
else {return false;}
;}
;}
else {return this.__AJ.execute(bk.command,bk.value);}
;}
}),__CG:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bp){}
,"default":function(bq){this.__Da(bq);if((qx.core.Environment.get("engine.name")=="gecko")){if(bq.command=="inserthtml"&&bq.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__CH("inserthtml","insertParagraph")){this.__CI();}
;}
;return this.__CL();}
}),__CH:function(br,bs){if(this.__Cu.length>0){var bt=this.__Cu[this.__Cu.length-1];return (bt.command==br&&bt.value==bs);}
;return false;}
,__CI:function(){this.__CL();if(this.__Cu.length>0){var bu=this.__Cu.pop();this.__Da(bu);}
;}
,__CJ:function(bv){this.__Da(bv);return this.__CL();}
,__CK:qx.core.Environment.select("engine.name",{"gecko":function(bw){this.__Da(bw);try{return this.__CL();}
catch(bx){if(qx.core.Environment.get("qx.debug")){this.error("execCommand failed! Details: "+bx);}
;}
;}
,"mshtml|webkit":function(by){}
,"default":function(bz){this.__Da(bz);return this.__CL();}
}),__CL:function(){try{return this.__lP.execCommand("Undo",false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__CB;}
,redo:function(){if(this.__CB){var bB;if(this.__Cv.length>0){var bC=this.__Cv.pop();if(this.__Cx[bC.actionType.toLowerCase()]){switch(bC.actionType){case n:bB=this.__CN(bC);break;case o:bB=this.__CT(bC);break;case C:bB=this.__CS(bC);break;case w:bB=this.__CM(bC);break;};}
else if(this.__Cw[bC.actionType]){var bA=this.__Cw[bC.actionType];bB=bA.redo.call(bA.context?bA.context:this,bC);this.__CY(bC);}
else {this.error("actionType "+bC.actionType+" is not managed! Please provide a handler method!");}
;this.__CC=true;this.__De();}
;return bB;}
;}
,__CM:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bD){var bE=this.__lP.body.innerHTML;var bG=bD.content;this.__lP.body.innerHTML=bG;var bF=bD;bF.content=bE;this.__CY(bF);return true;}
,"default":function(bH){this.__CY(bH);return this.__CU();}
}),__CN:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bI){}
,"default":function(bJ){this.__CY(bJ);var bK=this.__CU();if((qx.core.Environment.get("engine.name")=="gecko")){if(this.__CO("inserthtml",qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var bL=this.__CP();this.__CQ();if(bL!=null){this.__CR(bL);}
;}
;}
;return bK;}
}),__CO:function(bM,bN){if(this.__Cv.length>0){var bO=this.__Cv[this.__Cv.length-1];return (bO.command==bM&&bO.value==bN);}
;return false;}
,__CP:function(){if(this.__BD==null){return null;}
;var bP=this.__BD.getSelection();var bQ=bP?bP.focusNode:null;if(bQ==null){return null;}
;try{while(bQ.nodeName.toLowerCase()!="p"){bQ=bQ.parentNode;if(!bQ||qx.dom.Node.isNodeName(bQ,"body")){return null;}
;}
;}
catch(bR){return null;}
;if(bQ!=null&&qx.dom.Node.isNodeName(bQ,"p")){return bQ;}
else {return null;}
;}
,__CQ:function(){var bS=this.__Cv.pop();this.__CY(bS);this.__CU();}
,__CR:qx.core.Environment.select("engine.name",{"gecko":function(bT){if(bT==this.__BD.getContentBody().lastChild){return;}
;var bW=bT.firstChild;while(bW.firstChild){bW=bW.firstChild;}
;var bU=this.__BD.getSelection();var bV=this.__BD.getRange();if(bU&&bV){bV.selectNode(bW);bU.addRange(bV);bV.collapse(true);}
;}
,"default":(function(){}
)}),__CS:function(bX){this.__CY(bX);return this.__CU();}
,__CT:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bY){}
,"default":function(ca){this.__CY(ca);return this.__CU();}
}),__CU:function(){try{return this.__lP.execCommand("Redo",false,null);}
catch(e){return false;}
;}
,__BK:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__AJ.getCommandObject("backgroundcolor").customUndo=true;this.__AJ.getCommandObject("backgroundimage").customUndo=true;if((qx.core.Environment.get("engine.name")=="gecko")){}
;}
,__CV:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(cb,cc,cd){var ce=this.getUndoRedoObject();ce.commandObject=cd;ce.command=cb;ce.value=cc;ce.actionType="Custom";ce.content=this.__lP.body.innerHTML;this.__CW(ce);}
,"default":function(cf,cg,ch){if(this.__BD==null){return;}
;var cj=this.getUndoRedoObject();cj.commandObject=ch;cj.command=cf;cj.value=cg;cj.actionType="Custom";var ci=this.__BD.getSelection();if(ch.customUndo){var ck=[];switch(cf){case "backgroundcolor":ck.push(qx.bom.element.Style.get(this.__lP.body,"backgroundColor"));break;case "backgroundimage":ck.push(qx.bom.element.Style.get(this.__lP.body,"backgroundImage"),qx.bom.element.Style.get(this.__lP.body,"backgroundRepeat"),qx.bom.element.Style.get(this.__lP.body,"backgroundPosition"));break;case "inserthyperlink":if(ci&&!ci.isCollapsed){cj.actionType="Command";}
;break;};cj.parameter=ck;}
else {if((qx.core.Environment.get("engine.name")=="gecko")){if(ci&&ci.isCollapsed){switch(cf){case "insertorderedlist":case "insertunorderedlist":case "justifyright":case "inserthtml":case "insertimage":cj.actionType="Command";break;default:return;};}
else {cj.actionType="Command";}
;}
else {cj.actionType="Command";}
;}
;this.__CW(cj);}
}),__CW:function(cl){if(this.__CD){this.__CX();}
;this.__CY(cl);this.__CB=false;this.__Cv=[];this.__De();}
,__CX:function(){var cm=this.__Cu[this.__Cu.length-1];if(cm==null||cm.actionType!="Content"){var cn=this.getUndoRedoObject();cn.actionType="Content";if((qx.core.Environment.get("engine.name")=="mshtml")||(qx.core.Environment.get("engine.name")=="webkit")){cn.content=this.__CE;cn.actionType="Custom";this.__CE=null;}
;this.__CY(cn);this.__CD=false;}
;}
...
,__CY:function(co){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("ADD TO UNDO STACK");this.debug(co.actionType+" "+co.command+" "+co.value);}
;this.__Cu.push(co);}
,__Da:function(cp){if((qx.core.Environment.get(c))&&qx.core.Environment.get(G)){this.debug("ADD TO REDO STACK");this.debug(cp.actionType+" "+cp.command+" "+cp.value);}
;this.__Cv.push(cp);}
,_handleKeyPress:function(e){var cq=e.getKeyIdentifier().toLowerCase();var cr=e.isCtrlPressed();switch(cq){case h:case g:case u:case I:case p:case s:case l:case d:case b:case f:case H:break;case F:case k:case K:case J:case M:case O:case t:if(!cr){this.__Db();}
;break;default:this.__CB=false;this.__Cv=[];this.__Db();};}
,__Db:function(){if(!this.__CD){this.__CD=true;this.__CC=true;if((qx.core.Environment.get(E)==x)||(qx.core.Environment.get(E)==D)){this.__CE=this.__lP.body.innerHTML;}
;this.__De();}
;}
,__Dc:null,_handleMouseDown:qx.core.Environment.select(E,{"mshtml":function(e){var cs=e.getOriginalTarget();if(qx.dom.Node.isElement(cs)&&(qx.dom.Node.isNodeName(cs,y)||qx.dom.Node.isNodeName(cs,v))){this.__Dc={node:cs,content:cs.outerHTML};}
else {this.__Dc=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(E,{"gecko":function(e){if(this.__BD==null){return;}
;var cu=this.__BD.getSelection();if(!cu){this.__Dc=null;return;}
;var ct=cu.anchorNode;var cv=ct.childNodes[cu.anchorOffset];if(qx.dom.Node.isNodeName(cv,y)){if(this.__Dc==null){this.__Dc=cv.cloneNode(true);}
else {if(this.__Dc.style.width!=cv.style.width||this.__Dc.style.height!=cv.style.height){this.__Dd();this.__Dc=cv.cloneNode(true);}
;}
;}
else if(qx.dom.Node.isNodeName(ct,z)||qx.dom.Node.isNodeName(ct.parentNode,z)){var cw=ct.parentNode;while(qx.dom.Node.isNodeName(cw,v)){cw=cw.parentNode;}
;if(this.__Dc==null){this.__Dc=cw.cloneNode(true);}
else {qx.event.Timer.once(function(){if(cw.style.width!=this.__Dc.style.width||cw.style.height!=this.__Dc.style.height||cw.innerHTML!=this.__Dc.innerHTML){this.__Dd();this.__Dc=cw.cloneNode(true);}
;}
,this,0);}
;}
else {this.__Dc=null;}
;}
,"default":function(e){var cx=qx.bom.Event.getTarget(e);if(this.__Dc!=null){if(cx.nodeType==1){if(cx==this.__Dc.node){if(cx.outerHTML!=this.__Dc.content){this.__Dc.content=cx.outerHTML;this.__Dd();}
;}
else {for(var i=0,j=cx.childNodes.length;i<j;i++ ){if(cx.childNodes[i]==this.__Dc.node){if(cx.childNodes[i].outerHTML!=this.__Dc.content){this.__Dc.content=cx.childNodes[i].outerHTML;this.__Dd();}
;}
;}
;}
;}
...
;}
;}
}),__Dd:qx.core.Environment.select(E,{"mshtml|webkit":function(){this.__CV(C,null,null);}
,"default":function(){var cy=this.getUndoRedoObject();cy.actionType=C;this.__CY(cy);}
}),__De:function(){qx.event.Timer.once(function(e){if(this.__BD!=null){var cz={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__BD.fireDataEvent(r,cz);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__lP.body,A,this.__Cy);qx.event.Registration.removeListener(this.__lP,B,this.__Cz);if((qx.core.Environment.get(E)==x)){qx.event.Registration.removeListener(this.__lP,q,this.__CA);}
;}
catch(e){}
;this._disposeObjects(a);this.__BD=this.__Cu=this.__Cv=this._commands=this.__lP=null;this.__Cx=this.__Cw=null;}
});}
)();
