...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns.0860088651cd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="scrollY",f="update",d="scrollX",c="pane",b="os.scrollBarOverlayed",a="qx.ui.virtual.core.Scroller";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(h,i,j,k){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__xw=new qx.ui.virtual.core.Pane(h,i,j,k);this.__xw.addListener(f,this._computeScrollbars,this);this.__xw.addListener(d,this._onScrollPaneX,this);this.__xw.addListener(g,this._onScrollPaneY,this);if(qx.core.Environment.get(b)){this._add(this.__xw,{edge:0});}
else {this._add(this.__xw,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__xw:null,getPane:function(){return this.__xw;}
,_createChildControlImpl:function(l,m){if(l==c){return this.__xw;}
...
,_onScrollBarX:function(e){this.__xw.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__xw.setScrollY(e.getData());}
},destruct:function(){this.__xw.dispose();this.__xw=null;}
});}
)();
(function(){var l="scrollY",k="mousedown",j="__xy",h="__xD",g="dblclick",f="__xC",d="qx.debug",c="qx.event.type.Event",b="cellContextmenu",a="resize",x="scrollX",w="__xx",v="cellDblclick",u="qx.ui.virtual.core.Pane",t="click",s="cellClick",r="contextmenu",q="qx.event.type.Data",p="change",o="update",m="qx.ui.virtual.core.CellEvent",n="appear";qx.Class.define(u,{extend:qx.ui.core.Widget,construct:function(y,z,A,B){qx.ui.core.Widget.call(this);this.__xx=new qx.ui.virtual.core.Axis(A,y);this.__xy=new qx.ui.virtual.core.Axis(B,z);this.__om=0;this.__ol=0;this.__xz=0;this.__xA=0;this.__xB={};this.__iV={};this.__xC=new qx.ui.container.Composite();this.__xC.setUserBounds(0,0,0,0);this._add(this.__xC);this.__xD=[];this.__xx.addListener(p,this.fullUpdate,this);this.__xy.addListener(p,this.fullUpdate,this);this.addListener(a,this._onResize,this);this.addListenerOnce(n,this._onAppear,this);this.addListener(k,this._onMouseDown,this);this.addListener(t,this._onClick,this);this.addListener(g,this._onDblclick,this);this.addListener(r,this._onContextmenu,this);}
,events:{cellClick:m,cellContextmenu:m,cellDblclick:m,update:c,scrollX:q,scrollY:q},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__xx:null,__xy:null,__om:null,__ol:null,__xz:null,__xA:null,__xB:null,__iV:null,__xC:null,__xD:null,__xE:null,__sp:null,__tV:null,__xF:null,getRowConfig:function(){return this.__xx;}
,getColumnConfig:function(){return this.__xy;}
,getChildren:function(){return [this.__xC];}
,addLayer:function(C){if(qx.core.Environment.get(d)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
...
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__xy.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__xx.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(H){var I=this.getScrollMaxY();if(H<0){H=0;}
else if(H>I){H=I;}
;if(this.__om!==H){var J=this.__om;this.__om=H;this._deferredUpdateScrollPosition();this.fireDataEvent(l,H,J);}
;}
,getScrollY:function(){return this.__om;}
,setScrollX:function(K){var L=this.getScrollMaxX();if(K<0){K=0;}
else if(K>L){K=L;}
;if(K!==this.__ol){var M=this.__ol;this.__ol=K;this._deferredUpdateScrollPosition();this.fireDataEvent(x,K,M);}
;}
,getScrollX:function(){return this.__ol;}
,getScrollSize:function(){return {width:this.__xy.getTotalSize(),height:this.__xx.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__xx.getItemPosition(N);var P=R+this.__xx.getItemSize(N);var O=this.getScrollY();if(R<O){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__xy.getItemPosition(S);var T=U+this.__xy.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bd=this.__xx.getItemAtPosition(this.getScrollY()+bc-bf.top);be=this.__xy.getItemAtPosition(this.getScrollX()+bb-bf.left);if(!bd||!be){return null;}
...
;var bn=this.__ol+bm.width;var bo=this.__xA-bn;if(this.__ol-this.__xB.left<Math.min(this.__ol,bg)||this.__xB.right-bn<Math.min(bo,bi)){var bp=Math.min(this.__ol,bh);var bl=Math.min(bo,bj);this._setLayerWindow(bk,this.__ol-bp,this.__om,bm.width+bp+bl,bm.height,false);}
;}
,prefetchY:function(bq,br,bs,bt){var bu=this.getVisibleLayers();if(bu.length==0){return;}
;var bx=this.getBounds();if(!bx){return;}
;var bv=this.__om+bx.height;var bw=this.__xz-bv;if(this.__om-this.__xB.top<Math.min(this.__om,bq)||this.__xB.bottom-bv<Math.min(bw,bs)){var bz=Math.min(this.__om,br);var by=Math.min(bw,bt);this._setLayerWindow(bu,this.__ol,this.__om-bz,bx.width,bx.height+bz+by,false);}
;}
,_onResize:function(){if(this.getContainerElement().getDomElement()){this.__xE=true;this._updateScrollPosition();this.__xE=null;this.fireEvent(o);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onMouseDown:function(e){this.__xF=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onClick:function(e){this.__xG(e,s);}
,_onContextmenu:function(e){this.__xG(e,b);}
,_onDblclick:function(e){this.__xG(e,v);}
,__xG:function(e,bA){var bC=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bC){return;}
;var bB=this.__xF;if(bB==null||bB.row!==bC.row||bB.column!==bC.column){return;}
;this.fireNonBubblingEvent(bA,qx.ui.virtual.core.CellEvent,[this,e,bC.row,bC.column]);}
,syncWidget:function(bD){if(this.__iV._fullUpdate){this._fullUpdate();}
else if(this.__iV._updateScrollPosition){this._updateScrollPosition();}
;this.__iV={};}
,_setLayerWindow:function(bE,bF,top,bG,bH,bI){var bN=this.__xx.getItemAtPosition(top);if(bN){var bP=bN.index;var bT=this.__xx.getItemSizes(bP,bH+bN.offset);var bO=qx.lang.Array.sum(bT);var bV=top-bN.offset;var bS=top-bN.offset+bO;}
else {var bP=0;var bT=[];var bO=0;var bV=0;var bS=0;}
;var bR=this.__xy.getItemAtPosition(bF);if(bR){var bL=bR.index;var bK=this.__xy.getItemSizes(bL,bG+bR.offset);var bQ=qx.lang.Array.sum(bK);var bU=bF-bR.offset;var bM=bF-bR.offset+bQ;}
else {var bL=0;var bK=[];var bQ=0;var bU=0;var bM=0;}
;this.__xB={top:bV,bottom:bS,left:bU,right:bM};this.__xC.setUserBounds(this.__xB.left-this.__ol,this.__xB.top-this.__om,bQ,bO);this.__sp=bK;this.__tV=bT;for(var i=0;i<this.__xD.length;i++ ){var bJ=this.__xD[i];bJ.setUserBounds(0,0,bQ,bO);if(bI){bJ.fullUpdate(bP,bL,bT,bK);}
else {bJ.updateLayerWindow(bP,bL,bT,bK);}
;}
;}
,__xH:function(){if(this.__xE){return;}
;var bW=this.getScrollSize();if(this.__xz!==bW.height||this.__xA!==bW.width){this.__xz=bW.height;this.__xA=bW.width;this.fireEvent(o);}
;}
,fullUpdate:function(){this.__iV._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__iV._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__xH();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__ol,this.__om,bY.width,bY.height,true);this.__xH();}
,_deferredUpdateScrollPosition:function(){this.__iV._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__xH();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__om,bottom:this.__om+cc.height,left:this.__ol,right:this.__ol+cc.width};if(this.__xB.top<=cb.top&&this.__xB.bottom>=cb.bottom&&this.__xB.left<=cb.left&&this.__xB.right>=cb.right){this.__xC.setUserBounds(this.__xB.left-cb.left,this.__xB.top-cb.top,this.__xB.right-this.__xB.left,this.__xB.bottom-this.__xB.top);}
else {this._setLayerWindow(ca,this.__ol,this.__om,cc.width,cc.height,false);}
;this.__xH();}
},destruct:function(){this._disposeArray(h);this._disposeObjects(w,j,f);this.__xB=this.__iV=this.__sp=this.__tV=null;}
});}
)();
...
,events:{"change":f},members:{__xI:null,getDefaultItemSize:function(){return this.defaultItemSize;}
...
;}
;if(t.length==0){var u=[{startIndex:0,endIndex:y-1,firstItemSize:r,rangeStart:0,rangeEnd:y*r-1}];this.__xI=u;return u;}
...
;var z=u[u.length-1];var w=(y-z.startIndex-1)*r;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=y-1;this.__xI=u;return u;}
,__xK:function(A){var B=this.__xI||this.__xJ();var C=0;var E=B.length-1;while(true){var F=C+((E-C)>>1);var D=B[F];if(D.rangeEnd<A){C=F+1;}
else if(D.rangeStart>A){E=F-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(G){if(G<0||G>=this.getTotalSize()){return null;}
;var I=this.__xK(G);var K=I.rangeStart;var H=I.startIndex;var L=I.firstItemSize;if(K+L>G){return {index:H,offset:G-K};}
else {var J=this.defaultItemSize;return {index:H+1+Math.floor((G-K-L)/J),offset:(G-K-L)%J};}
;}
,__xL:function(M){var N=this.__xI||this.__xJ();var O=0;var Q=N.length-1;while(true){var R=O+((Q-O)>>1);var P=N[R];if(P.endIndex<M){O=R+1;}
...
,_onChangeSelection:function(e){if(this.__xN==true){return;}
;this.__xM=true;var F=this.getSelection();var H=[];for(var i=0;i<F.getLength();i++ ){var G=F.getItem(i);var I=this._getSelectables();var E=-1;if(I!=null){E=I.indexOf(G);}
...
;this.__xr();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__xM=false;}
,_onManagerChangeSelection:function(e){if(this.__xM==true){return;}
;this.__xN=true;this.__xr();this.__xN=false;}
,__xr:function(){if(this.__xP()){return;}
;var L=this._manager.getSelection();var M=[];for(var i=0;i<L.length;i++ ){var N=this._getDataFromRow(L[i]);if(N!=null){M.push(N);}
;}
;this.__xO(M);}
,__xO:function(O){var P=this.getSelection();if(O.length>0){var R=[0,P.getLength()];R=R.concat(O);var Q=P.splice.apply(P,R);Q.dispose();}
else {P.removeAll();}
;}
,__xP:function(){var T=this.getSelection();var V=this._manager.getSelection();if(T.getLength()!==V.length){return false;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__xm){this.__xm.dispose();}
;}
});}
)();
...
;this._fireChange();}
,_setLeadItem:function(bl){var bm=this.__rU;if(bm!==null){this._styleSelectable(bm,I,false);}
;if(bl!==null){this._styleSelectable(bl,I,true);}
;this.__rU=bl;}
,getLeadItem:function(){return this.__rU!==null?this.__rU:null;}
,_setAnchorItem:function(bn){var bo=this.__rV;if(bo!=null){this._styleSelectable(bo,w,false);}
...
;this._fireChange();}
,handleMouseOver:function(event){if(this.__rX!=null&&this.__rX!=this._getScroll().top){this.__rX=null;return;}
...
;var bO=event.isCtrlPressed()||(qx.core.Environment.get(y)==A&&event.isMetaPressed());var bL=event.isShiftPressed();if(this.isItemSelected(bM)&&!bL&&!bO&&!this.getDrag()){this.__rW=bM;this._userInteraction=false;return;}
else {this.__rW=null;}
...
;break;};var bP=this.getMode();if(this.getDrag()&&bP!==E&&bP!==D&&!bL&&!bO){this.__rK=this._getLocation();this.__rH=this._getScroll();this.__rL=event.getDocumentLeft()+this.__rH.left;this.__rM=event.getDocumentTop()+this.__rH.top;this.__rN=true;this._capture();}
;this._fireChange(p);this._userInteraction=false;}
,handleMouseUp:function(event){this._userInteraction=true;var bT=event.isCtrlPressed()||(qx.core.Environment.get(y)==A&&event.isMetaPressed());var bQ=event.isShiftPressed();if(!bT&&!bQ&&this.__rW!=null){var bR=this._getSelectableFromMouseEvent(event);if(bR===null||!this.isItemSelected(bR)){this._userInteraction=false;return;}
...
,handleMouseMove:function(event){if(!this.__rN){return;}
;this.__rO=event.getDocumentLeft();this.__rP=event.getDocumentTop();this._userInteraction=true;var bV=this.__rO+this.__rH.left;if(bV>this.__rL){this.__rQ=1;}
else if(bV<this.__rL){this.__rQ=-1;}
else {this.__rQ=0;}
;var bU=this.__rP+this.__rH.top;if(bU>this.__rM){this.__rR=1;}
else if(bU<this.__rM){this.__rR=-1;}
else {this.__rR=0;}
...
;if(!this.__rG){this.__rG=new qx.event.Timer(100);this.__rG.addListener(j,this._onInterval,this);}
...
;if(this.__rS){this._fireChange(p);}
...
,_autoSelect:function(){var cg=this._getDimension();var bY=Math.max(0,Math.min(this.__rO-this.__rK.left,cg.width))+this.__rH.left;var bX=Math.max(0,Math.min(this.__rP-this.__rK.top,cg.height))+this.__rH.top;if(this.__rI===bY&&this.__rJ===bX){return;}
;this.__rI=bY;this.__rJ=bX;var ci=this._getAnchorItem();var cb=ci;var ce=this.__rQ;var ch,ca;while(ce!==0){ch=ce>0?this._getRelatedSelectable(cb,s):this._getRelatedSelectable(cb,x);if(ch!==null){ca=this._getSelectableLocationX(ch);if((ce>0&&ca.left<=bY)||(ce<0&&ca.right>=bY)){cb=ch;continue;}
;}
;break;}
;var cf=this.__rR;var cd,cc;while(cf!==0){cd=cf>0?this._getRelatedSelectable(cb,L):this._getRelatedSelectable(cb,q);if(cd!==null){cc=this._getSelectableLocationY(cd);if((cf>0&&cc.top<=bX)||(cf<0&&cc.bottom>=bX)){cb=cd;continue;}
;}
;break;}
...
;cn=true;}
;}
else if(this.__rY[cr]){cn=true;if(cq===E||cq==D){cp=this._getSelectedItem();}
...
;}
;break;};this.__rX=this._getScroll().top;this._scrollItemIntoView(co);}
;}
...
;this.__fR={};}
,_selectItemRange:function(cw,cx,cy){var cB=this._getSelectableRange(cw,cx);if(!cy){var cA=this.__fR;var cC=this.__sa(cB);for(var cz in cA){if(!cC[cz]){this._removeFromSelection(cA[cz]);}
;}
;}
...
;}
,__sa:function(cG){var cI={};var cH;for(var i=0,l=cG.length;i<l;i++ ){cH=cG[i];cI[this._selectableToHashCode(cH)]=cH;}
;return cI;}
...
;}
;}
,_addToSelection:function(cN){var cO=this._selectableToHashCode(cN);if(this.__fR[cO]==null&&this._isSelectable(cN)){this.__fR[cO]=cN;this._styleSelectable(cN,C,true);this.__rS=true;}
;}
...
;this.__rS=true;}
,_removeFromSelection:function(cR){var cS=this._selectableToHashCode(cR);if(this.__fR[cS]!=null){delete this.__fR[cS];this._styleSelectable(cR,C,false);this.__rS=true;}
;}
...
;if(!cW){return false;}
;this._scrollItemIntoView(cV);this._setLeadItem(db);this._setAnchorItem(db);this.__rS=true;this._fireChange();}
,_fireChange:function(dc){if(this.__rS){this.__rT=dc||null;this.fireDataEvent(h,this.getSelection());delete this.__rS;}
;}
...
;return de;}
;return null;}
},destruct:function(){this._disposeObjects(c);this.__fR=this.__rW=this.__rV=null;this.__rU=null;}
});}
)();
...
,getLookupTable:function(){return this.__xR;}
,_reverseLookup:function(bf){return bf;}
,_getDataFromRow:function(bg){return this.__xR.getItem(bg);}
,_getSelectables:function(){return this.__xR;}
,getOpenNodes:function(){return this.__yN;}
,isNode:function(bh){return qx.Class.hasProperty(bh.constructor,this.getChildProperty());}
,getLevel:function(bi){return this.__yO[bi];}
...
,_applyModel:function(bH,bI){this.__yN=[];if(bH!=null){if(qx.core.Environment.get(N)){if(!qx.Class.hasMixin(bH.constructor,qx.data.marshal.MEventBubbling)){this.warn("The model item doesn't support the Mixin 'qx.data."+"marshal.MEventBubbling'. Therefore the tree can not update "+"the view automatically on model changes.");}
;}
;bH.addListener(G,this._onChangeBubble,this);this.__yT(bH);}
...
;if(qx.lang.String.startsWith(bM,this.getChildProperty())){this.__yR();}
;}
,_onUpdated:function(event){if(this.__gv==null){this.__gv=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__gv.schedule();}
,_onOpen:function(event){var bO=event.getRow();var bN=this.__xR.getItem(bO);if(this.isNode(bN)){if(this.isNodeOpen(bN)){this.closeNode(bN);}
...
;break;};}
;}
,_beforeApplySelection:function(bT){if(bT.length===0&&this.getSelectionMode()===y){var bU=this.__yW();var bV=this.getLookupTable().indexOf(bU);if(bV>=0){bT.push(bV);}
;}
;}
,_afterApplySelection:function(){var bW=this.getSelection();if(bW.getLength()>0&&this.getSelectionMode()===y){this.__yV(bW.getItem(0));}
else {this.__yQ=[];}
;}
,__yR:function(){this.buildLookupTable();this._applyDefaultSelection();}
...
;this.__yP=0;var cb=[];this.__yO=[];var bY=-1;var ca=this.getModel();if(ca!=null){if(!this.isHideRoot()){bY++ ;cb.push(ca);this.__yO.push(bY);}
;if(this.isNodeOpen(ca)){var bX=this.__yS(ca,bY);cb=cb.concat(bX);}
;}
;this._provider.removeBindings();this.__xR.removeAll();this.__xR.append(cb);this.__xX();this._updateSelection();}
,__yS:function(cc,cd){var ch=[];cd++ ;if(!this.isNode(cc)){return ch;}
...
;if(this.isNode(cj)){this.__yO.push(cd);ch.push(cj);if(this.isNodeOpen(cj)){var ce=this.__yS(cj,cd);ch=ch.concat(ce);}
;}
else {if(this.isShowLeafs()){this.__yO.push(cd);ch.push(cj);}
;}
;}
;ck.dispose();return ch;}
,__yT:function(cl){if(!qx.lang.Array.contains(this.__yN,cl)){this.__yN.push(cl);this.fireDataEvent(P,cl);}
;}
,__yU:function(cm,cn){if(cm===cn){this.__yT(cn);return true;}
;if(!this.isNode(cm)){return false;}
;var cp=cm.get(this.getChildProperty());if(cp==null){return false;}
;for(var i=0;i<cp.getLength();i++ ){var cq=cp.getItem(i);var co=this.__yU(cq,cn);if(co===true){this.__yT(cq);return true;}
;}
;return false;}
,__xX:function(){this.getPane().getRowConfig().setItemCount(this.__xR.getLength());this.getPane().fullUpdate();}
,getParent:function(cr){var ct=this.__xR.indexOf(cr);if(ct<0){return null;}
;var cu=this.__yO[ct];while(ct>0){ct-- ;var cs=this.__yO[ct];if(cs<cu){return this.__xR.getItem(ct);}
;}
;return null;}
,__yV:function(cv){this.__yQ=[];var parent=this.getParent(cv);while(parent!=null){this.__yQ.unshift(parent);parent=this.getParent(parent);}
;}
,__yW:function(){if(this.__yQ==null){return this.getModel();}
;var cw=this.getLookupTable();var parent=this.__yQ.pop();while(parent!=null){if(cw.contains(parent)){return parent;}
;parent=this.__yQ.pop();}
...
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__gv!=null){this.__gv.cancel();this.__gv.dispose();}
;var cx=this.getModel();if(cx!=null){cx.removeListener(G,this._onChangeBubble,this);}
;this._layer.removeListener(A,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__xR.dispose();this._layer=this._provider=this.__xR=this.__yN=this.__gv=null;}
});}
)();
...
(function(){var q="model",p="changeDelegate",o="virtual-tree-file",n="label",m="appearance",l="icon",k="bindItem",j=".length",i="]",h="virtual-tree-folder",c="[",g=".",f="qx.ui.tree.core.MWidgetController",b="BindingIds",a="",d="String";qx.Mixin.define(f,{construct:function(){this.__xd=[];}
,properties:{labelPath:{check:d,nullable:true},iconPath:{check:d,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:d,nullable:true},delegate:{event:p,init:null,nullable:true}},members:{__xd:null,bindDefaultProperties:function(r,s){this.bindProperty(a,q,null,r,s);this.bindProperty(this.getLabelPath(),n,this.getLabelOptions(),r,s);try{this.bindProperty(this.getChildProperty()+j,m,{converter:function(){return h;}
},r,s);}
catch(t){r.setAppearance(o);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),l,this.getIconOptions(),r,s);}
;}
,bindProperty:function(u,v,w,x,y){var z=this.__xe(y,u);var A=this._tree.getLookupTable();var B=A.bind(z,x,v,w);this.__xf(x,B);}
,bindPropertyReverse:function(C,D,E,F,G){var H=this.__xe(G,C);var I=this._tree.getLookupTable();var J=F.bind(D,I,H,E);this.__xf(F,J);}
,removeBindings:function(){while(this.__xd.length>0){var K=this.__xd.pop();this._removeBindingsFrom(K);}
;}
...
;}
,_removeBindingsFrom:function(O){var P=this.__xg(O);while(P.length>0){var Q=P.pop();try{this._tree.getLookupTable().removeBinding(Q);}
catch(e){O.removeBinding(Q);}
;}
;if(qx.lang.Array.contains(this.__xd,O)){qx.lang.Array.remove(this.__xd,O);}
;}
,__xe:function(R,S){var T=c+R+i;if(S!=null&&S!=a){T+=g+S;}
;return T;}
,__xf:function(U,V){var W=this.__xg(U);if(!qx.lang.Array.contains(W,V)){W.push(V);}
;if(!qx.lang.Array.contains(this.__xd,U)){this.__xd.push(U);}
;}
,__xg:function(X){var Y=X.getUserData(b);if(Y==null){Y=[];X.setUserData(b,Y);}
;return Y;}
...
;var q=this._renderer.getCellWidget();q.setOpen(r&&this._tree.isNodeOpen(p));q.setUserData(g,r);q.addListener(b,this.__yX,this);if(this._tree.getSelection().contains(p)){this._styleSelectabled(q);}
...
,poolCellWidget:function(t){t.removeListener(b,this.__yX,this);this._removeBindingsFrom(t);this._renderer.pool(t);this._onPool(t);}
...
,__yX:function(event){var J=event.getTarget();var K=J.getUserData(c);var I=this._tree.getLookupTable().getItem(K);if(event.getData()){this._tree.openNode(I);}
else {this._tree.closeNode(I);}
;}
},destruct:function(){this.removeBindings();this._renderer.dispose();this._tree=this._renderer=null;}
});}
)();
(function(){var b="qx.ui.virtual.layer.Abstract",a="abstract";qx.Class.define(b,{extend:qx.ui.core.Widget,type:a,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__iV={};}
,properties:{anonymous:{refine:true,init:true}},members:{__iV:null,__cy:null,__tT:null,__tU:null,__tV:null,__sp:null,getFirstRow:function(){return this.__tT;}
,getFirstColumn:function(){return this.__tU;}
,getRowSizes:function(){return this.__tV||[];}
,getColumnSizes:function(){return this.__sp||[];}
,syncWidget:function(c){if(!this.getContentElement().getDomElement()){return;}
;if(this.__iV.fullUpdate||this.__iV.updateLayerWindow&&this.__iV.updateLayerData){this._fullUpdate.apply(this,this.__cy);}
else if(this.__iV.updateLayerWindow){this._updateLayerWindow.apply(this,this.__cy);}
else if(this.__iV.updateLayerData&&this.__tV){this._updateLayerData();}
;if(this.__iV.fullUpdate||this.__iV.updateLayerWindow){var d=this.__cy;this.__tT=d[0];this.__tU=d[1];this.__tV=d[2];this.__sp=d[3];}
;this.__iV={};}
,_updateLayerData:function(){this._fullUpdate(this.__tT,this.__tU,this.__tV,this.__sp);}
...
,updateLayerData:function(){this.__iV.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(m,n,o,p){this.__cy=arguments;this.__iV.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(q,r,s,t){this.__cy=arguments;this.__iV.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__iV=this.__cy=this.__tV=this.__sp=null;}
});}
)();
...
;this._cellProvider=h;this.__xj=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:g},members:{__xj:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;var q=this.getRowSizes().length;var p=this.getFirstRow();var o=this.getFirstColumn();if(j<p||j>=p+q||k<o||k>=o+l){return null;}
;var n=(k-o)+(j-p)*l;var m=this._getChildren()[n];if(m.getUserData(a)){return null;}
else {return m;}
;}
,_getSpacer:function(){var r=this.__xj.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(a,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(v,w,z,A){var C=this._cellProvider;var G=this._getChildren();for(var i=0;i<G.length;i++ ){var E=G[i];if(E.getUserData(a)){this.__xj.push(E);}
...
;}
;}
;var U=this._cellProvider;var Y=this._getChildren();for(var i=0;i<Y.length;i++ ){if(!S[i]){var W=Y[i];if(W.getUserData(a)){this.__xj.push(W);}
...
,addSpacer:function(){if(!this.__zb){this.__zb=new qx.ui.core.Spacer();}
else {this._remove(this.__zb);}
;this._add(this.__zb);}
,addOpenButton:function(){this._add(this.getChildControl(m));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var K=this.getChildControl(t);if(this.__za){this._remove(K);}
;this._add(K);this.__za=true;}
,addLabel:function(L){var M=this.getChildControl(l);if(this.__yY){this._remove(M);}
;if(L){this.setLabel(L);}
else {M.setValue(this.getLabel());}
;this._add(M);this.__yY=true;}
,_applyIcon:function(N,O){if(!this.__zd()){this.__ze(N);}
else if(!this.isOpen()){this.__ze(N);}
;}
,_applyIconOpened:function(P,Q){if(this.isOpen()){if(this.__zc()&&this.__zd()){this.__ze(P);}
else if(!this.__zc()&&this.__zd()){this.__ze(P);}
;}
;}
...
;var W;if(U){W=this.__zd()?this.getIconOpened():null;}
else {W=this.getIcon();}
;if(W){this.__ze(W);}
;U?this.addState(s):this.removeState(s);}
,__zc:function(){return qx.util.PropertyUtil.getUserValue(this,t);}
,__zd:function(){return qx.util.PropertyUtil.getUserValue(this,B);}
,__ze:function(X){var Y=this.getChildControl(t,true);if(Y){Y.setSource(X);}
;}
...
;}
;if(this.__zb){this.__zb.setWidth((this.getLevel()+1)*this.getIndent()-be);}
;}
...
(function(){var d="created",c="qx.ui.virtual.cell.AbstractWidget",b="qx.event.type.Data",a="cell.states";qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){qx.core.Object.call(this);this.__cR=[];}
,events:{"created":b},members:{__cR:null,_createWidget:function(){throw new Error("abstract method call");}
,updateData:function(e,f){throw new Error("abstract method call");}
,updateStates:function(g,h){var k=g.getUserData(a);if(k){var i=h||{};for(var j in k){if(!i[j]){g.removeState(j);}
;}
;}
else {k={};}
...
;}
;g.setUserData(a,h);}
,getCellWidget:function(l,m){var n=this.__xk();this.updateStates(n,m);this.updateData(n,l);return n;}
,pool:function(o){this.__cR.push(o);}
,_cleanupPool:function(){var p=this.__cR.pop();while(p){p.destroy();p=this.__cR.pop();}
;}
,__xk:function(){var q=this.__cR.pop();if(q==null){q=this._createWidget();this.fireDataEvent(d,q);}
;return q;}
},destruct:function(){this._cleanupPool();this.__cR=null;}
});}
)();
...
(function(){var n='"',m="qx.debug.databinding",l="change",k="qx.data.marshal.Json",j="set",h="' is not a valid JavaScript identifier.",g="_applyEventPropagation",f="The key '",e="",d="Array",a="_validate",c="qx.debug",b="qx.data.model.";qx.Class.define(k,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(o){qx.core.Object.call(this);this.__yq=o;}
...
},members:{__yq:null,__yr:function(r){return Object.keys(r).sort().join(n);}
,toClass:function(s,t){this.__ys(s,t,null,0);}
,__ys:function(u,v,w,x){if(!qx.lang.Type.isObject(u)||!!u.$$isString||u instanceof qx.core.Object){if(u instanceof Array||qx.Bootstrap.getClass(u)==d){for(var i=0;i<u.length;i++ ){this.__ys(u[i],v,null,x+1);}
;}
;return;}
;var z=this.__yr(u);if(this.__yw(z,w,x)){return;}
;for(var A in u){this.__ys(u[A],v,A,x+1);}
;if(qx.Class.isDefined(b+z)){return;}
;if(this.__yq&&this.__yq.getModelClass&&this.__yq.getModelClass(z)!=null){return;}
;var G={};var F={__yt:this.__yt};for(var A in u){if(this.__yq&&this.__yq.getPropertyMapping){A=this.__yq.getPropertyMapping(A,z);}
...
;if(this.__yq&&this.__yq.getValidationRule){var C=this.__yq.getValidationRule(z,A);if(C){G[A].validate=a+A;F[a+A]=C;}
;}
;}
;if(this.__yq&&this.__yq.getModelSuperClass){var E=this.__yq.getModelSuperClass(z)||qx.core.Object;}
else {var E=qx.core.Object;}
;var B=[];if(this.__yq&&this.__yq.getModelMixins){var D=this.__yq.getModelMixins(z);if(!qx.lang.Type.isArray(D)){if(D!=null){B=[D];}
;}
else {B=D;}
;}
;if(v){B.push(qx.data.marshal.MEventBubbling);}
;var y={extend:E,include:B,properties:G,members:F,destruct:this.__yu};qx.Class.define(b+z,y);}
,__yu:function(){var H=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var I in H){this.__yt(this.get(H[I].name));}
;}
,__yt:function(J){if(!(J instanceof qx.core.Object)){return;}
;if(J.isDisposed()){return;}
;J.dispose();}
,__yv:function(K){var L;if(this.__yq&&this.__yq.getModelClass){L=this.__yq.getModelClass(K);}
;if(L!=null){return (new L());}
else {var M=qx.Class.getByName(b+K);return (new M());}
;}
,__yw:function(N,O,P){var Q=this.__yq;return Q&&Q.ignore&&Q.ignore(N,O,P);}
,toModel:function(R){return this.__yx(R,null,0);}
,__yx:function(S,T,U){var ba=qx.lang.Type.isObject(S);var V=S instanceof Array||qx.Bootstrap.getClass(S)==d;if((!ba&&!V)||!!S.$$isString||S instanceof qx.core.Object){return S;}
else if(this.__yw(this.__yr(S),T,U)){return S;}
else if(V){var bc=new qx.data.Array();bc.setAutoDisposeItems(true);for(var i=0;i<S.length;i++ ){bc.push(this.__yx(S[i],null,U+1));}
;return bc;}
else if(ba){var W=this.__yr(S);var bd=this.__yv(W);for(var bb in S){var X=bb;if(this.__yq&&this.__yq.getPropertyMapping){X=this.__yq.getPropertyMapping(bb,W);}
...
;}
;X=be;var Y=j+qx.lang.String.firstUp(X);if(bd[Y]){bd[Y](this.__yx(S[bb],bb,U+1));}
;}
;return bd;}
;throw new Error("Unsupported type!");}
},destruct:function(){this.__yq=null;}
});}
)();
(function(){var p="source",o="changeLeadIcon",n="changeSize",m="changeMode",l="changeDate",k="changeChecked",j="icon/16/places/user-desktop.png",i="size",h="leadIcon",g="date",c="mode",f="demobrowser.demo.virtual.tree.TreeItem",e="Boolean",b="checked",a="String",d="value";qx.Class.define(f,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:a,event:o,nullable:true},checked:{check:e,event:k,nullable:true},size:{check:a,event:n,nullable:true},date:{check:a,event:l,nullable:true},mode:{check:a,event:m,nullable:true}},members:{__Sr:null,__Ss:null,__St:null,__Su:null,__hE:null,_addWidgets:function(){var q=this.__Sr=new qx.ui.basic.Image();this.bind(h,q,p);q.setWidth(16);this.addWidget(q);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(j);var r=this.__Ss=new qx.ui.form.CheckBox();this.bind(b,r,d);r.bind(d,this,b);r.setFocusable(false);r.setTriState(true);r.setMarginRight(4);this.addWidget(r);this.addLabel();this.addWidget(new qx.ui.core.Spacer(),{flex:1});var s=this.__St=new qx.ui.basic.Label();this.bind(i,s,d);s.setWidth(50);this.addWidget(s);s=this.__Su=new qx.ui.basic.Label();this.bind(g,s,d);s.setWidth(150);this.addWidget(s);s=this.__hE=new qx.ui.basic.Label();this.bind(c,s,d);s.setWidth(80);this.addWidget(s);}
}});}
)();
