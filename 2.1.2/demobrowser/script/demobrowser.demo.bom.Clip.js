...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Clip.8ddfde92ae16.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var b="demobrowser.demo.bom.Clip",a="test1";qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);window.APPLICATION=this;var c=document.getElementById(a);var d=qx.bom.element.Clip.get(c)||{};qx.log.Logger.debug("Clip init: "+d.left+","+d.top+"  "+d.width+","+d.height);}
,set0:function(){var e=document.getElementById(a);qx.log.Logger.debug("Setting to: 20,20  120,40");qx.bom.element.Clip.set(e,{left:20,top:20,width:120,height:40});var f=qx.bom.element.Clip.get(e)||{};qx.log.Logger.debug("Clip after: "+f.left+","+f.top+"  "+f.width+","+f.height);}
,set1:function(){var g=document.getElementById(a);qx.log.Logger.debug("Setting to: 20,20  null,40");qx.bom.element.Clip.set(g,{left:20,top:20,height:40});var h=qx.bom.element.Clip.get(g)||{};qx.log.Logger.debug("Clip after: "+h.left+","+h.top+"  "+h.width+","+h.height);}
,set2:function(){var i=document.getElementById(a);qx.log.Logger.debug("Setting to: 20,20  120,null");qx.bom.element.Clip.set(i,{left:20,top:20,width:120});var j=qx.bom.element.Clip.get(i)||{};qx.log.Logger.debug("Clip after: "+j.left+","+j.top+"  "+j.width+","+j.height);}
,set3:function(){var k=document.getElementById(a);qx.log.Logger.debug("Setting to: null,20  120,40");qx.bom.element.Clip.set(k,{top:20,width:120,height:40});var l=qx.bom.element.Clip.get(k)||{};qx.log.Logger.debug("Clip after: "+l.left+","+l.top+"  "+l.width+","+l.height);}
,set4:function(){var m=document.getElementById(a);qx.log.Logger.debug("Setting to: 20,null  120,40");qx.bom.element.Clip.set(m,{left:20,width:120,height:40});var n=qx.bom.element.Clip.get(m)||{};qx.log.Logger.debug("Clip after: "+n.left+","+n.top+"  "+n.width+","+n.height);}
,reset:function(){var o=document.getElementById(a);qx.log.Logger.debug("Resetting");qx.bom.element.Clip.reset(o);var p=qx.bom.element.Clip.get(o)||{};qx.log.Logger.debug("Clip after: "+p.left+","+p.top+"  "+p.width+","+p.height);}
}});}
)();
