...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveLoader","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveLoader.7ed24fff4974.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="maxWidth",c="qx.ui.progressive.renderer.table.Widths",b="minWidth",a="width";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__If=[];for(var i=0;i<e;i++ ){this.__If[i]=new qx.ui.core.ColumnData();}
;}
,members:{__If:null,getData:function(){return this.__If;}
...
;}
,setWidth:function(j,k){if(j>this.__If.length-1||j<0){throw new Error("Column number out of range");}
;this.__If[j].setColumnWidth(k);}
,setMinWidth:function(l,m){if(l>this.__If.length-1||l<0){throw new Error("Column number out of range");}
;this.__If[l].setMinWidth(m);}
,setMaxWidth:function(n,o){if(n>this.__If.length-1||n<0){throw new Error("Column number out of range");}
;this.__If[n].setMaxWidth(o);}
}});}
)();
...
,members:{__uq:null,renderLayout:function(f,top,g,h){this.__uq=g;}
,getComputedWidth:function(){return this.__uq;}
...
,members:{__Ao:null,join:function(c){this.__Ao=c;}
...
(function(){var n="progressive-progressbar-indicator-undone",m="progress",l="%",k="progressive-progressbar-indicator-done",j="progressive-progressbar-percent-text",i="renderStart",h="progressive-progressbar-background",g="__Hn",f="0%",d="qx.ui.progressive.headfoot.Progress",a="__Hm",c="progressive-progressbar-percent-background",b="renderEnd";qx.Class.define(d,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,p){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__Ap={};this.__At();this.set({backgroundColor:this.__Ap.background});this.__Hm=new qx.ui.core.Widget();this.__Hm.set({width:0,backgroundColor:this.__Ap.indicatorDone});this.add(this.__Hm);var q=new qx.ui.core.Widget();q.set({backgroundColor:this.__Ap.indicatorUndone});this.add(q,{flex:1});this.__Hn=new qx.ui.basic.Atom(f);this.__Hn.set({width:100,backgroundColor:this.__Ap.percentBackground,textColor:this.__Ap.percentText});this.add(this.__Hn);this.exclude();}
,members:{__Ho:null,__Ap:null,__Hm:null,__Hn:null,_onChangeTheme:function(){qx.ui.progressive.headfoot.Abstract.prototype._onChangeTheme.call(this);this.__At();}
,__At:function(){var r=qx.theme.manager.Color.getInstance();this.__Ap.background=r.resolve(h);this.__Ap.indicatorDone=r.resolve(k);this.__Ap.indicatorUndone=r.resolve(n);this.__Ap.percentBackground=r.resolve(c);this.__Ap.percentText=r.resolve(j);}
,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(i,function(e){this.__Ho=e.getData().initial;this.show();}
,this);s.addListener(m,function(e){var v=1.0-(e.getData().remaining/this.__Ho);var w=this.getBounds();if(w){var t=Math.floor((w.width-this.__Hn.getBounds().width)*v);var u=Math.floor(v*100)+l;if(!isNaN(t)){this.__Hm.setMinWidth(t);this.__Hn.setLabel(u);}
;}
;}
,this);s.addListener(b,function(e){this.exclude();}
,this);}
},destruct:function(){this.__Ap=null;this._disposeObjects(a,g);}
});}
)();
(function(){var d="abstract",c="qx.ui.progressive.structure.Abstract",b="overflowY",a="auto";qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);if(!e){this.__Fi=new qx.ui.core.Widget();this.__xw=this.__Fi;}
else {this.__Fi=null;this.__xw=e;}
;this.__xw.getContentElement().setStyle(b,a);}
,members:{__Fi:null,__xw:null,applyStructure:function(f){throw new Error("applyStructure() is abstract");}
,getPane:function(){return this.__xw;}
},destruct:function(){if(this.__Fi){this.__Fi.dispose();}
;this.__Fi=this.__xw=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,c,d){qx.ui.progressive.structure.Abstract.call(this,d);if(!b){this.__Fj=new qx.ui.progressive.headfoot.Null();this.__mb=this.__Fj;}
else {this.__Fj=null;this.__mb=b;}
;if(!c){this.__Fk=new qx.ui.progressive.headfoot.Null();this.__Fl=this.__Fk;}
else {this.__Fk=null;this.__Fl=c;}
;}
,members:{__mb:null,__Fl:null,__Fj:null,__Fk:null,applyStructure:function(e){this.__mb.join(e);this.__Fl.join(e);e.add(this.__mb);e.add(this.getPane(),{flex:1});e.add(this.__Fl);}
,getHeader:function(){return this.__mb;}
,getFooter:function(){return this.__Fl;}
},destruct:function(){if(this.__Fj){this.__Fj.dispose();this.__Fj=null;}
;if(this.__Fk){this.__Fk.dispose();this.__Fk=null;}
;this.__mb=this.__Fl=null;}
});}
)();
...
(function(){var k="_applyDataModel",j="Boolean",h="qx.ui.progressive.model.Abstract",g="white",f="qx.ui.progressive.Progressive",d="dataAvailable",c="renderStart",b="Integer",a="qx.event.type.Data";qx.Class.define(f,{extend:qx.ui.container.Composite,construct:function(l){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__Gx={};this.set({backgroundColor:g});if(!l){l=new qx.ui.progressive.structure.Default();}
;this.__Gy=l;l.applyStructure(this);this.__Gz=false;this.__GA=false;this.__GB=0;}
,events:{"renderStart":a,"renderEnd":a,"progress":a,"progressDetail":a},properties:{dataModel:{check:h,apply:k},batchSize:{check:b,init:20},flushWidgetQueueAfterBatch:{check:j,init:false},interElementTimeout:{check:b,init:0}},members:{__Gx:null,__GA:null,__GC:null,__GB:null,__Gz:null,__Gy:null,getStructure:function(){return this.__Gy;}
,addRenderer:function(name,m){this.__Gx[name]=m;m.join(this,name);}
,removeRenderer:function(name){if(!this.__Gx[name]){throw new Error("No existing renderer named "+name);}
;delete this.__Gx[name];}
,render:function(){if(this.__GA){return;}
;this.__GA=true;var n=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__Gy.getPane(),batchSize:this.getBatchSize(),rendererData:this.__GE(),userData:{}});this.__GC=new Date();if(this.__Gz){this.__GB=n.getModel().getElementCount();this.fireDataEvent(c,{state:n,initial:this.__GB});this.__GD(n);}
else {qx.event.Timer.once(function(){this.__GB=n.getModel().getElementCount();this.fireDataEvent(c,{state:n,initial:this.__GB});this.__GD(n);this.__Gz=true;}
,this,10);}
;}
,_applyDataModel:function(o,p){if(p){p.removeListener(d,this.__GF,this);p.dispose();}
;o.addListener(d,this.__GF,this);}
,__GD:function(q){var r;var t;var s;for(var i=q.getBatchSize();i>0;i-- ){r=q.getModel().getNextElement();if(!r){this.debug("Render time: "+(new Date()-this.__GC)+"ms");this.__GA=false;this.fireDataEvent("renderEnd",q);q.dispose();return;}
;t=r.element;s=this.__Gx[t.renderer];s.render(q,t);this.fireDataEvent("progressDetail",{initial:this.__GB,remaining:r.remaining,element:t});}
;this.fireDataEvent("progress",{initial:this.__GB,remaining:r.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__GD(q);}
,this,this.getInterElementTimeout());}
,__GE:function(){var u={};for(var name in this.__Gx){u[name]={};}
;return u;}
,__GF:function(e){this.__GB=e.getData();this.render();}
},destruct:function(){for(var name in this.__Gx){this.__Gx[name].dispose();}
;this.__GC=this.__Gx=this.__Gy=null;}
});}
)();
...
(function(){var b="qx.ui.progressive.model.Default",a="dataAvailable";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__of=[];}
,members:{__of:null,addElements:function(c){this.__of=this.__of.concat(c);this.fireDataEvent(a,this.__of.length);}
,addElement:function(d){this.__of.push(d);this.fireDataEvent(a,this.__of.length);}
,getElementCount:function(){return this.__of.length;}
,getNextElement:function(){if(this.__of.length>0){return ({element:this.__of.shift(),remaining:this.__of.length});}
;return null;}
