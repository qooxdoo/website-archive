...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Dialog.519671d32679.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="Last Name",j="Notes",h="male",g="First Name",f="default",e="Cancel",d="Sex",c="Reading",b="Smith",a="Swimming",y="City",x="demobrowser.demo.showcase.Dialog",w="Hobbies",v="icon/22/actions/dialog-apply.png",u="John",t="female",s="Page",r="icon/22/actions/dialog-cancel.png",q="Country",p="OK",n="USA",o="New York",l="top",m="right";qx.Class.define(x,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var H=new qx.ui.layout.Grid(9,5);H.setColumnAlign(0,m,l);H.setColumnAlign(2,m,l);H.setColumnWidth(1,160);H.setColumnWidth(2,72);H.setColumnWidth(3,108);var B=new qx.ui.tabview.TabView;var K=new qx.ui.tabview.Page(s);K.setLayout(H);K.setPadding(10);B.add(K);this.getRoot().add(B,{left:40,top:40});var E=[g,k,y,q,j];for(var i=0;i<E.length;i++ ){K.add(new qx.ui.basic.Label(E[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});}
;var z=[u,b,o,n];for(var i=0;i<z.length;i++ ){K.add(new qx.ui.form.TextField(z[i]),{row:i,column:1});}
;K.add(new qx.ui.form.TextArea().set({height:250}),{row:4,column:1,colSpan:3});K.add(new qx.ui.basic.Label(d).set({allowShrinkX:false,paddingTop:3}),{row:0,column:2});var G=new qx.ui.form.RadioButton(t);var J=new qx.ui.form.RadioButton(h);var F=new qx.ui.form.RadioGroup();F.add(G,J);K.add(G,{row:0,column:3});K.add(J,{row:1,column:3});J.setValue(true);K.add(new qx.ui.basic.Label(w).set({allowShrinkX:false,paddingTop:3}),{row:2,column:2});K.add(new qx.ui.form.CheckBox(c),{row:2,column:3});K.add(new qx.ui.form.CheckBox(a).set({enabled:false}),{row:3,column:3});var I=new qx.ui.layout.HBox().set({spacing:4,alignX:m});var A=new qx.ui.container.Composite(I).set({paddingTop:11});K.add(A,{row:5,column:0,colSpan:4});var C=new qx.ui.form.Button(p,v);C.addState(f);A.add(C);var D=new qx.ui.form.Button(e,r);A.add(D);}
}});}
)();
