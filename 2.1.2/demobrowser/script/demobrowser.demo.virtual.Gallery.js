...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery.a8f70021b818.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
}});qx.Class.define(g,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bv){demobrowser.demo.virtual.AbstractGallery.call(this,bv);this.__Sl=new demobrowser.demo.virtual.GalleryCell();}
,members:{__Sl:null,_createScroller:function(){var bw=new qx.ui.virtual.core.Scroller(1,this.itemPerLine,this.itemHeight,this.itemWidth);this.layer=new qx.ui.virtual.layer.WidgetCell(this);bw.getPane().addLayer(this.layer);new qx.ui.virtual.behavior.Prefetch(bw,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:200,maxAbove:300,minBelow:600,maxBelow:800}).set({interval:500});return bw;}
...
;if(bz){this.__Sl.updateStates(bB,{selected:1});}
else {this.__Sl.updateStates(bB,{});}
;}
;}
...
;var bH=this.__Sl.getCellWidget(bI,bG);bH.setUserData(x,bF);return bH;}
,poolCellWidget:function(bJ){this.__Sl.pool(bJ);}
},destruct:function(){this._disposeObjects(R,H);}
...
(function(){var l="_applyInterval",k="__ks",j="appear",i="qx.debug",h="interval",g="qx.ui.virtual.behavior.Prefetch",f="_applyScroller",e="qx.ui.virtual.core.Scroller",d="Integer",c="scroll",a="scrollbar-x",b="scrollbar-y";qx.Class.define(g,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(i)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__ks=new qx.event.Timer(this.getInterval());this.__ks.addListener(h,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:e,nullable:true,init:null,apply:f},interval:{check:d,init:200,apply:l}},members:{__Iw:null,__Ix:null,__ks:null,__Iy:null,__Iz:null,setPrefetchX:function(o,p,q,r){this.__Iw=[o,p,q,r];}
,setPrefetchY:function(s,t,u,v){this.__Ix=[s,t,u,v];}
,_onInterval:function(){var w=this.__Iw;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Ix;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(y,z){if(z){if(this.__Iy){z.getChildControl(a).removeListenerById(this.__Iy);}
;if(this.__Iz){z.getChildControl(b).removeListenerById(this.__Iz);}
;}
;if(y){if(!y.getContainerElement().getDomElement()){this.__ks.stop();y.addListenerOnce(j,this.__ks.start,this.__ks);}
else {this.__ks.restart();}
;this.__Iy=y.getChildControl(a).addListener(c,this.__ks.restart,this.__ks);this.__Iz=y.getChildControl(b).addListener(c,this.__ks.restart,this.__ks);}
else {this.__ks.stop();}
;}
,_applyInterval:function(A,B){this.__ks.setInterval(A);}
},destruct:function(){this.setScroller(null);this.__Iw=this.__Ix=null;this._disposeObjects(k);}
});}
)();
