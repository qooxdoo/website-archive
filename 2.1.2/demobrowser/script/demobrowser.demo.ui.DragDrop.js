...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop.b91fbfdd5a62.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="drag",k="TextArea Target",j="solid",h="Copy Even Items",g="Reorderable",f="qx.ui.form.ListItem",d="droprequest",c="#33508D",b="Source",a="demobrowser.demo.ui.DragDrop",C="Simple Target",B="Enable drag",A="dragchange",z="\n",y="dragend",x="__Kv",w="icon/16/places/folder.png",v="dragstart",u="Item ",t="move",r="multi",s="copy",p="value",q="dragover",n="drop",o="items";qx.Class.define(a,{extend:qx.application.Standalone,members:{__Kv:null,__Sd:null,main:function(){qx.application.Standalone.prototype.main.call(this);var Q=this.getRoot();var I=new qx.ui.container.Scroll();var D=new qx.ui.layout.Basic();var G=new qx.ui.container.Composite(D).set({allowStretchY:false,allowStretchX:false});I.add(G);Q.add(I,{edge:0});var P=new qx.ui.basic.Label(b);G.add(P,{left:20,top:20});var N=new qx.ui.form.List;N.setDraggable(true);N.setSelectionMode(r);G.add(N,{left:20,top:40});for(var i=0;i<20;i++ ){N.add(new qx.ui.form.ListItem(u+i,w));}
...
;}
);var J=new qx.ui.basic.Label(k);G.add(J,{left:380,top:20});var K=new qx.ui.form.TextArea;K.setDroppable(true);K.setHeight(100);G.add(K,{left:380,top:40});K.addListener(n,function(e){this.debug("Related of drop: "+e.getRelatedTarget());this.setValue(e.getData(p).replace(/,/g,z));}
);K.addListener(q,function(e){if(!e.supportsType(p)){e.preventDefault();}
;}
);var L=new qx.ui.basic.Label(g);G.add(L,{left:600,top:20});var E=this.__Kv=new qx.ui.form.List;E.setDraggable(true);E.setDroppable(true);E.setSelectionMode(r);G.add(E,{left:600,top:40});for(var i=0;i<20;i++ ){E.add(new qx.ui.form.ListItem(u+i,w));}
...
);E.addListener(m,function(e){var bb=e.getOriginalTarget();if(bb instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Sd=bb;}
...
;}
);E.addListener(n,function(e){this.__Se(e.getOriginalTarget());}
,this);F.addListener(n,function(e){this.__Se(this.__Sd);}
,this);}
,__Se:function(bc){if(bc.classname!=f){return;}
;var bd=this.__Kv.getSortedSelection();for(var i=0,l=bd.length;i<l;i++ ){this.__Kv.addBefore(bd[i],bc);this.__Kv.addToSelection(bd[i]);}
;}
