...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Spinner.86ba456465ae.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="Disabled",r="Not Editable",q="demobrowser.demo.widget.Spinner",p="Stepped",o="Wrap",n="-3000",m="30",l="300",k="3000",j="changeValue",c="-30",i="Simple",g="Number format",b="right",a="100",f="left",d="0",h="middle";qx.Class.define(q,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(t,u){var v=new qx.ui.form.Spinner();t.add(new qx.ui.basic.Label(i),{column:0,row:u});t.add(new qx.ui.basic.Label(d),{column:1,row:u});t.add(v,{column:2,row:u});t.add(new qx.ui.basic.Label(a),{column:3,row:u});v.addListener(j,function(e){this.debug("ChangeValue: "+e.getData());}
);}
,addNonEditableSpinner:function(w,x){var y=new qx.ui.form.Spinner(0,50,100);y.setEditable(false);w.add(new qx.ui.basic.Label(r),{column:0,row:x});w.add(new qx.ui.basic.Label(d),{column:1,row:x});w.add(y,{column:2,row:x});w.add(new qx.ui.basic.Label(a),{column:3,row:x});}
,addWrappingSpinner:function(z,A){var B=new qx.ui.form.Spinner(-30,30,30);B.setWrap(true);z.add(new qx.ui.basic.Label(o),{column:0,row:A});z.add(new qx.ui.basic.Label(c),{column:1,row:A});z.add(B,{column:2,row:A});z.add(new qx.ui.basic.Label(m),{column:3,row:A});}
,addSteppedSpinner:function(C,D){var E=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});C.add(new qx.ui.basic.Label(p),{column:0,row:D});C.add(new qx.ui.basic.Label(n),{column:1,row:D});C.add(E,{column:2,row:D});C.add(new qx.ui.basic.Label(k),{column:3,row:D});}
,addDisabledSpinner:function(F,G){var H=new qx.ui.form.Spinner;H.setEnabled(false);F.add(new qx.ui.basic.Label(s),{column:0,row:G});F.add(new qx.ui.basic.Label(d),{column:1,row:G});F.add(H,{column:2,row:G});F.add(new qx.ui.basic.Label(a),{column:3,row:G++ });}
,addFormattedSpinner:function(I,J){var K=new qx.ui.form.Spinner(0,200,300);K.setSingleStep(0.5);K.setWidth(70);var L=new qx.util.format.NumberFormat();L.setMinimumFractionDigits(2);L.setMaximumFractionDigits(2);K.setNumberFormat(L);I.add(new qx.ui.basic.Label(g),{column:0,row:J});I.add(new qx.ui.basic.Label(d),{column:1,row:J});I.add(K,{column:2,row:J});I.add(new qx.ui.basic.Label(l),{column:3,row:J++ });}
,main:function(){qx.application.Standalone.prototype.main.call(this);var N=new qx.ui.layout.Grid(10,8);N.setColumnAlign(0,f,h);N.setColumnAlign(1,b,h);N.setColumnAlign(2,f,h);N.setColumnAlign(3,f,h);var M=new qx.ui.container.Composite(N);M.setPadding(10);this.getRoot().add(M,{left:0,top:0});this.addSimpleSpinner(M,0);this.addNonEditableSpinner(M,1);this.addWrappingSpinner(M,2);this.addSteppedSpinner(M,3);this.addDisabledSpinner(M,4);this.addFormattedSpinner(M,5);}
}});}
)();
