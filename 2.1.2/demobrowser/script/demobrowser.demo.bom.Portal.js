...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.177998864476.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="groupBoxes",h="demobrowser.demo.bom.portal.box.Manager",g="boxData",f="qx.event.type.Event",e="boxes",d="demobrowser.demo.bom.portal.box.Box",c="_applyActiveBox",b="loaded",a="singleton";qx.Class.define(h,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Qk=[];this.__Ql=[];this.__Qm={};}
,statics:{dataKeyRoot:g,dataKeyGroupBoxes:m,dataKeyBoxes:e},events:{"loaded":f},properties:{activeBox:{init:null,check:d,apply:c}},members:{__Qk:null,__Ql:null,__Qm:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);}
;n.setActive(true);}
...
,__bf:function(p){var t,w,u,v,x,p;var q=p[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var s=p[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in q){t=q[w];u=t.boxes;w=t.id;v={id:w,element:document.getElementById(w)};this.__Ql.push(v);this.__Qm[w]=[];for(var k=0,l=u.length;k<l;k++ ){p=s[u[k]];var r=document.getElementById(p.id);var x=new demobrowser.demo.bom.portal.box.Box(p,r,null,w);this.__Qk.push(x);this.__Qm[w].push(x);}
;}
;}
,getBoxes:function(){return this.__Qk;}
,getGroupBoxes:function(){return this.__Ql;}
,updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());qx.lang.Array.remove(this.__Qm[z],A);qx.lang.Array.insertAt(this.__Qm[y],A,B);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__Ql.length,D;i<j;i++ ){D=this.__Qm[this.__Ql[i].id];for(var k=0,l=D.length;k<l;k++ ){if(D[k].getId()===C){return this.__Ql[i];}
;}
;}
;return null;}
},destruct:function(){this.__Qk=this.__Ql=this.__Qm=null;}
});}
)();
(function(){var s="click",r="1px solid #444444",q="height",p="position",o="zIndex",n="_applyActive",m="width",l="box_content",k=" It does contain no UI widget code at all.",j="relative",c="demobrowser.demo.bom.portal.box.Box",i="1px solid orange",g="This is a demo application showing the low-level capabilities.",b="div",a="String",f="<br/><br/>",d="border",h="Boolean";qx.Class.define(c,{extend:qx.core.Object,construct:function(t,u,v,w){qx.core.Object.call(this);this.__Qn=t;this.__bV=t.id;if(u!=null){qx.bom.element.Style.set(u,m,t.width);qx.bom.element.Style.set(u,q,t.height);this.__Qq(u,v);}
;this.setElement(u);this.setGroupBoxId(w);this.__Qo=null;this.__Qp=null;if(t.resizable){this.setResizable(true);var x={minWidth:parseInt(t.minWidth),minHeight:parseInt(t.minHeight),maxWidth:parseInt(t.maxWidth),maxHeight:parseInt(t.maxHeight),handles:t.resizeHandles};this.__Qo=new demobrowser.demo.bom.portal.box.Resizable(this,x);}
;if(t.draggable){this.setDraggable(true);this.__Qp=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__Qr();}
,properties:{element:{init:null},groupBoxId:{init:null,check:a},active:{check:h,init:false,apply:n},resizable:{check:h,init:false},draggable:{check:h,init:false}},members:{__bV:null,__Qn:null,__Qp:null,__Qo:null,_applyActive:function(y,z){if(y){qx.bom.element.Style.set(this.getElement(),d,i);}
else {qx.bom.element.Style.set(this.getElement(),d,r);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__Qn;}
,getDraggableComponent:function(){return this.__Qp;}
,getResizableComponent:function(){return this.__Qo;}
,__Qq:function(A,B){if(B){for(var C in B){qx.bom.element.Style.set(C,B[C]);}
;}
;qx.bom.element.Style.set(A,p,j);qx.bom.element.Style.set(A,o,0);qx.bom.Element.addListener(A,s,this.__Qs,this,true);}
,__Qr:function(){var E=g+k;E=E+f+E+f+E;var D=qx.dom.Element.create(b,{"class":l});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__Qs:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__Qn=this.__Qo=this.__Qp=null;}
});}
)();
...
(function(){var m="mouseup",l="mousedown",k="visibility",j="_",i="visible",h="hidden",g="div",f="orientation",d="demobrowser.demo.bom.portal.box.Resizable",c="Handle",a="mouseover",b="mouseout";qx.Class.define(d,{extend:qx.core.Object,construct:function(n,o){qx.core.Object.call(this);this.__Qt=n;this.__fX=this.__Qt.getElement();this.__Qu={};this.__Qv=false;this.__Qw={orientation:null,lastCoord:{left:null,top:null}};this.__Qx={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__Qx){if(o[name]){this.__Qx[name]=o[name];}
;}
;this.__Qq();}
,members:{__Qw:null,__Qt:null,__fX:null,__Qu:null,__Qx:null,__Qv:false,getBox:function(){return this.__Qt;}
,__Qq:function(){switch(this.__Qx.handles){case 1:this.__Qu.east=null;break;case 2:this.__Qu.south=null;break;case 3:this.__Qu.south=null;this.__Qu.southeast=null;this.__Qu.east=null;break;};for(var q in this.__Qu){var p=this.__Qu[q]=qx.dom.Element.create(g);qx.bom.element.Attribute.set(p,f,q);qx.dom.Element.insertEnd(p,this.__fX);if(this.__fX.id){p.id=this.__fX.id+j+q;}
;this.__Qy(q);this.__Qz(q);}
;}
,__Qy:function(r){qx.bom.element.Class.add(this.__Qu[r],r+c);qx.bom.element.Style.set(this.__Qu[r],k,this.__Qx.autoHide?h:i);}
,__Qz:function(s){var u=qx.event.Registration;var t=this.__Qu[s];u.addListener(t,l,this.__QC,this);u.addListener(document,m,this.__QD,this);if(this.__Qx.autoHide){u.addListener(this.__Qt.getElement(),a,this.__QA,this);u.addListener(this.__Qt.getElement(),b,this.__QB,this);}
;}
,__QA:function(e){for(var v in this.__Qu){qx.bom.element.Style.set(this.__Qu[v],"visibility","visible");}
;}
,__QB:function(e){if(!this.__Qv){for(var w in this.__Qu){qx.bom.element.Style.set(this.__Qu[w],"visibility","hidden");}
;}
;}
,__QC:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,"mousemove",this.__QE,this,true);this.__Qv=true;var x=e.getTarget();this.__Qw.orientation=qx.bom.element.Attribute.get(x,"orientation");this.__Qw.lastCoord.left=e.getDocumentLeft();this.__Qw.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__fX);}
;}
,__QD:function(e){e.stopPropagation();if(this.__Qv){qx.event.Registration.removeListener(document,"mousemove",this.__QE,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__fX);if(this.__Qx.autoHide){for(var y in this.__Qu){qx.bom.element.Style.set(this.__Qu[y],"visibility","hidden");}
;}
;this.__Qv=false;qx.bom.Selection.clear(document.body);}
;}
,__QE:function(e){e.stopPropagation();if(this.__Qv){var z={left:null,top:null};switch(this.__Qw.orientation){case "south":z.top=e.getDocumentTop();break;case "southeast":z.top=e.getDocumentTop();z.left=e.getDocumentLeft();break;case "east":z.left=e.getDocumentLeft();break;};this.__QF(z,this.__Qw.lastCoord);this.__Qw.lastCoord.left=e.getDocumentLeft();this.__Qw.lastCoord.top=e.getDocumentTop();}
;}
,__QF:function(A,B){var I=qx.bom.element.Dimension;var F=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Qt.getId());var H=I.getContentSize(F.element);if(A.left){var E=A.left-B.left;if(E!==0){var D=I.getContentWidth(this.__fX)+E;var G=I.getWidth(this.__fX)+E;if((this.__Qx.minWidth==null||D>this.__Qx.minWidth)&&(this.__Qx.maxWidth==null||D<=this.__Qx.maxWidth)){if(H.width>=G){qx.bom.element.Style.set(this.__fX,"width",D+'px');this.__Qt.getData().width=D;}
;}
;}
;}
;if(A.top){var E=A.top-B.top;if(E!==0){var C=I.getContentHeight(this.__fX)+E;if((this.__Qx.minHeight==null||C>this.__Qx.minHeight)&&(this.__Qx.maxHeight==null||C<=this.__Qx.maxHeight)){qx.bom.element.Style.set(this.__fX,"height",C+"px");}
;}
;}
;}
},destruct:function(){if(this.__Qx.autoHide){qx.event.Registration.removeListener(this.__Qt.getElement(),a,this.__QA,this);qx.event.Registration.removeListener(this.__Qt.getElement(),b,this.__QB,this);}
;this.__Qt=this.__Qx=this.__fX=this.__Qu=null;this.__Qw=null;}
});}
)();
...
(function(){var c="auto",b="demobrowser.demo.bom.portal.box.Util",a="zIndex";qx.Class.define(b,{statics:{__QG:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,a);e=e==c?0:e;qx.bom.element.Style.set(d,a,e+this.__QG);}
,sendToBack:function(f){var g=qx.bom.element.Style.get(f,a);qx.bom.element.Style.set(f,a,g-this.__QG);}
}});}
)();
...
(function(){var k="mouseup",j="mousedown",i="mouseover",h="drag",g="dragend",f="move",d="demobrowser.demo.bom.portal.box.Draggable",c="cursor",b="mousemove",a="dragstart";qx.Class.define(d,{extend:qx.core.Object,construct:function(l){qx.core.Object.call(this);this.__Qt=l;this.__fX=l.getElement();this.__QH=null;this.__QI=null;this.__Qq();}
,members:{__Qt:null,__fX:null,__QH:null,__QI:null,getBox:function(){return this.__Qt;}
,getElement:function(){return this.__fX;}
,__Qq:function(){this.__QJ();this.__Qz();}
,__QJ:function(){this.__QH=qx.dom.Element.create("div");qx.bom.element.Class.add(this.__QH,"dragHandle");qx.dom.Element.insertBegin(this.__QH,this.__fX);}
,__Qz:function(){qx.bom.Element.addListener(this.__QH,j,this.__kR,this);qx.bom.Element.addListener(this.__QH,i,function(e){qx.bom.element.Style.set(this,c,f);}
,this.__QH);qx.bom.Element.addListener(this.__QH,a,this.__Nm,this);qx.bom.Element.addListener(this.__QH,g,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__QH,h,this.__QM,this);}
,__kR:function(e){if(e.isLeftPressed()){this.__QI={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__fX),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__fX)};qx.bom.Element.addListener(document.body,k,this.__QL,this,true);this.__QK();qx.event.Registration.fireEvent(this.__QH,a,qx.event.type.Event);}
;}
,__QK:qx.core.Environment.select("engine.name",{"mshtml":function(){var n=this;var m=qx.lang.Function.bind(this.__QL,n);document.getElementsByTagName("html")[0].onmouseleave=m;}
,"default":(function(){}
)}),__QL:function(e){try{e.stopPropagation();}
catch(o){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,"mousemove",this.__QM,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,"mouseup",this.__QL,this,true);}
,__Nm:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__Qt);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__Qt);qx.event.Registration.addListener(document.body,b,this.__QM,this,true);}
,__QM:function(e){e.stopPropagation();var p=e.getDocumentLeft()-this.__QI.left;var top=e.getDocumentTop()-this.__QI.top;qx.event.Timer.once(function(){this.checkGroupBox(p,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,p);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__Qt=this.__QH=this.__fX=this.__QI=null;}
});}
)();
(function(){var m="Boolean",l="left",k="demobrowser.demo.bom.portal.dragdrop.Manager",h="end",g="border",f="top",d="demobrowser.demo.bom.portal.box.Box",c="ease-out",b="singleton",a="px";qx.Class.define(k,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__QN={top:null,height:null};this.__QO={top:0,left:0};}
,properties:{activeBox:{check:d,init:null,nullable:true},sessionActive:{check:m,init:false}},members:{__QN:null,__QP:null,__QQ:false,__QO:null,__QR:null,__QS:null,startSession:function(n){this.setSessionActive(true);this.setActiveBox(n);this.__QP=n.getGroupBoxId();this.__QT();if(this.__QR==null){this.__QR={};var o=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=o.length;i<j;i++ ){this.__QR[o[i].element.id]={left:qx.bom.element.Location.getLeft(o[i].element),right:qx.bom.element.Location.getLeft(o[i].element)+qx.bom.element.Dimension.getWidth(o[i].element)};}
;}
;}
,__QT:function(){if(!this.__QS){this.__QS=qx.dom.Element.create("div");}
;var r=this.getActiveBox().getElement();var p=qx.bom.element.Dimension.getContentSize(r);this.__QU(r,this.__QS);qx.bom.element.Class.add(this.__QS,qx.bom.element.Class.get(r));var q="opacity:0.5;margin:0;position:absolute;"+"top:"+qx.bom.element.Location.getTop(r)+"px;"+"left:"+qx.bom.element.Location.getLeft(r)+"px;"+"width:"+p.width+"px;"+"height:"+p.height+"px";qx.bom.element.Style.setCss(this.__QS,q);qx.bom.element.Style.set(r,"border","1px dashed red");qx.dom.Node.getBodyElement(r).appendChild(this.__QS);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__QS);}
,__QU:function(s,t){while(s.firstChild){t.appendChild(s.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var y=this.getActiveBox();var v=y.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(y.getGroupBoxId(),this.__QP,y);y.setGroupBoxId(this.__QP);var x={left:qx.bom.element.Location.getLeft(this.__QS)+a,top:qx.bom.element.Location.getTop(this.__QS)+a};var w={left:qx.bom.element.Location.getLeft(v)+a,top:qx.bom.element.Location.getTop(v)+a};var z={timing:c,duration:300,keep:100,keyFrames:{'0':x,'100':w}};var u=qx.bom.element.Animation.animate(this.__QS,z);u.addListener(h,function(){this.__QU(this.__QS,v);qx.bom.element.Style.reset(v,g);this.__QS.parentNode.removeChild(this.__QS);if(y.isActive()){y._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(y);}
;}
,this);}
,onDragMove:function(top,A){if(this.__QO.left!=A){qx.bom.element.Style.set(this.__QS,l,A+a);}
;if(this.__QO.top!=top){qx.bom.element.Style.set(this.__QS,f,top+a);}
;var B=this.getActiveBox().getElement();if(this.__QN.top==null){this.__QN.top=qx.bom.element.Location.getTop(B);}
;if(this.__QN.height==null){this.__QN.height=qx.bom.element.Dimension.getHeight(B);}
;if(this.__QQ==false&&top>=this.__QN.top&&top<=(this.__QN.top+this.__QN.height)){return;}
;var C;if(this.__QQ){C=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__QP));while(C!=null){if(this.__QV(true,top,B,C)){this.__QQ=false;return;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {C=B;}
;if(top-this.__QO.top>0){C=qx.dom.Hierarchy.getNextElementSibling(C);while(C!=null){if(C){if(this.__QV(true,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {var C=qx.dom.Hierarchy.getPreviousElementSibling(C);while(C!=null){if(C){if(this.__QV(false,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getPreviousElementSibling(C);}
;}
;this.__QO.left=A;this.__QO.top=top;}
,__QV:function(D,top,E,F){var G=qx.bom.element.Location.getTop(F);var I=parseInt(qx.bom.element.Style.get(F,"paddingTop"));var J=parseInt(qx.bom.element.Style.get(F,"paddingBottom"));var H=qx.bom.element.Dimension.getContentHeight(F)+J+I;var K;if(D){if(top>=(G+(H/3))){K=qx.dom.Hierarchy.getNextElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertAfter(E,F);this.__QN.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
else {if(top<=(G+H*2/3)){K=qx.dom.Hierarchy.getPreviousElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertBefore(E,F);this.__QN.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
;return false;}
,checkGroupBox:function(L,M){if(this.__QR[this.__QP].left<=L&&this.__QR[this.__QP].right>=L){return;}
;for(var N in this.__QR){if(N!=this.__QP){if(this.__QR[N].left<=L+M&&this.__QR[N].right>=L){this.__QP=N;this.__QQ=true;return;}
;}
;}
;}
},destruct:function(){this.__QN=this.__QO=this.__QP=null;this.__QW=this.__QS=this.__QR=null;}
});}
)();
