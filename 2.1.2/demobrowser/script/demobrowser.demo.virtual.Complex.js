...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.e04770bd5020.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="icon/",q="",p="folder.png",o="places/",n="demobrowser.demo.virtual.DemoLayer",m="network-server.png",l="mouseover",k="user-trash.png",i="changeValue",h="network-workgroup.png",c="qx.ui.basic.Atom",g="/",f="user-desktop.png",b=" / ",a="row",e="foobar!",d="column";qx.Class.define(n,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__nL=[];}
,members:{_pool:null,__nL:null,getCellData:function(s,t){if(!this.__nL[s]){this.__nL[s]=[];}
;if(!this.__nL[s][t]){this.__nL[s][t]={label:this.__Sj(),icon:this.__Sk()};}
;return this.__nL[s][t];}
,getCellWidget:function(u,v){var w;if(v%2==0){w=this._pool.atom.pop();if(!w){w=new qx.ui.basic.Atom();w.addListener(l,function(){var x=this.__Sk();w.setIcon(x);this.__nL[u][v].icon=x;}
,this);}
...
;}
,__Sj:function(){var name=q;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__Sk:function(){var z=r;var B=o;var C=[p,k,m,h,f];var A=Math.floor(Math.random()*4);return (z+16+g+B+C[A]);}
