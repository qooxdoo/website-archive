...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.DateField.3b4f9f48e5ee.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="With date formater",o="demobrowser.demo.widget.DateField",n="",m="Set current date",l="Default",k="Set data",j="en",i="changeValue",h="Get data",g="Reset",c="Get date",f="dd.MM.yyyy",d="MM/dd/yyyy",b="MM-yyyy",a="execute";qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);qx.locale.Manager.getInstance().setLocale(j);this.getRoot().add(new qx.ui.basic.Label(l),{top:15,left:20});var r=new qx.ui.form.DateField();this.getRoot().add(r,{top:35,left:20});r.setValue(new Date());r.addListener(i,function(e){this.debug("Change Value: "+e.getData());}
);this.getRoot().add(new qx.ui.basic.Label(p),{top:15,left:150});var t=new qx.ui.form.DateField();this.getRoot().add(t,{top:35,left:150});t.setValue(new Date());var A=new qx.util.format.DateFormat(b);var B=new qx.util.format.DateFormat(d);var C=new qx.util.format.DateFormat(f);t.setDateFormat(B);var z=new qx.ui.form.Button(b);z.setWidth(120);this.getRoot().add(z,{top:80,left:150});z.addListener(a,function(e){t.setDateFormat(A);}
);var u=new qx.ui.form.Button(d);u.setWidth(120);this.getRoot().add(u,{top:110,left:150});u.addListener(a,function(e){t.setDateFormat(B);}
);var v=new qx.ui.form.Button(f);v.setWidth(120);this.getRoot().add(v,{top:140,left:150});v.addListener(a,function(e){t.setDateFormat(C);}
);this.getRoot().add(new qx.ui.basic.Label(k),{top:15,left:280});var s=new qx.ui.form.DateField();this.getRoot().add(s,{top:35,left:280});var D=new qx.ui.form.Button(m);D.setWidth(120);this.getRoot().add(D,{top:80,left:280});D.addListener(a,function(e){s.setValue(new Date());}
);var w=new qx.ui.form.Button(g);w.setWidth(120);this.getRoot().add(w,{top:110,left:280});w.addListener(a,function(e){s.resetValue();}
);this.getRoot().add(new qx.ui.basic.Label(h),{top:15,left:410});var y=new qx.ui.form.DateField();this.getRoot().add(y,{top:35,left:410});var x=new qx.ui.basic.Label();this.getRoot().add(x,{left:410,top:88});var q=new qx.ui.form.Button(c);q.setWidth(120);this.getRoot().add(q,{left:410,top:80});q.addListener(a,function(e){x.setValue(y.getValue()+n);}
);}
}});}
)();
...
,events:{"changeValue":f},properties:{dateFormat:{check:k,apply:I},placeholder:{check:a,nullable:true,apply:A},appearance:{refine:true,init:B},focusable:{refine:true,init:true},width:{refine:true,init:120}},statics:{__GG:null,__GH:null,getDefaultDateFormatter:function(){var L=qx.locale.Date.getDateFormat(F).toString();if(L==this.__GG){return this.__GH;}
;if(this.__GH){this.__GH.dispose();}
;this.__GH=new qx.util.format.DateFormat(L,qx.locale.Manager.getInstance().getLocale());this.__GG=L;return this.__GH;}
},members:{__GI:null,_forwardStates:{focused:true,invalid:true},_setDefaultDateFormat:function(){this.setDateFormat(qx.ui.form.DateField.getDefaultDateFormatter());}
,_addLocaleChangeListener:function(){if(qx.core.Environment.get(t)){this.__GI=qx.locale.Manager.getInstance().addListener(d,function(){this._setDefaultDateFormat();}
,this);}
;}
...
},destruct:function(){if(qx.core.Environment.get(t)){if(this.__GI){qx.locale.Manager.getInstance().removeListenerById(this.__GI);}
;}
;}
});}
)();
...
else {var by=(bv==null)?-1:bv.getDate();for(var i=0;i<6*7;i++ ){var bx=this.__yz[i];if(bx.hasState(P)){if(bx.hasState(a)){bx.removeState(a);}
;}
...
;this.__yy=this.__yz=this.__yA=null;}
});}
)();
