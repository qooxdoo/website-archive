...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.WebWorker.563df4778e6e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="qx.bom.WebWorker",d="html.webworker",c="qx.event.type.Data",b="message",a="error";qx.Class.define(f,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__EF=qx.core.Environment.get(d);this.__EF?this.__EH(g):this.__EI(g);}
,events:{"message":c,"error":c},members:{_worker:null,_handleErrorBound:null,_handleMessageBound:null,__EF:true,__EG:null,__EH:function(h){this._worker=new window.Worker(h);this._handleMessageBound=qx.lang.Function.bind(this._handleMessage,this);this._handleErrorBound=qx.lang.Function.bind(this._handleError,this);qx.bom.Event.addNativeListener(this._worker,"message",this._handleMessageBound);qx.bom.Event.addNativeListener(this._worker,"error",this._handleErrorBound);}
,__EI:function(i){var k=this;var j=new qx.bom.request.Xhr();j.onload=function(){k.__EG=(function(){var l=function(e){k.fireDataEvent('message',e);}
...
,postMessage:function(m){var n=this;if(this.__EF){this._worker.postMessage(m);}
else {setTimeout(function(){try{n.__EG.onmessage&&n.__EG.onmessage({data:m});}
...
},destruct:function(){if(this.__EF){qx.bom.Event.removeNativeListener(this._worker,b,this._handleMessageBound);qx.bom.Event.removeNativeListener(this._worker,a,this._handleErrorBound);if(this._worker){this._worker.terminate();this._worker=null;}
;}
