...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer.343e24585284.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__In:function(U,top,V,W,X){var Y=[N,V,M,top,J];W.createDataCellHtml(X,Y);Y.push(k);U.innerHTML+=Y.join(y);}
,testDefaultRenderer:function(ba){var bb=100;var bd={value:[null,x,32,new Date()],styleLeft:[0],styleWidth:[bb],styleHeight:[20],style:[y]};var bc=this._getNewTableDiv(bb);var top=0;qx.util.Permutation.permute(bd,function(be){this.__In(bc,top,bb,ba,be);top+=20;}
,this);}
,testBooleanRenderer:function(){var bi=70;var bh=30;var bj=new qx.ui.table.cellrenderer.Boolean();var bf={value:[null,true,false],styleLeft:[0],styleWidth:[bi],styleHeight:[bh],style:[y]};var bg=this._getNewTableDiv(bi);var top=0;qx.util.Permutation.permute(bf,function(bk){this.__In(bg,top,bi,bj,bk);top+=bh;}
,this);bj.setIconFalse(A);bj.setIconTrue(z);qx.util.Permutation.permute(bf,function(bl){this.__In(bg,top,bi,bj,bl);top+=bh;}
,this);}
,testDateRenderer:function(){var bp=180;var bq=new qx.ui.table.cellrenderer.Date();var bs={value:new Date(),styleLeft:[0],styleWidth:[bp],styleHeight:[20],style:[y]};var bo=qx.util.format.DateFormat;var br=[bo.getDateTimeInstance(),bo.getDateInstance()];var bm=this._getNewTableDiv(bp);var top=0;for(var i=0;i<br.length;i++ ){var bn=br[i];bq.setDateFormat(bn);this.__In(bm,top,bp,bq,bs);top+=20;}
;}
,testNumberRenderer:function(){var bx=new qx.ui.table.cellrenderer.Number();var bw=100;var bz={value:Math.PI,styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[y]};var bv=qx.util.format.NumberFormat;var by=[new bv().set({maximumFractionDigits:0}),new bv().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:d})];var bt=this._getNewTableDiv(bw);var top=0;for(var i=0;i<by.length;i++ ){var bu=by[i];bx.setNumberFormat(bu);this.__In(bt,top,bw,bx,bz);top+=20;}
;}
,testImageRenderer:function(){var bC=new qx.ui.table.cellrenderer.Image();var bA=50;var bD={value:[null,H,n,L,g,e],styleLeft:[0],styleWidth:[bA],styleHeight:[20],style:[y],tooltip:[y,t]};var bB=this._getNewTableDiv(bA);var top=0;qx.util.Permutation.permute(bD,function(bE){this.__In(bB,top,bA,bC,bE);top+=20;}
,this);}
,testStringRenderer:function(){var bJ=new qx.ui.table.cellrenderer.String();var bI=100;var bH=20;var bF={value:[null,w,G],styleLeft:[0],styleWidth:[bI],styleHeight:[bH],style:[y]};var bG=this._getNewTableDiv(bI);var top=0;qx.util.Permutation.permute(bF,function(bK){this.__In(bG,top,bI,bJ,bK);top+=20;}
,this);}
,testPasswordRenderer:function(){var bP=new qx.ui.table.cellrenderer.Password();var bO=100;var bN=20;var bL={value:[null,w,G],styleLeft:[0],styleWidth:[bO],styleHeight:[bN],style:[y]};var bM=this._getNewTableDiv(bO);var top=0;qx.util.Permutation.permute(bL,function(bQ){this.__In(bM,top,bO,bP,bQ);top+=20;}
,this);}
,testHtmlRenderer:function(){var bV=new qx.ui.table.cellrenderer.Html();var bU=100;var bT=50;var bR={value:[null,q,r,Q],styleLeft:[0],styleWidth:[bU],styleHeight:[bT],style:[y]};var bS=this._getNewTableDiv(bU);var top=0;qx.util.Permutation.permute(bR,function(bW){this.__In(bS,top,bU,bV,bW);top+=20;}
,this);}
,testConditionalRenderer:function(){var cc=new qx.ui.table.cellrenderer.Conditional();cc.addNumericCondition(O,0,null,u,null,null);cc.addNumericCondition(B,100,C,null,null,null);cc.addBetweenCondition(P,0,2,null,null,null,v,null);cc.addRegex(s,null,null,v,b);var cb=100;var ca=20;var bX={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[cb],table:[this.tableMock],styleHeight:[ca],style:[y]};var bY=this._getNewTableDiv(cb);var top=0;qx.util.Permutation.permute(bX,function(cd){this.__In(bY,top,cb,cc,cd);top+=20;}
,this);}
...
);var ch=100;var cg=20;var ce={value:[null,x,new Date(),30,H,false],styleLeft:[0],styleWidth:[ch],styleHeight:[cg],table:[this.tableMock],style:[y]};var cf=this._getNewTableDiv(ch);var top=0;qx.util.Permutation.permute(ce,function(cm){this.__In(cf,top,ch,ci,cm);top+=20;}
,this);}
,testReplaceRenderer:function(){var cs=new qx.ui.table.cellrenderer.Replace();cs.setReplaceMap({'1':E,'2':a,'3':h});cs.addReversedReplaceMap();var cq=100;var cp=20;var cn={value:[1,2,3],styleLeft:[0],styleWidth:[cq],table:[this.tableMock],styleHeight:[cp],style:[y]};var co=this._getNewTableDiv(cq);var top=0;qx.util.Permutation.permute(cn,function(ct){this.__In(co,top,cq,cs,ct);top+=20;}
,this);}
...
,init:k}},members:{__zA:16,__zB:16,__zC:null,_insetY:2,_identifyImage:function(A){throw new Error("_identifyImage is abstract");}
,_getImageInfos:function(B){var C=this._identifyImage(B);if(C==null||typeof C==g){C={url:C,tooltip:null};}
;if(!C.imageWidth||!C.imageHeight){var D=this.__zD(C.url);C.imageWidth=D.width;C.imageHeight=D.height;}
;C.width=C.imageWidth;C.height=C.imageHeight;return C;}
,__zD:function(E){var H=qx.util.ResourceManager.getInstance();var G=qx.io.ImageLoader;var F,I;if(H.has(E)){F=H.getImageWidth(E);I=H.getImageHeight(E);}
else if(G.isLoaded(E)){F=G.getWidth(E);I=G.getHeight(E);}
else {F=this.__zA;I=this.__zB;}
;return {width:F,height:I};}
,createDataCellHtml:function(J,K){this.__zC=this._getImageInfos(J);return qx.ui.table.cellrenderer.Abstract.prototype.createDataCellHtml.call(this,J,K);}
,_getCellClass:function(L){return qx.ui.table.cellrenderer.Abstract.prototype._getCellClass.call(this)+q;}
,_getContentHtml:function(M){var content=t;if(this.__zC.url){content=qx.bom.element.Decoration.create(this.__zC.url,this.getRepeat(),{width:this.__zC.width+m,height:this.__zC.height+m,display:qx.core.Environment.get(j),verticalAlign:s,position:f});}
;return content;}
,_getCellAttributes:function(N){var O=this.__zC.tooltip;if(O){return n+O+e;}
else {return u;}
;}
},destruct:function(){this.__zC=null;}
});}
)();
(function(){var h="_applyIconTrue",g="decoration/table/boolean-true.png",f="qx.ui.table.cellrenderer.Boolean",e=";padding-top:4px;",d="decoration/table/boolean-false.png",c="_applyIconFalse",b="changeTheme",a="String";qx.Class.define(f,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(){qx.ui.table.cellrenderer.AbstractImage.call(this);this.__FI=qx.util.AliasManager.getInstance();this.initIconTrue();this.initIconFalse();qx.theme.manager.Appearance.getInstance().addListener(b,this._onChangeTheme,this);}
,properties:{iconTrue:{check:a,init:g,apply:h},iconFalse:{check:a,init:d,apply:c}},members:{__HL:null,__HM:false,__FI:null,_onChangeTheme:function(){this._applyIconTrue(this.getIconTrue());this._applyIconFalse(this.getIconFalse());}
,_applyIconTrue:function(i){this.__HL=this.__FI.resolve(i);}
,_applyIconFalse:function(j){this.__HM=this.__FI.resolve(j);}
,_insetY:5,_getCellStyle:function(k){return qx.ui.table.cellrenderer.AbstractImage.prototype._getCellStyle.call(this,k)+e;}
,_identifyImage:function(l){var m={imageWidth:11,imageHeight:11};switch(l.value){case true:m.url=this.__HL;break;case false:m.url=this.__HM;break;default:m.url=null;break;};return m;}
},destruct:function(){this.__FI=null;qx.theme.manager.Appearance.getInstance().removeListener(b,this._onChangeTheme,this);}
});}
)();
(function(){var s="font-weight",r=";",q="text-align",p='g',o=":",n="qx.ui.table.cellrenderer.Conditional",m="color",l="font-style",k="==",j=">",c="between",h="<",f="regex",b="!between",a=">=",e="!=",d="<=",g="";qx.Class.define(n,{extend:qx.ui.table.cellrenderer.Default,construct:function(t,u,v,w){qx.ui.table.cellrenderer.Default.call(this);this.numericAllowed=[k,e,j,h,a,d];this.betweenAllowed=[c,b];this.conditions=[];this.__Fp=t||g;this.__Fq=u||g;this.__Fr=v||g;this.__Fs=w||g;}
,members:{__Fp:null,__Fq:null,__Fr:null,__Fs:null,__Ft:function(x,y){if(x[1]!=null){y[q]=x[1];}
;if(x[2]!=null){y[m]=x[2];}
;if(x[3]!=null){y[l]=x[3];}
;if(x[4]!=null){y[s]=x[4];}
;}
...
;var bd=X.table.getTableModel();var i;var bf;var Y;var bb={"text-align":this.__Fp,"color":this.__Fq,"font-style":this.__Fr,"font-weight":this.__Fs};for(i in this.conditions){bf=false;if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){Y=X.value;}
...
;if(bf==true){this.__Ft(this.conditions[i],bb);}
;}
...
(function(){var b="qx.ui.table.cellrenderer.Image",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__yL=c;}
;if(d){this.__yM=d;}
;this.__wg=qx.util.AliasManager.getInstance();}
,members:{__wg:null,__yM:16,__yL:16,_identifyImage:function(e){var f={imageWidth:this.__yL,imageHeight:this.__yM};if(e.value==a){f.url=null;}
else {f.url=this.__wg.resolve(e.value);}
