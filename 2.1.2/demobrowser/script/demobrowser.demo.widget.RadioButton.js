...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.RadioButton","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButton.fbdba62107c3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="Yellow",g="Red",f="demobrowser.demo.widget.RadioButton",d="Green",c="changeSelection",b="Blue",a="What is your favorite color?";qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var n=new qx.ui.basic.Label(a);var k=new qx.ui.layout.VBox();k.setSpacing(10);var i=new qx.ui.container.Composite(k);i.setPadding(20);this.getRoot().add(i,{left:0,top:0});i.add(n);var m=new qx.ui.form.RadioButton(g);var l=new qx.ui.form.RadioButton(d);var p=new qx.ui.form.RadioButton(h);var j=new qx.ui.form.RadioButton(b);i.add(m);i.add(l);i.add(p);i.add(j);var o=new qx.ui.form.RadioGroup(m,l,p,j);o.addListener(c,this._onChangeSelection,this);}
,_onChangeSelection:function(e){var r=e.getData()[0];var q=r.getLabel();alert("Your favorite color is: "+q);}
}});}
)();
