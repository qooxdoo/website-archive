...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Label.3c3420920316.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="foo bar",h="hello <b>world</b>",g="foo <i>bar</i>",f="hello world",e="demobrowser.demo.bom.Label",d="80px",c="Quite a long label text",b="1px solid red",a="This is <b>bold</b> text";qx.Class.define(e,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var l=qx.bom.Label.create(c);l.style.border=b;l.style.width=d;document.body.appendChild(l);var n=qx.bom.Label.getTextSize(c);this.debug("Preferred Label1 Size: "+n.width+"x"+n.height);var m=qx.bom.Label.create(a,true);m.style.border=b;m.style.width=d;document.body.appendChild(m);var n=qx.bom.Label.getHtmlSize(a);this.debug("Preferred Label2 Size: "+n.width+"x"+n.height);var n=qx.bom.Label.getHtmlSize(a,null,80);this.debug("Preferred Label2 Size (HeightForWidth): "+n.width+"x"+n.height);var s=f;var o=j;var q=qx.bom.Label;var r=new Date;for(var i=0;i<500;i++ ){q.getTextSize(i%2?s:o);}
;var stop=new Date;this.debug("Runtime to measure 500 text blocks: "+(stop-r)+"ms");var k=h;var p=g;var q=qx.bom.Label;var r=new Date;for(var i=0;i<500;i++ ){q.getHtmlSize(i%2?k:p);}
;var stop=new Date;this.debug("Runtime to measure 500 html blocks: "+(stop-r)+"ms");}
}});}
)();
