...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.4a9eb7e16eac.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="one",m="_applySpacing",k="Integer",h="_applyDragSelection",g="String",f="resize",d="demobrowser.demo.virtual.list.List",c="list",b="multi",a="_applyQuickSelection",C="_applyItemHeight",B="_applySelectionMode",A="additive",z="changeName",y="Number",x="addItem",w="removeItem",v="changeSelection",u="row",t="single",r="changeHeight",s=",",p="Boolean",q="selected",o="qx.event.type.Data";qx.Class.define(d,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__RW=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__RW);this.getPane().addListener(f,this._onResize,this);this.__qC=[];this.__cR=[];this.__uT=new qx.ui.virtual.selection.Row(this.getPane());this.__uT.addListener(v,this._onChangeSelection,this);this.__uT.attachMouseEvents();this.__uT.attachKeyEvents(this);this.__uT.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:o,removeItem:o,changeValue:o,changeSelection:o},properties:{appearance:{refine:true,init:c},focusable:{refine:true,init:true},spacing:{check:k,init:0,apply:m,themeable:true},enableInlineFind:{check:p,init:true},name:{check:g,nullable:true,event:z},itemHeight:{init:24,themeable:true,check:y,apply:C},selectionMode:{check:[t,b,A,n],init:t,apply:B},dragSelection:{check:p,init:false,apply:h},quickSelection:{check:p,init:false,apply:a}},members:{__qC:null,__cR:null,__uT:null,__RW:null,syncWidget:function(){this.update();}
,update:function(){var E=this.getPane().getRowConfig();E.setItemCount(this.__qC.length);E.resetItemSizes();for(var i=0;i<this.__qC.length;i++ ){var D=this.__qC[i].getHeight();if(D!==null){E.setItemSize(i,D);}
;}
;}
,updateSelection:function(){var F=this.__RW.getChildren();for(var i=0;i<F.length;i++ ){var G=F[i];var H=G.getUserData(u);if(this.__uT.isItemSelected(H)){G.addState(q);}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(v,this.__Sb(e.getData()));}
,getCellWidget:function(I,J){var L=this.__qC[I];if(!L){return null;}
;var K=this.__cR.pop()||new qx.ui.form.ListItem();K.set({label:L.getLabel(),icon:L.getIcon()});if(this.__uT.isItemSelected(I)){K.addState(q);}
else {K.removeState(q);}
;K.setUserData(u,I);return K;}
,poolCellWidget:function(M){this.__cR.push(M);}
...
,hasChildren:function(){return this.__qC.length>0;}
...
,add:function(W){this.__qC.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__qC,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__qC.length;i<j;i++ ){this._removeHelper(this.__qC[i]);}
;this.__qC=[];}
,indexOf:function(Y){return this.__qC.indexOf(Y);}
,addAt:function(ba,bb){qx.lang.Array.insertAt(this.__qC,ba,bb);this._addHelper(ba);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__qC,bc,bd);this._addHelper(bc);}
,addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__qC,be,bf);this._addHelper(be);}
,removeAt:function(bg){this.__qC.splice(bg,1);this._removeHelper(this.__qC[bg]);}
,__RX:function(bh){var bi=this.__qC.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__RY:function(bj){var bk=this.__qC[bj];return bk;}
,__Sa:function(bl){var bm=[];for(var i=0;i<bl.length;i++ ){bm.push(this.__RX(bl[i]));}
;return bm;}
,__Sb:function(bn){var bo=[];for(var i=0;i<bn.length;i++ ){bo.push(this.__qC[bn[i]]);}
;return bo;}
,selectAll:function(){this.__uT.selectAll();}
,setSelected:function(bp){this.__uT.selectItem(this.__RX(bp));}
,isSelected:function(bq){return this.__uT.isItemSelected(this.__RX(bq));}
,addToSelection:function(br){this.__uT.addItem(this.__RX(br));}
,removeFromSelection:function(bs){this.__uT.removeItem(this.__RX(bs));}
,selectRange:function(bt,bu){this.__uT.selectItemRange(this.__RX(bt),this.__RX(bu));}
,resetSelection:function(){this.__uT.clearSelection();}
,setSelection:function(bv){this.__uT.replaceSelection(this.__Sa(bv));}
,getSelectedItem:function(){return this.__qC[this.getSelected()];}
,getSelected:function(){return this.__qC[this.__uT.getSelectedItem()];}
,getSelection:function(){return this.__Sb(this.__uT.getSelection());}
,getSortedSelection:function(){return this.__Sb(this.__uT.getSortedSelection());}
,isSelectionEmpty:function(){return this.__uT.isSelectionEmpty();}
,getSelectionContext:function(){return this.__uT.getSelectionContext();}
,getSelectables:function(){return this.__Sb(this.__uT.getSelectables());}
,_applySelectionMode:function(bw,bx){this.__uT.setMode(bw);}
,_applyDragSelection:function(by,bz){this.__uT.setDrag(by);}
,_applyQuickSelection:function(bA,bB){this.__uT.setQuick(bA);}
}});}
)();
