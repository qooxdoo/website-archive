...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController.cc0b6f29602b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="changeModel",k="qx.core.Object",j="qx.debug",h="_applyTarget",g="qx.data.controller.Form",f="changeTarget",e=".",d="qx.ui.form.Form",c="_applyModel",b="modelSelection[0]",a="value";qx.Class.define(g,{extend:qx.core.Object,construct:function(m,n,o){qx.core.Object.call(this);this._selfUpdate=!!o;this.__Gq={};if(m!=null){this.setModel(m);}
;if(n!=null){this.setTarget(n);}
;}
,properties:{model:{check:k,apply:c,event:l,nullable:true,dereference:true},target:{check:d,apply:h,event:f,nullable:true,init:null,dereference:true}},members:{__Gr:null,__Gq:null,addBindingOptions:function(name,p,q){this.__Gq[name]=[p,q];if(this.getModel()==null||this.getTarget()==null){return;}
;var r=this.getTarget().getItems()[name];var s=this.__Gu(r)?b:a;this.__Gr.removeTarget(r,s,name);this.__Gr.addTarget(r,s,name,!this._selfUpdate,p,q);}
...
;if(this.__Gq[name]&&this.__Gq[name][1]){u=this.__Gq[name][1].converter(u);}
;B[y[i]]=u;}
else {if(!B[y[i]]){B[y[i]]={};}
;B=B[y[i]];}
;}
...
;var C=this.getTarget().getItems();for(var name in C){var F=C[name];var E=this.__Gu(F)?b:a;var D=this.__Gq[name];D=D&&this.__Gq[name][1];qx.data.SingleValueBinding.updateTarget(F,E,this.getModel(),name,D);}
;}
,_applyTarget:function(G,H){if(H!=null){this.__Gt(H);}
;if(this.getModel()==null){return;}
;if(G!=null){this.__Gs();}
;}
,_applyModel:function(I,J){if(this.__Gr!=null&&I==null){this.__Gr.setModel(null);}
;if(this.__Gr!=null){var K=this.getTarget().getItems();for(var name in K){var M=K[name];var L=this.__Gu(M)?b:a;this.__Gr.removeTarget(M,L,name);}
;}
;if(this.__Gr!=null){this.__Gr.setModel(I);}
;if(this.getTarget()==null){return;}
;if(I!=null){this.__Gs();}
;}
,__Gs:function(){if(this.__Gr==null){this.__Gr=new qx.data.controller.Object(this.getModel());}
;var N=this.getTarget().getItems();for(var name in N){var Q=N[name];var O=this.__Gu(Q)?b:a;var P=this.__Gq[name];try{if(P==null){this.__Gr.addTarget(Q,O,name,!this._selfUpdate);}
else {this.__Gr.addTarget(Q,O,name,!this._selfUpdate,P[0],P[1]);}
;}
...
,__Gt:function(S){if(this.__Gr==null){return;}
;var T=S.getItems();for(var name in T){var V=T[name];var U=this.__Gu(V)?b:a;this.__Gr.removeTarget(V,U,name);}
;}
,__Gu:function(W){return qx.Class.hasInterface(W.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(W.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__Gr){this.__Gr.dispose();}
;}
});}
)();
