...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.NamesList.77f6bfe1bb28.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="changeModel",i="application/json",h="json",g="loaded",f="error",e="fail",d="queued",c="changeState",b="__ud",a="success",x="String",w="changePhase",v="_marshaler",u="qx.data.store.Json",t="changeUrl",s="_applyUrl",r="aborted",q="qx.event.type.Data",p="receiving",o="sending",m="completed",n="failed",k="timeout",l="configured";qx.Class.define(u,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":q,"error":q},properties:{model:{nullable:true,event:j},state:{check:[l,d,o,p,m,r,k,n],init:l,event:c},url:{check:x,apply:s,event:t,nullable:true}},members:{_marshaler:null,_delegate:null,__ud:null,_applyUrl:function(A,B){if(A!=null){A=qx.util.AliasManager.getInstance().resolve(A);A=qx.util.ResourceManager.getInstance().toUri(A);this._createRequest(A);}
;}
...
;this.fireDataEvent(g,this.getModel());if(this.__ud){this.__ud.dispose();this.__ud=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__ud!=null){this._disposeObjects(b);}
...
;this.__qD={};var E=this._transport=this._createTransport();this._setPhase(x);this.__qE=qx.lang.Function.bind(this._onReadyStateChange,this);this.__qF=qx.lang.Function.bind(this._onLoad,this);this.__qG=qx.lang.Function.bind(this._onLoadEnd,this);this.__qH=qx.lang.Function.bind(this._onAbort,this);this.__mK=qx.lang.Function.bind(this._onTimeout,this);this.__qI=qx.lang.Function.bind(this._onError,this);E.onreadystatechange=this.__qE;E.onload=this.__qF;E.onloadend=this.__qG;E.onabort=this.__qH;E.ontimeout=this.__mK;E.onerror=this.__qI;}
...
,nullable:true},authentication:{check:f,nullable:true}},members:{__qE:null,__qF:null,__qG:null,__qH:null,__mK:null,__qI:null,__qJ:null,__mN:null,__qK:null,__qD:null,__qL:null,_transport:null,_createTransport:function(){throw new Error("Abstract method call");}
...
;this.__mN=true;this.__qK=n;this._transport.abort();}
,_setRequestHeaders:function(){var N=this._transport,L=this._getAllRequestHeaders();for(var M in L){N.setRequestHeader(M,L[M]);}
;}
,_getAllRequestHeaders:function(){var O={};qx.lang.Object.mergeWith(O,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(O,this.__qM());qx.lang.Object.mergeWith(O,this.__qL);qx.lang.Object.mergeWith(O,this.__qD);return O;}
,__qM:function(){var Q=this.getAuthentication(),P={};if(Q){Q.getAuthHeaders().forEach(function(R){P[R.key]=R.value;}
);return P;}
;}
,setRequestHeader:function(S,T){this.__qD[S]=T;}
,getRequestHeader:function(U){return this.__qD[U];}
,removeRequestHeader:function(V){if(this.__qD[V]){delete this.__qD[V];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__qK;}
...
,getResponse:function(){return this.__qJ;}
,_setResponse:function(X){var Y=X;if(this.__qJ!==X){this.__qJ=X;this.fireEvent(w,qx.event.type.Data,[this.__qJ,Y]);}
;}
,_onReadyStateChange:function(){var ba=this.getReadyState();if(qx.core.Environment.get(l)){this.debug("Fire readyState: "+ba);}
;this.fireEvent(z);if(this.__mN){return;}
;if(ba===3){this._setPhase(d);}
;if(this.isDone()){this.__qN();}
;}
,__qN:function(){var bb;if(qx.core.Environment.get(l)){this.debug("Request completed with HTTP status: "+this.getStatus());}
...
,_setPhase:function(bd){var be=this.__qK;if(qx.core.Environment.get(p)){qx.core.Assert.assertString(bd);qx.core.Assert.assertMatch(bd,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__qK=bd;this.fireDataEvent(h,bd,be);}
...
;var y=v[f+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(y)){var A=qx.data&&qx.data.IListData&&qx.Class.hasInterface(y&&y.constructor,qx.data.IListData);for(var i=0;i<y.length;i++ ){var z=A?y.getItem(i):y[i];B+=this.__qO(name,z,w);}
;}
else if(qx.lang.Type.isDate(y)&&x!=null){B+=this.__qO(name,x.format(y),w);}
else {B+=this.__qO(name,y,w);}
;}
;return B.substring(0,B.length-1);}
,__qO:function(name,D,E){if(D instanceof qx.core.Object&&E!=null){var F=encodeURIComponent(E(D));if(F===undefined){var F=encodeURIComponent(D);}
;}
...
;return T+k;}
;if(qx.locale&&qx.locale.LocalizedString&&O instanceof qx.locale.LocalizedString){O=O.toString();}
...
,init:true}},members:{__qP:null,_createTransport:function(){return new qx.bom.request.Xhr();}
...
;}
;return A;}
,setParser:function(B){var C=qx.io.request.Xhr;if(typeof C.PARSER[B]===b){return this.__qP=C.PARSER[B];}
;if(qx.core.Environment.get(n)){qx.core.Assert.assertFunction(B);}
;return this.__qP=B;}
,_getParser:function(){var D=this.__qP,E;if(D){return D;}
...
(function(){var k="activex",j="If-None-Match",i="xhr",h="engine.version",g="GET",f="-1",d="load",c="abort",b="Microsoft.XMLHTTP",a="browser.version",G="If-Match",F="Microsoft.XMLDOM",E="If-Range",D="Content-Type",C="io.xhr",B="on",A="timeout",z="If-Modified-Since",y="onunload",x="browser.documentmode",r="loadend",s="opera",p="gecko",q="file:",n="error",o="mshtml",l="undefined",m="qx.debug.io",t="",u="readystatechange",w="qx.bom.request.Xhr",v="engine.name";qx.Bootstrap.define(w,{construct:function(){this.__qQ=qx.Bootstrap.bind(this.__rc,this);this.__qR=qx.Bootstrap.bind(this.__rb,this);this.__mK=qx.Bootstrap.bind(this.__rg,this);this.__ra();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__qS=qx.Bootstrap.bind(this.__rj,this);window.attachEvent(y,this.__qS);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":w,"error":w,"loadend":w,"timeout":w,"abort":w,"load":w},members:{readyState:0,responseText:t,responseXML:null,status:0,statusText:t,timeout:0,open:function(H,I,J,K,L){this.__rl();if(typeof I===l){throw new Error("Not enough arguments");}
else if(typeof H===l){H=g;}
;this.__mN=false;this.__qT=false;this.__qU=false;this.__mO=I;if(typeof J==l){J=true;}
;this.__qV=J;if(!this.__rk()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__ra();}
;this.__qX.onreadystatechange=this.__qQ;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Open native request with method: "+H+", url: "+I+", async: "+J);}
;this.__qX.open(H,I,J,K,L);}
catch(M){if(!qx.util.Request.isCrossDomain(I)){throw M;}
;if(!this.__qV){this.__qW=M;}
;if(this.__qV){if(window.XDomainRequest){this.readyState=4;this.__qX=new XDomainRequest();this.__qX.onerror=qx.Bootstrap.bind(function(){this._emit(u);this._emit(n);this._emit(r);}
...
;this.__qX.open(H,I,J,K,L);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__mP){return;}
;this.readyState=4;this._emit(u);this._emit(n);this._emit(r);}
,this));}
;}
;if(qx.core.Environment.get(v)===o&&qx.core.Environment.get(x)<9&&this.__qX.readyState>0){this.__qX.setRequestHeader(z,f);}
;if(qx.core.Environment.get(v)===p&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__qV){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(u);}
;}
,setRequestHeader:function(N,O){this.__rl();if(N==G||N==z||N==j||N==E){this.__qU=true;}
;this.__qX.setRequestHeader(N,O);return this;}
,send:function(P){this.__rl();if(!this.__qV&&this.__qW){throw this.__qW;}
;if(qx.core.Environment.get(v)===s&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__qY=window.setTimeout(this.__mK,this.timeout);}
;P=typeof P==l?null:P;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Send native request");}
;this.__qX.send(P);}
catch(R){if(!this.__qV){throw R;}
;if(this._getProtocol()===q){this.readyState=2;this.__rd();var Q=this;window.setTimeout(function(){if(Q.__mP){return;}
;Q.readyState=3;Q.__rd();Q.readyState=4;Q.__rd();}
);}
;}
;if(qx.core.Environment.get(v)===p&&!this.__qV){this.__rc();}
;this.__qT=true;return this;}
,abort:function(){this.__rl();this.__mN=true;this.__qX.abort();if(this.__qX){this.readyState=this.__qX.readyState;}
;return this;}
...
,getResponseHeader:function(U){this.__rl();return this.__qX.getResponseHeader(U);}
,getAllResponseHeaders:function(){this.__rl();return this.__qX.getAllResponseHeaders();}
,getRequest:function(){return this.__qX;}
,dispose:function(){if(this.__mP){return false;}
;window.clearTimeout(this.__qY);if(window.detachEvent){window.detachEvent(y,this.__qS);}
;try{this.__qX.onreadystatechange;}
catch(W){return false;}
;var V=function(){}
;this.__qX.onreadystatechange=V;this.__qX.onload=V;this.__qX.onerror=V;this.abort();this.__qX=null;this.__mP=true;return true;}
...
,_getProtocol:function(){var Y=this.__mO;var ba=/^(\w+:)\/\//;if(Y!==null&&Y.match){var bb=Y.match(ba);if(bb&&bb[1]){return bb[1];}
;}
;return window.location.protocol;}
,__qX:null,__qV:null,__qQ:null,__qR:null,__qS:null,__mK:null,__qT:null,__mO:null,__mN:null,__fM:null,__mP:null,__qY:null,__qW:null,__qU:null,__ra:function(){this.__qX=this._createNativeXhr();this.__qX.onreadystatechange=this.__qQ;if(this.__qX.onabort){this.__qX.onabort=this.__qR;}
;this.__mP=this.__qT=this.__mN=false;}
,__rb:function(){if(!this.__mN){this.abort();}
;}
,__rc:function(){var bc=this.__qX,bd=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Received native readyState: "+bc.readyState);}
;if(this.readyState==bc.readyState){return;}
;this.readyState=bc.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__mN&&!this.__qT){return;}
;if(!this.__qV&&(bc.readyState==2||bc.readyState==3)){return;}
...
;if(bd){this.__rh();this.__ri();}
;}
;this.__rd();if(this.readyState==qx.bom.request.Xhr.DONE){if(bc){bc.onreadystatechange=function(){}
;}
;}
;}
,__rd:function(){var bf=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__qY);}
;if(qx.core.Environment.get(v)==o&&qx.core.Environment.get(x)<8){if(this.__qV&&!this.__qT&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(bf.__mP){return;}
;bf.readyState=3;bf._emit(u);bf.readyState=4;bf._emit(u);bf.__re();}
);return;}
;}
;}
;this._emit(u);if(this.readyState===qx.bom.request.Xhr.DONE){this.__re();}
;}
,__re:function(){if(this.__fM){this._emit(A);if(qx.core.Environment.get(v)===s){this._emit(n);}
;this.__fM=false;}
else {if(this.__mN){this._emit(c);}
else {if(this.__rf()){this._emit(n);}
else {this._emit(d);}
;}
;}
;this._emit(r);}
,__rf:function(){var bg;if(this._getProtocol()===q){bg=!this.responseText;}
else {bg=!this.statusText;}
;return bg;}
,__rg:function(){var bh=this.__qX;this.readyState=qx.bom.request.Xhr.DONE;this.__fM=true;bh.abort();this.responseText=t;this.responseXML=null;this.__rd();}
,__rh:function(){var bi=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===q&&this.status===0&&bi){if(!this.__rf()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(v)===s){if(bi&&this.__qU&&!this.__mN&&this.status===0){this.status=304;}
;}
;}
,__ri:function(){if(qx.core.Environment.get(v)==o&&(this.getResponseHeader(D)||t).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bj=new window.ActiveXObject(F);bj.async=false;bj.validateOnParse=false;bj.loadXML(this.responseText);this.responseXML=bj;}
;}
,__rj:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__rk:function(){var name=qx.core.Environment.get(v);var bk=qx.core.Environment.get(a);return !(name==o&&bk<9||name==p&&bk<3.5);}
,__rl:function(){if(this.__mP){throw new Error("Already disposed");}
;}
