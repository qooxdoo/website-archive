...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.bb553e8fa255.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="mousedown",l="teal",k="maroon",h="qx.ui.control.ColorPopup",g="#666",f="changeValue",d="#333",c="__Jh",b="#000",a="yellow",X="__Ji",W="changeGreen",V="colorpopup",U="_applyValue",T="blue",S="changeRed",R="field#",Q="#CCC",P="Color Selector",O="changeVisibility",t="recent",u="changeBlue",r="mouseover",s="Cancel",p="#FFF",q="right",n="Open ColorSelector",o="mouseout",v="#999",w="Automatic",D="Basic Colors",B="Preview (Old/New)",H="visible",F="Recent Colors",K="OK",J="field",y="green",N="red",M="preview-pane",L="selector-button",x="colorselector-cancelbutton",z="auto-button",A="colorselector-okbutton",C="Number",E="execute",G="selected-preview",I="current-preview";qx.Class.define(h,{extend:qx.ui.popup.Popup,implement:[qx.ui.form.IColorForm],construct:function(){qx.ui.popup.Popup.call(this);this.setLayout(new qx.ui.layout.VBox(5));this._createChildControl(z);this._createBoxes();this._createChildControl(M);this._createChildControl(L);this.addListener(O,this._onChangeVisibility,this);}
,properties:{appearance:{refine:true,init:V},value:{nullable:true,apply:U,event:f},red:{check:C,init:null,nullable:true,event:S},green:{check:C,init:null,nullable:true,event:W},blue:{check:C,init:null,nullable:true,event:u}},members:{__Jf:1e5,__Jg:null,__Jh:null,__Ji:null,__Jj:t,__Jk:12,_createChildControlImpl:function(Y,ba){var bb;switch(Y){case J:bb=new qx.ui.core.Widget;bb.addListener(m,this._onFieldMouseDown,this);bb.addListener(r,this._onFieldMouseOver,this);bb.addListener(o,this._onFieldMouseOut,this);break;case z:bb=new qx.ui.form.Button(this.tr(w));bb.setAllowStretchX(true);bb.addListener(E,this._onAutomaticBtnExecute,this);this.add(bb);break;case L:bb=new qx.ui.form.Button(this.tr(n));bb.addListener(E,this._onSelectorButtonExecute,this);this.add(bb);break;case M:bb=new qx.ui.groupbox.GroupBox(this.tr(B));bb.setLayout(new qx.ui.layout.HBox);bb.add(this._createChildControl(G,true),{flex:1});bb.add(this._createChildControl(I,true),{flex:1});this.add(bb);break;case G:bb=new qx.ui.container.Composite(new qx.ui.layout.Basic);break;case I:bb=new qx.ui.container.Composite(new qx.ui.layout.Basic);break;case A:bb=new qx.ui.form.Button(this.tr(K));bb.addListener(E,this._onColorSelectorOk,this);break;case x:bb=new qx.ui.form.Button(this.tr(s));bb.addListener(E,this._onColorSelectorCancel,this);break;};return bb||qx.ui.popup.Popup.prototype._createChildControlImpl.call(this,Y);}
,_createBoxes:function(){this.__Jg={};var bd=this._tables;var bg,bc,be;var j=0;for(var bf in bd){bg=bd[bf];bc=new qx.ui.groupbox.GroupBox(bg.label);bc.setLayout(new qx.ui.layout.HBox);this.__Jg[bf]=bc;this.add(bc);for(var i=0;i<this.__Jk;i++ ){be=this.getChildControl(R+(j++ ));be.setBackgroundColor(bg.values[i]||null);bc.add(be);}
;}
;}
,_createColorSelector:function(){if(this.__Ji){return;}
;var bh=new qx.ui.window.Window(this.tr(P));this.__Jh=bh;bh.setLayout(new qx.ui.layout.VBox(16));bh.setResizable(false);bh.moveTo(20,20);this.__Ji=new qx.ui.control.ColorSelector;bh.add(this.__Ji);var bi=new qx.ui.container.Composite(new qx.ui.layout.HBox(8,q));bh.add(bi);var bk=this._createChildControl(x);var bj=this._createChildControl(A);bi.add(bk);bi.add(bj);}
...
;var bq=this._tables[this.__Jj].values;var br=this.__Jg[this.__Jj];if(!bq){return;}
;var bs=this.getValue();if(!bs){return;}
;var bp=bq.indexOf(bs);if(bp!=-1){qx.lang.Array.removeAt(bq,bp);}
else if(bq.length==this.__Jk){bq.shift();}
...
;this.__Ji.setRed(bA);this.__Ji.setGreen(bz);this.__Ji.setBlue(by);this.__Jh.open();}
,_onColorSelectorOk:function(){var bB=this.__Ji;this.setValue(qx.util.ColorUtil.rgbToRgbString([bB.getRed(),bB.getGreen(),bB.getBlue()]));this.__Jh.close();}
,_onColorSelectorCancel:function(){this.__Jh.close();}
,_onChangeVisibility:function(e){if(this.getVisibility()==H){var bF=this.getRed();var bE=this.getGreen();var bC=this.getBlue();var bD=null;if(bF!==null||bE!==null||bC!==null){bD=qx.util.ColorUtil.rgbToRgbString([bF,bE,bC]);}
;this.getChildControl(G).setBackgroundColor(bD);this.getChildControl(I).setBackgroundColor(bD);}
;}
,_tables:{core:{label:qx.locale.Manager.tr(D),values:[b,d,g,v,Q,p,N,y,T,a,l,k]},recent:{label:qx.locale.Manager.tr(F),values:[]}}},destruct:function(){this._disposeObjects(c,X);this._tables=this.__Jg=null;}
});}
)();
