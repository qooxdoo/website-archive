...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController.3fef2ef1fa13.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="modelSelection[0]",c="qx.core.Object",d="qx.debug",e="_applyTarget",f="qx.data.controller.Form",g="changeTarget",h="value",j=" of ",k="Could not bind property ",l=".",m="No target is set.",n="qx.ui.form.Form",o="_applyModel";qx.Class.define(f,{extend:qx.core.Object,construct:function(p,r,q){qx.core.Object.call(this);this._selfUpdate=!!q;this.__Gu={};if(p!=null){this.setModel(p);}
;if(r!=null){this.setTarget(r);}
;}
,properties:{model:{check:c,apply:o,event:a,nullable:true,dereference:true},target:{check:n,apply:e,event:g,nullable:true,init:null,dereference:true}},members:{__Gv:null,__Gu:null,addBindingOptions:function(name,u,v){this.__Gu[name]=[u,v];if(this.getModel()==null||this.getTarget()==null){return;}
;var s=this.getTarget().getItems()[name];var t=this.__Gy(s)?b:h;this.__Gv.removeTarget(s,t,name);this.__Gv.addTarget(s,t,name,!this._selfUpdate,u,v);}
...
;if(this.__Gu[name]&&this.__Gu[name][1]){A=this.__Gu[name][1].converter(A);}
;D[E[i]]=A;}
else {if(!D[E[i]]){D[E[i]]={};}
;D=D[E[i]];}
;}
...
;var F=this.getTarget().getItems();for(var name in F){var I=F[name];var H=this.__Gy(I)?b:h;var G=this.__Gu[name];G=G&&this.__Gu[name][1];qx.data.SingleValueBinding.updateTarget(I,H,this.getModel(),name,G);}
;}
,_applyTarget:function(K,J){if(J!=null){this.__Gx(J);}
;if(this.getModel()==null){return;}
;if(K!=null){this.__Gw();}
;}
,_applyModel:function(N,L){if(this.__Gv!=null&&N==null){this.__Gv.setModel(null);}
;if(this.__Gv!=null){var M=this.getTarget().getItems();for(var name in M){var O=M[name];var P=this.__Gy(O)?b:h;this.__Gv.removeTarget(O,P,name);}
;}
;if(this.__Gv!=null){this.__Gv.setModel(N);}
;if(this.getTarget()==null){return;}
;if(N!=null){this.__Gw();}
;}
,__Gw:function(){if(this.__Gv==null){this.__Gv=new qx.data.controller.Object(this.getModel());}
;var T=this.getTarget().getItems();for(var name in T){var Q=T[name];var R=this.__Gy(Q)?b:h;var S=this.__Gu[name];try{if(S==null){this.__Gv.addTarget(Q,R,name,!this._selfUpdate);}
else {this.__Gv.addTarget(Q,R,name,!this._selfUpdate,S[0],S[1]);}
;}
catch(U){if(qx.core.Environment.get(d)){this.warn(k+name+j+this.getModel());}
;}
;}
;this.getTarget().redefineResetter();}
,__Gx:function(V){if(this.__Gv==null){return;}
;var Y=V.getItems();for(var name in Y){var X=Y[name];var W=this.__Gy(X)?b:h;this.__Gv.removeTarget(X,W,name);}
;}
,__Gy:function(ba){return qx.Class.hasInterface(ba.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(ba.constructor,qx.ui.form.IModelSelection);}
