...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorSelector.3849221b48c2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Cx=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__Cx=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pw?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pw=true;this.__Cx=true;this.setRed(255);this.setGreen(255);this.__Cx=false;this.setBlue(255);}
,__py:function(){if(!this.__Cx){this.__pw=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__Cr===null){this.__Cr=bU;}
;if(this.__Cr!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__Cr!==n){this._setHexFromRgb();}
;switch(this.__Cr){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__py();if(this.__Cr===bU){this.__Cr=null;}
;}
,_applyGreen:function(de,dd){if(this.__Cr===null){this.__Cr=cq;}
;if(this.__Cr!==cK){this.getChildControl(O).setValue(de);}
;if(this.__Cr!==n){this._setHexFromRgb();}
;switch(this.__Cr){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__py();if(this.__Cr===cq){this.__Cr=null;}
;}
,_applyBlue:function(dg,df){if(this.__Cr===null){this.__Cr=d;}
;if(this.__Cr!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__Cr!==n){this._setHexFromRgb();}
;switch(this.__Cr){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__py();if(this.__Cr===d){this.__Cr=null;}
;}
,_applyHue:function(di,dh){if(this.__Cr===null){this.__Cr=cr;}
;if(this.__Cr!==F){this.getChildControl(cu).setValue(di);}
;if(this.__Cr!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__Cr){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__Cr===cr){this.__Cr=null;}
;}
,_applySaturation:function(dk,dj){if(this.__Cr===null){this.__Cr=s;}
;if(this.__Cr!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__Cr!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__Cr){case F:case R:case s:this._setRgbFromHue();};if(this.__Cr===s){this.__Cr=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__Cr===null){this.__Cr=c;}
;if(this.__Cr!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__Cr!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__Cr){case F:case P:case c:this._setRgbFromHue();};if(this.__Cr===c){this.__Cr=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__Ct=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__Cu=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__Ct=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__Ct===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__Cu=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__Ct=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__Cu,0,256);this.__Cr=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__Cr=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__Ct){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__Ct=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__Ct===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__Cv=location.top+(du.height/2)-dv.top;this.__Cw=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__Ct=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__Cv,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__Cw,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__Cr=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__Cr=null;}
,_setRedFromSpinner:function(){if(this.__Cr!==null){return;}
;this.__Cr=cK;this.setRed(this.getChildControl(m).getValue());this.__Cr=null;}
,_setGreenFromSpinner:function(){if(this.__Cr!==null){return;}
;this.__Cr=cK;this.setGreen(this.getChildControl(O).getValue());this.__Cr=null;}
,_setBlueFromSpinner:function(){if(this.__Cr!==null){return;}
;this.__Cr=cK;this.setBlue(this.getChildControl(cG).getValue());this.__Cr=null;}
,_setHueFromSpinner:function(){if(this.__Cr!==null){return;}
;this.__Cr=F;this.setHue(this.getChildControl(cu).getValue());this.__Cr=null;}
,_setSaturationFromSpinner:function(){if(this.__Cr!==null){return;}
;this.__Cr=F;this.setSaturation(this.getChildControl(cx).getValue());this.__Cr=null;}
,_setBrightnessFromSpinner:function(){if(this.__Cr!==null){return;}
;this.__Cr=F;this.setBrightness(this.getChildControl(bT).getValue());this.__Cr=null;}
,_onHexFieldChange:function(e){if(this.__Cr!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__Cr=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__Cr=null;}
...
,_setHueFromRgb:function(){switch(this.__Cr){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__Cr){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
