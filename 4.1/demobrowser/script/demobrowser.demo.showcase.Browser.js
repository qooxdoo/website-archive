...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Browser.0e37aa6a79f5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="__rN",b="qx.ui.window.Manager";qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__rN:null,setDesktop:function(c){this.__rN=c;this.updateStack();}
...
,syncWidget:function(){this.__rN.forceUnblock();var h=this.__rN.getWindows();var g=this._minZIndex;var m=g+h.length*2;var j=g+h.length*4;var k=null;for(var i=0,l=h.length;i<l;i++ ){var f=h[i];if(!f.isVisible()){continue;}
;k=k||f;if(f.isModal()){f.setZIndex(j);this.__rN.blockContent(j-1);j+=2;k=f;}
...
,bringToFront:function(o){var n=this.__rN.getWindows();var p=qx.lang.Array.remove(n,o);if(p){n.push(o);this.updateStack();}
;}
,sendToBack:function(r){var q=this.__rN.getWindows();var s=qx.lang.Array.remove(q,r);if(s){q.unshift(r);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(a);}
});}
)();
(function(){var a="pointerup",b="Boolean",c="losecapture",d="__rP",f="move",g="qx.ui.core.MMovable",h="The move handle could not be redefined!",i="pointerdown",j="maximized",k="pointermove",l="__rO",m="roll",n="move-frame";qx.Mixin.define(g,{properties:{movable:{check:b,init:true},useMoveFrame:{check:b,init:false}},members:{__rO:null,__rP:null,__rQ:null,__rR:null,__rS:null,__rT:null,__rU:null,__rV:false,__rW:null,__rX:0,_activateMoveHandle:function(o){if(this.__rO){throw new Error(h);}
;this.__rO=o;o.addListener(i,this._onMovePointerDown,this);o.addListener(a,this._onMovePointerUp,this);o.addListener(k,this._onMovePointerMove,this);o.addListener(c,this.__sc,this);}
,__rY:function(){var p=this.__rP;if(!p){p=this.__rP=new qx.ui.core.Widget();p.setAppearance(n);p.exclude();qx.core.Init.getApplication().getRoot().add(p);}
;return p;}
,__sa:function(){var location=this.getContentLocation();var r=this.getBounds();var q=this.__rY();q.setUserBounds(location.left,location.top,r.width,r.height);q.show();q.setZIndex(this.getZIndex()+1);}
,__sb:function(e){var t=this.__rQ;var s=Math.max(t.left,Math.min(t.right,e.getDocumentLeft()));var v=Math.max(t.top,Math.min(t.bottom,e.getDocumentTop()));var u=this.__rR+s;var w=this.__rS+v;return {viewportLeft:parseInt(u,10),viewportTop:parseInt(w,10),parentLeft:parseInt(u-this.__rT,10),parentTop:parseInt(w-this.__rU,10)};}
,_onMoveRoll:function(e){e.stop();}
,_onMovePointerDown:function(e){if(!this.getMovable()||this.hasState(j)){return;}
;this.addListener(m,this._onMoveRoll,this);var parent=this.getLayoutParent();var x=parent.getContentLocation();var z=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isBlocked()){this.__rW=parent.getBlockerColor();this.__rX=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__rV=true;}
;}
;this.__rQ={left:x.left,top:x.top,right:x.left+z.width,bottom:x.top+z.height};var y=this.getContentLocation();this.__rT=x.left;this.__rU=x.top;this.__rR=y.left-e.getDocumentLeft();this.__rS=y.top-e.getDocumentTop();this.addState(f);this.__rO.capture();if(this.getUseMoveFrame()){this.__sa();}
;e.stop();}
,_onMovePointerMove:function(e){if(!this.hasState(f)){return;}
;var B=this.__sb(e);if(this.getUseMoveFrame()){this.__rY().setDomPosition(B.viewportLeft,B.viewportTop);}
...
;this.removeState(f);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__rV){parent.unblock();parent.setBlockerColor(this.__rW);parent.setBlockerOpacity(this.__rX);this.__rW=null;this.__rX=0;this.__rV=false;}
;}
;this.__rO.releaseCapture();var D=this.__sb(e);var C=this.getLayoutParent().getInsets();this.setLayoutProperties({left:D.parentLeft-(C.left||0),top:D.parentTop-(C.top||0)});if(this.getUseMoveFrame()){this.__rY().exclude();}
;e.stopPropagation();}
,__sc:function(e){if(!this.hasState(f)){return;}
;this.removeState(f);if(this.getUseMoveFrame()){this.__rY().exclude();}
;}
},destruct:function(){this._disposeObjects(d,l);this.__rQ=null;}
});}
)();
...
(function(){var a="Boolean",b="w-resize",c="touch",d="sw-resize",f="n-resize",g="resizableRight",h="ne-resize",i="se-resize",j="Integer",k="e-resize",l="resizableLeft",m="move",n="shorthand",o="maximized",p="resize",q="nw-resize",r="pointerup",s="pointerdown",t="qx.ui.core.MResizable",u="losecapture",v="resize-frame",w="resizableBottom",x="s-resize",y="pointermove",z="resizableTop",A="pointerout";qx.Mixin.define(t,{construct:function(){var content=this.getContentElement();content.addListener(s,this.__sp,this,true);content.addListener(r,this.__sq,this);content.addListener(y,this.__ss,this);content.addListener(A,this.__st,this);content.addListener(u,this.__sr,this);var B=content.getDomElement();if(B==null){B=window;}
;this.__sd=qx.event.Registration.getManager(B).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:a,init:true},resizableRight:{check:a,init:true},resizableBottom:{check:a,init:true},resizableLeft:{check:a,init:true},resizable:{group:[z,g,w,l],mode:n},resizeSensitivity:{check:j,init:5},useResizeFrame:{check:a,init:true}},members:{__sd:null,__se:null,__sf:null,__sg:null,__sh:null,__si:null,__sj:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var C=this.__se;if(!C){C=this.__se=new qx.ui.core.Widget();C.setAppearance(v);C.exclude();qx.core.Init.getApplication().getRoot().add(C);}
;return C;}
,__sk:function(){var location=this.getContentLocation();var D=this._getResizeFrame();D.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);D.show();D.setZIndex(this.getZIndex()+1);}
,__sl:function(e){var F=this.__sf;var E=this.getSizeHint();var I=this.__sj;var H=this.__si;var J=H.width;var G=H.height;var L=H.left;var top=H.top;var K;if((F&this.RESIZE_TOP)||(F&this.RESIZE_BOTTOM)){K=Math.max(I.top,Math.min(I.bottom,e.getDocumentTop()))-this.__sh;if(F&this.RESIZE_TOP){G-=K;}
else {G+=K;}
;if(G<E.minHeight){G=E.minHeight;}
else if(G>E.maxHeight){G=E.maxHeight;}
;if(F&this.RESIZE_TOP){top+=H.height-G;}
;}
;if((F&this.RESIZE_LEFT)||(F&this.RESIZE_RIGHT)){K=Math.max(I.left,Math.min(I.right,e.getDocumentLeft()))-this.__sg;if(F&this.RESIZE_LEFT){J-=K;}
else {J+=K;}
...
,__sm:{'1':f,'2':x,'4':b,'8':k,'5':q,'6':d,'9':h,'10':i},__sn:function(e){var location=this.getContentLocation();var O=this.getResizeSensitivity();var N=e.getDocumentLeft();var P=e.getDocumentTop();var M=this.__so(location,N,P,O);if(M>0){M=M|this.__so(location,N,P,O*2);}
;this.__sf=M;}
,__so:function(location,T,R,S){var Q=0;if(this.getResizableTop()&&Math.abs(location.top-R)<S&&T>location.left-S&&T<location.right+S){Q+=this.RESIZE_TOP;}
...
;return Q;}
,__sp:function(e){if(!this.__sf||!this.getEnabled()||e.getPointerType()==c){return;}
;this.addState(p);this.__sg=e.getDocumentLeft();this.__sh=e.getDocumentTop();var location=this.getContentLocation();var V=this.getBounds();this.__si={top:location.top,left:location.left,width:location.right-location.left,height:location.bottom-location.top,bounds:qx.lang.Object.clone(V)};var parent=this.getLayoutParent();var W=parent.getContentLocation();var U=parent.getBounds();this.__sj={left:W.left,top:W.top,right:W.left+U.width,bottom:W.top+U.height};if(this.getUseResizeFrame()){this.__sk();}
;this.capture();e.stop();}
,__sq:function(e){if(!this.hasState(p)||!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var X=this.__sl(e);this.setWidth(X.width);this.setHeight(X.height);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:X.parentLeft,top:X.parentTop});}
;this.__sf=0;this.removeState(p);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__sr:function(e){if(!this.__sf){return;}
...
;}
,__ss:function(e){if(!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.hasState(p)){var ba=this.__sl(e);if(this.getUseResizeFrame()){var Y=this._getResizeFrame();Y.setUserBounds(ba.viewportLeft,ba.viewportTop,ba.width,ba.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(o)&&!this.__sd.isSessionActive()){this.__sn(e);var bd=this.__sf;var bc=this.getApplicationRoot();if(bd){var bb=this.__sm[bd];this.setCursor(bb);bc.setGlobalCursor(bb);}
else if(this.getCursor()){this.resetCursor();bc.resetGlobalCursor();}
;}
;}
,__st:function(e){if(e.getPointerType()==c){return;}
;if(this.getCursor()&&!this.hasState(p)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__se!=null&&!qx.core.ObjectRegistry.inShutDown){this.__se.destroy();this.__se=null;}
;this.__sd=null;}
});}
)();
...
;var br=this.getLayoutProperties();this.__sv=br.left===undefined?0:br.left;this.__su=br.top===undefined?0:br.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(F);this._updateCaptionBar();this.fireEvent(Q);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(b,qx.event.type.Event,[false,true])){var bs=this.getLayoutProperties();this.__sv=bs.left===undefined?0:bs.left;this.__su=bs.top===undefined?0:bs.top;this.removeState(F);this.hide();this.fireEvent(v);}
;}
...
;var bt=this.__sv;var top=this.__su;this.setLayoutProperties({edge:null,left:bt,top:top});this.removeState(F);this._updateCaptionBar();this.fireEvent(S);}
;}
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__qp(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__qm.length>0){do {var Q=this.__qm[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__qm.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__qo(Q);G+=I;if(E&&this.__qm.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__qm.length>0);}
;}
,__qo:function(R){R.setVisibility(o);this.__qm.shift();this.fireDataEvent(m,R);}
,__qp:function(S){if(!S){return;}
;this.__qm.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__qn.length-1;i>=0;i-- ){var T=this.__qn[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__qn[W]!=undefined){throw new Error(v);}
;this.__qn[W]=X;}
...
;for(var i=0;i<this.__qm.length;i++ ){this.__qm[i].setVisibility(o);}
;this.__qm=[];}
;}
...
;bf.setVisibility(y);}
;}
,__qq:false,_setAllowMenuOpenHover:function(bg){this.__qq=bg;}
,_isAllowMenuOpenHover:function(){return this.__qq;}
...
(function(){var a="blur",b="Enter",c="Escape",d="Space",f="__qa",g="Left",h="Down",j="Up",k="singleton",l="qx.debug",m="interval",n="roll",o="event.touch",p="Object is no menu: ",q="__qb",r="pointerdown",s="qx.ui.menu.Manager",t="__oF",u="keydown",v="keyup",w="keypress",x="contextmenu",y="Right";qx.Class.define(s,{type:k,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__oF=[];var z=document.body;var A=qx.event.Registration;A.addListener(window.document.documentElement,r,this._onPointerDown,this,true);A.addListener(z,n,this._onRoll,this,true);A.addListener(z,u,this._onKeyUpDown,this,true);A.addListener(z,v,this._onKeyUpDown,this,true);A.addListener(z,w,this._onKeyPress,this,true);if(!qx.core.Environment.get(o)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__qa=new qx.event.Timer();this.__qa.addListener(m,this._onOpenInterval,this);this.__qb=new qx.event.Timer();this.__qb.addListener(m,this._onCloseInterval,this);}
,members:{__qc:null,__qd:null,__qa:null,__qb:null,__oF:null,_getChild:function(B,D,C,G){var F=B.getChildren();var length=F.length;var E;for(var i=D;i<length&&i>=0;i+=C){E=F[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
;if(G){i=i==length?0:length-1;for(;i!=D;i+=C){E=F[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
;}
;return null;}
,_isInMenu:function(H){while(H){if(H instanceof qx.ui.menu.Menu){return true;}
;H=H.getLayoutParent();}
;return false;}
,_isMenuOpener:function(J){var I=this.__oF;for(var i=0;i<I.length;i++ ){if(I[i].getOpener()===J){return true;}
;}
;return false;}
,_getMenuButton:function(K){while(K){if(K instanceof qx.ui.menu.AbstractButton){return K;}
;K=K.getLayoutParent();}
;return null;}
,add:function(L){if(qx.core.Environment.get(l)){if(!(L instanceof qx.ui.menu.Menu)){throw new Error(p+L);}
;}
;var M=this.__oF;M.push(L);L.setZIndex(1e6+M.length);}
,remove:function(N){if(qx.core.Environment.get(l)){if(!(N instanceof qx.ui.menu.Menu)){throw new Error(p+N);}
;}
;var O=this.__oF;if(O){qx.lang.Array.remove(O,N);}
;}
,hideAll:function(){var P=this.__oF;if(P){for(var i=P.length-1;i>=0;i-- ){P[i].exclude();}
;}
;}
,getActiveMenu:function(){var Q=this.__oF;return Q.length>0?Q[Q.length-1]:null;}
,scheduleOpen:function(R){this.cancelClose(R);if(R.isVisible()){if(this.__qc){this.cancelOpen(this.__qc);}
;}
else if(this.__qc!=R){this.__qc=R;this.__qa.restartWith(R.getOpenInterval());}
;}
,scheduleClose:function(S){this.cancelOpen(S);if(!S.isVisible()){if(this.__qd){this.cancelClose(this.__qd);}
;}
else if(this.__qd!=S){this.__qd=S;this.__qb.restartWith(S.getCloseInterval());}
;}
,cancelOpen:function(T){if(this.__qc==T){this.__qa.stop();this.__qc=null;}
;}
,cancelClose:function(U){if(this.__qd==U){this.__qb.stop();this.__qd=null;}
;}
,_onOpenInterval:function(e){this.__qa.stop();this.__qc.open();this.__qc=null;}
,_onCloseInterval:function(e){this.__qb.stop();this.__qd.exclude();this.__qd=null;}
,preventContextMenuOnce:function(){qx.event.Registration.addListener(document.body,x,this.__qe,this,true);}
,__qe:function(e){var V=e.getTarget();V=qx.ui.core.Widget.getWidgetByElement(V,true);if(this._isInMenu(V)){e.stopPropagation();e.preventDefault();}
;qx.event.Registration.removeListener(document.body,x,this.__qe,this,true);}
,_onPointerDown:function(e){var W=e.getTarget();W=qx.ui.core.Widget.getWidgetByElement(W,true);if(W==null){this.hideAll();return;}
;if(W.getMenu&&W.getMenu()&&W.getMenu().isVisible()){return;}
;if(this.__oF.length>0&&!this._isInMenu(W)){this.hideAll();}
;}
,__qf:{"Enter":1,"Space":1},__nA:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var X=this.getActiveMenu();if(!X){return;}
;var Y=e.getKeyIdentifier();if(this.__nA[Y]||(this.__qf[Y]&&X.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var bc=this.getActiveMenu();if(!bc){return;}
;var ba=e.getKeyIdentifier();var be=this.__nA[ba];var bb=this.__qf[ba];if(be){switch(ba){case j:this._onKeyPressUp(bc);break;case h:this._onKeyPressDown(bc);break;case g:this._onKeyPressLeft(bc);break;case y:this._onKeyPressRight(bc);break;case c:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(bb){var bd=bc.getSelectedButton();if(bd){switch(ba){case b:this._onKeyPressEnter(bc,bd,e);break;case d:this._onKeyPressSpace(bc,bd,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
,_onKeyPressUp:function(bj){var bf=bj.getSelectedButton();var bg=bj.getChildren();var bh=bf?bj.indexOf(bf)-1:bg.length-1;var bi=this._getChild(bj,bh,-1,true);if(bi){bj.setSelectedButton(bi);}
else {bj.resetSelectedButton();}
;}
,_onKeyPressDown:function(bk){var bl=bk.getSelectedButton();var bn=bl?bk.indexOf(bl)+1:0;var bm=this._getChild(bk,bn,1,true);if(bm){bk.setSelectedButton(bm);}
else {bk.resetSelectedButton();}
;}
,_onKeyPressLeft:function(bq){var bs=bq.getOpener();if(!bs){return;}
;if(bs instanceof qx.ui.menu.AbstractButton){var bp=bs.getLayoutParent();bp.resetOpenedButton();bp.setSelectedButton(bs);}
else if(bs instanceof qx.ui.menubar.Button){var bt=bs.getMenuBar().getMenuButtons();var bo=bt.indexOf(bs);if(bo===-1){return;}
;var bu=null;var length=bt.length;for(var i=1;i<=length;i++ ){var br=bt[(bo-i+length)%length];if(br.isEnabled()&&br.isVisible()){bu=br;break;}
;}
;if(bu&&bu!=bs){bu.open(true);}
;}
;}
,_onKeyPressRight:function(by){var bw=by.getSelectedButton();if(bw){var bv=bw.getMenu();if(bv){by.setOpenedButton(bw);var bD=this._getChild(bv,0,1);if(bD){bv.setSelectedButton(bD);}
;return;}
;}
else if(!by.getOpenedButton()){var bD=this._getChild(by,0,1);if(bD){by.setSelectedButton(bD);if(bD.getMenu()){by.setOpenedButton(bD);}
;return;}
;}
;var bA=by.getOpener();if(bA instanceof qx.ui.menu.Button&&bw){while(bA){bA=bA.getLayoutParent();if(bA instanceof qx.ui.menu.Menu){bA=bA.getOpener();if(bA instanceof qx.ui.menubar.Button){break;}
;}
else {break;}
;}
;if(!bA){return;}
;}
;if(bA instanceof qx.ui.menubar.Button){var bB=bA.getMenuBar().getMenuButtons();var bx=bB.indexOf(bA);if(bx===-1){return;}
;var bC=null;var length=bB.length;for(var i=1;i<=length;i++ ){var bz=bB[(bx+i)%length];if(bz.isEnabled()&&bz.isVisible()){bC=bz;break;}
;}
;if(bC&&bC!=bA){bC.open(true);}
;}
;}
,_onKeyPressEnter:function(bE,bF,e){if(bF.hasListener(w)){var bG=e.clone();bG.setBubbles(false);bG.setTarget(bF);bF.dispatchEvent(bG);}
;this.hideAll();}
,_onKeyPressSpace:function(bH,bI,e){if(bI.hasListener(w)){var bJ=e.clone();bJ.setBubbles(false);bJ.setTarget(bI);bI.dispatchEvent(bJ);}
;}
,_onRoll:function(e){var bK=e.getTarget();bK=qx.ui.core.Widget.getWidgetByElement(bK,true);if(this.__oF.length>0&&!this._isInMenu(bK)&&!this._isMenuOpener(bK)&&!e.getMomentum()){this.hideAll();}
;}
},destruct:function(){var bM=qx.event.Registration;var bL=document.body;bM.removeListener(window.document.documentElement,r,this._onPointerDown,this,true);bM.removeListener(bL,u,this._onKeyUpDown,this,true);bM.removeListener(bL,v,this._onKeyUpDown,this,true);bM.removeListener(bL,w,this._onKeyPress,this,true);this._disposeObjects(f,q);this._disposeArray(t);}
});}
)();
(function(){var a="Boolean",b="pointerover",c="qx.ui.core.Widget",d="excluded",f="selected",g="Integer",h="slidebar",j="menu",k="visible",l="_applySelectedButton",m="_applySpacingY",n="resize",o="_blocker",p="_applyCloseInterval",q="_applyBlockerColor",r="The menu instance needs a configured 'opener' widget!",s="_applyIconColumnWidth",t="qx.ui.menu.Menu",u="_applyOpenedButton",v="Color",w="Number",x="_applyArrowColumnWidth",y="Unknown target: ",z="_applySpacingX",A="_applyBlockerOpacity",B="Could not open menu instance because 'opener' widget is not visible",C="_applyOpenInterval",D="pointerout";qx.Class.define(t,{extend:qx.ui.core.Widget,include:[qx.ui.core.MPlacement,qx.ui.core.MRemoteChildrenHandling],construct:function(){qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.menu.Layout);var E=this.getApplicationRoot();E.add(this);this.addListener(b,this._onPointerOver);this.addListener(D,this._onPointerOut);this.addListener(n,this._onResize,this);E.addListener(n,this._onResize,this);this._blocker=new qx.ui.core.Blocker(E);this.initVisibility();this.initKeepFocus();this.initKeepActive();}
,properties:{appearance:{refine:true,init:j},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},visibility:{refine:true,init:d},keepFocus:{refine:true,init:true},keepActive:{refine:true,init:true},spacingX:{check:g,apply:z,init:0,themeable:true},spacingY:{check:g,apply:m,init:0,themeable:true},iconColumnWidth:{check:g,init:0,themeable:true,apply:s},arrowColumnWidth:{check:g,init:0,themeable:true,apply:x},blockerColor:{check:v,init:null,nullable:true,apply:q,themeable:true},blockerOpacity:{check:w,init:1,apply:A,themeable:true},selectedButton:{check:c,nullable:true,apply:l},openedButton:{check:c,nullable:true,apply:u},opener:{check:c,nullable:true},openInterval:{check:g,themeable:true,init:250,apply:C},closeInterval:{check:g,themeable:true,init:250,apply:p},blockBackground:{check:a,themeable:true,init:false}},members:{__qg:null,__qh:null,_blocker:null,open:function(){if(this.getOpener()!=null){var F=this.placeToWidget(this.getOpener(),true);if(F){this.__qj();this.show();this._placementTarget=this.getOpener();}
else {this.warn(B);}
;}
else {this.warn(r);}
;}
,openAtPointer:function(e){this.placeToPointer(e);this.__qj();this.show();this._placementTarget={left:e.getDocumentLeft(),top:e.getDocumentTop()};}
,openAtPoint:function(G){this.placeToPoint(G);this.__qj();this.show();this._placementTarget=G;}
...
;this.__qi();}
,__qi:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
;this.removeListener(n,this._onResize,this);bg.getChildrenContainer().addListener(n,this._onResize,this);this._add(bg);break;};return bg||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bi);}
...
,__qj:function(){var bp=this._getMenuBounds();if(!bp){this.addListenerOnce(n,this.__qj,this);return;}
...
else if(top===0){var bm=this._placementTarget;var bn=bm.top||bm.getBounds().top;this._assertSlideBar(function(){this.setHeight(bn);}
);this.moveTo(bq,0);}
...
;this.__qh=br;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bs){this.getChildControl(h);if(this.__qh){this.__qh.call(this);delete this.__qh;}
;}
...
else {throw new Error(y+bt);}
;this.__qj();}
;}
,_onPointerOver:function(e){var bv=qx.ui.menu.Manager.getInstance();bv.cancelClose(this);var bw=e.getTarget();if(bw.isEnabled()&&bw instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bw);var bu=bw.getMenu&&bw.getMenu();if(bu){bu.setOpener(bw);bv.scheduleOpen(bu);this.__qg=bu;}
else {var bx=this.getOpenedButton();if(bx){bv.scheduleClose(bx.getMenu());}
;if(this.__qg){bv.cancelOpen(this.__qg);this.__qg=null;}
;}
;}
...
;if(this.__qg){by.cancelOpen(this.__qg);}
;}
;}
},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){qx.ui.menu.Manager.getInstance().remove(this);}
;this.getApplicationRoot().removeListener(n,this._onResize,this);this._placementTarget=null;this._disposeObjects(o);}
});}
)();
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__qk:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__qk=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__qk||null;}
...
;return [C,D,E,I];}
,_onTap:function(e){if(e.isLeftPressed()){this.execute();qx.ui.menu.Manager.getInstance().hideAll();}
else {if(!this.getContextMenu()){qx.ui.menu.Manager.getInstance().preventContextMenuOnce();}
;}
;}
...
;var x=this.__ql(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__ql:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
(function(){var a="hovered",b="hover-button",c="pointerover",d="interval",f="__ef",g="qx.ui.form.HoverButton",h="Integer",i="pointerout";qx.Class.define(g,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(c,this._onPointerOver,this);this.addListener(i,this._onPointerOut,this);this.__ef=new qx.event.AcceleratingTimer();this.__ef.addListener(d,this._onInterval,this);}
,properties:{appearance:{refine:true,init:b},interval:{check:h,init:80},firstInterval:{check:h,init:200},minTimer:{check:h,init:20},timerDecrease:{check:h,init:2}},members:{__ef:null,_onPointerOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__ef.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(a);}
,_onPointerOut:function(e){this.__ef.stop();this.removeState(a);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
;}
,properties:{appearance:{refine:true,init:b}},members:{_onTap:function(e){if(e.isLeftPressed()&&this.getMenu()){this.execute();this.getMenu().open();return;}
;qx.ui.menu.AbstractButton.prototype._onTap.call(this,e);}
}});}
)();
...
,__qr:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
...
;this._getIframeElement().addListener(h,this.__Cy,this);}
...
,__Cy:function(e){var r=e.getData();if(r){this.setSource(r);}
;this.fireDataEvent(h,r);}
}});}
)();
(function(){var a="no",b="Boolean",c="px",d="event.help",f="gecko",g="auto",h="_applyScrollbar",i="Unable to set 'nativeHelp' property, possibly due to security restrictions",j="qx.debug",k="DOMNodeInserted",l="load",m="_applyNativeHelp",n="yes",o="scrolling",p="/",q="help",r="pointerup",s="appear",t="pointerdown",u="engine.name",v="block",w="qx.ui.embed.Iframe",x="losecapture",y="contextmenu",z="none",A="iframe",B="__CC",C="display";qx.Class.define(w,{extend:qx.ui.embed.AbstractIframe,construct:function(D){if(D!=null){this.__CB=D;}
;qx.ui.embed.AbstractIframe.call(this,D);qx.event.Registration.addListener(document.body,t,this.block,this,true);qx.event.Registration.addListener(document.body,r,this.release,this,true);qx.event.Registration.addListener(document.body,x,this.release,this,true);this.__CC=this._createBlockerElement();if((qx.core.Environment.get(u)==f)){this.addListenerOnce(s,function(e){var E=this.getContentElement().getDomElement();qx.bom.Event.addNativeListener(E,k,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:A},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:b,init:false,apply:m},scrollbar:{check:[g,a,n],nullable:true,themeable:true,apply:h}},members:{__CB:null,__CC:null,renderLayout:function(J,top,H,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,J,top,H,F);var I=c;var G=this.getInsets();this.__CC.setStyles({"left":(J+G.left)+I,"top":(top+G.top)+I,"width":(H-G.left-G.right)+I,"height":(F-G.top-G.bottom)+I});}
,_createContentElement:function(){var K=new qx.html.Iframe(this.__CB);K.addListener(l,this._onIframeLoad,this);return K;}
...
,block:function(){this.__CC.setStyle(C,v);}
,release:function(){this.__CC.setStyle(C,z);}
...
,setLayoutParent:function(parent){qx.ui.embed.AbstractIframe.prototype.setLayoutParent.call(this,parent);if(parent){this.getLayoutParent().getContentElement().add(this.__CC);}
;}
},destruct:function(){if(this.getLayoutParent()&&this.__CC.getParent()){this.getLayoutParent().getContentElement().remove(this.__CC);}
...
(function(){var a="source",b="element",c="name",d="qx.event.type.Event",f="iframe",g="qx.html.Iframe",h="navigate",i="qx.event.type.Data";qx.Class.define(g,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,f,k,l);this.setSource(j);this.addListener(h,this.__Cy,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(b);}
...
;}
,__Cy:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
...
;return d;}
,__op:function(I){var H=function(){qx.bom.Event.removeNativeListener(I,j,H);I.$$url=qx.bom.Iframe.queryCurrentUrl(I);}
