...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Selection","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Selection.a2c5b4a05225.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="text",b="getEnd",c="margin: 4px 0px",d="demobrowser.demo.bom.Selection",f="getEndSelectionDocument",g="div",h="getSelectionInput",i="this is a test",j="button",k="setSelectionInput",l="results",m="width:300px;height:250px",n="getStartSelectionDocument",o="setSelectionDocument",p="textarea",q="margin-right: 8px",r="border:1px solid darkgrey;",s="test\ntest2\ntest3\ntest4\ntest5",t="<strong>Results</strong>",u="background-color: lightgrey",v="getStart",w="test test2 test3 test4 test5 test6",x="container",y="textfield",z="position:relative;padding:20px",A="width:20%;margin-right:10px",B="margin-bottom:20px",C="width:500px;height:200px;",D="areaContainer",E="textContainer",F="test text",G="setSelectionTextarea",H="inputContainer",I="width:100%;margin-bottom:20px",J="<br/>",K="plaintext",L="getSelectionDocument",M="tap",N="getSelectionTextarea",O="textBlock",P="margin: 4px";qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var T=qx.dom.Element.create(g,{id:x,style:z});var bj=qx.dom.Element.create(g,{id:E,style:I});qx.dom.Element.insertEnd(bj,T);var bd=qx.dom.Element.create(g,{id:O,style:B});bd.innerHTML=w;qx.dom.Element.insertEnd(bd,bj);var bg=qx.bom.Input.create(j,{value:L,style:P});qx.bom.Element.addListener(bg,M,this._getSelection,document);qx.dom.Element.insertEnd(bg,bj);var W=qx.bom.Input.create(j,{value:o,style:P});qx.bom.Element.addListener(W,M,function(e){qx.bom.Selection.set(document.getElementById(K).firstChild,0,4);this.debug(qx.bom.Selection.getLength(document));}
,this);qx.dom.Element.insertEnd(W,bj);var X=qx.bom.Input.create(j,{value:n,style:P});qx.bom.Element.addListener(X,M,this._getStart,document);qx.dom.Element.insertEnd(X,bj);var R=qx.bom.Input.create(j,{value:f,style:P});qx.bom.Element.addListener(R,M,this._getEnd,document);qx.dom.Element.insertEnd(R,bj);var V=qx.dom.Element.create(g,{id:H,style:I});qx.dom.Element.insertEnd(V,T);this._input=qx.bom.Input.create(a,{id:y,value:F,style:A});qx.dom.Element.insertEnd(this._input,V);var ba=qx.bom.Input.create(j,{value:h,style:q});qx.bom.Element.addListener(ba,M,this._getSelection,this._input);qx.dom.Element.insertEnd(ba,V);var bh=qx.bom.Input.create(j,{value:k,style:q});qx.bom.Element.addListener(bh,M,this._setSelection,this._input);qx.dom.Element.insertEnd(bh,V);var be=qx.bom.Input.create(j,{value:v,style:q});qx.bom.Element.addListener(be,M,this._getStart,this._input);qx.dom.Element.insertEnd(be,V);var bk=qx.bom.Input.create(j,{value:b,style:q});qx.bom.Element.addListener(bk,M,this._getEnd,this._input);qx.dom.Element.insertEnd(bk,V);var S=qx.dom.Element.create(g,{id:D,style:I});qx.dom.Element.insertEnd(S,T);this._textArea=qx.bom.Input.create(p,{id:p,rows:7,cols:20,value:s,style:m});qx.dom.Element.insertEnd(this._textArea,S);var bf=qx.bom.Input.create(j,{value:N,style:q});qx.bom.Element.addListener(bf,M,this._getSelection,this._textArea);qx.dom.Element.insertEnd(bf,S);var Y=qx.bom.Input.create(j,{value:G,style:q});qx.bom.Element.addListener(Y,M,this._setSelection,this._textArea);qx.dom.Element.insertEnd(Y,S);var Q=qx.bom.Input.create(j,{value:v,style:q});qx.bom.Element.addListener(Q,M,this._getStart,this._textArea);qx.dom.Element.insertEnd(Q,S);var bi=qx.bom.Input.create(j,{value:b,style:q});qx.bom.Element.addListener(bi,M,this._getEnd,this._textArea);qx.dom.Element.insertEnd(bi,S);var bb=qx.dom.Element.create(g,{style:c});bb.innerHTML=t;var U=qx.dom.Element.create(g,{id:l,style:C+r+u});qx.dom.Element.insertEnd(bb,T);qx.dom.Element.insertEnd(U,T);var bc=qx.dom.Element.create(g,{id:K});bc.innerHTML=i;qx.dom.Element.insertEnd(bc,document.body);qx.dom.Element.insertEnd(T,document.body);}
,_getSelection:function(e){document.getElementById(l).innerHTML=qx.bom.Selection.get(this)+J+qx.bom.Selection.getLength(this);}
,_getStart:function(e){document.getElementById(l).innerHTML=qx.bom.Selection.getStart(this);}
,_getEnd:function(e){document.getElementById(l).innerHTML=qx.bom.Selection.getEnd(this);}
,_setSelection:function(e){qx.bom.Selection.set(this,0,7);}
},destruct:function(){this._input=this._textArea=null;}
});}
)();
