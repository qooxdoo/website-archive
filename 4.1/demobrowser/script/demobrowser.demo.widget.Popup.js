...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Popup.347238c6ad9f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="#FFFAD3",b="#DFFAD3",c="Open Popup #2",d="icon/32/apps/media-photo-album.png",f="pointerdown",g="top-right",h="Open Popup #1",i="demobrowser.demo.widget.Popup",j="Hello World #1";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.layout.HBox();k.setSpacing(20);var l=new qx.ui.container.Composite(k).set({padding:20});this.getRoot().add(l);l.add(this._getPopupButton1());l.add(this._getPopupButton2());}
,_getPopupButton1:function(){var m=new qx.ui.form.Button(h);var n=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:a,padding:[2,4],offset:3,offsetBottom:20});n.add(new qx.ui.basic.Atom(j,d));m.addListener(f,function(e){n.placeToPointer(e);n.show();}
,this);return m;}
,_getPopupButton2:function(){var o=new qx.ui.form.Button(c);var p=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:b,padding:[2,4],offset:3,position:g});p.add(new qx.ui.basic.Atom(j,d));o.addListener(f,function(e){p.placeToPointer(e);p.show();}
,this);return o;}
}});}
)();
