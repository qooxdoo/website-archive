...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection.7a32920c62d8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__dO=qx.bom.Stylesheet.createElement(p);this.__BJ={};this.__mw={};}
,members:{__dO:null,__BJ:null,__mw:null,getStylesheet:function(){return this.__dO;}
,getCssClass:function(q){return this.__BJ[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__mw[r];if(!s){var s=this.__BK();qx.bom.Stylesheet.addRule(this.__dO,k+s,r);this.__mw[r]=s;}
;this.__BJ[t]=s;return s;}
,__BK:function(){return e+this.toHashCode()+a+(this.__BL++ );}
,__BL:0},destruct:function(){this.__dO=this.__BJ=this.__mw=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dO=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__BM={};this.__BN={};this.__BO={};this.__BP={};this.__jv={};this.__BQ={};this.initAppearance();this.__BU();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__BR:null,__BS:null,__jv:null,__BQ:null,__BN:null,__BM:null,__BO:null,__BP:null,__BT:false,__dO:null,__BU:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__BR=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__BR.push(N);}
;}
;O=O.superclass;}
;}
...
,getCssClasses:function(br,bp){var bq=this.__dO.getCssClass(this.__BS)||t;return v+bq;}
,__BV:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__BS==bt){return;}
;this.__BS=bt;var bv=this.__jv[this.__BS];if(!bv){this.__BW();this.__BX(bs);this.__BY(bs);this.__Ca();this.__jv[this.__BS]=1;}
;this.__Cb();}
...
;}
;this.__BT=false;}
,__BY:function(){var bD=qx.lang.Object.getValues(this.__BN).join(I);this.__dO.computeClassForStyles(this.__BS,bD);}
...
},destruct:function(){this.__dO=this.__BM=this.__BN=this.__BO=this.__BP=this.__jv=this.__BQ=this.__BR=null;}
});}
)();
