...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.950eb12ee718.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Qp:4,__Qq:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Qq/this.__Qp),column:this.__Qq%this.__Qp});this.__Qq+=1;}
