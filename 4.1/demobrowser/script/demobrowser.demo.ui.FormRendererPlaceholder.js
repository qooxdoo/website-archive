...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererPlaceholder.8882f6ab9430.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Name",b="Registration",c="demobrowser.demo.ui.FormRendererPlaceholder",d="Send",e="send...",f="Bio",g="Country",h="Personal Information",i="Password",j="Reset",k="execute";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var m=new qx.ui.form.Form();m.addGroupHeader(b);var l=new qx.ui.form.TextField();l.setRequired(true);m.add(l,a);var q=new qx.ui.form.PasswordField();q.setRequired(true);m.add(q,i);m.addGroupHeader(h);m.add(new qx.ui.form.TextField(),g);m.add(new qx.ui.form.TextArea(),f);var o=new qx.ui.form.Button(d);o.addListener(k,function(){if(m.validate()){alert(e);}
;}
,this);m.addButton(o);var n=new qx.ui.form.Button(j);n.addListener(k,function(){m.reset();}
...
,members:{__vC:null,__vD:null,__gy:null,__vE:null,validate:function(c,e,d,f){this.__vE=false;this.__vD=c;this.__gy=d;this.__vC.call(f||this,this,e);}
,validateForm:function(g,h,i){this.__vE=true;this.__gy=h;this.__vC.call(i,g,this);}
,setValid:function(k,j){if(this.__vE){if(j!==undefined){this.__gy.setInvalidMessage(j);}
;this.__gy.setFormValid(k);}
else {if(j!==undefined){this.__vD.setInvalidMessage(j);}
;this.__gy.setItemValid(this.__vD,k);}
;}
},destruct:function(){this.__gy=this.__vD=null;}
});}
)();
...
(function(){var a="The given item has not been added.",b="qx.ui.form.Resetter",c=" not supported for reseting.",d="Item ";qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__mc=[];}
,members:{__mc:null,add:function(e){if(this._supportsValue(e)){var f=e.getValue();}
else if(this.__vz(e)){var f=e.getSelection();}
else if(this.__vH(e)){var f=e.getSelection().concat();}
else {throw new Error(d+e+c);}
;this.__mc.push({item:e,init:f});}
,remove:function(g){for(var i=0;i<this.__mc.length;i++ ){var h=this.__mc[i];if(h.item===g){this.__mc.splice(i,1);return true;}
;}
;return false;}
,reset:function(){for(var i=0;i<this.__mc.length;i++ ){var j=this.__mc[i];this.__vF(j.item,j.init);}
;}
,resetItem:function(k){var l;for(var i=0;i<this.__mc.length;i++ ){var m=this.__mc[i];if(m.item===k){l=m.init;break;}
;}
...
;}
,redefine:function(){for(var i=0;i<this.__mc.length;i++ ){var p=this.__mc[i].item;this.__mc[i].init=this.__vG(p);}
;}
,redefineItem:function(q){var r;for(var i=0;i<this.__mc.length;i++ ){if(this.__mc[i].item===q){r=this.__mc[i];break;}
;}
...
(function(){var a="Only widgets with placeholders supported.",b="qx.ui.form.renderer.SinglePlaceholder";qx.Class.define(b,{extend:qx.ui.form.renderer.Single,implement:qx.ui.form.renderer.IFormRenderer,members:{addItems:function(c,d,e){if(e!=null){this._add(this._createHeader(e),{row:this._row,column:0,colSpan:2});this._row++ ;}
;for(var i=0;i<c.length;i++ ){if(c[i].setPlaceholder===undefined){throw new Error(a);}
