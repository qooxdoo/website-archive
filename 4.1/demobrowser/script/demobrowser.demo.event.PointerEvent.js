...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.PointerEvent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.PointerEvent.00eea8f09427.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__OT=f+p.join(c)+a;this.__OU=o||50;this.__OV=n;this._clearLog();}
,_clearLog:function(){this.__OV.innerHTML=this.__OT+k;this.__OW=[];}
,_log:function(q){this.__OW.unshift(q);this.__OW=this.__OW.slice(0,this.__OU);var r=[this.__OT];for(var i=0;i<this.__OW.length;i++ ){r.push(g,this.__OW[i].join(e),l);}
;r.push(k);this.__OV.innerHTML=r.join(d);this.__OV.scrollTop=0;}
,__OT:null,__OU:null,__OV:null,__OW:null},destruct:function(){this.__OV=this.__OW=null;}
});}
)();
...
;qx.bom.Element.addListener(I,k,this.__OX,this);}
...
,this);}
,__OX:function(e){var O=e.getTarget().id.split(u)[1];var M=e.getTarget().checked;var N=document.getElementById(n);if(M){qx.bom.Element.addListener(N,O,this.logPointerEvent,this);}
