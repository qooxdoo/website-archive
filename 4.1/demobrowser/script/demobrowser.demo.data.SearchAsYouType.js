...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.d722a98452c2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__tO=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__uw=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__uw:null,__tO:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__uw!=null){i.stop(this.__uw);this.__uw=null;}
;this.__uw=i.start(function(){this.__tO.update();this.__uw=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__tO=null;}
});}
)();
