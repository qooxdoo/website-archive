...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop.d725f5ee9203.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
);G.addListener(b,function(e){var bf=e.getOriginalTarget();if(bf instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__PI=bf;}
...
;}
);G.addListener(g,function(e){this.__PJ(e.getOriginalTarget(),e.getDragTarget());}
,this);H.addListener(g,function(e){this.__PJ(this.__PI);}
,this);}
,__PJ:function(bi,bg){if(bi.classname!=n){return;}
