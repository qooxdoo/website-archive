...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.ElementResize.73f997a9bf98.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.event.ElementResize",b="resize",c="width: ",d="px",f="px<br>height: ";qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var g=document.getElementById(b);qx.bom.Element.addListener(g,b,this._onResize,this);this.update(g,g.offsetWidth,g.offsetHeight);}
,_onResize:function(e){var h=e.getData();this.update(e.getTarget(),h.width,h.height);}
,update:function(i,j,k){i.innerHTML=c+j+f+k+d;}
}});}
)();
(function(){var a="resize",b="interval",c="__ef",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__gy=g;this.__zy={};this.__ef=new qx.event.Timer(200);this.__ef.addListener(b,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__zy:null,__gy:null,__ef:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__zy;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__ef.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__zy;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__ef.stop();}
;}
;}
,_onInterval:function(e){var u=this.__zy;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,a,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__gy=this.__zy=null;this._disposeObjects(c);}
