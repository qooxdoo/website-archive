...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns.88868b89c4a1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,syncWidget:function(bD){if(this.__jd._fullUpdate){this._fullUpdate();}
else if(this.__jd._updateScrollPosition){this._updateScrollPosition();}
;this.__jd={};}
...
;this.__wL={top:bU,bottom:bQ,left:bS,right:bI};this.__wM.setUserBounds((this.getPaddingLeft()||0)+(this.__wL.left-this.__wI),(this.getPaddingTop()||0)+(this.__wL.top-this.__wH),bO,bM);this.__qk=bH;this.__wP=bR;for(var i=0;i<this.__wN.length;i++ ){var bG=this.__wN[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
...
;}
,fullUpdate:function(){this.__jd._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__jd._fullUpdate;}
...
,_deferredUpdateScrollPosition:function(){this.__jd._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
...
;this.__wS();}
},destruct:function(){this._disposeArray(b);this._disposeObjects(h,w,x);this.__wL=this.__jd=this.__qk=this.__wP=null;}
});}
)();
...
(function(){var a="one",b="Boolean",c="qx.ui.virtual.selection.MModel",d="qx.data.Array",f="multi",g="selected",h="_applySelection",j="change",k="_applyDragSelection",l="single",m="_applyQuickSelection",n="changeSelection",o="_applySelectionMode",p="additive",q="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this._initSelectionManager();this.__wu=new qx.data.Array();this.initSelection(this.__wu);}
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__wX:false,__wY:false,__wu:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
,_onChangeSelection:function(e){if(this.__wY==true){return;}
;this.__wX=true;var G=this.getSelection();var I=[];for(var i=0;i<G.getLength();i++ ){var H=G.getItem(i);var J=this._getSelectables();var F=-1;if(J!=null){F=J.indexOf(H);}
...
;this.__wz();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__wX=false;}
,_onManagerChangeSelection:function(e){if(this.__wX==true){return;}
;this.__wY=true;this.__wz();this.__wY=false;}
,__wz:function(){if(this.__xb()){return;}
;var M=this._manager.getSelection();var N=[];for(var i=0;i<M.length;i++ ){var O=this._getDataFromRow(M[i]);if(O!=null){N.push(O);}
;}
;this.__xa(N);}
,__xa:function(R){var Q=this.getSelection();if(R.length>0){var P=[0,Q.getLength()];P=P.concat(R);var S=Q.splice.apply(Q,P);S.dispose();}
else {Q.removeAll();}
;}
,__xb:function(){var U=this.getSelection();var W=this._manager.getSelection();if(U.getLength()!==W.length){return false;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__wu){this.__wu.dispose();}
;}
});}
)();
...
,openNodeAndParents:function(bk){this.__Db(this.getModel(),bk);this.buildLookupTable();}
...
,_init:function(){this.__xd=new qx.data.Array();this.__CU=[];this.__CV=[];this._initLayer();}
...
,this);}
,getLookupTable:function(){return this.__xd;}
,_reverseLookup:function(bp){return bp;}
,_getDataFromRow:function(bq){return this.__xd.getItem(bq);}
,_getSelectables:function(){return this.__xd;}
...
;}
;bQ.addListener(J,this._onChangeBubble,this);this.__Da(bQ);}
...
;}
;if(this.__xd.indexOf(bV)!=-1){this.__CX();}
;}
;}
,_onUpdated:function(event){if(this.__hh==null){this.__hh=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__hh.schedule();}
,_onOpen:function(event){var ca=event.getRow();var bY=this.__xd.getItem(ca);if(this.isNode(bY)){if(this.isNodeOpen(bY)){this.closeNode(bY);}
...
;break;};}
;}
,_beforeApplySelection:function(cg){if(cg.length===0&&this.getSelectionMode()===g){var cf=this.__Dd();var ch=this.getLookupTable().indexOf(cf);if(ch>=0){cg.push(ch);}
;}
;}
,_afterApplySelection:function(){var ci=this.getSelection();if(ci.getLength()>0&&this.getSelectionMode()===g){this.__Dc(ci.getItem(0));}
else {this.__CW=[];}
;}
...
;}
;if(!qx.lang.Array.equals(this.__xd.toArray(),cm)){this._provider.removeBindings();this.__xd.removeAll();this.__xd.append(cm);this.__xj();this._updateSelection();}
;}
...
,__Da:function(cw){if(!qx.lang.Array.contains(this.__CU,cw)){this.__CU.push(cw);this.fireDataEvent(t,cw);}
;}
,__Db:function(cx,cy){if(cx===cy){this.__Da(cy);return true;}
;if(!this.isNode(cx)){return false;}
;var cB=cx.get(this.getChildProperty());if(cB==null){return false;}
;for(var i=0;i<cB.getLength();i++ ){var cA=cB.getItem(i);var cz=this.__Db(cA,cy);if(cz===true){this.__Da(cA);return true;}
;}
;return false;}
,__xj:function(){this.getPane().getRowConfig().setItemCount(this.__xd.getLength());this.getPane().fullUpdate();}
,getParent:function(cD){var cE=this.__xd.indexOf(cD);if(cE<0){return null;}
;var cF=this.__CV[cE];while(cE>0){cE-- ;var cC=this.__CV[cE];if(cC<cF){return this.__xd.getItem(cE);}
;}
;return null;}
,__Dc:function(cG){this.__CW=[];var parent=this.getParent(cG);while(parent!=null){this.__CW.unshift(parent);parent=this.getParent(parent);}
;}
,__Dd:function(){if(this.__CW==null){return this.getModel();}
...
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__hh!=null){this.__hh.cancel();this.__hh.dispose();}
;var cI=this.getModel();if(cI!=null){cI.removeListener(J,this._onChangeBubble,this);}
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__xd.dispose();this._layer=this._provider=this.__xd=this.__CU=this.__hh=null;}
});}
)();
...
(function(){var a="BindingIds",b="model",c="",d="changeDelegate",f="virtual-tree-file",g="label",h="appearance",i="icon",j="bindItem",k=".length",l="]",m="virtual-tree-folder",n="[",o=".",p="String",q="qx.ui.tree.core.MWidgetController";qx.Mixin.define(q,{construct:function(){this.__xw=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:p,nullable:true},delegate:{event:d,init:null,nullable:true}},members:{__xw:null,bindDefaultProperties:function(r,s){this.bindProperty(c,b,null,r,s);this.bindProperty(this.getLabelPath(),g,this.getLabelOptions(),r,s);try{this.bindProperty(this.getChildProperty()+k,h,{converter:function(){return m;}
},r,s);}
catch(t){r.setAppearance(f);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),i,this.getIconOptions(),r,s);}
;}
,bindProperty:function(x,A,y,w,u){var z=this.__xx(u,x);var v=this._tree.getLookupTable();var B=v.bind(z,w,A,y);this.__xy(w,B);}
,bindPropertyReverse:function(I,E,G,H,C){var F=this.__xx(C,I);var D=this._tree.getLookupTable();var J=H.bind(E,D,F,G);this.__xy(H,J);}
,removeBindings:function(){while(this.__xw.length>0){var K=this.__xw.pop();this._removeBindingsFrom(K);}
;}
...
;}
,_removeBindingsFrom:function(O){var P=this.__xz(O);while(P.length>0){var Q=P.pop();try{this._tree.getLookupTable().removeBinding(Q);}
catch(e){O.removeBinding(Q);}
;}
;if(qx.lang.Array.contains(this.__xw,O)){qx.lang.Array.remove(this.__xw,O);}
;}
,__xx:function(S,T){var R=n+S+l;if(T!=null&&T!=c){R+=o+T;}
;return R;}
,__xy:function(V,W){var U=this.__xz(V);if(!qx.lang.Array.contains(U,W)){U.push(W);}
;if(!qx.lang.Array.contains(this.__xw,V)){this.__xw.push(V);}
;}
,__xz:function(X){var Y=X.getUserData(a);if(Y==null){Y=[];X.setUserData(a,Y);}
;return Y;}
...
;var o=this._renderer.getCellWidget();o.setOpen(p&&this._tree.isNodeOpen(s));o.addListener(a,this.__De,this);o.setUserData(b,this.getChildProperty());o.setUserData(g,this._tree.isShowLeafs());if(this._tree.getSelection().contains(s)){this._styleSelectabled(o);}
...
,poolCellWidget:function(u){u.removeListener(a,this.__De,this);this._removeBindingsFrom(u);this._renderer.pool(u);this._onPool(u);}
...
,__De:function(event){var K=event.getTarget();var L=K.getUserData(k);var J=this._tree.getLookupTable().getItem(L);if(event.getData()){this._tree.openNodeWithoutScrolling(J);}
...
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__jd={};}
,properties:{anonymous:{refine:true,init:true}},members:{__jd:null,__bI:null,__xp:null,__xq:null,__wP:null,__qk:null,getFirstRow:function(){return this.__xp;}
,getFirstColumn:function(){return this.__xq;}
,getRowSizes:function(){return this.__wP||[];}
,getColumnSizes:function(){return this.__qk||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jd.fullUpdate||this.__jd.updateLayerWindow&&this.__jd.updateLayerData){this._fullUpdate.apply(this,this.__bI);}
else if(this.__jd.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bI);}
else if(this.__jd.updateLayerData&&this.__wP){this._updateLayerData();}
;if(this.__jd.fullUpdate||this.__jd.updateLayerWindow){var d=this.__bI;this.__xp=d[0];this.__xq=d[1];this.__wP=d[2];this.__qk=d[3];}
;this.__jd={};}
,_updateLayerData:function(){this._fullUpdate(this.__xp,this.__xq,this.__wP,this.__qk);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__jd.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bI=arguments;this.__jd.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bI=arguments;this.__jd.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jd=this.__bI=this.__wP=this.__qk=null;}
});}
)();
...
;this._cellProvider=h;this.__xC=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__xC:null,getRenderedCellWidget:function(q,n){if(this._getChildren().length===0){return null;}
...
;}
,_getSpacer:function(){var r=this.__xC.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(B,v,A,z){var C=this._cellProvider;var H=this._getChildren().concat();for(var i=0;i<H.length;i++ ){var F=H[i];if(F.getUserData(g)){this.__xC.push(F);}
...
;}
;}
;var L=this._cellProvider;var P=this._getChildren().concat();for(var i=0;i<P.length;i++ ){if(!bb[i]){var W=P[i];if(W.getUserData(g)){this.__xC.push(W);}
...
;this._cellProvider=this.__xC=null;}
});}
)();
...
(function(){var a="created",b="qx.ui.virtual.cell.AbstractWidget",c="cell.states",d="abstract method call",e="qx.event.type.Data";qx.Class.define(b,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){qx.core.Object.call(this);this.__cN=[];}
,events:{"created":e},members:{__cN:null,_createWidget:function(){throw new Error(d);}
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__xD();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cN.push(p);}
,_cleanupPool:function(){var q=this.__cN.pop();while(q){q.destroy();q=this.__cN.pop();}
;}
,__xD:function(){var r=this.__cN.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
},destruct:function(){this._cleanupPool();this.__cN=null;}
});}
)();
...
},members:{__tB:null,__tC:function(z){return Object.keys(z).sort().join(a);}
,toClass:function(A,B){this.__tD(A,B,null,0);}
,__tD:function(N,I,C,K){if(!qx.lang.Type.isObject(N)||!!N.$$isString||N instanceof qx.core.Object){if(N instanceof Array||qx.Bootstrap.getClass(N)==h){for(var i=0;i<N.length;i++ ){this.__tD(N[i],I,C+o+i+m,K+1);}
;}
;return;}
;var E=this.__tC(N);if(this.__tH(E,C,K)){return;}
;for(var M in N){this.__tD(N[M],I,M,K+1);}
;if(qx.Class.isDefined(s+E)){return;}
;if(this.__tB&&this.__tB.getModelClass&&this.__tB.getModelClass(E,N,C,K)!=null){return;}
;var O={};var F={__tE:this.__tE};for(var M in N){if(this.__tB&&this.__tB.getPropertyMapping){M=this.__tB.getPropertyMapping(M,E);}
...
;if(this.__tB&&this.__tB.getValidationRule){var H=this.__tB.getValidationRule(E,M);if(H){O[M].validate=k+M;F[k+M]=H;}
;}
;}
;if(this.__tB&&this.__tB.getModelSuperClass){var L=this.__tB.getModelSuperClass(E,C,K)||qx.core.Object;}
else {var L=qx.core.Object;}
;var G=[];if(this.__tB&&this.__tB.getModelMixins){var J=this.__tB.getModelMixins(E,C,K);if(!qx.lang.Type.isArray(J)){if(J!=null){G=[J];}
;}
else {G=J;}
;}
;if(I){G.push(qx.data.marshal.MEventBubbling);}
;var D={extend:L,include:G,properties:O,members:F,destruct:this.__tF};qx.Class.define(s+E,D);}
,__tF:function(){var P=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var Q in P){this.__tE(this.get(P[Q].name));}
;}
,__tE:function(R){if(!(R instanceof qx.core.Object)){return;}
;if(R.isDisposed()){return;}
;R.dispose();}
,__tG:function(S,W,X,V){var Y;if(this.__tB&&this.__tB.getModelClass){Y=this.__tB.getModelClass(S,W,X,V);}
;if(Y!=null){return (new Y());}
else {var U=s+S;var T=qx.Class.getByName(U);if(!T){throw new Error(b+U+l);}
;return (new T());}
;}
,__tH:function(ba,bd,bb){var bc=this.__tB;return bc&&bc.ignore&&bc.ignore(ba,bd,bb);}
,toModel:function(be){return this.__tI(be,null,0);}
,__tI:function(bq,bg,bm){var bk=qx.lang.Type.isObject(bq);var bf=bq instanceof Array||qx.Bootstrap.getClass(bq)==h;if((!bk&&!bf)||!!bq.$$isString||bq instanceof qx.core.Object){return bq;}
else if(this.__tH(this.__tC(bq),bg,bm)){return bq;}
else if(bf){var bo=qx.data.Array;if(this.__tB&&this.__tB.getArrayClass){var bl=this.__tB.getArrayClass(bg,bm);bo=bl||bo;}
;var br=new bo();br.setAutoDisposeItems(true);for(var i=0;i<bq.length;i++ ){br.push(this.__tI(bq[i],bg+o+i+m,bm+1));}
;return br;}
else if(bk){var bh=this.__tC(bq);var bp=this.__tG(bh,bq,bg,bm);for(var bn in bq){var bi=bn;if(this.__tB&&this.__tB.getPropertyMapping){bi=this.__tB.getPropertyMapping(bn,bh);}
;var bs=bi.replace(/-|\.|\s+/g,d);if((qx.core.Environment.get(t))&&qx.core.Environment.get(e)){if(bs!=bi){this.warn(c+bn+n+bi+v);}
;}
;bi=bs;var bj=p+qx.lang.String.firstUp(bi);if(bp[bj]){bp[bj](this.__tI(bq[bn],bn,bm+1));}
;}
;return bp;}
;throw new Error(j);}
...
(function(){var a="source",b="changeLeadIcon",c="changeSize",d="changeMode",e="changeDate",f="checked",g="changeChecked",h="icon/16/places/user-desktop.png",i="value",j="size",k="leadIcon",l="date",m="mode",n="demobrowser.demo.virtual.tree.TreeItem",o="String",p="Boolean";qx.Class.define(n,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:o,event:b,nullable:true},checked:{check:p,event:g,nullable:true},size:{check:o,event:c,nullable:true},date:{check:o,event:e,nullable:true},mode:{check:o,event:d,nullable:true}},members:{__PX:null,__PY:null,__Qa:null,__Qb:null,__iJ:null,_addWidgets:function(){var q=this.__PX=new qx.ui.basic.Image();this.bind(k,q,a);q.setWidth(16);this.addWidget(q);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(h);var r=this.__PY=new qx.ui.form.CheckBox();this.bind(f,r,i);r.bind(i,this,f);r.setFocusable(false);r.setTriState(true);r.setMarginRight(4);this.addWidget(r);this.addLabel();this.addWidget(new qx.ui.core.Spacer(),{flex:1});var s=this.__Qa=new qx.ui.basic.Label();this.bind(j,s,i);s.setWidth(50);this.addWidget(s);s=this.__Qb=new qx.ui.basic.Label();this.bind(l,s,i);s.setWidth(150);this.addWidget(s);s=this.__iJ=new qx.ui.basic.Label();this.bind(m,s,i);s.setWidth(80);this.addWidget(s);}
}});}
)();
