...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Window.1ab8b2e56244.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,this);var bn=new qx.ui.basic.Atom(U,Q);bn.setRich(true);bo.add(bn);var bm=new qx.ui.tabview.TabView;bo.add(bm,{flex:1});var br=new qx.ui.tabview.Page(d);bm.add(br);var bp=new qx.ui.tabview.Page(bj);bm.add(bp);var bq=new qx.ui.tabview.Page(A);bm.add(bq);}
,createWindow2:function(){var by=new qx.ui.window.Window(c,W);by.setLayout(new qx.ui.layout.VBox(10));by.setStatus(V);by.open();this.getRoot().add(by,{left:350,top:120});var bF=new qx.ui.basic.Atom(y,p);by.add(bF);var bs=new qx.ui.container.Composite;bs.setLayout(new qx.ui.layout.HBox(10));by.add(bs,{flex:1});var bA=new qx.ui.groupbox.GroupBox(R);bA.setLayout(new qx.ui.layout.VBox(4));bs.add(bA,{flex:1});var bv=new qx.ui.form.CheckBox(l);bv.setValue(true);bv.addListener(m,function(e){by.setShowClose(e.getData());}
...
);bK.add(bE);var bG=[O,n,f,bk];for(var i=0;i<bG.length;i++ ){var bD=bG[i];var bw=new qx.ui.form.CheckBox(C+bD).set({value:true});bw.bind(x,by,u+qx.lang.String.firstUp(bD));bK.add(bw);}
