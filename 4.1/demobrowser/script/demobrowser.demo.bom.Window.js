...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.3266a05999d6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__zd:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__zd=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__zd[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__zd[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__zd[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__lm:null,__Ji:null,__ef:null,__Jj:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__Jk:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Jl:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__Jm(H,E&&A);if(E){if(this.__Jl()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__ef==null){this.__ef=new qx.event.Timer(500);this.__ef.addListener(f,this.__Jn,this);}
;this.__Ji=window.open(z,name,G);this.__ef.restart();C=this.__Ji;}
;}
...
;return C;}
,__Jm:function(K,O){var M;var J;var N=[];if(O&&this.__Jl()){for(var L in K){if(qx.bom.Window.__Jj[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__Jj[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Jk[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__Jn:function(){if(this.isClosed(this.__Ji)){this.getBlocker().unblock();this.__ef.stop();}
;}
,getBlocker:function(){if(this.__lm==null){this.__lm=new qx.bom.Blocker;}
;return this.__lm;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__cQ();}
,members:{__Jo:null,__CC:null,__Jp:null,__Jq:false,__Jr:10000,__Js:0,__Jt:f,block:function(r){if(!this.__Jq){this.__Jp=r;var q=this.__Jw();this.__Jx(q);this.__Jq=true;}
;}
,unblock:function(){if(this.__Jq){this.__Jy();this.__Jq=false;}
;}
,isBlocked:function(){return this.__Jq;}
,getBlockerElement:function(){return this.__CC;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__CC,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__CC,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__CC,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__CC);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__CC,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__CC,h);}
,__cQ:function(){this.__Ju();if((qx.core.Environment.get(j)==b)){this.__Jv();}
;qx.event.Registration.addListener(window,a,this.__yK,this);}
,__Ju:function(){this.__CC=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__CC,{display:d,opacity:this.__Js,backgroundColor:this.__Jt});this.setBlockerZIndex(this.__Jr);}
,__Jv:function(){this.__Jo=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Jo,l,false);qx.bom.element.Attribute.set(this.__Jo,i,n);qx.bom.element.Style.setStyles(this.__Jo,{display:d,opacity:this.__Js});}
,__Jw:function(){var v={position:p};if(this.__JA()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Jp)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Jp)+g;v.left=qx.bom.element.Location.getLeft(this.__Jp)+g;v.top=qx.bom.element.Location.getTop(this.__Jp)+g;}
;return v;}
,__Jx:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__CC,w);qx.dom.Element.insertEnd(this.__CC,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Jo,w);qx.dom.Element.insertEnd(this.__Jo,document.body);}
;}
,__Jy:function(){qx.dom.Element.remove(this.__CC);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Jo);}
;}
,__yK:function(e){if(this.__JA()){this.__Jz({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Jz(y);}
,this,0);}
;}
,__Jz:function(z){qx.bom.element.Style.setStyles(this.__CC,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Jo,z);}
;}
,__JA:function(){return (this.__Jp==null||qx.dom.Node.isWindow(this.__Jp)||qx.dom.Node.isDocument(this.__Jp));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__yK,this);this.__Jo=this.__CC=this.__Jp=null;}
});}
)();
