...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Label.da8599367a0e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="qx.core.Object",c="qx.data.controller.Object",d="get",e="[",f="reset",g="_applyModel",h="last";qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bb={};this.__hi=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__hi:null,__bb:null,_applyModel:function(o,l){for(var i=0;i<this.__hi.length;i++ ){var t=this.__hi[i][0];var q=this.__hi[i][1];var n=this.__hi[i][2];var r=this.__hi[i][3];var p=this.__hi[i][4];var m=this.__hi[i][5];if(l!=undefined&&!l.isDisposed()){this.__ws(t,q,n,l);}
...
;}
;}
,addTarget:function(z,w,u,x,y,v){this.__hi.push([z,w,u,x,y,v]);this.__wr(z,w,u,x,y,v);}
...
,removeTarget:function(K,J,L){this.__ws(K,J,L,this.getModel());for(var i=0;i<this.__hi.length;i++ ){if(this.__hi[i][0]==K&&this.__hi[i][1]==J&&this.__hi[i][2]==L){this.__hi.splice(i,1);}
;}
;}
