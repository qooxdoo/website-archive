...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Complex","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.af703c4a37f1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.virtual.Complex",b="horizontal",c="rgb(238, 243, 255)",d="white";qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var e=new qx.ui.virtual.core.Scroller(100,15,32,120);e.getPane().setWidth(450);for(var i=2;i<10;i++ ){e.getPane().getRowConfig().setItemSize(i,50+Math.round(Math.random()*40));e.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(e,{left:20,top:10});e.getPane().addLayer(new qx.ui.virtual.layer.Row(d,c));e.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));e.getPane().addLayer(new demobrowser.demo.virtual.DemoLayer);new qx.ui.virtual.behavior.Prefetch(e,{minLeft:500,maxLeft:600,minRight:1000,maxRight:1200,minAbove:0,maxAbove:0,minBelow:0,maxBelow:0});}
}});}
)();
...
;this.__CG=[];this.__CH=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__CG:null,__CH:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__CG[B]=A;if(this.__CI(B)){this.updateLayerData();}
;}
...
;this.__CH[C]=D;if(this.__CI(C)){this.updateLayerData();}
;}
,__CI:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__CH[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__CG[K]||this.getDefaultLineColor();}
,__CJ:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__CK:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__CJ(Y,ba,X);}
else {this.__CK(Y,bb,W);}
...
(function(){var a="_applyInterval",b="__ef",c="appear",d="qx.debug",e="interval",f="qx.ui.virtual.behavior.Prefetch",g="scroll",h="_applyScroller",i="qx.ui.virtual.core.Scroller",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(f,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(d)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__ef=new qx.event.Timer(this.getInterval());this.__ef.addListener(e,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__wf:null,__wg:null,__ef:null,__wh:null,__wi:null,setPrefetchX:function(o,r,p,q){this.__wf=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__wg=[v,u,t,s];}
,_onInterval:function(){var w=this.__wf;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__wg;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__wh){y.getChildControl(j).removeListenerById(this.__wh);}
;if(this.__wi){y.getChildControl(l).removeListenerById(this.__wi);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__ef.stop();z.addListenerOnce(c,this.__ef.start,this.__ef);}
else {this.__ef.restart();}
;this.__wh=z.getChildControl(j).addListener(g,this.__ef.restart,this.__ef);this.__wi=z.getChildControl(l).addListener(g,this.__ef.restart,this.__ef);}
else {this.__ef.stop();}
;}
,_applyInterval:function(B,A){this.__ef.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__wf=this.__wg=null;this._disposeObjects(b);}
});}
)();
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="pointerover",h="network-server.png",i="row",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__mE=[];}
,members:{_pool:null,__mE:null,getCellData:function(t,s){if(!this.__mE[t]){this.__mE[t]=[];}
;if(!this.__mE[t][s]){this.__mE[t][s]={label:this.__PP(),icon:this.__PQ()};}
;return this.__mE[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(g,function(){var x=this.__PQ();v.setIcon(x);this.__mE[w][u].icon=x;}
,this);}
;v.set(this.getCellData(w,u));}
else {v=this._pool.checkbox.pop();if(!v){v=new qx.ui.form.CheckBox();v.addListener(m,function(){this.setLabel(this.getLabel()==l?v.getUserData(i)+b+v.getUserData(n):l);}
,v);}
;v.set({value:w%2==0,label:w+b+u});}
;v.setUserData(i,w);v.setUserData(n,u);return v;}
,poolCellWidget:function(y){if(y.classname==p){this._pool.atom.push(y);}
else {this._pool.checkbox.push(y);}
;}
,__PP:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__PQ:function(){var z=a;var B=e;var A=[d,k,h,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
