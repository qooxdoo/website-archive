...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList.9ce6d46918d6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,createSecondExample:function(){var U=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var W=new qx.ui.basic.Label(j).set({font:v});U.add(W);var T=this.__PS=new qx.ui.list.List().set({height:280,width:150,labelPath:e,labelOptions:{converter:function(Y,X){return X?X.getLastname()+t+Y:B;}
...
,createThirdExample:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var be=new qx.ui.basic.Label(u).set({font:v});bc.add(be);var bb=this.__PT=new qx.ui.list.List().set({height:280,width:150,labelPath:e,labelOptions:{converter:function(bg,bf){return bf?bg+D+bf.getLastname():B;}
...
},destruct:function(){this.__JW.dispose();this.__PS.dispose();this.__PT.dispose();this.__JW=this.__PS=this.__PT=null;}
});}
)();
