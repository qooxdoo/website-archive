...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.2b2ceebfb043.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__IN].values;var bo=this.__IJ[this.__IN];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__IO){bn.shift();}
...
;this.__IL.setRed(bx);this.__IL.setGreen(bw);this.__IL.setBlue(bv);this.__IK.open();}
,_onColorSelectorOk:function(){var by=this.__IL;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__IK.close();}
,_onColorSelectorCancel:function(){this.__IK.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__IK){this.__IK.destroy();this.__IL.destroy();this.__IM.destroy();}
;this._tables=this.__IJ=null;}
});}
)();
