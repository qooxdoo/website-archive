...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas.982850180a63.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,events:{"redraw":j},properties:{syncDimension:{check:d,init:false},canvasWidth:{check:i,init:300,apply:b},canvasHeight:{check:i,init:150,apply:g}},members:{__Ef:null,_createContentElement:function(){return new qx.html.Canvas();}
,__Eg:function(){var n=this.getContentElement();var p=n.getHeight();var m=n.getWidth();var o=n.getContext2d();this._draw(m,p,o);this.fireNonBubblingEvent(c,qx.event.type.Data,[{width:m,height:p,context:o}]);}
,_applyCanvasWidth:function(r,q){this.getContentElement().setWidth(r);this.__Ef.schedule();}
,_applyCanvasHeight:function(t,s){this.getContentElement().setHeight(t);this.__Ef.schedule();}
,update:function(){this.__Ef.schedule();}
...
(function(){var a="canvas",b="2d",c="qx.html.Canvas";qx.Class.define(c,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__ez=document.createElement(a);}
,members:{__ez:null,_createDomElement:function(){return this.__ez;}
,getCanvas:function(){return this.__ez;}
,setWidth:function(f){this.__ez.width=f;}
,getWidth:function(){return this.__ez.width;}
,setHeight:function(g){this.__ez.height=g;}
,getHeight:function(){return this.__ez.height;}
,getContext2d:function(){return this.__ez.getContext(b);}
