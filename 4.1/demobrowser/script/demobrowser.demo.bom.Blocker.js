...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker.5a772e3f20a6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="300px",b="Block Document for 5s",c="100px",d="demobrowser.demo.bom.Blocker",f="red",g="Block Element for 5s",h="320px",i="200px",j="green",k="div",l="tap",m="orange",n="button",o="150px",p="absolute";qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var t=qx.bom.Input.create(n,{value:b});qx.bom.element.Style.setStyles(t,{position:p,left:c,top:c,width:i});var u=new qx.bom.Blocker;u.setBlockerOpacity(0.5);u.setBlockerColor(f);qx.event.Registration.addListener(t,l,function(e){u.block();qx.event.Timer.once(function(e){u.unblock();}
,window,5000);}
);qx.dom.Element.insertEnd(t,document.body);var q=qx.bom.Input.create(n,{value:g});qx.bom.element.Style.setStyles(q,{position:p,left:h,top:c,width:i});var s=qx.dom.Element.create(k);qx.bom.element.Style.setStyles(s,{position:p,left:a,top:o,width:a,height:i,backgroundColor:m,zIndex:500});qx.dom.Element.insertBegin(s,document.body);var r=new qx.bom.Blocker;r.setBlockerOpacity(0.5);r.setBlockerColor(j);qx.event.Registration.addListener(q,l,function(e){r.block(s);qx.event.Timer.once(function(e){r.unblock();}
,window,5000);}
