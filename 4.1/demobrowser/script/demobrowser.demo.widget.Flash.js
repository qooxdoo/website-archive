...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.ed2b34b54dc2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="Flash Player Version",c="right",d="qooxdoo is the best!",f="Message from Flash:",g="execute",h="Simple demo with FlashVars",i="__Qd",j="bgcolor",k="demobrowser.demo.widget.Flash",l="demobrowser/demo/flash/TestFlash.swf",m="1) no pop-up or advertising blocker is activated.\n",n="Send to Flash",o="demobrowser/demo/flash/FlashVersion.swf",p="No message.",q="Flash:",r="<b>qooxdoo:</b>",s="__Qe",t="demobrowser.demo.widget.Flash.sendMessage",u="demobrowser.demo.widget.Flash.flashReady",v="Couldn't connect to Flash Player! Please make sure that:\n",w="__Fg",x="demobrowser/demo/flash/fo_tester.swf",y="this is passed in via FlashVars",z="Two way communication (ActionScript <-> JavaScript)",A="__Qc",B="__cy",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(k,{extend:qx.application.Standalone,members:{__cy:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(h);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(z);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cy=this.createWindow();G.add(this.__cy,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:y};var M=new qx.ui.embed.Flash(x).set({scale:E,variables:L});M.getContentElement().setParam(j,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(g,function(){this.__cy.open();}
,this);N.add(O);return N;}
,__Fg:null,__Qc:null,__Qd:null,__Qe:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(r).set({rich:true}));Q.add(new qx.ui.basic.Label(f));this.__Qc=new qx.ui.form.TextArea(p);this.__Qc.setEnabled(false);Q.add(this.__Qc,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__Qd=new qx.ui.form.TextArea(d);Q.add(this.__Qd,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,c));this.__Qe=new qx.ui.form.Button(n);this.__Qe.setEnabled(false);this.__Qe.addListener(g,function(e){this.__Fg.getFlashElement().sendMessage(this.__Qd.getValue());}
,this);S.add(this.__Qe);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(q).set({rich:true}));this.__Fg=new qx.ui.embed.Flash(l);this.__Fg.setVariables({init:u});P.add(this.__Fg,{flex:1});return R;}
,sendMessage:function(T){this.__Qc.setValue(T);}
,initFlash:function(){if(this.__Fg.getFlashElement().setup){this.__Fg.getFlashElement().setup(t);this.__Qe.setEnabled(true);}
else {alert(v+m+a);}
;}
},statics:{__Qf:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Qf=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Qf.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Qf.initFlash();}
},destruct:function(){this._disposeObjects(A,i,s,w,B);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__EV){this.__EV=new Date().getTime();}
;var bp=new Date().getTime()-this.__EV;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__EV=null;}
;}
else {this.fireEvent(p);this.__EV=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__EW(c,bB);}
,_applyScale:function(bD,bC){this.__EW(h,bD);}
,_applyWmode:function(bF,bE){this.__EW(m,bF);}
,_applyPlay:function(bH,bG){this.__EW(I,bH);}
,_applyLoop:function(bJ,bI){this.__EW(s,bJ);}
,_applyMenu:function(bL,bK){this.__EW(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__EW(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__EW(z,bP);}
,__EW:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
...
;}
;}
;var O=this.__Fm(P,R,Q,M);this._flashObjects[R.id]=O;return O;}
,destroy:function(T,S){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){T=this.__Fh(T);if(T.readyState==4){this.__Fi(T);}
else {if(!S){S=window;}
;qx.bom.Event.addNativeListener(S,p,function(){qx.bom.Flash.__Fi(T);}
);}
;}
else {T=this.__Fh(T);if(T.parentNode){T.parentNode.removeChild(T);}
;delete this._flashObjects[T.id];}
;}
,__Fh:function(U){if(!U){throw new Error(z);}
;if(U.tagName.toLowerCase()!==L){U=U.firstChild;}
;if(!U||U.tagName.toLowerCase()!==L){throw new Error(A);}
;return U;}
,__Fi:qx.core.Environment.select(D,{"mshtml":qx.event.GlobalError.observeMethod(function(V){for(var i in V){if(typeof V[i]==b){V[i]=null;}
;}
;if(V.parentNode){V.parentNode.removeChild(V);}
;delete this._flashObjects[V.id];}
),"default":null}),__Fj:qx.event.GlobalError.observeMethod(function(){for(var W in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[W]);}
;window.__Fk=function(){}
;window.__Fl=function(){}
;qx.bom.Event.removeNativeListener(window,F,qx.bom.Flash.__Fj);}
),__Fm:function(bb,bd,bc,X){if(qx.core.Environment.get(D)==v&&qx.core.Environment.get(q)<11){bc.movie=bd.data;delete bd.data;delete bd.classid;var Y=u;for(var name in bc){Y+=m+name+J+bc[name]+E;}
...
},defer:function(bf){if(qx.core.Environment.get(D)==v){qx.bom.Event.addNativeListener(window,F,bf.__Fj);}
;}
});}
)();
(function(){var a="qx.util.TimerManager",b="interval",c="singleton";qx.Class.define(a,{extend:qx.core.Object,type:c,statics:{__EX:[],__EY:{},__uw:0},members:{__Fa:false,start:function(g,f,h,d,j){if(!j){j=f||0;}
;var e=(new Date()).getTime()+j;this.self(arguments).__EY[ ++this.self(arguments).__uw]={callback:g,userData:d||null,expireAt:e,recurTime:f,context:h||this};this.__Fb(e,this.self(arguments).__uw);return this.self(arguments).__uw;}
,stop:function(k){var l=this.self(arguments).__EX;var length=l.length;for(var i=0;i<length;i++ ){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__EY[k];if(l.length==0&&this.__Fa){qx.event.Idle.getInstance().removeListener(b,this.__Fc,this);this.__Fa=false;}
;}
,__Fb:function(m,p){var o=this.self(arguments).__EX;var n=this.self(arguments).__EY;var length=o.length;for(var i=0;i<length;i++ ){if(n[o[i]].expireAt>m){o.splice(i,0,p);break;}
;}
;if(o.length==length){o.push(p);}
;if(!this.__Fa){qx.event.Idle.getInstance().addListener(b,this.__Fc,this);this.__Fa=true;}
;}
,__Fc:function(){var r=(new Date()).getTime();var t=this.self(arguments).__EX;var s=this.self(arguments).__EY;while(t.length>0&&s[t[0]].expireAt<=r){var v=t.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__Fb(q.expireAt,v);}
else {delete s[v];}
;}
;if(t.length==0&&this.__Fa){qx.event.Idle.getInstance().removeListener(b,this.__Fc,this);this.__Fa=false;}
;}
}});}
)();
