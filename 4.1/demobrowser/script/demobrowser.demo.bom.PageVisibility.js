...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.00b3b7721079.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__pa=document||window.document;this.__HS();var self=this;qx.bom.Event.addNativeListener(this.__pa,this.__dw,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__pa:null,__HQ:null,__HR:null,__dw:null,__HS:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__pa[m]!=undefined){this.__HQ=m;this.__dw=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__pa[m]!=undefined){this.__HR=m;break;}
;}
;if(this.__HQ==null){this.__HQ=k;this.__dw=c;}
;if(this.__HR==null){this.__HR=b;}
;}
,isHidden:function(){return !!this.__pa[this.__HQ];}
,getVisibilityState:function(){return this.__pa[this.__HR]||d;}
}});}
)();
