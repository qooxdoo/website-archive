...
var settings = {"qx.application":"portal.Application","qx.theme":"qx.theme.Modern","qx.version":"1.0.2"};
...
var libinfo = {"__out__":{"sourceUri":"script"},"portal":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.0.2"}};
...
this.__zC=[];
this.__zD={};
},statics:{dataKeyRoot:h,dataKeyGroupBoxes:m,dataKeyBoxes:d},events:{"loaded":e},properties:{activeBox:{init:null,check:g,apply:c}},members:{__zB:null,__zC:null,__zD:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);
}n.setActive(true);
},load:function(){this.__zE(window[portal.box.Manager.dataKeyRoot]);
qx.event.Registration.fireEvent(this,b);
},__zE:function(p){var t,w,u,v,x,p;
...
this.__zB.push(x);
this.__zD[w].push(x);
}}},getBoxes:function(){return this.__zB;
},getGroupBoxes:function(){return this.__zC;
},updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());
qx.lang.Array.remove(this.__zD[z],A);
qx.lang.Array.insertAt(this.__zD[y],A,B);
},getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__zC.length,D;i<j;i++){D=this.__zD[this.__zC[i].id];

for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__zC[i];
}}}return null;
}},destruct:function(){this.__zB=this.__zC=this.__zD=null;
}});
})();
(function(){var v="Boolean",u="<br/><br/>",t="border",s="portal.box.Box",r="click",q="1px solid #444444",p="height",o="position",n="zIndex",m="_applyActive",g="width",l="box_content",j=" It does contain no UI widget code at all.",f="relative",d="1px solid orange",i="This is a demo application showing the low-level capabilities.",h="div",k="String";
qx.Class.define(s,{extend:qx.core.Object,construct:function(w,x,y,z){arguments.callee.base.call(this);
this.__zF=w;
this.__zG=w.id;

if(x!=null){qx.bom.element.Style.set(x,g,w.width);
qx.bom.element.Style.set(x,p,w.height);
this.__zJ(x,y);
}this.setElement(x);
this.setGroupBoxId(z);
this.__zH=null;
this.__zI=null;
if(w.resizable){this.setResizable(true);
var A={minWidth:parseInt(w.minWidth),minHeight:parseInt(w.minHeight),maxWidth:parseInt(w.maxWidth),maxHeight:parseInt(w.maxHeight),handles:w.resizeHandles};
this.__zH=new portal.box.Resizable(this,A);
}if(w.draggable){this.setDraggable(true);
this.__zI=new portal.box.Draggable(this);
}this.__zK();
},properties:{element:{init:null},groupBoxId:{init:null,check:k},active:{check:v,init:false,apply:m},resizable:{check:v,init:false},draggable:{check:v,init:false}},members:{__zG:null,__zF:null,__zI:null,__zH:null,_applyActive:function(B,C){if(B){qx.bom.element.Style.set(this.getElement(),t,d);
}else{qx.bom.element.Style.set(this.getElement(),t,q);
}},getId:function(){return this.getElement()?this.getElement().id:null;
},getData:function(){return this.__zF;
},getDraggableComponent:function(){return this.__zI;
},getResizableComponent:function(){return this.__zH;
},__zJ:function(a,b){if(b){for(var c in b){qx.bom.element.Style.set(c,b[c]);
}}qx.bom.element.Style.set(a,o,f);
qx.bom.element.Style.set(a,n,0);
qx.bom.Element.addListener(a,r,this.__zL,this,true);
},__zK:function(){var E=i+j;
E=E+u+E+u+E;
var D=qx.bom.Element.create(h,{"class":l});
D.innerHTML=E;
qx.dom.Element.insertEnd(D,this.getElement());
},__zL:function(e){portal.box.Manager.getInstance().setActiveBox(this);
}},destruct:function(){this.resetElement();
this.__zF=this.__zH=this.__zI=null;
}});
})();
...
this.__zM=P;
this.__zN=this.__zM.getElement();
this.__zO={};
this.__zP=false;
this.__zQ={orientation:null,lastCoord:{left:null,top:null}};
this.__zR={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};

for(var name in this.__zR){if(Q[name]){this.__zR[name]=Q[name];
}}this.__zS();
},members:{__zQ:null,__zM:null,__zN:null,__zO:null,__zR:null,__zP:false,getBox:function(){return this.__zM;
},__zS:function(){switch(this.__zR.handles){case 1:this.__zO.east=null;
break;
case 2:this.__zO.south=null;
break;
case 3:this.__zO.south=null;
this.__zO.southeast=null;
this.__zO.east=null;
break;
}for(var K in this.__zO){var J=this.__zO[K]=qx.bom.Element.create(g);
qx.bom.element.Attribute.set(J,p,K);
qx.dom.Element.insertEnd(J,this.__zN);

if(this.__zN.id){J.id=this.__zN.id+i+K;
}this.__zT(K);
this.__zU(K);
}},__zT:function(O){qx.bom.element.Class.add(this.__zO[O],O+k);
qx.bom.element.Style.set(this.__zO[O],v,this.__zR.autoHide?u:r);
},__zU:function(G){var I=qx.event.Registration;
var H=this.__zO[G];
I.addListener(H,j,this.__zX,this);
I.addListener(document.body,n,this.__zY,this);

if(this.__zR.autoHide){I.addListener(this.__zM.getElement(),t,this.__zV,this);
I.addListener(this.__zM.getElement(),s,this.__zW,this);
}},__zV:function(e){for(var w in this.__zO){qx.bom.element.Style.set(this.__zO[w],v,r);
}},__zW:function(e){if(!this.__zP){for(var a in this.__zO){qx.bom.element.Style.set(this.__zO[a],v,u);
}}},__zX:function(e){e.stopPropagation();
if(e.isLeftPressed()){qx.event.Registration.addListener(document.body,q,this.__Aa,this,true);
this.__zP=true;
var M=e.getTarget();
this.__zQ.orientation=qx.bom.element.Attribute.get(M,p);
this.__zQ.lastCoord.left=e.getDocumentLeft();
this.__zQ.lastCoord.top=e.getDocumentTop();
portal.box.Util.bringToFront(this.__zN);
}},__zY:function(e){e.stopPropagation();

if(this.__zP){qx.event.Registration.removeListener(document.body,q,this.__Aa,this,true);
portal.box.Util.sendToBack(this.__zN);

if(this.__zR.autoHide){for(var L in this.__zO){qx.bom.element.Style.set(this.__zO[L],v,u);
}}this.__zP=false;
qx.bom.Selection.clear(document.body);
}},__Aa:function(e){e.stopPropagation();

if(this.__zP){var N={left:null,top:null};

switch(this.__zQ.orientation){case o:N.top=e.getDocumentTop();
break;
case b:N.top=e.getDocumentTop();
N.left=e.getDocumentLeft();
break;
case h:N.left=e.getDocumentLeft();
break;
}this.__Ab(N,this.__zQ.lastCoord);
this.__zQ.lastCoord.left=e.getDocumentLeft();
this.__zQ.lastCoord.top=e.getDocumentTop();
}},__Ab:function(x,y){var F=qx.bom.element.Dimension;
var C=portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__zM.getId());
var E=F.getContentSize(C.element);

if(x.left){var B=x.left-y.left;

if(B!==0){var A=F.getContentWidth(this.__zN)+B;
var D=F.getWidth(this.__zN)+B;

if((this.__zR.minWidth==null||A>this.__zR.minWidth)&&(this.__zR.maxWidth==null||A<=this.__zR.maxWidth)){if(E.width>=D){qx.bom.element.Style.set(this.__zN,l,A+f);
}}}}
if(x.top){var B=x.top-y.top;

if(B!==0){var z=F.getContentHeight(this.__zN)+B;

if((this.__zR.minHeight==null||z>this.__zR.minHeight)&&(this.__zR.maxHeight==null||z<=this.__zR.maxHeight)){qx.bom.element.Style.set(this.__zN,d,z+c);
}}}}},destruct:function(){if(this.__zR.autoHide){qx.event.Registration.removeListener(this.__zM.getElement(),t,this.__zV,this);
qx.event.Registration.removeListener(this.__zM.getElement(),s,this.__zW,this);
}this.__zM=this.__zR=this.__zN=this.__zO=null;
this.__zQ=null;
}});
})();
...
qx.Class.define(b,{statics:{__Ac:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,c);
e=e==a?0:e;
qx.bom.element.Style.set(d,c,e+this.__Ac);
},sendToBack:function(f){var g=qx.bom.element.Style.get(f,c);
qx.bom.element.Style.set(f,c,g-this.__Ac);
}}});
})();
...
this.__Ad=t;
this.__Ae=t.getElement();
this.__Af=null;
this.__Ag=null;
this.__Ah();
},members:{__Ad:null,__Ae:null,__Af:null,__Ag:null,getBox:function(){return this.__Ad;
},getElement:function(){return this.__Ae;
},__Ah:function(){this.__Ai();
this.__Aj();
},__Ai:function(){this.__Af=qx.bom.Element.create(g);
qx.bom.element.Class.add(this.__Af,b);
qx.dom.Element.insertBegin(this.__Af,this.__Ae);
},__Aj:function(){qx.bom.Element.addListener(this.__Af,l,this.__Ak,this);
qx.bom.Element.addListener(this.__Af,j,function(e){qx.bom.element.Style.set(this,c,f);
},this.__Af);
qx.bom.Element.addListener(this.__Af,m,this.__An,this);
qx.bom.Element.addListener(this.__Af,h,portal.dragdrop.Manager.getInstance().stopSession,portal.dragdrop.Manager.getInstance());
qx.bom.Element.addListener(this.__Af,i,this.__Ao,this);
},__Ak:function(e){if(e.isLeftPressed()){this.__Ag={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__Ae),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__Ae)};
qx.bom.Element.addListener(document.body,n,this.__Am,this,true);
this.__Al();
qx.event.Registration.fireEvent(this.__Af,m,qx.event.type.Event);
}},__Al:qx.core.Variant.select(a,{"mshtml":function(){var r=this;
var q=qx.lang.Function.bind(this.__Am,r);
document.getElementsByTagName(d)[0].onmouseleave=q;
},"default":qx.lang.Function.empty}),__Am:function(e){try{e.stopPropagation();
}catch(s){}
if(portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,o,this.__Ao,this,true);
portal.dragdrop.Manager.getInstance().stopSession();
}qx.bom.Element.removeListener(document.body,n,this.__Am,this,true);
},__An:function(e){portal.box.Manager.getInstance().setActiveBox(this.__Ad);
portal.dragdrop.Manager.getInstance().startSession(this.__Ad);
qx.event.Registration.addListener(document.body,o,this.__Ao,this,true);
},__Ao:function(e){e.stopPropagation();
var p=e.getDocumentLeft()-this.__Ag.left;
var top=e.getDocumentTop()-this.__Ag.top;
qx.event.Timer.once(function(){this.checkGroupBox(p);
this.onDragMove(top,p);
},portal.dragdrop.Manager.getInstance(),0);
}},destruct:function(){this.__Ad=this.__Af=this.__Ae=this.__Ag=null;
}});
})();
...
qx.Class.define(d,{type:p,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__Ap={top:null,height:null};
this.__Aq={top:0,left:0};
},properties:{activeBox:{check:x,init:null,nullable:true},sessionActive:{check:u,init:false}},members:{__Ap:null,__Ar:null,__As:false,__Aq:null,__At:null,__Au:null,startSession:function(D){this.setSessionActive(true);
this.setActiveBox(D);
this.__Ar=D.getGroupBoxId();
this.__Av();
if(this.__At==null){this.__At={};
var E=portal.box.Manager.getInstance().getGroupBoxes();

for(var i=0,j=E.length;i<j;i++){this.__At[E[i].element.id]={left:qx.bom.element.Location.getLeft(E[i].element),right:qx.bom.element.Location.getLeft(E[i].element)+qx.bom.element.Dimension.getWidth(E[i].element)};
}}},__Av:function(){if(!this.__Au){this.__Au=qx.bom.Element.create(f);
}var c=this.getActiveBox().getElement();
var a=qx.bom.element.Dimension.getContentSize(c);
this.__Aw(c,this.__Au);
qx.bom.element.Class.add(this.__Au,qx.bom.element.Class.get(c));
var b=n+h+qx.bom.element.Location.getTop(c)+z+g+qx.bom.element.Location.getLeft(c)+z+r+a.width+z+k+a.height+A;
qx.bom.element.Style.setCss(this.__Au,b);
qx.bom.element.Style.set(c,y,w);
qx.dom.Node.getBodyElement(c).appendChild(this.__Au);
portal.box.Util.bringToFront(this.__Au);
},__Aw:function(T,U){while(T.firstChild){U.appendChild(T.firstChild);
}},stopSession:function(e){this.setSessionActive(false);
var R=this.getActiveBox();
var S=R.getElement();
portal.box.Manager.getInstance().updateGroupBoxMembers(R.getGroupBoxId(),this.__Ar,R);
R.setGroupBoxId(this.__Ar);
var Q=new qx.fx.effect.core.Move(this.__Au);
Q.set({x:qx.bom.element.Location.getLeft(S),y:qx.bom.element.Location.getTop(S),mode:m,duration:0.5,transition:l});
Q.start();
Q.addListener(q,function(){this.__Aw(this.__Au,S);
qx.bom.element.Style.reset(S,y);
this.__Au.parentNode.removeChild(this.__Au);

if(R.isActive()){R._applyActive(true);
}else{portal.box.Manager.getInstance().setActiveBox(R);
}},this);
},onDragMove:function(top,N){if(this.__Aq.left!=N){qx.bom.element.Style.set(this.__Au,t,N+A);
}
if(this.__Aq.top!=top){qx.bom.element.Style.set(this.__Au,v,top+A);
}var O=this.getActiveBox().getElement();

if(this.__Ap.top==null){this.__Ap.top=qx.bom.element.Location.getTop(O);
}
if(this.__Ap.height==null){this.__Ap.height=qx.bom.element.Dimension.getHeight(O);
}if(this.__As==false&&top>=this.__Ap.top&&top<=(this.__Ap.top+this.__Ap.height)){return;
}var P;
if(this.__As){P=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__Ar));
while(P!=null){if(this.__Ax(true,top,O,P)){this.__As=false;
return;
}P=qx.dom.Hierarchy.getNextElementSibling(P);
}}else{P=O;
}if(top-this.__Aq.top>0){P=qx.dom.Hierarchy.getNextElementSibling(P);

while(P!=null){if(P){if(this.__Ax(true,top,O,P)){return;
}}P=qx.dom.Hierarchy.getNextElementSibling(P);
}}else{var P=qx.dom.Hierarchy.getPreviousElementSibling(P);

while(P!=null){if(P){if(this.__Ax(false,top,O,P)){return;
}}P=qx.dom.Hierarchy.getPreviousElementSibling(P);
}}this.__Aq.left=N;
this.__Aq.top=top;
},__Ax:function(F,top,G,H){var I=qx.bom.element.Location.getTop(H);
var K=parseInt(qx.bom.element.Style.get(H,s));
var L=parseInt(qx.bom.element.Style.get(H,o));
var J=qx.bom.element.Dimension.getContentHeight(H)+L+K;
var M;

if(F){if(top>=(I+(J/3))){M=qx.dom.Hierarchy.getNextElementSibling(H);

if(M!=G||M==null){qx.dom.Element.insertAfter(G,H);
this.__Ap.top=qx.bom.element.Location.getTop(G);
}return true;
}}else{if(top<=(I+J*2/3)){M=qx.dom.Hierarchy.getPreviousElementSibling(H);

if(M!=G||M==null){qx.dom.Element.insertBefore(G,H);
this.__Ap.top=qx.bom.element.Location.getTop(G);
}return true;
}}return false;
},checkGroupBox:function(B){if(this.__At[this.__Ar].left<=B&&this.__At[this.__Ar].right>=B){return;
}
for(var C in this.__At){if(C!=this.__Ar){if(this.__At[C].left<=B&&this.__At[C].right>=B){this.__Ar=C;
this.__As=true;
return;
}}}}},destruct:function(){this.__Ap=this.__Aq=this.__Ar=null;
this.__Ay=this.__Au=this.__At=null;
}});
})();
