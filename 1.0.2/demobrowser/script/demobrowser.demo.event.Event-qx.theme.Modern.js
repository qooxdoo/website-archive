...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.Event-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"faa9d33a2f1f"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(z,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
