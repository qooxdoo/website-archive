...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.showcase.Localization-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"8bdb4d002776"},
  boot : "boot",
  bootIsInline : true,
