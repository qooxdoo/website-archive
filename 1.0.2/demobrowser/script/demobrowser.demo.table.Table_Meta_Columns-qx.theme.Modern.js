...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Meta_Columns-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a2ff41767a8b"},
  boot : "boot",
  bootIsInline : true,
