...
},_createHorizontalLayout:function(){var p=[];
...
q.setColumnFlex(1,1);
q.setColumnFlex(2,1);
q.setColumnAlign(0,n,m);
q.setColumnAlign(1,l,m);
q.setColumnAlign(2,b,m);
var s=0;

for(var i=0;i<p.length;i++){var r=p[i];
r.slider.setOrientation(g);
r.value.setWidth(100);
r.value.setTextAlign(l);
o.add(r.minimum,{row:s,column:0});
o.add(r.value,{row:s,column:1});
o.add(r.maximum,{row:s,column:2});
o.add(r.slider,{row:s+1,column:0,colSpan:3,rowSpan:1});
q.setRowHeight(s+2,20);
s+=3;
}return o;
