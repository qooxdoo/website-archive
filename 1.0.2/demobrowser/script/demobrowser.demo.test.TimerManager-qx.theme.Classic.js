...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.TimerManager-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e09f799ca026"},
  boot : "boot",
  bootIsInline : true,
