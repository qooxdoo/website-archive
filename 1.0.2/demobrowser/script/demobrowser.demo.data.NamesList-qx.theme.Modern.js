...
(function(){var o="persons.json</a> and bind the items to the list widget. In the ",n="converter for the label, the names will be set to both, the first ",m="Loading...",l="model.persons",k="' target='_blank'>",j="model",i="state",h="and last name.",g="value",f="demobrowser.demo.data.NamesList",c="firstname",e="<b>List bound to data in a json file</b><br/>",d="json/persons.json",b=", ",a="Loading the json file <a href='";
...
u.setLabelPath(c);
u.setLabelOptions({converter:function(p,q){return q.getLastname()+b+p;
}});
var s=d;
var v=new qx.data.store.Json(s);
var status=new qx.ui.basic.Label(m);
