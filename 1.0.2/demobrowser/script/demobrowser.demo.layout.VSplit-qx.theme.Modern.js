...
},getSplitPaneTwoFlexSimple:function(){var B=new qx.ui.splitpane.Pane(m);
B.setHeight(400);
B.setDecorator(l);
...
A.setWrap(true);
B.add(A,1);
var C=new qx.ui.form.TextArea(h);
C.setDecorator(null);
C.setWrap(true);
B.add(C,2);
return B;
},getSplitPaneTwoFlexWithOneMin:function(){var o=new qx.ui.splitpane.Pane(m);
o.setHeight(400);
o.setDecorator(l);
...
o.add(p,2);
return o;
},getSplitPaneTwoFlexWithOneMax:function(){var y=new qx.ui.splitpane.Pane(m);
y.setHeight(400);
y.setDecorator(l);
var x=new qx.ui.form.TextArea(k);
x.setDecorator(null);
x.setWrap(true);
y.add(x,1);
...
K.add(L,2);
return K;
},getSplitPaneOneFlexSimple:function(){var r=new qx.ui.splitpane.Pane(m);
r.setHeight(400);
r.setDecorator(l);
...
H.add(I);
return H;
},getSplitPaneOneFlexSimpleWithMin:function(){var u=new qx.ui.splitpane.Pane(m);
u.setHeight(400);
u.setDecorator(l);
var t=new qx.ui.form.TextArea(c);
t.setDecorator(null);
t.setWrap(true);
t.setMinHeight(350);
u.add(t,0);
