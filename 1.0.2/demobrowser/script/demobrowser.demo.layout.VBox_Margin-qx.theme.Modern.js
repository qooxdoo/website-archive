...
k.add(this.getBox4());
k.add(this.getBox5());
},getBox1:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
l.setMarginRight(30);
return m;
},getBox2:function(){var v=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
u.setMarginRight(30);
return v;
},getBox3:function(){var f=new qx.ui.layout.VBox();
...
z.setMarginRight(20);
return A;
},getBox5:function(){var p=new qx.ui.layout.VBox();
var r=new qx.ui.container.Composite(p).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
p.setSpacing(5);
p.setAlignX(b);
