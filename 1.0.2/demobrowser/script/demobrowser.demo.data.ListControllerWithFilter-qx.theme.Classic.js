...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ListControllerWithFilter-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"cf17cd7655d7"},
  boot : "boot",
  bootIsInline : true,
...
var w={};
w.filter=function(I){return parseInt(I)%2==0;
};
var A=new qx.ui.basic.Label(b);
this.getRoot().add(A,{left:10,top:290});
var E={converter:function(H){if(H==w){return l;
