...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.Finder-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"6f85a8a7a370"},
  boot : "boot",
  bootIsInline : true,
