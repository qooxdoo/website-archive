...
return l;
},getBox2:function(){var e=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,allowGrowY:false});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:30}),{flex:1});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:100}),{flex:3});
return e;
},getBox3:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,allowGrowY:false});

for(var i=0;i<25;i++){g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,height:5}),{flex:1});
}return g;
...
return h;
},getBox5:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,minHeight:0,decorator:d,backgroundColor:b,allowGrowY:false});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:1});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:2});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:3});
return f;
},getBox6:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:d,backgroundColor:b,allowGrowY:false});
