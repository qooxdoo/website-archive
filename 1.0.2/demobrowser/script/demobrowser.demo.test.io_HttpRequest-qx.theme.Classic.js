...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.io_HttpRequest-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"456225e8f673"},
  boot : "boot",
  bootIsInline : true,
