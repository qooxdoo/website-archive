...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.SelectBox","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.SelectBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"33c1611bc1df"},
  boot : "boot",
  bootIsInline : true,
...
var Q=new qx.ui.container.Scroll();
var P=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
P.setPadding(20);
P.add(this.createBox1());
P.add(this.createBox2());
P.add(this.createBox3());
P.add(this.createBox4());
Q.add(P,{left:20,top:20});
this.getRoot().add(Q,{edge:0});
},createBox1:function(){var S=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
S.add(new qx.ui.basic.Label(f));
var R=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var T=new qx.ui.form.ListItem(v+(i+1));
R.add(T);
if(i==5){R.setSelection([T]);
}}R.addListener(B,function(e){this.debug("changeSelection: "+e.getData()[0]);
});
S.add(R);
return S;
},createBox2:function(){var I=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
I.add(new qx.ui.basic.Label(w));
var H=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var J=new qx.ui.form.ListItem(G+Math.round(Math.random()*100000000));
H.add(J);
}I.add(H);
return I;
},createBox3:function(){var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
L.add(new qx.ui.basic.Label(p));
var N=[j,c,h,x,n,a,d,m,E,F,r,t,C,u,z,s,A,k,g];
var O=l;
var K=new qx.ui.form.SelectBox();

for(var i=0;i<N.length;i++){var M=new qx.ui.form.ListItem(N[i].substr(0,N[i].indexOf(y)),O+N[i]);
K.add(M);
}L.add(K);
return L;
