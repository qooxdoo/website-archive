...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Grid_Simple-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"169a112e5326"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="main",n="green",m="yellow",l="click me",k="click",j="center",i="top",h="middle",g="right",f="demobrowser.demo.layout.Grid_Simple";
...
q.add(this.getGrid2());
q.add(this.getGrid3());
},getGrid1:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:o,backgroundColor:m,allowGrowX:false,allowGrowY:false});
p.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:0,column:0});
p.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:0,column:1});
p.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:1,column:0});
p.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:1,column:1});
return p;
},getGrid2:function(){var c=new qx.ui.layout.Grid();
c.setColumnAlign(1,j,i);
c.setColumnAlign(0,g,h);
c.setSpacing(5);
var b=new qx.ui.container.Composite(c).set({decorator:o,backgroundColor:m,allowGrowX:false});
b.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,width:150}),{row:0,column:0});
var a=new qx.ui.basic.Label(l).set({decorator:o,backgroundColor:n,allowGrowX:false,width:50,height:50});
b.add(a,{row:0,column:1});
b.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,maxHeight:60,allowGrowX:false}),{row:1,column:0});
b.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,height:80}),{row:1,column:1});
b.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:2,column:0});
b.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:2,column:1});
var d=10;
a.addListener(k,function(e){a.setWidth(50+d);
d=-d;
});
return b;
},getGrid3:function(){var s=new qx.ui.container.Composite().set({decorator:o,backgroundColor:m,width:400,height:300,allowShrinkX:false,allowShrinkY:false});
var r=new qx.ui.layout.Grid();
r.setColumnFlex(1,2);
r.setRowFlex(1,3);
r.setSpacing(5);
s.setLayout(r);
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:0,column:0});
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:0,column:1});
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:1,column:0});
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}),{row:1,column:1});
return s;
}}});
})();
