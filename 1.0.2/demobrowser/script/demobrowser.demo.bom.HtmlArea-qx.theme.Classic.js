...
(function(){var bJ="0px",bI="outline",bH="mshtml",bG="hideFocus",bF="none",bE="true",bD="qx.client",bC="div",bB="16px",bA="840px",bp="left",bo="<option value=''></option>",bn="1px solid #AAA",bm="'>",bl="value='",bk="</option>",bj="change",bi="select",bh="clear:both",bg="Insert Table",bQ="Georgia",bR="<p>This low-level widget can be used separately at ",bO="http://",bP="Indent More",bM="Change font family",bN="demobrowser/demo/icons/htmlarea/format-fill-color.png",bK="Align Right",bL="Format Italic",bS="qx/icon/Oxygen/16/actions/format-text-underline.png",bT="350px",bt='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bs="white",bv="buttons at the toolbar.</p>",bu="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bx="qx/icon/Oxygen/16/actions/format-indent-more.png",bw="Comic Sans MS",bz="Tahoma",by="20px 20px",br="float",bq="<h1>HtmlArea low-level widget</h1>",a="Align Left",b="qx/icon/Oxygen/16/actions/format-justify-center.png",c="input",d="Align Justify",f="demobrowser/demo/icons/htmlarea/insert-text.png",g="Insert Horizontal Ruler",h="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",k="demobrowser/demo/icons/htmlarea/format-list-unordered.png",l="HTML Code:",m="Set Text Background Color",bX="Insert Link",bW="You can play around with this widget by hitting the ",bV="Undo Last Change",bU="Set Text Color",cc="demobrowser/demo/icons/htmlarea/format-text-color.png",cb="traditional web pages / single-page applications.<br/> ",ca="demobrowser/demo/icons/htmlarea/insert-table.png",bY="qx/icon/Oxygen/16/actions/edit-undo.png",ce="qx/icon/Oxygen/16/actions/edit-clear.png",cd="Arial Black",L="Impact",M="Change font size",J="Link: ",K="Redo Last Undo Step",P="Format Bold",Q="off",N="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",O="br",H="marginRight",I="image",u="<option qxKeepFocus='on' qxSelectable='off'",t="click",w="<option qxKeepFocus='on' qxSelectable='off' ",v="Remove Format",q="qx/icon/Oxygen/16/actions/insert-image.png",p="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",s="on",r="Insert HTML Code",o="qx/icon/Oxygen/16/actions/insert-link.png",n="Insert Ordered List",V="demobrowser.demo.bom.HtmlArea",W="qx/icon/Oxygen/16/actions/format-justify-left.png",X="Courier",Y="Courier New",R="4px",S="qx/icon/Oxygen/16/actions/format-justify-right.png",T="qx/icon/Oxygen/16/actions/format-text-bold.png",U="Insert Image",ba="qx/icon/Oxygen/16/actions/format-indent-less.png",bb="Times New Roman",E="",D="Align Center",C="qx/icon/Oxygen/16/actions/edit-redo.png",B="Lucida Console",A="innerHTML",z="qx/icon/Oxygen/16/actions/format-text-italic.png",y="Arial",x="qx/icon/Oxygen/16/actions/format-justify-fill.png",G="Verdana",F="Indent Less",bc="Format Strikethrough",bd="Format Underline",be="Inserted Unordered List",bf="It is the foundation for the UI widget component.</p>";
qx.Class.define(V,{extend:qx.application.Native,members:{__KP:null,__KQ:null,__KR:null,__KS:null,__KT:null,main:function(){arguments.callee.base.call(this);
this.__KP=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__KP,{margin:by});
var cx=qx.bom.Element.create(bC);
qx.bom.element.Style.setStyles(cx,{width:bA,padding:bJ,margin:bJ});
var cw=bq+bR+cb+bf+p+bW+bv;
qx.bom.element.Attribute.set(cx,A,cw);
this.__KQ=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__KQ,{width:bA,padding:bJ,margin:bJ,lineHeight:bJ,border:bn});
this.__KR=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__KR,{width:bA,height:bT,border:bn,borderTop:bJ,backgroundColor:bs});
qx.dom.Element.insertEnd(this.__KR,this.__KP);
var cv=bt;
this.__KS=new qx.bom.htmlarea.HtmlArea(this.__KR,cv,null,"blank.html");
this.__Le();
qx.dom.Element.insertBegin(this.__KQ,this.__KP);
qx.dom.Element.insertBegin(cx,this.__KP);
qx.dom.Element.insertBegin(this.__KP,document.body);
},__KU:function(e){var cf=window.prompt("FontSize: ","");
this.setFontSize(parseInt(cf));
},__KV:function(e){var cy=window.prompt("Color (Hex): ","#");
this.setTextColor(cy);
},__KW:function(e){var cE=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(cE);
},__KX:function(e){var cL={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(cL);
},__KY:function(e){var cF="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(cF);
},__La:function(e){var co=window.prompt(J,bO);
this.insertHyperLink(co);
},__Lb:function(e){var cK=window.prompt(l,E);
this.insertHtml(cK);
},__Lc:function(){var cq=qx.bom.Element.create(bC);
qx.bom.element.Style.setStyles(cq,{"float":bp});
var cs;
var cr=qx.bom.Element.create(bi,{title:bM});

if(qx.core.Variant.isSet(bD,bH)){qx.bom.element.Attribute.set(cr,bG,bE);
}else{qx.bom.element.Style.set(cr,bI,bF);
}cs=qx.bom.Collection.html(bo);
qx.dom.Element.insertEnd(cs[0],cr);
var ct=[bz,G,bb,y,cd,Y,X,bQ,L,bw,B];
var cp;
var cu;

for(var i=0,j=ct.length;i<j;i++){cp=u+bl+ct[i]+bm+ct[i]+bk;
cu=qx.bom.Collection.html(cp);

if(qx.core.Variant.isSet(bD,bH)){qx.bom.element.Attribute.set(cu[0],bG,bE);
}else{qx.bom.element.Style.set(cu[0],bI,bF);
}qx.dom.Element.insertEnd(cu[0],cr);
}qx.event.Registration.addListener(cr,bj,function(e){var cI=e.getTarget();
var cJ=cI.selectedIndex;

if(cJ!=0){this.setFontFamily(cI.options[cJ].value);
cI.options[0].selected=true;
}},this.__KS);
qx.dom.Element.insertBegin(cr,cq);
return cq;
},__Ld:function(){var cA=qx.bom.Element.create(bC);
qx.bom.element.Style.setStyles(cA,{"marginRight":bB,"float":bp});
var cC;
var cB=qx.bom.Element.create(bi,{title:M});

if(qx.core.Variant.isSet(bD,bH)){qx.bom.element.Attribute.set(cB,bG,bE);
}else{qx.bom.element.Style.set(cB,bI,bF);
}cC=qx.bom.Collection.html(bo);
qx.dom.Element.insertEnd(cC[0],cB);
var cD;
var cz;

for(var i=1;i<=7;i++){cz=w+bl+i+bm+i+bk;
cD=qx.bom.Collection.html(cz);

if(qx.core.Variant.isSet(bD,bH)){qx.bom.element.Attribute.set(cD[0],bG,bE);
}else{qx.bom.element.Style.set(cD[0],bI,bF);
}qx.dom.Element.insertEnd(cD[0],cB);
}qx.event.Registration.addListener(cB,bj,function(e){var cG=e.getTarget();
var cH=cG.selectedIndex;

if(cH!=0){this.setFontSize(cG.options[cH].value);
cG.options[0].selected=true;
}},this.__KS);
qx.dom.Element.insertBegin(cB,cA);
return cA;
},__Le:function(){var ch=[{bold:{text:P,image:T,action:this.__KS.setBold},italic:{text:bL,image:z,action:this.__KS.setItalic},underline:{text:bd,image:bS,action:this.__KS.setUnderline},strikethrough:{text:bc,image:N,action:this.__KS.setStrikeThrough},removeFormat:{text:v,image:ce,action:this.__KS.removeFormat}},{alignLeft:{text:a,image:W,action:this.__KS.setJustifyLeft},alignCenter:{text:D,image:b,action:this.__KS.setJustifyCenter},alignRight:{text:bK,image:S,action:this.__KS.setJustifyRight},alignJustify:{text:d,image:x,action:this.__KS.setJustifyFull}},{fontFamily:{custom:this.__Lc},fontSize:{custom:this.__Ld},fontColor:{text:bU,image:cc,action:this.__KV},textBackgroundColor:{text:m,image:bN,action:this.__KW}},{indent:{text:bP,image:bx,action:this.__KS.insertIndent},outdent:{text:F,image:ba,action:this.__KS.insertOutdent}},{insertImage:{text:U,image:q,action:this.__KX},insertTable:{text:bg,image:ca,action:this.__KY},insertLink:{text:bX,image:o,action:this.__La},insertHTML:{text:r,image:f,action:this.__Lb},insertHR:{text:g,image:h,action:this.__KS.insertHorizontalRuler}},{ol:{text:n,image:bu,action:this.__KS.insertOrderedList},ul:{text:be,image:k,action:this.__KS.insertUnorderedList}},{undo:{text:bV,image:bY,action:this.__KS.undo},redo:{text:K,image:C,action:this.__KS.redo}}];
var cj,cn,cg,cl;

for(var i=0,j=ch.length;i<j;i++){cn={};
cn[H]=i==j-1?bJ:bB;
cn[br]=bp;
cj=qx.bom.Element.create(bC);
qx.bom.element.Style.setStyles(cj,cn);

for(var ck in ch[i]){var cm=ch[i][ck];

if(cm.custom){cg=cm.custom.call(this);
}else{var ci=qx.util.AliasManager.getInstance().resolve(cm.image);
cl={type:I,src:qx.util.ResourceManager.getInstance().toUri(ci),title:cm.text,qxKeepFocus:s,qxSelectable:Q};
cg=qx.bom.Element.create(c,cl);
qx.bom.element.Style.setStyles(cg,{width:bB,height:bB,padding:R});

if(qx.core.Variant.isSet(bD,bH)){qx.bom.element.Attribute.set(cg,bG,bE);
}else{qx.bom.element.Style.set(cg,bI,bF);
}qx.event.Registration.addListener(cg,t,cm.action,this.__KS);
}qx.dom.Element.insertEnd(cg,cj);
}qx.dom.Element.insertEnd(cj,this.__KQ);
}qx.dom.Element.insertEnd(qx.bom.Element.create(O,{style:bh}),this.__KQ);
}}});
})();
