...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Flash-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"48c9666024cb"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var k="execute",j="Flash Player Version",i="__MJ",h="__MH",g="right",f="Message from Flash:",d="Simple demo with FlashVars",c="bgcolor",b="demobrowser.demo.widget.Flash",a="demobrowser/demo/flash/FlashVersion.swf",y="Flash:",x="<b>qooxdoo:</b>",w="__MI",v="__MK",u="demobrowser.demo.widget.Flash.sendMessage",t="demobrowser.demo.widget.Flash.flashReady",s="demobrowser/demo/flash/fo_tester.swf",r="this is passed in via FlashVars",q="Two way communication (ActionScript <-> JavaScript)",p="Message to Flash:",n="Show Flash Player version",o="__MG",l="noscale",m="#FF6600";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__MG:null,main:function(){arguments.callee.base.call(this);
var G=new qx.ui.tabview.TabView();
G.setContentPadding([8,8,8,8]);
var J=this.getRoot();
J.add(G,{edge:0});
var H=new qx.ui.tabview.Page(d);
H.setLayout(new qx.ui.layout.Canvas());
H.add(this.createFlashDemo1(),{edge:0});
G.add(H);
var I=new qx.ui.tabview.Page(q);
I.setLayout(new qx.ui.layout.Canvas());
I.add(this.createFlashDemo2(),{edge:0});
G.add(I);
this.__MG=this.createWindow();
J.add(this.__MG,{top:20,left:20});
...
D.add(new qx.ui.embed.Flash(a),{edge:0});
return D;
},createFlashDemo1:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var z={flashVarText:r};
var A=new qx.ui.embed.Flash(s).set({scale:l,variables:z});
A.getContentElement().setParam(c,m);
B.add(A,{flex:1});
var C=new qx.ui.form.Button(n);
C.addListener(k,function(){this.__MG.open();
},this);
B.add(C);
return B;
},__MH:null,__MI:null,__MJ:null,__MK:null,createFlashDemo2:function(){arguments.callee.self.setCallBackInstance(this);
var N=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var M=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
N.add(M,{flex:1});
M.add(new qx.ui.basic.Label(x).set({rich:true}));
M.add(new qx.ui.basic.Label(f));
this.__MI=new qx.ui.form.TextArea("No message.");
this.__MI.setEnabled(false);
M.add(this.__MI,{flex:1});
M.add(new qx.ui.basic.Label(p));
this.__MJ=new qx.ui.form.TextArea("qooxdoo is the best!");
M.add(this.__MJ,{flex:1});
var O=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,g));
this.__MK=new qx.ui.form.Button("Send to Flash");
this.__MK.setEnabled(false);
this.__MK.addListener(k,function(e){this.__MH.getFlashElement().sendMessage(this.__MJ.getValue());
},this);
O.add(this.__MK);
M.add(O);
var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
N.add(L,{flex:1});
L.add(new qx.ui.basic.Label(y).set({rich:true}));
this.__MH=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__MH.setVariables({init:t});
L.add(this.__MH,{flex:1});
return N;
},sendMessage:function(E){this.__MI.setValue(E);
},initFlash:function(){if(this.__MH.getFlashElement().setup){this.__MH.getFlashElement().setup(u);
this.__MK.setEnabled(true);
...
}}},statics:{__ML:null,setCallBackInstance:function(K){demobrowser.demo.widget.Flash.__ML=K;
},sendMessage:function(F){demobrowser.demo.widget.Flash.__ML.sendMessage(F);
},flashReady:function(){demobrowser.demo.widget.Flash.__ML.initFlash();
}},destruct:function(){this._disposeObjects(w,i,v,h,o);
}});
})();
...
qx.Class.define(p,{extend:qx.ui.core.Widget,construct:function(bn,bo){arguments.callee.base.call(this);
{};
this.setSource(bn);
...
},properties:{source:{check:g,apply:A},id:{check:g,apply:m},quality:{check:[c,x,G,C,n,f],init:f,nullable:true,apply:D},scale:{check:[Q,r,N,w],nullable:true,apply:H},wmode:{check:[u,h,l],init:h,nullable:true,apply:q},play:{check:j,nullable:true,apply:K},loop:{check:j,nullable:true,apply:b},mayScript:{check:j,nullable:false,apply:E},menu:{check:j,nullable:true,apply:M},allowScriptAccess:{check:[i,F,v],init:i,nullable:true,apply:R},liveConnect:{check:j,init:true,nullable:true,apply:t},variables:{init:{},check:P,apply:d}},members:{getFlashElement:function(){var bk=this.getContentElement();

if(bk){return bk.getFlashElement();
}else{return null;
}},_createContentElement:function(){return new qx.html.Flash();
},_applySource:function(S,T){var U=qx.util.ResourceManager.getInstance().toUri(S);
this.getContentElement().setSource(U);
qx.ui.core.queue.Layout.add(this);
},_applyId:function(bv,bw){this.getContentElement().setId(bv);
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(be,bf){this.getContentElement().setVariables(be);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(bt,bu){this.getContentElement().setAttribute(z,bt?k:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(V,W){this.__Jk(e,V);
},_applyScale:function(bg,bh){this.__Jk(a,bg);
},_applyWmode:function(br,bs){this.__Jk(O,br);
},_applyPlay:function(bl,bm){this.__Jk(s,bl);
},_applyLoop:function(ba,bb){this.__Jk(J,ba);
},_applyMenu:function(bp,bq){this.__Jk(L,bp);
},_applyAllowScriptAccess:function(bc,bd){this.__Jk(I,bc);
},_applyLiveConnect:function(bi,bj){this.__Jk(o,bi);
},__Jk:function(X,Y){this.getContentElement().setParam(X,Y);
qx.ui.core.queue.Layout.add(this);
}}});
})();
(function(){var d="movie",c="id",b="div",a="qx.html.Flash";
qx.Class.define(a,{extend:qx.html.Element,construct:function(){arguments.callee.base.call(this);
this.__EM={};
this.__EN={};
this.__EO={};
},members:{__EM:null,__EO:null,__EN:null,__EP:null,_createDomElement:function(){return qx.bom.Element.create(b);
},createFlash:function(){this.__EP=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__EN,this.__EM);
},setSource:function(h){{};

if(this.__EP){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(d,h);
},setId:function(i){{};

if(this.__EP){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(c,i);
},getVariables:function(){return this.__EN;
},setVariables:function(e){{};

if(this.__EP){throw new Error("The variables cannot be modified after initial creation");
}this.__EN=e;
},getAttributes:function(){return this.__EO;
},setAttribute:function(j,k){{};

if(this.__EP){throw new Error("The attributes cannot be modified after initial creation");
}
if(k===null||k===undefined){delete this.__EO[j];
}else{this.__EO[j]=k;
}},getParams:function(){return this.__EM;
},setParam:function(f,g){{};

if(this.__EP){throw new Error("The params cannot be modified after initial creation");
}
if(g===null||g===undefined){delete this.__EM[f];
}else{this.__EM[f]=g;
}},getFlashElement:function(){return this.__EP;
}},destruct:function(){if(this.__EP){qx.bom.Flash.destroy(this.__EP);
}this.__EM=this.__EN=this.__EO=null;
}});
})();
