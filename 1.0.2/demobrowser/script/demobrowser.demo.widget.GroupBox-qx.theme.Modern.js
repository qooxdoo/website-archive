...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.GroupBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cf88d69a4a71"},
  boot : "boot",
  bootIsInline : true,
