...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ListControllerWith3Widgets-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"ec845cb12091"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var A="execute",z="Item ",y="Write data to log",x="Add an item",w="<b>SelectBox</b>",v="Remove an item",u="<b>List</b><br/>",t="multi",s="All 3 widgets share the same data model. The List and the SelectBox ",r="demobrowser.demo.data.ListControllerWith3Widgets",p="<b>ComboBox</b><br/>",q="also share the same selection.";
qx.Class.define(r,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var k=[];

for(var i=0;i<30;i++){k.push(z+i);
}var m=new qx.data.Array(k);
var d=new qx.ui.form.List();
var a=new qx.ui.form.SelectBox();
var c=new qx.ui.form.ComboBox();
this.getRoot().add(d,{left:10,top:80});
d.setSelectionMode(t);
this.getRoot().add(a,{left:120,top:80});
this.getRoot().add(c,{left:250,top:80});
var h=new qx.data.controller.List(m,d);
var g=new qx.data.controller.List(m,a);
new qx.data.controller.List(m,c);
g.setSelection(h.getSelection());
var n=new qx.ui.form.Button(x);
n.setWidth(120);
this.getRoot().add(n,{left:380,top:80});
n.addListener(A,function(){m.push(z+m.length);
},this);
var e=new qx.ui.form.Button(v);
e.setWidth(120);
this.getRoot().add(e,{left:380,top:115});
e.addListener(A,function(){m.pop();
},this);
var j=new qx.ui.form.Button(y);
j.setWidth(120);
this.getRoot().add(j,{left:380,top:150});
j.addListener(A,function(){qx.log.appender.Console.show();
...
l.setWidth(100);
l.setValue(u);
this.getRoot().add(l,{left:20,top:10});
var b=new qx.ui.basic.Label();
b.setRich(true);
b.setWidth(100);
b.setValue(w);
this.getRoot().add(b,{left:130,top:10});
var o=new qx.ui.basic.Label();
o.setRich(true);
o.setWidth(100);
o.setValue(p);
this.getRoot().add(o,{left:260,top:10});
var f=new qx.ui.basic.Label();
f.setRich(true);
f.setWidth(360);
f.setValue(s+q);
this.getRoot().add(f,{left:20,top:30});
}}});
})();
