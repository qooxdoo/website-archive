...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.SplitPane-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"797bf4f699c0"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var m="value",l="horizontal",k="first",j="both",h="Trash",g="second",f="main",d="Show first pane",c="Documents (D:)",b="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",I="Windows (C:)",H="Toggle Splitpane Orientation",G="__Ng",F="Inbox",E="Desktop",D="_container1",C="execute",B="Presets",A="Network",z="changeSelection",t="Sent",u="/",r="Files",s="_container2",p="vertical",q="Workspace",n="Junk #",o="Data",v="Show both panes",w="Show second pane",y="demobrowser.demo.widget.SplitPane",x="Edit";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__Ng:null,main:function(){arguments.callee.base.call(this);
var L=new qx.ui.container.Scroll();
var K=new qx.ui.container.Composite(new qx.ui.layout.Basic());
K.setAllowStretchX(false);
L.add(K);
var R=new qx.ui.splitpane.Pane(l).set({width:450,height:300});
this.__Ng=R;
var U=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:f});
var X=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:f});
var O=this.__Nh();
var N=new qx.ui.form.Button(H).set({allowGrowX:false,allowGrowY:false});
...
var V=new qx.ui.form.RadioButton(d);
...
N.focus();
},_toggle:function(){var a=this.__Ng.getOrientation();
this.__Ng.setOrientation(a==l?p:l);
},_changeVisiblity:function(e){var J=e.getData()[0].getUserData(m);

if(J==j){this._container1.show();
this._container2.show();
}else if(J==k){this._container1.show();
this._container2.exclude();
}else if(J==g){this._container1.exclude();
this._container2.show();
}},__Nh:function(){var bi=new qx.ui.tree.Tree();
bi.setDecorator(null);
var bn=new qx.ui.tree.TreeFolder(u);
bn.setOpen(true);
bi.setRoot(bn);
var bl=new qx.ui.tree.TreeFolder(E);
bl.setOpen(true);
bn.add(bl);
var bd=new qx.ui.tree.TreeFolder(r);
var bb=new qx.ui.tree.TreeFolder(q);
var bc=new qx.ui.tree.TreeFolder(A);
var ba=new qx.ui.tree.TreeFolder(h);
bl.add(bd,bb,bc,ba);
var bj=new qx.ui.tree.TreeFile(I);
var Y=new qx.ui.tree.TreeFile(c);
bb.add(bj,Y);
var bm=new qx.ui.tree.TreeFolder(F);
var be=new qx.ui.tree.TreeFolder(B);
var bh=new qx.ui.tree.TreeFolder(t);
var bg=new qx.ui.tree.TreeFolder(h);

for(var i=0;i<100;i++){bg.add(new qx.ui.tree.TreeFile(n+i));
}var bk=new qx.ui.tree.TreeFolder(o);
var bf=new qx.ui.tree.TreeFolder(x);
bm.add(be,bh,bg,bk,bf);
bn.add(bm);
return bi;
}},destruct:function(){this._disposeObjects(G,D,s);
}});
})();
