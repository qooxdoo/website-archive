...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.KeyEvent-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"309c4ed95e18"},
  boot : "boot",
  bootIsInline : true,
