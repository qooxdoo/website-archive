...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.HtmlArea","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.HtmlArea-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"2ce9da9960a8"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(o,{extend:qx.application.Standalone,members:{__MM:null,main:function(){arguments.callee.base.call(this);
var O=h+k+g+c+d+n+a+b;
var J=new qx.ui.basic.Label(O);
J.set({rich:true,marginBottom:10});
var N=m;
var M=this.getRoot();
var L=new qx.ui.decoration.Single(1,l,f);
L.setWidthTop(0);
this.__MM=new qx.ui.embed.HtmlArea(N,null,"blank.html");
this.__MM.set({width:600,height:400,decorator:L});
var toolbar=this.__MW();
var I=new qx.ui.layout.VBox(0);
var K=new qx.ui.container.Composite(I);
K.add(J);
K.add(toolbar);
K.add(this.__MM);
M.add(K,{left:20,top:20});
},__MN:function(e){var Q=window.prompt("Color (Hex): ","#");
this.setTextColor(Q);
},__MO:function(e){var P=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(P);
},__MP:function(e){var S={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(S);
},__MQ:function(e){var H="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(H);
},__MR:function(e){var y=new qx.ui.window.Window("Insert Hyperlink");
y.setLayout(new qx.ui.layout.VBox(20));
y.set({width:400,showMaximize:false,showMinimize:false});
var C=new qx.ui.form.TextField("http://");
y.add(C);
var A=new qx.ui.layout.HBox(10);
A.setAlignX("right");
var B=new qx.ui.container.Composite(A);
var x=new qx.ui.form.Button("OK");
x.setWidth(60);
x.addListener("execute",function(e){this.insertHyperLink(C.getValue());
y.close();
},this);
B.add(x);
var z=new qx.ui.form.Button("Cancel");
z.setWidth(60);
z.addListener("execute",function(e){y.close();
},this);
B.add(z);
y.add(B);
y.center();
y.open();
this.saveRange();
},__MS:function(e){var G=window.prompt("HTML Code:","");
this.insertHtml(G);
},__MT:function(){var q=new qx.ui.form.SelectBox;
q.set({toolTipText:"Change Font Family",focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
q.add(new qx.ui.form.ListItem(""));
var r=["Tahoma","Verdana","Times New Roman","Arial","Arial Black","Courier New","Courier","Georgia","Impact","Comic Sans MS","Lucida Console"];
var p;

for(var i=0,j=r.length;i<j;i++){p=new qx.ui.form.ListItem(r[i]);
p.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString("12px "+r[i])});
q.add(p);
}q.addListener("changeSelection",function(e){var D=e.getData()[0].getLabel();

if(D!=""){this.setFontFamily(D);
q.setSelection([q.getChildren()[0]]);
}},this.__MM);
return q;
},__MU:function(){var F=new qx.ui.form.SelectBox;
F.set({toolTipText:"Change Font Size",focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
F.add(new qx.ui.form.ListItem(""));
var E;

for(var i=1;i<=7;i++){E=new qx.ui.form.ListItem(i+"");
E.set({focusable:false,keepFocus:true});
F.add(E);
}F.addListener("changeSelection",function(e){var R=e.getData()[0].getLabel();

if(R!=""){this.setFontSize(R);
F.setSelection([F.getChildren()[0]]);
}},this.__MM);
return F;
},__MV:function(){return [{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__MM.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__MM.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__MM.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__MM.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__MM.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__MM.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__MM.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__MM.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__MM.setJustifyFull}},{fontFamily:{custom:this.__MT},fontSize:{custom:this.__MU},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__MN},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__MO}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__MM.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__MM.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__MP},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__MQ},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__MR},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__MS},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__MM.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__MM.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__MM.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__MM.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__MM.redo}}];
},__MW:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator("main");
var s;
var t=this.__MV();

for(var i=0,j=t.length;i<j;i++){var u=new qx.ui.toolbar.Part;
toolbar.add(u);

for(var v in t[i]){var w=t[i][v];

if(w.custom){s=w.custom.call(this);
}else{s=new qx.ui.toolbar.Button(null,w.image);
s.set({focusable:false,keepFocus:true,center:true,toolTipText:w.text?w.text:""});
s.addListener("execute",w.action,this.__MM);
}u.add(s);
}}return toolbar;
}}});
})();
