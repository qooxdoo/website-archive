...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.ManualLayout-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"82ee4fe524f3"},
  boot : "boot",
  bootIsInline : true,
