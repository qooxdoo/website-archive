...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Resize_Columns-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"6ec6b0d40cca"},
  boot : "boot",
  bootIsInline : true,
...
},createTable:function(){var A=this.createRandomRows(50);
var y=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
y.setColumns([g,m,c,f]);
y.setData(A);
var x={tableColumnModel:function(I){return new qx.ui.table.columnmodel.Resize(I);
}};
var B=this._table=new qx.ui.table.Table(y,x);
B.set({width:600,height:400});
B.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var z=B.getTableColumnModel();
var w=z.getBehavior();
w.set(0,{width:k,minWidth:40,maxWidth:80});
w.setWidth(1,i);
w.setMinWidth(1,100);
w.setMaxWidth(1,320);
var z=B.getTableColumnModel();
z.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
return B;
...
E.addListener(r,function(u){var v=this.createRandomRows(10);
this._tableModel.addRows(v);
this.info("10 rows added");
},this);
F.add(E);
E=new qx.ui.toolbar.Button(p,d);
E.addListener(r,function(s){var t=this._tableModel.getRowCount();
this._tableModel.removeRows(t-10,10);
...
H.addListener(h,function(C){D.setKeepFirstVisibleRowComplete(this.getValue());
},H);
F.add(H);
return G;
