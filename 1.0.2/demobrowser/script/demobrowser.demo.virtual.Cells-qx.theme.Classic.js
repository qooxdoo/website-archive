...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Cells-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"64891ba42522"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var J="",I="' ",H="<b>HTML</b>",G="px;",F="Juhu",E="testImageCell",D="qx.theme",C="</div>",B="<div ",A="testNumberCell",be="class='",bd="width:",bc="testHtmlCell",bb="testDateCell",ba=">",Y="height:",X="testStringCell",W="testBooleanCellCustomImage",V="demobrowser.demo.virtual.Cells",U="testBooleanCell",Q="foobar!",R="qx.theme.Modern",O="icon/32/apps/utilities-notes.png",P="medium",M="main",N="icon/16/emotes/face-sad.png",K="icon/16/apps/internet-feed-reader.png",L="icon/16/emotes/face-smile.png",S="This is a feed reader!",T="style='";
qx.Class.define(V,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var v=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(v);
this.runTest(X);
this.runTest(A);
this.runTest(bb);
this.runTest(bc);
if(qx.core.Setting.get(D)==R){this.runTest(E);
this.runTest(U);
this.runTest(W);
}this.getRoot().add(this.topContainer,{edge:5});
},runTest:function(bs){this.setUp();
this[bs]();
...
},testStringCell:function(){var bg={value:[F,H,J,null],states:[{},{selected:1}]};
var bf=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(bg,function(bt){var bu=this.__Mi(bf,bt.value,bt.states);
this.container.add(bu);
},this);
},testNumberCell:function(){var bh={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var bi=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(bh,function(m){if(m.format){bi.setNumberFormat(m.format);
}else{bi.resetNumberFormat();
}var n=this.__Mi(bi,m.value,m.states);
this.container.add(n);
},this);
},testDateCell:function(){var w={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(P))],states:[{},{selected:1}]};
var x=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(w,function(e){if(e.format){x.setDateFormat(e.format);
}else{x.resetDateFormat();
}var f=this.__Mi(x,e.value,e.states);
this.container.add(f);
},this);
},testHtmlCell:function(){var a={value:[F,H,J,null],states:[{},{selected:1}]};
var b=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(a,function(c){var d=this.__Mi(b,c.value,c.states);
this.container.add(d);
},this);
},testImageCell:function(){var bv={value:[{url:K,tooltip:S},{url:O,tooltip:Q},null],states:[{},{selected:1}]};
var bw=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(bv,function(k){var l=this.__Mi(bw,k.value,k.states);
this.container.add(l);
},this);
},testBooleanCell:function(){var i={value:[true,false,null],states:[{},{selected:1}]};
var j=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(i,function(y){var z=this.__Mi(j,y.value,y.states);
this.container.add(z);
},this);
},testBooleanCellCustomImage:function(){var g={value:[true,false,null],states:[{},{selected:1}]};
var h=new qx.ui.virtual.cell.Boolean;
h.setIconFalse(N);
h.setIconTrue(L);
qx.util.Permutation.permute(g,function(o){var p=this.__Mi(h,o.value,o.states);
this.container.add(p);
},this);
},__Mi:function(bj,bk,bl){var bp=100;
var bn=30;
var br=new qx.ui.embed.Html().set({width:bp,height:bn,decorator:bl.selected?null:M});
var bm=bj.getCellProperties(bk,bl);
var bo=bm.insets;
var bq=[B,T,this._getCellSizeStyle(bp,bn,bo[0],bo[1]),bm.style,I,be,bm.classes,I,bm.attributes,ba,bm.content,C].join(J);
br.setHtml(bq);
return br;
...
(function(){var u="",t="px",s='" ',r="no-repeat",q='"',p='" style="',o='title="',n='<div style="',m='></div>',l="qx.ui.virtual.cell.AbstractImage",f="img",k="inline-block",i='/>',e="static",d="top",h='<img src="',g="abstract",j="-moz-inline-box";
qx.Class.define(l,{extend:qx.ui.virtual.cell.Cell,type:g,construct:function(){arguments.callee.base.call(this);
this._aliasManager=qx.util.AliasManager.getInstance();
},members:{__FE:16,__FF:16,_aliasManager:null,__FG:function(F){var I=qx.util.ResourceManager.getInstance();
var H=qx.io.ImageLoader;
var G,J;
if(I.has(F)){G=I.getImageWidth(F),J=I.getImageHeight(F);
}else if(H.isLoaded(F)){G=H.getWidth(F);
J=H.getHeight(F);
}else{G=this.__FE;
J=this.__FF;
}return {width:G,height:J};
},__FH:function(a){if(typeof (a)=="string"){a={url:a};
...
},getContent:function(v,w){if(v===null){return u;
}var content=u;
var y=this.__FH(this._identifyImage(v));
var C=qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9;
var z=y.tooltip?o+y.tooltip+q:u;
var x={width:y.width+t,height:y.height+t,display:C?j:k,verticalAlign:d,position:e};
var A=qx.bom.element.Decoration.getTagName(r,y.url);
var B=qx.bom.element.Decoration.getAttributes(y.url,r,x);
var D=qx.bom.element.Style.compile(B.style);

if(A===f){content=h+B.src+p+D+s;
content+=z+i;
}else{content=n+D+s;
content+=z+m;
}return content;
...
this.__FI=qx.util.AliasManager.getInstance();
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__FJ:null,__FK:null,__FI:null,_applyIconTrue:function(h){this.__FJ=this.__FI.resolve(h);
},_applyIconFalse:function(f){this.__FK=this.__FI.resolve(f);
},_identifyImage:function(g){return g==true?this.__FJ:this.__FK;
}}});
})();
