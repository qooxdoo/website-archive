...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ScrollContainer_EdgeCaseWidth-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c8c786cae9ae"},
  boot : "boot",
  bootIsInline : true,
