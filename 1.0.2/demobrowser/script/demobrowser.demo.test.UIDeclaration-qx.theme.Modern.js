...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.UIDeclaration-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"55dc31d1de12"},
  boot : "boot",
  bootIsInline : true,
