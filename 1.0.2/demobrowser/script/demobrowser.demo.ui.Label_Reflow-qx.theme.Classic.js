...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.Label_Reflow","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.Label_Reflow-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"4db4299369b6"},
  boot : "boot",
  bootIsInline : true,
...
var t=new qx.ui.container.Scroll();
var r=new qx.ui.layout.Grid();
r.setColumnFlex(0,1);
r.setRowFlex(0,1);
r.setSpacing(10);
var s=new qx.ui.container.Composite(r).set({backgroundColor:b,decorator:m,padding:10,allowGrowX:false,allowGrowY:false,allowStretchX:false,allowStretchY:false});
t.add(s);
this.getRoot().add(t,{edge:0});
var x=this.getPane();
s.add(x,{row:0,column:0,colSpan:3});
var v=new qx.ui.basic.Label(c).set({backgroundColor:j,decorator:m,padding:[4,8]});
s.add(v,{row:1,column:1});
var u=false;
v.addListener(k,function(){var z=x.getChildren()[0];
z.setValue(u?l:i);
u=!u;
});
var w=new qx.ui.basic.Label(a).set({backgroundColor:j,decorator:m,padding:[4,8]});
s.add(w,{row:1,column:2});
var y=false;
w.addListener(k,function(e){if(y){x.setWidth(600);
}else{x.setWidth(300);
}y=!y;
});
},getPane:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:g,width:600,decorator:m,padding:10});
var n=new qx.ui.basic.Label().set({rich:true,value:l});
q.add(n);
var o=new qx.ui.basic.Label().set({rich:true,value:f});
q.add(o);
var p=new qx.ui.basic.Label().set({rich:true,value:h});
q.add(p);
return q;
}}});
})();
