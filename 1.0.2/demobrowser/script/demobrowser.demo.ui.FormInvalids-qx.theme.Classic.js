...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.FormInvalids-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"8963b38e64f3"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="changeValue",n="I am a box",m=" invalidate all shown widgets. Try the invalid focus and tooltip.",l="disable tooltips",k="RadioGroup 2",j=")",h="RadioGroup 1",g="Invalid (",f="demobrowser.demo.ui.FormInvalids",d="disabled",a="<b>Validation</b><br/>Press the button to",c="Item ",b="invalid";
qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var w=[];
w.push(new qx.ui.form.Spinner());
this.getRoot().add(w[0],{left:20,top:70});
w.push(new qx.ui.form.Slider());
w[1].setWidth(200);
this.getRoot().add(w[1],{left:20,top:100});
w.push(new qx.ui.form.TextField());
this.getRoot().add(w[2],{left:20,top:130});
w.push(new qx.ui.form.TextArea());
this.getRoot().add(w[3],{left:20,top:160});
w.push(new qx.ui.form.PasswordField());
this.getRoot().add(w[4],{left:20,top:240});
w.push(new qx.ui.form.ComboBox());
this.getRoot().add(w[5],{left:20,top:270});
w.push(new qx.ui.form.SelectBox());
this.getRoot().add(w[6],{left:20,top:300});
w.push(new qx.ui.form.CheckBox());
this.getRoot().add(w[7],{left:20,top:330});
w.push(new qx.ui.form.RadioButton());
this.getRoot().add(w[8],{left:20,top:350});
w.push(new qx.ui.groupbox.GroupBox(n));
this.getRoot().add(w[9],{left:240,top:70});
w.push(new qx.ui.groupbox.RadioGroupBox(n));
this.getRoot().add(w[10],{left:240,top:170});
w.push(new qx.ui.groupbox.CheckGroupBox(n));
this.getRoot().add(w[11],{left:240,top:270});
w.push(new qx.ui.form.List());
this.getRoot().add(w[12],{left:390,top:70});

for(var i=0;i<10;i++){w[12].add(new qx.ui.form.ListItem(c+(i+1)));
}w.push(new qx.ui.form.DateField());
this.getRoot().add(w[13],{left:390,top:280});
w.push(new qx.ui.control.DateChooser());
this.getRoot().add(w[14],{left:520,top:70});
var t=new qx.ui.form.RadioGroup();
var p=new qx.ui.form.RadioButton(h);
t.add(p);
this.getRoot().add(p,{left:530,top:250});
var q=new qx.ui.form.RadioButton(k);
t.add(q);
this.getRoot().add(q,{left:530,top:270});
w.push(t);
var s=new qx.ui.form.ToggleButton(b);
this.getRoot().add(s,{left:260,top:20});
s.addListener(o,function(e){for(var i=0;i<w.length;i++){w[i].setInvalidMessage(g+i+j);
w[i].setValid(!e.getData());
}},this);
var u=new qx.ui.form.ToggleButton(d);
this.getRoot().add(u,{left:330,top:20});
u.addListener(o,function(e){for(var i=0;i<w.length;i++){w[i].setEnabled(!e.getData());
}},this);
var r=new qx.ui.form.ToggleButton(l);
this.getRoot().add(r,{left:410,top:20});
r.addListener(o,function(e){qx.ui.tooltip.Manager.getInstance().setShowInvalidTooltips(!e.getData());
},this);
var v=new qx.ui.basic.Label();
v.setRich(true);
v.setWidth(250);
v.setValue(a+m);
this.getRoot().add(v,{left:20,top:10});
}}});
})();
