...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_Scroller-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"dd14907881bb"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(e,{extend:qx.ui.container.Composite,include:[demobrowser.demo.table.MUtil],construct:function(){arguments.callee.base.call(this,new qx.ui.layout.Canvas());
