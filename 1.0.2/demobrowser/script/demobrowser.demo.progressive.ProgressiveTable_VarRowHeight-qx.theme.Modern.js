...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"95483699e8cf"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Ly:null,main:function(){arguments.callee.base.call(this);
var R=p;
...
++this.__Ly;
qx.io.ImageLoader.load(Q,function(z,A){this.info("Searching for ["+z+"]");
for(var j=0;j<this.imageData.length;j++){if(this.imageData[j].url==z){this.imageData[j].height=A.height;
--this.__Ly;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Ly+", end="+this.imageData.length);
if(this.__Ly==0){this.doLoad();
}return;
}}throw new Error("Image data for "+z+" not found");
},this);
}if(this.__Ly==0){this.doLoad();
}},doLoad:function(){var C=this;
var J=function(w,x){var y={renderer:v,location:c,data:[x,C.imageData[w]]};
return y;
};
var I=new qx.ui.progressive.renderer.table.Widths(2);
I.setWidth(0,200);
I.setWidth(1,q);
var E=[e,h];
var F=new qx.ui.progressive.headfoot.TableHeading(I,E);
var D=new qx.ui.progressive.headfoot.Progress(I,E);
var M=new qx.ui.progressive.structure.Default(F,D);
var B=new qx.ui.progressive.Progressive(M);
var K=new qx.ui.basic.Atom(a);
K.setHeight(16);
K.setTextColor(l);
B.add(K);
...
H.addElements(G);
B.setDataModel(H);
var L=new qx.ui.progressive.renderer.table.Row(I);
B.addRenderer(v,L);
var r=new qx.ui.progressive.renderer.table.cell.Image();
L.addRenderer(1,r);
B.set({width:400,maxWidth:400});
this.getRoot().add(B,{left:50,top:50,bottom:50});
B.render();
}}});
})();
...
if(d===undefined){this.__DK=d;
}else{this.__DK=16;
}
if(e===undefined){this.__DL=e;
}else{this.__DL=16;
}},members:{__DK:null,__DL:null,_identifyImage:function(f){var j={imageWidth:this.__DK,imageHeight:this.__DL};
var k;
