...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Huge-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"b27d8eae0d1d"},
  boot : "boot",
  bootIsInline : true,
