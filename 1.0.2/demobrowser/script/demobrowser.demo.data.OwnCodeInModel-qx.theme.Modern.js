...
A.setLabelPath(q);
A.setIconOptions({converter:function(t){return r+t+m;
}});
A.setIconPath(k);
var B={getModelMixins:function(c){if(c==i){return demobrowser.demo.data.ItemsMixin;
}}};
var w=l;
var D=new qx.data.store.Json(w,B);
D.bind(o,A,p);
var C=new qx.ui.form.Button(g);
C.setWidth(120);
this.getRoot().add(C,{left:130,top:80});
C.addListener(s,function(){D.getModel().sortByType();
},this);
var z=new qx.ui.form.Button(f);
z.setWidth(120);
this.getRoot().add(z,{left:130,top:110});
z.addListener(s,function(){D.getModel().sortByName();
},this);
...
qx.Mixin.define(d,{members:{sortByType:function(){var u=this.getItems();
u.sort(function(a,b){if(a.getType()>b.getType()){return 1;
}else if(a.getType()<b.getType()){return -1;
}else{return 0;
}});
},sortByName:function(){var v=this.getItems();
v.sort(function(a,b){return a.getName()>b.getName()?1:-1;
});
}}});
})();
