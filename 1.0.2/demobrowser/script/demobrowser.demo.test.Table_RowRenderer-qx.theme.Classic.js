...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_RowRenderer-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a56b05bf6f15"},
  boot : "boot",
  bootIsInline : true,
