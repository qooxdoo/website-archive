...
o.add(this.getBox2());
o.add(this.getBox3());
},getBox1:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
m.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
m.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
m.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return m;
