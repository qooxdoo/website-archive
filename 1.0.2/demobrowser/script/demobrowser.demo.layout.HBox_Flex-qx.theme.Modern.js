...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Flex-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"996f414304de"},
  boot : "boot",
  bootIsInline : true,
...
s.add(this.getBox5());
s.add(this.getBox6());
},getBox1:function(){var e=new qx.ui.layout.HBox();
var f=new qx.ui.container.Composite(e).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
e.setSpacing(5);
...
return f;
},getBox2:function(){var g=new qx.ui.layout.HBox();
var h=new qx.ui.container.Composite(g).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
g.setSpacing(5);
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:30}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:150}),{flex:3});
return h;
},getBox3:function(){var n=new qx.ui.layout.HBox();
var p=new qx.ui.container.Composite(n).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
n.setSpacing(5);

for(var i=0;i<25;i++){var o=new qx.ui.core.Widget();
o.set({decorator:d,backgroundColor:c,width:5});
p.add(o,{flex:1});
}return p;
},getBox4:function(){var q=new qx.ui.layout.HBox();
var r=new qx.ui.container.Composite(q).set({width:600,minWidth:600,decorator:d,backgroundColor:b,allowGrowX:false});
q.setSpacing(5);
r.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:1});
r.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:2});
r.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:3});
return r;
},getBox5:function(){var l=new qx.ui.layout.HBox();
var m=new qx.ui.container.Composite(l).set({width:300,minWidth:0,decorator:d,backgroundColor:b,allowGrowX:false});
l.setSpacing(5);
m.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
m.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
m.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return m;
},getBox6:function(){var j=new qx.ui.layout.HBox();
var k=new qx.ui.container.Composite(j).set({width:300,decorator:d,backgroundColor:b,allowGrowX:false});
j.setSpacing(5);
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return k;
}}});
})();
