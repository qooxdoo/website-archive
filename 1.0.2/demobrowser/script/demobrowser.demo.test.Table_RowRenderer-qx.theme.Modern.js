...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_RowRenderer","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_RowRenderer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1151f77b46d2"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var x="px",w='" ',v='>',u="",t=";position:relative;height:",s="table",r=' (init)</div>',q='class="',p=" (update)",o="relative",i="div",n='style="',l="px;",h="px; width:",g=": ",k="demobrowser.demo.test.Table_RowRenderer",j=", ",m='<div ';
qx.Class.define(k,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
...
var self=this;
qx.util.Permutation.permute(D,function(a){var content=[];

for(var e in a){if(e!==s){content.push(e+g+a[e]);
}}content=content.join(j);
var f=self._createRowElement(C,F,E);
var b=B.getRowClass(a);

if(b){f.className=b;
}f.innerHTML=content+p;
B.updateDataRowElement(a,f);
var d=[];
d.push(m);

if(b){d.push(q,b,w);
}var c=B.createRowStyle(a);
c+=t+E+h+F+l;

if(c){d.push(n,c,w);
}d.push(v,content,r);
C.innerHTML+=d.join(u);
self._rowTop+=E;
});
},_rowTop:0,_createRowElement:function(parent,y,z){var A=qx.bom.Element.create(i);
qx.bom.element.Style.setStyles(A,{position:o,width:y+x,height:z+x});
this._rowTop+=20;
