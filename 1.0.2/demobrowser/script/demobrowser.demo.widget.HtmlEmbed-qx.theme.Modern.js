...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.HtmlEmbed-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7a5ed3e0e410"},
  boot : "boot",
  bootIsInline : true,
