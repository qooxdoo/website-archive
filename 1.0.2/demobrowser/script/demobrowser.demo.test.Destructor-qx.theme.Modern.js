...
(function(){var f="Window: ",e="interval",d="__LQ",c="Label: ",b="demobrowser.demo.test.Destructor";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__LO:null,__LP:0,__LQ:null,main:function(){arguments.callee.base.call(this);
this.__LO=[];
this.currentTest=this.testWindows;
this.__LQ=new qx.event.Timer(1000);
this.__LQ.addListener(e,this.runTest,this);
this.__LQ.start();
},runTest:function(){this.__LP++;
var j=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__LP+" (Registry: "+j+")");
this.currentTest();
...
this.__LO.push(a);
}},testWindows:function(){for(var i=0;i<5;i++){var g=new qx.ui.window.Window(f+i);
g.open();
this.__LO.push(g);
