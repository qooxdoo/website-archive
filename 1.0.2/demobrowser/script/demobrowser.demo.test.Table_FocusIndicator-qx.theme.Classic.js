...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_FocusIndicator-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"26ba82cba177"},
  boot : "boot",
  bootIsInline : true,
