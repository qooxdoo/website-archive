...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Pane_Row-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a077fa5ee1cd"},
  boot : "boot",
  bootIsInline : true,
