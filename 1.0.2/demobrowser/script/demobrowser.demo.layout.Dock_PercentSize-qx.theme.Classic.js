...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Dock_PercentSize-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"aa8c393ab1eb"},
  boot : "boot",
  bootIsInline : true,
