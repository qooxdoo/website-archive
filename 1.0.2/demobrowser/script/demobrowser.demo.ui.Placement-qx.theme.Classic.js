...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.Placement","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.Placement-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"862c3ec0a11b"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var x="mousedown",w="changeSelection",v="top-left",u="bottom-right",t="right-top",s="bottom-left",r="left-bottom",q="top-right",p="demobrowser.demo.ui.Placement",o="Open DOM-Popup",j="DOM Popup",n="Open Popup",m="Content",h="right-bottom",g="DOM align control",l="domanchor",k="left-top";
qx.Class.define(p,{extend:qx.application.Standalone,members:{__Mg:null,main:function(){arguments.callee.base.call(this);
var F=this.getRoot();
this.__Mg=[s,u,v,q,t,h,k,r];
F.add(this.createTestField(s),{left:20,top:20});
F.add(this.createTestField(u),{right:20,top:20});
F.add(this.createTestField(v),{right:20,bottom:20});
F.add(this.createTestField(q),{left:20,bottom:20});
F.add(this.createTestField(t),{left:20,top:250});
F.add(this.createTestField(r),{right:20,top:250});
F.add(this.createDomClick(),{left:200,top:100});
},createTestField:function(y){var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var A=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
A.add(new qx.ui.basic.Atom(m));
A.setPadding(20);
var z=new qx.ui.form.SelectBox;
var D=null;

for(var i=0;i<this.__Mg.length;i++){var B=new qx.ui.form.ListItem(this.__Mg[i]);
z.add(B);

if(this.__Mg[i]==y){D=B;
}}C.add(z);
z.addListener(w,function(e){A.setPosition(e.getData()[0].getLabel());
});
z.setSelection([D]);
var E=new qx.ui.form.Button(n);
C.add(E);
E.addListener(x,function(e){A.placeToWidget(E);
A.show();
});
return C;
},createDomClick:function(){var c=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var f=new qx.ui.basic.Label(g);
c.add(f);
var b=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
b.add(new qx.ui.basic.Atom(j));
b.setPadding(20);
var a=new qx.ui.form.SelectBox;

for(var i=0;i<this.__Mg.length;i++){a.add(new qx.ui.form.ListItem(this.__Mg[i]));
}c.add(a);
a.addListener(w,function(e){b.setPosition(e.getData()[0].getLabel());
});
var d=new qx.ui.form.Button(o);
c.add(d);
d.addListener(x,function(e){b.placeToElement(document.getElementById(l));
b.show();
});
return c;
