...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.showcase.Browser-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"097f74e9b33d"},
  boot : "boot",
  bootIsInline : true,
