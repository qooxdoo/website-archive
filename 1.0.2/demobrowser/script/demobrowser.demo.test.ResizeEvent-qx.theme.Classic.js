...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.ResizeEvent","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ResizeEvent-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"213338d1781a"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var f="resize",d="demobrowser.demo.test.ResizeEvent",c="red",b="click",a="blue";
qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var h=new qx.ui.core.Widget().set({backgroundColor:c,width:80});
var g=new qx.ui.core.Widget().set({backgroundColor:a});
this.getRoot().add(h,{left:10,top:10});
this.getRoot().add(g,{left:10,top:110});
h.addListener(f,function(e){this.debug("Resize red");
g.setWidth(e.getData().width);
});
h.addListener(b,function(){h.setWidth(h.getWidth()+10);
});
}}});
})();
