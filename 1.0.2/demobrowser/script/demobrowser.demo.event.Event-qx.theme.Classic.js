...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.Event-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"295d68cbaa6e"},
  boot : "boot",
  bootIsInline : true,
