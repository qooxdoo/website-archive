...
var p=1;
n.addListener(j,function(e){var k=new qx.ui.window.Window(f+p++).set({width:200,height:150});
k.moveTo(p*15,p*15);
k.open();
});
q.add(n);
...
q.add(o);
},cModWin:1,newModalWindow:function(){var l=new qx.ui.window.Window(c+this.cModWin++).set({modal:true});
l.moveTo(300+this.cModWin*15,this.cModWin*15);
l.setLayout(new qx.ui.layout.HBox());
var m=new qx.ui.form.Button(i);
m.addListener(j,this.newModalWindow,this);
l.add(m);
l.open();
}}});
})();
