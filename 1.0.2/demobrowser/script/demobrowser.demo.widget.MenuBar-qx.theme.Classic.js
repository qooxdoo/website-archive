...
(function(){var bH="execute",bG="changeValue",bF="icon/16/actions/system-search.png",bE="Online Forum",bD="New",bC="icon/16/actions/edit-cut.png",bB="Search in files",bA="icon/16/actions/format-justify-fill.png",bz="Left aligned",by="Undo",bn="_openCommand",bm="Uppercase",bl="View",bk="C Dialect",bj="changeSelection",bi="Save as...",bh="Show line numbers",bg="Search previous...",bf="Quickstart",be="Cut",bO="Ctrl+N",bP="C",bM="Show console",bN="Search",bK="Help",bL="_redoCommand",bI="Redo",bJ="Show status bar",bQ="icon/16/actions/format-justify-left.png",bR="ANSI to OEM",br="Centered",bq="Paragraph",bt="Edit",bs="Ctrl+O",bv="icon/16/actions/document-print.png",bu="icon/16/actions/document-open.png",bx="C Sharp",bw="icon/16/actions/edit-undo.png",bp="Close",bo="icon/16/actions/document-save-as.png",h="Python",i="icon/16/apps/utilities-help.png",j="Show tree",k="Spaces to tabs",l="Right aligned",m="OEM to ANSI",n="JavaScript",o="demobrowser.demo.widget.MenuBar",p="_copyCommand",q="XML",bV="Save",bU="_undoCommand",bT="Capitals",bS="icon/16/actions/application-exit.png",ca="C Plus Plus",bY="_saveCommand",bX="Lowercase",bW="Search next...",cc="_newCommand",cb="Replace in files",N="Perl",O="Ctrl+P",L="Topics",M="Panes",R="Justified",S="Ctrl+X",P="Show macros",Q="Show ruler",J="Copy",K="Paste",y="_pasteCommand",x="icon/16/actions/format-justify-right.png",A="Ctrl+Z",z="Ctrl+R",u="icon/16/actions/edit-redo.png",t="Show tags",w="Info...",v="Format",s="File",r="Show tabs",X="Print",Y="icon/16/actions/document-save.png",ba="icon/16/actions/edit-copy.png",bb="Search...",T="icon/16/actions/format-justify-center.png",U="Open",V="_cutCommand",W="Objective C",bc="Exit",bd="Ctrl+S",I="Syntax",H="Ctrl+C",G="icon/16/actions/document-new.png",F="Tabs to spaces",E="ASCII table",D="Replace",C="HTML",B="icon/16/actions/edit-paste.png";
...
var cF=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cF.setPadding(20);
cF.setAllowStretchX(false);
cG.add(cF);
this.getRoot().add(cG,{edge:0});
this.createCommands();
cF.add(this.getMenuBar(),{left:20,top:20});
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(bO);
this._newCommand.addListener(bH,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bs);
this._openCommand.addListener(bH,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(bd);
this._saveCommand.addListener(bH,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(A);
this._undoCommand.addListener(bH,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(z);
this._redoCommand.addListener(bH,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(S);
this._cutCommand.addListener(bH,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(H);
this._copyCommand.addListener(bH,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(O);
this._pasteCommand.addListener(bH,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuBar:function(){var cA=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
cA.add(menubar);
var cz=new qx.ui.menubar.Button(s,null,this.getFileMenu());
var cy=new qx.ui.menubar.Button(bt,null,this.getEditMenu());
var cB=new qx.ui.menubar.Button(bN,null,this.getSearchMenu());
var cE=new qx.ui.menubar.Button(bl,null,this.getViewMenu());
var cD=new qx.ui.menubar.Button(v,null,this.getFormatMenu());
var cC=new qx.ui.menubar.Button(bK,null,this.getHelpMenu());
menubar.add(cz);
menubar.add(cy);
menubar.add(cB);
menubar.add(cE);
...
menubar.add(cC);
return cA;
},getFileMenu:function(){var cJ=new qx.ui.menu.Menu;
var cH=new qx.ui.menu.Button(bD,G,this._newCommand);
var cL=new qx.ui.menu.Button(U,bu,this._openCommand);
var cK=new qx.ui.menu.Button(bp);
var cO=new qx.ui.menu.Button(bV,Y,this._saveCommand);
var cN=new qx.ui.menu.Button(bi,bo);
var cM=new qx.ui.menu.Button(X,bv);
var cI=new qx.ui.menu.Button(bc,bS);
cH.addListener(bH,this.debugButton);
cL.addListener(bH,this.debugButton);
cK.addListener(bH,this.debugButton);
cO.addListener(bH,this.debugButton);
cN.addListener(bH,this.debugButton);
cM.addListener(bH,this.debugButton);
cI.addListener(bH,this.debugButton);
cJ.add(cH);
cJ.add(cL);
cJ.add(cK);
cJ.add(cO);
...
cJ.add(cI);
return cJ;
},getEditMenu:function(){var ce=new qx.ui.menu.Menu;
var ch=new qx.ui.menu.Button(by,bw,this._undoCommand);
var cg=new qx.ui.menu.Button(bI,u,this._redoCommand);
var cd=new qx.ui.menu.Button(be,bC,this._cutCommand);
var ci=new qx.ui.menu.Button(J,ba,this._copyCommand);
var cf=new qx.ui.menu.Button(K,B,this._pasteCommand);
ch.addListener(bH,this.debugButton);
cg.addListener(bH,this.debugButton);
cd.addListener(bH,this.debugButton);
ci.addListener(bH,this.debugButton);
cf.addListener(bH,this.debugButton);
ce.add(ch);
ce.add(cg);
ce.addSeparator();
ce.add(cd);
...
ce.add(cf);
return ce;
},getSearchMenu:function(){var cS=new qx.ui.menu.Menu;
var cQ=new qx.ui.menu.Button(bb,bF);
var cV=new qx.ui.menu.Button(bW);
var cR=new qx.ui.menu.Button(bg);
var cU=new qx.ui.menu.Button(D);
var cP=new qx.ui.menu.Button(bB,bF);
var cT=new qx.ui.menu.Button(cb);
cR.setEnabled(false);
cQ.addListener(bH,this.debugButton);
cV.addListener(bH,this.debugButton);
cR.addListener(bH,this.debugButton);
cU.addListener(bH,this.debugButton);
cP.addListener(bH,this.debugButton);
cT.addListener(bH,this.debugButton);
cS.add(cQ);
cS.add(cV);
cS.add(cR);
cS.add(cU);
...
var c=new qx.ui.menu.Button(M,null,null,this.getPanesMenu());
var g=new qx.ui.menu.Button(I,null,null,this.getSyntaxMenu());
var f=new qx.ui.menu.CheckBox(Q);
var d=new qx.ui.menu.CheckBox(bh);
var b=new qx.ui.menu.Button(E);
f.addListener(bG,this.debugCheckBox);
d.addListener(bG,this.debugCheckBox);
b.addListener(bH,this.debugButton);
a.add(c);
a.add(g);
a.addSeparator();
a.add(f);
...
var ds=new qx.ui.menu.CheckBox(r);
var du=new qx.ui.menu.CheckBox(bJ);
var dv=new qx.ui.menu.CheckBox(j);
var dr=new qx.ui.menu.CheckBox(P);
var dt=new qx.ui.menu.CheckBox(t);
var dp=new qx.ui.menu.CheckBox(bM);
ds.setValue(true);
du.setValue(true);
dr.setValue(true);
ds.addListener(bG,this.debugCheckBox);
du.addListener(bG,this.debugCheckBox);
dv.addListener(bG,this.debugCheckBox);
dr.addListener(bG,this.debugCheckBox);
dt.addListener(bG,this.debugCheckBox);
dp.addListener(bG,this.debugCheckBox);
dq.add(du);
dq.add(ds);
dq.addSeparator();
dq.add(dv);
...
dq.add(dp);
return dq;
},getSyntaxMenu:function(){var db=new qx.ui.menu.Menu;
var cW=new qx.ui.menu.RadioButton(C);
var cY=new qx.ui.menu.RadioButton(q);
var cX=new qx.ui.menu.RadioButton(n);
var da=new qx.ui.menu.Button(bk,null,null,this.getSyntaxCMenu());
var de=new qx.ui.menu.RadioButton(N);
var dc=new qx.ui.menu.RadioButton(h);
db.add(cW);
db.add(cY);
db.add(cX);
db.add(da);
db.add(de);
db.add(dc);
var dd=new qx.ui.form.RadioGroup;
dd.add(cW,cY,cX,de,dc);
dd.add.apply(dd,da.getMenu().getChildren());
dd.addListener(bj,this.debugRadio);
return db;
},getSyntaxCMenu:function(){var cu=new qx.ui.menu.Menu;
var ct=new qx.ui.menu.RadioButton(bP);
var cx=new qx.ui.menu.RadioButton(bx);
var cw=new qx.ui.menu.RadioButton(W);
var cv=new qx.ui.menu.RadioButton(ca);
cu.add(ct);
cu.add(cx);
cu.add(cw);
cu.add(cv);
...
var dh=new qx.ui.menu.Button(bq,null,null,this.getParagraphMenu());
var dk=new qx.ui.menu.Button(F);
var dl=new qx.ui.menu.Button(k);
var dg=new qx.ui.menu.Button(bm);
var dj=new qx.ui.menu.Button(bX);
var df=new qx.ui.menu.Button(bT);
var dn=new qx.ui.menu.Button(m);
var dm=new qx.ui.menu.Button(bR);
dk.addListener(bH,this.debugButton);
dl.addListener(bH,this.debugButton);
dg.addListener(bH,this.debugButton);
dj.addListener(bH,this.debugButton);
df.addListener(bH,this.debugButton);
dn.addListener(bH,this.debugButton);
dm.addListener(bH,this.debugButton);
di.add(dh);
di.add(dk);
di.add(dl);
di.addSeparator();
...
di.add(dm);
return di;
},getParagraphMenu:function(){var cj=new qx.ui.menu.Menu;
var cm=new qx.ui.menu.Button(bz,bQ);
var cn=new qx.ui.menu.Button(l,x);
var ck=new qx.ui.menu.Button(br,T);
var cl=new qx.ui.menu.Button(R,bA);
cm.addListener(bH,this.debugButton);
cn.addListener(bH,this.debugButton);
ck.addListener(bH,this.debugButton);
cl.addListener(bH,this.debugButton);
...
cj.add(cl);
return cj;
},getHelpMenu:function(){var co=new qx.ui.menu.Menu;
var cq=new qx.ui.menu.Button(L,i);
var cs=new qx.ui.menu.Button(bf);
var cr=new qx.ui.menu.Button(bE);
var cp=new qx.ui.menu.Button(w);
cq.addListener(bH,this.debugButton);
cs.addListener(bH,this.debugButton);
cr.addListener(bH,this.debugButton);
cp.addListener(bH,this.debugButton);
co.add(cq);
co.add(cs);
...
co.add(cp);
return co;
}},destruct:function(){this._disposeObjects(cc,bn,bY,bU,bL,V,p,y);
}});
})();
