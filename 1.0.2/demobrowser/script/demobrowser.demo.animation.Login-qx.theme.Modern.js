...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Login-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"58e4b4008c04"},
  boot : "boot",
  bootIsInline : true,
