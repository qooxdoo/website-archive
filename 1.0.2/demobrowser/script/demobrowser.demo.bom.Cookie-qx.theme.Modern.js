...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Cookie-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d0029e00559d"},
  boot : "boot",
  bootIsInline : true,
