...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_Pane","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_Pane-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"441a056b481a"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(d,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil,qx.core.MAssert],members:{main:function(){arguments.callee.base.call(this);
