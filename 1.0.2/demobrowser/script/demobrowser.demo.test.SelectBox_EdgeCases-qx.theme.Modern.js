...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.SelectBox_EdgeCases","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.SelectBox_EdgeCases-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d601025fe3fc"},
  boot : "boot",
  bootIsInline : true,
...
x.setMaxListHeight(null);

for(var i=0;i<300;i++){var y=new qx.ui.form.ListItem(j+i);
x.add(y);
}this.container.add(x,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(h),{left:25,bottom:45});
var u=new qx.ui.form.SelectBox();
var p=new qx.bom.Font(12,[e]);
var q=new qx.bom.Font(15,[a]);
var o=new qx.bom.Font(18,[d]);
var s=new qx.bom.Font(21,[m]);
var r=[p,q,o,s];

for(var i=0;i<r.length;i++){var t=new qx.ui.form.ListItem(f+(i+1));
t.setFont(r[i]);
u.add(t);
}this.container.add(u,{left:20,bottom:20});
},addBox3:function(){this.container.add(new qx.ui.basic.Label(k),{left:205,top:20});
var v=new qx.ui.form.SelectBox();
v.setWidth(300);
v.setMaxListHeight(100);

for(var i=0;i<20;i++){var w=new qx.ui.form.ListItem(c+i);
if(i%5==1){w.setEnabled(false);
}v.add(w);
}this.container.add(v,{left:200,top:40});
