...
var H=new qx.ui.form.ListItem(i);
G.add(H);
var D=new qx.ui.form.ListItem(n);
G.add(D);
var B=new qx.ui.form.ListItem(p);
G.add(B);
...
var x={name:null,gender:null,ok:0,hidden:e};
var J=qx.data.marshal.Json.createModel(x);
var A=new qx.data.controller.Object(J);
A.addTarget(y,r,g,true);
A.addTarget(G,j,l,true);
var w={converter:function(O){return O===1;
}};
var z={converter:function(u){return u?1:0;
}};
A.addTarget(K,r,h,true,w,z);
y.setRequired(true);
K.setRequired(true);
var M=new qx.ui.form.validation.Manager();
M.add(y,qx.util.Validate.required);
M.add(K);
M.setValidator(function(s){var t=G.getSelection()[0]!==H;
G.setValid(t);
return t;
});
var E=function(P){if(P instanceof qx.ui.form.ListItem){return P.getLabel();
}};
C.addListener(c,function(){if(M.validate()){alert("You are sending: "+qx.util.Serializer.toUriParameter(J,E));
}},this);
}}});
})();
