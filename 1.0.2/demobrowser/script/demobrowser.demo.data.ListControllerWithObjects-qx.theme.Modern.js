...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.ListControllerWithObjects","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ListControllerWithObjects-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"fe05dcd728dc"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var l="execute",k="smile",j="Jack",h=".png",g="kiss",f="demobrowser.demo.data.ListControllerWithObjects",e="emote",d="green",c="Jim",b="<b>Displaying objects in a list</b><br/>",H="Make all happy",G="sad",F="plain",E="surprise",D="embarrassed",C="online",B=" a converter by the icon. The font color shows the online status.",A="name",z="Write data to log",y="Jackob",s="textColor",t="have a name and an emotion, which is displayed with the help of ",q="This list display a set of persons in a list. Every person does ",r="Dan",o="Tim",p="Karl",m="Online <> Offline",n="icon/16/emotes/face-",u="Dustin",v="angel",x="Max",w="red";
qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var X=[x,y,o,j,r,u,p,c];
var O=[D,g,F,G,E,v];
var U=[];

for(var i=0;i<20;i++){var R=new demobrowser.demo.data.model.Person();
R.setName(X[i%X.length]);
R.setEmote(O[i%O.length]);
R.setOnline(i%3==0);
U.push(R);
}var V=new qx.data.Array(U);
var N=new qx.ui.form.List();
N.setWidth(150);
this.getRoot().add(N,{left:10,top:80});
var W={converter:function(a){return n+a+h;
}};
var S=new qx.data.controller.List(V,N,A);
S.setIconOptions(W);
S.setIconPath(e);
var Q={converter:function(I){if(I){return d;
}else{return w;
}}};
var L={bindItem:function(Y,ba,bb){Y.bindDefaultProperties(ba,bb);
Y.bindProperty(C,s,Q,ba,bb);
}};
S.setDelegate(L);
var M=new qx.ui.form.Button(H);
M.setWidth(120);
this.getRoot().add(M,{left:180,top:80});
M.addListener(l,function(){for(var i=0;i<V.length;i++){var J=V.getItem(i);
J.setEmote(k);
}},this);
var K=new qx.ui.form.Button(m);
K.setWidth(120);
this.getRoot().add(K,{left:180,top:115});
K.addListener(l,function(){for(var i=0;i<V.length;i++){V.getItem(i).toggleOnline();
}},this);
var T=new qx.ui.form.Button(z);
T.setWidth(120);
this.getRoot().add(T,{left:180,top:150});
T.addListener(l,function(){qx.log.appender.Console.show();
this.info(V.toString());
},this);
