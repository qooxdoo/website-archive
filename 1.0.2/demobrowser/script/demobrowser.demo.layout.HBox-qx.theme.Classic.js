...
p.add(this.getBox6());
p.add(this.getBox7());
},getBox1:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return n;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,minHeight:60,allowGrowX:false});
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:c}));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:a}));
...
var z=new qx.ui.container.Composite(x).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
x.setSpacing(5);
x.setAlignX(e);
...
y.setMarginRight(10);
return z;
},getBox7:function(){var s=new qx.ui.layout.HBox();
var u=new qx.ui.container.Composite(s).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
s.setSpacing(5);
s.setAlignX(f);
