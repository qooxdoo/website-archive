...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Label-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"030201ef460b"},
  boot : "boot",
  bootIsInline : true,
...
return x;
},createEditDialog:function(y,z){var A=new qx.ui.window.Window(z).set({allowMinimize:false,showMinimize:false,allowMaximize:false,showMaximize:false});
A.moveTo(350,20);
var C=new qx.ui.layout.Grid(10,10);
C.setColumnFlex(1,1);
C.setColumnAlign(0,f,k);
A.setLayout(C);
var B=new qx.data.controller.Object(y);
A.add(new qx.ui.basic.Label(t).set({paddingTop:5}),{row:0,column:0});
var D=new qx.ui.form.TextArea().set({liveUpdate:true});
B.addTarget(D,t,t,true);
A.add(D,{row:0,column:1});
A.add(new qx.ui.basic.Label(p),{row:1,column:0});
var E=new qx.ui.form.CheckBox();
B.addTarget(E,t,p,true);
A.add(E,{row:1,column:1});
A.add(new qx.ui.basic.Label(d),{row:2,column:0});
var E=new qx.ui.form.CheckBox();
B.addTarget(E,t,b,true);
A.add(E,{row:2,column:1});
A.add(new qx.ui.basic.Label(o),{row:3,column:0});
var E=new qx.ui.form.CheckBox().set({enabled:false});
B.addTarget(E,t,o);
A.add(E,{row:3,column:1});
return A;
}}});
})();
