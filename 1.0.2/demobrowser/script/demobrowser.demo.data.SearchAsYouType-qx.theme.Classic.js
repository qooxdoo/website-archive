...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.SearchAsYouType-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"b1b6d080061a"},
  boot : "boot",
  bootIsInline : true,
...
this.__Ln=i;
this.filter=qx.lang.Function.bind(function(h){return h.search(this.getSearchString())!=-1;
},this);
this.__Lo=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__Lo:null,__Ln:null,_applySearchString:function(e,f){var g=qx.util.TimerManager.getInstance();
if(this.__Lo!=null){g.stop(this.__Lo);
this.__Lo=null;
}this.__Lo=g.start(function(){this.__Ln.update();
this.__Lo=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__Ln=null;
}});
})();
