...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.CellEvents-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"da6116d17ddb"},
  boot : "boot",
  bootIsInline : true,
...
var q=new qx.ui.virtual.core.Scroller(20,20,40,40).set({width:400,height:300});
this.layer=new qx.test.ui.virtual.layer.LayerSimple(this);
var p=q.getPane();
p.addListener(i,this._onCellClick,this);
p.addListener(c,this._onContextMenu,this);
p.addListener(a,this._onDblclickPane,this);
p.addLayer(this.layer);
...
},_onCellClick:function(e){var r=k+e.getRow()+m+e.getColumn()+n;
this.__Mh(r);
},_onContextMenu:function(e){var s=h+e.getRow()+m+e.getColumn()+n;
this.__Mh(s);
},_onDblclickPane:function(e){var o=g+e.getRow()+m+e.getColumn()+n;
this.__Mh(o);
},__Mh:function(t){this.logger.setHtml(this.logger.getHtml()+t);
