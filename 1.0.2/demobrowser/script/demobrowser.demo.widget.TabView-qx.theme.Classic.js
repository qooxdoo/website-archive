...
Q.setWidth(500);
var U=new qx.ui.tabview.Page(a,h);
U.setLayout(new qx.ui.layout.VBox());
U.add(new qx.ui.basic.Label(o));
Q.add(U);
var S=new qx.ui.tabview.Page(c,x);
S.setLayout(new qx.ui.layout.VBox());
S.add(new qx.ui.basic.Label(r));
Q.add(S);
var T=new qx.ui.tabview.Page(u,g);
T.setLayout(new qx.ui.layout.VBox());
T.add(new qx.ui.basic.Label(y));
Q.add(T);
var R=new qx.ui.tabview.Page(s,B);
R.setLayout(new qx.ui.layout.VBox());
R.add(new qx.ui.basic.Label(q));
Q.add(R);
return Q;
...
},getTabView3:function(){var G=new qx.ui.tabview.TabView();
G.setWidth(500);
G.setHeight(300);

for(var i=1;i<=3;i++){var P=new qx.ui.tabview.Page(l+i,j);
P.setLayout(new qx.ui.layout.VBox(4));
G.add(P);
P.add(new qx.ui.basic.Label(l+i));
}var I=G.getChildren()[0];
var N=new qx.ui.basic.Label(w);
var L=new qx.ui.form.RadioButton(v);
var F=new qx.ui.form.RadioButton(d);
var K=new qx.ui.form.RadioButton(m);
var M=new qx.ui.form.RadioButton(t);
I.add(new qx.ui.core.Spacer(10,10));
I.add(N);
I.add(L);
I.add(F);
I.add(K);
I.add(M);
var O=new qx.ui.form.RadioGroup(L,F,K,M);
O.addListener(z,function(e){this.setBarPosition(e.getData()[0].getLabel());
},G);
K.setValue(true);
var H=new qx.ui.form.Button(A);
...
I.add(J);
I.add(E);
H.addListener(k,function(e){var C=G.getChildren().length+1;
var D=new qx.ui.tabview.Page(l+C,j);
G.add(D);
});
J.addListener(k,function(e){var X=G.getChildren();

if(X.length>0){G.remove(X[0]);
}});
E.addListener(k,function(e){var Y=G.getChildren();

if(Y.length>0){G.remove(Y[Y.length-1]);
}});
return G;
}}});
})();
