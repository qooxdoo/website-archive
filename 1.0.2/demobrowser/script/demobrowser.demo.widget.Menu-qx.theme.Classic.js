...
(function(){var ek="execute",ej="changeValue",ei="icon/16/actions/edit-cut.png",eh="changeSelection",eg="icon/16/actions/edit-paste.png",ef="Copy",ee="Paste",ed="icon/16/actions/edit-copy.png",ec="Cut",eb="icon/16/actions/system-search.png",dy="New",dx="Undo",dw="icon/16/actions/document-save.png",dv="Redo",du="icon/22/apps/preferences-users.png",dt="icon/16/actions/document-print.png",ds="icon/16/actions/document-open.png",dr="icon/16/actions/edit-undo.png",dq="Save",dp="icon/16/actions/edit-redo.png",er="Print",es="Open",ep="icon/16/actions/document-new.png",eq="Online Forum",en="icon/16/actions/format-justify-fill.png",eo="Search in files",el="C",em="__Nd",et="Left aligned",eu="Perl",dT="View",dS="C Dialect",dV="Info...",dU="Save as...",dX="Show line numbers",dW="Quickstart",ea="icon/16/actions/contact-new.png",dY="Actions",dR="Show console",dQ="Search",cf="Help",cg="Show status bar",ch="icon/16/actions/format-justify-left.png",ci="ANSI to OEM",cj="Centered",ck="Website 3",cl="Edit",cm="icon/16/actions/format-justify-center.png",cn="icon/16/actions/go-previous.png",co="C Sharp",ey="Close",ex="__Nb",ew="Split Button",ev="Website 2",eC="icon/16/actions/document-save-as.png",eB="Python",eA="icon/16/apps/utilities-help.png",ez="Show tree",eE="Options",eD="Spaces to tabs",cN="Right aligned",cO="Action 1",cL="OEM to ANSI",cM="Line 431",cR="JavaScript",cS="icon",cP="Action 2",cQ="Folder ",cJ="__Nc",cK="XML",cw="Line 313",cv="Paragraph",cy="demobrowser.demo.widget.Menu",cx="icon/16/actions/application-exit.png",cs="C Plus Plus",cr="Line 26",cu="Item ",ct="ASCII table",cq="Option 1",cp="Search next...",cX="Line 12",cY="Action 3",da="Replace in files",db="__MY",cT="Uppercase",cU="Ctrl+P",cV="Topics",cW="Panes",dc="Justified",dd="Ctrl+X",cG="Show macros",cF="Search previous...",cE="Back",cD="main",cC="Show ruler",cB="__Ne",cA="icon/16/actions/format-justify-right.png",cz="icon/16/actions/go-next.png",cI="Ctrl+Z",cH="command ",de="Option 3",df="Next",dg="Ctrl+R",dh="__Nf",di="Show tags",dj="Capitals",dk="Format",dl="__Na",dm="File",dn="__MX",dC="Show tabs",dB="Tabs to spaces",dA="Search...",dz="Line 1039",dG="Option 2",dF="Objective C",dE="Exit",dD="move to",dI="Ctrl+S",dH="Syntax",dO="Ctrl+C",dP="Website 1",dM="Menu Button",dN="Line 30",dK="Lowercase",dL="Replace",dJ="HTML";
qx.Class.define(cy,{extend:qx.application.Standalone,members:{__MX:null,__MY:null,__Na:null,__Nb:null,__Nc:null,__Nd:null,__Ne:null,__Nf:null,main:function(){arguments.callee.base.call(this);
var bz=new qx.ui.container.Scroll();
var by=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
by.setPadding(20);
by.setAllowStretchX(false);
bz.add(by);
this.getRoot().add(bz,{edge:0});
this.createCommands();
by.add(this.getMenuButton(),{left:20,top:20});
by.add(this.getSplitButton(),{left:150,top:20});
by.add(this.getMenuBar(),{left:20,top:100});
by.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var eF=new qx.ui.menu.Menu();
var eG=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){eG.add(new qx.ui.menu.Button(cQ+(i+1)));
}eF.add(new qx.ui.menu.Button(dD,null,null,eG));
eF.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){eF.add(new qx.ui.menu.Button(cH+(i+1)));
}return eF;
...
},createCommands:function(){this.__MX=new qx.ui.core.Command("Ctrl+N");
this.__MX.addListener(ek,this.debugCommand);
this.__MY=new qx.ui.core.Command("Ctrl+O");
this.__MY.addListener(ek,this.debugCommand);
this.__Na=new qx.ui.core.Command(dI);
this.__Na.addListener(ek,this.debugCommand);
this.__Nb=new qx.ui.core.Command(cI);
this.__Nb.addListener(ek,this.debugCommand);
this.__Nc=new qx.ui.core.Command(dg);
this.__Nc.addListener(ek,this.debugCommand);
this.__Nd=new qx.ui.core.Command(dd);
this.__Nd.addListener(ek,this.debugCommand);
this.__Ne=new qx.ui.core.Command(dO);
this.__Ne.addListener(ek,this.debugCommand);
this.__Nf=new qx.ui.core.Command(cU);
this.__Nf.addListener(ek,this.debugCommand);
this.__Nf.setEnabled(false);
},getMenuButton:function(){var D=new qx.ui.menu.Menu;
D.add(new qx.ui.menu.RadioButton(cq));
D.add(new qx.ui.menu.RadioButton(dG));
D.add(new qx.ui.menu.RadioButton(de));
var L=new qx.ui.menu.Menu;
L.add(new qx.ui.menu.RadioButton(cO));
L.add(new qx.ui.menu.RadioButton(cP));
L.add(new qx.ui.menu.RadioButton(cY));
var K=new qx.ui.form.RadioGroup;
K.add.apply(K,D.getChildren());
K.addListener(eh,this.debugRadio);
var I=new qx.ui.form.RadioGroup;
I.add.apply(I,L.getChildren());
I.addListener(eh,this.debugRadio);
var G=new qx.ui.menu.Menu();
var J=new qx.ui.menu.Button(dx,dr,this.__Nb);
var Q=new qx.ui.menu.Button(dv,dp,this.__Nc);
var F=new qx.ui.menu.Button(ec,ei,this.__Nd);
var N=new qx.ui.menu.Button(ef,ed,this.__Ne);
var H=new qx.ui.menu.Button(ee,eg,this.__Nf);
var E=new qx.ui.menu.Button(eE,eb,null,D);
var O=new qx.ui.menu.Button(dY,ea,null,L);
var M=new qx.ui.menu.Button(er,dt);
J.addListener(ek,this.debugButton);
Q.addListener(ek,this.debugButton);
F.addListener(ek,this.debugButton);
N.addListener(ek,this.debugButton);
H.addListener(ek,this.debugButton);
E.addListener(ek,this.debugButton);
O.addListener(ek,this.debugButton);
M.addListener(ek,this.debugButton);
G.add(J);
G.add(Q);
G.addSeparator();
G.add(F);
...
G.addSeparator();
G.add(M);
var P=new qx.ui.form.MenuButton(dM,du,G);
return P;
},getSplitButton:function(){var ca=new qx.ui.menu.Menu;
var ce=new qx.ui.menu.Button(dP);
var cc=new qx.ui.menu.Button(ev);
var cd=new qx.ui.menu.Button(ck);
ca.setMinWidth(120);
ce.addListener(ek,this.debugButton);
cc.addListener(ek,this.debugButton);
cd.addListener(ek,this.debugButton);
ca.add(ce);
ca.add(cc);
ca.add(cd);
var cb=new qx.ui.form.SplitButton(ew,du,ca);
cb.addListener(ek,this.debugButton);
return cb;
},getMenuBar:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.Grow);
n.setDecorator(cD);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
n.add(toolbar);
var w=new qx.ui.toolbar.Part;
...
toolbar.addSpacer();
toolbar.add(q);
var v=new qx.ui.toolbar.SplitButton(cE,cn,this.getBackMenu());
var s=new qx.ui.toolbar.SplitButton(df,cz,this.getForwardMenu());
var l=new qx.ui.toolbar.Button(dy,ep,this.__MX);
var p=new qx.ui.toolbar.Button(es,ds,this.__MY);
var u=new qx.ui.toolbar.Button(dq,dw,this.__Na);
v.addListener(ek,this.debugButton);
s.addListener(ek,this.debugButton);
l.addListener(ek,this.debugButton);
p.addListener(ek,this.debugButton);
u.addListener(ek,this.debugButton);
w.add(v);
w.add(s);
w.addSeparator();
w.add(l);
...
w.add(u);
w.setShow(cS);
var o=new qx.ui.toolbar.MenuButton(dm);
var k=new qx.ui.toolbar.MenuButton(cl);
var j=new qx.ui.toolbar.MenuButton(dQ);
var x=new qx.ui.toolbar.MenuButton(dT);
var t=new qx.ui.toolbar.MenuButton(dk);
o.setMenu(this.getFileMenu());
k.setMenu(this.getEditMenu());
j.setMenu(this.getSearchMenu());
x.setMenu(this.getViewMenu());
t.setMenu(this.getFormatMenu());
m.add(o);
m.add(k);
m.add(j);
m.add(x);
m.add(t);
var r=new qx.ui.toolbar.MenuButton(cf);
r.setMenu(this.getHelpMenu());
q.add(r);
return n;
},getBackMenu:function(){var bB=new qx.ui.menu.Menu;
var bC=new qx.ui.menu.Button(cw);
var bE=new qx.ui.menu.Button(dz);
var bA=new qx.ui.menu.Button(cX);
var bD=new qx.ui.menu.Button(cr);
bC.addListener(ek,this.debugButton);
bE.addListener(ek,this.debugButton);
bA.addListener(ek,this.debugButton);
bD.addListener(ek,this.debugButton);
bB.add(bC);
bB.add(bE);
bB.add(bA);
bB.add(bD);
return bB;
},getForwardMenu:function(){var bv=new qx.ui.menu.Menu;
var bw=new qx.ui.menu.Button(cM);
var bx=new qx.ui.menu.Button(dN);
bw.addListener(ek,this.debugButton);
bx.addListener(ek,this.debugButton);
bv.add(bw);
bv.add(bx);
return bv;
},getFileMenu:function(){var bb=new qx.ui.menu.Menu;
var Y=new qx.ui.menu.Button(dy,ep,this.__MX);
var bd=new qx.ui.menu.Button(es,ds,this.__MY);
var bc=new qx.ui.menu.Button(ey);
var bg=new qx.ui.menu.Button(dq,dw,this.__Na);
var bf=new qx.ui.menu.Button(dU,eC);
var be=new qx.ui.menu.Button(er,dt);
var ba=new qx.ui.menu.Button(dE,cx);
Y.addListener(ek,this.debugButton);
bd.addListener(ek,this.debugButton);
bc.addListener(ek,this.debugButton);
bg.addListener(ek,this.debugButton);
bf.addListener(ek,this.debugButton);
be.addListener(ek,this.debugButton);
ba.addListener(ek,this.debugButton);
bb.add(Y);
bb.add(bd);
...
var f=new qx.ui.menu.Button(dx,dr,this.__Nb);
var d=new qx.ui.menu.Button(dv,dp,this.__Nc);
var a=new qx.ui.menu.Button(ec,ei,this.__Nd);
var g=new qx.ui.menu.Button(ef,ed,this.__Ne);
var c=new qx.ui.menu.Button(ee,eg,this.__Nf);
f.addListener(ek,this.debugButton);
d.addListener(ek,this.debugButton);
a.addListener(ek,this.debugButton);
g.addListener(ek,this.debugButton);
c.addListener(ek,this.debugButton);
b.add(f);
b.add(d);
b.addSeparator();
b.add(a);
...
b.add(c);
return b;
},getSearchMenu:function(){var U=new qx.ui.menu.Menu;
var S=new qx.ui.menu.Button(dA,eb);
var X=new qx.ui.menu.Button(cp);
var T=new qx.ui.menu.Button(cF);
var W=new qx.ui.menu.Button(dL);
var R=new qx.ui.menu.Button(eo,eb);
var V=new qx.ui.menu.Button(da);
T.setEnabled(false);
S.addListener(ek,this.debugButton);
X.addListener(ek,this.debugButton);
T.addListener(ek,this.debugButton);
W.addListener(ek,this.debugButton);
R.addListener(ek,this.debugButton);
V.addListener(ek,this.debugButton);
U.add(S);
U.add(X);
U.add(T);
...
U.add(V);
return U;
},getViewMenu:function(){var eH=new qx.ui.menu.Menu;
var eJ=new qx.ui.menu.Button(cW,null,null,this.getPanesMenu());
var eM=new qx.ui.menu.Button(dH,null,null,this.getSyntaxMenu());
var eL=new qx.ui.menu.CheckBox(cC);
var eK=new qx.ui.menu.CheckBox(dX);
var eI=new qx.ui.menu.Button(ct);
eL.addListener(ej,this.debugCheckBox);
eK.addListener(ej,this.debugCheckBox);
eI.addListener(ek,this.debugButton);
eH.add(eJ);
eH.add(eM);
eH.addSeparator();
eH.add(eL);
...
eH.add(eI);
return eH;
},getPanesMenu:function(){var bL=new qx.ui.menu.Menu;
var bN=new qx.ui.menu.CheckBox(dC);
var bP=new qx.ui.menu.CheckBox(cg);
var bQ=new qx.ui.menu.CheckBox(ez);
var bM=new qx.ui.menu.CheckBox(cG);
var bO=new qx.ui.menu.CheckBox(di);
var bK=new qx.ui.menu.CheckBox(dR);
bN.setValue(true);
bP.setValue(true);
bM.setValue(true);
bN.addListener(ej,this.debugCheckBox);
bP.addListener(ej,this.debugCheckBox);
bQ.addListener(ej,this.debugCheckBox);
bM.addListener(ej,this.debugCheckBox);
bO.addListener(ej,this.debugCheckBox);
bK.addListener(ej,this.debugCheckBox);
bL.add(bP);
bL.add(bN);
bL.addSeparator();
bL.add(bQ);
...
bL.add(bK);
return bL;
},getSyntaxMenu:function(){var bV=new qx.ui.menu.Menu;
var bR=new qx.ui.menu.RadioButton(dJ);
var bT=new qx.ui.menu.RadioButton(cK);
var bS=new qx.ui.menu.RadioButton(cR);
var bU=new qx.ui.menu.Button(dS,null,null,this.getSyntaxCMenu());
var bY=new qx.ui.menu.RadioButton(eu);
var bW=new qx.ui.menu.RadioButton(eB);
bV.add(bR);
bV.add(bT);
bV.add(bS);
bV.add(bU);
...
bX.add(bR,bT,bS,bY,bW);
bX.add.apply(bX,bU.getMenu().getChildren());
bX.addListener(eh,this.debugRadio);
return bV;
},getSyntaxCMenu:function(){var z=new qx.ui.menu.Menu;
var y=new qx.ui.menu.RadioButton(el);
var C=new qx.ui.menu.RadioButton(co);
var B=new qx.ui.menu.RadioButton(dF);
var A=new qx.ui.menu.RadioButton(cs);
z.add(y);
z.add(C);
z.add(B);
z.add(A);
return z;
},getFormatMenu:function(){var bp=new qx.ui.menu.Menu;
var bo=new qx.ui.menu.Button(cv,null,null,this.getParagraphMenu());
var br=new qx.ui.menu.Button(dB);
var bs=new qx.ui.menu.Button(eD);
var bn=new qx.ui.menu.Button(cT);
var bq=new qx.ui.menu.Button(dK);
var bm=new qx.ui.menu.Button(dj);
var bu=new qx.ui.menu.Button(cL);
var bt=new qx.ui.menu.Button(ci);
br.addListener(ek,this.debugButton);
bs.addListener(ek,this.debugButton);
bn.addListener(ek,this.debugButton);
bq.addListener(ek,this.debugButton);
bm.addListener(ek,this.debugButton);
bu.addListener(ek,this.debugButton);
bt.addListener(ek,this.debugButton);
bp.add(bo);
bp.add(br);
bp.add(bs);
bp.addSeparator();
...
var bk=new qx.ui.menu.Button(et,ch);
var bl=new qx.ui.menu.Button(cN,cA);
var bi=new qx.ui.menu.Button(cj,cm);
var bj=new qx.ui.menu.Button(dc,en);
bk.addListener(ek,this.debugButton);
bl.addListener(ek,this.debugButton);
bi.addListener(ek,this.debugButton);
bj.addListener(ek,this.debugButton);
bh.add(bk);
bh.add(bl);
bh.add(bi);
bh.add(bj);
return bh;
},getHelpMenu:function(){var bF=new qx.ui.menu.Menu;
var bH=new qx.ui.menu.Button(cV,eA);
var bJ=new qx.ui.menu.Button(dW);
var bI=new qx.ui.menu.Button(eq);
var bG=new qx.ui.menu.Button(dV);
bH.addListener(ek,this.debugButton);
bJ.addListener(ek,this.debugButton);
bI.addListener(ek,this.debugButton);
bG.addListener(ek,this.debugButton);
bF.add(bH);
...
bF.add(bG);
return bF;
},getList:function(){var h=new qx.ui.form.List;
h.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){h.add(new qx.ui.form.ListItem(cu+i));
}return h;
},getContextMenu:function(){var eN=new qx.ui.menu.Menu;
var eP=new qx.ui.menu.Button(ec,ei,this.__Nd);
var eQ=new qx.ui.menu.Button(ef,ed,this.__Ne);
var eO=new qx.ui.menu.Button(ee,eg,this.__Nf);
eP.addListener(ek,this.debugButton);
eQ.addListener(ek,this.debugButton);
eO.addListener(ek,this.debugButton);
eN.add(eP);
eN.add(eQ);
eN.add(eO);
return eN;
}},destruct:function(){this._disposeObjects(dn,db,dl,ex,cJ,em,cB,dh);
}});
})();
...
qx.Class.define(f,{extend:qx.ui.form.SplitButton,construct:function(j,k,l,m){arguments.callee.base.call(this,j,k,l,m);
