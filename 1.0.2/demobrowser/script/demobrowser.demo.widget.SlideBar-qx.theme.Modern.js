...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.SlideBar-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"fd62297bbfa7"},
  boot : "boot",
  bootIsInline : true,
