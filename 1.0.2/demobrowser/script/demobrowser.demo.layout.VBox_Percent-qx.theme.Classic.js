...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Percent-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"bdd9733c7f53"},
  boot : "boot",
  bootIsInline : true,
...
F.add(this.getBox5());
F.add(this.getBox6());
},getBox1:function(){var G=new qx.ui.layout.VBox();
...
I.add(H,{flex:1});
return I;
},getBox2:function(){var v=new qx.ui.layout.VBox();
var x=new qx.ui.container.Composite(v).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
v.setSpacing(5);
...
x.add(z,{height:d});
x.add(y,{height:d});
x.add(w,{height:d,flex:1});
return x;
},getBox3:function(){var l=new qx.ui.layout.VBox();
var n=new qx.ui.container.Composite(l).set({decorator:f,backgroundColor:c,allowGrowY:false});
l.setSpacing(5);
...
return C;
},getBox5:function(){var g=new qx.ui.layout.VBox();
var i=new qx.ui.container.Composite(g).set({decorator:f,backgroundColor:c,height:100,allowGrowY:false});
g.setSpacing(5);
var k=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var j=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var h=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
