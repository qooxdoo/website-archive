...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.table.Table_Window_Editor","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Window_Editor-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"10abca4ab15a"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="execute",n="A boolean",m="A number",l="Table with window cell editor",k="A date",j="Enter",i="1*",h="50%",g="demobrowser.demo.table.Table_Window_Editor",f="appear",b="demobrowser.demo.table.ModalCellEditorFactory",d="Cell Editor",c="ID",a="Save";
...
s.setColumns([c,m,k,n]);
s.setData(u);
s.setColumnEditable(1,true);
var r={tableColumnModel:function(A){return new qx.ui.table.columnmodel.Resize(A);
}};
...
qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,members:{createCellEditor:function(w){var z=new qx.ui.window.Window(d);
z.setLayout(new qx.ui.layout.HBox(4));
z.set({padding:3,modal:true,showClose:false,showMaximize:false,showMinimize:false});
z.moveTo(300,250);
z.addListener(f,function(e){z.__LN.focus();
z.__LN.setTextSelection(0,z.__LN.getValue().length);
});
z.__LN=new qx.ui.form.TextField(w.value+"").set({allowGrowY:true});
z.add(z.__LN);
var x=new qx.ui.form.Button(a);
x.addListener(o,function(e){z.close();
});
z.add(x);
var y=new qx.ui.core.Command(j);
y.addListener(o,function(e){x.execute();
y.dispose();
y=null;
});
return z;
},getCellEditorValue:function(p){return parseFloat(p.__LN.getValue());
}}});
})();
