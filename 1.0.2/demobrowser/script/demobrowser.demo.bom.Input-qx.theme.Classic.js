...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Input-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"6369100a0ec5"},
  boot : "boot",
  bootIsInline : true,
