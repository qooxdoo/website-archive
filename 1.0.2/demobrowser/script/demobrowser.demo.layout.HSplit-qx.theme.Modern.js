...
},addSplitPaneTwoFlexSimple:function(){var r=new qx.ui.splitpane.Pane(p);
r.setWidth(400);
r.setHeight(60);
r.setDecorator(o);
this.getRoot().add(r,{left:20,top:20});
var q=new qx.ui.form.TextArea(n);
q.setDecorator(null);
q.setWrap(true);
r.add(q,1);
...
s.setWrap(true);
r.add(s,2);
},addSplitPaneTwoFlexWithOneMin:function(){var b=new qx.ui.splitpane.Pane(p);
b.setWidth(400);
b.setHeight(60);
b.setDecorator(o);
this.getRoot().add(b,{left:20,top:100});
var a=new qx.ui.form.TextArea(m);
a.setDecorator(null);
a.setWrap(true);
a.setMinWidth(250);
b.add(a,1);
...
c.setWrap(true);
b.add(c,2);
},addSplitPaneTwoFlexWithOneMax:function(){var x=new qx.ui.splitpane.Pane(p);
x.setWidth(400);
x.setHeight(60);
x.setDecorator(o);
this.getRoot().add(x,{left:20,top:180});
var w=new qx.ui.form.TextArea(n);
w.setDecorator(null);
w.setWrap(true);
x.add(w,1);
var y=new qx.ui.form.TextArea(i);
y.setDecorator(null);
y.setWrap(true);
y.setMaxWidth(100);
x.add(y,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var A=new qx.ui.splitpane.Pane(p);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(o);
...
B.setMinWidth(250);
A.add(B,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var u=new qx.ui.splitpane.Pane(p);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(o);
this.getRoot().add(u,{left:20,top:340});
...
v.setMaxWidth(100);
u.add(v,2);
},addSplitPaneOneFlexSimple:function(){var G=new qx.ui.splitpane.Pane(p);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(o);
this.getRoot().add(G,{left:500,top:20});
...
H.setWrap(true);
G.add(H);
},addSplitPaneOneFlexSimpleWithMax:function(){var J=new qx.ui.splitpane.Pane(p);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(o);
this.getRoot().add(J,{left:500,top:100});
var I=new qx.ui.form.TextArea(j);
I.setDecorator(null);
I.setWrap(true);
J.add(I,0);
var K=new qx.ui.form.TextArea(g);
K.setDecorator(null);
K.setWrap(true);
K.setMaxWidth(200);
J.add(K);
},addSplitPaneOneFlexSimpleWithMin:function(){var D=new qx.ui.splitpane.Pane(p);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(o);
this.getRoot().add(D,{left:500,top:180});
...
E.setWrap(true);
D.add(E);
},addSplitPaneAuto:function(){var M=new qx.ui.splitpane.Pane(p);
M.setDecorator(o);
