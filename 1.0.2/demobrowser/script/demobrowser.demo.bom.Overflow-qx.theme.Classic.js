...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Overflow-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"990a77b04db8"},
  boot : "boot",
  bootIsInline : true,
