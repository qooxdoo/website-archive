...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.SingleValueBinding-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"431d68c2064c"},
  boot : "boot",
  bootIsInline : true,
