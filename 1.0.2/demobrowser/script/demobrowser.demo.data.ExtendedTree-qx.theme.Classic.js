...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ExtendedTree-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"5b1f3a074e49"},
  boot : "boot",
  bootIsInline : true,
