...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Window-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"36e6e76a030a"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var T="changeValue",S="execute",R="icon/16/apps/office-calendar.png",Q="right",P="demobrowser.demo.widget.Window",O="Yes",N="Second Window",M="Page 1",L="bottom",K="Use move frame",bJ="Show Statusbar",bI="icon/16/actions/dialog-cancel.png",bH="icon/32/status/dialog-error.png",bG="Show Close",bF="icon/32/apps/office-address-book.png",bE="Third Window",bD="icon/22/apps/utilities-calculator.png",bC="Show Maximize",bB="Allow Close",bA="Use resize frame",bb="No",bc="resizable",Y="Allow Maximize",ba="value",W="The second window",X="Page 3",U="move",V="Resizable ",bf="First Window",bg="resize",bo="Moveable",bm="Demo loaded",bs="Allow Minimize",bq="Resizable",bw="Open Modal Dialog 2",bu="Open Modal Dialog 1",bi="First Modal Dialog",bz="top",by="Movable",bx="Show Minimize",bh="Basics",bk="Modal",bl="Do you want to fly to Berlin?",bn="Welcome to your first own Window.<br/>Have fun!",bp="Application is ready",br="icon/16/apps/internet-feed-reader.png",bt="Second Modal Dialog",bv="icon/16/actions/dialog-ok.png",bd="Page 2",be="left",bj="icon/16/apps/internet-telephony.png";
qx.Class.define(P,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
this.createWindow1();
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var G=new qx.ui.window.Window(bf,R);
G.setLayout(new qx.ui.layout.VBox(10));
G.setShowStatusbar(true);
G.setStatus(bm);
G.open();
this.getRoot().add(G,{left:20,top:20});
G.addListener(U,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
G.addListener(bg,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var F=new qx.ui.basic.Atom(bn,bF);
F.setRich(true);
G.add(F);
var E=new qx.ui.tabview.TabView;
G.add(E,{flex:1});
var J=new qx.ui.tabview.Page(M);
E.add(J);
var H=new qx.ui.tabview.Page(bd);
E.add(H);
var I=new qx.ui.tabview.Page(X);
E.add(I);
},createWindow2:function(){var h=new qx.ui.window.Window(N,br);
h.setLayout(new qx.ui.layout.VBox(10));
h.setStatus(bp);
h.open();
this.getRoot().add(h,{left:350,top:120});
var r=new qx.ui.basic.Atom(W,bD);
h.add(r);
var a=new qx.ui.container.Composite;
a.setLayout(new qx.ui.layout.HBox(10));
h.add(a,{flex:1});
var k=new qx.ui.groupbox.GroupBox(bh);
k.setLayout(new qx.ui.layout.VBox(4));
a.add(k,{flex:1});
var d=new qx.ui.form.CheckBox(bG);
d.setValue(true);
d.addListener(T,function(e){h.setShowClose(e.getData());
});
k.add(d);
var q=new qx.ui.form.CheckBox(bC);
q.setValue(true);
q.addListener(T,function(e){h.setShowMaximize(e.getData());
});
k.add(q);
var j=new qx.ui.form.CheckBox(bx);
j.setValue(true);
j.addListener(T,function(e){h.setShowMinimize(e.getData());
});
k.add(j);
var m=new qx.ui.form.CheckBox(bB);
m.setValue(true);
m.addListener(T,function(e){h.setAllowClose(e.getData());
});
k.add(m);
var s=new qx.ui.form.CheckBox(Y);
s.setValue(true);
s.addListener(T,function(e){h.setAllowMaximize(e.getData());
});
k.add(s);
var g=new qx.ui.form.CheckBox(bs);
g.setValue(true);
g.addListener(T,function(e){h.setAllowMinimize(e.getData());
});
k.add(g);
var b=new qx.ui.form.CheckBox(bJ);
b.setValue(false);
b.addListener(T,function(e){h.setShowStatusbar(e.getData());
});
k.add(b);
var u=new qx.ui.groupbox.GroupBox(bq);
u.setLayout(new qx.ui.layout.VBox(4));
a.add(u,{flex:1});
var o=new qx.ui.form.CheckBox(bA);
o.setValue(true);
o.addListener(T,function(e){h.setUseResizeFrame(e.getData());
});
u.add(o);
var p=[bz,Q,L,be];

for(var i=0;i<p.length;i++){var n=p[i];
var f=new qx.ui.form.CheckBox(V+n).set({value:true});
f.bind(ba,h,bc+qx.lang.String.firstUp(n));
u.add(f);
}var c=new qx.ui.groupbox.GroupBox(bo);
c.setLayout(new qx.ui.layout.VBox(4));
a.add(c,{flex:1});
var l=new qx.ui.form.CheckBox(by);
l.setValue(true);
l.addListener(T,function(e){h.setMovable(e.getData());
});
c.add(l);
var t=new qx.ui.form.CheckBox(K);
t.addListener(T,function(e){h.setUseMoveFrame(e.getData());
});
c.add(t);
},createWindow3:function(){var bK=new qx.ui.window.Window(bE,bj);
bK.setLayout(new qx.ui.layout.VBox);
bK.setMaxWidth(450);
bK.setMaxHeight(400);
bK.setAllowMaximize(false);
bK.open();
this.getRoot().add(bK,{left:100,top:250});
var bL=this.getModalWindow1();
var bM=new qx.ui.form.Button(bu,R);
bM.addListener(S,bL.open,bL);
bK.add(bM);
},getModalWindow1:function(){var w=new qx.ui.window.Window(bi);
w.setLayout(new qx.ui.layout.VBox(10));
w.setModal(true);
w.moveTo(150,150);
this.getRoot().add(w);
var v=this.getModalWindow2();
var y=new qx.ui.form.Button(bw,R);
y.addListener(S,v.open,v);
w.add(y);
var x=new qx.ui.form.CheckBox(bk);
x.setValue(true);
w.add(x);
x.addListener(T,function(e){w.setModal(e.getData());
});
return w;
},getModalWindow2:function(){var A=new qx.ui.window.Window(bt);
A.setLayout(new qx.ui.layout.VBox(10));
A.setModal(true);
A.setShowClose(false);
A.moveTo(300,300);
this.getRoot().add(A);
var z=new qx.ui.basic.Atom(bl,bH);
A.add(z);
var C=new qx.ui.container.Composite;
C.setLayout(new qx.ui.layout.HBox(10,Q));
A.add(C);
var D=new qx.ui.form.Button(O,bv);
D.addListener(S,function(e){A.close();
});
C.add(D);
var B=new qx.ui.form.Button(bb,bI);
B.addListener(S,function(e){alert("Sorry, please click 'Yes'!");
});
C.add(B);
return A;
}}});
...
(function(){var o="pane",n="lastTab",m="bar",k="page",j="firstTab",h="right",g="bottom",f="button",d="changeSelection",c="close",C="top",B="left",A="qx.event.type.Data",z="__Et",y="barRight",x="beforeChangeSelection",w="tabview",v="vertical",u="_applyBarPosition",t="barLeft",r="horizontal",s="qx.ui.tabview.TabView",p="barTop",q="barBottom";
qx.Class.define(s,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(R){arguments.callee.base.call(this);
this.__Es={top:p,right:y,bottom:q,left:t};
this._createChildControl(m);
this._createChildControl(o);
var S=this.__Et=new qx.ui.form.RadioGroup;
S.setWrap(false);
S.addListener(d,this._onChangeSelection,this);
if(R!=null){this.setBarPosition(R);
}else{this.initBarPosition();
}},events:{"changeSelection":A},properties:{appearance:{refine:true,init:w},barPosition:{check:[B,h,C,g],init:C,apply:u}},members:{__Et:null,_createChildControlImpl:function(ba){var bb;

switch(ba){case m:bb=new qx.ui.container.SlideBar();
bb.setZIndex(10);
this._add(bb);
break;
case o:bb=new qx.ui.container.Stack;
bb.setZIndex(5);
this._add(bb,{flex:1});
break;
...
Y.add(U);
this.__Et.add(V);
U.addState(this.__Es[this.getBarPosition()]);
U.addState(n);
var X=this.getChildren();

if(X[0]==U){U.addState(j);
}else{X[X.length-2].removeState(n);
}U.addListener(c,this._onPageClose,this);
},remove:function(bd){var bi=this.getChildControl(o);
var bg=this.getChildControl(m);
var bf=bd.getButton();
var bh=bi.getChildren();
if(this.getSelection()[0]==bd){var be=bh.indexOf(bd);

if(be==0){if(bh[1]){this.setSelection([bh[1]]);
}else{this.resetSelection();
}}else{this.setSelection([bh[be-1]]);
}}bg.remove(bf);
bi.remove(bd);
this.__Et.remove(bf);
bd.removeState(this.__Es[this.getBarPosition()]);
if(bd.hasState(j)){bd.removeState(j);

if(bh[0]){bh[0].addState(j);
}}
if(bd.hasState(n)){bd.removeState(n);

if(bh.length>0){bh[bh.length-1].addState(n);
}}bd.removeListener(c,this._onPageClose,this);
...
},__Es:null,_applyBarPosition:function(D,E){var F=this.getChildControl(m);
var K=D==B||D==h;
var I=D==h||D==g;
...
F.setOrientation(K?v:r);
var L=this.getChildren();
if(E){var G=this.__Es[E];
F.removeState(G);
for(var i=0,l=L.length;i<l;i++){L[i].removeState(G);
}}
if(D){var H=this.__Es[D];
F.addState(H);
for(var i=0,l=L.length;i<l;i++){L[i].addState(H);
}}},getSelection:function(){var a=this.__Et.getSelection();
var b=[];
...
for(var i=0;i<bl.length;i++){bm.push(bl[i].getChildControl(f));
}this.__Et.setSelection(bm);
},resetSelection:function(){this.__Et.resetSelection();
},isSelected:function(bj){var bk=bj.getChildControl(f);
return this.__Et.isSelected(bk);
},isSelectionEmpty:function(){return this.__Et.isSelectionEmpty();
},getSelectables:function(){var bn=this.__Et.getSelectables();
var bo=[];

for(var i=0;i<bn.length;i++){bo.push(bn[i].getUserData(k));
}return bo;
},_onChangeSelection:function(e){var Q=this.getChildControl(o);
var N=e.getData()[0];

if(N){Q.setSelection([N.getUserData(k)]);
N.focus();
this.scrollChildIntoView(N,null,null,false);
}else{Q.resetSelection();
}var P=Q.getSelection();
var O=e.getOldData();
this.fireDataEvent(d,P,O);
...
if(T){this.setSelection([T.getUserData(k)]);
}else{this.resetSelection();
...
qx.Class.define(e,{extend:qx.ui.container.Composite,construct:function(q,r){arguments.callee.base.call(this);
this._createChildControl(n);
if(q!=null){this.setLabel(q);
}
if(r!=null){this.setIcon(r);
}},events:{"close":h},properties:{appearance:{refine:true,init:f},label:{check:k,init:m,apply:c},icon:{check:k,init:m,apply:j},showCloseButton:{check:d,init:false,apply:g}},members:{_forwardStates:{barTop:1,barRight:1,barBottom:1,barLeft:1,firstTab:1,lastTab:1},_applyIcon:function(x,y){this.getChildControl(n).setIcon(x);
...
switch(o){case n:p=new qx.ui.tabview.TabButton;
p.setAllowGrowX(true);
p.setAllowGrowY(true);
p.setUserData(i,this);
p.addListener(l,this._onButtonClose,this);
break;
...
},events:{"close":a},properties:{showCloseButton:{check:h,init:false,apply:e}},members:{_applyIconPosition:function(u,v){var w={icon:this.getChildControl(l),label:this.getChildControl(k),closeButton:this.getShowCloseButton()?this.getChildControl(o):null};
for(var x in w){if(w[x]){this._remove(w[x]);
}}
switch(u){case d:this._add(w.label,{row:3,column:2});
this._add(w.icon,{row:1,column:2});

if(w.closeButton){this._add(w.closeButton,{row:0,column:4});
}break;
case g:this._add(w.label,{row:1,column:2});
this._add(w.icon,{row:3,column:2});

if(w.closeButton){this._add(w.closeButton,{row:0,column:4});
}break;
case m:this._add(w.label,{row:0,column:2});
this._add(w.icon,{row:0,column:0});

if(w.closeButton){this._add(w.closeButton,{row:0,column:4});
}break;
case j:this._add(w.label,{row:0,column:0});
...
switch(s){case k:var t=new qx.ui.basic.Label(this.getLabel());
t.setAnonymous(true);
this._add(t,{row:0,column:2});
this._getLayout().setColumnFlex(2,1);
break;
case l:t=new qx.ui.basic.Image(this.getIcon());
t.setAnonymous(true);
this._add(t,{row:0,column:0});
break;
case o:t=new qx.ui.form.Button();
t.addListener(i,this._onCloseButtonClick,this);
this._add(t,{row:0,column:4});

if(!this.getShowCloseButton()){t.exclude();
}break;
}return t||arguments.callee.base.call(this,s);
},_onCloseButtonClick:function(){this.fireDataEvent(b,this);
},_applyShowCloseButton:function(q,r){if(q){this._showChildControl(o);
