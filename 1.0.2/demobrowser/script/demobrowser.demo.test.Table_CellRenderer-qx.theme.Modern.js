...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_CellRenderer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"574f42704f22"},
  boot : "boot",
  bootIsInline : true,
