...
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return j;
},getBox2:function(){var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,minWidth:60,allowGrowY:false});
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
D.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:a}));
return D;
},getBox3:function(){var t=new qx.ui.layout.VBox();
var u=new qx.ui.container.Composite(t).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
t.setSpacing(5);
t.setAlignY(e);
u.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
u.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
u.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return u;
},getBox4:function(){var A=new qx.ui.layout.VBox();
var B=new qx.ui.container.Composite(A).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
A.setSpacing(5);
A.setAlignY(f);
...
B.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return B;
},getBox5:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
...
var q=new qx.ui.container.Composite(o).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
o.setSpacing(5);
o.setAlignY(e);
var s=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var r=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
