...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.ScrollIntoView-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"078b1e7fc181"},
  boot : "boot",
  bootIsInline : true,
