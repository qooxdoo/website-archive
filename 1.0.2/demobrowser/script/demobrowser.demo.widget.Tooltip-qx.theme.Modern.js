...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Tooltip-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d37d4d20db93"},
  boot : "boot",
  bootIsInline : true,
