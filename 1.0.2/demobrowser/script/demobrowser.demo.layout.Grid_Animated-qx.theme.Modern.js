...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Grid_Animated-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1d3e168702a3"},
  boot : "boot",
  bootIsInline : true,
