...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ListController-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"35ba52e0e863"},
  boot : "boot",
  bootIsInline : true,
