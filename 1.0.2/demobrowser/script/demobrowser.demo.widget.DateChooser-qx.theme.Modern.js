...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.DateChooser","qx.theme":"qx.theme.Modern"};
...
qx.$$resources = {};
qx.$$translations = {"C":{},"de":{"Last month":"Vorheriger Monat","Last year":"Vorheriges Jahr","Next month":"Nächster Monat","Next year":"Nächstes Jahr"},"de_DE":{},"en":{},"en_US":{},"fr":{"Last month":"Mois dernier","Last year":"Année dernière","Next month":"Mois prochain","Next year":"Année prochaine"},"fr_FR":{}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.DateChooser-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c36109210c80"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var r="execute",q="- Use the cursors keys to move the selection.",p="- Double-click or enter/space-key will fire an execute event.",o="bold",n="- Page-keys / shift + page-keys switch months/years.",m="changeDate",l="select a date",k="Show January 1981",j="Set current date",i="Execute: ",c="Change: ",h="center",g="en",b="demobrowser.demo.widget.DateChooser",a="Remove the selection",f="Description",d="- Escape will remove the selection.";
...
var y=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var F=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var z=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var u=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
F.add(u);
F.add(D);
y.add(F);
y.add(z);
...
var w=new qx.ui.control.DateChooser();
E.addBefore(w,y);
var C=new qx.ui.basic.Label(l);
B.add(C);
w.addListener(m,function(e){C.setValue(c+e.getData());
},this);
w.addListener(r,function(e){var s=w.getValue();
C.setValue(i+s);
},this);
var x=new qx.ui.form.Button(j);
x.setAlignX(h);
u.add(x);
x.addListener(r,function(e){w.setValue(new Date());
});
var A=new qx.ui.form.Button(k);
u.add(A);
A.addListener(r,function(e){w.showMonth(0,1981);
});
var v=new qx.ui.form.Button(a);
u.add(v);
v.addListener(r,function(e){w.setValue(null);
});
var t=new qx.ui.basic.Label(f);
t.setFont(o);
D.add(t);
D.add(new qx.ui.basic.Label(q));
D.add(new qx.ui.basic.Label(n));
D.add(new qx.ui.basic.Label(p));
D.add(new qx.ui.basic.Label(d));
}}});
})();
