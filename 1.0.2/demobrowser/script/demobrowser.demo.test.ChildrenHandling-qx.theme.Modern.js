...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ChildrenHandling-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1a38162bab01"},
  boot : "boot",
  bootIsInline : true,
