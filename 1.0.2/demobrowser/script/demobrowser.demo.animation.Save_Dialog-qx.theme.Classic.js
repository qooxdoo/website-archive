...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Save_Dialog-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"3f49ea0b9b07"},
  boot : "boot",
  bootIsInline : true,
