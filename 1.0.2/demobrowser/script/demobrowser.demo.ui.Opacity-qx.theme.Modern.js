...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.Opacity","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.Opacity-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7d21da88e997"},
  boot : "boot",
  bootIsInline : true,
...
o.setSpacing(10);
var n=new qx.ui.container.Composite(o);
n.setPadding(20);
p.add(n);
this.getRoot().add(p,{edge:0});
n.add(this.getGrid1());
},getGrid1:function(){var l=new qx.ui.decoration.Single(1,b,a);
var m=30;
var j=30;
var i=15;
var g=new qx.ui.container.Composite(new qx.ui.layout.Grid());
var h=new qx.ui.basic.Label().set({rich:true,value:e,decorator:l,backgroundColor:f});
h.setUserBounds(0,0,i*m+100,i*j);
g.add(h);
var k=Math.sqrt((m-1)*(m-1)+(j-1)*(j-1));

for(var x=0;x<m;x++){for(var y=0;y<j;y++){g.add(new qx.ui.core.Widget().set({backgroundColor:d,height:i,width:i,opacity:Math.sqrt(x*x+y*y)/k}),{row:x,column:y});
}}return g;
}}});
})();
