...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.root.Page","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Page-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"4734ac220546"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var f="main",e="demobrowser.demo.root.Page",d="yellow",c="red",b="green",a="blue";
qx.Class.define(e,{extend:qx.application.Inline,members:{main:function(){arguments.callee.base.call(this);
var g=new qx.ui.container.Composite(new qx.ui.layout.HBox());
var k=new qx.ui.core.Widget().set({backgroundColor:c,decorator:f,padding:10});
var j=new qx.ui.core.Widget().set({backgroundColor:a,decorator:f});
var i=new qx.ui.core.Widget().set({backgroundColor:b,decorator:f});
var h=new qx.ui.core.Widget().set({backgroundColor:d,decorator:f});
g.add(k);
g.add(j);
g.add(i);
g.add(h);
this.getRoot().add(g,{left:30,top:120});
}}});
})();
