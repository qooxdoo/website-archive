...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.showcase.Form-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"43a6aa31c185"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var p="placeholder",o="Button",n="CheckBox:",m="TextArea:",l="Boolean",k="RepeatButton:",j="execute",h="Website 2",g="Text",f="ToggleButton",X="password",W="RadioButton 3",V="Button:",U="ComboBox:",T="ToggleButton:",S="Options",R="RadioButton",Q="0",P="MenuButton:",O="demobrowser.demo.showcase.Form",w="PasswordField:",x="SplitButton",u="Buttons",v="",s="RadioButtons:",t="dd.mm.YYYY",q="List:",r="SplitButton:",y="Option",z="RadioButton 1",G="Spinner:",E="Selection",I="DateField:",H="RadioButton 2",K="Number",J="CheckBox",B="SelectBox:",N="Website 3",M="MenuButton",L="Website 1",A="Slider:",C="TextField:",D="Item ",F="RadioButtonGroup:";
qx.Class.define(O,{extend:qx.application.Standalone,statics:{ITEM_SIZE:5},members:{main:function(){arguments.callee.base.call(this);
var bb=new qx.ui.groupbox.GroupBox(g);
bb.setLayout(new qx.ui.layout.Grid(8,8));
bb.setWidth(290);
this.getRoot().add(bb,{left:20,top:10});
var bx=new qx.ui.form.TextField();
bx.setPlaceholder(p);
var bj=new qx.ui.basic.Label(C);
bj.setBuddy(bx);
bb.add(bj,{row:0,column:0});
bb.add(bx,{row:0,column:1});
var bh=new qx.ui.form.PasswordField();
bh.setPlaceholder(X);
bj=new qx.ui.basic.Label(w);
bj.setBuddy(bh);
bb.add(bj,{row:1,column:0});
bb.add(bh,{row:1,column:1});
var bc=new qx.ui.form.TextArea();
bc.setPlaceholder(p);
bj=new qx.ui.basic.Label(m);
bj.setBuddy(bc);
bb.add(bj,{row:2,column:0});
bb.add(bc,{row:2,column:1});
var bd=new qx.ui.form.ComboBox();
bd.setPlaceholder(p);
bj=new qx.ui.basic.Label(U);
bj.setBuddy(bd);
bb.add(bj,{row:3,column:0});
bb.add(bd,{row:3,column:1});
this.createItems(bd);
var bq=new qx.ui.form.DateField();
bq.setPlaceholder(t);
bj=new qx.ui.basic.Label(I);
bj.setBuddy(bq);
bb.add(bj,{row:4,column:0});
bb.add(bq,{row:4,column:1});
var bi=new qx.ui.groupbox.GroupBox(E);
bi.setLayout(new qx.ui.layout.Grid(8,8));
bi.setWidth(290);
this.getRoot().add(bi,{left:20,top:250});
var br=new qx.ui.form.SelectBox();
bj=new qx.ui.basic.Label(B);
bj.setBuddy(br);
bi.add(bj,{row:0,column:0});
bi.add(br,{row:0,column:1});
this.createItems(br);
...
bj.setBuddy(bw);
bi.add(bj,{row:1,column:0});
bi.add(bw,{row:1,column:1});
this.createItems(bw);
var bp=new qx.ui.form.RadioButtonGroup();
bp.add(new qx.ui.form.RadioButton(z));
bp.add(new qx.ui.form.RadioButton(H));
bp.add(new qx.ui.form.RadioButton(W));
bj=new qx.ui.basic.Label(F);
bj.setBuddy(bp);
bi.add(bj,{row:2,column:0});
bi.add(bp,{row:2,column:1});
var bu=new qx.ui.groupbox.GroupBox(u);
bu.setLayout(new qx.ui.layout.Grid(8,8));
bu.setWidth(210);
this.getRoot().add(bu,{left:330,top:10});
var bv=new qx.ui.form.Button(o);
bj=new qx.ui.basic.Label(V);
bj.setBuddy(bv);
bu.add(bj,{row:0,column:0});
bu.add(bv,{row:0,column:1});
var bf=new qx.ui.form.ToggleButton(f);
bj=new qx.ui.basic.Label(T);
bj.setBuddy(bf);
bu.add(bj,{row:1,column:0});
bu.add(bf,{row:1,column:1});
var bm=new qx.ui.form.RepeatButton(Q);
bj=new qx.ui.basic.Label(k);
bj.setBuddy(bm);
bu.add(bj,{row:2,column:0});
bu.add(bm,{row:2,column:1});
var bn=new qx.ui.form.MenuButton(M,null,this.createMenuForMenuButton());
bj=new qx.ui.basic.Label(P);
bj.setBuddy(bn);
bu.add(bj,{row:3,column:0});
bu.add(bn,{row:3,column:1});
var bg=new qx.ui.form.SplitButton(x,null,this.createMenuForSplitButton());
bj=new qx.ui.basic.Label(r);
bj.setBuddy(bg);
bu.add(bj,{row:4,column:0});
bu.add(bg,{row:4,column:1});
bm.addListener(j,function(){var bC=parseInt(bm.getLabel())+1;
bm.setLabel(bC.toString());
});
var be=new qx.ui.groupbox.GroupBox(l);
be.setLayout(new qx.ui.layout.Grid(8,8));
be.setWidth(210);
this.getRoot().add(be,{left:330,top:210});
var bs=new qx.ui.form.CheckBox(J);
bj=new qx.ui.basic.Label(n);
bj.setBuddy(bs);
be.add(bj,{row:0,column:0});
be.add(bs,{row:0,column:1});
var bl=new qx.ui.form.RadioButton(R);
be.add(new qx.ui.basic.Label(s),{row:1,column:0});
be.add(bl,{row:1,column:1});
var bt=new qx.ui.groupbox.GroupBox(K);
bt.setLayout(new qx.ui.layout.Grid(8,8));
bt.setWidth(210);
this.getRoot().add(bt,{left:330,top:310});
var bk=new qx.ui.form.Spinner(0,50,100);
bj=new qx.ui.basic.Label(G);
bj.setBuddy(bk);
bt.add(bj,{row:0,column:0});
bt.add(bk,{row:0,column:1});
var bo=new qx.ui.form.Slider();
bo.setWidth(130);
bj=new qx.ui.basic.Label(A);
bj.setBuddy(bo);
bt.add(bj,{row:1,column:0});
bt.add(bo,{row:1,column:1});
},createItems:function(Y){for(var i=0;i<arguments.callee.self.ITEM_SIZE;i++){var ba=new qx.ui.form.ListItem(D+i);
Y.add(ba);
}},createMenuForMenuButton:function(){var a=new qx.ui.menu.Menu;

for(var i=0;i<3;i++){a.add(new qx.ui.menu.RadioButton(y+i));
}var d=new qx.ui.form.RadioGroup;
d.add.apply(d,a.getChildren());
var c=new qx.ui.menu.Menu();

for(var i=0;i<3;i++){var e=new qx.ui.menu.Button(o+i);
c.add(e);
}var b=new qx.ui.menu.Button(S,v,null,a);
c.addSeparator();
c.add(b);
return c;
},createMenuForSplitButton:function(){var by=new qx.ui.menu.Menu;
var bB=new qx.ui.menu.Button(L);
var bz=new qx.ui.menu.Button(h);
var bA=new qx.ui.menu.Button(N);
by.add(bB);
by.add(bz);
by.add(bA);
return by;
