...
(function(){var bJ="value",bI="multi",bH="one",bG="bold",bF="changeSelection",bE="additive",bD="single",bC="changeValue",bB="Item No ",bA="Julian",bp="Show Icon",bo="Kevin",bn="Marvin",bm="Marc",bl="Configurable",bk="icon/16/places/folder.png",bj="computer.png",bi="Jason",bh="Jakob",bg="Lukas",bQ="Julius",bR="network-wired.png",bO="Jan",bP="Tobias",bM="Mika",bN="Nils",bK="Noah",bL="Tom",bS="Nico",bT="Multi Selection",bt="battery.png",bs="Felix",bv="Leon",bu="input-keyboard.png",bx="camera-web.png",bw="Enable drag selection",bz="icon",by="Show Both",br="48",bq="icon/48/devices/",b="Fabian",c="multimedia-player.png",d="camera-photo.png",f="media-flash.png",g="input-mouse.png",h="Joel",j="Dominic",k="Show Label",l="demobrowser.demo.widget.List",m="Enable quick selection",bX="Finn",bW="One as selection mode",bV="Jannis",bU="audio-card.png",cc="Alexander",cb="Additive Selection",ca="display.png",bY="Erik",ce="addaptive",cd="Johannes",L="pda.png",M="16",J="Jonas",K="icon/",P="David",Q="Maximilian",N="Tim",O="Justin",H="Single Selection",I="Linus",u="Daniel",t="Paul",w="Philipp",v="Niclas",q="One Selection",p="Nick",s="Jonathan",r="Ben",o="on",n="Vincent",V="/places/folder.png",W="Robin",X="both",Y="Jannick",R="Luis",S="drive-harddisk.png",T="Lennard",U="Moritz",ba="Florian",bb="drive-optical.png",E="media-optical.png",D="Marlon",C="Luca",B="network-wireless.png",A="audio-input-microphone.png",z="phone.png",y="Simon",x="Colin",G="label",F="printer.png",bc="Max",bd="Additive selection",be="Horizontal, Icons only",bf="Elias";
...
var cq=new qx.ui.basic.Label(bl);
cq.setFont(bG);
cw.add(cq,{left:20,top:20});
var cy=new qx.ui.form.List;
cy.setScrollbarX(o);
cy.set({height:280,width:150,selectionMode:bI});
var cz;

for(var i=1;i<=25;i++){cz=new qx.ui.form.ListItem(bB+i,K+((i%4)?M:br)+V);
cy.add(cz);
!(i%9)&&(cz.setEnabled(false));
if(i==20){cy.setSelection([cz]);
}}cy.addListener(bF,function(e){var cG=e.getData();

if(cG[0]){this.debug("Value: "+cG[0].getLabel());
}});
cw.add(cy,{left:20,top:40});
var cm=new qx.ui.form.RadioButton(H);
var cj=new qx.ui.form.RadioButton(bT);
var ck=new qx.ui.form.RadioButton(cb);
var ci=new qx.ui.form.RadioButton(q);
cm.setUserData(bJ,bD);
cj.setUserData(bJ,bI);
ck.setUserData(bJ,bE);
ci.setUserData(bJ,bH);
cj.setValue(true);
...
var cC=new qx.ui.form.RadioButton(k);
var cB=new qx.ui.form.RadioButton(bp);
var cE=new qx.ui.form.RadioButton(by);
cC.setUserData(bJ,G);
cB.setUserData(bJ,bz);
cE.setUserData(bJ,X);
cE.setValue(true);
...
cx.addListener(bF,function(e){for(var i=0;i<cy.getChildren().length;i++){cy.getChildren()[i].setShow(e.getData()[0].getUserData(bJ));
}});
var cu=new qx.ui.form.CheckBox(bw);
var cr=new qx.ui.form.CheckBox(m).set({enabled:false});
cw.add(cu,{left:180,top:220});
cw.add(cr,{left:180,top:240});
cu.addListener(bC,function(e){if(e.getData()){var a=cy.getSelectionMode();

if(a==bD||a==bH){this.debug("Drag selection is only available for the modes multi or additive");
}}cy.setDragSelection(e.getData());
});
cr.addListener(bC,function(e){if(e.getData()){var cF=cy.getSelectionMode();

if(cF==bI||cF==bE){this.debug("Quick selection is only available for the modes multi or additive");
}}cy.setQuickSelection(e.getData());
});
cl.addListener(bF,function(e){var cf=e.getData()[0].getUserData(bJ);
cy.setSelectionMode(cf);

if(cf==bD||cf==bH){cu.setEnabled(false);
cr.setEnabled(true);
}else if(cf==bI||cf==ce){cu.setEnabled(true);
cr.setEnabled(false);
}});
var cD=new qx.ui.basic.Label(bW);
cD.setFont(bG);
cw.add(cD,{left:330,top:20});
var cp=new qx.ui.form.List();
cp.set({height:280,width:150,selectionMode:bH});
var cz;

for(var i=1;i<=25;i++){cz=new qx.ui.form.ListItem(bB+i,bk);
cp.add(cz);
...
var cn;
ch.set({width:150,selectionMode:bE});
var ct=[bv,bg,C,bX,N,bs,J,R,Q,bA,bc,t,v,bO,r,bf,Y,w,bK,bL,U,bS,P,bN,y,b,bY,O,cc,bh,ba,p,I,bM,bi,u,T,bn,bV,bP,j,D,bm,cd,s,bQ,x,h,bo,n,W];
...
var cq=new qx.ui.basic.Label(be);
cq.setFont(bG);
cw.add(cq,{left:20,top:350});
var cA=new qx.ui.form.List(true);
var co;
cA.set({width:550,selectionMode:bI,height:null});
var cs=[bU,A,bt,d,bx,bj,ca,S,bb,bu,g,f,E,c,bR,B,L,z,F];
var cv=bq;
