...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_CellEditor-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a57fc3792ea4"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var m="",l="cat",k="Juhu",j="mouse",i="dog",h="execute",g="rat",f="demobrowser.demo.test.Table_CellEditor",e="Add/Remove editor",d="Get value",b="_container",c="boolean";
qx.Class.define(f,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
...
},_addEditor:function(y,z){z=qx.lang.Object.clone(z);
var A=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var E=y.createCellEditor(z);
var F=new qx.ui.container.Composite().set({width:200,height:20});
E.setUserBounds(0,0,200,20);
F.add(E);
A.add(F);
var C=new qx.ui.form.Button(d);
A.add(C);
C.addListener(h,function(){D.setValue(y.getCellEditorValue(E)+m);
});
var B=new qx.ui.form.Button(e);
A.add(B);
B.addListener(h,function(){E.destroy();
qx.ui.core.queue.Manager.flush();
E=y.createCellEditor(z);
E.setUserBounds(0,0,200,20);
F.add(E);
qx.ui.core.queue.Manager.flush();
});
var D=new qx.ui.basic.Label(m);
A.add(D);
this._container.add(A);
C.execute();
},testCheckBoxEditor:function(){var a={value:[true,false]};
qx.util.Permutation.permute(a,function(H){this._addEditor(new qx.ui.table.celleditor.CheckBox(),H);
},this);
},testComboBoxEditor:function(){var r={value:[m,l,g,2],table:[this.getTableMock()]};
var s=new qx.ui.table.celleditor.ComboBox();
s.setListData([i,l,j]);
qx.util.Permutation.permute(r,function(I){this._addEditor(s,I);
},this);
},testSelectBoxEditor:function(){var v={value:[m,l],table:[this.getTableMock()]};
var w=new qx.ui.table.celleditor.SelectBox();
w.setListData([i,l,j]);
qx.util.Permutation.permute(v,function(q){this._addEditor(w,q);
},this);
},testPasswordEditor:function(){var n={value:[null,10,k]};
qx.util.Permutation.permute(n,function(o){this._addEditor(new qx.ui.table.celleditor.PasswordField(),o);
},this);
},testTextfieldEditor:function(){var x={value:[null,10,k]};
qx.util.Permutation.permute(x,function(G){this._addEditor(new qx.ui.table.celleditor.TextField(),G);
},this);
},testTextfieldEditorDynamic:function(){var t={value:[true,k]};
var u=new qx.ui.table.celleditor.Dynamic();
u.setCellEditorFactoryFunction(function(p){if(typeof p.value==c){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(t,function(J){this._addEditor(u,J);
},this);
...
qx.Class.define(a,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,construct:function(c){arguments.callee.base.call(this);

if(c){this.setCellEditorFactoryFunction(c);
}},properties:{cellEditorFactoryFunction:{check:b,nullable:true,init:null}},members:{__IK:null,createCellEditor:function(d){var e=this.getCellEditorFactoryFunction();
{};
this.__IK=e(d);
var f=this.__IK.createCellEditor(d);
return f;
},getCellEditorValue:function(g){var h=this.getCellEditorFactoryFunction();
{};
var i=this.__IK.getCellEditorValue(g);
return i;
