...
H.add(this.getBox6());
H.add(this.getBox7());
},getBox1:function(){var A=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,allowGrowX:false});
...
z.setMarginLeft(-10);
return A;
},getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,allowGrowX:false});
...
j.setMarginLeft(-10);
return k;
},getBox3:function(){var w=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,width:500,allowGrowX:false});
