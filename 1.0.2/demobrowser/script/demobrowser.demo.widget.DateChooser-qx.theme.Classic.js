...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.DateChooser-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"1ae60a86e980"},
  boot : "boot",
  bootIsInline : true,
