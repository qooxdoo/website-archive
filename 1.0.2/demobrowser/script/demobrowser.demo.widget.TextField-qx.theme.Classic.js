...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.TextField","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.TextField-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d9f64ef7a00b"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var t="execute",s="monospace",r="Web 2.0",q="Toggle enabled",p="Send selection",o="Send end of selection",n="text\narea\nmonospace",m="Send content",l="20px sans-serif",k="Use the following buttons to interact with the ",d="changeValue",j="read only",h="Toggle live update",c="<b>first textfield</b> widget.",b="demobrowser.demo.widget.TextField",g="Send start of selection",f="text\narea",i="text\narea\nnowrap",a="max15";
...
u.setSpacing(10);
var I=new qx.ui.container.Composite(u);
I.setPadding(20);
this.getRoot().add(I,{left:0,top:0});
var w=new qx.ui.form.TextField(a).set({maxLength:15});
w.focus();
w.addListener(d,function(e){this.debug("ChangeValue: "+e.getData());
},this);
I.add(w);
var y=new qx.ui.form.TextField(r).set({font:qx.bom.Font.fromString(l),padding:6});
I.add(y);
var x=new qx.ui.form.TextField(j).set({readOnly:true});
I.add(x);
var z=new qx.ui.form.TextArea(f);
I.add(z);
var H=new qx.ui.form.TextArea(i);
H.setWrap(false);
I.add(H);
var G=new qx.ui.form.TextArea(n);
G.setFont(s);
I.add(G);
var B=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
B.setPadding(20);
var A=new qx.ui.form.Button(h);
A.addListener(t,function(){w.toggleLiveUpdate();
});
B.add(A);
var E=new qx.ui.form.Button(q);
var F=false;
E.addListener(t,function(){I.setEnabled(F);
F=!F;
});
B.add(E);
B.add(new qx.ui.core.Spacer(null,20));
var J=k+c;
var L=new qx.ui.basic.Label(J);
L.setRich(true);
B.add(L);
var C=new qx.ui.form.Button(m);
C.addListener(t,function(){this.debug("Sending content: "+w.getValue());
});
B.add(C);
var D=new qx.ui.form.Button(p);
D.setFocusable(false);
D.setKeepFocus(true);
D.addListener(t,function(){this.debug("Sending selection: "+w.getTextSelection());
});
B.add(D);
var K=new qx.ui.form.Button(g);
K.setFocusable(false);
K.setKeepFocus(true);
K.addListener(t,function(){this.debug("Sending selection: "+w.getTextSelectionStart());
});
B.add(K);
var v=new qx.ui.form.Button(o);
v.setFocusable(false);
v.setKeepFocus(true);
v.addListener(t,function(){this.debug("Sending selection: "+w.getTextSelectionEnd());
});
B.add(v);
this.getRoot().add(B,{left:200,top:0});
}}});
})();
