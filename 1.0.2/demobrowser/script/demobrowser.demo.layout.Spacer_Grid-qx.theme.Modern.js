...
f.add(this.getGrid1());
f.add(this.getGrid2());
},getGrid1:function(){var e=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:d,backgroundColor:b,allowGrowX:false,allowGrowY:false});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:0});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:1});
e.add(new qx.ui.core.Spacer(0,10),{row:1,column:0});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:0});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:1});
e.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:4,column:0});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:4,column:1});
return e;
