...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.FormRendererCustom-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"84f7582dff5d"},
  boot : "boot",
  bootIsInline : true,
