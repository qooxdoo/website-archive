...
g.add(this.getBox5());
g.add(this.getBox6());
},getBox1:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
m.add(l,{flex:1});
return m;
},getBox2:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
return y;
},getBox3:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
i.add(h,{flex:1});
return i;
},getBox4:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
return C;
},getBox6:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
