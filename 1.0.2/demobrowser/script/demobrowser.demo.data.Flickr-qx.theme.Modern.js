...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.Flickr-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c60f74418112"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var k="qooxdoo",j="/",i=".static.flickr.com/",h="http://api.flickr.com/services/rest/?tags=",g="",f="_",d="http://farm",c="Enter",b="keydown",a="model.photos.photo",G=".jpg",F="loaded",E="execute",D="source",C="selection[0]",B="_s.jpg",A="<span style='font-size: 20px'>Flickr</span>",z="failed",y="loading",x="value",r="demobrowser.demo.data.store.Flickr",s="demobrowser.demo.data.Flickr",p="title",q="icon",n="state",o="completed",l="Search",m="receiving",t="horizontal",u="model",w="&method=flickr.photos.search&api_key=63a8042eead205f7e0040f488c02afd9&format=json",v="id";
qx.Class.define(s,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var P=new demobrowser.demo.data.store.Flickr(k);
var H=new qx.ui.form.TextField(k);
this.getRoot().add(H,{left:30,top:50});
var I=new qx.ui.form.Button(l);
this.getRoot().add(I,{left:140,top:49});
I.addListener(E,function(){P.searchForTag(H.getValue());
},this);
H.addListener(b,function(e){if(e.getKeyIdentifier()==c){P.searchForTag(H.getValue());
}},this);
...
L.setHeight(110);
L.setOrientation(t);
this.getRoot().add(L,{left:30,right:30,top:80});
var N=new qx.data.controller.List(null,L);
N.setLabelPath(p);
N.setDelegate({configureItem:function(Y){Y.setShow(q);
}});
var J={converter:function(ba,bb){return (d+bb.getFarm()+i+bb.getServer()+j+ba+f+bb.getSecret()+B);
}};
N.setIconOptions(J);
N.setIconPath(v);
P.bind(a,N,u);
var K=new qx.ui.basic.Image();
this.getRoot().add(K,{left:30,top:200});
var O={converter:function(U){if(U){return (d+U.getFarm()+i+U.getServer()+j+U.getId()+f+U.getSecret()+G);
}return g;
}};
N.bind(C,K,D,O);
...
M.setWidth(260);
M.setValue(A);
this.getRoot().add(M,{left:10,top:10});
}}});
qx.Class.define(r,{extend:qx.data.store.Json,statics:{RESULT:null},construct:function(W){jsonFlickrApi=function(S){demobrowser.demo.data.store.Flickr.RESULT=S;
};
var X=h+W;
arguments.callee.base.call(this,X);
},members:{searchForTag:function(T){if(T!=g){this.setUrl(h+T);
}},_createRequest:function(Q){var R=new qx.io.ScriptLoader();
this.setState(m);
Q+=w;
R.load(Q,function(V){this.__Lh();
},this);
},__Lh:function(){this.setState(o);
var bc=demobrowser.demo.data.store.Flickr.RESULT;

if(bc==undefined){this.setState(z);
return;
