...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Tooltip-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"fd40086c0d6f"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var n="icon/16/actions/help-about.png",m="Tooltip text",l="icon/32/actions/help-about.png",k="Button #2 (Shared ToolTip)",j="Short timeout ToolTip",i="demobrowser.demo.widget.Tooltip",h="Hello World #3",g="Button with ToolTipText and ToolTipIcon",f="ToolTip with icon and label",d="Shared tool tip of button #",B="ToolTip with icon and rich text",A="Such a great tooltip with a (show) timeout of 50ms.",z="Icon only ToolTip",y="Button #1 (Shared ToolTip)",x="container",w="This also may contain <b style='color:red'>rich HTML</b> markup ",v="appear",u="2",t="Shared ToolTip",s="1",q="Button with ToolTipText",r="A long label text with auto-wrapping. ",o="Button with ToolTipIcon",p="and with a (show) timeout of 50ms.";
...
this.container=new qx.ui.container.Composite(H).set({padding:20});
I.add(this.container);
...
},__Ni:4,__Nj:0,add:function(J){this.container.add(J,{row:Math.floor(this.__Nj/this.__Ni),column:this.__Nj%this.__Ni});
this.__Nj+=1;
},createSharedToolTip:function(){var c=new qx.ui.tooltip.ToolTip(t);
c.addListener(v,function(e){var M=d;

if(this.getOpener()==b){M+=s;
}else{M+=u;
}c.setLabel(M);
});
var b=new qx.ui.form.Button(y);
b.setToolTip(c);
this.add(b);
var a=new qx.ui.form.Button(k);
a.setToolTip(c);
this.add(a);
},createIconToolTip:function(){var E=new qx.ui.form.Button(z).set({toolTip:new qx.ui.tooltip.ToolTip(null,n)});
this.add(E);
},createToolTip:function(){var G=new qx.ui.form.Button(f).set({toolTip:new qx.ui.tooltip.ToolTip(h,n)});
this.add(G);
},createShortTimeoutToolTip:function(){var D=new qx.ui.tooltip.ToolTip(A,l);
D.setShowTimeout(50);
var C=new qx.ui.form.Button(j);
this.add(C);
C.setToolTip(D);
},createRichToolTip:function(){var O=new qx.ui.tooltip.ToolTip(r+w+p,l);
O.setWidth(200);
O.setRich(true);
O.setShowTimeout(50);
var N=new qx.ui.form.Button(B);
this.add(N);
N.setToolTip(O);
},createToolTipText:function(){var F=new qx.ui.form.Button(q).set({toolTipText:m});
this.add(F);
},createToolTipIcon:function(){var L=new qx.ui.form.Button(o).set({toolTipIcon:n});
this.add(L);
},createToolTipTextIcon:function(){var K=new qx.ui.form.Button(g).set({toolTipText:m,toolTipIcon:n});
this.add(K);
