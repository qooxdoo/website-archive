...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Transition_Color-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"efb0a9bb65f5"},
  boot : "boot",
  bootIsInline : true,
