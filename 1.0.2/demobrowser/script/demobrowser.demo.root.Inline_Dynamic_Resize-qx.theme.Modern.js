...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Inline_Dynamic_Resize-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1566d5affd3c"},
  boot : "boot",
  bootIsInline : true,
