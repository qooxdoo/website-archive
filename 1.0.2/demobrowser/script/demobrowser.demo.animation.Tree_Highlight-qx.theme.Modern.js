...
(function(){var bc="execute",bb="appear",ba="changeSelection",Y="Trash",X="mode",W="Windows (C:)",V="Documents (D:)",U="Add before",T="Add after",S="Add at begin",bC="Inbox",bB="Desktop",bA="Show open button:",bz="New tree item name: ",by="auto",bx="Hello",bw="Presets",bv="Data 123213234325345234523453453245",bu="demobrowser.demo.animation.Tree_Highlight",bt="Network",bj="Control",bk="Sent",bh="Files",bi="Remove tree item",bf="Add file",bg="Workspace",bd="Junk #",be="Tree",bl="never",bm="Add folder",bo="Root",bn="always",bq="Move to parent",bp="Reset tree",bs="Edit",br="Remove all children";
...
var bE=new qx.ui.groupbox.GroupBox(be).set({contentPadding:[4,4,4,4]});
...
},getTree:function(){var L=new qx.ui.tree.Tree().set({width:200,height:400});
var Q=new qx.ui.tree.TreeFolder(bo);
Q.setOpen(true);
L.setRoot(Q);
var O=new qx.ui.tree.TreeFolder(bB);
O.setOpen(true);
Q.add(O);
var G=new qx.ui.tree.TreeFolder(bh);
var E=new qx.ui.tree.TreeFolder(bg);
var F=new qx.ui.tree.TreeFolder(bt);
var D=new qx.ui.tree.TreeFolder(Y);
O.add(G,E,F,D);
var M=new qx.ui.tree.TreeFile(W);
var C=new qx.ui.tree.TreeFile(V);
E.add(M,C);
var P=new qx.ui.tree.TreeFolder(bC);
var H=new qx.ui.tree.TreeFolder(bw);
var K=new qx.ui.tree.TreeFolder(bk);
var J=new qx.ui.tree.TreeFolder(Y);

for(var i=0;i<100;i++){J.add(new qx.ui.tree.TreeFile(bd+i));
}var N=new qx.ui.tree.TreeFolder(bv);
var I=new qx.ui.tree.TreeFolder(bs);
P.add(H,K,J,N,I);
Q.add(P);
return L;
},getCommandFrame:function(){var d=new qx.ui.groupbox.GroupBox(bj);
d.setLayout(new qx.ui.layout.Grid(3,5));
var f=0;
d.add(new qx.ui.basic.Label(bz).set({paddingTop:4}),{row:f,column:0});
this.inputItemName=new qx.ui.form.TextField(bx);
d.add(this.inputItemName,{row:f++,column:1});
this.btnAddFolder=new qx.ui.form.Button(bm);
this.btnAddFolder.addListener(bc,this._addFolder,this);
d.add(this.btnAddFolder,{row:f++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(bf);
this.btnAddFile.addListener(bc,this._addFile,this);
d.add(this.btnAddFile,{row:f++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(T);
this.btnAddAfter.addListener(bc,this._addAfter,this);
d.add(this.btnAddAfter,{row:f++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(U);
this.btnAddBefore.addListener(bc,this._addBefore,this);
d.add(this.btnAddBefore,{row:f++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(S);
this.btnAddBegin.addListener(bc,this._addBegin,this);
d.add(this.btnAddBegin,{row:f++,column:0,colSpan:2});
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
this.btnRemove=new qx.ui.form.Button(bi);
this.btnRemove.addListener(bc,this._removeTreeItem,this);
d.add(this.btnRemove,{row:f++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(br);
this.btnRemoveAll.addListener(bc,this._removeAll,this);
d.add(this.btnRemoveAll,{row:f++,column:0,colSpan:2});
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(bq);
this.btnMoveToParent.addListener(bc,this._moveToParent,this);
d.add(this.btnMoveToParent,{row:f++,column:0,colSpan:2});
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
d.add(new qx.ui.basic.Label(bA),{row:f,column:0});
var b=[bn,bl,by];
...
}this.mgrShowRootOpen.addListener(ba,this._onChangeShowOpen,this);
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
this.btnReset=new qx.ui.form.Button(bp);
this.btnReset.addListener(bc,this._resetTree,this);
d.add(this.btnReset,{row:f++,column:0,colSpan:2});
this._tree.addListener(ba,this._updateControls,this);
this._updateControls();
return d;
},_addFolder:function(){var u=this._tree.getSelection()[0];
var v=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
v.addListenerOnce(bb,function(){var k=new qx.fx.effect.core.Highlight(v.getContainerElement().getDomElement());
k.start();
},this);
u.setOpen(true);
u.add(v);
},_addFile:function(){var g=this._tree.getSelection()[0];
var h=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
h.addListenerOnce(bb,function(){var t=new qx.fx.effect.core.Highlight(h.getContainerElement().getDomElement());
t.start();
},this);
g.setOpen(true);
g.add(h);
},_addBefore:function(){var r=this._tree.getSelection()[0];
var s=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
s.addListenerOnce(bb,function(){var j=new qx.fx.effect.core.Highlight(s.getContainerElement().getDomElement());
j.start();
},this);
r.getParent().addBefore(s,r);
},_addAfter:function(){var w=this._tree.getSelection()[0];
var x=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
x.addListenerOnce(bb,function(){var a=new qx.fx.effect.core.Highlight(x.getContainerElement().getDomElement());
a.start();
},this);
w.getParent().addAfter(x,w);
},_addBegin:function(){var z=this._tree.getSelection()[0];
var A=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
A.addListenerOnce(bb,function(){var bD=new qx.fx.effect.core.Highlight(A.getContainerElement().getDomElement());
bD.start();
},this);
z.getParent().addAtBegin(A);
},_removeTreeItem:function(){var y=this._tree.getSelection()[0];
var parent=y.getParent();
parent.remove(y);
},_removeAll:function(){var R=this._tree.getSelection()[0];
R.removeAll();
},_moveToParent:function(){var B=this._tree.getSelection()[0];
var parent=B.getParent();
parent.remove(B);
parent.getParent().add(B);
this._updateControls();
},_onChangeShowOpen:function(){var l=this._tree.getSelection()[0];

if(l!=null){var m=this.mgrShowRootOpen.getSelection()[0].getUserData(X);
l.setOpenSymbolMode(m);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(bb,function(){this._tree.addListener(ba,this._updateControls,this);
},this);
},_updateControls:function(){var n=this._tree.getSelection()[0];

if(!n){this.btnAddFolder.setEnabled(false);
...
var o=q==-1;
var p=n instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(p);
this.btnAddFile.setEnabled(p);
this.btnAddBefore.setEnabled(!o);
this.btnAddAfter.setEnabled(!o);
this.btnAddBegin.setEnabled(!o);
this.btnRemove.setEnabled(!o);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(p);
this.showOpenButtons[n.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(q>0);
