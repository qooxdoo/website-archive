...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Margin-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"7af9646f7853"},
  boot : "boot",
  bootIsInline : true,
...
var C=new qx.ui.container.Composite(A).set({decorator:f,backgroundColor:d,allowGrowX:false});
A.setSpacing(5);
...
var x=new qx.ui.container.Composite(v).set({decorator:f,backgroundColor:d,height:100,allowGrowX:false});
v.setSpacing(5);
v.setAlignY(c);
