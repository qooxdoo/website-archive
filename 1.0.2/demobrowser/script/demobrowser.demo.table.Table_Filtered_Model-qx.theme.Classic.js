...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Filtered_Model-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"c16c4bda4a10"},
  boot : "boot",
  bootIsInline : true,
