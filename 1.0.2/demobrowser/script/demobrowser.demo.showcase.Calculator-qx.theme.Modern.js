...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.showcase.Calculator","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.showcase.Calculator-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"308eb8566a8e"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var l="execute",k="-",j="+",i="/",h="*",g="=",f="sans-serif",d="Verdana",c=".",b="black",J="Del",I="C",H="5",G="7",F="demobrowser.demo.showcase.Calculator",E="CE",D="solid",C="icon/22/apps/utilities-calculator.png",B="3",A="0",s="n",t="8",q="6",r="4",o="Calculator",p="right",m="2",n="1",u="demobrowser.demo.showcase.CalculatorLogic",v="__Lz",x="white",w="__LA",z="+/-",y="9";
qx.Class.define(F,{extend:qx.application.Standalone,members:{__Lz:null,__LA:null,main:function(){arguments.callee.base.call(this);
{};
this.__LA=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var L=new qx.ui.window.Window(o,C);
L.setLayout(new qx.ui.layout.VBox(16));
var N=new qx.ui.decoration.Single(1,D,b);
...
V.setLayout(bg);
this.__Lz=new qx.ui.basic.Label(this.__LA.getCurrentValue().toString()).set({decorator:N,backgroundColor:x,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[d,f],bold:true}),textAlign:p});
this.__Lz.setEnabled(false);
var bh=new qx.bom.Font().set({size:14,family:[d,f],bold:true});
var bb=new qx.ui.form.Button(A).set({font:bh,minWidth:40});
var ba=new qx.ui.form.Button(n).set({font:bh,minWidth:40});
var Y=new qx.ui.form.Button(m).set({font:bh,minWidth:40});
var X=new qx.ui.form.Button(B).set({font:bh,minWidth:40});
var bf=new qx.ui.form.Button(r).set({font:bh,minWidth:40});
var be=new qx.ui.form.Button(H).set({font:bh,minWidth:40});
var bd=new qx.ui.form.Button(q).set({font:bh,minWidth:40});
var bc=new qx.ui.form.Button(G).set({font:bh,minWidth:40});
var bj=new qx.ui.form.Button(t).set({font:bh,minWidth:40});
var bi=new qx.ui.form.Button(y).set({font:bh,minWidth:40});
var K=new qx.ui.form.Button(I).set({font:bh,minWidth:40});
var M=new qx.ui.form.Button(E).set({font:bh,minWidth:40});
var R=new qx.ui.form.Button(J).set({font:bh,minWidth:40});
var Q=new qx.ui.form.Button(z).set({font:bh,minWidth:40});
var T=new qx.ui.form.Button(c).set({font:bh,minWidth:40});
var P=new qx.ui.form.Button(j).set({font:bh,minWidth:40});
var W=new qx.ui.form.Button(k).set({font:bh,minWidth:40});
var U=new qx.ui.form.Button(h).set({font:bh,minWidth:40});
var S=new qx.ui.form.Button(i).set({font:bh,minWidth:40});
var O=new qx.ui.form.Button(g).set({font:bh,minWidth:40});
...
bg.setRowFlex(5,1);
bg.setRowFlex(6,1);
V.add(this.__Lz,{row:0,column:0,rowSpan:0,colSpan:4});
...
L.add(V,{flex:1});
K.addListener(l,function(e){this.__LA.cleanDisplay();
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
M.addListener(l,function(e){this.__LA.clearEntry();

if(this.__LA.getResult()!=null){this.__Lz.setValue(this.__LA.getCurrentValue().toString());
}},this);
R.addListener(l,function(e){this.__LA.deleteNumber();
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
Q.addListener(l,function(e){this.__LA.setSign();

if(this.__LA.getResult()!=null){this.__Lz.setValue(this.__LA.getResult().toString());
}},this);
bb.addListener(l,function(e){this.__LA.setCurrentValue(0);
this.__Lz.setValue(this.__LA.getCurrentValue().toFixed(this.__LA.getZeroCounter()).toString());
},this);
ba.addListener(l,function(e){this.__LA.setCurrentValue(1);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
Y.addListener(l,function(e){this.__LA.setCurrentValue(2);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
X.addListener(l,function(e){this.__LA.setCurrentValue(3);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
bf.addListener(l,function(e){this.__LA.setCurrentValue(4);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
be.addListener(l,function(e){this.__LA.setCurrentValue(5);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
bd.addListener(l,function(e){this.__LA.setCurrentValue(6);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
bc.addListener(l,function(e){this.__LA.setCurrentValue(7);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
bj.addListener(l,function(e){this.__LA.setCurrentValue(8);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
bi.addListener(l,function(e){this.__LA.setCurrentValue(9);
this.__Lz.setValue(this.__LA.getCurrentValue().toString());
},this);
P.addListener(l,function(e){this.__LA.calculate(j);

if(this.__LA.getResult()!=null){this.__Lz.setValue(this.__LA.getResult().toString());
}this.__LA.resetCurrentValue();
},this);
W.addListener(l,function(e){this.__LA.calculate(k);

if(this.__LA.getResult()!=null){this.__Lz.setValue(this.__LA.getResult().toString());
}this.__LA.resetCurrentValue();
},this);
U.addListener(l,function(e){this.__LA.calculate(h);

if(this.__LA.getResult()!=null){this.__Lz.setValue(this.__LA.getResult().toString());
}this.__LA.resetCurrentValue();
},this);
S.addListener(l,function(e){this.__LA.calculate(i);

if(this.__LA.getResult()!=null){this.__Lz.setValue(this.__LA.getResult().toString());
}this.__LA.resetCurrentValue();
},this);
O.addListener(l,function(e){this.__LA.calculate(g);

if(this.__LA.getResult()!=null){this.__Lz.setValue(this.__LA.getResult().toString());
}this.__LA.resetCurrentValue();
},this);
T.addListener(l,function(e){this.__LA.setComma();
},this);
}},destruct:function(){this._disposeObjects(w,v);
}});
qx.Class.define(u,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
},members:{__LB:0,__LC:0,__LD:"n",__LE:0,__LF:0,__LG:0,__LH:false,__LI:1,__LJ:0,__LK:false,__LL:0,setCurrentValue:function(bo){if(this.__LH){this.__LI*=10;
this.__LB=this.__LB+(bo/this.__LI);

if(bo==0){this.__LJ++;
}}else{this.__LH=false;

if(this.__LB<0){this.__LB=this.__LB*10-bo;
}else{this.__LB=this.__LB*10+bo;
}}},getZeroCounter:function(){return this.__LJ;
},setComma:function(){this.__LH=true;
},getCurrentValue:function(){return this.__LB;
},resetCurrentValue:function(){this.__LB=null;
},cleanDisplay:function(){this.__LL=0;
this.__LF=0;
this.__LD="n";
this.__LJ=0;
this.__LI=1;
...
this.__LC=0;
this.__LK=false;
},setResult:function(bp){this.__LC=bp;
},getResult:function(){return Math.round(this.__LC*10000000)/10000000;
},setCurrentOperation:function(a){this.__LD=a;
},getCurrentOperation:function(){return this.__LD;
},clearEntry:function(){this.__LK=false;
this.__LJ=0;
this.__LI=1;
this.__LH=false;
this.__LG++;
...
if(this.__LG<2){this.__LF=this.__LC;
}
if(this.__LE>=2){this.__LC=0;
this.__LE=0;
}},setSign:function(){this.__LL++;

if(this.__LL%2==0){this.__LK=false;
}else{this.__LK=true;
}
if(this.__LB==null){this.__LB=this.__LC;
}this.__LB=this.__LB*(-1);

if(this.__LC==0){this.__LC=this.__LB;
}
if(this.__LC!=0){this.__LF=this.__LC;
this.__LC=this.__LB;
}},deleteNumber:function(){var bk=false;
var bn=false;

if(this.__LB<0){this.__LB=this.__LB*(-1);
bn=true;
}
if(this.__LB!=null){if(this.__LB.toString().lastIndexOf(c)!=-1){this.__LB=this.__LB*this.__LI;
bk=true;
}}var bl=this.__LB%10;
var bm=bl/10;
this.__LB=this.__LB/10;
this.__LB=this.__LB-bm;

if(bk){this.__LI/=10;
this.__LB=this.__LB/(this.__LI);
bk=false;
}
if(bn){this.__LB=this.__LB*(-1);
bn=false;
}},calculate:function(bq){if(bq==j||bq==h||bq==i||bq==k||bq==g){this.__LH=false;
this.__LI=1;
this.__LJ=0;

if(this.__LD!=s){if(this.__LD==j){if(this.__LC==null){this.__LC=this.__LF;
}
if(this.__LK){this.__LC=this.__LF+this.__LB;
}else{this.__LC=this.__LC+this.__LB;
}this.__LB=this.__LC;
this.__LF=this.__LC;
}
if(this.__LD==k){if(this.__LC==0){this.__LC=this.__LB;
this.__LB=0;
}
if(this.__LC==null){this.__LC=this.__LF;
}
if(this.__LK){this.__LC=this.__LF-this.__LB;
}else{this.__LC=this.__LC-this.__LB;
}this.__LB=this.__LC;
...
if(this.__LD==i){if(this.__LC==0){this.__LC=this.__LB;
this.__LB=1;
}
if(this.__LC==null){this.__LC=this.__LF;
}
if(this.__LB!=null){if(this.__LB!=0){if(this.__LK){this.__LC=this.__LF/this.__LB;
}else{this.__LC=this.__LC/this.__LB;
}}else{alert("You can't divide by 0!");
}}this.__LB=this.__LC;
this.__LF=this.__LC;
}
if(this.__LD==h){if(this.__LC==0){this.__LC=1;
}
if(this.__LB==null){this.__LB=1;
}
if(this.__LC==null){this.__LC=this.__LF;
}
if(this.__LK){this.__LC=this.__LF*this.__LB;
...
this.__LF=this.__LC;
}}else{this.__LC=this.__LB;
}
if(bq!=g){this.__LD=bq;
}else{this.__LE++;
this.__LC=this.__LF;
this.__LD="n";
}this.__LK=false;
