...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Cookie-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"817e1b32f0cb"},
  boot : "boot",
  bootIsInline : true,
