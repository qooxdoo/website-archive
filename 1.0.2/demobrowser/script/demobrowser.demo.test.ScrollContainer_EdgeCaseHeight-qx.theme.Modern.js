...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.ScrollContainer_EdgeCaseHeight","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ScrollContainer_EdgeCaseHeight-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"37626b9f8893"},
  boot : "boot",
  bootIsInline : true,
...
w.set({width:200,height:300});
this.getRoot().add(w,{left:10,top:10});
w.add(this.generateBox());
var y=new qx.ui.form.Button(g);
var B=true;
y.addListener(r,function(){w.setWidth(B?300:200);
B=!B;
});
this.getRoot().add(y,{left:330,top:20});
var x=new qx.ui.form.Button(o);
var A=true;
x.addListener(r,function(){w.getChildren()[0].setWidth(A?100:300);
A=!A;
});
this.getRoot().add(x,{left:430,top:20});
var z=this.generateScrollbarConfig(q,100);
var v=this.generateScrollbarConfig(p,120);
z.addListener(s,function(e){w.setScrollbarX(e.getData()[0].getUserData(t));
});
v.addListener(s,function(e){w.setScrollbarY(e.getData()[0].getUserData(t));
});
},generateScrollbarConfig:function(C,top){var G=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));
var C=new qx.ui.basic.Label(C);
C.setMarginRight(20);
var D=new qx.ui.form.RadioButton(i);
var F=new qx.ui.form.RadioButton(c);
var E=new qx.ui.form.RadioButton(d);
D.setUserData(t,l);
F.setUserData(t,a);
E.setUserData(t,h);
D.setValue(true);
var H=new qx.ui.form.RadioGroup(D,F,E);
G.add(C);
G.add(D);
G.add(F);
G.add(E);
this.getRoot().add(G,{left:330,top:top});
return H;
},generateBox:function(){var u=new qx.ui.basic.Label(b).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:n,textColor:j,padding:10,decorator:new qx.ui.decoration.Single(4,f,m)});
return u;
}}});
})();
