...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Viewport-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"30610a2c20be"},
  boot : "boot",
  bootIsInline : true,
