...
},_createIconExample:function(){var C=new qx.ui.basic.Label(k);
C.setFont(t);
this.getRoot().add(C,{left:160,top:25});
var A=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var B=new qx.ui.form.ListItem(i+l,f);
A.add(B);
}this.getRoot().add(A,{left:160,top:40});
},_createHtmlExample:function(){var G=new qx.ui.basic.Label(d);
G.setFont(t);
...
},_createWideExample:function(){var z=new qx.ui.basic.Label(o);
z.setFont(t);
this.getRoot().add(z,{left:20,top:285});
var x=new qx.ui.form.ComboBox();
x.setWidth(300);
for(var i=1;i<101;i++){var y=new qx.ui.form.ListItem(i+a);
x.add(y);
