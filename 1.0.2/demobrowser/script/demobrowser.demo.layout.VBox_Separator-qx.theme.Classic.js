...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Separator-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"7f24c74435f8"},
  boot : "boot",
  bootIsInline : true,
...
n.add(this.getBox2());
n.add(this.getBox3());
},getBox1:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return o;
},getBox2:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,minWidth:60,allowGrowY:false});
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:b}));
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:d}));
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:a}));
return i;
},getBox3:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,allowGrowY:false});
var m=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,marginBottom:10});
var l=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,marginBottom:10,marginTop:20});
var j=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,marginBottom:10});
k.add(m);
k.add(l);
k.add(j);
return k;
