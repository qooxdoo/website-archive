...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.ExtendedList","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ExtendedList-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"9b989efa9a1f"},
  boot : "boot",
  bootIsInline : true,
...
var O=[n,v,t,g,u,p,s,d];
var H=[y,f,a,c,z,m];
var M=[];

for(var i=0;i<20;i++){var J=new demobrowser.demo.data.model.Person();
J.setName(O[i%O.length]);
J.setEmote(H[i%H.length]);
J.setOnline(i%3==0);
M.push(J);
}var N=new qx.data.Array(M);
var G=new qx.ui.form.List();
G.setWidth(150);
this.getRoot().add(G,{left:10,top:80});
var K=new qx.data.controller.List(null,G);
var F={configureItem:function(A){A.setPadding(3);
},createItem:function(){return new qx.ui.form.CheckBox();
},bindItem:function(B,C,D){B.bindProperty(x,o,null,C,D);
B.bindProperty(h,j,null,C,D);
B.bindPropertyReverse(h,j,null,C,D);
}};
K.setDelegate(F);
K.setModel(N);
var E=new qx.ui.form.Button(r);
E.setWidth(120);
this.getRoot().add(E,{left:180,top:80});
E.addListener(k,function(){for(var i=0;i<N.length;i++){N.getItem(i).toggleOnline();
}},this);
var L=new qx.ui.form.Button(w);
L.setWidth(120);
this.getRoot().add(L,{left:180,top:115});
L.addListener(k,function(){qx.log.appender.Console.show();
...
I.setWidth(410);
I.setValue(b+q+l);
this.getRoot().add(I,{left:20,top:10});
}}});
})();
