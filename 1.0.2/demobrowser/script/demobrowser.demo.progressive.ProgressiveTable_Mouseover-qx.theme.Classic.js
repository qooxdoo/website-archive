...
(function(){var t="row",s="",r="rgb(255, 0, 0)",q="celldata",p="onmouseover='demobrowser.demo.progressive.DateCellRenderer.onmouseover(this);' ",o="Number",n="red",m="1*",l="celldata='",k="' ",e="<br>",j="demobrowser.demo.progressive.ProgressiveTable_Mouseover",h="end",d="Date",c="Move your mouse over the Date field",g="demobrowser.demo.progressive.DateCellRenderer",f="color",i="Id",b="onmouseout='demobrowser.demo.progressive.DateCellRenderer.onmouseout(this);' ";
...
O.push({renderer:t,location:h,data:[F++,Math.random()*10000,M]});
}return O;
};
...
qx.Class.define(g,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(I){I.__Lw=qx.bom.element.Style.get(I,f);
I.style.color=r;
I.parentNode.style.height=32;
I.__Lx=I.innerHTML;
var K=Date.parse(I.attributes.getNamedItem(q).nodeValue);
var J=new Date(K);
I.innerHTML=J.toUTCString()+e+J.toString();
},onmouseout:function(a){a.style.color=a.__Lw;
a.parentNode.style.height=16;
a.innerHTML=a.__Lx;
}},members:{_getCellExtras:function(u){var v=[];
v.push(arguments.callee.base.call(this));
v.push(l+u.cellData.toUTCString()+k);
v.push(p,b);
return v.join(s);
}}});
})();
