...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Basic-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e0f18594a7b5"},
  boot : "boot",
  bootIsInline : true,
