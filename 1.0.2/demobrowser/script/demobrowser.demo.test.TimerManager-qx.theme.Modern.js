...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.TimerManager","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.TimerManager-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"5e5012a87d16"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="__LV",e="One-shot 1-second timer: ",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__LV:null,startTimers:function(){var s=qx.util.TimerManager.getInstance();
s.start(function(m,n){this.__LW(c+n);
},5000,this,null,0);
s.start(function(i,j){this.__LW(e+j);
},0,this,null,1000);
s.start(function(k,l){this.__LW(g+l);

if(++k.count==3){this.__LW(h);
s.stop(l);
}},2000,this,{count:0},2000);
},__LW:function(t){t=Date.parse(new Date)+" "+t+"\n";
this.__LV.setValue(this.__LV.getValue()+t);
},main:function(){arguments.callee.base.call(this);
var p=new qx.ui.layout.VBox(5);
var o=new qx.ui.container.Composite(p);
var q=new qx.ui.form.Button(b);
q.set({allowGrowX:false,allowGrowY:false});
q.addListener(a,function(){q.setEnabled(false);
this.startTimers();
},this);
var r=new qx.ui.form.TextArea();
r.set({width:400,height:300});
this.__LV=r;
o.add(r);
o.add(q);
this.getRoot().add(o,{left:20,top:10});
