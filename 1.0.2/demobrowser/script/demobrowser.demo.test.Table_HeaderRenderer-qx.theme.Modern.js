...
(function(){var j="Name",i="hovered",h="tool tip",g="icon/16/apps/internet-feed-reader.png",f="mouseover",d="demobrowser.demo.test.Table_HeaderRenderer",c="_container",b="mouseout";
qx.Class.define(d,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
this.setUp();
...
},testDefaultRenderer:function(){var r=new qx.ui.table.headerrenderer.Default();
r.setToolTip(h);
var p={name:[j],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var q=this._getNewHeaderContainer();
qx.util.Permutation.permute(p,function(k){var l=r.createHeaderCell(k);
q.add(l);
r.updateHeaderCell(k,l);
});
},testIconRenderer:function(){var o=new qx.ui.table.headerrenderer.Icon(g);
o.setToolTip(h);
var m={name:[j],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var n=this._getNewHeaderContainer();
qx.util.Permutation.permute(m,function(s){var t=o.createHeaderCell(s);
n.add(t);
o.updateHeaderCell(s,t);
});
},_getNewHeaderContainer:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
a.addListener(f,function(e){e.getTarget().addState(i);
});
a.addListener(b,function(e){e.getTarget().removeState(i);
});
