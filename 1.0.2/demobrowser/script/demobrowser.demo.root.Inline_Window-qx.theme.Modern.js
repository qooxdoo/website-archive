...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Inline_Window-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c1226f9af879"},
  boot : "boot",
  bootIsInline : true,
