...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_CellRenderer-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"60c336b9f6a3"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var bC="",bB="Hello",bA="icon/16/actions/go-down.png",bz="World",by="bold",bx="Juhu",bw="waiting",bv="icon/16/actions/go-next.png",bu="http://resources.qooxdoo.org/images/logo.gif",bt="$ ",cd="string",cc="border: 1px dotted green",cb="decoration",ca="multi<br>line",bY="between",bX="<",bW="inactive",bV="qx/decoration/Modern",bU="icon/16/actions/go-previous.png",bT="icon",bJ="number",bK="<i>italic</i>",bH="0$",bI="qx/icon/Tango",bF="<b>bold</b>",bG="icon/16/actions/go-up.png",bD="boolean",bE="demobrowser.demo.test.Table_CellRenderer",bL="tooltip",bM="red",bO="icon/16/emotes/face-sad.png",bN="icon/16/emotes/face-smile.png",bQ="left",bP=">=",bS="active",bR="object";
qx.Class.define(bE,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(cb,bV);
qx.util.AliasManager.getInstance().add(bT,bI);
},__LU:function(M,top,N,O,P){var Q=["<div style='position:absolute;height:20px;width:",N,"px;top:",top,"px'>"];
O.createDataCellHtml(P,Q);
Q.push("</div>");
M.innerHTML+=Q.join("");
},testDefaultRenderer:function(R){var S=100;
var U={value:[null,bx,32,new Date()],styleLeft:[0],styleWidth:[S],styleHeight:[20],style:[bC]};
var T=this._getNewTableDiv(S);
var top=0;
qx.util.Permutation.permute(U,function(ce){this.__LU(T,top,S,R,ce);
top+=20;
},this);
},testBooleanRenderer:function(){var br=70;
var bq=30;
var bs=new qx.ui.table.cellrenderer.Boolean();
var bo={value:[null,true,false],styleLeft:[0],styleWidth:[br],styleHeight:[bq],style:[bC]};
var bp=this._getNewTableDiv(br);
var top=0;
qx.util.Permutation.permute(bo,function(ci){this.__LU(bp,top,br,bs,ci);
top+=bq;
},this);
bs.setIconFalse(bO);
bs.setIconTrue(bN);
qx.util.Permutation.permute(bo,function(L){this.__LU(bp,top,br,bs,L);
top+=bq;
},this);
},testDateRenderer:function(){var Y=180;
var ba=new qx.ui.table.cellrenderer.Date();
var bc={value:new Date(),styleLeft:[0],styleWidth:[Y],styleHeight:[20],style:[bC]};
var X=qx.util.format.DateFormat;
var bb=[X.getDateTimeInstance(),X.getDateInstance()];
var V=this._getNewTableDiv(Y);
var top=0;

for(var i=0;i<bb.length;i++){var W=bb[i];
ba.setDateFormat(W);
this.__LU(V,top,Y,ba,bc);
top+=20;
}},testNumberRenderer:function(){var e=new qx.ui.table.cellrenderer.Number();
var d=100;
var g={value:Math.PI,styleLeft:[0],styleWidth:[d],styleHeight:[20],style:[bC]};
var c=qx.util.format.NumberFormat;
var f=[c.getIntegerInstance(),new c().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:bt})];
var a=this._getNewTableDiv(d);
var top=0;

for(var i=0;i<f.length;i++){var b=f[i];
e.setNumberFormat(b);
this.__LU(a,top,d,e,g);
top+=20;
}},testImageRenderer:function(){var k=new qx.ui.table.cellrenderer.Image();
var h=50;
var l={value:[null,bA,bG,bU,bv,bu],styleLeft:[0],styleWidth:[h],styleHeight:[20],style:[bC],tooltip:[bC,bL]};
var j=this._getNewTableDiv(h);
var top=0;
qx.util.Permutation.permute(l,function(cj){this.__LU(j,top,h,k,cj);
top+=20;
},this);
},testStringRenderer:function(){var y=new qx.ui.table.cellrenderer.String();
var x=100;
var w=20;
var u={value:[null,bB,bz],styleLeft:[0],styleWidth:[x],styleHeight:[w],style:[bC]};
var v=this._getNewTableDiv(x);
var top=0;
qx.util.Permutation.permute(u,function(E){this.__LU(v,top,x,y,E);
top+=20;
},this);
},testPasswordRenderer:function(){var t=new qx.ui.table.cellrenderer.Password();
var s=100;
var r=20;
var p={value:[null,bB,bz],styleLeft:[0],styleWidth:[s],styleHeight:[r],style:[bC]};
var q=this._getNewTableDiv(s);
var top=0;
qx.util.Permutation.permute(p,function(ch){this.__LU(q,top,s,t,ch);
top+=20;
},this);
},testHtmlRenderer:function(){var D=new qx.ui.table.cellrenderer.Html();
var C=100;
var B=50;
var z={value:[null,bF,bK,ca],styleLeft:[0],styleWidth:[C],styleHeight:[B],style:[bC]};
var A=this._getNewTableDiv(C);
var top=0;
qx.util.Permutation.permute(z,function(bn){this.__LU(A,top,C,D,bn);
top+=20;
},this);
},testConditionalRenderer:function(){var J=new qx.ui.table.cellrenderer.Conditional();
J.addNumericCondition(bX,0,null,bM,null,null);
J.addNumericCondition(bP,100,bQ,null,null,null);
J.addBetweenCondition(bY,0,2,null,null,null,by,null);
J.addRegex(bH,null,null,by,cc);
var I=100;
var H=20;
var F={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[I],table:[this.tableMock],styleHeight:[H],style:[bC]};
var G=this._getNewTableDiv(I);
var top=0;
qx.util.Permutation.permute(F,function(K){this.__LU(G,top,I,J,K);
top+=20;
},this);
},testDynamicRenderer:function(){var bm=new qx.ui.table.cellrenderer.Dynamic();
bm.setCellRendererFactoryFunction(function(m){var o=m.value;
var n=qx.ui.table.cellrenderer;

switch(typeof o){case cd:if(o.match(/^icon\//)){return new n.Image();
}else{return new n.String();
}case bD:return new n.Boolean();
case bJ:return new n.Number();
case bR:if(o instanceof Date){return new n.Date();
}return new n.Default();
}});
var bl=100;
var bk=20;
var bi={value:[null,bx,new Date(),30,bA,false],styleLeft:[0],styleWidth:[bl],styleHeight:[bk],table:[this.tableMock],style:[bC]};
var bj=this._getNewTableDiv(bl);
var top=0;
qx.util.Permutation.permute(bi,function(cf){this.__LU(bj,top,bl,bm,cf);
top+=20;
},this);
},testReplaceRenderer:function(){var bh=new qx.ui.table.cellrenderer.Replace();
bh.setReplaceMap({1:bS,2:bW,3:bw});
bh.addReversedReplaceMap();
var bg=100;
var bf=20;
var bd={value:[1,2,3],styleLeft:[0],styleWidth:[bg],table:[this.tableMock],styleHeight:[bf],style:[bC]};
var be=this._getNewTableDiv(bg);
var top=0;
qx.util.Permutation.permute(bd,function(cg){this.__LU(be,top,bg,bh,cg);
top+=20;
},this);
...
qx.Class.define(a,{extend:qx.ui.table.cellrenderer.Default,construct:function(c){arguments.callee.base.call(this);
