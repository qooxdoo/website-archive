...
},getSpacerWithoutFlex:function(){var k=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e,allowGrowX:false});
var l=new qx.ui.layout.HBox();
l.setSpacing(5);
k.setLayout(l);
k.add(new qx.ui.core.Widget().set({decorator:g,backgroundColor:f}));
