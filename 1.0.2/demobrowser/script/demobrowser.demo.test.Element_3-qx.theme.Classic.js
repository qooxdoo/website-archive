...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Element_3","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_3-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a26a27f95f73"},
  boot : "boot",
  bootIsInline : true,
