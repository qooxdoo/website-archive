...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Spinner-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"bb968f958db0"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(p,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(a,b){var c=new qx.ui.form.Spinner();
a.add(new qx.ui.basic.Label(i),{column:0,row:b});
a.add(new qx.ui.basic.Label(v),{column:1,row:b});
a.add(c,{column:2,row:b});
a.add(new qx.ui.basic.Label(t),{column:3,row:b});
c.addListener(f,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(D,E){var F=new qx.ui.form.Spinner(0,50,100);
F.setEditable(false);
D.add(new qx.ui.basic.Label(q),{column:0,row:E});
D.add(new qx.ui.basic.Label(v),{column:1,row:E});
D.add(F,{column:2,row:E});
D.add(new qx.ui.basic.Label(t),{column:3,row:E});
},addWrappingSpinner:function(A,B){var C=new qx.ui.form.Spinner(-30,30,30);
C.setWrap(true);
A.add(new qx.ui.basic.Label(n),{column:0,row:B});
A.add(new qx.ui.basic.Label(d),{column:1,row:B});
A.add(C,{column:2,row:B});
A.add(new qx.ui.basic.Label(g),{column:3,row:B});
},addSteppedSpinner:function(L,M){var N=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
L.add(new qx.ui.basic.Label(o),{column:0,row:M});
L.add(new qx.ui.basic.Label(m),{column:1,row:M});
...
I.setEnabled(false);
G.add(new qx.ui.basic.Label(r),{column:0,row:H});
G.add(new qx.ui.basic.Label(v),{column:1,row:H});
G.add(I,{column:2,row:H});
G.add(new qx.ui.basic.Label(t),{column:3,row:H++});
},addFormattedSpinner:function(w,x){var y=new qx.ui.form.Spinner(0,200,300);
y.setSingleStep(0.5);
y.setWidth(70);
var z=new qx.util.format.NumberFormat();
z.setMinimumFractionDigits(2);
z.setMaximumFractionDigits(2);
y.setNumberFormat(z);
w.add(new qx.ui.basic.Label(h),{column:0,row:x});
w.add(new qx.ui.basic.Label(v),{column:1,row:x});
w.add(y,{column:2,row:x});
w.add(new qx.ui.basic.Label(l),{column:3,row:x++});
