...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="white",c="#EEE",b="vertical",a="__MF";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__MF:null,main:function(){arguments.callee.base.call(this);
...
this.__MF=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__MF.getCellProperties(j+g+k);
