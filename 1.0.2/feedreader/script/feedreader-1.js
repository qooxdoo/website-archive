qx.$$packageData['17358de073ae']={"resources":{"qx/icon/Tango/16/actions/dialog-apply.png":[16,16,"png","feedreader","feedreader/images/combined/icons16.png",0,-80],"qx/icon/Tango/16/actions/document-new.png":[16,16,"png","feedreader","feedreader/images/combined/icons16.png",0,-16]}};
...
(function(){var p="",o="Add",n="Title:",m="Add a feed",l="feedreader.view.AddFeedWindow",k="__yJ",j="user",i="URL:",h="__yH",g="icon/16/actions/document-new.png",c="icon/16/actions/dialog-apply.png",f="__yI",d="right",b="Feed Information",a="execute";
qx.Class.define(l,{extend:qx.ui.window.Window,construct:function(s){arguments.callee.base.call(this,this.tr(m),g);
this.__yH=s;
this.set({modal:true,showMinimize:false,showMaximize:false,allowMaximize:false});
this._addContent();
},members:{__yI:null,__yJ:null,__yH:null,_addContent:function(){this.setLayout(new qx.ui.layout.VBox(10));
var x=new qx.ui.groupbox.GroupBox(this.tr(b));
this.add(x);
var u=new qx.ui.layout.Grid();
u.setSpacing(10);
x.setLayout(u);
var v=new qx.ui.basic.Label(this.tr(n));
var t=this.__yJ=new qx.ui.form.TextField();
var y=new qx.ui.basic.Label(this.tr(i));
var z=this.__yI=new qx.ui.form.TextField();
x.add(v,{row:0,column:0});
x.add(t,{row:0,column:1});
x.add(y,{row:1,column:0});
x.add(z,{row:1,column:1});
z.setWidth(200);
var w=new qx.ui.form.Button(this.tr(o),c);
w.set({alignX:d,allowGrowX:false});
this.add(w);
w.addListener(a,this._addFeed,this);
},_addFeed:function(e){var r=this.__yJ.getValue();

if(r==null||r==p){alert(this.tr("Please enter a title."));
return;
}var q=this.__yI.getValue();

if(q==null||r==p){alert(this.tr("Please enter a url."));
return;
}this.__yH.addFeed(r,q,j);
this.__yJ.setValue(p);
this.__yI.setValue(p);
this.close();
}},destruct:function(){this.__yK=null;
this._disposeObjects(h,k,f);
}});
})();
