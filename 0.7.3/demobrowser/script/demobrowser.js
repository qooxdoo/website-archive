...
if(qxsettings["qx.version"]==undefined)qxsettings["qx.version"]="0.7.3 (r11179) [legacy_0_7_x]";
...
if(!Error.prototype.toString||Error.prototype.toString()==$[1164]){Error.prototype.toString=function(){return this.message;
};
...
if($2.length!=3||$2[0]!=$[1851]){continue;
}var $3=$2[1];
...
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1].split($[63]);
if($2.length!=3||$2[0]!=$[1196]){continue;
}var $3=$2[1];
...
defer:function($0){$0.define($[1234],
[$[73],
$[117]],
$[73]);
$0.define($[2338],
...
$1,
$2,
$3){if($0!=$[615]&&$0!=$[996]){throw new Error("Unknown position: '"+$0+"'");
...
var $e=null;
var $f;
if(window.opera&&/Opera[\s\/]([0-9\.]*)/.test($1)){$7=$[137];
$8=RegExp.$1;
$6=$[137];
$8=$8.substring(0,
3)+$[32]+$8.substring(3);
$d=$1.indexOf($[1622])!==-1?$[23]:$1.indexOf($[1343])!==-1?$[28]:null;
}else if(typeof $2===$[10]&&$2===$[1767]&&/KHTML\/([0-9-\.]*)/.test($1)){$7=$[188];
$6=$[2326];
$8=RegExp.$1;
}else if($1.indexOf($[1446])!=-1&&/AppleWebKit\/([^ ]+)/.test($1)){$7=$[174];
$8=RegExp.$1;
$e=$8.indexOf($[201])!=-1;
var $g=RegExp($[918]).exec($8);
if($g){$8=$8.slice(0,
$g.index);
}
if($1.indexOf($[2232])!=-1){$6=$[1083];
}else if($1.indexOf($[914])!=-1){$6=$[1406];
}else if($1.indexOf($[2381])!=-1){$6=$[2099];
}else if($1.indexOf($[2337])!=-1){$6=$[1274];
}else if($1.indexOf($[1500])!=-1){$6=$[2115];
}else{$6=$[2116];
}
if($e){$6+=$[791];
}}else if(window.controllers&&typeof $3===$[10]&&$3===$[1735]&&/rv\:([^\);]+)(\)|;)/.test($1)){$7=$[28];
$8=RegExp.$1;
if($1.indexOf($[1292])!=-1){$6=$[2111];
}else if($1.indexOf($[2388])!=-1){$6=$[2136];
}else if($1.indexOf($[994])!=-1){$6=$[1435];
}else{$6=$[1458];
...
var $q=false;
var $r=false;
if($4.indexOf($[496])!=-1||$4.indexOf($[845])!=-1||$4.indexOf($[1884])!=-1){$o=true;
$n=$[436];
}else if($4.indexOf($[802])!=-1||$4.indexOf($[829])!=-1||$4.indexOf($[1554])!=-1){$p=true;
$n=$[1597];
}else if($4.indexOf($[2332])!=-1||$4.indexOf($[747])!=-1||$4.indexOf($[1971])!=-1){$q=true;
$n=$[1586];
}else{$r=true;
$n=$[72];
}var $s=false;
...
var $v=false;
if($7==$[23]){$s=true;
}if(document.implementation&&document.implementation.hasFeature){if(document.implementation.hasFeature($[1826],
$[849])){$t=$u=true;
}}this._runsLocally=$0;
this._engineName=$7;
this._engineNameMshtml=$7===$[23];
this._engineNameGecko=$7===$[28];
this._engineNameOpera=$7===$[137];
this._engineNameKhtml=$7===$[188];
this._engineNameWebkit=$7===$[174];
...
}if(!$1.hasOwnProperty($[882])&&!$1.type){$1.type=$[340];
}{};
...
genericToString:function(){return $[1953]+this.classname+$[108];
},
...
genericToString:function(){return $[1058]+this.name+$[108];
},
__registry:{},
__allowedKeys:null,
__validateConfig:function(){}}});
...
genericToString:function(){return $[1250]+this.name+$[108];
},
__registry:{},
...
destruct:function(){this._disposeFields($[2245]);
}});
...
}$1[$[141]+$3]=function(){if(this[$4]==null){this[$4]=this[$5]();
}return this[$4];
};
...
var $2=qx.core.Property.$$store.user[$0.name]=$[680]+$0.name;
var $3=$[903]+$0.method;
var $4=$[1775]+$0.implMethod;
var $5=$[986]+$0.implMethod;
var $6=qx.core.Property.$$method;
if(!$6.set[$0.name]){$6.set[$0.name]=$[31]+$0.method;
$6.get[$0.name]=$[141]+$0.method;
$6.reset[$0.name]=$[130]+$0.method;
}$1[$2]=$0.defaultValue;
$1[$[141]+$0.method]=function(){return this[$2];
};
$1[$[995]+$0.method]=function($7){return this[$2]=$7;
};
...
if(typeof $0.getAlias===$[10]){$1[$0.getAlias]=$1[$[141]+$0.method];
...
/* ID: qx.core.Property */
qx.Class.define($[2183],
{statics:{__checks:{"Boolean":$[2284],
"String":$[1521],
"NonEmptyString":$[1533],
"Number":$[374],
"Integer":$[1037],
...
$4;
if($1.charAt(0)===$[79]){if($1.charAt(1)===$[79]){$3=$[1181];
...
if($1.inheritable){$6.refresh[$5]=$2+$[173]+$3;
...
if($1.check===$[2]){$4[$2+$[563]+$3]=new Function($[683]+$6.set[$5]+$[1241]+$6.get[$5]+$[1717]);
$4[$2+$[2063]+$3]=new Function($[683]+$6.get[$5]+$[686]);
}},
__errors:{0:$[1847],
1:$[1599],
2:$[1264],
...
var $6=$[2193]+$2+$[1876]+$5+$[1671]+this.$$method[$3][$2]+$[1843]+$4+$[1277];
$0.printStackTrace();
...
this.$$store.init[$2],
$[18]);
}else if($4.inheritable||$4.nullable){$6.push($[1803]);
}else{$6.push($[1551],
$2,
$[1741],
$1.classname,
...
if($3===$[61]||$3===$[146]){var $b=this.$$store.theme[$2];
}else if($3===$[104]){var $b=this.$$store.init[$2];
}else{var $b=this.$$store.user[$2];
}{if(!$5.nullable||$5.check||$5.inheritable){$7.push($[1349]);
}if($3===$[31]){$7.push($[1678]+$2+$[347]+$3+$[401]);
}};
if($8){if($5.transform){$7.push($[1687],
$5.transform,
$[1129]);
...
$b,
$[2100]);
}}if($5.inheritable){$7.push($[780]);
}if($8&&(false||$3===$[31])){if(!$5.nullable){$7.push($[1602]+$2+$[347]+$3+$[401]);
}if($5.check!==undefined){if($5.nullable){$7.push($[1528]);
}if($5.inheritable){$7.push($[1236]);
}$7.push($[2174]);
if(this.__checks[$5.check]!==undefined){$7.push($[671],
this.__checks[$5.check],
$[279]);
}else if(qx.Class.isDefined($5.check)){$7.push($[1040],
$5.check,
$[279]);
}else if(qx.Interface.isDefined($5.check)){$7.push($[1634],
$5.check,
$[2129]);
}else if(typeof $5.check===$[51]){$7.push($[922],
$1.classname,
$[628],
$2);
$7.push($[2302]);
}else if(typeof $5.check===$[10]){$7.push($[671],
$5.check,
$[279]);
...
this.$$store.init[$2],
$[67]);
}}else{if($5.inheritable){$7.push($[1943],
this.$$store.inherit[$2],
$[18]);
}else{$7.push($[2262]);
}$7.push($[123],
this.$$store.user[$2],
$[237]);
if($3===$[31]){if(!$5.inheritable){$7.push($[273],
this.$$store.user[$2],
$[18]);
}$7.push($[48],
this.$$store.user[$2],
$[67]);
}else if($3===$[130]){if(!$5.inheritable){$7.push($[273],
this.$$store.user[$2],
$[18]);
}$7.push($[143],
this.$$store.user[$2],
...
this.$$store.init[$2],
$[18]);
}}else if($3===$[31]||$3===$[61]||$3===$[173]){$7.push($[143],
this.$$store.useinit[$2],
$[18]);
if($3===$[31]){$7.push($[48],
this.$$store.user[$2],
...
if($3===$[31]||$3===$[61]||$3===$[104]){$7.push($[1475]);
if($3===$[31]){$7.push($[48],
this.$$store.user[$2],
$[67]);
}else if($3===$[61]){$7.push($[48],
...
$5.apply,
$[2060]);
}if($5.event){$7.push($[2355],
$5.event,
$[1899]);
}if($5.inheritable&&$6.getChildren){$7.push($[1182]);
$7.push($[1239],
...
format:function($0,
$1){var $2=$0;
for(var $3=0;$3<$1.length;$3++){$2=$2.replace(new RegExp($[210]+($3+1),
$[372]),
$1[$3]);
}return $2;
},
...
toString:function(){if(this.classname){return $[1337]+this.classname+$[108];
}return $[2149];
},
base:function($0,
...
}if(qx.core.Setting){var $0=qx.core.Setting.get($[222])+$[2168];
...
this._commandLine=$1.getElementById($[1706]);
...
case $[355]:return $[1278];
case $[64]:return $[645];
case $[172]:return $[1739];
case $[105]:return $[1723];
}return $[109];
...
$1);
else if($0==null)this._appendNull($[292],
$1);
...
$[96]);
if($0.className)$1.push($[2105],
this._escapeHTML($0.className),
$[96]);
$1.push($[96]);
},
_appendNode:function($0,
$1){if($0.nodeType==1){$1.push($[1748],
$[2098],
...
}else if($0.nodeType==3){$1.push($[2396],
...
genericToString:function(){return $[1641]+this.name+$[108];
},
...
}var $3=$[650]+qx.core.Object.toHashCode($1)+($2?$[177]+qx.core.Object.toHashCode($2):$[0]);
...
}var $4=$[650]+qx.core.Object.toHashCode($1)+($2?$[177]+qx.core.Object.toHashCode($2):$[0]);
...
destruct:function(){this._disposeObjectDeep($[1728],
2);
}});
...
destruct:function(){this._disposeFields($[740],
$[1999],
$[2148],
$[1866]);
}});
...
defaultValue:false},
data:{_fast:true}},
destruct:function(){this._disposeFields($[1474]);
}});
...
destruct:function(){this._disposeFields($[1983],
$[1715]);
}});
...
destruct:function(){this._disposeFields($[1493]);
}});
...
if(this.getUseLongFormat()){switch($0.level){case $1.LEVEL_DEBUG:$2+=$[902];
break;
case $1.LEVEL_INFO:$2+=$[2010];
break;
case $1.LEVEL_WARN:$2+=$[898];
break;
case $1.LEVEL_ERROR:$2+=$[2139];
break;
case $1.LEVEL_FATAL:$2+=$[2231];
break;
}}else{$2+=$[283];
}var $4=$[0];
for(var $5=0;$5<$0.indent;$5++){$4+=$[353];
}$2+=$4;
...
}}catch(exc){$2+=$4+$[1389]+exc+$[573];
}$7.sort();
for(var $5=0;$5<$7.length;$5++){try{$2+=$4+$[353]+$7[$5]+$[38]+$6[$7[$5]]+$[135];
}catch(exc){$2+=$4+$[353]+$7[$5]+$[1668]+exc+$[573];
}}$2+=$4+$[2250];
}}if($0.throwable!=null){var $9=$0.throwable;
if($9.name==null){$2+=$[283]+$9;
}else{$2+=$[283]+$9.name;
}
if($9.message!=null){$2+=$[804]+$9.message;
}
if($9.number!=null){$2+=$[1306]+$9.number+$[65];
}var $a=qx.dev.StackTrace.getStackTraceFromError($9);
}
if($0.trace){var $a=$0.trace;
}
if($a&&$a.length>0){$2+=$[135];
for(var $5=0;$5<$a.length;$5++){$2+=$[1177]+$a[$5]+$[135];
}}return $2;
}}});
...
}var $4=$[1691]+$[1872]+$0+$[1195]+$1+$[1920]+$2+$[1901]+$3;
...
$[23])?$[1484]:$[402];
$0.open();
$0.write($[1666]+this._name+$[1777]+$[1078]+this._id+$[940]+$[2395]+$[779]+$[1949]+$[738]+$[1756]+$[2137]+$[1621]+$[1155]+$1+$[1082]+$[851]+$[766]+this._filterText+$[466]+$[513]+$[1009]+$[2353]+$[513]+$[2279]);
$0.close();
this._logElem=$0.getElementById($[456]);
this._markerBtn=$0.getElementById($[2204]);
this._filterInput=$0.getElementById($[169]);
this._logLinesDiv=$0.getElementById($[1063]);
var $2=this;
this._markerBtn.onclick=function(){$2._showMessageInLog($[966]);
};
...
}else{this._showMessageInLog($[1344]+this._errorsPreventingAutoCloseCount+$[1137]);
}},
...
if($0.level>=qx.log.Logger.LEVEL_ERROR){$1.style.backgroundColor=$[2068];
if(!this.getAutoCloseWithErrors()){this._errorsPreventingAutoCloseCount+=1;
}}else if($0.level==qx.log.Logger.LEVEL_DEBUG){$1.style.color=$[176];
}var $2;
...
}$0.elem.style[$[189]]=($1?$[0]:$[14]);
},
_applyAutoCloseWithErrors:function($0,
$1){if(!$0&&$1){this._errorsPreventingAutoCloseCount=0;
this._showMessageInLog($[956]);
}else if($0&&!$1){this._showMessageInLog($[1018]+this._errorsPreventingAutoCloseCount+$[1596]);
}}},
...
destruct:function(){this._disposeObjects($[2300]);
}});
...
measure:function($0,
$1,
$2){if(this._lastMeasureTime==null){$0=$[857]+$0;
...
null);
$0.ROOT_LOGGER.setMinLevel(qx.core.Setting.get($[1302]));
$0.ROOT_LOGGER.addAppender(new (qx.Class.getByName(qx.core.Setting.get($[843]))));
},
destruct:function(){this._disposeFields($[1754],
$[1445]);
}});
...
getFunctionName:function($0){if($0.$$original){return $0.classname+$[972];
}
...
if($3&&$3.length>=1&&$3[1]){return $[1303]+$3[1];
}return $[2179];
},
__fileNameToClassName:function($0){var $1=$[1726];
var $2=$0.indexOf($1);
...
}else{if($2.charAt(0)==$[1167]){if($2.charAt(1).toUpperCase()==$[1418]){$4=$2.substring(2);
if($4.match(/^[0-9A-Fa-f]+$/gi)){$3=String.fromCharCode(parseInt($[1399]+$4));
...
{};
if(!this.getApplication()){var $2=qx.Class.getByName(qx.core.Setting.get($[835]));
...
_onbeforeunload:function($0){this.createDispatchEvent($[306]);
if(this.getApplication()){var $1=this.getApplication().close();
if($1!=null){$0.returnValue=$1;
}}},
_onunload:function($0){this.createDispatchEvent($[154]);
...
svn:0,
folder:$[0],
toString:function(){return this.major+$[32]+this.minor+(this.revision==0?$[0]:$[32]+this.revision)+(this.state==$[0]?$[0]:$[100]+this.state)+(this.svn==0?$[0]:$[2207]+this.svn+$[65])+(this.folder==$[0]?$[0]:$[727]+this.folder+$[108]);
},
__init:function(){var $0=qx.core.Setting.get($[861]).split($[54]);
var $1=$0.shift();
var $2=$0.join($[54]);
...
$1,
$2){{};
var $3=$[644]+$1.toHashCode()+$[177]+qx.core.Object.toHashCode($0);
...
destruct:function(){this._disposeFields($[2077],
$[2025]);
}});
...
this._aliases={};
this.add($[340],
qx.core.Setting.get($[222])+$[1113]);
},
members:{_preprocess:function($0){var $1=this._dynamic;
if($1[$0]===false){return $0;
}else if($1[$0]===undefined){if($0.charAt(0)===$[56]||$0.charAt(0)===$[32]||$0.indexOf($[1469])===0||$0.indexOf($[1168])===$[46]||$0.indexOf($[1836])===0){$1[$0]=false;
return $0;
}var $2=$0.substring(0,
$0.indexOf($[56]));
...
qx.Theme.define($[1276],
{title:$[496],
widgets:{uri:qx.core.Setting.get($[222])+$[1348]}});




/* ID: qx.theme.classic.Appearance */
qx.Theme.define($[2288],
{title:$[408],
appearances:{"empty":{},
"widget":{},
"image":{},
"atom":{},
"popup":{},
"cursor-dnd-move":{style:function($0){return {source:$[1692]};
}},
"cursor-dnd-copy":{style:function($0){return {source:$[1284]};
}},
"cursor-dnd-alias":{style:function($0){return {source:$[1752]};
}},
"cursor-dnd-nodrop":{style:function($0){return {source:$[1904]};
}},
"label":{style:function($0){return {textColor:$0.disabled?$[280]:$[6]};
}},
...
style:function($0){return {backgroundColor:$[669],
textColor:$[665],
border:$[669],
padding:[1,
3,
...
4];
}return {backgroundColor:$0.abandoned?$[284]:$0.over?$[2130]:$[167],
border:$1,
padding:$2};
}},
"toolbar":{style:function($0){return {border:$[224],
backgroundColor:$[84]};
}},
"toolbar-part":{},
...
"toolbar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[226];
var $2=[3,
2,
1,
4];
}else if($0.over){var $1=$[224];
var $2=[2,
3];
}else{var $1=$[6];
var $2=[3,
...
backgroundColor:$0.abandoned?$[284]:$[167],
backgroundImage:$0.checked&&!$0.over?$[583]:null};
}},
"button-view":{style:function($0){return {border:$[161]};
}},
...
"radio-view-pane":{style:function($0){return {backgroundColor:$[1110]};
}},
"radio-view-page":{},
"radio-view-bar":{style:function($0){return {backgroundColor:$[1036],
padding:[1,
0],
...
$2=[3,
7];
}return {backgroundColor:$0.checked?$[874]:$[6],
iconPosition:$[9],
margin:[0,
1],
width:$[3],
...
2],
verticalChildrenAlign:$[33],
backgroundColor:$0.active?$[1595]:$[2268],
textColor:$0.active?$[2258]:$[987]};
}},
"window-resize-frame":{style:function($0){return {border:$[161]};
}},
...
"window-captionbar-button":{include:$[167],
...
"window-captionbar-minimize-button":{include:$[296],
style:function($0){return {icon:$[1381]};
}},
"window-captionbar-restore-button":{include:$[296],
style:function($0){return {icon:$[1193]};
}},
"window-captionbar-maximize-button":{include:$[296],
style:function($0){return {icon:$[1601]};
}},
"window-captionbar-close-button":{include:$[296],
style:function($0){return {marginLeft:2,
icon:$[1495]};
}},
"window-statusbar":{style:function($0){return {border:$[226]};
}},
...
"resizer-frame":{style:function($0){return {border:$[161]};
}},
"menu":{style:function($0){return {backgroundColor:$[677],
border:$[82],
padding:1};
}},
"menu-layout":{},
...
textColor:$0.over?$[227]:$[6]};
}},
"menu-button-arrow":{style:function($0){return {source:$[1473]};
}},
"menu-check-box":{include:$[371],
style:function($0){return {icon:$0.checked?$[1287]:$[223]};
}},
"menu-radio-button":{include:$[371],
style:function($0){return {icon:$0.checked?$[1421]:$[223]};
}},
...
"list":{style:function($0){return {border:$[226],
backgroundColor:$[206]};
}},
...
textColor:$0.selected?$[227]:$[6]};
}},
"text-field":{style:function($0){return {border:$[89],
padding:[1,
3],
textColor:$0.disabled?$[280]:$[6],
backgroundColor:$[236]};
}},
"text-area":{include:$[168]},
"combo-box":{style:function($0){return {border:$[89],
backgroundColor:$[236]};
}},
"combo-box-list":{include:$[206],
style:function($0){return {border:$[6],
overflow:$[121]};
}},
"combo-box-popup":{include:$[206],
style:function($0){return {maxHeight:150,
border:$[161]};
}},
"combo-box-text-field":{include:$[168],
style:function($0){return {border:$[6],
backgroundColor:$[257]};
}},
"combo-box-button":{include:$[167],
...
"combo-box-ex-list":{include:$[206],
style:function($0){return {border:$[6],
edge:0};
}},
"combo-box-ex-text-field":{include:$[168],
style:function($0){return {border:$[6],
minWidth:30,
width:100,
backgroundColor:$[257]};
}},
"combo-box-ex-popup":{include:$[206],
style:function($0){return {border:$[673]};
}},
"combo-box-ex-button":{include:$[1466]},
"treevirtual-focus-indicator":{include:$[2043]},
...
"tree-element-label":{include:$[163],
style:function($0){return {marginLeft:3,
height:15,
padding:2,
backgroundColor:$0.selected?$[69]:$[6],
textColor:$0.disabled?$[280]:($0.selected?$[227]:$[6])};
}},
"tree-folder":{include:$[725]},
"tree-folder-icon":{include:$[694]},
"tree-folder-label":{include:$[535]},
"tree":{include:$[394]},
"tree-icon":{include:$[545]},
"tree-label":{include:$[692]},
...
6],
spacing:4,
backgroundColor:$0.over?$[1026]:$[6],
paddingBottom:$0.over?0:2,
border:$0.over?new qx.ui.core.Border.fromConfig({bottom:[2,
$[5],
$[97]]}):$[6]};
}},
"list-view-header-cell-arrow-up":{style:function($0){return {source:$[1000]};
}},
"list-view-header-cell-arrow-down":{style:function($0){return {source:$[715]};
}},
"list-view-header-separator":{style:function($0){return {backgroundColor:$[722],
width:1,
marginTop:1,
marginBottom:1};
}},
...
"list-view-content-cell-html":{include:$[325]},
"list-view-content-cell-icon-html":{include:$[325]},
"list-view-content-cell-link":{include:$[325]},
...
"radio-button-group-box-legend":{include:$[1199]},
"spinner":{style:function($0){return {border:$[89],
backgroundColor:$[236]};
}},
"spinner-text-field":{include:$[168],
style:function($0){return {backgroundColor:$[257]};
}},
...
style:function($0){return {source:$[2281]};
}},
...
"datechooser-toolbar-button":{style:function($0){var $1={backgroundColor:$0.abandoned?$[284]:$[167],
backgroundImage:($0.checked&&!$0.over)?$[583]:null,
spacing:4,
width:$[3],
verticalChildrenAlign:$[33]};
if($0.pressed||$0.checked||$0.abandoned){$1.border=$[226];
}else if($0.over){$1.border=$[224];
}else{$1.border=$[6];
}
...
"datechooser-monthyear":{style:function($0){return {font:$[2229],
textAlign:$[59],
verticalAlign:$[33]};
}},
...
font:$[1355],
textAlign:$[59],
textColor:$0.weekend?$[314]:$[328],
backgroundColor:$0.weekend?$[328]:$[314]};
}},
"datechooser-day":{style:function($0){return {textAlign:$[59],
verticalAlign:$[33],
border:$0.today?$[225]:$[6],
textColor:$0.selected?$[227]:$0.otherMonth?$[280]:$[6],
backgroundColor:$0.selected?$[69]:$[6],
padding:[2,
4]};
}},
...
"table-editor-textfield":{include:$[168],
style:function($0){return {border:$[6],
padding:[0,
2]};
}},
...
"table-menubar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[226];
var $2=[3,
2,
1,
4];
...
border:$1,
backgroundColor:$2,
icon:$0.sorted?($0.sortedAscending?$[1751]:$[2164]):null,
...
"splitpane-splitter":{style:function($0){return {cursor:$0.horizontal?$[312]:$[384]};
}},
...
"scrollbar-blocker":{style:function($0){return {backgroundColor:$[225],
opacity:0.2};
}}}});
...
qx.Theme.define($[1948],
{title:$[2303],
icons:{uri:qx.core.Setting.get($[222])+$[1887]}});
...
construct:function(){arguments.callee.base.call(this);
this._layoutChanges={};
if(qx.core.Setting.get($[2314])){this._generateHtmlId();
}},
...
}if(qx.Class.isDefined($[929])){for($0 in $5){$1=$5[$0];
...
__initApplyMethods:function($0){var $1=$[2298];
var $2=$[1144];
var $3=$[2198];
var $4=$[1322];
var $5=$[644];
...
$[1969]+$7[$b]+$[1815]);
$0[$d+$7[$b]]=new Function($[825]+$7[$b]+$[1212]);
...
$5,
$6;$2<$3;$2++){$4=$1[$2];
$5=$[1394]+qx.lang.String.toFirstUp($4);
$6=$5+$[460];
...
$[1080]],
themeable:true},
clipLocation:{group:[$[703],
$[620]]},
clipDimension:{group:[$[713],
$[508]]},
clip:{group:[$[703],
$[620],
$[713],
...
$[189])!=$[14]&&qx.html.Style.getStyleProperty($0,
$[363])!=$[24]&&$0.offsetWidth>0&&$0.offsetHeight>0);
},
...
return this._handleDisplayable($[321]);
},
_applyDisplay:function($0,
$1){return this._handleDisplayable($[189]);
},
_handleDisplayable:function($0){var $1=this._computeDisplayable();
if(this._isDisplayable==$1&&!($1&&$0==$[321])){return true;
...
$2.addToJobQueue($[1780]);
}this.addToLayoutChanges($[2226]);
...
_beforeAppear:function(){this.createDispatchEvent($[979]);
},
...
_beforeInsertDom:function(){this.createDispatchEvent($[1646]);
},
_afterInsertDom:function(){this.createDispatchEvent($[2037]);
},
_beforeRemoveDom:function(){this.createDispatchEvent($[1729]);
},
_afterRemoveDom:function(){this.createDispatchEvent($[1439]);
},
_applyVisibility:function($0,
$1){if($0){if(this._isDisplayable){this._beforeAppear();
}this.removeStyleProperty($[189]);
...
$e=$d.length;
if($1.paddingLeft){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1825]);
}}
if($1.paddingRight){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1210]);
}}
if($1.paddingTop){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[2273]);
}}
if($1.paddingBottom){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1001]);
}}}
...
switch(this.getOverflow()){case $[37]:case $[139]:$0+=qx.ui.core.Widget.SCROLLBAR_SIZE;
break;
case $[3]:break;
}return $0;
},
...
case $[10]:return $0.indexOf($[210])!=-1?qx.ui.core.Widget.TYPE_PERCENT:$0.indexOf($[129])!=-1?qx.ui.core.Widget.TYPE_FLEX:qx.ui.core.Widget.TYPE_NULL;
...
switch(typeof $0){case $[58]:return isNaN($0)?qx.ui.core.Widget.TYPE_NULL:qx.ui.core.Widget.TYPE_PIXEL;
case $[10]:return $0.indexOf($[210])!=-1?qx.ui.core.Widget.TYPE_PERCENT:qx.ui.core.Widget.TYPE_NULL;
}return qx.ui.core.Widget.TYPE_NULL;
},
...
"gecko":function($0,
$1){this.setStyleProperty($[1930],
($0<0?$[678]:$[221]));
},
"default":function($0,
$1){this.setStyleProperty($[998],
($0<0?$[678]:$[221]));
...
"webkit":function($0,
$1){if($0){this.removeStyleProperty($[698]);
}else{this.setStyleProperty($[698],
$[14]);
}},
"khtml":function($0,
...
"default":function($0,
$1){if($0){return this.removeStyleProperty($[708]);
}else{this.setStyleProperty($[708],
$[14]);
}}}),
_applyOpacity:qx.core.Variant.select($[1],
{"mshtml":function($0,
$1){if($0==null||$0>=1||$0<0){this.removeStyleProperty($[169]);
}else{this.setStyleProperty($[169],
($[1198]+Math.round($0*100)+$[65]));
}},
"default":function($0,
$1){if($0==null||$0>1){if(qx.core.Variant.isSet($[1],
$[28])){this.removeStyleProperty($[575]);
}else if(qx.core.Variant.isSet($[1],
$[188])){this.removeStyleProperty($[491]);
...
$[2346]+$0+$[65]):this.removeStyleProperty($[598]);
},
...
$1=$1+$[52];
}return this.setStyleProperty($[1342],
($[2316]+$1+$[21]+$4+$[21]+$5+$[21]+$0+$[65]));
},
_applyOverflow:qx.core.Variant.select($[1],
{"default":function($0,
$1){var $2=$0;
var $3=$[87];
switch($0){case $[139]:$3=$[211];
$2=$[37];
break;
case $[121]:$3=$[212];
$2=$[37];
...
switch($0){case $[139]:this.setStyleProperty($[212],
$[24]);
break;
case $[121]:this.setStyleProperty($[211],
$[24]);
break;
...
$1){var $2=$0;
var $3=$[87];
switch($2){case $[139]:case $[121]:$2=$[37];
break;
}this._renderOverflow($3,
$2,
$0,
...
_styleBackgroundColor:function($0){$0?this.setStyleProperty($[657],
$0):this.removeStyleProperty($[657]);
},
...
for(var $4 in this._styleProperties){switch($4){case $[411]:case $[169]:case $[189]:break;
default:$3[$4]=$2[$4];
$2[$4]=$[0];
}}
for(var $4 in this._htmlProperties){switch($4){case $[1804]:$1.unselectable=this._htmlProperties[$4];
}}while($0.firstChild){$1.appendChild($0.firstChild);
}$0.appendChild($1);
}}),
_applyPaddingTop:function($0,
$1){this.addToQueue($[246]);
this._invalidateFrameHeight();
},
...
{statics:{includeFile:function($0){var $1=document.createElement($[1846]);
$1.type=$[600];
$1.rel=$[1261];
$1.href=$0;
var $2=document.getElementsByTagName($[685])[0];
$2.appendChild($1);
},
createElement:qx.lang.Object.select(document.createStyleSheet?$[165]:$[72],
...
$1.type=$[600];
$1.appendChild(document.createTextNode($0||$[1590]));
document.getElementsByTagName($[685])[0].appendChild($1);
if($1.sheet){return $1.sheet;
}else{var $2=document.styleSheets;
for(var $3=$2.length-1;$3>=0;$3--){if($2[$3].ownerNode==$1){return $2[$3];
}}}throw $[2049];
}}),
addRule:qx.lang.Object.select(document.createStyleSheet?$[165]:$[72],
{"ie4+":function($0,
$1,
$2){$0.addRule($1,
$2);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[300]:$[72],
{"safari2+":function($0,
$1,
$2){if(!$0._qxRules){$0._qxRules={};
}
if(!$0._qxRules[$1]){var $3=document.createTextNode($1+$[370]+$2+$[218]);
$0.ownerNode.appendChild($3);
$0._qxRules[$1]=$3;
}},
"other":function($0,
$1,
$2){$0.insertRule($1+$[370]+$2+$[218],
$0.cssRules.length);
}})}),
removeRule:qx.lang.Object.select(document.createStyleSheet?$[165]:$[72],
{"ie4+":function($0,
$1){var $2=$0.rules;
var $3=$2.length;
...
removeAllRules:qx.lang.Object.select(document.createStyleSheet?$[165]:$[72],
...
addImport:qx.lang.Object.select(document.createStyleSheet?$[165]:$[72],
{"ie4+":function($0,
$1){$0.addImport($1);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[300]:$[72],
{"safari2+":function($0,
$1){$0.ownerNode.appendChild(document.createTextNode($[704]+$1+$[539]));
},
"other":function($0,
$1){$0.insertRule($[704]+$1+$[539],
$0.cssRules.length);
}})}),
removeImport:qx.lang.Object.select(document.createStyleSheet?$[165]:$[72],
{"ie4+":function($0,
$1){var $2=$0.imports;
var $3=$2.length;
...
removeAllImports:qx.lang.Object.select(document.createStyleSheet?$[165]:$[72],
...
properties:{focusHandler:{check:$[697],
apply:$[1557],
nullable:true},
...
$1){var $2=$0!=null;
var $3=$1!=null;
if(qx.Class.isDefined($[203])&&$2){var $4=qx.ui.popup.PopupManager.getInstance();
if($4){$4.update($0);
}}
if($3){if($1.hasEventListeners($[344])){var $5=new qx.event.type.FocusEvent($[344],
$1);
...
if(qx.Class.isDefined($[181])){var $4=qx.ui.popup.ToolTipManager.getInstance();
if($4){$4.handleBlur($5);
}}$5.dispose();
}
...
var $5=new qx.event.type.FocusEvent($[285],
$0);
if($3){$5.setRelatedTarget($1);
}$0.dispatchEvent($5);
if(qx.Class.isDefined($[181])){var $4=qx.ui.popup.ToolTipManager.getInstance();
...
$[137])){$1._layoutChildOrig=$1._layoutChild;
...
destruct:function(){this._disposeObjectDeep($[1768],
1);
this._disposeObjects($[1362],
$[734]);
...
$0);
this.setTarget($1);
switch($0){case $[318]:case $[344]:this.setBubbles(true);
...
if($7!=null&&$7.getEnabled()){switch($4){case $[214]:case $[277]:if(qx.Class.isDefined($[183])){qx.ui.menu.Manager.getInstance().update($7,
$1);
}break;
}if(!this.getAllowClientSelectAll()){if($0.ctrlKey&&$4==$[187]){switch($5.tagName.toLowerCase()){case $[159]:case $[365]:case $[198]:break;
...
switch($2){case $[15]:case $[22]:case $[91]:case $[128]:case $[213]:this._lastMouseEventType=$2;
...
$b.setActiveChild($6);
}}switch($1){case $[86]:case $[144]:$8=qx.event.handler.EventHandler.getRelatedTargetObjectFromEvent($0);
if($8==$6){return;
...
$3,
$0);
}else{if($1==$[86]){if(qx.Class.isDefined($[181])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($3);
}}}$3.dispose();
$3=null;
qx.ui.core.Widget.flushGlobalQueues();
...
$4,
$5,
$6){switch($0){case $[15]:if(qx.Class.isDefined($[203])){qx.ui.popup.PopupManager.getInstance().update($1);
}
if(qx.Class.isDefined($[183])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[331])){qx.ui.embed.IframeManager.getInstance().handleMouseDown($5);
}break;
case $[22]:if(qx.Class.isDefined($[183])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[331])){qx.ui.embed.IframeManager.getInstance().handleMouseUp($5);
}break;
case $[86]:if(qx.Class.isDefined($[181])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($5);
}break;
case $[144]:if(qx.Class.isDefined($[181])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOut($5);
}break;
...
if(qx.Class.isDefined($[203])){qx.ui.popup.PopupManager.getInstance().update();
}if(qx.Class.isDefined($[183])){qx.ui.menu.Manager.getInstance().update();
}if(qx.Class.isDefined($[389])){qx.event.handler.DragAndDropHandler.getInstance().globalCancelDrag();
}qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1569]);
},
_onwindowfocus:function($0){if(this._focused){return;
}this._focused=true;
qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1970]);
},
...
this._disposeObjectDeep($[2393],
1);
this._disposeFields($[1318],
$[1714],
$[1961],
$[1341],
$[2321],
$[2257]);
this._disposeFields($[1947],
$[1629],
$[1426],
$[2119],
$[1054]);
...
if($3==$[158]||$3==$[45]){$1=this._charCode2KeyCode[$0.charCode]||$0.keyCode;
...
27:$[214],
32:$[122]},
_keyCodeToIdentifierMap:{16:$[297],
17:$[242],
18:$[278],
20:$[554],
224:$[264],
...
if($0>=$[46]&&$0<=$[247]){return true;
}
if($0>=$[187]&&$0<=$[391]){return true;
}
...
$1._keyCodeFix={12:$1._identifierToKeyCode($[180])};
}else if(qx.core.Variant.isSet($[1],
$[174])){$1._charCode2KeyCode={63289:$1._identifierToKeyCode($[180]),
63276:$1._identifierToKeyCode($[157]),
63277:$1._identifierToKeyCode($[197]),
63275:$1._identifierToKeyCode($[200]),
63273:$1._identifierToKeyCode($[178]),
63234:$1._identifierToKeyCode($[85]),
63232:$1._identifierToKeyCode($[133]),
63235:$1._identifierToKeyCode($[88]),
63233:$1._identifierToKeyCode($[145]),
63272:$1._identifierToKeyCode($[245]),
63302:$1._identifierToKeyCode($[311]),
...
63240:$1._identifierToKeyCode($[334]),
...
63248:$1._identifierToKeyCode($[286]),
3:$1._identifierToKeyCode($[90]),
12:$1._identifierToKeyCode($[180]),
13:$1._identifierToKeyCode($[90])};
}else if(qx.core.Variant.isSet($[1],
$[137])){$1._lastKeyCode=null;
}},
...
destruct:function(){this._disposeFields($[1323],
$[1957]);
}});
...
destruct:function(){this._disposeObjectDeep($[675]);
}});
...
destruct:function(){this._disposeFields($[1604]);
}});
...
if(qx.core.Variant.isSet($[1],
$[23])&&(qx.core.Client.getInstance().getMajor()<7)){try{document.execCommand($[2330],
false,
true);
...
if(qx.Class.isDefined($[684])&&$0 instanceof qx.ui.window.Window){this._modalWidgets.push($0);
var $1=$0.getZIndex();
...
_onwindowresize:function($0){if(qx.Class.isDefined($[203])){qx.ui.popup.PopupManager.getInstance().update();
}this._recomputeInnerWidth();
this._recomputeInnerHeight();
qx.ui.core.Widget.flushGlobalQueues();
},
...
defer:function(){if(qx.core.Setting.get($[896])){var $0=qx.core.Client.getInstance().getEngineBoxSizingAttributes();
var $1=$0.join($[501])+$[501];
var $2=$0.join($[471])+$[471];
qx.html.StyleSheet.createElement($[1044]+$[1810]+$[2080]+$1+$[1929]+$[2347]+$2+$[218]);
}
if(qx.core.Setting.get($[2275])){qx.html.StyleSheet.createElement($[2358]);
}},
destruct:function(){this._disposeObjects($[663]);
...
properties:{appearanceTheme:{check:$[147],
nullable:true,
apply:$[2171],
event:$[2397]}},
...
destruct:function(){this._disposeFields($[985],
$[1855]);
}});
...
qx.Class.define($[2093],
{type:$[25],
extend:qx.core.Target,
properties:{theme:{check:$[147],
nullable:true,
apply:$[1398],
event:$[1414]},
autoSync:{check:$[2],
...
getBorderThemes:function(){return this.__queryThemes($[706]);
},
getFontThemes:function(){return this.__queryThemes($[633]);
},
getWidgetThemes:function(){return this.__queryThemes($[403]);
},
getIconThemes:function(){return this.__queryThemes($[655]);
},
...
{type:$[25],
extend:qx.util.manager.Value,
properties:{colorTheme:{check:$[147],
nullable:true,
apply:$[2088],
event:$[1136]}},
...
rgbToRgbString:function($0){return $[1498]+$0[0]+$[21]+$0[1]+$[21]+$0[2]+$[65];
},
...
qx.Class.define($[1380],
{type:$[25],
extend:qx.util.manager.Value,
properties:{borderTheme:{check:$[147],
nullable:true,
apply:$[1205],
event:$[814]}},
...
switch($3){case $[179]:case $[229]:case $[89]:case $[82]:case $[5]:case $[204]:case $[220]:case $[208]:case $[14]:$1.setStyle($3);
break;
...
{type:$[25],
extend:qx.util.manager.Value,
properties:{fontTheme:{check:$[147],
nullable:true,
apply:$[1228],
event:$[1587]}},
...
var $3=[];
var $4;
for(var $5=0;$5<$2.length;$5++){switch($4=$2[$5]){case $[260]:$1.setBold(true);
break;
...
$1){this.__bold=$0===null?null:$0?$[260]:$[221];
},
_applyItalic:function($0,
$1){this.__italic=$0===null?null:$0?$[510]:$[221];
},
...
generateStyle:function(){return (this.__family?$[1942]+this.__family.replace(/\"/g,
$[172])+$[92]:$[0])+(this.__size?$[1243]+this.__size+$[92]:$[0])+(this.__weight?$[1963]+this.__weight+$[92]:$[0])+(this.__style?$[1504]+this.__style+$[92]:$[0])+(this.__decoration?$[1744]+this.__decoration+$[92]:$[0]);
}}});
...
qx.Class.define($[1367],
{type:$[25],
extend:qx.core.Target,
properties:{iconTheme:{check:$[147],
nullable:true,
apply:$[1543],
event:$[1885]}},
...
qx.Class.define($[1931],
{type:$[25],
extend:qx.core.Target,
properties:{widgetTheme:{check:$[147],
nullable:true,
apply:$[1808],
event:$[2352]}},
...
$1){if($1.getKeyIdentifier()!=$[277]){return;
}$1.stopPropagation();
$1.preventDefault();
...
destruct:function(){this._disposeFields($[1570]);
}});
...
while($0.tagName.toLowerCase()!=$[151]){$0=$0.offsetParent;
...
destruct:function(){this._disposeFields($[1060],
$[1915]);
}});
...
$[103]);
if($3!=$[74]&&$3!=$[149]){$1-=qx.html.Style.getBorderLeft($2);
}if($4!=$[74]&&$4!=$[149]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[10]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[103]);
if($5==$[74]||$5==$[149]){$1-=qx.html.Style.getBorderLeft($2)+qx.html.Style.getPaddingLeft($2);
break;
}}}return $1;
},
...
var $4=qx.html.Style.getStyleProperty($2,
$[103]);
if($3!=$[74]&&$3!=$[149]){$1-=qx.html.Style.getBorderTop($2);
}if($4!=$[74]&&$4!=$[149]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[10]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[103]);
if($5==$[74]||$5==$[149]){$1-=qx.html.Style.getBorderTop($2)+qx.html.Style.getPaddingTop($2);
break;
}}}return $1;
},
...
$[87])){case $[37]:case $[3]:case $[361]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
$[211])){case $[37]:case $[3]:$5=true;
break;
default:$5=false;
}}
...
if($6.tagName.toLowerCase()==$[151]){break;
}$6=$6.offsetParent;
}return true;
},
scrollY:function($0,
...
while($6){switch(qx.html.Style.getStyleProperty($6,
$[87])){case $[37]:case $[3]:case $[351]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
...
}this._timer=new qx.client.Timer(qx.core.Setting.get($[1818]));
...
this.__oninterval,
this);
this._disposeObjects($[265]);
}this._disposeFields($[933]);
}});
...
destruct:function(){this._disposeFields($[675]);
}});
...
qx.io.Alias.getInstance().add($[1033],
qx.core.Setting.get($[1443]));
qx.html.StyleSheet.includeFile(qx.io.Alias.getInstance().resolve($[2333]));
qx.html.StyleSheet.includeFile(qx.io.Alias.getInstance().resolve($[1074]));
...
_load:function(){this.viewer.dataLoader($[2356]);
}},
settings:{"demobrowser.resourceUri":$[475]},
destruct:function(){this._disposeObjects($[1200]);
}});
...
updateChildOnInnerHeightChange:function($0){if(this.getWidget().getVerticalChildrenAlign()==$[33]){$0.addToLayoutChanges($[140]);
...
}if($0.spacing||$0.orientation||$0.reverseChildrenOrder||$0.verticalChildrenAlign){$3._addChildrenToLayoutQueue($[140]);
}
...
}switch($2.getLayoutMode()){case $[19]:case $[263]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[140]);
}break;
case $[33]:case $[270]:while($5=$3[++$6]){$5.addToLayoutChanges($[140]);
}break;
default:$6+=$1;
while($5=$3[++$6]){$5.addToLayoutChanges($[140]);
}}},
updateChildrenOnMoveChild:function($0,
$1,
...
var $5=Math.max($1,
$2)+1;
for(var $6=$4;$6<$5;$6++){$3[$6].addToLayoutChanges($[140]);
}},
flushChildrenQueue:function($0){var $1=this.getWidget(),
...
switch($1.getLayoutMode()){case $[19]:case $[263]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[33]:case $[270]:$5=-1;
...
layoutChild_locationY:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[19]:case $[263]:var $3=$2.getPaddingBottom()+$2.getAccumulatedChildrenOuterHeight()-$0.getOuterHeight();
break;
case $[33]:case $[270]:var $3=$2.getPaddingTop()+Math.round(($2.getInnerHeight()-$2.getAccumulatedChildrenOuterHeight())/2);
break;
default:var $3=$2.getPaddingTop();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[19]:case $[263]:var $3=$4._cachedLocationVertical-$0.getOuterHeight()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationVertical+$4.getOuterHeight()+$2.getSpacing();
}}$0._cachedLocationVertical=$3;
switch(this.getWidget().getLayoutMode()){case $[19]:case $[1705]:case $[270]:$3+=!$0._computedBottomTypeNull?$0.getBottomValue():!$0._computedTopTypeNull?-($0.getTopValue()):0;
$0._resetRuntimeTop();
...
if(($0.getVerticalAlign()||this.getWidget().getVerticalChildrenAlign())==$[33]){$0.addToLayoutChanges($[140]);
}return $1||$2;
},
...
if($0.verticalChildrenAlign){$3._addChildrenToLayoutQueue($[140]);
}
...
}switch($2.getLayoutMode()){case $[12]:case $[250]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[125]);
}break;
case $[59]:case $[272]:while($5=$3[++$6]){$5.addToLayoutChanges($[125]);
}break;
default:$6+=$1;
...
switch($1.getLayoutMode()){case $[12]:case $[250]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[59]:case $[272]:$5=-1;
while($4=$2[++$5]){$1._layoutChild($4);
}break;
default:$5=-1;
var $7=false;
...
layoutChild_locationX:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[12]:case $[250]:var $3=$2.getPaddingRight()+$2.getAccumulatedChildrenOuterWidth()-$0.getOuterWidth();
break;
case $[59]:case $[272]:var $3=$2.getPaddingLeft()+Math.round(($2.getInnerWidth()-$2.getAccumulatedChildrenOuterWidth())/2);
break;
default:var $3=$2.getPaddingLeft();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[12]:case $[250]:var $3=$4._cachedLocationHorizontal-$0.getOuterWidth()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationHorizontal+$4.getOuterWidth()+$2.getSpacing();
}}$0._cachedLocationHorizontal=$3;
switch($2.getLayoutMode()){case $[12]:case $[1455]:case $[272]:$3+=!$0._computedRightTypeNull?$0.getRightValue():!$0._computedLeftTypeNull?-($0.getLeftValue()):0;
$0._resetRuntimeLeft();
...
statics:{Img_PlayAll_Default:$[1503],
Img_PlayAll_Stop:$[1864]},
properties:{playAll:{check:$[2],
apply:$[1773],
init:false}},
members:{__makeHeader:function(){var $0=new qx.ui.embed.HtmlEmbed($[1516]+$[1109]+$[1092]+$[171]+$[1986]+$[772]+qx.core.Version.toString()+$[390]);
$0.setHtmlProperty($[254],
$[576]);
$0.setStyleProperty($[84],
$[1762]+qx.io.Alias.getInstance().resolve($[1939])+$[1877]);
$0.setHeight(70);
return $0;
},
__makeCommands:function(){this._cmdObjectSummary=new qx.client.Command($[970]);
...
this);
this._cmdRunSample=new qx.client.Command($[334]);
this._cmdRunSample.addEventListener($[29],
this.runSample,
this);
this._cmdPrevSample=new qx.client.Command($[1685]);
this._cmdPrevSample.addEventListener($[29],
this.playPrev,
this);
this._cmdNextSample=new qx.client.Command($[1170]);
...
this);
this._cmdProfile=new qx.client.Command($[2187]);
...
this.widgets[$[310]].setEnabled(false);
this.widgets[$[138]].setEnabled(true);
},
__setStateLoading:function(){this.__states.isLoading=true;
this.__setStateInitialized();
if(!this.isPlayAll()){this.widgets[$[138]].setEnabled(false);
}},
__setStateLoaded:function(){this.__states.isLoading=false;
this.widgets[$[138]].setEnabled(true);
this.widgets[$[232]].resetEnabled();
this.widgets[$[240]].resetEnabled();
this.widgets[$[337]].resetEnabled();
this.widgets[$[190]].resetEnabled();
},
...
this.widgets[$[138]].setEnabled(true);
this.widgets[$[339]].setChecked(true);
...
if($0&&$0.qx){var $1=this.widgets[$[310]];
$1.setEnabled(true);
var $2=$1.getMenu();
$2.removeAll();
...
function($b){$3.setTheme($b.getTarget().getUserData($[661]));
});
$5.add($a);
$2.add($a);
}}},
__makeMenuBar:function(){var $0=[{label:$[910],
items:[{label:$[1628],
...
var $2=function($3,
$4){var $5={};
for(var $6 in $4){if($6!==$[1591]&&$6!==$[1273]&&$6!==$[163]&&$6!==$[254]){$5[$6]=$4[$6];
}}$3.set($5);
if($4.id!==undefined){$1.widgets[$4.id]=$3;
}
if($4.command!==undefined){$4.command.addEventListener($[274],
...
$0.add($1);
this.widgets[$[1823]]=$1;
this.runbutton=new qx.ui.toolbar.Button($[1890],
$[1407]);
$1.add(this.runbutton);
this.widgets[$[323]]=this.runbutton;
this.__bindCommand(this.runbutton,
this._cmdRunSample);
this.runbutton.setToolTip(new qx.ui.popup.ToolTip($[2263]));
var $2=new qx.ui.toolbar.Button($[1029],
...
this.__ehPlayAll,
this);
$2.setToolTip(new qx.ui.popup.ToolTip($[2364]));
var $3=new qx.ui.toolbar.Button($[2240],
$[1490]);
$1.add($3);
this.widgets[$[1291]]=$3;
this.__bindCommand($3,
this._cmdPrevSample);
$3.setToolTip(new qx.ui.popup.ToolTip($[750]));
var $4=new qx.ui.toolbar.Button($[785],
$[820]);
$1.add($4);
this.widgets[$[352]]=$4;
this.__bindCommand($4,
this._cmdNextSample);
$4.setToolTip(new qx.ui.popup.ToolTip($[732]));
var $5=new qx.ui.toolbar.Button($[1368],
$[2020]);
$1.add($5);
this.widgets[$[2081]]=$5;
$5.setToolTip(new qx.ui.popup.ToolTip($[2002]));
...
this._cmdProfile);
$7.setToolTip(new qx.ui.popup.ToolTip($[2016]));
this.widgets[$[339]]=$7;
...
$8.setToolTip(new qx.ui.popup.ToolTip($[2247]));
var $9=new qx.ui.toolbar.Button($[1918],
$[763]);
$6.add($9);
this.__bindCommand($9,
this._cmdNamespacePollution);
$9.setToolTip(new qx.ui.popup.ToolTip($[1180]));
return $0;
},
showProfile:function($0){if(!this._profWindow){var $1=new qx.ui.window.Window($[1320]);
$1.set({space:[20,
800,
20,
600],
...
var $1=new qx.ui.pageview.tabview.Button($[2055],
$[1977]);
this.widgets[$[399]]=$1;
$1.setChecked(true);
$0.getBar().add($1);
...
this);
var $4=new qx.ui.pageview.tabview.Button($[1045],
$[2014]);
$0.getBar().add($4);
...
this.logger=new qx.log.Logger($[1523]);
this.logger.addAppender(this.logappender);
this.f2.addEventListener($[160],
function($7){this.logappender.setElement(this.f2.getElement());
},
this);
var $8=new qx.ui.pageview.tabview.Button($[1589],
$[752]);
$0.getBar().add($8);
var $9=new qx.ui.pageview.tabview.Page($8);
$9.set({padding:[5]});
$0.getPane().add($9);
var $a=new qx.ui.embed.HtmlEmbed($[1066]);
$9.add($a);
this.widgets[$[477]]=$a;
$a.set({overflow:$[3],
width:$[11],
...
this.widgets[$[512]]=$1;
$1.setShow($[120]);
$1.setToolTip(new qx.ui.popup.ToolTip($[2184]));
var $2=new qx.ui.pageview.buttonview.Page($1);
$2.set({width:$[11],
height:$[11],
backgroundColor:$[62]});
$0.getPane().add($2);
var $3=new qx.ui.tree.Tree($[2367]);
$2.add($3);
this.tree=$3;
this.widgets[$[131]]=$3;
$1.setUserData($[537],
...
padding:5,
overflow:$[3]});
$3.getManager().addEventListener($[166],
...
this);
var $5=new qx.ui.pageview.buttonview.Button($[1605],
$[1501]);
this.widgets[$[862]]=$5;
$5.setShow($[120]);
$5.setToolTip(new qx.ui.popup.ToolTip($[873]));
var $6=new qx.ui.pageview.buttonview.Page($5);
$0.getPane().add($6);
var $7=new qx.ui.tree.Tree($[1246]);
$6.add($7);
this.tree1=$7;
this.widgets[$[298]]=$7;
$5.setUserData($[537],
...
padding:5,
overflow:$[3]});
$7.getManager().addEventListener($[166],
this.treeGetSelection,
this);
this.tree={};
var $8=this;
this.tree.getSelectedElement=function(){var $9=$8.widgets[$[190]].getBar().getManager().getSelected();
var $a;
if($9.getLabel()==$[631]){$a=$8.widgets[$[131]].getSelectedElement();
}else{$a=$8.widgets[$[298]].getSelectedElement();
}return $a;
};
return $0;
},
...
if($1.getUserData($[288]).getPrevSibling()){this._cmdPrevSample.setEnabled(true);
this.__states.isFirstSample=false;
}else{this._cmdPrevSample.setEnabled(false);
this.__states.isFirstSample=true;
}
if($1.getUserData($[288]).getNextSibling()){this._cmdNextSample.setEnabled(true);
this.__states.isLastSample=false;
...
if($a.hasChildren()){$6=new qx.ui.tree.TreeFolder($d.polish($a.label),
$[1812]);
$6.setUserData($[356],
false);
$6.setUserData($[676],
...
function($0){if(!this.getUserData($[356])){$2(this,
this.getUserData($[676]));
this.setUserData($[356],
true);
}});
if($a.label==$[2218]){$6.setOpen(true);
}}else{$6=new qx.ui.tree.TreeFile($d.polish($a.label),
$[2259]);
...
$a);
$a.widgetLinkFull=$6;
if($d.tests.handler.getFullName($a)==$d.tests.selected){$h=$a;
}}}var $c=this.tests.handler.ttree;
var $d=this;
this.widgets[$[190]].setEnabled(false);
var $e=this.widgets[$[131]];
var $f=this.widgets[$[298]];
var $g=[$e,
$f];
for(var $9=0;$9<$g.length;$9++){$g[$9].resetSelected();
$g[$9].destroyContent();
$g[$9].setUserData($[313],
$c);
}$c.widgetLinkFull=$e;
...
$2(this.widgets[$[131]],
$c);
this.widgets[$[190]].setEnabled(true);
if($h){if($h.widgetLinkFull){this.widgets[$[131]].setSelectedElement($h.widgetLinkFull);
if($h.widgetLinkFull instanceof qx.ui.tree.TreeFolder){$h.widgetLinkFull.open();
}}
if($h.widgetLinkFlat){this.widgets[$[298]].setSelectedElement($h.widgetLinkFlat);
if($h.widgetLinkFlat instanceof qx.ui.tree.TreeFolder){$h.widgetLinkFlat.open();
}}}},
runSample:function($0){if(!this.tests.selected){return;
}
if(!this.widgets[$[323]].isEnabled()){return;
}
...
}this.widgets[$[232]].getManager().setSelected(this.widgets[$[399]]);
this.widgets[$[240]].setEnabled(false);
this.__setStateLoading();
var $1=this.widgets[$[240]].getContentDocument();
if($1){$1.body.innerHTML=$[0];
}this.widgets[$[232]].setEnabled(false);
this.widgets[$[337]].setEnabled(false);
var $2;
var $3=this._sampleToTreeNodeMap[$0];
if($3){$3.setSelected(true);
$2=$[1820]+$0;
if(this._useProfile){$2+=$[2202];
}else{$2+=$[765];
...
if(this.f1.getSource()!=null&&this.f1.getSource()!=this.defaultUrl){$1.qx.log.Logger.ROOT_LOGGER.removeAllAppenders();
$1.qx.log.Logger.ROOT_LOGGER.addAppender(this.logappender);
var $5=$1.location.href;
var $6=$5.indexOf($[1351])+6;
var $7=$5.indexOf($[109]);
$7=$7==-1?$5.length:$7;
var $8=$5.substring($6,
$7).split($[56]);
...
var $b=$8[1].replace($[702],
$[0]).replace(/_/g,
$[54]);
$b=$b.charAt(0).toUpperCase()+$b.substring(1);
var $c=$[651]+$9+$[419]+$9+$[54]+$a+$[54]+$9+$[54]+$b;
}else{var $c=$[651]+$9+$[419]+$9+$[1816];
}var $d=$4.slice(-2).join($[729]);
...
if(this.isPlayAll()){if(this.widgets[$[352]].isEnabled()){qx.client.Timer.once(function(){this.widgets[$[352]].execute();
},
this,
1500);
...
var $1=this._sampleToTreeNodeMap[$[728]];
this.widgets[$[131]].setSelectedElement($1);
this.widgets[$[323]].execute();
}else{if(this.__states.isLoading){this.widgets[$[138]].setEnabled(false);
}this.setPlayAll(false);
}},
__applyPlayAll:function($0,
$1){if($0==true){this.widgets[$[138]].setIcon(demobrowser.DemoBrowser.Img_PlayAll_Stop);
}else{this.widgets[$[138]].setIcon(demobrowser.DemoBrowser.Img_PlayAll_Default);
}},
...
if($1){var $2=$1.getUserData($[288]).getPrevSibling().widgetLinkFull;
if($2){this.widgets[$[131]].setSelectedElement($2);
this.runSample();
}}},
playNext:function($0){var $1=this.tree.getSelectedElement();
if($1){var $2=$1.getUserData($[288]).getNextSibling().widgetLinkFull;
if($2){this.widgets[$[131]].setSelectedElement($2);
this.runSample();
}}},
__beautySource:function($0){var $1=$[915];
var $2=[];
var $3=$[0];
...
}}$1+=this.__beautyHtml(qx.html.String.escape($3))+$[1606];
return $1;
},
__beautyHtml:function($0){var $1=$0;
function $2($3){var $4=arguments[1]+$[1377]+arguments[2]+$[96];
var $5;
var $6=false;
...
var $9;
while(($9=$8.exec($5))!=null){$4+=$[1134]+$9[1]+$[1753]+$9[2].replace(/\s*$/,
$[0])+$[96];
}}}$4+=($6?$[56]:$[0]);
}$4+=$[816];
return $4;
...
polish:function($0){return $0.replace($[702],
$[0]).replace($[79],
$[54]);
},
defaultUrl:$[1613]},
...
init:$[27],
nullable:true},
firstSize:{apply:$[1057],
init:$[42]},
secondSize:{apply:$[2069],
init:$[42]},
...
this.getTopLevelWidget().setGlobalCursor($[312]);
...
destruct:function(){this._disposeObjects($[822],
$[1742],
$[2265],
$[1667],
$[1783],
...
{extend:qx.ui.layout.CanvasLayout,
construct:function($0){arguments.callee.base.call(this);
this.setAppearance($[1258]);
this.setStyleProperty($[175],
$[50]);
this.setStyleProperty($[228],
$[50]);
this.hide();
this._pane=$0;
this.initZIndex();
...
init:1e8}},
destruct:function(){this._disposeObjects($[262]);
}});
...
$1,
$2){arguments.callee.base.call(this);
this._blank=qx.io.Alias.getInstance().resolve($[223]);
...
$[174])){this._image=document.createElement($[1294]);
...
$0.style.filter=$[858]+$2+$[2293];
}else{$0.src=$2;
$0.style.filter=this.getEnabled()?$[0]:$[809];
}},
...
var $2=$1.offsetLeft;
var $3=$1.offsetTop;
if(qx.bom.element.Dimension.getBoxSizing($1)!==$[291]){$2+=this.__num($1,
$[98]);
$3+=this.__num($1,
$[93]);
...
if($5.getBoxSizing($0)!==$[291]){$2-=this.__num($0,
$[98]);
$3-=this.__num($0,
$[93]);
}
...
$[87])!=$[2224]){$2+=this.__num($0.parentNode,
$[98]);
...
if($0.tagName==$[1127]){var $3=$2.left;
var $4=$2.top;
...
"mshtml":function($0){if(qx.bom.Document.isStandardMode(qx.dom.Node.getDocument($0))){if(!this.__usesNativeBorderBox($0)){return $[2172];
}}return $[291];
},
...
this._iframe.style.left=$[720];
this._iframe.style.top=$[720];
document.body.appendChild(this._iframe);
var $0=qx.io.Alias.getInstance().resolve($[1525]);
this._iframe.src=$0;
this._titles={};
...
if($0!=this._state){top.location.hash=$[348]+encodeURIComponent($0);
this.__storeState($0);
}},
...
{"mshtml":function($0){var $1=$[1615]+encodeURIComponent($0)+$[1936];
...
"default":function($0){qx.client.Timer.once(function(){top.location.hash=$[348]+encodeURIComponent($0);
},
this,
0);
return true;
...
$1){$0===null?this.removeStyleProperty($[294]):this.setStyleProperty($[294],
$0);
},
_applyFont:function($0,
...
_styleTextColor:function($0){$0?this.setStyleProperty($[281],
$0):this.removeStyleProperty($[281]);
},
...
switch($5){case $[242]:case $[297]:case $[264]:case $[278]:this.__modifier[$5]=true;
break;
case $[243]:var $6=$[2283]+$2[$4];
this.error($6);
throw $6;
default:if(this.__key){var $6=$[2076];
this.error($6);
throw $6;
}this.__key=$5;
}}}return true;
...
if($0.length==1&&$0>=$[304]&&$0<=$[586]){return $0.toUpperCase();
}$0=$0.toLowerCase();
if(!qx.event.type.KeyEvent.keys[$0]){return $[243];
...
var $2=[];
for(var $3 in this.__modifier){$2.push(qx.locale.Key.getKeyName($[150],
$3));
}
if($1){$2.push(qx.locale.Key.getKeyName($[150],
$1));
}
...
destruct:function(){this._disposeFields($[1253]);
}});
...
$1,
$2){if($0!=$[150]&&$0!=$[287]){throw new Error('format must be one of: "short", "full"');
}var $3=$[1538]+$0+$[79]+$1;
...
$3[$4.marktr($[2041])]=$[90];
$3[$4.marktr($[2376])]=$[297];
$3[$4.marktr($[2379])]=$[1958];
$3[$4.marktr($[2006])]=$[278];
$3[$4.marktr($[831])]=$[1805];
$3[$4.marktr($[2307])]=$[264];
$3[$4.marktr($[2277])]=$[1769];
$3[$4.marktr($[909])]=$[85];
$3[$4.marktr($[1681])]=$[133];
$3[$4.marktr($[919])]=$[88];
$3[$4.marktr($[1593])]=$[145];
$3[$4.marktr($[2310])]=$[1896];
$3[$4.marktr($[1547])]=$[1073];
$3[$4.marktr($[1004])]=$[200];
$3[$4.marktr($[1497])]=$[178];
$3[$4.marktr($[1416])]=$[1098];
$3[$4.marktr($[881])]=$[1156];
$3[$4.marktr($[906])]=$[1373];
$3[$4.marktr($[2018])]=$[834];
$3[$4.marktr($[1237])]=$[333];
...
$1){if(!this.isClosed()){this._window.location.replace($0!=null?$0:($[1347]+$[56]));
}},
...
$0.push($[21]);
if(this.getName()!=null){this.setName($[968]+this.toHashCode());
...
destruct:function(){this._disposeObjectDeep($[2320],
1);
}});
...
qx.locale.Manager.getInstance().addEventListener($[362],
...
if($1===$[3]){$1=qx.util.Validation.isValidString($0)&&$0.match(/<.*>/)?$[406]:$[170];
}
switch($1){case $[170]:var $2=qx.html.String.escape($0).replace(/(^ | $)/g,
$[953]).replace(/  /g,
$[1378]);
this._isHtml=$2!==$0;
this._content=$2;
...
$1){this._mnemonicTest=$0?new RegExp($[2342]+$0+$[1658]+$0+$[1542]+$0+$[2289]+$0+$[65],
$[1673]):null;
if(this._isCreated){this._renderContent();
}},
...
$1){return ($[1201]+($1-14)+$[2117]+$0+$[1563]);
},
...
if(this.getMnemonic()){if(this._mnemonicTest.test($0)){$0=RegExp.$1+$[1176]+RegExp.$7+$[171]+RegExp.rightContext;
this._isHtml=true;
}else{$0+=$[2165]+this.getMnemonic()+$[65];
}}var $2=$1.style;
...
getTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[672]:qx.core.Client.getInstance().supportsInnerText()?$[666]:$[55],
...
setTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[672]:qx.core.Client.getInstance().supportsInnerText()?$[666]:$[55],
...
if(qx.Class.isDefined($[183])){var $1=qx.lang.Object.getValues(qx.ui.menu.Manager.getInstance().getAll());
...
if(qx.Class.isDefined($[290])&&$0 instanceof qx.ui.popup.ToolTip&&!($1 instanceof qx.ui.popup.ToolTip)){continue;
}$1.hide();
}}}});
...
qx.Class.define($[746],
{statics:{__umlautsRegExp:new RegExp($[2294],
$[372]),
__umlautsShortData:{"\xC4":$[187],
"\xD6":$[1486],
"\xDC":$[939],
"\xE4":$[304],
"\xF6":$[988],
...
break;
case $[145]:this._onkeypress_down($0);
break;
...
destruct:function(){this._disposeObjects($[2162]);
}});
...
_handleLabel:function(){switch(this.getShow()){case $[163]:case $[155]:case $[142]:this._labelIsVisible=!!this.getLabel();
break;
...
_handleIcon:function(){switch(this.getShow()){case $[120]:case $[155]:case $[142]:this._iconIsVisible=!!this.getIcon();
break;
...
inheritable:true,
event:$[343]}},
destruct:function(){this._disposeObjects($[1146]);
}});
...
destruct:function(){this._disposeObjects($[1027]);
}});
...
{type:$[25],
extend:qx.util.manager.Object,
properties:{currentToolTip:{check:$[290],
nullable:true,
apply:$[2319]}},
...
switch(this.getResizeMethod()){case $[164]:this.setOpacity(0.5);
break;
...
switch(this.getResizeMethod()){case $[289]:case $[164]:if(this._resizeWest||this._resizeEast){this.setWidth($1.lastWidth);
...
if(this._near($5.top,
$0.getPageY())){if(this.getResizableNorth()){$3=$[890];
...
$0.getPageX())){if(this.getResizableWest()){$3+=$[1891];
this._resizeWest=true;
}}else if(this._near($5.right,
$0.getPageX())){if(this.getResizableEast()){$3+=$[1924];
this._resizeEast=true;
}}
if(this._resizeNorth||this._resizeSouth||this._resizeWest||this._resizeEast){this.setCursor($3+$[2001]);
...
$d.setAppearance($[1266]);
$d.setHeight($[3]);
var $e=this._statusText=new qx.ui.basic.Label($[342]);
$e.setAppearance($[1871]);
...
minimize:function(){this.setMode($[268]);
},
...
$1){switch($0){case $[268]:this._disableResize=true;
this._minimize();
break;
...
break;
case $[268]:this._restoreFromMinimized();
break;
}}},
...
switch(this.getMoveMethod()){case $[164]:this.setOpacity(0.5);
break;
case $[106]:var $6=this._frame;
...
}switch(this.getMoveMethod()){case $[164]:this.setOpacity(null);
break;
...
destruct:function(){this._disposeFields($[1310],
$[1552],
$[937]);
}});
...
destruct:function(){this._disposeFields($[1643],
$[1824],
$[808]);
}});
...
if(!$0.stylesheet){$0.stylesheet=qx.html.StyleSheet.createElement($[1809]+$[997]+$[1548]+$[1517]+$[2127]+$[1296]+$[1883]+$[1317]+$[2340]+$[1787]+$[840]+$[2109]+(qx.core.Variant.isSet($[1],
$[23])?$[402]:$[1242])+$[218]+$[1894]+$[1699]+$[383]+$[1564]+$[2312]+$[383]+$[2027]+$[2083]+$[383]);
}},
members:{_getCellClass:function($0){return $[731];
},
...
if($2&qx.ui.table.cellrenderer.Default.STYLEFLAG_ALIGN_RIGHT){$1+=$[1672];
}
if($2&qx.ui.table.cellrenderer.Default.STYLEFLAG_BOLD){$1+=$[1185];
}
if($2&qx.ui.table.cellrenderer.Default.STYLEFLAG_ITALIC){$1+=$[1990];
}return $1;
},
...
postfix:{check:$[8],
init:$[0]}},
members:{format:function($0){switch($0){case Infinity:return $[1038];
case -Infinity:return $[1053];
case NaN:return $[952];
}var $1=($0<0);
if($1){$0=-$0;
}
...
var $3=new RegExp($[398]+qx.lang.String.escapeRegexpChars(this.getPrefix())+$[2309]+$[2108]+$1+$[778]+$[679]+$2+$[2291]+qx.lang.String.escapeRegexpChars(this.getPostfix())+$[177]);
var $4=$3.exec($0);
...
{statics:{getDecimalSeparator:function($0){return new qx.locale.LocalizedString($[2133],
[],
$0);
},
getGroupSeparator:function($0){return new qx.locale.LocalizedString($[938],
[],
$0);
},
getPercentFormat:function($0){return new qx.locale.LocalizedString($[1360],
[],
$0);
}}});
...
}else{this._format=qx.locale.Date.getDateFormat($[217],
this._locale)+$[54]+qx.locale.Date.getDateTimeFormat($[338],
$[346],
this._locale);
}},
statics:{getDateTimeInstance:function(){var $0=qx.util.format.DateFormat;
var $1=qx.locale.Date.getDateFormat($[217])+$[54]+qx.locale.Date.getDateTimeFormat($[338],
$[346]);
...
var $1=qx.locale.Date.getDateFormat($[150])+$[0];
...
if($e.type==$[261]){$c+=$e.text;
}else{var $f=$e.character;
var $g=$e.size;
var $h=$[109];
switch($f){case $[864]:if($g==2){$h=this.__fillNumber($3%100,
2);
}else if($g==4){$h=$3;
}break;
case $[1007]:$h=this.__fillNumber(this.__getDayInYear($0),
$g);
break;
case $[1441]:$h=this.__fillNumber($5,
$g);
break;
case $[1405]:$h=this.__fillNumber(this.__getWeekInYear($0),
$g);
break;
case $[1746]:if($g==2){$h=qx.locale.Date.getDayName($[186],
$6,
$2);
...
case $[892]:if($g==1||$g==2){$h=this.__fillNumber($4+1,
$g);
...
break;
case $[1610]:$h=this.__fillNumber($7,
$g);
break;
case $[1733]:$h=this.__fillNumber(($7==0)?24:$7,
$g);
break;
case $[1724]:$h=this.__fillNumber($7%12,
$g);
break;
case $[1186]:$h=this.__fillNumber((($7%12)==0)?12:($7%12),
$g);
break;
case $[736]:$h=this.__fillNumber($8,
$g);
break;
case $[1785]:$h=this.__fillNumber($9,
$g);
break;
case $[2244]:$h=this.__fillNumber($a,
$g);
break;
case $[659]:if($g==1){$h=$[764]+(($b<0)?$[100]:$[201])+this.__fillNumber($b)+$[1124];
...
switch($4){case $[607]:if($6==$[172]){if($5+1>=$3.length){$5++;
break;
}var $7=$3.charAt($5+1);
if($7==$[172]){$2+=$6;
$5++;
...
case $[252]:if($6==$0){$1++;
$5++;
}else{this.__formatTree.push({type:$[252],
character:$0,
size:$1});
$0=null;
$1=0;
...
default:if(($6>=$[641]&&$6<=$[659])||($6>=$[2235]&&$6<=$[610])){$0=$6;
$4=$[252];
}else if($6==$[172]){if($5+1>=$3.length){$2+=$6;
$5++;
break;
}var $7=$3.charAt($5+1);
if($7==$[172]){$2+=$6;
...
if($4!=$[55]){if($2.length>0){this.__formatTree.push({type:$[261],
text:$2});
$2=$[0];
}}else{$2+=$6;
$5++;
}break;
}}if($0!=null){this.__formatTree.push({type:$[252],
character:$0,
size:$1});
}else if($2.length>0){this.__formatTree.push({type:$[261],
text:$2});
}},
...
if($4.type==$[261]){$2+=qx.lang.String.escapeRegexpChars($4.text);
...
var $e=qx.locale.Date.getDayNames($[186],
this._locale);
...
this._parseRules.push({pattern:$[812],
regex:$[866],
groups:2,
manipulator:$1});
this._parseRules.push({pattern:$[806],
regex:$[2085],
manipulator:$1});
this._parseRules.push({pattern:$[1648],
regex:$[57],
manipulator:$4});
this._parseRules.push({pattern:$[2241],
regex:$[57],
manipulator:$4});
this._parseRules.push({pattern:$[2175],
regex:$[114]+$9.join($[136])+$[65],
manipulator:$b});
this._parseRules.push({pattern:$[1311],
regex:$[114]+$c.join($[136])+$[65],
manipulator:$d});
this._parseRules.push({pattern:$[2213],
regex:$[57],
field:$[605]});
this._parseRules.push({pattern:$[1795],
regex:$[57],
field:$[605]});
this._parseRules.push({pattern:$[1623],
regex:$[114]+$e.join($[136])+$[65],
manipulator:$f});
this._parseRules.push({pattern:$[2056],
regex:$[114]+$g.join($[136])+$[65],
manipulator:$h});
this._parseRules.push({pattern:$[2078],
regex:$[114]+$i.join($[136])+$[65],
manipulator:$j});
this._parseRules.push({pattern:$[304],
regex:$[114]+$0.AM_MARKER+$[136]+$0.PM_MARKER+$[65],
manipulator:$5});
this._parseRules.push({pattern:$[2019],
regex:$[57],
field:$[244]});
this._parseRules.push({pattern:$[1993],
regex:$[57],
field:$[244]});
this._parseRules.push({pattern:$[916],
regex:$[57],
manipulator:$6});
this._parseRules.push({pattern:$[1450],
regex:$[57],
manipulator:$6});
this._parseRules.push({pattern:$[1461],
regex:$[57],
field:$[244]});
this._parseRules.push({pattern:$[1865],
regex:$[57],
field:$[244]});
this._parseRules.push({pattern:$[1015],
regex:$[57],
manipulator:$7});
this._parseRules.push({pattern:$[744],
regex:$[57],
manipulator:$7});
...
regex:$[57],
field:$[612]});
this._parseRules.push({pattern:$[690],
regex:$[57],
field:$[595]});
this._parseRules.push({pattern:$[414],
regex:$[57],
field:$[595]});
this._parseRules.push({pattern:$[944],
regex:$[360],
field:$[238]});
this._parseRules.push({pattern:$[888],
regex:$[360],
field:$[238]});
this._parseRules.push({pattern:$[1172],
regex:$[360],
field:$[238]});
...
destruct:function(){this._disposeFields($[1214],
$[1813],
$[2216],
$[1518],
$[1510]);
...
{statics:{getAmMarker:function($0){return new qx.locale.LocalizedString($[1573],
[],
$0);
},
getPmMarker:function($0){return new qx.locale.LocalizedString($[2112],
[],
$0);
},
getDayNames:function($0,
$1){if($0!=$[134]&&$0!=$[186]&&$0!=$[132]){throw new Error('format must be one of "abbreviated", "narrow", "wide"');
}var $2=[$[712],
$[681],
$[709],
$[646],
...
$1,
$2){if($0!=$[134]&&$0!=$[186]&&$0!=$[132]){throw new Error('format must be one of "abbreviated", "narrow", "wide"');
}var $3=[$[712],
$[681],
$[709],
$[646],
...
$1){if($0!=$[150]&&$0!=$[322]&&$0!=$[217]&&$0!=$[287]){throw new Error('format must be one of "short", "medium", "long", "full"');
}var $2=$[1940]+$0;
...
switch($0){case $[150]:case $[322]:return qx.locale.Date.getDateTimeFormat($[1889],
$[2374]);
case $[217]:return qx.locale.Date.getDateTimeFormat($[338],
$[346]);
case $[287]:return qx.locale.Date.getDateTimeFormat($[1750],
$[1832]);
...
if($1){if($1==$[375]&&qx.core.Client.getInstance().isMshtml()){$0.cursor=$[233];
}else{$0.cursor=$1;
}}else{$0.cursor=$[0];
}},
_applyTextAlign:function($0,
...
if($0){this.addState($[682]);
}else{this.removeState($[682]);
}},
_applyTextColor:function($0,
$1){qx.theme.manager.Color.getInstance().connect(this._styleTextColor,
this,
...
{"mshtml":function($0){if(!this._inValueProperty&&$0.propertyName===$[451]){this.createDispatchDataEvent($[159],
...
newWidth:$1,
oldWidth:$2};
this.createDispatchDataEvent($[345],
$3);
}},
...
fromOverXPos:$0,
toOverXPos:$1};
this.createDispatchDataEvent($[674],
$4);
}},
...
var $3;
var $4=qx.io.Alias;
var $5=$4.getInstance().resolve($[1356]);
$3=new qx.ui.menu.Separator();
$2.add($3);
$3=new qx.ui.menu.Button($[2195],
$5);
$2.add($3);
...
destruct:function(){this._disposeFields($[309]);
}});
...
cellDblclick:1,
cellContextmenu:1}},
properties:{selectionModel:{check:$[341],
apply:$[1614],
event:$[1908]},
tableModel:{check:$[717],
apply:$[1572],
event:$[833],
nullable:true},
...
if($1!=null){$1.removeEventListener($[166],
this._onSelectionChanged,
this);
}$0.addEventListener($[166],
this._onSelectionChanged,
this);
},
...
this);
$0.addEventListener($[345],
this._onColWidthChanged,
this);
$0.addEventListener($[674],
...
switch($1){case $[178]:this.setFocusedCell(this._focusedCol,
0,
true);
break;
...
switch($1){case $[317]:case $[90]:$2=this.startEditing();
break;
default:$2=false;
break;
}}else if($0.isCtrlPressed()){$2=true;
switch($1){case $[187]:var $4=this.getTableModel().getRowCount();
...
-1);
break;
case $[145]:this.moveFocusedCell(0,
1);
break;
case $[157]:case $[197]:var $4=this.getPaneScroller(0);
...
var $2;
if($0==0){$2=this.trn($[1254],
$[2050],
$1,
$1);
}else{$2=this.trn($[1150],
$[1579],
$1,
$0,
$1);
...
var $4={table:this,
menu:$0};
this.createDispatchDataEvent($[842],
$4,
true);
...
_dumpRanges:function(){var $0=$[1285];
for(var $1=0;$1<this._selectedRangeArr.length;$1++){var $2=this._selectedRangeArr[$1];
$0+=$[727]+$2.minIndex+$[932]+$2.maxIndex+$[108];
}this.debug($0);
},
_fireChangeSelection:function(){if(this.hasBatchMode()){this._hadChangeEventInBatchMode=true;
}this.createDispatchEvent($[166]);
}},
destruct:function(){this._disposeFields($[1478]);
}});
...
$n+=$[934]+$8+$[869]+$6.getTotalWidth()+$[336];
if($n){$k.push($[1334],
$n,
$[625]);
}$k.push($[1530]);
...
this._horScrollBar.addEventListener($[207],
this._onScrollX,
this);
this._verScrollBar.addEventListener($[207],
this._onScrollY,
this);
...
this._paneClipper.addEventListener($[259],
this._onmousewheel,
this);
...
_onScrollX:function($0){this.createDispatchChangeEvent($[1307],
$0.getValue(),
$0.getOldValue());
var $1=$0.getValue();
...
if(this.hasEventListeners($[251])){this.dispatchEvent(new qx.ui.table.pane.CellEvent(this,
$[251],
$0),
true);
...
if(this.hasEventListeners($[689])){this.dispatchEvent(new qx.ui.table.pane.CellEvent(this,
$[689],
$0),
true);
}}},
...
$2);
this.startEditing();
if(this.hasEventListeners($[664])){var $3=this._getRowForPagePos($1,
$2);
...
this._resizeLine.removeStyleProperty($[363]);
},
_hideResizeLine:function(){if(this._resizeLine){this._resizeLine.setStyleProperty($[363],
$[24]);
}},
...
this._focusIndicator.addState($[660]);
...
this._focusIndicator.removeState($[660]);
this._cellEditor.dispose();
this._cellEditor=null;
this._cellEditorFactory=null;
}}},
...
$[0]);
}this._scrollBar.setOverflow($0?$[139]:$[121]);
...
this._blocker.setAppearance($[1084]);
this.add(this._blocker);
this.setMaximum(0);
},
...
destruct:function(){this._disposeObjects($[2363],
$[1068],
$[663]);
}});
...
destruct:function(){this._disposeObjects($[1980]);
}});
...
destruct:function(){this._disposeObjects($[1965],
$[262]);
}});
...
_ontabclose:function($0){this.createDispatchDataEvent($[2079],
this);
$0.stopPropagation();
},
_applyChecked:function($0,
...
_renderAppearance:function(){if(this.getView()){this.isFirstVisibleChild()?this.addState($[1964]):this.removeState($[381]);
...
!this.getView().getPlaceBarOnTop()?this.addState($[182]):this.removeState($[182]);
}arguments.callee.base.call(this);
}},
destruct:function(){this._disposeObjects($[1309]);
}});
...
$[23])){var $1=$0?$[1580]+$0+$[105]:$[402];
var $2=qx.ui.embed.Iframe._element=document.createElement($[1831]+$1+$[1494]);
...
if($0==null||$0===$[0]){$0=qx.io.Alias.getInstance().resolve($[1115]);
}this._isLoaded=false;
...
_syncScrolling:function(){this.getIframeNode().setAttribute($[1158],
this.getScrolling());
},
...
return $1?$1.getElementsByTagName($[151])[0]:null;
}}});
...
$0===$[9]?this.addState($[249]):this.removeState($[249]);
$0===$[12]?this.addState($[256]):this.removeState($[256]);
$0===$[16]?this.addState($[192]):this.removeState($[192]);
$0===$[19]?this.addState($[182]):this.removeState($[182]);
}arguments.callee.base.call(this);
}}});
...
this._labelObject.setStyleProperty($[228],
$[11]);
this._labelObject.setMode($[170]);
arguments.callee.base.call(this);
...
}this._iconObject.setAppearance($[694]);
...
destruct:function(){this._disposeObjects($[989],
$[378],
$[303]);
this._disposeFields($[1608]);
}});
...
destruct:function(){this._disposeFields($[1028]);
this._disposeObjects($[797],
$[2334],
$[1141]);
this._disposeObjectDeep($[1423],
1);
}});
...
this._labelObject.setAppearance($[692]);
...
this),
true);
}this.getTopLevelWidget().setGlobalCursor($[805]);
...
if($7&&!$7._horizontalLayout.getVisibility()&&this.isFirstChild()){if(this.isLastChild()||$6===true){return this.getOpen()?$[385]:$[350];
}else{return this.getOpen()?$[1575]:$[1232];
}}}
if($6===true){return this.getOpen()?$[385]:$[350];
}else if(this.isLastChild()){return this.getOpen()?$[1507]:$[1670];
}else{return this.getOpen()?$[2004]:$[1879];
...
destruct:function(){this._disposeFields($[924]);
...
this._iconObject.setAppearance($[926]);
this._labelObject.setAppearance($[2200]);
this.setOpen(true);
this.addToFolder();
this.addEventListener($[45],
this._onkeydown);
...
tabIndex:{refine:true,
init:1},
excludeSpecificTreeLines:{check:$[354],
init:[],
apply:$[2199]},
hideNode:{check:$[2],
init:false,
...
getExcludeSpecificTreeLines:function(){return qx.lang.Array.clone(this[$[1574]]);
},
...
}else{return this.getOpen()?$[385]:$[350];
}}else{return null;
}}},
destruct:function(){this._disposeObjects($[482]);
}});
...
var $2=this.getFireChange();
this.setFireChange(false);
if($0.getKeyIdentifier()==$[187]&&$0.isCtrlPressed()){if(this.getMultiSelection()){this._selectAll();
...
}switch($0.getKeyIdentifier()){case $[178]:return this.getHome(this.getLeadItem());
case $[200]:return this.getEnd(this.getLeadItem());
case $[145]:return this.getDown(this.getLeadItem());
...
case $[157]:return this.getPageUp(this.getLeadItem())||this.getHome(this.getLeadItem());
...
if(this.hasEventListeners($[166])){this.dispatchEvent(new qx.event.type.DataEvent($[166],
...
destruct:function(){this._disposeObjects($[1021]);
}});
...
destruct:function(){this._disposeFields($[758],
$[2366]);
}});
...
this.setRequestHeader($[2033],
$[1147]);
this.setRequestHeader($[2219],
...
destruct:function(){this._disposeObjectDeep($[1697],
1);
this._disposeObjects($[265]);
this._disposeFields($[1428]);
}});
...
statusCodeToString:function($0){switch($0){case -1:return $[1540];
case 200:return $[2173];
case 304:return $[781];
case 206:return $[827];
case 204:return $[1555];
case 300:return $[1882];
case 301:return $[1984];
case 302:return $[1149];
case 303:return $[921];
case 305:return $[2103];
case 400:return $[1669];
case 401:return $[2070];
case 402:return $[1962];
case 403:return $[1624];
case 404:return $[2052];
case 405:return $[2169];
case 406:return $[1034];
case 407:return $[1644];
case 408:return $[1840];
case 409:return $[1483];
case 410:return $[2066];
case 411:return $[2248];
case 412:return $[2186];
case 413:return $[1732];
case 414:return $[1030];
case 415:return $[2180];
case 500:return $[1095];
case 501:return $[775];
case 502:return $[946];
case 503:return $[2152];
case 504:return $[2209];
case 505:return $[975];
case 12002:return $[1340];
case 12029:return $[412];
case 12030:return $[412];
case 12031:return $[412];
case 12152:return $[1070];
case 13030:return $[1934];
default:return $[1536];
}}},
properties:{request:{check:$[700],
nullable:true},
...
_applyState:function($0,
$1){{};
switch($0){case $[153]:this.createDispatchEvent($[153]);
break;
...
$3,
$2);
$0.setRequestHeader($[1897],
$[1611]+$a(this.getUsername()+$[947]+this.getPassword()));
}else{$0.open($1,
$3,
$2,
this.getUsername(),
...
if($0.documentElement.tagName==$[1061]){throw new Error("XML-File is not well-formed!");
...
"mshtml":qx.lang.Object.select(location.protocol!==$[602]&&window.XMLHttpRequest?$[1071]:$[2146],
...
__convertNumber:function($0){return isFinite($0)?String($0):$[292];
},
...
return $[1145]+Math.floor($2/16).toString(16)+($2%16).toString(16);
},
...
if($0 instanceof Array||$1==$[354]){return this.__convertArray($0);
}else if($0 instanceof Date||$1==$[1979]){return this.__convertDate($0);
}else if($0 instanceof Object||$1==$[112]){return this.__convertMap($0);
}return $[0];
}return $[292];
},
__convertUndefined:function($0){if(qx.core.Setting.get($[1719])){return $[292];
}},
...
}var $1=($0&&$0.length>0)?eval($[679]+$0+$[279]):null;
return $1;
}},
...
var $2=$[1581]+$0;
if(qx.core.Variant.isSet($[1],
$[23])){this._frame=document.createElement($[1111]+$1+$[2205]);
...
this._form=document.createElement($[1459]);
this._form.target=$1;
this._form.id=this._form.name=$2;
this._form.style.display=$[14];
document.body.appendChild(this._form);
this._data=document.createElement($[365]);
this._data.id=this._data.name=$[927];
...
for(var $4 in $7){var $8=document.createElement($[365]);
$8.name=$4;
...
}if($0.firstChild.tagName&&$0.firstChild.tagName.toLowerCase()==$[742]){return $0.firstChild.innerHTML;
...
if(qx.core.Variant.isSet($[1],
$[28])){this._frame.src=qx.io.Alias.getInstance().resolve($[223]);
...
statics:{_uniqueId:0,
_instanceRegistry:{},
ScriptTransport_PREFIX:$[2044],
ScriptTransport_ID_PARAM:$[2348],
ScriptTransport_DATA_PARAM:$[786],
...
this._element=document.createElement($[2015]);
this._element.charset=$[1927];
this._element.src=$0;
{};
...
$6);
if(!$d){throw new Exception($[2008]);
}$h.readTree($4,
$d);
}var $3=new demobrowser.Tree($[716]);
var $h=this;
...
getChildren:function($0){if($0==$[716]){var $1=this.tmap;
var $2=[];
...
isClass:function($0){if($0.type&&$0.type==$[184]){return false;
}else{return true;
}},
hasTests:function($0){if(!this.isClass($0))return false;
else{var $1=$0.getChildren();
for(var $2=0;$2<$1.length;$2++){if($1[$2].type&&$1[$2].type==$[184])return true;
}return false;
}},
...
if($0.type&&$0.type==$[184]){$1=$1.concat($0.label);
}return $1.join($[32]);
},
...
testCount:function($0){if($0.type&&$0.type==$[184]){return 1;
}else{var $1=0;
var $2=$0.getIterator($[368]);
var $3;
while($3=$2()){if($3.type&&$3.type==$[184]){$1++;
}}return $1;
}}},
destruct:function(){this._disposeFields($[2125]);
...
destruct:function(){this._disposeObjects($[2315],
$[1121],
$[321]);
this._disposeObjectDeep($[2166],
1);
}});
...
if($i.match($4)){$f.push({type:$[707],
value:$i});
}else if($i.match($5)){$f.push({type:$[536],
value:$i});
}else if($i.match($a)){$f.push({type:$[687],
value:$i});
...
value:$i});
}else if($3[$i]){$f.push({type:$[658],
value:$i});
}else if($i.match($6)){$f.push({type:$[465],
value:$i});
}else if($i.match($8)){$f.push({type:$[1635],
value:$i});
}else if($i.match($7)){$f.push({type:$[2176],
value:$i});
}else if($i.match($c)){$f.push({type:$[565],
value:$i});
}else if($i.match($d)){$f.push({type:$[925],
value:$i});
}else if($i.match($b)){$f.push({type:$[1075],
value:$i});
}else if($i==$[355]){$f.push({type:$[234],
value:$[355]});
}else if($i==$[405]){$f.push({type:$[234],
value:$[405]});
}else if($i==$[64]){$f.push({type:$[234],
value:$[64]});
}else{$f.push({type:$[234],
value:$i});
}}return $f;
},
...
switch($4.type){case $[465]:$2.add($[1132],
$5,
$[171]);
break;
case $[707]:case $[536]:$2.add($[1496],
$5,
$[171]);
break;
case $[687]:case $[438]:$2.add($[1550],
$5,
$[171]);
break;
case $[478]:case $[379]:case $[658]:$2.add($[2154],
$4.type,
$[640],
$5,
$[171]);
...
this._frame.src=qx.io.Alias.getInstance().resolve($[1255]);
document.body.appendChild(this._frame);
},
"default":null}),
...
$1.add=$1.push;
$1.toString=$1.get=new Function($[1375]);
$1.clear=$1.init=new Function($[1085]);
$1.isEmpty=new Function($[2034]);
...
cldr_date_time_format_HHmm:$[2374],
cldr_date_time_format_HHmmss:$[346],
...
cldr_day_narrow_mon:$[1648],
cldr_day_narrow_sat:$[1172],
cldr_day_narrow_sun:$[1172],
...
cldr_month_narrow_10:$[1486],
cldr_month_narrow_11:"N",
cldr_month_narrow_12:"D",
cldr_month_narrow_2:"F",
cldr_month_narrow_3:$[1648],
cldr_month_narrow_4:$[187],
cldr_month_narrow_5:$[1648],
cldr_month_narrow_6:"J",
cldr_month_narrow_7:"J",
cldr_month_narrow_8:$[187],
cldr_month_narrow_9:$[1172],
