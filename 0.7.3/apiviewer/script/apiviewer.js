$=["","qx.client","Boolean","auto",'</div>',"undefined","solid","qx.event.type.Event","right","left","string","Integer","String","border-dark-shadow","none","top","bottom",';',"completed","horizontal","mshtml","hidden","middle","mouseup",".","vertical","mousedown","failed",",","singleton","set","gecko",'<div class="item-detail-text">','<div class="item-detail-headline">',"object","keydown","width","height","100%","center","aborted","timeout","scroll","border-light","sending","Number",'computed=this.',"function","px","receiving","white",":","selected"," ","0px","style","&",")",'=value;',"#","abstract","default","pressed","other","keypress",'this.',"number",'"',"background","1*","boolean","on",'</span>',"abandoned","over","outset","overflow","inset",";","mousemove","init","borderTopWidth","absolute","configured","effect","borderLeftWidth","icon","minWidth","maxWidth","mixin","mouseover","maxHeight","minHeight","click","position","load","get","qx.event.type.MouseEvent","text","Color","CSS1Compat","reset","(","qx.io.remote.Response","error","off","_","scrollY",'if(this.',"locationY","qx.event.type.DataEvent","/","locationX",'}',"Enter","=","paddingTop","both","opera","properties","static/image/blank.gif","interval","paddingBottom","scrollX","]","keyup","inherit","input","appear","?","shorthand","paddingLeft",'delete this.',"*","mouseout","Object","unstyle","paddingRight","Theme","border-light-shadow","fixed","</span>","div","body","border-dark","id","changeChecked","created","unload","_applyHtml","{@link #",'!==undefined)',"interface","Left","Right","dblclick","ie4+","textAlign","button","text-field","appearances","filter","'","refresh","webkit","gray","changeValue","dragging","groove","qx.ui.popup.ToolTipManager","\n","qx.ui.menu.Manager","marginTop","normal","khtml","display","Space","0","marginLeft","color","methods","constructor","events","null","qx.ui.core.Widget","1px","label","qx.event.type.DragEvent","checked","border","qx.ui.popup.PopupManager","dotted","qx.event.type.FocusEvent","list",'">',"classes","double","%","overflowX","overflowY","widthComputed",'return this.','else if(this.',"whiteSpace","disabled","qx.event.type.KeyEvent","dashed","var","qx.resourceUri","A","outset-thin","black","heightComputed","inset-thin","text-selected","nodeName","ridge","queued","resize","_applyText","_applyChecked","hand","class",'</td>',"ellipsis","sym","left-reversed","field",'!==undefined){',"fontSize","marginBottom","list-view-content-cell-text","50%","$","lead","Up","justify","widget","barLeft","NumLock","this.","barBottom","contextmenu","transparent","Tahoma","constants","mousewheel","}","top-reversed","Liberation Sans","marginRight","_applyTextAlign",'=true;',"middle-reversed","center-reversed",'old=this.',"Lucida Grande",')',"text-disabled","Bitstream Vera Sans","horizontalAlignment",": ","button-abandoned","focus","barTop","border-box","iframe","-","dark-shadow","qx.ui.popup.ToolTip","verticalAlignment","_applyClip","barRight","Down","widget/arrows/down.gif","window-captionbar-button","e-resize","blur","_pane","safari2","Verdana","nowrap","only_plus","beforeunload","col-resize","date-chooser-title","_element","100px","focusin","lineHeight",'" onclick="',"value","Packages","_applyValue","down","methods-static","dragover","date-chooser","dragenter","_manager","_applyName","qx.ui.embed.IframeManager","Home","focusout","9","desc","This ","btn_private","_updatePanels","Interface","px;","static","changeShow","_applyIcon",'","',"qx.io.remote.XmlHttpTransport","</h2>","-moz-scrollbars-vertical","result","  ","Array","toggle",">","bold","table-header-border","location","Label","-moz-scrollbars-horizontal","visibility","n-resize","textarea","_timer","qx.io.remote.ScriptTransport","apiviewer.title","&nbsp;","widthType","{","i","btn_protected","tree","changeState",'typeof value === "number" && isFinite(value)',"pointer","'>","button-view-pane","qx.io.remote.IframeTransport","_applyState","Tab","event","atom","row-resize","only_minus","_applyEnabled","qx.ui.form.Button","PageUp","underline","qx.ui.menu.Menu","disappear","qx.event.handler.DragAndDropHandler","qx.ui.core.Parent","tree-folder","PageDown","=''","<h2>",'",value);',"heightType",'',"<","html","End","Classic","Mixin","apiviewer.dao.Node","changeSelection","+","packages","zIndex","Connection dropped","content","_childrenQueue","pre","_labelObject","_data","MozOutline","ICON_MIXIN","a","_compute","F1",'<p>',"treeClose","cursor","protected","list-view-header","Element","indexOf","Insert","ClassViewer","qx.application.Gui","Content-Type","progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",' title="',"ICON_EVENT","win","1px dotted invert","_blank","qqstr","nw-resize","F2","__init$",", ","superMixins","fontStyle",'api/image/open.gif','api/image/close.gif',"styleTop",'.togglePanelVisibility(','<div class="item-desc">',"plus","_applyLabel","F12","dragleave","log","borderBottomWidth","ICON_CLASS","parent","list-view","params","list-view-content-cell","}</td><td> Get the property value.","_PRIV","mshtml|webkit","changeText","F3","tab-view-border","widget/arrows/up.gif",":content-box;","up","meta","./resource","gecko|opera|webkit",'<div class="class-description">',"keyword","padding","nocache","tabIndex","changeSelected","F11","opacity","qx.ui.embed.Flash","linecomment","Search","Delete","styleRight","KhtmlOpacity"," is deprecated!","getMembers","api/image/nextlevel.gif","outline","_columns","styleLeft","_detailLoader","Windows","F4","Static ","windowresize","qooxdoo",":border-box;","no-cache","barVertical","MozUserSelect",'#',"line","F10","btn_inherited","execute","_classDescElem","backgroundRepeat","__"," Results (","clipHeight","italic","_invalidate",'  </div>',"colorRight","Assertion Failure","_PROT","detail_loader","line-bottom","</code>","_applySelected","Pragma","fontWeight",'if(old===computed)return value;',"check-box","_tree","KhtmlUserSelect","noComputed","F5","qx.ui.selection.RadioManager","Inheritance hierarchy:","ICON_METHOD_PRIV","]);","dragstart",'else ','<span class="objectBox-number">',"img","removeChild","treeOpenWhileEmpty","button-view-bar","colors","getClasses","class_viewer","character","tree-element-label","widthParsed","fullcomment","|","treeOpenWithContent",'";',"ICON_PACKAGE","<span class='","colorBottom","Escape","F6","tree-folder-icon","spinner-button","_classViewer","see","_packageViewer","DOMMouseScroll","_applyVerticalChildrenAlign","_applyWrap","widthBottom","[]","changeOpen",'undefined','</code>',"drag","qx.allowUrlSettings","cross","internal","first","qx.io.image.Preloader","colorTop","nl","ICON_CONSTANT","end","qx.jsonDebugging","http://","_applyHorizontalChildrenAlign","F7","-khtml-box-sizing","]\n","borderRightWidth","MozOpacity","0 none","qx.theme.ClassicRoyale","instances of ",'>',"popup","qx.enableAspect","Cache-Control",'<div>',"ne-resize","static/image/dotted_white.gif","margin","<code>","getConstants","request","_recompute","focused","package_viewer","dragdrop","F8","Deprecated:","ICON_","&#","(a[","backgroundImage",')">',"qx.io.remote.AbstractRemoteTransport","text/css","qx.allowUrlVariants","file:","F9","hasComputed","minus","styleBottom","widthRight","before","superInterfaces","verticalChildrenAlign","dragexit","toString","clipTop","qx.ui.pageview.AbstractPage","_classTreeNodeHash","menu-button","_ABSTRACT","g","qx.event.type.ChangeEvent","textOverflow","boxSizing","anchor","_PUB",'.$$properties.',"qx.log.appender.Native","button-view","fonts",'if(computed===undefined)computed=null;',"textDecoration","_applyElement","qx.ui.pageview.AbstractButton","draggesture","Function","fontFamily"," s)","widthTop","Margin","getStatics","v",":constructor","</p>","Padding","icons","types","backgroundColor","qxkey",'</h2>',"heightParsed","_blocker","getPackages","new","Invalid Search",".toggleShowItemDetails('","tooltip-text","getEvents","name","innerText","barHorizontal","Class","concat","tooltip","ICON_METHOD_PROT","qx.core.Object",'!(',"textContent","ICON_INTERFACE","_objects","PrintScreen",",'","Z","ignore","__user$","getProperties","readonly","return this.","_frame",'<img src="',"return","_iconObject","horizontalChildrenAlign","head","qstr","private","Abstract ","tree-folder-label","slice","getAppearances",'</table>',"is","tree-element-icon","qx.io.remote.Exchange","qx.event.handler.FocusHandler","_applyOrientation","[","WebkitUserSelect","qx.io.remote.Request","clipLeft",'@import "',"Singleton ","borders",'<h2 class="warning">',"onscroll","widgets","_titleElem","userSelect","();","widthLeft","ident","clipWidth","qx.client.NativeWindow",'if(old===undefined)old=null;','<div class="item-detail-error">',"colorLeft","',sizingMethod='scale')","-1000px"," API Documentation","_STATIC",'</p>',"lastIndexOf","list-view-header-border","classLinkClicked","tree-element","\r\n","_focusHandler","Border",'    * { box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box }',"_valueOriginalTarget","Pause","Internal:","legend","javascript:void(0)","qx.util.Normalization","Linux","_applyTimeoutInterval","This method is no longer needed since the event object is now an instance of the Response class.","borderBottomStyle","Font","Use proxy","Enable live search","apiviewer.ui.PackageViewer","qx.ui.pageview.buttonview.Button","qx.Interface","qx.ui.tree.TreeFolder",'value !== null && window.document',"Included from mixin:",'    <input id="marker" type="button" value="Add divider"/> &#160; &#160; Filter: <input name="filter" id="filter" type="text" value="',"qx.ui.form.TextField",')a[i].',"_applyFocusRoot","<span class='string'>","<div class='version'>qooxdoo ","Not implemented","localeCompare","}</td><td> Call apply method with the init value.","See also:",'    html, body, input, pre{ font-size: 11px; font-family: Tahoma, sans-serif; line-height : 1 }','var inherit=prop.$$inherit;',"Get alias:","Not modified","_applyLocale","styleFloat","apiviewer.ui.panels.MethodPanel","</a>","addAtEnd","_image","_ScriptTransport_data","pixelBottom"," (nightly)","_cachedVisibleChildren","api/image/cross.gif","removeAll","qx.html.Dimension","_applyFont","Use getValue() instead!","_applySpacing","Macintosh","_hideTimer","tab-view-pane"," - ","progress","Access:","ICON_BLANK","Gray() Alpha(Opacity=30)",'"/>',"__inherit$","changeBorderTheme","Use removeHtmlProperty instead",'\\\\',"_applySize","_box","qx.core.Log.debug","this.removeStyleProperty('padding","Partial content","qx.application.IApplication","MacPPC","quote","mode","ICON_CLASS_SINGLETON","qx.application","_applyColorBottom"," &nbsp;","qx.ui.splitpane.SplitPane","qx.Class","qx.logAppender","qx.ui.listview.ContentCellLink","qx.event.handler.EventHandler","Win32","qx.iconTheme","forEach","table-header","button-view-page","1.0",'  <div id="control">',"autoComplete",'<',"_iframe",' is not (yet) ready!");',"addAfter","changeElement","(measure start) ","Height","qx.version","qx.log.appender.Window","Method/Property/Event is inherited from one of the super classes","<h3>Protected Method</h3>",".js","_layoutChanges","changeParent","_applyMarginBottom","Documentation errors:","_applySelectable","_applyPreloader","radio-view-button-checked","qx.bom.element.Dimension","tab-view-button-checked","cursor:","line-left","extend","Pixel","_applyBackgroundImage","firefox","changeTextColor","borderBottom",'computed=value;',"qx.boxModelCorrection","TBODY",'<span class="item-detail-optional">'," WARN:  ",'Does not allow any arguments!',"__states",'return value;','\\f'," DEBUG: ","change","apiviewer.ui.LegendView","qx.ui.listview.ContentCellIconHtml","_horizontalLayout","changeAnonymous",'<td class="icon" ',"qx.locale.Manager","list-view-content-cell-image","tab-view-button","_applyOpen","toolbar-button","qx.io.image.Manager","OmniWeb","_applyMinHeight","ICON_PROPERTY_PRIV","[^\\.0-9]","ms","See other",'!',"-webkit-box-sizing","&lt;","ws","tree-icon","_columnData","_showTimer","qx.ui.basic.Inline","line-through","_list","void","lschecked",'if(!clazz.$$propertiesAttached)qx.core.Property.attach(clazz);',"changeActiveChild","U",']._autoCloseWindow()}catch(e){}">',"_applyShowInterval","var a=arguments[0] instanceof Array?arguments[0]:arguments;","qx.theme.classic.color.Royale","C","Bad gateway",'value !== null && value.$$type === "Mixin"',"_applyBoundToWidget","icon/16/places/folder.png","qx.ui.pageview.AbstractPane","qx.dom.Element","qx.ui.embed.IconHtmlEmbed","split","_applyBackgroundRepeat","Log window message: Starting error recording, any errors below this line will prevent the log window from closing",'=computed;',"qx.ui.popup.Popup","Type","getConstructor","qx.io.Alias","<hr/>","_applyBottom",'px',"list-view-header-cell-arrow-up","_valueRelatedTarget","_spans",":constructor wrapper","_applyRootOpenClose","Show inherited items.","qx.ui.listview.ContentCellHtml",'value !== null && value.$$type === "Interface"',"_scroll","descending","qx.Mixin","_applyBorder","beforeAppear","_applyRight","Use qx.Class.define instead","__cache","_check","window-inactive-caption-text","o","_indentObject","property","qx.ui.layout.BoxLayout","_applyMaxHeight","Galeon","force","after",";vertical-align:top","userFocus","widget/splitpane/knob-horizontal.png","Check:","parentPaddingBottom","Control","qx.lang.Generics","qx.ui.basic.ScrollBar","8","warn","api/css/apiviewer.css","changeLeadItem",'  <div id="lines">',"6","client-document-blocker","push","qx.core.Log.error","qx.log.DefaultFilter","list-view-border","<a target='","Log window message: Stopping error recording, discarding ","}</td><td> Check whether the property equals <code>true</code>.",'</a></span>',"_selectedItems","hasOwnProperty","Inherited","qx.ui.basic.Image",')"/>',"changeSortOrder","Unidentified","list-view-header-cell-hover","_atom","_icons","Request-URL too large","_spacer","Not acceptable","toolbar-part-handle-line",'<a href="','_treeRowStructureFields',"radio-view-bar",'typeof value === "number" && isFinite(value) && value%1 === 0',"_knob","; ",'!(value instanceof ','value !== null && qx.theme.manager.Font.getInstance().isDynamic(value)',"qx.html.Scroll","html,body { margin:0;border:0;padding:0; } ","Information","_applyStretchChildrenOrthogonalAxis","<img style=\"position:absolute;top:0px;left:","pixelHeight","qx.ui.pageview.AbstractBar"," !important","_lastMouseDownDispatchTarget","<ul><li>",") ",'(backup);',"_applyFirstSize","[Mixin ","__all","qx.jsonEncodeUndefined","_applyFocused","lines","Init value:","qx.ui.tree.Tree",'if(computed===inherit){',"qx.log.Filter","_scrollBar","Connection closed by server","native",", Column:","apiviewer.ui.panels.PropertyPanel",'<h3',"_applyVerticalSpacing","tab","borderTop",'<body onload="qx = opener.qx;" onunload="try{qx.log.WindowAppender._registeredAppenders[',"sort","verticalAlign","qx.dev.Tokenizer","api/image/class18.gif",'  </style>',"_applyId","scrollbar-blocker","this.length = 0;","_applyPaddingTop","button-view-button","The property is a property group.","qx.ui.core.Font","qx.ui.layout.impl.LayoutImpl",';}',"qx.deprecationWarnings","qx.fontTheme","\\\"","unshift","HTTP version not supported","list-view-header-separator",'!==undefined&&',"iconSelected","qx.core.Log.info","Null","changeFont","_applyOverflow","<span>","radio-view-pane",'<iframe name="','value instanceof Date',"/static","getSuperMixins","borderLeftStyle","</td></tr></table>","bold-large","7","__convertBoolean","qx.aspects",'if((computed===undefined||computed===inherit)&&','character',"_applyHideInterval","_applyReadOnly","BODY","Bitstream Vera Sans Mono","qx.ui.form.InputCheckSymbol","_applySource","width:",'(value);',"Value",'<table cellspacing="0" cellpadding="0" class="info" width="100%">',"apiviewer.ui.panels.ConstantPanel","apiviewer.dao.State","<span class='ident'>","changeHtml","qx.OO","</code>, <code>","changeColorTheme"," errors have been recorded, keeping log window open.</b>","a=qx.lang.Array.fromShortHand(qx.lang.Array.fromArguments(a));","(passed time: ",">>> ",'_labelObject','<span class="objectBox-function">',"last","_resetRuntime",'\\u00',"_handle","splitpane-knob","Moved temporarily","_applyButton",'<td class="type">','    hr { border: 0 none; border-bottom: 1px solid #ccc; margin: 8px 0; padding: 0; height: 1px }',"apiviewer.MWidgetRegistry",'\\r',"substring","_history","deprecated","#D6D5D9","[object Error]","qx.ui.pageview.buttonview.ButtonView","anonymous","match",'<code>',"https://","CLASS","icon/16/status/folder-open.png","safari",'value !== null && value.$$type === "Class"',"_applySortBy","_applyAutoSync","<span style=\"text-decoration:underline\">","  at ","Scroll","The property value can be set using appearance themes.",'typeof value === "string" && qx.util.ColorUtil.isValid(value)',"wait","_THEMEABLE",'var a=this.getChildren();if(a)for(var i=0,l=a.length;i<l;i++){',"qx.ui.layout.impl.VerticalBoxLayoutImpl","apiviewer.dao.Package",'<span class="separator">,</span> ',"./script","debug","_applyAppearance","_itemName","Refined property:","_styleProperties","qx.ui.listview.Header","_applyOpacity","qx.html.Offset","widget/window/restore.gif","reverseChildrenOrder",",height=","qxvariant",'if(mixins[i].$$constructor){mixins[i].$$constructor.apply(this,arguments);}}}',"Alpha(Opacity=","check-box-group-box-legend","viewer","<div style='float:left;width:","item-private","charAt","_applyBorderTheme","any ","\\$1","parentPaddingRight","_applyZIndex","')","Inherited from:","tab-view-button-hover","_aliases","This method call is no longer needed.","px\" src=\"",'var backup=computed;',"_applyPaddingLeft","<h3>Constant</h3>","qx.core.LegacyProperty","OVERLAY_MIXIN","true","_lastUpDownType",'for(var i=0,l=mixins.length;i<l;i++){',"_applyFontTheme","Please use getKeyIdentifier() instead.","_applyTabIndex",'if(this.classname===',"start_plus","changeAppearance","_rowData","qx.debug",'if(value!==inherit)',"changeBarPosition","cached","qx.net.Http",'if(a[i].',"(!this.","font-size:",'<small>',"MSXML2.XMLHTTP.4.0","qx.locale.LocalizedString","4","changeBackgroundColor","changeRight","[Interface ","please use getText() instead.","_translationCatalog","static/stringbuilder/helper.html","qx.theme.manager.Color","splitpane-slider","remove","borderTopStyle","stylesheet","__useinit$","#ffbfbc",'Undefined value is not allowed!',"qx.bom.element.Style",'\\b','Is invalid!',"apiviewer.ObjectRegistry","colorInnerBottom","qx.ui.layout.impl.DockLayoutImpl","netnewswire","qx.ui.layout.HorizontalBoxLayout","qx.theme.classic.Widget","&#160;","': ","&gt;","</td><td class='text'>","client-document","borderRightStyle","qx.ui.listview.ContentCellImage","X-Qooxdoo-Response-Type","widget/cursors/copy.gif"," (r","apiviewer.initialTreeDepth",'</span></td>',"widget/menu/checkbox.gif","_markerBtn","ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=","_applyMaxLength","Firefox","-moz-box-sizing","_showTimeStamp","_applyShowKnob","SplashScreen","qx.lang.Core","_htmlAttributes",'){',"qx.minLogLevel","anonymous: ","MozBoxSizing"," (#","changeSource","Use getUseDoubleClick instead","units: ","<h3>Private Property</h3>","Set alias:","0.0","info","__convertNumber","Implemented interfaces:","__onmouseevent","apiviewer.ui.SearchView","PACKAGE","=((v==null)?0:v)+'px'","_valueDomEvent","qx.io.remote.RequestQueue","_applyColorInnerBottom","qx.ui.toolbar.CheckBox",' style="position:absolute;top:0px;left:0px" src="','<div _itemName="',"_applyLeft","_applyAnchorItem","_borderElement","tool-tip","ls","[object ","qx.appearanceTheme","Server timeout","__onwindowblur","clip","Mozilla","Log window message: <b>Note: ","ICON_PROPERTY_PUB_THEMEABLE",'</span></td></tr>',"\"/>","/widget/Windows",'var prop=qx.core.Property;',"changeBottom","_docNode","width=500,height=250,dependent=yes,resizable=yes,status=no,location=no,menubar=no,toolbar=no,scrollbars=no",'<table>',"widget/table/selectColumnOrder.png","ICON_APPEARANCE","beforeDisappear",'if(clazz.$$includes){var mixins=clazz.$$flatIncludes;',"_layoutImpl","INTERFACE","5","_cached",'<span class="selectorId">#',')prop.error(this,5,"',"qx.theme.manager.Icon","Windows Royale","qx.core.Version","toLocaleUpperCase","return this.join('');",'\", "',"qx.ui.listview.ContentCellText","&nbsp;&nbsp;","</table>","Show options","Width","qx.theme.manager.Border","widget/window/minimize.gif","pixelWidth","qx.ui.embed.TextEmbed","qx.log.Logger","__convertObject","sinput","pixelRight","  [not readable: ","4*","ae","explorer","_computed","_applyTheme","0x","api/image/blank.gif","_requestHeaders"," ms) ","_applyPage","qx.ui.toolbar.Part","omniweb","addAt","</span>: ","))",'!==inherit){',"changeFocused","changeTheme","qx.eventMonitorNoListeners","Classic Royale",'X',"end_minus","CapsLock","widget/menu/radiobutton.gif",'value !== null && (qx.locale.Manager.getInstance().isDynamic(value) || typeof value === "string")',"_fields",'title="',"_applyIconWidth","_lastMouseEventDate","_queue","_applyGlobalCursor","_applyStyleBottom","sub classes","MaxWidth","image","valueOf","_applyInterval","_bodyElement","galeon","_titles","join","removeDom","controller","Required by:","qx.html.StyleSheet","_appenderArr","AppleWebKit","Legacy properties are deprecated","Use setHtmlProperty instead","Allowed values:","_remappingChildTable",'api/image/',"iconHtml","qx.ui.listview.HeaderCell","qx.ui.core.ClientDocument","qx.util.manager.Object","right-reversed",'apiviewer.ui.ClassViewer.instance._onSelectItem(\'',"toolbar-part-handle"," or sub classes","other gecko","qx.ui.layout.impl.GridLayoutImpl","Private","qx.util.Compare",'<td class="toggle">','<div class="info-panel"><h2>',"Percent","_applyBackgroundColor","combo-box-button","qx.colorTheme",'.classname)this.$$initialized=true;',"_applyResponseType","widget/arrows/next.gif","_valueData",'//','else{',"qx.ui.listview.ContentCell","qx.core.Init"," (default: ","Ae",'<span class="selectorTag">',"apiviewer.ui.PackageTree","2","Conflict",'#lines { width: 100%; height: expression((document.body.offsetHeight - 30) + "px"); }',"changeCapture","_markedElement","map","O",'var computed, old=this.','value !== null && value.nodeType !== undefined',"add","_filterArr","The property value can be inherited from a parent object.","widget/window/close.gif","apiindex","<span class='comment'>"," <br/>","rgb(","$1#$2","header",'computed=undefined;delete this.',"RealPlayer",'px;height:',"Apps","<h3>Package</h3>","font-style:","qx.core.Log.assert","_applyMarginTop","Microsoft.XMLHTTP",'return retval;',"_applyVisibility","splice","<h1>","_INHERITED","_applyMaxWidth",'typeof value === "string"',"divider-vertical","static/history/helper.html","changeZIndex","qx.theme.classic.font.Default",'if(value!==null)',"--- Object: ","application/x-www-form-urlencoded",'typeof value === "string" && value.length > 0',"Legend","MIXIN","_WARN",'&gt;</div><div class="nodeChildren">',"<h3>Interface</h3>","Unknown status code","create","Not available","_inlineEvents",")+;)|[^&","_applyIconTheme","_applyWidthRight","qx.lang.Object","_window","changeLocale","static methods","_applyHorizontalSpacing",'throw new Error("Property ',"<h3>Singleton Class</h3>",'value !== null && qx.theme.manager.Border.getInstance().isDynamic(value)',"MacIntel","No content","_applyFocusHandler","form","qx.core.Log.log","Top","qx.ui.tree.TreeFile","qx.core.Log.warn","command","__convertString","</div><span style='float:left'>&hellip;</span>","_applyMnemonic","Protected","_applyDisplay","_document","Meta","windowblur","sub interfaces","_attachedWidget",'<span class="parameter-type">',"qx.ui.tree.SelectionManager","Generated methods:","__user$excludeSpecificTreeLines","start_minus","_header",'<span class="parenthesis">)</span></span>',"mozBoxSizing","Creates a new instance of ","form_","qx.dom.String","ue",'/>',"table-pane","</li><li>","unix","3","changeFontTheme",'<span class="objectBox-null">',"body {}","Change event:","search","qx.core.Aspect","window-active-caption"," errors.","mac","qx.ui.core.Border",'Requires exactly one argument!',"_divDataSets","apiviewer.ui.panels.InfoPanel","toolbar","widget/window/maximize.gif","Win",'if(value===null)prop.error(this,4,"',"_widget","_applyManager","_secondArea","Parsed","_previousParentFolder","qx.bom.Document",'Basic ',"qx.ui.toolbar.ToolBar","<h3>Abstract Class</h3>",'<html><body><div id="state">','(','value !== null && value.$$type === "Theme"',"_lastKeyCode",'    pre { margin: 0; padding: 4px 8px; font-family: Consolas, "Bitstream Vera Sans Mono", monospace; }',"_docTree","MSIE","_MIXIN","Forbidden","qx.html.Entity","_applyCaptureWidget","Object<br/>","script/apidata.js","_lastMouseDown","widthValue",'</span>=&quot;<span class="nodeValue">',"}</td><td> Toggle the property value.","cssFloat","toolbar-part","item-deprecated","qx.ui.tree.TreeRowStructure",'Referer','!(value && qx.Class.hasInterface(value.constructor, ',"Courier New","real","qx.ui.basic.Label","\" style=\"vertical-align:middle;",".gif","qx.ui.basic.ScrollArea","Use getUseTreeLines instead","[Theme ",':',"Proxy authentication required","apiviewer.ObjectRegistry.getObjectFromHashCode(","qx.ui.popup.PopupAtom","apiviewer.dao.Method","beforeInsertDom","_applyAutoCloseWithErrors",')"/> ',"qx.io.image.PreloaderSystem","Use getHideNode instead","qx.html.EventRegistration","_innerStyle","qx.ui.embed.LinkEmbed","icon/16/actions/document-new.png","please use setText() instead.",")+>)|(&([^;]|","qx.bom.element.Location","Ue","_applyStyleRight",'===value)return value;',"-1","Object is null","_applyMenu","apiviewer.ui.panels.EventPanel","<html><head><title>","_splitter","=[not readable: ","end_plus","_OVERRIDDEN"," in method ",'<img class="openclose" src="',"qx.ui.basic.Terminator","_applyColorRight","_applyWidthBottom","getSuperInterfaces",'if(value===undefined)prop.error(this,2,"',"_oldParent","_applyItalic","widget/splitpane/knob-vertical.png","_applySplitterSize",'value=this.',"api/image/vline.gif","splitpane-splitter","_formFields","toolbar=no,scrollbars=no,resizable=yes,","sub mixins","widget/cursors/move.gif",'<span class="objectBox-selector">',"<tr><td class='icon'>","qx.ui.selection.SelectionManager","_active","qx.ui.tree.AbstractTreeElement","MSXML2.XMLHTTP.3.0","_applyHideFocus","progid:DXImageTransform.Microsoft.Shadow(color='Gray', Direction=135, Strength=4)"," messages removed)","qx.ui.embed.HtmlEmbed","_applyLeadItem","bottom-reversed",'<span style="display:inline-block;display:inline;padding-right:18px;position:relative;top:-2px;left:0;width:',"commandLine","_applyImplementation","qx.core.Log.dir","qx.core.MUserData",'value instanceof RegExp',"_logEventQueue","qx.event.type.DomEvent","<pre>Could not execute json: \n","__ondragevent","apiviewer.dao.Property","_valueOldValue","ascending","changeEnabled","_applyLoaded","verticalSpacing","())","_applyParent","qx.core.Variant","qx.core.Target","&quot;",'<tr class="',"<div class='item-detail-text'><code>","width:18px","qx.net.HttpRequest","/source/class/","__listeners","beforeRemoveDom","addBefore","frame_","_applyMarginLeft","Request entity too large","</td></tr>",'<small>package</small>',"qx.html.Location","Gecko","qx.log.LogEventProcessor","pixelTop","&#39;","_applyBarPosition",' of an instance of ',"_config",'</small>',"_firstArea","qx.theme.classic.Border","text-decoration:","<h3>Public Property</h3>","_applyShow","_applyFocusedChild","Method/Property is included from a mixin","Apply method:","_SINGLETON",'<div class="objectBox-element">',"changeWidth","apiviewer.dao.Class","Implementations of this interface:","qx.ui.listview.HeaderSeparator","apiviewer.Viewer","widget/table/ascending.png","widget/cursors/alias.gif",'open.gif','\'); return false;"',"_parentLogger",'    #lines{ top: 30px; left: 0; right: 0; bottom: 0; position: absolute; overflow: auto; }',"_infoPanelHash","<h3>Class</h3>","ICON_METHOD","OVERLAY_ERROR","qx.lang.Array","_applyColorLeft","Show protected items.","#134275 url(","qx.ui.basic.Atom","qx.ui.splitpane.SplitPaneSplitter","toLocaleLowerCase","changeFocusedChild","KDE",'<td class="text">',"Parameters:","_children","qx.ui.splitpane.SplitPaneKnob","apiviewer.dao.ClassItem","&amp;","_applyMethod","_modify","</title></head>","every","\\\\","list-view-header-cell-arrow-down","addChild","changeValidator","__font","qx.util.Mime"," <span class='item-detail-define'>defined by ",'<td class="propertyNameCell"><span class="propertyName">'," is internal!","__convertFunction","<table cellpadding='0' cellspacing='0'>","_change","box-sizing","list-view-content-cell-icon-html","_applyIconPosition","changeDisplay","_classLoader","_applyWidth","_applyColorInnerRight",'/&gt;</div>',"changeMaxHeight","qx.ui.window.Window","Consolas","qx.locale.MTranslation","changeMinHeight","apiviewer.dao.Event",'return null;',"unselectable","Find","qx.ui.layout.CanvasLayout","_remappingChildTarget","$1~$2","1","_applyWidgetTheme","<br>","html { border:0 none; } ",'\\n',"dir","', ((v==null)?0:v)+'px')","_value",'_indentObject',"qx.preloaderTimeout","shift","qx.theme.manager.Appearance","parentPaddingLeft","<h3>Private Method</h3>","_arrowdown","addAtBegin","org.w3c.dom.svg","Current stack trace","qx.ui.pageview.buttonview.Pane",'Null value is not allowed!',"apiviewer.ui.ClassViewer","ordered","pixelLeft","qx.ui.listview.SelectionManager","qx.util.StringBuilder","file://","qx.event.handler.KeyEventHandler","Alt","qx.client.History","Request time-out","Bad request","qx.ui.layout.GridLayout","Backspace"," with incoming value '","PUB","link",'Could not change or apply init value after constructing phase!',"Hide options",'</span> <code>',"new Date(Date.UTC(","__convertUndefined","apiviewer.dao.Param","javascript","qxsetting","_data_","orientation","changeOverflow",'<h1><small>please wait</small>Loading data...</h1>',"list-view-content-cell-html","__stateMap","keyinput",'value instanceof Function',"_htmlProperties","...","__intervalHandler","<img src=\"","Method/Property/Event is not fully documented","The property refines the init value of an existing property.","_req",'<h1></h1>',"qx.log.appender.FireBug","</li></ul>","parseerror","_valueCurrentTarget","fast","qx.core.Log.dirxml","dragend","__oninput","_applySpellCheck","80%","width=","toLowerCase",'<span class="objectBox-string">&quot;',"list-view-header-cell"," of class ",") top left repeat-x","cross_plus","_applyMinWidth","qx.client.Command","\" />","Multiple choices","Win64","changeIconTheme","_applyCommand","/icon/Nuvola","qx.html.Iframe",'Authorization','", computed, old);',"borderRight",",top=","widget/cursors/nodrop.gif",'" alt="',"_resizeLine","1px 0",'value !== null && typeof value === "object"','value instanceof Array',"qx.ui.splitpane.HorizontalSplitPane","States:","_applyAlwaysShowPlusMinusSymbol",'<tr>',"OVERLAY_WARN","__visible","apiviewer.ui.panels.AppearancePanel","qx.ui.layout.impl.HorizontalBoxLayoutImpl","_infoPanels","_filterTextWords",",left=","qx_log_","_applyTextColor",'&nbsp;<span class="nodeName">',"__manager","_applyColorInnerTop","utf-8","_applyMaximum","} ","MozUserFocus","qx.theme.manager.Widget","item-protected","_applyMarginRight","_applyStyleLeft",'</div></body></html>',"</code><p>","Flex","}</td><td> Reset the property value.","font-family:","PROT","Overrides:","_applyHeight","qx.core.Log","_lastMouseEventType","qx.theme.icon.Nuvola",'    html, body{ padding: 0; margin: 0; border : 0 none; }',"_modalNativeWindow","_isErroneous","[Class ","resizer","_applyWidthTop","_style","changeLeft","_valueDomTarget","</div>","changeTop","api/image/open.gif","changeAnchorItem","<h3>Event</h3>","menu","__onselectevent","Payment required","font-weight:","ICON_PROPERTY_PUB","height:","_bar",'if(computed===undefined||computed===inherit){','</span>&quot;','</h3>','<span class="objectBox-object">',"__button","this.setStyleProperty('padding","windowfocus","BSD","qx.core.Log.clear","qx.Theme","gif","Date","heightValue","_applyHideNode","_applyUseTreeLines","_valueValue","Moved permanently","OVERLAY_","</h1>","qx.ui.toolbar.MenuButton","_parameters",'&quot;</span>',"qx.util.Validation","apiviewer.dao.Appearance","qx.util.ColorUtil","_valueTarget","_applySortOrder","./script/apiindex.js","changeName","borderLeft","cross_minus","api","apiviewer.dao.Constant","qx.ui.listview.ListViewPane"," INFO:  ","_applyTop","Classes including this mixin:","script",'_iconObject',"changeGlobalCursor",'<img','</h2><div></div></div>',"()","MSHTML-specific HTTP status code","toUpperCase",'var pa=this.getParent();if(pa)computed=pa.',"_dynamic"," | "," logRow-","reverse","construct","changeHeight","ss","X-Requested-With","return this.length === 0;","}</td><td> Set the property value.","qx.theme","qx.ui.selection.Selection",' style="',"insertDom","Server error","oe","_applyFamily","stretchChildrenOrthogonalAxis","empty","_ScriptTransport_","qx.borderTheme","ICON_CTOR",'value !== null && value.type !== undefined',"Error: Could not get a reference to the sheet object"," (default appearance of the class)","qx.ui.listview.ListView",'value !== null && value.nodeType === 1 && value.attributes',"Not found",'value !== null && typeof value === "object" && !(value instanceof Array) && !(value instanceof qx.core.Object)','(computed, old);',"qx.ui.pageview.AbstractPageView","horizontalSpacing",'()</span>','value !== null && value.nodeType === 9 && value.documentElement',"Gone","replace","#FFEEEE","</td></tr><tr><td>","\n</pre>","Unauthorized","_applyPaddingBottom","qx.ui.pageview.buttonview.Page","table-header-cell",".apply(this._remappingChildTarget, arguments)","_registry","*{","qx.ui.toolbar.PartHandle","Included mixins:","<h3>Static Class</h3>","qx.log.MLogging",'old=computed=this.',"_applyColorTheme","ICON_METHOD_PUB","qx.core.Client","MSXML2.XMLHTTP","qx.ui.pageview.buttonview.Bar","qx.theme.manager.Meta","changeSpacing",' </span>',"_applyIconHeight",'&lt;<span class="nodeTag">',"Package/Class/Mixin/Interface is not fully documented","removeAt","shiira",'===undefined)return;',"_applyActiveChild","substr","MaxHeight",'<span class="selectorClass">.','\\t',"_modalWidgets","<br />\n",'</div><div class="objectBox-element">&lt;/<span class="nodeTag">',"qx.dom.Node","_applyCursor","__storage","changeVisibility","colorInnerTop","realplayer","other webkit","px;overflow:hidden;white-space:nowrap'>","splitpane","_lastMouseDownDomTarget","_isPng","Show private and internal items.","apiviewer.Application",'close.gif',"abstract ","mixins","_applyUseAdvancedFlexAllocation","dirxml","Method/Property overrides the Method/Property of the super class"," ---\n","Line: ","qx.html.String",'))',"button-hover","_filterInput",'var retval=clazz.$$original.apply(this,arguments);',"camino",'    #control { top: 0; left: 0; right: 0; padding: 4px 8px; background: #eee; border-bottom: 1px solid #ccc; height: 30px }',"errors","item-internal","filter:","ICON_PROPERTY_PROT","list-view-pane","qx.ui.core.ClientDocumentBlocker"," ERROR: ","widget/arrows/down_small.gif","divider-horizontal","u","margin-left:","activeX","qx.client.Timer","[object Object]","<h3>Themeable Property</h3>","qx.lang.Function","Out of resources","_widgetRegistry","qx.dev.StackTrace","qx.core.Setting","line-right","This property allows 'null' values","Liberation Sans Mono","<h3>Mixin</h3>","_globalCursorStyleSheet","constant",'\\"',"widget/table/descending.png"," (","Oe","/static/log/log.html","margin-right:","Method not allowed","_applyAppearanceTheme","Returns:","content-box","Ok",'if(',"marked","int",'value instanceof Error','anonymous',"ICON_CLASS_STATIC","Unsupported media type","qx.core.Property","Precondition failed","changeMenu","__borderObject","_form","__theme$","Error in property ","type","_applyProhibitCaching","_applyType","MinWidth","this._style.","interfaces","_applyExcludeSpecificTreeLines","Apply method of property:","tree-label",'<h3 style="text-decoration: line-through;color: #7193b9">deprecated</h3>',"_applyStyleTop","marker",'"></iframe>',"PRIV","' href='","Gateway time-out",'else if(computed===undefined)',' onclick="',"qx.core.Log.timeEnd","_hideTimeStamp","qx.widgetTheme","spacing","X-Qooxdoo-Version","-moz-scrollbars-none",'else this.',"_applySecondSize","visible","Bottom","initial","qx.core.Log.time","colorInnerLeft","large","_applyDocNode",'" class="img"'," FATAL: ","Safari","hideFocus","ICON_METHOD_PUB_INHERITED","Direct ","MSXML2.XMLHTTP.6.0","_applyDisabledIcon","_applyPaddingRight","changeBorder","apiviewer.Controller",'<span class="type">','&gt;</span></div>',"en","__userData",'<span onclick="',"Length required","_applyWidthLeft","--- End of object ---","qx.isSource","_logLinesDiv","logRow","states",'var clazz=arguments.callee.constructor;',"_inputElement","__onwindowresize","legacy","window-active-caption-text","ICON_CLASS_ABSTRACT","apiviewer.ui.panels.PackagePanel","changeMinWidth",'var computed, old;','}else{',"Value: ",'</tr>',"_isCreated",'<td><span class="propertyValue">',"window-inactive-caption","<h3>Protected Property</h3>","qx.util.manager.Value","qx.core.Bootstrap","toLocaleString","parentPaddingTop","_slider","horizontalAlign","qx.enableApplicationLayout","_jobQueue","some",'</body></html>',"_containerObject","widget/arrows/up_small.gif","qx.io.Json",'<span style="white-space: nowrap;">','</small>API Documentation</h1>',"OVERLAY_OVERRIDDEN","qx.ui.toolbar.Button",'typeof value === "boolean"',"changeDirection","charCodeAt","Package","qx.theme.classic.Appearance","])*)(","<table><tr><td>","apiviewer.ui.AbstractViewer","qx.lang.Number","box","[\xE4\xF6\xFC\xDF\xC4\xD6\xDC]","qx.ui.layout.DockLayout","changeTabIndex","qx.lang.String"," - class ","_renderRuntime","_applyCapture","_appender",'.checkMap[value]===undefined','.check.call(this, value)',"Nuvola","overline","qx.html.ScrollIntoView","apiviewer.TreeUtil","_titleElement","_applyReverseChildrenOrder","_applyDecoration","qx.widgetDebugId","Property attributes:","rect(","colorInnerRight","_isLoaded","api/image/colorstrip.gif","_applyCurrentToolTip","_items","__onwindowfocus","qx.ui.layout.VerticalBoxLayout","Camino","konqueror","Auto","table-header-cell-hover","pop","BackgroundImageCache","isPrototypeOf","qx.ui.form.CheckBox",'<span class="method-signature"><span class="parenthesis">(</span>',"X11","NetNewsWire","qx.compatibility","_applyColorInnerLeft","apiviewer.ui.panels.ClassPanel","apiviewer.ClassLoader","^(((<([^>]|","qx.bom.Viewport","<h3>Public Method</h3>","url(","img{","_ScriptTransport_id","_applyBold","changeWidgetTheme",'    <pre id="log" wrap="wrap"></pre>','this.createDispatchChangeEvent("',"Shift","_applyColorTop","html,body{width:100%;height:100%;overflow:hidden;}","changeOpenMenu","OVERLAY_INHERITED","qx.log.appender.Abstract","qx.html.Style","list-view-content-cell-link","ICON_PROPERTY","_scrollContent","qx.locale.Locale","_checkValue","useAdvancedFlexAllocation","return this._remappingChildTarget.","changeOrientation","_ERROR","__oninterval","vertical-align:top","qx.ui.basic.HorizontalSpacer","Shiira","qx.theme.manager.Font","changeMaxWidth","MinHeight","qx.ui.splitpane.SplitPaneSlider","qx.io.image.PreloaderManager","apiviewer.resourceUri","table-focus-indicator","state","qx.ui.layout.impl.CanvasLayoutImpl","_commands","_applyMode","s",'<h1><small>','  <style type="text/css">','<div class="nodeText">',"</p></div>","monospace","changeAppearanceTheme"," [","_arrowup"];if(!window.qxsettings)qxsettings={};
if(qxsettings["qx.resourceUri"]==undefined)qxsettings["qx.resourceUri"]="./resource/qx";
if(qxsettings["apiviewer.resourceUri"]==undefined)qxsettings["apiviewer.resourceUri"]="./resource/apiviewer";
...
if(!Error.prototype.toString||Error.prototype.toString()==$[1072]){Error.prototype.toString=function(){return this.message;
};
...
}if(!String.prototype.quote){String.prototype.quote=function(){return $[67]+this.replace(/\\/g,
$[1658]).replace(/\"/g,
$[1010])+$[67];
};
}
...
__init:function(){if(window.qxsettings){for(var $0 in qxsettings){if(($0.split($[24])).length<2){throw new Error('Malformed settings key "'+$0+'". Must be following the schema "namespace.key".');
}
if(!this.__settings[$0]){this.__settings[$0]={};
...
__loadUrlSettings:function(){if(this.get($[538])!=true){return;
}var $0=document.location.search.slice(1).split($[56]);
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1].split($[51]);
if($2.length!=3||$2[0]!=$[1733]){continue;
}var $3=$2[1];
if(!this.__settings[$3]){this.__settings[$3]={};
}this.__settings[$3].value=decodeURIComponent($2[2]);
}}},
defer:function($0){$0.define($[538],
false);
$0.define($[582],
false);
$0.define($[208],
...
__loadUrlVariants:function(){if(qx.core.Setting.get($[582])!=true){return;
}var $0=document.location.search.slice(1).split($[56]);
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1].split($[51]);
if($2.length!=3||$2[0]!=$[1107]){continue;
}var $3=$2[1];
...
if($1.indexOf($[516])<0){$3=this.get($0)===$1;
}else{var $4=$1.split($[516]);
for(var $5=0,
...
__isValidArray:function($0){return typeof $0===$[34]&&$0!==null&&$0 instanceof Array;
},
__isValidObject:function($0){return typeof $0===$[34]&&$0!==null&&!($0 instanceof Array);
},
...
defer:function($0){$0.define($[1141],
[$[71],
$[105]],
$[71]);
$0.define($[2177],
...
$1,
$2,
$3){if($0!=$[589]&&$0!=$[916]){throw new Error("Unknown position: '"+$0+"'");
}this.__registry.push({pos:$0,
type:$1,
re:$2,
fcn:$3});
}},
defer:function(){qx.core.Setting.define($[560],
false);
}});
...
/* ID: qx.core.Client */
qx.Class.define($[1941],
{statics:{__init:function(){var $0=window.location.protocol===$[583];
...
var $e=null;
var $f;
if(window.opera&&/Opera[\s\/]([0-9\.]*)/.test($1)){$7=$[118];
$8=RegExp.$1;
$6=$[118];
$8=$8.substring(0,
3)+$[24]+$8.substring(3);
$d=$1.indexOf($[1487])!==-1?$[20]:$1.indexOf($[1233])!==-1?$[31]:null;
}else if(typeof $2===$[10]&&$2===$[1647]&&/KHTML\/([0-9-\.]*)/.test($1)){$7=$[174];
$6=$[2167];
$8=RegExp.$1;
}else if($1.indexOf($[1320])!=-1&&/AppleWebKit\/([^ ]+)/.test($1)){$7=$[164];
$8=RegExp.$1;
$e=$8.indexOf($[374])!=-1;
var $g=RegExp($[850]).exec($8);
if($g){$8=$8.slice(0,
$g.index);
}
if($1.indexOf($[2075])!=-1){$6=$[1080];
}else if($1.indexOf($[847])!=-1){$6=$[1285];
}else if($1.indexOf($[2210])!=-1){$6=$[1951];
}else if($1.indexOf($[2176])!=-1){$6=$[1173];
}else if($1.indexOf($[1376])!=-1){$6=$[1966];
}else{$6=$[1967];
}
if($e){$6+=$[749];
}}else if(window.controllers&&typeof $3===$[10]&&$3===$[1606]&&/rv\:([^\);]+)(\)|;)/.test($1)){$7=$[31];
$8=RegExp.$1;
if($1.indexOf($[1192])!=-1){$6=$[822];
}else if($1.indexOf($[2166])!=-1){$6=$[1987];
}else if($1.indexOf($[914])!=-1){$6=$[1312];
}else{$6=$[1334];
...
var $q=false;
var $r=false;
if($4.indexOf($[461])!=-1||$4.indexOf($[788])!=-1||$4.indexOf($[1771])!=-1){$o=true;
$n=$[402];
}else if($4.indexOf($[757])!=-1||$4.indexOf($[776])!=-1||$4.indexOf($[1419])!=-1){$p=true;
$n=$[1463];
}else if($4.indexOf($[2175])!=-1||$4.indexOf($[714])!=-1||$4.indexOf($[1849])!=-1){$q=true;
$n=$[1453];
}else{$r=true;
$n=$[63];
}var $s=false;
...
var $v=false;
if($7==$[20]){$s=true;
}if(document.implementation&&document.implementation.hasFeature){if(document.implementation.hasFeature($[1706],
$[793])){$t=$u=true;
}}this._runsLocally=$0;
this._engineName=$7;
this._engineNameMshtml=$7===$[20];
this._engineNameGecko=$7===$[31];
this._engineNameOpera=$7===$[118];
this._engineNameKhtml=$7===$[174];
this._engineNameWebkit=$7===$[164];
...
}if(!$1.hasOwnProperty($[819])&&!$1.type){$1.type=$[311];
}{};
...
genericToString:function(){return $[1824]+this.classname+$[124];
},
...
$6.basename=$c;
if(!$6.hasOwnProperty($[593])){$6.toString=this.genericToString;
}
...
}if($3.init!==undefined){$0.prototype[$[408]+$5]=$3.init;
...
genericToString:function(){return $[975]+this.name+$[124];
},
__registry:{},
__allowedKeys:null,
__validateConfig:function(){}}});
...
for(var $5 in $3){if(typeof $3[$5]===$[47]){if(typeof $4[$5]!==$[47]){throw new Error('Implementation of method "'+$5+'" is missing in class "'+$0.classname+'" required by interface "'+$1.name+'"');
}if($2===true&&!qx.Class.hasInterface($0,
$1)){$4[$5]=this.__wrapInterfaceMember($1,
$4[$5],
$5,
$3[$5]);
}}else{if(typeof $4[$5]===undefined){if(typeof $4[$5]!==$[47]){throw new Error('Implementation of member "'+$5+'" is missing in class "'+$0.classname+'" required by interface "'+$1.name+'"');
...
genericToString:function(){return $[1155]+this.name+$[124];
},
__registry:{},
...
destruct:function(){this._disposeFields($[2087]);
}});
...
}$1[$[96]+$3]=function(){if(this[$4]==null){this[$4]=this[$5]();
}return this[$4];
};
$1[$[481]+$3]=function(){if(this[$4]!=null){this[$4]=null;
if($0.addToQueueRuntime){this.addToQueueRuntime($0.name);
}}};
$1[$[569]+$3]=function(){var $7=this[$4];
var $8=this[$5]();
if($8!=$7){this[$4]=$8;
this[$6]($8,
$7);
...
$1[$[96]+$3].self=$1.constructor;
$1[$[481]+$3].self=$1.constructor;
$1[$[569]+$3].self=$1.constructor;
},
addProperty:function($0,
$1){qx.log.Logger.deprecatedMethodWarning(arguments.callee,
$[1321]);
if(typeof $0!==$[34]){throw new Error("AddProperty: Param should be an object!");
}
if(typeof $0.name!==$[10]){throw new Error("AddProperty: Malformed input parameters: name needed!");
}if($0.dispose===undefined&&($0.type==$[47]||$0.type==$[34])){$0.dispose=true;
...
if(typeof $0.type===$[10]){$0.hasType=true;
...
if(typeof $0.instance===$[10]){$0.hasInstance=true;
...
if(typeof $0.classname===$[10]){$0.hasClassName=true;
...
var $2=qx.core.Property.$$store.user[$0.name]=$[653]+$0.name;
var $3=$[835]+$0.method;
var $4=$[1655]+$0.implMethod;
var $5=$[907]+$0.implMethod;
var $6=qx.core.Property.$$method;
if(!$6.set[$0.name]){$6.set[$0.name]=$[30]+$0.method;
$6.get[$0.name]=$[96]+$0.method;
$6.reset[$0.name]=$[101]+$0.method;
}$1[$2]=$0.defaultValue;
$1[$[96]+$0.method]=function(){return this[$2];
};
$1[$[915]+$0.method]=function($7){return this[$2]=$7;
};
$1[$[101]+$0.method]=function(){return this[$[30]+$0.method]($0.defaultValue);
};
if($0.type===$[70]){$1[$[321]+$0.method]=function($7){return this[$[30]+$0.method](!this[$2]);
};
}
if($0.allowMultipleArguments||$0.hasConvert||$0.hasInstance||$0.hasClassName||$0.hasPossibleValues||$0.hasUnitDetection||$0.addToQueue||$0.addToQueueRuntime||$0.addToStateQueue){$1[$[30]+$0.method]=function($7){if($0.allowMultipleArguments&&arguments.length>1){$7=qx.lang.Array.fromArguments(arguments);
...
}else{$1[$[30]+$0.method]=function($7){var $8=this[$2];
if($7===$8){return $7;
}
if(!($0.allowNull&&$7==null)){if($0.hasType&&typeof $7!==$0.type){throw new Error("Attention! The value \""+$7+"\" is an invalid value for the property \""+$0.name+"\" which must be typeof \""+$0.type+"\" but is typeof \""+typeof $7+"\"!");
}}if(this[$5]){try{$7=this[$5]($7,
...
}$1[$[30]+$0.method].self=$1.constructor;
if(typeof $0.getAlias===$[10]){$1[$0.getAlias]=$1[$[96]+$0.method];
}if(typeof $0.setAlias===$[10]){$1[$0.setAlias]=$1[$[30]+$0.method];
}}}});
...
/* ID: qx.core.Property */
qx.Class.define($[2033],
{statics:{__checks:{"Boolean":$[2129],
"String":$[1390],
"NonEmptyString":$[1398],
"Number":$[341],
"Integer":$[957],
...
$4;
if($1.charAt(0)===$[106]){if($1.charAt(1)===$[106]){$3=$[477];
...
var $5=$1.name;
{};
if($1.dispose===undefined&&typeof $1.check===$[10]){$1.dispose=this.__dispose[$1.check]||qx.Class.isDefined($1.check)||qx.Interface.isDefined($1.check);
}var $6=this.$$method;
var $7=this.$$store;
$7.user[$5]=$[653]+$5;
$7.theme[$5]=$[2038]+$5;
...
if($1.inheritable||$1.apply||$1.event){$6.init[$5]=$2+$[80]+$3;
...
if($1.inheritable){$6.refresh[$5]=$2+$[163]+$3;
...
if($1.themeable){$6.style[$5]=$2+$[55]+$3;
...
if($1.check===$[2]){$4[$2+$[321]+$3]=new Function($[656]+$6.set[$5]+$[1147]+$6.get[$5]+$[1587]);
$4[$2+$[670]+$3]=new Function($[656]+$6.get[$5]+$[1884]);
}},
__errors:{0:$[1726],
1:$[1465],
2:$[1166],
...
var $6=$[2039]+$2+$[1764]+$5+$[1541]+this.$$method[$3][$2]+$[1723]+$4+$[1177];
$0.printStackTrace();
...
if($4.deferredInit&&$4.init===undefined){$6.push($[202],
this.$$store.init[$2],
$[151]);
$6.push($[201],
this.$$store.init[$2],
...
if($4.init!==undefined){$6.push($[201],
this.$$store.init[$2],
$[17]);
}else if($4.inheritable||$4.nullable){$6.push($[1684]);
}else{$6.push($[1416],
$2,
$[1611],
$1.classname,
...
var $6=$1.prototype;
var $7=[];
var $8=$3===$[30]||$3===$[55]||($3===$[80]&&$5.init===undefined);
var $9=$3===$[101]||$3===$[136];
var $a=$5.apply||$5.event||$5.inheritable;
if($3===$[55]||$3===$[136]){var $b=this.$$store.theme[$2];
}else if($3===$[80]){var $b=this.$$store.init[$2];
}else{var $b=this.$$store.user[$2];
}{if(!$5.nullable||$5.check||$5.inheritable){$7.push($[1239]);
}if($3===$[30]){$7.push($[1547]+$2+$[314]+$3+$[364]);
}};
if($8){if($5.transform){$7.push($[1552],
$5.transform,
$[1041]);
}}if($a){if($8){$7.push($[108],
$b,
$[1531]);
}else if($9){$7.push($[108],
$b,
$[1952]);
}}if($5.inheritable){$7.push($[738]);
}if($8&&(false||$3===$[30])){if(!$5.nullable){$7.push($[1471]+$2+$[314]+$3+$[364]);
}if($5.check!==undefined){if($5.nullable){$7.push($[1395]);
}if($5.inheritable){$7.push($[1142]);
}$7.push($[2026]);
if(this.__checks[$5.check]!==undefined){$7.push($[645],
this.__checks[$5.check],
$[257]);
}else if(qx.Class.isDefined($5.check)){$7.push($[960],
$5.check,
$[257]);
}else if(qx.Interface.isDefined($5.check)){$7.push($[1503],
$5.check,
$[1983]);
}else if(typeof $5.check===$[47]){$7.push($[853],
$1.classname,
$[605],
$2);
$7.push($[2148]);
}else if(typeof $5.check===$[10]){$7.push($[645],
$5.check,
$[257]);
...
}$7.push($[1253]+$2+$[314]+$3+$[364]);
}}
if(!$a){if($3===$[30]){$7.push($[65],
this.$$store.user[$2],
$[58]);
}else if($3===$[101]){$7.push($[108],
this.$$store.user[$2],
$[151]);
$7.push($[132],
this.$$store.user[$2],
$[17]);
}else if($3===$[55]){$7.push($[65],
this.$$store.theme[$2],
$[58]);
}else if($3===$[136]){$7.push($[108],
this.$$store.theme[$2],
$[151]);
$7.push($[132],
this.$$store.theme[$2],
$[17]);
}else if($3===$[80]&&$8){$7.push($[65],
this.$$store.init[$2],
$[58]);
}}else{if($5.inheritable){$7.push($[1363],
this.$$store.inherit[$2],
$[17]);
}else{$7.push($[2104]);
}$7.push($[108],
this.$$store.user[$2],
$[228]);
if($3===$[30]){if(!$5.inheritable){$7.push($[255],
this.$$store.user[$2],
$[17]);
}$7.push($[46],
this.$$store.user[$2],
$[58]);
}else if($3===$[101]){if(!$5.inheritable){$7.push($[255],
this.$$store.user[$2],
$[17]);
}$7.push($[132],
this.$$store.user[$2],
...
if($5.themeable){$7.push($[202],
this.$$store.theme[$2],
$[228]);
if(!$5.inheritable){$7.push($[255],
this.$$store.theme[$2],
$[17]);
}
if($3===$[30]){$7.push($[46],
...
$[252]);
$7.push($[113]);
}else if($3===$[80]){if($8){$7.push($[65],
this.$$store.init[$2],
$[58]);
}$7.push($[46],
this.$$store.theme[$2],
$[17]);
}else if($3===$[163]){$7.push($[46],
this.$$store.theme[$2],
$[17]);
}$7.push($[113]);
}$7.push($[202],
...
if($3===$[80]){if($8){$7.push($[46],
this.$$store.init[$2],
$[58]);
}else{$7.push($[46],
this.$$store.init[$2],
$[17]);
}}else if($3===$[30]||$3===$[55]||$3===$[163]){$7.push($[132],
this.$$store.useinit[$2],
$[17]);
if($3===$[30]){$7.push($[46],
this.$$store.user[$2],
...
$7.push($[609]);
$7.push($[692]);
}else if($a){if($3!==$[30]&&$3!==$[55]){$7.push($[609]);
}$7.push($[492]);
$7.push($[692]);
}if($a){if($5.apply){$7.push($[65],
$5.apply,
$[1917]);
}if($5.event){$7.push($[2190],
$5.event,
$[1777]);
}if($5.inheritable&&$6.getChildren){$7.push($[1091]);
$7.push($[1146],
...
format:function($0,
$1){var $2=$0;
for(var $3=0;$3<$1.length;$3++){$2=$2.replace(new RegExp($[197]+($3+1),
$[599]),
$1[$3]);
}return $2;
},
...
toString:function(){if(this.classname){return $[1228]+this.classname+$[124];
}return $[2002];
},
base:function($0,
...
this._logFormatted($3.length?$3:[$[484]],
$[104]);
throw $1?$1:$[484];
}},
...
}if(qx.core.Setting){var $0=qx.core.Setting.get($[208])+$[2019];
...
this._consoleLog=$1.getElementById($[421]);
this._commandLine=$1.getElementById($[1572]);
...
_syncLayout:function(){this._consoleLog.style.height=(qx.bom.Viewport.getHeight(this._consoleWindow)-42)+$[48];
},
...
$1){var $2=this._consoleLog.ownerDocument.createElement($[142]);
$2.className=$[2094]+($1?$[1890]+$1:$[0]);
...
if($7&&typeof ($7)==$[34]){var $8=$0[++$4];
$7.appender($8,
$2);
}else this._appendText($7,
$2);
}
for(var $6=$4+1;$6<$0.length;++$6){this._appendText($[53],
$2);
var $8=$0[$6];
if(typeof ($8)==$[10])this._appendText($8,
$2);
...
var $7=$4[3]?parseInt($4[3]):($4[4]==$[24]?-1:0);
$1.push($0.substr(0,
$4[0][0]==$[197]?$4.index:$4.index+1));
$1.push({appender:$6,
precision:$7});
...
_escapeHTML:function($0){function $1($2){switch($2){case $[367]:return $[855];
case $[322]:return $[1178];
case $[56]:return $[1653];
case $[162]:return $[1609];
case $[67]:return $[1591];
}return $[129];
...
$1);
else if($0==null)this._appendNull($[183],
$1);
else if(typeof $0==$[10])this._appendString($0,
$1);
else if(typeof $0==$[66])this._appendInteger($0,
$1);
else if($0.toString)this._appendText($0.toString(),
$1);
else if(typeof $0==$[47])this._appendFunction($0,
$1);
else if($0.nodeType==1)this._appendSelector($0,
$1);
else if(typeof $0==$[34])this._appendObjectFormatted($0,
$1);
...
$[72]);
if($0.className)$1.push($[1956],
this._escapeHTML($0.className),
$[72]);
$1.push($[72]);
},
_appendNode:function($0,
$1){if($0.nodeType==1){$1.push($[1623],
$[1948],
...
}else if($0.nodeType==3){$1.push($[2225],
this._escapeHTML($0.nodeValue),
$[4]);
}},
_addEvent:function($0,
$1,
$2){if(document.all)$0.attachEvent($[71]+$1,
$2);
...
$1,
$2){if(document.all)$0.detachEvent($[71]+$1,
$2);
...
return $1.compatMode===$[100]?$1.documentElement.clientWidth:$1.body.clientWidth;
}}),
...
"default":function($0){var $1=($0||window).document;
return $1.compatMode===$[100]?$1.documentElement.clientHeight:$1.body.clientHeight;
}}),
...
genericToString:function(){return $[1511]+this.name+$[124];
},
...
}var $3=$[348]+qx.core.Object.toHashCode($1)+($2?$[233]+qx.core.Object.toHashCode($2):$[0]);
...
if(typeof $1!==$[47]){throw new Error("qx.core.Target: removeEventListener("+$0+"): '"+$1+"' is not a function!");
}var $4=$[348]+qx.core.Object.toHashCode($1)+($2?$[233]+qx.core.Object.toHashCode($2):$[0]);
...
$3.call($4,
$0);
}}}if($0.getBubbles()&&!$0.getPropagationStopped()&&typeof (this.getParent)==$[47]){var $6=this.getParent();
if($6&&!$6.getDisposed()&&$6.getEnabled()){$6._dispatchEvent($0);
}}}},
destruct:function(){this._disposeObjectDeep($[1597],
2);
}});
...
destruct:function(){this._disposeFields($[708],
$[1867],
$[892],
$[1753]);
}});
...
defaultValue:false},
data:{_fast:true}},
destruct:function(){this._disposeFields($[1347]);
}});
...
destruct:function(){this._disposeFields($[1857],
$[1582]);
}});
...
destruct:function(){this._disposeFields($[1366]);
}});
...
while($3.length<6){$3=$[177]+$3;
}$2+=$3;
if(this.getUseLongFormat()){switch($0.level){case $1.LEVEL_DEBUG:$2+=$[834];
break;
case $1.LEVEL_INFO:$2+=$[1876];
break;
case $1.LEVEL_WARN:$2+=$[829];
break;
case $1.LEVEL_ERROR:$2+=$[1995];
break;
case $1.LEVEL_FATAL:$2+=$[2074];
break;
}}else{$2+=$[261];
}var $4=$[0];
for(var $5=0;$5<$0.indent;$5++){$4+=$[319];
}$2+=$4;
if(this.getUseLongFormat()){$2+=$0.logger.getName();
if($0.instanceId!=null){$2+=$[675]+$0.instanceId+$[124];
}$2+=$[261];
}if(typeof $0.message==$[10]){$2+=$0.message;
}else{var $6=$0.message;
if($6==null){$2+=$[1533];
}else{$2+=$[1396]+$6+$[1980];
var $7=new Array();
try{for(var $8 in $6){$7.push($8);
}}catch(exc){$2+=$4+$[1273]+exc+$[552];
}$7.sort();
for(var $5=0;$5<$7.length;$5++){try{$2+=$4+$[319]+$7[$5]+$[115]+$6[$7[$5]]+$[170];
}catch(exc){$2+=$4+$[319]+$7[$5]+$[1538]+exc+$[552];
}}$2+=$4+$[2091];
}}if($0.throwable!=null){var $9=$0.throwable;
if($9.name==null){$2+=$[261]+$9;
}else{$2+=$[261]+$9.name;
}
if($9.message!=null){$2+=$[760]+$9.message;
}
if($9.number!=null){$2+=$[1203]+$9.number+$[57];
}var $a=qx.dev.StackTrace.getStackTraceFromError($9);
}
if($0.trace){var $a=$0.trace;
}
if($a&&$a.length>0){$2+=$[170];
for(var $5=0;$5<$a.length;$5++){$2+=$[1085]+$a[$5]+$[170];
}}return $2;
}}});
...
properties:{maxMessages:{check:$[11],
init:500},
popUnder:{check:$[2],
init:false},
...
init:true,
apply:$[1518]},
windowWidth:{check:$[11],
init:600},
windowHeight:{check:$[11],
init:350},
windowLeft:{check:$[11],
nullable:true},
windowTop:{check:$[11],
...
}var $4=$[1556]+$[1760]+$0+$[1106]+$1+$[1796]+$2+$[1779]+$3;
...
$[20])?$[1358]:$[366];
$0.open();
$0.write($[1536]+this._name+$[1656]+$[993]+this._id+$[868]+$[2224]+$[737]+$[1821]+$[707]+$[1634]+$[1988]+$[1485]+$[1065]+$1+$[998]+$[794]+$[727]+this._filterText+$[194]+$[482]+$[929]+$[2189]+$[482]+$[2121]);
$0.close();
this._logElem=$0.getElementById($[421]);
this._markerBtn=$0.getElementById($[2051]);
this._filterInput=$0.getElementById($[161]);
this._logLinesDiv=$0.getElementById($[979]);
var $2=this;
this._markerBtn.onclick=function(){$2._showMessageInLog($[888]);
};
...
}else{this._showMessageInLog($[1234]+this._errorsPreventingAutoCloseCount+$[1051]);
}},
...
}else{var $1=this._logWindow.document.createElement($[142]);
if($0.level>=qx.log.Logger.LEVEL_ERROR){$1.style.backgroundColor=$[1924];
if(!this.getAutoCloseWithErrors()){this._errorsPreventingAutoCloseCount+=1;
}}else if($0.level==qx.log.Logger.LEVEL_DEBUG){$1.style.color=$[165];
}var $2;
...
if(this._removedMessageCount!=null){this._logElem.firstChild.innerHTML=$[102]+this._removedMessageCount+$[1567];
}this._logLinesDiv.scrollTop=this._logLinesDiv.scrollHeight;
}},
setFilterText:function($0){if($0==null){$0=$[0];
}this._filterText=$0;
$0=$0.toUpperCase();
this._filterTextWords=$0.split($[53]);
...
}$0.elem.style[$[175]]=($1?$[0]:$[14]);
},
_applyAutoCloseWithErrors:function($0,
$1){if(!$0&&$1){this._errorsPreventingAutoCloseCount=0;
this._showMessageInLog($[882]);
}else if($0&&!$1){this._showMessageInLog($[937]+this._errorsPreventingAutoCloseCount+$[1462]);
}}},
...
_oninterval:function(){if(this.getEnabled()){this.createDispatchEvent($[121]);
}}},
destruct:function(){if(this.__intervalHandler){window.clearInterval(this.__intervalHandler);
}this._disposeFields($[1744],
$[2207]);
}});
...
qx.Class.define($[1750],
{extend:qx.log.appender.Abstract,
construct:function(){arguments.callee.base.call(this);
},
members:{appendLogEvent:function($0){if(typeof console!=$[535]){var $1=qx.log.Logger;
...
{extend:qx.log.appender.Abstract,
construct:function(){arguments.callee.base.call(this);
if(typeof console!=$[535]&&console.debug&&!console.emu){this._appender=new qx.log.appender.FireBug;
...
destruct:function(){this._disposeObjects($[2146]);
}});
...
measure:function($0,
$1,
$2){if(this._lastMeasureTime==null){$0=$[801]+$0;
...
settings:{"qx.logAppender":$[606],
"qx.minLogLevel":200},
defer:function($0){$0.ROOT_LOGGER=new $0("root",
null);
$0.ROOT_LOGGER.setMinLevel(qx.core.Setting.get($[1200]));
$0.ROOT_LOGGER.addAppender(new (qx.Class.getByName(qx.core.Setting.get($[785]))));
},
destruct:function(){this._disposeFields($[1633],
$[1319]);
}});
...
"webkit":function($0){if($0.sourceURL&&$0.line){return [this.__fileNameToClassName($0.sourceURL)+$[51]+$0.line];
}},
...
getFunctionName:function($0){if($0.$$original){return $0.classname+$[894];
}
if($0.wrapper){return $0.wrapper.classname+$[621];
}
if($0.classname){return $0.classname+$[621];
}
if($0.mixin){for(var $1 in $0.mixin.$$members){if($0.mixin.$$members[$1]==$0){return $0.mixin.name+$[51]+$1;
}}for(var $1 in $0.mixin){if($0.mixin[$1]==$0){return $0.mixin.name+$[51]+$1;
}}}
if($0.self){var $2=$0.self.constructor;
if($2){for(var $1 in $2.prototype){if($2.prototype[$1]==$0){return $2.classname+$[51]+$1;
}}for(var $1 in $2){if($2[$1]==$0){return $2.classname+$[51]+$1;
}}}}var $3=$0.toString().match(/(function\s*\w*\(.*?\))/);
if($3&&$3.length>=1&&$3[1]){return $3[1];
}var $3=$0.toString().match(/(function\s*\(.*?\))/);
if($3&&$3.length>=1&&$3[1]){return $[1201]+$3[1];
}return $[2030];
},
__fileNameToClassName:function($0){var $1=$[1596];
var $2=$0.indexOf($1);
...
function($1){var $2={"  ":$[782],
"\n":$[1692]};
return $2[$1]||$1;
});
},
toText:function($0){return qx.html.String.unescape($0.replace(/\s+|<([^>])+>/gi,
function($1){if(/\s+/.test($1)){return $[53];
}else if(/^<BR|^<br/gi.test($1)){return $[170];
}else{return $[0];
}}));
}}});
...
}else{if($2.charAt(0)==$[470]){if($2.charAt(1).toUpperCase()==$[1294]){$4=$2.substring(2);
if($4.match(/^[0-9A-Fa-f]+$/gi)){$3=String.fromCharCode(parseInt($[1279]+$4));
...
check:function($0){if(typeof $0==$[47]){throw new Error("The application property takes an application instance as parameter "+"and no longer a class/constructor. You may have to fix your 'index.html'.");
...
{};
if(!this.getApplication()){var $2=qx.Class.getByName(qx.core.Setting.get($[780]));
...
svn:0,
folder:$[0],
toString:function(){return this.major+$[24]+this.minor+(this.revision==0?$[0]:$[24]+this.revision)+(this.state==$[0]?$[0]:$[267]+this.state)+(this.svn==0?$[0]:$[1185]+this.svn+$[57])+(this.folder==$[0]?$[0]:$[2229]+this.folder+$[124]);
},
__init:function(){var $0=qx.core.Setting.get($[803]).split($[53]);
var $1=$0.shift();
var $2=$0.join($[53]);
...
this.state=typeof RegExp.$6==$[10]?RegExp.$6:$[0];
}
if(/(\(r([0-9]+)\))?(\s\[([a-zA-Z0-9_-]+)\])?/.test($2)){this.svn=(RegExp.$2!=$[0]?parseInt(RegExp.$2):0);
this.folder=typeof RegExp.$4==$[10]?RegExp.$4:$[0];
}}},
settings:{"qx.version":$[1209]},
defer:function($0){$0.__init();
}});
...
213,
217],
"list-view-header-cell-hover":$[50],
"date-chooser":$[50],
...
$1,
$2){{};
var $3=$[620]+$1.toHashCode()+$[233]+qx.core.Object.toHashCode($0);
...
destruct:function(){this._disposeFields($[1932],
$[1888]);
}});
...
this._aliases={};
this.add($[311],
qx.core.Setting.get($[208])+$[1024]);
},
members:{_preprocess:function($0){var $1=this._dynamic;
if($1[$0]===false){return $0;
}else if($1[$0]===undefined){if($0.charAt(0)===$[111]||$0.charAt(0)===$[24]||$0.indexOf($[548])===0||$0.indexOf($[1077])===$[177]||$0.indexOf($[1715])===0){$1[$0]=false;
return $0;
}var $2=$0.substring(0,
$0.indexOf($[111]));
...
$6.indexOf($[111]))===$0){$2[$6]=$1+$6.substring($0.length);
$5[$6]=true;
...
destruct:function(){this._disposeFields($[1123]);
}});
...
qx.Theme.define($[1175],
{title:$[461],
widgets:{uri:qx.core.Setting.get($[208])+$[1238]}});




/* ID: qx.theme.classic.Appearance */
qx.Theme.define($[2133],
{title:$[370],
appearances:{"empty":{},
"widget":{},
"image":{},
"atom":{},
"popup":{},
"cursor-dnd-move":{style:function($0){return {source:$[1558]};
}},
"cursor-dnd-copy":{style:function($0){return {source:$[1184]};
}},
"cursor-dnd-alias":{style:function($0){return {source:$[1630]};
}},
"cursor-dnd-nodrop":{style:function($0){return {source:$[1780]};
}},
"label":{style:function($0){return {textColor:$0.disabled?$[258]:$[5]};
}},
"client-document":{style:function($0){return {backgroundColor:$[68],
textColor:$[98],
font:$[61]};
}},
"client-document-blocker":{style:function($0){return {cursor:$[61],
backgroundImage:$[120]};
}},
"tool-tip":{include:$[559],
style:function($0){return {backgroundColor:$[642],
textColor:$[635],
border:$[642],
padding:[1,
3,
...
"iframe":{style:function($0){return {border:$[77]};
}},
"check-box":{style:function($0){return {padding:[2,
3]};
}},
"radio-button":{include:$[493]},
"button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[77];
}else{var $1=$[75];
}
...
4];
}return {backgroundColor:$0.abandoned?$[262]:$0.over?$[1984]:$[158],
border:$1,
padding:$2};
}},
"toolbar":{style:function($0){return {border:$[210],
backgroundColor:$[68]};
}},
"toolbar-part":{},
...
"toolbar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[213];
var $2=[3,
2,
1,
4];
}else if($0.over){var $1=$[210];
var $2=[2,
3];
}else{var $1=$[5];
var $2=[3,
...
border:$1,
padding:$2,
verticalChildrenAlign:$[22],
backgroundColor:$0.abandoned?$[262]:$[158],
backgroundImage:$0.checked&&!$0.over?$[564]:null};
}},
"button-view":{style:function($0){return {border:$[268]};
}},
"button-view-pane":{style:function($0){return {backgroundColor:$[344],
padding:10};
}},
"button-view-page":{},
...
$3=$[3];
$2=null;
}return {backgroundColor:$0.checked?$[344]:$[5],
iconPosition:$[15],
margin:$1,
width:$2,
height:$3,
...
"tab-view-bar":{},
"tab-view-pane":{style:function($0){return {backgroundColor:$[759],
...
"radio-view":{include:$[607]},
"radio-view-pane":{style:function($0){return {backgroundColor:$[1021]};
}},
"radio-view-page":{},
"radio-view-bar":{style:function($0){return {backgroundColor:$[956],
padding:[1,
0],
border:$0.barTop?qx.ui.core.Border.fromConfig({bottom:[1,
$[6],
$[13]]}):qx.ui.core.Border.fromConfig({top:[1,
$[6],
$[13]]})};
}},
...
$2=[3,
7];
}return {backgroundColor:$0.checked?$[814]:$[5],
iconPosition:$[9],
margin:[0,
1],
width:$[3],
...
"window":{style:function($0){return {backgroundColor:$[68],
padding:1,
border:$0.maximized?$[5]:$[75]};
}},
"window-captionbar":{style:function($0){return {padding:[1,
2,
2],
verticalChildrenAlign:$[22],
backgroundColor:$0.active?$[1461]:$[2110],
textColor:$0.active?$[2100]:$[908]};
}},
"window-resize-frame":{style:function($0){return {border:$[268]};
}},
"window-captionbar-icon":{style:function($0){return {marginRight:2};
}},
"window-captionbar-title":{style:function($0){return {cursor:$[61],
font:$[323],
marginRight:2};
}},
"window-captionbar-button":{include:$[158],
...
"window-captionbar-minimize-button":{include:$[275],
style:function($0){return {icon:$[1266]};
}},
"window-captionbar-restore-button":{include:$[275],
style:function($0){return {icon:$[1104]};
}},
"window-captionbar-maximize-button":{include:$[275],
style:function($0){return {icon:$[1469]};
}},
"window-captionbar-close-button":{include:$[275],
style:function($0){return {marginLeft:2,
icon:$[1368]};
}},
"window-statusbar":{style:function($0){return {border:$[213]};
}},
...
"resizer":{style:function($0){return {border:$[75]};
}},
"resizer-frame":{style:function($0){return {border:$[268]};
}},
"menu":{style:function($0){return {backgroundColor:$[1835],
border:$[75],
padding:1};
}},
"menu-layout":{},
...
4],
verticalChildrenAlign:$[22],
backgroundColor:$0.over?$[52]:$[5],
textColor:$0.over?$[214]:$[5]};
}},
"menu-button-arrow":{style:function($0){return {source:$[1346]};
}},
"menu-check-box":{include:$[597],
style:function($0){return {icon:$0.checked?$[1188]:$[120]};
}},
"menu-radio-button":{include:$[597],
style:function($0){return {icon:$0.checked?$[1297]:$[120]};
}},
...
"list":{style:function($0){return {border:$[213],
backgroundColor:$[193]};
}},
...
padding:[3,
5],
backgroundColor:$0.selected?$[52]:$[5],
textColor:$0.selected?$[214]:$[5]};
}},
"text-field":{style:function($0){return {border:$[77],
padding:[1,
3],
textColor:$0.disabled?$[258]:$[5],
backgroundColor:$[227]};
}},
"text-area":{include:$[159]},
"combo-box":{style:function($0){return {border:$[77],
backgroundColor:$[227]};
}},
"combo-box-list":{include:$[193],
style:function($0){return {border:$[5],
overflow:$[107]};
}},
"combo-box-popup":{include:$[193],
style:function($0){return {maxHeight:150,
border:$[268]};
}},
"combo-box-text-field":{include:$[159],
style:function($0){return {border:$[5],
backgroundColor:$[243]};
}},
"combo-box-button":{include:$[158],
...
"combo-box-ex":{style:function($0){return {border:$[77],
backgroundColor:$[227]};
}},
"combo-box-ex-list":{include:$[193],
style:function($0){return {border:$[5],
edge:0};
}},
"combo-box-ex-text-field":{include:$[159],
style:function($0){return {border:$[5],
minWidth:30,
width:100,
backgroundColor:$[243]};
}},
"combo-box-ex-popup":{include:$[193],
style:function($0){return {border:$[1825]};
}},
"combo-box-ex-button":{include:$[1342]},
"treevirtual-focus-indicator":{include:$[1906]},
...
"tree-element-label":{include:$[186],
style:function($0){return {marginLeft:3,
height:15,
padding:2,
backgroundColor:$0.selected?$[52]:$[5],
textColor:$0.disabled?$[258]:($0.selected?$[214]:$[5])};
}},
"tree-folder":{include:$[703]},
"tree-folder-icon":{include:$[671]},
"tree-folder-label":{include:$[513]},
"tree":{include:$[360]},
"tree-icon":{include:$[524]},
"tree-label":{include:$[666]},
...
6],
spacing:4,
backgroundColor:$0.over?$[947]:$[5],
paddingBottom:$0.over?0:2,
border:$0.over?new qx.ui.core.Border.fromConfig({bottom:[2,
$[6],
$[84]]}):$[5]};
}},
"list-view-header-cell-arrow-up":{style:function($0){return {source:$[434]};
}},
"list-view-header-cell-arrow-down":{style:function($0){return {source:$[274]};
}},
"list-view-header-separator":{style:function($0){return {backgroundColor:$[701],
width:1,
marginTop:1,
marginBottom:1};
}},
"list-view-content-cell":{style:function($0){return {cursor:$[61],
backgroundColor:$0.selected?$[52]:$[5],
textColor:$0.selected?$[214]:$[5],
border:$0.lead&&
!$0.selected?
...
"list-view-content-cell-image":{include:$[427],
style:function($0){return {paddingLeft:6,
paddingRight:6};
}},
"list-view-content-cell-text":{include:$[427],
style:function($0){return {overflow:$[21],
paddingLeft:6,
paddingRight:6};
}},
"list-view-content-cell-html":{include:$[231]},
"list-view-content-cell-icon-html":{include:$[231]},
"list-view-content-cell-link":{include:$[231]},
"group-box":{style:function($0){return {backgroundColor:$[68]};
}},
...
"radio-button-group-box-legend":{include:$[1110]},
"spinner":{style:function($0){return {border:$[77],
backgroundColor:$[227]};
}},
"spinner-text-field":{include:$[159],
style:function($0){return {backgroundColor:$[243]};
}},
"spinner-button":{style:function($0){return {width:16,
backgroundColor:$[68],
paddingLeft:3,
border:$0.pressed||$0.checked||$0.abandoned?$[77]:$[75]};
}},
"spinner-button-up":{include:$[525],
style:function($0){return {source:$[2123]};
}},
"spinner-button-down":{include:$[525],
style:function($0){return {paddingTop:1,
source:$[1996]};
}},
"colorselector":{style:function($0){return {backgroundColor:$[68],
border:$[75]};
}},
"datechooser-toolbar-button":{style:function($0){var $1={backgroundColor:$0.abandoned?$[262]:$[158],
backgroundImage:($0.checked&&!$0.over)?$[564]:null,
spacing:4,
width:$[3],
verticalChildrenAlign:$[22]};
if($0.pressed||$0.checked||$0.abandoned){$1.border=$[213];
}else if($0.over){$1.border=$[210];
}else{$1.border=$[5];
}
...
"datechooser-monthyear":{style:function($0){return {font:$[2071],
textAlign:$[39],
verticalAlign:$[22]};
}},
...
"datechooser-day":{style:function($0){return {textAlign:$[39],
verticalAlign:$[22],
border:$0.today?$[211]:$[5],
textColor:$0.selected?$[214]:$0.otherMonth?$[258]:$[5],
backgroundColor:$0.selected?$[52]:$[5],
padding:[2,
4]};
}},
...
"table-editor-textfield":{include:$[159],
style:function($0){return {border:$[5],
padding:[0,
2]};
}},
"table-pane":{style:function($0){return {backgroundColor:$[1451]};
}},
...
"table-menubar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[213];
var $2=[3,
2,
1,
4];
...
border:$1,
backgroundColor:$2,
icon:$0.sorted?($0.sortedAscending?$[1629]:$[2016]):null,
...
"splitpane-splitter":{style:function($0){return {cursor:$0.horizontal?$[284]:$[350]};
}},
...
"scrollbar-blocker":{style:function($0){return {backgroundColor:$[211],
opacity:0.2};
}}}});
...
qx.Theme.define($[1820],
{title:$[2149],
icons:{uri:qx.core.Setting.get($[208])+$[1774]}});
...
construct:function(){arguments.callee.base.call(this);
this._layoutChanges={};
if(qx.core.Setting.get($[2156])){this._generateHtmlId();
}},
events:{"beforeAppear":$[7],
"appear":$[7],
"beforeDisappear":$[7],
"disappear":$[7],
"beforeInsertDom":$[7],
...
}if(qx.Class.isDefined($[860])){for($0 in $5){$1=$5[$0];
...
var $6=$4==null?$5.indexOf($0)+$2:$4===$[541]?0:$5.length-1;
var $7=$5[$6];
...
__initApplyMethods:function($0){var $1=$[2144];
var $2=$[1058];
var $3=$[2044];
var $4=$[1216];
var $5=$[620];
...
$a+$7[$b]+$4);
$0[$9+$7[$b]]=new Function($a+$7[$b]+$[362]);
}var $c=$1+$[623];
var $d=$2+$[623];
var $e=$3+$[442];
if(qx.core.Variant.isSet($[1],
$[31])){for(var $b=0;$b<4;$b++){$0[$c+$7[$b]]=new Function($5,
$e+$7[$b]+$4);
$0[$d+$7[$b]]=new Function($e+$7[$b]+$[362]);
}}else{for(var $b=0;$b<4;$b++){$0[$c+$7[$b]]=new Function($5,
$[1847]+$7[$b]+$[1696]);
$0[$d+$7[$b]]=new Function($[773]+$7[$b]+$[1120]);
}}for(var $b=0;$b<$6.length;$b++){$0[$1+$7[$b]]=new Function($5,
$3+$6[$b]+$4);
$0[$2+$7[$b]]=new Function($3+$6[$b]+$[362]);
}},
TYPE_NULL:0,
TYPE_PIXEL:1,
TYPE_PERCENT:2,
...
TYPE_FLEX:4,
layoutPropertyTypes:{},
__initLayoutProperties:function($0){var $1=[$[36],
$[37],
$[87],
$[88],
$[92],
...
$5,
$6;$2<$3;$2++){$4=$1[$2];
$5=$[1277]+qx.lang.String.toFirstUp($4);
$6=$5+$[885];
...
initScrollbarWidth:function(){var $0=document.createElement($[142]);
var $1=$0.style;
...
nullable:true,
init:null},
backgroundImage:{check:$[12],
nullable:true,
apply:$[821],
themeable:true},
backgroundRepeat:{check:$[12],
nullable:true,
apply:$[881],
themeable:true},
overflow:{check:[$[21],
...
nullable:true,
themeable:true},
marginRight:{check:$[45],
apply:$[1808],
nullable:true,
themeable:true},
marginBottom:{check:$[45],
apply:$[810],
nullable:true,
themeable:true},
marginLeft:{check:$[45],
...
nullable:true,
themeable:true},
paddingRight:{check:$[45],
apply:$[2081],
nullable:true,
themeable:true},
paddingBottom:{check:$[45],
apply:$[1928],
nullable:true,
themeable:true},
paddingLeft:{check:$[45],
apply:$[1127],
nullable:true,
themeable:true},
left:{apply:$[1223],
...
$[995]],
themeable:true},
clipLocation:{group:[$[678],
$[594]]},
clipDimension:{group:[$[690],
$[479]]},
clip:{group:[$[678],
$[594],
$[690],
...
$1){this._unitDetectionPixelPercent($[15],
$0);
this.addToQueue($[15]);
},
_applyBottom:function($0,
$1){this._unitDetectionPixelPercent($[16],
$0);
this.addToQueue($[16]);
},
_applyWidth:function($0,
$1){this._unitDetectionPixelPercentAutoFlex($[36],
$0);
this.addToQueue($[36]);
},
_applyMinWidth:function($0,
$1){this._unitDetectionPixelPercentAuto($[87],
$0);
this.addToQueue($[87]);
},
...
$1){this._unitDetectionPixelPercentAuto($[92],
$0);
this.addToQueue($[92]);
},
...
$[175])!=$[14]&&qx.html.Style.getStyleProperty($0,
$[328])!=$[21]&&$0.offsetWidth>0&&$0.offsetHeight>0);
},
...
if(typeof this._insertIndex==$[66]){qx.lang.Array.insertAt($0.getChildren(),
this,
this._insertIndex);
...
return this._handleDisplayable($[424]);
},
_applyDisplay:function($0,
$1){return this._handleDisplayable($[175]);
},
_handleDisplayable:function($0){var $1=this._computeDisplayable();
if(this._isDisplayable==$1&&!($1&&$0==$[424])){return true;
...
$2.addToJobQueue($[1660]);
}this.addToLayoutChanges($[2068]);
...
_beforeAppear:function(){this.createDispatchEvent($[903]);
},
_afterAppear:function(){this._isSeeable=true;
this.createDispatchEvent($[128]);
},
_beforeDisappear:function(){this.removeState($[74]);
if(qx.Class.isDefined($[353])){this.removeState($[62]);
this.removeState($[73]);
}this.createDispatchEvent($[1246]);
},
_afterDisappear:function(){this._isSeeable=false;
this.createDispatchEvent($[357]);
},
_isSeeable:false,
...
_beforeInsertDom:function(){this.createDispatchEvent($[1517]);
},
_afterInsertDom:function(){this.createDispatchEvent($[1901]);
},
_beforeRemoveDom:function(){this.createDispatchEvent($[1598]);
},
_afterRemoveDom:function(){this.createDispatchEvent($[1315]);
},
_applyVisibility:function($0,
$1){if($0){if(this._isDisplayable){this._beforeAppear();
}this.removeStyleProperty($[175]);
if(this._isDisplayable){this._afterAppear();
}}else{if(this._isDisplayable){this._beforeDisappear();
}this.setStyleProperty($[175],
$[14]);
...
_createElementImpl:function(){this.setElement(this.getTopLevelWidget().getDocumentElement().createElement($[142]));
},
...
$e=$d.length;
if($1.paddingLeft){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1702]);
}}
if($1.paddingRight){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1118]);
}}
if($1.paddingTop){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[2115]);
}}
if($1.paddingBottom){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[921]);
}}}
...
switch(this.getOverflow()){case $[42]:case $[107]:$0+=qx.ui.core.Widget.SCROLLBAR_SIZE;
break;
case $[3]:break;
}return $0;
},
...
switch(this.getOverflow()){case $[42]:case $[123]:$0+=qx.ui.core.Widget.SCROLLBAR_SIZE;
break;
case $[3]:break;
}return $0;
},
...
switch(typeof $0){case $[66]:return isNaN($0)?qx.ui.core.Widget.TYPE_NULL:qx.ui.core.Widget.TYPE_PIXEL;
case $[10]:return $0.indexOf($[197])!=-1?qx.ui.core.Widget.TYPE_PERCENT:$0.indexOf($[133])!=-1?qx.ui.core.Widget.TYPE_FLEX:qx.ui.core.Widget.TYPE_NULL;
...
switch(typeof $0){case $[66]:return isNaN($0)?qx.ui.core.Widget.TYPE_NULL:qx.ui.core.Widget.TYPE_PIXEL;
case $[10]:return $0.indexOf($[197])!=-1?qx.ui.core.Widget.TYPE_PERCENT:qx.ui.core.Widget.TYPE_NULL;
}return qx.ui.core.Widget.TYPE_NULL;
},
...
if($b!=this[$7]){switch($0){case $[87]:case $[88]:case $[36]:case $[9]:case $[8]:this._invalidateHasPercentX();
break;
case $[91]:case $[92]:case $[37]:case $[15]:case $[16]:this._invalidateHasPercentY();
break;
}}if($c!=this[$8]){switch($0){case $[87]:case $[88]:case $[36]:this._invalidateHasAutoX();
break;
case $[92]:case $[91]:case $[37]:this._invalidateHasAutoY();
break;
}}if($d!=this[$9]){switch($0){case $[36]:this._invalidateHasFlexX();
break;
case $[37]:this._invalidateHasFlexY();
break;
}}},
...
if($a!=this[$7]){switch($0){case $[87]:case $[88]:case $[36]:case $[9]:case $[8]:this._invalidateHasPercentX();
break;
case $[92]:case $[91]:case $[37]:case $[15]:case $[16]:this._invalidateHasPercentY();
break;
}}if($b!=this[$8]){switch($0){case $[87]:case $[88]:case $[36]:this._invalidateHasAutoX();
break;
case $[92]:case $[91]:case $[37]:this._invalidateHasAutoY();
break;
}}},
...
if($9!=this[$7]){switch($0){case $[87]:case $[88]:case $[36]:case $[9]:case $[8]:this._invalidateHasPercentX();
break;
case $[92]:case $[91]:case $[37]:case $[15]:case $[16]:this._invalidateHasPercentY();
break;
}}},
...
{"mshtml":function($0){},
"gecko":function($0){if($0.focused){if(!qx.event.handler.FocusHandler.mouseFocus&&!this.getHideFocus()){this.setStyleProperty($[383],
$[403]);
}}else{this.removeStyleProperty($[383]);
}},
"default":function($0){if($0.focused){if(!qx.event.handler.FocusHandler.mouseFocus&&!this.getHideFocus()){this.setStyleProperty($[457],
$[403]);
}}else{this.removeStyleProperty($[457]);
}}}),
...
_generateHtmlId:function(){var $0=this.classname+$[24]+qx.ui.core.Widget._idCounter++;
this.debug("setting autogenerated HTML id to "+$0);
this.setHtmlProperty($[145],
$0);
},
...
_applyEnabled:function($0,
$1){if($0===false){this.addState($[204]);
this.removeState($[74]);
if(qx.Class.isDefined($[353])){this.removeState($[73]);
this.removeState($[62]);
}}else{this.removeState($[204]);
}},
...
$1){if($0==null){this.removeStyleProperty($[376]);
}else{this.setStyleProperty($[376],
$0);
}},
_applyTabIndex:qx.core.Variant.select($[1],
{"mshtml":function($0,
$1){this.setHtmlProperty($[444],
$0<0?-1:1);
},
"gecko":function($0,
$1){this.setStyleProperty($[1805],
($0<0?$[652]:$[173]));
},
"default":function($0,
$1){this.setStyleProperty($[918],
($0<0?$[652]:$[173]));
this.setHtmlProperty($[444],
$0<0?-1:1);
}}),
...
$1){},
"gecko":function($0,
$1){if($0){this.removeStyleProperty($[469]);
}else{this.setStyleProperty($[469],
$[14]);
}},
"webkit":function($0,
$1){if($0){this.removeStyleProperty($[676]);
}else{this.setStyleProperty($[676],
$[14]);
}},
"khtml":function($0,
$1){if($0){this.removeStyleProperty($[495]);
}else{this.setStyleProperty($[495],
$[14]);
}},
"default":function($0,
$1){if($0){return this.removeStyleProperty($[686]);
}else{this.setStyleProperty($[686],
$[14]);
}}}),
_applyOpacity:qx.core.Variant.select($[1],
{"mshtml":function($0,
$1){if($0==null||$0>=1||$0<0){this.removeStyleProperty($[161]);
}else{this.setStyleProperty($[161],
($[1109]+Math.round($0*100)+$[57]));
}},
"default":function($0,
$1){if($0==null||$0>1){if(qx.core.Variant.isSet($[1],
$[31])){this.removeStyleProperty($[554]);
}else if(qx.core.Variant.isSet($[1],
$[174])){this.removeStyleProperty($[453]);
}this.removeStyleProperty($[447]);
}else{$0=qx.lang.Number.limit($0,
0,
1);
if(qx.core.Variant.isSet($[1],
$[31])){this.setStyleProperty($[554],
$0);
}else if(qx.core.Variant.isSet($[1],
$[174])){this.setStyleProperty($[453],
$0);
}this.setStyleProperty($[447],
$0);
}}}),
...
$1){if($0){this.setStyleProperty($[390],
this.__cursorMap[$0]||$0);
}else{this.removeStyleProperty($[390]);
}},
...
_styleBackgroundImage:function($0){$0?this.setStyleProperty($[578],
$[2184]+$0+$[57]):this.removeStyleProperty($[578]);
},
_applyBackgroundRepeat:function($0,
$1){$0?this.setStyleProperty($[476],
$0):this.removeStyleProperty($[476]);
},
...
var $4,
$5;
if($0==null){$4=($2==null?$[3]:$2+$[48]);
$0=$[3];
}else{$4=($2==null?$[3]:$0+$2+$[48]);
$0=$0+$[48];
}
if($1==null){$5=($3==null?$[3]:$3+$[48]);
$1=$[3];
}else{$5=($3==null?$[3]:$1+$3+$[48]);
$1=$1+$[48];
}return this.setStyleProperty($[1232],
($[2158]+$1+$[28]+$4+$[28]+$5+$[28]+$0+$[57]));
},
_applyOverflow:qx.core.Variant.select($[1],
{"default":function($0,
$1){var $2=$0;
var $3=$[76];
switch($0){case $[123]:$3=$[198];
$2=$[42];
break;
case $[107]:$3=$[199];
$2=$[42];
...
switch($0){case $[123]:this.setStyleProperty($[199],
$[21]);
break;
case $[107]:this.setStyleProperty($[198],
$[21]);
break;
...
$1){var $2=$0;
var $3=$[76];
switch($2){case $[123]:case $[107]:$2=$[42];
break;
}this._renderOverflow($3,
$2,
$0,
...
_styleBackgroundColor:function($0){$0?this.setStyleProperty($[626],
$0):this.removeStyleProperty($[626]);
},
...
}else{if($1===$[9]||$1===$[8]){this.__reflowBorderX($0);
...
var $1=this._borderElement=document.createElement($[142]);
var $2=$0.style;
var $3=this._innerStyle=$1.style;
if(qx.core.Variant.isSet($[1],
$[20])){}else{$3.width=$3.height=$[38];
}$3.position=$[82];
for(var $4 in this._styleProperties){switch($4){case $[376]:case $[161]:case $[175]:break;
default:$3[$4]=$2[$4];
$2[$4]=$[0];
}}
for(var $4 in this._htmlProperties){switch($4){case $[1685]:$1.unselectable=this._htmlProperties[$4];
}}while($0.firstChild){$1.appendChild($0.firstChild);
}$0.appendChild($1);
}}),
_applyPaddingTop:function($0,
$1){this.addToQueue($[116]);
this._invalidateFrameHeight();
},
...
$1){this.addToQueue($[230]);
},
execute:function(){var $0=this.getCommand();
if($0){$0.execute(this);
}this.createDispatchEvent($[474]);
},
...
{statics:{getStylePropertySure:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?$[585]:$[496],
...
getStyleProperty:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?$[585]:$[496],
{"hasComputed":function($0,
...
qx.Class.define($[1318],
{statics:{includeFile:function($0){var $1=document.createElement($[1725]);
$1.type=$[581];
$1.rel=$[1163];
$1.href=$0;
var $2=document.getElementsByTagName($[662])[0];
$2.appendChild($1);
},
createElement:qx.lang.Object.select(document.createStyleSheet?$[156]:$[63],
{"ie4+":function($0){var $1=document.createStyleSheet();
if($0){$1.cssText=$0;
}return $1;
},
"other":function($0){var $1=document.createElement($[55]);
$1.type=$[581];
$1.appendChild(document.createTextNode($0||$[1457]));
document.getElementsByTagName($[662])[0].appendChild($1);
if($1.sheet){return $1.sheet;
}else{var $2=document.styleSheets;
for(var $3=$2.length-1;$3>=0;$3--){if($2[$3].ownerNode==$1){return $2[$3];
}}}throw $[1911];
}}),
addRule:qx.lang.Object.select(document.createStyleSheet?$[156]:$[63],
{"ie4+":function($0,
$1,
$2){$0.addRule($1,
$2);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[279]:$[63],
{"safari2+":function($0,
$1,
$2){if(!$0._qxRules){$0._qxRules={};
}
if(!$0._qxRules[$1]){var $3=document.createTextNode($1+$[336]+$2+$[247]);
$0.ownerNode.appendChild($3);
$0._qxRules[$1]=$3;
}},
"other":function($0,
$1,
$2){$0.insertRule($1+$[336]+$2+$[247],
$0.cssRules.length);
}})}),
removeRule:qx.lang.Object.select(document.createStyleSheet?$[156]:$[63],
{"ie4+":function($0,
$1){var $2=$0.rules;
var $3=$2.length;
...
removeAllRules:qx.lang.Object.select(document.createStyleSheet?$[156]:$[63],
...
addImport:qx.lang.Object.select(document.createStyleSheet?$[156]:$[63],
{"ie4+":function($0,
$1){$0.addImport($1);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[279]:$[63],
{"safari2+":function($0,
$1){$0.ownerNode.appendChild(document.createTextNode($[679]+$1+$[518]));
},
"other":function($0,
$1){$0.insertRule($[679]+$1+$[518],
$0.cssRules.length);
}})}),
removeImport:qx.lang.Object.select(document.createStyleSheet?$[156]:$[63],
{"ie4+":function($0,
$1){var $2=$0.imports;
var $3=$2.length;
...
removeAllImports:qx.lang.Object.select(document.createStyleSheet?$[156]:$[63],
...
properties:{focusHandler:{check:$[673],
apply:$[1421],
nullable:true},
activeChild:{check:$[184],
apply:$[1953],
event:$[866],
nullable:true},
focusedChild:{check:$[184],
apply:$[1619],
event:$[1646],
nullable:true},
...
$1){if($0){this.addEventListener($[64],
this._onfocuskeyevent);
if(this.getTabIndex()<1){this.setTabIndex(1);
}this.setHideFocus(true);
this.setActiveChild(this);
}else{this.removeEventListener($[35],
this._onfocuskeyevent);
this.removeEventListener($[64],
this._onfocuskeyevent);
this.setTabIndex(-1);
...
$1){var $2=$0!=null;
var $3=$1!=null;
if(qx.Class.isDefined($[190])&&$2){var $4=qx.ui.popup.PopupManager.getInstance();
if($4){$4.update($0);
}}
if($3){if($1.hasEventListeners($[303])){var $5=new qx.event.type.FocusEvent($[303],
$1);
if($2){$5.setRelatedTarget($0);
}$1.dispatchEvent($5);
$5.dispose();
}}
if($2){if($0.hasEventListeners($[288])){var $5=new qx.event.type.FocusEvent($[288],
$0);
...
var $5=new qx.event.type.FocusEvent($[277],
$1);
if($2){$5.setRelatedTarget($0);
}$1.dispatchEvent($5);
if(qx.Class.isDefined($[169])){var $4=qx.ui.popup.ToolTipManager.getInstance();
if($4){$4.handleBlur($5);
}}$5.dispose();
}
...
var $5=new qx.event.type.FocusEvent($[263],
$0);
if($3){$5.setRelatedTarget($1);
}$0.dispatchEvent($5);
if(qx.Class.isDefined($[169])){var $4=qx.ui.popup.ToolTipManager.getInstance();
...
$[118])){$1._layoutChildOrig=$1._layoutChild;
...
destruct:function(){this._disposeObjectDeep($[1650],
1);
this._disposeObjects($[1248],
$[705]);
this._disposeFields($[379],
$[379],
$[1324],
$[1688],
$[750]);
...
$0);
this.setTarget($1);
switch($0){case $[288]:case $[303]:this.setBubbles(true);
...
getRelatedOriginalTargetObjectFromEvent:function($0){return qx.event.handler.EventHandler.getOriginalTargetObject($0.relatedTarget||($0.type==$[90]?$0.fromElement:$0.toElement));
},
...
if(!$1){if($0.type==$[90]){$1=$0.fromElement;
}else{$1=$0.toElement;
...
$3,
$4);
if($1==$[35]){this._checkKeyEventMatch($8);
}
if($7!=null&&$7.getEnabled()){switch($4){case $[522]:case $[347]:if(qx.Class.isDefined($[171])){qx.ui.menu.Manager.getInstance().update($7,
$1);
}break;
}if(!this.getAllowClientSelectAll()){if($0.ctrlKey&&$4==$[209]){switch($5.tagName.toLowerCase()){case $[127]:case $[330]:case $[266]:break;
default:qx.event.handler.EventHandler.stopDomEvent($0);
}}}$7.dispatchEvent($8);
if(qx.Class.isDefined($[358])){qx.event.handler.DragAndDropHandler.getInstance().handleKeyEvent($8);
}}$8.dispose();
},
...
var $2=$0.type;
if($2==$[79]){if(this._mouseIsDown&&$0.button==0){this._onmouseevent_post($0,
$[23]);
this._mouseIsDown=false;
}}else{if($2==$[26]){this._mouseIsDown=true;
}else if($2==$[23]){this._mouseIsDown=false;
}if($2==$[23]&&!this._lastMouseDown&&((new Date).valueOf()-this._lastMouseEventDate)<250){this._onmouseevent_post($0,
$[26]);
}else if($2==$[155]&&this._lastMouseEventType==$[23]&&((new Date).valueOf()-this._lastMouseEventDate)<250){this._onmouseevent_post($0,
$[93]);
}
switch($2){case $[26]:case $[23]:case $[93]:case $[155]:case $[242]:this._lastMouseEventType=$2;
this._lastMouseEventDate=(new Date).valueOf();
this._lastMouseDown=$2==$[26];
...
var $2=$0.type;
switch($2){case $[529]:$2=$[246];
break;
case $[93]:case $[155]:if($0.which!==1){return;
}}this._onmouseevent_post($0,
$2,
$1);
}}),
...
$1,
$2){var $3=false;
switch($1){case $[26]:this._lastMouseDownDomTarget=$0;
this._lastMouseDownDispatchTarget=$2;
break;
case $[23]:if(this._lastMouseDownDispatchTarget===$2&&$0!==this._lastMouseDownDomTarget){$3=true;
...
if(qx.core.Variant.isSet($[1],
$[31])){$9=this._onmouseevent_click_fix($2,
$1,
$5);
}if($1==$[242]&&!this.getAllowClientContextMenu()){qx.event.handler.EventHandler.stopDomEvent($0);
}if($a&&$1==$[26]){qx.event.handler.FocusHandler.mouseFocus=true;
...
$b.setActiveChild($6);
}}switch($1){case $[90]:case $[134]:$8=qx.event.handler.EventHandler.getRelatedTargetObjectFromEvent($0);
if($8==$6){return;
...
$3,
$0);
}else{if($1==$[90]){if(qx.Class.isDefined($[169])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($3);
}}}$3.dispose();
$3=null;
qx.ui.core.Widget.flushGlobalQueues();
...
$4,
$5,
$6){switch($0){case $[26]:if(qx.Class.isDefined($[190])){qx.ui.popup.PopupManager.getInstance().update($1);
}
if(qx.Class.isDefined($[171])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[301])){qx.ui.embed.IframeManager.getInstance().handleMouseDown($5);
}break;
case $[23]:if(qx.Class.isDefined($[171])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[301])){qx.ui.embed.IframeManager.getInstance().handleMouseUp($5);
}break;
case $[90]:if(qx.Class.isDefined($[169])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($5);
}break;
case $[134]:if(qx.Class.isDefined($[169])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOut($5);
}break;
}this._ignoreWindowBlur=$0===$[26];
if(qx.Class.isDefined($[358])&&$1){qx.event.handler.DragAndDropHandler.getInstance().handleMouseEvent($5);
}},
...
if(qx.Class.isDefined($[190])){qx.ui.popup.PopupManager.getInstance().update();
}if(qx.Class.isDefined($[171])){qx.ui.menu.Manager.getInstance().update();
}if(qx.Class.isDefined($[358])){qx.event.handler.DragAndDropHandler.getInstance().globalCancelDrag();
}qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1435]);
},
_onwindowfocus:function($0){if(this._focused){return;
}this._focused=true;
qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1848]);
},
_onwindowresize:function($0){qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[464]);
}},
destruct:function(){this.detachEvents();
this._disposeObjectDeep($[2220],
1);
this._disposeFields($[1213],
$[1580],
$[1836],
$[1231],
$[2164],
$[2098]);
this._disposeFields($[1819],
$[1494],
$[1302],
$[1970],
$[970]);
...
var $2=0;
var $3=$0.type;
if(!(this._lastUpDownType[$1]==$[35]&&$3==$[35])){this._idealKeyHandler($1,
$2,
$3,
$0);
}if($3==$[35]){if(this._isNonPrintableKeyCode($1)||
$1==
...
if(!(this._lastUpDownType[$4]==$[64]&&$3==$[35])){this._idealKeyHandler($1,
$2,
$3,
$0);
...
if($3==$[125]||$3==$[35]){$1=this._charCode2KeyCode[$0.charCode]||$0.keyCode;
...
_specialCharCodeMap:{8:$[1722],
9:$[347],
13:$[114],
27:$[522],
32:$[176]},
_keyCodeToIdentifierMap:{16:$[2191],
17:$[922],
18:$[1717],
20:$[1296],
224:$[1434],
...
91:$[1470],
93:$[1378]},
_numpadToCharCode:{96:$[177].charCodeAt(0),
97:$[1690].charCodeAt(0),
98:$[1356].charCodeAt(0),
99:$[1454].charCodeAt(0),
100:$[1152].charCodeAt(0),
101:$[1250].charCodeAt(0),
102:$[930].charCodeAt(0),
103:$[1029].charCodeAt(0),
104:$[925].charCodeAt(0),
105:$[304].charCodeAt(0),
106:$[133].charCodeAt(0),
107:$[374].charCodeAt(0),
109:$[267].charCodeAt(0),
110:$[28].charCodeAt(0),
111:$[111].charCodeAt(0)},
_charCodeA:$[209].charCodeAt(0),
_charCodeZ:$[651].charCodeAt(0),
_charCode0:$[177].charCodeAt(0),
_charCode9:$[304].charCodeAt(0),
...
if($0>=$[177]&&$0<=$[304]){return true;
}
if($0>=$[209]&&$0<=$[651]){return true;
}
switch($0){case $[374]:case $[267]:case $[133]:case $[111]:return true;
...
$[31])){$1._lastUpDownType={};
$1._keyCodeFix={12:$1._identifierToKeyCode($[239])};
}else if(qx.core.Variant.isSet($[1],
$[164])){$1._charCode2KeyCode={63289:$1._identifierToKeyCode($[239]),
63276:$1._identifierToKeyCode($[354]),
63277:$1._identifierToKeyCode($[361]),
63275:$1._identifierToKeyCode($[369]),
63273:$1._identifierToKeyCode($[302]),
63234:$1._identifierToKeyCode($[153]),
63232:$1._identifierToKeyCode($[235]),
63235:$1._identifierToKeyCode($[154]),
63233:$1._identifierToKeyCode($[273]),
63272:$1._identifierToKeyCode($[451]),
63302:$1._identifierToKeyCode($[395]),
63236:$1._identifierToKeyCode($[387]),
63237:$1._identifierToKeyCode($[407]),
63238:$1._identifierToKeyCode($[432]),
63239:$1._identifierToKeyCode($[462]),
63240:$1._identifierToKeyCode($[497]),
63241:$1._identifierToKeyCode($[523]),
63242:$1._identifierToKeyCode($[550]),
63243:$1._identifierToKeyCode($[573]),
63244:$1._identifierToKeyCode($[584]),
63245:$1._identifierToKeyCode($[472]),
63246:$1._identifierToKeyCode($[446]),
63247:$1._identifierToKeyCode($[419]),
63248:$1._identifierToKeyCode($[649]),
3:$1._identifierToKeyCode($[114]),
12:$1._identifierToKeyCode($[239]),
13:$1._identifierToKeyCode($[114])};
}else if(qx.core.Variant.isSet($[1],
$[118])){$1._lastKeyCode=null;
}},
destruct:function(){this._detachEvents();
this._disposeFields($[1132],
$[1484]);
}});
...
destruct:function(){this._disposeFields($[1217],
$[1829]);
}});
...
{"mshtml":function(){if(this.getType()==$[93]){return true;
...
2:$[8],
1:$[22]}}),
_computeButton:function(){switch(this.getDomEvent().type){case $[93]:case $[155]:return $[9];
case $[242]:return $[8];
...
destruct:function(){this._disposeFields($[1472]);
}});
...
limit:function($0,
$1,
$2){if(typeof $2===$[66]&&$0>$2){return $2;
}else if(typeof $1===$[66]&&$0<$1){return $1;
}else{return $0;
}}}});
...
this._blocker.addEventListener($[26],
this.blockHelper,
this);
this._blocker.addEventListener($[23],
this.blockHelper,
this);
...
if(qx.Class.isDefined($[1679])&&$0 instanceof qx.ui.window.Window){this._modalWidgets.push($0);
var $1=$0.getZIndex();
this._getBlocker().setZIndex($1);
$0.setZIndex($1+1);
}else if(qx.Class.isDefined($[691])&&$0 instanceof qx.client.NativeWindow){this._modalNativeWindow=$0;
this._getBlocker().setZIndex(1e7);
}},
release:function($0){if($0){if(qx.Class.isDefined($[691])&&$0 instanceof qx.client.NativeWindow){this._modalNativeWindow=null;
...
_onwindowresize:function($0){if(qx.Class.isDefined($[190])){qx.ui.popup.PopupManager.getInstance().update();
}this._recomputeInnerWidth();
this._recomputeInnerHeight();
qx.ui.core.Widget.flushGlobalQueues();
},
...
defer:function(){if(qx.core.Setting.get($[826])){var $0=qx.core.Client.getInstance().getEngineBoxSizingAttributes();
var $1=$0.join($[466])+$[466];
var $2=$0.join($[435])+$[435];
qx.html.StyleSheet.createElement($[963]+$[1693]+$[1933]+$1+$[1804]+$[2185]+$2+$[247]);
}
if(qx.core.Setting.get($[2118])){qx.html.StyleSheet.createElement($[2193]);
}},
destruct:function(){this._disposeObjects($[630]);
this._disposeFields($[1412],
$[1433],
$[1958],
$[1822],
$[2013]);
...
}if(this._initialLayoutDone){this.addToJobQueue($[95]);
}},
...
getMetaThemes:function(){return this.__queryThemes($[437]);
},
getColorThemes:function(){return this.__queryThemes($[509]);
},
getBorderThemes:function(){return this.__queryThemes($[681]);
},
getFontThemes:function(){return this.__queryThemes($[608]);
},
getWidgetThemes:function(){return this.__queryThemes($[684]);
},
getIconThemes:function(){return this.__queryThemes($[624]);
},
getAppearanceThemes:function(){return this.__queryThemes($[160]);
}},
settings:{"qx.theme":$[556],
"qx.colorTheme":null,
"qx.borderTheme":null,
"qx.fontTheme":null,
"qx.widgetTheme":null,
...
if(typeof $4===$[10]){if(!$3.isCssString($4)){throw new Error("Could not parse color: "+$4);
...
rgbToRgbString:function($0){return $[1372]+$0[0]+$[28]+$0[1]+$[28]+$0[2]+$[57];
},
...
switch($3){case $[168]:case $[216]:case $[77]:case $[75]:case $[6]:case $[191]:case $[206]:case $[196]:case $[14]:$1.setStyle($3);
break;
...
properties:{widthTop:{check:$[45],
init:0,
apply:$[1826]},
widthRight:{check:$[45],
init:0,
apply:$[1410]},
widthBottom:{check:$[45],
init:0,
apply:$[1545]},
widthLeft:{check:$[45],
init:0,
...
_applyStyleTop:function(){this.__informManager($[15]);
},
_applyStyleRight:function(){this.__informManager($[8]);
},
_applyStyleBottom:function(){this.__informManager($[16]);
},
...
{"gecko":function($0){var $1=$0._style;
$1.borderTopWidth=this.__widthTop||$[54];
$1.borderTopColor=this.__colorTop||$[0];
if(this.__complexTop){$1.borderTopStyle=$[6];
$1.MozBorderTopColors=this.__colorTop+$[53]+this.__colorInnerTop;
...
{"gecko":function($0){var $1=$0._style;
$1.borderRightWidth=this.__widthRight||$[54];
$1.borderRightColor=this.__colorRight||$[0];
if(this.__complexRight){$1.borderRightStyle=$[6];
$1.MozBorderRightColors=this.__colorRight+$[53]+this.__colorInnerRight;
...
{"gecko":function($0){var $1=$0._style;
$1.borderBottomWidth=this.__widthBottom||$[54];
$1.borderBottomColor=this.__colorBottom||$[0];
if(this.__complexBottom){$1.borderBottomStyle=$[6];
$1.MozBorderBottomColors=this.__colorBottom+$[53]+this.__colorInnerBottom;
...
$2=$0._innerStyle;
}$1.borderBottomWidth=$2.borderBottomWidth=$[185];
...
}else{$1.borderBottomWidth=this.__widthBottom||$[54];
...
{"gecko":function($0){var $1=$0._style;
$1.borderLeftWidth=this.__widthLeft||$[54];
$1.borderLeftColor=this.__colorLeft||$[0];
if(this.__complexLeft){$1.borderLeftStyle=$[6];
$1.MozBorderLeftColors=this.__colorLeft+$[53]+this.__colorInnerLeft;
...
var $3=[];
var $4;
for(var $5=0;$5<$2.length;$5++){switch($4=$2[$5]){case $[323]:$1.setBold(true);
break;
case $[480]:$1.setItalic(true);
break;
case $[355]:$1.setDecoration($[355]);
break;
...
reset:function($0){$0.removeStyleProperty($[615]);
$0.removeStyleProperty($[229]);
$0.removeStyleProperty($[491]);
$0.removeStyleProperty($[411]);
$0.removeStyleProperty($[610]);
},
...
$1){this.__size=$0===null?null:$0+$[48];
},
_applyFamily:function($0,
$1){var $2=$[0];
for(var $3=0,
$4=$0.length;$3<$4;$3++){if($0[$3].indexOf($[53])>0){$2+=$[67]+$0[$3]+$[67];
}else{$2+=$0[$3];
}
if($3!=$4-1){$2+=$[28];
}}this.__family=$2;
...
$1){this.__bold=$0===null?null:$0?$[323]:$[173];
},
_applyItalic:function($0,
$1){this.__italic=$0===null?null:$0?$[480]:$[173];
},
_applyDecoration:function($0,
$1){this.__decoration=$0===null?null:$0;
},
render:function($0){$0.setStyleProperty($[615],
this.__family);
$0.setStyleProperty($[229],
this.__size);
$0.setStyleProperty($[491],
this.__bold);
$0.setStyleProperty($[411],
this.__italic);
$0.setStyleProperty($[610],
this.__decoration);
},
...
generateStyle:function(){return (this.__family?$[1814]+this.__family.replace(/\"/g,
$[162])+$[78]:$[0])+(this.__size?$[1148]+this.__size+$[78]:$[0])+(this.__weight?$[1838]+this.__weight+$[78]:$[0])+(this.__style?$[1380]+this.__style+$[78]:$[0])+(this.__decoration?$[1616]+this.__decoration+$[78]:$[0]);
}}});
...
$1){if($1.getKeyIdentifier()!=$[347]){return;
}$1.stopPropagation();
$1.preventDefault();
...
while($0.tagName.toLowerCase()!=$[143]){$0=$0.offsetParent;
...
destruct:function(){this._disposeFields($[976],
$[1791]);
}});
...
$[94]);
if($3!=$[82]&&$3!=$[140]){$1-=qx.html.Style.getBorderLeft($2);
}if($4!=$[82]&&$4!=$[140]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[10]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[94]);
if($5==$[82]||$5==$[140]){$1-=qx.html.Style.getBorderLeft($2)+qx.html.Style.getPaddingLeft($2);
break;
}}}return $1;
},
...
var $4=qx.html.Style.getStyleProperty($2,
$[94]);
if($3!=$[82]&&$3!=$[140]){$1-=qx.html.Style.getBorderTop($2);
}if($4!=$[82]&&$4!=$[140]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[10]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[94]);
if($5==$[82]||$5==$[140]){$1-=qx.html.Style.getBorderTop($2)+qx.html.Style.getPaddingTop($2);
break;
}}}return $1;
},
...
$[76])){case $[42]:case $[3]:case $[327]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
$[198])){case $[42]:case $[3]:$5=true;
break;
default:$5=false;
}}
...
if($6.tagName.toLowerCase()==$[143]){break;
}$6=$6.offsetParent;
}return true;
},
scrollY:function($0,
...
while($6){switch(qx.html.Style.getStyleProperty($6,
$[76])){case $[42]:case $[3]:case $[317]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
$[199])){case $[42]:case $[3]:$5=true;
break;
default:$5=false;
}}
...
}this._timer=new qx.client.Timer(qx.core.Setting.get($[1699]));
this._timer.addEventListener($[121],
this.__oninterval,
this);
if($1){this.addEventListener($[18],
$1,
$2||null);
}},
events:{"completed":$[7]},
members:{_stopped:false,
start:function(){if(qx.lang.Object.isEmpty(this._list)){this.createDispatchEvent($[18]);
return;
}
...
destruct:function(){if(this._timer){this._timer.removeEventListener($[121],
this.__oninterval,
this);
this._disposeObjects($[331]);
}this._disposeFields($[862]);
}});
...
if(this.hasEventListeners($[95])){this.dispatchEvent(new qx.event.type.Event($[95]),
true);
}},
...
/* ID: apiviewer.Application */
qx.Class.define($[1973],
{extend:qx.application.Gui,
members:{main:function(){arguments.callee.base.call(this);
qx.Class.include(qx.ui.core.Widget,
apiviewer.MWidgetRegistry);
qx.io.Alias.getInstance().add($[1873],
qx.core.Setting.get($[2216]));
qx.html.StyleSheet.includeFile(qx.io.Alias.getInstance().resolve($[927]));
var $0=new qx.io.image.PreloaderSystem(apiviewer.TreeUtil.PRELOAD_IMAGES);
$0.start();
this.viewer=new apiviewer.Viewer;
this.controller=new apiviewer.Controller();
this.viewer.addToDocument();
qx.client.Timer.once(this._load,
this,
0);
},
_load:function(){this.controller.load($[1493]);
}},
settings:{"apiviewer.resourceUri":$[438]},
destruct:function(){this._disposeObjects($[1111],
$[1316]);
}});
...
/* ID: apiviewer.MWidgetRegistry */
qx.Mixin.define($[1066],
{properties:{id:{check:$[12],
apply:$[999],
nullable:true,
init:null}},
members:{_applyId:function($0,
$1){var $2=apiviewer.MWidgetRegistry;
if($1){$2.unregister(this,
$1);
}
if($0){$2.register(this,
$0);
}},
getWidgetById:function($0){return apiviewer.MWidgetRegistry.getWidgetById($0);
}},
statics:{__objectDb:{},
getWidgetById:function($0){return this.__objectDb[$0];
},
register:function($0,
$1){if(this.__objectDb[$1]){throw new Error("An object with the id '"+$1+"' already exists.");
}this.__objectDb[$1]=$0;
},
unregister:function($0,
$1){if(this.__objectDb[$1]!==$0){throw new Error("The object is not registered with the id '"+$1+"'.");
}delete (this.__objectDb[$1]);
}}});




/* ID: apiviewer.TreeUtil */
qx.Class.define($[2152],
{extend:qx.core.Object,
construct:function(){arguments.callee.base.call(this);
},
statics:{getChild:function($0,
$1){if($0!=null&&$0.children!=null){for(var $2=0;$2<$0.children.length;$2++){if($0.children[$2].type==$1){return $0.children[$2];
}}}return null;
},
getChildByAttribute:function($0,
$1,
$2){if($0.children!=null){for(var $3=0;$3<$0.children.length;$3++){var $4=$0.children[$3];
if($4.attributes&&$4.attributes[$1]==$2){return $4;
}}}return null;
},
getIconUrl:function($0,
$1){var $2;
var $3=apiviewer.dao;
if($0 instanceof $3.Package){$2=$[519];
}else if($0 instanceof $3.Class){switch($0.getType()){case $[89]:$2=$[384];
break;
case $[152]:$2=$[647];
break;
default:$2=$[423];
if($0.isStatic()){$2+=$[698];
}else if($0.isAbstract()){$2+=$[598];
}else if($0.isSingleton()){$2+=$[1622];
}}}else if($0 instanceof $3.Property){$2=$[2199];
if($0.isPublic()){$2+=$[604];
}else if($0.isProtected()){$2+=$[485];
}else if($0.isPrivate()||$0.isInternal()){$2+=$[429];
}
if($0.isThemeable()){$2+=$[1090];
}}else if($0 instanceof $3.Event){$2=$[401];
}else if($0 instanceof $3.Method){if($0.isConstructor()){var $2=$[1909];
}else{$2=$[1637];
if($0.isPublic()){$2+=$[604];
}else if($0.isProtected()){$2+=$[485];
}else if($0.isPrivate()||$0.isInternal()){$2+=$[429];
...
if($0.getClass().getType()==$[89]){$2+=$[1488];
}}else if($0 instanceof $3.Constant){$2=$[545];
}else if($0 instanceof $3.Appearance){$2=$[1245];
}else{throw new Error("Unknown node type: "+$0.type);
}if($0 instanceof $3.ClassItem){if($1){$2+=$[1388];
}else if($0.getOverriddenFrom&&$0.getOverriddenFrom()){$2+=$[1540];
}
if($0.getErrors().length>0){$2+=$[2206];
}}
if($0.hasWarning()){$2+=$[1401];
}return apiviewer.TreeUtil.iconNameToIconPath($2);
},
iconNameToIconPath:function($0){var $1=apiviewer.TreeUtil[$0];
if(!$1){var $2=$0.split($[106]);
var $3=$2[0]+$[106]+$2[1];
if($2[2]==$[1724]||$2[2]==$[1815]||$2[2]==$[2053]){$3+=$[106]+$2[2];
var $4=3;
}else{$4=2;
}$1=[apiviewer.TreeUtil[$3]];
if($1[0]==null){throw new Error("Unknown img constant: "+$3);
}
for(var $5=$4;$5<$2.length;$5++){var $6=apiviewer.TreeUtil[$[1859]+$2[$5]];
if($6==null){throw new Error("Unknown img constant: OVERLAY_"+$2[$5]);
}$1.push($6);
}}return $1;
},
...
defer:function($0,
$1,
$2){$0.PRELOAD_IMAGES=[$0.ICON_INFO,
$0.ICON_SEARCH,
$0.OVERLAY_ABSTRACT,
$0.OVERLAY_ERROR,
$0.OVERLAY_INHERITED,
$0.OVERLAY_OVERRIDDEN,
$0.OVERLAY_STATIC,
$0.OVERLAY_WARN,
$0.OVERLAY_MIXIN,
$0.OVERLAY_THEMEABLE,
...
$0.ICON_CLASS_ERROR,
$0.ICON_CLASS_STATIC,
$0.ICON_CLASS_STATIC_WARN,
$0.ICON_CLASS_STATIC_ERROR,
$0.ICON_CLASS_ABSTRACT,
$0.ICON_CLASS_ABSTRACT_WARN,
$0.ICON_CLASS_ABSTRACT_ERROR,
$0.ICON_CLASS_SINGLETON,
$0.ICON_CLASS_SINGLETON_WARN,
$0.ICON_CLASS_SINGLETON_ERROR,
$0.ICON_PROPERTY_PUB,
$0.ICON_PROPERTY_PROT,
$0.ICON_PROPERTY_PRIV,
$0.ICON_EVENT,
$0.ICON_INTERFACE,
$0.ICON_INTERFACE_WARN,
$0.ICON_MIXIN,
$0.ICON_MIXIN_WARN,
$0.ICON_METHOD_PUB,
$0.ICON_METHOD_PUB_INHERITED,
$0.ICON_CTOR,
$0.ICON_METHOD_PROT,
$0.ICON_METHOD_PRIV,
$0.ICON_CONSTANT];
...
qx.Class.define($[2140],
{extend:qx.ui.core.Parent,
construct:function(){arguments.callee.base.call(this);
},
properties:{mode:{check:[$[25],
$[19],
$[1711]],
init:$[25],
apply:$[2221],
...
$1){this.addToQueueRuntime($[778]);
},
_createLayoutImpl:function(){return new qx.ui.layout.impl.DockLayoutImpl(this);
},
addLeft:function($0){this._addAlignedHorizontal($[9],
arguments);
},
addRight:function($0){this._addAlignedHorizontal($[8],
arguments);
},
addTop:function($0){this._addAlignedVertical($[15],
arguments);
},
addBottom:function($0){this._addAlignedVertical($[16],
arguments);
},
...
members:{computeChildBoxWidth:function($0){if(this.getChildAlignMode($0)==$[19]){return $0.getWidthValue()||$0._computeBoxWidthFallback();
}return this.getWidget().getInnerWidth()-this._lastLeft-this._lastRight;
},
computeChildBoxHeight:function($0){if(this.getChildAlignMode($0)==$[25]){return $0.getHeightValue()||$0._computeBoxHeightFallback();
...
updateChildrenOnJobQueueFlush:function($0){if($0.mode||$0.addChild||$0.removeChild){this.getWidget()._addChildrenToLayoutQueue($[325]);
}},
flushChildrenQueue:function($0){var $1=this.getWidget(),
...
getChildAlign:function($0){return $0.getVerticalAlign()||$0.getHorizontalAlign()||$[61];
},
getChildAlignMode:function($0){return $0.getVerticalAlign()?$[25]:$0.getHorizontalAlign()?$[19]:$[61];
},
layoutChild:function($0,
...
var $0=new apiviewer.ui.PackageTree();
$0.setId($[339]);
var $1=this.__createButtonView($0,
new apiviewer.ui.SearchView(),
new apiviewer.ui.LegendView());
var $2=this.__createMainFrame(this.__createToolbar(),
this.__createDetailFrame());
this.add(this.__createVerticalSplitter($1,
$2));
},
members:{__createHeader:function(){var $0=new qx.ui.embed.HtmlEmbed($[1387]+$[1020]+qx.core.Setting.get($[333])+$[141]+$[697]+$[1860]+$[732]+qx.core.Version.toString()+$[1830]);
$0.setHtmlProperty($[145],
$[1374]);
$0.setStyleProperty($[68],
$[1642]+qx.io.Alias.getInstance().resolve($[2161])+$[1765]);
$0.setHeight(70);
return $0;
},
__createButtonView:function($0,
$1,
$2){var $3=new qx.ui.pageview.buttonview.ButtonView();
$3.set({width:$[38],
height:$[38],
border:$[2009]});
var $4=new qx.ui.pageview.buttonview.Button($[292],
apiviewer.TreeUtil.ICON_PACKAGE);
$4.setShow($[86]);
$4.setToolTip(new qx.ui.popup.ToolTip($[292]));
var $5=new qx.ui.pageview.buttonview.Button($[450],
apiviewer.TreeUtil.ICON_SEARCH);
$5.setShow($[86]);
$5.setToolTip(new qx.ui.popup.ToolTip($[450]));
var $6=new qx.ui.pageview.buttonview.Button($[1399],
apiviewer.TreeUtil.ICON_INFO);
$6.setShow($[86]);
$6.setToolTip(new qx.ui.popup.ToolTip($[964]));
$4.setChecked(true);
$3.getBar().add($4,
$5,
$6);
var $7=new qx.ui.pageview.buttonview.Page($4);
var $8=new qx.ui.pageview.buttonview.Page($5);
var $9=new qx.ui.pageview.buttonview.Page($6);
var $a=$3.getPane();
$a.add($7,
$8,
$9);
...
__createToolbar:function(){function $0($1,
$2,
$3,
$4,
$5,
$6){if(!$2){$2=qx.ui.toolbar.Button;
}var $7=new $2($1,
$3);
if($5){$7.setChecked(true);
}
if($4){$7.setToolTip(new qx.ui.popup.ToolTip($4));
}$7.setId($6);
return $7;
}var $8=new qx.ui.toolbar.ToolBar;
$8.set({horizontalChildrenAlign:$[8],
backgroundColor:$[68],
height:29,
border:$[487]});
var $9=new qx.ui.toolbar.Part;
$8.add($9);
$9.add($0($[942],
qx.ui.toolbar.CheckBox,
apiviewer.TreeUtil.iconNameToIconPath($[2077]),
$[896],
false,
$[473]));
$9.add($0($[1431],
qx.ui.toolbar.CheckBox,
apiviewer.TreeUtil.iconNameToIconPath($[643]),
$[1641],
false,
$[338]));
$9.add($0($[1336],
qx.ui.toolbar.CheckBox,
apiviewer.TreeUtil.iconNameToIconPath($[500]),
$[1972],
false,
$[307]));
return $8;
},
__createDetailFrame:function(){var $0=new qx.ui.layout.CanvasLayout;
$0.set({width:$[38],
height:$[69],
backgroundColor:$[50],
id:$[378]});
$0.setHtmlProperty($[145],
$[378]);
this._detailLoader=new qx.ui.embed.HtmlEmbed($[1737]);
this._detailLoader.setHtmlProperty($[145],
$[1196]);
this._detailLoader.setMarginLeft(20);
this._detailLoader.setMarginTop(20);
this._detailLoader.setId($[486]);
$0.add(this._detailLoader);
this._classViewer=new apiviewer.ui.ClassViewer;
this._classViewer.setId($[511]);
$0.add(this._classViewer);
this._packageViewer=new apiviewer.ui.PackageViewer;
this._packageViewer.setId($[571]);
$0.add(this._packageViewer);
return $0;
},
__createMainFrame:function($0,
$1){var $2=new qx.ui.layout.VerticalBoxLayout();
$2.set({width:$[38],
height:$[38],
border:$[818]});
$2.add($0,
...
__createVerticalSplitter:function($0,
$1){var $2=new qx.ui.splitpane.HorizontalSplitPane($[69],
$[1274]);
$2.setLiveResize(false);
$2.addLeft($0);
$2.addRight($1);
return $2;
}},
settings:{"apiviewer.title":$[465],
"apiviewer.initialTreeDepth":1},
destruct:function(){this._disposeFields($[596]);
this._disposeObjects($[494],
$[460],
$[526],
$[528]);
}});
...
properties:{orientation:{check:[$[19],
$[25]],
init:$[19],
apply:$[674],
event:$[2205]},
...
themeable:true,
apply:$[549]},
verticalChildrenAlign:{check:[$[15],
$[22],
$[16]],
init:$[15],
themeable:true,
...
defaultValue:null}},
members:{_createLayoutImpl:function(){return this.getOrientation()==$[25]?new qx.ui.layout.impl.VerticalBoxLayoutImpl(this):new qx.ui.layout.impl.HorizontalBoxLayoutImpl(this);
},
...
$1){this._layoutHorizontal=$0==$[19];
this._layoutVertical=$0==$[25];
...
if(($0.getHorizontalAlign()||this.getWidget().getHorizontalChildrenAlign())==$[39]){$0.addToLayoutChanges($[112]);
}return $1||$2;
},
updateChildOnInnerHeightChange:function($0){if(this.getWidget().getVerticalChildrenAlign()==$[22]){$0.addToLayoutChanges($[109]);
...
}if($0.spacing||$0.orientation||$0.reverseChildrenOrder||$0.verticalChildrenAlign){$3._addChildrenToLayoutQueue($[109]);
}
if($0.horizontalChildrenAlign){$3._addChildrenToLayoutQueue($[112]);
}
if($0.stretchChildrenOrthogonalAxis){$1=true;
}if($1){$3._recomputeChildrenStretchingX();
$3._addChildrenToLayoutQueue($[36]);
}
...
}switch($2.getLayoutMode()){case $[16]:case $[248]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[109]);
}break;
case $[22]:case $[253]:while($5=$3[++$6]){$5.addToLayoutChanges($[109]);
}break;
default:$6+=$1;
while($5=$3[++$6]){$5.addToLayoutChanges($[109]);
}}},
updateChildrenOnMoveChild:function($0,
$1,
...
var $5=Math.max($1,
$2)+1;
for(var $6=$4;$6<$5;$6++){$3[$6].addToLayoutChanges($[109]);
}},
flushChildrenQueue:function($0){var $1=this.getWidget(),
$2=$1.getVisibleChildren(),
$3=$2.length,
...
switch($1.getLayoutMode()){case $[16]:case $[248]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[22]:case $[253]:$5=-1;
...
layoutChild_locationY:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[16]:case $[248]:var $3=$2.getPaddingBottom()+$2.getAccumulatedChildrenOuterHeight()-$0.getOuterHeight();
break;
case $[22]:case $[253]:var $3=$2.getPaddingTop()+Math.round(($2.getInnerHeight()-$2.getAccumulatedChildrenOuterHeight())/2);
break;
default:var $3=$2.getPaddingTop();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[16]:case $[248]:var $3=$4._cachedLocationVertical-$0.getOuterHeight()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationVertical+$4.getOuterHeight()+$2.getSpacing();
}}$0._cachedLocationVertical=$3;
switch(this.getWidget().getLayoutMode()){case $[16]:case $[1570]:case $[253]:$3+=!$0._computedBottomTypeNull?$0.getBottomValue():!$0._computedTopTypeNull?-($0.getTopValue()):0;
$0._resetRuntimeTop();
...
$1){var $2=this.getWidget();
if(qx.core.Variant.isSet($[1],
$[31])){if($0.getAllowStretchX()&&$2.getStretchChildrenOrthogonalAxis()&&$0._computedWidthTypeNull){$0._renderRuntimeLeft($2.getPaddingLeft()||0);
$0._renderRuntimeRight($2.getPaddingRight()||0);
return;
}}var $3=$0.getHorizontalAlign()||$2.getHorizontalChildrenAlign();
var $4=$3==$[39]?Math.round(($2.getInnerWidth()-$0.getOuterWidth())/2):0;
...
qx.Class.define($[1864],
{statics:{isValid:function($0){switch(typeof $0){case $[5]:return false;
case $[34]:return $0!==null;
case $[10]:return $0!==$[0];
case $[66]:return !isNaN($0);
case $[47]:case $[70]:return true;
}return false;
},
...
case $[10]:return $0===$[0];
case $[66]:return isNaN($0);
case $[47]:case $[70]:return false;
}return true;
},
isValidNumber:function($0){return typeof $0===$[66]&&!isNaN($0);
},
isInvalidNumber:function($0){return typeof $0!==$[66]||isNaN($0);
},
isValidString:function($0){return typeof $0===$[10]&&$0!==$[0];
},
isInvalidString:function($0){return typeof $0!==$[10]||$0===$[0];
},
isValidArray:function($0){return typeof $0===$[34]&&$0!==null&&$0 instanceof Array;
},
isInvalidArray:function($0){return typeof $0!==$[34]||$0===null||!($0 instanceof Array);
},
isValidObject:function($0){return typeof $0===$[34]&&$0!==null&&!($0 instanceof Array);
},
isInvalidObject:function($0){return typeof $0!==$[34]||$0===null||$0 instanceof Array;
},
isValidNode:function($0){return typeof $0===$[34]&&$0!==null;
},
isInvalidNode:function($0){return typeof $0!==$[34]||$0===null;
},
isValidElement:function($0){return typeof $0===$[34]&&$0!==null||$0.nodeType!==1;
},
isInvalidElement:function($0){return typeof $0!==$[34]||$0===null||$0.nodeType!==1;
},
isValidFunction:function($0){return typeof $0===$[47];
},
isInvalidFunction:function($0){return typeof $0!==$[47];
},
isValidBoolean:function($0){return typeof $0===$[70];
},
isInvalidBoolean:function($0){return typeof $0!==$[70];
},
isValidStringOrNumber:function($0){switch(typeof $0){case $[10]:return $0!==$[0];
case $[66]:return !isNaN($0);
}return false;
},
isInvalidStringOrNumber:function($0){switch(typeof $0){case $[10]:return $0===$[0];
case $[66]:return isNaN($0);
}return false;
}}});
...
updateChildOnInnerWidthChange:function($0){if(this.getWidget().getHorizontalChildrenAlign()==$[39]){$0.addToLayoutChanges($[112]);
...
if(($0.getVerticalAlign()||this.getWidget().getVerticalChildrenAlign())==$[22]){$0.addToLayoutChanges($[109]);
}return $1||$2;
},
...
var $3=this.getWidget();
if($0.orientation){$1=$2=true;
}if($0.spacing||$0.orientation||$0.reverseChildrenOrder||$0.horizontalChildrenAlign){$3._addChildrenToLayoutQueue($[112]);
}
if($0.verticalChildrenAlign){$3._addChildrenToLayoutQueue($[109]);
}
...
}switch($2.getLayoutMode()){case $[8]:case $[226]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[112]);
}break;
case $[39]:case $[254]:while($5=$3[++$6]){$5.addToLayoutChanges($[112]);
}break;
default:$6+=$1;
while($5=$3[++$6]){$5.addToLayoutChanges($[112]);
}}},
updateChildrenOnMoveChild:function($0,
$1,
$2){var $3=this.getWidget().getVisibleChildren();
...
var $5=Math.max($1,
$2)+1;
for(var $6=$4;$6<$5;$6++){$3[$6].addToLayoutChanges($[112]);
}},
flushChildrenQueue:function($0){var $1=this.getWidget(),
$2=$1.getVisibleChildren(),
$3=$2.length,
...
switch($1.getLayoutMode()){case $[8]:case $[226]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[39]:case $[254]:$5=-1;
while($4=$2[++$5]){$1._layoutChild($4);
}break;
default:$5=-1;
var $7=false;
...
layoutChild_locationX:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[8]:case $[226]:var $3=$2.getPaddingRight()+$2.getAccumulatedChildrenOuterWidth()-$0.getOuterWidth();
break;
case $[39]:case $[254]:var $3=$2.getPaddingLeft()+Math.round(($2.getInnerWidth()-$2.getAccumulatedChildrenOuterWidth())/2);
break;
default:var $3=$2.getPaddingLeft();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[8]:case $[226]:var $3=$4._cachedLocationHorizontal-$0.getOuterWidth()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationHorizontal+$4.getOuterWidth()+$2.getSpacing();
}}$0._cachedLocationHorizontal=$3;
switch($2.getLayoutMode()){case $[8]:case $[1330]:case $[254]:$3+=!$0._computedRightTypeNull?$0.getRightValue():!$0._computedLeftTypeNull?-($0.getLeftValue()):0;
$0._resetRuntimeLeft();
...
$1){var $2=this.getWidget();
if(qx.core.Variant.isSet($[1],
$[31])){if($0.getAllowStretchY()&&$2.getStretchChildrenOrthogonalAxis()&&$0._computedHeightTypeNull){$0._renderRuntimeTop($2.getPaddingTop()||0);
$0._renderRuntimeBottom($2.getPaddingBottom()||0);
return;
}}var $3=$0.getVerticalAlign()||$2.getVerticalChildrenAlign();
var $4=$3==$[22]?Math.round(($2.getInnerHeight()-$0.getOuterHeight())/2):0;
if($3==$[16]){$4+=$2.getPaddingBottom();
...
this._labelObject.setStyleProperty($[289],
$[38]);
this._labelObject.setMode($[98]);
arguments.callee.base.call(this);
...
}this._iconObject.setAppearance($[671]);
this._labelObject.setAppearance($[513]);
this.addEventListener($[26],
this._onmousedown);
this.addEventListener($[23],
this._onmouseup);
},
...
$1){if($0){this.addState($[52]);
this._labelObject.addState($[52]);
}else{this.removeState($[52]);
this._labelObject.removeState($[52]);
}var $2=this.getTree();
if(!$2._fastUpdate||($1&&$2._oldItem==this)){this._iconObject.setSource(this._evalCurrentIcon());
if($0){this._iconObject.addState($[52]);
}else{this._iconObject.removeState($[52]);
...
getParentFolder:function(){if(this.getParent()&&typeof (this.getParent().getParent)==$[47]){return this.getParent().getParent();
}return null;
},
...
destruct:function(){this._disposeObjects($[910],
$[660],
$[381]);
this._disposeFields($[1476]);
}});
...
$1){if(typeof $1==$[70]){$0.setAnonymous($1);
}this._fields.push($0);
},
getLabelObject:function(){return this._labelObject;
},
...
destruct:function(){this._disposeFields($[949]);
this._disposeObjects($[1698],
$[1880],
$[1055]);
this._disposeObjectDeep($[1299],
1);
}});
...
$1){$0===null?this.removeStyleProperty($[157]):this.setStyleProperty($[157],
$0);
},
_applyFont:function($0,
...
_styleTextColor:function($0){$0?this.setStyleProperty($[179],
$0):this.removeStyleProperty($[179]);
},
...
$1,
$2){arguments.callee.base.call(this);
this._blank=qx.io.Alias.getInstance().resolve($[120]);
...
$1){if($1){$1.removeEventListener($[95],
this._onload,
this);
...
$[164])){this._image=document.createElement($[505]);
}else{this._image=new Image;
}this._image.style.border=$[555];
this._image.style.verticalAlign=$[15];
this._image.alt=$[0];
this._image.title=$[0];
...
$0.style.filter=$[399]+$2+$[695];
}else{$0.src=$2;
$0.style.filter=this.getEnabled()?$[0]:$[764];
}},
...
if(!$0){$0=document.createElement($[142]);
var $1=$0.style;
$1.width=$1.height=$[3];
$1.visibility=$[21];
$1.position=$[82];
...
$1){$0==null?this.removeStyleProperty($[203]):this.setStyleProperty($[203],
$0?$[173]:$[281]);
},
...
if($1===$[3]){$1=qx.util.Validation.isValidString($0)&&$0.match(/<.*>/)?$[368]:$[98];
}
switch($1){case $[98]:var $2=qx.html.String.escape($0).replace(/(^ | $)/g,
$[334]).replace(/  /g,
$[1261]);
this._isHtml=$2!==$0;
this._content=$2;
break;
case $[368]:this._isHtml=true;
this._content=$0;
break;
}
...
$1){this._mnemonicTest=$0?new RegExp($[2181]+$0+$[1527]+$0+$[1408]+$0+$[2134]+$0+$[57],
$[337]):null;
if(this._isCreated){this._renderContent();
}},
...
$1){return ($[1112]+($1-14)+$[1968]+$0+$[1429]);
},
...
if(this.getMnemonic()){if(this._mnemonicTest.test($0)){$0=RegExp.$1+$[1084]+RegExp.$7+$[141]+RegExp.rightContext;
this._isHtml=true;
}else{$0+=$[2017]+this.getMnemonic()+$[57];
}}var $2=$1.style;
if(this.getTextOverflow()&&!this.getWrap()){if(this.getInnerWidth()<this.getPreferredInnerWidth()){$2.overflow=$[21];
if(qx.core.Variant.isSet($[1],
$[430])){$2.textOverflow=$[224];
}else if(qx.core.Variant.isSet($[1],
$[118])){$2.OTextOverflow=$[224];
}else{$0=this.__patchTextOverflow($0,
this.getInnerWidth());
this._isHtml=true;
}}else{$2.overflow=$[0];
if(qx.core.Variant.isSet($[1],
$[430])){$2.textOverflow=$[0];
}else if(qx.core.Variant.isSet($[1],
$[118])){$2.OTextOverflow=$[0];
}}}
...
properties:{locale:{check:$[12],
nullable:true,
apply:$[741],
event:$[1413]}},
members:{_defaultLocale:$[872],
getLanguage:function(){return this._language;
},
getTerritory:function(){return this.getLocale().split($[106])[1]||$[0];
},
...
$1){this.addTranslation($0.substring($0.lastIndexOf($[24])+1),
$1);
},
...
destruct:function(){this._disposeFields($[1157]);
}});
...
getTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[646]:qx.core.Client.getInstance().supportsInnerText()?$[638]:$[61],
...
setTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[646]:qx.core.Client.getInstance().supportsInnerText()?$[638]:$[61],
...
this._iconObject.setAppearance($[524]);
this._labelObject.setAppearance($[666]);
this.addEventListener($[155],
this._ondblclick);
...
events:{"treeOpenWithContent":$[110],
"treeOpenWhileEmpty":$[110],
"treeClose":$[110]},
properties:{appearance:{refine:true,
init:$[360]},
icon:{refine:true,
...
if(this.hasContent()){if(this.getTree().hasEventListeners($[517])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[517],
this),
true);
}this.getTopLevelWidget().setGlobalCursor($[761]);
qx.client.Timer.once(this._openCallback,
this,
0);
}else{if(this.getTree().hasEventListeners($[507])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[507],
this),
true);
}this.setOpen(true);
}},
close:function(){if(this.getTree().hasEventListeners($[389])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[389],
this),
true);
...
_createChildrenStructure:function(){if(!(this instanceof qx.ui.tree.Tree)){this.setHeight($[3]);
}this.setVerticalChildrenAlign($[15]);
if(!this._horizontalLayout){this.setOrientation($[25]);
...
this._horizontalLayout.setAppearance(this instanceof qx.ui.tree.Tree?$[339]:$[360]);
this.setAppearance($[237]);
...
this._containerObject.setHeight($[3]);
...
var $6=$5[$3-$1-1];
if($1==$2){if(this.hasContent()||this.getAlwaysShowPlusMinusSymbol()){if(!$0){return this.getOpen()?$[586]:$[417];
}if($4==1){var $7=this.getParentFolder();
if($7&&!$7._horizontalLayout.getVisibility()&&this.isFirstChild()){if(this.isLastChild()||$6===true){return this.getOpen()?$[351]:$[282];
}else{return this.getOpen()?$[1442]:$[1138];
}}}
if($6===true){return this.getOpen()?$[351]:$[282];
}else if(this.isLastChild()){return this.getOpen()?$[1295]:$[1539];
}else{return this.getOpen()?$[1872]:$[1766];
}}else if($0&&!($6===true)){return this.isLastChild()?$[546]:$[539];
...
destruct:function(){this._disposeFields($[955]);
this._disposeObjects($[838],
$[2122]);
}});
...
this._iconObject.setAppearance($[857]);
this._labelObject.setAppearance($[2048]);
this.setOpen(true);
this.addToFolder();
...
init:1},
excludeSpecificTreeLines:{check:$[320],
init:[],
apply:$[2046]},
hideNode:{check:$[2],
init:false,
...
getExcludeSpecificTreeLines:function(){return qx.lang.Array.clone(this[$[1441]]);
},
...
switch($0.getKeyIdentifier()){case $[114]:$0.preventDefault();
if(qx.ui.tree.Tree.isTreeFolder($2)){return $2.toggle();
}break;
case $[153]:$0.preventDefault();
...
getIndentSymbol:function($0,
$1,
$2){if($1==$2&&(this.hasContent()||this.getAlwaysShowPlusMinusSymbol())){if(!$0){return this.getOpen()?$[586]:$[417];
}else{return this.getOpen()?$[351]:$[282];
}}else{return null;
}}},
destruct:function(){this._disposeObjects($[299]);
}});
...
events:{"changeSelection":$[110]},
properties:{boundedWidget:{check:$[184],
nullable:true},
...
if(this._activeDragSession){this.getBoundedWidget().addEventListener($[23],
this._ondragup,
this);
this.getBoundedWidget().setCapture(true);
}},
_ondragup:function($0){this.getBoundedWidget().removeEventListener($[23],
this._ondragup,
this);
...
var $2=this.getFireChange();
this.setFireChange(false);
if($0.getKeyIdentifier()==$[209]&&$0.isCtrlPressed()){if(this.getMultiSelection()){this._selectAll();
...
}else if($0.getKeyIdentifier()==$[176]){if(this._selectedItems.contains($4)){this.renderItemSelectionState($4,
false);
...
}switch($0.getKeyIdentifier()){case $[302]:return this.getHome(this.getLeadItem());
case $[369]:return this.getEnd(this.getLeadItem());
case $[273]:return this.getDown(this.getLeadItem());
case $[235]:return this.getUp(this.getLeadItem());
case $[153]:return this.getLeft(this.getLeadItem());
case $[154]:return this.getRight(this.getLeadItem());
case $[354]:return this.getPageUp(this.getLeadItem())||this.getHome(this.getLeadItem());
case $[361]:return this.getPageDown(this.getLeadItem())||this.getEnd(this.getLeadItem());
case $[176]:if($0.isCtrlPressed()){return this.getLeadItem();
}}return null;
},
_dispatchChange:function(){if(!this.getFireChange()){return;
}
if(this.hasEventListeners($[373])){this.dispatchEvent(new qx.event.type.DataEvent($[373],
...
destruct:function(){this._disposeObjects($[940]);
}});
...
destruct:function(){this._disposeFields($[1963],
$[1800]);
}});
...
var $5=$4[$3-$1-1];
if($0&&!($5===true)){if($1==$2){return this.isLastChild()?$[546]:$[539];
}else{return $[471];
}}return null;
},
...
/* ID: apiviewer.ui.PackageTree */
qx.Class.define($[1355],
{extend:qx.ui.tree.Tree,
construct:function(){arguments.callee.base.call(this,
$[292]);
this.set({backgroundColor:$[50],
overflow:$[42],
width:$[38],
height:$[38],
paddingLeft:5,
...
members:{setTreeData:function($0){this._docTree=$0;
this.removeAll();
this.__fillPackageNode(this,
$0,
0);
this.open();
if(this._wantedClassName){this.selectTreeNodeByClassName(this._wantedClassName);
this._wantedClassName=null;
}},
selectTreeNodeByClassName:function($0){if(this._docTree==null){this._wantedClassName=$0;
return true;
}var $1=$0.split($[24]);
var $2=$1[0];
var $3=0;
do{var $4=this._classTreeNodeHash[$2];
if(!$4){return false;
}
if(!$4.loaded){$4.setOpen(true);
}$3++;
$2+=$[24]+$1[$3];
}while($3<$1.length);
$4.setSelected(true);
if($4.isMaterialized()){$4.scrollIntoView();
}else{qx.client.Timer.once(function(){$4.scrollIntoView();
},
this,
100);
}return true;
},
__getPackageNodeOpener:function($0,
$1,
$2){var $3=this;
return function(){if(!$0.loaded){$3.__fillPackageNode($0,
$1,
$2+1);
$0.setAlwaysShowPlusMinusSymbol(false);
}};
},
__fillPackageNode:function($0,
$1,
$2){$0.loaded=true;
var $3=apiviewer.ui.PackageTree;
var $4=$1.getPackages();
for(var $5=0;$5<$4.length;$5++){var $6=$4[$5];
var $7=apiviewer.TreeUtil.getIconUrl($6);
var $8=new qx.ui.tree.TreeFolder($6.getName(),
$7);
$8.setAlwaysShowPlusMinusSymbol(true);
$8.setUserData($[215],
$6.getFullName());
$0.add($8);
$8.addEventListener($[534],
this.__getPackageNodeOpener($8,
$6,
$2+1),
this);
if($2<qx.core.Setting.get($[1186])&&$6.getPackages().length>0){$8.open();
}this._classTreeNodeHash[$6.getFullName()]=$8;
}var $9=$1.getClasses();
for(var $5=0;$5<$9.length;$5++){var $a=$9[$5];
var $7=apiviewer.TreeUtil.getIconUrl($a);
var $b=new qx.ui.tree.TreeFolder($a.getName(),
$7);
$b.setUserData($[215],
$a.getFullName());
$b.treeType=$3.PACKAGE_TREE;
$0.add($b);
this._classTreeNodeHash[$a.getFullName()]=$b;
}}},
destruct:function(){this._disposeFields($[1486],
$[596]);
}});
...
/* ID: apiviewer.ui.SearchView */
qx.Class.define($[1214],
...
function(){qx.client.Timer.once(this._showSearchForm,
this,
0);
},
this);
},
members:{_showSearchForm:function(){if(this.__initialized){return;
...
this.sinput.setWidth($[69]);
this.__button=new qx.ui.form.Button($[1686]);
this.__button.setEnabled(false);
this.optLabel=new qx.ui.toolbar.Button(null,
$[274]);
this.optLabel.set({marginLeft:10,
backgroundColor:$[50]});
this.optTooltipShow=new qx.ui.popup.ToolTip($[1263]);
this.optTooltipHide=new qx.ui.popup.ToolTip($[1727]);
this.optLabel.setToolTip(this.optTooltipShow);
this.optLabel.addEventListener($[93],
function(){this.__toggleOptions($1);
},
this);
this.add($0.add(this.sinput,
this.__button,
this.optLabel));
...
border:$[487],
spacing:4});
var $2=new qx.ui.form.CheckBox($[720],
$[864],
$[1227],
true);
this.add($1.add($2));
$2.addEventListener($[146],
function($3){this.__toggleLivesearch();
},
this);
qx.client.Timer.once(this._load,
this,
0);
this.sinput.addEventListener($[128],
function($3){this.sinput.getInputElement().focus();
},
this);
this.sinput.addEventListener($[35],
function($3){if($3.getKeyIdentifier()==$[114]){this._searchResult(this.sinput.getValue());
}},
this);
this.__button.addEventListener($[474],
function($3){this._searchResult(this.sinput.getValue());
},
this);
this.sinput.addEventListener($[166],
function($3){this._searchResult(this.sinput.getValue(),
$3);
},
this);
...
_searchResult:function($0,
$1){var $2=new Date();
var $0=qx.lang.String.trim($0);
if($0.length<2){if(this.__initresult){this.listdata.splice(0,
this.listdata.length);
this.rlv.getHeader()._columns[$[318]].headerCell.setLabel($[633]);
this.rlv.update();
}this.sinput.resetBackgroundColor();
this.__button.setEnabled(false);
return;
}else{var $3=[];
try{var $4=this._validateInput($0);
new RegExp($4[0]);
this.sinput.resetBackgroundColor();
this.__button.setEnabled(true);
}catch(ex){if(this.__initresult){this.listdata.splice(0,
this.listdata.length);
this.rlv.getHeader()._columns[$[318]].headerCell.setLabel($[633]);
this.rlv.update();
}this.sinput.setBackgroundColor($[1165]);
this.__button.setEnabled(false);
return;
}
if(!$1||($1.getType()==$[166]&&this.__livesearch)){$3=this._searchIndex($4[0],
$4[1]);
}else return;
var $5=new Date();
var $6=$3.length;
var $7=($5.getTime()-$2.getTime())/1000;
if(this.__initresult){this.listdata.splice(0,
this.listdata.length);
this.rlv.getHeader()._columns[$[318]].headerCell.setLabel($6+$[478]+$7+$[616]);
this._setListdata($3);
this.rlv.update();
}else{this.listdata=[];
var $8={icon:{label:$[53],
...
align:$[39],
sortable:true,
sortMethod:this._sortByIcons,
sortProp:$[86]},
result:{label:$6+$[478]+$7+$[616],
width:$[1759],
type:$[98],
sortable:true,
sortProp:$[98]}};
this.rlv=new qx.ui.listview.ListView(this.listdata,
$8);
this.rlv.setHeight($[69]);
this.rlv.setBorder(null);
this.add(this.rlv);
var $9=this.rlv.getPane();
$9.getManager().setMultiSelection(false);
$9.addEventListener($[93],
function($a){this._callDetailFrame($a.getCurrentTarget().getManager());
},
this);
$9.addEventListener($[35],
function($a){if($a.getKeyIdentifier()==$[114]){this._callDetailFrame($a.getCurrentTarget().getManager());
}},
this);
this._setListdata($3);
this.rlv.update();
...
_validateInput:function($0){var $1=[];
if(/^([\w\.]*\w+)(#\w+|\.\w+\(\)|#\.[\*|\+|\?]?)?$/.test($0)){if(RegExp.$2&&RegExp.$2.length>1){$1=[RegExp.$2,
RegExp.$1];
}else if(RegExp.$1.length>1){$1=[RegExp.$1,
null];
}else{return null;
}}else{$1=[$0,
null];
...
_searchIndex:function($0,
$1){var $2=[];
var $3=new RegExp($0,
(/^.*[A-Z].*$/).test($0)?$[0]:$[337]);
var $4=this.apiindex.__index__;
var $5=this.apiindex.__fullNames__;
var $6=this.apiindex.__types__;
for(var $7 in $4){if($3.test($7)){for(var $8=0,
$9=$4[$7].length;$8<$9;$8++){var $a=$6[$4[$7][$8][0]].toUpperCase();
if($1){var $b=$5[$4[$7][$8][1]];
if(new RegExp($1,
$[337]).test($b)){var $c=apiviewer.TreeUtil[$[575]+$a];
$2.push([$c,
$b+$7]);
}}else{var $c=apiviewer.TreeUtil[$[575]+$a];
var $d=$[0];
if($a!=$[1215]&&$a!=$[1078]&&$a!=$[1249]&&$a!=$[1400]){$d=$7;
}var $b=$5[$4[$7][$8][1]]+$d;
$2.push([$c,
$b]);
}}}}return $2;
},
_setListdata:function($0){$0.sort(function($1,
$2){if($1[1]<$2[1])return -1;
if($1[1]>$2[1])return 1;
return 0;
});
for(var $3=0,
$4=$0.length;$3<$4;$3++){var $5=$0[$3][0];
var $6={icon:$5,
html:$[0],
iconWidth:18,
iconHeight:18};
this.listdata.push({icon:$6,
result:{text:$0[$3][1]}});
}},
_sortByIcons:function($0,
$1){var $2={"package":0,
"class":1,
"interface":2,
"mixin":3,
...
"constructor":11,
"constant":12};
var $3=$0.substr($0.lastIndexOf($[111])+1);
var $4=$1.substr($1.lastIndexOf($[111])+1);
$0=$2[$3.substr(0,
$3.length-6)];
$1=$2[$4.substr(0,
$4.length-6)];
...
__toggleLivesearch:function(){if(this.__livesearch===false){this.__livesearch=true;
}else{this.__livesearch=false;
}},
__toggleOptions:function($0){if(this.__showoptions===false){this.__showoptions=true;
this.optLabel.setIcon($[434]);
this.optLabel.setToolTip(this.optTooltipHide);
$0.setHeight($[3]);
}else{this.__showoptions=false;
this.optLabel.setIcon($[274]);
this.optLabel.setToolTip(this.optTooltipShow);
$0.setHeight(1);
}},
_load:function(){var $0=new Date();
var $1=$[1869];
var $2=new qx.io.remote.Request($1);
$2.setAsynchronous(true);
$2.setTimeout(30000);
$2.setProhibitCaching(false);
$2.addEventListener($[18],
function($3){this.apiindex=eval($[102]+$3.getContent()+$[57]);
var $4=new Date();
this.info("Time to load api indexfile from server: "+($4.getTime()-$0.getTime())+"ms");
},
this);
$2.addEventListener($[27],
function($3){alert("Couldn't load file: "+$1);
},
this);
$2.send();
},
_callDetailFrame:function($0){var $1=$0.getSelectedItems()[0].result.text;
var $2=$0.getSelectedItems()[0].icon.icon;
var $3=$1;
var $4=null;
var $5=$1.indexOf($[59]);
if($5!=-1){$3=$1.substring(0,
$5);
$4=$1.substring($5+1);
}var $6=qx.core.Init.getInstance().getApplication().controller;
var $7=$6._classViewer;
if(/protected/.test($2)){var $8=$6._widgetRegistry.getWidgetById($[338]);
if($8.getChecked()===false){$8.setChecked(true);
$7.setShowProtected(true);
}}else if(/private/.test($2)){var $9=$6._widgetRegistry.getWidgetById($[307]);
if($9.getChecked()===false){$9.setChecked(true);
$7.setShowPrivate(true);
}}$6.__selectClass(apiviewer.dao.Class.getClassByName($3),
function(){if($4){if(!$7.showItem($4)){$6.error("Unknown item of class '"+$3+"': "+$4);
alert("Unknown item of class '"+$3+"': "+$4);
return;
}}else{$7.setScrollTop(0);
}$6.__updateHistory($1);
},
$6);
}},
destruct:function(){this._disposeFields($[1369]);
this._disposeObjects($[1271],
$[1846]);
}});
...
this);
this.addEventListener($[277],
this._onblur);
this.addEventListener($[263],
this._onfocus);
this.addEventListener($[127],
this._oninput);
},
...
_syncFieldWidth:function(){this._inputElement.style.width=this.getInnerWidth()+$[48];
},
_syncFieldHeight:function(){this._inputElement.style.height=(this.getInnerHeight()-2)+$[48];
},
_applyCursor:function($0,
...
if($1){if($1==$[342]&&qx.core.Client.getInstance().isMshtml()){$0.cursor=$[221];
}else{$0.cursor=$1;
}}else{$0.cursor=$[0];
}},
_applyTextAlign:function($0,
...
if($0){this.addState($[655]);
}else{this.removeState($[655]);
}},
_applyTextColor:function($0,
$1){qx.theme.manager.Color.getInstance().connect(this._styleTextColor,
this,
...
{"mshtml":function($0){if(!this._inValueProperty&&$0.propertyName===$[291]){this.createDispatchDataEvent($[127],
this.getComputedValue());
}},
"default":function($0){this.createDispatchDataEvent($[127],
this.getComputedValue());
}}),
...
}else{this._inputElement.removeEventListener($[127],
this.__oninput,
false);
}}this._disposeFields($[2097],
$[1662],
$[1757]);
}});
...
}if(qx.Class.isDefined($[448])&&$4!=null&&$2!=null&&$3!=null&&qx.ui.embed.Flash.getPlayerVersion().getMajor()>0){this._flashMode=true;
this.setIcon($4);
...
_createIcon:function(){if(this._flashMode&&qx.Class.isDefined($[448])){var $0=this._iconObject=new qx.ui.embed.Flash(this.getIcon());
...
$1){switch($0){case $[15]:case $[16]:this.setOrientation($[25]);
this.setReverseChildrenOrder($0==$[16]);
break;
default:this.setOrientation($[19]);
...
_handleLabel:function(){switch(this.getShow()){case $[186]:case $[117]:case $[126]:this._labelIsVisible=!!this.getLabel();
break;
...
_handleIcon:function(){switch(this.getShow()){case $[86]:case $[117]:case $[126]:this._iconIsVisible=!!this.getIcon();
break;
...
destruct:function(){this._disposeObjects($[660],
$[381]);
}});
...
$4);
this.initTabIndex();
this.addEventListener($[90],
this._onmouseover);
this.addEventListener($[134],
this._onmouseout);
this.addEventListener($[26],
this._onmousedown);
this.addEventListener($[23],
...
if(this.hasState($[73])){this.removeState($[73]);
this.addState($[62]);
}this.addState($[74]);
},
_onmouseout:function($0){if($0.getTarget()!=this){return;
}this.removeState($[74]);
if(this.hasState($[62])){this.setCapture(true);
this.removeState($[62]);
this.addState($[73]);
}},
...
var $1=this.hasState($[62]);
var $2=this.hasState($[73]);
if($1){this.removeState($[62]);
}
if($2){this.removeState($[73]);
}
if(!$2){this.addState($[74]);
if($1){this.execute();
}}},
_onkeydown:function($0){switch($0.getKeyIdentifier()){case $[114]:case $[176]:this.removeState($[73]);
this.addState($[62]);
$0.stopPropagation();
}},
_onkeyup:function($0){switch($0.getKeyIdentifier()){case $[114]:case $[176]:if(this.hasState($[62])){this.removeState($[73]);
this.removeState($[62]);
this.execute();
$0.stopPropagation();
}}}}});
...
init:true},
restrictToPageLeft:{check:$[11],
init:0},
restrictToPageRight:{check:$[11],
init:0},
restrictToPageTop:{check:$[11],
init:0},
restrictToPageBottom:{check:$[11],
init:0}},
...
if(qx.Class.isDefined($[171])){var $1=qx.lang.Object.getValues(qx.ui.menu.Manager.getInstance().getAll());
...
if(qx.Class.isDefined($[269])&&$0 instanceof qx.ui.popup.ToolTip&&!($1 instanceof qx.ui.popup.ToolTip)){continue;
}$1.hide();
}}}});
...
qx.Class.define($[713],
{statics:{__umlautsRegExp:new RegExp($[2139],
$[599]),
__umlautsShortData:{"\xC4":$[209],
"\xD6":$[1362],
"\xDC":$[867],
"\xE4":$[385],
"\xF6":$[909],
...
$4-=this.__num($2,
$[81]);
if($1.compatMode===$[100]){$3+=this.__num($2,
$[178]);
$4+=this.__num($2,
$[172]);
}return {left:$3,
...
var $2=$1.offsetLeft;
var $3=$1.offsetTop;
if(qx.bom.element.Dimension.getBoxSizing($1)!==$[265]){$2+=this.__num($1,
$[85]);
$3+=this.__num($1,
$[81]);
if(!$0.getBoundingClientRect){var $4;
while($0){if(this.__style($0,
$[94])===$[82]||this.__style($0,
$[94])===$[140]){$4=true;
break;
}$0=$0.offsetParent;
}
...
var $3=$2.left;
var $4=$2.top;
if($1.compatMode===$[100]){$3-=this.__num($0,
$[85]);
$4-=this.__num($0,
$[81]);
...
if($5.getBoxSizing($0)!==$[265]){$2-=this.__num($0,
$[85]);
$3-=this.__num($0,
$[81]);
}
...
$[76])!=$[2066]){$2+=this.__num($0.parentNode,
$[85]);
...
if($0.tagName==$[1036]){var $3=$2.left;
var $4=$2.top;
...
if($1){switch($1){case $[565]:$3-=this.__num($0,
$[178]);
$4-=this.__num($0,
$[172]);
$7+=this.__num($0,
...
$8-=this.__num($0,
$[122]);
case $[42]:$3-=$0.scrollLeft;
$4-=$0.scrollTop;
$7+=$0.scrollLeft;
$8+=$0.scrollTop;
case $[189]:$3+=this.__num($0,
$[85]);
$4+=this.__num($0,
$[81]);
$7-=this.__num($0,
...
"default":function($0){return $0.getAttribute($[55]);
}}),
COMPUTED_MODE:1,
CASCADED_MODE:2,
LOCAL_MODE:3,
...
"mshtml":function($0){if(qx.bom.Document.isStandardMode(qx.dom.Node.getDocument($0))){if(!this.__usesNativeBorderBox($0)){return $[2024];
}}return $[265];
},
...
/* ID: qx.bom.Document */
qx.Class.define($[1477],
{statics:{isQuirksMode:function($0){return ($0||window).document.compatMode!==$[100];
},
isStandardMode:function($0){return ($0||window).document.compatMode===$[100];
},
getWidth:function($0){var $1=($0||window).document;
var $2=qx.bom.Viewport.getWidth($0);
var $3=$1.compatMode===$[100]?$1.documentElement.scrollWidth:$1.body.scrollWidth;
return Math.max($3,
$2);
},
getHeight:function($0){var $1=($0||window).document;
var $2=qx.bom.Viewport.getHeight($0);
var $3=$1.compatMode===$[100]?$1.documentElement.scrollHeight:$1.body.scrollHeight;
return Math.max($3,
$2);
}}});
...
destruct:function(){this._disposeObjects($[948]);
}});
...
hideOnHover:{check:$[2],
init:true},
mousePointerOffsetX:{check:$[11],
init:1},
mousePointerOffsetY:{check:$[11],
init:20},
showInterval:{check:$[11],
init:1000,
apply:$[869]},
hideInterval:{check:$[11],
init:4000,
apply:$[1034]},
boundToWidget:{check:$[184],
apply:$[875]}},
...
{type:$[29],
extend:qx.util.manager.Object,
properties:{currentToolTip:{check:$[269],
nullable:true,
apply:$[2162]}},
...
_handleIcon:function(){switch(this.getShow()){case $[86]:case $[117]:this._iconIsVisible=true;
break;
default:this._iconIsVisible=false;
}
if(this._iconIsVisible){this._iconObject?this._iconObject.setDisplay(true):this._createIcon();
...
_onkeydown:function($0){if($0.getKeyIdentifier()==$[114]&&!$0.isAltPressed()){this.toggleChecked();
}},
_onkeyup:function($0){if($0.getKeyIdentifier()==$[176]){this.toggleChecked();
}}}});
...
init:false,
apply:$[220]}},
members:{_createElementImpl:function(){this.setElement(this.getTopLevelWidget().getDocumentElement().createElement($[127]));
},
_applyName:function($0,
$1){return this.setHtmlProperty($[637],
$0);
},
_applyValue:function($0,
$1){return this.setHtmlProperty($[291],
$0);
},
_applyType:function($0,
$1){return this.setHtmlProperty($[2040],
$0);
},
_applyChecked:function($0,
$1){return this.setHtmlProperty($[188],
$0);
},
...
"default":qx.lang.Function.returnTrue}),
_applyEnabled:function($0,
$1){$0===false?this.setHtmlProperty($[204],
$[204]):this.removeHtmlProperty($[204]);
return arguments.callee.base.call(this,
$0,
$1);
}},
...
this._scroll.setWidth($[3]);
this._scroll.setParent(this._frame);
this._scroll.addEventListener($[166],
this._onscroll,
this);
this._resizeLine=new qx.ui.basic.Terminator;
this._resizeLine.setBackgroundColor($[1071]);
...
destruct:function(){this._disposeObjects($[1443],
$[657],
$[278],
$[899],
$[1782]);
this._disposeFields($[458],
$[382]);
}});
...
}}$0[$3].contentClass=qx.Class.getByName($[1350]+qx.lang.String.toFirstUp($0[$3].type||$[98]));
$0[$3].headerCell=$1;
}this.addEventListener($[79],
this._onmousemove);
this.addEventListener($[26],
this._onmousedown);
this.addEventListener($[23],
...
}}this.getTopLevelWidget().setGlobalCursor($8?$[276]:null);
...
this.getTopLevelWidget().setGlobalCursor(null);
this._resizeTarget.removeState($[74]);
this.getParent().getResizeLine().setStyleProperty($[328],
$[21]);
...
$0.iconHeight||16,
$0.flash);
this.setStyleProperty($[601],
$[224]);
this._config=$0;
this._id=$1;
this.setWidth(typeof $0.width===$[5]?$[3]:$0.width);
...
this._arrowup.setAppearance($[891]);
this._arrowup.setVerticalAlign($[22]);
this._arrowup.setDisplay(false);
this._arrowdown=new qx.ui.basic.Image;
this._arrowdown.setAppearance($[1659]);
this._arrowdown.setVerticalAlign($[22]);
...
var $1=$0.getData();
var $2=this._id;
var $3=this._config.sortProp||$[98];
...
_onmouseover:function($0){this.addState($[74]);
},
_onmouseout:function($0){this.removeState($[74]);
},
...
destruct:function(){this._disposeObjects($[951],
$[2230],
$[1704]);
this._disposeFields($[1612]);
}});
...
properties:{horizontalSpacing:{check:$[11],
init:0,
apply:$[1415],
themeable:true},
verticalSpacing:{check:$[11],
init:0,
apply:$[990],
themeable:true},
horizontalChildrenAlign:{check:[$[9],
...
apply:$[530],
themeable:true},
cellPaddingTop:{check:$[11],
nullable:true},
cellPaddingRight:{check:$[11],
nullable:true,
themeable:true},
cellPaddingBottom:{check:$[11],
nullable:true,
themeable:true},
cellPaddingLeft:{check:$[11],
nullable:true,
themeable:true}},
members:{_applyHorizontalSpacing:function($0,
$1){this.addToQueueRuntime($[1919]);
this._invalidatePreferredInnerDimensions();
},
_applyVerticalSpacing:function($0,
$1){this.addToQueueRuntime($[1586]);
this._invalidatePreferredInnerDimensions();
},
_applyHorizontalChildrenAlign:function($0,
$1){this.addToQueueRuntime($[661]);
this._invalidatePreferredInnerDimensions();
},
_applyVerticalChildrenAlign:function($0,
$1){this.addToQueueRuntime($[591]);
this._invalidatePreferredInnerDimensions();
},
...
}this.forEachVisibleChild(function(){this.addToQueue($[36]);
});
},
...
}this.forEachVisibleChild(function(){this.addToQueue($[37]);
});
},
...
$[335])==qx.ui.core.Widget.TYPE_PERCENT){this._setupColumnProperty($2,
$[200],
null);
}}arguments.callee.base.call(this,
$0,
...
$[365])==qx.ui.core.Widget.TYPE_PERCENT){this._setupRowProperty($2,
$[212],
null);
}}arguments.callee.base.call(this,
$0,
...
destruct:function(){this._disposeFields($[858],
$[1140],
$[893]);
}});
...
updateChildOnInnerWidthChange:function($0){$0._recomputePercentX();
$0.addToLayoutChanges($[112]);
return true;
},
updateChildOnInnerHeightChange:function($0){$0._recomputePercentY();
$0.addToLayoutChanges($[109]);
return true;
},
layoutChild:function($0,
$1){this.layoutChild_sizeX($0,
...
switch($0.getHorizontalAlign()||$2.getColumnHorizontalAlignment($0._col)||$2.getRowHorizontalAlignment($0._row)||$2.getHorizontalChildrenAlign()){case $[39]:$4+=Math.round(($2.getColumnInnerWidth($0._col,
...
switch($0.getVerticalAlign()||$2.getRowVerticalAlignment($0._row)||$2.getColumnVerticalAlignment($0._col)||$2.getVerticalChildrenAlign()){case $[22]:$4+=Math.round(($2.getRowInnerHeight($0._col,
$0._row)-$0.getBoxHeight())/2);
break;
case $[16]:$4+=$2.getRowInnerHeight($0._col,
...
$5++,
$4);
if($1[$6].align){$3.setStyleProperty($[157],
$1[$6].align);
...
for($8 in $4){$7=$1[$2+$0];
$6=$5[$3*$0+($9++)];
if($6){if($7&&$7._selected){$6.addState($[52]);
}else{$6.removeState($[52]);
}
if($7&&$7._lead){$6.addState($[234]);
}else{$6.removeState($[234]);
...
var $2;
if(qx.util.Validation.isValidString(this.getIcon())){$0.push($[1745]);
if(qx.core.Variant.isSet($[1],
$[20])&&$1){$2=$[120];
}else{$2=this.getIcon();
}$0.push(qx.io.Alias.getInstance().resolve($2));
$0.push($[1507]);
if(this.getSpacing()!=null){$0.push($[2020]);
$0.push(this.getSpacing());
$0.push($[310]);
}
if(this.getIconWidth()!=null){$0.push($[1040]);
$0.push(this.getIconWidth());
$0.push($[310]);
}
if(this.getIconHeight()!=null){$0.push($[1840]);
...
statics:{empty:{source:$[120]}},
properties:{appearance:{refine:true,
init:$[842]}},
members:{setSource:function($0){if(this._initialLayoutDone){return this._updateContent(qx.io.Alias.getInstance().resolve($0==$[0]?$[120]:$0));
...
if(qx.core.Variant.isSet($[1],
$[31])){this._scrollBar.setStyleProperty($[94],
$[0]);
}this._scrollBar.setOverflow($0?$[123]:$[107]);
this._scrollBar.addEventListener($[42],
this._onscroll,
this);
this._scrollContent=new qx.ui.basic.Terminator;
if(qx.core.Variant.isSet($[1],
$[31])){this._scrollContent.setStyleProperty($[94],
$[0]);
}this._scrollBar.add(this._scrollContent);
if(this._horizontal){this._scrollContent.setHeight(5);
this._scrollBar.setWidth($[38]);
...
this._blocker.setAppearance($[1000]);
this.add(this._blocker);
this.setMaximum(0);
},
statics:{EVENT_DELAY:250},
properties:{value:{check:$[45],
init:0,
apply:$[293],
event:$[166],
transform:$[2202]},
...
_getScrollBarWidth:function(){if(qx.ui.basic.ScrollBar._scrollBarWidth==null){var $0=document.createElement($[142]);
$0.style.width=$[287];
$0.style.height=$[287];
$0.style.overflow=$[42];
...
destruct:function(){this._disposeObjects($[2200],
$[984],
$[630]);
}});
...
$[20])){$0.attachEvent($[683],
this.__onscroll);
}else{$0.addEventListener($[42],
this.__onscroll,
false);
}}},
_onscroll:function($0){this.createDispatchEvent($[42]);
qx.event.handler.EventHandler.stopDomEvent($0);
}},
destruct:function(){var $0=this.getElement();
if($0){if(qx.core.Variant.isSet($[1],
$[20])){$0.detachEvent($[683],
this.__onscroll);
}else{$0.removeEventListener($[42],
this.__onscroll,
false);
...
this.setRequestHeader($[1895],
$[465]);
this.setRequestHeader($[2062],
...
reset:function(){switch(this.getState()){case $[44]:case $[49]:this.error("Aborting already sent request!");
case $[217]:this.abort();
break;
}},
isConfigured:function(){return this.getState()===$[83];
},
isQueued:function(){return this.getState()===$[217];
},
isSending:function(){return this.getState()===$[44];
},
isReceiving:function(){return this.getState()===$[49];
},
isCompleted:function(){return this.getState()===$[18];
},
isAborted:function(){return this.getState()===$[40];
},
isTimeout:function(){return this.getState()===$[41];
},
isFailed:function(){return this.getState()===$[27];
},
_onqueued:function($0){this.setState($[217]);
this.dispatchEvent($0);
},
_onsending:function($0){this.setState($[44]);
this.dispatchEvent($0);
},
_onreceiving:function($0){this.setState($[49]);
this.dispatchEvent($0);
},
_oncompleted:function($0){this.setState($[18]);
this.dispatchEvent($0);
this.dispose();
},
_onaborted:function($0){this.setState($[40]);
this.dispatchEvent($0);
this.dispose();
},
_ontimeout:function($0){this.setState($[41]);
this.dispatchEvent($0);
this.dispose();
},
_onfailed:function($0){this.setState($[27]);
this.dispatchEvent($0);
this.dispose();
},
...
$1){if($0){this.setParameter($[443],
new Date().valueOf());
this.setRequestHeader($[490],
$[467]);
this.setRequestHeader($[561],
$[467]);
}else{this.removeParameter($[443]);
this.removeRequestHeader($[490]);
this.removeRequestHeader($[561]);
}},
_applyMethod:function($0,
$1){if($0===qx.net.Http.METHOD_POST){this.setRequestHeader($[398],
$[1397]);
}else{this.removeRequestHeader($[398]);
}},
_applyResponseType:function($0,
$1){this.setRequestHeader($[1183],
$0);
},
...
check:$[2],
apply:$[352]},
maxTotalRequests:{check:$[11],
nullable:true},
maxConcurrentRequests:{check:$[11],
init:3},
defaultTimeout:{check:$[11],
init:5000}},
members:{_debug:function(){var $0=this._active.length+$[111]+(this._queue.length+this._active.length);
{};
},
...
this._active.push($1);
this._debug();
$1.addEventListener($[44],
$0._onsending,
$0);
$1.addEventListener($[49],
$0._onreceiving,
$0);
$1.addEventListener($[18],
$0._oncompleted,
$0);
...
destruct:function(){this._disposeObjectDeep($[1562],
1);
this._disposeObjects($[331]);
this._disposeFields($[1303]);
}});
...
statusCodeToString:function($0){switch($0){case -1:return $[1406];
case 200:return $[2025];
case 304:return $[740];
case 206:return $[774];
case 204:return $[1420];
case 300:return $[1770];
case 301:return $[1858];
case 302:return $[1062];
case 303:return $[852];
case 305:return $[719];
case 400:return $[1720];
case 401:return $[1927];
case 402:return $[1837];
case 403:return $[1489];
case 404:return $[1915];
case 405:return $[2021];
case 406:return $[952];
case 407:return $[1513];
case 408:return $[1719];
case 409:return $[1357];
case 410:return $[1922];
case 411:return $[2089];
case 412:return $[2034];
case 413:return $[1602];
case 414:return $[950];
case 415:return $[2032];
case 500:return $[1902];
case 501:return $[733];
case 502:return $[873];
case 503:return $[2005];
case 504:return $[2055];
case 505:return $[1012];
case 12002:return $[1230];
case 12029:return $[377];
case 12030:return $[377];
case 12031:return $[377];
case 12152:return $[985];
case 13030:return $[1885];
default:return $[1404];
}}},
properties:{request:{check:$[677],
nullable:true},
implementation:{check:$[580],
nullable:true,
apply:$[1573]},
state:{check:[$[83],
$[44],
...
_onabort:function($0){this.setState($[40]);
},
_onfailed:function($0){this.setState($[27]);
},
_ontimeout:function($0){this.setState($[41]);
...
$1){if($1){$1.removeEventListener($[44],
this._onsending,
this);
$1.removeEventListener($[49],
this._onreceiving,
this);
$1.removeEventListener($[18],
this._oncompleted,
this);
...
$0.addEventListener($[44],
this._onsending,
this);
$0.addEventListener($[49],
this._onreceiving,
this);
$0.addEventListener($[18],
this._oncompleted,
this);
...
this._ontimeout,
this);
$0.addEventListener($[27],
this._onfailed,
this);
}},
_applyState:function($0,
$1){{};
switch($0){case $[44]:this.createDispatchEvent($[44]);
break;
case $[49]:this.createDispatchEvent($[49]);
break;
case $[18]:case $[40]:case $[41]:case $[27]:var $2=this.getImplementation();
if(!$2){break;
}
if(this.hasEventListeners($0)){var $3=new qx.io.remote.Response($0);
if($0==$[18]){var $4=$2.getResponseContent();
$3.setContent($4);
if($4===null){{};
$0=$[27];
...
properties:{state:{check:$[11],
nullable:true},
statusCode:{check:$[11],
nullable:true},
content:{nullable:true},
responseHeaders:{check:$[135],
nullable:true}},
...
event:$[340],
apply:$[346]},
requestHeaders:{check:$[135],
nullable:true},
parameters:{check:$[135],
nullable:true},
formFields:{check:$[135],
nullable:true},
responseType:{check:$[12],
nullable:true},
useBasicHttpAuth:{check:$[2],
nullable:true}},
...
break;
case $[83]:this.createDispatchEvent($[83]);
break;
case $[44]:this.createDispatchEvent($[44]);
break;
case $[49]:this.createDispatchEvent($[49]);
break;
case $[18]:this.createDispatchEvent($[18]);
break;
case $[40]:this.createDispatchEvent($[40]);
break;
case $[27]:this.createDispatchEvent($[27]);
break;
...
if($8 instanceof Array){for(var $9=0;$9<$8.length;$9++){$6.push(encodeURIComponent($7)+$[115]+encodeURIComponent($8[$9]));
}}else{$6.push(encodeURIComponent($7)+$[115]+encodeURIComponent($8));
}}
if($6.length>0){$3+=($3.indexOf($[129])>=0?$[56]:$[129])+$6.join($[56]);
}var $a=function($b){var $c=$[1190];
var $d=$[0];
var $e,
$f,
$g;
...
$3,
$2);
$0.setRequestHeader($[1776],
$[1478]+$a(this.getUsername()+$[1512]+this.getPassword()));
}else{$0.open($1,
$3,
$2,
this.getUsername(),
...
failedLocally:function(){if(this.getState()===$[27]){return;
}this.warn("Could not load from file: "+this.getUrl());
this.failed();
},
_onreadystatechange:function($0){switch(this.getState()){case $[18]:case $[40]:case $[27]:case $[41]:{};
return;
...
}catch(ex){}}if(typeof $0==$[34]&&$0!=null){if(!$0.documentElement){var $3=String(this.getRequest().responseText).replace(/<\?xml[^\?]*\?>/,
$[0]);
$0.loadXML($3);
}if(!$0.documentElement){throw new Error("Missing Document Element!");
}
if($0.documentElement.tagName==$[1752]){throw new Error("XML-File is not well-formed!");
}}else{throw new Error("Response was not a valid xml document ["+this.getRequest().responseText+"]");
}return $0;
},
getFetchedLength:function(){var $0=this.getResponseText();
return typeof $0==$[10]?$0.length:0;
},
getResponseContent:function(){if(this.getState()!==$[18]){{};
return null;
}{};
...
break;
case $[41]:this.getRequest().abort();
this.createDispatchEvent($[41]);
break;
}}},
defer:function($0,
...
qx.Class.define($[1595],
{statics:{create:qx.core.Variant.select($[1],
{"default":function(){return new XMLHttpRequest;
},
"mshtml":qx.lang.Object.select(location.protocol!==$[583]&&window.XMLHttpRequest?$[986]:$[2000],
...
__convertNumber:function($0){return isFinite($0)?String($0):$[183];
},
...
return $[1059]+Math.floor($2/16).toString(16)+($2%16).toString(16);
},
...
__convertDate:function($0){var $1=$0.getUTCFullYear()+$[28]+$0.getUTCMonth()+$[28]+$0.getUTCDate()+$[28]+$0.getUTCHours()+$[28]+$0.getUTCMinutes()+$[28]+$0.getUTCSeconds()+$[28]+$0.getUTCMilliseconds();
return $[1729]+$1+$[1288];
},
...
if($0 instanceof Array||$1==$[320]){return this.__convertArray($0);
}else if($0 instanceof Date||$1==$[1853]){return this.__convertDate($0);
}else if($0 instanceof Object||$1==$[135]){return this.__convertMap($0);
}return $[0];
}return $[183];
},
__convertUndefined:function($0){if(qx.core.Setting.get($[977])){return $[183];
}},
stringify:function($0,
$1){this.__beautify=$1;
this.__indent=this.BEAUTIFYING_LINE_END;
var $2=this[this.__map[typeof $0]]($0);
if(typeof $2!=$[10]){$2=null;
}if(qx.core.Setting.get($[547])){qx.log.Logger.getClassLogger(qx.io.Json).debug("JSON request: "+$2);
}return $2;
},
parse:function($0){if(!(/[^,:{}\[\]0-9.\-+Eaeflnr-u \n\r\t]/.test($0.replace(/"(\\.|[^"\\])*"/g,
$[0])))){throw new Error("Could not parse JSON string!");
}
try{return eval($[102]+$0+$[57]);
}catch(ex){throw new Error("Could not evaluate JSON string: "+ex.message);
}},
parseQx:function($0){if(qx.core.Setting.get($[547])){qx.log.Logger.getClassLogger(qx.io.Json).debug("JSON response: "+$0);
}var $1=($0&&$0.length>0)?eval($[1482]+$0+$[257]):null;
return $1;
}},
...
var $2=$[1447]+$0;
if(qx.core.Variant.isSet($[1],
$[20])){this._frame=document.createElement($[1022]+$1+$[2052]);
}else{this._frame=document.createElement($[266]);
}this._frame.src=$[712];
...
this._form=document.createElement($[1422]);
this._form.target=$1;
this._form.id=this._form.name=$2;
this._form.style.display=$[14];
document.body.appendChild(this._form);
this._data=document.createElement($[330]);
this._data.id=this._data.name=$[1734];
...
if($5 instanceof Array){for(var $6=0;$6<$5.length;$6++){$3.push(encodeURIComponent($4)+$[115]+encodeURIComponent($5[$6]));
}}else{$3.push(encodeURIComponent($4)+$[115]+encodeURIComponent($5));
}}
if($3.length>0){$1+=($1.indexOf($[129])>=0?$[56]:$[129])+$3.join($[56]);
}var $7=this.getFormFields();
for(var $4 in $7){var $8=document.createElement($[330]);
$8.name=$4;
...
_switchReadyState:function($0){switch(this.getState()){case $[18]:case $[40]:case $[27]:case $[41]:this.warn("Ignore Ready State Change");
return;
...
}if($0.firstChild.tagName&&$0.firstChild.tagName.toLowerCase()==$[380]){return $0.firstChild.innerHTML;
...
if(qx.core.Variant.isSet($[1],
$[31])){this._frame.src=qx.io.Alias.getInstance().resolve($[120]);
}document.body.removeChild(this._frame);
}
if(this._form){document.body.removeChild(this._form);
}this._disposeFields($[657],
$[2037]);
}});
...
return $1?$1.getElementsByTagName($[143])[0]:null;
}}});
...
statics:{_uniqueId:0,
_instanceRegistry:{},
ScriptTransport_PREFIX:$[1907],
ScriptTransport_ID_PARAM:$[2186],
ScriptTransport_DATA_PARAM:$[747],
...
$0+=($0.indexOf($[129])>=0?$[56]:$[129])+qx.io.remote.ScriptTransport.ScriptTransport_ID_PARAM+$[115]+this._uniqueId;
...
if($4 instanceof Array){for(var $5=0;$5<$4.length;$5++){$2.push(encodeURIComponent($3)+$[115]+encodeURIComponent($4[$5]));
}}else{$2.push(encodeURIComponent($3)+$[115]+encodeURIComponent($4));
}}
if($2.length>0){$0+=$[56]+$2.join($[56]);
}var $6=this.getData();
if($6!=null){$0+=$[56]+qx.io.remote.ScriptTransport.ScriptTransport_DATA_PARAM+$[115]+encodeURIComponent($6);
}qx.io.remote.ScriptTransport._instanceRegistry[this._uniqueId]=this;
this._element=document.createElement($[1879]);
this._element.charset=$[1802];
this._element.src=$0;
{};
...
for(var $1=0;$1<$0.children.length;$1++){var $2=$0.children[$1];
if(!this._addChildNode($2)){throw new Error("Unknown child type: "+$2.type+" node: "+qx.io.Json.stringify($2));
}}},
members:{getNode:function(){return this._docNode;
},
getNodeType:function(){return this._docNode.type;
},
getDeprecationText:function(){return this._deprecated||$[0];
},
isDeprecated:function(){return typeof (this._deprecated)==$[10]?true:false;
},
isInternal:function(){return this._docNode.attributes.access==$[540];
},
isPrivate:function(){return this._docNode.attributes.access==$[664];
},
isProtected:function(){return this._docNode.attributes.access==$[391];
},
...
_createNodeList:function($0,
$1,
$2,
$3){if($1){var $4=[];
for(var $5=0;$5<$0.children.length;$5++){$4.push(new $1($0.children[$5],
$2,
$3));
}return $4;
}else{return $0.children;
}},
_initializeFields:function(){},
_addChildNode:function($0){switch($0.type){case $[1070]:this._deprecated=$0.children?$0.children[0].attributes.text||$[0]:$[0];
break;
default:return false;
}return true;
}},
destruct:function(){this._disposeFields($[1241]);
}});




/* ID: apiviewer.dao.Class */
qx.Class.define($[1625],
{extend:apiviewer.dao.Node,
construct:function($0,
$1){arguments.callee.base.call(this,
$0);
arguments.callee.self.registerClass(this);
this._package=$1;
},
statics:{_class_registry:{},
_top_level_classes:[],
registerClass:function($0){if(!$0.getFullName())return;
this._class_registry[$0.getFullName()]=$0;
if(!$0._docNode.attributes.superClass){this._top_level_classes.push($0);
}},
getClassByName:function($0){return this._class_registry[$0];
},
...
isLoaded:function(){return this._docNode.attributes.externalRef!=$[1131];
},
getFullName:function(){return this._docNode.attributes.fullName||$[0];
},
getPackageName:function(){return this._docNode.attributes.packageName||$[0];
},
getDescription:function(){return this._desc||$[0];
},
getType:function(){return this._docNode.attributes.type||$[222];
},
...
getSuperClass:function(){return arguments.callee.self.getClassByName(this._docNode.attributes.superClass);
},
getChildClasses:function(){return this._docNode.attributes.childClasses?this._docNode.attributes.childClasses.split($[28]):[];
},
getInterfaces:function(){return this._docNode.attributes.interfaces?this._docNode.attributes.interfaces.split($[28]):[];
},
getMixins:function(){return this._docNode.attributes.mixins?this._docNode.attributes.mixins.split($[28]):[];
},
getImplementations:function(){return this._docNode.attributes.implementations?this._docNode.attributes.implementations.split($[28]):[];
},
getIncluder:function(){return this._docNode.attributes.includer?this._docNode.attributes.includer.split($[28]):[];
},
getConstructor:function(){if(this._constructor!=null){return this._constructor;
}var $0=apiviewer.TreeUtil.getChild(this.getNode(),
$[181]);
if($0){this._constructor=new apiviewer.dao.Method($0.children[0],
this,
$0.type);
}else{this._constructor=$[0];
var $1=this.getSuperClass();
while($1){var $2=$1.getConstructor();
if($2){var $0=$2.getNode();
this._constructor=new apiviewer.dao.Method($0,
this,
$[181]);
break;
}$1=$1.getSuperClass();
...
}else{var $0=apiviewer.TreeUtil.getChild(this.getNode(),
$[180]);
this._members=$0?this._createNodeList($0,
...
$[295]);
this._statics=$0?this._createNodeList($0,
apiviewer.dao.Method,
this,
$0.type):[];
...
$[182]);
this._events=$0?this._createNodeList($0,
apiviewer.dao.Event,
this,
$0.type):[];
return this._events;
...
$[119]);
this._properties=$0?this._createNodeList($0,
...
$[245]);
this._constants=$0?this._createNodeList($0,
...
$[160]);
this._appearances=$0?this._createNodeList($0,
...
getClassHierarchy:function(){var $0=[];
var $1=this;
while($1){$0.push($1);
$1=$1.getSuperClass();
}return $0;
},
getItem:function($0){var $1=[$[455],
$[619],
$[636],
$[654],
$[567],
$[668]];
for(var $2=0;$2<$1.length;$2++){var $3=this[$1[$2]]();
for(var $4=0;$4<$3.length;$4++){if($0==$3[$4].getName()){return $3[$4];
}}}},
getItemList:function($0){var $1={"events":$[636],
"constructor":$[886],
"properties":$[654],
"methods":$[455],
"methods-static":$[619],
"constants":$[567],
"appearances":$[668],
"superInterfaces":$[1546],
"superMixins":$[1025]};
if($0==$[181]){return this.getConstructor()?[this.getConstructor()]:[];
}else{return this[$1[$0]]();
}},
getItemByListAndName:function($0,
$1){var $2=this.getItemList($0);
for(var $3=0;$3<$2.length;$3++){if($1==$2[$3].getName()){return $2[$3];
}}},
getClassAppearance:function(){var $0=this.getAppearances();
for(var $1=0;$1<$0.length;$1++){if($0[$1].getType()==this){return $0[$1];
}}return null;
},
getAllInterfaces:function($0){if($0){var $1=this.getClassHierarchy();
}else{$1=[this];
}var $2=[];
for(var $3=0;$3<$1.length;$3++){var $4=$1[$3];
var $5=function($6){ifaceNode=apiviewer.dao.Class.getClassByName($6);
$2.push(ifaceNode);
var $7=ifaceNode.getSuperInterfaces();
for(var $8=0;$8<$7.length;$8++){$5($7[$8].getName());
}};
var $9=$4.getInterfaces();
for(var $8=0;$8<$9.length;$8++){$5($9[$8]);
}}return $2;
},
getNodesOfTypeFromMixins:function($0){var $1=this.getMixins();
var $2=[];
for(var $3=0;$3<$1.length;$3++){var $4=this;
var $5=function($6){var $7=$6.getItemList($0);
for(var $8=0;$8<$7.length;$8++){$2.push($7[$8]);
}var $9=$6.getSuperMixins();
for(var $8=0;$8<$9.length;$8++){$5(apiviewer.dao.Class.getClassByName($9[$8].getName()));
}};
var $6=apiviewer.dao.Class.getClassByName($1[$3]);
$5($6);
}return $2;
},
getDependendClasses:function(){var $0=function($1,
$2){$2.push($1);
var $3=$1.getSuperClass();
if($3){$0($3,
$2);
}var $4=$1.getMixins();
for(var $5=0;$5<$4.length;$5++){var $6=apiviewer.dao.Class.getClassByName($4[$5]);
$0($6,
$2);
}var $7=$1.getSuperMixins();
for(var $5=0;$5<$7.length;$5++){var $8=apiviewer.dao.Class.getClassByName($7[$5]);
$0($8,
$2);
}var $9=$1.getInterfaces();
for(var $5=0;$5<$9.length;$5++){var $a=apiviewer.dao.Class.getClassByName($9[$5]);
$0($a,
$2);
}var $b=$1.getSuperInterfaces();
for(var $5=0;$5<$b.length;$5++){var $c=apiviewer.dao.Class.getClassByName($b[$5]);
$0($c,
$2);
}return $2;
};
...
_initializeFields:function(){this._desc=$[0];
this._see=[];
this._superInterfaces=[];
this._superMixins=[];
},
_addChildNode:function($0){switch($0.type){case $[181]:case $[180]:case $[295]:case $[182]:case $[119]:case $[245]:case $[160]:break;
case $[590]:this._superInterfaces=this._createNodeList($0,
apiviewer.dao.ClassItem,
this,
$0.type);
break;
case $[410]:this._superMixins=this._createNodeList($0,
apiviewer.dao.ClassItem,
this,
$0.type);
break;
case $[305]:this._desc=$0.attributes.text||$[0];
break;
case $[527]:this._see.push($0.attributes.name);
break;
default:return arguments.callee.base.call(this,
$0);
}return true;
}}});
...
getDescription:function(){return this.getDocNode()._desc||$[0];
},
getTypes:function(){var $0=[];
for(var $1=0;$1<this._types.length;$1++){var $2={};
if(this._types[$1].attributes.dimensions){$2.dimensions=this._types[$1].attributes.dimensions;
}$2.type=this._types[$1].attributes.type;
$0.push($2);
}return $0;
},
getSee:function(){return this._see;
...
var $0=apiviewer.dao.Class.getClassByName(this._docNode.attributes.docFrom);
if($0){var $1=$0.getItemList(this._listName);
for(var $2=0;$2<$1.length;$2++){if($1[$2].getName()==this.getName()){this._itemDocNode=$1[$2];
break;
}}}return this._itemDocNode;
},
isRequiredByInterface:function($0){var $1=apiviewer.TreeUtil.getChild($0.getNode(),
this._listName);
if($1){var $2=apiviewer.TreeUtil.getChildByAttribute($1,
$[637],
this.getName());
return $2?true:false;
}return false;
...
var $1=this.getClass().getAllInterfaces(true);
for(var $2=0;$2<$1.length;$2++){if(this.isRequiredByInterface($1[$2])){$0.push($1[$2]);
}}this._requiredBy=$0;
return $0;
},
_initializeFields:function(){arguments.callee.base.call(this);
this._see=[];
this._errors=[];
this._types=[];
},
_addChildNode:function($0){switch($0.type){case $[1989]:this._errors=this._createNodeList($0);
break;
case $[305]:this._desc=$0.attributes.text||$[0];
break;
case $[527]:this._see.push($0.attributes.name);
break;
case $[625]:this._types=this._createNodeList($0);
break;
default:return arguments.callee.base.call(this,
$0);
}return true;
...
/* ID: apiviewer.dao.Method */
qx.Class.define($[1516],
...
members:{getName:function(){if(this.isConstructor()){return $[1892];
...
$[426]);
this._params=$0?this._createNodeList($0,
apiviewer.dao.Param,
this.getClass(),
this):[];
return this._params;
...
$[659]);
this._return=$0?new apiviewer.dao.Param($0,
this.getClass(),
this):$[0];
return this._return;
}},
...
getFromProperty:function(){return this.getClass().getItemByListAndName($[119],
this._docNode.attributes.fromProperty);
},
_addChildNode:function($0){switch($0.type){case $[426]:case $[659]:break;
default:return arguments.callee.base.call(this,
$0);
}return true;
}}});
...
members:{getTypes:function(){var $0=this.getMethod().getFromProperty();
if($0){if($0.isPropertyGroup()){var $1=this.getClass().getItemByListAndName($[119],
this.getName());
if($1){return $1.getTypes();
}}else{return $0.getTypes();
}}var $2=arguments.callee.base.call(this);
var $3=this._docNode.attributes;
if($3.type){$2.push({type:$3.type,
...
/* ID: apiviewer.dao.Event */
qx.Class.define($[1683],
{extend:apiviewer.dao.ClassItem,
construct:function($0,
$1,
$2){arguments.callee.base.call(this,
...
_addChildNode:function($0){switch($0.type){case $[625]:this._type=$0.children[0].attributes.type;
break;
default:return arguments.callee.base.call(this,
$0);
}return true;
...
members:{getTypes:function(){var $0=arguments.callee.base.call(this);
var $1=this.getDocNode();
var $2=$1.getType();
if($2){$0.push({type:$2,
dimensions:$1.getNode().attributes.dimensions});
}return $0;
},
getCheck:function(){var $0=this.getDocNode()._docNode.attributes;
if($0.check&&!apiviewer.dao.Class.getClassByName($0.check)&&!apiviewer.ui.ClassViewer.PRIMITIVES[$0.check]){return $0.check;
}else{return $[0];
}},
...
getUnitDetection:function(){return this._docNode.attributes.unitDetection;
},
getPossibleValues:function(){var $0=this._docNode.attributes.possibleValues;
if($0){$0=$0.split($[28]);
return $0;
}else{return [];
}},
getGroup:function(){var $0=this.getDocNode()._docNode.attributes.group;
if($0){return $0.split($[28]);
}return [];
},
isPropertyGroup:function(){return this.getDocNode()._docNode.attributes.group?true:false;
},
getType:function(){var $0=this._docNode.attributes;
if($0.type){return $0.type;
}if($0.check){if(apiviewer.dao.Class.getClassByName($0.check)||apiviewer.ui.ClassViewer.PRIMITIVES[$0.check]){return $0.check;
}}return null;
},
getPropertyType:function(){return this.getDocNode()._docNode.attributes.propertyType||$[632];
},
...
getGetAlias:function(){return this._docNode.attributes.getAlias;
},
getSetAlias:function(){return this._docNode.attributes.setAlias;
},
...
isOldProperty:function(){return this.getPropertyType()!==$[632];
}}});




/* ID: apiviewer.ui.AbstractViewer */
...
properties:{docNode:{check:$[372],
init:null,
nullable:true,
apply:$[2072]}},
statics:{fixLinks:function($0){var $1=$0.getElementsByTagName($[385]);
for(var $2=0;$2<$1.length;$2++){if(typeof $1[$2].href==$[10]&&$1[$2].href.indexOf($[548])==0){$1[$2].target=$[404];
}}},
highlightCode:function($0){var $1=$0.getElementsByTagName($[380]);
for(var $2=0;$2<$1.length;$2++){var $3=$1[$2];
if($3.className!==$[1732]){continue;
}$3.innerHTML=qx.dev.Tokenizer.javaScriptToHtml($3.innerHTML);
}}},
members:{_getTitleHtml:function($0){throw new Error("Abstract method called!");
},
_getDescriptionHtml:function($0){throw new Error("Abstract method called!");
},
_syncHtml:function(){var $0=new qx.util.StringBuilder();
$0.add($[1749]);
$0.add($[562],
$[4]);
var $1=this.getPanels();
for(var $2=0;$2<$1.length;$2++){var $3=$1[$2];
$0.add($3.getPanelHtml(this));
}this.getElement().innerHTML=$0.get();
apiviewer.ui.AbstractViewer.fixLinks(this.getElement());
var $4=this.getElement().childNodes;
this._titleElem=$4[0];
this._classDescElem=$4[1];
for(var $2=0;$2<$1.length;$2++){var $3=$1[$2];
$0.add($3.setElement($4[$2+2]));
}},
addInfoPanel:function($0){this._infoPanelHash[$0.toHashCode()]=$0;
this._infoPanels.push($0);
},
getPanels:function(){return this._infoPanels;
},
getPanelFromHashCode:function($0){return this._infoPanelHash[$0];
},
_updatePanels:function(){var $0=this.getPanels();
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1];
$2.update(this,
this.getDocNode());
}},
_applyDocNode:function($0){if(!this._titleElem){return ;
}this._titleElem.innerHTML=this._getTitleHtml($0);
this._classDescElem.innerHTML=this._getDescriptionHtml($0);
apiviewer.ui.AbstractViewer.fixLinks(this._classDescElem);
apiviewer.ui.AbstractViewer.highlightCode(this._classDescElem);
this._updatePanels();
},
togglePanelVisibility:function($0){try{$0.setIsOpen(!$0.getIsOpen());
var $1=$0.getTitleElement().getElementsByTagName($[505])[0];
$1.src=qx.io.Alias.getInstance().resolve($0.getIsOpen()?$[413]:$[412]);
$0.update(this,
this.getDocNode());
}catch(exc){this.error("Toggling info body failed",
exc);
}}},
destruct:function(){this._disposeFields($[475],
$[685]);
this._disposeObjectDeep($[1794],
1);
this._disposeObjectDeep($[1635],
1);
}});
...
/* ID: apiviewer.ObjectRegistry */
qx.Class.define($[1170],
{statics:{__objectDb:{},
register:function($0){var $1=qx.core.Object.toHashCode($0);
this.__objectDb[$1]=$0;
},
getObjectFromHashCode:function($0){return this.__objectDb[$0];
}}});
...
qx.Class.define($[996],
{extend:qx.core.Object,
statics:{tokenizeJavaScript:function($0){var $1={"break":1,
"case":1,
"catch":1,
"continue":1,
"default":1,
...
var $f=[];
var $g=$0.match($e);
for(var $h=0;$h<$g.length;$h++){var $i=$g[$h];
if($i.match($4)){$f.push({type:$[449],
value:$i});
}else if($i.match($5)){$f.push({type:$[515],
value:$i});
}else if($i.match($a)){$f.push({type:$[663],
value:$i});
}else if($i.match($9)){$f.push({type:$[405],
value:$i});
}else if($1[$i]){$f.push({type:$[441],
value:$i});
}else if($2[$i]){$f.push({type:$[349],
value:$i});
}else if($3[$i]){$f.push({type:$[627],
value:$i});
}else if($i.match($6)){$f.push({type:$[689],
value:$i});
}else if($i.match($8)){$f.push({type:$[1505],
value:$i});
}else if($i.match($7)){$f.push({type:$[2028],
value:$i});
}else if($i.match($c)){$f.push({type:$[544],
value:$i});
}else if($i.match($d)){$f.push({type:$[856],
value:$i});
}else if($i.match($b)){$f.push({type:$[991],
value:$i});
}else if($i==$[322]){$f.push({type:$[225],
value:$[322]});
}else if($i==$[367]){$f.push({type:$[225],
value:$[367]});
}else if($i==$[56]){$f.push({type:$[225],
value:$[56]});
}else{$f.push({type:$[225],
value:$i});
}}return $f;
},
javaScriptToHtml:function($0){var $1=qx.dev.Tokenizer.tokenizeJavaScript($0);
var $2=new qx.util.StringBuilder();
for(var $3=0;$3<$1.length;$3++){var $4=$1[$3];
var $5=qx.html.String.escape($4.value);
switch($4.type){case $[689]:$2.add($[1046],
$5,
$[141]);
break;
case $[449]:case $[515]:$2.add($[1370],
$5,
$[141]);
break;
case $[663]:case $[405]:$2.add($[731],
$5,
$[141]);
break;
case $[441]:case $[349]:case $[627]:$2.add($[520],
$4.type,
$[343],
$5,
$[141]);
...
{"mshtml":function(){qx.core.Init.getInstance().addEventListener($[95],
this.__onload,
this);
},
"default":null}),
__onload:qx.core.Variant.select($[1],
{"mshtml":function(){this._frame=document.createElement($[266]);
this._frame.style.visibility=$[21];
this._frame.src=qx.io.Alias.getInstance().resolve($[1158]);
document.body.appendChild(this._frame);
},
"default":null}),
...
$1.add=$1.push;
$1.toString=$1.get=new Function($[1258]);
$1.clear=$1.init=new Function($[1001]);
$1.isEmpty=new Function($[1896]);
...
this.addInfoPanel(new apiviewer.ui.panels.MethodPanel($[181],
$[181],
false,
true));
this.addInfoPanel(new apiviewer.ui.panels.EventPanel($[182],
$[182],
true,
true));
this.addInfoPanel(new apiviewer.ui.panels.PropertyPanel($[119],
$[119],
true,
true));
this.addInfoPanel(new apiviewer.ui.panels.MethodPanel($[180],
$[180],
true,
true));
this.addInfoPanel(new apiviewer.ui.panels.MethodPanel($[295],
$[1414],
false,
true));
this.addInfoPanel(new apiviewer.ui.panels.ConstantPanel($[245],
$[245],
false,
true));
this.addInfoPanel(new apiviewer.ui.panels.AppearancePanel($[160],
$[160],
false,
true));
},
events:{"classLinkClicked":$[110]},
properties:{showInherited:{check:$[2],
init:false,
apply:$[308]},
showProtected:{check:$[2],
init:false,
apply:$[308]},
showPrivate:{check:$[2],
init:false,
...
"Interface":true,
"Theme":true},
createImageHtml:function($0,
$1,
$2){if(typeof $0==$[10]){return $[658]+qx.io.Alias.getInstance().resolve($0)+$[2073]+($2?$[1900]+$2+$[67]:$[0])+$[1450];
}else{if($2){$2+=$[917];
}else{$2=$[2208];
}return apiviewer.ui.ClassViewer.createOverlayImageHtml(18,
18,
$0,
$1,
$2);
}},
createOverlayImageHtml:function($0,
$1,
$2,
$3,
$4){var $5=$[1571]+$0+$[1377]+$1+$[890]+(($4==null)?$[366]:($[17]+$4))+$[194];
for(var $6=0;$6<$2.length;$6++){$5+=$[1882];
if($3!=null){$5+=$[400]+$3+$[67];
}$5+=$[1221]+qx.io.Alias.getInstance().resolve($2[$6])+$[765];
}$5+=$[72];
return $5;
}},
members:{_getTitleHtml:function($0){switch($0.getType()){case $[89]:var $1=$[371];
break;
case $[152]:var $1=$[309];
break;
default:var $1=$[640];
...
$[1613]);
$2.add($[2084]);
if($0.isAbstract()){$2.add($[665]);
}else if($0.isStatic()){$2.add($[463]);
}else if($0.isSingleton()){$2.add($[680]);
}$2.add($1,
$[1946]);
$2.add(apiviewer.ui.panels.InfoPanel.setTitleClass($0,
$0.getName()));
return $2.get();
},
_getDescriptionHtml:function($0){switch($0.getType()){case $[89]:var $1=$[1557];
break;
case $[152]:var $1=$[1436];
break;
default:var $1=$[1306];
...
var $3=$0.getDescription();
if($3!=$[0]){$2.add($[440],
apiviewer.ui.panels.InfoPanel.resolveLinkAttributes($3,
$0),
$[4]);
}switch($0.getType()){case $[89]:case $[152]:$2.add(this.__getHierarchyTreeHtml($0));
break;
default:$2.add(this.__getClassHierarchyHtml($0));
break;
}$2.add(this.__getDependentClassesHtml($0.getChildClasses(),
$[2078]+$1+$[51]));
$2.add(this.__getDependentClassesHtml($0.getInterfaces(),
$[1212]));
$2.add(this.__getDependentClassesHtml($0.getMixins(),
$[1935]));
$2.add(this.__getDependentClassesHtml($0.getImplementations(),
$[1626]));
$2.add(this.__getDependentClassesHtml($0.getIncluder(),
$[1878]));
var $4=$0.getConstructor();
if($4){$2.add(apiviewer.ui.panels.InfoPanel.createSeeAlsoHtml($4));
}
if($0.isDeprecated()){$2.add($[682],
$[574],
$[628]);
$2.add($[388]);
var $3=$0.getDeprecationText();
if($3){$2.add($3);
}else{$2.add($[306],
$0.getType(),
$[454]);
...
__getDependentClassesHtml:function($0,
$1){var $2=apiviewer.ui.ClassViewer;
if($0.length>0){var $3=new qx.util.StringBuilder($[363],
$1,
$[316]);
for(var $4=0;$4<$0.length;$4++){if($4!=0){$3.add($[409]);
}$3.add(apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0[$4],
null,
true,
false));
}$3=$3.get();
...
__getClassHierarchyHtml:function($0){var $1=apiviewer.ui.ClassViewer;
var $2=new qx.util.StringBuilder($[363],
$[499],
$[316]);
var $3=$0.getClassHierarchy();
$2.add($1.createImageHtml($[997]),
$[1492]);
var $4=0;
for(var $5=$3.length-1;$5>=0;$5--){$2.add($[562]);
$2.add($1.createImageHtml($[456],
null,
$[1999]+$4+$[48]),
$1.createImageHtml(apiviewer.TreeUtil.getIconUrl($3[$5])));
if($5!=0){$2.add(apiviewer.ui.panels.InfoPanel.createItemLinkHtml($3[$5].getFullName(),
null,
false));
}else{$2.add($3[$5].getFullName());
}$4+=18;
$2.add($[4]);
}return $2.get();
},
__getHierarchyTreeHtml:function($0){if($0.getType()==$[89]){var $1=$[410];
}else{$1=$[590];
}var $2=apiviewer.ui.ClassViewer;
var $3=$2.createImageHtml($[1280],
null,
$[1594]);
var $4=function($5,
$6){var $7=[];
for(var $8=0;$8<$5.length;$8++){var $9=new qx.util.StringBuilder();
var $0=$5[$8];
if(!$6){if($8==$5.length-1){$9.add($2.createImageHtml($[456]));
}else{$9.add($2.createImageHtml($[751]));
}}else{if(!$6){$9.add($3);
}}$9.add($2.createImageHtml(apiviewer.TreeUtil.getIconUrl($0)));
if(!$6){$9.add(apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getFullName(),
null,
false));
}else{$9.add($0.getFullName());
}$7.push($9.get());
var $a=qx.lang.Array.clone($0.getItemList($1));
for(var $b=0;$b<$a.length;$b++){$a[$b]=apiviewer.dao.Class.getClassByName($a[$b].getName());
}if($a.length>0){var $c=$4($a);
for(var $d=0;$d<$c.length;$d++){if($8==$5.length-1){if($6){$7.push($c[$d]);
}else{$7.push($3+$c[$d]);
}}else{$7.push($2.createImageHtml($[1553])+$c[$d]);
}}}}return $7;
};
var $e=new qx.util.StringBuilder();
if($0.getItemList($1).length>0){$e.add($[363],
$[499],
$[316]);
$e.add($4([$0],
true).join($[1959]));
...
showItem:function($0){var $1=this.getDocNode().getItem($0);
if(!$1){return false;
}var $2=this._getPanelForItemNode($1);
var $3=$2.getItemElement($1.getName());
if(!$3){return false;
}var $4=$3.parentNode.parentNode;
if(this._markedElement){this._markedElement.className=$[0];
}$4.className=$[2027];
this._markedElement=$4;
qx.html.ScrollIntoView.scrollX($4,
true);
qx.html.ScrollIntoView.scrollY($4,
true);
return true;
},
_onSelectItem:function($0){this.createDispatchDataEvent($[702],
$0);
},
_getPanelForItemNode:function($0){var $1=this.getPanels();
for(var $2=0;$2<$1.length;$2++){var $3=$1[$2];
if($3.canDisplayItem($0)){return $3;
}}}},
destruct:function(){this._disposeFields($[685],
$[475],
$[1360]);
}});
...
/* ID: apiviewer.ui.panels.InfoPanel */
...
resolveLinkAttributes:function($0,
$1){var $2=/\{@link([^\}]*)\}/mg;
var $3=new qx.util.StringBuilder();
var $4;
var $5=0;
while(($4=$2.exec($0))!=null){$3.add($0.substring($5,
$4.index)+this.createItemLinkHtml($4[1],
$1));
$5=$4.index+$4[0].length;
}$3.add($0.substring($5,
$0.length));
return $3.get();
},
createItemLinkHtml:function($0,
$1,
$2,
$3){if($2==null){$2=true;
}$0=qx.lang.String.trim($0);
if($0.charAt(0)==$[67]||$0.charAt(0)==$[796]){return $0;
}else{var $4=this.ITEM_SPEC_REGEX.exec($0);
if($4==null){return $0;
}else{var $5=$4[2];
var $6=$4[3];
var $7=$4[6];
if($5==null||$5.length==0){$5=$1.getFullName();
}else if($1&&$5.indexOf($[24])==-1){var $8=$1.getName();
if($1 instanceof apiviewer.dao.Package){var $9=$1.getFullName();
}else{var $a=$1.getFullName();
var $9=$a.substring(0,
$a.length-$8.length-1);
}$5=$9+$[24]+$5;
}if($7==null||$7.length==0){$7=$4[1];
}if($2){var $b=apiviewer.dao.Class.getClassByName($5);
if($b){var $c;
if($6){var $d=$6.substring(1);
var $e=$d.indexOf($[102]);
if($e!=-1){$d=qx.lang.String.trim($d.substring(0,
$e));
}$c=$b.getItem($d);
}else{$c=$b;
}
if($c){var $f=apiviewer.TreeUtil.getIconUrl($c);
var $g=apiviewer.ui.ClassViewer.createImageHtml($f);
}}}var $h=$5+($6?$6:$[0]);
var $i=new qx.util.StringBuilder($[2125],
(typeof $g!=$[5]?$g:$[0]),
$[954]+window.location.protocol,
$[1348],
...
createSeeAlsoHtml:function($0){var $1=apiviewer.ui.ClassViewer;
var $2=$0.getSee();
if($2.length>0){var $3=new qx.util.StringBuilder();
for(var $4=0;$4<$2.length;$4++){if($3.length!=0){$3.add($[409]);
}$3.add(this.createItemLinkHtml($2[$4].getName(),
$0.getClass()));
}
if(!$3.isEmpty()){$3.add($[33],
$[736],
$[4],
$[32],
$3,
...
createInheritedFromHtml:function($0,
$1){var $2=apiviewer.ui.ClassViewer;
if($0.getClass().getType()!=$[89]&&$0.getClass()!=$1){var $3=new qx.util.StringBuilder($[33],
$[1121],
$[4],
$[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getClass().getFullName()+$[59]+$0.getName()),
$[4]);
return $3.get();
}else{return $[0];
}},
createOverwriddenFromHtml:function($0){var $1=apiviewer.ui.ClassViewer;
if($0.getOverriddenFrom()){var $2=new qx.util.StringBuilder($[33],
$[1816],
$[4],
$[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getOverriddenFrom().getFullName()+$[59]+$0.getName()),
$[4]);
return $2.get();
}else{return $[0];
}},
createIncludedFromHtml:function($0,
$1){var $2=apiviewer.ui.ClassViewer;
if($0.getClass()!=$1){if($0.getClass().getType()==$[89]){var $3=new qx.util.StringBuilder($[33],
$[726],
$[4],
$[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getClass().getFullName()+$[59]+$0.getName()),
...
createDescriptionHtml:function($0,
$1,
$2){var $3=$0.getDescription();
if($3){if(!$2){$3=this.__extractFirstSentence($3);
}return $[416]+this.resolveLinkAttributes($3,
$1)+$[4];
}else{return $[0];
}},
__extractFirstSentence:function($0){var $1=$0;
var $2=$1.indexOf($[622]);
if($2!=-1){$1=$1.substr(0,
$2+4);
var $3=this.SENTENCE_END_REGEX.exec($1);
if($3!=null){$1=$0.substring(0,
$3.index+$3[0].length-1)+$[622];
}}return $1;
},
descriptionHasDetails:function($0){var $1=$0.getDescription();
if($1){return this.__extractFirstSentence($1)!=$1;
}else{return false;
}},
createTypeHtml:function($0,
$1,
$2){if($2==null){$2=true;
}var $3=[];
var $4,
...
$7;
if($0){$3=$0.getTypes();
}var $8=new qx.util.StringBuilder();
if($3.length==0){$8.add($1);
}else{if($3.length>1){$8.add($[102]);
}
for(var $9=0;$9<$3.length;$9++){if($9>0){$8.add($[1889]);
}$5=$3[$9].type;
$4=$3[$9].dimensions;
if(apiviewer.ui.ClassViewer.PRIMITIVES[$5]){$8.add($5);
}else{$6=$5;
if($2){var $a=$5.lastIndexOf($[24]);
if($a!=-1){$6+=$[53]+$5.substring($a+1);
}}$8.add(apiviewer.ui.panels.InfoPanel.createItemLinkHtml($6,
$0.getClass(),
false,
true));
}
if($4){for(var $b=0;$b<parseInt($4);$b++){$8.add($[533]);
}}}
if($3.length>1){$8.add($[57]);
}}return $8.get();
},
createErrorHtml:function($0,
$1){var $2=apiviewer.ui.ClassViewer;
docNode=$0.getDocNode();
var $3=docNode.getErrors();
if($3.length>0){var $4=new qx.util.StringBuilder($[693],
$[811],
$[4]);
for(var $5=0;$5<$3.length;$5++){$4.add($[32],
$3[$5].attributes.msg,
$[1371]);
$4.add($[102]);
if($0.getClass()!=$1){$4.add($0.getClass().getFullName(),
$[959]);
}$4.add($[1981],
$3[$5].attributes.line,
$[987],
$3[$5].attributes.column+$[57],
$[4]);
}return $4.get();
}else{return $[0];
}},
createDeprecationHtml:function($0,
$1){if(!$0.isDeprecated()){return $[0];
}var $2=apiviewer.ui.ClassViewer;
var $3=new qx.util.StringBuilder();
$3.add($[693],
$[574],
...
createAccessHtml:function($0){if($0.isPublic()){return $[0];
}var $1=apiviewer.ui.ClassViewer;
var $2=new qx.util.StringBuilder();
$2.add($[33],
$[762],
$[4]);
$2.add($[32]);
var $3=[];
if($0.isPrivate()){$3.push($[664]);
}
if($0.isInternal()){$3.push($[540]);
}
if($0.isProtected()){$3.push($[391]);
}$2.add($3.join($[53]));
$2.add($[4]);
return $2.get();
},
createInfoRequiredByHtml:function($0){var $1=apiviewer.ui.ClassViewer;
var $2=new qx.util.StringBuilder();
var $3=$0.getRequiredBy();
if($3.length>0){$2.add($[33],
$[1317],
$[4]);
for(var $4=0;$4<$3.length;$4++){$2.add($[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($3[$4].getFullName()+$[59]+$0.getName()),
$[4]);
}}return $2.get();
},
setTitleClass:function($0,
$1){var $2=[$[520],
$[0],
$[343],
$1,
$[141]];
$2[1]=this.getItemCssClasses($0);
return $2.join($[0]);
},
getItemCssClasses:function($0){var $1=[];
if($0.isDeprecated()){$1.push($[1500]);
}
if($0.isPrivate()){$1.push($[1113]);
}
if($0.isInternal()){$1.push($[1990]);
}
if($0.isProtected()){$1.push($[1807]);
}return $1.join($[53]);
}},
members:{canDisplayItem:function($0){return ($0.getListName()==this.getListName());
},
getItemTypeHtml:function($0,
$1){throw new Error("Abstract method called!");
},
getItemTitleHtml:function($0,
$1){throw new Error("Abstract method called!");
},
getItemTextHtml:function($0,
$1,
$2){throw new Error("Abstract method called!");
},
getItemTooltip:function($0,
$1){return $[0];
},
getItemHtml:function($0,
$1,
$2){if(($0 instanceof apiviewer.dao.Class)||$0 instanceof apiviewer.dao.Package){var $3=$0.getPackage();
}else{var $3=$0.getClass();
}var $4=new qx.util.StringBuilder();
var $5=($3!=$1)&&$3.getType()==$[222];
var $6=apiviewer.TreeUtil.getIconUrl($0,
$5);
$4.add($[1592],
apiviewer.ui.panels.InfoPanel.getItemCssClasses($0),
$[194]);
var $7=this.getItemTooltip($0,
$1);
var $8=$7?$[1300]+$7+$[1781]+$7+$[67]:$[366];
$4.add($[840],
$8,
$[558],
apiviewer.ui.ClassViewer.createImageHtml($6),
$[223]);
var $9=this.getItemTypeHtml($0,
$1);
$4.add($[1064],
(($9)?($9+$[334]):$[334]),
$[223]);
$4.add($[1338]);
if(this.itemHasDetails($0,
$1)){$4.add($[658],
qx.io.Alias.getInstance().resolve($[1832]),
$[290],
this.__encodeObject(this),
$[634],
$0.getName(),
$[162],
(($3!=$1)?$[650]+$3.getFullName()+$[162]:$[0]),
$[944]);
}else{$4.add($[1176]);
}$4.add($[223]);
$4.add($[1648]);
...
}$4.add(this.getItemTitleHtml($0,
$1));
$4.add($[1844]);
$4.add($[1222],
$0.getName(),
$[194]);
$4.add(this.getItemTextHtml($0,
$1,
$2));
$4.add($[4]);
$4.add($[223]);
...
__encodeObject:function($0){return $[1514]+$0.toHashCode()+$[57];
},
getPanelHtml:function($0){var $1=this._labelText.charAt(0).toUpperCase()+this._labelText.substring(1);
var $2=new qx.util.StringBuilder($[1339]);
$2.add($[1542],
qx.io.Alias.getInstance().resolve($[1325]+(this.getIsOpen()?$[1974]:$[1631])),
$[290],
this.__encodeObject($0),
$[415]+this.__encodeObject(this),
$[1519],
$[2088],
this.__encodeObject($0),
$[415],
...
_getPanelItems:function($0,
$1){if(!$1){return [];
}var $2=this.getListName();
var $3=[];
var $4={};
if($0&&($2==$[182]||$2==$[119]||$2==$[180])){var $5=$1.getClassHierarchy();
}else{$5=[$1];
}
for(var $6=0;$6<$5.length;$6++){var $7=$5[$6];
var $8=$7.getItemList(this.getListName());
if($2==$[182]||$2==$[119]||$2==$[180]){qx.lang.Array.append($8,
$7.getNodesOfTypeFromMixins(this.getListName()));
}for(var $9=0;$9<$8.length;$9++){var $a=$8[$9].getName();
if(!$4[$a]){$4[$a]=$7;
$3.push($8[$9]);
}}}return $3;
},
__filterItems:function($0,
$1,
$2){if($1&&$2){return $0;
}copyArr=$0.concat();
for(var $3=$0.length-1;$3>=0;$3--){var $4=$0[$3];
if($4.isPrivate()&&!$2){qx.lang.Array.removeAt(copyArr,
$3);
}
if($4.isProtected()&&!$1){qx.lang.Array.removeAt(copyArr,
$3);
}
if($4.isInternal()&&!$2){qx.lang.Array.removeAt(copyArr,
$3);
}}return copyArr;
},
_sortItems:function($0){$0.sort(function($1,
$2){sum1=0;
if($1.isInternal()){sum1+=4;
}
if($1.isPrivate()){sum1+=2;
}
if($1.isProtected()){sum1+=1;
}sum2=0;
if($2.isInternal()){sum2+=4;
}
if($2.isPrivate()){sum2+=2;
}
if($2.isProtected()){sum2+=1;
}
if(sum1==sum2){var $3=$1.getName();
var $4=$2.getName();
return $3.toLowerCase()<$4.toLowerCase()?-1:1;
}else{return sum1-sum2;
}});
},
_displayNodes:function($0,
$1){if($0&&$0.length>0){var $2=new qx.util.StringBuilder($[1043]);
for(var $3=0;$3<$0.length;$3++){$2.add(this.getItemHtml($0[$3],
$1,
false));
}$2.add($[669]);
this.getBodyElement().innerHTML=$2.get();
apiviewer.ui.AbstractViewer.fixLinks(this.getBodyElement());
apiviewer.ui.AbstractViewer.highlightCode(this.getBodyElement());
this.getBodyElement().style.display=!this.getIsOpen()?$[14]:$[0];
this.getElement().style.display=$[0];
}else{this.getElement().style.display=$[14];
}},
update:function($0,
$1){this.setDocNode($1);
var $2=$0.getShowProtected();
var $3=$0.getShowInherited();
var $4=$0.getShowPrivate();
var $5=this._getPanelItems($3,
$1);
if($5&&$5.length>0){$5=this.__filterItems($5,
$2,
$4);
this._sortItems($5);
}this._displayNodes($5,
$1);
},
_applyElement:function($0){this._titleElement=$0.firstChild;
this._bodyElement=$0.lastChild;
},
getTitleElement:function(){return this._titleElement;
},
getBodyElement:function(){return this._bodyElement;
},
getItemElement:function($0){var $1=this.getBodyElement().getElementsByTagName($[827])[0].childNodes;
for(var $2=0;$2<$1.length;$2++){if($1[$2].childNodes[3].childNodes[1].getAttribute($[1098])==$0){return $1[$2].childNodes[3].childNodes[1];
}}},
toggleShowItemDetails:function($0,
$1){try{var $2=this.getItemElement($0);
if(!$2){throw Error("Element for name '"+$0+"' not found!");
}var $3=$2._showDetails?!$2._showDetails:true;
$2._showDetails=$3;
if($1){var $4=apiviewer.dao.Class.getClassByName($1);
}else{$4=this.getDocNode();
}var $5=$4.getItemByListAndName(this.getListName(),
$0);
var $6=$2.parentNode.previousSibling.firstChild;
$6.src=qx.io.Alias.getInstance().resolve($3?$[413]:$[412]);
$2.innerHTML=this.getItemTextHtml($5,
this.getDocNode(),
$3);
apiviewer.ui.AbstractViewer.fixLinks($2);
apiviewer.ui.AbstractViewer.highlightCode($2);
}catch(exc){this.error("Toggling item details failed",
exc);
}}},
destruct:function(){this._disposeFields($[2153],
$[1311]);
}});
...
addClass:function($0){var $1=$0.getFullName();
var $2=this.getClasses();
for(var $3=0;$3<$2.length;$3++){if($2[$3].getFullName()==$1){$2[$3]=$0;
return;
}}$2.push($0);
},
getItem:function($0){var $1=[$[510],
$[631]];
for(var $2=0;$2<$1.length;$2++){var $3=this[$1[$2]]();
for(var $4=0;$4<$3.length;$4++){if($0==$3[$4].getName()){return $3[$4];
}}}},
getItemList:function($0){var $1={"classes":$[510],
"packages":$[631]};
return this[$1[$0]]();
},
getItemByListAndName:function($0,
...
_addChildNode:function($0){switch($0.type){case $[195]:this._classes=this._createNodeList($0,
apiviewer.dao.Class,
this);
break;
case $[375]:this._packages=this._createNodeList($0,
...
/* ID: apiviewer.ui.panels.MethodPanel */
qx.Class.define($[743],
{extend:apiviewer.ui.panels.InfoPanel,
members:{getItemTitleHtml:function($0){if($0.isConstructor()){var $1=$0.getClass().getName();
}else{$1=$0.getName();
}var $2=new qx.util.StringBuilder(apiviewer.ui.panels.InfoPanel.setTitleClass($0,
$1));
$2.add($[2174]);
var $3=$0.getParams();
...
apiviewer.ui.panels.InfoPanel.createTypeHtml($5,
$[207]),
$[1728],
$5.getName(),
$[536]);
if($5.getDefaultValue()){$2.add($[129]);
}}$2.add($[1444]);
return $2.get();
},
getItemTypeHtml:function($0){var $1=new qx.util.StringBuilder();
if($0.isAbstract()){$1.add($[1975]);
}
if(!$0.isConstructor()){$1.add(apiviewer.ui.panels.InfoPanel.createTypeHtml($0.getDocNode().getReturn(),
$[863]));
}return $1.get();
},
getItemTextHtml:function($0,
$1,
$2){var $3=apiviewer.ui.ClassViewer;
var $4=$0.getClass();
var $5=new qx.util.StringBuilder();
if($0.isConstructor()&&!$0.getDescription()){$5.add($[1446],
$4.getName(),
$[24]);
}else{$5.add(apiviewer.ui.panels.InfoPanel.createDescriptionHtml($0,
$4,
$2));
}
if($2){var $6=$0.getDocNode().getParams();
if($6.length>0){$5.add($[33],
$[1649],
$[4]);
for(var $7=0;$7<$6.length;$7++){var $8=$6[$7];
var $9=$8.getType()?$8.getType():$[207];
var $a=$8.getArrayDimensions();
if($a){for(var $7=0;$7<$a;$7++){$9+=$[533];
}}var $b=$8.getDefaultValue();
$5.add($[32]);
if($b){$5.add($[828]);
}$5.add($[566],
$8.getName(),
...
$[972],
$[72]);
}var $c=$8.getDescription();
if($c){$5.add($[53],
apiviewer.ui.panels.InfoPanel.resolveLinkAttributes($c,
$4));
}$5.add($[4]);
}}var $d=$0.getDocNode().getReturn();
if($d){var $c=$d.getDescription();
if($c){$5.add($[33],
$[2023],
$[4],
$[32],
...
if($0.getApply()){$5.add($[33],
$[2047],
$[4],
$[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getApply(),
$0.getClass(),
true,
true),
$[4]);
}$5.add(apiviewer.ui.panels.InfoPanel.createAccessHtml($0));
$5.add(apiviewer.ui.panels.InfoPanel.createIncludedFromHtml($0,
$1));
$5.add(apiviewer.ui.panels.InfoPanel.createOverwriddenFromHtml($0));
$5.add(apiviewer.ui.panels.InfoPanel.createInheritedFromHtml($0,
$1));
$5.add(apiviewer.ui.panels.InfoPanel.createInfoRequiredByHtml($0));
$5.add(apiviewer.ui.panels.InfoPanel.createSeeAlsoHtml($0));
$5.add(apiviewer.ui.panels.InfoPanel.createErrorHtml($0,
$1));
$5.add(apiviewer.ui.panels.InfoPanel.createDeprecationHtml($0,
$[47]));
}return $5.get();
},
itemHasDetails:function($0,
$1){var $2=$0.getDocNode();
var $3=$2.getReturn()&&$2.getReturn().getDescription();
return ($0.getClass()!=
$1||$0.getOverriddenFrom()!=null||$0.getRequiredBy().length>0||$2.getParams().length>0||$3||$0.getSee().length>0||$0.getErrors().length>0||$0.isDeprecated()||$0.getApply()||apiviewer.ui.panels.InfoPanel.descriptionHasDetails($0));
}}});




/* ID: apiviewer.ui.panels.EventPanel */
qx.Class.define($[1535],
{extend:apiviewer.ui.panels.InfoPanel,
members:{itemHasDetails:function($0,
$1){return ($0.getClass()!=
$1||$0.getSee().length>0||$0.getErrors().length>0||apiviewer.ui.panels.InfoPanel.descriptionHasDetails($0));
},
getItemTypeHtml:function($0){return apiviewer.ui.panels.InfoPanel.createTypeHtml($0,
$[207]);
},
getItemTitleHtml:function($0){return apiviewer.ui.panels.InfoPanel.setTitleClass($0,
$0.getName());
},
getItemTextHtml:function($0,
$1,
$2){textHtml=new qx.util.StringBuilder(apiviewer.ui.panels.InfoPanel.createDescriptionHtml($0,
$0.getClass(),
$2));
if($2){textHtml.add(apiviewer.ui.panels.InfoPanel.createInheritedFromHtml($0,
$1));
textHtml.add(apiviewer.ui.panels.InfoPanel.createSeeAlsoHtml($0));
textHtml.add(apiviewer.ui.panels.InfoPanel.createErrorHtml($0,
$1));
textHtml.add(apiviewer.ui.panels.InfoPanel.createDeprecationHtml($0,
$[348]));
}return textHtml.get();
}}});
...
/* ID: apiviewer.ui.panels.PropertyPanel */
qx.Class.define($[988],
{extend:apiviewer.ui.panels.InfoPanel,
members:{__createGeneratedMethodsHtml:function($0,
$1){if($0.getPropertyType()==$[2099]||$0.getPropertyType()==$[1144]||$0.isRefined()){return $[0];
}
if($0.isPrivate()){var $2=$[477];
var $3=$0.getName().substring(2);
}else if($0.isProtected()){$2=$[106];
$3=$0.getName().substring(1);
}else{$2=$[0];
$3=$0.getName();
}$3=qx.lang.String.toFirstUp($3);
var $4=[];
if($0.getPropertyType()==$[1754]){$4.push($[150]+$2+$[96]+$3+$[428]);
}else{$4.push($[150]+$2+$[30]+$3+$[1897]);
if(!$0.isPropertyGroup()){$4.push($[150]+$2+$[96]+$3+$[428]);
$4.push($[150]+$2+$[80]+$3+$[735]);
}$4.push($[150]+$2+$[101]+$3+$[1813]);
if($0.getType()==$[2]){$4.push($[150]+$2+$[321]+$3+$[1497]);
$4.push($[150]+$2+$[670]+$3+$[938]);
}}var $5=new qx.util.StringBuilder();
$5.add($[33],
$[1440],
$[4],
...
$5.add($[1027]);
$5.add($[4]);
return apiviewer.ui.panels.InfoPanel.resolveLinkAttributes($5.get(),
$1);
},
__createAttributesHtml:function($0){var $1=[];
if($0.isNullable()){$1.push($[2010]);
}
if($0.isInheritable()){$1.push($[1367]);
}
if($0.isThemeable()){$1.push($[1087]);
}
if($0.isPropertyGroup()){$1.push($[1004]);
}
if($0.isRefined()){$1.push($[1747]);
}
if($1.length>0){var $2=new qx.util.StringBuilder();
$2.add($[33],
$[2157],
$[4],
$[32]);
...
__createRefinedFromHtml:function($0){if($0.isRefined()){var $1=new qx.util.StringBuilder($[33],
$[1099],
$[4],
$[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getOverriddenFrom().getFullName()+$[59]+$0.getName()),
...
getItemTextHtml:function($0,
$1,
$2){var $3=$0.getDocNode();
var $4=new qx.util.StringBuilder(apiviewer.ui.panels.InfoPanel.createDescriptionHtml($0,
$0.getClass(),
$2));
if($2){var $5=null;
var $6=qx.lang.Array.clone($0.getPossibleValues());
if($6.length>0){if($0.isNullable()){$6.push($[183]);
}$5=$[566]+$6.join($[1049])+$[488];
}else if($0.getClassname()){$5=$[557]+$0.getClassname();
}else if($0.getInstance()){$5=$[557]+$0.getInstance()+$[1333];
}else if($0.getUnitDetection()){$5=$[1206]+$0.getUnitDetection();
}else if($0.getType()){$5=$[1116]+$0.getType();
}
if($5){$4.add($[33],
$[1323],
$[4],
...
$4.add($5,
$[4]);
}if($0.getCheck()){$4.add($[33],
$[920],
$[4],
$[32],
$0.getCheck(),
$[4]);
}if(!$0.isPropertyGroup()){$4.add($[33],
$[980],
$[4],
$[32],
$[1076],
($0.getDefaultValue()?$0.getDefaultValue():$[183]),
$[536],
$[4]);
}if($0.getGetAlias()){$4.add($[33],
$[739],
$[4],
$[32],
$0.getGetAlias(),
$[4]);
}if($0.getSetAlias()){$4.add($[33],
$[1208],
$[4],
$[32],
$0.getSetAlias(),
$[4]);
}if($0.getEvent()&&!$0.isRefined()){$4.add($[33],
$[1458],
$[4],
$[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($[59]+$0.getEvent(),
$0.getClass(),
true,
true),
$[4]);
}if($0.getApplyMethod()&&!$0.isRefined()){$4.add($[33],
$[1621],
$[4],
$[32],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($[59]+$0.getApplyMethod(),
$0.getClass(),
true,
true),
$[4]);
}$4.add(this.__createAttributesHtml($0));
$4.add(this.__createGeneratedMethodsHtml($0,
$1));
$4.add(apiviewer.ui.panels.InfoPanel.createIncludedFromHtml($0,
$1));
$4.add(this.__createRefinedFromHtml($0));
$4.add(apiviewer.ui.panels.InfoPanel.createInheritedFromHtml($0,
$1));
$4.add(apiviewer.ui.panels.InfoPanel.createInfoRequiredByHtml($0));
$4.add(apiviewer.ui.panels.InfoPanel.createSeeAlsoHtml($3));
$4.add(apiviewer.ui.panels.InfoPanel.createErrorHtml($0,
$1));
$4.add(apiviewer.ui.panels.InfoPanel.createDeprecationHtml($3,
$[911]));
}return $4.get();
}}});
...
/* ID: apiviewer.ui.panels.ConstantPanel */
qx.Class.define($[1044],
{extend:apiviewer.ui.panels.InfoPanel,
members:{itemHasDetails:function($0,
$1){return ($0.getSee().length>0||$0.getErrors().length>0||apiviewer.ui.panels.InfoPanel.descriptionHasDetails($0)||this.__hasConstantValueHtml($0));
},
getItemTypeHtml:function($0){return apiviewer.ui.panels.InfoPanel.createTypeHtml($0,
$[207]);
},
...
getItemTextHtml:function($0,
$1,
$2){var $3=apiviewer.ui.panels.InfoPanel.createDescriptionHtml($0,
$0.getClass(),
$2);
if($2){$3+=this.__createConstantValueHtml($0);
$3+=apiviewer.ui.panels.InfoPanel.createSeeAlsoHtml($0);
$3+=apiviewer.ui.panels.InfoPanel.createErrorHtml($0,
$1);
$3+=apiviewer.ui.panels.InfoPanel.createDeprecationHtml($0,
$[2014]);
}return $3;
},
__hasConstantValueHtml:function($0){return $0.getValue()?true:false;
},
__createConstantValueHtml:function($0){var $1=apiviewer.ui.ClassViewer;
if(this.__hasConstantValueHtml($0)){html=new qx.util.StringBuilder($[33],
$[2106],
$[4],
$[32],
qx.html.String.escape(qx.io.Json.stringify($0.getValue())),
$[4]);
return html.get();
}else{return $[0];
}}}});
...
/* ID: apiviewer.ui.panels.AppearancePanel */
qx.Class.define($[1792],
{extend:apiviewer.ui.panels.InfoPanel,
members:{__getAllAppearanceStates:function($0){var $1=$0.getStates();
if($1.length>0){var $2=qx.lang.Array.copy($1);
}else{$2=[];
}var $3=$0.getType();
var $4=$0.getClass();
var $5=1;
if($3!=$4){$4=$3;
$5=0;
}var $6=$4.getClassHierarchy();
for(var $7=$5;$7<$6.length;$7++){$4=$6[$7];
var $8=$4.getClassAppearance();
if($8){var $9=$8.getStates();
if($9){qx.lang.Array.append($2,
$9);
}}}return $2;
},
_getPanelItems:function($0,
$1){var $2=arguments.callee.base.call(this,
$0,
$1);
if(!$0){return $2;
}var $3=$1.getClassHierarchy();
for(var $4=0;$4<$3.length;$4++){classNode=$3[$4];
var $5=classNode.getClassAppearance();
if($5){if($5.getType()!=$1){$2.push($5);
}return $2;
}}},
getItemTypeHtml:function($0){var $1=$0.getName();
if($0.getType()==$0.getClass()){var $2=$1+$[1912];
}else{var $2=$1;
}return $2;
},
getItemTitleHtml:function($0){return apiviewer.ui.panels.InfoPanel.setTitleClass($0,
...
var $4=new qx.util.StringBuilder();
$4.add($[416],
apiviewer.ui.panels.InfoPanel.createDescriptionHtml($0,
$0.getClass(),
true),
$[4]);
if($2){var $5=this.__getAllAppearanceStates($0);
if($5.length>0){$4.add($[33],
$[1787],
$[4]);
for(var $6=0;$6<$5.length;$6++){var $7=$5[$6];
$4.add($[1593],
$7.getName(),
$[1811]);
var $8=$7.getAppearance();
if($8.getType()!=$0.getClass()){$4.add($[1664],
apiviewer.ui.panels.InfoPanel.createItemLinkHtml($8.getType().getFullName()),
$[1287]);
}var $9=$7.getDescription();
if($9){$4.add($[53],
apiviewer.ui.panels.InfoPanel.resolveLinkAttributes($9,
$7.getClass()));
}$4.add($[2226]);
}$4.add($[4]);
}}return $4.get();
...
itemHasDetails:function($0,
$1){return this.__getAllAppearanceStates($0).length>0;
}}});




/* ID: apiviewer.dao.Constant */
qx.Class.define($[1874],
{extend:apiviewer.dao.ClassItem,
construct:function($0,
$1,
$2){arguments.callee.base.call(this,
...
/* ID: apiviewer.dao.Appearance */
qx.Class.define($[1865],
{extend:apiviewer.dao.ClassItem,
construct:function($0,
$1,
$2){arguments.callee.base.call(this,
...
_addChildNode:function($0){switch($0.type){case $[2095]:this._states=this._createNodeList($0,
apiviewer.dao.State,
this);
break;
default:return arguments.callee.base.call(this,
...
/* ID: apiviewer.dao.State */
qx.Class.define($[1045],
{extend:apiviewer.dao.ClassItem,
construct:function($0,
$1){arguments.callee.base.call(this,
$0,
...
members:{_showHtml:function(){if(this.getHtml()!==$[0]){return;
}var $0=apiviewer.TreeUtil;
var $1=[{icon:$[519],
desc:$[1379]},
{icon:$[423],
desc:$[1636]},
...
for(var $3=0;$3<$1.length;$3++){var $4=$1[$3];
$2.add($[1560]);
$2.add(apiviewer.ui.ClassViewer.createImageHtml(apiviewer.TreeUtil.iconNameToIconPath($4.icon)));
$2.add($[1179],
$4.desc,
$[1603]);
}$2.add($[1262]);
this.setHtml($2.toString());
}}});
...
destruct:function(){this._disposeObjects($[1841],
$[278]);
}});
...
$1){var $2=this._bar;
var $3=this._pane;
switch($0){case $[15]:$2.moveSelfToBegin();
$2.setHeight($[3]);
$2.setWidth(null);
$2.setOrientation($[19]);
$3.setWidth(null);
$3.setHeight($[69]);
this.setOrientation($[25]);
break;
case $[16]:$2.moveSelfToEnd();
$2.setHeight($[3]);
$2.setWidth(null);
$2.setOrientation($[19]);
$3.setWidth(null);
...
this.setOrientation($[25]);
break;
case $[9]:$2.moveSelfToBegin();
$2.setWidth($[3]);
$2.setHeight(null);
$2.setOrientation($[25]);
$3.setHeight(null);
$3.setWidth($[69]);
this.setOrientation($[19]);
break;
...
destruct:function(){this._disposeObjectDeep($[2163],
1);
}});
...
qx.Class.define($[1943],
{extend:qx.ui.pageview.AbstractBar,
properties:{appearance:{refine:true,
init:$[508]}},
members:{getWheelDelta:function($0){var $1=$0.getWheelDelta();
switch(this.getParent().getBarPosition()){case $[9]:case $[8]:$1*=-1;
}return $1;
},
_renderAppearance:function(){if(this.getParent()){var $0=this.getParent().getBarPosition();
$0===$[9]?this.addState($[238]):this.removeState($[238]);
$0===$[8]?this.addState($[272]):this.removeState($[272]);
$0===$[15]?this.addState($[264]):this.removeState($[264]);
$0===$[16]?this.addState($[241]):this.removeState($[241]);
}arguments.callee.base.call(this);
}}});
...
$0===$[15]||$0===$[16]?this.addState($[639]):this.removeState($[639]);
$0===$[9]||$0===$[8]?this.addState($[468]):this.removeState($[468]);
}arguments.callee.base.call(this);
}}});
...
$0);
}}$0?this.addState($[188]):this.removeState($[188]);
var $3=this.getPage();
...
appearance:{refine:true,
init:$[1003]}},
members:{_onkeypress:function($0){switch(this.getView().getBarPosition()){case $[15]:case $[16]:switch($0.getKeyIdentifier()){case $[153]:var $1=true;
break;
case $[154]:var $1=false;
break;
default:return;
}break;
case $[9]:case $[8]:switch($0.getKeyIdentifier()){case $[235]:var $1=true;
break;
case $[273]:var $1=false;
break;
default:return;
}break;
default:return;
...
$1.setLeft($3.left);
switch(this.getDirection()){case $[436]:$1.setBottom($3.top);
$1.setTop(null);
break;
case $[294]:$1.setTop($3.bottom);
$1.setBottom(null);
break;
}this.addState($[62]);
...
$1.removeEventListener($[128],
this._onmenuappear,
this);
$1.removeEventListener($[357],
this._onmenudisappear,
this);
}
if($0){$0.setOpener(this);
$0.addEventListener($[128],
this._onmenuappear,
this);
$0.addEventListener($[357],
this._onmenudisappear,
this);
}},
_onmousedown:function($0){if($0.getTarget()!=this||!$0.isLeftButtonPressed()){return;
}this.hasState($[62])?this._hideMenu():this._showMenu();
},
...
inheritable:true,
event:$[312]}},
destruct:function(){this._disposeObjects($[1060]);
}});
...
properties:{checked:{check:$[2],
init:false,
apply:$[220],
event:$[146]}},
members:{_applyChecked:function($0,
$1){$0?this.addState($[188]):this.removeState($[188]);
},
_onmouseup:function($0){this.setCapture(false);
if(!this.hasState($[73])){this.addState($[74]);
...
this.addInfoPanel(new apiviewer.ui.panels.ClassPanel($[195],
$[195],
$[222]));
this.addInfoPanel(new apiviewer.ui.panels.ClassPanel($[195],
$[2045],
...
$[1976],
$[89]));
this.addInfoPanel(new apiviewer.ui.panels.PackagePanel($[375],
$[375]));
},
members:{_getTitleHtml:function($0){var $1=$[0];
$1+=$[1604];
$1+=$0.getFullName();
return $1;
},
_getDescriptionHtml:function($0){var $1=new qx.util.StringBuilder();
desc=$0.getDescription();
if(desc!=$[0]){$1.add($[440],
apiviewer.ui.panels.InfoPanel.resolveLinkAttributes(desc,
$0),
$[4]);
}return $1.get();
}}});
...
/* ID: apiviewer.ui.panels.ClassPanel */
qx.Class.define($[2179],
{extend:apiviewer.ui.panels.InfoPanel,
construct:function($0,
$1,
$2){arguments.callee.base.call(this,
...
properties:{type:{check:[$[222],
$[89],
$[152]]}},
members:{getItemTypeHtml:function($0){return apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getName(),
$0,
false,
true);
},
getItemTitleHtml:function($0){return $0.getFullName();
},
getItemTextHtml:function($0,
$1,
$2){if($2){return apiviewer.ui.panels.InfoPanel.resolveLinkAttributes($0.getDescription(),
$0);
}else{return apiviewer.ui.panels.InfoPanel.createDescriptionHtml($0,
$0.getClass(),
$2);
}},
getItemTooltip:function($0,
$1){if($0.isAbstract()){var $2=$[665];
}else if($0.isStatic()){var $2=$[463];
}else if($0.isSingleton()){var $2=$[680];
}else{var $2=$[0];
}
switch($0.getType()){case $[89]:$2+=$[371];
break;
case $[152]:$2+=$[309];
break;
default:$2+=$[640];
...
itemHasDetails:function($0,
$1){return apiviewer.ui.panels.InfoPanel.descriptionHasDetails($0);
},
update:function($0,
$1){this.setDocNode($1);
var $2=$1.getClasses();
var $3=[];
for(var $4=0;$4<$2.length;$4++){if($2[$4].getType()==this.getType()){$3.push($2[$4]);
}}
if($3&&$3.length>0){this._sortItems($3);
}this._displayNodes($3,
$1);
}}});
...
/* ID: apiviewer.ui.panels.PackagePanel */
qx.Class.define($[2102],
{extend:apiviewer.ui.panels.InfoPanel,
members:{getItemTypeHtml:function($0){return apiviewer.ui.panels.InfoPanel.createItemLinkHtml($0.getFullName(),
null,
false,
true);
},
...
$1){this.setDocNode($1);
var $2=$1.getPackages();
if($2&&$2.length>0){this._sortItems($2);
}this._displayNodes($2,
$1);
}}});
...
firstSize:{apply:$[974],
init:$[69]},
secondSize:{apply:$[2065],
init:$[69]},
splitterSize:{check:$[11],
init:4,
apply:$[1551],
themeable:true}},
...
switch($1){case $[19]:this._splitter.removeEventListener($[26],
this._onSplitterMouseDownX,
this);
this._splitter.removeEventListener($[79],
this._onSplitterMouseMoveX,
this);
this._splitter.removeEventListener($[23],
this._onSplitterMouseUpX,
this);
this._knob.removeEventListener($[26],
this._onSplitterMouseDownX,
this);
this._knob.removeEventListener($[79],
this._onSplitterMouseMoveX,
this);
this._knob.removeEventListener($[23],
this._onSplitterMouseUpX,
this);
this._splitter.removeState($[19]);
this._knob.removeState($[19]);
this._firstArea.setWidth(null);
this._secondArea.setWidth(null);
this._splitter.setWidth(null);
break;
case $[25]:this._splitter.removeEventListener($[26],
...
this._onSplitterMouseUpY,
this);
this._splitter.removeState($[25]);
this._knob.removeState($[25]);
this._firstArea.setHeight(null);
this._secondArea.setHeight(null);
this._splitter.setHeight(null);
break;
}
switch($0){case $[19]:this._splitter.addEventListener($[79],
this._onSplitterMouseMoveX,
this);
this._splitter.addEventListener($[26],
this._onSplitterMouseDownX,
this);
this._splitter.addEventListener($[23],
this._onSplitterMouseUpX,
this);
this._knob.addEventListener($[79],
this._onSplitterMouseMoveX,
this);
this._knob.addEventListener($[26],
this._onSplitterMouseDownX,
this);
this._knob.addEventListener($[23],
this._onSplitterMouseUpX,
this);
this._splitter.addState($[19]);
this._knob.addState($[19]);
break;
case $[25]:this._splitter.addEventListener($[26],
this._onSplitterMouseDownY,
this);
this._splitter.addEventListener($[79],
this._onSplitterMouseMoveY,
this);
this._splitter.addEventListener($[23],
this._onSplitterMouseUpY,
...
this._onSplitterMouseUpY,
this);
this._splitter.addState($[25]);
this._knob.addState($[25]);
break;
}this._syncFirstSize();
...
_syncFirstSize:function(){switch(this.getOrientation()){case $[19]:this._firstArea.setWidth(this.getFirstSize());
break;
case $[25]:this._firstArea.setHeight(this.getFirstSize());
break;
}},
_syncSecondSize:function(){switch(this.getOrientation()){case $[19]:this._secondArea.setWidth(this.getSecondSize());
break;
case $[25]:this._secondArea.setHeight(this.getSecondSize());
break;
}},
_syncSplitterSize:function(){switch(this.getOrientation()){case $[19]:this._splitter.setWidth(this.getSplitterSize());
break;
case $[25]:this._splitter.setHeight(this.getSplitterSize());
break;
}},
_onSplitterMouseDownX:function($0){if(!$0.isLeftButtonPressed()){return;
}this._commonMouseDown();
this.getTopLevelWidget().setGlobalCursor($[284]);
this._slider.addState($[167]);
this._knob.addState($[167]);
...
this.getTopLevelWidget().setGlobalCursor($[350]);
this._slider.addState($[167]);
this._knob.addState($[167]);
...
this.getTopLevelWidget().setGlobalCursor(null);
this._slider.removeState($[167]);
this._knob.removeState($[167]);
},
...
destruct:function(){this._disposeObjects($[771],
$[1614],
$[1474],
$[1537],
$[2116],
...
{extend:qx.ui.layout.CanvasLayout,
construct:function($0){arguments.callee.base.call(this);
this.setAppearance($[1160]);
this.setStyleProperty($[229],
$[54]);
this.setStyleProperty($[289],
$[54]);
this.hide();
this._pane=$0;
this.initZIndex();
...
init:1e8}},
destruct:function(){this._disposeObjects($[278]);
}});
...
/* ID: apiviewer.Controller */
qx.Class.define($[2083],
{extend:qx.core.Object,
construct:function($0){arguments.callee.base.call(this);
this._widgetRegistry=apiviewer.MWidgetRegistry;
this._titlePrefix=qx.core.Setting.get($[333])+$[697];
document.title=this._titlePrefix;
this._classLoader=new apiviewer.ClassLoader($[1095]);
this._detailLoader=this._widgetRegistry.getWidgetById($[486]);
this._packageViewer=this._widgetRegistry.getWidgetById($[571]);
this._classViewer=this._widgetRegistry.getWidgetById($[511]);
this.__bindClassViewer();
this._tree=this._widgetRegistry.getWidgetById($[339]);
this.__bindTree();
this.__bindToolbar();
this._history=qx.client.History.getInstance();
this.__bindHistory();
},
members:{load:function($0){var $1=new qx.io.remote.Request($0);
$1.setTimeout(180000);
$1.setProhibitCaching(false);
$1.addEventListener($[18],
function($2){var $3=new Date();
this.debug("Time to load data from server: "+($3.getTime()-$9.getTime())+"ms");
var $4=$2.getContent();
var $5=new Date();
var $6=eval($[102]+$4+$[57]);
var $7=new Date();
this.debug("Time to eval tree data: "+($7.getTime()-$5.getTime())+"ms");
qx.client.Timer.once(function(){this.__setDocTree($6);
var $8=this._history.getState();
if($8){qx.client.Timer.once(function(){this.__selectItem(this.__decodeState($8));
},
this,
0);
}this._detailLoader.setHtml($[2223]+qx.core.Setting.get($[333])+$[2126]);
},
this,
0);
},
this);
$1.addEventListener($[27],
function($2){this.error("Couldn't load file: "+$0);
},
this);
var $9=new Date();
$1.send();
},
__bindClassViewer:function(){this._classViewer.addEventListener($[702],
function($0){this.__selectItem($0.getData());
},
this);
},
__bindTree:function(){this._tree.getManager().addEventListener($[373],
function($0){var $1=$0.getData()[0];
if($1&&$1.getUserData($[215])&&!this._ignoreTreeSelection){var $2=$1.getUserData($[215]);
this.__updateHistory($2);
}},
this);
this._tree.addEventListener($[128],
function($3){var $4=this._tree.getManager().getSelectedItem();
if($4){this._tree.getManager().scrollItemIntoView($4);
}},
this);
},
__bindToolbar:function(){var $0=this._widgetRegistry.getWidgetById($[473]);
$0.addEventListener($[146],
function($1){this._classViewer.setShowInherited($1.getData());
},
this);
var $2=this._widgetRegistry.getWidgetById($[338]);
$2.addEventListener($[146],
function($1){this._classViewer.setShowProtected($1.getData());
},
this);
var $3=this._widgetRegistry.getWidgetById($[307]);
$3.addEventListener($[146],
function($1){this._classViewer.setShowPrivate($1.getData());
},
this);
},
__bindHistory:function(){this._history.addEventListener($[568],
function($0){var $1=this.__decodeState($0.getData());
if($1){this.__selectItem($1);
}},
this);
},
__setDocTree:function($0){var $1=new Date();
var $2=new apiviewer.dao.Package($0);
var $3=new Date();
this.debug("Time to build data tree: "+($3.getTime()-$1.getTime())+"ms");
var $1=new Date();
this._tree.setTreeData($2);
var $3=new Date();
this.debug("Time to update tree: "+($3.getTime()-$1.getTime())+"ms");
return true;
},
__updateHistory:function($0){var $1=this._titlePrefix+$[2143]+$0;
qx.client.History.getInstance().addToHistory(this.__encodeState($0),
$1);
},
__selectClass:function($0,
$1,
$2){this._detailLoader.setVisibility(false);
var $3=qx.ui.core.ClientDocument.getInstance();
$3.setGlobalCursor($[1089]);
var $4=$1?qx.lang.Function.bind($1,
$2):function(){};
if($0 instanceof apiviewer.dao.Class){this._classLoader.classLoadDependendClasses($0,
function($5){this._packageViewer.setVisibility(false);
this._classViewer.setDocNode($5);
this._classViewer.setVisibility(true);
$3.resetGlobalCursor();
$4();
},
this);
}else{this._classLoader.packageLoadDependendClasses($0,
function(){this._classViewer.setVisibility(false);
this._packageViewer.setDocNode($0);
...
__selectItem:function($0){var $1=$0;
var $2=null;
var $3=$0.indexOf($[59]);
if($3!=-1){$1=$0.substring(0,
$3);
$2=$0.substring($3+1);
var $4=$2.indexOf($[102]);
if($4!=-1){$2=qx.lang.String.trim($2.substring(0,
$4));
}}this._ignoreTreeSelection=true;
var $5=this._tree.selectTreeNodeByClassName($1);
this._ignoreTreeSelection=false;
if(!$5){this.error("Unknown class: "+$1);
alert("Unknown class: "+$1);
return;
}var $6=this._tree.getSelectedElement().getUserData($[215]);
this.__selectClass(apiviewer.dao.Class.getClassByName($6),
function(){if($2){if(!this._classViewer.showItem($2)){this.error("Unknown item of class '"+$1+"': "+$2);
alert("Unknown item of class '"+$1+"': "+$2);
return;
}}else{this._classViewer.setScrollTop(0);
}this.__updateHistory($0);
},
this);
},
__encodeState:function($0){return $0.replace(/(.*)#(.*)/g,
$[1689]);
},
__decodeState:function($0){return $0.replace(/(.*)~(.*)/g,
$[1373]);
}},
destruct:function(){this._disposeFields($[2006]);
this._disposeObjects($[460],
$[528],
$[526],
$[1674],
$[494],
...
/* ID: apiviewer.ClassLoader */
qx.Class.define($[2180],
{extend:qx.core.Object,
construct:function($0){arguments.callee.base.call(this);
this._baseUri=$0;
},
members:{load:function($0,
$1,
$2,
$3){var $4=this._baseUri+$[111]+$0+$[807];
var $5=new qx.io.remote.Request($4);
var $6=null;
$5.setAsynchronous($1);
$5.setTimeout(30000);
$5.setProhibitCaching(false);
$5.addEventListener($[18],
function($7){var $8=eval($[102]+$7.getContent()+$[57]);
var $9=$0.substring(0,
$0.lastIndexOf($[24]));
var $a=apiviewer.dao.Class.getClassByName($9);
$6=new apiviewer.dao.Class($8,
$a);
$a.addClass($6);
this.__runCallback($6,
$2,
$3);
},
this);
$5.addEventListener($[27],
function($7){alert("Couldn't load file: "+$4);
},
this);
$5.send();
return $6;
},
__runCallback:function($0,
$1,
$2){if($1){if($2){$1.call($2,
$0);
}else{$1($0);
}}},
__loadClassList:function($0,
$1,
$2){var $3=0;
var $4=0;
for(var $5=0;$5<$0.length;$5++){var $6=$0[$5];
if(!$6.isLoaded()){this.load($6.getFullName(),
true,
function($7){$4+=1;
if($4>=$3){this.__runCallback(apiviewer.dao.Class.getClassByName($0[0].getFullName()),
$1,
$2);
}},
this);
...
if($3==0){this.__runCallback($0[0],
$1,
$2);
}},
classLoadDependendClasses:function($0,
$1,
$2){var $3=$0.getDependendClasses();
this.__loadClassList($3,
$1,
$2);
},
packageLoadDependendClasses:function($0,
$1,
$2){var $3=$0.getClasses();
this.__loadClassList($3,
$1,
$2);
}}});
...
{"mshtml":function(){arguments.callee.base.call(this);
this._iframe=document.createElement($[266]);
this._iframe.style.visibility=$[21];
this._iframe.style.position=$[82];
this._iframe.style.left=$[696];
this._iframe.style.top=$[696];
document.body.appendChild(this._iframe);
var $0=qx.io.Alias.getInstance().resolve($[1392]);
this._iframe.src=$0;
this._titles={};
...
events:{"request":$[110]},
properties:{timeoutInterval:{check:$[45],
init:100,
apply:$[715]}},
...
if($0!=this._state){top.location.hash=$[59]+encodeURIComponent($0);
this.__storeState($0);
}},
...
this.createDispatchDataEvent($[568],
$0);
...
{"mshtml":function($0){var $1=$[1481]+encodeURIComponent($0)+$[1810];
...
"default":function($0){qx.client.Timer.once(function(){top.location.hash=$[59]+encodeURIComponent($0);
},
this,
0);
return true;
...
cldr_number_decimal_separator:$[24],
cldr_number_group_separator:$[28],
cldr_pm:"pm",
cldr_quotationEnd:"’",
cldr_quotationStart:"‘",
