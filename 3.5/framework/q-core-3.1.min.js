...
,getGeoLocation:function(){return bz in navigator;}
...
;var a=document.createElement(x);return a.canPlayType(P);}
...
;var a=document.createElement(x);return a.canPlayType(bQ);}
,getAudioAif:function(){if(!qx.bom.client.Html.getAudio()){return Q;}
;var a=document.createElement(x);return a.canPlayType(U);}
...
;var v=document.createElement(t);return v.canPlayType(bF);}
...
;}
,getUserDataStorage:function(){var bW=document.createElement(m);bW.style[bL]=bS;document.getElementsByTagName(w)[0].appendChild(bW);var bX=false;try{bW.addBehavior(bK);bW.load(bC);bX=true;}
catch(e){}
;document.getElementsByTagName(w)[0].removeChild(bW);return bX;}
