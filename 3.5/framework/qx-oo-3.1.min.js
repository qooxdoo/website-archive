...
(function(){var a='"',b="Class '",c="",d="Unsupported type!",e="change",f="qx.data.marshal.Json",g="Array",h="_validate",j="' could not be found.",k="set",l="_applyEventPropagation",m="qx.data.model.";qx.Class.define(f,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(n){qx.core.Object.call(this);this.__ym=n;}
,statics:{$$instance:null,createModel:function(o,p){if(this.$$instance===null){this.$$instance=new qx.data.marshal.Json();}
;this.$$instance.toClass(o,p);return this.$$instance.toModel(o);}
},members:{__ym:null,__yn:function(q){return Object.keys(q).sort().join(a);}
,toClass:function(r,s){this.__yo(r,s,null,0);}
,__yo:function(E,z,t,B){if(!qx.lang.Type.isObject(E)||!!E.$$isString||E instanceof qx.core.Object){if(E instanceof Array||qx.Bootstrap.getClass(E)==g){for(var i=0;i<E.length;i++ ){this.__yo(E[i],z,null,B+1);}
;}
;return;}
;var v=this.__yn(E);if(this.__ys(v,t,B)){return;}
;for(var D in E){this.__yo(E[D],z,D,B+1);}
;if(qx.Class.isDefined(m+v)){return;}
;if(this.__ym&&this.__ym.getModelClass&&this.__ym.getModelClass(v,E)!=null){return;}
;var F={};var w={__yp:this.__yp};for(var D in E){if(this.__ym&&this.__ym.getPropertyMapping){D=this.__ym.getPropertyMapping(D,v);}
;D=D.replace(/-|\.|\s+/g,c);{}
;F[D]={};F[D].nullable=true;F[D].event=e+qx.lang.String.firstUp(D);if(z){F[D].apply=l;}
;if(this.__ym&&this.__ym.getValidationRule){var y=this.__ym.getValidationRule(v,D);if(y){F[D].validate=h+D;w[h+D]=y;}
;}
;}
;if(this.__ym&&this.__ym.getModelSuperClass){var C=this.__ym.getModelSuperClass(v)||qx.core.Object;}
else {var C=qx.core.Object;}
;var x=[];if(this.__ym&&this.__ym.getModelMixins){var A=this.__ym.getModelMixins(v);if(!qx.lang.Type.isArray(A)){if(A!=null){x=[A];}
;}
else {x=A;}
;}
;if(z){x.push(qx.data.marshal.MEventBubbling);}
;var u={extend:C,include:x,properties:F,members:w,destruct:this.__yq};qx.Class.define(m+v,u);}
,__yq:function(){var G=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var H in G){this.__yp(this.get(G[H].name));}
;}
,__yp:function(I){if(!(I instanceof qx.core.Object)){return;}
;if(I.isDisposed()){return;}
;I.dispose();}
,__yr:function(L,K){var M;if(this.__ym&&this.__ym.getModelClass){M=this.__ym.getModelClass(L,K);}
;if(M!=null){return (new M());}
else {var J=m+L;var N=qx.Class.getByName(J);if(!N){throw new Error(b+J+j);}
;return (new N());}
;}
,__ys:function(O,R,P){var Q=this.__ym;return Q&&Q.ignore&&Q.ignore(O,R,P);}
,toModel:function(S){return this.__yt(S,null,0);}
,__yt:function(bd,U,ba){var Y=qx.lang.Type.isObject(bd);var T=bd instanceof Array||qx.Bootstrap.getClass(bd)==g;if((!Y&&!T)||!!bd.$$isString||bd instanceof qx.core.Object){return bd;}
else if(this.__ys(this.__yn(bd),U,ba)){return bd;}
else if(T){var be=new qx.data.Array();be.setAutoDisposeItems(true);for(var i=0;i<bd.length;i++ ){be.push(this.__yt(bd[i],null,ba+1));}
;return be;}
else if(Y){var V=this.__yn(bd);var bc=this.__yr(V,bd);for(var bb in bd){var W=bb;if(this.__ym&&this.__ym.getPropertyMapping){W=this.__ym.getPropertyMapping(bb,V);}
;var bf=W.replace(/-|\.|\s+/g,c);{}
;W=bf;var X=k+qx.lang.String.firstUp(W);if(bc[X]){bc[X](this.__yt(bd[bb],bb,ba+1));}
;}
;return bc;}
;throw new Error(d);}
},destruct:function(){this.__ym=null;}
});}
)();
...
;if((n instanceof qx.core.Object)&&qx.Class.hasMixin(n.constructor,qx.data.marshal.MEventBubbling)){var o=qx.lang.Function.bind(this.__pr,this,name);var q=n.addListener(g,o,this);var p=n.getUserData(d+this.$$hash);if(p==null){p=[];n.setUserData(d+this.$$hash,p);}
;p.push(q);}
;}
,__pr:function(name,e){var y=e.getData();var u=y.value;var s=y.old;if(qx.Class.hasInterface(e.getTarget().constructor,qx.data.IListData)){if(y.name.indexOf){var x=y.name.indexOf(h)!=-1?y.name.indexOf(h):y.name.length;var v=y.name.indexOf(f)!=-1?y.name.indexOf(f):y.name.length;if(v==0){var t=name+y.name;}
...
else if(arguments.length>1){this.__ps=[];for(var i=0;i<arguments.length;i++ ){this.__ps.push(arguments[i]);}
;}
else if(typeof r==n){this.__ps=new Array(r);}
else if(r instanceof Array){this.__ps=qx.lang.Array.clone(r);}
else {this.__ps=[];this.dispose();throw new Error(j);}
;for(var i=0;i<this.__ps.length;i++ ){this._applyEventPropagation(this.__ps[i],null,i);}
;this.__pt();{}
;}
,properties:{autoDisposeItems:{check:e,init:false}},events:{"change":q,"changeLength":q},members:{__ps:null,concat:function(s){if(s){var t=this.__ps.concat(s);}
else {var t=this.__ps.concat();}
;return new qx.data.Array(t);}
,join:function(u){return this.__ps.join(u);}
,pop:function(){var v=this.__ps.pop();this.__pt();this._registerEventChaining(null,v,this.length-1);this.fireDataEvent(o,{value:[],name:this.length+f,old:[v],item:this});this.fireDataEvent(g,{start:this.length-1,end:this.length-1,type:l,removed:[v],added:[]},null);return v;}
,push:function(w){for(var i=0;i<arguments.length;i++ ){this.__ps.push(arguments[i]);this.__pt();this._registerEventChaining(arguments[i],null,this.length-1);this.fireDataEvent(o,{value:[arguments[i]],name:(this.length-1)+f,old:[],item:this});this.fireDataEvent(g,{start:this.length-1,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,reverse:function(){if(this.length==0){return;}
;var x=this.__ps.concat();this.__ps.reverse();this.__pu(0,this.length);this.fireDataEvent(g,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(o,{value:this.__ps,name:k+(this.__ps.length-1),old:x,item:this});}
,shift:function(){if(this.length==0){return;}
;var y=this.__ps.shift();this.__pt();this._registerEventChaining(null,y,this.length-1);this.__pu(0,this.length);this.fireDataEvent(o,{value:[],name:m,old:[y],item:this});this.fireDataEvent(g,{start:0,end:this.length-1,type:l,removed:[y],added:[]},null);return y;}
,slice:function(A,z){return new qx.data.Array(this.__ps.slice(A,z));}
,splice:function(F,H,J){var M=this.__ps.length;var I=this.__ps.splice.apply(this.__ps,arguments);if(this.__ps.length!=M){this.__pt();}
...
;this.__pu(F+(arguments.length-2)-H,this.length);var G=[];for(var i=2;i<arguments.length;i++ ){G[i-2]=arguments[i];}
...
;var N=this.__ps.concat();this.__ps.sort.apply(this.__ps,arguments);if(qx.lang.Array.equals(this.__ps,N)===true){return;}
;this.__pu(0,this.length);this.fireDataEvent(g,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(o,{value:this.__ps,name:k+(this.length-1),old:N,item:this});}
,unshift:function(P){for(var i=arguments.length-1;i>=0;i-- ){this.__ps.unshift(arguments[i]);this.__pt();this.__pu(0,this.length);this.fireDataEvent(o,{value:[this.__ps[0]],name:m,old:[this.__ps[1]],item:this});this.fireDataEvent(g,{start:0,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,toArray:function(){return this.__ps;}
,getItem:function(Q){return this.__ps[Q];}
,setItem:function(R,T){var S=this.__ps[R];if(S===T){return;}
;this.__ps[R]=T;this._registerEventChaining(T,S,R);if(this.length!=this.__ps.length){this.__pt();}
...
,indexOf:function(U){return this.__ps.indexOf(U);}
,lastIndexOf:function(V){return this.__ps.lastIndexOf(V);}
,toString:function(){if(this.__ps!=null){return this.__ps.toString();}
;return f;}
,contains:function(W){return this.__ps.indexOf(W)!==-1;}
...
,removeAll:function(){for(var i=0;i<this.__ps.length;i++ ){this._registerEventChaining(null,this.__ps[i],i);}
;if(this.getLength()==0){return [];}
;var bk=this.getLength();var bj=this.__ps.concat();this.__ps.length=0;this.__pt();this.fireDataEvent(o,{value:[],name:k+(bk-1),old:bj,item:this});this.fireDataEvent(g,{start:0,end:bk-1,type:l,removed:bj,added:[]},null);return bj;}
,append:function(bl){if(bl instanceof qx.data.Array){bl=bl.toArray();}
;{}
;Array.prototype.push.apply(this.__ps,bl);for(var i=0;i<bl.length;i++ ){this._registerEventChaining(bl[i],null,this.__ps.length+i);}
;var bm=this.length;this.__pt();var name=bm==(this.length-1)?bm:bm+a+(this.length-1);this.fireDataEvent(o,{value:bl,name:name+f,old:[],item:this});this.fireDataEvent(g,{start:bm,end:this.length-1,type:b,added:bl,removed:[]},null);}
...
,forEach:function(bt,bu){for(var i=0;i<this.__ps.length;i++ ){bt.call(bu,this.__ps[i],i,this);}
;}
,filter:function(bv,self){return new qx.data.Array(this.__ps.filter(bv,self));}
,map:function(bw,self){return new qx.data.Array(this.__ps.map(bw,self));}
,some:function(bx,self){return this.__ps.some(bx,self);}
,every:function(by,self){return this.__ps.every(by,self);}
,reduce:function(bA,bz){return this.__ps.reduce(bA,bz);}
,reduceRight:function(bC,bB){return this.__ps.reduceRight(bC,bB);}
,__pt:function(){var bD=this.length;this.length=this.__ps.length;this.fireDataEvent(p,this.length,bD);}
,__pu:function(bF,bE){for(var i=bF;i<bE;i++ ){this._registerEventChaining(this.__ps[i],this.__ps[i],i);}
;}
},destruct:function(){for(var i=0;i<this.__ps.length;i++ ){var bG=this.__ps[i];this._applyEventPropagation(null,bG,i);if(this.isAutoDisposeItems()&&bG&&bG instanceof qx.core.Object){bG.dispose();}
;}
;this.__ps=null;}
});}
)();
