...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.71fdccfc62ca.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:d,apply:g}},members:{_storage:null,__CI:null,_applyModel:function(k,j){if(j){j.removeListenerById(this.__CI);j.dispose();this.__CI=null;}
;if(k){this.__CI=k.addListener(f,this.__CJ,this);this.__CJ();}
else {this._storage.removeItem(this._key);}
;}
,__CJ:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
