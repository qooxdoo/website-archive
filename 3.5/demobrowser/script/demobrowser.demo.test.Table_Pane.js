...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_Pane","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_Pane.967ece9407e0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{selectionModel:{check:a}},members:{__uw:null,handleMouseDown:function(c,d){if(d.isLeftPressed()){var e=this.getSelectionModel();if(!e.isSelectedIndex(c)){this._handleSelectEvent(c,d);this.__uw=true;}
else {this.__uw=false;}
;}
else if(d.isRightPressed()&&d.getModifiers()==0){var e=this.getSelectionModel();if(!e.isSelectedIndex(c)){e.setSelectionInterval(c,c);}
;}
;}
,handleMouseUp:function(f,g){if(g.isLeftPressed()&&!this.__uw){this._handleSelectEvent(f,g);}
;}
...
(function(){var a="..",b="changeSelection",c="Try to turn off batch mode althoug it was not turned on.",d="_applySelectionMode",f="]",g="qx.event.type.Event",h="Ranges:",k="qx.ui.table.selection.Model",l=" [";qx.Class.define(k,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__uI=[];this.__uJ=-1;this.__uK=-1;this.hasBatchModeRefCount=0;this.__uL=false;}
,events:{"changeSelection":g},statics:{NO_SELECTION:1,SINGLE_SELECTION:2,SINGLE_INTERVAL_SELECTION:3,MULTIPLE_INTERVAL_SELECTION:4,MULTIPLE_INTERVAL_SELECTION_TOGGLE:5},properties:{selectionMode:{init:2,check:[1,2,3,4,5],apply:d}},members:{__uL:null,__uJ:null,__uK:null,__uI:null,_applySelectionMode:function(m){this.resetSelection();}
,setBatchMode:function(n){if(n){this.hasBatchModeRefCount+=1;}
else {if(this.hasBatchModeRefCount==0){throw new Error(c);}
;this.hasBatchModeRefCount-=1;if(this.__uL){this.__uL=false;this._fireChangeSelection();}
;}
;return this.hasBatchMode();}
,hasBatchMode:function(){return this.hasBatchModeRefCount>0;}
,getAnchorSelectionIndex:function(){return this.__uJ;}
,_setAnchorSelectionIndex:function(o){this.__uJ=o;}
,getLeadSelectionIndex:function(){return this.__uK;}
,_setLeadSelectionIndex:function(p){this.__uK=p;}
,_getSelectedRangeArr:function(){return this.__uI;}
,resetSelection:function(){if(!this.isSelectionEmpty()){this._resetSelection();this._fireChangeSelection();}
;}
,isSelectionEmpty:function(){return this.__uI.length==0;}
,getSelectedCount:function(){var r=0;for(var i=0;i<this.__uI.length;i++ ){var q=this.__uI[i];r+=q.maxIndex-q.minIndex+1;}
;return r;}
,isSelectedIndex:function(s){for(var i=0;i<this.__uI.length;i++ ){var t=this.__uI[i];if(s>=t.minIndex&&s<=t.maxIndex){return true;}
;}
;return false;}
,getSelectedRanges:function(){var u=[];for(var i=0;i<this.__uI.length;i++ ){u.push({minIndex:this.__uI[i].minIndex,maxIndex:this.__uI[i].maxIndex});}
;return u;}
,iterateSelection:function(w,v){for(var i=0;i<this.__uI.length;i++ ){for(var j=this.__uI[i].minIndex;j<=this.__uI[i].maxIndex;j++ ){w.call(v,j);}
;}
;}
...
,removeSelectionInterval:function(G,E){this.__uJ=G;this.__uK=E;var D=Math.min(G,E);var H=Math.max(G,E);for(var i=0;i<this.__uI.length;i++ ){var J=this.__uI[i];if(J.minIndex>H){break;}
else if(J.maxIndex>=D){var K=(J.minIndex>=D)&&(J.minIndex<=H);var F=(J.maxIndex>=D)&&(J.maxIndex<=H);if(K&&F){this.__uI.splice(i,1);i-- ;}
else if(K){J.minIndex=H+1;}
else if(F){J.maxIndex=D-1;}
else {var I={minIndex:H+1,maxIndex:J.maxIndex};this.__uI.splice(i+1,0,I);J.maxIndex=D-1;break;}
;}
;}
;this._fireChangeSelection();}
,_resetSelection:function(){this.__uI=[];this.__uJ=-1;this.__uK=-1;}
,_addSelectionInterval:function(O,M){this.__uJ=O;this.__uK=M;var L=Math.min(O,M);var P=Math.max(O,M);var N=0;for(;N<this.__uI.length;N++ ){var Q=this.__uI[N];if(Q.minIndex>L){break;}
;}
;this.__uI.splice(N,0,{minIndex:L,maxIndex:P});var R=this.__uI[0];for(var i=1;i<this.__uI.length;i++ ){var Q=this.__uI[i];if(R.maxIndex+1>=Q.minIndex){R.maxIndex=Math.max(R.maxIndex,Q.maxIndex);this.__uI.splice(i,1);i-- ;}
else {R=Q;}
;}
;}
,_dumpRanges:function(){var S=h;for(var i=0;i<this.__uI.length;i++ ){var T=this.__uI[i];S+=l+T.minIndex+a+T.maxIndex+f;}
;this.debug(S);}
,_fireChangeSelection:function(){if(this.hasBatchMode()){this.__uL=true;}
...
;}
,properties:{highlightFocusRow:{check:b,init:true}},members:{_colors:null,__uX:null,__uY:null,initThemeValues:function(){this.__uY=r;this.__uX={};this._colors={};this._renderFont(qx.theme.manager.Font.getInstance().resolve(d));var y=qx.theme.manager.Color.getInstance();this._colors.bgcolFocusedSelected=y.resolve(u);this._colors.bgcolFocused=y.resolve(i);this._colors.bgcolSelected=y.resolve(p);this._colors.bgcolEven=y.resolve(a);this._colors.bgcolOdd=y.resolve(l);this._colors.colSelected=y.resolve(t);this._colors.colNormal=y.resolve(h);this._colors.horLine=y.resolve(n);}
,_insetY:1,_renderFont:function(z){if(z){this.__uX=z.getStyles();this.__uY=qx.bom.element.Style.compile(this.__uX);this.__uY=this.__uY.replace(/"/g,g);}
else {this.__uY=r;this.__uX=qx.bom.Font.getDefaultStyles();}
;}
,updateDataRowElement:function(D,A){var B=this.__uX;var C=A.style;qx.bom.element.Style.setStyles(A,B);if(D.focusedRow&&this.getHighlightFocusRow()){C.backgroundColor=D.selected?this._colors.bgcolFocusedSelected:this._colors.bgcolFocused;}
...
;return e+E+v;}
,createRowStyle:function(G){var F=[];F.push(x);F.push(this.__uY);F.push(q);if(G.focusedRow&&this.getHighlightFocusRow()){F.push(G.selected?this._colors.bgcolFocusedSelected:this._colors.bgcolFocused);}
...
},destruct:function(){this._colors=this.__uX=this.__uY=null;if(qx.core.Environment.get(o)){qx.theme.manager.Color.getInstance().removeListener(f,this.initThemeValues,this);qx.theme.manager.Font.getInstance().removeListener(f,this.initThemeValues,this);}
;}
});}
)();
...
(function(){var a="__vb",b="first",c="hovered",d="last",e="qx.ui.table.pane.Header";qx.Class.define(e,{extend:qx.ui.core.Widget,construct:function(f){qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.HBox());this.__lH=new qx.ui.core.Blocker(this);this.__vb=f;}
,members:{__vb:null,__vj:null,__vk:null,__lH:null,getPaneScroller:function(){return this.__vb;}
,getTable:function(){return this.__vb.getTable();}
...
;}
,setMouseOverColumn:function(l){if(l!=this.__vk){if(this.__vk!=null){var k=this.getHeaderWidgetAtColumn(this.__vk);if(k!=null){k.removeState(c);}
;}
;if(l!=null){this.getHeaderWidgetAtColumn(l).addState(c);}
;this.__vk=l;}
;}
,getHeaderWidgetAtColumn:function(n){var m=this.getPaneScroller().getTablePaneModel().getX(n);return this._getChildren()[m];}
,showColumnMoveFeedback:function(y,x){var r=this.getContentLocation();if(this.__vj==null){var w=this.getTable();var o=this.getPaneScroller().getTablePaneModel().getX(y);var q=this._getChildren()[o];var s=w.getTableModel();var u=w.getTableColumnModel();var v={xPos:o,col:y,name:s.getColumnName(y),table:w};var t=u.getHeaderCellRenderer(y);var p=t.createHeaderCell(v);var z=q.getBounds();p.setWidth(z.width);p.setHeight(z.height);p.setZIndex(1000000);p.setOpacity(0.8);p.setLayoutProperties({top:r.top});this.getApplicationRoot().add(p);this.__vj=p;}
;this.__vj.setLayoutProperties({left:r.left+x});this.__vj.show();}
,hideColumnMoveFeedback:function(){if(this.__vj!=null){this.__vj.destroy();this.__vj=null;}
;}
,isShowingColumnMoveFeedback:function(){return this.__vj!=null;}
...
;if(x===0){C.addState(b);C.removeState(d);}
else if(x===F-1){C.removeState(b);C.addState(d);}
else {C.removeState(b);C.removeState(d);}
;}
;}
,_cleanUpCells:function(){var O=this._getChildren();for(var x=O.length-1;x>=0;x-- ){var N=O[x];N.destroy();}
;}
},destruct:function(){this.__lH.dispose();this._disposeObjects(a);}
});}
)();
...
(function(){var a='<div>',b="</div>",c="overflow: hidden;",d="qx.event.type.Data",e='</div>',f="paneReloadsData",g="div",h='style="',j="_applyMaxCacheLines",k="qx.ui.table.pane.Pane",l="width: 100%;",m="qx.event.type.Event",n="_applyVisibleRowCount",o='>',p="",q='" ',r="line-height: ",s="paneUpdated",t="appear",u='class="',v="width:100%;",w="px;",z='<div ',A="'>",B="Number",C="_applyFirstVisibleRow",D="<div style='",E=";position:relative;";qx.Class.define(k,{extend:qx.ui.core.Widget,construct:function(F){qx.ui.core.Widget.call(this);this.__vb=F;this.__vc=0;this.__uS=0;this.__vd=[];}
,events:{"paneReloadsData":d,"paneUpdated":m},properties:{firstVisibleRow:{check:B,init:0,apply:C},visibleRowCount:{check:B,init:0,apply:n},maxCacheLines:{check:B,init:1000,apply:j},allowShrinkX:{refine:true,init:false}},members:{__uS:null,__vc:null,__vb:null,__ve:null,__uP:null,__uO:null,__vd:null,__vf:0,_applyFirstVisibleRow:function(H,G){this.updateContent(false,H-G);}
,_applyVisibleRowCount:function(J,I){this.updateContent(true);}
,_getContentHint:function(){return {width:this.getPaneScroller().getTablePaneModel().getTotalWidth(),height:400};}
,getPaneScroller:function(){return this.__vb;}
,getTable:function(){return this.__vb.getTable();}
,setFocusedCell:function(M,L,K){if(M!=this.__uO||L!=this.__uP){var N=this.__uP;this.__uO=M;this.__uP=L;if(L!=N&&!K){if(N!==null){this.updateContent(false,null,N,true);}
...
,onTableModelDataChanged:function(T,V,R,Q){this.__vg();var S=this.getFirstVisibleRow();var U=this.getVisibleRowCount();if(V==-1||V>=S&&T<S+U){this.updateContent();}
;}
,onTableModelMetaDataChanged:function(){this.updateContent(true);}
,_applyMaxCacheLines:function(X,W){if(this.__vf>=X&&X!==-1){this.__vg();}
;}
,__vg:function(){this.__vd=[];this.__vf=0;}
,__vh:function(bb,Y,ba){if(!Y&&!ba&&this.__vd[bb]){return this.__vd[bb];}
else {return null;}
;}
,__vi:function(bg,bf,bd,be){var bc=this.getMaxCacheLines();if(!bd&&!be&&!this.__vd[bg]&&bc>0){this._applyMaxCacheLines(bc);this.__vd[bg]=bf;this.__vf+=1;}
;}
,updateContent:function(bh,bk,bj,bi){if(bh){this.__vg();}
...
;bM.push(e);var bP=bM.join(p);this.__vi(bC,bP,bF,bJ);bX.push(bP);}
...
;}
;if(!this.__ve){this.__ve=document.createElement(g);}
;var cj=a;cj+=this._getRowsHtml(ch+cd,Math.abs(cm));cj+=e;this.__ve.innerHTML=cj;var ci=this.__ve.firstChild.childNodes;if(cm>0){for(var i=ci.length-1;i>=0;i-- ){var cg=ci[0];ck.appendChild(cg);}
;}
else {for(var i=ci.length-1;i>=0;i-- ){var cg=ci[ci.length-1];ck.insertBefore(cg,ck.firstChild);}
;}
;if(this.__uP!==null){this._updateRowStyles(this.__uP-cm);this._updateRowStyles(this.__uP);}
;this.fireEvent(s);}
...
;var cA=cu.join(p);cs.innerHTML=cA;this.setWidth(cr);this.__vc=cw;this.__uS=cq;this.fireEvent(s);}
},destruct:function(){this.__ve=this.__vb=this.__vd=null;}
});}
)();
...
;qx.ui.table.cellrenderer.Abstract.__tR.stylesheet=qx.bom.Stylesheet.createElement(N);}
...
(function(){var a="keypress",b="#FFE",c="demobrowser.demo.test.Table_Pane",d="Down",f="main",g="Up";qx.Class.define(c,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil,qx.core.MAssert],members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({decorator:f,backgroundColor:b,width:600,height:400});this.getRoot().add(h,{left:10,top:10});var i=new qx.ui.table.pane.Pane(this.getScrollerMock()).set({firstVisibleRow:0,visibleRowCount:20});h.add(i);var j=0;h.addListener(a,function(e){switch(e.getKeyIdentifier()){case g:j-=1;break;case d:j+=1;break;default:return;};j=Math.min(Math.max(0,j),499);i.setFirstVisibleRow(j);}
);}
}});}
)();
