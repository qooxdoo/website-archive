...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Conditional","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional.6a7154bc5984.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="1100EE",b="3300CC",c="2200DD",d="end",e="880077",f="Number 1",g="4400BB",h="",i=">",j="0099FF",k="DD0022",l="center",m="660099",n="0066FF",o="AA0055",p="EE0011",q="990066",s="770088",t="row",u="BB0044",v="0000FF",w="right",y="00CCFF",z="bold",A="CC0033",B="demobrowser.demo.progressive.ProgressiveTable_Conditional",C="5500AA",D="FF0000",E="Number 2",F="0033FF",G="ID";qx.Class.define(B,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var L=function(S){var T=[];for(var R=0;R<S;R++ ){var x=Math.random()*1000;T.push({renderer:t,location:d,data:[R,x,x]});}
;return T;}
;var O=new qx.ui.progressive.renderer.table.Widths(3);var J=[G,f,E];var K=new qx.ui.progressive.headfoot.TableHeading(O,J);var I=new qx.ui.progressive.headfoot.Progress(O,J);var N=new qx.ui.progressive.structure.Default(K,I);var H=new qx.ui.progressive.Progressive(N);var Q=new qx.ui.progressive.model.Default();var M=L(100);Q.addElements(M);H.setDataModel(Q);var P=new qx.ui.progressive.renderer.table.Row(O);H.addRenderer(t,P);var r=new qx.ui.progressive.renderer.table.cell.Conditional(w,h,h,h);r.addNumericCondition(i,0,null,D,null,null);r.addNumericCondition(i,50,null,p,null,null);r.addNumericCondition(i,100,null,k,null,null);r.addNumericCondition(i,150,null,A,null,null);r.addNumericCondition(i,200,null,u,null,null);r.addNumericCondition(i,250,null,o,null,null);r.addNumericCondition(i,300,null,q,null,null);r.addNumericCondition(i,350,null,e,null,null);r.addNumericCondition(i,400,null,s,null,null);r.addNumericCondition(i,450,null,m,null,null);r.addNumericCondition(i,500,null,C,null,null);r.addNumericCondition(i,550,null,g,null,null);r.addNumericCondition(i,600,null,b,null,null);r.addNumericCondition(i,650,null,c,null,null);r.addNumericCondition(i,700,null,a,null,null);r.addNumericCondition(i,750,null,v,null,null);r.addNumericCondition(i,800,null,F,null,null);r.addNumericCondition(i,850,null,n,null,null);r.addNumericCondition(i,900,null,j,null,null);r.addNumericCondition(i,950,l,y,null,z);P.addRenderer(2,r);this.getRoot().add(H,{edge:50});H.render();}
}});}
)();
...
(function(){var a="regex cannot be null!",b="font-weight",c="==",d="Condition not recognized or value1/value2 is null!",e="Condition not recognized or value is null!",f="",g=">",h="text-align",j="between",k="regex",l="<",m='g',n="qx.ui.progressive.renderer.table.cell.Conditional",o=":",p=";",q="!between",r=">=",s="color",t="font-style",u="!=",v="<=";qx.Class.define(n,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(y,w,x,z){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__vY=[c,u,g,l,r,v];this.__wa=[j,q];this.__wb=[];this.__wc=y||f;this.__wd=w||f;this.__we=x||f;this.__wf=z||f;}
,members:{__vY:null,__wa:null,__wb:null,__wc:null,__wd:null,__we:null,__wf:null,__wg:function(B,A){if(B.align){A[h]=B.align;}
;if(B.color){A[s]=B.color;}
;if(B.style){A[t]=B.style;}
;if(B.weight){A[b]=B.weight;}
;}
,addNumericCondition:function(I,H,G,F,C,E,D){if(!qx.lang.Array.contains(this.__vY,I)||H==null){throw new Error(e);}
;this.__wb.push({condition:I,align:G,color:F,style:C,weight:E,value1:H,target:D});}
,addBetweenCondition:function(Q,P,O,N,M,J,L,K){if(!qx.lang.Array.contains(this.__wa,Q)||P==null||O==null){throw new Error(d);}
;this.__wb.push({condition:Q,align:N,color:M,style:J,weight:L,value1:P,value2:O,target:K});}
,addRegex:function(R,W,V,S,U,T){if(!R){throw new Error(a);}
;this.__wb.push({condition:k,align:W,color:V,style:S,weight:U,regex:R,target:T});}
,_getCellStyle:function(bb){if(this.__wb.length==0){return bb.style||f;}
;var i;var bc;var X;var ba={"text-align":this.__wc,"color":this.__wd,"font-style":this.__we,"font-weight":this.__wf};for(i=0;i<this.__wb.length;i++ ){var bf=this.__wb[i];bc=false;if(qx.lang.Array.contains(this.__vY,bf.condition)){if(bf.target==null){X=bb.cellData;}
else {X=bb.element.data[bf.target];}
;switch(bf.condition){case c:if(X==bf.value1){bc=true;}
;break;case u:if(X!=bf.value1){bc=true;}
;break;case g:if(X>bf.value1){bc=true;}
;break;case l:if(X<bf.value1){bc=true;}
;break;case r:if(X>=bf.value1){bc=true;}
;break;case v:if(X<=bf.value1){bc=true;}
;break;};}
else if(qx.lang.Array.contains(this.__wa,bf.condition)){if(bf.target==null){X=bb.cellData;}
else {X=bb.element.data[bf.target];}
;switch(bf.condition){case j:if(X>=bf.value1&&X<=bf.value2){bc=true;}
;break;case q:if(X<bf.value1&&X>bf.value2){bc=true;}
;break;};}
else if(bf.condition==k){if(bf.target==null){X=bb.cellData;}
else {X=bb.element.data[bf.target];}
;var Y=new RegExp(bf.value1,m);bc=Y.test(X);}
;if(bc){this.__wg(bf,ba);}
;var bd=[];for(var be in ba){if(ba[be]){bd.push(be,o,ba[be],p);}
;}
;}
;return bd.join(f);}
},destruct:function(){this.__vY=this.__wa=this.__wb=null;}
});}
)();
