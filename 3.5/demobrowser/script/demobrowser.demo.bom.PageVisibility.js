...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.341ae623d953.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mm=document||window.document;this.__Hs();var self=this;qx.bom.Event.addNativeListener(this.__mm,this.__Hr,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mm:null,__Hp:null,__Hq:null,__Hr:null,__Hs:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mm[m]!=undefined){this.__Hp=m;this.__Hr=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mm[m]!=undefined){this.__Hq=m;break;}
;}
;if(this.__Hp==null){this.__Hp=k;this.__Hr=c;}
;if(this.__Hq==null){this.__Hq=b;}
;}
,isHidden:function(){return !!this.__mm[this.__Hp];}
,getVisibilityState:function(){return this.__mm[this.__Hq]||d;}
}});}
)();
