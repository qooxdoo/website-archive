...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.8fc214293e28.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__So:4,__Sp:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Sp/this.__So),column:this.__Sp%this.__So});this.__Sp+=1;}
