...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Mouseover","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover.fffabc74cdbb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="content",c="px",d="  font-size: 11px;",f=")",g="px ",h=';',j='',k="padding: ",l="end",m="div",n="  position: absolute;",o="qx.tableResizeDebug",p="changeTheme",q="-col-",r="__columnData",s="css.userselect",t="Renderer is already joined to a Progressive.",u="css.boxmodel",v="css.textoverflow",w="  top: 0px;",x="  width : 100%;",y="  overflow:hidden;",z=" {",A="}",B="  border-right:1px solid #f2f2f2;",C="Invalid location: ",D="  cursor:default;",E="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",F="-row {",G="-row",H="__FP",I="qx.debug",J="qx.dyntheme",K="start",L="relative",M="",N=": width=",O=':ellipsis;',P=':',Q="  white-space:nowrap;",R="  padding : 0px 6px 0px 6px;",S="qx.ui.progressive.renderer.table.Row",T="width: ",U=" out of range (max: ",V="px;",W="0px ",X="progressive-table-row-background-odd",Y=".qx-progressive-",bo="__qk",bp="  height: 100%;",bq="qx-progressive-",bk="progressive-table-row-background-even",bl="col ",bm="  border-bottom:1px solid #eeeeee;",bn="left: ",br="No existing renderer for column ",bs="css.userselect.none",bt="Column ";qx.Class.define(S,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bu){qx.ui.progressive.renderer.Abstract.call(this);this.__Fd=bu;this.__FO={};this.__FP=new qx.ui.progressive.renderer.table.cell.Default();this.__EJ=null;this.__FQ={};this.__FU();this.__qk=new qx.ui.layout.HBox();this.__qk.connectToWidget(this);if(qx.core.Environment.get(J)){qx.theme.manager.Color.getInstance().addListener(p,this.__FU,this);}
;}
,statics:{__tR:null,__FR:6,__FS:n+w+bp+y+(qx.core.Environment.get(v)?qx.bom.Style.getCssName(qx.core.Environment.get(v))+O:M)+Q+B+bm+R+D+d+E+(qx.core.Environment.get(s)?qx.bom.Style.getCssName(qx.core.Environment.get(s))+P+qx.core.Environment.get(bs)+h:j)},properties:{defaultRowHeight:{init:16}},members:{__EJ:null,__sA:null,__FT:null,__Fd:null,__FO:null,__FP:null,__FQ:null,__qk:null,__FU:function(){var bv=qx.theme.manager.Color.getInstance();this.__FQ.bgcol=[];this.__FQ.bgcol[0]=bv.resolve(bk);this.__FQ.bgcol[1]=bv.resolve(X);}
,join:function(bx,name){if(this.__EJ){throw new Error(t);}
;this.__EJ=bx;this.__sA=name;var by=qx.ui.progressive.renderer.table.Row;if(!by.__tR){by.__tR={};}
;var bw=bx.toHashCode();if(!by.__tR[bw]){by.__tR[bw]={rowstylesheet:null,cellstylesheet:[]};var bz=Y+bw+F+x+A;by.__tR[bw].rowstylesheet=qx.bom.Stylesheet.createElement(bz);var bA=this.__Fd.getData();for(var i=0;i<bA.length;i++ ){var bz=Y+bw+q+i+z+by.__FS+A;by.__tR[bw].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bz);}
;this.__FT=bw;var bB=bx.getStructure().getPane();bB.addListener(a,this._resizeColumns,this);}
;}
,addRenderer:function(bC,bE){var bD=this.__Fd.getData();if(bC<0||bC>=bD.length){throw new Error(bt+bC+U+(bD.length-1)+f);}
;this.__FO[bC]=bE;}
,removeRenderer:function(bF){var bG=this.__Fd.getData();if(bF<0||bF>=bG.length){throw new Error(bt+bF+U+(bG.length-1)+f);}
;if(!this.__FO[bF]){throw new Error(br+bF);}
;delete this.__FO[bF];}
,render:function(bI,bR){var bS=bR.data;var bM=[];var bO;var bN;var bK=0;if(bI.getRendererData()[this.__sA].end===undefined){bI.getRendererData()[this.__sA]={end:0,start:1,rows:0,totalHeight:0};}
;var bQ=document.createElement(m);for(var i=0;i<bS.length;i++ ){var bL=bq+this.__FT+q+i;bN=this.__FO[i]||this.__FP;bO={state:bI,rowDiv:bQ,stylesheet:bL,element:bR,dataIndex:i,cellData:bS[i],height:bK};bM.push(bN.render(bO));if(bO.height>bK){bK=bO.height;}
;}
;bK=(bK>0?bK:this.getDefaultRowHeight());var bP=bI.getRendererData()[this.__sA];bP.totalHeight+=bK;bQ.style.position=L;bQ.style.height=bK+c;bQ.className=bq+this.__FT+G;bQ.innerHTML=bM.join(M);switch(bR.location){case l:var bH=bP.end||0;bQ.style.backgroundColor=this.__FQ.bgcol[bH];bP.end=(bH==0?1:0);bI.getPane().getContentElement().getDomElement().appendChild(bQ);break;case K:var bJ=bI.getPane().getContentElement().getDomElement();var bT=bJ.childNodes;if(bT.length>0){var bH=bP.start;bQ.style.backgroundColor=this.__FQ.bgcol[bH];bP.start=(bH==0?1:0);bJ.insertBefore(bQ,bT[0]);break;}
else {bJ.appendChild(bQ);}
;break;default:throw new Error(C+bR.location);}; ++bP.rows;}
,getLayoutChildren:function(){return this.__Fd.getData();}
,_resizeColumns:function(e){var cc=this.__EJ.getStructure().getPane();var bY=cc.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();var bW=Y+this.__FT+G;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__tR[this.__FT].rowstylesheet,bW);var bX=T+bY+V;qx.bom.Stylesheet.addRule(bV.__tR[this.__FT].rowstylesheet,bW,bX);this.__qk.renderLayout(bY,100,{top:0,right:0,bottom:0,left:0});var cb=this.__Fd.getData();for(var i=0,ce=0;i<cb.length;i++ ,ce+=bY){var bW=Y+this.__FT+q+i;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__tR[this.__FT].cellstylesheet[i],bW);bY=cb[i].getComputedWidth();if(qx.core.Environment.get(I)){if(qx.core.Environment.get(o)){this.debug(bl+i+N+bY);}
;}
;var ca;if(qx.core.Environment.get(u)==b){ca=qx.ui.progressive.renderer.table.Row.__FR*2;}
else {ca=-1;}
;var cf=(bY-ca)+V;var cd=W+qx.ui.progressive.renderer.table.Row.__FR+g+W+qx.ui.progressive.renderer.table.Row.__FR+V;var bU=ce+V;var bX=bV.__FS+T+cf+bn+bU+k+cd;qx.bom.Stylesheet.addRule(bV.__tR[this.__FT].cellstylesheet[i],bW,bX);}
;}
},destruct:function(){qx.theme.manager.Color.getInstance().removeListener(p,this.__FU,this);var name;for(name in this.__FO){this.__FO[name]=null;}
;var ch=qx.ui.progressive.renderer.table.Row;var cg=this.__EJ.toHashCode();if(ch.__tR&&ch.__tR[cg]){if(ch.__tR[cg].rowstylesheet){var cj=Y+this.__FT+G;var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ch.__tR[this.__FT].rowstylesheet,cj);}
;if(ch.__tR[cg].cellstylesheet){for(var i=ch.__tR[cg].cellstylesheet.length-1;i>=0;i-- ){var cj=Y+this.__FT+q+i;var ci=ch.__tR[this.__FT].cellstylesheet[i];var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ci,cj);}
;}
;}
;if(this.__EJ&&this.__EJ.getRendererData){var ck=this.__EJ.getRendererData();if(ck&&ck[this.__sA]&&ck[this.__sA].end!==undefined){ck[this.__sA]=null;}
;}
;this.__FQ=this.__FO=this.__EJ=this.__Fd=null;this._disposeObjects(bo,H,r);}
});}
)();
...
;if(this.getGroupingUsed()){var z=E;E=l;var H;for(H=z.length;H>3;H-=3){E=l+qx.locale.Number.getGroupSeparator(this.__ki)+z.substring(H-3,H)+E;}
;E=z.substring(0,H)+E;}
;var B=this.getPrefix()?this.getPrefix():l;var y=this.getPostfix()?this.getPostfix():l;var F=B+(A?a:l)+E;if(D.length>0){F+=l+qx.locale.Number.getDecimalSeparator(this.__ki)+D;}
;F+=y;return F;}
,parse:function(R){var N=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__ki)+l);var L=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__ki)+l);var J=new RegExp(c+qx.lang.String.escapeRegexpChars(this.getPrefix())+o+m+N+k+h+L+s+qx.lang.String.escapeRegexpChars(this.getPostfix())+q);var M=J.exec(R);if(M==null){throw new Error(d+R+e);}
...
(function(){var a="-",b="QQQ",c='W',d="qqqq",e="h",f="KK",g='L',h=" is not supported",m="Z",n="Date string '",o="GGGGG",p='abbreviated',q="Y+",r=". Wildcard ",s="eeeee",t="(\\d\\d?)",u="LL",v="abbreviated",w="EEEE",x="^",y=":",z='y',A="quoted_literal",B="weekOfYear",C='3rd quarter',D="SSS",E='a',F="day",G="(-*",H="qqq",I="locale",J="K",K='q',L="Provided date is invalid",M="pm",N="Error parsing date '",O='Anno Domini',P='G',Q="a",R='2nd quarter',S="yyyy-MM-dd'T'HH:mm:ss",T="GMT",U="HH:mm:ss",V="dd",W="+",X="qx.util.format.DateFormat",Y='weekDay',en="am",ei="eee",eo="quarter",ek="ee",el="q",eh="QQQQ",em="HHmmss",es="ww",et="H",eu='Y+',ev="wide",ep='wide',eq="(\\d\\d\\d?)",ej="(GMT[\\+\\-]\\d\\d:\\d\\d)",er="_applyLocale",ez="Q",fd="c",eA="(",eB="weekOfMonth",ew="ccc",ex="long",ge="Malformed date format: ",ey="EEEEE",eC='Y',eD="EE",eE="GGG",eJ='-',eK="w",eL="mm",eF='h',eG="S",eH='s',eI='A',eQ="yyyy-MM-dd",eR="G",eS='z',eT="GG",eM=")",eN="kk",eO="ss",eP="([\\+\\-]\\d\\d\\d\\d)",eX="default",eY='BC',gi='H',fa='S',eU='1st quarter',eV="stand-alone",gg="0",eW="MMMM",fb='c',fc="d",fo='Q',fn='Q1',fm="eeee",fs="QQ",fr="LLLLL",fq="HH",fp='k',fh="m",fg="DDD",ff="D",fe='D',fl="LLLL",fk="(\\d\\d*?)",fj='e',fi="': the value for day or month is too large",fz="literal",fy='K',fx="L",fw="hh",fD="ms",fC="(\\d\\d?\\d?)",fB="cccc",fA="e",fv='y+',fu="|",ft="W",fO="dayOfYear",fN="GGGG",fM='Q2',fS='B',fR="MM",fQ='Q4',fP="y+",fH='narrow',fG="ccccc",fF="E",fE="wildcard",fL='',fK="' does not match the date format: ",fJ="short",fI='d',fY="unkown",fX="narrow",fW="\\d?",fV="'",gd="k",gc='Before Christ',gb='Z',ga="qx.debug",fU='m',fT=" ",dQ="yyyy-MM-dd'T'HH:mm:ss'Z'",dP="String",gj='Q3',dN="z",dO="DD",dM="min",gh="",dK='M',dL="sec",dJ='isoUtcDateTime',gf='4th quarter',dH="(\\d?)",dI="SS",dG="MMM",ea="s",eb="M",dX='w',dY="EEE",dV="$",dW="?",dU='AD',dF="\\d",dS="+?",dT="hour",dR="MMMMM",eg='E',ee='month',ef="LLL",ec="qq",ed="format";qx.Class.define(X,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(gl,gk){qx.core.Object.call(this);if(!gk){this.__ki=qx.locale.Manager.getInstance().getLocale();this.__tv=qx.locale.Manager.getInstance().bind(I,this,I);}
else {this.__ki=gk;this.setLocale(gk);}
;this.__tw=this.__ki;if(gl!=null){this.__tx=gl.toString();if(this.__tx in qx.util.format.DateFormat.ISO_MASKS){if(this.__tx===dJ){this.__ty=true;}
;this.__tx=qx.util.format.DateFormat.ISO_MASKS[this.__tx];}
;}
else {this.__tx=qx.locale.Date.getDateFormat(ex,this.__ki)+fT+qx.locale.Date.getDateTimeFormat(em,U,this.__ki);}
;}
,properties:{locale:{apply:er,nullable:true,check:dP}},statics:{getDateInstance:function(){var gm=qx.util.format.DateFormat;var gn=qx.locale.Date.getDateFormat(fJ)+gh;if(gm._dateInstance==null||gm._dateInstance.__tx!=gn){gm._dateInstance=new gm(gn);}
;return gm._dateInstance;}
,getDateTimeInstance:function(){var go=qx.util.format.DateFormat;var gp=qx.locale.Date.getDateFormat(ex)+fT+qx.locale.Date.getDateTimeFormat(em,U);if(go._dateTimeInstance==null||go._dateTimeInstance.__tx!=gp){go._dateTimeInstance=new go(gp);}
;return go._dateTimeInstance;}
,ASSUME_YEAR_2000_THRESHOLD:30,ISO_MASKS:{isoDate:eQ,isoTime:U,isoDateTime:S,isoUtcDateTime:dQ},AM_MARKER:en,PM_MARKER:M},members:{__tv:null,__ki:null,__tw:null,__tx:null,__tz:null,__tA:null,__tB:null,__ty:null,__tC:function(gr,gq){var gs=gh+(gr<0?((-1)*gr):gr);while(gs.length<gq){gs=gg+gs;}
;return gr<0?a+gs:gs;}
,__tD:function(gt){var gu=new Date(gt.getTime());var gv=gu.getDate();while(gu.getMonth()!=0){gu.setDate(-1);gv+=gu.getDate()+1;}
;return gv;}
,__tE:function(gw){return new Date(gw.getTime()+(3-((gw.getDay()+6)%7))*86400000);}
,__tF:function(gx){var gz=this.__tE(gx);var gA=gz.getFullYear();var gy=this.__tE(new Date(gA,0,4));return Math.floor(1.5+(gz.getTime()-gy.getTime())/86400000/7);}
,__tG:function(gB){var gD=this.__tE(gB);var gC=this.__tE(new Date(gB.getFullYear(),gB.getMonth(),4));return Math.floor(1.5+(gD.getTime()-gC.getTime())/86400000/7);}
,__tH:function(gE){var gF=this.__tE(gE);return gF.getFullYear();}
,__tI:function(gH){var gG=new Date(gH,2,1);gG.setDate(-1);return gG.getDate()+1===29;}
,__tJ:function(gM,gN){var gL=0;var gO=0;if(!gN){gN=1971;}
...
,__tK:function(gS,gQ,gP){var gR;switch(gQ){case 11:gR=gS-1;if(gS!=this.__tH(new Date(gR,gQ,gP))){gR=gS;}
;break;case 0:gR=gS+1;if(gS!=this.__tH(new Date(gR,gQ,gP))){gR=gS;}
;break;default:gR=gS;};return gR;}
,_applyLocale:function(gU,gT){this.__ki=gU===null?this.setLocale(this.__tw):gU;}
,format:function(hl){if(hl==null){return null;}
;if(isNaN(hl.getTime())){if(qx.core.Environment.get(ga)){qx.log.Logger.error(L);}
;return null;}
;if(this.__ty){hl=new Date(hl.getUTCFullYear(),hl.getUTCMonth(),hl.getUTCDate(),hl.getUTCHours(),hl.getUTCMinutes(),hl.getUTCSeconds(),hl.getUTCMilliseconds());}
;var gX=this.__ki;var hd=hl.getFullYear();var gY=hl.getMonth();var hc=hl.getDate();var hg=hl.getDay();var hj=hl.getHours();var hq=hl.getMinutes();var hh=hl.getSeconds();var ho=hl.getMilliseconds();var hf=hl.getTimezoneOffset();var hk=hf>0?1:-1;var gV=Math.floor(Math.abs(hf)/60);var hn=Math.abs(hf)%60;this.__tL();var hp=gh;for(var i=0;i<this.__tB.length;i++ ){var he=this.__tB[i];if(he.type==fz){hp+=he.text;}
else {var gW=he.character;var hi=he.size;var hr=dW;switch(gW){case z:if(hi==2){hr=this.__tC(hd%100,2);}
else {var ha=Math.abs(hd);hr=ha+gh;if(hi>hr.length){for(var j=hr.length;j<hi;j++ ){hr=gg+hr;}
;}
;if(hd<0){hr=a+hr;}
;}
;break;case eC:hr=this.__tH(hl)+gh;var ha=hr.replace(eJ,fL);if(hi>hr.length){for(var j=ha.length;j<hi;j++ ){ha=gg+ha;}
;}
;hr=hr.indexOf(a)!=-1?a+ha:ha;break;case P:if(hi>=1&&hi<=3){hr=hd>0?dU:eY;}
else if(hi==4){hr=hd>0?O:gc;}
else if(hi==5){hr=hd>0?eI:fS;}
;break;case fo:if(hi==1||hi==2){hr=this.__tC(parseInt(gY/4)+1,hi);}
;if(hi==3){hr=fo+(parseInt(gY/4)+1);}
;break;case K:if(hi==1||hi==2){hr=this.__tC(parseInt(gY/4)+1,hi);}
;if(hi==3){hr=fo+(parseInt(gY/4)+1);}
;break;case fe:hr=this.__tC(this.__tD(hl),hi);break;case fI:hr=this.__tC(hc,hi);break;case dX:hr=this.__tC(this.__tF(hl),hi);break;case c:hr=this.__tG(hl);break;case eg:if(hi>=1&&hi<=3){hr=qx.locale.Date.getDayName(v,hg,gX,ed,true);}
else if(hi==4){hr=qx.locale.Date.getDayName(ev,hg,gX,ed,true);}
else if(hi==5){hr=qx.locale.Date.getDayName(fX,hg,gX,ed,true);}
;break;case fj:var hb=qx.locale.Date.getWeekStart(gX);var hm=1+((hg-hb>=0)?(hg-hb):7+(hg-hb));if(hi>=1&&hi<=2){hr=this.__tC(hm,hi);}
...
;break;case dK:if(hi==1||hi==2){hr=this.__tC(gY+1,hi);}
...
;break;case g:if(hi==1||hi==2){hr=this.__tC(gY+1,hi);}
...
;break;case E:hr=(hj<12)?qx.locale.Date.getAmMarker(gX):qx.locale.Date.getPmMarker(gX);break;case gi:hr=this.__tC(hj,hi);break;case fp:hr=this.__tC((hj==0)?24:hj,hi);break;case fy:hr=this.__tC(hj%12,hi);break;case eF:hr=this.__tC(((hj%12)==0)?12:(hj%12),hi);break;case fU:hr=this.__tC(hq,hi);break;case eH:hr=this.__tC(hh,hi);break;case fa:hr=this.__tC(ho,3);if(hi<hr.length){hr=hr.substr(0,hi);}
else {while(hi>hr.length){hr+=gg;}
;}
;break;case eS:if(hi>=1&&hi<=4){hr=T+((hk>0)?a:W)+this.__tC(Math.abs(gV),2)+y+this.__tC(hn,2);}
;break;case gb:if(hi>=1&&hi<=3){hr=((hk>0)?a:W)+this.__tC(Math.abs(gV),2)+this.__tC(hn,2);}
else {hr=T+((hk>0)?a:W)+this.__tC(Math.abs(gV),2)+y+this.__tC(hn,2);}
;break;};hp+=hr;}
;}
;return hp;}
,parse:function(hy){this.__tM();var hB=this.__tz.regex.exec(hy);if(hB==null){throw new Error(n+hy+fK+this.__tx);}
;var hs={era:1,year:1970,quarter:1,month:0,day:1,dayOfYear:1,hour:0,ispm:false,weekDay:4,weekYear:1970,weekOfMonth:1,weekOfYear:1,min:0,sec:0,ms:0};var hw=1;var ht=false;var hu=false;for(var i=0;i<this.__tz.usedRules.length;i++ ){var hv=this.__tz.usedRules[i];var hx=hB[hw];if(hv.field!=null){hs[hv.field]=parseInt(hx,10);}
else {hv.manipulator(hs,hx,hv.pattern);}
;if(hv.pattern==q){var hz=false;for(var k=0;k<this.__tz.usedRules.length;k++ ){if(this.__tz.usedRules[k].pattern==fv){hz=true;break;}
;}
;if(!hz){ht=true;}
;}
;if(hv.pattern.indexOf(ff)!=-1){var hD=false;for(var k=0;k<this.__tz.usedRules.length;k++ ){if(this.__tz.usedRules[k].pattern.indexOf(fc)!=-1){hD=true;break;}
;}
;if(!hD){hu=true;}
;}
;hw+=(hv.groups==null)?1:hv.groups;}
;if(ht){hs.year=this.__tK(hs.weekYear,hs.month,hs.day);}
;if(hu){var hC=this.__tJ(hs.dayOfYear,hs.year);hs.month=hC.month;hs.day=hC.day;}
;if(hs.era<0&&(hs.year*hs.era<0)){hs.year=hs.year*hs.era;}
;var hA=new Date(hs.year,hs.month,hs.day,(hs.ispm)?(hs.hour+12):hs.hour,hs.min,hs.sec,hs.ms);if(this.__ty){hA=new Date(hA.getUTCFullYear(),hA.getUTCMonth(),hA.getUTCDate(),hA.getUTCHours(),hA.getUTCMinutes(),hA.getUTCSeconds(),hA.getUTCMilliseconds());}
;if(hs.month!=hA.getMonth()||hs.year!=hA.getFullYear()){throw new Error(N+hy+fi);}
;return hA;}
,__tL:function(){if(this.__tB!=null){return;}
;this.__tB=[];var hI;var hG=0;var hK=gh;var hE=this.__tx;var hH=eX;var i=0;while(i<hE.length){var hJ=hE.charAt(i);switch(hH){case A:if(hJ==fV){if(i+1>=hE.length){i++ ;break;}
;var hF=hE.charAt(i+1);if(hF==fV){hK+=hJ;i++ ;}
else {i++ ;hH=fY;}
;}
else {hK+=hJ;i++ ;}
;break;case fE:if(hJ==hI){hG++ ;i++ ;}
else {this.__tB.push({type:fE,character:hI,size:hG});hI=null;hG=0;hH=eX;}
;break;default:if((hJ>=E&&hJ<=eS)||(hJ>=eI&&hJ<=gb)){hI=hJ;hH=fE;}
else if(hJ==fV){if(i+1>=hE.length){hK+=hJ;i++ ;break;}
;var hF=hE.charAt(i+1);if(hF==fV){hK+=hJ;i++ ;}
;i++ ;hH=A;}
else {hH=eX;}
;if(hH!=eX){if(hK.length>0){this.__tB.push({type:fz,text:hK});hK=gh;}
;}
else {hK+=hJ;i++ ;}
;break;};}
;if(hI!=null){this.__tB.push({type:fE,character:hI,size:hG});}
else if(hK.length>0){this.__tB.push({type:fz,text:hK});}
;}
,__tM:function(){if(this.__tz!=null){return;}
;var hO=this.__tx;this.__tO();this.__tL();var hU=[];var hP=x;for(var hM=0;hM<this.__tB.length;hM++ ){var hV=this.__tB[hM];if(hV.type==fz){hP+=qx.lang.String.escapeRegexpChars(hV.text);}
else {var hN=hV.character;var hQ=hV.size;var hS;for(var hW=0;hW<this.__tA.length;hW++ ){var hR=this.__tA[hW];if(this.__tN(hR,hN,hQ)){hS=hR;break;}
;}
...
;this.__tz={regex:hL,"usedRules":hU,pattern:hP};}
,__tN:function(hY,ia,ib){if(ia===z&&hY.pattern===fv){hY.regex=hY.regexFunc(ib);return true;}
else if(ia===eC&&hY.pattern===eu){hY.regex=hY.regexFunc(ib);return true;}
else {return ia==hY.pattern.charAt(0)&&ib==hY.pattern.length;}
;}
,__tO:function(){var ir=qx.util.format.DateFormat;var iu=qx.lang.String;if(this.__tA!=null){return;}
;var is=this.__tA=[];var im=qx.locale.Date.getAmMarker(this.__ki).toString()||ir.AM_MARKER;var iB=qx.locale.Date.getPmMarker(this.__ki).toString()||ir.PM_MARKER;var id=this.__ki;var ij=function(iE,iF){iF=parseInt(iF,10);if(iF>0){if(iF<ir.ASSUME_YEAR_2000_THRESHOLD){iF+=2000;}
...
},destruct:function(){if(this.__tv!=null){qx.locale.Manager.getInstance().removeBinding(this.__tv);}
;this.__tB=this.__tz=this.__tA=null;}
});}
)();
(function(){var a='format',b="short",c="HH:mm",d='_',e="stand-alone",f="HHmmsszz",g="cldr_date_format_",h="HHmm",j="narrow",k="HHmmss",l="qx.debug",m="This case should never happen.",n="cldr_time_format_",o="sat",p="abbreviated",q="wide",r="HH:mm:ss zz",s="full",t="cldr_pm",u="cldr_day_",v="_",w="cldr_month_",x="long",y="wed",z="medium",A="fri",B="cldr_am",C="tue",D="qx.locale.Date",E="mon",F="cldr_date_time_format_",G="sun",H="format",I="thu",J="HH:mm:ss",K='stand-alone';qx.Class.define(D,{statics:{__tP:qx.locale.Manager.getInstance(),getAmMarker:function(L){return this.__tP.localize(B,[],L);}
,getPmMarker:function(M){return this.__tP.localize(t,[],M);}
...
;var Q=[G,E,C,y,I,A,o];var R=[];for(var i=0;i<Q.length;i++ ){var N=u+S+v+length+v+Q[i];R.push(P?this.__tQ(S,S===a?K:a,N,O):this.__tP.localize(N,[],O));}
;return R;}
...
;var W=[G,E,C,y,I,A,o];var T=u+U+v+length+v+W[Y];return X?this.__tQ(U,U===a?K:a,T,V):this.__tP.localize(T,[],V);}
...
;var bd=[];for(var i=0;i<12;i++ ){var ba=w+be+v+length+v+(i+1);bd.push(bc?this.__tQ(be,be===a?K:a,ba,bb):this.__tP.localize(ba,[],bb));}
;return bd;}
...
;var bf=w+bg+v+length+v+(bi+1);return bj?this.__tQ(bg,bg===a?K:a,bf,bh):this.__tP.localize(bf,[],bh);}
,getDateFormat:function(bm,bk){if(qx.core.Environment.get(l)){qx.core.Assert.assertInArray(bm,[b,z,x,s]);}
;var bl=g+bm;return this.__tP.localize(bl,[],bk);}
,getDateTimeFormat:function(br,bp,bn){var bq=F+br;var bo=this.__tP.localize(bq,[],bn);if(bo==bq){bo=bp;}
;return bo;}
,getTimeFormat:function(bv,bs){if(qx.core.Environment.get(l)){qx.core.Assert.assertInArray(bv,[b,z,x,s]);}
;var bu=n+bv;var bt=this.__tP.localize(bu,[],bs);if(bt!=bu){return bt;}
...
else {bK=this.__tP.getTerritory()||this.__tP.getLanguage();}
;return bK.toUpperCase();}
,__tQ:function(bN,bM,bQ,bP){var bO=this.__tP.localize(bQ,[],bP);if(bO==bQ){var bL=bQ.replace(d+bN+d,d+bM+d);return this.__tP.localize(bL,[],bP);}
else {return bO;}
;}
}});}
)();
(function(){var a="",b="rgb(255, 0, 0)",c="celldata",d="onmouseover='demobrowser.demo.progressive.DateCellRenderer.onmouseover(this);' ",e="Number",f="red",g="1*",h="celldata='",i="row",j="' ",k="<br>",l="demobrowser.demo.progressive.ProgressiveTable_Mouseover",m="end",n="Date",o="Move your mouse over the Date field",p="demobrowser.demo.progressive.DateCellRenderer",q="color",r="Id",s="onmouseout='demobrowser.demo.progressive.DateCellRenderer.onmouseout(this);' ";qx.Class.define(l,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var D=0;var y=function(G){var H=[];var J=new Date().getTime();var F=400*24*60*60*1000;for(var K=0;K<G;K++ ){var I=new Date(J+Math.random()*F-F/2);H.push({renderer:i,location:m,data:[D++ ,Math.random()*10000,I]});}
;return H;}
;var B=new qx.ui.progressive.renderer.table.Widths(3);B.setWidth(0,100);B.setWidth(1,g);B.setWidth(2,300);var v=[r,e,n];var x=new qx.ui.progressive.headfoot.TableHeading(B,v);var u=new qx.ui.progressive.headfoot.Progress(B,v);var A=new qx.ui.progressive.structure.Default(x,u);var t=new qx.ui.progressive.Progressive(A);var w=new qx.ui.basic.Atom(o);w.setTextColor(f);w.setHeight(16);w.setRich(true);t.add(w);var E=new qx.ui.progressive.model.Default();var z=y(500);E.addElements(z);t.setDataModel(E);var C=new qx.ui.progressive.renderer.table.Row(B);t.addRenderer(i,C);C.addRenderer(2,new demobrowser.demo.progressive.DateCellRenderer());this.getRoot().add(t,{edge:50});t.render();}
}});qx.Class.define(p,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(M){M.__Ri=qx.bom.element.Style.get(M,q);M.style.color=b;M.parentNode.style.height=32;M.__Rj=M.innerHTML;var N=Date.parse(M.attributes.getNamedItem(c).nodeValue);var L=new Date(N);M.innerHTML=L.toUTCString()+k+L.toString();}
,onmouseout:function(O){O.style.color=O.__Ri;O.parentNode.style.height=16;O.innerHTML=O.__Rj;}
},members:{_getCellExtras:function(P){var Q=[];Q.push(qx.ui.progressive.renderer.table.cell.Default.prototype._getCellExtras.call(this));Q.push(h+P.cellData.toUTCString()+j);Q.push(d,s);return Q.join(a);}
}});}
)();
(function(){var a="Column number out of range",b="Unrecognized key: ",c="qx.ui.progressive.renderer.table.Widths",d="minWidth",e="width",f="maxWidth";qx.Class.define(c,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__Hz=[];for(var i=0;i<g;i++ ){this.__Hz[i]=new qx.ui.core.ColumnData();}
;}
,members:{__Hz:null,getData:function(){return this.__Hz;}
...
;}
,setWidth:function(l,m){if(l>this.__Hz.length-1||l<0){throw new Error(a);}
;this.__Hz[l].setColumnWidth(m);}
,setMinWidth:function(n,o){if(n>this.__Hz.length-1||n<0){throw new Error(a);}
;this.__Hz[n].setMinWidth(o);}
,setMaxWidth:function(p,q){if(p>this.__Hz.length-1||p<0){throw new Error(a);}
;this.__Hz[p].setMaxWidth(q);}
}});}
)();
...
,members:{__up:null,renderLayout:function(g,top,f,h){this.__up=f;}
,getComputedWidth:function(){return this.__up;}
...
,members:{__EJ:null,join:function(c){this.__EJ=c;}
},destruct:function(){this.__EJ=null;}
});}
)();
(function(){var a="progressive-table-header-cell",b="resize",c="progressive-table-header",d="_layout",f="qx.ui.progressive.headfoot.TableHeading";qx.Class.define(f,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(l,k){qx.ui.progressive.headfoot.Abstract.call(this);this.__Fd=l;var j=l.getData();this.__Fe=[];for(var i=0;i<j.length;i++ ){var g=new qx.ui.basic.Atom(k[i]);g.setAppearance(a);this.add(g);this.__Fe[i]=g;}
;var h=new qx.ui.core.Widget();h.set({height:16,appearance:a,minWidth:0,width:0});this.add(h,{flex:1});this.addListener(b,this._resizeColumns,this);this.__qk=new qx.ui.layout.HBox();this.__qk.connectToWidget(this);}
,properties:{appearance:{refine:true,init:c}},members:{__Fd:null,__Ff:null,__Fe:null,__qk:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__Ff){return this.__Fd.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var p=this.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();this.__Ff=true;var n={top:this.getPaddingTop(),right:this.getPaddingRight(),bottom:this.getPaddingBottom(),left:this.getPaddingLeft()};this.__qk.renderLayout(p,100,n);this.__Ff=false;var o=this.__Fd.getData();for(var i=0;i<o.length;i++ ){this.__Fe[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__Fd=this.__Fe=null;this._disposeObjects(d);}
});}
)();
(function(){var a="progressive-progressbar-indicator-undone",b="__GQ",c="progress",d="%",f="progressive-progressbar-indicator-done",g="progressive-progressbar-percent-text",h="renderStart",i="__GR",j="progressive-progressbar-background",k="0%",l="qx.ui.progressive.headfoot.Progress",m="progressive-progressbar-percent-background",n="renderEnd";qx.Class.define(l,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,q){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__FQ={};this.__FU();this.set({backgroundColor:this.__FQ.background});this.__GQ=new qx.ui.core.Widget();this.__GQ.set({width:0,backgroundColor:this.__FQ.indicatorDone});this.add(this.__GQ);var p=new qx.ui.core.Widget();p.set({backgroundColor:this.__FQ.indicatorUndone});this.add(p,{flex:1});this.__GR=new qx.ui.basic.Atom(k);this.__GR.set({width:100,backgroundColor:this.__FQ.percentBackground,textColor:this.__FQ.percentText});this.add(this.__GR);this.exclude();}
,members:{__GS:null,__FQ:null,__GQ:null,__GR:null,_onChangeTheme:function(){qx.ui.progressive.headfoot.Abstract.prototype._onChangeTheme.call(this);this.__FU();}
,__FU:function(){var r=qx.theme.manager.Color.getInstance();this.__FQ.background=r.resolve(j);this.__FQ.indicatorDone=r.resolve(f);this.__FQ.indicatorUndone=r.resolve(a);this.__FQ.percentBackground=r.resolve(m);this.__FQ.percentText=r.resolve(g);}
,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(h,function(e){this.__GS=e.getData().initial;this.show();}
,this);s.addListener(c,function(e){var u=1.0-(e.getData().remaining/this.__GS);var w=this.getBounds();if(w){var v=Math.floor((w.width-this.__GR.getBounds().width)*u);var t=Math.floor(u*100)+d;if(!isNaN(v)){this.__GQ.setMinWidth(v);this.__GR.setLabel(t);}
;}
;}
,this);s.addListener(n,function(e){this.exclude();}
,this);}
},destruct:function(){this.__FQ=null;this._disposeObjects(b,i);}
});}
)();
(function(){var a="applyStructure() is abstract",b="abstract",c="qx.ui.progressive.structure.Abstract",d="overflowY",e="auto";qx.Class.define(c,{type:b,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__EF=new qx.ui.core.Widget();this.__xo=this.__EF;}
else {this.__EF=null;this.__xo=f;}
;this.__xo.getContentElement().setStyle(d,e);}
,members:{__EF:null,__xo:null,applyStructure:function(g){throw new Error(a);}
,getPane:function(){return this.__xo;}
},destruct:function(){if(this.__EF){this.__EF.dispose();}
;this.__EF=this.__xo=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,d,c){qx.ui.progressive.structure.Abstract.call(this,c);if(!b){this.__EG=new qx.ui.progressive.headfoot.Null();this.__my=this.__EG;}
else {this.__EG=null;this.__my=b;}
;if(!d){this.__EH=new qx.ui.progressive.headfoot.Null();this.__EI=this.__EH;}
else {this.__EH=null;this.__EI=d;}
;}
,members:{__my:null,__EI:null,__EG:null,__EH:null,applyStructure:function(e){this.__my.join(e);this.__EI.join(e);e.add(this.__my);e.add(this.getPane(),{flex:1});e.add(this.__EI);}
,getHeader:function(){return this.__my;}
,getFooter:function(){return this.__EI;}
},destruct:function(){if(this.__EG){this.__EG.dispose();this.__EG=null;}
;if(this.__EH){this.__EH.dispose();this.__EH=null;}
;this.__my=this.__EI=null;}
});}
)();
...
(function(){var a="dataAvailable",b="_applyDataModel",c="Boolean",d="Render time: ",f="qx.ui.progressive.model.Abstract",g="renderStart",h="ms",j="progress",k="white",l="No existing renderer named ",m="qx.ui.progressive.Progressive",n="progressDetail",o="Integer",p="renderEnd",q="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.container.Composite,construct:function(r){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__FV={};this.set({backgroundColor:k});if(!r){r=new qx.ui.progressive.structure.Default();}
;this.__FW=r;r.applyStructure(this);this.__FX=false;this.__FY=false;this.__Ga=0;}
,events:{"renderStart":q,"renderEnd":q,"progress":q,"progressDetail":q},properties:{dataModel:{check:f,apply:b},batchSize:{check:o,init:20},flushWidgetQueueAfterBatch:{check:c,init:false},interElementTimeout:{check:o,init:0}},members:{__FV:null,__FY:null,__Gb:null,__Ga:null,__FX:null,__FW:null,getStructure:function(){return this.__FW;}
,addRenderer:function(name,s){this.__FV[name]=s;s.join(this,name);}
,removeRenderer:function(name){if(!this.__FV[name]){throw new Error(l+name);}
;delete this.__FV[name];}
,render:function(){if(this.__FY){return;}
;this.__FY=true;var t=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__FW.getPane(),batchSize:this.getBatchSize(),rendererData:this.__Gd(),userData:{}});this.__Gb=new Date();if(this.__FX){this.__Ga=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__Ga});this.__Gc(t);}
else {qx.event.Timer.once(function(){this.__Ga=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__Ga});this.__Gc(t);this.__FX=true;}
,this,10);}
;}
,_applyDataModel:function(v,u){if(u){u.removeListener(a,this.__Ge,this);u.dispose();}
;v.addListener(a,this.__Ge,this);}
,__Gc:function(x){var w;var z;var y;for(var i=x.getBatchSize();i>0;i-- ){w=x.getModel().getNextElement();if(!w){this.debug(d+(new Date()-this.__Gb)+h);this.__FY=false;this.fireDataEvent(p,x);x.dispose();return;}
;z=w.element;y=this.__FV[z.renderer];y.render(x,z);this.fireDataEvent(n,{initial:this.__Ga,remaining:w.remaining,element:z});}
;this.fireDataEvent(j,{initial:this.__Ga,remaining:w.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__Gc(x);}
,this,this.getInterElementTimeout());}
,__Gd:function(){var A={};for(var name in this.__FV){A[name]={};}
;return A;}
,__Ge:function(e){this.__Ga=e.getData();this.render();}
},destruct:function(){for(var name in this.__FV){this.__FV[name].dispose();}
;this.__Gb=this.__FV=this.__FW=null;}
});}
)();
...
(function(){var a="dataAvailable",b="qx.ui.progressive.model.Default";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__oB=[];}
,members:{__oB:null,addElements:function(c){this.__oB=this.__oB.concat(c);this.fireDataEvent(a,this.__oB.length);}
,addElement:function(d){this.__oB.push(d);this.fireDataEvent(a,this.__oB.length);}
,getElementCount:function(){return this.__oB.length;}
,getNextElement:function(){if(this.__oB.length>0){return ({element:this.__oB.shift(),remaining:this.__oB.length});}
;return null;}
