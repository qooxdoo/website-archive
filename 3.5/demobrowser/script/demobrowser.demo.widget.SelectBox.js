...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SelectBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SelectBox.9f0a08c59fab.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="icon/16/devices/",b="phone.png",c="audio-card.png",d="battery.png",f="printer.png",g="Simple",h="display.png",j="audio-input-microphone.png",k="Empty Item",l="computer.png",m="Random Value ",n="input-keyboard.png",o="drive-optical.png",p="",q="media-optical.png",r="changeSelection",s="pda.png",t="network-wired.png",u=".",v="camera-photo.png",w="network-wireless.png",x="media-flash.png",y="Option ",z="input-mouse.png",A="demobrowser.demo.widget.SelectBox",B="With icons",C="drive-harddisk.png",D="camera-web.png",E="multimedia-player.png",F="Item ",G="Long text",H="changeSelection: ";qx.Class.define(A,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.container.Scroll();var I=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));I.setPadding(20);I.add(this.createBox1());I.add(this.createBox2());I.add(this.createBox3());I.add(this.createBox4());J.add(I,{left:20,top:20});this.getRoot().add(J,{edge:0});}
,createBox1:function(){var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));L.add(new qx.ui.basic.Label(g));var K=new qx.ui.form.SelectBox();for(var i=0;i<30;i++ ){var M=new qx.ui.form.ListItem(F+(i+1));K.add(M);if(i==5){K.setSelection([M]);}
;}
;K.addListener(r,function(e){this.debug(H+e.getData()[0]);}
);L.add(K);return L;}
,createBox2:function(){var O=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));O.add(new qx.ui.basic.Label(G));var N=new qx.ui.form.SelectBox();for(var i=0;i<30;i++ ){var P=new qx.ui.form.ListItem(m+Math.round(Math.random()*100000000));N.add(P);}
;O.add(N);return O;}
,createBox3:function(){var R=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));R.add(new qx.ui.basic.Label(B));var T=[c,j,d,v,D,l,h,C,o,n,z,x,q,E,t,w,s,b,f];var U=a;var Q=new qx.ui.form.SelectBox();for(var i=0;i<T.length;i++ ){var S=new qx.ui.form.ListItem(T[i].substr(0,T[i].indexOf(u)),U+T[i]);Q.add(S);}
;R.add(Q);return R;}
,createBox4:function(){var W=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));W.add(new qx.ui.basic.Label(k));var V=new qx.ui.form.SelectBox();V.add(new qx.ui.form.ListItem(p));for(var i=0;i<10;i++ ){V.add(new qx.ui.form.ListItem(y+(i+1)));}
;W.add(V);return W;}
}});}
)();
...
;this.addListener(n,this._onKeyInput,this);this.addListener(p,this.__nU,this);}
,properties:{appearance:{refine:true,init:v}},members:{__pm:null,_createChildControlImpl:function(D,C){var B;switch(D){case t:B=new qx.ui.core.Spacer();this._add(B,{flex:1});break;case A:B=new qx.ui.basic.Atom(z);B.setCenter(false);B.setAnonymous(true);this._add(B,{flex:1});break;case o:B=new qx.ui.basic.Image();B.setAnonymous(true);this._add(B);break;};return B||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,D);}
...
,__nU:function(e){var F=e.getData()[0];var E=this.getChildControl(l);if(E.getSelection()[0]!=F){if(F){E.setSelection([F]);}
else {E.resetSelection();}
;}
;this.__pn();this.__po();}
,__pn:function(){var H=this.getChildControl(l).getSelection()[0];var G=this.getChildControl(A);var I=H?H.getIcon():r;I==null?G.resetIcon():G.setIcon(I);}
,__po:function(){var L=this.getChildControl(l).getSelection()[0];var J=this.getChildControl(A);var K=L?L.getLabel():r;var M=this.getFormat();if(M!=null){K=M.call(this,L);}
...
,_onKeyPress:function(e){var S=e.getKeyIdentifier();if(S==b||S==i){if(this.__pm){this.setSelection([this.__pm]);this.__pm=null;}
;this.toggle();}
...
,_onListMouseDown:function(e){if(this.__pm){this.setSelection([this.__pm]);this.__pm=null;}
;}
,_onListChangeSelection:function(e){var X=e.getData();var V=e.getOldData();if(V&&V.length>0){V[0].removeListener(h,this.__pn,this);V[0].removeListener(f,this.__po,this);}
;if(X.length>0){var U=this.getChildControl(x);var W=this.getChildControl(l);var Y=W.getSelectionContext();if(U.isVisible()&&(Y==y||Y==k)){this.__pm=X[0];}
else {this.setSelection([X[0]]);this.__pm=null;}
;X[0].addListener(h,this.__pn,this);X[0].addListener(f,this.__po,this);}
