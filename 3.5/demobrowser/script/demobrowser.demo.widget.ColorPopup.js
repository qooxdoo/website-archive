...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.527f08265368.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(M),values:[m,h,f,J,w,F,V,U,t,n,b,c]},recent:{label:qx.locale.Manager.tr(R),values:[]}}},destruct:function(){if(this.__Ir){this.__Ir.destroy();this.__Is.destroy();this.__It.destroy();}
...
,setValue:function(de){var dd;if(de==null){this.__nz=true;dd=[255,255,255];}
else {dd=qx.util.ColorUtil.stringToRgb(de);this.__nz=false;}
;this.__wn=true;this.setRed(dd[0]);this.setGreen(dd[1]);this.__wn=false;this.setBlue(dd[2]);}
,getValue:function(){return this.__nz?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__nz=true;this.__wn=true;this.setRed(255);this.setGreen(255);this.__wn=false;this.setBlue(255);}
,__nB:function(){if(!this.__wn){this.__nz=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dg,df){if(this.__wh===null){this.__wh=ci;}
;if(this.__wh!==cM){this.getChildControl(n).setValue(dg);}
;if(this.__wh!==o){this._setHexFromRgb();}
;switch(this.__wh){case cM:case o:case ci:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nB();if(this.__wh===ci){this.__wh=null;}
;}
,_applyGreen:function(di,dh){if(this.__wh===null){this.__wh=ct;}
;if(this.__wh!==cM){this.getChildControl(U).setValue(di);}
;if(this.__wh!==o){this._setHexFromRgb();}
;switch(this.__wh){case cM:case o:case ct:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nB();if(this.__wh===ct){this.__wh=null;}
;}
,_applyBlue:function(dk,dj){if(this.__wh===null){this.__wh=d;}
;if(this.__wh!==cM){this.getChildControl(cm).setValue(dk);}
;if(this.__wh!==o){this._setHexFromRgb();}
;switch(this.__wh){case cM:case o:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__nB();if(this.__wh===d){this.__wh=null;}
;}
,_applyHue:function(dm,dl){if(this.__wh===null){this.__wh=cB;}
;if(this.__wh!==J){this.getChildControl(cu).setValue(dm);}
;if(this.__wh!==W){if(this.getChildControl(cb).getBounds()){this.getChildControl(cb).setDomLeft(Math.round(dm/1.40625)+this.getChildControl(cK).getPaddingLeft());}
else {this.getChildControl(cb).setLayoutProperties({left:Math.round(dm/1.40625)});}
;}
;switch(this.__wh){case J:case W:case cB:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__wh===cB){this.__wh=null;}
;}
,_applySaturation:function(dp,dn){if(this.__wh===null){this.__wh=t;}
;if(this.__wh!==J){this.getChildControl(cA).setValue(dp);}
;if(this.__wh!==W){this._setBrightnessGradiant();if(this.getChildControl(cb).getBounds()){this.getChildControl(cb).setDomTop(256-Math.round(dp*2.56)+this.getChildControl(cK).getPaddingTop());}
else {this.getChildControl(cb).setLayoutProperties({top:256-Math.round(dp*2.56)});}
;}
;switch(this.__wh){case J:case W:case t:this._setRgbFromHue();};if(this.__wh===t){this.__wh=null;}
;}
,_applyBrightness:function(ds,dr){if(this.__wh===null){this.__wh=c;}
;if(this.__wh!==J){this.getChildControl(ch).setValue(ds);}
;if(this.__wh!==V){var dq=256-Math.round(ds*2.56);if(this.getChildControl(cl).getBounds()){this.getChildControl(cl).setDomTop(dq+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cl).setLayoutProperties({top:dq});}
;}
;switch(this.__wh){case J:case V:case c:this._setRgbFromHue();};if(this.__wh===c){this.__wh=null;}
;}
,_onBrightnessHandleMouseDown:function(e){this.getChildControl(cl).capture();this.__wj=cl;var dv=this.getChildControl(cd).getContentLocation();var du=this.getChildControl(cl).getContentLocation();var dt=this.getChildControl(cd).getBounds();this.__wk=dv.top+(e.getDocumentTop()-du.top)-dt.top;e.stopPropagation();}
,_onBrightnessHandleMouseUp:function(e){this.getChildControl(cl).releaseCapture();this.__wj=null;}
,_onBrightnessHandleMouseMove:function(e){if(this.__wj===cl){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(cd).getContentLocation();var dw=this.getChildControl(cl).getBounds();this.__wk=location.top+(dw.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cl).capture();this.__wj=cl;}
...
;e.stop();}
,_setBrightnessOnFieldEvent:function(e){var dx=qx.lang.Number.limit(e.getDocumentTop()-this.__wk,0,256);this.__wh=V;if(this.getChildControl(cl).getBounds()){this.getChildControl(cl).setDomTop(dx);}
else {this.getChildControl(cl).setLayoutProperties({top:dx});}
;this.setBrightness(100-Math.round(dx/2.56));this.__wh=null;}
,_onHueSaturationHandleMouseUp:function(e){if(this.__wj){e.stopPropagation();this.getChildControl(cb).releaseCapture();this.__wj=null;}
;}
,_onHueSaturationHandleMouseMove:function(e){if(this.__wj===cb){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(bY).getContentLocation();var dy=this.getChildControl(cb).getBounds();var dz=this.getChildControl(bY).getBounds();this.__wl=location.top+(dy.height/2)-dz.top;this.__wm=location.left+(dy.width/2)-dz.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(cb).capture();this.__wj=cb;}
...
;e.stop();}
,_setHueSaturationOnFieldEvent:function(e){var dB=qx.lang.Number.limit(e.getDocumentTop()-this.__wl,0,256);var dA=qx.lang.Number.limit(e.getDocumentLeft()-this.__wm,0,256);this.getChildControl(cb).setDomPosition(dA,dB);this.__wh=W;this.setSaturation(100-Math.round(dB/2.56));this.setHue(Math.round(dA*1.40625));this.__wh=null;}
,_setRedFromSpinner:function(){if(this.__wh!==null){return;}
;this.__wh=cM;this.setRed(this.getChildControl(n).getValue());this.__wh=null;}
,_setGreenFromSpinner:function(){if(this.__wh!==null){return;}
;this.__wh=cM;this.setGreen(this.getChildControl(U).getValue());this.__wh=null;}
,_setBlueFromSpinner:function(){if(this.__wh!==null){return;}
;this.__wh=cM;this.setBlue(this.getChildControl(cm).getValue());this.__wh=null;}
,_setHueFromSpinner:function(){if(this.__wh!==null){return;}
;this.__wh=J;this.setHue(this.getChildControl(cu).getValue());this.__wh=null;}
,_setSaturationFromSpinner:function(){if(this.__wh!==null){return;}
;this.__wh=J;this.setSaturation(this.getChildControl(cA).getValue());this.__wh=null;}
,_setBrightnessFromSpinner:function(){if(this.__wh!==null){return;}
;this.__wh=J;this.setBrightness(this.getChildControl(ch).getValue());this.__wh=null;}
,_onHexFieldChange:function(e){if(this.__wh!==null){return;}
;try{var dD=this.getChildControl(cJ);var dC=qx.util.ColorUtil.hexStringToRgb(N+dD.getValue());}
catch(dE){return;}
;this.__wh=o;this.setRed(dC[0]);this.setGreen(dC[1]);this.setBlue(dC[2]);this.__wh=null;}
...
,_setHueFromRgb:function(){switch(this.__wh){case J:case W:case V:break;default:var dI=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dI[0]);this.setSaturation(dI[1]);this.setBrightness(dI[2]);};}
,_setRgbFromHue:function(){switch(this.__wh){case cM:case o:break;default:var dJ=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dJ[0]);this.setGreen(dJ[1]);this.setBlue(dJ[2]);};}
