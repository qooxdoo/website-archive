...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox.c3041f5a6cc6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_beforeOpen:function(){this.__HW();}
...
;this.close();}
,__HV:function(event){if(this.__xE==true){return;}
;var N=this.__gf.getItem(0);if(N){N=this.__bo(N);this.setValue(N);}
;}
,_applyPlaceholder:function(P,O){this.getChildControl(r).setPlaceholder(P);}
,__HW:function(){var S=this.getValue();var R=this.getChildControl(s);var Q=R.getSelection();if(this.__bo(Q.getItem(0))!==S){this.__xE=true;Q.removeAll();this.__xE=false;if(S==null||S==q){return;}
...
;return bb;}
},destruct:function(){var be=this.getChildControl(r);this.removeAllBindings();be.removeAllBindings();this.__gf.removeListener(k,this.__HV,this);this.__gf=null;}
});}
)();
