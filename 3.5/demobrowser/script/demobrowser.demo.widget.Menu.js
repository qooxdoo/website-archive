...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu.5d0e9b8c9909.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Online Forum",b="__Ck",c="New",d="icon/16/actions/edit-cut.png",f="icon/16/actions/format-justify-fill.png",g="Search in files",h="C",j="changeValue",k="Left aligned",l="Undo",m="__Sh",n="Perl",o="View",p="C Dialect",q="changeSelection",r="Info...",s="Save as...",t="Show line numbers",u="icon/16/actions/document-save.png",v="Quickstart",w="icon/16/actions/contact-new.png",x="Ctrl+N",y="icon/16/actions/edit-paste.png",z="Actions",A="Show console",B="Search",C="Help",D="Redo",E="Show status bar",F="icon/16/actions/format-justify-left.png",G="__Cr",H="ANSI to OEM",I="Centered",J="Website 3",K="icon/22/apps/preferences-users.png",L="__Sk",M="Edit",N="icon/16/actions/format-justify-center.png",O="Ctrl+O",P="icon/16/actions/document-print.png",Q="icon/16/actions/go-previous.png",R="icon/16/actions/document-open.png",S="C Sharp",T="icon/16/actions/edit-undo.png",U="Close",V="Split Button",W="Website 2",X="icon/16/actions/document-save-as.png",Y="Python",cM="icon/16/apps/utilities-help.png",cN="Show tree",cO="__Sj",cI="Options",cJ="Spaces to tabs",cK="Right aligned",cL="Action 1",cT="OEM to ANSI",cU="Line 431",cV="JavaScript",cW="icon",cP="Action 2",cQ="Folder ",cR="XML",cS="__Sm",db="Line 313",dD="Save",er="Paragraph",dc="demobrowser.demo.widget.Menu",cX="icon/16/actions/application-exit.png",cY="C Plus Plus",en="Line 26",da="Item ",dd="ASCII table",de="Option 1",df="Search next...",dk="Line 12",dl="Action 3",dm="Replace in files",dg="Uppercase",dh="Ctrl+P",di="__Sl",dj="Topics",dr="Panes",ds="Justified",dt="Ctrl+X",du="icon/16/actions/edit-redo.png",dn="Search previous...",dp="Change selection: ",eo="Back",dq="main",dy="Copy",dz=" = ",eq="Paste",dA="Execute command: ",dv="Show ruler",dw="icon/16/actions/format-justify-right.png",ep="icon/16/actions/go-next.png",dx="Ctrl+Z",dB="command ",dC="Option 3",dO="Next",dN="Ctrl+R",dM="Show macros",dS="Show tags",dR="Capitals",dQ="Execute button: ",dP="Format",dH="File",dG="Change checked: ",dF="Show tabs",dE="Print",dL="execute",dK="icon/16/actions/edit-copy.png",dJ="Cut",dI="Tabs to spaces",ea="Search...",dY="Line 1039",dX="Option 2",dW="Open",ee="Objective C",ed="Exit",ec="move to",eb="icon/16/actions/system-search.png",dV="Ctrl+S",dU="Syntax",dT="Ctrl+C",ei="__Si",eh="Website 1",eg="Menu Button",em="icon/16/actions/document-new.png",el="Line 30",ek="Lowercase",ej="Replace",ef="HTML";qx.Class.define(dc,{extend:qx.application.Standalone,members:{__Sh:null,__Si:null,__Sj:null,__Ck:null,__Cr:null,__Sk:null,__Sl:null,__Sm:null,main:function(){qx.application.Standalone.prototype.main.call(this);var et=new qx.ui.container.Scroll();var es=new qx.ui.container.Composite(new qx.ui.layout.Canvas);es.setPadding(20);es.setAllowStretchX(false);et.add(es);this.getRoot().add(et,{edge:0});this.createCommands();es.add(this.getMenuButton(),{left:20,top:20});es.add(this.getSplitButton(),{left:150,top:20});es.add(this.getMenuBar(),{left:20,top:100});es.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
...
;return eu;}
,debugRadio:function(e){this.debug(dp+e.getData()[0].getLabel());}
...
,createCommands:function(){this.__Sh=new qx.ui.core.Command(x);this.__Sh.addListener(dL,this.debugCommand);this.__Si=new qx.ui.core.Command(O);this.__Si.addListener(dL,this.debugCommand);this.__Sj=new qx.ui.core.Command(dV);this.__Sj.addListener(dL,this.debugCommand);this.__Ck=new qx.ui.core.Command(dx);this.__Ck.addListener(dL,this.debugCommand);this.__Cr=new qx.ui.core.Command(dN);this.__Cr.addListener(dL,this.debugCommand);this.__Sk=new qx.ui.core.Command(dt);this.__Sk.addListener(dL,this.debugCommand);this.__Sl=new qx.ui.core.Command(dT);this.__Sl.addListener(dL,this.debugCommand);this.__Sm=new qx.ui.core.Command(dh);this.__Sm.addListener(dL,this.debugCommand);this.__Sm.setEnabled(false);}
,getMenuButton:function(){var ew=new qx.ui.menu.Menu;ew.add(new qx.ui.menu.RadioButton(de));ew.add(new qx.ui.menu.RadioButton(dX));ew.add(new qx.ui.menu.RadioButton(dC));var eE=new qx.ui.menu.Menu;eE.add(new qx.ui.menu.RadioButton(cL));eE.add(new qx.ui.menu.RadioButton(cP));eE.add(new qx.ui.menu.RadioButton(dl));var eD=new qx.ui.form.RadioGroup;eD.add.apply(eD,ew.getChildren());eD.addListener(q,this.debugRadio);var eB=new qx.ui.form.RadioGroup;eB.add.apply(eB,eE.getChildren());eB.addListener(q,this.debugRadio);var ez=new qx.ui.menu.Menu();var eC=new qx.ui.menu.Button(l,T,this.__Ck);var eJ=new qx.ui.menu.Button(D,du,this.__Cr);var ey=new qx.ui.menu.Button(dJ,d,this.__Sk);var eG=new qx.ui.menu.Button(dy,dK,this.__Sl);var eA=new qx.ui.menu.Button(eq,y,this.__Sm);var ex=new qx.ui.menu.Button(cI,eb,null,ew);var eH=new qx.ui.menu.Button(z,w,null,eE);var eF=new qx.ui.menu.Button(dE,P);eC.addListener(dL,this.debugButton);eJ.addListener(dL,this.debugButton);ey.addListener(dL,this.debugButton);eG.addListener(dL,this.debugButton);eA.addListener(dL,this.debugButton);ex.addListener(dL,this.debugButton);eH.addListener(dL,this.debugButton);eF.addListener(dL,this.debugButton);ez.add(eC);ez.add(eJ);ez.addSeparator();ez.add(ey);ez.add(eG);ez.add(eA);ez.addSeparator();ez.add(ex);ez.add(eH);ez.addSeparator();ez.add(eF);var eI=new qx.ui.form.MenuButton(eg,K,ez);return eI;}
,getSplitButton:function(){var eK=new qx.ui.menu.Menu;var eO=new qx.ui.menu.Button(eh);var eM=new qx.ui.menu.Button(W);var eN=new qx.ui.menu.Button(J);eK.setMinWidth(120);eO.addListener(dL,this.debugButton);eM.addListener(dL,this.debugButton);eN.addListener(dL,this.debugButton);eK.add(eO);eK.add(eM);eK.add(eN);var eL=new qx.ui.form.SplitButton(V,K,eK);eL.addListener(dL,this.debugButton);return eL;}
,getMenuBar:function(){var eS=new qx.ui.container.Composite(new qx.ui.layout.Grow);eS.setDecorator(dq);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);eS.add(toolbar);var fc=new qx.ui.toolbar.Part;var eR=new qx.ui.toolbar.Part;var eV=new qx.ui.toolbar.Part;toolbar.add(fc);toolbar.add(eR);toolbar.addSpacer();toolbar.add(eV);var fb=new qx.ui.toolbar.SplitButton(eo,Q,this.getBackMenu());var fe=new qx.ui.toolbar.SplitButton(dO,ep,this.getForwardMenu());var eW=new qx.ui.toolbar.Button(c,em,this.__Sh);var eU=new qx.ui.toolbar.Button(dW,R,this.__Si);var fa=new qx.ui.toolbar.Button(dD,u,this.__Sj);fb.addListener(dL,this.debugButton);fe.addListener(dL,this.debugButton);eW.addListener(dL,this.debugButton);eU.addListener(dL,this.debugButton);fa.addListener(dL,this.debugButton);fc.add(fb);fc.add(fe);fc.addSeparator();fc.add(eW);fc.add(eU);fc.add(fa);fc.setShow(cW);var eT=new qx.ui.toolbar.MenuButton(dH);var eP=new qx.ui.toolbar.MenuButton(M);var eQ=new qx.ui.toolbar.MenuButton(B);var fd=new qx.ui.toolbar.MenuButton(o);var eY=new qx.ui.toolbar.MenuButton(dP);eT.setMenu(this.getFileMenu());eP.setMenu(this.getEditMenu());eQ.setMenu(this.getSearchMenu());fd.setMenu(this.getViewMenu());eY.setMenu(this.getFormatMenu());eR.add(eT);eR.add(eP);eR.add(eQ);eR.add(fd);eR.add(eY);var eX=new qx.ui.toolbar.MenuButton(C);eX.setMenu(this.getHelpMenu());eV.add(eX);return eS;}
...
,getForwardMenu:function(){var fk=new qx.ui.menu.Menu;var fl=new qx.ui.menu.Button(cU);var fm=new qx.ui.menu.Button(el);fl.addListener(dL,this.debugButton);fm.addListener(dL,this.debugButton);fk.add(fl);fk.add(fm);return fk;}
,getFileMenu:function(){var fp=new qx.ui.menu.Menu;var fn=new qx.ui.menu.Button(c,em,this.__Sh);var fr=new qx.ui.menu.Button(dW,R,this.__Si);var fq=new qx.ui.menu.Button(U);var fu=new qx.ui.menu.Button(dD,u,this.__Sj);var ft=new qx.ui.menu.Button(s,X);var fo=new qx.ui.menu.Button(dE,P);var fs=new qx.ui.menu.Button(ed,cX);fn.addListener(dL,this.debugButton);fr.addListener(dL,this.debugButton);fq.addListener(dL,this.debugButton);fu.addListener(dL,this.debugButton);ft.addListener(dL,this.debugButton);fo.addListener(dL,this.debugButton);fs.addListener(dL,this.debugButton);fp.add(fn);fp.add(fr);fp.add(fq);fp.add(fu);fp.add(ft);fp.add(fo);fp.add(fs);return fp;}
,getEditMenu:function(){var fw=new qx.ui.menu.Menu;var fz=new qx.ui.menu.Button(l,T,this.__Ck);var fy=new qx.ui.menu.Button(D,du,this.__Cr);var fv=new qx.ui.menu.Button(dJ,d,this.__Sk);var fA=new qx.ui.menu.Button(dy,dK,this.__Sl);var fx=new qx.ui.menu.Button(eq,y,this.__Sm);fz.addListener(dL,this.debugButton);fy.addListener(dL,this.debugButton);fv.addListener(dL,this.debugButton);fA.addListener(dL,this.debugButton);fx.addListener(dL,this.debugButton);fw.add(fz);fw.add(fy);fw.addSeparator();fw.add(fv);fw.add(fA);fw.add(fx);return fw;}
,getSearchMenu:function(){var fE=new qx.ui.menu.Menu;var fC=new qx.ui.menu.Button(ea,eb);var fH=new qx.ui.menu.Button(df);var fD=new qx.ui.menu.Button(dn);var fG=new qx.ui.menu.Button(ej);var fB=new qx.ui.menu.Button(g,eb);var fF=new qx.ui.menu.Button(dm);fD.setEnabled(false);fC.addListener(dL,this.debugButton);fH.addListener(dL,this.debugButton);fD.addListener(dL,this.debugButton);fG.addListener(dL,this.debugButton);fB.addListener(dL,this.debugButton);fF.addListener(dL,this.debugButton);fE.add(fC);fE.add(fH);fE.add(fD);fE.add(fG);fE.addSeparator();fE.add(fB);fE.add(fF);return fE;}
,getViewMenu:function(){var fI=new qx.ui.menu.Menu;var fK=new qx.ui.menu.Button(dr,null,null,this.getPanesMenu());var fN=new qx.ui.menu.Button(dU,null,null,this.getSyntaxMenu());var fM=new qx.ui.menu.CheckBox(dv);var fL=new qx.ui.menu.CheckBox(t);var fJ=new qx.ui.menu.Button(dd);fM.addListener(j,this.debugCheckBox);fL.addListener(j,this.debugCheckBox);fJ.addListener(dL,this.debugButton);fI.add(fK);fI.add(fN);fI.addSeparator();fI.add(fM);fI.add(fL);fI.addSeparator();fI.add(fJ);return fI;}
,getPanesMenu:function(){var fP=new qx.ui.menu.Menu;var fR=new qx.ui.menu.CheckBox(dF);var fO=new qx.ui.menu.CheckBox(E);var fU=new qx.ui.menu.CheckBox(cN);var fQ=new qx.ui.menu.CheckBox(dM);var fS=new qx.ui.menu.CheckBox(dS);var fT=new qx.ui.menu.CheckBox(A);fR.setValue(true);fO.setValue(true);fQ.setValue(true);fR.addListener(j,this.debugCheckBox);fO.addListener(j,this.debugCheckBox);fU.addListener(j,this.debugCheckBox);fQ.addListener(j,this.debugCheckBox);fS.addListener(j,this.debugCheckBox);fT.addListener(j,this.debugCheckBox);fP.add(fO);fP.add(fR);fP.addSeparator();fP.add(fU);fP.add(fQ);fP.add(fS);fP.add(fT);return fP;}
,getSyntaxMenu:function(){var ga=new qx.ui.menu.Menu;var fV=new qx.ui.menu.RadioButton(ef);var fX=new qx.ui.menu.RadioButton(cR);var fW=new qx.ui.menu.RadioButton(cV);var fY=new qx.ui.menu.Button(p,null,null,this.getSyntaxCMenu());var gd=new qx.ui.menu.RadioButton(n);var gb=new qx.ui.menu.RadioButton(Y);ga.add(fV);ga.add(fX);ga.add(fW);ga.add(fY);ga.add(gd);ga.add(gb);var gc=new qx.ui.form.RadioGroup;gc.add(fV,fX,fW,gd,gb);gc.add.apply(gc,fY.getMenu().getChildren());gc.addListener(q,this.debugRadio);return ga;}
,getSyntaxCMenu:function(){var gf=new qx.ui.menu.Menu;var ge=new qx.ui.menu.RadioButton(h);var gi=new qx.ui.menu.RadioButton(S);var gg=new qx.ui.menu.RadioButton(ee);var gh=new qx.ui.menu.RadioButton(cY);gf.add(ge);gf.add(gi);gf.add(gg);gf.add(gh);return gf;}
,getFormatMenu:function(){var gm=new qx.ui.menu.Menu;var gl=new qx.ui.menu.Button(er,null,null,this.getParagraphMenu());var go=new qx.ui.menu.Button(dI);var gp=new qx.ui.menu.Button(cJ);var gk=new qx.ui.menu.Button(dg);var gn=new qx.ui.menu.Button(ek);var gj=new qx.ui.menu.Button(dR);var gr=new qx.ui.menu.Button(cT);var gq=new qx.ui.menu.Button(H);go.addListener(dL,this.debugButton);gp.addListener(dL,this.debugButton);gk.addListener(dL,this.debugButton);gn.addListener(dL,this.debugButton);gj.addListener(dL,this.debugButton);gr.addListener(dL,this.debugButton);gq.addListener(dL,this.debugButton);gm.add(gl);gm.add(go);gm.add(gp);gm.addSeparator();gm.add(gk);gm.add(gn);gm.add(gj);gm.addSeparator();gm.add(gr);gm.add(gq);return gm;}
,getParagraphMenu:function(){var gs=new qx.ui.menu.Menu;var gw=new qx.ui.menu.Button(k,F);var gv=new qx.ui.menu.Button(cK,dw);var gt=new qx.ui.menu.Button(I,N);var gu=new qx.ui.menu.Button(ds,f);gw.addListener(dL,this.debugButton);gv.addListener(dL,this.debugButton);gt.addListener(dL,this.debugButton);gu.addListener(dL,this.debugButton);gs.add(gw);gs.add(gv);gs.add(gt);gs.add(gu);return gs;}
,getHelpMenu:function(){var gx=new qx.ui.menu.Menu;var gz=new qx.ui.menu.Button(dj,cM);var gB=new qx.ui.menu.Button(v);var gA=new qx.ui.menu.Button(a);var gy=new qx.ui.menu.Button(r);gz.addListener(dL,this.debugButton);gB.addListener(dL,this.debugButton);gA.addListener(dL,this.debugButton);gy.addListener(dL,this.debugButton);gx.add(gz);gx.add(gB);gx.addSeparator();gx.add(gA);gx.addSeparator();gx.add(gy);return gx;}
...
;return gC;}
,getContextMenu:function(){var gD=new qx.ui.menu.Menu;var gF=new qx.ui.menu.Button(dJ,d,this.__Sk);var gG=new qx.ui.menu.Button(dy,dK,this.__Sl);var gE=new qx.ui.menu.Button(eq,y,this.__Sm);gF.addListener(dL,this.debugButton);gG.addListener(dL,this.debugButton);gE.addListener(dL,this.debugButton);gD.add(gF);gD.add(gG);gD.add(gE);return gD;}
},destruct:function(){this._disposeObjects(m,ei,cO,b,G,L,di,cS);}
});}
)();
...
,_onMouseOver:function(e){e.stopPropagation();this.addState(b);delete this.__sF;}
...
;var T=this.getMenu();if(T&&T.isVisible()){this.__sF=true;return;}
;this.removeState(b);}
...
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__sF){this.removeState(b);}
;}
}});}
)();
