...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Video","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Video.218429fd8b3f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="timeupdate",b="demobrowser/demo/media/qx.ogv",c="#CCC",d="Native Controls",f="Loop",g="Mute",h="html.video.h264",i="0:00",j="html.video.ogg",k="demobrowser/demo/media/qx.m4v",l="demobrowser/demo/media/qx.webm",m="It seems that your browser doesn't support HTML5 video",n="loadeddata",o="Play/Pause",p="changeValue",q=":",r="ended",s="0",t="demobrowser.demo.bom.Video",u="html.video.webm";qx.Class.define(t,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var y=this.getRoot();var D=new qx.ui.container.Composite(new qx.ui.layout.Basic());y.add(D,{left:10,top:40});if(qx.core.Environment.get(h)){var w=qx.util.ResourceManager.getInstance().toUri(k);}
else if(qx.core.Environment.get(u)){var w=qx.util.ResourceManager.getInstance().toUri(l);}
else if(qx.core.Environment.get(j)){var w=qx.util.ResourceManager.getInstance().toUri(b);}
else {y.add(new qx.ui.basic.Label(m,{left:10,top:10}));return;}
;var B=new qx.bom.media.Video(w);var v=new qx.ui.form.ToggleButton(o);v.addListener(p,function(e){if(B.isPaused()){B.play();}
else {B.pause();}
;}
,this);var z=new qx.ui.form.ToggleButton(d);z.addListener(p,function(e){if(B.hasControls()){B.hideControls();}
else {B.showControls();}
;}
,this);var x=new qx.ui.form.ToggleButton(g);x.addListener(p,function(e){if(B.isMuted()){B.setMuted(false);}
else {B.setMuted(true);}
;}
,this);var E=new qx.ui.form.ToggleButton(f);E.addListener(p,function(e){if(B.isLoop()){B.setLoop(false);}
else {B.setLoop(true);}
;}
,this);var C=new qx.ui.basic.Label(i);C.setTextColor(c);var A=new qx.ui.indicator.ProgressBar();A.setHeight(21);A.setWidth(220);B.addListener(n,function(){y.add(z,{left:315,top:10});y.add(v,{left:10,top:270});y.add(A,{left:90,top:272});y.add(C,{left:185,top:275});y.add(x,{left:314,top:270});y.add(E,{left:364,top:270});D.getContentElement().getDomElement().appendChild(B.getMediaObject());D.setWidth(400);D.setHeight(220);B.setWidth(D.getWidth());B.setHeight(D.getHeight());}
,this);B.addListener(a,function(){A.setMaximum(B.getDuration());var F=B.getCurrentTime();var H=Math.floor(F/60);var G=parseInt(F%60);A.setValue(F);C.setValue(H+q+(G>9?G:s+G));}
,this);B.addListener(r,function(){if(!B.isLoop()){v.resetValue();}
;}
,this);}
}});}
)();
...
(function(){var a="video",b="qx.bom.media.Video";qx.Class.define(b,{extend:qx.bom.media.Abstract,construct:function(c){this._video=document.createElement(a);if(c){this._video.src=c;}
...
;}
,properties:{appearance:{refine:true,init:c}},events:{complete:g,change:i},members:{__zX:0,__FE:100,getValue:function(){return this.__zX;}
,setValue:function(m){var l=this.getMaximum();if(!qx.lang.Type.isNumber(m)||!isFinite(m)){return null;}
;if(m<0){m=0;}
;if(m>l){m=l;}
;this.__zX=m;this._changeProgress(m/l);return m;}
,getMaximum:function(){return this.__FE;}
,setMaximum:function(o){var n=o;var p=this.getValue();if(!qx.lang.Type.isNumber(n)||!isFinite(n)||n<=0){return null;}
;if(n<p){n=p;}
;this.__FE=n;this._changeProgress(p/n);return n;}
