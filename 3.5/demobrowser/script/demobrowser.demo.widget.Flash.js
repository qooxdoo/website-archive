...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.eff6e4004fdb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__Sf",c="Flash Player Version",d="__Fl",f="right",g="qooxdoo is the best!",h="Message from Flash:",i="execute",j="Simple demo with FlashVars",k="bgcolor",l="demobrowser.demo.widget.Flash",m="demobrowser/demo/flash/TestFlash.swf",n="1) no pop-up or advertising blocker is activated.\n",o="Send to Flash",p="demobrowser/demo/flash/FlashVersion.swf",q="No message.",r="Flash:",s="<b>qooxdoo:</b>",t="demobrowser.demo.widget.Flash.sendMessage",u="demobrowser.demo.widget.Flash.flashReady",v="Couldn't connect to Flash Player! Please make sure that:\n",w="__cw",x="demobrowser/demo/flash/fo_tester.swf",y="this is passed in via FlashVars",z="Two way communication (ActionScript <-> JavaScript)",A="__Se",B="Message to Flash:",C="Show Flash Player version",D="noscale",E="__Sd",F="#FF6600";qx.Class.define(l,{extend:qx.application.Standalone,members:{__cw:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(j);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(z);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cw=this.createWindow();G.add(this.__cw,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:y};var M=new qx.ui.embed.Flash(x).set({scale:D,variables:L});M.getContentElement().setParam(k,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(C);O.addListener(i,function(){this.__cw.open();}
,this);N.add(O);return N;}
,__Fl:null,__Sd:null,__Se:null,__Sf:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(s).set({rich:true}));Q.add(new qx.ui.basic.Label(h));this.__Sd=new qx.ui.form.TextArea(q);this.__Sd.setEnabled(false);Q.add(this.__Sd,{flex:1});Q.add(new qx.ui.basic.Label(B));this.__Se=new qx.ui.form.TextArea(g);Q.add(this.__Se,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));this.__Sf=new qx.ui.form.Button(o);this.__Sf.setEnabled(false);this.__Sf.addListener(i,function(e){this.__Fl.getFlashElement().sendMessage(this.__Se.getValue());}
,this);S.add(this.__Sf);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(r).set({rich:true}));this.__Fl=new qx.ui.embed.Flash(m);this.__Fl.setVariables({init:u});P.add(this.__Fl,{flex:1});return R;}
,sendMessage:function(T){this.__Sd.setValue(T);}
,initFlash:function(){if(this.__Fl.getFlashElement().setup){this.__Fl.getFlashElement().setup(t);this.__Sf.setEnabled(true);}
else {alert(v+n+a);}
;}
},statics:{__Sg:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Sg=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Sg.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Sg.initFlash();}
},destruct:function(){this._disposeObjects(E,A,b,d,w);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__Fg){this.__Fg=new Date().getTime();}
;var bp=new Date().getTime()-this.__Fg;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__Fg=null;}
;}
else {this.fireEvent(p);this.__Fg=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__Fh(c,bB);}
,_applyScale:function(bD,bC){this.__Fh(h,bD);}
,_applyWmode:function(bF,bE){this.__Fh(m,bF);}
,_applyPlay:function(bH,bG){this.__Fh(I,bH);}
,_applyLoop:function(bJ,bI){this.__Fh(s,bJ);}
,_applyMenu:function(bL,bK){this.__Fh(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__Fh(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__Fh(z,bP);}
,__Fh:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__Fi={};this.__Fj={};this.__Fk={};}
,members:{__Fi:null,__Fk:null,__Fj:null,__Fl:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__Fl=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Fj,this.__Fi);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__Fl){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__Fl){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__Fj;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__Fl){throw new Error(d);}
;this.__Fj=t;}
,getAttributes:function(){return this.__Fk;}
...
else if(this.__Fl){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Fk[u];}
else {this.__Fk[u]=v;}
;}
,getParams:function(){return this.__Fi;}
...
;}
;}
;if(this.__Fl){throw new Error(l);}
;if(x===null||x===undefined){delete this.__Fi[w];}
else {this.__Fi[w]=x;}
;}
,getFlashElement:function(){return this.__Fl;}
},destruct:function(){if(this.__Fl){qx.bom.Flash.destroy(this.__Fl);}
;this.__Fi=this.__Fj=this.__Fk=null;}
});}
)();
