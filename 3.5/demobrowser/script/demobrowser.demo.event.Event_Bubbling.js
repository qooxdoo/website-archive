...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling.f1289c4271cf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__QI=f+p.join(c)+a;this.__QJ=o||50;this.__QK=n;this._clearLog();}
,_clearLog:function(){this.__QK.innerHTML=this.__QI+j;this.__QL=[];}
,_log:function(q){this.__QL.unshift(q);this.__QL=this.__QL.slice(0,this.__QJ);var r=[this.__QI];for(var i=0;i<this.__QL.length;i++ ){r.push(g,this.__QL[i].join(e),l);}
;r.push(j);this.__QK.innerHTML=r.join(d);this.__QK.scrollTop=0;}
,__QI:null,__QJ:null,__QK:null,__QL:null},destruct:function(){this.__QK=this.__QL=null;}
});}
)();
