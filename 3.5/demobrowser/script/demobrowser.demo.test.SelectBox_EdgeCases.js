...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.SelectBox_EdgeCases.b2c9a485ef11.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Times New Roman",b="Long list",c="Long button, short text",d="",e="Fonts",f="container",g="Font ",h="Tahoma",j="Courier New",k="Item ",l="Arial",m="demobrowser.demo.test.SelectBox_EdgeCases";qx.Class.define(m,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var n=new qx.ui.container.Scroll();this.container=new qx.ui.container.Composite(new qx.ui.layout.Canvas());this.container.setAllowStretchX(false);this.container.setAllowGrowX(false);n.add(this.container);this.getRoot().add(n,{edge:0});this.addBox1();this.addBox2();this.addBox3();}
,addBox1:function(){this.container.add(new qx.ui.basic.Label(b),{left:25,top:20});var o=new qx.ui.form.SelectBox();o.setMaxListHeight(null);for(var i=0;i<300;i++ ){var p=new qx.ui.form.ListItem(d+i);o.add(p);}
;this.container.add(o,{left:20,top:40});}
,addBox2:function(){this.container.add(new qx.ui.basic.Label(e),{left:25,bottom:45});var w=new qx.ui.form.SelectBox();var r=new qx.bom.Font(12,[h]);var s=new qx.bom.Font(15,[l]);var t=new qx.bom.Font(18,[j]);var u=new qx.bom.Font(21,[a]);var q=[r,s,t,u];for(var i=0;i<q.length;i++ ){var v=new qx.ui.form.ListItem(g+(i+1));v.setFont(q[i]);w.add(v);}
;this.container.add(w,{left:20,bottom:20});}
,addBox3:function(){this.container.add(new qx.ui.basic.Label(c),{left:205,top:20});var x=new qx.ui.form.SelectBox();x.setWidth(300);x.setMaxListHeight(100);for(var i=0;i<20;i++ ){var y=new qx.ui.form.ListItem(k+i);if(i%5==1){y.setEnabled(false);}
;x.add(y);}
