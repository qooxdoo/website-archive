...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker.dc15531b27e2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__em();}
,members:{__IU:null,__wv:null,__IV:null,__IW:false,__IX:10000,__IY:0,__Ja:f,block:function(r){if(!this.__IW){this.__IV=r;var q=this.__Jd();this.__Je(q);this.__IW=true;}
;}
,unblock:function(){if(this.__IW){this.__Jf();this.__IW=false;}
;}
,isBlocked:function(){return this.__IW;}
,getBlockerElement:function(){return this.__wv;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__wv,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wv,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wv,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wv);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wv,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wv,h);}
,__em:function(){this.__Jb();if((qx.core.Environment.get(j)==b)){this.__Jc();}
;qx.event.Registration.addListener(window,a,this.__zd,this);}
,__Jb:function(){this.__wv=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wv,{display:d,opacity:this.__IY,backgroundColor:this.__Ja});this.setBlockerZIndex(this.__IX);}
,__Jc:function(){this.__IU=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__IU,l,false);qx.bom.element.Attribute.set(this.__IU,i,n);qx.bom.element.Style.setStyles(this.__IU,{display:d,opacity:this.__IY});}
,__Jd:function(){var v={position:p};if(this.__Jh()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__IV)+g;v.height=qx.bom.element.Dimension.getHeight(this.__IV)+g;v.left=qx.bom.element.Location.getLeft(this.__IV)+g;v.top=qx.bom.element.Location.getTop(this.__IV)+g;}
;return v;}
,__Je:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wv,w);qx.dom.Element.insertEnd(this.__wv,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__IU,w);qx.dom.Element.insertEnd(this.__IU,document.body);}
;}
,__Jf:function(){qx.dom.Element.remove(this.__wv);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__IU);}
;}
,__zd:function(e){if(this.__Jh()){this.__Jg({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Jg(y);}
,this,0);}
;}
,__Jg:function(z){qx.bom.element.Style.setStyles(this.__wv,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__IU,z);}
;}
,__Jh:function(){return (this.__IV==null||qx.dom.Node.isWindow(this.__IV)||qx.dom.Node.isDocument(this.__IV));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__zd,this);this.__IU=this.__wv=this.__IV=null;}
});}
)();
