...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.c70ae1e48597.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="touchmove",b="black",c="#333",d="px",f="border-left",g="green",h="div",i="100%",j="demobrowser.demo.mobile.PingPong",k="0",l="200px",m="30px",n="qx.debug",o="interval",p="0px",q="12px",r="15em",s="center",t="100px",u="1px solid white",v='Lucida Grande',w="innerHTML",z="top",A="right",B="Arial",C="50%",D="<b>This demo is supposed to be run in a WebKit-based browser.</b>",E="engine.name",F="20px",G="webkit",H="none",I="border-right",J="white",K="left",L="absolute";qx.Class.define(j,{extend:qx.application.Native,members:{__QQ:null,__QR:null,__QS:null,__QT:null,__QU:5,__QV:1,__QW:1,__QX:null,__QY:null,__Ra:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(n)){qx.log.appender.Native;qx.log.appender.Console;}
...
;var M=this.__Re(K);R.add(M);var N=this.__Re(A);R.add(N);this.__QR=this.__Rf(K);M.add(this.__QR);M.addListener(a,qx.lang.Function.bind(this.__hQ,this),this);this.__QQ=this.__Rf(A);N.add(this.__QQ);N.addListener(a,qx.lang.Function.bind(this.__hQ,this),this);this.__QS=this.__Rg();R.add(this.__QS);this.__QY=this.__Rh();M.add(this.__QY);this.__Ra=this.__Rh();N.add(this.__Ra);this.__QX=[0,0];this.__Rb();}
,__Rb:function(){this.__QS.setStyles({"left":l,"top":l});this.__QT=new qx.event.Timer(40);this.__QT.addListener(o,function(){var x=(parseInt(this.__QS.getStyle(K))+this.__QU*this.__QV);var y=(parseInt(this.__QS.getStyle(z))+this.__QU*this.__QW);this.__QS.setStyle(K,x+d);this.__QS.setStyle(z,y+d);this.__Rd();}
,this);this.__QT.start();}
,__Rc:function(S){this.__QT.stop();this.__QT.dispose();this.__QU=5;this.__QX[S]=this.__QX[S]+1;this.__QY.setAttribute(w,this.__QX[0]);this.__Ra.setAttribute(w,this.__QX[1]);this.__Rb();}
,__Rd:function(){var U=this.getBoundsFor(this.__QS);if(U.top<=0){this.__QW=1;}
;if(U.bottom>=window.innerHeight-5){this.__QW=-1;}
;if(U.left<=0||U.right>=window.innerWidth){this.__Rc(U.left<=0?1:0);}
;var V=this.getBoundsFor(this.__QR);if(U.left<=V.right&&U.bottom>=V.top&&U.top<=V.bottom){this.__QV=1;this.__QU=Math.min(this.__QU+1,20);}
;var T=this.getBoundsFor(this.__QQ);if(U.right>=T.left&&U.bottom>=T.top&&U.top<=T.bottom){this.__QV=-1;this.__QU=Math.min(this.__QU+1,20);}
;}
,__hQ:function(e){var Y=e.getAllTouches().length;var W=e.getAllTouches()[0];var ba=W.pageY;var X=0;if(Y>1){var bb=e.getAllTouches()[1];if(W.pageX<bb.pageX){ba=W.pageY;X=bb.pageY;}
else {ba=bb.pageY;X=W.pageY;}
;}
;this.__QR.setStyles({"top":(ba-50)+d});if(Y>1){this.__QQ.setStyles({"top":(X-50)+d});}
;e.preventDefault();}
,getBoundsFor:function(bc){return qx.bom.element.Location.get(bc.getDomElement());}
,__Re:function(be){var bd={"width":C,"height":i,"position":L,"backgroundColor":b};if(be==K){bd[I]=u;}
else {bd[K]=C;bd[f]=u;}
;return new qx.html.Element(h,bd);}
,__Rf:function(bg){var bf={"width":m,"height":t,"top":t,"position":L,"backgroundColor":J};bf[bg]=F;return new qx.html.Element(h,bf);}
,__Rg:function(){var bh={"width":F,"height":F,"position":L,"backgroundColor":J,"userSelect":H};return new qx.html.Element(h,bh);}
,__Rh:function(){var bi={"width":i,"height":i,"textAlign":s,"fontSize":r,"color":c,"fontFamily":B};var bj=new qx.html.Element(h,bi);bj.setAttribute(w,k);return bj;}
}});}
)();
