...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.66067186ebdf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="groupBoxes",b="demobrowser.demo.bom.portal.box.Manager",c="boxData",d="qx.event.type.Event",e="boxes",f="demobrowser.demo.bom.portal.box.Box",g="_applyActiveBox",h="loaded",m="singleton";qx.Class.define(b,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__PR=[];this.__PS=[];this.__PT={};}
,statics:{dataKeyRoot:c,dataKeyGroupBoxes:a,dataKeyBoxes:e},events:{"loaded":d},properties:{activeBox:{init:null,check:f,apply:g}},members:{__PR:null,__PS:null,__PT:null,_applyActiveBox:function(o,n){if(n!=null){n.setActive(false);}
;o.setActive(true);}
,load:function(){this.__em(window[demobrowser.demo.bom.portal.box.Manager.dataKeyRoot]);qx.event.Registration.fireEvent(this,h);}
,__em:function(t){var s,w,u,v,x,t;var p=t[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var r=t[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in p){s=p[w];u=s.boxes;w=s.id;v={id:w,element:document.getElementById(w)};this.__PS.push(v);this.__PT[w]=[];for(var k=0,l=u.length;k<l;k++ ){t=r[u[k]];var q=document.getElementById(t.id);var x=new demobrowser.demo.bom.portal.box.Box(t,q,null,w);this.__PR.push(x);this.__PT[w].push(x);}
;}
;}
,getBoxes:function(){return this.__PR;}
,getGroupBoxes:function(){return this.__PS;}
,updateGroupBoxMembers:function(A,B,y){var z=qx.dom.Hierarchy.getElementIndex(y.getElement());qx.lang.Array.remove(this.__PT[B],y);qx.lang.Array.insertAt(this.__PT[A],y,z);}
...
(function(){var a="click",b="Boolean",c="1px solid #444444",d="height",f="position",g="zIndex",h="_applyActive",i="width",j="box_content",k=" It does contain no UI widget code at all.",l="<br/><br/>",m="relative",n="demobrowser.demo.bom.portal.box.Box",o="1px solid orange",p="This is a demo application showing the low-level capabilities.",q="div",r="String",s="border";qx.Class.define(n,{extend:qx.core.Object,construct:function(v,x,t,u){qx.core.Object.call(this);this.__PU=v;this.__ci=v.id;if(x!=null){qx.bom.element.Style.set(x,i,v.width);qx.bom.element.Style.set(x,d,v.height);this.__PX(x,t);}
;this.setElement(x);this.setGroupBoxId(u);this.__PV=null;this.__PW=null;if(v.resizable){this.setResizable(true);var w={minWidth:parseInt(v.minWidth),minHeight:parseInt(v.minHeight),maxWidth:parseInt(v.maxWidth),maxHeight:parseInt(v.maxHeight),handles:v.resizeHandles};this.__PV=new demobrowser.demo.bom.portal.box.Resizable(this,w);}
;if(v.draggable){this.setDraggable(true);this.__PW=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__PY();}
,properties:{element:{init:null},groupBoxId:{init:null,check:r},active:{check:b,init:false,apply:h},resizable:{check:b,init:false},draggable:{check:b,init:false}},members:{__ci:null,__PU:null,__PW:null,__PV:null,_applyActive:function(z,y){if(z){qx.bom.element.Style.set(this.getElement(),s,o);}
...
,__PX:function(C,A){if(A){for(var B in A){qx.bom.element.Style.set(B,A[B]);}
;}
;qx.bom.element.Style.set(C,f,m);qx.bom.element.Style.set(C,g,0);qx.bom.Element.addListener(C,a,this.__Qa,this,true);}
,__PY:function(){var E=p+k;E=E+l+E+l+E;var D=qx.dom.Element.create(q,{"class":j});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
...
(function(){var a="south",b="mouseup",c="mousedown",d='px',f="width",g="visibility",h="_",i="height",j="mouseover",k="mouseout",l="px",m="east",n="visible",o="hidden",p="mousemove",q="div",r="orientation",s="demobrowser.demo.bom.portal.box.Resizable",t="southeast",u="Handle";qx.Class.define(s,{extend:qx.core.Object,construct:function(v,w){qx.core.Object.call(this);this.__Qb=v;this.__gl=this.__Qb.getElement();this.__Qc={};this.__Qd=false;this.__Qe={orientation:null,lastCoord:{left:null,top:null}};this.__Qf={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__Qf){if(w[name]){this.__Qf[name]=w[name];}
;}
;this.__PX();}
,members:{__Qe:null,__Qb:null,__gl:null,__Qc:null,__Qf:null,__Qd:false,getBox:function(){return this.__Qb;}
,__PX:function(){switch(this.__Qf.handles){case 1:this.__Qc.east=null;break;case 2:this.__Qc.south=null;break;case 3:this.__Qc.south=null;this.__Qc.southeast=null;this.__Qc.east=null;break;};for(var y in this.__Qc){var x=this.__Qc[y]=qx.dom.Element.create(q);qx.bom.element.Attribute.set(x,r,y);qx.dom.Element.insertEnd(x,this.__gl);if(this.__gl.id){x.id=this.__gl.id+h+y;}
;this.__Qg(y);this.__Qh(y);}
;}
,__Qg:function(z){qx.bom.element.Class.add(this.__Qc[z],z+u);qx.bom.element.Style.set(this.__Qc[z],g,this.__Qf.autoHide?o:n);}
,__Qh:function(B){var C=qx.event.Registration;var A=this.__Qc[B];C.addListener(A,c,this.__Qk,this);C.addListener(document,b,this.__Ql,this);if(this.__Qf.autoHide){C.addListener(this.__Qb.getElement(),j,this.__Qi,this);C.addListener(this.__Qb.getElement(),k,this.__Qj,this);}
;}
,__Qi:function(e){for(var D in this.__Qc){qx.bom.element.Style.set(this.__Qc[D],g,n);}
;}
,__Qj:function(e){if(!this.__Qd){for(var E in this.__Qc){qx.bom.element.Style.set(this.__Qc[E],g,o);}
;}
;}
,__Qk:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,p,this.__Qm,this,true);this.__Qd=true;var F=e.getTarget();this.__Qe.orientation=qx.bom.element.Attribute.get(F,r);this.__Qe.lastCoord.left=e.getDocumentLeft();this.__Qe.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__gl);}
;}
,__Ql:function(e){e.stopPropagation();if(this.__Qd){qx.event.Registration.removeListener(document,p,this.__Qm,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__gl);if(this.__Qf.autoHide){for(var G in this.__Qc){qx.bom.element.Style.set(this.__Qc[G],g,o);}
;}
;this.__Qd=false;qx.bom.Selection.clear(document.body);}
;}
,__Qm:function(e){e.stopPropagation();if(this.__Qd){var H={left:null,top:null};switch(this.__Qe.orientation){case a:H.top=e.getDocumentTop();break;case t:H.top=e.getDocumentTop();H.left=e.getDocumentLeft();break;case m:H.left=e.getDocumentLeft();break;};this.__Qn(H,this.__Qe.lastCoord);this.__Qe.lastCoord.left=e.getDocumentLeft();this.__Qe.lastCoord.top=e.getDocumentTop();}
;}
,__Qn:function(K,L){var Q=qx.bom.element.Dimension;var N=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Qb.getId());var P=Q.getContentSize(N.element);if(K.left){var M=K.left-L.left;if(M!==0){var J=Q.getContentWidth(this.__gl)+M;var O=Q.getWidth(this.__gl)+M;if((this.__Qf.minWidth==null||J>this.__Qf.minWidth)&&(this.__Qf.maxWidth==null||J<=this.__Qf.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__gl,f,J+d);this.__Qb.getData().width=J;}
;}
;}
;}
;if(K.top){var M=K.top-L.top;if(M!==0){var I=Q.getContentHeight(this.__gl)+M;if((this.__Qf.minHeight==null||I>this.__Qf.minHeight)&&(this.__Qf.maxHeight==null||I<=this.__Qf.maxHeight)){qx.bom.element.Style.set(this.__gl,i,I+l);}
;}
;}
;}
},destruct:function(){if(this.__Qf.autoHide){qx.event.Registration.removeListener(this.__Qb.getElement(),j,this.__Qi,this);qx.event.Registration.removeListener(this.__Qb.getElement(),k,this.__Qj,this);}
;this.__Qb=this.__Qf=this.__gl=this.__Qc=null;this.__Qe=null;}
});}
)();
...
(function(){var a="zIndex",b="auto",c="demobrowser.demo.bom.portal.box.Util";qx.Class.define(c,{statics:{__Qo:1000,bringToFront:function(e){var d=qx.bom.element.Style.get(e,a);d=d==b?0:d;qx.bom.element.Style.set(e,a,d+this.__Qo);}
,sendToBack:function(g){var f=qx.bom.element.Style.get(g,a);qx.bom.element.Style.set(g,a,f-this.__Qo);}
}});}
)();
...
(function(){var a="mousemove",b="engine.name",c="mouseup",d="mousedown",f="dragstart",g="mouseover",h="drag",i="dragend",j="div",k="move",l="dragHandle",m="demobrowser.demo.bom.portal.box.Draggable",n="cursor",o="html";qx.Class.define(m,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.__Qb=p;this.__gl=p.getElement();this.__Qp=null;this.__Qq=null;this.__PX();}
,members:{__Qb:null,__gl:null,__Qp:null,__Qq:null,getBox:function(){return this.__Qb;}
,getElement:function(){return this.__gl;}
,__PX:function(){this.__Qr();this.__Qh();}
,__Qr:function(){this.__Qp=qx.dom.Element.create(j);qx.bom.element.Class.add(this.__Qp,l);qx.dom.Element.insertBegin(this.__Qp,this.__gl);}
,__Qh:function(){qx.bom.Element.addListener(this.__Qp,d,this.__ll,this);qx.bom.Element.addListener(this.__Qp,g,function(e){qx.bom.element.Style.set(this,n,k);}
,this.__Qp);qx.bom.Element.addListener(this.__Qp,f,this.__MV,this);qx.bom.Element.addListener(this.__Qp,i,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__Qp,h,this.__Qu,this);}
,__ll:function(e){if(e.isLeftPressed()){this.__Qq={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__gl),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__gl)};qx.bom.Element.addListener(document.body,c,this.__Qt,this,true);this.__Qs();qx.event.Registration.fireEvent(this.__Qp,f,qx.event.type.Event);}
;}
,__Qs:qx.core.Environment.select(b,{"mshtml":function(){var r=this;var q=qx.lang.Function.bind(this.__Qt,r);document.getElementsByTagName(o)[0].onmouseleave=q;}
,"default":(function(){}
)}),__Qt:function(e){try{e.stopPropagation();}
catch(s){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,a,this.__Qu,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,c,this.__Qt,this,true);}
,__MV:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__Qb);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__Qb);qx.event.Registration.addListener(document.body,a,this.__Qu,this,true);}
...
},destruct:function(){this.__Qb=this.__Qp=this.__gl=this.__Qq=null;}
});}
)();
...
(function(){var a="width:",b="top",c="Boolean",d="px",f="border",g="left",h="demobrowser.demo.bom.portal.dragdrop.Manager",k="height:",l="paddingTop",m="opacity:0.5;margin:0;position:absolute;",n="end",o="left:",p="div",q="demobrowser.demo.bom.portal.box.Box",r="px;",s="paddingBottom",t="1px dashed red",u="ease-out",v="singleton",w="top:";qx.Class.define(h,{type:v,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Qv={top:null,height:null};this.__Qw={top:0,left:0};}
,properties:{activeBox:{check:q,init:null,nullable:true},sessionActive:{check:c,init:false}},members:{__Qv:null,__Qx:null,__Qy:false,__Qw:null,__Qz:null,__QA:null,startSession:function(y){this.setSessionActive(true);this.setActiveBox(y);this.__Qx=y.getGroupBoxId();this.__QB();if(this.__Qz==null){this.__Qz={};var x=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=x.length;i<j;i++ ){this.__Qz[x[i].element.id]={left:qx.bom.element.Location.getLeft(x[i].element),right:qx.bom.element.Location.getLeft(x[i].element)+qx.bom.element.Dimension.getWidth(x[i].element)};}
;}
;}
,__QB:function(){if(!this.__QA){this.__QA=qx.dom.Element.create(p);}
;var B=this.getActiveBox().getElement();var z=qx.bom.element.Dimension.getContentSize(B);this.__QC(B,this.__QA);qx.bom.element.Class.add(this.__QA,qx.bom.element.Class.get(B));var A=m+w+qx.bom.element.Location.getTop(B)+r+o+qx.bom.element.Location.getLeft(B)+r+a+z.width+r+k+z.height+d;qx.bom.element.Style.setCss(this.__QA,A);qx.bom.element.Style.set(B,f,t);qx.dom.Node.getBodyElement(B).appendChild(this.__QA);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__QA);}
,__QC:function(C,D){while(C.firstChild){D.appendChild(C.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var I=this.getActiveBox();var G=I.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(I.getGroupBoxId(),this.__Qx,I);I.setGroupBoxId(this.__Qx);var F={left:qx.bom.element.Location.getLeft(this.__QA)+d,top:qx.bom.element.Location.getTop(this.__QA)+d};var H={left:qx.bom.element.Location.getLeft(G)+d,top:qx.bom.element.Location.getTop(G)+d};var J={timing:u,duration:300,keep:100,keyFrames:{'0':F,'100':H}};var E=qx.bom.element.Animation.animate(this.__QA,J);E.addListener(n,function(){this.__QC(this.__QA,G);qx.bom.element.Style.reset(G,f);this.__QA.parentNode.removeChild(this.__QA);if(I.isActive()){I._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(I);}
;}
,this);}
,onDragMove:function(top,M){if(this.__Qw.left!=M){qx.bom.element.Style.set(this.__QA,g,M+d);}
;if(this.__Qw.top!=top){qx.bom.element.Style.set(this.__QA,b,top+d);}
;var K=this.getActiveBox().getElement();if(this.__Qv.top==null){this.__Qv.top=qx.bom.element.Location.getTop(K);}
;if(this.__Qv.height==null){this.__Qv.height=qx.bom.element.Dimension.getHeight(K);}
;if(this.__Qy==false&&top>=this.__Qv.top&&top<=(this.__Qv.top+this.__Qv.height)){return;}
;var L;if(this.__Qy){L=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__Qx));while(L!=null){if(this.__QD(true,top,K,L)){this.__Qy=false;return;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {L=K;}
;if(top-this.__Qw.top>0){L=qx.dom.Hierarchy.getNextElementSibling(L);while(L!=null){if(L){if(this.__QD(true,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {var L=qx.dom.Hierarchy.getPreviousElementSibling(L);while(L!=null){if(L){if(this.__QD(false,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getPreviousElementSibling(L);}
;}
;this.__Qw.left=M;this.__Qw.top=top;}
,__QD:function(P,top,S,Q){var O=qx.bom.element.Location.getTop(Q);var T=parseInt(qx.bom.element.Style.get(Q,l));var N=parseInt(qx.bom.element.Style.get(Q,s));var U=qx.bom.element.Dimension.getContentHeight(Q)+N+T;var R;if(P){if(top>=(O+(U/3))){R=qx.dom.Hierarchy.getNextElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertAfter(S,Q);this.__Qv.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
else {if(top<=(O+U*2/3)){R=qx.dom.Hierarchy.getPreviousElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertBefore(S,Q);this.__Qv.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
;return false;}
,checkGroupBox:function(X,W){if(this.__Qz[this.__Qx].left<=X&&this.__Qz[this.__Qx].right>=X){return;}
;for(var V in this.__Qz){if(V!=this.__Qx){if(this.__Qz[V].left<=X+W&&this.__Qz[V].right>=X){this.__Qx=V;this.__Qy=true;return;}
;}
;}
;}
