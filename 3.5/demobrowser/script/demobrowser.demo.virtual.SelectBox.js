...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SelectBox.f7675b71789c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="click",c="one",d="Enter",e="list",f="changeDelegate",g="change",h="qx.data.Array",j="changeVisibility",k="qx.ui.form.core.VirtualDropDownList",l="_applySelection",m="changeSelection",n="Invalid parameter 'target'!",o="qx.event.type.Data";qx.Class.define(k,{extend:qx.ui.popup.Popup,construct:function(p){qx.core.Assert.assertNotNull(p,n);qx.core.Assert.assertNotUndefined(p,n);qx.core.Assert.assertInterface(p,qx.ui.form.core.AbstractVirtualBox,n);qx.ui.popup.Popup.call(this,new qx.ui.layout.VBox());this._target=p;this._createChildControl(e);this.addListener(j,this.__xh,this);this.__xe=new qx.data.Array();this.initSelection(this.__xe);}
,properties:{autoHide:{refine:true,init:false},keepActive:{refine:true,init:true},selection:{check:h,event:m,apply:l,nullable:false,deferredInit:true}},events:{"changeSelection":o},members:{_target:null,_preselected:null,__xf:false,__xg:false,__xe:null,open:function(){this.placeToWidget(this._target,true);this.show();}
,close:function(){this.hide();}
,setPreselected:function(q){this._preselected=q;this.__xg=true;var s=this.getChildControl(e).getSelection();var r=new qx.data.Array([q]);this.__xj(r,s);r.dispose();this.__xg=false;}
...
,_handleKeyboard:function(event){if(this.isVisible()&&event.getKeyIdentifier()===d){this.__xi();return;}
;var w=event.clone();w.setTarget(this.getChildControl(e));w.setBubbles(false);this.getChildControl(e).dispatchEvent(w);}
,_handleMouse:function(event){this.__xi();}
,__nU:function(event){if(this.__xf){return;}
;var x=this.getSelection();var y=this.getChildControl(e).getSelection();this.__xg=true;this.__xj(x,y);this.__xg=false;this.__xf=true;this.__xj(y,x);this.__xf=false;}
,_onListChangeSelection:function(event){if(this.__xg){return;}
;var z=this.getChildControl(e).getSelection();if(this.isVisible()){this.setPreselected(z.getItem(0));}
else {this.__xf=true;this.__xj(z,this.getSelection());this.__xf=false;}
;}
,__xh:function(event){if(this.isVisible()){if(this._preselected==null){var A=this.getSelection();var B=this.getChildControl(e).getSelection();this.__xj(A,B);}
;this.__xk();}
...
,_applySelection:function(D,C){D.addListener(g,this.__nU,this);if(C!=null){C.removeListener(g,this.__nU,this);}
;this.__xj(D,this.getChildControl(e).getSelection(D));}
,__xi:function(){if(this._preselected!=null){var E=this.getSelection();E.splice(0,1,this._preselected);this._preselected=null;this.close();}
;}
,__xj:function(F,H){if(F.equals(H)){return;}
...
;}
,__xk:function(){this.__xl();this.__xm();}
,__xl:function(){var I=this._target.getBounds().width;this.setWidth(I);}
,__xm:function(){var J=this.__xn();var L=this._target.getMaxListHeight();var K=this.getChildControl(e);var M=K.getPane().getRowConfig().getTotalSize();if(L==null||M<L){L=M;}
;if(L>J){K.setMaxHeight(J);}
else if(L<J){K.setMaxHeight(L);}
;}
,__xn:function(){var N=this.getLayoutLocation(this._target);var Q=qx.bom.Viewport.getHeight();var P=N.top;var O=Q-N.bottom;return P>O?P:O;}
},destruct:function(){if(this.__xe){this.__xe.dispose();}
;}
});}
)();
...
;}
,_handleKeyboard:function(event){var T=this._getAction(event);switch(T){case q:this.__yc+=this.__ye(event.getKeyIdentifier());this.__yb.restart();break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
...
,__yd:function(){this.__yb.stop();var Y=this.__yc;if(Y==null||Y==s){return;}
...
;}
;this.__yc=s;}
,__ye:function(bi){if(bi===f){return B;}
else {return bi;}
;}
},destruct:function(){this._removeBindings();this.__yb.removeListener(l,this.__yd,this);this.__yb.dispose();this.__yb=null;}
});}
)();
