...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_3d.ebe0bbb117dd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="360deg",b="infinite",c="css.transform.3d",d="demobrowser.demo.animation.Animation_3d",e="",f="preserve-3d",g="flat",h="container",i="45deg",j="parent",k="0deg",l="mouseover",m="50px",n="mouseout",o="center top",p="css.animation",q="-100px",r='label',s="20deg",t="CSS animations not supported, sorry!";qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(p)==null||!qx.core.Environment.get(c)){document.body.innerHTML=e;var w=document.createElement(r);w.innerHTML=t;document.body.appendChild(w);return;}
;var u={duration:10000,repeat:b,keyFrames:{'0':{rotate:[null,k]},'100':{rotate:[null,a]}}};var parent=document.getElementById(j);qx.bom.element.Animation.animate(parent,u);qx.bom.element.Transform.setStyle(parent,f);qx.bom.element.Transform.transform(parent.children[0],{translate:[null,null,q],rotate:[null,i]});qx.bom.element.Transform.transform(parent.children[1],{translate:[null,null,m],rotate:[s]});qx.bom.element.Transform.setOrigin(parent.children[1],o);var v=document.getElementById(h);qx.bom.element.Transform.setPerspective(v,500);qx.bom.Event.addNativeListener(v,l,function(){qx.bom.element.Transform.setStyle(parent,g);}
);qx.bom.Event.addNativeListener(v,n,function(){qx.bom.element.Transform.setStyle(parent,f);}
);}
}});}
)();
