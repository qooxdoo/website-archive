...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Scroll.5f19509b48ae.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="span",b="qx.module.Template";qx.Bootstrap.define(b,{statics:{get:function(e,f,d){var c=qx.bom.Template.get(e,f,d);c=qx.module.Template.__Dm(c);return qxWeb.$init([c],qxWeb);}
,render:function(h,i,g){return qx.bom.Template.render(h,i,g);}
,renderToNode:function(l,m,k){var j=qx.bom.Template.renderToNode(l,m,k);j=qx.module.Template.__Dm(j);return qxWeb.$init([j],qxWeb);}
,__Dm:function(n){if(qxWeb.isTextNode(n)){var o=document.createElement(a);o.appendChild(n);n=o;}
;return n;}
...
(function(){var a="#resetbutton",b="click",c="animationEnd",d="list-template",e=".list",f="scrolling",g="#startbutton",h="demobrowser.demo.animation.Scroll";qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var k={items:[]};for(var i=0;i<30;i++ ){k.items.push(i);}
;for(var j=0;j<5;j++ ){q.template.get(d,k).appendTo(document.body);}
;this.reset();q(a).on(b,this.reset,this);q(g).on(b,function(){q(e).addClass(f).setScrollTop(250,2000).once(c,function(){q(e).removeClass(f);}
);}
);}
