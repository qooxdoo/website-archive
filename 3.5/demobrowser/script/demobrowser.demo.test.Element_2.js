...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_2","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_2.f1d754c267be.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="text",b="backgroundColor",c="demobrowser.demo.test.Element_2",d="color",e="Show inner element",f="Internal move while hidden -> show again",g="fontSize",h="Create five elements (2 hidden)",i="el4_2",j="el2",k="Make complex hidden element visible",l="el4",m="Internal move while hidden",n="Create document",o="test",p="#ccc",q="20px",r="el5",s="red",t="el4_3",u="doc",v="Make simple hidden element visible",w="el3",x="el4_1",y="el1",z="id";qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);this.info(n);var A=new qx.html.Root(document.getElementById(o));A.setAttribute(z,u);this.info(h);var G=new qx.html.Element;G.setAttribute(z,y);var E=new qx.html.Element;E.setAttribute(z,j);var F=new qx.html.Element;F.setAttribute(z,w);var H=new qx.html.Element;H.setAttribute(z,l);var I=new qx.html.Element;I.setAttribute(z,r);A.add(G,E,F,H,I);E.exclude();H.exclude();qx.html.Element.flush();this.info(v);E.include();qx.html.Element.flush();this.info(k);var B=new qx.html.Element;B.setAttribute(z,x);var D=new qx.html.Element;D.setAttribute(z,i);D.setStyle(d,s);D.setAttribute(a,i);D.exclude();var C=new qx.html.Element;C.setAttribute(z,t);H.add(B,D,C);H.include();qx.html.Element.flush();this.info(e);D.include();qx.html.Element.flush();this.info(m);H.exclude();C.moveTo(0);H.remove(D);B.setStyle(g,q);B.setAttribute(a,x);H.setStyle(b,p);qx.html.Element.flush();this.info(f);H.include();qx.html.Element.flush();}
}});}
)();
