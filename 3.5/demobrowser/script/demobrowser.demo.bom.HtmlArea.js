...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea.8ed113b04233.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,this.__Nw);qx.dom.Element.insertBegin(ei,eh);return eh;}
,__NE:function(){var ep=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ep,{"marginRight":cA,"float":di});var er;var eq=qx.dom.Element.create(cN,{title:cQ});if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(eq,cx,dT);}
...
;}
,this.__Nw);qx.dom.Element.insertBegin(eq,ep);return ep;}
,__NG:function(){var ew=[{bold:{text:cO,image:dq,action:this.__Nw.setBold},italic:{text:u,image:dz,action:this.__Nw.setItalic},underline:{text:dI,image:w,action:this.__Nw.setUnderline},strikethrough:{text:dJ,image:cS,action:this.__Nw.setStrikeThrough},removeFormat:{text:cX,image:cH,action:this.__Nw.removeFormat}},{alignLeft:{text:K,image:dp,action:this.__Nw.setJustifyLeft},alignCenter:{text:dw,image:L,action:this.__Nw.setJustifyCenter},alignRight:{text:t,image:dl,action:this.__Nw.setJustifyRight},alignJustify:{text:O,image:dx,action:this.__Nw.setJustifyFull}},{fontFamily:{custom:this.__ND},fontSize:{custom:this.__NE},fontColor:{text:cJ,image:cL,action:this.__Nx},textBackgroundColor:{text:V,image:s,action:this.__Ny}},{indent:{text:m,image:C,action:this.__Nw.insertIndent},outdent:{text:dK,image:dH,action:this.__Nw.insertOutdent}},{insertImage:{text:dD,image:dg,action:this.__Nz},insertTable:{text:b,image:cF,action:this.__NA},insertLink:{text:X,image:de,action:this.__NB},insertHTML:{text:dR,image:Q,action:this.__NC},insertHR:{text:R,image:S,action:this.__Nw.insertHorizontalRuler}},{ol:{text:dm,image:B,action:this.__Nw.insertOrderedList},ul:{text:dO,image:T,action:this.__Nw.insertUnorderedList}},{undo:{text:dA,image:cG,action:this.__Nw.undo},redo:{text:dQ,image:dv,action:this.__Nw.redo}}];var ey,eC,ev,ez;for(var i=0,j=ew.length;i<j;i++ ){eC={};eC[cY]=i==j-1?dC:cA;eC[G]=di;ey=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ey,eC);for(var eA in ew[i]){var eB=ew[i][eA];if(eB.custom){ev=eB.custom.call(this);}
...
;qx.event.Registration.addListener(ev,cV,eB.action,this.__Nw);}
;qx.dom.Element.insertEnd(ev,ey);}
;qx.dom.Element.insertEnd(ey,this.__PO);}
;qx.dom.Element.insertEnd(qx.dom.Element.create(cT,{style:a}),this.__PO);}
}});}
)();
...
},properties:{contentType:{check:hV,init:ha},messengerMode:{check:gY,init:false},insertParagraphOnLinebreak:{check:gY,init:true},insertLinebreakOnCtrlEnter:{check:gY,init:true},postProcess:{check:t,nullable:true,init:null},useUndoRedo:{check:gY,init:true},nativeContextMenu:{check:gY,init:false},defaultFontFamily:{check:hV,init:fQ},defaultFontSize:{check:hW,init:4}},members:{__lm:null,__cT:false,__At:false,__Au:false,__Av:false,__Aw:false,__An:null,__Ax:null,__Ay:null,__Az:null,__qy:null,__Am:null,__AA:null,__AB:null,__AC:false,__AD:false,__AE:function(iH){if(qx.dom.Node.isElement(iH)&&qx.dom.Node.isNodeName(iH,p)){this.__lm=iH;}
;}
,_createAndAddIframe:function(iI){this.__qy=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__qy,iI);if((qx.core.Environment.get(eK)==gM)){qx.bom.element.Attribute.set(this.__qy,gR,fm);}
else {qx.bom.element.Style.set(this.__qy,hg,he);}
;qx.bom.element.Style.setStyles(this.__qy,{width:gq,height:gq});qx.dom.Element.insertBegin(this.__qy,this.__lm);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__qy);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__qy);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__qy,C,this._loaded,this);}
...
,__zX:fD,getIframeObject:function(){return this.__qy;}
...
;this.__cT=true;this.__An=js;js.setContentDocument(this._getIframeDocument());this.__AS();if((qx.core.Environment.get(eK)==P)){this.__zq();}
;this.fireEvent(gH);}
...
;}
,"default":(function(){}
)}),invalidateEditor:qx.core.Environment.select(eK,{"gecko":function(){this.__Au=false;this.__cT=false;this.__At=true;}
,"default":function(){}
}),__AK:qx.core.Environment.select(eK,{"gecko":function(){this.__AN();this.__zq();this.__An.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__Au=true;this.__cT=true;this.__At=false;this.fireEvent(gd);}
,"default":function(){}
...
catch(e){this.error(x+qx.bom.Iframe.queryCurrentUrl(this.__qy)+fe,e);this.fireDataEvent(fR,e);}
;}
;}
...
catch(jV){if(!this.__cT){this.error(m);this.fireDataEvent(fR,jV);}
...
;}
;this.__Bb();}
;break;case eM:this.__AU=false;return;};}
;}
...
,__Br:function(gc,ga,fX){try{var fW=this.__mm;var fV=false;var fY=this.__Bh.getRange();this.__mm.body.focus();if((qx.core.Environment.get(fd)==dX)){if(gc!=ds){fY.select();if(((fY.text)&&(fY.text.length>0))||((fY.length==1)&&(fY.item(0))&&(fY.item(0).tagName==eM))){fW=fY;}
else {fW=this.__mm;}
;}
...
else {this.__mm.body.focus();var gh=this.__Bh.getSelection();var gg=this.__Bs();if(gg&&gh&&gh.type!=eN){try{gg.pasteHTML(gj);gg.collapse(false);gg.select();gi=true;}
catch(e){}
;}
else {gi=false;}
;this.__Bh.resetSavedRange();return gi;}
;}
,"default":function(gl,gm){this.__mm.body.focus();return this.__mm.execCommand(gm.identifier,false,gl);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(fd,{"gecko":function(){var gu=this.__BG();var gy=this.__Bu(gu);var gq=this.__BE(gu);var gv=B+Date.parse(new Date());var gw=eS+Date.parse(new Date());var go=ff;var gs=fH+gv+ee;go+=gs;go+=eR+gw+ey+gy+eF;go+=gq+fI;this.__Bh.getCommandManager().addUndoStep(R,m,this.getCommandObject(R));this.execute(R,go);this.__Bv();qx.bom.element.Attribute.reset(this.__mm.getElementById(gv),U);var gt=this.__mm.getElementById(gw);if(gt.previousSibling.innerHTML==gs){var gn=this.__BF();var gr=this.__mm.createElement(eY);var gp=this.__mm.createAttribute(fy);gp.nodeValue=dA;gr.setAttributeNode(gp);var gx=this.__mm.createAttribute(dT);gx.nodeValue=o;gr.setAttributeNode(gx);gt.previousSibling.appendChild(gn);gt.previousSibling.appendChild(gr);}
...
;return false;}
,"default":function(){return false;}
}),__Bx:function(gU,gV){var gT=(qx.core.Environment.get(fd)==dX)?this.__Bh.getRange():this.__mm;return gT.execCommand(gV.identifier,false,gU);}
,__By:function(gY,ha){if((qx.core.Environment.get(fd)==dX)){var gX=this.__Bh.getFocusNode();this.__Bz(gX);}
;this.__mm.body.focus();var gW=this.__mm.execCommand(ha.identifier,false,gY);if((qx.core.Environment.get(fd)==du)){var gX=this.__Bh.getFocusNode();this.__Bz(gX.parentNode);}
;return gW;}
...
;}
,__BA:qx.core.Environment.select(fd,{"gecko":function(hs,hm){if(hs.src){this.__mm.execCommand(hm.identifier,false,hs.src);delete hs.src;var hf=this.__Bh.getSelection();if(hf){var he=hf.anchorNode;var hn=hf.anchorOffset;var hg=he.childNodes[hn-1];var hp;for(var hi in hs){hp=this.__mm.createAttribute(hi);hp.nodeValue=hs[hi];hg.setAttributeNode(hp);}
...
;var hq=this.__mm.createDocumentFragment();var hr;if(hl&&hd!=null){var hh=this.__BB(hd);hq.appendChild(hh.root);hr=hh.inline;}
else {hr=this.__mm.createElement(S);hq.appendChild(hr);}
;var ho=this.__mm.createTextNode(dA);hr.appendChild(ho);var hk=hg.parentNode;if(hg==hk.lastChild){hk.appendChild(hq);}
...
;hC+=f;return this.__mm.execCommand(dI,false,hC);}
else {return false;}
;}
}),__BB:function(hF){while(hF.firstChild&&hF.firstChild.nodeType==1){hF=hF.firstChild;}
;var hI=this.__BG(hF);var hM,hG,hK;var hE=dA;var parent=null;var hL=null;var hJ=hI.child;while(hJ){hL=this.__mm.createElement(hJ[ev]?dU:S);hG=this.__mm.createAttribute(V);hL.setAttributeNode(hG);for(var hH in hJ){if(hH!=en&&hH!=ev){hE+=hH+dP+hJ[hH]+ef;}
else if(hH==ev){hK=this.__mm.createAttribute(fr);hK.nodeValue=hJ[hH];hL.setAttributeNode(hK);}
;}
;hG.nodeValue=hE;if(parent!=null){parent.appendChild(hL);}
else {hM=hL;}
;parent=hL;hJ=hJ.child;hE=dA;}
;return {root:hM,inline:hL};}
,__BC:qx.core.Environment.select(fd,{"gecko|opera":function(hN,hR){var hU=this.__Bh.getSelection();var hP=this.__Bh.getRange();if(hU.isCollapsed){var hO=ec+( ++this.__Bk);var hV=this.__mm.createElement(dJ);var hQ=this.__mm.createAttribute(dy);var hS=this.__mm.createAttribute(U);var hT=this.__mm.createTextNode(hN);hS.nodeValue=hO;hV.setAttributeNode(hS);hQ.nodeValue=hN;hV.setAttributeNode(hQ);hV.appendChild(hT);hP.insertNode(hV);hP.selectNode(hV);hU.collapseToEnd();return true;}
else {return this.__mm.execCommand(hR.identifier,false,hN);}
;}
...
;return false;}
;}
,"default":function(ic,id){return this.__mm.execCommand(id.identifier,false,ic);}
...
;return im;}
,__BF:function(){var is=this.__mm.createDocumentFragment();var ix=this.__BG();var parent=is;var iv=ix.child;var it;var iw=false;while(iv){iw=iv[ev]!=null;it=this.__mm.createElement(iw?dU:S);parent.appendChild(it);for(var ir in iv){if(ir!=en&&ir!=ev){qx.bom.element.Style.set(it,ir,iv[ir]);}
;}
;if(iw){var iu=this.__mm.createAttribute(fr);iu.nodeValue=iv[ev];it.setAttributeNode(iu);}
...
;}
;}
;if((qx.core.Environment.get(fd)==dX)){this.__mm.body.focus();this.__Bh.getRange().select();return this.__mm.execCommand(fi,false,jm);}
...
;}
;}
;return this.__mm.execCommand(fi,false,jm);}
,__BM:qx.core.Environment.select(fd,{"mshtml":function(ju,jv){this.__mm.body.focus();return this.__mm.execCommand(eV,false,ju);}
,"gecko|opera":function(jw,jx){this.__mm.body.focus();return this.__mm.execCommand(fa,false,jw);}
,"webkit":function(jA,jB){var jC=this.__Bh.getSelection();var jz=this.__Bh.getRange();if(!jC||!jC.isCollapsed){this.__mm.body.focus();this.__mm.execCommand(eV,false,jA);if(jC){jC.collapseToEnd();}
;return true;}
...
;}
;jz.setStart(jC.anchorNode,jC.anchorNode.nodeValue.charAt(jE)==el?jE+1:jE);jz.setEnd(jC.anchorNode,jy);jC.addRange(jz);this.__mm.body.focus();this.__mm.execCommand(eV,false,jA);jC.collapseToEnd();return true;}
;}
}),__BN:function(jF,jG){jF=jF!=null&&typeof jF==dN?jF:D;qx.bom.element.Style.set(this.__mm.body,b,jF);return true;}
,__BO:function(jJ,jK){var jI,jH,jM;var jL=qx.bom.htmlarea.manager.Command;if(jJ==null){jI=null;}
else {jI=jJ[0];jH=jJ[1];jM=jJ[2];}
;if(jI==null||typeof jI!=dN){qx.bom.element.Style.set(this.__mm.body,fG,dA);qx.bom.element.Style.set(this.__mm.body,dS,dA);qx.bom.element.Style.set(this.__mm.body,z,dA);return true;}
...
;qx.bom.element.Style.set(this.__mm.body,fG,jI);qx.bom.element.Style.set(this.__mm.body,dS,jH);qx.bom.element.Style.set(this.__mm.body,z,jM);return true;}
,__BP:qx.core.Environment.select(fd,{"mshtml":function(jO,jP){var jN=this.__mm.body.createTextRange();jN.select();return true;}
...
;}
,__Cj:qx.core.Environment.select(bu,{"mshtml|webkit":function(bW){var bU=this.__mm.body.innerHTML;var bX=bW.content;this.__mm.body.innerHTML=bX;var bV=bW;bV.content=bU;this.__CD(bV);return true;}
,"default":function(cc){var cb=cc;var ca=qx.bom.element.Style;switch(cc.command){case P:cb.parameter=[ca.get(this.__mm.body,b)];break;case h:cb.parameter=[ca.get(this.__mm.body,C),ca.get(this.__mm.body,D),ca.get(this.__mm.body,I)];break;};this.__CD(cb);if(cc.command==V){if((qx.core.Environment.get(bu)==W)){var cd=o+this.__An.__hyperLinkId;var bY=this.__mm.getElementById(cd);if(bY){bY.parentNode.removeChild(bY);return true;}
else {return false;}
;}
;}
...
}),__Cp:function(){try{return this.__mm.execCommand(t,false,null);}
catch(e){return false;}
;}
...
;return cq;}
;}
,__Cq:qx.core.Environment.select(bu,{"mshtml|webkit":function(cu){var cs=this.__mm.body.innerHTML;var cv=cu.content;this.__mm.body.innerHTML=cv;var ct=cu;ct.content=cs;this.__CC(ct);return true;}
...
}),__Cy:function(){try{return this.__mm.execCommand(z,false,null);}
catch(e){return false;}
;}
...
;}
,__Cz:qx.core.Environment.select(bu,{"mshtml|webkit":function(cP,cR,cS){var cQ=this.getUndoRedoObject();cQ.commandObject=cS;cQ.command=cP;cQ.value=cR;cQ.actionType=bD;cQ.content=this.__mm.body.innerHTML;this.__CA(cQ);}
,"default":function(cX,cV,cW){if(this.__Bh==null){return;}
;var cT=this.getUndoRedoObject();cT.commandObject=cW;cT.command=cX;cT.value=cV;cT.actionType=bD;var cY=this.__Bh.getSelection();if(cW.customUndo){var cU=[];switch(cX){case P:cU.push(qx.bom.element.Style.get(this.__mm.body,b));break;case h:cU.push(qx.bom.element.Style.get(this.__mm.body,C),qx.bom.element.Style.get(this.__mm.body,D),qx.bom.element.Style.get(this.__mm.body,I));break;case V:if(cY&&!cY.isCollapsed){cT.actionType=r;}
...
,__CE:function(){if(!this.__Ch){this.__Ch=true;this.__Cg=true;if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){this.__Ci=this.__mm.body.innerHTML;}
;this.__CH();}
;}
...
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__mm.body,bw,this.__Cc);qx.event.Registration.removeListener(this.__mm,bv,this.__Cd);if((qx.core.Environment.get(bu)==Y)){qx.event.Registration.removeListener(this.__mm,d,this.__Ce);}
;}
catch(e){}
;this._disposeObjects(Q);this.__Bh=this.__BX=this.__BY=this._commands=this.__mm=null;this.__Cb=this.__Ca=null;}
});}
)();
