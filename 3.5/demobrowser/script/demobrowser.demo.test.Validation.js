...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Validation.d579c68bc729.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(y,{extend:qx.core.Object,properties:{name:{init:K,validate:r},age:{init:18,validate:qx.util.Validate.number()},gender:{init:q,validate:qx.util.Validate.inArray([q,v])}},members:{__RD:function(W){if(W.length<2){throw new qx.core.ValidationError(I+n+W+f);}
;}
}});}
)();
