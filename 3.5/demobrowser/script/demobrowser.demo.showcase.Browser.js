...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Browser.d7b44260eee6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__sY(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__sV.length>0){do {var Q=this.__sV[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__sV.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__sX(Q);G+=I;if(E&&this.__sV.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__sV.length>0);}
;}
,__sX:function(R){R.setVisibility(o);this.__sV.shift();this.fireDataEvent(m,R);}
,__sY:function(S){if(!S){return;}
;this.__sV.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__sW.length-1;i>=0;i-- ){var T=this.__sW[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__sW[W]!=undefined){throw new Error(v);}
;this.__sW[W]=X;}
...
;bf.setVisibility(y);}
;}
,__ta:false,_setAllowMenuOpenHover:function(bg){this.__ta=bg;}
,_isAllowMenuOpenHover:function(){return this.__ta;}
...
(function(){var a="blur",b="mousedown",c="Enter",d="__lj",f="Escape",g="Space",h="keydown",j="Left",k="Down",l="Up",m="singleton",n="mousewheel",o="interval",p="keyup",q="event.touch",r="Object is no menu: ",s="qx.ui.menu.Manager",t="__sH",u="keypress",v="Right",w="__sG",x="qx.debug";qx.Class.define(s,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__lj=[];var y=document.body;var z=qx.event.Registration;z.addListener(window.document.documentElement,b,this._onMouseDown,this,true);z.addListener(y,n,this._onMouseWheel,this,true);z.addListener(y,h,this._onKeyUpDown,this,true);z.addListener(y,p,this._onKeyUpDown,this,true);z.addListener(y,u,this._onKeyPress,this,true);if(!qx.core.Environment.get(q)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__sG=new qx.event.Timer;this.__sG.addListener(o,this._onOpenInterval,this);this.__sH=new qx.event.Timer;this.__sH.addListener(o,this._onCloseInterval,this);}
,members:{__sI:null,__sJ:null,__sG:null,__sH:null,__lj:null,_getChild:function(A,C,B,F){var E=A.getChildren();var length=E.length;var D;for(var i=C;i<length&&i>=0;i+=B){D=E[i];if(D.isEnabled()&&!D.isAnonymous()&&D.isVisible()){return D;}
;}
...
,scheduleOpen:function(Q){this.cancelClose(Q);if(Q.isVisible()){if(this.__sI){this.cancelOpen(this.__sI);}
;}
else if(this.__sI!=Q){this.__sI=Q;this.__sG.restartWith(Q.getOpenInterval());}
;}
,scheduleClose:function(R){this.cancelOpen(R);if(!R.isVisible()){if(this.__sJ){this.cancelClose(this.__sJ);}
;}
else if(this.__sJ!=R){this.__sJ=R;this.__sH.restartWith(R.getCloseInterval());}
;}
,cancelOpen:function(S){if(this.__sI==S){this.__sG.stop();this.__sI=null;}
;}
,cancelClose:function(T){if(this.__sJ==T){this.__sH.stop();this.__sJ=null;}
;}
...
;}
,__sK:{"Enter":1,"Space":1},__ph:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var V=this.getActiveMenu();if(!V){return;}
;var W=e.getKeyIdentifier();if(this.__ph[W]||(this.__sK[W]&&V.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var ba=this.getActiveMenu();if(!ba){return;}
;var X=e.getKeyIdentifier();var bc=this.__ph[X];var Y=this.__sK[X];if(bc){switch(X){case l:this._onKeyPressUp(ba);break;case k:this._onKeyPressDown(ba);break;case j:this._onKeyPressLeft(ba);break;case v:this._onKeyPressRight(ba);break;case f:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
...
,openAtPoint:function(G){this.placeToPoint(G);this.__sO();this.show();this._placementTarget=G;}
...
;this.__sN();}
,__sN:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__sO:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(o,this.__sO,this);return;}
...
;this.__sM=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__sM){this.__sM.call(this);delete this.__sM;}
;}
...
;this.__sO();}
;}
,_onMouseOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__sL=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__sL){bt.cancelOpen(this.__sL);this.__sL=null;}
;}
;}
...
;if(this.__sL){bw.cancelOpen(this.__sL);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__sP:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__sP=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
;var x=this.__sQ(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__sQ:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
,__tb:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
...
;this._getIframeElement().addListener(h,this.__wr,this);}
...
,__wr:function(e){var r=e.getData();if(r){this.setSource(r);}
;this.fireDataEvent(h,r);}
}});}
)();
(function(){var a="__wv",b="no",c="mousedown",d="Boolean",f="px",g="event.help",h="gecko",i="auto",j="_applyScrollbar",k="Unable to set 'nativeHelp' property, possibly due to security restrictions",l="qx.debug",m="DOMNodeInserted",n="load",o="_applyNativeHelp",p="yes",q="scrolling",r="/",s="help",t="appear",u="engine.name",v="mouseup",w="block",x="qx.ui.embed.Iframe",y="losecapture",z="contextmenu",A="none",B="iframe",C="display";qx.Class.define(x,{extend:qx.ui.embed.AbstractIframe,construct:function(D){if(D!=null){this.__wu=D;}
;qx.ui.embed.AbstractIframe.call(this,D);qx.event.Registration.addListener(document.body,c,this.block,this,true);qx.event.Registration.addListener(document.body,v,this.release,this,true);qx.event.Registration.addListener(document.body,y,this.release,this,true);this.__wv=this._createBlockerElement();if((qx.core.Environment.get(u)==h)){this.addListenerOnce(t,function(e){var E=this.getContentElement().getDomElement();qx.bom.Event.addNativeListener(E,m,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:B},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:d,init:false,apply:o},scrollbar:{check:[i,b,p],nullable:true,themeable:true,apply:j}},members:{__wu:null,__wv:null,renderLayout:function(J,top,H,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,J,top,H,F);var I=f;var G=this.getInsets();this.__wv.setStyles({"left":(J+G.left)+I,"top":(top+G.top)+I,"width":(H-G.left-G.right)+I,"height":(F-G.top-G.bottom)+I});}
,_createContentElement:function(){var K=new qx.html.Iframe(this.__wu);K.addListener(n,this._onIframeLoad,this);return K;}
...
,block:function(){this.__wv.setStyle(C,w);}
,release:function(){this.__wv.setStyle(C,A);}
...
,_applyNativeHelp:function(R,Q){if(qx.core.Environment.get(g)){var document=this.getDocument();if(!document){return;}
...
,setLayoutParent:function(parent){qx.ui.embed.AbstractIframe.prototype.setLayoutParent.call(this,parent);if(parent){this.getLayoutParent().getContentElement().add(this.__wv);}
;}
},destruct:function(){if(this.getLayoutParent()&&this.__wv.getParent()){this.getLayoutParent().getContentElement().remove(this.__wv);}
;this._disposeObjects(a);qx.event.Registration.removeListener(document.body,c,this.block,this,true);qx.event.Registration.removeListener(document.body,v,this.release,this,true);qx.event.Registration.removeListener(document.body,y,this.release,this,true);}
});}
)();
(function(){var a="source",b="element",c="name",d="qx.event.type.Event",f="iframe",g="qx.html.Iframe",h="navigate",i="qx.event.type.Data";qx.Class.define(g,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,f,k,l);this.setSource(j);this.addListener(h,this.__wr,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(b);}
...
;}
,__wr:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
