...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.02557d020ece.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<em>no content</em>",b="Memory Storage",c="click",d="html.storage.userdata",e="",f="list",g="save",h="value",i="Web Storage",j="demobrowser.demo.bom.Storage",k="<br>",l="userData Storage",m="clear",n="html.storage.local",o=":",p="using",q="remove",r="key";qx.Class.define(j,{extend:qx.application.Native,members:{__fn:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__fn=qx.bom.Storage.getLocal();var u=document.getElementById(g);var s=document.getElementById(m);var t=document.getElementById(q);var self=this;qx.bom.Event.addNativeListener(u,c,function(){var v=qx.bom.Input.getValue(document.getElementById(r));var w=qx.bom.Input.getValue(document.getElementById(h));self.__fn.setItem(v,w);self.updateList();}
);qx.bom.Event.addNativeListener(s,c,function(){self.__fn.clear();self.updateList();}
);qx.bom.Event.addNativeListener(t,c,function(){self.__fn.removeItem(self.__fn.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var x=document.getElementById(f);x.innerHTML=e;this.__fn.forEach(function(y,z){x.innerHTML+=y+o+z+k;}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__CK:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__CL:null,__CM:null,getLocal:function(){if(this.__CL){return this.__CL;}
;return this.__CL=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__CM){return this.__CM;}
;return this.__CM=new qx.bom.storage.Web(b);}
},construct:function(g){this.__nC=g;}
,members:{__nC:null,getStorage:function(){return window[this.__nC+c];}
,getLength:function(){return this.getStorage(this.__nC).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__nC).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__nC).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__nC).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__nC);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__nC).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__CL:null,__CM:null,__ci:0,getLocal:function(){if(this.__CL){return this.__CL;}
;return this.__CL=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__CM){return this.__CM;}
;return this.__CM=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__CN=document.createElement(f);this.__CN.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__CN);this.__CN.addBehavior(j);this.__CO=m;this.__CN.load(this.__CO);this.__fn={};this.__CP={};var l=this.__CN.getAttribute(d+qx.bom.storage.UserData.__ci);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fn[l.key]=l.value;this.__CP[l.key]=d+qx.bom.storage.UserData.__ci;qx.bom.storage.UserData.__ci++ ;l=this.__CN.getAttribute(d+qx.bom.storage.UserData.__ci);}
;}
,members:{__CN:null,__CO:h,__fn:null,__CP:null,getStorage:function(){return this.__fn;}
,getLength:function(){return Object.keys(this.__fn).length;}
,setItem:function(n,p){if(this.__CP[n]){var o=this.__CP[n];}
else {var o=d+qx.bom.storage.UserData.__ci;qx.bom.storage.UserData.__ci++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__CN.setAttribute(o,q);this.__CN.save(this.__CO);this.__fn[n]=p;this.__CP[n]=o;}
,getItem:function(r){return this.__fn[r]||null;}
,removeItem:function(v){var u=this.__CP[v];if(u==undefined){return;}
;this.__CN.removeAttribute(u);qx.bom.storage.UserData.__ci-- ;delete this.__fn[v];delete this.__CP[v];var t=d+qx.bom.storage.UserData.__ci;if(this.__CN.getAttribute(t)){var w=this.__CN.getAttribute(d+qx.bom.storage.UserData.__ci);this.__CN.removeAttribute(t);this.__CN.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__CP[s]=u;}
;this.__CN.save(this.__CO);}
,clear:function(){for(var x in this.__CP){this.__CN.removeAttribute(this.__CP[x]);}
;this.__CN.save(this.__CO);this.__fn={};this.__CP={};}
,getKey:function(y){return Object.keys(this.__fn)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__CL:null,__CM:null,getLocal:function(){if(this.__CL){return this.__CL;}
;return this.__CL=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__CM){return this.__CM;}
;return this.__CM=new qx.bom.storage.Memory();}
},construct:function(){this.__fn={};}
,members:{__fn:null,getStorage:function(){return this.__fn;}
,getLength:function(){return Object.keys(this.__fn).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__fn[b]=c;}
,getItem:function(e){var d=this.__fn[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__fn[f];}
,clear:function(){this.__fn={};}
,getKey:function(h){var g=Object.keys(this.__fn);return g[h];}
