...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.77fec5535ac4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Boolean",b="one",c="selected",d="_applySpacing",f="qx.event.type.Data",g="Integer",h="_applyDragSelection",k="changeSelection",m="String",n="resize",o="demobrowser.demo.virtual.list.List",p="list",q="multi",r="row",s="_applyQuickSelection",t="single",u="_applyItemHeight",v="_applySelectionMode",w="additive",x="changeName",y="Number",z="addItem",A="removeItem",B="changeHeight",C=",";qx.Class.define(o,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__RE=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__RE);this.getPane().addListener(n,this._onResize,this);this.__rB=[];this.__cL=[];this.__uN=new qx.ui.virtual.selection.Row(this.getPane());this.__uN.addListener(k,this._onChangeSelection,this);this.__uN.attachMouseEvents();this.__uN.attachKeyEvents(this);this.__uN.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:f,removeItem:f,changeValue:f,changeSelection:f},properties:{appearance:{refine:true,init:p},focusable:{refine:true,init:true},spacing:{check:g,init:0,apply:d,themeable:true},enableInlineFind:{check:a,init:true},name:{check:m,nullable:true,event:x},itemHeight:{init:24,themeable:true,check:y,apply:u},selectionMode:{check:[t,q,w,b],init:t,apply:v},dragSelection:{check:a,init:false,apply:h},quickSelection:{check:a,init:false,apply:s}},members:{__rB:null,__cL:null,__uN:null,__RE:null,syncWidget:function(){this.update();}
,update:function(){var D=this.getPane().getRowConfig();D.setItemCount(this.__rB.length);D.resetItemSizes();for(var i=0;i<this.__rB.length;i++ ){var E=this.__rB[i].getHeight();if(E!==null){D.setItemSize(i,E);}
;}
;}
,updateSelection:function(){var F=this.__RE.getChildren();for(var i=0;i<F.length;i++ ){var G=F[i];var H=G.getUserData(r);if(this.__uN.isItemSelected(H)){G.addState(c);}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(k,this.__RI(e.getData()));}
,getCellWidget:function(L,I){var K=this.__rB[L];if(!K){return null;}
;var J=this.__cL.pop()||new qx.ui.form.ListItem();J.set({label:K.getLabel(),icon:K.getIcon()});if(this.__uN.isItemSelected(L)){J.addState(c);}
else {J.removeState(c);}
;J.setUserData(r,L);return J;}
,poolCellWidget:function(M){this.__cL.push(M);}
...
;this.setSelection(S);}
,getChildren:function(){return this.__rB;}
,hasChildren:function(){return this.__rB.length>0;}
...
,add:function(W){this.__rB.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__rB,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__rB.length;i<j;i++ ){this._removeHelper(this.__rB[i]);}
;this.__rB=[];}
,indexOf:function(Y){return this.__rB.indexOf(Y);}
,addAt:function(bb,ba){qx.lang.Array.insertAt(this.__rB,bb,ba);this._addHelper(bb);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__rB,bc,bd);this._addHelper(bc);}
,addAfter:function(bf,be){qx.lang.Array.insertAfter(this.__rB,bf,be);this._addHelper(bf);}
,removeAt:function(bg){this.__rB.splice(bg,1);this._removeHelper(this.__rB[bg]);}
,__RF:function(bh){var bi=this.__rB.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__RG:function(bk){var bj=this.__rB[bk];return bj;}
,__RH:function(bl){var bm=[];for(var i=0;i<bl.length;i++ ){bm.push(this.__RF(bl[i]));}
;return bm;}
,__RI:function(bo){var bn=[];for(var i=0;i<bo.length;i++ ){bn.push(this.__rB[bo[i]]);}
;return bn;}
,selectAll:function(){this.__uN.selectAll();}
,setSelected:function(bp){this.__uN.selectItem(this.__RF(bp));}
,isSelected:function(bq){return this.__uN.isItemSelected(this.__RF(bq));}
,addToSelection:function(br){this.__uN.addItem(this.__RF(br));}
,removeFromSelection:function(bs){this.__uN.removeItem(this.__RF(bs));}
,selectRange:function(bt,bu){this.__uN.selectItemRange(this.__RF(bt),this.__RF(bu));}
,resetSelection:function(){this.__uN.clearSelection();}
,setSelection:function(bv){this.__uN.replaceSelection(this.__RH(bv));}
,getSelectedItem:function(){return this.__rB[this.getSelected()];}
,getSelected:function(){return this.__rB[this.__uN.getSelectedItem()];}
,getSelection:function(){return this.__RI(this.__uN.getSelection());}
,getSortedSelection:function(){return this.__RI(this.__uN.getSortedSelection());}
,isSelectionEmpty:function(){return this.__uN.isSelectionEmpty();}
,getSelectionContext:function(){return this.__uN.getSelectionContext();}
,getSelectables:function(){return this.__RI(this.__uN.getSelectables());}
,_applySelectionMode:function(bx,bw){this.__uN.setMode(bx);}
,_applyDragSelection:function(bz,by){this.__uN.setDrag(bz);}
,_applyQuickSelection:function(bB,bA){this.__uN.setQuick(bB);}
}});}
)();
