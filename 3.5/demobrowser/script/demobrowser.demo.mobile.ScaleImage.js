...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.3c55ad2dcd05.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(x);var D={"width":j,"height":v,"position":C,"left":s,"top":s,"background":d+G+f};this.__zT=new qx.html.Element(h,D);this.__zT.addListener(a,this.__hQ,this);this.__zT.addListener(p,this.__hR,this);F.add(this.__zT);}
,__hQ:function(e){if(e.isMultiTouch()){this.__Ke=e.getRotation()+this.__Kd;this.__Kf=e.getScale()*this.__Kc;this.__zT.setStyle(o,z+this.__Ke+i+this.__Kf+f);}
...
;e.preventDefault();}
,__hR:function(e){if(e.isMultiTouch()){this.__Kd=this.__Ke;this.__Kc=this.__Kf;}
;}
}});}
)();
