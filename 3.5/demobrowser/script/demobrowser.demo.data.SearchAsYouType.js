...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.10ab7e87f373.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__Ji=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__rW=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__rW:null,__Ji:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__rW!=null){i.stop(this.__rW);this.__rW=null;}
;this.__rW=i.start(function(){this.__Ji.update();this.__rW=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__Ji=null;}
});}
)();
