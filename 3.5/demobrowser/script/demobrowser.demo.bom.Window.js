...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.cebb5f87fe7c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="click",c="Open Native Modal Window",d="demobrowser.demo.bom.Window",f="Modal Window closed?",g="http://sourceforge.net",h="window1",i="window3",j="http://slashdot.org",k="Window closed?",l="http://qooxdoo.org",m="demobrowser/demo/html/ModalWindow.html",n="Open Faked Native Modal Window",o="window2",p="#eee",q="button";qx.Class.define(d,{extend:qx.application.Native,members:{__su:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__su=[l,g,j,r.toUri(m)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,b,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__su[0],h,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,c);document.body.appendChild(s);qx.event.Registration.addListener(s,b,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__su[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,b,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(p);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__su[0],i,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__lH:null,__IO:null,__js:null,__IP:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__IQ:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__IR:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__IS(H,E&&A);if(E){if(this.__IR()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__js==null){this.__js=new qx.event.Timer(500);this.__js.addListener(f,this.__IT,this);}
;this.__IO=window.open(z,name,G);this.__js.restart();C=this.__IO;}
;}
...
;return C;}
,__IS:function(K,O){var M;var J;var N=[];if(O&&this.__IR()){for(var L in K){if(qx.bom.Window.__IP[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__IP[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__IQ[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__IT:function(){if(this.isClosed(this.__IO)){this.getBlocker().unblock();this.__js.stop();}
;}
