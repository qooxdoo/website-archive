...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer.564b4249a5bc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__HH:function(X,top,W,Y,U){var V=[q,W,r,top,y];Y.createDataCellHtml(U,V);V.push(a);X.innerHTML+=V.join(v);}
,testDefaultRenderer:function(bc){var bd=100;var ba={value:[null,K,32,new Date()],styleLeft:[0],styleWidth:[bd],styleHeight:[20],style:[v]};var bb=this._getNewTableDiv(bd);var top=0;qx.util.Permutation.permute(ba,function(be){this.__HH(bb,top,bd,bc,be);top+=20;}
,this);}
,testBooleanRenderer:function(){var bi=70;var bh=30;var bj=new qx.ui.table.cellrenderer.Boolean();var bf={value:[null,true,false],styleLeft:[0],styleWidth:[bi],styleHeight:[bh],style:[v]};var bg=this._getNewTableDiv(bi);var top=0;qx.util.Permutation.permute(bf,function(bk){this.__HH(bg,top,bi,bj,bk);top+=bh;}
,this);bj.setIconFalse(M);bj.setIconTrue(N);qx.util.Permutation.permute(bf,function(bl){this.__HH(bg,top,bi,bj,bl);top+=bh;}
,this);}
,testDateRenderer:function(){var bn=180;var bq=new qx.ui.table.cellrenderer.Date();var bm={value:new Date(),styleLeft:[0],styleWidth:[bn],styleHeight:[20],style:[v]};var bp=qx.util.format.DateFormat;var br=[bp.getDateTimeInstance(),bp.getDateInstance()];var bs=this._getNewTableDiv(bn);var top=0;for(var i=0;i<br.length;i++ ){var bo=br[i];bq.setDateFormat(bo);this.__HH(bs,top,bn,bq,bm);top+=20;}
;}
,testNumberRenderer:function(){var bx=new qx.ui.table.cellrenderer.Number();var bw=100;var bt={value:Math.PI,styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[v]};var bv=qx.util.format.NumberFormat;var by=[new bv().set({maximumFractionDigits:0}),new bv().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:g})];var bz=this._getNewTableDiv(bw);var top=0;for(var i=0;i<by.length;i++ ){var bu=by[i];bx.setNumberFormat(bu);this.__HH(bz,top,bw,bx,bt);top+=20;}
;}
,testImageRenderer:function(){var bC=new qx.ui.table.cellrenderer.Image();var bD=50;var bA={value:[null,s,E,u,d,f],styleLeft:[0],styleWidth:[bD],styleHeight:[20],style:[v],tooltip:[v,J]};var bB=this._getNewTableDiv(bD);var top=0;qx.util.Permutation.permute(bA,function(bE){this.__HH(bB,top,bD,bC,bE);top+=20;}
,this);}
,testStringRenderer:function(){var bJ=new qx.ui.table.cellrenderer.String();var bI=100;var bH=20;var bF={value:[null,l,t],styleLeft:[0],styleWidth:[bI],styleHeight:[bH],style:[v]};var bG=this._getNewTableDiv(bI);var top=0;qx.util.Permutation.permute(bF,function(bK){this.__HH(bG,top,bI,bJ,bK);top+=20;}
,this);}
,testPasswordRenderer:function(){var bP=new qx.ui.table.cellrenderer.Password();var bO=100;var bN=20;var bL={value:[null,l,t],styleLeft:[0],styleWidth:[bO],styleHeight:[bN],style:[v]};var bM=this._getNewTableDiv(bO);var top=0;qx.util.Permutation.permute(bL,function(bQ){this.__HH(bM,top,bO,bP,bQ);top+=20;}
,this);}
,testHtmlRenderer:function(){var bV=new qx.ui.table.cellrenderer.Html();var bU=100;var bT=50;var bR={value:[null,D,A,n],styleLeft:[0],styleWidth:[bU],styleHeight:[bT],style:[v]};var bS=this._getNewTableDiv(bU);var top=0;qx.util.Permutation.permute(bR,function(bW){this.__HH(bS,top,bU,bV,bW);top+=20;}
,this);}
,testConditionalRenderer:function(){var cc=new qx.ui.table.cellrenderer.Conditional();cc.addNumericCondition(p,0,null,L,null,null);cc.addNumericCondition(P,100,O,null,null,null);cc.addBetweenCondition(o,0,2,null,null,null,I,null);cc.addRegex(B,null,null,I,j);var cb=100;var ca=20;var bX={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[cb],table:[this.tableMock],styleHeight:[ca],style:[v]};var bY=this._getNewTableDiv(cb);var top=0;qx.util.Permutation.permute(bX,function(cd){this.__HH(bY,top,cb,cc,cd);top+=20;}
,this);}
...
);var ch=100;var cg=20;var ce={value:[null,K,new Date(),30,s,false],styleLeft:[0],styleWidth:[ch],styleHeight:[cg],table:[this.tableMock],style:[v]};var cf=this._getNewTableDiv(ch);var top=0;qx.util.Permutation.permute(ce,function(cm){this.__HH(cf,top,ch,ci,cm);top+=20;}
,this);}
,testReplaceRenderer:function(){var cs=new qx.ui.table.cellrenderer.Replace();cs.setReplaceMap({'1':Q,'2':k,'3':c});cs.addReversedReplaceMap();var cq=100;var cp=20;var cn={value:[1,2,3],styleLeft:[0],styleWidth:[cq],table:[this.tableMock],styleHeight:[cp],style:[v]};var co=this._getNewTableDiv(cq);var top=0;qx.util.Permutation.permute(cn,function(ct){this.__HH(co,top,cq,cs,ct);top+=20;}
,this);}
...
(function(){var a="qx.dyntheme",b="_applyIconTrue",c="decoration/table/boolean-true.png",d="qx.ui.table.cellrenderer.Boolean",e=";padding-top:4px;",f="decoration/table/boolean-false.png",g="_applyIconFalse",h="changeTheme",i="String";qx.Class.define(d,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(){qx.ui.table.cellrenderer.AbstractImage.call(this);this.__Fa=qx.util.AliasManager.getInstance();this.initIconTrue();this.initIconFalse();if(qx.core.Environment.get(a)){qx.theme.manager.Appearance.getInstance().addListener(h,this._onChangeTheme,this);}
;}
,properties:{iconTrue:{check:i,init:c,apply:b},iconFalse:{check:i,init:f,apply:g}},members:{__Ht:null,__Hu:false,__Fa:null,_onChangeTheme:qx.core.Environment.select(a,{"true":function(){this._applyIconTrue(this.getIconTrue());this._applyIconFalse(this.getIconFalse());}
,"false":null}),_applyIconTrue:function(j){this.__Ht=this.__Fa.resolve(j);}
,_applyIconFalse:function(k){this.__Hu=this.__Fa.resolve(k);}
,_insetY:5,_getCellStyle:function(l){return qx.ui.table.cellrenderer.AbstractImage.prototype._getCellStyle.call(this,l)+e;}
,_identifyImage:function(m){var n={imageWidth:11,imageHeight:11};switch(m.value){case true:n.url=this.__Ht;break;case false:n.url=this.__Hu;break;default:n.url=null;break;};return n;}
},destruct:function(){this.__Fa=null;if(qx.core.Environment.get(a)){qx.theme.manager.Appearance.getInstance().removeListener(h,this._onChangeTheme,this);}
;}
});}
)();
(function(){var a="regex cannot be null!",b="font-weight",c="==",d="Condition not recognized or value1/value2 is null!",e="Condition not recognized or value is null!",f="",g=">",h="text-align",j="between",k="<",l=";",m='g',n="regex",o=":",p="qx.ui.table.cellrenderer.Conditional",q="!between",r=">=",s="color",t="font-style",u="!=",v="<=";qx.Class.define(p,{extend:qx.ui.table.cellrenderer.Default,construct:function(y,w,x,z){qx.ui.table.cellrenderer.Default.call(this);this.numericAllowed=[c,u,g,k,r,v];this.betweenAllowed=[j,q];this.conditions=[];this.__wc=y||f;this.__wd=w||f;this.__we=x||f;this.__wf=z||f;}
,members:{__wc:null,__wd:null,__we:null,__wf:null,__wg:function(B,A){if(B[1]!=null){A[h]=B[1];}
;if(B[2]!=null){A[s]=B[2];}
;if(B[3]!=null){A[t]=B[3];}
;if(B[4]!=null){A[b]=B[4];}
;}
...
;}
,_getCellStyle:function(bi){var bf=bi.table.getTableModel();var i;var be;var bb;var bd={"text-align":this.__wc,"color":this.__wd,"font-style":this.__we,"font-weight":this.__wf};for(i in this.conditions){be=false;if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){bb=bi.value;}
...
;if(be==true){this.__wg(this.conditions[i],bd);}
;}
...
(function(){var a="qx.ui.table.cellrenderer.Image",b="";qx.Class.define(a,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__yF=c;}
;if(d){this.__yG=d;}
;this.__vU=qx.util.AliasManager.getInstance();}
,members:{__vU:null,__yG:16,__yF:16,_identifyImage:function(e){var f={imageWidth:this.__yF,imageHeight:this.__yG};if(e.value==b){f.url=null;}
else {f.url=this.__vU.resolve(e.value);}
