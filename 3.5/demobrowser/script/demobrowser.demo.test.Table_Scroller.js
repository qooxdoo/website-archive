...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_Scroller.6438638ce6c5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="__vr",b="mousedown",c="Boolean",d="__vq",g="scroll",h="focus-indicator",i="mouseout",j="changeHorizontalScrollBarVisible",k="excluded",l="bottom",m="_applyScrollTimeout",n="changeScrollX",o="_applyTablePaneModel",p="Integer",q="scrollbar-y",r="qx.event.type.Data",s="dblclick",t="dataEdited",u="mousewheel",v="interval",w="qx.ui.table.pane.Scroller",y="__vm",z="table-scroller-focus-indicator",A="_headerClipper",B="visible",C="mousemove",D="resize-line",E="_applyShowCellFocusIndicator",F="y",G="header",H="resize",I="vertical",J="__vo",K="__js",L="changeScrollY",M="__vp",N="editing",O="appear",P="__vl",Q="click",R="__vn",S="modelChanged",T="table-scroller",U="beforeSort",V="scrollbar-x",W="cellDblclick",X="mouseup",Y="horizontal",bx="__my",by="cellClick",bz="losecapture",bt="contextmenu",bu="col-resize",bv="disappear",bw="_applyVerticalScrollBarVisible",bD="_applyHorizontalScrollBarVisible",bE="os.scrollBarOverlayed",bF="pane",bH="cellContextmenu",bA="close",bB="changeTablePaneModel",bC="x",br="qx.ui.table.pane.Model",bG="qx.ui.table.pane.CellEvent",bs="changeVerticalScrollBarVisible";qx.Class.define(w,{extend:qx.ui.core.Widget,include:[qx.ui.core.scroll.MScrollBarFactory],construct:function(bI){qx.ui.core.Widget.call(this);this.__uo=bI;var bJ=new qx.ui.layout.Grid();bJ.setColumnFlex(0,1);bJ.setRowFlex(1,1);this._setLayout(bJ);this.__my=this._showChildControl(G);this.__vl=this._showChildControl(bF);this.__vm=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({minWidth:0});this._add(this.__vm,{row:0,column:0,colSpan:2});this._headerClipper=new qx.ui.table.pane.Clipper();this._headerClipper.add(this.__my);this._headerClipper.addListener(bz,this._onChangeCaptureHeader,this);this._headerClipper.addListener(C,this._onMousemoveHeader,this);this._headerClipper.addListener(b,this._onMousedownHeader,this);this._headerClipper.addListener(X,this._onMouseupHeader,this);this._headerClipper.addListener(Q,this._onClickHeader,this);this.__vm.add(this._headerClipper,{flex:1});this.__vn=new qx.ui.table.pane.Clipper();this.__vn.add(this.__vl);this.__vn.addListener(u,this._onMousewheel,this);this.__vn.addListener(C,this._onMousemovePane,this);this.__vn.addListener(b,this._onMousedownPane,this);this.__vn.addListener(X,this._onMouseupPane,this);this.__vn.addListener(Q,this._onClickPane,this);this.__vn.addListener(bt,this._onContextMenu,this);this.__vn.addListener(s,this._onDblclickPane,this);this.__vn.addListener(H,this._onResizePane,this);if(qx.core.Environment.get(bE)){this.__vo=new qx.ui.container.Composite();this.__vo.setLayout(new qx.ui.layout.Canvas());this.__vo.add(this.__vn,{edge:0});this._add(this.__vo,{row:1,column:0});}
else {this._add(this.__vn,{row:1,column:0});}
;this.__vp=this._showChildControl(V);this.__vq=this._showChildControl(q);this.__vr=this.getChildControl(h);this.initShowCellFocusIndicator();this.getChildControl(D).hide();this.addListener(i,this._onMouseout,this);this.addListener(O,this._onAppear,this);this.addListener(bv,this._onDisappear,this);this.__js=new qx.event.Timer();this.__js.addListener(v,this._oninterval,this);this.initScrollTimeout();}
,statics:{MIN_COLUMN_WIDTH:10,RESIZE_REGION_RADIUS:5,CLICK_TOLERANCE:5,HORIZONTAL_SCROLLBAR:1,VERTICAL_SCROLLBAR:2},events:{"changeScrollY":r,"changeScrollX":r,"cellClick":bG,"cellDblclick":bG,"cellContextmenu":bG,"beforeSort":r},properties:{horizontalScrollBarVisible:{check:c,init:false,apply:bD,event:j},verticalScrollBarVisible:{check:c,init:false,apply:bw,event:bs},tablePaneModel:{check:br,apply:o,event:bB},liveResize:{check:c,init:false},focusCellOnMouseMove:{check:c,init:false},selectBeforeFocus:{check:c,init:false},showCellFocusIndicator:{check:c,init:true,apply:E},contextMenuFromDataCellsOnly:{check:c,init:true},resetSelectionOnHeaderClick:{check:c,init:true},scrollTimeout:{check:p,init:100,apply:m},appearance:{refine:true,init:T}},members:{__uS:null,__uo:null,__vs:null,__vt:null,__vu:null,_moveColumn:null,__vv:null,_lastMoveTargetX:null,_lastMoveTargetScroller:null,__vw:null,__vx:null,__vy:null,__vz:null,__vA:null,__vB:false,__vC:null,__vD:null,__vE:null,__uO:null,__uP:null,__vF:null,__vG:null,__vH:null,__vp:null,__vq:null,__my:null,_headerClipper:null,__vl:null,__vn:null,__vo:null,__vr:null,__vm:null,__js:null,getPaneInsetRight:function(){var bM=this.getTopRightWidget();var bN=bM&&bM.isVisible()&&bM.getBounds()?bM.getBounds().width+bM.getMarginLeft()+bM.getMarginRight():0;var bL=this.__vq;var bK=this.getVerticalScrollBarVisible()?this.getVerticalScrollBarWidth()+bL.getMarginLeft()+bL.getMarginRight():0;return Math.max(bN,bK);}
,setPaneWidth:function(bO){if(this.isVerticalScrollBarVisible()){bO+=this.getPaneInsetRight();}
;this.setWidth(bO);}
,_createChildControlImpl:function(bR,bQ){var bP;switch(bR){case G:bP=(this.getTable().getNewTablePaneHeader())(this);break;case bF:bP=(this.getTable().getNewTablePane())(this);break;case h:bP=new qx.ui.table.pane.FocusIndicator(this);bP.setUserBounds(0,0,0,0);bP.setZIndex(1000);bP.addListener(X,this._onMouseupFocusIndicator,this);this.__vn.add(bP);bP.show();bP.setDecorator(null);break;case D:bP=new qx.ui.core.Widget();bP.setUserBounds(0,0,0,0);bP.setZIndex(1000);this.__vn.add(bP);break;case V:bP=this._createScrollBar(Y).set({alignY:l});bP.addListener(g,this._onScrollX,this);if(this.__vo!=null){bP.setMinHeight(qx.ui.core.scroll.AbstractScrollArea.DEFAULT_SCROLLBAR_WIDTH);this.__vo.add(bP,{bottom:0,right:0,left:0});}
else {this._add(bP,{row:2,column:0});}
;break;case q:bP=this._createScrollBar(I);bP.addListener(g,this._onScrollY,this);if(this.__vo!=null){this.__vo.add(bP,{right:0,bottom:0,top:0});}
else {this._add(bP,{row:1,column:1});}
;break;};return bP||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bR);}
,_applyHorizontalScrollBarVisible:function(bT,bS){this.__vp.setVisibility(bT?B:k);}
,_applyVerticalScrollBarVisible:function(bV,bU){this.__vq.setVisibility(bV?B:k);}
...
,_applyShowCellFocusIndicator:function(ca,bY){if(ca){this.__vr.setDecorator(z);this._updateFocusIndicator();}
else {if(this.__vr){this.__vr.setDecorator(null);}
;}
;}
,getScrollY:function(){return this.__vq.getPosition();}
,setScrollY:function(scrollY,cb){this.__vq.scrollTo(scrollY);if(cb){this._updateContent();}
;}
,getScrollX:function(){return this.__vp.getPosition();}
,setScrollX:function(scrollX){this.__vp.scrollTo(scrollX);}
,getTable:function(){return this.__uo;}
,onColVisibilityChanged:function(){this.updateHorScrollBarMaximum();this._updateFocusIndicator();}
,setColumnWidth:function(ce,cd){this.__my.setColumnWidth(ce,cd);this.__vl.setColumnWidth(ce,cd);var cc=this.getTablePaneModel();var x=cc.getX(ce);if(x!=-1){this.updateHorScrollBarMaximum();this._updateFocusIndicator();}
;}
,onColOrderChanged:function(){this.__my.onColOrderChanged();this.__vl.onColOrderChanged();this.updateHorScrollBarMaximum();}
,onTableModelDataChanged:function(ci,cg,cj,ch){this.__vl.onTableModelDataChanged(ci,cg,cj,ch);var cf=this.getTable().getTableModel().getRowCount();if(cf!=this.__uS){this.updateVerScrollBarMaximum();if(this.getFocusedRow()>=cf){if(cf==0){this.setFocusedCell(null,null);}
else {this.setFocusedCell(this.getFocusedColumn(),cf-1);}
;}
;this.__uS=cf;}
;}
,onSelectionChanged:function(){this.__vl.onSelectionChanged();}
,onFocusChanged:function(){this.__vl.onFocusChanged();}
,onTableModelMetaDataChanged:function(){this.__my.onTableModelMetaDataChanged();this.__vl.onTableModelMetaDataChanged();}
,_onPaneModelChanged:function(){this.__my.onPaneModelChanged();this.__vl.onPaneModelChanged();}
,_onResizePane:function(){this.updateHorScrollBarMaximum();this.updateVerScrollBarMaximum();this._updateContent();this.__my._updateContent();this.__uo._updateScrollBarVisibility();}
,updateHorScrollBarMaximum:function(){var co=this.__vn.getInnerSize();if(!co){return;}
;var cl=this.getTablePaneModel().getTotalWidth();var cm=this.__vp;if(co.width<cl){var ck=Math.max(0,cl-co.width);cm.setMaximum(ck);cm.setKnobFactor(co.width/cl);var cn=cm.getPosition();cm.setPosition(Math.min(cn,ck));}
else {cm.setMaximum(0);cm.setKnobFactor(1);cm.setPosition(0);}
;}
,updateVerScrollBarMaximum:function(){var cw=this.__vn.getInnerSize();if(!cw){return;}
;var cu=this.getTable().getTableModel();var cq=cu.getRowCount();if(this.getTable().getKeepFirstVisibleRowComplete()){cq+=1;}
;var cp=this.getTable().getRowHeight();var cs=cq*cp;var cv=this.__vq;if(cw.height<cs){var cr=Math.max(0,cs-cw.height);cv.setMaximum(cr);cv.setKnobFactor(cw.height/cs);var ct=cv.getPosition();cv.setPosition(Math.min(ct,cr));}
...
,_onScrollX:function(e){var cx=e.getData();this.fireDataEvent(n,cx,e.getOldData());this._headerClipper.scrollToX(cx);this.__vn.scrollToX(cx);}
...
;var cA=e.getWheelDelta(F);if(cA>0&&cA<1){cA=1;}
else if(cA<0&&cA>-1){cA=-1;}
;if(qx.event.handler.MouseEmulation.ON){this.__vq.scrollBy(cA);}
else {this.__vq.scrollBySteps(cA);}
;var cy=cA!=0&&!this.__vI(this.__vq,cA);cA=e.getWheelDelta(bC);if(cA>0&&cA<1){cA=1;}
else if(cA<0&&cA>-1){cA=-1;}
;if(qx.event.handler.MouseEmulation.ON){this.__vp.scrollBy(cA);}
else {this.__vp.scrollBySteps(cA);}
;if(this.__vD&&this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(this.__vD,this.__vE);}
;cy=cy||(cA!=0&&!this.__vI(this.__vp,cA));if(cy){e.stop();}
;}
,__vI:function(cC,cD){var cB=cC.getPosition();return (cD<0&&cB<=0)||(cD>0&&cB>=cC.getMaximum());}
,__vJ:function(cJ){var cH=this.getTable();var cK=this.__my.getHeaderWidgetAtColumn(this.__vx);var cE=cK.getSizeHint().minWidth;var cG=Math.max(cE,this.__vz+cJ-this.__vy);if(this.getLiveResize()){var cF=cH.getTableColumnModel();cF.setColumnWidth(this.__vx,cG,true);}
else {this.__my.setColumnWidth(this.__vx,cG,true);var cI=this.getTablePaneModel();this._showResizeLine(cI.getColumnLeft(this.__vx)+cG);}
;this.__vy+=cG-this.__vz;this.__vz=cG;}
,__vK:function(cM){var cL=qx.ui.table.pane.Scroller.CLICK_TOLERANCE;if(this.__my.isShowingColumnMoveFeedback()||cM>this.__vw+cL||cM<this.__vw-cL){this.__vv+=cM-this.__vw;this.__my.showColumnMoveFeedback(this._moveColumn,this.__vv);var cN=this.__uo.getTablePaneScrollerAtPageX(cM);if(this._lastMoveTargetScroller&&this._lastMoveTargetScroller!=cN){this._lastMoveTargetScroller.hideColumnMoveFeedback();}
;if(cN!=null){this._lastMoveTargetX=cN.showColumnMoveFeedback(cM);}
else {this._lastMoveTargetX=null;}
;this._lastMoveTargetScroller=cN;this.__vw=cM;}
;}
,_onMousemoveHeader:function(e){var cU=this.getTable();if(!cU.getEnabled()){return;}
;var cV=false;var cO=null;var cS=e.getDocumentLeft();var cT=e.getDocumentTop();this.__vD=cS;this.__vE=cT;if(this.__vx!=null){this.__vJ(cS);cV=true;e.stopPropagation();}
else if(this._moveColumn!=null){this.__vK(cS);e.stopPropagation();}
...
;}
;}
;var cQ=cV?bu:null;this.getApplicationRoot().setGlobalCursor(cQ);this.setCursor(cQ);this.__my.setMouseOverColumn(cO);}
,_onMousemovePane:function(e){var cX=this.getTable();if(!cX.getEnabled()){return;}
;var da=e.getDocumentLeft();var db=e.getDocumentTop();this.__vD=da;this.__vE=db;var cY=this._getRowForPagePos(da,db);if(cY!=null&&this._getColumnForPageX(da)!=null){if(this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(da,db);}
;}
;this.__my.setMouseOverColumn(null);}
...
;}
;}
,_startResizeHeader:function(dh,df){var dg=this.getTable().getTableColumnModel();this.__vx=dh;this.__vy=df;this.__vz=dg.getColumnWidth(this.__vx);this._headerClipper.capture();}
,_startMoveHeader:function(di,dj){this._moveColumn=di;this.__vw=dj;this.__vv=this.getTablePaneModel().getColumnLeft(di);this._headerClipper.capture();}
,_onMousedownPane:function(e){var dn=this.getTable();if(!dn.getEnabled()){return;}
;if(dn.isEditing()){dn.stopEditing();}
;var dl=e.getDocumentLeft();var dm=e.getDocumentTop();var dq=this._getRowForPagePos(dl,dm);var dp=this._getColumnForPageX(dl);if(dq!==null){this.__vA={row:dq,col:dp};this.__vB=false;var dk=this.getSelectBeforeFocus();if(dk){dn.getSelectionManager().handleMouseDown(dq,e);}
;if(!this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(dl,dm);}
;if(!dk){dn.getSelectionManager().handleMouseDown(dq,e);}
;}
;}
,_onMouseupFocusIndicator:function(e){if(this.__vA&&!this.__vB&&!this.isEditing()&&this.__vr.getRow()==this.__vA.row&&this.__vr.getColumn()==this.__vA.col){this.fireEvent(by,qx.ui.table.pane.CellEvent,[this,e,this.__vA.row,this.__vA.col],true);this.__vB=true;}
else if(!this.isEditing()){this._onMousedownPane(e);}
;}
,_onChangeCaptureHeader:function(e){if(this.__vx!=null){this._stopResizeHeader();}
;if(this._moveColumn!=null){this._stopMoveHeader();}
;}
,_stopResizeHeader:function(){var dr=this.getTable().getTableColumnModel();if(!this.getLiveResize()){this._hideResizeLine();dr.setColumnWidth(this.__vx,this.__vz,true);}
;this.__vx=null;this._headerClipper.releaseCapture();this.getApplicationRoot().setGlobalCursor(null);this.setCursor(null);if(this.isEditing()){var ds=this.__vF.getBounds().height;this.__vF.setUserBounds(0,0,this.__vz,ds);}
;}
,_stopMoveHeader:function(){var dx=this.getTable().getTableColumnModel();var dy=this.getTablePaneModel();this.__my.hideColumnMoveFeedback();if(this._lastMoveTargetScroller){this._lastMoveTargetScroller.hideColumnMoveFeedback();}
...
;if(this.__vx!=null){this._stopResizeHeader();this.__vC=true;e.stop();}
else if(this._moveColumn!=null){this._stopMoveHeader();e.stop();}
;}
,_onClickHeader:function(e){if(this.__vC){this.__vC=false;return;}
...
;var dM=e.getDocumentLeft();var dN=e.getDocumentTop();var dQ=this._getRowForPagePos(dM,dN);var dP=this._getColumnForPageX(dM);if(dQ!=null&&dP!=null){dO.getSelectionManager().handleClick(dQ,e);if(this.__vr.isHidden()||(this.__vA&&!this.__vB&&!this.isEditing()&&dQ==this.__vA.row&&dP==this.__vA.col)){this.fireEvent(by,qx.ui.table.pane.CellEvent,[this,e,dQ,dP],true);this.__vB=true;}
;}
;}
...
;if(!this.getShowCellFocusIndicator()||dV===null||(this.__vA&&dV==this.__vA.row&&dU==this.__vA.col)){this.fireEvent(bH,qx.ui.table.pane.CellEvent,[this,e,dV,dU],true);var dR=this.getTable().getContextMenu();if(dR){if(dR.getChildren().length>0){dR.openAtMouse(e);}
else {dR.exclude();}
;e.preventDefault();}
;}
;}
...
;if(this.__vx==null){this.setCursor(null);this.getApplicationRoot().setGlobalCursor(null);}
;this.__my.setMouseOverColumn(null);if(this.getFocusCellOnMouseMove()){this.__uo.setFocusedCell();}
;}
,_showResizeLine:function(x){var ec=this._showChildControl(D);var eb=ec.getWidth();var ed=this.__vn.getBounds();ec.setUserBounds(x-Math.round(eb/2),0,eb,ed.height);}
,_hideResizeLine:function(){this._excludeChildControl(D);}
,showColumnMoveFeedback:function(em){var en=this.getTablePaneModel();var eg=this.getTable().getTableColumnModel();var eh=this.__vl.getContentLocation().left;var el=en.getColumnCount();var ei=0;var eq=0;var ef=eh;for(var ee=0;ee<el;ee++ ){var ep=en.getColumnAtX(ee);var eo=eg.getColumnWidth(ep);if(em<ef+eo/2){break;}
;ef+=eo;ei=ee+1;eq=ef-eh;}
;var ek=this.__vn.getContentLocation().left;var ej=this.__vn.getBounds().width;var scrollX=ek-eh;eq=qx.lang.Number.limit(eq,scrollX+2,scrollX+ej-1);this._showResizeLine(eq);return en.getFirstColumnX()+ei;}
,hideColumnMoveFeedback:function(){this._hideResizeLine();}
,_focusCellAtPagePos:function(et,er){var eu=this._getRowForPagePos(et,er);if(eu!=-1&&eu!=null){var es=this._getColumnForPageX(et);this.__uo.setFocusedCell(es,eu);}
;}
,setFocusedCell:function(ev,ew){if(!this.isEditing()){this.__vl.setFocusedCell(ev,ew,this.__vt);this.__uO=ev;this.__uP=ew;this._updateFocusIndicator();}
;}
,getFocusedColumn:function(){return this.__uO;}
,getFocusedRow:function(){return this.__uP;}
,scrollCellVisible:function(eJ,eK){var eH=this.getTablePaneModel();var ex=eH.getX(eJ);if(ex!=-1){var eE=this.__vn.getInnerSize();if(!eE){return;}
...
;}
,isEditing:function(){return this.__vF!=null;}
,startEditing:function(){var eP=this.getTable();var eN=eP.getTableModel();var eR=this.__uO;if(!this.isEditing()&&(eR!=null)&&eN.isColumnEditable(eR)){var eQ=this.__uP;var eL=this.getTablePaneModel().getX(eR);var eM=eN.getValue(eR,eQ);this.scrollCellVisible(eL,eQ);this.__vG=eP.getTableColumnModel().getCellEditorFactory(eR);var eO={col:eR,row:eQ,xPos:eL,value:eM,table:eP};this.__vF=this.__vG.createCellEditor(eO);if(this.__vF===null){return false;}
else if(this.__vF instanceof qx.ui.window.Window){this.__vF.setModal(true);this.__vF.setShowClose(false);this.__vF.addListener(bA,this._onCellEditorModalWindowClose,this);var f=eP.getModalCellEditorPreOpenFunction();if(f!=null){f(this.__vF,eO);}
;this.__vF.open();}
else {var eS=this.__vr.getInnerSize();this.__vF.setUserBounds(0,0,eS.width,eS.height);this.__vr.addListener(b,function(e){this.__vA={row:this.__uP,col:this.__uO};e.stopPropagation();}
,this);this.__vr.add(this.__vF);this.__vr.addState(N);this.__vr.setKeepActive(false);this.__vr.setDecorator(z);this.__vF.focus();this.__vF.activate();}
;return true;}
;return false;}
,stopEditing:function(){if(!this.getShowCellFocusIndicator()){this.__vr.setDecorator(null);}
;this.flushEditor();this.cancelEditing();}
,flushEditor:function(){if(this.isEditing()){var eT=this.__vG.getCellEditorValue(this.__vF);var eU=this.getTable().getTableModel().getValue(this.__uO,this.__uP);this.getTable().getTableModel().setValue(this.__uO,this.__uP,eT);this.__uo.focus();this.__uo.fireDataEvent(t,{row:this.__uP,col:this.__uO,oldValue:eU,value:eT});}
;}
,cancelEditing:function(){if(this.isEditing()&&!this.__vF.pendingDispose){if(this._cellEditorIsModalWindow){this.__vF.destroy();this.__vF=null;this.__vG=null;this.__vF.pendingDispose=true;}
else {this.__vr.removeState(N);this.__vr.setKeepActive(true);this.__vF.destroy();this.__vF=null;this.__vG=null;}
;}
;}
,_onCellEditorModalWindowClose:function(e){this.stopEditing();}
,_getColumnForPageX:function(eV){var eY=this.getTable().getTableColumnModel();var fa=this.getTablePaneModel();var eX=fa.getColumnCount();var eW=this.__vl.getContentLocation().left;for(var x=0;x<eX;x++ ){var fc=fa.getColumnAtX(x);var fb=eY.getColumnWidth(fc);eW+=fb;if(eV<eW){return fc;}
;}
;return null;}
,_getResizeColumnForPageX:function(fe){var fh=this.getTable().getTableColumnModel();var fi=this.getTablePaneModel();var fg=fi.getColumnCount();var ff=this.__my.getContentLocation().left;var fd=qx.ui.table.pane.Scroller.RESIZE_REGION_RADIUS;for(var x=0;x<fg;x++ ){var fk=fi.getColumnAtX(x);var fj=fh.getColumnWidth(fk);ff+=fj;if(fe>=(ff-fd)&&fe<=(ff+fd)){return fk;}
;}
;return -1;}
,_getRowForPagePos:function(fr,fs){var fl=this.__vl.getContentLocation();if(fr<fl.left||fr>fl.right){return null;}
;if(fs>=fl.top&&fs<=fl.bottom){var fm=this.getTable().getRowHeight();var scrollY=this.__vq.getPosition();if(this.getTable().getKeepFirstVisibleRowComplete()){scrollY=Math.floor(scrollY/fm)*fm;}
...
;var fo=this.__my.getContentLocation();if(fs>=fo.top&&fs<=fo.bottom&&fr<=fo.right){return -1;}
;return null;}
,setTopRightWidget:function(fu){var fv=this.__vH;if(fv!=null){this.__vm.remove(fv);}
;if(fu!=null){this.__vm.add(fu);}
;this.__vH=fu;}
,getTopRightWidget:function(){return this.__vH;}
,getHeader:function(){return this.__my;}
,getTablePane:function(){return this.__vl;}
,getVerticalScrollBarWidth:function(){var fw=this.__vq;return fw.isVisible()?(fw.getSizeHint().width||0):0;}
,getNeededScrollBars:function(fA,fB){var fM=this.__vq;var fL=fM.getSizeHint().width+fM.getMarginLeft()+fM.getMarginRight();var fG=this.__vp;var fJ=fG.getSizeHint().height+fG.getMarginTop()+fG.getMarginBottom();var fD=this.__vn.getInnerSize();var fx=fD?fD.width:0;if(this.getVerticalScrollBarVisible()){fx+=fL;}
...
,getPaneClipper:function(){return this.__vn;}
,getScrollAreaContainer:function(){return this.getPaneClipper();}
,_applyScrollTimeout:function(fP,fO){this._startInterval(fP);}
,_startInterval:function(fQ){this.__js.setInterval(fQ);this.__js.start();}
,_stopInterval:function(){this.__js.stop();}
,_postponedUpdateContent:function(){this._updateContent();}
,_oninterval:qx.event.GlobalError.observeMethod(function(){if(this.__vt&&!this.__vl._layoutPending){this.__vt=false;this._updateContent();}
;}
),_updateContent:function(){var fY=this.__vn.getInnerSize();if(!fY){return;}
;var fW=fY.height;var scrollX=this.__vp.getPosition();var scrollY=this.__vq.getPosition();var fS=this.getTable().getRowHeight();var fU=Math.floor(scrollY/fS);var fX=this.__vl.getFirstVisibleRow();this.__vl.setFirstVisibleRow(fU);var fT=Math.ceil(fW/fS);var fR=0;var fV=this.getTable().getKeepFirstVisibleRowComplete();if(!fV){fT++ ;fR=scrollY%fS;}
;this.__vl.setVisibleRowCount(fT);if(fU!=fX){this._updateFocusIndicator();}
;this.__vn.scrollToX(scrollX);if(!fV){this.__vn.scrollToY(fR);}
;}
,_updateFocusIndicator:function(){var ga=this.getTable();if(!ga.getEnabled()){return;}
;this.__vr.moveToCell(this.__uO,this.__uP);}
},destruct:function(){this._stopInterval();var gb=this.getTablePaneModel();if(gb){gb.dispose();}
;this.__vA=this.__vH=this.__uo=null;this._disposeObjects(M,d,A,R,a,bx,P,y,K,J);}
});}
)();
...
(function(){var a="Escape",b="keypress",c="Enter",d="excluded",f="Integer",g="qx.ui.table.pane.FocusIndicator";qx.Class.define(g,{extend:qx.ui.container.Composite,construct:function(h){qx.ui.container.Composite.call(this);this.__vL=h;this.setKeepActive(true);this.addListener(b,this._onKeyPress,this);}
,properties:{visibility:{refine:true,init:d},row:{check:f,nullable:true},column:{check:f,nullable:true}},members:{__vL:null,_onKeyPress:function(e){var i=e.getKeyIdentifier();if(i!==a&&i!==c){e.stopPropagation();}
;}
,moveToCell:function(p,q){if(!this.__vL.getShowCellFocusIndicator()&&!this.__vL.getTable().getTableModel().isColumnEditable(p)){this.exclude();return;}
else {this.show();}
;if(p==null){this.hide();this.setRow(null);this.setColumn(null);}
else {var j=this.__vL.getTablePaneModel().getX(p);if(j==-1){this.hide();this.setRow(null);this.setColumn(null);}
else {var o=this.__vL.getTable();var m=o.getTableColumnModel();var n=this.__vL.getTablePaneModel();var l=this.__vL.getTablePane().getFirstVisibleRow();var k=o.getRowHeight();this.setUserBounds(n.getColumnLeft(p)-2,(q-l)*k-2,m.getColumnWidth(p)+3,k+3);this.show();this.setRow(q);this.setColumn(p);}
;}
;}
...
,events:{"modelChanged":b},statics:{EVENT_TYPE_MODEL_CHANGED:c},properties:{firstColumnX:{check:f,init:0,apply:d},maxColumnCount:{check:a,init:-1,apply:h}},members:{__vM:null,__vN:null,_applyFirstColumnX:function(l,k){this.__vM=null;this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,_applyMaxColumnCount:function(n,m){this.__vM=null;this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,setTableColumnModel:function(o){if(this.__vN){this.__vN.removeListener(i,this._onColVisibilityChanged,this);this.__vN.removeListener(e,this._onColVisibilityChanged,this);}
;this.__vN=o;this.__vN.addListener(i,this._onColVisibilityChanged,this);this.__vN.addListener(e,this._onHeaderCellRendererChanged,this);this.__vM=null;}
,_onColVisibilityChanged:function(p){this.__vM=null;this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,_onHeaderCellRendererChanged:function(q){this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,getColumnCount:function(){if(this.__vM==null){var r=this.getFirstColumnX();var t=this.getMaxColumnCount();var s=this.__vN.getVisibleColumnCount();if(t==-1||(r+t)>s){this.__vM=s-r;}
else {this.__vM=t;}
;}
;return this.__vM;}
,getColumnAtX:function(v){var u=this.getFirstColumnX();return this.__vN.getVisibleColumnAtX(u+v);}
,getX:function(z){var w=this.getFirstColumnX();var y=this.getMaxColumnCount();var x=this.__vN.getVisibleX(z)-w;if(x>=0&&(y==-1||x<y)){return x;}
else {return -1;}
;}
,getColumnLeft:function(D){var B=0;var C=this.getColumnCount();for(var x=0;x<C;x++ ){var A=this.getColumnAtX(x);if(A==D){return B;}
;B+=this.__vN.getColumnWidth(A);}
;return -1;}
,getTotalWidth:function(){var E=0;var F=this.getColumnCount();for(var x=0;x<F;x++ ){var G=this.getColumnAtX(x);E+=this.__vN.getColumnWidth(G);}
;return E;}
},destruct:function(){if(this.__vN){this.__vN.removeListener(i,this._onColVisibilityChanged,this);this.__vN.removeListener(e,this._onColVisibilityChanged,this);}
;this.__vN=null;}
});}
)();
