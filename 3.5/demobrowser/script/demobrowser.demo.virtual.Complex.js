...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.07ad8fe2e0fb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applyInterval",b="appear",c="qx.debug",d="interval",e="qx.ui.virtual.behavior.Prefetch",f="scroll",g="_applyScroller",h="qx.ui.virtual.core.Scroller",i="__js",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(e,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(c)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__js=new qx.event.Timer(this.getInterval());this.__js.addListener(d,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:h,nullable:true,init:null,apply:g},interval:{check:k,init:200,apply:a}},members:{__HO:null,__HP:null,__js:null,__HQ:null,__HR:null,setPrefetchX:function(o,r,p,q){this.__HO=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__HP=[v,u,t,s];}
,_onInterval:function(){var w=this.__HO;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__HP;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__HQ){y.getChildControl(j).removeListenerById(this.__HQ);}
;if(this.__HR){y.getChildControl(l).removeListenerById(this.__HR);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__js.stop();z.addListenerOnce(b,this.__js.start,this.__js);}
else {this.__js.restart();}
;this.__HQ=z.getChildControl(j).addListener(f,this.__js.restart,this.__js);this.__HR=z.getChildControl(l).addListener(f,this.__js.restart,this.__js);}
else {this.__js.stop();}
;}
,_applyInterval:function(B,A){this.__js.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__HO=this.__HP=null;this._disposeObjects(i);}
});}
)();
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="network-server.png",h="row",i="mouseover",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__oi=[];}
,members:{_pool:null,__oi:null,getCellData:function(t,s){if(!this.__oi[t]){this.__oi[t]=[];}
;if(!this.__oi[t][s]){this.__oi[t][s]={label:this.__RQ(),icon:this.__RR()};}
;return this.__oi[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(i,function(){var x=this.__RR();v.setIcon(x);this.__oi[w][u].icon=x;}
,this);}
;v.set(this.getCellData(w,u));}
else {v=this._pool.checkbox.pop();if(!v){v=new qx.ui.form.CheckBox();v.addListener(m,function(){this.setLabel(this.getLabel()==l?v.getUserData(h)+b+v.getUserData(n):l);}
,v);}
;v.set({value:w%2==0,label:w+b+u});}
;v.setUserData(h,w);v.setUserData(n,u);return v;}
,poolCellWidget:function(y){if(y.classname==p){this._pool.atom.push(y);}
else {this._pool.checkbox.push(y);}
;}
,__RQ:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__RR:function(){var z=a;var B=e;var A=[d,k,g,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
},destruct:function(){this._pool=this.__oi=null;}
});}
)();
