...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.0d8905487e92.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="$$widget",i="The root widget does not support 'left', or 'top' paddings!",j="div",k="left",l="paddingTop",m="qxIsRootPage",n="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(o){this.__mm=o;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__zd,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__js:null,__mm:null,_createContentElement:function(){var q=this.__mm.createElement(j);this.__mm.body.appendChild(q);var p=new qx.html.Root(q);p.setStyles({position:n,textAlign:k});p.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(c)==f)){p.setAttribute(m,1);}
;return p;}
...
;this.__ox=w;w.style.overflow=p;w.style.textAlign=r;this.__oy=x||false;this.__oz=v||false;this.__oA();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__oy:false,__oz:false,__ox:null,__oA:function(){if(this.__oy||this.__oz){var y=qx.bom.element.Dimension.getSize(this.__ox);if(this.__oy&&y.width<1){throw new Error(s+this.__ox+t+this+k);}
;if(this.__oz){if(y.height<1){throw new Error(s+this.__ox+t+this+g);}
;if(y.height>=1&&qx.bom.element.Style.get(this.__ox,j,3)==f){qx.bom.element.Style.set(this.__ox,j,y.height+h);}
;}
;qx.event.Registration.addListener(this.__ox,a,this._onResize,this);}
;}
,_createContentElement:function(){var z=this.__ox;if(this.__oy||this.__oz){var B=document.createElement(q);z.appendChild(B);}
else {B=z;}
...
,this,0);return A;}
,_onResize:function(e){var C=e.getData();if((C.oldWidth!==C.width)&&this.__oy||(C.oldHeight!==C.height)&&this.__oz){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var H=this.__oy;var E=this.__oz;if(!H||!E){var D=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {D={};}
;var I=qx.bom.element.Dimension;if(H){var G=I.getContentWidth(this.__ox);D.width=G;D.minWidth=G;D.maxWidth=G;}
;if(E){var F=I.getContentHeight(this.__ox);D.height=F;D.minHeight=F;D.maxHeight=F;}
;return D;}
},defer:function(J,K){qx.ui.core.MLayoutHandling.remap(K);}
,destruct:function(){qx.event.Registration.removeListener(this.__ox,a,this._onResize,this);this.__ox=null;}
});}
)();
...
(function(){var a="__qO",b="qx.ui.window.Manager";qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__qO:null,setDesktop:function(c){this.__qO=c;this.updateStack();}
...
,syncWidget:function(){this.__qO.forceUnblock();var h=this.__qO.getWindows();var g=this._minZIndex;var m=g+h.length*2;var j=g+h.length*4;var k=null;for(var i=0,l=h.length;i<l;i++ ){var f=h[i];if(!f.isVisible()){continue;}
;k=k||f;if(f.isModal()){f.setZIndex(j);this.__qO.blockContent(j-1);j+=2;k=f;}
...
,bringToFront:function(o){var n=this.__qO.getWindows();var p=qx.lang.Array.remove(n,o);if(p){n.push(o);this.updateStack();}
;}
,sendToBack:function(r){var q=this.__qO.getWindows();var s=qx.lang.Array.remove(q,r);if(s){q.unshift(r);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(a);}
});}
)();
(function(){var a="__qP",b="mouseup",c="mousedown",d="Boolean",f="__qQ",g="losecapture",h="mousewheel",i="qx.ui.core.MMovable",j="The move handle could not be redefined!",k="mousemove",l="move",m="maximized",n="move-frame";qx.Mixin.define(i,{properties:{movable:{check:d,init:true},useMoveFrame:{check:d,init:false}},members:{__qP:null,__qQ:null,__qR:null,__qS:null,__qT:null,__qU:null,__qV:null,__qW:false,__qX:null,__qY:0,_activateMoveHandle:function(o){if(this.__qP){throw new Error(j);}
;this.__qP=o;o.addListener(c,this._onMoveMouseDown,this);o.addListener(b,this._onMoveMouseUp,this);o.addListener(k,this._onMoveMouseMove,this);o.addListener(g,this.__rd,this);if(qx.event.handler.MouseEmulation.ON){o.addListener(h,function(e){e.stopPropagation();}
,this);}
;}
,__ra:function(){var p=this.__qQ;if(!p){p=this.__qQ=new qx.ui.core.Widget();p.setAppearance(n);p.exclude();qx.core.Init.getApplication().getRoot().add(p);}
;return p;}
,__rb:function(){var location=this.getContentLocation();var r=this.getBounds();var q=this.__ra();q.setUserBounds(location.left,location.top,r.width,r.height);q.show();q.setZIndex(this.getZIndex()+1);}
,__rc:function(e){var t=this.__qR;var w=Math.max(t.left,Math.min(t.right,e.getDocumentLeft()));var s=Math.max(t.top,Math.min(t.bottom,e.getDocumentTop()));var u=this.__qS+w;var v=this.__qT+s;return {viewportLeft:parseInt(u,10),viewportTop:parseInt(v,10),parentLeft:parseInt(u-this.__qU,10),parentTop:parseInt(v-this.__qV,10)};}
,_onMoveMouseDown:function(e){if(!this.getMovable()||this.hasState(m)){return;}
;var parent=this.getLayoutParent();var x=parent.getContentLocation();var z=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isBlocked()){this.__qX=parent.getBlockerColor();this.__qY=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__qW=true;}
;}
;this.__qR={left:x.left,top:x.top,right:x.left+z.width,bottom:x.top+z.height};var y=this.getContentLocation();this.__qU=x.left;this.__qV=x.top;this.__qS=y.left-e.getDocumentLeft();this.__qT=y.top-e.getDocumentTop();this.addState(l);this.__qP.capture();if(this.getUseMoveFrame()){this.__rb();}
;e.stop();}
,_onMoveMouseMove:function(e){if(!this.hasState(l)){return;}
;var B=this.__rc(e);if(this.getUseMoveFrame()){this.__ra().setDomPosition(B.viewportLeft,B.viewportTop);}
...
;this.removeState(l);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__qW){parent.unblock();parent.setBlockerColor(this.__qX);parent.setBlockerOpacity(this.__qY);this.__qX=null;this.__qY=0;this.__qW=false;}
;}
;this.__qP.releaseCapture();var D=this.__rc(e);var C=this.getLayoutParent().getInsets();this.setLayoutProperties({left:D.parentLeft-(C.left||0),top:D.parentTop-(C.top||0)});if(this.getUseMoveFrame()){this.__ra().exclude();}
;e.stopPropagation();}
,__rd:function(e){if(!this.hasState(l)){return;}
;this.removeState(l);if(this.getUseMoveFrame()){this.__ra().exclude();}
;}
},destruct:function(){this._disposeObjects(f,a);this.__qR=null;}
});}
)();
...
(function(){var a="mousedown",b="Boolean",c="w-resize",d="sw-resize",f="n-resize",g="resizableRight",h="ne-resize",i="se-resize",j="Integer",k="e-resize",l="resizableLeft",m="mousemove",n="move",o="shorthand",p="maximized",q="resize",r="nw-resize",s="mouseout",t="qx.ui.core.MResizable",u="mouseup",v="losecapture",w="resize-frame",x="resizableBottom",y="s-resize",z="resizableTop";qx.Mixin.define(t,{construct:function(){var content=this.getContentElement();content.addListener(a,this.__rq,this,true);content.addListener(u,this.__rr,this);content.addListener(m,this.__rt,this);content.addListener(s,this.__ru,this);content.addListener(v,this.__rs,this);var A=content.getDomElement();if(A==null){A=window;}
;this.__re=qx.event.Registration.getManager(A).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:b,init:true},resizableRight:{check:b,init:true},resizableBottom:{check:b,init:true},resizableLeft:{check:b,init:true},resizable:{group:[z,g,x,l],mode:o},resizeSensitivity:{check:j,init:5},useResizeFrame:{check:b,init:true}},members:{__re:null,__rf:null,__rg:null,__rh:null,__ri:null,__rj:null,__rk:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var B=this.__rf;if(!B){B=this.__rf=new qx.ui.core.Widget();B.setAppearance(w);B.exclude();qx.core.Init.getApplication().getRoot().add(B);}
;return B;}
,__rl:function(){var location=this.getContentLocation();var C=this._getResizeFrame();C.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);C.show();C.setZIndex(this.getZIndex()+1);}
,__rm:function(e){var E=this.__rg;var D=this.getSizeHint();var H=this.__rk;var G=this.__rj;var I=G.width;var F=G.height;var K=G.left;var top=G.top;var J;if((E&this.RESIZE_TOP)||(E&this.RESIZE_BOTTOM)){J=Math.max(H.top,Math.min(H.bottom,e.getDocumentTop()))-this.__ri;if(E&this.RESIZE_TOP){F-=J;}
else {F+=J;}
;if(F<D.minHeight){F=D.minHeight;}
else if(F>D.maxHeight){F=D.maxHeight;}
;if(E&this.RESIZE_TOP){top+=G.height-F;}
;}
;if((E&this.RESIZE_LEFT)||(E&this.RESIZE_RIGHT)){J=Math.max(H.left,Math.min(H.right,e.getDocumentLeft()))-this.__rh;if(E&this.RESIZE_LEFT){I-=J;}
else {I+=J;}
...
,__rn:{'1':f,'2':y,'4':c,'8':k,'5':r,'6':d,'9':h,'10':i},__ro:function(e){var location=this.getContentLocation();var N=this.getResizeSensitivity();var O=e.getDocumentLeft();var M=e.getDocumentTop();var L=this.__rp(location,O,M,N);if(L>0){L=L|this.__rp(location,O,M,N*2);}
;this.__rg=L;}
,__rp:function(location,S,R,P){var Q=0;if(this.getResizableTop()&&Math.abs(location.top-R)<P&&S>location.left-P&&S<location.right+P){Q+=this.RESIZE_TOP;}
...
;return Q;}
,__rq:function(e){if(!this.__rg||!this.getEnabled()){return;}
;this.addState(q);this.__rh=e.getDocumentLeft();this.__ri=e.getDocumentTop();var location=this.getContentLocation();var U=this.getBounds();this.__rj={top:location.top,left:location.left,width:location.right-location.left,height:location.bottom-location.top,bounds:qx.lang.Object.clone(U)};var parent=this.getLayoutParent();var V=parent.getContentLocation();var T=parent.getBounds();this.__rk={left:V.left,top:V.top,right:V.left+T.width,bottom:V.top+T.height};if(this.getUseResizeFrame()){this.__rl();}
;this.capture();e.stop();}
,__rr:function(e){if(!this.hasState(q)||!this.getEnabled()){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var W=this.__rm(e);this.setWidth(W.width);this.setHeight(W.height);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:W.parentLeft,top:W.parentTop});}
;this.__rg=0;this.removeState(q);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__rs:function(e){if(!this.__rg){return;}
...
;}
,__rt:function(e){if(!this.getEnabled()){return;}
;if(this.hasState(q)){var Y=this.__rm(e);if(this.getUseResizeFrame()){var X=this._getResizeFrame();X.setUserBounds(Y.viewportLeft,Y.viewportTop,Y.width,Y.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(p)&&!this.__re.isSessionActive()){this.__ro(e);var bc=this.__rg;var bb=this.getApplicationRoot();if(bc){var ba=this.__rn[bc];this.setCursor(ba);bb.setGlobalCursor(ba);}
else if(this.getCursor()){this.resetCursor();bb.resetGlobalCursor();}
;}
;}
,__ru:function(e){if(this.getCursor()&&!this.hasState(q)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__rf!=null&&!qx.core.ObjectRegistry.inShutDown){this.__rf.destroy();this.__rf=null;}
;this.__re=null;}
});}
)();
...
;var br=this.getLayoutProperties();this.__rw=br.left===undefined?0:br.left;this.__rv=br.top===undefined?0:br.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(F);this._updateCaptionBar();this.fireEvent(Q);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(b,qx.event.type.Event,[false,true])){var bs=this.getLayoutProperties();this.__rw=bs.left===undefined?0:bs.left;this.__rv=bs.top===undefined?0:bs.top;this.removeState(F);this.hide();this.fireEvent(x);}
;}
...
;var bt=this.__rw;var top=this.__rv;this.setLayoutProperties({edge:null,left:bt,top:top});this.removeState(F);this._updateCaptionBar();this.fireEvent(S);}
;}
