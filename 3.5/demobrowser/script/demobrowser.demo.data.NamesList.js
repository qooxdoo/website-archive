...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.NamesList.2b88903b10f2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{selection:{check:b,event:f,apply:d,init:null}},events:{"changeSelection":h},members:{_modifingSelection:0,__El:null,__Em:null,__Ek:null,_applySelection:function(k,j){if(this.__Em!=undefined&&j!=undefined){j.removeListenerById(this.__Em);}
;this.__Em=k.addListener(a,this.__En,this);this._updateSelection();}
...
;var m=this.getTarget().getSelection();var l=this.getSelection();if(l==null){l=new qx.data.Array();this.__Ek=l;this.setSelection(l);}
...
,_addChangeTargetListener:function(p,o){if(this.__El!=undefined&&o!=undefined){o.removeListenerById(this.__El);}
;if(p!=null){if(this.__Eo()||this.__Ep()){this.__El=p.addListener(f,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()){return;}
;this._startSelectionModification();if(this.__Eo()){var s=[];for(var i=0;i<this.getSelection().length;i++ ){var t=this.getSelection().getItem(i);var u=this.__Er(t);if(u!=null){s.push(u);}
;}
...
;}
;}
else if(this.__Ep()){var r=this.getSelection().getItem(this.getSelection().length-1);if(r!==undefined){this.__Eq(r);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__Eo:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.IMultiSelection);}
,__Ep:function(){var w=this.getTarget().constructor;return qx.Class.implementsInterface(w,qx.ui.core.ISingleSelection);}
,__Eq:function(x){var y=this.__Er(x);if(y==null){return;}
;if(this.__Eo()){this.getTarget().addToSelection(y);}
else if(this.__Ep()){this.getTarget().setSelection([y]);}
;}
,__Er:function(z){var A=this.getTarget().getSelectables(true);for(var i=0;i<A.length;i++ ){if(A[i].getModel()==z){return A[i];}
;}
;return null;}
...
(function(){var a="changeModel",b="_applyLabelOptions",c="_applyLabelPath",d="changeTarget",e="_applyModel",f="change",g="icon",h="ReverseBindingId",k="qx.data.controller.List",m="_applyIconPath",n="BindingId",o="_applyDelegate",p="",q="changeDelegate",r="_applyTarget",s="]",t="qx.data.IListData",u="model[",v="model",w="label",x="String",y="_applyIconOptions",z=".";qx.Class.define(k,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__xJ=[];this.__Es=[];this.__Et=[];this.__Eu={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:t,apply:e,event:a,nullable:true,dereference:true},target:{apply:r,event:d,nullable:true,init:null,dereference:true},labelPath:{check:x,apply:c,nullable:true},iconPath:{check:x,apply:m,nullable:true},labelOptions:{apply:b,nullable:true},iconOptions:{apply:y,nullable:true},delegate:{apply:o,event:q,init:null,nullable:true}},members:{__yf:null,__xJ:null,__Eu:null,__Es:null,__Et:null,__Ev:null,__Ew:null,update:function(){this.__Ey();this.__EC();this._updateSelection();}
,_applyDelegate:function(E,D){this._setConfigureItem(E,D);this._setFilter(E,D);this._setCreateItem(E,D);this._setBindItem(E,D);}
,_applyIconOptions:function(G,F){this.__EC();}
,_applyLabelOptions:function(I,H){this.__EC();}
,_applyIconPath:function(K,J){this.__EC();}
,_applyLabelPath:function(M,L){this.__EC();}
...
;if(P!=null){this.__yf=P.addListener(f,this.__Ex,this);this.__xQ();this.__Ey();if(N==null){this._changeTargetSelection();}
else {this.__Ev=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var O=this.getTarget();if(O!=null){var length=O.getChildren().length;for(var i=0;i<length;i++ ){this.__EB();}
;}
;}
;}
...
;if(S!=null){if(this.getModel()!=null){for(var i=0;i<this.__xJ.length;i++ ){this.__EA(this.__EE(i));}
;}
;}
;}
,__Ex:function(){this.__Ew=true;qx.ui.core.queue.Widget.add(this);if(this.__xJ.length!=this.getModel().getLength()){this.update();}
;}
...
;this.__xQ();var U=this.__xJ.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++ ){this.__EA(this.__EE(j));}
;}
else if(U<T){for(var j=T;j>U;j-- ){this.__EB();}
;}
;this.__Ev=true;qx.ui.core.queue.Widget.add(this);}
,__Ez:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__yf);this.__yf=V.addListener(f,this.__Ex,this);}
;}
...
;return W;}
,__EA:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__EB:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bo,br,bp,bn,bm){if(bp!=null){var bp=qx.lang.Object.clone(bp);this.__Eu[br]=bp.onUpdate;delete bp.onUpdate;}
else {bp={};this.__Eu[br]=null;}
;bp.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bm);bp.ignoreConverter=v;var bq=u+bm+s;if(bo!=null&&bo!=p){bq+=z+bo;}
;var bs=this.bind(bq,bn,br,bp);bn.setUserData(br+n,bs);if(!qx.lang.Array.contains(this.__Es,br)){this.__Es.push(br);}
;}
,bindPropertyReverse:function(by,bv,bw,bx,bt){var bu=u+bt+s;if(by!=null&&by!=p){bu+=z+by;}
;var bz=bx.bind(bv,this,bu,bw);bx.setUserData(by+h,bz);if(!qx.lang.Array.contains(this.__Et,by)){this.__Et.push(by);}
;}
...
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__Es.length;i++ ){var bE=bD.getUserData(this.__Es[i]+n);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__Et.length;i++ ){var bE=bD.getUserData(this.__Et[i]+h);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__EC:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++ ){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__EE(i));}
;this.__Ez();}
...
,_setFilter:function(bR,bP){if((bR==null||bR.filter==null)&&(bP!=null&&bP.filter!=null)){this.__ED();}
...
;}
;var bS=this.getTarget().getChildren();for(var i=0;i<bS.length;i++ ){this._bindListItem(bS[i],this.__EE(i));}
;this.__Ez();this._endSelectionModification();this._updateSelection();}
,__ED:function(){this.__xQ();this.__Ey();this.__EC();this.__Ew=true;qx.ui.core.queue.Widget.add(this);}
...
;}
;}
,__EE:function(bY){return this.__xJ[bY];}
},destruct:function(){this.__xJ=this.__Eu=this.__Es=null;this.__Et=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
...
;this.fireDataEvent(e,this.getModel());if(this.__uc){this.__uc.dispose();this.__uc=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__uc!=null){this._disposeObjects(u);}
...
(function(){var a='"',b="Class '",c="The model contained an illegal name: '",d="",e="qx.debug.databinding",f="change",g="qx.data.marshal.Json",h="Array",j="Unsupported type!",k="_validate",l="' could not be found.",m="'.",n="'. Replaced it with '",o="set",p="' is not a valid JavaScript identifier.",q="_applyEventPropagation",r="qx.data.model.",s="qx.debug",t="The key '";qx.Class.define(g,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(u){qx.core.Object.call(this);this.__yi=u;}
,statics:{$$instance:null,createModel:function(v,w){if(this.$$instance===null){this.$$instance=new qx.data.marshal.Json();}
;this.$$instance.toClass(v,w);return this.$$instance.toModel(v);}
},members:{__yi:null,__yj:function(x){return Object.keys(x).sort().join(a);}
,toClass:function(y,z){this.__yk(y,z,null,0);}
,__yk:function(L,G,A,I){if(!qx.lang.Type.isObject(L)||!!L.$$isString||L instanceof qx.core.Object){if(L instanceof Array||qx.Bootstrap.getClass(L)==h){for(var i=0;i<L.length;i++ ){this.__yk(L[i],G,null,I+1);}
;}
;return;}
;var C=this.__yj(L);if(this.__yo(C,A,I)){return;}
;for(var K in L){this.__yk(L[K],G,K,I+1);}
;if(qx.Class.isDefined(r+C)){return;}
;if(this.__yi&&this.__yi.getModelClass&&this.__yi.getModelClass(C,L)!=null){return;}
;var M={};var D={__yl:this.__yl};for(var K in L){if(this.__yi&&this.__yi.getPropertyMapping){K=this.__yi.getPropertyMapping(K,C);}
;K=K.replace(/-|\.|\s+/g,d);if(qx.core.Environment.get(s)){this.assertTrue((/^[$0-9A-Za-z_]*$/).test(K),t+K+p);}
;M[K]={};M[K].nullable=true;M[K].event=f+qx.lang.String.firstUp(K);if(G){M[K].apply=q;}
;if(this.__yi&&this.__yi.getValidationRule){var F=this.__yi.getValidationRule(C,K);if(F){M[K].validate=k+K;D[k+K]=F;}
;}
;}
;if(this.__yi&&this.__yi.getModelSuperClass){var J=this.__yi.getModelSuperClass(C)||qx.core.Object;}
else {var J=qx.core.Object;}
;var E=[];if(this.__yi&&this.__yi.getModelMixins){var H=this.__yi.getModelMixins(C);if(!qx.lang.Type.isArray(H)){if(H!=null){E=[H];}
;}
else {E=H;}
;}
;if(G){E.push(qx.data.marshal.MEventBubbling);}
;var B={extend:J,include:E,properties:M,members:D,destruct:this.__ym};qx.Class.define(r+C,B);}
,__ym:function(){var N=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var O in N){this.__yl(this.get(N[O].name));}
;}
,__yl:function(P){if(!(P instanceof qx.core.Object)){return;}
;if(P.isDisposed()){return;}
;P.dispose();}
,__yn:function(S,R){var T;if(this.__yi&&this.__yi.getModelClass){T=this.__yi.getModelClass(S,R);}
;if(T!=null){return (new T());}
else {var Q=r+S;var U=qx.Class.getByName(Q);if(!U){throw new Error(b+Q+l);}
;return (new U());}
;}
,__yo:function(V,Y,W){var X=this.__yi;return X&&X.ignore&&X.ignore(V,Y,W);}
,toModel:function(ba){return this.__yp(ba,null,0);}
,__yp:function(bk,bc,bh){var bg=qx.lang.Type.isObject(bk);var bb=bk instanceof Array||qx.Bootstrap.getClass(bk)==h;if((!bg&&!bb)||!!bk.$$isString||bk instanceof qx.core.Object){return bk;}
else if(this.__yo(this.__yj(bk),bc,bh)){return bk;}
else if(bb){var bl=new qx.data.Array();bl.setAutoDisposeItems(true);for(var i=0;i<bk.length;i++ ){bl.push(this.__yp(bk[i],null,bh+1));}
;return bl;}
else if(bg){var bd=this.__yj(bk);var bj=this.__yn(bd,bk);for(var bi in bk){var be=bi;if(this.__yi&&this.__yi.getPropertyMapping){be=this.__yi.getPropertyMapping(bi,bd);}
;var bm=be.replace(/-|\.|\s+/g,d);if((qx.core.Environment.get(s))&&qx.core.Environment.get(e)){if(bm!=be){this.warn(c+bi+n+be+m);}
;}
;be=bm;var bf=o+qx.lang.String.firstUp(be);if(bj[bf]){bj[bf](this.__yp(bk[bi],bi,bh+1));}
;}
;return bj;}
;throw new Error(j);}
...
;this.__rC={};var P=this._transport=this._createTransport();this._setPhase(G);this.__rD=qx.lang.Function.bind(this._onReadyStateChange,this);this.__rE=qx.lang.Function.bind(this._onLoad,this);this.__rF=qx.lang.Function.bind(this._onLoadEnd,this);this.__rG=qx.lang.Function.bind(this._onAbort,this);this.__ne=qx.lang.Function.bind(this._onTimeout,this);this.__rH=qx.lang.Function.bind(this._onError,this);P.onreadystatechange=this.__rD;P.onload=this.__rE;P.onloadend=this.__rF;P.onabort=this.__rG;P.ontimeout=this.__ne;P.onerror=this.__rH;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__rD:null,__rE:null,__rF:null,__rG:null,__ne:null,__rH:null,__rI:null,__nh:null,__rJ:null,__rC:null,__rK:null,_transport:null,_createTransport:function(){throw new Error(E);}
...
;this.__nh=true;this.__rJ=s;this._transport.abort();}
,_setRequestHeaders:function(){var X=this._transport,W=this._getAllRequestHeaders();for(var Y in W){X.setRequestHeader(Y,W[Y]);}
;}
,_getAllRequestHeaders:function(){var ba={};qx.lang.Object.mergeWith(ba,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(ba,this.__rL());qx.lang.Object.mergeWith(ba,this.__rK);qx.lang.Object.mergeWith(ba,this.__rC);return ba;}
,__rL:function(){var bc=this.getAuthentication(),bb={};if(bc){bc.getAuthHeaders().forEach(function(bd){bb[bd.key]=bd.value;}
);return bb;}
;}
,setRequestHeader:function(be,bf){this.__rC[be]=bf;}
,getRequestHeader:function(bg){return this.__rC[bg];}
,removeRequestHeader:function(bh){if(this.__rC[bh]){delete this.__rC[bh];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__rJ;}
...
,getResponse:function(){return this.__rI;}
,_setResponse:function(bl){var bk=bl;if(this.__rI!==bl){this.__rI=bl;this.fireEvent(H,qx.event.type.Data,[this.__rI,bk]);}
;}
,_onReadyStateChange:function(){var bm=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(B+bm);}
;this.fireEvent(D);if(this.__nh){return;}
;if(bm===3){this._setPhase(p);}
;if(this.isDone()){this.__rM();}
;}
,__rM:function(){if(qx.core.Environment.get(f)){this.debug(A+this.getStatus());}
...
,_setPhase:function(bo){var bp=this.__rJ;if(qx.core.Environment.get(m)){qx.core.Assert.assertString(bo);qx.core.Assert.assertMatch(bo,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__rJ=bo;this.fireDataEvent(c,bo,bp);}
...
;if(this._transport){bu.onreadystatechange=bu.onload=bu.onloadend=bu.onabort=bu.ontimeout=bu.onerror=bt;bu.dispose();}
;}
});}
)();
...
;var A=z[h+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(A)){var D=qx.data&&qx.data.IListData&&qx.Class.hasInterface(A&&A.constructor,qx.data.IListData);for(var i=0;i<A.length;i++ ){var F=D?A.getItem(i):A[i];E+=this.__rN(name,F,C);}
;}
else if(qx.lang.Type.isDate(A)&&y!=null){E+=this.__rN(name,y.format(A),C);}
else {E+=this.__rN(name,A,C);}
;}
;return E.substring(0,E.length-1);}
,__rN:function(name,I,G){if(I&&I.$$type==o){I=I.classname;}
...
(function(){var a="Retry open native request with method: ",b="activex",c="No XHR support available.",d="If-None-Match",f="xhr",g="If-Modified-Since",h="engine.version",i="onunload",j="GET",k="-1",l="qx.debug.io",m="Open native request with method: ",n="error",o="loadend",p="load",q="Received native readyState: ",r="abort",s=", url: ",t="browser.documentmode",u="",v="readystatechange",w="Microsoft.XMLHTTP",x="Already disposed",y="browser.version",z="opera",A="qx.bom.request.Xhr",B="on",C="gecko",D="If-Match",E="mshtml",F="engine.name",G="Microsoft.XMLDOM",H="file:",I="Send native request",J="If-Range",K="Content-Type",L="io.xhr",M="Not enough arguments",N="timeout",O="undefined",P=", async: ",Q="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(A,{extend:Object,construct:function(){var R=qx.Bootstrap.bind(this.__sa,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__rO=qx.event.GlobalError.observeMethod(R);}
else {this.__rO=R;}
;this.__rP=qx.Bootstrap.bind(this.__rY,this);this.__ne=qx.Bootstrap.bind(this.__se,this);this.__rX();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__rQ=qx.Bootstrap.bind(this.__sh,this);window.attachEvent(i,this.__rQ);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":A,"error":A,"loadend":A,"timeout":A,"abort":A,"load":A},members:{readyState:0,responseText:u,responseXML:null,status:0,statusText:u,timeout:0,open:function(W,S,T,V,U){this.__sj();if(typeof S===O){throw new Error(M);}
else if(typeof W===O){W=j;}
;this.__nh=false;this.__rR=false;this.__rS=false;this.__ni=S;if(typeof T==O){T=true;}
;this.__rT=T;if(!this.__si()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__rX();}
;this.__rV.onreadystatechange=this.__rO;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,m+W+s+S+P+T);}
;this.__rV.open(W,S,T,V,U);}
catch(X){if(!qx.util.Request.isCrossDomain(S)){throw X;}
;if(!this.__rT){this.__rU=X;}
;if(this.__rT){if(window.XDomainRequest){this.readyState=4;this.__rV=new XDomainRequest();this.__rV.onerror=qx.Bootstrap.bind(function(){this._emit(v);this._emit(n);this._emit(o);}
,this);if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+W+s+S+P+T);}
;this.__rV.open(W,S,T,V,U);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__nj){return;}
;this.readyState=4;this._emit(v);this._emit(n);this._emit(o);}
,this));}
;}
;if(qx.core.Environment.get(F)===E&&qx.core.Environment.get(t)<9&&this.__rV.readyState>0){this.__rV.setRequestHeader(g,k);}
;if(qx.core.Environment.get(F)===C&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__rT){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(v);}
;}
,setRequestHeader:function(Y,ba){this.__sj();if(Y==D||Y==g||Y==d||Y==J){this.__rS=true;}
;this.__rV.setRequestHeader(Y,ba);return this;}
,send:function(bb){this.__sj();if(!this.__rT&&this.__rU){throw this.__rU;}
;if(qx.core.Environment.get(F)===z&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__rW=window.setTimeout(this.__ne,this.timeout);}
;bb=typeof bb==O?null:bb;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,I);}
;this.__rV.send(bb);}
catch(bd){if(!this.__rT){throw bd;}
;if(this._getProtocol()===H){this.readyState=2;this.__sb();var bc=this;window.setTimeout(function(){if(bc.__nj){return;}
;bc.readyState=3;bc.__sb();bc.readyState=4;bc.__sb();}
);}
;}
;if(qx.core.Environment.get(F)===C&&!this.__rT){this.__sa();}
;this.__rR=true;return this;}
,abort:function(){this.__sj();this.__nh=true;this.__rV.abort();if(this.__rV){this.readyState=this.__rV.readyState;}
;return this;}
...
,getResponseHeader:function(bg){this.__sj();return this.__rV.getResponseHeader(bg);}
,getAllResponseHeaders:function(){this.__sj();return this.__rV.getAllResponseHeaders();}
,overrideMimeType:function(bh){this.__sj();if(this.__rV.overrideMimeType){this.__rV.overrideMimeType(bh);}
else {throw new Error(Q);}
;return this;}
,getRequest:function(){return this.__rV;}
,dispose:function(){if(this.__nj){return false;}
;window.clearTimeout(this.__rW);if(window.detachEvent){window.detachEvent(i,this.__rQ);}
;try{this.__rV.onreadystatechange;}
catch(bj){return false;}
;var bi=function(){}
;this.__rV.onreadystatechange=bi;this.__rV.onload=bi;this.__rV.onerror=bi;this.abort();this.__rV=null;this.__nj=true;return true;}
,isDisposed:function(){return !!this.__nj;}
...
,_getProtocol:function(){var bl=this.__ni;var bm=/^(\w+:)\/\//;if(bl!==null&&bl.match){var bn=bl.match(bm);if(bn&&bn[1]){return bn[1];}
;}
;return window.location.protocol;}
,__rV:null,__rT:null,__rO:null,__rP:null,__rQ:null,__ne:null,__rR:null,__ni:null,__nh:null,__ga:null,__nj:null,__rW:null,__rU:null,__rS:null,__rX:function(){this.__rV=this._createNativeXhr();this.__rV.onreadystatechange=this.__rO;if(this.__rV.onabort){this.__rV.onabort=this.__rP;}
;this.__nj=this.__rR=this.__nh=false;}
,__rY:function(){if(!this.__nh){this.abort();}
;}
,__sa:function(){var bo=this.__rV,bp=true;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,q+bo.readyState);}
;if(this.readyState==bo.readyState){return;}
;this.readyState=bo.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__nh&&!this.__rR){return;}
;if(!this.__rT&&(bo.readyState==2||bo.readyState==3)){return;}
...
;if(bp){this.__sf();this.__sg();}
;}
;this.__sb();if(this.readyState==qx.bom.request.Xhr.DONE){if(bo){bo.onreadystatechange=function(){}
;}
;}
;}
,__sb:function(){var br=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__rW);}
;if(qx.core.Environment.get(F)==E&&qx.core.Environment.get(t)<8){if(this.__rT&&!this.__rR&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(br.__nj){return;}
;br.readyState=3;br._emit(v);br.readyState=4;br._emit(v);br.__sc();}
);return;}
;}
;}
;this._emit(v);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sc();}
;}
,__sc:function(){if(this.__ga){this._emit(N);if(qx.core.Environment.get(F)===z){this._emit(n);}
;this.__ga=false;}
else {if(this.__nh){this._emit(r);}
else {if(this.__sd()){this._emit(n);}
else {this._emit(p);}
;}
;}
;this._emit(o);}
,__sd:function(){var bs;if(this._getProtocol()===H){bs=!this.responseText;}
else {bs=!this.statusText;}
;return bs;}
,__se:function(){var bt=this.__rV;this.readyState=qx.bom.request.Xhr.DONE;this.__ga=true;bt.abort();this.responseText=u;this.responseXML=null;this.__sb();}
,__sf:function(){var bu=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===H&&this.status===0&&bu){if(!this.__sd()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(F)===z){if(bu&&this.__rS&&!this.__nh&&this.status===0){this.status=304;}
;}
;}
,__sg:function(){if(qx.core.Environment.get(F)==E&&(this.getResponseHeader(K)||u).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bv=new window.ActiveXObject(G);bv.async=false;bv.validateOnParse=false;bv.loadXML(this.responseText);this.responseXML=bv;}
;}
,__sh:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__si:function(){var name=qx.core.Environment.get(F);var bw=qx.core.Environment.get(y);return !(name==E&&bw<9||name==C&&bw<3.5);}
,__sj:function(){if(this.__nj){throw new Error(x);}
;}
