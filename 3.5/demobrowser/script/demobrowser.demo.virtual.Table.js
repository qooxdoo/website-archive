...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.a38bf52a637b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="demobrowser.demo.virtual.Table",d="__RP",e="white",f="#EEE",g="vertical";qx.Class.define(c,{extend:qx.application.Standalone,members:{__RP:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(e,f));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(g));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__RP=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__RP.getCellProperties(k+a+j);}
...
;this.__wN=[];this.__wO=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__wN:null,__wO:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__wN[B]=A;if(this.__wP(B)){this.updateLayerData();}
;}
...
;this.__wO[C]=D;if(this.__wP(C)){this.updateLayerData();}
;}
,__wP:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__wO[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__wN[K]||this.getDefaultLineColor();}
,__wQ:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__wR:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__wQ(Y,ba,X);}
else {this.__wR(Y,bb,W);}
...
;}
},destruct:function(){this.__wN=this.__wO=null;}
});}
)();
...
;this.__dk=qx.bom.Stylesheet.createElement(p);this.__td={};this.__lA={};}
,members:{__dk:null,__td:null,__lA:null,getStylesheet:function(){return this.__dk;}
,getCssClass:function(q){return this.__td[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lA[r];if(!s){var s=this.__te();qx.bom.Stylesheet.addRule(this.__dk,k+s,r);this.__lA[r]=s;}
;this.__td[t]=s;return s;}
,__te:function(){return e+this.toHashCode()+a+(this.__tf++ );}
,__tf:0},destruct:function(){this.__dk=this.__td=this.__lA=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dk=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__tg={};this.__th={};this.__ti={};this.__tj={};this.__jN={};this.__tk={};this.initAppearance();this.__to();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__tl:null,__tm:null,__jN:null,__tk:null,__th:null,__tg:null,__ti:null,__tj:null,__tn:false,__dk:null,__to:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__tl=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__tl.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__th={};}
;}
,_getValue:function(R){if(this.__tn){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__tn){U=this.__th;}
else {U=this.__tg;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__tn){var bi=this.__tj;}
else {bi=this.__ti;}
...
;}
,getCellProperties:function(bk,bj){this.__tp(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dk.getCssClass(this.__tm)||t;return v+bq;}
,__tp:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__tm==bt){return;}
;this.__tm=bt;var bv=this.__jN[this.__tm];if(!bv){this.__tq();this.__tr(bs);this.__ts(bs);this.__tt();this.__jN[this.__tm]=1;}
;this.__tu();}
,__tq:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__tr:function(bz){this.__th={};this.__tn=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__tn=false;}
,__ts:function(){var bD=qx.lang.Object.getValues(this.__th).join(I);this.__dk.computeClassForStyles(this.__tm,bD);}
,__tt:function(){var bI=this.__tl;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__tk[this.__tm]=bG;}
,__tu:function(){var bK=qx.util.PropertyUtil;var bJ=this.__tk[this.__tm]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__tg).join(I);}
,getInsets:function(bQ,bR){var bT=this.__ti;var bS=this.__tj;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dk=this.__tg=this.__th=this.__ti=this.__tj=this.__jN=this.__tk=this.__tl=null;}
});}
)();
