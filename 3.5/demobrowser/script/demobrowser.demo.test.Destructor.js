...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.938ce046a42f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Window: ",b="interval",c=")",d="Done! (Registry: ",e="Label: ",f=" (Registry: ",g="__js",h="demobrowser.demo.test.Destructor",j="Round: ";qx.Class.define(h,{extend:qx.application.Standalone,members:{__cM:null,__Ru:0,__js:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cM=[];this.currentTest=this.testWindows;this.__js=new qx.event.Timer(1000);this.__js.addListener(b,this.runTest,this);this.__js.start();}
,runTest:function(){this.__Ru++ ;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(j+this.__Ru+f+m+c);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cM;for(var i=0,l=k.length;i<l;i++ ){k[i].destroy();}
...
,testLabels:function(){for(var i=0;i<250;i++ ){var n=new qx.ui.basic.Label(e+i);this.getRoot().add(n,{left:50,top:50+i*20});this.__cM.push(n);}
;}
,testWindows:function(){for(var i=0;i<5;i++ ){var o=new qx.ui.window.Window(a+i);o.open();this.__cM.push(o);}
;}
