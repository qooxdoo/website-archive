...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SelectBox.1bd62b4b7b53.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="F",b="G",c="Type in the textfield or set the selection with the button.",d="J",e="selection[0]",f="D",g="E",h="H",i="I",j="B",k="C",l="<b>Synchronized Selection</b><br/>",m="value",n="A",o="execute",p="<b>Change Selection</b><br/>",q="demobrowser.demo.data.SelectBox",r="Bound to the same data and share the selection. The label is also bound to the selection.",s="The selection is: ",t="Set Selection to 'C'";qx.Class.define(q,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var C=new qx.data.Array([n,j,k,f,g,a,b,h,i,d]);var D=new qx.ui.form.SelectBox();this.getRoot().add(D,{left:10,top:110});var y=new qx.data.controller.List(C,D);var B=new qx.ui.form.SelectBox();this.getRoot().add(B,{left:150,top:110});var x=new qx.data.controller.List(C,B);y.setSelection(x.getSelection());var A=new qx.ui.basic.Label();this.getRoot().add(new qx.ui.basic.Label(s),{left:10,top:140});this.getRoot().add(A,{left:110,top:140});y.bind(e,A,m);var v=new qx.ui.form.TextField(n);v.setLiveUpdate(true);v.setWidth(150);this.getRoot().add(v,{left:290,top:110});v.bind(m,y,e);y.bind(e,v,m);var w=new qx.ui.form.Button(t);w.setWidth(150);this.getRoot().add(w,{left:290,top:140});w.addListener(o,function(){y.getSelection().setItem(0,k);}
,this);var u=new qx.ui.basic.Label();u.setRich(true);u.setWidth(240);u.setValue(l+r);this.getRoot().add(u,{left:10,top:10});var z=new qx.ui.basic.Label();z.setRich(true);z.setWidth(130);z.setValue(p+c);this.getRoot().add(z,{left:300,top:10});}
}});}
)();
