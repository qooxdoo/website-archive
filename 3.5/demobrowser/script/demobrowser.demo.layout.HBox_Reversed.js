...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Reversed.c3314cd42fe8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Hx:{north:1,south:2,west:3,east:4,center:5},__Hy:{'1':t,'2':e,'3':z,'4':u},__lq:function(){var H=this._getLayoutChildren();var P,J;var length=H.length;var L=[];var O=[];var K=[];var I=this.getSort()===o;var N=this.getSort()===A;for(var i=0;i<length;i++ ){P=H[i];K=P.getLayoutProperties().edge;if(K===n){if(J){throw new Error(b);}
;J=P;}
...
;this.__gx=Q;var M=[];for(var i=0;i<length;i++ ){K=Q[i].getLayoutProperties().edge;M[i]=this.__Hx[K]||5;}
;this.__Hw=M;delete this._invalidChildrenCache;}
,renderLayout:function(bl,bb,bt){if(this._invalidChildrenCache){this.__lq();}
;var bk=qx.ui.layout.Util;var W=this.__gx;var bm=this.__Hw;var length=W.length;var ba,bu,Y,bf,bg,br,bd,T,S;var bx=[];var bc=[];var bs=this._getSeparatorWidths();var bB=this.getSpacingX();var bA=this.getSpacingY();var X=-bB;var bn=-bA;if(bs.x){X-=bs.x+bB;}
;if(bs.y){bn-=bs.y+bA;}
...
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__lq();}
;var bS=this.__gx;var cd=this.__Hw;var length=bS.length;var bW,ce;var bY,bX;var ca=0,cl=0;var bP=0,cg=0;var cb=0,ck=0;var bQ=0,cf=0;var ch=this._getSeparatorWidths();var cj=this.getSpacingX(),ci=this.getSpacingY();var bU=-cj,bT=-ci;if(ch.x){bU-=ch.x+cj;}
;if(ch.y){bT-=ch.y+ci;}
...
},destruct:function(){this.__Hw=this.__gx=null;}
});}
)();
...
,_applyValue:function(bh,bg){var bf=this.getChildControl(u);this._updateButtons();this.__wo=bh;if(bh!==null){if(this.getNumberFormat()){bf.setValue(this.getNumberFormat().format(bh));}
...
,_applyNumberFormat:function(bp,bo){var bn=this.getChildControl(u);bn.setFilter(this._getFilterRegExp());this.getNumberFormat().addListener(F,this._onChangeNumberFormat,this);this._applyValue(this.__wo,undefined);}
...
;}
;}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case a:this.__wp=true;case j:this.getChildControl(z).press();break;case m:this.__wq=true;case h:this.getChildControl(r).press();break;default:return;};e.stopPropagation();e.preventDefault();}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case a:this.getChildControl(z).release();this.__wp=false;break;case j:this.getChildControl(z).release();break;case m:this.getChildControl(r).release();this.__wq=false;break;case h:this.getChildControl(r).release();break;};}
...
;this.setValue(bv);}
else {this._applyValue(this.__wo,undefined);}
;}
...
,_countUp:function(){if(this.__wp){var bC=this.getValue()+this.getPageStep();}
...
;}
;this.gotoValue(bC);}
,_countDown:function(){if(this.__wq){var bE=this.getValue()-this.getPageStep();}
...
(function(){var a="yellow",b="gray",c="blue",d="bottom",f="green",g="click to reverse",h="top",i="demobrowser.demo.layout.HBox_Reversed",j="middle",k="main",l="mousedown";qx.Class.define(i,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var m=new qx.ui.layout.HBox();var o=(new qx.ui.container.Composite(m)).set({decorator:k,backgroundColor:a,height:80});m.setReversed(true);m.setSpacing(5);var q=new qx.ui.core.Widget().set({decorator:k,backgroundColor:c,maxHeight:60,alignY:h});var p=new qx.ui.basic.Label(g).set({decorator:k,rich:true,backgroundColor:f,maxHeight:60,alignY:j,allowGrowX:true,allowGrowY:true});var n=new qx.ui.core.Widget().set({decorator:k,backgroundColor:b,maxHeight:60,alignY:d});o.add(q);o.add(p);o.add(n);o.addListener(l,function(e){m.setReversed(!m.getReversed());}
