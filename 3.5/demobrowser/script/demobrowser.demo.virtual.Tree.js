...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree.eaa62f3d23c4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Show Leafs",b="Show top level open/close icons",c="item",d="changeValue",f="loaded",g="execute",h="drop",j="File #",k="demobrowser.demo.virtual.Tree",l="Enable drag selection",m="Open mode:",n="change",o="Hide Root Node",p="Update Model",q="Control",r=" items",s="icon/48/places/folder.png",t="move",u="New Item ",v="Enable multi selection",w="copy",x="name",y="dragstart",z="",A="mode",B="multi",C="changeSelection",D="Drag me:",E="single",F="Selection: ",G="children",H="Tree:",I="click",J="json/tree.json",K="model",L="none",M="double click",N="Selection:",O="Root node:",P="Toggle Height";qx.Class.define(k,{extend:qx.application.Standalone,members:{i:0,__LW:null,main:function(){qx.application.Standalone.prototype.main.call(this);var T=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));this.getRoot().add(T,{top:20,left:20});var R=new qx.ui.tree.VirtualTree(null,x,G).set({width:200,height:400});T.add(R);R.setDroppable(true);R.setDraggable(true);R.addListener(y,function(e){e.addType(c);e.addAction(t);}
);R.addListener(h,function(e){var W=e.getOriginalTarget();var X=W&&W.getModel?W.getModel():U.getModel();if(e.getCurrentAction()==t){var V=R.getSelection().getItem(0);this.removeItem(U.getModel(),V);}
else {var V=qx.data.marshal.Json.createModel({"name":u+this.i++ ,"children":[]});}
;if(X.getChildren){X.getChildren().push(V);}
;}
,this);var Q=J;var U=new qx.data.store.Json(Q);this.__LW=U;U.bind(K,R,K);U.addListener(f,function(){R.openNode(R.getModel().getChildren().getItem(0));}
...
;this.removeItem(bb.getItem(i),Y);}
;}
,getCommandFrame:function(bg){var br=new qx.ui.groupbox.GroupBox(q);var bh=4;br.setLayout(new qx.ui.layout.Grid(5,3));var bt=0;br.add(new qx.ui.basic.Label(F).set({paddingTop:4}),{row:bt,column:0});var bs=new qx.ui.form.TextField().set({readOnly:true});br.add(bs,{row:bt++ ,column:1});bg.getSelection().addListener(n,function(e){var bu=bg.getSelection();if(bu.getLength()>0){if(bg.getSelectionMode()===B){bs.setValue(bu.getLength()+r);}
else {bs.setValue(bu.getItem(0).getName());}
;}
else {bs.setValue(z);}
;}
);br.add(new qx.ui.core.Spacer(bh,bh),{row:bt++ ,column:0});br.add(new qx.ui.basic.Label(m),{row:bt,column:0});var bd={"click":I,"dblclick":M,"none":L};var bc=new qx.ui.form.RadioGroup();for(var bm in bd){var bl=new qx.ui.form.RadioButton(bd[bm]).set({value:bm==bg.getOpenMode()});bl.setUserData(A,bm);bc.add(bl);br.add(bl,{row:bt++ ,column:1});}
;bc.addListener(C,function(e){bg.setOpenMode(e.getData()[0].getUserData(A));}
);br.add(new qx.ui.core.Spacer(bh,bh),{row:bt++ ,column:0});br.add(new qx.ui.basic.Label(N),{row:bt,column:0});var be=new qx.ui.form.CheckBox(v);br.add(be,{row:bt++ ,column:1});be.addListener(d,function(e){var bv=e.getData();bg.setSelectionMode(bv?B:E);}
);var bf=new qx.ui.form.CheckBox(l);br.add(bf,{row:bt++ ,column:1});bf.addListener(d,function(e){var bw=e.getData();bg.setDragSelection(bw);if(!be.getValue()){be.setValue(true);}
;}
);br.add(new qx.ui.core.Spacer(bh,bh),{row:bt++ ,column:0});br.add(new qx.ui.basic.Label(O),{row:bt,column:0});var bq=new qx.ui.form.CheckBox(o);br.add(bq,{row:bt++ ,column:1});bq.addListener(d,function(e){bg.setHideRoot(e.getData());}
);var bk=new qx.ui.form.CheckBox(b);br.add(bk,{row:bt++ ,column:1});bk.addListener(d,function(e){bg.setShowTopLevelOpenCloseIcons(e.getData());}
);br.add(new qx.ui.core.Spacer(bh,bh),{row:bt++ ,column:0});br.add(new qx.ui.basic.Label(H),{row:bt,column:0});var bn=new qx.ui.form.CheckBox(a);bn.setValue(bg.isShowLeafs());br.add(bn,{row:bt++ ,column:1});bn.addListener(d,function(e){bg.setShowLeafs(e.getData());}
);br.add(new qx.ui.core.Spacer(bh,bh),{row:bt++ ,column:0});var bp=new qx.ui.form.Button(p);bp.addListener(g,function(e){var by=bg.getModel().getChildren().getItem(0);var bA=by.getChildren().getItem(2);var bz=[];for(var i=0;i<10;i++ ){bz.push({"name":j+(bA.getChildren().getLength()+i)});}
;var bx=qx.data.marshal.Json.createModel(bz,true);bA.getChildren().append(bx);}
,this);br.add(bp,{row:bt++ ,column:1});var bi=new qx.ui.form.Button(P);br.add(bi,{row:bt++ ,column:1});var bo=new qx.ui.basic.Image(s);bo.setDraggable(true);bo.addListener(y,function(e){e.addType(c);e.addAction(w);}
);br.add(new qx.ui.basic.Label(D),{row:bt,column:0});br.add(bo,{row:bt++ ,column:1});var bj=true;bi.addListener(g,function(e){bg.setHeight(bj?600:400);bj=!bj;}
);return br;}
}});}
)();
...
(function(){var a="changeModel",b="resize",c="_applyLabelOptions",d="Boolean",f="or 'labelPath' is 'null'!",g="one",h="marshal.MEventBubbling'. Therefore the tree can not update ",j="_applyOpenMode",k="the view automatically on model changes.",l="qx.core.Object",m="Space",n="Left",o="filter",p="Integer",q="_applyModel",r="_applyShowTopLevelOpenCloseIcons",s="_applyLabelPath",t="dblclick",u="open",v="changeOpenMode",w="qx.debug",x="changeDelegate",y="virtual-tree",z="_applyChildProperty",A="qx.event.type.Data",B="_applyIconPath",C="_applyDelegate",D="_applyHideRoot",E="close",F="The model item doesn't support the Mixin 'qx.data.",G="_applyRowHeight",H="sorter",I="Right",J="cellDblclick",K="Enter",L="qx.ui.tree.VirtualTree",M="click",N="keypress",O="cellClick",P="none",Q="Could not build tree, because 'childProperty' and/",R="updated",S="_applyShowLeafs",T="String",U="_applyIconOptions",V="changeBubble",W=".";qx.Class.define(L,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.tree.core.IVirtualTree,qx.data.controller.ISelection],include:[qx.ui.virtual.selection.MModel,qx.ui.core.MContentPadding],construct:function(X,ba,Y){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);this._init();if(ba!=null){this.setLabelPath(ba);}
...
,events:{open:A,close:A},properties:{appearance:{refine:true,init:y},focusable:{refine:true,init:true},width:{refine:true,init:100},height:{refine:true,init:200},itemHeight:{check:p,init:25,apply:G,themeable:true},openMode:{check:[M,t,P],init:t,apply:j,event:v,themeable:true},hideRoot:{check:d,init:false,apply:D},showTopLevelOpenCloseIcons:{check:d,init:false,apply:r},showLeafs:{check:d,init:true,apply:S},childProperty:{check:T,apply:z,nullable:true},labelPath:{check:T,apply:s,nullable:true},iconPath:{check:T,apply:B,nullable:true},labelOptions:{apply:c,nullable:true},iconOptions:{apply:U,nullable:true},model:{check:l,apply:q,event:a,nullable:true,deferredInit:true},delegate:{event:x,apply:C,init:null,nullable:true}},members:{_provider:null,_layer:null,__xJ:null,__yH:null,__yI:null,__gI:null,_itemWidth:0,__yJ:null,syncWidget:function(bc){var be=this._layer.getFirstRow();var bd=this._layer.getRowSizes().length;for(var bg=be;bg<be+bd;bg++ ){var bb=this._layer.getRenderedCellWidget(bg,0);if(bb!=null){this._itemWidth=Math.max(this._itemWidth,bb.getSizeHint().width);}
;}
;var bf=this.getPane().getInnerSize().width;this.getPane().getColumnConfig().setItemSize(0,Math.max(this._itemWidth,bf));}
,openNode:function(bh){this.__yM(bh);this.buildLookupTable();}
,refresh:function(){this.buildLookupTable();}
,openNodeAndParents:function(bi){this.__yN(this.getModel(),bi);this.buildLookupTable();}
,closeNode:function(bj){if(qx.lang.Array.contains(this.__yH,bj)){qx.lang.Array.remove(this.__yH,bj);this.fireDataEvent(E,bj);this.buildLookupTable();}
;}
,isNodeOpen:function(bk){return qx.lang.Array.contains(this.__yH,bk);}
,_init:function(){this.__xJ=new qx.data.Array();this.__yH=[];this.__yI=[];this._initLayer();}
...
,this);}
,getLookupTable:function(){return this.__xJ;}
,_reverseLookup:function(bl){return bl;}
,_getDataFromRow:function(bm){return this.__xJ.getItem(bm);}
,_getSelectables:function(){return this.__xJ;}
,getOpenNodes:function(){return this.__yH;}
,isNode:function(bn){return qx.ui.tree.core.Util.isNode(bn,this.getChildProperty());}
,getLevel:function(bo){return this.__yI[bo];}
...
,_applyOpenMode:function(bt,bs){var bu=this.getPane();if(bt===t){bu.addListener(J,this._onOpen,this);}
else if(bt===M){bu.addListener(O,this._onOpen,this);}
;if(bs===t){bu.removeListener(J,this._onOpen,this);}
else if(bs===M){bu.removeListener(O,this._onOpen,this);}
;}
...
,_applyModel:function(bM,bL){this.__yH=[];if(bM!=null){if(qx.core.Environment.get(w)){if(!qx.Class.hasMixin(bM.constructor,qx.data.marshal.MEventBubbling)){this.warn(F+h+k);}
;}
;bM.addListener(V,this._onChangeBubble,this);this.__yM(bM);}
;if(bL!=null){bL.removeListener(V,this._onChangeBubble,this);}
;this.__yK();}
...
;}
;if(this.__xJ.indexOf(bR)!=-1){this.__yK();}
;}
;}
,_onUpdated:function(event){if(this.__gI==null){this.__gI=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__gI.schedule();}
,_onOpen:function(event){var bV=event.getRow();var bU=this.__xJ.getItem(bV);if(this.isNode(bU)){if(this.isNodeOpen(bU)){this.closeNode(bU);}
...
;}
;break;case I:if(bX&&!this.isNodeOpen(bY)){this.openNode(bY);}
else {if(bX){var ca=bY.get(this.getChildProperty());if(ca!=null&&ca.getLength()>0){bW.splice(0,1,ca.getItem(0));}
;}
;}
;break;case K:case m:if(!bX){return;}
;if(this.isNodeOpen(bY)){this.closeNode(bY);}
else {this.openNode(bY);}
;break;};}
;}
,_beforeApplySelection:function(cc){if(cc.length===0&&this.getSelectionMode()===g){var cb=this.__yP();var cd=this.getLookupTable().indexOf(cb);if(cd>=0){cc.push(cd);}
;}
;}
,_afterApplySelection:function(){var ce=this.getSelection();if(ce.getLength()>0&&this.getSelectionMode()===g){this.__yO(ce.getItem(0));}
else {this.__yJ=[];}
;}
,__yK:function(){this.buildLookupTable();this._applyDefaultSelection();}
,buildLookupTable:function(){if(this.getModel()!=null&&(this.getChildProperty()==null||this.getLabelPath()==null)){throw new Error(Q+f);}
;this._itemWidth=0;var ci=[];this.__yI=[];var cg=-1;var ch=this.getModel();if(ch!=null){if(!this.isHideRoot()){cg++ ;ci.push(ch);this.__yI.push(cg);}
;if(this.isNodeOpen(ch)){var cf=this.__yL(ch,cg);ci=ci.concat(cf);}
;}
;if(!qx.lang.Array.equals(this.__xJ.toArray(),ci)){this._provider.removeBindings();this.__xJ.removeAll();this.__xJ.append(ci);this.__xP();this._updateSelection();}
;}
,__yL:function(cj,co){var cn=[];co++ ;if(!this.isNode(cj)){return cn;}
;var cr=cj.get(this.getChildProperty());if(cr==null){return cn;}
;cr=cr.copy();var cp=this.getDelegate();var cm=qx.util.Delegate.getMethod(cp,o);var cl=qx.util.Delegate.getMethod(cp,H);if(cl!=null){cr.sort(cl);}
;for(var i=0;i<cr.getLength();i++ ){var cq=cr.getItem(i);if(cm&&!cm(cq)){continue;}
;if(this.isNode(cq)){this.__yI.push(co);cn.push(cq);if(this.isNodeOpen(cq)){var ck=this.__yL(cq,co);cn=cn.concat(ck);}
;}
else {if(this.isShowLeafs()){this.__yI.push(co);cn.push(cq);}
;}
;}
;cr.dispose();return cn;}
,__yM:function(cs){if(!qx.lang.Array.contains(this.__yH,cs)){this.__yH.push(cs);this.fireDataEvent(u,cs);}
;}
,__yN:function(ct,cu){if(ct===cu){this.__yM(cu);return true;}
;if(!this.isNode(ct)){return false;}
;var cx=ct.get(this.getChildProperty());if(cx==null){return false;}
;for(var i=0;i<cx.getLength();i++ ){var cw=cx.getItem(i);var cv=this.__yN(cw,cu);if(cv===true){this.__yM(cw);return true;}
;}
;return false;}
,__xP:function(){this.getPane().getRowConfig().setItemCount(this.__xJ.getLength());this.getPane().fullUpdate();}
,getParent:function(cz){var cA=this.__xJ.indexOf(cz);if(cA<0){return null;}
;var cB=this.__yI[cA];while(cA>0){cA-- ;var cy=this.__yI[cA];if(cy<cB){return this.__xJ.getItem(cA);}
;}
;return null;}
,__yO:function(cC){this.__yJ=[];var parent=this.getParent(cC);while(parent!=null){this.__yJ.unshift(parent);parent=this.getParent(parent);}
;}
,__yP:function(){if(this.__yJ==null){return this.getModel();}
;var cD=this.getLookupTable();var parent=this.__yJ.pop();while(parent!=null){if(cD.contains(parent)){return parent;}
;parent=this.__yJ.pop();}
;return this.getModel();}
},destruct:function(){var cF=this.getPane();if(cF!=null){if(cF.hasListener(J)){cF.removeListener(J,this._onOpen,this);}
;if(cF.hasListener(O)){cF.removeListener(O,this._onOpen,this);}
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__gI!=null){this.__gI.cancel();this.__gI.dispose();}
;var cE=this.getModel();if(cE!=null){cE.removeListener(V,this._onChangeBubble,this);}
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__xJ.dispose();this._layer=this._provider=this.__xJ=this.__yH=this.__gI=null;}
});}
)();
...
(function(){var a="BindingIds",b="model",c="",d="changeDelegate",f="virtual-tree-file",g="label",h="appearance",i="icon",j="bindItem",k=".length",l="]",m="virtual-tree-folder",n="[",o=".",p="String",q="qx.ui.tree.core.MWidgetController";qx.Mixin.define(q,{construct:function(){this.__wU=[];}
...
;}
,bindProperty:function(x,A,y,w,u){var z=this.__wV(u,x);var v=this._tree.getLookupTable();var B=v.bind(z,w,A,y);this.__wW(w,B);}
,bindPropertyReverse:function(I,E,G,H,C){var F=this.__wV(C,I);var D=this._tree.getLookupTable();var J=H.bind(E,D,F,G);this.__wW(H,J);}
,removeBindings:function(){while(this.__wU.length>0){var K=this.__wU.pop();this._removeBindingsFrom(K);}
;}
...
;}
,_removeBindingsFrom:function(O){var P=this.__wX(O);while(P.length>0){var Q=P.pop();try{this._tree.getLookupTable().removeBinding(Q);}
catch(e){O.removeBinding(Q);}
;}
;if(qx.lang.Array.contains(this.__wU,O)){qx.lang.Array.remove(this.__wU,O);}
;}
,__wV:function(S,T){var R=n+S+l;if(T!=null&&T!=c){R+=o+T;}
;return R;}
,__wW:function(V,W){var U=this.__wX(V);if(!qx.lang.Array.contains(U,W)){U.push(W);}
;if(!qx.lang.Array.contains(this.__wU,V)){this.__wU.push(V);}
;}
,__wX:function(X){var Y=X.getUserData(a);if(Y==null){Y=[];X.setUserData(a,Y);}
;return Y;}
...
;var o=this._renderer.getCellWidget();o.setOpen(p&&this._tree.isNodeOpen(s));o.addListener(a,this.__yQ,this);o.setUserData(b,this.getChildProperty());o.setUserData(g,this._tree.isShowLeafs());if(this._tree.getSelection().contains(s)){this._styleSelectabled(o);}
...
,poolCellWidget:function(u){u.removeListener(a,this.__yQ,this);this._removeBindingsFrom(u);this._renderer.pool(u);this._onPool(u);}
...
,__yQ:function(event){var K=event.getTarget();var L=K.getUserData(k);var J=this._tree.getLookupTable().getItem(L);if(event.getData()){this._tree.openNode(J);}
...
(function(){var a="open",b="cell.childProperty",c="cell.level",d="qx.ui.tree.VirtualTreeItem",e="virtual-tree-folder",f="cell.showLeafs",g="changeLength";qx.Class.define(d,{extend:qx.ui.tree.core.AbstractItem,properties:{appearance:{refine:true,init:e}},members:{_forwardStates:{selected:true},_addWidgets:function(){this.addSpacer();this.addOpenButton();this.addIcon();this.addLabel();}
...
,hasChildren:function(){var h=this.getModel();var j=this.getUserData(b);var i=this.getUserData(f);return qx.ui.tree.core.Util.hasChildren(h,j,!i);}
,_applyModel:function(n,m){var k=this.getUserData(b);var l=this.getUserData(f);if(n!=null&&qx.ui.tree.core.Util.isNode(n,k)&&qx.ui.tree.core.Util.hasChildren(n,k,!l)){n.get(k).addListener(g,this._onChangeLength,this);}
;if(m!=null&&qx.ui.tree.core.Util.isNode(m,k)&&qx.ui.tree.core.Util.hasChildren(m,k,!l)){m.get(k).removeListener(g,this._onChangeLength,this);}
;}
