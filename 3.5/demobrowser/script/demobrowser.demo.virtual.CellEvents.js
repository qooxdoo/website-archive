...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.9ebc6ac538e8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=b+e.getRow()+i+e.getColumn()+h;this.__RO(q);}
,_onContextMenu:function(e){var r=f+e.getRow()+i+e.getColumn()+h;this.__RO(r);}
,_onDblclickPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__RO(s);}
