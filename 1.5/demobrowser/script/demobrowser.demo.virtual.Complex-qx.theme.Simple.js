...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Complex","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex-qx.theme.Simple.2ba68d72f1b4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__ht=[];
},members:{_pool:null,__ht:null,getCellData:function(i,k){if(!this.__ht[i]){this.__ht[i]=[];
}
if(!this.__ht[i][k]){this.__ht[i][k]={label:this.__NB(),icon:this.__NC()};
}return this.__ht[i][k];
},getCellWidget:function(l,m){var n;

if(m%2==0){n=this._pool.atom.pop();

if(!n){n=new qx.ui.basic.Atom();
n.addListener(c,function(){var o=this.__NC();
n.setIcon(o);
this.__ht[l][m].icon=o;
},this);
...
(function(){var k="__kr",j="_applyInterval",i="appear",h="qx.debug",g="interval",f="qx.ui.virtual.behavior.Prefetch",e="_applyScroller",d="qx.ui.virtual.core.Scroller",c="scrollbar-x",b="Integer",a="scrollbar-y";
qx.Class.define(f,{extend:qx.core.Object,construct:function(l,m){if(qx.core.Environment.get(h)){this.assertObject(m);
...
}},properties:{scroller:{check:d,nullable:true,init:null,apply:e},interval:{check:b,init:200,apply:j}},members:{__IB:null,__IC:null,__kr:null,__ID:null,__IE:null,setPrefetchX:function(n,o,p,q){this.__IB=[n,o,p,q];
},setPrefetchY:function(r,s,t,u){this.__IC=[r,s,t,u];
},_onInterval:function(){var v=this.__IB;
...
qx.ui.core.queue.Manager.flush();
}},_applyScroller:function(x,y){if(y){if(this.__ID){y.getChildControl(c).removeListenerById(this.__ID);
}
if(this.__IE){y.getChildControl(a).removeListenerById(this.__IE);
}}
if(x){if(!x.getContainerElement().getDomElement()){this.__kr.stop();
x.addListenerOnce(i,this.__kr.start,this.__kr);
}else{this.__kr.restart();
}this.__ID=x.getChildControl("scrollbar-x").addListener("scroll",this.__kr.restart,this.__kr);
this.__IE=x.getChildControl("scrollbar-y").addListener("scroll",this.__kr.restart,this.__kr);
}else{this.__kr.stop();
}},_applyInterval:function(z,A){this.__kr.setInterval(z);
