...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellSpan","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellSpan-qx.theme.Simple.1e48bd8949cb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="yellow",i="bold",h="table-scroller-header",g="green",f="__NA",e=" / ",d="Widget Cells",c="demobrowser.demo.virtual.CellSpan",b="HTML Cells",a="x";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__NA:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__NA.setBackgroundColor(s);
return this.__NA.getCellProperties(q+e+r);
...
},__Hl:function(A,B,C,D,top,E,F){var H=this._cellProvider.getCellProperties(B,C);
var G=H.insets||[0,0];
...
var W=R[i];
this.__Hl(U,S.firstRow,S.firstColumn,W.left,W.top,W.width,W.height);
}}else{O=[];
...
if(!O[N][T]){this.__Hl(U,N,T,V,top,P,M);
}T++;
V+=P;
}top+=M;
N++;
...
}return this.__CA(J,M);
},__CA:function(N,O){var P=[];
...
this.__AP=[];
this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__Iu());
...
},__AP:null,setCellSpan:function(u,v,w,x){var y=u+d+v;
this._spanManager.removeCell(y);

if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);
}qx.ui.core.queue.Widget.add(this);
},__Iu:function(){var self=this;
...
return z;
},__Iv:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);
...
}}},__Iw:function(){var O=this.getChildren();
...
this._add(L);
}}},_fullUpdate:function(P,Q,R,S){this.__Iv(P,Q,R.length,S.length);
this.__Iw();
this._cellLayer.fullUpdate(P,Q,R,S);
},_updateLayerWindow:function(T,U,V,W){this.__Iv(T,U,V.length,W.length);
this.__Iw();
...
this._cellProvider=this.__AP=this._cells=this._bounds=this._spanMap=null;
}});
})();
