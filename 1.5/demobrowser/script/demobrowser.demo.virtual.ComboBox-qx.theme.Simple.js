...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ComboBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox-qx.theme.Simple.3860bd17e6a5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.virtual.ComboBox",b="os.name",a="engine.version";
...
this.__AP=[];
},properties:{anonymous:{refine:true,init:false}},events:{updated:b},members:{__AP:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;
...
}},_getSpacer:function(){var r=this.__AP.pop();
...
if(E.getUserData(g)){this.__AP.push(E);
...
if(W.getUserData(g)){this.__AP.push(W);
...
(function(){var w="textfield",v="value",u="dropdown",t="button",s="inner",r="list",q="change",p="_applyValue",o="select",n="Function",e="",m="Enter",h="qx.debug",c="virtual-combobox",b="click",g="_applyPlaceholder",f="single",j="changeValue",a="qx.ui.form.VirtualComboBox",k="String",d="converter";
qx.Class.define(a,{extend:qx.ui.form.core.AbstractVirtualBox,implement:[qx.ui.form.IStringForm],construct:function(x){qx.ui.form.core.AbstractVirtualBox.call(this,x);
var y=this._createChildControl(w);
this._createChildControl(t);
var z=this.getChildControl(u);
z.getChildControl(r).setSelectionMode(f);
this.__iC=z.getSelection();
this.__iC.addListener(q,this.__Ip,this);
this.bind(v,y,v);
y.bind(v,this,v);
if(qx.core.Environment.get(h)){qx.log.Logger.deprecateMethodOverriding(this,qx.ui.form.VirtualComboBox,p);
}},properties:{appearance:{refine:true,init:c},width:{refine:true,init:120},value:{nullable:true,event:j,apply:p},placeholder:{check:k,nullable:true,apply:g},defaultFormat:{check:n,init:null,nullable:true}},members:{__In:null,__Io:null,__iC:null,__Bc:null,getTextSelection:function(){return this.getChildControl(w).getTextSelection();
...
this._add(F,{flex:1});
break;
case t:F=new qx.ui.form.Button();
F.setFocusable(false);
...
switch(G){case o:this.setValue(this.getChildControl(w).getValue());
break;
...
var J=this.getChildControl(u).isVisible();
...
if(L==this.getChildControl(t)){this.toggle();
}else{this.close();
}},__Ip:function(event){if(this.__Bc==true){return;
}var M=this.__iC.getItem(0);
M=this.__ko(M);
this.setValue(M);
},_applyValue:function(N,O){},_applyPlaceholder:function(P,Q){this.getChildControl(w).setPlaceholder(P);
},__Iq:function(){var T=this.getValue();
var S=this.getChildControl(u);
var R=S.getSelection();

if(this.__ko(R.getItem(0))!==T){this.__Bc=true;
R.removeAll();
this.__Bc=false;
if(T==null||T==e){return;
}var X=this.getModel();
var W=S.getChildControl(r)._getLookupTable();

for(var i=0,l=W.length;i<l;i++){var U=X.getItem(W[i]);
var V=this.__ko(U);

if(V&&V.indexOf(T)==0){S.setPreselected(U);
break;
}}}},__ko:function(Y){var bb=this.getLabelOptions();
var ba=this.getDefaultFormat();
var bd=this.getLabelPath();
var bc=null;

if(bd!=null){bc=qx.data.SingleValueBinding.getValueFromObject(Y,bd);
}else if(qx.lang.Type.isString(Y)){bc=Y;
}var be=qx.util.Delegate.getMethod(bb,d);

if(be!=null){bc=be(bc);
}
if(bc!=null&&ba!=null){bc=ba(qx.lang.String.stripTags(bc));
}return bc;
}},destruct:function(){var bf=this.getChildControl(w);
this.removeAllBindings();
bf.removeAllBindings();
this.__iC.removeListener(q,this.__Ip,this);
this.__iC=null;
}});
})();
