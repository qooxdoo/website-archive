...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Save_Dialog","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Save_Dialog-qx.theme.Classic.9c222f4cab03.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.animation.Save_Dialog",b="os.name",a="engine.version";
...
(function(){var r="execute",q="__LU",p="middle",o="Cancel",n="demobrowser.demo.animation.Save_Dialog",m="appear",l="Your changes will be lost if you don't save them.",k="close",j="__LS",h="__ub",c="__LT",g="center",f="Save...",b='<b "font-size:12pt;">Do you want to save the changes you made in the doc "Untitled"?</b>',a="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",e="right",d="Don't save";
qx.Class.define(n,{extend:qx.application.Standalone,members:{__LS:null,__LT:null,__LU:null,__ub:null,__LV:function(){if(qx.core.Environment.get("engine.name")=="mshtml"){this.__LS=new qx.fx.effect.core.Fade(this.__LT.getContainerElement().getDomElement()).set({from:0,to:1});
this.__LU=new qx.fx.effect.core.Fade(this.__LT.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__LS=new qx.fx.effect.combination.Grow(this.__LT.getContainerElement().getDomElement());
this.__LU=new qx.fx.effect.combination.Shrink(this.__LT.getContainerElement().getDomElement());
}},showDialog:function(){this.__LT.setZIndex(1);
this.__LS.start();
},hideDialog:function(){this.__LU.start();
},main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__ub=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__ub.setLayout(new qx.ui.layout.VBox());
t.add(this.__ub,{left:40,top:40});
var x=new qx.ui.form.Button(k);
x.set({allowStretchX:false,alignX:e,marginBottom:15});
x.addListener(r,this.showDialog,this);
this.__ub.add(x);
var z=a;
var v=new qx.ui.form.TextArea(z);
v.set({width:400,height:250});
this.__ub.add(v);
var y=new qx.ui.layout.Grid(3,4);
y.setColumnWidth(0,120);
y.setColumnWidth(1,110);
y.setColumnWidth(2,110);
y.setRowHeight(2,10);
y.setRowAlign(3,g,p);
this.__LT=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__LT.setLayout(y);
t.add(this.__LT,{left:65,top:125});
this.__LT.addListenerOnce(m,this.__LV,this);
var A=new qx.ui.basic.Label(b);
var u=new qx.ui.basic.Label(l);
A.setRich(true);
this.__LT.add(A,{row:0,column:0,colSpan:3});
this.__LT.add(u,{row:1,column:0,colSpan:3});
var w=[d,o,f];

for(var i=0;i<w.length;i++){var s=new qx.ui.form.Button(w[i]);
s.setAllowStretchX(false);
this.__LT.add(s,{row:3,column:i});
s.addListener(r,this.hideDialog,this);
}}},destruct:function(){this._disposeObjects(h,c,j,q);
}});
})();
...
this.__ty=qx.fx.Base.EffectState.IDLE;
this.__iI=u;
},events:{"setup":s,"update":s,"finish":s},properties:{duration:{init:0.5,check:t,apply:g},fps:{init:100,check:t},sync:{init:false,check:o},from:{init:0,check:t},to:{init:1,check:t},delay:{init:0.0,check:t},queue:{check:i,dereference:true},transition:{init:q,check:[q,f,c,k,p,d,h,j,b,m,e]}},statics:{EffectState:{IDLE:'idle',PREPARING:'preparing',RUNNING:'running'}},members:{__ty:null,__tz:null,__tA:null,__tB:null,__tC:null,__tD:null,__tE:null,__tF:null,__iI:null,_getElement:function(){return this.__iI;
},_setElement:function(v){this.__iI=v;
},_applyDuration:function(w,x){},init:function(){this.__ty=qx.fx.Base.EffectState.PREPARING;
this.__tz=0;
this.__tA=this.getDelay()*1000+(new Date().getTime());
this.__tB=this.__tA+(this.getDuration()*1000);
this.__tC=this.getTo()-this.getFrom();
this.__tD=this.__tB-this.__tA;
this.__tE=this.getFps()*this.getDuration();
...
},start:function(){if(this.__ty!=qx.fx.Base.EffectState.IDLE){return false;
}this.init();
...
this.afterFinish();
},render:function(z){if(this.__ty==qx.fx.Base.EffectState.PREPARING){this.__ty=qx.fx.Base.EffectState.RUNNING;
...
if(this.__ty==qx.fx.Base.EffectState.RUNNING){this.__tF=qx.fx.Transition.get(this.getTransition())(z)*this.__tC+this.getFrom();
this.beforeUpdateInternal();
this.beforeUpdate();
this.update(this.__tF);
this.afterUpdateInternal();
this.afterUpdate();

if(this.hasListener(r)){this.fireEvent(r);
}}},loop:function(A){if(A>=this.__tA){if(A>=this.__tB){this.end();
}var C=(A-this.__tA)/this.__tD;
var B=Math.round(C*this.__tE);
if(B>this.__tz){this.render(C);
this.__tz=B;
}}},cancel:function(){if(!this.getSync()){this.getQueue().remove(this);
}this.__ty=qx.fx.Base.EffectState.IDLE;
},resetState:function(){this.__ty=qx.fx.Base.EffectState.IDLE;
},isActive:function(){return this.__ty===qx.fx.Base.EffectState.RUNNING||this.__ty===qx.fx.Base.EffectState.PREPARING;
}},destruct:function(){this.__iI=this.__ty=null;
}});
})();
(function(){var e="__default",d="qx.fx.queue.Manager",c="__gw",b="singleton",a="object";
qx.Class.define(d,{extend:qx.core.Object,type:b,construct:function(){qx.core.Object.call(this);
this.__gw={};
},members:{__gw:null,getQueue:function(f){if(typeof (this.__gw[f])==a){return this.__gw[f];
}else{return this.__gw[f]=new qx.fx.queue.Queue;
...
this.__tG=[];
},properties:{limit:{init:Infinity,check:a}},members:{__tH:null,__tG:null,add:function(c){var d=new Date().getTime();
c._startOn+=d;
c._finishOn+=d;

if(this.__tG.length<this.getLimit()){this.__tG.push(c);
}else{c.resetState();
}
if(!this.__tH){this.__tH=qx.lang.Function.periodical(this.loop,15,this);
}},remove:function(e){qx.lang.Array.remove(this.__tG,e);

if(this.__tG.length==0){window.clearInterval(this.__tH);
delete this.__tH;
}},loop:function(){var f=new Date().getTime();

for(var i=0,g=this.__tG.length;i<g;i++){this.__tG[i]&&this.__tG[i].loop(f);
...
(function(){var j="sinodial",i="px",h="flicker",g="0px",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",J="easeInQuad",I="reverse",H="none",G="overflow",F="linear",E="height",D='bottom-left',C='top-left',B='bottom-right',A="bottom-right",q="qx.fx.effect.combination.Grow",r="__yW",o="bottom-left",p="visible",m="__yX",n="width",k="top-left",l="__yV",s="top",t="top-right",v='top-right',u="block",x='center',w="hidden",z="left",y="display";
qx.Class.define(q,{extend:qx.fx.Base,construct:function(K){qx.fx.Base.call(this,K);
this.__yV=new qx.fx.effect.core.Move(K);
this.__yW=new qx.fx.effect.core.Scale(K);
this.__yX=new qx.fx.effect.core.Parallel(this.__yV,this.__yW);
},properties:{direction:{init:f,check:[k,t,o,A,f]},scaleTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]},moveTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]}},members:{__yW:null,__yV:null,__yX:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
...
this.__yW.afterFinishInternal=function(){var S;
...
break;
}this.__yV.set({x:P,y:Q,sync:true,transition:this.getMoveTransition()});
this.__yW.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[N.width,N.height]});
...
this.__yX.setDuration(this.getDuration());
this.__yX.start();
}},destruct:function(){this._disposeObjects(l,r,m);
}});
})();
(function(){var i="position",h="px",g="relative",f="Number",e="absolute",d="top",c="left",b='absolute',a="qx.fx.effect.core.Move";
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:g,check:[g,e]},x:{init:0,check:f},y:{init:0,check:f}},members:{__tI:null,__tJ:null,__tK:null,__tL:null,__tM:null,setup:function(){var j=this._getElement();
qx.fx.Base.prototype.setup.call(this);

if(j.parentNode){this.__tK=qx.bom.element.Location.getLeft(j)-qx.bom.element.Location.getLeft(j.parentNode);
this.__tL=qx.bom.element.Location.getTop(j)-qx.bom.element.Location.getTop(j.parentNode);
}else{this.__tK=qx.bom.element.Location.getLeft(j);
this.__tL=qx.bom.element.Location.getTop(j);
}this.__tM=qx.bom.element.Style.get(j,i);
qx.bom.element.Style.set(j,i,e);

if(this.getMode()==b){this.__tI=this.getX()-this.__tK;
this.__tJ=this.getY()-this.__tL;
}else{this.__tI=this.getX();
this.__tJ=this.getY();
}},update:function(k){var m=this._getElement();
qx.fx.Base.prototype.update.call(this);
var l=Math.round(this.__tI*k+this.__tK);
var top=Math.round(this.__tJ*k+this.__tL);
qx.bom.element.Style.set(m,c,l+h);
qx.bom.element.Style.set(m,d,top+h);
},afterFinishInternal:function(){qx.bom.element.Style.set(this._getElement(),i,this.__tM);
}}});
})();
...
this.__yY=qx.fx.effect.core.Scale.originalStyle;
this.__za=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:p},scaleY:{init:true,check:p},scaleContent:{init:true,check:p},scaleFromCenter:{init:true,check:p},scaleFrom:{init:100.0,check:o},scaleTo:{init:100,check:o},restoreAfterFinish:{init:false,check:p},alternateDimensions:{init:[],check:k}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':c,'px':q,'%':f,'pt':h}},members:{__zb:null,__tL:null,__tK:null,__zc:null,__zd:null,__ze:null,__zf:null,__yY:null,__za:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var w=this._getElement();
this.__zb=qx.bom.element.Style.get(w,g);

for(var u in this.__yY){this.__yY[u]=w.style[u];
}this.__tL=qx.bom.element.Location.getTop(w);
this.__tK=qx.bom.element.Location.getLeft(w);

try{var v=qx.bom.element.Style.get(w,n);
}catch(x){if(typeof (v)!=a){v=(qx.core.Environment.get(l)==m)?i:b;
}}
for(var s in this.__za){if(v.indexOf(s)>0){this.__zc=parseFloat(v);
this.__zd=s;
break;
}}this.__ze=(this.getScaleTo()-this.getScaleFrom())/100;
var t=this.getAlternateDimensions();

if(t.length==0){this.__zf=[w.offsetWidth,w.offsetHeight];
}else{this.__zf=t;
}},update:function(y){var A=this._getElement();
qx.fx.Base.prototype.update.call(this);
var z=(this.getScaleFrom()/100.0)+(this.__ze*y);

if(this.getScaleContent()&&this.__zc){qx.bom.element.Style.set(A,n,this.__zc*z+this.__zd);
}this._setDimensions(this.__zf[0]*z,this.__zf[1]*z);
},finish:function(){qx.fx.Base.prototype.finish.call(this);
var D=this._getElement();

if(this.getRestoreAfterFinish()){for(var B in this.__yY){var C=this.__yY[B];
...
if(this.getScaleFromCenter()){var K=(E-this.__zf[0])/2;
var L=(F-this.__zf[1])/2;

if(this.__zb==e){if(I){d.top=this.__tL-L+q;
}
if(H){d.left=this.__tK-K+q;
}}else{if(I){d.top=-L+q;
}
if(H){d.left=-K+q;
}}}
for(var G in d){qx.bom.element.Style.set(J,G,d[G]);
}}},destruct:function(){this.__zf=this.__yY=this.__za=null;
}});
})();
(function(){var b="qx.fx.effect.core.Parallel",a="__tG";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(c){qx.fx.Base.call(this);
this.__tG=arguments;
},members:{__tG:null,finish:function(){qx.fx.Base.prototype.finish.call(this);
var d=this.__tG;
...
(function(){var j="sinodial",i="none",h="overflow",g="flicker",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",G="easeInQuad",F="reverse",E="linear",D="scroll",C="Boolean",B="px",A='bottom-left',z='top-left',y='bottom-right',x="bottom-right",q="opacity",r="__yW",o="bottom-left",p="visible",m="qx.fx.effect.combination.Shrink",n="__yX",k="top-left",l="__yV",s="top-right",t='top-right',v='center',u="hidden",w="display";
qx.Class.define(m,{extend:qx.fx.Base,construct:function(H){qx.fx.Base.call(this,H);
this.__yV=new qx.fx.effect.core.Move(H);
this.__yW=new qx.fx.effect.core.Scale(H);
this.__yX=new qx.fx.effect.core.Parallel(this.__yV,this.__yW);
},properties:{direction:{init:f,check:[k,s,o,x,f]},moveTransition:{init:j,check:[E,G,a,j,F,g,b,e,d,i,c]},scaleTransition:{init:j,check:[E,G,a,j,F,g,b,e,d,i,c]},modifyDisplay:{init:true,check:C}},members:{__zl:null,__yV:null,__yW:null,__yX:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
...
for(var I in this.__zl){J=this.__zl[I];
...
var L,M;
this.__zl={top:qx.bom.element.Location.getTop(N,D),left:qx.bom.element.Location.getLeft(N,D),width:qx.bom.element.Dimension.getContentWidth(N),height:qx.bom.element.Dimension.getContentHeight(N),opacity:qx.bom.element.Style.get(N,q)};

switch(this.getDirection()){case z:L=M=0;
break;
case t:L=this.__zl.width;
M=0;
break;
case A:L=0;
M=this.__zl.height;
break;
case y:L=this.__zl.width;
M=this.__zl.height;
break;
case v:L=this.__zl.width/2;
M=this.__zl.height/2;
break;
}this.__yV.set({x:L,y:M,sync:true,transition:this.getMoveTransition()});
this.__yW.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__yX.setDuration(this.getDuration());
this.__yX.start();
}},destruct:function(){this._disposeObjects(l,r,n);
}});
})();
...
(function(){var k="overflowY",j="engine.name",i="hidden",h="auto",g="textarea",f="width",d="webkit",c="Boolean",b="Integer",a="input",A="",z="appear",y="mshtml",x="qx.debug",w="px",v="_applyWrap",u="-1",t="_applyMinimalLineHeight",s="mousewheel",r="y",p="_applyAutoSize",q="tabIndex",n='name',o="qx.ui.form.TextArea",l='id',m="absolute";
...
},properties:{wrap:{check:c,init:true,apply:v},appearance:{refine:true,init:g},singleStep:{check:b,init:20},minimalLineHeight:{check:b,apply:t,init:4},autoSize:{check:c,apply:p,init:false}},members:{__vA:null,__vB:null,__vC:null,setValue:function(C){C=qx.ui.form.AbstractField.prototype.setValue.call(this,C);
this.__vD();
return C;
},_onMousewheel:function(e){var D=this.getContentElement();
var scrollY=D.getScrollY();
D.scrollToY(scrollY+e.getWheelDelta(r)*this.getSingleStep());
var E=D.getScrollY();

if(E!=scrollY){e.stop();
}},__vD:function(){if(this.isAutoSize()){var H=this.__vE();

if(H){this.__vC=this.__vC||this._getAreaHeight();
var J=this._getScrolledAreaHeight();
if(this.getMaxHeight()){var F=this.getInsets();
var G=-F.top+this.getMaxHeight()-F.bottom;

if(J>G){this.getContentElement().setStyle(k,h);
}else{this.getContentElement().setStyle(k,i);
}}var I=Math.max(J,this.__vC);
this._setAreaHeight(I);
}else{this.addListenerOnce(z,function(){if(qx.core.Environment.get(j)==d){var L=this.getContentElement();
var K=this.getValue();
L.setStyle(k,i,true);
this.setValue(A);
this.setValue(K);
...
},_setAreaHeight:function(M){if(this._getAreaHeight()!==M){this.__vB=M;
qx.ui.core.queue.Layout.add(this);
qx.ui.core.queue.Manager.flush();
this.__vH();
}},_getScrolledAreaHeight:function(){var O=this.__vE();
var N=O.getDomElement();

if(N){if(!N.parentNode){qx.html.Element.flush();
return this._getScrolledAreaHeight();
}if(qx.core.Environment.get(j)===d){O.setWrap(!this.getWrap(),true);
}O.setWrap(this.getWrap(),true);
if(qx.core.Environment.get(j)==d){N.style.overflow=i;
}if(qx.core.Environment.get(j)==y){N.style.overflow=A;
}O.setValue(this.getValue());
this.__vG(O);

if(qx.core.Environment.get(j)==y){if(!N.scrollTop){qx.html.Element.flush();
}return N.scrollTop+this._getTextSize().height;
}return N.scrollTop;
}},__vE:function(){this.__vA=this.__vA||this.__vF();
return this.__vA;
},__vF:function(){var S,Q,P,R;
S=this.getContentElement();
if(!S.getDomElement()){return;
}P=qx.bom.Collection.create(S.getDomElement()).clone()[0];
R=new qx.html.Input(g);
R.useElement(P);
Q=R;
Q.setStyles({position:m,top:0,left:-9999,height:0,overflow:i},true);
Q.removeAttribute(l);
Q.removeAttribute(n);
Q.setAttribute(q,u);
...
this.__vG(Q);
return Q;
},__vG:function(T){T=T.getDomElement();

if(T){T.scrollTop=10000;
}},_createInputElement:function(){return new qx.html.Input(g,{overflowX:h,overflowY:h});
},_applyWrap:function(U,V){this.getContentElement().setWrap(U);
this.__vD();
},_applyMinimalLineHeight:function(){qx.ui.core.queue.Layout.add(this);
},_applyAutoSize:function(W,X){if(qx.core.Environment.get(x)){this.__vI();
}
if(W){this.__vD();
this.addListener(a,this.__vD,this);
this.addListenerOnce(z,function(){this.getContentElement().setStyle(k,i);
});
}else{this.removeListener(a,this.__vD);
this.getContentElement().setStyle(k,h);
}},_applyDimension:function(Y){qx.ui.form.AbstractField.prototype._applyDimension.call(this);

if(qx.core.Environment.get(x)){this.__vI();
}
if(Y===this.getMaxHeight()){this.__vD();
}},__vH:function(){var content=this.getContentElement();
var bb=content.getDomElement();
var ba=content.getStyle(f);
content.setStyle(f,parseInt(ba,10)+1000+w,true);
if(bb){qx.bom.element.Dimension.getWidth(bb);
}content.setStyle(f,ba,true);
...
}},_getContentHint:function(){var bc=qx.ui.form.AbstractField.prototype._getContentHint.call(this);
bc.height=bc.height*this.getMinimalLineHeight();
bc.width=this._getTextSize().width*20;

if(this.isAutoSize()){bc.height=this.__vB||bc.height;
}return bc;
}}});
})();
...
qx.Class.define(b,{statics:{__rR:/\s+/g,__rS:/^\s+|\s+$/g,add:qx.lang.Object.select(qx.core.Environment.get(t)?r:s,{"native":function(u,name){u.classList.add(name);
return name;
...
return N.className=N.className.replace(P,q).replace(this.__rS,q).replace(this.__rR,p);
...
if(w&&w.nodeType){return this.__vN([w]);
}else{return w;
}}return null;
};
};
...
},__vJ:/^[^<]*(<(.|\s)+>)[^>]*$|^#([\w-]+)$/,create:function(G,H){var J=qx.bom.Collection;
if(G.nodeType){return new J(G);
}else if(typeof G==="string"){var I=J.__vJ.exec(G);
...
},__vL:/^.[^:#\[\.,]*$/,not:function(ba){if(this.__vL.test(ba)){var bb=qx.bom.Selector.matches(":not("+ba+")",this);
return this.__vN(bb);
...
return this.__vN(qx.lang.Array.unique(bl));
...
if(this.length===1){return this.__vN(bs.query(bq,this[0]));
}else{var br=[];

for(var i=0,l=this.length;i<l;i++){br.push.apply(br,bs.query(bq,this[i]));
}return this.__vN(qx.lang.Array.unique(br));
...
},nextAll:function(bw){return this.__vM("getNextSiblings",bw);
...
},prevAll:function(bA){return this.__vM("getPreviousSiblings",bA);
...
},parents:function(bD){return this.__vM("getAncestors",bD);
},siblings:function(bE){return this.__vM("getSiblings",bE);
},__vM:function(bF,bG){var bI=[];
...
},__vN:function(bK){var bL=new qx.bom.Collection;
bL.__vK=this;
...
},__vO:function(bM,bN){var bS=this[0];
...
},__vP:function(bX,bY){var cb=qx.bom.Selector;
...
},append:function(ce){return this.__vO(arguments,this.__vQ);
},prepend:function(cf){return this.__vO(arguments,this.__vR);
},__vQ:function(cg,ch){cg.appendChild(ch);
},__vR:function(ci,cj){ci.insertBefore(cj,ci.firstChild);
},appendTo:function(ck){return this.__vP(arguments,"append");
},prependTo:function(cl){return this.__vP(arguments,"prepend");
},before:function(cm){return this.__vO(arguments,this.__vS);
},after:function(cn){return this.__vO(arguments,this.__vT);
},__vS:function(co,cp){co.parentNode.insertBefore(cp,co);
},__vT:function(cq,cr){cq.parentNode.insertBefore(cr,cq.nextSibling);
},insertBefore:function(cs){return this.__vP(arguments,"before");
},insertAfter:function(ct){return this.__vP(arguments,"after");
...
}cu.map(this.__vU).append(this);
}return this;
},__vU:function(cw){while(cw.firstChild){cw=cw.firstChild;
}return cw;
...
},replaceAll:function(cz){return this.__vP(arguments,"replaceWith");
