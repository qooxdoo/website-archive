...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Iframe","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Iframe-qx.theme.Classic.95dc7f02d903.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.event.Event_Iframe";
...
var o=qx.bom.Iframe.create({name:m,src:b});
o.id=m;
document.body.appendChild(o);
qx.event.Registration.addListener(o,d,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var r=window.document.getElementById(m);
var q=qx.bom.Iframe.getDocument(r);
this._juhu=q.getElementById(h);
this._inner=q.getElementById(k);
...
qx.event.Registration.addListener(q.getElementById(f),c,this._onkeydown,this);

for(var i=1;i<10;i++){var p=q.getElementById(j+i);
qx.event.Registration.addListener(p,n,this._cascadeCapture,this,true);
qx.event.Registration.addListener(p,n,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(q.getElementById(l),l,this._scroll,this);
},_onkeydown:function(e){this.debug("keydown: "+e.getKeyIdentifier());
},_scroll:function(e){this.debug("scroll");
},_cascadeCapture:function(e){var s=e.getCurrentTarget();
this.debug("capture: "+s.id+" "+e.getEventPhase());
},_cascadeBubble:function(e){var t=e.getCurrentTarget();
this.debug("bubble: "+t.id+" "+e.getEventPhase());
