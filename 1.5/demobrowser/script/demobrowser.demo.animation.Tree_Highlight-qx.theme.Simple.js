...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Tree_Highlight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Tree_Highlight-qx.theme.Simple.a207ef5e2cff.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.animation.Tree_Highlight",b="os.name",a="engine.version";
...
(function(){var k="execute",j="appear",h="changeSelection",g="Trash",f="mode",e="Windows (C:)",d="Documents (D:)",c="Add before",b="Add after",a="Add at begin",K="Inbox",J="Desktop",I="Show open button:",H="New tree item name: ",G="auto",F="Hello",E="Presets",D="Data 123213234325345234523453453245",C="demobrowser.demo.animation.Tree_Highlight",B="Network",r="Control",s="Sent",p="Files",q="Remove tree item",n="Add file",o="Workspace",l="Junk #",m="Tree",t="never",u="Add folder",w="Root",v="always",y="Move to parent",x="Reset tree",A="Edit",z="Remove all children";
...
this._container=new qx.ui.container.Composite(new qx.ui.layout.HBox().set({spacing:20})).set({padding:30});
this.getRoot().add(this._container);
var L=new qx.ui.groupbox.GroupBox(m).set({contentPadding:[4,4,4,4]});
L.setLayout(new qx.ui.layout.Canvas());
this._container.add(L);
this._treeGroup=L;
var M=this.getTree();
L.add(M,{edge:0});
this._tree=M;
this._container.add(this.getCommandFrame());
},getTree:function(){var W=new qx.ui.tree.Tree().set({width:200,height:400});
var bc=new qx.ui.tree.TreeFolder(w);
bc.setOpen(true);
W.setRoot(bc);
var ba=new qx.ui.tree.TreeFolder(J);
ba.setOpen(true);
bc.add(ba);
var R=new qx.ui.tree.TreeFolder(p);
var P=new qx.ui.tree.TreeFolder(o);
var Q=new qx.ui.tree.TreeFolder(B);
var O=new qx.ui.tree.TreeFolder(g);
ba.add(R,P,Q,O);
var X=new qx.ui.tree.TreeFile(e);
var N=new qx.ui.tree.TreeFile(d);
P.add(X,N);
var bb=new qx.ui.tree.TreeFolder(K);
var S=new qx.ui.tree.TreeFolder(E);
var V=new qx.ui.tree.TreeFolder(s);
var U=new qx.ui.tree.TreeFolder(g);

for(var i=0;i<100;i++){U.add(new qx.ui.tree.TreeFile(l+i));
}var Y=new qx.ui.tree.TreeFolder(D);
var T=new qx.ui.tree.TreeFolder(A);
bb.add(S,V,U,Y,T);
bc.add(bb);
return W;
},getCommandFrame:function(){var bf=new qx.ui.groupbox.GroupBox(r);
bf.setLayout(new qx.ui.layout.Grid(3,5));
var bh=0;
bf.add(new qx.ui.basic.Label(H).set({paddingTop:4}),{row:bh,column:0});
this.inputItemName=new qx.ui.form.TextField(F);
bf.add(this.inputItemName,{row:bh++,column:1});
this.btnAddFolder=new qx.ui.form.Button(u);
this.btnAddFolder.addListener(k,this._addFolder,this);
bf.add(this.btnAddFolder,{row:bh++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(n);
this.btnAddFile.addListener(k,this._addFile,this);
bf.add(this.btnAddFile,{row:bh++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(b);
this.btnAddAfter.addListener(k,this._addAfter,this);
bf.add(this.btnAddAfter,{row:bh++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(c);
this.btnAddBefore.addListener(k,this._addBefore,this);
bf.add(this.btnAddBefore,{row:bh++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(a);
this.btnAddBegin.addListener(k,this._addBegin,this);
bf.add(this.btnAddBegin,{row:bh++,column:0,colSpan:2});
bf.add(new qx.ui.core.Spacer(5,5),{row:bh++,column:0});
this.btnRemove=new qx.ui.form.Button(q);
this.btnRemove.addListener(k,this._removeTreeItem,this);
bf.add(this.btnRemove,{row:bh++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(z);
this.btnRemoveAll.addListener(k,this._removeAll,this);
bf.add(this.btnRemoveAll,{row:bh++,column:0,colSpan:2});
bf.add(new qx.ui.core.Spacer(5,5),{row:bh++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(y);
this.btnMoveToParent.addListener(k,this._moveToParent,this);
bf.add(this.btnMoveToParent,{row:bh++,column:0,colSpan:2});
bf.add(new qx.ui.core.Spacer(5,5),{row:bh++,column:0});
bf.add(new qx.ui.basic.Label(I),{row:bh,column:0});
var bd=[v,t,G];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<bd.length;i++){var bg=bd[i];
var be=new qx.ui.form.RadioButton(bg).set({value:bg==this._tree.getRootOpenClose()});
be.setUserData(f,bg);
this.showOpenButtons[bg]=be;
this.mgrShowRootOpen.add(be);
bf.add(be,{row:bh++,column:1});
}this.mgrShowRootOpen.addListener(h,this._onChangeShowOpen,this);
bf.add(new qx.ui.core.Spacer(5,5),{row:bh++,column:0});
this.btnReset=new qx.ui.form.Button(x);
this.btnReset.addListener(k,this._resetTree,this);
bf.add(this.btnReset,{row:bh++,column:0,colSpan:2});
this._tree.addListener(h,this._updateControls,this);
this._updateControls();
return bf;
},_addFolder:function(){var bi=this._tree.getSelection()[0];
var bj=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
bj.addListenerOnce(j,function(){var bk=new qx.fx.effect.core.Highlight(bj.getContainerElement().getDomElement());
bk.start();
},this);
bi.setOpen(true);
bi.add(bj);
},_addFile:function(){var bl=this._tree.getSelection()[0];
var bm=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bm.addListenerOnce(j,function(){var bn=new qx.fx.effect.core.Highlight(bm.getContainerElement().getDomElement());
bn.start();
},this);
bl.setOpen(true);
bl.add(bm);
},_addBefore:function(){var bo=this._tree.getSelection()[0];
var bp=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bp.addListenerOnce(j,function(){var bq=new qx.fx.effect.core.Highlight(bp.getContainerElement().getDomElement());
bq.start();
},this);
bo.getParent().addBefore(bp,bo);
},_addAfter:function(){var br=this._tree.getSelection()[0];
var bs=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bs.addListenerOnce(j,function(){var bt=new qx.fx.effect.core.Highlight(bs.getContainerElement().getDomElement());
bt.start();
},this);
br.getParent().addAfter(bs,br);
},_addBegin:function(){var bu=this._tree.getSelection()[0];
var bv=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bv.addListenerOnce(j,function(){var bw=new qx.fx.effect.core.Highlight(bv.getContainerElement().getDomElement());
bw.start();
},this);
bu.getParent().addAtBegin(bv);
},_removeTreeItem:function(){var bx=this._tree.getSelection()[0];
var parent=bx.getParent();
parent.remove(bx);
},_removeAll:function(){var by=this._tree.getSelection()[0];
by.removeAll();
},_moveToParent:function(){var bz=this._tree.getSelection()[0];
var parent=bz.getParent();
parent.remove(bz);
parent.getParent().add(bz);
this._updateControls();
},_onChangeShowOpen:function(){var bA=this._tree.getSelection()[0];

if(bA!=null){var bB=this.mgrShowRootOpen.getSelection()[0].getUserData(f);
bA.setOpenSymbolMode(bB);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(j,function(){this._tree.addListener(h,this._updateControls,this);
},this);
},_updateControls:function(){var bC=this._tree.getSelection()[0];

if(!bC){this.btnAddFolder.setEnabled(false);
...
var bD=bF==-1;
var bE=bC instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(bE);
this.btnAddFile.setEnabled(bE);
this.btnAddBefore.setEnabled(!bD);
this.btnAddAfter.setEnabled(!bD);
this.btnAddBegin.setEnabled(!bD);
this.btnRemove.setEnabled(!bD);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(bE);
this.showOpenButtons[bC.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(bF>0);
}},destruct:function(){this._container=this._treeGroup=this._tree=this.inputItemName=this.btnAddFolder=this.btnAddFile=this.btnAddAfter=this.btnAddBefore=this.btnAddBegin=this.btnRemove=this.btnRemoveAll=this.btnMoveToParent=this.showOpenButtons=this.mgrShowRootOpen=this.btnReset=null;
}});
})();
...
(function(){var m="qx.debug",k="visible",j="excluded",h="qx.ui.tree.core.AbstractTreeItem",g="open",f="abstract",e="addItem",d="removeItem",c="Invalid child index: ",b="__iU",a="__rb";
...
this.__iU=[];
},properties:{parent:{check:h,nullable:true}},members:{__iU:null,__rb:null,getTree:function(){var p=this;
...
}}},getChildrenContainer:function(){if(!this.__rb){this.__rb=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?k:j});
}return this.__rb;
...
}},addAt:function(Q,R){if(qx.core.Environment.get(m)){this.assert(R<=this.__iU.length&&R>=0,c+R);
}
if(R==this.__iU.length){this.add(Q);
return;
}var V=Q.getParent();
...
}qx.lang.Array.insertAt(this.__iU,Q,R);

if(!U){this.__rc();
}
if(this.getTree()){Q.recursiveAddToWidgetQueue();
qx.ui.core.queue.Widget.add(this);
}},addBefore:function(W,X){if(qx.core.Environment.get(m)){this.assert(this.__iU.indexOf(X)>=0);
}var Y=W.getParent();

if(Y){Y.remove(W);
}this.addAt(W,this.__iU.indexOf(X));
},addAfter:function(ba,bb){if(qx.core.Environment.get(m)){this.assert(this.__iU.indexOf(bb)>=0);
}var bc=ba.getParent();

if(bc){bc.remove(ba);
}this.addAt(ba,this.__iU.indexOf(bb)+1);
},addAtBegin:function(bd){this.addAt(bd,0);
},remove:function(be){for(var i=0,l=arguments.length;i<l;i++){var bi=arguments[i];

if(this.__iU.indexOf(bi)==-1){this.warn("Cannot remove treeitem '"+bi+"'. It is not a child of this tree item.");
return;
...
}}qx.lang.Array.remove(this.__iU,bi);
bi.setParent(null);
bf.remove(bi);
}var bg=this.getTree();

if(bg){bg.fireNonBubblingEvent(d,qx.event.type.Data,[bi]);
}qx.ui.core.queue.Widget.add(this);
},removeAt:function(bj){var bk=this.__iU[bj];

if(bk){this.remove(bk);
}},removeAll:function(){var bl=this.__iU.concat();
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{startColor:{init:c,check:f},endColor:{init:a,check:f},restoreBackground:{init:true,check:h},keepBackgroundImage:{init:false,check:h}},members:{__zl:null,__zm:null,__zn:null,__zo:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var j=this._getElement();
this.__zl={backgroundImage:qx.bom.element.Style.get(j,g),backgroundColor:qx.bom.element.Style.get(j,i)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,g,e);
}this.__zm=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__zn=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__zo=[this.__zn[0]-this.__zm[0],this.__zn[1]-this.__zm[1],this.__zn[2]-this.__zm[2]];
},update:function(k){qx.fx.Base.prototype.update.call(this);
var l=[this.__zm[0]+Math.round(this.__zo[0]*k),this.__zm[1]+Math.round(this.__zo[1]*k),this.__zm[2]+Math.round(this.__zo[2]*k)];
...
for(var n in this.__zl){qx.bom.element.Style.set(o,n,this.__zl[n]);
