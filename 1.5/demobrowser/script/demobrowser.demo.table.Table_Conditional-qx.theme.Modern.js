...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Conditional","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Conditional-qx.theme.Modern.de5385575c92.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.table.Table_Conditional";
...
qx.Class.define(c,{extend:qx.application.Standalone,include:demobrowser.demo.table.MUtil,members:{__MU:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},showDialog:function(s){if(!this.__MU){var v=this.__MU=new qx.ui.window.Window().set({modal:true,showMinimize:false,showMaximize:false,width:180,contentPadding:[10,10,10,10]});
v.moveTo(315,100);
...
}this.__MU.getChildren()[1].setValue(s);
this.__MU.open();
this.__MU.getChildren()[2].focus();
...
(function(){var j=">",i="",h="#3300CC",g="#BB0044",f="#FF0000",e="icon/16/actions/dialog-ok.png",d="Number 1",c="center",b="Table using conditional cell renderer",a="#DD0022",H="#1100EE",G="demobrowser.demo.table.Table_Conditional",F="#880077",E="#660099",D="#CC0033",C="#AA0055",B="#0000FF",A="#0099FF",z="#5500AA",y="right",q="#990066",r="#00CCFF",o="#EE0011",p="bold",m="#770088",n="#4400BB",k="icon/16/actions/dialog-cancel.png",l="#0033FF",s="Number 2",t="#2200DD",v="#0066FF",u="ID",w="Image";
qx.Class.define(G,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return b;
},createTable:function(){var J=new qx.ui.table.model.Simple();
J.setColumns([u,d,s,w]);
var I=[e,k];
var K=[];

for(var P=0;P<100;P++){var x=Math.random()*1000;
K.push([P,x,x,I[Math.floor(x)%2]]);
}J.setData(K);
J.setColumnEditable(1,true);
J.setColumnEditable(2,true);
var M=new qx.ui.table.Table(J);
M.setMetaColumnCounts([1,-1]);
var N=qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION;
M.getSelectionModel().setSelectionMode(N);
var O=new qx.ui.table.cellrenderer.Conditional(y,i,i,i);
O.addNumericCondition(j,0,null,f,null,null);
O.addNumericCondition(j,50,null,o,null,null);
O.addNumericCondition(j,100,null,a,null,null);
O.addNumericCondition(j,150,null,D,null,null);
O.addNumericCondition(j,200,null,g,null,null);
O.addNumericCondition(j,250,null,C,null,null);
O.addNumericCondition(j,300,null,q,null,null);
O.addNumericCondition(j,350,null,F,null,null);
O.addNumericCondition(j,400,null,m,null,null);
O.addNumericCondition(j,450,null,E,null,null);
O.addNumericCondition(j,500,null,z,null,null);
O.addNumericCondition(j,550,null,n,null,null);
O.addNumericCondition(j,600,null,h,null,null);
O.addNumericCondition(j,650,null,t,null,null);
O.addNumericCondition(j,700,null,H,null,null);
O.addNumericCondition(j,750,null,B,null,null);
O.addNumericCondition(j,800,null,l,null,null);
O.addNumericCondition(j,850,null,v,null,null);
O.addNumericCondition(j,900,null,A,null,null);
O.addNumericCondition(j,950,c,r,null,p);
M.getTableColumnModel().setDataCellRenderer(2,O);
var L=new qx.ui.table.cellrenderer.Image();
M.getTableColumnModel().setDataCellRenderer(3,L);
return M;
}}});
})();
...
for(var I=0;I<z;I++){this.__xF[I]={width:E,headerRenderer:F,dataRenderer:C,editorFactory:B};
this.__xC[I]=I;
this.__xD[I]=I;
}this.__xE=null;
this.__wE=true;
...
this.assertNotUndefined(this.__xF[J],h);
}var N=this.__xF[J].width;

if(N!=K){this.__xF[J].width=K;
...
this.assertNotUndefined(this.__xF[O],h);
}return this.__xF[O].width;
...
this.assertNotUndefined(this.__xF[P],h);
}var R=this.__xF[P].headerRenderer;

if(R!==this.__xG){R.dispose();
}this.__xF[P].headerRenderer=Q;
this.fireDataEvent(o,{col:P});
},getHeaderCellRenderer:function(S){if(qx.core.Environment.get(k)){this.assertInteger(S,j);
this.assertNotUndefined(this.__xF[S],h);
}return this.__xF[S].headerRenderer;
...
this.assertNotUndefined(this.__xF[T],h);
}this.__xF[T].dataRenderer=U;
var V=this.__xF[T].dataRenderer;

if(V!==this.__xH){return V;
}return null;
},getDataCellRenderer:function(W){if(qx.core.Environment.get(k)){this.assertInteger(W,j);
this.assertNotUndefined(this.__xF[W],h);
}return this.__xF[W].dataRenderer;
...
this.assertNotUndefined(this.__xF[X],h);
}var ba=this.__xF[X].headerRenderer;

if(ba!==this.__xI){ba.dispose();
}this.__xF[X].editorFactory=Y;
},getCellEditorFactory:function(bb){if(qx.core.Environment.get(k)){this.assertInteger(bb,j);
this.assertNotUndefined(this.__xF[bb],h);
}return this.__xF[bb].editorFactory;
},_getColToXPosMap:function(){if(this.__xE==null){this.__xE={};

for(var be=0;be<this.__xC.length;be++){var bd=this.__xC[be];
this.__xE[bd]={overX:be};
}
for(var bc=0;bc<this.__xD.length;bc++){var bd=this.__xD[bc];
this.__xE[bd].visX=bc;
}}return this.__xE;
...
for(var x=bo+1;x<this.__xC.length;x++){var bq=this.__xC[x];
var bm=br[bq].visX;

if(bm!=null){bp=bm;
break;
}}if(bp==null){bp=this.__xD.length;
}this.__xD.splice(bp,0,bk);
}else{var bn=this.getVisibleX(bk);
this.__xD.splice(bn,1);
}this.__xE=null;
if(!this.__wE){var bs={col:bk,visible:bl};
...
}this.__xC.splice(bt,1);
this.__xC.splice(bu,0,bx);
this.__xE=null;
...
if(by.length==this.__xC.length){this.__wE=true;
var bB=new Array(by.length);

for(var bz=0;bz<this.__xC.length;bz++){var bA=this.isColumnVisible(bz);
bB[bz]=bA;

if(bA){this.setColumnVisible(bz,false);
}}this.__xC=qx.lang.Array.clone(by);
this.__xE=null;
for(var bz=0;bz<this.__xC.length;bz++){if(bB[bz]){this.setColumnVisible(bz,true);
}}this.__wE=false;
this.fireDataEvent(f);
}else{throw new Error("setColumnsOrder: Invalid number of column positions given, expected "+this.__xC.length+", got "+by.length);
...
},members:{__yG:null,__FI:16,__FH:16,_identifyImage:function(e){var f={imageWidth:this.__FH,imageHeight:this.__FI};

if(e.value==a){f.url=null;
}else{f.url=this.__yG.resolve(e.value);
}f.tooltip=e.tooltip;
return f;
