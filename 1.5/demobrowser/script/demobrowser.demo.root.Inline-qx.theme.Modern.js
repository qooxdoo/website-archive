...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline-qx.theme.Modern.7630e546d12e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.root.Inline",a="engine.version";
...
qx.Class.define(j,{extend:qx.ui.root.Abstract,construct:function(n){this.__nB=n;
qx.ui.root.Abstract.call(this);
this._setLayout(new qx.ui.layout.Basic());
this.setZIndex(10000);
qx.ui.core.queue.Layout.add(this);
this.addListener(k,this.__qm,this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
if((qx.core.Environment.get(m)==i)){this.setKeepFocus(true);
}},members:{__kr:null,__nB:null,_createContainerElement:function(){var p=this.__nB.createElement(l);
this.__nB.body.appendChild(p);
...
},__qm:function(e){this.getContainerElement().setStyles({width:0,height:0});
...
(function(){var i="main",h="black",g="red",f="demobrowser.demo.root.Inline",e="isle",d="green",c="white",b="yellow",a="blue";
qx.Class.define(f,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);
var l=new qx.ui.root.Inline(document.getElementById(e)).set({decorator:i,padding:10,textColor:h,backgroundColor:c});
var m=new qx.ui.core.Widget().set({backgroundColor:g,decorator:i,padding:10});
var n=new qx.ui.core.Widget().set({backgroundColor:a,decorator:i});
var k=new qx.ui.core.Widget().set({backgroundColor:d,decorator:i});
var j=new qx.ui.core.Widget().set({backgroundColor:b,decorator:i});
l.add(m);
l.add(n);
l.add(k);
l.add(j);
l.setLayout(new qx.ui.layout.HBox());
}}});
})();
...
}},members:{__we:false,__wf:false,__mk:null,__wg:function(){if(this.__we||this.__wf){var y=qx.bom.element.Dimension.getSize(this.__mk);

if(this.__we&&y.width<1){throw new Error("The root element "+this.__mk+" of "+this+" needs a width when its width size should be used!");
}
if(this.__wf){if(y.height<1){throw new Error("The root element "+this.__mk+" of "+this+" needs a height when its height size should be used!");
}if(y.height>=1&&qx.bom.element.Style.get(this.__mk,q,3)==p){qx.bom.element.Style.set(this.__mk,q,y.height+o);
}}qx.event.Registration.addListener(this.__mk,s,this._onResize,this);
}},_createContainerElement:function(){var z=this.__mk;

if(this.__we||this.__wf){var D=document.createElement(b);
z.appendChild(D);
...
if((H.oldWidth!==H.width)&&this.__we||(H.oldHeight!==H.height)&&this.__wf){qx.ui.core.queue.Layout.add(this);
}},_computeSizeHint:function(){var M=this.__we;
var J=this.__wf;
...
if(M){var L=N.getContentWidth(this.__mk);
I.width=L;
I.minWidth=L;
I.maxWidth=L;
}
if(J){var K=N.getContentHeight(this.__mk);
I.height=K;
I.minHeight=K;
I.maxHeight=K;
}return I;
}},defer:function(O,P){qx.ui.core.MLayoutHandling.remap(P);
},destruct:function(){qx.event.Registration.removeListener(this.__mk,s,this._onResize,this);
this.__mk=null;
}});
})();
(function(){var f="resize",d="__kr",c="interval",b="body",a="qx.event.handler.ElementResize";
qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);
this.__x=g;
this.__wh={};
this.__kr=new qx.event.Timer(200);
this.__kr.addListener(c,this._onInterval,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__wh:null,__x:null,__kr:null,canHandleEvent:function(h,i){return h.tagName.toLowerCase()!==b;
...
if(qx.lang.Object.isEmpty(r)){this.__kr.stop();
}}},_onInterval:function(e){var u=this.__wh;
...
y.width=w;
y.height=v;
}}}},destruct:function(){this.__x=this.__wh=null;
