...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Flash","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash-qx.theme.Simple.99b711263d0a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.widget.Flash";
...
(function(){var k="execute",j="__cp",i="Flash Player Version",h="__NL",g="__NN",f="right",d="Message from Flash:",c="Simple demo with FlashVars",b="__FM",a="bgcolor",y="demobrowser.demo.widget.Flash",x="demobrowser/demo/flash/FlashVersion.swf",w="Flash:",v="<b>qooxdoo:</b>",u="demobrowser.demo.widget.Flash.sendMessage",t="__NM",s="demobrowser.demo.widget.Flash.flashReady",r="demobrowser/demo/flash/fo_tester.swf",q="this is passed in via FlashVars",p="Two way communication (ActionScript <-> JavaScript)",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__cp:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
z.add(B);
this.__cp=this.createWindow();
C.add(this.__cp,{top:20,left:20});
...
H.addListener(k,function(){this.__cp.open();
},this);
G.add(H);
return G;
},__FM:null,__NL:null,__NM:null,__NN:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
...
this.__NL=new qx.ui.form.TextArea("No message.");
this.__NL.setEnabled(false);
J.add(this.__NL,{flex:1});
J.add(new qx.ui.basic.Label(n));
this.__NM=new qx.ui.form.TextArea("qooxdoo is the best!");
J.add(this.__NM,{flex:1});
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));
this.__NN=new qx.ui.form.Button("Send to Flash");
this.__NN.setEnabled(false);
this.__NN.addListener(k,function(e){this.__FM.getFlashElement().sendMessage(this.__NM.getValue());
},this);
L.add(this.__NN);
J.add(L);
...
this.__FM=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__FM.setVariables({init:s});
I.add(this.__FM,{flex:1});
return K;
},sendMessage:function(M){this.__NL.setValue(M);
},initFlash:function(){if(this.__FM.getFlashElement().setup){this.__FM.getFlashElement().setup(u);
this.__NN.setEnabled(true);
...
}}},statics:{__NO:null,setCallBackInstance:function(N){demobrowser.demo.widget.Flash.__NO=N;
},sendMessage:function(O){demobrowser.demo.widget.Flash.__NO.sendMessage(O);
},flashReady:function(){demobrowser.demo.widget.Flash.__NO.initFlash();
}},destruct:function(){this._disposeObjects(h,t,g,b,j);
}});
})();
...
if(bh!=d&&bh!=null&&bh!=b){if(!this.isLoaded()){if(!this.__FY){this.__FY=new Date().getTime();
}var bi=new Date().getTime()-this.__FY;
...
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bt,bu){this.__Ga(a,bt);
},_applyScale:function(bv,bw){this.__Ga(X,bv);
},_applyWmode:function(bx,by){this.__Ga(S,bx);
},_applyPlay:function(bz,bA){this.__Ga(L,bz);
},_applyLoop:function(bB,bC){this.__Ga(n,bB);
},_applyMenu:function(bD,bE){this.__Ga(l,bD);
},_applyAllowScriptAccess:function(bF,bG){this.__Ga(k,bF);
},_applyLiveConnect:function(bH,bI){this.__Ga(D,bH);
},__Ga:function(bJ,bK){this.getContentElement().setParam(bJ,bK);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
this.__FK={};
this.__FL={};
},members:{__FJ:null,__FL:null,__FK:null,__FM:null,_createDomElement:function(){return qx.bom.Element.create(d);
},createFlash:function(){this.__FM=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__FK,this.__FJ);
},setSource:function(j){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(j,f);
}
if(this.__FM){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,j);
},setId:function(k){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(k,f);
}
if(this.__FM){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(b,k);
},getVariables:function(){return this.__FK;
},setVariables:function(l){if(qx.core.Environment.get(g)){qx.core.Assert.assertMap(l,f);
}
if(this.__FM){throw new Error("The variables cannot be modified after initial creation");
}this.__FK=l;
},getAttributes:function(){return this.__FL;
...
if(this.__FM){throw new Error("The attributes cannot be modified after initial creation");
}
if(n===null||n===undefined){delete this.__FL[m];
}else{this.__FL[m]=n;
}},getParams:function(){return this.__FJ;
...
if(this.__FM){throw new Error("The params cannot be modified after initial creation");
}
if(p===null||p===undefined){delete this.__FJ[o];
}else{this.__FJ[o]=p;
}},getFlashElement:function(){return this.__FM;
}},destruct:function(){if(this.__FM){qx.bom.Flash.destroy(this.__FM);
}this.__FJ=this.__FK=this.__FL=null;
}});
})();
