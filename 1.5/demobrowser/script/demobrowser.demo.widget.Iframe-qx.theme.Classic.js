...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Iframe","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe-qx.theme.Classic.2b3f9ab990d2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.widget.Iframe";
...
},properties:{appearance:{refine:true,init:a},scrollbarX:{check:[u,q,d],init:u,themeable:true,apply:m},scrollbarY:{check:[u,q,d],init:u,themeable:true,apply:m},scrollbar:{group:[f,i]}},members:{__Af:null,__Ag:null,_getIframeElement:function(){return this.getChildControl(t).getContentElement();
...
}},_startIframeObserver:function(){if(this.__Ag){this._stopIframeObserver();
}var E=qx.event.Idle.getInstance();
this.__Ag=E.addListener(h,this._onIframeObserverInterval,this);
},_stopIframeObserver:function(){this.__Af=null;

if(!this.__Ag){return;
}var F=qx.event.Idle.getInstance();
F.removeListenerById(this.__Ag);
},_onIframeObserverInterval:function(){var G=this._getIframeSize();

if(!G){this._disableScollbars();
return;
}
if(this.__Af&&G.width==this.__Af.width&&G.height==this.__Af.height){return;
}this.__Af=G;
...
}},_updateScrollbars:function(){var J=this.__Af;
