...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Scroll","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Scroll-qx.theme.Modern.b708d05f020f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.animation.Scroll";
...
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:d,check:[d,b]},x:{init:0,check:c},y:{init:0,check:c}},members:{__HM:null,__HN:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var e=this._getElement();
this.__HM={x:e.scrollLeft,y:e.scrollTop};
if(this._atEndPosition(this.__HM.x,this.__HM.y)){return;
}
if(this.getMode()==b){this.__HN={left:this.getX()-this.__HM.x,top:this.getY()-this.__HM.y};
}},update:function(f){qx.fx.Base.prototype.update.call(this);
var g=this._getElement();

if(this.getMode()==d){if(this.getX()!=0){g.scrollLeft=this.__HM.x+(this.getX()*f);
}
if(this.getY()!=0){g.scrollTop=this.__HM.y+(this.getY()*f);
}}else{g.scrollLeft=this.__HM.x+(this.__HN.left*f);
g.scrollTop=this.__HM.y+(this.__HN.top*f);
