...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree_Dynamic","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Dynamic-qx.theme.Modern.59ef985bcfae.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.virtual.Tree_Dynamic",b="os.name",a="engine.version";
...
(function(){var p="default",o="children",n="open",m="",l="Root",k="icon",j="label",h="demobrowser.demo.virtual.Tree_Dynamic",g="demobrowser/demo/icons/loading22.gif",f="Loading",c="loading",e="Item ",d="icon/22/mimetypes/office-document.png",b="loaded",a="icon/22/places/folder.png";
qx.Class.define(h,{extend:qx.application.Standalone,members:{count:0,main:function(){qx.application.Standalone.prototype.main.call(this);
var r={label:l,children:[],icon:p,loaded:true};
r=qx.data.marshal.Json.createModel(r,true);
this.createRandomData(r);
var q=new qx.ui.tree.VirtualTree(r,j,o);
this.getRoot().add(q,{edge:20});
q.setIconPath(k);
q.setIconOptions({converter:function(u,v){if(u==p){if(v.getChildren!=null){return a;
}else{return d;
}}else{return g;
}}});
var t=this;
var s={bindItem:function(w,x,y){w.bindDefaultProperties(x,y);
w.bindProperty(m,n,{converter:function(z,A,B,C){var D=C.isOpen();

if(D&&!z.getLoaded()){z.setLoaded(true);
qx.event.Timer.once(function(){z.getChildren().removeAll();
this.createRandomData(z);
},t,1000);
}return D;
}},x,y);
}};
q.setDelegate(s);
},createRandomData:function(parent){var E=parseInt(Math.random()*50);

for(var i=0;i<E;i++){var F={label:e+this.count++,icon:p,loaded:true};

if(Math.random()>0.3){F[b]=false;
F[o]=[{label:f,icon:c}];
