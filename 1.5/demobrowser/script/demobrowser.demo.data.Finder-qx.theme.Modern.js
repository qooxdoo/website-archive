...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Finder","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Finder-qx.theme.Modern.d30d877c76b7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.data.Finder";
...
(function(){var g="name",f="model",e="selection[0].files",d="Finder",c="model.files",b="demobrowser/demo/data/finder.json",a="demobrowser.demo.data.Finder";
...
var i=new qx.ui.window.Window(d);
i.setLayout(new qx.ui.layout.HBox());
i.setContentPadding(0);
i.setShowMaximize(false);
i.setShowMinimize(false);
i.setShowClose(false);
i.open();
var j=new qx.ui.form.List();
i.add(j);
var l=new qx.ui.form.List();
i.add(l);
var k=new qx.ui.form.List();
i.add(k);
var o=new qx.data.controller.List(null,j);
o.setLabelPath(g);
var n=new qx.data.controller.List(null,l);
n.setLabelPath(g);
var m=new qx.data.controller.List(null,k);
m.setLabelPath(g);
var h=qx.util.ResourceManager.getInstance().toUri(b);
var p=new qx.data.store.Json(h);
p.bind(c,o,f);
o.bind(e,n,f);
n.bind(e,m,f);
}}});
