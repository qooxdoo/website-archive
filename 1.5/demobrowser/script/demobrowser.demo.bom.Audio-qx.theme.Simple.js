...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Audio","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Audio-qx.theme.Simple.3180882859b6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="changeValue",q="timeupdate",p="html.audio.mp3",o="Play/Pause",n="html.audio.ogg",m="#CCC",l="Loop",k="It seems that your browser doesn't support HTML5 audio",j="0:00",i="demobrowser/demo/media/audiotest.ogg",c="loadeddata",h="Mute",g="demobrowser/demo/media/audiotest.mp3",b="ended",a="0",f="demobrowser.demo.bom.Audio",d=":";
...
if(qx.core.Environment.get(p)){var w=qx.util.ResourceManager.getInstance().toUri(g);
}else if(qx.core.Environment.get(n)){var w=qx.util.ResourceManager.getInstance().toUri(i);
...
x.setHeight(21);
x.setWidth(220);
z.addListener(c,function(){v.add(s,{left:10,top:10});
