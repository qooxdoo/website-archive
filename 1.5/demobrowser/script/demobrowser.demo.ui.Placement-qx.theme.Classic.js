...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Placement","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Placement-qx.theme.Classic.afb57bc588b7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(k,{extend:qx.application.Standalone,members:{__tp:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__tp=[n,p,q,l,o,b,d,m];
...
for(var i=0;i<this.__tp.length;i++){var x=new qx.ui.form.ListItem(this.__tp[i]);
v.add(x);

if(this.__tp[i]==u){z=x;
}}y.add(v);
...
for(var i=0;i<this.__tp.length;i++){B.add(new qx.ui.form.ListItem(this.__tp[i]));
}D.add(B);
