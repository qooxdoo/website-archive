...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Flow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow-qx.theme.Simple.945478953659.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="_applyLayoutChange",n="top",m="left",l="Integer",k="lineBreak",j="' is not supported by the flow layout!",h="middle",g="qx.debug",f="bottom",e="qx.ui.layout.Flow",b="center",d="right",c="The property '",a="Boolean";
qx.Class.define(e,{extend:qx.ui.layout.Abstract,construct:function(p,q,r){qx.ui.layout.Abstract.call(this);
...
}},properties:{alignX:{check:[m,b,d],init:m,apply:o},alignY:{check:[n,h,f],init:n,apply:o},spacingX:{check:l,init:0,apply:o},spacingY:{check:l,init:0,apply:o},reversed:{check:a,init:false,apply:o}},members:{verifyLayoutProperty:qx.core.Environment.select(g,{"true":function(s,name,t){this.assertEquals(k,name,c+name+j);
...
}},__GS:function(B,C,D){var F=qx.ui.layout.Util;
var I=0;

if(this.getAlignX()!="left"){I=D-B.width;

if(this.getAlignX()=="center"){I=Math.round(I/2);
}}
...
}},_computeSizeHint:function(){return this.__GT(Infinity);
},hasHeightForWidth:function(){return true;
},getHeightForWidth:function(K){return this.__GT(K).height;
},__GT:function(L){var M=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());
var Q=0;
var N=0;
var O=0;
...
qx.Class.define(a,{extend:Object,construct:function(b,c){this.__iU=b;
this.__Fw=c;
this.__Fx=b.length>0;
this.__Fy=0;
},members:{__iU:null,__Fw:null,__Fx:null,__Fy:null,computeNextLine:function(d){var d=d||Infinity;

if(!this.__Fx){throw new Error("No more lines to compute");
}var o=this.__iU;
var m=0;
var f=0;
var n=[];
...
for(var i=this.__Fy;i<o.length;i++){var l=o[i];
var p=l.getSizeHint();
var h=this.__Fz(i);
var g=p.width+h;
var e=i==this.__Fy;

if(!e&&f+g>d){this.__Fy=i;
break;
...
if(l.getLayoutProperties().lineBreak){this.__Fy=i+1;
break;
}}
if(i>=o.length){this.__Fx=false;
}return {height:m,width:f,children:n,gapsBefore:j};
},__Fz:function(q){var r=q==this.__Fy;

if(r){return this.__iU[q].getMarginLeft();
}else{return Math.max(this.__iU[q-1].getMarginRight(),this.__iU[q].getMarginLeft(),this.__Fw);
}},hasMoreLines:function(){return this.__Fx;
}}});
})();
