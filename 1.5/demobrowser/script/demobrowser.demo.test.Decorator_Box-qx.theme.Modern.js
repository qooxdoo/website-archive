...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Decorator_Box","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Decorator_Box-qx.theme.Modern.ef0a8c4d9dfa.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
if(k){this.__na(k,m);
}if(l!=null){this.__mY.setInsets(l);
}}else{this.__mY=new qx.ui.decoration.BoxDiv(k,l,m);
}},properties:{baseImage:{check:b,nullable:true,apply:e}},members:{__mY:null,_isHorizontal:null,_setOrientation:function(n){this._isHorizontal=n==i;
},getMarkup:function(){return this.__mY.getMarkup();
},resize:function(o,p,q){this.__mY.resize(o,p,q);
},tint:function(r,s){},getInsets:function(){return this.__mY.getInsets();
},_applyInsets:function(t,u,name){var v=g+qx.lang.String.firstUp(name);
this.__mY[v](t);
},_applyBaseImage:function(w,x){if(this.__mY instanceof qx.ui.decoration.BoxDiv){this.__mY.setBaseImage(w);
}else{this.__na(w);
}},__na:function(y){this.__mY.setBorderImage(y);
...
this.__mY.setSlice([0,z,0,H]);
}else{var A=B.getImageHeight(C+d+D);
var G=B.getImageHeight(C+c+D);
this.__mY.setSlice([G,0,A,0]);
}}},destruct:function(){this.__nb=this.__Fv=this.__pf=null;
}});
})();
...
}},properties:{baseImage:{check:r,nullable:true,apply:u}},members:{__nb:null,__Fv:null,__pf:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__nb;
...
}}}},tint:function(J,K){},_applyBaseImage:function(L,M){if(qx.core.Environment.get(v)){if(this.__nb){throw new Error("This decorator is already in-use. Modification is not possible anymore!");
...
var Q=S[1];
var O=S[2];
var T=this.__Fv={t:Q+c+O,b:Q+t+O,c:Q+o+O,l:Q+e+O,r:Q+a+O};
this.__pf={top:N.getImageHeight(T.t),bottom:N.getImageHeight(T.b),left:N.getImageWidth(T.l),right:N.getImageWidth(T.r)};
}}},destruct:function(){this.__nb=this.__Fv=this.__pf=null;
}});
})();
