...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.showcase.Calculator","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Calculator-qx.theme.Simple.ea56df6072f8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.showcase.Calculator";
...
(function(){var k="execute",j="-",i="+",h="/",g="*",f="=",d=".",c="black",b="Del",a="sans-serif",H="C",G="__MJ",F="5",E="7",D="demobrowser.demo.showcase.Calculator",C="CE",B="solid",A="icon/22/apps/utilities-calculator.png",z="3",y="0",r="qx.debug",s="n",p="8",q="__MI",n="6",o="4",l="Calculator",m="2",t="Verdana",u="1",w="demobrowser.demo.showcase.CalculatorLogic",v="+/-",x="9";
qx.Class.define(D,{extend:qx.application.Standalone,members:{__MI:null,__MJ:null,main:function(){qx.application.Standalone.prototype.main.call(this);
if(qx.core.Environment.get(r)){qx.log.appender.Native;
qx.log.appender.Console;
}this.__MJ=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var J=new qx.ui.window.Window(l,A);
J.setLayout(new qx.ui.layout.VBox(16));
var L=new qx.ui.decoration.Single(1,B,c);
var T=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var be=new qx.ui.layout.Grid(5,5);
T.setLayout(be);
this.__MI=new qx.ui.basic.Label(this.__MJ.getCurrentValue().toString()).set({decorator:L,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__MI.setEnabled(false);
var bf=new qx.bom.Font().set({size:14,family:[t,a],bold:true});
var Y=new qx.ui.form.Button(y).set({font:bf,minWidth:40});
var X=new qx.ui.form.Button(u).set({font:bf,minWidth:40});
var W=new qx.ui.form.Button(m).set({font:bf,minWidth:40});
var V=new qx.ui.form.Button(z).set({font:bf,minWidth:40});
var bd=new qx.ui.form.Button(o).set({font:bf,minWidth:40});
var bc=new qx.ui.form.Button(F).set({font:bf,minWidth:40});
var bb=new qx.ui.form.Button(n).set({font:bf,minWidth:40});
var ba=new qx.ui.form.Button(E).set({font:bf,minWidth:40});
var bh=new qx.ui.form.Button(p).set({font:bf,minWidth:40});
var bg=new qx.ui.form.Button(x).set({font:bf,minWidth:40});
var I=new qx.ui.form.Button(H).set({font:bf,minWidth:40});
var K=new qx.ui.form.Button(C).set({font:bf,minWidth:40});
var P=new qx.ui.form.Button(b).set({font:bf,minWidth:40});
var O=new qx.ui.form.Button(v).set({font:bf,minWidth:40});
var R=new qx.ui.form.Button(d).set({font:bf,minWidth:40});
var N=new qx.ui.form.Button(i).set({font:bf,minWidth:40});
var U=new qx.ui.form.Button(j).set({font:bf,minWidth:40});
var S=new qx.ui.form.Button(g).set({font:bf,minWidth:40});
var Q=new qx.ui.form.Button(h).set({font:bf,minWidth:40});
var M=new qx.ui.form.Button(f).set({font:bf,minWidth:40});
be.setColumnFlex(0,1);
be.setColumnFlex(1,1);
be.setColumnFlex(2,1);
be.setColumnFlex(3,1);
be.setRowFlex(1,1);
be.setRowFlex(2,1);
be.setRowFlex(3,1);
be.setRowFlex(4,1);
be.setRowFlex(5,1);
be.setRowFlex(6,1);
T.add(this.__MI,{row:0,column:0,rowSpan:0,colSpan:4});
T.add(I,{row:1,column:2,rowSpan:1,colSpan:2});
T.add(K,{row:1,column:1});
T.add(P,{row:1,column:0});
T.add(ba,{row:2,column:0});
T.add(bh,{row:2,column:1});
T.add(bg,{row:2,column:2});
T.add(Q,{row:2,column:3});
T.add(bd,{row:3,column:0});
T.add(bc,{row:3,column:1});
T.add(bb,{row:3,column:2});
T.add(S,{row:3,column:3});
T.add(X,{row:4,column:0});
T.add(W,{row:4,column:1});
T.add(V,{row:4,column:2});
T.add(U,{row:4,column:3});
T.add(Y,{row:5,column:0});
T.add(O,{row:5,column:1});
T.add(R,{row:5,column:2});
T.add(N,{row:5,column:3});
T.add(M,{row:6,column:0,rowSpan:1,colSpan:4});
J.setWidth(260);
J.setMinWidth(260);
J.setHeight(260);
J.open();
...
J.add(T,{flex:1});
I.addListener(k,function(e){this.__MJ.cleanDisplay();
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
K.addListener(k,function(e){this.__MJ.clearEntry();

if(this.__MJ.getResult()!=null){this.__MI.setValue(this.__MJ.getCurrentValue().toString());
}},this);
P.addListener(k,function(e){this.__MJ.deleteNumber();
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
O.addListener(k,function(e){this.__MJ.setSign();

if(this.__MJ.getResult()!=null){this.__MI.setValue(this.__MJ.getResult().toString());
}},this);
Y.addListener(k,function(e){this.__MJ.setCurrentValue(0);
this.__MI.setValue(this.__MJ.getCurrentValue().toFixed(this.__MJ.getZeroCounter()).toString());
},this);
X.addListener(k,function(e){this.__MJ.setCurrentValue(1);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
W.addListener(k,function(e){this.__MJ.setCurrentValue(2);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
V.addListener(k,function(e){this.__MJ.setCurrentValue(3);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
bd.addListener(k,function(e){this.__MJ.setCurrentValue(4);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__MJ.setCurrentValue(5);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
bb.addListener(k,function(e){this.__MJ.setCurrentValue(6);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
ba.addListener(k,function(e){this.__MJ.setCurrentValue(7);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
bh.addListener(k,function(e){this.__MJ.setCurrentValue(8);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
bg.addListener(k,function(e){this.__MJ.setCurrentValue(9);
this.__MI.setValue(this.__MJ.getCurrentValue().toString());
},this);
N.addListener(k,function(e){this.__MJ.calculate(i);

if(this.__MJ.getResult()!=null){this.__MI.setValue(this.__MJ.getResult().toString());
}this.__MJ.resetCurrentValue();
},this);
U.addListener(k,function(e){this.__MJ.calculate(j);

if(this.__MJ.getResult()!=null){this.__MI.setValue(this.__MJ.getResult().toString());
}this.__MJ.resetCurrentValue();
},this);
S.addListener(k,function(e){this.__MJ.calculate(g);

if(this.__MJ.getResult()!=null){this.__MI.setValue(this.__MJ.getResult().toString());
}this.__MJ.resetCurrentValue();
},this);
Q.addListener(k,function(e){this.__MJ.calculate(h);

if(this.__MJ.getResult()!=null){this.__MI.setValue(this.__MJ.getResult().toString());
}this.__MJ.resetCurrentValue();
},this);
M.addListener(k,function(e){this.__MJ.calculate(f);

if(this.__MJ.getResult()!=null){this.__MI.setValue(this.__MJ.getResult().toString());
}this.__MJ.resetCurrentValue();
},this);
R.addListener(k,function(e){this.__MJ.setComma();
},this);
}},destruct:function(){this._disposeObjects(G,q);
}});
qx.Class.define(w,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__MK:0,__um:0,__ML:"n",__MM:0,__MN:0,__MO:0,__MP:false,__MQ:1,__MR:0,__MS:false,__MT:0,setCurrentValue:function(bi){if(this.__MP){this.__MQ*=10;
this.__MK=this.__MK+(bi/this.__MQ);

if(bi==0){this.__MR++;
}}else{this.__MP=false;

if(this.__MK<0){this.__MK=this.__MK*10-bi;
}else{this.__MK=this.__MK*10+bi;
}}},getZeroCounter:function(){return this.__MR;
},setComma:function(){this.__MP=true;
},getCurrentValue:function(){return this.__MK;
},resetCurrentValue:function(){this.__MK=null;
},cleanDisplay:function(){this.__MT=0;
this.__MN=0;
this.__ML="n";
this.__MR=0;
this.__MQ=1;
...
this.__um=0;
this.__MS=false;
},setResult:function(bj){this.__um=bj;
},getResult:function(){return Math.round(this.__um*10000000)/10000000;
},setCurrentOperation:function(bk){this.__ML=bk;
},getCurrentOperation:function(){return this.__ML;
},clearEntry:function(){this.__MS=false;
this.__MR=0;
this.__MQ=1;
this.__MP=false;
this.__MO++;
...
if(this.__MO<2){this.__MN=this.__um;
}
if(this.__MM>=2){this.__um=0;
this.__MM=0;
}},setSign:function(){this.__MT++;

if(this.__MT%2==0){this.__MS=false;
}else{this.__MS=true;
}
if(this.__MK==null){this.__MK=this.__um;
}this.__MK=this.__MK*(-1);

if(this.__um==0){this.__um=this.__MK;
}
if(this.__um!=0){this.__MN=this.__um;
this.__um=this.__MK;
}},deleteNumber:function(){var bl=false;
var bo=false;

if(this.__MK<0){this.__MK=this.__MK*(-1);
bo=true;
}
if(this.__MK!=null){if(this.__MK.toString().lastIndexOf(d)!=-1){this.__MK=this.__MK*this.__MQ;
bl=true;
}}var bm=this.__MK%10;
var bn=bm/10;
this.__MK=this.__MK/10;
this.__MK=this.__MK-bn;

if(bl){this.__MQ/=10;
this.__MK=this.__MK/(this.__MQ);
bl=false;
}
if(bo){this.__MK=this.__MK*(-1);
bo=false;
}},calculate:function(bp){if(bp==i||bp==g||bp==h||bp==j||bp==f){this.__MP=false;
this.__MQ=1;
this.__MR=0;

if(this.__ML!=s){if(this.__ML==i){if(this.__um==null){this.__um=this.__MN;
}
if(this.__MS){this.__um=this.__MN+this.__MK;
}else{this.__um=this.__um+this.__MK;
}this.__MK=this.__um;
this.__MN=this.__um;
}
if(this.__ML==j){if(this.__um==0){this.__um=this.__MK;
this.__MK=0;
}
if(this.__um==null){this.__um=this.__MN;
}
if(this.__MS){this.__um=this.__MN-this.__MK;
}else{this.__um=this.__um-this.__MK;
}this.__MK=this.__um;
...
if(this.__ML==h){if(this.__um==0){this.__um=this.__MK;
this.__MK=1;
}
if(this.__um==null){this.__um=this.__MN;
}
if(this.__MK!=null){if(this.__MK!=0){if(this.__MS){this.__um=this.__MN/this.__MK;
}else{this.__um=this.__um/this.__MK;
}}else{alert("You can't divide by 0!");
}}this.__MK=this.__um;
this.__MN=this.__um;
}
if(this.__ML==g){if(this.__um==0){this.__um=1;
}
if(this.__MK==null){this.__MK=1;
}
if(this.__um==null){this.__um=this.__MN;
}
if(this.__MS){this.__um=this.__MN*this.__MK;
...
this.__MN=this.__um;
}}else{this.__um=this.__MK;
}
if(bp!=f){this.__ML=bp;
}else{this.__MM++;
this.__um=this.__MN;
this.__ML="n";
}this.__MS=false;
...
}},"tooltip/atom":dg,"tooltip-error":{include:dq,style:function(dV){return {textColor:ds,showTimeout:100,hideTimeout:10000,decorator:bA,font:dd,backgroundColor:undefined};
...
}},"resize-frame":U,"dragdrop-cursor":{style:function(dY){var ea=T;

if(dY.copy){ea=bN;
}else if(dY.move){ea=ba;
...
}},"table-header-cell":{alias:dg,style:function(eh){return {decorator:eh.first?A:R,minWidth:13,font:dd,paddingTop:3,paddingLeft:5,cursor:di,sortIcon:eh.sorted?(qx.theme.simple.Image.URLS[cj+(eh.sortedAscending?j:cE)]):undefined};
...
}},"treevirtual-only-expand":{style:function(et){return {icon:qx.theme.simple.Image.URLS[bb]};
...
}},"treevirtual-end-expand":{style:function(ex){return {icon:qx.theme.simple.Image.URLS[bw]};
...
}},"splitpane/splitter/knob":{style:function(eE){return {source:qx.theme.simple.Image.URLS[b+(eE.horizontal?cS:by)],padding:2};
...
}},"virtual-list":ca,"virtual-list/row-layer":P,"row-layer":dk,"column-layer":dk,"group-item":{include:dr,alias:dr,style:function(eX){return {padding:4,backgroundColor:bv,textColor:bY,font:dd};
...
}},"spinner/textfield":du,"spinner/upbutton":{alias:dn,include:dn,style:function(fx){var fy=bp;

if(fx.hovered&&!fx.pressed&&!fx.checked){fy=Q;
...
if(fz.hovered&&!fz.pressed&&!fz.checked){fA=W;
}else if(fz.hovered&&(fz.pressed||fz.checked)){fA=ch;
}else if(fz.pressed||fz.checked){fA=ci;
}return {icon:qx.theme.simple.Image.URLS[bz],decorator:fA,width:17};
...
}},"window-resize-frame":bC,"window/pane":{},"window/captionbar":{style:function(gf){return {backgroundColor:gf.active?cL:n,padding:8,font:dd,decorator:S};
...
}},"window/restore-button":{alias:dj,style:function(gj){return {icon:qx.theme.simple.Image.URLS[bB],padding:[1,2],cursor:gj.disabled?undefined:di};
...
}},"tabview":{},"tabview/bar":{alias:bu,style:function(gK){var gL=0,gO=0,gM=0,gN=0;
...
}if(gU.barTop||gU.barBottom){he=V;
...
}else if(gU.lastTab&&!gU.checked){he+=bx;
...
}},"tabview-page/button/label":{alias:dr,style:function(hf){return {padding:[0,1,0,1],margin:hf.focused?0:1};
...
}},"colorpopup/colorselector-okbutton":{alias:dj,include:dj,style:function(hl){return {icon:bo};
