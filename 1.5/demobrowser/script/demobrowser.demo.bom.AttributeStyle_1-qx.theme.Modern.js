...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.AttributeStyle_1","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.AttributeStyle_1-qx.theme.Modern.8fa6e4ed0e61.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.bom.AttributeStyle_1",a="engine.version";
...
(function(){var f="test8",e="backgroundColor",d="black",c="red",b="demobrowser.demo.bom.AttributeStyle_1",a="color";
...
var i=qx.bom.element.Opacity;
this.info("test1");
this.debug("classname: "+g.get(document.getElementById("test1"),"class"));
this.debug("title: "+g.get(document.getElementById("test1"),"title"));
this.debug("top: "+h.get(document.getElementById("test1"),"top"));
this.info("test2");
this.debug("name: "+g.get(document.getElementById("test2"),"name"));
this.debug("value: "+g.get(document.getElementById("test2"),"value"));
this.debug("type: "+g.get(document.getElementById("test2"),"type"));
this.debug("max: "+g.get(document.getElementById("test2"),"maxlength"));
this.debug("left: "+h.get(document.getElementById("test2"),"left"));
this.info("test3");
this.debug("name: "+g.get(document.getElementById("test3"),"name"));
this.debug("value: "+g.get(document.getElementById("test3"),"value"));
this.debug("type: "+g.get(document.getElementById("test3"),"type"));
this.debug("checked: "+g.get(document.getElementById("test3"),"checked"));
this.debug("disabled: "+g.get(document.getElementById("test3"),"disabled"));
this.debug("tabindex: "+g.get(document.getElementById("test3"),"tabindex"));
this.info("test4");
this.debug("disabled: "+g.get(document.getElementById("test4"),"disabled"));
this.debug("readonly: "+g.get(document.getElementById("test4"),"readonly"));
this.info("test5");
this.debug("disabled: "+g.get(document.getElementById("test5"),"disabled"));
this.debug("readonly: "+g.get(document.getElementById("test5"),"readonly"));
this.info("test6");
this.debug("href: "+g.get(document.getElementById("test6"),"href"));
this.debug("style: "+g.get(document.getElementById("test6"),"style"));
this.debug("css: "+h.getCss(document.getElementById("test6")));
this.debug("color: "+h.get(document.getElementById("test6"),"color"));
this.debug("bg: "+h.get(document.getElementById("test6"),"backgroundColor"));
this.debug("family: "+h.get(document.getElementById("test6"),"fontFamily"));
this.debug("text: "+g.get(document.getElementById("test6"),"text"));
this.debug("html: "+g.get(document.getElementById("test6"),"html"));
this.debug("opacity: "+i.get(document.getElementById("test6")));
this.info("test7");
this.debug("valign: "+g.get(document.getElementById("test7"),"valign"));
this.debug("colspan: "+g.get(document.getElementById("test7").getElementsByTagName("td")[0],"colspan"));
this.info("test8");
h.set(document.getElementById(f),a,c);
h.set(document.getElementById(f),e,d);
i.set(document.getElementById(f),0.5);
this.debug("opacity: "+i.get(document.getElementById("test8")));
this.info("test9");
