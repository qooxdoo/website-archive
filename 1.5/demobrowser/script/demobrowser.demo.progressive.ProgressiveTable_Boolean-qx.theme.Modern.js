...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Boolean","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean-qx.theme.Modern.4209e528a50d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.progressive.ProgressiveTable_Boolean",b="os.name",a="engine.version";
...
this.__BO=J.toUri(H);
this.__BP=J.toUri(G);
},properties:{allowToggle:{check:E,init:false}},members:{__BO:null,__BP:null,__BQ:null,__BR:null,__BS:null,__BT:null,__BU:null,__BV:null,_identifyImage:function(K){var L={imageWidth:11,imageHeight:11};

switch(K.cellData){case true:L.url=this.__BO;
L.extras=w;
break;
...
if((qx.core.Environment.get(b)==c)&&/\.png$/i.test(this.__BO)){L.extras+=i+this.getBlankImage()+j+e+h+a+this.__BO+j+d;
}else{L.extras+=i+this.__BO+j;
}L.extras+=m+v+u+f;

if((qx.core.Environment.get(b)==c)&&/\.png$/i.test(this.__BP)){L.extras+=i+this.getBlankImage()+j+e+h+a+this.__BP+j+d;
}else{L.extras+=i+this.__BP+j;
}L.extras+=q+g;
...
return N;
}},destruct:function(){this.__BO=this.__BP=null;
}});
})();
