...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_FocusIndicator","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_FocusIndicator-qx.theme.Modern.e02fc422a9b1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.Table_FocusIndicator";
...
(function(){var i="main",h="keypress",g="#FFE",f="demobrowser.demo.test.Table_FocusIndicator",d="Left",c="Right",b="Down",a="Up";
qx.Class.define(f,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil,qx.core.MAssert],members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var j=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({decorator:i,backgroundColor:g,width:600,height:400});
this.getRoot().add(j,{left:10,top:10});
var m=new qx.ui.table.pane.FocusIndicator(this.getScrollerMock()).set({decorator:i});
j.add(m);
var k=6;
var l=2;
m.moveToCell(l,k);
j.addListener(h,function(e){switch(e.getKeyIdentifier()){case d:l-=1;
break;
case c:l+=1;
break;
case a:k-=1;
...
break;
default:return;
}l=Math.min(Math.max(0,l),5);
k=Math.min(Math.max(0,k),19);
m.moveToCell(l,k);
});
}}});
})();
