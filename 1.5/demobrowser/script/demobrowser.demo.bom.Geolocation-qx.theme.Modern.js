...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Geolocation","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Geolocation-qx.theme.Modern.9b7f89f87598.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.bom.Geolocation";
...
},properties:{timestamp:{check:b},latitude:{check:b},longitude:{check:b},altitude:{check:b,nullable:true},accuracy:{check:b},altitudeAccuracy:{check:b,nullable:true},heading:{nullable:true},speed:{check:b,nullable:true}},members:{init:function(c){this.setTimestamp(c.timestamp);
this.setLatitude(c.coords.latitude);
this.setLongitude(c.coords.longitude);
this.setAltitude(c.coords.altitude);
this.setAccuracy(c.coords.accuracy);
this.setAltitudeAccuracy(c.coords.altitudeAccuracy);
this.setHeading(c.coords.heading);
this.setSpeed(c.coords.speed);
}}});
})();
