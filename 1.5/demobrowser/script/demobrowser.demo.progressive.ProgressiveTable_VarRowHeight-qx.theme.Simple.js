...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_VarRowHeight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Simple.9a7337612ade.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",b="os.name",a="engine.version";
...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__MH:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var A=p;
...
--this.__MH;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__MH+", end="+this.imageData.length);
if(this.__MH==0){this.doLoad();
}return;
...
(function(){var u="px'",t='" ',s='src="',r="mshtml",q="vertical-align:middle;",p="text-align:center;",o="abstract",n="",m='<img ',l=" height='",e='" style="filter:',k=" title='",h="engine.name",c="qx.ui.progressive.renderer.table.cell.Icon",b=" style='padding-top:2px;'",g=" width='",f="'",i=">",a="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",j="qx/static/blank.gif",d="',sizingMethod='scale')";
...
var x=v.resolve(j);
this.__BM=w.toUri(x);
},members:{__BM:null,getBlankImage:function(){return this.__BM;
...
var D=this.__BN(B);
C.push(m);
if((qx.core.Environment.get(h)==r)&&/\.png$/i.test(D.url)){C.push(s,this.__BM,e,a,D.url,d,t);
}else{C.push(s,D.url,t);
}if(D.imageWidth){C.push(g,D.imageWidth,u);
...
return C.join(n);
},__BN:function(E){var F=this._identifyImage(E);
if(F==null||typeof F=="string"){F={url:F,tooltip:null};
}if(F.url==null){F.url=this.__BM;
}return F;
}}});
})();
...
if(d===undefined){this.__FH=d;
}else{this.__FH=16;
}
if(e===undefined){this.__FI=e;
}else{this.__FI=16;
}},members:{__FH:null,__FI:null,_identifyImage:function(f){var j={imageWidth:this.__FH,imageHeight:this.__FI};
var k;
