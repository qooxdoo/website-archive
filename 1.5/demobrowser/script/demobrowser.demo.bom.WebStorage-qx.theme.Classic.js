...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.WebStorage","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.WebStorage-qx.theme.Classic.8b4d95f9c696.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="click",j="",i="demobrowser.demo.bom.WebStorage",h="Save",g="value",f="Web Storage",d="Clear",c="changeSelection",b="Remove",a="key";
...
var m=new qx.ui.container.Composite(new qx.ui.layout.Basic());
m.setAllowStretchX(false);
n.add(m);
this.getRoot().add(n,{edge:0});
var l=new qx.ui.form.TextField(a);
var q=new qx.ui.form.TextField(g);
var s=new qx.ui.form.Button(h);
var o=new qx.ui.form.Button(d);
var r=new qx.ui.form.Button(b);
var p=new qx.ui.form.List();
p.set({height:280,width:245});
m.add(l,{left:20,top:20});
m.add(q,{left:120,top:20});
m.add(s,{left:220,top:18});
m.add(p,{left:20,top:50});
m.add(r,{left:20,top:330});
m.add(o,{left:220,top:330});
var t=qx.bom.storage.Local.getInstance();
s.addListener(k,function(){var v=l.getValue();
var u=q.getValue();
t.setItem(v,u);

if(!p.findItem(v)){p.add(new qx.ui.form.ListItem(v));
}l.setValue(j);
q.setValue(j);
p.resetSelection();
l.focus();
},this);
r.addListener(k,function(){var w=p.getSelection()[0];

if(w){t.removeItem(w);
p.remove(w);
}},this);
o.addListener(k,function(){t.clear();
p.removeAll();
},this);
p.addListener(c,function(e){var y=e.getData();
var x=y[0];

if(x){var A=x.getLabel();
var z=t.getItem(A);
l.setValue(A);
q.setValue(z);
}});
