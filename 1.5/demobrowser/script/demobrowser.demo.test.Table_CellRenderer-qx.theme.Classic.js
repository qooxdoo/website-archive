...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellRenderer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Classic.3cf151a95043.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="",j="Hello",h="icon/16/actions/go-down.png",g="World",f="icon",e="bold",d="Juhu",c="</div>",b="qx/icon/Oxygen",a="waiting",R="icon/16/actions/go-next.png",Q="http://resources.qooxdoo.org/images/logo.gif",P="qx.theme.Classic",O="$ ",N="string",M="border: 1px dotted green",L="inactive",K="decoration",J="multi<br>line",I="between",r="<",s="<div style='position:absolute;height:20px;width:",p="px;top:",q="icon/16/actions/go-previous.png",n="number",o="px'>",l="Classic",m="<i>italic</i>",t="0$",u="qx/icon/Tango",A="<b>bold</b>",z="icon/16/actions/go-up.png",C="qx/decoration/",B="boolean",E="demobrowser.demo.test.Table_CellRenderer",D="tooltip",w="red",H="icon/16/emotes/face-sad.png",G="icon/16/emotes/face-smile.png",F="left",v=">=",x="active",y="object";
qx.Class.define(E,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(K,C+S);

if(S==l){qx.util.AliasManager.getInstance().add(f,b);
}else{qx.util.AliasManager.getInstance().add(f,u);
}},__Hl:function(U,top,V,W,X){var Y=[s,V,p,top,o];
...
var top=0;
qx.util.Permutation.permute(bd,function(be){this.__Hl(bc,top,bb,ba,be);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bf,function(bk){this.__Hl(bg,top,bi,bj,bk);
top+=bh;
},this);
bj.setIconFalse(H);
bj.setIconTrue(G);
qx.util.Permutation.permute(bf,function(bl){this.__Hl(bg,top,bi,bj,bl);
top+=bh;
},this);
...
var by=[new bv().set({maximumFractionDigits:0}),new bv().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:O})];
var bt=this._getNewTableDiv(bw);
var top=0;

for(var i=0;i<by.length;i++){var bu=by[i];
bx.setNumberFormat(bu);
this.__Hl(bt,top,bw,bx,bz);
top+=20;
}},testImageRenderer:function(){var bC=new qx.ui.table.cellrenderer.Image();
var bA=50;
var bD={value:[null,h,z,q,R,Q],styleLeft:[0],styleWidth:[bA],styleHeight:[20],style:[k],tooltip:[k,D]};
var bB=this._getNewTableDiv(bA);
var top=0;
qx.util.Permutation.permute(bD,function(bE){this.__Hl(bB,top,bA,bC,bE);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bL,function(bQ){this.__Hl(bM,top,bO,bP,bQ);
top+=20;
},this);
},testHtmlRenderer:function(){var bV=new qx.ui.table.cellrenderer.Html();
var bU=100;
var bT=50;
var bR={value:[null,A,m,J],styleLeft:[0],styleWidth:[bU],styleHeight:[bT],style:[k]};
var bS=this._getNewTableDiv(bU);
var top=0;
qx.util.Permutation.permute(bR,function(bW){this.__Hl(bS,top,bU,bV,bW);
top+=20;
},this);
},testConditionalRenderer:function(){var cc=new qx.ui.table.cellrenderer.Conditional();
cc.addNumericCondition(r,0,null,w,null,null);
cc.addNumericCondition(v,100,F,null,null,null);
cc.addBetweenCondition(I,0,2,null,null,null,e,null);
cc.addRegex(t,null,null,e,M);
var cb=100;
var ca=20;
...
var top=0;
qx.util.Permutation.permute(bX,function(cd){this.__Hl(bY,top,cb,cc,cd);
top+=20;
},this);
...
switch(typeof cl){case N:if(cl.match(/^icon\//)){return new ck.Image();
}else{return new ck.String();
}case B:return new ck.Boolean();
case n:return new ck.Number();
...
var top=0;
qx.util.Permutation.permute(ce,function(cm){this.__Hl(cf,top,ch,ci,cm);
top+=20;
},this);
},testReplaceRenderer:function(){var cs=new qx.ui.table.cellrenderer.Replace();
cs.setReplaceMap({1:x,2:L,3:a});
...
var top=0;
qx.util.Permutation.permute(cn,function(ct){this.__Hl(co,top,cq,cs,ct);
top+=20;
},this);
