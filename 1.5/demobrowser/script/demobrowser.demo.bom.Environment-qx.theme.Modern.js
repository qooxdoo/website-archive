...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Environment","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Environment-qx.theme.Modern.f7b2ad30abca.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.bom.Environment",b="os.name",a="engine.version";
...
u.add(e);
u.add(c);
var v=qx.core.Environment._checks;
...
u.add(h);
u.add(b+s+a);
}u.add(o,t,n,qx.core.Environment.get(t),k);
}u.add(f);
v=qx.core.Environment._asyncChecks;
var p=qx.lang.Object.getLength(v);
q=qx.lang.Object.getKeys(v);

if(p){for(var i=0;i<q.length;i++){var t=q[i];
qx.core.Environment.getAsync(t,function(x){u.add(o,this,n,x,k);
p--;
