...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Button","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Button-qx.theme.Modern.c25bb1c1d77a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.widget.Button",b="os.name",a="engine.version";
...
(function(){var r="0",q="white",p="main",o="execute",n="Off",m="Button A",l="#AAA",k="icon/22/actions/list-add.png",j="Button B",i="demobrowser.demo.widget.Button",c="icon/22/apps/internet-web-browser.png",h="Hover",g="icon/22/apps/media-video-player.png",b="icon/22/apps/internet-mail.png",a="changeValue",f="On",d="Toggle Button";
...
s.setSpacing(10);
var t=new qx.ui.container.Composite(s);
t.setPadding(20);
this.getRoot().add(t,{left:0,top:0});
this.addNormalButtons(t);
this.addToggleButton(t);
this.addToggleButtonGroup(t);
this.addRepeatButton(t);
this.addHoverButton(t);
},addNormalButtons:function(u){var v=new qx.ui.form.Button(m,g);
u.add(v);
var w=new qx.ui.form.Button(j,b);
w.setEnabled(false);
u.add(w);
},addToggleButton:function(x){var y=new qx.ui.form.ToggleButton(d,c);
y.focus();
x.add(y);
y.addListener(a,function(e){this.debug("Checked: "+e.getData());
},this);
},addToggleButtonGroup:function(z){var B=new qx.ui.form.ToggleButton(f);
var A=new qx.ui.form.ToggleButton(n);
var C=new qx.ui.form.RadioGroup();
C.add(B,A);
z.add(B);
z.add(A);
},addRepeatButton:function(D){var E=new qx.ui.form.RepeatButton(null,k);
D.add(E);
var F=new qx.ui.basic.Label(r);
F.setDecorator(p);
F.setPadding(2,4);
F.setBackgroundColor(q);
D.add(F);
E.addListener(o,function(){var G=parseInt(F.getValue())+1;
F.setValue(G.toString());
});
},addHoverButton:function(H){var I=new qx.ui.form.HoverButton(h).set({padding:10,backgroundColor:l});
H.add(I);
var J=new qx.ui.basic.Label(r);
J.setDecorator(p);
J.setPadding(2,4);
J.setBackgroundColor(q);
H.add(J);
I.addListener(o,function(){var K=parseInt(J.getValue())+1;
J.setValue(K.toString());
});
}}});
})();
