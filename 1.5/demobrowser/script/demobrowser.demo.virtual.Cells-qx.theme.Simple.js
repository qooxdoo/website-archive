...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Cells","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Simple.94db221775cd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.util.Permutation.permute(E,function(F){var G=this.__Hl(D,F.value,F.states);
...
}var K=this.__Hl(I,J.value,J.states);
...
}var O=this.__Hl(M,N.value,N.states);
this.container.add(O);
},this);
},testHtmlCell:function(){var P={value:[f,h,j,null],states:[{},{selected:1}]};
var Q=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(P,function(R){var S=this.__Hl(Q,R.value,R.states);
...
qx.util.Permutation.permute(T,function(V){var W=this.__Hl(U,V.value,V.states);
...
qx.util.Permutation.permute(X,function(ba){var bb=this.__Hl(Y,ba.value,ba.states);
...
bd.setIconFalse(n);
bd.setIconTrue(l);
qx.util.Permutation.permute(bc,function(be){var bf=this.__Hl(bd,be.value,be.states);
this.container.add(bf);
},this);
},__Hl:function(bg,bh,bi){var bm=100;
var bk=30;
...
},members:{__AG:16,__AH:16,_aliasManager:null,__AI:function(v){var y=qx.util.ResourceManager.getInstance();
...
},__AJ:function(A){if(typeof (A)=="string"){A={url:A};
...
var H=this.__AJ(this._identifyImage(E));
...
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__Gk:null,__Gl:null,__Gj:null,_applyIconTrue:function(f){this.__Gk=this.__Gj.resolve(f);
},_applyIconFalse:function(g){this.__Gl=this.__Gj.resolve(g);
},_identifyImage:function(h){return h==true?this.__Gk:this.__Gl;
}}});
})();
