...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ProgressBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ProgressBar-qx.theme.Modern.79ed1d0185f5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.widget.ProgressBar",a="engine.version";
...
(function(){var d="change",c="changeValue",b="complete",a="demobrowser.demo.widget.ProgressBar";
...
var h=new qx.ui.container.Composite(f);
var i=new qx.ui.indicator.ProgressBar(0,200);
var j=new qx.ui.form.Slider().set({minimum:0,maximum:200});
var g=new qx.ui.basic.Label();
k.add(h,{left:0,top:0});
h.add(i);
h.add(j);
h.add(g);
f.setSpacing(10);
h.setPadding(20);
g.setValue("Completed: 0 (0%)");
j.addListener(c,function(e){i.setValue(e.getData());
});
i.addListener(d,function(e){g.setValue("Completed: "+i.getValue()+" ("+e.getData()+"%)");
g.setTextColor("black");
});
i.addListener(b,function(e){g.setTextColor("green");
});
}}});
})();
