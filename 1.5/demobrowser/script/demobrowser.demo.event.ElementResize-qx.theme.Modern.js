...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.ElementResize","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.ElementResize-qx.theme.Modern.dc6fa739229e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.event.ElementResize",a="engine.version";
...
qx.bom.Element.addListener(g,f,this._onResize,this);
this.update(g,g.offsetWidth,g.offsetHeight);
},_onResize:function(e){var h=e.getData();
this.update(e.getTarget(),h.width,h.height);
