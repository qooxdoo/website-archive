...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_2","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_2-qx.theme.Simple.41fe55b90ef8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.test.Element_2",b="os.name",a="engine.version";
...
(function(){var s="id",r="text",q="el4_2",p="el4_1",o="backgroundColor",n="#ccc",m="fontSize",l="demobrowser.demo.test.Element_2",k="20px",j="el5",d="red",i="el4_3",g="el2",c="el3",b="el4",f="test",e="doc",h="color",a="el1";
...
var t=new qx.html.Root(document.getElementById(f));
t.setAttribute(s,e);
this.info("Create five elements (2 hidden)");
var z=new qx.html.Element;
z.setAttribute(s,a);
var x=new qx.html.Element;
x.setAttribute(s,g);
var y=new qx.html.Element;
y.setAttribute(s,c);
var A=new qx.html.Element;
A.setAttribute(s,b);
var B=new qx.html.Element;
B.setAttribute(s,j);
t.add(z,x,y,A,B);
x.exclude();
A.exclude();
...
var u=new qx.html.Element;
u.setAttribute(s,p);
var w=new qx.html.Element;
w.setAttribute(s,q);
w.setStyle(h,d);
w.setAttribute(r,q);
w.exclude();
var v=new qx.html.Element;
v.setAttribute(s,i);
A.add(u,w,v);
A.include();
qx.html.Element.flush();
