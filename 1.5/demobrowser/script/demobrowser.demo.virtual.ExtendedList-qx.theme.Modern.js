...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ExtendedList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ExtendedList-qx.theme.Modern.0820ed1d9c9f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.virtual.ExtendedList";
...
(function(){var t="value",s="execute",r="online",q="Karl",p="name",o="<b>Displaying Checkboxes in a list</b><br/>",n="Write data to log",m="Jakob",l="Online <> Offline",k="This list display a set of persons in a list as checkbox. Every ",d="Jack",j="Dustin",g="Jim",c="Max",b="person does have a name as label and an online status as checkbox.",f="label",e="Dan",h="Tim",a="demobrowser.demo.virtual.ExtendedList";
...
var A=[c,m,h,d,e,j,q,g];
var C=[];

for(var i=0;i<20;i++){var y=new demobrowser.demo.data.model.Person();
y.setName(A[i%A.length]);
y.setOnline(i%3==0);
C.push(y);
}var B=new qx.data.Array(C);
var w=new qx.ui.list.List();
w.setWidth(150);
this.getRoot().add(w,{left:10,top:80});
var v={configureItem:function(D){D.setPadding(3);
},createItem:function(){return new qx.ui.form.CheckBox();
},bindItem:function(E,F,G){E.bindProperty(p,f,null,F,G);
E.bindProperty(r,t,null,F,G);
E.bindPropertyReverse(r,t,null,F,G);
}};
w.setDelegate(v);
w.setModel(B);
var u=new qx.ui.form.Button(l);
u.setWidth(120);
this.getRoot().add(u,{left:180,top:80});
u.addListener(s,function(){for(var i=0;i<B.length;i++){B.getItem(i).toggleOnline();
}},this);
var z=new qx.ui.form.Button(n);
z.setWidth(120);
this.getRoot().add(z,{left:180,top:115});
z.addListener(s,function(){qx.log.appender.Console.show();
...
x.setValue(o+k+b);
this.getRoot().add(x,{left:20,top:10});
}}});
})();
