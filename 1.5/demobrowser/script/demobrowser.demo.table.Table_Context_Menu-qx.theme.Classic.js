...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Context_Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Context_Menu-qx.theme.Classic.f41985886d2c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__FC=[];
this.__FD=[];
},members:{__FC:null,__FD:null,setContextMenuHandler:function(m,n,o){this.__FC[m]=n;
this.__FD[m]=o||this;
},getContextMenuHandler:function(p){return this.__FC[p];
