...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Showcase","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Showcase-qx.theme.Classic.178c413c541c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="linear",s="Number",r="reverse",q="Boolean",p="none",o="wobble",n="flicker",m="pulse",l="sinodial",k="easeOutQuad",d="spring",j="easeInQuad",g="full",c="Color",b="backgroundColor",f="#ffffff",e="backgroundImage",h="qx.fx.effect.combination.ColorFlow",a="__zk",i="#ffffaa";
qx.Class.define(h,{extend:qx.fx.Base,construct:function(u){qx.fx.Base.call(this,u);
this.__zk=[new qx.fx.effect.core.Highlight(u),new qx.fx.effect.core.Highlight(u)];
},properties:{startColor:{init:f,check:c},endColor:{init:i,check:c},forwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},backwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},forwardDuration:{init:1.0,check:s},backwardDuration:{init:1.0,check:s},delayBetween:{init:0.3,check:s},restoreBackground:{init:true,check:q},keepBackgroundImage:{init:false,check:q}},members:{__zl:null,__zk:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var v=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__zl={backgroundImage:qx.bom.element.Style.get(v,e),backgroundColor:qx.bom.element.Style.get(v,b)};
this.__zk[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__zk[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__zk[0].afterFinishInternal=function(){self.__zk[1].start();
};
this.__zk[0].start();
}},destruct:function(){this._disposeArray(a);
}});
})();
(function(){var e="opacity",d="qx.fx.effect.combination.Pulsate",c="__FE",b="__FF",a="sinodial";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
var g=this.getDuration()/6;
var h=0;
this.__FE=[new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f)];

for(var i=0,l=this.__FE.length;i<l;i++){this.__FE[i].set({duration:g,to:((h%2)!=0)?1:0,from:((h%2)!=0)?0:1,transition:a,modifyDisplay:false});
h++;
}},properties:{duration:{init:2,refine:true}},members:{__e:null,__FE:null,__FF:null,__FG:false,beforeSetup:function(){this.__e=qx.bom.element.Style.get(this._getElement(),e);
...
for(var i=0,l=this.__FE.length;i<l;i++){this.__FE[i].id=j;
this.__FF.push(this.__FE[i]);
this.__FE[i].afterFinishInternal=function(){qx.lang.Array.remove(self.__FF,this);
if(this.id<5){self.__FE[this.id+1].start();
}else{if(self.__FG){self.end();
}}};
j++;
}this.__FE[0].start();
},end:function(){if(this.__FF.length==0){qx.fx.Base.prototype.end.call(this);
}else{this.__FG=true;
}},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),e,this.__e);
},_applyDuration:function(k,m){var n=k/6;

for(var i=0,l=this.__FE.length;i<l;i++){this.__FE[i].set({duration:n});
}},cancel:function(){for(var i=0,l=this.__FF.length;i<l;i++){this.__FF[i].cancel();
}qx.fx.Base.prototype.cancel.call(this);
}},destruct:function(){this._disposeArray(c);
this._disposeArray(b);
}});
})();
(function(){var i="__yX",h="opacity",g="Boolean",f="none",e="qx.fx.effect.combination.Puff",d="__yW",c="_effects",b="__Gq",a="display";
qx.Class.define(e,{extend:qx.fx.Base,construct:function(j){qx.fx.Base.call(this,j);
this.__yW=new qx.fx.effect.core.Scale(j);
this.__Gq=new qx.fx.effect.core.Fade(j);
this.__yX=new qx.fx.effect.core.Parallel(this.__yW,this.__Gq);
},properties:{modifyDisplay:{init:true,check:g}},members:{__Gq:null,__yW:null,__yX:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var l=this._getElement();
var k={opacity:qx.bom.element.Style.get(l,h)};
this.__Gq.afterFinishInternal=function(){var n=this._getElement();

for(var m in k){qx.bom.element.Style.set(n,m,k[m]);
}};
this.__yW.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__Gq.set({sync:true,to:0.0,modifyDisplay:false});
...
(function(){var u="out",t="px",s="south",r="Number",q="north-west",p="west",o="in",n="north",m="south-east",l="south-west",e="east",k="north-east",h="display",c="__yX",b="top",g="Boolean",f="block",i="left",a="__yV",j="__Gq",d="qx.fx.effect.combination.Drop";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(v){qx.fx.Base.call(this,v);
this.__yV=new qx.fx.effect.core.Move(v);
this.__Gq=new qx.fx.effect.core.Fade(v);
this.__yX=new qx.fx.effect.core.Parallel(this.__yV,this.__Gq);
},properties:{direction:{init:s,check:[s,p,e,n,l,m,k,q]},xAmount:{init:100,check:r},yAmount:{init:100,check:r},mode:{init:u,check:[o,u]},modifyDisplay:{init:true,check:g}},members:{__Gq:null,__yV:null,__yX:null,start:function(){qx.fx.Base.prototype.start.call(this);
...
this.__Gq.afterFinishInternal=function(){for(var B in z){qx.bom.element.Style.set(A,B,z[B]+t);
}};
this.__Gq.set({duration:Math.min(0.5,this.getDuration()),sync:true,from:(this.getMode()==u)?1:0,to:(this.getMode()==u)?0:1,modifyDisplay:true});
this.__yX.setDuration(this.getDuration());
this.__yX.start();
}},destruct:function(){this._disposeObjects(a,j,c);
}});
})();
(function(){var q="display",p="in",o="overflow",n="block",m="none",l="visible",k="0px",j="hidden",i="visiblity",h="Boolean",c="height",g="width",f="__HV",b="px",a="qx.fx.effect.combination.Fold",e="__HW",d="out";
qx.Class.define(a,{extend:qx.fx.Base,construct:function(r){qx.fx.Base.call(this,r);
},properties:{modifyDisplay:{init:true,check:h},mode:{init:p,check:[p,d]}},members:{__HV:null,__HW:null,__zl:null,afterFinish:function(){var s=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==p)){qx.bom.element.Style.set(s,q,n);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var t=this._getElement();
var self=this;
this.__HV=new qx.fx.effect.core.Scale(t);
this.__HW=new qx.fx.effect.core.Scale(t);
this.__HV.afterFinishInternal=function(){self.__HW.start();
};
this.__HW.afterFinishInternal=function(){self._cleanUp();
};
this.__zl=this._getStyle();
...
}else{this.__HV.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__zl.width,this.__zl.height]});
this.__HW.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__zl.width,this.__zl.height]});
...
for(var u in this.__zl){v=this.__zl[u];
...
}},destruct:function(){this._disposeObjects(f,e);
}});
})();
(function(){var j="off",i="overflow",h="__yW",g="Boolean",f="qx.fx.effect.combination.Switch",e="none",d="__Gi",c="flicker",b="hidden",a="display";
qx.Class.define(f,{extend:qx.fx.Base,construct:function(k){qx.fx.Base.call(this,k);
this.setTransition(c);
var l=this.__yW=new qx.fx.effect.core.Scale(k);
this.__yW.beforeSetup=function(){qx.bom.element.Style.set(k,i,b);
};
this.__Gi=new qx.fx.effect.core.Fade(k);
this.__Gi.afterFinishInternal=function(){l.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:g},mode:{init:j,check:[j]}},members:{__yW:null,__Gi:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var n=this._getElement();
var m=qx.bom.element.Style.get(n,i);
this.__yW.afterFinishInternal=function(){qx.bom.element.Style.set(n,i,m);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==j)){qx.bom.element.Style.set(this._getElement(),a,e);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}
if(this.getMode()==j){this.__yW.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__Gi.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__Gi.start();
},_applyDuration:function(o,p){this.__yW.setDuration(o/2);
this.__Gi.setDuration(o/2);
}},destruct:function(){this._disposeObjects(d,h);
}});
})();
