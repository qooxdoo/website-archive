...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Touch","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Touch-qx.theme.Modern.d6b9bafa759a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(s,{extend:qx.application.Native,members:{__Nh:null,__Ni:null,main:function(){qx.application.Native.prototype.main.call(this);
...
N.setAttribute(j,v);
return;
}M.add(this.__Nj(10,10,c,z));
M.add(this.__Nj(110,10,w,K));
this.__Nh=this.__Nk(10,110);
M.add(this.__Nh);
this.__Ni=this.__Nk(110,110);
M.add(this.__Ni);
M.add(this.__Nl(210,10));
},__Nj:function(x,y,O,P){var Q={"position":h,"left":x+l,"top":y+l,"width":d,"height":d,"backgroundColor":O,"fontFamily":f,"fontSize":g};
var R=new qx.html.Element(k,Q,{"id":P});
R.setAttribute(j,A+P+m);
R.addListener(C,this.__Nm,this);
R.addListener(a,this.__Nm,this);
R.addListener(F,this.__Nm,this);
R.addListener(u,this.__Nm,this);
return R;
},__Nk:function(x,y){var S={"position":h,"left":x+l,"top":y+l,"width":d,"fontFamily":f,"fontSize":t};
return new qx.html.Element(k,S);
},__Nl:function(x,y){var T={"position":h,"left":x+l,"top":y+l,"width":b,"height":b,"backgroundColor":p,"fontFamily":f,"fontSize":g};
