...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Command","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Command-qx.theme.Modern.190db9e6e698.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.ui.Command",b="os.name",a="engine.version";
...
(function(){var p="  Button in the content at the bottom\n",o="demobrowser.demo.ui.Command",n="Save",m="label",l="icon",k="Editor",j="Save the current file.",i="  Button in the menu\n",h="icon/16/actions/document-save.png",g="  Button in the toolbar\n",c="CTRL+S",f="and have the same execute listener.",e="File",b="You can see three buttons in this window:\n",a="execute",d="Each of the buttons is configured using the same command ";
...
var u=new qx.ui.core.Command(c);
u.setLabel(n);
u.setIcon(h);
u.setToolTipText(j);
u.addListener(a,function(){alert("Saving...");
},this);
var t=new qx.ui.window.Window(k);
t.setLayout(new qx.ui.layout.VBox(0));
t.setWidth(400);
t.setHeight(300);
t.setContentPadding(0);
t.moveTo(30,10);
t.open();
var menubar=new qx.ui.menubar.MenuBar();
t.add(menubar);
var s=new qx.ui.menubar.Button(e);
menubar.add(s);
var v=new qx.ui.menu.Menu();
s.setMenu(v);
var q=new qx.ui.menu.Button();
q.setCommand(u);
v.add(q);
var toolbar=new qx.ui.toolbar.ToolBar();
t.add(toolbar);
var y=new qx.ui.toolbar.Button();
y.setCommand(u);
y.setShow(l);
toolbar.add(y);
var content=new qx.ui.container.Composite();
content.setLayout(new qx.ui.layout.VBox());
t.add(content,{flex:1});
var r=new qx.ui.form.TextArea();
content.add(r,{flex:1});
