...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.treevirtual.TreeVirtual_Filter","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.treevirtual.TreeVirtual_Filter-qx.theme.Classic.e0a7042f507a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="demobrowser.demo.treevirtual.TreeVirtual_Filter",d="qx.core.BaseInit",c="engine.name",b="os.name",a="engine.version";
...
this.__yL=false;
this.__yM=false;
},properties:{behavior:{check:j,init:null,nullable:true,apply:h,event:e}},members:{__yM:null,__yL:null,__xT:null,_applyBehavior:function(r,s){if(s!=null){s.dispose();
s=null;
