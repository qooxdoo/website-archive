...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.DragDrop","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop-qx.theme.Classic.8e2f5077176f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.ui.DragDrop",a="engine.version";
...
qx.Class.define(s,{extend:qx.application.Standalone,members:{__oD:null,__Nv:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var M=this.getRoot();
...
var C=this.__oD=new qx.ui.form.List;
C.setDraggable(true);
C.setDroppable(true);
...
C.addListener(n,function(e){D.setDomPosition(-1000,-1000);
});
C.addListener(A,function(e){var V=e.getOriginalTarget();
if(V instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Nv=V;
}
...
C.addListener(m,function(e){this.__Nw(e.getOriginalTarget());
},this);
D.addListener(m,function(e){this.__Nw(this.__Nv);
},this);
},__Nw:function(W){if(W.classname!=w){return;
}var X=this.__oD.getSortedSelection();

for(var i=0,l=X.length;i<l;i++){this.__oD.addBefore(X[i],W);
this.__oD.addToSelection(X[i]);
