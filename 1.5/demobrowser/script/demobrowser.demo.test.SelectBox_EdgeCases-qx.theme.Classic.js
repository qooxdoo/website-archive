...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.SelectBox_EdgeCases","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.SelectBox_EdgeCases-qx.theme.Classic.3e223c549d68.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.SelectBox_EdgeCases";
...
(function(){var m="Times New Roman",l="Long list",k="Long button, short text",j="",h="Fonts",g="container",f="Font ",e="Tahoma",d="Courier New",c="Item ",a="Arial",b="demobrowser.demo.test.SelectBox_EdgeCases";
...
var n=new qx.ui.container.Scroll();
...
n.add(this.container);
this.getRoot().add(n,{edge:0});
this.addBox1();
this.addBox2();
this.addBox3();
},addBox1:function(){this.container.add(new qx.ui.basic.Label(l),{left:25,top:20});
var o=new qx.ui.form.SelectBox();
o.setMaxListHeight(null);

for(var i=0;i<300;i++){var p=new qx.ui.form.ListItem(j+i);
o.add(p);
}this.container.add(o,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(h),{left:25,bottom:45});
var w=new qx.ui.form.SelectBox();
var r=new qx.bom.Font(12,[e]);
var s=new qx.bom.Font(15,[a]);
var q=new qx.bom.Font(18,[d]);
var u=new qx.bom.Font(21,[m]);
var t=[r,s,q,u];

for(var i=0;i<t.length;i++){var v=new qx.ui.form.ListItem(f+(i+1));
v.setFont(t[i]);
w.add(v);
}this.container.add(w,{left:20,bottom:20});
},addBox3:function(){this.container.add(new qx.ui.basic.Label(k),{left:205,top:20});
var x=new qx.ui.form.SelectBox();
x.setWidth(300);
x.setMaxListHeight(100);

for(var i=0;i<20;i++){var y=new qx.ui.form.ListItem(c+i);
if(i%5==1){y.setEnabled(false);
}x.add(y);
