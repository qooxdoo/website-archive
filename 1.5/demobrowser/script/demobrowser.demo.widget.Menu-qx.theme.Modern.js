...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Modern.78e7cccb7281.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.widget.Menu",a="engine.version";
...
(function(){var cb="execute",ca="changeValue",bY="icon/16/actions/edit-cut.png",bX="changeSelection",bW="icon/16/actions/edit-paste.png",bV="Copy",bU="Paste",bT="icon/16/actions/edit-copy.png",bS="Cut",bR="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",ci="Print",cj="Open",cg="icon/16/actions/document-new.png",ch="Online Forum",ce="icon/16/actions/format-justify-fill.png",cf="Search in files",cc="C",cd="Left aligned",ck="Perl",cl="View",bK="C Dialect",bJ="Info...",bM="Save as...",bL="Show line numbers",bO="__NT",bN="Quickstart",bQ="icon/16/actions/contact-new.png",bP="Actions",bI="Show console",bH="Search",a="Help",b="Show status bar",c="icon/16/actions/format-justify-left.png",d="ANSI to OEM",f="Centered",g="Website 3",h="Edit",j="icon/16/actions/format-justify-center.png",k="icon/16/actions/go-previous.png",l="C Sharp",cp="Close",co="__Fd",cn="Website 2",cm="icon/16/actions/document-save-as.png",ct="Python",cs="icon/16/apps/utilities-help.png",cr="Show tree",cq="Options",cv="Spaces to tabs",cu="Right aligned",K="Action 1",L="OEM to ANSI",I="Line 431",J="JavaScript",O="icon",P="__NR",M="Action 2",N="Folder ",G="XML",H="Line 313",t="Paragraph",s="demobrowser.demo.widget.Menu",v="icon/16/actions/application-exit.png",u="C Plus Plus",p="Line 26",o="Item ",r="ASCII table",q="Option 1",n="Search next...",m="__NS",U="Line 12",V="Action 3",W="Replace in files",X="Uppercase",Q="Topics",R="Panes",S="Justified",T="__EV",Y="Show macros",ba="Search previous...",D="__NU",C="Back",B="__NP",A="main",z="icon/16/actions/format-justify-right.png",y="icon/16/actions/go-next.png",x="command ",w="Option 3",F="Next",E="Ctrl+R",bb="__NQ",bc="Show tags",bd="Capitals",be="Format",bf="File",bg="Show tabs",bh="Split Button",bi="Tabs to spaces",bj="Search...",bk="Line 1039",by="Option 2",bx="Objective C",bw="Exit",bv="move to",bC="Syntax",bB="Show ruler",bA="Website 1",bz="Menu Button",bE="Line 30",bD="Lowercase",bF="Replace",bG="HTML";
qx.Class.define(s,{extend:qx.application.Standalone,members:{__NP:null,__NQ:null,__NR:null,__EV:null,__Fd:null,__NS:null,__NT:null,__NU:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cx=new qx.ui.container.Scroll();
var cw=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cw.setPadding(20);
cw.setAllowStretchX(false);
cx.add(cw);
this.getRoot().add(cx,{edge:0});
this.createCommands();
cw.add(this.getMenuButton(),{left:20,top:20});
cw.add(this.getSplitButton(),{left:150,top:20});
cw.add(this.getMenuBar(),{left:20,top:100});
cw.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var cy=new qx.ui.menu.Menu();
var cz=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){cz.add(new qx.ui.menu.Button(N+(i+1)));
}cy.add(new qx.ui.menu.Button(bv,null,null,cz));
cy.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cy.add(new qx.ui.menu.Button(x+(i+1)));
}return cy;
...
},createCommands:function(){this.__NP=new qx.ui.core.Command("Ctrl+N");
this.__NP.addListener(cb,this.debugCommand);
this.__NQ=new qx.ui.core.Command("Ctrl+O");
this.__NQ.addListener(cb,this.debugCommand);
this.__NR=new qx.ui.core.Command("Ctrl+S");
this.__NR.addListener(cb,this.debugCommand);
this.__EV=new qx.ui.core.Command("Ctrl+Z");
this.__EV.addListener(cb,this.debugCommand);
this.__Fd=new qx.ui.core.Command(E);
this.__Fd.addListener(cb,this.debugCommand);
this.__NS=new qx.ui.core.Command("Ctrl+X");
this.__NS.addListener(cb,this.debugCommand);
this.__NT=new qx.ui.core.Command("Ctrl+C");
this.__NT.addListener(cb,this.debugCommand);
this.__NU=new qx.ui.core.Command("Ctrl+P");
this.__NU.addListener(cb,this.debugCommand);
this.__NU.setEnabled(false);
},getMenuButton:function(){var cA=new qx.ui.menu.Menu;
cA.add(new qx.ui.menu.RadioButton(q));
cA.add(new qx.ui.menu.RadioButton(by));
cA.add(new qx.ui.menu.RadioButton(w));
var cI=new qx.ui.menu.Menu;
cI.add(new qx.ui.menu.RadioButton(K));
cI.add(new qx.ui.menu.RadioButton(M));
cI.add(new qx.ui.menu.RadioButton(V));
var cH=new qx.ui.form.RadioGroup;
cH.add.apply(cH,cA.getChildren());
cH.addListener(bX,this.debugRadio);
var cF=new qx.ui.form.RadioGroup;
cF.add.apply(cF,cI.getChildren());
cF.addListener(bX,this.debugRadio);
var cD=new qx.ui.menu.Menu();
var cG=new qx.ui.menu.Button(bt,bn,this.__EV);
var cN=new qx.ui.menu.Button(br,bl,this.__Fd);
var cC=new qx.ui.menu.Button(bS,bY,this.__NS);
var cK=new qx.ui.menu.Button(bV,bT,this.__NT);
var cE=new qx.ui.menu.Button(bU,bW,this.__NU);
var cB=new qx.ui.menu.Button(cq,bR,null,cA);
var cL=new qx.ui.menu.Button(bP,bQ,null,cI);
var cJ=new qx.ui.menu.Button(ci,bp);
cG.addListener(cb,this.debugButton);
cN.addListener(cb,this.debugButton);
cC.addListener(cb,this.debugButton);
cK.addListener(cb,this.debugButton);
cE.addListener(cb,this.debugButton);
cB.addListener(cb,this.debugButton);
cL.addListener(cb,this.debugButton);
cJ.addListener(cb,this.debugButton);
cD.add(cG);
cD.add(cN);
cD.addSeparator();
cD.add(cC);
...
cD.addSeparator();
cD.add(cJ);
var cM=new qx.ui.form.MenuButton(bz,bq,cD);
return cM;
},getSplitButton:function(){var cO=new qx.ui.menu.Menu;
var cS=new qx.ui.menu.Button(bA);
var cQ=new qx.ui.menu.Button(cn);
var cR=new qx.ui.menu.Button(g);
cO.setMinWidth(120);
cS.addListener(cb,this.debugButton);
cQ.addListener(cb,this.debugButton);
cR.addListener(cb,this.debugButton);
cO.add(cS);
cO.add(cQ);
cO.add(cR);
var cP=new qx.ui.form.SplitButton(bh,bq,cO);
cP.addListener(cb,this.debugButton);
return cP;
},getMenuBar:function(){var cX=new qx.ui.container.Composite(new qx.ui.layout.Grow);
cX.setDecorator(A);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
cX.add(toolbar);
var dh=new qx.ui.toolbar.Part;
...
toolbar.addSpacer();
toolbar.add(db);
var dg=new qx.ui.toolbar.SplitButton(C,k,this.getBackMenu());
var dd=new qx.ui.toolbar.SplitButton(F,y,this.getForwardMenu());
var cV=new qx.ui.toolbar.Button(bu,cg,this.__NP);
var da=new qx.ui.toolbar.Button(cj,bo,this.__NQ);
var df=new qx.ui.toolbar.Button(bm,bs,this.__NR);
dg.addListener(cb,this.debugButton);
dd.addListener(cb,this.debugButton);
cV.addListener(cb,this.debugButton);
...
dh.add(df);
dh.setShow(O);
var cY=new qx.ui.toolbar.MenuButton(bf);
var cU=new qx.ui.toolbar.MenuButton(h);
var cT=new qx.ui.toolbar.MenuButton(bH);
var di=new qx.ui.toolbar.MenuButton(cl);
var de=new qx.ui.toolbar.MenuButton(be);
cY.setMenu(this.getFileMenu());
cU.setMenu(this.getEditMenu());
cT.setMenu(this.getSearchMenu());
di.setMenu(this.getViewMenu());
de.setMenu(this.getFormatMenu());
cW.add(cY);
cW.add(cU);
cW.add(cT);
cW.add(di);
cW.add(de);
var dc=new qx.ui.toolbar.MenuButton(a);
dc.setMenu(this.getHelpMenu());
db.add(dc);
return cX;
},getBackMenu:function(){var dk=new qx.ui.menu.Menu;
var dl=new qx.ui.menu.Button(H);
var dn=new qx.ui.menu.Button(bk);
var dj=new qx.ui.menu.Button(U);
var dm=new qx.ui.menu.Button(p);
dl.addListener(cb,this.debugButton);
dn.addListener(cb,this.debugButton);
dj.addListener(cb,this.debugButton);
dm.addListener(cb,this.debugButton);
dk.add(dl);
dk.add(dn);
dk.add(dj);
dk.add(dm);
return dk;
},getForwardMenu:function(){var dp=new qx.ui.menu.Menu;
var dq=new qx.ui.menu.Button(I);
var dr=new qx.ui.menu.Button(bE);
dq.addListener(cb,this.debugButton);
dr.addListener(cb,this.debugButton);
dp.add(dq);
dp.add(dr);
return dp;
},getFileMenu:function(){var du=new qx.ui.menu.Menu;
var ds=new qx.ui.menu.Button(bu,cg,this.__NP);
var dw=new qx.ui.menu.Button(cj,bo,this.__NQ);
var dv=new qx.ui.menu.Button(cp);
var dz=new qx.ui.menu.Button(bm,bs,this.__NR);
var dy=new qx.ui.menu.Button(bM,cm);
var dx=new qx.ui.menu.Button(ci,bp);
var dt=new qx.ui.menu.Button(bw,v);
ds.addListener(cb,this.debugButton);
dw.addListener(cb,this.debugButton);
dv.addListener(cb,this.debugButton);
dz.addListener(cb,this.debugButton);
dy.addListener(cb,this.debugButton);
dx.addListener(cb,this.debugButton);
dt.addListener(cb,this.debugButton);
du.add(ds);
du.add(dw);
du.add(dv);
du.add(dz);
...
du.add(dt);
return du;
},getEditMenu:function(){var dB=new qx.ui.menu.Menu;
var dE=new qx.ui.menu.Button(bt,bn,this.__EV);
var dD=new qx.ui.menu.Button(br,bl,this.__Fd);
var dA=new qx.ui.menu.Button(bS,bY,this.__NS);
var dF=new qx.ui.menu.Button(bV,bT,this.__NT);
var dC=new qx.ui.menu.Button(bU,bW,this.__NU);
dE.addListener(cb,this.debugButton);
dD.addListener(cb,this.debugButton);
dA.addListener(cb,this.debugButton);
dF.addListener(cb,this.debugButton);
dC.addListener(cb,this.debugButton);
dB.add(dE);
dB.add(dD);
dB.addSeparator();
dB.add(dA);
...
dB.add(dC);
return dB;
},getSearchMenu:function(){var dJ=new qx.ui.menu.Menu;
var dH=new qx.ui.menu.Button(bj,bR);
var dM=new qx.ui.menu.Button(n);
var dI=new qx.ui.menu.Button(ba);
var dL=new qx.ui.menu.Button(bF);
var dG=new qx.ui.menu.Button(cf,bR);
var dK=new qx.ui.menu.Button(W);
dI.setEnabled(false);
...
dJ.add(dK);
return dJ;
},getViewMenu:function(){var dN=new qx.ui.menu.Menu;
var dP=new qx.ui.menu.Button(R,null,null,this.getPanesMenu());
var dS=new qx.ui.menu.Button(bC,null,null,this.getSyntaxMenu());
var dR=new qx.ui.menu.CheckBox(bB);
var dQ=new qx.ui.menu.CheckBox(bL);
var dO=new qx.ui.menu.Button(r);
dR.addListener(ca,this.debugCheckBox);
dQ.addListener(ca,this.debugCheckBox);
dO.addListener(cb,this.debugButton);
dN.add(dP);
dN.add(dS);
dN.addSeparator();
dN.add(dR);
...
dN.add(dO);
return dN;
},getPanesMenu:function(){var dU=new qx.ui.menu.Menu;
var dW=new qx.ui.menu.CheckBox(bg);
var dY=new qx.ui.menu.CheckBox(b);
var ea=new qx.ui.menu.CheckBox(cr);
var dV=new qx.ui.menu.CheckBox(Y);
var dX=new qx.ui.menu.CheckBox(bc);
var dT=new qx.ui.menu.CheckBox(bI);
dW.setValue(true);
dY.setValue(true);
dV.setValue(true);
dW.addListener(ca,this.debugCheckBox);
dY.addListener(ca,this.debugCheckBox);
ea.addListener(ca,this.debugCheckBox);
dV.addListener(ca,this.debugCheckBox);
dX.addListener(ca,this.debugCheckBox);
dT.addListener(ca,this.debugCheckBox);
dU.add(dY);
dU.add(dW);
dU.addSeparator();
dU.add(ea);
...
var eb=new qx.ui.menu.RadioButton(bG);
var ed=new qx.ui.menu.RadioButton(G);
var ec=new qx.ui.menu.RadioButton(J);
var ee=new qx.ui.menu.Button(bK,null,null,this.getSyntaxCMenu());
var ei=new qx.ui.menu.RadioButton(ck);
var eg=new qx.ui.menu.RadioButton(ct);
ef.add(eb);
ef.add(ed);
ef.add(ec);
ef.add(ee);
...
eh.addListener(bX,this.debugRadio);
return ef;
},getSyntaxCMenu:function(){var ek=new qx.ui.menu.Menu;
var ej=new qx.ui.menu.RadioButton(cc);
var en=new qx.ui.menu.RadioButton(l);
var em=new qx.ui.menu.RadioButton(bx);
var el=new qx.ui.menu.RadioButton(u);
ek.add(ej);
ek.add(en);
ek.add(em);
ek.add(el);
...
var eq=new qx.ui.menu.Button(t,null,null,this.getParagraphMenu());
var et=new qx.ui.menu.Button(bi);
var eu=new qx.ui.menu.Button(cv);
var ep=new qx.ui.menu.Button(X);
var es=new qx.ui.menu.Button(bD);
var eo=new qx.ui.menu.Button(bd);
var ew=new qx.ui.menu.Button(L);
var ev=new qx.ui.menu.Button(d);
et.addListener(cb,this.debugButton);
eu.addListener(cb,this.debugButton);
ep.addListener(cb,this.debugButton);
es.addListener(cb,this.debugButton);
eo.addListener(cb,this.debugButton);
ew.addListener(cb,this.debugButton);
ev.addListener(cb,this.debugButton);
er.add(eq);
er.add(et);
er.add(eu);
er.addSeparator();
...
var eA=new qx.ui.menu.Button(cd,c);
var eB=new qx.ui.menu.Button(cu,z);
var ey=new qx.ui.menu.Button(f,j);
var ez=new qx.ui.menu.Button(S,ce);
eA.addListener(cb,this.debugButton);
eB.addListener(cb,this.debugButton);
ey.addListener(cb,this.debugButton);
ez.addListener(cb,this.debugButton);
ex.add(eA);
ex.add(eB);
ex.add(ey);
ex.add(ez);
return ex;
},getHelpMenu:function(){var eC=new qx.ui.menu.Menu;
var eE=new qx.ui.menu.Button(Q,cs);
var eG=new qx.ui.menu.Button(bN);
var eF=new qx.ui.menu.Button(ch);
var eD=new qx.ui.menu.Button(bJ);
eE.addListener(cb,this.debugButton);
eG.addListener(cb,this.debugButton);
eF.addListener(cb,this.debugButton);
eD.addListener(cb,this.debugButton);
eC.add(eE);
eC.add(eG);
eC.addSeparator();
eC.add(eF);
...
eC.add(eD);
return eC;
},getList:function(){var eH=new qx.ui.form.List;
eH.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){eH.add(new qx.ui.form.ListItem(o+i));
}return eH;
},getContextMenu:function(){var eI=new qx.ui.menu.Menu;
var eK=new qx.ui.menu.Button(bS,bY,this.__NS);
var eL=new qx.ui.menu.Button(bV,bT,this.__NT);
var eJ=new qx.ui.menu.Button(bU,bW,this.__NU);
eK.addListener(cb,this.debugButton);
eL.addListener(cb,this.debugButton);
eJ.addListener(cb,this.debugButton);
eI.add(eK);
eI.add(eL);
eI.add(eJ);
return eI;
}},destruct:function(){this._disposeObjects(B,bb,P,T,co,m,bO,D);
}});
})();
