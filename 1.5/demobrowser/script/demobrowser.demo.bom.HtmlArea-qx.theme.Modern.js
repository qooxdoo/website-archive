...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea-qx.theme.Modern.cc7f704f4cd0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="0px",s="840px",r="1px solid #AAA",q="div",p="white",o="350px",n='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',m="demobrowser.demo.bom.HtmlArea",l="traditional web pages / single-page applications.<br/> ",k="innerHTML",c="<p>This low-level widget can be used separately at ",h="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",g="20px 20px",b="You can play around with this widget by hitting the ",a="<h1>HtmlArea low-level widget</h1>",f="buttons at the toolbar.</p>",d="It is the foundation for the UI widget component.</p>";
qx.Class.define(m,{extend:qx.application.Native,members:{__ub:null,__LW:null,__LX:null,__JI:null,__cj:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__ub=qx.bom.Element.create(q);
qx.bom.element.Style.setStyles(this.__ub,{margin:g});
var w=qx.bom.Element.create(q);
qx.bom.element.Style.setStyles(w,{width:s,padding:t,margin:t});
var v=a+c+l+d+h+b+f;
qx.bom.element.Attribute.set(w,k,v);
this.__LW=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LW,{width:s,padding:t,margin:t,lineHeight:t,border:r});
this.__LX=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__LX,{width:s,height:o,border:r,borderTop:t,backgroundColor:p});
qx.dom.Element.insertEnd(this.__LX,this.__ub);
var u=n;
this.__JI=new qx.bom.htmlarea.HtmlArea(this.__LX,u,null,"blank.html");
this.__JS();
qx.dom.Element.insertBegin(this.__LW,this.__ub);
qx.dom.Element.insertBegin(w,this.__ub);
qx.dom.Element.insertBegin(this.__ub,document.body);
},__LY:function(e){var x=window.prompt("FontSize: ","");
this.setFontSize(parseInt(x));
},__JJ:function(e){var y=window.prompt("Color (Hex): ","#");
this.setTextColor(y);
},__JK:function(e){var z=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(z);
},__JL:function(e){var A={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(A);
},__JM:function(e){var B="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(B);
},__JN:function(e){var C=window.prompt("Link: ","http://");
this.insertHyperLink(C);
},__JO:function(e){var D=window.prompt("HTML Code:","");
this.insertHtml(D);
},__JP:function(){var F=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(F,{"float":"left"});
var H;
var G=qx.bom.Element.create("select",{title:"Change font family"});

if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(G,"hideFocus","true");
}else{qx.bom.element.Style.set(G,"outline","none");
}H=qx.bom.Collection.html("<option value=''></option>");
qx.dom.Element.insertEnd(H[0],G);
var I=["Tahoma","Verdana","Times New Roman","Arial","Arial Black","Courier New","Courier","Georgia","Impact","Comic Sans MS","Lucida Console"];
var E;
var J;

for(var i=0,j=I.length;i<j;i++){E="<option qxKeepFocus='on' qxSelectable='off'"+"value='"+I[i]+"'>"+I[i]+"</option>";
J=qx.bom.Collection.html(E);

if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(J[0],"hideFocus","true");
}else{qx.bom.element.Style.set(J[0],"outline","none");
}qx.dom.Element.insertEnd(J[0],G);
}qx.event.Registration.addListener(G,"change",function(e){var K=e.getTarget();
var L=K.selectedIndex;

if(L!=0){this.setFontFamily(K.options[L].value);
K.options[0].selected=true;
}},this.__JI);
qx.dom.Element.insertBegin(G,F);
return F;
},__JQ:function(){var N=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(N,{"marginRight":"16px","float":"left"});
var P;
var O=qx.bom.Element.create("select",{title:"Change font size"});

if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(O,"hideFocus","true");
}else{qx.bom.element.Style.set(O,"outline","none");
}P=qx.bom.Collection.html("<option value=''></option>");
qx.dom.Element.insertEnd(P[0],O);
var Q;
var M;

for(var i=1;i<=7;i++){M="<option qxKeepFocus='on' qxSelectable='off' "+"value='"+i+"'>"+i+"</option>";
Q=qx.bom.Collection.html(M);

if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(Q[0],"hideFocus","true");
}else{qx.bom.element.Style.set(Q[0],"outline","none");
}qx.dom.Element.insertEnd(Q[0],O);
}qx.event.Registration.addListener(O,"change",function(e){var R=e.getTarget();
var S=R.selectedIndex;

if(S!=0){this.setFontSize(R.options[S].value);
R.options[0].selected=true;
}},this.__JI);
qx.dom.Element.insertBegin(O,N);
return N;
},__JS:function(){var U=[{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__JI.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__JI.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__JI.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__JI.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__JI.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__JI.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__JI.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__JI.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__JI.setJustifyFull}},{fontFamily:{custom:this.__JP},fontSize:{custom:this.__JQ},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__JJ},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__JK}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__JI.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__JI.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__JL},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__JM},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__JN},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__JO},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__JI.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__JI.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__JI.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__JI.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__JI.redo}}];
var W,bb,T,Y;

for(var i=0,j=U.length;i<j;i++){bb={};
bb["marginRight"]=i==j-1?"0px":"16px";
bb["float"]="left";
W=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(W,bb);

for(var X in U[i]){var ba=U[i][X];

if(ba.custom){T=ba.custom.call(this);
}else{var V=qx.util.AliasManager.getInstance().resolve(ba.image);
Y={type:"image",src:qx.util.ResourceManager.getInstance().toUri(V),title:ba.text,qxKeepFocus:"on",qxSelectable:"off"};
T=qx.bom.Element.create("input",Y);
qx.bom.element.Style.setStyles(T,{width:"16px",height:"16px",padding:"4px"});

if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(T,"hideFocus","true");
}else{qx.bom.element.Style.set(T,"outline","none");
}qx.event.Registration.addListener(T,"click",ba.action,this.__JI);
}qx.dom.Element.insertEnd(T,W);
}qx.dom.Element.insertEnd(W,this.__LW);
}qx.dom.Element.insertEnd(qx.bom.Element.create("br",{style:"clear:both"}),this.__LW);
}}});
})();
