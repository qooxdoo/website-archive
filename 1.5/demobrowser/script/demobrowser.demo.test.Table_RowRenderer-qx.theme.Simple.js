...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_RowRenderer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_RowRenderer-qx.theme.Simple.7fd05060aeb7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.Table_RowRenderer";
...
(function(){var r="px",q='" ',p='>',o="",n=";position:relative;height:",m="table",l=' (init)</div>',k='class="',j=" (update)",i="relative",c="div",h='style="',f="px;",b="px; width:",a=": ",e="demobrowser.demo.test.Table_RowRenderer",d=", ",g='<div ';
...
},testDefaultRenderer:function(s){var s=new qx.ui.table.rowrenderer.Default();
var w=300;
var v=20;
var u={focusedRow:[true,false],selected:[true,false],row:[1,2],table:[this.tableMock]};
var t=this._getNewTableDiv(w);
var self=this;
qx.util.Permutation.permute(u,function(x){var content=[];

for(var B in x){if(B!==m){content.push(B+a+x[B]);
}}content=content.join(d);
var C=self._createRowElement(t,w,v);
var y=s.getRowClass(x);

if(y){C.className=y;
}C.innerHTML=content+j;
s.updateDataRowElement(x,C);
var A=[];
A.push(g);

if(y){A.push(k,y,q);
}var z=s.createRowStyle(x);
z+=n+v+b+w+f;

if(z){A.push(h,z,q);
}A.push(p,content,l);
t.innerHTML+=A.join(o);
self._rowTop+=v;
});
},_rowTop:0,_createRowElement:function(parent,D,E){var F=qx.bom.Element.create(c);
qx.bom.element.Style.setStyles(F,{position:i,width:D+r,height:E+r});
this._rowTop+=20;
