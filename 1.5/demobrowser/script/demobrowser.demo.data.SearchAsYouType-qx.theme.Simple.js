...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SearchAsYouType","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Simple.36734a2eb9d3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__qF=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__qF:null,__N:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__qF!=null){i.stop(this.__qF);
this.__qF=null;
}this.__qF=i.start(function(){this.__N.update();
this.__qF=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__N=null;
}});
})();
