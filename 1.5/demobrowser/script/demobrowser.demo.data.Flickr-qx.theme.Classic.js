...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Flickr","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr-qx.theme.Classic.df09e15a4973.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.data.Flickr",b="os.name",a="engine.version";
...
qx.data.store.Jsonp.call(this,this.__Mb(R));
},members:{searchForTag:function(S){if(S!=h){this.setUrl(this.__Mb(S));
}},__Mb:function(T){if(!T){return;
}var U=u+T;
U+=m;
return U;
}}});
