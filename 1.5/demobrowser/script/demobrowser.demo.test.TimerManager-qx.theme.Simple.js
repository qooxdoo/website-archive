...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager-qx.theme.Simple.55bb75f73378.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.TimerManager";
...
(function(){var j="Stopping recurrent 2-second timer",i="Recurrent 2-second timer with limit 3:",h="\n",g="One-shot 1-second timer: ",f=" ",e="demobrowser.demo.test.TimerManager",d="Recurrent 5-second timer: ",c="Start timers",b="execute",a="__vw";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__vw:null,startTimers:function(){var k=qx.util.TimerManager.getInstance();
k.start(function(l,m){this.__Ng(d+m);
},5000,this,null,0);
k.start(function(n,o){this.__Ng(g+o);
},0,this,null,1000);
k.start(function(p,q){this.__Ng(i+q);

if(++p.count==3){this.__Ng(j);
k.stop(q);
}},2000,this,{count:0},2000);
},__Ng:function(r){r=Date.parse(new Date)+f+r+h;
this.__vw.setValue(this.__vw.getValue()+r);
},main:function(){qx.application.Standalone.prototype.main.call(this);
var t=new qx.ui.layout.VBox(5);
var s=new qx.ui.container.Composite(t);
var u=new qx.ui.form.Button(c);
u.set({allowGrowX:false,allowGrowY:false});
u.addListener(b,function(){u.setEnabled(false);
this.startTimers();
},this);
var v=new qx.ui.form.TextArea();
v.set({width:400,height:300});
this.__vw=v;
s.add(v);
s.add(u);
this.getRoot().add(s,{left:20,top:10});
}},destruct:function(){this._disposeObjects(a);
}});
})();
(function(){var c="interval",b="qx.util.TimerManager",a="singleton";
qx.Class.define(b,{extend:qx.core.Object,type:a,statics:{__Gb:[],__Gc:{},__qF:0},members:{__Gd:false,start:function(d,e,f,g,h){if(!h){h=e||0;
}var j=(new Date()).getTime()+h;
this.self(arguments).__Gc[++this.self(arguments).__qF]={callback:d,userData:g||null,expireAt:j,recurTime:e,context:f||this};
this.__Ge(j,this.self(arguments).__qF);
return this.self(arguments).__qF;
},stop:function(k){var l=this.self(arguments).__Gb;
var length=l.length;

for(var i=0;i<length;i++){if(l[i]==k){l.splice(i,1);
break;
}}delete this.self(arguments).__Gc[k];
if(l.length==0&&this.__Gd){qx.event.Idle.getInstance().removeListener(c,this.__Gf,this);
this.__Gd=false;
}},__Ge:function(m,n){var p=this.self(arguments).__Gb;
var o=this.self(arguments).__Gc;
var length=p.length;

for(var i=0;i<length;i++){if(o[p[i]].expireAt>m){p.splice(i,0,n);
break;
}}if(p.length==length){p.push(n);
}if(!this.__Gd){qx.event.Idle.getInstance().addListener(c,this.__Gf,this);
this.__Gd=true;
}},__Gf:function(){var t=(new Date()).getTime();
var r=this.self(arguments).__Gb;
var s=this.self(arguments).__Gc;
...
this.__Ge(q.expireAt,v);
}else{delete s[v];
}}if(r.length==0&&this.__Gd){qx.event.Idle.getInstance().removeListener(c,this.__Gf,this);
this.__Gd=false;
}}}});
})();
