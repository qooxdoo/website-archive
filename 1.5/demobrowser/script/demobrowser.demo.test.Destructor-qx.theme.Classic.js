...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor-qx.theme.Classic.fb863f8d81e2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.Destructor";
...
(function(){var e="Window: ",d="__kr",c="interval",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__dc:null,__Ne:0,__kr:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__dc=[];
this.currentTest=this.testWindows;
this.__kr=new qx.event.Timer(1000);
this.__kr.addListener(c,this.runTest,this);
this.__kr.start();
},runTest:function(){this.__Ne++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Ne+" (Registry: "+g+")");
this.currentTest();
