...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Modern.9adaa0541f7b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(m,{extend:qx.application.Native,members:{__sF:null,__MB:1,__MC:0,__MD:0,__ME:0,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(B)){qx.log.appender.Native;
qx.log.appender.Console;
}var G=new qx.html.Element(k);
...
var I=new qx.html.Element(k,F);
G.add(I);
I.setAttribute(u,t);
return;
}var H=qx.util.ResourceManager.getInstance().toUri(q);
var E={"width":D,"height":s,"position":g,"left":h,"top":h,"background":c+H+i};
this.__sF=new qx.html.Element(k,E);
this.__sF.addListener(f,this.__rO,this);
this.__sF.addListener(x,this.__rN,this);
G.add(this.__sF);
},__rO:function(e){if(e.isMultiTouch()){this.__MD=e.getRotation()+this.__MC;
this.__ME=e.getScale()*this.__MB;
this.__sF.setStyle(y,o+this.__MD+a+this.__ME+i);
}else{var J=parseInt(e.getDocumentLeft())-(parseInt(this.__sF.getStyle(w))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__sF.getStyle(d))/2);
this.__sF.setStyles({"left":J+j,"top":top+j});
}},__rN:function(e){if(e.isMultiTouch()){this.__MC=this.__MD;
this.__MB=this.__ME;
}}}});
})();
