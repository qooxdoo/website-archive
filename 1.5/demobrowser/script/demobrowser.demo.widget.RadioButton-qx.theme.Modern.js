...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.RadioButton","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButton-qx.theme.Modern.51f349f58d1b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.widget.RadioButton";
...
(function(){var h="Yellow",g="Red",f="demobrowser.demo.widget.RadioButton",d="Green",c="changeSelection",b="Blue",a="What is your favorite color?";
...
i.add(n);
var m=new qx.ui.form.RadioButton(g);
var l=new qx.ui.form.RadioButton(d);
var p=new qx.ui.form.RadioButton(h);
var j=new qx.ui.form.RadioButton(b);
i.add(m);
i.add(l);
i.add(p);
i.add(j);
var o=new qx.ui.form.RadioGroup(m,l,p,j);
o.addListener(c,this._onChangeSelection,this);
},_onChangeSelection:function(e){var r=e.getData()[0];
var q=r.getLabel();
alert("Your favorite color is: "+q);
}}});
})();
