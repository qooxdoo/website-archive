...
var envinfo = {"qx.allowUrlSettings":true,"qx.application":"demobrowser.Application","qx.contrib":false,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"28155","qx.theme":"demobrowser.Theme","qx.version":"1.5"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"demobrowser":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.5"},"qxc.ui.logpane":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.82468e152e3f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}for(var bp in bo){if(bp.indexOf(o)!=-1){var br=bp.split(o);
...
(function(){var cc="visible",cb="excluded",ca="enabled",bY="execute",bX="current",bW="",bV="/",bU="value",bT="tags",bS="1.5",bC="category",bB="modelLink",bA="all",bz="interval",by="node",bx="horizontal",bw='execute',bv='value',bu="html",bt="noPlayground",cj="~",ck="widget",ch="http://demo.qooxdoo.org/",ci="separator-vertical",cf="request",cg="Demos",cd="^.*",ce="filled",cl="changeValue",cm="?qxenv:demobrowser.withTests:true",bL="__Lg",bK="__Lp",bN="demobrowser.DemoBrowser",bM="__Lm",bP="http://manual.qooxdoo.org/",bO="__Lo",bR="__Lu",bQ="_history",bJ="_leftComposite",bI="_status",a="Ctrl+N",b="completed",c="__pJ",d="failed",f="__Lq",g="_searchTextField",h="f1",n="Ctrl+O",o='changeSelection',p="_blank",cq="__Lb",cp="__Lr",co="logappender",cn="_runbutton",cu=".html",ct="_tree",cs="f2",cr="_demoView",cx="_stopbutton",cv="ig",S="Unable to access namespace. Maybe no demo loaded.",T='excluded',Q="_urlWindow",R='_cmdDisposeSample',W="qx.theme.Modern",X="toolbar",U="tree1",V="demo/welcome.html",O='_cmdSampleInOwnWindow',P=".*",B="right-top",A="background-splitpane",D='demo/',C="index.html",x="Filter...",w="__pF",z="/playground/",y='label',v="/apiviewer/",q="icon/16/actions/edit-find.png",bd="_",be="qooxdoo ",bf="right",bg="main",Y='_cmdObjectSummary',ba="Info",bb="js",bc="_prevButton",bh="file:",bi='_cmdNextSample',L="__Ll",K="left",J=".",I='_cmdPrevSample',H="Ctrl+Left",G='_cmdRunSample',F="F5",E="bottom-left",N=" ",M="runbutton",bj="_infosplit",bk="Ctrl+Right",bl="_navPart",bm="?qx.theme=",bn="textfield",bo="Ctrl+D",bp="mainsplit",bq="-",br="app-header",bs="Demo Browser",bG="_nextButton",bF="__Lf",bE="log",bD="_iframe",bH="__Ln";
qx.Class.define(bN,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);
this.__pF={};
...
this.__Lb=this.__LC();
this.add(this.__Lb);
var cF=new qx.ui.splitpane.Pane(bx);
this.mainsplit=cF;
var cC=new qx.ui.splitpane.Pane(bx);
cC.setDecorator(null);
this._infosplit=cC;
this.add(cF,{flex:1});
var cH=this._leftComposite=new qx.ui.container.Composite();
cH.setLayout(new qx.ui.layout.VBox(3));
cH.setBackgroundColor(A);
cF.add(cH,0);
var cA=new qx.ui.container.Composite();
cA.setLayout(new qx.ui.layout.HBox(3));
cA.setAppearance(bn);
cH.add(cA);
var cI=new qx.ui.basic.Image(q);
cA.add(cI);
this._searchTextField=new qx.ui.form.TextField();
this._searchTextField.setLiveUpdate(true);
this._searchTextField.setAppearance(ck);
this._searchTextField.setPlaceholder(x);
var cG=new qx.event.Timer(500);
cG.addListener(bz,function(cJ){this.filter(this._searchTextField.getValue());
cG.stop();
},this);
this._searchTextField.addListener(cl,function(cK){cG.restart();
},this);
cA.add(this._searchTextField,{flex:1});
this._status=new qx.ui.basic.Label(bW);
this._status.setAppearance(ck);
this._status.setWidth(80);
this._status.setTextAlign(bf);
cA.add(this._status);
cF.add(cC,1);
this._tree=this.__LG();
cH.add(this._tree,{flex:1});
this.__LH();
this._demoView=this.__LD();
{cC.add(this._demoView,2);
};
var cy=this.__Lc=this.__LE();
var cz=this.__Ld=this.__LF();
var cD=this.__Le=new qxc.ui.logpane.LogView();
var cE=this.__fD=new qx.ui.container.Stack;
cE.setDecorator(bg);
cE.add(cy);
cE.add(cz);
cE.add(cD);
...
this._history.addListener(cf,function(e){var cL=e.getData().replace(cj,bV);

if(this._currentSample!=cL){this.setCurrentSample(cL);
}},this);
this.__Lf=[this.__Ll,this.__Lm,this.__Lp];
{this.__Lf.push(this.__Lj);
this.__Lf.push(this.__Ln);
this.__Lf.push(this.__Lr);
};
this.__Lg=new qx.event.Timer(250);
this.__Lg.addListener(bz,this.__LJ,this);
this.__Lg.start();
this.__Lh=new demobrowser.InfoWindow(this.tr(ba));
this.__Lh.setAutoCenter(true);
},properties:{playDemos:{check:[bA,bC,bX],init:bX}},members:{_iframe:null,__La:null,__Lg:null,__Li:null,_tree:null,_status:null,_searchTextField:null,__Lj:null,__Lk:null,__Lf:null,_versionFilter:null,_navPart:null,__Ll:null,__Lm:null,__Ln:null,__Lo:null,__Lp:null,__Lq:null,__Lr:null,__Lb:null,_leftComposite:null,_infosplit:null,_demoView:null,__Ls:null,__pJ:null,__pF:null,__Lt:null,_urlWindow:null,__Lh:null,__fD:null,__Lc:null,__Ld:null,__Le:null,__Lu:null,defaultUrl:V,playgroundUrl:ch+bS+z,__Lv:function(){this._cmdObjectSummary=new qx.ui.core.Command(n);
this._cmdObjectSummary.addListener(bY,this.__Lx,this);
this._cmdRunSample=new qx.ui.core.Command(F);
this._cmdRunSample.addListener(bY,this.runSample,this);
this._cmdPrevSample=new qx.ui.core.Command(H);
this._cmdPrevSample.addListener(bY,this.playPrev,this);
this._cmdNextSample=new qx.ui.core.Command(bk);
this._cmdNextSample.addListener(bY,this.playNext,this);
this._cmdSampleInOwnWindow=new qx.ui.core.Command(a);
this._cmdSampleInOwnWindow.addListener(bY,this.__Ly,this);
this._cmdDisposeSample=new qx.ui.core.Command(bo);
this._cmdDisposeSample.addListener(bY,this.__LB,this);
},__Lw:function(e){var cO=e.getTarget()===this.__Lu?this.__Lt:this.__Lu;
var cN=e.getData()[0];

if(cO&&cN){cO.setModelSelection([cN.getModel()]);
}var cM=cN!=null?cN.getUserData(bU):bW;

switch(cM){case bu:this.__fD.setSelection([this.__Lc]);
this.__fD.show();
break;
case bb:this.__fD.setSelection([this.__Ld]);
this.__fD.show();
break;
case bE:this.__fD.setSelection([this.__Le]);
this.__fD.show();
break;
default:this.__fD.resetSelection();
this.__fD.exclude();
}},__Lx:function(){var cQ=this._iframe.getWindow();
var cP;

if(cQ&&cQ.qx){cP=cQ.qx.dev.ObjectSummary.getInfo();
}else{cP=S;
}var cR=new qx.ui.form.TextArea(cP);
cR.setDecorator(null);
cR.setAutoSize(true);
cR.setMaxHeight(qx.bom.Viewport.getHeight()-100);
this.__Lh.setContent(cR);
this.__Lh.setWidth(400);
this.__Lh.show();
},__Ly:function(){var cS=this._iframe.getSource();
window.open(cS,p);
},__Lz:function(cT){var cU=!!cT;
var cV=this._tree.getSelection()[0].getUserData(bT);

if(cV){cU=cU&&!qx.lang.Array.contains(cV,bt);
}this.__Lj.setEnabled(cU);
this.__Lk=cT;
},__LA:function(){if(this.__Lk){var cY=this.__Lk;
var cX='{"code": '+'"'+encodeURIComponent(cY)+'"}';
var cW=this.playgroundUrl+"#"+encodeURIComponent(cX);
window.open(cW,"_blank");
}else{var da=new qx.ui.basic.Label(this.tr("Could not open the Playground."));
this.__Lh.setContent(da);
this.__Lh.setWidth(200);
this.__Lh.show();
}},__uU:function(){window.open(ch+bS+v);
},__uV:function(){var db=(bS.split(bq)[0]);
window.open(bP+db);
},_onHideShowTests:function(event){var dd=window.location.search;
var de=window.location.hash;
var dc=C;

if(dd==bW){dc+=cm;
}dc+=de;
location.replace(dc);
},__LB:function(e){var dg=this._iframe.getWindow();
var df;

if(dg&&dg.qx){dg.qx.core.ObjectRegistry.shutdown();
df=this.tr("Demo has been disposed.");
}else{df=this.tr("Unable to access application.");
}var dh=new qx.ui.basic.Label(df);
dh.setRich(true);
dh.setWrap(true);
this.__Lh.setContent(dh);
this.__Lh.setWidth(350);
this.__Lh.show();
},__LC:function(){var dE=new qx.ui.toolbar.ToolBar();
this._navPart=new qx.ui.toolbar.Part();
dE.add(this._navPart);
...
this._stopbutton.addListenerOnce("appear",function(dM){var dN=this._stopbutton.getSizeHint();
this._stopbutton.setMinWidth(dN.width);
this._runbutton.setMinWidth(dN.width);
},this);
var dG=new qx.ui.toolbar.Part();
dE.add(dG);
var dr=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");
dr.addListener("execute",this.playPrev,this);
dr.setToolTipText("Run previous demo");
dG.add(dr);
this._prevButton=dr;
var dC=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");
dC.addListener("execute",this.playNext,this);
dC.setToolTipText("Run next demo");
dG.add(dC);
this._nextButton=dC;
var du={converter:function(dO){return dO=="visible";
}};
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dr,"enabled",du);
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dC,"enabled",du);
var dJ=this._navPart=new qx.ui.toolbar.Part();
dE.add(dJ);
var dK=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");
dK.addListener("execute",this.__Ly,this);
dK.setToolTipText("Open demo in new window");
this.__Ll=dK;
dJ.add(dK);
{var dz=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");
dz.addListener("execute",this.__LA,this);
dz.setToolTipText("Open demo in the playground");
dz.setEnabled(false);
if(qx.core.Environment.get("browser.name")=="ie"){dz.exclude();
}this.__Lj=dz;
dJ.add(dz);
var dl=new qx.ui.toolbar.Part();
dE.add(dl);
var dx=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");
dl.add(dx);
dx.setToolTipText(this.tr("Open the qooxdoo API Viewer"));
dx.addListener("execute",this.__uU,this);
var dj=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");
dl.add(dj);
dj.setToolTipText(this.tr("Open the qooxdoo Manual"));
dj.addListener("execute",this.__uV,this);
};
var dF=new qx.ui.toolbar.Part;
dE.add(dF);
{var dB=new qx.ui.menu.Menu;
this.__Lo=dB;
var ds=new qx.ui.menu.RadioButton("Modern Theme");
var dH=new qx.ui.menu.RadioButton("Classic Theme");
var dI=new qx.ui.menu.RadioButton("Simple Theme");
ds.setUserData("value","qx.theme.Modern");
ds.setValue(true);
dH.setUserData("value","qx.theme.Classic");
dI.setUserData("value","qx.theme.Simple");
var dv=new qx.ui.form.RadioGroup(ds,dH,dI);
dv.addListener("changeSelection",this.__LN,this);
dB.add(ds);
dB.add(dH);
dB.add(dI);
var dt=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dB);
this.__Ln=dt;
dt.setToolTipText("Choose theme");
dF.add(dt);
};
var dw=new qx.ui.menu.Menu;
{var dL=new qx.ui.menu.Button(this.tr("Object Summary"));
this.__Lr=dL;
dL.setCommand(this._cmdObjectSummary);
dw.add(dL);
};
var dp=new qx.ui.menu.Button(this.tr("Dispose Demo"));
this.__Lp=dp;
dp.setCommand(this._cmdDisposeSample);
dw.add(dp);
{dw.addSeparator();
var dm=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));
dm.setValue(!!qx.core.Environment.get("demobrowser.withTests"));
dm.addListener("changeValue",this._onHideShowTests,this);
dw.add(dm);
};
var dq=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",dw);
this.__Lq=dq;
dq.setToolTipText("Debugging options");
dF.add(dq);
var dy=new qx.ui.toolbar.Part;
this.__Lm=dy;
dE.addSpacer();
dE.add(dy);
{var dD=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");
dD.setToolTipText("Display HTML source");
dD.setModel('html');
var dn=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");
dn.setToolTipText("Display JavaScript source");
dn.setModel('js');
dD.setUserData("value","html");
dn.setUserData("value","js");
dy.add(dD);
dy.add(dn);
};
var dA=new qx.ui.toolbar.RadioButton("Log File","icon/22/apps/utilities-log-viewer.png");
dA.setToolTipText("Display log file");
dA.setUserData("value","log");
dA.setModel('log');
dy.add(dA);
var di=this.__Lu=new qx.ui.form.RadioGroup;
di.setAllowEmptySelection(true);
di.add(dA);
di.addListener('changeSelection',this.__Lw,this);
{di.add(dD,dn);
};
dE.setOverflowHandling(true);
var dk=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");
dk.setAppearance("toolbar-button");
dE.add(dk);
dE.setOverflowIndicator(dk);
dE.setRemovePriority(dy,6);
dE.setRemovePriority(dF,5);
dE.setRemovePriority(dl,4);
dE.setRemovePriority(dJ,3);
dE.setRemovePriority(dG,2);
dE.setRemovePriority(this._navPart,1);
this.__pJ=new qx.ui.menu.Menu();
dk.setMenu(this.__pJ);
dE.addListener("hideItem",this._onHideItem,this);
dE.addListener("showItem",this._onShowItem,this);
return dE;
},_onHideItem:function(e){var dP=e.getData();
var dQ=this._getMenuItems(dP);

for(var i=0,l=dQ.length;i<l;i++){dQ[i].setVisibility(cc);

if(dP===this.__Ln&&!(dQ[i] instanceof qx.ui.menu.Separator)){dQ[i].getMenu().setPosition(B);
}}},_onShowItem:function(e){var dR=e.getData();
var dT=this._getMenuItems(dR);

for(var i=0,l=dT.length;i<l;i++){dT[i].setVisibility(cb);
}
if(dR===this.__Ln){var dS=dR.getMenuButtons();

for(var i=0,l=dS.length;i<l;i++){dS[i].getMenu().setPosition(E);
}}},_getMenuItems:function(dU){var dW=[];

if(dU instanceof qx.ui.toolbar.Part){var ec=dU.getChildren();
var eb=null;
var dV=false;
var dX=this.__pJ.getChildren();

if(dU!=this.__Lm){eb=this.__pF[dU.toHashCode()];

if(!eb){eb=new qx.ui.menu.Separator();
this.__pJ.addBefore(eb,dX[0]);
this.__pF[dU.toHashCode()]=eb;
}dW.push(eb);
}else{dV=true;
}
for(var i=0,l=ec.length;i<l;i++){if(ec[i].getVisibility()==T){continue;
}var dY=this.__pF[ec[i].toHashCode()];

if(!dY){if(ec[i] instanceof qx.ui.toolbar.RadioButton){dY=new qx.ui.menu.RadioButton(ec[i].getLabel());
dY.setToolTipText(ec[i].getToolTipText());
dY.setEnabled(ec[i].getEnabled());
dY.setUserData(bv,ec[i].getUserData(bv));
dY.setModel(ec[i].getModel());
ec[i].bind(ca,dY,ca);
ec[i].bind(bU,dY,bU);
dY.bind(bU,ec[i],bU);

if(!this.__Lt){this.__Lt=new qx.ui.form.RadioGroup();
this.__Lt.setAllowEmptySelection(true);
this.__Lt.addListener(o,this.__Lw,this);
}this.__Lt.add(dY);
}else if(ec[i] instanceof qx.ui.toolbar.MenuButton){dY=new qx.ui.menu.Button(ec[i].getLabel().translate(),ec[i].getIcon(),ec[i].getCommand(),ec[i].getMenu());
dY.setToolTipText(ec[i].getToolTipText());
dY.setEnabled(ec[i].getEnabled());
ec[i].bind(ca,dY,ca);
}else if(ec[i] instanceof qx.ui.toolbar.Button){dY=new qx.ui.menu.Button(ec[i].getLabel().translate(),ec[i].getIcon());
dY.getChildControl(y,false).setRich(true);
dY.setTextColor(ec[i].getTextColor());
dY.setToolTipText(ec[i].getToolTipText());
dY.setEnabled(ec[i].getEnabled());
ec[i].bind(ca,dY,ca);
var ea=qx.event.Registration.getManager(ec[i]).getListeners(ec[i],bw);

if(ea&&ea.length>0){for(var j=0,k=ea.length;j<k;j++){dY.addListener(bw,qx.lang.Function.bind(ea[j].handler,ea[j].context));
}}}else if(ec[i] instanceof qx.ui.toolbar.CheckBox){dY=new qx.ui.menu.CheckBox(ec[i].getLabel());
dY.setToolTipText(ec[i].getToolTipText());
dY.setEnabled(ec[i].getEnabled());
ec[i].bind(ca,dY,ca);
}else{dY=new qx.ui.menu.Separator();
}
if(dV){this.__pJ.add(dY);
}else{this.__pJ.addBefore(dY,eb);
}this.__pF[ec[i].toHashCode()]=dY;
}dW.push(dY);
}}return dW;
},__LD:function(){var ed=new qx.ui.embed.Iframe().set({nativeContextMenu:true});
ed.addListener("load",this.__LI,this);
this._iframe=ed;
return ed;
},__LE:function(){var ee=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");
ee.setOverflow("auto","auto");
ee.setFont("monospace");
ee.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.html.page"]=ee;
ee.getContentElement().setAttribute("id","qx_srcview");
return ee;
},__LF:function(){var ef=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");
ef.setOverflow("auto","auto");
ef.setFont("monospace");
ef.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.js.page"]=ef;
ef.getContentElement().setAttribute("id","qx_srcview");
return ef;
},__LG:function(){var eh=new qx.ui.tree.Tree();
var eg=new qx.ui.tree.TreeFolder("Demos");
eh.setAppearance("demo-tree");
eh.setRoot(eg);
eh.setSelection([eg]);
this.tree=this.widgets["treeview.flat"]=eh;
eh.addListener("changeSelection",this.treeGetSelection,this);
eh.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);
},this);
return eh;
},__LH:function(){var ei=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");
ei.setLayout(new qx.ui.layout.VBox(10));
ei.setAllowMaximize(false);
ei.setAllowMinimize(false);
var el=new qx.ui.basic.Label("");
el.setSelectable(true);
el.setNativeContextMenu(true);
ei.add(el);
this._urlWindow=ei;
var em=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);
...
this.getApplicationRoot().add(ei);
var ej=new qx.ui.menu.Menu();
var ek=new qx.ui.menu.Button(this.tr("Get Demo Link"),"icon/22/mimetypes/text-html.png");
ek.addListener("execute",function(e){var eo=this.tree.getSelection()[0];
var eq=eo.getUserData("modelLink");
var en=this.tests.handler.getFullName(eq);
en=en.replace(".","~");
var ep=location.protocol+"//"+location.host+location.pathname+"#"+en;
this._urlWindow.getChildren()[0].setValue(ep);
this._urlWindow.open();
},this);
ej.add(ek);
this._tree.setContextMenu(ej);
},treeGetSelection:function(e){var er=this.tree.getSelection()[0];
var es=er.getUserData(bB);
this.tests.selected=this.tests.handler.getFullName(es);
},leftReloadTree:function(e){this._sampleToTreeNodeMap={};
var et=this._sampleToTreeNodeMap;
var eB=null;
var eE=null;
var eD;
{eD=/\?autorun=true/.test(location.href);
};
var eA=this._history.getState();
var ey=eA.match(/([^~]+)~/);

if(ey){eB=ey[1];
}else{var eu=eA.match(/([^~][\w]*)/);

if(eu){eB=eu[1];

if(eD){this.setPlayDemos(bC);
}}else{eB=cg;

if(eD){this.setPlayDemos(bA);
}}}function eC(eF,eG){var eK=eG.getChildren();
var t;

for(var i=0;i<eK.length;i++){var eH=eK[i];

if(eH.hasChildren()){t=new qx.ui.tree.TreeFolder(ew.polish(eH.label));
t.setUserData(ce,false);
t.setUserData(by,eH);
eC(t,t.getUserData(by));

if(eH.label==eB){eE=t;
t.setOpen(true);
}}else{if(!eH.type){continue;
}t=new qx.ui.tree.TreeFile(ew.polish(eH.label));
var eJ=eH.pwd().slice(1).join(bV)+bV+eH.label;

if(eH.tags){var j,m,eI;
t.setUserData(bT,eH.tags);
}et[eJ]=t;
}eF.add(t);
t.setUserData(bB,eH);
eH.widgetLinkFull=t;
}}var ez=this.tests.handler.ttree;
var ew=this;
this.tree.setUserData(bB,ez);
this.tree.getRoot().setOpen(true);
eC(this.tree.getRoot(),ez);

if(eE!=null){this.tree.setSelection([eE]);
}},runSample:function(e){if(e&&(e.getType()===bY||e.getType()===bz)){if(this.tests.selected===bW){this.setPlayDemos(bA);
}else if(this.tests.selected.indexOf(bu)>0){if(this.__Ls){this.__Ls.stop();
}this.setPlayDemos(bX);
}else{this.setPlayDemos(bC);
}}this._runbutton.setVisibility(cb);
this._stopbutton.setVisibility(cc);

if(this.tests.selected!=bW){var eL=this.tests.selected.replace(J,bV);
this.setCurrentSample(eL);
}else{this.playNext();
}},stopSample:function(e){this.setPlayDemos(bX);
this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
this._stopbutton.setVisibility(cb);
this._runbutton.setVisibility(cc);
},setCurrentSample:function(eM){if(!eM){return;
}
if(!this._sampleToTreeNodeMap){return;
}var eN;
var eP=this._sampleToTreeNodeMap[eM];

if(eP){eP.getTree().setSelection([eP]);
eN=D+eM;
{eN+=bm+this.__La;
};
var eO=eP.getUserData(bT);

if(eO){this.__Lj.setEnabled(!qx.lang.Array.contains(eO,bt));
}}else{eN=this.defaultUrl;
}
if(this._iframe.getSource()==eN){this._iframe.reload();
}else{this.__Li=false;
this._iframe.setSource(eN);
}if(eN==this.defaultUrl){this.disableMenuButtons();
}else{this.enableMenuButtons();
}this._currentSample=eM;
this._currentSampleUrl=eN;
},__LI:function(){var eT=this._iframe.getWindow();
var fa=this._iframe.getSource();

if(fa!=null&&fa!=this.defaultUrl){var eS;

try{eS=eT.location.href;
}catch(fc){eS=window.location.href;
var fb=eS.lastIndexOf("/");

if(fb!=-1){eS=eS.substring(0,fb+1);
}eS+=fa;
}var eX=eS.indexOf("/demo/")+6;
var eU=eS.indexOf("?");
eU=eU==-1?eS.length:eU;
var eV=eS.substring(eX,eU).split("/");
var eY=String.fromCharCode(187);

if(eV.length==2){var eQ=eV[0];
eQ=eQ.charAt(0).toUpperCase()+eQ.substring(1);
var eW=eV[1].replace(".html","").replace("_"," ");
eW=eW.charAt(0).toUpperCase()+eW.substring(1);
var eR="qooxdoo "+eY+" Demo Browser "+eY+" "+eQ+" "+eY+" "+eW;
}else{var eR="qooxdoo "+eY+" Demo Browser "+eY+" Start";
}document.title=eR;
}if(this.getPlayDemos()!="current"){if(!eW){this.playNext();
}else{var self=this;
this.__Ls=qx.event.Timer.once(this.playNext,self,5000);
this._nextButton.setEnabled(false);
this._prevButton.setEnabled(false);
}}else{this._stopbutton.setVisibility("excluded");
this._runbutton.setVisibility("visible");
}},__LJ:function(e){var fd=this._iframe.getWindow();

try{if(fd&&fd.qx&&fd.qx.log&&fd.qx.log.appender){if(!this.__Li){this.__Li=true;
this.debug("Demo loaded: "+this._currentSample);
this.__Le.clear();

try{this.__Le.fetch(fd.qx.log.Logger);
}catch(e){return ;
}this._history.addToHistory(this._currentSample.replace("/","~"),document.title);
if(this._currentSampleUrl!=this.defaultUrl){this.__LK(this._currentSampleUrl);
}}}else{this.__Li=false;
}}catch(fe){this.__Li=false;
}},filter:function(ff){var fn=new RegExp(cd+ff+P,cv);
var fl=this._tree.getRoot().getItems(true,true);
var fm=0;
var fg=0;

for(var i=0;i<fl.length;i++){var fo=fl[i];
var parent=fo.getParent();
var fk=fo.getUserData(bT);
var fh=false;

if(fk!=null){for(var j=0;j<fk.length;j++){fh=!!fk[j].match(fn);

if(fh){break;
}}}
if(fo.getChildren().length==0){fg++;
}
if((fh||(fo.getLabel().search(fn)!=-1)||(parent.getLabel().search(fn)!=-1))){if(fo.getChildren().length==0){fm++;
}fo.show();
fo.getParent().setOpen(true);
fo.getParent().show();
}else{fo.exclude();
}}if(ff==bW){var fj=this._tree.getRoot().getItems(false,true);
var fi=this._tree.getSelection();
for(var i=0;i<fj.length;i++){if(fj[i]==fi[0]||fj[i]==fi[0].getParent()){continue;
}fj[i].setOpen(false);
}}this._status.setValue(fm+bV+fg);
},__LK:function(fp){if(typeof (fp)!="string"){return;
}var fq=new qx.io.remote.Request(fp);
fq.setTimeout(180000);
fq.setProhibitCaching(false);
fq.addListener("completed",function(fr){var content=fr.getContent();
if(content){{var fu=content.indexOf("<script",content.indexOf("<script")+7);
var fA=content.indexOf("src",fu);
var ft=content.indexOf("\"",fA+5);
var fv=content.substring(fA+5,ft);
var fy=fv.substring(4,fv.length-3)+".src.js";
var u="script/demobrowser.demo";
var fx=fp.split('/');
var fw=fx[1];
var fz=fx[2];
fz=fz.substr(0,fz.indexOf('.html'));
u+="."+fw+"."+fz+".src.js";
fy=u;
var fs=new qx.io.remote.Request(fy);
fs.setTimeout(180000);
fs.setProhibitCaching(false);
fs.addListener("completed",function(fB){var fC=fB.getContent();
this.__Lz(fC);

if(fC){this.widgets["outputviews.sourcepage.js.page"].setHtml(this.__LL(fC,"javascript"));
}},this);
fs.addListener("failed",function(fD){this.error("Couldn't load file: "+fp);
},this);
fs.send();
this.widgets["outputviews.sourcepage.html.page"].setHtml(this.__LL(content));
};
}},this);
fq.addListener("failed",function(fE){this.error("Couldn't load file: "+fp);
},this);
fq.send();
},dataLoader:function(fF){var fG=new qx.io.remote.Request(fF);
fG.setTimeout(180000);
fG.setProhibitCaching(false);
fG.addListener(b,function(fH){var content=fH.getContent();
if(!content){if(window.location.protocol==bh){alert("Failed to load demo data from the file system.\n\n"+"The security settings of your browser may prohibit AJAX "+"when using the file protocol. Please try the http protocol "+"instead.");
}return;
}var fI=eval(content);
qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(fI);
this.leftReloadTree();
var fJ=this._history.getState();

if(fJ){this.setCurrentSample(fJ.replace(cj,bV));
}else{this.setCurrentSample(this.defaultUrl);
}},this,0);
},this);
fG.addListener(d,function(fK){this.error("Couldn't load file: "+fF);
},this);
fG.send();
},playPrev:function(e){this.setPlayDemos(bX);
var fO=this.tree.getSelection()[0];

if(fO){var fL=this.tree.getPreviousNodeOf(fO,false);

if(!fL||fL==this.tree.getRoot()){return;
}
while(fL.isVisible&&!fL.isVisible()){fL=this.tree.getPreviousNodeOf(fL,false);
}
if(fL.getParent()==this.tree.getRoot()){var fN=this.tree.getPreviousNodeOf(fL,false);

while(fN.isVisible&&!fN.isVisible()){fN=this.tree.getPreviousNodeOf(fN,false);
}
if(fN.getParent()==this.tree.getRoot()){fN.setOpen(true);
var fM=this.tree.getPreviousNodeOf(fL,false);
...
if(!fL||fL===fO){this._stopbutton.setVisibility(cb);
this._runbutton.setVisibility(cc);
return;
}else{this.tree.setSelection([fL]);
this.runSample();
}}},playNext:function(e){this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
var fR=this.tree.getSelection()[0];

if(fR){var fP=this.tree.getNextNodeOf(fR);

if(!fP){this.setPlayDemos(bX);
this._stopbutton.setVisibility(cb);
this._runbutton.setVisibility(cc);
return;
}
if(fP.getParent()==this.tree.getRoot()){if(this.getPlayDemos()==bC){if(fP!=fR&&fP!=fR.getParent()){this.setPlayDemos(bX);
this._stopbutton.setVisibility(cb);
this._runbutton.setVisibility(cc);
return;
}}fP.setOpen(true);
fP=this.tree.getNextNodeOf(fP);
}
if(!fP){this._stopbutton.setVisibility(cb);
this._runbutton.setVisibility(cc);
return;
}
while(!fP.isVisible()){var fQ=this.tree.getNextNodeOf(fP);

if(!fQ){this._stopbutton.setVisibility(cb);
this._runbutton.setVisibility(cc);
return;
}
if(fQ.getParent()==this.tree.getRoot()){fP.setOpen(true);
var fQ=this.tree.getNextNodeOf(fQ);
}fP=fQ;
}
if(fP){this.tree.setSelection([fP]);
this.runSample();
}else{this._stopbutton.setVisibility(cb);
this._runbutton.setVisibility(cc);
}}},__LL:function(fS,fT){var fU=new qx.util.StringBuilder("<pre class='script'>");
var fW=[];
var fX=new qx.util.StringBuilder();
var fY=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;
var fV=/^\s*<\/script>\s*$/i;
fS=fS.replace(/\r\n/g,"\n").replace(/\r/g,"\n");
var fW=fS.split('\n');
if(fT=="javascript"){return "<pre ><div class='script'>"+qx.dev.Tokenizer.javaScriptToHtml(fS)+"</div></pre>";
}
for(var i=0;i<fW.length;i++){if(fY.exec(fW[i])){fU.add(this.__LM(qx.bom.String.escape(fX.get()+fW[i])));
fX.clear();
}else if(fV.exec(fW[i])){var ga=qx.dev.Tokenizer.javaScriptToHtml(fX.get());
fU.add('<div class="script">',ga,'</div>');
fX.clear();
fX.add(fW[i],'\n');
}else{fX.add(fW[i],'\n');
}}fU.add(this.__LM(qx.bom.String.escape(fX.get())),"</pre>");
return fU.get();
},disableMenuButtons:function(){var gb=this.__Lf;

for(var i=0;i<gb.length;i++){gb[i].setEnabled(false);
}},enableMenuButtons:function(){var gc=this.__Lf;

for(var i=0;i<gc.length;i++){gc[i].setEnabled(true);
}},__LM:function(gd){var gf=gd;
function ge(gg){var s=new qx.util.StringBuilder(arguments[1],'<span class="html-tag-name">',arguments[2],'</span>');
var gh;
var gi=false;
if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){gh=arguments[i];
...
while((r=m.exec(gh))!=null){s.add(' <span class="keyword">',r[1],'</span>=<span class="string">',r[2].replace(/\s*$/,""),'</span>');
}}}s.add((gi?"/":""));
}s.add('&gt;');
return s.get();
}gf=gf.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,ge);
return gf;
},polish:function(gj){return gj.replace(cu,bW).replace(bd,N);
},__LN:function(e){this.__La=e.getData()[0].getUserData("value");
this.runSample();
},_createHeader:function(){var gm=new qx.ui.layout.HBox();
var gk=new qx.ui.container.Composite(gm);
gk.setAppearance(br);
var gn=new qx.ui.basic.Label(bs);
var gl=new qx.ui.basic.Label(be+bS);
gk.add(gn);
gk.add(new qx.ui.core.Spacer,{flex:1});
gk.add(gl);
return gk;
}},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;
this._disposeObjects(bp,U,K,M,X,h,cs,bQ,co,Y,G,I,bi,O,R,bK,f,bl,cn,cx,L,bH,bO,bM,bR,cq,bj,g,bI,ct,bD,cr,bF,cp,bL,bJ,Q,bG,bc,w,c);
}});
})();
...
this.__ug=new qx.ui.toolbar.ToolBar();
this.__ug.add(L);
this.__ug.addSpacer();
...
this.add(M,{flex:1});
this.__wj=new qx.log.appender.Element();
qx.log.Logger.unregister(this.__wj);
this.__wk=document.createElement(C);
this.__wj.setElement(this.__wk);
M.addListenerOnce(r,function(){M.getContentElement().getDomElement().appendChild(this.__wk);
},this);
},properties:{showLogLevel:{check:a,apply:b,init:false},logLevel:{check:[m,g,k,h],init:m,event:p}},members:{__wk:null,__wj:null,__wi:null,__wl:null,__ug:null,clear:function(){this.__wj.clear();
},fetch:function(O){if(!O){O=qx.log.Logger;
}O.register(this.__wj);
O.clear();
},getAppenderElement:function(){return this.__wk;
},_applyShowLogLevel:function(P,Q){if(!this.__wl){this.__wl=this.__wm();
this.__ug.add(this.__wl);
}
if(P){this.__wl.show();
}else{this.__wl.exclude();
}},__wm:function(){var R=new qx.ui.menu.Menu();
var U=new qx.ui.toolbar.MenuButton(t,d);
U.setMenu(R);

for(var i=0,l=this.__wi.length;i<l;i++){var T=this.__wi[i];
...
qx.log.Logger.register(this);
},members:{__iI:null,setElement:function(t){this.clear();
if(t){qx.bom.element.Class.add(t,j);
}this.__iI=t;
},clear:function(){var u=this.__iI;
if(u){u.innerHTML=q;
}},process:function(v){var w=this.__iI;
...
}},properties:{title:{check:k,event:g,nullable:true,apply:c},state:{check:k,event:d,nullable:true,apply:e}},members:{__wo:null,_applyState:function(n,o){this._writeState(n);
...
if(this.__wo[u]!=null){this.setTitle(this.__wo[u]);
...
this.__wq();
},members:{__wp:null,__wq:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__wp=qx.lang.Function.bind(this.__ua,this);
qx.bom.Event.addNativeListener(window,d,this.__wp);
}else{qx.event.Idle.getInstance().addListener(c,this.__ua,this);
}},__wr:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,d,this.__wp);
}else{qx.event.Idle.getInstance().removeListener(c,this.__ua,this);
}},__ua:function(){var e=this._readState();
...
this.__wv();
},members:{__ws:null,__wt:false,__wu:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);
this.__wu=this._getHash();
},_setHash:function(o){qx.bom.History.prototype._setHash.call(this,o);
this.__wu=this._encode(o);
},_readState:function(){if(!this.__wt){return this._decode(this._getHash());
}var p=this.__ws.contentWindow.document;
...
try{var s=this.__ws.contentWindow.document;
s.open();
s.write(f+r+d);
s.close();
}catch(t){}},__wv:function(){this.__wy(function(){qx.event.Idle.getInstance().addListener(n,this.__ua,this);
});
},__ua:function(e){var v=null;
var u=this._getHash();

if(!this.__wx(u)){v=this.__ww(u);
}else{v=this._readState();
}
if(qx.lang.Type.isString(v)&&v!=this.getState()){this._onHistoryLoad(v);
}},__ww:function(w){w=this._decode(w);
this._writeState(w);
return w;
},__wx:function(x){return qx.lang.Type.isString(x)&&x==this.__wu;
},__wy:function(y){this.__ws=this.__wz();
document.body.appendChild(this.__ws);
this.__wA(function(){this._writeState(this.getState());

if(y){y.call(this);
}},this);
},__wz:function(){var z=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(h)});
z.style.visibility=a;
z.style.position=b;
z.style.left=m;
z.style.top=m;
return z;
},__wA:function(A,B,C){if(typeof C===c){C=0;
}
if(!this.__ws.contentWindow||!this.__ws.contentWindow.document){if(C>20){throw new Error("can't initialize iframe");
}qx.event.Timer.once(function(){this.__wA(A,B,++C);
},this,10);
return;
}this.__wt=true;
A.call(B||window);
}},destruct:function(){this.__ws=null;
qx.event.Idle.getInstance().addListener(n,this.__ua,this);
}});
}})();
...
this.addListener(g,this.__LO,this);
},properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__KC:null,_getContentContainer:function(){if(!this.__KC){this.__KC=new qx.ui.container.Composite(new qx.ui.layout.VBox());
this.__KC.setMinHeight(20);
}return this.__KC;
...
y=y>=0?y:0;
this.moveTo(x,y);
},__LO:function(){if(this.getAutoCenter()){this.center();
}}}});
})();
...
this.tmap=p;
this.ttree=this.__LP(p);
},members:{__LP:function(q){var s=q;
