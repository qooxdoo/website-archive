...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.HeightForWidth","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.HeightForWidth-qx.theme.Simple.432d326609c7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.ui.HeightForWidth",a="engine.version";
...
(function(){var e="main",d="Screenshots #1 and #2 show that the label can be reduced in size to 102 pixels horizontally or to 55 pixels vertically, so long as there is enough space in the other direction. Screenshot #3 shows what happens when the label is squeezed down to its minimum height and minimum width.",c="We would like QLabel to tell the layout that screenshot #1 and screenshot #2 are acceptable but that screenshot #3 is not. The sizeHint() and minimumSizeHint() functions cannot do this, so Qt provides a complementary mechanism: height-for-width.",b="demobrowser.demo.ui.HeightForWidth",a="Every widget's QSizePolicy contains a boolean height-for-width flag that indicates whether or not the widget is able to trade width for height and height for width. The layout will call the virtual function QWidget::heightForWidth() as necessary to determine the desired height for a height-for-width widget with a given width.";
...
f.setSpacing(20);
var i=new qx.ui.container.Composite(f).set({decorator:e,width:300});
this.getRoot().add(i,{left:20,top:20});
var j=new qx.ui.basic.Label().set({decorator:e,rich:true,value:d});
i.add(j);
var g=new qx.ui.basic.Label().set({decorator:e,rich:true,value:c});
i.add(g);
var h=new qx.ui.basic.Label().set({decorator:e,rich:true,value:a});
i.add(h);
}}});
})();
