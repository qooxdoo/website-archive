...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.MenuBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.MenuBar-qx.theme.Modern.6bfe3694fb39.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="demobrowser.demo.widget.MenuBar",a="engine.version";
...
(function(){var bE="execute",bD="changeValue",bC="icon/16/actions/system-search.png",bB="Online Forum",bA="New",bz="icon/16/actions/edit-cut.png",by="icon/16/actions/format-justify-fill.png",bx="Search in files",bw="C",bv="Left aligned",bk="Undo",bj="_openCommand",bi="Uppercase",bh="View",bg="C Dialect",bf="changeSelection",be="enabled",bd="Save as...",bc="Show line numbers",bb="Search previous...",bL="Quickstart",bM="Cut",bJ="Ctrl+N",bK="icon/16/actions/edit-paste.png",bH="Show console",bI="Search",bF="Help",bG="_redoCommand",bN="Redo",bO="Show status bar",bo="icon/16/actions/format-justify-left.png",bn="ANSI to OEM",bq="Centered",bp="Paragraph",bs="Edit",br="Ctrl+O",bu="icon/16/actions/document-print.png",bt="icon/16/actions/document-open.png",bm="C Sharp",bl="icon/16/actions/edit-undo.png",a="Close",b="icon/16/actions/document-save-as.png",c="Python",d="icon/16/apps/utilities-help.png",f="Show tree",g="Spaces to tabs",h="Right aligned",i="OEM to ANSI",j="JavaScript",k="demobrowser.demo.widget.MenuBar",bS="_copyCommand",bR="XML",bQ="Save",bP="_undoCommand",bW="Capitals",bV="icon/16/actions/application-exit.png",bU="C Plus Plus",bT="_saveCommand",bY="Lowercase",bX="Search next...",J="_newCommand",K="Replace in files",H="Perl",I="Ctrl+P",N="Topics",O="Panes",L="Justified",M="Ctrl+X",F="Show macros",G="Show ruler",s="Enabled",r="Copy",u="Paste",t="_pasteCommand",o="icon/16/actions/format-justify-right.png",n="Ctrl+Z",q="Ctrl+R",p="icon/16/actions/edit-redo.png",m="Show tags",l="Info...",T="Format",U="File",V="Show tabs",W="value",P="Print",Q="icon/16/actions/document-save.png",R="icon/16/actions/edit-copy.png",S="Search...",X="icon/16/actions/format-justify-center.png",Y="Open",C="_cutCommand",B="Objective C",A="Exit",z="Ctrl+S",y="Syntax",x="Ctrl+C",w="icon/16/actions/document-new.png",v="Tabs to spaces",E="ASCII table",D="Replace",ba="HTML";
...
var cd=new qx.ui.container.Scroll();
var cc=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cc.setPadding(20);
cc.setAllowStretchX(false);
cd.add(cc);
this.getRoot().add(cd,{edge:0});
this.createCommands();
var ca=this.getMenuBar();
cc.add(ca,{left:20,top:50});
var cb=new qx.ui.form.ToggleButton(s);
cb.setValue(true);
cc.add(cb,{left:20,top:10});
cb.bind(W,ca,be);
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(bJ);
this._newCommand.addListener(bE,this.debugCommand);
this._openCommand=new qx.ui.core.Command(br);
this._openCommand.addListener(bE,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(z);
this._saveCommand.addListener(bE,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(n);
this._undoCommand.addListener(bE,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(q);
this._redoCommand.addListener(bE,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(M);
this._cutCommand.addListener(bE,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(x);
this._copyCommand.addListener(bE,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(I);
this._pasteCommand.addListener(bE,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuBar:function(){var cg=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
cg.add(menubar);
var cf=new qx.ui.menubar.Button(U,null,this.getFileMenu());
var ce=new qx.ui.menubar.Button(bs,null,this.getEditMenu());
var ch=new qx.ui.menubar.Button(bI,null,this.getSearchMenu());
var ck=new qx.ui.menubar.Button(bh,null,this.getViewMenu());
var cj=new qx.ui.menubar.Button(T,null,this.getFormatMenu());
var ci=new qx.ui.menubar.Button(bF,null,this.getHelpMenu());
menubar.add(cf);
menubar.add(ce);
menubar.add(ch);
menubar.add(ck);
...
menubar.add(ci);
return cg;
},getFileMenu:function(){var cn=new qx.ui.menu.Menu;
var cl=new qx.ui.menu.Button(bA,w,this._newCommand);
var cp=new qx.ui.menu.Button(Y,bt,this._openCommand);
var co=new qx.ui.menu.Button(a);
var cs=new qx.ui.menu.Button(bQ,Q,this._saveCommand);
var cr=new qx.ui.menu.Button(bd,b);
var cq=new qx.ui.menu.Button(P,bu);
var cm=new qx.ui.menu.Button(A,bV);
cl.addListener(bE,this.debugButton);
cp.addListener(bE,this.debugButton);
co.addListener(bE,this.debugButton);
cs.addListener(bE,this.debugButton);
cr.addListener(bE,this.debugButton);
cq.addListener(bE,this.debugButton);
cm.addListener(bE,this.debugButton);
cn.add(cl);
cn.add(cp);
cn.add(co);
cn.add(cs);
...
cn.add(cm);
return cn;
},getEditMenu:function(){var cu=new qx.ui.menu.Menu;
var cx=new qx.ui.menu.Button(bk,bl,this._undoCommand);
var cw=new qx.ui.menu.Button(bN,p,this._redoCommand);
var ct=new qx.ui.menu.Button(bM,bz,this._cutCommand);
var cy=new qx.ui.menu.Button(r,R,this._copyCommand);
var cv=new qx.ui.menu.Button(u,bK,this._pasteCommand);
cx.addListener(bE,this.debugButton);
cw.addListener(bE,this.debugButton);
ct.addListener(bE,this.debugButton);
cy.addListener(bE,this.debugButton);
cv.addListener(bE,this.debugButton);
cu.add(cx);
cu.add(cw);
cu.addSeparator();
cu.add(ct);
...
var cA=new qx.ui.menu.Button(S,bC);
var cF=new qx.ui.menu.Button(bX);
var cB=new qx.ui.menu.Button(bb);
var cE=new qx.ui.menu.Button(D);
var cz=new qx.ui.menu.Button(bx,bC);
var cD=new qx.ui.menu.Button(K);
cB.setEnabled(false);
cA.addListener(bE,this.debugButton);
cF.addListener(bE,this.debugButton);
cB.addListener(bE,this.debugButton);
cE.addListener(bE,this.debugButton);
cz.addListener(bE,this.debugButton);
cD.addListener(bE,this.debugButton);
cC.add(cA);
cC.add(cF);
cC.add(cB);
cC.add(cE);
...
cC.add(cD);
return cC;
},getViewMenu:function(){var cG=new qx.ui.menu.Menu;
var cI=new qx.ui.menu.Button(O,null,null,this.getPanesMenu());
var cL=new qx.ui.menu.Button(y,null,null,this.getSyntaxMenu());
var cK=new qx.ui.menu.CheckBox(G);
var cJ=new qx.ui.menu.CheckBox(bc);
var cH=new qx.ui.menu.Button(E);
cK.addListener(bD,this.debugCheckBox);
cJ.addListener(bD,this.debugCheckBox);
cH.addListener(bE,this.debugButton);
cG.add(cI);
cG.add(cL);
cG.addSeparator();
cG.add(cK);
...
cG.add(cH);
return cG;
},getPanesMenu:function(){var cN=new qx.ui.menu.Menu;
var cP=new qx.ui.menu.CheckBox(V);
var cR=new qx.ui.menu.CheckBox(bO);
var cS=new qx.ui.menu.CheckBox(f);
var cO=new qx.ui.menu.CheckBox(F);
var cQ=new qx.ui.menu.CheckBox(m);
var cM=new qx.ui.menu.CheckBox(bH);
cP.setValue(true);
cR.setValue(true);
cO.setValue(true);
cP.addListener(bD,this.debugCheckBox);
cR.addListener(bD,this.debugCheckBox);
cS.addListener(bD,this.debugCheckBox);
cO.addListener(bD,this.debugCheckBox);
cQ.addListener(bD,this.debugCheckBox);
cM.addListener(bD,this.debugCheckBox);
cN.add(cR);
cN.add(cP);
cN.addSeparator();
cN.add(cS);
...
cN.add(cM);
return cN;
},getSyntaxMenu:function(){var cX=new qx.ui.menu.Menu;
var cT=new qx.ui.menu.RadioButton(ba);
var cV=new qx.ui.menu.RadioButton(bR);
var cU=new qx.ui.menu.RadioButton(j);
var cW=new qx.ui.menu.Button(bg,null,null,this.getSyntaxCMenu());
var db=new qx.ui.menu.RadioButton(H);
var cY=new qx.ui.menu.RadioButton(c);
cX.add(cT);
cX.add(cV);
cX.add(cU);
cX.add(cW);
...
da.add(cT,cV,cU,db,cY);
da.add.apply(da,cW.getMenu().getChildren());
da.addListener(bf,this.debugRadio);
return cX;
},getSyntaxCMenu:function(){var dd=new qx.ui.menu.Menu;
var dc=new qx.ui.menu.RadioButton(bw);
var dg=new qx.ui.menu.RadioButton(bm);
var df=new qx.ui.menu.RadioButton(B);
var de=new qx.ui.menu.RadioButton(bU);
dd.add(dc);
dd.add(dg);
dd.add(df);
dd.add(de);
return dd;
},getFormatMenu:function(){var dk=new qx.ui.menu.Menu;
var dj=new qx.ui.menu.Button(bp,null,null,this.getParagraphMenu());
var dm=new qx.ui.menu.Button(v);
var dn=new qx.ui.menu.Button(g);
var di=new qx.ui.menu.Button(bi);
var dl=new qx.ui.menu.Button(bY);
var dh=new qx.ui.menu.Button(bW);
var dq=new qx.ui.menu.Button(i);
var dp=new qx.ui.menu.Button(bn);
dm.addListener(bE,this.debugButton);
dn.addListener(bE,this.debugButton);
di.addListener(bE,this.debugButton);
dl.addListener(bE,this.debugButton);
dh.addListener(bE,this.debugButton);
dq.addListener(bE,this.debugButton);
dp.addListener(bE,this.debugButton);
dk.add(dj);
dk.add(dm);
dk.add(dn);
dk.addSeparator();
...
dk.add(dp);
return dk;
},getParagraphMenu:function(){var dr=new qx.ui.menu.Menu;
var du=new qx.ui.menu.Button(bv,bo);
var dv=new qx.ui.menu.Button(h,o);
var ds=new qx.ui.menu.Button(bq,X);
var dt=new qx.ui.menu.Button(L,by);
du.addListener(bE,this.debugButton);
dv.addListener(bE,this.debugButton);
ds.addListener(bE,this.debugButton);
dt.addListener(bE,this.debugButton);
dr.add(du);
dr.add(dv);
dr.add(ds);
dr.add(dt);
return dr;
},getHelpMenu:function(){var dw=new qx.ui.menu.Menu;
var dy=new qx.ui.menu.Button(N,d);
var dA=new qx.ui.menu.Button(bL);
var dz=new qx.ui.menu.Button(bB);
var dx=new qx.ui.menu.Button(l);
dy.addListener(bE,this.debugButton);
dA.addListener(bE,this.debugButton);
dz.addListener(bE,this.debugButton);
dx.addListener(bE,this.debugButton);
dw.add(dy);
dw.add(dA);
dw.addSeparator();
dw.add(dz);
...
dw.add(dx);
return dw;
}},destruct:function(){this._disposeObjects(J,bj,bT,bP,bG,C,bS,t);
}});
})();
