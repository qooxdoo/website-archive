...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Simple.b889ea9df51d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="left",j="div",i="20px",h="absolute",g="px",f="100%",d="innerHTML",c="touchmove",b="black",a="200px",I="30px",H="100px",G="1px solid white",F="top",E="right",D="50%",C="none",B="white",A="border-left",z="green",r="demobrowser.demo.mobile.PingPong",s="qx.debug",p="interval",q="0px",n="12px",o="event.touch",l='Lucida Grande',m="qx.mobile.emulatetouch",t="engine.name",u="webkit",w="border-right",v="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(r,{extend:qx.application.Native,members:{__Mk:null,__Ml:null,__Mm:null,__Mn:null,__Mo:5,__Mp:1,__Mq:1,__Mr:null,__Ms:null,__Mt:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(s)){qx.log.appender.Native;
qx.log.appender.Console;
}var L={"width":f,"height":f,"backgroundColor":b,"margin":q,"userSelect":C};
var O=new qx.html.Element(j,L);
O.useElement(document.body);
O.setRoot(true);

if(qx.core.Environment.get(t)!=u||(!qx.core.Environment.get(o)&&qx.core.Environment.get(m)==false)){var N={"color":z,"font-family":l,"font-size":n,"position":h,"left":I,"top":i};
var M=new qx.html.Element(j,N);
O.add(M);
M.setAttribute(d,v);
return;
}var J=this.__Mx(k);
...
var K=this.__Mx(E);
O.add(K);
this.__Ml=this.__My(k);
J.add(this.__Ml);
J.addListener(c,qx.lang.Function.bind(this.__rO,this,this.__Ml),this);
this.__Mk=this.__My(E);
K.add(this.__Mk);
K.addListener(c,qx.lang.Function.bind(this.__rO,this,this.__Mk),this);
this.__Mm=this.__Mz();
O.add(this.__Mm);
this.__Ms=this.__MA();
J.add(this.__Ms);
...
this.__Mr=[0,0];
this.__Mu();
},__Mu:function(){this.__Mm.setStyles({"left":a,"top":a});
this.__Mn=new qx.event.Timer(40);
this.__Mn.addListener(p,function(){var x=(parseInt(this.__Mm.getStyle(k))+this.__Mo*this.__Mp);
var y=(parseInt(this.__Mm.getStyle(F))+this.__Mo*this.__Mq);
this.__Mm.setStyle(k,x+g);
this.__Mm.setStyle(F,y+g);
this.__Mw();
},this);
this.__Mn.start();
},__Mv:function(P){this.__Mn.stop();
this.__Mn.dispose();
this.__Mo=5;
this.__Mr[P]=this.__Mr[P]+1;
this.__Ms.setAttribute(d,this.__Mr[0]);
this.__Mt.setAttribute(d,this.__Mr[1]);
this.__Mu();
},__Mw:function(){var R=this.getBoundsFor(this.__Mm);
if(R.top<=0){this.__Mq=1;
}if(R.bottom>=window.innerHeight-5){this.__Mq=-1;
}if(R.left<=0||R.right>=window.innerWidth){this.__Mv(R.left<=0?1:0);
}var S=this.getBoundsFor(this.__Ml);

if(R.left<=S.right&&R.bottom>=S.top&&R.top<=S.bottom){this.__Mp=1;
this.__Mo=Math.min(this.__Mo+1,20);
}var Q=this.getBoundsFor(this.__Mk);

if(R.right>=Q.left&&R.bottom>=Q.top&&R.top<=Q.bottom){this.__Mp=-1;
this.__Mo=Math.min(this.__Mo+1,20);
}},__rO:function(T,e){T.setStyles({"top":(e.getDocumentTop()-50)+g});
},getBoundsFor:function(U){return qx.bom.element.Location.get(U.getDomElement());
},__Mx:function(V){var W={"width":D,"height":f,"position":h,"backgroundColor":b};

if(V==k){W[w]=G;
}else{W[k]=D;
W[A]=G;
}return new qx.html.Element(j,W);
},__My:function(X){var Y={"width":I,"height":H,"top":H,"position":h,"backgroundColor":B};
Y[X]=i;
return new qx.html.Element(j,Y);
},__Mz:function(){var ba={"width":i,"height":i,"position":h,"backgroundColor":B,"userSelect":C};
return new qx.html.Element(j,ba);
},__MA:function(){var bb={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};
var bc=new qx.html.Element("div",bb);
bc.setAttribute("innerHTML","0");
return bc;
}}});
})();
