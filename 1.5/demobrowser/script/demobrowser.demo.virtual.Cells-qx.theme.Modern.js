...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Cells","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Modern.cc52a6ff1ad6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.util.Permutation.permute(H,function(I){var J=this.__Hl(G,I.value,I.states);
...
}var N=this.__Hl(L,M.value,M.states);
...
qx.util.Permutation.permute(W,function(Y){var ba=this.__Hl(X,Y.value,Y.states);
...
qx.util.Permutation.permute(bb,function(bd){var be=this.__Hl(bc,bd.value,bd.states);
...
bg.setIconFalse(n);
bg.setIconTrue(l);
qx.util.Permutation.permute(bf,function(bh){var bi=this.__Hl(bg,bh.value,bh.states);
this.container.add(bi);
},this);
},__Hl:function(bj,bk,bl){var bp=100;
var bn=30;
