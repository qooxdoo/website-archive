...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.List","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List-qx.theme.Classic.36218b631534.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.virtual.List",b="os.name",a="engine.version";
...
qx.Class.define(v,{extend:qx.application.Standalone,properties:{showMode:{init:m,check:[p,n,m],event:bf}},members:{__NF:null,__NG:null,__NH:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bJ=this.getRoot();
...
var bR=this.__NF=new qx.ui.list.List(ca).set({scrollbarX:"on",selectionMode:"multi",height:280,width:150,labelPath:"label",iconPath:"icon",iconOptions:{converter:function(ce){return "icon/"+ce+"/places/folder.png";
}}});
bM.add(bR,{top:20});
var bQ=this;
...
var bT=this.__NG=new qx.ui.form.CheckBox("Enable drag selection");
var bX=this.__NH=new qx.ui.form.CheckBox("Enable quick selection").set({enabled:false});
...
this.__NF.setSelectionMode(cx);

if(cx==k||cx==o){this.__NG.setEnabled(false);
this.__NH.setEnabled(true);
}else if(cx==l||cx==N){this.__NG.setEnabled(true);
this.__NH.setEnabled(false);
}},onShowModeChange:function(e){var cy=e.getData()[0].getUserData(q);
this.setShowMode(cy);
},onDragCheckChange:function(e){if(e.getData()){var cz=this.__NF.getSelectionMode();

if(cz==k||cz==o){this.debug("Drag selection is only available for the modes multi or additive");
}}this.__NF.setDragSelection(e.getData());
},onQuickCheckChange:function(e){if(e.getData()){var cA=this.__NF.getSelectionMode();

if(cA==l||cA==j){this.debug("Quick selection is only available for the modes multi or additive");
}}this.__NF.setQuickSelection(e.getData());
}}});
})();
