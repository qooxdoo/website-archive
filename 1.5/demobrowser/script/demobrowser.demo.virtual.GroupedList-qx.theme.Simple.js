...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.GroupedList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Simple.a225541181b7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(h,{extend:qx.application.Standalone,members:{__oD:null,__KU:null,__NE:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
M.bind(l,this.__oD,j);
M.bind(l,this.__KU,j);
M.bind(l,this.__NE,j);
...
O.add(P);
var N=this.__oD=new qx.ui.list.List().set({height:280,width:150,labelPath:g,labelOptions:{converter:function(Q,R){return R?Q+m+R.getLastname():o;
}}});
O.add(N,{top:20});
return O;
...
T.add(V);
var S=this.__KU=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(W,X){return X?X.getLastname()+", "+W:"no model...";
}}});
T.add(S,{top:20});
...
S.setDelegate(U);
S.setSelection(this.__oD.getSelection());
return T;
...
bb.add(bd);
var ba=this.__NE=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(be,bf){return bf?be+" "+bf.getLastname():"no model...";
}}});
bb.add(ba,{top:20});
...
ba.setDelegate(bc);
ba.setSelection(this.__oD.getSelection());
return bb;
}},destruct:function(){this.__oD.dispose();
this.__KU.dispose();
this.__NE.dispose();
this.__oD=this.__KU=this.__NE=null;
}});
})();
