...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree_Columns","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns-qx.theme.Modern.4de4b2103201.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},_getDataFromRow:function(bd){return this.__nD.getItem(bd);
...
},getLevel:function(bf){return this.__Ca[bf];
...
},_applyModel:function(bE,bF){this.__BY=[];
...
if(qx.lang.String.startsWith(bJ,this.getChildProperty())){this.__Cd();
...
}}},_beforeApplySelection:function(bQ){if(bQ.length===0&&this.getSelectionMode()===d){var bR=this.__Ci();
var bS=this.getLookupTable().indexOf(bR);

if(bS>=0){bQ.push(bS);
}}},_afterApplySelection:function(){var bT=this.getSelection();

if(bT.getLength()>0&&this.getSelectionMode()===d){this.__Ch(bT.getItem(0));
}else{this.__Cc=[];
...
if(this.isNodeOpen(bW)){var bU=this.__Ce(bW,bV);
bX=bX.concat(bU);
...
if(this.isNode(ce)){this.__Ca.push(ca);
cb.push(ce);

if(this.isNodeOpen(ce)){var cc=this.__Ce(ce,ca);
cb=cb.concat(cc);
}}else{if(this.isShowLeafs()){this.__Ca.push(ca);
cb.push(ce);
}}}return cb;
},__Cf:function(cf){if(!qx.lang.Array.contains(this.__BY,cf)){this.__BY.push(cf);
this.fireDataEvent(s,cf);
}},__Cg:function(cg,ch){if(cg===ch){this.__Cf(ch);
return true;
}
...
var ci=this.__Cg(ck,ch);

if(ci===true){this.__Cf(ck);
return true;
}}return false;
},__Bl:function(){this.getPane().getRowConfig().setItemCount(this.__nD.getLength());
this.getPane().fullUpdate();
},getParent:function(cl){var cn=this.__nD.indexOf(cl);
...
if(cm<co){return this.__nD.getItem(cn);
}}return null;
},__Ch:function(cp){this.__Cc=[];
...
this.addIcon();
this.setIcon(g);
var r=this.__NJ=new qx.ui.form.CheckBox();
this.bind(n,r,p);
r.bind(p,this,n);
...
var s=this.__gD=new qx.ui.basic.Label();
this.bind(c,s,p);
s.setWidth(50);
this.addWidget(s);
s=this.__NK=new qx.ui.basic.Label();
this.bind(e,s,p);
s.setWidth(150);
this.addWidget(s);
s=this.__eg=new qx.ui.basic.Label();
this.bind(b,s,p);
s.setWidth(80);
this.addWidget(s);
}}});
