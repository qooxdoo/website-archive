...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.showcase.Browser","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Browser-qx.theme.Modern.51bc3b0ac0d4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="demobrowser.demo.showcase.Browser",d="qx.core.BaseInit",c="engine.name",b="os.name",a="engine.version";
...
(function(){var o="execute",n="This feature is currently not supported.",m="http://",l="demobrowser.demo.showcase.Browser",k="separator-vertical",j="icon/16/actions/go-previous.png",i="keypress",h="Enter",g="icon/16/actions/go-next.png",f="Web Browser",b="icon/16/actions/media-playback-start.png",d="http://qooxdoo.org",c="icon/16/categories/internet.png",a="middle";
...
},_createBrowser:function(){var r=new qx.ui.window.Window(f,c);
var p=new qx.ui.layout.VBox();
p.setSeparator(k);
r.setLayout(p);
r.setAllowClose(false);
r.setContentPadding(0);
r.open();
var toolbar=new qx.ui.toolbar.ToolBar();
r.add(toolbar);
var s=new qx.ui.toolbar.Button(null,j);
s.addListener(o,function(e){this.iframe.getWindow().history.back();
},this);
toolbar.add(s);
var t=new qx.ui.toolbar.Button(null,g);
t.addListener(o,function(e){this.iframe.getWindow().history.forward();
},this);
toolbar.add(t);
t.setEnabled(false);
s.setEnabled(false);
t.setToolTipText(n);
s.setToolTipText(n);
this.txtUrl=new qx.ui.form.TextField().set({marginLeft:1,value:d,padding:2,alignY:a});
this.txtUrl.addListener(i,function(e){if(e.getKeyIdentifier()==h){this.surfTo(this.txtUrl.getValue());
}},this);
toolbar.add(this.txtUrl,{flex:1});
var q=new qx.ui.toolbar.Button(null,b);
q.addListener(o,function(e){this.surfTo(this.txtUrl.getValue());
},this);
toolbar.add(q);
this.iframe=new qx.ui.embed.Iframe().set({width:400,height:300,minWidth:200,minHeight:150,source:this.txtUrl.getValue(),decorator:null});
r.add(this.iframe,{flex:1});
return r;
},surfTo:function(u){if(u.indexOf(m)!==0){u=m+u;
this.txtUrl.setValue(u);
...
}this._getIframeElement().addListener(j,this.__Ae,this);
...
},__Ae:function(e){var p=e.getData();

if(p){this.setSource(p);
}this.fireDataEvent(j,p);
}}});
})();
(function(){var k="mousedown",j="load",i="help",h="engine.name",g="mouseup",f="losecapture",d="contextmenu",c="none",b="display",a="no",z="Boolean",y="px",x="gecko",w="auto",v="__Ai",u="_applyScrollbar",t="DOMNodeInserted",s="_applyNativeHelp",r="yes",q="scrolling",o="/",p="appear",m="block",n="qx.ui.embed.Iframe",l="iframe";
qx.Class.define(n,{extend:qx.ui.embed.AbstractIframe,construct:function(A){if(A!=null){this.__Ah=A;
...
this.__Ai=this._createBlockerElement();
this.getContainerElement().add(this.__Ai);
...
},block:function(){this.__Ai.setStyle(b,m);
},release:function(){this.__Ai.setStyle(b,c);
...
this.setSource(i);
this.addListener(b,this.__Ae,this);
...
this.setSource(null);
this.setSource(s);
}},__Ae:function(e){var u=e.getData();
