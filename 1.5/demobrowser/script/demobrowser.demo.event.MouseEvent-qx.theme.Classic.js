...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent-qx.theme.Classic.81571508d08b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},_initLogger:function(n,o,p){this.__Mc=e+n.join(h)+k;
this.__Md=p||50;
this.__Me=o;
this._clearLog();
},_clearLog:function(){this.__Me.innerHTML=this.__Mc+l;
this.__Mf=[];
},_log:function(q){this.__Mf.unshift(q);
this.__Mf=this.__Mf.slice(0,this.__Md);
var r=[this.__Mc];

for(var i=0;i<this.__Mf.length;i++){r.push(d,this.__Mf[i].join(f),a);
}r.push(l);
this.__Me.innerHTML=r.join(g);
this.__Me.scrollTop=0;
},__Mc:null,__Md:null,__Me:null,__Mf:null},destruct:function(){this.__Me=this.__Mf=null;
}});
})();
...
}qx.bom.Element.addListener(G,k,this.__Mg,this);
...
},__Mg:function(e){var K=e.getTarget().id.split(x)[1];
