...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Mouseover","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Simple.f98c712da07d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l=".qx-progressive-",k="-col-",j="px;",h="-row",g="}",f="width: ",d="0px ",c="qx-progressive-",b="px",a="content",G="px ",F="end",E="div",D="qx.tableResizeDebug",C="  width : 100%;",B=" {",A="__columnData",z="css.boxmodel",y="qx.debug",x="relative",s="-row {",t="resize",q="start",r="",o="padding: ",p="qx.ui.progressive.renderer.table.Row",m="__yP",n="progressive-table-row-background-odd",u="progressive-table-row-background-even",v="left: ",w="__FT";
qx.Class.define(p,{extend:qx.ui.progressive.renderer.Abstract,construct:function(H){qx.ui.progressive.renderer.Abstract.call(this);
this.__Gn=H;
this.__GU={};
this.__FT=new qx.ui.progressive.renderer.table.cell.Default();
this.__Gm=null;
this.__GV={};
var I=qx.theme.manager.Color.getInstance();
this.__GV.bgcol=[];
this.__GV.bgcol[0]=I.resolve(u);
this.__GV.bgcol[1]=I.resolve(n);
this.__yP=new qx.ui.layout.HBox();
this.__yP.connectToWidget(this);
},statics:{__xg:null,__GW:6,__GX:"  position: absolute;"+"  top: 0px;"+"  height: 100%;"+"  overflow:hidden;"+"  text-overflow:ellipsis;"+"  -o-text-overflow: ellipsis;"+"  white-space:nowrap;"+"  border-right:1px solid #f2f2f2;"+"  border-bottom:1px solid #eeeeee;"+"  padding : 0px 6px 0px 6px;"+"  cursor:default;"+"  font-size: 11px;"+"  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;"+((qx.core.Environment.get("engine.name")=="mshtml")?'':';-moz-user-select:none;')},properties:{defaultRowHeight:{init:16}},members:{__Gm:null,__lK:null,__GY:null,__Gn:null,__GU:null,__FT:null,__GV:null,__yP:null,join:function(J,name){if(this.__Gm){throw new Error("Renderer is already joined to a Progressive.");
}this.__Gm=J;
this.__lK=name;
...
if(!L.__xg[K]){L.__xg[K]={rowstylesheet:null,cellstylesheet:[]};
var M=l+K+s+C+g;
L.__xg[K].rowstylesheet=qx.bom.Stylesheet.createElement(M);
var N=this.__Gn.getData();

for(var i=0;i<N.length;i++){var M=l+K+k+i+B+L.__GX+g;
L.__xg[K].cellstylesheet[i]=qx.bom.Stylesheet.createElement(M);
}this.__GY=K;
var O=J.getStructure().getPane();
O.addListener(t,this._resizeColumns,this);
}},addRenderer:function(P,Q){var R=this.__Gn.getData();

if(P<0||P>=R.length){throw new Error("Column "+P+" out of range (max: "+(R.length-1)+")");
}this.__GU[P]=Q;
},removeRenderer:function(S){var T=this.__Gn.getData();

if(S<0||S>=T.length){throw new Error("Column "+S+" out of range (max: "+(T.length-1)+")");
}
if(!this.__GU[S]){throw new Error("No existing renderer for column "+S);
}delete this.__GU[S];
...
var bc;
var Y=0;
if(U.getRendererData()[this.__lK].end===undefined){U.getRendererData()[this.__lK]={end:0,start:1,rows:0,totalHeight:0};
}var bf=document.createElement(E);
for(var i=0;i<bg.length;i++){var ba=c+this.__GY+k+i;
bc=this.__GU[i]||this.__FT;
...
var be=U.getRendererData()[this.__lK];
be.totalHeight+=Y;
bf.style.position=x;
bf.style.height=Y+b;
bf.className=c+this.__GY+h;
bf.innerHTML=bb.join(r);
switch(V.location){case F:var W=be.end||0;
bf.style.backgroundColor=this.__GV.bgcol[W];
be.end=(W==0?1:0);
U.getPane().getContentElement().getDomElement().appendChild(bf);
break;
case q:var X=U.getPane().getContentElement().getDomElement();
var bh=X.childNodes;
...
},getLayoutChildren:function(){return this.__Gn.getData();
},_resizeColumns:function(e){var bp=this.__Gm.getStructure().getPane();
var bm=bp.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bn=l+this.__GY+h;
var bj=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bj.__xg[this.__GY].rowstylesheet,bn);
var bl=f+bm+j;
qx.bom.Stylesheet.addRule(bj.__xg[this.__GY].rowstylesheet,bn,bl);
this.__yP.renderLayout(bm,100);
var bo=this.__Gn.getData();
for(var i=0,bs=0;i<bo.length;i++,bs+=bm){var bn=l+this.__GY+k+i;
var bj=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bj.__xg[this.__GY].cellstylesheet[i],bn);
bm=bo[i].getComputedWidth();

if(qx.core.Environment.get(y)){if(qx.core.Environment.get(D)){this.debug("col "+i+": width="+bm);
}}var bk;

if(qx.core.Environment.get(z)==a){bk=qx.ui.progressive.renderer.table.Row.__GW*2;
}else{bk=-1;
}var br=(bm-bk)+j;
var bq=d+qx.ui.progressive.renderer.table.Row.__GW+G+d+qx.ui.progressive.renderer.table.Row.__GW+j;
var bi=bs+j;
var bl=bj.__GX+f+br+v+bi+o+bq;
qx.bom.Stylesheet.addRule(bj.__xg[this.__GY].cellstylesheet[i],bn,bl);
}}},destruct:function(){var name;

for(name in this.__GU){this.__GU[name]=null;
}var bu=qx.ui.progressive.renderer.table.Row;
var bt=this.__Gm.toHashCode();

if(bu.__xg&&bu.__xg[bt]){if(bu.__xg[bt].rowstylesheet){var bw=l+this.__GY+h;
var bu=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bu.__xg[this.__GY].rowstylesheet,bw);
}if(bu.__xg[bt].cellstylesheet){for(var i=bu.__xg[bt].cellstylesheet.length-1;i>=0;i--){var bw=l+this.__GY+k+i;
var bv=bu.__xg[this.__GY].cellstylesheet[i];
var bu=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bv,bw);
}}}
if(this.__Gm&&this.__Gm.getRendererData){var bx=this.__Gm.getRendererData();

if(bx&&bx[this.__lK]&&bx[this.__lK].end!==undefined){bx[this.__lK]=null;
}}this.__GV=this.__GU=this.__Gm=this.__Gn=null;
this._disposeObjects(m,w,A);
}});
})();
...
qx.Class.define(a,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(K){K.__MF=qx.bom.element.Style.get(K,"color");
K.style.color=q;
...
},onmouseout:function(N){N.style.color=N.__MF;
...
this.__yP=new qx.ui.layout.HBox();
this.__yP.connectToWidget(this);
},properties:{appearance:{refine:true,init:c}},members:{__Gn:null,__Gp:null,__Go:null,__yP:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);
},getLayoutChildren:function(){if(this.__Gp){return this.__Gn.getData();
...
this.__Gp=true;
this.__yP.renderLayout(n,100);
this.__Gp=false;
var o=this.__Gn.getData();
for(var i=0;i<o.length;i++){this.__Go[i].setWidth(o[i].getComputedWidth());
}}},destruct:function(){this.__Gn=this.__Go=null;
