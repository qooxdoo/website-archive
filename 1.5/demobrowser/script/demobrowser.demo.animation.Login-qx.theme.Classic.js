...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Login","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Login-qx.theme.Classic.41e45a14ddf5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="top",n="right",m="resize",l="Name",k="Password",j="__LQ",h="__KD",g="__ub",f="appear",d="demobrowser.demo.animation.Login",a="50%",c="execute",b="30%";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__KD:null,__ub:null,__LQ:null,checkInput:function(){this.__KD.start();
},__LR:function(){this.__KD=new qx.fx.effect.combination.Shake(this.__ub.getContainerElement().getDomElement());
...
this.__ub.setLayout(q);
this.__ub.addListener(m,function(e){var u=this.__ub.getBounds();
this.__ub.set({marginTop:Math.round(-u.height/2),marginLeft:Math.round(-u.width/2)});
},this);
this.getRoot().add(this.__ub,{left:a,top:b});
var p=[l,k];

for(var i=0;i<p.length;i++){this.__ub.add(new qx.ui.basic.Label(p[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var r=new qx.ui.form.TextField();
var s=new qx.ui.form.PasswordField();
this.__ub.add(r.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__ub.add(s.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var t=this.__LQ=new qx.ui.form.Button("Login");
t.setAllowStretchX(false);
this.__ub.add(t,{row:3,column:1});
t.addListener(c,this.checkInput,this);
this.__ub.addListener(f,this.__LR,this);
}},destruct:function(){this._disposeObjects(g,j,h);
}});
})();
...
(function(){var e="horizontal",d="vertical",c="__tG",b="qx.fx.effect.combination.Shake",a="Number";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
this.__tG=[new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f)];
},properties:{direction:{init:e,check:[e,d]},duration:{init:0.5,refine:true},distance:{init:20,check:a}},members:{__tG:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var g=parseFloat(this.getDistance());
var h=parseFloat(this.getDuration())/10.0;

if(this.getDirection()==e){this.__tG[0].set({x:g,y:0,duration:h});
this.__tG[1].set({x:-g*2,y:0,duration:h*2});
this.__tG[2].set({x:g*2,y:0,duration:h*2});
this.__tG[3].set({x:-g*2,y:0,duration:h*2});
this.__tG[4].set({x:g*2,y:0,duration:h*2});
this.__tG[5].set({x:-g,y:0,duration:h*2});
}else if(this.getDirection()==d){this.__tG[0].set({y:g,x:0,duration:h});
this.__tG[1].set({y:-g*2,x:0,duration:h*2});
this.__tG[2].set({y:g*2,x:0,duration:h*2});
this.__tG[3].set({y:-g*2,x:0,duration:h*2});
this.__tG[4].set({y:g*2,x:0,duration:h*2});
this.__tG[5].set({y:-g,x:0,duration:h*2});
}var k=this.__tG;

for(var i=0,j=this.__tG.length;i<j;i++){this.__tG[i].id=i;

if(i<5){this.__tG[i].afterFinishInternal=function(){k[this.id+1].start();
};
}}this.__tG[0].start();
