...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_AutoSize","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_AutoSize-qx.theme.Simple.c5c89e6fd2d3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},properties:{sort:{check:[e,c,v],init:e,apply:n},separatorX:{check:b,nullable:true,apply:k},separatorY:{check:b,nullable:true,apply:k},connectSeparators:{check:u,init:false,apply:k},spacingX:{check:f,init:0,apply:k},spacingY:{check:f,init:0,apply:k}},members:{__iU:null,__pf:null,verifyLayoutProperty:qx.core.Environment.select(q,{"true":function(E,name,F){this.assertInArray(name,[w,y,t,o],r+name+p);
...
},__pg:{north:1,south:2,west:3,east:4,center:5},__ph:{1:j,2:s,3:h,4:l},__jF:function(){var G=this._getLayoutChildren();
var O,I;
var length=G.length;
var K=[];
var N=[];
...
},renderLayout:function(Q,R){if(this._invalidChildrenCache){this.__jF();
