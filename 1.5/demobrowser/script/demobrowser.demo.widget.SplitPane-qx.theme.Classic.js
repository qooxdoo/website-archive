...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SplitPane","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane-qx.theme.Classic.db602227d54a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.widget.SplitPane";
...
(function(){var w="value",v="horizontal",u="first",t="second",s="both",r="main",q="offset",p="Show first pane",o="demobrowser.demo.widget.SplitPane",n="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",f="Show both panes",m="Toggle Splitpane Orientation",j="Offset (",c="__Bb",b="Show second pane",h="_container2",g="vertical",k="):",a="changeSelection",l="_container1",d="execute";
qx.Class.define(o,{extend:qx.application.Standalone,members:{__Bb:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var y=new qx.ui.container.Scroll();
var x=new qx.ui.container.Composite(new qx.ui.layout.Basic());
x.setAllowStretchX(false);
y.add(x);
var F=new qx.ui.splitpane.Pane(v).set({width:450,height:300});
this.__Bb=F;
var J=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:r});
var M=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:r});
var B=this.__NV();
var A=new qx.ui.form.Button(m).set({allowGrowX:false,allowGrowY:false});
A.addListener(d,this._toggle,this);
...
F.add(J,0);
F.add(M,1);
x.add(F,{left:20,top:40});
this.getRoot().add(y,{edge:0});
var z=new qx.ui.layout.VBox(5);
var G=new qx.ui.container.Composite(z);
var K=new qx.ui.form.RadioButton(p);
var L=new qx.ui.form.RadioButton(b);
var I=new qx.ui.form.RadioButton(f);
K.setUserData(w,u);
L.setUserData(w,t);
I.setUserData(w,s);
I.setValue(true);
...
G.add(L);
G.add(I);
var E=new qx.ui.form.RadioGroup(K,L,I);
E.addListener(a,this._changeVisiblity,this);
x.add(G,{left:490,top:42});
A.focus();
var C=new qx.ui.basic.Label();
this.getRoot().add(C,{left:490,top:120});
var H=new qx.ui.form.Slider().set({minimum:0,maximum:30,value:6,width:100});
this.getRoot().add(H,{left:490,top:140});
H.bind(w,F,q);
H.bind(w,C,w,{converter:function(N){return j+N+k;
}});
},_toggle:function(){var O=this.__Bb.getOrientation();
this.__Bb.setOrientation(O==v?g:v);
},_changeVisiblity:function(e){var P=e.getData()[0].getUserData(w);

if(P==s){this._container1.show();
this._container2.show();
}else if(P==u){this._container1.show();
this._container2.exclude();
}else if(P==t){this._container1.exclude();
this._container2.show();
}},__NV:function(){var ba=new qx.ui.tree.Tree();
ba.setDecorator(null);
var bf=new qx.ui.tree.TreeFolder("/");
bf.setOpen(true);
ba.setRoot(bf);
var bd=new qx.ui.tree.TreeFolder("Desktop");
bd.setOpen(true);
bf.add(bd);
var U=new qx.ui.tree.TreeFolder("Files");
var S=new qx.ui.tree.TreeFolder("Workspace");
var T=new qx.ui.tree.TreeFolder("Network");
var R=new qx.ui.tree.TreeFolder("Trash");
bd.add(U,S,T,R);
var bb=new qx.ui.tree.TreeFile("Windows (C:)");
var Q=new qx.ui.tree.TreeFile("Documents (D:)");
S.add(bb,Q);
var be=new qx.ui.tree.TreeFolder("Inbox");
var V=new qx.ui.tree.TreeFolder("Presets");
var Y=new qx.ui.tree.TreeFolder("Sent");
var X=new qx.ui.tree.TreeFolder("Trash");

for(var i=0;i<100;i++){X.add(new qx.ui.tree.TreeFile("Junk #"+i));
}var bc=new qx.ui.tree.TreeFolder("Data");
var W=new qx.ui.tree.TreeFolder("Edit");
be.add(V,Y,X,bc,W);
bf.add(be);
return ba;
}},destruct:function(){this._disposeObjects(c,l,h);
}});
})();
...
}this.__mC.addListener(d,this._onMouseDown,this);
this.__mC.addListener(r,this._onMouseUp,this);
this.__mC.addListener(D,this._onMouseMove,this);
this.__mC.addListener(c,this._onMouseOut,this);
this.__mC.addListener(m,this._onMouseUp,this);
},properties:{appearance:{refine:true,init:u},offset:{check:b,init:6,apply:v},orientation:{init:i,check:[i,g],apply:w}},members:{__mv:null,__mw:false,__mx:null,__my:null,__mz:null,__mA:null,__mB:null,__iU:null,__mC:null,_createChildControlImpl:function(F,G){var H;
...
this._add(H,{type:F});
H.addListener(C,this.__mD,this);
break;
}return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);
},__mD:function(e){this.__mF(e.getData());
},__mE:function(I){this.__mC=new qx.ui.splitpane.Blocker(I);
this.getContentElement().add(this.__mC);
var J=this.getChildControl(j);
var K=J.getWidth();

if(!K){J.addListenerOnce(p,function(){this.__mF();
},this);
}J.addListener(A,function(e){var L=e.getData();

if(L.height==0||L.width==0){this.__mC.hide();
}else{this.__mC.show();
}},this);
},getBlocker:function(){return this.__mC;
...
if(!this.__mC){this.__mE(M);
}this.__mC.setOrientation(M);
...
this.__mF();
},_applyOffset:function(S,T){this.__mF();
},__mF:function(U){var V=this.getChildControl(j);
var ba=this.getOffset();
var bb=V.getBounds();
var Y=V.getContainerElement().getDomElement();
if(!Y){return;
}if(this.__mz){var X=null;
...
}this.__mC.setWidth(ba,X);
this.__mC.setLeft(ba,bc);
}}else{var W=null;
...
this.__mv=this.__mz?e.getDocumentLeft()-bi.left+bh.left:e.getDocumentTop()-bi.top+bh.top;
...
if(this.__mw){this.__mG();
var bl=this.getChildControl(k);
var bm=this.__mA;

if(this.__mz){bl.setDomLeft(bm);
this.__mC.setStyle(n,(bm-this.getOffset())+h);
}else{bl.setDomTop(bm);
this.__mC.setStyle(s,(bm-this.getOffset())+h);
}e.stop();
}},_onMouseOut:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());
},_onMouseUp:function(e){if(!this.__mw){return;
}this._finalizeSizes();
...
this.releaseCapture();
e.stop();
},_finalizeSizes:function(){var br=this.__mA;
var bo=this.__mB;
...
}else{if(this.__mz){bs.setWidth(br);
bp.setWidth(bo);
}else{bs.setHeight(br);
bp.setHeight(bo);
}}},__mG:function(){if(this.__mz){var bx=o,bE=z,by=l,bC=this.__mx;
}else{var bx=q,bE=a,by=B,bC=this.__my;
...
this.__mB=bw;
},_isActiveDragSession:function(){return this.__mw;
},_setLastMousePosition:function(x,y){this.__mx=x;
this.__my=y;
