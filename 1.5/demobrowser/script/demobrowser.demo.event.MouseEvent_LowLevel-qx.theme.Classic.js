...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Classic.2603b5e0c42a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(k,{extend:demobrowser.demo.event.EventDemo,members:{__Mh:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__Mh=qx.lang.Function.bind(this.logMouseEvent,this);
...
if(B.checked){qx.bom.Event.addNativeListener(z,A[i],this.__Mh);
}qx.bom.Event.addNativeListener(B,o,qx.lang.Function.bind(this.__Mg,this));
}},__Mg:function(e){var F=qx.bom.Event.getTarget(e);
var E=F.id.split(w)[1];
var C=F.checked;
var D=document.getElementById(l);

if(C){qx.bom.Event.addNativeListener(D,E,this.__Mh);
}else{qx.bom.Event.removeNativeListener(D,E,this.__Mh);
