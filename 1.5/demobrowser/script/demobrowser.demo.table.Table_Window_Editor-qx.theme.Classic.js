...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Window_Editor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Window_Editor-qx.theme.Classic.f0cbd39aaac1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
A.moveTo(300,250);
A.addListener(c,function(e){A.__ys.focus();
A.__ys.setTextSelection(0,A.__ys.getValue().length);
});
A.__ys=new qx.ui.form.TextField(x.value+j).set({allowGrowY:true});
A.add(A.__ys);
...
return A;
},getCellEditorValue:function(B){return parseFloat(B.__ys.getValue());
}}});
})();
