...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Virtual_List","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List-qx.theme.Modern.23bbe25150ae.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.test.Virtual_List";
...
this.__Np=new qx.ui.virtual.layer.WidgetCell(this);
this.getPane().addLayer(this.__Np);
this.getPane().addListener(z,this._onResize,this);
this.__a=[];
this.__bL=[];
this.__wR=new qx.ui.virtual.selection.Row(this.getPane());
this.__wR.addListener(h,this._onChangeSelection,this);
this.__wR.attachMouseEvents();
this.__wR.attachKeyEvents(this);
this.__wR.attachListEvents(this);
...
this.fireDataEvent(h,this.__Nt(e.getData()));
},getCellWidget:function(I,J){var L=this.__a[I];

if(!L){return null;
}var K=this.__bL.pop()||new qx.ui.form.ListItem();
K.set({label:L.getLabel(),icon:L.getIcon()});

if(this.__wR.isItemSelected(I)){K.addState(n);
}else{K.removeState(n);
}K.setUserData(g,I);
return K;
},poolCellWidget:function(M){this.__bL.push(M);
...
},hasChildren:function(){return this.__a.length>0;
...
qx.ui.core.queue.Widget.add(this);
},add:function(W){this.__a.push(W);
this._addHelper(W);
return this;
},remove:function(X){qx.lang.Array.remove(this.__a,X);
this._removeHelper(X);
return this;
},removeAll:function(){for(var i=0,j=this.__a.length;i<j;i++){this._removeHelper(this.__a[i]);
}this.__a=[];
},indexOf:function(Y){return this.__a.indexOf(Y);
},addAt:function(ba,bb){qx.lang.Array.insertAt(this.__a,ba,bb);
this._addHelper(ba);
},addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__a,bc,bd);
this._addHelper(bc);
},addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__a,be,bf);
this._addHelper(be);
},removeAt:function(bg){this.__a.splice(bg,1);
this._removeHelper(this.__a[bg]);
},__Nq:function(bh){var bi=this.__a.indexOf(bh);

if(bi<0){return null;
}else{return bi;
}},__Nr:function(bj){var bk=this.__a[bj];
return bk;
},__Ns:function(bl){var bm=[];

for(var i=0;i<bl.length;i++){bm.push(this.__Nq(bl[i]));
}return bm;
},__Nt:function(bn){var bo=[];

for(var i=0;i<bn.length;i++){bo.push(this.__a[bn[i]]);
}return bo;
},selectAll:function(){this.__wR.selectAll();
},setSelected:function(bp){this.__wR.selectItem(this.__Nq(bp));
},isSelected:function(bq){return this.__wR.isItemSelected(this.__Nq(bq));
},addToSelection:function(br){this.__wR.addItem(this.__Nq(br));
},removeFromSelection:function(bs){this.__wR.removeItem(this.__Nq(bs));
},selectRange:function(bt,bu){this.__wR.selectItemRange(this.__Nq(bt),this.__Nq(bu));
},resetSelection:function(){this.__wR.clearSelection();
},setSelection:function(bv){this.__wR.replaceSelection(this.__Ns(bv));
},getSelectedItem:function(){return this.__a[this.getSelected()];
},getSelected:function(){return this.__a[this.__wR.getSelectedItem()];
},getSelection:function(){return this.__Nt(this.__wR.getSelection());
},getSortedSelection:function(){return this.__Nt(this.__wR.getSortedSelection());
},isSelectionEmpty:function(){return this.__wR.isSelectionEmpty();
},getSelectionContext:function(){return this.__wR.getSelectionContext();
},getSelectables:function(){return this.__Nt(this.__wR.getSelectables());
},_applySelectionMode:function(bw,bx){this.__wR.setMode(bw);
},_applyDragSelection:function(by,bz){this.__wR.setDrag(by);
},_applyQuickSelection:function(bA,bB){this.__wR.setQuick(bA);
}}});
})();
