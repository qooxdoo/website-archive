...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererCustom","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererCustom-qx.theme.Classic.d0eeac7de09b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="demobrowser.demo.ui.FormRendererCustom";
...
(function(){var v="execute",u="Name",t="demobrowser.demo.ui.FormRendererCustom",s="Registration",r="demobrowser.demo.ui.CustomRenderer",q="bio",p="Bio",o="Send",n="email",m="Contact",e="phone",l="Personal Information",h="Password",c="Country",b="Phone",g="Email",f="abc@def.gh",j="right",a="+01 234 56789",k="Reset",d="Please tell us some details about you...";
...
x.add(B,h);
x.addGroupHeader(m);
x.add(new qx.ui.form.TextField(),g,qx.util.Validate.email(),n,null,{placeholder:f});
x.add(new qx.ui.form.TextField(),b,null,e,null,{placeholder:a});
x.addGroupHeader(l);
x.add(new qx.ui.form.TextField(),c);
x.add(new qx.ui.form.TextArea(),p,null,q,null,{placeholder:d});
var z=new qx.ui.form.Button(o);
z.addListener(v,function(){if(x.validate()){alert("send...");
}},this);
x.addButton(z);
var y=new qx.ui.form.Button(k);
y.addListener(v,function(){x.reset();
},this);
x.addButton(y);
var A=new demobrowser.demo.ui.CustomRenderer(x);
this.getRoot().add(A,{left:10,top:10});
}}});
qx.Class.define(r,{extend:qx.ui.form.renderer.Single,members:{__Nx:0,__Ny:0,addItems:function(C,D,E,F){var I=0;
if(E!=null){this._add(this._createHeader(E),{row:I,column:this.__Nx,colSpan:2});
I++;
}for(var i=0;i<C.length;i++){var H=this._createLabel(D[i],C[i]);
this._add(H,{row:I,column:this.__Nx});
var G=C[i];
H.setBuddy(G);

if(G instanceof qx.ui.form.RadioGroup){G=this._createWidgetForRadioGroup(G);
}this._add(G,{row:I,column:this.__Nx+1});
if(F[i]&&F[i].placeholder){G.setPlaceholder(F[i].placeholder);
}I++;
}this.__Nx+=2;
this.__Ny<I?this.__Ny=I:null;
...
this._add(this._buttonRow,{row:this.__Ny,column:0,colSpan:this.__Nx});
