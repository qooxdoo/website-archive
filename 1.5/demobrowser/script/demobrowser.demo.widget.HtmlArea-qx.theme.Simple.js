...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Simple.d509a626bd8b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="demobrowser.demo.widget.HtmlArea",d="qx.core.BaseInit",c="engine.name",b="os.name",a="engine.version";
qx.Class.define(d,{statics:{getApplication:function(){return this.__ec||null;
...
(function(){var o="demobrowser.demo.widget.HtmlArea",n="As an application developer you can <b>use the same API.</b></p>",m='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',l="solid",k="<p>This UI-level widget can be used at RIA (Rich ",h="<h1>HtmlArea UI-level widget</h1>",g="Internet Applications) and inline applications.<br/>",f="border-main",d="so code-duplication is avoided.<br/>",c="The UI widget does use the low-level component internally ",a="<p>You can play around with this widget by hitting the ",b="buttons at the toolbar.</p>";
qx.Class.define(o,{extend:qx.application.Standalone,members:{__JI:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var v=h+k+g+c+d+n+a+b;
var q=new qx.ui.basic.Label(v);
q.set({rich:true,marginBottom:10});
var u=m;
var t=this.getRoot();
var s=new qx.ui.decoration.Single(1,l,f);
s.setWidthTop(0);
this.__JI=new qx.ui.embed.HtmlArea(u,null,"blank.html");
this.__JI.set({width:600,height:400,decorator:s});
...
r.add(toolbar);
r.add(this.__JI);
t.add(r,{left:20,top:20});
},__JJ:function(e){var w=window.prompt("Color (Hex): ","#");
this.setTextColor(w);
},__JK:function(e){var x=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(x);
},__JL:function(e){var y={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(y);
},__JM:function(e){var z="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(z);
},__JN:function(e){var B=new qx.ui.window.Window("Insert Hyperlink");
B.setLayout(new qx.ui.layout.VBox(20));
B.set({width:400,showMaximize:false,showMinimize:false});
var F=new qx.ui.form.TextField("http://");
B.add(F);
var D=new qx.ui.layout.HBox(10);
D.setAlignX("right");
var E=new qx.ui.container.Composite(D);
var A=new qx.ui.form.Button("OK");
A.setWidth(60);
A.addListener("execute",function(e){this.insertHyperLink(F.getValue());
B.close();
},this);
E.add(A);
var C=new qx.ui.form.Button("Cancel");
C.setWidth(60);
C.addListener("execute",function(e){B.close();
},this);
E.add(C);
B.add(E);
B.center();
B.open();
this.saveRange();
},__JO:function(e){var G=window.prompt("HTML Code:","");
this.insertHtml(G);
},__JP:function(){var I=new qx.ui.form.SelectBox;
I.set({toolTipText:"Change Font Family",focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
I.add(new qx.ui.form.ListItem(""));
var J=["Tahoma","Verdana","Times New Roman","Arial","Arial Black","Courier New","Courier","Georgia","Impact","Comic Sans MS","Lucida Console"];
var H;

for(var i=0,j=J.length;i<j;i++){H=new qx.ui.form.ListItem(J[i]);
H.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString("12px "+J[i])});
I.add(H);
}I.addListener("changeSelection",function(e){var K=e.getData()[0].getLabel();

if(K!=""){this.setFontFamily(K);
I.setSelection([I.getChildren()[0]]);
}},this.__JI);
return I;
},__JQ:function(){var M=new qx.ui.form.SelectBox;
M.set({toolTipText:"Change Font Size",focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
M.add(new qx.ui.form.ListItem(""));
var L;

for(var i=1;i<=7;i++){L=new qx.ui.form.ListItem(i+"");
L.set({focusable:false,keepFocus:true});
M.add(L);
}M.addListener("changeSelection",function(e){var N=e.getData()[0].getLabel();

if(N!=""){this.setFontSize(N);
M.setSelection([M.getChildren()[0]]);
}},this.__JI);
return M;
},__JR:function(){return [{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__JI.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__JI.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__JI.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__JI.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__JI.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__JI.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__JI.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__JI.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__JI.setJustifyFull}},{fontFamily:{custom:this.__JP},fontSize:{custom:this.__JQ},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__JJ},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__JK}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__JI.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__JI.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__JL},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__JM},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__JN},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__JO},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__JI.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__JI.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__JI.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__JI.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__JI.redo}}];
},__JS:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator("main");
var O;
var P=this.__JR();

for(var i=0,j=P.length;i<j;i++){var Q=new qx.ui.toolbar.Part;
toolbar.add(Q);

for(var R in P[i]){var S=P[i][R];

if(S.custom){O=S.custom.call(this);
}else{O=new qx.ui.toolbar.Button(null,S.image);
O.set({focusable:false,keepFocus:true,center:true,toolTipText:S.text?S.text:""});
O.addListener("execute",S.action,this.__JI);
}Q.add(O);
}}return toolbar;
}}});
})();
...
(function(){var dB="engine.name",dA="",dz="mshtml",dy="gecko",dx="webkit",dw="qx.event.type.Data",dv="opera",du="qx.event.type.Event",dt=" ",ds="Boolean",ci="qx.debug",ch="enter",cg="id",cf='"',ce="__elementToFocus__",cd="qx.bom.htmlarea.HtmlArea.debug",cc="engine.version",cb="old_id",ca="loadingError",bY="pageup",dI="backgroundcolor",dJ="end",dG="div",dH="redo",dE="i",dF="backspace",dC="inserthtml",dD="style",dK="backgroundimage",dL="100%",da='</head>',cY='<head>',dc="k",db=":",de='redo',dd="y",dg='">',df="down",cX="g",cW="left",o="fontsize",p="undo",q="pagedown",r='</style>',t="u",u="right",v="control",w='<style type="text/css">',x="up",y="None",ea="'",dY="delete",dX=">",dW="b",ee='</body></html>',ed="String",ec="z",eb=";",eg="fontfamily",ef="contextmenu",bo="-",bp='</span>',bm="backgroundColor",bn="li",bs='undo',bt="textbackgroundcolor",bq="Function",br="fontSize",bk="textcolor",bl="br",R="home",Q="<",T="focused",S="fontFamily",N="load",M='<font ',P='id="__elementToFocus__"',O="setUnderline",L="backgroundPosition",K="<!--",by=' size="',bz='/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',bA="'>",bB="insertimage",bu='bold',bv="&copy;",bw="bold",bx="mouseup",bC="readyAfterInvalid",bD="styleWithCSS",bd="span",bc=" />",bb="setBold",ba="P",Y="<P>&nbsp;</P>",X="</",W="qx/static/blank.html",V="&gt;",bh='="',bg="paddingLeft",bE="X",bF="inserthorizontalrule",bG='<p>',bH='</font>',bI="#",bJ="backgroundRepeat",bK="a",bL="&amp;",bM="removeformat",bN="marginLeft",cr="ready",cq="<p>&nbsp;</p>",cp='DOCTYPE html PUBLIC "-/',co="italic",cv="browser.version",cu=" html, body {overflow-x: visible; } ",ct='<body>',cs="insertorderedlist",cz='body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } ',cy="hideFocus",cS="keypress",cT="none",cQ='/DTD XHTML 1.0 Transitional/',cR='<html xmlns="http:/',cO="S",cP="outline",cM="setItalic",cN="body",cU="marginBottom",cV="xhtml",dk="focusOut",dj="justifyleft",dm='</p>',dl="paddingTop",dp="underline",dn="Please use the method 'qx.dom.Node.isBlockNode' instead.",dr='<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',dq="Control",di='<span style="font-family:',dh="__CY",dS='/W3C/',dT="placeholder",dU="backgroundImage",dV="marginTop",dO="> ",dP=" { ",dQ='italic',dR="click",dM='<!',dN="\ufeff",n="focus",m="&quot;",l="marginRight",k="STYLE",h="justifyfull",g='underline',f="inserthyperlink",d="<br />",c='html { margin:0px; padding:0px; } ',b="<br>",B='/EN" "http:/',C="justifycenter",z="<br /><div id='placeholder'></div>",A="useCSS",F="object",G="strikethrough",D="blur",E="text/html",I="true",J="1.9",cA='',cx=' style="',cH="indent",cD="messengerContent",cl="Integer",cj="insertunorderedlist",U="Text",cn="&lt;",bf="_moz_dirty",be='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>',bQ='<br/><div class="placeholder"></div>',bR="selectall",bS="transparent",bT=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",bU="justifyright",bV='/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',bW="//text()[string-length(normalize-space(.))>0]",bX="outdent",bO="about:blank",bP="<body style='",ck="qx.bom.htmlarea.HtmlArea",cG="paddingBottom",cF="keydown",cE="keyup",cL="Verdana",cK="focusout",cJ="$",cI="-->",cC=" }",cB="paddingRight",H='html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } ',bj="Off",bi='p { margin:0px; padding:0px; }',cw='body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ';
qx.Class.define(ck,{extend:qx.core.Object,construct:function(eh,ei,ej,ek){qx.core.Object.call(this);
var en=ek||qx.util.ResourceManager.getInstance().toUri(W);
this.__Dq(eh);
this.__Dr();
this._createAndAddIframe(en);
this._addIframeLoadListener();
this.__CX=qx.bom.htmlarea.HtmlArea.__Da(ej);
if(qx.lang.Type.isString(ei)){this.__ux=ei;
}if((qx.core.Environment.get(dB)==dv)){var em=qx.dom.Node.getWindow(eh);
var eo=qx.event.Registration.getManager(em).getHandler(qx.event.handler.Keyboard);
eo._keyCodeToIdentifierMap[35]=bI;
eo._keyCodeToIdentifierMap[45]=bo;
eo._keyCodeToIdentifierMap[112]=ba;
eo._keyCodeToIdentifierMap[115]=cO;
eo._keyCodeToIdentifierMap[120]=bE;
}this.__CY=this.__DD();
},events:{"load":du,"loadingError":dw,"messengerContent":dw,"cursorContext":dw,"ready":du,"readyAfterInvalid":du,"focused":du,"focusOut":du,"contextmenu":dw,"undoRedoState":dw},statics:{simpleLinebreak:b,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:bb},italic:{method:cM},underline:{method:O},undo:{method:p},redo:{method:dH}},__Da:function(ep){if(ep==null||ep==dA){return dA;
}else if(typeof ep==F){var eq=dA;

for(var i in ep){eq+=i+dP+ep[i]+cC;
}return eq;
}else{return ep;
}},__Db:function(er){var es={};
var a=er.split(eb);
var i;

for(i=0;i<a.length;i++){var et=a[i],eu=et.indexOf(db);

if(eu===-1){continue;
}var name=qx.lang.String.trim(et.substring(0,eu));
var ev=qx.lang.String.trim(et.substring(eu+1,et.length));

if(name&&ev){es[name]=ev;
}}return es;
},__Dc:function(ew,ey,ez,eA){var eF=[];

switch(ew.nodeType){case 1:case 11:var i;
var eD=ew.tagName.toLowerCase();
var eH={};
var eB={};
var closed=(!(ew.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__Dd(ew)));

if(ey){if((qx.core.Environment.get(dB)==dz)){if(eD==dG&&ew.className&&ew.className==dT){for(i=ew.firstChild;i;i=i.nextSibling){eF.push(qx.bom.htmlarea.HtmlArea.__Dc(i,true,ez,eA));
}return eF.join(dA);
}}var eG=ew.attributes;
var eE=eG.length;
var a;

if((qx.core.Environment.get(dB)==dy)){if(eD==bd&&eE==1&&eG[0].name==bf&&ew.childNodes.length==0){return dA;
}}
for(i=0;i<eE;i++){a=eG[i];
if(!a.specified){continue;
}var name=qx.dom.Node.getName(a);
var eI=a.nodeValue;
if(/(_moz|contenteditable)/.test(name)){continue;
}
if(name!=dD){if(qx.core.Environment.get(dB)==dz){if(name==cg&&ew.getAttribute(cb)){eI=ew.getAttribute(cb);
}else if(!isNaN(eI)){eI=ew.getAttribute(name);
}else{eI=a.nodeValue;
}}else{eI=a.nodeValue;
}}else{eI=ew.style.cssText;
}
if(/(_moz|^$)/.test(eI)){continue;
}if(name==cb){continue;
}if(!eI){continue;
}if(name==cg&&eI==ce){continue;
}if(name.charAt(0)===cJ){continue;
}eH[name]=eI;
}if(eH.style!==undefined){eB=qx.bom.htmlarea.HtmlArea.__Db(eH.style);
delete eH.style;
}if(eA){var eC={domElement:ew,tag:eD,attributes:eH,styles:eB};
eA(eC);
eC.domElement=null;
eD=eC.tag;
}if(eD){eF.push(Q,eD);
for(var name in eH){var eI=eH[name];
eF.push(dt,name,bh,eI.toString().replace(new RegExp(cf,cX),ea),cf);
}if(!qx.lang.Object.isEmpty(eB)){eF.push(cx);

for(var name in eB){var eI=eB[name];
eF.push(name,db,eI.toString().replace(new RegExp(cf,cX),ea),eb);
}eF.push(cf);
}eF.push(closed?bc:dX);
}}for(i=ew.firstChild;i;i=i.nextSibling){eF.push(qx.bom.htmlarea.HtmlArea.__Dc(i,true,ez,eA));
}if(ey&&!closed&&eD){eF.push(X,eD,dX);
}break;
case 3:eF.push(ez?ew.data:qx.bom.htmlarea.HtmlArea.__De(ew.data));
break;
case 8:eF.push(K,ew.data,cI);
break;
}return eF.join(dA);
},closingTags:bT,__Dd:function(eJ){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(dt+eJ.tagName+dt)!=-1);
},__De:function(s){s=s.replace(/&/ig,bL);
s=s.replace(/</ig,cn);
s=s.replace(/>/ig,V);
s=s.replace(/\x22/ig,m);
s=s.replace(/\xA9/ig,bv);
return s;
},isBlockNode:function(eK){var eL=qx.bom.htmlarea.HtmlArea.isBlockNode;
var eM=dn;
qx.log.Logger.deprecatedMethodWarning(eL,eM);
return qx.dom.Node.isBlockNode(eK);
},isParagraphParent:function(eN){if(!qx.dom.Node.isElement(eN)){return false;
}eN=qx.dom.Node.getName(eN);
return /^(body|td|th|caption|fieldset|div)$/.test(eN);
},isHeadlineNode:function(eO){if(!qx.dom.Node.isElement(eO)){return false;
}var eP=qx.dom.Node.getName(eO);
return /^h[1-6]$/.test(eP);
}},properties:{contentType:{check:ed,init:cV},messengerMode:{check:ds,init:false},insertParagraphOnLinebreak:{check:ds,init:true},insertLinebreakOnCtrlEnter:{check:ds,init:true},postProcess:{check:bq,nullable:true,init:null},useUndoRedo:{check:ds,init:true},nativeContextMenu:{check:ds,init:false},defaultFontFamily:{check:ed,init:cL},defaultFontSize:{check:cl,init:4}},members:{__cj:null,__cT:false,__Df:false,__Dg:false,__Dh:false,__Di:false,__CY:null,__Dj:null,__Dk:null,__Dl:null,__ws:null,__CX:null,__Dm:null,__Dn:null,__Do:false,__Dp:false,__Dq:function(eQ){if(qx.dom.Node.isElement(eQ)&&qx.dom.Node.isNodeName(eQ,dG)){this.__cj=eQ;
}},_createAndAddIframe:function(eR){this.__ws=qx.bom.Iframe.create();
qx.bom.Iframe.setSource(this.__ws,eR);
if((qx.core.Environment.get(dB)==dz)){qx.bom.element.Attribute.set(this.__ws,cy,I);
}else{qx.bom.element.Style.set(this.__ws,cP,cT);
}qx.bom.element.Style.setStyles(this.__ws,{width:dL,height:dL});
...
},_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__ws,N,this._loaded,this);
},__Dr:function(){this.__Dm={"xhtml":{doctype:dM+cp+dS+cQ+B+bV,html:cR+bz,meta:dr,style:qx.core.Environment.select(dB,{"mshtml":c+cw,"default":H+cz}),contentStyle:bi,body:ct,footer:ee}};
},__ux:dA,getIframeObject:function(){return this.__ws;
},getCommandManager:function(){return this.__CY;
},setValue:function(eS){if(qx.lang.Type.isString(eS)){this.__ux=eS;
var eT=this._getIframeDocument();

if(eT&&eT.body){eT.body.innerHTML=this.__Ds(eS);
}}},__Ds:function(eU){var eX=dA;

if((qx.core.Environment.get(dB)==dy)){if(qx.core.Environment.get(cv)<=2){eX+=be;
}}var eY=eU.length==0?dN:dA;
var eW=qx.core.Environment.get(dB)==dy||qx.core.Environment.get(dB)==dx?P:cA;
var eV=bG+di+this.getDefaultFontFamily()+dg+M+eW+by+this.getDefaultFontSize()+dg+eX+eU+eY+bH+bp+dm;
return eV;
},getValue:function(){return this.__ux;
},getComputedValue:function(fa){return this.getHtml(fa);
},getCompleteHtml:function(){var fc=this.__Dm[this.getContentType()];
var fb=fc.html+cY+fc.meta+w+fc.contentStyle+r+da;
fb+=bP+this.__Dt()+bA;
fb+=this.getHtml()+ee;
return fb;
},__Dt:function(){var ff=[bm,dU,bJ,L,S,br,dV,cU,bN,l,dl,cG,bg,cB];
var fe=qx.bom.element.Style;
var fd=this.getContentBody();
var fi={};
var fh,fj;
var fg=qx.core.Environment.get(dB)==dz?2:1;

for(var i=0,j=ff.length;i<j;i++){fh=ff[i];
fj=fe.get(fd,fh,fg);

if(fj!==undefined&&fj!=dA){fi[fh]=fj;
}}return qx.bom.element.Style.compile(fi);
...
}},getWords:function(fk){if(!fk){fk=this.getContentBody();
}
if(!fk){return [];
}var fm=fk.cloneNode(true);
var fo=fm.innerHTML;
fo=fo.replace(/>/gi,dO);
fo=fo.replace(/\n/gi,dt);
fo=fo.replace(/<!--.*-->/gi,dA);
fm.innerHTML=fo;
var fl=qx.core.Environment.get(dB)==dz||qx.core.Environment.get(dB)==dv?fm.innerText:fm.textContent;
var fn=fl.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);
return !fn?[]:fn;
},getWordsWithElement:function(){var fq=this.getTextNodes();
var fu={};
var i,j,fv,fr,fp;

for(var i=0,ft=fq.length;i<ft;++i){fr=fq[i];
fv=fr.nodeValue.split(dt);

for(var j=0,fs=fv.length;j<fs;++j){fp=this._cleanupWord(fv[j]);

if(fp!=null&&fp.length>1){if(!fu[fp]){fu[fp]=[];
}fu[fp].push(fr);
}}}return fu;
},_cleanupWord:function(fw){if(!fw){return null;
}return fw.replace(qx.bom.htmlarea.HtmlArea.CleanupWordsRegExp,dA);
},getTextNodes:function(){return this._fetchTextNodes(this.getContentBody());
},_fetchTextNodes:function(fx){var fz=[];
var fy;
if(fx.hasChildNodes){for(var i=0;i<fx.childNodes.length;i++){fy=this._fetchTextNodes(fx.childNodes[i]);
qx.lang.Array.append(fz,fy);
}}if(fx.nodeType==3){if(fx.nodeValue.length>1){fz.push(fx);
}}return fz;
},__Du:0,__Dv:function(){var fA=this._getIframeDocument();
if(!fA){this.__Du++;

if(this.__Du>5){this.error('cant load HtmlArea. Document is not available. '+fA);
this.fireDataEvent(ca);
}else{if(qx.core.Environment.get(ci)){this.error('document not available, try again...');
}qx.event.Timer.once(function(){this.__Dv();
},this,0);
}}else{this.__Du=0;
...
return;
}if((qx.core.Environment.get(dB)==dz)){this.__Dv();
}else{this._onDocumentIsReady();
}},isReady:function(){return this.__cT;
},_onDocumentIsReady:function(){var fB=new qx.bom.htmlarea.manager.Command(this);

if(this.getUseUndoRedo()){fB=new qx.bom.htmlarea.manager.UndoRedo(fB,this);
}this.__Dg=true;
if((qx.core.Environment.get(dB)==dz)){this.setEditable(true);
}this.__Dz();

if(!(qx.core.Environment.get(dB)==dv)){this.__CD();
}if(!(qx.core.Environment.get(dB)==dz)){this.setEditable(true);
}this.__cT=true;
this.__CY=fB;
fB.setContentDocument(this._getIframeDocument());
this.__DE();
if((qx.core.Environment.get(dB)==dv)){this.__CD();
}this.fireEvent(cr);
},forceEditable:qx.core.Environment.select(dB,{"gecko":function(){var fC=this._getIframeDocument();

if(fC){if(parseFloat(qx.core.Environment.get(cc))>=J){fC.designMode=bj;
fC.body.contentEditable=false;
fC.body.contentEditable=true;
}else{fC.body.contentEditable=true;
this.__DF(true);
}}},"default":qx.lang.Function.empty}),invalidateEditor:qx.core.Environment.select(dB,{"gecko":function(){this.__Dg=false;
this.__cT=false;
this.__Df=true;
},"default":function(){}}),__Dw:qx.core.Environment.select(dB,{"gecko":function(){this.__Dz();
this.__CD();
...
this.__Df=false;
this.fireEvent(bC);
},"default":function(){}}),__Dx:function(fD){var fF=dA;

if(!fD){return fF;
}
try{var fE=fD.getAttribute(dD);

if(!fE){return fF;
}if((qx.core.Environment.get(dB)==dz)){fF=fE.cssText;
}else{fF=fE;
}}catch(fG){this.error("can't extract style from elem. ");
}return fF;
},__Dy:function(fH){var fI=qx.core.Environment.get(dB)==dy?cu:dA;
var fJ=this.__Dm[this.getContentType()];
var fK=cY+fJ.meta+w+fI+fJ.style+fJ.contentStyle+this.__CX+r+da;
var content=fJ.body+fH;
return fJ.html+fK+content+fJ.footer;
},__Dz:function(){var fM=this.__Ds(this.getValue());

if(qx.lang.Type.isString(fM)){var fL=this._getIframeDocument();

try{fL.open(E,true);
fL.write(this.__Dy(fM));
fL.close();
}catch(e){this.error("cant open document on source '"+qx.bom.Iframe.queryCurrentUrl(this.__ws)+"'",e);
this.fireDataEvent(ca,e);
}}},__CD:function(){this.__DA();
this.__DC();
this.__DB();
},__DA:function(){var fO=qx.event.Registration;
var fN=this._getIframeDocument();
fO.addListener(fN.body,"keypress",this._handleKeyPress,this);
fO.addListener(fN.body,"keyup",this._handleKeyUp,this);
fO.addListener(fN.body,"keydown",this._handleKeyDown,this);
},__DB:function(){var fR=qx.event.Registration;
var fP=this._getIframeDocument();
var fQ=qx.core.Environment.get("engine.name")=="webkit"?this._getIframeWindow():fP.body;
fR.addListener(fQ,"focus",this._handleFocusEvent,this);
fR.addListener(fQ,"blur",this._handleBlurEvent,this);
fR.addListener(fP,"focusout",this._handleFocusOutEvent,this);
},__DC:function(){var fU=qx.event.Registration;
var fT=this._getIframeDocument();
var fS=qx.core.Environment.get("engine.name")=="mshtml"?"click":"mouseup";
fU.addListener(fT.body,fS,this._handleMouseUpOnBody,this);
fU.addListener(fT.documentElement,fS,this._handleMouseUpOnDocument,this);
fU.addListener(fT.documentElement,"contextmenu",this._handleContextMenuEvent,this);
},__DD:function(){if(this.__Dj==null){this.__Dj={execute:function(fV,fW){this.stackedCommands=true;
this.commandStack.push({command:fV,value:fW});
},commandStack:[],stackedCommands:false};
}this.__Dj.stackedCommands=false;
return this.__Dj;
},__DE:function(){var fX=this.__Dj;

if(fX!=null&&fX.stackedCommands){var fY=fX.commandStack;

if(fY!=null){for(var i=0,j=fY.length;i<j;i++){this.__CY.execute(fY[i].command,fY[i].value);
}}}},__DF:function(ga){var gb=this._getIframeDocument();

if(this.__Dg&&gb){try{if((qx.core.Environment.get("engine.name")=="gecko")){gb.designMode=(ga!==false)?'Off':'On';
}gb.designMode=(ga!==false)?'On':'Off';
}catch(e){}}},setEditable:function(gc){if(this.__Dg){this.__DF(true);
if((qx.core.Environment.get(dB)==dy)){try{var gd=this._getIframeDocument();
gd.execCommand(bD,false,true);
}catch(ge){try{var gd=this._getIframeDocument();
gd.execCommand(A,false,false);
}catch(gf){if(!this.__cT){this.error("Failed to enable rich edit functionality");
this.fireDataEvent(ca,gf);
...
},__DG:false,_handleKeyUp:function(e){var gg=e.getKeyIdentifier().toLowerCase();
this.__Dk=e;

if((qx.core.Environment.get(ci))&&qx.core.Environment.get(cd)){this.debug(e.getType()+" | "+gg);
}if(qx.core.Environment.get(dB)==dz||qx.core.Environment.get(dB)==dx){if(this.__DG){switch(gg){case ch:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(dB)==dx)){this.__DH();
e.preventDefault();
e.stopPropagation();
}else{var gh=this.__DR(this.getSelection());

if(gh){gh.collapse(true);
gh.pasteHTML(bQ);
}}this.__DM();
}break;
case v:this.__DG=false;
return;
break;
}}}else if((qx.core.Environment.get(dB)==dy)){switch(gg){case cW:case u:case x:case df:case bY:case q:case dY:case dJ:case dF:this.__Di=(this.getFocusNode()==this.getContentBody().firstChild);
break;
}}},__DH:function(){var gi=this.getSelection();
var gj="";
if(gi&&(gi.focusNode.textContent==""||gi.focusNode.parentElement.tagName=="LI")){gj="<br class='webkit-block-placeholder' />";
}this.__CY.execute("inserthtml",gj+qx.bom.htmlarea.HtmlArea.simpleLinebreak);
},_handleKeyDown:qx.core.Environment.select(dB,{"mshtml|webkit":function(e){var gk=e.getKeyIdentifier().toLowerCase();

if((qx.core.Environment.get(ci))&&qx.core.Environment.get(cd)){}if(this.__DG&&(gk==ec||gk==dd||gk==dW||gk==t||gk==dE||gk==dc)){e.preventDefault();
e.stopPropagation();
}if(gk==v){this.__DG=true;
...
if((qx.core.Environment.get(ci))&&qx.core.Environment.get(cd)){this.debug(e.getType()+" | "+gl);
}if(this.__Do){var gv=!((qx.core.Environment.get(dB)==dz)&&gl==ch)||!((qx.core.Environment.get(dB)==dy)&&gl==ch);

if(gv){this.__DM();
this.__Do=false;
}}
switch(gl){case ch:if(!go&&!gn&&this.getMessengerMode()){e.preventDefault();
e.stopPropagation();
this.fireDataEvent(cD,this.getComputedValue());
this.resetHtml();
}if(gn){if(!this.getInsertLinebreakOnCtrlEnter()){return;
}e.preventDefault();
e.stopPropagation();

if((qx.core.Environment.get(dB)==dy)){if(this.__DP()){this.insertHtml(d);
this.__DM();
return;
}this.insertHtml(z);
}else if((qx.core.Environment.get(dB)==dv)){var gu=this.getSelection();
var gq=this.__DR(gu);

if(gu&&gq){var gr=gp.createElement(bl);
gq.collapse(true);
gq.insertNode(gr);
gq.collapse(true);
gq.selectNode(gr);
...
}if((qx.core.Environment.get(dB)==dz)){if(!this.getInsertParagraphOnLinebreak()){if(this.__CY.execute(dC,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__DM();
e.preventDefault();
e.stopPropagation();
}}}else if((qx.core.Environment.get(dB)==dy)){if(this.getInsertParagraphOnLinebreak()&&!go&&!gn){var gu=this.getSelection();

if(gu){var gm=gu.focusNode;
if(this.__DP()){this.__DM();
return;
}if(this.__DQ()){this.__DM();
return;
}while(!qx.dom.Node.isNodeName(gm,cN)){if(qx.dom.Node.isNodeName(gm,bn)){this.__DM();
return;
}gm=gm.parentNode;
...
this.__DM();
this.__Do=true;
}}else if((qx.core.Environment.get(dB)==dx)){if(this.getInsertParagraphOnLinebreak()&&go){this.__DH();
e.preventDefault();
e.stopPropagation();
this.__DM();
}}break;
case x:if(qx.core.Environment.get(dB)==dy&&qx.core.Environment.get(cc)<1.9&&go){var gu=this.getSelection();
if(gu&&gu.focusNode==gp.body.firstChild){if(this.__Di){if(gu.focusOffset!=0){gu.extend(gu.focusNode,0);
}}}}this.__DM();
break;
case R:if(qx.core.Environment.get(dB)==dy&&qx.core.Environment.get(cc)<1.9){if(gn){var gu=this.getSelection();
if(go){if(gu&&(gu.focusOffset!=0)||(gu.focusNode!=gp.body.firstChild)){gu.extend(gp.body.firstChild,0);
}}else{var gs=null;
var gt;
if(gp){gs=gp.evaluate(bW,gp.body,null,XPathResult.ANY_TYPE,null);
}
if(gs&&gu){while(gt=gs.iterateNext()){if(gt&&gt.parentNode&&gt.parentNode.tagName!=k){try{gu.extend(gt,0);

if(!this.isSelectionCollapsed()){gu.collapseToStart();
}}catch(e){}break;
}}}}}}this.__DM();
break;
case cW:case u:case df:case bY:case q:case dY:case dJ:case dF:this.__DM();
break;
case dW:if(gn){this.__DI(bu,true);
}break;
case dE:case dc:if(gn){this.__DI(dQ,true);
}break;
case t:if(gn){this.__DI(g,true);
}break;
case ec:if(gn&&!go){this.__DI(bs,true);
}else if(gn&&go){this.__DI(de,true);
}break;
case dd:if(gn){this.__DI(de,true);
}break;
case bK:if(gn){this.selectAll();
}break;
}this.__Dk=null;
},__DI:function(gw,gx){var gz=null;
var gy=qx.bom.htmlarea.HtmlArea.hotkeyInfo;

if(gy[gw]){gz=gy[gw].method;
}
if(gz!=null&&this[gz]){this[gz]();

if(gx){this.__Dk.preventDefault();
...
if(qx.core.Environment.get(dB)==dy||qx.core.Environment.get(dB)==dx){var gA=this.getContentDocument().getElementById(ce);

if(gA){qx.bom.element.Attribute.reset(gA,cg);
}}this.fireEvent(T);
...
},_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(ci))&&qx.core.Environment.get(cd)){this.debug("handleMouse "+e.getType());
}this.__Dp=true;
this.__DM();
},_handleMouseUpOnDocument:qx.core.Environment.select(dB,{"mshtml":qx.lang.Function.empty,"default":function(e){if(!this.__Dp){qx.bom.Element.activate(this.getContentBody());
}this.__Dp=false;
}}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var gD=e.getViewportLeft();
var gC=e.getViewportTop();
var gE=qx.bom.element.Location.getLeft(this.__cj)+gD;
var gF=qx.bom.element.Location.getTop(this.__cj)+gC;
var gB={x:gE,y:gF,relX:gD,relY:gC,target:e.getTarget()};
e.preventDefault();
e.stopPropagation();
qx.event.Timer.once(function(){this.fireDataEvent(ef,gB);
},this,0);
}},isLoaded:function(){return this.__Dg;
},insertHtml:function(gG){return this.__CY.execute(dC,gG);
},removeFormat:function(){var gH=this.__CY.execute(bM);
this.__CY.execute(o,this.getDefaultFontSize());
this.__CY.execute(eg,this.getDefaultFontFamily());
return gH;
},setBold:function(){return this.__CY.execute(bw);
},setItalic:function(){return this.__CY.execute(co);
},setUnderline:function(){return this.__CY.execute(dp);
},setStrikeThrough:function(){return this.__CY.execute(G);
},setFontSize:function(gI){return this.__CY.execute(o,gI);
},setFontFamily:function(gJ){return this.__CY.execute(eg,gJ);
},setTextColor:function(gK){return this.__CY.execute(bk,gK);
},setTextBackgroundColor:function(gL){return this.__CY.execute(bt,gL);
},setJustifyLeft:function(){return this.__CY.execute(dj);
},setJustifyCenter:function(){return this.__CY.execute(C);
},setJustifyRight:function(){return this.__CY.execute(bU);
},setJustifyFull:function(){return this.__CY.execute(h);
},insertIndent:function(){return this.__CY.execute(cH);
},insertOutdent:function(){return this.__CY.execute(bX);
},insertOrderedList:function(){return this.__CY.execute(cs);
},insertUnorderedList:function(){return this.__CY.execute(cj);
},insertHorizontalRuler:function(){return this.__CY.execute(bF);
},insertImage:function(gM){return this.__CY.execute(bB,gM);
},insertHyperLink:function(gN){return this.__CY.execute(f,gN);
},removeBackgroundColor:function(){this.__CY.execute(dI,bS);
},setBackgroundColor:function(gO){this.__CY.execute(dI,gO);
},removeBackgroundImage:function(){this.__CY.execute(dK);
},setBackgroundImage:function(gP,gQ,gR){return this.__CY.execute(dK,[gP,gQ,gR]);
},selectAll:function(){return this.__CY.execute(bR);
},undo:function(){if(this.getUseUndoRedo()){return this.__CY.execute(p);
}else{return true;
}},redo:function(){if(this.getUseUndoRedo()){return this.__CY.execute(dH);
}else{return true;
}},resetHtml:function(){var gS=this._getIframeDocument();
while(gS.body.firstChild){gS.body.removeChild(gS.body.firstChild);
}if(qx.core.Environment.get(dB)==dy){gS.body.innerHTML=cq;
}else if(qx.core.Environment.get(dB)==dx){var gT=this.getSelection();
...
}return qx.bom.htmlarea.HtmlArea.__Dc(gW.body,false,gV,this.getPostProcess());
},containsOnlyPlaceholder:qx.core.Environment.select(dB,{"mshtml":function(){var gX=this._getIframeDocument();
return (gX.body.innerHTML==Y);
},"default":qx.lang.Function.returnFalse}),_selectElement:function(gY){var hb=this.getContentWindow().getSelection();
var ha=this.getContentDocument().createRange();
ha.setStart(gY,0);
hb.removeAllRanges();
hb.addRange(ha);
},focusContent:qx.core.Environment.select(dB,{"gecko":function(){var hd=this.getContentDocument();
var hc=hd.getElementById(ce);
this.getContentWindow().focus();
qx.bom.Element.focus(this.getContentBody());

if(hc){this._selectElement(hc);
}else{this.__DJ();
}},"webkit":function(){qx.bom.Element.focus(this.getContentWindow());
qx.bom.Element.focus(this.getContentBody());
var he=this.getContentDocument().getElementById(ce);

if(he){qx.bom.element.Attribute.reset(he,cg);
}this.__DJ();
...
}},__DK:qx.core.Environment.select("engine.name",{"gecko":function(){var hf=this.getContentBody().childNodes;

if(hf.length==0){return false;
}else if(hf.length==1){return !(hf[0]&&qx.dom.Node.isNodeName(hf[0],"br")&&qx.bom.element.Attribute.get(hf[0],"_moz_dirty")!=null);
}else{return true;
}},"webkit":function(){var hg=this.getContentBody().childNodes;

if(hg.length==0){return false;
}else if(hg.length==1){return !(hg[0]&&qx.dom.Node.isNodeName(hg[0],"br"));
}else{return true;
}},"default":function(){var hh=this.getContentBody().childNodes;

if(hh.length==0){return false;
}else if(hh.length==1){return !(hh[0]&&qx.dom.Node.isNodeName(hh[0],"p")&&hh[0].firstChild==null);
}else{return true;
}}}),__DL:qx.core.Environment.select("engine.name",{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__Ds("");
var hi=this.getContentDocument().getElementById("__elementToFocus__");
qx.bom.element.Attribute.reset(hi,"id");
this._selectElement(hi);
},"default":function(){var hj=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());

if(qx.dom.Node.isNodeName(hj,"p")){qx.bom.element.Style.set(hj,"font-family",this.getDefaultFontFamily());
qx.bom.element.Style.set(hj,"font-size",this.getDefaultFontSize());
}}}),getContextInformation:function(){return this.__DN();
},__DM:function(){qx.event.Timer.once(function(e){var hk=this.__DN();
this.fireDataEvent("cursorContext",hk);
},this,200);
...
}var ho=this.getFocusNode();

if(ho==null){return;
}
if(qx.dom.Node.isText(ho)){ho=ho.parentNode;
}var hs=this._getIframeDocument();
var hB=(qx.core.Environment.get("engine.name")=="mshtml")?ho.currentStyle:hs.defaultView.getComputedStyle(ho,null);
var hv=false;
var hl=false;
var hq=false;
var hp=false;
...
if(hB!=null){if((qx.core.Environment.get("engine.name")=="mshtml")){hl=hB.fontStyle=="italic";
hq=hB.textDecoration.indexOf("underline")!==-1;
hp=hB.textDecoration.indexOf("line-through")!==-1;
hz=hB.fontSize;
hu=hB.fontFamily;
hr=hB.textAlign=="left";
hC=hB.textAlign=="center";
hn=hB.textAlign=="right";
hy=hB.textAlign=="justify";
}else{hl=hB.getPropertyValue("font-style")=="italic";
hq=hB.getPropertyValue("text-decoration").indexOf("underline")!==-1;
hp=hB.getPropertyValue("text-decoration").indexOf("line-through")!==-1;
hz=hB.getPropertyValue("font-size");
hu=hB.getPropertyValue("font-family");
hr=hB.getPropertyValue("text-align")=="left";
hC=hB.getPropertyValue("text-align")=="center";
hn=hB.getPropertyValue("text-align")=="right";
hy=hB.getPropertyValue("text-align")=="justify";
}
if(qx.core.Environment.get("engine.name")=="mshtml"||qx.core.Environment.get("engine.name")=="opera"){hv=hB.fontWeight==700;
}else{hv=hB.getPropertyValue("font-weight")=="bold"||qx.dom.Node.isNodeName(ho,"b");
}}var hm=ho;
if(hm!=null&&hm.parentNode!=null&&!qx.dom.Node.isDocument(hm.parentNode)){while(hm!=null&&!qx.dom.Node.isNodeName(hm,"body")){var ht=qx.dom.Node.getName(hm);

if(ht=="ol"){hA=true;
break;
}else if(ht=="ul"){hw=true;
break;
}
if(hD==null||hD==""){hD=qx.bom.element.Attribute.get(hm,'size');
}hm=hm.parentNode;
}}var hx={bold:hv?1:0,italic:hl?1:0,underline:hq?1:0,strikethrough:hp?1:0,fontSize:(hD==null)?hz:hD,fontFamily:hu,insertUnorderedList:hw?1:0,insertOrderedList:hA?1:0,justifyLeft:hr?1:0,justifyCenter:hC?1:0,justifyRight:hn?1:0,justifyFull:hy?1:0};
this._processingExamineCursorContext=false;
return hx;
},getSelection:qx.core.Environment.select(dB,{"mshtml":function(){return this._getIframeDocument()?this._getIframeDocument().selection:null;
},"default":function(){return this._getIframeWindow()?this._getIframeWindow().getSelection():null;
}}),isSelectionCollapsed:qx.core.Environment.select(dB,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==y;
},"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;
}}),getSelectedText:qx.core.Environment.select(dB,{"mshtml":function(){return this.getRange()?this.getRange().text:dA;
},"default":function(){return this.getRange()?this.getRange().toString():dA;
}}),getSelectedHtml:function(){if(this.__Dl!=null){return this.__Dl;
}var hE=this.getRange();

if(!hE){return dA;
}else{return this.__DO(hE);
}},__DO:qx.core.Environment.select("engine.name",{"mshtml":function(hF){if(!hF){return "";
}return hF.item?hF.item(0).outerHTML:hF.htmlText;
},"default":function(hG){var hH=this._getIframeDocument();

if(hH&&hG){try{var hI=hH.createElement("body");
hI.appendChild(hG.cloneContents());
return hI.innerHTML;
}catch(hJ){}return hG+"";
}return "";
}}),clearSelection:qx.core.Environment.select(dB,{"mshtml":function(){var hK=this.getSelection();

if(hK){hK.empty();
}},"default":function(){var hL=this.getSelection();

if(hL){hL.collapseToStart();
}}}),__DP:qx.core.Environment.select("engine.name",{"gecko":function(){var hM=this.getSelection();
...
},__DR:qx.core.Environment.select("engine.name",{"mshtml":function(hO){var hP=this._getIframeDocument();
...
}}}),saveRange:qx.core.Environment.select(dB,{"mshtml":function(){this.__Dn=this.getRange();
},"default":function(){}}),getSavedRange:qx.core.Environment.select(dB,{"mshtml":function(){return this.__Dn;
},"default":function(){}}),resetSavedRange:qx.core.Environment.select(dB,{"mshtml":function(){this.__Dn=null;
},"default":function(){}}),getFocusNode:qx.core.Environment.select(dB,{"mshtml":function(){var hU=this.getSelection();
var hV;

switch(hU.type){case U:case y:hV=this.__DR(hU);

if(hV){hV.collapse(false);
return hV.parentElement();
}else{return null;
}break;
case dq:hV=this.__DR(hU);
...
}})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var ia=this._getIframeDocument();
var ic=qx.event.Registration;
ic.removeListener(ia.body,cS,this._handleKeyPress,this);
ic.removeListener(ia.body,cE,this._handleKeyUp,this);
ic.removeListener(ia.body,cF,this._handleKeyDown,this);
var ib=qx.core.Environment.get(dB)==dx?this._getIframeWindow():ia.body;
ic.removeListener(ib,n,this._handleFocusEvent);
ic.removeListener(ib,D,this._handleBlurEvent);
ic.removeListener(ia,cK,this._handleFocusOutEvent);
var hY=qx.core.Environment.get(dB)==dz?dR:bx;
ic.removeListener(ia.body,hY,this._handleMouseUpOnBody,this);
ic.removeListener(ia.documentElement,hY,this._handleMouseUpOnDocument,this);
ic.removeListener(ia.documentElement,ef,this._handleContextMenuEvent,this);

if((qx.core.Environment.get(dB)==dz)){qx.bom.Iframe.setSource(this.__ws,bO);
}}catch(id){}
...
(function(){var cn="engine.name",cm="legacy-font-size",cl="",ck="mshtml",cj="inserthtml",ci='color',ch="text-decoration",cg="__Ej",cf=';',ce="span",bx="transparent",bw="p",bv="id",bu="InsertHtml",bt='">',bs="child",br="gecko",bq="font-family",bp="text-align",bo='text-decoration',cu="BackColor",cv="FontSize",cs="qx.debug",ct="/>",cq="</font>",cr=':',co="font-size",cp="background-color",cw="font",cx=":",bV="='",bU="<img ",bX=";",bW="px",ca="Control",bY="__paragraph__",cc="qx.bom.htmlarea.HtmlArea.debug",cb="size",bT="' ",bS="webkit",a="BODY",b="__Ek",c="undefined",d="backgroundColor",f="_moz",g="formatBlock",h="insertParagraph",m="li",n='<span style="',o="__EI",cB="type",cA="FONT",cz="__EA",cy="__placeholder__",cF='font-family:',cE="outdent",cD='</a> ',cC="InsertImage",cH="__resetHtml",cG="FontName",N="blockquote",O="__EH",L="__Ez",M="style",R="__EG",S="qx.bom.htmlarea.manager.Command",P="'><br class='webkit-block-placeholder' />",Q="string",J="a",K='"',w="<span></span>",v="__Ey",y="CreateLink",x="__EF",s="<p style='",r="__Eo",u="__Ep",t="qx_link",q="none",p='"></span>',X="Italic",Y=" ",ba="InsertUnorderedList",bb="__Ex",T="body",U="OL",V='text-align:',W="Bold",bc="ForeColor",bd='" ',G='</p>',F="<hr />",E='<font style="',D="IMG",C='<p id="',B="JustifyRight",A="LI",z="__getHtml",I='>',H="__ED",be='" size="',bf="Indent",bg="__Em",bh="HiliteColor",bi="br",bj="Copy",bk="</span>",bl="__Ef",bm="Paste",bn="RemoveFormat",bB="StrikeThrough",bA='',bz='style="',by="JustifyCenter",bF="_moz_dirty",bE="color",bD="JustifyLeft",bC=' <a href="',bH="Underline",bG="SelectAll",bO="Cut",bP="__EC",bM="href",bN='<span id="',bK="UL",bL="JustifyFull",bI="Outdent",bJ="indent",bQ="selectall",bR="InsertOrderedList",cd="__EB";
qx.Class.define(S,{extend:qx.core.Object,construct:function(cI){qx.core.Object.call(this);
this.__DS=cI;
this.__nB=null;
this._commands=null;
this.__Ea();
...
this.__DV=0;
},statics:{__DW:"|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",__DX:"repeat repeat-x repeat-y no-repeat"},members:{__nB:null,__DS:null,__DY:false,__DT:null,__DU:null,__DV:null,setContentDocument:function(cJ){this.__nB=cJ;
},getCommandObject:function(cK){if(this._commands[cK]){return this._commands[cK];
}else{return null;
}},__Ea:function(){this._commands={bold:{useBuiltin:false,identifier:W,method:x},italic:{useBuiltin:false,identifier:X,method:R},underline:{useBuiltin:false,identifier:bH,method:O},strikethrough:{useBuiltin:false,identifier:bB,method:o},fontfamily:{useBuiltin:true,identifier:cG,method:null},fontsize:{useBuiltin:false,identifier:cv,method:bb},textcolor:{useBuiltin:true,identifier:bc,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:v},backgroundcolor:{useBuiltin:false,identifier:null,method:L},backgroundimage:{useBuiltin:false,identifier:null,method:cz},justifyleft:{useBuiltin:false,identifier:bD,method:cg},justifyright:{useBuiltin:false,identifier:B,method:cg},justifycenter:{useBuiltin:false,identifier:by,method:cg},justifyfull:{useBuiltin:false,identifier:bL,method:cg},indent:{useBuiltin:true,identifier:bf,method:null},outdent:{useBuiltin:true,identifier:bI,method:null},copy:{useBuiltin:true,identifier:bj,method:null},cut:{useBuiltin:true,identifier:bO,method:null},paste:{useBuiltin:true,identifier:bm,method:null},insertorderedlist:{useBuiltin:false,identifier:bR,method:b},insertunorderedlist:{useBuiltin:false,identifier:ba,method:b},inserthorizontalrule:{useBuiltin:false,identifier:bu,method:u},insertimage:{useBuiltin:false,identifier:cC,method:bg},inserthyperlink:{useBuiltin:false,identifier:y,method:r},selectall:{useBuiltin:false,identifier:bG,method:cd},selectedtext:{useBuiltin:false,identifier:null,method:bP},selectedhtml:{useBuiltin:false,identifier:null,method:H},inserthtml:{useBuiltin:false,identifier:bu,method:bl},resethtml:{useBuiltin:false,identifier:null,method:cH},gethtml:{useBuiltin:false,identifier:null,method:z},removeformat:{useBuiltin:true,identifier:bn,method:null}};
},execute:function(cL,cM){if(!this.__DS.isReady()){this.error("editor not ready! '"+cL+"':'"+cM+"'");
return false;
}cL=cL.toLowerCase();
cM=cM!=null?cM:null;
if(this._commands[cL]){var cN;
var cO=this._commands[cL];
if(!((qx.core.Environment.get(cn)==bS)&&(cL==bJ||cL==cE))){if(this.__Eb()){this.__Ec();
}}if(cO.useBuiltin){cN=this.__Ed(cO.identifier,false,cM);
}else{if(cO.method!=null&&this[cO.method]){cN=this[cO.method].call(this,cM,cO);
}else{this.error("The method '"+cO.method+"' you calling to execute the command '"+cL+"' is not available!");
}}this.__DS.resetSavedRange();
return cN;
}else{this.error("Command "+cL+" is currently not supported!");
}},__Eb:function(){var Node=qx.dom.Node;
var cP=this.__DS.getFocusNode();
var cS=false;
var cQ=false;

if(cP){if(Node.isText(cP)){var cR=qx.dom.Hierarchy.getAncestors(cP);

for(var i=0,j=cR.length;i<j;i++){if(Node.isNodeName(cR[i],bw)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(cR[i])){cS=true;
break;
}}}else if(Node.isNodeName(cP,T)){cQ=true;
}}return cQ||!cS;
},__Ec:function(){this.__Ed(g,false,bw);
},__Ed:function(cT,cU,cV){try{var cY=this.__nB;
var cW=false;
var cX=this.__DS.getRange();
this.__nB.body.focus();
if((qx.core.Environment.get(cn)==ck)){if(cT!=bQ){cX.select();
if(((cX.text)&&(cX.text.length>0))||((cX.length==1)&&(cX.item(0))&&(cX.item(0).tagName==D))){cY=cX;
}else{cY=this.__nB;
}}if(((qx.core.Environment.get(cn)==ck))&&(this.__DT[cT])){if(cX.text==cl){cW=true;
}}}var da=cY.execCommand(cT,cU,cV);

if(cW&&cX.text!=cl){cX.collapse();
}
if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cc)){this.debug("execCommand "+cT+" with value "+cV+" succeded");
}this.__DY=false;
}catch(db){if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cc)){this.debug("execCommand "+cT+" with value "+cV+" failed");
}return false;
}return da;
},__Ee:qx.core.Environment.select(cn,{"mshtml":function(){var dd=this.__DS;
var dc=dd.getSavedRange()!=null?dd.getSavedRange():dd.getRange();
return dc;
},"default":function(){return this.__DS.getRange();
}}),__Ef:qx.core.Environment.select(cn,{"mshtml":function(de,df){var di;
if(de==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__Ei();
}else{this.__nB.body.focus();
var dh=this.__DS.getSelection();
var dg=this.__Ee();
if(dg&&dh&&dh.type!=ca){try{dg.pasteHTML(de);
dg.collapse(false);
dg.select();
di=true;
}catch(e){}}else{di=false;
}this.__DS.resetSavedRange();
return di;
}},"default":function(dj,dk){this.__nB.body.focus();
return this.__nB.execCommand(dk.identifier,false,dj);
}}),insertParagraphOnLinebreak:qx.core.Environment.select(cn,{"gecko":function(){var dt=this.__Es();
var dx=this.__Eg(dt);
var dp=this.__Eq(dt);
var du=cy+Date.parse(new Date());
var dv=bY+Date.parse(new Date());
var dm=bA;
var dr=bN+du+p;
dm+=dr;
dm+=C+dv+bd+dx+I;
dm+=dp+G;
this.__DS.getCommandManager().addUndoStep(cj,h,this.getCommandObject(cj));
this.execute(cj,dm);
this.__Eh();
qx.bom.element.Attribute.reset(this.__nB.getElementById(du),bv);
var ds=this.__nB.getElementById(dv);

if(ds.previousSibling.innerHTML==dr){var dl=this.__Er();
var dq=this.__nB.createElement(bi);
var dn=this.__nB.createAttribute(bF);
dn.nodeValue=cl;
dq.setAttributeNode(dn);
var dw=this.__nB.createAttribute(cB);
dw.nodeValue=f;
dq.setAttributeNode(dw);
ds.previousSibling.appendChild(dl);
ds.previousSibling.appendChild(dq);
}qx.bom.element.Attribute.reset(ds,bv);
return true;
},"webkit":function(){var dy=this.getCurrentStyles();
var dz=cl;
var dB={"background-color":true,"text-align":true};
for(var dA in dy){if(dB[dA]){dz+=dA+cx+dy[dA]+bX;
}}this.__DS.insertHtml(s+dz+P);
},"default":qx.lang.Function.empty}),__Eg:qx.core.Environment.select(cn,{"gecko":function(dC){var dH=bz;
var dG=dC.child;
if(dG[bp]){dH+=V+dG[bp]+cf;
delete dC.child[bp];
}if(dG[bq]){dH+=cF+dG[bq]+cf;
delete dC.child[bq];
}var dF={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};
var dD={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};

for(var dE in dG){if(dF[dE]||dD[dE]){dH+=dE+cr+dG[dE]+cf;
delete dC.child[dE];
}}dH+=K;
return dH;
},"default":function(){return cl;
}}),__Eh:qx.core.Environment.select(cn,{"gecko":function(){var dP=this.__DS.getSelection();

if(!dP||!dP.focusNode){return;
}var dI=dP.focusNode;
var dN=dP.focusNode;

while(!qx.dom.Node.isNodeName(dN,bw)){dN=dN.parentNode;
}var dM=dN.previousSibling.id;
var dQ=dN.nextSibling?dN.nextSibling.id:null;

if(qx.lang.String.startsWith(dM,bY)&&dM==dQ){var dO=dN.nextSibling;
var dK=this.__DS.getRange();
dK.selectNode(dO);
dP.addRange(dK);
var dJ=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;
this.__DS.getCommandManager().addUndoStep(cj,dJ,this.getCommandObject(cj));
this.execute(cj,dJ);
var dL=this.__DS.getRange();

if(dI){while(dI&&dI.firstChild&&qx.dom.Node.isElement(dI.firstChild)){dI=dI.firstChild;
}}dL.selectNode(dI);
dP.addRange(dL);
dL.collapse(true);
}},"default":qx.lang.Function.empty}),__Ei:qx.core.Environment.select(cn,{"mshtml":function(){var dR=this.__DS.getRange();
if(dR&&!qx.dom.Node.isNodeName(dR.parentElement(),m)){dR.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);
dR.collapse(false);
dR.select();
return true;
}return false;
},"default":function(){return false;
}}),__Ej:function(dS,dT){var dU=(qx.core.Environment.get(cn)==ck)?this.__DS.getRange():this.__nB;
return dU.execCommand(dT.identifier,false,dS);
},__Ek:function(dV,dW){if((qx.core.Environment.get(cn)==ck)){var dX=this.__DS.getFocusNode();
this.__El(dX);
}this.__nB.body.focus();
var dY=this.__nB.execCommand(dW.identifier,false,dV);

if((qx.core.Environment.get(cn)==bS)){var dX=this.__DS.getFocusNode();
this.__El(dX.parentNode);
}return dY;
},__El:function(ea){var eb=[];
var parent=ea.parentNode;

while(qx.dom.Node.isNodeName(parent,N)){eb.push(parent);
parent=parent.parentNode;
}if(eb.length>0){parent.appendChild(ea);
parent.removeChild(eb[eb.length-1]);
}},__Em:qx.core.Environment.select(cn,{"gecko":function(ec,ed){if(ec.src){this.__nB.execCommand(ed.identifier,false,ec.src);
delete ec.src;
var eq=this.__DS.getSelection();
if(eq){var ep=eq.anchorNode;
var ek=eq.anchorOffset;
var eh=ep.childNodes[ek-1];
var en;

for(var ej in ec){en=this.__nB.createAttribute(ej);
en.nodeValue=ec[ej];
eh.setAttributeNode(en);
}var ei={"font":true,"span":true};
var ef=null;
var em=true;
if(qx.dom.Node.isElement(eh.previousSibling)&&ei[qx.dom.Node.getName(eh.previousSibling)]){ef=eh.previousSibling;
}else if(ei[qx.dom.Node.getName(eh.parentNode)]){ef=eh.parentNode;
em=false;
}var eg=this.__nB.createDocumentFragment();
var er;

if(em&&ef!=null){var ei=this.__En(ef);
eg.appendChild(ei.root);
er=ei.inline;
}else{er=this.__nB.createElement(ce);
eg.appendChild(er);
}var eo=this.__nB.createTextNode(cl);
er.appendChild(eo);
var el=eh.parentNode;
if(eh==el.lastChild){el.appendChild(eg);
}else{el.insertBefore(eg,eh.nextSibling);
}var ee=this.__DS.getRange();
ee.selectNodeContents(er);
}return true;
}else{return false;
}},"mshtml":function(es,et){var ey=false;
var ez=bU;

for(var eu in es){ez+=eu+bV+es[eu]+bT;
}ez+=ct;
var ev=this.__DS.getSelection();
var ew=this.__Ee();
if(ev&&ev.type!=ca){try{ew.select();
ew.pasteHTML(ez);
ey=true;
}catch(e){}}this.__DS.resetSavedRange();
return ey;
},"default":function(eA,eB){if(eA.src){var eD=bU;

for(var eC in eA){eD+=eC+bV+eA[eC]+bT;
}eD+=ct;
return this.__nB.execCommand(bu,false,eD);
}else{return false;
}}}),__En:function(eE){while(eE.firstChild&&eE.firstChild.nodeType==1){eE=eE.firstChild;
}var eI=this.__Es(eE);
var eM,eG,eK;
var eF=cl;
var parent=null;
...
while(eJ){eL=this.__nB.createElement(eJ[cm]?cw:ce);
eG=this.__nB.createAttribute(M);
eL.setAttributeNode(eG);
for(var eH in eJ){if(eH!=bs&&eH!=cm){eF+=eH+cx+eJ[eH]+bX;
}else if(eH==cm){eK=this.__nB.createAttribute(cb);
eK.nodeValue=eJ[eH];
eL.setAttributeNode(eK);
}}eG.nodeValue=eF;
...
eJ=eJ.child;
eF=cl;
}return {root:eM,inline:eL};
},__Eo:qx.core.Environment.select(cn,{"gecko|opera":function(eN,eO){var eU=this.__DS.getSelection();
var eR=this.__DS.getRange();
if(eU.isCollapsed){var eQ=t+(++this.__DV);
var eV=this.__nB.createElement(J);
var eS=this.__nB.createAttribute(bM);
var eP=this.__nB.createAttribute(bv);
var eT=this.__nB.createTextNode(eN);
eP.nodeValue=eQ;
eV.setAttributeNode(eP);
eS.nodeValue=eN;
eV.setAttributeNode(eS);
eV.appendChild(eT);
eR.insertNode(eV);
eR.selectNode(eV);
eU.collapseToEnd();
return true;
}else{return this.__nB.execCommand(eO.identifier,false,eN);
}},"mshtml":function(eW,eX){try{var fa;
var eY=this.__Ee();
var fb=this.__DS;
var eY=fb.getSavedRange()!=null?fb.getSavedRange():fb.getRange();

if(eY!=null&&eY.text!=cl){fa=eY.execCommand(eX.identifier,false,eW);
}else{fa=this.__Ef(bC+eW+bt+eW+cD,eX);
}this.__DS.resetSavedRange();
return fa;
}catch(e){if(qx.core.Environment.get(cs)){this.error("inserthyperlink failed!");
}return false;
}},"default":function(fc,fd){return this.__nB.execCommand(fd.identifier,false,fc);
}}),__Ep:function(fe,ff){var fg=F;
if((qx.core.Environment.get(cn)==br)){fg+=this.__Eq();
}return this.__Ef(fg,ff);
},__Eq:function(fh){var fl=cl;
var fk=n;
var fj=[];
var fo=typeof fh!==c?fh:this.__Es();
var fm=fo.child;
var fn=false;
if(qx.lang.Object.isEmpty(fm)){return cl;
}
while(fm){fn=fm[cm]!=null;
fl+=fn?E:fk;

for(var fi in fm){fl+=(fi!=bs&&fi!=cm)?fi+cr+fm[fi]+cf:cl;
}fl+=fn?be+fm[cm]+bt:bt;
fj.unshift(fn?cq:bk);
fm=fm.child;
}if(fj.length==1&&fj[0]==cq){fl+=w;
}for(var i=0,j=fj.length;i<j;i++){fl+=fj[i];
}return fl;
},__Er:function(){var fq=this.__nB.createDocumentFragment();
var fv=this.__Es();
var parent=fq;
var ft=fv.child;
var fr;
...
while(ft){fu=ft[cm]!=null;
fr=this.__nB.createElement(fu?cw:ce);
parent.appendChild(fr);
for(var fp in ft){if(fp!=bs&&fp!=cm){qx.bom.element.Style.set(fr,fp,ft[fp]);
}}
if(fu){var fs=this.__nB.createAttribute(cb);
fs.nodeValue=ft[cm];
fr.setAttributeNode(fs);
}parent=fr;
ft=ft.child;
}return fq;
},__Es:function(fw){var fy={};
var fz=null;
var fA=this.getCurrentStyles(fw);
fz=fy.child={};

for(var fx in fA){if(fx!=ch){fz[fx]=fA[fx];
}}if(fA[ch]){var fB=fA[ch];
for(var i=0,j=fB.length;i<j;i++){if(fz==null){fz=fy.child={};
}else{fz=fz.child={};
}fz[ci]=fB[i][ci];
fz[bo]=fB[i][bo];
}}if(fA[ci]&&fA[bo]){fz=fz.child={};
fz[ci]=fA[ci];
}return fy;
},getCurrentStyles:function(fC){if(fC==null){var fE=this.__DS.getSelection();

if(!fE||fE.focusNode==null){return {};
}fC=(fE.focusNode.nodeType==3)?fE.focusNode.parentNode:fE.focusNode;
}var fF=qx.dom.Hierarchy.getAncestors(fC);
var fH=qx.lang.Array.insertBefore(fF,fC,fF[0]);
var fD=this.__Et(fH);
var fG=this.__Eu(fD,fH);
return fG;
},__Et:function(fI){var fL={};
var fJ,fK;

for(var i=0,j=fI.length;i<j;i++){fK=fI[i];

for(var k=0,l=fK.style.length;k<l;k++){fJ=fK.style[k];

if(fJ.length>0&&typeof fL[fJ]===c){fL[fJ]=fK.style.getPropertyValue(fJ);
}}if(fK.tagName.toUpperCase()==cA&&fK.size&&fL[cm]===undefined){fL[cm]=fK.size;
}}if(fL[cm]&&fL[co]){delete fL[co];
}return fL;
},__Eu:function(fM,fN){var fS=fN[0];
var fQ=this.__DS.getContentWindow().getComputedStyle(fS,null);
var fO;
var fR={};

for(var fP in fM){if(fP!=cm){fO=fQ.getPropertyValue(fP);
}else{fO=fM[fP];
}if(fP==cp&&fO==bx){fR[fP]=this.__Ew(fN);
}else if(fP==ch){fR[fP]=this.__Ev(fN);
}else{fR[fP]=fO;
}}return fR;
},__Ev:function(fT){var fW,fY,fU;
var fX=[];
var fV=this.__DS.getContentWindow();

for(var i=0,j=fT.length;i<j;i++){fU=fV.getComputedStyle(fT[i],null);
fW=fU.getPropertyValue(ch);
fY=fU.getPropertyValue(bE);
if(fW!=q){fX.push({'text-decoration':fW,'color':fY});
}}return fX;
},__Ew:function(ga){var gc,gb,gd;

for(var i=0;i<ga.length;i++){gc=ga[i];
gb=this.__DS.getContentWindow().getComputedStyle(gc,null);
gd=gb.getPropertyValue(cp);
if(gd!=bx){return gd;
}}},__Ex:function(ge,gf){var gr=this.__DS.getSelection();
var gm=((qx.core.Environment.get(cn)==ck))?this.__DS.getRange():gm=gr.getRangeAt(0);
var gn=[];
var gq;
var gl=[U,bK];
var gg,i,j,go;
go=((qx.core.Environment.get(cn)==ck))?gm.parentElement():gm.commonAncestorContainer;
if(go.tagName==a){for(var i=0;i<gl.length;i++){gg=go.getElementsByTagName(gl[i]);

for(var j=0;j<gg.length;j++){if(gg[j]){gn.push(gg[j]);
}}}}else if(qx.lang.Array.contains(gl,go.tagName)){gn.push(go);
}
if(gn.length>0){for(var i=0;i<gn.length;i++){var gi=gn[i];
gq=((qx.core.Environment.get(cn)==ck))?((gi==go)||(go.tagName==a)):gr.containsNode(gi,false);
for(j=0;j<gi.childNodes.length;j++){var gk=gi.childNodes[j];
if(gq||(gr.focusNode.nodeValue&&qx.dom.Hierarchy.contains(gk,gr.focusNode)&&(gr.focusOffset==gr.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(gk,gr.anchorNode)&&(gr.anchorOffset==0))||(gr.containsNode(gk,false))){gk.style.fontSize=(this.__DU[ge]||ge)+bW;
}}}}else{var gj=((qx.core.Environment.get(cn)==ck))?go:gr.focusNode;
var gp=qx.dom.Hierarchy.getAncestors(gj);

for(i=0;i<gp.length;i++){if(gp[i].tagName==A){if((((qx.core.Environment.get(cn)==br))&&((gr.anchorOffset==0)&&(gr.focusNode.nodeValue&&(gr.focusOffset==gr.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(gp[i].firstChild,gr.anchorNode)&&qx.dom.Hierarchy.contains(gp[i].lastChild,gr.focusNode)))||(((qx.core.Environment.get(cn)==ck))&&(gm.htmlText==gp[i].innerHTML))){gp[i].style.fontSize=(this.__DU[ge]||ge)+bW;
}break;
}}}if((qx.core.Environment.get(cn)==ck)){this.__nB.body.focus();
this.__DS.getRange().select();
return this.__nB.execCommand(cv,false,ge);
}else if((qx.core.Environment.get(cn)==br)){var parent=gm.commonAncestorContainer;
if(parent.nodeType===1){var gh=parent.getElementsByTagName(ce);

for(i=0;i<gh.length;i++){if(gh[i].style.fontSize){gh[i].style.fontSize=null;
}}}}return this.__nB.execCommand(cv,false,ge);
},__Ey:qx.core.Environment.select(cn,{"mshtml":function(gs,gt){this.__nB.body.focus();
return this.__nB.execCommand(cu,false,gs);
},"gecko|opera":function(gu,gv){this.__nB.body.focus();
return this.__nB.execCommand(bh,false,gu);
},"webkit":function(gw,gx){var gy=this.__DS.getSelection();
var gz=this.__DS.getRange();
if(!gy||!gy.isCollapsed){this.__nB.body.focus();
this.__nB.execCommand(cu,false,gw);
if(gy){gy.collapseToEnd();
}return true;
}else{var gB=gy.anchorOffset;
var gC=gy.anchorOffset;
var gz=gy.getRangeAt(0);
var gA=gy.anchorNode;
while(gC>0){if(gA.nodeValue.charCodeAt(gC)==160||gA.nodeValue.charCodeAt(gC)==32){break;
}else{gC--;
}}while(gB<gA.nodeValue.length){if(gA.nodeValue.charCodeAt(gB)==160||gA.nodeValue.charCodeAt(gB)==32){break;
}else{gB++;
}}gz.setStart(gy.anchorNode,gy.anchorNode.nodeValue.charAt(gC)==Y?gC+1:gC);
gz.setEnd(gy.anchorNode,gB);
gy.addRange(gz);
this.__nB.body.focus();
this.__nB.execCommand(cu,false,gw);
gy.collapseToEnd();
return true;
}}}),__Ez:function(gD,gE){gD=gD!=null&&typeof gD==Q?gD:bx;
qx.bom.element.Style.set(this.__nB.body,d,gD);
return true;
},__EA:function(gF,gG){var gH,gJ,gI;
var gK=qx.bom.htmlarea.manager.Command;

if(gF==null){gH=null;
}else{gH=gF[0];
gJ=gF[1];
gI=gF[2];
}if(gH==null||typeof gH!="string"){qx.bom.element.Style.set(this.__nB.body,"backgroundImage","");
qx.bom.element.Style.set(this.__nB.body,"backgroundRepeat","");
qx.bom.element.Style.set(this.__nB.body,"backgroundPosition","");
return true;
}else{if(gH.search(/^url.*\(/)==-1){gH="url("+gH+")";
}}if(gJ!=null&&!qx.lang.String.contains(gK.__DX,gJ)){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+gJ+"' is not allowed for parameter 'repeat'. Possible values are '"+gK.__DX+"'");
}return false;
}else{gJ="no-repeat";
}
if(gI!=null){if(qx.lang.Type.isString(gI)&&!qx.lang.String.contains(gK.__DW,'|'+gI+'|')){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+gI+"' is not allowed for parameter 'position'. Possible values are '"+gK.__DW+"'");
}return false;
}else{if(qx.lang.Type.isArray(gI)&&gI.length==2){gI=gI[0]+" "+gI[1];
}else{if(qx.core.Environment.get("qx.debug")){this.error("If an array is provided for parameter 'position' it has to define two elements!");
}return false;
}}}else{gI="top";
}qx.bom.element.Style.set(this.__nB.body,"backgroundImage",gH);
qx.bom.element.Style.set(this.__nB.body,"backgroundRepeat",gJ);
qx.bom.element.Style.set(this.__nB.body,"backgroundPosition",gI);
return true;
},__EB:qx.core.Environment.select("engine.name",{"mshtml":function(gL,gM){var gN=this.__nB.body.createTextRange();
gN.select();
return true;
},"default":function(gO,gP){return this.__Ed(gP.identifier,false,gO);
}}),__EC:function(){return this.__DS.getSelectedText();
},__ED:function(){return this.__DS.getSelectedHtml();
},__EE:function(gQ,gR){var gV=this.__DS.getFocusNode();

if(gV.textContent==""){var gT=qx.dom.Hierarchy.getAncestors(gV);
gT.unshift(gV);
var Node=qx.dom.Node;
var gS=qx.bom.element.Style;
var gU=gT.shift();

while(gT.length>0){if(Node.getName(gU)=="p"||Node.getName(gU)=="body"){break;
}if(gS.get(gU,gQ,gS.LOCAL_MODE)==gR){gS.reset(gU,gQ);
return true;
}gU=gT.shift();
}}return false;
},__EF:qx.core.Environment.select("engine.name",{"gecko":function(gW,gX){if(this.__EE("fontWeight","bold")){return true;
}else{return this.__Ed(gX.identifier,false,gW);
}},"default":function(gY,ha){return this.__Ed(ha.identifier,false,gY);
}}),__EG:qx.core.Environment.select("engine.name",{"gecko":function(hb,hc){if(this.__EE("fontStyle","italic")){return true;
}else{return this.__Ed(hc.identifier,false,hb);
}},"default":function(hd,he){return this.__Ed(he.identifier,false,hd);
}}),__EH:qx.core.Environment.select("engine.name",{"gecko":function(hf,hg){if(this.__EE("textDecoration","underline")){return true;
}else{return this.__Ed(hg.identifier,false,hf);
}},"default":function(hh,hi){return this.__Ed(hi.identifier,false,hh);
}}),__EI:qx.core.Environment.select("engine.name",{"gecko":function(hj,hk){if(this.__EE("textDecoration","line-through")){return true;
}else{return this.__Ed(hk.identifier,false,hj);
}},"default":function(hl,hm){return this.__Ed(hm.identifier,false,hl);
}})},destruct:function(){this.__nB=this.__DS=this._commands=null;
this.__DT=this.__DU=null;
}});
})();
(function(){var m="engine.name",l="Command",k="mshtml",h="Custom",g="Content",f="Internal",d="gecko",c="qx.debug",b="webkit",a="mousedown",bg="backgroundcolor",bf="backgroundimage",be="table",bd="td",bc="img",bb="p",ba="mouseup",Y="keypress",X="qx.bom.htmlarea.HtmlArea.debug",W="inserthtml",t="undo",u="backgroundColor",r="pageup",s="b",p="shift",q="end",n="insertorderedlist",o="control",x="insertunorderedlist",y="Undo",G="pagedown",E="__CY",N="home",I="backgroundImage",S="backgroundRepeat",Q="a",A="y",V="backgroundPosition",U="justifyright",T="redo",z="k",C="qx.bom.htmlarea.manager.UndoRedo",D="left",F="i",H="Redo",J="u",O="inserthyperlink",R="right",v="enter",w="insertimage",B="z",M="undoRedoState",L="down",K="up",P="body";
qx.Class.define(C,{extend:qx.core.Object,construct:function(bh,bi){qx.core.Object.call(this);
this.__CY=bh;
this.__DS=bi;
this.__EJ=[];
this.__EK=[];
...
}},members:{__EQ:false,__ER:false,__ES:false,__EM:null,__EL:null,__CY:null,__nB:null,__EJ:null,__EK:null,__DS:null,__EN:null,__EO:null,__EP:null,__ET:null,setContentDocument:function(bj){this.__nB=bj;
this.__CY.setContentDocument(bj);
qx.event.Registration.addListener(bj.body,Y,this.__EN,this);
qx.event.Registration.addListener(bj.body,ba,this.__EO,this);

if((qx.core.Environment.get(m)==k)){qx.event.Registration.addListener(bj.body,a,this.__EP,this,true);
}},insertParagraphOnLinebreak:function(){return this.__CY.insertParagraphOnLinebreak();
},execute:function(bk,bl){var bm;
bk=bk.toLowerCase();
if(this._commands[bk]){if(this._commands[bk].passthrough){bm=this.__CY.execute(bk,bl);
}else{bm=this[bk].call(this);
}}else{if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==b)){this.__Fl(bk,bl,this.__CY.getCommandObject(bk));
bm=this.__CY.execute(bk,bl);
if(!bm){this.__EJ.pop();
}}else{bm=this.__CY.execute(bk,bl);

if(bm){this.__Fl(bk,bl,this.__CY.getCommandObject(bk));
}}
if(bk==t&&this.__EJ.length==0){this.__ER=false;
this.__Ft();
}else if(bk==T&&this.__EK.length==0){this.__EQ=false;
this.__Ft();
}}this.__ES=false;
return bm;
},addUndoStep:function(bn,bo,bp){this.__Fl(bn,bo,bp);
},registerHandler:function(bq,br,bs,bt){this.__EL[bq]={undo:br,redo:bs,context:bt};
},isUndoPossible:function(){return this.__ER;
},undo:function(){var bw;

if(this.__ES){this.__Fn();
}if(this.__EJ.length>0){var bv=this.__EJ.pop();

if(this.__EM[bv.actionType.toLowerCase()]){switch(bv.actionType){case l:bw=this.__EV(bv);
break;
case g:bw=this.__Fa(bv);
break;
case f:bw=this.__EY(bv);
break;
case h:bw=this.__EU(bv);
break;
}}else if(this.__EL[bv.actionType]){var bu=this.__EL[bv.actionType];
bw=bu.undo.call(bu.context?bu.context:this,bv);
this.__Fp(bv);
}else{this.error("actionType "+bv.actionType+" is not managed! Please provide a handler method!");
}this.__EQ=true;
this.__Ft();
return bw;
}},__EU:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bx){var by=this.__nB.body.innerHTML;
var bA=bx.content;
this.__nB.body.innerHTML=bA;
var bz=bx;
bz.content=by;
this.__Fp(bz);
return true;
},"default":function(bB){var bF=bB;
var bE=qx.bom.element.Style;
switch(bB.command){case "backgroundcolor":bF.parameter=[bE.get(this.__nB.body,"backgroundColor")];
break;
case "backgroundimage":bF.parameter=[bE.get(this.__nB.body,"backgroundImage"),bE.get(this.__nB.body,"backgroundRepeat"),bE.get(this.__nB.body,"backgroundPosition")];
break;
}this.__Fp(bF);
if(bB.command=="inserthyperlink"){if((qx.core.Environment.get("engine.name")=="gecko")){var bD="qx_link"+this.__CY.__hyperLinkId;
var bC=this.__nB.getElementById(bD);

if(bC){bC.parentNode.removeChild(bC);
return true;
}else{return false;
}}}else{return this.__CY.execute(bB.command,bB.value);
}}}),__EV:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(bG){},"default":function(bH){this.__Fp(bH);

if((qx.core.Environment.get("engine.name")=="gecko")){if(bH.command=="inserthtml"&&bH.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__EW("inserthtml","insertParagraph")){this.__EX();
}}return this.__Fb();
}}),__EW:function(bI,bJ){if(this.__EJ.length>0){var bK=this.__EJ[this.__EJ.length-1];
return (bK.command==bI&&bK.value==bJ);
}return false;
},__EX:function(){this.__Fb();

if(this.__EJ.length>0){var bL=this.__EJ.pop();
this.__Fp(bL);
}},__EY:function(bM){this.__Fp(bM);
return this.__Fb();
},__Fa:qx.core.Environment.select(m,{"gecko":function(bN){this.__Fp(bN);

try{return this.__Fb();
}catch(bO){if(qx.core.Environment.get(c)){this.error("execCommand failed! Details: "+bO);
}}},"mshtml|webkit":function(bP){},"default":function(bQ){this.__Fp(bQ);
return this.__Fb();
}}),__Fb:function(){try{return this.__nB.execCommand(y,false,null);
}catch(e){return false;
}},isRedoPossible:function(){return this.__EQ;
},redo:function(){if(this.__EQ){var bS;
if(this.__EK.length>0){var bT=this.__EK.pop();

if(this.__EM[bT.actionType.toLowerCase()]){switch(bT.actionType){case l:bS=this.__Fd(bT);
break;
case g:bS=this.__Fj(bT);
break;
case f:bS=this.__Fi(bT);
break;
case h:bS=this.__Fc(bT);
break;
}}else if(this.__EL[bT.actionType]){var bR=this.__EL[bT.actionType];
bS=bR.redo.call(bR.context?bR.context:this,bT);
this.__Fo(bT);
}else{this.error("actionType "+bT.actionType+" is not managed! Please provide a handler method!");
}this.__ER=true;
this.__Ft();
}return bS;
}},__Fc:qx.core.Environment.select(m,{"mshtml|webkit":function(bU){var bV=this.__nB.body.innerHTML;
var bX=bU.content;
this.__nB.body.innerHTML=bX;
var bW=bU;
bW.content=bV;
this.__Fo(bW);
return true;
},"default":function(bY){this.__Fo(bY);
return this.__Fk();
}}),__Fd:qx.core.Environment.select(m,{"mshtml|webkit":function(ca){},"default":function(cb){this.__Fo(cb);
var cc=this.__Fk();

if((qx.core.Environment.get(m)==d)){if(this.__Fe(W,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cd=this.__Ff();
this.__Fg();

if(cd!=null){this.__Fh(cd);
}}}return cc;
}}),__Fe:function(ce,cf){if(this.__EK.length>0){var cg=this.__EK[this.__EK.length-1];
return (cg.command==ce&&cg.value==cf);
}return false;
},__Ff:function(){if(this.__DS==null){return null;
}var ch=this.__DS.getSelection();
var ci=ch?ch.focusNode:null;

if(ci==null){return null;
}
try{while(ci.nodeName.toLowerCase()!=bb){ci=ci.parentNode;

if(!ci||qx.dom.Node.isNodeName(ci,P)){return null;
}}}catch(cj){return null;
}
if(ci!=null&&qx.dom.Node.isNodeName(ci,bb)){return ci;
}else{return null;
}},__Fg:function(){var ck=this.__EK.pop();
this.__Fo(ck);
this.__Fk();
},__Fh:qx.core.Environment.select(m,{"gecko":function(cl){if(cl==this.__DS.getContentBody().lastChild){return;
}var co=cl.firstChild;

while(co.firstChild){co=co.firstChild;
}var cm=this.__DS.getSelection();
var cn=this.__DS.getRange();

if(cm&&cn){cn.selectNode(co);
cm.addRange(cn);
cn.collapse(true);
}},"default":qx.lang.Function.empty}),__Fi:function(cp){this.__Fo(cp);
return this.__Fk();
},__Fj:qx.core.Environment.select(m,{"mshtml|webkit":function(cq){},"default":function(cr){this.__Fo(cr);
return this.__Fk();
}}),__Fk:function(){try{return this.__nB.execCommand(H,false,null);
}catch(e){return false;
}},__Ea:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};
this.__CY.getCommandObject(bg).customUndo=true;
this.__CY.getCommandObject(bf).customUndo=true;

if((qx.core.Environment.get(m)==d)){}},__Fl:qx.core.Environment.select(m,{"mshtml|webkit":function(cs,ct,cu){var cv=this.getUndoRedoObject();
cv.commandObject=cu;
cv.command=cs;
cv.value=ct;
cv.actionType=h;
cv.content=this.__nB.body.innerHTML;
this.__Fm(cv);
},"default":function(cw,cx,cy){if(this.__DS==null){return;
}var cA=this.getUndoRedoObject();
cA.commandObject=cy;
cA.command=cw;
cA.value=cx;
cA.actionType=h;
var cz=this.__DS.getSelection();

if(cy.customUndo){var cB=[];

switch(cw){case bg:cB.push(qx.bom.element.Style.get(this.__nB.body,u));
break;
case bf:cB.push(qx.bom.element.Style.get(this.__nB.body,I),qx.bom.element.Style.get(this.__nB.body,S),qx.bom.element.Style.get(this.__nB.body,V));
break;
case O:if(cz&&!cz.isCollapsed){cA.actionType=l;
}break;
}cA.parameter=cB;
}else{if((qx.core.Environment.get(m)==d)){if(cz&&cz.isCollapsed){switch(cw){case n:case x:case U:case W:case w:cA.actionType=l;
break;
default:return;
}}else{cA.actionType=l;
}}else{cA.actionType=l;
}}this.__Fm(cA);
}}),__Fm:function(cC){if(this.__ES){this.__Fn();
}this.__Fo(cC);
this.__EQ=false;
this.__EK=[];
this.__Ft();
},__Fn:function(){var cD=this.__EJ[this.__EJ.length-1];

if(cD==null||cD.actionType!=g){var cE=this.getUndoRedoObject();
cE.actionType=g;

if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==b)){cE.content=this.__ET;
cE.actionType=h;
this.__ET=null;
}this.__Fo(cE);
this.__ES=false;
...
},__Fo:function(cF){if((qx.core.Environment.get(c))&&qx.core.Environment.get(X)){this.debug("ADD TO UNDO STACK");
this.debug(cF.actionType+" "+cF.command+" "+cF.value);
}this.__EJ.push(cF);
},__Fp:function(cG){if((qx.core.Environment.get(c))&&qx.core.Environment.get(X)){this.debug("ADD TO REDO STACK");
...
switch(cH){case o:case p:case D:case R:case K:case L:case r:case G:case N:case q:case v:break;
case Q:case s:case F:case J:case z:case A:case B:if(!cI){this.__Fq();
}break;
...
this.__ER=true;
if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==b)){this.__ET=this.__nB.body.innerHTML;
}this.__Ft();
}},__Fr:null,_handleMouseDown:qx.core.Environment.select(m,{"mshtml":function(e){var cJ=e.getOriginalTarget();

if(qx.dom.Node.isElement(cJ)&&(qx.dom.Node.isNodeName(cJ,bc)||qx.dom.Node.isNodeName(cJ,be))){this.__Fr={node:cJ,content:cJ.outerHTML};
}else{this.__Fr=null;
...
if(!cL){this.__Fr=null;
return;
}var cK=cL.anchorNode;
var cM=cK.childNodes[cL.anchorOffset];
if(qx.dom.Node.isNodeName(cM,bc)){if(this.__Fr==null){this.__Fr=cM.cloneNode(true);
}else{if(this.__Fr.style.width!=cM.style.width||this.__Fr.style.height!=cM.style.height){this.__Fs();
this.__Fr=cM.cloneNode(true);
}}}else if(qx.dom.Node.isNodeName(cK,bd)||qx.dom.Node.isNodeName(cK.parentNode,bd)){var cN=cK.parentNode;

while(qx.dom.Node.isNodeName(cN,be)){cN=cN.parentNode;
}if(this.__Fr==null){this.__Fr=cN.cloneNode(true);
}else{qx.event.Timer.once(function(){if(cN.style.width!=this.__Fr.style.width||cN.style.height!=this.__Fr.style.height||cN.innerHTML!=this.__Fr.innerHTML){this.__Fs();
this.__Fr=cN.cloneNode(true);
}},this,0);
}}else{this.__Fr=null;
}},"default":function(e){var cO=qx.bom.Event.getTarget(e);

if(this.__Fr!=null){if(cO.nodeType==1){if(cO==this.__Fr.node){if(cO.outerHTML!=this.__Fr.content){this.__Fr.content=cO.outerHTML;
this.__Fs();
}}else{for(var i=0,j=cO.childNodes.length;i<j;i++){if(cO.childNodes[i]==this.__Fr.node){if(cO.childNodes[i].outerHTML!=this.__Fr.content){this.__Fr.content=cO.childNodes[i].outerHTML;
this.__Fs();
}}}}}else{this.__Fr=null;
}}}}),__Fs:qx.core.Environment.select(m,{"mshtml|webkit":function(){this.__Fl(f,null,null);
},"default":function(){var cP=this.getUndoRedoObject();
cP.actionType=f;
this.__Fo(cP);
}}),__Ft:function(){qx.event.Timer.once(function(e){if(this.__DS!=null){var cQ={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};
this.__DS.fireDataEvent(M,cQ);
}},this,200);
...
if((qx.core.Environment.get(m)==k)){qx.event.Registration.removeListener(this.__nB,a,this.__EP);
...
this.__bk=bk.left===undefined?0:bk.left;
this.__bj=bk.top===undefined?0:bk.top;
...
this.__bk=bl.left===undefined?0:bl.left;
this.__bj=bl.top===undefined?0:bl.top;
this.removeState(c);
this.hide();
this.fireEvent(z);
...
(function(){var v="keypress",u="qx.debug",t="interval",s="keydown",r="mousedown",q="keyup",p="__np",o="blur",n="Enter",m="__og",d="Up",l="__of",h="Escape",c="event.touch",b="qx.ui.menu.Manager",g="Left",f="Down",j="Right",a="singleton",k="Space";
qx.Class.define(b,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__np=[];
var w=document.body;
...
},members:{__oh:null,__oi:null,__of:null,__og:null,__np:null,_getChild:function(y,z,A,B){var C=y.getChildren();
var length=C.length;
var D;
...
}},hideAll:function(){var K=this.__np;

if(K){for(var i=K.length-1;i>=0;i--){K[i].exclude();
}}},getActiveMenu:function(){var L=this.__np;
return L.length>0?L[L.length-1]:null;
},scheduleOpen:function(M){this.cancelClose(M);
if(M.isVisible()){if(this.__oh){this.cancelOpen(this.__oh);
}}else if(this.__oh!=M){this.__oh=M;
this.__of.restartWith(M.getOpenInterval());
}},scheduleClose:function(N){this.cancelOpen(N);
if(!N.isVisible()){if(this.__oi){this.cancelClose(this.__oi);
}}else if(this.__oi!=N){this.__oi=N;
this.__og.restartWith(N.getCloseInterval());
}},cancelOpen:function(O){if(this.__oh==O){this.__of.stop();
this.__oh=null;
}},cancelClose:function(P){if(this.__oi==P){this.__og.stop();
this.__oi=null;
...
}if(this.__np.length>0&&!this._isInMenu(Q)){this.hideAll();
}},__oj:{"Enter":1,"Space":1},__ok:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var R=this.getActiveMenu();

if(!R){return;
}var S=e.getKeyIdentifier();

if(this.__ok[S]||(this.__oj[S]&&R.getSelectedButton())){e.stopPropagation();
...
}},__ra:function(z){while(!(z instanceof qx.ui.menu.Menu)){z=z.getLayoutParent();
}return z;
