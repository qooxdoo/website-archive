...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.Fingers","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.Fingers-qx.theme.Modern.27bb39f68eb7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="demobrowser.demo.mobile.Fingers",b="os.name",a="engine.version";
...
(function(){var l="px",k="div",j="50px",h="absolute",g="green",f="100%",d="30px",c="100px",b="innerHTML",a="20px",D="white",C="touchmove",B="black",A="yellow",z="qx.debug",y="0px",x="12px",w="event.touch",v="demobrowser.demo.mobile.Fingers",u='Lucida Grande',s="qx.mobile.emulatetouch",t="touchstart",q="engine.name",r="red",o="webkit",p="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",m="<b>Use your fingers to move the dots</b>",n="blue";
qx.Class.define(v,{extend:qx.application.Native,members:{__Mi:null,__Mj:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(z)){qx.log.appender.Native;
qx.log.appender.Console;
}var G={"width":f,"height":f,"backgroundColor":B,"margin":y};
var L=new qx.html.Element(k,G);
L.useElement(document.body);
L.setRoot(true);

if(qx.core.Environment.get(q)!=o||(!qx.core.Environment.get(w)&&qx.core.Environment.get(s)==false)){var J={"color":g,"position":h,"font-family":u,"font-size":x,"left":d,"top":a};
var H=new qx.html.Element(k,J);
L.add(H);
H.setAttribute(b,p);
return;
}var F={"color":D,"position":h,"left":d,"top":a};
var H=new qx.html.Element(k,F);
L.add(H);
H.setAttribute(b,m);
var I=[n,r,g,D,A];

for(var i=0;i<I.length;i++){var E={"backgroundColor":I[i],"width":c,"height":c,"position":h,"-moz-border-radius":j,"-webkit-border-radius":j,"border-radius":j,"top":((i+5)*30)+l,"left":((i+1)*150)+l};
var K=new qx.html.Element(k,E);
L.add(K);
}this.__Mi=[];
this.__Mj=[];
L.addListener(t,this._onTouchStart,this);
L.addListener(C,this._onTouchMove,this);
},_onTouchStart:function(e){var N=e.getAllTouches();

for(var i=0;i<N.length;i++){var M=N[i];
this.__Mi[i]=parseInt(M.target.style.left)-M.pageX;
this.__Mj[i]=parseInt(M.target.style.top)-M.pageY;
}},_onTouchMove:function(e){var P=e.getAllTouches();

for(var i=0;i<P.length;i++){var O=P[i];

if(P.target==document.body){continue;
}qx.bom.element.Style.setStyles(O.target,{"left":(O.pageX+this.__Mi[i])+l,"top":(O.pageY+this.__Mj[i])+l});
}e.stop();
}}});
})();
