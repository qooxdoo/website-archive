...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Gallery","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery-qx.theme.Classic.f946b93eaf89.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="",k="selected",j="cell",h="layer",g="icon",f="#f3f3f3",d="label",c="Gallery (HTML - divs)",b="manager",a="default",P="demobrowser.demo.virtual.Gallery",O="demobrowser.demo.virtual.WidgetGallery",N="text-align: center;",M="auto",L="color: white; background-color: #00398D;",K="user-desktop.png",J="<img src='",I="__ND",H="'></img>",G="group",s="resize",t="folder.png",q="vertical",r="multi",o="network-server.png",p="user-trash.png",m="off",n="top",u="icon/32/places/",v="horizontal",y="demobrowser.demo.virtual.AbstractGallery",x="abstract",A="position: absolute;",z="demobrowser.demo.virtual.HtmlGallery",C="Gallery (widgets)",B="<br>",w="Icon #",F="network-workgroup.png",E="text-selected",D="demobrowser.demo.virtual.GalleryCell";
...
this.__ND=new demobrowser.demo.virtual.GalleryCell();
...
if(bx){this.__ND.updateStates(bz,{selected:1});
}else{this.__ND.updateStates(bz,{});
...
}var bF=this.__ND.getCellWidget(bG,bE);
bF.setUserData(j,bD);
return bF;
},poolCellWidget:function(bH){this.__ND.pool(bH);
...
var bR=bS?L:l;
return {style:[A,N,this._fontCss,bR].join(l),content:[J,bT.resolvedIcon,H,B,bT.label].join(l)};
