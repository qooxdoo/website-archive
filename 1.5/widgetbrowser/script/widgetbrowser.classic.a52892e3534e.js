...
cc.setBackgroundColor(this.__zL[ca]);
...
this.__zQ=false;
this.setBlue(cg[2]);
},getValue:function(){return this.__J?null:bz+qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);
},resetValue:function(){this.__J=true;
this.__zQ=true;
this.setRed(255);
this.setGreen(255);
this.__zQ=false;
this.setBlue(255);
},__O:function(){if(!this.__zQ){this.__J=false;
this.fireDataEvent("changeValue",this.getValue());
}},_applyRed:function(ch,ci){if(this.__zK===null){this.__zK=bA;
}
if(this.__zK!==bv){this.getChildControl(bp).setValue(ch);
}
if(this.__zK!==bu){this._setHexFromRgb();
}
switch(this.__zK){case bv:case bu:case bA:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__O();

if(this.__zK===bA){this.__zK=null;
}},_applyGreen:function(cj,ck){if(this.__zK===null){this.__zK=bH;
}
if(this.__zK!==bv){this.getChildControl(bd).setValue(cj);
}
if(this.__zK!==bu){this._setHexFromRgb();
}
switch(this.__zK){case bv:case bu:case bH:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__O();

if(this.__zK===bH){this.__zK=null;
}},_applyBlue:function(cl,cm){if(this.__zK===null){this.__zK=bD;
}
if(this.__zK!==bv){this.getChildControl(W).setValue(cl);
}
if(this.__zK!==bu){this._setHexFromRgb();
}
switch(this.__zK){case bv:case bu:case bD:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__O();

if(this.__zK===bD){this.__zK=null;
}},_applyHue:function(cn,co){if(this.__zK===null){this.__zK=bI;
}
if(this.__zK!==bw){this.getChildControl(V).setValue(cn);
}
if(this.__zK!==bs){if(this.getChildControl(bx).getBounds()){this.getChildControl(bx).setDomLeft(Math.round(cn/1.40625)+this.getChildControl(X).getPaddingLeft());
}else{this.getChildControl(bx).setLayoutProperties({left:Math.round(cn/1.40625)});
}}
switch(this.__zK){case bw:case bs:case bI:this._setRgbFromHue();
}this._setBrightnessGradiant();

if(this.__zK===bI){this.__zK=null;
}},_applySaturation:function(cp,cq){if(this.__zK===null){this.__zK=bE;
}
if(this.__zK!==bw){this.getChildControl(U).setValue(cp);
}
if(this.__zK!==bs){this._setBrightnessGradiant();
...
switch(this.__zK){case bw:case bs:case bE:this._setRgbFromHue();
}
if(this.__zK===bE){this.__zK=null;
}},_applyBrightness:function(cr,cs){if(this.__zK===null){this.__zK=bG;
}
if(this.__zK!==bw){this.getChildControl(ba).setValue(cr);
}
if(this.__zK!==bc){var ct=256-Math.round(cr*2.56);
...
switch(this.__zK){case bw:case bc:case bG:this._setRgbFromHue();
}
if(this.__zK===bG){this.__zK=null;
...
this.__zN=cw.top+(e.getDocumentTop()-cv.top)-cu.top;
e.stopPropagation();
},_onBrightnessHandleMouseUp:function(e){this.getChildControl(by).releaseCapture();
this.__zM=null;
},_onBrightnessHandleMouseMove:function(e){if(this.__zM===by){this._setBrightnessOnFieldEvent(e);
e.stopPropagation();
...
this.__zN=location.top+(cx.height/2);
...
e.stop();
},_setBrightnessOnFieldEvent:function(e){var cy=qx.lang.Number.limit(e.getDocumentTop()-this.__zN,0,256);
this.__zK=bc;
...
this.__zK=null;
},_onHueSaturationHandleMouseUp:function(e){if(this.__zM){e.stopPropagation();
this.getChildControl(bx).releaseCapture();
this.__zM=null;
}},_onHueSaturationHandleMouseMove:function(e){if(this.__zM===bx){this._setHueSaturationOnFieldEvent(e);
e.stopPropagation();
...
this.__zO=location.top+(cz.height/2)-cA.top;
this.__zP=location.left+(cz.width/2)-cA.left;
...
e.stop();
},_setHueSaturationOnFieldEvent:function(e){var cC=qx.lang.Number.limit(e.getDocumentTop()-this.__zO,0,256);
var cB=qx.lang.Number.limit(e.getDocumentLeft()-this.__zP,0,256);
this.getChildControl(bx).setDomPosition(cB,cC);
this.__zK=bs;
this.setSaturation(100-Math.round(cC/2.56));
this.setHue(Math.round(cB*1.40625));
this.__zK=null;
},_setRedFromSpinner:function(){if(this.__zK!==null){return;
}this.__zK=bv;
this.setRed(this.getChildControl(bp).getValue());
this.__zK=null;
},_setGreenFromSpinner:function(){if(this.__zK!==null){return;
}this.__zK=bv;
this.setGreen(this.getChildControl(bd).getValue());
this.__zK=null;
},_setBlueFromSpinner:function(){if(this.__zK!==null){return;
}this.__zK=bv;
this.setBlue(this.getChildControl(W).getValue());
this.__zK=null;
},_setHueFromSpinner:function(){if(this.__zK!==null){return;
}this.__zK=bw;
this.setHue(this.getChildControl(V).getValue());
this.__zK=null;
},_setSaturationFromSpinner:function(){if(this.__zK!==null){return;
}this.__zK=bw;
this.setSaturation(this.getChildControl(U).getValue());
this.__zK=null;
},_setBrightnessFromSpinner:function(){if(this.__zK!==null){return;
}this.__zK=bw;
this.setBrightness(this.getChildControl(ba).getValue());
this.__zK=null;
},_onHexFieldChange:function(e){if(this.__zK!==null){return;
}
...
this.setGreen(cI[1]);
this.setBlue(cI[2]);
},_setHueFromRgb:function(){switch(this.__zK){case bw:case bs:case bc:break;
...
}},_setRgbFromHue:function(){switch(this.__zK){case bv:case bu:break;
...
(function(){var m="current-preview",l="execute",k="selected-preview",h="Number",g="preview-pane",f="selector-button",d="colorselector-cancelbutton",c="auto-button",b="colorselector-okbutton",a="mousedown",W="teal",V="maroon",U="qx.ui.control.ColorPopup",T="#666",S="changeValue",R="__ID",Q="#333",P="#000",O="yellow",N="changeGreen",t="colorpopup",u="_applyValue",r="blue",s="changeRed",p="field#",q="__IE",n="#CCC",o="Color Selector",v="changeVisibility",w="changeBlue",D="mouseover",B="Cancel",H="#FFF",F="right",J="Open ColorSelector",I="mouseout",y="#999",M="Automatic",L="Basic Colors",K="Preview (Old/New)",x="visible",z="Recent Colors",A="OK",C="field",E="green",G="red";
...
},_createBoxes:function(){this.__IC={};
var bc=this._tables;
var bf,bb,bd;
var j=0;
...
for(var i=0;i<this.__IG;i++){bd=this.getChildControl(p+(j++));
bd.setBackgroundColor(bf.values[i]||null);
bb.add(bd);
}}},_createColorSelector:function(){if(this.__IE){return;
}var bg=new qx.ui.window.Window(this.tr(o));
this.__ID=bg;
bg.setLayout(new qx.ui.layout.VBox(16));
bg.setResizable(false);
bg.moveTo(20,20);
this.__IE=new qx.ui.control.ColorSelector;
bg.add(this.__IE);
...
}var bp=this._tables[this.__IF].values;
var bq=this.__IC[this.__IF];
...
}else if(bp.length==this.__IG){bp.shift();
}bp.push(br);
...
this.__IE.setGreen(by);
this.__IE.setBlue(bx);
this.__ID.open();
},_onColorSelectorOk:function(){var bA=this.__IE;
this.setValue(qx.util.ColorUtil.rgbToRgbString([bA.getRed(),bA.getGreen(),bA.getBlue()]));
this.__ID.close();
},_onColorSelectorCancel:function(){this.__ID.close();
...
}},_tables:{core:{label:L,values:[P,Q,T,y,n,H,G,E,r,O,W,V]},recent:{label:z,values:[]}}},destruct:function(){this._disposeObjects(R,q);
this._tables=this.__IC=null;
}});
})();
...
this.__Ks=new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
this.add(this.__Ks,{top:0});
this.initWidgets();
},members:{__Ks:null,initWidgets:function(){var l=this._widgets=new qx.type.Array();
var j;
