...
(function(){var u="textfield",t="value",s="button",r="inner",q="change",p="dropdown",o="select",n="Function",m="Enter",k="list",d="virtual-combobox",j="click",g="_applyValue",c="_applyPlaceholder",b="single",f="changeValue",e="qx.ui.form.VirtualComboBox",h="String",a="converter";
qx.Class.define(e,{extend:qx.ui.form.core.AbstractVirtualBox,implement:[qx.ui.form.IStringForm],construct:function(v){qx.ui.form.core.AbstractVirtualBox.call(this,v);
var w=this._createChildControl(u);
this._createChildControl(s);
var x=this.getChildControl(p);
x.getChildControl(k).setSelectionMode(b);
this.__it=x.getSelection();
this.__it.addListener(q,this.__HR,this);
this.bind(t,w,t);
w.bind(t,this,t);
},properties:{appearance:{refine:true,init:d},width:{refine:true,init:120},value:{nullable:true,event:f,apply:g},placeholder:{check:h,nullable:true,apply:c},defaultFormat:{check:n,init:null,nullable:true}},members:{__HP:null,__HQ:null,__it:null,__AV:null,getTextSelection:function(){return this.getChildControl(u).getTextSelection();
},getTextSelectionLength:function(){return this.getChildControl(u).getTextSelectionLength();
},setTextSelection:function(y,z){this.getChildControl(u).setTextSelection(y,z);
...
this.selectAllText();
},tabFocus:function(){var A=this.getChildControl(u);
...
switch(B){case u:D=new qx.ui.form.TextField();
...
},_handleKeyboard:function(event){var E=this._getAction(event);

switch(E){case o:this.setValue(this.getChildControl(u).getValue());
break;
default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);
break;
}},_getAction:function(event){var F=event.getKeyIdentifier();
var H=this.getChildControl(p).isVisible();
var G=this._isModifierPressed(event);
...
if(J==this.getChildControl(s)){this.toggle();
}else{this.close();
}},__HR:function(event){if(this.__AV==true){return;
}var K=this.__it.getItem(0);
K=this.__kf(K);
this.setValue(K);
},_applyValue:function(L,M){},_applyPlaceholder:function(N,O){this.getChildControl(u).setPlaceholder(N);
},__HS:function(){var R=this.getValue();
var Q=this.getChildControl("dropdown");
var P=Q.getSelection();

if(this.__kf(P.getItem(0))!==R){this.__AV=true;
P.removeAll();
this.__AV=false;
if(R==null||R==""){return;
}var V=this.getModel();
...
break;
}}}},__kf:function(W){var Y=this.getLabelOptions();
...
}var bc=qx.util.Delegate.getMethod(Y,a);

if(bc!=null){ba=bc(ba);
}
if(ba!=null&&X!=null){ba=X(qx.lang.String.stripTags(ba));
}return ba;
}},destruct:function(){var bd=this.getChildControl(u);
this.removeAllBindings();
bd.removeAllBindings();
this.__it.removeListener(q,this.__HR,this);
this.__it=null;
}});
})();
