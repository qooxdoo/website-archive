qx.$$packageData['1024']={"locales":{},"resources":{"qx/icon/Oxygen/16/apps/office-calendar.png":[16,16,"png","qx"],"qx/icon/Tango/16/apps/office-calendar.png":[16,16,"png","qx"]},"translations":{}};
...
this.initWidgets();
},members:{__Kz:0,initWidgets:function(){var g=this._widgets=new qx.type.Array();
var h=this.__Ji();
h.setFocusedCell(2,5);
g.push(h);
this.add(h);
},__Ji:function(){var k=this.__KA(50);
