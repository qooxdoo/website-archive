qx.$$packageData['1024']={"locales":{},"resources":{"qx/static/blank.gif":[1,1,"gif","qx"],"twitterdemo/twitter_logo_outline.png":[300,78,"png","twitterdemo"]},"translations":{}};
...
(function(){var k="value",j=" ",h="icon",g="model",f="text",e="source",d="mshtml",c="engine.name",b="user.profile_image_url",a="Enter",J="one",I="http",H="keydown",G="http://twitter.com/statuses/user_timeline/1and1.json",F="<a href='",E="execute",D="1and1",C="selection[0]",B="username",A="Location: ",r="twitterdemo.Demo",s="twitterdemo/twitter_logo_outline.png",p="Details",q="user.name",n="Name: ",o="target='_blank'",l="</a>",m="Posted with: ",t="' target='_blank'>",u="Show",w="user.location",v=".json",y="http://twitter.com/statuses/user_timeline/",x="Avatar: ",z="Message: ";
qx.Class.define(r,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);
this._createView();
},members:{_createView:function(){this.setLayout(new qx.ui.layout.Canvas());
var T=new qx.ui.basic.Image(s);
this.add(T,{left:10,top:15});
var O=new qx.ui.form.List();
this.add(O,{left:10,top:135,bottom:5});
O.set({selectionMode:J,width:300,maxHeight:400});
...
var K=new qx.ui.form.TextField(D);
K.setPlaceholder(B);
P.add(K);
var S=new qx.ui.form.Button(u);
P.add(S);
S.addListener(E,function(){var X=y+K.getValue()+v;

if(V.getUrl()==X){V.reload();
}else{V.setUrl(X);
}},this);
K.addListener(H,function(Y){if(Y.getKeyIdentifier()==a){S.execute();
}},this);
this.add(P,{left:10,top:105});
var N=new qx.ui.groupbox.GroupBox(p);
...
N.add(new qx.ui.basic.Label(A),{row:1,column:0});
...
L.addTarget(name,k,q);
L.addTarget(location,k,w);
L.addTarget(U,k,f,false,{converter:function(ba){var bb=ba.split(j);

for(var i=bb.length-1;i>=0;i--){if(bb[i].indexOf(I)==0){bb[i]=F+bb[i]+t+bb[i]+l;
}}return bb.join(j);
}});
