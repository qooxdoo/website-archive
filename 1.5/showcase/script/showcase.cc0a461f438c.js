qx.$$packageData['1024']={"locales":{},"resources":{"qx/static/blank.gif":[1,1,"gif","qx"],"qxc/application/twitterdemo/twitter_logo_outline.png":[300,78,"png","twitterdemo"]},"translations":{}};
...
(function(){var k="value",j=" ",h="icon",g="model",f="text",e="source",d="mshtml",c="engine.name",b="user.profile_image_url",a="Enter",J="one",I="http",H="keydown",G="http://twitter.com/statuses/user_timeline/1and1.json",F="<a href='",E="execute",D="1and1",C="selection[0]",B="username",A="Location: ",r="twitterdemo/twitter_logo_outline.png",s="Details",p="user.name",q="Name: ",n="qxc.application.twitterdemo.Demo",o="target='_blank'",l="</a>",m="Posted with: ",t="' target='_blank'>",u="Show",w="user.location",v=".json",y="http://twitter.com/statuses/user_timeline/",x="Avatar: ",z="Message: ";
