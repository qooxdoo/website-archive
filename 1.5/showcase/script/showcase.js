...
var envinfo = {"qx.application":"showcase.Application","qx.debug":false,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"28156","qx.theme":"showcase.theme.Theme","qx.version":"1.5"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.5"},"qxc.application.formdemo":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qxc.application.twitterdemo":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"showcase":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
qx.$$loader = {
  ...
  packages : {"1":{"uris":["__out__:showcase.27e673afd35f.js"]},"2":{"uris":["__out__:showcase.1d2b24573c75.js"]},"4":{"uris":["__out__:showcase.f3e0342dcf01.js"]},"16":{"uris":["__out__:showcase.feca9293868c.js"]},"130":{"uris":["__out__:showcase.a2cdf4268103.js"]},"131":{"uris":["__out__:showcase.f7a3ac1b2219.js"]},"256":{"uris":["__out__:showcase.2de4a85b508d.js"]},"386":{"uris":["__out__:showcase.94a5470435a9.js"]},"512":{"uris":["__out__:showcase.418a43bce37e.js"]},"514":{"uris":["__out__:showcase.39953b71bc58.js"]},"789":{"uris":["__out__:showcase.0c5f4ffa0c0a.js"]},"899":{"uris":["__out__:showcase.ac8c1909595b.js"]},"1024":{"uris":["__out__:showcase.9b98f0e7ee33.js"]},"1923":{"uris":["__out__:showcase.e945339caeae.js"]},"2015":{"uris":["__out__:showcase.8263f2a8d985.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
...
qx.Bootstrap.define(v,{statics:{_checks:{},_asyncChecks:{},__cJ:{},get:function(ba){if(this.__cJ[ba]!=undefined){return this.__cJ[ba];
...
if(this.__cJ[bd]!=undefined){window.setTimeout(function(){be.call(self,bg.__cJ[bd]);
},0);
return;
}var bf=this._asyncChecks[bd];

if(bf){bf(function(bh){bg.__cJ[bd]=bh;
be.call(self,bh);
});
return;
...
qx.Bootstrap.trace(this);
}},select:function(bi,bj){return this.__cK(this.get(bi),bj);
},selectAsync:function(bk,bl,self){this.getAsync(bk,function(bm){var bn=this.__cK(bk,bl);
bn.call(self,bm);
},this);
},__cK:function(bo,bp){var br=bp[bo];
...
},__cL:function(){if(qx&&qx.$$environment){for(var bz in qx.$$environment){var by=qx.$$environment[bz];
this._checks[bz]=this.__cN(by);
}}},__cM:function(){if(window.document&&window.document.location){var bA=window.document.location.search.slice(1).split(I);
...
}this._checks[bD]=this.__cN(bB);
}}},__cN:function(bE){return qx.Bootstrap.bind(function(bF){return bF;
},null,bE);
...
this.set({name:j,part:o,icon:e,contentClass:f,description:showcase.page.DescriptionBuilder.build(j,this.__Ku,null,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:v+q+g+t+a+c+i,__Kv:{"States":h+p,"Decorators":k+b+n},__Kw:{"pages/gui_toolkit/ui_theming.html":j,"pages/gui_toolkit/ui_appearance.html":s,"pages/gui_toolkit/ui_custom_themes.html":d,"pages/gui_toolkit/ui_decorators.html":m},__Kx:{"#ui~Decoration.html":u},__Ky:{"#qx.theme":l}}});
})();
...
var P=R[1];
var N=R[2];
var S=this.__Fv={t:P+c+N,b:P+t+N,c:P+o+N,l:P+e+N,r:P+a+N};
this.__pf={top:M.getImageHeight(S.t),bottom:M.getImageHeight(S.b),left:M.getImageWidth(S.l),right:M.getImageWidth(S.r)};
...
this.set({name:j,part:a,icon:c,contentClass:d,description:showcase.page.DescriptionBuilder.build(j,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:f+s+k+g+o,__Kz:{"Text Formatting":i,"Alignment":v,"Lists":h,"Redo/Undo":m},__Kv:{"Inserting":p},__Kw:{"pages/gui_toolkit/ui_html_editing.html":t},__Kx:{"#bom~HtmlArea.html":b,"#widget~HtmlArea.html":e},__Ky:{"#qx.bom.htmlarea":q,"#qx.ui.toolbar":l,"#qx.ui.menubar":r,"#qx.ui.menu":u}}});
})();
...
this.set({name:j,part:w,icon:u,contentClass:a,description:showcase.page.DescriptionBuilder.build(j,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:v+e,__Kz:{"Selection":d,"Text":q,"Buttons":m,"MenuButton":i},__Kv:{"Widgets":p,"Keyboard Navigation":n},__Kw:{"pages/gui_toolkit/ui_form_handling.html":o},__Kx:{"#ui~FormRenderer.html":r,"#ui~FormRendererCustom.html":z,"#ui~FormRendererDouble.html":c,"#ui~FormRendererPlaceholder.html":k,"#ui~FormValidator.html":x,"#ui~MultiPageForm.html":b,"#showcase~Form.html":g,"#data~FormController.html":t,"#data~Form.html":f},__Ky:{"#qx.ui.form":l,"#qx.ui.form.renderer":y,"#qx.data.controller.Form":h}}});
})();
...
qx.Class.define(h,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(t,u,v){this.__mk=t;
t.style.overflow=a;
t.style.textAlign=b;
this.__we=u||false;
this.__wf=v||false;
...
}},members:{__we:false,__wf:false,__mk:null,__wg:function(){if(this.__we||this.__wf){var w=qx.bom.element.Dimension.getSize(this.__mk);

if(this.__we&&w.width<1){throw new Error("The root element "+this.__mk+" of "+this+" needs a width when its width size should be used!");
}
if(this.__wf){if(w.height<1){throw new Error("The root element "+this.__mk+" of "+this+" needs a height when its height size should be used!");
}if(w.height>=1&&qx.bom.element.Style.get(this.__mk,o,3)==n){qx.bom.element.Style.set(this.__mk,o,w.height+m);
}}qx.event.Registration.addListener(this.__mk,q,this._onResize,this);
}},_createContainerElement:function(){var x=this.__mk;

if(this.__we||this.__wf){var B=document.createElement(f);
x.appendChild(B);
...
if((F.oldWidth!==F.width)&&this.__we||(F.oldHeight!==F.height)&&this.__wf){qx.ui.core.queue.Layout.add(this);
}},_computeSizeHint:function(){var K=this.__we;
var H=this.__wf;
...
if(K){var J=L.getContentWidth(this.__mk);
G.width=J;
G.minWidth=J;
G.maxWidth=J;
}
if(H){var I=L.getContentHeight(this.__mk);
G.height=I;
G.minHeight=I;
G.maxHeight=I;
}return G;
}},defer:function(M,N){qx.ui.core.MLayoutHandling.remap(N);
},destruct:function(){qx.event.Registration.removeListener(this.__mk,q,this._onResize,this);
this.__mk=null;
}});
})();
...
this.set({name:j,part:C,icon:m,contentClass:s,description:showcase.page.DescriptionBuilder.build(j,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:e+f+r+w+u+n,__Kz:{"Sorting":c,"Reordering":x,"Column Resizing":p,"Hide Columns":o,"Table Resize":t},__Kv:{"Cell Renderer":d,"Header Renderer":y},__Kw:{"pages/widget/table_remote_model.html":z},__Kx:{"#table~Table.html":q,"#table~Table_Cell_Editor.html":A,"#table~Table_Conditional.html":v,"#table~Table_Context_Menu.html":l,"#table~Table_Events.html":k,"#table~Table_Filtered_Model.html":g,"#table~Table_Huge.html":h,"#table~Table_Meta_Columns.html":b,"#table~Table_Resize_Columns.html":i,"#table~Table_Selection.html":D,"#table~Table_Window_Editor.html":a},__Ky:{"#qx.ui.table.Table":j}}});
})();
...
this.set({name:g,part:c,icon:k,contentClass:f,description:showcase.page.DescriptionBuilder.build(p,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:d+b+m+e,__Kz:{"Drag":a,"Reorder":j,"Move":n},__Kv:null,__Kw:{"pages/gui_toolkit/ui_dragdrop.html":p},__Kx:{"#ui~DragDrop.html":l},__Ky:{"#qx.ui.core.Widget~drag":h,"#qx.ui.core.DragDropCursor":i}}});
})();
...
(function(){var s="1.5",r="http://demo.qooxdoo.org/",q="<h1>",p="</div>",o="",n="</p>",m="<h2>Demos</h2>",l="<p>",k="showcase.page.DescriptionBuilder",j="</h1>",d="<div id='description'>",i="http://manual.qooxdoo.org/",g="<h2>Api</h2>",c="/demobrowser/",b="/",f="/apiviewer/",e="<h2>Features</h2>",h="<h2>Documentation</h2>",a="<h2>Try This</h2>";
qx.Class.define(k,{statics:{_demoPrefix:r+s+c,_apiPrefix:r+s+f,_manualPrefix:i+s+b,build:function(t,u,v,w,x,y,z){var A=[];
A.push(d,q,t,j,l,u,n);

if(v){A.push(a,this.__KB(v));
}
if(w){A.push(e,this.__KB(w));
}
if(x){A.push(h,this.__KA(this._manualPrefix,x));
}
if(y){A.push(m,this.__KA(this._demoPrefix,y));
}
if(z){A.push(g,this.__KA(this._apiPrefix,z));
}A.push(p);
return A.join(o);
},__KA:function(B,C){var D=["<ul>"];

for(var E in C){D.push("<li><a href='",B,E,"' target='_blank'>",C[E],"</a></li>");
}D.push("</ul>");
return D.join("");
},__KB:function(F){var G=["<ul>"];
...
this.set({name:x,part:f,icon:h,contentClass:t,description:showcase.page.DescriptionBuilder.build(j,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:v+n+c+r,__Kz:{"Change the language":l+d+a,"Change the country":u+m+w+q+o,"Open the command menu":s+z},__Kv:{"Standards based translation":p+i+y,"CLDR":"Localisation data like date and time formats are taken from the "+"<a href='http://cldr.unicode.org/'>Unicode Common Locale Data Repository</a> (CLDR). This "+"guarantees that qooxdoo uses the standardized data for even the smallest "+"countries.","Live locale switching":k},__Kw:{"pages/development/internationalization.html":j},__Kx:{"#showcase~Localization.html":e},__Ky:{"#qx.locale":b}}});
})();
...
this.set({name:j,part:s,icon:c,contentClass:a,description:showcase.page.DescriptionBuilder.build(j,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:x+v+d+h,__Kz:{"Close Group":m,"Change User Data":w,"Add User":k,"Delete User":l},__Kv:{"Filtering":r,"Sorting":i,"Grouping":n,"Selection":e+y,"Data Binding":o,"Custom Rendering":f},__Kw:{"pages/widget/virtuallist.html":j},__Kx:{"#virtual~List.html":t,"#virtual~ListWithFilter.html":u,"#virtual~ExtendedList.html":b,"#virtual~GroupedList.html":q},__Ky:{"#qx.ui.list.List":j,"#qx.ui.list.core.IListDelegate":g}}});
})();
...
if(j){this.__na(j,l);
}if(k!=null){this.__mY.setInsets(k);
}}else{this.__mY=new qx.ui.decoration.BoxDiv(j,k,l);
}},properties:{baseImage:{check:b,nullable:true,apply:e}},members:{__mY:null,_isHorizontal:null,_setOrientation:function(m){this._isHorizontal=m==h;
},getMarkup:function(){return this.__mY.getMarkup();
},resize:function(n,o,p){this.__mY.resize(n,o,p);
},tint:function(q,r){},getInsets:function(){return this.__mY.getInsets();
},_applyInsets:function(s,t,name){var u=f+qx.lang.String.firstUp(name);
this.__mY[u](s);
},_applyBaseImage:function(v,w){if(this.__mY instanceof qx.ui.decoration.BoxDiv){this.__mY.setBaseImage(v);
}else{this.__na(v);
}},__na:function(x){this.__mY.setBorderImage(x);
...
this.set({name:j,part:u,icon:e,contentClass:a,description:showcase.page.DescriptionBuilder.build(j,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:t+w+g+l+m,__Kz:{"Detail View":b,"Change Tweet":A},__Kv:{"Loading Data":h,"Binding":q},__Kw:{"pages/data_binding/data_binding.html":r,"pages/data_binding/single_value_binding.html":k,"pages/data_binding/controller.html":x,"pages/data_binding/stores.html":v},__Kx:{"#data~SingleValueBinding.html":d,"#data~ListControllerWith3Widgets.html":n,"#data~TreeController.html":s,"#data~FormController.html":i,"#data~Flickr.html":y},__Ky:{"#qx.data":c,"#qx.data.store.Jsonp":f,"#qx.data.controller.List":o,"#qx.data.controller.Object":p}}});
})();
...
qx.Class.define(p,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:u,part:d,icon:f,contentClass:g,description:showcase.page.DescriptionBuilder.build(u,this.__Ku,this.__Kz,this.__Kv,this.__Kw,this.__Kx,this.__Ky)});
},members:{__Ku:r+m+b,__Kz:{"Expand":e,"Resize":k,"Selection":o},__Kv:{"Configurable":q,"Scrolling":c,"Multi Columns":t},__Kw:{"pages/widget/tree.html":a},__Kx:{"#widget~Tree.html":s,"#widget~Tree_Columns.html":j,"#data~TreeController.html":l,"#data~JsonToTree.html":n,"#data~ExtendedTree.html":h},__Ky:{"#qx.ui.tree":i}}});
})();
...
(function(){var k="complete",j="_applySelectedPage",h="Boolean",g="showcase/images/welcome.png",f="showcase.Application",e="stack",d="showcase/images/loading66.gif",c="selection[0]",b="selection[0].readyState",a="__oE",C="value",B="selection[0].description",A="showcase",z="name",y="icon",x="selectedPage",w="showcase.Page",v="state",u="_applyShowLoadIndicator",t="en_US",r="page-preview",s="__KE",p="__fD",q="50%",n="__KD",o="selection[0].part",l="showLoadIndicator",m="__oG";
qx.Class.define(f,{extend:qx.application.Inline,properties:{selectedPage:{check:w,apply:j,nullable:true},showLoadIndicator:{check:h,init:false,apply:u}},members:{__fD:null,__KC:null,__oE:null,__oG:null,__KD:null,__KE:null,main:function(){qx.application.Inline.prototype.main.call(this);
...
this.__fD.set({appearance:e,maxWidth:600,allowGrowX:false});
D.add(this.__fD,{row:N,column:0});
var H=new qx.ui.basic.Image(g).set({allowGrowX:true,allowGrowY:true,allowShrinkX:true,padding:[5,0,0,180]});
this.__fD.add(H);
this.__oE=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var K=new qx.ui.basic.Image(d).set({marginLeft:-33});
this.__oE.add(K,{left:q,top:200});
this.__fD.add(this.__oE);
this.__oG=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
this.__fD.add(this.__oG);
this.__KE=new showcase.ui.Description();
D.add(this.__KE,{row:N++,column:1});
this.__KE.exclude();
var L=new qx.data.Array();
L.push(new showcase.page.table.Page(),new showcase.page.form.Page(),new showcase.page.virtuallist.Page(),new showcase.page.databinding.Page(),new showcase.page.tree.Page(),new showcase.page.theme.Page(),new showcase.page.i18n.Page(),new showcase.page.dragdrop.Page(),new showcase.page.htmleditor.Page());
var M=new qx.data.controller.List(L,E,z);
M.setIconPath(y);
M.bind(c,this,x);
M.bind(B,this.__KE,C);
M.bind(b,this,l,{converter:function(O){return O!==k;
}});
M.setDelegate({configureItem:function(P){P.set({appearance:r});
}});
...
}}},_applyShowLoadIndicator:function(Q){if(Q){this.__fD.setSelection([this.__oE]);
}else{this.__fD.setSelection([this.__oG]);
...
this.__KF();
}}},_showPage:function(U){this.__KE.show();
U.load(function(V){if(this.getSelectedPage()==V){var W=V.getContent().getView();
this.__oG.add(W,{edge:0});
W.show();
this.__KG(W);
}},this);
},__KF:function(){if(this.__KD){this.__KD.cancel();
this.__KD.dispose();
this.__KD=null;
}},__KG:function(X){if(qx.core.Environment.get("engine.name")=="mshtml"){return;
}X.getContentElement().setStyle("display","none",true);
this.__KF();
qx.event.Timer.once(function(){var Y=X.getContentElement().getDomElement();
this.__KD=new qx.fx.effect.core.Fade(Y);
this.__KD.set({from:0,to:1});
this.__KD.addListenerOnce("update",function(){X.getContentElement().setStyle("display","block");
},this);
this.__KD.start();
},this,0);
}},destruct:function(){this._disposeObjects(p,a,m,s,n);
}});
})();
...
(function(){var n="drag",m="dragend",k="drop",j="droprequest",h="dragstart",g="groupbox/legend",f="printer",d="icon",c="Battery",b="Scanner",bk=".png",bj="Soundblaster",bi="Cart",bh="Cell Phone",bg="BluRay Drive",bf="computer",be="WiFi",bd="camera-photo",bc="Printer",bb="DVD",u="network-wired",v="Keyboard",s="HDD",t="center",q="name",r="Computer",o="pda",p="move",y="showcase.page.dragdrop.Content",z="middle",H="PDA",F="Camera",P="selected",K="iPod",W="icon/64/actions/object-flip-horizontal.png",U="network-wireless",B="Mouse",ba="drive-optical",Y="camera-web",X="media-flash",A="Display",D="Mic.",E="input-mouse",G="SD Card",I="Network Cable",L="icon/64/devices/",R="battery",V="drive-harddisk",w="scanner",x="audio-input-microphone",C="media-optical",O="Shop",N="phone",M="Webcam",T="input-keyboard",S="items",J="multimedia-player",Q="audio-card",a="display";
qx.Class.define(y,{extend:showcase.AbstractContent,construct:function(bl){showcase.AbstractContent.call(this,bl);
this.setView(this._createView());
},members:{__JC:null,__JD:null,_createView:function(){var bs=new qx.ui.layout.Grid();
bs.setRowFlex(1,1);
bs.setColumnFlex(0,1);
bs.setColumnFlex(2,1);
bs.setColumnAlign(1,t,z);
var bt=new qx.ui.container.Composite(bs);
bt.setPadding(20);
bt.add(new qx.ui.basic.Label(O).set({appearance:g,paddingBottom:5}),{row:0,column:0});
bt.add(new qx.ui.basic.Label(bi).set({appearance:g,paddingBottom:5}),{row:0,column:2});
var bm=new qx.ui.form.List();
bm.set({draggable:true,droppable:true});
bt.add(bm,{row:1,column:0});
bm.addListener(h,this.__tm,this);
bm.addListener(j,this.__JF,this);
bm.addListener(k,this.__JE,this);
bm.addListener(n,this.__JH,this);
bm.addListener(m,this.__JG,this);
var bq=new qx.ui.basic.Image(W);
bq.setPadding(10);
bt.add(bq,{row:1,column:1});
var br=new qx.ui.form.List();
br.set({draggable:true,droppable:true});
bt.add(br,{row:1,column:2});
br.addListener(h,this.__tm,this);
br.addListener(j,this.__JF,this);
br.addListener(k,this.__JE,this);
br.addListener(n,this.__JH,this);
br.addListener(m,this.__JG,this);
var bn=qx.data.marshal.Json.createModel([{"name":b,"icon":w},{"name":bj,"icon":Q},{"name":D,"icon":x},{"name":c,"icon":R},{"name":F,"icon":bd},{"name":M,"icon":Y},{"name":r,"icon":bf},{"name":A,"icon":a},{"name":s,"icon":V},{"name":bg,"icon":ba},{"name":v,"icon":T},{"name":B,"icon":E},{"name":G,"icon":X},{"name":bb,"icon":C},{"name":K,"icon":J},{"name":I,"icon":u},{"name":be,"icon":U},{"name":H,"icon":o},{"name":bh,"icon":N},{"name":bc,"icon":f}]);
var bo=new qx.data.controller.List(null,bm);
bo.setLabelPath(q);
bo.setIconPath(d);
bo.setIconOptions({converter:function(bu){return L+bu+bk;
}});
bo.setModel(bn);
...
return bt;
},__JE:function(e){var bv=e.getData("items");
...
}}},__JF:function(e){var bz=e.getTarget();
var by=bz.getSelection().concat();
e.addData("items",by);
},__tm:function(e){e.addType(S);
e.addAction(p);
var bA=e.getTarget().getSelection()[0];
this.__JC.set({label:bA.getLabel(),icon:bA.getIcon(),width:bA.getBounds().width});
},__JG:function(e){this.__JD&&this.__JD.removeState("dragover");
this.__JC.setDomPosition(-1000,-1000);
},__JH:function(e){var bB=e.getOriginalTarget();

if(bB instanceof qx.ui.form.ListItem){if(bB!=this.__JD){this.__JD&&this.__JD.removeState("dragover");
bB.addState("dragover");
this.__JD=bB;
}}else{this.__JD&&this.__JD.removeState("dragover");
}this.__JC.setDomPosition(e.getDocumentLeft()+15,e.getDocumentTop()+15);
}}});
})();
