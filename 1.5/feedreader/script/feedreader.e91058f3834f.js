...
(function(){var s="",r="URL",q="Add",p="__P",o="keypress",n="Title",m="Add a feed",l="feedreader.view.AddFeedWindow",k="user",j="this.__form",c="__N",i="icon/16/actions/document-new.png",g="icon/16/actions/dialog-apply.png",b="__O",a="right",f="Feed Information",d="execute",h="Enter";
...
this._addContent();
},members:{__O:null,__P:null,__N:null,__Q:null,_addContent:function(){this.setLayout(new qx.ui.layout.VBox(10));
this.__Q=new qx.ui.form.Form();
this.__Q.addGroupHeader(this.tr(f));
this.__P=new qx.ui.form.TextField().set({required:true,width:250});
this.__Q.add(this.__P,this.tr(n));
this.__O=new qx.ui.form.TextField().set({required:true});
this.__Q.add(this.__O,this.tr(r),qx.util.Validate.checkUrl);
var u=new qx.ui.form.Button(this.tr(q),g);
u.set({alignX:a,allowGrowX:false});
u.addListener(d,this._addFeed,this);
this.__Q.addButton(u);
this.addListener(o,function(e){if(e.getTarget() instanceof qx.ui.form.TextField&&e.getKeyIdentifier()===h){this._addFeed();
}});
this.add(new qx.ui.form.renderer.SinglePlaceholder(this.__Q));
},_addFeed:function(e){if(this.__Q.validate()){var w=this.__P.getValue();
var v=this.__O.getValue();
this.__N.addFeed(w,v,k);
this.__P.setValue(s);
this.__O.setValue(s);
this.close();
}}},destruct:function(){this.__R=null;
this._disposeObjects(c,p,b,j);
}});
})();
