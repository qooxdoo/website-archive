...
(function(){var k="os.name",j="os.version",h="css.borderradius",g="default",f="browser.quirksmode",e="browser.name",d="qx.allowUrlSettings",c="event.pointer",b="io.ssl",a="locale.variant",X="css.textoverflow",W="html.xul",V="css.boxshadow",U="event.touch",T="io.maxrequests",S="css.gradients",R="browser.documentmode",Q="ecmascript.objectcount",P="locale",O="engine.version",r="engine.name",s="css.rgba",p="css.boxmodel",q="css.placeholder",n="|",o="browser.version",l="io.xhr",m="qx.core.Environment",u="qx.debug.databinding",v="qx.optimization.basecalls",C="qx.debug.dispose",A="qx.optimization.variables",G="true",E="qx.optimization.privates",K="qx.aspects",I="qx.debug",x="qx.dynamicmousewheel",N=":",M="qxenv",L="qx.optimization.strings",w="qx.optimization.comments",y="qx.optimization.variants",z="qx.mobile.emulatetouch",B="qx.dynlocale",D="false",F="&",H="qx.mobile.nativescroll",J="qx.allowUrlVariants",t="qx.propertyDebugLevel";
qx.Bootstrap.define(m,{statics:{_checks:{},_asyncChecks:{},__cJ:{},get:function(Y){if(this.__cJ[Y]!=undefined){return this.__cJ[Y];
}var ba=this._checks[Y];
...
}},getAsync:function(bc,bd,self){var bf=this;

if(this.__cJ[bc]!=undefined){window.setTimeout(function(){bd.call(self,bf.__cJ[bc]);
},0);
return;
}var be=this._asyncChecks[bc];

if(be){be(function(bg){bf.__cJ[bc]=bg;
bd.call(self,bg);
});
return;
...
qx.Bootstrap.trace(this);
}},select:function(bh,bi){return this.__cK(this.get(bh),bi);
},selectAsync:function(bj,bk,self){this.getAsync(bj,function(bl){var bm=this.__cK(bj,bk);
bm.call(self,bl);
},this);
},__cK:function(bn,bo){var bq=bo[bn];

if(bo.hasOwnProperty(bn)){return bq;
}for(var bp in bo){if(bp.indexOf(n)!=-1){var br=bp.split(n);

for(var i=0;i<br.length;i++){if(br[i]==bn){return bo[bp];
}}}}
if(bo[g]!==undefined){return bo[g];
}
if(qx.Bootstrap.DEBUG){throw new Error('No match for variant "'+bn+'" ('+(typeof bn)+' type)'+' in variants ['+qx.Bootstrap.getKeysAsString(bo)+'] found, and no default ("default") given');
}},invalidateCacheKey:function(bs){delete this.__cJ[bs];
},add:function(bt,bu){if(this._checks[bt]==undefined){if(bu instanceof Function){this._checks[bt]=bu;
}else{this._checks[bt]=this.__cN(bu);
}}},addAsync:function(bv,bw){if(this._checks[bv]==undefined){this._asyncChecks[bv]=bw;
}},_initDefaultQxValues:function(){this.add(d,function(){return false;
});
this.add(J,function(){return false;
});
this.add(t,function(){return 0;
});
...
},__cL:function(){if(qx&&qx.$$environment){for(var by in qx.$$environment){var bx=qx.$$environment[by];
this._checks[by]=this.__cN(bx);
}}},__cM:function(){if(window.document&&window.document.location){var bz=window.document.location.search.slice(1).split(F);

for(var i=0;i<bz.length;i++){var bB=bz[i].split(N);

if(bB.length!=3||bB[0]!=M){continue;
}var bC=bB[1];
var bA=decodeURIComponent(bB[2]);
if(bA==G){bA=true;
}else if(bA==D){bA=false;
}else if(/^(\d|\.)+$/.test(bA)){bA=parseFloat(bA);
}this._checks[bC]=this.__cN(bA);
}}},__cN:function(bD){return qx.Bootstrap.bind(function(bE){return bE;
},null,bD);
},useCheck:function(bF){return true;
},_initChecksMap:function(){if(this.useCheck(O)){this._checks[O]=qx.bom.client.Engine.getVersion;
}
...
}}},defer:function(bG){bG._initDefaultQxValues();
bG._initChecksMap();
bG.__cL();
if(bG.get(d)===true){bG.__cM();
}}});
})();
...
(function(){var m="separator-vertical",l="Posts",k="bold",j="_applyLoading",i="__oE",h="center",g="feedreader.view.List",f="__oD",e="single",d="middle",a="__fD",c="feedreader/images/loading66.gif",b="Boolean";
...
p.setFont(k);
this._add(p);
this.__fD=new qx.ui.container.Stack();
this._add(this.__fD,{flex:1});
this.__oD=new qx.ui.form.List();
this.__oD.setDecorator(null);
this.__oD.setSelectionMode(e);
this.__oD.setPadding(0);
this.__oD.setMargin(0);
this.__fD.add(this.__oD);
this.__oE=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));
var n=new qx.ui.basic.Image(c);
n.setAlignY(d);
this.__oE.add(n);
this.__fD.add(this.__oE);
},properties:{loading:{check:b,init:false,apply:j}},members:{__fD:null,__oD:null,__oE:null,_applyLoading:function(q,r){if(q){this.__fD.setSelection([this.__oE]);
}else{this.__fD.setSelection([this.__oD]);
}},getList:function(){return this.__oD;
}},destruct:function(){this._disposeObjects(f,a,i);
}});
})();
...
if(!feedreader.view.Article.__oF){feedreader.view.Article.__oF=true;
...
(function(){var l="execute",k="settings",j="loading",h="main",g="addfeed",f="selection[0]",d="title",c="north",b="new",a="changeModel",Y="__pA",X="__pr",W="article",V="__px",U="F1",T="selection[0].state",S="partLoaded",R="Control+A",Q="loaded",P="icon/22/places/folder.png",s="feedreader/images/loading22.gif",t="error",q="change",r="user",o="__pz",p="__pv",m="feeds",n="__pt",v="__pB",w="enabled",D="__ps",B="vertical",H="state",F="__pp",L="__py",J="Control+D",y="icon/22/actions/process-stop.png",O="selection[0].articles",N="static",M="icon/22/apps/internet-feed-reader.png",x="model",z="feedreader.Application",A="Control+P",C="Control+R",E="__pC",G="feedreader.model.Feed",I="__pu",K="__pq",u="__pw";
qx.Class.define(z,{extend:qx.application.Standalone,members:{__pp:null,__pq:null,__R:null,__pr:null,__ps:null,__pt:null,__pu:null,__pv:null,__pw:null,__px:null,__py:null,__pz:null,__pA:null,__pB:null,__pC:null,__pD:false,__pE:false,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__pA=bc.getFeedFolder();
this.__pC=bc.getStaticFeedFolder();
this.__pB=bc.getUserFeedFolder();
this._setUpBinding();
this.__pr.getRoot().setOpen(true);
this.__pr.getRoot().getChildren()[0].setOpen(true);
this.__pr.getRoot().getChildren()[1].setOpen(true);
this.__pr.setHideRoot(true);
this.__pp.getSelection().push(this.__pC.getFeeds().getItem(0));
this.reload();
},_setUpBinding:function(){var bd={converter:this._state2iconConverter};
this.__pp=new qx.data.controller.Tree(this.__pA,this.__pr,m,d);
this.__pp.setIconOptions(bd);
this.__pp.setIconPath(H);
this.__pq=new qx.data.controller.List(null,this.__pu.getList(),d);
this.__pp.bind(O,this.__pq,x);
this.__pq.bind(f,this.__py,W);
this.__pq.getSelection().addListener(q,this._listControllerChange,this);
this.__pq.addListener(a,this._treeControllerChange,this);
var be={converter:this._state2loadingConverter};
this.__pp.bind(T,this.__pu,j,be);
be={converter:this._category2enabledConverter};
this.__pp.bind(f,this.__pt.getRemoveButton(),w,be);
...
},_listControllerChange:function(bi){var bj=this.__pp.getSelection().getItem(0);
var bk=this.__pq.getSelection().getItem(0);
if(bk!=undefined){bj.setSelectedArticle(bk);
}},_treeControllerChange:function(bl){var bm=this.__pp.getSelection().getItem(0);
if(bm!=null&&bm.classname==G&&bm.getSelectedArticle()!=null&&bm.getArticles().contains(bm.getSelectedArticle())){qx.event.Timer.once(function(){this.__pq.getSelection().push(bm.getSelectedArticle());
},this,0);
}else{this.__pu.getList().scrollToY(0);
}},_createLayout:function(){var bn=new qx.ui.layout.Dock();
var bo=new qx.ui.container.Composite(bn);
this.getRoot().add(bo,{edge:0});
this.__ps=new feedreader.view.Header();
bo.add(this.__ps,{edge:c});
this.__pt=new feedreader.view.ToolBar(this);
bo.add(this.__pt,{edge:c});
this.__pv=new qx.ui.splitpane.Pane();
bo.add(this.__pv);
this.__pr=new qx.ui.tree.Tree();
this.__pr.setWidth(250);
this.__pr.setDecorator(h);
this.__pr.setPadding(0);
this.__pv.add(this.__pr,0);
this.__pw=new qx.ui.splitpane.Pane(B);
this.__pw.setDecorator(null);
this.__pv.add(this.__pw,1);
this.__pu=new feedreader.view.List(this.__pA);
this.__pu.setHeight(200);
this.__pu.setDecorator(h);
this.__pw.add(this.__pu,0);
this.__py=new feedreader.view.Article();
this.__py.setDecorator(h);
this.__pw.add(this.__py,1);
},_initializeCommands:function(){var bp={};
bp.reload=new qx.ui.core.Command(C);
...
this.__R=bp;
},getCommand:function(bq){return this.__R[bq];
},addFeed:function(br,bs,bt){var bu=new feedreader.model.Feed(br,bs,bt);
this.__pB.getFeeds().push(bu);
var bv=feedreader.io.FeedLoader.getInstance();
bv.load(bu);
},removeFeed:function(){var bw=this.__pp.getSelection().getItem(0);
if(bw&&bw.getCategory&&bw.getCategory()!==N){var bx=this.__pB.getFeeds();
for(var i=0;i<bx.length;i++){if(bw===bx.getItem(i)){bx.splice(i,1);
return;
}}}},reload:function(){var by=feedreader.io.FeedLoader.getInstance();
by.loadAll(this.__pA);
this.__py.setArticle(null);
},showPreferences:function(){if(!this.__pE){this.__pt.signalLoading(k,true);
}qx.io.PartLoader.require([k],function(){this.__pE=true;
if(!this.__px){this.__px=new feedreader.view.PreferenceWindow();
this.getRoot().add(this.__px);
}this.__px.center();
this.__px.open();
this.__pt.signalLoading(k,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){if(!this.__pD){this.__pt.signalLoading(g,true);
}qx.io.PartLoader.require([g],function(){this.__pD=true;
if(!this.__pz){this.__pz=new feedreader.view.AddFeedWindow(this);
this.getRoot().add(this.__pz);
}this.__pz.center();
this.__pz.open();
this.__pt.signalLoading(g,false);
},this);
}},destruct:function(){this.__R=null;
this._disposeObjects(n,I,L,X,Y,p,u,D,E,v,F,K,V,o);
}});
})();
...
(function(){var k="enabled",j="originalIcon",i="__pH",h=")",g="__pJ",f="Remove feed",d="Preferences",c="excluded",b="addFeed",a="removeFeed",H="icon/22/actions/help-about.png",G="Reload the feeds. (%1)",F="Help",E="visible",D="feedreader.view.ToolBar",C="icon/22/actions/media-seek-forward.png",B="toolbar-button",A="Add feed",z="addfeed",y="icon/22/actions/view-refresh.png",r="(",s="reload",p="showItem",q="settings",n="about",o="icon/22/actions/dialog-cancel.png",l="Reload",m="preferences",t="icon/22/actions/dialog-ok.png",u="icon/22/apps/preferences-theme.png",w="hideItem",v="Open preferences window.",x="feedreader/images/loading22.gif";
qx.Class.define(D,{extend:qx.ui.toolbar.ToolBar,construct:function(I){qx.ui.toolbar.ToolBar.call(this);
this.__pF={};
this.__pG=new qx.ui.toolbar.Button(this.tr(A),t);
this.__pG.setCommand(I.getCommand(b));
this.add(this.__pG);
this.__pH=new qx.ui.toolbar.Button(this.tr(f),o);
this.__pH.setCommand(I.getCommand(a));
this.__pH.setEnabled(false);
this.add(this.__pH);
this.addSeparator();
var L=new qx.ui.toolbar.Button(this.tr(l),y);
var J=I.getCommand(s);
L.setCommand(J);
L.setToolTipText(this.tr(G,J.toString()));
this.add(L);
this.addSeparator();
this.__pI=new qx.ui.toolbar.Button(this.tr(d),u);
this.__pI.setCommand(I.getCommand(m));
this.__pI.setToolTipText(this.tr(v));
this.add(this.__pI);
this.addSpacer();
var M=new qx.ui.toolbar.Button(this.tr(F),H);
var K=I.getCommand(n);
M.setCommand(K);
M.setToolTipText(r+K.toString()+h);
this.add(M);
this.setOverflowHandling(true);
var N=new qx.ui.toolbar.MenuButton(null,C);
N.setAppearance(B);
this.add(N);
this.setOverflowIndicator(N);
this.__pJ=new qx.ui.menu.Menu();
N.setMenu(this.__pJ);
this.addListener(w,this._onHideItem,this);
this.addListener(p,this._onShowItem,this);
},members:{__pH:null,__pJ:null,__pF:null,__pG:null,__pI:null,getRemoveButton:function(){return this.__pH;
...
Q.setVisibility(c);
},_getMenuItem:function(S){var T=this.__pF[S.toHashCode()];
...
this.__pF[S.toHashCode()]=T;
}return T;
},signalLoading:function(U,V){if(U==z){var W=this.__pG;
}else if(U==q){var W=this.__pI;
}else{return ;
}if(V){W.setUserData(j,W.getIcon());
W.setIcon(x);
}else{var X=W.getUserData(j);
W.setIcon(X);
}}},destruct:function(){this._disposeObjects(i,g);
}});
})();
