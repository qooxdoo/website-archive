...
(function(){var o="",n="mshtml",m="engine.name",l="undefined",k='\\$1',j="%",h='\\\u',g='-',f='\\u',e="qx.lang.String",b="0",d="g",c=' ',a='\n';
...
},capitalize:function(u){if(this.__UD===null){var v=qx.core.Environment.get(m)==n?f:h;
...
while(i--){Q=Q.replace(new RegExp(j+(i+1),d),P[i]+o);
}return Q;
