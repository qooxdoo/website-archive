...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Tokenizer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"0439773f0b0d"},
  boot : "boot",
  bootIsInline : true,
