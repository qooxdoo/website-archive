...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Overflow-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a48d293f04fd"},
  boot : "boot",
  bootIsInline : true,
