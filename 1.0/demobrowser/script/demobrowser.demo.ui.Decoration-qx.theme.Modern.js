...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.Decoration-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"fdf92716b861"},
  boot : "boot",
  bootIsInline : true,
