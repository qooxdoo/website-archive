...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.progressive.ProgressiveTable_VarRowHeight","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"32b453f64884"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var y="row",x="small icon",w="This, too, is tall.",v="No attributes specified.",u="1*",t="demobrowser/demo/icons/",s="",q="TALL ICON",p="I am tall.",o="red",g="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",n="format-justify-left.png",l="I am small.",f="end",e="multimedia-player.png",k="This, too, is small.",h="Id",m="Image",d="Note variable row heights in this table.";
qx.Class.define(g,{extend:qx.application.Standalone,members:{__Ht:null,main:function(){arguments.callee.base.call(this);
var R=t;
this.imageData=[{url:R+n,height:4,tooltip:x},{url:R+e,height:4,tooltip:q},s];
this.__Ht=0;
...
}N=P.resolve(this.imageData[i].url);
Q=O.toUri(N);
this.imageData[i].url=Q;
++this.__Ht;
qx.io.ImageLoader.load(Q,function(L,M){this.info("Searching for ["+L+"]");
for(var j=0;j<this.imageData.length;j++){if(this.imageData[j].url==L){this.imageData[j].height=M.height;
--this.__Ht;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Ht+", end="+this.imageData.length);
if(this.__Ht==0){this.doLoad();
}return;
}}throw new Error("Image data for "+L+" not found");
},this);
}if(this.__Ht==0){this.doLoad();
}},doLoad:function(){var A=this;
var H=function(a,b){var c={renderer:y,location:f,data:[b,A.imageData[a]]};
return c;
};
var G=new qx.ui.progressive.renderer.table.Widths(2);
G.setWidth(0,200);
G.setWidth(1,u);
var C=[h,m];
var D=new qx.ui.progressive.headfoot.TableHeading(G,C);
var B=new qx.ui.progressive.headfoot.Progress(G,C);
var K=new qx.ui.progressive.structure.Default(D,B);
var z=new qx.ui.progressive.Progressive(K);
var I=new qx.ui.basic.Atom(d);
I.setHeight(16);
I.setTextColor(o);
z.add(I);
...
F.addElements(E);
z.setDataModel(F);
var J=new qx.ui.progressive.renderer.table.Row(G);
z.addRenderer(y,J);
var r=new qx.ui.progressive.renderer.table.cell.Image();
J.addRenderer(1,r);
z.set({width:400,maxWidth:400});
this.getRoot().add(z,{left:50,top:50,bottom:50});
z.render();
}}});
})();
...
(function(){var j="progressive-table-header-cell",h="resize",g="progressive-table-header",f="_layout",d="qx.ui.progressive.headfoot.TableHeading";
qx.Class.define(d,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(k,l){arguments.callee.base.call(this);
this.__Hu=k;
var n=k.getData();
this.__Hv=[];
...
m.set({height:16,appearance:j,minWidth:0,width:0});
this.add(m,{flex:1});
this.addListener(h,this._resizeColumns,this);
this.__Hw=new qx.ui.layout.HBox();
this.__Hw.connectToWidget(this);
},properties:{appearance:{refine:true,init:g}},members:{__Hu:null,__Hx:null,__Hv:null,__Hw:null,join:function(c){arguments.callee.base.call(this,c);
},getLayoutChildren:function(){if(this.__Hx){return this.__Hu.getData();
}else{return arguments.callee.base.call(this);
}},_resizeColumns:function(e){var a=this.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
this.__Hx=true;
this.__Hw.renderLayout(a,100);
this.__Hx=false;
var b=this.__Hu.getData();
for(var i=0;i<b.length;i++){this.__Hv[i].setWidth(b[i].getComputedWidth());
...
(function(){var D=".qx-progressive-",C="-col-",B="px;",A="-row",z="}",y="width: ",x="0px ",w="qx-progressive-",v="px",u="padding: ",U="px ",T="end",S="div",R="  width : 100%;",Q=" {",P="__columnData",O="relative",N="-row {",M="resize",L="start",J="",K="__HD",H="qx.ui.progressive.renderer.table.Row",I="progressive-table-row-background-odd",F="progressive-table-row-background-even",G="__HA",E="left: ";
qx.Class.define(H,{extend:qx.ui.progressive.renderer.Abstract,construct:function(V){arguments.callee.base.call(this);
this.__Hy=V;
this.__Hz={};
this.__HA=new qx.ui.progressive.renderer.table.cell.Default();
this.__HB=null;
this.__HC={};
var W=qx.theme.manager.Color.getInstance();
this.__HC.bgcol=[];
this.__HC.bgcol[0]=W.resolve(F);
this.__HC.bgcol[1]=W.resolve(I);
this.__HD=new qx.ui.layout.HBox();
this.__HD.connectToWidget(this);
},statics:{__HE:null,__HF:6,__HG:"  position: absolute;"+"  top: 0px;"+"  height: 100%;"+"  overflow:hidden;"+"  text-overflow:ellipsis;"+"  -o-text-overflow: ellipsis;"+"  white-space:nowrap;"+"  border-right:1px solid #f2f2f2;"+"  border-bottom:1px solid #eeeeee;"+"  padding : 0px 6px 0px 6px;"+"  cursor:default;"+"  font-size: 11px;"+"  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;"+(qx.core.Variant.isSet("qx.client","mshtml")?'':';-moz-user-select:none;')},properties:{defaultRowHeight:{init:16}},members:{__HB:null,__HH:null,__HI:null,__Hy:null,__Hz:null,__HA:null,__HC:null,__HD:null,join:function(bd,name){if(this.__HB){throw new Error("Renderer is already joined to a Progressive.");
}this.__HB=bd;
this.__HH=name;
var bf=qx.ui.progressive.renderer.table.Row;

if(!bf.__HE){bf.__HE={};
}var be=bd.toHashCode();

if(!bf.__HE[be]){bf.__HE[be]={rowstylesheet:null,cellstylesheet:[]};
var bg=D+be+N+R+z;
bf.__HE[be].rowstylesheet=qx.bom.Stylesheet.createElement(bg);
var bh=this.__Hy.getData();

for(var i=0;i<bh.length;i++){var bg=D+be+C+i+Q+bf.__HG+z;
bf.__HE[be].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bg);
}this.__HI=be;
var bi=bd.getStructure().getPane();
bi.addListener(M,this._resizeColumns,this);
}},addRenderer:function(p,q){var r=this.__Hy.getData();

if(p<0||p>=r.length){throw new Error("Column "+p+" out of range (max: "+(r.length-1)+")");
}this.__Hz[p]=q;
},removeRenderer:function(s){var t=this.__Hy.getData();

if(s<0||s>=t.length){throw new Error("Column "+s+" out of range (max: "+(t.length-1)+")");
}
if(!this.__Hz[s]){throw new Error("No existing renderer for column "+s);
}delete this.__Hz[s];
},render:function(a,b){var n=b.data;
var h=[];
var k;
var j;
var f=0;
if(a.getRendererData()[this.__HH].end===undefined){a.getRendererData()[this.__HH]={end:0,start:1,rows:0,totalHeight:0};
}var m=document.createElement(S);
for(var i=0;i<n.length;i++){var g=w+this.__HI+C+i;
j=this.__Hz[i]||this.__HA;
k={state:a,rowDiv:m,stylesheet:g,element:b,dataIndex:i,cellData:n[i],height:f};
h.push(j.render(k));
if(k.height>f){f=k.height;
}}f=(f>0?f:this.getDefaultRowHeight());
var l=a.getRendererData()[this.__HH];
l.totalHeight+=f;
m.style.position=O;
m.style.height=f+v;
m.className=w+this.__HI+A;
m.innerHTML=h.join(J);
switch(b.location){case T:var c=l.end||0;
m.style.backgroundColor=this.__HC.bgcol[c];
l.end=(c==0?1:0);
a.getPane().getContentElement().getDomElement().appendChild(m);
break;
case L:var d=a.getPane().getContentElement().getDomElement();
var o=d.childNodes;
if(o.length>0){var c=l.start;
m.style.backgroundColor=this.__HC.bgcol[c];
l.start=(c==0?1:0);
d.insertBefore(m,o[0]);
break;
}else{d.appendChild(m);
}break;
default:throw new Error("Invalid location: "+b.location);
}++l.rows;
},getLayoutChildren:function(){return this.__Hy.getData();
},_resizeColumns:function(e){var bq=this.__HB.getStructure().getPane();
var bn=bq.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bo=D+this.__HI+A;
var bk=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bk.__HE[this.__HI].rowstylesheet,bo);
var bm=y+bn+B;
qx.bom.Stylesheet.addRule(bk.__HE[this.__HI].rowstylesheet,bo,bm);
this.__HD.renderLayout(bn,100);
var bp=this.__Hy.getData();
for(var i=0,bt=0;i<bp.length;i++,bt+=bn){var bo=D+this.__HI+C+i;
var bk=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bk.__HE[this.__HI].cellstylesheet[i],bo);
bn=bp[i].getComputedWidth();
{};
var bl;

if(qx.bom.client.Feature.CONTENT_BOX){bl=qx.ui.progressive.renderer.table.Row.__HF*2;
}else{bl=-1;
}var bs=(bn-bl)+B;
var br=x+qx.ui.progressive.renderer.table.Row.__HF+U+x+qx.ui.progressive.renderer.table.Row.__HF+B;
var bj=bt+B;
var bm=bk.__HG+y+bs+E+bj+u+br;
qx.bom.Stylesheet.addRule(bk.__HE[this.__HI].cellstylesheet[i],bo,bm);
}}},destruct:function(){var name;

for(name in this.__Hz){this.__Hz[name]=null;
}var Y=qx.ui.progressive.renderer.table.Row;
var X=this.__HB.toHashCode();

if(Y.__HE&&Y.__HE[X]){if(Y.__HE[X].rowstylesheet){var bb=D+this.__HI+A;
var Y=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(Y.__HE[this.__HI].rowstylesheet,bb);
}if(Y.__HE[X].cellstylesheet){for(var i=Y.__HE[X].cellstylesheet.length-1;i>=0;i--){var bb=D+this.__HI+C+i;
var ba=Y.__HE[this.__HI].cellstylesheet[i];
var Y=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(ba,bb);
}}}
if(this.__HB&&this.__HB.getRendererData){var bc=this.__HB.getRendererData();

if(bc&&bc[this.__HH]&&bc[this.__HH].end!==undefined){bc[this.__HH]=null;
}}this.__HC=this.__Hz=this.__HB=this.__Hy=null;
this._disposeObjects(K,G,P);
}});
})();
(function(){var l="",k="'",j="abstract",i=">",h="</div>",g="<div ",f="' ",e="style='",d="qx.ui.progressive.renderer.table.cell.Abstract",c="class='";
qx.Class.define(d,{type:j,extend:qx.core.Object,members:{_getCellStyle:function(a){return l;
},_getCellExtras:function(b){return l;
},_getContentHtml:function(p){return p.cellData||l;
},render:function(m){var o=[];
var n=this._getCellStyle(m);
o.push(g,c,m.stylesheet,f);

if(n){o.push(e,n,k);
}o.push(this._getCellExtras(m),i,this._getContentHtml(m),h);
return o.join(l);
}}});
})();
...
(function(){var x="px'",w='" ',v='src="',u="mshtml",t="vertical-align:middle;",s="text-align:center;",r="abstract",q="",p='<img ',o=" height='",h='" style="filter:',n=" style='padding-top:2px;'",k=" title='",f=" width='",e="qx.ui.progressive.renderer.table.cell.Icon",j="'",i="qx.client",l=">",d="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",m="qx/static/blank.gif",g="',sizingMethod='scale')";
qx.Class.define(e,{type:r,extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){arguments.callee.base.call(this);
var y=qx.util.AliasManager.getInstance();
var z=qx.util.ResourceManager.getInstance();
var A=y.resolve(m);
this.__HJ=z.toUri(A);
},members:{__HJ:null,getBlankImage:function(){return this.__HJ;
},_identifyImage:function(B){throw new Error("_identifyImage() is abstract");
},_getCellStyle:function(C){var D=arguments.callee.base.call(this,C)+s+t;
return D;
},_getContentHtml:function(a){var b=[];
var c=this.__HK(a);
b.push(p);
if(qx.core.Variant.isSet(i,u)&&/\.png$/i.test(c.url)){b.push(v,this.__HJ,h,d,c.url,g,w);
}else{b.push(v,c.url,w);
}if(c.imageWidth){b.push(f,c.imageWidth,x);
}if(c.imageHeight){b.push(o,c.imageHeight,x);
}b.push(n);
if(c.tooltip){b.push(k,c.tooltip,j);
}if(c.extras){b.push(c.extras);
}b.push(l);
return b.join(q);
},__HK:function(E){var F=this._identifyImage(E);
if(F==null||typeof F=="string"){F={url:F,tooltip:null};
}if(F.url==null){F.url=this.__HJ;
}return F;
}}});
})();
(function(){var c="qx.ui.progressive.renderer.table.cell.Image",b="string",a="";
qx.Class.define(c,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(j,k){arguments.callee.base.call(this);

if(j===undefined){this.__HL=j;
}else{this.__HL=16;
}
if(k===undefined){this.__HM=k;
}else{this.__HM=16;
}},members:{__HL:null,__HM:null,_identifyImage:function(d){var h={imageWidth:this.__HL,imageHeight:this.__HM};
var i;
