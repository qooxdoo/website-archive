...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Multimedia","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Multimedia-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cf36368be21a"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(e,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
...
(function(){var k="qx.bom.client.Multimedia";
qx.Bootstrap.define(k,{statics:{__BU:{quicktime:{plugin:"QuickTime",control:"QuickTimeCheckObject.QuickTimeCheck.1"},wmv:{plugin:"Windows Media",control:"WMPlayer.OCX.7"},divx:{plugin:"DivX Web Player",control:"npdivx.DivXBrowserPlugin.1"},silverlight:{plugin:"Silverlight",control:"AgControl.AgControl"}},has:function(s,t){if(this.__BU[s]){var u=this.__BU[s];
if(u.installed){if(t==null||(u.version>=parseFloat(t))){return true;
}}}return false;
},__BV:qx.core.Variant.select("qx.client",{"mshtml":function(){var l=window.ActiveXObject;

if(!l){return;
}var n=this.__BU;
var m,o;

for(var p in n){m=n[p];

try{o=new ActiveXObject(m.control);
}catch(j){continue;
}switch(p){case "quicktime":m.version=0;
break;
case "wmv":m.version=o.versionInfo;
break;
case "divx":m.version=0;
break;
case "silverlight":try{m.version=o.version===undefined?0:o.version;
}catch(q){try{m.version=o.settings.version===undefined?0:o.settings.version;
}catch(r){m.version=0;
}}break;
}m.installed=true;
