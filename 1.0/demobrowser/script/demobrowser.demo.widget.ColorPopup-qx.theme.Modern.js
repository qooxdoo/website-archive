...
(function(){var q="current-preview",p="execute",o="selected-preview",n="Number",m="preview-pane",l="selector-button",k="colorselector-cancelbutton",h="auto-button",g="colorselector-okbutton",f="__wL",bc="mousedown",bb="teal",ba="maroon",Y="qx.ui.control.ColorPopup",X="#666",W="changeValue",V="#333",U="#000",T="yellow",S="changeGreen",x="colorpopup",y="_applyValue",v="blue",w="changeRed",t="field#",u="__wM",r="#CCC",s="Color Selector",z="changeVisibility",A="recent",H="changeBlue",F="mouseover",L="Cancel",J="#FFF",O="right",N="Open ColorSelector",C="mouseout",R="#999",Q="Automatic",P="Basic Colors",B="Preview (Old/New)",D="visible",E="Recent Colors",G="OK",I="field",K="green",M="red";
qx.Class.define(Y,{extend:qx.ui.popup.Popup,implement:[qx.ui.form.IColorForm],construct:function(){arguments.callee.base.call(this);
this.setLayout(new qx.ui.layout.VBox(5));
this._createChildControl(h);
this._createBoxes();
this._createChildControl(m);
this._createChildControl(l);
this.addListener(z,this._onChangeVisibility,this);
},properties:{appearance:{refine:true,init:x},value:{nullable:true,apply:y,event:W},red:{check:n,init:null,nullable:true,event:w},green:{check:n,init:null,nullable:true,event:S},blue:{check:n,init:null,nullable:true,event:H}},members:{__wJ:1e5,__wK:null,__wL:null,__wM:null,__wN:A,__wO:12,_createChildControlImpl:function(bw){var bx;

switch(bw){case I:bx=new qx.ui.core.Widget;
bx.addListener(bc,this._onFieldMouseDown,this);
bx.addListener(F,this._onFieldMouseOver,this);
bx.addListener(C,this._onFieldMouseOut,this);
break;
case h:bx=new qx.ui.form.Button(this.tr(Q));
bx.setAllowStretchX(true);
bx.addListener(p,this._onAutomaticBtnExecute,this);
this.add(bx);
break;
case l:bx=new qx.ui.form.Button(this.tr(N));
bx.addListener(p,this._onSelectorButtonExecute,this);
this.add(bx);
break;
case m:bx=new qx.ui.groupbox.GroupBox(this.tr(B));
bx.setLayout(new qx.ui.layout.HBox);
bx.add(this._createChildControl(o,true),{flex:1});
bx.add(this._createChildControl(q,true),{flex:1});
this.add(bx);
break;
case o:bx=new qx.ui.container.Composite(new qx.ui.layout.Basic);
break;
case q:bx=new qx.ui.container.Composite(new qx.ui.layout.Basic);
break;
case g:bx=new qx.ui.form.Button(this.tr(G));
bx.addListener(p,this._onColorSelectorOk,this);
break;
case k:bx=new qx.ui.form.Button(this.tr(L));
bx.addListener(p,this._onColorSelectorCancel,this);
break;
...
bn=new qx.ui.groupbox.GroupBox(br.label);
bn.setLayout(new qx.ui.layout.HBox);
this.__wK[bq]=bn;
this.add(bn);

for(var i=0;i<this.__wO;i++){bp=this.getChildControl(t+(j++));
bp.setBackgroundColor(br.values[i]||null);
bn.add(bp);
}}},_createColorSelector:function(){if(this.__wM){return;
}var a=new qx.ui.window.Window(this.tr(s));
this.__wL=a;
a.setLayout(new qx.ui.layout.VBox(16));
a.setResizable(false);
a.moveTo(20,20);
this.__wM=new qx.ui.control.ColorSelector;
a.add(this.__wM);
var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(8,O));
a.add(b);
var d=this._createChildControl(k);
var c=this._createChildControl(g);
b.add(d);
b.add(c);
},_applyValue:function(by,bz){if(by===null){this.setRed(null);
this.setGreen(null);
this.setBlue(null);
}else{var bA=qx.util.ColorUtil.stringToRgb(by);
this.setRed(bA[0]);
this.setGreen(bA[1]);
this.setBlue(bA[2]);
}this.getChildControl(o).setBackgroundColor(by);
this._rotatePreviousColors();
},_rotatePreviousColors:function(){if(!this._tables){return;
}var bf=this._tables[this.__wN].values;
var bg=this.__wK[this.__wN];
...
this.__wM.setGreen(bC);
this.__wM.setBlue(bB);
this.__wL.open();
},_onColorSelectorOk:function(){var bm=this.__wM;
this.setValue(qx.util.ColorUtil.rgbToRgbString([bm.getRed(),bm.getGreen(),bm.getBlue()]));
this.__wL.close();
},_onColorSelectorCancel:function(){this.__wL.close();
},_onChangeVisibility:function(e){if(this.getVisibility()==D){var bv=this.getRed();
var bu=this.getGreen();
var bs=this.getBlue();
var bt=null;

if(bv!==null||bu!==null||bs!==null){var bt=qx.util.ColorUtil.rgbToRgbString([bv,bu,bs]);
}this.getChildControl(o).setBackgroundColor(bt);
this.getChildControl(q).setBackgroundColor(bt);
}},_tables:{core:{label:P,values:[U,V,X,R,r,J,M,K,v,T,bb,ba]},recent:{label:E,values:[]}}},destruct:function(){this._disposeObjects(f,u);
this._tables=this.__wK=null;
}});
})();
