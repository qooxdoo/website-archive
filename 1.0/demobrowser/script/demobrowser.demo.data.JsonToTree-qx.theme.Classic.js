...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.JsonToTree-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"4a2be23fcc28"},
  boot : "boot",
  bootIsInline : true,
