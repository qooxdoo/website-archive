...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Grid_Animated-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"54d8841c94e5"},
  boot : "boot",
  bootIsInline : true,
...
a.setPadding(20);
this.getRoot().add(a,{left:0,top:0});
a.add(this.getAnimGrid(),{row:0,column:0});
},getNewWidget:function(){var q=new qx.ui.core.Widget().set({width:50,height:50,backgroundColor:l});
q.addListener(j,function(e){if(this._active==q){return;
}var o=[];
var m=0.3;

if(this._active){this._active.set({backgroundColor:l,width:50,height:50});
}q.set({backgroundColor:d});
var p=q.getBounds();
o.push(new demobrowser.demo.layout.Grid_Animated_Property(q,h).set({from:p.width,to:200,duration:m,transition:k}));
o.push(new demobrowser.demo.layout.Grid_Animated_Property(q,g).set({from:p.height,to:200,duration:m,transition:k}));
var n=new qx.fx.effect.core.Parallel(o[0],o[1]);
n.start();
this._active=q;
},this);
return q;
},getAnimGrid:function(){var r=new qx.ui.container.Composite().set({decorator:c,backgroundColor:i,width:500,height:500});
...
(function(){var c="qx.fx.effect.core.Parallel",b="__Br";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(e){arguments.callee.base.call(this);
this.__Br=arguments;
},members:{__Br:null,finish:function(){arguments.callee.base.call(this);
var d=this.__Br;
