...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.NamesList-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d0e56c2ba8ef"},
  boot : "boot",
  bootIsInline : true,
