...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Dock_AutoSize-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a2597ce0561f"},
  boot : "boot",
  bootIsInline : true,
