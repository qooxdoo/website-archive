...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Menu-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d9814242ca36"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var ci="execute",ch="changeValue",cg="icon/16/actions/edit-cut.png",cf="changeSelection",ce="icon/16/actions/edit-paste.png",cd="Copy",cc="Paste",cb="icon/16/actions/edit-copy.png",ca="Cut",bY="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",cp="Print",cq="Open",cn="icon/16/actions/document-new.png",co="__Iz",cl="Online Forum",cm="__It",cj="icon/16/actions/format-justify-fill.png",ck="Search in files",cr="C",cs="Left aligned",bR="Perl",bQ="View",bT="C Dialect",bS="Info...",bV="Save as...",bU="Show line numbers",bX="__Is",bW="Quickstart",bP="icon/16/actions/contact-new.png",bO="Ctrl+N",a="Actions",b="Show console",c="Search",d="Help",f="Show status bar",g="icon/16/actions/format-justify-left.png",h="ANSI to OEM",j="Centered",k="Website 3",l="Edit",cw="icon/16/actions/format-justify-center.png",cv="Ctrl+O",cu="icon/16/actions/go-previous.png",ct="C Sharp",cA="Close",cz="Split Button",cy="Website 2",cx="icon/16/actions/document-save-as.png",cC="Python",cB="icon/16/apps/utilities-help.png",K="Show tree",L="Options",I="Spaces to tabs",J="Right aligned",O="Action 1",P="OEM to ANSI",M="Line 431",N="JavaScript",G="icon",H="Action 2",t="Folder ",s="XML",v="Line 313",u="Paragraph",p="demobrowser.demo.widget.Menu",o="icon/16/actions/application-exit.png",r="C Plus Plus",q="__Iy",n="Line 26",m="Item ",U="ASCII table",V="Option 1",W="Search next...",X="Line 12",Q="Action 3",R="Replace in files",S="Uppercase",T="Ctrl+P",Y="Topics",ba="Panes",D="Justified",C="__Ix",B="Ctrl+X",A="Search previous...",z="Back",y="main",x="Show ruler",w="__Iw",F="icon/16/actions/format-justify-right.png",E="icon/16/actions/go-next.png",bb="Ctrl+Z",bc="command ",bd="Option 3",be="Next",bf="Ctrl+R",bg="Show macros",bh="Show tags",bi="Capitals",bj="Format",bk="File",by="Show tabs",bx="Tabs to spaces",bw="Search...",bv="__Iv",bC="Line 1039",bB="Option 2",bA="Objective C",bz="Exit",bE="move to",bD="Ctrl+S",bL="Syntax",bM="Ctrl+C",bJ="Website 1",bK="Menu Button",bH="Line 30",bI="Lowercase",bF="Replace",bG="__Iu",bN="HTML";
qx.Class.define(p,{extend:qx.application.Standalone,members:{__Is:null,__It:null,__Iu:null,__Iv:null,__Iw:null,__Ix:null,__Iy:null,__Iz:null,main:function(){arguments.callee.base.call(this);
var ea=new qx.ui.container.Scroll();
var dY=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
dY.setPadding(20);
dY.setAllowStretchX(false);
ea.add(dY);
this.getRoot().add(ea,{edge:0});
this.createCommands();
dY.add(this.getMenuButton(),{left:20,top:20});
dY.add(this.getSplitButton(),{left:150,top:20});
dY.add(this.getMenuBar(),{left:20,top:100});
dY.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var dJ=new qx.ui.menu.Menu();
var dK=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){dK.add(new qx.ui.menu.Button(t+(i+1)));
}dJ.add(new qx.ui.menu.Button(bE,null,null,dK));
dJ.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){dJ.add(new qx.ui.menu.Button(bc+(i+1)));
}return dJ;
...
},createCommands:function(){this.__Is=new qx.ui.core.Command(bO);
this.__Is.addListener(ci,this.debugCommand);
this.__It=new qx.ui.core.Command(cv);
this.__It.addListener(ci,this.debugCommand);
this.__Iu=new qx.ui.core.Command(bD);
this.__Iu.addListener(ci,this.debugCommand);
this.__Iv=new qx.ui.core.Command(bb);
this.__Iv.addListener(ci,this.debugCommand);
this.__Iw=new qx.ui.core.Command(bf);
this.__Iw.addListener(ci,this.debugCommand);
this.__Ix=new qx.ui.core.Command(B);
this.__Ix.addListener(ci,this.debugCommand);
this.__Iy=new qx.ui.core.Command(bM);
this.__Iy.addListener(ci,this.debugCommand);
this.__Iz=new qx.ui.core.Command(T);
this.__Iz.addListener(ci,this.debugCommand);
this.__Iz.setEnabled(false);
},getMenuButton:function(){var dv=new qx.ui.menu.Menu;
dv.add(new qx.ui.menu.RadioButton(V));
dv.add(new qx.ui.menu.RadioButton(bB));
dv.add(new qx.ui.menu.RadioButton(bd));
var dD=new qx.ui.menu.Menu;
dD.add(new qx.ui.menu.RadioButton(O));
dD.add(new qx.ui.menu.RadioButton(H));
dD.add(new qx.ui.menu.RadioButton(Q));
var dC=new qx.ui.form.RadioGroup;
dC.add.apply(dC,dv.getChildren());
dC.addListener(cf,this.debugRadio);
var dA=new qx.ui.form.RadioGroup;
dA.add.apply(dA,dD.getChildren());
dA.addListener(cf,this.debugRadio);
var dy=new qx.ui.menu.Menu();
var dB=new qx.ui.menu.Button(bt,bn,this.__Iv);
var dI=new qx.ui.menu.Button(br,bl,this.__Iw);
var dx=new qx.ui.menu.Button(ca,cg,this.__Ix);
var dF=new qx.ui.menu.Button(cd,cb,this.__Iy);
var dz=new qx.ui.menu.Button(cc,ce,this.__Iz);
var dw=new qx.ui.menu.Button(L,bY,null,dv);
var dG=new qx.ui.menu.Button(a,bP,null,dD);
var dE=new qx.ui.menu.Button(cp,bp);
dB.addListener(ci,this.debugButton);
dI.addListener(ci,this.debugButton);
dx.addListener(ci,this.debugButton);
dF.addListener(ci,this.debugButton);
dz.addListener(ci,this.debugButton);
dw.addListener(ci,this.debugButton);
...
dy.addSeparator();
dy.add(dE);
var dH=new qx.ui.form.MenuButton(bK,bq,dy);
return dH;
},getSplitButton:function(){var da=new qx.ui.menu.Menu;
var de=new qx.ui.menu.Button(bJ);
var dc=new qx.ui.menu.Button(cy);
var dd=new qx.ui.menu.Button(k);
da.setMinWidth(120);
de.addListener(ci,this.debugButton);
...
da.add(dc);
da.add(dd);
var db=new qx.ui.form.SplitButton(cz,bq,da);
db.addListener(ci,this.debugButton);
return db;
},getMenuBar:function(){var cO=new qx.ui.container.Composite(new qx.ui.layout.Grow);
cO.setDecorator(y);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
cO.add(toolbar);
var cX=new qx.ui.toolbar.Part;
var cN=new qx.ui.toolbar.Part;
var cR=new qx.ui.toolbar.Part;
toolbar.add(cX);
toolbar.add(cN);
toolbar.addSpacer();
toolbar.add(cR);
var cW=new qx.ui.toolbar.SplitButton(z,cu,this.getBackMenu());
var cT=new qx.ui.toolbar.SplitButton(be,E,this.getForwardMenu());
var cM=new qx.ui.toolbar.Button(bu,cn,this.__Is);
var cQ=new qx.ui.toolbar.Button(cq,bo,this.__It);
var cV=new qx.ui.toolbar.Button(bm,bs,this.__Iu);
cW.addListener(ci,this.debugButton);
cT.addListener(ci,this.debugButton);
cM.addListener(ci,this.debugButton);
cQ.addListener(ci,this.debugButton);
cV.addListener(ci,this.debugButton);
cX.add(cW);
cX.add(cT);
cX.addSeparator();
cX.add(cM);
...
cX.add(cV);
cX.setShow(G);
var cP=new qx.ui.toolbar.MenuButton(bk);
var cL=new qx.ui.toolbar.MenuButton(l);
var cK=new qx.ui.toolbar.MenuButton(c);
var cY=new qx.ui.toolbar.MenuButton(bQ);
var cU=new qx.ui.toolbar.MenuButton(bj);
cP.setMenu(this.getFileMenu());
cL.setMenu(this.getEditMenu());
cK.setMenu(this.getSearchMenu());
cY.setMenu(this.getViewMenu());
cU.setMenu(this.getFormatMenu());
cN.add(cP);
cN.add(cL);
cN.add(cK);
cN.add(cY);
cN.add(cU);
var cS=new qx.ui.toolbar.MenuButton(d);
cS.setMenu(this.getHelpMenu());
cR.add(cS);
return cO;
},getBackMenu:function(){var eu=new qx.ui.menu.Menu;
var ev=new qx.ui.menu.Button(v);
var ex=new qx.ui.menu.Button(bC);
var et=new qx.ui.menu.Button(X);
var ew=new qx.ui.menu.Button(n);
ev.addListener(ci,this.debugButton);
ex.addListener(ci,this.debugButton);
et.addListener(ci,this.debugButton);
...
eu.add(ew);
return eu;
},getForwardMenu:function(){var eL=new qx.ui.menu.Menu;
var eM=new qx.ui.menu.Button(M);
var eN=new qx.ui.menu.Button(bH);
eM.addListener(ci,this.debugButton);
eN.addListener(ci,this.debugButton);
eL.add(eM);
eL.add(eN);
return eL;
},getFileMenu:function(){var dS=new qx.ui.menu.Menu;
var dQ=new qx.ui.menu.Button(bu,cn,this.__Is);
var dU=new qx.ui.menu.Button(cq,bo,this.__It);
var dT=new qx.ui.menu.Button(cA);
var dX=new qx.ui.menu.Button(bm,bs,this.__Iu);
var dW=new qx.ui.menu.Button(bV,cx);
var dV=new qx.ui.menu.Button(cp,bp);
var dR=new qx.ui.menu.Button(bz,o);
dQ.addListener(ci,this.debugButton);
...
dS.add(dR);
return dS;
},getEditMenu:function(){var eA=new qx.ui.menu.Menu;
var eD=new qx.ui.menu.Button(bt,bn,this.__Iv);
var eC=new qx.ui.menu.Button(br,bl,this.__Iw);
var ez=new qx.ui.menu.Button(ca,cg,this.__Ix);
var eE=new qx.ui.menu.Button(cd,cb,this.__Iy);
var eB=new qx.ui.menu.Button(cc,ce,this.__Iz);
eD.addListener(ci,this.debugButton);
eC.addListener(ci,this.debugButton);
ez.addListener(ci,this.debugButton);
eE.addListener(ci,this.debugButton);
...
eA.add(eB);
return eA;
},getSearchMenu:function(){var dr=new qx.ui.menu.Menu;
var dp=new qx.ui.menu.Button(bw,bY);
var du=new qx.ui.menu.Button(W);
var dq=new qx.ui.menu.Button(A);
var dt=new qx.ui.menu.Button(bF);
var dn=new qx.ui.menu.Button(ck,bY);
var ds=new qx.ui.menu.Button(R);
dq.setEnabled(false);
...
dr.add(ds);
return dr;
},getViewMenu:function(){var eF=new qx.ui.menu.Menu;
var eH=new qx.ui.menu.Button(ba,null,null,this.getPanesMenu());
var eK=new qx.ui.menu.Button(bL,null,null,this.getSyntaxMenu());
var eJ=new qx.ui.menu.CheckBox(x);
var eI=new qx.ui.menu.CheckBox(bU);
var eG=new qx.ui.menu.Button(U);
eJ.addListener(ch,this.debugCheckBox);
eI.addListener(ch,this.debugCheckBox);
...
eF.add(eG);
return eF;
},getPanesMenu:function(){var cE=new qx.ui.menu.Menu;
var cG=new qx.ui.menu.CheckBox(by);
var cI=new qx.ui.menu.CheckBox(f);
var cJ=new qx.ui.menu.CheckBox(K);
var cF=new qx.ui.menu.CheckBox(bg);
var cH=new qx.ui.menu.CheckBox(bh);
var cD=new qx.ui.menu.CheckBox(b);
cG.setValue(true);
cI.setValue(true);
cF.setValue(true);
cG.addListener(ch,this.debugCheckBox);
cI.addListener(ch,this.debugCheckBox);
cJ.addListener(ch,this.debugCheckBox);
cF.addListener(ch,this.debugCheckBox);
cH.addListener(ch,this.debugCheckBox);
cD.addListener(ch,this.debugCheckBox);
cE.add(cI);
cE.add(cG);
cE.addSeparator();
cE.add(cJ);
...
cE.add(cD);
return cE;
},getSyntaxMenu:function(){var dj=new qx.ui.menu.Menu;
var df=new qx.ui.menu.RadioButton(bN);
var dh=new qx.ui.menu.RadioButton(s);
var dg=new qx.ui.menu.RadioButton(N);
var di=new qx.ui.menu.Button(bT,null,null,this.getSyntaxCMenu());
var dm=new qx.ui.menu.RadioButton(bR);
var dk=new qx.ui.menu.RadioButton(cC);
dj.add(df);
dj.add(dh);
dj.add(dg);
dj.add(di);
dj.add(dm);
dj.add(dk);
var dl=new qx.ui.form.RadioGroup;
dl.add(df,dh,dg,dm,dk);
dl.add.apply(dl,di.getMenu().getChildren());
dl.addListener(cf,this.debugRadio);
return dj;
},getSyntaxCMenu:function(){var ep=new qx.ui.menu.Menu;
var eo=new qx.ui.menu.RadioButton(cr);
var es=new qx.ui.menu.RadioButton(ct);
var er=new qx.ui.menu.RadioButton(bA);
var eq=new qx.ui.menu.RadioButton(r);
ep.add(eo);
ep.add(es);
ep.add(er);
ep.add(eq);
return ep;
},getFormatMenu:function(){var ei=new qx.ui.menu.Menu;
var eh=new qx.ui.menu.Button(u,null,null,this.getParagraphMenu());
var ek=new qx.ui.menu.Button(bx);
var el=new qx.ui.menu.Button(I);
var eg=new qx.ui.menu.Button(S);
var ej=new qx.ui.menu.Button(bI);
var ef=new qx.ui.menu.Button(bi);
var en=new qx.ui.menu.Button(P);
var em=new qx.ui.menu.Button(h);
ek.addListener(ci,this.debugButton);
el.addListener(ci,this.debugButton);
eg.addListener(ci,this.debugButton);
ej.addListener(ci,this.debugButton);
...
var dO=new qx.ui.menu.Button(cs,g);
var dP=new qx.ui.menu.Button(J,F);
var dM=new qx.ui.menu.Button(j,cw);
var dN=new qx.ui.menu.Button(D,cj);
...
dL.add(dN);
return dL;
},getHelpMenu:function(){var eO=new qx.ui.menu.Menu;
var eQ=new qx.ui.menu.Button(Y,cB);
var eS=new qx.ui.menu.Button(bW);
var eR=new qx.ui.menu.Button(cl);
var eP=new qx.ui.menu.Button(bS);
eQ.addListener(ci,this.debugButton);
eS.addListener(ci,this.debugButton);
eR.addListener(ci,this.debugButton);
eP.addListener(ci,this.debugButton);
eO.add(eQ);
eO.add(eS);
eO.addSeparator();
eO.add(eR);
...
eO.add(eP);
return eO;
},getList:function(){var ey=new qx.ui.form.List;
ey.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){ey.add(new qx.ui.form.ListItem(m+i));
}return ey;
},getContextMenu:function(){var eb=new qx.ui.menu.Menu;
var ed=new qx.ui.menu.Button(ca,cg,this.__Ix);
var ee=new qx.ui.menu.Button(cd,cb,this.__Iy);
var ec=new qx.ui.menu.Button(cc,ce,this.__Iz);
ed.addListener(ci,this.debugButton);
ee.addListener(ci,this.debugButton);
ec.addListener(ci,this.debugButton);
eb.add(ed);
...
eb.add(ec);
return eb;
}},destruct:function(){this._disposeObjects(bX,cm,bG,bv,w,C,q,co);
}});
})();
...
}},_applyEnabled:function(j,k){if(j){qx.event.Registration.addListener(document.documentElement,r,this.__nk,this);
...
for(var i=0;i<f;i++){var h=this.__no(a[i]);

switch(h){case p:case A:case U:case P:this.__ni[h]=true;
break;
case v:var g=O+a[i];
this.error(g);
throw g;
default:if(this.__nj){var g=B;
this.error(g);
throw g;
}this.__nj=h;
}}}return true;
...
return this.__nm(e);
},__nm:function(e){var bi=this.__nj;
...
},__nn:{esc:bd,ctrl:p,print:ba,del:R,pageup:m,pagedown:H,numlock:Y,numpad_0:T,numpad_1:M,numpad_2:C,numpad_3:y,numpad_4:N,numpad_5:X,numpad_6:K,numpad_7:Q,numpad_8:W,numpad_9:J,numpad_divide:z,numpad_multiply:F,numpad_minus:n,numpad_plus:t},__no:function(bj){var bk=qx.event.handler.Keyboard;
var bl=v;
...
var bl=this.__nn[bj]||qx.lang.String.firstUp(bj);

if(bk.isValidKeyIdentifier(bl)){return bl;
}else{return v;
}},toString:function(){var bh=this.__nj;
var bg=[];

for(var bf in this.__ni){if(this.__ni[bf]){bg.push(qx.locale.Key.getKeyName(s,bf));
}}
