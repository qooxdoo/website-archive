...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Percent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"ebc9f86007c9"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="main",n="green",m="33%",l="yellow",k="50%",j="demobrowser.demo.layout.HBox_Percent";
...
a.add(this.getBox5());
a.add(this.getBox6());
},getBox1:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:l,width:500,allowGrowX:false});
var A=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var z=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var x=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
y.add(A,{width:k});
y.add(z,{flex:1});
y.add(x,{flex:1});
return y;
},getBox2:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:l,width:500,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var t=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
u.add(w,{width:m});
u.add(v,{width:m});
u.add(t,{width:m,flex:1});
return u;
},getBox3:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:l,allowGrowX:false});
var E=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var D=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var B=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
C.add(E,{width:k});
C.add(D,{flex:1});
C.add(B,{flex:1});
return C;
},getBox4:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:l,allowGrowX:false});
var i=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var h=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var f=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
g.add(i,{width:m,flex:1});
g.add(h,{width:m,flex:1});
g.add(f,{width:m,flex:1});
return g;
},getBox5:function(){var c=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:l,width:200,allowGrowX:false});
var e=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var d=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var b=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
c.add(e,{width:m,flex:1});
c.add(d,{width:m,flex:1});
c.add(b,{width:m,flex:1});
return c;
},getBox6:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:o,backgroundColor:l,width:500,allowGrowX:false});
var s=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var r=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var p=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
q.add(s,{width:m,flex:1});
q.add(r,{width:m,flex:1});
q.add(p,{width:m,flex:1});
return q;
}}});
})();
