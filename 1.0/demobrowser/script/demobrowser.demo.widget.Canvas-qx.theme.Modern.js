...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Canvas-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"de32300800c6"},
  boot : "boot",
  bootIsInline : true,
