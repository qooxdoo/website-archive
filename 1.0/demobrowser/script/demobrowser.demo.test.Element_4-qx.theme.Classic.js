...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_4-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"771f826a4348"},
  boot : "boot",
  bootIsInline : true,
