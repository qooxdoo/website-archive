...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.showcase.Form-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"2fc5af354779"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var H="placeholder",G="Button",F="CheckBox:",E="TextArea:",D="Boolean",C="RepeatButton:",B="execute",A="Website 2",z="Text",y="ToggleButton",bq="password",bp="RadioButton 3",bo="Button:",bn="ComboBox:",bm="ToggleButton:",bl="Options",bk="RadioButton",bj="0",bi="MenuButton:",bh="demobrowser.demo.showcase.Form",O="PasswordField:",P="SplitButton",M="Buttons",N="",K="RadioButtons:",L="dd.mm.YYYY",I="List:",J="SplitButton:",Q="Option",R="RadioButton 1",Y="Spinner:",W="Selection",bb="DateField:",ba="RadioButton 2",bd="Number",bc="CheckBox",T="SelectBox:",bg="Website 3",bf="MenuButton",be="Website 1",S="Slider:",U="TextField:",V="Item ",X="RadioButtonGroup:";
qx.Class.define(bh,{extend:qx.application.Standalone,statics:{ITEM_SIZE:5},members:{main:function(){arguments.callee.base.call(this);
var a=new qx.ui.groupbox.GroupBox(z);
a.setLayout(new qx.ui.layout.Grid(8,8));
a.setWidth(290);
this.getRoot().add(a,{left:20,top:10});
var x=new qx.ui.form.TextField();
x.setPlaceholder(H);
var j=new qx.ui.basic.Label(U);
j.setBuddy(x);
a.add(j,{row:0,column:0});
a.add(x,{row:0,column:1});
var g=new qx.ui.form.PasswordField();
g.setPlaceholder(bq);
j=new qx.ui.basic.Label(O);
j.setBuddy(g);
a.add(j,{row:1,column:0});
a.add(g,{row:1,column:1});
var b=new qx.ui.form.TextArea();
b.setPlaceholder(H);
j=new qx.ui.basic.Label(E);
j.setBuddy(b);
a.add(j,{row:2,column:0});
a.add(b,{row:2,column:1});
var c=new qx.ui.form.ComboBox();
c.setPlaceholder(H);
j=new qx.ui.basic.Label(bn);
j.setBuddy(c);
a.add(j,{row:3,column:0});
a.add(c,{row:3,column:1});
this.createItems(c);
var q=new qx.ui.form.DateField();
q.setPlaceholder(L);
j=new qx.ui.basic.Label(bb);
j.setBuddy(q);
a.add(j,{row:4,column:0});
a.add(q,{row:4,column:1});
var h=new qx.ui.groupbox.GroupBox(W);
h.setLayout(new qx.ui.layout.Grid(8,8));
h.setWidth(290);
this.getRoot().add(h,{left:20,top:250});
var r=new qx.ui.form.SelectBox();
j=new qx.ui.basic.Label(T);
j.setBuddy(r);
h.add(j,{row:0,column:0});
h.add(r,{row:0,column:1});
this.createItems(r);
var w=new qx.ui.form.List();
w.setHeight(60);
w.setWidth(155);
j=new qx.ui.basic.Label(I);
j.setBuddy(w);
h.add(j,{row:1,column:0});
h.add(w,{row:1,column:1});
this.createItems(w);
var p=new qx.ui.form.RadioButtonGroup();
p.add(new qx.ui.form.RadioButton(R));
p.add(new qx.ui.form.RadioButton(ba));
p.add(new qx.ui.form.RadioButton(bp));
j=new qx.ui.basic.Label(X);
j.setBuddy(p);
h.add(j,{row:2,column:0});
h.add(p,{row:2,column:1});
var u=new qx.ui.groupbox.GroupBox(M);
u.setLayout(new qx.ui.layout.Grid(8,8));
u.setWidth(210);
this.getRoot().add(u,{left:330,top:10});
var v=new qx.ui.form.Button(G);
j=new qx.ui.basic.Label(bo);
j.setBuddy(v);
u.add(j,{row:0,column:0});
u.add(v,{row:0,column:1});
var e=new qx.ui.form.ToggleButton(y);
j=new qx.ui.basic.Label(bm);
j.setBuddy(e);
u.add(j,{row:1,column:0});
u.add(e,{row:1,column:1});
var m=new qx.ui.form.RepeatButton(bj);
j=new qx.ui.basic.Label(C);
j.setBuddy(m);
u.add(j,{row:2,column:0});
u.add(m,{row:2,column:1});
var n=new qx.ui.form.MenuButton(bf,null,this.createMenuForMenuButton());
j=new qx.ui.basic.Label(bi);
j.setBuddy(n);
u.add(j,{row:3,column:0});
u.add(n,{row:3,column:1});
var f=new qx.ui.form.SplitButton(P,null,this.createMenuForSplitButton());
j=new qx.ui.basic.Label(J);
j.setBuddy(f);
u.add(j,{row:4,column:0});
u.add(f,{row:4,column:1});
m.addListener(B,function(){var by=parseInt(m.getLabel())+1;
m.setLabel(by.toString());
});
var d=new qx.ui.groupbox.GroupBox(D);
d.setLayout(new qx.ui.layout.Grid(8,8));
d.setWidth(210);
this.getRoot().add(d,{left:330,top:210});
var s=new qx.ui.form.CheckBox(bc);
j=new qx.ui.basic.Label(F);
j.setBuddy(s);
d.add(j,{row:0,column:0});
d.add(s,{row:0,column:1});
var l=new qx.ui.form.RadioButton(bk);
d.add(new qx.ui.basic.Label(K),{row:1,column:0});
d.add(l,{row:1,column:1});
var t=new qx.ui.groupbox.GroupBox(bd);
t.setLayout(new qx.ui.layout.Grid(8,8));
t.setWidth(210);
this.getRoot().add(t,{left:330,top:310});
var k=new qx.ui.form.Spinner(0,50,100);
j=new qx.ui.basic.Label(Y);
j.setBuddy(k);
t.add(j,{row:0,column:0});
t.add(k,{row:0,column:1});
var o=new qx.ui.form.Slider();
o.setWidth(130);
j=new qx.ui.basic.Label(S);
j.setBuddy(o);
t.add(j,{row:1,column:0});
t.add(o,{row:1,column:1});
},createItems:function(bw){for(var i=0;i<arguments.callee.self.ITEM_SIZE;i++){var bx=new qx.ui.form.ListItem(V+i);
bw.add(bx);
}},createMenuForMenuButton:function(){var br=new qx.ui.menu.Menu;

for(var i=0;i<3;i++){br.add(new qx.ui.menu.RadioButton(Q+i));
}var bu=new qx.ui.form.RadioGroup;
bu.add.apply(bu,br.getChildren());
var bt=new qx.ui.menu.Menu();

for(var i=0;i<3;i++){var bv=new qx.ui.menu.Button(G+i);
bt.add(bv);
}var bs=new qx.ui.menu.Button(bl,N,null,br);
bt.addSeparator();
bt.add(bs);
return bt;
},createMenuForSplitButton:function(){var bz=new qx.ui.menu.Menu;
var bC=new qx.ui.menu.Button(be);
var bA=new qx.ui.menu.Button(A);
var bB=new qx.ui.menu.Button(bg);
bz.add(bC);
bz.add(bA);
bz.add(bB);
return bz;
...
(function(){var B="textfield",A="button",z="list",y="selected",x="focusout",w="inner",v="changeValue",u="popup",t="focusin",s="combobox",l="click",r="blur",o="Enter",k="quick",j="_applyPlaceholder",n="qx.ui.form.ComboBox",m="single",p="Down",i="String",q="qx.event.type.Data";
qx.Class.define(n,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.form.IStringForm],construct:function(){arguments.callee.base.call(this);
var h=this._createChildControl(B);
this._createChildControl(A);
this.addListener(l,this._onClick);
this.addListener(t,function(e){h.fireNonBubblingEvent(t,qx.event.type.Focus);
},this);
this.addListener(x,function(e){h.fireNonBubblingEvent(x,qx.event.type.Focus);
},this);
},properties:{appearance:{refine:true,init:s},placeholder:{check:i,nullable:true,apply:j}},events:{"changeValue":q},members:{__rA:null,__rB:null,_applyPlaceholder:function(f,g){this.getChildControl(B).setPlaceholder(f);
},_createChildControlImpl:function(F){var G;

switch(F){case B:G=new qx.ui.form.TextField();
G.setFocusable(false);
G.addState(w);
G.addListener(v,this._onTextFieldChangeValue,this);
G.addListener(r,this.close,this);
this._add(G,{flex:1});
break;
...
this._add(G);
break;
case z:G=arguments.callee.base.call(this,F);
G.setSelectionMode(m);
break;
}return G||arguments.callee.base.call(this,F);
},_forwardStates:{focused:true},tabFocus:function(){var L=this.getChildControl(B);
L.getFocusElement().focus();
L.selectAllText();
},setValue:function(R){var S=this.getChildControl(B);

if(S.getValue()==R){return;
}S.setValue(R);
},getValue:function(){return this.getChildControl(B).getValue();
},resetValue:function(){this.getChildControl(B).setValue(null);
},_onKeyPress:function(e){var b=this.getChildControl(u);
var a=e.getKeyIdentifier();

if(a==p&&e.isAltPressed()){this.getChildControl(A).addState(y);
this.toggle();
e.stopPropagation();
}else if(a==o){if(b.isVisible()){this.close();
e.stop();
}}else if(b.isVisible()){arguments.callee.base.call(this,e);
}},_onClick:function(e){var c=e.getTarget();

if(c==this.getChildControl(A)){this.toggle();
}else{this.close();
}},_onListMouseDown:function(e){if(this.__rA){var d=this.__rA.getLabel();

if(this.getFormat()!=null){d=this.getFormat().call(this,this.__rA);
}if(d&&d.translate){d=d.translate();
}this.setValue(d);
this.__rA=null;
}},_onListChangeSelection:function(e){var C=e.getData();

if(C.length>0){var D=this.getChildControl(z);

if(D.getSelectionContext()==k){this.__rA=C[0];
}else{var E=C[0].getLabel();

if(this.getFormat()!=null){E=this.getFormat().call(this,C[0]);
}if(E&&E.translate){E=E.translate();
}this.setValue(E);
this.__rA=null;
}}},_onPopupChangeVisibility:function(e){var I=this.getChildControl(u);

if(I.isVisible()){var J=this.getChildControl(z);
var K=this.getValue();
var H=null;

if(K){H=J.findItem(K);
}
if(H){J.setSelection([H]);
}else{J.resetSelection();
}}else{this.tabFocus();
}this.getChildControl(A).removeState(y);
},_onTextFieldChangeValue:function(e){var O=e.getData();
var N=this.getChildControl(z);

if(O!=null){var M=N.findItem(O,false);

if(M){N.setSelection([M]);
}else{N.resetSelection();
}}else{N.resetSelection();
}this.fireDataEvent(v,O,e.getOldData());
},getTextSelection:function(){return this.getChildControl(B).getTextSelection();
},getTextSelectionLength:function(){return this.getChildControl(B).getTextSelectionLength();
},setTextSelection:function(P,Q){this.getChildControl(B).setTextSelection(P,Q);
},clearTextSelection:function(){this.getChildControl(B).clearTextSelection();
},selectAllText:function(){this.getChildControl(B).selectAllText();
}}});
})();
...
(function(){var p="list",o="textfield",n="popup",m="Down",l="",k="Escape",j="qx.util.format.DateFormat",i="changeValue",h="Left",g="Up",B="execute",A="changeLocale",z="_applyDateFormat",y="changeVisibility",x="qx.dynlocale",w="medium",v="mouseup",u="qx.ui.form.DateField",t="datefield",s="hidden",q="on",r="Right";
qx.Class.define(u,{extend:qx.ui.form.ComboBox,implement:[qx.ui.form.IDateForm],construct:function(){arguments.callee.base.call(this);
this.setDateFormat(qx.ui.form.DateField.getDefaultDateFormatter());
if(qx.core.Variant.isSet(x,q)){qx.locale.Manager.getInstance().addListener(A,function(){this.setDateFormat(qx.ui.form.DateField.getDefaultDateFormatter());
},this);
}},properties:{appearance:{refine:true,init:t},dateFormat:{check:j,apply:z}},statics:{__wv:null,__ww:null,getDefaultDateFormatter:function(){var C=qx.locale.Date.getDateFormat(w).toString();

if(C==this.__wv){return this.__ww;
}
if(this.__ww){this.__ww.dispose();
}this.__ww=new qx.util.format.DateFormat(C,qx.locale.Manager.getInstance().getLocale());
this.__wv=C;
return this.__ww;
}},members:{setValue:function(G){var H=this.getChildControl(o);
H.setValue(this.getDateFormat().format(G));
var I=this.getChildControl(p);
I.setValue(G);
},getValue:function(){var U=this.getChildControl(o).getValue();
try{return this.getDateFormat().parse(U);
}catch(F){return null;
}},resetValue:function(){var a=this.getChildControl(o);
a.setValue(l);
var b=this.getChildControl(p);
b.setValue(null);
},_applyDateFormat:function(P,Q){try{var S=this.getChildControl(o);
var T=S.getValue();
var R=Q.parse(T);
S.setValue(P.format(R));
}catch(N){}},_createChildControlImpl:function(D){var E;

switch(D){case p:E=new qx.ui.control.DateChooser();
E.setFocusable(false);
E.setKeepFocus(true);
E.addListener(B,this._onChangeDate,this);
break;
case n:E=new qx.ui.popup.Popup(new qx.ui.layout.VBox);
E.setAutoHide(false);
E.add(this.getChildControl(p));
E.addListener(v,this._onChangeDate,this);
E.addListener(y,this._onPopupChangeVisibility,this);
break;
}return E||arguments.callee.base.call(this,D);
},_onChangeDate:function(e){var L=this.getChildControl(o);
var M=this.getChildControl(p).getValue();
L.setValue(this.getDateFormat().format(M));
this.close();
},_onKeyPress:function(e){var J=e.getKeyIdentifier();

if(J==m&&e.isAltPressed()){this.toggle();
e.stopPropagation();
return;
}var K=this.getChildControl(n);

if(K.getVisibility()==s){return;
}if(J==k){this.close();
e.stopPropagation();
return;
}if(J===h||J===r||J===m||J===g){e.preventDefault();
}this.getChildControl(p).handleKeyPress(e);
},_onPopupChangeVisibility:function(e){var d=this.getChildControl(n);

if(d.isVisible()){var f=this.getChildControl(p);
var c=this.getValue();
f.setValue(c);
}},_onTextFieldChangeValue:function(e){var V=this.getValue();

if(V!=null){var W=this.getChildControl(p);
W.setValue(V);
}this.fireDataEvent(i,this.getValue());
},isEmpty:function(){var O=this.getChildControl(o).getValue();
return O==null||O==l;
}}});
})();
...
(function(){var u="selected",t="click",s="last-month-button",r="default",q="next-month-button",p="otherMonth",o="month-year-label",n="last-year-button",m="navigation-bar",l="next-year-button",bu="date-pane",bt="PageUp",bs="mousedown",br="today",bq="Integer",bp="PageDown",bo="changeLocale",bn="next-month-button-tooltip",bm="last-month-button-tooltip",bl="qx.dynlocale",D="last-year-button-tooltip",E="next-year-button-tooltip",B="on",C="weekend",z="day",A="lastMonth",v="Next month",w="Escape",H="Left",I="weekday",Q="changeValue",O="Space",Y="Down",T="qx.ui.control.DateChooser",bh="Date",be="Enter",K="dblclick",bk="day#",bj="Next year",bi="ww",J="_applyValue",M="Up",N="weekday#",P="datechooser",R="header",U="week",bb="lastYear",bg="nextYear",F="changeShownYear",G="week#",L="Last month",X="Right",W="Last year",V="EE",bd="mouseup",bc="keypress",S="",ba="nextMonth",k="week#0",bf="changeShownMonth";
qx.Class.define(T,{extend:qx.ui.core.Widget,include:[qx.ui.core.MExecutable,qx.ui.form.MForm],implement:[qx.ui.form.IExecutable,qx.ui.form.IForm,qx.ui.form.IDateForm],construct:function(a){arguments.callee.base.call(this);
var c=new qx.ui.layout.VBox();
this._setLayout(c);
this._createChildControl(m);
this._createChildControl(bu);
this.addListener(bc,this._onKeyPress);
var b=(a!=null)?a:new Date();
this.showMonth(b.getMonth(),b.getFullYear());
if(qx.core.Variant.isSet(bl,B)){qx.locale.Manager.getInstance().addListener(bo,this._updateDatePane,this);
}this.addListener(bs,this._onMouseUpDown,this);
this.addListener(bd,this._onMouseUpDown,this);
},statics:{MONTH_YEAR_FORMAT:qx.locale.Date.getDateTimeFormat("yyyyMMMM","MMMM yyyy")},properties:{appearance:{refine:true,init:P},width:{refine:true,init:200},height:{refine:true,init:150},shownMonth:{check:bq,init:null,nullable:true,event:bf},shownYear:{check:bq,init:null,nullable:true,event:F},value:{check:bh,init:null,nullable:true,event:Q,apply:J}},members:{__ws:null,__wt:null,__wu:null,_forwardStates:{invalid:true},_createChildControlImpl:function(bz){var bA;

switch(bz){case m:bA=new qx.ui.container.Composite(new qx.ui.layout.HBox());
bA.add(this.getChildControl(n));
bA.add(this.getChildControl(s));
bA.add(this.getChildControl(o),{flex:1});
bA.add(this.getChildControl(q));
bA.add(this.getChildControl(l));
this._add(bA);
break;
case D:bA=new qx.ui.tooltip.ToolTip(this.tr(W));
break;
case n:bA=new qx.ui.form.Button();
bA.addState(bb);
bA.setFocusable(false);
bA.setToolTip(this.getChildControl(D));
bA.addListener(t,this._onNavButtonClicked,this);
break;
case bm:bA=new qx.ui.tooltip.ToolTip(this.tr(L));
break;
case s:bA=new qx.ui.toolbar.Button();
bA.addState(A);
bA.setFocusable(false);
bA.setToolTip(this.getChildControl(bm));
bA.addListener(t,this._onNavButtonClicked,this);
break;
case bn:bA=new qx.ui.tooltip.ToolTip(this.tr(v));
break;
case q:bA=new qx.ui.toolbar.Button();
bA.addState(ba);
bA.setFocusable(false);
bA.setToolTip(this.getChildControl(bn));
bA.addListener(t,this._onNavButtonClicked,this);
break;
case E:bA=new qx.ui.tooltip.ToolTip(this.tr(bj));
break;
case l:bA=new qx.ui.toolbar.Button();
bA.addState(bg);
bA.setFocusable(false);
bA.setToolTip(this.getChildControl(E));
bA.addListener(t,this._onNavButtonClicked,this);
break;
case o:bA=new qx.ui.basic.Label();
...
bA.setCursor(r);
break;
case I:bA=new qx.ui.basic.Label();
bA.setAllowGrowX(true);
bA.setAllowGrowY(true);
bA.setSelectable(false);
bA.setAnonymous(true);
bA.setCursor(r);
break;
case z:bA=new qx.ui.basic.Label();
bA.setAllowGrowX(true);
bA.setAllowGrowY(true);
bA.setCursor(r);
bA.addListener(bs,this._onDayClicked,this);
bA.addListener(K,this._onDayDblClicked,this);
break;
case bu:var bB=new qx.ui.layout.Grid();
...
for(var i=0;i<7;i++){bC=this.getChildControl(N+i);
bA.add(bC,{column:i+1,row:0});
this.__ws.push(bC);
}this.__wt=[];
this.__wu=[];

for(var y=0;y<6;y++){var bC=this.getChildControl(G+(y+1));
bA.add(bC,{column:0,row:y+1});
this.__wu.push(bC);
for(var x=0;x<7;x++){var bC=this.getChildControl(bk+((y*7)+x));
bA.add(bC,{column:x+1,row:y+1});
this.__wt.push(bC);
}}this._add(bA);
break;
}return bA||arguments.callee.base.call(this,bz);
},_applyValue:function(cf,cg){if((cf!=null)&&(this.getShownMonth()!=cf.getMonth()||this.getShownYear()!=cf.getFullYear())){this.showMonth(cf.getMonth(),cf.getFullYear());
}else{var ci=(cf==null)?-1:cf.getDate();

for(var i=0;i<6*7;i++){var ch=this.__wt[i];

if(ch.hasState(p)){if(ch.hasState(u)){ch.removeState(u);
}}else{var cj=parseInt(ch.getValue());

if(cj==ci){ch.addState(u);
}else if(ch.hasState(u)){ch.removeState(u);
}}}}},_onMouseUpDown:function(e){var bv=e.getTarget();

if(bv==this.getChildControl(m)||bv==this.getChildControl(bu)){e.stopPropagation();
return;
}},_onNavButtonClicked:function(bw){var by=this.getShownYear();
var bx=this.getShownMonth();

switch(bw.getCurrentTarget()){case this.getChildControl(n):by--;
break;
case this.getChildControl(s):bx--;

if(bx<0){bx=11;
by--;
}break;
case this.getChildControl(q):bx++;

if(bx>=12){bx=0;
by++;
}break;
case this.getChildControl(l):by++;
break;
}this.showMonth(bx,by);
},_onDayClicked:function(ck){var cl=ck.getCurrentTarget().dateTime;
this.setValue(new Date(cl));
},_onDayDblClicked:function(){this.execute();
},_onKeyPress:function(d){var j=null;
var g=null;
var h=null;

if(d.getModifiers()==0){switch(d.getKeyIdentifier()){case H:j=-1;
break;
case X:j=1;
break;
case M:j=-7;
...
case bp:g=1;
break;
case w:if(this.getValue()!=null){this.setValue(null);
return true;
}break;
case be:case O:if(this.getValue()!=null){this.execute();
}return;
}}else if(d.isShiftPressed()){switch(d.getKeyIdentifier()){case bt:h=-1;
break;
case bp:h=1;
break;
}}
if(j!=null||g!=null||h!=null){var f=this.getValue();

if(f!=null){f=new Date(f.getTime());
}
if(f==null){f=new Date();
}else{if(j!=null){f.setDate(f.getDate()+j);
}
if(g!=null){f.setMonth(f.getMonth()+g);
}
if(h!=null){f.setFullYear(f.getFullYear()+h);
}}this.setValue(f);
}},showMonth:function(cm,cn){if((cm!=null&&cm!=this.getShownMonth())||(cn!=null&&cn!=this.getShownYear())){if(cm!=null){this.setShownMonth(cm);
}
if(cn!=null){this.setShownYear(cn);
}this._updateDatePane();
}},handleKeyPress:function(e){this._onKeyPress(e);
},_updateDatePane:function(){var bS=qx.ui.control.DateChooser;
var bP=new Date();
var bI=bP.getFullYear();
var bN=bP.getMonth();
var bL=bP.getDate();
var bT=this.getValue();
var bW=(bT==null)?-1:bT.getFullYear();
var ce=(bT==null)?-1:bT.getMonth();
var bQ=(bT==null)?-1:bT.getDate();
var bM=this.getShownMonth();
var cb=this.getShownYear();
var bJ=qx.locale.Date.getWeekStart();
var bU=new Date(this.getShownYear(),this.getShownMonth(),1);
var bR=new qx.util.format.DateFormat(bS.MONTH_YEAR_FORMAT);
this.getChildControl(o).setValue(bR.format(bU));
var cd=bU.getDay();
var bO=1+((7-cd)%7);
var bV=new qx.util.format.DateFormat(V);

for(var i=0;i<7;i++){var bX=(i+bJ)%7;
var ca=this.__ws[i];
bU.setDate(bO+bX);
ca.setValue(bV.format(bU));

if(qx.locale.Date.isWeekend(bX)){ca.addState(C);
}else{ca.removeState(C);
}}bU=new Date(cb,bM,1,12,0,0);
var bE=(7+cd-bJ)%7;
bU.setDate(bU.getDate()-bE);
var bY=new qx.util.format.DateFormat(bi);

for(var bD=0;bD<6;bD++){this.__wu[bD].setValue(bY.format(bU));

for(var i=0;i<7;i++){var ca=this.__wt[bD*7+i];
var bH=bU.getFullYear();
var bG=bU.getMonth();
var bK=bU.getDate();
var bF=(bW==bH&&ce==bG&&bQ==bK);

if(bF){ca.addState(u);
}else{ca.removeState(u);
}
if(bG!=bM){ca.addState(p);
}else{ca.removeState(p);
}var cc=(bH==bI&&bG==bN&&bK==bL);

if(cc){ca.addState(br);
}else{ca.removeState(br);
}ca.setValue(S+bK);
ca.dateTime=bU.getTime();
bU.setDate(bU.getDate()+1);
}}bR.dispose();
bV.dispose();
bY.dispose();
}},destruct:function(){if(qx.core.Variant.isSet(bl,B)){qx.locale.Manager.getInstance().removeListener(bo,this._updateDatePane,this);
...
(function(){var n="Boolean",m="changeSelection",l="__tn",k="_applyValid",j="",h="changeRequired",g="changeValid",f="changeInvalidMessage",d="_applyInvalidMessage",c="String",a="qx.ui.form.RadioButtonGroup",b="qx.event.type.Data";
...
}this.__tn=new qx.ui.form.RadioGroup();
this.__tn.addListener(m,function(e){this.fireDataEvent(m,e.getData(),e.getOldData());
},this);
},properties:{valid:{check:n,init:true,apply:k,event:g},required:{check:n,init:false,event:h},invalidMessage:{check:c,init:j,event:f,apply:d}},events:{"changeSelection":b},members:{__tn:null,_applyInvalidMessage:function(y,z){var A=this._getChildren();
...
}},getRadioGroup:function(){return this.__tn;
},getChildren:function(){return this._getChildren();
},add:function(t,u){this.__tn.add(t);
this._add(t,u);
},remove:function(v){this.__tn.remove(v);
this._remove(v);
},removeAll:function(){var r=this.__tn.getItems();

for(var i=0;i<r.length;i++){this.__tn.remove(r[i]);
}this._removeAll();
},getSelection:function(){return this.__tn.getSelection();
},setSelection:function(w){return this.__tn.setSelection(w);
},resetSelection:function(){return this.__tn.resetSelection();
},isSelected:function(s){return this.__tn.isSelected(s);
},isSelectionEmpty:function(){return this.__tn.isSelectionEmpty();
},getSelectables:function(){return this.__tn.getSelectables();
...
(function(){var u="button",t="hovered",s="pressed",r="arrow",q="Enter",p="Space",o="abandoned",n="both",m="String",l="changeVisibility",K="splitbutton",J="changeShow",I="mouseout",H="keydown",G="execute",F="_applyMenu",E="icon",D="mouseover",C="keyup",B="qx.ui.menu.Menu",z="_applyIcon",A="label",x="_applyShow",y="changeMenu",v="_applyLabel",w="qx.ui.form.SplitButton";
qx.Class.define(w,{extend:qx.ui.core.Widget,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(L,M,N,O){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.HBox);
this._createChildControl(r);
this.addListener(D,this._onMouseOver,this,true);
...
}},properties:{appearance:{refine:true,init:K},focusable:{refine:true,init:true},label:{apply:v,nullable:true,check:m},icon:{check:m,apply:z,nullable:true,themeable:true},show:{init:n,check:[n,A,E],themeable:true,inheritable:true,apply:x,event:J},menu:{check:B,nullable:true,apply:F,event:y}},members:{__vP:null,_createChildControlImpl:function(R){var S;

switch(R){case u:S=new qx.ui.form.Button;
S.addListener(G,this._onButtonExecute,this);
S.setFocusable(false);
this._addAt(S,0,{flex:1});
break;
case r:S=new qx.ui.form.MenuButton;
S.setFocusable(false);
this._addAt(S,1);
break;
}return S||arguments.callee.base.call(this,R);
},_forwardStates:{hovered:1,focused:1},_applyLabel:function(f,g){var h=this.getChildControl(u);
f==null?h.resetLabel():h.setLabel(f);
},_applyIcon:function(T,U){var V=this.getChildControl(u);
T==null?V.resetIcon():V.setIcon(T);
},_applyMenu:function(i,j){var k=this.getChildControl(r);

if(i){k.resetEnabled();
k.setMenu(i);
i.setOpener(this);
i.addListener(l,this._onChangeMenuVisibility,this);
}else{k.setEnabled(false);
k.resetMenu();
}
if(j){j.removeListener(l,this._onChangeMenuVisibility,this);
j.resetOpener();
...
}var Q=e.getRelatedTarget();

if(qx.ui.core.Widget.contains(this,Q)){return;
}var P=this.getMenu();

if(P&&P.isVisible()){this.__vP=true;
return;
}this.removeState(t);
},_onKeyDown:function(e){var c=this.getChildControl(u);

switch(e.getKeyIdentifier()){case q:case p:c.removeState(o);
c.addState(s);
}},_onKeyUp:function(e){var d=this.getChildControl(u);

switch(e.getKeyIdentifier()){case q:case p:if(d.hasState(s)){d.removeState(o);
d.removeState(s);
d.execute();
}}},_onButtonExecute:function(e){this.execute();
},_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__vP){this.removeState(t);
}}}});
})();
