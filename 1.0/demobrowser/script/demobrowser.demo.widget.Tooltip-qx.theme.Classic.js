...
(function(){var q="icon/16/actions/help-about.png",p="Tooltip text",o="icon/32/actions/help-about.png",n="Button #2 (Shared ToolTip)",m="Short timeout ToolTip",l="demobrowser.demo.widget.Tooltip",k="Hello World #3",j="Button with ToolTipText and ToolTipIcon",i="ToolTip with icon and label",h="Shared tool tip of button #",E="ToolTip with icon and rich text",D="Such a great tooltip with a (show) timeout of 50ms.",C="Icon only ToolTip",B="Button #1 (Shared ToolTip)",A="container",z="This also may contain <b style='color:red'>rich HTML</b> markup ",y="appear",x="2",w="Shared ToolTip",v="1",t="Button with ToolTipText",u="A long label text with auto-wrapping. ",r="Button with ToolTipIcon",s="and with a (show) timeout of 50ms.";
...
},__Ik:4,__Il:0,add:function(g){this.container.add(g,{row:Math.floor(this.__Il/this.__Ik),column:this.__Il%this.__Ik});
this.__Il+=1;
},createSharedToolTip:function(){var f=new qx.ui.tooltip.ToolTip(w);
f.addListener(y,function(e){var O=h;

if(this.getOpener()==d){O+=v;
}else{O+=x;
}f.setLabel(O);
});
var d=new qx.ui.form.Button(B);
d.setToolTip(f);
this.add(d);
var c=new qx.ui.form.Button(n);
c.setToolTip(f);
this.add(c);
},createIconToolTip:function(){var L=new qx.ui.form.Button(C).set({toolTip:new qx.ui.tooltip.ToolTip(null,q)});
this.add(L);
},createToolTip:function(){var F=new qx.ui.form.Button(i).set({toolTip:new qx.ui.tooltip.ToolTip(k,q)});
this.add(F);
},createShortTimeoutToolTip:function(){var K=new qx.ui.tooltip.ToolTip(D,o);
K.setShowTimeout(50);
var J=new qx.ui.form.Button(m);
this.add(J);
J.setToolTip(K);
},createRichToolTip:function(){var N=new qx.ui.tooltip.ToolTip(u+z+s,o);
N.setWidth(200);
N.setRich(true);
N.setShowTimeout(50);
var M=new qx.ui.form.Button(E);
this.add(M);
M.setToolTip(N);
},createToolTipText:function(){var G=new qx.ui.form.Button(t).set({toolTipText:p});
this.add(G);
},createToolTipIcon:function(){var b=new qx.ui.form.Button(r).set({toolTipIcon:q});
this.add(b);
},createToolTipTextIcon:function(){var a=new qx.ui.form.Button(j).set({toolTipText:p,toolTipIcon:q});
this.add(a);
