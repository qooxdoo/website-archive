...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_CellEditor-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"34a85275194c"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var q="",p="cat",o="Juhu",n="mouse",m="dog",l="execute",k="rat",j="demobrowser.demo.test.Table_CellEditor",i="Add/Remove editor",h="Get value",f="_container",g="boolean";
qx.Class.define(j,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
...
},_addEditor:function(w,x){x=qx.lang.Object.clone(x);
var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var C=w.createCellEditor(x);
var D=new qx.ui.container.Composite().set({width:200,height:20});
C.setUserBounds(0,0,200,20);
D.add(C);
y.add(D);
var A=new qx.ui.form.Button(h);
y.add(A);
A.addListener(l,function(){B.setValue(w.getCellEditorValue(C)+q);
});
var z=new qx.ui.form.Button(i);
y.add(z);
z.addListener(l,function(){C.destroy();
qx.ui.core.queue.Manager.flush();
C=w.createCellEditor(x);
C.setUserBounds(0,0,200,20);
D.add(C);
qx.ui.core.queue.Manager.flush();
});
var B=new qx.ui.basic.Label(q);
y.add(B);
this._container.add(y);
A.execute();
},testCheckBoxEditor:function(){var e={value:[true,false]};
qx.util.Permutation.permute(e,function(J){this._addEditor(new qx.ui.table.celleditor.CheckBox(),J);
},this);
},testComboBoxEditor:function(){var E={value:[q,p,k,2],table:[this.getTableMock()]};
var F=new qx.ui.table.celleditor.ComboBox();
F.setListData([m,p,n]);
qx.util.Permutation.permute(E,function(H){this._addEditor(F,H);
},this);
},testSelectBoxEditor:function(){var t={value:[q,p],table:[this.getTableMock()]};
var u=new qx.ui.table.celleditor.SelectBox();
u.setListData([m,p,n]);
qx.util.Permutation.permute(t,function(s){this._addEditor(u,s);
},this);
},testPasswordEditor:function(){var v={value:[null,10,o]};
qx.util.Permutation.permute(v,function(r){this._addEditor(new qx.ui.table.celleditor.PasswordField(),r);
},this);
},testTextfieldEditor:function(){var a={value:[null,10,o]};
qx.util.Permutation.permute(a,function(d){this._addEditor(new qx.ui.table.celleditor.TextField(),d);
},this);
},testTextfieldEditorDynamic:function(){var b={value:[true,o]};
var c=new qx.ui.table.celleditor.Dynamic();
c.setCellEditorFactoryFunction(function(G){if(typeof G.value==g){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(b,function(I){this._addEditor(c,I);
},this);
...
qx.Class.define(a,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,construct:function(f){arguments.callee.base.call(this);

if(f){this.setCellEditorFactoryFunction(f);
}},properties:{cellEditorFactoryFunction:{check:b,nullable:true,init:null}},members:{__GG:null,createCellEditor:function(g){var h=this.getCellEditorFactoryFunction();
{};
this.__GG=h(g);
var i=this.__GG.createCellEditor(g);
return i;
},getCellEditorValue:function(c){var d=this.getCellEditorFactoryFunction();
{};
var e=this.__GG.getCellEditorValue(c);
return e;
}},destruct:function(){this.__GG=null;
}});
})();
