...
},set0:function(){var g=document.getElementById(f);
...
},set1:function(){var m=document.getElementById(f);
...
},set2:function(){var c=document.getElementById(f);
...
},set3:function(){var k=document.getElementById(f);
...
},set4:function(){var o=document.getElementById(f);
...
},reset:function(){var a=document.getElementById(f);
qx.log.Logger.debug("Resetting");
qx.bom.element.Clip.reset(a);
