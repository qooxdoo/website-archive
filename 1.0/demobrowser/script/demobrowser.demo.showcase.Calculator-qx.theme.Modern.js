...
(function(){var Q="execute",P="-",O="+",N="n",M="/",L="*",K="=",J="sans-serif",I="Verdana",H=".",bp="black",bo="Del",bn="C",bm="5",bl="7",bk="demobrowser.demo.showcase.Calculator",bj="CE",bi="solid",bh="icon/22/apps/utilities-calculator.png",bg="3",X="0",Y="8",V="6",W="4",T="Calculator",U="right",R="__Ko",S="2",ba="1",bb="__Kn",bd="demobrowser.demo.showcase.CalculatorLogic",bc="white",bf="+/-",be="9";
qx.Class.define(bk,{extend:qx.application.Standalone,members:{__Kn:null,__Ko:null,main:function(){arguments.callee.base.call(this);
{};
this.__Ko=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var b=new qx.ui.window.Window(T,bh);
b.setLayout(new qx.ui.layout.VBox(16));
var d=new qx.ui.decoration.Single(1,bi,bp);
var m=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var w=new qx.ui.layout.Grid(5,5);
m.setLayout(w);
this.__Kn=new qx.ui.basic.Label(this.__Ko.getCurrentValue().toString()).set({decorator:d,backgroundColor:bc,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[I,J],bold:true}),textAlign:U});
this.__Kn.setEnabled(false);
var x=new qx.bom.Font().set({size:14,family:[I,J],bold:true});
var r=new qx.ui.form.Button(X).set({font:x,minWidth:40});
var q=new qx.ui.form.Button(ba).set({font:x,minWidth:40});
var p=new qx.ui.form.Button(S).set({font:x,minWidth:40});
var o=new qx.ui.form.Button(bg).set({font:x,minWidth:40});
var v=new qx.ui.form.Button(W).set({font:x,minWidth:40});
var u=new qx.ui.form.Button(bm).set({font:x,minWidth:40});
var t=new qx.ui.form.Button(V).set({font:x,minWidth:40});
var s=new qx.ui.form.Button(bl).set({font:x,minWidth:40});
var z=new qx.ui.form.Button(Y).set({font:x,minWidth:40});
var y=new qx.ui.form.Button(be).set({font:x,minWidth:40});
var a=new qx.ui.form.Button(bn).set({font:x,minWidth:40});
var c=new qx.ui.form.Button(bj).set({font:x,minWidth:40});
var i=new qx.ui.form.Button(bo).set({font:x,minWidth:40});
var h=new qx.ui.form.Button(bf).set({font:x,minWidth:40});
var k=new qx.ui.form.Button(H).set({font:x,minWidth:40});
var g=new qx.ui.form.Button(O).set({font:x,minWidth:40});
var n=new qx.ui.form.Button(P).set({font:x,minWidth:40});
var l=new qx.ui.form.Button(L).set({font:x,minWidth:40});
var j=new qx.ui.form.Button(M).set({font:x,minWidth:40});
var f=new qx.ui.form.Button(K).set({font:x,minWidth:40});
w.setColumnFlex(0,1);
w.setColumnFlex(1,1);
w.setColumnFlex(2,1);
w.setColumnFlex(3,1);
...
w.setRowFlex(5,1);
w.setRowFlex(6,1);
m.add(this.__Kn,{row:0,column:0,rowSpan:0,colSpan:4});
m.add(a,{row:1,column:2,rowSpan:1,colSpan:2});
m.add(c,{row:1,column:1});
m.add(i,{row:1,column:0});
m.add(s,{row:2,column:0});
m.add(z,{row:2,column:1});
m.add(y,{row:2,column:2});
m.add(j,{row:2,column:3});
m.add(v,{row:3,column:0});
m.add(u,{row:3,column:1});
m.add(t,{row:3,column:2});
m.add(l,{row:3,column:3});
m.add(q,{row:4,column:0});
m.add(p,{row:4,column:1});
m.add(o,{row:4,column:2});
m.add(n,{row:4,column:3});
m.add(r,{row:5,column:0});
m.add(h,{row:5,column:1});
m.add(k,{row:5,column:2});
m.add(g,{row:5,column:3});
m.add(f,{row:6,column:0,rowSpan:1,colSpan:4});
b.setWidth(260);
b.setMinWidth(260);
b.setHeight(260);
b.open();
...
b.add(m,{flex:1});
a.addListener(Q,function(e){this.__Ko.cleanDisplay();
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
c.addListener(Q,function(e){this.__Ko.clearEntry();

if(this.__Ko.getResult()!=null){this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
}},this);
i.addListener(Q,function(e){this.__Ko.deleteNumber();
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
h.addListener(Q,function(e){this.__Ko.setSign();

if(this.__Ko.getResult()!=null){this.__Kn.setValue(this.__Ko.getResult().toString());
}},this);
r.addListener(Q,function(e){this.__Ko.setCurrentValue(0);
this.__Kn.setValue(this.__Ko.getCurrentValue().toFixed(this.__Ko.getZeroCounter()).toString());
},this);
q.addListener(Q,function(e){this.__Ko.setCurrentValue(1);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
p.addListener(Q,function(e){this.__Ko.setCurrentValue(2);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
o.addListener(Q,function(e){this.__Ko.setCurrentValue(3);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
v.addListener(Q,function(e){this.__Ko.setCurrentValue(4);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
u.addListener(Q,function(e){this.__Ko.setCurrentValue(5);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
t.addListener(Q,function(e){this.__Ko.setCurrentValue(6);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
s.addListener(Q,function(e){this.__Ko.setCurrentValue(7);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
z.addListener(Q,function(e){this.__Ko.setCurrentValue(8);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
y.addListener(Q,function(e){this.__Ko.setCurrentValue(9);
this.__Kn.setValue(this.__Ko.getCurrentValue().toString());
},this);
g.addListener(Q,function(e){this.__Ko.calculate(O);

if(this.__Ko.getResult()!=null){this.__Kn.setValue(this.__Ko.getResult().toString());
}this.__Ko.resetCurrentValue();
},this);
n.addListener(Q,function(e){this.__Ko.calculate(P);

if(this.__Ko.getResult()!=null){this.__Kn.setValue(this.__Ko.getResult().toString());
}this.__Ko.resetCurrentValue();
},this);
l.addListener(Q,function(e){this.__Ko.calculate(L);

if(this.__Ko.getResult()!=null){this.__Kn.setValue(this.__Ko.getResult().toString());
}this.__Ko.resetCurrentValue();
},this);
j.addListener(Q,function(e){this.__Ko.calculate(M);

if(this.__Ko.getResult()!=null){this.__Kn.setValue(this.__Ko.getResult().toString());
}this.__Ko.resetCurrentValue();
},this);
f.addListener(Q,function(e){this.__Ko.calculate(K);

if(this.__Ko.getResult()!=null){this.__Kn.setValue(this.__Ko.getResult().toString());
}this.__Ko.resetCurrentValue();
},this);
k.addListener(Q,function(e){this.__Ko.setComma();
},this);
}},destruct:function(){this._disposeObjects(R,bb);
}});
qx.Class.define(bd,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
},members:{__Kp:0,__Kq:0,__Kr:N,__Ks:0,__Kt:0,__Ku:0,__Kv:false,__Kw:1,__Kx:0,__Ky:false,__Kz:0,setCurrentValue:function(G){if(this.__Kv){this.__Kw*=10;
this.__Kp=this.__Kp+(G/this.__Kw);

if(G==0){this.__Kx++;
}}else{this.__Kv=false;

if(this.__Kp<0){this.__Kp=this.__Kp*10-G;
}else{this.__Kp=this.__Kp*10+G;
}}},getZeroCounter:function(){return this.__Kx;
},setComma:function(){this.__Kv=true;
},getCurrentValue:function(){return this.__Kp;
},resetCurrentValue:function(){this.__Kp=null;
},cleanDisplay:function(){this.__Kz=0;
this.__Kt=0;
this.__Kr=N;
this.__Kx=0;
this.__Kw=1;
...
this.__Kq=0;
this.__Ky=false;
},setResult:function(E){this.__Kq=E;
},getResult:function(){return Math.round(this.__Kq*10000000)/10000000;
},setCurrentOperation:function(F){this.__Kr=F;
},getCurrentOperation:function(){return this.__Kr;
},clearEntry:function(){this.__Ky=false;
this.__Kx=0;
this.__Kw=1;
this.__Kv=false;
this.__Ku++;
...
if(this.__Ku<2){this.__Kt=this.__Kq;
}
if(this.__Ks>=2){this.__Kq=0;
this.__Ks=0;
}},setSign:function(){this.__Kz++;

if(this.__Kz%2==0){this.__Ky=false;
}else{this.__Ky=true;
}
if(this.__Kp==null){this.__Kp=this.__Kq;
}this.__Kp=this.__Kp*(-1);

if(this.__Kq==0){this.__Kq=this.__Kp;
}
if(this.__Kq!=0){this.__Kt=this.__Kq;
this.__Kq=this.__Kp;
}},deleteNumber:function(){var A=false;
var D=false;

if(this.__Kp<0){this.__Kp=this.__Kp*(-1);
D=true;
}
if(this.__Kp!=null){if(this.__Kp.toString().lastIndexOf(H)!=-1){this.__Kp=this.__Kp*this.__Kw;
A=true;
}}var B=this.__Kp%10;
var C=B/10;
this.__Kp=this.__Kp/10;
this.__Kp=this.__Kp-C;

if(A){this.__Kw/=10;
this.__Kp=this.__Kp/(this.__Kw);
A=false;
}
if(D){this.__Kp=this.__Kp*(-1);
D=false;
}},calculate:function(bq){if(bq==O||bq==L||bq==M||bq==P||bq==K){this.__Kv=false;
this.__Kw=1;
this.__Kx=0;

if(this.__Kr!=N){if(this.__Kr==O){if(this.__Kq==null){this.__Kq=this.__Kt;
}
if(this.__Ky){this.__Kq=this.__Kt+this.__Kp;
}else{this.__Kq=this.__Kq+this.__Kp;
}this.__Kp=this.__Kq;
this.__Kt=this.__Kq;
}
if(this.__Kr==P){if(this.__Kq==0){this.__Kq=this.__Kp;
this.__Kp=0;
}
if(this.__Kq==null){this.__Kq=this.__Kt;
}
if(this.__Ky){this.__Kq=this.__Kt-this.__Kp;
}else{this.__Kq=this.__Kq-this.__Kp;
}this.__Kp=this.__Kq;
...
if(this.__Kr==M){if(this.__Kq==0){this.__Kq=this.__Kp;
this.__Kp=1;
}
if(this.__Kq==null){this.__Kq=this.__Kt;
}
if(this.__Kp!=null){if(this.__Kp!=0){if(this.__Ky){this.__Kq=this.__Kt/this.__Kp;
}else{this.__Kq=this.__Kq/this.__Kp;
}}else{alert("You can't divide by 0!");
}}this.__Kp=this.__Kq;
this.__Kt=this.__Kq;
}
if(this.__Kr==L){if(this.__Kq==0){this.__Kq=1;
}
if(this.__Kp==null){this.__Kp=1;
}
if(this.__Kq==null){this.__Kq=this.__Kt;
}
if(this.__Ky){this.__Kq=this.__Kt*this.__Kp;
...
this.__Kt=this.__Kq;
}}else{this.__Kq=this.__Kp;
}
if(bq!=K){this.__Kr=bq;
}else{this.__Ks++;
this.__Kq=this.__Kt;
this.__Kr=N;
}this.__Ky=false;
