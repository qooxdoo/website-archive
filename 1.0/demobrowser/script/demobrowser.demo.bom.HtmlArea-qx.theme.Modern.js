...
(function(){var z="0px",y="840px",x="1px solid #AAA",w="white",v="350px",u='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',t="demobrowser.demo.bom.HtmlArea",s="traditional web pages / single-page applications.<br/> ",r="innerHTML",q="<p>This low-level widget can be used separately at ",l="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",p="div",o="20px 20px",k="You can play around with this widget by hitting the ",h="<h1>HtmlArea low-level widget</h1>",n="buttons at the toolbar.</p>",m="It is the foundation for the UI widget component.</p>";
qx.Class.define(t,{extend:qx.application.Native,members:{__CK:null,__CL:null,__CM:null,__CN:null,__CO:null,main:function(){arguments.callee.base.call(this);
this.__CK=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__CK,{margin:o});
var O=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(O,{width:y,padding:z,margin:z});
var N=h+q+s+m+l+k+n;
qx.bom.element.Attribute.set(O,r,N);
this.__CL=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__CL,{width:y,padding:z,margin:z,lineHeight:z,border:x});
this.__CM=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__CM,{width:y,height:v,border:x,borderTop:z,backgroundColor:w});
qx.dom.Element.insertEnd(this.__CM,this.__CK);
var M=u;
this.__CN=new qx.bom.htmlarea.HtmlArea(this.__CM,M,null,"blank.html");
this.__CY();
qx.dom.Element.insertBegin(this.__CL,this.__CK);
qx.dom.Element.insertBegin(O,this.__CK);
qx.dom.Element.insertBegin(this.__CK,document.body);
},__CP:function(e){var L=window.prompt("FontSize: ","");
this.setFontSize(parseInt(L));
},__CQ:function(e){var bb=window.prompt("Color (Hex): ","#");
this.setTextColor(bb);
},__CR:function(e){var I=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(I);
},__CS:function(e){var d={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(d);
},__CT:function(e){var J="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(J);
},__CU:function(e){var a=window.prompt("Link: ","http://");
this.insertHyperLink(a);
},__CV:function(e){var K=window.prompt("HTML Code:","");
this.insertHtml(K);
},__CW:function(){var V=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(V,{"float":"left"});
var X;
var W=qx.bom.Element.create("select",{title:"Change font family"});

if(qx.core.Variant.isSet("qx.client","mshtml")){qx.bom.element.Attribute.set(W,"hideFocus","true");
}else{qx.bom.element.Style.set(W,"outline","none");
}X=qx.bom.Collection.html("<option value=''></option>");
qx.dom.Element.insertEnd(X[0],W);
var Y=["Tahoma","Verdana","Times New Roman","Arial","Arial Black","Courier New","Courier","Georgia","Impact","Comic Sans MS","Lucida Console"];
var U;
var ba;

for(var i=0,j=Y.length;i<j;i++){U="<option qxKeepFocus='on' qxSelectable='off'"+"value='"+Y[i]+"'>"+Y[i]+"</option>";
ba=qx.bom.Collection.html(U);

if(qx.core.Variant.isSet("qx.client","mshtml")){qx.bom.element.Attribute.set(ba[0],"hideFocus","true");
}else{qx.bom.element.Style.set(ba[0],"outline","none");
}qx.dom.Element.insertEnd(ba[0],W);
}qx.event.Registration.addListener(W,"change",function(e){var f=e.getTarget();
var g=f.selectedIndex;

if(g!=0){this.setFontFamily(f.options[g].value);
f.options[0].selected=true;
}},this.__CN);
qx.dom.Element.insertBegin(W,V);
return V;
},__CX:function(){var Q=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(Q,{"marginRight":"16px","float":"left"});
var S;
var R=qx.bom.Element.create("select",{title:"Change font size"});

if(qx.core.Variant.isSet("qx.client","mshtml")){qx.bom.element.Attribute.set(R,"hideFocus","true");
}else{qx.bom.element.Style.set(R,"outline","none");
}S=qx.bom.Collection.html("<option value=''></option>");
qx.dom.Element.insertEnd(S[0],R);
var T;
var P;

for(var i=1;i<=7;i++){P="<option qxKeepFocus='on' qxSelectable='off' "+"value='"+i+"'>"+i+"</option>";
T=qx.bom.Collection.html(P);

if(qx.core.Variant.isSet("qx.client","mshtml")){qx.bom.element.Attribute.set(T[0],"hideFocus","true");
}else{qx.bom.element.Style.set(T[0],"outline","none");
}qx.dom.Element.insertEnd(T[0],R);
}qx.event.Registration.addListener(R,"change",function(e){var b=e.getTarget();
var c=b.selectedIndex;

if(c!=0){this.setFontSize(b.options[c].value);
b.options[0].selected=true;
}},this.__CN);
qx.dom.Element.insertBegin(R,Q);
return Q;
},__CY:function(){var B=[{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__CN.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__CN.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__CN.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__CN.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__CN.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__CN.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__CN.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__CN.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__CN.setJustifyFull}},{fontFamily:{custom:this.__CW},fontSize:{custom:this.__CX},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__CQ},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__CR}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__CN.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__CN.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__CS},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__CT},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__CU},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__CV},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__CN.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__CN.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__CN.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__CN.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__CN.redo}}];
var D,H,A,F;

for(var i=0,j=B.length;i<j;i++){H={};
H["marginRight"]=i==j-1?"0px":"16px";
H["float"]="left";
D=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(D,H);

for(var E in B[i]){var G=B[i][E];

if(G.custom){A=G.custom.call(this);
}else{var C=qx.util.AliasManager.getInstance().resolve(G.image);
F={type:"image",src:qx.util.ResourceManager.getInstance().toUri(C),title:G.text,qxKeepFocus:"on",qxSelectable:"off"};
A=qx.bom.Element.create("input",F);
qx.bom.element.Style.setStyles(A,{width:"16px",height:"16px",padding:"4px"});

if(qx.core.Variant.isSet("qx.client","mshtml")){qx.bom.element.Attribute.set(A,"hideFocus","true");
}else{qx.bom.element.Style.set(A,"outline","none");
}qx.event.Registration.addListener(A,"click",G.action,this.__CN);
}qx.dom.Element.insertEnd(A,D);
}qx.dom.Element.insertEnd(D,this.__CL);
}qx.dom.Element.insertEnd(qx.bom.Element.create("br",{style:"clear:both"}),this.__CL);
}}});
})();
