...
(function(){var j="Stopping recurrent 2-second timer",i="Recurrent 2-second timer with limit 3:",h="One-shot 1-second timer: ",g="demobrowser.demo.test.TimerManager",f="Recurrent 5-second timer: ",e="__GE",d="Start timers",c="execute";
qx.Class.define(g,{extend:qx.application.Standalone,members:{__GE:null,startTimers:function(){var b=qx.util.TimerManager.getInstance();
b.start(function(s,t){this.__GF(f+t);
},5000,this,null,0);
b.start(function(k,l){this.__GF(h+l);
},0,this,null,1000);
b.start(function(q,r){this.__GF(i+r);

if(++q.count==3){this.__GF(j);
b.stop(r);
}},2000,this,{count:0},2000);
},__GF:function(a){a=Date.parse(new Date)+" "+a+"\n";
this.__GE.setValue(this.__GE.getValue()+a);
