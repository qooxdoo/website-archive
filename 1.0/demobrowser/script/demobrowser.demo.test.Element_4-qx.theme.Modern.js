...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Element_4","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_4-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1b78a3ef26eb"},
  boot : "boot",
  bootIsInline : true,
