...
(function(){var r="",q="Hello",p="icon/16/actions/go-down.png",o="World",n="bold",m="Juhu",l="</div>",k="waiting",j="icon/16/actions/go-next.png",h="http://resources.qooxdoo.org/images/logo.gif",V="$ ",U="string",T="border: 1px dotted green",S="inactive",R="decoration",Q="multi<br>line",P="between",O="<",N="<div style='position:absolute;height:20px;width:",M="px;top:",y="qx/decoration/Modern",z="icon/16/actions/go-previous.png",w="icon",x="number",u="px'>",v="<i>italic</i>",s="0$",t="qx/icon/Tango",A="<b>bold</b>",B="icon/16/actions/go-up.png",E="boolean",D="demobrowser.demo.test.Table_CellRenderer",G="tooltip",F="red",I="icon/16/emotes/face-sad.png",H="icon/16/emotes/face-smile.png",C="left",L=">=",K="active",J="object";
qx.Class.define(D,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(R,y);
qx.util.AliasManager.getInstance().add(w,t);
},__Go:function(b,top,c,d,e){var f=[N,c,M,top,u];
d.createDataCellHtml(e,f);
f.push(l);
b.innerHTML+=f.join(r);
},testDefaultRenderer:function(bl){var bm=100;
var bo={value:[null,m,32,new Date()],styleLeft:[0],styleWidth:[bm],styleHeight:[20],style:[r]};
var bn=this._getNewTableDiv(bm);
var top=0;
qx.util.Permutation.permute(bo,function(bz){this.__Go(bn,top,bm,bl,bz);
top+=20;
},this);
},testBooleanRenderer:function(){var cm=70;
var cl=30;
var cn=new qx.ui.table.cellrenderer.Boolean();
var cj={value:[null,true,false],styleLeft:[0],styleWidth:[cm],styleHeight:[cl],style:[r]};
var ck=this._getNewTableDiv(cm);
var top=0;
qx.util.Permutation.permute(cj,function(bf){this.__Go(ck,top,cm,cn,bf);
top+=cl;
},this);
cn.setIconFalse(I);
cn.setIconTrue(H);
qx.util.Permutation.permute(cj,function(bt){this.__Go(ck,top,cm,cn,bt);
top+=cl;
},this);
},testDateRenderer:function(){var bD=180;
var bE=new qx.ui.table.cellrenderer.Date();
var bG={value:new Date(),styleLeft:[0],styleWidth:[bD],styleHeight:[20],style:[r]};
var bC=qx.util.format.DateFormat;
var bF=[bC.getDateTimeInstance(),bC.getDateInstance()];
var bA=this._getNewTableDiv(bD);
var top=0;

for(var i=0;i<bF.length;i++){var bB=bF[i];
bE.setDateFormat(bB);
this.__Go(bA,top,bD,bE,bG);
top+=20;
}},testNumberRenderer:function(){var bL=new qx.ui.table.cellrenderer.Number();
var bK=100;
var bN={value:Math.PI,styleLeft:[0],styleWidth:[bK],styleHeight:[20],style:[r]};
var bJ=qx.util.format.NumberFormat;
var bM=[bJ.getIntegerInstance(),new bJ().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:V})];
var bH=this._getNewTableDiv(bK);
var top=0;

for(var i=0;i<bM.length;i++){var bI=bM[i];
bL.setNumberFormat(bI);
this.__Go(bH,top,bK,bL,bN);
top+=20;
}},testImageRenderer:function(){var ch=new qx.ui.table.cellrenderer.Image();
var cf=50;
var ci={value:[null,p,B,z,j,h],styleLeft:[0],styleWidth:[cf],styleHeight:[20],style:[r],tooltip:[r,G]};
var cg=this._getNewTableDiv(cf);
var top=0;
qx.util.Permutation.permute(ci,function(bs){this.__Go(cg,top,cf,ch,bs);
top+=20;
},this);
},testStringRenderer:function(){var bk=new qx.ui.table.cellrenderer.String();
var bj=100;
var bi=20;
var bg={value:[null,q,o],styleLeft:[0],styleWidth:[bj],styleHeight:[bi],style:[r]};
var bh=this._getNewTableDiv(bj);
var top=0;
qx.util.Permutation.permute(bg,function(bp){this.__Go(bh,top,bj,bk,bp);
top+=20;
},this);
},testPasswordRenderer:function(){var by=new qx.ui.table.cellrenderer.Password();
var bx=100;
var bw=20;
var bu={value:[null,q,o],styleLeft:[0],styleWidth:[bx],styleHeight:[bw],style:[r]};
var bv=this._getNewTableDiv(bx);
var top=0;
qx.util.Permutation.permute(bu,function(a){this.__Go(bv,top,bx,by,a);
top+=20;
},this);
},testHtmlRenderer:function(){var cd=new qx.ui.table.cellrenderer.Html();
var cc=100;
var cb=50;
var bY={value:[null,A,v,Q],styleLeft:[0],styleWidth:[cc],styleHeight:[cb],style:[r]};
var ca=this._getNewTableDiv(cc);
var top=0;
qx.util.Permutation.permute(bY,function(ce){this.__Go(ca,top,cc,cd,ce);
top+=20;
},this);
},testConditionalRenderer:function(){var bX=new qx.ui.table.cellrenderer.Conditional();
bX.addNumericCondition(O,0,null,F,null,null);
bX.addNumericCondition(L,100,C,null,null,null);
bX.addBetweenCondition(P,0,2,null,null,null,n,null);
bX.addRegex(s,null,null,n,T);
var bW=100;
var bV=20;
var bT={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bW],table:[this.tableMock],styleHeight:[bV],style:[r]};
var bU=this._getNewTableDiv(bW);
var top=0;
qx.util.Permutation.permute(bT,function(g){this.__Go(bU,top,bW,bX,g);
top+=20;
},this);
},testDynamicRenderer:function(){var bS=new qx.ui.table.cellrenderer.Dynamic();
bS.setCellRendererFactoryFunction(function(bc){var be=bc.value;
var bd=qx.ui.table.cellrenderer;

switch(typeof be){case U:if(be.match(/^icon\//)){return new bd.Image();
}else{return new bd.String();
}case E:return new bd.Boolean();
case x:return new bd.Number();
case J:if(be instanceof Date){return new bd.Date();
}return new bd.Default();
}});
var bR=100;
var bQ=20;
var bO={value:[null,m,new Date(),30,p,false],styleLeft:[0],styleWidth:[bR],styleHeight:[bQ],table:[this.tableMock],style:[r]};
var bP=this._getNewTableDiv(bR);
var top=0;
qx.util.Permutation.permute(bO,function(br){this.__Go(bP,top,bR,bS,br);
top+=20;
},this);
},testReplaceRenderer:function(){var bb=new qx.ui.table.cellrenderer.Replace();
bb.setReplaceMap({1:K,2:S,3:k});
bb.addReversedReplaceMap();
var ba=100;
var Y=20;
var W={value:[1,2,3],styleLeft:[0],styleWidth:[ba],table:[this.tableMock],styleHeight:[Y],style:[r]};
var X=this._getNewTableDiv(ba);
var top=0;
qx.util.Permutation.permute(W,function(bq){this.__Go(X,top,ba,bb,bq);
top+=20;
},this);
...
(function(){var F="",E="==",D=">",C="between",B="<",A="regex",z="!between",y=">=",x="!=",w="<=",t=";",v='g',u=":",s="qx.ui.table.cellrenderer.Conditional";
qx.Class.define(s,{extend:qx.ui.table.cellrenderer.Default,construct:function(G,H,I,J){arguments.callee.base.call(this);
...
this.__Gy=I||F;
this.__Gz=J||F;
},members:{__Gw:null,__Gx:null,__Gy:null,__Gz:null,__GA:function(h,j){if(h[1]!=null){j["text-align"]=h[1];
}
if(h[2]!=null){j["color"]=h[2];
}
if(h[3]!=null){j["font-style"]=h[3];
}
if(h[4]!=null){j["font-weight"]=h[4];
...
}},addRegex:function(a,b,c,d,e,f){if(a!=null){var g=[A,b,c,d,e,a,f];
}
if(g!=null){this.conditions.push(g);
}else{throw new Error("regex cannot be null!");
}},_getCellStyle:function(k){if(!this.conditions.length){return k.style||F;
}var p=k.table.getTableModel();
var i;
var r;
var l;
var n={"text-align":this.__Gw,"color":this.__Gx,"font-style":this.__Gy,"font-weight":this.__Gz};
...
switch(this.conditions[i][0]){case E:if(l==this.conditions[i][5]){r=true;
}break;
case x:if(l!=this.conditions[i][5]){r=true;
}break;
case D:if(l>this.conditions[i][5]){r=true;
}break;
case B:if(l<this.conditions[i][5]){r=true;
}break;
case y:if(l>=this.conditions[i][5]){r=true;
}break;
case w:if(l<=this.conditions[i][5]){r=true;
}break;
...
switch(this.conditions[i][0]){case C:if(l>=this.conditions[i][5]&&l<=this.conditions[i][6]){r=true;
}break;
case z:if(l<this.conditions[i][5]&&l>this.conditions[i][6]){r=true;
}break;
}}else if(this.conditions[i][0]==A){if(this.conditions[i][6]==null){l=k.value;
}else{l=p.getValueById(this.conditions[i][6],k.row);
}var m=new RegExp(this.conditions[i][5],v);
r=m.test(l);
}if(r==true){this.__GA(this.conditions[i],n);
}}var q=[];

for(var o in n){if(n[o]){q.push(o,u,n[o],t);
}}return q.join(F);
...
},members:{__GD:null,__GC:16,__GB:16,_identifyImage:function(e){var f={imageWidth:this.__GB,imageHeight:this.__GC};

if(e.value==c){f.url=null;
}else{f.url=this.__GD.resolve(e.value);
}f.tooltip=e.tooltip;
return f;
