...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.TreeController-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1f0327aebdef"},
  boot : "boot",
  bootIsInline : true,
