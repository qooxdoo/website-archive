...
E.setPadding(20);
this.getRoot().add(E,{left:0,top:0});
this.addNormalButtons(E);
this.addToggleButton(E);
this.addRepeatButton(E);
this.addHoverButton(E);
},addNormalButtons:function(w){var x=new qx.ui.form.Button(o,i);
w.add(x);
var y=new qx.ui.form.Button(l,h);
y.setEnabled(false);
w.add(y);
},addToggleButton:function(b){var c=new qx.ui.form.ToggleButton(d,j);
c.focus();
b.add(c);
c.addListener(f,function(e){this.debug("Checked: "+e.getData());
},this);
...
A.add(C);
B.addListener(p,function(){var a=parseInt(C.getValue())+1;
C.setValue(a.toString());
});
},addHoverButton:function(t){var u=new qx.ui.form.HoverButton(g).set({padding:10,backgroundColor:n});
t.add(u);
...
t.add(v);
u.addListener(p,function(){var z=parseInt(v.getValue())+1;
