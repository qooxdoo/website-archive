...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VSplit-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"0db04af1df1a"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var v="vertical",u="main",t="Flex:1",s="Flex:1; Min:250",r="Auto",q="Flex:2",p="Flex:0",o="Flex:2; Max:100",n="Flex:1; Max:100",m="Flex:1; Max:200",j="Flex:2; Min:250",l="Flex:0; Min:350",k="demobrowser.demo.layout.VSplit";
...
var I=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(I);
I.add(this.getSplitPaneTwoFlexSimple(),{left:0});
I.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
I.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
I.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
I.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
I.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
I.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
I.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
I.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var G=new qx.ui.splitpane.Pane(v);
G.setHeight(400);
G.setDecorator(u);
...
G.add(H,2);
return G;
},getSplitPaneTwoFlexWithOneMin:function(){var x=new qx.ui.splitpane.Pane(v);
x.setHeight(400);
x.setDecorator(u);
var w=new qx.ui.form.TextArea(s);
w.setDecorator(null);
w.setWrap(true);
w.setMinHeight(250);
x.add(w,1);
...
x.add(y,2);
return x;
},getSplitPaneTwoFlexWithOneMax:function(){var h=new qx.ui.splitpane.Pane(v);
h.setHeight(400);
h.setDecorator(u);
...
h.add(i,2);
return h;
},getSplitPaneTwoFlexWithTwoMin:function(){var N=new qx.ui.splitpane.Pane(v);
N.setHeight(400);
N.setDecorator(u);
var M=new qx.ui.form.TextArea(s);
M.setDecorator(null);
M.setWrap(true);
M.setMinHeight(250);
N.add(M,1);
var O=new qx.ui.form.TextArea(j);
O.setDecorator(null);
O.setWrap(true);
O.setMinHeight(250);
N.add(O,2);
return N;
},getSplitPaneTwoFlexWithTwoMax:function(){var b=new qx.ui.splitpane.Pane(v);
b.setHeight(400);
b.setDecorator(u);
...
b.add(c,2);
return b;
},getSplitPaneOneFlexSimple:function(){var e=new qx.ui.splitpane.Pane(v);
e.setHeight(400);
e.setDecorator(u);
var d=new qx.ui.form.TextArea(p);
d.setDecorator(null);
d.setWrap(true);
e.add(d,0);
var f=new qx.ui.form.TextArea(t);
...
e.add(f);
return e;
},getSplitPaneOneFlexSimpleWithMax:function(){var K=new qx.ui.splitpane.Pane(v);
K.setHeight(400);
K.setDecorator(u);
...
J.setWrap(true);
K.add(J,0);
var L=new qx.ui.form.TextArea(m);
L.setDecorator(null);
L.setWrap(true);
L.setMaxHeight(200);
K.add(L);
return K;
},getSplitPaneOneFlexSimpleWithMin:function(){var D=new qx.ui.splitpane.Pane(v);
D.setHeight(400);
D.setDecorator(u);
var C=new qx.ui.form.TextArea(l);
C.setDecorator(null);
C.setWrap(true);
C.setMinHeight(350);
D.add(C,0);
var E=new qx.ui.form.TextArea(t);
E.setDecorator(null);
E.setWrap(true);
D.add(E);
return D;
},getSplitPaneAuto:function(){var A=new qx.ui.splitpane.Pane(v);
A.setDecorator(u);
var z=new qx.ui.form.TextArea(r);
z.setDecorator(null);
z.setWrap(true);
A.add(z,0);
var B=new qx.ui.form.TextArea(r);
B.setDecorator(null);
B.setWrap(true);
A.add(B);
return A;
...
(function(){var bl="splitter",bk="slider",bj="mousedown",bi="mouseout",bh="mousemove",bg="mouseup",bf="losecapture",be="active",bd="horizontal",bc="vertical",bB="knob",bA="Integer",bz="height",by="row-resize",bx="move",bw="maxHeight",bv="width",bu="_applyOrientation",bt="mouseover",bs="splitpane",bq="qx.ui.splitpane.Pane",br="_applyOffset",bo="minHeight",bp="minWidth",bm="col-resize",bn="maxWidth";
qx.Class.define(bq,{extend:qx.ui.core.Widget,construct:function(P){arguments.callee.base.call(this);
this.__kx=[];
...
this.addListener(bi,this._onMouseOut);
this.addListener(bf,this._onMouseUp);
},properties:{appearance:{refine:true,init:bs},offset:{check:bA,init:6,apply:br},orientation:{init:bd,check:[bd,bc],apply:bu}},members:{__ky:null,__kz:false,__kA:null,__kB:null,__kC:null,__kD:null,__kE:null,__kx:null,_createChildControlImpl:function(w){var z;

switch(w){case bk:z=new qx.ui.splitpane.Slider(this);
z.exclude();
this._add(z,{type:w});
break;
case bl:z=new qx.ui.splitpane.Splitter(this);
this._add(z,{type:w});
z.addListener(bx,this._onSplitterMove,this);
if(qx.bom.client.Engine.OPERA){z.addListener(bt,this._onSplitterMouseOver,z);
}break;
}return z||arguments.callee.base.call(this,w);
},_applyOrientation:function(q,r){var s=this.getChildControl(bk);
var v=this.getChildControl(bl);
this.__kC=q===bd;
var u=this._getLayout();

if(u){u.dispose();
}var t=q===bc?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;
this._setLayout(t);
v.removeState(r);
v.addState(q);
v.getChildControl(bB).removeState(r);
v.getChildControl(bB).addState(q);
s.removeState(r);
s.addState(q);
},_applyOffset:function(a,b){var c=this.getChildControl(bl);

if(b===0){c.removeListener(bj,this._onMouseDown,this);
c.removeListener(bh,this._onMouseMove,this);
c.removeListener(bi,this._onMouseOut,this);
c.removeListener(bg,this._onMouseUp,this);
c.removeListener(bf,this._onMouseUp,this);
this.addListener(bj,this._onMouseDown);
this.addListener(bg,this._onMouseUp);
this.addListener(bh,this._onMouseMove);
this.addListener(bi,this._onMouseOut);
...
if(a===0){this.removeListener(bj,this._onMouseDown);
this.removeListener(bg,this._onMouseUp);
this.removeListener(bh,this._onMouseMove);
this.removeListener(bi,this._onMouseOut);
this.removeListener(bf,this._onMouseUp);
c.addListener(bj,this._onMouseDown,this);
c.addListener(bh,this._onMouseMove,this);
c.addListener(bi,this._onMouseOut,this);
c.addListener(bg,this._onMouseUp,this);
c.addListener(bf,this._onMouseUp,this);
}},add:function(d,f){if(f==null){this._add(d);
}else{this._add(d,{flex:f});
}this.__kx.push(d);
},remove:function(J){this._remove(J);
qx.lang.Array.remove(this.__kx,J);
},getChildren:function(){return this.__kx;
},_onMouseDown:function(e){if(!e.isLeftPressed()||!this._isNear()){return;
}var K=this.getChildControl(bl);
var M=K.getContainerLocation();
var L=this.getContentLocation();
this.__ky=this.__kC?e.getDocumentLeft()-M.left+L.left:e.getDocumentTop()-M.top+L.top;
var O=this.getChildControl(bk);
var N=K.getBounds();
O.setUserBounds(N.left,N.top,N.width,N.height);
O.setZIndex(K.getZIndex()+1);
O.show();
this.__kz=true;
...
var A=this.getChildControl(bk);
var B=this.__kD;

if(this.__kC){A.setDomLeft(B);
}else{A.setDomTop(B);
}e.stop();
}else{this.__kF();
...
var bb=this.getChildControl(bk);
bb.exclude();
this.__kz=false;
this.releaseCapture();
this.__kF();
...
},_onSplitterMouseOver:function(){this.addState(be);
},_finalizeSizes:function(){var F=this.__kD;
var C=this.__kE;
...
var G=H[2];
var D=H[3];
var E=G.getLayoutProperties().flex;
var I=D.getLayoutProperties().flex;
if((E!=0)&&(I!=0)){G.setLayoutProperties({flex:F});
D.setLayoutProperties({flex:C});
}else{if(this.__kC){G.setWidth(F);
D.setWidth(C);
}else{G.setHeight(F);
D.setHeight(C);
}}},_isNear:function(){var Q=this.getChildControl(bl);
var S=Q.getBounds();
...
},__kF:function(){var Y=this.getChildControl(bl);
var ba=this.getApplicationRoot();
if(this.__kz||this._isNear()){var X=this.__kC?bm:by;
this.setCursor(X);
ba.setGlobalCursor(X);
Y.addState(be);
}else if(Y.hasState(be)){this.resetCursor();
ba.resetGlobalCursor();
Y.removeState(be);
}},__kG:function(){if(this.__kC){var i=bp,p=bv,j=bn,n=this.__kA;
}else{var i=bo,p=bz,j=bw,n=this.__kB;
