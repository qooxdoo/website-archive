...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Tree_Highlight-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a96d25a745c2"},
  boot : "boot",
  bootIsInline : true,
...
var bD=new qx.ui.groupbox.GroupBox(s).set({contentPadding:[4,4,4,4]});
...
bC.setOpen(true);
bx.setRoot(bC);
var bA=new qx.ui.tree.TreeFolder(P);
bA.setOpen(true);
bC.add(bA);
var bs=new qx.ui.tree.TreeFolder(v);
var bq=new qx.ui.tree.TreeFolder(u);
var br=new qx.ui.tree.TreeFolder(H);
var bp=new qx.ui.tree.TreeFolder(n);
bA.add(bs,bq,br,bp);
var by=new qx.ui.tree.TreeFile(l);
var bo=new qx.ui.tree.TreeFile(k);
bq.add(by,bo);
var bB=new qx.ui.tree.TreeFolder(Q);
var bt=new qx.ui.tree.TreeFolder(K);
var bw=new qx.ui.tree.TreeFolder(y);
var bv=new qx.ui.tree.TreeFolder(n);

for(var i=0;i<100;i++){bv.add(new qx.ui.tree.TreeFile(r+i));
}var bz=new qx.ui.tree.TreeFolder(J);
var bu=new qx.ui.tree.TreeFolder(G);
bB.add(bt,bw,bv,bz,bu);
bC.add(bB);
return bx;
},getCommandFrame:function(){var bh=new qx.ui.groupbox.GroupBox(x);
bh.setLayout(new qx.ui.layout.Grid(3,5));
var bj=0;
bh.add(new qx.ui.basic.Label(N).set({paddingTop:4}),{row:bj,column:0});
this.inputItemName=new qx.ui.form.TextField(L);
bh.add(this.inputItemName,{row:bj++,column:1});
this.btnAddFolder=new qx.ui.form.Button(A);
this.btnAddFolder.addListener(q,this._addFolder,this);
bh.add(this.btnAddFolder,{row:bj++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(t);
this.btnAddFile.addListener(q,this._addFile,this);
bh.add(this.btnAddFile,{row:bj++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(h);
this.btnAddAfter.addListener(q,this._addAfter,this);
bh.add(this.btnAddAfter,{row:bj++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(j);
this.btnAddBefore.addListener(q,this._addBefore,this);
bh.add(this.btnAddBefore,{row:bj++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(g);
this.btnAddBegin.addListener(q,this._addBegin,this);
bh.add(this.btnAddBegin,{row:bj++,column:0,colSpan:2});
bh.add(new qx.ui.core.Spacer(5,5),{row:bj++,column:0});
this.btnRemove=new qx.ui.form.Button(w);
this.btnRemove.addListener(q,this._removeTreeItem,this);
bh.add(this.btnRemove,{row:bj++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(F);
this.btnRemoveAll.addListener(q,this._removeAll,this);
bh.add(this.btnRemoveAll,{row:bj++,column:0,colSpan:2});
bh.add(new qx.ui.core.Spacer(5,5),{row:bj++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(E);
this.btnMoveToParent.addListener(q,this._moveToParent,this);
bh.add(this.btnMoveToParent,{row:bj++,column:0,colSpan:2});
bh.add(new qx.ui.core.Spacer(5,5),{row:bj++,column:0});
bh.add(new qx.ui.basic.Label(O),{row:bj,column:0});
var bf=[B,z,M];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<bf.length;i++){var bi=bf[i];
var bg=new qx.ui.form.RadioButton(bi).set({value:bi==this._tree.getRootOpenClose()});
bg.setUserData(m,bi);
this.showOpenButtons[bi]=bg;
this.mgrShowRootOpen.add(bg);
bh.add(bg,{row:bj++,column:1});
...
bh.add(this.btnReset,{row:bj++,column:0,colSpan:2});
...
T.addListenerOnce(p,function(){var bF=new qx.fx.effect.core.Highlight(T.getContainerElement().getDomElement());
bF.start();
},this);
S.setOpen(true);
S.add(T);
},_addFile:function(){var X=this._tree.getSelection()[0];
var Y=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
Y.addListenerOnce(p,function(){var bm=new qx.fx.effect.core.Highlight(Y.getContainerElement().getDomElement());
bm.start();
},this);
X.setOpen(true);
X.add(Y);
},_addBefore:function(){var d=this._tree.getSelection()[0];
var e=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
e.addListenerOnce(p,function(){var a=new qx.fx.effect.core.Highlight(e.getContainerElement().getDomElement());
a.start();
},this);
d.getParent().addBefore(e,d);
},_addAfter:function(){var U=this._tree.getSelection()[0];
var V=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
V.addListenerOnce(p,function(){var ba=new qx.fx.effect.core.Highlight(V.getContainerElement().getDomElement());
ba.start();
},this);
U.getParent().addAfter(V,U);
},_addBegin:function(){var b=this._tree.getSelection()[0];
var c=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
c.addListenerOnce(p,function(){var R=new qx.fx.effect.core.Highlight(c.getContainerElement().getDomElement());
R.start();
},this);
b.getParent().addAtBegin(c);
},_removeTreeItem:function(){var f=this._tree.getSelection()[0];
var parent=f.getParent();
parent.remove(f);
},_removeAll:function(){var W=this._tree.getSelection()[0];
W.removeAll();
},_moveToParent:function(){var bn=this._tree.getSelection()[0];
var parent=bn.getParent();
parent.remove(bn);
parent.getParent().add(bn);
this._updateControls();
},_onChangeShowOpen:function(){var bk=this._tree.getSelection()[0];

if(bk!=null){var bl=this.mgrShowRootOpen.getSelection()[0].getUserData(m);
bk.setOpenSymbolMode(bl);
...
},_updateControls:function(){var bb=this._tree.getSelection()[0];

if(!bb){this.btnAddFolder.setEnabled(false);
...
var bc=be==-1;
var bd=bb instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(bd);
this.btnAddFile.setEnabled(bd);
this.btnAddBefore.setEnabled(!bc);
this.btnAddAfter.setEnabled(!bc);
this.btnAddBegin.setEnabled(!bc);
this.btnRemove.setEnabled(!bc);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(bd);
this.showOpenButtons[bb.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(be>0);
...
qx.Class.define(e,{extend:qx.fx.Base,properties:{startColor:{init:d,check:h},endColor:{init:a,check:h},restoreBackground:{init:true,check:i},keepBackgroundImage:{init:false,check:i}},members:{__AV:null,__AW:null,__AX:null,__AY:null,setup:function(){arguments.callee.base.call(this);
var j=this._getElement();
this.__AV={backgroundImage:qx.bom.element.Style.get(j,"backgroundImage"),backgroundColor:qx.bom.element.Style.get(j,"backgroundColor")};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,b,f);
}this.__AW=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__AX=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__AY=[this.__AX[0]-this.__AW[0],this.__AX[1]-this.__AW[1],this.__AX[2]-this.__AW[2]];
},update:function(k){arguments.callee.base.call(this);
var l=[this.__AW[0]+Math.round(this.__AY[0]*k),this.__AW[1]+Math.round(this.__AY[1]*k),this.__AW[2]+Math.round(this.__AY[2]*k)];
...
for(var n in this.__AV){qx.bom.element.Style.set(o,n,this.__AV[n]);
}}},destruct:function(){this.__AW=this.__AX=this.__AY=null;
}});
})();
