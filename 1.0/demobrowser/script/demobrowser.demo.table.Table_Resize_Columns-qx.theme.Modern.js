...
A.setColumns([h,n,d,g]);
A.setData(C);
var z={tableColumnModel:function(E){return new qx.ui.table.columnmodel.Resize(E);
}};
...
var y=B.getBehavior();
y.set(0,{width:l,minWidth:40,maxWidth:80});
y.setWidth(1,j);
y.setMinWidth(1,100);
y.setMaxWidth(1,320);
var B=D.getTableColumnModel();
...
w.add(v);
u=new qx.ui.toolbar.Button(r,k);
u.addListener(s,function(H){var I=this.createRandomRows(10);
this._tableModel.addRows(I);
this.info("10 rows added");
},this);
v.add(u);
u=new qx.ui.toolbar.Button(q,e);
u.addListener(s,function(F){var G=this._tableModel.getRowCount();
this._tableModel.removeRows(G-10,10);
...
w.add(v);
var t=this._table;
x=new qx.ui.toolbar.CheckBox(f);
x.set({value:t.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(p+c)});
x.addListener(i,function(a){t.setKeepFirstVisibleRowComplete(this.getValue());
},x);
v.add(x);
return w;
