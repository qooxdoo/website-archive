...
A.add(z);
}A.addListener(h,function(e){var F=e.getData()[0];
this.debug("Selected: "+F.getBackgroundColor()+" ("+F.getWidth()+"x"+F.getHeight()+")");
});
A.addListener(a,function(e){var E=this.getBounds();
