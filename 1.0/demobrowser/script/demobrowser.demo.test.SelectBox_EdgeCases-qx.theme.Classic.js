...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.SelectBox_EdgeCases","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.SelectBox_EdgeCases-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"b66ba90e86c3"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var u="Times New Roman",t="Long list",s="Long button, short text",r="",q="Fonts",p="container",o="Font ",n="Tahoma",m="Courier New",l="Item ",j="Arial",k="demobrowser.demo.test.SelectBox_EdgeCases";
...
h.add(this.container);
this.getRoot().add(h,{edge:0});
this.addBox1();
this.addBox2();
this.addBox3();
},addBox1:function(){this.container.add(new qx.ui.basic.Label(t),{left:25,top:20});
var x=new qx.ui.form.SelectBox();
x.setMaxListHeight(null);

for(var i=0;i<300;i++){var y=new qx.ui.form.ListItem(r+i);
x.add(y);
}this.container.add(x,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(q),{left:25,bottom:45});
var g=new qx.ui.form.SelectBox();
var b=new qx.bom.Font(12,[n]);
var c=new qx.bom.Font(15,[j]);
var a=new qx.bom.Font(18,[m]);
var e=new qx.bom.Font(21,[u]);
var d=[b,c,a,e];

for(var i=0;i<d.length;i++){var f=new qx.ui.form.ListItem(o+(i+1));
f.setFont(d[i]);
g.add(f);
}this.container.add(g,{left:20,bottom:20});
},addBox3:function(){this.container.add(new qx.ui.basic.Label(s),{left:205,top:20});
var v=new qx.ui.form.SelectBox();
v.setWidth(300);
v.setMaxListHeight(100);

for(var i=0;i<20;i++){var w=new qx.ui.form.ListItem(l+i);
