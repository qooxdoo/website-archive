...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.Pane_Column","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Pane_Column-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ce1bdeddaed4"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var h="bold",g="table-scroller-header",f="white",e="#EEE",d="demobrowser.demo.virtual.Pane_Column",c="Even/Odd Colors",b="Custom Colors",a="Even/Odd & Custom Colors";
qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var k=new qx.ui.layout.Grid(5,0);
k.setRowFlex(1,1);
k.setColumnFlex(0,1);
k.setColumnFlex(1,1);
k.setColumnFlex(2,1);
var j=new qx.ui.container.Composite(k);
this.getRoot().add(j,{edge:0});
j.add(new qx.ui.basic.Label(c).set({font:h,decorator:g,padding:3,allowGrowX:true}),{row:0,column:0});
var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);
m.getPane().addLayer(new qx.ui.virtual.layer.Column(f,e));
j.add(m,{row:1,column:0});
j.add(new qx.ui.basic.Label(b).set({font:h,decorator:g,padding:3,allowGrowX:true}),{row:0,column:1});
var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);
var l=new qx.ui.virtual.layer.Column();

for(var i=0;i<10000;i++){l.setColor(i,qx.util.ColorUtil.randomColor());
}m.getPane().addLayer(l);
j.add(m,{row:1,column:1});
j.add(new qx.ui.basic.Label(a).set({font:h,decorator:g,padding:3,allowGrowX:true}),{row:0,column:2});
var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);
var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);
var l=new qx.ui.virtual.layer.Column(f,e);

for(var i=0;i<10000;i++){if(Math.random()>0.7){l.setColor(i,qx.util.ColorUtil.randomColor());
}}m.getPane().addLayer(l);
j.add(m,{row:1,column:2});
}}});
})();
...
(function(){var m="scrollY",l="update",k="scrollX",j="__vB",i="pane",h="qx.ui.virtual.core.Scroller";
qx.Class.define(h,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(c,d,f,g){arguments.callee.base.call(this);
this.__vB=new qx.ui.virtual.core.Pane(c,d,f,g);
this.__vB.addListener(l,this._computeScrollbars,this);
this.__vB.addListener(k,this._onScrollPaneX,this);
this.__vB.addListener(m,this._onScrollPaneY,this);
this._add(this.__vB,{row:0,column:0});
},properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__vB:null,getPane:function(){return this.__vB;
},_createChildControlImpl:function(b){if(b==i){return this.__vB;
...
},_onScrollBarX:function(e){this.__vB.setScrollX(e.getData());
},_onScrollBarY:function(e){this.__vB.setScrollY(e.getData());
...
(function(){var bB="appear",bA="qx.ui.virtual.core.CellEvent",bz="qx.event.type.Data",by="change",bx="update",bw="scrollY",bv="full update",bu="__si",bt="dblclick",bs="update layer window",bQ="qx.event.type.Event",bP="cellContextmenu",bO="resize",bN="__sa",bM="scrollX",bL="__sh",bK="cellDblclick",bJ="__rY",bI="qx.ui.virtual.core.Pane",bH="click",bF="prefetch x",bG="contextmenu",bD="cellClick",bE="prefetch y",bC="scroll";
qx.Class.define(bI,{extend:qx.ui.core.Widget,construct:function(bk,bl,bm,bn){arguments.callee.base.call(this);
this.__rY=new qx.ui.virtual.core.Axis(bm,bk);
this.__sa=new qx.ui.virtual.core.Axis(bn,bl);
this.__sb=0;
this.__sc=0;
this.__sd=0;
this.__se=0;
this.__sf={};
this.__sg={};
this.__sh=new qx.ui.container.Composite();
this.__sh.setUserBounds(0,0,0,0);
this._add(this.__sh);
this.__si=[];
this.__rY.addListener(by,this.fullUpdate,this);
this.__sa.addListener(by,this.fullUpdate,this);
this.addListener(bO,this._onResize,this);
this.addListenerOnce(bB,this._onAppear,this);
this.addListener(bH,this._onClick,this);
this.addListener(bt,this._onDblclick,this);
this.addListener(bG,this._onContextmenu,this);
},events:{cellClick:bA,cellContextmenu:bA,cellDblclick:bA,update:bQ,scrollX:bz,scrollY:bz},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__rY:null,__sa:null,__sb:null,__sc:null,__sd:null,__se:null,__sf:null,__sg:null,__sh:null,__si:null,__sj:null,__sk:null,__sl:null,DEBUG:false,getRowConfig:function(){return this.__rY;
},getColumnConfig:function(){return this.__sa;
},getChildren:function(){return [this.__sh];
},addLayer:function(bo){{};
this.__si.push(bo);
bo.setUserBounds(0,0,0,0);
this.__sh.add(bo);
},getLayers:function(){return this.__si;
},getVisibleLayers:function(){var bi=[];

for(var i=0;i<this.__si.length;i++){var bj=this.__si[i];

if(bj.isVisible()){bi.push(bj);
}}return bi;
},getScrollMaxX:function(){var b=this.getBounds();

if(b){return Math.max(0,this.__sa.getTotalSize()-b.width);
}return 0;
},getScrollMaxY:function(){var a=this.getBounds();

if(a){return Math.max(0,this.__rY.getTotalSize()-a.height);
}return 0;
...
if(this.__sb!==cc){var ce=this.__sb;
this.__sb=cc;
this._deferredUpdateScrollPosition();
this.fireDataEvent(bw,cc,ce);
}},getScrollY:function(){return this.__sb;
},setScrollX:function(Y){var ba=this.getScrollMaxX();

if(Y<0){Y=0;
}else if(Y>ba){Y=ba;
}
if(Y!==this.__sc){var bb=this.__sc;
this.__sc=Y;
this._deferredUpdateScrollPosition();
this.fireDataEvent(bM,Y,bb);
}},getScrollX:function(){return this.__sc;
},getScrollSize:function(){return {width:this.__sa.getTotalSize(),height:this.__rY.getTotalSize()};
},scrollRowIntoView:function(bc){var bf=this.getBounds();

if(!bf){this.addListenerOnce(bB,function(){this.scrollRowIntoView(bc);
},this);
return;
}var bg=this.__rY.getItemPosition(bc);
var be=bg+this.__rY.getItemSize(bc);
var bd=this.getScrollY();

if(bg<bd){this.setScrollY(bg);
}else if(be>bd+bf.height){this.setScrollY(be-bf.height);
}},scrollColumnIntoView:function(c){var g=this.getBounds();

if(!g){this.addListenerOnce(bB,function(){this.scrollColumnIntoView(c);
},this);
return;
}var f=this.__sa.getItemPosition(c);
var d=f+this.__sa.getItemSize(c);
var h=this.getScrollX();

if(f<h){this.setScrollX(f);
}else if(d>h+g.width){this.setScrollX(d-g.width);
}},scrollCellIntoView:function(j,k){var l=this.getBounds();

if(!l){this.addListenerOnce(bB,function(){this.scrollCellIntoView(j,k);
},this);
return;
}this.scrollColumnIntoView(j);
this.scrollRowIntoView(k);
},getCellAtPosition:function(T,U){var V,W;
var X=this.getContentLocation();

if(!X||U<X.top||U>=X.bottom||T<X.left||T>=X.right){return null;
}V=this.__rY.getItemAtPosition(this.getScrollY()+U-X.top);
W=this.__sa.getItemAtPosition(this.getScrollX()+T-X.left);

if(!V||!W){return null;
}return {row:V.index,column:W.index};
},prefetchX:function(F,G,H,I){var J=this.getVisibleLayers();

if(J.length==0){return;
}var L=this.getBounds();

if(!L){return;
}var M=this.__sc+L.width;
var N=this.__se-M;

if(this.__sc-this.__sf.left<Math.min(this.__sc,F)||this.__sf.right-M<Math.min(N,H)){this.DEBUG&&console.log(bF);
var O=Math.min(this.__sc,G);
var K=Math.min(N,I);
this._setLayerWindow(J,this.__sc-O,this.__sb,L.width+O+K,L.height,false);
...
if(!bY){return;
}var bW=this.__sb+bY.height;
var bX=this.__sd-bW;

if(this.__sb-this.__sf.top<Math.min(this.__sb,bR)||this.__sf.bottom-bW<Math.min(bX,bT)){this.DEBUG&&console.log(bE);
var cb=Math.min(this.__sb,bS);
var ca=Math.min(bX,bU);
this._setLayerWindow(bV,this.__sc,this.__sb-cb,bY.width,bY.height+cb+ca,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__sj=true;
this._updateScrollPosition();
this.__sj=null;
this.fireEvent(bx);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__sm(e,bD);
},_onContextmenu:function(e){this.__sm(e,bP);
},_onDblclick:function(e){this.__sm(e,bK);
},__sm:function(e,P){var Q=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());

if(!Q){return;
}this.fireNonBubblingEvent(P,qx.ui.virtual.core.CellEvent,[this,e,Q.row,Q.column]);
},syncWidget:function(){if(this.__sg._fullUpdate){this._fullUpdate();
}else if(this.__sg._updateScrollPosition){this._updateScrollPosition();
}this.__sg={};
},_setLayerWindow:function(m,n,top,o,p,q){var v=this.__rY.getItemAtPosition(top);

if(v){var x=v.index;
var C=this.__rY.getItemSizes(x,p+v.offset);
var w=qx.lang.Array.sum(C);
var E=top-v.offset;
var B=top-v.offset+w;
}else{var x=0;
var C=[];
var w=0;
var E=0;
var B=0;
}var z=this.__sa.getItemAtPosition(n);

if(z){var t=z.index;
var s=this.__sa.getItemSizes(t,o+z.offset);
var y=qx.lang.Array.sum(s);
var D=n-z.offset;
var u=n-z.offset+y;
}else{var t=0;
var s=[];
...
var D=0;
var u=0;
}this.__sf={top:E,bottom:B,left:D,right:u};
this.__sh.setUserBounds(this.__sf.left-this.__sc,this.__sf.top-this.__sb,y,w);
this.__sk=s;
this.__sl=C;
this.DEBUG&&qx.ui.core.queue.Manager.flush();

for(var i=0;i<this.__si.length;i++){var A=new Date();
var r=this.__si[i];
r.setUserBounds(0,0,y,w);

if(q){r.fullUpdate(x,t,C,s);
}else{r.updateLayerWindow(x,t,C,s);
}if(this.DEBUG){this.debug("layer update ("+r.classname+"): "+(new Date()-A)+"ms");
var A=new Date();
qx.ui.core.queue.Manager.flush();
this.debug("layer flush ("+r.classname+"): "+(new Date()-A)+"ms");
}}},__sn:function(){if(this.__sj){return;
}var bh=this.getScrollSize();

if(this.__sd!==bh.height||this.__se!==bh.width){this.__sd=bh.height;
this.__se=bh.width;
this.fireEvent(bx);
}},fullUpdate:function(){this.__sg._fullUpdate=1;
qx.ui.core.queue.Widget.add(this);
},isUpdatePending:function(){return !!this.__sg._fullUpdate;
},_fullUpdate:function(){var R=this.getVisibleLayers();

if(R.length==0){this.__sn();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var S=this.getBounds();
this.DEBUG&&console.log(bv);
this._setLayerWindow(R,this.__sc,this.__sb,S.width,S.height,true);
this.__sn();
},_deferredUpdateScrollPosition:function(){this.__sg._updateScrollPosition=1;
qx.ui.core.queue.Widget.add(this);
},_updateScrollPosition:function(){var bp=this.getVisibleLayers();

if(bp.length==0){this.__sn();
return;
}var br=this.getBounds();

if(!br){return ;
}var bq={top:this.__sb,bottom:this.__sb+br.height,left:this.__sc,right:this.__sc+br.width};

if(this.__sf.top<=bq.top&&this.__sf.bottom>=bq.bottom&&this.__sf.left<=bq.left&&this.__sf.right>=bq.right){this.DEBUG&&console.log(bC);
this.__sh.setUserBounds(this.__sf.left-bq.left,this.__sf.top-bq.top,this.__sf.right-this.__sf.left,this.__sf.bottom-this.__sf.top);
}else{this.DEBUG&&console.log(bs);
this._setLayerWindow(bp,this.__sc,this.__sb,br.width,br.height,false);
}this.__sn();
}},destruct:function(){this._disposeArray(bu);
this._disposeObjects(bJ,bN,bL);
this.__sf=this.__sg=this.__sk=this.__sl=null;
}});
})();
(function(){var o="change",n="qx.event.type.Event",m="qx.ui.virtual.core.Axis";
qx.Class.define(m,{extend:qx.core.Object,construct:function(p,q){arguments.callee.base.call(this);
this.itemCount=q;
this.defaultItemSize=p;
this.customSizes={};
},events:{"change":n},members:{__so:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
this.fireNonBubblingEvent(o);
},getItemSize:function(X){return this.customSizes[X]||this.defaultItemSize;
},resetItemSizes:function(){this.customSizes={};
this.__so=null;
this.fireNonBubblingEvent(o);
},__sp:function(){if(this.__so){return this.__so;
}var A=this.defaultItemSize;
var H=this.itemCount;
var C=[];

for(var E in this.customSizes){var y=parseInt(E);

if(y<H){C.push(y);
}}
if(C.length==0){var D=[{startIndex:0,endIndex:H-1,firstItemSize:A,rangeStart:0,rangeEnd:H*A-1}];
this.__so=D;
return D;
}C.sort(function(a,b){return a>b?1:-1;
});
var D=[];
var z=0;

for(var i=0;i<C.length;i++){var y=C[i];

if(y>=H){break;
}var G=this.customSizes[y];
var B=y*A+z;
z+=G-A;
D[i]={startIndex:y,firstItemSize:G,rangeStart:B};

if(i>0){D[i-1].rangeEnd=B-1;
D[i-1].endIndex=y-1;
}}if(D[0].rangeStart>0){D.unshift({startIndex:0,endIndex:D[0].startIndex-1,firstItemSize:A,rangeStart:0,rangeEnd:D[0].rangeStart-1});
}var I=D[D.length-1];
var F=(H-I.startIndex-1)*A;
I.rangeEnd=I.rangeStart+I.firstItemSize+F-1;
I.endIndex=H-1;
this.__so=D;
return D;
},__sq:function(K){var L=this.__so||this.__sp();
var M=0;
var O=L.length-1;
while(true){var P=M+((O-M)>>1);
var N=L[P];

if(N.rangeEnd<K){M=P+1;
}else if(N.rangeStart>K){O=P-1;
}else{return N;
}}},getItemAtPosition:function(s){if(s<0||s>=this.getTotalSize()){return null;
}var u=this.__sq(s);
var w=u.rangeStart;
var t=u.startIndex;
var x=u.firstItemSize;

if(w+x>s){return {index:t,offset:s-w};
}else{var v=this.defaultItemSize;
return {index:t+1+Math.floor((s-w-x)/v),offset:(s-w-x)%v};
}},__sr:function(e){var f=this.__so||this.__sp();
var g=0;
var j=f.length-1;
while(true){var k=g+((j-g)>>1);
var h=f[k];

if(h.endIndex<e){g=k+1;
}else if(h.startIndex>e){j=k-1;
}else{return h;
...
}},getTotalSize:function(){var J=this.__so||this.__sp();
return J[J.length-1].rangeEnd+1;
},getItemSizes:function(Q,R){var S=this.customSizes;
var V=this.defaultItemSize;
var U=0;
var T=[];
var i=0;

while(U<R){var W=S[Q++]||V;
U+=W;
T[i++]=W;

if(Q>=this.itemCount){break;
}}return T;
}},destruct:function(){this.customSizes=this.__so=null;
}});
})();
...
(function(){var g="qx.ui.virtual.layer.Abstract",f="abstract";
qx.Class.define(g,{extend:qx.ui.core.Widget,type:f,implement:[qx.ui.virtual.core.ILayer],construct:function(){arguments.callee.base.call(this);
this.__rk={};
},properties:{anonymous:{refine:true,init:true}},members:{__rk:null,__rl:null,__rm:null,__rn:null,__ro:null,__rp:null,getFirstRow:function(){return this.__rm;
},getFirstColumn:function(){return this.__rn;
},getRowSizes:function(){return this.__ro||[];
},getColumnSizes:function(){return this.__rp||[];
},syncWidget:function(){if(!this.getContentElement().getDomElement()){return;
}
if(this.__rk.fullUpdate||this.__rk.updateLayerWindow&&this.__rk.updateLayerData){this._fullUpdate.apply(this,this.__rl);
}else if(this.__rk.updateLayerWindow){this._updateLayerWindow.apply(this,this.__rl);
}else if(this.__rk.updateLayerData&&this.__ro){this._updateLayerData();
}
if(this.__rk.fullUpdate||this.__rk.updateLayerWindow){var a=this.__rl;
this.__rm=a[0];
this.__rn=a[1];
this.__ro=a[2];
this.__rp=a[3];
}this.__rk={};
},_updateLayerData:function(){this._fullUpdate(this.__rm,this.__rn,this.__ro,this.__rp);
},_fullUpdate:function(l,m,n,o){throw new Error("Abstract method '_fullUpdate' called!");
},_updateLayerWindow:function(b,c,d,e){this._fullUpdate(b,c,d,e);
},updateLayerData:function(){this.__rk.updateLayerData=true;
qx.ui.core.queue.Widget.add(this);
},fullUpdate:function(h,i,j,k){this.__rl=arguments;
this.__rk.fullUpdate=true;
qx.ui.core.queue.Widget.add(this);
},updateLayerWindow:function(p,q,r,s){this.__rl=arguments;
this.__rk.updateLayerWindow=true;
qx.ui.core.queue.Widget.add(this);
}},destruct:function(){this.__rk=this.__rl=this.__ro=this.__rp=null;
}});
})();
(function(){var f="Color",e="_applyColorOdd",d="_applyColorEven",c="qx.ui.virtual.layer.AbstractBackground";
qx.Class.define(c,{extend:qx.ui.virtual.layer.Abstract,construct:function(i,j){arguments.callee.base.call(this);

if(i){this.setColorEven(i);
}
if(j){this.setColorOdd(j);
}this.__rq={};
this.__rr={};
},properties:{colorEven:{nullable:true,check:f,apply:d,themeable:true},colorOdd:{nullable:true,check:f,apply:e,themeable:true}},members:{__rs:null,__rt:null,__rq:null,__rr:null,setColor:function(g,h){if(h){this.__rq[g]=qx.theme.manager.Color.getInstance().resolve(h);
}else{delete (this.__rq[g]);
}},clearCustomColors:function(){this.__rq={};
this.updateLayerData();
},getColor:function(a){var b=this.__rq[a];

if(b){return b;
}else{return a%2==0?this.__rs:this.__rt;
}},_applyColorEven:function(n,o){if(n){this.__rs=qx.theme.manager.Color.getInstance().resolve(n);
}else{this.__rs=null;
}this.updateLayerData();
},_applyColorOdd:function(p,q){if(p){this.__rt=qx.theme.manager.Color.getInstance().resolve(p);
}else{this.__rt=null;
}this.updateLayerData();
},setBackground:function(k,l){if(l){this.__rr[k]=qx.theme.manager.Decoration.getInstance().resolve(l);
}else{delete (this.__rr[k]);
}this.updateLayerData();
},getBackground:function(m){return this.__rr[m];
}},destruct:function(){this.__rq=this.__rr=null;
}});
})();
...
qx.Class.define(n,{extend:qx.ui.virtual.layer.AbstractBackground,properties:{appearance:{refine:true,init:j}},members:{_fullUpdate:function(v,w,y,z){var G=[];
...
G.push(t,r,q,o,J,u,p,I.getMarkup(),s);
C++;
}else{var F=this.getColor(D);

if(F){G.push(t,r,q,o,J,u,f,z[x],u,g,E,u,h,F,p,s);
C++;
}}J+=z[x];
D+=1;
}var A=this.getContentElement().getDomElement();
A.style.display=e;
A.innerHTML=G.join(k);
for(var i=0,l=H.length;i<l;i++){var B=H[i];
B.decorator.resize(A.childNodes[B.childIndex].firstChild,B.width,B.height);
}A.style.display=m;
this._height=E;
},updateLayerWindow:function(K,L,M,N){if(L!==this.getFirstColumn()||N.length!==this.getColumnSizes().length||this._height<qx.lang.Array.sum(M)){this._fullUpdate(K,L,M,N);
