...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.ManualLayout-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"38cc722e7040"},
  boot : "boot",
  bootIsInline : true,
