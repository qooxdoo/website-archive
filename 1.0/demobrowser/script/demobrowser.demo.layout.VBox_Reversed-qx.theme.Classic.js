...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Reversed-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"1060f076fdeb"},
  boot : "boot",
  bootIsInline : true,
