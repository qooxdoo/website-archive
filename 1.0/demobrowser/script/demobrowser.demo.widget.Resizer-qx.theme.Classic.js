...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Resizer","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Resizer-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"875e416dacaf"},
  boot : "boot",
  bootIsInline : true,
...
},_getResizerList:function(){var f=new qx.ui.form.List().set({width:100,height:200,minWidth:50,minHeight:100,maxHeight:400,maxWidth:500});

for(var i=0;i<100;i++){f.add(new qx.ui.form.ListItem(c+i));
}var g=new qx.ui.container.Resizer();
g.setLayout(new qx.ui.layout.Grow());
g.add(f);
return g;
},_getResizer:function(){var d=new qx.ui.form.TextArea;
d.setValue(a);
var e=new qx.ui.container.Resizer().set({minWidth:100,minHeight:50,width:200,height:100,resizableTop:false,resizableLeft:false});
e.setLayout(new qx.ui.layout.Canvas());
e.add(d,{top:0,right:0,bottom:0,left:0});
return e;
}}});
})();
...
qx.Class.define(c,{extend:qx.ui.form.AbstractField,construct:function(f){arguments.callee.base.call(this,f);
this.initWrap();
...
},_getContentHint:function(){var e=arguments.callee.base.call(this);
e.height=e.height*4;
e.width=this._getTextSize().width*20;
return e;
}}});
})();
