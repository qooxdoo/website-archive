...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.Event_Iframe-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"3380b8e9df8a"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var q="click",p="iframe",o="scroll",n="inner",m="div",l="juhu",k="contextmenu",j="input",h="load",g="keydown",d="demobrowser.demo.event.Event_Iframe",f="data/Event_2_frame.html";
qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var t=qx.bom.Iframe.create({name:p,src:f});
t.id=p;
document.body.appendChild(t);
qx.event.Registration.addListener(t,h,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var c=window.document.getElementById(p);
var b=qx.bom.Iframe.getDocument(c);
this._juhu=b.getElementById(l);
this._inner=b.getElementById(n);
qx.event.Registration.addListener(this._juhu,k,this._preventDefault,this);
...
qx.event.Registration.addListener(b.getElementById(j),g,this._onkeydown,this);

for(var i=1;i<10;i++){var a=b.getElementById(m+i);
qx.event.Registration.addListener(a,q,this._cascadeCapture,this,true);
qx.event.Registration.addListener(a,q,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(b.getElementById(o),o,this._scroll,this);
},_onkeydown:function(e){this.debug("keydown: "+e.getKeyIdentifier());
},_scroll:function(e){this.debug("scroll");
},_cascadeCapture:function(e){var r=e.getCurrentTarget();
this.debug("capture: "+r.id+" "+e.getEventPhase());
