...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.ListControllerWithObjects","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ListControllerWithObjects-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"38c86766d56d"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="execute",n="smile",m="Jack",l=".png",k="kiss",j="demobrowser.demo.data.ListControllerWithObjects",h="emote",g="green",f="Jim",e="<b>Displaying objects in a list</b><br/>",K="Make all happy",J="sad",I="plain",H="surprise",G="embarrassed",F="online",E=" a converter by the icon. The font color shows the online status.",D="name",C="Write data to log",B="Jackob",v="textColor",w="have a name and an emotion, which is displayed with the help of ",t="This list display a set of persons in a list. Every person does ",u="Dan",r="Tim",s="Karl",p="Online <> Offline",q="icon/16/emotes/face-",x="Dustin",y="angel",A="Max",z="red";
qx.Class.define(j,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var ba=[A,B,r,m,u,x,s,f];
var Q=[G,k,I,J,H,y];
var W=[];

for(var i=0;i<20;i++){var T=new demobrowser.demo.data.model.Person();
T.setName(ba[i%ba.length]);
T.setEmote(Q[i%Q.length]);
T.setOnline(i%3==0);
W.push(T);
}var X=new qx.data.Array(W);
var P=new qx.ui.form.List();
P.setWidth(150);
this.getRoot().add(P,{left:10,top:80});
var Y={converter:function(L){return q+L+l;
}};
var U=new qx.data.controller.List(X,P,D);
U.setIconOptions(Y);
U.setIconPath(h);
var S={converter:function(d){if(d){return g;
}else{return z;
}}};
var N={bindItem:function(a,b,c){a.bindDefaultProperties(b,c);
a.bindProperty(F,v,S,b,c);
}};
U.setDelegate(N);
var O=new qx.ui.form.Button(K);
O.setWidth(120);
this.getRoot().add(O,{left:180,top:80});
O.addListener(o,function(){for(var i=0;i<X.length;i++){var bb=X.getItem(i);
bb.setEmote(n);
}},this);
var M=new qx.ui.form.Button(p);
M.setWidth(120);
this.getRoot().add(M,{left:180,top:115});
M.addListener(o,function(){for(var i=0;i<X.length;i++){X.getItem(i).toggleOnline();
}},this);
var V=new qx.ui.form.Button(C);
V.setWidth(120);
this.getRoot().add(V,{left:180,top:150});
V.addListener(o,function(){qx.log.appender.Console.show();
...
R.setWidth(410);
R.setValue(e+t+w+E);
this.getRoot().add(R,{left:20,top:10});
}}});
})();
