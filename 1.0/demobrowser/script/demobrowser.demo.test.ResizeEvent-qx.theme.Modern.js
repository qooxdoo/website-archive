...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ResizeEvent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"ec66c8df7785"},
  boot : "boot",
  bootIsInline : true,
