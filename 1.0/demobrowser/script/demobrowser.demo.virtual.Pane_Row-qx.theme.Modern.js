...
(function(){var m="bold",l="table-scroller-header",k="white",j="#EEE",h="demobrowser.demo.virtual.Pane_Row",g="Even/Odd Colors",f="Custom Colors",e="Even/Odd & Custom Colors";
qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var c=new qx.ui.layout.Grid(5,0);
c.setRowFlex(1,1);
c.setColumnFlex(0,1);
c.setColumnFlex(1,1);
c.setColumnFlex(2,1);
...
var d=new qx.ui.virtual.core.Scroller(100,10000,60,100);
d.getPane().addLayer(new qx.ui.virtual.layer.Row(k,j));
a.add(d,{row:1,column:0});
a.add(new qx.ui.basic.Label(f).set({font:m,decorator:l,padding:3,allowGrowX:true}),{row:0,column:1});
var d=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var b=new qx.ui.virtual.layer.Row();

for(var i=0;i<10000;i++){b.setColor(i,qx.util.ColorUtil.randomColor());
...
var d=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var d=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var b=new qx.ui.virtual.layer.Row(k,j);

for(var i=0;i<10000;i++){if(Math.random()>0.7){b.setColor(i,qx.util.ColorUtil.randomColor());
}}d.getPane().addLayer(b);
