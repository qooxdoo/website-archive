...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Spinner","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Spinner-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"488760044d81"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var z="0",y="middle",x="100",w="left",v="Disabled",u="Not Editable",t="demobrowser.demo.widget.Spinner",s="Stepped",r="Wrap",q="-3000",k="30",p="300",n="3000",j="changeValue",i="-30",m="Simple",l="Number format",o="right";
qx.Class.define(t,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(A,B){var C=new qx.ui.form.Spinner();
A.add(new qx.ui.basic.Label(m),{column:0,row:B});
A.add(new qx.ui.basic.Label(z),{column:1,row:B});
A.add(C,{column:2,row:B});
A.add(new qx.ui.basic.Label(x),{column:3,row:B});
C.addListener(j,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(D,E){var F=new qx.ui.form.Spinner(0,50,100);
F.setEditable(false);
D.add(new qx.ui.basic.Label(u),{column:0,row:E});
D.add(new qx.ui.basic.Label(z),{column:1,row:E});
D.add(F,{column:2,row:E});
D.add(new qx.ui.basic.Label(x),{column:3,row:E});
},addWrappingSpinner:function(a,b){var c=new qx.ui.form.Spinner(-30,30,30);
c.setWrap(true);
a.add(new qx.ui.basic.Label(r),{column:0,row:b});
a.add(new qx.ui.basic.Label(i),{column:1,row:b});
a.add(c,{column:2,row:b});
a.add(new qx.ui.basic.Label(k),{column:3,row:b});
},addSteppedSpinner:function(L,M){var N=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
L.add(new qx.ui.basic.Label(s),{column:0,row:M});
L.add(new qx.ui.basic.Label(q),{column:1,row:M});
L.add(N,{column:2,row:M});
L.add(new qx.ui.basic.Label(n),{column:3,row:M});
},addDisabledSpinner:function(G,H){var I=new qx.ui.form.Spinner;
I.setEnabled(false);
G.add(new qx.ui.basic.Label(v),{column:0,row:H});
G.add(new qx.ui.basic.Label(z),{column:1,row:H});
G.add(I,{column:2,row:H});
G.add(new qx.ui.basic.Label(x),{column:3,row:H++});
},addFormattedSpinner:function(d,f){var g=new qx.ui.form.Spinner(0,200,300);
g.setSingleStep(0.5);
g.setWidth(70);
var h=new qx.util.format.NumberFormat();
h.setMinimumFractionDigits(2);
h.setMaximumFractionDigits(2);
g.setNumberFormat(h);
d.add(new qx.ui.basic.Label(l),{column:0,row:f});
d.add(new qx.ui.basic.Label(z),{column:1,row:f});
d.add(g,{column:2,row:f});
d.add(new qx.ui.basic.Label(p),{column:3,row:f++});
},main:function(){arguments.callee.base.call(this);
var K=new qx.ui.layout.Grid(10,8);
K.setColumnAlign(0,w,y);
K.setColumnAlign(1,o,y);
K.setColumnAlign(2,w,y);
K.setColumnAlign(3,w,y);
var J=new qx.ui.container.Composite(K);
J.setPadding(10);
this.getRoot().add(J,{left:0,top:0});
this.addSimpleSpinner(J,0);
this.addNonEditableSpinner(J,1);
this.addWrappingSpinner(J,2);
this.addSteppedSpinner(J,3);
this.addDisabledSpinner(J,4);
this.addFormattedSpinner(J,5);
}}});
})();
