...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_HeaderRenderer","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_HeaderRenderer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"dcb0278d495d"},
  boot : "boot",
  bootIsInline : true,
...
},members:{getTableMock:function(){var z=this.getColumnModelMock();
var w=this.getModelMock();
var y=new qx.ui.table.selection.Model();
var A=new qx.ui.table.selection.Manager();
A.setSelectionModel(y);
var v={getTableModel:function(){return w;
},getTableColumnModel:function(){return z;
},getRowHeight:function(){return 20;
},getForceLineHeight:function(){return true;
},getSelectionModel:function(){return y;
},getDataRowRenderer:function(){return new qx.ui.table.rowrenderer.Default(v);
},updateContent:function(){},setFocusedCell:function(p,q){},getKeepFirstVisibleRowComplete:function(){return true;
},_updateScrollBarVisibility:function(){},getSelectionManager:function(){return A;
},getNewTablePaneHeader:function(R){return function(E){var F=new qx.ui.table.pane.Header(E);
return F;
};
},getNewTablePane:function(C){return function(Q){return new qx.ui.table.pane.Pane(Q);
};
},getEnabled:function(){return true;
}};
return v;
},getSelectionMock:function(){return {isSelectedIndex:function(B){return B==0;
...
},setColumnWidth:function(H,I){},getVisibleX:function(x){return x;
},getHeaderCellRenderer:function(r){return new qx.ui.table.headerrenderer.Default();
},getDataCellRenderer:function(){return new qx.ui.table.cellrenderer.Default();
},addListener:function(){}};
},getPaneModelMock:function(){var n={getColumnAtX:function(x){return x;
},getColumnCount:function(){return 4;
},getX:function(L){return L;
},getColumnLeft:function(m){return m*100;
},getTotalWidth:function(){return 4*100;
}};
return n;
},getModelMock:function(){return {getSortColumnIndex:function(){return 0;
},isSortAscending:function(){return true;
},isColumnSortable:function(S){return true;
...
},getValue:function(J,K){return h+J+g+K;
}};
},getPaneMock:function(){return {getFirstVisibleRow:function(){return 0;
}};
},getScrollerMock:function(){var t=this.getTableMock();
var s=this.getPaneModelMock();
var u=this.getPaneMock();
return {getTable:function(){return t;
},getTablePaneModel:function(){return s;
},getTablePane:function(){return u;
}};
},_getNewTableDiv:function(M){var N=qx.bom.Element.create(b);
qx.bom.element.Style.setStyles(N,{position:a,left:this._tableLeft+j,width:(M||150)+j,top:20+j,height:e,backgroundColor:c});
this._tableLeft+=(M||150)+20;
document.body.appendChild(N);
return N;
}}});
})();
(function(){var n="Name",m="hovered",l="tool tip",k="icon/16/apps/internet-feed-reader.png",j="mouseover",i="demobrowser.demo.test.Table_HeaderRenderer",h="_container",g="mouseout";
qx.Class.define(i,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
this.setUp();
this.testDefaultRenderer();
this.testIconRenderer();
},setUp:function(){this._container=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
this.getRoot().add(this._container,{left:20,top:20});
},testDefaultRenderer:function(){var f=new qx.ui.table.headerrenderer.Default();
f.setToolTip(l);
var c={name:[n],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var d=this._getNewHeaderContainer();
qx.util.Permutation.permute(c,function(s){var t=f.createHeaderCell(s);
d.add(t);
f.updateHeaderCell(s,t);
});
},testIconRenderer:function(){var q=new qx.ui.table.headerrenderer.Icon(k);
q.setToolTip(l);
var o={name:[n],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var p=this._getNewHeaderContainer();
qx.util.Permutation.permute(o,function(a){var b=q.createHeaderCell(a);
p.add(b);
q.updateHeaderCell(a,b);
});
},_getNewHeaderContainer:function(){var r=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
r.addListener(j,function(e){e.getTarget().addState(m);
});
r.addListener(g,function(e){e.getTarget().removeState(m);
});
this._container.add(r);
return r;
