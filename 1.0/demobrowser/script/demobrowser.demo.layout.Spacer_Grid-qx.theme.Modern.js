...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Spacer_Grid","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Spacer_Grid-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"253d9d108d93"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var e="main",d="green",c="yellow",b="demobrowser.demo.layout.Spacer_Grid";
...
h.setSpacing(10);
var g=new qx.ui.container.Composite(h);
g.setPadding(20);
this.getRoot().add(g,{edge:0});
g.add(this.getGrid1());
g.add(this.getGrid2());
},getGrid1:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:e,backgroundColor:c,allowGrowX:false,allowGrowY:false});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:0,column:0});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:0,column:1});
f.add(new qx.ui.core.Spacer(0,10),{row:1,column:0});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:2,column:0});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:2,column:1});
f.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:4,column:0});
f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:4,column:1});
return f;
},getGrid2:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:e,backgroundColor:c,allowGrowX:false,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:0,column:0});
a.add(new qx.ui.core.Spacer(10,0),{row:0,column:2});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:0,column:3});
a.add(new qx.ui.core.Spacer(30,0),{row:1,column:4});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:0,column:5});
a.add(new qx.ui.core.Spacer(0,5),{row:1,column:0});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:2,column:0});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:2,column:3});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:2,column:5});
return a;
}}});
})();
