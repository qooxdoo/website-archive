...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Canvas_LeftRight-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"9fe634e9ca14"},
  boot : "boot",
  bootIsInline : true,
