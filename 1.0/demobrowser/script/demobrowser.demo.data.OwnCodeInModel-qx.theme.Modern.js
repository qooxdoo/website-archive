...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.OwnCodeInModel-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f1a8135f8416"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var B="execute",A="icon/16/mimetypes/",z="name",y="model",x="model.items",w="demobrowser.demo.data.OwnCodeInModel",v=".png",u="json/list.json",t="type",s="Using the delegation to bring two sort function to the root model ",o="Sort By Name",r="items",q="class of this demo. The buttons just calling those sort functions.",n="<b>Adding own code to the model</b><br/>",m="demobrowser.demo.data.ItemsMixin",p="Sort By Type";
...
this.getRoot().add(e,{left:10,top:80});
var h=new qx.data.controller.List(null,e);
h.setLabelPath(z);
h.setIconOptions({converter:function(C){return A+C+v;
}});
h.setIconPath(t);
var i={getModelMixins:function(l){if(l==r){return demobrowser.demo.data.ItemsMixin;
}}};
var d=u;
var k=new qx.data.store.Json(d,i);
k.bind(x,h,y);
var j=new qx.ui.form.Button(p);
j.setWidth(120);
this.getRoot().add(j,{left:130,top:80});
j.addListener(B,function(){k.getModel().sortByType();
},this);
var g=new qx.ui.form.Button(o);
g.setWidth(120);
this.getRoot().add(g,{left:130,top:110});
g.addListener(B,function(){k.getModel().sortByName();
},this);
...
qx.Mixin.define(m,{members:{sortByType:function(){var c=this.getItems();
