...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_Header","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_Header-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"772740d6281f"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(g,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
var k=new qx.ui.table.pane.Header(this.getScrollerMock());
this.getRoot().add(k,{left:10,top:10});
k.onPaneModelChanged();
k.setColumnWidth(0,150);
k.addListener(d,function(e){var i=e.getTarget();

if(i instanceof qx.ui.table.headerrenderer.HeaderCell){var j=k._indexOf(i);
k.setMouseOverColumn(j);
}});
var m=new qx.ui.form.ToggleButton(h);
this.getRoot().add(m,{left:20,top:100});
m.addListener(c,function(e){var n=e.getData();

if(n){m.setLabel(b);
k.showColumnMoveFeedback(1,50);
}else{m.setLabel(h);
k.hideColumnMoveFeedback();
}});
var l=new qx.ui.form.Button(f);
this.getRoot().add(l,{left:20,top:140});
l.addListener(a,function(){k.onPaneModelChanged();
});
}}});
})();
