...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Margin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"8e2f6373a1d4"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var k="main",j="green",i="yellow",h="middle",g="demobrowser.demo.layout.HBox_Margin";
...
var n=new qx.ui.container.Composite(l).set({decorator:k,backgroundColor:i,allowGrowX:false});
l.setSpacing(5);
var p=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var o=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var m=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
n.add(p);
n.add(o);
n.add(m);
...
var C=new qx.ui.container.Composite(A).set({decorator:k,backgroundColor:i,allowGrowX:false});
A.setSpacing(5);
...
var s=new qx.ui.container.Composite(q).set({decorator:k,backgroundColor:i,height:100,allowGrowX:false});
q.setSpacing(5);
q.setAlignY(h);
var u=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var t=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var r=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
s.add(u);
s.add(t);
s.add(r);
...
var x=new qx.ui.container.Composite(v).set({decorator:k,backgroundColor:i,height:100,allowGrowX:false});
v.setSpacing(5);
v.setAlignY(h);
var z=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var y=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var w=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
x.add(z);
x.add(y);
x.add(w);
z.setMarginTop(20);
...
return x;
},getBox5:function(){var b=new qx.ui.layout.HBox();
var d=new qx.ui.container.Composite(b).set({decorator:k,backgroundColor:i,height:100,allowGrowX:false});
b.setSpacing(5);
b.setAlignY(h);
