...
(function(){var n="changeValue",m="2007-01-30 22:54:03",l="Trash",k="-rwxr-xr-x",j="Permissions",h="Documents (D:)",g="Windows (C:)",f="Inbox",d="Desktop",c="execute",Q="color: white;",P="font-weight: bold;",O="Disable the tree?",N="1*",M="Network",L="Control",K="Last Accessed",J="changeSelection",I="Sent",H="Files",v="demobrowser.demo.treevirtual.TreeVirtual_Multiple_Columns",w="background-color: red; ",t="Workspace",u="Open/close click selects row?",r="Remove",s="treeOpenWhileEmpty",p="Tree",q="Spam",x="background-color: cyan;",y="Data",B="Always show open/close symbol?",A="Current Selection: ",D='/',C="Remove open/close if found empty?",F="Exclude first-level tree lines?",E="Spam Message #",z="Use tree lines if theme supports them?",G="Edit";
qx.Class.define(v,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
qx.Class.include(qx.ui.treevirtual.TreeVirtual,qx.ui.treevirtual.MNode);
var bb=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
this.getRoot().add(bb,{edge:30});
var U=new qx.ui.treevirtual.TreeVirtual([p,j,K]);
U.set({width:400});
U.setAlwaysShowOpenCloseSymbol(true);
var T=U.getTableColumnModel().getBehavior();
T.set(0,{width:N,minWidth:180});
bb.add(U);
var ba=U.getDataModel();
var W=ba.addBranch(null,d,true);
U.nodeSetLabelStyle(W,w+Q+P);
var S;
ba.addBranch(W,H,true);
S=ba.addBranch(W,t,true);
var Y=ba.addLeaf(S,g);
ba.setColumnData(Y,1,k);
ba.setColumnData(Y,2,m);
Y=ba.addLeaf(S,h);
ba.setColumnData(Y,1,k);
ba.setColumnData(Y,2,m);
ba.addBranch(W,M,true);
Y=ba.addBranch(W,l,true);
U.nodeSetCellStyle(Y,x);
var X=ba.addBranch(null,f,true);
Y=ba.addBranch(X,q,false);

for(var i=1;i<3000;i++){ba.addLeaf(Y,E+i);
}ba.addBranch(X,I,false);
ba.addBranch(X,l,false);
ba.addBranch(X,y,false);
ba.addBranch(X,G,false);
ba.setData();
var V=new qx.ui.groupbox.GroupBox(L);
V.setLayout(new qx.ui.layout.Canvas());
bb.add(V);
var o=new qx.ui.basic.Atom(A);
V.add(o,{left:0,top:6});
o=new qx.ui.form.TextField();
o.set({readOnly:true});
V.add(o,{left:4,right:0,top:20});
U.addListener(J,function(e){var a=e.getData();
this.setValue(U.getHierarchy(a[0].nodeId).join(D));
R.setEnabled(true);
},o);
var R=new qx.ui.form.Button(r);
R.set({enabled:false});
V.add(R,{top:50,left:0});
R.addListener(c,function(e){var b=U.getSelectedNodes();

for(var i=0;i<b.length;i++){ba.prune(b[i].nodeId,true);
ba.setData();
}});
o=new qx.ui.form.CheckBox(z);
o.set({value:true});
V.add(o,{top:80,left:0});
o.addListener(n,function(e){U.setUseTreeLines(e.getData());
});
o=new qx.ui.form.CheckBox(F);
o.set({value:false});
V.add(o,{top:100,left:0});
o.addListener(n,function(e){U.setExcludeFirstLevelTreeLines(e.getData());
});
o=new qx.ui.form.CheckBox(B);
o.set({value:true});
V.add(o,{top:120,left:0});
o.addListener(n,function(e){U.setAlwaysShowOpenCloseSymbol(e.getData());
});
o=new qx.ui.form.CheckBox(C);
o.set({value:true});
V.add(o,{top:140,left:0});
U.addListener(s,function(e){if(this.getValue()){var bc=e.getData();
U.nodeSetHideOpenClose(bc,true);
}},o);
o=new qx.ui.form.CheckBox(u);
o.set({value:false});
V.add(o,{top:160,left:0});
o.addListener(n,function(e){U.setOpenCloseClickSelectsRow(e.getData());
});
o=new qx.ui.form.CheckBox(O);
o.set({value:false});
V.add(o,{top:180,left:0});
o.addListener(n,function(e){U.setEnabled(!e.getData());
});
}}});
})();
