...
(function(){var y="row",x="Last item is intentionally ",w="demobrowser.demo.progressive.ProgressiveTable",v="start",u="</span>",t="Number",s="1*",r="<span style='color:red;'>",q="inserted at the top to show how ",p="it's done",m="end",o="Date",n="Id";
qx.Class.define(w,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var i=0;
var e=function(z){var C=[];
var B=new Date().getTime();
var D=400*24*60*60*1000;

for(var E=0;E<z;E++){var A=new Date(B+Math.random()*D-D/2);
C.push({renderer:y,location:E==z-1?v:m,data:[i++,Math.random()*10000,A]});
}return C;
};
...
var j=new qx.ui.basic.Atom(r+x+q+p+u);
j.setRich(true);
j.setHeight(16);
a.add(j);
...
g.addElements(f);
a.setDataModel(g);
var l=new qx.ui.progressive.renderer.table.Row(h);
a.addRenderer(y,l);
a.set({width:500,maxWidth:500});
