...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.showcase.Browser-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"38763416b51d"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var t="execute",s="This feature is currently not supported.",r="http://",q="demobrowser.demo.showcase.Browser",p="separator-vertical",o="icon/16/actions/go-previous.png",n="keypress",m="Enter",l="icon/16/actions/go-next.png",k="Web Browser",h="icon/16/actions/media-playback-start.png",j="http://web.de",i="icon/16/categories/internet.png",g="middle";
...
},_createBrowser:function(){var c=new qx.ui.window.Window(k,i);
var a=new qx.ui.layout.VBox();
a.setSeparator(p);
c.setLayout(a);
c.setAllowClose(false);
c.setContentPadding(0);
c.open();
var toolbar=new qx.ui.toolbar.ToolBar();
c.add(toolbar);
var d=new qx.ui.toolbar.Button(null,o);
d.addListener(t,function(e){this.iframe.getWindow().history.back();
},this);
toolbar.add(d);
var f=new qx.ui.toolbar.Button(null,l);
f.addListener(t,function(e){this.iframe.getWindow().history.forward();
},this);
toolbar.add(f);
f.setEnabled(false);
d.setEnabled(false);
f.setToolTipText(s);
d.setToolTipText(s);
this.txtUrl=new qx.ui.form.TextField().set({marginLeft:1,value:j,padding:2,alignY:g});
this.txtUrl.addListener(n,function(e){if(e.getKeyIdentifier()==m){this.surfTo(this.txtUrl.getValue());
}},this);
toolbar.add(this.txtUrl,{flex:1});
var b=new qx.ui.toolbar.Button(null,h);
b.addListener(t,function(e){this.surfTo(this.txtUrl.getValue());
},this);
toolbar.add(b);
...
c.add(this.iframe,{flex:1});
return c;
},surfTo:function(u){if(u.indexOf(r)!==0){u=r+u;
...
(function(){var n="qx.client",m="mousedown",l="load",k="help",j="mouseup",i="losecapture",h="contextmenu",g="none",f="display",d="repeat",E="Boolean",D="px",C="url(",B=")",A="gecko",z="div",y="__rc",x="DOMNodeInserted",w="_applyNativeHelp",v="/",t="appear",u="mshtml",r="block",s="qx.ui.embed.Iframe",p="iframe",q="absolute",o="qx/static/blank.gif";
qx.Class.define(s,{extend:qx.ui.embed.AbstractIframe,include:qx.ui.core.MNativeOverflow,construct:function(L){if(L!=null){this.__rb=L;
...
if(qx.core.Variant.isSet(n,A)){this.addListenerOnce(t,function(e){var F=this.getContainerElement().getDomElement();
qx.bom.Event.addNativeListener(F,x,this._onDOMNodeInserted);
});
this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);
}},properties:{appearance:{refine:true,init:p},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:E,init:false,apply:w}},members:{__rb:null,__rc:null,renderLayout:function(G,top,H,I){arguments.callee.base.call(this,G,top,H,I);
var K=D;
var J=this.getInsets();
this.__rc.setStyles({"left":J.left+K,"top":J.top+K,"width":(H-J.left-J.right)+K,"height":(I-J.top-J.bottom)+K});
},_createContentElement:function(){var a=new qx.html.Iframe(this.__rb);
a.addListener(l,this._onIframeLoad,this);
return a;
},_getIframeElement:function(){return this.getContentElement();
},_createBlockerElement:function(){var M=new qx.html.Element(z);
M.setStyles({"zIndex":20,"position":q,"display":g});
if(qx.core.Variant.isSet(n,u)){M.setStyles({backgroundImage:C+qx.util.ResourceManager.getInstance().toUri(o)+B,backgroundRepeat:d});
}return M;
},_onIframeLoad:function(e){this._applyNativeContextMenu(this.getNativeContextMenu(),null);
this._applyNativeHelp(this.getNativeHelp(),null);
this.fireNonBubblingEvent(l);
},block:function(){this.__rc.setStyle(f,r);
},release:function(){this.__rc.setStyle(f,g);
...
},_applyNativeHelp:qx.core.Variant.select(n,{"mshtml":function(N,O){var document=this.getDocument();

if(!document){return;
}
try{if(O===false){qx.bom.Event.removeNativeListener(document,k,qx.lang.Function.returnFalse);
}
if(N===false){qx.bom.Event.addNativeListener(document,k,qx.lang.Function.returnFalse);
}}catch(e){}},"default":function(){}}),_syncSourceAfterDOMMove:function(){var c=this.getContentElement().getDomElement();
var b=c.src;
if(b.charAt(b.length-1)==v){b=b.substring(0,b.length-1);
}
...
},events:{"load":d},members:{_applyProperty:function(name,h){arguments.callee.base.call(this,name,h);
