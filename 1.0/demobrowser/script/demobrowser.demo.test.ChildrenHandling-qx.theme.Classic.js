...
},createRemoveButton:function(r,s){var u=true;
var t=new qx.ui.form.Button(q+r.getBackgroundColor()).set({width:100});
t.addListener(d,function(){if(u){this._hbox.remove(r);
this._grid.remove(this._gridWidgets[s]);
t.setLabel(k+r.getBackgroundColor());
}else{this._hbox.add(r);
this._grid.add(this._gridWidgets[s],{row:0,column:s});
t.setLabel(q+r.getBackgroundColor());
}u=!u;
},this);
return t;
