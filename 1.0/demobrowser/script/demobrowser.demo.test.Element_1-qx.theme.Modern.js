...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_1-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"56d20a3f9a6d"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var y="id",x="100px",w="after2",v="text",u="hello",t="el3b",s="height",r="sans-serif",q="<b>hello</b>",p="color",N="demobrowser.demo.test.Element_1",M="18px",L="blue",K="before2",J="el2b",I="html",H="el2a",G="width",F="after1",E="test",C="el3a",D="bold",A="doc",B="before1",z="el1";
qx.Class.define(N,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var c=new qx.html.Root(document.getElementById(E));
c.setAttribute(y,A);
this.info("Basics");
...
d.setAttribute(I,q);
b.setAttribute(v,u);
b.setStyles({fontWeight:D,fontSize:M,fontFamily:r});
m.setStyle(p,L);
m.setStyle(G,x).setStyle(s,x);
