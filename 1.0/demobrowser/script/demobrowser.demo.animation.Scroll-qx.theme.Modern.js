...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Scroll-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"13e6dcff82fa"},
  boot : "boot",
  bootIsInline : true,
