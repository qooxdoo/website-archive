...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Validation-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d4f85a85c7c1"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var n="<br>",m="new name: ",l="new gender: ",k="male",j="female",i="new age: ",h="demobrowser.demo.test.Validation",g="<b>Setting the age ",f="property to 27</b><br>",e="- name: Name is validated to a minimum length of two.<br/>",Q="<br>old name: ",P="age:",O="fmale",N="<br><b>Setting the name to 'Hans'</b><br>",M="property to 'female'</b><br>",L="<br><b>Setting the gender ",K="<b>Testing the gender ",J="<br>old gender: ",I="<br><b>Setting the age ",H="- age: Age is validated to be a number.<br/>",u="<b>Initial property values</b><br>",v="",s="<b>Setting the name to ''</b><br>",t="demobrowser.demo.test.Person",q="property to 'true'</b><br>",r="- gender: Gender is validated to be either male or female.",o="property to 'fmale'</b><br>",p="<font color='red'>GENDER NOT SET</font>",w="gender:",x="<br>old age: ",A="Hans",z="The demo creates an internal class containing three properties:<br/>",C="<font color='red'>AGE NOT SET</font>",B="My name",E="<font color='red'>NAME NOT SET</font>",D="__FU",y="white",G="name:",F="<b>Description</b><br/>";
...
b.setBackgroundColor(y);
b.set({padding:10,width:250,height:360});
this.getRoot().add(b,{left:10,top:10});
b.setHtml(u);
b.setHtml(b.getHtml()+G+a.getName()+n);
b.setHtml(b.getHtml()+P+a.getAge()+n);
b.setHtml(b.getHtml()+w+a.getGender()+n);
b.setHtml(b.getHtml()+N);
a.setName(A);
b.setHtml(b.getHtml()+m+a.getName()+n);
b.setHtml(b.getHtml()+s);
try{a.setName(v);
b.setHtml(b.getHtml()+m+a.getName()+n);
}catch(R){b.setHtml(b.getHtml()+E+Q+a.getName()+n);
}b.setHtml(b.getHtml()+I+f);
a.setAge(27);
b.setHtml(b.getHtml()+i+a.getAge()+n);
b.setHtml(b.getHtml()+g+q);
try{a.setAge(true);
b.setHtml(b.getHtml()+i+a.getAge()+n);
}catch(S){b.setHtml(b.getHtml()+C+x+a.getAge()+n);
}b.setHtml(b.getHtml()+L+M);
a.setGender(j);
b.setHtml(b.getHtml()+l+a.getGender()+n);
b.setHtml(b.getHtml()+K+o);
try{a.setAge(O);
b.setHtml(b.getHtml()+l+a.getGender()+n);
}catch(T){b.setHtml(b.getHtml()+p+J+a.getGender()+n);
}var c=new qx.ui.basic.Label();
c.setRich(true);
c.setWidth(250);
c.setValue(F+z+e+H+r);
this.getRoot().add(c,{left:280,top:10});
}}});
qx.Class.define(t,{extend:qx.core.Object,properties:{name:{init:B,validate:D},age:{init:18,validate:qx.util.Validate.number()},gender:{init:k,validate:qx.util.Validate.inArray([k,j])}},members:{__FU:function(d){if(d.length<2){throw new qx.core.ValidationError("Validation Error: Name "+"must be longer than one characters. ("+d+")");
}}}});
})();
...
qx.Class.define(k,{extend:qx.ui.core.Widget,include:[qx.ui.core.MNativeOverflow],construct:function(x){arguments.callee.base.call(this);
...
A.setAttribute(g,y||s);
A.setStyles({"padding":o,"border":u});
...
if(qx.core.Variant.isSet(h,n)){this.getContainerElement().setStyle(r,a?t:u);
this.getContentElement().setStyle(r,a?t:u);
