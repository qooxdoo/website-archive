...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.MouseEvent","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.MouseEvent-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"0cdf8fcec6f2"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var p="change",o="mousedown",n="mouseout",m="demobrowser.demo.event.MouseEvent",l="clientX",k="dblclick",j="relatedTarget",h="mouse",g="button",f="capture",F="mousemove",E="pageY",D="screenX",C="logger",B="",A="mouseover",z="check_",y="click",x="Event",w="Target",u="clientY",v="mouseup",s="losecapture",t="contextmenu",q="screenY",r="pageX";
qx.Class.define(m,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
this._initLogger([w,x,g,r,E,l,u,D,q,j],document.getElementById(C),50);
var a=document.getElementById(h);
var c=[o,v,y,k,t,F,A,n];

for(var i=0;i<c.length;i++){var d=document.getElementById(z+c[i]);

if(d.checked){qx.bom.Element.addListener(a,c[i],this.logMouseEvent,this);
}qx.bom.Element.addListener(d,p,this.__FR,this);
}var b=document.getElementById(f);
b.checked=false;
qx.bom.Element.addListener(b,p,function(e){var J=e.getTarget().checked;

if(J){qx.bom.Element.capture(a);
}else{qx.bom.Element.releaseCapture(a);
}},this);
qx.bom.Element.addListener(a,s,function(e){b.checked=false;
},this);
},__FR:function(e){var I=e.getTarget().id.split("_")[1];
var G=e.getTarget().checked;
var H=document.getElementById("mouse");

if(G){qx.bom.Element.addListener(H,I,this.logMouseEvent,this);
}else{qx.bom.Element.removeListener(H,I,this.logMouseEvent,this);
}},logMouseEvent:function(K){K.preventDefault();
this._log([K.getTarget().id,K.getType(),K.getButton(),K.getDocumentLeft(),K.getDocumentTop(),K.getScreenLeft(),K.getScreenTop(),K.getViewportLeft(),K.getViewportTop(),K.getRelatedTarget()?K.getRelatedTarget().id:B]);
}}});
})();
