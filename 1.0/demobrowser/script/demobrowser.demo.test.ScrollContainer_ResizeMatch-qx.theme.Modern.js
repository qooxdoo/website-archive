...
i.set({width:200,height:200});
this.getRoot().add(i,{left:10,top:10});
i.add(this.generateBox());
var h=new qx.ui.form.Button(e);
var j=true;
h.addListener(b,function(){i.setWidth(j?300:200);
i.setHeight(j?300:200);
j=!j;
});
this.getRoot().add(h,{left:10,top:400});
},generateBox:function(){var g=new qx.ui.basic.Label(a).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:f,textColor:d,padding:10});
return g;
}}});
})();
