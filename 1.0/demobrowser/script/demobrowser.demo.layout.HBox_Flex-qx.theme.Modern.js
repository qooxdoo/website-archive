...
var l=new qx.ui.container.Composite(k).set({width:500,decorator:f,backgroundColor:d,allowGrowX:false});
k.setSpacing(5);
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:3});
return l;
},getBox2:function(){var g=new qx.ui.layout.HBox();
var h=new qx.ui.container.Composite(g).set({width:500,decorator:f,backgroundColor:d,allowGrowX:false});
g.setSpacing(5);
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:30}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:150}),{flex:3});
return h;
...
var p=new qx.ui.container.Composite(o).set({width:600,minWidth:600,decorator:f,backgroundColor:d,allowGrowX:false});
o.setSpacing(5);
p.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:120}),{flex:1});
p.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:120}),{flex:2});
p.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:120}),{flex:3});
return p;
},getBox5:function(){var a=new qx.ui.layout.HBox();
var b=new qx.ui.container.Composite(a).set({width:300,minWidth:0,decorator:f,backgroundColor:d,allowGrowX:false});
a.setSpacing(5);
b.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:1});
b.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:2});
b.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:3});
return b;
},getBox6:function(){var m=new qx.ui.layout.HBox();
var n=new qx.ui.container.Composite(m).set({width:300,decorator:f,backgroundColor:d,allowGrowX:false});
m.setSpacing(5);
n.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:1});
n.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:2});
n.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:3});
return n;
}}});
})();
