...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.KeyEvent","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.KeyEvent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"6377eb5b3e37"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="keyinput",n="",m="logger",l="keypress",k="Char code",j="Ctrl",h="Key identifier",g="demobrowser.demo.event.KeyEvent",f="Shift",e="keydown",b="Event",d="Alt",c="keyup";
qx.Class.define(g,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
this._initLogger([b,h,k,f,j,d],document.getElementById(m),50);
var a=[e,l,c,o];

for(var i=0;i<a.length;i++){qx.bom.Element.addListener(document.documentElement,a[i],this.logKeyEvent,this);
}},logKeyEvent:function(p){var q=p.getType();
this._log([q,q!==o?p.getKeyIdentifier():n,q==o?p.getCharCode():n,p.isShiftPressed(),p.isAltPressed(),p.isCtrlPressed()]);
p.preventDefault();
}}});
})();
