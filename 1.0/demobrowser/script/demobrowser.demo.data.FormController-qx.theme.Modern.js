...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.FormController-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"0b9021903a2f"},
  boot : "boot",
  bootIsInline : true,
