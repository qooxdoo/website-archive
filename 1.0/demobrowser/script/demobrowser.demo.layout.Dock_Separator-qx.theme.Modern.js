...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Dock_Separator-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cbbd0b6912f6"},
  boot : "boot",
  bootIsInline : true,
