...
},generateScrollbarConfig:function(u,top){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));
var u=new qx.ui.basic.Label(u);
u.setMarginRight(20);
var v=new qx.ui.form.RadioButton(i);
var x=new qx.ui.form.RadioButton(c);
var w=new qx.ui.form.RadioButton(d);
v.setUserData(t,l);
x.setUserData(t,a);
w.setUserData(t,h);
v.setValue(true);
var z=new qx.ui.form.RadioGroup(v,x,w);
y.add(u);
y.add(v);
y.add(x);
y.add(w);
this.getRoot().add(y,{left:330,top:top});
return z;
},generateBox:function(){var A=new qx.ui.basic.Label(b).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:n,textColor:j,padding:10,decorator:new qx.ui.decoration.Single(4,f,m)});
return A;
}}});
})();
