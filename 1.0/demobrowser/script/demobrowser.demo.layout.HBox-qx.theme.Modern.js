...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"3853512f81cd"},
  boot : "boot",
  bootIsInline : true,
