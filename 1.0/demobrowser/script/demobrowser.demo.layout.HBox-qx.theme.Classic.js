...
(function(){var m="main",l="green",k="yellow",j="center",i="right",h="demobrowser.demo.layout.HBox",g="top",f="bottom",e="middle";
...
s.add(this.getBox6());
s.add(this.getBox7());
},getBox1:function(){var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:m,backgroundColor:k,allowGrowX:false});
D.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
D.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
D.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
return D;
},getBox2:function(){var r=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:m,backgroundColor:k,minHeight:60,allowGrowX:false});
r.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l,maxHeight:40,alignY:g}));
r.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l,maxHeight:40,alignY:e}));
r.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l,maxHeight:40,alignY:f}));
return r;
},getBox3:function(){var c=new qx.ui.layout.HBox();
var d=new qx.ui.container.Composite(c).set({decorator:m,backgroundColor:k,width:500,allowGrowX:false});
c.setSpacing(5);
c.setAlignX(i);
d.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
d.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
...
var b=new qx.ui.container.Composite(a).set({decorator:m,backgroundColor:k,width:500,allowGrowX:false});
a.setSpacing(5);
a.setAlignX(j);
b.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
b.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
b.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
return b;
},getBox5:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:m,backgroundColor:k,allowGrowX:false});
var q=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var p=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var n=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
o.add(q);
o.add(p);
o.add(n);
q.setMarginRight(10);
...
n.setMarginRight(10);
return o;
},getBox6:function(){var y=new qx.ui.layout.HBox();
var A=new qx.ui.container.Composite(y).set({decorator:m,backgroundColor:k,width:500,allowGrowX:false});
y.setSpacing(5);
y.setAlignX(i);
var C=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var B=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var z=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
A.add(C);
A.add(B);
A.add(z);
C.setMarginRight(10);
...
z.setMarginRight(10);
return A;
},getBox7:function(){var t=new qx.ui.layout.HBox();
var v=new qx.ui.container.Composite(t).set({decorator:m,backgroundColor:k,width:500,allowGrowX:false});
t.setSpacing(5);
t.setAlignX(j);
var x=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var w=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
v.add(x);
v.add(w);
v.add(u);
x.setMarginRight(10);
