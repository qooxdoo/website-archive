...
return c;
},getGrid3:function(){var s=new qx.ui.container.Composite().set({decorator:p,backgroundColor:n,width:400,height:300,allowShrinkX:false,allowShrinkY:false});
var r=new qx.ui.layout.Grid();
r.setColumnFlex(1,2);
r.setRowFlex(1,3);
r.setSpacing(5);
s.setLayout(r);
s.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:0,column:0});
s.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:0,column:1});
s.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:1,column:0});
s.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:1,column:1});
return s;
}}});
})();
