...
this.getRoot().add(F);
var G=new qx.ui.basic.Label(n).set({decorator:w,width:200});
F.add(G);
this.getRoot().add(this.createConfigureButton(G,i),{left:240,top:20});
var H=new qx.ui.basic.Label(p).set({decorator:w,rich:true});
F.add(H);
this.getRoot().add(this.createConfigureButton(H,k),{left:240,top:60});
var I=new qx.ui.basic.Label(q).set({decorator:w,width:80});
F.add(I);
var J=new qx.ui.basic.Label().set({value:l,decorator:w,rich:true,width:120});
F.add(J);
var K=new qx.ui.basic.Label(e).set({decorator:w,font:new qx.bom.Font(28,[v,u])});
F.add(K);
var L=new qx.ui.basic.Label(r).set({decorator:w,font:new qx.bom.Font(28,[v,u]),width:150});
F.add(L);
...
C.setColumnFlex(1,1);
C.setColumnAlign(0,j,o);
A.setLayout(C);
var B=new qx.data.controller.Object(y);
A.add(new qx.ui.basic.Label(x).set({paddingTop:5}),{row:0,column:0});
var D=new qx.ui.form.TextArea().set({liveUpdate:true});
B.addTarget(D,x,x,true);
A.add(D,{row:0,column:1});
A.add(new qx.ui.basic.Label(t),{row:1,column:0});
var E=new qx.ui.form.CheckBox();
B.addTarget(E,x,t,true);
A.add(E,{row:1,column:1});
A.add(new qx.ui.basic.Label(h),{row:2,column:0});
var E=new qx.ui.form.CheckBox();
B.addTarget(E,x,f,true);
A.add(E,{row:2,column:1});
A.add(new qx.ui.basic.Label(s),{row:3,column:0});
