...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_NegativeMargin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"22d353e019b9"},
  boot : "boot",
  bootIsInline : true,
...
i.setMarginLeft(-10);
return j;
},getBox3:function(){var E=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:500,allowGrowX:false});
...
D.setMarginLeft(-10);
return E;
},getBox4:function(){var A=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:500,allowGrowX:false});
...
I.setMarginLeft(-10);
return J;
},getBox7:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:200,allowGrowX:false});
