...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.FormRendererPlaceholder-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ffa66361a7da"},
  boot : "boot",
  bootIsInline : true,
