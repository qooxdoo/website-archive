...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Application-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"9cf1d46619e7"},
  boot : "boot",
  bootIsInline : true,
