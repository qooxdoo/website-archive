...
k.add(this.getGrid1());
k.add(this.getGrid2());
},getGrid1:function(){var a=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,allowGrowX:false});
a.setLayout(new qx.ui.layout.Grid(5,20));
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:0});
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:1});
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,width:150,maxWidth:150}),{row:1,column:0,rowSpan:1,colSpan:2});
return a;
...
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,height:70,allowGrowX:false}),{row:0,column:1});
