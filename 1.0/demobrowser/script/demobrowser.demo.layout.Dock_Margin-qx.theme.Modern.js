...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Dock_Margin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cb62e76283e3"},
  boot : "boot",
  bootIsInline : true,
