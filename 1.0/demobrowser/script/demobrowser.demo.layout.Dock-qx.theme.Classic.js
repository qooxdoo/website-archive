...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Dock-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ac230d3df886"},
  boot : "boot",
  bootIsInline : true,
