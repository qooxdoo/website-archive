...
(function(){var y="horizontal",x="main",w="Flex:1",v="Flex:1; Min:250",u="Auto",t="Flex:2",s="Flex:0",r="Flex:2; Max:100",q="Flex:1; Max:100",p="Flex:1; Max:200",m="Flex:2; Min:250",o="Flex:0; Min:350",n="demobrowser.demo.layout.HSplit";
...
},addSplitPaneTwoFlexSimple:function(){var h=new qx.ui.splitpane.Pane(y);
h.setWidth(400);
h.setHeight(60);
h.setDecorator(x);
this.getRoot().add(h,{left:20,top:20});
var g=new qx.ui.form.TextArea(w);
g.setDecorator(null);
g.setWrap(true);
h.add(g,1);
var i=new qx.ui.form.TextArea(t);
i.setDecorator(null);
i.setWrap(true);
h.add(i,2);
},addSplitPaneTwoFlexWithOneMin:function(){var k=new qx.ui.splitpane.Pane(y);
k.setWidth(400);
k.setHeight(60);
k.setDecorator(x);
...
j.setMinWidth(250);
k.add(j,1);
var l=new qx.ui.form.TextArea(t);
l.setDecorator(null);
l.setWrap(true);
k.add(l,2);
},addSplitPaneTwoFlexWithOneMax:function(){var M=new qx.ui.splitpane.Pane(y);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(x);
...
L.setWrap(true);
M.add(L,1);
var N=new qx.ui.form.TextArea(r);
N.setDecorator(null);
N.setWrap(true);
N.setMaxWidth(100);
M.add(N,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var G=new qx.ui.splitpane.Pane(y);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(x);
this.getRoot().add(G,{left:20,top:260});
var F=new qx.ui.form.TextArea(v);
F.setDecorator(null);
F.setWrap(true);
F.setMinWidth(250);
G.add(F,1);
var H=new qx.ui.form.TextArea(m);
H.setDecorator(null);
H.setWrap(true);
H.setMinWidth(250);
G.add(H,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var D=new qx.ui.splitpane.Pane(y);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(x);
...
C.setMaxWidth(100);
D.add(C,1);
var E=new qx.ui.form.TextArea(r);
E.setDecorator(null);
E.setWrap(true);
E.setMaxWidth(100);
D.add(E,2);
},addSplitPaneOneFlexSimple:function(){var e=new qx.ui.splitpane.Pane(y);
e.setWidth(400);
e.setHeight(60);
e.setDecorator(x);
...
d.setWrap(true);
e.add(d,0);
var f=new qx.ui.form.TextArea(w);
f.setDecorator(null);
f.setWrap(true);
e.add(f);
},addSplitPaneOneFlexSimpleWithMax:function(){var A=new qx.ui.splitpane.Pane(y);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(x);
this.getRoot().add(A,{left:500,top:100});
var z=new qx.ui.form.TextArea(s);
z.setDecorator(null);
z.setWrap(true);
A.add(z,0);
var B=new qx.ui.form.TextArea(p);
B.setDecorator(null);
B.setWrap(true);
B.setMaxWidth(200);
A.add(B);
},addSplitPaneOneFlexSimpleWithMin:function(){var b=new qx.ui.splitpane.Pane(y);
b.setWidth(400);
b.setHeight(60);
b.setDecorator(x);
this.getRoot().add(b,{left:500,top:180});
var a=new qx.ui.form.TextArea(o);
a.setDecorator(null);
a.setWrap(true);
a.setMinWidth(350);
b.add(a,0);
var c=new qx.ui.form.TextArea(w);
c.setDecorator(null);
c.setWrap(true);
b.add(c);
},addSplitPaneAuto:function(){var J=new qx.ui.splitpane.Pane(y);
J.setDecorator(x);
...
I.setWrap(true);
J.add(I,0);
var K=new qx.ui.form.TextArea(u);
K.setDecorator(null);
K.setWrap(true);
J.add(K);
}}});
