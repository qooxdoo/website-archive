...
(function(){var o="100px",n="200px",m="absolute",l="300px",k="click",j="button",i="Block Document for 5s",h="demobrowser.demo.bom.Blocker",g="red",f="Block Element for 5s",b="320px",d="div",c="orange",a="150px";
qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var q=qx.bom.Input.create(j,{value:i});
qx.bom.element.Style.setStyles(q,{position:m,left:o,top:o,width:n});
var s=new qx.bom.Blocker;
s.setBlockerOpacity(0.5);
qx.event.Registration.addListener(q,k,function(e){s.setBlockerColor(g);
s.block();
qx.event.Timer.once(function(e){s.unblock();
},window,5000);
});
qx.dom.Element.insertEnd(q,document.body);
var p=qx.bom.Input.create(j,{value:f});
qx.bom.element.Style.setStyles(p,{position:m,left:b,top:o,width:n});
var r=qx.bom.Element.create(d);
qx.bom.element.Style.setStyles(r,{position:m,left:l,top:a,width:l,height:n,backgroundColor:c,zIndex:500});
qx.dom.Element.insertBegin(r,document.body);
qx.event.Registration.addListener(p,k,function(e){s.block(r);
qx.event.Timer.once(function(e){s.unblock();
},window,5000);
});
