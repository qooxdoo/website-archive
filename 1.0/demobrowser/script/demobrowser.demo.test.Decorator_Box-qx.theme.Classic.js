...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Decorator_Box-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"2f97106547d1"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var N="px",M="no-repeat",L="0",K="-1px",J="-c",I="mshtml",H="horizontal",G="",F="qx.ui.decoration.AbstractBox",E="-l",x='<div style="position:absolute;top:0;left:0;overflow:hidden;font-size:0;line-height:0;">',D='</div>',A="_applyBaseImage",v="-b",u="-t",z="repeat-x",y="repeat-y",B="abstract",t="-r",C="String",w="qx.client";
qx.Class.define(F,{extend:qx.ui.decoration.Abstract,type:B,construct:function(P,Q){arguments.callee.base.call(this);
if(P!=null){this.setBaseImage(P);
}
if(Q!=null){this.setInsets(Q);
}},properties:{baseImage:{check:C,nullable:true,apply:A}},members:{__Gl:null,__Gm:null,__Gn:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__Gl;
},_setOrientation:function(O){this._isHorizontal=O==H;
},getMarkup:function(){if(this.__Gl){return this.__Gl;
...
if(this._isHorizontal){o.push(l.create(m.l,M,{top:0,left:0}));
o.push(l.create(m.c,z,{top:0,left:n.left+N}));
o.push(l.create(m.r,M,{top:0,right:0}));
}else{o.push(l.create(m.t,M,{top:0,left:0}));
o.push(l.create(m.c,y,{top:n.top+N,left:n.left+N}));
o.push(l.create(m.b,M,{bottom:0,left:0}));
}o.push(D);
return this.__Gl=o.join(G);
},resize:function(p,q,r){p.style.width=q+N;
p.style.height=r+N;
var s=this.__Gn;

if(this._isHorizontal){var innerWidth=q-s.left-s.right;
p.childNodes[1].style.width=innerWidth+N;
}else{var innerHeight=r-s.top-s.bottom;
p.childNodes[1].style.height=innerHeight+N;
}
if(qx.core.Variant.isSet(w,I)){if(qx.bom.client.Engine.VERSION<7||(qx.bom.client.Feature.QUIRKS_MODE&&qx.bom.client.Engine.VERSION<8)){if(this._isHorizontal){p.childNodes[2].style.marginRight=(q%2==1)?K:L;
}else{p.childNodes[2].style.marginBottom=(r%2==1)?K:L;
...
var f=h[1];
var d=h[2];
var i=this.__Gm={t:f+u+d,b:f+v+d,c:f+J+d,l:f+E+d,r:f+t+d};
this.__Gn={top:c.getImageHeight(i.t),bottom:c.getImageHeight(i.b),left:c.getImageWidth(i.l),right:c.getImageWidth(i.r)};
}}},destruct:function(){this.__Gl=this.__Gm=this.__Gn=null;
}});
})();
