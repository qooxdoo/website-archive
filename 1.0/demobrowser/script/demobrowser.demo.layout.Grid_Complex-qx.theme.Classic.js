...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Grid_Complex-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d07b6d68f171"},
  boot : "boot",
  bootIsInline : true,
