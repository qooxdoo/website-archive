...
(function(){var k="legend",j="changeValue",i="execute",h="resize",g="check-groupbox",f="qx.event.type.Event",d="qx.ui.groupbox.CheckGroupBox",c="qx.event.type.Data";
qx.Class.define(d,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IExecutable,qx.ui.form.IBooleanForm],properties:{appearance:{refine:true,init:g}},events:{"changeValue":c,"execute":f},members:{_createChildControlImpl:function(m){var n;

switch(m){case k:n=new qx.ui.form.CheckBox();
n.setValue(true);
n.addListener(j,this._onRadioChangeValue,this);
n.addListener(h,this._repositionFrame,this);
n.addListener(i,this._onExecute,this);
this._add(n);
}return n||arguments.callee.base.call(this,m);
...
(function(){var m="legend",l="changeValue",k="execute",j="resize",i="changeName",h="changeChecked",g="qx.ui.groupbox.RadioGroupBox",f="radio-groupbox",d="qx.event.type.Event",c="qx.event.type.Data";
qx.Class.define(g,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IRadioItem,qx.ui.form.IExecutable,qx.ui.form.IBooleanForm],properties:{appearance:{refine:true,init:f}},events:{"changeValue":c,"execute":d},members:{_createChildControlImpl:function(n){var o;

switch(n){case m:o=new qx.ui.form.RadioButton;
o.setValue(true);
o.addListener(l,this._onRadioChangeValue,this);
o.addListener(j,this._repositionFrame,this);
o.addListener(k,this._onExecute,this);
this._add(o);
...
this.fireDataEvent(l,a,e.getOldData());
},_onRadioChangeName:function(e){this.fireDataEvent(i,e.getData());
},execute:function(){this.getChildControl(m).execute();
},setCommand:function(p){this.getChildControl(m).setCommand(p);
},getCommand:function(){return this.getChildControl(m).getCommand();
},getGroup:function(){return this.getChildControl(m).getGroup();
},setGroup:function(b){if(b!=null){b.add(this);
}return;
},getValue:function(){return this.getChildControl(m).getValue();
},setValue:function(q){this.getChildControl(m).setValue(q);
},resetValue:function(){this.getChildControl(m).resetValue();
},getLabel:function(){return this.getChildControl(m).getLabel();
}}});
})();
