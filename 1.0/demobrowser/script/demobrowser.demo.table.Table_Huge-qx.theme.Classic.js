...
(function(){var o="x",n="_tableModel",m="Cell ",l="Table",k="demobrowser.demo.table.Table_Huge",j="Column ";
qx.Class.define(k,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return l;
},COL_COUNT:50,ROW_COUNT:10000,createRandomRows:function(e){var g=[];

for(var h=0;h<e;h++){var f=[];

for(var i=0;i<this.COL_COUNT;i++){f.push(m+i+o+h);
}g.push(f);
}return g;
...
for(var i=0;i<this.COL_COUNT;i++){d.push(j+i);
}a.setColumns(d);
a.setData(b);
