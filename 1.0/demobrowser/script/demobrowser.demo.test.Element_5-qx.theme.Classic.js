...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Element_5","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_5-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"aa1796fdd96c"},
  boot : "boot",
  bootIsInline : true,
