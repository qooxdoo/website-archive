...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Element_2","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_2-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"2a56a4383eea"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var B="id",A="text",z="el4_2",y="el4_1",x="backgroundColor",w="#ccc",v="fontSize",u="demobrowser.demo.test.Element_2",t="20px",s="el5",m="red",r="el4_3",p="el2",l="el3",k="el4",o="test",n="doc",q="color",j="el1";
...
var a=new qx.html.Root(document.getElementById(o));
a.setAttribute(B,n);
