...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Table-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"36e4657ad838"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="__JA",c="white",b="#EEE",a="vertical";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__JA:null,main:function(){arguments.callee.base.call(this);
...
this.__JA=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__JA.getCellProperties(j+g+k);
