...
(function(){var f="demobrowser.demo.test.DummyTable",e="main",d="demobrowser.demo.test.Table_Scroller",c="#FFE",b="table";
qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var a=new demobrowser.demo.test.DummyTable();
this.getRoot().add(a,{left:10,top:10});
}}});
qx.Class.define(f,{extend:qx.ui.container.Composite,include:[demobrowser.demo.table.MUtil],construct:function(){arguments.callee.base.call(this,new qx.ui.layout.Canvas());
this.setAppearance(b);
this.set({decorator:e,backgroundColor:c,width:600,height:400});
