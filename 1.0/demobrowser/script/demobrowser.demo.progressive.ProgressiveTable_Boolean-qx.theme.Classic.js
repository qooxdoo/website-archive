...
this.__HX=L.toUri(J);
this.__HY=L.toUri(I);
},properties:{allowToggle:{check:G,init:false}},members:{__HX:null,__HY:null,__Ia:null,__Ib:null,__Ic:null,__Id:null,__Ie:null,__If:null,_identifyImage:function(a){var b={imageWidth:11,imageHeight:11};

switch(a.cellData){case true:b.url=this.__HX;
b.extras=y;
break;
case false:b.url=this.__HY;
b.extras=r;
break;
default:b.url=null;
break;
}
if(this.getAllowToggle()){b.extras+=p+D+A+n+q+g;

if(qx.core.Variant.isSet(i,e)&&/\.png$/i.test(this.__HX)){b.extras+=k+this.getBlankImage()+l+f+j+c+this.__HX+l+d;
}else{b.extras+=k+this.__HX+l;
}b.extras+=o+x+w+g;

if(qx.core.Variant.isSet(i,e)&&/\.png$/i.test(this.__HY)){b.extras+=k+this.getBlankImage()+l+f+j+c+this.__HY+l+d;
}else{b.extras+=k+this.__HY+l;
}b.extras+=s+h;
b.extras+=u+t+E+v+m+F+h+H;
}return b;
},_getCellStyle:function(M){var N=arguments.callee.base.call(this,M);
return N;
}},destruct:function(){this.__HX=this.__HY=null;
}});
})();
