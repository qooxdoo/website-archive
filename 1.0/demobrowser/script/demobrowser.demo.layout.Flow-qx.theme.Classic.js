...
(function(){var B="icon/48/devices/computer.png",A="7th a wide, short button",z="1. First Button",y="Flow Layout with line breaks",x="Number 6",w="demobrowser.demo.layout.Flow",v="Flow Layout",u="center",t="20px Margins around the great big 5th button!",s="top",o="bottom",r="3rd really, really, really long Button",q="middle",n="Number 4",m="item #",p="2. Second longer Button...";
...
},_createGalleryWindow:function(C,top){var D=new qx.ui.window.Window(v).set({contentPadding:0,width:200});
...
for(var i=0;i<30;i++){E.add(new qx.ui.basic.Atom(m+(i+1),B).set({iconPosition:s,width:60,padding:5}));
}D.moveTo(C,top);
D.open();
},_createLineBreakWindow:function(a,top){var k=new qx.ui.layout.Flow();
k.setAlignX(u);
var b=new qx.ui.window.Window(y).set({contentPadding:0,width:500,height:200,layout:k});
var l=B;
var e=new qx.ui.form.Button(z,l);
b.add(e);
var d=new qx.ui.form.Button(p,l);
b.add(d,{lineBreak:true});
var c=new qx.ui.form.Button(r,l);
c.setHeight(100);
b.add(c);
var j=new qx.ui.form.Button(n,l);
j.setAlignY(o);
b.add(j);
var h=new qx.ui.form.Button(t);
h.setHeight(100);
h.setMargin(20);
b.add(h,{lineBreak:true});
var g=new qx.ui.form.Button(x,l);
g.setAlignY(q);
b.add(g);
var f=new qx.ui.form.Button(A,l);
f.setMaxHeight(20);
b.add(f);
b.moveTo(a,top);
b.open();
...
qx.Class.define(v,{extend:qx.ui.layout.Abstract,construct:function(q,r,s){arguments.callee.base.call(this);
...
}},properties:{alignX:{check:[B,A,u],init:B,apply:C},alignY:{check:[z,x,w],init:z,apply:C},spacingX:{check:y,init:0,apply:C},spacingY:{check:y,init:0,apply:C},reversed:{check:t,init:false,apply:C}},members:{verifyLayoutProperty:null,renderLayout:function(E,F){var J=this._getLayoutChildren();
...
}},__zk:function(g,h,j){var l=qx.ui.layout.Util;
var o=0;

if(this.getAlignX()!=B){o=j-g.width;

if(this.getAlignX()==A){o=Math.round(o/2);
}}
for(var i=0;i<g.children.length;i++){var m=g.children[i];
var p=m.getSizeHint();
var n=m.getMarginTop();
var k=m.getMarginBottom();
var top=l.computeVerticalAlignOffset(m.getAlignY()||this.getAlignY(),n+p.height+k,g.height,n,k);
m.renderLayout(o+g.gapsBefore[i],h+top,p.width,p.height);
o+=g.gapsBefore[i]+p.width;
}},_computeSizeHint:function(){return this.__zl(Infinity);
},hasHeightForWidth:function(){return true;
},getHeightForWidth:function(D){return this.__zl(D).height;
},__zl:function(a){var b=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());
var f=0;
var c=0;
var d=0;
...
qx.Class.define(a,{extend:Object,construct:function(b,c){this.__zm=b;
this.__zn=c;
this.__zo=b.length>0;
this.__zp=0;
},members:{__zm:null,__zn:null,__zo:null,__zp:null,computeNextLine:function(d){var d=d||Infinity;

if(!this.__zo){throw new Error("No more lines to compute");
}var o=this.__zm;
var m=0;
var f=0;
var n=[];
...
for(var i=this.__zp;i<o.length;i++){var l=o[i];
var p=l.getSizeHint();
var h=this.__zq(i);
var g=p.width+h;
var e=i==this.__zp;

if(!e&&f+g>d){this.__zp=i;
break;
...
if(l.getLayoutProperties().lineBreak){this.__zp=i+1;
break;
}}
if(i>=o.length){this.__zo=false;
}return {height:m,width:f,children:n,gapsBefore:j};
},__zq:function(q){var r=q==this.__zp;

if(r){return this.__zm[q].getMarginLeft();
}else{return Math.max(this.__zm[q-1].getMarginRight(),this.__zm[q].getMarginLeft(),this.__zn);
}},hasMoreLines:function(){return this.__zo;
}}});
})();
