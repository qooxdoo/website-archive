...
(function(){var W="icon/16/devices/drive-harddisk.png",V="Trash",U="Windows (C:)",T="Documents (D:)",S="Family",R="TINC",Q="Development",P="Inbox",O="Desktop",N="Announce",bF="Personal",bE="Products",bD="-rw-r--r--",bC="Presets",bB="Competition",bA="Network",bz="Questions",by="Sent",bx="Spam",bw="Files",be="icon/16/status/dialog-information.png",bf="Bugs",bc="Projects",bd="Company",ba="Devel",bb="Workspace",X="Holiday",Y="icon/16/places/user-trash.png",bg="Chat",bh=" 2005",bo="Big",bm="Press",bq="Data",bp="Internal",bs="demobrowser.demo.widget.Tree_Columns",br="May ",bj="Root",bv="icon/16/places/user-desktop.png",bu="kb",bt="Pustefix",bi="Relations",bk="Lists",bl="Item ",bn="Edit";
qx.Class.define(bs,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var f=new qx.ui.container.Scroll();
var q=new qx.ui.container.Composite(new qx.ui.layout.Basic());
q.setAllowGrowX(false);
q.setAllowStretchX(false);
f.add(q);
this.getRoot().add(f,{edge:0});
var L=new qx.ui.tree.Tree().set({width:600,height:500});
q.add(L,{left:20,top:48});
var M=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bj);
M.setOpen(true);
L.setRoot(M);
var E=this.configureTreeItem(new qx.ui.tree.TreeFolder(),O);
M.add(E);
var g=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bw);
var d=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bb);
var e=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bA);
var c=this.configureTreeItem(new qx.ui.tree.TreeFolder(),V);
E.add(g,d,e,c);
var K=this.configureTreeItem(new qx.ui.tree.TreeFile(),U,W);
var J=this.configureTreeItem(new qx.ui.tree.TreeFile(),T,W);
d.add(K,J);
var F=this.configureTreeItem(new qx.ui.tree.TreeFolder(),P);
var h=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bC);
var l=this.configureTreeItem(new qx.ui.tree.TreeFolder(),by);
var k=this.configureTreeItem(new qx.ui.tree.TreeFolder(),V,Y);
var n=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bq);
var m=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bn);
var A=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bg);
var z=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bt);
var y=this.configureTreeItem(new qx.ui.tree.TreeFolder(),R);
var I=this.configureTreeItem(new qx.ui.tree.TreeFolder(),N);
var H=this.configureTreeItem(new qx.ui.tree.TreeFolder(),ba);
y.add(I,H);
m.add(A,z,y);
var p=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bk);
var v=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bi);
var w=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bd);
var x=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bz);
var r=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bp);
var s=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bE);
var t=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bm);
var u=this.configureTreeItem(new qx.ui.tree.TreeFolder(),Q);
var B=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bB);
p.add(v,w,x,r,s,t,u,B);
var o=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bF);
var C=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bf);
var G=this.configureTreeItem(new qx.ui.tree.TreeFolder(),S);
var D=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bc);
var j=this.configureTreeItem(new qx.ui.tree.TreeFolder(),X);
o.add(C,G,D,j);
var b=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bo);

for(var i=0;i<50;i++){b.add(this.configureTreeItem(new qx.ui.tree.TreeFolder(),bl+i));
}var a=this.configureTreeItem(new qx.ui.tree.TreeFolder(),bx);
F.add(h,l,k,n,m,p,o,b,a);
M.add(F);
},configureTreeItem:function(bG,bH,bI){if(Math.floor(Math.random()*4)==0){var bL=new qx.ui.basic.Image(be);
bG.addWidget(bL);
...
bG.setIcon(arguments.length>=3?bI:bv);
var bK=new qx.ui.form.CheckBox();
bK.setFocusable(false);
bG.addWidget(bK);
bG.addLabel(bH);
bG.addWidget(new qx.ui.core.Spacer(),{flex:1});
var bJ=new qx.ui.basic.Label(Math.round(Math.random()*100)+bu);
bJ.setWidth(50);
bG.addWidget(bJ);
bJ=new qx.ui.basic.Label(br+Math.round(Math.random()*30+1)+bh);
bJ.setWidth(150);
bG.addWidget(bJ);
bJ=new qx.ui.basic.Label(bD);
bJ.setWidth(80);
bG.addWidget(bJ);
return bG;
}}});
