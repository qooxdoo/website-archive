...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox_Margin","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Margin-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"653152f51fb9"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="main",n="green",m="yellow",l="center",k="demobrowser.demo.layout.VBox_Margin";
...
p.add(this.getBox4());
p.add(this.getBox5());
},getBox1:function(){var v=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:o,backgroundColor:m,allowGrowY:false});
...
var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
v.add(x);
v.add(w);
v.add(u);
x.setAllowGrowX(false);
w.setAllowGrowX(false);
u.setAllowGrowX(false);
x.setMarginLeft(20);
u.setMarginRight(30);
return v;
},getBox2:function(){var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:o,backgroundColor:m,allowGrowY:false});
...
var q=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
r.add(t);
r.add(s);
r.add(q);
t.setMarginLeft(20);
...
var c=new qx.ui.container.Composite(a).set({decorator:o,backgroundColor:m,width:150,allowGrowY:false});
a.setSpacing(5);
a.setAlignX(l);
...
b.setMarginRight(30);
return c;
},getBox4:function(){var f=new qx.ui.layout.VBox();
var h=new qx.ui.container.Composite(f).set({decorator:o,backgroundColor:m,width:150,allowGrowY:false});
f.setSpacing(5);
f.setAlignX(l);
var j=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var i=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var g=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
h.add(j);
h.add(i);
h.add(g);
j.setMarginLeft(20);
...
var A=new qx.ui.container.Composite(y).set({decorator:o,backgroundColor:m,width:150,allowGrowY:false});
y.setSpacing(5);
y.setAlignX(l);
var C=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
var B=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n});
