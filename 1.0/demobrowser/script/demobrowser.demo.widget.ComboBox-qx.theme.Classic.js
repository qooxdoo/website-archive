...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.ComboBox-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"7918c9475fbd"},
  boot : "boot",
  bootIsInline : true,
...
},_createIconExample:function(){var z=new qx.ui.basic.Label(n);
z.setFont(w);
this.getRoot().add(z,{left:160,top:25});
var x=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var y=new qx.ui.form.ListItem(i+o,j);
x.add(y);
