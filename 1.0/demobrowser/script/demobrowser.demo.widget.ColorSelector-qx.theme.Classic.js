...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.ColorSelector","qx.theme":"qx.theme.Classic"};
...
qx.$$resources = {};
qx.$$translations = {"C":{},"de":{"Details":"Details","HSB":"HSB","Hex":"Hex","Presets":"Voreinstellungen","Preview (Old/New)":"Vorschau (alt/neu)","RGB":"RGB"},"de_DE":{},"en":{},"en_US":{},"fr":{"Details":"Détails","HSB":"TSV","Hex":"Hex","Presets":"Pré-réglages","Preview (Old/New)":"Aperçu (Ancien/Nouveau)","RGB":"RVB"},"fr_FR":{}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.ColorSelector-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ca1f5355b007"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var cs="brightness-handle",cr="hue-saturation-handle",cq="hsbSpinner",cp="rgbSpinner",co="changeValue",cn="hexField",cm="hueSaturationField",cl="brightness-field",ck="mousedown",cj="rgb-spinner-red",bX="preview-content-old",bW="rgb-spinner-green",bV="brightnessField",bU="hue-saturation-field",bT="hsb-spinner-brightness",bS="preview-content-new",bR="hue-saturation-pane",bQ="rgb-spinner-blue",bP="hsb-spinner-hue",bO="hsb-spinner-saturation",cz="hex-field",cA="brightnessModifier",cx="blueModifier",cy="saturationModifier",cv="middle",cw="Number",ct="#",cu="redModifier",cB="greenModifier",cC="hueModifier",cc="Integer",cb="brightness-pane",ce="control-pane",cd="preset-grid",cg="mouseup",cf="preset-field-set",ci="qx.event.type.Event",ch="mousemove",ca="hex-field-composite",bY="rgb-spinner-composite",Y="hsb-spinner-composite",ba="control-bar",bb="mousewheel",bc="visual-pane",bd="input-field-set",be="preview-field-set",bf="black",bg="_applyGreen",bh="#333",bi="aqua",cG="colorbucket",cF="qx.event.type.Data",cE="Hex",cD="#BBB",cK="decoration/colorselector/brightness-handle.gif",cJ="Visual",cI="_applySaturation",cH="Preview (Old/New)",cM="FFFFFF",cL="decoration/colorselector/brightness-field.png",by="white",bz="orange",bw="_applyRed",bx="_applyBlue",bC="maroon",bD="Presets",bA="_applyBrightness",bB="#999",bu="purple",bv="red",bq="blue",bp="_applyHue",bs="decoration/colorselector/huesaturation-handle.gif",br="colorselector",bm="qx.ui.control.ColorSelector",bl="lime",bo="#EEE",bn="olive",bk="RGB",bj="decoration/colorselector/huesaturation-field.jpg",bI="navy",bJ="teal",bK="green",bL="yellow",bE="#666",bF="fuchsia",bG="Details",bH="",bM="colorbucket#",bN="appear",bt="HSB";
qx.Class.define(bm,{extend:qx.ui.core.Widget,implement:[qx.ui.form.IColorForm],construct:function(){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.VBox());
this._createChildControl(ba);
this.addListener(bN,this._onAppear,this);
},events:{"dialogok":ci,"dialogcancel":ci,"changeValue":cF},properties:{appearance:{refine:true,init:br},red:{check:cc,init:255,apply:bw},green:{check:cc,init:255,apply:bg},blue:{check:cc,init:255,apply:bx},hue:{check:cw,init:0,apply:bp},saturation:{check:cw,init:0,apply:cI},brightness:{check:cw,init:100,apply:bA}},members:{__wA:null,__wB:[bC,bv,bz,bL,bn,bu,bF,bl,bK,bI,bq,bi,bJ,bf,bh,bE,bB,cD,bo,by],__wC:bH,__wD:0,__wE:0,__wF:0,__wG:true,__wH:false,_createChildControlImpl:function(d){var f;

switch(d){case ba:f=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
f.add(this.getChildControl(ce));
f.add(this.getChildControl(bc));
this._add(f);
break;
case bc:f=new qx.ui.groupbox.GroupBox(this.tr(cJ));
f.setLayout(new qx.ui.layout.HBox(10));
f.add(this.getChildControl(bR));
f.add(this.getChildControl(cb));
break;
case ce:f=new qx.ui.container.Composite(new qx.ui.layout.VBox(12));
f.add(this.getChildControl(cf));
f.add(this.getChildControl(bd));
f.add(this.getChildControl(be),{flex:1});
break;
case bR:f=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
f.setAllowGrowY(false);
f.addListener(bb,this._onHueSaturationPaneMouseWheel,this);
f.add(this.getChildControl(bU));
f.add(this.getChildControl(cr),{left:0,top:256});
break;
case bU:f=new qx.ui.basic.Image(bj);
f.addListener(ck,this._onHueSaturationFieldMouseDown,this);
break;
case cr:f=new qx.ui.basic.Image(bs);
f.addListener(ck,this._onHueSaturationFieldMouseDown,this);
f.addListener(cg,this._onHueSaturationHandleMouseUp,this);
f.addListener(ch,this._onHueSaturationHandleMouseMove,this);
break;
case cb:f=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
f.setAllowGrowY(false);
f.addListener(bb,this._onBrightnessPaneMouseWheel,this);
f.add(this.getChildControl(cl));
f.add(this.getChildControl(cs));
break;
case cl:f=new qx.ui.basic.Image(cL);
f.addListener(ck,this._onBrightnessFieldMouseDown,this);
break;
case cs:f=new qx.ui.basic.Image(cK);
f.addListener(ck,this._onBrightnessHandleMouseDown,this);
f.addListener(cg,this._onBrightnessHandleMouseUp,this);
f.addListener(ch,this._onBrightnessHandleMouseMove,this);
break;
case cf:f=new qx.ui.groupbox.GroupBox(this.tr(bD));
f.setLayout(new qx.ui.layout.Grow());
f.add(this.getChildControl(cd));
break;
case cG:f=new qx.ui.core.Widget();
f.addListener(ck,this._onColorFieldClick,this);
break;
case cd:m=new qx.ui.layout.Grid(3,3);
f=new qx.ui.container.Composite(m);
var n;
var l;

for(var i=0;i<2;i++){for(var j=0;j<10;j++){l=i*10+j;
n=this.getChildControl(bM+l);
n.setBackgroundColor(this.__wB[l]);
f.add(n,{column:j,row:i});
}}break;
case bd:f=new qx.ui.groupbox.GroupBox(this.tr(bG));
var m=new qx.ui.layout.VBox();
m.setSpacing(10);
f.setLayout(m);
f.add(this.getChildControl(ca));
f.add(this.getChildControl(bY));
f.add(this.getChildControl(Y));
break;
case be:f=new qx.ui.groupbox.GroupBox(this.tr(cH));
var m=new qx.ui.layout.HBox(10);
f.setLayout(m);
f.add(this.getChildControl(bX),{flex:1});
f.add(this.getChildControl(bS),{flex:1});
break;
case ca:var k=new qx.ui.layout.HBox(4);
k.setAlignY(cv);
f=new qx.ui.container.Composite(k);
var p=new qx.ui.basic.Label(this.tr(cE));
f.add(p);
var o=new qx.ui.basic.Label(ct);
f.add(o);
f.add(this.getChildControl(cz));
break;
case cz:f=new qx.ui.form.TextField(cM);
f.setMaxLength(6);
f.setFilter(/[0-9A-Fa-f]/);
f.setWidth(55);
f.addListener(co,this._onHexFieldChange,this);
break;
case bY:var k=new qx.ui.layout.HBox(4);
k.setAlignY(cv);
f=new qx.ui.container.Composite(k);
var g=new qx.ui.basic.Label(this.tr(bk));
g.setWidth(25);
f.add(g);
f.add(this.getChildControl(cj));
f.add(this.getChildControl(bW));
f.add(this.getChildControl(bQ));
break;
case cj:f=new qx.ui.form.Spinner(0,255,255);
f.setWidth(50);
f.addListener(co,this._setRedFromSpinner,this);
break;
case bW:f=new qx.ui.form.Spinner(0,255,255);
f.setWidth(50);
f.addListener(co,this._setGreenFromSpinner,this);
break;
case bQ:f=new qx.ui.form.Spinner(0,255,255);
f.setWidth(50);
f.addListener(co,this._setBlueFromSpinner,this);
break;
case Y:var k=new qx.ui.layout.HBox(4);
k.setAlignY(cv);
f=new qx.ui.container.Composite(k);
var h=new qx.ui.basic.Label(this.tr(bt));
h.setWidth(25);
f.add(h);
f.add(this.getChildControl(bP));
f.add(this.getChildControl(bO));
f.add(this.getChildControl(bT));
break;
case bP:f=new qx.ui.form.Spinner(0,0,360);
f.setWidth(50);
f.addListener(co,this._setHueFromSpinner,this);
break;
case bO:f=new qx.ui.form.Spinner(0,0,100);
f.setWidth(50);
f.addListener(co,this._setSaturationFromSpinner,this);
break;
case bT:f=new qx.ui.form.Spinner(0,100,100);
f.setWidth(50);
f.addListener(co,this._setBrightnessFromSpinner,this);
break;
case bX:f=new qx.ui.core.Widget();
break;
case bS:f=new qx.ui.core.Widget();
break;
}return f||arguments.callee.base.call(this,d);
},setValue:function(L){var M;

if(L==null){this.__wG=true;
M=[255,255,255];
}else{M=qx.util.ColorUtil.stringToRgb(L);
this.__wG=false;
}this.__wH=true;
this.setRed(M[0]);
this.setGreen(M[1]);
this.__wH=false;
this.setBlue(M[2]);
},getValue:function(){return this.__wG?null:ct+qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);
},resetValue:function(){this.__wG=true;
this.__wH=true;
this.setRed(255);
this.setGreen(255);
this.__wH=false;
this.setBlue(255);
},__wI:function(){if(!this.__wH){this.__wG=false;
this.fireDataEvent(co,this.getValue());
}},_applyRed:function(I,J){if(this.__wA===null){this.__wA=cu;
}
if(this.__wA!==cp){this.getChildControl(cj).setValue(I);
}
if(this.__wA!==cn){this._setHexFromRgb();
}
switch(this.__wA){case cp:case cn:case cu:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__wI();

if(this.__wA===cu){this.__wA=null;
}},_applyGreen:function(U,V){if(this.__wA===null){this.__wA=cB;
}
if(this.__wA!==cp){this.getChildControl(bW).setValue(U);
}
if(this.__wA!==cn){this._setHexFromRgb();
}
switch(this.__wA){case cp:case cn:case cB:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__wI();

if(this.__wA===cB){this.__wA=null;
}},_applyBlue:function(G,H){if(this.__wA===null){this.__wA=cx;
}
if(this.__wA!==cp){this.getChildControl(bQ).setValue(G);
}
if(this.__wA!==cn){this._setHexFromRgb();
}
switch(this.__wA){case cp:case cn:case cx:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__wI();

if(this.__wA===cx){this.__wA=null;
}},_applyHue:function(C,D){if(this.__wA===null){this.__wA=cC;
}
if(this.__wA!==cq){this.getChildControl(bP).setValue(C);
}
if(this.__wA!==cm){if(this.getChildControl(cr).getBounds()){this.getChildControl(cr).setDomLeft(Math.round(C/1.40625)+this.getChildControl(bR).getPaddingLeft());
}else{this.getChildControl(cr).setLayoutProperties({left:Math.round(C/1.40625)});
}}
switch(this.__wA){case cq:case cm:case cC:this._setRgbFromHue();
}this._setBrightnessGradiant();

if(this.__wA===cC){this.__wA=null;
}},_applySaturation:function(R,S){if(this.__wA===null){this.__wA=cy;
}
if(this.__wA!==cq){this.getChildControl(bO).setValue(R);
}
if(this.__wA!==cm){this._setBrightnessGradiant();

if(this.getChildControl(cr).getBounds()){this.getChildControl(cr).setDomTop(256-Math.round(R*2.56)+this.getChildControl(bR).getPaddingTop());
}else{this.getChildControl(cr).setLayoutProperties({top:256-Math.round(R*2.56)});
}}
switch(this.__wA){case cq:case cm:case cy:this._setRgbFromHue();
}
if(this.__wA===cy){this.__wA=null;
}},_applyBrightness:function(z,A){if(this.__wA===null){this.__wA=cA;
}
if(this.__wA!==cq){this.getChildControl(bT).setValue(z);
}
if(this.__wA!==bV){var B=256-Math.round(z*2.56);

if(this.getChildControl(cs).getBounds()){this.getChildControl(cs).setDomTop(B+this.getChildControl(cb).getPaddingTop());
}else{this.getChildControl(cs).setLayoutProperties({top:B});
}}
switch(this.__wA){case cq:case bV:case cA:this._setRgbFromHue();
}
if(this.__wA===cA){this.__wA=null;
}},_onBrightnessHandleMouseDown:function(e){this.getChildControl(cs).capture();
this.__wC=cs;
var c=this.getChildControl(cl).getContainerLocation();
var b=this.getChildControl(cs).getContainerLocation();
var a=this.getChildControl(cl).getBounds();
this.__wD=c.top+(e.getDocumentTop()-b.top)-a.top;
e.stopPropagation();
},_onBrightnessHandleMouseUp:function(e){this.getChildControl(cs).releaseCapture();
this.__wC=null;
},_onBrightnessHandleMouseMove:function(e){if(this.__wC===cs){this._setBrightnessOnFieldEvent(e);
e.stopPropagation();
}},_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(cl).getContainerLocation();
var cN=this.getChildControl(cs).getBounds();
this.__wD=location.top+(cN.height/2);
...
e.stop();
},_setBrightnessOnFieldEvent:function(e){var q=qx.lang.Number.limit(e.getDocumentTop()-this.__wD,0,256);
this.__wA=bV;

if(this.getChildControl(cs).getBounds()){this.getChildControl(cs).setDomTop(q);
}else{this.getChildControl(cs).setLayoutProperties({top:q});
}this.setBrightness(100-Math.round(q/2.56));
this.__wA=null;
},_onHueSaturationHandleMouseUp:function(e){if(this.__wC){e.stopPropagation();
this.getChildControl(cr).releaseCapture();
this.__wC=null;
}},_onHueSaturationHandleMouseMove:function(e){if(this.__wC===cr){this._setHueSaturationOnFieldEvent(e);
e.stopPropagation();
}},_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(bU).getContainerLocation();
var x=this.getChildControl(cr).getBounds();
var y=this.getChildControl(bU).getBounds();
this.__wE=location.top+(x.height/2)-y.top;
this.__wF=location.left+(x.width/2)-y.left;
...
e.stop();
},_setHueSaturationOnFieldEvent:function(e){var F=qx.lang.Number.limit(e.getDocumentTop()-this.__wE,0,256);
var E=qx.lang.Number.limit(e.getDocumentLeft()-this.__wF,0,256);
this.getChildControl(cr).setDomPosition(E,F);
this.__wA=cm;
this.setSaturation(100-Math.round(F/2.56));
this.setHue(Math.round(E*1.40625));
this.__wA=null;
},_setRedFromSpinner:function(){if(this.__wA!==null){return;
}this.__wA=cp;
this.setRed(this.getChildControl(cj).getValue());
this.__wA=null;
},_setGreenFromSpinner:function(){if(this.__wA!==null){return;
}this.__wA=cp;
this.setGreen(this.getChildControl(bW).getValue());
this.__wA=null;
},_setBlueFromSpinner:function(){if(this.__wA!==null){return;
}this.__wA=cp;
this.setBlue(this.getChildControl(bQ).getValue());
this.__wA=null;
},_setHueFromSpinner:function(){if(this.__wA!==null){return;
}this.__wA=cq;
this.setHue(this.getChildControl(bP).getValue());
this.__wA=null;
},_setSaturationFromSpinner:function(){if(this.__wA!==null){return;
}this.__wA=cq;
this.setSaturation(this.getChildControl(bO).getValue());
this.__wA=null;
},_setBrightnessFromSpinner:function(){if(this.__wA!==null){return;
}this.__wA=cq;
this.setBrightness(this.getChildControl(bT).getValue());
this.__wA=null;
},_onHexFieldChange:function(e){if(this.__wA!==null){return;
}
try{var P=this.getChildControl(cz);
var O=qx.util.ColorUtil.hexStringToRgb(ct+P.getValue());
}catch(w){return;
}this.__wA=cn;
this.setRed(O[0]);
this.setGreen(O[1]);
this.setBlue(O[2]);
this.__wA=null;
},_setHexFromRgb:function(){var T=qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(cz).setValue(T);
...
this.setGreen(X[1]);
this.setBlue(X[2]);
},_setHueFromRgb:function(){switch(this.__wA){case cq:case cm:case bV:break;
default:var Q=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);
this.setHue(Q[0]);
this.setSaturation(Q[1]);
this.setBrightness(Q[2]);
}},_setRgbFromHue:function(){switch(this.__wA){case cp:case cn:break;
default:var K=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);
this.setRed(K[0]);
this.setGreen(K[1]);
this.setBlue(K[2]);
}},_setPreviewFromRgb:function(){var N=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(bS).setBackgroundColor(N);
},setPreviousColor:function(r,s,t){var u=qx.util.ColorUtil.rgbToRgbString([r,s,t]);
this.getChildControl(bX).setBackgroundColor(u);
this.setRed(r);
this.setGreen(s);
this.setBlue(t);
...
this.getChildControl(cl).setBackgroundColor(cQ);
},_onAppear:function(e){var v=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(bX).setBackgroundColor(v);
this.getChildControl(bS).setBackgroundColor(v);
}}});
})();
