...
o.add(this.getBox2());
o.add(this.getBox3());
},getBox1:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return a;
},getBox2:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,minWidth:60,allowGrowY:false});
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:e}));
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
return n;
},getBox3:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,allowGrowY:false});
var m=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var l=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var j=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
k.add(m);
k.add(l);
k.add(j);
return k;
