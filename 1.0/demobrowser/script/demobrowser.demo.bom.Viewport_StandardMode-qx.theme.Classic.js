...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Viewport_StandardMode","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Viewport_StandardMode-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"4a97b26f8f93"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var b="click",a="demobrowser.demo.bom.Viewport_StandardMode";
qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.bom.Element.addListener(document.body,b,function(){this.debug("Document Dimension: "+qx.bom.Document.getWidth()+"x"+qx.bom.Document.getHeight());
