...
(function(){var m="execute",l="Flash Player Version",k="__In",j="right",i="qooxdoo is the best!",h="Message from Flash:",g="Simple demo with FlashVars",f="bgcolor",d="demobrowser.demo.widget.Flash",c="demobrowser/demo/flash/TestFlash.swf",E="__Ip",D="Send to Flash",C="demobrowser/demo/flash/FlashVersion.swf",B="No message.",A="Flash:",z="<b>qooxdoo:</b>",y="__Iq",x="__Im",w="demobrowser.demo.widget.Flash.sendMessage",v="demobrowser.demo.widget.Flash.flashReady",t="demobrowser/demo/flash/fo_tester.swf",u="this is passed in via FlashVars",r="Two way communication (ActionScript <-> JavaScript)",s="Message to Flash:",p="Show Flash Player version",q="__Io",n="noscale",o="#FF6600";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Im:null,main:function(){arguments.callee.base.call(this);
var P=new qx.ui.tabview.TabView();
P.setContentPadding([8,8,8,8]);
var S=this.getRoot();
S.add(P,{edge:0});
var Q=new qx.ui.tabview.Page(g);
Q.setLayout(new qx.ui.layout.Canvas());
Q.add(this.createFlashDemo1(),{edge:0});
P.add(Q);
var R=new qx.ui.tabview.Page(r);
R.setLayout(new qx.ui.layout.Canvas());
R.add(this.createFlashDemo2(),{edge:0});
P.add(R);
this.__Im=this.createWindow();
S.add(this.__Im,{top:20,left:20});
},createWindow:function(){var O=new qx.ui.window.Window(l).set({width:300,height:200,contentPadding:[0,0,0,0]});
O.setLayout(new qx.ui.layout.Canvas());
O.add(new qx.ui.embed.Flash(C),{edge:0});
return O;
},createFlashDemo1:function(){var H=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var F={flashVarText:u};
var G=new qx.ui.embed.Flash(t).set({scale:n,variables:F});
G.getContentElement().setParam(f,o);
H.add(G,{flex:1});
var I=new qx.ui.form.Button(p);
I.addListener(m,function(){this.__Im.open();
},this);
H.add(I);
return H;
},__In:null,__Io:null,__Ip:null,__Iq:null,createFlashDemo2:function(){arguments.callee.self.setCallBackInstance(this);
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
...
this.__Io=new qx.ui.form.TextArea(B);
this.__Io.setEnabled(false);
K.add(this.__Io,{flex:1});
K.add(new qx.ui.basic.Label(s));
this.__Ip=new qx.ui.form.TextArea(i);
K.add(this.__Ip,{flex:1});
var M=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,j));
this.__Iq=new qx.ui.form.Button(D);
this.__Iq.setEnabled(false);
this.__Iq.addListener(m,function(e){this.__In.getFlashElement().sendMessage(this.__Ip.getValue());
},this);
M.add(this.__Iq);
K.add(M);
var J=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
L.add(J,{flex:1});
J.add(new qx.ui.basic.Label(A).set({rich:true}));
this.__In=new qx.ui.embed.Flash(c);
this.__In.setVariables({init:v});
J.add(this.__In,{flex:1});
return L;
},sendMessage:function(a){this.__Io.setValue(a);
},initFlash:function(){if(this.__In.getFlashElement().setup){this.__In.getFlashElement().setup(w);
this.__Iq.setEnabled(true);
...
}}},statics:{__Ir:null,setCallBackInstance:function(N){demobrowser.demo.widget.Flash.__Ir=N;
},sendMessage:function(b){demobrowser.demo.widget.Flash.__Ir.sendMessage(b);
},flashReady:function(){demobrowser.demo.widget.Flash.__Ir.initFlash();
}},destruct:function(){this._disposeObjects(q,E,y,k,x);
}});
})();
...
(function(){var t="Boolean",s="sameDomain",r="opaque",q="String",p="best",o="quality",n="_applyVariables",m="low",l="_applyLoop",k="scale",bc="_applyAllowScriptAccess",bb="showall",ba="Map",Y="wmode",X="excactfit",W="_applyMenu",V="menu",U="_applyPlay",T="loop",S="allowScriptAccess",A="_applyWmode",B="noborder",y="swLiveConnect",z="qx.ui.embed.Flash",w="_applyId",x="high",u="",v="transparent",C="play",D="_applyLiveConnect",K="_applySource",I="appear",M="medium",L="flash",O="_applyMayScript",N="_applyQuality",F="never",R="_applyScale",Q="autohigh",P="always",E="window",G="noscale",H="autolow",J="mayscript";
qx.Class.define(z,{extend:qx.ui.core.Widget,construct:function(e,f){arguments.callee.base.call(this);
{};
this.setSource(e);

if(f){this.setId(f);
}else{this.setId(L+this.toHashCode());
}this.initQuality();
this.initWmode();
this.initAllowScriptAccess();
this.initLiveConnect();
this.addListenerOnce(I,function(){this.getContentElement().createFlash();
},this);
},properties:{source:{check:q,apply:K},id:{check:q,apply:w},quality:{check:[m,H,Q,M,x,p],init:p,nullable:true,apply:N},scale:{check:[bb,B,X,G],nullable:true,apply:R},wmode:{check:[E,r,v],init:r,nullable:true,apply:A},play:{check:t,nullable:true,apply:U},loop:{check:t,nullable:true,apply:l},mayScript:{check:t,nullable:false,apply:O},menu:{check:t,nullable:true,apply:W},allowScriptAccess:{check:[s,P,F],init:s,nullable:true,apply:bc},liveConnect:{check:t,init:true,nullable:true,apply:D},variables:{init:{},check:ba,apply:n}},members:{getFlashElement:function(){var bw=this.getContentElement();

if(bw){return bw.getFlashElement();
}else{return null;
...
qx.ui.core.queue.Layout.add(this);
},_applyId:function(bo,bp){this.getContentElement().setId(bo);
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(bg,bh){this.getContentElement().setVariables(bg);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(bs,bt){this.getContentElement().setAttribute(J,bs?u:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bi,bj){this.__yz(o,bi);
},_applyScale:function(bm,bn){this.__yz(k,bm);
},_applyWmode:function(a,b){this.__yz(Y,a);
},_applyPlay:function(g,h){this.__yz(C,g);
},_applyLoop:function(i,j){this.__yz(T,i);
},_applyMenu:function(bu,bv){this.__yz(V,bu);
},_applyAllowScriptAccess:function(bq,br){this.__yz(S,bq);
},_applyLiveConnect:function(bk,bl){this.__yz(y,bk);
},__yz:function(c,d){this.getContentElement().setParam(c,d);
qx.ui.core.queue.Layout.add(this);
}}});
})();
(function(){var h="movie",g="id",f="div",e="qx.html.Flash";
qx.Class.define(e,{extend:qx.html.Element,construct:function(){arguments.callee.base.call(this);
this.__yA={};
this.__yB={};
this.__yC={};
},members:{__yA:null,__yC:null,__yB:null,__yD:null,_createDomElement:function(){return qx.bom.Element.create(f);
},createFlash:function(){this.__yD=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__yB,this.__yA);
},setSource:function(b){{};

if(this.__yD){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(h,b);
},setId:function(a){{};

if(this.__yD){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(g,a);
},getVariables:function(){return this.__yB;
},setVariables:function(k){{};

if(this.__yD){throw new Error("The variables cannot be modified after initial creation");
}this.__yB=k;
},getAttributes:function(){return this.__yC;
},setAttribute:function(i,j){{};

if(this.__yD){throw new Error("The attributes cannot be modified after initial creation");
}
if(j===null||j===undefined){delete this.__yC[i];
}else{this.__yC[i]=j;
}},getParams:function(){return this.__yA;
},setParam:function(c,d){{};

if(this.__yD){throw new Error("The params cannot be modified after initial creation");
}
if(d===null||d===undefined){delete this.__yA[c];
}else{this.__yA[c]=d;
}},getFlashElement:function(){return this.__yD;
}},destruct:function(){if(this.__yD){qx.bom.Flash.destroy(this.__yD);
}this.__yA=this.__yB=this.__yC=null;
}});
})();
