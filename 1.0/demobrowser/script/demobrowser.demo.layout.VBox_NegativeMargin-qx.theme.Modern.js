...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1d03cd69f693"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var x="main",w="yellow",v="gray",u="blue",t="center",s="green",r="left",q="right",p="demobrowser.demo.layout.VBox_NegativeMargin";
...
var B=new qx.ui.container.Composite(z).set({decorator:x,backgroundColor:w,width:140,allowGrowY:false});
var D=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var C=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var A=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
B.add(D);
B.add(C);
B.add(A);
C.setMarginTop(-10);
A.setMarginTop(-10);
return B;
},getBox2:function(){var f=new qx.ui.layout.VBox();
var h=new qx.ui.container.Composite(f).set({decorator:x,backgroundColor:w,width:140,allowGrowY:false});
var j=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var i=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var g=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
h.add(j);
h.add(i);
h.add(g);
i.setMarginTop(-10);
i.setMarginBottom(20);
g.setMarginTop(-10);
return h;
},getBox3:function(){var J=new qx.ui.layout.VBox();
var L=new qx.ui.container.Composite(J).set({decorator:x,backgroundColor:w,width:140,height:300,allowGrowY:false});
var N=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var M=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var K=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
L.add(N,{flex:1});
L.add(M,{flex:1});
L.add(K,{flex:1});
M.setMarginTop(-10);
...
var Q=new qx.ui.container.Composite(O).set({decorator:x,backgroundColor:w,width:140,height:300,allowGrowY:false});
var S=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var R=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var P=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
Q.add(S,{flex:1});
Q.add(R,{flex:2});
Q.add(P,{flex:3});
R.setMarginTop(-10);
...
var m=new qx.ui.container.Composite(k).set({decorator:x,backgroundColor:w,width:140,height:300,allowGrowY:false});
var o=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var n=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var l=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
m.add(o,{flex:1});
m.add(n,{flex:2});
m.add(l,{flex:3});
n.setMarginTop(-10);
...
var G=new qx.ui.container.Composite(E).set({decorator:x,backgroundColor:w,width:140,height:100,allowGrowY:false});
var I=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var H=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var F=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
G.add(I,{flex:1});
G.add(H,{flex:1});
G.add(F,{flex:1});
H.setMarginTop(-10);
F.setMarginTop(-10);
return G;
},getBox7:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:x,backgroundColor:w,width:140,height:100,allowGrowY:false});
var e=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var d=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var b=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
c.add(e,{flex:1});
c.add(d,{flex:2});
c.add(b,{flex:3});
d.setMarginTop(-10);
