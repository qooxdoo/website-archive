...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.treevirtual.TreeVirtual_Events","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.treevirtual.TreeVirtual_Events-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"5e7e145b704f"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var x="Trash",w="Windows (C:)",v="Data",u="Documents (D:)",t="\n  ",s="treeOpenWithContent",r="treeOpenWhileEmpty",q="demobrowser.demo.treevirtual.TreeVirtual_Events",p="Edit",o="Workspace",g="Network",n="Spam Message #",k="Selected labels:",d="Inbox",c="Desktop",j="changeSelection",h="Sent",l="treeClose",b="Files",m="Tree",f="Spam";
qx.Class.define(q,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
qx.Class.include(qx.ui.treevirtual.TreeVirtual,qx.ui.treevirtual.MNode);
var z=new qx.ui.treevirtual.TreeVirtual(m);
z.setColumnWidth(0,400);
z.setAlwaysShowOpenCloseSymbol(true);
this.getRoot().add(z,{edge:30});
var E=z.getDataModel();
var B=E.addBranch(null,c,true);
var D;
E.addBranch(B,b,true);
D=E.addBranch(B,o,true);
E.addLeaf(D,w);
E.addLeaf(D,u);
E.addBranch(B,g,true);
E.addBranch(B,x,true);
var C=E.addBranch(null,d,true);
D=E.addBranch(C,f,false);

for(var i=1;i<3000;i++){E.addLeaf(D,n+i);
}E.addBranch(C,h,false);
E.addBranch(C,x,false);
E.addBranch(C,v,false);
E.addBranch(C,p,false);
E.setData();
var A=1;
z.addListener(s,function(e){alert('treeOpenWithContent ');
var y=e.getData();
E.addLeaf(y.nodeId,A.toString());
A++;
});
z.addListener(l,function(e){alert('treeClose ');
});
z.addListener(r,function(e){alert('treeOpenWhileEmpty');
var a=e.getData();
z.nodeSetHideOpenClose(a,true);
});
z.addListener(j,function(e){var F=k;
var G=e.getData();

for(i=0;i<G.length;i++){F+=t+G[i].label;
}alert('changeSelection: '+F);
});
}}});
})();
...
(function(){var cy="Function",cx="Boolean",cw="column-button",cv="qx.event.type.Data",cu="statusbar",ct="qx.ui.table.pane.CellEvent",cs="PageUp",cr="changeLocale",cq="changeSelection",cp="qx.dynlocale",dL="Enter",dK="metaDataChanged",dJ="dataChanged",dI="on",dH="__ue",dG="_applyStatusBarVisible",dF="columnVisibilityMenuCreateStart",dE="blur",dD="qx.ui.table.Table",dC="columnVisibilityMenuCreateEnd",cF="Use 'resetSelection' instead.",cG="verticalScrollBarChanged",cD="_applyMetaColumnCounts",cE="one of one row",cB="focus",cC="changeDataRowRenderer",cz="changeHeaderCellHeight",cA="Escape",cN="A",cO="changeSelectionModel",dd="Left",cY="Down",dl="Integer",dg="_applyHeaderCellHeight",dy="visibilityChanged",ds="qx.ui.table.ITableModel",cT="orderChanged",dB="_applySelectionModel",dA="menu",dz="_applyAdditionalStatusBarText",cR="_applyFocusCellOnMouseMove",cV="table",cX="_applyColumnVisibilityButtonVisible",db="changeTableModel",de="qx.event.type.Event",dh="tableWidthChanged",dn="End",du="__ud",cH="Object",cI="_applyShowCellFocusIndicator",cU="resize",dk="__tU",dj="changeScrollY",di="_applyTableModel",dq="menu-button",dp="_applyKeepFirstVisibleRowComplete",df="widthChanged",dm="Home",cm="_applyRowHeight",dt="F2",cJ="appear",cK="Up",da="__tT",cn="%1 rows",co="qx.ui.table.selection.Model",cQ="one row",cL="PageDown",cM="%1 of %2 rows",cP="keypress",dc="changeRowHeight",dw="Number",dv="__uc",cW="changeVisible",dx="qx.ui.table.IRowRenderer",cS="Right",dr="Space";
qx.Class.define(dD,{extend:qx.ui.core.Widget,construct:function(eE,eF){arguments.callee.base.call(this);
if(!eF){eF={};
}
if(eF.selectionManager){this.setNewSelectionManager(eF.selectionManager);
}
if(eF.selectionModel){this.setNewSelectionModel(eF.selectionModel);
}
if(eF.tableColumnModel){this.setNewTableColumnModel(eF.tableColumnModel);
}
if(eF.tablePane){this.setNewTablePane(eF.tablePane);
}
if(eF.tablePaneHeader){this.setNewTablePaneHeader(eF.tablePaneHeader);
}
if(eF.tablePaneScroller){this.setNewTablePaneScroller(eF.tablePaneScroller);
}
if(eF.tablePaneModel){this.setNewTablePaneModel(eF.tablePaneModel);
}
if(eF.columnMenu){this.setNewColumnMenu(eF.columnMenu);
}this._setLayout(new qx.ui.layout.VBox());
this.__tT=new qx.ui.container.Composite(new qx.ui.layout.HBox());
this._add(this.__tT,{flex:1});
this.setDataRowRenderer(new qx.ui.table.rowrenderer.Default(this));
this.__tU=this.getNewSelectionManager()(this);
this.setSelectionModel(this.getNewSelectionModel()(this));
this.setTableModel(eE||this.getEmptyTableModel());
this.setMetaColumnCounts([-1]);
this.setTabIndex(1);
this.addListener(cP,this._onKeyPress);
this.addListener(cB,this._onFocusChanged);
this.addListener(dE,this._onFocusChanged);
var eG=new qx.ui.core.Widget().set({height:0});
this._add(eG);
eG.addListener(cU,this._onResize,this);
this.__tV=null;
this.__tW=null;
if(qx.core.Variant.isSet(cp,dI)){qx.locale.Manager.getInstance().addListener(cr,this._onChangeLocale,this);
}this.initStatusBarVisible();
},events:{"columnVisibilityMenuCreateStart":cv,"columnVisibilityMenuCreateEnd":cv,"tableWidthChanged":de,"verticalScrollBarChanged":cv,"cellClick":ct,"cellDblclick":ct,"cellContextmenu":ct,"dataEdited":cv},statics:{__tX:{cellClick:1,cellDblclick:1,cellContextmenu:1}},properties:{appearance:{refine:true,init:cV},focusable:{refine:true,init:true},minWidth:{refine:true,init:50},selectable:{refine:true,init:false},selectionModel:{check:co,apply:dB,event:cO},tableModel:{check:ds,apply:di,event:db},rowHeight:{check:dw,init:20,apply:cm,event:dc},forceLineHeight:{check:cx,init:true},headerCellHeight:{check:dl,init:16,apply:dg,event:cz,nullable:true},statusBarVisible:{check:cx,init:true,apply:dG},additionalStatusBarText:{nullable:true,init:null,apply:dz},columnVisibilityButtonVisible:{check:cx,init:true,apply:cX},metaColumnCounts:{check:cH,apply:cD},focusCellOnMouseMove:{check:cx,init:false,apply:cR},rowFocusChangeModifiesSelection:{check:cx,init:true},showCellFocusIndicator:{check:cx,init:true,apply:cI},keepFirstVisibleRowComplete:{check:cx,init:true,apply:dp},alwaysUpdateCells:{check:cx,init:false},dataRowRenderer:{check:dx,init:null,nullable:true,event:cC},modalCellEditorPreOpenFunction:{check:cy,init:null,nullable:true},newColumnMenu:{check:cy,init:function(){return new qx.ui.table.columnmenu.Button();
}},newSelectionManager:{check:cy,init:function(u){return new qx.ui.table.selection.Manager(u);
}},newSelectionModel:{check:cy,init:function(dM){return new qx.ui.table.selection.Model(dM);
}},newTableColumnModel:{check:cy,init:function(y){return new qx.ui.table.columnmodel.Basic(y);
}},newTablePane:{check:cy,init:function(C){return new qx.ui.table.pane.Pane(C);
}},newTablePaneHeader:{check:cy,init:function(bW){return new qx.ui.table.pane.Header(bW);
}},newTablePaneScroller:{check:cy,init:function(eH){return new qx.ui.table.pane.Scroller(eH);
}},newTablePaneModel:{check:cy,init:function(eI){return new qx.ui.table.pane.Model(eI);
}}},members:{__tV:null,__tW:null,__tT:null,__tU:null,__tY:null,__ua:null,__ub:null,__uc:null,__ud:null,__ue:null,_createChildControlImpl:function(cc){var cd;

switch(cc){case cu:cd=new qx.ui.basic.Label();
cd.set({allowGrowX:true});
this._add(cd);
break;
case cw:cd=this.getNewColumnMenu()();
cd.set({focusable:false});
var ce=cd.factory(dA,{table:this});
ce.addListener(cJ,this._initColumnMenu,this);
break;
}return cd||arguments.callee.base.call(this,cc);
},_applySelectionModel:function(ci,cj){this.__tU.setSelectionModel(ci);

if(cj!=null){cj.removeListener(cq,this._onSelectionChanged,this);
}ci.addListener(cq,this._onSelectionChanged,this);
},_applyRowHeight:function(ei,ej){var ek=this._getPaneScrollerArr();

for(var i=0;i<ek.length;i++){ek[i].updateVerScrollBarMaximum();
}},_applyHeaderCellHeight:function(k,m){var n=this._getPaneScrollerArr();

for(var i=0;i<n.length;i++){n[i].getHeader().setHeight(k);
}},getEmptyTableModel:function(){if(!this.__ue){this.__ue=new qx.ui.table.model.Simple();
this.__ue.setColumns([]);
this.__ue.setData([]);
}return this.__ue;
},_applyTableModel:function(bq,br){this.getTableColumnModel().init(bq.getColumnCount(),this);

if(br!=null){br.removeListener(dK,this._onTableModelMetaDataChanged,this);
br.removeListener(dJ,this._onTableModelDataChanged,this);
}bq.addListener(dK,this._onTableModelMetaDataChanged,this);
bq.addListener(dJ,this._onTableModelDataChanged,this);
this._updateStatusBar();
this._updateTableData(0,bq.getRowCount(),0,bq.getColumnCount());
this._onTableModelMetaDataChanged();
},getTableColumnModel:function(){if(!this.__ud){var dV=this.__ud=this.getNewTableColumnModel()(this);
dV.addListener(dy,this._onColVisibilityChanged,this);
dV.addListener(df,this._onColWidthChanged,this);
dV.addListener(cT,this._onColOrderChanged,this);
var dU=this.getTableModel();
dV.init(dU.getColumnCount(),this);
var dS=this._getPaneScrollerArr();

for(var i=0;i<dS.length;i++){var dT=dS[i];
var dW=dT.getTablePaneModel();
dW.setTableColumnModel(dV);
}}return this.__ud;
},_applyStatusBarVisible:function(ck,cl){if(ck){this._showChildControl(cu);
}else{this._excludeChildControl(cu);
}
if(ck){this._updateStatusBar();
}},_applyAdditionalStatusBarText:function(bs,bt){this.__tY=bs;
this._updateStatusBar();
},_applyColumnVisibilityButtonVisible:function(o,p){if(o){this._showChildControl(cw);
}else{this._excludeChildControl(cw);
}},_applyMetaColumnCounts:function(K,L){var S=K;
var M=this._getPaneScrollerArr();
var Q={};

if(K>L){var U=qx.event.Registration.getManager(M[0]);

for(var V in qx.ui.table.Table.__tX){Q[V]={};
Q[V].capture=U.getListeners(M[0],V,true);
Q[V].bubble=U.getListeners(M[0],V,false);
}}this._cleanUpMetaColumns(S.length);
var R=0;

for(var i=0;i<M.length;i++){var W=M[i];
var T=W.getTablePaneModel();
T.setFirstColumnX(R);
T.setMaxColumnCount(S[i]);
R+=S[i];
}if(S.length>M.length){var P=this.getTableColumnModel();

for(var i=M.length;i<S.length;i++){var T=this.getNewTablePaneModel()(P);
T.setFirstColumnX(R);
T.setMaxColumnCount(S[i]);
R+=S[i];
var W=this.getNewTablePaneScroller()(this);
W.setTablePaneModel(T);
W.addListener(dj,this._onScrollY,this);
for(V in qx.ui.table.Table.__tX){if(!Q[V]){break;
}
if(Q[V].capture&&Q[V].capture.length>0){var N=Q[V].capture;

for(var i=0;i<N.length;i++){var O=N[i].context;

if(!O){O=this;
}else if(O==M[0]){O=W;
}W.addListener(V,N[i].handler,O,true);
}}
if(Q[V].bubble&&Q[V].bubble.length>0){var Y=Q[V].bubble;

for(var i=0;i<Y.length;i++){var O=Y[i].context;

if(!O){O=this;
}else if(O==M[0]){O=W;
}W.addListener(V,Y[i].handler,O,false);
}}}var X=(i==S.length-1)?1:0;
this.__tT.add(W,{flex:X});
M=this._getPaneScrollerArr();
}}for(var i=0;i<M.length;i++){var W=M[i];
var ba=(i==(M.length-1));
W.getHeader().setHeight(this.getHeaderCellHeight());
W.setTopRightWidget(ba?this.getChildControl(cw):null);
}
if(!this.isColumnVisibilityButtonVisible()){this._excludeChildControl(cw);
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
},_applyFocusCellOnMouseMove:function(bk,bl){var bm=this._getPaneScrollerArr();

for(var i=0;i<bm.length;i++){bm[i].setFocusCellOnMouseMove(bk);
}},_applyShowCellFocusIndicator:function(z,A){var B=this._getPaneScrollerArr();

for(var i=0;i<B.length;i++){B[i].setShowCellFocusIndicator(z);
}},_applyKeepFirstVisibleRowComplete:function(bn,bo){var bp=this._getPaneScrollerArr();

for(var i=0;i<bp.length;i++){bp[i].onKeepFirstVisibleRowCompleteChanged();
}},getSelectionManager:function(){return this.__tU;
},_getPaneScrollerArr:function(){return this.__tT.getChildren();
},getPaneScroller:function(eB){return this._getPaneScrollerArr()[eB];
...
this._updateStatusBar();
},_onSelectionChanged:function(er){var es=this._getPaneScrollerArr();

for(var i=0;i<es.length;i++){es[i].onSelectionChanged();
}this._updateStatusBar();
...
},_onTableModelDataChanged:function(dY){var ea=dY.getData();
this._updateTableData(ea.firstRow,ea.lastRow,ea.firstColumn,ea.lastColumn,ea.removeStart,ea.removeCount);
},_updateTableData:function(bw,bx,by,bz,bA,bB){var bC=this._getPaneScrollerArr();
if(bB){this.getSelectionModel().removeSelectionInterval(bA,bA+bB);
}
for(var i=0;i<bC.length;i++){bC[i].onTableModelDataChanged(bw,bx,by,bz);
}var bD=this.getTableModel().getRowCount();

if(bD!=this.__ua){this.__ua=bD;
this._updateScrollBarVisibility();
this._updateStatusBar();
}},_onScrollY:function(a){if(!this.__ub){this.__ub=true;
var b=this._getPaneScrollerArr();

for(var i=0;i<b.length;i++){b[i].setScrollY(a.getData());
}this.__ub=false;
}},_onKeyPress:function(bF){if(!this.getEnabled()){return;
}var bM=this.__tW;
var bJ=true;
var bN=bF.getKeyIdentifier();

if(this.isEditing()){if(bF.getModifiers()==0){switch(bN){case dL:this.stopEditing();
var bM=this.__tW;
this.moveFocusedCell(0,1);

if(this.__tW!=bM){bJ=this.startEditing();
}break;
case cA:this.cancelEditing();
this.focus();
break;
default:bJ=false;
break;
}}return;
}else{if(bF.isCtrlPressed()){bJ=true;

switch(bN){case cN:var bK=this.getTableModel().getRowCount();

if(bK>0){this.getSelectionModel().setSelectionInterval(0,bK-1);
}break;
default:bJ=false;
break;
}}else{switch(bN){case dr:this.__tU.handleSelectKeyDown(this.__tW,bF);
break;
case dt:case dL:bJ=this.startEditing();
break;
case dm:this.setFocusedCell(this.__tV,0,true);
break;
case dn:var bK=this.getTableModel().getRowCount();
this.setFocusedCell(this.__tV,bK-1,true);
break;
case dd:this.moveFocusedCell(-1,0);
break;
case cS:this.moveFocusedCell(1,0);
break;
case cK:this.moveFocusedCell(0,-1);
break;
case cY:this.moveFocusedCell(0,1);
break;
case cs:case cL:var bI=this.getPaneScroller(0);
var bL=bI.getTablePane();
var bK=bL.getVisibleRowCount()-1;
var bH=this.getRowHeight();
var bG=(bN==cs)?-1:1;
bI.setScrollY(bI.getScrollY()+bG*bK*bH);
this.moveFocusedCell(0,bG*bK);
break;
default:bJ=false;
}}}
if(bM!=this.__tW&&this.getRowFocusChangeModifiesSelection()){this.__tU.handleMoveKeyDown(this.__tW,bF);
}
if(bJ){bF.preventDefault();
bF.stopPropagation();
}},_onFocusChanged:function(v){var w=this._getPaneScrollerArr();

for(var i=0;i<w.length;i++){w[i].onFocusChanged();
}},_onColVisibilityChanged:function(dP){var dQ=this._getPaneScrollerArr();

for(var i=0;i<dQ.length;i++){dQ[i].onColVisibilityChanged();
}var dR=dP.getData();

if(this.__uc!=null&&dR.col!=null&&dR.visible!=null){this.__uc[dR.col].setVisible(dR.visible);
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
},_onColWidthChanged:function(ef){var eg=this._getPaneScrollerArr();

for(var i=0;i<eg.length;i++){var eh=ef.getData();
eg[i].setColumnWidth(eh.col,eh.newWidth);
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
},_onColOrderChanged:function(c){var d=this._getPaneScrollerArr();

for(var i=0;i<d.length;i++){d[i].onColOrderChanged();
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
},getTablePaneScrollerAtPageX:function(bu){var bv=this._getMetaColumnAtPageX(bu);
return (bv!=-1)?this.getPaneScroller(bv):null;
},setFocusedCell:function(eK,eL,eM){if(!this.isEditing()&&(eK!=this.__tV||eL!=this.__tW)){if(eK===null){eK=0;
}this.__tV=eK;
this.__tW=eL;
var eN=this._getPaneScrollerArr();

for(var i=0;i<eN.length;i++){eN[i].setFocusedCell(eK,eL);
}
if(eK!==null&&eM){this.scrollCellVisible(eK,eL);
}}},resetSelection:function(){this.getSelectionModel().resetSelection();
},clearSelection:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,cF);
this.resetSelection();
},resetCellFocus:function(){this.setFocusedCell(null,null,false);
},getFocusedColumn:function(){return this.__tV;
},getFocusedRow:function(){return this.__tW;
},highlightFocusedRow:function(eC){this.getDataRowRenderer().setHighlightFocusRow(eC);
},clearFocusedRowHighlight:function(){this.resetCellFocus();
var eA=this._getPaneScrollerArr();

for(var i=0;i<eA.length;i++){eA[i].onFocusChanged();
}},moveFocusedCell:function(bd,be){var bi=this.__tV;
var bj=this.__tW;

if(bi===null||bj===null){return;
}
if(bd!=0){var bh=this.getTableColumnModel();
var x=bh.getVisibleX(bi);
var bg=bh.getVisibleColumnCount();
x=qx.lang.Number.limit(x+bd,0,bg-1);
bi=bh.getVisibleColumnAtX(x);
}
if(be!=0){var bf=this.getTableModel();
bj=qx.lang.Number.limit(bj+be,0,bf.getRowCount()-1);
}this.setFocusedCell(bi,bj,true);
},scrollCellVisible:function(q,r){var s=this.getTableColumnModel();
var x=s.getVisibleX(q);
var t=this._getMetaColumnAtColumnX(x);

if(t!=-1){this.getPaneScroller(t).scrollCellVisible(q,r);
}},isEditing:function(){if(this.__tV!=null){var x=this.getTableColumnModel().getVisibleX(this.__tV);
var ez=this._getMetaColumnAtColumnX(x);
return this.getPaneScroller(ez).isEditing();
}return false;
},startEditing:function(){if(this.__tV!=null){var x=this.getTableColumnModel().getVisibleX(this.__tV);
var cg=this._getMetaColumnAtColumnX(x);
var cf=this.getPaneScroller(cg).startEditing();
return cf;
}return false;
},stopEditing:function(){if(this.__tV!=null){var x=this.getTableColumnModel().getVisibleX(this.__tV);
var ch=this._getMetaColumnAtColumnX(x);
this.getPaneScroller(ch).stopEditing();
}},cancelEditing:function(){if(this.__tV!=null){var x=this.getTableColumnModel().getVisibleX(this.__tV);
var eJ=this._getMetaColumnAtColumnX(x);
this.getPaneScroller(eJ).cancelEditing();
}},updateContent:function(){var dX=this._getPaneScrollerArr();

for(var i=0;i<dX.length;i++){dX[i].getTablePane().updateContent();
...
},_getMetaColumnAtColumnX:function(eO){var eQ=this.getMetaColumnCounts();
var eR=0;

for(var i=0;i<eQ.length;i++){var eP=eQ[i];
eR+=eP;

if(eP==-1||eO<eR){return i;
}}return -1;
...
if(ey>=0){if(ew==0){ex=this.trn(cQ,cn,ey,ey);
}else{ex=this.trn(cE,cM,ey,ew,ey);
}}
if(this.__tY){if(ex){ex+=this.__tY;
}else{ex=this.__tY;
}}
if(ex){this.getChildControl(cu).setValue(ex);
}}},_updateScrollerWidths:function(){var eb=this._getPaneScrollerArr();

for(var i=0;i<eb.length;i++){var ed=(i==(eb.length-1));
var ee=eb[i].getTablePaneModel().getTotalWidth();
eb[i].setPaneWidth(ee);
var ec=ed?1:0;
eb[i].setLayoutProperties({flex:ec});
}},_updateScrollBarVisibility:function(){if(!this.getBounds()){return;
}var bR=qx.ui.table.pane.Scroller.HORIZONTAL_SCROLLBAR;
var bU=qx.ui.table.pane.Scroller.VERTICAL_SCROLLBAR;
var bO=this._getPaneScrollerArr();
var bQ=false;
var bT=false;

for(var i=0;i<bO.length;i++){var bV=(i==(bO.length-1));
var bP=bO[i].getNeededScrollBars(bQ,!bV);
...
var bS;
bO[i].setHorizontalScrollBarVisible(bQ);
if(bV){bS=bO[i].getVerticalScrollBarVisible();
}bO[i].setVerticalScrollBarVisible(bV&&bT);
if(bV&&bT!=bS){this.fireDataEvent(cG,bT);
}}},_initColumnMenu:function(){var F=this.getTableModel();
var G=this.getTableColumnModel();
var H=this.getChildControl(cw);
H.empty();
var E=H.getMenu();
var I={table:this,menu:E,columnButton:H};
this.fireDataEvent(dF,I);
this.__uc={};

for(var J=0,l=F.getColumnCount();J<l;J++){var D=H.factory(dq,{text:F.getColumnName(J),column:J,bVisible:G.isColumnVisible(J)});
qx.core.Assert.assertInterface(D,qx.ui.table.IColumnMenuItem);
D.addListener(cW,this._createColumnVisibilityCheckBoxHandler(J),this);
this.__uc[J]=D;
}var I={table:this,menu:E,columnButton:H};
this.fireDataEvent(dC,I);
},_createColumnVisibilityCheckBoxHandler:function(bE){return function(et){var eu=this.getTableColumnModel();
eu.setColumnVisible(bE,et.getData());
};
},setColumnWidth:function(h,j){this.getTableColumnModel().setColumnWidth(h,j);
},_onResize:function(){this.fireEvent(dh);
this._updateScrollerWidths();
this._updateScrollBarVisibility();
},addListener:function(el,em,self,en){if(arguments.callee.self.__tX[el]){for(var i=0,eo=this._getPaneScrollerArr();i<eo.length;i++){eo[i].addListener.apply(eo[i],arguments);
}}else{return arguments.callee.base.call(this,el,em,self,en);
}},removeListener:function(bX,bY,self,ca){if(arguments.callee.self.__tX[bX]){for(var i=0,cb=this._getPaneScrollerArr();i<cb.length;i++){cb[i].removeListener.apply(cb[i],arguments);
}}else{arguments.callee.base.call(this,bX,bY,self,ca);
}},destroy:function(){this.getChildControl(cw).getMenu().destroy();
arguments.callee.base.call(this);
}},destruct:function(){if(qx.core.Variant.isSet(cp,dI)){qx.locale.Manager.getInstance().removeListener(cr,this._onChangeLocale,this);
}var eq=this.getSelectionModel();

if(eq){eq.dispose();
}var ep=this.getDataRowRenderer();

if(ep){ep.dispose();
}this._cleanUpMetaColumns(0);
this.getTableColumnModel().dispose();
this._disposeObjects(dk,da,dH,dH,du);
this._disposeMap(dv);
}});
})();
...
this.__uo=false;
},events:{"changeSelection":v},statics:{NO_SELECTION:1,SINGLE_SELECTION:2,SINGLE_INTERVAL_SELECTION:3,MULTIPLE_INTERVAL_SELECTION:4,MULTIPLE_INTERVAL_SELECTION_TOGGLE:5},properties:{selectionMode:{init:2,check:[1,2,3,4,5],apply:s}},members:{__uo:null,__um:null,__un:null,__ul:null,_applySelectionMode:function(B){this.resetSelection();
},setBatchMode:function(T){if(T){this.hasBatchModeRefCount+=1;
}else{if(this.hasBatchModeRefCount==0){throw new Error("Try to turn off batch mode althoug it was not turned on.");
}this.hasBatchModeRefCount-=1;

if(this.__uo){this.__uo=false;
this._fireChangeSelection();
}}return this.hasBatchMode();
},hasBatchMode:function(){return this.hasBatchModeRefCount>0;
},getAnchorSelectionIndex:function(){return this.__um;
},_setAnchorSelectionIndex:function(q){this.__um=q;
},getLeadSelectionIndex:function(){return this.__un;
},_setLeadSelectionIndex:function(U){this.__un=U;
},_getSelectedRangeArr:function(){return this.__ul;
...
this.resetSelection();
},isSelectionEmpty:function(){return this.__ul.length==0;
},getSelectedCount:function(){var f=0;

for(var i=0;i<this.__ul.length;i++){var d=this.__ul[i];
f+=d.maxIndex-d.minIndex+1;
}return f;
},isSelectedIndex:function(a){for(var i=0;i<this.__ul.length;i++){var b=this.__ul[i];

if(a>=b.minIndex&&a<=b.maxIndex){return true;
}}return false;
},getSelectedRanges:function(){var c=[];

for(var i=0;i<this.__ul.length;i++){c.push({minIndex:this.__ul[i].minIndex,maxIndex:this.__ul[i].maxIndex});
}return c;
},iterateSelection:function(J,K){for(var i=0;i<this.__ul.length;i++){for(var j=this.__ul[i].minIndex;j<=this.__ul[i].maxIndex;j++){J.call(K,j);
}}},setSelectionInterval:function(N,O){var P=arguments.callee.self;
...
break;
}},removeSelectionInterval:function(g,h){this.__um=g;
this.__un=h;
var k=Math.min(g,h);
var m=Math.max(g,h);
...
if(p&&n){this.__ul.splice(i,1);
i--;
}else if(p){o.minIndex=m+1;
}else if(n){o.maxIndex=k-1;
}else{var l={minIndex:m+1,maxIndex:o.maxIndex};
this.__ul.splice(i+1,0,l);
o.maxIndex=k-1;
break;
}}}this._fireChangeSelection();
},_resetSelection:function(){this.__ul=[];
this.__um=-1;
this.__un=-1;
},_clearSelection:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,r);
this._resetSelection();
},_addSelectionInterval:function(C,D){this.__um=C;
this.__un=D;
var E=Math.min(C,D);
var G=Math.max(C,D);
var F=0;

for(;F<this.__ul.length;F++){var H=this.__ul[F];

if(H.minIndex>E){break;
}}this.__ul.splice(F,0,{minIndex:E,maxIndex:G});
var I=this.__ul[0];

for(var i=1;i<this.__ul.length;i++){var H=this.__ul[i];

if(I.maxIndex+1>=H.minIndex){I.maxIndex=Math.max(I.maxIndex,H.maxIndex);
this.__ul.splice(i,1);
i--;
}else{I=H;
}}},_dumpRanges:function(){var L=u;

for(var i=0;i<this.__ul.length;i++){var M=this.__ul[i];
L+=x+M.minIndex+A+M.maxIndex+w;
}this.debug(L);
},_fireChangeSelection:function(){if(this.hasBatchMode()){this.__uo=true;
}else{this.fireEvent(z);
}}},destruct:function(){this.__ul=null;
}});
})();
(function(){var bt="dataChanged",bs="qx.event.type.Data",br="Left",bq="Right",bp="hidden",bo="Boolean",bn="Enter",bm="number",bl="changeSelection",bk="dataEdited",bh="object",bj="qx.ui.treevirtual.TreeVirtual",bi="string",bg="treevirtual";
qx.Class.define(bj,{extend:qx.ui.table.Table,construct:function(x,y){if(!y){y={};
}
if(!y.dataModel){y.dataModel=new qx.ui.treevirtual.SimpleTreeDataModel();
}
if(y.treeColumn===undefined){y.treeColumn=0;
y.dataModel.setTreeColumn(y.treeColumn);
}
if(!y.treeDataCellRenderer){y.treeDataCellRenderer=new qx.ui.treevirtual.SimpleTreeDataCellRenderer();
}
if(!y.defaultDataCellRenderer){y.defaultDataCellRenderer=new qx.ui.treevirtual.DefaultDataCellRenderer();
}
if(!y.dataRowRenderer){y.dataRowRenderer=new qx.ui.treevirtual.SimpleTreeDataRowRenderer();
}
if(!y.selectionManager){y.selectionManager=function(E){return new qx.ui.treevirtual.SelectionManager(E);
};
}
if(!y.tableColumnModel){y.tableColumnModel=function(bd){return new qx.ui.table.columnmodel.Resize(bd);
};
}if(typeof (x)==bi){x=[x];
}y.dataModel.setColumns(x);
y.dataModel.setTreeColumn(y.treeColumn);
y.dataModel.setTree(this);
arguments.callee.base.call(this,y.dataModel,y);
this.addListener(bk,function(e){this.getDataModel().setData();
},this);
this.setColumnVisibilityButtonVisible(x.length>1);
this.setRowHeight(16);
this.setMetaColumnCounts(x.length>1?[1,-1]:[1]);
this.setOverflow(bp);
var A=y.treeDataCellRenderer;
var z=y.defaultDataCellRenderer;
var D=this.getTableColumnModel();
var C=this.getDataModel().getTreeColumn();

for(var i=0;i<x.length;i++){D.setDataCellRenderer(i,i==C?A:z);
}this.setDataRowRenderer(y.dataRowRenderer);
this.setFocusCellOnMouseMove(true);
this.setShowCellFocusIndicator(false);
var B=this._getPaneScrollerArr();
for(var i=0;i<B.length;i++){B[i].setSelectBeforeFocus(true);
}},events:{"treeOpenWithContent":bs,"treeOpenWhileEmpty":bs,"treeClose":bs,"changeSelection":bs},statics:{SelectionMode:{NONE:qx.ui.table.selection.Model.NO_SELECTION,SINGLE:qx.ui.table.selection.Model.SINGLE_SELECTION,SINGLE_INTERVAL:qx.ui.table.selection.Model.SINGLE_INTERVAL_SELECTION,MULTIPLE_INTERVAL:qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION,MULTIPLE_INTERVAL_TOGGLE:qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION_TOGGLE}},properties:{openCloseClickSelectsRow:{check:bo,init:false},appearance:{refine:true,init:bg}},members:{getDataModel:function(){return this.getTableModel();
},setUseTreeLines:function(b){var v=this.getDataModel();
var t=v.getTreeColumn();
var u=this.getTableColumnModel().getDataCellRenderer(t);
u.setUseTreeLines(b);
if(v.hasListener(bt)){var w={firstRow:0,lastRow:v.getRowCount()-1,firstColumn:0,lastColumn:v.getColumnCount()-1};
v.fireDataEvent(bt,w);
}},getUseTreeLines:function(){var a=this.getDataModel().getTreeColumn();
var c=this.getTableColumnModel().getDataCellRenderer(a);
return c.getUseTreeLines();
},setAlwaysShowOpenCloseSymbol:function(b){var o=this.getDataModel();
var m=o.getTreeColumn();
var n=this.getTableColumnModel().getDataCellRenderer(m);
n.setAlwaysShowOpenCloseSymbol(b);
if(o.hasListener(bt)){var p={firstRow:0,lastRow:o.getRowCount()-1,firstColumn:0,lastColumn:o.getColumnCount()-1};
o.fireDataEvent(bt,p);
}},setExcludeFirstLevelTreeLines:function(b){var W=this.getDataModel();
var U=W.getTreeColumn();
var V=this.getTableColumnModel().getDataCellRenderer(U);
V.setExcludeFirstLevelTreeLines(b);
if(W.hasListener(bt)){var X={firstRow:0,lastRow:W.getRowCount()-1,firstColumn:0,lastColumn:W.getColumnCount()-1};
W.fireDataEvent(bt,X);
}},getExcludeFirstLevelTreeLines:function(){var bb=this.getDataModel().getTreeColumn();
var bc=this.getTableColumnModel().getDataCellRenderer(bb);
return bc.getExcludeFirstLevelTreeLines();
...
},getHierarchy:function(d){var k=this;
var h=[];
var f;
var l;
...
if(typeof (d)==bh){f=d;
l=f.nodeId;
}else if(typeof (d)==bm){l=d;
}else{throw new Error("Expected node object or node id");
}function g(q){if(!q){return ;
}var r=k.getDataModel().getData()[q];
h.unshift(r.label);
g(r.parentNodeId);
}g(l);
return h;
},getSelectedNodes:function(){return this.getDataModel().getSelectedNodes();
},_onKeyPress:function(G){if(!this.getEnabled()){return;
}var P=G.getKeyIdentifier();
var L=false;
var N=G.getModifiers();

if(N==0){switch(P){case bn:var I=this.getDataModel();
var J=this.getFocusedColumn();
var M=I.getTreeColumn();

if(J==M){var O=this.getFocusedRow();
var H=I.getValue(M,O);

if(!H.bHideOpenClose){I.setState(H,{bOpened:!H.bOpened});
}L=true;
}break;
case br:this.moveFocusedCell(-1,0);
break;
case bq:this.moveFocusedCell(1,0);
break;
}}else if(N==qx.event.type.Dom.CTRL_MASK){switch(P){case br:var I=this.getDataModel();
var O=this.getFocusedRow();
var M=I.getTreeColumn();
var H=I.getValue(M,O);
if((H.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH)&&!H.bHideOpenClose&&H.bOpened){I.setState(H,{bOpened:!H.bOpened});
}this.setFocusedCell(M,O,true);
L=true;
break;
case bq:var I=this.getDataModel();
var O=this.getFocusedRow();
var M=I.getTreeColumn();
var H=I.getValue(M,O);
if((H.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH)&&!H.bHideOpenClose&&!H.bOpened){I.setState(H,{bOpened:!H.bOpened});
...
L=true;
break;
}}else if(N==qx.event.type.Dom.SHIFT_MASK){switch(P){case br:var I=this.getDataModel();
var O=this.getFocusedRow();
var M=I.getTreeColumn();
var H=I.getValue(M,O);
if(H.parentNodeId){var K=I.getRowFromNodeId(H.parentNodeId);
this.setFocusedCell(this._focusedCol,K,true);
}L=true;
break;
case bq:var I=this.getDataModel();
var O=this.getFocusedRow();
var M=I.getTreeColumn();
var H=I.getValue(M,O);
if((H.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH)&&!H.bHideOpenClose){if(!H.bOpened){I.setState(H,{bOpened:!H.bOpened});
}if(H.children.length>0){this.moveFocusedCell(0,1);
}}L=true;
break;
}}if(L){G.preventDefault();
G.stopPropagation();
}else{arguments.callee.base.call(this,G);
}},_onSelectionChanged:function(be){this.getDataModel()._clearSelections();
if(this.getSelectionMode()!=qx.ui.treevirtual.TreeVirtual.SelectionMode.NONE){var bf=this._calculateSelectedNodes();
this.fireDataEvent(bl,bf);
}arguments.callee.base.call(this,be);
},_calculateSelectedNodes:function(){var T=this.getDataModel();
var R=this.getSelectionModel().getSelectedRanges();
var S=[];
var Q;

for(var i=0;i<R.length;i++){for(var j=R[i].minIndex;j<=R[i].maxIndex;j++){Q=T.getValue(T.getTreeColumn(),j);
T.setState(Q,{bSelected:true});
S.push(Q);
}}return S;
},setOverflow:function(s){if(s!=bp){throw new Error("Tree overflow must be hidden.  "+"The internal elements of it will scroll.");
}}}});
})();
...
var w=qx.theme.manager.Color.getInstance();
this.__ug.bgcolFocusedSelected=w.resolve(l);
this.__ug.bgcolFocused=w.resolve(q);
this.__ug.bgcolSelected=w.resolve(t);
this.__ug.bgcolEven=w.resolve(u);
this.__ug.bgcolOdd=w.resolve(m);
this.__ug.colSelected=w.resolve(n);
this.__ug.colNormal=w.resolve(s);
this.__ug.horLine=w.resolve(e);
},properties:{highlightFocusRow:{check:k,init:true}},members:{__ug:null,__uh:null,__uf:null,_insetY:1,_renderFont:function(D){if(D){this.__uh=D.getStyles();
this.__uf=qx.bom.element.Style.compile(this.__uh);
this.__uf=this.__uf.replace(/"/g,d);
}else{this.__uf=v;
this.__uh=qx.bom.Font.getDefaultStyles();
}},updateDataRowElement:function(x,y){var A=this.__uh;
var z=y.style;
qx.bom.element.Style.setStyles(y,A);

if(x.focusedRow&&this.getHighlightFocusRow()){z.backgroundColor=x.selected?this.__ug.bgcolFocusedSelected:this.__ug.bgcolFocused;
}else{if(x.selected){z.backgroundColor=this.__ug.bgcolSelected;
}else{z.backgroundColor=(x.row%2==0)?this.__ug.bgcolEven:this.__ug.bgcolOdd;
}}z.color=x.selected?this.__ug.colSelected:this.__ug.colNormal;
z.borderBottom=c+this.__ug.horLine;
...
if(a.focusedRow&&this.getHighlightFocusRow()){b.push(a.selected?this.__ug.bgcolFocusedSelected:this.__ug.bgcolFocused);
}else{if(a.selected){b.push(this.__ug.bgcolSelected);
}else{b.push((a.row%2==0)?this.__ug.bgcolEven:this.__ug.bgcolOdd);
}}b.push(o);
b.push(a.selected?this.__ug.colSelected:this.__ug.colNormal);
b.push(p,this.__ug.horLine);
return b.join(v);
},getRowClass:function(B){return v;
}},destruct:function(){this.__ug=this.__uh=this.__uf=null;
}});
})();
...
qx.Class.define(i,{extend:qx.ui.form.Button,construct:function(r,s,t){arguments.callee.base.call(this,r,s);
if(t!=null){this.setMenu(t);
}},properties:{menu:{check:n,nullable:true,apply:g,event:j}},members:{_applyMenu:function(v,w){if(w){w.removeListener(o,this._onMenuChange,this);
w.resetOpener();
}
if(v){v.addListener(o,this._onMenuChange,this);
v.setOpener(this);
v.removeState(m);
v.removeState(k);
...
if(a.isVisible()){this.addState(q);
...
},members:{__ui:null,factory:function(j,k){switch(j){case c:var m=new qx.ui.menu.Menu();
this.setMenu(m);
return m;
...
(function(){var bl="keypress",bk="interval",bj="keydown",bi="mousedown",bh="keyup",bg="__lr",bf="blur",be="Enter",bd="__lt",bc="__ls",V="Up",bb="Escape",Y="qx.ui.menu.Manager",U="Left",T="Down",X="Right",W="singleton",ba="Space";
qx.Class.define(Y,{type:W,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__lr=[];
var f=document.body;
var g=qx.event.Registration;
g.addListener(window.document.documentElement,bi,this._onMouseDown,this,true);
g.addListener(f,bj,this._onKeyUpDown,this,true);
g.addListener(f,bh,this._onKeyUpDown,this,true);
g.addListener(f,bl,this._onKeyPress,this,true);
qx.bom.Element.addListener(window,bf,this.hideAll,this);
this.__ls=new qx.event.Timer;
this.__ls.addListener(bk,this._onOpenInterval,this);
this.__lt=new qx.event.Timer;
this.__lt.addListener(bk,this._onCloseInterval,this);
},members:{__lu:null,__lv:null,__ls:null,__lt:null,__lr:null,_getChild:function(bm,bn,bo,bp){var bq=bm.getChildren();
...
if(z){qx.lang.Array.remove(z,y);
}},hideAll:function(){var x=this.__lr;

if(x){for(var i=x.length-1;i>=0;i--){x[i].exclude();
}}},getActiveMenu:function(){var d=this.__lr;
...
}},scheduleClose:function(J){this.cancelOpen(J);
if(!J.isVisible()){if(this.__lv){this.cancelClose(this.__lv);
}}else if(this.__lv!=J){this.__lv=J;
this.__lt.restartWith(J.getCloseInterval());
}},cancelOpen:function(m){if(this.__lu==m){this.__ls.stop();
this.__lu=null;
}},cancelClose:function(B){if(this.__lv==B){this.__lt.stop();
this.__lv=null;
...
}if(this.__lr.length>0&&!this._isInMenu(I)){this.hideAll();
}},__lw:{"Enter":1,"Space":1},__lx:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var bA=this.getActiveMenu();

if(!bA){return;
}var bB=e.getKeyIdentifier();

if(this.__lx[bB]||(this.__lw[bB]&&bA.getSelectedButton())){e.stopPropagation();
...
if(G){switch(E){case V:this._onKeyPressUp(D);
break;
case T:this._onKeyPressDown(D);
break;
case U:this._onKeyPressLeft(D);
break;
case X:this._onKeyPressRight(D);
break;
case bb:this.hideAll();
break;
}e.stopPropagation();
e.preventDefault();
}else if(F){var H=D.getSelectedButton();

if(H){switch(E){case be:this._onKeyPressEnter(D,H,e);
break;
case ba:this._onKeyPressSpace(D,H,e);
break;
}e.stopPropagation();
e.preventDefault();
...
}},_onKeyPressDown:function(h){var j=h.getSelectedButton();
var l=j?h.indexOf(j)+1:0;
...
}}},_onKeyPressEnter:function(a,b,e){if(b.hasListener(bl)){var c=e.clone();
c.setBubbles(false);
c.setTarget(b);
b.dispatchEvent(c);
}this.hideAll();
},_onKeyPressSpace:function(n,o,e){if(o.hasListener(bl)){var p=e.clone();
p.setBubbles(false);
p.setTarget(o);
o.dispatchEvent(p);
}}},destruct:function(){var bt=qx.event.Registration;
var bs=document.body;
bt.removeListener(window.document.documentElement,bi,this._onMouseDown,this,true);
bt.removeListener(bs,bj,this._onKeyUpDown,this,true);
bt.removeListener(bs,bh,this._onKeyUpDown,this,true);
bt.removeListener(bs,bl,this._onKeyPress,this,true);
this._disposeObjects(bc,bd);
this._disposeArray(bg);
}});
})();
(function(){var V="slidebar",U="Integer",T="resize",S="qx.ui.core.Widget",R="selected",Q="visible",P="Boolean",O="mouseout",N="excluded",M="menu",bl="_applySelectedButton",bk="_applySpacingY",bj="_blocker",bi="_applyCloseInterval",bh="_applyBlockerColor",bg="_applyIconColumnWidth",bf="mouseover",be="_applyArrowColumnWidth",bd="qx.ui.menu.Menu",bc="Color",ba="Number",bb="_applyOpenInterval",X="_applySpacingX",Y="_applyBlockerOpacity",W="_applyOpenedButton";
qx.Class.define(bd,{extend:qx.ui.core.Widget,include:[qx.ui.core.MPlacement,qx.ui.core.MChildrenHandling],construct:function(){arguments.callee.base.call(this);
this._setLayout(new qx.ui.menu.Layout);
var o=this.getApplicationRoot();
o.add(this);
this.addListener(bf,this._onMouseOver);
this.addListener(O,this._onMouseOut);
this.addListener(T,this._onResize,this);
o.addListener(T,this._onResize,this);
this._blocker=new qx.ui.core.Blocker(o);
this.initVisibility();
this.initKeepFocus();
this.initKeepActive();
},properties:{appearance:{refine:true,init:M},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},visibility:{refine:true,init:N},keepFocus:{refine:true,init:true},keepActive:{refine:true,init:true},spacingX:{check:U,apply:X,init:0,themeable:true},spacingY:{check:U,apply:bk,init:0,themeable:true},iconColumnWidth:{check:U,init:0,themeable:true,apply:bg},arrowColumnWidth:{check:U,init:0,themeable:true,apply:be},blockerColor:{check:bc,init:null,nullable:true,apply:bh,themeable:true},blockerOpacity:{check:ba,init:1,apply:Y,themeable:true},selectedButton:{check:S,nullable:true,apply:bl},openedButton:{check:S,nullable:true,apply:W},opener:{check:S,nullable:true},openInterval:{check:U,themeable:true,init:250,apply:bb},closeInterval:{check:U,themeable:true,init:250,apply:bi},blockBackground:{check:P,themeable:true,init:false}},members:{__kL:null,__kM:null,_blocker:null,open:function(){if(this.getOpener()!=null){this.placeToWidget(this.getOpener());
this.__kO();
this.show();
...
},openAtPoint:function(D){this.placeToPoint(D);
this.__kO();
this.show();
this._placementTarget=D;
},addSeparator:function(){this.add(new qx.ui.menu.Separator);
},getColumnSizes:function(){return this._getMenuLayout().getColumnSizes();
},getSelectables:function(){var bm=[];
var bn=this.getChildren();

for(var i=0;i<bn.length;i++){if(bn[i].isEnabled()){bm.push(bn[i]);
}}return bm;
},_applyIconColumnWidth:function(p,q){this._getMenuLayout().setIconColumnWidth(p);
},_applyArrowColumnWidth:function(bo,bp){this._getMenuLayout().setArrowColumnWidth(bo);
},_applySpacingX:function(m,n){this._getMenuLayout().setColumnSpacing(m);
},_applySpacingY:function(k,l){this._getMenuLayout().setSpacing(k);
},_applyVisibility:function(r,s){arguments.callee.base.call(this,r,s);
var t=qx.ui.menu.Manager.getInstance();

if(r===Q){t.add(this);
var u=this.getParentMenu();

if(u){u.setOpenedButton(this.getOpener());
}}else if(s===Q){t.remove(this);
var u=this.getParentMenu();

if(u&&u.getOpenedButton()==this.getOpener()){u.resetOpenedButton();
}this.resetOpenedButton();
this.resetSelectedButton();
}this.__kN();
},__kN:function(){if(this.isVisible()){if(this.getBlockBackground()){var C=this.getZIndex();
this._blocker.blockContent(C-1);
}}else{if(this._blocker.isContentBlocked()){this._blocker.unblockContent();
}}},getParentMenu:function(){var j=this.getOpener();

if(!j||!(j instanceof qx.ui.menu.AbstractButton)){return null;
}
while(j&&!(j instanceof qx.ui.menu.Menu)){j=j.getLayoutParent();
}return j;
},_applySelectedButton:function(g,h){if(h){h.removeState(R);
}
if(g){g.addState(R);
...
},_applyBlockerOpacity:function(J,K){this._blocker.setOpacity(J);
},_createChildControlImpl:function(E){var F;

switch(E){case V:var F=new qx.ui.menu.MenuSlideBar();
var H=this._getLayout();
this._setLayout(new qx.ui.layout.Grow());
var G=F.getLayout();
F.setLayout(H);
G.dispose();
var I=qx.lang.Array.clone(this.getChildren());

for(var i=0;i<I.length;i++){F.add(I[i]);
}this.removeListener(T,this._onResize,this);
F.getChildrenContainer().addListener(T,this._onResize,this);
this.add(F);
break;
...
},__kO:function(){var b=this._getMenuBounds();

if(!b){this.addListenerOnce(T,this.__kO,this);
return;
...
}},_assertSlideBar:function(L){if(this.hasChildControl(V)){return L.call(this);
}this.__kM=L;
...
}},_onMouseOver:function(e){var z=qx.ui.menu.Manager.getInstance();
z.cancelClose(this);
var A=e.getTarget();

if(A.isEnabled()&&A instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(A);
var y=A.getMenu&&A.getMenu();

if(y){y.setOpener(A);
z.scheduleOpen(y);
this.__kL=y;
}else{var B=this.getOpenedButton();

if(B){z.scheduleClose(B.getMenu());
}
if(this.__kL){z.cancelOpen(this.__kL);
this.__kL=null;
...
if(f){d.cancelClose(f.getMenu());
}if(this.__kL){d.cancelOpen(this.__kL);
}}}},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){qx.ui.menu.Manager.getInstance().remove(this);
}this.getApplicationRoot().removeListener(T,this._onResize,this);
this._placementTarget=null;
this._disposeObjects(bj);
}});
})();
...
qx.Class.define(k,{extend:qx.ui.core.Widget,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],type:m,construct:function(){arguments.callee.base.call(this);
...
if(this._isChildControlVisible(y)){var E=this.getChildControl(y);
B=E.getMarginLeft()+E.getSizeHint().width+E.getMarginRight();
}
if(this._isChildControlVisible(w)){var D=this.getChildControl(w);
...
if(qx.core.Variant.isSet(u,s)){var I=e.getOldData();

if(!I){qx.locale.Manager.getInstance().addListener(v,this._onChangeLocale,this);
}
if(!K){qx.locale.Manager.getInstance().removeListener(v,this._onChangeLocale,this);
}}var J=K!=null?K.toString():n;
this.getChildControl(w).setValue(J);
...
}},"off":null}),_applyIcon:function(f,g){if(f){this._showChildControl(z).setSource(f);
...
}},__li:function(x){while(!(x instanceof qx.ui.menu.Menu)){x=x.getLayoutParent();
}return x;
},_computeSizeHint:function(){var v=this._getLayoutChildren();
var u=0;
var w=0;
...
qx.Class.define(o,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MRemoteLayoutHandling],construct:function(a){arguments.callee.base.call(this);
var b=this.getChildControl(u);
this._add(b,{flex:1});
...
switch(I){case r:J=new qx.ui.form.RepeatButton;
J.addListener(p,this._onExecuteForward,this);
J.setFocusable(false);
this._addAt(J,2);
break;
case s:J=new qx.ui.form.RepeatButton;
J.addListener(p,this._onExecuteBackward,this);
J.setFocusable(false);
this._addAt(J,0);
break;
case q:J=new qx.ui.container.Composite();
if(qx.bom.client.Engine.GECKO){J.addListener(m,this._onRemoveChild,this);
}this.getChildControl(u).add(J);
break;
case u:J=new qx.ui.core.scroll.ScrollPane();
J.addListener(j,this._onResize,this);
J.addListener(i,this._onScroll,this);
J.addListener(n,this._onScroll,this);
break;
...
if(E==t){G.removeState(t);
F.removeState(t);
G.addState(v);
F.addState(v);
}else if(E==v){G.removeState(v);
F.removeState(v);
G.addState(t);
F.addState(t);
}
if(D==v){this._setLayout(new qx.ui.layout.HBox());
...
},_updateArrowsEnabled:function(){var d=this.getChildControl(u);

if(this.getOrientation()===v){var c=d.getScrollX();
var f=d.getScrollMaxX();
}else{var c=d.getScrollY();
var f=d.getScrollMaxY();
}this.getChildControl(s).setEnabled(c>0);
this.getChildControl(r).setEnabled(c<f);
...
},properties:{appearance:{refine:true,init:f},openMenu:{check:o,event:e,nullable:true},show:{init:p,check:[p,k,m],inheritable:true,event:j},spacing:{nullable:true,check:h,themeable:true,apply:n}},members:{__oC:false,_setAllowMenuOpenHover:function(t){this.__oC=t;
},_isAllowMenuOpenHover:function(){return this.__oC;
},_applySpacing:function(b,c){var d=this._getLayout();
...
},members:{__uj:false,_applyVisible:function(a,b){if(!this.bInListener){this.setValue(a);
}}}});
})();
...
},properties:{selectionModel:{check:f}},members:{__uk:null,handleMouseDown:function(l,m){if(m.isLeftPressed()){var n=this.getSelectionModel();

if(!n.isSelectedIndex(l)){this._handleSelectEvent(l,m);
this.__uk=true;
}else{this.__uk=false;
}}else if(m.isRightPressed()&&m.getModifiers()==0){var n=this.getSelectionModel();

if(!n.isSelectedIndex(l)){n.setSelectionInterval(l,l);
}}},handleMouseUp:function(c,d){if(d.isLeftPressed()&&!this.__uk){this._handleSelectEvent(c,d);
}},handleClick:function(s,t){},handleSelectKeyDown:function(a,b){this._handleSelectEvent(a,b);
...
if(!c.__up){var e=qx.theme.manager.Color.getInstance();
c.__up=arguments.callee.self;
var d=n+
...
}c.__up.stylesheet=qx.bom.Stylesheet.createElement(d);
}},members:{_insetX:6+6+1,_insetY:0,_getCellClass:function(f){return m;
},_getCellStyle:function(T){return T.style||p;
},_getCellAttributes:function(N){return p;
...
S+=I+Math.max(P,0)+o;
return S;
},createDataCellHtml:function(a,b){b.push(K,this._getCellClass(a),t,v,a.styleLeft,B,this._getCellSizeStyle(a.styleWidth,a.styleHeight,this._insetX,this._insetY),this._getCellStyle(a),l,this._getCellAttributes(a),E+this._getContentHtml(a),w);
}}});
})();
...
(function(){var j="qx.event.type.Data",h="visibilityChanged",g="orderChanged",f="visibilityChangedPre",e="__uw",d="widthChanged",c="qx.ui.table.columnmodel.Basic",b="__ux",a="__uv";
qx.Class.define(c,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__uq=[];
this.__ur=[];
},events:{"widthChanged":j,"visibilityChangedPre":j,"visibilityChanged":j,"orderChanged":j},statics:{DEFAULT_WIDTH:100,DEFAULT_HEADER_RENDERER:qx.ui.table.headerrenderer.Default,DEFAULT_DATA_RENDERER:qx.ui.table.cellrenderer.Default,DEFAULT_EDITOR_FACTORY:qx.ui.table.celleditor.TextField},members:{__us:null,__ut:null,__ur:null,__uq:null,__uu:null,__uv:null,__uw:null,__ux:null,init:function(M){{};
this.__uu=[];
var P=qx.ui.table.columnmodel.Basic.DEFAULT_WIDTH;
var Q=this.__uv||(this.__uv=new qx.ui.table.columnmodel.Basic.DEFAULT_HEADER_RENDERER());
var O=this.__uw||(this.__uw=new qx.ui.table.columnmodel.Basic.DEFAULT_DATA_RENDERER());
var N=this.__ux||(this.__ux=new qx.ui.table.columnmodel.Basic.DEFAULT_EDITOR_FACTORY());
this.__uq=[];
this.__ur=[];

for(var S=0;S<M;S++){this.__uu[S]={width:P,headerRenderer:Q,dataRenderer:O,editorFactory:N};
this.__uq[S]=S;
this.__ur[S]=S;
}this.__ut=null;
...
}},getVisibleColumns:function(){return this.__ur!=null?this.__ur:[];
},setColumnWidth:function(H,I){{};
var K=this.__uu[H].width;

if(K!=I){this.__uu[H].width=I;
var J={col:H,newWidth:I,oldWidth:K};
this.fireDataEvent(d,J);
}},getColumnWidth:function(w){{};
return this.__uu[w].width;
},setHeaderCellRenderer:function(bc,bd){{};
var be=this.__uu[bc].headerRenderer;

if(be!==this.__uv){be.dispose();
}this.__uu[bc].headerRenderer=bd;
},getHeaderCellRenderer:function(u){{};
return this.__uu[u].headerRenderer;
},setDataCellRenderer:function(T,U){{};
var V=this.__uu[T].headerRenderer;

if(V!==this.__uw){V.dispose();
}this.__uu[T].dataRenderer=U;
},getDataCellRenderer:function(W){{};
return this.__uu[W].dataRenderer;
},setCellEditorFactory:function(Y,ba){{};
var bb=this.__uu[Y].headerRenderer;

if(bb!==this.__ux){bb.dispose();
}this.__uu[Y].editorFactory=ba;
},getCellEditorFactory:function(bf){{};
return this.__uu[bf].editorFactory;
},_getColToXPosMap:function(){if(this.__ut==null){this.__ut={};

for(var B=0;B<this.__uq.length;B++){var A=this.__uq[B];
this.__ut[A]={overX:B};
}
for(var z=0;z<this.__ur.length;z++){var A=this.__ur[z];
this.__ut[A].visX=z;
}}return this.__ut;
},getVisibleColumnCount:function(){return this.__ur!=null?this.__ur.length:0;
},getVisibleColumnAtX:function(v){{};
return this.__ur[v];
},getVisibleX:function(y){{};
return this._getColToXPosMap()[y].visX;
},getOverallColumnCount:function(){return this.__uq.length;
...
},setColumnVisible:function(l,m){{};

if(m!=this.isColumnVisible(l)){if(m){var s=this._getColToXPosMap();
var p=s[l].overX;

if(p==null){throw new Error("Showing column failed: "+l+". The column is not added to this TablePaneModel.");
}var q;

for(var x=p+1;x<this.__uq.length;x++){var r=this.__uq[x];
var n=s[r].visX;

if(n!=null){q=n;
break;
}}if(q==null){q=this.__ur.length;
}this.__ur.splice(q,0,l);
}else{var o=this.getVisibleX(l);
this.__ur.splice(o,1);
}this.__ut=null;
if(!this.__us){var t={col:l,visible:m};
this.fireDataEvent(f,t);
this.fireDataEvent(h,t);
}}},moveColumn:function(C,D){{};
this.__us=true;
var G=this.__uq[C];
var E=this.isColumnVisible(G);

if(E){this.setColumnVisible(G,false);
}this.__uq.splice(C,1);
this.__uq.splice(D,0,G);
this.__ut=null;

if(E){this.setColumnVisible(G,true);
}this.__us=false;
var F={col:G,fromOverXPos:C,toOverXPos:D};
this.fireDataEvent(g,F);
},setColumnsOrder:function(bg){{};

if(bg.length==this.__uq.length){this.__us=true;
var bj=new Array(bg.length);

for(var bh=0;bh<this.__uq.length;bh++){var bi=this.isColumnVisible(bh);
bj[bh]=bi;

if(bi){this.setColumnVisible(bh,false);
}}this.__uq=qx.lang.Array.clone(bg);
this.__ut=null;
for(var bh=0;bh<this.__uq.length;bh++){if(bj[bh]){this.setColumnVisible(bh,true);
}}this.__us=false;
this.fireEvent(g);
}else{throw new Error("setColumnsOrder: Invalid number of column positions given, expected "+this.__uq.length+", got "+bg.length);
}}},destruct:function(){for(var i=0;i<this.__uu.length;i++){this.__uu[i].headerRenderer.dispose();
this.__uu[i].dataRenderer.dispose();
this.__uu[i].editorFactory.dispose();
}this.__uq=this.__ur=this.__uu=this.__ut=null;
this._disposeObjects(a,e,b);
}});
})();
...
}},_applyIcon:function(p,q){if(p){this._showChildControl(k).setSource(p);
...
},fromText:function(n){return qx.bom.String.escape(n).replace(/(  |\n)/g,function(l){var m={"  ":i,"\n":h};
return m[l]||l;
});
},toText:function(o){return qx.bom.String.unescape(o.replace(/\s+|<([^>])+>/gi,function(a){if(/\s+/.test(a)){return g;
}else if(/^<BR|^<br/gi.test(a)){return k;
}else{return j;
}}));
}},defer:function(b,c,d){b.FROM_CHARCODE=qx.lang.Object.invert(b.TO_CHARCODE);
}});
})();
...
for(E=y.length;E>3;E-=3){C=u+qx.locale.Number.getGroupSeparator(this.__uy)+y.substring(E-3,E)+C;
}C=y.substring(0,E)+C;
}var A=this.getPrefix()?this.getPrefix():u;
var x=this.getPostfix()?this.getPostfix():u;
var D=A+(z?s:u)+C;

if(B.length>0){D+=u+qx.locale.Number.getDecimalSeparator(this.__uy)+B;
}D+=x;
return D;
},parse:function(H){var M=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__uy)+u);
var K=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__uy)+u);
var I=new RegExp(f+qx.lang.String.escapeRegexpChars(this.getPrefix())+j+k+M+h+o+K+d+qx.lang.String.escapeRegexpChars(this.getPostfix())+l);
var L=I.exec(H);
...
var P=L[2];
var O=L[3];
P=P.replace(new RegExp(M,n),u);
var J=(N?s:u)+P;

if(O!=null&&O.length!=0){O=O.replace(new RegExp(K),u);
J+=i+O;
}return parseFloat(J);
}}});
})();
...
qx.Class.define(k,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(dd,de){arguments.callee.base.call(this);

if(!de){this.__pp=qx.locale.Manager.getInstance().getLocale();
}else{this.__pp=de;
}
if(dd!=null){this.__pq=dd.toString();
}else{this.__pq=qx.locale.Date.getDateFormat(bL,this.__pp)+bP+qx.locale.Date.getDateTimeFormat(bK,bM,this.__pp);
}},statics:{getDateTimeInstance:function(){var cu=qx.util.format.DateFormat;
var ct=qx.locale.Date.getDateFormat(bL)+bP+qx.locale.Date.getDateTimeFormat(bK,bM);

if(cu._dateInstance==null||cu._dateInstance.__pq!=ct){cu._dateTimeInstance=new cu();
}return cu._dateTimeInstance;
},getDateInstance:function(){var cs=qx.util.format.DateFormat;
var cr=qx.locale.Date.getDateFormat(V)+bD;

if(cs._dateInstance==null||cs._dateInstance.__pq!=cr){cs._dateInstance=new cs(cr);
}return cs._dateInstance;
},ASSUME_YEAR_2000_THRESHOLD:30,LOGGING_DATE_TIME__format:o,AM_MARKER:"am",PM_MARKER:"pm",MEDIUM_TIMEZONE_NAMES:["GMT"],FULL_TIMEZONE_NAMES:["Greenwich Mean Time"]},members:{__pp:null,__pq:null,__pr:null,__ps:null,__pt:null,__pu:function(cR,cS){var cT=bD+cR;

while(cT.length<cS){cT=bJ+cT;
}return cT;
},__pv:function(da){var db=new Date(da.getTime());
var dc=db.getDate();

while(db.getMonth()!=0){db.setDate(-1);
dc+=db.getDate()+1;
}return dc;
},__pw:function(ch){return new Date(ch.getTime()+(3-((ch.getDay()+6)%7))*86400000);
},__px:function(dN){var dP=this.__pw(dN);
var dQ=dP.getFullYear();
var dO=this.__pw(new Date(dQ,0,4));
return Math.floor(1.5+(dP.getTime()-dO.getTime())/86400000/7);
},format:function(cv){if(cv==null){return null;
}var cB=qx.util.format.DateFormat;
var cC=this.__pp;
var cM=cv.getFullYear();
var cG=cv.getMonth();
var cO=cv.getDate();
var cw=cv.getDay();
var cH=cv.getHours();
var cD=cv.getMinutes();
var cI=cv.getSeconds();
var cK=cv.getMilliseconds();
var cN=cv.getTimezoneOffset();
var cz=cN>0?1:-1;
var cx=Math.floor(Math.abs(cN)/60);
var cE=Math.abs(cN)%60;
this.__py();
var cL=bD;

for(var i=0;i<this.__pt.length;i++){var cJ=this.__pt[i];

if(cJ.type==bk){cL+=cJ.text;
}else{var cA=cJ.character;
var cF=cJ.size;
var cy=y;

switch(cA){case d:case I:if(cF==2){cy=this.__pu(cM%100,2);
}else{cy=cM+bD;

if(cF>cy.length){for(var i=cy.length;i<cF;i++){cy=bJ+cy;
}}}break;
case u:cy=this.__pu(this.__pv(cv),cF);
break;
case W:cy=this.__pu(cO,cF);
break;
case B:cy=this.__pu(this.__px(cv),cF);
break;
case x:if(cF==2){cy=qx.locale.Date.getDayName(bf,cw,cC,bE);
}else if(cF==3){cy=qx.locale.Date.getDayName(bC,cw,cC,bE);
}else if(cF==4){cy=qx.locale.Date.getDayName(bB,cw,cC,bE);
}break;
case P:if(cF==2){cy=qx.locale.Date.getDayName(bf,cw,cC,bx);
}else if(cF==3){cy=qx.locale.Date.getDayName(bC,cw,cC,bx);
}else if(cF==4){cy=qx.locale.Date.getDayName(bB,cw,cC,bx);
}break;
case U:if(cF==1||cF==2){cy=this.__pu(cG+1,cF);
}else if(cF==3){cy=qx.locale.Date.getMonthName(bC,cG,cC,bE);
}else if(cF==4){cy=qx.locale.Date.getMonthName(bB,cG,cC,bE);
}break;
case bs:if(cF==1||cF==2){cy=this.__pu(cG+1,cF);
}else if(cF==3){cy=qx.locale.Date.getMonthName(bC,cG,cC,bx);
}else if(cF==4){cy=qx.locale.Date.getMonthName(bB,cG,cC,bx);
}break;
case bc:cy=(cH<12)?qx.locale.Date.getAmMarker(cC):qx.locale.Date.getPmMarker(cC);
break;
case M:cy=this.__pu(cH,cF);
break;
case O:cy=this.__pu((cH==0)?24:cH,cF);
break;
case w:cy=this.__pu(cH%12,cF);
break;
case bX:cy=this.__pu(((cH%12)==0)?12:(cH%12),cF);
break;
case Y:cy=this.__pu(cD,cF);
break;
case bV:cy=this.__pu(cI,cF);
break;
case J:cy=this.__pu(cK,cF);
break;
case bI:if(cF==1){cy=h+((cz>0)?be:bN)+this.__pu(Math.abs(cx))+c+this.__pu(cE,2);
}else if(cF==2){cy=cB.MEDIUM_TIMEZONE_NAMES[cx];
}else if(cF==3){cy=cB.FULL_TIMEZONE_NAMES[cx];
}break;
case bO:cy=((cz>0)?be:bN)+this.__pu(Math.abs(cx),2)+this.__pu(cE,2);
break;
}cL+=cy;
}}return cL;
},parse:function(ci){this.__pz();
var co=this.__pr.regex.exec(ci);

if(co==null){throw new Error("Date string '"+ci+"' does not match the date format: "+this.__pq);
}var cj={year:1970,month:0,day:1,hour:0,ispm:false,min:0,sec:0,ms:0};
var ck=1;

for(var i=0;i<this.__pr.usedRules.length;i++){var cm=this.__pr.usedRules[i];
var cl=co[ck];

if(cm.field!=null){cj[cm.field]=parseInt(cl,10);
}else{cm.manipulator(cj,cl);
}ck+=(cm.groups==null)?1:cm.groups;
}var cn=new Date(cj.year,cj.month,cj.day,(cj.ispm)?(cj.hour+12):cj.hour,cj.min,cj.sec,cj.ms);

if(cj.month!=cn.getMonth()||cj.year!=cn.getFullYear()){throw new Error("Error parsing date '"+ci+"': the value for day or month is too large");
}return cn;
...
case bw:if(eb==ea){dX++;
i++;
}else{this.__pt.push({type:bw,character:ea,size:dX});
ea=null;
dX=0;
dY=bl;
}break;
...
if(dY!=bl){if(ec.length>0){this.__pt.push({type:bk,text:ec});
ec=bD;
}}else{ec+=eb;
i++;
}break;
}}if(ea!=null){this.__pt.push({type:bw,character:ea,size:dX});
}else if(ec.length>0){this.__pt.push({type:bk,text:ec});
...
for(var dA=0;dA<this.__pt.length;dA++){var dJ=this.__pt[dA];

if(dJ.type==bk){dE+=qx.lang.String.escapeRegexpChars(dJ.text);
}else{var dB=dJ.character;
var dF=dJ.size;
var dD;

for(var dK=0;dK<this.__ps.length;dK++){var dG=this.__ps[dK];

if(dB==dG.pattern.charAt(0)&&dF==dG.pattern.length){dD=dG;
break;
}}if(dD==null){var dH=bD;
...
try{dz=new RegExp(dE);
}catch(cU){throw new Error("Malformed date format: "+dC);
}this.__pr={regex:dz,"usedRules":dI,pattern:dE};
},__pA:function(){var dk=qx.util.format.DateFormat;
var dr=qx.lang.String;

if(this.__ps!=null){return ;
}var dl=this.__ps=[];
var dy=function(dT,dU){dU=parseInt(dU,10);

if(dU<dk.ASSUME_YEAR_2000_THRESHOLD){dU+=2000;
}else if(dU<100){dU+=1900;
}dT.year=dU;
};
var ds=function(cp,cq){cp.month=parseInt(cq,10)-1;
};
var dp=function(a,b){a.ispm=(b==dk.PM_MARKER);
};
var dn=function(dL,dM){dL.hour=parseInt(dM,10)%24;
};
var dm=function(cf,cg){cf.hour=parseInt(cg,10)%12;
};
var dv=function(dR,dS){return;
};
var dt=qx.locale.Date.getMonthNames(bC,this.__pp,bE);

for(var i=0;i<dt.length;i++){dt[i]=dr.escapeRegexpChars(dt[i].toString());
}var du=function(cd,ce){ce=dr.escapeRegexpChars(ce);
cd.month=dt.indexOf(ce);
};
var dh=qx.locale.Date.getMonthNames(bB,this.__pp,bE);

for(var i=0;i<dh.length;i++){dh[i]=dr.escapeRegexpChars(dh[i].toString());
}var dg=function(cX,cY){cY=dr.escapeRegexpChars(cY);
cX.month=dh.indexOf(cY);
};
var dj=qx.locale.Date.getDayNames(bf,this.__pp,bE);

for(var i=0;i<dj.length;i++){dj[i]=dr.escapeRegexpChars(dj[i].toString());
}var df=function(cV,cW){cW=dr.escapeRegexpChars(cW);
cV.month=dj.indexOf(cW);
};
var dw=qx.locale.Date.getDayNames(bC,this.__pp,bE);

for(var i=0;i<dw.length;i++){dw[i]=dr.escapeRegexpChars(dw[i].toString());
}var dq=function(cb,cc){cc=dr.escapeRegexpChars(cc);
cb.month=dw.indexOf(cc);
};
var dx=qx.locale.Date.getDayNames(bB,this.__pp,bE);

for(var i=0;i<dx.length;i++){dx[i]=dr.escapeRegexpChars(dx[i].toString());
}var di=function(cP,cQ){cQ=dr.escapeRegexpChars(cQ);
cP.month=dx.indexOf(cQ);
};
dl.push({pattern:bT,regex:R,manipulator:dy});
dl.push({pattern:bS,regex:br,manipulator:dy});
dl.push({pattern:s,regex:bu,manipulator:dy});
dl.push({pattern:l,regex:S,manipulator:dy});
dl.push({pattern:F,regex:ba,manipulator:dy});
dl.push({pattern:t,regex:n,manipulator:dy});
dl.push({pattern:ca,regex:r,manipulator:dy});
dl.push({pattern:C,regex:bF,manipulator:ds});
dl.push({pattern:p,regex:bF,manipulator:ds});
dl.push({pattern:E,regex:bA+dt.join(by)+bz,manipulator:du});
dl.push({pattern:K,regex:bA+dh.join(by)+bz,manipulator:dg});
dl.push({pattern:j,regex:bF,field:bH});
dl.push({pattern:Q,regex:bF,field:bH});
dl.push({pattern:bQ,regex:bA+dj.join(by)+bz,manipulator:df});
dl.push({pattern:A,regex:bA+dw.join(by)+bz,manipulator:dq});
dl.push({pattern:bn,regex:bA+dx.join(by)+bz,manipulator:di});
dl.push({pattern:f,regex:bA+dk.AM_MARKER+by+dk.PM_MARKER+bz,manipulator:dp});
dl.push({pattern:bR,regex:bF,field:bi});
dl.push({pattern:m,regex:bF,field:bi});
dl.push({pattern:bY,regex:bF,manipulator:dn});
dl.push({pattern:T,regex:bF,manipulator:dn});
dl.push({pattern:bt,regex:bF,field:bi});
dl.push({pattern:e,regex:bF,field:bi});
dl.push({pattern:v,regex:bF,manipulator:dm});
dl.push({pattern:bq,regex:bF,manipulator:dm});
dl.push({pattern:bo,regex:bF,field:bp});
dl.push({pattern:H,regex:bF,field:bp});
dl.push({pattern:L,regex:bF,field:bG});
dl.push({pattern:D,regex:bF,field:bG});
dl.push({pattern:q,regex:bh,field:bg});
dl.push({pattern:bb,regex:bh,field:bg});
dl.push({pattern:bW,regex:bh,field:bg});
dl.push({pattern:bv,regex:g,manipulator:dv});
dl.push({pattern:G,regex:N,manipulator:dv});
}},destruct:function(){this.__pt=this.__pr=this.__ps=null;
}});
})();
(function(){var r="_",q="format",p="thu",o="sat",n="cldr_day_",m="cldr_month_",l="wed",k="fri",j="tue",h="mon",I="sun",H="short",G="HH:mm",F="HHmmsszz",E="HHmm",D="HHmmss",C="cldr_date_format_",B="HH:mm:ss zz",A="full",z="cldr_pm",x="long",y="medium",v="cldr_am",w="qx.locale.Date",t="cldr_date_time_format_",u="cldr_time_format_",s="HH:mm:ss";
qx.Class.define(w,{statics:{__pa:qx.locale.Manager.getInstance(),getAmMarker:function(bx){return this.__pa.localize(v,[],bx);
},getPmMarker:function(S){return this.__pa.localize(z,[],S);
},getDayNames:function(length,c,d){var d=d?d:q;
{};
var f=[I,h,j,l,p,k,o];
var g=[];

for(var i=0;i<f.length;i++){var e=n+d+r+length+r+f[i];
g.push(this.__pa.localize(e,[],c));
}return g;
},getDayName:function(length,N,O,P){var P=P?P:q;
{};
var R=[I,h,j,l,p,k,o];
var Q=n+P+r+length+r+R[N];
return this.__pa.localize(Q,[],O);
},getMonthNames:function(length,J,K){var K=K?K:q;
{};
var M=[];

for(var i=0;i<12;i++){var L=m+K+r+length+r+(i+1);
M.push(this.__pa.localize(L,[],J));
}return M;
},getMonthName:function(length,be,bf,bg){var bg=bg?bg:q;
{};
var bh=m+bg+r+length+r+(be+1);
return this.__pa.localize(bh,[],bf);
},getDateFormat:function(bb,bc){{};
var bd=C+bb;
return this.__pa.localize(bd,[],bc);
},getDateTimeFormat:function(bs,bt,bu){var bw=t+bs;
var bv=this.__pa.localize(bw,[],bu);

if(bv==bw){bv=bt;
}return bv;
},getTimeFormat:function(bl,bm){{};
var bo=u+bl;
var bn=this.__pa.localize(bo,[],bm);

if(bn!=bo){return bn;
}
switch(bl){case H:case y:return qx.locale.Date.getDateTimeFormat(E,G);
case x:return qx.locale.Date.getDateTimeFormat(D,s);
case A:return qx.locale.Date.getDateTimeFormat(F,B);
default:throw new Error("This case should never happen.");
}},getWeekStart:function(bp){var bq={"MV":5,"AE":6,"AF":6,"BH":6,"DJ":6,"DZ":6,"EG":6,"ER":6,"ET":6,"IQ":6,"IR":6,"JO":6,"KE":6,"KW":6,"LB":6,"LY":6,"MA":6,"OM":6,"QA":6,"SA":6,"SD":6,"SO":6,"TN":6,"YE":6,"AS":0,"AU":0,"AZ":0,"BW":0,"CA":0,"CN":0,"FO":0,"GE":0,"GL":0,"GU":0,"HK":0,"IE":0,"IL":0,"IS":0,"JM":0,"JP":0,"KG":0,"KR":0,"LA":0,"MH":0,"MN":0,"MO":0,"MP":0,"MT":0,"NZ":0,"PH":0,"PK":0,"SG":0,"TH":0,"TT":0,"TW":0,"UM":0,"US":0,"UZ":0,"VI":0,"ZA":0,"ZW":0,"MW":0,"NG":0,"TJ":0};
var br=qx.locale.Date._getTerritory(bp);
return bq[br]!=null?bq[br]:1;
},getWeekendStart:function(X){var ba={"EG":5,"IL":5,"SY":5,"IN":0,"AE":4,"BH":4,"DZ":4,"IQ":4,"JO":4,"KW":4,"LB":4,"LY":4,"MA":4,"OM":4,"QA":4,"SA":4,"SD":4,"TN":4,"YE":4};
var Y=qx.locale.Date._getTerritory(X);
return ba[Y]!=null?ba[Y]:6;
},getWeekendEnd:function(bi){var bj={"AE":5,"BH":5,"DZ":5,"IQ":5,"JO":5,"KW":5,"LB":5,"LY":5,"MA":5,"OM":5,"QA":5,"SA":5,"SD":5,"TN":5,"YE":5,"AF":5,"IR":5,"EG":6,"IL":6,"SY":6};
var bk=qx.locale.Date._getTerritory(bi);
return bj[bk]!=null?bj[bk]:0;
},isWeekend:function(T,U){var W=qx.locale.Date.getWeekendStart(U);
var V=qx.locale.Date.getWeekendEnd(U);

if(V>W){return ((T>=W)&&(T<=V));
}else{return ((T>=W)||(T<=V));
}},_getTerritory:function(a){if(a){var b=a.split(r)[1]||a;
}else{b=this.__pa.getTerritory()||this.__pa.getLanguage();
...
(function(){var bW="",bV="Number",bU='</div>',bT='" ',bS="paneUpdated",bR='<div>',bQ="</div>",bP="overflow: hidden;",bO="qx.event.type.Data",bN="paneReloadsData",cp="div",co='style="',cn="_applyMaxCacheLines",cm="qx.ui.table.pane.Pane",cl="width: 100%;",ck="qx.event.type.Event",cj="_applyVisibleRowCount",ci='>',ch="line-height: ",cg="appear",ce='class="',cf="width:100%;",cc="px;",cd='<div ',ca="'>",cb="_applyFirstVisibleRow",bX="<div style='",bY=";position:relative;";
qx.Class.define(cm,{extend:qx.ui.core.Widget,construct:function(by){arguments.callee.base.call(this);
this.__uz=by;
this.__uA=0;
this.__uB=0;
this.__uC=[];
},events:{"paneReloadsData":bO,"paneUpdated":ck},properties:{firstVisibleRow:{check:bV,init:0,apply:cb},visibleRowCount:{check:bV,init:0,apply:cj},maxCacheLines:{check:bV,init:1000,apply:cn},allowShrinkX:{refine:true,init:false}},members:{__uB:null,__uA:null,__uz:null,__uD:null,__uE:null,__uF:null,__uC:null,__uG:0,_applyFirstVisibleRow:function(bL,bM){this.updateContent(false,bL-bM);
},_applyVisibleRowCount:function(cr,cs){this.updateContent(true);
},_getContentHint:function(){return {width:this.getPaneScroller().getTablePaneModel().getTotalWidth(),height:400};
},getPaneScroller:function(){return this.__uz;
},getTable:function(){return this.__uz.getTable();
},setFocusedCell:function(u,v,w){if(u!=this.__uF||v!=this.__uE){var z=this.__uE;
this.__uF=u;
this.__uE=v;
...
},setColumnWidth:function(bw,bx){this.updateContent(true);
},onColOrderChanged:function(){this.updateContent(true);
},onPaneModelChanged:function(){this.updateContent(true);
},onTableModelDataChanged:function(a,b,c,d){this.__uH();
var f=this.getFirstVisibleRow();
var e=this.getVisibleRowCount();

if(b==-1||b>=f&&a<f+e){this.updateContent();
}},onTableModelMetaDataChanged:function(){this.updateContent(true);
},_applyMaxCacheLines:function(ct,cu){if(this.__uG>=ct&&ct!==-1){this.__uH();
}},__uH:function(){this.__uC=[];
this.__uG=0;
},__uI:function(L,M,N){if(!M&&!N&&this.__uC[L]){return this.__uC[L];
}else{return null;
}},__uJ:function(br,bs,bt,bu){var bv=this.getMaxCacheLines();

if(!bt&&!bu&&!this.__uC[br]&&bv>0){this._applyMaxCacheLines(bv);
this.__uC[br]=bs;
this.__uG+=1;
}},updateContent:function(cv,cw,cx,cy){if(cv){this.__uH();
...
var C=I.getSelectionModel();
var F=I.getTableModel();
var J=I.getDataRowRenderer();
...
for(;y<B;y++,K++){H.row=K;
H.selected=C.isSelectedIndex(K);
H.focusedRow=(this.__uE==K);
H.rowData=F.getRowData(K);
J.updateDataRowElement(H,D[y]);
...
R.push({col:bp,xPos:x,editable:S.isColumnEditable(bp),focusedCol:this.__uF==bp,styleLeft:U,styleWidth:X});
U+=X;
}var bo=[];
var bq=false;
...
if(Q){bg.push(ce,Q,bT);
}var bf=be.createRowStyle(bj);
bf+=bY+be.getRowHeightStyle(bk)+cf;

if(bf){bg.push(co,bf,bT);
}bg.push(ci);
...
var bi=bg.join(bW);
this.__uJ(W,bi,ba,bd);
bo.push(bi);
}this.fireDataEvent(bN,bq);
return bo.join(bW);
...
for(i=Math.abs(g)-1;i>=0;i--){var n=j[t];

try{r.removeChild(n);
}catch(cq){break;
}}if(!this.__uD){this.__uD=document.createElement(cp);
}var q=bR;
q+=this._getRowsHtml(o+k,Math.abs(g));
q+=bU;
this.__uD.innerHTML=q;
var l=this.__uD.firstChild.childNodes;
if(g>0){for(var i=l.length-1;i>=0;i--){var n=l[0];
r.appendChild(n);
}}else{for(var i=l.length-1;i>=0;i--){var n=l[l.length-1];
r.insertBefore(n,r.firstChild);
}}if(this.__uE!==null){this._updateRowStyles(this.__uE-g);
this._updateRowStyles(this.__uE);
}this.fireEvent(bS);
},_updateAllRows:function(){var bC=this.getContentElement().getDomElement();

if(!bC){this.addListenerOnce(cg,arguments.callee,this);
return;
}var bI=this.getTable();
var bF=bI.getTableModel();
var bH=this.getPaneScroller().getTablePaneModel();
var bG=bH.getColumnCount();
var bz=bI.getRowHeight();
...
var bE;
if(bA>0){bE=[bX,cl,(bI.getForceLineHeight()?ch+bz+cc:bW),bP,ca,this._getRowsHtml(bD,bA),bQ];
}else{bE=[];
}var bK=bE.join(bW);
bC.innerHTML=bK;
this.setWidth(bB);
...
this.__uB=bA;
this.fireEvent(bS);
}},destruct:function(){this.__uD=this.__uz=this.__uC=null;
}});
})();
(function(){var h="hovered",g="__uK",f="qx.ui.table.pane.Header";
qx.Class.define(f,{extend:qx.ui.core.Widget,construct:function(a){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.HBox());
this.__uK=a;
},members:{__uK:null,__uL:null,__uM:null,getPaneScroller:function(){return this.__uK;
},getTable:function(){return this.__uK.getTable();
},onColOrderChanged:function(){this._updateContent(true);
},onPaneModelChanged:function(){this._updateContent(true);
},onTableModelMetaDataChanged:function(){this._updateContent();
},setColumnWidth:function(i,j){var k=this.getHeaderWidgetAtColumn(i);

if(k!=null){k.setWidth(j);
}},setMouseOverColumn:function(d){if(d!=this.__uM){if(this.__uM!=null){var e=this.getHeaderWidgetAtColumn(this.__uM);

if(e!=null){e.removeState(h);
}}
if(d!=null){this.getHeaderWidgetAtColumn(d).addState(h);
}this.__uM=d;
...
if(this.__uL==null){var B=this.getPaneScroller().getTablePaneModel().getX(A);
...
this.__uL=C;
}this.__uL.setLayoutProperties({left:E.left+x});
this.__uL.show();
},hideColumnMoveFeedback:function(){if(this.__uL!=null){this.__uL.destroy();
this.__uL=null;
}},isShowingColumnMoveFeedback:function(){return this.__uL!=null;
},_updateContent:function(n){var s=this.getTable().getTableModel();
var v=this.getTable().getTableColumnModel();
var w=this.getPaneScroller().getTablePaneModel();
var z=this._getChildren();
var t=w.getColumnCount();
var o=s.getSortColumnIndex();
if(n){this._cleanUpCells();
}var p={};
p.sortedAscending=s.isSortAscending();

for(var x=0;x<t;x++){var r=w.getColumnAtX(x);

if(r===undefined){continue;
}var y=v.getColumnWidth(r);
var u=v.getHeaderCellRenderer(r);
p.xPos=x;
p.col=r;
p.name=s.getColumnName(r);
p.editable=s.isColumnEditable(r);
p.sorted=(r==o);
var q=z[x];
if(q==null){q=u.createHeaderCell(p);
q.set({width:y});
this._add(q);
}else{u.updateHeaderCell(p,q);
}}},_cleanUpCells:function(){var c=this._getChildren();

for(var x=c.length-1;x>=0;x--){var b=c[x];
b.destroy();
}}},destruct:function(){this._disposeObjects(g);
}});
})();
...
(function(){var eb="Boolean",ea="resize-line",dY="mousedown",dX="qx.event.type.Data",dW="mouseup",dV="qx.ui.table.pane.CellEvent",dU="scroll",dT="focus-indicator",dS="excluded",dR="scrollbar-y",eY="visible",eX="mousemove",eW="header",eV="editing",eU="click",eT="modelChanged",eS="scrollbar-x",eR="cellClick",eQ="pane",eP="mouseout",ei="changeHorizontalScrollBarVisible",ej="__uU",eg="bottom",eh="_applyScrollTimeout",ee="changeScrollX",ef="_applyTablePaneModel",ec="Integer",ed="dblclick",em="__uQ",en="dataEdited",ev="__uS",et="mousewheel",eD="interval",ey="qx.ui.table.pane.Scroller",eL="_applyShowCellFocusIndicator",eI="__uR",ep="resize",eO="__uW",eN="__uT",eM="vertical",eo="changeScrollY",er="appear",es="table-scroller",eu="beforeSort",ew="cellDblclick",ez="__uO",eF="horizontal",eK="__uP",ek="losecapture",el="contextmenu",eq="__uV",eC="col-resize",eB="disappear",eA="_applyVerticalScrollBarVisible",eH="_applyHorizontalScrollBarVisible",eG="cellContextmenu",ex="close",eE="changeTablePaneModel",dQ="qx.ui.table.pane.Model",eJ="changeVerticalScrollBarVisible";
qx.Class.define(ey,{extend:qx.ui.core.Widget,include:qx.ui.core.scroll.MScrollBarFactory,construct:function(D){arguments.callee.base.call(this);
this.__uN=D;
var E=new qx.ui.layout.Grid();
E.setColumnFlex(0,1);
E.setRowFlex(1,1);
this._setLayout(E);
this.__uO=this._showChildControl(eS);
this.__uP=this._showChildControl(dR);
this.__uQ=this._showChildControl(eW);
this.__uR=this._showChildControl(eQ);
this.__uS=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({minWidth:0});
this._add(this.__uS,{row:0,column:0,colSpan:2});
this.__uT=new qx.ui.table.pane.Clipper();
this.__uT.add(this.__uQ);
this.__uT.addListener(ek,this._onChangeCaptureHeader,this);
this.__uT.addListener(eX,this._onMousemoveHeader,this);
this.__uT.addListener(dY,this._onMousedownHeader,this);
this.__uT.addListener(dW,this._onMouseupHeader,this);
this.__uT.addListener(eU,this._onClickHeader,this);
this.__uS.add(this.__uT,{flex:1});
this.__uU=new qx.ui.table.pane.Clipper();
this.__uU.add(this.__uR);
this.__uU.addListener(et,this._onMousewheel,this);
this.__uU.addListener(eX,this._onMousemovePane,this);
this.__uU.addListener(dY,this._onMousedownPane,this);
this.__uU.addListener(dW,this._onMouseupPane,this);
this.__uU.addListener(eU,this._onClickPane,this);
this.__uU.addListener(el,this._onContextMenu,this);
this.__uU.addListener(ed,this._onDblclickPane,this);
this.__uU.addListener(ep,this._onResizePane,this);
this._add(this.__uU,{row:1,column:0});
this.__uV=this.getChildControl(dT);
this.getChildControl(ea).hide();
this.addListener(eP,this._onMouseout,this);
this.addListener(er,this._onAppear,this);
this.addListener(eB,this._onDisappear,this);
this.__uW=new qx.event.Timer();
this.__uW.addListener(eD,this._oninterval,this);
this.initScrollTimeout();
},statics:{MIN_COLUMN_WIDTH:10,RESIZE_REGION_RADIUS:5,CLICK_TOLERANCE:5,HORIZONTAL_SCROLLBAR:1,VERTICAL_SCROLLBAR:2},events:{"changeScrollY":dX,"changeScrollX":dX,"cellClick":dV,"cellDblclick":dV,"cellContextmenu":dV,"beforeSort":dX},properties:{horizontalScrollBarVisible:{check:eb,init:true,apply:eH,event:ei},verticalScrollBarVisible:{check:eb,init:true,apply:eA,event:eJ},tablePaneModel:{check:dQ,apply:ef,event:eE},liveResize:{check:eb,init:false},focusCellOnMouseMove:{check:eb,init:false},selectBeforeFocus:{check:eb,init:false},showCellFocusIndicator:{check:eb,init:true,apply:eL},scrollTimeout:{check:ec,init:100,apply:eh},appearance:{refine:true,init:es}},members:{__uX:null,__uN:null,__uY:null,__va:null,__vb:null,__vc:null,__vd:null,__ve:null,__vf:null,__vg:null,__vh:null,__vi:null,__vj:null,__vk:null,__vl:null,__vm:null,__vn:null,__vo:null,__vp:null,__vq:null,__vr:null,__vs:null,__uO:null,__uP:null,__uQ:null,__uT:null,__uR:null,__uU:null,__uV:null,__uS:null,__uW:null,getPaneInsetRight:function(){var cl=this.getTopRightWidget();
var cm=cl&&cl.isVisible()&&cl.getBounds()?cl.getBounds().width:0;
var ck=this.getVerticalScrollBarVisible()?this.getVerticalScrollBarWidth():0;
return Math.max(cm,ck);
},setPaneWidth:function(fu){if(this.isVerticalScrollBarVisible()){fu+=this.getPaneInsetRight();
}this.setWidth(fu);
},_createChildControlImpl:function(R){var S;

switch(R){case eW:S=(this.getTable().getNewTablePaneHeader())(this);
break;
case eQ:S=(this.getTable().getNewTablePane())(this);
break;
case dT:S=new qx.ui.table.pane.FocusIndicator(this);
S.setUserBounds(0,0,0,0);
S.setZIndex(1000);
S.addListener(dW,this._onMouseupFocusIndicator,this);
this.__uU.add(S);
S.exclude();
break;
case ea:S=new qx.ui.core.Widget();
S.setUserBounds(0,0,0,0);
S.setZIndex(1000);
this.__uU.add(S);
break;
case eS:S=this._createScrollBar(eF).set({minWidth:0,alignY:eg});
S.addListener(dU,this._onScrollX,this);
this._add(S,{row:2,column:0});
break;
case dR:S=this._createScrollBar(eM);
S.addListener(dU,this._onScrollY,this);
this._add(S,{row:1,column:1});
break;
}return S||arguments.callee.base.call(this,R);
},_applyHorizontalScrollBarVisible:function(cv,cw){this.__uO.setVisibility(cv?eY:dS);

if(!cv){this.setScrollY(0,true);
}},_applyVerticalScrollBarVisible:function(v,w){this.__uP.setVisibility(v?eY:dS);

if(!v){this.setScrollX(0);
}},_applyTablePaneModel:function(z,A){if(A!=null){A.removeListener(eT,this._onPaneModelChanged,this);
}z.addListener(eT,this._onPaneModelChanged,this);
},_applyShowCellFocusIndicator:function(fa,fb){if(fa){this._updateFocusIndicator();
}else{if(this.__uV){this.__uV.hide();
}}},getScrollY:function(){return this.__uP.getPosition();
},setScrollY:function(scrollY,fc){this.__uP.scrollTo(scrollY);

if(fc){this._updateContent();
}},getScrollX:function(){return this.__uO.getPosition();
},setScrollX:function(scrollX){this.__uO.scrollTo(scrollX);
},getTable:function(){return this.__uN;
},onColVisibilityChanged:function(){this.updateHorScrollBarMaximum();
this._updateFocusIndicator();
},setColumnWidth:function(bv,bw){this.__uQ.setColumnWidth(bv,bw);
this.__uR.setColumnWidth(bv,bw);
var bx=this.getTablePaneModel();
var x=bx.getX(bv);

if(x!=-1){this.updateHorScrollBarMaximum();
this._updateFocusIndicator();
}},onColOrderChanged:function(){this.__uQ.onColOrderChanged();
this.__uR.onColOrderChanged();
this.updateHorScrollBarMaximum();
},onTableModelDataChanged:function(bT,bU,bV,bW){this.__uR.onTableModelDataChanged(bT,bU,bV,bW);
var bX=this.getTable().getTableModel().getRowCount();

if(bX!=this.__uX){this.updateVerScrollBarMaximum();

if(this.getFocusedRow()>=bX){if(bX==0){this.setFocusedCell(null,null);
}else{this.setFocusedCell(this.getFocusedColumn(),bX-1);
}}this.__uX=bX;
}},onSelectionChanged:function(){this.__uR.onSelectionChanged();
},onFocusChanged:function(){this.__uR.onFocusChanged();
},onTableModelMetaDataChanged:function(){this.__uQ.onTableModelMetaDataChanged();
this.__uR.onTableModelMetaDataChanged();
},_onPaneModelChanged:function(){this.__uQ.onPaneModelChanged();
this.__uR.onPaneModelChanged();
},_onResizePane:function(){this.updateHorScrollBarMaximum();
this.updateVerScrollBarMaximum();
this._updateContent();
this.__uQ._updateContent();
this.__uN._updateScrollBarVisibility();
},updateHorScrollBarMaximum:function(){var ds=this.__uU.getInnerSize();

if(!ds){return ;
}var dq=this.getTablePaneModel().getTotalWidth();
var dr=this.__uO;

if(ds.width<dq){var dp=Math.max(0,dq-ds.width);
dr.setMaximum(dp);
dr.setKnobFactor(ds.width/dq);
var dt=dr.getPosition();
dr.setPosition(Math.min(dt,dp));
}else{dr.setMaximum(0);
dr.setKnobFactor(1);
dr.setPosition(0);
}},updateVerScrollBarMaximum:function(){var cE=this.__uU.getInnerSize();

if(!cE){return ;
}var cC=this.getTable().getTableModel();
var cy=cC.getRowCount();

if(this.getTable().getKeepFirstVisibleRowComplete()){cy+=1;
}var cx=this.getTable().getRowHeight();
var cA=cy*cx;
var cD=this.__uP;

if(cE.height<cA){var cz=Math.max(0,cA-cE.height);
cD.setMaximum(cz);
cD.setKnobFactor(cE.height/cA);
var cB=cD.getPosition();
cD.setPosition(Math.min(cB,cz));
...
this.fireDataEvent(ee,q,e.getOldData());
this.__uT.scrollToX(q);
this.__uU.scrollToX(q);
},_onScrollY:function(e){this.fireDataEvent(eo,e.getData(),e.getOldData());
this._postponedUpdateContent();
},_onMousewheel:function(e){var r=this.getTable();

if(!r.getEnabled()){return;
}var t=qx.bom.client.Engine.GECKO?1:3;
var s=this.__uP.getPosition()+((e.getWheelDelta()*t)*r.getRowHeight());
this.__uP.scrollTo(s);
if(this.__vm&&this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(this.__vm,this.__vn);
}e.stop();
},__vt:function(bE){var bJ=this.getTable();
var bK=this.__uQ.getHeaderWidgetAtColumn(this.__vh);
var bF=bK.getSizeHint().minWidth;
var bH=Math.max(bF,this.__vj+bE-this.__vi);

if(this.getLiveResize()){var bG=bJ.getTableColumnModel();
bG.setColumnWidth(this.__vh,bH);
}else{this.__uQ.setColumnWidth(this.__vh,bH);
var bI=this.getTablePaneModel();
this._showResizeLine(bI.getColumnLeft(this.__vh)+bH);
}this.__vi+=bH-this.__vj;
this.__vj=bH;
},__vu:function(bB){var bC=qx.ui.table.pane.Scroller.CLICK_TOLERANCE;

if(this.__uQ.isShowingColumnMoveFeedback()||bB>this.__vg+bC||bB<this.__vg-bC){this.__vd+=bB-this.__vg;
this.__uQ.showColumnMoveFeedback(this.__vc,this.__vd);
var bD=this.__uN.getTablePaneScrollerAtPageX(bB);

if(this.__vf&&this.__vf!=bD){this.__vf.hideColumnMoveFeedback();
}
if(bD!=null){this.__ve=bD.showColumnMoveFeedback(bB);
}else{this.__ve=null;
}this.__vf=bD;
this.__vg=bB;
}},_onMousemoveHeader:function(e){var dA=this.getTable();
...
if(this.__vh!=null){this.__vt(dy);
dB=true;
e.stopPropagation();
}else if(this.__vc!=null){this.__vu(dy);
e.stopPropagation();
}else{var dv=this._getResizeColumnForPageX(dy);

if(dv!=-1){dB=true;
}else{var dx=dA.getTableModel();
var dC=this._getColumnForPageX(dy);

if(dC!=null&&dx.isColumnSortable(dC)){du=dC;
}}}var dw=dB?eC:null;
this.getApplicationRoot().setGlobalCursor(dw);
this.setCursor(dw);
this.__uQ.setMouseOverColumn(du);
},_onMousemovePane:function(e){var fq=this.getTable();

if(!fq.getEnabled()){return;
}var fs=e.getDocumentLeft();
var ft=e.getDocumentTop();
this.__vm=fs;
this.__vn=ft;
var fr=this._getRowForPagePos(fs,ft);

if(fr!=null&&this._getColumnForPageX(fs)!=null){if(this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(fs,ft);
}}this.__uQ.setMouseOverColumn(null);
...
e.stop();
}}},_startResizeHeader:function(da,db){var dc=this.getTable().getTableColumnModel();
this.__vh=da;
this.__vi=db;
this.__vj=dc.getColumnWidth(this.__vh);
this.__uT.capture();
},_startMoveHeader:function(T,U){this.__vc=T;
this.__vg=U;
this.__vd=this.getTablePaneModel().getColumnLeft(T);
this.__uT.capture();
},_onMousedownPane:function(e){var fn=this.getTable();

if(!fn.getEnabled()){return;
}
if(this.isEditing()){this.stopEditing();
}var fk=e.getDocumentLeft();
var fm=e.getDocumentTop();
var fp=this._getRowForPagePos(fk,fm);
var fo=this._getColumnForPageX(fk);

if(fp!==null){this.__vk={row:fp,col:fo};
var fl=this.getSelectBeforeFocus();

if(fl){fn.getSelectionManager().handleMouseDown(fp,e);
}if(!this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(fk,fm);
}
if(!fl){fn.getSelectionManager().handleMouseDown(fp,e);
}}},_onMouseupFocusIndicator:function(e){if(this.__vk&&this.__uV.getRow()==this.__vk.row&&this.__uV.getColumn()==this.__vk.col){this.__vk={};
this.fireEvent(eR,qx.ui.table.pane.CellEvent,[this,e,this.__vk.row,this.__vk.col],true);
}},_onChangeCaptureHeader:function(e){if(this.__vh!=null){this._stopResizeHeader();
}
if(this.__vc!=null){this._stopMoveHeader();
}},_stopResizeHeader:function(){var bk=this.getTable().getTableColumnModel();
if(!this.getLiveResize()){this._hideResizeLine();
bk.setColumnWidth(this.__vh,this.__vj);
}this.__vh=null;
this.__uT.releaseCapture();
this.getApplicationRoot().setGlobalCursor(null);
this.setCursor(null);
},_stopMoveHeader:function(){var cg=this.getTable().getTableColumnModel();
var ch=this.getTablePaneModel();
this.__uQ.hideColumnMoveFeedback();

if(this.__vf){this.__vf.hideColumnMoveFeedback();
}
if(this.__ve!=null){var cj=ch.getFirstColumnX()+ch.getX(this.__vc);
var cf=this.__ve;

if(cf!=cj&&cf!=cj+1){var ci=cg.getVisibleColumnAtX(cj);
var ce=cg.getVisibleColumnAtX(cf);
var cd=cg.getOverallX(ci);
var cc=(ce!=null)?cg.getOverallX(ce):cg.getOverallColumnCount();
...
this.__ve=null;
this.__uT.releaseCapture();
},_onMouseupPane:function(e){var bL=this.getTable();

if(!bL.getEnabled()){return;
}var bM=this._getRowForPagePos(e.getDocumentLeft(),e.getDocumentTop());

if(bM!=-1&&bM!=null&&this._getColumnForPageX(e.getDocumentLeft())!=null){bL.getSelectionManager().handleMouseUp(bM,e);
}},_onMouseupHeader:function(e){var y=this.getTable();

if(!y.getEnabled()){return;
}
if(this.__vh!=null){this._stopResizeHeader();
this.__vl=true;
e.stop();
}else if(this.__vc!=null){this._stopMoveHeader();
e.stop();
}},_onClickHeader:function(e){if(this.__vl){this.__vl=false;
return;
...
var dm={column:dn,ascending:dl};

if(this.fireDataEvent(eu,dm)){di.sortByColumn(dn,dl);
dk.getSelectionModel().resetSelection();
}}}e.stop();
},_onClickPane:function(e){var cL=this.getTable();

if(!cL.getEnabled()){return;
}var cO=e.getDocumentLeft();
var cP=e.getDocumentTop();
var cM=this._getRowForPagePos(cO,cP);
var cN=this._getColumnForPageX(cO);

if(cM!=null&&cN!=null){cL.getSelectionManager().handleClick(cM,e);

if(this.__uV.isHidden()||(this.__vk&&cM==this.__vk.row&&cN==this.__vk.col)){this.__vk={};
this.fireEvent(eR,qx.ui.table.pane.CellEvent,[this,e,cM,cN],true);
}}},_onContextMenu:function(e){var bR=e.getDocumentLeft();
var bS=e.getDocumentTop();
var bP=this._getRowForPagePos(bR,bS);
var bQ=this._getColumnForPageX(bR);

if(this.__uV.isHidden()||(this.__vk&&bP==this.__vk.row&&bQ==this.__vk.col)){this.__vk={};
this.fireEvent(eG,qx.ui.table.pane.CellEvent,[this,e,bP,bQ],true);
var bO=this.getTable().getContextMenu();

if(bO){if(bO.getChildren().length>0){bO.openAtMouse(e);
}else{bO.exclude();
}e.preventDefault();
}}},_onContextMenuOpen:function(e){},_onDblclickPane:function(e){var bz=e.getDocumentLeft();
var bA=e.getDocumentTop();
this._focusCellAtPagePos(bz,bA);
this.startEditing();
var by=this._getRowForPagePos(bz,bA);

if(by!=-1&&by!=null){this.fireEvent(ew,qx.ui.table.pane.CellEvent,[this,e,by],true);
}},_onMouseout:function(e){var F=this.getTable();

if(!F.getEnabled()){return;
}if(this.__vh==null){this.setCursor(null);
this.getApplicationRoot().setGlobalCursor(null);
}this.__uQ.setMouseOverColumn(null);
},_showResizeLine:function(x){var de=this._showChildControl(ea);
var dd=de.getWidth();
var df=this.__uU.getBounds();
de.setUserBounds(x-Math.round(dd/2),0,dd,df.height);
},_hideResizeLine:function(){this._excludeChildControl(ea);
},showColumnMoveFeedback:function(dD){var dM=this.getTablePaneModel();
var dL=this.getTable().getTableColumnModel();
var dG=this.__uR.getContainerLocation().left;
var dK=dM.getColumnCount();
var dH=0;
var dF=0;
var dP=dG;

for(var dE=0;dE<dK;dE++){var dI=dM.getColumnAtX(dE);
var dN=dL.getColumnWidth(dI);

if(dD<dP+dN/2){break;
}dP+=dN;
dH=dE+1;
dF=dP-dG;
}var dJ=this.__uU.getContainerLocation().left;
var dO=this.__uU.getBounds().width;
var scrollX=dJ-dG;
dF=qx.lang.Number.limit(dF,scrollX+2,scrollX+dO-1);
this._showResizeLine(dF);
return dM.getFirstColumnX()+dH;
},hideColumnMoveFeedback:function(){this._hideResizeLine();
},_focusCellAtPagePos:function(cF,cG){var cI=this._getRowForPagePos(cF,cG);

if(cI!=-1&&cI!=null){var cH=this._getColumnForPageX(cF);
this.__uN.setFocusedCell(cH,cI);
}},setFocusedCell:function(bt,bu){if(!this.isEditing()){this.__uR.setFocusedCell(bt,bu,this.__va);
this.__vo=bt;
this.__vp=bu;
this._updateFocusIndicator();
}},getFocusedColumn:function(){return this.__vo;
},getFocusedRow:function(){return this.__vp;
},scrollCellVisible:function(V,W){var bh=this.getTablePaneModel();
var X=bh.getX(V);

if(X!=-1){var be=this.__uU.getInnerSize();

if(!be){return;
}var bf=this.getTable().getTableColumnModel();
var bb=bh.getColumnLeft(V);
var bi=bf.getColumnWidth(V);
var Y=this.getTable().getRowHeight();
var bj=W*Y;
var scrollX=this.getScrollX();
var scrollY=this.getScrollY();
var bg=Math.min(bb,bb+bi-be.width);
var bd=bb;
this.setScrollX(Math.max(bg,Math.min(bd,scrollX)));
var ba=bj+Y-be.height;

if(this.getTable().getKeepFirstVisibleRowComplete()){ba+=Y;
}var bc=bj;
this.setScrollY(Math.max(ba,Math.min(bc,scrollY)),true);
}},isEditing:function(){return this.__vq!=null;
},startEditing:function(){var bp=this.getTable();
var bn=bp.getTableModel();
var br=this.__vo;

if(!this.isEditing()&&(br!=null)&&bn.isColumnEditable(br)){var bs=this.__vp;
var bl=this.getTablePaneModel().getX(br);
var bm=bn.getValue(br,bs);
this.__vr=bp.getTableColumnModel().getCellEditorFactory(br);
var bo={col:br,row:bs,xPos:bl,value:bm,table:bp};
this.__vq=this.__vr.createCellEditor(bo);
if(this.__vq===null){return false;
}else if(this.__vq instanceof qx.ui.window.Window){this.__vq.setModal(true);
this.__vq.setShowClose(false);
this.__vq.addListener(ex,this._onCellEditorModalWindowClose,this);
var f=bp.getModalCellEditorPreOpenFunction();

if(f!=null){f(this.__vq,bo);
}this.__vq.open();
}else{var bq=this.__uV.getInnerSize();
this.__vq.setUserBounds(0,0,bq.width,bq.height);
this.__uV.addListener(dY,function(e){e.stopPropagation();
});
this.__uV.add(this.__vq);
this.__uV.addState(eV);
this.__uV.setKeepActive(false);
this.__vq.focus();
this.__vq.activate();
}return true;
}return false;
...
this.cancelEditing();
},flushEditor:function(){if(this.isEditing()){var cK=this.__vr.getCellEditorValue(this.__vq);
var cJ=this.getTable().getTableModel().getValue(this.__vo,this.__vp);
this.getTable().getTableModel().setValue(this.__vo,this.__vp,cK);
this.__uN.focus();
this.__uN.fireDataEvent(en,{row:this.__vp,col:this.__vo,oldValue:cJ,value:cK});
}},cancelEditing:function(){if(this.isEditing()&&!this.__vq.pendingDispose){if(this._cellEditorIsModalWindow){this.__vq.destroy();
this.__vq=null;
this.__vr=null;
this.__vq.pendingDispose=true;
}else{this.__uV.removeState(eV);
this.__uV.setKeepActive(true);
this.__vq.destroy();
this.__vq=null;
this.__vr=null;
}}},_onCellEditorModalWindowClose:function(e){this.stopEditing();
},_getColumnForPageX:function(fd){var fg=this.getTable().getTableColumnModel();
var fh=this.getTablePaneModel();
var ff=fh.getColumnCount();
var fj=this.__uQ.getContainerLocation().left;

for(var x=0;x<ff;x++){var fe=fh.getColumnAtX(x);
var fi=fg.getColumnWidth(fe);
fj+=fi;

if(fd<fj){return fe;
}}return null;
},_getResizeColumnForPageX:function(cn){var cr=this.getTable().getTableColumnModel();
var cs=this.getTablePaneModel();
var cq=cs.getColumnCount();
var cu=this.__uQ.getContainerLocation().left;
var co=qx.ui.table.pane.Scroller.RESIZE_REGION_RADIUS;

for(var x=0;x<cq;x++){var cp=cs.getColumnAtX(x);
var ct=cr.getColumnWidth(cp);
cu+=ct;

if(cn>=(cu-co)&&cn<=(cu+co)){return cp;
}}return -1;
},_getRowForPagePos:function(cQ,cR){var cS=this.__uR.getContentLocation();

if(cQ<cS.left||cQ>cS.right){return null;
}
if(cR>=cS.top&&cR<=cS.bottom){var cT=this.getTable().getRowHeight();
var scrollY=this.__uP.getPosition();

if(this.getTable().getKeepFirstVisibleRowComplete()){scrollY=Math.floor(scrollY/cT)*cT;
}var cW=scrollY+cR-cS.top;
var cY=Math.floor(cW/cT);
var cX=this.getTable().getTableModel();
var cU=cX.getRowCount();
return (cY<cU)?cY:null;
}var cV=this.__uQ.getContainerLocation();

if(cR>=cV.top&&cR<=cV.bottom&&cQ<=cV.right){return -1;
}return null;
},setTopRightWidget:function(ca){var cb=this.__vs;

if(cb!=null){this.__uS.remove(cb);
}
if(ca!=null){this.__uS.add(ca);
}this.__vs=ca;
},getTopRightWidget:function(){return this.__vs;
},getHeader:function(){return this.__uQ;
},getTablePane:function(){return this.__uR;
},getVerticalScrollBarWidth:function(){var bN=this.__uP;
return bN.isVisible()?(bN.getSizeHint().width||0):0;
},getNeededScrollBars:function(a,b){var j=this.__uP.getSizeHint().width;
var k=this.__uU.getInnerSize();
var c=k?k.width:0;
...
},_applyScrollTimeout:function(B,C){this._startInterval(B);
},_startInterval:function(fv){this.__uW.setInterval(fv);
this.__uW.start();
},_stopInterval:function(){this.__uW.stop();
},_postponedUpdateContent:function(){this._updateContent();
},_oninterval:qx.event.GlobalError.observeMethod(function(){if(this.__va&&!this.__uR._layoutPending){this.__va=false;
this._updateContent();
}}),_updateContent:function(){var N=this.__uU.getInnerSize();

if(!N){return;
}var Q=N.height;
var scrollX=this.__uO.getPosition();
var scrollY=this.__uP.getPosition();
var K=this.getTable().getRowHeight();
var L=Math.floor(scrollY/K);
var P=this.__uR.getFirstVisibleRow();
this.__uR.setFirstVisibleRow(L);
var M=Math.ceil(Q/K);
var J=0;
var O=this.getTable().getKeepFirstVisibleRowComplete();

if(!O){M++;
J=scrollY%K;
}this.__uR.setVisibleRowCount(M);

if(L!=P){this._updateFocusIndicator();
}this.__uU.scrollToX(scrollX);
if(!O){this.__uU.scrollToY(J);
}},_updateFocusIndicator:function(){if(!this.getShowCellFocusIndicator()){return;
}var bY=this.getTable();

if(!bY.getEnabled()){return;
}this.__uV.moveToCell(this.__vo,this.__vp);
}},destruct:function(){this._stopInterval();
var u=this.getTablePaneModel();

if(u){u.dispose();
}this.__vk=this.__vs=this.__uN=null;
this._disposeObjects(ez,eK,eN,ej,eq,em,eI,ev,eO);
}});
})();
...
},properties:{visibility:{refine:true,init:k},row:{check:o,nullable:true},column:{check:o,nullable:true}},members:{__vv:null,_onKeyPress:function(e){var p=e.getKeyIdentifier();

if(p!==n&&p!==l){e.stopPropagation();
}},moveToCell:function(a,b){if(a==null){this.hide();
this.setRow(null);
this.setColumn(null);
}else{var c=this.__vv.getTablePaneModel().getX(a);

if(c==-1){this.hide();
this.setRow(null);
this.setColumn(null);
}else{var i=this.__vv.getTable();
var g=i.getTableColumnModel();
var h=this.__vv.getTablePaneModel();
var f=this.__vv.getTablePane().getFirstVisibleRow();
...
(function(){var u="Boolean",t="mouseup",s="mousedown",r="losecapture",q="resizableBottom",p="mouseout",o="resizableRight",n="resizableLeft",m="mousemove",l="shorthand",i="resizableTop",k="Integer",j="qx.ui.core.MResizable";
qx.Mixin.define(j,{construct:function(){this.addListener(s,this.__U,this,true);
this.addListener(t,this.__V,this);
this.addListener(m,this.__X,this);
this.addListener(p,this.__Y,this);
this.addListener(r,this.__W,this);
},properties:{resizableTop:{check:u,init:true},resizableRight:{check:u,init:true},resizableBottom:{check:u,init:true},resizableLeft:{check:u,init:true},resizable:{group:[i,o,q,n],mode:l},resizeSensitivity:{check:k,init:5},useResizeFrame:{check:u,init:true}},members:{__K:null,__L:null,__M:null,__N:null,__O:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,__P:function(){var A=this.__K;

if(!A){A=this.__K=new qx.ui.core.Widget();
A.setAppearance("resize-frame");
A.exclude();
qx.core.Init.getApplication().getRoot().add(A);
}return A;
},__Q:function(){var b=this.__O;
var a=this.__P();
a.setUserBounds(b.left,b.top,b.width,b.height);
a.show();
a.setZIndex(this.getZIndex()+1);
},__R:function(e){var E=this.__L;
...
if((E&this.RESIZE_TOP)||(E&this.RESIZE_BOTTOM)){I=e.getDocumentTop()-this.__N;
...
if((E&this.RESIZE_LEFT)||(E&this.RESIZE_RIGHT)){I=e.getDocumentLeft()-this.__M;
...
},__S:{1:"n-resize",2:"s-resize",4:"w-resize",8:"e-resize",5:"nw-resize",6:"sw-resize",9:"ne-resize",10:"se-resize"},__T:function(e){var f=this.getContentLocation();
var c=this.getResizeSensitivity();
var h=e.getDocumentLeft();
var g=e.getDocumentTop();
var d=0;

if(this.getResizableTop()&&Math.abs(f.top-g)<c){d+=this.RESIZE_TOP;
}else if(this.getResizableBottom()&&Math.abs(f.bottom-g)<c){d+=this.RESIZE_BOTTOM;
}
if(this.getResizableLeft()&&Math.abs(f.left-h)<c){d+=this.RESIZE_LEFT;
}else if(this.getResizableRight()&&Math.abs(f.right-h)<c){d+=this.RESIZE_RIGHT;
}this.__L=d;
...
this.__O={top:location.top,left:location.left,width:C.width,height:C.height,bounds:qx.lang.Object.clone(C)};
...
if(this.getUseResizeFrame()){this.__P().exclude();
}},__X:function(e){if(this.hasState("resize")){var y=this.__R(e);
if(this.getUseResizeFrame()){var w=this.__P();
...
(function(){var l="move",k="Boolean",j="mouseup",i="mousedown",h="losecapture",g="qx.ui.core.MMovable",f="mousemove",d="maximized",c="__u",b="__t";
qx.Mixin.define(g,{properties:{movable:{check:k,init:true},useMoveFrame:{check:k,init:false}},members:{__t:null,__u:null,__v:null,__w:null,__x:null,__y:null,__z:null,__A:false,__B:null,__C:0,_activateMoveHandle:function(a){if(this.__t){throw new Error("The move handle could not be redefined!");
}this.__t=a;
a.addListener(i,this._onMoveMouseDown,this);
a.addListener(j,this._onMoveMouseUp,this);
a.addListener(f,this._onMoveMouseMove,this);
a.addListener(h,this.__G,this);
},__D:function(){var s=this.__u;

if(!s){s=this.__u=new qx.ui.core.Widget();
s.setAppearance("move-frame");
s.exclude();
...
}}this.__v={left:u.left,top:u.top,right:u.left+v.width,bottom:u.top+v.height};
var t=this.getContainerLocation();
this.__y=u.left;
this.__z=u.top;
this.__w=t.left-e.getDocumentLeft();
this.__x=t.top-e.getDocumentTop();
this.addState(l);
this.__t.capture();
...
if(this.getUseMoveFrame()){this.__D().setDomPosition(r.viewportLeft,r.viewportTop);
...
(function(){var e="qx.ui.window.IWindowManager";
qx.Interface.define(e,{members:{setDesktop:function(b){this.assertInterface(b,qx.ui.window.IDesktop);
...
(function(){var o="qx.ui.window.Manager",n="__J";
qx.Class.define(o,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__J:null,setDesktop:function(f){this.__J=f;
this.updateStack();
...
c.setZIndex(e);
if(c.getModal()){this.__J.blockContent(e-1);
}d=d||c.isActive();
a=c;
}
if(!d){this.__J.setActiveWindow(a);
}},bringToFront:function(p){var q=this.__J.getWindows();
var r=qx.lang.Array.remove(q,p);

if(r){q.push(p);
this.updateStack();
}},sendToBack:function(g){var h=this.__J.getWindows();
...
this.initVisibility();
qx.ui.core.FocusHandler.getInstance().addRoot(this);
},statics:{DEFAULT_MANAGER_CLASS:qx.ui.window.Manager},events:{"beforeClose":j,"close":j,"beforeMinimize":j,"minimize":j,"beforeMaximize":j,"maximize":j,"beforeRestore":j,"restore":j},properties:{appearance:{refine:true,init:F},visibility:{refine:true,init:q},focusable:{refine:true,init:true},active:{check:k,init:false,apply:o,event:x},modal:{check:k,init:false,event:u},caption:{apply:n,event:B,nullable:true},icon:{check:L,nullable:true,apply:E,event:p,themeable:true},status:{check:L,nullable:true,apply:z,event:s},showClose:{check:k,init:true,apply:g,themeable:true},showMaximize:{check:k,init:true,apply:g,themeable:true},showMinimize:{check:k,init:true,apply:g,themeable:true},allowClose:{check:k,init:true,apply:g},allowMaximize:{check:k,init:true,apply:g},allowMinimize:{check:k,init:true,apply:g},showStatusbar:{check:k,init:false,apply:A}},members:{__H:null,__I:null,getChildrenContainer:function(){return this.getChildControl(R);
},_forwardStates:{active:true,maximized:true},setLayoutParent:function(parent){{};
arguments.callee.base.call(this,parent);
},_createChildControlImpl:function(br){var bs;

switch(br){case N:bs=new qx.ui.container.Composite(new qx.ui.layout.HBox());
this._add(bs);
bs.add(this.getChildControl(O));
break;
case O:bs=new qx.ui.basic.Label();
bs.setValue(this.getStatus());
break;
case R:bs=new qx.ui.container.Composite();
this._add(bs,{flex:1});
break;
case i:var bu=new qx.ui.layout.Grid();
bu.setRowFlex(0,1);
bu.setColumnFlex(1,1);
bs=new qx.ui.container.Composite(bu);
this._add(bs);
bs.addListener(t,this._onCaptionMouseDblClick,this);
this._activateMoveHandle(bs);
break;
case P:bs=new qx.ui.basic.Image(this.getIcon());
this.getChildControl(i).add(bs,{row:0,column:0});
break;
case Q:bs=new qx.ui.basic.Label(this.getCaption());
bs.setWidth(0);
bs.setAllowGrowX(true);
var bt=this.getChildControl(i);
bt.add(bs,{row:0,column:1});
break;
case d:bs=new qx.ui.form.Button();
bs.setFocusable(false);
bs.addListener(a,this._onMinimizeButtonClick,this);
this.getChildControl(i).add(bs,{row:0,column:2});
break;
case f:bs=new qx.ui.form.Button();
bs.setFocusable(false);
bs.addListener(a,this._onRestoreButtonClick,this);
this.getChildControl(i).add(bs,{row:0,column:3});
break;
case h:bs=new qx.ui.form.Button();
bs.setFocusable(false);
bs.addListener(a,this._onMaximizeButtonClick,this);
this.getChildControl(i).add(bs,{row:0,column:4});
break;
case c:bs=new qx.ui.form.Button();
bs.setFocusable(false);
bs.addListener(a,this._onCloseButtonClick,this);
this.getChildControl(i).add(bs,{row:0,column:6});
break;
}return bs||arguments.callee.base.call(this,br);
...
}var bd=this.getLayoutProperties();
this.__I=bd.left===undefined?0:bd.left;
this.__H=bd.top===undefined?0:bd.top;
...
if(this.fireNonBubblingEvent(I,qx.event.type.Event,[false,true])){var V=this.getLayoutProperties();
this.__I=V.left===undefined?0:V.left;
this.__H=V.top===undefined?0:V.top;
this.removeState(b);
this.hide();
this.fireEvent(m);
...
}}},_applyActive:function(bm,bn){if(bn){this.removeState(K);
}else{this.addState(K);
}},_getContentPaddingTarget:function(){return this.getChildControl(R);
},_applyShowStatusbar:function(bk,bl){if(bk){this._showChildControl(N);
}else{this._excludeChildControl(N);
}},_applyCaptionBarChange:function(X,Y){this._updateCaptionBar();
},_applyStatus:function(bo,bp){var bq=this.getChildControl(O,true);

if(bq){bq.setValue(bo);
}},_applyCaption:function(T,U){this.getChildControl(Q).setValue(T);
},_applyIcon:function(bh,bi){this.getChildControl(P).setSource(bh);
},_onWindowEventStop:function(e){e.stopPropagation();
},_onWindowMouseDown:function(e){this.setActive(true);
},_onWindowFocusOut:function(e){if(this.getModal()){return;
}var S=e.getRelatedTarget();

if(S!=null&&!qx.ui.core.Widget.contains(this,S)){this.setActive(false);
...
qx.Class.define(j,{extend:qx.core.Object,construct:function(o){arguments.callee.base.call(this);
o.addListener(h,this._onColVisibilityChanged,this);
this.__vw=o;
},events:{"modelChanged":m},statics:{EVENT_TYPE_MODEL_CHANGED:"modelChanged"},properties:{firstColumnX:{check:k,init:0,apply:l},maxColumnCount:{check:n,init:-1,apply:i}},members:{__vx:null,__vw:null,_applyFirstColumnX:function(f,g){this.__vx=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},_applyMaxColumnCount:function(a,b){this.__vx=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},setTableColumnModel:function(p){this.__vw=p;
this.__vx=null;
},_onColVisibilityChanged:function(A){this.__vx=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},getColumnCount:function(){if(this.__vx==null){var c=this.getFirstColumnX();
var e=this.getMaxColumnCount();
var d=this.__vw.getVisibleColumnCount();

if(e==-1||(c+e)>d){this.__vx=d-c;
}else{this.__vx=e;
}}return this.__vx;
},getColumnAtX:function(u){var v=this.getFirstColumnX();
return this.__vw.getVisibleColumnAtX(v+u);
},getX:function(B){var C=this.getFirstColumnX();
var D=this.getMaxColumnCount();
var x=this.__vw.getVisibleX(B)-C;
...
(function(){var t="metaDataChanged",s="qx.event.type.Data",r="qx.event.type.Event",q="abstract",p="qx.ui.table.model.Abstract";
qx.Class.define(p,{type:q,extend:qx.core.Object,implement:qx.ui.table.ITableModel,events:{"dataChanged":s,"metaDataChanged":r,"sorted":s},construct:function(){arguments.callee.base.call(this);
this.__tJ=[];
this.__tK=[];
this.__tL={};
},members:{__tJ:null,__tK:null,__tL:null,__tM:null,getRowCount:function(){throw new Error("getRowCount is abstract");
...
},prefetchRows:function(e,f){},getValue:function(k,l){throw new Error("getValue is abstract");
...
},setValueById:function(w,x,y){this.setValue(this.getColumnIndexById(w),x,y);
},getColumnCount:function(){return this.__tJ.length;
},getColumnIndexById:function(u){return this.__tL[u];
},getColumnId:function(v){return this.__tJ[v];
},getColumnName:function(z){return this.__tK[z];
},setColumnIds:function(d){this.__tJ=d;
this.__tL={};

for(var i=0;i<d.length;i++){this.__tL[d[i]]=i;
}this.__tK=new Array(d.length);
if(!this.__tM){this.fireEvent(t);
}},setColumnNamesByIndex:function(j){if(this.__tJ.length!=j.length){throw new Error("this.__columnIdArr and columnNameArr have different length: "+this.__tJ.length+" != "+j.length);
}this.__tK=j;
this.fireEvent(t);
},setColumnNamesById:function(h){this.__tK=new Array(this.__tJ.length);

for(var i=0;i<this.__tJ.length;++i){this.__tK[i]=h[this.__tJ[i]];
}},setColumns:function(A,B){var C=this.__tJ.length==0||B;

if(B==null){if(this.__tJ.length==0){B=A;
}else{B=this.__tJ;
}}
...
}},destruct:function(){this.__tJ=this.__tK=this.__tL=null;
}});
})();
(function(){var e="dataChanged",d="metaDataChanged",c="qx.ui.table.model.Simple",b="Boolean",a="sorted";
qx.Class.define(c,{extend:qx.ui.table.model.Abstract,construct:function(){arguments.callee.base.call(this);
this.__tN=[];
this.__tO=-1;
this.__tP=[];
this.__tQ=null;
},properties:{caseSensitiveSorting:{check:b,init:true}},statics:{_defaultSortComparatorAscending:function(bs,bt){var bu=bs[arguments.callee.columnIndex];
var bv=bt[arguments.callee.columnIndex];
return (bu>bv)?1:((bu==bv)?0:-1);
},_defaultSortComparatorInsensitiveAscending:function(V,W){var X=(isNaN(V[arguments.callee.columnIndex])?V[arguments.callee.columnIndex].toLowerCase():V[arguments.callee.columnIndex]);
var Y=(isNaN(W[arguments.callee.columnIndex])?W[arguments.callee.columnIndex].toLowerCase():W[arguments.callee.columnIndex]);
...
},_defaultSortComparatorInsensitiveDescending:function(bm,bn){var bo=(isNaN(bm[arguments.callee.columnIndex])?bm[arguments.callee.columnIndex].toLowerCase():bm[arguments.callee.columnIndex]);
var bp=(isNaN(bn[arguments.callee.columnIndex])?bn[arguments.callee.columnIndex].toLowerCase():bn[arguments.callee.columnIndex]);
return (bo<bp)?1:((bo==bp)?0:-1);
}},members:{__tN:null,__tQ:null,__tR:null,__tP:null,__tO:null,__tS:null,getRowData:function(R){var S=this.__tN[R];

if(S==null||S.originalData==null){return S;
}else{return S.originalData;
}},getRowDataAsMap:function(J){var L=this.__tN[J];
var K={};

for(var M=0;M<this.getColumnCount();M++){K[this.getColumnId(M)]=L[M];
}return K;
},getDataAsMapArray:function(){var br=this.getRowCount();
var bq=[];

for(var i=0;i<br;i++){bq.push(this.getRowDataAsMap(i));
}return bq;
},setEditable:function(f){this.__tQ=[];

for(var g=0;g<this.getColumnCount();g++){this.__tQ[g]=f;
}this.fireEvent(d);
},setColumnEditable:function(T,U){if(U!=this.isColumnEditable(T)){if(this.__tQ==null){this.__tQ=[];
}this.__tQ[T]=U;
this.fireEvent(d);
}},isColumnEditable:function(t){return this.__tQ?(this.__tQ[t]==true):false;
},setColumnSortable:function(bc,bd){if(bd!=this.isColumnSortable(bc)){if(this.__tR==null){this.__tR=[];
}this.__tR[bc]=bd;
this.fireEvent(d);
}},isColumnSortable:function(bG){return (this.__tR?(this.__tR[bG]!==false):true);
...
if(qx.lang.Type.isFunction(bk)){bl={ascending:bk,descending:function(ba,bb){return bk(bb,ba);
}};
}else{bl=bk;
}this.__tP[bj]=bl;
},getSortMethods:function(by){return this.__tP[by];
},clearSorting:function(){if(this.__tO!=-1){this.__tO=-1;
this.__tS=true;
this.fireEvent(d);
}},getSortColumnIndex:function(){return this.__tO;
},isSortAscending:function(){return this.__tS;
},getRowCount:function(){return this.__tN.length;
},getValue:function(bw,bx){if(bx<0||bx>=this.__tN.length){throw new Error("this.__rowArr out of bounds: "+bx+" (0.."+this.__tN.length+")");
}return this.__tN[bx][bw];
},setValue:function(bH,bI,bJ){if(this.__tN[bI][bH]!=bJ){this.__tN[bI][bH]=bJ;
if(this.hasListener(e)){var bK={firstRow:bI,lastRow:bI,firstColumn:bH,lastColumn:bH};
this.fireDataEvent(e,bK);
}
if(bH==this.__tO){this.clearSorting();
}}},setData:function(bz,bA){this.__tN=bz;
if(this.hasListener(e)){var bB={firstRow:0,lastRow:bz.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
this.fireDataEvent(e,bB);
}
if(bA!==false){this.clearSorting();
}},getData:function(){return this.__tN;
},setDataAsMapArray:function(G,H,I){this.setData(this._mapArray2RowArr(G,H),I);
},addRows:function(N,O,P){if(O==null){O=this.__tN.length;
}N.splice(0,0,O,0);
Array.prototype.splice.apply(this.__tN,N);
var Q={firstRow:O,lastRow:this.__tN.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
...
},setRows:function(h,k,l){if(k==null){k=0;
}h.splice(0,0,k,h.length);
Array.prototype.splice.apply(this.__tN,h);
var m={firstRow:k,lastRow:this.__tN.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
...
},removeRows:function(C,D,E){this.__tN.splice(C,D);
var F={firstRow:C,lastRow:this.__tN.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1,removeStart:C,removeCount:D};
this.fireDataEvent(e,F);

if(E!==false){this.clearSorting();
}},_mapArray2RowArr:function(n,o){var s=n.length;
...
if(o){q.originalData=n[i];
}
for(var j=0;j<p;++j){q[j]=n[i][this.getColumnId(j)];
}r[i]=q;
}return r;
}},destruct:function(){this.__tN=this.__tQ=this.__tP=this.__tR=null;
}});
})();
(function(){var bz="",by="!",bx="'!",bw="'",bv="Expected '",bu="' (rgb(",bt=",",bs=")), but found value '",br="Event (",bq="Expected value to be the CSS color '",cF="' but found ",cE="The value '",cD="qx.core.Object",cC="Expected value to be an array but found ",cB=") was fired.",cA="Expected value to be an integer >= 0 but found ",cz="' to be not equal with '",cy="' to '",cx="qx.ui.core.Widget",cw="Called assertTrue with '",bG="Expected value to be a map but found ",bH="The function did not raise an exception!",bE="Expected value to be undefined but found ",bF="Expected value to be a DOM element but found  '",bC="Expected value to be a regular expression but found ",bD="' to implement the interface '",bA="Expected value to be null but found ",bB="Invalid argument 'type'",bO="Called assert with 'false'",bP="Assertion error! ",cc="Expected value to be a string but found ",bX="null",ck="' but found '",cf="' must must be a key of the map '",cs="The String '",cp="Expected value not to be undefined but found ",bT="qx.util.ColorUtil",cv=": ",cu="The raised exception does not have the expected type! ",ct=") not fired.",bS="qx.core.Assert",bV="Expected value to be typeof object but found ",bW="' (identical) but found '",ca="' must have any of the values defined in the array '",cd="Expected value to be a number but found ",cg="Called assertFalse with '",cm="]",cr="Expected value to be a qooxdoo object but found ",bI="' arguments.",bJ="Expected value not to be null but found ",bU="Array[",cj="' does not match the regular expression '",ci="' to be not identical with '",ch="' arguments but found '",co="', which cannot be converted to a CSS color!",cn="Expected object '",ce="qx.core.AssertionError",cl="Expected value to be a boolean but found ",bn="))!",cq="Expected value to be a qooxdoo widget but found ",bK="Expected value '%1' to be in the range '%2'..'%3'!",bL="Expected value to be typeof '",bY="Expected value to be typeof function but found ",bo="Expected value to be an integer but found ",bp="Called fail().",bR="The parameter 're' must be a string or a regular expression.",bM="Expected value to be a number >= 0 but found ",bN="Expected value to be instanceof '",bQ="Wrong number of arguments given. Expected '",cb="object";
qx.Bootstrap.define(bS,{statics:{__pQ:true,__pR:function(cV,cW){var cX=bz;

for(var i=1,l=arguments.length;i<l;i++){cX=cX+this.__pS(arguments[i]);
}var da=bP+cV+cv+cX;

if(this.__pQ){qx.log.Logger.error(da);
}
if(qx.Class.isDefined(ce)){var cY=new qx.core.AssertionError(cV,cX);

if(this.__pQ){qx.log.Logger.error("Stack trace: \n"+cY.getStackTrace());
}throw cY;
}else{throw new Error(da);
}},__pS:function(W){var X;

if(W===null){X=bX;
}else if(qx.lang.Type.isArray(W)&&W.length>10){X=bU+W.length+cm;
}else if((W instanceof Object)&&(W.toString==null)){X=qx.util.Json.stringify(W);
}else{try{X=W.toString();
}catch(e){X=bz;
}}return X;
},assert:function(dq,dr){dq==true||this.__pR(dr||bz,bO);
},fail:function(dP){this.__pR(dP||bz,bp);
},assertTrue:function(dl,dm){(dl===true)||this.__pR(dm||bz,cw,dl,bw);
},assertFalse:function(ba,bb){(ba===false)||this.__pR(bb||bz,cg,ba,bw);
},assertEquals:function(dy,dz,dA){dy==dz||this.__pR(dA||bz,bv,dy,ck,dz,bx);
},assertNotEquals:function(T,U,V){T!=U||this.__pR(V||bz,bv,T,cz,U,bx);
},assertIdentical:function(dU,dV,dW){dU===dV||this.__pR(dW||bz,bv,dU,bW,dV,bx);
},assertNotIdentical:function(dK,dL,dM){dK!==dL||this.__pR(dM||bz,bv,dK,ci,dL,bx);
},assertNotUndefined:function(ds,dt){ds!==undefined||this.__pR(dt||bz,cp,ds,by);
},assertUndefined:function(dw,dx){dw===undefined||this.__pR(dx||bz,bE,dw,by);
},assertNotNull:function(cG,cH){cG!==null||this.__pR(cH||bz,bJ,cG,by);
},assertNull:function(dn,dp){dn===null||this.__pR(dp||bz,bA,dn,by);
},assertJsonEquals:function(db,dc,dd){this.assertEquals(qx.util.Json.stringify(db),qx.util.Json.stringify(dc),dd);
},assertMatch:function(Q,R,S){this.assertString(Q);
this.assert(qx.lang.Type.isRegExp(R)||qx.lang.Type.isString(R),bR);
Q.search(R)>=0||this.__pR(S||bz,cs,Q,cj,R.toString(),bx);
},assertArgumentsCount:function(z,A,B,C){var D=z.length;
(D>=A&&D<=B)||this.__pR(C||bz,bQ,A,cy,B,ch,arguments.length,bI);
},assertEventFired:function(p,event,q,r,s){var u=false;
var t=function(e){if(r){r.call(p,e);
}u=true;
};
var v=p.addListener(event,t,p);
q.call();
u===true||this.__pR(s||bz,br,event,ct);
p.removeListenerById(v);
},assertEventNotFired:function(h,event,j,k){var n=false;
var m=function(e){n=true;
};
var o=h.addListener(event,m,h);
j.call();
n===false||this.__pR(k||bz,br,event,cB);
h.removeListenerById(o);
...
if(dF==null){this.__pR(dE||bz,bH);
}dF instanceof dC||this.__pR(dE||bz,cu,dC);

if(dD){this.assertMatch(dF.toString(),dD,dE);
}},assertInArray:function(E,F,G){F.indexOf(E)!==-1||this.__pR(G||bz,cE,E,ca,F,bw);
},assertArrayEquals:function(d,f,g){this.assertArray(d,g);
this.assertArray(f,g);
this.assertEquals(d.length,f.length,g);

for(var i=0;i<d.length;i++){this.assertIdentical(d[i],f[i],g);
}},assertKeyInMap:function(a,b,c){b[a]!==undefined||this.__pR(c||bz,cE,a,cf,b,bw);
},assertFunction:function(cP,cQ){qx.lang.Type.isFunction(cP)||this.__pR(cQ||bz,bY,cP,by);
},assertString:function(cL,cM){qx.lang.Type.isString(cL)||this.__pR(cM||bz,cc,cL,by);
},assertBoolean:function(dN,dO){qx.lang.Type.isBoolean(dN)||this.__pR(dO||bz,cl,dN,by);
},assertNumber:function(cJ,cK){(qx.lang.Type.isNumber(cJ)&&isFinite(cJ))||this.__pR(cK||bz,cd,cJ,by);
},assertPositiveNumber:function(du,dv){(qx.lang.Type.isNumber(du)&&isFinite(du)&&du>=0)||this.__pR(dv||bz,bM,du,by);
},assertInteger:function(cN,cO){(qx.lang.Type.isNumber(cN)&&isFinite(cN)&&cN%1===0)||this.__pR(cO||bz,bo,cN,by);
},assertPositiveInteger:function(bk,bl){var bm=(qx.lang.Type.isNumber(bk)&&isFinite(bk)&&bk%1===0&&bk>=0);
bm||this.__pR(bl||bz,cA,bk,by);
},assertInRange:function(K,L,M,N){(K>=L&&K<=M)||this.__pR(N||bz,qx.lang.String.format(bK,[K,L,M]));
},assertObject:function(H,I){var J=H!==null&&(qx.lang.Type.isObject(H)||typeof H===cb);
J||this.__pR(I||bz,bV,(H),by);
},assertArray:function(cR,cS){qx.lang.Type.isArray(cR)||this.__pR(cS||bz,cC,cR,by);
},assertMap:function(O,P){qx.lang.Type.isObject(O)||this.__pR(P||bz,bG,O,by);
},assertRegExp:function(dI,dJ){qx.lang.Type.isRegExp(dI)||this.__pR(dJ||bz,bC,dI,by);
},assertType:function(bc,bd,be){this.assertString(bd,bB);
typeof (bc)===bd||this.__pR(be||bz,bL,bd,cF,bc,by);
},assertInstance:function(dQ,dR,dS){var dT=dR.classname||dR+bz;
dQ instanceof dR||this.__pR(dS||bz,bN,dT,cF,dQ,by);
},assertInterface:function(w,x,y){qx.Class.implementsInterface(w,x)||this.__pR(y||bz,cn,w,bD,x,bx);
},assertCssColor:function(de,df,dg){var dh=qx.Class.getByName(bT);

if(!dh){throw new Error("qx.util.ColorUtil not available! Your code must have a dependency on 'qx.util.ColorUtil'");
}var dj=dh.stringToRgb(de);

try{var di=dh.stringToRgb(df);
}catch(cI){this.__pR(dg||bz,bq,de,bu,dj.join(bt),bs,df,co);
}var dk=dj[0]==di[0]&&dj[1]==di[1]&&dj[2]==di[2];
dk||this.__pR(dg||bz,bq,dj,bu,dj.join(bt),bs,df,bu,di.join(bt),bn);
},assertElement:function(cT,cU){!!(cT&&cT.nodeType===1)||this.__pR(cU||bz,bF,cT,bx);
},assertQxObject:function(dG,dH){this.__pT(dG,cD)||this.__pR(dH||bz,cr,dG,by);
},assertQxWidget:function(bi,bj){this.__pT(bi,cx)||this.__pR(bj||bz,cq,bi,by);
},__pT:function(bf,bg){if(!bf){return false;
}var bh=bf.constructor;

while(bh){if(bh.classname===bg){return true;
}bh=bh.superclass;
}return false;
}}});
})();
(function(){var G=",",F="",E="string",D="null",C='"',B="qx.jsonDebugging",A='\\u00',z="new Date(Date.UTC(",y='\\\\',x="__mh",bd='\\f',bc='\\"',bb="))",ba="}",Y='(',X=":",W="{",V='\\r',U="__lX",T='\\t',N="__mi",O="]",L="[",M="Use 'parse' instead!",J="qx.jsonEncodeUndefined",K='\\b',H="qx.util.Json",I=')',P="__lW",Q="__ma",S='\\n',R="__lY";
qx.Class.define(H,{statics:{__lU:null,BEAUTIFYING_INDENT:"  ",BEAUTIFYING_LINE_END:"\n",__lV:{"function":P,"boolean":U,"number":R,"string":Q,"object":x,"undefined":N},__lW:function(bv,bw){return String(bv);
},__lX:function(c,d){return String(c);
},__lY:function(bz,bA){return isFinite(bz)?String(bz):D;
},__ma:function(be,bf){var bg;

if(/["\\\x00-\x1f]/.test(be)){bg=be.replace(/([\x00-\x1f\\"])/g,qx.util.Json.__mc);
}else{bg=be;
}return C+bg+C;
},__mb:{'\b':K,'\t':T,'\n':S,'\f':bd,'\r':V,'"':bc,'\\':y},__mc:function(a,b){var p=qx.util.Json.__mb[b];

if(p){return p;
}p=b.charCodeAt();
return A+Math.floor(p/16).toString(16)+(p%16).toString(16);
},__md:function(q,r){var t=[],w=true,v,s;
var u=qx.util.Json.__mk;
t.push(L);

if(u){qx.util.Json.__me+=qx.util.Json.BEAUTIFYING_INDENT;
t.push(qx.util.Json.__me);
}
for(var i=0,l=q.length;i<l;i++){s=q[i];
v=this.__lV[typeof s];

if(v){s=this[v](s,i+F);

if(typeof s==E){if(!w){t.push(G);

if(u){t.push(qx.util.Json.__me);
}}t.push(s);
w=false;
}}}
if(u){qx.util.Json.__me=qx.util.Json.__me.substring(0,qx.util.Json.__me.length-qx.util.Json.BEAUTIFYING_INDENT.length);
t.push(qx.util.Json.__me);
}t.push(O);
return t.join(F);
},__mf:function(bn,bo){var bp=bn.getUTCFullYear()+G+bn.getUTCMonth()+G+bn.getUTCDate()+G+bn.getUTCHours()+G+bn.getUTCMinutes()+G+bn.getUTCSeconds()+G+bn.getUTCMilliseconds();
return z+bp+bb;
},__mg:function(g,h){var m=[],o=true,k,j;
var n=qx.util.Json.__mk;
m.push(W);

if(n){qx.util.Json.__me+=qx.util.Json.BEAUTIFYING_INDENT;
m.push(qx.util.Json.__me);
}
for(var h in g){j=g[h];
k=this.__lV[typeof j];

if(k){j=this[k](j,h);

if(typeof j==E){if(!o){m.push(G);

if(n){m.push(qx.util.Json.__me);
}}m.push(this.__ma(h),X,j);
o=false;
}}}
if(n){qx.util.Json.__me=qx.util.Json.__me.substring(0,qx.util.Json.__me.length-qx.util.Json.BEAUTIFYING_INDENT.length);
m.push(qx.util.Json.__me);
}m.push(ba);
return m.join(F);
},__mh:function(bt,bu){if(bt){if(qx.lang.Type.isFunction(bt.toJSON)&&bt.toJSON!==this.__lU){return this.__mj(bt.toJSON(bu),bu);
}else if(qx.lang.Type.isDate(bt)){return this.__mf(bt,bu);
}else if(qx.lang.Type.isArray(bt)){return this.__md(bt,bu);
}else if(qx.lang.Type.isObject(bt)){return this.__mg(bt,bu);
}return F;
}return D;
},__mi:function(bx,by){if(qx.core.Setting.get(J)){return D;
}},__mj:function(e,f){return this[this.__lV[typeof e]](e,f);
},stringify:function(bj,bk){this.__mk=bk;
this.__me=this.BEAUTIFYING_LINE_END;
var bl=this.__mj(bj,F);

if(typeof bl!=E){bl=null;
}if(qx.core.Setting.get(B)){qx.log.Logger.debug(this,"JSON request: "+bl);
}return bl;
},parse:function(bq,br){if(br===undefined){br=true;
}
if(qx.core.Setting.get(B)){qx.log.Logger.debug(this,"JSON response: "+bq);
}
if(br){if(/[^,:{}\[\]0-9.\-+Eaeflnr-u \n\r\t]/.test(bq.replace(/"(\\.|[^"\\])*"/g,F))){throw new Error("Could not parse JSON string!");
}}
try{var bs=(bq&&bq.length>0)?eval(Y+bq+I):null;
return bs;
}catch(bh){throw new Error("Could not evaluate JSON string: "+bh.message);
}},parseQx:function(bi){qx.log.Logger.deprecatedMethodWarning(arguments.callee,M);
return qx.util.Json.parse(bi,false);
}},settings:{"qx.jsonEncodeUndefined":true,"qx.jsonDebugging":false},defer:function(bm){bm.__lU=Date.prototype.toJSON;
}});
})();
(function(){var bk="number",bj="dataChanged",bi="object",bh="treeOpenWhileEmpty",bg="treeOpenWithContent",bf="bSelected",be="qx.ui.treevirtual.SimpleTreeDataModel",bd="bOpened",bc="treeClose",bb="<virtual root>";
...
this._treeColumn=0;
this._selections={};
this._nodeArr.push(arguments.callee.self.__Ke());
this.__Kd=null;
},statics:{__Ke:function(){return {label:bb,nodeId:0,bOpened:true,children:[]};
},Type:{LEAF:1,BRANCH:2}},members:{__Kf:null,__Kd:null,_rowArr:null,_nodeArr:null,_nodeRowMap:null,_treeColumn:null,_selections:null,setTree:function(f){this.__Kf=f;
},getTree:function(){return this.__Kf;
},setEditable:function(bl){this.__Kd=[];

for(var bm=0;bm<this.getColumnCount();bm++){this.__Kd[bm]=bl;
}this.fireEvent(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED);
},setColumnEditable:function(h,k){if(k!=this.isColumnEditable(h)){if(this.__Kd==null){this.__Kd=[];
}this.__Kd[h]=k;
this.fireEvent(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED);
}},isColumnEditable:function(g){return (this.__Kd?this.__Kd[g]==true:false);
},isColumnSortable:function(V){return false;
},sortByColumn:function(P,Q){throw new Error("Trees can not be sorted by column");
},getSortColumnIndex:function(){return -1;
},setTreeColumn:function(bP){this._treeColumn=bP;
},getTreeColumn:function(){return this._treeColumn;
},getRowCount:function(){return this._rowArr.length;
},getRowData:function(z){return this._rowArr[z];
},getValue:function(bK,bL){if(bL<0||bL>=this._rowArr.length){throw new Error("this._rowArr row "+"("+bL+") out of bounds: "+this._rowArr+" (0.."+(this._rowArr.length-1)+")");
}
if(bK<0||bK>=this._rowArr[bL].length){throw new Error("this._rowArr column "+"("+bK+") out of bounds: "+this._rowArr[bL]+" (0.."+(this._rowArr[bL].length-1)+")");
}return this._rowArr[bL][bK];
},setValue:function(bE,bF,bG){if(bE==this._treeColumn){return ;
}var bH=this.getNodeFromRow(bF);

if(bH.columnData[bE]!=bG){bH.columnData[bE]=bG;
this.setData();
if(this.hasListener(bj)){var bI={firstRow:bH.nodeId,lastRow:bH.nodeId,firstColumn:bE,lastColumn:bE};
this.fireDataEvent(bj,bI);
}}},_addNode:function(B,C,D,E,F,G,H){var K;
if(B){K=this._nodeArr[B];

if(!K){throw new Error("Request to add a child to a non-existent parent");
}if(K.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF){throw new Error("Sorry, a LEAF may not have children.");
}}else{K=this._nodeArr[0];
B=0;
}if(F==qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF){D=false;
E=false;
}var J=this._nodeArr.length;
var I={type:F,nodeId:J,parentNodeId:B,label:C,bSelected:false,bOpened:D,bHideOpenClose:E,icon:G,iconSelected:H,children:[],columnData:[]};
this._nodeArr.push(I);
K.children.push(J);
return J;
},addBranch:function(t,u,v,w,x,y){return this._addNode(t,u,v,w,qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH,x,y);
},addLeaf:function(W,X,Y,ba){return this._addNode(W,X,false,false,qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF,Y,ba);
},prune:function(R,S){var T;
var U;

if(typeof (R)==bi){T=R;
U=T.nodeId;
}else if(typeof (R)==bk){U=R;
}else{throw new Error("Expected node object or node id");
...
}},move:function(bx,by){var bD;
var bz;
var bC;
var bA;
by=by||0;

if(typeof (bx)==bi){bD=bx;
bz=bD.nodeId;
}else if(typeof (bx)==bk){bz=bx;
bD=this._nodeArr[bz];
}else{throw new Error("Expected move node object or node id");
}
if(typeof (by)==bi){bC=by;
bA=bC.nodeId;
}else if(typeof (by)==bk){bA=by;
bC=this._nodeArr[bA];
}else{throw new Error("Expected parent node object or node id");
}if(bC.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF){throw new Error("Sorry, a LEAF may not have children.");
}var bB=this._nodeArr[bD.parentNodeId];
qx.lang.Array.remove(bB.children,bz);
bC.children.push(bz);
this._nodeArr[bz].parentNodeId=bA;
},setData:function(c){var e=this;
function d(){var M=function(l,m){var q=null;
var p;
var n=e._nodeArr[l].children.length;

for(var i=0;i<n;i++){p=e._nodeArr[l].children[i];
q=e._nodeArr[p];
if(q==null){continue;
}q.level=m;
q.bFirstChild=(i==0);
q.lastChild=[i==n-1];
var parent=e._nodeArr[q.parentNodeId];
while(parent.nodeId){var r=parent.lastChild[parent.lastChild.length-1];
q.lastChild.unshift(r);
parent=e._nodeArr[parent.parentNodeId];
}if(!q.columnData){q.columnData=[];
}
if(q.columnData.length<e.getColumnCount()){q.columnData[e.getColumnCount()-1]=null;
}var o=[];
if(q.columnData){for(var j=0;j<q.columnData.length;j++){if(j==e._treeColumn){o.push(q);
}else{o.push(q.columnData[j]);
}}}else{o.push(q);
}if(q.bSelected){o.selected=true;
}e._nodeRowMap[q.nodeId]=e._rowArr.length;
e._rowArr.push(o);
if(q.bOpened){M(p,m+1);
}}};
e._rowArr=[];
e._nodeRowMap=[];
M(0,1);
if(e.hasListener(bj)){var L={firstRow:0,lastRow:e._rowArr.length-1,firstColumn:0,lastColumn:e.getColumnCount()-1};
e.fireDataEvent(bj,L);
}}
...
this.setData([arguments.callee.self.__Ke()]);
},setColumnData:function(bM,bN,bO){this._nodeArr[bM].columnData[bN]=bO;
},getColumnData:function(a,b){return this._nodeArr[a].columnData[b];
},setState:function(bn,bo){var bp;
var bu;

if(typeof (bn)==bi){bp=bn;
bu=bp.nodeId;
}else if(typeof (bn)==bk){bu=bn;
bp=this._nodeArr[bu];
}else{throw new Error("Expected node object or node id");
}
for(var bs in bo){switch(bs){case bf:var bv=this.getRowFromNodeId(bu);
var bq=this.getTree().getSelectionModel();
var br=qx.ui.treevirtual.TreeVirtual;
var bw=(typeof (bv)===bk&&this.getTree().getSelectionMode()!=br.SelectionMode.NONE);
if(bo[bs]){this._selections[bu]=true;
if(bw&&!bq.isSelectedIndex(bv)){bq.setSelectionInterval(bv,bv);
}}else{delete this._selections[bu];
if(bw&&bq.isSelectedIndex(bv)){bq.removeSelectionInterval(bv,bv);
}}break;
case bd:if(bo[bs]==bp.bOpened){break;
}var bt=this.__Kf;
if(bp.bOpened){bt.fireDataEvent(bc,bp);
}else{if(bp.children.length>0){bt.fireDataEvent(bg,bp);
}else{bt.fireDataEvent(bh,bp);
}}if(!bp.bHideOpenClose){bp.bOpened=!bp.bOpened;
bt.getSelectionModel()._clearSelection();
}this.setData();
break;
default:break;
}bp[bs]=bo[bs];
...
},getNodeFromRow:function(A){return this._nodeArr[this._rowArr[A][this._treeColumn].nodeId];
},_clearSelections:function(){for(var bJ in this._selections){this._nodeArr[bJ].bSelected=false;
}this._selections={};
},getSelectedNodes:function(){var N=[];

for(var O in this._selections){N.push(this._nodeArr[O]);
}return N;
}},destruct:function(){this._rowArr=this._nodeArr=this._nodeRowMap=this._selections=this.__Kf=null;
}});
})();
...
(function(){var u='px;',t="",s="Boolean",r='',q='px',p='</div>',n='<div style="position:absolute;',m=";",l='left:',k='">',bh='</span>',bg='background-image:url(',bf="treevirtual-start-contract",be='">&nbsp;</div>',bd="treevirtual-file",bc="qx.ui.treevirtual.SimpleTreeDataCellRenderer",bb="qx.client",ba="treevirtual-only-expand",Y='style="',X='top:0;',B='background-repeat:no-repeat;',C='>',z='right:',A='<div style="',x='" title="',y="treevirtual-end",v="treevirtual-cross",w=');',D='<span',E="treevirtual-end-contract",L=';width:',J=';"',P="treevirtual-end-expand",N="treevirtual-only-contract",T="treevirtual-contract",R='top:',G="content-box",W='bottom:',V="treevirtual-start-expand",U="mshtml",F="treevirtual-cross-contract",H="treevirtual-folder",I='width:',K="treevirtual-expand",M="treevirtual-cross-expand",O="treevirtual-line",Q=';height:',S='height:';
qx.Class.define(bc,{extend:qx.ui.table.cellrenderer.Abstract,construct:function(){var a=qx.ui.treevirtual.SimpleTreeDataCellRenderer;
if(a.__Kg){a.__Kl();
a.__Kg=false;
}arguments.callee.base.call(this);
this.__Kh=qx.util.AliasManager.getInstance();
this.__Ki=qx.util.ResourceManager.getInstance();
this.__Kj=qx.theme.manager.Appearance.getInstance();
this.BLANK=this.__Ki.toUri(this.__Kh.resolve("static/blank.gif"));
},statics:{__Kk:{},__Kg:true,__Kl:function(){qx.theme.manager.Meta.getInstance().initialize();
var bo=qx.ui.treevirtual.SimpleTreeDataCellRenderer;
var br=qx.io.ImageLoader;
var bp=qx.util.AliasManager.getInstance();
var bs=qx.util.ResourceManager.getInstance();
var bq=qx.theme.manager.Appearance.getInstance();
var bt=function(f){br.load(bs.toUri(bp.resolve(f)));
};
bo.__Kk.line=bq.styleFrom(O);
bt(bo.__Kk.line.icon);
bo.__Kk.contract=bq.styleFrom(T);
bt(bo.__Kk.contract.icon);
bo.__Kk.expand=bq.styleFrom(K);
bt(bo.__Kk.expand.icon);
bo.__Kk.onlyContract=bq.styleFrom(N);
bt(bo.__Kk.onlyContract.icon);
bo.__Kk.onlyExpand=bq.styleFrom(ba);
bt(bo.__Kk.onlyExpand.icon);
bo.__Kk.startContract=bq.styleFrom(bf);
bt(bo.__Kk.startContract.icon);
bo.__Kk.startExpand=bq.styleFrom(V);
bt(bo.__Kk.startExpand.icon);
bo.__Kk.endContract=bq.styleFrom(E);
bt(bo.__Kk.endContract.icon);
bo.__Kk.endExpand=bq.styleFrom(P);
bt(bo.__Kk.endExpand.icon);
bo.__Kk.crossContract=bq.styleFrom(F);
bt(bo.__Kk.crossContract.icon);
bo.__Kk.crossExpand=bq.styleFrom(M);
bt(bo.__Kk.crossExpand.icon);
bo.__Kk.end=bq.styleFrom(y);
bt(bo.__Kk.end.icon);
bo.__Kk.cross=bq.styleFrom(v);
bt(bo.__Kk.cross.icon);
}},properties:{useTreeLines:{check:s,init:true},excludeFirstLevelTreeLines:{check:s,init:false},alwaysShowOpenCloseSymbol:{check:s,init:false}},members:{__Kh:null,__Kj:null,__Ki:null,_getCellStyle:function(g){var h=g.value;
var j=arguments.callee.base.call(this,g)+(h.cellStyle?h.cellStyle+m:t);
return j;
},_getContentHtml:function(bw){var by=t;
var bz=0;
var bB=this._addExtraContentBeforeIndentation(bw,bz);
by+=bB.html;
bz=bB.pos;
var bA=this._addIndentation(bw,bz);
by+=bA.html;
bz=bA.pos;
bB=this._addExtraContentBeforeIcon(bw,bz);
by+=bB.html;
bz=bB.pos;
var bx=this._addIcon(bw,bz);
by+=bx.html;
bz=bx.pos;
bB=this._addExtraContentBeforeLabel(bw,bz);
by+=bB.html;
bz=bB.pos;
by+=this._addLabel(bw,bz);
return by;
},_addImage:function(bJ){var bL=[];
var bK=this.__Ki.toUri(this.__Kh.resolve(bJ.url));
if(bJ.position){var bM=bJ.position;
bL.push(n);

if(!qx.core.Variant.isSet(bb,U)){bL.push(qx.bom.element.BoxSizing.compile(G));
}
if(bM.top!==undefined){bL.push(R+bM.top+u);
}
if(bM.right!==undefined){bL.push(z+bM.right+u);
}
if(bM.bottom!==undefined){bL.push(W+bM.bottom+u);
}
if(bM.left!==undefined){bL.push(l+bM.left+u);
}
if(bM.width!==undefined){bL.push(I+bM.width+u);
}
if(bM.height!==undefined){bL.push(S+bM.height+u);
}bL.push(k);
}bL.push(A);
bL.push(bg+bK+w);
bL.push(B);

if(bJ.imageWidth&&bJ.imageHeight){bL.push(L+bJ.imageWidth+q+Q+bJ.imageHeight+q);
}var bN=bJ.tooltip;

if(bN!=null){bL.push(x+bN);
}bL.push(be);

if(bJ.position){bL.push(p);
}return bL.join(t);
},_addIndentation:function(bS,bT){var bU=bS.value;
var bV;
var bW=t;
var ca=this.getUseTreeLines();
var bX=this.getExcludeFirstLevelTreeLines();
var bY=this.getAlwaysShowOpenCloseSymbol();

for(var i=0;i<bU.level;i++){bV=this._getIndentSymbol(i,bU,ca,bY,bX);
bW+=this._addImage({url:bV.icon,position:{top:0+(bV.paddingTop||0),left:bT+(bV.paddingLeft||0),width:19,height:16}});
bT+=19;
}return ({html:bW,pos:bT});
},_addIcon:function(bi,bj){var bk=bi.value;
var bm=(bk.bSelected?bk.iconSelected:bk.icon);

if(!bm){if(bk.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF){var o=this.__Kj.styleFrom(bd);
}else{var bl={opened:bk.bOpened};
var o=this.__Kj.styleFrom(H,bl);
}bm=o.icon;
}var bn=this._addImage({url:bm,position:{top:0,left:bj,width:19,height:16}});
return ({html:bn,pos:bj+19});
},_addLabel:function(bO,bP){var bQ=bO.value;
var bR=n+l+bP+u+X+(bQ.labelStyle?bQ.labelStyle+m:t)+k+D+(bO.labelSpanStyle?Y+bO.labelSpanStyle+J:t)+C+bQ.label+bh+p;
return bR;
},_addExtraContentBeforeIndentation:function(d,e){return {html:r,pos:e};
},_addExtraContentBeforeIcon:function(b,c){return {html:r,pos:c};
},_addExtraContentBeforeLabel:function(bu,bv){return {html:r,pos:bv};
},_getIndentSymbol:function(bC,bD,bE,bF,bG){var bH=qx.ui.treevirtual.SimpleTreeDataCellRenderer;
if(bC==0&&bG){bE=false;
}if(bC<bD.level-1){return (bE&&!bD.lastChild[bC]?bH.__Kk.line:{icon:this.BLANK});
}var bI=bD.lastChild[bD.lastChild.length-1];
if(bD.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH&&!bD.bHideOpenClose){if(bD.children.length>0||bF){if(!bE){return (bD.bOpened?bH.__Kk.contract:bH.__Kk.expand);
}if(bC==0&&bD.bFirstChild){if(bI){return (bD.bOpened?bH.__Kk.onlyContract:bH.__Kk.onlyExpand);
}else{return (bD.bOpened?bH.__Kk.startContract:bH.__Kk.startExpand);
}}if(bI){return (bD.bOpened?bH.__Kk.endContract:bH.__Kk.endExpand);
}return (bD.bOpened?bH.__Kk.crossContract:bH.__Kk.crossExpand);
}}if(bE){if(bD.parentNodeId==0){if(bI&&bD.bFirstChild){return {icon:this.BLANK};
}if(bI){return bH.__Kk.end;
}if(bD.bFirstChild){return (bD.bOpened?bH.__Kk.startContract:bH.__Kk.startExpand);
}}return (bI?bH.__Kk.end:bH.__Kk.cross);
}return {icon:this.BLANK};
}},destruct:function(){this.__Kh=this.__Ki=this.__Kj=null;
}});
})();
...
(function(){var s="qx.ui.treevirtual.SelectionManager",r="Space",q="Enter";
qx.Class.define(s,{extend:qx.ui.table.selection.Manager,construct:function(j){arguments.callee.base.call(this);
this.__Km=j;
},members:{__Km:null,getTable:function(){return this.__Km;
},handleMoveKeyDown:function(a,b){var d=this.getSelectionModel();

switch(b.getModifiers()){case 0:break;
...
}},_handleSelectEvent:function(k,l){var p=this;
function m(t,u,v){var G=t.getDataModel();
var B=G.getTreeColumn();
if(v instanceof qx.event.type.Mouse){if(!t.getFocusCellOnMouseMove()){var A=t._getPaneScrollerArr();

for(var i=0;i<A.length;i++){A[i]._focusCellAtPagePos(v.getViewportLeft(),v.getViewportTop());
}}}var z=t.getFocusedColumn();
if(z!=B){t.startEditing();
return false;
}var w=G.getValue(B,t.getFocusedRow());

if(!w){return false;
}if(v instanceof qx.event.type.Mouse){var C=t.getTableColumnModel();
var E=C._getColToXPosMap();
var H=qx.bom.element.Location.getLeft(t.getContentElement().getDomElement());

for(i=0;i<E[B].visX;i++){H+=C.getColumnWidth(E[i].visX);
}var x=v.getViewportLeft();
var D=2;
var y=H+(w.level-1)*19+2;

if(x>=y-D&&x<=y+19+D){G.setState(w,{bOpened:!w.bOpened});
return t.getOpenCloseClickSelectsRow()?false:true;
}else{return p._handleExtendedClick(t,v,w,H);
}}else{var F=v.getKeyIdentifier();

switch(F){case r:return false;
case q:if(!w.bHideOpenClose){G.setState(w,{bOpened:!w.bOpened});
}return t.getOpenCloseClickSelectsRow()?false:true;
default:return true;
}}}var o=m(this.__Km,k,l);
if(!o){var n=qx.ui.table.selection.Manager;
n.prototype._handleSelectEvent.call(this,k,l);
...
qx.Class.define(n,{extend:qx.ui.table.columnmodel.Basic,include:qx.locale.MTranslation,construct:function(){arguments.callee.base.call(this);
this.__GJ=false;
this.__GK=false;
},properties:{behavior:{check:p,init:null,nullable:true,apply:m,event:g}},members:{__GK:null,__GJ:null,__GL:null,_applyBehavior:function(d,e){if(e!=null){e.dispose();
e=null;
}d._setNumColumns(this.getOverallColumnCount());
d.setTableColumnModel(this);
},init:function(u,v){arguments.callee.base.call(this,u);

if(this.__GL==null){this.__GL=v;
v.addListener(t,this._onappear,this);
v.addListener(r,this._onTableWidthChanged,this);
v.addListener(q,this._onverticalscrollbarchanged,this);
v.addListener(s,this._addResetColumnWidthButton,this);
...
},getTable:function(){return this.__GL;
...
},_onappear:function(event){if(this.__GJ){return ;
}this.__GJ=true;
{};
this.getBehavior().onAppear(event,event.getType()!==t);
this.__GL._updateScrollerWidths();
this.__GL._updateScrollBarVisibility();
this.__GJ=false;
this.__GK=true;
},_onTableWidthChanged:function(event){if(this.__GJ||!this.__GK){return ;
}this.__GJ=true;
{};
this.getBehavior().onTableWidthChanged(event);
this.__GJ=false;
},_onverticalscrollbarchanged:function(event){if(this.__GJ||!this.__GK){return ;
}this.__GJ=true;
{};
this.getBehavior().onVerticalScrollBarChanged(event);
qx.event.Timer.once(function(){if(this.__GL&&!this.__GL.isDisposed()){this.__GL._updateScrollerWidths();
this.__GL._updateScrollBarVisibility();
}},this,0);
this.__GJ=false;
},_oncolumnwidthchanged:function(event){if(this.__GJ||!this.__GK){return ;
}this.__GJ=true;
{};
this.getBehavior().onColumnWidthChanged(event);
this.__GJ=false;
},_onvisibilitychanged:function(event){if(this.__GJ||!this.__GK){return ;
}this.__GJ=true;
{};
...
},members:{__GM:null,renderLayout:function(f,top,g,h){this.__GM=g;
},getComputedWidth:function(){return this.__GM;
...
(function(){var m="Function",k="Boolean",j="minWidth",h="width",g="qx.ui.table.columnmodel.Resize",f="qx.ui.table.columnmodel.resizebehavior.Default",e="__GP",d="maxWidth",c="__GO";
qx.Class.define(f,{extend:qx.ui.table.columnmodel.resizebehavior.Abstract,construct:function(){arguments.callee.base.call(this);
this.__GN=[];
this.__GO=new qx.ui.layout.HBox();
this.__GO.connectToWidget(this);
this.__GP=new qx.util.DeferredCall(this._computeColumnsFlexWidth,this);
},properties:{newResizeBehaviorColumnData:{check:m,init:function(t){return new qx.ui.core.ColumnData();
}},initializeWidthsOnEveryAppear:{check:k,init:false},tableColumnModel:{check:g}},members:{__GO:null,__GQ:null,__GN:null,__GP:null,__GR:false,setWidth:function(q,r,s){if(q>=this.__GN.length){throw new Error("Column number out of range");
}this.__GN[q].setColumnWidth(r,s);
this.__GP.schedule();
},setMinWidth:function(H,I){if(H>=this.__GN.length){throw new Error("Column number out of range");
}this.__GN[H].setMinWidth(I);
this.__GP.schedule();
},setMaxWidth:function(w,x){if(w>=this.__GN.length){throw new Error("Column number out of range");
}this.__GN[w].setMaxWidth(x);
this.__GP.schedule();
},set:function(n,o){for(var p in o){switch(p){case h:this.setWidth(n,o[p]);
break;
case j:this.setMinWidth(n,o[p]);
break;
case d:this.setMaxWidth(n,o[p]);
break;
default:throw new Error("Unknown property: "+p);
}}},onAppear:function(event,v){if(v===true||!this.__GR||this.getInitializeWidthsOnEveryAppear()){this._computeColumnsFlexWidth();
this.__GR=true;
...
},onVisibilityChanged:function(event){var u=event.getData();
if(u.visible){this._computeColumnsFlexWidth();
return;
}this._extendLastColumn(event);
},_setNumColumns:function(a){var b=this.__GN;
if(a<=b.length){b.splice(a,b.length);
return;
}for(var i=b.length;i<a;i++){b[i]=this.getNewResizeBehaviorColumnData()();
b[i].columnNumber=i;
}},getLayoutChildren:function(){return this.__GQ;
},_computeColumnsFlexWidth:function(){this.__GP.cancel();
var N=this._getAvailableWidth();

if(N===null){return;
}var J=this.getTableColumnModel();
var L=J.getVisibleColumns();
var M=L.length;
var K=this.__GN;
var i,l;
...
for(i=0;i<M;i++){P.push(K[L[i]]);
}this.__GQ=P;
this.__GS();
this.__GO.renderLayout(N,100);
for(i=0,l=P.length;i<l;i++){var O=P[i].getComputedWidth();
J.setColumnWidth(L[i],O);
}},__GS:function(){this.__GO.invalidateChildrenCache();
var y=this.__GQ;

for(var i=0,l=y.length;i<l;i++){y[i].invalidateLayoutCache();
}},_extendNextColumn:function(event){var U=this.getTableColumnModel();
var X=event.getData();
var S=U.getVisibleColumns();
var R=this._getAvailableWidth();
var Q=S.length;
if(X.newWidth>X.oldWidth){return ;
}var i;
var T;
var W=0;

for(i=0;i<Q;i++){W+=U.getColumnWidth(S[i]);
}if(W<R){for(i=0;i<S.length;i++){if(S[i]==X.col){T=S[i+1];
break;
}}
if(T){var V=(R-(W-U.getColumnWidth(T)));
U.setColumnWidth(T,V);
}}},_extendLastColumn:function(event){var C=this.getTableColumnModel();
var G=event.getData();
if(G.visible){return;
}var B=C.getVisibleColumns();
if(B.length==0){return;
}var A=this._getAvailableWidth(C);
var z=B.length;
var i;
var E;
var F=0;

for(i=0;i<z;i++){F+=C.getColumnWidth(B[i]);
}if(F<A){E=B[B.length-1];
var D=(A-(F-C.getColumnWidth(E)));
C.setColumnWidth(E,D);
}},_getResizeColumnData:function(){return this.__GN;
}},destruct:function(){this.__GN=this.__GQ=null;
this._disposeObjects(c,e);
}});
})();
(function(){var r="number",q="object",p="qx.ui.treevirtual.MNode";
qx.Mixin.define(p,{members:{nodeGet:function(u){if(typeof (u)==q){return u;
}else if(typeof (u)==r){return this.getTableModel().getData()[u];
}else{throw new Error("Expected node object or node id");
}},nodeToggleOpened:function(J){var K;
var L;

if(typeof (J)==q){K=J;
L=K.nodeId;
}else if(typeof (J)==r){L=J;
K=this.getTableModel().getData()[L];
}else{throw new Error("Expected node object or node id");
}this.getTableModel().setState(L,{bOpened:!K.bOpened});
},nodeSetState:function(d,e){var f;

if(typeof (d)==q){f=d.nodeId;
}else if(typeof (d)==r){f=d;
}else{throw new Error("Expected node object or node id");
}this.getTableModel().setState(f,e);
},nodeSetLabel:function(D,E){this.nodeSetState(D,{label:E});
},nodeGetLabel:function(H){var I=this.nodeGet(H);
return I.label;
},nodeSetSelected:function(m,b){this.nodeSetState(m,{bSelected:b});
},nodeGetSelected:function(B){var C=this.nodeGet(B);
return C.bSelected;
},nodeSetOpened:function(k,b){var l;

if(typeof (k)==q){l=k;
}else if(typeof (k)==r){l=this.getTableModel().getData()[k];
}else{throw new Error("Expected node object or node id");
}if(b!=l.bOpened){this.nodeToggleOpened(l);
}},nodeGetOpened:function(s){var t=this.nodeGet(s);
return t.bOpened;
},nodeSetHideOpenClose:function(M,b){this.nodeSetState(M,{bHideOpenClose:b});
},nodeGetHideOpenClose:function(n){var o=this.nodeGet(n);
return o.bHideOpenClose;
},nodeSetIcon:function(v,w){this.nodeSetState(v,{icon:w});
},nodeGetIcon:function(F){var G=this.nodeGet(F);
return G.icon;
},nodeSetSelectedIcon:function(x,y){this.nodeSetState(x,{iconSelected:y});
},nodeGetSelectedIcon:function(N){var O=this.nodeGet(N);
return O.iconSelected;
},nodeSetCellStyle:function(g,h){this.nodeSetState(g,{cellStyle:h});
},nodeGetCellStyle:function(z){var A=this.nodeGet(z);
return A.cellStyle;
},nodeSetLabelStyle:function(i,j){this.nodeSetState(i,{labelStyle:j});
