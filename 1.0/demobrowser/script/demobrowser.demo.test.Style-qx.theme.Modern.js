...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Style-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"b4cf7838d1f2"},
  boot : "boot",
  bootIsInline : true,
