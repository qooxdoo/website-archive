...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Selection-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"5c958a947d9f"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(M,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var T=qx.bom.Element.create(i,{id:l,style:u});
var bj=qx.bom.Element.create(i,{id:z,style:d});
qx.dom.Element.insertEnd(bj,T);
var bb=qx.bom.Element.create(i,{id:v,style:x});
bb.innerHTML=o;
qx.dom.Element.insertEnd(bb,bj);
...
var bc=qx.bom.Input.create(k,{value:r,style:f});
qx.bom.Element.addListener(bc,j,function(e){qx.bom.Selection.set(document.getElementById(P).firstChild,0,4);
...
var Y=qx.bom.Input.create(k,{value:K,style:h});
qx.bom.Element.addListener(Y,j,this._getSelection,this._input);
qx.dom.Element.insertEnd(Y,V);
...
var bd=qx.bom.Input.create(k,{value:a,style:h});
qx.bom.Element.addListener(bd,j,this._getStart,this._input);
qx.dom.Element.insertEnd(bd,V);
...
var ba=qx.bom.Element.create(i,{style:N});
ba.innerHTML=q;
var U=qx.bom.Element.create(i,{id:g,style:A+s+n});
qx.dom.Element.insertEnd(ba,T);
qx.dom.Element.insertEnd(U,T);
var be=qx.bom.Element.create(i,{id:P});
be.innerHTML=J;
qx.dom.Element.insertEnd(be,document.body);
