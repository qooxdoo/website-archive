...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Transition_Position-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"f6b165f783fd"},
  boot : "boot",
  bootIsInline : true,
...
var w;
var D=false;
H.addListenerOnce(l,function(){w=new qx.fx.effect.core.Move(H.getContainerElement().getDomElement());
