...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.Event_Iframe-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"ef17676758db"},
  boot : "boot",
  bootIsInline : true,
