...
qx.Mixin.define(bF,{members:{assert:function(d,e){qx.core.Assert.assert(d,e);
},fail:function(bv){qx.core.Assert.fail(bv);
},assertTrue:function(n,o){qx.core.Assert.assertTrue(n,o);
},assertFalse:function(W,X){qx.core.Assert.assertFalse(W,X);
},assertEquals:function(a,b,c){qx.core.Assert.assertEquals(a,b,c);
},assertNotEquals:function(bQ,bR,bS){qx.core.Assert.assertNotEquals(bQ,bR,bS);
},assertIdentical:function(p,q,r){qx.core.Assert.assertIdentical(p,q,r);
},assertNotIdentical:function(bT,bU,bV){qx.core.Assert.assertNotIdentical(bT,bU,bV);
},assertNotUndefined:function(bK,bL){qx.core.Assert.assertNotUndefined(bK,bL);
},assertUndefined:function(bI,bJ){qx.core.Assert.assertUndefined(bI,bJ);
},assertNotNull:function(J,K){qx.core.Assert.assertNotNull(J,K);
},assertNull:function(H,I){qx.core.Assert.assertNull(H,I);
},assertJsonEquals:function(Q,R,S){qx.core.Assert.assertJsonEquals(Q,R,S);
},assertMatch:function(T,U,V){qx.core.Assert.assertMatch(T,U,V);
},assertArgumentsCount:function(bo,bp,bq,br){qx.core.Assert.assertArgumentsCount(bo,bp,bq,br);
},assertEventFired:function(bM,event,bN,bO,bP){qx.core.Assert.assertEventFired(bM,event,bN,bO,bP);
},assertEventNotFired:function(bl,event,bm,bn){qx.core.Assert.assertEventNotFired(bl,event,bm,bn);
},assertException:function(D,E,F,G){qx.core.Assert.assertException(D,E,F,G);
},assertInArray:function(bW,bX,bY){qx.core.Assert.assertInArray(bW,bX,bY);
},assertArrayEquals:function(N,O,P){qx.core.Assert.assertArrayEquals(N,O,P);
},assertKeyInMap:function(w,x,y){qx.core.Assert.assertKeyInMap(w,x,y);
},assertFunction:function(j,k){qx.core.Assert.assertFunction(j,k);
},assertString:function(h,i){qx.core.Assert.assertString(h,i);
},assertBoolean:function(s,t){qx.core.Assert.assertBoolean(s,t);
},assertNumber:function(l,m){qx.core.Assert.assertNumber(l,m);
},assertPositiveNumber:function(bG,bH){qx.core.Assert.assertPositiveNumber(bG,bH);
},assertInteger:function(bD,bE){qx.core.Assert.assertInteger(bD,bE);
},assertPositiveInteger:function(Y,ba){qx.core.Assert.assertPositiveInteger(Y,ba);
},assertInRange:function(bz,bA,bB,bC){qx.core.Assert.assertInRange(bz,bA,bB,bC);
},assertObject:function(f,g){qx.core.Assert.assertObject(f,g);
},assertArray:function(L,M){qx.core.Assert.assertArray(L,M);
},assertMap:function(u,v){qx.core.Assert.assertMap(u,v);
},assertRegExp:function(bg,bh){qx.core.Assert.assertRegExp(bg,bh);
},assertType:function(bd,be,bf){qx.core.Assert.assertType(bd,be,bf);
},assertInstance:function(bs,bt,bu){qx.core.Assert.assertInstance(bs,bt,bu);
},assertInterface:function(bi,bj,bk){qx.core.Assert.assertInterface(bi,bj,bk);
},assertCssColor:function(bw,bx,by){qx.core.Assert.assertCssColor(bw,bx,by);
},assertElement:function(bb,bc){qx.core.Assert.assertElement(bb,bc);
},assertQxObject:function(z,A){qx.core.Assert.assertQxObject(z,A);
},assertQxWidget:function(B,C){qx.core.Assert.assertQxWidget(B,C);
}}});
})();
