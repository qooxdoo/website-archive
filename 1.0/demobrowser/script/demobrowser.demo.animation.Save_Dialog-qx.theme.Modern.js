...
(function(){var A="execute",z="__BK",y="middle",x="Cancel",w="demobrowser.demo.animation.Save_Dialog",v="appear",u="Your changes will be lost if you don't save them.",t="__BJ",s="close",r="center",m="__BH",q="Save...",p='<b "font-size:12pt;">Do you want to save the changes you made in the doc "Untitled"?</b>',l="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",k="right",o="__BI",n="Don't save";
qx.Class.define(w,{extend:qx.application.Standalone,members:{__BH:null,__BI:null,__BJ:null,__BK:null,__BL:function(){if(qx.bom.client.Engine.MSHTML){this.__BH=new qx.fx.effect.core.Fade(this.__BI.getContainerElement().getDomElement()).set({from:0,to:1});
this.__BJ=new qx.fx.effect.core.Fade(this.__BI.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__BH=new qx.fx.effect.combination.Grow(this.__BI.getContainerElement().getDomElement());
this.__BJ=new qx.fx.effect.combination.Shrink(this.__BI.getContainerElement().getDomElement());
}},showDialog:function(){this.__BI.setZIndex(1);
this.__BH.start();
},hideDialog:function(){this.__BJ.start();
},main:function(){arguments.callee.base.call(this);
var b=this.getRoot();
this.__BK=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__BK.setLayout(new qx.ui.layout.VBox());
b.add(this.__BK,{left:40,top:40});
var f=new qx.ui.form.Button(s);
...
g.setRowHeight(2,10);
g.setRowAlign(3,r,y);
this.__BI=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__BI.setLayout(g);
b.add(this.__BI,{left:65,top:125});
this.__BI.addListenerOnce(v,this.__BL,this);
var j=new qx.ui.basic.Label(p);
var c=new qx.ui.basic.Label(u);
j.setRich(true);
this.__BI.add(j,{row:0,column:0,colSpan:3});
this.__BI.add(c,{row:1,column:0,colSpan:3});
var e=[n,x,q];

for(var i=0;i<e.length;i++){var a=new qx.ui.form.Button(e[i]);
a.setAllowStretchX(false);
this.__BI.add(a,{row:3,column:i});
a.addListener(A,this.hideDialog,this);
}}},destruct:function(){this._disposeObjects(z,o,m,t);
}});
})();
