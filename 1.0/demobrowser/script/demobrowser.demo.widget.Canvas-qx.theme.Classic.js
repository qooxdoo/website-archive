...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Canvas-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"61829adf7008"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="mshtml",n="redraw",m="Canvas is not support in Internet Explorer!",l="center",k="qx.client",j="middle",i="Window containing a Canvas - synced coordinates",h="Window containing a Canvas - static coordinates",g="Resize the windows to see the effect.",f="rgba(0, 0, 200, 0.5)",c="demobrowser.demo.widget.Canvas",d="rgb(200,0,0)";
qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var t=new qx.ui.basic.Label(g);
this.getRoot().add(t,{left:10,top:10});
var s=new qx.ui.window.Window(h).set({width:200,height:200});
s.setLayout(new qx.ui.layout.Canvas());

if(qx.core.Variant.isSet(k,o)){var r=new qx.ui.container.Composite(new qx.ui.layout.HBox());
r.add(new qx.ui.basic.Label(m).set({rich:true,alignX:l,alignY:j}));
}else{var r=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:false});
r.addListener(n,this.draw,this);
}s.add(r,{edge:0});
this.getRoot().add(s,{left:30,top:40});
s.open();
var p=new qx.ui.window.Window(i).set({width:200,height:200});
p.setLayout(new qx.ui.layout.Canvas());

if(qx.core.Variant.isSet(k,o)){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox());
q.add(new qx.ui.basic.Label(m).set({rich:true,alignX:l,alignY:j}));
}else{var q=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:true});
q.addListener(n,this.draw,this);
}p.add(q,{edge:0});
this.getRoot().add(p,{left:30,top:250});
p.open();
},draw:function(e){var b=e.getData();
var a=b.context;
a.fillStyle=d;
a.fillRect(20,20,105,100);
a.fillStyle=f;
a.fillRect(70,70,105,100);
}}});
})();
...
(function(){var n="Integer",m="resize",l="_applyCanvasWidth",k="redraw",j="Boolean",i="__zw",h="_applyCanvasHeight",g="qx.ui.embed.Canvas",f="qx.event.type.Data";
qx.Class.define(g,{extend:qx.ui.core.Widget,construct:function(r,s){arguments.callee.base.call(this);
this.__zw=new qx.util.DeferredCall(this.__zx,this);
this.addListener(m,this._onResize,this);

if(r!==undefined){this.setCanvasWidth(r);
}
if(s!==undefined){this.setCanvasHeight(s);
}},events:{"redraw":f},properties:{syncDimension:{check:j,init:false},canvasWidth:{check:n,init:300,apply:l},canvasHeight:{check:n,init:150,apply:h}},members:{__zw:null,_createContentElement:function(){return new qx.html.Canvas();
},__zx:function(){var b=this.getContentElement();
var d=b.getHeight();
var a=b.getWidth();
var c=b.getContext2d();
this._draw(a,d,c);
this.fireNonBubblingEvent(k,qx.event.type.Data,[{width:a,height:d,context:c}]);
},_applyCanvasWidth:function(p,q){this.getContentElement().setWidth(p);
this.__zw.schedule();
},_applyCanvasHeight:function(t,u){this.getContentElement().setHeight(t);
this.__zw.schedule();
},update:function(){this.__zw.schedule();
...
},_draw:function(v,w,x){}},destruct:function(){this._disposeObjects(i);
}});
})();
(function(){var e="canvas",d="2d",c="qx.html.Canvas";
qx.Class.define(c,{extend:qx.html.Element,construct:function(){arguments.callee.base.call(this,e);
this.__zy=document.createElement(e);
},members:{__zy:null,_createDomElement:function(){return this.__zy;
},getCanvas:function(){return this.__zy;
},setWidth:function(b){this.__zy.width=b;
},getWidth:function(){return this.__zy.width;
},setHeight:function(a){this.__zy.height=a;
},getHeight:function(){return this.__zy.height;
},getContext2d:function(){return this.__zy.getContext(d);
