...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Showcase-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f629ddc874db"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var x='px',w="Boolean",v="Number",u="fontSize",t="Array",s="qx.fx.effect.core.Scale",r="12px",q='pt',p='em',o="position",l='%',n="100%",m="string",k="absolute";
qx.Class.define(s,{extend:qx.fx.Base,construct:function(y){arguments.callee.base.call(this,y);
this.__Ba=qx.fx.effect.core.Scale.originalStyle;
this.__Bb=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:w},scaleY:{init:true,check:w},scaleContent:{init:true,check:w},scaleFromCenter:{init:true,check:w},scaleFrom:{init:100.0,check:v},scaleTo:{init:100,check:v},restoreAfterFinish:{init:false,check:w},alternateDimensions:{init:[],check:t}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':p,'px':x,'%':l,'pt':q}},members:{__Bc:null,__Bd:null,__Be:null,__Bf:null,__Bg:null,__Bh:null,__Bi:null,__Ba:null,__Bb:null,setup:function(){arguments.callee.base.call(this);
var f=this._getElement();
this.__Bc=qx.bom.element.Style.get(f,o);

for(var c in this.__Ba){this.__Ba[c]=f.style[c];
}this.__Bd=qx.bom.element.Location.getTop(f);
this.__Be=qx.bom.element.Location.getLeft(f);

try{var e=qx.bom.element.Style.get(f,u);
}catch(g){if(typeof (e)!=m){e=(qx.bom.client.Engine.MSHTML)?r:n;
}}
for(var a in this.__Bb){if(e.indexOf(a)>0){this.__Bf=parseFloat(e);
this.__Bg=a;
break;
}}this.__Bh=(this.getScaleTo()-this.getScaleFrom())/100;
var b=this.getAlternateDimensions();

if(b.length==0){this.__Bi=[f.offsetWidth,f.offsetHeight];
}else{this.__Bi=b;
}},update:function(h){var j=this._getElement();
arguments.callee.base.call(this);
var i=(this.getScaleFrom()/100.0)+(this.__Bh*h);

if(this.getScaleContent()&&this.__Bf){qx.bom.element.Style.set(j,u,this.__Bf*i+this.__Bg);
}this._setDimensions(this.__Bi[0]*i,this.__Bi[1]*i);
},finish:function(){arguments.callee.base.call(this);
var B=this._getElement();

if(this.getRestoreAfterFinish()){for(var z in this.__Ba){var A=this.__Ba[z];
...
if(F){d.width=Math.round(C)+x;
}
if(G){d.height=Math.round(D)+x;
}
if(this.getScaleFromCenter()){var I=(C-this.__Bi[0])/2;
var J=(D-this.__Bi[1])/2;

if(this.__Bc==k){if(G){d.top=this.__Bd-J+x;
}
if(F){d.left=this.__Be-I+x;
}}else{if(G){d.top=-J+x;
}
if(F){d.left=-I+x;
}}}
for(var E in d){qx.bom.element.Style.set(H,E,d[E]);
}}},destruct:function(){this.__Bi=this.__Ba=this.__Bb=null;
}});
})();
...
(function(){var u="linear",t="Number",s="reverse",r="Boolean",q="none",p="wobble",o="flicker",n="pulse",m="sinodial",l="easeOutQuad",e="spring",k="easeInQuad",h="full",d="Color",c="backgroundColor",g="__Bk",f="#ffffff",i="backgroundImage",b="qx.fx.effect.combination.ColorFlow",j="#ffffaa";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(v){arguments.callee.base.call(this,v);
this.__Bk=[new qx.fx.effect.core.Highlight(v),new qx.fx.effect.core.Highlight(v)];
},properties:{startColor:{init:f,check:d},endColor:{init:j,check:d},forwardTransition:{init:u,check:[u,k,l,m,s,o,p,n,e,q,h]},backwardTransition:{init:u,check:[u,k,l,m,s,o,p,n,e,q,h]},forwardDuration:{init:1.0,check:t},backwardDuration:{init:1.0,check:t},delayBetween:{init:0.3,check:t},restoreBackground:{init:true,check:r},keepBackgroundImage:{init:false,check:r}},members:{__Bl:null,__Bk:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var a=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__Bl={backgroundImage:qx.bom.element.Style.get(a,i),backgroundColor:qx.bom.element.Style.get(a,c)};
...
(function(){var e="opacity",d="qx.fx.effect.combination.Pulsate",c="__Bm",b="sinodial";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(f){arguments.callee.base.call(this,f);
var g=this.getDuration()/6;
var h=0;
this.__Bm=[new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f)];

for(var i=0,l=this.__Bm.length;i<l;i++){this.__Bm[i].set({duration:g,to:((h%2)!=0)?1:0,from:((h%2)!=0)?0:1,transition:b,modifyDisplay:false});
h++;
}},properties:{duration:{init:2,refine:true}},members:{__Bn:null,__Bm:null,beforeSetup:function(){this.__Bn=qx.bom.element.Style.get(this._getElement(),e);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var a=0;
var self=this;

for(var i=0,l=this.__Bm.length;i<l;i++){this.__Bm[i].id=a;

if(a<5){this.__Bm[i].afterFinishInternal=function(){self.__Bm[this.id+1].start();
};
}a++;
}this.__Bm[0].start();
},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),e,this.__Bn);
}},destruct:function(){this._disposeArray(c);
}});
})();
(function(){var j="opacity",i="Boolean",h="none",g="qx.fx.effect.combination.Puff",f="_effects",e="__Bp",d="__Bo",c="__Bq",b="display";
qx.Class.define(g,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
this.__Bo=new qx.fx.effect.core.Scale(a);
this.__Bp=new qx.fx.effect.core.Fade(a);
this.__Bq=new qx.fx.effect.core.Parallel(this.__Bo,this.__Bp);
},properties:{modifyDisplay:{init:true,check:i}},members:{__Bp:null,__Bo:null,__Bq:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),b,h);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var l=this._getElement();
var k={opacity:qx.bom.element.Style.get(l,j)};
this.__Bp.afterFinishInternal=function(){var n=this._getElement();

for(var m in k){qx.bom.element.Style.set(n,m,k[m]);
}};
this.__Bo.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__Bp.set({sync:true,to:0.0,modifyDisplay:false});
this.__Bq.start();
}},destruct:function(){this._disposeArray(f);
this._disposeObjects(c,d,e);
}});
})();
...
(function(){var p="sinodial",o="none",n="overflow",m="flicker",l="center",k="pulse",j="spring",i="full",h="wobble",g="easeOutQuad",M="easeInQuad",L="reverse",K="linear",J="scroll",I="Boolean",H="px",G='bottom-left',F='top-left',E='bottom-right',D="bottom-right",w="opacity",x="__Bu",u="bottom-left",v="visible",s="qx.fx.effect.combination.Shrink",t="top-left",q="top-right",r='top-right',y="__Bs",z='center',B="__Bt",A="hidden",C="display";
qx.Class.define(s,{extend:qx.fx.Base,construct:function(N){arguments.callee.base.call(this,N);
this.__Bs=new qx.fx.effect.core.Move(N);
this.__Bt=new qx.fx.effect.core.Scale(N);
this.__Bu=new qx.fx.effect.core.Parallel(this.__Bs,this.__Bt);
},properties:{direction:{init:l,check:[t,q,u,D,l]},moveTransition:{init:p,check:[K,M,g,p,L,m,h,k,j,o,i]},scaleTransition:{init:p,check:[K,M,g,p,L,m,h,k,j,o,i]},modifyDisplay:{init:true,check:I}},members:{__Bv:null,__Bs:null,__Bt:null,__Bu:null,setup:function(){arguments.callee.base.call(this);
...
for(var d in this.__Bv){e=this.__Bv[d];
...
var a,b;
this.__Bv={top:qx.bom.element.Location.getTop(c,J),left:qx.bom.element.Location.getLeft(c,J),width:qx.bom.element.Dimension.getContentWidth(c),height:qx.bom.element.Dimension.getContentHeight(c),opacity:qx.bom.element.Style.get(c,w)};

switch(this.getDirection()){case F:a=b=0;
break;
case r:a=this.__Bv.width;
b=0;
break;
case G:a=0;
b=this.__Bv.height;
break;
case E:a=this.__Bv.width;
b=this.__Bv.height;
break;
case z:a=this.__Bv.width/2;
b=this.__Bv.height/2;
break;
}this.__Bs.set({x:a,y:b,sync:true,transition:this.getMoveTransition()});
this.__Bt.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__Bu.start();
}},destruct:function(){this._disposeObjects(y,B,x);
}});
})();
(function(){var k="sinodial",j="px",i="flicker",h="0px",g="center",f="pulse",e="spring",d="full",c="wobble",b="easeOutQuad",K="easeInQuad",J="reverse",I="none",H="overflow",G="linear",F="__Bx",E="height",D='bottom-left',C='top-left',B='bottom-right',r="bottom-right",s="qx.fx.effect.combination.Grow",p="__Bw",q="bottom-left",n="visible",o="width",l="top-left",m="__By",t="top",u="top-right",w='top-right',v="block",y='center',x="hidden",A="left",z="display";
qx.Class.define(s,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
this.__Bw=new qx.fx.effect.core.Move(a);
this.__Bx=new qx.fx.effect.core.Scale(a);
this.__By=new qx.fx.effect.core.Parallel(this.__Bw,this.__Bx);
},properties:{direction:{init:g,check:[l,u,q,r,g]},scaleTransition:{init:k,check:[G,K,b,k,J,i,c,f,e,I,d]},moveTransition:{init:k,check:[G,K,b,k,J,i,c,f,e,I,d]}},members:{__Bx:null,__Bw:null,__By:null,setup:function(){arguments.callee.base.call(this);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var R=this._getElement();
qx.bom.element.Style.set(R,z,v);
qx.bom.element.Style.set(R,H,x);
var P,O;
var S,T;
var Q={top:qx.bom.element.Location.getTop(R),left:qx.bom.element.Location.getLeft(R),width:qx.bom.element.Dimension.getContentWidth(R),height:qx.bom.element.Dimension.getContentHeight(R),overflow:n};
this.__Bx.afterFinishInternal=function(){var M;
var N=this._getElement();

for(var L in Q){M=Q[L];
...
T=-Q.height;
break;
case y:P=Math.round(Q.width/2);
O=Math.round(Q.height/2);
S=-Math.round(Q.width/2);
T=-Math.round(Q.height/2);
break;
}this.__Bw.set({x:S,y:T,sync:true,transition:this.getMoveTransition()});
this.__Bx.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[Q.width,Q.height]});
qx.bom.element.Style.set(R,t,(Q.top+O)+j);
qx.bom.element.Style.set(R,A,(Q.left+P)+j);
qx.bom.element.Style.set(R,E,h);
qx.bom.element.Style.set(R,o,h);
this.__By.start();
}},destruct:function(){this._disposeObjects(p,F,m);
}});
})();
(function(){var z="out",y="px",x="south",w="Number",v="north-west",u="west",t="in",s="north",r="south-east",q="south-west",j="east",p="north-east",m="display",h="__BA",g="top",l="Boolean",k="block",n="left",f="__BB",o="__Bz",i="qx.fx.effect.combination.Drop";
qx.Class.define(i,{extend:qx.fx.Base,construct:function(B){arguments.callee.base.call(this,B);
this.__Bz=new qx.fx.effect.core.Move(B);
this.__BA=new qx.fx.effect.core.Fade(B);
this.__BB=new qx.fx.effect.core.Parallel(this.__Bz,this.__BA);
},properties:{direction:{init:x,check:[x,u,j,s,q,r,p,v]},xAmount:{init:100,check:w},yAmount:{init:100,check:w},mode:{init:z,check:[t,z]},modifyDisplay:{init:true,check:l}},members:{__BA:null,__Bz:null,__BB:null,start:function(){arguments.callee.base.call(this);
var e=this._getElement();
qx.bom.element.Style.set(e,m,k);
var c=this.getXAmount();
var b=this.getYAmount();
var d={top:qx.bom.element.Location.getTop(e),left:qx.bom.element.Location.getLeft(e)};
var a={x:c,y:b,sync:true};

switch(this.getDirection()){case x:a.x=0;
a.y=b;
break;
case s:a.x=0;
a.y=-b;
...
if(this.getMode()==t){qx.bom.element.Style.set(e,g,(d.top-a.y)+y);
qx.bom.element.Style.set(e,n,(d.left-a.x)+y);
}this.__Bz.set(a);
this.__BA.afterFinishInternal=function(){for(var A in d){qx.bom.element.Style.set(e,A,d[A]+y);
}};
this.__BA.set({duration:0.5,sync:true,from:(this.getMode()==z)?1:0,to:(this.getMode()==z)?0:1,modifyDisplay:true});
this.__BB.start();
}},destruct:function(){this._disposeObjects(o,h,f);
}});
})();
(function(){var u="display",t="in",s="overflow",r="block",q="none",p="visible",o="0px",n="hidden",m="visiblity",l="Boolean",g="height",k="width",j="px",f="qx.fx.effect.combination.Fold",e="__BC",i="out",h="__BD";
qx.Class.define(f,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
},properties:{modifyDisplay:{init:true,check:l},mode:{init:t,check:[t,i]}},members:{__BC:null,__BD:null,__BE:null,afterFinish:function(){var v=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==t)){qx.bom.element.Style.set(v,u,r);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var w=this._getElement();
var self=this;
this.__BC=new qx.fx.effect.core.Scale(w);
this.__BD=new qx.fx.effect.core.Scale(w);
this.__BC.afterFinishInternal=function(){self.__BD.start();
};
this.__BD.afterFinishInternal=function(){self._cleanUp();
};
this.__BE=this._getStyle();
qx.bom.element.Style.set(w,s,n);

if(this.getMode()==t){this.__BC.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__BD.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__BC.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__BE.width,this.__BE.height]});
this.__BD.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__BE.width,this.__BE.height]});
qx.bom.element.Style.set(w,u,r);
qx.bom.element.Style.set(w,g,o);
qx.bom.element.Style.set(w,k,o);
}this.__BC.start();
},_cleanUp:function(){var y;
var z=this._getElement();

if((this.getMode()==t)&&(this.getModifyDisplay())){qx.bom.element.Style.set(z,u,q);
}
for(var x in this.__BE){y=this.__BE[x];

if(x!=s){y+=j;
}qx.bom.element.Style.set(z,x,y);
}qx.bom.element.Style.set(z,s,p);
},_getStyle:function(){var d=this._getElement();
var b=(qx.bom.element.Style.get(d,u)==q);

if(b){qx.bom.element.Style.set(d,m,n);
qx.bom.element.Style.set(d,u,r);
}var c={overflow:qx.bom.element.Style.get(d,s),top:qx.bom.element.Location.getTop(d),left:qx.bom.element.Location.getLeft(d),width:qx.bom.element.Dimension.getContentWidth(d),height:qx.bom.element.Dimension.getContentHeight(d)};

if(b){qx.bom.element.Style.set(d,u,q);
qx.bom.element.Style.set(d,m,p);
}return c;
}},destruct:function(){this._disposeObjects(e,h);
}});
})();
(function(){var l="off",k="overflow",j="Boolean",i="qx.fx.effect.combination.Switch",h="none",g="flicker",f="__BF",e="__BG",d="hidden",c="display";
qx.Class.define(i,{extend:qx.fx.Base,construct:function(o){arguments.callee.base.call(this,o);
this.setTransition(g);
var p=this.__BF=new qx.fx.effect.core.Scale(o);
this.__BF.beforeSetup=function(){qx.bom.element.Style.set(o,k,d);
};
this.__BG=new qx.fx.effect.core.Fade(o);
this.__BG.afterFinishInternal=function(){p.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:j},mode:{init:l,check:[l]}},members:{__BF:null,__BG:null,setup:function(){arguments.callee.base.call(this);
var b=this._getElement();
var a=qx.bom.element.Style.get(b,k);
this.__BF.afterFinishInternal=function(){qx.bom.element.Style.set(b,k,a);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==l)){qx.bom.element.Style.set(this._getElement(),c,h);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}
if(this.getMode()==l){this.__BF.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__BG.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__BG.start();
},_applyDuration:function(m,n){this.__BF.setDuration(m/2);
this.__BG.setDuration(m/2);
}},destruct:function(){this._disposeObjects(e,f);
}});
})();
