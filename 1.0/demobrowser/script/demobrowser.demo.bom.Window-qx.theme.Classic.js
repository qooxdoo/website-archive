...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Window-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"dd18cf1c5cd3"},
  boot : "boot",
  bootIsInline : true,
