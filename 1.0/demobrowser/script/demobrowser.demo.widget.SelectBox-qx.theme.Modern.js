...
(function(){var q="icon/16/devices/",p="phone.png",o="audio-card.png",n="battery.png",m="printer.png",l="Simple",k="display.png",j="audio-input-microphone.png",h="Empty Item",g="computer.png",L="Random Value ",K="input-keyboard.png",J="drive-optical.png",I="",H="media-optical.png",G="changeSelection",F="pda.png",E="network-wired.png",D=".",C="camera-photo.png",x="network-wireless.png",y="media-flash.png",v="Option ",w="input-mouse.png",t="demobrowser.demo.widget.SelectBox",u="With icons",r="drive-harddisk.png",s="camera-web.png",z="multimedia-player.png",A="Item ",B="Long text";
...
},createBox1:function(){var U=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
U.add(new qx.ui.basic.Label(l));
var T=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var V=new qx.ui.form.ListItem(A+(i+1));
T.add(V);
if(i==5){T.setSelection([V]);
}}T.addListener(G,function(e){this.debug("changeSelection: "+e.getData()[0]);
});
U.add(T);
return U;
},createBox2:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
b.add(new qx.ui.basic.Label(B));
var a=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var c=new qx.ui.form.ListItem(L+Math.round(Math.random()*100000000));
a.add(c);
}b.add(a);
return b;
},createBox3:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
N.add(new qx.ui.basic.Label(u));
var P=[o,j,n,C,s,g,k,r,J,K,w,y,H,z,E,x,F,p,m];
var Q=q;
var M=new qx.ui.form.SelectBox();

for(var i=0;i<P.length;i++){var O=new qx.ui.form.ListItem(P[i].substr(0,P[i].indexOf(D)),Q+P[i]);
M.add(O);
}N.add(M);
return N;
},createBox4:function(){var S=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
S.add(new qx.ui.basic.Label(h));
var R=new qx.ui.form.SelectBox();
R.add(new qx.ui.form.ListItem(I));

for(var i=0;i<10;i++){R.add(new qx.ui.form.ListItem(v+(i+1)));
}S.add(R);
return S;
}}});
})();
