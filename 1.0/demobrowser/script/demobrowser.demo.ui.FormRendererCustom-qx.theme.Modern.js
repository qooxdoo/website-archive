...
(function(){var r="execute",q="Name",p="demobrowser.demo.ui.FormRendererCustom",o="Registration",n="demobrowser.demo.ui.CustomRenderer",m="Bio",l="Send",k="Contact",j="Country",h="Personal Information",e="Password",g="Email",f="Phone",d="right",c="Reset";
qx.Class.define(p,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var t=new qx.ui.form.Form();
t.addGroupHeader(o);
...
t.add(x,e);
t.addGroupHeader(k);
t.add(new qx.ui.form.TextField(),g,qx.util.Validate.email());
t.add(new qx.ui.form.TextField(),f);
t.addGroupHeader(h);
t.add(new qx.ui.form.TextField(),j);
t.add(new qx.ui.form.TextArea(),m);
var v=new qx.ui.form.Button(l);
v.addListener(r,function(){if(t.validate()){alert("send...");
}},this);
t.addButton(v);
var u=new qx.ui.form.Button(c);
u.addListener(r,function(){t.reset();
},this);
t.addButton(u);
var w=new demobrowser.demo.ui.CustomRenderer(t);
this.getRoot().add(w,{left:10,top:10});
}}});
qx.Class.define(n,{extend:qx.ui.form.renderer.Single,members:{__Kb:0,__Kc:0,addItems:function(y,z,A){var D=0;
if(A!=null){this._add(this._createHeader(A),{row:D,column:this.__Kb,colSpan:2});
D++;
}for(var i=0;i<y.length;i++){var C=this._createLabel(z[i],y[i]);
this._add(C,{row:D,column:this.__Kb});
var B=y[i];
C.setBuddy(B);

if(B instanceof qx.ui.form.RadioGroup){B=this._createWidgetForRadioGroup(B);
}this._add(B,{row:D,column:this.__Kb+1});
D++;
}this.__Kb+=2;
this.__Kc<D?this.__Kc=D:null;
...
this._add(this._buttonRow,{row:this.__Kc,column:0,colSpan:this.__Kb});
