...
}function r(p,q){return parseInt(qx.bom.element.Style.get(p,q,qx.bom.element.Style.COMPUTED_MODE,false),10);
}var t=this.href;
var v=t.substr(t.indexOf(j)+1);
...
u.style.left=location.left+o;
u.style.top=location.top+o;

if(qx.bom.client.Feature.BORDER_BOX){u.style.width=(location.right-location.left)+o;
u.style.height=(location.bottom-location.top)+o;
}else{u.style.width=(location.right-location.left-r(u,f)-r(u,b))+o;
u.style.height=(location.bottom-location.top-r(u,g)-r(u,m))+o;
}return false;
