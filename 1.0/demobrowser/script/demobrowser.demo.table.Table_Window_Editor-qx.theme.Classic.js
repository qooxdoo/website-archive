...
(function(){var s="execute",r="A boolean",q="A number",p="Table with window cell editor",o="A date",n="Enter",m="1*",l="50%",k="demobrowser.demo.table.Table_Window_Editor",j="appear",g="demobrowser.demo.table.ModalCellEditorFactory",i="Cell Editor",h="ID",f="Save";
qx.Class.define(k,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return p;
},createTable:function(){var y=this.createRandomRows(50);
var w=new qx.ui.table.model.Simple();
w.setColumns([h,q,o,r]);
w.setData(y);
w.setColumnEditable(1,true);
var v={tableColumnModel:function(t){return new qx.ui.table.columnmodel.Resize(t);
}};
var z=new qx.ui.table.Table(w,v);
z.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var x=z.getTableColumnModel();
var u=x.getBehavior();
u.set(0,{width:m,minWidth:40,maxWidth:80});
u.setWidth(1,l);
u.setMinWidth(1,100);
u.setMaxWidth(1,320);
u.set(3,{width:100});
x.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
z.setShowCellFocusIndicator(false);
x.setCellEditorFactory(1,new demobrowser.demo.table.ModalCellEditorFactory());
return z;
}}});
qx.Class.define(g,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,members:{createCellEditor:function(a){var d=new qx.ui.window.Window(i);
d.setLayout(new qx.ui.layout.HBox(4));
d.set({padding:3,modal:true,showClose:false,showMaximize:false,showMinimize:false});
d.moveTo(300,250);
d.addListener(j,function(e){d.__GV.focus();
d.__GV.setTextSelection(0,d.__GV.getValue().length);
});
d.__GV=new qx.ui.form.TextField(a.value+"").set({allowGrowY:true});
d.add(d.__GV);
var b=new qx.ui.form.Button(f);
b.addListener(s,function(e){d.close();
});
d.add(b);
var c=new qx.ui.core.Command(n);
c.addListener(s,function(e){b.execute();
c.dispose();
c=null;
});
return d;
},getCellEditorValue:function(A){return parseFloat(A.__GV.getValue());
}}});
})();
