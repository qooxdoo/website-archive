...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.TabView-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"2db77d5dfec6"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var t="Page #",s="execute",r="icon/32/apps/utilities-terminal.png",q="icon/16/apps/utilities-terminal.png",p="icon/16/apps/utilities-calculator.png",o="demobrowser.demo.widget.TabView",n="bottom",m="Notes",l="Remove first page",k="Layout",J="icon/16/apps/utilities-help.png",I="Add new page",H="changeSelection",G="Calculator...",F="icon/16/apps/utilities-notes.png",E="Bar Position",D="top",C="Calculator",B="right",A="Help",y="Help...",z="Notes...",w="Layout-Settings",x="Remove last page",u="left",v=" with close button.";
...
var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
a.setPadding(20);
a.setAllowStretchX(false);
b.add(a);
this.getRoot().add(b,{edge:0});
a.add(this.getTabView1());
a.add(this.getTabView2());
a.add(this.getTabView3());
},getTabView1:function(){var d=new qx.ui.tabview.TabView();
d.setWidth(500);
var j=new qx.ui.tabview.Page(k,q);
j.setLayout(new qx.ui.layout.VBox());
j.add(new qx.ui.basic.Label(w));
d.add(j);
var g=new qx.ui.tabview.Page(m,F);
g.setLayout(new qx.ui.layout.VBox());
g.add(new qx.ui.basic.Label(z));
d.add(g);
var h=new qx.ui.tabview.Page(C,p);
h.setLayout(new qx.ui.layout.VBox());
h.add(new qx.ui.basic.Label(G));
d.add(h);
var f=new qx.ui.tabview.Page(A,J);
...
for(var i=1;i<=20;i++){var M=new qx.ui.tabview.Page(t+i,q);
M.setLayout(new qx.ui.layout.VBox());
M.setShowCloseButton(true);
M.add(new qx.ui.basic.Label(t+i+v));
L.add(M);
}return L;
},getTabView3:function(){var P=new qx.ui.tabview.TabView();
P.setWidth(500);
P.setHeight(300);

for(var i=1;i<=3;i++){var Y=new qx.ui.tabview.Page(t+i,r);
Y.setLayout(new qx.ui.layout.VBox(4));
P.add(Y);
Y.add(new qx.ui.basic.Label(t+i));
}var R=P.getChildren()[0];
var W=new qx.ui.basic.Label(E);
var U=new qx.ui.form.RadioButton(D);
var O=new qx.ui.form.RadioButton(n);
var T=new qx.ui.form.RadioButton(u);
var V=new qx.ui.form.RadioButton(B);
R.add(new qx.ui.core.Spacer(10,10));
R.add(W);
R.add(U);
R.add(O);
R.add(T);
R.add(V);
var X=new qx.ui.form.RadioGroup(U,O,T,V);
X.addListener(H,function(e){this.setBarPosition(e.getData()[0].getLabel());
},P);
T.setValue(true);
var Q=new qx.ui.form.Button(I);
var S=new qx.ui.form.Button(l);
var N=new qx.ui.form.Button(x);
R.add(new qx.ui.core.Spacer(10,10));
R.add(Q);
R.add(S);
R.add(N);
Q.addListener(s,function(e){var ba=P.getChildren().length+1;
var bb=new qx.ui.tabview.Page(t+ba,r);
P.add(bb);
});
S.addListener(s,function(e){var c=P.getChildren();

if(c.length>0){P.remove(c[0]);
}});
N.addListener(s,function(e){var K=P.getChildren();

if(K.length>0){P.remove(K[K.length-1]);
}});
return P;
}}});
})();
