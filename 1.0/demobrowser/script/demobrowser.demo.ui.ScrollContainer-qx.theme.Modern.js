...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.ScrollContainer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"391567e6c800"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var h="demobrowser.demo.ui.ScrollContainer",g="red",f="Toggle size",e="blue",d="execute";
...
b.set({width:300,height:200});
b.add(this.generateBoxes());
this.getRoot().add(b,{left:10,top:10});
var a=new qx.ui.form.Button(f).set({padding:5});
var c=true;
a.addListener(d,function(){b.setWidth(c?800:300);
c=!c;
});
this.getRoot().add(a,{left:10,top:400});
},generateBoxes:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.Grid());

for(var y=0;y<10;y++){for(var x=0;x<10;x++){i.add((new qx.ui.core.Widget()).set({backgroundColor:((x+y)%2==0)?g:e,width:60,allowShrinkY:false,allowShrinkX:false,height:60}),{column:x,row:y});
}}return i;
}}});
})();
