...
qx.Class.define(n,{extend:qx.application.Native,members:{__FS:null,__FT:0,main:function(){arguments.callee.base.call(this);
this.__FS=[];
var a=new qx.event.Timer(5000);
a.addListener(k,this.runTest,this);
a.start();
this.runTest();
...
q.start();
},clear:function(){var b=this.__FS;

for(var i=0,l=b.length;i<l;i++){var c=b[i].firstChild.id;
qx.bom.Flash.destroy(b[i]);
this.debug("cleaned: "+c);
