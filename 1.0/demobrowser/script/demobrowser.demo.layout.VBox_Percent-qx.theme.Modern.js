...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Percent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e765b26c4d2d"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var v="main",u="green",t="33%",s="yellow",r="50%",q="demobrowser.demo.layout.VBox_Percent";
qx.Class.define(q,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
...
var i=new qx.ui.container.Composite(g).set({decorator:v,backgroundColor:s,height:300,allowGrowY:false});
g.setSpacing(5);
var k=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var j=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var h=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
i.add(k,{height:r});
i.add(j,{flex:1});
i.add(h,{flex:1});
return i;
...
I.add(K,{height:t});
I.add(J,{height:t});
I.add(H,{height:t,flex:1});
return I;
},getBox3:function(){var l=new qx.ui.layout.VBox();
var n=new qx.ui.container.Composite(l).set({decorator:v,backgroundColor:s,allowGrowY:false});
l.setSpacing(5);
var p=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var o=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var m=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
n.add(p,{height:r});
n.add(o,{flex:1});
n.add(m,{flex:1});
return n;
},getBox4:function(){var w=new qx.ui.layout.VBox();
var y=new qx.ui.container.Composite(w).set({decorator:v,backgroundColor:s,allowGrowY:false});
w.setSpacing(5);
var A=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var z=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var x=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
y.add(A,{height:t,flex:1});
y.add(z,{height:t,flex:1});
y.add(x,{height:t,flex:1});
return y;
},getBox5:function(){var B=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(B).set({decorator:v,backgroundColor:s,height:100,allowGrowY:false});
B.setSpacing(5);
var F=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var E=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var C=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
D.add(F,{height:t,flex:1});
D.add(E,{height:t,flex:1});
D.add(C,{height:t,flex:1});
return D;
},getBox6:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:v,backgroundColor:s,height:300,allowGrowY:false});
a.setSpacing(5);
var e=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var d=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
var b=new qx.ui.core.Widget().set({decorator:v,backgroundColor:u});
c.add(e,{height:t,flex:1});
c.add(d,{height:t,flex:1});
c.add(b,{height:t,flex:1});
return c;
}}});
})();
