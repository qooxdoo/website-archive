...
(function(){var m="value",l="horizontal",k="first",j="both",h="Trash",g="second",f="main",d="Show first pane",c="Documents (D:)",b="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",I="Windows (C:)",H="Toggle Splitpane Orientation",G="Inbox",F="Desktop",E="_container1",D="execute",C="Presets",B="__Ig",A="Network",z="changeSelection",t="Sent",u="/",r="Files",s="_container2",p="vertical",q="Workspace",n="Junk #",o="Data",v="Show both panes",w="Show second pane",y="demobrowser.demo.widget.SplitPane",x="Edit";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__Ig:null,main:function(){arguments.callee.base.call(this);
var bb=new qx.ui.container.Scroll();
var ba=new qx.ui.container.Composite(new qx.ui.layout.Basic());
ba.setAllowStretchX(false);
bb.add(ba);
var bh=new qx.ui.splitpane.Pane(l).set({width:450,height:300});
this.__Ig=bh;
var bk=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:f});
var bn=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:f});
var be=this.__Ih();
var bd=new qx.ui.form.Button(H).set({allowGrowX:false,allowGrowY:false});
bd.addListener(D,this._toggle,this);
var bf=new qx.ui.basic.Label(b);
bf.setRich(true);
bk.add(be);
bn.add(bd);
bn.add(bf);
...
bh.add(bk,0);
bh.add(bn,1);
ba.add(bh,{left:20,top:40});
this.getRoot().add(bb,{edge:0});
var bc=new qx.ui.layout.VBox(5);
var bi=new qx.ui.container.Composite(bc);
var bl=new qx.ui.form.RadioButton(d);
var bm=new qx.ui.form.RadioButton(w);
var bj=new qx.ui.form.RadioButton(v);
bl.setUserData(m,k);
bm.setUserData(m,g);
bj.setUserData(m,j);
bj.setValue(true);
...
bi.add(bm);
bi.add(bj);
var bg=new qx.ui.form.RadioGroup(bl,bm,bj);
bg.addListener(z,this._changeVisiblity,this);
ba.add(bi,{left:490,top:42});
bd.focus();
},_toggle:function(){var J=this.__Ig.getOrientation();
this.__Ig.setOrientation(J==l?p:l);
},_changeVisiblity:function(e){var a=e.getData()[0].getUserData(m);

if(a==j){this._container1.show();
this._container2.show();
}else if(a==k){this._container1.show();
this._container2.exclude();
}else if(a==g){this._container1.exclude();
this._container2.show();
}},__Ih:function(){var T=new qx.ui.tree.Tree();
T.setDecorator(null);
var Y=new qx.ui.tree.TreeFolder(u);
Y.setOpen(true);
T.setRoot(Y);
var W=new qx.ui.tree.TreeFolder(F);
W.setOpen(true);
Y.add(W);
var O=new qx.ui.tree.TreeFolder(r);
var M=new qx.ui.tree.TreeFolder(q);
var N=new qx.ui.tree.TreeFolder(A);
var L=new qx.ui.tree.TreeFolder(h);
W.add(O,M,N,L);
var U=new qx.ui.tree.TreeFile(I);
var K=new qx.ui.tree.TreeFile(c);
M.add(U,K);
var X=new qx.ui.tree.TreeFolder(G);
var P=new qx.ui.tree.TreeFolder(C);
var S=new qx.ui.tree.TreeFolder(t);
var R=new qx.ui.tree.TreeFolder(h);

for(var i=0;i<100;i++){R.add(new qx.ui.tree.TreeFile(n+i));
}var V=new qx.ui.tree.TreeFolder(o);
var Q=new qx.ui.tree.TreeFolder(x);
X.add(P,S,R,V,Q);
Y.add(X);
return T;
}},destruct:function(){this._disposeObjects(B,E,s);
}});
})();
