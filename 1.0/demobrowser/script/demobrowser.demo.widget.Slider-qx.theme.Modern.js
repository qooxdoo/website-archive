...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Slider","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Slider-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"483cdc83dd2b"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var u="left",t="bottom",s="center",r="vertical",q="Max: ",p="changeValue",o="horizontal",n="top",m="middle",l="demobrowser.demo.widget.Slider",j="Min: ",k="right";
...
},_createVerticalLayout:function(){var w=[];
w.push(this._createSliderGroup(new qx.ui.form.Slider().set({maximum:1000,value:100})));
w.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-100,maximum:100,singleStep:5,pageStep:20,value:0})));
w.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-600,maximum:-200,singleStep:10,pageStep:50,value:-300})));
w.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:25,maximum:75,singleStep:5,pageStep:10,value:25})));
...
for(var i=0;i<w.length;i++){var y=w[i];
y.slider.setOrientation(r);
v.add(y.slider,{row:0,column:z,rowSpan:3,colSpan:1});
v.add(y.minimum,{row:0,column:z+1});
v.add(y.value,{row:1,column:z+1});
v.add(y.maximum,{row:2,column:z+1});
x.setColumnMinWidth(z+1,80);
x.setColumnWidth(z+2,20);
z+=3;
}return v;
},_createHorizontalLayout:function(){var d=[];
d.push(this._createSliderGroup(new qx.ui.form.Slider().set({maximum:1000,value:100})));
d.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-100,maximum:100,singleStep:5,pageStep:20,value:0})));
d.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-600,maximum:-200,singleStep:10,pageStep:50,value:-300})));
d.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:25,maximum:75,singleStep:5,pageStep:10,value:25})));
var f=new qx.ui.layout.Grid();
var c=new qx.ui.container.Composite(f);
c.setPadding(20);
c.setWidth(400);
c.setHeight(400);
f.setSpacing(5);
...
f.setColumnFlex(1,1);
f.setColumnFlex(2,1);
f.setColumnAlign(0,u,t);
f.setColumnAlign(1,s,t);
f.setColumnAlign(2,k,t);
var h=0;

for(var i=0;i<d.length;i++){var g=d[i];
g.slider.setOrientation(o);
g.value.setWidth(100);
g.value.setTextAlign(s);
c.add(g.minimum,{row:h,column:0});
c.add(g.value,{row:h,column:1});
c.add(g.maximum,{row:h,column:2});
c.add(g.slider,{row:h+1,column:0,colSpan:3,rowSpan:1});
f.setRowHeight(h+2,20);
h+=3;
}return c;
},_createSliderGroup:function(a){var b={slider:a,minimum:new qx.ui.basic.Label(j+a.getMinimum().toString()),maximum:new qx.ui.basic.Label(q+a.getMaximum().toString()),value:new qx.ui.basic.Label(a.getValue().toString())};
a.addListener(p,function(e){b.value.setValue(a.getValue().toString());
});
return b;
}}});
})();
