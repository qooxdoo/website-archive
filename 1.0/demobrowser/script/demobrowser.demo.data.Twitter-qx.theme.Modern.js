...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.Twitter-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"84e956274a04"},
  boot : "boot",
  bootIsInline : true,
