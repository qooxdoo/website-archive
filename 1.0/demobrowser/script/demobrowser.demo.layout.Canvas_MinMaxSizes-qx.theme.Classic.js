...
(function(){var x="20%",w="9%",v="3%",u="6%",t="12%",s="black",r="teal",q="red",p="maxHeight=300",o="minWidth=400",k="green",n="yellow",m="orange",j="solid",i="blue",l="demobrowser.demo.layout.Canvas_MinMaxSizes";
qx.Class.define(l,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var h=new qx.ui.decoration.Single(3,j,s);
var g=new qx.ui.core.Widget().set({backgroundColor:q,decorator:h});
var f=new qx.ui.core.Widget().set({backgroundColor:i,decorator:h});
var e=new qx.ui.basic.Label(p).set({backgroundColor:k,decorator:h,padding:5,maxHeight:300,allowStretchX:true,allowStretchY:true});
var d=new qx.ui.core.Widget().set({backgroundColor:n,decorator:h});
var c=new qx.ui.core.Widget().set({backgroundColor:m,decorator:h});
var b=new qx.ui.basic.Label(o).set({backgroundColor:r,decorator:h,padding:5,minWidth:400,allowStretchX:true,allowStretchY:true});
var a=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
a.add(g,{left:v,top:v,right:v,bottom:v,width:x,height:x});
a.add(f,{left:u,top:u,right:u,width:x,height:x});
a.add(e,{left:w,top:w,bottom:w,width:x,height:x});
a.add(d,{left:t,top:t,width:x,height:x});
a.add(c,{top:w,right:w,width:x,height:x});
a.add(b,{right:w,bottom:w,width:x,height:x});
