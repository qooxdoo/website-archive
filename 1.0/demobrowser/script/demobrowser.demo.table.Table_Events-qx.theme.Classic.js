...
(function(){var p="",o="columnVisibilityMenuCreateEnd",n="Boolean",m="icon/16/actions/edit-cut.png",l="A number",k="changeValue",j="Column",i="sorted",h="tableWidthChanged",g="verticalScrollBarChanged",N="icon/16/actions/edit-copy.png",M="icon/22/actions/media-record.png",L="cellContextmenu",K="_events",J="Cut",I="_tableModel",H="Table",G="asc",F="icon/16/actions/edit-paste.png",E="columnVisibilityMenuCreateStart",w="cellDblclick",x="_eventsWin",u="Copy",v="Name",s="desc",t="Paste",q="Event log",r="cellClick",y="metaDataChanged",z="demobrowser.demo.table.Table_Events",B="Row",A="A date",D="Capture events",C="ID";
qx.Class.define(z,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return H;
},main:function(){arguments.callee.base.call(this);
var b=this._eventsWin=new qx.ui.window.Window(q).set({height:400,width:290,showClose:false,showMinimize:false,contentPadding:0});
b.setLayout(new qx.ui.layout.Canvas());
b.open();
this.getRoot().add(b,{left:670,top:10});
this._events=new qx.ui.table.model.Simple();
this._events.setColumns([v,B,j]);
this._events.setData([]);
var a=new qx.ui.table.Table(this._events);
a.getTableColumnModel().setColumnWidth(0,150);
a.getTableColumnModel().setColumnWidth(1,60);
a.getTableColumnModel().setColumnWidth(2,60);
b.add(a,{edge:0});
},createTable:function(){var S=this.createRandomRows(50);
var O=this._tableModel=new qx.ui.table.model.Simple();
O.setColumns([C,l,A,n]);
O.setData(S);
O.setColumnEditable(1,true);
O.setColumnEditable(2,true);
var T=new qx.ui.table.Table(O);
T.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var P=T.getTableColumnModel();
P.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
var U=function(e){this._events.addRows([[e.getType(),p,p,p]],0);
};
var R=function(e){this._events.addRows([[e.getType(),e.getRow(),e.getColumn()]],0);
};
var Q=function(e){var ba=e.getData();
this._events.addRows([[e.getType(),ba.ascending?G:s,ba.columnIndex]],0);
};
T.addListener(E,U,this);
T.addListener(o,U,this);
T.addListener(h,U,this);
T.addListener(g,U,this);
T.addListener(r,R,this);
T.addListener(w,R,this);
T.addListener(L,R,this);
O.addListener(i,Q,this);
O.addListener(y,U,this);
T.setContextMenu(this.getContextMenu());
return T;
},createControls:function(){var f=new qx.ui.toolbar.ToolBar();
var c,d;
d=new qx.ui.toolbar.Part();
f.add(d);
c=new qx.ui.toolbar.CheckBox(D,M).set({value:true});
d.add(c);
c.addListener(k,function(e){if(c.isValue()){this._events.setData([]);
this._eventsWin.open();
}else{this._eventsWin.close();
}},this);
return f;
},getContextMenu:function(){var V=new qx.ui.menu.Menu();
var X=new qx.ui.menu.Button(J,m);
var Y=new qx.ui.menu.Button(u,N);
var W=new qx.ui.menu.Button(t,F);
V.add(X);
V.add(Y);
V.add(W);
return V;
}},destruct:function(){this._disposeObjects(I,x,K);
}});
})();
