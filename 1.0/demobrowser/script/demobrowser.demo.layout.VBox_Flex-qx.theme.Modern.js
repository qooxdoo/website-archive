...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Flex-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"ba6ca03b5241"},
  boot : "boot",
  bootIsInline : true,
