...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.treevirtual.TreeVirtual-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1c7c1d7a1db1"},
  boot : "boot",
  bootIsInline : true,
