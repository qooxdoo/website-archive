...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Viewport-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"4a16316c4680"},
  boot : "boot",
  bootIsInline : true,
