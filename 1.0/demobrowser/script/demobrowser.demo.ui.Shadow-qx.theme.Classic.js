...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.Shadow-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ad8e826c3fa0"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var e="shadow-window",d="main",c="demobrowser.demo.ui.Shadow",b="yellow";
qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var a=new qx.ui.core.Widget().set({decorator:e});
this.getRoot().add(a,{top:10,left:10});
var a=new qx.ui.core.Widget().set({shadow:e,decorator:d,backgroundColor:b});
this.getRoot().add(a,{top:10,left:150});
}}});
})();
