...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Application-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e188bdcde27e"},
  boot : "boot",
  bootIsInline : true,
