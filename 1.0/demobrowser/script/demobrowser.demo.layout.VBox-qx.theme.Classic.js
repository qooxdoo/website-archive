...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"849648d807ea"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="main",n="green",m="yellow",l="middle",k="bottom",j="demobrowser.demo.layout.VBox",i="center",h="left",g="right";
qx.Class.define(j,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var p=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(p);
p.add(this.getBox1());
p.add(this.getBox2());
p.add(this.getBox3());
...
p.add(this.getBox6());
p.add(this.getBox7());
},getBox1:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:o,backgroundColor:m,allowGrowY:false});
f.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
f.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
f.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
return f;
},getBox2:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:o,backgroundColor:m,minWidth:60,allowGrowY:false});
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,maxWidth:40,alignX:h}));
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,maxWidth:40,alignX:i}));
s.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,maxWidth:40,alignX:g}));
return s;
},getBox3:function(){var q=new qx.ui.layout.VBox();
var r=new qx.ui.container.Composite(q).set({decorator:o,backgroundColor:m,height:300,allowGrowY:false});
q.setSpacing(5);
q.setAlignY(k);
r.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
r.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
r.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
return r;
},getBox4:function(){var C=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(C).set({decorator:o,backgroundColor:m,height:300,allowGrowY:false});
C.setSpacing(5);
C.setAlignY(l);
D.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
D.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
D.add(new qx.ui.core.Widget().set({decorator:o,backgroundColor:n}));
return D;
},getBox5:function(){var z=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:o,backgroundColor:m,allowGrowY:false});
var B=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10});
var A=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10,marginTop:20});
var y=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10});
z.add(B);
z.add(A);
z.add(y);
return z;
},getBox6:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:o,backgroundColor:m,height:300,allowGrowY:false});
a.setSpacing(5);
a.setAlignY(k);
var e=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10});
var d=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10,marginTop:20});
var b=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10});
c.add(e);
c.add(d);
c.add(b);
return c;
},getBox7:function(){var t=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(t).set({decorator:o,backgroundColor:m,height:300,allowGrowY:false});
t.setSpacing(5);
t.setAlignY(l);
var x=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10,marginTop:20});
var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:n,marginBottom:10});
v.add(x);
v.add(w);
v.add(u);
return v;
