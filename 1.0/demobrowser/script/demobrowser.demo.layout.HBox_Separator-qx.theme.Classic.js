...
(function(){var n="main",m="green",l="yellow",k="separator-horizontal",j="demobrowser.demo.layout.HBox_Separator",i="top",h="bottom",g="middle";
...
a.add(this.getBox2());
a.add(this.getBox3());
},getBox1:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,k)).set({decorator:n,backgroundColor:l,allowGrowX:false});
b.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
b.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
b.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
return b;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,k)).set({decorator:n,backgroundColor:l,minHeight:60,allowGrowX:false});
o.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxHeight:40,alignY:i}));
o.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxHeight:40,alignY:g}));
o.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxHeight:40,alignY:h}));
return o;
},getBox3:function(){var d=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,k)).set({decorator:n,backgroundColor:l,allowGrowX:false});
