...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Destructor-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"808346a23982"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var g="Window: ",f="interval",e="__Gi",d="Label: ",c="demobrowser.demo.test.Destructor";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__Gg:null,__Gh:0,__Gi:null,main:function(){arguments.callee.base.call(this);
this.__Gg=[];
this.currentTest=this.testWindows;
this.__Gi=new qx.event.Timer(1000);
this.__Gi.addListener(f,this.runTest,this);
this.__Gi.start();
},runTest:function(){this.__Gh++;
var b=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Gh+" (Registry: "+b+")");
this.currentTest();
qx.ui.core.queue.Manager.flush();
var a=this.__Gg;

for(var i=0,l=a.length;i<l;i++){a[i].destroy();
}a.length=0;
qx.ui.core.queue.Manager.flush();
var b=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Done! (Registry: "+b+")");
},testLabels:function(){for(var i=0;i<250;i++){var j=new qx.ui.basic.Label(d+i);
this.getRoot().add(j,{left:50,top:50+i*20});
this.__Gg.push(j);
}},testWindows:function(){for(var i=0;i<5;i++){var h=new qx.ui.window.Window(g+i);
h.open();
this.__Gg.push(h);
