...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.MenuBar-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"3ce2770961cb"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var co="execute",cn="changeValue",cm="icon/16/actions/system-search.png",cl="Online Forum",ck="New",cj="icon/16/actions/edit-cut.png",ci="Search in files",ch="icon/16/actions/format-justify-fill.png",cg="Left aligned",cf="Undo",bT="_openCommand",bS="Uppercase",bR="View",bQ="C Dialect",bP="changeSelection",bO="Save as...",bN="Show line numbers",bM="Search previous...",bL="Quickstart",bK="Cut",cv="Ctrl+N",cw="C",ct="Show console",cu="Search",cr="Help",cs="_redoCommand",cp="Redo",cq="Show status bar",cx="icon/16/actions/format-justify-left.png",cy="ANSI to OEM",bX="Centered",bW="Paragraph",ca="Edit",bY="Ctrl+O",cc="icon/16/actions/document-print.png",cb="icon/16/actions/document-open.png",ce="C Sharp",cd="icon/16/actions/edit-undo.png",bV="Close",bU="icon/16/actions/document-save-as.png",N="Python",O="icon/16/apps/utilities-help.png",P="Show tree",Q="Spaces to tabs",R="Right aligned",S="OEM to ANSI",T="JavaScript",U="demobrowser.demo.widget.MenuBar",V="_copyCommand",W="Topics",cC="Save",cB="_undoCommand",cA="Capitals",cz="icon/16/actions/application-exit.png",cG="C Plus Plus",cF="_saveCommand",cE="Lowercase",cD="Search next...",cI="_newCommand",cH="Replace in files",bu="Perl",bv="Ctrl+P",bs="XML",bt="Panes",by="Justified",bz="Ctrl+X",bw="Show macros",bx="Show ruler",bq="Copy",br="Paste",bf="_pasteCommand",be="icon/16/actions/format-justify-right.png",bh="Ctrl+Z",bg="Ctrl+R",bb="icon/16/actions/edit-redo.png",ba="Show tags",bd="Info...",bc="Format",Y="File",X="Show tabs",bE="Print",bF="icon/16/actions/document-save.png",bG="icon/16/actions/edit-copy.png",bH="Search...",bA="icon/16/actions/format-justify-center.png",bB="Open",bC="_cutCommand",bD="Objective C",bI="Exit",bJ="Ctrl+S",bp="Syntax",bo="Ctrl+C",bn="icon/16/actions/document-new.png",bm="Tabs to spaces",bl="ASCII table",bk="Replace",bj="HTML",bi="icon/16/actions/edit-paste.png";
qx.Class.define(U,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var de=new qx.ui.container.Scroll();
var dd=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
dd.setPadding(20);
dd.setAllowStretchX(false);
de.add(dd);
this.getRoot().add(de,{edge:0});
this.createCommands();
dd.add(this.getMenuBar(),{left:20,top:20});
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(cv);
this._newCommand.addListener(co,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bY);
this._openCommand.addListener(co,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(bJ);
this._saveCommand.addListener(co,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(bh);
this._undoCommand.addListener(co,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(bg);
this._redoCommand.addListener(co,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(bz);
this._cutCommand.addListener(co,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(bo);
this._copyCommand.addListener(co,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(bv);
this._pasteCommand.addListener(co,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuBar:function(){var I=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
I.add(menubar);
var H=new qx.ui.menubar.Button(Y,null,this.getFileMenu());
var G=new qx.ui.menubar.Button(ca,null,this.getEditMenu());
var J=new qx.ui.menubar.Button(cu,null,this.getSearchMenu());
var M=new qx.ui.menubar.Button(bR,null,this.getViewMenu());
var L=new qx.ui.menubar.Button(bc,null,this.getFormatMenu());
var K=new qx.ui.menubar.Button(cr,null,this.getHelpMenu());
menubar.add(H);
menubar.add(G);
menubar.add(J);
menubar.add(M);
...
menubar.add(K);
return I;
},getFileMenu:function(){var i=new qx.ui.menu.Menu;
var g=new qx.ui.menu.Button(ck,bn,this._newCommand);
var k=new qx.ui.menu.Button(bB,cb,this._openCommand);
var j=new qx.ui.menu.Button(bV);
var n=new qx.ui.menu.Button(cC,bF,this._saveCommand);
var m=new qx.ui.menu.Button(bO,bU);
var l=new qx.ui.menu.Button(bE,cc);
var h=new qx.ui.menu.Button(bI,cz);
g.addListener(co,this.debugButton);
k.addListener(co,this.debugButton);
j.addListener(co,this.debugButton);
n.addListener(co,this.debugButton);
m.addListener(co,this.debugButton);
l.addListener(co,this.debugButton);
h.addListener(co,this.debugButton);
i.add(g);
i.add(k);
i.add(j);
i.add(n);
...
i.add(h);
return i;
},getEditMenu:function(){var cK=new qx.ui.menu.Menu;
var cN=new qx.ui.menu.Button(cf,cd,this._undoCommand);
var cM=new qx.ui.menu.Button(cp,bb,this._redoCommand);
var cJ=new qx.ui.menu.Button(bK,cj,this._cutCommand);
var cO=new qx.ui.menu.Button(bq,bG,this._copyCommand);
var cL=new qx.ui.menu.Button(br,bi,this._pasteCommand);
cN.addListener(co,this.debugButton);
cM.addListener(co,this.debugButton);
cJ.addListener(co,this.debugButton);
cO.addListener(co,this.debugButton);
...
cK.add(cL);
return cK;
},getSearchMenu:function(){var ds=new qx.ui.menu.Menu;
var dq=new qx.ui.menu.Button(bH,cm);
var dv=new qx.ui.menu.Button(cD);
var dr=new qx.ui.menu.Button(bM);
var du=new qx.ui.menu.Button(bk);
var dp=new qx.ui.menu.Button(ci,cm);
var dt=new qx.ui.menu.Button(cH);
dr.setEnabled(false);
...
ds.add(dt);
return ds;
},getViewMenu:function(){var cW=new qx.ui.menu.Menu;
var cY=new qx.ui.menu.Button(bt,null,null,this.getPanesMenu());
var dc=new qx.ui.menu.Button(bp,null,null,this.getSyntaxMenu());
var db=new qx.ui.menu.CheckBox(bx);
var da=new qx.ui.menu.CheckBox(bN);
var cX=new qx.ui.menu.Button(bl);
db.addListener(cn,this.debugCheckBox);
da.addListener(cn,this.debugCheckBox);
...
cW.add(cX);
return cW;
},getPanesMenu:function(){var cQ=new qx.ui.menu.Menu;
var cS=new qx.ui.menu.CheckBox(X);
var cU=new qx.ui.menu.CheckBox(cq);
var cV=new qx.ui.menu.CheckBox(P);
var cR=new qx.ui.menu.CheckBox(bw);
var cT=new qx.ui.menu.CheckBox(ba);
var cP=new qx.ui.menu.CheckBox(ct);
cS.setValue(true);
cU.setValue(true);
cR.setValue(true);
cS.addListener(cn,this.debugCheckBox);
cU.addListener(cn,this.debugCheckBox);
cV.addListener(cn,this.debugCheckBox);
cR.addListener(cn,this.debugCheckBox);
cT.addListener(cn,this.debugCheckBox);
cP.addListener(cn,this.debugCheckBox);
cQ.add(cU);
cQ.add(cS);
cQ.addSeparator();
cQ.add(cV);
...
cQ.add(cP);
return cQ;
},getSyntaxMenu:function(){var C=new qx.ui.menu.Menu;
var y=new qx.ui.menu.RadioButton(bj);
var A=new qx.ui.menu.RadioButton(bs);
var z=new qx.ui.menu.RadioButton(T);
var B=new qx.ui.menu.Button(bQ,null,null,this.getSyntaxCMenu());
var F=new qx.ui.menu.RadioButton(bu);
var D=new qx.ui.menu.RadioButton(N);
C.add(y);
C.add(A);
C.add(z);
C.add(B);
C.add(F);
C.add(D);
var E=new qx.ui.form.RadioGroup;
E.add(y,A,z,F,D);
E.add.apply(E,B.getMenu().getChildren());
E.addListener(bP,this.debugRadio);
return C;
},getSyntaxCMenu:function(){var p=new qx.ui.menu.Menu;
var o=new qx.ui.menu.RadioButton(cw);
var s=new qx.ui.menu.RadioButton(ce);
var r=new qx.ui.menu.RadioButton(bD);
var q=new qx.ui.menu.RadioButton(cG);
p.add(o);
p.add(s);
p.add(r);
p.add(q);
return p;
},getFormatMenu:function(){var di=new qx.ui.menu.Menu;
var dh=new qx.ui.menu.Button(bW,null,null,this.getParagraphMenu());
var dk=new qx.ui.menu.Button(bm);
var dl=new qx.ui.menu.Button(Q);
var dg=new qx.ui.menu.Button(bS);
var dj=new qx.ui.menu.Button(cE);
var df=new qx.ui.menu.Button(cA);
var dn=new qx.ui.menu.Button(S);
var dm=new qx.ui.menu.Button(cy);
...
var w=new qx.ui.menu.Button(cg,cx);
var x=new qx.ui.menu.Button(R,be);
var u=new qx.ui.menu.Button(bX,bA);
var v=new qx.ui.menu.Button(by,ch);
w.addListener(co,this.debugButton);
x.addListener(co,this.debugButton);
u.addListener(co,this.debugButton);
v.addListener(co,this.debugButton);
t.add(w);
t.add(x);
t.add(u);
t.add(v);
...
var c=new qx.ui.menu.Button(W,O);
var f=new qx.ui.menu.Button(bL);
var d=new qx.ui.menu.Button(cl);
var b=new qx.ui.menu.Button(bd);
...
a.add(b);
return a;
}},destruct:function(){this._disposeObjects(cI,bT,cF,cB,cs,bC,V,bf);
}});
})();
