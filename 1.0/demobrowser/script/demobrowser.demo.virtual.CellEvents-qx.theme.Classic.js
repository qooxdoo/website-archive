...
(function(){var p='</p>',o=' / ',n="logger",m='<p style="color:green;">You clicked on cell ',l="",k="cellClick",j='<p style="color:yellow;">You rightclicked cell ',i='<p style="color:red;">You double clicked cell ',h="demobrowser.demo.virtual.CellEvents",g="main",c="cellDblclick",f="cellContextmenu",d="layer";
...
var r=s.getPane();
r.addListener(k,this._onCellClick,this);
r.addListener(f,this._onContextMenu,this);
r.addListener(c,this._onDblclickPane,this);
r.addLayer(this.layer);
this.logger=new qx.ui.embed.Html().set({width:400,height:300,html:l,decorator:g});
this.getRoot().add(s,{left:20,top:10});
this.getRoot().add(this.logger,{left:450,top:10});
},_onCellClick:function(e){var q=m+e.getRow()+o+e.getColumn()+p;
this.__IW(q);
},_onContextMenu:function(e){var t=j+e.getRow()+o+e.getColumn()+p;
this.__IW(t);
},_onDblclickPane:function(e){var a=i+e.getRow()+o+e.getColumn()+p;
this.__IW(a);
},__IW:function(b){this.logger.setHtml(this.logger.getHtml()+b);
}},destruct:function(){this._disposeObjects(d,n);
}});
})();
