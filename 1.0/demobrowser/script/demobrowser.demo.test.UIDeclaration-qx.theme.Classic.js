...
(function(){var r="Item",q="Button",p="Header",o="Last Name",n="Page 1",m="First Name",l="firstname",k="Email",j="Demo loaded",h="icon/16/apps/office-calendar.png",F="Page 3",E="move",D="First Window",C="Simple Form",B="Page 2",A="resize",z="Date",y="win",x="Cancel",w="icon/32/apps/office-address-book.png",u="Welcome to your first own Window.<br/>Have fun!",v="Save",s="demobrowser.demo.test.UIDeclaration",t="Company";
qx.Class.define(s,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var f={clazz:qx.ui.form.Form,children:[{type:p,label:C},{type:r,label:m,validator:null,name:l,widget:{clazz:qx.ui.form.TextField,required:true,width:200}},{type:r,label:o,widget:{clazz:qx.ui.form.TextField}},{type:r,label:t,widget:{clazz:qx.ui.form.TextField}},{type:r,label:k,widget:{clazz:qx.ui.form.TextField}},{type:r,label:z,widget:{clazz:qx.ui.form.DateField}},{type:q,widget:{clazz:qx.ui.form.Button,label:v}},{type:q,widget:{clazz:qx.ui.form.Button,label:x}}]};
var g={clazz:qx.ui.window.Window,layout:{clazz:qx.ui.layout.VBox,spacing:10},layoutProperties:{left:20,top:20},showStatusbar:true,status:j,caption:D,icon:h,id:y,listeners:[{event:E,handler:function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
}},{event:A,handler:function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
}}],children:[{clazz:qx.ui.basic.Atom,label:u,icon:w,rich:true},{clazz:qx.ui.tabview.TabView,layoutProperties:{flex:1},children:[{clazz:qx.ui.tabview.Page,label:n,layoutProperties:{flex:1},layout:{clazz:qx.ui.layout.Canvas},children:[f]},{clazz:qx.ui.tabview.Page,label:B,layoutProperties:{flex:1}},{clazz:qx.ui.tabview.Page,label:F,layoutProperties:{flex:1}}]}]};
this.addFromDefinition(g);
this.win.open();
},addFromDefinition:function(N){var O=this.getRoot();
this.__Gj(O,N);
},__Gj:function(G,H){var I=new H.clazz();
...
if(L!=null){for(var i=0;i<L.length;i++){if(I instanceof qx.ui.form.Form){this.__Gk(I,L[i]);
}else{this.__Gj(I,L[i]);
...
}}},__Gk:function(a,b){if(b.type===p){a.addGroupHeader(b.label);
return;
...
if(b.type===r){a.add(c,b.label,b.validator,b.name);
}else if(b.type===q){a.addButton(c);
}}}});
})();
