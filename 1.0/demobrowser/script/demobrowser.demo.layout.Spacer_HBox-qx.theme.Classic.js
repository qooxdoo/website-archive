...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Spacer_HBox-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"39073e96ad54"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var k="main",j="green",i="yellow",h="top",g="bottom",f="middle",e="demobrowser.demo.layout.Spacer_HBox";
...
},getSpacerWithoutFlex:function(){var l=new qx.ui.container.Composite().set({decorator:k,backgroundColor:i,allowGrowX:false});
var m=new qx.ui.layout.HBox();
m.setSpacing(5);
l.setLayout(m);
l.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}));
l.add(new qx.ui.core.Spacer(30,40));
l.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}));
l.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}));
return l;
},getSpacerWithFlex:function(){var n=new qx.ui.container.Composite().set({decorator:k,backgroundColor:i,height:100,width:400});
var o=new qx.ui.layout.HBox();
o.setSpacing(5);
n.setLayout(o);
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:40,alignY:h}));
n.add(new qx.ui.core.Spacer(30,40),{flex:1});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:40,alignY:f}));
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:40,alignY:g}));
return n;
},getAddRemoveSpacer:function(){var b=new qx.ui.container.Composite().set({decorator:k,backgroundColor:i});
var d=new qx.ui.layout.HBox();
d.setSpacing(5);
b.setLayout(d);
b.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:40,alignY:h}));
b.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:40,alignY:f}));
var c=new qx.ui.core.Spacer(30,40);
b.add(c,{flex:1});
b.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:40,alignY:g}));
b.remove(c);
return b;
}}});
})();
