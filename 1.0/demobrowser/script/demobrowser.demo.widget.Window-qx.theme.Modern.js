...
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var be=new qx.ui.window.Window(n,j);
be.setLayout(new qx.ui.layout.VBox(10));
be.setShowStatusbar(true);
be.setStatus(F);
be.open();
this.getRoot().add(be,{left:20,top:20});
be.addListener(p,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
be.addListener(w,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var bd=new qx.ui.basic.Atom(C,P);
bd.setRich(true);
be.add(bd);
...
bc.add(bh);
var bf=new qx.ui.tabview.Page(M);
bc.add(bf);
var bg=new qx.ui.tabview.Page(o);
bc.add(bg);
},createWindow2:function(){var bw=new qx.ui.window.Window(d,G);
bw.setLayout(new qx.ui.layout.VBox(10));
bw.setStatus(E);
bw.open();
this.getRoot().add(bw,{left:350,top:120});
var bG=new qx.ui.basic.Atom(r,V);
bw.add(bG);
var bq=new qx.ui.container.Composite;
bq.setLayout(new qx.ui.layout.HBox(10));
bw.add(bq,{flex:1});
var bz=new qx.ui.groupbox.GroupBox(O);
bz.setLayout(new qx.ui.layout.VBox(4));
bq.add(bz,{flex:1});
var bt=new qx.ui.form.CheckBox(X);
bt.setValue(true);
bt.addListener(l,function(e){bw.setShowClose(e.getData());
});
bz.add(bt);
var bF=new qx.ui.form.CheckBox(U);
bF.setValue(true);
bF.addListener(l,function(e){bw.setShowMaximize(e.getData());
});
bz.add(bF);
var by=new qx.ui.form.CheckBox(A);
by.setValue(true);
by.addListener(l,function(e){bw.setShowMinimize(e.getData());
});
bz.add(by);
var bB=new qx.ui.form.CheckBox(T);
bB.setValue(true);
bB.addListener(l,function(e){bw.setAllowClose(e.getData());
});
bz.add(bB);
var bH=new qx.ui.form.CheckBox(t);
bH.setValue(true);
bH.addListener(l,function(e){bw.setAllowMaximize(e.getData());
});
bz.add(bH);
var bv=new qx.ui.form.CheckBox(D);
bv.setValue(true);
bv.addListener(l,function(e){bw.setAllowMinimize(e.getData());
});
bz.add(bv);
var br=new qx.ui.form.CheckBox(bb);
br.setValue(false);
br.addListener(l,function(e){bw.setShowStatusbar(e.getData());
});
bz.add(br);
var bI=new qx.ui.groupbox.GroupBox(J);
bI.setLayout(new qx.ui.layout.VBox(4));
bq.add(bI,{flex:1});
var bD=new qx.ui.form.CheckBox(S);
bD.setValue(true);
bD.addListener(l,function(e){bw.setUseResizeFrame(e.getData());
});
bI.add(bD);
var bE=[z,h,b,u];

for(var i=0;i<bE.length;i++){var bC=bE[i];
var bu=new qx.ui.form.CheckBox(m+bC).set({value:true});
bu.bind(q,bw,s+qx.lang.String.firstUp(bC));
bI.add(bu);
}var bs=new qx.ui.groupbox.GroupBox(x);
bs.setLayout(new qx.ui.layout.VBox(4));
bq.add(bs,{flex:1});
var bA=new qx.ui.form.CheckBox(Q);
bA.setValue(true);
bA.addListener(l,function(e){bw.setMovable(e.getData());
});
bs.add(bA);
var bx=new qx.ui.form.CheckBox(a);
bx.addListener(l,function(e){bw.setUseMoveFrame(e.getData());
});
bs.add(bx);
},createWindow3:function(){var bn=new qx.ui.window.Window(W,v);
bn.setLayout(new qx.ui.layout.VBox);
bn.setMaxWidth(450);
bn.setMaxHeight(400);
bn.setAllowMaximize(false);
bn.open();
this.getRoot().add(bn,{left:100,top:250});
var bo=this.getModalWindow1();
var bp=new qx.ui.form.Button(N,j);
bp.addListener(k,bo.open,bo);
bn.add(bp);
