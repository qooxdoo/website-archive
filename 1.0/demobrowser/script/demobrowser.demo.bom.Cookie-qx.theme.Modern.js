...
qx.Class.define(j,{extend:qx.application.Standalone,statics:{COOKIE_KEY:"TextFieldContent"},members:{main:function(){arguments.callee.base.call(this);
