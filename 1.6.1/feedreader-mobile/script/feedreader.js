...
var envinfo = {"qx.application":"feedreader.MobileApplication","qx.debug":false,"qx.debug.databinding":false,"qx.debug.dispose":false,"qx.mobile.emulatetouch":true,"qx.nativeScrollBars":true,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"","qx.theme":"qx.theme.Modern","qx.version":"1.6.1"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:feedreader.21f988ad0a4e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(f,{extend:qx.application.Mobile,members:{__Ch:null,main:function(){qx.application.Mobile.prototype.main.call(this);
var j=new feedreader.model.Model();
var k=feedreader.io.FeedLoader.getInstance();
this.__Ch=j.getFeedFolder();
k.loadAll(this.__Ch);
this.buildUpGui();
},buildUpGui:function(){var m=new feedreader.view.mobile.OverviewPage();
var n=new feedreader.view.mobile.FeedPage();
var l=new feedreader.view.mobile.ArticlePage();
m.show();
m.setFeeds(this.__Ch);
...
this._setRoot(j);
this.__CN();
},events:{add:e,remove:e},members:{__CJ:null,__CK:null,__dG:null,__CL:null,__CM:null,__CN:function(){if(qx.core.Environment.get("phonegap")&&qx.core.Environment.get("os.name")=="android"){this.__CL=qx.lang.Function.bind(this._onBackButton,this);
...
if(this.__CK){k=this.__CK.back();
}
if(k){navigator.app.exitApp();
}}},_onMenuButton:function(){if(qx.core.Environment.get(f)&&qx.core.Environment.get(h)==g){if(this.__CK){this.__CK.menu();
}}},add:function(l){this.__CJ[l.getId()]=l;
this.fireDataEvent(d,l);
},remove:function(m){var n=this.getPage(m);
delete this.__CJ[m];
this.fireDataEvent(a,n);
},show:function(o){var p=this.__CK;
...
},_setCurrentPage:function(r){this.__CK=r;
},getPage:function(s){return this.__CJ[s];
},__CP:function(){var t=document.getElementsByTagName("input");
...
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{transitionEnd:1,animationEnd:1,animationStart:1,animationIteration:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true,TYPE_TO_NATIVE:qx.core.Environment.select("engine.name",{"webkit":{transitionEnd:"webkitTransitionEnd",animationEnd:"webkitAnimationEnd",animationStart:"webkitAnimationStart",animationIteration:"webkitAnimationIteration"},"gecko":{transitionEnd:"mozTransitionEnd",animationEnd:"mozAnimationEnd",animationStart:"mozAnimationStart",animationIteration:"mozAnimationIteration"},"default":null}),NATIVE_TO_TYPE:qx.core.Environment.select("engine.name",{"webkit":{webkitTransitionEnd:"transitionEnd",webkitAnimationEnd:"animationEnd",webkitAnimationStart:"animationStart",webkitAnimationIteration:"animationIteration"},"gecko":{mozTransitionEnd:"transitionEnd",mozAnimationEnd:"animationEnd",mozAnimationStart:"animationStart",mozAnimationIteration:"animationIteration"},"default":null})},members:{__Db:null,__Da:null,canHandleEvent:function(d,e){},registerEvent:qx.core.Environment.select(b,{"webkit|gecko":function(f,g,h){var j=qx.core.ObjectRegistry.toHashCode(f)+g;
var i=qx.event.handler.Transition.TYPE_TO_NATIVE[g];
this.__Da[j]={target:f,type:i};
qx.bom.Event.addNativeListener(f,i,this.__Db);
},"default":function(){}}),unregisterEvent:qx.core.Environment.select(b,{"webkit|gecko":function(k,l,m){var o=this.__Da;

if(!o){return;
}var n=qx.core.ObjectRegistry.toHashCode(k)+l;

if(o[n]){delete o[n];
}qx.bom.Event.removeNativeListener(k,qx.event.handler.Transition.TYPE_TO_NATIVE[l],this.__Db);
...
}},members:{__Dc:false,_resize:function(){if(qx.core.Environment.get(k)){this._setStyle(a,window.innerHeight+o);
...
(function(){var o="resize",n="orientationchange",m="qx.mobile.nativescroll",l='TEXTAREA',k="qx/mobile/js/iscroll.min.js",j='INPUT',i="iscroll",h="scrollbar",g='SELECT',f="domupdated",b="div",d="qx.ui.mobile.container.MIScroll",c="success",a='iscrollstart';
qx.Mixin.define(d,{construct:function(){this.__Dm();
this.__CN();
},members:{__Dl:null,_createScrollElement:function(){var scroll=qx.bom.Element.create(b);
qx.bom.element.Class.add(scroll,i);
return scroll;
},_getScrollContentElement:function(){return this.getContainerElement().childNodes[0];
},__Dm:function(){if(!window.iScroll){{var q=k;
};
var p=qx.util.ResourceManager.getInstance().toUri(q);
var r=new qx.io.ScriptLoader();
r.load(p,this.__Dp,this);
}else{this._setScroll(this.__Dn());
}},__Dn:function(){var scroll=new iScroll(this.getContainerElement(),{hideScrollbar:true,fadeScrollbar:true,hScrollbar:false,scrollbarClass:h,onBeforeScrollStart:function(e){var t=e.target;

while(t.nodeType!=1){t=t.parentNode;
}
if(t.tagName!=g&&t.tagName!=j&&t.tagName!=l){e.preventDefault();
}if(qx.core.Environment.get(m)==false){var s=new qx.event.message.Message(a);
qx.event.message.Bus.getInstance().dispatch(s);
}}});
return scroll;
...
},__Do:function(){qx.event.Registration.removeListener(window,n,this._refresh,this);
qx.event.Registration.removeListener(window,o,this._refresh,this);
...
(function(){var g="feedreader.view.mobile.OverviewPage",f="changeSelectedFeed",d="changeFeeds",c="_applyFeeds",b="changeSelection",a="Feed Reader";
qx.Class.define(g,{extend:qx.ui.mobile.page.NavigationPage,construct:function(){qx.ui.mobile.page.NavigationPage.call(this);
this.setTitle(a);
},properties:{feeds:{event:d,init:null,apply:c},selectedFeed:{event:f,init:null,nullable:true}},members:{__Cp:null,__Dx:null,_initialize:function(){qx.ui.mobile.page.NavigationPage.prototype._initialize.call(this);
this.__Cp=new qx.ui.mobile.list.List();
this.__Cp.setDelegate({configureItem:function(h,i){h.setTitle(i.getTitle());
h.setShowArrow(true);
}});
this.__Cp.addListener(b,function(e){var j=this.__Dx.getItem(e.getData());
this.setSelectedFeed(j);
},this);
this.getContent().add(this.__Cp);
},_applyFeeds:function(k,l){this.__Dx=k.getFeeds().getItem(0).getFeeds();
this.__Cp.setModel(this.__Dx);
}}});
})();
...
(function(){var g="_applyFeed",f="feedreader.view.mobile.FeedPage",d="Back",c="changeFeed",b="changeSelection",a="changeSelectedArticle";
...
},properties:{feed:{event:c,init:null,nullable:true,apply:g},selectedArticle:{event:a,init:null,nullable:true}},members:{__Cp:null,__DG:null,_initialize:function(){qx.ui.mobile.page.NavigationPage.prototype._initialize.call(this);
this.__Cp=new qx.ui.mobile.list.List();
this.__Cp.setDelegate({configureItem:function(h,i){h.setTitle(i.getTitle());
h.setShowArrow(true);
}});
this.__Cp.addListener(b,function(e){var j=this.__DG.getItem(e.getData());
this.setSelectedArticle(j);
},this);
this.getContent().add(this.__Cp);
},_applyFeed:function(k,l){if(k!=null){this.__DG=k.getArticles();
this.__Cp.setModel(this.__DG);
this.setTitle(k.getTitle());
}}}});
})();
(function(){var e="feedreader.view.mobile.ArticlePage",d="whitearea",c="_applyArticle",b="changeArticle",a="Back";
qx.Class.define(e,{extend:qx.ui.mobile.page.NavigationPage,construct:function(){qx.ui.mobile.page.NavigationPage.call(this);
this.setShowBackButton(true);
this.setBackButtonText(this.tr(a));
},properties:{article:{event:b,init:null,nullable:true,apply:c}},members:{__DH:null,_initialize:function(){qx.ui.mobile.page.NavigationPage.prototype._initialize.call(this);
this.__DH=new qx.ui.mobile.embed.Html();
this.__DH.addCssClass(d);
this.getContent().add(this.__DH);
