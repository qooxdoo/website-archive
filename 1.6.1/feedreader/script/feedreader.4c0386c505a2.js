...
this.__qb=bh.left===undefined?0:bh.left;
this.__qa=bh.top===undefined?0:bh.top;
...
this.__qb=bi.left===undefined?0:bi.left;
this.__qa=bi.top===undefined?0:bi.top;
this.removeState(b);
this.hide();
this.fireEvent(u);
...
(function(){var u="language",t="execute",s="icon/16/apps/preferences-locale.png",r="feedreader.view.desktop.PreferenceWindow",q="icon/16/apps/preferences-theme.png",p="English",o="Nederlands",n="Français",m="Español",l="Italiano",d="Language",k="icon/16/actions/dialog-cancel.png",h="icon/16/actions/dialog-ok.png",c="Svenska",b="Preferences",g="Cancel",f="Română",i="Deutsch",a="OK",j="right";
qx.Class.define(r,{extend:qx.ui.window.Window,construct:function(){qx.ui.window.Window.call(this,this.tr(b),q);
...
var D={"en":p,"de":i,"es":m,"fr":n,"it":l,"nl":o,"ro":f,"sv":c};
