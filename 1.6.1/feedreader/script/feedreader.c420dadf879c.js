...
(function(){var l="execute",k="settings",j="loading",h="main",g="addfeed",f="selection[0]",d="north",c="new",b="changeModel",a="__BW",Y="__Cg",X="article",W="__Ce",V="__BY",U="__Ca",T="F1",S="selection[0].state",R="partLoaded",Q="Control+A",P="loaded",s="icon/22/places/folder.png",t="feedreader/images/loading22.gif",q="error",r="change",o="user",p="__Cb",m="enabled",n="cached",v="__Cj",w="vertical",D="__BX",B="state",H="__Cd",F="__Ci",L="Control+D",J="__oM",y="icon/22/actions/process-stop.png",O="selection[0].articles",N="static",M="icon/22/apps/internet-feed-reader.png",x="model",z="feedreader.Application",A="Control+P",C="__Cc",E="Control+R",G="icon/22/apps/preferences-clock.png",I="feedreader.model.Feed",K="__Ch",u="__Cf";
qx.Class.define(z,{extend:qx.application.Standalone,members:{__BW:null,__BX:null,__BQ:null,__BY:null,__oM:null,__Ca:null,__Cb:null,__Cc:null,__Cd:null,__Ce:null,__Cf:null,__Cg:null,__Ch:null,__Ci:null,__Cj:null,__Ck:false,__Cl:false,main:function(){qx.application.Standalone.prototype.main.call(this);
qx.io.PartLoader.getInstance().addListener(R,function(e){this.debug("part loaded: "+e.getData().getName());
},this);
...
this.__Ch=bc.getFeedFolder();
this.__Cj=bc.getStaticFeedFolder();
this.__Ci=bc.getUserFeedFolder();
this._setUpBinding();
this.__BY.getRoot().setOpen(true);
this.__BY.getRoot().getChildren()[0].setOpen(true);
this.__BY.getRoot().getChildren()[1].setOpen(true);
this.__BY.setHideRoot(true);
this.__BW.getSelection().push(this.__Cj.getFeeds().getItem(0));
this.reload();
},_setUpBinding:function(){var bd={converter:this._state2iconConverter};
this.__BW=new qx.data.controller.Tree(this.__Ch,this.__BY,"feeds","title");
this.__BW.setIconOptions(bd);
this.__BW.setIconPath(B);
this.__BX=new qx.data.controller.List(null,this.__Cb.getList(),"title");
this.__BW.bind(O,this.__BX,x);
this.__BX.bind(f,this.__Cf,X);
this.__BX.getSelection().addListener(r,this._listControllerChange,this);
this.__BX.addListener(b,this._treeControllerChange,this);
var be={converter:this._state2loadingConverter};
this.__BW.bind(S,this.__Cb,j,be);
be={converter:this._category2enabledConverter};
this.__BW.bind(f,this.__Ca.getRemoveButton(),m,be);
},_category2enabledConverter:function(bf){return !!bf&&bf.getCategory()==o;
},_state2iconConverter:function(bg){if(bg==c||bg==j){return t;
}else if(bg==P){return M;
}else if(bg==q){return y;
}else if(bg==n){return G;
}return s;
},_state2loadingConverter:function(bh){if(bh==c||bh==j){return true;
}return false;
},_listControllerChange:function(bi){var bj=this.__BW.getSelection().getItem(0);
var bk=this.__BX.getSelection().getItem(0);
if(bk!=undefined){bj.setSelectedArticle(bk);
}},_treeControllerChange:function(bl){var bm=this.__BW.getSelection().getItem(0);
if(bm!=null&&bm.classname==I&&bm.getSelectedArticle()!=null&&bm.getArticles().contains(bm.getSelectedArticle())){qx.event.Timer.once(function(){this.__BX.getSelection().push(bm.getSelectedArticle());
},this,0);
}else{this.__Cb.getList().scrollToY(0);
}},_createLayout:function(){var bn=new qx.ui.layout.Dock();
var bo=new qx.ui.container.Composite(bn);
this.getRoot().add(bo,{edge:0});
this.__oM=new feedreader.view.desktop.Header();
bo.add(this.__oM,{edge:d});
this.__Ca=new feedreader.view.desktop.ToolBar(this);
bo.add(this.__Ca,{edge:d});
this.__Cc=new qx.ui.splitpane.Pane();
bo.add(this.__Cc);
this.__BY=new qx.ui.tree.Tree();
this.__BY.setWidth(250);
this.__BY.setDecorator(h);
this.__BY.setPadding(0);
this.__Cc.add(this.__BY,0);
this.__Cd=new qx.ui.splitpane.Pane(w);
this.__Cd.setDecorator(null);
this.__Cc.add(this.__Cd,1);
this.__Cb=new feedreader.view.desktop.List(this.__Ch);
this.__Cb.setHeight(200);
this.__Cb.setDecorator(h);
this.__Cd.add(this.__Cb,0);
this.__Cf=new feedreader.view.desktop.Article();
this.__Cf.setDecorator(h);
this.__Cd.add(this.__Cf,1);
},_initializeCommands:function(){var bp={};
bp.reload=new qx.ui.core.Command(E);
bp.reload.addListener(l,this.reload,this);
bp.about=new qx.ui.core.Command(T);
bp.about.addListener(l,this.showAbout,this);
bp.preferences=new qx.ui.core.Command(A);
bp.preferences.addListener(l,this.showPreferences,this);
bp.addFeed=new qx.ui.core.Command(Q);
bp.addFeed.addListener(l,this.showAddFeed,this);
bp.removeFeed=new qx.ui.core.Command(L);
bp.removeFeed.addListener(l,this.removeFeed,this);
this.__BQ=bp;
},getCommand:function(bq){return this.__BQ[bq];
},addFeed:function(br,bs,bt){var bu=new feedreader.model.Feed(br,bs,bt);
this.__Ci.getFeeds().push(bu);
var bv=feedreader.io.FeedLoader.getInstance();
bv.load(bu);
},removeFeed:function(){var bw=this.__BW.getSelection().getItem(0);
if(bw&&bw.getCategory&&bw.getCategory()!==N){var bx=this.__Ci.getFeeds();
for(var i=0;i<bx.length;i++){if(bw===bx.getItem(i)){bx.splice(i,1);
return;
}}}},reload:function(){var by=feedreader.io.FeedLoader.getInstance();
by.loadAll(this.__Ch);
this.__Cf.setArticle(null);
},showPreferences:function(){if(!this.__Cl){this.__Ca.signalLoading(k,true);
}qx.io.PartLoader.require([k],function(){this.__Cl=true;
if(!this.__Ce){this.__Ce=new feedreader.view.desktop.PreferenceWindow();
this.getRoot().add(this.__Ce);
}this.__Ce.center();
this.__Ce.open();
this.__Ca.signalLoading(k,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){if(!this.__Ck){this.__Ca.signalLoading(g,true);
}qx.io.PartLoader.require([g],function(){this.__Ck=true;
if(!this.__Cg){this.__Cg=new feedreader.view.desktop.AddFeedWindow(this);
this.getRoot().add(this.__Cg);
}this.__Cg.center();
this.__Cg.open();
this.__Ca.signalLoading(g,false);
},this);
}},destruct:function(){this.__BQ=null;
this._disposeObjects(U,p,u,V,K,C,H,J,v,F,a,D,W,Y);
}});
})();
...
(function(){var d="default",c="Feed Reader",b="feedreader.view.desktop.Header",a="app-header";
qx.Class.define(b,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);
this.setLayout(new qx.ui.layout.HBox);
this.setAppearance(a);
var f=new qx.ui.basic.Label(c);
var e=new qxc.ui.versionlabel.VersionLabel();
e.setFont(d);
this.add(f);
...
(function(){var m="_blank",l="Verdana",k="sans-serif",j="_applyArticle",h="feedreader/css/reader.css",g="blogEntry",f="a",e="Candara",d="white",c="Object",a="auto",b="feedreader.view.desktop.Article";
qx.Class.define(b,{extend:qx.ui.embed.Html,construct:function(){qx.ui.embed.Html.call(this);
if(!feedreader.view.desktop.Article.__BR){feedreader.view.desktop.Article.__BR=true;
var o=qx.util.ResourceManager.getInstance().toUri(h);
qx.bom.Stylesheet.includeFile(o);
}this.setCssClass(g);
this.setOverflowY(a);
this.setBackgroundColor(d);
var n=new qx.bom.Font(14,[e,l,k]);
n.setLineHeight(1.8);
this.setFont(n);
},properties:{article:{apply:j,nullable:true,check:c}},members:{_applyArticle:function(p,q){var r=feedreader.ArticleBuilder.createHtml(this.getArticle(),true);
this.setHtml(r);
qx.html.Element.flush();
var t=this.getContentElement().getDomElement();
var s=t.getElementsByTagName(f);
for(var i=0;i<s.length;i++){s[i].target=m;
}}}});
})();
...
(function(){var m="separator-vertical",l="__Cp",k="Posts",j="bold",i="__By",h="__cd",g="center",f="_applyLoading",e="single",d="feedreader.view.desktop.List",a="middle",c="feedreader/images/loading66.gif",b="Boolean";
qx.Class.define(d,{extend:qx.ui.core.Widget,construct:function(){qx.ui.core.Widget.call(this);
var o=new qx.ui.layout.VBox();
o.setSeparator(m);
this._setLayout(o);
var p=new qx.ui.basic.Label(this.tr(k));
p.setPadding(5);
p.setAllowGrowX(true);
p.setFont(j);
this._add(p);
this.__cd=new qx.ui.container.Stack();
this._add(this.__cd,{flex:1});
this.__Cp=new qx.ui.form.List();
this.__Cp.setDecorator(null);
this.__Cp.setSelectionMode(e);
this.__Cp.setPadding(0);
this.__Cp.setMargin(0);
this.__cd.add(this.__Cp);
this.__By=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,g));
var n=new qx.ui.basic.Image(c);
n.setAlignY(a);
this.__By.add(n);
this.__cd.add(this.__By);
},properties:{loading:{check:b,init:false,apply:f}},members:{__cd:null,__Cp:null,__By:null,_applyLoading:function(q,r){if(q){this.__cd.setSelection([this.__By]);
}else{this.__cd.setSelection([this.__Cp]);
}},getList:function(){return this.__Cp;
}},destruct:function(){this._disposeObjects(l,h,i);
}});
})();
...
(function(){var k="enabled",j="originalIcon",i=")",h="Remove feed",g="Preferences",f="excluded",d="addFeed",c="removeFeed",b="__ks",a="icon/22/actions/help-about.png",H="Reload the feeds. (%1)",G="visible",F="about",E="icon/22/actions/media-seek-forward.png",D="toolbar-button",C="Add feed",B="addfeed",A="icon/22/actions/view-refresh.png",z="(",y="reload",r="showItem",s="settings",p="feedreader.view.desktop.ToolBar",q="Help",n="icon/22/actions/dialog-cancel.png",o="__Cn",l="Reload",m="preferences",t="icon/22/actions/dialog-ok.png",u="icon/22/apps/preferences-theme.png",w="hideItem",v="Open preferences window.",x="feedreader/images/loading22.gif";
qx.Class.define(p,{extend:qx.ui.toolbar.ToolBar,construct:function(I){qx.ui.toolbar.ToolBar.call(this);
this.__kq={};
this.__Cm=new qx.ui.toolbar.Button(this.tr(C),t);
this.__Cm.setCommand(I.getCommand(d));
this.add(this.__Cm);
this.__Cn=new qx.ui.toolbar.Button(this.tr(h),n);
this.__Cn.setCommand(I.getCommand(c));
this.__Cn.setEnabled(false);
this.add(this.__Cn);
this.addSeparator();
var L=new qx.ui.toolbar.Button(this.tr(l),A);
var J=I.getCommand(y);
L.setCommand(J);
L.setToolTipText(this.tr(H,J.toString()));
this.add(L);
this.addSeparator();
this.__Co=new qx.ui.toolbar.Button(this.tr(g),u);
this.__Co.setCommand(I.getCommand(m));
this.__Co.setToolTipText(this.tr(v));
this.add(this.__Co);
this.addSpacer();
var M=new qx.ui.toolbar.Button(this.tr(q),a);
var K=I.getCommand(F);
M.setCommand(K);
M.setToolTipText(z+K.toString()+i);
this.add(M);
this.setOverflowHandling(true);
var N=new qx.ui.toolbar.MenuButton(null,E);
N.setAppearance(D);
this.add(N);
this.setOverflowIndicator(N);
this.__ks=new qx.ui.menu.Menu();
N.setMenu(this.__ks);
this.addListener(w,this._onHideItem,this);
this.addListener(r,this._onShowItem,this);
},members:{__Cn:null,__ks:null,__kq:null,__Cm:null,__Co:null,getRemoveButton:function(){return this.__Cn;
},_onHideItem:function(e){var P=e.getData();
var O=this._getMenuItem(P);
O.setVisibility(G);
},_onShowItem:function(e){var R=e.getData();
var Q=this._getMenuItem(R);
Q.setVisibility(f);
},_getMenuItem:function(S){var T=this.__kq[S.toHashCode()];

if(!T){if(S instanceof qx.ui.toolbar.Button){T=new qx.ui.menu.Button(S.getLabel().translate(),S.getIcon(),S.getCommand());
S.bind(k,T,k);
}else{T=new qx.ui.menu.Separator();
}this.__ks.addAt(T,0);
this.__kq[S.toHashCode()]=T;
}return T;
},signalLoading:function(U,V){if(U==B){var W=this.__Cm;
}else if(U==s){var W=this.__Co;
}else{return ;
}if(V){W.setUserData(j,W.getIcon());
W.setIcon(x);
}else{var X=W.getUserData(j);
W.setIcon(X);
}}},destruct:function(){this._disposeObjects(o,b);
}});
})();
