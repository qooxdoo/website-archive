...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.Fingers","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.Fingers-qx.theme.Modern.80e6afb70344.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="px",k="div",j="50px",h="absolute",g="green",f="100%",d="30px",c="100px",b="innerHTML",a="20px",B="white",A="touchmove",z="black",y="yellow",x="qx.debug",w="0px",v="12px",u="demobrowser.demo.mobile.Fingers",t='Lucida Grande',s="touchstart",q="<b>This demo is supposed to be run in a WebKit-based browser.</b>",r="engine.name",o="red",p="webkit",m="<b>Use your fingers to move the dots</b>",n="blue";
qx.Class.define(u,{extend:qx.application.Native,members:{__OG:null,__OH:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(x)){qx.log.appender.Native;
qx.log.appender.Console;
}var E={"width":f,"height":f,"backgroundColor":z,"margin":w};
var J=new qx.html.Element(k,E);
J.useElement(document.body);
J.setRoot(true);

if(qx.core.Environment.get(r)!=p){var H={"color":g,"position":h,"font-family":t,"font-size":v,"left":d,"top":a};
var F=new qx.html.Element(k,H);
J.add(F);
F.setAttribute(b,q);
return;
}var D={"color":B,"position":h,"left":d,"top":a};
var F=new qx.html.Element(k,D);
J.add(F);
F.setAttribute(b,m);
var G=[n,o,g,B,y];

for(var i=0;i<G.length;i++){var C={"backgroundColor":G[i],"width":c,"height":c,"position":h,"-moz-border-radius":j,"-webkit-border-radius":j,"border-radius":j,"top":((i+5)*30)+l,"left":((i+1)*150)+l};
var I=new qx.html.Element(k,C);
J.add(I);
}this.__OG=[];
this.__OH=[];
J.addListener(s,this._onTouchStart,this);
J.addListener(A,this._onTouchMove,this);
},_onTouchStart:function(e){var L=e.getAllTouches();

for(var i=0;i<L.length;i++){var K=L[i];
this.__OG[i]=parseInt(K.target.style.left)-K.pageX;
this.__OH[i]=parseInt(K.target.style.top)-K.pageY;
}},_onTouchMove:function(e){var N=e.getAllTouches();

for(var i=0;i<N.length;i++){var M=N[i];

if(N.target==document.body){continue;
}qx.bom.element.Style.setStyles(M.target,{"left":(M.pageX+this.__OG[i])+l,"top":(M.pageY+this.__OH[i])+l});
}e.stop();
}}});
})();
