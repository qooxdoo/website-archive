...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.UIDeclaration","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration-qx.theme.Simple.37217b01561f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
var A={clazz:qx.ui.form.Form,children:[{type:j,label:w},{type:l,label:f,validator:null,name:d,widget:{clazz:qx.ui.form.TextField,required:true,width:200}},{type:l,label:h,widget:{clazz:qx.ui.form.TextField}},{type:l,label:n,widget:{clazz:qx.ui.form.TextField}},{type:l,label:c,widget:{clazz:qx.ui.form.TextField}},{type:l,label:t,widget:{clazz:qx.ui.form.DateField}},{type:k,widget:{clazz:qx.ui.form.Button,label:p}},{type:k,widget:{clazz:qx.ui.form.Button,label:r}}]};
var B={clazz:qx.ui.window.Window,layout:{clazz:qx.ui.layout.VBox,spacing:10},layoutProperties:{left:20,top:20},showStatusbar:true,status:b,caption:x,icon:a,id:s,listeners:[{event:y,handler:function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
}},{event:u,handler:function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
}}],children:[{clazz:qx.ui.basic.Atom,label:o,icon:q,rich:true},{clazz:qx.ui.tabview.TabView,layoutProperties:{flex:1},children:[{clazz:qx.ui.tabview.Page,label:g,layoutProperties:{flex:1},layout:{clazz:qx.ui.layout.Canvas},children:[A]},{clazz:qx.ui.tabview.Page,label:v,layoutProperties:{flex:1}},{clazz:qx.ui.tabview.Page,label:z,layoutProperties:{flex:1}}]}]};
this.addFromDefinition(B);
this.win.open();
},addFromDefinition:function(C){var D=this.getRoot();
this.__Au(D,C);
},__Au:function(E,F){var G=new F.clazz();
...
if(J!=null){for(var i=0;i<J.length;i++){if(G instanceof qx.ui.form.Form){this.__Py(G,J[i]);
}else{this.__Au(G,J[i]);
...
}}},__Py:function(L,M){if(M.type===j){L.addGroupHeader(M.label);
return;
...
if(M.type===l){L.add(N,M.label,M.validator,M.name);
}else if(M.type===k){L.addButton(N);
}}}});
})();
...
for(var i=0;i<6*7;i++){var bu=this.__zB[i];
...
for(var bK=0;bK<6;bK++){this.__zC[bK].setValue(cg.format(cc));

for(var i=0;i<7;i++){var ch=this.__zB[bK*7+i];
...
}this.__zA=this.__zB=this.__zC=null;
}});
})();
