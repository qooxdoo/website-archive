...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Placement","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Placement-qx.theme.Classic.91a1f47b3f86.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(o,{extend:qx.application.Standalone,members:{__EE:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var r=this.getRoot();
this.__EE=["bottom-left","bottom-right","top-left","top-right","right-top","right-bottom","left-top","left-bottom"];
...
for(var i=0;i<this.__EE.length;i++){var v=new qx.ui.form.ListItem(this.__EE[i]);
t.add(v);

if(this.__EE[i]==s){x=v;
}}w.add(t);
...
for(var i=0;i<this.__EE.length;i++){z.add(new qx.ui.form.ListItem(this.__EE[i]));
}B.add(z);
...
return B;
}},destruct:function(){this.__EE=null;
}});
})();
