...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window-qx.theme.Modern.226d76f8761d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(i,{extend:qx.application.Native,members:{__AN:null,main:function(){qx.application.Native.prototype.main.call(this);
var n=qx.util.ResourceManager.getInstance();
this.__AN=["http://qooxdoo.org","http://sourceforge.net","http://slashdot.org",n.toUri("demobrowser/demo/html/ModalWindow.html")];
...
this.window1=qx.bom.Window.open(this.__AN[0],g,t);
},this);
...
this.window2=qx.bom.Window.open(this.__AN[3],a,u,true);
},this);
...
this.window3=qx.bom.Window.open(this.__AN[0],c,w,true,false);
},this);
...
qx.Class.define(m,{statics:{__jv:null,__Mc:null,__it:null,__Md:{"top":f,left:d,width:k,height:q,scrollbars:a,resizable:s},__Me:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Mf:function(){return window.showModalDialog!=null;
...
if(x==null){x=true;
}var z=this.__Mg(v,w&&x);

if(w){if(this.__Mf()&&x){C=window.showModalDialog(u,[window.self],z);
}else{this.getBlocker().block();

if(this.__it==null){this.__it=new qx.event.Timer(500);
this.__it.addListener(l,this.__Mh,this);
}this.__Mc=window.open(u,name,z);
this.__it.restart();
C=this.__Mc;
...
},__Mg:function(D,E){var F;
var I;
var G=[];

if(E&&this.__Mf()){for(var H in D){if(qx.bom.Window.__Md[H]){var J=n;

if(H!=h&&H!=s){J=j;
}I=qx.bom.Window.__Md[H]+c+D[H]+J;
G.push(I);
}else{qx.log.Logger.warn("Option '"+H+"' is not supported for modal windows.");
}}F=G.join(b);
}else{for(var H in D){if(qx.bom.Window.__Me[H]){if(qx.lang.Type.isBoolean(D[H])){I=H+r+(D[H]?o:p);
}else{I=H+r+D[H];
}G.push(I);
}else{qx.log.Logger.warn("Option '"+H+"' is not supported for native windows.");
}}F=G.join(i);
}return F;
},__Mh:function(){if(this.isClosed(this.__Mc)){this.getBlocker().unblock();
this.__it.stop();
}},getBlocker:function(){if(this.__jv==null){this.__jv=new qx.bom.Blocker;
}return this.__jv;
