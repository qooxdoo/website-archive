...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Conditional","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional-qx.theme.Modern.6b5c14f7130b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
var L=function(R){var S=[];

for(var T=0;T<R;T++){var x=Math.random()*1000;
S.push({renderer:h,location:d,data:[T,x,x]});
}return S;
};
var O=new qx.ui.progressive.renderer.table.Widths(3);
var J=[v,b,t];
var K=new qx.ui.progressive.headfoot.TableHeading(O,J);
var I=new qx.ui.progressive.headfoot.Progress(O,J);
var Q=new qx.ui.progressive.structure.Default(K,I);
var H=new qx.ui.progressive.Progressive(Q);
var N=new qx.ui.progressive.model.Default();
var M=L(100);
N.addElements(M);
H.setDataModel(N);
var P=new qx.ui.progressive.renderer.table.Row(O);
H.addRenderer(h,P);
...
for(var i=0;i<e;i++){this.__LH[i]=new qx.ui.core.ColumnData();
}},members:{__LH:null,getData:function(){return this.__LH;
...
}}},setWidth:function(j,k){if(j>this.__LH.length-1||j<0){throw new Error("Column number out of range");
}this.__LH[j].setColumnWidth(k);
},setMinWidth:function(l,m){if(l>this.__LH.length-1||l<0){throw new Error("Column number out of range");
}this.__LH[l].setMinWidth(m);
},setMaxWidth:function(n,o){if(n>this.__LH.length-1||n<0){throw new Error("Column number out of range");
}this.__LH[n].setMaxWidth(o);
}}});
})();
...
},members:{__IC:null,join:function(c){this.__IC=c;
}},destruct:function(){this.__IC=null;
}});
})();
...
},properties:{appearance:{refine:true,init:c}},members:{__Iz:null,__JA:null,__FT:null,__nH:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);
},getLayoutChildren:function(){if(this.__JA){return this.__Iz.getData();
...
this.__JA=true;
this.__nH.renderLayout(n,100);
this.__JA=false;
var o=this.__Iz.getData();
for(var i=0;i<o.length;i++){this.__FT[i].setWidth(o[i].getComputedWidth());
}}},destruct:function(){this.__Iz=this.__FT=null;
this._disposeObjects(b);
}});
})();
(function(){var n="progressive-progressbar-indicator-undone",m="progress",l="%",k="progressive-progressbar-indicator-done",j="progressive-progressbar-percent-text",i="renderStart",h="progressive-progressbar-background",g="0%",f="__Ln",d="qx.ui.progressive.headfoot.Progress",a="__Lo",c="progressive-progressbar-percent-background",b="renderEnd";
...
this.__ID.background=q.resolve(h);
this.__ID.indicatorDone=q.resolve(k);
this.__ID.indicatorUndone=q.resolve(n);
this.__ID.percentBackground=q.resolve(c);
this.__ID.percentText=q.resolve(j);
this.set({backgroundColor:this.__ID.background});
this.__Ln=new qx.ui.core.Widget();
this.__Ln.set({width:0,backgroundColor:this.__ID.indicatorDone});
this.add(this.__Ln);
var r=new qx.ui.core.Widget();
r.set({backgroundColor:this.__ID.indicatorUndone});
this.add(r,{flex:1});
this.__Lo=new qx.ui.basic.Atom(g);
this.__Lo.set({width:100,backgroundColor:this.__ID.percentBackground,textColor:this.__ID.percentText});
this.add(this.__Lo);
this.exclude();
},members:{__Lp:null,__ID:null,__Ln:null,__Lo:null,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);
s.addListener(i,function(e){this.__Lp=e.getData().initial;
this.show();
},this);
s.addListener(m,function(e){var v=1.0-(e.getData().remaining/this.__Lp);
var w=this.getBounds();

if(w){var t=Math.floor((w.width-this.__Lo.getBounds().width)*v);
var u=Math.floor(v*100)+l;

if(!isNaN(t)){this.__Ln.setMinWidth(t);
this.__Lo.setLabel(u);
}}},this);
s.addListener(b,function(e){this.exclude();
},this);
}},destruct:function(){this.__ID=null;
this._disposeObjects(f,a);
}});
})();
...
if(!e){this.__DE=new qx.ui.core.Widget();
this.__zn=this.__DE;
}else{this.__DE=null;
this.__zn=e;
}this.__zn.getContentElement().setStyle(b,a);
},members:{__DE:null,__zn:null,applyStructure:function(f){throw new Error("applyStructure() is abstract");
},getPane:function(){return this.__zn;
}},destruct:function(){if(this.__DE){this.__DE.dispose();
}this.__DE=this.__zn=null;
}});
})();
...
if(!b){this.__Jp=new qx.ui.progressive.headfoot.Null();
this.__oM=this.__Jp;
}else{this.__Jp=null;
this.__oM=b;
}if(!c){this.__Jq=new qx.ui.progressive.headfoot.Null();
this.__Jr=this.__Jq;
}else{this.__Jq=null;
this.__Jr=c;
}},members:{__oM:null,__Jr:null,__Jp:null,__Jq:null,applyStructure:function(e){this.__oM.join(e);
this.__Jr.join(e);
e.add(this.__oM);
e.add(this.getPane(),{flex:1});
e.add(this.__Jr);
},getHeader:function(){return this.__oM;
},getFooter:function(){return this.__Jr;
}},destruct:function(){if(this.__Jp){this.__Jp.dispose();
this.__Jp=null;
}
if(this.__Jq){this.__Jq.dispose();
this.__Jq=null;
}this.__oM=this.__Jr=null;
}});
})();
...
this.__KD=false;
this.__KE=0;
},events:{"renderStart":k,"renderEnd":k,"progress":k,"progressDetail":k},properties:{dataModel:{check:c,apply:f},batchSize:{check:g,init:20},flushWidgetQueueAfterBatch:{check:d,init:false},interElementTimeout:{check:g,init:0}},members:{__FU:null,__KD:null,__KF:null,__KE:null,__KC:null,__KB:null,getStructure:function(){return this.__KB;
},addRenderer:function(name,m){this.__FU[name]=m;
m.join(this,name);
},removeRenderer:function(name){if(!this.__FU[name]){throw new Error("No existing renderer named "+name);
}delete this.__FU[name];
},render:function(){if(this.__KD){return;
}this.__KD=true;
var n=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__KB.getPane(),batchSize:this.getBatchSize(),rendererData:this.__KH(),userData:{}});
this.__KF=new Date();
if(this.__KC){this.__KE=n.getModel().getElementCount();
this.fireDataEvent(h,{state:n,initial:this.__KE});
this.__KG(n);
}else{qx.event.Timer.once(function(){this.__KE=n.getModel().getElementCount();
this.fireDataEvent(h,{state:n,initial:this.__KE});
this.__KG(n);
this.__KC=true;
},this,10);
}},_applyDataModel:function(o,p){if(p){p.removeListener(j,this.__KI,this);
p.dispose();
}o.addListener(j,this.__KI,this);
},__KG:function(q){var r;
var t;
var s;

for(var i=q.getBatchSize();i>0;i--){r=q.getModel().getNextElement();

if(!r){this.debug("Render time: "+(new Date()-this.__KF)+"ms");
this.__KD=false;
this.fireDataEvent("renderEnd",q);
q.dispose();
return ;
}t=r.element;
s=this.__FU[t.renderer];
s.render(q,t);
this.fireDataEvent("progressDetail",{initial:this.__KE,remaining:r.remaining,element:t});
}this.fireDataEvent("progress",{initial:this.__KE,remaining:r.remaining});
if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();
}qx.event.Timer.once(function(){this.__KG(q);
},this,this.getInterElementTimeout());
},__KH:function(){var u={};

for(var name in this.__FU){u[name]={};
}return u;
},__KI:function(e){this.__KE=e.getData();
this.render();
}},destruct:function(){for(var name in this.__FU){this.__FU[name].dispose();
}this.__KF=this.__FU=this.__KB=null;
}});
})();
...
this.__AT=[];
},members:{__AT:null,addElements:function(c){this.__AT=this.__AT.concat(c);
this.fireDataEvent(b,this.__AT.length);
},addElement:function(d){this.__AT.push(d);
this.fireDataEvent(b,this.__AT.length);
},getElementCount:function(){return this.__AT.length;
},getNextElement:function(){if(this.__AT.length>0){return ({element:this.__AT.shift(),remaining:this.__AT.length});
}return null;
}},destruct:function(){this.__AT=null;
}});
})();
...
(function(){var l=".qx-progressive-",k="-col-",j="px;",h="-row",g="}",f="width: ",d="0px ",c="qx-progressive-",b="px",a="content",G="px ",F="__IB",E="end",D="div",C="qx.tableResizeDebug",B="  width : 100%;",A=" {",z="__columnData",y="css.boxmodel",x="qx.debug",s="relative",t="-row {",q="resize",r="start",o="",p="padding: ",m="qx.ui.progressive.renderer.table.Row",n="progressive-table-row-background-odd",u="progressive-table-row-background-even",v="left: ",w="__nH";
qx.Class.define(m,{extend:qx.ui.progressive.renderer.Abstract,construct:function(H){qx.ui.progressive.renderer.Abstract.call(this);
this.__Iz=H;
this.__IA={};
this.__IB=new qx.ui.progressive.renderer.table.cell.Default();
this.__IC=null;
this.__ID={};
var I=qx.theme.manager.Color.getInstance();
this.__ID.bgcol=[];
this.__ID.bgcol[0]=I.resolve(u);
this.__ID.bgcol[1]=I.resolve(n);
this.__nH=new qx.ui.layout.HBox();
this.__nH.connectToWidget(this);
},statics:{__mV:null,__IE:6,__IF:"  position: absolute;"+"  top: 0px;"+"  height: 100%;"+"  overflow:hidden;"+(qx.core.Environment.get("css.textoverflow")?qx.lang.String.hyphenate(qx.core.Environment.get("css.textoverflow"))+':ellipsis;':"")+"  white-space:nowrap;"+"  border-right:1px solid #f2f2f2;"+"  border-bottom:1px solid #eeeeee;"+"  padding : 0px 6px 0px 6px;"+"  cursor:default;"+"  font-size: 11px;"+"  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;"+(qx.core.Environment.get("css.userselect")?qx.lang.String.hyphenate(qx.core.Environment.get("css.userselect"))+':'+qx.core.Environment.get("css.userselect.none")+';':'')},properties:{defaultRowHeight:{init:16}},members:{__IC:null,__AL:null,__IG:null,__Iz:null,__IA:null,__IB:null,__ID:null,__nH:null,join:function(J,name){if(this.__IC){throw new Error("Renderer is already joined to a Progressive.");
}this.__IC=J;
this.__AL=name;
...
if(!L.__mV[K]){L.__mV[K]={rowstylesheet:null,cellstylesheet:[]};
var M=l+K+t+B+g;
L.__mV[K].rowstylesheet=qx.bom.Stylesheet.createElement(M);
var N=this.__Iz.getData();

for(var i=0;i<N.length;i++){var M=l+K+k+i+A+L.__IF+g;
L.__mV[K].cellstylesheet[i]=qx.bom.Stylesheet.createElement(M);
}this.__IG=K;
var O=J.getStructure().getPane();
O.addListener(q,this._resizeColumns,this);
}},addRenderer:function(P,Q){var R=this.__Iz.getData();

if(P<0||P>=R.length){throw new Error("Column "+P+" out of range (max: "+(R.length-1)+")");
}this.__IA[P]=Q;
},removeRenderer:function(S){var T=this.__Iz.getData();

if(S<0||S>=T.length){throw new Error("Column "+S+" out of range (max: "+(T.length-1)+")");
}
if(!this.__IA[S]){throw new Error("No existing renderer for column "+S);
}delete this.__IA[S];
...
var bc;
var Y=0;
if(U.getRendererData()[this.__AL].end===undefined){U.getRendererData()[this.__AL]={end:0,start:1,rows:0,totalHeight:0};
}var bf=document.createElement(D);
for(var i=0;i<bg.length;i++){var ba=c+this.__IG+k+i;
bc=this.__IA[i]||this.__IB;
...
var be=U.getRendererData()[this.__AL];
be.totalHeight+=Y;
bf.style.position=s;
bf.style.height=Y+b;
bf.className=c+this.__IG+h;
bf.innerHTML=bb.join(o);
switch(V.location){case E:var W=be.end||0;
bf.style.backgroundColor=this.__ID.bgcol[W];
be.end=(W==0?1:0);
...
},getLayoutChildren:function(){return this.__Iz.getData();
},_resizeColumns:function(e){var bp=this.__IC.getStructure().getPane();
var bm=bp.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bn=l+this.__IG+h;
var bj=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bj.__mV[this.__IG].rowstylesheet,bn);
var bl=f+bm+j;
qx.bom.Stylesheet.addRule(bj.__mV[this.__IG].rowstylesheet,bn,bl);
this.__nH.renderLayout(bm,100);
var bo=this.__Iz.getData();
for(var i=0,bs=0;i<bo.length;i++,bs+=bm){var bn=l+this.__IG+k+i;
var bj=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bj.__mV[this.__IG].cellstylesheet[i],bn);
bm=bo[i].getComputedWidth();

if(qx.core.Environment.get(x)){if(qx.core.Environment.get(C)){this.debug("col "+i+": width="+bm);
}}var bk;

if(qx.core.Environment.get(y)==a){bk=qx.ui.progressive.renderer.table.Row.__IE*2;
}else{bk=-1;
}var br=(bm-bk)+j;
var bq=d+qx.ui.progressive.renderer.table.Row.__IE+G+d+qx.ui.progressive.renderer.table.Row.__IE+j;
var bi=bs+j;
var bl=bj.__IF+f+br+v+bi+p+bq;
qx.bom.Stylesheet.addRule(bj.__mV[this.__IG].cellstylesheet[i],bn,bl);
}}},destruct:function(){var name;

for(name in this.__IA){this.__IA[name]=null;
}var bu=qx.ui.progressive.renderer.table.Row;
var bt=this.__IC.toHashCode();

if(bu.__mV&&bu.__mV[bt]){if(bu.__mV[bt].rowstylesheet){var bw=l+this.__IG+h;
var bu=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bu.__mV[this.__IG].rowstylesheet,bw);
}if(bu.__mV[bt].cellstylesheet){for(var i=bu.__mV[bt].cellstylesheet.length-1;i>=0;i--){var bw=l+this.__IG+k+i;
var bv=bu.__mV[this.__IG].cellstylesheet[i];
var bu=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bv,bw);
}}}
if(this.__IC&&this.__IC.getRendererData){var bx=this.__IC.getRendererData();

if(bx&&bx[this.__AL]&&bx[this.__AL].end!==undefined){bx[this.__AL]=null;
}}this.__ID=this.__IA=this.__IC=this.__Iz=null;
this._disposeObjects(w,F,z);
}});
})();
...
this.__xX=v||s;
this.__xY=w||s;
},members:{__Js:null,__Jt:null,__Ju:null,__xV:null,__xW:null,__xX:null,__xY:null,__ya:function(x,y){if(x.align){y[h]=x.align;
}
...
}},addNumericCondition:function(z,A,B,C,D,E,F){if(!qx.lang.Array.contains(this.__Js,z)||A==null){throw new Error("Condition not recognized or value is null!");
}this.__Ju.push({condition:z,align:B,color:C,style:D,weight:E,value1:A,target:F});
},addBetweenCondition:function(G,H,I,J,K,L,M,N){if(!qx.lang.Array.contains(this.__Jt,G)||H==null||I==null){throw new Error("Condition not recognized or value1/value2 is null!");
}this.__Ju.push({condition:G,align:J,color:K,style:L,weight:M,value1:H,value2:I,target:N});
},addRegex:function(O,P,Q,R,S,T){if(!O){throw new Error("regex cannot be null!");
}this.__Ju.push({condition:o,align:P,color:Q,style:R,weight:S,regex:O,target:T});
},_getCellStyle:function(U){if(this.__Ju.length==0){return U.style||s;
}var i;
var Y;
var V;
var X={"text-align":this.__xV,"color":this.__xW,"font-style":this.__xX,"font-weight":this.__xY};

for(i=0;i<this.__Ju.length;i++){var bc=this.__Ju[i];
Y=false;

if(qx.lang.Array.contains(this.__Js,bc.condition)){if(bc.target==null){V=U.cellData;
...
}}else if(qx.lang.Array.contains(this.__Jt,bc.condition)){if(bc.target==null){V=U.cellData;
}else{V=U.element.data[bc.target];
}
...
}},destruct:function(){this.__Js=this.__Jt=this.__Ju=null;
}});
})();
