...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline-qx.theme.Modern.0dce1f30587b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="qx.data.store.Offline",d="session",c="qx.debug",b="_applyModel",a="changeModel";
qx.Class.define(f,{extend:qx.core.Object,construct:function(g,h){qx.core.Object.call(this);

try{if(qx.core.Environment.get(c)){this.assertNotUndefined(g);
...
},properties:{model:{nullable:true,event:a,apply:b}},members:{_storage:null,__BJ:null,_applyModel:function(i,j){if(j){j.removeListenerById(this.__BJ);
j.dispose();
this.__BJ=null;
}
if(i){this.__BJ=i.addListener("changeBubble",this.__BK,this);
this.__BK();
}else{this._storage.removeItem(this._key);
}},__BK:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());
