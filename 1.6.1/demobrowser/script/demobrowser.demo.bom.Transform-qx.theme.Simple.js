...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Transform","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Transform-qx.theme.Simple.69dedfc0276a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="45deg",i="10deg",h="20deg",g="15deg",f="25deg",e="10px",d="150deg",c="50px",b='label',a="40deg",S="flat",R="preserve-3d",Q="perspective30",P="css.transform.3d",O="CSS transforms not supported, sorry!",N="bottom left",M="origin-rt",L="skew",K="scale",J="3dpart",q="perspective100",r="50% 50%",o="bottom right",p="origin-lb",m="perorig-br",n="rotate",k="center",l="visible",s="perspective1000",t="perorig-bl",A="perorig-c",y="combo",D="",C="perspective500",F="left bottom",E="demobrowser.demo.bom.Transform",v="origin-c",I="none",H="css.transform",G="translate",u="<br><br>Your browser does not support 3D CSS transforms, sorry!",w="hidden",x="3d",z="right top",B="display";
qx.Class.define(E,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(H)==null){document.body.innerHTML=D;
var U=document.createElement(b);
U.innerHTML=O;
document.body.appendChild(U);
return;
}var T=document.getElementById(K);
qx.bom.element.Transform.scale(T,0.8);
T=document.getElementById(G);
qx.bom.element.Transform.translate(T,[e,e]);
T=document.getElementById(n);
qx.bom.element.Transform.rotate(T,j);
T=document.getElementById(L);
qx.bom.element.Transform.skew(T,f);
T=document.getElementById(y);
qx.bom.element.Transform.transform(T,{rotate:f,scale:[1.2,0.6],skew:[h,i]});
T=document.getElementById(v);
qx.bom.element.Transform.setOrigin(T,r);
qx.bom.element.Transform.transform(T,{rotate:g});
T=document.getElementById(p);
qx.bom.element.Transform.setOrigin(T,F);
qx.bom.element.Transform.transform(T,{rotate:g});
T=document.getElementById(M);
qx.bom.element.Transform.setOrigin(T,z);
qx.bom.element.Transform.transform(T,{rotate:g});
if(qx.core.Environment.get(P)){T=document.getElementById(S);
qx.bom.element.Transform.setStyle(T,S);
qx.bom.element.Transform.transform(T,{rotate:[h,a]});
qx.bom.element.Transform.transform(T.children[0],{translate:[null,null,c]});
T=document.getElementById(x);
qx.bom.element.Transform.setStyle(T,R);
qx.bom.element.Transform.transform(T,{rotate:[h,a]});
qx.bom.element.Transform.transform(T.children[0],{translate:[null,null,c]});
T=document.getElementById(Q);
qx.bom.element.Transform.setPerspective(T,30);
qx.bom.element.Transform.transform(T.children[0],{rotate:[j]});
T=document.getElementById(q);
qx.bom.element.Transform.setPerspective(T,100);
qx.bom.element.Transform.transform(T.children[0],{rotate:[j]});
T=document.getElementById(C);
qx.bom.element.Transform.setPerspective(T,500);
qx.bom.element.Transform.transform(T.children[0],{rotate:[j]});
T=document.getElementById(s);
qx.bom.element.Transform.setPerspective(T,1000);
qx.bom.element.Transform.transform(T.children[0],{rotate:[j]});
T=document.getElementById(A);
qx.bom.element.Transform.setPerspective(T,100);
qx.bom.element.Transform.setPerspectiveOrigin(T,k);
qx.bom.element.Transform.transform(T.children[0],{rotate:[j]});
T=document.getElementById(t);
qx.bom.element.Transform.setPerspective(T,100);
qx.bom.element.Transform.setPerspectiveOrigin(T,N);
qx.bom.element.Transform.transform(T.children[0],{rotate:[j]});
T=document.getElementById(m);
qx.bom.element.Transform.setPerspective(T,100);
qx.bom.element.Transform.setPerspectiveOrigin(T,o);
qx.bom.element.Transform.transform(T.children[0],{rotate:[j]});
T=document.getElementById(l);
qx.bom.element.Transform.setPerspective(T,50);
qx.bom.element.Transform.setBackfaceVisibility(T,true);
qx.bom.element.Transform.transform(T,{rotate:[null,d,i]});
T=document.getElementById(w);
qx.bom.element.Transform.setPerspective(T,100);
qx.bom.element.Transform.setBackfaceVisibility(T,false);
qx.bom.element.Transform.transform(T,{rotate:[null,d,i]});
}else{document.getElementById(J).style[B]=I;
var U=document.createElement(b);
U.innerHTML=u;
document.body.appendChild(U);
}}}});
