...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SingleValueBinding","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SingleValueBinding-qx.theme.Simple.2563a47f4a0a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="qx.data.Array",r="demobrowser.demo.data.model.Node",q="String",p="changeNames",o="changeName",n="Validation Error: ",m="- ",l="",k="changeChild",j="changeColor",c="Marge",h="AFFE",f="is no number (parseFloat says so!).",b="Homer",a="\n",e="__Oq",d="changeName2",g="changeChildren";
qx.Class.define(r,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:s,event:g},child:{check:r,event:k,nullable:true},names:{check:s,event:p,init:new qx.data.Array(b,c)},name:{check:q,init:h,event:o},name2:{check:q,event:d},number:{init:10,validate:e},color:{event:j,nullable:true}},members:{__Oq:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
