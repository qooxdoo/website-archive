...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Modern.ffdfe0da298f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="div",j="50px",i="absolute",h="touchmove",g="url(",f=")",d="green",c="200px",b="30px",a="qx.debug",w="12px",v="event.touch",u="touchend",t='Lucida Grande',s="innerHTML",r="demobrowser.demo.mobile.ScaleImage",q="59px",p="engine.name",o="demobrowser/demo/mobile/qooxdoo-logo.png",n="20px",l="webkit",m="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(r,{extend:qx.application.Native,members:{__DC:null,__Pa:1,__Pb:0,__Pc:0,__Pd:0,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(a)){qx.log.appender.Native;
qx.log.appender.Console;
}var z=new qx.html.Element(k);
z.useElement(document.body);
z.setRoot(true);

if(qx.core.Environment.get(p)!=l||!qx.core.Environment.get(v)){var y={"color":d,"position":i,"font-family":t,"font-size":w,"left":b,"top":n};
var B=new qx.html.Element(k,y);
z.add(B);
B.setAttribute(s,m);
return;
}var A=qx.util.ResourceManager.getInstance().toUri(o);
var x={"width":c,"height":q,"position":i,"left":j,"top":j,"background":g+A+f};
this.__DC=new qx.html.Element("div",x);
this.__DC.addListener(h,this.__CG,this);
this.__DC.addListener(u,this.__CF,this);
z.add(this.__DC);
},__CG:function(e){if(e.isMultiTouch()){this.__Pc=e.getRotation()+this.__Pb;
this.__Pd=e.getScale()*this.__Pa;
this.__DC.setStyle("-webkit-transform","rotate("+this.__Pc+"deg) scale("+this.__Pd+")");
}else{var C=parseInt(e.getDocumentLeft())-(parseInt(this.__DC.getStyle("width"))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__DC.getStyle("height"))/2);
this.__DC.setStyles({"left":C+"px","top":top+"px"});
}},__CF:function(e){if(e.isMultiTouch()){this.__Pb=this.__Pc;
this.__Pa=this.__Pd;
}}}});
})();
