...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Window_Editor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Window_Editor-qx.theme.Classic.f575406ad450.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
A.moveTo(300,250);
A.addListener(c,function(e){A.__pm.focus();
A.__pm.setTextSelection(0,A.__pm.getValue().length);
});
A.__pm=new qx.ui.form.TextField(x.value+j).set({allowGrowY:true});
A.add(A.__pm);
...
return A;
},getCellEditorValue:function(B){return parseFloat(B.__pm.getValue());
}}});
})();
...
this.__nD=false;
this.__nE=false;
},properties:{behavior:{check:j,init:null,nullable:true,apply:h,event:e}},members:{__nE:null,__nD:null,__mi:null,_applyBehavior:function(r,s){if(s!=null){s.dispose();
s=null;
