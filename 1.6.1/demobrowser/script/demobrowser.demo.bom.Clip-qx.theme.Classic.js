...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Clip","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Clip-qx.theme.Classic.59b7ac307c86.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var b="test1",a="demobrowser.demo.bom.Clip";
...
var d=qx.bom.element.Clip.get(c)||{};
qx.log.Logger.debug("Clip init: "+d.left+","+d.top+"  "+d.width+","+d.height);
},set0:function(){var e=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  120,40");
qx.bom.element.Clip.set(e,{left:20,top:20,width:120,height:40});
var f=qx.bom.element.Clip.get(e)||{};
qx.log.Logger.debug("Clip after: "+f.left+","+f.top+"  "+f.width+","+f.height);
},set1:function(){var g=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  null,40");
qx.bom.element.Clip.set(g,{left:20,top:20,height:40});
var h=qx.bom.element.Clip.get(g)||{};
qx.log.Logger.debug("Clip after: "+h.left+","+h.top+"  "+h.width+","+h.height);
},set2:function(){var i=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  120,null");
qx.bom.element.Clip.set(i,{left:20,top:20,width:120});
var j=qx.bom.element.Clip.get(i)||{};
qx.log.Logger.debug("Clip after: "+j.left+","+j.top+"  "+j.width+","+j.height);
},set3:function(){var k=document.getElementById(b);
qx.log.Logger.debug("Setting to: null,20  120,40");
qx.bom.element.Clip.set(k,{top:20,width:120,height:40});
var l=qx.bom.element.Clip.get(k)||{};
qx.log.Logger.debug("Clip after: "+l.left+","+l.top+"  "+l.width+","+l.height);
},set4:function(){var m=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,null  120,40");
qx.bom.element.Clip.set(m,{left:20,width:120,height:40});
var n=qx.bom.element.Clip.get(m)||{};
qx.log.Logger.debug("Clip after: "+n.left+","+n.top+"  "+n.width+","+n.height);
},reset:function(){var o=document.getElementById(b);
qx.log.Logger.debug("Resetting");
qx.bom.element.Clip.reset(o);
var p=qx.bom.element.Clip.get(o)||{};
qx.log.Logger.debug("Clip after: "+p.left+","+p.top+"  "+p.width+","+p.height);
}}});
})();
