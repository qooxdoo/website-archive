...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.DragDrop","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop-qx.theme.Simple.bdec60f76b87.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="drop",k="value",j="items",h="move",g="multi",f="dragover",d="icon/16/places/folder.png",c="dragstart",b="Item ",a="copy",z="drag",y="TextArea Target",x="solid",w="Reorderable",v="droprequest",u="#33508D",t="Source",s="demobrowser.demo.ui.DragDrop",r="Simple Target",q="Enable drag",o="__Cp",p="\n",n="dragend";
qx.Class.define(s,{extend:qx.application.Standalone,members:{__Cp:null,__PG:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var L=this.getRoot();
...
}var M=new qx.ui.form.CheckBox(q);
M.setValue(true);
...
I.addListener(v,function(e){this.debug("Related of droprequest: "+e.getRelatedTarget());
...
var H=new qx.ui.basic.Label(w);
D.add(H,{left:500,top:20});
var B=this.__Cp=new qx.ui.form.List;
B.setDraggable(true);
B.setDroppable(true);
...
C.setDecorator(new qx.ui.decoration.Single().set({top:[1,x,u]}));
C.setHeight(0);
C.setOpacity(0.5);
C.setZIndex(100);
...
B.addListener(z,function(e){var U=e.getOriginalTarget();
if(U instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__PG=U;
}
...
B.addListener(m,function(e){this.__PH(e.getOriginalTarget());
},this);
C.addListener(m,function(e){this.__PH(this.__PG);
},this);
},__PH:function(V){if(V.classname!="qx.ui.form.ListItem"){return;
}var W=this.__Cp.getSortedSelection();

for(var i=0,l=W.length;i<l;i++){this.__Cp.addBefore(W[i],V);
this.__Cp.addToSelection(W[i]);
