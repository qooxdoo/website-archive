...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip-qx.theme.Modern.4a0ee1c7af4d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},__Qk:4,__Ql:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Ql/this.__Qk),column:this.__Ql%this.__Qk});
this.__Ql+=1;
