...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.AutoSizeTextArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea-qx.theme.Classic.94a417771c29.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="Maximal height",k="wrap",j="Wrap handling",h="Minimal height",g="value",f="Non-default minimal line height",e="demobrowser.demo.ui.AutoSizeTextArea",d="The quick brown fox…",c="Regular",b="Auto-Size",a="Wrap";
qx.Class.define(e,{extend:qx.application.Standalone,construct:function(){qx.application.Standalone.call(this);
},members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var n=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));
this.getRoot().add(n,{top:20,left:20});
var q=new qx.ui.basic.Label();
q.setValue(c);
var o=new qx.ui.form.TextArea();
o.set({allowStretchY:false,value:this.__PF()});
n.add(q,{row:0,column:0});
n.add(o,{row:1,column:0});
q=new qx.ui.basic.Label();
q.setValue(b);
var u=new qx.ui.form.TextArea();
u.set({allowStretchY:false,value:this.__PF(),autoSize:true});
n.add(q,{row:0,column:1});
n.add(u,{row:1,column:1});
q=new qx.ui.basic.Label();
q.setValue(f);
var v=new qx.ui.form.TextArea();
v.set({allowStretchY:false,value:d,autoSize:true,minimalLineHeight:1,maxHeight:300});
n.add(q,{row:0,column:2});
n.add(v,{row:1,column:2});
q=new qx.ui.basic.Label();
q.setValue(h);
var r=new qx.ui.form.TextArea();
r.set({allowStretchY:false,value:this.__PF(),autoSize:true,minHeight:200});
n.add(q,{row:2,column:0});
n.add(r,{row:3,column:0});
q=new qx.ui.basic.Label();
q.setValue(l);
var p=new qx.ui.form.TextArea();
p.set({allowStretchY:false,value:this.__PF(),autoSize:true,minHeight:200,maxHeight:300});
n.add(q,{row:2,column:1});
n.add(p,{row:3,column:1});
q=new qx.ui.basic.Label();
q.setValue(j);
var s=new qx.ui.form.TextArea();
s.set({allowStretchY:false,value:this.__PF(),autoSize:true,minimalLineHeight:2});
var m=new qx.ui.form.CheckBox(a);
m.setValue(false);
m.setAllowStretchX(false);
m.bind(g,s,k);
n.add(q,{row:2,column:2});
var t=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));
n.add(t,{row:3,column:2});
t.add(s,{row:0,column:0});
t.add(m,{row:1,column:0});
},__PF:function(){var w=new qx.type.Array(2);

for(var i=0;i<w.length;i++){w[i]="The quick brown fox jumps over the lazy dog. ";
}return w.join("");
}}});
})();
