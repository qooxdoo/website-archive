...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager-qx.theme.Simple.b2fd3d3de4d3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="Stopping recurrent 2-second timer",i="Recurrent 2-second timer with limit 3:",h="__GT",g="\n",f="One-shot 1-second timer: ",e=" ",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__GT:null,startTimers:function(){var k=qx.util.TimerManager.getInstance();
k.start(function(l,m){this.__Pr(c+m);
},5000,this,null,0);
k.start(function(n,o){this.__Pr(f+o);
},0,this,null,1000);
k.start(function(p,q){this.__Pr(i+q);

if(++p.count==3){this.__Pr(j);
k.stop(q);
}},2000,this,{count:0},2000);
},__Pr:function(r){r=Date.parse(new Date)+e+r+g;
this.__GT.setValue(this.__GT.getValue()+r);
...
u.addListener(a,function(){u.setEnabled(false);
this.startTimers();
},this);
