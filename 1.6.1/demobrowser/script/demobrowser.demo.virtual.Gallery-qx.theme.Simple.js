...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery-qx.theme.Simple.7e3785e0b87b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__PO=new demobrowser.demo.virtual.GalleryCell();
...
if(bx){this.__PO.updateStates(bz,{selected:1});
}else{this.__PO.updateStates(bz,{});
...
}var bF=this.__PO.getCellWidget(bG,bE);
bF.setUserData(j,bD);
return bF;
},poolCellWidget:function(bH){this.__PO.pool(bH);
}},destruct:function(){this._disposeObjects(x,h);
}});
...
(function(){var l="scroll",k="scrollbar-x",j="scrollbar-y",i="_applyInterval",h="__it",g="appear",f="qx.debug",e="interval",d="qx.ui.virtual.behavior.Prefetch",c="_applyScroller",a="qx.ui.virtual.core.Scroller",b="Integer";
qx.Class.define(d,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(f)){this.assertObject(n);
...
}},properties:{scroller:{check:a,nullable:true,init:null,apply:c},interval:{check:b,init:200,apply:i}},members:{__ww:null,__wx:null,__it:null,__wy:null,__wz:null,setPrefetchX:function(o,p,q,r){this.__ww=[o,p,q,r];
},setPrefetchY:function(s,t,u,v){this.__wx=[s,t,u,v];
},_onInterval:function(){var w=this.__ww;
...
qx.ui.core.queue.Manager.flush();
}},_applyScroller:function(y,z){if(z){if(this.__wy){z.getChildControl(k).removeListenerById(this.__wy);
}
if(this.__wz){z.getChildControl(j).removeListenerById(this.__wz);
}}
if(y){if(!y.getContainerElement().getDomElement()){this.__it.stop();
y.addListenerOnce(g,this.__it.start,this.__it);
}else{this.__it.restart();
}this.__wy=y.getChildControl(k).addListener(l,this.__it.restart,this.__it);
this.__wz=y.getChildControl(j).addListener(l,this.__it.restart,this.__it);
}else{this.__it.stop();
}},_applyInterval:function(A,B){this.__it.setInterval(A);
...
},properties:{defaultLineColor:{init:e,check:c,themeable:true},defaultLineSize:{init:1,check:b,themeable:true}},members:{__HS:null,__HT:null,isHorizontal:function(){return this._isHorizontal;
...
if(this.__HU(l)){this.updateLayerData();
...
if(this.__HU(n)){this.updateLayerData();
}},__HU:function(p){if(this._isHorizontal){var t=this.getFirstColumn();
var r=t+this.getColumnSizes().length-1;
return p>=t&&p<=r;
}else{var s=this.getFirstRow();
var q=s+this.getRowSizes().length-1;
return p>=s&&p<=q;
}},getLineSize:function(u){return this.__HT[u]||this.getDefaultLineSize();
},getLineColor:function(v){return this.__HS[v]||this.getDefaultLineColor();
},__HV:function(w,z,A){var top=0;
var B,C;
...
if(this._isHorizontal){this.__HV(N,J,L);
}else{this.__HW(N,K,M);
