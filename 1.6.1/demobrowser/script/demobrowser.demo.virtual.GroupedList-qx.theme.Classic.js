...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.GroupedList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Classic.9df3340c7071.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(h,{extend:qx.application.Standalone,members:{__Cp:null,__PP:null,__PQ:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
M.bind(l,this.__Cp,j);
M.bind(l,this.__PP,j);
M.bind(l,this.__PQ,j);
...
O.add(P);
var N=this.__Cp=new qx.ui.list.List().set({height:280,width:150,labelPath:g,labelOptions:{converter:function(Q,R){return R?Q+m+R.getLastname():o;
}}});
O.add(N,{top:20});
return O;
...
T.add(V);
var S=this.__PP=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(W,X){return X?X.getLastname()+", "+W:"no model...";
}}});
T.add(S,{top:20});
...
S.setDelegate(U);
S.setSelection(this.__Cp.getSelection());
return T;
...
bb.add(bd);
var ba=this.__PQ=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(be,bf){return bf?be+" "+bf.getLastname():"no model...";
}}});
bb.add(ba,{top:20});
...
ba.setDelegate(bc);
ba.setSelection(this.__Cp.getSelection());
return bb;
}},destruct:function(){this.__Cp.dispose();
this.__PP.dispose();
this.__PQ.dispose();
this.__Cp=this.__PP=this.__PQ=null;
}});
})();
