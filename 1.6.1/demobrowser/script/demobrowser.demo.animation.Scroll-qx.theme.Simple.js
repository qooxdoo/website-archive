...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Scroll","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Scroll-qx.theme.Simple.816e0af68da3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:d,check:[d,b]},x:{init:0,check:c},y:{init:0,check:c}},members:{__Ll:null,__Lm:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var e=this._getElement();
this.__Ll={x:e.scrollLeft,y:e.scrollTop};
if(this._atEndPosition(this.__Ll.x,this.__Ll.y)){return;
}
if(this.getMode()==b){this.__Lm={left:this.getX()-this.__Ll.x,top:this.getY()-this.__Ll.y};
}},update:function(f){qx.fx.Base.prototype.update.call(this);
var g=this._getElement();

if(this.getMode()==d){if(this.getX()!=0){g.scrollLeft=this.__Ll.x+(this.getX()*f);
}
if(this.getY()!=0){g.scrollTop=this.__Ll.y+(this.getY()*f);
}}else{g.scrollLeft=this.__Ll.x+(this.__Lm.left*f);
g.scrollTop=this.__Ll.y+(this.__Lm.top*f);
