...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_VarRowHeight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Simple.46a3f9440f4e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Pg:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var A=p;
...
--this.__Pg;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Pg+", end="+this.imageData.length);
if(this.__Pg==0){this.doLoad();
}return;
...
if(d===undefined){this.__qi=d;
}else{this.__qi=16;
}
if(e===undefined){this.__qj=e;
}else{this.__qj=16;
}},members:{__qi:null,__qj:null,_identifyImage:function(f){var j={imageWidth:this.__qi,imageHeight:this.__qj};
var k;
