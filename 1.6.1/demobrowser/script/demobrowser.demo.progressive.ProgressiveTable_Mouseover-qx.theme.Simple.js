...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Simple.230f320711ad.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(f,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(L){L.__Pe=qx.bom.element.Style.get(L,e);
L.style.color=q;
...
},onmouseout:function(O){O.style.color=O.__Pe;
