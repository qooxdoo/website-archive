...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_Reversed","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Reversed-qx.theme.Classic.dbf3700ec240.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},properties:{sort:{check:[g,e,t],init:g,apply:l},separatorX:{check:d,nullable:true,apply:k},separatorY:{check:d,nullable:true,apply:k},connectSeparators:{check:s,init:false,apply:k},spacingX:{check:h,init:0,apply:k},spacingY:{check:h,init:0,apply:k}},members:{__dS:null,__AV:null,verifyLayoutProperty:qx.core.Environment.select(p,{"true":function(C,name,D){this.assertInArray(name,[v,x,r,o],q+name+m);
...
},__BU:{north:1,south:2,west:3,east:4,center:5},__BV:{1:"top",2:"bottom",3:"left",4:"right"},__kD:function(){var E=this._getLayoutChildren();
var M,G;
var length=E.length;
var I=[];
var L=[];
...
},renderLayout:function(O,P){if(this._invalidChildrenCache){this.__kD();
...
this._applyValue(this.__xR,undefined);
...
}}}},_onKeyDown:function(e){switch(e.getKeyIdentifier()){case d:this.__xS=true;
case J:this.getChildControl(h).press();
break;
case H:this.__xT=true;
...
}else{this._applyValue(this.__xR,undefined);
...
},_countUp:function(){if(this.__xS){var bC=this.getValue()+this.getPageStep();
...
},_countDown:function(){if(this.__xT){var bE=this.getValue()-this.getPageStep();
...
(function(){var l="main",k="demobrowser.demo.layout.VBox_Reversed",j="yellow",i="gray",h="blue",g="green",f="click to reverse",d="top",c="bottom",b="middle",a="mousedown";
qx.Class.define(k,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);
var m=new qx.ui.layout.VBox();
var o=new qx.ui.container.Composite(m).set({decorator:l,backgroundColor:j,width:120});
m.setSpacing(5);
m.setReversed(true);
var q=new qx.ui.core.Widget().set({decorator:l,backgroundColor:h,maxHeight:60,alignY:d});
var p=new qx.ui.basic.Label(f).set({decorator:l,rich:true,backgroundColor:g,padding:5,height:60,maxHeight:60,alignY:b,allowGrowX:true,allowGrowY:true});
var n=new qx.ui.core.Widget().set({decorator:l,backgroundColor:i,maxHeight:60,alignY:c});
o.add(q);
o.add(p);
o.add(n);
