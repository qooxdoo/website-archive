...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table-qx.theme.Modern.156c5869c8d5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="white",c="#EEE",b="vertical",a="__PL";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__PL:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},getCellProperties:function(j,k){return this.__PL.getCellProperties(j+g+k);
