...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor_Flash-qx.theme.Modern.02ee728f4068.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(j,{extend:qx.application.Native,members:{__cP:null,__FE:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__cP=[];
...
o.start();
},clear:function(){var p=this.__cP;
