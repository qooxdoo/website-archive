...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellSpan","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellSpan-qx.theme.Simple.428cc3847345.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="yellow",i="bold",h="table-scroller-header",g="green",f=" / ",e="Widget Cells",d="demobrowser.demo.virtual.CellSpan",c="HTML Cells",b="x",a="__PL";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__PL:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
k.add(new qx.ui.basic.Label(c).set({font:i,decorator:h,padding:3,allowGrowX:true}),{row:0,column:0});
var m=this.getHtmlCellSpanScroller();
k.add(m,{row:1,column:0});
k.add(new qx.ui.basic.Label(e).set({font:i,decorator:h,padding:3,allowGrowX:true}),{row:0,column:1});
var m=this.getWidgetCellSpanScroller();
k.add(m,{row:1,column:1});
this.__PL=new qx.ui.virtual.cell.Cell();
},getHtmlCellSpanScroller:function(){var p=new qx.ui.virtual.core.Scroller(1000,100,50,120);
var o=p.getPane();
var n=new qx.ui.virtual.layer.HtmlCellSpan(this,o.getRowConfig(),o.getColumnConfig());
n.setCellSpan(1,1,2,2);
n.setCellSpan(1,5,3,3);
n.setCellSpan(7,4,2,4);
n.setCellSpan(6,0,10,2);
n.setCellSpan(10,9,10,5);
n.setCellSpan(11,3,6,3);
p.getPane().addLayer(n);
return p;
},getCellProperties:function(q,r){var s=(q+r)%2==0?j:g;
this.__PL.setBackgroundColor(s);
return this.__PL.getCellProperties(q+f+r);
},getWidgetCellSpanScroller:function(){var v=new qx.ui.virtual.core.Scroller(1000,100,50,120);
var u=v.getPane();
var t=new qx.ui.virtual.layer.WidgetCellSpan(this,u.getRowConfig(),u.getColumnConfig());
t.setCellSpan(1,1,2,2);
t.setCellSpan(1,5,3,3);
t.setCellSpan(7,4,2,4);
t.setCellSpan(6,0,10,2);
t.setCellSpan(10,9,10,5);
t.setCellSpan(11,3,6,3);
v.getPane().addLayer(t);
this._pool=[];
return v;
},getCellWidget:function(w,x){var y=this._pool.pop()||new qx.ui.basic.Label().set({allowGrowX:true});
y.set({backgroundColor:(w+x)%2==0?j:g,value:w+b+x,padding:3});
return y;
...
}this.__jl=qx.bom.Stylesheet.createElement(p);
this.__Ip={};
this.__ls={};
},members:{__jl:null,__Ip:null,__ls:null,getStylesheet:function(){return this.__jl;
},getCssClass:function(q){return this.__Ip[q]||null;
},computeClassForStyles:function(r,s){var t=this.__ls[s];

if(!t){var t=this.__Iq();
qx.bom.Stylesheet.addRule(this.__jl,c+t,s);
this.__ls[s]=t;
}this.__Ip[r]=t;
return t;
},__Iq:function(){return j+this.toHashCode()+n+(this.__Ir++);
},__Ir:0},destruct:function(){this.__jl=this.__Ip=this.__ls=null;
}});
})();
...
this.__jl=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__IH={};
this.__II={};
this.__IJ={};
this.__IK={};
...
for(var I in L){if(!M[I]){this.__IM.push(I);
}}J=J.superclass;
}},_getCssProperties:function(){return [b,n,C,s,d,c,e,h];
},_applyAppearance:function(N,O){if(O){this.__II={};
}},_getValue:function(P){if(this.__IO){return qx.util.PropertyUtil.getThemeValue(this,P);
}else{return qx.util.PropertyUtil.getUserValue(this,P);
}},_storeStyle:function(Q,R){var S;

if(this.__IO){S=this.__II;
}else{S=this.__IH;
}
...
}},getCellProperties:function(bh,bi){this.__IQ(bi);
...
},getCssClasses:function(bn,bo){var bp=this.__jl.getCssClass(this.__IN)||f;
return p+bp;
},__IQ:function(bq){if(!bq){bq={};
}var bs=this.getAppearance();
var br=bs+"-"+qx.lang.Object.getKeys(bq).sort().join(" ");

if(this.__IN==br){return;
}this.__IN=br;
var bt=this.__hm[this.__IN];

if(!bt){this.__IR();
this.__IS(bq);
this.__IT(bq);
this.__IU();
this.__hm[this.__IN]=1;
}this.__IV();
},__IR:function(){var bu=qx.util.PropertyUtil;
var bv=this._getCssProperties();

for(var i=0;i<bv.length;i++){bu.deleteThemeValue(this,bv[i]);
}},__IS:function(bw){this.__II={};
this.__IO=true;
...
},__IT:function(){var bB=qx.lang.Object.getValues(this.__II).join(";");
this.__jl.computeClassForStyles(this.__IN,bB);
},__IU:function(){var bG=this.__IM;
...
}}this.__IL[this.__IN]=bE;
},__IV:function(){var bI=qx.util.PropertyUtil;
var bH=this.__IL[this.__IN]||{};

for(var bJ in bH){bI.setThemed(this,bJ,bH[bJ]);
}},getStyles:function(bK,bL){return qx.lang.Object.getValues(this.__IH).join(v);
},getInsets:function(bM,bN){var bR=this.__IJ;
var bQ=this.__IK;
...
return [bS+bO,top+bP];
}},destruct:function(){this.__jl=this.__IH=this.__II=this.__IJ=this.__IK=this.__hm=this.__IL=this.__IM=null;
}});
})();
...
},__KJ:function(p,q,r,s,top,t,u){var w=this._cellProvider.getCellProperties(q,r);
var v=w.insets||[0,0];
...
var N=I[i];
this.__KJ(L,J.firstRow,J.firstColumn,N.left,N.top,N.width,N.height);
}}else{F=[];
...
if(!F[E][K]){this.__KJ(L,E,K,M,top,G,D);
}K++;
M+=G;
}top+=D;
E++;
...
(function(){var k="change",j="lastColumn",h="qx.debug",g="firstColumn",f="firstRow",d="qx.ui.virtual.layer.CellSpanManager",c="lastRow";
qx.Class.define(d,{extend:qx.core.Object,construct:function(m,n){qx.core.Object.call(this);

if(qx.core.Environment.get(h)){this.assertInstance(m,qx.ui.virtual.core.Axis);
this.assertInstance(n,qx.ui.virtual.core.Axis);
}this._cells={};
this._invalidateSortCache();
this._invalidatePositionCache();
m.addListener(k,this._onRowConfigChange,this);
n.addListener(k,this._onColumnConfigChange,this);
this._rowConfig=m;
this._columnConfig=n;
},members:{addCell:function(o,p,q,r,s){this._cells[o]={firstRow:p,lastRow:p+r-1,firstColumn:q,lastColumn:q+s-1,id:o};
this._invalidateSortCache();
},removeCell:function(t){delete (this._cells[t]);
this._invalidateSortCache();
},_invalidateSortCache:function(){this._sorted={};
},_getSortedCells:function(u){if(this._sorted[u]){return this._sorted[u];
}var v=this._sorted[u]=qx.lang.Object.getValues(this._cells);
v.sort(function(a,b){return a[u]<b[u]?-1:1;
});
return v;
},_findCellsInRange:function(w,x,y){var A=this._getSortedCells(w);

if(A.length==0){return {};
}var C=0;
var z=A.length-1;
while(true){var E=C+((z-C)>>1);
var B=A[E];

if(B[w]>=x&&(E==0||A[E-1][w]<x)){break;
}
if(B[w]>=x){z=E-1;
}else{C=E+1;
}
...
while(B&&B[w]>=x&&B[w]<=y){D[B.id]=B;
B=A[E++];
}return D;
},findCellsInWindow:function(F,G,H,I){var M={};

if(H>0){var K=F+H-1;
qx.lang.Object.merge(M,this._findCellsInRange(f,F,K),this._findCellsInRange(c,F,K));
}var J={};

if(I>0){var L=G+I-1;
qx.lang.Object.merge(J,this._findCellsInRange(g,G,L),this._findCellsInRange(j,G,L));
}return this.__Iu(J,M);
},__Iu:function(N,O){var P=[];

for(var Q in N){if(O[Q]){P.push(O[Q]);
}}return P;
...
this._columnPos=[];
},_getRowPosition:function(R){var S=this._rowPos[R];

if(S!==undefined){return S;
}S=this._rowPos[R]=this._rowConfig.getItemPosition(R);
return S;
},_getColumnPosition:function(T){var U=this._columnPos[T];

if(U!==undefined){return U;
}U=this._columnPos[T]=this._columnConfig.getItemPosition(T);
return U;
},_getSingleCellBounds:function(V,W,X){var Y={left:0,top:0,width:0,height:0};
Y.height=this._getRowPosition(V.lastRow)+this._rowConfig.getItemSize(V.lastRow)-this._getRowPosition(V.firstRow);
Y.top=this._getRowPosition(V.firstRow)-this._getRowPosition(W);
Y.width=this._getColumnPosition(V.lastColumn)+this._columnConfig.getItemSize(V.lastColumn)-this._getColumnPosition(V.firstColumn);
Y.left=this._getColumnPosition(V.firstColumn)-this._getColumnPosition(X);
return Y;
},getCellBounds:function(ba,bb,bc){var bd=[];

for(var i=0,l=ba.length;i<l;i++){bd.push(this._getSingleCellBounds(ba[i],bb,bc));
}return bd;
},computeCellSpanMap:function(be,bf,bg,bh,bi){var bj=[];

if(bh<=0){return bj;
}var bs=bf+bh-1;

for(var i=bf;i<=bs;i++){bj[i]=[];
}
if(bi<=0){return bj;
}var bl=bg+bi-1;

for(var i=0,l=be.length;i<l;i++){var bo=be[i];
var bm=Math.max(bf,bo.firstRow);
var bn=Math.min(bs,bo.lastRow);
var bt;

for(var bp=bm;bp<=bn;bp++){bt=bj[bp];
var bk=Math.max(bg,bo.firstColumn);
var br=Math.min(bl,bo.lastColumn);

for(var bq=bk;bq<=br;bq++){bt[bq]=1;
}}}return bj;
}},destruct:function(){this._rowConfig.removeListener(k,this._onRowConfigChange,this);
this._columnConfig.removeListener(k,this._onColumnConfigChange,this);
...
this.__yN=[];
this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__LI());
...
},__yN:null,setCellSpan:function(u,v,w,x){var y=u+h+v;
this._spanManager.removeCell(y);

if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);
}qx.ui.core.queue.Widget.add(this);
},__LI:function(){var self=this;
...
return z;
},__LJ:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);
...
}}},__LK:function(){var O=this.getChildren();
...
this._add(L);
}}},_fullUpdate:function(P,Q,R,S){this.__LJ(P,Q,R.length,S.length);
this.__LK();
this._cellLayer.fullUpdate(P,Q,R,S);
},_updateLayerWindow:function(T,U,V,W){this.__LJ(T,U,V.length,W.length);
this.__LK();
...
this._cellProvider=this.__yN=this._cells=this._bounds=this._spanMap=null;
}});
})();
