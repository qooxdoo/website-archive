...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Flickr","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr-qx.theme.Simple.6e55e4bdbc6a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="qooxdoo",j="/",i=".static.flickr.com/",h="",g="_",f="http://farm",d="Enter",c="keydown",b="model.photos.photo",a=".jpg",D="execute",C="source",B="selection[0]",A="_s.jpg",z="<span style='font-size: 20px'>Flickr</span>",y="loading",x="value",w="demobrowser.demo.data.store.Flickr",v="demobrowser.demo.data.Flickr",u="http://api.flickr.com/services/rest/?tags=",r="title",s="icon",p="state",q="Search",n="jsonFlickrApi",o="horizontal",l="model",m="&method=flickr.photos.search&api_key=63a8042eead205f7e0040f488c02afd9&format=json",t="id";
...
var M=new demobrowser.demo.data.store.Flickr(k);
var E=new qx.ui.form.TextField(k);
this.getRoot().add(E,{left:30,top:50});
var F=new qx.ui.form.Button(q);
this.getRoot().add(F,{left:140,top:49});
F.addListener(D,function(){M.searchForTag(E.getValue());
},this);
E.addListener(c,function(e){if(e.getKeyIdentifier()==d){M.searchForTag(E.getValue());
}},this);
var status=new qx.ui.basic.Label(y);
...
I.setHeight(110);
I.setOrientation(o);
this.getRoot().add(I,{left:30,right:30,top:80});
var K=new qx.data.controller.List(null,I);
K.setLabelPath(r);
K.setDelegate({configureItem:function(N){N.setShow(s);
}});
var G={converter:function(O,P){return (f+P.getFarm()+i+P.getServer()+j+O+g+P.getSecret()+A);
}};
K.setIconOptions(G);
K.setIconPath(t);
M.bind(b,K,l);
var H=new qx.ui.basic.Image();
this.getRoot().add(H,{left:30,top:200});
var L={converter:function(Q){if(Q){return (f+Q.getFarm()+i+Q.getServer()+j+Q.getId()+g+Q.getSecret()+a);
}return h;
}};
K.bind(B,H,C,L);
...
qx.Class.define(w,{extend:qx.data.store.Jsonp,construct:function(R){this.setCallbackName(n);
qx.data.store.Jsonp.call(this,this.__Or(R));
},members:{searchForTag:function(S){if(S!=h){this.setUrl(this.__Or(S));
}},__Or:function(T){if(!T){return;
}var U=u+T;
U+=m;
return U;
}}});
