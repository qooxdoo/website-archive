...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.FormController","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController-qx.theme.Modern.e870b01409c0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},properties:{model:{check:h,apply:a,event:j,nullable:true,dereference:true},target:{check:b,apply:f,event:d,nullable:true,init:null,dereference:true}},members:{__Kx:null,__Kw:null,addBindingOptions:function(name,p,q){this.__Kw[name]=[p,q];
if(this.getModel()==null||this.getTarget()==null){return;
}var r=this.getTarget().getItems()[name];
var s=this.__KA(r)?l:k;
this.__Kx.removeTarget(r,s,name);
this.__Kx.addTarget(r,s,name,!this._selfUpdate,p,q);
...
}if(this.__Kw[name]&&this.__Kw[name][1]){u=this.__Kw[name][1].converter(u);
}B[y[i]]=u;
}else{if(!B[y[i]]){B[y[i]]={};
}B=B[y[i]];
...
var E=this.__KA(F)?l:k;
var D=this.__Kw[name];
D=D&&this.__Kw[name][1];
qx.data.SingleValueBinding.updateTarget(F,E,this.getModel(),name,D);
}},_applyTarget:function(G,H){if(H!=null){this.__Kz(H);
}if(this.getModel()==null){return;
}if(G!=null){this.__Ky();
}},_applyModel:function(I,J){if(this.__Kx!=null){var K=this.getTarget().getItems();

for(var name in K){var M=K[name];
var L=this.__KA(M)?l:k;
this.__Kx.removeTarget(M,L,name);
}}if(this.__Kx!=null){this.__Kx.setModel(I);
...
var O=this.__KA(Q)?l:k;
var P=this.__Kw[name];
try{if(P==null){this.__Kx.addTarget(Q,O,name,!this._selfUpdate);
}else{this.__Kx.addTarget(Q,O,name,!this._selfUpdate,P[0],P[1]);
...
},__Kz:function(S){if(this.__Kx==null){return;
}var T=S.getItems();
for(var name in T){var V=T[name];
var U=this.__KA(V)?l:k;
this.__Kx.removeTarget(V,U,name);
}},__KA:function(W){return qx.Class.hasInterface(W.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(W.constructor,qx.ui.form.IModelSelection);
