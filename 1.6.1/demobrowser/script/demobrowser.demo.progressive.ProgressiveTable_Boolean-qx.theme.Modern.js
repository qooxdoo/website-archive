...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Boolean","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean-qx.theme.Modern.d886ad92e911.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
var o=0;
var k=function(r){var s=[];

for(var t=0;t<r;t++){s.push({renderer:e,location:c,data:[o++,(Math.floor(Math.random()*2)==0?false:true)]});
}return s;
};
var n=new qx.ui.progressive.renderer.table.Widths(2);
n.setWidth(0,100);
n.setWidth(1,100);
var i=[a,d];
var j=new qx.ui.progressive.headfoot.TableHeading(n,i);
var h=new qx.ui.progressive.headfoot.Progress(n,i);
var q=new qx.ui.progressive.structure.Default(j,h);
var g=new qx.ui.progressive.Progressive(q);
var m=new qx.ui.progressive.model.Default();
var l=k(20);
m.addElements(l);
g.setDataModel(m);
var p=new qx.ui.progressive.renderer.table.Row(n);
g.addRenderer(e,p);
var f=new qx.ui.progressive.renderer.table.cell.Boolean();
f.setAllowToggle(true);
p.addRenderer(1,f);
g.set({width:200+qx.bom.element.Overflow.getScrollbarWidth(),maxWidth:200+qx.bom.element.Overflow.getScrollbarWidth()});
this.getRoot().add(g,{left:50,top:50,bottom:50});
g.render();
}}});
})();
...
var v=t.resolve(h);
this.__HX=u.toUri(v);
},members:{__HX:null,getBlankImage:function(){return this.__HX;
...
var B=this.__HY(z);
A.push(k);
if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(B.url)){A.push(q,this.__HX,j,e,B.url,a,r);
...
return A.join(l);
},__HY:function(C){var D=this._identifyImage(C);
if(D==null||typeof D=="string"){D={url:D,tooltip:null};
}if(D.url==null){D.url=this.__HX;
}return D;
}}});
})();
...
this.__yc=H.toUri(F);
this.__yd=H.toUri(E);
},properties:{allowToggle:{check:a,init:false}},members:{__yc:null,__yd:null,__Js:null,__Ju:null,__xV:null,__xW:null,__xX:null,__xY:null,_identifyImage:function(I){var J={imageWidth:11,imageHeight:11};

switch(I.cellData){case true:J.url=this.__yc;
J.extras=w;
break;
case false:J.url=this.__yd;
J.extras=r;
break;
default:J.url=null;
break;
...
if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__yc)){J.extras+=i+this.getBlankImage()+j+e+h+c+this.__yc+j+d;
}else{J.extras+=i+this.__yc+j;
}J.extras+=o+s+t+f;

if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__yd)){J.extras+=i+this.getBlankImage()+j+e+h+c+this.__yd+j+d;
}else{J.extras+=i+this.__yd+j;
}J.extras+=v+g;
...
return L;
}},destruct:function(){this.__yc=this.__yd=null;
}});
})();
