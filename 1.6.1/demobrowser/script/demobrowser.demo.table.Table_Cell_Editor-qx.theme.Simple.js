...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Cell_Editor-qx.theme.Simple.b7ca5098089e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},properties:{cellEditorFactoryFunction:{check:b,nullable:true,init:null}},members:{__pn:null,__LP:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();

if(qx.core.Environment.get(c)){this.assertFunction(g,d);
}this.__pn=g(f);
var h=this.__pn.createCellEditor(f);
this.__LP[h.toHashCode()]=f;
return h;
...
}var j=this.__LP[i.toHashCode()];
this.__pn=k(j);
var l=this.__pn.getCellEditorValue(i);
return l;
