...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Canvas","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas-qx.theme.Classic.e8036a13f08b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="redraw",l="html.canvas",k="center",j="middle",i="Window containing a Canvas - synced coordinates",h="Canvas is not supported by this browser!",g="Window containing a Canvas - static coordinates",f="Resize the windows to see the effect.",d="Canvas is not support by this browser!",c="rgba(0, 0, 200, 0.5)",a="demobrowser.demo.widget.Canvas",b="rgb(200,0,0)";
...
var r=new qx.ui.basic.Label(f);
this.getRoot().add(r,{left:10,top:10});
var q=new qx.ui.window.Window(g).set({width:200,height:200});
q.setLayout(new qx.ui.layout.Canvas());

if(!qx.core.Environment.get(l)){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox());
p.add(new qx.ui.basic.Label(h).set({rich:true,alignX:k,alignY:j}));
}else{var p=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:false});
p.addListener(m,this.draw,this);
}q.add(p,{edge:0});
this.getRoot().add(q,{left:30,top:40});
q.open();
var n=new qx.ui.window.Window(i).set({width:200,height:200});
n.setLayout(new qx.ui.layout.Canvas());

if(!qx.core.Environment.get(l)){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox());
o.add(new qx.ui.basic.Label(d).set({rich:true,alignX:k,alignY:j}));
}else{var o=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:true});
o.addListener(m,this.draw,this);
}n.add(o,{edge:0});
this.getRoot().add(n,{left:30,top:250});
n.open();
},draw:function(e){var t=e.getData();
var s=t.context;
s.fillStyle=b;
s.fillRect(20,20,105,100);
s.fillStyle=c;
s.fillRect(70,70,105,100);
}}});
})();
