...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Simple.aef00922c6b8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var ci="execute",ch="changeValue",cg="icon/16/actions/edit-cut.png",cf="changeSelection",ce="icon/16/actions/edit-paste.png",cd="Copy",cc="Paste",cb="icon/16/actions/edit-copy.png",ca="Cut",bY="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",cp="Print",cq="Open",cn="icon/16/actions/document-new.png",co="Online Forum",cl="icon/16/actions/format-justify-fill.png",cm="Search in files",cj="C",ck="Left aligned",cr="__tU",cs="__Qd",bR="Perl",bQ="View",bT="C Dialect",bS="Info...",bV="Save as...",bU="Show line numbers",bX="Quickstart",bW="icon/16/actions/contact-new.png",bP="Ctrl+N",bO="Actions",a="__Qg",b="Show console",c="Search",d="Help",f="Show status bar",g="icon/16/actions/format-justify-left.png",h="ANSI to OEM",j="Centered",k="Website 3",l="Edit",cw="icon/16/actions/format-justify-center.png",cv="Ctrl+O",cu="icon/16/actions/go-previous.png",ct="C Sharp",cA="Close",cz="Split Button",cy="Website 2",cx="icon/16/actions/document-save-as.png",cC="Python",cB="icon/16/apps/utilities-help.png",K="Show tree",L="Options",I="Spaces to tabs",J="Right aligned",O="Action 1",P="OEM to ANSI",M="Line 431",N="JavaScript",G="icon",H="Action 2",t="__Qi",s="Folder ",v="XML",u="Line 313",p="Paragraph",o="demobrowser.demo.widget.Menu",r="icon/16/actions/application-exit.png",q="C Plus Plus",n="Line 26",m="Item ",U="ASCII table",V="Option 1",W="Search next...",X="Line 12",Q="Action 3",R="Replace in files",S="Uppercase",T="Ctrl+P",Y="Topics",ba="Panes",D="Justified",C="Ctrl+X",B="Search previous...",A="Back",z="main",y="Show ruler",x="icon/16/actions/format-justify-right.png",w="icon/16/actions/go-next.png",F="Ctrl+Z",E="__uc",bb="command ",bc="Option 3",bd="Next",be="Ctrl+R",bf="Show macros",bg="Show tags",bh="Capitals",bi="Format",bj="File",bk="__Qf",by="Show tabs",bx="Tabs to spaces",bw="Search...",bv="Line 1039",bC="Option 2",bB="Objective C",bA="Exit",bz="move to",bE="Ctrl+S",bD="Syntax",bL="__Qe",bM="__Qh",bJ="Ctrl+C",bK="Website 1",bH="Menu Button",bI="Line 30",bF="Lowercase",bG="Replace",bN="HTML";
qx.Class.define(o,{extend:qx.application.Standalone,members:{__Qd:null,__Qe:null,__Qf:null,__tU:null,__uc:null,__Qg:null,__Qh:null,__Qi:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
}cF.add(new qx.ui.menu.Button(bz,null,null,cG));
cF.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cF.add(new qx.ui.menu.Button(bb+(i+1)));
}return cF;
...
},createCommands:function(){this.__Qd=new qx.ui.core.Command(bP);
this.__Qd.addListener(ci,this.debugCommand);
this.__Qe=new qx.ui.core.Command(cv);
this.__Qe.addListener(ci,this.debugCommand);
this.__Qf=new qx.ui.core.Command(bE);
this.__Qf.addListener(ci,this.debugCommand);
this.__tU=new qx.ui.core.Command(F);
this.__tU.addListener(ci,this.debugCommand);
this.__uc=new qx.ui.core.Command(be);
this.__uc.addListener(ci,this.debugCommand);
this.__Qg=new qx.ui.core.Command(C);
this.__Qg.addListener(ci,this.debugCommand);
this.__Qh=new qx.ui.core.Command(bJ);
this.__Qh.addListener(ci,this.debugCommand);
this.__Qi=new qx.ui.core.Command(T);
this.__Qi.addListener(ci,this.debugCommand);
this.__Qi.setEnabled(false);
},getMenuButton:function(){var cH=new qx.ui.menu.Menu;
cH.add(new qx.ui.menu.RadioButton(V));
cH.add(new qx.ui.menu.RadioButton(bC));
cH.add(new qx.ui.menu.RadioButton(bc));
...
var cN=new qx.ui.menu.Button(bt,bn,this.__tU);
var cU=new qx.ui.menu.Button(br,bl,this.__uc);
var cJ=new qx.ui.menu.Button(ca,cg,this.__Qg);
var cR=new qx.ui.menu.Button(cd,cb,this.__Qh);
var cL=new qx.ui.menu.Button(cc,ce,this.__Qi);
var cI=new qx.ui.menu.Button(L,bY,null,cH);
var cS=new qx.ui.menu.Button(bO,bW,null,cP);
...
var dk=new qx.ui.toolbar.SplitButton(bd,w,this.getForwardMenu());
var dd=new qx.ui.toolbar.Button(bu,cn,this.__Qd);
var dh=new qx.ui.toolbar.Button(cq,bo,this.__Qe);
var dm=new qx.ui.toolbar.Button(bm,bs,this.__Qf);
...
var dv=new qx.ui.menu.Button(bv);
...
var dz=new qx.ui.menu.Button(bu,cn,this.__Qd);
var dD=new qx.ui.menu.Button(cq,bo,this.__Qe);
var dC=new qx.ui.menu.Button(cA);
var dG=new qx.ui.menu.Button(bm,bs,this.__Qf);
var dF=new qx.ui.menu.Button(bV,cx);
var dE=new qx.ui.menu.Button(cp,bp);
var dA=new qx.ui.menu.Button(bA,r);
...
var dL=new qx.ui.menu.Button(bt,bn,this.__tU);
var dK=new qx.ui.menu.Button(br,bl,this.__uc);
var dH=new qx.ui.menu.Button(ca,cg,this.__Qg);
var dM=new qx.ui.menu.Button(cd,cb,this.__Qh);
var dJ=new qx.ui.menu.Button(cc,ce,this.__Qi);
...
var dO=new qx.ui.menu.Button(bw,bY);
...
var ea=new qx.ui.menu.Button(bD,null,null,this.getSyntaxMenu());
var dY=new qx.ui.menu.CheckBox(y);
var dX=new qx.ui.menu.CheckBox(bU);
var dV=new qx.ui.menu.Button(U);
...
var ed=new qx.ui.menu.CheckBox(bf);
var ef=new qx.ui.menu.CheckBox(bg);
...
var et=new qx.ui.menu.RadioButton(bB);
...
var eH=new qx.ui.menu.Button(ck,g);
var eI=new qx.ui.menu.Button(J,x);
...
for(var i=0;i<20;i++){eO.add(new qx.ui.form.ListItem(m+i));
}return eO;
},getContextMenu:function(){var eP=new qx.ui.menu.Menu;
var eR=new qx.ui.menu.Button(ca,cg,this.__Qg);
var eS=new qx.ui.menu.Button(cd,cb,this.__Qh);
var eQ=new qx.ui.menu.Button(cc,ce,this.__Qi);
...
eP.add(eQ);
return eP;
}},destruct:function(){this._disposeObjects(cs,bL,bk,cr,E,a,bM,t);
}});
})();
...
if(T&&T.isVisible()){this.__xQ=true;
return;
}this.removeState(j);
...
},_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__xQ){this.removeState(j);
}}}});
})();
