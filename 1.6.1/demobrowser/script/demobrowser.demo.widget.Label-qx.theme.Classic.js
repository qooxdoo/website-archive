...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Label","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Label-qx.theme.Classic.2aeb41608610.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="value",s="main",r="Verdana",q="sans-serif",p="selectable",o="rich",n="Big Long Label Cutted",m="My First Long Label Cutted",l="rich label",k="top",d="native context menu",j="text label",g="configure rich label",c="demobrowser.demo.widget.Label",b="nativeContextMenu",f="right",e="configure text label",h="A long label text with auto-wrapping. This also may contain <b style='color:red'>rich HTML</b> markup.",a="Big Long Label",i="execute";
...
var u=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
this.getRoot().add(u);
var v=new qx.ui.basic.Label(j).set({decorator:s,width:200});
u.add(v);
this.getRoot().add(this.createConfigureButton(v,e),{left:240,top:20});
var w=new qx.ui.basic.Label(l).set({decorator:s,rich:true});
u.add(w);
this.getRoot().add(this.createConfigureButton(w,g),{left:240,top:60});
var x=new qx.ui.basic.Label(m).set({decorator:s,width:80});
u.add(x);
var y=new qx.ui.basic.Label().set({value:h,decorator:s,rich:true,width:120});
u.add(y);
var z=new qx.ui.basic.Label(a).set({decorator:s,font:new qx.bom.Font(28,[r,q])});
u.add(z);
var A=new qx.ui.basic.Label(n).set({decorator:s,font:new qx.bom.Font(28,[r,q]),width:150});
u.add(A);
},createConfigureButton:function(B,C){var E=new qx.ui.form.Button(C);
var D;
E.addListener(i,function(){if(!D){D=this.createEditDialog(B,C);
}D.open();
},this);
return E;
},createEditDialog:function(F,G){var H=new qx.ui.window.Window(G).set({allowMinimize:false,showMinimize:false,allowMaximize:false,showMaximize:false});
H.moveTo(350,20);
var J=new qx.ui.layout.Grid(10,10);
J.setColumnFlex(1,1);
J.setColumnAlign(0,f,k);
H.setLayout(J);
var I=new qx.data.controller.Object(F);
H.add(new qx.ui.basic.Label(t).set({paddingTop:5}),{row:0,column:0});
var K=new qx.ui.form.TextArea().set({liveUpdate:true});
I.addTarget(K,t,t,true);
H.add(K,{row:0,column:1});
H.add(new qx.ui.basic.Label(p),{row:1,column:0});
var L=new qx.ui.form.CheckBox();
I.addTarget(L,t,p,true);
H.add(L,{row:1,column:1});
H.add(new qx.ui.basic.Label(d),{row:2,column:0});
var L=new qx.ui.form.CheckBox();
I.addTarget(L,t,b,true);
H.add(L,{row:2,column:1});
H.add(new qx.ui.basic.Label(o),{row:3,column:0});
var L=new qx.ui.form.CheckBox().set({enabled:false});
I.addTarget(L,t,o);
H.add(L,{row:3,column:1});
return H;
}}});
})();
...
var s=this.__ef[i][4];
var n=this.__ef[i][5];
if(l!=undefined&&!l.isDisposed()){this.__zt(t,q,o,l);
}if(k!=undefined){this.__zs(t,q,o,r,s,n);
...
this.__zs(u,v,w,x,y,z);
},__zs:function(A,B,C,D,E,F){if(this.getModel()==null){return;
...
},removeTarget:function(J,K,L){this.__zt(J,K,L,this.getModel());
for(var i=0;i<this.__ef.length;i++){if(this.__ef[i][0]==J&&this.__ef[i][1]==K&&this.__ef[i][2]==L){this.__ef.splice(i,1);
}}},__zt:function(M,N,O,P){if(!(M instanceof qx.core.Object)){return ;
