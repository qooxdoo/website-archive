...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Video","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Video-qx.theme.Simple.38e8223c7460.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u="changeValue",t="timeupdate",s="demobrowser/demo/media/qx.ogv",r="#CCC",q="Native Controls",p="Loop",o="Mute",n="html.video.h264",m="0:00",l="html.video.ogg",d="demobrowser/demo/media/qx.m4v",k="demobrowser/demo/media/qx.webm",h="It seems that your browser doesn't support HTML5 video",c="loadeddata",b="Play/Pause",g=":",f="ended",i="0",a="demobrowser.demo.bom.Video",j="html.video.webm";
...
var y=this.getRoot();
var D=new qx.ui.container.Composite(new qx.ui.layout.Basic());
y.add(D,{left:10,top:40});

if(qx.core.Environment.get(n)){var w=qx.util.ResourceManager.getInstance().toUri(d);
}else if(qx.core.Environment.get(j)){var w=qx.util.ResourceManager.getInstance().toUri(k);
}else if(qx.core.Environment.get(l)){var w=qx.util.ResourceManager.getInstance().toUri(s);
}else{y.add(new qx.ui.basic.Label(h,{left:10,top:10}));
return;
}var B=new qx.bom.media.Video(w);
var v=new qx.ui.form.ToggleButton(b);
v.addListener(u,function(e){if(B.isPaused()){B.play();
}else{B.pause();
}},this);
var x=new qx.ui.form.ToggleButton(q);
x.addListener(u,function(e){if(B.hasControls()){B.hideControls();
}else{B.showControls();
}},this);
var z=new qx.ui.form.ToggleButton(o);
z.addListener(u,function(e){if(B.isMuted()){B.setMuted(false);
}else{B.setMuted(true);
}},this);
var E=new qx.ui.form.ToggleButton(p);
E.addListener(u,function(e){if(B.isLoop()){B.setLoop(false);
}else{B.setLoop(true);
}},this);
var C=new qx.ui.basic.Label(m);
C.setTextColor(r);
var A=new qx.ui.indicator.ProgressBar();
A.setHeight(21);
A.setWidth(220);
B.addListener(c,function(){y.add(x,{left:315,top:10});
y.add(v,{left:10,top:270});
y.add(A,{left:90,top:272});
y.add(C,{left:185,top:275});
y.add(z,{left:314,top:270});
y.add(E,{left:364,top:270});
D.getContentElement().getDomElement().appendChild(B.getMediaObject());
D.setWidth(400);
D.setHeight(220);
B.setWidth(D.getWidth());
B.setHeight(D.getHeight());
},this);
B.addListener(t,function(){A.setMaximum(B.getDuration());
var F=B.getCurrentTime();
var H=Math.floor(F/60);
var G=parseInt(F%60);
A.setValue(F);
C.setValue(H+g+(G>9?G:i+G));
},this);
B.addListener(f,function(){if(!B.isLoop()){v.resetValue();
}},this);
}}});
})();
