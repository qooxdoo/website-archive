...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea-qx.theme.Classic.4a339c249d90.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(B,{extend:qx.application.Native,members:{__DE:null,__On:null,__Oo:null,__wf:null,__kd:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__DE=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__DE,{margin:f});
...
this.__On=qx.bom.Element.create(ca);
qx.bom.element.Style.setStyles(this.__On,{width:bR,padding:cb,margin:cb,lineHeight:cb,border:bs});
this.__Oo=qx.bom.Element.create(ca);
qx.bom.element.Style.setStyles(this.__Oo,{width:bR,height:bQ,border:bs,borderTop:cb,backgroundColor:bI});
qx.dom.Element.insertEnd(this.__Oo,this.__DE);
var cw=bP;
this.__wf=new qx.bom.htmlarea.HtmlArea(this.__Oo,cw,null,S);
this.__wp();
qx.dom.Element.insertBegin(this.__On,this.__DE);
qx.dom.Element.insertBegin(cy,this.__DE);
qx.dom.Element.insertBegin(this.__DE,document.body);
},__Op:function(e){var cz=window.prompt(bE,cg);
this.setFontSize(parseInt(cz));
},__wg:function(e){var cA=window.prompt(cf,bp);
this.setTextColor(cA);
},__wh:function(e){var cB=window.prompt(cl,bp);
this.setTextBackgroundColor(cB);
},__wi:function(e){var cC={src:qx.util.ResourceManager.getInstance().toUri(l),border:0,title:bn,alt:bn};
this.insertImage(cC);
},__wj:function(e){var cD=bA+bf+bu+k+bb+cj+bu+J+bc+cj+K+ba;
this.insertHtml(cD);
},__wk:function(e){var cE=window.prompt(v,ck);
this.insertHyperLink(cE);
},__wl:function(e){var cF=window.prompt(cq,cg);
this.insertHtml(cF);
},__wm:function(){var cH=qx.bom.Element.create(ca);
...
return cH;
},__wn:function(){var cP=qx.bom.Element.create(ca);
...
return cP;
},__wp:function(){var cW=[{bold:{text:p,image:F,action:this.__wf.setBold},italic:{text:bO,image:bz,action:this.__wf.setItalic},underline:{text:bB,image:bN,action:this.__wf.setUnderline},strikethrough:{text:bC,image:r,action:this.__wf.setStrikeThrough},removeFormat:{text:R,image:I,action:this.__wf.removeFormat}},{alignLeft:{text:m,image:A,action:this.__wf.setJustifyLeft},alignCenter:{text:bh,image:cp,action:this.__wf.setJustifyCenter},alignRight:{text:bL,image:G,action:this.__wf.setJustifyRight},alignJustify:{text:cn,image:bx,action:this.__wf.setJustifyFull}},{fontFamily:{custom:this.__wm},fontSize:{custom:this.__wn},fontColor:{text:P,image:Q,action:this.__wg},textBackgroundColor:{text:cv,image:bM,action:this.__wh}},{indent:{text:bK,image:b,action:this.__wf.insertIndent},outdent:{text:bD,image:be,action:this.__wf.insertOutdent}},{insertImage:{text:bd,image:T,action:this.__wi},insertTable:{text:ce,image:O,action:this.__wj},insertLink:{text:cu,image:D,action:this.__wk},insertHTML:{text:E,image:cm,action:this.__wl},insertHR:{text:ct,image:cs,action:this.__wf.insertHorizontalRuler}},{ol:{text:C,image:a,action:this.__wf.insertOrderedList},ul:{text:bF,image:cr,action:this.__wf.insertUnorderedList}},{undo:{text:bl,image:H,action:this.__wf.undo},redo:{text:q,image:bi,action:this.__wf.redo}}];
var cY,dd,cV,db;
...
}qx.event.Registration.addListener(cV,X,dc.action,this.__wf);
}qx.dom.Element.insertEnd(cV,cY);
}qx.dom.Element.insertEnd(cY,this.__On);
}qx.dom.Element.insertEnd(qx.bom.Element.create(o,{style:ch}),this.__On);
}}});
})();
