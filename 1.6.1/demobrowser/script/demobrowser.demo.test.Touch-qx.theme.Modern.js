...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Touch","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Touch-qx.theme.Modern.08818f589d5f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(s,{extend:qx.application.Native,members:{__Ps:null,__Pt:null,main:function(){qx.application.Native.prototype.main.call(this);
...
N.setAttribute(j,v);
return;
}M.add(this.__Pu(10,10,c,z));
M.add(this.__Pu(110,10,w,K));
this.__Ps=this.__Pv(10,110);
M.add(this.__Ps);
this.__Pt=this.__Pv(110,110);
M.add(this.__Pt);
M.add(this.__Pw(210,10));
},__Pu:function(x,y,O,P){var Q={"position":h,"left":x+l,"top":y+l,"width":d,"height":d,"backgroundColor":O,"fontFamily":f,"fontSize":g};
var R=new qx.html.Element(k,Q,{"id":P});
R.setAttribute(j,A+P+m);
R.addListener(C,this.__Px,this);
R.addListener(a,this.__Px,this);
R.addListener(F,this.__Px,this);
R.addListener(u,this.__Px,this);
return R;
},__Pv:function(x,y){var S={"position":h,"left":x+l,"top":y+l,"width":d,"fontFamily":f,"fontSize":t};
return new qx.html.Element(k,S);
},__Pw:function(x,y){var T={"position":h,"left":x+l,"top":y+l,"width":b,"height":b,"backgroundColor":p,"fontFamily":f,"fontSize":g};
