...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent-qx.theme.Simple.9ddfc3f89569.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}qx.bom.Element.addListener(F,l,this.__OE,this);
...
},__OE:function(e){var J=e.getTarget().id.split("_")[1];
