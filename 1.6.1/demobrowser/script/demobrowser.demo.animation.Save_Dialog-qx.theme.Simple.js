...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Save_Dialog-qx.theme.Simple.310aff39a48f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="execute",s="mshtml",r="engine.name",q="__DE",p="middle",o="Cancel",n="demobrowser.demo.animation.Save_Dialog",m="appear",l="Your changes will be lost if you don't save them.",k="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",d="center",j="__Ok",g="Save...",c='<b "font-size:12pt;">Do you want to save the changes you made in the doc "Untitled"?</b>',b="close",f="right",e="__Ol",h="__Oj",a="Don't save";
qx.Class.define(n,{extend:qx.application.Standalone,members:{__Oj:null,__Ok:null,__Ol:null,__DE:null,__Om:function(){if(qx.core.Environment.get(r)==s){this.__Oj=new qx.fx.effect.core.Fade(this.__Ok.getContainerElement().getDomElement()).set({from:0,to:1});
this.__Ol=new qx.fx.effect.core.Fade(this.__Ok.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__Oj=new qx.fx.effect.combination.Grow(this.__Ok.getContainerElement().getDomElement());
this.__Ol=new qx.fx.effect.combination.Shrink(this.__Ok.getContainerElement().getDomElement());
}},showDialog:function(){this.__Ok.setZIndex(1);
this.__Oj.start();
},hideDialog:function(){this.__Ol.start();
...
this.__DE.setLayout(new qx.ui.layout.VBox());
v.add(this.__DE,{left:40,top:40});
...
A.setRowHeight(2,10);
A.setRowAlign(3,d,p);
this.__Ok=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__Ok.setLayout(A);
v.add(this.__Ok,{left:65,top:125});
this.__Ok.addListenerOnce(m,this.__Om,this);
var C=new qx.ui.basic.Label(c);
var w=new qx.ui.basic.Label(l);
C.setRich(true);
this.__Ok.add(C,{row:0,column:0,colSpan:3});
this.__Ok.add(w,{row:1,column:0,colSpan:3});
var y=[a,o,g];

for(var i=0;i<y.length;i++){var u=new qx.ui.form.Button(y[i]);
u.setAllowStretchX(false);
this.__Ok.add(u,{row:3,column:i});
u.addListener(t,this.hideDialog,this);
}}},destruct:function(){this._disposeObjects(q,j,h,e);
}});
})();
