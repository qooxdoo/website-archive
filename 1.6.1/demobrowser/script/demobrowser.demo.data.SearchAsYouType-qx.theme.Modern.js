...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Modern.c0c5d2f26829.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__sY=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__sY:null,__sd:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__sY!=null){i.stop(this.__sY);
this.__sY=null;
}this.__sY=i.start(function(){this.__sd.update();
this.__sY=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__sd=null;
}});
})();
