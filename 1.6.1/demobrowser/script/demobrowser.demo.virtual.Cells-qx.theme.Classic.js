...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Cells","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Classic.e23aa89c578e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="",i="<b>HTML</b>",h="px;",g="Juhu",f="testImageCell",e="qx.theme",d="testNumberCell",c="width:",b="testHtmlCell",a="testDateCell",y="css.boxmodel",x="height:",w="testStringCell",v="testBooleanCellCustomImage",u="demobrowser.demo.virtual.Cells",t="content",s="testBooleanCell",r="foobar!",q="qx.theme.Modern",p="icon/32/apps/utilities-notes.png",n="medium",o="icon/16/emotes/face-sad.png",l="icon/16/apps/internet-feed-reader.png",m="icon/16/emotes/face-smile.png",k="This is a feed reader!";
...
var z=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(z);
this.runTest(w);
this.runTest(d);
this.runTest(a);
this.runTest(b);
if(qx.core.Environment.get(e)==q){this.runTest(f);
this.runTest(s);
this.runTest(v);
}this.getRoot().add(this.topContainer,{edge:5});
},runTest:function(A){this.setUp();
this[A]();
...
},testStringCell:function(){var C={value:[g,i,j,null],states:[{},{selected:1}]};
var B=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(C,function(D){var E=this.__KJ(B,D.value,D.states);
this.container.add(E);
},this);
},testNumberCell:function(){var F={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var G=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(F,function(H){if(H.format){G.setNumberFormat(H.format);
}else{G.resetNumberFormat();
}var I=this.__KJ(G,H.value,H.states);
this.container.add(I);
},this);
},testDateCell:function(){var J={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(n))],states:[{},{selected:1}]};
var K=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(J,function(L){if(L.format){K.setDateFormat(L.format);
}else{K.resetDateFormat();
}var M=this.__KJ(K,L.value,L.states);
this.container.add(M);
},this);
},testHtmlCell:function(){var N={value:[g,i,j,null],states:[{},{selected:1}]};
var O=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(N,function(P){var Q=this.__KJ(O,P.value,P.states);
this.container.add(Q);
},this);
},testImageCell:function(){var R={value:[{url:l,tooltip:k},{url:p,tooltip:r},null],states:[{},{selected:1}]};
var S=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(R,function(T){var U=this.__KJ(S,T.value,T.states);
this.container.add(U);
},this);
},testBooleanCell:function(){var V={value:[true,false,null],states:[{},{selected:1}]};
var W=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(V,function(X){var Y=this.__KJ(W,X.value,X.states);
this.container.add(Y);
},this);
},testBooleanCellCustomImage:function(){var ba={value:[true,false,null],states:[{},{selected:1}]};
var bb=new qx.ui.virtual.cell.Boolean;
bb.setIconFalse(o);
bb.setIconTrue(m);
qx.util.Permutation.permute(ba,function(bc){var bd=this.__KJ(bb,bc.value,bc.states);
this.container.add(bd);
},this);
},__KJ:function(be,bf,bg){var bk=100;
var bi=30;
var bm=new qx.ui.embed.Html().set({width:bk,height:bi,decorator:bg.selected?null:"main"});
var bh=be.getCellProperties(bf,bg);
var bj=bh.insets;
var bl=["<div ","style='",this._getCellSizeStyle(bk,bi,bj[0],bj[1]),bh.style,"' ","class='",bh.classes,"' ",bh.attributes,">",bh.content,"</div>"].join("");
bm.setHtml(bl);
return bm;
},_getCellSizeStyle:function(bn,bo,bp,bq){var br=j;

if(qx.core.Environment.get(y)==t){bn-=bp;
bo-=bq;
}br+=c+bn+h;
br+=x+bo+h;
return br;
...
},members:{__qe:16,__qf:16,_aliasManager:null,__qh:function(w){var z=qx.util.ResourceManager.getInstance();
...
},__Jx:function(B){if(typeof (B)==d){B={url:B};
...
var I=this.__Jx(this._identifyImage(F));
...
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__Jy:null,__Jz:null,__yb:null,_applyIconTrue:function(f){this.__Jy=this.__yb.resolve(f);
},_applyIconFalse:function(g){this.__Jz=this.__yb.resolve(g);
},_identifyImage:function(h){return h==true?this.__Jy:this.__Jz;
}}});
})();
