...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree-qx.theme.Modern.946f11d9e1b7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(z,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.tree.core.IVirtualTree,qx.data.controller.ISelection],include:[qx.ui.virtual.selection.MModel,qx.ui.core.MContentPadding],construct:function(P,Q,R){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);
this._init();
...
},_getDataFromRow:function(bd){return this.__yh.getItem(bd);
...
},getLevel:function(bf){return this.__Ib[bf];
...
},_applyModel:function(bE,bF){this.__Ia=[];
...
if(qx.lang.String.startsWith(bJ,this.getChildProperty())){this.__Ie();
...
}}},_beforeApplySelection:function(bQ){if(bQ.length===0&&this.getSelectionMode()===d){var bR=this.__Ij();
var bS=this.getLookupTable().indexOf(bR);

if(bS>=0){bQ.push(bS);
}}},_afterApplySelection:function(){var bT=this.getSelection();

if(bT.getLength()>0&&this.getSelectionMode()===d){this.__Ii(bT.getItem(0));
}else{this.__Id=[];
...
if(this.isNodeOpen(bW)){var bU=this.__If(bW,bV);
bX=bX.concat(bU);
...
if(this.isNode(ce)){this.__Ib.push(ca);
cb.push(ce);

if(this.isNodeOpen(ce)){var cc=this.__If(ce,ca);
cb=cb.concat(cc);
}}else{if(this.isShowLeafs()){this.__Ib.push(ca);
cb.push(ce);
}}}return cb;
},__Ig:function(cf){if(!qx.lang.Array.contains(this.__Ia,cf)){this.__Ia.push(cf);
this.fireDataEvent(s,cf);
}},__Ih:function(cg,ch){if(cg===ch){this.__Ig(ch);
return true;
}
...
var ci=this.__Ih(ck,ch);

if(ci===true){this.__Ig(ck);
return true;
}}return false;
},__yn:function(){this.getPane().getRowConfig().setItemCount(this.__yh.getLength());
this.getPane().fullUpdate();
},getParent:function(cl){var cn=this.__yh.indexOf(cl);
...
if(cm<co){return this.__yh.getItem(cn);
}}return null;
},__Ii:function(cp){this.__Id=[];
