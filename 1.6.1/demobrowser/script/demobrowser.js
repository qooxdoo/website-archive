...
var envinfo = {"qx.allowUrlSettings":true,"qx.application":"demobrowser.Application","qx.contrib":false,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"","qx.theme":"demobrowser.Theme","qx.version":"1.6.1"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.28dcfb52084d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cf="/",ce="enabled",cd="",cc="value",cb="modelLink",ca="tags",bY="success",bX=".",bW="~",bV='\n',bC="fail",bB="node",bA='execute',bz='</span>',by=".src.js",bx='value',bw="<script",bv="javascript",bu="\n",bt="widget",cm="interval",cn="horizontal",ck="separator-vertical",cl="request",ci="src",cj="_leftComposite",cg='</div>',ch="^.*",co="filled",cp="changeValue",bO="?qxenv:demobrowser.withTests:true",bN="__ks",bQ="demobrowser.DemoBrowser",bP="<pre ><div class='script'>",bS="_infosplit",bR="__NF",bU='</span>=<span class="string">',bT="_history",bM="_status",bL='.html',a='<span class="html-tag-name">',b="_searchTextField",c="f1",d="__NG",f="script/demobrowser.demo",g="noPlayground",h='changeSelection',n="string",o='<div class="script">',p="logappender",ct="_runbutton",cs=".html",cr="_tree",cq="f2",cy="<pre class='script'>",cx="__ND",cv="visible",cu="ig",cA="</div></pre>",cz='excluded',S="_urlWindow",T='_cmdDisposeSample',Q="qx.theme.Modern",R="toolbar",W="tree1",X="outputviews.sourcepage.html.page",U="__Ns",V="demo/welcome.html",O='_cmdSampleInOwnWindow',P=".*",B=" ",A="background-splitpane",D='demo/',C="</pre>",x="__NE",w="__Nx",z="index.html",y="Filter...",v="/playground/",q='label',bd="icon/16/actions/edit-find.png",be="_",bf="__NK",bg="__kq",Y="right",ba="main",bb='_cmdObjectSummary',bc="Info",bh="_prevButton",bi='/',L="file:",K='_cmdNextSample',J='&gt;',I="left",H="__NC",G='_cmdPrevSample',F="\"",E='_cmdRunSample',N="excluded",M="1.6.1",bj="__NH",bk="http://demo.qooxdoo.org/",bl="bottom-left",bm="right-top",bn="runbutton",bo="outputviews.sourcepage.js.page",bp="_demoView",bq="_navPart",br="?qx.theme=",bs="textfield",bG="mainsplit",bF="__NI",bE="app-header",bD="Demo Browser",bK="_nextButton",bJ="__Nw",bI=' <span class="keyword">',bH="_iframe";
...
this.__Ns=this.__NS();
this.add(this.__Ns);
var cI=new qx.ui.splitpane.Pane(cn);
this.mainsplit=cI;
var cF=new qx.ui.splitpane.Pane(cn);
cF.setDecorator(null);
this._infosplit=cF;
this.add(cI,{flex:1});
var cK=this._leftComposite=new qx.ui.container.Composite();
cK.setLayout(new qx.ui.layout.VBox(3));
cK.setBackgroundColor(A);
cI.add(cK,0);
var cD=new qx.ui.container.Composite();
cD.setLayout(new qx.ui.layout.HBox(3));
cD.setAppearance(bs);
cK.add(cD);
var cL=new qx.ui.basic.Image(bd);
cD.add(cL);
this._searchTextField=new qx.ui.form.TextField();
this._searchTextField.setLiveUpdate(true);
this._searchTextField.setAppearance(bt);
this._searchTextField.setPlaceholder(y);
var cJ=new qx.event.Timer(500);
cJ.addListener(cm,function(cM){this.filter(this._searchTextField.getValue());
cJ.stop();
},this);
this._searchTextField.addListener(cp,function(cN){cJ.restart();
},this);
cD.add(this._searchTextField,{flex:1});
this._status=new qx.ui.basic.Label(cd);
this._status.setAppearance(bt);
this._status.setWidth(80);
this._status.setTextAlign(Y);
cD.add(this._status);
cI.add(cF,1);
this._tree=this.__NW();
cK.add(this._tree,{flex:1});
this.__NX();
this._demoView=this.__NT();
{cF.add(this._demoView,2);
};
var cB=this.__Nt=this.__NU();
var cC=this.__Nu=this.__NV();
var cG=this.__Nv=new qxc.ui.logpane.LogView();
var cH=this.__cd=new qx.ui.container.Stack;
cH.setDecorator(ba);
cH.add(cB);
cH.add(cC);
cH.add(cG);
...
this._history.addListener(cl,function(e){var cO=e.getData().replace(bW,cf);

if(this._currentSample!=cO){this.setCurrentSample(cO);
}},this);
this.__Nw=[this.__NC,this.__ND,this.__NG];
{this.__Nw.push(this.__NA);
this.__Nw.push(this.__NE);
this.__Nw.push(this.__NI);
};
this.__Nx=new qx.event.Timer(250);
this.__Nx.addListener(cm,this.__Oa,this);
this.__Nx.start();
this.__Ny=new demobrowser.InfoWindow(this.tr(bc));
this.__Ny.setAutoCenter(true);
},members:{_iframe:null,__Nr:null,__Nx:null,__Nz:null,_tree:null,_status:null,_searchTextField:null,__NA:null,__NB:null,__Nw:null,_versionFilter:null,_navPart:null,__NC:null,__ND:null,__NE:null,__NF:null,__NG:null,__NH:null,__NI:null,__Ns:null,_leftComposite:null,_infosplit:null,_demoView:null,__ks:null,__kq:null,__NJ:null,_urlWindow:null,__Ny:null,__cd:null,__Nt:null,__Nu:null,__Nv:null,__NK:null,defaultUrl:V,playgroundUrl:bk+M+v,__NL:function(){this._cmdObjectSummary=new qx.ui.core.Command("Ctrl+O");
this._cmdObjectSummary.addListener("execute",this.__NN,this);
...
this._cmdSampleInOwnWindow.addListener("execute",this.__NO,this);
this._cmdDisposeSample=new qx.ui.core.Command("Ctrl+D");
this._cmdDisposeSample.addListener("execute",this.__NR,this);
},__NM:function(e){var cR=e.getTarget()===this.__NK?this.__NJ:this.__NK;
var cQ=e.getData()[0];

if(cR&&cQ){cR.setModelSelection([cQ.getModel()]);
}var cP=cQ!=null?cQ.getUserData("value"):"";

switch(cP){case "html":this.__cd.setSelection([this.__Nt]);
this.__cd.show();
break;
case "js":this.__cd.setSelection([this.__Nu]);
this.__cd.show();
break;
case "log":this.__cd.setSelection([this.__Nv]);
this.__cd.show();
break;
default:this.__cd.resetSelection();
this.__cd.exclude();
}},__NN:function(){var cT=this._iframe.getWindow();
var cS;

if(cT&&cT.qx){cS=cT.qx.dev.ObjectSummary.getInfo();
}else{cS="Unable to access namespace. Maybe no demo loaded.";
}var cU=new qx.ui.form.TextArea(cS);
cU.setDecorator(null);
cU.setAutoSize(true);
cU.setMaxHeight(qx.bom.Viewport.getHeight()-100);
this.__Ny.setContent(cU);
this.__Ny.setWidth(400);
this.__Ny.show();
},__NO:function(){var cV=this._iframe.getSource();
window.open(cV,"_blank");
},__NP:function(cW){var cX=!!cW;
var cY=this._tree.getSelection()[0].getUserData("tags");

if(cY){cX=cX&&!qx.lang.Array.contains(cY,"noPlayground");
}this.__NA.setEnabled(cX);
this.__NB=cW;
},__NQ:function(){if(this.__NB){var dc=this.__NB;
var db='{"code": '+'"'+encodeURIComponent(dc)+'"}';
var da=this.playgroundUrl+"#"+encodeURIComponent(db);
window.open(da,"_blank");
}else{var dd=new qx.ui.basic.Label(this.tr("Could not open the Playground."));
this.__Ny.setContent(dd);
this.__Ny.setWidth(200);
this.__Ny.show();
}},__GC:function(){window.open("http://demo.qooxdoo.org/"+"1.6.1"+"/apiviewer/");
},__GD:function(){var de=("1.6.1".split("-")[0]);
window.open("http://manual.qooxdoo.org/"+de);
},_onHideShowTests:function(event){var dg=window.location.search;
var dh=window.location.hash;
var df=z;

if(dg==cd){df+=bO;
}df+=dh;
location.replace(df);
},__NR:function(e){var dj=this._iframe.getWindow();
var di;

if(dj&&dj.qx){dj.qx.core.ObjectRegistry.shutdown();
di=this.tr("Demo has been disposed.");
}else{di=this.tr("Unable to access application.");
}var dk=new qx.ui.basic.Label(di);
dk.setRich(true);
dk.setWrap(true);
this.__Ny.setContent(dk);
this.__Ny.setWidth(350);
this.__Ny.show();
},__NS:function(){var dI=new qx.ui.toolbar.ToolBar();
...
dI.add(dK);
var du=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");
du.addListener("execute",this.playPrev,this);
du.setToolTipText("Run previous demo");
dK.add(du);
this._prevButton=du;
...
dK.add(dG);
this._nextButton=dG;
var dx={converter:function(dP){return dP=="visible";
}};
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",du,"enabled",dx);
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dG,"enabled",dx);
...
dO.addListener("execute",this.__NO,this);
...
dD.addListener("execute",this.__NQ,this);
...
dB.addListener("execute",this.__GC,this);
var dm=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");
dp.add(dm);
dm.setToolTipText(this.tr("Open the qooxdoo Manual"));
dm.addListener("execute",this.__GD,this);
};
var dJ=new qx.ui.toolbar.Part;
dI.add(dJ);
{var dF=new qx.ui.menu.Menu;
this.__NF=dF;
var dv=new qx.ui.menu.RadioButton("Modern Theme");
var dL=new qx.ui.menu.RadioButton("Classic Theme");
var dM=new qx.ui.menu.RadioButton("Simple Theme");
dv.setUserData("value","qx.theme.Modern");
dv.setValue(true);
dL.setUserData("value","qx.theme.Classic");
dM.setUserData("value","qx.theme.Simple");
var dy=new qx.ui.form.RadioGroup(dv,dL,dM);
dy.addListener("changeSelection",this.__Oe,this);
dF.add(dv);
dF.add(dL);
dF.add(dM);
var dw=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dF);
this.__NE=dw;
dw.setToolTipText("Choose theme");
dJ.add(dw);
};
var dz=new qx.ui.menu.Menu;
{var dA=new qx.ui.menu.Button(this.tr("Object Summary"));
this.__NI=dA;
dA.setCommand(this._cmdObjectSummary);
dz.add(dA);
};
var ds=new qx.ui.menu.Button(this.tr("Dispose Demo"));
this.__NG=ds;
ds.setCommand(this._cmdDisposeSample);
dz.add(ds);
{dz.addSeparator();
var dq=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));
dq.setValue(!!qx.core.Environment.get("demobrowser.withTests"));
dq.addListener("changeValue",this._onHideShowTests,this);
dz.add(dq);
};
var dt=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",dz);
this.__NH=dt;
dt.setToolTipText("Debugging options");
dJ.add(dt);
...
dH.setModel('html');
var dr=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");
dr.setToolTipText("Display JavaScript source");
dr.setModel('js');
dH.setUserData("value","html");
dr.setUserData("value","js");
dC.add(dH);
dC.add(dr);
};
...
dE.setModel('log');
dC.add(dE);
var dl=this.__NK=new qx.ui.form.RadioGroup;
dl.setAllowEmptySelection(true);
dl.add(dE);
dl.addListener('changeSelection',this.__NM,this);
{dl.add(dH,dr);
};
dI.setOverflowHandling(true);
var dn=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");
dn.setAppearance("toolbar-button");
dI.add(dn);
dI.setOverflowIndicator(dn);
dI.setRemovePriority(dC,6);
dI.setRemovePriority(dJ,5);
dI.setRemovePriority(dp,4);
dI.setRemovePriority(dN,3);
dI.setRemovePriority(dK,2);
dI.setRemovePriority(this._navPart,1);
this.__ks=new qx.ui.menu.Menu();
dn.setMenu(this.__ks);
dI.addListener("hideItem",this._onHideItem,this);
dI.addListener("showItem",this._onShowItem,this);
return dI;
},_onHideItem:function(e){var dQ=e.getData();
var dR=this._getMenuItems(dQ);

for(var i=0,l=dR.length;i<l;i++){dR[i].setVisibility(cv);

if(dQ===this.__NE&&!(dR[i] instanceof qx.ui.menu.Separator)){dR[i].getMenu().setPosition(bm);
}}},_onShowItem:function(e){var dS=e.getData();
var dU=this._getMenuItems(dS);

for(var i=0,l=dU.length;i<l;i++){dU[i].setVisibility(N);
}
if(dS===this.__NE){var dT=dS.getMenuButtons();

for(var i=0,l=dT.length;i<l;i++){dT[i].getMenu().setPosition(bl);
}}},_getMenuItems:function(dV){var dX=[];

if(dV instanceof qx.ui.toolbar.Part){var ed=dV.getChildren();
var ec=null;
var dW=false;
var dY=this.__ks.getChildren();

if(dV!=this.__ND){ec=this.__kq[dV.toHashCode()];

if(!ec){ec=new qx.ui.menu.Separator();
this.__ks.addBefore(ec,dY[0]);
this.__kq[dV.toHashCode()]=ec;
}dX.push(ec);
}else{dW=true;
}
for(var i=0,l=ed.length;i<l;i++){if(ed[i].getVisibility()==cz){continue;
}var ea=this.__kq[ed[i].toHashCode()];

if(!ea){if(ed[i] instanceof qx.ui.toolbar.RadioButton){ea=new qx.ui.menu.RadioButton(ed[i].getLabel());
ea.setToolTipText(ed[i].getToolTipText());
ea.setEnabled(ed[i].getEnabled());
ea.setUserData(bx,ed[i].getUserData(bx));
ea.setModel(ed[i].getModel());
ed[i].bind(ce,ea,ce);
ed[i].bind(cc,ea,cc);
ea.bind(cc,ed[i],cc);

if(!this.__NJ){this.__NJ=new qx.ui.form.RadioGroup();
this.__NJ.setAllowEmptySelection(true);
this.__NJ.addListener(h,this.__NM,this);
}this.__NJ.add(ea);
}else if(ed[i] instanceof qx.ui.toolbar.MenuButton){ea=new qx.ui.menu.Button(ed[i].getLabel().translate(),ed[i].getIcon(),ed[i].getCommand(),ed[i].getMenu());
ea.setToolTipText(ed[i].getToolTipText());
ea.setEnabled(ed[i].getEnabled());
ed[i].bind(ce,ea,ce);
}else if(ed[i] instanceof qx.ui.toolbar.Button){ea=new qx.ui.menu.Button(ed[i].getLabel().translate(),ed[i].getIcon());
ea.getChildControl(q,false).setRich(true);
ea.setTextColor(ed[i].getTextColor());
ea.setToolTipText(ed[i].getToolTipText());
ea.setEnabled(ed[i].getEnabled());
ed[i].bind(ce,ea,ce);
var eb=qx.event.Registration.getManager(ed[i]).getListeners(ed[i],bA);

if(eb&&eb.length>0){for(var j=0,k=eb.length;j<k;j++){ea.addListener(bA,qx.lang.Function.bind(eb[j].handler,eb[j].context));
}}}else if(ed[i] instanceof qx.ui.toolbar.CheckBox){ea=new qx.ui.menu.CheckBox(ed[i].getLabel());
ea.setToolTipText(ed[i].getToolTipText());
ea.setEnabled(ed[i].getEnabled());
ed[i].bind(ce,ea,ce);
}else{ea=new qx.ui.menu.Separator();
}
if(dW){this.__ks.add(ea);
}else{this.__ks.addBefore(ea,ec);
}this.__kq[ed[i].toHashCode()]=ea;
}dX.push(ea);
}}return dX;
},__NT:function(){var ee=new qx.ui.embed.Iframe().set({nativeContextMenu:true});
ee.addListener("load",this.__NY,this);
this._iframe=ee;
return ee;
},__NU:function(){var ef=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");
ef.setOverflow("auto","auto");
ef.setFont("monospace");
ef.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.html.page"]=ef;
ef.getContentElement().setAttribute("id","qx_srcview");
return ef;
},__NV:function(){var eg=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");
eg.setOverflow("auto","auto");
eg.setFont("monospace");
eg.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.js.page"]=eg;
eg.getContentElement().setAttribute("id","qx_srcview");
return eg;
},__NW:function(){var ei=new qx.ui.tree.Tree();
var eh=new qx.ui.tree.TreeFolder("Demos");
ei.setAppearance("demo-tree");
ei.setRoot(eh);
this.tree=this.widgets["treeview.flat"]=ei;
ei.addListener("changeSelection",this.treeGetSelection,this);
ei.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);
},this);
return ei;
},__NX:function(){var ej=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");
ej.setLayout(new qx.ui.layout.VBox(10));
ej.setAllowMaximize(false);
ej.setAllowMinimize(false);
var em=new qx.ui.basic.Label("");
em.setSelectable(true);
em.setNativeContextMenu(true);
ej.add(em);
this._urlWindow=ej;
var en=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);
...
this.getApplicationRoot().add(ej);
var ek=new qx.ui.menu.Menu();
var el=new qx.ui.menu.Button(this.tr("Get Demo Link"),"icon/22/mimetypes/text-html.png");
el.addListener("execute",function(e){var ep=this.tree.getSelection()[0];
var er=ep.getUserData("modelLink");
var eo=this.tests.handler.getFullName(er);
eo=eo.replace(".","~");
var eq=location.protocol+"//"+location.host+location.pathname+"#"+eo;
this._urlWindow.getChildren()[0].setValue(eq);
this._urlWindow.open();
},this);
ek.add(el);
this._tree.setContextMenu(ek);
},treeGetSelection:function(e){var es=this.tree.getSelection()[0];
this._runbutton.setEnabled(!es.hasChildren());
var et=es.getUserData(cb);
this.tests.selected=this.tests.handler.getFullName(et);
},leftReloadTree:function(e){this._sampleToTreeNodeMap={};
var eu=this._sampleToTreeNodeMap;
var eC=null;
var eE=null;
var eB=this._history.getState();
var ez=eB.match(/([^~]+)~/);

if(ez){eC=ez[1];
}else{var ew=eB.match(/([^~][\w]*)/);

if(ew){eC=ew[1];
}}function eD(eF,eG){var eK=eG.getChildren();
var t;

for(var i=0;i<eK.length;i++){var eH=eK[i];

if(eH.hasChildren()){t=new qx.ui.tree.TreeFolder(ey.polish(eH.label));
t.setUserData(co,false);
t.setUserData(bB,eH);
eD(t,t.getUserData(bB));

if(eH.label==eC){eE=t;
t.setOpen(true);
}}else{if(!eH.type){continue;
}t=new qx.ui.tree.TreeFile(ey.polish(eH.label));
var eJ=eH.pwd().slice(1).join(cf)+cf+eH.label;

if(eH.tags){var j,m,eI;
t.setUserData(ca,eH.tags);
}eu[eJ]=t;
}eF.add(t);
t.setUserData(cb,eH);
eH.widgetLinkFull=t;
}}var eA=this.tests.handler.ttree;
var ey=this;
this.tree.setUserData(cb,eA);
this.tree.getRoot().setOpen(true);
eD(this.tree.getRoot(),eA);

if(eE!=null){this.tree.setSelection([eE]);
}else{this.tree.setSelection([this.tree.getRoot()]);
}},runSample:function(e){if(this.tests.selected&&this.tests.selected!=cd){var eL=this.tests.selected.replace(bX,cf);
...
var eO=eP.getUserData(ca);

if(eO){this.__NA.setEnabled(!qx.lang.Array.contains(eO,g));
}}else{eN=this.defaultUrl;
}
if(this._iframe.getSource()==eN){this._iframe.reload();
}else{this.__Nz=false;
...
},__NY:function(){var eT=this._iframe.getWindow();
...
}},__Oa:function(e){var fd=this._iframe.getWindow();

try{if(fd&&fd.qx&&fd.qx.log&&fd.qx.log.appender){if(!this.__Nz){this.__Nz=true;
this.debug("Demo loaded: "+this._currentSample);
this.__Nv.clear();

try{this.__Nv.fetch(fd.qx.log.Logger);
}catch(e){return ;
}this._history.addToHistory(this._currentSample.replace(cf,bW),document.title);
if(this._currentSampleUrl!=this.defaultUrl){this.__Ob(this._currentSampleUrl);
}}}else{this.__Nz=false;
}}catch(fe){this.__Nz=false;
}},filter:function(ff){var fn=new RegExp(ch+ff+P,cu);
...
}}if(ff==cd){var fj=this._tree.getRoot().getItems(false,true);
var fi=this._tree.getSelection();
for(var i=0;i<fj.length;i++){if(fj[i]==fi[0]||fj[i]==fi[0].getParent()){continue;
}fj[i].setOpen(false);
}}this._status.setValue(fm+cf+fg);
},__Ob:function(fp){if(typeof (fp)!=n){return;
}var fq=new qx.io.request.Xhr(fp);
fq.setTimeout(180000);
fq.addListener(bY,function(fr){var content=fr.getTarget().getResponse();
if(content){{var fu=content.indexOf(bw,content.indexOf(bw)+7);
var fA=content.indexOf(ci,fu);
var ft=content.indexOf(F,fA+5);
var fv=content.substring(fA+5,ft);
var fy=fv.substring(4,fv.length-3)+by;
var u=f;
var fx=fp.split(bi);
var fw=fx[1];
var fz=fx[2];
fz=fz.substr(0,fz.indexOf(bL));
u+=bX+fw+bX+fz+by;
fy=u;
var fs=new qx.io.request.Xhr(fy);
fs.setTimeout(18000);
fs.addListener(bY,function(){var fB=fs.getResponse();
this.__NP(fB);

if(fB){this.widgets[bo].setHtml(this.__Oc(fB,bv));
}},this);
fs.addListener(bC,function(){this.error("Couldn't load file: "+fp);
},this);
fs.send();
this.widgets[X].setHtml(this.__Oc(content));
};
}},this);
fq.addListener(bC,function(fC){this.error("Couldn't load file: "+fp);
},this);
fq.send();
},dataLoader:function(fD){var fE=new qx.io.request.Xhr(fD);
fE.setTimeout(180000);
fE.addListener(bY,function(fF){var content=fF.getTarget().getResponse();
if(!content){if(window.location.protocol==L){alert("Failed to load demo data from the file system.\n\n"+"The security settings of your browser may prohibit AJAX "+"when using the file protocol. Please try the http protocol "+"instead.");
}return;
}var fG=eval(content);
qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(fG);
this.leftReloadTree();
var fH=this._history.getState();

if(fH){this.setCurrentSample(fH.replace(bW,cf));
}else{this.setCurrentSample(this.defaultUrl);
}},this,0);
},this);
fE.addListener(bC,function(fI){this.error("Couldn't load file: "+fD);
},this);
fE.send();
},playPrev:function(e){var fM=this.tree.getSelection()[0];

if(fM){var fJ=this.tree.getPreviousNodeOf(fM,false);

if(!fJ||fJ==this.tree.getRoot()){return;
}
while(fJ.isVisible&&!fJ.isVisible()){fJ=this.tree.getPreviousNodeOf(fJ,false);
}
if(fJ.getParent()==this.tree.getRoot()){var fL=this.tree.getPreviousNodeOf(fJ,false);

while(fL.isVisible&&!fL.isVisible()){fL=this.tree.getPreviousNodeOf(fL,false);
}
if(fL.getParent()==this.tree.getRoot()){fL.setOpen(true);
var fK=this.tree.getPreviousNodeOf(fJ,false);
...
if(!fJ||fJ===fM){return;
}else{this.tree.setSelection([fJ]);
this.runSample();
}}},playNext:function(e){this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
var fP=this.tree.getSelection()[0];

if(fP){var fN=this.tree.getNextNodeOf(fP);

if(!fN){return;
}
if(fN.getParent()==this.tree.getRoot()){fN.setOpen(true);
fN=this.tree.getNextNodeOf(fN);
}
if(!fN){return;
}
while(!fN.isVisible()){var fO=this.tree.getNextNodeOf(fN);

if(!fO){return ;
}
if(fO.getParent()==this.tree.getRoot()){fN.setOpen(true);
var fO=this.tree.getNextNodeOf(fO);
}fN=fO;
}
if(fN){this.tree.setSelection([fN]);
this.runSample();
}}},__Oc:function(fQ,fR){var fS=new qx.util.StringBuilder(cy);
var fU=[];
var fV=new qx.util.StringBuilder();
var fW=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;
var fT=/^\s*<\/script>\s*$/i;
fQ=fQ.replace(/\r\n/g,bu).replace(/\r/g,bu);
var fU=fQ.split(bV);
if(fR==bv){return bP+qx.dev.Tokenizer.javaScriptToHtml(fQ)+cA;
}
for(var i=0;i<fU.length;i++){if(fW.exec(fU[i])){fS.add(this.__Od(qx.bom.String.escape(fV.get()+fU[i])));
fV.clear();
}else if(fT.exec(fU[i])){var fX=qx.dev.Tokenizer.javaScriptToHtml(fV.get());
fS.add(o,fX,cg);
fV.clear();
fV.add(fU[i],bV);
}else{fV.add(fU[i],bV);
}}fS.add(this.__Od(qx.bom.String.escape(fV.get())),C);
return fS.get();
},disableMenuButtons:function(){var fY=this.__Nw;

for(var i=0;i<fY.length;i++){fY[i].setEnabled(false);
}},enableMenuButtons:function(){var ga=this.__Nw;

for(var i=0;i<ga.length;i++){ga[i].setEnabled(true);
}},__Od:function(gb){var gd=gb;
function gc(ge){var s=new qx.util.StringBuilder(arguments[1],a,arguments[2],bz);
var gf;
var gg=false;
if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){gf=arguments[i];
...
while((r=m.exec(gf))!=null){s.add(bI,r[1],bU,r[2].replace(/\s*$/,cd),bz);
}}}s.add((gg?cf:cd));
}s.add(J);
return s.get();
}gd=gd.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,gc);
return gd;
},polish:function(gh){return gh.replace(cs,cd).replace(be,B);
},__Oe:function(e){this.__Nr=e.getData()[0].getUserData(cc);
this.runSample();
},_createHeader:function(){var gk=new qx.ui.layout.HBox();
var gi=new qx.ui.container.Composite(gk);
gi.setAppearance(bE);
var gl=new qx.ui.basic.Label(bD);
var gj=new qxc.ui.versionlabel.VersionLabel();
gi.add(gl);
gi.add(new qx.ui.core.Spacer,{flex:1});
gi.add(gj);
return gi;
}},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;
this._disposeObjects(bG,W,I,bn,R,c,cq,bT,p,bb,E,G,K,O,T,d,bj,bq,ct,H,x,bR,cx,bf,U,bS,b,bM,cr,bH,bp,bJ,bF,w,cj,S,bK,bh,bg,bN);
}});
})();
...
this.__Fi=new qx.ui.toolbar.ToolBar();
this.__Fi.add(L);
this.__Fi.addSpacer();
var K=new qx.ui.toolbar.Button(this.tr(C),E);
...
this.add(M,{flex:1});
this.__Hd=new qx.log.appender.Element();
qx.log.Logger.unregister(this.__Hd);
this.__He=document.createElement(B);
this.__Hd.setElement(this.__He);
M.addListenerOnce(s,function(){M.getContentElement().getDomElement().appendChild(this.__He);
},this);
},properties:{showLogLevel:{check:a,apply:b,init:false},logLevel:{check:[m,g,k,h],init:m,event:q}},members:{__He:null,__Hd:null,__Hc:null,__Hf:null,__Fi:null,clear:function(){this.__Hd.clear();
},fetch:function(O){if(!O){O=qx.log.Logger;
}O.register(this.__Hd);
O.clear();
},getAppenderElement:function(){return this.__He;
},_applyShowLogLevel:function(P,Q){if(!this.__Hf){this.__Hf=this.__Hg();
this.__Fi.add(this.__Hf);
}
if(P){this.__Hf.show();
}else{this.__Hf.exclude();
}},__Hg:function(){var R=new qx.ui.menu.Menu();
var U=new qx.ui.toolbar.MenuButton(u,d);
U.setMenu(R);

for(var i=0,l=this.__Hc.length;i<l;i++){var T=this.__Hc[i];
...
this.addListener(g,this.__Of,this);
},properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__Bx:null,_getContentContainer:function(){if(!this.__Bx){this.__Bx=new qx.ui.container.Composite(new qx.ui.layout.VBox());
this.__Bx.setMinHeight(20);
}return this.__Bx;
...
y=y>=0?y:0;
this.moveTo(x,y);
},__Of:function(){if(this.getAutoCenter()){this.center();
}}}});
})();
...
this.tmap=p;
this.ttree=this.__Og(p);
},members:{__Og:function(q){var s=q;
...
(function(){var j="_applyLinearBackgroundGradient",i=" ",h=")",g="horizontal",f=",",e=" 0",d="px",c="0",b="shorthand",a="Color",E="vertical",D="Number",C="%",B="),to(",A="from(",z="background-image",y="background",x="browser.name",w="-webkit-gradient(linear,",v="startColorPosition",q="qx.debug",r="deg, ",o="css.gradient.legacywebkit",p="startColor",m="ie",n="",k="qx.ui.decoration.MLinearBackgroundGradient",l="(",s="endColorPosition",t="css.gradient.linear",u="endColor";
qx.Mixin.define(k,{properties:{startColor:{check:a,nullable:true,apply:j},endColor:{check:a,nullable:true,apply:j},orientation:{check:[g,E],init:E,apply:j},startColorPosition:{check:D,init:0,apply:j},endColorPosition:{check:D,init:100,apply:j},colorPositionUnit:{check:[d,C],init:C,apply:j},gradientStart:{group:[p,v],mode:b},gradientEnd:{group:[u,s],mode:b}},members:{_styleLinearBackgroundGradient:function(F){{var I=qx.theme.manager.Color.getInstance();
var P=I.resolve(this.getStartColor());
var K=I.resolve(this.getEndColor());
};
var Q=this.getColorPositionUnit();
if(qx.core.Environment.get(o)){Q=Q===d?n:Q;

if(this.getOrientation()==g){var O=this.getStartColorPosition()+Q+e+Q;
var M=this.getEndColorPosition()+Q+e+Q;
}else{var O=c+Q+i+this.getStartColorPosition()+Q;
var M=c+Q+i+this.getEndColorPosition()+Q;
}var L=A+P+B+K+h;
var J=w+O+f+M+f+L+h;
F[y]=J;
}else{var R=this.getOrientation()==g?0:270;
if(qx.core.Environment.get(x)==m){R=R-90;
}var H=P+i+this.getStartColorPosition()+Q;
var G=K+i+this.getEndColorPosition()+Q;
var N=qx.core.Environment.get(t);
F[z]=N+l+R+r+H+f+G+h;
}},_resizeLinearBackgroundGradient:function(S,T,U){var V=this.getInsets();
T-=V.left+V.right;
U-=V.top+V.bottom;
return {left:V.left,top:V.top,width:T,height:U};
...
}}},__rY:function(L){var P=this._generateBackgroundMarkup(L);
...
L[y]=0;
L[m]=0;
return this.__rW=this._generateBackgroundMarkup(L,P);
},__sa:function(T,U,V){var W=this.getInsets();
U-=W.left+W.right;
V-=W.top+W.bottom;
