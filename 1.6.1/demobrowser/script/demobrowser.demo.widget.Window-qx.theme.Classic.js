...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Window-qx.theme.Classic.014a999862c1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="changeValue",k="execute",j="icon/16/apps/office-calendar.png",h="right",g="demobrowser.demo.widget.Window",f="Yes",d="Second Window",c="Page 1",b="bottom",a="Use move frame",bb="Show Statusbar",ba="icon/16/actions/dialog-cancel.png",Y="icon/32/status/dialog-error.png",X="Show Close",W="icon/32/apps/office-address-book.png",V="Third Window",U="icon/22/apps/utilities-calculator.png",T="Show Maximize",S="Allow Close",R="Use resize frame",s="No",t="resizable",q="Allow Maximize",r="value",o="The second window",p="Page 3",m="move",n="Resizable ",w="First Window",x="resize",F="Moveable",D="Demo loaded",J="Allow Minimize",H="Resizable",N="Open Modal Dialog 2",L="Open Modal Dialog 1",z="First Modal Dialog",Q="top",P="Movable",O="Show Minimize",y="Basics",B="Modal",C="Do you want to fly to Berlin?",E="Welcome to your first own Window.<br/>Have fun!",G="Application is ready",I="icon/16/apps/internet-feed-reader.png",K="Second Modal Dialog",M="icon/16/actions/dialog-ok.png",u="Page 2",v="left",A="icon/16/apps/internet-telephony.png";
...
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var be=new qx.ui.window.Window(w,j);
be.setLayout(new qx.ui.layout.VBox(10));
be.setShowStatusbar(true);
be.setStatus(D);
be.open();
this.getRoot().add(be,{left:20,top:20});
be.addListener(m,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
be.addListener(x,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var bd=new qx.ui.basic.Atom(E,W);
bd.setRich(true);
be.add(bd);
var bc=new qx.ui.tabview.TabView;
be.add(bc,{flex:1});
var bh=new qx.ui.tabview.Page(c);
bc.add(bh);
var bf=new qx.ui.tabview.Page(u);
bc.add(bf);
var bg=new qx.ui.tabview.Page(p);
bc.add(bg);
},createWindow2:function(){var bo=new qx.ui.window.Window(d,I);
bo.setLayout(new qx.ui.layout.VBox(10));
bo.setStatus(G);
bo.open();
this.getRoot().add(bo,{left:350,top:120});
var bx=new qx.ui.basic.Atom(o,U);
bo.add(bx);
var bi=new qx.ui.container.Composite;
bi.setLayout(new qx.ui.layout.HBox(10));
bo.add(bi,{flex:1});
var bq=new qx.ui.groupbox.GroupBox(y);
bq.setLayout(new qx.ui.layout.VBox(4));
bi.add(bq,{flex:1});
var bl=new qx.ui.form.CheckBox(X);
bl.setValue(true);
bl.addListener(l,function(e){bo.setShowClose(e.getData());
});
bq.add(bl);
var bw=new qx.ui.form.CheckBox(T);
bw.setValue(true);
bw.addListener(l,function(e){bo.setShowMaximize(e.getData());
});
bq.add(bw);
var bp=new qx.ui.form.CheckBox(O);
bp.setValue(true);
bp.addListener(l,function(e){bo.setShowMinimize(e.getData());
});
bq.add(bp);
var bs=new qx.ui.form.CheckBox(S);
bs.setValue(true);
bs.addListener(l,function(e){bo.setAllowClose(e.getData());
});
bq.add(bs);
var by=new qx.ui.form.CheckBox(q);
by.setValue(true);
by.addListener(l,function(e){bo.setAllowMaximize(e.getData());
});
bq.add(by);
var bn=new qx.ui.form.CheckBox(J);
bn.setValue(true);
bn.addListener(l,function(e){bo.setAllowMinimize(e.getData());
});
bq.add(bn);
var bj=new qx.ui.form.CheckBox(bb);
bj.setValue(false);
bj.addListener(l,function(e){bo.setShowStatusbar(e.getData());
});
bq.add(bj);
var bA=new qx.ui.groupbox.GroupBox(H);
bA.setLayout(new qx.ui.layout.VBox(4));
bi.add(bA,{flex:1});
var bu=new qx.ui.form.CheckBox(R);
bu.setValue(true);
bu.addListener(l,function(e){bo.setUseResizeFrame(e.getData());
});
bA.add(bu);
var bv=[Q,h,b,v];

for(var i=0;i<bv.length;i++){var bt=bv[i];
var bm=new qx.ui.form.CheckBox(n+bt).set({value:true});
bm.bind(r,bo,t+qx.lang.String.firstUp(bt));
bA.add(bm);
}var bk=new qx.ui.groupbox.GroupBox(F);
bk.setLayout(new qx.ui.layout.VBox(4));
bi.add(bk,{flex:1});
var br=new qx.ui.form.CheckBox(P);
br.setValue(true);
br.addListener(l,function(e){bo.setMovable(e.getData());
});
bk.add(br);
var bz=new qx.ui.form.CheckBox(a);
bz.addListener(l,function(e){bo.setUseMoveFrame(e.getData());
});
bk.add(bz);
},createWindow3:function(){var bB=new qx.ui.window.Window(V,A);
...
bB.open();
this.getRoot().add(bB,{left:100,top:250});
var bC=this.getModalWindow1();
var bD=new qx.ui.form.Button(L,j);
bD.addListener(k,bC.open,bC);
bB.add(bD);
},getModalWindow1:function(){var bF=new qx.ui.window.Window(z);
bF.setLayout(new qx.ui.layout.VBox(10));
bF.setModal(true);
bF.moveTo(150,150);
this.getRoot().add(bF);
var bE=this.getModalWindow2();
var bH=new qx.ui.form.Button(N,j);
bH.addListener(k,bE.open,bE);
bF.add(bH);
var bG=new qx.ui.form.CheckBox(B);
bG.setValue(true);
bF.add(bG);
bG.addListener(l,function(e){bF.setModal(e.getData());
});
return bF;
},getModalWindow2:function(){var bJ=new qx.ui.window.Window(K);
bJ.setLayout(new qx.ui.layout.VBox(10));
bJ.setModal(true);
bJ.setShowClose(false);
bJ.moveTo(300,300);
this.getRoot().add(bJ);
var bI=new qx.ui.basic.Atom(C,Y);
bJ.add(bI);
var bL=new qx.ui.container.Composite;
bL.setLayout(new qx.ui.layout.HBox(10,h));
bJ.add(bL);
var bM=new qx.ui.form.Button(f,M);
bM.addListener(k,function(e){bJ.close();
});
bL.add(bM);
var bK=new qx.ui.form.Button(s,ba);
bK.addListener(k,function(e){alert("Sorry, please click 'Yes'!");
});
bL.add(bK);
return bJ;
}}});
...
(function(){var m="pane",k="lastTab",j="bar",h="page",g="firstTab",f="close",d="right",c="bottom",b="button",a="qx.debug",C="changeSelection",B="top",A="left",z="qx.event.type.Data",y="barRight",x="beforeChangeSelection",w="close-button",v="tabview",u="vertical",t="__qG",r="_applyBarPosition",s="barLeft",p="horizontal",q="qx.ui.tabview.TabView",n="barTop",o="barBottom";
...
this.__qF={top:n,right:y,bottom:o,left:s};
this._createChildControl(j);
this._createChildControl(m);
var E=this.__qG=new qx.ui.form.RadioGroup;
E.setWrap(false);
E.addListener(C,this._onChangeSelection,this);
if(D!=null){this.setBarPosition(D);
}else{this.initBarPosition();
}},events:{"changeSelection":z},properties:{appearance:{refine:true,init:v},barPosition:{check:[A,d,B,c],init:B,apply:r}},members:{__qG:null,_createChildControlImpl:function(F,G){var H;
...
M.add(I);
this.__qG.add(J);
I.addState(this.__qF[this.getBarPosition()]);
I.addState(k);
...
S.addAt(N,O);
this.__qG.add(P);
N.addState(this.__qF[this.getBarPosition()]);
R=this.getChildren();
...
Y.remove(T);
this.__qG.remove(V);
T.removeState(this.__qF[this.getBarPosition()]);
...
},__qF:null,_applyBarPosition:function(bb,bc){var bd=this.getChildControl(j);
var bi=bb==A||bb==d;
var bg=bb==d||bb==c;
...
bd.setOrientation(bi?u:p);
var bj=this.getChildren();
if(bc){var be=this.__qF[bc];
bd.removeState(be);
for(var i=0,l=bj.length;i<l;i++){bj[i].removeState(be);
}}
if(bb){var bf=this.__qF[bb];
bd.addState(bf);
for(var i=0,l=bj.length;i<l;i++){bj[i].addState(bf);
}}},getSelection:function(){var bl=this.__qG.getSelection();
var bm=[];
...
var bA=bB.getButton().getChildControl(w);
bA.reset();
this.remove(bB);
