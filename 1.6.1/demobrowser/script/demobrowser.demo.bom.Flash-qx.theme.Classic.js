...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Flash","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Flash-qx.theme.Classic.5bf28e101d81.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}}}var w=this.__JN(r,s,u,v);
this._flashObjects[s.id]=w;
return w;
},destroy:qx.core.Environment.select(n,{"mshtml":function(x,y){x=this.__JI(x);

if(x.readyState==4){this.__JJ(x);
}else{if(!y){y=window;
}qx.bom.Event.addNativeListener(y,f,function(){qx.bom.Flash.__JJ(x);
});
}},"default":function(z,A){z=this.__JI(z);

if(z.parentNode){z.parentNode.removeChild(z);
}delete this._flashObjects[z.id];
}}),__JI:function(B){if(!B){throw new Error("DOM element is null or undefined!");
}
...
},__JJ:qx.core.Environment.select("engine.name",{"mshtml":qx.event.GlobalError.observeMethod(function(C){for(var i in C){if(typeof C[i]=="function"){C[i]=null;
}}
if(C.parentNode){C.parentNode.removeChild(C);
}delete this._flashObjects[C.id];
}),"default":null}),__JK:qx.event.GlobalError.observeMethod(function(){for(var D in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[D]);
}window.__JL=function(){};
window.__JM=function(){};
qx.bom.Event.removeNativeListener(window,"beforeunload",qx.bom.Flash.__JK);
}),__JN:qx.core.Environment.select("engine.name",{"mshtml":function(E,F,G,H){G.movie=F.data;
delete F.data;
delete F.classid;
var I="";
...
return O;
}})},defer:function(P){if((qx.core.Environment.get(n)==j)){qx.bom.Event.addNativeListener(window,g,P.__JK);
}}});
})();
