...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash-qx.theme.Classic.e8c504099d9c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="execute",j="__Qb",i="Flash Player Version",h="right",g="qooxdoo is the best!",f="Message from Flash:",d="Simple demo with FlashVars",c="bgcolor",b="demobrowser.demo.widget.Flash",a="Send to Flash",A="demobrowser/demo/flash/FlashVersion.swf",z="Flash:",y="<b>qooxdoo:</b>",x="__PY",w="demobrowser.demo.widget.Flash.sendMessage",v="demobrowser.demo.widget.Flash.flashReady",u="__JH",t="demobrowser/demo/flash/fo_tester.swf",s="this is passed in via FlashVars",r="Two way communication (ActionScript <-> JavaScript)",p="__cy",q="Message to Flash:",n="__Qa",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__cy:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var B=new qx.ui.tabview.TabView();
B.setContentPadding([8,8,8,8]);
var E=this.getRoot();
E.add(B,{edge:0});
var C=new qx.ui.tabview.Page(d);
C.setLayout(new qx.ui.layout.Canvas());
C.add(this.createFlashDemo1(),{edge:0});
B.add(C);
var D=new qx.ui.tabview.Page(r);
D.setLayout(new qx.ui.layout.Canvas());
D.add(this.createFlashDemo2(),{edge:0});
B.add(D);
this.__cy=this.createWindow();
E.add(this.__cy,{top:20,left:20});
},createWindow:function(){var F=new qx.ui.window.Window(i).set({width:300,height:200,contentPadding:[0,0,0,0]});
F.setLayout(new qx.ui.layout.Canvas());
F.add(new qx.ui.embed.Flash(A),{edge:0});
return F;
},createFlashDemo1:function(){var I=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var G={flashVarText:s};
var H=new qx.ui.embed.Flash(t).set({scale:l,variables:G});
H.getContentElement().setParam(c,m);
I.add(H,{flex:1});
var J=new qx.ui.form.Button(o);
J.addListener(k,function(){this.__cy.open();
},this);
I.add(J);
return I;
},__JH:null,__PY:null,__Qa:null,__Qb:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var M=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
...
this.__PY=new qx.ui.form.TextArea("No message.");
this.__PY.setEnabled(false);
L.add(this.__PY,{flex:1});
L.add(new qx.ui.basic.Label(q));
this.__Qa=new qx.ui.form.TextArea(g);
L.add(this.__Qa,{flex:1});
var N=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));
this.__Qb=new qx.ui.form.Button(a);
this.__Qb.setEnabled(false);
this.__Qb.addListener(k,function(e){this.__JH.getFlashElement().sendMessage(this.__Qa.getValue());
},this);
N.add(this.__Qb);
L.add(N);
var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
M.add(K,{flex:1});
K.add(new qx.ui.basic.Label(z).set({rich:true}));
this.__JH=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__JH.setVariables({init:v});
K.add(this.__JH,{flex:1});
return M;
},sendMessage:function(O){this.__PY.setValue(O);
},initFlash:function(){if(this.__JH.getFlashElement().setup){this.__JH.getFlashElement().setup(w);
this.__Qb.setEnabled(true);
...
}}},statics:{__Qc:null,setCallBackInstance:function(P){demobrowser.demo.widget.Flash.__Qc=P;
},sendMessage:function(Q){demobrowser.demo.widget.Flash.__Qc.sendMessage(Q);
},flashReady:function(){demobrowser.demo.widget.Flash.__Qc.initFlash();
}},destruct:function(){this._disposeObjects(x,n,j,u,p);
}});
})();
...
if(bh!=d&&bh!=null&&bh!=b){if(!this.isLoaded()){if(!this.__JC){this.__JC=new Date().getTime();
}var bi=new Date().getTime()-this.__JC;
...
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bt,bu){this.__JD(a,bt);
},_applyScale:function(bv,bw){this.__JD(X,bv);
},_applyWmode:function(bx,by){this.__JD(S,bx);
},_applyPlay:function(bz,bA){this.__JD(L,bz);
},_applyLoop:function(bB,bC){this.__JD(m,bB);
},_applyMenu:function(bD,bE){this.__JD(k,bD);
},_applyAllowScriptAccess:function(bF,bG){this.__JD(n,bF);
},_applyLiveConnect:function(bH,bI){this.__JD(v,bH);
},__JD:function(bJ,bK){this.getContentElement().setParam(bJ,bK);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
if(this.__JH){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,j);
},setId:function(k){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(k,f);
}
if(this.__JH){throw new Error("The id cannot be modified after initial creation");
...
if(this.__JH){throw new Error("The variables cannot be modified after initial creation");
}this.__JF=l;
...
if(this.__JH){throw new Error("The attributes cannot be modified after initial creation");
}
if(n===null||n===undefined){delete this.__JG[m];
}else{this.__JG[m]=n;
...
if(this.__JH){throw new Error("The params cannot be modified after initial creation");
}
if(p===null||p===undefined){delete this.__JE[o];
}else{this.__JE[o]=p;
