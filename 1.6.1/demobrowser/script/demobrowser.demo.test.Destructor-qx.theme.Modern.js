...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor-qx.theme.Modern.e327e537d673.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="Window: ",d="interval",c="__it",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__cP:null,__Pq:0,__it:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__cP=[];
this.currentTest=this.testWindows;
this.__it=new qx.event.Timer(1000);
this.__it.addListener(d,this.runTest,this);
this.__it.start();
},runTest:function(){this.__Pq++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Pq+" (Registry: "+g+")");
this.currentTest();
