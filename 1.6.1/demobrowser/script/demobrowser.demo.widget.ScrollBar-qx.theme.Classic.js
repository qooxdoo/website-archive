...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ScrollBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ScrollBar-qx.theme.Classic.ad3b7543611e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="scroll",d="Value: ",c="horizontal",b="demobrowser.demo.widget.ScrollBar",a="vertical";
...
var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({padding:20});
this.getRoot().add(h,{edge:0});
var j=new qx.ui.basic.Label(d).set({padding:30});
h.add(j,{row:0,column:0});
var i=new qx.ui.core.scroll.ScrollBar(a).set({height:200,maximum:500});
i.addListener(f,function(e){g.setPosition(e.getData());
});
h.add(i,{row:0,column:1});
var g=new qx.ui.core.scroll.NativeScrollBar(c).set({width:300,maximum:500});
g.addListener(f,function(e){i.setPosition(e.getData());
j.setValue(d+e.getData());
});
h.add(g,{row:1,column:0});
g.setPosition(170);
}}});
})();
