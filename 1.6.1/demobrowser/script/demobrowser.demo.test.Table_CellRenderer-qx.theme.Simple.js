...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellRenderer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Simple.1ddef3562d33.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},__KJ:function(Q,top,R,S,T){var U=["<div style='position:absolute;height:20px;width:",R,"px;top:",top,"px'>"];
...
var top=0;
qx.util.Permutation.permute(Y,function(ba){this.__KJ(X,top,W,V,ba);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bb,function(bg){this.__KJ(bc,top,be,bf,bg);
top+=bd;
},this);
bf.setIconFalse(y);
bf.setIconTrue(B);
qx.util.Permutation.permute(bb,function(bh){this.__KJ(bc,top,be,bf,bh);
top+=bd;
},this);
...
var top=0;
qx.util.Permutation.permute(bz,function(bA){this.__KJ(bx,top,bw,by,bA);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bH,function(bM){this.__KJ(bI,top,bK,bL,bM);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bN,function(bS){this.__KJ(bO,top,bQ,bR,bS);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bT,function(bY){this.__KJ(bU,top,bW,bX,bY);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(ca,function(ci){this.__KJ(cb,top,cd,ce,ci);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(cj,function(co){this.__KJ(ck,top,cm,cn,co);
top+=20;
},this);
...
},members:{__qk:null,__qj:16,__qi:16,_identifyImage:function(e){var f={imageWidth:this.__qi,imageHeight:this.__qj};

if(e.value==a){f.url=null;
}else{f.url=this.__qk.resolve(e.value);
}f.tooltip=e.tooltip;
return f;
