...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Geolocation","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Geolocation-qx.theme.Modern.d1887786c8d1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="</p>",n="<p>Latitude: ",m="error",l="Geolocation Not Supported",k="100px",j="Finding Your Location...",i="400px",h="html.geolocation",g="demobrowser.demo.bom.Geolocation",f="Position Unavailable",c="position",e="<p>Longitude: ",d="Timeout",b="Permission Denied",a="Failed: ";
qx.Class.define(g,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var p=qx.bom.Label.create(j,true);
p.style.width=i;
p.style.height=k;
document.body.appendChild(p);

if(!qx.core.Environment.get(h)){qx.bom.Label.setValue(p,l);
return;
}var q=qx.bom.GeoLocation.getInstance();
q.addListener(c,function(r){qx.bom.Label.setValue(p,n+r.getLatitude()+o+e+r.getLongitude()+o);
},this);
q.addListener(m,function(s){var t=[b,f,d];
var u=s.getData();
console.log(u);
qx.bom.Label.setValue(p,a+t[u.code-1]);
},this);
