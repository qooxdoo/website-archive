...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox-qx.theme.Classic.9d06660bf14b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="main",h="green",g="yellow",f="center",e="right",d="demobrowser.demo.layout.HBox",c="top",b="bottom",a="middle";
...
j.add(this.getBox6());
j.add(this.getBox7());
},getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return k;
},getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,minHeight:60,allowGrowX:false});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:c}));
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:a}));
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:b}));
return l;
},getBox3:function(){var m=new qx.ui.layout.HBox();
var n=new qx.ui.container.Composite(m).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
m.setSpacing(5);
m.setAlignX(e);
...
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return n;
},getBox4:function(){var o=new qx.ui.layout.HBox();
var p=new qx.ui.container.Composite(o).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
o.setSpacing(5);
o.setAlignX(f);
...
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return p;
},getBox5:function(){var r=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
var t=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var s=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var q=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
r.add(t);
r.add(s);
r.add(q);
t.setMarginRight(10);
...
q.setMarginRight(10);
return r;
},getBox6:function(){var u=new qx.ui.layout.HBox();
var w=new qx.ui.container.Composite(u).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
u.setSpacing(5);
u.setAlignX(e);
var y=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var x=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var v=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
w.add(y);
w.add(x);
w.add(v);
y.setMarginRight(10);
...
v.setMarginRight(10);
return w;
},getBox7:function(){var z=new qx.ui.layout.HBox();
var B=new qx.ui.container.Composite(z).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
z.setSpacing(5);
z.setAlignX(f);
var D=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var C=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var A=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
B.add(D);
B.add(C);
B.add(A);
D.setMarginRight(10);
