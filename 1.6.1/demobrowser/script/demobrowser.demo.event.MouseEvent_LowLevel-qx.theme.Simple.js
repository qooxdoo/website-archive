...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Simple.59dbe2dfc324.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="demobrowser.demo.event.MouseEvent_LowLevel",k="mouseout",j="mousedown",h="clientX",g="dblclick",f="relatedTarget",d="mouse",c="button",b="mousemove",a="screenX",x="logger",w="",v="mouseover",u="check_",t="click",s="Event",r="Target",q="clientY",p="mouseup",o="contextmenu",m="change",n="screenY";
qx.Class.define(l,{extend:demobrowser.demo.event.EventDemo,members:{__OF:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__OF=qx.lang.Function.bind(this.logMouseEvent,this);
this._initLogger([r,s,c,h,q,a,n,f],document.getElementById(x),50);
var y=document.getElementById(d);
var z=[j,p,t,g,o,b,v,k];

for(var i=0;i<z.length;i++){var A=document.getElementById(u+z[i]);

if(A.checked){qx.bom.Event.addNativeListener(y,z[i],this.__OF);
}qx.bom.Event.addNativeListener(A,m,qx.lang.Function.bind(this.__OE,this));
}},__OE:function(e){var E=qx.bom.Event.getTarget(e);
var D=E.id.split("_")[1];
var B=E.checked;
var C=document.getElementById("mouse");

if(B){qx.bom.Event.addNativeListener(C,D,this.__OF);
}else{qx.bom.Event.removeNativeListener(C,D,this.__OF);
}},logMouseEvent:function(F){qx.bom.Event.preventDefault(F);
this._log([qx.bom.Event.getTarget(F).id,F.type,F.button,F.clientX,F.clientY,F.screenX,F.screenY,qx.bom.Event.getRelatedTarget(F)?qx.bom.Event.getRelatedTarget(F).id:w]);
}}});
})();
