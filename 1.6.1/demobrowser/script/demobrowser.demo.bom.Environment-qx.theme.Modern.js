...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Environment","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Environment-qx.theme.Modern.d5c84832deae.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="<tr><td>",n="</td><td>",m="output",l="</table>",k="</td></tr>",j="demobrowser.demo.bom.Environment",h="<tr><td colspan='2'>&nbsp;</td></tr>",g="",f="<tr><td colspan='2'><h2>Asynchronous checks</h2></td></tr>",e="<h2>Synchronous checks</h2>",b="<tr><td colspan='2'><b>",d=".",c="<table border='0'>",a="</b></td></tr>";
...
u.add(e);
u.add(c);
var v=qx.core.Environment.getChecks();
var q=qx.lang.Object.getKeys(v);
q.sort();
var w=g;
...
u.add(h);
u.add(b+s+a);
}u.add(o,t,n,qx.lang.Json.stringify(qx.core.Environment.get(t),null,2),k);
}u.add(f);
v=qx.core.Environment.getAsyncChecks();
var p=qx.lang.Object.getLength(v);
q=qx.lang.Object.getKeys(v);

if(p){for(var i=0;i<q.length;i++){var t=q[i];
qx.core.Environment.getAsync(t,function(x){u.add(o,this,n,qx.lang.Json.stringify(x,null,2),k);
p--;
