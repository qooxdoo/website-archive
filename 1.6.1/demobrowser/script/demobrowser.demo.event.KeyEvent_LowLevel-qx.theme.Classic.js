...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.KeyEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.KeyEvent_LowLevel-qx.theme.Classic.19b05b35c96c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},_initLogger:function(k,l,m){this.__OA="<table><tr><th>"+k.join("</th><th>")+"</th></tr>";
this.__OB=m||50;
this.__OC=l;
this._clearLog();
},_clearLog:function(){this.__OC.innerHTML=this.__OA+h;
this.__OD=[];
},_log:function(n){this.__OD.unshift(n);
this.__OD=this.__OD.slice(0,this.__OB);
var o=[this.__OA];

for(var i=0;i<this.__OD.length;i++){o.push(d,this.__OD[i].join(f),a);
}o.push(h);
this.__OC.innerHTML=o.join(e);
this.__OC.scrollTop=0;
},__OA:null,__OB:null,__OC:null,__OD:null},destruct:function(){this.__OC=this.__OD=null;
}});
})();
...
qx.Class.define(f,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
