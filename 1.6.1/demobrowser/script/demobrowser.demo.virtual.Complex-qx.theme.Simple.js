...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex-qx.theme.Simple.d736ded830b8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__lP=[];
},members:{_pool:null,__lP:null,getCellData:function(i,k){if(!this.__lP[i]){this.__lP[i]=[];
}
if(!this.__lP[i][k]){this.__lP[i][k]={label:this.__PM(),icon:this.__PN()};
}return this.__lP[i][k];
},getCellWidget:function(l,m){var n;

if(m%2==0){n=this._pool.atom.pop();

if(!n){n=new qx.ui.basic.Atom();
n.addListener(c,function(){var o=this.__PN();
n.setIcon(o);
this.__lP[l][m].icon=o;
},this);
