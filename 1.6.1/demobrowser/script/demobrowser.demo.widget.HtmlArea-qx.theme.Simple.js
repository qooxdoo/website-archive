...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Simple.d6efecc66df8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(bG,{extend:qx.application.Standalone,members:{__wf:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
ca.setWidthTop(0);
this.__wf=new qx.ui.embed.HtmlArea(cc,null,F);
this.__wf.set({width:600,height:400,decorator:ca});
...
},__wg:function(e){var ce=window.prompt(bt,bx);
this.setTextColor(ce);
},__wh:function(e){var cf=window.prompt(bf,bx);
this.setTextBackgroundColor(cf);
},__wi:function(e){var cg={src:qx.util.ResourceManager.getInstance().toUri(bL),border:0,title:bw,alt:bw};
this.insertImage(cg);
},__wj:function(e){var ch=R+U+bz+bD+K+bv+bz+b+s+bv+c+M;
this.insertHtml(ch);
},__wk:function(e){var cj=new qx.ui.window.Window(H);
...
cj.open();
this.saveRange();
},__wl:function(e){var co=window.prompt(bq,bB);
this.insertHtml(co);
},__wm:function(){var cq=new qx.ui.form.SelectBox;
...
return cq;
},__wn:function(){var cu=new qx.ui.form.SelectBox;
...
return cu;
},__wo:function(){return [{bold:{text:bS,image:p,action:this.__wf.setBold},italic:{text:ba,image:W,action:this.__wf.setItalic},underline:{text:x,image:Y,action:this.__wf.setUnderline},strikethrough:{text:y,image:bV,action:this.__wf.setStrikeThrough},removeFormat:{text:I,image:bP,action:this.__wf.removeFormat}},{alignLeft:{text:n,image:t,action:this.__wf.setJustifyLeft},alignCenter:{text:O,image:bl,action:this.__wf.setJustifyCenter},alignRight:{text:bb,image:q,action:this.__wf.setJustifyRight},alignJustify:{text:bk,image:B,action:this.__wf.setJustifyFull}},{fontFamily:{custom:this.__wm},fontSize:{custom:this.__wn},fontColor:{text:d,image:k,action:this.__wg},textBackgroundColor:{text:bj,image:bn,action:this.__wh}},{indent:{text:be,image:bu,action:this.__wf.insertIndent},outdent:{text:z,image:T,action:this.__wf.insertOutdent}},{insertImage:{text:r,image:G,action:this.__wi},insertTable:{text:f,image:l,action:this.__wj},insertLink:{text:a,image:E,action:this.__wk},insertHTML:{text:D,image:bm,action:this.__wl},insertHR:{text:bp,image:bo,action:this.__wf.insertHorizontalRuler}},{ol:{text:u,image:bH,action:this.__wf.insertOrderedList},ul:{text:bc,image:br,action:this.__wf.insertUnorderedList}},{undo:{text:bM,image:m,action:this.__wf.undo},redo:{text:bT,image:P,action:this.__wf.redo}}];
...
cw.addListener(bA,cA.action,this.__wf);
}cy.add(cw);
}}return toolbar;
}}});
})();
...
this.__uu=qx.bom.htmlarea.HtmlArea.__uw(eD);
if(qx.lang.Type.isString(eC)){this.__uv=eC;
...
},__uy:function(eP,eQ,eR,eS){var eX=[];

switch(eP.nodeType){case 1:case 11:var i;
var eV=eP.tagName.toLowerCase();
var fa={};
var eT={};
var closed=(!(eP.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__uz(eP)));

if(eQ){if((qx.core.Environment.get(dT)==dR)){if(eV==dt&&eP.className&&eP.className==A){for(i=eP.firstChild;i;i=i.nextSibling){eX.push(qx.bom.htmlarea.HtmlArea.__uy(i,true,eR,eS));
}return eX.join(dS);
...
}if(fa.style!==undefined){eT=qx.bom.htmlarea.HtmlArea.__ux(fa.style);
delete fa.style;
...
eX.push(dK,name,dg,fb.toString().replace(new RegExp(cq,er),R),cq);
}if(!qx.lang.Object.isEmpty(eT)){eX.push(cT);

for(var name in eT){var fb=eT[name];
eX.push(name,v,fb.toString().replace(new RegExp(cq,er),R),L);
}eX.push(cq);
}eX.push(closed?cF:O);
}}for(i=eP.firstChild;i;i=i.nextSibling){eX.push(qx.bom.htmlarea.HtmlArea.__uy(i,true,eR,eS));
}if(eQ&&!closed&&eV){eX.push(cJ,eV,O);
}break;
case 3:eX.push(eR?eP.data:qx.bom.htmlarea.HtmlArea.__uA(eP.data));
break;
case 8:eX.push(bL,eP.data,bV);
break;
}return eX.join(dS);
},closingTags:cH,__uz:function(fc){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(dK+fc.tagName+dK)!=-1);
},__uA:function(s){s=s.replace(/&/ig,dC);
s=s.replace(/</ig,cQ);
s=s.replace(/>/ig,dj);
...
}},properties:{contentType:{check:P,init:k},messengerMode:{check:cu,init:false},insertParagraphOnLinebreak:{check:cu,init:true},insertLinebreakOnCtrlEnter:{check:cu,init:true},postProcess:{check:bf,nullable:true,init:null},useUndoRedo:{check:cu,init:true},nativeContextMenu:{check:cu,init:false},defaultFontFamily:{check:P,init:bT},defaultFontSize:{check:cY,init:4}},members:{__kd:null,__gR:false,__uB:false,__uC:false,__uD:false,__uE:false,__tG:null,__uF:null,__uG:null,__uH:null,__rG:null,__uu:null,__uI:null,__uJ:null,__uK:false,__uL:false,__uM:function(fj){if(qx.dom.Node.isElement(fj)&&qx.dom.Node.isNodeName(fj,dt)){this.__kd=fj;
}},_createAndAddIframe:function(fk){this.__rG=qx.bom.Iframe.create();
qx.bom.Iframe.setSource(this.__rG,fk);
if((qx.core.Environment.get(dT)==dR)){qx.bom.element.Attribute.set(this.__rG,eh,ca);
}else{qx.bom.element.Style.set(this.__rG,eg,ei);
}qx.bom.element.Style.setStyles(this.__rG,{width:q,height:q});
...
},_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__rG,bk,this._loaded,this);
},__uN:function(){this.__uI={"xhtml":{doctype:cV+dz+z+ej+ce+cN,html:ek+bN,meta:b,style:qx.core.Environment.select(dT,{"mshtml":cc+dI,"default":dm+ep}),contentStyle:dJ,body:en,footer:N}};
},__uv:dS,getIframeObject:function(){return this.__rG;
},getCommandManager:function(){return this.__tG;
},setValue:function(fl){if(qx.lang.Type.isString(fl)){this.__uv=fl;
var fm=this._getIframeDocument();

if(fm&&fm.body){fm.body.innerHTML=this.__uO(fl);
}}},__uO:function(fn){var fq=dS;

if((qx.core.Environment.get(dT)==dQ)){if(qx.core.Environment.get(dy)<=2){fq+=cP;
}}var fr=fn.length==0?cR:dS;
var fp=qx.core.Environment.get(dT)==dQ||qx.core.Environment.get(dT)==dP?bI:cU;
var fo=dd+C+this.getDefaultFontFamily()+y+bj+fp+bM+this.getDefaultFontSize()+y+fq+fn+fr+dk+bz+f;
return fo;
},getValue:function(){return this.__uv;
},getComputedValue:function(fs){return this.getHtml(fs);
},getCompleteHtml:function(){var fu=this.__uI[this.getContentType()];
var ft=fu.html+t+fu.meta+bt+fu.contentStyle+bs+r;
ft+=K+this.__uP()+bO;
ft+=this.getHtml()+N;
return ft;
},__uP:function(){var fx=[bA,G,dB,bK,Y,be,D,l,dE,cv,d,bS,dh,bX];
...
},__uQ:0,__uR:function(){var fS=this._getIframeDocument();
if(!fS){this.__uQ++;

if(this.__uQ>5){this.error('cant load HtmlArea. Document is not available. '+fS);
this.fireDataEvent(dV);
}else{if(qx.core.Environment.get(cs)){this.error('document not available, try again...');
}qx.event.Timer.once(function(){this.__uR();
},this,0);
}}else{this.__uQ=0;
...
return;
}if((qx.core.Environment.get(dT)==dR)){this.__uR();
...
if(!(qx.core.Environment.get(dT)==dO)){this.__uW();
}if(!(qx.core.Environment.get(dT)==dR)){this.setEditable(true);
}this.__gR=true;
this.__tG=fT;
...
this.__vd(true);
}}},"default":qx.lang.Function.empty}),invalidateEditor:qx.core.Environment.select(dT,{"gecko":function(){this.__uC=false;
this.__gR=false;
this.__uB=true;
},"default":function(){}}),__uS:qx.core.Environment.select(dT,{"gecko":function(){this.__uV();
this.__uW();
...
this.__uB=false;
this.fireEvent(cA);
},"default":function(){}}),__uT:function(fV){var fX=dS;
...
},__uU:function(ga){var gb=qx.core.Environment.get(dT)==dQ?em:dS;
var gc=this.__uI[this.getContentType()];
var gd=t+gc.meta+bt+gb+gc.style+gc.contentStyle+this.__uu+bs+r;
var content=gc.body+ga;
return gc.html+gd+content+gc.footer;
},__uV:function(){var gf=this.__uO(this.getValue());

if(qx.lang.Type.isString(gf)){var ge=this._getIframeDocument();

try{ge.open(bY,true);
ge.write(this.__uU(gf));
ge.close();
...
this.__va();
this.__uY();
},__uX:function(){var gh=qx.event.Registration;
...
},__uY:function(){var gk=qx.event.Registration;
...
},__va:function(){var gn=qx.event.Registration;
...
},__vb:function(){if(this.__uF==null){this.__uF={execute:function(go,gp){this.stackedCommands=true;
this.commandStack.push({command:go,value:gp});
},commandStack:[],stackedCommands:false};
}this.__uF.stackedCommands=false;
return this.__uF;
},__vc:function(){var gq=this.__uF;

if(gq!=null&&gq.stackedCommands){var gr=gq.commandStack;

if(gr!=null){for(var i=0,j=gr.length;i<j;i++){this.__tG.execute(gr[i].command,gr[i].value);
}}}},__vd:function(gs){var gt=this._getIframeDocument();

if(this.__uC&&gt){try{if((qx.core.Environment.get(dT)==dQ)){gt.designMode=(gs!==false)?x:ds;
}gt.designMode=(gs!==false)?ds:x;
}catch(e){}}},setEditable:function(gu){if(this.__uC){this.__vd(true);
...
}catch(gx){if(!this.__gR){this.error("Failed to enable rich edit functionality");
...
},__ve:false,_handleKeyUp:function(e){var gy=e.getKeyIdentifier().toLowerCase();
this.__uG=e;

if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cl)){this.debug(e.getType()+" | "+gy);
}if(qx.core.Environment.get(dT)==dR||qx.core.Environment.get(dT)==dP){if(this.__ve){switch(gy){case cr:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(dT)==dP)){this.__vf();
e.preventDefault();
e.stopPropagation();
}else{var gz=this.__vp(this.getSelection());

if(gz){gz.collapse(true);
gz.pasteHTML(H);
}}this.__vk();
}break;
case bv:this.__ve=false;
return;
break;
}}}else if((qx.core.Environment.get(dT)==dQ)){switch(gy){case cp:case cn:case bu:case et:case ee:case eu:case U:case dq:case dx:this.__uE=(this.getFocusNode()==this.getContentBody().firstChild);
break;
}}},__vf:function(){var gA=this.getSelection();
var gB=dS;
if(gA&&(gA.focusNode.textContent==dS||gA.focusNode.parentElement.tagName==cO)){gB=bH;
}this.__tG.execute(ec,gB+qx.bom.htmlarea.HtmlArea.simpleLinebreak);
},_handleKeyDown:qx.core.Environment.select(dT,{"mshtml|webkit":function(e){var gC=e.getKeyIdentifier().toLowerCase();

if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cl)){}if(this.__ve&&(gC==M||gC==dn||gC==dU||gC==bp||gC==du||gC==u)){e.preventDefault();
e.stopPropagation();
}if(gC==bv){this.__ve=true;
...
if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cl)){this.debug(e.getType()+" | "+gD);
}if(this.__uK){var gN=!((qx.core.Environment.get(dT)==dR)&&gD==cr)||!((qx.core.Environment.get(dT)==dQ)&&gD==cr);

if(gN){this.__vk();
this.__uK=false;
}}
switch(gD){case cr:if(!gG&&!gF&&this.getMessengerMode()){e.preventDefault();
e.stopPropagation();
this.fireDataEvent(da,this.getComputedValue());
this.resetHtml();
}if(gF){if(!this.getInsertLinebreakOnCtrlEnter()){return;
}e.preventDefault();
e.stopPropagation();

if((qx.core.Environment.get(dT)==dQ)){if(this.__vn()){this.insertHtml(bh);
this.__vk();
return;
}this.insertHtml(cg);
}else if((qx.core.Environment.get(dT)==dO)){var gM=this.getSelection();
var gI=this.__vp(gM);

if(gM&&gI){var gJ=gH.createElement(eb);
gI.collapse(true);
gI.insertNode(gJ);
gI.collapse(true);
gI.selectNode(gJ);
...
}if((qx.core.Environment.get(dT)==dR)){if(!this.getInsertParagraphOnLinebreak()){if(this.__tG.execute(ec,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__vk();
e.preventDefault();
e.stopPropagation();
}}}else if((qx.core.Environment.get(dT)==dQ)){if(this.getInsertParagraphOnLinebreak()&&!gG&&!gF){var gM=this.getSelection();

if(gM){var gE=gM.focusNode;
if(this.__vn()){this.__vk();
return;
}if(this.__vo()){this.__vk();
return;
}while(!qx.dom.Node.isNodeName(gE,ea)){if(qx.dom.Node.isNodeName(gE,bB)){this.__vk();
return;
}gE=gE.parentNode;
...
this.__vk();
this.__uK=true;
}}else if((qx.core.Environment.get(dT)==dP)){if(this.getInsertParagraphOnLinebreak()&&gG){this.__vf();
e.preventDefault();
e.stopPropagation();
this.__vk();
}}break;
case bu:if(qx.core.Environment.get(dT)==dQ&&qx.core.Environment.get(ck)<1.9&&gG){var gM=this.getSelection();
if(gM&&gM.focusNode==gH.body.firstChild){if(this.__uE){if(gM.focusOffset!=0){gM.extend(gM.focusNode,0);
}}}}this.__vk();
break;
case bc:if(qx.core.Environment.get(dT)==dQ&&qx.core.Environment.get(ck)<1.9){if(gF){var gM=this.getSelection();
if(gG){if(gM&&(gM.focusOffset!=0)||(gM.focusNode!=gH.body.firstChild)){gM.extend(gH.body.firstChild,0);
}}else{var gK=null;
var gL;
if(gH){gK=gH.evaluate(cL,gH.body,null,XPathResult.ANY_TYPE,null);
}
if(gK&&gM){while(gL=gK.iterateNext()){if(gL&&gL.parentNode&&gL.parentNode.tagName!=W){try{gM.extend(gL,0);

if(!this.isSelectionCollapsed()){gM.collapseToStart();
}}catch(e){}break;
}}}}}}this.__vk();
break;
case cp:case cn:case et:case ee:case eu:case U:case dq:case dx:this.__vk();
break;
case dU:if(gF){this.__vg(bQ,true);
}break;
case du:case u:if(gF){this.__vg(cI,true);
}break;
case bp:if(gF){this.__vg(bP,true);
}break;
case M:if(gF&&!gG){this.__vg(bG,true);
}else if(gF&&gG){this.__vg(w,true);
}break;
case dn:if(gF){this.__vg(w,true);
}break;
case dD:if(gF){this.selectAll();
}break;
}this.__uG=null;
},__vg:function(gO,gP){var gR=null;
var gQ=qx.bom.htmlarea.HtmlArea.hotkeyInfo;

if(gQ[gO]){gR=gQ[gO].method;
}
if(gR!=null&&this[gR]){this[gR]();

if(gP){this.__uG.preventDefault();
...
if(qx.core.Environment.get(dT)==dQ||qx.core.Environment.get(dT)==dP){var gS=this.getContentDocument().getElementById(ct);

if(gS){qx.bom.element.Attribute.reset(gS,dM);
}}this.fireEvent(ba);
...
},_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(cs))&&qx.core.Environment.get(cl)){this.debug("handleMouse "+e.getType());
}this.__uL=true;
this.__vk();
},_handleMouseUpOnDocument:qx.core.Environment.select(dT,{"mshtml":qx.lang.Function.empty,"default":function(e){if(!this.__uL){qx.bom.Element.activate(this.getContentBody());
}this.__uL=false;
}}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var gV=e.getViewportLeft();
var gU=e.getViewportTop();
var gW=qx.bom.element.Location.getLeft(this.__kd)+gV;
var gX=qx.bom.element.Location.getTop(this.__kd)+gU;
var gT={x:gW,y:gX,relX:gV,relY:gU,target:e.getTarget()};
e.preventDefault();
e.stopPropagation();
qx.event.Timer.once(function(){this.fireDataEvent(ed,gT);
},this,0);
}},isLoaded:function(){return this.__uC;
},insertHtml:function(gY){return this.__tG.execute(ec,gY);
},removeFormat:function(){var ha=this.__tG.execute(dF);
this.__tG.execute(ey,this.getDefaultFontSize());
this.__tG.execute(bC,this.getDefaultFontFamily());
return ha;
},setBold:function(){return this.__tG.execute(dw);
},setItalic:function(){return this.__tG.execute(dY);
},setUnderline:function(){return this.__tG.execute(dW);
},setStrikeThrough:function(){return this.__tG.execute(cj);
},setFontSize:function(hb){return this.__tG.execute(ey,hb);
},setFontFamily:function(hc){return this.__tG.execute(bC,hc);
},setTextColor:function(hd){return this.__tG.execute(bd,hd);
},setTextBackgroundColor:function(he){return this.__tG.execute(bg,he);
},setJustifyLeft:function(){return this.__tG.execute(g);
},setJustifyCenter:function(){return this.__tG.execute(cf);
},setJustifyRight:function(){return this.__tG.execute(bx);
},setJustifyFull:function(){return this.__tG.execute(cy);
},insertIndent:function(){return this.__tG.execute(cS);
},insertOutdent:function(){return this.__tG.execute(V);
},insertOrderedList:function(){return this.__tG.execute(eo);
},insertUnorderedList:function(){return this.__tG.execute(cX);
},insertHorizontalRuler:function(){return this.__tG.execute(dc);
},insertImage:function(hf){return this.__tG.execute(dA,hf);
},insertHyperLink:function(hg){return this.__tG.execute(bi,hg);
},removeBackgroundColor:function(){this.__tG.execute(dr,bl);
},setBackgroundColor:function(hh){this.__tG.execute(dr,hh);
},removeBackgroundImage:function(){this.__tG.execute(p);
},setBackgroundImage:function(hi,hj,hk){return this.__tG.execute(p,[hi,hj,hk]);
},selectAll:function(){return this.__tG.execute(bm);
},undo:function(){if(this.getUseUndoRedo()){return this.__tG.execute(ew);
}else{return true;
}},redo:function(){if(this.getUseUndoRedo()){return this.__tG.execute(dv);
}else{return true;
}},resetHtml:function(){var hl=this._getIframeDocument();
while(hl.body.firstChild){hl.body.removeChild(hl.body.firstChild);
}if(qx.core.Environment.get(dT)==dQ){hl.body.innerHTML=dG;
}else if(qx.core.Environment.get(dT)==dP){var hm=this.getSelection();
var hn=hl.createRange();

if(hn&&hm){hm.addRange(hn);
}}},getHtml:function(ho){var hp=this._getIframeDocument();

if(hp==null){return null;
}return qx.bom.htmlarea.HtmlArea.__uy(hp.body,false,ho,this.getPostProcess());
},containsOnlyPlaceholder:qx.core.Environment.select(dT,{"mshtml":function(){var hq=this._getIframeDocument();
return (hq.body.innerHTML==cK);
},"default":qx.lang.Function.returnFalse}),_selectElement:function(hr){var ht=this.getContentWindow().getSelection();
var hs=this.getContentDocument().createRange();
hs.setStart(hr,0);
ht.removeAllRanges();
ht.addRange(hs);
},focusContent:qx.core.Environment.select(dT,{"gecko":function(){var hv=this.getContentDocument();
var hu=hv.getElementById(ct);
this.getContentWindow().focus();
qx.bom.Element.focus(this.getContentBody());

if(hu){this._selectElement(hu);
}else{this.__vh();
}},"webkit":function(){qx.bom.Element.focus(this.getContentWindow());
qx.bom.Element.focus(this.getContentBody());
var hw=this.getContentDocument().getElementById(ct);

if(hw){qx.bom.element.Attribute.reset(hw,dM);
}this.__vh();
...
}},__vi:qx.core.Environment.select(dT,{"gecko":function(){var hx=this.getContentBody().childNodes;

if(hx.length==0){return false;
}else if(hx.length==1){return !(hx[0]&&qx.dom.Node.isNodeName(hx[0],eb)&&qx.bom.element.Attribute.get(hx[0],T)!=null);
}else{return true;
}},"webkit":function(){var hy=this.getContentBody().childNodes;

if(hy.length==0){return false;
}else if(hy.length==1){return !(hy[0]&&qx.dom.Node.isNodeName(hy[0],eb));
}else{return true;
}},"default":function(){var hz=this.getContentBody().childNodes;

if(hz.length==0){return false;
}else if(hz.length==1){return !(hz[0]&&qx.dom.Node.isNodeName(hz[0],br)&&hz[0].firstChild==null);
}else{return true;
}}}),__vj:qx.core.Environment.select(dT,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__uO(dS);
var hA=this.getContentDocument().getElementById(ct);
qx.bom.element.Attribute.reset(hA,dM);
this._selectElement(hA);
},"default":function(){var hB=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());

if(qx.dom.Node.isNodeName(hB,br)){qx.bom.element.Style.set(hB,es,this.getDefaultFontFamily());
qx.bom.element.Style.set(hB,bo,this.getDefaultFontSize());
}}}),getContextInformation:function(){return this.__vl();
},__vk:function(){qx.event.Timer.once(function(e){var hC=this.__vl();
this.fireDataEvent(cB,hC);
},this,200);
...
}var hG=this.getFocusNode();

if(hG==null){return;
}
if(qx.dom.Node.isText(hG)){hG=hG.parentNode;
}var hK=this._getIframeDocument();
var hT=(qx.core.Environment.get(dT)==dR)?hG.currentStyle:hK.defaultView.getComputedStyle(hG,null);
var hN=false;
var hD=false;
var hI=false;
var hH=false;
...
if(hT!=null){if((qx.core.Environment.get(dT)==dR)){hD=hT.fontStyle==dY;
hI=hT.textDecoration.indexOf(dW)!==-1;
hH=hT.textDecoration.indexOf(Q)!==-1;
hR=hT.fontSize;
hM=hT.fontFamily;
hJ=hT.textAlign==cp;
hU=hT.textAlign==ez;
hF=hT.textAlign==cn;
hQ=hT.textAlign==eA;
}else{hD=hT.getPropertyValue(m)==dY;
hI=hT.getPropertyValue(ev).indexOf(dW)!==-1;
hH=hT.getPropertyValue(ev).indexOf(Q)!==-1;
hR=hT.getPropertyValue(bo);
hM=hT.getPropertyValue(es);
hJ=hT.getPropertyValue(co)==cp;
hU=hT.getPropertyValue(co)==ez;
hF=hT.getPropertyValue(co)==cn;
hQ=hT.getPropertyValue(co)==eA;
}
if(qx.core.Environment.get(dT)==dR||qx.core.Environment.get(dT)==dO){hN=hT.fontWeight==700;
}else{hN=hT.getPropertyValue(J)==dw||qx.dom.Node.isNodeName(hG,dU);
}}var hE=hG;
if(hE!=null&&hE.parentNode!=null&&!qx.dom.Node.isDocument(hE.parentNode)){while(hE!=null&&!qx.dom.Node.isNodeName(hE,ea)){var hL=qx.dom.Node.getName(hE);

if(hL==cM){hS=true;
break;
}else if(hL==cC){hO=true;
break;
}
if(hV==null||hV==dS){hV=qx.bom.element.Attribute.get(hE,F);
}hE=hE.parentNode;
}}var hP={bold:hN?1:0,italic:hD?1:0,underline:hI?1:0,strikethrough:hH?1:0,fontSize:(hV==null)?hR:hV,fontFamily:hM,insertUnorderedList:hO?1:0,insertOrderedList:hS?1:0,justifyLeft:hJ?1:0,justifyCenter:hU?1:0,justifyRight:hF?1:0,justifyFull:hQ?1:0};
...
}var hW=this.getRange();

if(!hW){return dS;
}else{return this.__vm(hW);
}},__vm:qx.core.Environment.select(dT,{"mshtml":function(hX){if(!hX){return dS;
}return hX.item?hX.item(0).outerHTML:hX.htmlText;
},"default":function(hY){var ia=this._getIframeDocument();

if(ia&&hY){try{var ib=ia.createElement(ea);
ib.appendChild(hY.cloneContents());
return ib.innerHTML;
}catch(ic){}return hY+dS;
}return dS;
}}),clearSelection:qx.core.Environment.select(dT,{"mshtml":function(){var id=this.getSelection();

if(id){id.empty();
}},"default":function(){var ie=this.getSelection();

if(ie){ie.collapseToStart();
}}}),__vn:qx.core.Environment.select(dT,{"gecko":function(){var ig=this.getSelection();
var ih=this.getFocusNode();
return ig&&this.isSelectionCollapsed()&&ih!=null&&qx.dom.Node.isText(ih)&&ig.anchorOffset<ih.length;
},"default":function(){return false;
}}),__vo:qx.core.Environment.select(dT,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());
},"default":function(){return false;
}}),getRange:function(){return this.__vp(this.getSelection());
},__vp:qx.core.Environment.select(dT,{"mshtml":function(ii){var ij=this._getIframeDocument();

if(ii){try{return ii.createRange();
}catch(ik){return ij?ij.body.createTextRange():null;
}}else{return ij?ij.body.createTextRange():null;
}},"default":function(il){var im=this._getIframeDocument();

if(il){try{return il.getRangeAt(0);
}catch(io){return im?im.createRange():null;
}}else{return im?im.createRange():null;
}}}),saveRange:qx.core.Environment.select(dT,{"mshtml":function(){this.__uJ=this.getRange();
},"default":function(){}}),getSavedRange:qx.core.Environment.select(dT,{"mshtml":function(){return this.__uJ;
},"default":function(){}}),resetSavedRange:qx.core.Environment.select(dT,{"mshtml":function(){this.__uJ=null;
},"default":function(){}}),getFocusNode:qx.core.Environment.select(dT,{"mshtml":function(){var ip=this.getSelection();
var iq;

switch(ip.type){case cW:case S:iq=this.__vp(ip);

if(iq){iq.collapse(false);
return iq.parentElement();
}else{return null;
}break;
case B:iq=this.__vp(ip);

if(iq){try{iq.collapse(false);
}catch(ir){}return iq.item(0);
}else{return null;
}break;
default:return this._getIframeDocument().body;
}},"default":function(){var is=this.getSelection();

if(is&&is.focusNode){return is.focusNode;
}return this._getIframeDocument().body;
}})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var iu=this._getIframeDocument();
var iw=qx.event.Registration;
iw.removeListener(iu.body,eq,this._handleKeyPress,this);
iw.removeListener(iu.body,bE,this._handleKeyUp,this);
iw.removeListener(iu.body,bD,this._handleKeyDown,this);
var iv=qx.core.Environment.get(dT)==dP?this._getIframeWindow():iu.body;
iw.removeListener(iv,bq,this._handleFocusEvent);
iw.removeListener(iv,bn,this._handleBlurEvent);
iw.removeListener(iu,bF,this._handleFocusOutEvent);
var it=qx.core.Environment.get(dT)==dR?bw:dp;
iw.removeListener(iu.body,it,this._handleMouseUpOnBody,this);
iw.removeListener(iu.documentElement,it,this._handleMouseUpOnDocument,this);
iw.removeListener(iu.documentElement,ed,this._handleContextMenuEvent,this);

if((qx.core.Environment.get(dT)==dR)){qx.bom.Iframe.setSource(this.__rG,db);
}}catch(ix){}
if(this.__tG instanceof qx.core.Object){this._disposeObjects(de);
}else{this.__tG=null;
...
(function(){var cw="engine.name",cv="",cu="legacy-font-size",ct="mshtml",cs="inserthtml",cr="qx.debug",cq='color',cp="text-decoration",co=';',cn="p",bx="span",bw="__vE",bv="transparent",bu="id",bt="InsertHtml",bs='">',br="child",bq="gecko",bp="font-family",bo="text-align",cD='text-decoration',cE="BackColor",cB="FontSize",cC="/>",cz="<img ",cA="</font>",cx="backgroundPosition",cy="font-size",cF='|',cG="string",bV="background-color",bU="backgroundRepeat",bX="font",bW=":",ca="='",bY=" ",cc=";",cb="body",bT="px",bS="backgroundImage",a="Control",b="__paragraph__",c=':',d="qx.bom.htmlarea.HtmlArea.debug",f="size",g="' ",h="webkit",m="textDecoration",n="BODY",o="__vF",cS="undefined",cR="__wc",cQ="_moz",cP="top",cW="formatBlock",cV="insertParagraph",cU="li",cT='<span style="',cY="__vA",cX="__vV",N="no-repeat",O=' <a href="',L="FONT",M="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",R="__placeholder__",S='font-family:',P="<p style='",Q="outdent",J="__wb",K='</a> ',w="InsertImage",v="__resetHtml",y="FontName",x="__vW",s="bold",r="blockquote",u="underline",t="style",q="__we",p="qx.bom.htmlarea.manager.Command",X="__vT",Y="'><br class='webkit-block-placeholder' />",ba="a",bb='"',T="<span></span>",U="__vH",V="type",W="CreateLink",bc="__wd",bd="italic",G="__vU",F="qx_link",E="none",D='"></span>',C="Italic",B="fontStyle",A="InsertUnorderedList",z="OL",I='text-align:',H="Bold",be="ForeColor",bf="url(",bg='" ',bh="repeat repeat-x repeat-y no-repeat",bi='</p>',bj="<hr />",bk='<font style="',bl="IMG",bm='<p id="',bn="StrikeThrough",bB="LI",bA="__getHtml",bz='>',by='" size="',bF="Indent",bE="HiliteColor",bD="br",bC="fontWeight",bH="Copy",bG="</span>",bO="Paste",bP="__vJ",bM="RemoveFormat",bN="JustifyRight",bK='',bL="__vX",bI='style="',bJ="__vS",bQ="JustifyCenter",bR="_moz_dirty",cg="color",cf="JustifyLeft",ci="Underline",ch="SelectAll",ck="Cut",cj="__vK",cm="line-through",cl=")",ce="href",cd='<span id="',cL="__vY",cM="UL",cN="JustifyFull",cO="Outdent",cH="indent",cI="backgroundColor",cJ="selectall",cK="InsertOrderedList";
qx.Class.define(p,{extend:qx.core.Object,construct:function(da){qx.core.Object.call(this);
this.__tH=da;
this.__kc=null;
this._commands=null;
this.__uk();
...
this.__vs=0;
},statics:{__vt:M,__vu:bh},members:{__kc:null,__tH:null,__vv:false,__vq:null,__vr:null,__vs:null,setContentDocument:function(db){this.__kc=db;
},getCommandObject:function(dc){if(this._commands[dc]){return this._commands[dc];
}else{return null;
}},__uk:function(){this._commands={bold:{useBuiltin:false,identifier:H,method:J},italic:{useBuiltin:false,identifier:C,method:cR},underline:{useBuiltin:false,identifier:ci,method:bc},strikethrough:{useBuiltin:false,identifier:bn,method:q},fontfamily:{useBuiltin:true,identifier:y,method:null},fontsize:{useBuiltin:false,identifier:cB,method:bJ},textcolor:{useBuiltin:true,identifier:be,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:X},backgroundcolor:{useBuiltin:false,identifier:null,method:G},backgroundimage:{useBuiltin:false,identifier:null,method:cX},justifyleft:{useBuiltin:false,identifier:cf,method:bw},justifyright:{useBuiltin:false,identifier:bN,method:bw},justifycenter:{useBuiltin:false,identifier:bQ,method:bw},justifyfull:{useBuiltin:false,identifier:cN,method:bw},indent:{useBuiltin:true,identifier:bF,method:null},outdent:{useBuiltin:true,identifier:cO,method:null},copy:{useBuiltin:true,identifier:bH,method:null},cut:{useBuiltin:true,identifier:ck,method:null},paste:{useBuiltin:true,identifier:bO,method:null},insertorderedlist:{useBuiltin:false,identifier:cK,method:o},insertunorderedlist:{useBuiltin:false,identifier:A,method:o},inserthorizontalrule:{useBuiltin:false,identifier:bt,method:cj},insertimage:{useBuiltin:false,identifier:w,method:U},inserthyperlink:{useBuiltin:false,identifier:W,method:bP},selectall:{useBuiltin:false,identifier:ch,method:x},selectedtext:{useBuiltin:false,identifier:null,method:bL},selectedhtml:{useBuiltin:false,identifier:null,method:cL},inserthtml:{useBuiltin:false,identifier:bt,method:cY},resethtml:{useBuiltin:false,identifier:null,method:v},gethtml:{useBuiltin:false,identifier:null,method:bA},removeformat:{useBuiltin:true,identifier:bM,method:null}};
},execute:function(dd,de){if(!this.__tH.isReady()){this.error("editor not ready! '"+dd+"':'"+de+"'");
return false;
}dd=dd.toLowerCase();
de=de!=null?de:null;
if(this._commands[dd]){var df;
var dg=this._commands[dd];
if(!((qx.core.Environment.get(cw)==h)&&(dd==cH||dd==Q))){if(this.__vw()){this.__vx();
}}if(dg.useBuiltin){df=this.__vy(dg.identifier,false,de);
...
break;
}}}else if(Node.isNodeName(dh,cb)){di=true;
}}return di||!dk;
},__vx:function(){this.__vy(cW,false,cn);
},__vy:function(dl,dm,dn){try{var dr=this.__kc;
var dp=false;
var dq=this.__tH.getRange();
this.__kc.body.focus();
if((qx.core.Environment.get(cw)==ct)){if(dl!=cJ){dq.select();
if(((dq.text)&&(dq.text.length>0))||((dq.length==1)&&(dq.item(0))&&(dq.item(0).tagName==bl))){dr=dq;
}else{dr=this.__kc;
}}if(((qx.core.Environment.get(cw)==ct))&&(this.__vq[dl])){if(dq.text==cv){dp=true;
}}}var ds=dr.execCommand(dl,dm,dn);

if(dp&&dq.text!=cv){dq.collapse();
}
if((qx.core.Environment.get(cr))&&qx.core.Environment.get(d)){this.debug("execCommand "+dl+" with value "+dn+" succeded");
}this.__vv=false;
}catch(dt){if((qx.core.Environment.get(cr))&&qx.core.Environment.get(d)){this.debug("execCommand "+dl+" with value "+dn+" failed");
}return false;
}return ds;
},__vz:qx.core.Environment.select(cw,{"mshtml":function(){var dv=this.__tH;
var du=dv.getSavedRange()!=null?dv.getSavedRange():dv.getRange();
return du;
},"default":function(){return this.__tH.getRange();
}}),__vA:qx.core.Environment.select(cw,{"mshtml":function(dw,dx){var dA;
if(dw==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__vD();
}else{this.__kc.body.focus();
var dz=this.__tH.getSelection();
var dy=this.__vz();
if(dy&&dz&&dz.type!=a){try{dy.pasteHTML(dw);
dy.collapse(false);
dy.select();
dA=true;
...
return dA;
}},"default":function(dB,dC){this.__kc.body.focus();
return this.__kc.execCommand(dC.identifier,false,dB);
}}),insertParagraphOnLinebreak:qx.core.Environment.select(cw,{"gecko":function(){var dK=this.__vN();
var dO=this.__vB(dK);
var dG=this.__vL(dK);
var dL=R+Date.parse(new Date());
var dM=b+Date.parse(new Date());
var dE=bK;
var dI=cd+dL+D;
dE+=dI;
dE+=bm+dM+bg+dO+bz;
...
this.execute(cs,dE);
this.__vC();
qx.bom.element.Attribute.reset(this.__kc.getElementById(dL),bu);
var dJ=this.__kc.getElementById(dM);

if(dJ.previousSibling.innerHTML==dI){var dD=this.__vM();
var dH=this.__kc.createElement(bD);
var dF=this.__kc.createAttribute(bR);
dF.nodeValue=cv;
dH.setAttributeNode(dF);
var dN=this.__kc.createAttribute(V);
dN.nodeValue=cQ;
...
for(var dR in dP){if(dS[dR]){dQ+=dR+bW+dP[dR]+cc;
}}this.__tH.insertHtml(P+dQ+Y);
},"default":qx.lang.Function.empty}),__vB:qx.core.Environment.select(cw,{"gecko":function(dT){var dY=bI;
var dX=dT.child;
if(dX[bo]){dY+=I+dX[bo]+co;
delete dT.child[bo];
}if(dX[bp]){dY+=S+dX[bp]+co;
delete dT.child[bp];
...
for(var dV in dX){if(dW[dV]||dU[dV]){dY+=dV+c+dX[dV]+co;
delete dT.child[dV];
}}dY+=bb;
return dY;
},"default":function(){return cv;
}}),__vC:qx.core.Environment.select(cw,{"gecko":function(){var eh=this.__tH.getSelection();
...
if(qx.lang.String.startsWith(ee,b)&&ee==ei){var eg=ef.nextSibling;
var ec=this.__tH.getRange();
ec.selectNode(eg);
eh.addRange(ec);
var eb=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;
this.__tH.getCommandManager().addUndoStep(cs,eb,this.getCommandObject(cs));
this.execute(cs,eb);
var ed=this.__tH.getRange();

if(ea){while(ea&&ea.firstChild&&qx.dom.Node.isElement(ea.firstChild)){ea=ea.firstChild;
}}ed.selectNode(ea);
eh.addRange(ed);
ed.collapse(true);
}},"default":qx.lang.Function.empty}),__vD:qx.core.Environment.select(cw,{"mshtml":function(){var ej=this.__tH.getRange();
if(ej&&!qx.dom.Node.isNodeName(ej.parentElement(),cU)){ej.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);
ej.collapse(false);
ej.select();
return true;
}return false;
},"default":function(){return false;
}}),__vE:function(ek,el){var em=(qx.core.Environment.get(cw)==ct)?this.__tH.getRange():this.__kc;
return em.execCommand(el.identifier,false,ek);
},__vF:function(en,eo){if((qx.core.Environment.get(cw)==ct)){var ep=this.__tH.getFocusNode();
this.__vG(ep);
}this.__kc.body.focus();
var eq=this.__kc.execCommand(eo.identifier,false,en);

if((qx.core.Environment.get(cw)==h)){var ep=this.__tH.getFocusNode();
this.__vG(ep.parentNode);
}return eq;
},__vG:function(er){var es=[];
var parent=er.parentNode;

while(qx.dom.Node.isNodeName(parent,r)){es.push(parent);
parent=parent.parentNode;
}if(es.length>0){parent.appendChild(er);
parent.removeChild(es[es.length-1]);
}},__vH:qx.core.Environment.select(cw,{"gecko":function(et,eu){if(et.src){this.__kc.execCommand(eu.identifier,false,et.src);
delete et.src;
var eI=this.__tH.getSelection();
if(eI){var eH=eI.anchorNode;
var eC=eI.anchorOffset;
var ez=eH.childNodes[eC-1];
var eF;

for(var eB in et){eF=this.__kc.createAttribute(eB);
eF.nodeValue=et[eB];
...
eE=false;
}var ey=this.__kc.createDocumentFragment();
var eJ;

if(eE&&ew!=null){var eA=this.__vI(ew);
ey.appendChild(eA.root);
eJ=eA.inline;
}else{eJ=this.__kc.createElement(bx);
ey.appendChild(eJ);
}var eG=this.__kc.createTextNode(cv);
eJ.appendChild(eG);
var eD=ez.parentNode;
if(ez==eD.lastChild){eD.appendChild(ey);
}else{eD.insertBefore(ey,ez.nextSibling);
}var ev=this.__tH.getRange();
...
for(var eM in eK){eQ+=eM+ca+eK[eM]+g;
}eQ+=cC;
var eN=this.__tH.getSelection();
var eO=this.__vz();
if(eN&&eN.type!=a){try{eO.select();
eO.pasteHTML(eQ);
eP=true;
...
for(var eT in eR){eU+=eT+ca+eR[eT]+g;
}eU+=cC;
return this.__kc.execCommand(bt,false,eU);
}else{return false;
}}}),__vI:function(eV){while(eV.firstChild&&eV.firstChild.nodeType==1){eV=eV.firstChild;
}var fa=this.__vN(eV);
var fe,eX,fc;
var eW=cv;
var parent=null;
...
while(fb){fd=this.__kc.createElement(fb[cu]?bX:bx);
eX=this.__kc.createAttribute(t);
fd.setAttributeNode(eX);
for(var eY in fb){if(eY!=br&&eY!=cu){eW+=eY+bW+fb[eY]+cc;
}else if(eY==cu){fc=this.__kc.createAttribute(f);
fc.nodeValue=fb[eY];
...
},__vJ:qx.core.Environment.select(cw,{"gecko|opera":function(ff,fg){var fm=this.__tH.getSelection();
var fj=this.__tH.getRange();
if(fm.isCollapsed){var fi=F+(++this.__vs);
var fn=this.__kc.createElement(ba);
var fk=this.__kc.createAttribute(ce);
var fh=this.__kc.createAttribute(bu);
var fl=this.__kc.createTextNode(ff);
fh.nodeValue=fi;
...
fm.collapseToEnd();
return true;
}else{return this.__kc.execCommand(fg.identifier,false,ff);
...
}else{fr=this.__vA(O+fo+bs+fo+K,fp);
}this.__tH.resetSavedRange();
return fr;
}catch(e){if(qx.core.Environment.get(cr)){this.error("inserthyperlink failed!");
}return false;
}},"default":function(ft,fu){return this.__kc.execCommand(fu.identifier,false,ft);
}}),__vK:function(fv,fw){var fx=bj;
if((qx.core.Environment.get(cw)==bq)){fx+=this.__vL();
}return this.__vA(fx,fw);
},__vL:function(fy){var fC=cv;
var fB=cT;
var fA=[];
var fF=typeof fy!==cS?fy:this.__vN();
var fD=fF.child;
var fE=false;
...
for(var fz in fD){fC+=(fz!=br&&fz!=cu)?fz+c+fD[fz]+co:cv;
}fC+=fE?by+fD[cu]+bs:bs;
fA.unshift(fE?cA:bG);
fD=fD.child;
}if(fA.length==1&&fA[0]==cA){fC+=T;
}for(var i=0,j=fA.length;i<j;i++){fC+=fA[i];
}return fC;
},__vM:function(){var fH=this.__kc.createDocumentFragment();
var fM=this.__vN();
var parent=fH;
var fK=fM.child;
var fI;
...
fI=this.__kc.createElement(fL?bX:bx);
parent.appendChild(fI);
for(var fG in fK){if(fG!=br&&fG!=cu){qx.bom.element.Style.set(fI,fG,fK[fG]);
}}
if(fL){var fJ=this.__kc.createAttribute(f);
fJ.nodeValue=fK[cu];
fI.setAttributeNode(fJ);
}parent=fI;
fK=fK.child;
}return fH;
},__vN:function(fN){var fP={};
var fQ=null;
...
fQ[cD]=fS[i][cD];
}}if(fR[cq]&&fR[cD]){fQ=fQ.child={};
fQ[cq]=fR[cq];
}return fP;
},getCurrentStyles:function(fT){if(fT==null){var fV=this.__tH.getSelection();
...
var fU=this.__vO(fY);
var fX=this.__vP(fU,fY);
return fX;
},__vO:function(ga){var gd={};
var gb,gc;
...
if(gb.length>0&&typeof gd[gb]===cS){gd[gb]=gc.style.getPropertyValue(gb);
}}if(gc.tagName.toUpperCase()==L&&gc.size&&gd[cu]===undefined){gd[cu]=gc.size;
}}if(gd[cu]&&gd[cy]){delete gd[cy];
}return gd;
},__vP:function(ge,gf){var gk=gf[0];
var gi=this.__tH.getContentWindow().getComputedStyle(gk,null);
var gg;
var gj={};

for(var gh in ge){if(gh!=cu){gg=gi.getPropertyValue(gh);
}else{gg=ge[gh];
}if(gh==bV&&gg==bv){gj[gh]=this.__vR(gf);
}else if(gh==cp){gj[gh]=this.__vQ(gf);
}else{gj[gh]=gg;
}}return gj;
},__vQ:function(gl){var go,gq,gm;
var gp=[];
var gn=this.__tH.getContentWindow();

for(var i=0,j=gl.length;i<j;i++){gm=gn.getComputedStyle(gl[i],null);
go=gm.getPropertyValue(cp);
gq=gm.getPropertyValue(cg);
if(go!=E){gp.push({'text-decoration':go,'color':gq});
}}return gp;
},__vR:function(gr){var gt,gs,gu;

for(var i=0;i<gr.length;i++){gt=gr[i];
gs=this.__tH.getContentWindow().getComputedStyle(gt,null);
gu=gs.getPropertyValue(bV);
if(gu!=bv){return gu;
}}},__vS:function(gv,gw){var gI=this.__tH.getSelection();
var gD=((qx.core.Environment.get(cw)==ct))?this.__tH.getRange():gD=gI.getRangeAt(0);
var gE=[];
var gH;
var gC=[z,cM];
var gx,i,j,gF;
gF=((qx.core.Environment.get(cw)==ct))?gD.parentElement():gD.commonAncestorContainer;
if(gF.tagName==n){for(var i=0;i<gC.length;i++){gx=gF.getElementsByTagName(gC[i]);
...
gH=((qx.core.Environment.get(cw)==ct))?((gz==gF)||(gF.tagName==n)):gI.containsNode(gz,false);
for(j=0;j<gz.childNodes.length;j++){var gB=gz.childNodes[j];
if(gH||(gI.focusNode.nodeValue&&qx.dom.Hierarchy.contains(gB,gI.focusNode)&&(gI.focusOffset==gI.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(gB,gI.anchorNode)&&(gI.anchorOffset==0))||(gI.containsNode(gB,false))){gB.style.fontSize=(this.__vr[gv]||gv)+bT;
}}}}else{var gA=((qx.core.Environment.get(cw)==ct))?gF:gI.focusNode;
var gG=qx.dom.Hierarchy.getAncestors(gA);

for(i=0;i<gG.length;i++){if(gG[i].tagName==bB){if((((qx.core.Environment.get(cw)==bq))&&((gI.anchorOffset==0)&&(gI.focusNode.nodeValue&&(gI.focusOffset==gI.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(gG[i].firstChild,gI.anchorNode)&&qx.dom.Hierarchy.contains(gG[i].lastChild,gI.focusNode)))||(((qx.core.Environment.get(cw)==ct))&&(gD.htmlText==gG[i].innerHTML))){gG[i].style.fontSize=(this.__vr[gv]||gv)+bT;
}break;
}}}if((qx.core.Environment.get(cw)==ct)){this.__kc.body.focus();
this.__tH.getRange().select();
return this.__kc.execCommand(cB,false,gv);
}else if((qx.core.Environment.get(cw)==bq)){var parent=gD.commonAncestorContainer;
if(parent.nodeType===1){var gy=parent.getElementsByTagName(bx);

for(i=0;i<gy.length;i++){if(gy[i].style.fontSize){gy[i].style.fontSize=null;
}}}}return this.__kc.execCommand(cB,false,gv);
},__vT:qx.core.Environment.select(cw,{"mshtml":function(gJ,gK){this.__kc.body.focus();
return this.__kc.execCommand(cE,false,gJ);
},"gecko|opera":function(gL,gM){this.__kc.body.focus();
return this.__kc.execCommand(bE,false,gL);
},"webkit":function(gN,gO){var gP=this.__tH.getSelection();
var gQ=this.__tH.getRange();
if(!gP||!gP.isCollapsed){this.__kc.body.focus();
this.__kc.execCommand(cE,false,gN);
...
}}gQ.setStart(gP.anchorNode,gP.anchorNode.nodeValue.charAt(gT)==bY?gT+1:gT);
...
gP.collapseToEnd();
return true;
}}}),__vU:function(gU,gV){gU=gU!=null&&typeof gU==cG?gU:bv;
qx.bom.element.Style.set(this.__kc.body,cI,gU);
return true;
},__vV:function(gW,gX){var gY,hb,ha;
...
hb=gW[1];
ha=gW[2];
}if(gY==null||typeof gY!=cG){qx.bom.element.Style.set(this.__kc.body,bS,cv);
qx.bom.element.Style.set(this.__kc.body,bU,cv);
qx.bom.element.Style.set(this.__kc.body,cx,cv);
return true;
}else{if(gY.search(/^url.*\(/)==-1){gY=bf+gY+cl;
}}if(hb!=null&&!qx.lang.String.contains(hc.__vu,hb)){if(qx.core.Environment.get(cr)){this.error("The value '"+hb+"' is not allowed for parameter 'repeat'. Possible values are '"+hc.__vu+"'");
}return false;
}else{hb=N;
}
if(ha!=null){if(qx.lang.Type.isString(ha)&&!qx.lang.String.contains(hc.__vt,cF+ha+cF)){if(qx.core.Environment.get(cr)){this.error("The value '"+ha+"' is not allowed for parameter 'position'. Possible values are '"+hc.__vt+"'");
}return false;
}else{if(qx.lang.Type.isArray(ha)&&ha.length==2){ha=ha[0]+bY+ha[1];
}else{if(qx.core.Environment.get(cr)){this.error("If an array is provided for parameter 'position' it has to define two elements!");
}return false;
}}}else{ha=cP;
}qx.bom.element.Style.set(this.__kc.body,bS,gY);
qx.bom.element.Style.set(this.__kc.body,bU,hb);
qx.bom.element.Style.set(this.__kc.body,cx,ha);
return true;
},__vW:qx.core.Environment.select(cw,{"mshtml":function(hd,he){var hf=this.__kc.body.createTextRange();
hf.select();
return true;
},"default":function(hg,hh){return this.__vy(hh.identifier,false,hg);
}}),__vX:function(){return this.__tH.getSelectedText();
},__vY:function(){return this.__tH.getSelectedHtml();
},__wa:function(hi,hj){var hn=this.__tH.getFocusNode();
...
while(hl.length>0){if(Node.getName(hm)==cn||Node.getName(hm)==cb){break;
}if(hk.get(hm,hi,hk.LOCAL_MODE)==hj){hk.reset(hm,hi);
return true;
}hm=hl.shift();
}}return false;
},__wb:qx.core.Environment.select(cw,{"gecko":function(ho,hp){if(this.__wa(bC,s)){return true;
}else{return this.__vy(hp.identifier,false,ho);
}},"default":function(hq,hr){return this.__vy(hr.identifier,false,hq);
}}),__wc:qx.core.Environment.select(cw,{"gecko":function(hs,ht){if(this.__wa(B,bd)){return true;
}else{return this.__vy(ht.identifier,false,hs);
}},"default":function(hu,hv){return this.__vy(hv.identifier,false,hu);
}}),__wd:qx.core.Environment.select(cw,{"gecko":function(hw,hx){if(this.__wa(m,u)){return true;
}else{return this.__vy(hx.identifier,false,hw);
}},"default":function(hy,hz){return this.__vy(hz.identifier,false,hy);
}}),__we:qx.core.Environment.select(cw,{"gecko":function(hA,hB){if(this.__wa(m,cm)){return true;
}else{return this.__vy(hB.identifier,false,hA);
}},"default":function(hC,hD){return this.__vy(hD.identifier,false,hC);
}})},destruct:function(){this.__kc=this.__tH=this._commands=null;
this.__vq=this.__vr=null;
}});
})();
(function(){var m="engine.name",l="Command",k="mshtml",h="gecko",g="Custom",f="Content",d="Internal",c="inserthtml",b="backgroundimage",a="qx.debug",bi="backgroundcolor",bh="webkit",bg="backgroundColor",bf="mousedown",be="table",bd="backgroundImage",bc="backgroundRepeat",bb="p",ba="backgroundPosition",Y="td",t="img",u="inserthyperlink",r="mouseup",s="keypress",p="qx.bom.htmlarea.HtmlArea.debug",q="undo",n="pageup",o="b",x="control",y="shift",G="end",E="right",O="qx_link",J="__tG",U="insertunorderedlist",S="Undo",A="pagedown",X="k",W="home",V="a",z="insertorderedlist",C="y",D="justifyright",F="redo",H="insertParagraph",K="qx.bom.htmlarea.manager.UndoRedo",P="left",T="i",v="u",w="enter",B="Redo",N="insertimage",M="z",L="undoRedoState",R="down",Q="up",I="body";
...
}},members:{__tP:false,__tQ:false,__tR:false,__tL:null,__tK:null,__tG:null,__kc:null,__tI:null,__tJ:null,__tH:null,__tM:null,__tN:null,__tO:null,__tS:null,setContentDocument:function(bl){this.__kc=bl;
this.__tG.setContentDocument(bl);
qx.event.Registration.addListener(bl.body,s,this.__tM,this);
qx.event.Registration.addListener(bl.body,r,this.__tN,this);

if((qx.core.Environment.get(m)==k)){qx.event.Registration.addListener(bl.body,bf,this.__tO,this,true);
}},insertParagraphOnLinebreak:function(){return this.__tG.insertParagraphOnLinebreak();
},execute:function(bm,bn){var bo;
bm=bm.toLowerCase();
if(this._commands[bm]){if(this._commands[bm].passthrough){bo=this.__tG.execute(bm,bn);
}else{bo=this[bm].call(this);
}}else{if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){this.__ul(bm,bn,this.__tG.getCommandObject(bm));
bo=this.__tG.execute(bm,bn);
if(!bo){this.__tI.pop();
}}else{bo=this.__tG.execute(bm,bn);

if(bo){this.__ul(bm,bn,this.__tG.getCommandObject(bm));
}}
if(bm==q&&this.__tI.length==0){this.__tQ=false;
this.__ut();
}else if(bm==F&&this.__tJ.length==0){this.__tP=false;
this.__ut();
}}this.__tR=false;
return bo;
},addUndoStep:function(bp,bq,br){this.__ul(bp,bq,br);
},registerHandler:function(bs,bt,bu,bv){this.__tK[bs]={undo:bt,redo:bu,context:bv};
},isUndoPossible:function(){return this.__tQ;
},undo:function(){var by;

if(this.__tR){this.__un();
}if(this.__tI.length>0){var bx=this.__tI.pop();

if(this.__tL[bx.actionType.toLowerCase()]){switch(bx.actionType){case l:by=this.__tU(bx);
break;
case f:by=this.__tY(bx);
break;
case d:by=this.__tX(bx);
break;
case g:by=this.__tT(bx);
break;
}}else if(this.__tK[bx.actionType]){var bw=this.__tK[bx.actionType];
...
this.__ut();
return by;
}},__tT:qx.core.Environment.select(m,{"mshtml|webkit":function(bz){var bA=this.__kc.body.innerHTML;
var bC=bz.content;
this.__kc.body.innerHTML=bC;
var bB=bz;
bB.content=bA;
this.__up(bB);
return true;
...
switch(bD.command){case bi:bH.parameter=[bG.get(this.__kc.body,bg)];
break;
case b:bH.parameter=[bG.get(this.__kc.body,bd),bG.get(this.__kc.body,bc),bG.get(this.__kc.body,ba)];
break;
}this.__up(bH);
if(bD.command==u){if((qx.core.Environment.get(m)==h)){var bF=O+this.__tG.__hyperLinkId;
var bE=this.__kc.getElementById(bF);

if(bE){bE.parentNode.removeChild(bE);
return true;
}else{return false;
}}}else{return this.__tG.execute(bD.command,bD.value);
}}}),__tU:qx.core.Environment.select(m,{"mshtml|webkit":function(bI){},"default":function(bJ){this.__up(bJ);

if((qx.core.Environment.get(m)==h)){if(bJ.command==c&&bJ.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__tV(c,H)){this.__tW();
}}return this.__ua();
}}),__tV:function(bK,bL){if(this.__tI.length>0){var bM=this.__tI[this.__tI.length-1];
return (bM.command==bK&&bM.value==bL);
}return false;
},__tW:function(){this.__ua();

if(this.__tI.length>0){var bN=this.__tI.pop();
this.__up(bN);
}},__tX:function(bO){this.__up(bO);
return this.__ua();
},__tY:qx.core.Environment.select(m,{"gecko":function(bP){this.__up(bP);

try{return this.__ua();
}catch(bQ){if(qx.core.Environment.get(a)){this.error("execCommand failed! Details: "+bQ);
}}},"mshtml|webkit":function(bR){},"default":function(bS){this.__up(bS);
return this.__ua();
}}),__ua:function(){try{return this.__kc.execCommand(S,false,null);
}catch(e){return false;
}},isRedoPossible:function(){return this.__tP;
},redo:function(){if(this.__tP){var bU;
if(this.__tJ.length>0){var bV=this.__tJ.pop();

if(this.__tL[bV.actionType.toLowerCase()]){switch(bV.actionType){case l:bU=this.__uc(bV);
break;
case f:bU=this.__ui(bV);
break;
case d:bU=this.__uh(bV);
break;
case g:bU=this.__ub(bV);
break;
}}else if(this.__tK[bV.actionType]){var bT=this.__tK[bV.actionType];
...
}},__ub:qx.core.Environment.select(m,{"mshtml|webkit":function(bW){var bX=this.__kc.body.innerHTML;
var ca=bW.content;
this.__kc.body.innerHTML=ca;
var bY=bW;
bY.content=bX;
this.__uo(bY);
return true;
},"default":function(cb){this.__uo(cb);
return this.__uj();
}}),__uc:qx.core.Environment.select(m,{"mshtml|webkit":function(cc){},"default":function(cd){this.__uo(cd);
var ce=this.__uj();

if((qx.core.Environment.get(m)==h)){if(this.__ud(c,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cf=this.__ue();
this.__uf();

if(cf!=null){this.__ug(cf);
}}}return ce;
}}),__ud:function(cg,ch){if(this.__tJ.length>0){var ci=this.__tJ[this.__tJ.length-1];
return (ci.command==cg&&ci.value==ch);
}return false;
},__ue:function(){if(this.__tH==null){return null;
}var cj=this.__tH.getSelection();
...
}},__uf:function(){var cm=this.__tJ.pop();
this.__uo(cm);
this.__uj();
},__ug:qx.core.Environment.select(m,{"gecko":function(cn){if(cn==this.__tH.getContentBody().lastChild){return;
}var cq=cn.firstChild;

while(cq.firstChild){cq=cq.firstChild;
}var co=this.__tH.getSelection();
var cp=this.__tH.getRange();

if(co&&cp){cp.selectNode(cq);
co.addRange(cp);
cp.collapse(true);
}},"default":qx.lang.Function.empty}),__uh:function(cr){this.__uo(cr);
return this.__uj();
},__ui:qx.core.Environment.select(m,{"mshtml|webkit":function(cs){},"default":function(ct){this.__uo(ct);
return this.__uj();
}}),__uj:function(){try{return this.__kc.execCommand(B,false,null);
}catch(e){return false;
}},__uk:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};
this.__tG.getCommandObject(bi).customUndo=true;
this.__tG.getCommandObject(b).customUndo=true;

if((qx.core.Environment.get(m)==h)){}},__ul:qx.core.Environment.select(m,{"mshtml|webkit":function(cu,cv,cw){var cx=this.getUndoRedoObject();
cx.commandObject=cw;
cx.command=cu;
cx.value=cv;
cx.actionType=g;
cx.content=this.__kc.body.innerHTML;
this.__um(cx);
},"default":function(cy,cz,cA){if(this.__tH==null){return;
}var cC=this.getUndoRedoObject();
cC.commandObject=cA;
cC.command=cy;
cC.value=cz;
cC.actionType=g;
var cB=this.__tH.getSelection();

if(cA.customUndo){var cD=[];

switch(cy){case bi:cD.push(qx.bom.element.Style.get(this.__kc.body,bg));
break;
case b:cD.push(qx.bom.element.Style.get(this.__kc.body,bd),qx.bom.element.Style.get(this.__kc.body,bc),qx.bom.element.Style.get(this.__kc.body,ba));
break;
...
}}),__um:function(cE){if(this.__tR){this.__un();
}this.__uo(cE);
this.__tP=false;
this.__tJ=[];
this.__ut();
},__un:function(){var cF=this.__tI[this.__tI.length-1];

if(cF==null||cF.actionType!=f){var cG=this.getUndoRedoObject();
cG.actionType=f;

if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){cG.content=this.__tS;
cG.actionType=g;
this.__tS=null;
}this.__uo(cG);
this.__tR=false;
...
},__uo:function(cH){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO UNDO STACK");
this.debug(cH.actionType+" "+cH.command+" "+cH.value);
}this.__tI.push(cH);
},__up:function(cI){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO REDO STACK");
...
switch(cJ){case x:case y:case P:case E:case Q:case R:case n:case A:case W:case G:case w:break;
case V:case o:case T:case v:case X:case C:case M:if(!cK){this.__uq();
}break;
...
}},__ur:null,_handleMouseDown:qx.core.Environment.select(m,{"mshtml":function(e){var cL=e.getOriginalTarget();

if(qx.dom.Node.isElement(cL)&&(qx.dom.Node.isNodeName(cL,t)||qx.dom.Node.isNodeName(cL,be))){this.__ur={node:cL,content:cL.outerHTML};
}else{this.__ur=null;
...
if(!cN){this.__ur=null;
return;
}var cM=cN.anchorNode;
var cO=cM.childNodes[cN.anchorOffset];
if(qx.dom.Node.isNodeName(cO,t)){if(this.__ur==null){this.__ur=cO.cloneNode(true);
}else{if(this.__ur.style.width!=cO.style.width||this.__ur.style.height!=cO.style.height){this.__us();
...
}if(this.__ur==null){this.__ur=cP.cloneNode(true);
}else{qx.event.Timer.once(function(){if(cP.style.width!=this.__ur.style.width||cP.style.height!=this.__ur.style.height||cP.innerHTML!=this.__ur.innerHTML){this.__us();
this.__ur=cP.cloneNode(true);
}},this,0);
}}else{this.__ur=null;
}},"default":function(e){var cQ=qx.bom.Event.getTarget(e);

if(this.__ur!=null){if(cQ.nodeType==1){if(cQ==this.__ur.node){if(cQ.outerHTML!=this.__ur.content){this.__ur.content=cQ.outerHTML;
this.__us();
}}else{for(var i=0,j=cQ.childNodes.length;i<j;i++){if(cQ.childNodes[i]==this.__ur.node){if(cQ.childNodes[i].outerHTML!=this.__ur.content){this.__ur.content=cQ.childNodes[i].outerHTML;
this.__us();
}}}}}else{this.__ur=null;
...
cR.actionType=d;
this.__uo(cR);
}}),__ut:function(){qx.event.Timer.once(function(e){if(this.__tH!=null){var cS={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};
this.__tH.fireDataEvent(L,cS);
}},this,200);
}},destruct:function(){try{qx.event.Registration.removeListener(this.__kc.body,s,this.__tM);
qx.event.Registration.removeListener(this.__kc,r,this.__tN);

if((qx.core.Environment.get(m)==k)){qx.event.Registration.removeListener(this.__kc,bf,this.__tO);
}}catch(e){}this._disposeObjects(J);
