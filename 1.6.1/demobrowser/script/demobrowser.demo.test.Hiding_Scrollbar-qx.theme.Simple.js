...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Hiding_Scrollbar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Hiding_Scrollbar-qx.theme.Simple.e5b1763a796a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="value",k="demobrowser.demo.test.Hiding_Scrollbar",j="vertical",i="d",h="e",g="width",f="height",e="b",d="c",c="a",a="horizontal",b="ID";
qx.Class.define(k,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var n=new qx.ui.table.Table();
n.setStatusBarVisible(false);
var q=new qx.ui.table.model.Simple();
q.setColumns([b]);
n.setTableModel(q);
var p=[[c],[e],[d],[i],[h]];
q.setData(p);
n.setHeight(50);
n.setWidth(150);
this.getRoot().add(n,{left:30,top:30});
var m=new qx.ui.form.Slider(j);
m.set({height:100,minimum:40,maximum:130,value:50});
m.bind(l,n,f);
this.getRoot().add(m,{top:20});
var o=new qx.ui.form.Slider(a);
o.set({width:100,minimum:30,maximum:150,value:150});
o.bind(l,n,g);
this.getRoot().add(o,{left:20});
}}});
})();
