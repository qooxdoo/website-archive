...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline_Dynamic_Resize","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Dynamic_Resize-qx.theme.Simple.6177821b2a7a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(j,{extend:qx.ui.root.Abstract,construct:function(n){this.__kc=n;
qx.ui.root.Abstract.call(this);
this._setLayout(new qx.ui.layout.Basic());
this.setZIndex(10000);
qx.ui.core.queue.Layout.add(this);
this.addListener(k,this.__jC,this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
if((qx.core.Environment.get(m)==i)){this.setKeepFocus(true);
}},members:{__it:null,__kc:null,_createContainerElement:function(){var p=this.__kc.createElement(l);
this.__kc.body.appendChild(p);
...
},__jC:function(e){this.getContainerElement().setStyles({width:0,height:0});
...
(function(){var t="widget",s="drive-optical.png",r="computer.png",q="audio-card.png",p="battery.png",o="isle1",n="input-keyboard.png",m="icon/48/devices/",l="demobrowser.demo.root.Inline_Dynamic_Resize",k="isle2",d="drive-harddisk.png",j="camera-web.png",g="network-wired.png",c="icon/48/devices/computer.png",b="camera-photo.png",f="network-wireless.png",e="audio-input-microphone.png",h="group",a="display.png";
qx.Class.define(l,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);
var x=new qx.ui.root.Inline(document.getElementById(o),false,true);
x.setLayout(new qx.ui.layout.Canvas());
x.add(new qx.ui.form.Button(null,c),{edge:0});
var v=new qx.ui.root.Inline(document.getElementById(k),true,false).set({padding:[10,0],decorator:null,appearance:t});
v.setLayout(new qx.ui.layout.Canvas());
var w=new qx.ui.container.SlideBar();
w.setLayout(new qx.ui.layout.HBox(3));
v.add(w,{edge:0});
var u=[q,e,p,b,j,r,a,d,s,n,g,f];

for(var i=0;i<u.length;i++){w.add((new qx.ui.basic.Image(m+u[i])).set({decorator:h,padding:4}));
}}}});
})();
(function(){var t="resize",s="relative",r="mshtml",q="engine.name",p="height",o="",n="px",m="position",l="qx.debug",k="engine.version",c="qx.ui.root.Inline",h="$$widget",g="hidden",b="div",a="left",f="appear",d="Please use a DOM element to create an inline root.";
qx.Class.define(c,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(u,v,w){if(qx.core.Environment.get(l)){this.assertElement(u,d);
}this.__zQ=u;
u.style.overflow=g;
u.style.textAlign=a;
this.__AX=v||false;
...
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
if((qx.core.Environment.get(q)==r)){this.setKeepFocus(true);
}var window=qx.dom.Node.getWindow(u);
qx.event.Registration.addListener(window,t,this._onWindowResize,this);
},members:{__AX:false,__AY:false,__zQ:null,__Ba:function(){if(this.__AX||this.__AY){var x=qx.bom.element.Dimension.getSize(this.__zQ);

if(this.__AX&&x.width<1){throw new Error("The root element "+this.__zQ+" of "+this+" needs a width when its width size should be used!");
}
if(this.__AY){if(x.height<1){throw new Error("The root element "+this.__zQ+" of "+this+" needs a height when its height size should be used!");
}if(x.height>=1&&qx.bom.element.Style.get(this.__zQ,p,3)==o){qx.bom.element.Style.set(this.__zQ,p,x.height+n);
}}qx.event.Registration.addListener(this.__zQ,t,this._onResize,this);
}},_createContainerElement:function(){var y=this.__zQ;

if(this.__AX||this.__AY){var C=document.createElement(b);
y.appendChild(C);
if((qx.core.Environment.get(q)==r)&&qx.core.Environment.get(k)==6){var B=qx.dom.Node.getBodyElement(y);
var A;
var E;
var D=false;
var z=qx.dom.Hierarchy.getAncestors(y);

for(var i=0,j=z.length;i<j;i++){A=z[i];

if(A!=B){E=qx.bom.element.Style.get(A,m);

if(E==s){D=true;
break;
}}else{break;
}}
if(D){y.style.position=s;
}}}else{C=y;
}var F=new qx.html.Root(C);
C.style.position=s;
F.setAttribute(h,this.toHashCode());
qx.event.Timer.once(function(e){this.fireEvent(f);
},this,0);
return F;
},_onResize:function(e){var G=e.getData();

if((G.oldWidth!==G.width)&&this.__AX||(G.oldHeight!==G.height)&&this.__AY){qx.ui.core.queue.Layout.add(this);
}},_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();
}if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();
}},_computeSizeHint:function(){var L=this.__AX;
var I=this.__AY;

if(!L||!I){var H=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);
}else{H={};
}var M=qx.bom.element.Dimension;

if(L){var K=M.getContentWidth(this.__zQ);
H.width=K;
H.minWidth=K;
H.maxWidth=K;
}
if(I){var J=M.getContentHeight(this.__zQ);
H.height=J;
H.minHeight=J;
H.maxHeight=J;
}return H;
}},defer:function(N,O){qx.ui.core.MLayoutHandling.remap(O);
},destruct:function(){qx.event.Registration.removeListener(this.__zQ,t,this._onResize,this);
this.__zQ=null;
}});
})();
(function(){var f="resize",d="interval",c="__it",b="body",a="qx.event.handler.ElementResize";
qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);
this.__dv=g;
this.__AT={};
this.__it=new qx.event.Timer(200);
this.__it.addListener(d,this._onInterval,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__AT:null,__dv:null,__it:null,canHandleEvent:function(h,i){return h.tagName.toLowerCase()!==b;
...
if(qx.lang.Object.isEmpty(r)){this.__it.stop();
}}},_onInterval:function(e){var u=this.__AT;
...
y.width=w;
y.height=v;
}}}},destruct:function(){this.__dv=this.__AT=null;
this._disposeObjects(c);
