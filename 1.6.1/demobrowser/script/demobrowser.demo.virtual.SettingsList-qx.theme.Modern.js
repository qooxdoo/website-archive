...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.SettingsList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SettingsList-qx.theme.Modern.2683ba623562.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(b,{extend:qx.application.Standalone,members:{__cP:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var r=[];
var s=[h,c,a,g];

for(var i=0;i<s.length;i++){r[i]={name:s[i],checked:i<2,group:null};
}this.__cP=qx.data.marshal.Json.createModel(r,true);
var t=[];
...
this.__cP.toArray().forEach(function(u,v){v=v<2?0:1;
...
this.__cP.forEach(function(z){if(x.getLabel()==z.getGroup().getName()){z.setChecked(y);
}});
},this);
