...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SplitPane","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane-qx.theme.Classic.f320b40a301e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="value",k="horizontal",j="first",h="Trash",g="both",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",K="Windows (C:)",J="Toggle Splitpane Orientation",I="Inbox",H="Desktop",G="_container1",F="execute",E="):",D="Presets",C="Network",B="__zn",s="changeSelection",t="Sent",q="Offset (",r="/",o="offset",p="Files",m="_container2",n="vertical",u="Workspace",v="Junk #",x="Data",w="Show both panes",z="Show second pane",y="demobrowser.demo.widget.SplitPane",A="Edit";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__zn:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
O.addListener(F,this._toggle,this);
...
V.bind(l,T,o);
V.bind(l,Q,l,{converter:function(bc){return q+bc+E;
}});
},_toggle:function(){var bd=this.__zn.getOrientation();
this.__zn.setOrientation(bd==k?n:k);
...
this._container2.show();
}},__Qj:function(){var bo=new qx.ui.tree.Tree();
...
var bi=new qx.ui.tree.TreeFolder(C);
...
var bk=new qx.ui.tree.TreeFolder(D);
...
bt.add(bs);
return bo;
}},destruct:function(){this._disposeObjects(B,G,m);
}});
})();
