...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.WebWorker","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.WebWorker-qx.theme.Classic.2aea775150c6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="",j="Calculate",i="demobrowser/demo/webworker/webworker.js",h="30",g="message",f="html.webworker",d="Calculating...",c="demobrowser.demo.bom.WebWorker",b="execute",a="Calculate Fibonacci Numbers in a Web Worker";
...
var p=this.getRoot();
var o=qx.util.ResourceManager.getInstance().toUri(i);
var q=new qx.bom.WebWorker(o);
var s=new qx.ui.basic.Label(a);
var l=new qx.ui.basic.Label(k);
var n=new qx.ui.form.Button(j).set({width:100});
var m=new qx.ui.form.TextField(h);
var r=new qx.ui.form.List().set({width:200});

if(qx.core.Environment.get(f)){l.setValue("Your browser supports Web Workers");
}else{l.setValue("Your browser doesn't support Web Workers");
}p.add(l,{left:20,top:10});
p.add(s,{left:20,top:40});
p.add(m,{left:20,top:60});
p.add(n,{left:120,top:58});
p.add(r,{left:20,top:90});
q.addListener(g,function(e){var t=e.getData();
r.addAt(new qx.ui.form.ListItem(k+t.result),0);

if(t.done){n.setEnabled(true);
m.setEnabled(true);
n.setLabel(j);
}});
n.addListener(b,function(e){r.removeAll();
q.postMessage(parseInt(m.getValue()||0,10));
n.setEnabled(false);
m.setEnabled(false);
n.setLabel(d);
},this);
...
this.__Jj=qx.core.Environment.get(d);
this.__Jj?this.__Jl(l):this.__Jm(l);
},events:{"message":i,"error":i},members:{_worker:null,_handleErrorBound:null,_handleMessageBound:null,__Jj:true,__Jk:null,__Jl:function(m){this._worker=new window.Worker(m);
...
},__Jm:function(n){var p=this;
var o=new qx.bom.request.Xhr();
o.onload=function(){p.__Jk=(function(){var q=function(e){p.fireDataEvent(f,e);
};
...
if(this.__Jj){this._worker.postMessage(r);
}else{setTimeout(function(){try{s.__Jk.onmessage&&s.__Jk.onmessage({data:r});
...
}},destruct:function(){if(this.__Jj){qx.bom.Event.removeNativeListener(this._worker,j,this._handleMessageBound);
qx.bom.Event.removeNativeListener(this._worker,k,this._handleErrorBound);

if(this._worker){this._worker.terminate();
this._worker=null;
}}else{if(this.__Jk){this.__Jk=null;
}}}});
})();
