...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline_Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window-qx.theme.Simple.0e8261587145.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="execute",i="Add modal window",h="demobrowser.demo.root.Inline_Window",g="Add window",f="Window #",d="isle",c="Modal Window #",b="white",a="main";
qx.Class.define(h,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);
var n=new qx.ui.root.Inline(document.getElementById(d)).set({decorator:a,padding:10,backgroundColor:b});
n.setLayout(new qx.ui.layout.HBox(10));
var k=new qx.ui.form.Button(g);
var m=1;
k.addListener(j,function(e){var o=new qx.ui.window.Window(f+m++).set({width:200,height:150});
o.moveTo(m*15,m*15);
o.open();
});
n.add(k);
var l=new qx.ui.form.Button(i);
l.addListener(j,this.newModalWindow,this);
n.add(l);
},cModWin:1,newModalWindow:function(){var p=new qx.ui.window.Window(c+this.cModWin++).set({modal:true});
p.moveTo(300+this.cModWin*15,this.cModWin*15);
p.setLayout(new qx.ui.layout.HBox());
var q=new qx.ui.form.Button(i);
q.addListener(j,this.newModalWindow,this);
p.add(q);
p.open();
}}});
})();
