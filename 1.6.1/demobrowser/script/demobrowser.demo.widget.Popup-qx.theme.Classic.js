...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Popup","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Popup-qx.theme.Classic.8d8c8acc2086.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},_getPopupButton1:function(){var m=new qx.ui.form.Button(b);
var n=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:g,padding:[2,4],offset:3,offsetBottom:20});
n.add(new qx.ui.basic.Atom(h,i));
m.addListener(j,function(e){n.placeToMouse(e);
n.show();
},this);
return m;
},_getPopupButton2:function(){var o=new qx.ui.form.Button(d);
var p=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:f,padding:[2,4],offset:3,position:c});
