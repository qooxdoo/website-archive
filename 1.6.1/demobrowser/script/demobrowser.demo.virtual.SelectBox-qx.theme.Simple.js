...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.SelectBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SelectBox-qx.theme.Simple.ae243a7ee514.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="Item ",m="toolTipText",l="",k="icon/16/devices/",j="printer",h="firstname",g=".png",f="media-optical",d="computer",c="Simple",V="Filtered",U="json/persons.json",T="camera-photo",S="Empty Item",R="network-wired",Q="selection[0]",P="change",O="icon",N="Random Value ",M="Grouped with Persons",u="drive-harddisk",v="model.persons",s="Sorted",t="audio-card",q="network-wireless",r="drive-optical",o="camera-web",p="media-flash",w="input-mouse",x="Option ",E="pda",C="battery",G="model",F="label",I="audio-input-microphone",H="no model...",z="With icons",L="demobrowser.demo.virtual.SelectBox",K="phone",J="input-keyboard",y=" ",A="multimedia-player",B="Long text",D="display";
...
var Y=new qx.ui.container.Scroll();
var W=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
Y.add(W,{edge:0});
var ba=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
ba.setPadding(20);
var X=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
X.setPadding(20);
ba.add(this.createBox1());
ba.add(this.createBox2());
ba.add(this.createBox3());
ba.add(this.createBox4());
X.add(this.createBox5());
X.add(this.createBox6());
X.add(this.createBox7());
W.add(ba,{left:20,top:20});
W.add(X,{left:20,top:200});
this.getRoot().add(Y,{edge:0});
},createBox1:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
bc.add(new qx.ui.basic.Label(c));
var bb=new qx.data.Array();

for(var i=0;i<300;i++){bb.push(n+(i+1));
}var bd=new qx.ui.form.VirtualSelectBox(bb);
bc.add(bd);
bd.getSelection().push(bb.getItem(5));
bd.getSelection().addListener(P,function(e){this.debug("Change selection: ",bd.getSelection().getItem(0));
});
return bc;
},createBox2:function(){var bf=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
bf.add(new qx.ui.basic.Label(B));
var be=new qx.data.Array();

for(var i=0;i<300;i++){be.push(N+Math.round(Math.random()*100000000));
}var bg=new qx.ui.form.VirtualSelectBox(be);
bf.add(bg);
bg.bind(Q,bg,m,null);
var bh={bindItem:function(bi,bj,bk){bi.bindDefaultProperties(bj,bk);
bi.bindProperty(l,m,null,bj,bk);
}};
bg.setDelegate(bh);
return bf;
},createBox3:function(){var bm=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
bm.add(new qx.ui.basic.Label(z));
var bn=[t,I,C,T,o,d,D,u,r,J,w,p,f,A,R,q,E,K,j];
var br=k;
var bo=g;
var bp=[];

for(var i=0;i<bn.length;i++){bp.push({label:bn[i],icon:br+bn[i]+bo});
}var bq=qx.data.marshal.Json.createModel(bp);
var bl=new qx.ui.form.VirtualSelectBox(bq).set({labelPath:F,iconPath:O});
bm.add(bl);
return bm;
},createBox4:function(){var bt=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
bt.add(new qx.ui.basic.Label(S));
var bs=new qx.data.Array();
bs.push(l);

for(var i=0;i<300;i++){bs.push(x+(i+1));
}var bu=new qx.ui.form.VirtualSelectBox(bs);
bt.add(bu);
return bt;
},createBox5:function(){var bw=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
bw.add(new qx.ui.basic.Label(s));
var bv=new qx.data.Array();

for(var i=0;i<300;i++){bv.push(n+i);
}var bx=new qx.ui.form.VirtualSelectBox(bv);
bw.add(bx);
var by={sorter:function(a,b){return a<b?1:a>b?-1:0;
}};
bx.setDelegate(by);
return bw;
},createBox6:function(){var bA=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
bA.add(new qx.ui.basic.Label(V));
var bz=new qx.data.Array();

for(var i=0;i<300;i++){bz.push(n+i);
}var bB=new qx.ui.form.VirtualSelectBox(bz);
bA.add(bB);
var bC={filter:function(bD){return ((parseInt(bD.slice(5,bD.length),10))%2==1);
}};
bB.setDelegate(bC);
return bA;
},createBox7:function(){var bG=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
bG.add(new qx.ui.basic.Label(M));
var bF=new qx.ui.form.VirtualSelectBox();
bF.setLabelPath(h);
bF.setLabelOptions({converter:function(bJ,bK){return bK?bJ+y+bK.getLastname():H;
}});
bG.add(bF);
var bE=U;
var bI=new qx.data.store.Json(bE);
bI.bind(v,bF,G);
var bH={sorter:function(a,b){a=a.getFirstname();
b=b.getFirstname();
return a>b?1:a<b?-1:0;
},group:function(bL){return bL.getFirstname().charAt(0).toUpperCase();
}};
bF.setDelegate(bH);
return bG;
}}});
...
(function(){var w="appear",v="qx.ui.virtual.core.CellEvent",u="update",t="change",s="qx.event.type.Data",r="qx.ui.virtual.core.Pane",q="resize",p="__yB",o="click",n="scrollX",f="dblclick",m="contextmenu",j="qx.debug",c="cellClick",b="__yA",h="cellContextmenu",g="qx.event.type.Event",k="__yH",a="__yI",l="cellDblclick",d="scrollY";
qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(x,y,z,A){qx.ui.core.Widget.call(this);
this.__yA=new qx.ui.virtual.core.Axis(z,x);
this.__yB=new qx.ui.virtual.core.Axis(A,y);
this.__yC=0;
this.__yD=0;
this.__yE=0;
this.__yF=0;
...
this._add(this.__yH);
this.__yI=[];
this.__yA.addListener(t,this.fullUpdate,this);
this.__yB.addListener(t,this.fullUpdate,this);
...
for(var i=0;i<this.__yI.length;i++){var D=this.__yI[i];

if(D.isVisible()){C.push(D);
}}return C;
},getScrollMaxX:function(){var E=this.getInnerSize();

if(E){return Math.max(0,this.__yB.getTotalSize()-E.width);
}return 0;
},getScrollMaxY:function(){var F=this.getInnerSize();

if(F){return Math.max(0,this.__yA.getTotalSize()-F.height);
}return 0;
...
if(this.__yC!==G){var I=this.__yC;
this.__yC=G;
...
if(J!==this.__yD){var L=this.__yD;
this.__yD=J;
this._deferredUpdateScrollPosition();
this.fireDataEvent(n,J,L);
...
return;
}var Q=this.__yA.getItemPosition(M);
var O=Q+this.__yA.getItemSize(M);
...
return;
}var T=this.__yB.getItemPosition(R);
var S=T+this.__yB.getItemSize(R);
...
}bc=this.__yA.getItemAtPosition(this.getScrollY()+bb-be.top);
bd=this.__yB.getItemAtPosition(this.getScrollX()+ba-be.left);
...
if(!bl){return;
}var bm=this.__yD+bl.width;
var bn=this.__yF-bm;

if(this.__yD-this.__yG.left<Math.min(this.__yD,bf)||this.__yG.right-bm<Math.min(bn,bh)){var bo=Math.min(this.__yD,bg);
var bk=Math.min(bn,bi);
this._setLayerWindow(bj,this.__yD-bo,this.__yC,bl.width+bo+bk,bl.height,false);
...
if(!bw){return;
}var bu=this.__yC+bw.height;
var bv=this.__yE-bu;

if(this.__yC-this.__yG.top<Math.min(this.__yC,bp)||this.__yG.bottom-bu<Math.min(bv,br)){var by=Math.min(this.__yC,bq);
var bx=Math.min(bv,bs);
this._setLayerWindow(bt,this.__yD,this.__yC-by,bw.width,bw.height+by+bx,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__yJ=true;
this._updateScrollPosition();
this.__yJ=null;
this.fireEvent(u);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__yK(e,c);
},_onContextmenu:function(e){this.__yK(e,h);
},_onDblclick:function(e){this.__yK(e,l);
},__yK:function(e,bz){var bA=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());
...
},_setLayerWindow:function(bB,bC,top,bD,bE,bF){var bK=this.__yA.getItemAtPosition(top);

if(bK){var bM=bK.index;
var bQ=this.__yA.getItemSizes(bM,bE+bK.offset);
...
var bS=0;
var bP=0;
}var bO=this.__yB.getItemAtPosition(bC);

if(bO){var bI=bO.index;
var bH=this.__yB.getItemSizes(bI,bD+bO.offset);
...
var bR=0;
var bJ=0;
}this.__yG={top:bS,bottom:bP,left:bR,right:bJ};
this.__yH.setUserBounds(this.__yG.left-this.__yD,this.__yG.top-this.__yC,bN,bL);
this.__ok=bH;
this.__yz=bQ;

for(var i=0;i<this.__yI.length;i++){var bG=this.__yI[i];
...
if(this.__yE!==bT.height||this.__yF!==bT.width){this.__yE=bT.height;
this.__yF=bT.width;
this.fireEvent(u);
...
if(bU.length==0){this.__yL();
return;
}var bV=this.getBounds();

if(!bV){return ;
}this._setLayerWindow(bU,this.__yD,this.__yC,bV.width,bV.height,true);
this.__yL();
...
if(bW.length==0){this.__yL();
return;
}var bY=this.getBounds();

if(!bY){return ;
}var bX={top:this.__yC,bottom:this.__yC+bY.height,left:this.__yD,right:this.__yD+bY.width};

if(this.__yG.top<=bX.top&&this.__yG.bottom>=bX.bottom&&this.__yG.left<=bX.left&&this.__yG.right>=bX.right){this.__yH.setUserBounds(this.__yG.left-bX.left,this.__yG.top-bX.top,this.__yG.right-this.__yG.left,this.__yG.bottom-this.__yG.top);
}else{this._setLayerWindow(bW,this.__yD,this.__yC,bY.width,bY.height,false);
}this.__yL();
}},destruct:function(){this._disposeArray(a);
this._disposeObjects(b,p,k);
...
this.customSizes={};
},events:{"change":e},members:{__zj:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
this.__zj=u;
return u;
},__zl:function(A){var B=this.__zj||this.__zk();
var C=0;
var E=B.length-1;
...
}},__zm:function(M){var N=this.__zj||this.__zk();
var O=0;
var Q=N.length-1;
...
}},getTotalSize:function(){var U=this.__zj||this.__zk();
...
this.__yN=[];
},properties:{anonymous:{refine:true,init:false}},events:{updated:b},members:{__yN:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;
...
}},_getSpacer:function(){var r=this.__yN.pop();
...
if(E.getUserData(g)){this.__yN.push(E);
...
if(W.getUserData(g)){this.__yN.push(W);
