...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Drag_And_Drop","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Drag_And_Drop-qx.theme.Modern.69c7924f8d75.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="movetransfer",n="A date",m="droprequest",l="Boolean",k="A number",j="_tableModel",h="Table",g="demobrowser.demo.table.Table_Drag_And_Drop",f="move",d="icon/16/apps/office-calendar.png",a="drop",c="ID",b="dragstart";
qx.Class.define(g,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return h;
},createTable:function(){var p=this._tableModel=new qx.ui.table.model.Simple();
p.setColumns([c,k,n,l]);
p.setData(this.createRandomRows(100));
p.setColumnEditable(1,true);
var r=new qx.ui.table.Table(p).set({decorator:null});
var q=r.getTableColumnModel();
q.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
q.setHeaderCellRenderer(2,new qx.ui.table.headerrenderer.Icon(d,n));
r.setDraggable(true);
r.setDroppable(true);
r.setFocusCellOnMouseMove(true);
r.addListener(b,this._handleDragStart,this);
r.addListener(m,this._handleDropRequest,this);
r.addListener(a,this._handleDrop,this);
return r;
},_handleDragStart:function(e){e.addAction(f);
e.addType(o);
},_handleDropRequest:function(e){var t=e.getCurrentType();
var v=this._table.getSelectionModel().getSelectedRanges();
var w=[];

for(var i=0;i<v.length;i++){for(var s=v[i].minIndex;s<=v[i].maxIndex;s++){var u=this._table.getTableModel().getRowData(s);

if(u==null){continue;
}u.rowId=s;
w.push(u);
}}e.addData(t,w);
},_handleDrop:function(e){if(e.supportsType(o)){var y=e.getData(o);
var x=this._table.getTableModel();
x.removeRows(y[0].rowId,y.length);
x.addRows(y,this._table.getFocusedRow());
