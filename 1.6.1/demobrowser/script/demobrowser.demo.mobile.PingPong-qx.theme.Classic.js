...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Classic.f238fc01f6ce.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u="touchmove",t="div",s="100%",r="demobrowser.demo.mobile.PingPong",q="<b>This demo is supposed to be run in a WebKit-based browser.</b>",p="engine.name",o="black",n="20px",m="none",l="30px",d="qx.debug",k="0px",h="webkit",c="12px",b="innerHTML",g="green",f='Lucida Grande',i="left",a="right",j="absolute";
qx.Class.define(r,{extend:qx.application.Native,members:{__OI:null,__OJ:null,__OK:null,__OL:null,__OM:5,__ON:1,__OO:1,__OP:null,__OQ:null,__OR:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(d)){qx.log.appender.Native;
qx.log.appender.Console;
}var z={"width":s,"height":s,"backgroundColor":o,"margin":k,"userSelect":m};
var C=new qx.html.Element(t,z);
C.useElement(document.body);
C.setRoot(true);

if(qx.core.Environment.get(p)!=h){var B={"color":g,"font-family":f,"font-size":c,"position":j,"left":l,"top":n};
var A=new qx.html.Element(t,B);
C.add(A);
A.setAttribute(b,q);
return;
}var v=this.__OV(i);
...
var w=this.__OV(a);
C.add(w);
this.__OJ=this.__OW("left");
v.add(this.__OJ);
v.addListener(u,qx.lang.Function.bind(this.__CG,this,this.__OJ),this);
this.__OI=this.__OW("right");
w.add(this.__OI);
w.addListener(u,qx.lang.Function.bind(this.__CG,this,this.__OI),this);
this.__OK=this.__OX();
C.add(this.__OK);
this.__OQ=this.__OY();
v.add(this.__OQ);
...
this.__OP=[0,0];
this.__OS();
},__OS:function(){this.__OK.setStyles({"left":"200px","top":"200px"});
this.__OL=new qx.event.Timer(40);
this.__OL.addListener("interval",function(){var x=(parseInt(this.__OK.getStyle("left"))+this.__OM*this.__ON);
var y=(parseInt(this.__OK.getStyle("top"))+this.__OM*this.__OO);
this.__OK.setStyle("left",x+"px");
this.__OK.setStyle("top",y+"px");
this.__OU();
},this);
this.__OL.start();
},__OT:function(D){this.__OL.stop();
this.__OL.dispose();
this.__OM=5;
this.__OP[D]=this.__OP[D]+1;
this.__OQ.setAttribute("innerHTML",this.__OP[0]);
this.__OR.setAttribute("innerHTML",this.__OP[1]);
this.__OS();
},__OU:function(){var F=this.getBoundsFor(this.__OK);
if(F.top<=0){this.__OO=1;
}if(F.bottom>=window.innerHeight-5){this.__OO=-1;
}if(F.left<=0||F.right>=window.innerWidth){this.__OT(F.left<=0?1:0);
}var G=this.getBoundsFor(this.__OJ);

if(F.left<=G.right&&F.bottom>=G.top&&F.top<=G.bottom){this.__ON=1;
this.__OM=Math.min(this.__OM+1,20);
}var E=this.getBoundsFor(this.__OI);

if(F.right>=E.left&&F.bottom>=E.top&&F.top<=E.bottom){this.__ON=-1;
this.__OM=Math.min(this.__OM+1,20);
}},__CG:function(H,e){H.setStyles({"top":(e.getDocumentTop()-50)+"px"});
},getBoundsFor:function(I){return qx.bom.element.Location.get(I.getDomElement());
},__OV:function(J){var K={"width":"50%","height":"100%","position":"absolute","backgroundColor":"black"};

if(J=="left"){K["border-right"]="1px solid white";
}else{K["left"]="50%";
K["border-left"]="1px solid white";
}return new qx.html.Element("div",K);
},__OW:function(L){var M={"width":"30px","height":"100px","top":"100px","position":"absolute","backgroundColor":"white"};
M[L]="20px";
return new qx.html.Element("div",M);
},__OX:function(){var N={"width":"20px","height":"20px","position":"absolute","backgroundColor":"white","userSelect":"none"};
return new qx.html.Element("div",N);
},__OY:function(){var O={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};
var P=new qx.html.Element("div",O);
P.setAttribute("innerHTML","0");
return P;
}}});
})();
