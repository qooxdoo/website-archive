...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:fce-lowlevel.ca6feeb41482.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.$$packageData['0']={"locales":{},"resources":{"fce/lowlevel/css/style.css":"fce"},"translations":{}};
...
(function(){var j=" ",i="a",h="mailto:?subject=",g="os.name",f="\n\n",e="os.version",d="div",c="browser.name",b="qx.debug",a="&nbsp;",w="_applyFeatureSet",v="h1",u="qooxdoo detected client features for ",t="Send feature set data by email",s="Launch Configuration Editor (may not work on mobile devices)",r="fce.ApplicationLowLevel",q="?ria",p="browser.version",o="out",n=" on ",l="<br/>",m="changeFeatures",k="&body=";
qx.Class.define(r,{extend:qx.application.Native,properties:{featureSet:{init:null,nullable:true,apply:w}},members:{main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(b)){qx.log.appender.Native;
qx.log.appender.Console;
}var x=new fce.Environment();
x.addListenerOnce(m,function(y){this.setFeatureSet(y.getData());
},this);
x.check();
},_applyFeatureSet:function(z,A){if(z){var G=fce.Util.getFormattedJson(z);
var H=G.replace(/ /g,a).replace(/\n/g,l);
var E=u+z[c]+j+z[p]+n+z[g]+j+z[e];
var F=document.createElement(v);
F.innerHTML=E;
var J=document.createElement(d);
J.id=o;
J.innerHTML=H;
...
var C=encodeURIComponent(navigator.userAgent+f+G);
B.href=h+I+k+C;
