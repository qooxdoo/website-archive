  ...
  members : {
    ...
    */
    ...
    _serializeData : function(data, contentType){
      ...
      var isPost = this.getMethod() === "POST",isJson = /application\/.*\+?json/.test(contentType),serializedData = "";
      if(!data){
      ...
      if(qx.lang.Type.isObject(data)){
        ...
        serializedData = (isJson) ? qx.lang.Json.stringify(data) : qx.util.Uri.toParameter(data, isPost);
