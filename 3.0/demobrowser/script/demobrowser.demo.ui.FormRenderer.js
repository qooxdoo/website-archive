...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRenderer.d800ee7355bd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.addListener(n,this._onKeyInput,this);this.addListener(p,this.__oQ,this);}
,properties:{appearance:{refine:true,init:v}},members:{__pN:null,_createChildControlImpl:function(D,C){var B;switch(D){case t:B=new qx.ui.core.Spacer();this._add(B,{flex:1});break;case A:B=new qx.ui.basic.Atom(z);B.setCenter(false);B.setAnonymous(true);this._add(B,{flex:1});break;case o:B=new qx.ui.basic.Image();B.setAnonymous(true);this._add(B);break;};return B||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,D);}
...
,__oQ:function(e){var F=e.getData()[0];var E=this.getChildControl(l);if(E.getSelection()[0]!=F){if(F){E.setSelection([F]);}
else {E.resetSelection();}
;}
;this.__pO();this.__pP();}
,__pO:function(){var H=this.getChildControl(l).getSelection()[0];var G=this.getChildControl(A);var I=H?H.getIcon():r;I==null?G.resetIcon():G.setIcon(I);}
,__pP:function(){var L=this.getChildControl(l).getSelection()[0];var J=this.getChildControl(A);var K=L?L.getLabel():r;var M=this.getFormat();if(M!=null){K=M.call(this,L);}
...
,_onKeyPress:function(e){var S=e.getKeyIdentifier();if(S==b||S==i){if(this.__pN){this.setSelection([this.__pN]);this.__pN=null;}
;this.toggle();}
...
,_onListMouseDown:function(e){if(this.__pN){this.setSelection([this.__pN]);this.__pN=null;}
;}
,_onListChangeSelection:function(e){var X=e.getData();var V=e.getOldData();if(V&&V.length>0){V[0].removeListener(h,this.__pO,this);V[0].removeListener(f,this.__pP,this);}
;if(X.length>0){var U=this.getChildControl(x);var W=this.getChildControl(l);var Y=W.getSelectionContext();if(U.isVisible()&&(Y==y||Y==k)){this.__pN=X[0];}
else {this.setSelection([X[0]]);this.__pN=null;}
;X[0].addListener(h,this.__pO,this);X[0].addListener(f,this.__pP,this);}
