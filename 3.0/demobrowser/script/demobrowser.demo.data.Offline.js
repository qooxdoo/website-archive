...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.60f06cf942b2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:d,apply:g}},members:{_storage:null,__CG:null,_applyModel:function(k,j){if(j){j.removeListenerById(this.__CG);j.dispose();this.__CG=null;}
;if(k){this.__CG=k.addListener(f,this.__CH,this);this.__CH();}
else {this._storage.removeItem(this._key);}
;}
,__CH:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__CI:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__CJ:null,__CK:null,getLocal:function(){if(this.__CJ){return this.__CJ;}
;return this.__CJ=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__CK){return this.__CK;}
;return this.__CK=new qx.bom.storage.Web(b);}
},construct:function(g){this.__oy=g;}
,members:{__oy:null,getStorage:function(){return window[this.__oy+c];}
,getLength:function(){return this.getStorage(this.__oy).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__oy).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__oy).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__oy).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__oy);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__oy).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__CJ:null,__CK:null,__co:0,getLocal:function(){if(this.__CJ){return this.__CJ;}
;return this.__CJ=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__CK){return this.__CK;}
;return this.__CK=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__CL=document.createElement(f);this.__CL.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__CL);this.__CL.addBehavior(j);this.__CM=m;this.__CL.load(this.__CM);this.__fP={};this.__CN={};var l=this.__CL.getAttribute(d+qx.bom.storage.UserData.__co);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fP[l.key]=l.value;this.__CN[l.key]=d+qx.bom.storage.UserData.__co;qx.bom.storage.UserData.__co++ ;l=this.__CL.getAttribute(d+qx.bom.storage.UserData.__co);}
;}
,members:{__CL:null,__CM:h,__fP:null,__CN:null,getStorage:function(){return this.__fP;}
,getLength:function(){return Object.keys(this.__fP).length;}
,setItem:function(n,p){if(this.__CN[n]){var o=this.__CN[n];}
else {var o=d+qx.bom.storage.UserData.__co;qx.bom.storage.UserData.__co++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__CL.setAttribute(o,q);this.__CL.save(this.__CM);this.__fP[n]=p;this.__CN[n]=o;}
,getItem:function(r){return this.__fP[r]||null;}
,removeItem:function(v){var u=this.__CN[v];if(u==undefined){return;}
;this.__CL.removeAttribute(u);qx.bom.storage.UserData.__co-- ;delete this.__fP[v];delete this.__CN[v];var t=d+qx.bom.storage.UserData.__co;if(this.__CL.getAttribute(t)){var w=this.__CL.getAttribute(d+qx.bom.storage.UserData.__co);this.__CL.removeAttribute(t);this.__CL.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__CN[s]=u;}
;this.__CL.save(this.__CM);}
,clear:function(){for(var x in this.__CN){this.__CL.removeAttribute(this.__CN[x]);}
;this.__CL.save(this.__CM);this.__fP={};this.__CN={};}
