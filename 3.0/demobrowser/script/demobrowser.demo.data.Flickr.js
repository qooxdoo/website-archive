...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr.096d90206887.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="application/json",c="json",d="aborted",e="loaded",f="qx.event.type.Data",g="__tU",h="error",i="fail",j="receiving",k="queued",l="changeState",m="success",n="String",o="changePhase",p="sending",q="_marshaler",r="completed",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":f,"error":f},properties:{model:{nullable:true,event:a},state:{check:[u,k,p,j,r,d,w,s],init:u,event:l},url:{check:n,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__tU:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__tU;}
,_setRequest:function(C){this.__tU=C;}
,_createRequest:function(D){if(this.__tU){this.__tU.dispose();this.__tU=null;}
...
;this.fireDataEvent(e,this.getModel());if(this.__tU){this.__tU.dispose();this.__tU=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__tU!=null){this._disposeObjects(g);}
...
;this.__rv={};var P=this._transport=this._createTransport();this._setPhase(G);this.__rw=qx.lang.Function.bind(this._onReadyStateChange,this);this.__rx=qx.lang.Function.bind(this._onLoad,this);this.__ry=qx.lang.Function.bind(this._onLoadEnd,this);this.__rz=qx.lang.Function.bind(this._onAbort,this);this.__oa=qx.lang.Function.bind(this._onTimeout,this);this.__rA=qx.lang.Function.bind(this._onError,this);P.onreadystatechange=this.__rw;P.onload=this.__rx;P.onloadend=this.__ry;P.onabort=this.__rz;P.ontimeout=this.__oa;P.onerror=this.__rA;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__rw:null,__rx:null,__ry:null,__rz:null,__oa:null,__rA:null,__rB:null,__od:null,__rC:null,__rv:null,__rD:null,_transport:null,_createTransport:function(){throw new Error(E);}
...
;this.__od=true;this.__rC=s;this._transport.abort();}
,_setRequestHeaders:function(){var X=this._transport,W=this._getAllRequestHeaders();for(var Y in W){X.setRequestHeader(Y,W[Y]);}
;}
,_getAllRequestHeaders:function(){var ba={};qx.lang.Object.mergeWith(ba,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(ba,this.__rE());qx.lang.Object.mergeWith(ba,this.__rD);qx.lang.Object.mergeWith(ba,this.__rv);return ba;}
,__rE:function(){var bc=this.getAuthentication(),bb={};if(bc){bc.getAuthHeaders().forEach(function(bd){bb[bd.key]=bd.value;}
);return bb;}
;}
,setRequestHeader:function(be,bf){this.__rv[be]=bf;}
,getRequestHeader:function(bg){return this.__rv[bg];}
,removeRequestHeader:function(bh){if(this.__rv[bh]){delete this.__rv[bh];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__rC;}
...
,getResponse:function(){return this.__rB;}
,_setResponse:function(bk){var bj=bk;if(this.__rB!==bk){this.__rB=bk;this.fireEvent(H,qx.event.type.Data,[this.__rB,bj]);}
;}
,_onReadyStateChange:function(){var bl=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(B+bl);}
;this.fireEvent(D);if(this.__od){return;}
;if(bl===3){this._setPhase(p);}
;if(this.isDone()){this.__rF();}
;}
,__rF:function(){if(qx.core.Environment.get(f)){this.debug(A+this.getStatus());}
...
,_setPhase:function(bn){var bo=this.__rC;if(qx.core.Environment.get(m)){qx.core.Assert.assertString(bn);qx.core.Assert.assertMatch(bn,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__rC=bn;this.fireDataEvent(c,bn,bo);}
,_serializeData:function(bq){var bp=typeof this.getMethod!==L&&this.getMethod()==y;if(!bq){return;}
;if(qx.lang.Type.isString(bq)){return bq;}
;if(qx.Class.isSubClassOf(bq.constructor,qx.core.Object)){return qx.util.Serializer.toUriParameter(bq);}
;if(qx.lang.Type.isObject(bq)){return qx.util.Uri.toParameter(bq,bp);}
;}
...
;var A=z[h+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(A)){var D=qx.data&&qx.data.IListData&&qx.Class.hasInterface(A&&A.constructor,qx.data.IListData);for(var i=0;i<A.length;i++ ){var F=D?A.getItem(i):A[i];E+=this.__rG(name,F,C);}
;}
else if(qx.lang.Type.isDate(A)&&y!=null){E+=this.__rG(name,y.format(A),C);}
else {E+=this.__rG(name,A,C);}
;}
;return E.substring(0,E.length-1);}
,__rG:function(name,I,G){if(I&&I.$$type==o){I=I.classname;}
...
(function(){var a="Retry open native request with method: ",b="activex",c="No XHR support available.",d="If-None-Match",f="xhr",g="If-Modified-Since",h="engine.version",i="onunload",j="GET",k="-1",l="qx.debug.io",m="Open native request with method: ",n="error",o="loadend",p="load",q="Received native readyState: ",r="abort",s=", url: ",t="browser.documentmode",u="",v="readystatechange",w="Microsoft.XMLHTTP",x="Already disposed",y="browser.version",z="opera",A="qx.bom.request.Xhr",B="on",C="gecko",D="If-Match",E="mshtml",F="engine.name",G="Microsoft.XMLDOM",H="file:",I="Send native request",J="If-Range",K="Content-Type",L="io.xhr",M="Not enough arguments",N="timeout",O="undefined",P=", async: ";qx.Bootstrap.define(A,{extend:Object,construct:function(){var Q=qx.Bootstrap.bind(this.__rS,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__rH=qx.event.GlobalError.observeMethod(Q);}
else {this.__rH=Q;}
;this.__rI=qx.Bootstrap.bind(this.__rR,this);this.__oa=qx.Bootstrap.bind(this.__rW,this);this.__rQ();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__rJ=qx.Bootstrap.bind(this.__sa,this);window.attachEvent(i,this.__rJ);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":A,"error":A,"loadend":A,"timeout":A,"abort":A,"load":A},members:{readyState:0,responseText:u,responseXML:null,status:0,statusText:u,timeout:0,open:function(V,R,S,U,T){this.__sc();if(typeof R===O){throw new Error(M);}
else if(typeof V===O){V=j;}
;this.__od=false;this.__rK=false;this.__rL=false;this.__oe=R;if(typeof S==O){S=true;}
;this.__rM=S;if(!this.__sb()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__rQ();}
;this.__rO.onreadystatechange=this.__rH;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,m+V+s+R+P+S);}
;this.__rO.open(V,R,S,U,T);}
catch(W){if(!qx.util.Request.isCrossDomain(R)){throw W;}
;if(!this.__rM){this.__rN=W;}
;if(this.__rM){if(window.XDomainRequest){this.readyState=4;this.__rO=new XDomainRequest();this.__rO.onerror=qx.Bootstrap.bind(function(){this._emit(v);this._emit(n);this._emit(o);}
,this);if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+V+s+R+P+S);}
;this.__rO.open(V,R,S,U,T);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__of){return;}
;this.readyState=4;this._emit(v);this._emit(n);this._emit(o);}
,this));}
;}
;if(qx.core.Environment.get(F)===E&&qx.core.Environment.get(t)<9&&this.__rO.readyState>0){this.__rO.setRequestHeader(g,k);}
;if(qx.core.Environment.get(F)===C&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__rM){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(v);}
;}
,setRequestHeader:function(X,Y){this.__sc();if(X==D||X==g||X==d||X==J){this.__rL=true;}
;this.__rO.setRequestHeader(X,Y);return this;}
,send:function(ba){this.__sc();if(!this.__rM&&this.__rN){throw this.__rN;}
;if(qx.core.Environment.get(F)===z&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__rP=window.setTimeout(this.__oa,this.timeout);}
;ba=typeof ba==O?null:ba;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,I);}
;this.__rO.send(ba);}
catch(bc){if(!this.__rM){throw bc;}
;if(this._getProtocol()===H){this.readyState=2;this.__rT();var bb=this;window.setTimeout(function(){if(bb.__of){return;}
;bb.readyState=3;bb.__rT();bb.readyState=4;bb.__rT();}
);}
;}
;if(qx.core.Environment.get(F)===C&&!this.__rM){this.__rS();}
;this.__rK=true;return this;}
,abort:function(){this.__sc();this.__od=true;this.__rO.abort();if(this.__rO){this.readyState=this.__rO.readyState;}
;return this;}
...
,getResponseHeader:function(bf){this.__sc();return this.__rO.getResponseHeader(bf);}
,getAllResponseHeaders:function(){this.__sc();return this.__rO.getAllResponseHeaders();}
,getRequest:function(){return this.__rO;}
,dispose:function(){if(this.__of){return false;}
;window.clearTimeout(this.__rP);if(window.detachEvent){window.detachEvent(i,this.__rJ);}
;try{this.__rO.onreadystatechange;}
catch(bh){return false;}
;var bg=function(){}
;this.__rO.onreadystatechange=bg;this.__rO.onload=bg;this.__rO.onerror=bg;this.abort();this.__rO=null;this.__of=true;return true;}
,isDisposed:function(){return !!this.__of;}
...
,_getProtocol:function(){var bj=this.__oe;var bk=/^(\w+:)\/\//;if(bj!==null&&bj.match){var bl=bj.match(bk);if(bl&&bl[1]){return bl[1];}
;}
;return window.location.protocol;}
,__rO:null,__rM:null,__rH:null,__rI:null,__rJ:null,__oa:null,__rK:null,__oe:null,__od:null,__gy:null,__of:null,__rP:null,__rN:null,__rL:null,__rQ:function(){this.__rO=this._createNativeXhr();this.__rO.onreadystatechange=this.__rH;if(this.__rO.onabort){this.__rO.onabort=this.__rI;}
;this.__of=this.__rK=this.__od=false;}
,__rR:function(){if(!this.__od){this.abort();}
;}
,__rS:function(){var bm=this.__rO,bn=true;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,q+bm.readyState);}
;if(this.readyState==bm.readyState){return;}
;this.readyState=bm.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__od&&!this.__rK){return;}
;if(!this.__rM&&(bm.readyState==2||bm.readyState==3)){return;}
...
;if(bn){this.__rX();this.__rY();}
;}
;this.__rT();if(this.readyState==qx.bom.request.Xhr.DONE){if(bm){bm.onreadystatechange=function(){}
;}
;}
;}
,__rT:function(){var bp=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__rP);}
;if(qx.core.Environment.get(F)==E&&qx.core.Environment.get(t)<8){if(this.__rM&&!this.__rK&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(bp.__of){return;}
;bp.readyState=3;bp._emit(v);bp.readyState=4;bp._emit(v);bp.__rU();}
);return;}
;}
;}
;this._emit(v);if(this.readyState===qx.bom.request.Xhr.DONE){this.__rU();}
;}
,__rU:function(){if(this.__gy){this._emit(N);if(qx.core.Environment.get(F)===z){this._emit(n);}
;this.__gy=false;}
else {if(this.__od){this._emit(r);}
else {if(this.__rV()){this._emit(n);}
else {this._emit(p);}
;}
;}
;this._emit(o);}
,__rV:function(){var bq;if(this._getProtocol()===H){bq=!this.responseText;}
else {bq=!this.statusText;}
;return bq;}
,__rW:function(){var br=this.__rO;this.readyState=qx.bom.request.Xhr.DONE;this.__gy=true;br.abort();this.responseText=u;this.responseXML=null;this.__rT();}
,__rX:function(){var bs=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===H&&this.status===0&&bs){if(!this.__rV()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(F)===z){if(bs&&this.__rL&&!this.__od&&this.status===0){this.status=304;}
;}
;}
,__rY:function(){if(qx.core.Environment.get(F)==E&&(this.getResponseHeader(K)||u).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bt=new window.ActiveXObject(G);bt.async=false;bt.validateOnParse=false;bt.loadXML(this.responseText);this.responseXML=bt;}
;}
,__sa:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sb:function(){var name=qx.core.Environment.get(F);var bu=qx.core.Environment.get(y);return !(name==E&&bu<9||name==C&&bu<3.5);}
,__sc:function(){if(this.__of){throw new Error(x);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__sd:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__sd=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__sd=i;}
,_getParser:function(k){var j=this.__sd,m=c,l=c;if(j){return j;}
...
(function(){var a="url: ",b="qx.debug.io",c="qx.bom.request.Script",d="Invalid state",e="head",f="error",g="loadend",h="qx.debug",i="script",j="load",k="Unknown response headers",l="browser.documentmode",m="abort",n="",o="Received native readyState: loaded",p="readystatechange",q="Response header cannot be determined for ",r="requests made with script transport.",s="opera",t="unknown",u="Open native request with ",v="Response headers cannot be determined for",w="mshtml",x="engine.name",y="Detected error",z="Send native request",A="on",B="timeout",C="Unknown environment key at this phase",D="Received native load";qx.Bootstrap.define(c,{construct:function(){this.__oh();this.__nX=qx.Bootstrap.bind(this._onNativeLoad,this);this.__nY=qx.Bootstrap.bind(this._onNativeError,this);this.__oa=qx.Bootstrap.bind(this._onTimeout,this);this.__ob=document.head||document.getElementsByTagName(e)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__oj()?0:15000;}
,events:{"readystatechange":c,"error":c,"loadend":c,"timeout":c,"abort":c,"load":c},members:{readyState:null,status:null,statusText:null,timeout:null,__oc:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(H,G){if(this.__of){return;}
;this.__oh();this.__od=null;this.__oe=G;if(this.__om(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__of){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__oe=qx.util.Uri.appendParamsToUrl(this.__oe,K);return this;}
,send:function(){if(this.__of){return null;}
;var M=this.__ok(),L=this.__ob,N=this;if(this.timeout>0){this.__gw=window.setTimeout(this.__oa,this.timeout);}
;if(this.__om(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;L.insertBefore(M,L.firstChild);window.setTimeout(function(){N._readyStateChange(2);N._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__of){return null;}
;this.__od=true;this.__ol();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__of){return null;}
;if(this.__om(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__of){return null;}
;if(this.__om(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__oc=P;}
,dispose:function(){var Q=this.__og;if(!this.__of){if(Q){Q.onload=Q.onreadystatechange=null;this.__ol();}
;if(this.__gw){window.clearTimeout(this.__gw);}
;this.__of=true;}
;}
,isDisposed:function(){return !!this.__of;}
,_getUrl:function(){return this.__oe;}
,_getScriptElement:function(){return this.__og;}
,_onTimeout:function(){this.__oi();if(!this.__oj()){this._emit(f);}
;this._emit(B);if(!this.__oj()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__og,R=this.__oc,T=this;if(this.__od){return;}
;if(this.__om(x)===w&&this.__om(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__om(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__om(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__om(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__gw){window.clearTimeout(this.__gw);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__oi();this._emit(f);this._emit(g);}
,__og:null,__ob:null,__oe:n,__nX:null,__nY:null,__oa:null,__gw:null,__od:null,__of:null,__oh:function(){this.readyState=0;this.status=0;this.statusText=n;}
,_readyStateChange:function(U){this.readyState=U;this._emit(p);}
,_success:function(){this.__ol();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=n+this.status;}
,__oi:function(){this.__ol();this.readyState=4;this.status=0;this.statusText=null;}
,__oj:function(){var W=this.__om(x)===w&&this.__om(l)<9;var V=this.__om(x)===s;return !(W||V);}
,__ok:function(){var X=this.__og=document.createElement(i);X.src=this.__oe;X.onerror=this.__nY;X.onload=this.__nX;if(this.__om(x)===w&&this.__om(l)<9){X.onreadystatechange=this.__nX;}
;return X;}
,__ol:function(){var Y=this.__og;if(Y&&Y.parentNode){this.__ob.removeChild(Y);}
;}
,__om:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__yz();}
,members:{responseJson:null,__co:null,__ys:null,__yt:null,__yu:null,__yv:null,__yw:null,__of:null,__yx:e,open:function(t,p){if(this.__of){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__yu=false;q=this.__ys||b;s=this.__yt||this.__yx+n+this.__co+m;if(!this.__yt){this.constructor[this.__co]=this;}
else {if(!window[this.__yt]){this.__yv=true;window[this.__yt]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__yt+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__yw=p=qx.util.Uri.appendParamsToUrl(p,r);this.__id(c,[t,p]);}
,callback:function(v){if(this.__of){return;}
;this.__yu=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__co]=undefined;this.__yy();}
,setCallbackParam:function(w){this.__ys=w;return this;}
,setCallbackName:function(name){this.__yt=name;return this;}
,setPrefix:function(x){this.__yx=x;}
,getGeneratedUrl:function(){return this.__yw;}
,dispose:function(){this.__yy();this.__id(d);}
,_onNativeLoad:function(){this.status=this.__yu?200:500;this.__id(i);}
,__yy:function(){if(this.__yv&&window[this.__yt]){window[this.__yt]=undefined;this.__yv=false;}
;}
,__id:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__yz:function(){this.__co=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
...
}});qx.Class.define(n,{extend:qx.data.store.Jsonp,construct:function(R){this.setCallbackName(z);qx.data.store.Jsonp.call(this,this.__Qs(R));}
,members:{searchForTag:function(S){if(S!=t){this.setUrl(this.__Qs(S));}
;}
,__Qs:function(U){if(!U){return;}
...
;if(this.getSelection()==null){this.__Ee=new qx.data.Array();this.setSelection(this.__Ee);}
;}
,properties:{selection:{check:b,event:f,apply:d,init:null}},events:{"changeSelection":h},members:{_modifingSelection:0,__Ef:null,__Eg:null,__Ee:null,_applySelection:function(k,j){if(this.__Eg!=undefined&&j!=undefined){j.removeListenerById(this.__Eg);}
;this.__Eg=k.addListener(a,this.__Eh,this);this._updateSelection();}
,__Eh:function(){this._updateSelection();}
,_changeTargetSelection:function(){if(this.getTarget()==null){return;}
;if(!this.__Ei()&&!this.__Ej()){return;}
;if(this._inSelectionModification()){return;}
;var m=this.getTarget().getSelection();var l=this.getSelection();if(l==null){l=new qx.data.Array();this.__Ee=l;this.setSelection(l);}
...
,_addChangeTargetListener:function(p,o){if(this.__Ef!=undefined&&o!=undefined){o.removeListenerById(this.__Ef);}
;if(p!=null){if(this.__Ei()||this.__Ej()){this.__Ef=p.addListener(f,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()){return;}
;this._startSelectionModification();if(this.__Ei()){var s=[];for(var i=0;i<this.getSelection().length;i++ ){var t=this.getSelection().getItem(i);var u=this.__El(t);if(u!=null){s.push(u);}
;}
...
;}
;}
else if(this.__Ej()){var r=this.getSelection().getItem(this.getSelection().length-1);if(r!==undefined){this.__Ek(r);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__Ei:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.IMultiSelection);}
,__Ej:function(){var w=this.getTarget().constructor;return qx.Class.implementsInterface(w,qx.ui.core.ISingleSelection);}
,__Ek:function(x){var y=this.__El(x);if(y==null){return;}
;if(this.__Ei()){this.getTarget().addToSelection(y);}
else if(this.__Ej()){this.getTarget().setSelection([y]);}
;}
,__El:function(z){var A=this.getTarget().getSelectables(true);for(var i=0;i<A.length;i++ ){if(A[i].getModel()==z){return A[i];}
;}
;return null;}
...
},destruct:function(){if(this.__Ee){this.__Ee.dispose();}
;}
});}
)();
...
(function(){var a="changeModel",b="_applyLabelOptions",c="_applyLabelPath",d="changeTarget",e="_applyModel",f="change",g="icon",h="ReverseBindingId",k="qx.data.controller.List",m="_applyIconPath",n="BindingId",o="_applyDelegate",p="",q="changeDelegate",r="_applyTarget",s="]",t="qx.data.IListData",u="model[",v="model",w="label",x="String",y="_applyIconOptions",z=".";qx.Class.define(k,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__xG=[];this.__Em=[];this.__En=[];this.__Eo={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:t,apply:e,event:a,nullable:true,dereference:true},target:{apply:r,event:d,nullable:true,init:null,dereference:true},labelPath:{check:x,apply:c,nullable:true},iconPath:{check:x,apply:m,nullable:true},labelOptions:{apply:b,nullable:true},iconOptions:{apply:y,nullable:true},delegate:{apply:o,event:q,init:null,nullable:true}},members:{__yc:null,__xG:null,__Eo:null,__Em:null,__En:null,__Ep:null,__Eq:null,update:function(){this.__Es();this.__Ew();this._updateSelection();}
,_applyDelegate:function(E,D){this._setConfigureItem(E,D);this._setFilter(E,D);this._setCreateItem(E,D);this._setBindItem(E,D);}
,_applyIconOptions:function(G,F){this.__Ew();}
,_applyLabelOptions:function(I,H){this.__Ew();}
,_applyIconPath:function(K,J){this.__Ew();}
,_applyLabelPath:function(M,L){this.__Ew();}
,_applyModel:function(P,N){if(N!=undefined){if(this.__yc!=undefined){N.removeListenerById(this.__yc);}
;}
;if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length).dispose();}
;if(P!=null){this.__yc=P.addListener(f,this.__Er,this);this.__xN();this.__Es();if(N==null){this._changeTargetSelection();}
else {this.__Ep=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var O=this.getTarget();if(O!=null){var length=O.getChildren().length;for(var i=0;i<length;i++ ){this.__Ev();}
;}
;}
;}
...
;if(S!=null){if(this.getModel()!=null){for(var i=0;i<this.__xG.length;i++ ){this.__Eu(this.__Ey(i));}
;}
;}
;}
,__Er:function(){this.__Eq=true;qx.ui.core.queue.Widget.add(this);if(this.__xG.length!=this.getModel().getLength()){this.update();}
;}
,syncWidget:function(){if(this.__Ep){this._changeTargetSelection();}
;if(this.__Eq){this._updateSelection();}
;this.__Eq=this.__Ep=null;}
,__Es:function(){if(this.getTarget()==null){return;}
;this.__xN();var U=this.__xG.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++ ){this.__Eu(this.__Ey(j));}
;}
else if(U<T){for(var j=T;j>U;j-- ){this.__Ev();}
;}
;this.__Ep=true;qx.ui.core.queue.Widget.add(this);}
,__Et:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__yc);this.__yc=V.addListener(f,this.__Er,this);}
;}
...
;return W;}
,__Eu:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__Ev:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bo,br,bp,bn,bm){if(bp!=null){var bp=qx.lang.Object.clone(bp);this.__Eo[br]=bp.onUpdate;delete bp.onUpdate;}
else {bp={};this.__Eo[br]=null;}
;bp.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bm);bp.ignoreConverter=v;var bq=u+bm+s;if(bo!=null&&bo!=p){bq+=z+bo;}
;var bs=this.bind(bq,bn,br,bp);bn.setUserData(br+n,bs);if(!qx.lang.Array.contains(this.__Em,br)){this.__Em.push(br);}
;}
,bindPropertyReverse:function(by,bv,bw,bx,bt){var bu=u+bt+s;if(by!=null&&by!=p){bu+=z+by;}
;var bz=bx.bind(bv,this,bu,bw);bx.setUserData(by+h,bz);if(!qx.lang.Array.contains(this.__En,by)){this.__En.push(by);}
;}
,_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;}
;for(var i=0;i<this.__Em.length;i++ ){if(this.__Eo[this.__Em[i]]!=null){this.__Eo[this.__Em[i]]();}
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__Em.length;i++ ){var bE=bD.getUserData(this.__Em[i]+n);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__En.length;i++ ){var bE=bD.getUserData(this.__En[i]+h);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__Ew:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++ ){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__Ey(i));}
;this.__Et();}
...
,_setFilter:function(bR,bP){if((bR==null||bR.filter==null)&&(bP!=null&&bP.filter!=null)){this.__Ex();}
...
;var bQ=this.__xG;this.__xN();if(bQ.length>this.__xG.length){for(var j=bQ.length;j>this.__xG.length;j-- ){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bQ.length<this.__xG.length){for(var j=bQ.length;j<this.__xG.length;j++ ){var bT=this._createItem();this.getTarget().add(bT);}
;}
;var bS=this.getTarget().getChildren();for(var i=0;i<bS.length;i++ ){this._bindListItem(bS[i],this.__Ey(i));}
;this.__Et();this._endSelectionModification();this._updateSelection();}
,__Ex:function(){this.__xN();this.__Es();this.__Ew();this.__Eq=true;qx.ui.core.queue.Widget.add(this);}
,__xN:function(){var bW=this.getModel();if(bW==null){return;}
;var bX=this.getDelegate();if(bX!=null){var bV=bX.filter;}
;this.__xG=[];for(var i=0;i<bW.getLength();i++ ){if(bV==null||bV(bW.getItem(i))){this.__xG.push(i);}
;}
;}
,__Ey:function(bY){return this.__xG[bY];}
},destruct:function(){this.__xG=this.__Eo=this.__Em=null;this.__En=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
