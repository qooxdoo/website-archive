...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox.b5bf345b48f4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},destruct:function(){if(this.__xa){this.__xa.dispose();}
;}
});}
)();
...
(function(){var a="changeModel",b="click",c="one",d="Enter",e="list",f="changeDelegate",g="change",h="qx.data.Array",j="changeVisibility",k="qx.ui.form.core.VirtualDropDownList",l="_applySelection",m="changeSelection",n="Invalid parameter 'target'!",o="qx.event.type.Data";qx.Class.define(k,{extend:qx.ui.popup.Popup,construct:function(p){qx.core.Assert.assertNotNull(p,n);qx.core.Assert.assertNotUndefined(p,n);qx.core.Assert.assertInterface(p,qx.ui.form.core.AbstractVirtualBox,n);qx.ui.popup.Popup.call(this,new qx.ui.layout.VBox());this._target=p;this._createChildControl(e);this.addListener(j,this.__xe,this);this.__xb=new qx.data.Array();this.initSelection(this.__xb);}
,properties:{autoHide:{refine:true,init:false},keepActive:{refine:true,init:true},selection:{check:h,event:m,apply:l,nullable:false,deferredInit:true}},events:{"changeSelection":o},members:{_target:null,_preselected:null,__xc:false,__xd:false,__xb:null,open:function(){this.placeToWidget(this._target,true);this.show();}
,close:function(){this.hide();}
,setPreselected:function(q){this._preselected=q;this.__xd=true;var s=this.getChildControl(e).getSelection();var r=new qx.data.Array([q]);this.__xg(r,s);r.dispose();this.__xd=false;}
...
,_handleKeyboard:function(event){if(this.isVisible()&&event.getKeyIdentifier()===d){this.__xf();return;}
;var w=event.clone();w.setTarget(this.getChildControl(e));w.setBubbles(false);this.getChildControl(e).dispatchEvent(w);}
,_handleMouse:function(event){this.__xf();}
,__oQ:function(event){if(this.__xc){return;}
;var x=this.getSelection();var y=this.getChildControl(e).getSelection();this.__xd=true;this.__xg(x,y);this.__xd=false;this.__xc=true;this.__xg(y,x);this.__xc=false;}
,_onListChangeSelection:function(event){if(this.__xd){return;}
;var z=this.getChildControl(e).getSelection();if(this.isVisible()){this.setPreselected(z.getItem(0));}
else {this.__xc=true;this.__xg(z,this.getSelection());this.__xc=false;}
;}
,__xe:function(event){if(this.isVisible()){if(this._preselected==null){var A=this.getSelection();var B=this.getChildControl(e).getSelection();this.__xg(A,B);}
;this.__xh();}
...
,_applySelection:function(D,C){D.addListener(g,this.__oQ,this);if(C!=null){C.removeListener(g,this.__oQ,this);}
;this.__xg(D,this.getChildControl(e).getSelection(D));}
,__xf:function(){if(this._preselected!=null){var E=this.getSelection();E.splice(0,1,this._preselected);this._preselected=null;this.close();}
;}
,__xg:function(F,H){if(F.equals(H)){return;}
...
;}
,__xh:function(){this.__xi();this.__xj();}
,__xi:function(){var I=this._target.getBounds().width;this.setWidth(I);}
,__xj:function(){var J=this.__xk();var L=this._target.getMaxListHeight();var K=this.getChildControl(e);var M=K.getPane().getRowConfig().getTotalSize();if(L==null||M<L){L=M;}
;if(L>J){K.setMaxHeight(J);}
else if(L<J){K.setMaxHeight(L);}
;}
,__xk:function(){var N=this.getLayoutLocation(this._target);var Q=qx.bom.Viewport.getHeight();var P=N.top;var O=Q-N.bottom;return P>O?P:O;}
...
(function(){var a="Function",b="inner",c="",d="focusout",f="list",g="change",h="virtual-combobox",j="click",k="textfield",m="dropdown",n="value",o="_applyPlaceholder",p="single",q="converter",r="select",s="changeValue",t="qx.ui.form.VirtualComboBox",u="button",v="String",w="focusin",x="Enter";qx.Class.define(t,{extend:qx.ui.form.core.AbstractVirtualBox,implement:[qx.ui.form.IStringForm],construct:function(y){qx.ui.form.core.AbstractVirtualBox.call(this,y);var z=this._createChildControl(k);this._createChildControl(u);var A=this.getChildControl(m);A.getChildControl(f).setSelectionMode(p);this.__gD=A.getSelection();this.__gD.addListener(g,this.__HR,this);this.bind(n,z,n);z.bind(n,this,n);this.addListener(w,function(e){z.fireNonBubblingEvent(w,qx.event.type.Focus);}
,this);this.addListener(d,function(e){z.fireNonBubblingEvent(d,qx.event.type.Focus);}
,this);}
,properties:{appearance:{refine:true,init:h},width:{refine:true,init:120},value:{nullable:true,event:s},placeholder:{check:v,nullable:true,apply:o},defaultFormat:{check:a,init:null,nullable:true}},members:{__HP:null,__HQ:null,__gD:null,__xB:null,getTextSelection:function(){return this.getChildControl(k).getTextSelection();}
,getTextSelectionLength:function(){return this.getChildControl(k).getTextSelectionLength();}
,setTextSelection:function(B,C){this.getChildControl(k).setTextSelection(B,C);}
...
,tabFocus:function(){var D=this.getChildControl(k);D.getFocusElement().focus();D.selectAllText();}
,focus:function(){qx.ui.form.core.AbstractVirtualBox.prototype.focus.call(this);this.getChildControl(k).getFocusElement().focus();}
,_createChildControlImpl:function(G,F){var E;switch(G){case k:E=new qx.ui.form.TextField();E.setFocusable(qx.event.handler.MouseEmulation.ON);E.addState(b);this._add(E,{flex:1});break;case u:E=new qx.ui.form.Button();E.setFocusable(false);E.setKeepActive(true);E.addState(b);this._add(E);break;};return E||qx.ui.form.core.AbstractVirtualBox.prototype._createChildControlImpl.call(this,G,F);}
,_beforeOpen:function(){this.__HS();}
,_handleKeyboard:function(event){var H=this._getAction(event);switch(H){case r:this.setValue(this.getChildControl(k).getValue());break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
,_getAction:function(event){var I=event.getKeyIdentifier();var K=this.getChildControl(m).isVisible();var J=this._isModifierPressed(event);if(!K&&!J&&I===x){return r;}
else {return qx.ui.form.core.AbstractVirtualBox.prototype._getAction.call(this,event);}
;}
,_handleMouse:function(event){qx.ui.form.core.AbstractVirtualBox.prototype._handleMouse.call(this,event);var L=event.getType();if(L!==j){return;}
;var M=event.getTarget();if(M==this.getChildControl(u)){this.toggle();}
else {this.close();}
;}
,__HR:function(event){if(this.__xB==true){return;}
;var N=this.__gD.getItem(0);if(N){N=this.__bo(N);this.setValue(N);}
;}
,_applyPlaceholder:function(P,O){this.getChildControl(k).setPlaceholder(P);}
,__HS:function(){var S=this.getValue();var R=this.getChildControl(m);var Q=R.getSelection();if(this.__bo(Q.getItem(0))!==S){this.__xB=true;Q.removeAll();this.__xB=false;if(S==null||S==c){return;}
;var W=this.getModel();var V=R.getChildControl(f)._getLookupTable();for(var i=0,l=V.length;i<l;i++ ){var T=W.getItem(V[i]);var U=this.__bo(T);if(U&&U.indexOf(S)==0){R.setPreselected(T);break;}
;}
;}
;}
...
;var X=qx.util.Delegate.getMethod(Y,q);if(X!=null){bb=X(bb);}
;if(bb!=null&&bc!=null){bb=bc(qx.lang.String.stripTags(bb));}
;return bb;}
},destruct:function(){var be=this.getChildControl(k);this.removeAllBindings();be.removeAllBindings();this.__gD.removeListener(g,this.__HR,this);this.__gD=null;}
});}
)();
