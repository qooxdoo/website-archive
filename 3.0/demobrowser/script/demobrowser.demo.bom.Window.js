...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.097243aeb53b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="click",c="Open Native Modal Window",d="demobrowser.demo.bom.Window",f="Modal Window closed?",g="http://sourceforge.net",h="window1",i="window3",j="http://slashdot.org",k="Window closed?",l="http://qooxdoo.org",m="demobrowser/demo/html/ModalWindow.html",n="Open Faked Native Modal Window",o="window2",p="#eee",q="button";qx.Class.define(d,{extend:qx.application.Native,members:{__sn:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__sn=[l,g,j,r.toUri(m)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,b,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__sn[0],h,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,c);document.body.appendChild(s);qx.event.Registration.addListener(s,b,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__sn[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,b,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(p);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__sn[0],i,A,true,false);}
,this);}
...
;return C;}
,__IK:function(K,O){var M;var J;var N=[];if(O&&this.__IJ()){for(var L in K){if(qx.bom.Window.__IH[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__IH[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__II[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__IL:function(){if(this.isClosed(this.__IG)){this.getBlocker().unblock();this.__jO.stop();}
;}
,getBlocker:function(){if(this.__mY==null){this.__mY=new qx.bom.Blocker;}
;return this.__mY;}
