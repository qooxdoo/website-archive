...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.284df0281565.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="demobrowser.demo.virtual.Table",d="white",e="#EEE",f="vertical",g="__RB";qx.Class.define(c,{extend:qx.application.Standalone,members:{__RB:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(d,e));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(f));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__RB=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__RB.getCellProperties(k+a+j);}
...
;this.__dq=qx.bom.Stylesheet.createElement(p);this.__sV={};this.__lA={};}
,members:{__dq:null,__sV:null,__lA:null,getStylesheet:function(){return this.__dq;}
,getCssClass:function(q){return this.__sV[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lA[r];if(!s){var s=this.__sW();qx.bom.Stylesheet.addRule(this.__dq,k+s,r);this.__lA[r]=s;}
;this.__sV[t]=s;return s;}
,__sW:function(){return e+this.toHashCode()+a+(this.__sX++ );}
,__sX:0},destruct:function(){this.__dq=this.__sV=this.__lA=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dq=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__sY={};this.__ta={};this.__tb={};this.__tc={};this.__kk={};this.__td={};this.initAppearance();this.__th();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__te:null,__tf:null,__kk:null,__td:null,__ta:null,__sY:null,__tb:null,__tc:null,__tg:false,__dq:null,__th:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__te=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__te.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__ta={};}
;}
,_getValue:function(R){if(this.__tg){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__tg){U=this.__ta;}
else {U=this.__sY;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__tg){var bi=this.__tc;}
else {bi=this.__tb;}
...
;}
,getCellProperties:function(bk,bj){this.__ti(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dq.getCssClass(this.__tf)||t;return v+bq;}
,__ti:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__tf==bt){return;}
;this.__tf=bt;var bv=this.__kk[this.__tf];if(!bv){this.__tj();this.__tk(bs);this.__tl(bs);this.__tm();this.__kk[this.__tf]=1;}
;this.__tn();}
,__tj:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__tk:function(bz){this.__ta={};this.__tg=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__tg=false;}
,__tl:function(){var bD=qx.lang.Object.getValues(this.__ta).join(I);this.__dq.computeClassForStyles(this.__tf,bD);}
,__tm:function(){var bI=this.__te;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__td[this.__tf]=bG;}
,__tn:function(){var bK=qx.util.PropertyUtil;var bJ=this.__td[this.__tf]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__sY).join(I);}
,getInsets:function(bQ,bR){var bT=this.__tb;var bS=this.__tc;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dq=this.__sY=this.__ta=this.__tb=this.__tc=this.__kk=this.__td=this.__te=null;}
});}
)();
