...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListControllerWithFilter.2c0fb046ee1d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Show all numbers.",b="Write data to log",c="Add an item",d="Remove an item",e="Show only even numbers.",f="Odd / Even filter",g="Remove filter",h="<b>Filtered List</b><br/>",j="Reverse order",k="demobrowser.demo.data.ListControllerWithFilter",l="Show only odd numbers.",m="value",n="init",o="delegate",p="List showing numbered items, bound to a data array.",q="execute";qx.Class.define(k,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var B=[];for(var i=0;i<8;i++ ){B.push(i);}
...
;var C=new qx.ui.basic.Label(n);this.getRoot().add(C,{left:10,top:290});var r={converter:function(I){if(I==w){return e;}
else if(I==u){return l;}
;return a;}
};y.bind(o,C,m,r);var E=new qx.ui.form.Button(c);E.setWidth(120);this.getRoot().add(E,{left:130,top:80});E.addListener(q,function(){D.push(D.length);}
,this);var x=new qx.ui.form.Button(d);x.setWidth(120);this.getRoot().add(x,{left:130,top:115});x.addListener(q,function(){D.pop();}
,this);var z=new qx.ui.form.Button(b);z.setWidth(120);this.getRoot().add(z,{left:130,top:150});z.addListener(q,function(){qx.log.appender.Console.show();this.info(D.toString());}
,this);var s=new qx.ui.form.Button(f);s.setWidth(120);this.getRoot().add(s,{left:130,top:185});s.addListener(q,function(){y.getDelegate()==u?y.setDelegate(w):y.setDelegate(u);}
,this);var A=new qx.ui.form.Button(g);A.setWidth(120);this.getRoot().add(A,{left:130,top:220});A.addListener(q,function(){y.setDelegate(null);}
,this);var F=new qx.ui.form.Button(j);F.setWidth(120);this.getRoot().add(F,{left:130,top:255});F.addListener(q,function(){D.reverse();}
,this);var t=new qx.ui.basic.Label();t.setRich(true);t.setWidth(200);t.setValue(h+p);this.getRoot().add(t,{left:20,top:10});}
}});}
)();
