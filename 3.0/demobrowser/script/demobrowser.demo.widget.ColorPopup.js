...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.81ce4047522e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="mousedown",b="teal",c="maroon",d="qx.ui.control.ColorPopup",f="#666",g="changeValue",h="#333",k="preview-pane",l="__Il",m="execute",n="#000",o="yellow",p="changeGreen",q="colorpopup",r="_applyValue",s="selector-button",t="colorselector-cancelbutton",u="blue",v="changeRed",w="field#",x="#CCC",y="auto-button",z="Color Selector",A="current-preview",B="changeVisibility",C="recent",D="changeBlue",E="mouseover",F="Cancel",G="#FFF",H="__Ik",I="right",J="Open ColorSelector",K="mouseout",L="#999",M="colorselector-okbutton",N="Automatic",O="Basic Colors",P="Preview (Old/New)",Q="visible",R="Number",S="selected-preview",T="Recent Colors",U="OK",V="field",W="green",X="red";qx.Class.define(d,{extend:qx.ui.popup.Popup,implement:[qx.ui.form.IColorForm],construct:function(){qx.ui.popup.Popup.call(this);this.setLayout(new qx.ui.layout.VBox(5));this._createChildControl(y);this._createBoxes();this._createChildControl(k);this._createChildControl(s);this.addListener(B,this._onChangeVisibility,this);}
,properties:{appearance:{refine:true,init:q},value:{nullable:true,apply:r,event:g},red:{check:R,init:null,nullable:true,event:v},green:{check:R,init:null,nullable:true,event:p},blue:{check:R,init:null,nullable:true,event:D}},members:{__Ii:1e5,__Ij:null,__Ik:null,__Il:null,__Im:C,__In:12,_createChildControlImpl:function(bb,ba){var Y;switch(bb){case V:Y=new qx.ui.core.Widget;Y.addListener(a,this._onFieldMouseDown,this);Y.addListener(E,this._onFieldMouseOver,this);Y.addListener(K,this._onFieldMouseOut,this);break;case y:Y=new qx.ui.form.Button(this.tr(N));Y.setAllowStretchX(true);Y.addListener(m,this._onAutomaticBtnExecute,this);this.add(Y);break;case s:Y=new qx.ui.form.Button(this.tr(J));Y.addListener(m,this._onSelectorButtonExecute,this);this.add(Y);break;case k:Y=new qx.ui.groupbox.GroupBox(this.tr(P));Y.setLayout(new qx.ui.layout.HBox);Y.add(this._createChildControl(S,true),{flex:1});Y.add(this._createChildControl(A,true),{flex:1});this.add(Y);break;case S:Y=new qx.ui.container.Composite(new qx.ui.layout.Basic);break;case A:Y=new qx.ui.container.Composite(new qx.ui.layout.Basic);break;case M:Y=new qx.ui.form.Button(this.tr(U));Y.addListener(m,this._onColorSelectorOk,this);break;case t:Y=new qx.ui.form.Button(this.tr(F));Y.addListener(m,this._onColorSelectorCancel,this);break;};return Y||qx.ui.popup.Popup.prototype._createChildControlImpl.call(this,bb);}
,_createBoxes:function(){this.__Ij={};var bd=this._tables;var bg,bc,be;var j=0;for(var bf in bd){bg=bd[bf];bc=new qx.ui.groupbox.GroupBox(bg.label);bc.setLayout(new qx.ui.layout.HBox);this.__Ij[bf]=bc;this.add(bc);for(var i=0;i<this.__In;i++ ){be=this.getChildControl(w+(j++ ));be.setBackgroundColor(bg.values[i]||null);bc.add(be);}
;}
;}
,_createColorSelector:function(){if(this.__Il){return;}
;var bh=new qx.ui.window.Window(this.tr(z));this.__Ik=bh;bh.setLayout(new qx.ui.layout.VBox(16));bh.setResizable(false);bh.moveTo(20,20);this.__Il=new qx.ui.control.ColorSelector;bh.add(this.__Il);var bi=new qx.ui.container.Composite(new qx.ui.layout.HBox(8,I));bh.add(bi);var bk=this._createChildControl(t);var bj=this._createChildControl(M);bi.add(bk);bi.add(bj);}
,_applyValue:function(bn,bm){if(bn===null){this.setRed(null);this.setGreen(null);this.setBlue(null);}
else {var bl=qx.util.ColorUtil.stringToRgb(bn);this.setRed(bl[0]);this.setGreen(bl[1]);this.setBlue(bl[2]);}
;this.getChildControl(S).setBackgroundColor(bn);this._rotatePreviousColors();}
,_rotatePreviousColors:function(){if(!this._tables){return;}
;var bq=this._tables[this.__Im].values;var br=this.__Ij[this.__Im];if(!bq){return;}
;var bs=this.getValue();if(!bs){return;}
;var bp=bq.indexOf(bs);if(bp!=-1){qx.lang.Array.removeAt(bq,bp);}
else if(bq.length==this.__In){bq.shift();}
;bq.push(bs);var bo=br.getChildren();for(var i=0;i<bo.length;i++ ){bo[i].setBackgroundColor(bq[i]||null);}
;}
,_onFieldMouseDown:function(e){var bt=this.getChildControl(A).getBackgroundColor();this.setValue(bt);if(bt){this.hide();}
;}
,_onFieldMouseOver:function(e){this.getChildControl(A).setBackgroundColor(e.getTarget().getBackgroundColor());}
,_onFieldMouseOut:function(e){var bx=this.getRed();var bw=this.getGreen();var bu=this.getBlue();var bv=null;if(bx!==null||bw!==null||bu!==null){bv=qx.util.ColorUtil.rgbToRgbString([bx,bw,bu]);}
;this.getChildControl(A).setBackgroundColor(bv);}
,_onAutomaticBtnExecute:function(){this.setValue(null);this.hide();}
,_onSelectorButtonExecute:function(){this._createColorSelector();this.exclude();var bA=this.getRed();var bz=this.getGreen();var by=this.getBlue();if(bA===null||bz===null||by===null){bA=255;bz=255;by=255;}
;this.__Il.setRed(bA);this.__Il.setGreen(bz);this.__Il.setBlue(by);this.__Ik.open();}
,_onColorSelectorOk:function(){var bB=this.__Il;this.setValue(qx.util.ColorUtil.rgbToRgbString([bB.getRed(),bB.getGreen(),bB.getBlue()]));this.__Ik.close();}
,_onColorSelectorCancel:function(){this.__Ik.close();}
,_onChangeVisibility:function(e){if(this.getVisibility()==Q){var bF=this.getRed();var bE=this.getGreen();var bC=this.getBlue();var bD=null;if(bF!==null||bE!==null||bC!==null){bD=qx.util.ColorUtil.rgbToRgbString([bF,bE,bC]);}
;this.getChildControl(S).setBackgroundColor(bD);this.getChildControl(A).setBackgroundColor(bD);}
;}
,_tables:{core:{label:qx.locale.Manager.tr(O),values:[n,h,f,L,x,G,X,W,u,o,b,c]},recent:{label:qx.locale.Manager.tr(T),values:[]}}},destruct:function(){this._disposeObjects(H,l);this._tables=this.__Ij=null;}
});}
)();
...
,setValue:function(de){var dd;if(de==null){this.__ov=true;dd=[255,255,255];}
else {dd=qx.util.ColorUtil.stringToRgb(de);this.__ov=false;}
;this.__wl=true;this.setRed(dd[0]);this.setGreen(dd[1]);this.__wl=false;this.setBlue(dd[2]);}
,getValue:function(){return this.__ov?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__ov=true;this.__wl=true;this.setRed(255);this.setGreen(255);this.__wl=false;this.setBlue(255);}
,__ox:function(){if(!this.__wl){this.__ov=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dg,df){if(this.__wf===null){this.__wf=ci;}
;if(this.__wf!==cM){this.getChildControl(n).setValue(dg);}
;if(this.__wf!==o){this._setHexFromRgb();}
;switch(this.__wf){case cM:case o:case ci:this._setHueFromRgb();};this._setPreviewFromRgb();this.__ox();if(this.__wf===ci){this.__wf=null;}
;}
,_applyGreen:function(di,dh){if(this.__wf===null){this.__wf=ct;}
;if(this.__wf!==cM){this.getChildControl(U).setValue(di);}
;if(this.__wf!==o){this._setHexFromRgb();}
;switch(this.__wf){case cM:case o:case ct:this._setHueFromRgb();};this._setPreviewFromRgb();this.__ox();if(this.__wf===ct){this.__wf=null;}
;}
,_applyBlue:function(dk,dj){if(this.__wf===null){this.__wf=d;}
;if(this.__wf!==cM){this.getChildControl(cm).setValue(dk);}
;if(this.__wf!==o){this._setHexFromRgb();}
;switch(this.__wf){case cM:case o:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__ox();if(this.__wf===d){this.__wf=null;}
;}
,_applyHue:function(dm,dl){if(this.__wf===null){this.__wf=cB;}
;if(this.__wf!==J){this.getChildControl(cu).setValue(dm);}
;if(this.__wf!==W){if(this.getChildControl(cb).getBounds()){this.getChildControl(cb).setDomLeft(Math.round(dm/1.40625)+this.getChildControl(cK).getPaddingLeft());}
else {this.getChildControl(cb).setLayoutProperties({left:Math.round(dm/1.40625)});}
;}
;switch(this.__wf){case J:case W:case cB:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__wf===cB){this.__wf=null;}
;}
,_applySaturation:function(dp,dn){if(this.__wf===null){this.__wf=t;}
;if(this.__wf!==J){this.getChildControl(cA).setValue(dp);}
;if(this.__wf!==W){this._setBrightnessGradiant();if(this.getChildControl(cb).getBounds()){this.getChildControl(cb).setDomTop(256-Math.round(dp*2.56)+this.getChildControl(cK).getPaddingTop());}
else {this.getChildControl(cb).setLayoutProperties({top:256-Math.round(dp*2.56)});}
;}
;switch(this.__wf){case J:case W:case t:this._setRgbFromHue();};if(this.__wf===t){this.__wf=null;}
;}
,_applyBrightness:function(ds,dr){if(this.__wf===null){this.__wf=c;}
;if(this.__wf!==J){this.getChildControl(ch).setValue(ds);}
;if(this.__wf!==V){var dq=256-Math.round(ds*2.56);if(this.getChildControl(cl).getBounds()){this.getChildControl(cl).setDomTop(dq+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cl).setLayoutProperties({top:dq});}
;}
;switch(this.__wf){case J:case V:case c:this._setRgbFromHue();};if(this.__wf===c){this.__wf=null;}
;}
,_onBrightnessHandleMouseDown:function(e){this.getChildControl(cl).capture();this.__wh=cl;var dv=this.getChildControl(cd).getContentLocation();var du=this.getChildControl(cl).getContentLocation();var dt=this.getChildControl(cd).getBounds();this.__wi=dv.top+(e.getDocumentTop()-du.top)-dt.top;e.stopPropagation();}
,_onBrightnessHandleMouseUp:function(e){this.getChildControl(cl).releaseCapture();this.__wh=null;}
,_onBrightnessHandleMouseMove:function(e){if(this.__wh===cl){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(cd).getContentLocation();var dw=this.getChildControl(cl).getBounds();this.__wi=location.top+(dw.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cl).capture();this.__wh=cl;}
...
;e.stop();}
,_setBrightnessOnFieldEvent:function(e){var dx=qx.lang.Number.limit(e.getDocumentTop()-this.__wi,0,256);this.__wf=V;if(this.getChildControl(cl).getBounds()){this.getChildControl(cl).setDomTop(dx);}
else {this.getChildControl(cl).setLayoutProperties({top:dx});}
;this.setBrightness(100-Math.round(dx/2.56));this.__wf=null;}
,_onHueSaturationHandleMouseUp:function(e){if(this.__wh){e.stopPropagation();this.getChildControl(cb).releaseCapture();this.__wh=null;}
;}
,_onHueSaturationHandleMouseMove:function(e){if(this.__wh===cb){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(bY).getContentLocation();var dy=this.getChildControl(cb).getBounds();var dz=this.getChildControl(bY).getBounds();this.__wj=location.top+(dy.height/2)-dz.top;this.__wk=location.left+(dy.width/2)-dz.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(cb).capture();this.__wh=cb;}
...
;e.stop();}
,_setHueSaturationOnFieldEvent:function(e){var dB=qx.lang.Number.limit(e.getDocumentTop()-this.__wj,0,256);var dA=qx.lang.Number.limit(e.getDocumentLeft()-this.__wk,0,256);this.getChildControl(cb).setDomPosition(dA,dB);this.__wf=W;this.setSaturation(100-Math.round(dB/2.56));this.setHue(Math.round(dA*1.40625));this.__wf=null;}
,_setRedFromSpinner:function(){if(this.__wf!==null){return;}
;this.__wf=cM;this.setRed(this.getChildControl(n).getValue());this.__wf=null;}
,_setGreenFromSpinner:function(){if(this.__wf!==null){return;}
;this.__wf=cM;this.setGreen(this.getChildControl(U).getValue());this.__wf=null;}
,_setBlueFromSpinner:function(){if(this.__wf!==null){return;}
;this.__wf=cM;this.setBlue(this.getChildControl(cm).getValue());this.__wf=null;}
,_setHueFromSpinner:function(){if(this.__wf!==null){return;}
;this.__wf=J;this.setHue(this.getChildControl(cu).getValue());this.__wf=null;}
,_setSaturationFromSpinner:function(){if(this.__wf!==null){return;}
;this.__wf=J;this.setSaturation(this.getChildControl(cA).getValue());this.__wf=null;}
,_setBrightnessFromSpinner:function(){if(this.__wf!==null){return;}
;this.__wf=J;this.setBrightness(this.getChildControl(ch).getValue());this.__wf=null;}
,_onHexFieldChange:function(e){if(this.__wf!==null){return;}
;try{var dD=this.getChildControl(cJ);var dC=qx.util.ColorUtil.hexStringToRgb(N+dD.getValue());}
catch(dE){return;}
;this.__wf=o;this.setRed(dC[0]);this.setGreen(dC[1]);this.setBlue(dC[2]);this.__wf=null;}
...
,_setHueFromRgb:function(){switch(this.__wf){case J:case W:case V:break;default:var dI=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dI[0]);this.setSaturation(dI[1]);this.setBrightness(dI[2]);};}
,_setRgbFromHue:function(){switch(this.__wf){case cM:case o:break;default:var dJ=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dJ[0]);this.setGreen(dJ[1]);this.setBlue(dJ[2]);};}
