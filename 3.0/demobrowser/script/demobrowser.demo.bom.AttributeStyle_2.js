...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.AttributeStyle_2.491c15c8fd53.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="text",b="Checkbox #1",c="demobrowser.demo.bom.AttributeStyle_2",d="label",e="checkbox",f="input",g="chk";qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var h=qx.dom.Element.create(f,{type:e,checked:true,id:g});document.body.appendChild(h);var i=qx.dom.Element.create(d,{"for":g});qx.bom.element.Attribute.set(i,a,b);document.body.appendChild(i);}
}});}
)();
