...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.aa6768a53a89.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="touchmove",b="black",c="#333",d="px",f="border-left",g="green",h="div",i="100%",j="demobrowser.demo.mobile.PingPong",k="0",l="200px",m="30px",n="qx.debug",o="interval",p="0px",q="12px",r="15em",s="center",t="100px",u="1px solid white",v='Lucida Grande',w="innerHTML",z="top",A="right",B="Arial",C="50%",D="<b>This demo is supposed to be run in a WebKit-based browser.</b>",E="engine.name",F="20px",G="webkit",H="none",I="border-right",J="white",K="left",L="absolute";qx.Class.define(j,{extend:qx.application.Native,members:{__QC:null,__QD:null,__QE:null,__QF:null,__QG:5,__QH:1,__QI:1,__QJ:null,__QK:null,__QL:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(n)){qx.log.appender.Native;qx.log.appender.Console;}
;var O={"width":i,"height":i,"backgroundColor":b,"margin":p,"userSelect":H};var R=new qx.html.Element(h,O);R.useElement(document.body);R.setRoot(true);if(qx.core.Environment.get(E)!=G){var Q={"color":g,"font-family":v,"font-size":q,"position":L,"left":m,"top":F};var P=new qx.html.Element(h,Q);R.add(P);P.setAttribute(w,D);return;}
;var M=this.__QP(K);R.add(M);var N=this.__QP(A);R.add(N);this.__QD=this.__QQ(K);M.add(this.__QD);M.addListener(a,qx.lang.Function.bind(this.__im,this,this.__QD),this);this.__QC=this.__QQ(A);N.add(this.__QC);N.addListener(a,qx.lang.Function.bind(this.__im,this,this.__QC),this);this.__QE=this.__QR();R.add(this.__QE);this.__QK=this.__QS();M.add(this.__QK);this.__QL=this.__QS();N.add(this.__QL);this.__QJ=[0,0];this.__QM();}
,__QM:function(){this.__QE.setStyles({"left":l,"top":l});this.__QF=new qx.event.Timer(40);this.__QF.addListener(o,function(){var x=(parseInt(this.__QE.getStyle(K))+this.__QG*this.__QH);var y=(parseInt(this.__QE.getStyle(z))+this.__QG*this.__QI);this.__QE.setStyle(K,x+d);this.__QE.setStyle(z,y+d);this.__QO();}
,this);this.__QF.start();}
,__QN:function(S){this.__QF.stop();this.__QF.dispose();this.__QG=5;this.__QJ[S]=this.__QJ[S]+1;this.__QK.setAttribute(w,this.__QJ[0]);this.__QL.setAttribute(w,this.__QJ[1]);this.__QM();}
,__QO:function(){var U=this.getBoundsFor(this.__QE);if(U.top<=0){this.__QI=1;}
;if(U.bottom>=window.innerHeight-5){this.__QI=-1;}
;if(U.left<=0||U.right>=window.innerWidth){this.__QN(U.left<=0?1:0);}
;var V=this.getBoundsFor(this.__QD);if(U.left<=V.right&&U.bottom>=V.top&&U.top<=V.bottom){this.__QH=1;this.__QG=Math.min(this.__QG+1,20);}
;var T=this.getBoundsFor(this.__QC);if(U.right>=T.left&&U.bottom>=T.top&&U.top<=T.bottom){this.__QH=-1;this.__QG=Math.min(this.__QG+1,20);}
;}
,__im:function(W,e){W.setStyles({"top":(e.getDocumentTop()-50)+d});}
,getBoundsFor:function(X){return qx.bom.element.Location.get(X.getDomElement());}
,__QP:function(ba){var Y={"width":C,"height":i,"position":L,"backgroundColor":b};if(ba==K){Y[I]=u;}
else {Y[K]=C;Y[f]=u;}
;return new qx.html.Element(h,Y);}
,__QQ:function(bc){var bb={"width":m,"height":t,"top":t,"position":L,"backgroundColor":J};bb[bc]=F;return new qx.html.Element(h,bb);}
,__QR:function(){var bd={"width":F,"height":F,"position":L,"backgroundColor":J,"userSelect":H};return new qx.html.Element(h,bd);}
,__QS:function(){var be={"width":i,"height":i,"textAlign":s,"fontSize":r,"color":c,"fontFamily":B};var bf=new qx.html.Element(h,be);bf.setAttribute(w,k);return bf;}
}});}
)();
