...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_Scroller.b18b2d874d5e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__cO={};this.__ig={};}
,members:{__vd:false,__ve:false,__ig:null,__cO:null,inTouchMomentum:function(){if(qx.core.Environment.get(d)){qx.Bootstrap.warn(f+m+l);}
;return this.__vd;}
,_onTouchStart:function(e){if(this.__ig){clearTimeout(this.__ig.x);clearTimeout(this.__ig.y);}
;this.__cO={"x":0,"y":0};if(this.__vd){this.__ve=true;this.__vd=false;}
;}
,_onTouchEnd:function(e){if(this.__ve){this.__ve=false;e.stop();}
;}
,_onTouchMove:function(e){this._onTouchMoveDirectional(n,e);this._onTouchMoveDirectional(o,e);this.__vd=true;e.stop();}
...
;this.__cO[t]=e[g+p]();r.scrollBy(s);if(this.__ig[t]){clearTimeout(this.__ig[t]);this.__ig[t]=null;}
;this.__ig[t]=setTimeout(qx.lang.Function.bind(function(u){this.__ii(u,t);}
,this,s),100);}
;}
,__ii:function(v,x){this.__ig[x]=null;var y=this._isChildControlVisible(h+x);if(v==0||!y){this.__vd=false;return;}
;if(v>0){v=Math.max(0,v-3);}
else {v=Math.min(0,v+3);}
;this.__ig[x]=setTimeout(qx.lang.Function.bind(function(A,z){this.__ii(A,z);}
,this,v,x),10);var w=this.getChildControl(h+x,true);w.scrollBy(v);}
},destruct:function(){clearTimeout(this.__ig.x);clearTimeout(this.__ig.y);this.__ig=this.__cO=this.__vd=null;}
});}
)();
...
(function(){var a="mousedown",b="Boolean",c="scroll",d="focus-indicator",g="mouseout",h="__vj",i="changeHorizontalScrollBarVisible",j="excluded",k="bottom",l="_applyScrollTimeout",m="changeScrollX",n="_applyTablePaneModel",o="Integer",p="scrollbar-y",q="qx.event.type.Data",r="dblclick",s="__vk",t="dataEdited",u="__vh",v="mousewheel",w="interval",y="__vf",z="qx.ui.table.pane.Scroller",A="__vm",B="table-scroller-focus-indicator",C="__vg",D="visible",E="mousemove",F="resize-line",G="_applyShowCellFocusIndicator",H="y",I="header",J="resize",K="__nz",L="vertical",M="changeScrollY",N="editing",O="appear",P="__vl",Q="click",R="modelChanged",S="table-scroller",T="beforeSort",U="scrollbar-x",V="cellDblclick",W="__vi",X="mouseup",Y="horizontal",bx="cellClick",by="losecapture",bz="contextmenu",bt="col-resize",bu="disappear",bv="_applyVerticalScrollBarVisible",bw="__jO",bD="_applyHorizontalScrollBarVisible",bE="os.scrollBarOverlayed",bF="pane",bH="cellContextmenu",bA="close",bB="changeTablePaneModel",bC="x",br="qx.ui.table.pane.Model",bG="qx.ui.table.pane.CellEvent",bs="changeVerticalScrollBarVisible";qx.Class.define(z,{extend:qx.ui.core.Widget,include:qx.core.Environment.filter({"event.touch":qx.ui.core.scroll.MTouchScroll,"true":qx.ui.core.scroll.MScrollBarFactory}),construct:function(bI){qx.ui.core.Widget.call(this);this.__uh=bI;var bJ=new qx.ui.layout.Grid();bJ.setColumnFlex(0,1);bJ.setRowFlex(1,1);this._setLayout(bJ);this.__nz=this._showChildControl(I);this.__vf=this._showChildControl(bF);this.__vg=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({minWidth:0});this._add(this.__vg,{row:0,column:0,colSpan:2});this.__vh=new qx.ui.table.pane.Clipper();this.__vh.add(this.__nz);this.__vh.addListener(by,this._onChangeCaptureHeader,this);this.__vh.addListener(E,this._onMousemoveHeader,this);this.__vh.addListener(a,this._onMousedownHeader,this);this.__vh.addListener(X,this._onMouseupHeader,this);this.__vh.addListener(Q,this._onClickHeader,this);this.__vg.add(this.__vh,{flex:1});this.__vi=new qx.ui.table.pane.Clipper();this.__vi.add(this.__vf);this.__vi.addListener(v,this._onMousewheel,this);this.__vi.addListener(E,this._onMousemovePane,this);this.__vi.addListener(a,this._onMousedownPane,this);this.__vi.addListener(X,this._onMouseupPane,this);this.__vi.addListener(Q,this._onClickPane,this);this.__vi.addListener(bz,this._onContextMenu,this);this.__vi.addListener(r,this._onDblclickPane,this);this.__vi.addListener(J,this._onResizePane,this);if(qx.core.Environment.get(bE)){this.__vj=new qx.ui.container.Composite();this.__vj.setLayout(new qx.ui.layout.Canvas());this.__vj.add(this.__vi,{edge:0});this._add(this.__vj,{row:1,column:0});}
else {this._add(this.__vi,{row:1,column:0});}
;this.__vk=this._showChildControl(U);this.__vl=this._showChildControl(p);this.__vm=this.getChildControl(d);this.initShowCellFocusIndicator();this.getChildControl(F).hide();this.addListener(g,this._onMouseout,this);this.addListener(O,this._onAppear,this);this.addListener(bu,this._onDisappear,this);this.__jO=new qx.event.Timer();this.__jO.addListener(w,this._oninterval,this);this.initScrollTimeout();}
,statics:{MIN_COLUMN_WIDTH:10,RESIZE_REGION_RADIUS:5,CLICK_TOLERANCE:5,HORIZONTAL_SCROLLBAR:1,VERTICAL_SCROLLBAR:2},events:{"changeScrollY":q,"changeScrollX":q,"cellClick":bG,"cellDblclick":bG,"cellContextmenu":bG,"beforeSort":q},properties:{horizontalScrollBarVisible:{check:b,init:false,apply:bD,event:i},verticalScrollBarVisible:{check:b,init:false,apply:bv,event:bs},tablePaneModel:{check:br,apply:n,event:bB},liveResize:{check:b,init:false},focusCellOnMouseMove:{check:b,init:false},selectBeforeFocus:{check:b,init:false},showCellFocusIndicator:{check:b,init:true,apply:G},contextMenuFromDataCellsOnly:{check:b,init:true},resetSelectionOnHeaderClick:{check:b,init:true},scrollTimeout:{check:o,init:100,apply:l},appearance:{refine:true,init:S}},members:{__uK:null,__uh:null,__vn:null,__vo:null,__vp:null,__vq:null,__vr:null,__vs:null,__vt:null,__vu:null,__vv:null,__vw:null,__vx:null,__vy:null,__vz:false,__vA:null,__vB:null,__vC:null,__uG:null,__uH:null,__vD:null,__vE:null,__vF:null,__vk:null,__vl:null,__nz:null,__vh:null,__vf:null,__vi:null,__vj:null,__vm:null,__vg:null,__jO:null,getPaneInsetRight:function(){var bM=this.getTopRightWidget();var bN=bM&&bM.isVisible()&&bM.getBounds()?bM.getBounds().width+bM.getMarginLeft()+bM.getMarginRight():0;var bL=this.__vl;var bK=this.getVerticalScrollBarVisible()?this.getVerticalScrollBarWidth()+bL.getMarginLeft()+bL.getMarginRight():0;return Math.max(bN,bK);}
,setPaneWidth:function(bO){if(this.isVerticalScrollBarVisible()){bO+=this.getPaneInsetRight();}
;this.setWidth(bO);}
,_createChildControlImpl:function(bR,bQ){var bP;switch(bR){case I:bP=(this.getTable().getNewTablePaneHeader())(this);break;case bF:bP=(this.getTable().getNewTablePane())(this);break;case d:bP=new qx.ui.table.pane.FocusIndicator(this);bP.setUserBounds(0,0,0,0);bP.setZIndex(1000);bP.addListener(X,this._onMouseupFocusIndicator,this);this.__vi.add(bP);bP.show();bP.setDecorator(null);break;case F:bP=new qx.ui.core.Widget();bP.setUserBounds(0,0,0,0);bP.setZIndex(1000);this.__vi.add(bP);break;case U:bP=this._createScrollBar(Y).set({alignY:k});bP.addListener(c,this._onScrollX,this);if(this.__vj!=null){bP.setMinHeight(qx.ui.core.scroll.AbstractScrollArea.DEFAULT_SCROLLBAR_WIDTH);this.__vj.add(bP,{bottom:0,right:0,left:0});}
else {this._add(bP,{row:2,column:0});}
;break;case p:bP=this._createScrollBar(L);bP.addListener(c,this._onScrollY,this);if(this.__vj!=null){this.__vj.add(bP,{right:0,bottom:0,top:0});}
else {this._add(bP,{row:1,column:1});}
;break;};return bP||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bR);}
,_applyHorizontalScrollBarVisible:function(bT,bS){this.__vk.setVisibility(bT?D:j);}
,_applyVerticalScrollBarVisible:function(bV,bU){this.__vl.setVisibility(bV?D:j);}
...
,_applyShowCellFocusIndicator:function(ca,bY){if(ca){this.__vm.setDecorator(B);this._updateFocusIndicator();}
else {if(this.__vm){this.__vm.setDecorator(null);}
;}
;}
,getScrollY:function(){return this.__vl.getPosition();}
,setScrollY:function(scrollY,cb){this.__vl.scrollTo(scrollY);if(cb){this._updateContent();}
;}
,getScrollX:function(){return this.__vk.getPosition();}
,setScrollX:function(scrollX){this.__vk.scrollTo(scrollX);}
,getTable:function(){return this.__uh;}
,onColVisibilityChanged:function(){this.updateHorScrollBarMaximum();this._updateFocusIndicator();}
,setColumnWidth:function(ce,cd){this.__nz.setColumnWidth(ce,cd);this.__vf.setColumnWidth(ce,cd);var cc=this.getTablePaneModel();var x=cc.getX(ce);if(x!=-1){this.updateHorScrollBarMaximum();this._updateFocusIndicator();}
;}
,onColOrderChanged:function(){this.__nz.onColOrderChanged();this.__vf.onColOrderChanged();this.updateHorScrollBarMaximum();}
,onTableModelDataChanged:function(ci,cg,cj,ch){this.__vf.onTableModelDataChanged(ci,cg,cj,ch);var cf=this.getTable().getTableModel().getRowCount();if(cf!=this.__uK){this.updateVerScrollBarMaximum();if(this.getFocusedRow()>=cf){if(cf==0){this.setFocusedCell(null,null);}
else {this.setFocusedCell(this.getFocusedColumn(),cf-1);}
;}
;this.__uK=cf;}
;}
,onSelectionChanged:function(){this.__vf.onSelectionChanged();}
,onFocusChanged:function(){this.__vf.onFocusChanged();}
,onTableModelMetaDataChanged:function(){this.__nz.onTableModelMetaDataChanged();this.__vf.onTableModelMetaDataChanged();}
,_onPaneModelChanged:function(){this.__nz.onPaneModelChanged();this.__vf.onPaneModelChanged();}
,_onResizePane:function(){this.updateHorScrollBarMaximum();this.updateVerScrollBarMaximum();this._updateContent();this.__nz._updateContent();this.__uh._updateScrollBarVisibility();}
,updateHorScrollBarMaximum:function(){var co=this.__vi.getInnerSize();if(!co){return;}
;var cl=this.getTablePaneModel().getTotalWidth();var cm=this.__vk;if(co.width<cl){var ck=Math.max(0,cl-co.width);cm.setMaximum(ck);cm.setKnobFactor(co.width/cl);var cn=cm.getPosition();cm.setPosition(Math.min(cn,ck));}
else {cm.setMaximum(0);cm.setKnobFactor(1);cm.setPosition(0);}
;}
,updateVerScrollBarMaximum:function(){var cw=this.__vi.getInnerSize();if(!cw){return;}
;var cu=this.getTable().getTableModel();var cq=cu.getRowCount();if(this.getTable().getKeepFirstVisibleRowComplete()){cq+=1;}
;var cp=this.getTable().getRowHeight();var cs=cq*cp;var cv=this.__vl;if(cw.height<cs){var cr=Math.max(0,cs-cw.height);cv.setMaximum(cr);cv.setKnobFactor(cw.height/cs);var ct=cv.getPosition();cv.setPosition(Math.min(ct,cr));}
...
,_onScrollX:function(e){var cx=e.getData();this.fireDataEvent(m,cx,e.getOldData());this.__vh.scrollToX(cx);this.__vi.scrollToX(cx);}
,_onScrollY:function(e){this.fireDataEvent(M,e.getData(),e.getOldData());this._postponedUpdateContent();}
...
;if(qx.event.handler.MouseEmulation.ON){this.__vl.scrollBy(cA);}
else {this.__vl.scrollBySteps(cA);}
;var cy=cA!=0&&!this.__vG(this.__vl,cA);cA=e.getWheelDelta(bC);if(cA>0&&cA<1){cA=1;}
else if(cA<0&&cA>-1){cA=-1;}
;if(qx.event.handler.MouseEmulation.ON){this.__vk.scrollBy(cA);}
else {this.__vk.scrollBySteps(cA);}
;if(this.__vB&&this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(this.__vB,this.__vC);}
;cy=cy||(cA!=0&&!this.__vG(this.__vk,cA));if(cy){e.stop();}
;}
,__vG:function(cC,cD){var cB=cC.getPosition();return (cD<0&&cB<=0)||(cD>0&&cB>=cC.getMaximum());}
,__vH:function(cJ){var cH=this.getTable();var cK=this.__nz.getHeaderWidgetAtColumn(this.__vv);var cE=cK.getSizeHint().minWidth;var cG=Math.max(cE,this.__vx+cJ-this.__vw);if(this.getLiveResize()){var cF=cH.getTableColumnModel();cF.setColumnWidth(this.__vv,cG,true);}
else {this.__nz.setColumnWidth(this.__vv,cG,true);var cI=this.getTablePaneModel();this._showResizeLine(cI.getColumnLeft(this.__vv)+cG);}
;this.__vw+=cG-this.__vx;this.__vx=cG;}
,__vI:function(cM){var cL=qx.ui.table.pane.Scroller.CLICK_TOLERANCE;if(this.__nz.isShowingColumnMoveFeedback()||cM>this.__vu+cL||cM<this.__vu-cL){this.__vr+=cM-this.__vu;this.__nz.showColumnMoveFeedback(this.__vq,this.__vr);var cN=this.__uh.getTablePaneScrollerAtPageX(cM);if(this.__vt&&this.__vt!=cN){this.__vt.hideColumnMoveFeedback();}
;if(cN!=null){this.__vs=cN.showColumnMoveFeedback(cM);}
else {this.__vs=null;}
;this.__vt=cN;this.__vu=cM;}
;}
,_onMousemoveHeader:function(e){var cU=this.getTable();if(!cU.getEnabled()){return;}
;var cV=false;var cO=null;var cS=e.getDocumentLeft();var cT=e.getDocumentTop();this.__vB=cS;this.__vC=cT;if(this.__vv!=null){this.__vH(cS);cV=true;e.stopPropagation();}
else if(this.__vq!=null){this.__vI(cS);e.stopPropagation();}
...
;}
;}
;var cQ=cV?bt:null;this.getApplicationRoot().setGlobalCursor(cQ);this.setCursor(cQ);this.__nz.setMouseOverColumn(cO);}
,_onMousemovePane:function(e){var cX=this.getTable();if(!cX.getEnabled()){return;}
;var da=e.getDocumentLeft();var db=e.getDocumentTop();this.__vB=da;this.__vC=db;var cY=this._getRowForPagePos(da,db);if(cY!=null&&this._getColumnForPageX(da)!=null){if(this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(da,db);}
;}
;this.__nz.setMouseOverColumn(null);}
...
;}
;}
,_startResizeHeader:function(dh,df){var dg=this.getTable().getTableColumnModel();this.__vv=dh;this.__vw=df;this.__vx=dg.getColumnWidth(this.__vv);this.__vh.capture();}
,_startMoveHeader:function(di,dj){this.__vq=di;this.__vu=dj;this.__vr=this.getTablePaneModel().getColumnLeft(di);this.__vh.capture();}
,_onMousedownPane:function(e){var dn=this.getTable();if(!dn.getEnabled()){return;}
;if(dn.isEditing()){dn.stopEditing();}
;var dl=e.getDocumentLeft();var dm=e.getDocumentTop();var dq=this._getRowForPagePos(dl,dm);var dp=this._getColumnForPageX(dl);if(dq!==null){this.__vy={row:dq,col:dp};this.__vz=false;var dk=this.getSelectBeforeFocus();if(dk){dn.getSelectionManager().handleMouseDown(dq,e);}
;if(!this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(dl,dm);}
;if(!dk){dn.getSelectionManager().handleMouseDown(dq,e);}
;}
;}
,_onMouseupFocusIndicator:function(e){if(this.__vy&&!this.__vz&&!this.isEditing()&&this.__vm.getRow()==this.__vy.row&&this.__vm.getColumn()==this.__vy.col){this.fireEvent(bx,qx.ui.table.pane.CellEvent,[this,e,this.__vy.row,this.__vy.col],true);this.__vz=true;}
else if(!this.isEditing()){this._onMousedownPane(e);}
;}
,_onChangeCaptureHeader:function(e){if(this.__vv!=null){this._stopResizeHeader();}
;if(this.__vq!=null){this._stopMoveHeader();}
;}
,_stopResizeHeader:function(){var dr=this.getTable().getTableColumnModel();if(!this.getLiveResize()){this._hideResizeLine();dr.setColumnWidth(this.__vv,this.__vx,true);}
;this.__vv=null;this.__vh.releaseCapture();this.getApplicationRoot().setGlobalCursor(null);this.setCursor(null);if(this.isEditing()){var ds=this.__vD.getBounds().height;this.__vD.setUserBounds(0,0,this.__vx,ds);}
;}
,_stopMoveHeader:function(){var dx=this.getTable().getTableColumnModel();var dy=this.getTablePaneModel();this.__nz.hideColumnMoveFeedback();if(this.__vt){this.__vt.hideColumnMoveFeedback();}
;if(this.__vs!=null){var dA=dy.getFirstColumnX()+dy.getX(this.__vq);var dw=this.__vs;if(dw!=dA&&dw!=dA+1){var dz=dx.getVisibleColumnAtX(dA);var dv=dx.getVisibleColumnAtX(dw);var du=dx.getOverallX(dz);var dt=(dv!=null)?dx.getOverallX(dv):dx.getOverallColumnCount();if(dt>du){dt-- ;}
;dx.moveColumn(du,dt);this._updateFocusIndicator();}
;}
;this.__vq=null;this.__vs=null;this.__vh.releaseCapture();}
...
;if(this.__vv!=null){this._stopResizeHeader();this.__vA=true;e.stop();}
else if(this.__vq!=null){this._stopMoveHeader();e.stop();}
;}
,_onClickHeader:function(e){if(this.__vA){this.__vA=false;return;}
...
;var dM=e.getDocumentLeft();var dN=e.getDocumentTop();var dQ=this._getRowForPagePos(dM,dN);var dP=this._getColumnForPageX(dM);if(dQ!=null&&dP!=null){dO.getSelectionManager().handleClick(dQ,e);if(this.__vm.isHidden()||(this.__vy&&!this.__vz&&!this.isEditing()&&dQ==this.__vy.row&&dP==this.__vy.col)){this.fireEvent(bx,qx.ui.table.pane.CellEvent,[this,e,dQ,dP],true);this.__vz=true;}
;}
;}
...
;if(!this.getShowCellFocusIndicator()||dV===null||(this.__vy&&dV==this.__vy.row&&dU==this.__vy.col)){this.fireEvent(bH,qx.ui.table.pane.CellEvent,[this,e,dV,dU],true);var dR=this.getTable().getContextMenu();if(dR){if(dR.getChildren().length>0){dR.openAtMouse(e);}
else {dR.exclude();}
;e.preventDefault();}
;}
;}
,_onContextMenuOpen:function(e){}
,_onDblclickPane:function(e){var dX=e.getDocumentLeft();var dY=e.getDocumentTop();this._focusCellAtPagePos(dX,dY);this.startEditing();var dW=this._getRowForPagePos(dX,dY);if(dW!=-1&&dW!=null){this.fireEvent(V,qx.ui.table.pane.CellEvent,[this,e,dW],true);}
;}
,_onMouseout:function(e){var ea=this.getTable();if(!ea.getEnabled()){return;}
;if(this.__vv==null){this.setCursor(null);this.getApplicationRoot().setGlobalCursor(null);}
;this.__nz.setMouseOverColumn(null);if(this.getFocusCellOnMouseMove()){this.__uh.setFocusedCell();}
;}
,_showResizeLine:function(x){var ec=this._showChildControl(F);var eb=ec.getWidth();var ed=this.__vi.getBounds();ec.setUserBounds(x-Math.round(eb/2),0,eb,ed.height);}
,_hideResizeLine:function(){this._excludeChildControl(F);}
,showColumnMoveFeedback:function(em){var en=this.getTablePaneModel();var eg=this.getTable().getTableColumnModel();var eh=this.__vf.getContentLocation().left;var el=en.getColumnCount();var ei=0;var eq=0;var ef=eh;for(var ee=0;ee<el;ee++ ){var ep=en.getColumnAtX(ee);var eo=eg.getColumnWidth(ep);if(em<ef+eo/2){break;}
;ef+=eo;ei=ee+1;eq=ef-eh;}
;var ek=this.__vi.getContentLocation().left;var ej=this.__vi.getBounds().width;var scrollX=ek-eh;eq=qx.lang.Number.limit(eq,scrollX+2,scrollX+ej-1);this._showResizeLine(eq);return en.getFirstColumnX()+ei;}
,hideColumnMoveFeedback:function(){this._hideResizeLine();}
,_focusCellAtPagePos:function(et,er){var eu=this._getRowForPagePos(et,er);if(eu!=-1&&eu!=null){var es=this._getColumnForPageX(et);this.__uh.setFocusedCell(es,eu);}
;}
,setFocusedCell:function(ev,ew){if(!this.isEditing()){this.__vf.setFocusedCell(ev,ew,this.__vo);this.__uG=ev;this.__uH=ew;this._updateFocusIndicator();}
;}
,getFocusedColumn:function(){return this.__uG;}
,getFocusedRow:function(){return this.__uH;}
,scrollCellVisible:function(eJ,eK){var eH=this.getTablePaneModel();var ex=eH.getX(eJ);if(ex!=-1){var eE=this.__vi.getInnerSize();if(!eE){return;}
...
;}
,isEditing:function(){return this.__vD!=null;}
,startEditing:function(){var eP=this.getTable();var eN=eP.getTableModel();var eR=this.__uG;if(!this.isEditing()&&(eR!=null)&&eN.isColumnEditable(eR)){var eQ=this.__uH;var eL=this.getTablePaneModel().getX(eR);var eM=eN.getValue(eR,eQ);this.scrollCellVisible(eL,eQ);this.__vE=eP.getTableColumnModel().getCellEditorFactory(eR);var eO={col:eR,row:eQ,xPos:eL,value:eM,table:eP};this.__vD=this.__vE.createCellEditor(eO);if(this.__vD===null){return false;}
else if(this.__vD instanceof qx.ui.window.Window){this.__vD.setModal(true);this.__vD.setShowClose(false);this.__vD.addListener(bA,this._onCellEditorModalWindowClose,this);var f=eP.getModalCellEditorPreOpenFunction();if(f!=null){f(this.__vD,eO);}
;this.__vD.open();}
else {var eS=this.__vm.getInnerSize();this.__vD.setUserBounds(0,0,eS.width,eS.height);this.__vm.addListener(a,function(e){this.__vy={row:this.__uH,col:this.__uG};e.stopPropagation();}
,this);this.__vm.add(this.__vD);this.__vm.addState(N);this.__vm.setKeepActive(false);this.__vm.setDecorator(B);this.__vD.focus();this.__vD.activate();}
;return true;}
;return false;}
,stopEditing:function(){if(!this.getShowCellFocusIndicator()){this.__vm.setDecorator(null);}
;this.flushEditor();this.cancelEditing();}
,flushEditor:function(){if(this.isEditing()){var eT=this.__vE.getCellEditorValue(this.__vD);var eU=this.getTable().getTableModel().getValue(this.__uG,this.__uH);this.getTable().getTableModel().setValue(this.__uG,this.__uH,eT);this.__uh.focus();this.__uh.fireDataEvent(t,{row:this.__uH,col:this.__uG,oldValue:eU,value:eT});}
;}
,cancelEditing:function(){if(this.isEditing()&&!this.__vD.pendingDispose){if(this._cellEditorIsModalWindow){this.__vD.destroy();this.__vD=null;this.__vE=null;this.__vD.pendingDispose=true;}
else {this.__vm.removeState(N);this.__vm.setKeepActive(true);this.__vD.destroy();this.__vD=null;this.__vE=null;}
;}
;}
,_onCellEditorModalWindowClose:function(e){this.stopEditing();}
,_getColumnForPageX:function(eV){var eY=this.getTable().getTableColumnModel();var fa=this.getTablePaneModel();var eX=fa.getColumnCount();var eW=this.__vf.getContentLocation().left;for(var x=0;x<eX;x++ ){var fc=fa.getColumnAtX(x);var fb=eY.getColumnWidth(fc);eW+=fb;if(eV<eW){return fc;}
;}
;return null;}
,_getResizeColumnForPageX:function(fe){var fh=this.getTable().getTableColumnModel();var fi=this.getTablePaneModel();var fg=fi.getColumnCount();var ff=this.__nz.getContentLocation().left;var fd=qx.ui.table.pane.Scroller.RESIZE_REGION_RADIUS;for(var x=0;x<fg;x++ ){var fk=fi.getColumnAtX(x);var fj=fh.getColumnWidth(fk);ff+=fj;if(fe>=(ff-fd)&&fe<=(ff+fd)){return fk;}
;}
;return -1;}
,_getRowForPagePos:function(fr,fs){var fl=this.__vf.getContentLocation();if(fr<fl.left||fr>fl.right){return null;}
;if(fs>=fl.top&&fs<=fl.bottom){var fm=this.getTable().getRowHeight();var scrollY=this.__vl.getPosition();if(this.getTable().getKeepFirstVisibleRowComplete()){scrollY=Math.floor(scrollY/fm)*fm;}
...
;var fo=this.__nz.getContentLocation();if(fs>=fo.top&&fs<=fo.bottom&&fr<=fo.right){return -1;}
;return null;}
,setTopRightWidget:function(fu){var fv=this.__vF;if(fv!=null){this.__vg.remove(fv);}
;if(fu!=null){this.__vg.add(fu);}
;this.__vF=fu;}
,getTopRightWidget:function(){return this.__vF;}
,getHeader:function(){return this.__nz;}
,getTablePane:function(){return this.__vf;}
,getVerticalScrollBarWidth:function(){var fw=this.__vl;return fw.isVisible()?(fw.getSizeHint().width||0):0;}
,getNeededScrollBars:function(fA,fB){var fM=this.__vl;var fL=fM.getSizeHint().width+fM.getMarginLeft()+fM.getMarginRight();var fG=this.__vk;var fJ=fG.getSizeHint().height+fG.getMarginTop()+fG.getMarginBottom();var fD=this.__vi.getInnerSize();var fx=fD?fD.width:0;if(this.getVerticalScrollBarVisible()){fx+=fL;}
...
,getPaneClipper:function(){return this.__vi;}
,_applyScrollTimeout:function(fP,fO){this._startInterval(fP);}
,_startInterval:function(fQ){this.__jO.setInterval(fQ);this.__jO.start();}
,_stopInterval:function(){this.__jO.stop();}
,_postponedUpdateContent:function(){this._updateContent();}
,_oninterval:qx.event.GlobalError.observeMethod(function(){if(this.__vo&&!this.__vf._layoutPending){this.__vo=false;this._updateContent();}
;}
),_updateContent:function(){var fY=this.__vi.getInnerSize();if(!fY){return;}
;var fW=fY.height;var scrollX=this.__vk.getPosition();var scrollY=this.__vl.getPosition();var fS=this.getTable().getRowHeight();var fU=Math.floor(scrollY/fS);var fX=this.__vf.getFirstVisibleRow();this.__vf.setFirstVisibleRow(fU);var fT=Math.ceil(fW/fS);var fR=0;var fV=this.getTable().getKeepFirstVisibleRowComplete();if(!fV){fT++ ;fR=scrollY%fS;}
;this.__vf.setVisibleRowCount(fT);if(fU!=fX){this._updateFocusIndicator();}
;this.__vi.scrollToX(scrollX);if(!fV){this.__vi.scrollToY(fR);}
;}
,_updateFocusIndicator:function(){var ga=this.getTable();if(!ga.getEnabled()){return;}
;this.__vm.moveToCell(this.__uG,this.__uH);}
},destruct:function(){this._stopInterval();var gb=this.getTablePaneModel();if(gb){gb.dispose();}
;this.__vy=this.__vF=this.__uh=null;this._disposeObjects(s,P,u,W,A,K,y,C,bw,h);}
});}
)();
...
(function(){var a="Escape",b="keypress",c="Enter",d="excluded",f="Integer",g="qx.ui.table.pane.FocusIndicator";qx.Class.define(g,{extend:qx.ui.container.Composite,construct:function(h){qx.ui.container.Composite.call(this);this.__vJ=h;this.setKeepActive(true);this.addListener(b,this._onKeyPress,this);}
,properties:{visibility:{refine:true,init:d},row:{check:f,nullable:true},column:{check:f,nullable:true}},members:{__vJ:null,_onKeyPress:function(e){var i=e.getKeyIdentifier();if(i!==a&&i!==c){e.stopPropagation();}
;}
,moveToCell:function(p,q){if(!this.__vJ.getShowCellFocusIndicator()&&!this.__vJ.getTable().getTableModel().isColumnEditable(p)){this.exclude();return;}
else {this.show();}
;if(p==null){this.hide();this.setRow(null);this.setColumn(null);}
else {var j=this.__vJ.getTablePaneModel().getX(p);if(j==-1){this.hide();this.setRow(null);this.setColumn(null);}
else {var o=this.__vJ.getTable();var m=o.getTableColumnModel();var n=this.__vJ.getTablePaneModel();var l=this.__vJ.getTablePane().getFirstVisibleRow();var k=o.getRowHeight();this.setUserBounds(n.getColumnLeft(p)-2,(q-l)*k-2,m.getColumnWidth(p)+3,k+3);this.show();this.setRow(q);this.setColumn(p);}
;}
;}
...
,events:{"modelChanged":b},statics:{EVENT_TYPE_MODEL_CHANGED:c},properties:{firstColumnX:{check:f,init:0,apply:d},maxColumnCount:{check:a,init:-1,apply:h}},members:{__vK:null,__vL:null,_applyFirstColumnX:function(l,k){this.__vK=null;this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,_applyMaxColumnCount:function(n,m){this.__vK=null;this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,setTableColumnModel:function(o){if(this.__vL){this.__vL.removeListener(i,this._onColVisibilityChanged,this);this.__vL.removeListener(e,this._onColVisibilityChanged,this);}
;this.__vL=o;this.__vL.addListener(i,this._onColVisibilityChanged,this);this.__vL.addListener(e,this._onHeaderCellRendererChanged,this);this.__vK=null;}
,_onColVisibilityChanged:function(p){this.__vK=null;this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,_onHeaderCellRendererChanged:function(q){this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);}
,getColumnCount:function(){if(this.__vK==null){var r=this.getFirstColumnX();var t=this.getMaxColumnCount();var s=this.__vL.getVisibleColumnCount();if(t==-1||(r+t)>s){this.__vK=s-r;}
else {this.__vK=t;}
;}
;return this.__vK;}
,getColumnAtX:function(v){var u=this.getFirstColumnX();return this.__vL.getVisibleColumnAtX(u+v);}
,getX:function(z){var w=this.getFirstColumnX();var y=this.getMaxColumnCount();var x=this.__vL.getVisibleX(z)-w;if(x>=0&&(y==-1||x<y)){return x;}
else {return -1;}
;}
,getColumnLeft:function(D){var B=0;var C=this.getColumnCount();for(var x=0;x<C;x++ ){var A=this.getColumnAtX(x);if(A==D){return B;}
;B+=this.__vL.getColumnWidth(A);}
;return -1;}
,getTotalWidth:function(){var E=0;var F=this.getColumnCount();for(var x=0;x<F;x++ ){var G=this.getColumnAtX(x);E+=this.__vL.getColumnWidth(G);}
;return E;}
},destruct:function(){if(this.__vL){this.__vL.removeListener(i,this._onColVisibilityChanged,this);this.__vL.removeListener(e,this._onColVisibilityChanged,this);}
;this.__vL=null;}
});}
)();
