...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.d26268f01752.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__np=document||window.document;this.__Hl();var self=this;qx.bom.Event.addNativeListener(this.__np,this.__Hk,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__np:null,__Hi:null,__Hj:null,__Hk:null,__Hl:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__np[m]!=undefined){this.__Hi=m;this.__Hk=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__np[m]!=undefined){this.__Hj=m;break;}
;}
;if(this.__Hi==null){this.__Hi=k;this.__Hk=c;}
;if(this.__Hj==null){this.__Hj=b;}
;}
,isHidden:function(){return !!this.__np[this.__Hi];}
,getVisibilityState:function(){return this.__np[this.__Hj]||d;}
}});}
)();
