...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SelectBox.095156f5f731.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_handleKeyboard:function(event){var T=this._getAction(event);switch(T){case q:this.__xY+=this.__yb(event.getKeyIdentifier());this.__xX.restart();break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
...
,__ya:function(){this.__xX.stop();var Y=this.__xY;if(Y==null||Y==s){return;}
...
;}
;this.__xY=s;}
,__yb:function(bi){if(bi===f){return B;}
else {return bi;}
;}
},destruct:function(){this._removeBindings();this.__xX.removeListener(l,this.__ya,this);this.__xX.dispose();this.__xX=null;}
});}
)();
