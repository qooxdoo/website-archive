...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery.2581f33e9b67.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_generateItems:function(bg){var bj=[];var bm=[s,y,x,P,m];var bk=qx.util.AliasManager.getInstance();var bi=qx.util.ResourceManager.getInstance();for(var i=0;i<bg;i++ ){var bn=C+bm[Math.floor(Math.random()*bm.length)];var bh=bk.resolve(bn);var bl=bi.toUri(bh);bj[i]={label:N+(i+1),icon:bn,resolvedIcon:bl};}
;return bj;}
...
;}
}});qx.Class.define(f,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bv){demobrowser.demo.virtual.AbstractGallery.call(this,bv);this.__RE=new demobrowser.demo.virtual.GalleryCell();}
,members:{__RE:null,_createScroller:function(){var bw=new qx.ui.virtual.core.Scroller(1,this.itemPerLine,this.itemHeight,this.itemWidth);this.layer=new qx.ui.virtual.layer.WidgetCell(this);bw.getPane().addLayer(this.layer);new qx.ui.virtual.behavior.Prefetch(bw,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:200,maxAbove:300,minBelow:600,maxBelow:800}).set({interval:500});return bw;}
...
;if(by){this.__RE.updateStates(bx,{selected:1});}
else {this.__RE.updateStates(bx,{});}
;}
;}
...
;var bE=this.__RE.getCellWidget(bF,bD);bE.setUserData(n,bH);return bE;}
,poolCellWidget:function(bJ){this.__RE.pool(bJ);}
...
(function(){var a="_applyInterval",b="__jO",c="appear",d="qx.debug",e="interval",f="qx.ui.virtual.behavior.Prefetch",g="scroll",h="_applyScroller",i="qx.ui.virtual.core.Scroller",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(f,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(d)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__jO=new qx.event.Timer(this.getInterval());this.__jO.addListener(e,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__HK:null,__HL:null,__jO:null,__HM:null,__HN:null,setPrefetchX:function(o,r,p,q){this.__HK=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__HL=[v,u,t,s];}
,_onInterval:function(){var w=this.__HK;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__HL;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__HM){y.getChildControl(j).removeListenerById(this.__HM);}
;if(this.__HN){y.getChildControl(l).removeListenerById(this.__HN);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__jO.stop();z.addListenerOnce(c,this.__jO.start,this.__jO);}
else {this.__jO.restart();}
;this.__HM=z.getChildControl(j).addListener(g,this.__jO.restart,this.__jO);this.__HN=z.getChildControl(l).addListener(g,this.__jO.restart,this.__jO);}
else {this.__jO.stop();}
;}
,_applyInterval:function(B,A){this.__jO.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__HK=this.__HL=null;this._disposeObjects(b);}
});}
)();
