...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.0f83ddba2b7a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Boolean",b="one",c="selected",d="_applySpacing",f="qx.event.type.Data",g="Integer",h="_applyDragSelection",k="changeSelection",m="String",n="resize",o="demobrowser.demo.virtual.list.List",p="list",q="multi",r="row",s="_applyQuickSelection",t="single",u="_applyItemHeight",v="_applySelectionMode",w="additive",x="changeName",y="Number",z="addItem",A="removeItem",B="changeHeight",C=",";qx.Class.define(o,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__Rq=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__Rq);this.getPane().addListener(n,this._onResize,this);this.__ru=[];this.__cM=[];this.__uF=new qx.ui.virtual.selection.Row(this.getPane());this.__uF.addListener(k,this._onChangeSelection,this);this.__uF.attachMouseEvents();this.__uF.attachKeyEvents(this);this.__uF.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:f,removeItem:f,changeValue:f,changeSelection:f},properties:{appearance:{refine:true,init:p},focusable:{refine:true,init:true},spacing:{check:g,init:0,apply:d,themeable:true},enableInlineFind:{check:a,init:true},name:{check:m,nullable:true,event:x},itemHeight:{init:24,themeable:true,check:y,apply:u},selectionMode:{check:[t,q,w,b],init:t,apply:v},dragSelection:{check:a,init:false,apply:h},quickSelection:{check:a,init:false,apply:s}},members:{__ru:null,__cM:null,__uF:null,__Rq:null,syncWidget:function(){this.update();}
,update:function(){var D=this.getPane().getRowConfig();D.setItemCount(this.__ru.length);D.resetItemSizes();for(var i=0;i<this.__ru.length;i++ ){var E=this.__ru[i].getHeight();if(E!==null){D.setItemSize(i,E);}
;}
;}
,updateSelection:function(){var F=this.__Rq.getChildren();for(var i=0;i<F.length;i++ ){var G=F[i];var H=G.getUserData(r);if(this.__uF.isItemSelected(H)){G.addState(c);}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(k,this.__Ru(e.getData()));}
,getCellWidget:function(L,I){var K=this.__ru[L];if(!K){return null;}
;var J=this.__cM.pop()||new qx.ui.form.ListItem();J.set({label:K.getLabel(),icon:K.getIcon()});if(this.__uF.isItemSelected(L)){J.addState(c);}
...
;this.setSelection(S);}
,getChildren:function(){return this.__ru;}
,hasChildren:function(){return this.__ru.length>0;}
...
,add:function(W){this.__ru.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__ru,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__ru.length;i<j;i++ ){this._removeHelper(this.__ru[i]);}
;this.__ru=[];}
,indexOf:function(Y){return this.__ru.indexOf(Y);}
,addAt:function(bb,ba){qx.lang.Array.insertAt(this.__ru,bb,ba);this._addHelper(bb);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__ru,bc,bd);this._addHelper(bc);}
,addAfter:function(bf,be){qx.lang.Array.insertAfter(this.__ru,bf,be);this._addHelper(bf);}
,removeAt:function(bg){this.__ru.splice(bg,1);this._removeHelper(this.__ru[bg]);}
,__Rr:function(bh){var bi=this.__ru.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__Rs:function(bk){var bj=this.__ru[bk];return bj;}
,__Rt:function(bl){var bm=[];for(var i=0;i<bl.length;i++ ){bm.push(this.__Rr(bl[i]));}
;return bm;}
,__Ru:function(bo){var bn=[];for(var i=0;i<bo.length;i++ ){bn.push(this.__ru[bo[i]]);}
;return bn;}
,selectAll:function(){this.__uF.selectAll();}
,setSelected:function(bp){this.__uF.selectItem(this.__Rr(bp));}
,isSelected:function(bq){return this.__uF.isItemSelected(this.__Rr(bq));}
,addToSelection:function(br){this.__uF.addItem(this.__Rr(br));}
,removeFromSelection:function(bs){this.__uF.removeItem(this.__Rr(bs));}
,selectRange:function(bt,bu){this.__uF.selectItemRange(this.__Rr(bt),this.__Rr(bu));}
,resetSelection:function(){this.__uF.clearSelection();}
,setSelection:function(bv){this.__uF.replaceSelection(this.__Rt(bv));}
,getSelectedItem:function(){return this.__ru[this.getSelected()];}
,getSelected:function(){return this.__ru[this.__uF.getSelectedItem()];}
,getSelection:function(){return this.__Ru(this.__uF.getSelection());}
,getSortedSelection:function(){return this.__Ru(this.__uF.getSortedSelection());}
,isSelectionEmpty:function(){return this.__uF.isSelectionEmpty();}
,getSelectionContext:function(){return this.__uF.getSelectionContext();}
,getSelectables:function(){return this.__Ru(this.__uF.getSelectables());}
,_applySelectionMode:function(bx,bw){this.__uF.setMode(bx);}
,_applyDragSelection:function(bz,by){this.__uF.setDrag(bz);}
,_applyQuickSelection:function(bB,bA){this.__uF.setQuick(bB);}
}});}
)();
