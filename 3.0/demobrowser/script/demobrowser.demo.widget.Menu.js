...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu.42b45bd72635.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Online Forum",b="New",c="icon/16/actions/edit-cut.png",d="icon/16/actions/format-justify-fill.png",f="Search in files",g="C",h="__RV",j="changeValue",k="Left aligned",l="Undo",m="Perl",n="View",o="C Dialect",p="changeSelection",q="Info...",r="Save as...",s="Show line numbers",t="icon/16/actions/document-save.png",u="Quickstart",v="icon/16/actions/contact-new.png",w="Ctrl+N",x="__RW",y="icon/16/actions/edit-paste.png",z="Actions",A="Show console",B="Search",C="Help",D="Redo",E="Show status bar",F="icon/16/actions/format-justify-left.png",G="ANSI to OEM",H="Centered",I="Website 3",J="icon/22/apps/preferences-users.png",K="Edit",L="icon/16/actions/format-justify-center.png",M="Ctrl+O",N="icon/16/actions/document-print.png",O="icon/16/actions/go-previous.png",P="icon/16/actions/document-open.png",Q="C Sharp",R="icon/16/actions/edit-undo.png",S="Close",T="Split Button",U="Website 2",V="icon/16/actions/document-save-as.png",W="Python",X="icon/16/apps/utilities-help.png",Y="Show tree",cM="Options",cN="Spaces to tabs",cO="Right aligned",cI="Action 1",cJ="OEM to ANSI",cK="Line 431",cL="JavaScript",cT="icon",cU="Action 2",cV="__RT",cW="Folder ",cP="XML",cQ="Line 313",cR="Save",cS="Paragraph",db="demobrowser.demo.widget.Menu",dD="icon/16/actions/application-exit.png",er="C Plus Plus",dc="Line 26",cX="Item ",cY="ASCII table",en="Option 1",da="Search next...",dd="Line 12",de="Action 3",df="Replace in files",dk="__RU",dl="Uppercase",dm="Ctrl+P",dg="Topics",dh="Panes",di="Justified",dj="Ctrl+X",dr="icon/16/actions/edit-redo.png",ds="Search previous...",dt="Change selection: ",du="__RS",dn="Back",dp="main",eo="Copy",dq=" = ",dy="Paste",dz="Execute command: ",eq="Show ruler",dA="icon/16/actions/format-justify-right.png",dv="icon/16/actions/go-next.png",dw="Ctrl+Z",ep="command ",dx="Option 3",dB="Next",dC="Ctrl+R",dO="Show macros",dN="Show tags",dM="Capitals",dS="Execute button: ",dR="Format",dQ="File",dP="Change checked: ",dH="Show tabs",dG="__RX",dF="Print",dE="execute",dL="icon/16/actions/edit-copy.png",dK="Cut",dJ="__Ci",dI="Tabs to spaces",ea="Search...",dY="Line 1039",dX="Option 2",dW="Open",ee="Objective C",ed="Exit",ec="move to",eb="icon/16/actions/system-search.png",dV="Ctrl+S",dU="Syntax",dT="__Cp",ei="Ctrl+C",eh="Website 1",eg="Menu Button",em="icon/16/actions/document-new.png",el="Line 30",ek="Lowercase",ej="Replace",ef="HTML";qx.Class.define(db,{extend:qx.application.Standalone,members:{__RS:null,__RT:null,__RU:null,__Ci:null,__Cp:null,__RV:null,__RW:null,__RX:null,main:function(){qx.application.Standalone.prototype.main.call(this);var et=new qx.ui.container.Scroll();var es=new qx.ui.container.Composite(new qx.ui.layout.Canvas);es.setPadding(20);es.setAllowStretchX(false);et.add(es);this.getRoot().add(et,{edge:0});this.createCommands();es.add(this.getMenuButton(),{left:20,top:20});es.add(this.getSplitButton(),{left:150,top:20});es.add(this.getMenuBar(),{left:20,top:100});es.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
,getRootContextMenu:function(){var eu=new qx.ui.menu.Menu();var ev=new qx.ui.menu.Menu();for(var i=0;i<30;i++ ){ev.add(new qx.ui.menu.Button(cW+(i+1)));}
;eu.add(new qx.ui.menu.Button(ec,null,null,ev));eu.add(new qx.ui.menu.Separator());for(var i=0;i<7;i++ ){eu.add(new qx.ui.menu.Button(ep+(i+1)));}
;return eu;}
,debugRadio:function(e){this.debug(dt+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(dz+this.getShortcut());}
,debugButton:function(e){this.debug(dS+this.getLabel());}
,debugCheckBox:function(e){this.debug(dP+this.getLabel()+dq+e.getData());}
,createCommands:function(){this.__RS=new qx.ui.core.Command(w);this.__RS.addListener(dE,this.debugCommand);this.__RT=new qx.ui.core.Command(M);this.__RT.addListener(dE,this.debugCommand);this.__RU=new qx.ui.core.Command(dV);this.__RU.addListener(dE,this.debugCommand);this.__Ci=new qx.ui.core.Command(dw);this.__Ci.addListener(dE,this.debugCommand);this.__Cp=new qx.ui.core.Command(dC);this.__Cp.addListener(dE,this.debugCommand);this.__RV=new qx.ui.core.Command(dj);this.__RV.addListener(dE,this.debugCommand);this.__RW=new qx.ui.core.Command(ei);this.__RW.addListener(dE,this.debugCommand);this.__RX=new qx.ui.core.Command(dm);this.__RX.addListener(dE,this.debugCommand);this.__RX.setEnabled(false);}
,getMenuButton:function(){var ew=new qx.ui.menu.Menu;ew.add(new qx.ui.menu.RadioButton(en));ew.add(new qx.ui.menu.RadioButton(dX));ew.add(new qx.ui.menu.RadioButton(dx));var eE=new qx.ui.menu.Menu;eE.add(new qx.ui.menu.RadioButton(cI));eE.add(new qx.ui.menu.RadioButton(cU));eE.add(new qx.ui.menu.RadioButton(de));var eD=new qx.ui.form.RadioGroup;eD.add.apply(eD,ew.getChildren());eD.addListener(p,this.debugRadio);var eB=new qx.ui.form.RadioGroup;eB.add.apply(eB,eE.getChildren());eB.addListener(p,this.debugRadio);var ez=new qx.ui.menu.Menu();var eC=new qx.ui.menu.Button(l,R,this.__Ci);var eJ=new qx.ui.menu.Button(D,dr,this.__Cp);var ey=new qx.ui.menu.Button(dK,c,this.__RV);var eG=new qx.ui.menu.Button(eo,dL,this.__RW);var eA=new qx.ui.menu.Button(dy,y,this.__RX);var ex=new qx.ui.menu.Button(cM,eb,null,ew);var eH=new qx.ui.menu.Button(z,v,null,eE);var eF=new qx.ui.menu.Button(dF,N);eC.addListener(dE,this.debugButton);eJ.addListener(dE,this.debugButton);ey.addListener(dE,this.debugButton);eG.addListener(dE,this.debugButton);eA.addListener(dE,this.debugButton);ex.addListener(dE,this.debugButton);eH.addListener(dE,this.debugButton);eF.addListener(dE,this.debugButton);ez.add(eC);ez.add(eJ);ez.addSeparator();ez.add(ey);ez.add(eG);ez.add(eA);ez.addSeparator();ez.add(ex);ez.add(eH);ez.addSeparator();ez.add(eF);var eI=new qx.ui.form.MenuButton(eg,J,ez);return eI;}
,getSplitButton:function(){var eK=new qx.ui.menu.Menu;var eO=new qx.ui.menu.Button(eh);var eM=new qx.ui.menu.Button(U);var eN=new qx.ui.menu.Button(I);eK.setMinWidth(120);eO.addListener(dE,this.debugButton);eM.addListener(dE,this.debugButton);eN.addListener(dE,this.debugButton);eK.add(eO);eK.add(eM);eK.add(eN);var eL=new qx.ui.form.SplitButton(T,J,eK);eL.addListener(dE,this.debugButton);return eL;}
,getMenuBar:function(){var eS=new qx.ui.container.Composite(new qx.ui.layout.Grow);eS.setDecorator(dp);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);eS.add(toolbar);var fc=new qx.ui.toolbar.Part;var eR=new qx.ui.toolbar.Part;var eV=new qx.ui.toolbar.Part;toolbar.add(fc);toolbar.add(eR);toolbar.addSpacer();toolbar.add(eV);var fb=new qx.ui.toolbar.SplitButton(dn,O,this.getBackMenu());var fe=new qx.ui.toolbar.SplitButton(dB,dv,this.getForwardMenu());var eW=new qx.ui.toolbar.Button(b,em,this.__RS);var eU=new qx.ui.toolbar.Button(dW,P,this.__RT);var fa=new qx.ui.toolbar.Button(cR,t,this.__RU);fb.addListener(dE,this.debugButton);fe.addListener(dE,this.debugButton);eW.addListener(dE,this.debugButton);eU.addListener(dE,this.debugButton);fa.addListener(dE,this.debugButton);fc.add(fb);fc.add(fe);fc.addSeparator();fc.add(eW);fc.add(eU);fc.add(fa);fc.setShow(cT);var eT=new qx.ui.toolbar.MenuButton(dQ);var eP=new qx.ui.toolbar.MenuButton(K);var eQ=new qx.ui.toolbar.MenuButton(B);var fd=new qx.ui.toolbar.MenuButton(n);var eY=new qx.ui.toolbar.MenuButton(dR);eT.setMenu(this.getFileMenu());eP.setMenu(this.getEditMenu());eQ.setMenu(this.getSearchMenu());fd.setMenu(this.getViewMenu());eY.setMenu(this.getFormatMenu());eR.add(eT);eR.add(eP);eR.add(eQ);eR.add(fd);eR.add(eY);var eX=new qx.ui.toolbar.MenuButton(C);eX.setMenu(this.getHelpMenu());eV.add(eX);return eS;}
,getBackMenu:function(){var fg=new qx.ui.menu.Menu;var fh=new qx.ui.menu.Button(cQ);var fj=new qx.ui.menu.Button(dY);var ff=new qx.ui.menu.Button(dd);var fi=new qx.ui.menu.Button(dc);fh.addListener(dE,this.debugButton);fj.addListener(dE,this.debugButton);ff.addListener(dE,this.debugButton);fi.addListener(dE,this.debugButton);fg.add(fh);fg.add(fj);fg.add(ff);fg.add(fi);return fg;}
,getForwardMenu:function(){var fk=new qx.ui.menu.Menu;var fl=new qx.ui.menu.Button(cK);var fm=new qx.ui.menu.Button(el);fl.addListener(dE,this.debugButton);fm.addListener(dE,this.debugButton);fk.add(fl);fk.add(fm);return fk;}
,getFileMenu:function(){var fp=new qx.ui.menu.Menu;var fn=new qx.ui.menu.Button(b,em,this.__RS);var fr=new qx.ui.menu.Button(dW,P,this.__RT);var fq=new qx.ui.menu.Button(S);var fu=new qx.ui.menu.Button(cR,t,this.__RU);var ft=new qx.ui.menu.Button(r,V);var fo=new qx.ui.menu.Button(dF,N);var fs=new qx.ui.menu.Button(ed,dD);fn.addListener(dE,this.debugButton);fr.addListener(dE,this.debugButton);fq.addListener(dE,this.debugButton);fu.addListener(dE,this.debugButton);ft.addListener(dE,this.debugButton);fo.addListener(dE,this.debugButton);fs.addListener(dE,this.debugButton);fp.add(fn);fp.add(fr);fp.add(fq);fp.add(fu);fp.add(ft);fp.add(fo);fp.add(fs);return fp;}
,getEditMenu:function(){var fw=new qx.ui.menu.Menu;var fz=new qx.ui.menu.Button(l,R,this.__Ci);var fy=new qx.ui.menu.Button(D,dr,this.__Cp);var fv=new qx.ui.menu.Button(dK,c,this.__RV);var fA=new qx.ui.menu.Button(eo,dL,this.__RW);var fx=new qx.ui.menu.Button(dy,y,this.__RX);fz.addListener(dE,this.debugButton);fy.addListener(dE,this.debugButton);fv.addListener(dE,this.debugButton);fA.addListener(dE,this.debugButton);fx.addListener(dE,this.debugButton);fw.add(fz);fw.add(fy);fw.addSeparator();fw.add(fv);fw.add(fA);fw.add(fx);return fw;}
,getSearchMenu:function(){var fE=new qx.ui.menu.Menu;var fC=new qx.ui.menu.Button(ea,eb);var fH=new qx.ui.menu.Button(da);var fD=new qx.ui.menu.Button(ds);var fG=new qx.ui.menu.Button(ej);var fB=new qx.ui.menu.Button(f,eb);var fF=new qx.ui.menu.Button(df);fD.setEnabled(false);fC.addListener(dE,this.debugButton);fH.addListener(dE,this.debugButton);fD.addListener(dE,this.debugButton);fG.addListener(dE,this.debugButton);fB.addListener(dE,this.debugButton);fF.addListener(dE,this.debugButton);fE.add(fC);fE.add(fH);fE.add(fD);fE.add(fG);fE.addSeparator();fE.add(fB);fE.add(fF);return fE;}
,getViewMenu:function(){var fI=new qx.ui.menu.Menu;var fK=new qx.ui.menu.Button(dh,null,null,this.getPanesMenu());var fN=new qx.ui.menu.Button(dU,null,null,this.getSyntaxMenu());var fM=new qx.ui.menu.CheckBox(eq);var fL=new qx.ui.menu.CheckBox(s);var fJ=new qx.ui.menu.Button(cY);fM.addListener(j,this.debugCheckBox);fL.addListener(j,this.debugCheckBox);fJ.addListener(dE,this.debugButton);fI.add(fK);fI.add(fN);fI.addSeparator();fI.add(fM);fI.add(fL);fI.addSeparator();fI.add(fJ);return fI;}
,getPanesMenu:function(){var fP=new qx.ui.menu.Menu;var fR=new qx.ui.menu.CheckBox(dH);var fO=new qx.ui.menu.CheckBox(E);var fU=new qx.ui.menu.CheckBox(Y);var fQ=new qx.ui.menu.CheckBox(dO);var fS=new qx.ui.menu.CheckBox(dN);var fT=new qx.ui.menu.CheckBox(A);fR.setValue(true);fO.setValue(true);fQ.setValue(true);fR.addListener(j,this.debugCheckBox);fO.addListener(j,this.debugCheckBox);fU.addListener(j,this.debugCheckBox);fQ.addListener(j,this.debugCheckBox);fS.addListener(j,this.debugCheckBox);fT.addListener(j,this.debugCheckBox);fP.add(fO);fP.add(fR);fP.addSeparator();fP.add(fU);fP.add(fQ);fP.add(fS);fP.add(fT);return fP;}
,getSyntaxMenu:function(){var ga=new qx.ui.menu.Menu;var fV=new qx.ui.menu.RadioButton(ef);var fX=new qx.ui.menu.RadioButton(cP);var fW=new qx.ui.menu.RadioButton(cL);var fY=new qx.ui.menu.Button(o,null,null,this.getSyntaxCMenu());var gd=new qx.ui.menu.RadioButton(m);var gb=new qx.ui.menu.RadioButton(W);ga.add(fV);ga.add(fX);ga.add(fW);ga.add(fY);ga.add(gd);ga.add(gb);var gc=new qx.ui.form.RadioGroup;gc.add(fV,fX,fW,gd,gb);gc.add.apply(gc,fY.getMenu().getChildren());gc.addListener(p,this.debugRadio);return ga;}
,getSyntaxCMenu:function(){var gf=new qx.ui.menu.Menu;var ge=new qx.ui.menu.RadioButton(g);var gi=new qx.ui.menu.RadioButton(Q);var gg=new qx.ui.menu.RadioButton(ee);var gh=new qx.ui.menu.RadioButton(er);gf.add(ge);gf.add(gi);gf.add(gg);gf.add(gh);return gf;}
,getFormatMenu:function(){var gm=new qx.ui.menu.Menu;var gl=new qx.ui.menu.Button(cS,null,null,this.getParagraphMenu());var go=new qx.ui.menu.Button(dI);var gp=new qx.ui.menu.Button(cN);var gk=new qx.ui.menu.Button(dl);var gn=new qx.ui.menu.Button(ek);var gj=new qx.ui.menu.Button(dM);var gr=new qx.ui.menu.Button(cJ);var gq=new qx.ui.menu.Button(G);go.addListener(dE,this.debugButton);gp.addListener(dE,this.debugButton);gk.addListener(dE,this.debugButton);gn.addListener(dE,this.debugButton);gj.addListener(dE,this.debugButton);gr.addListener(dE,this.debugButton);gq.addListener(dE,this.debugButton);gm.add(gl);gm.add(go);gm.add(gp);gm.addSeparator();gm.add(gk);gm.add(gn);gm.add(gj);gm.addSeparator();gm.add(gr);gm.add(gq);return gm;}
,getParagraphMenu:function(){var gs=new qx.ui.menu.Menu;var gw=new qx.ui.menu.Button(k,F);var gv=new qx.ui.menu.Button(cO,dA);var gt=new qx.ui.menu.Button(H,L);var gu=new qx.ui.menu.Button(di,d);gw.addListener(dE,this.debugButton);gv.addListener(dE,this.debugButton);gt.addListener(dE,this.debugButton);gu.addListener(dE,this.debugButton);gs.add(gw);gs.add(gv);gs.add(gt);gs.add(gu);return gs;}
,getHelpMenu:function(){var gx=new qx.ui.menu.Menu;var gz=new qx.ui.menu.Button(dg,X);var gB=new qx.ui.menu.Button(u);var gA=new qx.ui.menu.Button(a);var gy=new qx.ui.menu.Button(q);gz.addListener(dE,this.debugButton);gB.addListener(dE,this.debugButton);gA.addListener(dE,this.debugButton);gy.addListener(dE,this.debugButton);gx.add(gz);gx.add(gB);gx.addSeparator();gx.add(gA);gx.addSeparator();gx.add(gy);return gx;}
,getList:function(){var gC=new qx.ui.form.List;gC.setContextMenu(this.getContextMenu());for(var i=0;i<20;i++ ){gC.add(new qx.ui.form.ListItem(cX+i));}
;return gC;}
,getContextMenu:function(){var gD=new qx.ui.menu.Menu;var gF=new qx.ui.menu.Button(dK,c,this.__RV);var gG=new qx.ui.menu.Button(eo,dL,this.__RW);var gE=new qx.ui.menu.Button(dy,y,this.__RX);gF.addListener(dE,this.debugButton);gG.addListener(dE,this.debugButton);gE.addListener(dE,this.debugButton);gD.add(gF);gD.add(gG);gD.add(gE);return gD;}
},destruct:function(){this._disposeObjects(du,cV,dk,dJ,dT,h,x,dG);}
});}
)();
...
;this.__sG();}
,__sG:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__sH:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(o,this.__sH,this);return;}
...
;this.__sF=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__sF){this.__sF.call(this);delete this.__sF;}
;}
...
;this.__sH();}
;}
,_onMouseOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__sE=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__sE){bt.cancelOpen(this.__sE);this.__sE=null;}
;}
;}
...
;if(this.__sE){bw.cancelOpen(this.__sE);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__sI:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__sI=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__sI||null;}
...
(function(){var a="__sz",b="blur",c="mousedown",d="Enter",f="__lj",g="Escape",h="Space",j="keydown",k="Left",l="Down",m="Up",n="singleton",o="mousewheel",p="interval",q="event.touch",r="__sA",s="Object is no menu: ",t="qx.ui.menu.Manager",u="keyup",v="keypress",w="Right",x="qx.debug";qx.Class.define(t,{type:n,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__lj=[];var y=document.body;var z=qx.event.Registration;z.addListener(window.document.documentElement,c,this._onMouseDown,this,true);z.addListener(y,o,this._onMouseWheel,this,true);z.addListener(y,j,this._onKeyUpDown,this,true);z.addListener(y,u,this._onKeyUpDown,this,true);z.addListener(y,v,this._onKeyPress,this,true);if(!qx.core.Environment.get(q)){qx.bom.Element.addListener(window,b,this.hideAll,this);}
;this.__sz=new qx.event.Timer;this.__sz.addListener(p,this._onOpenInterval,this);this.__sA=new qx.event.Timer;this.__sA.addListener(p,this._onCloseInterval,this);}
,members:{__sB:null,__sC:null,__sz:null,__sA:null,__lj:null,_getChild:function(A,C,B,F){var E=A.getChildren();var length=E.length;var D;for(var i=C;i<length&&i>=0;i+=B){D=E[i];if(D.isEnabled()&&!D.isAnonymous()&&D.isVisible()){return D;}
;}
...
;G=G.getLayoutParent();}
;return false;}
,_isMenuOpener:function(I){var H=this.__lj;for(var i=0;i<H.length;i++ ){if(H[i].getOpener()===I){return true;}
;}
;return false;}
,_getMenuButton:function(J){while(J){if(J instanceof qx.ui.menu.AbstractButton){return J;}
;J=J.getLayoutParent();}
;return null;}
,add:function(K){if(qx.core.Environment.get(x)){if(!(K instanceof qx.ui.menu.Menu)){throw new Error(s+K);}
;}
;var L=this.__lj;L.push(K);K.setZIndex(1e6+L.length);}
,remove:function(M){if(qx.core.Environment.get(x)){if(!(M instanceof qx.ui.menu.Menu)){throw new Error(s+M);}
;}
;var N=this.__lj;if(N){qx.lang.Array.remove(N,M);}
;}
,hideAll:function(){var O=this.__lj;if(O){for(var i=O.length-1;i>=0;i-- ){O[i].exclude();}
;}
;}
,getActiveMenu:function(){var P=this.__lj;return P.length>0?P[P.length-1]:null;}
,scheduleOpen:function(Q){this.cancelClose(Q);if(Q.isVisible()){if(this.__sB){this.cancelOpen(this.__sB);}
;}
else if(this.__sB!=Q){this.__sB=Q;this.__sz.restartWith(Q.getOpenInterval());}
;}
,scheduleClose:function(R){this.cancelOpen(R);if(!R.isVisible()){if(this.__sC){this.cancelClose(this.__sC);}
;}
else if(this.__sC!=R){this.__sC=R;this.__sA.restartWith(R.getCloseInterval());}
;}
,cancelOpen:function(S){if(this.__sB==S){this.__sz.stop();this.__sB=null;}
;}
,cancelClose:function(T){if(this.__sC==T){this.__sA.stop();this.__sC=null;}
;}
,_onOpenInterval:function(e){this.__sz.stop();this.__sB.open();this.__sB=null;}
,_onCloseInterval:function(e){this.__sA.stop();this.__sC.exclude();this.__sC=null;}
...
;if(this.__lj.length>0&&!this._isInMenu(U)){this.hideAll();}
;}
,__sD:{"Enter":1,"Space":1},__pI:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var V=this.getActiveMenu();if(!V){return;}
;var W=e.getKeyIdentifier();if(this.__pI[W]||(this.__sD[W]&&V.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var ba=this.getActiveMenu();if(!ba){return;}
;var X=e.getKeyIdentifier();var bc=this.__pI[X];var Y=this.__sD[X];if(bc){switch(X){case m:this._onKeyPressUp(ba);break;case l:this._onKeyPressDown(ba);break;case k:this._onKeyPressLeft(ba);break;case w:this._onKeyPressRight(ba);break;case g:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(Y){var bb=ba.getSelectedButton();if(bb){switch(X){case d:this._onKeyPressEnter(ba,bb,e);break;case h:this._onKeyPressSpace(ba,bb,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
...
;}
,_onMouseWheel:function(e){var bI=e.getTarget();bI=qx.ui.core.Widget.getWidgetByElement(bI,true);if(this.__lj.length>0&&!this._isInMenu(bI)&&!this._isMenuOpener(bI)){this.hideAll();}
;}
},destruct:function(){var bK=qx.event.Registration;var bJ=document.body;bK.removeListener(window.document.documentElement,c,this._onMouseDown,this,true);bK.removeListener(bJ,j,this._onKeyUpDown,this,true);bK.removeListener(bJ,u,this._onKeyUpDown,this,true);bK.removeListener(bJ,v,this._onKeyPress,this,true);this._disposeObjects(a,r);this._disposeArray(f);}
});}
)();
...
;var x=this.__sJ(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__sJ:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__sR(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__sO.length>0){do {var Q=this.__sO[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__sO.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__sQ(Q);G+=I;if(E&&this.__sO.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__sO.length>0);}
;}
,__sQ:function(R){R.setVisibility(o);this.__sO.shift();this.fireDataEvent(m,R);}
,__sR:function(S){if(!S){return;}
;this.__sO.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__sP.length-1;i>=0;i-- ){var T=this.__sP[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__sP[W]!=undefined){throw new Error(v);}
;this.__sP[W]=X;}
...
;for(var i=0;i<this.__sO.length;i++ ){this.__sO[i].setVisibility(o);}
;this.__sO=[];}
;}
...
;bf.setVisibility(y);}
;}
,__sS:false,_setAllowMenuOpenHover:function(bg){this.__sS=bg;}
,_isAllowMenuOpenHover:function(){return this.__sS;}
...
,__sT:function(){var x=this.getChildrenContainer().getChildren();x=x.filter(function(y){return y.getVisibility()==k;}
...
(function(){var b="-",c="PageUp",d="Escape",f="Boolean",g="+",h="qx.event.type.Data",j="_applyShortcut",k="PrintScreen",l="NumLock",m="short",n="keydown",o="5",p="8",q="execute",r="Meta",s="0",t="",u="2",v="Control",w="Shift",x="You can only specify one non modifier key!",y="3",z="Unidentified",A="/",B="Delete",C="String",D="changeEnabled",E="*",F="qx.bom.Shortcut",G="6",H="4",I="1",J="Alt",K="Not a valid key name for a shortcut: ",L="PageDown",M="Whitespaces are not allowed within shortcuts",N="_applyEnabled",O="keypress",P="7",Q="a",R="z",S="9";qx.Class.define(F,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__zG={};this.__zH=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":h},properties:{enabled:{init:true,check:f,event:D,apply:N},shortcut:{check:C,apply:j,nullable:true},autoRepeat:{check:f,init:false}},members:{__zG:t,__zH:t,execute:function(U){this.fireDataEvent(q,U);}
,__zI:function(event){if(this.getEnabled()&&this.__zJ(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__iE:function(event){if(this.getEnabled()&&this.__zJ(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(W,V){if(W){qx.event.Registration.addListener(document.documentElement,n,this.__zI,this);qx.event.Registration.addListener(document.documentElement,O,this.__iE,this);}
else {qx.event.Registration.removeListener(document.documentElement,n,this.__zI,this);qx.event.Registration.removeListener(document.documentElement,O,this.__iE,this);}
;}
,_applyShortcut:function(bb,Y){if(bb){if(bb.search(/[\s]+/)!=-1){var bc=M;this.error(bc);throw new Error(bc);}
;this.__zG={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__zH=null;var X;var a=[];while(bb.length>0&&X!=-1){X=bb.search(/[-+]+/);a.push((bb.length==1||X==-1)?bb:bb.substring(0,X));bb=bb.substring(X+1);}
;var ba=a.length;for(var i=0;i<ba;i++ ){var bd=this.__zL(a[i]);switch(bd){case v:case w:case r:case J:this.__zG[bd]=true;break;case z:var bc=K+a[i];this.error(bc);throw bc;default:if(this.__zH){var bc=x;this.error(bc);throw bc;}
;this.__zH=bd;};}
;}
;return true;}
...
;return false;}
,__zK:{esc:d,ctrl:v,print:k,del:B,pageup:c,pagedown:L,numlock:l,numpad_0:s,numpad_1:I,numpad_2:u,numpad_3:y,numpad_4:H,numpad_5:o,numpad_6:G,numpad_7:P,numpad_8:p,numpad_9:S,numpad_divide:A,numpad_multiply:E,numpad_minus:b,numpad_plus:g},__zL:function(bg){var bf=qx.event.util.Keyboard;var bh=z;if(bf.isValidKeyIdentifier(bg)){return bg;}
;if(bg.length==1&&bg>=Q&&bg<=R){return bg.toUpperCase();}
;bg=bg.toLowerCase();var bh=this.__zK[bg]||qx.lang.String.firstUp(bg);if(bf.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bj=this.__zH;var bk=[];for(var bi in this.__zG){if(this.__zG[bi]){bk.push(qx.locale.Key.getKeyName(m,bi));}
;}
...
,_onMouseOver:function(e){e.stopPropagation();this.addState(b);delete this.__sy;}
...
;var T=this.getMenu();if(T&&T.isVisible()){this.__sy=true;return;}
;this.removeState(b);}
...
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__sy){this.removeState(b);}
;}
}});}
)();
...
(function(){var a="mousedown",b="Boolean",c="one",d="qx.event.type.Data",f=", because it is not a child element!",g="_applyDragSelection",h="Could not add + ",j="mousemove",k="changeSelection",l="Could not test if ",m="Could not remove ",n="addItem",o=" from selection, because it is not a child element!",p="multi",q="_applyQuickSelection",r="single",s="mouseover",t=" is selected, because it is not a child element!",u="__gz",v="_applySelectionMode",w="additive",x="mouseup",y="keypress",z="losecapture",A="Could not select ",B="removeItem",C=" to selection, because it is not a child element!",D="qx.ui.core.MMultiSelectionHandling";qx.Mixin.define(D,{construct:function(){var F=this.SELECTION_MANAGER;var E=this.__gz=new F(this);this.addListener(a,E.handleMouseDown,E);this.addListener(x,E.handleMouseUp,E);this.addListener(s,E.handleMouseOver,E);this.addListener(j,E.handleMouseMove,E);this.addListener(z,E.handleLoseCapture,E);this.addListener(y,E.handleKeyPress,E);this.addListener(n,E.handleAddItem,E);this.addListener(B,E.handleRemoveItem,E);E.addListener(k,this._onSelectionChange,this);}
,events:{"changeSelection":d},properties:{selectionMode:{check:[r,p,w,c],init:r,apply:v},dragSelection:{check:b,init:false,apply:g},quickSelection:{check:b,init:false,apply:q}},members:{__gz:null,selectAll:function(){this.__gz.selectAll();}
...
,_getLeadItem:function(){var O=this.__gz.getMode();if(O===r||O===c){return this.__gz.getSelectedItem();}
...
(function(){var a="qx.ui.form.List",b="text",c="Boolean",d="one",f="addChildWidget",g="_applySpacing",h="Enter",j="Integer",k="action",m="keyinput",n="qx.event.type.Data",o="addItem",p="vertical",q="removeChildWidget",r="",s="_applyOrientation",t="__pK",u="single",v="keypress",w="list",x="horizontal",y="label",z="pane",A="removeItem";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__pK=this._createListItemContainer();this.__pK.addListener(f,this._onAddChild,this);this.__pK.addListener(q,this._onRemoveChild,this);this.getChildControl(z).add(this.__pK);if(B){this.setOrientation(x);}
else {this.initOrientation();}
;this.addListener(v,this._onKeyPress);this.addListener(m,this._onKeyInput);this.__pL=r;}
...
,_applyOrientation:function(F,C){var D=F===x;var E=D?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__pK;content.setLayout(E);content.setAllowGrowX(!D);content.setAllowGrowY(D);this._applySpacing(this.getSpacing());}
,_applySpacing:function(H,G){this.__pK.getLayout().setSpacing(H);}
...
;if(((new Date).valueOf()-this.__pM)>1000){this.__pL=r;}
;this.__pL+=e.getChar();var K=this.findItemByLabelFuzzy(this.__pL);if(K){this.setSelection([K]);}
