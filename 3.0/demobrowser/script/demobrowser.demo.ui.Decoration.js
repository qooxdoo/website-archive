...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Decoration.6ec00f11d25f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.ui.Decoration";qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var b=new qx.ui.layout.HBox();b.setSpacing(10);var d=new qx.ui.container.Scroll();this.getRoot().add(d,{edge:0});var c=new qx.ui.container.Composite(b);c.setPadding(20);d.add(c);c.add(this.getDecorations());}
,getDecorations:function(){var h=qx.theme.manager.Decoration.getInstance().getTheme();var f=new qx.ui.layout.Grid();f.setSpacing(10);var e=new qx.ui.container.Composite(f);var j=h.decorations;var k=8;var i=0;for(var g in j){e.add(new qx.ui.basic.Label(g).set({rich:true,wrap:true,decorator:g,padding:5,height:80,width:80}),{row:Math.floor(i/k),column:i%k});i+=1;}
;return e;}
}});}
)();
