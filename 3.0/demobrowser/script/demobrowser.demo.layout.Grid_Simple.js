...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Grid_Simple.ed65fe10ee24.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="click me",b="click",c="yellow",d="center",f="green",g="top",h="middle",i="right",j="demobrowser.demo.layout.Grid_Simple",k="main";qx.Class.define(j,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(l);l.add(this.getGrid1());l.add(this.getGrid2());l.add(this.getGrid3());}
,getGrid1:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:k,backgroundColor:c,allowGrowX:false,allowGrowY:false});m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:0,column:0});m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:0,column:1});m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:1,column:0});m.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:1,column:1});return m;}
,getGrid2:function(){var o=new qx.ui.layout.Grid();o.setColumnAlign(1,d,g);o.setColumnAlign(0,i,h);o.setSpacing(5);var p=new qx.ui.container.Composite(o).set({decorator:k,backgroundColor:c,allowGrowX:false});p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f,width:150}),{row:0,column:0});var n=new qx.ui.basic.Label(a).set({decorator:k,backgroundColor:f,allowGrowX:false,width:50,height:50});p.add(n,{row:0,column:1});p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f,maxHeight:60,allowGrowX:false}),{row:1,column:0});p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f,height:80}),{row:1,column:1});p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:2,column:0});p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:2,column:1});var q=10;n.addListener(b,function(e){n.setWidth(50+q);q=-q;}
);return p;}
,getGrid3:function(){var s=new qx.ui.container.Composite().set({decorator:k,backgroundColor:c,width:400,height:300,allowShrinkX:false,allowShrinkY:false});var r=new qx.ui.layout.Grid();r.setColumnFlex(1,2);r.setRowFlex(1,3);r.setSpacing(5);s.setLayout(r);s.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:0,column:0});s.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:0,column:1});s.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:1,column:0});s.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:f}),{row:1,column:1});return s;}
}});}
)();
