...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Video.32f15fb8e929.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{appearance:{refine:true,init:c}},events:{complete:g,change:i},members:{__zV:0,__Fx:100,getValue:function(){return this.__zV;}
,setValue:function(m){var l=this.getMaximum();if(!qx.lang.Type.isNumber(m)||!isFinite(m)){return null;}
;if(m<0){m=0;}
;if(m>l){m=l;}
;this.__zV=m;this._changeProgress(m/l);return m;}
,getMaximum:function(){return this.__Fx;}
,setMaximum:function(o){var n=o;var p=this.getValue();if(!qx.lang.Type.isNumber(n)||!isFinite(n)||n<=0){return null;}
;if(n<p){n=p;}
;this.__Fx=n;this._changeProgress(p/n);return n;}
