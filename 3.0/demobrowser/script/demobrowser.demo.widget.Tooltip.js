...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.89ca540f671a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Sa:4,__Sb:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Sb/this.__Sa),column:this.__Sb%this.__Sa});this.__Sb+=1;}
