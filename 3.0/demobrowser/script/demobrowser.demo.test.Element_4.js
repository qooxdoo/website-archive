...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_4","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_4.6adcbeb04397.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Exclude & show together",b="el2",c="Create five elements (2 hidden)",d="el5",e="doc",f="demobrowser.demo.test.Element_4",g="Hide a rendered element",h="el3",i="el4",j="el1",k="Create document",l="test",m="Show one of the two hidden elements",n="id",o="Include one and hide another element";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);this.info(k);var p=new qx.html.Root(document.getElementById(l));p.setAttribute(n,e);this.info(c);var s=new qx.html.Element;s.setAttribute(n,j);var q=new qx.html.Element;q.setAttribute(n,b);var r=new qx.html.Element;r.setAttribute(n,h);var t=new qx.html.Element;t.setAttribute(n,i);var u=new qx.html.Element;u.setAttribute(n,d);p.add(s,q,r,t,u);q.hide();t.hide();qx.html.Element.flush();this.info(m);q.show();qx.html.Element.flush();this.info(g);r.hide();qx.html.Element.flush();this.info(a);r.exclude();r.show();qx.html.Element.flush();this.info(o);r.include();q.hide();qx.html.Element.flush();}
}});}
)();
