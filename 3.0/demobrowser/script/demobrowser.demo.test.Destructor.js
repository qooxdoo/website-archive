...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.e80a58bde342.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="__jO",b="Window: ",c="interval",d=")",e="Done! (Registry: ",f="Label: ",g=" (Registry: ",h="demobrowser.demo.test.Destructor",j="Round: ";qx.Class.define(h,{extend:qx.application.Standalone,members:{__cN:null,__Rg:0,__jO:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cN=[];this.currentTest=this.testWindows;this.__jO=new qx.event.Timer(1000);this.__jO.addListener(c,this.runTest,this);this.__jO.start();}
,runTest:function(){this.__Rg++ ;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(j+this.__Rg+g+m+d);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cN;for(var i=0,l=k.length;i<l;i++ ){k[i].destroy();}
;k.length=0;qx.ui.core.queue.Manager.flush();var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(e+m+d);}
,testLabels:function(){for(var i=0;i<250;i++ ){var n=new qx.ui.basic.Label(f+i);this.getRoot().add(n,{left:50,top:50+i*20});this.__cN.push(n);}
;}
,testWindows:function(){for(var i=0;i<5;i++ ){var o=new qx.ui.window.Window(b+i);o.open();this.__cN.push(o);}
;}
},destruct:function(){this._disposeObjects(a);}
});}
)();
