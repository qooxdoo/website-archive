...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.622a42537c9c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__Ja=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__rP=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__rP:null,__Ja:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__rP!=null){i.stop(this.__rP);this.__rP=null;}
;this.__rP=i.start(function(){this.__Ja.update();this.__rP=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__Ja=null;}
});}
)();
