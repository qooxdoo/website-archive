...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea.3e0570cbeb5a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="clear:both",b="Insert Table",c="div",d="<tr>",f="Color (Hex): ",g="Georgia",h="<p>This low-level widget can be used separately at ",k="http://",l="BgColor (Hex): ",m="Indent More",n="<option value=''></option>",o="1px solid #AAA",p="Change font family",r="'>",s="demobrowser/demo/icons/htmlarea/format-fill-color.png",t="Align Right",u="Format Italic",v="value='",w="qx/icon/Oxygen/16/actions/format-text-underline.png",x="350px",y='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',z="white",A="buttons at the toolbar.</p>",B="demobrowser/demo/icons/htmlarea/format-list-ordered.png",C="qx/icon/Oxygen/16/actions/format-indent-more.png",D="Comic Sans MS",E="Tahoma",F="20px 20px",G="float",H="<h1>HtmlArea low-level widget</h1>",I="<td>First Row, First cell</td>",J="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",K="Align Left",L="qx/icon/Oxygen/16/actions/format-justify-center.png",M="#",N="input",O="Align Justify",P="</option>",Q="demobrowser/demo/icons/htmlarea/insert-text.png",R="Insert Horizontal Ruler",S="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",T="demobrowser/demo/icons/htmlarea/format-list-unordered.png",U="HTML Code:",V="Set Text Background Color",W="outline",X="Insert Link",Y="on",cB="You can play around with this widget by hitting the ",cC="<td>Second Row, First cell</td>",cD="mshtml",cx="hideFocus",cy="none",cz="</tbody>",cA="16px",cI="qooxdoo logo",cJ="Set Text Color",cK="840px",cL="demobrowser/demo/icons/htmlarea/format-text-color.png",cE="traditional web pages / single-page applications.<br/> ",cF="demobrowser/demo/icons/htmlarea/insert-table.png",cG="qx/icon/Oxygen/16/actions/edit-undo.png",cH="qx/icon/Oxygen/16/actions/edit-clear.png",cP="Arial Black",ds="Impact",dU="change",cQ="Change font size",cM="Link: ",cN="select",dQ="Redo Last Undo Step",cO="Format Bold",cR="off",cS="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",cT="br",cY="marginRight",da="image",db="<option qxKeepFocus='on' qxSelectable='off'",cU="engine.name",cV="click",cW="<option qxKeepFocus='on' qxSelectable='off' ",cX="Remove Format",df="blank.html",dg="qx/icon/Oxygen/16/actions/insert-image.png",dh="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",di="left",dc="</table>",dd="<td>First Row, Second cell</td>",dR="Insert HTML Code",de="qx/icon/Oxygen/16/actions/insert-link.png",dm="Insert Ordered List",dn="demobrowser.demo.bom.HtmlArea",dT="true",dp="qx/icon/Oxygen/16/actions/format-justify-left.png",dj="Courier",dk="Courier New",dS="4px",dl="qx/icon/Oxygen/16/actions/format-justify-right.png",dq="qx/icon/Oxygen/16/actions/format-text-bold.png",dr="<td>Second Row, Second cell</td>",dD="Insert Image",dC="0px",dB="</tr>",dH="qx/icon/Oxygen/16/actions/format-indent-less.png",dG="<tbody>",dF="Times New Roman",dE="",dw="Align Center",dv="qx/icon/Oxygen/16/actions/edit-redo.png",du="Lucida Console",dt="innerHTML",dA="Undo Last Change",dz="qx/icon/Oxygen/16/actions/format-text-italic.png",dy="Arial",dx="qx/icon/Oxygen/16/actions/format-justify-fill.png",dL="Verdana",dK="Indent Less",dJ="Format Strikethrough",dI="Format Underline",dP="<table border='1'>",dO="Inserted Unordered List",dN="FontSize: ",dM="It is the foundation for the UI widget component.</p>";qx.Class.define(dn,{extend:qx.application.Native,members:{__Ez:null,__PA:null,__PB:null,__Ni:null,__lm:null,main:function(){qx.application.Native.prototype.main.call(this);this.__Ez=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(this.__Ez,{margin:F});var dX=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(dX,{width:cK,padding:dC,margin:dC});var dW=H+h+cE+dM+dh+cB+A;qx.bom.element.Attribute.set(dX,dt,dW);this.__PA=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(this.__PA,{width:cK,padding:dC,margin:dC,lineHeight:dC,border:o});this.__PB=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(this.__PB,{width:cK,height:x,border:o,borderTop:dC,backgroundColor:z});qx.dom.Element.insertEnd(this.__PB,this.__Ez);var dV=y;this.__Ni=new qx.bom.htmlarea.HtmlArea(this.__PB,dV,null,df);this.__Ns();qx.dom.Element.insertBegin(this.__PA,this.__Ez);qx.dom.Element.insertBegin(dX,this.__Ez);qx.dom.Element.insertBegin(this.__Ez,document.body);}
,__PC:function(e){var dY=window.prompt(dN,dE);this.setFontSize(parseInt(dY));}
,__Nj:function(e){var ea=window.prompt(f,M);this.setTextColor(ea);}
,__Nk:function(e){var eb=window.prompt(l,M);this.setTextBackgroundColor(eb);}
,__Nl:function(e){var ec={src:qx.util.ResourceManager.getInstance().toUri(J),border:0,title:cI,alt:cI};this.insertImage(ec);}
,__Nm:function(e){var ed=dP+dG+d+I+dd+dB+d+cC+dr+dB+cz+dc;this.insertHtml(ed);}
,__Nn:function(e){var ee=window.prompt(cM,k);this.insertHyperLink(ee);}
,__No:function(e){var ef=window.prompt(U,dE);this.insertHtml(ef);}
,__Np:function(){var eh=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(eh,{"float":di});var ej;var ei=qx.dom.Element.create(cN,{title:p});if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(ei,cx,dT);}
else {qx.bom.element.Style.set(ei,W,cy);}
;ej=q.create(n);qx.dom.Element.insertEnd(ej[0],ei);var ek=[E,dL,dF,dy,cP,dk,dj,g,ds,D,du];var eg;var el;for(var i=0,j=ek.length;i<j;i++ ){eg=db+v+ek[i]+r+ek[i]+P;el=q.create(eg);if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(el[0],cx,dT);}
else {qx.bom.element.Style.set(el[0],W,cy);}
;qx.dom.Element.insertEnd(el[0],ei);}
;qx.event.Registration.addListener(ei,dU,function(e){var em=e.getTarget();var en=em.selectedIndex;if(en!=0){this.setFontFamily(em.options[en].value);em.options[0].selected=true;}
;}
,this.__Ni);qx.dom.Element.insertBegin(ei,eh);return eh;}
,__Nq:function(){var ep=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ep,{"marginRight":cA,"float":di});var er;var eq=qx.dom.Element.create(cN,{title:cQ});if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(eq,cx,dT);}
else {qx.bom.element.Style.set(eq,W,cy);}
;er=q.create(n);qx.dom.Element.insertEnd(er[0],eq);var es;var eo;for(var i=1;i<=7;i++ ){eo=cW+v+i+r+i+P;es=q.create(eo);if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(es[0],cx,dT);}
else {qx.bom.element.Style.set(es[0],W,cy);}
;qx.dom.Element.insertEnd(es[0],eq);}
;qx.event.Registration.addListener(eq,dU,function(e){var et=e.getTarget();var eu=et.selectedIndex;if(eu!=0){this.setFontSize(et.options[eu].value);et.options[0].selected=true;}
;}
,this.__Ni);qx.dom.Element.insertBegin(eq,ep);return ep;}
,__Ns:function(){var ew=[{bold:{text:cO,image:dq,action:this.__Ni.setBold},italic:{text:u,image:dz,action:this.__Ni.setItalic},underline:{text:dI,image:w,action:this.__Ni.setUnderline},strikethrough:{text:dJ,image:cS,action:this.__Ni.setStrikeThrough},removeFormat:{text:cX,image:cH,action:this.__Ni.removeFormat}},{alignLeft:{text:K,image:dp,action:this.__Ni.setJustifyLeft},alignCenter:{text:dw,image:L,action:this.__Ni.setJustifyCenter},alignRight:{text:t,image:dl,action:this.__Ni.setJustifyRight},alignJustify:{text:O,image:dx,action:this.__Ni.setJustifyFull}},{fontFamily:{custom:this.__Np},fontSize:{custom:this.__Nq},fontColor:{text:cJ,image:cL,action:this.__Nj},textBackgroundColor:{text:V,image:s,action:this.__Nk}},{indent:{text:m,image:C,action:this.__Ni.insertIndent},outdent:{text:dK,image:dH,action:this.__Ni.insertOutdent}},{insertImage:{text:dD,image:dg,action:this.__Nl},insertTable:{text:b,image:cF,action:this.__Nm},insertLink:{text:X,image:de,action:this.__Nn},insertHTML:{text:dR,image:Q,action:this.__No},insertHR:{text:R,image:S,action:this.__Ni.insertHorizontalRuler}},{ol:{text:dm,image:B,action:this.__Ni.insertOrderedList},ul:{text:dO,image:T,action:this.__Ni.insertUnorderedList}},{undo:{text:dA,image:cG,action:this.__Ni.undo},redo:{text:dQ,image:dv,action:this.__Ni.redo}}];var ey,eC,ev,ez;for(var i=0,j=ew.length;i<j;i++ ){eC={};eC[cY]=i==j-1?dC:cA;eC[G]=di;ey=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ey,eC);for(var eA in ew[i]){var eB=ew[i][eA];if(eB.custom){ev=eB.custom.call(this);}
else {var ex=qx.util.AliasManager.getInstance().resolve(eB.image);ez={type:da,src:qx.util.ResourceManager.getInstance().toUri(ex),title:eB.text,qxKeepFocus:Y,qxSelectable:cR};ev=qx.dom.Element.create(N,ez);qx.bom.element.Style.setStyles(ev,{width:cA,height:cA,padding:dS});if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(ev,cx,dT);}
else {qx.bom.element.Style.set(ev,W,cy);}
;qx.event.Registration.addListener(ev,cV,eB.action,this.__Ni);}
;qx.dom.Element.insertEnd(ev,ey);}
;qx.dom.Element.insertEnd(ey,this.__PA);}
;qx.dom.Element.insertEnd(qx.dom.Element.create(cT,{style:a}),this.__PA);}
}});}
)();
(function(){var b="qx.blankpage",c='</span>',d="backgroundColor",f="li",g="pageup",h='undo',k="engine.version",l="backgroundcolor",m="Failed to enable rich edit functionality",n="end",o="<br class='webkit-block-placeholder' />",p="div",q="right",r="qx.event.type.Data",t="Function",u='On',v="fontSize",w="textcolor",x="cant open document on source '",y="home",z="<",A="focused",B="fontFamily",C="load",D='document not available, try again...',E='<font ',F="__Al",G='id="__elementToFocus__"',H="setUnderline",I="backgroundPosition",J="redo",K="<!--",L=' size="',M="i",N='/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',O="'>",P='underline',Q="opera",R='bold',S="&copy;",T="ul",U="backspace",V="cursorContext",W="bold",X="mouseup",Y="enter",gd="y",fU="readyAfterInvalid",ge="inserthtml",ga="styleWithCSS",gb="span",fI=" />",gc="id",gi="style",gj="setBold",gp="<P>&nbsp;</P>",gk="</",gf="textbackgroundcolor",gg="&gt;",fY='="',gh="can't extract style from elem. ",go="paddingLeft",gT="backgroundimage",gq='size',gr="100%",gl="inserthorizontalrule",gm='</head>',hT='<p>',gn='"',gs='<head>',gt="k",gu="backgroundRepeat",gz="insertimage",gA="qx.event.type.Event",gB=":",gv='redo',gw="a",gx="&amp;",gy='Off',gG="removeformat",gH="marginLeft",gI="ready",gJ="<p>&nbsp;</p>",gC="about:blank",gD='DOCTYPE html PUBLIC "-/',gE="italic",gF='">',gO="browser.version",gP=" html, body {overflow-x: visible; } ",ib='<body>',gQ="insertorderedlist",gK="down",gL='body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } ',gM="font-family",gN="mshtml",gR="g",gS="hideFocus",he="keypress",hd="none",hc="left",hi='/DTD XHTML 1.0 Transitional/',hh='<html xmlns="http:/',hg=" ",hf="outline",gX="fontsize",gW="setItalic",gV="font-style",gU="body",hb="marginBottom",ha="undo",gY="xhtml",hp="Boolean",ho="focusOut",hn="text-decoration",hm="justifyleft",ht="handleMouse ",hs='</p>',hr="gecko",hq="paddingTop",hl="underline",hk="br",hj='</font>',hE='<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',hD="Control",hC="pagedown",hI='<span style="font-family:',hH='/W3C/',hG="text-align",hF="placeholder",hx='cant load HtmlArea. Document is not available. ',hw="justify",hv="backgroundImage",hu="center",hB="marginTop",hA="> ",hz=" { ",hy="font-weight",hO="LI",hN="p",hM='italic',hL='<!',hS='</style>',hR="\ufeff",hQ="u",hP=" | ",hK="focus",hJ="&quot;",eO="marginRight",eN="STYLE",ic="__elementToFocus__",eL="justifyfull",eM="control",eK="engine.name",ia="click",eI="inserthyperlink",eJ="<br />",eH='html { margin:0px; padding:0px; } ',hX='<style type="text/css">',eF="qx.bom.htmlarea.HtmlArea.debug",eG="old_id",eE="<br>",eX='/EN" "http:/',eY="justifycenter",eV="<br /><div id='placeholder'></div>",eW="up",eT="useCSS",eU="object",eS="strikethrough",eD="blur",eQ="font-size",eR="None",eP="text/html",fm="true",fk="1.9",fl='',fi=' style="',fj="indent",fh="messengerContent",hW="Integer",ff="insertunorderedlist",fg="Text",fe="'",hY="delete",fc="&lt;",fd="_moz_dirty",fa=">",fb="qx.debug",fu='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>',fv="b",fs='</body></html>',ft='<br/><div class="placeholder"></div>',fq="selectall",fr="transparent",fp="line-through",hV="String",fn=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",fo="z",fH="justifyright",hU='/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',fJ="ol",fE=";",fD="",fG="//text()[string-length(normalize-space(.))>0]",fF="outdent",fA="<div></div>",fz="fontfamily",fC="<body style='",fB="qx.bom.htmlarea.HtmlArea",fw="paddingBottom",fy="keydown",fx="keyup",fR="loadingError",fQ="Verdana",fT="contextmenu",fS="focusout",fN="$",fM="-->",fP=" }",fO="webkit",fK="paddingRight",fL='html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } ',fV="Off",fX='p { margin:0px; padding:0px; }',fW='body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ';qx.Class.define(fB,{extend:qx.core.Object,construct:function(ie,ih,ii,id){qx.core.Object.call(this);var ig=id||qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(b));this.__AC(ie);this.__AD();this._createAndAddIframe(ig);this._addIframeLoadListener();this.__Ak=qx.bom.htmlarea.HtmlArea.__Am(ii);if(qx.lang.Type.isString(ih)){this.__zV=ih;}
;this.__Al=this.__AP();}
,events:{"load":gA,"loadingError":r,"messengerContent":r,"cursorContext":r,"ready":gA,"readyAfterInvalid":gA,"focused":gA,"focusOut":gA,"contextmenu":r,"undoRedoState":r},statics:{simpleLinebreak:eE,EMPTY_DIV:fA,GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:gj},italic:{method:gW},underline:{method:H},undo:{method:ha},redo:{method:J}},__Am:function(ik){if(ik==null||ik==fD){return fD;}
else if(typeof ik==eU){var ij=fD;for(var i in ik){ij+=i+hz+ik[i]+fP;}
;return ij;}
else {return ik;}
;}
,__An:function(iq){var il={};var a=iq.split(fE);var i;for(i=0;i<a.length;i++ ){var im=a[i],io=im.indexOf(gB);if(io===-1){continue;}
;var name=im.substring(0,io).trim();var ip=im.substring(io+1,im.length).trim();if(name&&ip){il[name]=ip;}
;}
;return il;}
,__Ao:function(iC,is,iz,iy){var iu=[];switch(iC.nodeType){case 1:case 11:var i;var it=iC.tagName.toLowerCase();var iA={};var ir={};var closed=(!(iC.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__Ap(iC)));if(is){if((qx.core.Environment.get(eK)==gN)){if(it==p&&iC.className&&iC.className==hF){for(i=iC.firstChild;i;i=i.nextSibling){iu.push(qx.bom.htmlarea.HtmlArea.__Ao(i,true,iz,iy));}
;return iu.join(fD);}
;}
;var ix=iC.attributes;var iv=ix.length;var a;if((qx.core.Environment.get(eK)==hr)){if(it==gb&&iv==1&&ix[0].name==fd&&iC.childNodes.length==0){return fD;}
;}
;for(i=0;i<iv;i++ ){a=ix[i];if(!a.specified){continue;}
;var name=qx.dom.Node.getName(a);var iB=a.nodeValue;if(/(_moz|contenteditable)/.test(name)){continue;}
;if(name!=gi){if(qx.core.Environment.get(eK)==gN){if(name==gc&&iC.getAttribute(eG)){iB=iC.getAttribute(eG);}
else if(!isNaN(iB)){iB=iC.getAttribute(name);}
else {iB=a.nodeValue;}
;}
else {iB=a.nodeValue;}
;}
else {iB=iC.style.cssText;}
;if(/(_moz|^$)/.test(iB)){continue;}
;if(name==eG){continue;}
;if(!iB){continue;}
;if(name==gc&&iB==ic){continue;}
;if(name.charAt(0)===fN){continue;}
;iA[name]=iB;}
;if(iA.style!==undefined){ir=qx.bom.htmlarea.HtmlArea.__An(iA.style);delete iA.style;}
;if(iy){var iw={domElement:iC,tag:it,attributes:iA,styles:ir};iy(iw);iw.domElement=null;it=iw.tag;}
;if(it){iu.push(z,it);for(var name in iA){var iB=iA[name];iu.push(hg,name,fY,iB.toString().replace(new RegExp(gn,gR),fe),gn);}
;if(!qx.lang.Object.isEmpty(ir)){iu.push(fi);for(var name in ir){var iB=ir[name];iu.push(name,gB,iB.toString().replace(new RegExp(gn,gR),fe),fE);}
;iu.push(gn);}
;iu.push(closed?fI:fa);}
;}
;for(i=iC.firstChild;i;i=i.nextSibling){iu.push(qx.bom.htmlarea.HtmlArea.__Ao(i,true,iz,iy));}
;if(is&&!closed&&it){iu.push(gk,it,fa);}
;break;case 3:iu.push(iz?iC.data:qx.bom.htmlarea.HtmlArea.__Aq(iC.data));break;case 8:iu.push(K,iC.data,fM);break;};return iu.join(fD);}
,closingTags:fn,__Ap:function(iD){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(hg+iD.tagName+hg)!=-1);}
,__Aq:function(s){s=s.replace(/&/ig,gx);s=s.replace(/</ig,fc);s=s.replace(/>/ig,gg);s=s.replace(/\x22/ig,hJ);s=s.replace(/\xA9/ig,S);return s;}
,isParagraphParent:function(iE){if(!qx.dom.Node.isElement(iE)){return false;}
;iE=qx.dom.Node.getName(iE);return /^(body|td|th|caption|fieldset|div)$/.test(iE);}
,isHeadlineNode:function(iF){if(!qx.dom.Node.isElement(iF)){return false;}
;var iG=qx.dom.Node.getName(iF);return /^h[1-6]$/.test(iG);}
},properties:{contentType:{check:hV,init:gY},messengerMode:{check:hp,init:false},insertParagraphOnLinebreak:{check:hp,init:true},insertLinebreakOnCtrlEnter:{check:hp,init:true},postProcess:{check:t,nullable:true,init:null},useUndoRedo:{check:hp,init:true},nativeContextMenu:{check:hp,init:false},defaultFontFamily:{check:hV,init:fQ},defaultFontSize:{check:hW,init:4}},members:{__lm:null,__cX:false,__Ar:false,__As:false,__At:false,__Au:false,__Al:null,__Av:null,__Aw:null,__Ax:null,__ra:null,__Ak:null,__Ay:null,__Az:null,__AA:false,__AB:false,__AC:function(iH){if(qx.dom.Node.isElement(iH)&&qx.dom.Node.isNodeName(iH,p)){this.__lm=iH;}
;}
,_createAndAddIframe:function(iI){this.__ra=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__ra,iI);if((qx.core.Environment.get(eK)==gN)){qx.bom.element.Attribute.set(this.__ra,gS,fm);}
else {qx.bom.element.Style.set(this.__ra,hf,hd);}
;qx.bom.element.Style.setStyles(this.__ra,{width:gr,height:gr});qx.dom.Element.insertBegin(this.__ra,this.__lm);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__ra);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__ra);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__ra,C,this._loaded,this);}
,__AD:function(){this.__Ay={"xhtml":{doctype:hL+gD+hH+hi+eX+hU,html:hh+N,meta:hE,style:qx.core.Environment.select(eK,{"mshtml":eH+fW,"default":fL+gL}),contentStyle:fX,body:ib,footer:fs}};}
,__zV:fD,getIframeObject:function(){return this.__ra;}
,getCommandManager:function(){return this.__Al;}
,setValue:function(iK){if(qx.lang.Type.isString(iK)){this.__zV=iK;var iJ=this._getIframeDocument();if(iJ&&iJ.body){iJ.body.innerHTML=this.__AE(iK);}
;}
;}
,__AE:function(iO){var iN=fD;if((qx.core.Environment.get(eK)==hr)){if(qx.core.Environment.get(gO)<=2){iN+=fu;}
;}
;var iP=iO.length==0?hR:fD;var iM=qx.core.Environment.get(eK)==hr||qx.core.Environment.get(eK)==fO?G:fl;var iL=hT+hI+this.getDefaultFontFamily()+gF+E+iM+L+this.getDefaultFontSize()+gF+iN+iO+iP+hj+c+hs;return iL;}
,getValue:function(){return this.__zV;}
,getComputedValue:function(iQ){return this.getHtml(iQ);}
,getCompleteHtml:function(){var iS=this.__Ay[this.getContentType()];var iR=iS.html+gs+iS.meta+hX+iS.contentStyle+hS+gm;iR+=fC+this.__AF()+O;iR+=this.getHtml()+fs;return iR;}
,__AF:function(){var iW=[d,hv,gu,I,B,v,hB,hb,gH,eO,hq,fw,go,fK];var iU=qx.bom.element.Style;var iT=this.getContentBody();var iY={};var iV,ja;var iX=qx.core.Environment.get(eK)==gN?2:1;for(var i=0,j=iW.length;i<j;i++ ){iV=iW[i];ja=iU.get(iT,iV,iX);if(ja!==undefined&&ja!=fD){iY[iV]=ja;}
;}
;return qx.bom.element.Style.compile(iY);}
...
;}
,getWords:function(jb){if(!jb){jb=this.getContentBody();}
;if(!jb){return [];}
;var jd=jb.cloneNode(true);var jf=jd.innerHTML;jf=jf.replace(/>/gi,hA);jf=jf.replace(/\n/gi,hg);jf=jf.replace(/<!--.*-->/gi,fD);jd.innerHTML=jf;var jc=qx.core.Environment.get(eK)==gN||qx.core.Environment.get(eK)==Q?jd.innerText:jd.textContent;var je=jc.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);return !je?[]:je;}
,getWordsWithElement:function(){var jh=this.getTextNodes();var jl={};var i,j,jm,ji,jg;for(var i=0,jk=jh.length;i<jk; ++i){ji=jh[i];jm=ji.nodeValue.split(hg);for(var j=0,jj=jm.length;j<jj; ++j){jg=this._cleanupWord(jm[j]);if(jg!=null&&jg.length>1){if(!jl[jg]){jl[jg]=[];}
;jl[jg].push(ji);}
;}
;}
;return jl;}
,_cleanupWord:function(jn){if(!jn){return null;}
;return jn.replace(qx.bom.htmlarea.HtmlArea.CleanupWordsRegExp,fD);}
,getTextNodes:function(){return this._fetchTextNodes(this.getContentBody());}
,_fetchTextNodes:function(jq){var jp=[];var jo;if(jq.hasChildNodes){for(var i=0;i<jq.childNodes.length;i++ ){jo=this._fetchTextNodes(jq.childNodes[i]);qx.lang.Array.append(jp,jo);}
;}
;if(jq.nodeType==3){if(jq.nodeValue.length>1){jp.push(jq);}
;}
;return jp;}
,__AG:0,__AH:function(){var jr=this._getIframeDocument();if(!jr){this.__AG++ ;if(this.__AG>5){this.error(hx+jr);this.fireDataEvent(fR);}
else {if(qx.core.Environment.get(fb)){this.error(D);}
;qx.event.Timer.once(function(){this.__AH();}
,this,0);}
;}
else {this.__AG=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__As){return;}
;if(this.__Ar){this.__AI();return;}
;if((qx.core.Environment.get(eK)==gN)){this.__AH();}
else {this._onDocumentIsReady();}
;}
,isReady:function(){return this.__cX;}
,_onDocumentIsReady:function(){var js=new qx.bom.htmlarea.manager.Command(this);if(this.getUseUndoRedo()){js=new qx.bom.htmlarea.manager.UndoRedo(js,this);}
;this.__As=true;if((qx.core.Environment.get(eK)==gN)){this.setEditable(true);}
;this.__AL();if(!(qx.core.Environment.get(eK)==Q)){this.__zo();}
;if(!(qx.core.Environment.get(eK)==gN)){this.setEditable(true);}
;this.__cX=true;this.__Al=js;js.setContentDocument(this._getIframeDocument());this.__AQ();if((qx.core.Environment.get(eK)==Q)){this.__zo();}
;this.fireEvent(gI);}
,forceEditable:qx.core.Environment.select(eK,{"gecko":function(){var jt=this._getIframeDocument();if(jt){if(parseFloat(qx.core.Environment.get(k))>=fk){jt.designMode=fV;jt.body.contentEditable=false;jt.body.contentEditable=true;}
else {jt.body.contentEditable=true;this.__AR(true);}
;}
;}
,"default":(function(){}
)}),invalidateEditor:qx.core.Environment.select(eK,{"gecko":function(){this.__As=false;this.__cX=false;this.__Ar=true;}
,"default":function(){}
}),__AI:qx.core.Environment.select(eK,{"gecko":function(){this.__AL();this.__zo();this.__Al.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__As=true;this.__cX=true;this.__Ar=false;this.fireEvent(fU);}
,"default":function(){}
}),__AJ:function(jw){var jv=fD;if(!jw){return jv;}
;try{var ju=jw.getAttribute(gi);if(!ju){return jv;}
;if((qx.core.Environment.get(eK)==gN)){jv=ju.cssText;}
else {jv=ju;}
;}
catch(jx){this.error(gh);}
;return jv;}
,__AK:function(jB){var jA=qx.core.Environment.get(eK)==hr?gP:fD;var jz=this.__Ay[this.getContentType()];var jy=gs+jz.meta+hX+jA+jz.style+jz.contentStyle+this.__Ak+hS+gm;var content=jz.body+jB;return jz.html+jy+content+jz.footer;}
,__AL:function(){var jD=this.__AE(this.getValue());if(qx.lang.Type.isString(jD)){var jC=this._getIframeDocument();try{jC.open(eP,true);jC.write(this.__AK(jD));jC.close();}
catch(e){this.error(x+qx.bom.Iframe.queryCurrentUrl(this.__ra)+fe,e);this.fireDataEvent(fR,e);}
;}
;}
,__zo:function(){this.__AM();this.__AO();this.__AN();}
,__AM:function(){var jF=qx.event.Registration;var jE=this._getIframeDocument();jF.addListener(jE.body,he,this._handleKeyPress,this);jF.addListener(jE.body,fx,this._handleKeyUp,this);jF.addListener(jE.body,fy,this._handleKeyDown,this);}
,__AN:function(){var jI=qx.event.Registration;var jG=this._getIframeDocument();var jH=qx.core.Environment.get(eK)==fO?this._getIframeWindow():jG.body;jI.addListener(jH,hK,this._handleFocusEvent,this);jI.addListener(jH,eD,this._handleBlurEvent,this);jI.addListener(jG,fS,this._handleFocusOutEvent,this);}
,__AO:function(){var jL=qx.event.Registration;var jK=this._getIframeDocument();var jJ=qx.core.Environment.get(eK)==gN?ia:X;jL.addListener(jK.body,jJ,this._handleMouseUpOnBody,this);jL.addListener(jK.documentElement,jJ,this._handleMouseUpOnDocument,this);jL.addListener(jK.documentElement,fT,this._handleContextMenuEvent,this);}
,__AP:function(){if(this.__Av==null){this.__Av={execute:function(jM,jN){this.stackedCommands=true;this.commandStack.push({command:jM,value:jN});}
,commandStack:[],stackedCommands:false};}
;this.__Av.stackedCommands=false;return this.__Av;}
,__AQ:function(){var jO=this.__Av;if(jO!=null&&jO.stackedCommands){var jP=jO.commandStack;if(jP!=null){for(var i=0,j=jP.length;i<j;i++ ){this.__Al.execute(jP[i].command,jP[i].value);}
;}
;}
;}
,__AR:function(jQ){var jR=this._getIframeDocument();if(this.__As&&jR){try{if((qx.core.Environment.get(eK)==hr)){jR.designMode=(jQ!==false)?gy:u;}
;jR.designMode=(jQ!==false)?u:gy;}
catch(e){}
;}
;}
,setEditable:function(jT){if(this.__As){this.__AR(true);if((qx.core.Environment.get(eK)==hr)){try{var jS=this._getIframeDocument();jS.execCommand(ga,false,true);}
catch(jU){try{var jS=this._getIframeDocument();jS.execCommand(eT,false,false);}
catch(jV){if(!this.__cX){this.error(m);this.fireDataEvent(fR,jV);}
...
;this.__At=jT;}
;}
,getEditable:function(){return this.__At;}
,isEditable:function(){return this.__At;}
,__AS:false,_handleKeyUp:function(e){var jW=e.getKeyIdentifier().toLowerCase();this.__Aw=e;if((qx.core.Environment.get(fb))&&qx.core.Environment.get(eF)){this.debug(e.getType()+hP+jW);}
;if(qx.core.Environment.get(eK)==gN||qx.core.Environment.get(eK)==fO){if(this.__AS){switch(jW){case Y:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(eK)==fO)){this.__AT();e.preventDefault();e.stopPropagation();}
else {var jX=this.__Be(this.getSelection());if(jX){jX.collapse(true);jX.pasteHTML(ft);}
;}
;this.__AY();}
;break;case eM:this.__AS=false;return;break;};}
;}
else if((qx.core.Environment.get(eK)==hr)){switch(jW){case hc:case q:case eW:case gK:case g:case hC:case hY:case n:case U:this.__Au=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__AT:function(){var jY=this.getSelection();var ka=fD;if(jY&&(jY.focusNode.textContent==fD||jY.focusNode.parentElement.tagName==hO)){ka=o;}
;this.__Al.execute(ge,ka+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
,_handleKeyDown:qx.core.Environment.select(eK,{"mshtml|webkit":function(e){var kb=e.getKeyIdentifier().toLowerCase();if((qx.core.Environment.get(fb))&&qx.core.Environment.get(eF)){}
;if(this.__AS&&(kb==fo||kb==gd||kb==fv||kb==hQ||kb==M||kb==gt)){e.preventDefault();e.stopPropagation();}
;if(kb==eM){this.__AS=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var kg=this.getContentDocument();var kc=e.getKeyIdentifier().toLowerCase();var ke=e.isCtrlPressed();var kf=e.isShiftPressed();this.__Aw=e;if((qx.core.Environment.get(fb))&&qx.core.Environment.get(eF)){this.debug(e.getType()+hP+kc);}
;if(this.__AA){var km=!((qx.core.Environment.get(eK)==gN)&&kc==Y)||!((qx.core.Environment.get(eK)==hr)&&kc==Y);if(km){this.__AY();this.__AA=false;}
;}
;switch(kc){case Y:if(!kf&&!ke&&this.getMessengerMode()){e.preventDefault();e.stopPropagation();this.fireDataEvent(fh,this.getComputedValue());this.resetHtml();}
;if(ke){if(!this.getInsertLinebreakOnCtrlEnter()){return;}
;e.preventDefault();e.stopPropagation();if((qx.core.Environment.get(eK)==hr)){if(this.__Bc()){this.insertHtml(eJ);this.__AY();return;}
;this.insertHtml(eV);}
else if((qx.core.Environment.get(eK)==Q)){var kj=this.getSelection();var kh=this.__Be(kj);if(kj&&kh){var ki=kg.createElement(hk);kh.collapse(true);kh.insertNode(ki);kh.collapse(true);kh.selectNode(ki);kj.addRange(kh);kh.collapse(true);}
;}
;this.__AY();}
;if((qx.core.Environment.get(eK)==gN)){if(!this.getInsertParagraphOnLinebreak()){if(this.__Al.execute(ge,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__AY();e.preventDefault();e.stopPropagation();}
;}
;}
else if((qx.core.Environment.get(eK)==hr)){if(this.getInsertParagraphOnLinebreak()&&!kf&&!ke){var kj=this.getSelection();if(kj){var kl=kj.focusNode;if(this.__Bc()){this.__AY();return;}
;if(this.__Bd()){this.__AY();return;}
;while(!qx.dom.Node.isNodeName(kl,gU)){if(qx.dom.Node.isNodeName(kl,f)){this.__AY();return;}
;kl=kl.parentNode;}
;}
;this.__Al.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__AY();this.__AA=true;}
;}
else if((qx.core.Environment.get(eK)==fO)){if(this.getInsertParagraphOnLinebreak()&&kf){this.__AT();e.preventDefault();e.stopPropagation();this.__AY();}
;}
;break;case eW:if(qx.core.Environment.get(eK)==hr&&qx.core.Environment.get(k)<1.9&&kf){var kj=this.getSelection();if(kj&&kj.focusNode==kg.body.firstChild){if(this.__Au){if(kj.focusOffset!=0){kj.extend(kj.focusNode,0);}
;}
;}
;}
;this.__AY();break;case y:if(qx.core.Environment.get(eK)==hr&&qx.core.Environment.get(k)<1.9){if(ke){var kj=this.getSelection();if(kf){if(kj&&(kj.focusOffset!=0)||(kj.focusNode!=kg.body.firstChild)){kj.extend(kg.body.firstChild,0);}
;}
else {var kd=null;var kk;if(kg){kd=kg.evaluate(fG,kg.body,null,XPathResult.ANY_TYPE,null);}
;if(kd&&kj){while(kk=kd.iterateNext()){if(kk&&kk.parentNode&&kk.parentNode.tagName!=eN){try{kj.extend(kk,0);if(!this.isSelectionCollapsed()){kj.collapseToStart();}
;}
catch(kn){}
;break;}
;}
...
;}
;}
;this.__AY();break;case hc:case q:case gK:case g:case hC:case hY:case n:case U:this.__AY();break;case fv:if(ke){this.__AU(R,true);}
;break;case M:case gt:if(ke){this.__AU(hM,true);}
;break;case hQ:if(ke){this.__AU(P,true);}
;break;case fo:if(ke&&!kf){this.__AU(h,true);}
else if(ke&&kf){this.__AU(gv,true);}
;break;case gd:if(ke){this.__AU(gv,true);}
;break;case gw:if(ke){this.selectAll();}
;break;};this.__Aw=null;}
,__AU:function(ko,kr){var kq=null;var kp=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(kp[ko]){kq=kp[ko].method;}
;if(kq!=null&&this[kq]){this[kq]();if(kr){this.__Aw.preventDefault();this.__Aw.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__AA=true;}
;this.__AY();}
;}
,_handleFocusEvent:function(e){this.__Ax=null;if(qx.core.Environment.get(eK)==hr||qx.core.Environment.get(eK)==fO){var ks=this.getContentDocument().getElementById(ic);if(ks){qx.bom.element.Attribute.reset(ks,gc);}
;}
;this.fireEvent(A);}
,_handleBlurEvent:function(e){this.__zV=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__AS=false;if(this.__Ax==null){this.__Ax=this.getSelectedHtml();}
;this.fireEvent(ho);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(fb))&&qx.core.Environment.get(eF)){this.debug(ht+e.getType());}
;this.__AB=true;this.__AY();}
,_handleMouseUpOnDocument:qx.core.Environment.select(eK,{"mshtml":(function(){}
),"default":function(e){if(!this.__AB){qx.bom.Element.activate(this.getContentBody());}
;this.__AB=false;}
}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var ku=e.getViewportLeft();var kt=e.getViewportTop();var kv=qx.bom.element.Location.getLeft(this.__lm)+ku;var kw=qx.bom.element.Location.getTop(this.__lm)+kt;var kx={x:kv,y:kw,relX:ku,relY:kt,target:e.getTarget()};e.preventDefault();e.stopPropagation();qx.event.Timer.once(function(){this.fireDataEvent(fT,kx);}
,this,0);}
;}
,isLoaded:function(){return this.__As;}
,insertHtml:function(ky){return this.__Al.execute(ge,ky);}
,removeFormat:function(){var kz=this.__Al.execute(gG);this.__Al.execute(gX,this.getDefaultFontSize());this.__Al.execute(fz,this.getDefaultFontFamily());return kz;}
,setBold:function(){return this.__Al.execute(W);}
,setItalic:function(){return this.__Al.execute(gE);}
,setUnderline:function(){return this.__Al.execute(hl);}
,setStrikeThrough:function(){return this.__Al.execute(eS);}
,setFontSize:function(kA){return this.__Al.execute(gX,kA);}
,setFontFamily:function(kB){return this.__Al.execute(fz,kB);}
,setTextColor:function(kC){return this.__Al.execute(w,kC);}
,setTextBackgroundColor:function(kD){return this.__Al.execute(gf,kD);}
,setJustifyLeft:function(){return this.__Al.execute(hm);}
,setJustifyCenter:function(){return this.__Al.execute(eY);}
,setJustifyRight:function(){return this.__Al.execute(fH);}
,setJustifyFull:function(){return this.__Al.execute(eL);}
,insertIndent:function(){return this.__Al.execute(fj);}
,insertOutdent:function(){return this.__Al.execute(fF);}
,insertOrderedList:function(){return this.__Al.execute(gQ);}
,insertUnorderedList:function(){return this.__Al.execute(ff);}
,insertHorizontalRuler:function(){return this.__Al.execute(gl);}
,insertImage:function(kE){return this.__Al.execute(gz,kE);}
,insertHyperLink:function(kF){return this.__Al.execute(eI,kF);}
,removeBackgroundColor:function(){return this.__Al.execute(l,fr);}
,setBackgroundColor:function(kG){return this.__Al.execute(l,kG);}
,removeBackgroundImage:function(){return this.__Al.execute(gT);}
,setBackgroundImage:function(kH,kJ,kI){return this.__Al.execute(gT,[kH,kJ,kI]);}
,selectAll:function(){return this.__Al.execute(fq);}
,undo:function(){if(this.getUseUndoRedo()){return this.__Al.execute(ha);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__Al.execute(J);}
else {return true;}
;}
,resetHtml:function(){var kK=this._getIframeDocument();while(kK.body.firstChild){kK.body.removeChild(kK.body.firstChild);}
;if(qx.core.Environment.get(eK)==hr){kK.body.innerHTML=gJ;}
else if(qx.core.Environment.get(eK)==fO){var kL=this.getSelection();var kM=kK.createRange();if(kM&&kL){kL.addRange(kM);}
;}
;}
,getHtml:function(kN){var kO=this._getIframeDocument();if(kO==null){return null;}
;return qx.bom.htmlarea.HtmlArea.__Ao(kO.body,false,kN,this.getPostProcess());}
,containsOnlyPlaceholder:qx.core.Environment.select(eK,{"mshtml":function(){var kP=this._getIframeDocument();return (kP.body.innerHTML==gp);}
,"default":(function(){return false;}
)}),_selectElement:function(kS){var kR=this.getContentWindow().getSelection();var kQ=this.getContentDocument().createRange();kQ.setStart(kS,0);kR.removeAllRanges();kR.addRange(kQ);}
,focusContent:qx.core.Environment.select(eK,{"gecko":function(){var kU=this.getContentDocument();var kT=kU.getElementById(ic);this.getContentWindow().focus();qx.bom.Element.focus(this.getContentBody());if(kT){this._selectElement(kT);}
else {this.__AV();}
;}
,"webkit":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());var kV=this.getContentDocument().getElementById(ic);if(kV){qx.bom.element.Attribute.reset(kV,gc);}
;this.__AV();}
,"opera":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());this.__AV();}
,"default":function(){qx.bom.Element.focus(this.getContentBody());this.__AV();}
}),__AV:function(){if(!this.__AW()){this.__AX();}
;}
,__AW:qx.core.Environment.select(eK,{"gecko":function(){var kW=this.getContentBody().childNodes;if(kW.length==0){return false;}
else if(kW.length==1){return !(kW[0]&&qx.dom.Node.isNodeName(kW[0],hk)&&qx.bom.element.Attribute.get(kW[0],fd)!=null);}
else {return true;}
;}
,"webkit":function(){var kX=this.getContentBody().childNodes;if(kX.length==0){return false;}
else if(kX.length==1){return !(kX[0]&&qx.dom.Node.isNodeName(kX[0],hk));}
else {return true;}
;}
,"default":function(){var kY=this.getContentBody().childNodes;if(kY.length==0){return false;}
else if(kY.length==1){return !(kY[0]&&qx.dom.Node.isNodeName(kY[0],hN)&&kY[0].firstChild==null);}
else {return true;}
;}
}),__AX:qx.core.Environment.select(eK,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__AE(fD);var la=this.getContentDocument().getElementById(ic);qx.bom.element.Attribute.reset(la,gc);this._selectElement(la);}
,"default":function(){var lb=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());if(qx.dom.Node.isNodeName(lb,hN)){qx.bom.element.Style.set(lb,gM,this.getDefaultFontFamily());qx.bom.element.Style.set(lb,eQ,this.getDefaultFontSize());}
;}
}),getContextInformation:function(){return this.__Ba();}
,__AY:function(){qx.event.Timer.once(function(e){var lc=this.__Ba();this.fireDataEvent(V,lc);}
,this,200);}
,__Ba:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return null;}
;this._processingExamineCursorContext=true;if(!this.__AW()){this.__AX();}
;var lg=this.getFocusNode();if(lg==null){return null;}
;if(qx.dom.Node.isText(lg)){lg=lg.parentNode;}
;var lk=this._getIframeDocument();var lt=(qx.core.Environment.get(eK)==gN)?lg.currentStyle:lk.defaultView.getComputedStyle(lg,null);var lm=false;var ld=false;var li=false;var lh=false;var ll=false;var ls=false;var lj=false;var lu=false;var lf=false;var lp=false;var lq=null;var lr=null;var ln=null;if(lt!=null){if((qx.core.Environment.get(eK)==gN)){ld=lt.fontStyle==gE;li=lt.textDecoration.indexOf(hl)!==-1;lh=lt.textDecoration.indexOf(fp)!==-1;lq=lt.fontSize;ln=lt.fontFamily;lj=lt.textAlign==hc;lu=lt.textAlign==hu;lf=lt.textAlign==q;lp=lt.textAlign==hw;}
else {ld=lt.getPropertyValue(gV)==gE;li=lt.getPropertyValue(hn).indexOf(hl)!==-1;lh=lt.getPropertyValue(hn).indexOf(fp)!==-1;lq=lt.getPropertyValue(eQ);ln=lt.getPropertyValue(gM);lj=lt.getPropertyValue(hG)==hc;lu=lt.getPropertyValue(hG)==hu;lf=lt.getPropertyValue(hG)==q;lp=lt.getPropertyValue(hG)==hw;}
;if(qx.core.Environment.get(eK)==gN||qx.core.Environment.get(eK)==Q){lm=lt.fontWeight==700;}
else {lm=lt.getPropertyValue(hy)==W||qx.dom.Node.isNodeName(lg,fv);}
;}
;var le=lg;if(le!=null&&le.parentNode!=null&&!qx.dom.Node.isDocument(le.parentNode)){while(le!=null&&!qx.dom.Node.isNodeName(le,gU)){var lv=qx.dom.Node.getName(le);if(lv==fJ){ls=true;break;}
else if(lv==T){ll=true;break;}
;if(lr==null||lr==fD){lr=qx.bom.element.Attribute.get(le,gq);}
;le=le.parentNode;}
;}
;var lo={bold:lm?1:0,italic:ld?1:0,underline:li?1:0,strikethrough:lh?1:0,fontSize:(lr==null)?lq:lr,fontFamily:ln,insertUnorderedList:ll?1:0,insertOrderedList:ls?1:0,justifyLeft:lj?1:0,justifyCenter:lu?1:0,justifyRight:lf?1:0,justifyFull:lp?1:0};this._processingExamineCursorContext=false;return lo;}
,getSelection:qx.core.Environment.select(eK,{"mshtml":function(){return this._getIframeDocument()?this._getIframeDocument().selection:null;}
,"default":function(){return this._getIframeWindow()?this._getIframeWindow().getSelection():null;}
}),isSelectionCollapsed:qx.core.Environment.select(eK,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==eR;}
,"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;}
}),getSelectedText:qx.core.Environment.select(eK,{"mshtml":function(){return this.getRange()?this.getRange().text:fD;}
,"default":function(){return this.getRange()?this.getRange().toString():fD;}
}),getSelectedHtml:function(){if(this.__Ax!=null){return this.__Ax;}
;var lw=this.getRange();if(!lw){return fD;}
else {return this.__Bb(lw);}
;}
,__Bb:qx.core.Environment.select(eK,{"mshtml":function(lx){if(!lx){return fD;}
;return lx.item?lx.item(0).outerHTML:lx.htmlText;}
,"default":function(lz){var ly=this._getIframeDocument();if(ly&&lz){try{var lA=ly.createElement(gU);lA.appendChild(lz.cloneContents());return lA.innerHTML;}
catch(lB){}
;return lz+fD;}
;return fD;}
}),clearSelection:qx.core.Environment.select(eK,{"mshtml":function(){var lC=this.getSelection();if(lC){lC.empty();}
;}
,"default":function(){var lD=this.getSelection();if(lD){lD.collapseToStart();}
;}
}),__Bc:qx.core.Environment.select(eK,{"gecko":function(){var lE=this.getSelection();var lF=this.getFocusNode();return lE&&this.isSelectionCollapsed()&&lF!=null&&qx.dom.Node.isText(lF)&&lE.anchorOffset<lF.length;}
,"default":function(){return false;}
}),__Bd:qx.core.Environment.select(eK,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());}
,"default":function(){return false;}
}),getRange:function(){return this.__Be(this.getSelection());}
,__Be:qx.core.Environment.select(eK,{"mshtml":function(lH){var lG=this._getIframeDocument();if(lH){try{return lH.createRange();}
catch(lI){return lG?lG.body.createTextRange():null;}
;}
else {return lG?lG.body.createTextRange():null;}
;}
,"default":function(lK){var lJ=this._getIframeDocument();if(lK){try{return lK.getRangeAt(0);}
catch(lL){return lJ?lJ.createRange():null;}
;}
else {return lJ?lJ.createRange():null;}
;}
}),saveRange:qx.core.Environment.select(eK,{"mshtml":function(){this.__Az=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(eK,{"mshtml":function(){return this.__Az;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(eK,{"mshtml":function(){this.__Az=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(eK,{"mshtml":function(){var lM=this.getSelection();var lN;switch(lM.type){case fg:case eR:lN=this.__Be(lM);if(lN){lN.collapse(false);return lN.parentElement();}
else {return null;}
;break;case hD:lN=this.__Be(lM);if(lN){try{lN.collapse(false);}
catch(lO){}
;return lN.item(0);}
else {return null;}
;break;default:return this._getIframeDocument().body;};}
,"default":function(){var lP=this.getSelection();if(lP&&lP.focusNode){return lP.focusNode;}
;return this._getIframeDocument().body;}
})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var lR=this._getIframeDocument();var lT=qx.event.Registration;lT.removeListener(lR.body,he,this._handleKeyPress,this);lT.removeListener(lR.body,fx,this._handleKeyUp,this);lT.removeListener(lR.body,fy,this._handleKeyDown,this);var lS=qx.core.Environment.get(eK)==fO?this._getIframeWindow():lR.body;lT.removeListener(lS,hK,this._handleFocusEvent);lT.removeListener(lS,eD,this._handleBlurEvent);lT.removeListener(lR,fS,this._handleFocusOutEvent);var lQ=qx.core.Environment.get(eK)==gN?ia:X;lT.removeListener(lR.body,lQ,this._handleMouseUpOnBody,this);lT.removeListener(lR.documentElement,lQ,this._handleMouseUpOnDocument,this);lT.removeListener(lR.documentElement,fT,this._handleContextMenuEvent,this);if((qx.core.Environment.get(eK)==gN)){qx.bom.Iframe.setSource(this.__ra,gC);}
;}
catch(lU){}
;if(this.__Al instanceof qx.core.Object){this._disposeObjects(F);}
else {this.__Al=null;}
;this.__Ay=this.__ra=this.__lm=this.__Av=null;}
});}
)();
...
(function(){var a="backgroundColor",b="_moz",c="top",d="/>",f="formatBlock",g=';',h="insertParagraph",m=" succeded",n="li",o='<span style="',p="__BO",q="underline",r="<img ",s="' is not allowed for parameter 'position'. Possible values are '",t="no-repeat",u="</font>",v=' <a href="',w="FONT",x="inserthyperlink failed!",y="backgroundPosition",z="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",A="__placeholder__",B="JustifyCenter",C="transparent",D="Cut",E="outdent",F="__BT",G='</a> ',H="InsertImage",I="font-size",J="__resetHtml",K="FontName",L="__Bv",M="p",N="bold",O="blockquote",P="If an array is provided for parameter 'position' it has to define two elements!",Q="inserthtml",R="span",S='|',T="id",U="style",V='color',W="__BU",X="The method '",Y="qx.bom.htmlarea.manager.Command",dM="'><br class='webkit-block-placeholder' />",dH="string",dN="a",dJ='"',dK="__Bw",dG="<span></span>",dL="__BL",dR="background-color",dS="backgroundRepeat",dT="type",dU="font",dO="CreateLink",dP=":",dI="InsertHtml",dQ="':'",dY="='",eD=" with value ",ea="italic",eb='">',dV="__BJ",dW="' you calling to execute the command '",fE="font-family",dX="mshtml",ec="qx_link",ed="none",ee='"></span>',ej="Italic",ek="fontStyle",el=" ",ef=";",eg=" failed",eh="InsertUnorderedList",ei="__BR",eq="body",er="OL",es='text-align:',et="Bold",em="ForeColor",en="child",eo="px",ep="url(",ey='" ',ez="repeat repeat-x repeat-y no-repeat",fI='</p>',eA="gecko",eu="<hr />",ev="__BK",fG="legacy-font-size",ew="__Br",eB="backgroundImage",eC="editor not ready! '",eO='<font style="',eN="text-align",eM="__BB",eS="Command ",eR="Control",eQ="IMG",eP="__paragraph__",eH="__BS",eG="StrikeThrough",eF='text-decoration',eE="LI",eL="__getHtml",eK='>',eJ="__BM",eI='font-family:',fa='" size="',eY="Indent",eX=':',eW="HiliteColor",fe="br",fd="fontWeight",fc="Copy",fb="</span>",eV="engine.name",eU="Paste",eT="The value '",fp="BackColor",fo="qx.bom.htmlarea.HtmlArea.debug",fn="__BP",ft='<p id="',fs="RemoveFormat",fr="text-decoration",fq="JustifyRight",fi="size",fh="FontSize",fg="' is not allowed for parameter 'repeat'. Possible values are '",ff="' ",fm='',fl="webkit",fk='style="',fj="execCommand ",fz="'",fy="' is not available!",fx="_moz_dirty",fw="color",fD="qx.debug",fC="JustifyLeft",fB="textDecoration",fA=" is currently not supported!",fv="Underline",fu="SelectAll",dC="<p style='",dB="line-through",fJ="BODY",dz=")",dA="",dy="href",fH='<span id="',dw="__By",dx="__BN",dv="UL",fF="JustifyFull",dt="Outdent",du="indent",ds="selectall",dE="__BA",dF="InsertOrderedList",dD="undefined";qx.Class.define(Y,{extend:qx.core.Object,construct:function(fK){qx.core.Object.call(this);this.__Bf=fK;this.__np=null;this._commands=null;this.__Bm();this.__Bg={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__Bh=[10,12,16,18,24,32,48];this.__Bi=0;}
,statics:{__Bj:z,__Bk:ez},members:{__np:null,__Bf:null,__Bl:false,__Bg:null,__Bh:null,__Bi:null,setContentDocument:function(fL){this.__np=fL;}
,getCommandObject:function(fM){if(this._commands[fM]){return this._commands[fM];}
else {return null;}
;}
,__Bm:function(){this._commands={bold:{useBuiltin:false,identifier:et,method:ei},italic:{useBuiltin:false,identifier:ej,method:eH},underline:{useBuiltin:false,identifier:fv,method:F},strikethrough:{useBuiltin:false,identifier:eG,method:W},fontfamily:{useBuiltin:true,identifier:K,method:null},fontsize:{useBuiltin:false,identifier:fh,method:dV},textcolor:{useBuiltin:true,identifier:em,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:ev},backgroundcolor:{useBuiltin:false,identifier:null,method:dL},backgroundimage:{useBuiltin:false,identifier:null,method:eJ},justifyleft:{useBuiltin:false,identifier:fC,method:L},justifyright:{useBuiltin:false,identifier:fq,method:L},justifycenter:{useBuiltin:false,identifier:B,method:L},justifyfull:{useBuiltin:false,identifier:fF,method:L},indent:{useBuiltin:true,identifier:eY,method:null},outdent:{useBuiltin:true,identifier:dt,method:null},copy:{useBuiltin:true,identifier:fc,method:null},cut:{useBuiltin:true,identifier:D,method:null},paste:{useBuiltin:true,identifier:eU,method:null},insertorderedlist:{useBuiltin:false,identifier:dF,method:dK},insertunorderedlist:{useBuiltin:false,identifier:eh,method:dK},inserthorizontalrule:{useBuiltin:false,identifier:dI,method:eM},insertimage:{useBuiltin:false,identifier:H,method:dw},inserthyperlink:{useBuiltin:false,identifier:dO,method:dE},selectall:{useBuiltin:false,identifier:fu,method:dx},selectedtext:{useBuiltin:false,identifier:null,method:p},selectedhtml:{useBuiltin:false,identifier:null,method:fn},inserthtml:{useBuiltin:false,identifier:dI,method:ew},resethtml:{useBuiltin:false,identifier:null,method:J},gethtml:{useBuiltin:false,identifier:null,method:eL},removeformat:{useBuiltin:true,identifier:fs,method:null}};}
,execute:function(fN,fP){if(!this.__Bf.isReady()){this.error(eC+fN+dQ+fP+fz);return false;}
;fN=fN.toLowerCase();fP=fP!=null?fP:null;if(this._commands[fN]){var fO;var fQ=this._commands[fN];if(!((qx.core.Environment.get(eV)==fl)&&(fN==du||fN==E))){if(this.__Bn()){this.__Bo();}
;}
;if(fQ.useBuiltin){fO=this.__Bp(fQ.identifier,false,fP);}
else {if(fQ.method!=null&&this[fQ.method]){fO=this[fQ.method].call(this,fP,fQ);}
else {this.error(X+fQ.method+dW+fN+fy);}
;}
;this.__Bf.resetSavedRange();return fO;}
else {this.error(eS+fN+fA);}
;}
,__Bn:function(){var Node=qx.dom.Node;var fR=this.__Bf.getFocusNode();var fU=false;var fS=false;if(fR){if(Node.isText(fR)){var fT=qx.dom.Hierarchy.getAncestors(fR);for(var i=0,j=fT.length;i<j;i++ ){if(Node.isNodeName(fT[i],M)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(fT[i])){fU=true;break;}
;}
;}
else if(Node.isNodeName(fR,eq)){fS=true;}
;}
;return fS||!fU;}
,__Bo:function(){this.__Bp(f,false,M);}
,__Bp:function(gc,ga,fX){try{var fW=this.__np;var fV=false;var fY=this.__Bf.getRange();this.__np.body.focus();if((qx.core.Environment.get(eV)==dX)){if(gc!=ds){fY.select();if(((fY.text)&&(fY.text.length>0))||((fY.length==1)&&(fY.item(0))&&(fY.item(0).tagName==eQ))){fW=fY;}
else {fW=this.__np;}
;}
;if(((qx.core.Environment.get(eV)==dX))&&(this.__Bg[gc])){if(fY.text==dA){fV=true;}
;}
;}
;var gb=fW.execCommand(gc,ga,fX);if(fV&&fY.text!=dA){fY.collapse();}
;if((qx.core.Environment.get(fD))&&qx.core.Environment.get(fo)){this.debug(fj+gc+eD+fX+m);}
;this.__Bl=false;}
catch(gd){if((qx.core.Environment.get(fD))&&qx.core.Environment.get(fo)){this.debug(fj+gc+eD+fX+eg);}
;return false;}
;return gb;}
,__Bq:qx.core.Environment.select(eV,{"mshtml":function(){var gf=this.__Bf;var ge=gf.getSavedRange()!=null?gf.getSavedRange():gf.getRange();return ge;}
,"default":function(){return this.__Bf.getRange();}
}),__Br:qx.core.Environment.select(eV,{"mshtml":function(gj,gk){var gi;if(gj==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__Bu();}
else {this.__np.body.focus();var gh=this.__Bf.getSelection();var gg=this.__Bq();if(gg&&gh&&gh.type!=eR){try{gg.pasteHTML(gj);gg.collapse(false);gg.select();gi=true;}
catch(e){}
;}
else {gi=false;}
;this.__Bf.resetSavedRange();return gi;}
;}
,"default":function(gl,gm){this.__np.body.focus();return this.__np.execCommand(gm.identifier,false,gl);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(eV,{"gecko":function(){var gu=this.__BE();var gy=this.__Bs(gu);var gq=this.__BC(gu);var gv=A+Date.parse(new Date());var gw=eP+Date.parse(new Date());var go=fm;var gs=fH+gv+ee;go+=gs;go+=ft+gw+ey+gy+eK;go+=gq+fI;this.__Bf.getCommandManager().addUndoStep(Q,h,this.getCommandObject(Q));this.execute(Q,go);this.__Bt();qx.bom.element.Attribute.reset(this.__np.getElementById(gv),T);var gt=this.__np.getElementById(gw);if(gt.previousSibling.innerHTML==gs){var gn=this.__BD();var gr=this.__np.createElement(fe);var gp=this.__np.createAttribute(fx);gp.nodeValue=dA;gr.setAttributeNode(gp);var gx=this.__np.createAttribute(dT);gx.nodeValue=b;gr.setAttributeNode(gx);gt.previousSibling.appendChild(gn);gt.previousSibling.appendChild(gr);}
;qx.bom.element.Attribute.reset(gt,T);return true;}
,"webkit":function(){var gz=this.getCurrentStyles();var gA=dA;var gC={"background-color":true,"text-align":true};for(var gB in gz){if(gC[gB]){gA+=gB+dP+gz[gB]+ef;}
;}
;this.__Bf.insertHtml(dC+gA+dM);}
,"default":(function(){}
)}),__Bs:qx.core.Environment.select(eV,{"gecko":function(gG){var gI=fk;var gD=gG.child;if(gD[eN]){gI+=es+gD[eN]+g;delete gG.child[eN];}
;if(gD[fE]){gI+=eI+gD[fE]+g;delete gG.child[fE];}
;var gH={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};var gF={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};for(var gE in gD){if(gH[gE]||gF[gE]){gI+=gE+eX+gD[gE]+g;delete gG.child[gE];}
;}
;gI+=dJ;return gI;}
,"default":function(){return dA;}
}),__Bt:qx.core.Environment.select(eV,{"gecko":function(){var gQ=this.__Bf.getSelection();if(!gQ||!gQ.focusNode){return;}
;var gJ=gQ.focusNode;var gO=gQ.focusNode;while(!qx.dom.Node.isNodeName(gO,M)){gO=gO.parentNode;}
;var gN=gO.previousSibling.id;var gR=gO.nextSibling?gO.nextSibling.id:null;if(qx.lang.String.startsWith(gN,eP)&&gN==gR){var gP=gO.nextSibling;var gL=this.__Bf.getRange();gL.selectNode(gP);gQ.addRange(gL);var gK=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__Bf.getCommandManager().addUndoStep(Q,gK,this.getCommandObject(Q));this.execute(Q,gK);var gM=this.__Bf.getRange();if(gJ){while(gJ&&gJ.firstChild&&qx.dom.Node.isElement(gJ.firstChild)){gJ=gJ.firstChild;}
;}
;gM.selectNode(gJ);gQ.addRange(gM);gM.collapse(true);}
;}
,"default":(function(){}
)}),__Bu:qx.core.Environment.select(eV,{"mshtml":function(){var gS=this.__Bf.getRange();if(gS&&!qx.dom.Node.isNodeName(gS.parentElement(),n)){gS.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);gS.collapse(false);gS.select();return true;}
;return false;}
,"default":function(){return false;}
}),__Bv:function(gU,gV){var gT=(qx.core.Environment.get(eV)==dX)?this.__Bf.getRange():this.__np;return gT.execCommand(gV.identifier,false,gU);}
,__Bw:function(gY,ha){if((qx.core.Environment.get(eV)==dX)){var gX=this.__Bf.getFocusNode();this.__Bx(gX);}
;this.__np.body.focus();var gW=this.__np.execCommand(ha.identifier,false,gY);if((qx.core.Environment.get(eV)==fl)){var gX=this.__Bf.getFocusNode();this.__Bx(gX.parentNode);}
;return gW;}
,__Bx:function(hb){var hc=[];var parent=hb.parentNode;while(qx.dom.Node.isNodeName(parent,O)){hc.push(parent);parent=parent.parentNode;}
;if(hc.length>0){parent.appendChild(hb);parent.removeChild(hc[hc.length-1]);}
;}
,__By:qx.core.Environment.select(eV,{"gecko":function(hs,hm){if(hs.src){this.__np.execCommand(hm.identifier,false,hs.src);delete hs.src;var hf=this.__Bf.getSelection();if(hf){var he=hf.anchorNode;var hn=hf.anchorOffset;var hg=he.childNodes[hn-1];var hp;for(var hi in hs){hp=this.__np.createAttribute(hi);hp.nodeValue=hs[hi];hg.setAttributeNode(hp);}
;var hh={"font":true,"span":true};var hd=null;var hl=true;if(qx.dom.Node.isElement(hg.previousSibling)&&hh[qx.dom.Node.getName(hg.previousSibling)]){hd=hg.previousSibling;}
else if(hh[qx.dom.Node.getName(hg.parentNode)]){hd=hg.parentNode;hl=false;}
;var hq=this.__np.createDocumentFragment();var hr;if(hl&&hd!=null){var hh=this.__Bz(hd);hq.appendChild(hh.root);hr=hh.inline;}
else {hr=this.__np.createElement(R);hq.appendChild(hr);}
;var ho=this.__np.createTextNode(dA);hr.appendChild(ho);var hk=hg.parentNode;if(hg==hk.lastChild){hk.appendChild(hq);}
else {hk.insertBefore(hq,hg.nextSibling);}
;var hj=this.__Bf.getRange();hj.selectNodeContents(hr);}
;return true;}
else {return false;}
;}
,"mshtml":function(hx,hu){var hw=false;var ht=r;for(var hv in hx){ht+=hv+dY+hx[hv]+ff;}
;ht+=d;var hy=this.__Bf.getSelection();var hz=this.__Bq();if(hy&&hy.type!=eR){try{hz.select();hz.pasteHTML(ht);hw=true;}
catch(e){}
;}
;this.__Bf.resetSavedRange();return hw;}
,"default":function(hB,hD){if(hB.src){var hC=r;for(var hA in hB){hC+=hA+dY+hB[hA]+ff;}
;hC+=d;return this.__np.execCommand(dI,false,hC);}
else {return false;}
;}
}),__Bz:function(hF){while(hF.firstChild&&hF.firstChild.nodeType==1){hF=hF.firstChild;}
;var hI=this.__BE(hF);var hM,hG,hK;var hE=dA;var parent=null;var hL=null;var hJ=hI.child;while(hJ){hL=this.__np.createElement(hJ[fG]?dU:R);hG=this.__np.createAttribute(U);hL.setAttributeNode(hG);for(var hH in hJ){if(hH!=en&&hH!=fG){hE+=hH+dP+hJ[hH]+ef;}
else if(hH==fG){hK=this.__np.createAttribute(fi);hK.nodeValue=hJ[hH];hL.setAttributeNode(hK);}
;}
;hG.nodeValue=hE;if(parent!=null){parent.appendChild(hL);}
else {hM=hL;}
;parent=hL;hJ=hJ.child;hE=dA;}
;return {root:hM,inline:hL};}
,__BA:qx.core.Environment.select(eV,{"gecko|opera":function(hN,hR){var hU=this.__Bf.getSelection();var hP=this.__Bf.getRange();if(hU.isCollapsed){var hO=ec+( ++this.__Bi);var hV=this.__np.createElement(dN);var hQ=this.__np.createAttribute(dy);var hS=this.__np.createAttribute(T);var hT=this.__np.createTextNode(hN);hS.nodeValue=hO;hV.setAttributeNode(hS);hQ.nodeValue=hN;hV.setAttributeNode(hQ);hV.appendChild(hT);hP.insertNode(hV);hP.selectNode(hV);hU.collapseToEnd();return true;}
else {return this.__np.execCommand(hR.identifier,false,hN);}
;}
,"mshtml":function(hW,ib){try{var ia;var hX=this.__Bq();var hY=this.__Bf;var hX=hY.getSavedRange()!=null?hY.getSavedRange():hY.getRange();if(hX!=null&&hX.text!=dA){ia=hX.execCommand(ib.identifier,false,hW);}
else {ia=this.__Br(v+hW+eb+hW+G,ib);}
;this.__Bf.resetSavedRange();return ia;}
catch(e){if(qx.core.Environment.get(fD)){this.error(x);}
;return false;}
;}
,"default":function(ic,id){return this.__np.execCommand(id.identifier,false,ic);}
}),__BB:function(ig,ih){var ie=eu;if((qx.core.Environment.get(eV)==eA)){ie+=this.__BC();}
;return this.__Br(ie,ih);}
,__BC:function(ij){var im=dA;var il=o;var ik=[];var iq=typeof ij!==dD?ij:this.__BE();var io=iq.child;var ip=false;if(qx.lang.Object.isEmpty(io)){return dA;}
;while(io){ip=io[fG]!=null;im+=ip?eO:il;for(var ii in io){im+=(ii!=en&&ii!=fG)?ii+eX+io[ii]+g:dA;}
;im+=ip?fa+io[fG]+eb:eb;ik.unshift(ip?u:fb);io=io.child;}
;if(ik.length==1&&ik[0]==u){im+=dG;}
;for(var i=0,j=ik.length;i<j;i++ ){im+=ik[i];}
;return im;}
,__BD:function(){var is=this.__np.createDocumentFragment();var ix=this.__BE();var parent=is;var iv=ix.child;var it;var iw=false;while(iv){iw=iv[fG]!=null;it=this.__np.createElement(iw?dU:R);parent.appendChild(it);for(var ir in iv){if(ir!=en&&ir!=fG){qx.bom.element.Style.set(it,ir,iv[ir]);}
;}
;if(iw){var iu=this.__np.createAttribute(fi);iu.nodeValue=iv[fG];it.setAttributeNode(iu);}
;parent=it;iv=iv.child;}
;return is;}
,__BE:function(iz){var iA={};var iB=null;var iC=this.getCurrentStyles(iz);iB=iA.child={};for(var iy in iC){if(iy!=fr){iB[iy]=iC[iy];}
;}
;if(iC[fr]){var iD=iC[fr];for(var i=0,j=iD.length;i<j;i++ ){if(iB==null){iB=iA.child={};}
else {iB=iB.child={};}
;iB[V]=iD[i][V];iB[eF]=iD[i][eF];}
;}
;if(iC[V]&&iC[eF]){iB=iB.child={};iB[V]=iC[V];}
;return iA;}
,getCurrentStyles:function(iG){if(iG==null){var iJ=this.__Bf.getSelection();if(!iJ||iJ.focusNode==null){return {};}
;iG=(iJ.focusNode.nodeType==3)?iJ.focusNode.parentNode:iJ.focusNode;}
;var iH=qx.dom.Hierarchy.getAncestors(iG);var iE=qx.lang.Array.insertBefore(iH,iG,iH[0]);var iI=this.__BF(iE);var iF=this.__BG(iI,iE);return iF;}
,__BF:function(iN){var iM={};var iK,iL;for(var i=0,j=iN.length;i<j;i++ ){iL=iN[i];for(var k=0,l=iL.style.length;k<l;k++ ){iK=iL.style[k];if(iK.length>0&&typeof iM[iK]===dD){iM[iK]=iL.style.getPropertyValue(iK);}
;}
;if(iL.tagName.toUpperCase()==w&&iL.size&&iM[fG]===undefined){iM[fG]=iL.size;}
;}
;if(iM[fG]&&iM[I]){delete iM[I];}
;return iM;}
,__BG:function(iT,iP){var iR=iP[0];var iS=this.__Bf.getContentWindow().getComputedStyle(iR,null);var iU;var iQ={};for(var iO in iT){if(iO!=fG){iU=iS.getPropertyValue(iO);}
else {iU=iT[iO];}
;if(iO==dR&&iU==C){iQ[iO]=this.__BI(iP);}
else if(iO==fr){iQ[iO]=this.__BH(iP);}
else {iQ[iO]=iU;}
;}
;return iQ;}
,__BH:function(iX){var iY,jb,iV;var ja=[];var iW=this.__Bf.getContentWindow();for(var i=0,j=iX.length;i<j;i++ ){iV=iW.getComputedStyle(iX[i],null);iY=iV.getPropertyValue(fr);jb=iV.getPropertyValue(fw);if(iY!=ed){ja.push({'text-decoration':iY,'color':jb});}
;}
;return ja;}
,__BI:function(jd){var je,jc,jf;for(var i=0;i<jd.length;i++ ){je=jd[i];jc=this.__Bf.getContentWindow().getComputedStyle(je,null);jf=jc.getPropertyValue(dR);if(jf!=C){return jf;}
;}
;}
,__BJ:function(jm,jn){var jh=this.__Bf.getSelection();var jl=((qx.core.Environment.get(eV)==dX))?this.__Bf.getRange():jl=jh.getRangeAt(0);var jp=[];var jt;var jk=[er,dv];var jg,i,j,jr;jr=((qx.core.Environment.get(eV)==dX))?jl.parentElement():jl.commonAncestorContainer;if(jr.tagName==fJ){for(var i=0;i<jk.length;i++ ){jg=jr.getElementsByTagName(jk[i]);for(var j=0;j<jg.length;j++ ){if(jg[j]){jp.push(jg[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(jk,jr.tagName)){jp.push(jr);}
;if(jp.length>0){for(var i=0;i<jp.length;i++ ){var js=jp[i];jt=((qx.core.Environment.get(eV)==dX))?((js==jr)||(jr.tagName==fJ)):jh.containsNode(js,false);for(j=0;j<js.childNodes.length;j++ ){var jj=js.childNodes[j];if(jt||(jh.focusNode.nodeValue&&qx.dom.Hierarchy.contains(jj,jh.focusNode)&&(jh.focusOffset==jh.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(jj,jh.anchorNode)&&(jh.anchorOffset==0))||(jh.containsNode(jj,false))){jj.style.fontSize=(this.__Bh[jm]||jm)+eo;}
;}
;}
;}
else {var ji=((qx.core.Environment.get(eV)==dX))?jr:jh.focusNode;var jo=qx.dom.Hierarchy.getAncestors(ji);for(i=0;i<jo.length;i++ ){if(jo[i].tagName==eE){if((((qx.core.Environment.get(eV)==eA))&&((jh.anchorOffset==0)&&(jh.focusNode.nodeValue&&(jh.focusOffset==jh.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(jo[i].firstChild,jh.anchorNode)&&qx.dom.Hierarchy.contains(jo[i].lastChild,jh.focusNode)))||(((qx.core.Environment.get(eV)==dX))&&(jl.htmlText==jo[i].innerHTML))){jo[i].style.fontSize=(this.__Bh[jm]||jm)+eo;}
;break;}
;}
;}
;if((qx.core.Environment.get(eV)==dX)){this.__np.body.focus();this.__Bf.getRange().select();return this.__np.execCommand(fh,false,jm);}
else if((qx.core.Environment.get(eV)==eA)){var parent=jl.commonAncestorContainer;if(parent.nodeType===1){var jq=parent.getElementsByTagName(R);for(i=0;i<jq.length;i++ ){if(jq[i].style.fontSize){jq[i].style.fontSize=null;}
;}
;}
;}
;return this.__np.execCommand(fh,false,jm);}
,__BK:qx.core.Environment.select(eV,{"mshtml":function(ju,jv){this.__np.body.focus();return this.__np.execCommand(fp,false,ju);}
,"gecko|opera":function(jw,jx){this.__np.body.focus();return this.__np.execCommand(eW,false,jw);}
,"webkit":function(jA,jB){var jC=this.__Bf.getSelection();var jz=this.__Bf.getRange();if(!jC||!jC.isCollapsed){this.__np.body.focus();this.__np.execCommand(fp,false,jA);if(jC){jC.collapseToEnd();}
;return true;}
else {var jy=jC.anchorOffset;var jE=jC.anchorOffset;var jz=jC.getRangeAt(0);var jD=jC.anchorNode;while(jE>0){if(jD.nodeValue.charCodeAt(jE)==160||jD.nodeValue.charCodeAt(jE)==32){break;}
else {jE-- ;}
;}
;while(jy<jD.nodeValue.length){if(jD.nodeValue.charCodeAt(jy)==160||jD.nodeValue.charCodeAt(jy)==32){break;}
else {jy++ ;}
;}
;jz.setStart(jC.anchorNode,jC.anchorNode.nodeValue.charAt(jE)==el?jE+1:jE);jz.setEnd(jC.anchorNode,jy);jC.addRange(jz);this.__np.body.focus();this.__np.execCommand(fp,false,jA);jC.collapseToEnd();return true;}
;}
}),__BL:function(jF,jG){jF=jF!=null&&typeof jF==dH?jF:C;qx.bom.element.Style.set(this.__np.body,a,jF);return true;}
,__BM:function(jJ,jK){var jI,jH,jM;var jL=qx.bom.htmlarea.manager.Command;if(jJ==null){jI=null;}
else {jI=jJ[0];jH=jJ[1];jM=jJ[2];}
;if(jI==null||typeof jI!=dH){qx.bom.element.Style.set(this.__np.body,eB,dA);qx.bom.element.Style.set(this.__np.body,dS,dA);qx.bom.element.Style.set(this.__np.body,y,dA);return true;}
else {if(jI.search(/^url.*\(/)==-1){jI=ep+jI+dz;}
;}
;if(jH!=null&&!qx.lang.String.contains(jL.__Bk,jH)){if(qx.core.Environment.get(fD)){this.error(eT+jH+fg+jL.__Bk+fz);}
;return false;}
else {jH=t;}
;if(jM!=null){if(qx.lang.Type.isString(jM)&&!qx.lang.String.contains(jL.__Bj,S+jM+S)){if(qx.core.Environment.get(fD)){this.error(eT+jM+s+jL.__Bj+fz);}
;return false;}
else {if(qx.lang.Type.isArray(jM)&&jM.length==2){jM=jM[0]+el+jM[1];}
else {if(qx.core.Environment.get(fD)){this.error(P);}
;return false;}
;}
;}
else {jM=c;}
;qx.bom.element.Style.set(this.__np.body,eB,jI);qx.bom.element.Style.set(this.__np.body,dS,jH);qx.bom.element.Style.set(this.__np.body,y,jM);return true;}
,__BN:qx.core.Environment.select(eV,{"mshtml":function(jO,jP){var jN=this.__np.body.createTextRange();jN.select();return true;}
,"default":function(jQ,jR){return this.__Bp(jR.identifier,false,jQ);}
}),__BO:function(){return this.__Bf.getSelectedText();}
,__BP:function(){return this.__Bf.getSelectedHtml();}
,__BQ:function(jV,jW){var jU=this.__Bf.getFocusNode();if(jU.textContent==dA){var jT=qx.dom.Hierarchy.getAncestors(jU);jT.unshift(jU);var Node=qx.dom.Node;var jS=qx.bom.element.Style;var jX=jT.shift();while(jT.length>0){if(Node.getName(jX)==M||Node.getName(jX)==eq){break;}
;if(jS.get(jX,jV,jS.LOCAL_MODE)==jW){jS.reset(jX,jV);return true;}
;jX=jT.shift();}
;}
;return false;}
,__BR:qx.core.Environment.select(eV,{"gecko":function(jY,ka){if(this.__BQ(fd,N)){return true;}
else {return this.__Bp(ka.identifier,false,jY);}
;}
,"default":function(kb,kc){return this.__Bp(kc.identifier,false,kb);}
}),__BS:qx.core.Environment.select(eV,{"gecko":function(kd,ke){if(this.__BQ(ek,ea)){return true;}
else {return this.__Bp(ke.identifier,false,kd);}
;}
,"default":function(kf,kg){return this.__Bp(kg.identifier,false,kf);}
}),__BT:qx.core.Environment.select(eV,{"gecko":function(kh,ki){if(this.__BQ(fB,q)){return true;}
else {return this.__Bp(ki.identifier,false,kh);}
;}
,"default":function(kj,kk){return this.__Bp(kk.identifier,false,kj);}
}),__BU:qx.core.Environment.select(eV,{"gecko":function(kl,km){if(this.__BQ(fB,dB)){return true;}
else {return this.__Bp(km.identifier,false,kl);}
;}
,"default":function(kn,ko){return this.__Bp(ko.identifier,false,kn);}
})},destruct:function(){this.__np=this.__Bf=this._commands=null;this.__Bg=this.__Bh=null;}
});}
)();
(function(){var a="undo",b="backgroundColor",c="actionType ",d="mousedown",f="pageup",g="ADD TO UNDO STACK",h="backgroundimage",k="control",l="shift",m="end",n="right",o="qx_link",p="b",q="insertunorderedlist",r="Command",s=" ",t="Undo",u="pagedown",v="k",w="home",x="qx.debug",y="Content",z="Redo",A=" is not managed! Please provide a handler method!",B="table",C="backgroundImage",D="backgroundRepeat",E="p",F="a",G="insertorderedlist",H="y",I="backgroundPosition",J="justifyright",K="redo",L="insertParagraph",M="qx.bom.htmlarea.manager.UndoRedo",N="left",O="i",P="backgroundcolor",Q="td",R="img",S="Internal",T="__Al",U="u",V="inserthyperlink",W="gecko",X="enter",Y="mshtml",bu="engine.name",bv="mouseup",bw="keypress",bq="execCommand failed! Details: ",br="ADD TO REDO STACK",bs="qx.bom.htmlarea.HtmlArea.debug",bt="webkit",bA="insertimage",bB="inserthtml",bC="z",bD="Custom",bx="undoRedoState",by="down",bz="up",bp="body";qx.Class.define(M,{extend:qx.core.Object,construct:function(bF,bE){qx.core.Object.call(this);this.__Al=bF;this.__Bf=bE;this.__BV=[];this.__BW=[];this._commands=null;this.__np=null;this.__BX={};this.__BY={command:true,content:true,custom:true};this.__Bm();this.__Ca=qx.lang.Function.bind(this._handleKeyPress,this);this.__Cb=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(bu)==Y)){this.__Cc=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__Cd:false,__Ce:false,__Cf:false,__BY:null,__BX:null,__Al:null,__np:null,__BV:null,__BW:null,__Bf:null,__Ca:null,__Cb:null,__Cc:null,__Cg:null,setContentDocument:function(bG){this.__np=bG;this.__Al.setContentDocument(bG);qx.event.Registration.addListener(bG.body,bw,this.__Ca,this);qx.event.Registration.addListener(bG.body,bv,this.__Cb,this);if((qx.core.Environment.get(bu)==Y)){qx.event.Registration.addListener(bG.body,d,this.__Cc,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__Al.insertParagraphOnLinebreak();}
,execute:function(bH,bJ){var bI;bH=bH.toLowerCase();if(this._commands[bH]){if(this._commands[bH].passthrough){bI=this.__Al.execute(bH,bJ);}
else {bI=this[bH].call(this);}
;}
else {if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){this.__Cx(bH,bJ,this.__Al.getCommandObject(bH));bI=this.__Al.execute(bH,bJ);if(!bI){this.__BV.pop();}
;}
else {bI=this.__Al.execute(bH,bJ);if(bI){this.__Cx(bH,bJ,this.__Al.getCommandObject(bH));}
;}
;if(bH==a&&this.__BV.length==0){this.__Ce=false;this.__CF();}
else if(bH==K&&this.__BW.length==0){this.__Cd=false;this.__CF();}
;}
;this.__Cf=false;return bI;}
,addUndoStep:function(bK,bL,bM){this.__Cx(bK,bL,bM);}
,registerHandler:function(bO,bN,bQ,bP){this.__BX[bO]={undo:bN,redo:bQ,context:bP};}
,isUndoPossible:function(){return this.__Ce;}
,undo:function(){var bT;if(this.__Cf){this.__Cz();}
;if(this.__BV.length>0){var bS=this.__BV.pop();if(this.__BY[bS.actionType.toLowerCase()]){switch(bS.actionType){case r:bT=this.__Ci(bS);break;case y:bT=this.__Cm(bS);break;case S:bT=this.__Cl(bS);break;case bD:bT=this.__Ch(bS);break;};}
else if(this.__BX[bS.actionType]){var bR=this.__BX[bS.actionType];bT=bR.undo.call(bR.context?bR.context:this,bS);this.__CB(bS);}
else {this.error(c+bS.actionType+A);}
;this.__Cd=true;this.__CF();return bT;}
;}
,__Ch:qx.core.Environment.select(bu,{"mshtml|webkit":function(bW){var bU=this.__np.body.innerHTML;var bX=bW.content;this.__np.body.innerHTML=bX;var bV=bW;bV.content=bU;this.__CB(bV);return true;}
,"default":function(cc){var cb=cc;var ca=qx.bom.element.Style;switch(cc.command){case P:cb.parameter=[ca.get(this.__np.body,b)];break;case h:cb.parameter=[ca.get(this.__np.body,C),ca.get(this.__np.body,D),ca.get(this.__np.body,I)];break;};this.__CB(cb);if(cc.command==V){if((qx.core.Environment.get(bu)==W)){var cd=o+this.__Al.__hyperLinkId;var bY=this.__np.getElementById(cd);if(bY){bY.parentNode.removeChild(bY);return true;}
else {return false;}
;}
;}
else {return this.__Al.execute(cc.command,cc.value);}
;}
}),__Ci:qx.core.Environment.select(bu,{"mshtml|webkit":function(ce){}
,"default":function(cf){this.__CB(cf);if((qx.core.Environment.get(bu)==W)){if(cf.command==bB&&cf.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__Cj(bB,L)){this.__Ck();}
;}
;return this.__Cn();}
}),__Cj:function(cg,ch){if(this.__BV.length>0){var ci=this.__BV[this.__BV.length-1];return (ci.command==cg&&ci.value==ch);}
;return false;}
,__Ck:function(){this.__Cn();if(this.__BV.length>0){var cj=this.__BV.pop();this.__CB(cj);}
;}
,__Cl:function(ck){this.__CB(ck);return this.__Cn();}
,__Cm:qx.core.Environment.select(bu,{"gecko":function(cl){this.__CB(cl);try{return this.__Cn();}
catch(cm){if(qx.core.Environment.get(x)){this.error(bq+cm);}
;}
;}
,"mshtml|webkit":function(cn){}
,"default":function(co){this.__CB(co);return this.__Cn();}
}),__Cn:function(){try{return this.__np.execCommand(t,false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__Cd;}
,redo:function(){if(this.__Cd){var cq;if(this.__BW.length>0){var cr=this.__BW.pop();if(this.__BY[cr.actionType.toLowerCase()]){switch(cr.actionType){case r:cq=this.__Cp(cr);break;case y:cq=this.__Cv(cr);break;case S:cq=this.__Cu(cr);break;case bD:cq=this.__Co(cr);break;};}
else if(this.__BX[cr.actionType]){var cp=this.__BX[cr.actionType];cq=cp.redo.call(cp.context?cp.context:this,cr);this.__CA(cr);}
else {this.error(c+cr.actionType+A);}
;this.__Ce=true;this.__CF();}
;return cq;}
;}
,__Co:qx.core.Environment.select(bu,{"mshtml|webkit":function(cu){var cs=this.__np.body.innerHTML;var cv=cu.content;this.__np.body.innerHTML=cv;var ct=cu;ct.content=cs;this.__CA(ct);return true;}
,"default":function(cw){this.__CA(cw);return this.__Cw();}
}),__Cp:qx.core.Environment.select(bu,{"mshtml|webkit":function(cx){}
,"default":function(cy){this.__CA(cy);var cz=this.__Cw();if((qx.core.Environment.get(bu)==W)){if(this.__Cq(bB,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cA=this.__Cr();this.__Cs();if(cA!=null){this.__Ct(cA);}
;}
;}
;return cz;}
}),__Cq:function(cC,cD){if(this.__BW.length>0){var cB=this.__BW[this.__BW.length-1];return (cB.command==cC&&cB.value==cD);}
;return false;}
,__Cr:function(){if(this.__Bf==null){return null;}
;var cE=this.__Bf.getSelection();var cF=cE?cE.focusNode:null;if(cF==null){return null;}
;try{while(cF.nodeName.toLowerCase()!=E){cF=cF.parentNode;if(!cF||qx.dom.Node.isNodeName(cF,bp)){return null;}
;}
;}
catch(cG){return null;}
;if(cF!=null&&qx.dom.Node.isNodeName(cF,E)){return cF;}
else {return null;}
;}
,__Cs:function(){var cH=this.__BW.pop();this.__CA(cH);this.__Cw();}
,__Ct:qx.core.Environment.select(bu,{"gecko":function(cK){if(cK==this.__Bf.getContentBody().lastChild){return;}
;var cL=cK.firstChild;while(cL.firstChild){cL=cL.firstChild;}
;var cI=this.__Bf.getSelection();var cJ=this.__Bf.getRange();if(cI&&cJ){cJ.selectNode(cL);cI.addRange(cJ);cJ.collapse(true);}
;}
,"default":(function(){}
)}),__Cu:function(cM){this.__CA(cM);return this.__Cw();}
,__Cv:qx.core.Environment.select(bu,{"mshtml|webkit":function(cN){}
,"default":function(cO){this.__CA(cO);return this.__Cw();}
}),__Cw:function(){try{return this.__np.execCommand(z,false,null);}
catch(e){return false;}
;}
,__Bm:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__Al.getCommandObject(P).customUndo=true;this.__Al.getCommandObject(h).customUndo=true;if((qx.core.Environment.get(bu)==W)){}
;}
,__Cx:qx.core.Environment.select(bu,{"mshtml|webkit":function(cP,cR,cS){var cQ=this.getUndoRedoObject();cQ.commandObject=cS;cQ.command=cP;cQ.value=cR;cQ.actionType=bD;cQ.content=this.__np.body.innerHTML;this.__Cy(cQ);}
,"default":function(cX,cV,cW){if(this.__Bf==null){return;}
;var cT=this.getUndoRedoObject();cT.commandObject=cW;cT.command=cX;cT.value=cV;cT.actionType=bD;var cY=this.__Bf.getSelection();if(cW.customUndo){var cU=[];switch(cX){case P:cU.push(qx.bom.element.Style.get(this.__np.body,b));break;case h:cU.push(qx.bom.element.Style.get(this.__np.body,C),qx.bom.element.Style.get(this.__np.body,D),qx.bom.element.Style.get(this.__np.body,I));break;case V:if(cY&&!cY.isCollapsed){cT.actionType=r;}
;break;};cT.parameter=cU;}
else {if((qx.core.Environment.get(bu)==W)){if(cY&&cY.isCollapsed){switch(cX){case G:case q:case J:case bB:case bA:cT.actionType=r;break;default:return;};}
else {cT.actionType=r;}
;}
else {cT.actionType=r;}
;}
;this.__Cy(cT);}
}),__Cy:function(da){if(this.__Cf){this.__Cz();}
;this.__CA(da);this.__Cd=false;this.__BW=[];this.__CF();}
,__Cz:function(){var db=this.__BV[this.__BV.length-1];if(db==null||db.actionType!=y){var dc=this.getUndoRedoObject();dc.actionType=y;if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){dc.content=this.__Cg;dc.actionType=bD;this.__Cg=null;}
;this.__CA(dc);this.__Cf=false;}
;}
...
,__CA:function(dd){if((qx.core.Environment.get(x))&&qx.core.Environment.get(bs)){this.debug(g);this.debug(dd.actionType+s+dd.command+s+dd.value);}
;this.__BV.push(dd);}
,__CB:function(de){if((qx.core.Environment.get(x))&&qx.core.Environment.get(bs)){this.debug(br);this.debug(de.actionType+s+de.command+s+de.value);}
;this.__BW.push(de);}
,_handleKeyPress:function(e){var df=e.getKeyIdentifier().toLowerCase();var dg=e.isCtrlPressed();switch(df){case k:case l:case N:case n:case bz:case by:case f:case u:case w:case m:case X:break;case F:case p:case O:case U:case v:case H:case bC:if(!dg){this.__CC();}
;break;default:this.__Cd=false;this.__BW=[];this.__CC();};}
,__CC:function(){if(!this.__Cf){this.__Cf=true;this.__Ce=true;if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){this.__Cg=this.__np.body.innerHTML;}
;this.__CF();}
;}
,__CD:null,_handleMouseDown:qx.core.Environment.select(bu,{"mshtml":function(e){var dh=e.getOriginalTarget();if(qx.dom.Node.isElement(dh)&&(qx.dom.Node.isNodeName(dh,R)||qx.dom.Node.isNodeName(dh,B))){this.__CD={node:dh,content:dh.outerHTML};}
else {this.__CD=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(bu,{"gecko":function(e){if(this.__Bf==null){return;}
;var dj=this.__Bf.getSelection();if(!dj){this.__CD=null;return;}
;var dl=dj.anchorNode;var dk=dl.childNodes[dj.anchorOffset];if(qx.dom.Node.isNodeName(dk,R)){if(this.__CD==null){this.__CD=dk.cloneNode(true);}
else {if(this.__CD.style.width!=dk.style.width||this.__CD.style.height!=dk.style.height){this.__CE();this.__CD=dk.cloneNode(true);}
;}
;}
else if(qx.dom.Node.isNodeName(dl,Q)||qx.dom.Node.isNodeName(dl.parentNode,Q)){var di=dl.parentNode;while(qx.dom.Node.isNodeName(di,B)){di=di.parentNode;}
;if(this.__CD==null){this.__CD=di.cloneNode(true);}
else {qx.event.Timer.once(function(){if(di.style.width!=this.__CD.style.width||di.style.height!=this.__CD.style.height||di.innerHTML!=this.__CD.innerHTML){this.__CE();this.__CD=di.cloneNode(true);}
;}
,this,0);}
;}
else {this.__CD=null;}
;}
,"default":function(e){var dm=qx.bom.Event.getTarget(e);if(this.__CD!=null){if(dm.nodeType==1){if(dm==this.__CD.node){if(dm.outerHTML!=this.__CD.content){this.__CD.content=dm.outerHTML;this.__CE();}
;}
else {for(var i=0,j=dm.childNodes.length;i<j;i++ ){if(dm.childNodes[i]==this.__CD.node){if(dm.childNodes[i].outerHTML!=this.__CD.content){this.__CD.content=dm.childNodes[i].outerHTML;this.__CE();}
;}
;}
;}
;}
...
;}
;}
}),__CE:qx.core.Environment.select(bu,{"mshtml|webkit":function(){this.__Cx(S,null,null);}
,"default":function(){var dn=this.getUndoRedoObject();dn.actionType=S;this.__CA(dn);}
}),__CF:function(){qx.event.Timer.once(function(e){if(this.__Bf!=null){var dp={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__Bf.fireDataEvent(bx,dp);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__np.body,bw,this.__Ca);qx.event.Registration.removeListener(this.__np,bv,this.__Cb);if((qx.core.Environment.get(bu)==Y)){qx.event.Registration.removeListener(this.__np,d,this.__Cc);}
;}
catch(e){}
;this._disposeObjects(T);this.__Bf=this.__BV=this.__BW=this._commands=this.__np=null;this.__BY=this.__BX=null;}
});}
)();
