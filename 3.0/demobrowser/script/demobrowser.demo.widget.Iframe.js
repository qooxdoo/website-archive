...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.27b20c88b817.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[t,q,o],init:t,themeable:true,apply:i},scrollbarY:{check:[t,q,o],init:t,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__wq:null,__wr:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__wr){this._stopIframeObserver();}
;var E=qx.event.Idle.getInstance();this.__wr=E.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__wq=null;if(!this.__wr){return;}
;var F=qx.event.Idle.getInstance();F.removeListenerById(this.__wr);}
,_onIframeObserverInterval:function(){var G=this._getIframeSize();if(!G){this._disableScollbars();return;}
;if(this.__wq&&G.width==this.__wq.width&&G.height==this.__wq.height){return;}
;this.__wq=G;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var J=this.__wq;var M=this.getChildControl(j).getBounds();var K=this.getChildControl(j).getInnerSize();if(!J||!K||!K){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__wq=null;}
});}
)();
