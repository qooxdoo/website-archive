...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.d9d31a241529.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="$$widget",i="The root widget does not support 'left', or 'top' paddings!",j="div",k="left",l="paddingTop",m="qxIsRootPage",n="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(o){this.__np=o;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__zb,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__jO:null,__np:null,_createContentElement:function(){var q=this.__np.createElement(j);this.__np.body.appendChild(q);var p=new qx.html.Root(q);p.setStyles({position:n,textAlign:k});p.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(c)==f)){p.setAttribute(m,1);}
;return p;}
...
,__zb:function(e){this.getContentElement().setStyles({width:0,height:0});}
...
;this.__pa=v;v.style.overflow=o;v.style.textAlign=q;this.__pb=w||false;this.__pc=u||false;this.__pd();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
;var window=qx.dom.Node.getWindow(v);qx.event.Registration.addListener(window,a,this._onWindowResize,this);}
,members:{__pb:false,__pc:false,__pa:null,__pd:function(){if(this.__pb||this.__pc){var x=qx.bom.element.Dimension.getSize(this.__pa);if(this.__pb&&x.width<1){throw new Error(r+this.__pa+s+this+k);}
;if(this.__pc){if(x.height<1){throw new Error(r+this.__pa+s+this+g);}
;if(x.height>=1&&qx.bom.element.Style.get(this.__pa,j,3)==f){qx.bom.element.Style.set(this.__pa,j,x.height+h);}
;}
;qx.event.Registration.addListener(this.__pa,a,this._onResize,this);}
;}
,_createContentElement:function(){var y=this.__pa;if(this.__pb||this.__pc){var A=document.createElement(p);y.appendChild(A);}
else {A=y;}
...
,this,0);return z;}
,_onResize:function(e){var B=e.getData();if((B.oldWidth!==B.width)&&this.__pb||(B.oldHeight!==B.height)&&this.__pc){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var G=this.__pb;var D=this.__pc;if(!G||!D){var C=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {C={};}
;var H=qx.bom.element.Dimension;if(G){var F=H.getContentWidth(this.__pa);C.width=F;C.minWidth=F;C.maxWidth=F;}
;if(D){var E=H.getContentHeight(this.__pa);C.height=E;C.minHeight=E;C.maxHeight=E;}
;return C;}
},defer:function(I,J){qx.ui.core.MLayoutHandling.remap(J);}
,destruct:function(){qx.event.Registration.removeListener(this.__pa,a,this._onResize,this);this.__pa=null;}
});}
)();
(function(){var a="resize",b="interval",c="__jO",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__gz=g;this.__pe={};this.__jO=new qx.event.Timer(200);this.__jO.addListener(b,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__pe:null,__gz:null,__jO:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__pe;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__jO.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__pe;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__jO.stop();}
;}
;}
,_onInterval:function(e){var u=this.__pe;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,a,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__gz=this.__pe=null;this._disposeObjects(c);}
