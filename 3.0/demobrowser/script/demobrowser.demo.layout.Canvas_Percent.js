...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Canvas_Percent.dacaf4ddd76a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="black",b="12%",c="teal",d="red",e="demobrowser.demo.layout.Canvas_Percent",f="9%",g="3%",h="green",i="6%",j="yellow",k="orange",l="20%",m="solid",n="blue";qx.Class.define(e,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var v=new qx.ui.decoration.Decorator().set({width:3,style:m,color:a});var u=new qx.ui.core.Widget().set({backgroundColor:d,decorator:v});var t=new qx.ui.core.Widget().set({backgroundColor:n,decorator:v});var s=new qx.ui.core.Widget().set({backgroundColor:h,decorator:v});var r=new qx.ui.core.Widget().set({backgroundColor:j,decorator:v});var q=new qx.ui.core.Widget().set({backgroundColor:k,decorator:v});var p=new qx.ui.core.Widget().set({backgroundColor:c,decorator:v});var o=new qx.ui.container.Composite(new qx.ui.layout.Canvas());o.add(u,{left:g,top:g,right:g,bottom:g,width:l,height:l});o.add(t,{left:i,top:i,right:i,width:l,height:l});o.add(s,{left:f,top:f,bottom:f,width:l,height:l});o.add(r,{left:b,top:b,width:l,height:l});o.add(q,{top:f,right:f,width:l,height:l});o.add(p,{right:f,bottom:f,width:l,height:l});this.getRoot().add(o,{edge:0});}
}});}
)();
