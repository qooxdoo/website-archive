...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.d780199227f4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.log.Logger.debug(this,j+(new Date-qx.Bootstrap.LOADSTART)+k);var q=f;var r=qx.Class.getByName(q);if(r){this.__cP=new r;var p=new Date;this.__cP.main();qx.log.Logger.debug(this,c+(new Date-p)+k);var p=new Date;this.__cP.finalize();qx.log.Logger.debug(this,m+(new Date-p)+k);}
...
(function(){var a="This decorator is already in-use. Modification is not possible anymore!",b="qx.debug",c="background-color",d='demobrowser.Theme',e="qx.ui.decoration.MBackgroundColor",f="Color",g="_applyBackgroundColor";qx.Mixin.define(e,{properties:{backgroundColor:{check:f,nullable:true,apply:g}},members:{_styleBackgroundColor:function(h){var i=this.getBackgroundColor();if(i&&d){i=qx.theme.manager.Color.getInstance().resolve(i);}
;if(i){h[c]=i;}
;}
,_applyBackgroundColor:function(){if(qx.core.Environment.get(b)){if(this._isInitialized()){throw new Error(a);}
;}
;}
}});}
)();
...
(function(){var a="double",b="Invalid Single decorator (zero border width). Use qx.ui.decorator.Background instead!",c="px ",d="widthTop",e="inset",f="solid",g="dotted",h="styleRight",i="styleBottom",j="_applyWidth",k="border-top",l="qx.debug",m="border-left",n="ridge",o="border-right",p="qx.ui.decoration.MSingleBorder",q="shorthand",r="Color",s="widthBottom",t="outset",u="widthLeft",v="",w="border-bottom",x="styleTop",y="colorBottom",z="groove",A="styleLeft",B="widthRight",C="dashed",D="Number",E="colorLeft",F="colorRight",G="colorTop",H="_applyStyle",I=" ",J="This decorator is already in-use. Modification is not possible anymore!",K="absolute";qx.Mixin.define(p,{properties:{widthTop:{check:D,init:0,apply:j},widthRight:{check:D,init:0,apply:j},widthBottom:{check:D,init:0,apply:j},widthLeft:{check:D,init:0,apply:j},styleTop:{nullable:true,check:[f,g,C,a,e,t,n,z],init:f,apply:H},styleRight:{nullable:true,check:[f,g,C,a,e,t,n,z],init:f,apply:H},styleBottom:{nullable:true,check:[f,g,C,a,e,t,n,z],init:f,apply:H},styleLeft:{nullable:true,check:[f,g,C,a,e,t,n,z],init:f,apply:H},colorTop:{nullable:true,check:r,apply:H},colorRight:{nullable:true,check:r,apply:H},colorBottom:{nullable:true,check:r,apply:H},colorLeft:{nullable:true,check:r,apply:H},left:{group:[u,A,E]},right:{group:[B,h,F]},top:{group:[d,x,G]},bottom:{group:[s,i,y]},width:{group:[d,B,s,u],mode:q},style:{group:[x,h,i,A],mode:q},color:{group:[G,F,y,E],mode:q}},members:{_styleBorder:function(L){{var N=qx.theme.manager.Color.getInstance();var R=N.resolve(this.getColorTop());var O=N.resolve(this.getColorRight());var M=N.resolve(this.getColorBottom());var Q=N.resolve(this.getColorLeft());}
;var P=this.getWidthTop();if(P>0){L[k]=P+c+this.getStyleTop()+I+(R||v);}
;var P=this.getWidthRight();if(P>0){L[o]=P+c+this.getStyleRight()+I+(O||v);}
;var P=this.getWidthBottom();if(P>0){L[w]=P+c+this.getStyleBottom()+I+(M||v);}
;var P=this.getWidthLeft();if(P>0){L[m]=P+c+this.getStyleLeft()+I+(Q||v);}
;if(qx.core.Environment.get(l)){if(L.length===0){throw new Error(b);}
;}
;L.position=K;}
...
(function(){var a="innerWidthRight",b="innerColorBottom",c="css.borderradius",d="px ",e='""',f="_applyDoubleBorder",g="border-top",h="inset 0 -",i="css.boxsizing",j="innerWidthTop",k="100%",l="qx.debug",m="border-left",n="innerColorRight",o="css.boxshadow",p="innerColorTop",q="innerColorLeft",r="inset ",s="shorthand",t="inset -",u="Color",v="border-box",w="This decorator is already in-use. Modification is not possible anymore!",x="qx.ui.decoration.MDoubleBorder",y="border-bottom",z="innerOpacity is configured but the browser doesn't support RGBA colors.",A=":before",B="inset 0 ",C="px solid ",D="innerWidthBottom",E="css.rgba",F="inherit",G="Number",H="innerWidthLeft",I="px 0 ",J="inset 0 0 0 ",K="border-right",L=" ",M=",",N="absolute";qx.Mixin.define(x,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__ei;this._styleBorder=this.__eg;}
,properties:{innerWidthTop:{check:G,init:0,apply:f},innerWidthRight:{check:G,init:0,apply:f},innerWidthBottom:{check:G,init:0,apply:f},innerWidthLeft:{check:G,init:0,apply:f},innerWidth:{group:[j,a,D,H],mode:s},innerColorTop:{nullable:true,check:u,apply:f},innerColorRight:{nullable:true,check:u,apply:f},innerColorBottom:{nullable:true,check:u,apply:f},innerColorLeft:{nullable:true,check:u,apply:f},innerColor:{group:[p,n,b,q],mode:s},innerOpacity:{check:G,init:1,apply:f}},members:{__eg:function(O){var X=qx.core.Environment.get(o);var R,bc,innerWidth;{var W=qx.theme.manager.Color.getInstance();R={top:W.resolve(this.getColorTop()),right:W.resolve(this.getColorRight()),bottom:W.resolve(this.getColorBottom()),left:W.resolve(this.getColorLeft())};bc={top:W.resolve(this.getInnerColorTop()),right:W.resolve(this.getInnerColorRight()),bottom:W.resolve(this.getInnerColorBottom()),left:W.resolve(this.getInnerColorLeft())};}
;innerWidth={top:this.getInnerWidthTop(),right:this.getInnerWidthRight(),bottom:this.getInnerWidthBottom(),left:this.getInnerWidthLeft()};var U=this.getWidthTop();if(U>0){O[g]=U+d+this.getStyleTop()+L+R.top;}
;U=this.getWidthRight();if(U>0){O[K]=U+d+this.getStyleRight()+L+R.right;}
;U=this.getWidthBottom();if(U>0){O[y]=U+d+this.getStyleBottom()+L+R.bottom;}
;U=this.getWidthLeft();if(U>0){O[m]=U+d+this.getStyleLeft()+L+R.left;}
;var bb=this.getInnerOpacity();if(bb<1){this.__eh(bc,bb);}
;if(innerWidth.top>0||innerWidth.right>0||innerWidth.bottom>0||innerWidth.left>0){var ba=(innerWidth.top||0)+C+bc.top;var Y=(innerWidth.right||0)+C+bc.right;var T=(innerWidth.bottom||0)+C+bc.bottom;var V=(innerWidth.left||0)+C+bc.left;O[A]={"width":k,"height":k,"position":N,"content":e,"border-top":ba,"border-right":Y,"border-bottom":T,"border-left":V,"left":0,"top":0};var P=qx.bom.Style.getCssName(qx.core.Environment.get(i));O[A][P]=v;var Q=qx.core.Environment.get(c);if(Q){Q=qx.bom.Style.getCssName(Q);O[A][Q]=F;}
;var S=[];if(bc.top&&innerWidth.top&&bc.top==bc.bottom&&bc.top==bc.right&&bc.top==bc.left&&innerWidth.top==innerWidth.bottom&&innerWidth.top==innerWidth.right&&innerWidth.top==innerWidth.left){S.push(J+innerWidth.top+d+bc.top);}
else {if(bc.top){S.push(B+(innerWidth.top||0)+d+bc.top);}
;if(bc.right){S.push(t+(innerWidth.right||0)+I+bc.right);}
;if(bc.bottom){S.push(h+(innerWidth.bottom||0)+d+bc.bottom);}
;if(bc.left){S.push(r+(innerWidth.left||0)+I+bc.left);}
;}
;if(S.length>0&&X){X=qx.bom.Style.getCssName(X);if(!O[X]){O[X]=S.join(M);}
else {O[X]+=M+S.join(M);}
;}
;}
;}
,__eh:function(bg,bd){if(!qx.core.Environment.get(E)){if(qx.core.Environment.get(l)){qx.log.Logger.warn(z);}
;return;}
;for(var bh in bg){var be=qx.util.ColorUtil.stringToRgb(bg[bh]);be.push(bd);var bf=qx.util.ColorUtil.rgbToRgbString(be);bg[bh]=bf;}
;}
,_applyDoubleBorder:function(){if(qx.core.Environment.get(l)){if(this._isInitialized()){throw new Error(w);}
;}
;}
...
(function(){var a=" 0",b="</div>",c="),to(",d="px",e="css.borderradius",f="from(",g=")",h="background-image",i="background",j="<div style='width: 100%; height: 100%; position: absolute;",k="filter",l="background-size",m="', ",n="'></div>",o="0",p="_applyLinearBackgroundGradient",q="-webkit-gradient(linear,",r="startColorPosition",s="qx.debug",t="background-color",u="deg, ",v="url(",w="css.gradient.legacywebkit",x="EndColorStr='#FF",y="startColor",z="shorthand",A="100% 100%",B="Color",C='<div style=\"position: absolute; width: 100%; height: 100%; filter:progid:DXImageTransform.Microsoft.Gradient(GradientType=',D="MBoxShadow",E="StartColorStr='#FF",F="vertical",G="",H="transparent",I="qx.ui.decoration.MLinearBackgroundGradient",J="(",K="endColorPosition",L="canvas",M="';)\">",N="css.gradient.linear",O="';)",P="endColor",Q=", ",R="css.gradient.filter",S="horizontal",T="Number",U='2d',V="%",W=" ",X="white",Y="This decorator is already in-use. Modification is not possible anymore!",bd="linear-gradient",be='progid:DXImageTransform.Microsoft.Gradient(GradientType=',bf=",";qx.Mixin.define(I,{properties:{startColor:{check:B,nullable:true,apply:p},endColor:{check:B,nullable:true,apply:p},orientation:{check:[S,F],init:F,apply:p},startColorPosition:{check:T,init:0,apply:p},endColorPosition:{check:T,init:100,apply:p},colorPositionUnit:{check:[d,V],init:V,apply:p},gradientStart:{group:[y,r],mode:z},gradientEnd:{group:[P,K],mode:z}},members:{__ek:null,_styleLinearBackgroundGradient:function(bg){var bq=this.__el();var bu=bq.start;var bo=bq.end;var bm;if(!bu||!bo){return;}
;var bx=this.getColorPositionUnit();if(qx.core.Environment.get(w)){bx=bx===d?G:bx;if(this.getOrientation()==S){var bt=this.getStartColorPosition()+bx+a+bx;var br=this.getEndColorPosition()+bx+a+bx;}
else {var bt=o+bx+W+this.getStartColorPosition()+bx;var br=o+bx+W+this.getEndColorPosition()+bx;}
;var bj=f+bu+c+bo+g;bm=q+bt+bf+br+bf+bj+g;bg[i]=bm;}
else if(qx.core.Environment.get(R)&&!qx.core.Environment.get(N)&&qx.core.Environment.get(e)){if(!this.__ek){this.__ek=document.createElement(L);}
;var bk=this.getOrientation()==F;var bq=this.__el();var bn=bk?200:1;var bp=bk?1:200;this.__ek.width=bp;this.__ek.height=bn;var bl=this.__ek.getContext(U);if(bk){var bw=bl.createLinearGradient(0,0,0,bn);}
else {var bw=bl.createLinearGradient(0,0,bp,0);}
;bw.addColorStop(this.getStartColorPosition()/100,bq.start);bw.addColorStop(this.getEndColorPosition()/100,bq.end);bl.fillStyle=bw;bl.fillRect(0,0,bp,bn);var bm=v+this.__ek.toDataURL()+g;bg[h]=bm;bg[l]=A;}
else if(qx.core.Environment.get(R)&&!qx.core.Environment.get(N)){var bq=this.__el();var bv=this.getOrientation()==S?1:0;var bu=bq.start;var bo=bq.end;if(!qx.util.ColorUtil.isHex6String(bu)){bu=qx.util.ColorUtil.stringToRgb(bu);bu=qx.util.ColorUtil.rgbToHexString(bu);}
;if(!qx.util.ColorUtil.isHex6String(bo)){bo=qx.util.ColorUtil.stringToRgb(bo);bo=qx.util.ColorUtil.rgbToHexString(bo);}
;bu=bu.substring(1,bu.length);bo=bo.substring(1,bo.length);bm=be+bv+Q+E+bu+m+x+bo+O;if(bg[k]){bg[k]+=Q+bm;}
else {bg[k]=bm;}
;if(!bg[t]||bg[t]==H){bg[t]=X;}
;}
else {var by=this.getOrientation()==S?0:270;var bi=bu+W+this.getStartColorPosition()+bx;var bh=bo+W+this.getEndColorPosition()+bx;var bs=qx.core.Environment.get(N);if(bs===bd){by=this.getOrientation()==S?by+90:by-90;}
;bm=bs+J+by+u+bi+bf+bh+g;if(bg[h]){bg[h]+=Q+bm;}
else {bg[h]=bm;}
;}
;}
,__el:function(){{var bz=qx.theme.manager.Color.getInstance();var bB=bz.resolve(this.getStartColor());var bA=bz.resolve(this.getEndColor());}
;return {start:bB,end:bA};}
,_getContent:function(){if(qx.core.Environment.get(R)&&!qx.core.Environment.get(N)){var bE=this.__el();var bH=this.getOrientation()==S?1:0;var bG=qx.util.ColorUtil.hex3StringToHex6String(bE.start);var bD=qx.util.ColorUtil.hex3StringToHex6String(bE.end);bG=bG.substring(1,bG.length);bD=bD.substring(1,bD.length);var bF=G;if(this.classname.indexOf(D)!=-1){var bC={};this._styleBoxShadow(bC);bF=j+qx.bom.element.Style.compile(bC)+n;}
;return C+bH+Q+E+bG+m+x+bD+M+bF+b;}
;return G;}
,_applyLinearBackgroundGradient:function(){if(qx.core.Environment.get(s)){if(this._isInitialized()){throw new Error(Y);}
;}
;}
}});}
)();
...
(function(){var a="_applyBoxShadow",b="shadowHorizontalLength",c="Boolean",d="",e="This decorator is already in-use. Modification is not possible anymore!",f="qx.debug",g="px ",h="css.boxshadow",i="shadowVerticalLength",j="inset ",k="shorthand",l="qx.ui.decoration.MBoxShadow",m="Integer",n="Color",o=",";qx.Mixin.define(l,{properties:{shadowHorizontalLength:{nullable:true,check:m,apply:a},shadowVerticalLength:{nullable:true,check:m,apply:a},shadowBlurRadius:{nullable:true,check:m,apply:a},shadowSpreadRadius:{nullable:true,check:m,apply:a},shadowColor:{nullable:true,check:n,apply:a},inset:{init:false,check:c,apply:a},shadowLength:{group:[b,i],mode:k}},members:{_styleBoxShadow:function(p){var x=qx.core.Environment.get(h);if(!x||this.getShadowVerticalLength()==null&&this.getShadowHorizontalLength()==null){return;}
;{var t=qx.theme.manager.Color.getInstance();var q=t.resolve(this.getShadowColor());}
;if(q!=null){var w=this.getShadowVerticalLength()||0;var r=this.getShadowHorizontalLength()||0;var blur=this.getShadowBlurRadius()||0;var v=this.getShadowSpreadRadius()||0;var u=this.getInset()?j:d;var s=u+r+g+w+g+blur+g+v+g+q;x=qx.bom.Style.getCssName(x);if(!p[x]){p[x]=s;}
else {p[x]+=o+s;}
;}
;}
...
(function(){var a="demobrowser.Application",b="viewer",c="qx.debug",d="script/demodata.json",e="demobrowser/css/sourceview.css",f="demobrowser/css/style.css";qx.Class.define(a,{extend:qx.application.Standalone,construct:function(){qx.application.Standalone.call(this);var g=qx.util.ResourceManager.getInstance().toUri(f);qx.bom.Stylesheet.includeFile(g);g=qx.util.ResourceManager.getInstance().toUri(e);qx.bom.Stylesheet.includeFile(g);}
,members:{main:function(){qx.application.Standalone.prototype.main.call(this);if(qx.core.Environment.get(c)){qx.log.appender.Native;qx.log.appender.Console;}
;this.viewer=new demobrowser.DemoBrowser;this.getRoot().add(this.viewer,{edge:0});}
,finalize:function(){qx.application.Standalone.prototype.finalize.call(this);this.viewer.dataLoader(d);}
...
(function(){var a="-",b='</span>',c="src",d="__OY",f="Demos",g='</div>',h="Simple Theme",n="modelLink",o="^.*",p="filled",q="changeValue",v="bottom-left",w="node",x="Display HTML source",y="?qxenv:demobrowser.withTests:true",z="browser.name",A="__OQ",B="dblclick",C="icon/22/actions/media-playback-start.png",D="Open the qooxdoo Manual",E="_runbutton",F="__OV",G="value",H="app-header",I="demobrowser.DemoBrowser",J="HTML Code",K="load",L="_infosplit",M='</span>=<span class="string">',N="Run previous demo",O="changeSelection",P="enabled",Q="//",R="icon/22/actions/media-seek-forward.png",S="ie",T="icon/22/actions/help-contents.png",U="_leftComposite",V="icon/22/apps/utilities-color-chooser.png",W="_status",X="__OX",Y="Ctrl+N",ba="Previous",bb='.html',bc='execute',bd="Run",be='<span class="html-tag-name">',bf="tags",bg="Demo loaded: ",bh="__OP",bi="<div class='script'>The sample source will be displayed here.</div>",bj="_searchTextField",bk='http://demo.qooxdoo.org/3.0/playground/',bl="Open demo in the playground",bm="tree1",bn="icon/22/actions/help-about.png",bo="f1",bp="white",bq="Debug",br="Display log file",bs="id",bt="script/demobrowser.demo",bu="Run the selected demo",bv="icon/22/apps/utilities-log-viewer.png",bw="Ctrl+O",bx="Log File",by='changeSelection',bz=".src.js",bA="_blank",bB=" Demo Browser ",bC="qx.theme.Classic",bD='value',bE="auto",bF="execute",bG="Get Demo Link",bH='<div class="script">',bI="logappender",bJ="<pre class='script'>",bK="Choose theme",bL="Demo has been disposed.",bM=".html",bN="icon/22/apps/internet-web-browser.png",bO="#",bP="f2",bQ="visibility",bR="visible",bS="JS Code",bT="icon/22/mimetypes/executable.png",bU="ig",bV="success",bW="__Jw",bX="Unable to access namespace. Maybe no demo loaded.",bY="html",ca="noPlayground",cb="<script",cc="Hide/Show Tests Demos",cd='excluded',ce='"}',cf="_urlWindow",cg="icon/22/actions/edit-redo.png",ch='_cmdDisposeSample',ci="qx.theme.Modern",cj='{"code": "',ck="demobrowser.withTests",cl="toolbar",cm="icon/22/apps/office-spreadsheet.png",cn="horizontal",co="To Playground",cp="?qxenv:qx.theme:",cq="~",cr="demo/welcome.html",cs='_cmdSampleInOwnWindow',ct=".*",cu="__Pc",cv="right-top",cx="app-splitpane",cy="</pre>",cz="hideItem",cA="Open the qooxdoo API Viewer",cB="javascript",cC="default",cD="Debugging options",cE="index.html",cF="file:",cG="Filter...",cH="Manual",cI="qx.theme.Indigo",cJ="showItem",cK='js',cL="<pre ><div class='script'>",cM='label',cN="Dispose Demo",cO="changeState",cP="Classic Theme",cQ="toolbar-button",cR='html',cS="__Pb",cT='log',cU="icon/16/actions/edit-find.png",cV="Couldn't load file: ",cW="treeview.flat",cX="qooxdoo ",cY="http://manual.qooxdoo.org/",da="Own Window",db="right",dc="main",dd='_cmdObjectSummary',de="qx_srcview",df="Info",dg="js",dh="\n",di="__Pe",dj="_prevButton",dk='/',dl="/demo/",dm='_cmdNextSample',dn="_history",dp="Indigo Theme",dq='&gt;',dr="Unable to access application.",ds="outputviews.sourcepage.html.page",dt=".",du="Run next demo",dv='_cmdPrevSample',dw=" Start",dx="\"",dy="Ctrl+Left",dz="demo-tree",dA="Display JavaScript source",dB='_cmdRunSample',dC="Next",dD="widget",dE="excluded",dF="F5",dG="_demoView",dH="icon/22/actions/application-exit.png",dI="Modern Theme",dJ="Open demo in new window",dK="Demo Browser",dL="interval",dM="__JA",dN='3.0',dO="string",dP="icon/22/mimetypes/text-html.png",dQ="API Viewer",dR=" ",dS="runbutton",dT='Failed to load demo data from the file system.\n\nThe security settings of your browser may prohibit AJAX when using the file protocol. Please try the http protocol instead.',dU="/",dV="__OL",dW="outputviews.sourcepage.js.page",dX="<div class='script'>The sample JS source will be displayed here.</div>",dY="__Pa",ea="",eb="Ctrl+Right",ec="_navPart",ed="textfield",ee="_tree",ef="Ctrl+D",eg="mainsplit",eh="Could not open the Playground.",ei="icon/22/actions/go-previous.png",ej="Object Summary",ek='\n',el='http://demo.qooxdoo.org/3.0/apiviewer/',em="_nextButton",en='demo/',eo="?",ep=' <span class="keyword">',eq="</div></pre>",er="__OW",es="monospace",et="fail",eu="left",ew="icon/22/actions/go-next.png",ey="Demo Link",ez="qx.theme.Simple",eA="Theme",eB="log",eC="_iframe";qx.Class.define(I,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__Jw={};var eG=new qx.ui.layout.VBox;this.setLayout(eG);this.add(this._createHeader());this.widgets={};this.tests={};this.__OK=cI;this.__Pf();this.__OL=this.__Pm();this.add(this.__OL);var eE=new qx.ui.splitpane.Pane(cn);eE.setAppearance(cx);this.mainsplit=eE;var eH=new qx.ui.splitpane.Pane(cn);eH.setDecorator(null);this._infosplit=eH;this.add(eE,{flex:1});var eJ=this._leftComposite=new qx.ui.container.Composite();eJ.setLayout(new qx.ui.layout.VBox(3));eE.add(eJ,0);{}
;var eF=new qx.ui.container.Composite();eF.setLayout(new qx.ui.layout.HBox(3));eF.setAppearance(ed);eJ.add(eF);var eN=new qx.ui.basic.Image(cU);eF.add(eN);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(dD);this._searchTextField.setPlaceholder(cG);var eL=new qx.event.Timer(500);eL.addListener(dL,function(eO){this.filter(this._searchTextField.getValue());eL.stop();}
,this);this._searchTextField.addListener(q,function(eP){eL.restart();}
,this);eF.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(ea);this._status.setAppearance(dD);this._status.setWidth(80);this._status.setTextAlign(db);eF.add(this._status);eE.add(eH,1);this._tree=this.__Pq();eJ.add(this._tree,{flex:1});this.__Pr();this._demoView=this.__Pn();{eH.add(this._demoView,2);}
;var eD=this.__OM=this.__Po();var eK=this.__ON=this.__Pp();var eI=this.__OO=new qxc.ui.logpane.LogView();eI.setDecorator(null);var eM=this.__cb=new qx.ui.container.Stack();eM.setDecorator(dc);eM.add(eD);eM.add(eK);eM.add(eI);eH.add(eM,1);eM.resetSelection();eM.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(cO,function(e){var eQ=e.getData().replace(cq,dU);if(this._currentSample!=eQ){this.setCurrentSample(eQ);}
;}
,this);this.__OP=[this.__OV,this.__OW,this.__Pa];{this.__OP.push(this.__OT);this.__OP.push(this.__OX);this.__OP.push(this.__Pc);}
;this.__OQ=new qx.event.Timer(250);this.__OQ.addListener(dL,this.__Pt,this);this.__OQ.start();this.__OR=new demobrowser.InfoWindow(this.tr(df));this.__OR.setAutoCenter(true);}
,members:{_iframe:null,__OK:null,__OQ:null,__OS:null,_tree:null,_status:null,_searchTextField:null,__OT:null,__OU:null,__OP:null,_versionFilter:null,_navPart:null,__OV:null,__OW:null,__OX:null,__OY:null,__Pa:null,__Pb:null,__Pc:null,__OL:null,_leftComposite:null,_infosplit:null,_demoView:null,__JA:null,__Jw:null,__Pd:null,_urlWindow:null,__OR:null,__cb:null,__OM:null,__ON:null,__OO:null,__Pe:null,defaultUrl:cr,playgroundUrl:bk,__Pf:function(){this._cmdObjectSummary=new qx.ui.core.Command(bw);this._cmdObjectSummary.addListener(bF,this.__Ph,this);this._cmdRunSample=new qx.ui.core.Command(dF);this._cmdRunSample.addListener(bF,this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command(dy);this._cmdPrevSample.addListener(bF,this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command(eb);this._cmdNextSample.addListener(bF,this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command(Y);this._cmdSampleInOwnWindow.addListener(bF,this.__Pi,this);this._cmdDisposeSample=new qx.ui.core.Command(ef);this._cmdDisposeSample.addListener(bF,this.__Pl,this);}
,__Pg:function(e){var eR=e.getTarget()===this.__Pe?this.__Pd:this.__Pe;var eS=e.getData()[0];if(eR&&eS){eR.setModelSelection([eS.getModel()]);}
;var eT=eS!=null?eS.getUserData(G):ea;switch(eT){case bY:this.__cb.setSelection([this.__OM]);this.__cb.show();break;case dg:this.__cb.setSelection([this.__ON]);this.__cb.show();break;case eB:this.__cb.setSelection([this.__OO]);this.__cb.show();break;default:this.__cb.resetSelection();this.__cb.exclude();};}
,__Ph:function(){var eV=this._iframe.getWindow();var eU;if(eV&&eV.qx){eU=eV.qx.dev.ObjectSummary.getInfo();}
else {eU=bX;}
;var eW=new qx.ui.form.TextArea(eU);eW.setDecorator(null);eW.setAutoSize(true);eW.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__OR.setContent(eW);this.__OR.setWidth(400);this.__OR.show();}
,__Pi:function(){var eX=this._iframe.getSource();eX=eX.substr(0,eX.indexOf(eo));{eX+=cp+this.__OK;}
;window.open(eX,bA);}
,__Pj:function(fa){var eY=!!fa;var fb=this._tree.getSelection()[0].getUserData(bf);if(fb){eY=eY&&!qx.lang.Array.contains(fb,ca);}
;this.__OT.setEnabled(eY);this.__OU=fa;}
,__Pk:function(){if(this.__OU){var fe=this.__OU;var fd=cj+encodeURIComponent(fe)+ce;var fc=this.playgroundUrl+bO+encodeURIComponent(fd);window.open(fc,bA);}
else {var ff=new qx.ui.basic.Label(this.tr(eh));this.__OR.setContent(ff);this.__OR.setWidth(200);this.__OR.show();}
;}
,__Md:function(){window.open(el);}
,__Me:function(){var fg=(dN.split(a)[0]);window.open(cY+fg);}
,_onHideShowTests:function(event){var fi=window.location.search;var fj=window.location.hash;var fh=cE;if(fi==ea){fh+=y;}
;fh+=fj;location.replace(fh);}
,__Pl:function(e){var fl=this._iframe.getWindow();var fk;if(fl&&fl.qx){fl.qx.core.ObjectRegistry.shutdown();fk=this.tr(bL);}
else {fk=this.tr(dr);}
;var fm=new qx.ui.basic.Label(fk);fm.setRich(true);fm.setWrap(true);this.__OR.setContent(fm);this.__OR.setWidth(350);this.__OR.show();}
,__Pm:function(){var fJ=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr(bd),C);this._runbutton.addListener(bF,this.runSample,this);this._runbutton.setToolTipText(bu);fJ.add(this._runbutton);var fM=new qx.ui.toolbar.Part();fJ.add(fM);var fv=new qx.ui.toolbar.Button(this.tr(ba),ei);fv.addListener(bF,this.playPrev,this);fv.setToolTipText(N);fM.add(fv);this._prevButton=fv;var fH=new qx.ui.toolbar.Button(this.tr(dC),ew);fH.addListener(bF,this.playNext,this);fH.setToolTipText(du);fM.add(fH);this._nextButton=fH;var fy={converter:function(fR){return fR==bR;}
};qx.data.SingleValueBinding.bind(this._runbutton,bQ,fv,P,fy);qx.data.SingleValueBinding.bind(this._runbutton,bQ,fH,P,fy);var fw=this._navPart=new qx.ui.toolbar.Part();fJ.add(fw);var fQ=new qx.ui.toolbar.Button(this.tr(da),cg);fQ.addListener(bF,this.__Pi,this);fQ.setToolTipText(dJ);this.__OV=fQ;fw.add(fQ);{var fE=new qx.ui.toolbar.Button(this.tr(co),dH);fE.addListener(bF,this.__Pk,this);fE.setToolTipText(bl);fE.setEnabled(false);if(qx.core.Environment.get(z)==S){fE.exclude();}
;this.__OT=fE;fw.add(fE);var fq=new qx.ui.toolbar.Part();fJ.add(fq);var fC=new qx.ui.toolbar.Button(this.tr(dQ),T);fq.add(fC);fC.setToolTipText(this.tr(cA));fC.addListener(bF,this.__Md,this);var fo=new qx.ui.toolbar.Button(this.tr(cH),bn);fq.add(fo);fo.setToolTipText(this.tr(D));fo.addListener(bF,this.__Me,this);}
;var fK=new qx.ui.toolbar.Part;fJ.add(fK);{var fG=new qx.ui.menu.Menu;this.__OY=fG;var fP=new qx.ui.menu.RadioButton(dI);var fN=new qx.ui.menu.RadioButton(cP);var fO=new qx.ui.menu.RadioButton(h);var fL=new qx.ui.menu.RadioButton(dp);fP.setUserData(G,ci);fN.setUserData(G,bC);fO.setUserData(G,ez);fL.setUserData(G,cI);fL.setValue(true);var fz=new qx.ui.form.RadioGroup(fP,fN,fO,fL);fz.addListener(O,this.__Px,this);fG.add(fL);fG.add(fP);fG.add(fN);fG.add(fO);var fx=new qx.ui.toolbar.MenuButton(this.tr(eA),V,fG);this.__OX=fK;fx.setToolTipText(bK);fK.add(fx);}
;var fA=new qx.ui.menu.Menu;{var fB=new qx.ui.menu.Button(this.tr(ej));this.__Pc=fB;fB.setCommand(this._cmdObjectSummary);fA.add(fB);}
;var ft=new qx.ui.menu.Button(this.tr(cN));this.__Pa=ft;ft.setCommand(this._cmdDisposeSample);fA.add(ft);{fA.addSeparator();var fr=new qx.ui.menu.CheckBox(this.tr(cc));fr.setValue(!!qx.core.Environment.get(ck));fr.addListener(q,this._onHideShowTests,this);fA.add(fr);}
;var fu=new qx.ui.toolbar.MenuButton(this.tr(bq),cm,fA);this.__Pb=fu;fu.setToolTipText(cD);fK.add(fu);var fD=new qx.ui.toolbar.Part;this.__OW=fD;fJ.addSpacer();fJ.add(fD);{var fI=new qx.ui.toolbar.RadioButton(J,bN);fI.setToolTipText(x);fI.setModel(cR);var fs=new qx.ui.toolbar.RadioButton(bS,bT);fs.setToolTipText(dA);fs.setModel(cK);fI.setUserData(G,bY);fs.setUserData(G,dg);fD.add(fI);fD.add(fs);}
;var fF=new qx.ui.toolbar.RadioButton(bx,bv);fF.setToolTipText(br);fF.setUserData(G,eB);fF.setModel(cT);fD.add(fF);var fn=this.__Pe=new qx.ui.form.RadioGroup;fn.setAllowEmptySelection(true);fn.add(fF);fn.addListener(by,this.__Pg,this);{fn.add(fI,fs);}
;fJ.setOverflowHandling(true);var fp=new qx.ui.toolbar.MenuButton(null,R);fp.setAppearance(cQ);fJ.add(fp);fJ.setOverflowIndicator(fp);fJ.setRemovePriority(fD,6);fJ.setRemovePriority(fK,5);fJ.setRemovePriority(fq,4);fJ.setRemovePriority(fw,3);fJ.setRemovePriority(fM,2);fJ.setRemovePriority(this._navPart,1);this.__JA=new qx.ui.menu.Menu();fp.setMenu(this.__JA);fJ.addListener(cz,this._onHideItem,this);fJ.addListener(cJ,this._onShowItem,this);return fJ;}
,_onHideItem:function(e){var fT=e.getData();var fS=this._getMenuItems(fT);for(var i=0,l=fS.length;i<l;i++ ){fS[i].setVisibility(bR);if(fT===this.__OX&&!(fS[i] instanceof qx.ui.menu.Separator)){fS[i].getMenu().setPosition(cv);}
;}
;}
,_onShowItem:function(e){var fV=e.getData();var fU=this._getMenuItems(fV);for(var i=0,l=fU.length;i<l;i++ ){fU[i].setVisibility(dE);}
;if(fV===this.__OX){var fW=fV.getMenuButtons();for(var i=0,l=fW.length;i<l;i++ ){fW[i].getMenu().setPosition(v);}
;}
;}
,_getMenuItems:function(gf){var fY=[];if(gf instanceof qx.ui.toolbar.Part){var ge=gf.getChildren();var gd=null;var fX=false;var ga=this.__JA.getChildren();if(gf!=this.__OW){gd=this.__Jw[gf.toHashCode()];if(!gd){gd=new qx.ui.menu.Separator();this.__JA.addBefore(gd,ga[0]);this.__Jw[gf.toHashCode()]=gd;}
;fY.push(gd);}
else {fX=true;}
;for(var i=0,l=ge.length;i<l;i++ ){if(ge[i].getVisibility()==cd){continue;}
;var gb=this.__Jw[ge[i].toHashCode()];if(!gb){if(ge[i] instanceof qx.ui.toolbar.RadioButton){gb=new qx.ui.menu.RadioButton(ge[i].getLabel());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());gb.setUserData(bD,ge[i].getUserData(bD));gb.setModel(ge[i].getModel());ge[i].bind(P,gb,P);ge[i].bind(G,gb,G);gb.bind(G,ge[i],G);if(!this.__Pd){this.__Pd=new qx.ui.form.RadioGroup();this.__Pd.setAllowEmptySelection(true);this.__Pd.addListener(by,this.__Pg,this);}
;this.__Pd.add(gb);}
else if(ge[i] instanceof qx.ui.toolbar.MenuButton){gb=new qx.ui.menu.Button(ge[i].getLabel().translate(),ge[i].getIcon(),ge[i].getCommand(),ge[i].getMenu());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());ge[i].bind(P,gb,P);}
else if(ge[i] instanceof qx.ui.toolbar.Button){gb=new qx.ui.menu.Button(ge[i].getLabel().translate(),ge[i].getIcon());gb.getChildControl(cM,false).setRich(true);gb.setTextColor(ge[i].getTextColor());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());ge[i].bind(P,gb,P);var gc=qx.event.Registration.getManager(ge[i]).getListeners(ge[i],bc);if(gc&&gc.length>0){for(var j=0,k=gc.length;j<k;j++ ){gb.addListener(bc,qx.lang.Function.bind(gc[j].handler,gc[j].context));}
;}
;}
else if(ge[i] instanceof qx.ui.toolbar.CheckBox){gb=new qx.ui.menu.CheckBox(ge[i].getLabel());gb.setToolTipText(ge[i].getToolTipText());gb.setEnabled(ge[i].getEnabled());ge[i].bind(P,gb,P);}
else {gb=new qx.ui.menu.Separator();}
;if(fX){this.__JA.add(gb);}
else {this.__JA.addBefore(gb,gd);}
;this.__Jw[ge[i].toHashCode()]=gb;}
;fY.push(gb);}
;}
;return fY;}
,__Pn:function(){var gg=new qx.ui.embed.Iframe().set({nativeContextMenu:true});gg.addListener(K,this.__Ps,this);this._iframe=gg;return gg;}
,__Po:function(){var gh=new qx.ui.embed.Html(bi);gh.setOverflow(bE,bE);gh.setFont(es);gh.setBackgroundColor(bp);this.widgets[ds]=gh;gh.getContentElement().setAttribute(bs,de);return gh;}
,__Pp:function(){var gi=new qx.ui.embed.Html(dX);gi.setOverflow(bE,bE);gi.setFont(es);gi.setBackgroundColor(bp);this.widgets[dW]=gi;gi.getContentElement().setAttribute(bs,de);return gi;}
,__Pq:function(){var gk=new qx.ui.tree.Tree();var gj=new qx.ui.tree.TreeFolder(f);gk.setAppearance(dz);gk.setRoot(gj);this.tree=this.widgets[cW]=gk;gk.addListener(O,this.treeGetSelection,this);gk.addListener(B,function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return gk;}
,__Pr:function(){var gl=new qx.ui.window.Window(this.tr(ey),dP);gl.setLayout(new qx.ui.layout.VBox(10));gl.setAllowMaximize(false);gl.setAllowMinimize(false);var go=new qx.ui.basic.Label(ea);go.setSelectable(true);go.setNativeContextMenu(true);gl.add(go);this._urlWindow=gl;var gp=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(gp<0){gp=0;}
;var top=Math.ceil((qx.bom.Viewport.getHeight()/2)-25);if(top<0){top=0;}
;gl.moveTo(gp,top);this.getApplicationRoot().add(gl);var gm=new qx.ui.menu.Menu();var gn=new qx.ui.menu.Button(this.tr(bG),dP);gn.addListener(bF,function(e){var gr=this.tree.getSelection()[0];var gt=gr.getUserData(n);var gq=this.tests.handler.getFullName(gt);gq=gq.replace(dt,cq);var gs=location.protocol+Q+location.host+location.pathname+bO+gq;this._urlWindow.getChildren()[0].setValue(gs);this._urlWindow.open();}
,this);gm.add(gn);this._tree.setContextMenu(gm);}
,treeGetSelection:function(e){var gu=this.tree.getSelection()[0];this._runbutton.setEnabled(!gu.hasChildren());var gv=gu.getUserData(n);this.tests.selected=this.tests.handler.getFullName(gv);}
,leftReloadTree:function(e){this._sampleToTreeNodeMap={};var gw=this._sampleToTreeNodeMap;var gC=null;var gE=null;var gB=this._history.getState();var gz=gB.match(/([^~]+)~/);if(gz){gC=gz[1];}
else {var gx=gB.match(/([^~][\w]*)/);if(gx){gC=gx[1];}
;}
;function gD(gI,gF){var gK=gF.getChildren();var t;for(var i=0;i<gK.length;i++ ){var gG=gK[i];if(gG.hasChildren()){t=new qx.ui.tree.TreeFolder(gy.polish(gG.label));t.setUserData(p,false);t.setUserData(w,gG);gD(t,t.getUserData(w));if(gG.label==gC){gE=t;t.setOpen(true);}
;}
else {if(!gG.type){continue;}
;t=new qx.ui.tree.TreeFile(gy.polish(gG.label));var gJ=gG.pwd().slice(1).join(dU)+dU+gG.label;if(gG.tags){t.setUserData(bf,gG.tags);{var j,m,gH;}
;}
;gw[gJ]=t;}
;gI.add(t);t.setUserData(n,gG);gG.widgetLinkFull=t;}
;}
;var gA=this.tests.handler.ttree;var gy=this;this.tree.setUserData(n,gA);this.tree.getRoot().setOpen(true);gD(this.tree.getRoot(),gA);{}
;if(gE!=null){this.tree.setSelection([gE]);}
else {this.tree.setSelection([this.tree.getRoot()]);}
;}
,runSample:function(e){if(this.tests.selected&&this.tests.selected!=ea){var gL=this.tests.selected.replace(dt,dU);this.setCurrentSample(gL);}
else {this.playNext();}
;}
,setCurrentSample:function(gP){if(!gP){return;}
;if(!this._sampleToTreeNodeMap){return;}
;var gM;var gO=this._sampleToTreeNodeMap[gP];if(gO){gO.getTree().setSelection([gO]);gM=en+gP;{gM+=cp+this.__OK;}
;var gN=gO.getUserData(bf);if(gN){this.__OT.setEnabled(!qx.lang.Array.contains(gN,ca));}
;}
else {gM=this.defaultUrl;}
;if(this._iframe.getSource()==gM){this._iframe.reload();}
else {this.__OS=false;this.__OX.getChildren()[0].setEnabled(false);this.__OX.getChildren()[1].setEnabled(false);this._iframe.setSource(gM);this._iframe.addListener(K,function(){window.setTimeout(function(){var gQ=this._iframe.getWindow();if(gQ&&gQ.qx&&gQ.qx.theme&&gQ.qx.theme.manager&&gQ.qx.theme.manager.Meta){this.__OX.getChildren()[0].setEnabled(true);this.__OX.getChildren()[1].setEnabled(true);}
;}
.bind(this),333);}
,this);}
;if(gM==this.defaultUrl){this.disableMenuButtons();}
else {this.enableMenuButtons();}
;this._currentSample=gP;this._currentSampleUrl=gM;}
,__Ps:function(){var gV=this._iframe.getWindow();var gS=this._iframe.getSource();if(gS!=null&&gS!=this.defaultUrl){var gU;try{gU=gV.location.href;}
catch(hd){gU=window.location.href;var hc=gU.lastIndexOf(dU);if(hc!=-1){gU=gU.substring(0,hc+1);}
;gU+=gS;}
;var ha=gU.indexOf(dl)+6;var gW=gU.indexOf(eo);gW=gW==-1?gU.length:gW;var gX=gU.substring(ha,gW).split(dU);var hb=String.fromCharCode(187);if(gX.length==2){var gR=gX[0];gR=gR.charAt(0).toUpperCase()+gR.substring(1);var gY=gX[1].replace(bM,ea).replace(/_/g,dR);gY=gY.charAt(0).toUpperCase()+gY.substring(1);var gT=cX+hb+bB+hb+dR+gR+dR+hb+dR+gY;}
else {var gT=cX+hb+bB+hb+dw;}
;document.title=gT;}
;}
,__Pt:function(e){var he=this._iframe.getWindow();try{if(he&&he.qx&&he.qx.log&&he.qx.log.appender){if(!this.__OS){this.__OS=true;this.debug(bg+this._currentSample);this.__OO.clear();try{this.__OO.fetch(he.qx.log.Logger);}
catch(hf){return;}
;this._history.addToHistory(this._currentSample.replace(dU,cq),document.title);if(this._currentSampleUrl!=this.defaultUrl){this.__Pu(this._currentSampleUrl);}
;}
;}
else {this.__OS=false;}
;}
catch(hg){this.__OS=false;}
;}
,filter:function(hj){var hp=new RegExp(o+hj+ct,bU);var hn=this._tree.getRoot().getItems(true,true);var ho=0;var hh=0;for(var i=0;i<hn.length;i++ ){var hq=hn[i];var parent=hq.getParent();var hm=hq.getUserData(bf);var hi=false;if(hm!=null){for(var j=0;j<hm.length;j++ ){hi=!!hm[j].match(hp);if(hi){break;}
;}
;}
;if(hq.getChildren().length==0){hh++ ;}
;if((hi||(hq.getLabel().search(hp)!=-1)||(parent.getLabel().search(hp)!=-1))){if(hq.getChildren().length==0){ho++ ;}
;hq.show();hq.getParent().setOpen(true);hq.getParent().show();}
else {hq.exclude();}
;}
;if(hj==ea){var hl=this._tree.getRoot().getItems(false,true);var hk=this._tree.getSelection();for(var i=0;i<hl.length;i++ ){if(hl[i]==hk[0]||hl[i]==hk[0].getParent()){continue;}
;hl[i].setOpen(false);}
;}
;this._status.setValue(ho+dU+hh);}
,__Pu:function(hr){if(typeof (hr)!=dO){return;}
;var hs=new qx.io.request.Xhr(hr);hs.setTimeout(180000);hs.addListener(bV,function(hB){var content=hB.getTarget().getResponse();if(content){{var hv=content.indexOf(cb,content.indexOf(cb)+7);var hC=content.indexOf(c,hv);var hu=content.indexOf(dx,hC+5);var hw=content.substring(hC+5,hu);var hz=hw.substring(4,hw.length-3)+bz;var u=bt;var hy=hr.split(dk);var hx=hy[1];var hA=hy[2];hA=hA.substr(0,hA.indexOf(bb));u+=dt+hx+dt+hA+bz;hz=u;var ht=new qx.io.request.Xhr(hz);ht.setTimeout(18000);ht.addListener(bV,function(){var hD=ht.getResponse();this.__Pj(hD);if(hD){this.widgets[dW].setHtml(this.__Pv(hD,cB));}
;}
,this);ht.addListener(et,function(){this.error(cV+hr);}
,this);ht.send();this.widgets[ds].setHtml(this.__Pv(content));}
;}
;}
,this);hs.addListener(et,function(hE){this.error(cV+hr);}
,this);hs.send();}
,dataLoader:function(url){var req=new qx.io.request.Xhr(url);req.setTimeout(180000);req.addListener(bV,function(evt){var content=evt.getTarget().getResponse();if(!content){if(window.location.protocol==cF){alert(dT);}
;return;}
;var treeData=eval(content);qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(treeData);this.leftReloadTree();var hF=this._history.getState();if(hF){this.setCurrentSample(hF.replace(cq,dU));}
else {this.setCurrentSample(this.defaultUrl);}
;}
,this,0);}
,this);req.addListener(et,function(hG){this.error(cV+url);}
,this);req.send();}
,playPrev:function(e){var hK=this.tree.getSelection()[0];if(hK){var hH=this.tree.getPreviousNodeOf(hK,false);if(!hH||hH==this.tree.getRoot()){return;}
;while(hH.isVisible&&!hH.isVisible()){hH=this.tree.getPreviousNodeOf(hH,false);}
;if(hH.getParent()==this.tree.getRoot()){var hJ=this.tree.getPreviousNodeOf(hH,false);while(hJ.isVisible&&!hJ.isVisible()){hJ=this.tree.getPreviousNodeOf(hJ,false);}
;if(hJ.getParent()==this.tree.getRoot()){hJ.setOpen(true);var hI=this.tree.getPreviousNodeOf(hH,false);while(hI.isVisible&&!hI.isVisible()){hI=this.tree.getPreviousNodeOf(hI,false);}
;if(hJ!==hI){hH=hI;}
;}
else {hH=hJ;}
;}
;if(!hH||hH===hK){return;}
else {this.tree.setSelection([hH]);this.runSample();}
;}
;}
,playNext:function(e){this._nextButton.setEnabled(true);this._prevButton.setEnabled(true);var hN=this.tree.getSelection()[0];if(hN){var hL=this.tree.getNextNodeOf(hN);if(!hL){return;}
;if(hL.getParent()==this.tree.getRoot()){hL.setOpen(true);hL=this.tree.getNextNodeOf(hL);}
;if(!hL){return;}
;while(!hL.isVisible()){var hM=this.tree.getNextNodeOf(hL);if(!hM){return;}
;if(hM.getParent()==this.tree.getRoot()){hL.setOpen(true);var hM=this.tree.getNextNodeOf(hM);}
;hL=hM;}
;if(hL){this.tree.setSelection([hL]);this.runSample();}
;}
;}
,__Pv:function(hP,hU){var hO=new qx.util.StringBuilder(bJ);var hR=[];var hS=new qx.util.StringBuilder();var hT=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var hQ=/^\s*<\/script>\s*$/i;hP=hP.replace(/\r\n/g,dh).replace(/\r/g,dh);var hR=hP.split(ek);if(hU==cB){return cL+qx.dev.Tokenizer.javaScriptToHtml(hP)+eq;}
;for(var i=0;i<hR.length;i++ ){if(hT.exec(hR[i])){hO.add(this.__Pw(qx.bom.String.escape(hS.get()+hR[i])));hS.clear();}
else if(hQ.exec(hR[i])){var hV=qx.dev.Tokenizer.javaScriptToHtml(hS.get());hO.add(bH,hV,g);hS.clear();hS.add(hR[i],ek);}
else {hS.add(hR[i],ek);}
;}
;hO.add(this.__Pw(qx.bom.String.escape(hS.get())),cy);return hO.get();}
,disableMenuButtons:function(){var hW=this.__OP;for(var i=0;i<hW.length;i++ ){hW[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var hX=this.__OP;for(var i=0;i<hX.length;i++ ){hX[i].setEnabled(true);}
;}
,__Pw:function(ib){var ia=ib;function hY(ie){var s=new qx.util.StringBuilder(arguments[1],be,arguments[2],b);var ic;var id=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++ ){ic=arguments[i];if(ic==dU){id=true;break;}
else {var m=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;var r;while((r=m.exec(ic))!=null){s.add(ep,r[1],M,r[2].replace(/\s*$/,ea),b);}
;}
;}
;s.add((id?dU:ea));}
;s.add(dq);return s.get();}
;ia=ia.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,hY);return ia;}
,polish:function(ig){return ig.replace(bM,ea).replace(/_/g,dR);}
,__Px:function(e){this.__OK=e.getData()[0].getUserData(G);var ii=this._iframe.getWindow();var ih=ii.qx.Theme.getByName(this.__OK);if(ih&&ii.qx.theme.manager&&ii.qx.theme.manager.Meta){ii.qx.theme.manager.Meta.getInstance().setTheme(ih);}
;}
,_createHeader:function(){var il=new qx.ui.layout.HBox();var ij=new qx.ui.container.Composite(il);ij.setAppearance(H);var im=new qx.ui.basic.Label(dK);var ik=new qxc.ui.versionlabel.VersionLabel();ik.setFont(cC);ij.add(im);ij.add(new qx.ui.core.Spacer,{flex:1});ij.add(ik);return ij;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(eg,bm,eu,dS,cl,bo,bP,dn,bI,dd,dB,dv,dm,cs,ch,dY,cS,ec,E,F,X,d,er,di,dV,L,bj,W,ee,eC,dG,bh,cu,A,U,cf,em,dj,bW,dM);}
});}
)();
(function(){var a="separator-vertical",b="_applyShowLogLevel",c="Boolean",d="qxc.ui.logpane.LogView",f="warn",g='',h="Debug",j="Log",k="auto",m="execute",n="error",o="__Mr",p="icon/16/actions/edit-clear.png",q="Clear",r="DIV",s="middle",t="icon/16/status/dialog-information.png",u="Warning",v="info",w="Log Level",x="Error",y="appear",z="main",A="changeLogLevel",B="Info",C="bold",D="model",E="icon/16/categories/system.png",F="icon/16/status/dialog-error.png",G="monospace",H="icon/16/status/dialog-warning.png",I="debug",J="white",K="scroll";qx.Class.define(d,{extend:qx.ui.container.Composite,construct:function(){this.__Mq=[[I,h,E],[v,B,t],[f,u,H],[n,x,F]];var O=new qx.ui.layout.VBox();O.setSeparator(a);qx.ui.container.Composite.call(this,O);this.setDecorator(z);var M=new qx.ui.basic.Label(this.tr(j)).set({font:C,padding:10,alignY:s,allowGrowX:true,allowGrowY:true});this.__Ki=new qx.ui.toolbar.ToolBar();this.__Ki.add(M);this.__Ki.addSpacer();this.__Ki.setBackgroundColor(J);var L=new qx.ui.toolbar.Button(this.tr(q),p);L.addListener(m,function(e){this.clear();}
,this);this.__Ki.add(L);this.add(this.__Ki);var N=new qx.ui.embed.Html(g);N.set({backgroundColor:J,overflowY:K,overflowX:k,font:G,padding:3});this.add(N,{flex:1});this.__Mr=new qx.log.appender.Element();qx.log.Logger.unregister(this.__Mr);this.__Ms=document.createElement(r);this.__Mr.setElement(this.__Ms);N.addListenerOnce(y,function(){N.getContentElement().getDomElement().appendChild(this.__Ms);}
,this);}
,properties:{showLogLevel:{check:c,apply:b,init:false},logLevel:{check:[I,v,f,n],init:I,event:A}},members:{__Ms:null,__Mr:null,__Mq:null,__Mt:null,__Ki:null,clear:function(){this.__Mr.clear();}
,fetch:function(P){if(!P){P=qx.log.Logger;}
;P.register(this.__Mr);P.clear();}
,getAppenderElement:function(){return this.__Ms;}
,_applyShowLogLevel:function(R,Q){if(!this.__Mt){this.__Mt=this.__Mu();this.__Ki.add(this.__Mt);}
;if(R){this.__Mt.show();}
else {this.__Mt.exclude();}
;}
,__Mu:function(){var S=new qx.ui.menu.Menu();var V=new qx.ui.toolbar.MenuButton(w,E);V.setMenu(S);for(var i=0,l=this.__Mq.length;i<l;i++ ){var U=this.__Mq[i];var T=new qx.ui.menu.Button(U[1],U[2]);T.setUserData(D,U[0]);T.addListener(m,function(W){var X=W.getTarget();this.setLogLevel(X.getUserData(D));V.setIcon(X.getIcon());}
,this);S.add(T);}
;return V;}
},destruct:function(){this._disposeObjects(o);this.__Ms=null;}
});}
)();
...
(function(){var a='.qxappender .type-array{color:#CC3E8A;font-weight:bold;}',b="",c='.qxappender .type-instance{color:#565656;font-weight:bold}',d="qx.log.appender.Element",e='.qxappender .level-info{background:#DEEDFA}',f='.qxappender .type-stringify{color:#565656;font-weight:bold}',g='.qxappender .type-number{color:#155791;font-weight:normal;}',h="qxappender",i='.qxappender .type-map{color:#CC3E8A;font-weight:bold;}',j='.qxappender .type-class{color:#5F3E8A;font-weight:bold}',k='.qxappender .type-boolean{color:#15BC91;font-weight:normal;}',l='.qxappender .level-error{background:#FFE2D5}',m='.qxappender .level-debug{background:white}',n='.qxappender .type-key{color:#565656;font-style:italic}',o='.qxappender .level-user{background:#E3EFE9}',p='.qxappender .level-warn{background:#FFF7D5}',q='.qxappender .type-string{color:black;font-weight:normal;}';qx.Class.define(d,{extend:qx.core.Object,construct:function(s){qx.core.Object.call(this);var r=[m,e,p,l,o,q,g,k,a,i,n,j,c,f];qx.bom.Stylesheet.createElement(r.join(b));qx.log.Logger.register(this);}
,members:{__gJ:null,setElement:function(t){this.clear();if(t){qx.bom.element.Class.add(t,h);}
;this.__gJ=t;}
,clear:function(){var u=this.__gJ;if(u){u.innerHTML=b;}
;}
,process:function(v){var w=this.__gJ;if(!w){return;}
...
(function(){var a="resize",b="demobrowser.InfoWindow",c="Boolean",d="_applyContent",e="center",f="OK",g="execute";qx.Class.define(b,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);this.setLayout(new qx.ui.layout.VBox(10));this.setMinWidth(200);this.setMaxWidth(qx.bom.Viewport.getWidth()-10);this.setMaxHeight(qx.bom.Viewport.getHeight()-10);this.setShowMinimize(false);this.setShowMaximize(false);this.add(this._getContentContainer(),{flex:1});this.add(this._makeOkButton(),{flex:0});this.addListener(a,this.__Py,this);}
,properties:{content:{apply:d},autoCenter:{check:c,init:false}},members:{__ND:null,_getContentContainer:function(){if(!this.__ND){this.__ND=new qx.ui.container.Composite(new qx.ui.layout.Canvas());this.__ND.setMinHeight(20);}
;return this.__ND;}
,clear:function(){this._getContentContainer().removeAll();}
,_makeOkButton:function(){var j=new qx.ui.form.Button(this.tr(f));j.addListener(g,function(k){this.close();}
,this);j.setAllowStretchX(false);j.setMinWidth(60);j.setAlignX(e);return j;}
,_applyContent:function(m,l){this.clear();this._getContentContainer().add(m,{edge:0});}
...
,__Py:function(){if(this.getAutoCenter()){this.center();}
;}
}});}
)();
...
(function(){var a="request",b="mshtml",c="engine.name",d="changeTitle",e="abstract",f="",g='#',h="_applyState",i="Abstract method call",j="event.hashchange",k="_applyTitle",l="changeState",m="qx.bom.History",n="String",o="browser.documentmode",p="qx.event.type.Data";qx.Class.define(m,{extend:qx.core.Object,type:e,construct:function(){qx.core.Object.call(this);this._baseUrl=window.location.href.split(g)[0]+g;this._titles={};this._setInitialState();}
,events:{"request":p},statics:{SUPPORTS_HASH_CHANGE_EVENT:qx.core.Environment.get(j),getInstance:function(){if(!this.$$instance){if(!(window==window.top)&&qx.core.Environment.get(c)==b&&qx.core.Environment.get(o)>=9){this.$$instance=new qx.bom.HashHistory();}
else if(!(window==window.top)&&qx.core.Environment.get(c)==b){this.$$instance=new qx.bom.IframeHistory();}
else if(this.SUPPORTS_HASH_CHANGE_EVENT){this.$$instance=new qx.bom.NativeHistory();}
else if((qx.core.Environment.get(c)==b)){this.$$instance=new qx.bom.IframeHistory();}
else {this.$$instance=new qx.bom.NativeHistory();}
;}
;return this.$$instance;}
},properties:{title:{check:n,event:d,nullable:true,apply:k},state:{check:n,event:l,nullable:true,apply:h}},members:{_titles:null,_applyState:function(r,q){this._writeState(r);}
,_setInitialState:function(){this.setState(this._readState());}
,_encode:function(s){if(qx.lang.Type.isString(s)){return encodeURIComponent(s);}
;return f;}
,_decode:function(t){if(qx.lang.Type.isString(t)){return decodeURIComponent(t);}
;return f;}
,_applyTitle:function(u){if(u!=null){document.title=u||f;}
;}
,addToHistory:function(w,v){if(!qx.lang.Type.isString(w)){w=w+f;}
;if(qx.lang.Type.isString(v)){this.setTitle(v);this._titles[w]=v;}
;if(this.getState()!==w){this._writeState(w);}
;}
...
,this,100);}
,_onHistoryLoad:function(x){this.setState(x);this.fireDataEvent(a,x);if(this._titles[x]!=null){this.setTitle(this._titles[x]);}
;}
,_readState:function(){throw new Error(i);}
,_writeState:function(){throw new Error(i);}
,_setHash:function(A){var y=this._baseUrl+(A||f);var z=window.location;if(y!=z.href){z.href=y;}
;}
,_getHash:function(){var B=/#(.*)$/.exec(window.location.href);return B&&B[1]?B[1]:f;}
},destruct:function(){this._titles=null;}
});}
)();
(function(){var a="qx.blankpage",b="undefined",c="",d="interval",e="#",f="-1000px",g="hidden",h="can't initialize iframe",i="qx.bom.HashHistory",j="absolute";qx.Class.define(i,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this._baseUrl=null;this.__rc();}
,members:{__qY:null,__ra:null,__rb:false,addToHistory:function(l,k){if(!qx.lang.Type.isString(l)){l=l+c;}
;if(qx.lang.Type.isString(k)){this.setTitle(k);this._titles[l]=k;}
;if(this.getState()!==l){this._writeState(l);}
;}
,__rc:function(){this.__ra=this.__rd();document.body.appendChild(this.__ra);this.__re(function(){this._baseUrl=this.__ra.contentWindow.document.location.href;this.__rf();}
,this);}
,__rd:function(){var m=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(a))+e});m.style.visibility=g;m.style.position=j;m.style.left=f;m.style.top=f;return m;}
,__re:function(n,p,o){if(typeof o===b){o=0;}
;if(!this.__ra.contentWindow||!this.__ra.contentWindow.document){if(o>20){throw new Error(h);}
;qx.event.Timer.once(function(){this.__re(n,p, ++o);}
,this,10);return;}
;this.__rb=true;n.call(p||window);}
,__rf:function(){qx.event.Idle.getInstance().addListener(d,this.__rh,this);}
,__rg:function(){qx.event.Idle.getInstance().removeListener(d,this.__rh,this);}
,__rh:function(){var q=this._readState();if(qx.lang.Type.isString(q)&&q!=this.getState()){this._onHistoryLoad(q);}
;}
,_readState:function(){var r=!this._getHash()?c:this._getHash().substr(1);return this._decode(r);}
,_getHash:function(){if(!this.__rb){return null;}
;return this.__ra.contentWindow.document.location.hash;}
,_writeState:function(s){this._setHash(this._encode(s));}
,_setHash:function(u){if(!this.__ra||!this._baseUrl){return;}
;var t=!this.__ra.contentWindow.document.location.hash?c:this.__ra.contentWindow.document.location.hash.substr(1);if(u!=t){this.__ra.contentWindow.document.location.hash=u;}
;}
},destruct:function(){this.__rg();this.__ra=null;}
});}
)();
...
(function(){var a="request",b="qx.bom.IframeHistory",c="engine.name",d="can't initialize iframe",f="",g="mshtml",h="interval",i="state",j='<html><body><div id="state">',k="-1000px",l="browser.version",m="hidden",n="qx.blankpage",o="undefined",p='</div></body></html>',q="absolute";qx.Class.define(b,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__rn();}
,members:{__ra:null,__rb:false,__rj:null,__rk:null,__rl:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);this.__rl=this._getHash();}
,_setHash:function(r){qx.bom.History.prototype._setHash.call(this,r);this.__rl=this._encode(r);}
,addToHistory:function(t,s){if(!qx.lang.Type.isString(t)){t=t+f;}
;if(qx.lang.Type.isString(s)){this.setTitle(s);this._titles[t]=s;}
;if(this.getState()!==t){this.setState(t);}
;this.fireDataEvent(a,t);}
,_onHistoryLoad:function(u){this._setState(u);this.fireDataEvent(a,u);if(this._titles[u]!=null){this.setTitle(this._titles[u]);}
;}
,_setState:function(v){this.__rk=true;this.setState(v);this.__rk=false;}
,_applyState:function(x,w){if(this.__rk){return;}
;this._writeState(x);}
,_readState:function(){if(!this.__rb){return this._decode(this._getHash());}
;var y=this.__ra.contentWindow.document;var z=y.getElementById(i);return z?this._decode(z.innerText):f;}
,_writeState:function(B){if(!this.__rb){this.__rm();this.__rj=qx.event.Timer.once(function(){this._writeState(B);}
,this,50);return;}
;this.__rm();var B=this._encode(B);if(qx.core.Environment.get(c)==g&&qx.core.Environment.get(l)!=8){this._setHash(B);}
;var A=this.__ra.contentWindow.document;A.open();A.write(j+B+p);A.close();}
,__rm:function(){if(this.__rj){this.__rj.stop();this.__rj.dispose();}
;}
,__rn:function(){this.__rc(function(){qx.event.Idle.getInstance().addListener(h,this.__rh,this);}
);}
,__rh:function(e){var D=null;var C=this._getHash();if(!this.__rp(C)){D=this.__ro(C);}
else {D=this._readState();}
;if(qx.lang.Type.isString(D)&&D!=this.getState()){this._onHistoryLoad(D);}
;}
,__ro:function(E){E=this._decode(E);this._writeState(E);return E;}
,__rp:function(F){return qx.lang.Type.isString(F)&&F==this.__rl;}
,__rc:function(G){this.__ra=this.__rd();document.body.appendChild(this.__ra);this.__re(function(){this._writeState(this.getState());if(G){G.call(this);}
;}
,this);}
,__rd:function(){var H=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(n))});H.style.visibility=m;H.style.position=q;H.style.left=k;H.style.top=k;return H;}
,__re:function(I,K,J){if(typeof J===o){J=0;}
;if(!this.__ra.contentWindow||!this.__ra.contentWindow.document){if(J>20){throw new Error(d);}
;qx.event.Timer.once(function(){this.__re(I,K, ++J);}
,this,10);return;}
;this.__rb=true;I.call(K||window);}
},destruct:function(){this.__ra=null;if(this.__rj){this.__rj.dispose();this.__rj=null;}
;qx.event.Idle.getInstance().removeListener(h,this.__rh,this);}
});}
)();
(function(){var a="qx.bom.NativeHistory",b="hashchange",c="engine.name",d="interval";qx.Class.define(a,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__rf();}
,members:{__qY:null,__rf:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){var e=qx.lang.Function.bind(this.__rh,this);this.__qY=qx.event.GlobalError.observeMethod(e);qx.bom.Event.addNativeListener(window,b,this.__qY);}
else {qx.event.Idle.getInstance().addListener(d,this.__rh,this);}
;}
,__rg:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,b,this.__qY);}
else {qx.event.Idle.getInstance().removeListener(d,this.__rh,this);}
;}
,__rh:function(){var f=this._readState();if(qx.lang.Type.isString(f)&&f!=this.getState()){this._onHistoryLoad(f);}
;}
,_readState:function(){return this._decode(this._getHash());}
,_writeState:qx.core.Environment.select(c,{"opera":function(g){qx.event.Timer.once(function(){this._setHash(this._encode(g));}
,this,0);}
,"default":function(h){this._setHash(this._encode(h));}
})},destruct:function(){this.__rg();}
});}
)();
...
;this._getIframeElement().addListener(h,this.__wp,this);}
...
,__wp:function(e){var r=e.getData();if(r){this.setSource(r);}
;this.fireDataEvent(h,r);}
}});}
)();
(function(){var a="no",b="mousedown",c="Boolean",d="px",f="event.help",g="gecko",h="auto",i="_applyScrollbar",j="Unable to set 'nativeHelp' property, possibly due to security restrictions",k="qx.debug",l="DOMNodeInserted",m="load",n="_applyNativeHelp",o="yes",p="scrolling",q="/",r="__wt",s="help",t="appear",u="engine.name",v="mouseup",w="block",x="qx.ui.embed.Iframe",y="losecapture",z="contextmenu",A="none",B="iframe",C="display";qx.Class.define(x,{extend:qx.ui.embed.AbstractIframe,construct:function(D){if(D!=null){this.__ws=D;}
;qx.ui.embed.AbstractIframe.call(this,D);qx.event.Registration.addListener(document.body,b,this.block,this,true);qx.event.Registration.addListener(document.body,v,this.release,this,true);qx.event.Registration.addListener(document.body,y,this.release,this,true);this.__wt=this._createBlockerElement();if((qx.core.Environment.get(u)==g)){this.addListenerOnce(t,function(e){var E=this.getContentElement().getDomElement();qx.bom.Event.addNativeListener(E,l,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:B},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:c,init:false,apply:n},scrollbar:{check:[h,a,o],nullable:true,themeable:true,apply:i}},members:{__ws:null,__wt:null,renderLayout:function(J,top,H,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,J,top,H,F);var I=d;var G=this.getInsets();this.__wt.setStyles({"left":(J+G.left)+I,"top":(top+G.top)+I,"width":(H-G.left-G.right)+I,"height":(F-G.top-G.bottom)+I});}
,_createContentElement:function(){var K=new qx.html.Iframe(this.__ws);K.addListener(m,this._onIframeLoad,this);return K;}
...
,block:function(){this.__wt.setStyle(C,w);}
,release:function(){this.__wt.setStyle(C,A);}
...
,setLayoutParent:function(parent){qx.ui.embed.AbstractIframe.prototype.setLayoutParent.call(this,parent);if(parent){this.getLayoutParent().getContentElement().add(this.__wt);}
;}
},destruct:function(){if(this.getLayoutParent()&&this.__wt.getParent()){this.getLayoutParent().getContentElement().remove(this.__wt);}
;this._disposeObjects(r);qx.event.Registration.removeListener(document.body,b,this.block,this,true);qx.event.Registration.removeListener(document.body,v,this.release,this,true);qx.event.Registration.removeListener(document.body,y,this.release,this,true);}
});}
)();
(function(){var a="source",b="element",c="name",d="qx.event.type.Event",f="iframe",g="qx.html.Iframe",h="navigate",i="qx.event.type.Data";qx.Class.define(g,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,f,k,l);this.setSource(j);this.addListener(h,this.__wp,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(b);}
...
;}
,__wp:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
...
,addSpacer:function(){if(!this.__yR){this.__yR=new qx.ui.core.Spacer();}
else {this._remove(this.__yR);}
;this._add(this.__yR);}
,addOpenButton:function(){this._add(this.getChildControl(l));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var L=this.getChildControl(s);if(this.__yQ){this._remove(L);}
;this._add(L);this.__yQ=true;}
,addLabel:function(M){var N=this.getChildControl(D);if(this.__yP){this._remove(N);}
;if(M){this.setLabel(M);}
else {N.setValue(this.getLabel());}
;this._add(N);this.__yP=true;}
,_applyIcon:function(P,O){if(!this.__yT()){this.__yU(P);}
else if(!this.isOpen()){this.__yU(P);}
;}
,_applyIconOpened:function(R,Q){if(this.isOpen()){if(this.__yS()&&this.__yT()){this.__yU(R);}
else if(!this.__yS()&&this.__yT()){this.__yU(R);}
;}
;}
...
;var X;if(W){X=this.__yT()?this.getIconOpened():null;}
else {X=this.getIcon();}
;if(X){this.__yU(X);}
;W?this.addState(t):this.removeState(t);}
,__yS:function(){return qx.util.PropertyUtil.getUserValue(this,s);}
,__yT:function(){return qx.util.PropertyUtil.getUserValue(this,v);}
,__yU:function(Y){var ba=this.getChildControl(s,true);if(ba){ba.setSource(Y);}
;}
...
;}
;if(this.__yR){this.__yR.setWidth((this.getLevel()+1)*this.getIndent()-bf);}
;}
...
(function(){var a="open",b="__qj",c="abstract",d="qx.debug",e="'. It is not a child of this tree item.",f="addItem",g="__gV",h="visible",j="excluded",k="removeItem",m="Invalid child index: ",n="Cannot remove treeitem '",o="qx.ui.tree.core.AbstractTreeItem";qx.Class.define(o,{extend:qx.ui.tree.core.AbstractItem,type:c,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__gV=[];}
,properties:{parent:{check:o,nullable:true}},members:{__gV:null,__qj:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
;}
;}
,getChildrenContainer:function(){if(!this.__qj){this.__qj=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?h:j});}
;return this.__qj;}
,hasChildrenContainer:function(){return this.__qj;}
...
;}
,__GN:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);}
;}
...
;this.__gV.push(Q);if(!N){this.__GN();}
;if(P){Q.recursiveAddToWidgetQueue();P.fireNonBubblingEvent(f,qx.event.type.Data,[Q]);}
;}
;if(P){qx.ui.core.queue.Widget.add(this);}
;}
,addAt:function(X,T){if(qx.core.Environment.get(d)){this.assert(T<=this.__gV.length&&T>=0,m+T);}
...
;qx.lang.Array.insertAt(this.__gV,X,T);if(!V){this.__GN();}
;if(this.getTree()){X.recursiveAddToWidgetQueue();qx.ui.core.queue.Widget.add(this);}
;}
,addBefore:function(Y,bb){if(qx.core.Environment.get(d)){this.assert(this.__gV.indexOf(bb)>=0);}
;var ba=Y.getParent();if(ba){ba.remove(Y);}
;this.addAt(Y,this.__gV.indexOf(bb));}
,addAfter:function(bd,bc){if(qx.core.Environment.get(d)){this.assert(this.__gV.indexOf(bc)>=0);}
;var be=bd.getParent();if(be){be.remove(bd);}
;this.addAt(bd,this.__gV.indexOf(bc)+1);}
,addAtBegin:function(bf){this.addAt(bf,0);}
,remove:function(bk){for(var i=0,l=arguments.length;i<l;i++ ){var bj=arguments[i];if(this.__gV.indexOf(bj)==-1){this.warn(n+bj+e);return;}
...
(function(){var a="Boolean",b="_applyOpenMode",c="excluded",d="Space",f="Left",g="Enter",h="dblclick",j="changeOpenMode",k="_applyRootOpenClose",l="visible",m="changeSelection",n="qx.ui.tree.Tree",o="qx.event.type.Data",p="qx.ui.tree.core.AbstractTreeItem",q="tree",r="_applyHideRoot",s="changeRoot",t="__pK",u="_applyRoot",v="click",w="keypress",x="none",y="pane",z="Right";qx.Class.define(n,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__pK=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(y).add(this.__pK);this.initOpenMode();this.initRootOpenClose();this.addListener(m,this._onChangeSelection,this);this.addListener(w,this._onKeyPress,this);}
,events:{addItem:o,removeItem:o},properties:{openMode:{check:[v,h,x],init:h,apply:b,event:j,themeable:true},root:{check:p,init:null,nullable:true,event:s,apply:u},hideRoot:{check:a,init:false,apply:r},rootOpenClose:{check:a,init:false,apply:k},appearance:{refine:true,init:q},focusable:{refine:true,init:true}},members:{__pK:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__pK;}
...
,_getContentPaddingTarget:function(){return this.__pK;}
...
(function(){var c="No target to insert tests",d="",e="^",f="demobrowser.TreeDataHandler",g="ttree",h="All",l="\\.[^\\.]+$",m=".",n="test",o="demobrowser.withTests",p="depth";qx.Class.define(f,{extend:qx.core.Object,construct:function(q){qx.core.Object.call(this);this.tmap=q;this.ttree=this.__Pz(q);}
,members:{__Pz:function(u){var s=u;function r(B,x){var y=x.classname;var A=y.split(m);function z(parent,G){if(!G.length){return parent;}
else {var D=G[0];var H=G.slice(1,G.length);var F=null;var E=null;var I=parent.getChildren();for(var i=0;i<I.length;i++ ){if(I[i].label==D){E=I[i];break;}
;}
;if(E==null){E=new demobrowser.Tree(D);parent.add(E);}
;F=z(E,H);return F;}
;}
;var C=z(B,A);if(!C){throw new Error(c);}
;t.readTree(x,C);}
;function v(a,b){return (a.classname<b.classname)?-1:(a.classname>b.classname)?1:0;}
;var w=new demobrowser.Tree(h);var t=this;s.sort(v);for(var i=0;i<s.length;i++ ){r(w,s[i]);}
;return w;}
,readTree:function(L,J){var N=arguments[1]||new demobrowser.Tree(L.classname);var J;function P(a,b){return (a.name<b.name)?-1:(a.name>b.name)?1:0;}
;if(L.tests){L.tests.sort(P);for(var j=0;j<L.tests.length;j++ ){var M=L.tests[j].tags;var K=false;if(!qx.core.Environment.get(o)){for(var k=0;k<M.length;k++ ){if(M[k]===n){K=true;break;}
;}
;}
;if(!K){J=new demobrowser.Tree(L.tests[j].name);J.tags=L.tests[j].tags;J.type=n;J.desc=L.tests[j].desc;J.manifest=L.tests[j].manifest;N.add(J);}
;}
;}
;if(L.children&&L.children.length){for(var j=0;j<L.children.length;j++ ){var O=this.readTree(L.children[j]);{}
;N.add(O);}
;}
;{}
;return N;}
...
,getChilds:function(S){var V=[];var T=this.tmap;var W=e+S+l;var U=new RegExp(W);for(var i=0;i<T.length;i++ ){if(T[i].classname.match(U)){V.push(T[i]);}
;}
;return V;}
...
;return bb;}
,getChildren:function(bc){if(bc==h){var bd=this.tmap;var be=[];for(var i=0;i<bd.length;i++ ){be.push(bd[i].classname);}
;return be;}
else if(this.isClass(bc)){return this.getTests(bc);}
else {return [];}
;}
,isClass:function(bf){if(bf.type&&bf.type==n){return false;}
else {return true;}
;}
,hasTests:function(bg){if(!this.isClass(bg)){return false;}
else {var bh=bg.getChildren();for(var i=0;i<bh.length;i++ ){if(bh[i].type&&bh[i].type==n){return true;}
;}
;return false;}
;}
...
;var bm=this.getPath(bl);if(bl.type&&bl.type==n){bm=bm.concat(bl.label);}
;return bm.join(m);}
...
;}
,testCount:function(br){if(br.type&&br.type==n){return 1;}
else {var bs=0;var bu=br.getIterator(p);var bt;while(bt=bu()){if(bt.type&&bt.type==n){bs++ ;}
;}
;return bs;}
;}
},environment:{"demobrowser.withTests":false},destruct:function(){this.tmap=null;this._disposeObjects(g);}
});}
)();
(function(){var a="tags",b="",c="widgetLinkFlat",d="widgetLinkFull",e="parent",g="manifest",h="children",j="depth",k="demobrowser.Tree";qx.Class.define(k,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.label=arguments[0]||b;this.children=[];this.tags=null;this.parent=null;this.manifest=null;this.readme=null;}
...
,map:function(l,n){var m=j;var o=this;var p=this.getIterator(m);while(o=p()){l.apply(o,n);}
;}
,print:function(){this.map(function(){this.debug(this.label);}
,[]);}
,getIterator:function(r){var s=[this];var q=r==j?1:0;function f(){var t;if(s.length){t=s.shift();var u=t.getChildren();if(u.length){if(q){s=u.concat(s);}
else {s=s.concat(u);}
;}
;}
else {t=null;}
...
,getSibling:function(y){var v=this.parent.getChildren();var w=this.self(arguments).indexOf(v,this);var x=w+y;if(v[x]){return v[x];}
;}
,add:function(z){this.children.push(z);z.parent=this;}
},statics:{indexOf:function(A,B){for(var i=0;i<A.length;i++ ){if(A[i]==B){return i;}
;}
;}
},destruct:function(){this._disposeObjects(d,c,e);this._disposeArray(h);this._disposeArray(a);this._disposeMap(g);}
});}
)();
...
(function(){var a="qxc.ui.versionlabel.VersionLabel",b="versionLabel.name",c="qooxdoo",d="",e='3.0',f='',g="versionLabel.version",h=" ";qx.Class.define(a,{extend:qx.ui.basic.Label,construct:function(j,i){if(j==undefined){j=qx.core.Environment.get(b);}
;if(i==undefined){i=qx.core.Environment.get(g);if(i==null){i=f;if(i==d){i=e;}
;}
;}
...
(function(){var a="main",b="Demo browser",c="tree",d="demobrowser.Appearance";qx.Theme.define(d,{extend:qx.theme.indigo.Appearance,title:b,appearances:{"demo-tree":{alias:c,include:c,style:function(){return {width:270,padding:0,decorator:a};}
}}});}
)();
(function(){var a="demobrowser.Theme",b="Demo browser";qx.Theme.define(a,{title:b,meta:{color:qx.theme.indigo.Color,decoration:qx.theme.indigo.Decoration,font:qx.theme.indigo.Font,icon:qx.theme.icon.Tango,appearance:demobrowser.Appearance}});}
)();
