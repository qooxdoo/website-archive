...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_FlexShrinking.64e58bb7a534.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="east",b="yellow",c="center",d="demobrowser.demo.layout.Dock_FlexShrinking",e="north",f="south",g="west",h="x",i="green",j="blue",k="fuchsia",l="orange",m="main",n="y",o="red";qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(q);var p=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:m,backgroundColor:b,width:150,height:100,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:m,backgroundColor:o});var v=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j});var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});var t=new qx.ui.core.Widget().set({decorator:m,backgroundColor:i});var s=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k});p.add(w,{edge:e,flex:1});p.add(v,{edge:g,flex:1});p.add(u,{edge:f,flex:1});p.add(t,{edge:a,flex:1});p.add(s,{edge:c});q.add(p);var r=new qx.ui.layout.Dock();r.setSort(n);var p=(new qx.ui.container.Composite(r)).set({decorator:m,backgroundColor:b,width:150,height:100,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:m,backgroundColor:o});var v=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j});var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});var t=new qx.ui.core.Widget().set({decorator:m,backgroundColor:i});var s=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k});p.add(w,{edge:e,flex:1});p.add(v,{edge:g,flex:1});p.add(u,{edge:f,flex:1});p.add(t,{edge:a,flex:1});p.add(s,{edge:c});q.add(p);var r=new qx.ui.layout.Dock();r.setSort(h);var p=(new qx.ui.container.Composite(r)).set({decorator:m,backgroundColor:b,width:150,height:100,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:m,backgroundColor:o});var v=new qx.ui.core.Widget().set({decorator:m,backgroundColor:j});var u=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});var t=new qx.ui.core.Widget().set({decorator:m,backgroundColor:i});var s=new qx.ui.core.Widget().set({decorator:m,backgroundColor:k});p.add(w,{edge:e,flex:1});p.add(v,{edge:g,flex:1});p.add(u,{edge:f,flex:1});p.add(t,{edge:a,flex:1});p.add(s,{edge:c});q.add(p);}
}});}
)();
