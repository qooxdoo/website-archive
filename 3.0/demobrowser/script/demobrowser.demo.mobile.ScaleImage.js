...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.e3f010a386ca.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(x);var D={"width":j,"height":v,"position":C,"left":s,"top":s,"background":d+G+f};this.__zR=new qx.html.Element(h,D);this.__zR.addListener(a,this.__im,this);this.__zR.addListener(p,this.__in,this);F.add(this.__zR);}
,__im:function(e){if(e.isMultiTouch()){this.__JT=e.getRotation()+this.__JS;this.__JU=e.getScale()*this.__JR;this.__zR.setStyle(o,z+this.__JT+i+this.__JU+f);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__zR.getStyle(q))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__zR.getStyle(b))/2);this.__zR.setStyles({"left":I+c,"top":top+c});}
;}
,__in:function(e){if(e.isMultiTouch()){this.__JS=this.__JT;this.__JR=this.__JU;}
;}
}});}
)();
