...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas.d2c3ef98bdcb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="_applyCanvasWidth",c="redraw",d="Boolean",f="_applyCanvasHeight",g="qx.ui.embed.Canvas",h="Integer",i="__DB",j="qx.event.type.Data";qx.Class.define(g,{extend:qx.ui.core.Widget,construct:function(l,k){qx.ui.core.Widget.call(this);this.__DB=new qx.util.DeferredCall(this.__DC,this);this.addListener(a,this._onResize,this);if(l!==undefined){this.setCanvasWidth(l);}
;if(k!==undefined){this.setCanvasHeight(k);}
;}
,events:{"redraw":j},properties:{syncDimension:{check:d,init:false},canvasWidth:{check:h,init:300,apply:b},canvasHeight:{check:h,init:150,apply:f}},members:{__DB:null,_createContentElement:function(){return new qx.html.Canvas();}
,__DC:function(){var n=this.getContentElement();var p=n.getHeight();var m=n.getWidth();var o=n.getContext2d();this._draw(m,p,o);this.fireNonBubblingEvent(c,qx.event.type.Data,[{width:m,height:p,context:o}]);}
,_applyCanvasWidth:function(r,q){this.getContentElement().setWidth(r);this.__DB.schedule();}
,_applyCanvasHeight:function(t,s){this.getContentElement().setHeight(t);this.__DB.schedule();}
,update:function(){this.__DB.schedule();}
...
(function(){var a="canvas",b="2d",c="qx.html.Canvas";qx.Class.define(c,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__ek=document.createElement(a);}
,members:{__ek:null,_createDomElement:function(){return this.__ek;}
,getCanvas:function(){return this.__ek;}
,setWidth:function(f){this.__ek.width=f;}
,getWidth:function(){return this.__ek.width;}
,setHeight:function(g){this.__ek.height=g;}
,getHeight:function(){return this.__ek.height;}
,getContext2d:function(){return this.__ek.getContext(b);}
