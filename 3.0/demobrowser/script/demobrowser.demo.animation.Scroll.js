...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Scroll.b63c2c3258e6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="span",b="qx.module.Template";qx.Bootstrap.define(b,{statics:{get:function(e,f,d){var c=qx.bom.Template.get(e,f,d);c=qx.module.Template.__Hs(c);return qxWeb.$init([c]);}
,render:function(h,i,g){return qx.bom.Template.render(h,i,g);}
,renderToNode:function(l,m,k){var j=qx.bom.Template.renderToNode(l,m,k);j=qx.module.Template.__Hs(j);return qxWeb.$init([j]);}
,__Hs:function(n){if(q.isTextNode(n)){var o=document.createElement(a);o.appendChild(n);n=o;}
;return n;}
...
(function(){var a="#resetbutton",b="click",c="animationEnd",d="list-template",e=".list",f="scrolling",g="#startbutton",h="demobrowser.demo.animation.Scroll";qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var j={items:[]};for(var i=0;i<30;i++ ){j.items.push(i);}
;for(var i=0;i<5;i++ ){q.template.get(d,j).appendTo(document.body);}
...
,reset:function(){q(e).forEach(function(k,i){k.scrollTop=i*100;}
);}
}});}
)();
