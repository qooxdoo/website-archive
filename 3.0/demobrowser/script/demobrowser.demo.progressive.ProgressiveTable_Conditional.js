...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional.0144e4f47aa8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="progressive-table-header-cell",b="resize",c="progressive-table-header",d="_layout",f="qx.ui.progressive.headfoot.TableHeading";qx.Class.define(f,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(l,k){qx.ui.progressive.headfoot.Abstract.call(this);this.__EV=l;var j=l.getData();this.__EW=[];for(var i=0;i<j.length;i++ ){var g=new qx.ui.basic.Atom(k[i]);g.setAppearance(a);this.add(g);this.__EW[i]=g;}
;var h=new qx.ui.core.Widget();h.set({height:16,appearance:a,minWidth:0,width:0});this.add(h,{flex:1});this.addListener(b,this._resizeColumns,this);this.__qL=new qx.ui.layout.HBox();this.__qL.connectToWidget(this);}
,properties:{appearance:{refine:true,init:c}},members:{__EV:null,__EX:null,__EW:null,__qL:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__EX){return this.__EV.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var p=this.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();this.__EX=true;var n={top:this.getPaddingTop(),right:this.getPaddingRight(),bottom:this.getPaddingBottom(),left:this.getPaddingLeft()};this.__qL.renderLayout(p,100,n);this.__EX=false;var o=this.__EV.getData();for(var i=0;i<o.length;i++ ){this.__EW[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__EV=this.__EW=null;this._disposeObjects(d);}
});}
)();
...
(function(){var a="resize",b="__qL",c="content",d="px",f="  font-size: 11px;",g=")",h="px ",j=';',k='',l="padding: ",m="end",n="div",o="  position: absolute;",p="qx.tableResizeDebug",q="changeTheme",r="-col-",s="__columnData",t="css.userselect",u="Renderer is already joined to a Progressive.",v="css.boxmodel",w="css.textoverflow",x="  top: 0px;",y="  width : 100%;",z="  overflow:hidden;",A=" {",B="}",C="  border-right:1px solid #f2f2f2;",D="Invalid location: ",E="  cursor:default;",F="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",G="-row {",H="-row",I="qx.debug",J="qx.dyntheme",K="__FI",L="start",M="relative",N="",O=": width=",P=':ellipsis;',Q=':',R="  white-space:nowrap;",S="  padding : 0px 6px 0px 6px;",T="qx.ui.progressive.renderer.table.Row",U="width: ",V=" out of range (max: ",W="px;",X="0px ",Y="progressive-table-row-background-odd",bo=".qx-progressive-",bp="  height: 100%;",bq="qx-progressive-",bk="progressive-table-row-background-even",bl="col ",bm="  border-bottom:1px solid #eeeeee;",bn="left: ",br="No existing renderer for column ",bs="css.userselect.none",bt="Column ";qx.Class.define(T,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bu){qx.ui.progressive.renderer.Abstract.call(this);this.__EV=bu;this.__FH={};this.__FI=new qx.ui.progressive.renderer.table.cell.Default();this.__ED=null;this.__FJ={};this.__FN();this.__qL=new qx.ui.layout.HBox();this.__qL.connectToWidget(this);if(qx.core.Environment.get(J)){qx.theme.manager.Color.getInstance().addListener(q,this.__FN,this);}
;}
,statics:{__tK:null,__FK:6,__FL:o+x+bp+z+(qx.core.Environment.get(w)?qx.bom.Style.getCssName(qx.core.Environment.get(w))+P:N)+R+C+bm+S+E+f+F+(qx.core.Environment.get(t)?qx.bom.Style.getCssName(qx.core.Environment.get(t))+Q+qx.core.Environment.get(bs)+j:k)},properties:{defaultRowHeight:{init:16}},members:{__ED:null,__st:null,__FM:null,__EV:null,__FH:null,__FI:null,__FJ:null,__qL:null,__FN:function(){var bv=qx.theme.manager.Color.getInstance();this.__FJ.bgcol=[];this.__FJ.bgcol[0]=bv.resolve(bk);this.__FJ.bgcol[1]=bv.resolve(Y);}
,join:function(bx,name){if(this.__ED){throw new Error(u);}
;this.__ED=bx;this.__st=name;var by=qx.ui.progressive.renderer.table.Row;if(!by.__tK){by.__tK={};}
;var bw=bx.toHashCode();if(!by.__tK[bw]){by.__tK[bw]={rowstylesheet:null,cellstylesheet:[]};var bz=bo+bw+G+y+B;by.__tK[bw].rowstylesheet=qx.bom.Stylesheet.createElement(bz);var bA=this.__EV.getData();for(var i=0;i<bA.length;i++ ){var bz=bo+bw+r+i+A+by.__FL+B;by.__tK[bw].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bz);}
;this.__FM=bw;var bB=bx.getStructure().getPane();bB.addListener(a,this._resizeColumns,this);}
;}
,addRenderer:function(bC,bE){var bD=this.__EV.getData();if(bC<0||bC>=bD.length){throw new Error(bt+bC+V+(bD.length-1)+g);}
;this.__FH[bC]=bE;}
,removeRenderer:function(bF){var bG=this.__EV.getData();if(bF<0||bF>=bG.length){throw new Error(bt+bF+V+(bG.length-1)+g);}
;if(!this.__FH[bF]){throw new Error(br+bF);}
;delete this.__FH[bF];}
,render:function(bI,bR){var bS=bR.data;var bM=[];var bO;var bN;var bK=0;if(bI.getRendererData()[this.__st].end===undefined){bI.getRendererData()[this.__st]={end:0,start:1,rows:0,totalHeight:0};}
;var bQ=document.createElement(n);for(var i=0;i<bS.length;i++ ){var bL=bq+this.__FM+r+i;bN=this.__FH[i]||this.__FI;bO={state:bI,rowDiv:bQ,stylesheet:bL,element:bR,dataIndex:i,cellData:bS[i],height:bK};bM.push(bN.render(bO));if(bO.height>bK){bK=bO.height;}
;}
;bK=(bK>0?bK:this.getDefaultRowHeight());var bP=bI.getRendererData()[this.__st];bP.totalHeight+=bK;bQ.style.position=M;bQ.style.height=bK+d;bQ.className=bq+this.__FM+H;bQ.innerHTML=bM.join(N);switch(bR.location){case m:var bH=bP.end||0;bQ.style.backgroundColor=this.__FJ.bgcol[bH];bP.end=(bH==0?1:0);bI.getPane().getContentElement().getDomElement().appendChild(bQ);break;case L:var bJ=bI.getPane().getContentElement().getDomElement();var bT=bJ.childNodes;if(bT.length>0){var bH=bP.start;bQ.style.backgroundColor=this.__FJ.bgcol[bH];bP.start=(bH==0?1:0);bJ.insertBefore(bQ,bT[0]);break;}
else {bJ.appendChild(bQ);}
;break;default:throw new Error(D+bR.location);}; ++bP.rows;}
,getLayoutChildren:function(){return this.__EV.getData();}
,_resizeColumns:function(e){var cc=this.__ED.getStructure().getPane();var bY=cc.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();var bW=bo+this.__FM+H;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__tK[this.__FM].rowstylesheet,bW);var bX=U+bY+W;qx.bom.Stylesheet.addRule(bV.__tK[this.__FM].rowstylesheet,bW,bX);this.__qL.renderLayout(bY,100,{top:0,right:0,bottom:0,left:0});var cb=this.__EV.getData();for(var i=0,ce=0;i<cb.length;i++ ,ce+=bY){var bW=bo+this.__FM+r+i;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__tK[this.__FM].cellstylesheet[i],bW);bY=cb[i].getComputedWidth();if(qx.core.Environment.get(I)){if(qx.core.Environment.get(p)){this.debug(bl+i+O+bY);}
;}
;var ca;if(qx.core.Environment.get(v)==c){ca=qx.ui.progressive.renderer.table.Row.__FK*2;}
else {ca=-1;}
;var cf=(bY-ca)+W;var cd=X+qx.ui.progressive.renderer.table.Row.__FK+h+X+qx.ui.progressive.renderer.table.Row.__FK+W;var bU=ce+W;var bX=bV.__FL+U+cf+bn+bU+l+cd;qx.bom.Stylesheet.addRule(bV.__tK[this.__FM].cellstylesheet[i],bW,bX);}
;}
},destruct:function(){qx.theme.manager.Color.getInstance().removeListener(q,this.__FN,this);var name;for(name in this.__FH){this.__FH[name]=null;}
;var ch=qx.ui.progressive.renderer.table.Row;var cg=this.__ED.toHashCode();if(ch.__tK&&ch.__tK[cg]){if(ch.__tK[cg].rowstylesheet){var cj=bo+this.__FM+H;var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ch.__tK[this.__FM].rowstylesheet,cj);}
;if(ch.__tK[cg].cellstylesheet){for(var i=ch.__tK[cg].cellstylesheet.length-1;i>=0;i-- ){var cj=bo+this.__FM+r+i;var ci=ch.__tK[this.__FM].cellstylesheet[i];var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ci,cj);}
;}
;}
;if(this.__ED&&this.__ED.getRendererData){var ck=this.__ED.getRendererData();if(ck&&ck[this.__st]&&ck[this.__st].end!==undefined){ck[this.__st]=null;}
;}
;this.__FJ=this.__FH=this.__ED=this.__EV=null;this._disposeObjects(b,K,s);}
});}
)();
...
(function(){var a="regex cannot be null!",b="font-weight",c="==",d="Condition not recognized or value1/value2 is null!",e="Condition not recognized or value is null!",f="",g=">",h="text-align",j="between",k="regex",l="<",m='g',n="qx.ui.progressive.renderer.table.cell.Conditional",o=":",p=";",q="!between",r=">=",s="color",t="font-style",u="!=",v="<=";qx.Class.define(n,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(y,w,x,z){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__vW=[c,u,g,l,r,v];this.__vX=[j,q];this.__vY=[];this.__wa=y||f;this.__wb=w||f;this.__wc=x||f;this.__wd=z||f;}
,members:{__vW:null,__vX:null,__vY:null,__wa:null,__wb:null,__wc:null,__wd:null,__we:function(B,A){if(B.align){A[h]=B.align;}
;if(B.color){A[s]=B.color;}
;if(B.style){A[t]=B.style;}
;if(B.weight){A[b]=B.weight;}
;}
,addNumericCondition:function(I,H,G,F,C,E,D){if(!qx.lang.Array.contains(this.__vW,I)||H==null){throw new Error(e);}
;this.__vY.push({condition:I,align:G,color:F,style:C,weight:E,value1:H,target:D});}
,addBetweenCondition:function(Q,P,O,N,M,J,L,K){if(!qx.lang.Array.contains(this.__vX,Q)||P==null||O==null){throw new Error(d);}
;this.__vY.push({condition:Q,align:N,color:M,style:J,weight:L,value1:P,value2:O,target:K});}
,addRegex:function(R,W,V,S,U,T){if(!R){throw new Error(a);}
;this.__vY.push({condition:k,align:W,color:V,style:S,weight:U,regex:R,target:T});}
,_getCellStyle:function(bb){if(this.__vY.length==0){return bb.style||f;}
;var i;var bc;var X;var ba={"text-align":this.__wa,"color":this.__wb,"font-style":this.__wc,"font-weight":this.__wd};for(i=0;i<this.__vY.length;i++ ){var bf=this.__vY[i];bc=false;if(qx.lang.Array.contains(this.__vW,bf.condition)){if(bf.target==null){X=bb.cellData;}
...
;break;};}
else if(qx.lang.Array.contains(this.__vX,bf.condition)){if(bf.target==null){X=bb.cellData;}
else {X=bb.element.data[bf.target];}
...
;if(bc){this.__we(bf,ba);}
;var bd=[];for(var be in ba){if(ba[be]){bd.push(be,o,ba[be],p);}
;}
;}
;return bd.join(f);}
},destruct:function(){this.__vW=this.__vX=this.__vY=null;}
});}
)();
