...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker.c0252e67452a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__eP();}
,members:{__IM:null,__wt:null,__IN:null,__IO:false,__IP:10000,__IQ:0,__IR:f,block:function(r){if(!this.__IO){this.__IN=r;var q=this.__IU();this.__IV(q);this.__IO=true;}
;}
,unblock:function(){if(this.__IO){this.__IW();this.__IO=false;}
;}
,isBlocked:function(){return this.__IO;}
,getBlockerElement:function(){return this.__wt;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__wt,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wt,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wt,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wt);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wt,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wt,h);}
,__eP:function(){this.__IS();if((qx.core.Environment.get(j)==b)){this.__IT();}
;qx.event.Registration.addListener(window,a,this.__zb,this);}
,__IS:function(){this.__wt=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wt,{display:d,opacity:this.__IQ,backgroundColor:this.__IR});this.setBlockerZIndex(this.__IP);}
,__IT:function(){this.__IM=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__IM,l,false);qx.bom.element.Attribute.set(this.__IM,i,n);qx.bom.element.Style.setStyles(this.__IM,{display:d,opacity:this.__IQ});}
,__IU:function(){var v={position:p};if(this.__IY()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__IN)+g;v.height=qx.bom.element.Dimension.getHeight(this.__IN)+g;v.left=qx.bom.element.Location.getLeft(this.__IN)+g;v.top=qx.bom.element.Location.getTop(this.__IN)+g;}
;return v;}
,__IV:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wt,w);qx.dom.Element.insertEnd(this.__wt,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__IM,w);qx.dom.Element.insertEnd(this.__IM,document.body);}
;}
,__IW:function(){qx.dom.Element.remove(this.__wt);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__IM);}
;}
,__zb:function(e){if(this.__IY()){this.__IX({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__IX(y);}
,this,0);}
;}
,__IX:function(z){qx.bom.element.Style.setStyles(this.__wt,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__IM,z);}
;}
,__IY:function(){return (this.__IN==null||qx.dom.Node.isWindow(this.__IN)||qx.dom.Node.isDocument(this.__IN));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__zb,this);this.__IM=this.__wt=this.__IN=null;}
});}
)();
