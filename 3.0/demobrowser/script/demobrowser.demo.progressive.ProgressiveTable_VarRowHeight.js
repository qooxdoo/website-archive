...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight.d259a1afea8d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",b="format-justify-left.png",c="end",d="Found [",e="Id",f="No attributes specified.",g="TALL ICON",h="1*",k=", end=",l="This, too, is small.",m="This, too, is tall.",n="",o="row",p="Searching for [",q="]",s=" not found",t="small icon",u="demobrowser/demo/icons/",v="I am small.",w="red",x="Image data for ",y="I am tall.",z="].  loadCount=",A="multimedia-player.png",B="Image",C="Note variable row heights in this table.";qx.Class.define(a,{extend:qx.application.Standalone,members:{__QV:null,main:function(){qx.application.Standalone.prototype.main.call(this);var H=u;this.imageData=[{url:H+b,height:4,tooltip:t},{url:H+A,height:4,tooltip:g},n];this.__QV=0;var F=qx.util.AliasManager.getInstance();var E=qx.util.ResourceManager.getInstance();var D;var G;for(var i=0;i<this.imageData.length;i++ ){if(!this.imageData[i]){continue;}
;D=F.resolve(this.imageData[i].url);G=E.toUri(D);this.imageData[i].url=G; ++this.__QV;qx.io.ImageLoader.load(G,function(I,J){this.info(p+I+q);for(var j=0;j<this.imageData.length;j++ ){if(this.imageData[j].url==I){this.imageData[j].height=J.height; --this.__QV;this.debug(d+this.imageData[j].url+z+this.__QV+k+this.imageData.length);if(this.__QV==0){this.doLoad();}
;return;}
;}
;throw new Error(x+I+s);}
,this);}
;if(this.__QV==0){this.doLoad();}
;}
...
(function(){var a="qx.ui.progressive.renderer.table.cell.Image",b="string",c="";qx.Class.define(a,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(d,e){qx.ui.progressive.renderer.table.cell.Icon.call(this);if(d===undefined){this.__yC=d;}
else {this.__yC=16;}
;if(e===undefined){this.__yD=e;}
else {this.__yD=16;}
;}
,members:{__yC:null,__yD:null,_identifyImage:function(k){var h={imageWidth:this.__yC,imageHeight:this.__yD};var j;if(typeof (k.cellData)==b){h.url=k.cellData;}
