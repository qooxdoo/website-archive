...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ComboBox.d0aace688e0a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="blur",b="Enter",c="changeValue",d="selected",f="key",g="button",h="Down",i="qx.event.type.Data",j="inner",k="visible",l="quick",m="String",n="list",o="textfield",p="qx.ui.form.ComboBox",q="single",r="focusin",s="combobox",t="click",u="popup",v="focusout",w="_applyPlaceholder";qx.Class.define(p,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.form.IStringForm],construct:function(){qx.ui.form.AbstractSelectBox.call(this);var x=this._createChildControl(o);this._createChildControl(g);this.addListener(t,this._onClick);this.addListener(r,function(e){x.fireNonBubblingEvent(r,qx.event.type.Focus);}
,this);this.addListener(v,function(e){x.fireNonBubblingEvent(v,qx.event.type.Focus);}
,this);}
,properties:{appearance:{refine:true,init:s},placeholder:{check:m,nullable:true,apply:w}},events:{"changeValue":i},members:{__pN:null,__zv:null,_applyPlaceholder:function(z,y){this.getChildControl(o).setPlaceholder(z);}
,_createChildControlImpl:function(C,B){var A;switch(C){case o:A=new qx.ui.form.TextField();A.setFocusable(qx.event.handler.MouseEmulation.ON);A.addState(j);A.addListener(c,this._onTextFieldChangeValue,this);A.addListener(a,this.close,this);this._add(A,{flex:1});break;case g:A=new qx.ui.form.Button();A.setFocusable(false);A.setKeepActive(true);A.addState(j);this._add(A);break;case n:A=qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,C);A.setSelectionMode(q);break;};return A||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,C);}
,_forwardStates:{focused:true,invalid:true},tabFocus:function(){var D=this.getChildControl(o);D.getFocusElement().focus();D.selectAllText();}
,focus:function(){qx.ui.form.AbstractSelectBox.prototype.focus.call(this);this.getChildControl(o).getFocusElement().focus();}
,setValue:function(F){var E=this.getChildControl(o);if(E.getValue()==F){return;}
;E.setValue(F);}
,getValue:function(){return this.getChildControl(o).getValue();}
,resetValue:function(){this.getChildControl(o).setValue(null);}
,_onKeyPress:function(e){var H=this.getChildControl(u);var G=e.getKeyIdentifier();if(G==h&&e.isAltPressed()){this.getChildControl(g).addState(d);this.toggle();e.stopPropagation();}
else if(G==b){if(H.isVisible()){this._setPreselectedItem();this.resetAllTextSelection();this.close();e.stop();}
;}
else if(H.isVisible()){qx.ui.form.AbstractSelectBox.prototype._onKeyPress.call(this,e);}
;}
,_onClick:function(e){var I=e.getTarget();if(I==this.getChildControl(g)){this.toggle();}
else {this.close();}
;}
,_onListMouseDown:function(e){this._setPreselectedItem();}
,_setPreselectedItem:function(){if(this.__pN){var J=this.__pN.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__pN);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__pN=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(n);var L=M.getSelectionContext();if(L==l||L==f){this.__pN=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__pN=null;}
;}
;}
,_onPopupChangeVisibility:function(e){qx.ui.form.AbstractSelectBox.prototype._onPopupChangeVisibility.call(this,e);var P=this.getChildControl(u);if(P.isVisible()){var O=this.getChildControl(n);var Q=this.getValue();var R=null;if(Q){R=O.findItem(Q);}
;if(R){O.setSelection([R]);}
else {O.resetSelection();}
;}
else {if(e.getOldData()==k){this.tabFocus();}
;}
;this.getChildControl(g).removeState(d);}
,_onTextFieldChangeValue:function(e){var T=e.getData();var S=this.getChildControl(n);if(T!=null){var U=S.findItem(T,false);if(U){S.setSelection([U]);}
...
,setTextSelection:function(V,W){this.getChildControl(o).setTextSelection(V,W);}
