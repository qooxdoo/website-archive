...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent.e61f60d9b77f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__Qu=f+p.join(c)+a;this.__Qv=o||50;this.__Qw=n;this._clearLog();}
,_clearLog:function(){this.__Qw.innerHTML=this.__Qu+j;this.__Qx=[];}
,_log:function(q){this.__Qx.unshift(q);this.__Qx=this.__Qx.slice(0,this.__Qv);var r=[this.__Qu];for(var i=0;i<this.__Qx.length;i++ ){r.push(g,this.__Qx[i].join(e),l);}
;r.push(j);this.__Qw.innerHTML=r.join(d);this.__Qw.scrollTop=0;}
,__Qu:null,__Qv:null,__Qw:null,__Qx:null},destruct:function(){this.__Qw=this.__Qx=null;}
});}
)();
...
;qx.bom.Element.addListener(F,A,this.__Qy,this);}
...
,this);}
,__Qy:function(e){var K=e.getTarget().id.split(q)[1];var I=e.getTarget().checked;var J=document.getElementById(h);if(I){qx.bom.Element.addListener(J,K,this.logMouseEvent,this);}
