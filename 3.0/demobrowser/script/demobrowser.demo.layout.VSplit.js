...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VSplit","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VSplit.7069a2b98f06.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="vertical",b="Flex:1; Max:100",c="Flex:1; Max:200",d="Flex:1; Min:250",e="Flex:2; Min:250",f="Flex:0; Min:350",g="Auto",h="Flex:2",i="Flex:0",j="Flex:1",k="main",l="Flex:2; Max:100",m="demobrowser.demo.layout.VSplit";qx.Class.define(m,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var n=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});scroll.add(n);n.add(this.getSplitPaneTwoFlexSimple(),{left:0});n.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});n.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});n.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});n.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});n.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});n.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});n.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});n.add(this.getSplitPaneAuto(),{top:550,left:630});}
,getSplitPaneTwoFlexSimple:function(){var p=new qx.ui.splitpane.Pane(a);p.setHeight(400);p.setDecorator(k);var o=new qx.ui.form.TextArea(j);o.setDecorator(null);o.setWrap(true);p.add(o,1);var q=new qx.ui.form.TextArea(h);q.setDecorator(null);q.setWrap(true);p.add(q,2);return p;}
,getSplitPaneTwoFlexWithOneMin:function(){var s=new qx.ui.splitpane.Pane(a);s.setHeight(400);s.setDecorator(k);var r=new qx.ui.form.TextArea(d);r.setDecorator(null);r.setWrap(true);r.setMinHeight(250);s.add(r,1);var t=new qx.ui.form.TextArea(h);t.setDecorator(null);t.setWrap(true);s.add(t,2);return s;}
,getSplitPaneTwoFlexWithOneMax:function(){var v=new qx.ui.splitpane.Pane(a);v.setHeight(400);v.setDecorator(k);var u=new qx.ui.form.TextArea(j);u.setDecorator(null);u.setWrap(true);v.add(u,1);var w=new qx.ui.form.TextArea(l);w.setDecorator(null);w.setWrap(true);w.setMaxHeight(100);v.add(w,2);return v;}
,getSplitPaneTwoFlexWithTwoMin:function(){var y=new qx.ui.splitpane.Pane(a);y.setHeight(400);y.setDecorator(k);var x=new qx.ui.form.TextArea(d);x.setDecorator(null);x.setWrap(true);x.setMinHeight(250);y.add(x,1);var z=new qx.ui.form.TextArea(e);z.setDecorator(null);z.setWrap(true);z.setMinHeight(250);y.add(z,2);return y;}
,getSplitPaneTwoFlexWithTwoMax:function(){var B=new qx.ui.splitpane.Pane(a);B.setHeight(400);B.setDecorator(k);var A=new qx.ui.form.TextArea(b);A.setDecorator(null);A.setWrap(true);A.setMaxHeight(100);B.add(A,1);var C=new qx.ui.form.TextArea(l);C.setDecorator(null);C.setWrap(true);C.setMaxHeight(100);B.add(C,2);return B;}
,getSplitPaneOneFlexSimple:function(){var E=new qx.ui.splitpane.Pane(a);E.setHeight(400);E.setDecorator(k);var D=new qx.ui.form.TextArea(i);D.setDecorator(null);D.setWrap(true);E.add(D,0);var F=new qx.ui.form.TextArea(j);F.setDecorator(null);F.setWrap(true);E.add(F);return E;}
,getSplitPaneOneFlexSimpleWithMax:function(){var H=new qx.ui.splitpane.Pane(a);H.setHeight(400);H.setDecorator(k);var G=new qx.ui.form.TextArea(i);G.setDecorator(null);G.setWrap(true);H.add(G,0);var I=new qx.ui.form.TextArea(c);I.setDecorator(null);I.setWrap(true);I.setMaxHeight(200);H.add(I);return H;}
,getSplitPaneOneFlexSimpleWithMin:function(){var K=new qx.ui.splitpane.Pane(a);K.setHeight(400);K.setDecorator(k);var J=new qx.ui.form.TextArea(f);J.setDecorator(null);J.setWrap(true);J.setMinHeight(350);K.add(J,0);var L=new qx.ui.form.TextArea(j);L.setDecorator(null);L.setWrap(true);K.add(L);return K;}
,getSplitPaneAuto:function(){var N=new qx.ui.splitpane.Pane(a);N.setDecorator(k);var M=new qx.ui.form.TextArea(g);M.setDecorator(null);M.setWrap(true);N.add(M,0);var O=new qx.ui.form.TextArea(g);O.setDecorator(null);O.setWrap(true);N.add(O);return N;}
}});}
)();
...
(function(){var a="slider",b="mousedown",c="splitter",d="px",f="mouseout",g="Integer",h="height",i="mousemove",j="move",k="maxHeight",l="resize",m="vertical",n="width",o="_applyOrientation",p="_applyOffset",q="splitpane",r="qx.ui.splitpane.Pane",s="top",t="minHeight",u="knob",v="mouseup",w="horizontal",z="minWidth",A="appear",B="losecapture",C="left",D="maxWidth";qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(E){qx.ui.core.Widget.call(this);this.__gV=[];if(E){this.setOrientation(E);}
else {this.initOrientation();}
;this.__mY.addListener(b,this._onMouseDown,this);this.__mY.addListener(v,this._onMouseUp,this);this.__mY.addListener(i,this._onMouseMove,this);this.__mY.addListener(f,this._onMouseOut,this);this.__mY.addListener(B,this._onMouseUp,this);}
,properties:{appearance:{refine:true,init:q},offset:{check:g,init:6,apply:p},orientation:{init:w,check:[w,m],apply:o}},members:{__nJ:null,__nK:false,__nL:null,__nM:null,__nN:null,__nO:null,__nP:null,__gV:null,__mY:null,_createChildControlImpl:function(H,G){var F;switch(H){case a:F=new qx.ui.splitpane.Slider(this);F.exclude();this._add(F,{type:H});break;case c:F=new qx.ui.splitpane.Splitter(this);this._add(F,{type:H});F.addListener(j,this.__nQ,this);break;};return F||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
,__nQ:function(e){this.__nS(e.getData());}
,__nR:function(K){this.__mY=new qx.ui.splitpane.Blocker(K);this.getContentElement().add(this.__mY);var I=this.getChildControl(c);var J=I.getWidth();if(!J){I.addListenerOnce(A,function(){this.__nS();}
,this);}
;I.addListener(l,function(e){var L=e.getData();if(L.height==0||L.width==0){this.__mY.hide();}
else {this.__mY.show();}
;}
,this);}
,getBlocker:function(){return this.__mY;}
,_applyOrientation:function(Q,N){var R=this.getChildControl(a);var M=this.getChildControl(c);this.__nN=Q===w;if(!this.__mY){this.__nR(Q);}
;this.__mY.setOrientation(Q);var P=this._getLayout();if(P){P.dispose();}
;var O=Q===m?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;this._setLayout(O);M.removeState(N);M.addState(Q);M.getChildControl(u).removeState(N);M.getChildControl(u).addState(Q);R.removeState(N);R.addState(Q);qx.ui.core.queue.Manager.flush();this.__nS();}
,_applyOffset:function(T,S){this.__nS();}
,__nS:function(V){var U=this.getChildControl(c);var ba=this.getOffset();var bb=U.getBounds();var Y=U.getContentElement().getDomElement();if(!Y){return;}
;if(this.__nN){var X=null;if(V){X=V.width;}
else if(bb){X=bb.width;}
;var bc=V&&V.left;if(X){if(isNaN(bc)){bc=qx.bom.element.Location.getPosition(Y).left;}
;this.__mY.setWidth(ba,X);this.__mY.setLeft(ba,bc);}
;}
...
;this.__mY.setHeight(ba,W);this.__mY.setTop(ba,top);}
;}
;}
,add:function(be,bd){if(bd==null){this._add(be);}
else {this._add(be,{flex:bd});}
;this.__gV.push(be);}
,remove:function(bf){this._remove(bf);qx.lang.Array.remove(this.__gV,bf);}
,getChildren:function(){return this.__gV;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;var bg=this.getChildControl(c);var bj=bg.getContentLocation();var bh=this.getContentLocation();this.__nJ=this.__nN?e.getDocumentLeft()-bj.left+bh.left:e.getDocumentTop()-bj.top+bh.top;var bi=this.getChildControl(a);var bk=bg.getBounds();bi.setUserBounds(bk.left,bk.top,bk.width,bk.height);bi.setZIndex(bg.getZIndex()+1);bi.show();this.__nK=true;this.__mY.capture();e.stop();}
,_onMouseMove:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__nK){this.__nT();var bl=this.getChildControl(a);var bm=this.__nO;if(this.__nN){bl.setDomLeft(bm);this.__mY.setStyle(C,(bm-this.getOffset())+d);}
else {bl.setDomTop(bm);this.__mY.setStyle(s,(bm-this.getOffset())+d);}
;e.stop();}
;}
,_onMouseOut:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onMouseUp:function(e){if(!this.__nK){return;}
;this._finalizeSizes();var bn=this.getChildControl(a);bn.exclude();this.__nK=false;this.releaseCapture();e.stop();}
,_finalizeSizes:function(){var br=this.__nO;var bo=this.__nP;if(br==null){return;}
...
else {if(this.__nN){bs.setWidth(br);bq.setWidth(bo);}
else {bs.setHeight(br);bq.setHeight(bo);}
;}
;}
,__nT:function(){if(this.__nN){var bx=z,bE=n,by=D,bC=this.__nL;}
else {var bx=t,bE=h,by=k,bC=this.__nM;}
;var bD=this._getChildren();var bv=bD[2].getSizeHint();var bA=bD[3].getSizeHint();var bB=bD[2].getBounds()[bE]+bD[3].getBounds()[bE];var bz=bC-this.__nJ;var bw=bB-bz;if(bz<bv[bx]){bw-=bv[bx]-bz;bz=bv[bx];}
else if(bw<bA[bx]){bz-=bA[bx]-bw;bw=bA[bx];}
;if(bz>bv[by]){bw+=bz-bv[by];bz=bv[by];}
else if(bw>bA[by]){bz+=bw-bA[by];bw=bA[by];}
;this.__nO=bz;this.__nP=bw;}
,_isActiveDragSession:function(){return this.__nK;}
,_setLastMousePosition:function(x,y){this.__nL=x;this.__nM=y;}
...
(function(){var a="Boolean",b="px",c="nowrap",d="_applyWrap",f="-1",g="_applyMinimalLineHeight",h="Integer",i="textarea",j="auto",k="0",l="mousewheel",m="autoSize is ignored when the height property is set. ",n="-9999px",o="input",p="whiteSpace",q="visible",r="y",s="browser.documentmode",t="",u="width",v="property instead.",w="_applyAutoSize",x="appear",y="tabIndex",z='name',A="normal",B="mshtml",C="engine.name",D="qx.ui.form.TextArea",E="webkit",F='id',G="hidden",H="overflowY",I="If you want to set an initial height, use the minHeight ",J="qx.debug",K="absolute";qx.Class.define(D,{extend:qx.ui.form.AbstractField,construct:function(L){qx.ui.form.AbstractField.call(this,L);this.initWrap();this.addListener(l,this._onMousewheel,this);}
,properties:{wrap:{check:a,init:true,apply:d},appearance:{refine:true,init:i},singleStep:{check:h,init:20},minimalLineHeight:{check:h,apply:g,init:4},autoSize:{check:a,apply:w,init:false}},members:{__oB:null,__oC:null,__oD:null,setValue:function(M){M=qx.ui.form.AbstractField.prototype.setValue.call(this,M);this.__oE();return M;}
,_onMousewheel:function(e){var O=this.getContentElement();var scrollY=O.getScrollY();if(qx.event.handler.MouseEmulation.ON){O.scrollToY(scrollY+e.getWheelDelta(r));}
else {O.scrollToY(scrollY+e.getWheelDelta(r)*this.getSingleStep());}
;var N=O.getScrollY();if(N!=scrollY){e.stop();}
;}
,__oE:function(){if(this.isAutoSize()){var R=this.__oF();if(R&&this.getBounds()){this.__oD=this.__oD||this._getAreaHeight();var T=this._getScrolledAreaHeight();if(this.getMaxHeight()){var P=this.getInsets();var Q=-P.top+this.getMaxHeight()-P.bottom;if(T>Q){this.getContentElement().setStyle(H,j);}
else {this.getContentElement().setStyle(H,G);}
;}
;var S=Math.max(T,this.__oD);this._setAreaHeight(S);}
else {this.getContentElement().addListenerOnce(x,function(){this.__oE();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(U){if(this._getAreaHeight()!==U){this.__oC=U;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__oI();}
;}
,_getScrolledAreaHeight:function(){var W=this.__oF();var V=W.getDomElement();if(V){if(!V.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
;if(qx.core.Environment.get(C)===E||(qx.core.Environment.get(C)==B)){W.setWrap(!this.getWrap(),true);}
;W.setWrap(this.getWrap(),true);if(qx.core.Environment.get(C)===E||(qx.core.Environment.get(C)==B)){V.style.overflow=G;}
;if(qx.core.Environment.get(C)==B&&qx.core.Environment.get(s)>=8){V.style.overflow=q;V.style.overflowX=G;}
;W.setValue(this.getValue()||t);if(qx.core.Environment.get(C)==B){V.style.height=j;qx.html.Element.flush();V.style.height=k;}
;this.__oH(W);if(qx.core.Environment.get(C)==B&&qx.core.Environment.get(s)==8){if(!V.scrollTop){qx.html.Element.flush();}
;}
;return V.scrollTop;}
;}
,__oF:function(){this.__oB=this.__oB||this.__oG();return this.__oB;}
,__oG:function(){var ba,Y,bb,X;ba=this.getContentElement();if(!ba.getDomElement()){return null;}
;bb=qx.bom.Element.clone(ba.getDomElement());X=new qx.html.Input(i);X.useElement(bb);Y=X;Y.setStyles({position:K,top:0,left:n,height:0,overflow:G},true);Y.removeAttribute(F);Y.removeAttribute(z);Y.setAttribute(y,f);Y.setValue(ba.getValue()||t);Y.insertBefore(ba);this.__oH(Y);return Y;}
,__oH:function(bc){bc=bc.getDomElement();if(bc){bc.scrollTop=10000;}
;}
,_createInputElement:function(){return new qx.html.Input(i,{overflowX:j,overflowY:j});}
,_applyWrap:function(bf,bd){this.getContentElement().setWrap(bf);if(this._placeholder){var be=bf?A:c;this._placeholder.setStyle(p,be);}
;this.__oE();}
,_applyMinimalLineHeight:function(){qx.ui.core.queue.Layout.add(this);}
,_applyAutoSize:function(bh,bg){if(qx.core.Environment.get(J)){this.__oJ();}
;if(bh){this.__oE();this.addListener(o,this.__oE,this);if(!this.getBounds()){this.addListenerOnce(x,function(){this.getContentElement().setStyle(H,G);}
);}
else {this.getContentElement().setStyle(H,G);}
;}
else {this.removeListener(o,this.__oE);this.getContentElement().setStyle(H,j);}
;}
,_applyDimension:function(bi){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(J)){this.__oJ();}
;if(bi===this.getMaxHeight()){this.__oE();}
;}
,__oI:function(){var content=this.getContentElement();var bk=content.getDomElement();var bj=content.getStyle(u);content.setStyle(u,parseInt(bj,10)+1000+b,true);if(bk){qx.bom.element.Dimension.getWidth(bk);}
;content.setStyle(u,bj,true);}
,__oJ:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(m+I+v);}
;}
,_getContentHint:function(){var bl=qx.ui.form.AbstractField.prototype._getContentHint.call(this);bl.height=bl.height*this.getMinimalLineHeight();bl.width=this._getTextSize().width*20;if(this.isAutoSize()){bl.height=this.__oC||bl.height;}
;return bl;}
},destruct:function(){this.setAutoSize(false);if(this.__oB){this.__oB.dispose();}
;}
});}
)();
