...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Portal","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.113597b3feaf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="300px",b="demobrowser.demo.bom.Portal",c="700px",d="500px",e="box2",f="box6",g="box0",h="200px",i="box4",j="10px",k="GroupBox Left",l="100px",m="groupBoxRight",n="250px",o="120px",p="box1",q="box3",r="350px",s="box7",t="GroupBox Right",u="box5",v="140px",w="groupBoxLeft";qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);boxData={groupBoxes:{"groupBoxLeft":{id:w,name:k,boxes:[g,p,e,q]},"groupBoxRight":{id:m,name:t,boxes:[i,u,f,s]}},boxes:{box0:{id:g,name:g,width:a,height:o,minWidth:j,maxWidth:r,minHeight:j,maxHeight:c,draggable:true,resizable:true,resizeHandles:1},box1:{id:p,name:p,width:a,height:l,minWidth:j,maxWidth:r,minHeight:j,maxHeight:c,draggable:true,resizable:false,resizeHandles:1},box2:{id:e,name:e,width:a,height:l,minWidth:j,maxWidth:r,minHeight:j,maxHeight:c,draggable:false,resizable:false,resizeHandles:0},box3:{id:q,name:q,width:a,height:l,minWidth:j,maxWidth:r,minHeight:j,maxHeight:c,draggable:true,resizable:true,resizeHandles:3},box4:{id:i,name:i,width:a,height:l,minWidth:j,maxWidth:r,minHeight:j,maxHeight:c,draggable:true,resizable:true,resizeHandles:1},box5:{id:u,name:u,width:n,height:h,minWidth:j,maxWidth:d,minHeight:j,maxHeight:c,draggable:true,resizable:true,resizeHandles:2},box6:{id:f,name:f,width:a,height:l,minWidth:j,maxWidth:r,minHeight:j,maxHeight:c,draggable:false,resizable:false,resizeHandles:0},box7:{id:s,name:s,width:a,height:v,minWidth:j,maxWidth:r,minHeight:j,maxHeight:c,draggable:true,resizable:true,resizeHandles:2}}};demobrowser.demo.bom.portal.box.Manager.getInstance().load();demobrowser.demo.bom.portal.dragdrop.Manager.getInstance();}
}});}
)();
(function(){var a="groupBoxes",b="demobrowser.demo.bom.portal.box.Manager",c="boxData",d="qx.event.type.Event",e="boxes",f="demobrowser.demo.bom.portal.box.Box",g="_applyActiveBox",h="loaded",m="singleton";qx.Class.define(b,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__PD=[];this.__PE=[];this.__PF={};}
,statics:{dataKeyRoot:c,dataKeyGroupBoxes:a,dataKeyBoxes:e},events:{"loaded":d},properties:{activeBox:{init:null,check:f,apply:g}},members:{__PD:null,__PE:null,__PF:null,_applyActiveBox:function(o,n){if(n!=null){n.setActive(false);}
;o.setActive(true);}
,load:function(){this.__eP(window[demobrowser.demo.bom.portal.box.Manager.dataKeyRoot]);qx.event.Registration.fireEvent(this,h);}
,__eP:function(t){var s,w,u,v,x,t;var p=t[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var r=t[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in p){s=p[w];u=s.boxes;w=s.id;v={id:w,element:document.getElementById(w)};this.__PE.push(v);this.__PF[w]=[];for(var k=0,l=u.length;k<l;k++ ){t=r[u[k]];var q=document.getElementById(t.id);var x=new demobrowser.demo.bom.portal.box.Box(t,q,null,w);this.__PD.push(x);this.__PF[w].push(x);}
;}
;}
,getBoxes:function(){return this.__PD;}
,getGroupBoxes:function(){return this.__PE;}
,updateGroupBoxMembers:function(A,B,y){var z=qx.dom.Hierarchy.getElementIndex(y.getElement());qx.lang.Array.remove(this.__PF[B],y);qx.lang.Array.insertAt(this.__PF[A],y,z);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__PE.length,D;i<j;i++ ){D=this.__PF[this.__PE[i].id];for(var k=0,l=D.length;k<l;k++ ){if(D[k].getId()===C){return this.__PE[i];}
;}
;}
;return null;}
...
(function(){var a="click",b="Boolean",c="1px solid #444444",d="height",f="position",g="zIndex",h="_applyActive",i="width",j="box_content",k=" It does contain no UI widget code at all.",l="<br/><br/>",m="relative",n="demobrowser.demo.bom.portal.box.Box",o="1px solid orange",p="This is a demo application showing the low-level capabilities.",q="div",r="String",s="border";qx.Class.define(n,{extend:qx.core.Object,construct:function(v,x,t,u){qx.core.Object.call(this);this.__PG=v;this.__co=v.id;if(x!=null){qx.bom.element.Style.set(x,i,v.width);qx.bom.element.Style.set(x,d,v.height);this.__PJ(x,t);}
;this.setElement(x);this.setGroupBoxId(u);this.__PH=null;this.__PI=null;if(v.resizable){this.setResizable(true);var w={minWidth:parseInt(v.minWidth),minHeight:parseInt(v.minHeight),maxWidth:parseInt(v.maxWidth),maxHeight:parseInt(v.maxHeight),handles:v.resizeHandles};this.__PH=new demobrowser.demo.bom.portal.box.Resizable(this,w);}
;if(v.draggable){this.setDraggable(true);this.__PI=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__PK();}
,properties:{element:{init:null},groupBoxId:{init:null,check:r},active:{check:b,init:false,apply:h},resizable:{check:b,init:false},draggable:{check:b,init:false}},members:{__co:null,__PG:null,__PI:null,__PH:null,_applyActive:function(z,y){if(z){qx.bom.element.Style.set(this.getElement(),s,o);}
else {qx.bom.element.Style.set(this.getElement(),s,c);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__PG;}
,getDraggableComponent:function(){return this.__PI;}
,getResizableComponent:function(){return this.__PH;}
,__PJ:function(C,A){if(A){for(var B in A){qx.bom.element.Style.set(B,A[B]);}
;}
;qx.bom.element.Style.set(C,f,m);qx.bom.element.Style.set(C,g,0);qx.bom.Element.addListener(C,a,this.__PL,this,true);}
,__PK:function(){var E=p+k;E=E+l+E+l+E;var D=qx.dom.Element.create(q,{"class":j});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__PL:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__PG=this.__PH=this.__PI=null;}
});}
)();
...
(function(){var a="south",b="mouseup",c="mousedown",d='px',f="width",g="visibility",h="_",i="height",j="mouseover",k="mouseout",l="px",m="east",n="visible",o="hidden",p="mousemove",q="div",r="orientation",s="demobrowser.demo.bom.portal.box.Resizable",t="southeast",u="Handle";qx.Class.define(s,{extend:qx.core.Object,construct:function(v,w){qx.core.Object.call(this);this.__PM=v;this.__gJ=this.__PM.getElement();this.__PN={};this.__PO=false;this.__PP={orientation:null,lastCoord:{left:null,top:null}};this.__PQ={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__PQ){if(w[name]){this.__PQ[name]=w[name];}
;}
;this.__PJ();}
,members:{__PP:null,__PM:null,__gJ:null,__PN:null,__PQ:null,__PO:false,getBox:function(){return this.__PM;}
,__PJ:function(){switch(this.__PQ.handles){case 1:this.__PN.east=null;break;case 2:this.__PN.south=null;break;case 3:this.__PN.south=null;this.__PN.southeast=null;this.__PN.east=null;break;};for(var y in this.__PN){var x=this.__PN[y]=qx.dom.Element.create(q);qx.bom.element.Attribute.set(x,r,y);qx.dom.Element.insertEnd(x,this.__gJ);if(this.__gJ.id){x.id=this.__gJ.id+h+y;}
;this.__PR(y);this.__PS(y);}
;}
,__PR:function(z){qx.bom.element.Class.add(this.__PN[z],z+u);qx.bom.element.Style.set(this.__PN[z],g,this.__PQ.autoHide?o:n);}
,__PS:function(B){var C=qx.event.Registration;var A=this.__PN[B];C.addListener(A,c,this.__PV,this);C.addListener(document,b,this.__PW,this);if(this.__PQ.autoHide){C.addListener(this.__PM.getElement(),j,this.__PT,this);C.addListener(this.__PM.getElement(),k,this.__PU,this);}
;}
,__PT:function(e){for(var D in this.__PN){qx.bom.element.Style.set(this.__PN[D],g,n);}
;}
,__PU:function(e){if(!this.__PO){for(var E in this.__PN){qx.bom.element.Style.set(this.__PN[E],g,o);}
;}
;}
,__PV:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,p,this.__PX,this,true);this.__PO=true;var F=e.getTarget();this.__PP.orientation=qx.bom.element.Attribute.get(F,r);this.__PP.lastCoord.left=e.getDocumentLeft();this.__PP.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__gJ);}
;}
,__PW:function(e){e.stopPropagation();if(this.__PO){qx.event.Registration.removeListener(document,p,this.__PX,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__gJ);if(this.__PQ.autoHide){for(var G in this.__PN){qx.bom.element.Style.set(this.__PN[G],g,o);}
;}
;this.__PO=false;qx.bom.Selection.clear(document.body);}
;}
,__PX:function(e){e.stopPropagation();if(this.__PO){var H={left:null,top:null};switch(this.__PP.orientation){case a:H.top=e.getDocumentTop();break;case t:H.top=e.getDocumentTop();H.left=e.getDocumentLeft();break;case m:H.left=e.getDocumentLeft();break;};this.__PY(H,this.__PP.lastCoord);this.__PP.lastCoord.left=e.getDocumentLeft();this.__PP.lastCoord.top=e.getDocumentTop();}
;}
,__PY:function(K,L){var Q=qx.bom.element.Dimension;var N=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__PM.getId());var P=Q.getContentSize(N.element);if(K.left){var M=K.left-L.left;if(M!==0){var J=Q.getContentWidth(this.__gJ)+M;var O=Q.getWidth(this.__gJ)+M;if((this.__PQ.minWidth==null||J>this.__PQ.minWidth)&&(this.__PQ.maxWidth==null||J<=this.__PQ.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__gJ,f,J+d);this.__PM.getData().width=J;}
;}
;}
;}
;if(K.top){var M=K.top-L.top;if(M!==0){var I=Q.getContentHeight(this.__gJ)+M;if((this.__PQ.minHeight==null||I>this.__PQ.minHeight)&&(this.__PQ.maxHeight==null||I<=this.__PQ.maxHeight)){qx.bom.element.Style.set(this.__gJ,i,I+l);}
;}
;}
;}
},destruct:function(){if(this.__PQ.autoHide){qx.event.Registration.removeListener(this.__PM.getElement(),j,this.__PT,this);qx.event.Registration.removeListener(this.__PM.getElement(),k,this.__PU,this);}
;this.__PM=this.__PQ=this.__gJ=this.__PN=null;this.__PP=null;}
});}
)();
...
(function(){var a="zIndex",b="auto",c="demobrowser.demo.bom.portal.box.Util";qx.Class.define(c,{statics:{__Qa:1000,bringToFront:function(e){var d=qx.bom.element.Style.get(e,a);d=d==b?0:d;qx.bom.element.Style.set(e,a,d+this.__Qa);}
,sendToBack:function(g){var f=qx.bom.element.Style.get(g,a);qx.bom.element.Style.set(g,a,f-this.__Qa);}
}});}
)();
...
(function(){var a="mousemove",b="engine.name",c="mouseup",d="mousedown",f="dragstart",g="mouseover",h="drag",i="dragend",j="div",k="move",l="dragHandle",m="demobrowser.demo.bom.portal.box.Draggable",n="cursor",o="html";qx.Class.define(m,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.__PM=p;this.__gJ=p.getElement();this.__Qb=null;this.__Qc=null;this.__PJ();}
,members:{__PM:null,__gJ:null,__Qb:null,__Qc:null,getBox:function(){return this.__PM;}
,getElement:function(){return this.__gJ;}
,__PJ:function(){this.__Qd();this.__PS();}
,__Qd:function(){this.__Qb=qx.dom.Element.create(j);qx.bom.element.Class.add(this.__Qb,l);qx.dom.Element.insertBegin(this.__Qb,this.__gJ);}
,__PS:function(){qx.bom.Element.addListener(this.__Qb,d,this.__ll,this);qx.bom.Element.addListener(this.__Qb,g,function(e){qx.bom.element.Style.set(this,n,k);}
,this.__Qb);qx.bom.Element.addListener(this.__Qb,f,this.__MG,this);qx.bom.Element.addListener(this.__Qb,i,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__Qb,h,this.__Qg,this);}
,__ll:function(e){if(e.isLeftPressed()){this.__Qc={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__gJ),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__gJ)};qx.bom.Element.addListener(document.body,c,this.__Qf,this,true);this.__Qe();qx.event.Registration.fireEvent(this.__Qb,f,qx.event.type.Event);}
;}
,__Qe:qx.core.Environment.select(b,{"mshtml":function(){var r=this;var q=qx.lang.Function.bind(this.__Qf,r);document.getElementsByTagName(o)[0].onmouseleave=q;}
,"default":(function(){}
)}),__Qf:function(e){try{e.stopPropagation();}
catch(s){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,a,this.__Qg,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,c,this.__Qf,this,true);}
,__MG:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__PM);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__PM);qx.event.Registration.addListener(document.body,a,this.__Qg,this,true);}
,__Qg:function(e){e.stopPropagation();var t=e.getDocumentLeft()-this.__Qc.left;var top=e.getDocumentTop()-this.__Qc.top;qx.event.Timer.once(function(){this.checkGroupBox(t,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,t);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__PM=this.__Qb=this.__gJ=this.__Qc=null;}
});}
)();
(function(){var a="width:",b="top",c="Boolean",d="px",f="border",g="left",h="demobrowser.demo.bom.portal.dragdrop.Manager",k="height:",l="paddingTop",m="opacity:0.5;margin:0;position:absolute;",n="end",o="left:",p="div",q="demobrowser.demo.bom.portal.box.Box",r="px;",s="paddingBottom",t="1px dashed red",u="ease-out",v="singleton",w="top:";qx.Class.define(h,{type:v,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Qh={top:null,height:null};this.__Qi={top:0,left:0};}
,properties:{activeBox:{check:q,init:null,nullable:true},sessionActive:{check:c,init:false}},members:{__Qh:null,__Qj:null,__Qk:false,__Qi:null,__Ql:null,__Qm:null,startSession:function(y){this.setSessionActive(true);this.setActiveBox(y);this.__Qj=y.getGroupBoxId();this.__Qn();if(this.__Ql==null){this.__Ql={};var x=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=x.length;i<j;i++ ){this.__Ql[x[i].element.id]={left:qx.bom.element.Location.getLeft(x[i].element),right:qx.bom.element.Location.getLeft(x[i].element)+qx.bom.element.Dimension.getWidth(x[i].element)};}
;}
;}
,__Qn:function(){if(!this.__Qm){this.__Qm=qx.dom.Element.create(p);}
;var B=this.getActiveBox().getElement();var z=qx.bom.element.Dimension.getContentSize(B);this.__Qo(B,this.__Qm);qx.bom.element.Class.add(this.__Qm,qx.bom.element.Class.get(B));var A=m+w+qx.bom.element.Location.getTop(B)+r+o+qx.bom.element.Location.getLeft(B)+r+a+z.width+r+k+z.height+d;qx.bom.element.Style.setCss(this.__Qm,A);qx.bom.element.Style.set(B,f,t);qx.dom.Node.getBodyElement(B).appendChild(this.__Qm);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__Qm);}
,__Qo:function(C,D){while(C.firstChild){D.appendChild(C.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var I=this.getActiveBox();var G=I.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(I.getGroupBoxId(),this.__Qj,I);I.setGroupBoxId(this.__Qj);var F={left:qx.bom.element.Location.getLeft(this.__Qm)+d,top:qx.bom.element.Location.getTop(this.__Qm)+d};var H={left:qx.bom.element.Location.getLeft(G)+d,top:qx.bom.element.Location.getTop(G)+d};var J={timing:u,duration:300,keep:100,keyFrames:{'0':F,'100':H}};var E=qx.bom.element.Animation.animate(this.__Qm,J);E.addListener(n,function(){this.__Qo(this.__Qm,G);qx.bom.element.Style.reset(G,f);this.__Qm.parentNode.removeChild(this.__Qm);if(I.isActive()){I._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(I);}
;}
,this);}
,onDragMove:function(top,M){if(this.__Qi.left!=M){qx.bom.element.Style.set(this.__Qm,g,M+d);}
;if(this.__Qi.top!=top){qx.bom.element.Style.set(this.__Qm,b,top+d);}
;var K=this.getActiveBox().getElement();if(this.__Qh.top==null){this.__Qh.top=qx.bom.element.Location.getTop(K);}
;if(this.__Qh.height==null){this.__Qh.height=qx.bom.element.Dimension.getHeight(K);}
;if(this.__Qk==false&&top>=this.__Qh.top&&top<=(this.__Qh.top+this.__Qh.height)){return;}
;var L;if(this.__Qk){L=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__Qj));while(L!=null){if(this.__Qp(true,top,K,L)){this.__Qk=false;return;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {L=K;}
;if(top-this.__Qi.top>0){L=qx.dom.Hierarchy.getNextElementSibling(L);while(L!=null){if(L){if(this.__Qp(true,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {var L=qx.dom.Hierarchy.getPreviousElementSibling(L);while(L!=null){if(L){if(this.__Qp(false,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getPreviousElementSibling(L);}
;}
;this.__Qi.left=M;this.__Qi.top=top;}
,__Qp:function(P,top,S,Q){var O=qx.bom.element.Location.getTop(Q);var T=parseInt(qx.bom.element.Style.get(Q,l));var N=parseInt(qx.bom.element.Style.get(Q,s));var U=qx.bom.element.Dimension.getContentHeight(Q)+N+T;var R;if(P){if(top>=(O+(U/3))){R=qx.dom.Hierarchy.getNextElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertAfter(S,Q);this.__Qh.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
else {if(top<=(O+U*2/3)){R=qx.dom.Hierarchy.getPreviousElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertBefore(S,Q);this.__Qh.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
;return false;}
,checkGroupBox:function(X,W){if(this.__Ql[this.__Qj].left<=X&&this.__Ql[this.__Qj].right>=X){return;}
;for(var V in this.__Ql){if(V!=this.__Qj){if(this.__Ql[V].left<=X+W&&this.__Ql[V].right>=X){this.__Qj=V;this.__Qk=true;return;}
;}
;}
;}
},destruct:function(){this.__Qh=this.__Qi=this.__Qj=null;this.__Qq=this.__Qm=this.__Ql=null;}
});}
)();
