...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.54a584231d1c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="network-server.png",h="row",i="mouseover",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__mJ=[];}
,members:{_pool:null,__mJ:null,getCellData:function(t,s){if(!this.__mJ[t]){this.__mJ[t]=[];}
;if(!this.__mJ[t][s]){this.__mJ[t][s]={label:this.__RC(),icon:this.__RD()};}
;return this.__mJ[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(i,function(){var x=this.__RD();v.setIcon(x);this.__mJ[w][u].icon=x;}
,this);}
...
;}
,__RC:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__RD:function(){var z=a;var B=e;var A=[d,k,g,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
