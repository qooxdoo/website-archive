...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.26f24ccb6e23.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=b+e.getRow()+i+e.getColumn()+h;this.__RA(q);}
,_onContextMenu:function(e){var r=f+e.getRow()+i+e.getColumn()+h;this.__RA(r);}
,_onDblclickPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__RA(s);}
,__RA:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
