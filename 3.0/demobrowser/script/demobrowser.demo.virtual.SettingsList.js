...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.SettingsList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SettingsList.91ee6d354fb1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return function(event){if(qx.core.Environment.get(b)){if(qx.core&&qx.core.Object&&q.self&&qx.Bootstrap.isObject(q.self)&&q.self.isDisposed&&qx.Bootstrap.isFunction(q.self.isDisposed)){qx.core.Assert&&qx.core.Assert.assertFalse(q.self.isDisposed(),d+q.self.toString()+g+qx.lang.Function.getName(r));}
;}
...
(function(){var a="mshtml",b="engine.name",c="_applyTheme",d="",e="'.",f="qx-",g="__di",h="Unable to resolve decorator '",j="singleton",k=";",l="qx.theme.manager.Decoration",m=".",n="Theme",o="object",p="changeTheme",q="string",r="browser.documentmode",s=":";qx.Class.define(l,{type:j,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__dh=[];this.__bbh=(qx.core.Environment.get(b)==a&&qx.core.Environment.get(r)<9);}
,properties:{theme:{check:n,nullable:true,apply:c,event:p}},members:{__di:null,__dh:null,__bbh:false,getCssClassName:function(t){if(qx.lang.Type.isString(t)){return f+t;}
...
;var D=this.__bbh?z:z+(B?s:d);this.__dh.push(D+C);v.addRule(D+C,w);continue;}
;F+=C+s+u[C]+k;}
...
;var H=this.__di;if(!H){H=this.__di={};}
...
,isCached:function(R){return !this.__di?false:qx.lang.Object.contains(this.__di,R);}
...
;}
;this._disposeMap(g);this.__di={};}
},destruct:function(){this._disposeMap(g);}
});}
)();
(function(){var a="qx.ui.style.Stylesheet",b="singleton";qx.Class.define(a,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__dj=qx.bom.Stylesheet.createElement();this.__dh=[];}
,members:{__dh:null,__dj:null,addRule:function(d,c){if(this.hasRule(d)){return;}
;qx.bom.Stylesheet.addRule(this.__dj,d,c);this.__dh.push(d);}
,hasRule:function(e){return this.__dh.indexOf(e)!=-1;}
,removeRule:function(f){delete this.__dh[this.__dh.indexOf(f)];qx.bom.Stylesheet.removeRule(this.__dj,f);}
},destruct:function(){qx.bom.Stylesheet.removeSheet(this.__dj);}
});}
)();
...
,__dl:{},__dm:{},_allowCreationWithMarkup:function(Q){if(!Q){Q=window;}
;var R=Q.location.href;if(qx.dom.Element.__dm[R]==undefined){try{Q.document.createElement(g);qx.dom.Element.__dm[R]=true;}
catch(e){qx.dom.Element.__dm[R]=false;}
;}
;return qx.dom.Element.__dm[R];}
,getHelperElement:function(S){if(!S){S=window;}
;var T=S.location.href;if(!qx.dom.Element.__dl[T]){var U=qx.dom.Element.__dl[T]=S.document.createElement(n);if(qx.core.Environment.get(a)==j){U.style.display=f;S.document.body.appendChild(U);}
;}
;return qx.dom.Element.__dl[T];}
,create:function(name,bc,W){if(!W){W=window;}
;if(!name){throw new Error(k);}
;var Y=this.__dk;var X=d;for(var bb in bc){if(Y[bb]){X+=bb+b+bc[bb]+p;}
;}
...
;var I=this.__dn;name=I.names[name]||name;if(I.bools[name]){J=!!J;}
...
,toParameter:function(O,S){var R,Q=[];for(R in O){if(O.hasOwnProperty(R)){var P=O[R];if(P instanceof Array){for(var i=0;i<P.length;i++ ){this.__do(R,P[i],Q,S);}
;}
else {this.__do(R,P,Q,S);}
;}
;}
;return Q.join(y);}
,__do:function(W,X,V,U){var T=window.encodeURIComponent;if(U){V.push(T(W).replace(/%20/g,b)+E+T(X).replace(/%20/g,b));}
else {V.push(T(W)+E+T(X));}
;}
,getAbsolute:function(ba){var Y=document.createElement(e);Y.innerHTML=B+ba+x;return Y.firstChild.href;}
}});}
)();
(function(){var a="qx.bom.client.Stylesheet",b="html.stylesheet.deleterule",c="html.stylesheet.insertrule",d="function",e="html.stylesheet.createstylesheet",f="html.stylesheet.addimport",g="html.stylesheet.removeimport",h="object";qx.Bootstrap.define(a,{statics:{__dp:function(){if(!qx.bom.client.Stylesheet.__dq){qx.bom.client.Stylesheet.__dq=qx.bom.Stylesheet.createElement();}
;return qx.bom.client.Stylesheet.__dq;}
,getCreateStyleSheet:function(){return typeof document.createStyleSheet===h;}
,getInsertRule:function(){return typeof qx.bom.client.Stylesheet.__dp().insertRule===d;}
,getDeleteRule:function(){return typeof qx.bom.client.Stylesheet.__dp().deleteRule===d;}
,getAddImport:function(){return (typeof qx.bom.client.Stylesheet.__dp().addImport===h);}
,getRemoveImport:function(){return (typeof qx.bom.client.Stylesheet.__dp().removeImport===h);}
...
,getInsets:function(){if(this.__dr){return this.__dr;}
...
;var bc=this.getInnerOpacity();if(bc<1){this.__eh(bd,bc);}
...
;}
;}
,__eh:function(bh,be){if(!qx.core.Environment.get(F)){if(qx.core.Environment.get(m)){qx.log.Logger.warn(A);}
;return;}
...
,getLinearGradient:function(){qx.bom.client.Css.__dL=false;var cb=N;var bX=document.createElement(n);var bY=qx.bom.Style.getAppliedStyle(bX,G,cb);if(!bY){cb=by;var bY=qx.bom.Style.getAppliedStyle(bX,G,cb,false);if(bY){qx.bom.client.Css.__dL=true;}
;}
;if(!bY){return null;}
;var ca=/(.*?)\(/.exec(bY);return ca?ca[1]:null;}
,getFilterGradient:function(){return qx.bom.client.Css.__dM(bC,bR);}
...
,getLegacyWebkitGradient:function(){if(qx.bom.client.Css.__dL===null){qx.bom.client.Css.getLinearGradient();}
;return qx.bom.client.Css.__dL;}
...
,getFilterTextShadow:function(){return qx.bom.client.Css.__dM(I,T);}
,__dM:function(cn,cl){var cm=false;var co=bF+cn+W+cl+bB;var ck=document.createElement(n);document.body.appendChild(ck);ck.style.filter=co;if(ck.filters&&ck.filters.length>0&&ck.filters.item(cn).enabled==true){cm=true;}
...
else if(qx.core.Environment.get(S)&&!qx.core.Environment.get(O)&&qx.core.Environment.get(e)){if(!this.__ek){this.__ek=document.createElement(M);}
;var bq=this.getOrientation()==G;var bw=this.__el();var bt=bq?200:1;var bv=bq?1:200;this.__ek.width=bv;this.__ek.height=bt;var br=this.__ek.getContext(X);if(bq){var bC=br.createLinearGradient(0,0,0,bt);}
else {var bC=br.createLinearGradient(0,0,bv,0);}
;bC.addColorStop(this.getStartColorPosition()/100,bw.start);bC.addColorStop(this.getEndColorPosition()/100,bw.end);br.fillStyle=bC;br.fillRect(0,0,bv,bt);var bs=v+this.__ek.toDataURL()+g;bm[h]=bs;bm[l]=B;}
else if(qx.core.Environment.get(S)&&!qx.core.Environment.get(O)){var bw=this.__el();var bB=this.getOrientation()==T?1:0;var bA=bw.start;var bu=bw.end;if(!qx.util.ColorUtil.isHex6String(bA)){bA=qx.util.ColorUtil.stringToRgb(bA);bA=qx.util.ColorUtil.rgbToHexString(bA);}
...
;}
;}
,__el:function(){if(qx.core.Environment.get(A)){var bF=qx.theme.manager.Color.getInstance();var bH=bF.resolve(this.getStartColor());var bG=bF.resolve(this.getEndColor());}
else {var bH=this.getStartColor();var bG=this.getEndColor();}
;return {start:bH,end:bG};}
,_getContent:function(){if(qx.core.Environment.get(S)&&!qx.core.Environment.get(O)){var bK=this.__el();var bN=this.getOrientation()==T?1:0;var bM=qx.util.ColorUtil.hex3StringToHex6String(bK.start);var bJ=qx.util.ColorUtil.hex3StringToHex6String(bK.end);bM=bM.substring(1,bM.length);bJ=bJ.substring(1,bJ.length);var bL=H;if(this.classname.indexOf(D)!=-1){var bI={};this._styleBoxShadow(bI);bL=j+qx.bom.element.Style.compile(bI)+n;}
...
;if(qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(p))){if(!this.__dJ(p)){return i;}
;}
;return b;}
...
(function(){var a="cursor:",b="engine.name",c="ns-resize",d="",e="mshtml",f="nw-resize",g="n-resize",h="engine.version",i="nesw-resize",j="opera",k="browser.documentmode",l=";",m="nwse-resize",n="ew-resize",o="qx.bom.element.Cursor",p="ne-resize",q="e-resize",r="browser.quirksmode",s="cursor";qx.Bootstrap.define(o,{statics:{__dK:{},compile:function(t){return a+(this.__dK[t]||t)+l;}
,get:function(v,u){return qx.bom.element.Style.get(v,s,u,false);}
,set:function(x,w){x.style.cursor=this.__dK[w]||w;}
,reset:function(y){y.style.cursor=d;}
},defer:function(z){if(qx.core.Environment.get(b)==e&&((parseFloat(qx.core.Environment.get(h))<9||qx.core.Environment.get(k)<9)&&!qx.core.Environment.get(r))){z.__dK[i]=p;z.__dK[m]=f;if(((parseFloat(qx.core.Environment.get(h))<8||qx.core.Environment.get(k)<8)&&!qx.core.Environment.get(r))){z.__dK[n]=q;z.__dK[c]=g;}
;}
else if(qx.core.Environment.get(b)==j&&parseInt(qx.core.Environment.get(h))<12){z.__dK[i]=p;z.__dK[m]=f;}
;}
});}
)();
...
(function(){var a="css.float",b="px",c="Cascaded styles are not supported in this browser!",d="css.appearance",e="pixelRight",f="float",g="css.userselect",h="css.boxsizing",i="css.textoverflow",j="qx.debug",k="pixelHeight",l=":",m="pixelTop",n="browser.documentmode",o="css.borderimage",p="Invalid argument 'name'",q="pixelLeft",r="engine.name",s="css.usermodify",t="mshtml",u="qx.bom.element.Style",v="Invalid argument 'smart'",w="",x="pixelBottom",y="Invalid argument 'styles'",z="pixelWidth",A=";",B="Invalid argument 'element'",C="style";qx.Bootstrap.define(u,{statics:{__dN:null,__dO:null,__dP:function(){var E={"appearance":qx.core.Environment.get(d),"userSelect":qx.core.Environment.get(g),"textOverflow":qx.core.Environment.get(i),"borderImage":qx.core.Environment.get(o),"float":qx.core.Environment.get(a),"userModify":qx.core.Environment.get(s),"boxSizing":qx.core.Environment.get(h)};this.__dO={};for(var D in qx.lang.Object.clone(E)){if(!E[D]){delete E[D];}
else {this.__dO[D]=D==f?f:qx.bom.Style.getCssName(E[D]);}
;}
;this.__dN=E;}
,__dQ:function(name){var F=qx.bom.Style.getPropertyName(name);if(F){this.__dN[name]=F;}
;return F;}
,__dR:{width:z,height:k,left:q,right:e,top:m,bottom:x},__dS:{clip:qx.bom.element.Clip,cursor:qx.bom.element.Cursor,opacity:qx.bom.element.Opacity,boxSizing:qx.bom.element.BoxSizing},compile:function(G){var J=[];var K=this.__dS;var I=this.__dO;var name,H;for(name in G){H=G[name];if(H==null){continue;}
;name=this.__dN[name]||this.__dQ(name)||name;if(K[name]){J.push(K[name].compile(H));}
...
;}
,isPropertySupported:function(O){return (this.__dS[O]||this.__dN[O]||O in document.documentElement.style);}
...
;}
;name=this.__dN[name]||this.__dQ(name)||name;if(P!==false&&this.__dS[name]){this.__dS[name].set(R,Q);}
...
;}
;var V=this.__dN;var ba=this.__dS;var T=Y.style;for(var X in S){var U=S[X];var name=V[X]||this.__dQ(X)||X;if(U===undefined){if(W!==false&&ba[name]){ba[name].reset(Y);}
else {T[name]=w;}
;}
...
;}
;}
,reset:function(bc,name,bb){name=this.__dN[name]||this.__dQ(name)||name;if(bb!==false&&this.__dS[name]){this.__dS[name].reset(bc);}
else {bc.style[name]=w;}
;}
,get:qx.core.Environment.select(r,{"mshtml":function(bf,name,bg,bj){name=this.__dN[name]||this.__dQ(name)||name;if(bj!==false&&this.__dS[name]){return this.__dS[name].get(bf,bg);}
...
;var bi=this.__dR[name];if(bi){var be=bf.style[name];bf.style[name]=bh||0;var bd=bf.style[bi]+b;bf.style[name]=be;return bd;}
;return bh;};}
,"default":function(bm,name,bn,bo){name=this.__dN[name]||this.__dQ(name)||name;if(bo!==false&&this.__dS[name]){return this.__dS[name].get(bm,bn);}
...
,__dT:function(k){var m=this.getWidth(k)>this.getHeight(k)?90:0;var l=k.orientation;if(l==null||Math.abs(l%180)==m){return {"-270":90,"-180":180,"-90":-90,"0":0,"90":90,"180":180,"270":-90};}
else {return {"-270":180,"-180":-90,"-90":0,"0":90,"90":180,"180":-90,"270":0};}
;}
,__dU:null,getOrientation:function(n){var n=n||window.top;var o=n.orientation;if(o==null){o=this.getWidth(n)>this.getHeight(n)?90:0;}
else {if(this.__dU==null){this.__dU=this.__dT(n);}
;o=this.__dU[o];}
;return o;}
...
(function(){var a="qx.ui.decoration.Decorator",b="_style",c="_getDefaultInsetsFor",d="bottom",e="top",f="left",g="right";qx.Class.define(a,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],include:[qx.ui.decoration.MBackgroundColor,qx.ui.decoration.MBorderRadius,qx.ui.decoration.MBoxShadow,qx.ui.decoration.MDoubleBorder,qx.ui.decoration.MLinearBackgroundGradient,qx.ui.decoration.MBorderImage],members:{__em:false,getPadding:function(){var k=this.getInset();var h=this._getDefaultInsetsForBorderImage();var n=k.top-(h.top?h.top:this.getWidthTop());var m=k.right-(h.right?h.right:this.getWidthRight());var j=k.bottom-(h.bottom?h.bottom:this.getWidthBottom());var l=k.left-(h.left?h.left:this.getWidthLeft());return {top:k.top?n:this.getInnerWidthTop(),right:k.right?m:this.getInnerWidthRight(),bottom:k.bottom?j:this.getInnerWidthBottom(),left:k.left?l:this.getInnerWidthLeft()};}
...
,_isInitialized:function(){return this.__em;}
}});}
)();
...
;var j=this.getTheme();if(j!==null&&j.fonts[l]){var m=this.__eo(j.fonts[l]);return k[l]=(new m).set(j.fonts[l]);}
;return l;}
,isDynamic:function(q){var p=this._dynamic;if(q&&(q instanceof qx.bom.Font||p[q]!==undefined)){return true;}
;var o=this.getTheme();if(o!==null&&q&&o.fonts[q]){var n=this.__eo(o.fonts[q]);p[q]=(new n).set(o.fonts[q]);return true;}
;return false;}
,__en:function(s,r){if(s[r].include){var t=s[s[r].include];s[r].include=null;delete s[r].include;s[r]=qx.lang.Object.mergeWith(s[r],t,false);this.__en(s,r);}
;}
,_applyTheme:function(y){var u=this._dynamic;for(var x in u){if(u[x].themed){u[x].dispose();delete u[x];}
;}
;if(y){var v=y.fonts;for(var x in v){if(v[x].include&&v[v[x].include]){this.__en(v,x);}
;var w=this.__eo(v[x]);u[x]=(new w).set(v[x]);u[x].themed=true;}
;}
;this._setDynamic(u);}
,__eo:function(z){if(z.sources){return qx.bom.webfonts.WebFont;}
;return qx.bom.Font;}
},destruct:function(){this._disposeMap(c);}
});}
)();
(function(){var a="Boolean",b="px",c="_applyItalic",d="_applyBold",e="underline",f="_applyTextShadow",g="Integer",h="_applyFamily",j="_applyLineHeight",k='"',m="Array",n="line-through",o="overline",p="Color",q="String",r="",s="italic",t="normal",u="qx.bom.Font",v="bold",w="Number",x="_applyDecoration",y=" ",z="_applySize",A=",",B="_applyColor";qx.Class.define(u,{extend:qx.core.Object,construct:function(D,C){qx.core.Object.call(this);this.__ep={fontFamily:r,fontSize:null,fontWeight:null,fontStyle:null,textDecoration:null,lineHeight:null,color:null,textShadow:null};if(D!==undefined){this.setSize(D);}
...
,__eq:{fontFamily:r,fontSize:r,fontWeight:r,fontStyle:r,textDecoration:r,lineHeight:1.2,color:r,textShadow:r},getDefaultStyles:function(){return this.__eq;}
},properties:{size:{check:g,nullable:true,apply:z},lineHeight:{check:w,nullable:true,apply:j},family:{check:m,nullable:true,apply:h},bold:{check:a,nullable:true,apply:d},italic:{check:a,nullable:true,apply:c},decoration:{check:[e,n,o],nullable:true,apply:x},color:{check:p,nullable:true,apply:B},textShadow:{nullable:true,check:q,apply:f}},members:{__ep:null,_applySize:function(M,L){this.__ep.fontSize=M===null?null:M+b;}
,_applyLineHeight:function(O,N){this.__ep.lineHeight=O===null?null:O;}
,_applyFamily:function(P,Q){var R=r;for(var i=0,l=P.length;i<l;i++ ){if(P[i].indexOf(y)>0){R+=k+P[i]+k;}
else {R+=P[i];}
;if(i!==l-1){R+=A;}
;}
;this.__ep.fontFamily=R;}
,_applyBold:function(T,S){this.__ep.fontWeight=T==null?null:T?v:t;}
,_applyItalic:function(V,U){this.__ep.fontStyle=V==null?null:V?s:t;}
,_applyDecoration:function(X,W){this.__ep.textDecoration=X==null?null:X;}
,_applyColor:function(ba,Y){this.__ep.color=null;if(ba){this.__ep.color=qx.theme.manager.Color.getInstance().resolve(ba);}
;}
,_applyTextShadow:function(bc,bb){this.__ep.textShadow=bc==null?null:bc;}
,getStyles:function(){return this.__ep;}
}});}
)();
(function(){var a="qx.bom.webfonts.WebFont",b="",c="qx.debug",d="changeStatus",e="_applySources",f="qx.event.type.Data",g=" was not applied, perhaps the source file could not be loaded.",h="WebFont ";qx.Class.define(a,{extend:qx.bom.Font,events:{"changeStatus":f},properties:{sources:{nullable:true,apply:e}},members:{__er:null,_applySources:function(m,o){var j=[];for(var i=0,l=m.length;i<l;i++ ){var k=this._quoteFontFamily(m[i].family);j.push(k);var n=m[i].source;qx.bom.webfonts.Manager.getInstance().require(k,n,this._onWebFontChangeStatus,this);}
...
(function(){var a="m",b="os.name",c=")",d="os.version",e="qx.bom.webfonts.Manager",f="svg",g="chrome",h="browser.name",k="singleton",n=",\n",o="src: ",p="mobileSafari",q="'eot)",r="');",s="qx.debug",t="interval",u="#",v="firefox",w="!",y="eot",z="ios",A="changeStatus",B="\.(",C="}\n",D="font-family: ",E="browser.documentmode",F="mobile safari",G="safari",H="@font-face.*?",I="",J="ttf",K=";\n",L="') format('svg')",M="') format('woff')",N="('embedded-opentype')",O="browser.version",P="opera",Q="engine.version",R="Couldn't create @font-face rule for WebFont ",S="mshtml",T="engine.name",U="url('",V="src: url('",W="('embedded-opentype)",X="\nfont-style: normal;\nfont-weight: normal;",Y="?#iefix') format('embedded-opentype')",bl="woff",bm="ie",bn=";",bh="'eot')",bi="Error while adding @font-face rule:",bj="@font-face {",bk="') format('truetype')";qx.Class.define(e,{extend:qx.core.Object,type:k,construct:function(){qx.core.Object.call(this);this.__es=[];this.__et={};this.__eu=[];this.__ev=this.getPreferredFormats();}
,statics:{FONT_FORMATS:[y,bl,J,f],VALIDATION_TIMEOUT:5000},members:{__es:null,__ew:null,__et:null,__ev:null,__eu:null,__ex:null,require:function(bq,br,bs,bu){var bp=[];for(var i=0,l=br.length;i<l;i++ ){var bt=br[i].split(u);var bo=qx.util.ResourceManager.getInstance().toUri(bt[0]);if(bt.length>1){bo=bo+u+bt[1];}
;bp.push(bo);}
;if(qx.core.Environment.get(T)==S&&(parseInt(qx.core.Environment.get(Q))<9)||qx.core.Environment.get(E)<9){if(!this.__ex){this.__ex=new qx.event.Timer(100);this.__ex.addListener(t,this.__ez,this);}
;if(!this.__ex.isEnabled()){this.__ex.start();}
;this.__eu.push([bq,bp,bs,bu]);}
else {this.__ey(bq,bp,bs,bu);}
;}
,remove:function(bw){var bv=null;for(var i=0,l=this.__es.length;i<l;i++ ){if(this.__es[i]==bw){bv=i;this.__eF(bw);break;}
;}
;if(bv){qx.lang.Array.removeAt(this.__es,bv);}
;if(bw in this.__et){this.__et[bw].dispose();delete this.__et[bw];}
;}
...
;return bx;}
,removeStyleSheet:function(){this.__es=[];if(this.__ew){qx.bom.Stylesheet.removeSheet(this.__ew);}
;this.__ew=null;}
,__ey:function(bE,bG,bD,bH){if(!qx.lang.Array.contains(this.__es,bE)){var bI=this.__eB(bG);var bF=this.__eC(bE,bI);if(!bF){throw new Error(R+bE+w);}
;if(!this.__ew){this.__ew=qx.bom.Stylesheet.createElement();}
;try{this.__eE(bF);}
catch(bJ){if(qx.core.Environment.get(s)){this.warn(bi,bJ.message);return;}
;}
;this.__es.push(bE);}
;if(!this.__et[bE]){this.__et[bE]=new qx.bom.webfonts.Validator(bE);this.__et[bE].setTimeout(qx.bom.webfonts.Manager.VALIDATION_TIMEOUT);this.__et[bE].addListenerOnce(A,this.__eA,this);}
;if(bD){var bC=bH||window;this.__et[bE].addListenerOnce(A,bD,bC);}
;this.__et[bE].validate();}
,__ez:function(){if(this.__eu.length==0){this.__ex.stop();return;}
;var bK=this.__eu.shift();this.__ey.apply(this,bK);}
,__eA:function(bL){var bM=bL.getData();if(bM.valid===false){qx.event.Timer.once(function(){this.remove(bM.family);}
,this,250);}
;}
,__eB:function(bN){var bP=qx.bom.webfonts.Manager.FONT_FORMATS;var bO={};for(var i=0,l=bN.length;i<l;i++ ){var bQ=null;for(var x=0;x<bP.length;x++ ){var bR=new RegExp(B+bP[x]+c);var bS=bR.exec(bN[i]);if(bS){bQ=bS[1];}
;}
;if(bQ){bO[bQ]=bN[i];}
;}
;return bO;}
,__eC:function(bV,bY){var bX=[];var bT=this.__ev.length>0?this.__ev:qx.bom.webfonts.Manager.FONT_FORMATS;for(var i=0,l=bT.length;i<l;i++ ){var bU=bT[i];if(bY[bU]){bX.push(this.__eD(bU,bY[bU]));}
;}
;var bW=o+bX.join(n)+bn;bW=D+bV+K+bW;bW=bW+X;return bW;}
,__eD:function(cb,ca){switch(cb){case y:return U+ca+r+V+ca+Y;case bl:return U+ca+M;case J:return U+ca+bk;case f:return U+ca+L;default:return null;};}
,__eE:function(cd){var cc=bj+cd+C;if(qx.core.Environment.get(h)==bm&&qx.core.Environment.get(E)<9){var ce=this.__eG(this.__ew.cssText);ce+=cc;this.__ew.cssText=ce;}
else {this.__ew.insertRule(cc,this.__ew.cssRules.length);}
;}
,__eF:function(cf){var ci=new RegExp(H+cf,a);for(var i=0,l=document.styleSheets.length;i<l;i++ ){var cg=document.styleSheets[i];if(cg.cssText){var ch=cg.cssText.replace(/\n/g,I).replace(/\r/g,I);ch=this.__eG(ch);if(ci.exec(ch)){ch=ch.replace(ci,I);}
;cg.cssText=ch;}
else if(cg.cssRules){for(var j=0,m=cg.cssRules.length;j<m;j++ ){var ch=cg.cssRules[j].cssText.replace(/\n/g,I).replace(/\r/g,I);if(ci.exec(ch)){this.__ew.deleteRule(j);return;}
;}
;}
;}
;}
,__eG:function(cj){return cj.replace(q,bh).replace(W,N);}
},destruct:function(){delete this.__es;this.removeStyleSheet();for(var ck in this.__et){this.__et[ck].dispose();}
...
(function(){var a="sans-serif",b="changeStatus",c="Integer",d="auto",e="qx.event.type.Data",f="0",g="qx.bom.webfonts.Validator",h="interval",i="Georgia",j="WEei",k="Times New Roman",l="__eN",m="Arial",n="normal",o="Helvetica",p="350px",q="_applyFontFamily",r="-1000px",s="hidden",t="serif",u="span",v="absolute",w=",";qx.Class.define(g,{extend:qx.core.Object,construct:function(x){qx.core.Object.call(this);if(x){this.setFontFamily(x);}
;this.__eK=this._getRequestedHelpers();}
,statics:{COMPARISON_FONTS:{sans:[m,o,a],serif:[k,i,t]},HELPER_CSS:{position:v,margin:f,padding:f,top:r,left:r,fontSize:p,width:d,height:d,lineHeight:n,fontVariant:n,visibility:s},COMPARISON_STRING:j,__eL:null,__eM:null,removeDefaultHelperElements:function(){var y=qx.bom.webfonts.Validator.__eM;if(y){for(var z in y){document.body.removeChild(y[z]);}
;}
;delete qx.bom.webfonts.Validator.__eM;}
},properties:{fontFamily:{nullable:true,init:null,apply:q},timeout:{check:c,init:5000}},events:{"changeStatus":e},members:{__eK:null,__eN:null,__eO:null,validate:function(){this.__eO=new Date().getTime();if(this.__eN){this.__eN.restart();}
...
,this,0);}
;}
,_reset:function(){if(this.__eK){for(var B in this.__eK){var A=this.__eK[B];document.body.removeChild(A);}
;this.__eK=null;}
;}
,_isFontValid:function(){if(!qx.bom.webfonts.Validator.__eL){this.__eP();}
;if(!this.__eK){this.__eK=this._getRequestedHelpers();}
;var D=qx.bom.element.Dimension.getWidth(this.__eK.sans);var C=qx.bom.element.Dimension.getWidth(this.__eK.serif);var E=qx.bom.webfonts.Validator;if(D!==E.__eL.sans&&C!==E.__eL.serif){return true;}
;return false;}
...
;}
,__eP:function(){var M=qx.bom.webfonts.Validator;if(!M.__eM){M.__eM={sans:this._getHelperElement(M.COMPARISON_FONTS.sans),serif:this._getHelperElement(M.COMPARISON_FONTS.serif)};}
;M.__eL={sans:qx.bom.element.Dimension.getWidth(M.__eM.sans),serif:qx.bom.element.Dimension.getWidth(M.__eM.serif)};}
,__eQ:function(){if(this._isFontValid()){this.__eN.stop();this._reset();this.fireDataEvent(b,{family:this.getFontFamily(),valid:true});}
else {var N=new Date().getTime();if(N-this.__eO>=this.getTimeout()){this.__eN.stop();this._reset();this.fireDataEvent(b,{family:this.getFontFamily(),valid:false});}
;}
;}
},destruct:function(){this._reset();this.__eN.stop();this.__eN.removeListener(h,this.__eQ,this);this._disposeObjects(l);}
});}
)();
...
,__eR:{visible:true,hidden:true},getContentWidth:function(u){var r=qx.bom.element.Style;var s=qx.bom.element.Style.get(u,k);var t=parseInt(r.get(u,g)||d,10);var x=parseInt(r.get(u,e)||d,10);if(this.__eR[s]){var w=u.clientWidth;if((qx.core.Environment.get(b)==h)||qx.dom.Node.isBlockNode(u)){w=w-t-x;}
...
;}
;}
,getContentHeight:function(D){var y=qx.bom.element.Style;var A=qx.bom.element.Style.get(D,l);var B=parseInt(y.get(D,j)||d,10);var z=parseInt(y.get(D,i)||d,10);if(this.__eR[A]){return D.clientHeight-B-z;}
...
(function(){var a="'.",b="Missing appearance: ",c="_applyTheme",d="qx.debug",e="string",f="Cannot find a matching appearance for '",g="Hint: This may be an issue with nested child controls and a missing alias definition in the appearance theme.",h="qx.theme.manager.Appearance",j=":",k="Theme",l="undefined",m="changeTheme",n="/",o="singleton";qx.Class.define(h,{type:o,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__eS={};this.__eT={};}
,properties:{theme:{check:k,nullable:true,event:m,apply:c}},members:{__eU:{},__eS:null,__eT:null,_applyTheme:function(){this.__eT={};this.__eS={};}
,__eV:function(D,z,q,u){var w=z.appearances;var r=w[D];if(!r){var C=n;var s=[];var v=D.split(C);var B=qx.lang.Array.clone(v);var y;while(!r&&v.length>0){s.unshift(v.pop());var t=v.join(C);r=w[t];if(r){y=r.alias||r;if(typeof y===e){var A=y+C+s.join(C);return this.__eV(A,z,q,B);}
;}
;}
;for(var i=0;i<s.length-1;i++ ){s.shift();var x=s.join(C);var p=this.__eV(x,z,null,B);if(p){return p;}
;}
;if(q!=null){return this.__eV(q,z,null,B);}
;if(qx.core.Environment.get(d)){if(typeof u!==l){this.debug(f+u.join(n)+a);if(u.length>1){this.info(g);}
;}
;}
;return null;}
else if(typeof r===e){return this.__eV(r,z,q,B);}
else if(r.include&&!r.style){return this.__eV(r.include,z,q,B);}
;return D;}
,styleFrom:function(W,O,P,F){if(!P){P=this.getTheme();}
;var M=this.__eT;var E=M[W];if(!E){E=M[W]=this.__eV(W,P,F);}
...
;if(J>0){U+=j+J;}
;}
;var K=this.__eS;if(K[U]!==undefined){return K[U];}
;if(!O){O=this.__eU;}
...
;return K[U]=R||null;}
},destruct:function(){this.__eS=this.__eT=null;}
});}
)();
...
;W.include=this.__eW(W.include);W.patch=this.__eW(W.patch);if(qx.core.Environment.get(q)){this.__j(name,W);}
;var V={$$type:Q,name:name,title:W.title,toString:this.genericToString};if(W.extend){V.supertheme=W.extend;}
;V.basename=qx.Bootstrap.createNamespace(name,V);this.__fa(V,W);this.__eX(V,W);this.$$registry[name]=V;for(var i=0,a=W.include,l=a.length;i<l;i++ ){this.include(V,a[i]);}
;for(var i=0,a=W.patch,l=a.length;i<l;i++ ){this.patch(V,a[i]);}
;}
,__eW:function(X){if(!X){return [];}
;if(qx.Bootstrap.isArray(X)){return X;}
else {return [X];}
;}
,__eX:function(Y,ba){var bb=ba.aliases||{};if(ba.extend&&ba.extend.aliases){qx.Bootstrap.objectMergeWith(bb,ba.extend.aliases,false);}
;Y.aliases=bb;}
...
,__eY:function(bd){for(var i=0,bc=this.__fb,l=bc.length;i<l;i++ ){if(bd[bc[i]]){return bc[i];}
;}
;}
,__fa:function(bi,bj){var bf=this.__eY(bj);if(bj.extend&&!bf){bf=bj.extend.type;}
...
,$$registry:{},__fb:[N,u,n,d,j,s,e,R],__i:qx.core.Environment.select(q,{"true":{"title":m,"aliases":U,"type":m,"extend":U,"colors":U,"borders":U,"decorations":U,"fonts":U,"icons":U,"widgets":U,"appearances":U,"meta":U,"include":U,"patch":U},"default":null}),__fc:qx.core.Environment.select(q,{"true":{"color":U,"border":U,"decoration":U,"font":U,"icon":U,"appearance":U,"widget":U},"default":null}),__j:qx.core.Environment.select(q,{"true":function(name,bq){var bp=this.__i;for(var bo in bq){if(bp[bo]===undefined){throw new Error(f+bo+M+name+h);}
...
;}
;if(bq.meta){var bm;for(var bo in bq.meta){bm=bq.meta[bo];if(this.__fc[bo]===undefined){throw new Error(C+bo+S);}
;if(typeof bm!==this.__fc[bo]){throw new Error(I+bo+L);}
...
;}
,"default":function(){}
}),patch:function(bu,bs){this.__fd(bs);var bw=this.__eY(bs);if(bw!==this.__eY(bu)){throw new Error(w+bu.name+v+bs.name+b);}
;var bt=bs[bw];var br=bu.$$clazz.prototype;for(var bv in bt){br[bv]=bt[bv];}
;}
,include:function(bA,by){this.__fd(by);var bC=by.type;if(bC!==bA.type){throw new Error(w+bA.name+v+by.name+b);}
;var bz=by[bC];var bx=bA.$$clazz.prototype;for(var bB in bz){if(bx[bB]!==undefined){continue;}
;bx[bB]=bz[bB];}
;}
,__fd:function(bD){if(typeof bD===H||bD==null){var bF=new Error(g);if(qx.core.Environment.get(q)){var bE=qx.dev.StackTrace.getStackTraceFromError(bF);qx.Bootstrap.error(this,bE);}
;throw bF;}
;}
}});}
)();
(function(){var a="widget",b="qx.ui.tooltip.ToolTip",c="Boolean",d="",f="interval",g="mouseover",h="_applyCurrent",i="mouseout",j="qx.ui.tooltip.Manager",k="mousemove",l="__fh",m="focusout",n="tooltip-error",o="__ff",p="singleton",q="__fe";qx.Class.define(j,{type:p,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);qx.event.Registration.addListener(document.body,g,this.__fm,this,true);this.__fe=new qx.event.Timer();this.__fe.addListener(f,this.__fj,this);this.__ff=new qx.event.Timer();this.__ff.addListener(f,this.__fk,this);this.__fg={left:0,top:0};}
,properties:{current:{check:b,nullable:true,apply:h},showInvalidToolTips:{check:c,init:true},showToolTips:{check:c,init:true}},members:{__fg:null,__ff:null,__fe:null,__fh:null,__fi:null,getSharedTooltip:function(){if(!this.__fh){this.__fh=new qx.ui.tooltip.ToolTip().set({rich:true});}
;return this.__fh;}
,getSharedErrorTooltip:function(){if(!this.__fi){this.__fi=new qx.ui.tooltip.ToolTip().set({appearance:n,rich:true});this.__fi.setLabel(d);this.__fi.syncAppearance();}
;return this.__fi;}
,_applyCurrent:function(t,s){if(s&&qx.ui.core.Widget.contains(s,t)){return;}
;if(s){if(!s.isDisposed()){s.exclude();}
;this.__fe.stop();this.__ff.stop();}
;var u=qx.event.Registration;var r=document.body;if(t){this.__fe.startWith(t.getShowTimeout());u.addListener(r,i,this.__fn,this,true);u.addListener(r,m,this.__fo,this,true);u.addListener(r,k,this.__fl,this,true);}
else {u.removeListener(r,i,this.__fn,this,true);u.removeListener(r,m,this.__fo,this,true);u.removeListener(r,k,this.__fl,this,true);}
;}
,__fj:function(e){var v=this.getCurrent();if(v&&!v.isDisposed()){this.__ff.startWith(v.getHideTimeout());if(v.getPlaceMethod()==a){v.placeToWidget(v.getOpener());}
else {v.placeToPoint(this.__fg);}
;v.show();}
;this.__fe.stop();}
,__fk:function(e){var w=this.getCurrent();if(w&&!w.isDisposed()){w.exclude();}
;this.__ff.stop();this.resetCurrent();}
,__fl:function(e){var x=this.__fg;x.left=Math.round(e.getDocumentLeft());x.top=Math.round(e.getDocumentTop());}
,__fm:function(e){var y=qx.ui.core.Widget.getWidgetByElement(e.getTarget());this.showToolTip(y);}
...
,__fn:function(e){var E=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!E){return;}
...
;}
,__fo:function(e){var H=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!H){return;}
;var I=this.getCurrent();if(I&&I==H.getToolTip()){this.setCurrent(null);}
;}
},destruct:function(){qx.event.Registration.removeListener(document.body,g,this.__fm,this,true);this._disposeObjects(q,o,l);this.__fg=null;}
});}
)();
...
;}
;}
,"false":null}),__fp:null,__fq:null,__fr:null,__fs:null,__ft:null,__fu:null,__fv:null,getBounds:function(){return this.__fu||this.__fq||null;}
...
;if(P!=null&&P!==this.__fp){this.__fp=P;qx.ui.core.queue.Layout.add(this);return null;}
;var O=this.__fq;if(!O){O=this.__fq={};}
;var T={};if(U!==O.left||top!==O.top){T.position=true;O.left=U;O.top=top;}
;if(R!==O.width||Q!==O.height){T.size=true;O.width=R;O.height=Q;}
;if(this.__fr){T.local=true;delete this.__fr;}
;if(this.__ft){T.margin=true;delete this.__ft;}
;return T;}
,isExcluded:function(){return false;}
,hasValidLayout:function(){return !this.__fr;}
,scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);}
,invalidateLayoutCache:function(){this.__fr=true;this.__fs=null;}
,getSizeHint:function(V){var W=this.__fs;if(W){return W;}
;if(V===false){return null;}
;W=this.__fs=this._computeSizeHint();if(this._hasHeightForWidth()&&this.__fp&&this.getHeight()==null){W.height=this.__fp;}
...
,_applyMargin:function(){this.__ft=true;var parent=this.$$parent;if(parent){parent.updateLayoutProperties();}
;}
...
,setUserBounds:function(bi,top,bh,bj){this.__fu={left:bi,top:top,width:bh,height:bj};qx.ui.core.queue.Layout.add(this);}
,resetUserBounds:function(){delete this.__fu;qx.ui.core.queue.Layout.add(this);}
,__fw:{},setLayoutProperties:function(bm){if(bm==null){return;}
;var bk=this.__fv;if(!bk){bk=this.__fv={};}
...
;return null;}
,clone:function(){var bq=qx.core.Object.prototype.clone.call(this);var br=this.__fv;if(br){bq.__fv=qx.lang.Object.clone(br);}
;return bq;}
...
;this.$$parent=this.$$subparent=this.__fv=this.__fq=this.__fu=this.__fs=null;}
});}
)();
...
(function(){var a="qx.ui.core.queue.Layout",b="layout";qx.Class.define(a,{statics:{__eu:{},__fx:{},remove:function(c){delete this.__eu[c.$$hash];}
,add:function(d){this.__eu[d.$$hash]=d;qx.ui.core.queue.Manager.scheduleFlush(b);}
,isScheduled:function(e){return !!this.__eu[e.$$hash];}
,flush:function(){var f=this.__fz();for(var i=f.length-1;i>=0;i-- ){var g=f[i];if(g.hasValidLayout()){continue;}
...
;}
;}
,getNestingLevel:function(l){var k=this.__fx;var n=0;var parent=l;while(true){if(k[parent.$$hash]!=null){n+=k[parent.$$hash];break;}
;if(!parent.$$parent){break;}
;parent=parent.$$parent;n+=1;}
;var m=n;while(l&&l!==parent){k[l.$$hash]=m-- ;l=l.$$parent;}
;return n;}
,__fy:function(){var t=qx.ui.core.queue.Visibility;this.__fx={};var s=[];var r=this.__eu;var o,q;for(var p in r){o=r[p];if(t.isVisible(o)){q=this.getNestingLevel(o);if(!s[q]){s[q]={};}
;s[q][p]=o;delete r[p];}
;}
;return s;}
,__fz:function(){var x=[];var z=this.__fy();for(var w=z.length-1;w>=0;w-- ){if(!z[w]){continue;}
...
(function(){var a="Method '",b="qxWeb",c="' already available as static method.",d="qx.debug",e="' already available.";qx.Bootstrap.define(b,{extend:qx.type.BaseArray,statics:{__eP:[],$$qx:qx,$init:function(j){var h=[];for(var i=0;i<j.length;i++ ){var g=!!(j[i]&&(j[i].nodeType===1||j[i].nodeType===9));if(g){h.push(j[i]);continue;}
;var f=!!(j[i]&&j[i].history&&j[i].location&&j[i].document);if(f){h.push(j[i]);}
;}
;var k=qx.lang.Array.cast(h,qxWeb);for(var i=0;i<qxWeb.__eP.length;i++ ){qxWeb.__eP[i].call(k);}
;return k;}
...
;qxWeb[name]=n[name];}
;}
,$attachInit:function(o){this.__eP.push(o);}
...
else {var L=qxWeb.getDocument(K[0]);O=qx.module.Css.__fB(K[0].tagName,L);}
;K.setStyle(d,O);K[0].$$qPrevDisp=a;}
;}
);return this;}
,__fA:{},__fB:function(T,Q){var S=qx.module.Css.__fA;if(!S[T]){var U=Q||document;var R=qxWeb(U.createElement(T)).appendTo(Q.body);S[T]=R.getStyle(d);R.remove();}
;return S[T]||c;}
...
;return A.className;}
,"default":function(C,E){var D={};var F;var B=C.className;if(B){F=B.split(this.__fC);for(var i=0,l=F.length;i<l;i++ ){D[F[i]]=true;}
...
;return P.className;}
,"default":function(S,Q){var R=new RegExp(v+Q.join(g)+v,s);return S.className=S.className.replace(R,f).replace(this.__fD,f).replace(this.__fC,p);}
...
(function(){var a="mshtml",b="engine.name",c="*",d="load",e="left",f="qx.module.Event",g="undefined",h="DOMContentLoaded",n="browser.documentmode",o="complete";qx.Bootstrap.define(f,{statics:{__fK:{},__fL:{on:{},off:{}},on:function(w,t,u){for(var i=0;i<this.length;i++ ){var p=this[i];var q=u||qxWeb(p);var v=qx.module.Event.__fL.on;var s=v[c]||[];if(v[w]){s=s.concat(v[w]);}
;for(var j=0,m=s.length;j<m;j++ ){s[j](p,w,t,u);}
;var r=function(event){var B=qx.module.Event.__fK;var A=B[c]||[];if(B[w]){A=A.concat(B[w]);}
...
;if(!p.__fM){p.__fM=new qx.event.Emitter();}
;var z=p.__fM.on(w,r,q);if(!p.__fN){p.__fN={};}
;if(!p.__fN[w]){p.__fN[w]={};}
;p.__fN[w][z]=r;if(!u){if(!p.__fO){p.__fO={};}
;p.__fO[z]=q;}
;}
;return this;}
,off:function(L,D,I){var H=(D===null&&I===null);for(var j=0;j<this.length;j++ ){var C=this[j];if(!C.__fN){continue;}
;var N=[];if(L!==null){N.push(L);}
else {for(var F in C.__fN){N.push(F);}
;}
;for(var i=0,l=N.length;i<l;i++ ){for(var G in C.__fN[N[i]]){var K=C.__fN[N[i]][G];if(H||K==D||K.original==D){var E=typeof C.__fO!==g&&C.__fO[G];var O;if(!I&&E){O=C.__fO[G];}
;C.__fM.off(N[i],K,O||I);if(H||K.original==D){qx.bom.Event.removeNativeListener(C,N[i],K);}
;delete C.__fN[N[i]][G];if(E){delete C.__fO[G];}
;}
;}
;var J=qx.module.Event.__fL.off;var M=J[c]||[];if(J[L]){M=M.concat(J[L]);}
;for(var k=0,m=M.length;k<m;k++ ){M[k](C,L,D,I);}
;}
;}
;return this;}
,allOff:function(P){return this.off(P||null,null,null);}
,emit:function(Q,R){for(var j=0;j<this.length;j++ ){var S=this[j];if(S.__fM){S.__fM.emit(Q,R);}
;}
;return this;}
,once:function(U,T,W){var self=this;var V=function(X){self.off(U,V,W);T.call(this,X);}
;this.on(U,V,W);return this;}
,hasListener:function(Y){if(!this[0]||!this[0].__fM||!this[0].__fM.getListeners()[Y]){return false;}
;return this[0].__fM.getListeners()[Y].length>0;}
...
;}
;bf.forEach(function(bh){bh.__fM=null;}
);for(var i=0;i<be.length;i++ ){var ba=be[i];if(!ba.__fM){continue;}
;var bc=ba.__fM.getListeners();for(var name in bc){for(var j=bc[name].length-1;j>=0;j-- ){var bd=bc[name][j].listener;if(bd.original){bd=bd.original;}
...
;var bo=qx.module.Event.__fK;for(var i=0,l=bq.length;i<l;i++ ){var bp=bq[i];if(qx.lang.Type.isFunction(bn)){if(!bo[bp]){bo[bp]=[];}
;bo[bp].push(bn);}
;}
;}
,$unregisterNormalization:function(bu,br){if(!qx.lang.Type.isArray(bu)){bu=[bu];}
;var bs=qx.module.Event.__fK;for(var i=0,l=bu.length;i<l;i++ ){var bt=bu[i];if(bs[bt]){qx.lang.Array.remove(bs[bt],br);}
;}
;}
,$getRegistry:function(){return qx.module.Event.__fK;}
,$registerEventHook:function(bA,bx,bw){if(!qx.lang.Type.isArray(bA)){bA=[bA];}
;var by=qx.module.Event.__fL.on;for(var i=0,l=bA.length;i<l;i++ ){var bz=bA[i];if(qx.lang.Type.isFunction(bx)){if(!by[bz]){by[bz]=[];}
;by[bz].push(bx);}
;}
;if(!bw){return;}
;var bv=qx.module.Event.__fL.off;for(var i=0,l=bA.length;i<l;i++ ){var bz=bA[i];if(qx.lang.Type.isFunction(bw)){if(!bv[bz]){bv[bz]=[];}
;bv[bz].push(bw);}
;}
;}
,$unregisterEventHook:function(bG,bD,bC){if(!qx.lang.Type.isArray(bG)){bG=[bG];}
;var bE=qx.module.Event.__fL.on;for(var i=0,l=bG.length;i<l;i++ ){var bF=bG[i];if(bE[bF]){qx.lang.Array.remove(bE[bF],bD);}
;}
;if(!bC){return;}
;var bB=qx.module.Event.__fL.off;for(var i=0,l=bG.length;i<l;i++ ){var bF=bG[i];if(bB[bF]){qx.lang.Array.remove(bB[bF],bC);}
;}
;}
,$getHookRegistry:function(){return qx.module.Event.__fL;}
...
(function(){var a="qx.event.Emitter",b="*";qx.Bootstrap.define(a,{extend:Object,statics:{__fP:[]},members:{__fN:null,__fQ:null,on:function(name,c,d){var e=qx.event.Emitter.__fP.length;this.__fR(name).push({listener:c,ctx:d,id:e});qx.event.Emitter.__fP.push({name:name,listener:c,ctx:d});return e;}
...
;}
,getListeners:function(){return this.__fN;}
,__fR:function(name){if(this.__fN==null){this.__fN={};}
;if(this.__fN[name]==null){this.__fN[name]=[];}
;return this.__fN[name];}
}});}
)();
...
(function(){var a="css.animation",b="translate",c="rotate",d="skew",e="scale",f="qx.bom.element.Animation";qx.Bootstrap.define(f,{statics:{animate:function(h,k,g){var j=qx.bom.element.Animation.__fS(h,k.keyFrames);if(qx.core.Environment.get(a)&&j){return qx.bom.element.AnimationCss.animate(h,k,g);}
else {return qx.bom.element.AnimationJs.animate(h,k,g);}
;}
,animateReverse:function(m,o,l){var n=qx.bom.element.Animation.__fS(m,o.keyFrames);if(qx.core.Environment.get(a)&&n){return qx.bom.element.AnimationCss.animateReverse(m,o,l);}
else {return qx.bom.element.AnimationJs.animateReverse(m,o,l);}
;}
,__fS:function(p,t){var r=[];for(var v in t){var s=t[v];for(var u in s){if(r.indexOf(u)==-1){r.push(u);}
;}
;}
...
;if(this.__fV!=null){var name=this.__gd(S,R);var Q=name+E+V+C+W.repeat+E+W.timing+E+(W.delay?W.delay+C:t)+(W.alternate?k:t);qx.bom.Event.addNativeListener(P,this.__fV[y],this.__fW);qx.bom.Event.addNativeListener(P,this.__fV[s],this.__fX);qx.bom.Event.addNativeListener(P,this.__fV[A],this.__fY);P.style[qx.lang.String.camelCase(this.__fV[r])]=Q;if(T&&T==100&&this.__fV[a]){P.style[this.__fV[a]]=w;}
;}
...
;if(this.__fV==null){window.setTimeout(function(){qx.bom.element.AnimationCss.__fY({target:P});}
,0);}
;return U;}
,__fW:function(e){e.target.$$animation.emit(f,e.target);}
,__fX:function(e){if(e.target!=null&&e.target.$$animation!=null){e.target.$$animation.emit(z,e.target);}
;}
,__fY:function(e){var X=e.target;var Y=X.$$animation;if(!Y){return;}
;var bb=Y.desc;if(qx.bom.element.AnimationCss.__fV!=null){var ba=qx.lang.String.camelCase(qx.bom.element.AnimationCss.__fV[r]);X.style[ba]=t;qx.bom.Event.removeNativeListener(X,qx.bom.element.AnimationCss.__fV[r],qx.bom.element.AnimationCss.__fY);}
;if(bb.origin!=null){qx.bom.element.Transform.setOrigin(X,t);}
;qx.bom.element.AnimationCss.__ga(X,bb.keyFrames[Y.keep]);X.$$animation=null;Y.el=null;Y.ended=true;Y.emit(g,X);}
,__ga:function(bc,bd){var bf;for(var be in bd){if(be in qx.bom.element.AnimationCss.__fU){if(!bf){bf={};}
;bf[be]=bd[be];}
else {bc.style[qx.lang.String.camelCase(be)]=bd[be];}
;}
;if(bf){qx.bom.element.Transform.transform(bc,bf);}
;}
,__gb:function(bg){if(!bg.hasOwnProperty(k)){bg.alternate=false;}
...
;}
,__gc:qx.core.Environment.select(l,{"true":function(bi){var bh=[u,n,m,i,p,c,d,k];for(var name in bi){if(!(bh.indexOf(name)!=-1)){qx.Bootstrap.warn(v+name+x);}
;}
...
;}
;}
,"default":null}),__gd:function(frames,bl){var bo=t;for(var bs in frames){bo+=(bl?-(bs-100):bs)+D;var bn=frames[bs];var bq;for(var bk in bn){if(bk in this.__fU){if(!bq){bq={};}
;bq[bk]=bn[bk];}
...
;var name=this.__fT+this.__co++ ;var bp=this.__fV[I]+E+name;qx.bom.Stylesheet.addRule(this.__dj,bp,bo);this.__dh[bo]=name;return name;}
}});}
)();
...
(function(){var c="cm",d="mm",e="0",f="pt",g="pc",h="",k="%",l="em",m="qx.bom.element.AnimationJs",n="infinite",o="#",p="in",q="px",r="start",s="end",t="ex",u="undefined",v="iteration",w="string";qx.Bootstrap.define(m,{statics:{__gh:30,__gi:[k,p,c,d,l,t,f,g,q],animate:function(y,z,x){return this._animate(y,z,x,false);}
...
;var I=N.keyFrames;var G=this.__go(I);var H=this.__gn(M,G);var K=parseInt(M/H,10);this.__gj(I,D);var L=this.__gk(K,H,G,I,M,N.timing);var E=new qx.bom.element.AnimationHandle();E.jsAnimation=true;if(F){L.reverse();E.reverse=true;}
;E.desc=N;E.el=D;E.delta=L;E.stepTime=H;E.steps=K;D.$$animation=E;E.i=0;E.initValues={};E.repeatSteps=this.__gl(K,N.repeat);var J=N.delay||0;var self=this;E.delayId=window.setTimeout(function(){E.delayId=null;self.play(E);}
,J);return E;}
,__gj:function(S,O){var V={};for(var R in S){for(var name in S[R]){var P=qx.bom.Style.getPropertyName(name);if(P&&P!=name){var U=qx.bom.Style.getCssName(P);S[R][U]=S[R][name];delete S[R][name];name=U;}
...
;if(Q[name]===h&&this.__gi.indexOf(V[name])!=-1){Q[name]=e+V[name];}
;}
;}
;}
;}
,__gk:function(bg,ba,Y,bc,bk,be){var bb=new Array(bg);var bm=1;bb[0]=bc[0];var X=bc[0];var bd=bc[Y[bm]];for(var i=1;i<bb.length;i++ ){if(i*ba/bk*100>Y[bm]){X=bd;bm++ ;bd=bc[Y[bm]];}
...
;}
;}
;qx.bom.element.AnimationJs.__gm(bn.el,bp);bn.i++ ;if(bn.i%bn.steps==0){bn.emit(v,bn.el);if(bn.desc.alternate){bn.delta.reverse();}
;}
...
;this.__gm(br,bt.keyFrames[bv]);}
else {this.__gm(br,bs);}
;br.$$animation=null;bu.el=null;bu.ended=true;bu.animationId=null;bu.emit(s,br);return bu;}
,__gl:function(bx,bw){if(bw==undefined){return bx;}
;if(bw==n){return Number.MAX_VALUE;}
;return bx*bw;}
,__gm:function(bz,by){for(var bA in by){if(by[bA]===undefined){continue;}
...
;}
;}
,__gn:function(bD,bB){var bE=100;for(var i=0;i<bB.length-1;i++ ){bE=Math.min(bE,bB[i+1]-bB[i]);}
;var bC=bD*bE/100;while(bC>this.__gh){bC=bC/2;}
;return Math.round(bC);}
,__go:function(bG){var bF=Object.keys(bG);for(var i=0;i<bF.length;i++ ){bF[i]=parseInt(bF[i],10);}
...
;return y;}
,request:function(r,t){var s=qx.core.Environment.get(d);var u=function(w){var v=window.performance&&performance.timing&&performance.timing.navigationStart;if(w<1e10&&v){w=v+w;}
;w=w||+(new Date());r.call(t,w);}
...
,getCss:function(I){var J=this.__gs(I);if(this.__gr!=null){var H=this.__gr[b];return qx.bom.Style.getCssName(H)+u+J+n;}
;return e;}
,setOrigin:function(K,L){if(this.__gr!=null){K.style[this.__gr[s]]=L;}
;}
,getOrigin:function(M){if(this.__gr!=null){return M.style[this.__gr[s]];}
;return e;}
,setStyle:function(N,O){if(this.__gr!=null){N.style[this.__gr[t]]=O;}
;}
,getStyle:function(P){if(this.__gr!=null){return P.style[this.__gr[t]];}
;return e;}
,setPerspective:function(Q,R){if(this.__gr!=null){Q.style[this.__gr[c]]=R+g;}
;}
,getPerspective:function(S){if(this.__gr!=null){return S.style[this.__gr[c]];}
;return e;}
,setPerspectiveOrigin:function(T,U){if(this.__gr!=null){T.style[this.__gr[o]]=U;}
;}
,getPerspectiveOrigin:function(V){if(this.__gr!=null){var W=V.style[this.__gr[o]];if(W!=e){return W;}
else {var Y=V.style[this.__gr[o]+q];var X=V.style[this.__gr[o]+r];if(Y!=e){return Y+j+X;}
;}
;}
;return e;}
,setBackfaceVisibility:function(ba,bb){if(this.__gr!=null){ba.style[this.__gr[a]]=bb?d:l;}
;}
,getBackfaceVisibility:function(bc){if(this.__gr!=null){return bc.style[this.__gr[a]]==d;}
;return true;}
,__gs:function(bf){var bg=e;for(var bd in bf){var be=bf[bd];if(qx.Bootstrap.isArray(be)){for(var i=0;i<be.length;i++ ){if(be[i]==undefined){continue;}
;bg+=bd+this.__gq[i]+f;bg+=be[i];bg+=p;}
;}
...
(function(){var a="qx.util.DeferredCall",b="The context object '",c="qx.debug",d="'is already disposed.",e="' of the defered call '";qx.Class.define(a,{extend:qx.core.Object,construct:function(f,g){qx.core.Object.call(this);this.__bz=f;this.__bB=g||null;this.__gz=qx.util.DeferredCallManager.getInstance();}
,members:{__bz:null,__bB:null,__gz:null,cancel:function(){this.__gz.cancel(this);}
...
;var bM=[];var bN=this._modified;for(var bK in bN){bL=bN[bK];if(bL.__ha()||bL.classname==T){if(bL.__gJ&&qx.dom.Hierarchy.isRendered(bL.__gJ)){bM.push(bL);}
...
;}
;delete bI[bK];}
;var scroll=this._scroll;for(var bK in scroll){bL=scroll[bK];var bC=bL.__gJ;if(bC&&bC.offsetWidth){var bF=true;if(bL.__gO!=null){bL.__gJ.scrollLeft=bL.__gO;delete bL.__gO;}
;if(bL.__gP!=null){bL.__gJ.scrollTop=bL.__gP;delete bL.__gP;}
...
;}
;}
;var bE={"releaseCapture":1,"blur":1,"deactivate":1};for(var i=0;i<this._actions.length;i++ ){var bR=this._actions[i];var bO=bR.element.__gJ;if(!bO||!bE[bR.type]&&!bR.element.__ha()){continue;}
...
,__gI:function(bV){var bW=qx.core.ObjectRegistry.fromHashCode(bV.$$element);return bW&&!bW.__ha();}
},members:{__gA:null,__gJ:null,__a:false,__gK:true,__gL:true,__gM:null,__gN:null,__gO:null,__gP:null,__gQ:null,__gR:null,__gS:null,__gB:null,__gC:null,__gT:null,__gU:null,__gV:null,__gW:null,__gX:null,_scheduleChildrenUpdate:function(){if(this.__gW){return;}
...
;}
;var length;var bX=this.__gV;if(bX){length=bX.length;var bY;for(var i=0;i<length;i++ ){bY=bX[i];if(bY.__gL&&bY.__gK&&!bY.__gJ){bY.__gY();}
;}
;}
...
;}
;delete this.__gW;}
,_insertChildren:function(){var ca=this.__gV;var length=ca.length;var cc;if(length>2){var cb=document.createDocumentFragment();for(var i=0;i<length;i++ ){cc=ca[i];if(cc.__gJ&&cc.__gK){cb.appendChild(cc.__gJ);}
;}
;this.__gJ.appendChild(cb);}
else {var cb=this.__gJ;for(var i=0;i<length;i++ ){cc=ca[i];if(cc.__gJ&&cc.__gK){cb.appendChild(cc.__gJ);}
;}
;}
;}
,_syncChildren:function(){var cm=qx.core.ObjectRegistry;var cd=this.__gV;var ck=cd.length;var ce;var ci;var cg=this.__gJ;var cl=cg.childNodes;var cf=0;var cj;if(qx.core.Environment.get(A)){var ch=0;}
...
;}
;}
;for(var i=0;i<ck;i++ ){ce=cd[i];if(ce.__gK){ci=ce.__gJ;cj=cl[cf];if(!ci){continue;}
...
;}
,_syncData:function(){var cx=this.__gJ;var cw=qx.bom.element.Attribute;var cu=qx.bom.element.Style;var cv=this.__gR;if(cv){var cA=this.__gC;if(cA){var cy;for(var cz in cv){cy=cA[cz];if(cy!==undefined){cw.set(cx,cz,cy);}
else {cw.reset(cx,cz);}
;}
;}
;this.__gR=null;}
;var cv=this.__gQ;if(cv){var cA=this.__gB;if(cA){var ct={};for(var cz in cv){ct[cz]=cA[cz];}
;cu.setStyles(cx,ct);}
;this.__gQ=null;}
...
;this.__gS=null;}
;}
,__ha:function(){var cB=this;while(cB){if(cB.__a){return true;}
...
;if(!this.__gJ){this.__gY();dp.push(this.__gJ);}
...
;if(this.__gJ){dr.fadeOut(dq).once(v,function(){this.hide();qx.html.Element.flush();}
,this);return dr.getAnimationHandles()[0];}
;}
,show:function(){if(this.__gL){return this;}
;if(this.__gJ){qx.html.Element._visibility[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
...
;delete this.__gP;}
,scrollToX:function(x,dC){var dD=this.__gJ;if(dC!==true&&dD&&dD.offsetWidth){dD.scrollLeft=x;delete this.__gO;}
...
;return this.__gO||0;}
,scrollToY:function(y,dG){var dF=this.__gJ;if(dG!==true&&dF&&dF.offsetWidth){dF.scrollTop=y;delete this.__gP;}
...
,__he:null,__hf:function(e){if(!this.__he){this.__he=true;this.__gJ.scrollTop=0;this.__gJ.scrollLeft=0;delete this.__he;}
;}
...
;qx.html.Element.__gD[this.toHashCode()]={element:this,start:dM,end:dN};qx.html.Element._scheduleFlush(K);}
...
;if(this.__gJ){if(!this.__gQ){this.__gQ={};}
...
;}
;if(this.__gJ){qx.event.Registration.removeListener(this.__gJ,eN,eI,self,eH);}
else {var eJ=this.__gU;var eM;if(eH==null){eH=false;}
...
;if(this.__gJ){qx.event.Registration.removeListenerById(this.__gJ,eO);}
else {delete this.__gU[eO];}
;return this;}
,hasListener:function(eQ,eP){if(this.$$disposed){return false;}
;if(this.__gJ){return qx.event.Registration.hasListener(this.__gJ,eQ,eP);}
;var eR=this.__gU;var eT;if(eP==null){eP=false;}
;for(var eS in eR){eT=eR[eS];if(eT.capture===eP&&eT.type===eQ){return true;}
;}
;return false;}
},defer:function(eU){eU.__hh=new qx.util.DeferredCall(eU.flush,eU);}
,destruct:function(){var eV=this.__gJ;if(eV){qx.event.Registration.getManager(eV).removeAllListeners(eV);eV.$$element=L;}
;if(!qx.core.ObjectRegistry.inShutDown){var parent=this.__gX;if(parent&&!parent.$$disposed){parent.remove(this);}
;}
;this._disposeArray(P);this.__gC=this.__gB=this.__gU=this.__gT=this.__gR=this.__gQ=this.__gS=this.__gJ=this.__gX=this.__gM=this.__gN=null;}
});}
)();
(function(){var a="qx.event.handler.Appear",b="disappear",c="appear";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(d){qx.core.Object.call(this);this.__gz=d;this.__hi={};qx.event.handler.Appear.__hj[this.$$hash]=this;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{appear:true,disappear:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true,__hj:{},refresh:function(){var e=this.__hj;for(var f in e){e[f].refresh();}
;}
},members:{__gz:null,__hi:null,canHandleEvent:function(h,g){}
,registerEvent:function(l,m,j){var k=qx.core.ObjectRegistry.toHashCode(l)+m;var i=this.__hi;if(i&&!i[k]){i[k]=l;l.$$displayed=l.offsetWidth>0;}
;}
,unregisterEvent:function(q,r,o){var p=qx.core.ObjectRegistry.toHashCode(q)+r;var n=this.__hi;if(!n){return;}
;if(n[p]){delete n[p];}
;}
,refresh:function(){var w=this.__hi;var v;for(var u in w){v=w[u];var s=v.offsetWidth>0;if((!!v.$$displayed)!==s){v.$$displayed=s;var t=qx.event.Registration.createEvent(s?c:b);this.__gz.dispatchEvent(v,t);}
;}
;}
},destruct:function(){this.__gz=this.__hi=null;delete qx.event.handler.Appear.__hj[this.$$hash];}
...
(function(){var a="qx.event.handler.UserAction";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(b){qx.core.Object.call(this);this.__gz=b;this.__cx=b.getWindow();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{useraction:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__gz:null,__cx:null,canHandleEvent:function(d,c){}
,registerEvent:function(g,f,e){}
,unregisterEvent:function(j,i,h){}
},destruct:function(){this.__gz=this.__cx=null;}
,defer:function(k){qx.event.Registration.addHandler(k);}
});}
)();
(function(){var a="os.name",b="mousedown",c="mouseout",d="gecko",e="dblclick",f="useraction",g="mousewheel",h="event.touch",j="mousemove",k="ios",l="mouseover",m="qx.event.handler.Mouse",n="click",o="on",p="engine.version",q="engine.name",r="mouseup",s="contextmenu",t="qx.emulatemouse",u="webkit",v="DOMMouseScroll",w="device.touch",x="event.mspointer";qx.Class.define(m,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(y){qx.core.Object.call(this);this.__gz=y;this.__cx=y.getWindow();this.__a=this.__cx.document;if(!(qx.core.Environment.get(h)&&qx.event.handler.MouseEmulation.ON)){this._initButtonObserver();this._initMoveObserver();this._initWheelObserver();}
;if(qx.core.Environment.get(t)){qx.event.handler.MouseEmulation;}
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT+qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__hk:null,__hl:null,__hm:null,__hn:null,__ho:null,__gz:null,__cx:null,__a:null,__hp:null,canHandleEvent:function(A,z){}
...
:(function(){return null;}
),__hq:function(H,I,J){if(!J){J=qx.bom.Event.getTarget(H);}
...
,__hr:function(){var M=[this.__cx,this.__a,this.__a.body];var L=this.__cx;var K=v;for(var i=0;i<M.length;i++ ){if(qx.bom.Event.supportsEvent(M[i],g)){K=g;L=M[i];break;}
;}
;return {type:K,target:L};}
,preventNextClick:function(){this.__hp=true;}
,_initButtonObserver:function(){this.__hk=qx.lang.Function.listener(this._onButtonEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,b,this.__hk);Event.addNativeListener(this.__a,r,this.__hk);if(!(qx.event.handler.MouseEmulation.ON&&qx.core.Environment.get(x)&&qx.core.Environment.get(w))){Event.addNativeListener(this.__a,n,this.__hk);}
;Event.addNativeListener(this.__a,e,this.__hk);Event.addNativeListener(this.__a,s,this.__hk);}
,_initMoveObserver:function(){this.__hl=qx.lang.Function.listener(this._onMoveEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,j,this.__hl);Event.addNativeListener(this.__a,l,this.__hl);Event.addNativeListener(this.__a,c,this.__hl);}
,_initWheelObserver:function(){this.__hm=qx.lang.Function.listener(this._onWheelEvent,this);var N=this.__hr();qx.bom.Event.addNativeListener(N.target,N.type,this.__hm);}
,_stopButtonObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,b,this.__hk);Event.removeNativeListener(this.__a,r,this.__hk);if(!(qx.event.handler.MouseEmulation.ON&&qx.core.Environment.get(x)&&qx.core.Environment.get(w))){Event.removeNativeListener(this.__a,n,this.__hk);}
;Event.removeNativeListener(this.__a,e,this.__hk);Event.removeNativeListener(this.__a,s,this.__hk);}
,_stopMoveObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,j,this.__hl);Event.removeNativeListener(this.__a,l,this.__hl);Event.removeNativeListener(this.__a,c,this.__hl);}
,_stopWheelObserver:function(){var O=this.__hr();qx.bom.Event.removeNativeListener(O.target,O.type,this.__hm);}
,_onMoveEvent:qx.event.GlobalError.observeMethod(function(P){this.__hq(P);}
),_onButtonEvent:qx.event.GlobalError.observeMethod(function(S){var R=S.type;var T=qx.bom.Event.getTarget(S);if(R==n&&this.__hp){delete this.__hp;return;}
;if(qx.core.Environment.get(q)==d||qx.core.Environment.get(q)==u){if(T&&T.nodeType==3){T=T.parentNode;}
;}
;var Q=qx.event.handler.DragDrop&&this.__gz.getHandler(qx.event.handler.DragDrop).isSessionActive();if(Q&&R==n){return;}
;if(this.__hs){this.__hs(S,R,T);}
;if(this.__hu){this.__hu(S,R,T);}
;this.__hq(S,R,T);if(this.__ht){this.__ht(S,R,T);}
;if(this.__hv&&!Q){this.__hv(S,R,T);}
;this.__hn=R;}
),_onWheelEvent:qx.event.GlobalError.observeMethod(function(U){this.__hq(U,g);}
),__hs:qx.core.Environment.select(q,{"webkit":function(W,V,X){if(parseFloat(qx.core.Environment.get(p))<530){if(V==s){this.__hq(W,r,X);}
;}
;}
,"default":null}),__ht:qx.core.Environment.select(q,{"opera":function(Y,ba,bb){if(ba==r&&Y.button==2){this.__hq(Y,s,bb);}
;}
,"default":null}),__hu:qx.core.Environment.select(q,{"mshtml":function(bc,bd,be){if(bc.target!==undefined){return;}
;if(bd==r&&this.__hn==n){this.__hq(bc,b,be);}
else if(bd==e){this.__hq(bc,n,be);}
;}
,"default":null}),__hv:qx.core.Environment.select(q,{"mshtml":null,"default":function(bg,bf,bh){switch(bf){case b:this.__ho=bh;break;case r:if(bh!==this.__ho){var bi=qx.dom.Hierarchy.getCommonParent(bh,this.__ho);if(bi){this.__hq(bg,n,bi);}
;}
;};}
...
;this.__gz=this.__cx=this.__a=this.__ho=null;}
...
,__hw:function(n){n=n==null?0:n;return this.__hx()[n];}
,__hx:function(){var o=(this._isTouchEnd()?this.getChangedTargetTouches():this.getTargetTouches());return o;}
...
;var t=document.createElement(q);var s=t.style;s.height=s.width=m;s.overflow=w;document.body.appendChild(t);var c=z(t);this.__hC=c;document.body.removeChild(t);return this.__hC;}
...
(function(){var a="resize",b="os.name",c="qx.event.handler.Orientation",d="landscape",e="android",f="portrait",g="orientationchange";qx.Class.define(c,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(h){qx.core.Object.call(this);this.__gz=h;this.__cx=h.getWindow();this._initObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{orientationchange:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__gz:null,__cx:null,__hy:null,_currentOrientation:null,__hz:null,canHandleEvent:function(j,i){}
...
;}
},destruct:function(){this._stopObserver();this.__gz=this.__cx=null;}
...
(function(){var a="touchmove",b="os.name",c="MSPointerDown",d="swipe",e="android",f="qx.event.handler.TouchCore",g="event.mspointer",h="MSPointerCancel",j="y",k="pointer-events",l="longtap",m="touchend",n="MSPointerUp",o="right",p="engine.name",q="x",r="touchcancel",s="MSPointerMove",t="webkit",u="none",v="left",w="tap",z="down",A="undefined",B="up",C="touchstart";qx.Bootstrap.define(f,{extend:Object,statics:{TAP_MAX_DISTANCE:qx.core.Environment.get(b)!=e?10:40,SWIPE_DIRECTION:{x:[v,o],y:[B,z]},SWIPE_MIN_DISTANCE:qx.core.Environment.get(b)!=e?11:41,SWIPE_MIN_VELOCITY:0,LONGTAP_TIME:500},construct:function(D,E){this.__hD=D;this.__fM=E;this._initTouchObserver();}
,members:{__hD:null,__fM:null,__hE:null,__hF:null,__hG:null,__hH:null,__hI:null,__hJ:null,__hK:null,__hL:null,__hM:null,__hN:null,__hO:null,_initTouchObserver:function(){this.__hE=qx.lang.Function.listener(this._onTouchEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__hD,C,this.__hE);Event.addNativeListener(this.__hD,a,this.__hE);Event.addNativeListener(this.__hD,m,this.__hE);Event.addNativeListener(this.__hD,r,this.__hE);if(qx.core.Environment.get(g)){Event.addNativeListener(this.__hD,c,this.__hE);Event.addNativeListener(this.__hD,s,this.__hE);Event.addNativeListener(this.__hD,n,this.__hE);Event.addNativeListener(this.__hD,h,this.__hE);}
;}
,_stopTouchObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__hD,C,this.__hE);Event.removeNativeListener(this.__hD,a,this.__hE);Event.removeNativeListener(this.__hD,m,this.__hE);Event.removeNativeListener(this.__hD,r,this.__hE);if(qx.core.Environment.get(g)){Event.removeNativeListener(this.__hD,c,this.__hE);Event.removeNativeListener(this.__hD,s,this.__hE);Event.removeNativeListener(this.__hD,n,this.__hE);Event.removeNativeListener(this.__hD,h,this.__hE);}
;}
...
else if(K==s){if(this.__hL==true){K=a;}
;}
else if(K==h){K=r;}
;}
;if(K==C){this.__hF=this._getTarget(M);this.__hK=true;if(M.touches&&M.touches.length>1){this.__hM=this._getScalingDistance(M.touches[0],M.touches[1]);this.__hN=this._getRotationAngle(M.touches[0],M.touches[1]);}
;}
;if(K==a){if(typeof M.scale==A&&M.targetTouches.length>1){var N=this._getScalingDistance(M.targetTouches[0],M.targetTouches[1]);M.scale=N/this.__hM;}
;if(typeof M.rotation==A&&M.targetTouches.length>1){var L=this._getRotationAngle(M.targetTouches[0],M.targetTouches[1]);M.rotation=L-this.__hN;}
;if(this.__hK){this.__hK=this._isBelowTapMaxDistance(M.changedTouches[0]);}
;}
;this._fireEvent(M,K);this.__hQ(M,K);}
,_isBelowTapMaxDistance:function(O){var P={x:O.screenX-this.__hG,y:O.screenY-this.__hH};var Q=qx.event.handler.TouchCore;return (Math.abs(P.x)<=Q.TAP_MAX_DISTANCE&&Math.abs(P.y)<=Q.TAP_MAX_DISTANCE);}
,_getTarget:function(S){var T=qx.bom.Event.getTarget(S);if(qx.core.Environment.get(p)==t){if(T&&T.nodeType==3){T=T.parentNode;}
;}
else if(qx.core.Environment.get(g)){var R=this.__hP(S);if(R){T=R;}
;}
;return T;}
,__hP:function(W){if(W&&W.touches){var U=W.touches[0].clientX;var V=W.touches[0].clientY;}
...
;var bc=bc||bb.type;if(bd&&bd.nodeType&&this.__fM){this.__fM.emit(bc,bb);}
;}
,__hQ:function(be,bf,bg){if(!bg){bg=this._getTarget(be);}
;var bf=bf||be.type;if(bf==C){this.__hR(be,bg);}
else if(bf==a){this.__hS(be,bg);}
else if(bf==m){this.__hT(be,bg);}
;}
,__hR:function(bi,bj){var bh=bi.changedTouches[0];this.__hL=true;this.__hG=bh.screenX;this.__hH=bh.screenY;this.__hI=new Date().getTime();this.__hJ=bi.targetTouches.length===1;if(this.__hJ){this.__hO=window.setTimeout(this.__hV.bind(this,bi,bj),qx.event.handler.TouchCore.LONGTAP_TIME);}
else {this.__hW();}
;}
,__hS:function(bk,bl){if(this.__hJ&&bk.changedTouches.length>1){this.__hJ=false;}
;if(!this._isBelowTapMaxDistance(bk.changedTouches[0])){this.__hW();}
;}
,__hT:function(bm,bn){this.__hL=false;this.__hW();if(this.__hJ){var bq=bm.changedTouches[0];var br={x:bq.screenX-this.__hG,y:bq.screenY-this.__hH};var bo;if(this.__hF==bn&&this.__hK){if(qx.event&&qx.event.type&&qx.event.type.Tap){bo=qx.event.type.Tap;}
;this._fireEvent(bm,w,bn,bo);}
else {var bp=this.__hU(bm,bn,br);if(bp){if(qx.event&&qx.event.type&&qx.event.type.Swipe){bo=qx.event.type.Swipe;}
;bm.swipe=bp;this._fireEvent(bm,d,bn,bo);}
;}
;}
;}
,__hU:function(bu,bv,bA){var bx=qx.event.handler.TouchCore;var by=new Date().getTime()-this.__hI;var bB=(Math.abs(bA.x)>=Math.abs(bA.y))?q:j;var bs=bA[bB];var bt=bx.SWIPE_DIRECTION[bB][bs<0?0:1];var bz=(by!==0)?bs/by:0;var bw=null;if(Math.abs(bz)>=bx.SWIPE_MIN_VELOCITY&&Math.abs(bs)>=bx.SWIPE_MIN_DISTANCE){bw={startTime:this.__hI,duration:by,axis:bB,direction:bt,distance:bs,velocity:bz};}
;return bw;}
,__hV:function(bC,bD){this._fireEvent(bC,l,bD,qx.event.type.Tap);this.__hO=null;this.__hK=false;}
,__hW:function(){if(this.__hO){window.clearTimeout(this.__hO);this.__hO=null;}
;}
,dispose:function(){this._stopTouchObserver();this.__hF=this.__hD=this.__fM=this.__hM=this.__hN=null;this.__hW();}
}});}
)();
(function(){var a="touchmove",b="engine.name",c="mouseup",d="qx.event.handler.Touch",f="useraction",g="touchend",h="mshtml",i="event.mspointer",j="qx.mobile.nativescroll",k="dispose",l="qx.mobile.emulatetouch",m="event.touch",n="touchstart",o="mousedown",p="mousemove";qx.Class.define(d,{extend:qx.event.handler.TouchCore,implement:qx.event.IEventHandler,construct:function(q){this.__gz=q;this.__cx=q.getWindow();this.__a=this.__cx.document;qx.event.handler.TouchCore.apply(this,[this.__a]);if(!qx.core.Environment.get(i)){this._initMouseObserver();}
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{touchstart:1,touchmove:1,touchend:1,touchcancel:1,tap:1,longtap:1,swipe:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT,IGNORE_CAN_HANDLE:true,MOUSE_TO_TOUCH_MAPPING:{"mousedown":n,"mousemove":a,"mouseup":g}},members:{__hX:null,__gz:null,__cx:null,__a:null,__hY:false,canHandleEvent:function(s,r){}
,registerEvent:function(v,u,t){}
,unregisterEvent:function(y,x,w){}
...
,__ia:qx.core.Environment.select(l,{"true":function(E){var D=E.type;var F=qx.event.handler.Touch.MOUSE_TO_TOUCH_MAPPING;if(F[D]){D=F[D];if(D==n&&this.__ib(E)){this.__hY=true;}
else if(D==g){this.__hY=false;}
;var H=this.__ic(E);var G=(D==g?[]:[H]);E.touches=G;E.targetTouches=G;E.changedTouches=[H];}
;return D;}
,"default":(function(){}
)}),__ib:qx.core.Environment.select(l,{"true":function(J){if((qx.core.Environment.get(b)==h)){var I=1;}
else {var I=0;}
;return J.button==I;}
,"default":(function(){}
)}),__ic:qx.core.Environment.select(l,{"true":function(K){var L=this._getTarget(K);return {clientX:K.clientX,clientY:K.clientY,screenX:K.screenX,screenY:K.screenY,pageX:K.pageX,pageY:K.pageY,identifier:1,target:L};}
,"default":(function(){}
)}),_initMouseObserver:qx.core.Environment.select(l,{"true":function(){if(!qx.core.Environment.get(m)){this.__hX=qx.lang.Function.listener(this._onMouseEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,o,this.__hX);Event.addNativeListener(this.__a,p,this.__hX);Event.addNativeListener(this.__a,c,this.__hX);}
;}
,"default":(function(){}
)}),_stopMouseObserver:qx.core.Environment.select(l,{"true":function(){if(!qx.core.Environment.get(m)){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,o,this.__hX);Event.removeNativeListener(this.__a,p,this.__hX);Event.removeNativeListener(this.__a,c,this.__hX);}
;}
,"default":(function(){}
)}),_onTouchEvent:qx.event.GlobalError.observeMethod(function(M){this._commonTouchEventHandler(M);}
),_onMouseEvent:qx.core.Environment.select(l,{"true":qx.event.GlobalError.observeMethod(function(O){if(!qx.core.Environment.get(m)){if(O.type==p&&!this.__hY){return;}
;var N=this.__ia(O);this._commonTouchEventHandler(O,N);}
;}
),"default":(function(){}
)}),dispose:function(){this.__id(k);this._stopMouseObserver();this.__gz=this.__cx=this.__a=null;}
,__id:function(Q,P){qx.event.handler.TouchCore.prototype[Q].apply(this,P||[]);}
...
(function(){var a="touchmove",b="os.name",c="mouseup",d="mousedown",f="touchend",g="win",h="none",i="qx.event.handler.MouseEmulation",j="event.mspointer",k="qx.emulatemouse",l="longtap",m="click",n="event.touch",o="touchstart",p="contextmenu",q="tap",r="device.touch",s="mousewheel",t="mousemove";qx.Class.define(i,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(u){qx.core.Object.call(this);this.__gz=u;this.__cx=u.getWindow();this.__a=this.__cx.document;if(qx.event.handler.MouseEmulation.ON){this._initObserver();document.documentElement.style.msTouchAction=h;}
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST,SUPPORTED_TYPES:{mousedown:1,mouseup:1,mousemove:1,click:1,contextmenu:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT+qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true,ON:qx.core.Environment.get(k)&&((qx.core.Environment.get(j)&&qx.core.Environment.get(r))||(qx.core.Environment.get(n)&&qx.core.Environment.get(b)!==g))},members:{__gz:null,__cx:null,__a:null,__ie:null,__if:null,__ig:null,canHandleEvent:function(w,v){}
,registerEvent:function(z,y,x){}
,unregisterEvent:function(C,B,A){}
,__hq:function(D,E,F){var G=E==s?new qx.event.type.MouseWheel():new qx.event.type.Mouse();G.init(D,F,null,true,true);G.setType(E);return qx.event.Registration.getManager(F).dispatchEvent(F,G);}
,__ih:function(H,I,J,K){var L=this.__iq(K,J);L.wheelDelta=H;L.wheelDeltaY=I;L.wheelDeltaX=H;this.__hq(L,s,K);}
,__ii:function(N,O,Q,M,R){this.__ig=null;if(N==0&&O==0){return;}
;var S=parseInt((R||20)/10);if(N>0){N=Math.max(0,N-S);}
else {N=Math.min(0,N+S);}
;if(O>0){O=Math.max(0,O-S);}
else {O=Math.min(0,O+S);}
;var P=+(new Date());qx.bom.AnimationFrame.request(qx.lang.Function.bind(function(T,U,X,W,V){this.__ii(T,U,X,W,V-P);}
,this,N,O,Q,M));this.__ih(N,O,Q,M);}
,__ij:function(Y){var bb={x:Y.screenX,y:Y.screenY};var ba=false;var bc=20;if(Math.abs(bb.x-this.__ie.x)>bc){ba=true;}
;if(Math.abs(bb.y-this.__ie.y)>bc){ba=true;}
;return ba;}
,_initObserver:function(){qx.event.Registration.addListener(this.__a,o,this.__il,this);qx.event.Registration.addListener(this.__a,a,this.__im,this);qx.event.Registration.addListener(this.__a,f,this.__in,this);qx.event.Registration.addListener(this.__a,q,this.__io,this);qx.event.Registration.addListener(this.__a,l,this.__ip,this);qx.bom.Event.addNativeListener(this.__cx,o,this.__ik);}
,_stopObserver:function(){qx.event.Registration.removeListener(this.__a,o,this.__il,this);qx.event.Registration.removeListener(this.__a,a,this.__im,this);qx.event.Registration.removeListener(this.__a,f,this.__in,this);qx.event.Registration.removeListener(this.__a,q,this.__io,this);qx.event.Registration.removeListener(this.__a,l,this.__ip,this);qx.bom.Event.removeNativeListener(this.__cx,o,this.__ik);}
,__ik:function(e){e.preventDefault();}
,__il:function(e){var be=e.getTarget();var bd=this.__iq(be,e.getAllTouches()[0]);if(qx.core.Environment.get(n)){if(!this.__hq(bd,d,be)){e.preventDefault();}
;}
;this.__if={x:bd.screenX,y:bd.screenY};this.__ie={x:bd.screenX,y:bd.screenY};}
,__im:function(e){var bf=e.getTarget();var bi=this.__iq(bf,e.getChangedTargetTouches()[0]);if(qx.core.Environment.get(n)){if(!this.__hq(bi,t,bf)){e.preventDefault();}
;}
;var bh=-parseInt(this.__if.y-bi.screenY);var bg=-parseInt(this.__if.x-bi.screenX);this.__if={x:bi.screenX,y:bi.screenY};if(e.getNativeEvent().pointerType!=4){var bj=e.getChangedTargetTouches()[0];this.__ih(bg,bh,bj,bf);if(this.__ig){clearTimeout(this.__ig);this.__ig=null;}
;this.__ig=setTimeout(qx.lang.Function.bind(function(bk,bl,bm,bn){this.__ii(bk,bl,bm,bn);}
,this,bg,bh,bj,bf),100);}
;}
,__in:function(e){var bp=e.getTarget();var bo=this.__iq(bp,e.getChangedTargetTouches()[0]);if(qx.core.Environment.get(n)){if(!this.__hq(bo,c,bp)){e.preventDefault();}
;}
;}
,__io:function(e){var br=e.getTarget();var bq=this.__iq(br,e.getChangedTargetTouches()[0]);if(!this.__ij(bq)){this.__hq(bq,m,br);}
;}
,__ip:function(e){var bt=e.getTarget();var bs=this.__iq(bt,e.getChangedTargetTouches()[0]);this.__hq(bs,p,bt);}
,__iq:function(bv,bw){var bu={};bu.button=0;bu.wheelDelta=0;bu.wheelDeltaX=0;bu.wheelDeltaY=0;bu.wheelX=0;bu.wheelY=0;bu.target=bv;bu.clientX=bw.clientX;bu.clientY=bw.clientY;bu.pageX=bw.pageX;bu.pageY=bw.pageY;bu.screenX=bw.screenX;bu.screenY=bw.screenY;bu.shiftKey=false;bu.ctrlKey=false;bu.altKey=false;bu.metaKey=false;return bu;}
},destruct:function(){if(qx.event.handler.MouseEmulation.ON){this._stopObserver();}
;this.__gz=this.__cx=this.__a=null;}
...
,__ir:{'0':g,'2':h,'1':b},__is:{'1':g,'2':h,'4':b},stop:function(){this.stopPropagation();}
...
;default:if(this._native.target!==undefined){return this.__ir[this._native.button]||c;}
else {return this.__is[this._native.button]||c;}
;};}
...
,__it:function(p){var m=Math.abs(p);if(qx.event.type.MouseWheel.MINSCROLL==null||qx.event.type.MouseWheel.MINSCROLL>m){qx.event.type.MouseWheel.MINSCROLL=m;this.__iu();}
;if(qx.event.type.MouseWheel.MAXSCROLL==null||qx.event.type.MouseWheel.MAXSCROLL<m){qx.event.type.MouseWheel.MAXSCROLL=m;this.__iu();}
...
,__iu:function(){var q=qx.event.type.MouseWheel.MAXSCROLL||0;var t=qx.event.type.MouseWheel.MINSCROLL||q;if(q<=t){return;}
...
;}
;return this.__iv(v);}
;if(u===b){var x=0;if(e.wheelDelta!==undefined){if(e.wheelDeltaX!==undefined){x=e.wheelDeltaX?this.__iv(-e.wheelDeltaX):0;}
;}
else {if(e.axis&&e.axis==e.HORIZONTAL_AXIS){x=this.__iv(e.detail);}
;}
;return x;}
;if(u===l){var y=0;if(e.wheelDelta!==undefined){if(e.wheelDeltaY!==undefined){y=e.wheelDeltaY?this.__iv(-e.wheelDeltaY):0;}
else {y=this.__iv(-e.wheelDelta);}
;}
else {if(!(e.axis&&e.axis==e.HORIZONTAL_AXIS)){y=this.__iv(e.detail);}
;}
;return y;}
;return 0;}
,__iv:function(z){if(qx.event.handler.MouseEmulation.ON){return z;}
else if(qx.core.Environment.get(g)){return this.__it(z);}
...
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{keyup:1,keydown:1,keypress:1,keyinput:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true},members:{__ix:null,__gz:null,__cx:null,__a:null,__iw:null,__iy:null,__iz:null,__iA:null,canHandleEvent:function(s,r){}
,registerEvent:function(v,u,t){}
,unregisterEvent:function(y,x,w){}
,_fireInputEvent:function(A,z){var B=this.__iB();if(B&&B.offsetWidth!=0){var event=qx.event.Registration.createEvent(g,qx.event.type.KeyInput,[A,B,z]);this.__gz.dispatchEvent(B,event);}
...
;}
,__iB:function(){var H=this.__gz.getHandler(qx.event.handler.Focus);var I=H.getActive();if(!I||I.offsetWidth==0){I=H.getFocus();}
;if(!I||I.offsetWidth==0){I=this.__gz.getWindow().document.body;}
;return I;}
,_initKeyObserver:function(){this.__ix=qx.lang.Function.listener(this.__iC,this);this.__iA=qx.lang.Function.listener(this.__iE,this);var Event=qx.bom.Event;Event.addNativeListener(this.__a,o,this.__ix);Event.addNativeListener(this.__a,m,this.__ix);Event.addNativeListener(this.__a,c,this.__iA);}
,_stopKeyObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__a,o,this.__ix);Event.removeNativeListener(this.__a,m,this.__ix);Event.removeNativeListener(this.__a,c,this.__iA);for(var K in (this.__iz||{})){var J=this.__iz[K];Event.removeNativeListener(J.target,c,J.callback);}
;delete (this.__iz);}
...
},destruct:function(){this._stopKeyObserver();this.__iy=this.__gz=this.__cx=this.__a=this.__iw=null;}
...
;}
,tryActivate:function(Y){var X=this.__jf(Y);if(X){this.setActive(X);}
;}
,__hq:function(ba,bc,bf,be){var bd=qx.event.Registration;var bb=bd.createEvent(bf,qx.event.type.Focus,[ba,bc,be]);bd.dispatchEvent(ba,bb);}
,_windowFocused:true,__iR:function(){if(this._windowFocused){this._windowFocused=false;this.__hq(this._window,null,b,false);}
;}
,__iS:function(){if(!this._windowFocused){this._windowFocused=true;this.__hq(this._window,null,d,false);}
;}
,_initObserver:qx.core.Environment.select(w,{"gecko":function(){this.__iH=qx.lang.Function.listener(this.__iY,this);this.__iI=qx.lang.Function.listener(this.__ja,this);this.__iJ=qx.lang.Function.listener(this.__iX,this);this.__iK=qx.lang.Function.listener(this.__iW,this);this.__iL=qx.lang.Function.listener(this.__iT,this);qx.bom.Event.addNativeListener(this._document,this.__iF,this.__iH,true);qx.bom.Event.addNativeListener(this._document,this.__iG,this.__iI,true);qx.bom.Event.addNativeListener(this._window,d,this.__iJ,true);qx.bom.Event.addNativeListener(this._window,b,this.__iK,true);qx.bom.Event.addNativeListener(this._window,D,this.__iL,true);}
,"mshtml":function(){this.__iH=qx.lang.Function.listener(this.__iY,this);this.__iI=qx.lang.Function.listener(this.__ja,this);this.__iN=qx.lang.Function.listener(this.__iU,this);this.__iO=qx.lang.Function.listener(this.__iV,this);this.__iM=qx.lang.Function.listener(this.__jc,this);qx.bom.Event.addNativeListener(this._document,this.__iF,this.__iH);qx.bom.Event.addNativeListener(this._document,this.__iG,this.__iI);qx.bom.Event.addNativeListener(this._document,u,this.__iN);qx.bom.Event.addNativeListener(this._document,z,this.__iO);qx.bom.Event.addNativeListener(this._document,a,this.__iM);}
,"webkit":function(){this.__iH=qx.lang.Function.listener(this.__iY,this);this.__iI=qx.lang.Function.listener(this.__ja,this);this.__iO=qx.lang.Function.listener(this.__iV,this);this.__iJ=qx.lang.Function.listener(this.__iX,this);this.__iK=qx.lang.Function.listener(this.__iW,this);this.__iM=qx.lang.Function.listener(this.__jc,this);qx.bom.Event.addNativeListener(this._document,this.__iF,this.__iH,true);qx.bom.Event.addNativeListener(this._document,this.__iG,this.__iI,true);qx.bom.Event.addNativeListener(this._document,a,this.__iM,false);qx.bom.Event.addNativeListener(this._window,y,this.__iO,true);qx.bom.Event.addNativeListener(this._window,d,this.__iJ,true);qx.bom.Event.addNativeListener(this._window,b,this.__iK,true);}
,"opera":function(){this.__iH=qx.lang.Function.listener(this.__iY,this);this.__iI=qx.lang.Function.listener(this.__ja,this);this.__iN=qx.lang.Function.listener(this.__iU,this);this.__iO=qx.lang.Function.listener(this.__iV,this);qx.bom.Event.addNativeListener(this._document,this.__iF,this.__iH,true);qx.bom.Event.addNativeListener(this._document,this.__iG,this.__iI,true);qx.bom.Event.addNativeListener(this._window,g,this.__iN,true);qx.bom.Event.addNativeListener(this._window,y,this.__iO,true);}
}),_stopObserver:qx.core.Environment.select(w,{"gecko":function(){qx.bom.Event.removeNativeListener(this._document,this.__iF,this.__iH,true);qx.bom.Event.removeNativeListener(this._document,this.__iG,this.__iI,true);qx.bom.Event.removeNativeListener(this._window,d,this.__iJ,true);qx.bom.Event.removeNativeListener(this._window,b,this.__iK,true);qx.bom.Event.removeNativeListener(this._window,D,this.__iL,true);}
,"mshtml":function(){qx.bom.Event.removeNativeListener(this._document,this.__iF,this.__iH);qx.bom.Event.removeNativeListener(this._document,this.__iG,this.__iI);qx.bom.Event.removeNativeListener(this._document,u,this.__iN);qx.bom.Event.removeNativeListener(this._document,z,this.__iO);qx.bom.Event.removeNativeListener(this._document,a,this.__iM);}
,"webkit":function(){qx.bom.Event.removeNativeListener(this._document,this.__iF,this.__iH,true);qx.bom.Event.removeNativeListener(this._document,this.__iG,this.__iI,true);qx.bom.Event.removeNativeListener(this._document,a,this.__iM,false);qx.bom.Event.removeNativeListener(this._window,y,this.__iO,true);qx.bom.Event.removeNativeListener(this._window,d,this.__iJ,true);qx.bom.Event.removeNativeListener(this._window,b,this.__iK,true);}
,"opera":function(){qx.bom.Event.removeNativeListener(this._document,this.__iF,this.__iH,true);qx.bom.Event.removeNativeListener(this._document,this.__iG,this.__iI,true);qx.bom.Event.removeNativeListener(this._window,g,this.__iN,true);qx.bom.Event.removeNativeListener(this._window,y,this.__iO,true);}
}),__iT:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"gecko":function(bg){var bh=qx.bom.Event.getTarget(bg);if(!this.__jg(bh)){qx.bom.Event.preventDefault(bg);}
;}
,"default":null})),__iU:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml":function(bj){this.__iS();var bk=qx.bom.Event.getTarget(bj);var bi=this.__je(bk);if(bi){this.setFocus(bi);}
;this.tryActivate(bk);}
,"opera":function(bl){var bm=qx.bom.Event.getTarget(bl);if(bm==this._document||bm==this._window){this.__iS();if(this.__iP){this.setFocus(this.__iP);delete this.__iP;}
;if(this.__iQ){this.setActive(this.__iQ);delete this.__iQ;}
;}
else {this.setFocus(bm);this.tryActivate(bm);if(!this.__jg(bm)){bm.selectionStart=0;bm.selectionEnd=0;}
;}
;}
,"default":null})),__iV:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml":function(bn){var bo=qx.bom.Event.getRelatedTarget(bn);if(bo==null){this.__iR();this.resetFocus();this.resetActive();}
;}
...
;}
,"opera":function(br){var bs=qx.bom.Event.getTarget(br);if(bs==this._document){this.__iR();this.__iP=this.getFocus();this.__iQ=this.getActive();this.resetFocus();this.resetActive();}
else {if(bs===this.getFocus()){this.resetFocus();}
;if(bs===this.getActive()){this.resetActive();}
;}
;}
,"default":null})),__iW:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"gecko":function(bt){var bu=qx.bom.Event.getTarget(bt);if(bu===this._window||bu===this._document){this.__iR();this.resetActive();this.resetFocus();}
;}
,"webkit":function(bv){var bw=qx.bom.Event.getTarget(bv);if(bw===this._window||bw===this._document){this.__iR();this.__iP=this.getFocus();this.__iQ=this.getActive();this.resetActive();this.resetFocus();}
;}
,"default":null})),__iX:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"gecko":function(bx){var by=qx.bom.Event.getTarget(bx);if(by===this._window||by===this._document){this.__iS();by=this._body;}
;this.setFocus(by);this.tryActivate(by);}
,"webkit":function(bz){var bA=qx.bom.Event.getTarget(bz);if(bA===this._window||bA===this._document){this.__iS();if(this.__iP){this.setFocus(this.__iP);delete this.__iP;}
;if(this.__iQ){this.setActive(this.__iQ);delete this.__iQ;}
;}
else {this.setFocus(bA);this.tryActivate(bA);}
;}
,"default":null})),__iY:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml":function(bC){var bD=qx.bom.Event.getTarget(bC);var bB=this.__je(bD);if(bB){if(!this.__jg(bD)){bD.unselectable=B;try{document.selection.empty();}
catch(bE){}
;try{bB.focus();}
catch(bF){}
;}
;}
else {qx.bom.Event.preventDefault(bC);if(!this.__jg(bD)){bD.unselectable=B;}
;}
;}
,"webkit|gecko":function(bH){var bI=qx.bom.Event.getTarget(bH);var bG=this.__je(bI);if(bG){this.setFocus(bG);if(qx.core.Environment.get(n)&&qx.event.handler.MouseEmulation.ON){try{if(document.activeElement==bG){bG.blur();}
;bG.focus();}
catch(bJ){}
;}
;}
...
;}
,"opera":function(bM){var bN=qx.bom.Event.getTarget(bM);var bK=this.__je(bN);if(!this.__jg(bN)){qx.bom.Event.preventDefault(bM);if(bK){var bL=this.getFocus();if(bL&&bL.selectionEnd){bL.selectionStart=0;bL.selectionEnd=0;bL.blur();}
;if(bK){this.setFocus(bK);}
;}
;}
else if(bK){this.setFocus(bK);}
;}
,"default":null})),__ja:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml":function(bO){var bP=qx.bom.Event.getTarget(bO);if(bP.unselectable){bP.unselectable=r;}
;this.tryActivate(this.__jb(bP));}
...
;}
,"webkit|opera":function(bS){var bT=qx.bom.Event.getTarget(bS);this.tryActivate(this.__jb(bT));}
,"default":null})),__jb:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml|webkit":function(bU){var bV=this.getFocus();if(bV&&bU!=bV&&(bV.nodeName.toLowerCase()===m||bV.nodeName.toLowerCase()===i)){bU=bV;}
;return bU;}
,"default":function(bW){return bW;}
})),__jc:qx.event.GlobalError.observeMethod(qx.core.Environment.select(w,{"mshtml|webkit":function(bX){var bY=qx.bom.Event.getTarget(bX);if(!this.__jg(bY)){qx.bom.Event.preventDefault(bX);}
;}
,"default":null})),__jd:function(ca){var cb=qx.bom.element.Attribute.get(ca,q);if(cb>=1){return true;}
;var cc=qx.event.handler.Focus.FOCUSABLE_ELEMENTS;if(cb>=0&&cc[ca.tagName]){return true;}
;return false;}
,__je:function(cd){while(cd&&cd.nodeType===1){if(cd.getAttribute(A)==B){return null;}
;if(this.__jd(cd)){return cd;}
;cd=cd.parentNode;}
;return this._body;}
,__jf:function(ce){var cf=ce;while(ce&&ce.nodeType===1){if(ce.getAttribute(C)==B){return null;}
;ce=ce.parentNode;}
;return cf;}
,__jg:function(cg){while(cg&&cg.nodeType===1){var ch=cg.getAttribute(p);if(ch!=null){return ch===B;}
;cg=cg.parentNode;}
;return true;}
,_applyActive:function(cj,ci){if(ci){this.__hq(ci,cj,h,true);}
;if(cj){this.__hq(cj,ci,t,true);}
;}
,_applyFocus:function(cl,ck){if(ck){this.__hq(ck,cl,z,true);}
;if(cl){this.__hq(cl,ck,u,true);}
;if(ck){this.__hq(ck,cl,b,false);}
;if(cl){this.__hq(cl,ck,d,false);}
;}
},destruct:function(){this._stopObserver();this._manager=this._window=this._document=this._root=this._body=this.__jh=null;}
...
,"default":function(t){if(this.__ji(t)){return t.value.substring(t.selectionStart,t.selectionEnd);}
...
,"default":function(x){if(qx.core.Environment.get(a)==k){var B,C,A;if(this.__ji(x)){var z=x.selectionStart;var y=x.selectionEnd;B=x.value.substring(z,y);C=y-z;}
else {B=qx.bom.Selection.get(x);C=B.length;}
;A=qx.util.StringSplit.split(B,/\r\n/);return C-(A.length-1);}
;if(this.__ji(x)){return x.selectionEnd-x.selectionStart;}
else {return this.get(x).length;}
;}
}),getStart:qx.core.Environment.select(m,{"selection":function(D){if(this.__ji(D)){var I=qx.bom.Range.get();if(!D.contains(I.parentElement())){return -1;}
...
;return  ++L;}
;}
,"default":function(N){if(qx.core.Environment.get(a)===i||qx.core.Environment.get(a)===g){if(this.__ji(N)){return N.selectionStart;}
...
;}
;}
;if(this.__ji(N)){return N.selectionStart;}
else {return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(N)).anchorOffset;}
;}
}),getEnd:qx.core.Environment.select(m,{"selection":function(Q){if(this.__ji(Q)){var V=qx.bom.Range.get();if(!Q.contains(V.parentElement())){return -1;}
...
;return U-( ++Y);}
;}
,"default":function(bb){if(qx.core.Environment.get(a)===i||qx.core.Environment.get(a)===g){if(this.__ji(bb)){return bb.selectionEnd;}
...
;}
;}
;if(this.__ji(bb)){return bb.selectionEnd;}
else {return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(bb)).focusOffset;}
;}
}),__ji:function(be){return qx.dom.Node.isElement(be)&&(be.nodeName.toLowerCase()==h||be.nodeName.toLowerCase()==n);}
...
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{input:1,change:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__jj:false,__jk:null,__jl:null,__jm:null,canHandleEvent:function(D,C){var B=D.tagName.toLowerCase();if(C===n&&(B===n||B===g)){return true;}
;if(C===m&&(B===n||B===g||B===q)){return true;}
;return false;}
,registerEvent:function(I,H,F){if(qx.core.Environment.get(w)==v&&(qx.core.Environment.get(c)<9||(qx.core.Environment.get(c)>=9&&qx.core.Environment.get(r)<9))){if(!I.__jn){var G=I.tagName.toLowerCase();var E=I.type;if(E===a||E===h||G===g||E===y||E===f){qx.bom.Event.addNativeListener(I,j,this._onPropertyWrapper);}
...
}),unregisterEvent:function(R,Q){if(qx.core.Environment.get(w)==v&&qx.core.Environment.get(c)<9&&qx.core.Environment.get(r)<9){if(R.__jn){var P=R.tagName.toLowerCase();var O=R.type;if(O===a||O===h||P===g||O===y||O===f){qx.bom.Event.removeNativeListener(R,j,this._onPropertyWrapper);}
...
;}
;}
,__jp:qx.core.Environment.select(w,{"mshtml":function(T){if(qx.core.Environment.get(c)>=9&&qx.core.Environment.get(r)>=9){qx.bom.Event.removeNativeListener(T,n,this._onInputWrapper);if(T.type===a||T.type===h||T.type===g){qx.bom.Event.removeNativeListener(T,u,this._inputFixWrapper);}
;}
;}
...
}),_onKeyPress:qx.core.Environment.select(w,{"mshtml|opera":function(e,Y){if(e.keyCode===13){if(Y.value!==this.__jl){this.__jl=Y.value;qx.event.Registration.fireEvent(Y,m,qx.event.type.Data,[Y.value]);}
;}
;}
,"default":null}),_inputFix:qx.core.Environment.select(w,{"mshtml":function(e,ba){if(e.keyCode===46||e.keyCode===8){if(ba.value!==this.__jm){this.__jm=ba.value;qx.event.Registration.fireEvent(ba,n,qx.event.type.Data,[ba.value]);}
;}
;}
,"default":null}),_onKeyDown:qx.core.Environment.select(w,{"opera":function(e){if(e.keyCode===13){this.__jj=true;}
;}
,"default":null}),_onKeyUp:qx.core.Environment.select(w,{"opera":function(e){if(e.keyCode===13){this.__jj=false;}
;}
,"default":null}),_onBlur:qx.core.Environment.select(w,{"opera":function(e){if(this.__jk&&qx.core.Environment.get(s)<10.6){window.clearTimeout(this.__jk);}
;}
,"default":null}),_onInput:qx.event.GlobalError.observeMethod(function(e){var bc=qx.bom.Event.getTarget(e);var bb=bc.tagName.toLowerCase();if(!this.__jj||bb!==n){if((qx.core.Environment.get(w)==t)&&qx.core.Environment.get(s)<10.6){this.__jk=window.setTimeout(function(){qx.event.Registration.fireEvent(bc,n,qx.event.type.Data,[bc.value]);}
,0);}
...
(function(){var a="blur",b="mousedown",c="qxDraggable",d="mouseout",f="Escape",g="drag",h="keydown",i="Unsupported data type: ",j="drop",k="qxDroppable",l="qx.event.handler.DragDrop",m="This method must not be used outside the drop event listener!",n="Control",o="Shift",p="!",q="mousemove",r="move",s="droprequest",t="copy",u="dragstart",v="alias",w="mouseover",x="dragchange",y="Alt",z="keyup",A="mouseup",B="keypress",C="dragleave",D="dragend",E="dragover",F="left",G="Please use a droprequest listener to the drag source to fill the manager with data!",H="on";qx.Class.define(l,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(I){qx.core.Object.call(this);this.__gz=I;this.__a=I.getWindow().document.documentElement;this.__gz.addListener(this.__a,b,this._onMouseDown,this);this.__jA();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1},IGNORE_CAN_HANDLE:true},members:{__gz:null,__a:null,__jq:null,__jr:null,__js:null,__jt:null,__ju:null,__d:null,__jv:null,__jw:null,__jx:false,__jy:0,__jz:0,canHandleEvent:function(K,J){}
,registerEvent:function(N,M,L){}
,unregisterEvent:function(Q,P,O){}
,addType:function(R){this.__js[R]=true;}
,addAction:function(S){this.__jt[S]=true;}
,supportsType:function(T){return !!this.__js[T];}
,supportsAction:function(U){return !!this.__jt[U];}
,getData:function(V){if(!this.__jG||!this.__jq){throw new Error(m);}
;if(!this.__js[V]){throw new Error(i+V+p);}
;if(!this.__d[V]){this.__jv=V;this.__hq(s,this.__jr,this.__jq,false);}
;if(!this.__d[V]){throw new Error(G);}
;return this.__d[V]||null;}
,getCurrentAction:function(){return this.__jw;}
,addData:function(W,X){this.__d[W]=X;}
,getCurrentType:function(){return this.__jv;}
,isSessionActive:function(){return this.__jx;}
,__jA:function(){this.__js={};this.__jt={};this.__ju={};this.__d={};}
,__jB:function(){if(this.__jr==null){return;}
;var bc=this.__jt;var Y=this.__ju;var ba=null;if(this.__jG){if(Y.Shift&&Y.Control&&bc.alias){ba=v;}
...
;}
;var bb=this.__jw;if(ba!=bb){if(this.__jq){this.__jw=ba;this.__jC=this.__hq(x,this.__jq,this.__jr,true);if(!this.__jC){ba=null;}
;}
;if(ba!=bb){this.__jw=ba;this.__hq(x,this.__jr,this.__jq,false);}
;}
;}
,__hq:function(bi,be,bf,bg,bj){var bh=qx.event.Registration;var bd=bh.createEvent(bi,qx.event.type.Drag,[bg,bj]);if(be!==bf){bd.setRelatedTarget(bf);}
;return bh.dispatchEvent(be,bd);}
,__jD:function(bk){while(bk&&bk.nodeType==1){if(bk.getAttribute(c)==H){return bk;}
;bk=bk.parentNode;}
;return null;}
,__jE:function(bl){while(bl&&bl.nodeType==1){if(bl.getAttribute(k)==H){return bl;}
;bl=bl.parentNode;}
;return null;}
,__jF:function(){this.__jr=null;this.__gz.removeListener(this.__a,q,this._onMouseMove,this,true);this.__gz.removeListener(this.__a,A,this._onMouseUp,this,true);qx.event.Registration.removeListener(window,a,this._onWindowBlur,this);this.__jA();}
,clearSession:function(){if(this.__jx){this.__gz.removeListener(this.__a,w,this._onMouseOver,this,true);this.__gz.removeListener(this.__a,d,this._onMouseOut,this,true);this.__gz.removeListener(this.__a,h,this._onKeyDown,this,true);this.__gz.removeListener(this.__a,z,this._onKeyUp,this,true);this.__gz.removeListener(this.__a,B,this._onKeyPress,this,true);this.__hq(D,this.__jr,this.__jq,false);this.__jx=false;}
;this.__jG=false;this.__jq=null;this.__jF();}
,__jG:false,__jC:false,_onWindowBlur:function(e){this.clearSession();}
,_onKeyDown:function(e){var bm=e.getKeyIdentifier();switch(bm){case y:case n:case o:if(!this.__ju[bm]){this.__ju[bm]=true;this.__jB();}
;};}
,_onKeyUp:function(e){var bn=e.getKeyIdentifier();switch(bn){case y:case n:case o:if(this.__ju[bn]){this.__ju[bn]=false;this.__jB();}
;};}
,_onKeyPress:function(e){var bo=e.getKeyIdentifier();switch(bo){case f:this.clearSession();};}
,_onMouseDown:function(e){if(this.__jx||e.getButton()!==F){return;}
;var bp=this.__jD(e.getTarget());if(bp){this.__jy=e.getDocumentLeft();this.__jz=e.getDocumentTop();this.__jr=bp;this.__gz.addListener(this.__a,q,this._onMouseMove,this,true);this.__gz.addListener(this.__a,A,this._onMouseUp,this,true);qx.event.Registration.addListener(window,a,this._onWindowBlur,this);}
;}
,_onMouseUp:function(e){if(this.__jG&&this.__jC){this.__hq(j,this.__jq,this.__jr,false,e);}
;if(this.__jx&&e.getTarget()==this.__jr){e.stopPropagation();this.__hp();}
;this.clearSession();}
,_onMouseMove:function(e){if(this.__jx){if(!this.__hq(g,this.__jr,this.__jq,true,e)){this.clearSession();}
;}
else {if(Math.abs(e.getDocumentLeft()-this.__jy)>3||Math.abs(e.getDocumentTop()-this.__jz)>3){if(this.__hq(u,this.__jr,this.__jq,true,e)){this.__jx=true;this.__gz.addListener(this.__a,w,this._onMouseOver,this,true);this.__gz.addListener(this.__a,d,this._onMouseOut,this,true);this.__gz.addListener(this.__a,h,this._onKeyDown,this,true);this.__gz.addListener(this.__a,z,this._onKeyUp,this,true);this.__gz.addListener(this.__a,B,this._onKeyPress,this,true);var bq=this.__ju;bq.Control=e.isCtrlPressed();bq.Shift=e.isShiftPressed();bq.Alt=e.isAltPressed();this.__jB();}
else {this.__hq(D,this.__jr,this.__jq,false);this.__jF();}
;}
;}
;}
...
;var bu=this.__jE(bt);if(bu&&bu!=this.__jq){this.__jG=this.__hq(E,bu,this.__jr,true,e);this.__jq=bu;this.__jB();}
;}
...
;var by=this.__jE(e.getTarget());var bx=this.__jE(e.getRelatedTarget());if(by&&by!==bx&&by==this.__jq){this.__hq(C,this.__jq,bx,false,e);this.__jq=null;this.__jG=false;qx.event.Timer.once(this.__jB,this,0);}
;}
,__hp:function(){var bz=qx.event.Registration.getManager(window).getHandler(qx.event.handler.Mouse);bz.preventNextClick();}
},destruct:function(){this.__jr=this.__jq=this.__gz=this.__a=this.__js=this.__jt=this.__ju=this.__d=null;}
...
(function(){var a="best-fit",b="placementRight",c="Boolean",d="bottom-right",e="' ",f="widget",g="placementLeft",h="qx.ui.core.MPlacement",i="left-top",j="Integer",k="left-middle",l="right-middle",m="top-center",n="[qx.ui.core.MPlacement.setMoveDirection()], the value was '",o="offsetRight",p="mouse",q="interval",r="keep-align",s="bottom-left",t="direct",u="shorthand",v="Invalid value for the parameter 'direction' ",w="offsetLeft",x="top-left",y="appear",z="offsetBottom",A="top",B="top-right",C="offsetTop",D="but 'top' or 'left' are allowed.",E="right-bottom",F="disappear",G="right-top",H="bottom-center",I="left-bottom",J="left";qx.Mixin.define(h,{statics:{__gL:null,__jH:J,setVisibleElement:function(K){this.__gL=K;}
,getVisibleElement:function(){return this.__gL;}
,setMoveDirection:function(L){if(L===A||L===J){this.__jH=L;}
else {throw new Error(v+n+L+e+D);}
;}
,getMoveDirection:function(){return this.__jH;}
},properties:{position:{check:[x,m,B,s,H,d,i,k,I,G,l,E],init:s,themeable:true},placeMethod:{check:[f,p],init:p,themeable:true},domMove:{check:c,init:false},placementModeX:{check:[t,r,a],init:r,themeable:true},placementModeY:{check:[t,r,a],init:r,themeable:true},offsetLeft:{check:j,init:0,themeable:true},offsetTop:{check:j,init:0,themeable:true},offsetRight:{check:j,init:0,themeable:true},offsetBottom:{check:j,init:0,themeable:true},offset:{group:[C,o,z,w],mode:u,themeable:true}},members:{__jI:null,__jJ:null,__jK:null,getLayoutLocation:function(N){var P,O,R,top;O=N.getBounds();if(!O){return null;}
...
;}
,placeToWidget:function(bc,ba){if(ba){this.__jL();this.__jI=qx.lang.Function.bind(this.placeToWidget,this,bc,false);qx.event.Idle.getInstance().addListener(q,this.__jI);this.__jK=function(){this.__jL();}
;this.addListener(F,this.__jK,this);}
;var bb=bc.getContentLocation()||this.getLayoutLocation(bc);if(bb!=null){this.__jN(bb);return true;}
else {return false;}
;}
,__jL:function(){if(this.__jI){qx.event.Idle.getInstance().removeListener(q,this.__jI);this.__jI=null;}
;if(this.__jK){this.removeListener(F,this.__jK,this);this.__jK=null;}
;}
,placeToMouse:function(event){var be=Math.round(event.getDocumentLeft());var top=Math.round(event.getDocumentTop());var bd={left:be,top:top,right:be,bottom:top};this.__jN(bd);}
,placeToElement:function(bh,bf){var location=qx.bom.element.Location.get(bh);var bg={left:location.left,top:location.top,right:location.left+bh.offsetWidth,bottom:location.top+bh.offsetHeight};if(bf){this.__jI=qx.lang.Function.bind(this.placeToElement,this,bh,false);qx.event.Idle.getInstance().addListener(q,this.__jI);this.addListener(F,function(){if(this.__jI){qx.event.Idle.getInstance().removeListener(q,this.__jI);this.__jI=null;}
;}
,this);}
;this.__jN(bg);}
,placeToPoint:function(bj){var bi={left:bj.left,top:bj.top,right:bj.left,bottom:bj.top};this.__jN(bi);}
,_getPlacementOffsets:function(){return {left:this.getOffsetLeft(),top:this.getOffsetTop(),right:this.getOffsetRight(),bottom:this.getOffsetBottom()};}
,__jM:function(bk){var bl=null;if(this._computePlacementSize){var bl=this._computePlacementSize();}
else if(this.isVisible()){var bl=this.getBounds();}
;if(bl==null){this.addListenerOnce(y,function(){this.__jM(bk);}
,this);}
else {bk.call(this,bl);}
;}
,__jN:function(bm){this.__jM(function(bo){var bn=qx.util.placement.Placement.compute(bo,this.getLayoutParent().getBounds(),bm,this._getPlacementOffsets(),this.getPosition(),this.getPlacementModeX(),this.getPlacementModeY());this.removeState(g);this.removeState(b);this.addState(bm.left<bn.left?b:g);this.moveTo(bn.left,bn.top);}
);}
},destruct:function(){this.__jL();}
});}
)();
(function(){var a="Number",b="interval",c="_applyTimeoutInterval",d="qx.event.type.Event",e="qx.event.Idle",f="singleton";qx.Class.define(e,{extend:qx.core.Object,type:f,construct:function(){qx.core.Object.call(this);var g=new qx.event.Timer(this.getTimeoutInterval());g.addListener(b,this._onInterval,this);g.start();this.__jO=g;}
,events:{"interval":d},properties:{timeoutInterval:{check:a,init:100,apply:c}},members:{__jO:null,_applyTimeoutInterval:function(h){this.__jO.setInterval(h);}
,_onInterval:function(){this.fireEvent(b);}
},destruct:function(){if(this.__jO){this.__jO.stop();}
;this.__jO=null;}
});}
)();
(function(){var a="-",b="best-fit",c="size",d="edge-start",e="target.bottom",f="offsets",g="size.width",h="bottom",i="offsets.bottom",j="qx.util.placement.Placement",k="Please use '",l="qx.debug",m="keep-align",n="center",o="target.right",p="direct",q="offsets.right",r="middle",s="target",t='__jP',u="align-start",v="Invalid 'mode' argument!'",w="left",x="align-end",y="Class",z="offsets.left",A="top",B="area",C="right",D="edge-end",E="target.top",F="area.height",G="target.left",H="align-center",I="area.width",J="' instead!",K="size.height",L="offsets.top";qx.Class.define(j,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__jP=qx.util.placement.DirectAxis;}
,properties:{axisX:{check:y},axisY:{check:y},edge:{check:[A,C,h,w],init:A},align:{check:[A,C,h,w,n,r],init:C}},statics:{__jQ:null,compute:function(W,P,M,N,V,Q,R){this.__jQ=this.__jQ||new qx.util.placement.Placement();var T=V.split(a);var S=T[0];var O=T[1];if(qx.core.Environment.get(l)){if(O===n||O===r){var U=r;if(S===A||S===h){U=n;}
;qx.core.Assert.assertEquals(U,O,k+S+a+U+J);}
;}
;this.__jQ.set({axisX:this.__jU(Q),axisY:this.__jU(R),edge:S,align:O});return this.__jQ.compute(W,P,M,N);}
,__jR:null,__jS:null,__jT:null,__jU:function(X){switch(X){case p:this.__jR=this.__jR||qx.util.placement.DirectAxis;return this.__jR;case m:this.__jS=this.__jS||qx.util.placement.KeepAlignAxis;return this.__jS;case b:this.__jT=this.__jT||qx.util.placement.BestFitAxis;return this.__jT;default:throw new Error(v);};}
},members:{__jP:null,compute:function(be,bb,Y,ba){if(qx.core.Environment.get(l)){this.assertObject(be,c);this.assertNumber(be.width,g);this.assertNumber(be.height,K);this.assertObject(bb,B);this.assertNumber(bb.width,I);this.assertNumber(bb.height,F);this.assertObject(Y,s);this.assertNumber(Y.top,E);this.assertNumber(Y.right,o);this.assertNumber(Y.bottom,e);this.assertNumber(Y.left,G);this.assertObject(ba,f);this.assertNumber(ba.top,L);this.assertNumber(ba.right,q);this.assertNumber(ba.bottom,i);this.assertNumber(ba.left,z);}
;var bc=this.getAxisX()||this.__jP;var bf=bc.computeStart(be.width,{start:Y.left,end:Y.right},{start:ba.left,end:ba.right},bb.width,this.__jV());var bd=this.getAxisY()||this.__jP;var top=bd.computeStart(be.height,{start:Y.top,end:Y.bottom},{start:ba.top,end:ba.bottom},bb.height,this.__jW());return {left:bf,top:top};}
,__jV:function(){var bh=this.getEdge();var bg=this.getAlign();if(bh==w){return d;}
else if(bh==C){return D;}
else if(bg==w){return u;}
else if(bg==n){return H;}
else if(bg==C){return x;}
;}
,__jW:function(){var bj=this.getEdge();var bi=this.getAlign();if(bj==A){return d;}
...
(function(){var a="backgroundColor",b="drag",c="_applyNativeContextMenu",d="div",f="_applyBackgroundColor",g="qx.event.type.Data",h="object",j="_applyFocusable",k=" requires a layout, but no one was defined!",m="qx.event.type.KeyInput",n="focused",o="disabled",p="move",q="createChildControl",r="Unsupported control: ",s="dragstart",t="Invalid left decorator inset detected: ",u="Font",v="qx.dynlocale",w="dragchange",x="Invalid layout data: ",y="Could not add widget to itself: ",z="_applyEnabled",A="_applySelectable",B="Number",C="_applyKeepActive",D="dragend",E="_applyVisibility",F="The 'before' widget is not a child of this widget!",G="Child control '",H="qxDraggable",I="syncAppearance",J='" while styling ',K="paddingLeft",L="' of widget ",M="qx.event.type.Mouse",N="Wrong 'left' argument. ",O="_applyPadding",P="__kd",Q="#",R="'Child' must be an instance of qx.ui.core.LayoutItem!",S="Remove Error: ",T="visible",U="qx.event.type.Event",V="qx.event.type.MouseWheel",W="_applyCursor",X="changeVisibility",Y="_applyDraggable",cX="resize",cY="Decorator",da="At least one child in control ",cT="zIndex",cU="changeTextColor",cV="$$widget",cW="changeContextMenu",df="on",dg="paddingTop",dh="opacity",di="This widget has no children!",db="The 'after' widget is not a child of this widget!",dc="changeSelectable",dd="Invalid top decorator inset detected: ",de="none",dm="outline",dO="hidden",eO="Please use 'getContentElement' instead.",dn="_applyAppearance",dj=" returned an invalid size hint!",dk="hovered",eK="_applyOpacity",dl="Boolean",dp="px",dq="__jX",dr="qx.ui.core.Widget",dw="default",dx="minHeight is larger than maxHeight!",dy="TabIndex property must be between 1 and 32000",ds="_applyFont",dt="cursor",du="qxDroppable",dv="' already created!",dC="__kf",dD="changeZIndex",dE=": ",dF="Color",dz="changeEnabled",dA="Please use 'getContentLocation' instead.",eL="Abstract method call: _getContentHeightForWidth()!",dB="changeFont",dJ="qx.event.type.Focus",dK="_applyDecorator",eN="_applyZIndex",dL="_applyTextColor",dG=' has no themeable property "',dH="Widget is not focusable!",eM="qx.ui.menu.Menu",dI="engine.name",dM="qx.event.type.Drag",dN="Invalid right decorator inset detected: ",ea="Invalid widget to add: ",dY="qx.event.type.KeySequence",dX="excluded",ee="DOM element is not yet created!",ed="_applyToolTipText",ec="The layout of the widget",eb="Exception while creating child control '",dS="_applyDroppable",dR=" is not a child of this widget!",dQ="widget",dP="Wrong 'top' argument. ",dW="qxClass",dV="changeDecorator",dU="qx.event.type.Tap",dT="Integer",em="changeBackgroundColor",ek="_applyTabIndex",ej="Invalid bottom decorator inset detected: ",ei="changeAppearance",eq="qx.debug",ep="shorthand",eo="/",en="String",eh="border-box",eg="",ef="_applyContextMenu",eB="changeToolTipText",eA="padding",ez="tabIndex",eF="paddingBottom",eE="beforeContextmenuOpen",eD="changeNativeContextMenu",eC="undefined",eu="qx.ui.tooltip.ToolTip",et="contextmenu",es="_applyKeepFocus",er="paddingRight",ey="minWidth is larger than maxWidth!",ex="changeLocale",ew="qxKeepFocus",ev="__kc",eJ="opera",eI="qx.event.type.Touch",eH="qxKeepActive",eG="absolute";qx.Class.define(dr,{extend:qx.ui.core.LayoutItem,include:[qx.locale.MTranslation],construct:function(){qx.ui.core.LayoutItem.call(this);this.__jX=this.__ke();this.initFocusable();this.initSelectable();this.initNativeContextMenu();}
,events:{appear:U,disappear:U,createChildControl:g,resize:g,move:g,syncAppearance:g,mousemove:M,mouseover:M,mouseout:M,mousedown:M,mouseup:M,click:M,dblclick:M,contextmenu:M,beforeContextmenuOpen:g,mousewheel:V,touchstart:eI,touchend:eI,touchmove:eI,touchcancel:eI,tap:dU,longtap:dU,swipe:eI,keyup:dY,keydown:dY,keypress:dY,keyinput:m,focus:dJ,blur:dJ,focusin:dJ,focusout:dJ,activate:dJ,deactivate:dJ,capture:U,losecapture:U,drop:dM,dragleave:dM,dragover:dM,drag:dM,dragstart:dM,dragend:dM,dragchange:dM,droprequest:dM},properties:{paddingTop:{check:dT,init:0,apply:O,themeable:true},paddingRight:{check:dT,init:0,apply:O,themeable:true},paddingBottom:{check:dT,init:0,apply:O,themeable:true},paddingLeft:{check:dT,init:0,apply:O,themeable:true},padding:{group:[dg,er,eF,K],mode:ep,themeable:true},zIndex:{nullable:true,init:10,apply:eN,event:dD,check:dT,themeable:true},decorator:{nullable:true,init:null,apply:dK,event:dV,check:cY,themeable:true},backgroundColor:{nullable:true,check:dF,apply:f,event:em,themeable:true},textColor:{nullable:true,check:dF,apply:dL,event:cU,themeable:true,inheritable:true},font:{nullable:true,apply:ds,check:u,event:dB,themeable:true,inheritable:true,dereference:true},opacity:{check:B,apply:eK,themeable:true,nullable:true,init:null},cursor:{check:en,apply:W,themeable:true,inheritable:true,nullable:true,init:null},toolTip:{check:eu,nullable:true},toolTipText:{check:en,nullable:true,event:eB,apply:ed},toolTipIcon:{check:en,nullable:true,event:eB},blockToolTip:{check:dl,init:false},visibility:{check:[T,dO,dX],init:T,apply:E,event:X},enabled:{init:true,check:dl,inheritable:true,apply:z,event:dz},anonymous:{init:false,check:dl},tabIndex:{check:dT,nullable:true,apply:ek},focusable:{check:dl,init:false,apply:j},keepFocus:{check:dl,init:false,apply:es},keepActive:{check:dl,init:false,apply:C},draggable:{check:dl,init:false,apply:Y},droppable:{check:dl,init:false,apply:dS},selectable:{check:dl,init:false,event:dc,apply:A},contextMenu:{check:eM,apply:ef,nullable:true,event:cW},nativeContextMenu:{check:dl,init:false,themeable:true,event:eD,apply:c},appearance:{check:en,init:dQ,apply:dn,event:ei}},statics:{DEBUG:false,getWidgetByElement:function(eS,eQ){while(eS){var eP=eS.$$widget;if(eP!=null){var eR=qx.core.ObjectRegistry.fromHashCode(eP);if(!eQ||!eR.getAnonymous()){return eR;}
;}
...
;return false;}
,__jY:new qx.util.ObjectPool()},members:{__jX:null,__ka:null,__kb:null,__kc:null,_getLayout:function(){return this.__kc;}
,_setLayout:function(eU){if(qx.core.Environment.get(eq)){if(eU){this.assertInstance(eU,qx.ui.layout.Abstract);}
;}
;if(this.__kc){this.__kc.connectToWidget(null);}
;if(eU){eU.connectToWidget(this);}
;this.__kc=eU;qx.ui.core.queue.Layout.add(this);}
,setLayoutParent:function(parent){if(this.$$parent===parent){return;}
...
;var content=this.getContentElement();var fg=fd.size||this._updateInsets;var fe=dp;var eV={};if(fd.position){eV.left=fc+fe;eV.top=top+fe;}
;if(fg||fd.margin){eV.width=eY+fe;eV.height=eW+fe;}
;if(Object.keys(eV).length>0){content.setStyles(eV);}
;if(fg||fd.local||fd.margin){if(this.__kc&&this.hasLayoutChildren()){var fb=this.getInsets();var innerWidth=eY-fb.left-fb.right;var innerHeight=eW-fb.top-fb.bottom;var ff=this.getDecorator();var fa={left:0,right:0,top:0,bottom:0};if(ff){ff=qx.theme.manager.Decoration.getInstance().resolve(ff);fa=ff.getPadding();}
;var eX={top:this.getPaddingTop()+fa.top,right:this.getPaddingRight()+fa.right,bottom:this.getPaddingBottom()+fa.bottom,left:this.getPaddingLeft()+fa.left};this.__kc.renderLayout(innerWidth,innerHeight,eX);}
...
,__kd:null,clearSeparators:function(){var fi=this.__kd;if(!fi){return;}
;var fj=qx.ui.core.Widget.__jY;var content=this.getContentElement();var fh;for(var i=0,l=fi.length;i<l;i++ ){fh=fi[i];fj.poolObject(fh);content.remove(fh.getContentElement());}
;fi.length=0;}
,renderSeparator:function(fl,fm){var fk=qx.ui.core.Widget.__jY.getObject(qx.ui.core.Widget);fk.set({decorator:fl});var fo=fk.getContentElement();this.getContentElement().add(fo);var fn=fo.getDomElement();if(fn){fn.style.top=fm.top+dp;fn.style.left=fm.left+dp;fn.style.width=fm.width+dp;fn.style.height=fm.height+dp;}
else {fo.setStyles({left:fm.left+dp,top:fm.top+dp,width:fm.width+dp,height:fm.height+dp});}
;if(!this.__kd){this.__kd=[];}
;this.__kd.push(fk);}
,_computeSizeHint:function(){var fv=this.getWidth();var fp=this.getMinWidth();var fq=this.getMaxWidth();var ft=this.getHeight();var fr=this.getMinHeight();var fs=this.getMaxHeight();if(qx.core.Environment.get(eq)){if(fp!==null&&fq!==null){this.assert(fp<=fq,ey);}
...
,invalidateLayoutCache:function(){qx.ui.core.LayoutItem.prototype.invalidateLayoutCache.call(this);if(this.__kc){this.__kc.invalidateLayoutCache();}
;}
,_getContentHint:function(){var fA=this.__kc;if(fA){if(this.hasLayoutChildren()){var fB=fA.getSizeHint();if(qx.core.Environment.get(eq)){var fz=ec+this.toString()+dj;this.assertInteger(fB.width,N+fz);this.assertInteger(fB.height,dP+fz);}
;return fB;}
...
,getInsets:function(){var top=this.getPaddingTop();var fL=this.getPaddingRight();var fM=this.getPaddingBottom();var fP=this.getPaddingLeft();if(this.getDecorator()){var fO=qx.theme.manager.Decoration.getInstance().resolve(this.getDecorator());var fN=fO.getInsets();if(qx.core.Environment.get(eq)){this.assertNumber(fN.top,dd+fN.top);this.assertNumber(fN.right,dN+fN.right);this.assertNumber(fN.bottom,ej+fN.bottom);this.assertNumber(fN.left,t+fN.left);}
...
,hide:function(){this.setVisibility(dO);}
...
;return false;}
,__ke:function(){var fW=this._createContentElement();fW.setAttribute(cV,this.toHashCode());if(qx.core.Environment.get(eq)){fW.setAttribute(dW,this.classname);}
;var fV={"zIndex":10,"boxSizing":eh};if(!qx.ui.root.Inline||!(this instanceof qx.ui.root.Inline)){fV.position=eG;}
;fW.setStyles(fV);return fW;}
,_createContentElement:function(){return new qx.html.Element(d,{overflowX:dO,overflowY:dO});}
,getContainerElement:function(){if(qx.core.Environment.get(eq)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,eO);}
;return this.__jX;}
,getContentElement:function(){return this.__jX;}
,__kf:null,getLayoutChildren:function(){var fY=this.__kf;if(!fY){return this.__kg;}
...
;return ga||fY;}
,scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);}
,invalidateLayoutChildren:function(){var gb=this.__kc;if(gb){gb.invalidateChildrenCache();}
;qx.ui.core.queue.Layout.add(this);}
,hasLayoutChildren:function(){var gd=this.__kf;if(!gd){return false;}
;var gc;for(var i=0,l=gd.length;i<l;i++ ){gc=gd[i];if(!gc.hasUserBounds()&&!gc.isExcluded()){return true;}
;}
;return false;}
,getChildrenContainer:function(){return this;}
,__kg:[],_getChildren:function(){return this.__kf||this.__kg;}
,_indexOf:function(gf){var ge=this.__kf;if(!ge){return -1;}
;return ge.indexOf(gf);}
,_hasChildren:function(){var gg=this.__kf;return gg!=null&&(!!gg[0]);}
,addChildrenToQueue:function(gh){var gi=this.__kf;if(!gi){return;}
...
;if(gl.getLayoutParent()==this){qx.lang.Array.remove(this.__kf,gl);}
;if(this.__kf){this.__kf.push(gl);}
else {this.__kf=[gl];}
;this.__kh(gl,gk);}
,_addAt:function(gp,gm,go){if(!this.__kf){this.__kf=[];}
;if(gp.getLayoutParent()==this){qx.lang.Array.remove(this.__kf,gp);}
;var gn=this.__kf[gm];if(gn===gp){gp.setLayoutProperties(go);}
;if(gn){qx.lang.Array.insertBefore(this.__kf,gp,gn);}
else {this.__kf.push(gp);}
;this.__kh(gp,go);}
,_addBefore:function(gq,gs,gr){if(qx.core.Environment.get(eq)){this.assertInArray(gs,this._getChildren(),F);}
;if(gq==gs){return;}
;if(!this.__kf){this.__kf=[];}
;if(gq.getLayoutParent()==this){qx.lang.Array.remove(this.__kf,gq);}
;qx.lang.Array.insertBefore(this.__kf,gq,gs);this.__kh(gq,gr);}
,_addAfter:function(gv,gt,gu){if(qx.core.Environment.get(eq)){this.assertInArray(gt,this._getChildren(),db);}
;if(gv==gt){return;}
;if(!this.__kf){this.__kf=[];}
;if(gv.getLayoutParent()==this){qx.lang.Array.remove(this.__kf,gv);}
;qx.lang.Array.insertAfter(this.__kf,gv,gt);this.__kh(gv,gu);}
,_remove:function(gw){if(!this.__kf){throw new Error(di);}
;qx.lang.Array.remove(this.__kf,gw);this.__ki(gw);}
,_removeAt:function(gx){if(!this.__kf){throw new Error(di);}
;var gy=this.__kf[gx];qx.lang.Array.removeAt(this.__kf,gx);this.__ki(gy);return gy;}
,_removeAll:function(){if(!this.__kf){return [];}
;var gz=this.__kf.concat();this.__kf.length=0;for(var i=gz.length-1;i>=0;i-- ){this.__ki(gz[i]);}
;qx.ui.core.queue.Layout.add(this);return gz;}
,_afterAddChild:null,_afterRemoveChild:null,__kh:function(gB,gA){if(qx.core.Environment.get(eq)){this.assertInstance(gB,qx.ui.core.LayoutItem,ea+gB);this.assertNotIdentical(gB,this,y+gB);if(gA!=null){this.assertType(gA,h,x+gA);}
;}
...
;}
,__ki:function(gC){if(qx.core.Environment.get(eq)){this.assertNotUndefined(gC);}
;if(gC.getLayoutParent()!==this){throw new Error(S+gC+dR);}
;gC.setLayoutParent(null);if(this.__kc){this.__kc.invalidateChildrenCache();}
...
,_applyPadding:function(gF,gE,name){this._updateInsets=true;qx.ui.core.queue.Layout.add(this);this.__kj(name,gF);}
,__kj:function(gG,gJ){var content=this.getContentElement();var gH=this.getDecorator();gH=qx.theme.manager.Decoration.getInstance().resolve(gH);if(gH){var gI=qx.Bootstrap.firstLow(gG.replace(eA,eg));gJ+=gH.getPadding()[gI]||0;}
;content.setStyle(gG,gJ+dp);}
...
;}
,_applyToolTipText:function(gO,gN){if(qx.core.Environment.get(v)){if(this.__kb){return;}
;var gM=qx.locale.Manager.getInstance();this.__kb=gM.addListener(ex,function(){var gP=this.getToolTipText();if(gP&&gP.translate){this.setToolTipText(gP.translate());}
;}
,this);}
;}
...
;}
,__kk:null,$$stateChanges:null,_forwardStates:null,hasState:function(hj){var hi=this.__kk;return !!hi&&!!hi[hj];}
,addState:function(hn){var hm=this.__kk;if(!hm){hm=this.__kk={};}
;if(hm[hn]){return;}
;this.__kk[hn]=true;if(hn===dk){this.syncAppearance();}
else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hl=this.__kn;if(forward&&forward[hn]&&hl){var hk;for(var ho in hl){hk=hl[ho];if(hk instanceof qx.ui.core.Widget){hl[ho].addState(hn);}
;}
;}
;}
,removeState:function(hs){var hr=this.__kk;if(!hr||!hr[hs]){return;}
;delete this.__kk[hs];if(hs===dk){this.syncAppearance();}
else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hq=this.__kn;if(forward&&forward[hs]&&hq){for(var ht in hq){var hp=hq[ht];if(hp instanceof qx.ui.core.Widget){hp.removeState(hs);}
;}
;}
;}
,replaceState:function(hv,hy){var hx=this.__kk;if(!hx){hx=this.__kk={};}
;if(!hx[hy]){hx[hy]=true;}
;if(hx[hv]){delete hx[hv];}
;if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hw=this.__kn;if(forward&&forward[hy]&&hw){for(var hz in hw){var hu=hw[hz];if(hu instanceof qx.ui.core.Widget){hu.replaceState(hv,hy);}
;}
;}
;}
,__kl:null,__km:null,syncAppearance:function(){var hE=this.__kk;var hD=this.__kl;var hF=qx.theme.manager.Appearance.getInstance();var hB=qx.core.Property.$$method.setThemed;var hJ=qx.core.Property.$$method.resetThemed;if(this.__km){delete this.__km;if(hD){var hA=hF.styleFrom(hD,hE,null,this.getAppearance());hD=null;}
;}
;if(!hD){var hC=this;var hG=[];do {hG.push(hC.$$subcontrol||hC.getAppearance());}
while(hC=hC.$$subparent);hD=hG.reverse().join(eo).replace(/#[0-9]+/g,eg);this.__kl=hD;}
;var hI=hF.styleFrom(hD,hE,null,this.getAppearance());if(hI){if(hA){for(var hH in hA){if(hI[hH]===undefined){this[hJ[hH]]();}
;}
;}
;if(qx.core.Environment.get(eq)){for(var hH in hI){if(!this[hB[hH]]){throw new Error(this.classname+dG+hH+J+hD);}
;}
;}
...
;}
;this.fireDataEvent(I,this.__kk);}
,_applyAppearance:function(hL,hK){this.updateAppearance();}
,checkAppearanceNeeds:function(){if(!this.__ka){qx.ui.core.queue.Appearance.add(this);this.__ka=true;}
else if(this.$$stateChanges){qx.ui.core.queue.Appearance.add(this);delete this.$$stateChanges;}
;}
,updateAppearance:function(){this.__km=true;qx.ui.core.queue.Appearance.add(this);var hO=this.__kn;if(hO){var hM;for(var hN in hO){hM=hO[hN];if(hM instanceof qx.ui.core.Widget){hM.updateAppearance();}
;}
;}
;}
...
;hT.setAttribute(ez,hV);hT.setStyle(dm,de);}
else {if(hT.isNativelyFocusable()){hT.setAttribute(ez,-1);}
else if(hS){hT.setAttribute(ez,null);}
;}
;}
,_applyKeepFocus:function(hX){var hW=this.getFocusElement();hW.setAttribute(ew,hX?df:null);}
...
;if(this.getFocusable()&&ib!=null){this.getFocusElement().setAttribute(ez,ib);}
;}
,_applySelectable:function(ie,ic){if(ic!==null){this._applyCursor(this.getCursor());}
;this.getContentElement().setSelectable(ie);}
,_applyEnabled:function(ih,ig){if(ih===false){this.addState(o);this.removeState(dk);if(this.isFocusable()){this.removeState(n);this._applyFocusable(false,true);}
...
,_applyContextMenu:function(il,ik){if(ik){ik.removeState(et);if(ik.getOpener()==this){ik.resetOpener();}
;if(!il){this.removeListener(et,this._onContextMenuOpen);ik.removeListener(X,this._onBeforeContextMenuOpen,this);}
;}
;if(il){il.setOpener(this);il.addState(et);if(!ik){this.addListener(et,this._onContextMenuOpen);il.addListener(X,this._onBeforeContextMenuOpen,this);}
;}
;}
,_onContextMenuOpen:function(e){this.getContextMenu().openAtMouse(e);e.stop();}
,_onBeforeContextMenuOpen:function(e){if(e.getData()==T&&this.hasListener(eE)){this.fireDataEvent(eE,e);}
;}
...
,scrollChildIntoView:function(ix,iw,iv,iu){iu=typeof iu==eC?true:iu;var it=qx.ui.core.queue.Layout;var parent;if(iu){iu=!it.isScheduled(ix);parent=ix.getLayoutParent();if(iu&&parent){iu=!it.isScheduled(parent);if(iu){parent.getChildren().forEach(function(iy){iu=iu&&!it.isScheduled(iy);}
);}
;}
;}
...
,hasChildControl:function(iF){if(!this.__kn){return false;}
;return !!this.__kn[iF];}
,__kn:null,_getCreatedChildControls:function(){return this.__kn;}
,getChildControl:function(iI,iH){if(!this.__kn){if(iH){return null;}
;this.__kn={};}
;var iG=this.__kn[iI];if(iG){return iG;}
...
;delete iP.$$subcontrol;delete iP.$$subparent;var iQ=this.__kk;var forward=this._forwardStates;if(iQ&&forward&&iP instanceof qx.ui.core.Widget){for(var iR in iQ){if(forward[iR]){iP.removeState(iR);}
;}
;}
;delete this.__kn[iS];return iP;}
,_createChildControl:function(iX){if(!this.__kn){this.__kn={};}
else if(this.__kn[iX]){throw new Error(G+iX+dv);}
...
;}
catch(iY){iY.message=eb+iX+L+this.toString()+dE+iY.message;throw iY;}
;if(!iT){throw new Error(r+iX);}
;iT.$$subcontrol=iX;iT.$$subparent=this;var iV=this.__kk;var forward=this._forwardStates;if(iV&&forward&&iT instanceof qx.ui.core.Widget){for(var iW in iV){if(forward[iW]){iT.addState(iW);}
;}
;}
;this.fireDataEvent(q,iT);return this.__kn[iX]=iT;}
,_createChildControlImpl:function(jb,ja){return null;}
,_disposeChildControls:function(){var jf=this.__kn;if(!jf){return;}
...
,setDomLeft:function(jl){var jk=this.getContentElement().getDomElement();if(jk){jk.style.left=jl+dp;}
else {throw new Error(ee);}
;}
,setDomTop:function(jn){var jm=this.getContentElement().getDomElement();if(jm){jm.style.top=jn+dp;}
else {throw new Error(ee);}
;}
,setDomPosition:function(jp,top){var jo=this.getContentElement().getDomElement();if(jo){jo.style.left=jp+dp;jo.style.top=top+dp;}
else {throw new Error(ee);}
;}
...
;}
;return jq;}
},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Environment.get(v)){if(this.__kb){qx.locale.Manager.getInstance().removeListenerById(this.__kb);}
;}
...
;if(!qx.core.ObjectRegistry.inShutDown){this.clearSeparators();this.__kd=null;}
else {this._disposeArray(P);}
;this._disposeArray(dC);this.__kk=this.__kn=null;this._disposeObjects(ev,dq);}
});}
)();
...
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1,keyup:1,keydown:1,keypress:1,keyinput:1,capture:1,losecapture:1,focusin:1,focusout:1,focus:1,blur:1,activate:1,deactivate:1,appear:1,disappear:1,dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1,touchstart:1,touchend:1,touchmove:1,touchcancel:1,tap:1,longtap:1,swipe:1},IGNORE_CAN_HANDLE:false},members:{__gz:null,__ko:{focusin:1,focusout:1,focus:1,blur:1},__kp:{mouseover:1,mouseout:1,appear:1,disappear:1},canHandleEvent:function(f,e){return f instanceof qx.ui.core.Widget;}
...
;if(this.__ko[h.getType()]){m=m&&m.getFocusTarget();if(!m){return;}
;}
...
;if(u){if(this.__ko[h.getType()]){u=u.getFocusTarget();}
;if(u===m){return;}
;}
;}
;var q=h.getCurrentTarget();var s=qx.ui.core.Widget.getWidgetByElement(q);if(!s||s.isAnonymous()){return;}
;if(this.__ko[h.getType()]){s=s.getFocusTarget();}
;var t=h.getType();if(!s||!(s.isEnabled()||this.__kp[t])){return;}
;var g=h.getEventPhase()==qx.event.type.Event.CAPTURING_PHASE;var p=this.__gz.getListeners(s,t,g);if(!p||p.length===0){return;}
...
},destruct:function(){this.__lm=this.__fs=null;}
});}
)();
(function(){var a="qx.ui.core.queue.Visibility",b="visibility";qx.Class.define(a,{statics:{__eu:[],__cN:{},remove:function(c){delete this.__cN[c.$$hash];qx.lang.Array.remove(this.__eu,c);}
,isVisible:function(d){return this.__cN[d.$$hash]||false;}
,__kq:function(f){var h=this.__cN;var g=f.$$hash;var e;if(f.isExcluded()){e=false;}
else {var parent=f.$$parent;if(parent){e=this.__kq(parent);}
else {e=f.isRootWidget();}
;}
;return h[g]=e;}
,add:function(k){var j=this.__eu;if(qx.lang.Array.contains(j,k)){return;}
;j.unshift(k);qx.ui.core.queue.Manager.scheduleFlush(b);}
,flush:function(){var o=this.__eu;var p=this.__cN;for(var i=o.length-1;i>=0;i-- ){var n=o[i].$$hash;if(p[n]!=null){o[i].addChildrenToQueue(o);}
;}
;var l={};for(var i=o.length-1;i>=0;i-- ){var n=o[i].$$hash;l[n]=p[n];p[n]=null;}
;for(var i=o.length-1;i>=0;i-- ){var m=o[i];var n=m.$$hash;o.splice(i,1);if(p[n]==null){this.__kq(m);}
;if(p[n]&&p[n]!=l[n]){m.checkAppearanceNeeds();}
;}
;this.__eu=[];}
}});}
)();
(function(){var a=" due to exceptions in user code. The application has to be reloaded!",b="Error in the 'Appearance' queue:",c="Error in the 'Widget' queue:",d="\n",f="Error in the 'Layout' queue:",g="Error in the 'Visibility' queue:",h="qx.debug",i="useraction",j="qx.debug.ui.queue",k="Error while layout flush: ",l="Error in the 'Dispose' queue:",m="Stack trace: \n",n="event.touch",o="qx.ui.core.queue.Manager",p=" times in a row",q="Fatal Error: Flush terminated ";qx.Class.define(o,{statics:{__kr:false,__gp:false,__ks:{},__kt:0,MAX_RETRIES:10,scheduleFlush:function(r){var self=qx.ui.core.queue.Manager;self.__ks[r]=true;if(!self.__kr){self.__gp=false;qx.bom.AnimationFrame.request(function(){if(self.__gp){self.__gp=false;return;}
;self.flush();}
,self);self.__kr=true;}
;}
,flush:function(){var self=qx.ui.core.queue.Manager;if(self.__ku){return;}
;self.__ku=true;self.__gp=true;var s=self.__ks;self.__kv(function(){while(s.visibility||s.widget||s.appearance||s.layout||s.element){if(s.widget){delete s.widget;if(qx.core.Environment.get(j)){try{qx.ui.core.queue.Widget.flush();}
...
;}
;}
,function(){self.__kr=false;}
);self.__kv(function(){if(s.dispose){delete s.dispose;if(qx.core.Environment.get(j)){try{qx.ui.core.queue.Dispose.flush();}
...
,__kv:qx.core.Environment.select(h,{"true":function(t,u){t();u();}
...
;self.__kr=false;self.__ku=false;self.__kt+=1;if(self.__kt<=self.MAX_RETRIES){self.scheduleFlush();}
else {throw new Error(q+(self.__kt-1)+p+a);}
;throw e;}
finally{w();}
;}
}),__kw:function(e){qx.ui.core.queue.Manager.flush();}
},defer:function(x){qx.html.Element._scheduleFlush=x.scheduleFlush;qx.event.Registration.addListener(window,i,qx.core.Environment.get(n)?x.__kw:x.flush);}
});}
)();
(function(){var a="qx.ui.core.queue.Widget",b="widget",c="$$default";qx.Class.define(a,{statics:{__eu:[],__ks:{},remove:function(e,g){var d=this.__eu;if(!qx.lang.Array.contains(d,e)){return;}
;var f=e.$$hash;if(g==null){qx.lang.Array.remove(d,e);delete this.__ks[f];return;}
;if(this.__ks[f]){delete this.__ks[f][g];if(qx.lang.Object.getLength(this.__ks[f])==0){qx.lang.Array.remove(d,e);}
;}
;}
,add:function(j,l){var h=this.__eu;if(!qx.lang.Array.contains(h,j)){h.unshift(j);}
;if(l==null){l=c;}
;var k=j.$$hash;if(!this.__ks[k]){this.__ks[k]={};}
;this.__ks[k][l]=true;qx.ui.core.queue.Manager.scheduleFlush(b);}
,flush:function(){var m=this.__eu;var n,o;for(var i=m.length-1;i>=0;i-- ){n=m[i];o=this.__ks[n.$$hash];m.splice(i,1);n.syncWidget(o);}
;if(m.length!=0){return;}
;this.__eu=[];this.__ks={};}
}});}
)();
(function(){var a="appearance",b="qx.ui.core.queue.Appearance";qx.Class.define(b,{statics:{__eu:[],remove:function(c){qx.lang.Array.remove(this.__eu,c);}
,add:function(e){var d=this.__eu;if(qx.lang.Array.contains(d,e)){return;}
;d.unshift(e);qx.ui.core.queue.Manager.scheduleFlush(a);}
,has:function(f){return qx.lang.Array.contains(this.__eu,f);}
,flush:function(){var j=qx.ui.core.queue.Visibility;var g=this.__eu;var h;for(var i=g.length-1;i>=0;i-- ){h=g[i];g.splice(i,1);if(j.isVisible(h)){h.syncAppearance();}
else {h.$$stateChanges=true;}
;}
;}
}});}
)();
(function(){var a="dispose",b="qx.ui.core.queue.Dispose";qx.Class.define(b,{statics:{__eu:[],add:function(d){var c=this.__eu;if(qx.lang.Array.contains(c,d)){return;}
;c.unshift(d);qx.ui.core.queue.Manager.scheduleFlush(a);}
,isEmpty:function(){return this.__eu.length==0;}
,flush:function(){var e=this.__eu;for(var i=e.length-1;i>=0;i-- ){var f=e[i];e.splice(i,1);f.dispose();}
...
(function(){var a="qx.locale.LocalizedString";qx.Class.define(a,{extend:qx.type.BaseString,construct:function(b,d,c){qx.type.BaseString.call(this,b);this.__ky=d;this.__kz=c;}
,members:{__ky:null,__kz:null,translate:function(){return qx.locale.Manager.getInstance().translate(this.__ky,this.__kz);}
}});}
)();
(function(){var a="locale",b="_applyLocale",c="",d="changeLocale",e="_",f="Locale: ",g="C",h="locale.variant",j="qx.dynlocale",k=" not available.",l="qx.locale.Manager",m="String",n="singleton",o="qx.debug";qx.Class.define(l,{type:n,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__kA=qx.$$translations||{};this.__kB=qx.$$locales||{};var p=qx.core.Environment.get(a);var q=qx.core.Environment.get(h);if(q!==c){p+=e+q;}
;this.__kC=p;this.setLocale(p||this.__kD);}
...
},properties:{locale:{check:m,nullable:true,apply:b,event:d}},members:{__kD:g,__kE:null,__kF:null,__kA:null,__kB:null,__kC:null,getLanguage:function(){return this.__kF;}
,getTerritory:function(){return this.getLocale().split(e)[1]||c;}
,getAvailableLocales:function(F){var G=[];for(var E in this.__kB){if(E!=this.__kD){if(this.__kB[E]===null&&!F){continue;}
;G.push(E);}
;}
;return G;}
,__kG:function(H){var J;if(H==null){return null;}
;var I=H.indexOf(e);if(I==-1){J=H;}
else {J=H.substring(0,I);}
;return J;}
,_applyLocale:function(L,K){if(qx.core.Environment.get(o)){if(!(L in this.__kB||L==this.__kC)){qx.log.Logger.warn(f+L+k);}
;}
;this.__kE=L;this.__kF=this.__kG(L);}
,addTranslation:function(M,P){var N=this.__kA;if(N[M]){for(var O in P){N[M][O]=P[O];}
;}
else {N[M]=P;}
;}
,addLocale:function(T,R){var Q=this.__kB;if(Q[T]){for(var S in R){Q[T][S]=R[S];}
;}
else {Q[T]=R;}
;}
,translate:function(X,W,U){var V=this.__kA;return this.__kH(V,X,W,U);}
,localize:function(bc,bb,Y){var ba=this.__kB;return this.__kH(ba,bc,bb,Y);}
,__kH:function(bh,bi,bf,bg){if(qx.core.Environment.get(o)){this.assertObject(bh);this.assertString(bi);this.assertArray(bf);}
;var bd;if(!bh){return bi;}
;if(bg){var be=this.__kG(bg);}
else {bg=this.__kE;be=this.__kF;}
;if(!bd&&bh[bg]){bd=bh[bg][bi];}
;if(!bd&&bh[be]){bd=bh[be][bi];}
;if(!bd&&bh[this.__kD]){bd=bh[this.__kD][bi];}
;if(!bd){bd=bi;}
...
;return bd;}
},destruct:function(){this.__kA=this.__kB=null;}
});}
)();
(function(){var a="qx.bom.client.Locale",b="-",c="locale",d="",e="android",f="locale.variant";qx.Bootstrap.define(a,{statics:{getLocale:function(){var g=qx.bom.client.Locale.__kI();var h=g.indexOf(b);if(h!=-1){g=g.substr(0,h);}
;return g;}
,getVariant:function(){var i=qx.bom.client.Locale.__kI();var k=d;var j=i.indexOf(b);if(j!=-1){k=i.substr(j+1);}
;return k;}
,__kI:function(){var l=(navigator.userLanguage||navigator.language||d);if(qx.bom.client.OperatingSystem.getName()==e){var m=/(\w{2})-(\w{2})/i.exec(navigator.userAgent);if(m){l=m[0];}
;}
;return l.toLowerCase();}
},defer:function(n){qx.core.Environment.add(c,n.getLocale);qx.core.Environment.add(f,n.getVariant);}
});}
)();
(function(){var a="Image could not be loaded: ",b="Boolean",c="px",d="http",e=".png",f="background-image",g="engine.version",h="scale",i="changeSource",j="div",k="nonScaled",l="qx.ui.basic.Image",m="loaded",n="0 0",o=", no-repeat",p="qx.debug",q="replacement",r="backgroundImage",s="backgroundRepeat",t="-disabled.$1",u="class",v="qx.event.type.Event",w="loadingFailed",x="css.alphaimageloaderneeded",y="String",z="browser.documentmode",A="backgroundPosition",B="border-box",C="__kJ",D="left",E="_applySource",F="$$widget",G="data:image/",H="top",I="scaled",J=", ",K="image",L="mshtml",M="engine.name",N=", 0 0",O="_applyScale",P="try to load an unmanaged relative image: ",Q="position",R="img",S="no-repeat",T="background-position",U="hidden",V="alphaScaled",W=",",X="absolute";qx.Class.define(l,{extend:qx.ui.core.Widget,construct:function(Y){this.__kJ={};qx.ui.core.Widget.call(this);if(Y){this.setSource(Y);}
;}
,properties:{source:{check:y,init:null,nullable:true,event:i,apply:E,themeable:true},scale:{check:b,init:false,themeable:true,apply:O},appearance:{refine:true,init:K},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},events:{loadingFailed:v,loaded:v},members:{__kK:null,__kL:null,__hB:null,__kJ:null,__kM:null,__kN:null,_onChangeTheme:function(){qx.ui.core.Widget.prototype._onChangeTheme.call(this);this._styleSource();}
,getContentElement:function(){return this.__kR();}
,_createContentElement:function(){return this.__kR();}
,_getContentHint:function(){return {width:this.__kK||0,height:this.__kL||0};}
,_applyDecorator:function(bc,bb){qx.ui.core.Widget.prototype._applyDecorator.call(this,bc,bb);var bd=this.getSource();bd=qx.util.AliasManager.getInstance().resolve(bd);var ba=this.getContentElement();if(this.__kN){ba=ba.getChild(0);}
;this.__kX(ba,bd);}
,_applyPadding:function(bf,be,name){qx.ui.core.Widget.prototype._applyPadding.call(this,bf,be,name);var bg=this.getContentElement();if(this.__kN){bg.getChild(0).setStyles({top:this.getPaddingTop()||0,left:this.getPaddingLeft()||0});}
else {bg.setPadding(this.getPaddingLeft()||0,this.getPaddingTop()||0);}
;}
,renderLayout:function(bj,top,bh,bk){qx.ui.core.Widget.prototype.renderLayout.call(this,bj,top,bh,bk);var bi=this.getContentElement();if(this.__kN){bi.getChild(0).setStyles({width:bh-(this.getPaddingLeft()||0)-(this.getPaddingRight()||0),height:bk-(this.getPaddingTop()||0)-(this.getPaddingBottom()||0),top:this.getPaddingTop()||0,left:this.getPaddingLeft()||0});}
;}
...
,__kO:function(bp){this.__hB=bp;}
,__kP:function(){if(this.__hB==null){var br=this.getSource();var bq=false;if(br!=null){bq=qx.lang.String.endsWith(br,e);}
;if(this.getScale()&&bq&&qx.core.Environment.get(x)){this.__hB=V;}
else if(this.getScale()){this.__hB=I;}
else {this.__hB=k;}
;}
;return this.__hB;}
,__kQ:function(bu){var bt;var bs;if(bu==V){bt=true;bs=j;}
else if(bu==k){bt=false;bs=j;}
else {bt=true;bs=R;}
;var bw=new qx.html.Image(bs);bw.setAttribute(F,this.toHashCode());bw.setScale(bt);bw.setStyles({"overflowX":U,"overflowY":U,"boxSizing":B});if(qx.core.Environment.get(x)){var bv=this.__kN=new qx.html.Element(j);bv.setAttribute(F,this.toHashCode());bv.setStyle(Q,X);bv.add(bw);return bv;}
;return bw;}
,__kR:function(){if(this.$$disposed){return null;}
;var bx=this.__kP();if(this.__kJ[bx]==null){this.__kJ[bx]=this.__kQ(bx);}
;var by=this.__kJ[bx];if(!this.__kM){this.__kM=by;}
;return by;}
,_styleSource:function(){var bz=qx.util.AliasManager.getInstance().resolve(this.getSource());var bC=this.getContentElement();if(this.__kN){bC=bC.getChild(0);}
;if(!bz){bC.resetSource();return;}
;this.__kS(bz);if((qx.core.Environment.get(M)==L)&&(parseInt(qx.core.Environment.get(g),10)<9||qx.core.Environment.get(z)<9)){var bA=this.getScale()?h:S;bC.tagNameHint=qx.bom.element.Decoration.getTagName(bA,bz);}
;var bB=this.__kM;if(this.__kN){bB=bB.getChild(0);}
;if(qx.util.ResourceManager.getInstance().has(bz)){this.__kU(bB,bz);}
else if(qx.io.ImageLoader.isLoaded(bz)){this.__kV(bB,bz);}
else {this.__kW(bB,bz);}
;}
,__kS:qx.core.Environment.select(M,{"mshtml":function(bE){var bF=qx.core.Environment.get(x);var bD=qx.lang.String.endsWith(bE,e);if(bF&&bD){if(this.getScale()&&this.__kP()!=V){this.__kO(V);}
else if(!this.getScale()&&this.__kP()!=k){this.__kO(k);}
;}
else {if(this.getScale()&&this.__kP()!=I){this.__kO(I);}
else if(!this.getScale()&&this.__kP()!=k){this.__kO(k);}
;}
;this.__kT(this.__kR());}
,"default":function(bG){if(this.getScale()&&this.__kP()!=I){this.__kO(I);}
else if(!this.getScale()&&this.__kP(k)){this.__kO(k);}
;this.__kT(this.__kR());}
}),__kT:function(bK){var bJ=this.__kM;if(bJ!=bK){if(bJ!=null){var bU=c;var bH={};var bP=this.getBounds();if(bP!=null){bH.width=bP.width+bU;bH.height=bP.height+bU;}
;var bQ=this.getInsets();bH.left=parseInt(bJ.getStyle(D)||bQ.left)+bU;bH.top=parseInt(bJ.getStyle(H)||bQ.top)+bU;bH.zIndex=10;var bN=this.__kN?bK.getChild(0):bK;bN.setStyles(bH,true);bN.setSelectable(this.getSelectable());var bR=bJ.getParent();if(bR){var bI=bR.getChildren().indexOf(bJ);bR.removeAt(bI);bR.addAt(bK,bI);}
;var bM=bN.getNodeName();bN.setSource(null);var bL=this.__kN?this.__kM.getChild(0):this.__kM;bN.tagNameHint=bM;bN.setAttribute(u,bL.getAttribute(u));qx.html.Element.flush();var bT=bL.getDomElement();var bS=bK.getDomElement();if(bT&&bS){var bO=bT.$$hash;bT.$$hash=bS.$$hash;bS.$$hash=bO;}
;this.__kM=bK;}
;}
;}
,__kU:function(bW,bY){var bX=qx.util.ResourceManager.getInstance();if(!this.getEnabled()){var bV=bY.replace(/\.([a-z]+)$/,t);if(bX.has(bV)){bY=bV;this.addState(q);}
else {this.removeState(q);}
;}
;if(bW.getSource()===bY){return;}
;this.__kX(bW,bY);this.__la(bX.getImageWidth(bY),bX.getImageHeight(bY));}
,__kV:function(ca,ce){var cc=qx.io.ImageLoader;this.__kX(ca,ce);var cd=cc.getWidth(ce);var cb=cc.getHeight(ce);this.__la(cd,cb);}
,__kW:function(cf,ci){var cj=qx.io.ImageLoader;if(qx.core.Environment.get(p)){var ch=ci.toLowerCase();var cg=qx.lang.String.startsWith;if(!cg(ch,d)&&!cg(ch,G)){var self=this.self(arguments);if(!self.__Lz){self.__Lz={};}
;if(!self.__Lz[ci]){this.debug(P+ci);self.__Lz[ci]=true;}
;}
;}
;if(!cj.isFailed(ci)){cj.load(ci,this.__kY,this);}
else {if(cf!=null){cf.resetSource();}
;}
;}
,__kX:function(ck,cp){if(ck.getNodeName()==j){var cs=qx.theme.manager.Decoration.getInstance().resolve(this.getDecorator());if(cs){var cq=(cs.getStartColor()&&cs.getEndColor());var co=cs.getBackgroundImage();if(cq||co){var cl=this.getScale()?h:S;var cm=qx.bom.element.Decoration.getAttributes(cp,cl);var cn=cs.getStyles(true);var cr={"backgroundImage":cm.style.backgroundImage,"backgroundPosition":(cm.style.backgroundPosition||n),"backgroundRepeat":(cm.style.backgroundRepeat||S)};if(co){cr[A]+=W+cn[T]||n;cr[s]+=J+cs.getBackgroundRepeat();}
;if(cq){cr[A]+=N;cr[s]+=o;}
;cr[r]+=W+cn[f];ck.setStyles(cr);return;}
;}
else {ck.setSource(null);}
;}
;ck.setSource(cp);}
,__kY:function(ct,cu){if(this.$$disposed===true){return;}
;if(ct!==qx.util.AliasManager.getInstance().resolve(this.getSource())){return;}
;if(cu.failed){this.warn(a+ct);this.fireEvent(w);}
else if(cu.aborted){return;}
else {this.fireEvent(m);}
;this._styleSource();}
,__la:function(cv,cw){if(cv!==this.__kK||cw!==this.__kL){this.__kK=cv;this.__kL=cw;qx.ui.core.queue.Layout.add(this);}
;}
},destruct:function(){delete this.__kM;this._disposeMap(C);}
});}
)();
...
;}
,getTagName:function(bh,bf){if(bf&&qx.core.Environment.get(r)&&this.__dx[bh]&&qx.lang.String.endsWith(bf,d)){return k;}
;return this.__dy[bh];}
...
;}
;var bm;if(qx.core.Environment.get(r)&&this.__dx[bj]&&bk===A){var bn=this.__dA(bl);this.__dz(bi,bn.width,bn.height);bm=this.processAlphaFix(bi,bj,bl);}
else {delete bi.clip;if(bj===i){bm=this.__dB(bi,bj,bl);}
else if(bj===q||bj===Q){bm=this.__dC(bi,bj,bl);}
else {bm=this.__dF(bi,bj,bl);}
;}
;return bm;}
,__dz:function(bp,bo,bq){if(bp.width==null&&bo!=null){bp.width=bo+c;}
;if(bp.height==null&&bq!=null){bp.height=bq+c;}
;}
,__dA:function(br){var bs=qx.util.ResourceManager.getInstance().getImageWidth(br)||qx.io.ImageLoader.getWidth(br);var bt=qx.util.ResourceManager.getInstance().getImageHeight(br)||qx.io.ImageLoader.getHeight(br);return {width:bs,height:bt};}
...
,__dB:function(bA,bB,bz){var bC=qx.util.ResourceManager.getInstance().toUri(bz);var bD=this.__dA(bz);this.__dz(bA,bD.width,bD.height);return {src:bC,style:bA};}
,__dC:function(bE,bF,bH){var bG=qx.util.ResourceManager.getInstance();var bK=bG.getCombinedFormat(bH);var bM=this.__dA(bH);var bI;if(bK){var bL=bG.getData(bH);var bJ=bL[4];if(bK==I){bI=bG.toDataUri(bH);}
else {bI=bG.toUri(bJ);}
;if(bF===q){bE=this.__dD(bE,bL,bM.height);}
else {bE=this.__dE(bE,bL,bM.width);}
;return {src:bI,style:bE};}
else {if(qx.core.Environment.get(p)){this.__dH(bH);}
...
;}
,__dD:function(bN,bO,bQ){var bP=qx.util.ResourceManager.getInstance().getImageHeight(bO[4]);bN.clip={top:-bO[6],height:bQ};bN.height=bP+c;if(bN.top!=null){bN.top=(parseInt(bN.top,10)+bO[6])+c;}
else if(bN.bottom!=null){bN.bottom=(parseInt(bN.bottom,10)+bQ-bP-bO[6])+c;}
;return bN;}
,__dE:function(bS,bT,bR){var bU=qx.util.ResourceManager.getInstance().getImageWidth(bT[4]);bS.clip={left:-bT[5],width:bR};bS.width=bU+c;if(bS.left!=null){bS.left=(parseInt(bS.left,10)+bT[5])+c;}
else if(bS.right!=null){bS.right=(parseInt(bS.right,10)+bR-bU-bT[5])+c;}
;return bS;}
,__dF:function(bV,bW,ca){var bY=qx.util.ResourceManager.getInstance();var bX=bY.getCombinedFormat(ca);var ci=this.__dA(ca);if(bX&&bW!==b){var ch=bY.getData(ca);var cf=ch[4];if(bX==I){var cc=bY.toDataUri(ca);var cb=0;var cd=0;}
else {var cc=bY.toUri(cf);var cb=ch[5];var cd=ch[6];if(bV.paddingTop||bV.paddingLeft){var top=bV.paddingTop||0;var cj=bV.paddingLeft||0;cb+=bV.paddingLeft||0;cd+=bV.paddingTop||0;bV.clip={left:cj,top:top,width:ci.width,height:ci.height};}
;}
...
;return {style:bV};}
else {var top=bV.paddingTop||0;var cj=bV.paddingLeft||0;bV.backgroundPosition=cj+g+top+c;if(qx.core.Environment.get(p)){if(bW!==b){this.__dH(ca);}
;}
;this.__dz(bV,ci.width,ci.height);this.__dG(bV,ca,bW);return {style:bV};}
;}
,__dG:function(ck,cn,cl){var top=null;var cq=null;if(ck.backgroundPosition){var cm=ck.backgroundPosition.split(L);cq=parseInt(cm[0],10);if(isNaN(cq)){cq=cm[0];}
...
;}
,__dH:function(cr){if(this.DEBUG&&qx.util.ResourceManager.getInstance().has(cr)&&cr.indexOf(a)==-1){if(!this.__dw[cr]){qx.log.Logger.debug(l+cr);this.__dw[cr]=true;}
;}
;}
...
(function(){var a="load",b="html.image.naturaldimensions",c="qx.io.ImageLoader";qx.Bootstrap.define(c,{statics:{__cN:{},__dV:{width:null,height:null},__dW:/\.(png|gif|jpg|jpeg|bmp)\b/i,__dX:/^data:image\/(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(d){var e=this.__cN[d];return !!(e&&e.loaded);}
,isFailed:function(f){var g=this.__cN[f];return !!(g&&g.failed);}
,isLoading:function(h){var j=this.__cN[h];return !!(j&&j.loading);}
,getFormat:function(o){var n=this.__cN[o];if(!n||!n.format){var k=this.__dX.exec(o);if(k!=null){var m=(n&&qx.lang.Type.isNumber(n.width)?n.width:this.__dV.width);var p=(n&&qx.lang.Type.isNumber(n.height)?n.height:this.__dV.height);n={loaded:true,format:k[1],width:m,height:p};}
;}
;return n?n.format:null;}
,getSize:function(q){var r=this.__cN[q];return r?{width:r.width,height:r.height}:this.__dV;}
...
;var w=new Image();var B=qx.lang.Function.listener(this.__dY,this,w,y);w.onload=B;w.onerror=B;w.src=y;A.element=w;}
;}
...
;}
;this.__cN[C]=null;}
,__dY:qx.event.GlobalError.observeMethod(function(event,H,G){var L=this.__cN[G];var I=function(M){return (M&&M.height!==0);}
;if(event.type===a&&I(H)){L.loaded=true;L.width=this.__ea(H);L.height=this.__eb(H);var J=this.__dW.exec(G);if(J!=null){L.format=J[1];}
;}
else {L.failed=true;}
...
;}
),__ea:function(N){return qx.core.Environment.get(b)?N.naturalWidth:N.width;}
,__eb:function(O){return qx.core.Environment.get(b)?O.naturalHeight:O.height;}
,dispose:function(){this.__cN={};}
}});}
)();
(function(){var a="')",b="gecko",c="background-image:url(",d="0",e=");",f="",g="px",h="number",i=")",j="background-repeat:",k="engine.version",l="data:",m=" ",n="qx.bom.element.Background",o=";",p="url(",q="background-position:",r="base64",s="url('",t="engine.name",u="'";qx.Class.define(n,{statics:{__ec:[c,null,e,q,null,o,j,null,o],__ed:{backgroundImage:null,backgroundPosition:null,backgroundRepeat:null},__ee:function(z,top){var v=qx.core.Environment.get(t);var x=qx.core.Environment.get(k);if(v==b&&x<1.9&&z==top&&typeof z==h){top+=0.01;}
;if(z){var y=(typeof z==h)?z+g:z;}
else {y=d;}
;if(top){var w=(typeof top==h)?top+g:top;}
else {w=d;}
;return y+m+w;}
,__ef:function(A){var String=qx.lang.String;var B=A.substr(0,50);return String.startsWith(B,l)&&String.contains(B,r);}
,compile:function(F,D,H,top){var G=this.__ee(H,top);var E=qx.util.ResourceManager.getInstance().toUri(F);if(this.__ef(E)){E=u+E+u;}
;var C=this.__ec;C[1]=E;C[4]=G;C[7]=D;return C.join(f);}
,getStyles:function(L,J,N,top){if(!L){return this.__ed;}
;var M=this.__ee(N,top);var K=qx.util.ResourceManager.getInstance().toUri(L);var O;if(this.__ef(K)){O=s+K+a;}
else {O=p+K+i;}
...
(function(){var a="offline",b="qx.event.handler.Offline",c="online";qx.Class.define(b,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(d){qx.core.Object.call(this);this.__gz=d;this.__cx=d.getWindow();this._initObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{online:true,offline:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__gz:null,__cx:null,__hz:null,canHandleEvent:function(f,e){}
...
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST},members:{__cz:null,__ld:null,__le:true,__cx:null,_getParent:function(l){return l.parentNode;}
...
;this.__le=q;this.__ld=r;this.__cz.fireEvent(r,h,qx.event.type.Event,[true,false]);}
,getCaptureElement:function(){return this.__ld;}
,releaseCapture:function(){var s=this.__ld;if(!s){return;}
;this.__ld=null;this.__cz.fireEvent(s,d,qx.event.type.Event,[true,false]);this.nativeReleaseCapture(s);}
...
,"default":(function(){}
)})},destruct:function(){this.__ld=this.__cx=this.__cz=null;}
...
;this.__lp=y;this.__gV=B;delete this._invalidChildrenCache;}
...
;var bs=qx.ui.layout.Util;var bf=this.__gV;var bk=0,bl=0,be=0;var bi=0,bj=0;var bp,bg,br;for(var i=0,l=bf.length;i<l;i+=1){bp=bf[i];bg=bp.getSizeHint();bl+=bg.width;var bo=this.__lo[i];var bh=this.__ln[i];if(bo){bk+=bg.minWidth;}
...
},destruct:function(){this.__ln=this.__lo=this.__gV=null;}
});}
)();
...
(function(){var a="_applyActiveWindow",b="changeModal",c="__gz",d="__lG",f="changeVisibility",g="changeActive",h="qx.ui.window.MDesktop",i="qx.ui.window.Window";qx.Mixin.define(h,{properties:{activeWindow:{check:i,apply:a,init:null,nullable:true}},members:{__lG:null,__gz:null,getWindowManager:function(){if(!this.__gz){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());}
;return this.__gz;}
,supportsMaximize:function(){return true;}
,setWindowManager:function(j){if(this.__gz){this.__gz.setDesktop(null);}
;j.setDesktop(this);this.__gz=j;}
...
;}
,_addWindow:function(n){if(!qx.lang.Array.contains(this.getWindows(),n)){this.getWindows().push(n);n.addListener(g,this._onChangeActive,this);n.addListener(b,this._onChangeModal,this);n.addListener(f,this._onChangeVisibility,this);}
;if(n.getActive()){this.setActiveWindow(n);}
;this.getWindowManager().updateStack();}
,_afterRemoveChild:function(o){if(qx.Class.isDefined(i)&&o instanceof qx.ui.window.Window){this._removeWindow(o);}
;}
,_removeWindow:function(p){qx.lang.Array.remove(this.getWindows(),p);p.removeListener(g,this._onChangeActive,this);p.removeListener(b,this._onChangeModal,this);p.removeListener(f,this._onChangeVisibility,this);this.getWindowManager().updateStack();}
,getWindows:function(){if(!this.__lG){this.__lG=[];}
;return this.__lG;}
},destruct:function(){this._disposeArray(d);this._disposeObjects(c);}
});}
)();
(function(){var a="indexOf",b="addAfter",c="add",d="addBefore",e="_",f="addAt",g="hasChildren",h="removeAt",i="removeAll",j="getChildren",k="remove",l="qx.ui.core.MRemoteChildrenHandling";qx.Mixin.define(l,{members:{__lI:function(q,m,o,n){var p=this.getChildrenContainer();if(p===this){q=e+q;}
;return (p[q])(m,o,n);}
,getChildren:function(){return this.__lI(j);}
,hasChildren:function(){return this.__lI(g);}
,add:function(s,r){return this.__lI(c,s,r);}
,remove:function(t){return this.__lI(k,t);}
,removeAll:function(){return this.__lI(i);}
,indexOf:function(u){return this.__lI(a,u);}
,addAt:function(x,v,w){this.__lI(f,x,v,w);}
,addBefore:function(y,A,z){this.__lI(d,y,A,z);}
,addAfter:function(D,B,C){this.__lI(b,D,B,C);}
,removeAt:function(E){return this.__lI(h,E);}
}});}
)();
...
(function(){var a="__lH",b="qx.ui.window.Manager";qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__lH:null,setDesktop:function(c){this.__lH=c;this.updateStack();}
,getDesktop:function(){return this.__lH;}
,changeActiveWindow:function(d,e){if(d){this.bringToFront(d);d.setActive(true);}
;if(e){e.resetActive();}
;}
,_minZIndex:1e5,updateStack:function(){qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(){this.__lH.forceUnblock();var h=this.__lH.getWindows();var g=this._minZIndex;var m=g+h.length*2;var j=g+h.length*4;var k=null;for(var i=0,l=h.length;i<l;i++ ){var f=h[i];if(!f.isVisible()){continue;}
;k=k||f;if(f.isModal()){f.setZIndex(j);this.__lH.blockContent(j-1);j+=2;k=f;}
else if(f.isAlwaysOnTop()){f.setZIndex(m);m+=2;}
else {f.setZIndex(g);g+=2;}
;if(!k.isModal()&&f.isActive()||f.getZIndex()>k.getZIndex()){k=f;}
;}
;this.__lH.setActiveWindow(k);}
,bringToFront:function(o){var n=this.__lH.getWindows();var p=qx.lang.Array.remove(n,o);if(p){n.push(o);this.updateStack();}
;}
,sendToBack:function(r){var q=this.__lH.getWindows();var s=qx.lang.Array.remove(q,r);if(s){q.unshift(r);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(a);}
});}
)();
(function(){var a="__lK",b="mouseup",c="mousedown",d="Boolean",f="losecapture",g="mousewheel",h="qx.ui.core.MMovable",i="The move handle could not be redefined!",j="mousemove",k="move",l="maximized",m="__lJ",n="move-frame";qx.Mixin.define(h,{properties:{movable:{check:d,init:true},useMoveFrame:{check:d,init:false}},members:{__lJ:null,__lK:null,__lL:null,__lM:null,__lN:null,__lO:null,__lP:null,__lQ:false,__lR:null,__lS:0,_activateMoveHandle:function(o){if(this.__lJ){throw new Error(i);}
;this.__lJ=o;o.addListener(c,this._onMoveMouseDown,this);o.addListener(b,this._onMoveMouseUp,this);o.addListener(j,this._onMoveMouseMove,this);o.addListener(f,this.__lW,this);if(qx.event.handler.MouseEmulation.ON){o.addListener(g,function(e){e.stopPropagation();}
,this);}
;}
,__lT:function(){var p=this.__lK;if(!p){p=this.__lK=new qx.ui.core.Widget();p.setAppearance(n);p.exclude();qx.core.Init.getApplication().getRoot().add(p);}
;return p;}
,__lU:function(){var location=this.getContentLocation();var r=this.getBounds();var q=this.__lT();q.setUserBounds(location.left,location.top,r.width,r.height);q.show();q.setZIndex(this.getZIndex()+1);}
,__lV:function(e){var t=this.__lL;var w=Math.max(t.left,Math.min(t.right,e.getDocumentLeft()));var s=Math.max(t.top,Math.min(t.bottom,e.getDocumentTop()));var u=this.__lM+w;var v=this.__lN+s;return {viewportLeft:parseInt(u,10),viewportTop:parseInt(v,10),parentLeft:parseInt(u-this.__lO,10),parentTop:parseInt(v-this.__lP,10)};}
,_onMoveMouseDown:function(e){if(!this.getMovable()||this.hasState(l)){return;}
;var parent=this.getLayoutParent();var x=parent.getContentLocation();var z=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isBlocked()){this.__lR=parent.getBlockerColor();this.__lS=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__lQ=true;}
;}
;this.__lL={left:x.left,top:x.top,right:x.left+z.width,bottom:x.top+z.height};var y=this.getContentLocation();this.__lO=x.left;this.__lP=x.top;this.__lM=y.left-e.getDocumentLeft();this.__lN=y.top-e.getDocumentTop();this.addState(k);this.__lJ.capture();if(this.getUseMoveFrame()){this.__lU();}
;e.stop();}
,_onMoveMouseMove:function(e){if(!this.hasState(k)){return;}
;var B=this.__lV(e);if(this.getUseMoveFrame()){this.__lT().setDomPosition(B.viewportLeft,B.viewportTop);}
...
;this.removeState(k);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__lQ){parent.unblock();parent.setBlockerColor(this.__lR);parent.setBlockerOpacity(this.__lS);this.__lR=null;this.__lS=0;this.__lQ=false;}
;}
;this.__lJ.releaseCapture();var D=this.__lV(e);var C=this.getLayoutParent().getInsets();this.setLayoutProperties({left:D.parentLeft-(C.left||0),top:D.parentTop-(C.top||0)});if(this.getUseMoveFrame()){this.__lT().exclude();}
;e.stopPropagation();}
,__lW:function(e){if(!this.hasState(k)){return;}
;this.removeState(k);if(this.getUseMoveFrame()){this.__lT().exclude();}
;}
},destruct:function(){this._disposeObjects(a,m);this.__lL=null;}
});}
)();
(function(){var a="resetPaddingRight",b="setPaddingTop",c="_applyContentPadding",d="setPaddingBottom",e="resetThemed",f="contentPaddingRight",g="Integer",h="contentPaddingLeft",i="setThemedPaddingLeft",j="resetPaddingTop",k="shorthand",l="setThemedPaddingRight",m="setThemed",n="setPaddingRight",o="contentPaddingBottom",p="resetPaddingBottom",q="qx.ui.core.MContentPadding",r="resetPaddingLeft",s="setThemedPaddingTop",t="setPaddingLeft",u="setThemedPaddingBottom",v="contentPaddingTop";qx.Mixin.define(q,{properties:{contentPaddingTop:{check:g,init:0,apply:c,themeable:true},contentPaddingRight:{check:g,init:0,apply:c,themeable:true},contentPaddingBottom:{check:g,init:0,apply:c,themeable:true},contentPaddingLeft:{check:g,init:0,apply:c,themeable:true},contentPadding:{group:[v,f,o,h],mode:k,themeable:true}},members:{__lX:{contentPaddingTop:b,contentPaddingRight:n,contentPaddingBottom:d,contentPaddingLeft:t},__lY:{contentPaddingTop:s,contentPaddingRight:l,contentPaddingBottom:u,contentPaddingLeft:i},__ma:{contentPaddingTop:j,contentPaddingRight:a,contentPaddingBottom:p,contentPaddingLeft:r},_applyContentPadding:function(z,w,name,y){var A=this._getContentPaddingTarget();if(z==null){var x=this.__ma[name];A[x]();}
else {if(y==m||y==e){var B=this.__lY[name];A[B](z);}
else {var B=this.__lX[name];A[B](z);}
;}
;}
}});}
)();
(function(){var a="mousedown",b="Boolean",c="w-resize",d="sw-resize",f="n-resize",g="resizableRight",h="ne-resize",i="se-resize",j="Integer",k="e-resize",l="resizableLeft",m="mousemove",n="move",o="shorthand",p="maximized",q="resize",r="nw-resize",s="mouseout",t="qx.ui.core.MResizable",u="mouseup",v="losecapture",w="resize-frame",x="resizableBottom",y="s-resize",z="resizableTop";qx.Mixin.define(t,{construct:function(){var content=this.getContentElement();content.addListener(a,this.__mn,this,true);content.addListener(u,this.__mo,this);content.addListener(m,this.__mq,this);content.addListener(s,this.__mr,this);content.addListener(v,this.__mp,this);var A=content.getDomElement();if(A==null){A=window;}
;this.__mb=qx.event.Registration.getManager(A).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:b,init:true},resizableRight:{check:b,init:true},resizableBottom:{check:b,init:true},resizableLeft:{check:b,init:true},resizable:{group:[z,g,x,l],mode:o},resizeSensitivity:{check:j,init:5},useResizeFrame:{check:b,init:true}},members:{__mb:null,__mc:null,__md:null,__me:null,__mf:null,__mg:null,__mh:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var B=this.__mc;if(!B){B=this.__mc=new qx.ui.core.Widget();B.setAppearance(w);B.exclude();qx.core.Init.getApplication().getRoot().add(B);}
;return B;}
,__mi:function(){var location=this.getContentLocation();var C=this._getResizeFrame();C.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);C.show();C.setZIndex(this.getZIndex()+1);}
,__mj:function(e){var E=this.__md;var D=this.getSizeHint();var H=this.__mh;var G=this.__mg;var I=G.width;var F=G.height;var K=G.left;var top=G.top;var J;if((E&this.RESIZE_TOP)||(E&this.RESIZE_BOTTOM)){J=Math.max(H.top,Math.min(H.bottom,e.getDocumentTop()))-this.__mf;if(E&this.RESIZE_TOP){F-=J;}
else {F+=J;}
;if(F<D.minHeight){F=D.minHeight;}
else if(F>D.maxHeight){F=D.maxHeight;}
;if(E&this.RESIZE_TOP){top+=G.height-F;}
;}
;if((E&this.RESIZE_LEFT)||(E&this.RESIZE_RIGHT)){J=Math.max(H.left,Math.min(H.right,e.getDocumentLeft()))-this.__me;if(E&this.RESIZE_LEFT){I-=J;}
else {I+=J;}
...
,__mk:{'1':f,'2':y,'4':c,'8':k,'5':r,'6':d,'9':h,'10':i},__ml:function(e){var location=this.getContentLocation();var N=this.getResizeSensitivity();var O=e.getDocumentLeft();var M=e.getDocumentTop();var L=this.__mm(location,O,M,N);if(L>0){L=L|this.__mm(location,O,M,N*2);}
;this.__md=L;}
,__mm:function(location,S,R,P){var Q=0;if(this.getResizableTop()&&Math.abs(location.top-R)<P&&S>location.left-P&&S<location.right+P){Q+=this.RESIZE_TOP;}
...
;return Q;}
,__mn:function(e){if(!this.__md||!this.getEnabled()){return;}
;this.addState(q);this.__me=e.getDocumentLeft();this.__mf=e.getDocumentTop();var location=this.getContentLocation();var U=this.getBounds();this.__mg={top:location.top,left:location.left,width:location.right-location.left,height:location.bottom-location.top,bounds:qx.lang.Object.clone(U)};var parent=this.getLayoutParent();var V=parent.getContentLocation();var T=parent.getBounds();this.__mh={left:V.left,top:V.top,right:V.left+T.width,bottom:V.top+T.height};if(this.getUseResizeFrame()){this.__mi();}
;this.capture();e.stop();}
,__mo:function(e){if(!this.hasState(q)||!this.getEnabled()){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var W=this.__mj(e);this.setWidth(W.width);this.setHeight(W.height);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:W.parentLeft,top:W.parentTop});}
;this.__md=0;this.removeState(q);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__mp:function(e){if(!this.__md){return;}
...
;}
,__mq:function(e){if(!this.getEnabled()){return;}
;if(this.hasState(q)){var Y=this.__mj(e);if(this.getUseResizeFrame()){var X=this._getResizeFrame();X.setUserBounds(Y.viewportLeft,Y.viewportTop,Y.width,Y.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(p)&&!this.__mb.isSessionActive()){this.__ml(e);var bc=this.__md;var bb=this.getApplicationRoot();if(bc){var ba=this.__mk[bc];this.setCursor(ba);bb.setGlobalCursor(ba);}
else if(this.getCursor()){this.resetCursor();bb.resetGlobalCursor();}
;}
;}
,__mr:function(e){if(this.getCursor()&&!this.hasState(q)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__mc!=null&&!qx.core.ObjectRegistry.inShutDown){this.__mc.destroy();this.__mc=null;}
;this.__mb=null;}
});}
)();
(function(){var a="beforeClose",b="beforeMinimize",c="mousedown",d="Boolean",f="window-resize-frame",g="changeStatus",h="changeIcon",i="excluded",j="_applyModal",k="execute",l="dblclick",m="statusbar",n="qx.debug",o="_applyActive",p="active",q="minimize-button",r="qx.event.type.Event",s="close-button",t="beforeRestore",u="qx.ui.window.IDesktop. All root widgets implement this interface.",v="captionbar",w="String",x="minimize",y="modal",z="changeModal",A="title",B="icon",C="showStatusbar",D="changeAlwaysOnTop",E="_applyShowStatusbar",F="maximized",G="_applyStatus",H="qx.ui.window.Window",I="normal",J="Windows can only be added to widgets, which implement the interface ",K="changeCaption",L="statusbar-text",M="focusout",N="beforeMaximize",O="maximize",P="maximize-button",Q="restore",R="window",S="pane",T="close",U="changeActive",V="restore-button",W="_applyCaptionBarChange",X="Centering depends on parent bounds!",Y="minimized";qx.Class.define(H,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MRemoteLayoutHandling,qx.ui.core.MResizable,qx.ui.core.MMovable,qx.ui.core.MContentPadding],construct:function(ba,bb){qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.VBox());this._createChildControl(v);this._createChildControl(S);if(bb!=null){this.setIcon(bb);}
;if(ba!=null){this.setCaption(ba);}
;this._updateCaptionBar();this.addListener(c,this._onWindowMouseDown,this,true);this.addListener(M,this._onWindowFocusOut,this);qx.core.Init.getApplication().getRoot().add(this);this.initVisibility();qx.ui.core.FocusHandler.getInstance().addRoot(this);this._getResizeFrame().setAppearance(f);}
,statics:{DEFAULT_MANAGER_CLASS:qx.ui.window.Manager},events:{"beforeClose":r,"close":r,"beforeMinimize":r,"minimize":r,"beforeMaximize":r,"maximize":r,"beforeRestore":r,"restore":r},properties:{appearance:{refine:true,init:R},visibility:{refine:true,init:i},focusable:{refine:true,init:true},active:{check:d,init:false,apply:o,event:U},alwaysOnTop:{check:d,init:false,event:D},modal:{check:d,init:false,event:z,apply:j},caption:{apply:W,event:K,nullable:true},icon:{check:w,nullable:true,apply:W,event:h,themeable:true},status:{check:w,nullable:true,apply:G,event:g},showClose:{check:d,init:true,apply:W,themeable:true},showMaximize:{check:d,init:true,apply:W,themeable:true},showMinimize:{check:d,init:true,apply:W,themeable:true},allowClose:{check:d,init:true,apply:W},allowMaximize:{check:d,init:true,apply:W},allowMinimize:{check:d,init:true,apply:W},showStatusbar:{check:d,init:false,apply:E}},members:{__ms:null,__mt:null,getChildrenContainer:function(){return this.getChildControl(S);}
,_forwardStates:{active:true,maximized:true,showStatusbar:true,modal:true},setLayoutParent:function(parent){if(qx.core.Environment.get(n)){parent&&this.assertInterface(parent,qx.ui.window.IDesktop,J+u);}
;qx.ui.core.Widget.prototype.setLayoutParent.call(this,parent);}
,_createChildControlImpl:function(bg,bf){var bc;switch(bg){case m:bc=new qx.ui.container.Composite(new qx.ui.layout.HBox());this._add(bc);bc.add(this.getChildControl(L));break;case L:bc=new qx.ui.basic.Label();bc.setValue(this.getStatus());break;case S:bc=new qx.ui.container.Composite();this._add(bc,{flex:1});break;case v:var bd=new qx.ui.layout.Grid();bd.setRowFlex(0,1);bd.setColumnFlex(1,1);bc=new qx.ui.container.Composite(bd);this._add(bc);bc.addListener(l,this._onCaptionMouseDblClick,this);this._activateMoveHandle(bc);break;case B:bc=new qx.ui.basic.Image(this.getIcon());this.getChildControl(v).add(bc,{row:0,column:0});break;case A:bc=new qx.ui.basic.Label(this.getCaption());bc.setWidth(0);bc.setAllowGrowX(true);var be=this.getChildControl(v);be.add(bc,{row:0,column:1});break;case q:bc=new qx.ui.form.Button();bc.setFocusable(false);bc.addListener(k,this._onMinimizeButtonClick,this);this.getChildControl(v).add(bc,{row:0,column:2});break;case V:bc=new qx.ui.form.Button();bc.setFocusable(false);bc.addListener(k,this._onRestoreButtonClick,this);this.getChildControl(v).add(bc,{row:0,column:3});break;case P:bc=new qx.ui.form.Button();bc.setFocusable(false);bc.addListener(k,this._onMaximizeButtonClick,this);this.getChildControl(v).add(bc,{row:0,column:4});break;case s:bc=new qx.ui.form.Button();bc.setFocusable(false);bc.addListener(k,this._onCloseButtonClick,this);this.getChildControl(v).add(bc,{row:0,column:6});break;};return bc||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bg);}
,_updateCaptionBar:function(){var bi;var bj=this.getIcon();if(bj){this.getChildControl(B).setSource(bj);this._showChildControl(B);}
else {this._excludeChildControl(B);}
;var bh=this.getCaption();if(bh){this.getChildControl(A).setValue(bh);this._showChildControl(A);}
else {this._excludeChildControl(A);}
;if(this.getShowMinimize()){this._showChildControl(q);bi=this.getChildControl(q);this.getAllowMinimize()?bi.resetEnabled():bi.setEnabled(false);}
else {this._excludeChildControl(q);}
;if(this.getShowMaximize()){if(this.isMaximized()){this._showChildControl(V);this._excludeChildControl(P);}
else {this._showChildControl(P);this._excludeChildControl(V);}
;bi=this.getChildControl(P);this.getAllowMaximize()?bi.resetEnabled():bi.setEnabled(false);}
else {this._excludeChildControl(P);this._excludeChildControl(V);}
;if(this.getShowClose()){this._showChildControl(s);bi=this.getChildControl(s);this.getAllowClose()?bi.resetEnabled():bi.setEnabled(false);}
else {this._excludeChildControl(s);}
;}
,close:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(a,qx.event.type.Event,[false,true])){this.hide();this.fireEvent(T);}
;}
...
;}
;if(qx.core.Environment.get(n)){this.warn(X);}
;}
,maximize:function(){if(this.isMaximized()){return;}
;var parent=this.getLayoutParent();if(parent!=null&&parent.supportsMaximize()){if(this.fireNonBubblingEvent(N,qx.event.type.Event,[false,true])){if(!this.isVisible()){this.open();}
;var bn=this.getLayoutProperties();this.__mt=bn.left===undefined?0:bn.left;this.__ms=bn.top===undefined?0:bn.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(F);this._updateCaptionBar();this.fireEvent(O);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(b,qx.event.type.Event,[false,true])){var bo=this.getLayoutProperties();this.__mt=bo.left===undefined?0:bo.left;this.__ms=bo.top===undefined?0:bo.top;this.removeState(F);this.hide();this.fireEvent(x);}
;}
,restore:function(){if(this.getMode()===I){return;}
;if(this.fireNonBubblingEvent(t,qx.event.type.Event,[false,true])){if(!this.isVisible()){this.open();}
;var bp=this.__mt;var top=this.__ms;this.setLayoutProperties({edge:null,left:bp,top:top});this.removeState(F);this._updateCaptionBar();this.fireEvent(Q);}
;}
...
;}
;}
,_applyActive:function(bs,br){if(br){this.removeState(p);}
else {this.addState(p);}
;}
,_applyModal:function(bu,bt){if(bt){this.removeState(y);}
else {this.addState(y);}
;}
,_getContentPaddingTarget:function(){return this.getChildControl(S);}
,_applyShowStatusbar:function(bx,bv){var bw=this._getResizeFrame();if(bx){this.addState(C);bw.addState(C);}
else {this.removeState(C);bw.removeState(C);}
;if(bx){this._showChildControl(m);}
else {this._excludeChildControl(m);}
;}
,_applyCaptionBarChange:function(bz,by){this._updateCaptionBar();}
,_applyStatus:function(bB,bA){var bC=this.getChildControl(L,true);if(bC){bC.setValue(bB);}
;}
...
,_onRestoreButtonClick:function(e){this.restore();this.getChildControl(V).reset();}
,_onMaximizeButtonClick:function(e){this.maximize();this.getChildControl(P).reset();}
...
;if(v){this.setSeparator(v);}
;}
,properties:{alignY:{check:[k,o,f],init:k,apply:b},alignX:{check:[m,c,r],init:m,apply:b},spacing:{check:p,init:0,apply:b},separator:{check:a,nullable:true,apply:b},reversed:{check:s,init:false,apply:d}},members:{__mu:null,__lo:null,__lp:null,__gV:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__lq:function(){var B=this._getLayoutChildren();var length=B.length;var x=false;var w=this.__mu&&this.__mu.length!=length&&this.__lo&&this.__mu;var z;var y=w?this.__mu:new Array(length);var A=w?this.__lo:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__mu=y;this.__lo=A;}
;this.__lp=x;this.__gV=B;delete this._invalidChildrenCache;}
...
;var i,ba,G,O;var P=[];var W=H;for(i=0;i<length;i+=1){O=this.__mu[i];G=O!=null?Math.floor((N-H)*O):K[i].getSizeHint().height;P.push(G);W+=G;}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__lq();}
;var be=qx.ui.layout.Util;var bs=this.__gV;var bh=0,bi=0,bq=0;var bj=0,bk=0;var bo,bf,br;for(var i=0,l=bs.length;i<l;i+=1){bo=bs[i];bf=bo.getSizeHint();bi+=bf.height;var bn=this.__lo[i];var bg=this.__mu[i];if(bn){bh+=bf.minHeight;}
...
},destruct:function(){this.__mu=this.__lo=this.__gV=null;}
});}
)();
...
,members:{__mv:null,__mw:null,__mx:null,__my:null,connectTo:function(m){m.addListener(a,this.__iE,this);m.addListener(j,this._onFocusIn,this,true);m.addListener(b,this._onFocusOut,this,true);m.addListener(d,this._onActivate,this,true);m.addListener(h,this._onDeactivate,this,true);}
...
;}
,__iE:function(e){if(e.getKeyIdentifier()!=f){return;}
;if(!this.__my){return;}
...
(function(){var a="' must be defined!",b="height",c="vAlign",d="hAlign",e="' is not supported by the Grid layout!",f="bottom",g="Invalid parameter 'column'",h="Integer",m="The property '",n="'",o="_applyLayoutChange",p="qx.debug",q="Value must be positive",r="center",s="qx.ui.layout.Grid",t="middle",u="maxHeight",v="Cannot add widget '",w="width",z=") for '",A="'!. ",B="top",C="minHeight",D="right",E="' in this cell (",F=", ",G="The layout properties 'row' and 'column' of the child widget '",H="minWidth",I="flex",J="left",K="maxWidth",L="Invalid parameter 'row'",M="There is already a widget '";qx.Class.define(s,{extend:qx.ui.layout.Abstract,construct:function(O,N){qx.ui.layout.Abstract.call(this);this.__mJ=[];this.__mK=[];if(O){this.setSpacingX(O);}
;if(N){this.setSpacingY(N);}
;}
,properties:{spacingX:{check:h,init:0,apply:o},spacingY:{check:h,init:0,apply:o}},members:{__mL:null,__mJ:null,__mK:null,__mM:null,__mN:null,__mO:null,__mP:null,__mQ:null,__mR:null,verifyLayoutProperty:qx.core.Environment.select(p,{"true":function(P,name,Q){var R={"row":1,"column":1,"rowSpan":1,"colSpan":1};this.assert(R[name]==1,m+name+e);this.assertInteger(Q);this.assert(Q>=0,q);}
,"false":null}),__mS:function(){var Y=[];var T=[];var W=[];var V=-1;var S=-1;var X=this._getLayoutChildren();for(var i=0,l=X.length;i<l;i++ ){var ba=X[i];var bb=ba.getLayoutProperties();var bc=bb.row;var U=bb.column;bb.colSpan=bb.colSpan||1;bb.rowSpan=bb.rowSpan||1;if(bc==null||U==null){throw new Error(G+ba+a);}
...
;}
;this.__mL=Y;this.__mM=T;this.__mN=W;this.__mO=V;this.__mP=S;this.__mQ=null;this.__mR=null;delete this._invalidChildrenCache;}
,_setRowData:function(bg,be,bf){var bd=this.__mJ[bg];if(!bd){this.__mJ[bg]={};this.__mJ[bg][be]=bf;}
else {bd[be]=bf;}
;}
,_setColumnData:function(bh,bj,bk){var bi=this.__mK[bh];if(!bi){this.__mK[bh]={};this.__mK[bh][bj]=bk;}
else {bi[bj]=bk;}
;}
...
,getColumnAlign:function(bp){var bq=this.__mK[bp]||{};return {vAlign:bq.vAlign||B,hAlign:bq.hAlign||J};}
...
,getRowAlign:function(bv){var bu=this.__mJ[bv]||{};return {vAlign:bu.vAlign||B,hAlign:bu.hAlign||J};}
,getCellWidget:function(bx,bw){if(this._invalidChildrenCache){this.__mS();}
;var bx=this.__mL[bx]||{};return bx[bw]||null;}
...
;return this.__mP+1;}
,getCellAlign:function(bF,bz){var bE=B;var bC=J;var bD=this.__mJ[bF];var bA=this.__mK[bz];var by=this.__mL[bF][bz];if(by){var bB={vAlign:by.getAlignY(),hAlign:by.getAlignX()};}
else {bB={};}
...
,getColumnFlex:function(bI){var bJ=this.__mK[bI]||{};return bJ.flex!==undefined?bJ.flex:0;}
,setRowFlex:function(bL,bK){this._setRowData(bL,I,bK);this._applyLayoutChange();return this;}
,getRowFlex:function(bO){var bM=this.__mJ[bO]||{};var bN=bM.flex!==undefined?bM.flex:0;return bN;}
,setColumnMaxWidth:function(bP,bQ){this._setColumnData(bP,K,bQ);this._applyLayoutChange();return this;}
,getColumnMaxWidth:function(bR){var bS=this.__mK[bR]||{};return bS.maxWidth!==undefined?bS.maxWidth:Infinity;}
,setColumnWidth:function(bT,bU){this._setColumnData(bT,w,bU);this._applyLayoutChange();return this;}
,getColumnWidth:function(bV){var bW=this.__mK[bV]||{};return bW.width!==undefined?bW.width:null;}
,setColumnMinWidth:function(bX,bY){this._setColumnData(bX,H,bY);this._applyLayoutChange();return this;}
,getColumnMinWidth:function(ca){var cb=this.__mK[ca]||{};return cb.minWidth||0;}
,setRowMaxHeight:function(cd,cc){this._setRowData(cd,u,cc);this._applyLayoutChange();return this;}
,getRowMaxHeight:function(cf){var ce=this.__mJ[cf]||{};return ce.maxHeight||Infinity;}
,setRowHeight:function(cg,ch){this._setRowData(cg,b,ch);this._applyLayoutChange();return this;}
,getRowHeight:function(cj){var ci=this.__mJ[cj]||{};return ci.height!==undefined?ci.height:null;}
,setRowMinHeight:function(cl,ck){this._setRowData(cl,C,ck);this._applyLayoutChange();return this;}
,getRowMinHeight:function(cn){var cm=this.__mJ[cn]||{};return cm.minHeight||0;}
,__mT:function(cp){var co=cp.getSizeHint();var cr=cp.getMarginLeft()+cp.getMarginRight();var cq=cp.getMarginTop()+cp.getMarginBottom();var cs={height:co.height+cq,width:co.width+cr,minHeight:co.minHeight+cq,minWidth:co.minWidth+cr,maxHeight:co.maxHeight+cq,maxWidth:co.maxWidth+cr};return cs;}
,_fixHeightsRowSpan:function(cN){var cz=this.getSpacingY();for(var i=0,l=this.__mN.length;i<l;i++ ){var cF=this.__mN[i];var cC=this.__mT(cF);var cv=cF.getLayoutProperties();var cB=cv.row;var cK=cz*(cv.rowSpan-1);var ct=cK;var cw={};for(var j=0;j<cv.rowSpan;j++ ){var cA=cv.row+j;var cJ=cN[cA];var cL=this.getRowFlex(cA);if(cL>0){cw[cA]={min:cJ.minHeight,value:cJ.height,max:cJ.maxHeight,flex:cL};}
...
;}
;}
,_fixWidthsColSpan:function(cR){var cS=this.getSpacingX();for(var i=0,l=this.__mM.length;i<l;i++ ){var cO=this.__mM[i];var cQ=this.__mT(cO);var cU=cO.getLayoutProperties();var cP=cU.column;var db=cS*(cU.colSpan-1);var cT=db;var cV={};var cX;for(var j=0;j<cU.colSpan;j++ ){var cW=cU.column+j;var da=cR[cW];var cY=this.getColumnFlex(cW);if(cY>0){cV[cW]={min:da.minWidth,value:da.width,max:da.maxWidth,flex:cY};}
...
;var dm=[];var df=this.__mO;var de=this.__mP;for(var dn=0;dn<=df;dn++ ){var dg=0;var di=0;var dh=0;for(var dl=0;dl<=de;dl++ ){var dd=this.__mL[dn][dl];if(!dd){continue;}
;var dj=dd.getLayoutProperties().rowSpan||0;if(dj>1){continue;}
;var dk=this.__mT(dd);if(this.getRowFlex(dn)>0){dg=Math.max(dg,dk.minHeight);}
...
;if(this.__mN.length>0){this._fixHeightsRowSpan(dm);}
;this.__mQ=dm;return dm;}
,_getColWidths:function(){if(this.__mR!=null){return this.__mR;}
;var dt=[];var dq=this.__mP;var ds=this.__mO;for(var dy=0;dy<=dq;dy++ ){var dw=0;var dv=0;var dr=Infinity;for(var dz=0;dz<=ds;dz++ ){var dp=this.__mL[dz][dy];if(!dp){continue;}
;var du=dp.getLayoutProperties().colSpan||0;if(du>1){continue;}
;var dx=this.__mT(dp);if(this.getColumnFlex(dy)>0){dv=Math.max(dv,dx.minWidth);}
...
;if(this.__mM.length>0){this._fixWidthsColSpan(dt);}
;this.__mR=dt;return dt;}
...
,renderLayout:function(ej,dO,ei){if(this._invalidChildrenCache){this.__mS();}
;var ed=qx.ui.layout.Util;var dQ=this.getSpacingX();var dW=this.getSpacingY();var eh=this._getColWidths();var ek=this._getColumnFlexOffsets(ej);var dR=[];var em=this.__mP;var dP=this.__mO;var el;for(var en=0;en<=em;en++ ){el=ek[en]?ek[en].offset:0;dR[en]=eh[en].width+el;}
...
;var er=0;for(var en=0;en<=em;en++ ){var top=0;for(var dX=0;dX<=dP;dX++ ){var ef=this.__mL[dX][en];if(!ef){top+=et[dX]+dW;continue;}
...
;er+=dR[en]+dQ;}
;}
,invalidateLayoutCache:function(){qx.ui.layout.Abstract.prototype.invalidateLayoutCache.call(this);this.__mR=null;this.__mQ=null;}
...
(function(){var a="dblclick",b="qx.ui.form.Button",c="mouseup",d="mousedown",f="Enter",g="pressed",h="event.mspointer",i="hovered",j="mouseover",k="mouseout",l="mousemove",m="keydown",n="abandoned",o="button",p="keyup",q="Space";qx.Class.define(b,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(r,t,s){qx.ui.basic.Atom.call(this,r,t);if(s!=null){this.setCommand(s);}
;this.addListener(j,this._onMouseOver);this.addListener(k,this._onMouseOut);this.addListener(d,this._onMouseDown);this.addListener(c,this._onMouseUp);this.addListener(m,this._onKeyDown);this.addListener(p,this._onKeyUp);this.addListener(a,this._onStopEvent);if(qx.event.handler.MouseEmulation.ON&&!qx.core.Environment.get(h)){this.addListener(l,function(e){var x=this.getBounds();var u={left:e.getDocumentLeft(),top:e.getDocumentTop()};var v=u.left>x.left&&u.left<x.left+x.width;var w=u.top>x.top&&u.top<x.top+x.height;if(v&&w){this.addState(g);}
else {this.removeState(g);}
;}
);}
;}
,properties:{appearance:{refine:true,init:o},focusable:{refine:true,init:true}},members:{_forwardStates:{focused:true,hovered:true,pressed:true,disabled:true},press:function(){if(this.hasState(n)){return;}
;this.addState(g);}
,release:function(){if(this.hasState(g)){this.removeState(g);}
;}
,reset:function(){this.removeState(g);this.removeState(n);this.removeState(i);}
,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;if(this.hasState(n)){this.removeState(n);this.addState(g);}
;this.addState(i);}
,_onMouseOut:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.removeState(i);if(this.hasState(g)){this.removeState(g);this.addState(n);}
;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;e.stopPropagation();this.capture();this.removeState(n);this.addState(g);}
,_onMouseUp:function(e){this.releaseCapture();var y=this.hasState(g);var z=this.hasState(n);if(y){this.removeState(g);}
;if(z){this.removeState(n);}
else {if(y){this.execute();}
;}
;e.stopPropagation();}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case f:case q:this.removeState(n);this.addState(g);e.stopPropagation();};}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case f:case q:if(this.hasState(g)){this.removeState(n);this.removeState(g);this.execute();e.stopPropagation();}
;};}
}});}
)();
(function(){var a="_applyBlockerColor",b="Number",c="qx.debug",d="Please use 'isBlocked' instead.",e="Please use 'forceUnblock' instead.",f="qx.ui.core.MBlocker",g="_applyBlockerOpacity",h="Please use 'unblock' instead.",i="Color",j="__mY";qx.Mixin.define(f,{construct:function(){this.__mY=this._createBlocker();}
,properties:{blockerColor:{check:i,init:null,nullable:true,apply:a,themeable:true},blockerOpacity:{check:b,init:1,apply:g,themeable:true}},members:{__mY:null,_createBlocker:function(){return new qx.ui.core.Blocker(this);}
,_applyBlockerColor:function(l,k){this.__mY.setColor(l);}
,_applyBlockerOpacity:function(n,m){this.__mY.setOpacity(n);}
,block:function(){this.__mY.block();}
,isBlocked:function(){return this.__mY.isBlocked();}
,unblock:function(){this.__mY.unblock();}
,forceUnblock:function(){this.__mY.forceUnblock();}
,blockContent:function(o){this.__mY.blockContent(o);}
,isContentBlocked:function(){if(qx.core.Environment.get(c)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,d);}
;return this.__mY.isBlocked();}
,unblockContent:function(){if(qx.core.Environment.get(c)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,h);}
;this.__mY.unblock();}
,forceUnblockContent:function(){if(qx.core.Environment.get(c)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,e);}
;this.__mY.forceUnblock();}
,getBlocker:function(){return this.__mY;}
},destruct:function(){this._disposeObjects(j);}
});}
)();
(function(){var a="qx.dyntheme",b="backgroundColor",c="_applyOpacity",d="Boolean",f="px",g="keydown",h="deactivate",j="changeTheme",k="opacity",l="qx.debug",m="Please use 'isBlocked' instead.",n="Tab",o="qx.event.type.Event",p="move",q="Please use 'getBlockerElement' instead.",r="Please use 'unblock' instead.",s="Color",t="resize",u="zIndex",v="Please use 'forceUnblock' instead.",w="appear",x="qx.ui.root.Abstract",y="keyup",z="__jO",A="keypress",B="Number",C="unblocked",D="qx.ui.core.Blocker",E="disappear",F="blocked",G="__mY",H="_applyColor";qx.Class.define(D,{extend:qx.core.Object,events:{blocked:o,unblocked:o},construct:function(I){qx.core.Object.call(this);this._widget=I;I.addListener(t,this.__ne,this);I.addListener(p,this.__ne,this);I.addListener(E,this.__ng,this);if(qx.Class.isDefined(x)&&I instanceof qx.ui.root.Abstract){this._isRoot=true;this.setKeepBlockerActive(true);}
;if(qx.core.Environment.get(a)){qx.theme.manager.Color.getInstance().addListener(j,this._onChangeTheme,this);}
;this.__na=[];this.__nb=[];}
,properties:{color:{check:s,init:null,nullable:true,apply:H,themeable:true},opacity:{check:B,init:1,apply:c,themeable:true},keepBlockerActive:{check:d,init:false}},members:{__mY:null,__nc:0,__na:null,__nb:null,__jO:null,_widget:null,_isRoot:false,__nd:null,__ne:function(e){var J=e.getData();if(this.isBlocked()){this._updateBlockerBounds(J);}
;}
,__nf:function(){this._updateBlockerBounds(this._widget.getBounds());this._widget.getLayoutParent().getContentElement().add(this.getBlockerElement());}
,__ng:function(){if(this.isBlocked()){this.getBlockerElement().getParent().remove(this.getBlockerElement());this._widget.addListenerOnce(w,this.__nf,this);}
;}
...
,_applyColor:function(N,M){var L=qx.theme.manager.Color.getInstance().resolve(N);this.__nh(b,L);}
,_applyOpacity:function(P,O){this.__nh(k,P);}
,_onChangeTheme:qx.core.Environment.select(a,{"true":function(){this._applyColor(this.getColor());}
,"false":null}),__nh:function(R,S){var Q=[];this.__mY&&Q.push(this.__mY);for(var i=0;i<Q.length;i++ ){Q[i].setStyle(R,S);}
;}
,_backupActiveWidget:function(){var T=qx.event.Registration.getManager(window).getHandler(qx.event.handler.Focus);this.__na.push(T.getActive());this.__nb.push(T.getFocus());if(this._widget.isFocusable()){this._widget.focus();}
;}
,_restoreActiveWidget:function(){var W=this.__na.length;if(W>0){var V=this.__na[W-1];if(V){qx.bom.Element.activate(V);}
;this.__na.pop();}
;var U=this.__nb.length;if(U>0){var V=this.__nb[U-1];if(V){qx.bom.Element.focus(this.__nb[U-1]);}
;this.__nb.pop();}
;}
,__ni:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());}
,getBlockerElement:function(X){if(!this.__mY){this.__mY=this.__ni();this.__mY.setStyle(u,15);if(!X){if(this._isRoot){X=this._widget;}
else {X=this._widget.getLayoutParent();}
;}
;X.getContentElement().add(this.__mY);this.__mY.exclude();}
;return this.__mY;}
,block:function(){this._block();}
,_block:function(Y,bb){if(!this._isRoot&&!this._widget.getLayoutParent()){this.__nd=this._widget.addListenerOnce(w,this._block.bind(this,Y));return;}
...
;this.__nc++ ;if(this.__nc<2){this._backupActiveWidget();var bc=this._widget.getBounds();if(bc){this._updateBlockerBounds(bc);}
;ba.include();if(!bb){ba.activate();}
;ba.addListener(h,this.__nl,this);ba.addListener(A,this.__nk,this);ba.addListener(g,this.__nk,this);ba.addListener(y,this.__nk,this);this.fireEvent(F,qx.event.type.Event);}
;}
,isBlocked:function(){return this.__nc>0;}
,unblock:function(){if(this.__nd){this._widget.removeListenerById(this.__nd);}
;if(!this.isBlocked()){return;}
;this.__nc-- ;if(this.__nc<1){this.__nj();this.__nc=0;}
;}
,forceUnblock:function(){if(!this.isBlocked()){return;}
;this.__nc=0;this.__nj();}
,__nj:function(){this._restoreActiveWidget();var bd=this.getBlockerElement();bd.removeListener(h,this.__nl,this);bd.removeListener(A,this.__nk,this);bd.removeListener(g,this.__nk,this);bd.removeListener(y,this.__nk,this);bd.exclude();this.fireEvent(C,qx.event.type.Event);}
...
;this.unblock();}
,forceUnblockContent:function(){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,v);}
;this.forceUnblock();}
,__nk:function(e){if(e.getKeyIdentifier()==n){e.stop();}
;}
,__nl:function(){if(this.getKeepBlockerActive()){this.getBlockerElement().activate();}
;}
...
;this._widget.removeListener(t,this.__ne,this);this._widget.removeListener(p,this.__ne,this);this._widget.removeListener(w,this.__nf,this);this._widget.removeListener(E,this.__ng,this);if(this.__nd){this._widget.removeListenerById(this.__nd);}
;this._disposeObjects(G,z);this.__na=this.__nb=this._widget=null;}
});}
)();
...
;qx.html.Element.call(this,q,x);this.addListener(f,this._stopPropagation,this);this.addListener(o,this._stopPropagation,this);this.addListener(s,this._stopPropagation,this);this.addListener(a,this._stopPropagation,this);this.addListener(p,this._stopPropagation,this);this.addListener(l,this._stopPropagation,this);this.addListener(m,this._stopPropagation,this);this.addListener(j,this._stopPropagation,this);this.addListener(r,this._stopPropagation,this);this.addListener(h,this.__nm,this);this.addListener(g,this.__nm,this);}
,members:{_stopPropagation:function(e){e.stopPropagation();}
,__nm:function(){var z=this.getStyle(u);this.setStyle(u,null,true);this.setStyle(u,z,true);}
}});}
)();
(function(){var a="changeGlobalCursor",b="engine.name",c="keypress",d="Boolean",f="root",g="help",h="",i="contextmenu",j=" !important",k="input",l="_applyGlobalCursor",m="Space",n="_applyNativeHelp",o=";",p="event.help",q="qx.ui.root.Abstract",r="abstract",s="textarea",t="String",u="*";qx.Class.define(q,{type:r,extend:qx.ui.core.Widget,include:[qx.ui.core.MChildrenHandling,qx.ui.core.MBlocker,qx.ui.window.MDesktop],construct:function(){qx.ui.core.Widget.call(this);qx.ui.core.FocusHandler.getInstance().addRoot(this);qx.ui.core.queue.Visibility.add(this);this.initNativeHelp();this.addListener(c,this.__no,this);}
,properties:{appearance:{refine:true,init:f},enabled:{refine:true,init:true},focusable:{refine:true,init:true},globalCursor:{check:t,nullable:true,themeable:true,apply:l,event:a},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:d,init:false,apply:n}},members:{__nn:null,isRootWidget:function(){return true;}
,getLayout:function(){return this._getLayout();}
,_applyGlobalCursor:qx.core.Environment.select(b,{"mshtml":function(w,v){}
,"default":function(A,z){var y=qx.bom.Stylesheet;var x=this.__nn;if(!x){this.__nn=x=y.createElement();}
...
;e.preventDefault();}
,__no:function(e){if(e.getKeyIdentifier()!==m){return;}
...
,members:{__cx:null,__np:null,_createContentElement:function(){var u=this.__np;if((qx.core.Environment.get(g)==h)){if(!u.body){alert(j);}
;}
...
},destruct:function(){this.__cx=this.__np=null;}
});}
)();
(function(){var a="': ",b="width",c="qx.ui.layout.Canvas",d="number",e="qx.debug",f="height",g="Bad format of layout property '",h="' is not supported by the Canvas layout!",j=". The value must be either an integer or an percent string.",k="The property '";qx.Class.define(c,{extend:qx.ui.layout.Abstract,members:{verifyLayoutProperty:qx.core.Environment.select(e,{"true":function(o,name,n){var m={top:1,left:1,bottom:1,right:1,width:1,height:1,edge:1};this.assert(m[name]==1,k+name+h);if(name==b||name==f){this.assertMatch(n,qx.ui.layout.Util.PERCENT_VALUE);}
else {if(typeof n===d){this.assertInteger(n);}
else if(qx.lang.Type.isString(n)){this.assertMatch(n,qx.ui.layout.Util.PERCENT_VALUE);}
else {this.fail(g+name+a+n+j);}
;}
;}
,"false":null}),renderLayout:function(s,u,w){var C=this._getLayoutChildren();var p,E,B;var r,top,q,t,x,v;var A,z,D,y;for(var i=0,l=C.length;i<l;i++ ){p=C[i];E=p.getSizeHint();B=p.getLayoutProperties();A=p.getMarginTop();z=p.getMarginRight();D=p.getMarginBottom();y=p.getMarginLeft();r=B.left!=null?B.left:B.edge;if(qx.lang.Type.isString(r)){r=Math.round(parseFloat(r)*s/100);}
;q=B.right!=null?B.right:B.edge;if(qx.lang.Type.isString(q)){q=Math.round(parseFloat(q)*s/100);}
;top=B.top!=null?B.top:B.edge;if(qx.lang.Type.isString(top)){top=Math.round(parseFloat(top)*u/100);}
;t=B.bottom!=null?B.bottom:B.edge;if(qx.lang.Type.isString(t)){t=Math.round(parseFloat(t)*u/100);}
;if(r!=null&&q!=null){x=s-r-q-y-z;if(x<E.minWidth){x=E.minWidth;}
else if(x>E.maxWidth){x=E.maxWidth;}
;r+=y;}
else {x=B.width;if(x==null){x=E.width;}
else {x=Math.round(parseFloat(x)*s/100);if(x<E.minWidth){x=E.minWidth;}
else if(x>E.maxWidth){x=E.maxWidth;}
;}
;if(q!=null){r=s-x-q-z-y;}
else if(r==null){r=y;}
else {r+=y;}
;}
;if(top!=null&&t!=null){v=u-top-t-A-D;if(v<E.minHeight){v=E.minHeight;}
else if(v>E.maxHeight){v=E.maxHeight;}
;top+=A;}
else {v=B.height;if(v==null){v=E.height;}
else {v=Math.round(parseFloat(v)*u/100);if(v<E.minHeight){v=E.minHeight;}
else if(v>E.maxHeight){v=E.maxHeight;}
;}
;if(t!=null){top=u-v-t-D-A;}
else if(top==null){top=A;}
else {top+=A;}
;}
;r+=w.left;top+=w.top;p.renderLayout(r,top,x,v);}
;}
,_computeSizeHint:function(){var V=0,I=0;var S=0,R=0;var Q,F;var N,L;var U=this._getLayoutChildren();var G,K,J;var T,top,H,M;for(var i=0,l=U.length;i<l;i++ ){G=U[i];K=G.getLayoutProperties();J=G.getSizeHint();var P=G.getMarginLeft()+G.getMarginRight();var O=G.getMarginTop()+G.getMarginBottom();Q=J.width+P;F=J.minWidth+P;T=K.left!=null?K.left:K.edge;if(T&&typeof T===d){Q+=T;F+=T;}
;H=K.right!=null?K.right:K.edge;if(H&&typeof H===d){Q+=H;F+=H;}
;V=Math.max(V,Q);I=Math.max(I,F);N=J.height+O;L=J.minHeight+O;top=K.top!=null?K.top:K.edge;if(top&&typeof top===d){N+=top;L+=top;}
;M=K.bottom!=null?K.bottom:K.edge;if(M&&typeof M===d){N+=M;L+=M;}
;S=Math.max(S,N);R=Math.max(R,L);}
;return {width:V,minWidth:I,height:S,minHeight:R};}
}});}
)();
...
(function(){var a="name",b="group.checked",c="#ddd",d="Fruits",f="label",g="Apple",h="Carrot",j="Vegetables",k="demobrowser.demo.virtual.SettingsList",l="value",m="changeValue",n="Orange",o="Potato",p="checked";qx.Class.define(k,{extend:qx.application.Standalone,members:{__cN:null,main:function(){qx.application.Standalone.prototype.main.call(this);var q=[];var s=[g,n,o,h];for(var i=0;i<s.length;i++ ){q[i]={name:s[i],checked:i<2,group:null};}
;this.__cN=qx.data.marshal.Json.createModel(q,true);var t=[];for(var i=0;i<2;i++ ){t[i]={name:null,checked:false};}
;t=qx.data.marshal.Json.createModel(t,true);t.getItem(0).setName(d);t.getItem(1).setName(j);this.__cN.toArray().forEach(function(u,v){v=v<2?0:1;u.setGroup(t.getItem(v));}
);var r=new qx.ui.list.List();r.setWidth(150);this.getRoot().add(r,{left:20,top:20});r.setDelegate(this);r.setModel(this.__cN);}
...
;var y=e.getData();this.__cN.forEach(function(z){if(x.getLabel()==z.getGroup().getName()){z.setChecked(y);}
;}
);}
,this);}
,bindItem:function(B,A,D){B.bindProperty(a,f,null,A,D);B.bindProperty(p,l,null,A,D);B.bindPropertyReverse(p,l,null,A,D);var C=this.__cN;B.bindPropertyReverse(b,l,{converter:function(H,J){var I=J.getItem(D);var F=I.getGroup();var G=C.toArray().filter(function(L){return L.getGroup()==F;}
...
,bindGroupItem:function(O,P,Q){O.bindProperty(a,f,null,P,Q);O.bindProperty(p,l,null,P,Q);O.bindPropertyReverse(p,l,null,P,Q);}
,group:function(R){return R.getGroup();}
}});}
)();
...
(function(){var a='"',b="The model contained an illegal name: '",c="",d="qx.debug.databinding",e="change",f="qx.data.marshal.Json",g="Array",h="Unsupported type!",j="_validate",k="'.",l="'. Replaced it with '",m="set",n="' is not a valid JavaScript identifier.",o="_applyEventPropagation",p="qx.data.model.",q="qx.debug",r="The key '";qx.Class.define(f,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(s){qx.core.Object.call(this);this.__yf=s;}
...
},members:{__yf:null,__yg:function(v){return Object.keys(v).sort().join(a);}
,toClass:function(w,x){this.__yh(w,x,null,0);}
,__yh:function(J,E,y,G){if(!qx.lang.Type.isObject(J)||!!J.$$isString||J instanceof qx.core.Object){if(J instanceof Array||qx.Bootstrap.getClass(J)==g){for(var i=0;i<J.length;i++ ){this.__yh(J[i],E,null,G+1);}
;}
;return;}
;var A=this.__yg(J);if(this.__yl(A,y,G)){return;}
;for(var I in J){this.__yh(J[I],E,I,G+1);}
;if(qx.Class.isDefined(p+A)){return;}
;if(this.__yf&&this.__yf.getModelClass&&this.__yf.getModelClass(A,J)!=null){return;}
;var K={};var B={__yi:this.__yi};for(var I in J){if(this.__yf&&this.__yf.getPropertyMapping){I=this.__yf.getPropertyMapping(I,A);}
...
;if(this.__yf&&this.__yf.getValidationRule){var D=this.__yf.getValidationRule(A,I);if(D){K[I].validate=j+I;B[j+I]=D;}
;}
;}
;if(this.__yf&&this.__yf.getModelSuperClass){var H=this.__yf.getModelSuperClass(A)||qx.core.Object;}
else {var H=qx.core.Object;}
;var C=[];if(this.__yf&&this.__yf.getModelMixins){var F=this.__yf.getModelMixins(A);if(!qx.lang.Type.isArray(F)){if(F!=null){C=[F];}
;}
else {C=F;}
;}
;if(E){C.push(qx.data.marshal.MEventBubbling);}
;var z={extend:H,include:C,properties:K,members:B,destruct:this.__yj};qx.Class.define(p+A,z);}
,__yj:function(){var L=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var M in L){this.__yi(this.get(L[M].name));}
;}
,__yi:function(N){if(!(N instanceof qx.core.Object)){return;}
;if(N.isDisposed()){return;}
;N.dispose();}
,__yk:function(P,O){var Q;if(this.__yf&&this.__yf.getModelClass){Q=this.__yf.getModelClass(P,O);}
;if(Q!=null){return (new Q());}
else {var R=qx.Class.getByName(p+P);return (new R());}
;}
,__yl:function(S,V,T){var U=this.__yf;return U&&U.ignore&&U.ignore(S,V,T);}
,toModel:function(W){return this.__ym(W,null,0);}
,__ym:function(bh,Y,be){var bd=qx.lang.Type.isObject(bh);var X=bh instanceof Array||qx.Bootstrap.getClass(bh)==g;if((!bd&&!X)||!!bh.$$isString||bh instanceof qx.core.Object){return bh;}
else if(this.__yl(this.__yg(bh),Y,be)){return bh;}
else if(X){var bi=new qx.data.Array();bi.setAutoDisposeItems(true);for(var i=0;i<bh.length;i++ ){bi.push(this.__ym(bh[i],null,be+1));}
;return bi;}
else if(bd){var ba=this.__yg(bh);var bg=this.__yk(ba,bh);for(var bf in bh){var bb=bf;if(this.__yf&&this.__yf.getPropertyMapping){bb=this.__yf.getPropertyMapping(bf,ba);}
;var bj=bb.replace(/-|\.|\s+/g,c);if((qx.core.Environment.get(q))&&qx.core.Environment.get(d)){if(bj!=bb){this.warn(b+bf+l+bb+k);}
;}
;bb=bj;var bc=m+qx.lang.String.firstUp(bb);if(bg[bc]){bg[bc](this.__ym(bh[bf],bf,be+1));}
;}
;return bg;}
;throw new Error(h);}
...
;}
else if(typeof u==q){this.__pl=new Array(u);}
else if(u instanceof Array){this.__pl=qx.lang.Array.clone(u);}
else {this.__pl=[];this.dispose();throw new Error(l);}
;for(var i=0;i<this.__pl.length;i++ ){this._applyEventPropagation(this.__pl[i],null,i);}
;this.__pm();if(qx.core.Environment.get(k)){this[0]=h;}
;}
,properties:{autoDisposeItems:{check:e,init:false}},events:{"change":t,"changeLength":t},members:{__pl:null,concat:function(v){if(v){var w=this.__pl.concat(v);}
else {var w=this.__pl.concat();}
;return new qx.data.Array(w);}
,join:function(x){return this.__pl.join(x);}
,pop:function(){var y=this.__pl.pop();this.__pm();this._registerEventChaining(null,y,this.length-1);this.fireDataEvent(r,{value:[],name:this.length+f,old:[y],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:g,items:[y],removed:[y],added:[]},null);return y;}
,push:function(z){for(var i=0;i<arguments.length;i++ ){this.__pl.push(arguments[i]);this.__pm();this._registerEventChaining(arguments[i],null,this.length-1);this.fireDataEvent(r,{value:[arguments[i]],name:(this.length-1)+f,old:[],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:b,items:[arguments[i]],added:[arguments[i]],removed:[]},null);}
;return this.length;}
,reverse:function(){if(this.length==0){return;}
;var A=this.__pl.concat();this.__pl.reverse();this.__pn(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,items:null,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__pl,name:n+(this.__pl.length-1),old:A,item:this});}
,shift:function(){if(this.length==0){return;}
;var B=this.__pl.shift();this.__pm();this._registerEventChaining(null,B,this.length-1);this.__pn(0,this.length);this.fireDataEvent(r,{value:[],name:p,old:[B],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:g,items:[B],removed:[B],added:[]},null);return B;}
,slice:function(D,C){return new qx.data.Array(this.__pl.slice(D,C));}
,splice:function(J,L,N){var Q=this.__pl.length;var M=this.__pl.splice.apply(this.__pl,arguments);if(this.__pl.length!=Q){this.__pm();}
...
;this.__pn(J+(arguments.length-2)-L,this.length);var K=[];for(var i=2;i<arguments.length;i++ ){K[i-2]=arguments[i];}
...
;var R=this.__pl.concat();this.__pl.sort.apply(this.__pl,arguments);if(qx.lang.Array.equals(this.__pl,R)===true){return;}
;this.__pn(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,items:null,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__pl,name:n+(this.length-1),old:R,item:this});}
,unshift:function(T){for(var i=arguments.length-1;i>=0;i-- ){this.__pl.unshift(arguments[i]);this.__pm();this.__pn(0,this.length);this.fireDataEvent(r,{value:[this.__pl[0]],name:p,old:[this.__pl[1]],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:b,items:[arguments[i]],added:[arguments[i]],removed:[]},null);}
;return this.length;}
,toArray:function(){return this.__pl;}
,getItem:function(U){return this.__pl[U];}
,setItem:function(V,X){var W=this.__pl[V];if(W===X){return;}
;this.__pl[V]=X;this._registerEventChaining(X,W,V);if(this.length!=this.__pl.length){this.__pm();}
...
,indexOf:function(Y){return this.__pl.indexOf(Y);}
,lastIndexOf:function(ba){return this.__pl.lastIndexOf(ba);}
,toString:function(){if(this.__pl!=null){return this.__pl.toString();}
;return f;}
,contains:function(bb){return this.__pl.indexOf(bb)!==-1;}
...
;var bo=this.getLength();var bn=this.__pl.concat();this.__pl.length=0;this.__pm();this.fireDataEvent(r,{value:[],name:n+(bo-1),old:bn,item:this});this.fireDataEvent(o,{start:0,end:bo-1,type:g,items:bn,removed:bn,added:[]},null);return bn;}
...
;Array.prototype.push.apply(this.__pl,bp);for(var i=0;i<bp.length;i++ ){this._registerEventChaining(bp[i],null,this.__pl.length+i);}
;var bq=this.length;this.__pm();var name=bq==(this.length-1)?bq:bq+a+(this.length-1);this.fireDataEvent(r,{value:bp,name:name+f,old:[],item:this});this.fireDataEvent(o,{start:bq,end:this.length-1,type:b,items:bp,added:bp,removed:[]},null);}
...
,forEach:function(bx,by){for(var i=0;i<this.__pl.length;i++ ){bx.call(by,this.__pl[i],i,this);}
;}
,filter:function(bz,self){return new qx.data.Array(this.__pl.filter(bz,self));}
,map:function(bA,self){return new qx.data.Array(this.__pl.map(bA,self));}
,some:function(bB,self){return this.__pl.some(bB,self);}
,every:function(bC,self){return this.__pl.every(bC,self);}
,reduce:function(bE,bD){return this.__pl.reduce(bE,bD);}
,reduceRight:function(bG,bF){return this.__pl.reduceRight(bG,bF);}
,__pm:function(){var bH=this.length;this.length=this.__pl.length;this.fireDataEvent(s,this.length,bH);}
,__pn:function(bJ,bI){for(var i=bJ;i<bI;i++ ){this._registerEventChaining(this.__pl[i],this.__pl[i],i);}
;}
},destruct:function(){for(var i=0;i<this.__pl.length;i++ ){var bK=this.__pl[i];this._applyEventPropagation(null,bK,i);if(this.isAutoDisposeItems()&&bK&&bK instanceof qx.core.Object){bK.dispose();}
;}
;this.__pl=null;}
});}
)();
...
,_getContentHint:function(){var I=qx.bom.element.Scroll.getScrollbarWidth();return {width:this.__nN?100:I,maxWidth:this.__nN?null:I,minWidth:this.__nN?null:I,height:this.__nN?I:100,maxHeight:this.__nN?I:null,minHeight:this.__nN?I:null};}
...
,_applyPosition:function(M){var content=this.getContentElement();if(this.__nN){content.scrollToX(M);}
else {content.scrollToY(M);}
;}
,_applyOrientation:function(P,N){var O=this.__nN=P===w;this.set({allowGrowX:O,allowShrinkX:O,allowGrowY:!O,allowShrinkY:!O});if(O){this.replaceState(m,w);}
...
,_updateScrollBar:function(){var R=this.__nN;var S=this.getBounds();if(!S){return;}
...
,scrollTo:function(V,U){this.stopScrollAnimation();if(U){var W=this.getPosition();this.__oX=new qx.bom.AnimationFrame();this.__oX.on(g,function(Y){var X=parseInt(Y/U*(V-W)+W);this.updatePosition(X);}
,this);this.__oX.on(h,function(){this.setPosition(Math.max(0,Math.min(this.getMaximum(),V)));this.__oX=null;this.fireEvent(o);}
,this);this.__oX.startSequence(U);}
...
,stopScrollAnimation:function(){if(this.__oX){this.__oX.cancelSequence();this.__oX=null;}
;}
,_onScroll:function(e){var bg=this.getContentElement();var bh=this.__nN?bg.getScrollX():bg.getScrollY();this.setPosition(bh);}
...
;}
,events:{"scrollAnimationEnd":k},properties:{appearance:{refine:true,init:z},orientation:{check:[w,q],init:w,apply:r},maximum:{check:v,apply:A,init:100},position:{check:h,init:0,apply:y,event:E},singleStep:{check:f,init:20},pageStep:{check:f,init:10,apply:t},knobFactor:{check:c,apply:i,nullable:true}},members:{__wu:2,__wv:0,_computeSizeHint:function(){var G=qx.ui.core.Widget.prototype._computeSizeHint.call(this);if(this.getOrientation()===w){this.__wv=G.minWidth;G.minWidth=0;}
else {this.__wv=G.minHeight;G.minHeight=0;}
;return G;}
,renderLayout:function(L,top,I,H){var K=qx.ui.core.Widget.prototype.renderLayout.call(this,L,top,I,H);var J=this.getOrientation()===w;if(this.__wv>=(J?I:H)){this.getChildControl(m).setVisibility(n);this.getChildControl(C).setVisibility(n);}
...
,_onResizeSlider:function(e){var bf=this.getChildControl(a).getChildControl(l);var bi=bf.getSizeHint();var bg=false;var bh=this.getChildControl(a).getInnerSize();if(this.getOrientation()==q){if(bh.height<bi.minHeight+this.__wu){bg=true;}
;}
else {if(bh.width<bi.minWidth+this.__wu){bg=true;}
;}
;if(bg){bf.exclude();}
else {bf.show();}
;}
...
(function(){var a="",b="qx.ui.form.MForm",c="Boolean",d="_applyValid",f="changeLocale",g="changeRequired",h="changeValid",i="qx.dynlocale",j="changeInvalidMessage",k="String",l="invalid";qx.Mixin.define(b,{construct:function(){if(qx.core.Environment.get(i)){qx.locale.Manager.getInstance().addListener(f,this.__os,this);}
;}
...
,__os:qx.core.Environment.select(i,{"true":function(e){var o=this.getInvalidMessage();if(o&&o.translate){this.setInvalidMessage(o.translate());}
;var p=this.getRequiredInvalidMessage();if(p&&p.translate){this.setRequiredInvalidMessage(p.translate());}
;}
,"false":null})},destruct:function(){if(qx.core.Environment.get(i)){qx.locale.Manager.getInstance().removeListener(f,this.__os,this);}
;}
});}
)();
...
;}
,events:{changeValue:m,slideAnimationEnd:T},properties:{appearance:{refine:true,init:a},focusable:{refine:true,init:true},orientation:{check:[V,D],init:V,apply:G},value:{check:be,init:0,apply:w,nullable:true},minimum:{check:p,init:0,apply:L,event:bf},maximum:{check:p,init:100,apply:Y,event:O},singleStep:{check:p,init:1},pageStep:{check:p,init:10},knobFactor:{check:bd,apply:x,nullable:true}},members:{__ww:null,__wx:null,__wy:null,__wz:null,__wA:null,__wB:null,__wC:null,__wD:null,__jO:null,__wE:null,__wF:null,__wG:null,__oX:null,_forwardStates:{invalid:true},_createChildControlImpl:function(bj,bi){var bh;switch(bj){case R:bh=new qx.ui.core.Widget();bh.addListener(C,this._onUpdate,this);bh.addListener(J,this._onMouseOver);bh.addListener(i,this._onMouseOut);this._add(bh);break;};return bh||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bj);}
,_onMouseOver:function(e){this.addState(b);}
,_onMouseOut:function(e){this.removeState(b);}
,_onMouseWheel:function(e){var bl=this.getOrientation()===V?k:B;var bm=e.getWheelDelta(bl);if(qx.event.handler.MouseEmulation.ON){this.slideBy(bm);}
else {var bk=bm>0?1:bm<0?-1:0;this.slideBy(bk*this.getSingleStep());}
;e.stop();}
,_onKeyPress:function(e){var bo=this.getOrientation()===V;var bn=bo?n:q;var forward=bo?E:o;switch(e.getKeyIdentifier()){case forward:this.slideForward();break;case bn:this.slideBack();break;case t:this.slidePageForward(100);break;case g:this.slidePageBack(100);break;case I:this.slideToBegin(200);break;case y:this.slideToEnd(200);break;default:return;};e.stop();}
,_onMouseDown:function(e){if(this.__wz){return;}
;var br=this.__nN;var bp=this.getChildControl(R);var bq=br?H:N;var bv=br?e.getDocumentLeft():e.getDocumentTop();var bx=this.getDecorator();bx=qx.theme.manager.Decoration.getInstance().resolve(bx);if(br){var bu=bx?bx.getInsets().left:0;var bt=(this.getPaddingLeft()||0)+bu;}
else {var bu=bx?bx.getInsets().top:0;var bt=(this.getPaddingTop()||0)+bu;}
;var bw=this.__ww=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bq];bw+=bt;var bs=this.__wx=qx.bom.element.Location.get(bp.getContentElement().getDomElement())[bq];if(e.getTarget()===bp){this.__wz=true;if(!this.__wE){this.__wE=new qx.event.Timer(100);this.__wE.addListener(v,this._fireValue,this);}
;this.__wE.start();this.__wA=bv+bw-bs;bp.addState(d);}
else {this.__wB=true;this.__wC=bv<=bs?-1:1;this.__wI(e);this._onInterval();if(!this.__jO){this.__jO=new qx.event.Timer(100);this.__jO.addListener(v,this._onInterval,this);}
;this.__jO.start();}
;this.addListener(z,this._onMouseMove);this.capture();e.stopPropagation();}
,_onMouseUp:function(e){if(this.__wz){this.releaseCapture();delete this.__wz;this.__wE.stop();this._fireValue();delete this.__wA;this.getChildControl(R).removeState(d);if(e.getType()===U){var bz;var bA;var by;if(this.__nN){bz=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__ww);by=qx.bom.element.Location.get(this.getContentElement().getDomElement())[N];bA=e.getDocumentTop()-(by+this.getChildControl(R).getBounds().top);}
else {bz=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__ww);by=qx.bom.element.Location.get(this.getContentElement().getDomElement())[H];bA=e.getDocumentLeft()-(by+this.getChildControl(R).getBounds().left);}
;if(bA<0||bA>this.__wy||bz<0||bz>this.__wy){this.getChildControl(R).removeState(b);}
;}
;}
else if(this.__wB){this.__jO.stop();this.releaseCapture();delete this.__wB;delete this.__wC;delete this.__wD;}
;this.removeListener(z,this._onMouseMove);if(e.getType()===U){e.stopPropagation();}
;}
,_onMouseMove:function(e){if(this.__wz){var bC=this.__nN?e.getDocumentLeft():e.getDocumentTop();var bB=bC-this.__wA;this.slideTo(this._positionToValue(bB));}
else if(this.__wB){this.__wI(e);}
;e.stopPropagation();}
,_onInterval:function(e){var bD=this.getValue()+(this.__wC*this.getPageStep());if(bD<this.getMinimum()){bD=this.getMinimum();}
else if(bD>this.getMaximum()){bD=this.getMaximum();}
;var bE=this.__wC==-1;if((bE&&bD<=this.__wD)||(!bE&&bD>=this.__wD)){bD=this.__wD;}
;this.slideTo(bD);}
,_onUpdate:function(e){var bG=this.getInnerSize();var bH=this.getChildControl(R).getBounds();var bF=this.__nN?F:A;this._updateKnobSize();this.__wH=bG[bF]-bH[bF];this.__wy=bH[bF];this._updateKnobPosition();}
,__nN:false,__wH:0,__wI:function(e){var bI=this.__nN;var bP=bI?e.getDocumentLeft():e.getDocumentTop();var bS=this.__ww;var bJ=this.__wx;var bT=this.__wy;var bQ=bP-bS;if(bP>=bJ){bQ-=bT;}
;var bM=this._positionToValue(bQ);var bK=this.getMinimum();var bL=this.getMaximum();if(bM<bK){bM=bK;}
else if(bM>bL){bM=bL;}
else {var bR=this.getValue();var bO=this.getPageStep();var bN=this.__wC<0?K:S;bM=bR+(Math[bN]((bM-bR)/bO)*bO);}
;if(this.__wD==null||(this.__wC==-1&&bM<=this.__wD)||(this.__wC==1&&bM>=this.__wD)){this.__wD=bM;}
;}
,_positionToValue:function(bV){var bU=this.__wH;if(bU==null||bU==0){return 0;}
;var bX=bV/bU;if(bX<0){bX=0;}
else if(bX>1){bX=1;}
;var bW=this.getMaximum()-this.getMinimum();return this.getMinimum()+Math.round(bW*bX);}
,_valueToPosition:function(cc){var bY=this.__wH;if(bY==null){return 0;}
;var ca=this.getMaximum()-this.getMinimum();if(ca==0){return 0;}
;var cc=cc-this.getMinimum();var cb=cc/ca;if(cb<0){cb=0;}
else if(cb>1){cb=1;}
;return Math.round(bY*cb);}
,_updateKnobPosition:function(){this._setKnobPosition(this._valueToPosition(this.getValue()));}
,_setKnobPosition:function(cf){var cd=this.getChildControl(R);var ce=this.getDecorator();ce=qx.theme.manager.Decoration.getInstance().resolve(ce);var content=cd.getContentElement();if(this.__nN){if(ce&&ce.getPadding()){cf+=ce.getPadding().left;}
;cf+=this.getPaddingLeft()||0;content.setStyle(H,cf+f,true);}
else {if(ce&&ce.getPadding()){cf+=ce.getPadding().top;}
;cf+=this.getPaddingTop()||0;content.setStyle(N,cf+f,true);}
;}
,_updateKnobSize:function(){var ch=this.getKnobFactor();if(ch==null){return;}
;var cg=this.getInnerSize();if(cg==null){return;}
;if(this.__nN){this.getChildControl(R).setWidth(Math.round(ch*cg.width));}
else {this.getChildControl(R).setHeight(Math.round(ch*cg.height));}
;}
,slideToBegin:function(ci){this.slideTo(this.getMinimum(),ci);}
,slideToEnd:function(cj){this.slideTo(this.getMaximum(),cj);}
,slideForward:function(){this.slideBy(this.getSingleStep());}
,slideBack:function(){this.slideBy(-this.getSingleStep());}
,slidePageForward:function(ck){this.slideBy(this.getPageStep(),ck);}
,slidePageBack:function(cl){this.slideBy(-this.getPageStep(),cl);}
,slideBy:function(cn,cm){this.slideTo(this.getValue()+cn,cm);}
,slideTo:function(cp,co){this.stopSlideAnimation();if(co){this.__wK(cp,co);}
else {this.updatePosition(cp);}
;}
,updatePosition:function(cq){this.setValue(this.__wJ(cq));}
,stopSlideAnimation:function(){if(this.__oX){this.__oX.cancelSequence();this.__oX=null;}
;}
,__wJ:function(cr){if(cr<this.getMinimum()){cr=this.getMinimum();}
else if(cr>this.getMaximum()){cr=this.getMaximum();}
else {cr=this.getMinimum()+Math.round((cr-this.getMinimum())/this.getSingleStep())*this.getSingleStep();}
;return cr;}
,__wK:function(ct,cs){ct=this.__wJ(ct);var cu=this.getValue();this.__oX=new qx.bom.AnimationFrame();this.__oX.on(j,function(cv){this.setValue(parseInt(cv/cs*(ct-cu)+cu));}
,this);this.__oX.on(l,function(){this.setValue(ct);this.__oX=null;this.fireEvent(Q);}
,this);this.__oX.startSequence(cs);}
,_applyOrientation:function(cy,cx){var cw=this.getChildControl(R);this.__nN=cy===V;if(this.__nN){this.removeState(D);cw.removeState(D);this.addState(V);cw.addState(V);cw.setLayoutProperties({top:0,right:null,bottom:0});}
else {this.removeState(V);cw.removeState(V);this.addState(D);cw.addState(D);cw.setLayoutProperties({right:0,bottom:null,left:0});}
;this._updateKnobPosition();}
,_applyKnobFactor:function(cA,cz){if(cA!=null){this._updateKnobSize();}
else {if(this.__nN){this.getChildControl(R).resetWidth();}
else {this.getChildControl(R).resetHeight();}
;}
;}
,_applyValue:function(cC,cB){if(cC!=null){this._updateKnobPosition();if(this.__wz){this.__wG=[cC,cB];}
else {this.fireEvent(h,qx.event.type.Data,[cC,cB]);}
;}
else {this.resetValue();}
;}
,_fireValue:function(){if(!this.__wG){return;}
;var cD=this.__wG;this.__wG=null;this.fireEvent(h,qx.event.type.Data,cD);}
,_applyMinimum:function(cF,cE){if(this.getValue()<cF){this.setValue(cF);}
;this._updateKnobPosition();}
,_applyMaximum:function(cH,cG){if(this.getValue()>cH){this.setValue(cH);}
;this._updateKnobPosition();}
}});}
)();
...
(function(){var a="press",b="hovered",c="qx.ui.form.RepeatButton",d="release",f="Enter",g="pressed",h="interval",i="__jO",j="qx.event.type.Event",k="Space",l="abandoned",m="Integer",n="execute";qx.Class.define(c,{extend:qx.ui.form.Button,construct:function(o,p){qx.ui.form.Button.call(this,o,p);this.__jO=new qx.event.AcceleratingTimer();this.__jO.addListener(h,this._onInterval,this);}
,events:{"execute":j,"press":j,"release":j},properties:{interval:{check:m,init:100},firstInterval:{check:m,init:500},minTimer:{check:m,init:20},timerDecrease:{check:m,init:2}},members:{__sK:null,__jO:null,press:function(){if(this.isEnabled()){if(!this.hasState(g)){this.__sL();}
;this.removeState(l);this.addState(g);}
;}
,release:function(q){if(!this.isEnabled()){return;}
;if(this.hasState(g)){if(!this.__sK){this.execute();}
;}
;this.removeState(g);this.removeState(l);this.__sM();}
,_applyEnabled:function(s,r){qx.ui.form.Button.prototype._applyEnabled.call(this,s,r);if(!s){this.removeState(g);this.removeState(l);this.__sM();}
;}
,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;if(this.hasState(l)){this.removeState(l);this.addState(g);this.__jO.start();}
;this.addState(b);}
,_onMouseOut:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.removeState(b);if(this.hasState(g)){this.removeState(g);this.addState(l);this.__jO.stop();}
;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;this.capture();this.__sL();e.stopPropagation();}
,_onMouseUp:function(e){this.releaseCapture();if(!this.hasState(l)){this.addState(b);if(this.hasState(g)&&!this.__sK){this.execute();}
;}
;this.__sM();e.stopPropagation();}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case f:case k:if(this.hasState(g)){if(!this.__sK){this.execute();}
;this.removeState(g);this.removeState(l);e.stopPropagation();this.__sM();}
;};}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case f:case k:this.removeState(l);this.addState(g);e.stopPropagation();this.__sL();};}
,_onInterval:function(e){this.__sK=true;this.fireEvent(n);}
,__sL:function(){this.fireEvent(a);this.__sK=false;this.__jO.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.removeState(l);this.addState(g);}
,__sM:function(){this.fireEvent(d);this.__jO.stop();this.removeState(l);this.removeState(g);}
},destruct:function(){this._disposeObjects(i);}
});}
)();
(function(){var a="Integer",b="interval",c="qx.event.type.Event",d="qx.event.AcceleratingTimer",e="__jO";qx.Class.define(d,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__jO=new qx.event.Timer(this.getInterval());this.__jO.addListener(b,this._onInterval,this);}
,events:{"interval":c},properties:{interval:{check:a,init:100},firstInterval:{check:a,init:500},minimum:{check:a,init:20},decrease:{check:a,init:2}},members:{__jO:null,__sN:null,start:function(){this.__jO.setInterval(this.getFirstInterval());this.__jO.start();}
,stop:function(){this.__jO.stop();this.__sN=null;}
,_onInterval:function(){this.__jO.stop();if(this.__sN==null){this.__sN=this.getInterval();}
;this.__sN=Math.max(this.getMinimum(),this.__sN-this.getDecrease());this.__jO.setInterval(this.__sN);this.__jO.start();this.fireEvent(b);}
...
;this.__cO[bn]=e[m+bj]();bl.scrollBy(bm);if(this.__ig[bn]){clearTimeout(this.__ig[bn]);this.__ig[bn]=null;}
;this.__ig[bn]=setTimeout(qx.lang.Function.bind(function(bo){this.__ii(bo,bn);}
,this,bm),100);}
;}
,__ii:function(bp,br){this.__ig[br]=null;var bs=this._isChildControlVisible(n+br);if(bp==0||!bs){return;}
;if(bp>0){bp=Math.max(0,bp-3);}
else {bp=Math.min(0,bp+3);}
;this.__ig[br]=setTimeout(qx.lang.Function.bind(function(bu,bt){this.__ii(bu,bt);}
...
,events:{update:m,scrollAnimationEnd:m},properties:{scrollX:{check:j,apply:g,event:f,init:0},scrollY:{check:l,apply:h,event:b,init:0}},members:{__oY:null,add:function(r){var s=this._getChildren()[0];if(s){this._remove(s);s.removeListener(a,this._onUpdate,this);}
...
;this.stopScrollAnimation();if(L){var N=this.getScrollX();this.__oY=new qx.bom.AnimationFrame();this.__oY.on(o,function(){this.setScrollX(O);this.__oY=null;this.fireEvent(c);}
,this);this.__oY.on(i,function(Q){var P=parseInt(Q/L*(O-N)+N);this.setScrollX(P);}
,this);this.__oY.startSequence(L);}
else {this.setScrollX(O);}
;}
,scrollToY:function(U,R){var S=this.getScrollMaxY();if(U<0){U=0;}
else if(U>S){U=S;}
;this.stopScrollAnimation();if(R){var T=this.getScrollY();this.__oY=new qx.bom.AnimationFrame();this.__oY.on(o,function(){this.setScrollY(U);this.__oY=null;this.fireEvent(c);}
,this);this.__oY.on(i,function(W){var V=parseInt(W/R*(U-T)+T);this.setScrollY(V);}
,this);this.__oY.startSequence(R);}
...
,stopScrollAnimation:function(){if(this.__oY){this.__oY.cancelSequence();this.__oY=null;}
;}
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__xl=new qx.ui.virtual.core.Pane(o,l,n,m);this.__xl.addListener(c,this._computeScrollbars,this);this.__xl.addListener(d,this._onScrollPaneX,this);this.__xl.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__xl,{edge:0});}
else {this._add(this.__xl,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__xl:null,getPane:function(){return this.__xl;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__xl;}
...
,_onScrollBarX:function(e){this.__xl.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__xl.setScrollY(e.getData());}
},destruct:function(){this.__xl.dispose();this.__xl=null;}
});}
)();
(function(){var a="scrollY",b="mousedown",c="qx.event.type.Data",d="dblclick",f="__xm",g="change",h="qx.debug",j="qx.event.type.Event",k="cellContextmenu",l="__xr",m="resize",n="scrollX",o="appear",p="qx.ui.virtual.core.CellEvent",q="cellDblclick",r="qx.ui.virtual.core.Pane",s="__xn",t="click",u="update",v="cellClick",w="contextmenu",x="__xs";qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__xm=new qx.ui.virtual.core.Axis(A,B);this.__xn=new qx.ui.virtual.core.Axis(z,y);this.__pX=0;this.__pW=0;this.__xo=0;this.__xp=0;this.__xq={};this.__ks={};this.__xr=new qx.ui.container.Composite();this.__xr.setUserBounds(0,0,0,0);this._add(this.__xr);this.__xs=[];this.__xm.addListener(g,this.fullUpdate,this);this.__xn.addListener(g,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(o,this._onAppear,this);this.addListener(b,this._onMouseDown,this);this.addListener(t,this._onClick,this);this.addListener(d,this._onDblclick,this);this.addListener(w,this._onContextmenu,this);}
,events:{cellClick:p,cellContextmenu:p,cellDblclick:p,update:j,scrollX:c,scrollY:c},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__xm:null,__xn:null,__pX:null,__pW:null,__xo:null,__xp:null,__xq:null,__ks:null,__xr:null,__xs:null,__xt:null,__sI:null,__tN:null,__xu:null,getRowConfig:function(){return this.__xm;}
,getColumnConfig:function(){return this.__xn;}
,getChildren:function(){return [this.__xr];}
,addLayer:function(C){if(qx.core.Environment.get(h)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__xs.push(C);C.setUserBounds(0,0,0,0);this.__xr.add(C);}
,getLayers:function(){return this.__xs;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__xs.length;i++ ){var E=this.__xs[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__xn.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__xm.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__pX!==J){var I=this.__pX;this.__pX=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__pX;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__pW){var L=this.__pW;this.__pW=M;this._deferredUpdateScrollPosition();this.fireDataEvent(n,M,L);}
;}
,getScrollX:function(){return this.__pW;}
,getScrollSize:function(){return {width:this.__xn.getTotalSize(),height:this.__xm.getTotalSize()};}
,scrollRowIntoView:function(P){var Q=this.getBounds();if(!Q){this.addListenerOnce(o,function(){qx.event.Timer.once(function(){this.scrollRowIntoView(P);}
,this,0);}
,this);return;}
;var R=this.__xm.getItemPosition(P);var O=R+this.__xm.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
else if(O>N+Q.height){this.setScrollY(O-Q.height);}
;}
,scrollColumnIntoView:function(S){var V=this.getBounds();if(!V){this.addListenerOnce(o,function(){qx.event.Timer.once(function(){this.scrollColumnIntoView(S);}
,this,0);}
,this);return;}
;var U=this.__xn.getItemPosition(S);var T=U+this.__xn.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
else if(T>W+V.width){this.setScrollX(T-V.width);}
;}
,scrollCellIntoView:function(X,ba){var Y=this.getBounds();if(!Y){this.addListenerOnce(o,function(){qx.event.Timer.once(function(){this.scrollCellIntoView(X,ba);}
,this,0);}
,this);return;}
...
;bf=this.__xm.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__xn.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__pW+bl.width;var bo=this.__xp-bn;if(this.__pW-this.__xq.left<Math.min(this.__pW,bj)||this.__xq.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__pW,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__pW-bp,this.__pX,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__pX+bw.height;var bt=this.__xo-bs;if(this.__pX-this.__xq.top<Math.min(this.__pX,bz)||this.__xq.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__pX,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__pW,this.__pX-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__xt=true;this._updateScrollPosition();this.__xt=null;this.fireEvent(u);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onMouseDown:function(e){this.__xu=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onClick:function(e){this.__xv(e,v);}
,_onContextmenu:function(e){this.__xv(e,k);}
,_onDblclick:function(e){this.__xv(e,q);}
,__xv:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__xu;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
;this.fireNonBubblingEvent(bC,qx.ui.virtual.core.CellEvent,[this,e,bB.row,bB.column]);}
,syncWidget:function(bD){if(this.__ks._fullUpdate){this._fullUpdate();}
else if(this.__ks._updateScrollPosition){this._updateScrollPosition();}
;this.__ks={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__xm.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__xm.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__xn.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__xn.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__xq={top:bU,bottom:bQ,left:bS,right:bI};this.__xr.setUserBounds((this.getPaddingLeft()||0)+(this.__xq.left-this.__pW),(this.getPaddingTop()||0)+(this.__xq.top-this.__pX),bO,bM);this.__sI=bH;this.__tN=bR;for(var i=0;i<this.__xs.length;i++ ){var bG=this.__xs[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__xw:function(){if(this.__xt){return;}
;var bW=this.getScrollSize();if(this.__xo!==bW.height||this.__xp!==bW.width){this.__xo=bW.height;this.__xp=bW.width;this.fireEvent(u);}
;}
,fullUpdate:function(){this.__ks._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__ks._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__xw();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__pW,this.__pX,bY.width,bY.height,true);this.__xw();}
,_deferredUpdateScrollPosition:function(){this.__ks._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__xw();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__pX,bottom:this.__pX+cc.height,left:this.__pW,right:this.__pW+cc.width};if(this.__xq.top<=cb.top&&this.__xq.bottom>=cb.bottom&&this.__xq.left<=cb.left&&this.__xq.right>=cb.right){this.__xr.setUserBounds((this.getPaddingLeft()||0)+(this.__xq.left-cb.left),(this.getPaddingTop()||0)+(this.__xq.top-cb.top),this.__xq.right-this.__xq.left,this.__xq.bottom-this.__xq.top);}
else {this._setLayerWindow(ca,this.__pW,this.__pX,cc.width,cc.height,false);}
;this.__xw();}
},destruct:function(){this._disposeArray(x);this._disposeObjects(f,s,l);this.__xq=this.__ks=this.__sI=this.__tN=null;}
});}
)();
...
,events:{"change":e},members:{__xx:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__xx=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__xx=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__xx=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__xx=null;this.fireNonBubblingEvent(c);}
,__xy:function(){if(this.__xx){return this.__xx;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__xx=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__xx=u;return u;}
,__xz:function(F){var B=this.__xx||this.__xy();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__xz(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__xA:function(M){var O=this.__xx||this.__xy();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__xA(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__xx||this.__xy();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__xx=null;}
});}
)();
...
(function(){var a="one",b="Boolean",c="qx.ui.virtual.selection.MModel",d="qx.data.Array",f="multi",g="selected",h="_applySelection",j="change",k="_applyDragSelection",l="single",m="_applyQuickSelection",n="changeSelection",o="_applySelectionMode",p="additive",q="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this._initSelectionManager();this.__xb=new qx.data.Array();this.initSelection(this.__xb);}
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__xB:false,__xC:false,__xb:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
,_onChangeSelection:function(e){if(this.__xC==true){return;}
;this.__xB=true;var F=this.getSelection();var H=[];for(var i=0;i<F.getLength();i++ ){var G=F.getItem(i);var I=this._getSelectables();var E=-1;if(I!=null){E=I.indexOf(G);}
...
;this.__xg();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__xB=false;}
,_onManagerChangeSelection:function(e){if(this.__xB==true){return;}
;this.__xC=true;this.__xg();this.__xC=false;}
,__xg:function(){if(this.__xE()){return;}
;var L=this._manager.getSelection();var M=[];for(var i=0;i<L.length;i++ ){var N=this._getDataFromRow(L[i]);if(N!=null){M.push(N);}
;}
;this.__xD(M);}
,__xD:function(Q){var P=this.getSelection();if(Q.length>0){var O=[0,P.getLength()];O=O.concat(Q);var R=P.splice.apply(P,O);R.dispose();}
else {P.removeAll();}
;}
,__xE:function(){var T=this.getSelection();var V=this._manager.getSelection();if(T.getLength()!==V.length){return false;}
...
;throw new Error(n);}
,getSelection:function(){return qx.lang.Object.getValues(this.__gD);}
,getSortedSelection:function(){var bS=this.getSelectables();var bR=qx.lang.Object.getValues(this.__gD);bR.sort(function(a,b){return bS.indexOf(a)-bS.indexOf(b);}
);return bR;}
,isItemSelected:function(bT){var bU=this._selectableToHashCode(bT);return this.__gD[bU]!==undefined;}
,isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__gD);}
...
;this._fireChange();}
,_setLeadItem:function(bY){var bX=this.__pE;if(bX!==null){this._styleSelectable(bX,u,false);}
;if(bY!==null){this._styleSelectable(bY,u,true);}
;this.__pE=bY;}
,getLeadItem:function(){return this.__pE!==null?this.__pE:null;}
,_setAnchorItem:function(cb){var ca=this.__pF;if(ca!=null){this._styleSelectable(ca,G,false);}
...
,_getSelectableLocationY:function(cj){throw new Error(bt);}
...
;this._fireChange();}
,handleMouseOver:function(event){if(this.__pH!=null&&this.__pH!=this._getScroll().top){this.__pH=null;return;}
...
;var cy=event.isCtrlPressed()||(qx.core.Environment.get(c)==D&&event.isMetaPressed());var cz=event.isShiftPressed();if(this.isItemSelected(cB)&&!cz&&!cy&&!this.getDrag()){this.__pG=cB;this._userInteraction=false;return;}
else {this.__pG=null;}
;this._scrollItemIntoView(cB);switch(this.getMode()){case X:case h:this._setSelectedItem(cB);break;case bu:this._setLeadItem(cB);this._setAnchorItem(cB);this._toggleInSelection(cB);break;case S:this._setLeadItem(cB);if(cz){var cA=this._getAnchorItem();if(cA===null){cA=this._getFirstSelectable();this._setAnchorItem(cA);}
...
;break;};var cC=this.getMode();if(this.getDrag()&&cC!==X&&cC!==h&&!cz&&!cy){this.__pu=this._getLocation();this.__pr=this._getScroll();this.__pv=event.getDocumentLeft()+this.__pr.left;this.__pw=event.getDocumentTop()+this.__pr.top;this.__px=true;this._capture();}
;this._fireChange(bo);this._userInteraction=false;}
,handleMouseUp:function(event){this._userInteraction=true;var cG=event.isCtrlPressed()||(qx.core.Environment.get(c)==D&&event.isMetaPressed());var cD=event.isShiftPressed();if(!cG&&!cD&&this.__pG!=null){var cE=this._getSelectableFromMouseEvent(event);if(cE===null||!this.isItemSelected(cE)){this._userInteraction=false;return;}
;var cF=this.getMode();if(cF===bu){this._removeFromSelection(cE);}
else {this._setSelectedItem(cE);if(this.getMode()===S){this._setLeadItem(cE);this._setAnchorItem(cE);}
;}
;this._userInteraction=false;}
;this._cleanup();}
,handleLoseCapture:function(event){this._cleanup();}
,handleMouseMove:function(event){if(!this.__px){return;}
;this.__py=event.getDocumentLeft();this.__pz=event.getDocumentTop();this._userInteraction=true;var cH=this.__py+this.__pr.left;if(cH>this.__pv){this.__pA=1;}
else if(cH<this.__pv){this.__pA=-1;}
else {this.__pA=0;}
;var cI=this.__pz+this.__pr.top;if(cI>this.__pw){this.__pB=1;}
else if(cI<this.__pw){this.__pB=-1;}
else {this.__pB=0;}
;var location=this.__pu;if(this.__py<location.left){this.__po=this.__py-location.left;}
else if(this.__py>location.right){this.__po=this.__py-location.right;}
else {this.__po=0;}
;if(this.__pz<location.top){this.__pp=this.__pz-location.top;}
else if(this.__pz>location.bottom){this.__pp=this.__pz-location.bottom;}
else {this.__pp=0;}
;if(!this.__pq){this.__pq=new qx.event.Timer(100);this.__pq.addListener(E,this._onInterval,this);}
;this.__pq.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
,handleAddItem:function(e){var cJ=e.getData();if(this.getMode()===h&&this.isSelectionEmpty()){this.addItem(cJ);}
;}
,handleRemoveItem:function(e){this.removeItem(e.getData());}
,_cleanup:function(){if(!this.getDrag()&&this.__px){return;}
;if(this.__pC){this._fireChange(bo);}
;delete this.__px;delete this.__ps;delete this.__pt;this._releaseCapture();if(this.__pq){this.__pq.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__po,this.__pp);this.__pr=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cS=this._getDimension();var cL=Math.max(0,Math.min(this.__py-this.__pu.left,cS.width))+this.__pr.left;var cK=Math.max(0,Math.min(this.__pz-this.__pu.top,cS.height))+this.__pr.top;if(this.__ps===cL&&this.__pt===cK){return;}
;this.__ps=cL;this.__pt=cK;var cP=this._getAnchorItem();var cN=cP;var cQ=this.__pA;var cT,cM;while(cQ!==0){cT=cQ>0?this._getRelatedSelectable(cN,t):this._getRelatedSelectable(cN,T);if(cT!==null){cM=this._getSelectableLocationX(cT);if((cQ>0&&cM.left<=cL)||(cQ<0&&cM.right>=cL)){cN=cT;continue;}
;}
;break;}
;var cR=this.__pB;var cU,cO;while(cR!==0){cU=cR>0?this._getRelatedSelectable(cN,bA):this._getRelatedSelectable(cN,br);if(cU!==null){cO=this._getSelectableLocationY(cU);if((cR>0&&cO.top<=cK)||(cR<0&&cO.bottom>=cK)){cN=cU;continue;}
;}
;break;}
;var cV=this.getMode();if(cV===S){this._selectItemRange(cP,cN);}
else if(cV===bu){if(this.isItemSelected(cP)){this._selectItemRange(cP,cN,true);}
else {this._deselectItemRange(cP,cN);}
;this._setAnchorItem(cN);}
;this._fireChange(bB);}
,__pI:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;var dc,db;var de=event.getKeyIdentifier();var dd=this.getMode();var cX=event.isCtrlPressed()||(qx.core.Environment.get(c)==D&&event.isMetaPressed());var cY=event.isShiftPressed();var da=false;if(de===z&&cX){if(dd!==X&&dd!==h){this._selectAllItems();da=true;}
;}
else if(de===p){if(dd!==X&&dd!==h){this._clearSelection();da=true;}
;}
else if(de===r){var cW=this.getLeadItem();if(cW!=null&&!cY){if(cX||dd===bu){this._toggleInSelection(cW);}
else {this._setSelectedItem(cW);}
;da=true;}
;}
else if(this.__pI[de]){da=true;if(dd===X||dd==h){dc=this._getSelectedItem();}
else {dc=this.getLeadItem();}
;if(dc!==null){switch(de){case V:db=this._getFirstSelectable();break;case N:db=this._getLastSelectable();break;case x:db=this._getRelatedSelectable(dc,br);break;case v:db=this._getRelatedSelectable(dc,bA);break;case k:db=this._getRelatedSelectable(dc,T);break;case Y:db=this._getRelatedSelectable(dc,t);break;case bv:db=this._getPage(dc,true);break;case B:db=this._getPage(dc,false);break;};}
...
;if(db!==null){switch(dd){case X:case h:this._setSelectedItem(db);break;case bu:this._setLeadItem(db);break;case S:if(cY){var df=this._getAnchorItem();if(df===null){this._setAnchorItem(df=this._getFirstSelectable());}
...
;}
;break;};this.__pH=this._getScroll().top;this._scrollItemIntoView(db);}
;}
...
;}
,_clearSelection:function(){var dh=this.__gD;for(var di in dh){this._removeFromSelection(dh[di]);}
;this.__gD={};}
,_selectItemRange:function(dj,dn,dl){var dp=this._getSelectableRange(dj,dn);if(!dl){var dm=this.__gD;var dq=this.__pJ(dp);for(var dk in dm){if(!dq[dk]){this._removeFromSelection(dm[dk]);}
;}
;}
...
;}
,__pJ:function(dv){var dw={};var du;for(var i=0,l=dv.length;i<l;i++ ){du=dv[i];dw[this._selectableToHashCode(du)]=du;}
;return dw;}
,_getSelectedItem:function(){for(var dx in this.__gD){return this.__gD[dx];}
;return null;}
,_setSelectedItem:function(dz){if(this._isSelectable(dz)){var dy=this.__gD;var dA=this._selectableToHashCode(dz);if(!dy[dA]||(dy.length>=2)){this._clearSelection();this._addToSelection(dz);}
;}
;}
,_addToSelection:function(dB){var dC=this._selectableToHashCode(dB);if(this.__gD[dC]==null&&this._isSelectable(dB)){this.__gD[dC]=dB;this._styleSelectable(dB,P,true);this.__pC=true;}
;}
,_toggleInSelection:function(dD){var dE=this._selectableToHashCode(dD);if(this.__gD[dE]==null){this.__gD[dE]=dD;this._styleSelectable(dD,P,true);}
else {delete this.__gD[dE];this._styleSelectable(dD,P,false);}
;this.__pC=true;}
,_removeFromSelection:function(dF){var dG=this._selectableToHashCode(dF);if(this.__gD[dG]!=null){delete this.__gD[dG];this._styleSelectable(dF,P,false);this.__pC=true;}
;}
...
;}
;var dO=dJ[0];var dH=dN;var dL=this.__gD;for(var dM in dL){if(dI[dM]){delete dI[dM];}
...
;if(!dK){return false;}
;this._scrollItemIntoView(dH);this._setLeadItem(dO);this._setAnchorItem(dO);this.__pC=true;this._fireChange();}
,_fireChange:function(dP){if(this.__pC){this.__pD=dP||null;this.fireDataEvent(bq,this.getSelection());delete this.__pC;}
;}
...
;return dR;}
;return null;}
},destruct:function(){this._disposeObjects(by);this.__gD=this.__pG=this.__pF=null;this.__pE=null;}
});}
)();
...
(function(){var c="changeModel",d="resize",f="_applyLabelOptions",g="_applyLabelPath",h="qx.data.Array",j="_applyGroupLabelOptions",m="changeLength",n="Integer",o="_applyModel",p="changeGroups",q="Boolean",r="GroupingTypeError: You can't mix 'Objects' and 'Strings' as",s="sorter",t="row-layer",u="group",v="_applyIconPath",w="_applyDelegate",x="changeDelegate",y=" group identifier!",z="???",A="_applyRowHeight",B="qx.data.IListData",C="filter",D="virtual-list",E="String",F="_applyGroupLabelPath",G="_applyIconOptions",H="qx.ui.list.List";qx.Class.define(H,{extend:qx.ui.virtual.core.Scroller,include:[qx.ui.virtual.selection.MModel],implement:qx.data.controller.ISelection,construct:function(I){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);this._init();this.__xF=new qx.data.Array();this.initGroups(this.__xF);if(I!=null){this.initModel(I);}
;this.initItemHeight();}
,properties:{appearance:{refine:true,init:D},focusable:{refine:true,init:true},width:{refine:true,init:100},height:{refine:true,init:200},model:{check:B,apply:o,event:c,nullable:true,deferredInit:true},itemHeight:{check:n,init:25,apply:A,themeable:true},labelPath:{check:E,apply:g,nullable:true},iconPath:{check:E,apply:v,nullable:true},groupLabelPath:{check:E,apply:F,nullable:true},labelOptions:{apply:f,nullable:true},iconOptions:{apply:G,nullable:true},groupLabelOptions:{apply:j,nullable:true},delegate:{apply:w,event:x,init:null,nullable:true},autoGrouping:{check:q,init:true},groups:{check:h,event:p,nullable:false,deferredInit:true}},members:{_background:null,_provider:null,_layer:null,__xG:null,__xH:null,__xI:null,__xJ:false,__xK:false,__xL:false,__xF:null,refresh:function(){this.__xN();}
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__xG=[];this.__xH=[];this.__xI={};this.__xJ=false;this.__xK=false;this.__xL=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__xG;}
,_lookup:function(P){return this.__xG[P];}
,_lookupGroup:function(Q){return this.__xH.indexOf(Q);}
,_reverseLookup:function(R){if(R<0){return -1;}
;return this.__xG.indexOf(R);}
...
,_applyDelegate:function(bl,bk){this._provider.setDelegate(bl);this.__xN();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this.__xN();this._applyDefaultSelection();}
,__xM:function(){this.getPane().getRowConfig().setItemCount(this.__xG.length);this.getPane().fullUpdate();}
,__xN:function(){this.__xG=[];this.__xH=[];this.__xI={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var bm=this.getModel();if(bm!=null){this._runDelegateFilter(bm);this._runDelegateSorter(bm);this._runDelegateGroup(bm);}
;this._updateSelection();this.__xM();}
,_runDelegateFilter:function(bo){var bn=qx.util.Delegate.getMethod(this.getDelegate(),C);for(var i=0,l=bo.length;i<l; ++i){if(bn==null||bn(bo.getItem(i))){this.__xG.push(i);}
;}
;}
,_runDelegateSorter:function(bp){if(this.__xG.length==0){return;}
;var bq=qx.util.Delegate.getMethod(this.getDelegate(),s);if(bq!=null){this.__xG.sort(function(a,b){return bq(bp.getItem(a),bp.getItem(b));}
);}
;}
,_runDelegateGroup:function(bu){var bv=qx.util.Delegate.getMethod(this.getDelegate(),u);if(bv!=null){for(var i=0,l=this.__xG.length;i<l; ++i){var br=this.__xG[i];var bt=this.getModel().getItem(br);var bs=bv(bt);this.__xO(bs,br);}
;this.__xG=this.__xP();}
;}
,__xO:function(bx,bw){if(bx==null){this.__xL=true;bx=z;}
;var name=this.__xQ(bx);if(this.__xI[name]==null){this.__xI[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bx);}
;}
;this.__xI[name].push(bw);}
,__xP:function(){this.__xR();var bB=[];var bD=0;var bz=this.getGroups();for(var i=0;i<bz.getLength();i++ ){var by=bz.getItem(i);bB.push(-1);this.__xH.push(bD);bD++ ;var bC=this.__xQ(by);var bA=this.__xI[bC];if(bA!=null){for(var k=0;k<bA.length;k++ ){bB.push(bA[k]);bD++ ;}
;}
;}
;return bB;}
,__xQ:function(bF){var name=null;if(!qx.lang.Type.isString(bF)){var bE=this.getGroups().indexOf(bF);this.__xK=true;name=u;if(bE==-1){name+=this.getGroups().getLength();}
else {name+=bE;}
;}
else {this.__xJ=true;var name=bF;}
;return name;}
,__xR:function(){if(this.__xK&&this.__xL||this.__xK&&this.__xJ){throw new Error(r+y);}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__xG=this.__xH=this.__xI=null;if(this.__xF){this.__xF.dispose();}
;}
});}
)();
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__ks={};}
,properties:{anonymous:{refine:true,init:true}},members:{__ks:null,__bH:null,__tL:null,__tM:null,__tN:null,__sI:null,getFirstRow:function(){return this.__tL;}
,getFirstColumn:function(){return this.__tM;}
,getRowSizes:function(){return this.__tN||[];}
,getColumnSizes:function(){return this.__sI||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__ks.fullUpdate||this.__ks.updateLayerWindow&&this.__ks.updateLayerData){this._fullUpdate.apply(this,this.__bH);}
else if(this.__ks.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bH);}
else if(this.__ks.updateLayerData&&this.__tN){this._updateLayerData();}
;if(this.__ks.fullUpdate||this.__ks.updateLayerWindow){var d=this.__bH;this.__tL=d[0];this.__tM=d[1];this.__tN=d[2];this.__sI=d[3];}
;this.__ks={};}
,_updateLayerData:function(){this._fullUpdate(this.__tL,this.__tM,this.__tN,this.__sI);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__ks.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bH=arguments;this.__ks.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bH=arguments;this.__ks.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__ks=this.__bH=this.__tN=this.__sI=null;}
});}
)();
...
;this.__xS={};this.__xT={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__xU:null,__xV:null,__xS:null,__xT:null,setColor:function(h,g){if(g){this.__xS[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__xS[h]);}
;}
,clearCustomColors:function(){this.__xS={};this.updateLayerData();}
,getColor:function(i){var j=this.__xS[i];if(j){return j;}
else {return i%2==0?this.__xU:this.__xV;}
;}
,_applyColorEven:function(l,k){if(l){this.__xU=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__xU=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__xV=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__xV=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__xT[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__xT[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__xT[q];}
},destruct:function(){this.__xS=this.__xT=null;}
});}
)();
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__xW(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__xW(K)){this.updateLayerData();}
;}
,__xW:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
(function(){var a="cell.type",b="model[",c="groups[",d="model",f="",g="changeDelegate",h="label",i="qx.ui.list.core.MWidgetController",j="icon",k="]",l="value",m="BindingIds",n=".",o="group",p="String";qx.Mixin.define(i,{construct:function(){this.__wR=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},groupLabelPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},groupLabelOptions:{nullable:true},delegate:{event:g,init:null,nullable:true}},members:{__wR:null,bindDefaultProperties:function(q,r){if(q.getUserData(a)!=o){this.bindProperty(f,d,null,q,r);this.bindProperty(this.getLabelPath(),h,this.getLabelOptions(),q,r);if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),j,this.getIconOptions(),q,r);}
;}
else {this.bindProperty(this.getGroupLabelPath(),l,this.getGroupLabelOptions(),q,r);}
;}
,bindProperty:function(u,x,v,t,s){var y=t.getUserData(a);var w=this.__wS(s,u,y);if(v){v.ignoreConverter=d;}
;var z=this._list.bind(w,t,x,v);this.__wT(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__wS(A,D,G);var H=F.bind(B,this._list,C,E);this.__wT(F,H);}
,removeBindings:function(){while(this.__wR.length>0){var I=this.__wR.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_removeBindingsFrom:function(T){var U=this.__wU(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__wR,T)){qx.lang.Array.remove(this.__wR,T);}
;}
,__wS:function(X,ba,Y){var W=b+X+k;if(Y==o){W=c+X+k;}
;if(ba!=null&&ba!=f){W+=n+ba;}
;return W;}
,__wT:function(bc,bd){var bb=this.__wU(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
;if(!qx.lang.Array.contains(this.__wR,bc)){this.__wR.push(bc);}
;}
,__wU:function(be){var bf=be.getUserData(m);if(bf==null){bf=[];be.setUserData(m,bf);}
;return bf;}
...
,styleSelectabled:function(v){var u=this.__wV(v);this._styleSelectabled(u);}
,styleUnselectabled:function(x){var w=this.__wV(x);this._styleUnselectabled(w);}
...
;}
,_styleSelectabled:function(A){this.__wW(A,{selected:1});}
,_styleUnselectabled:function(B){this.__wW(B,{});}
...
,__wV:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__wW:function(I,H){if(I==null){return;}
...
;this._cellProvider=h;this.__wX=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__wX:null,getRenderedCellWidget:function(q,n){var j=this.getColumnSizes().length;var p=this.getRowSizes().length;var o=this.getFirstRow();var m=this.getFirstColumn();if(q<o||q>=o+p||n<m||n>=m+j){return null;}
;var l=(n-m)+(q-o)*j;var k=this._getChildren()[l];if(k.getUserData(g)){return null;}
else {return k;}
;}
,_getSpacer:function(){var r=this.__wX.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(A,v,D,z){var B=this._cellProvider;var G=this._getChildren();for(var i=0;i<G.length;i++ ){var E=G[i];if(E.getUserData(g)){this.__wX.push(E);}
...
;}
;}
;var J=this._cellProvider;var N=this._getChildren();for(var i=0;i<N.length;i++ ){if(!W[i]){var T=N[i];if(T.getUserData(g)){this.__wX.push(T);}
...
;this._cellProvider=this.__wX=null;}
});}
)();
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__wY();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cM.push(p);}
,_cleanupPool:function(){var q=this.__cM.pop();while(q){q.destroy();q=this.__cM.pop();}
;}
,__wY:function(){var r=this.__cM.pop();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
...
(function(){var a=" array contains ",b="__gz",c="qx.ui.core.MSingleSelectionHandling",d=" items!",f="changeSelection",g="changeSelected",h="Could only select one item, but the selection",i="qx.event.type.Data";qx.Mixin.define(c,{events:{"changeSelection":i},members:{__gz:null,getSelection:function(){var j=this.__oK().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__oK().setSelected(k[0]);break;default:throw new Error(h+a+k.length+d);};}
,resetSelection:function(){this.__oK().resetSelected();}
,isSelected:function(l){return this.__oK().isSelected(l);}
,isSelectionEmpty:function(){return this.__oK().isSelectionEmpty();}
,getSelectables:function(m){return this.__oK().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(f,o,n);}
,__oK:function(){if(this.__gz==null){var p=this;this.__gz=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
...
(function(){var a=", because it is not a child element!",b="__oN",c="__oL",d="Boolean",e="qx.ui.core.SingleSelectionManager",f="qx.debug",g="Invalid selectionProvider!",h="Could not check if ",j=" is selected,",k="Could not select ",l="__oM",m="changeSelected",n=" because it is not a child element!",o="qx.event.type.Data";qx.Class.define(e,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(f)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,g);}
;this.__oL=p;}
,events:{"changeSelected":o},properties:{allowEmptySelection:{check:d,init:true,apply:b}},members:{__oM:null,__oL:null,getSelected:function(){return this.__oM;}
,setSelected:function(q){if(!this.__oP(q)){throw new Error(k+q+a);}
;this.__oO(q);}
,resetSelected:function(){this.__oO(null);}
,isSelected:function(r){if(!this.__oP(r)){throw new Error(h+r+j+n);}
;return this.__oM===r;}
,isSelectionEmpty:function(){return this.__oM==null;}
,getSelectables:function(t){var s=this.__oL.getItems();var u=[];for(var i=0;i<s.length;i++ ){if(this.__oL.isItemSelectable(s[i])){u.push(s[i]);}
;}
;if(!t){for(var i=u.length-1;i>=0;i-- ){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__oN:function(w,v){if(!w){this.__oO(this.__oM);}
;}
,__oO:function(x){var A=this.__oM;var y=x;if(y!=null&&A===y){return;}
;if(!this.isAllowEmptySelection()&&y==null){var z=this.getSelectables(true)[0];if(z){y=z;}
;}
;this.__oM=y;this.fireDataEvent(m,y,A);}
,__oP:function(B){var C=this.__oL.getItems();for(var i=0;i<C.length;i++ ){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__oL.toHashCode){this._disposeObjects(c);}
else {this.__oL=null;}
...
(function(){var a="Could not set the model selection. Maybe your models are not unique? ",b="qx.ui.form.MModelSelection",c="Please use an array as parameter.",d="change",f="qx.debug",g="__pg",h="changeSelection",k="qx.event.type.Data";qx.Mixin.define(b,{construct:function(){this.__pg=new qx.data.Array();this.__pg.addListener(d,this.__pj,this);this.addListener(h,this.__pi,this);}
,events:{changeModelSelection:k},members:{__pg:null,__ph:false,__pi:function(){if(this.__ph){return;}
...
;}
;}
,__pj:function(){this.__ph=true;var r=this.getSelectables(true);var s=[];var q=this.__pg.toArray();for(var i=0;i<q.length;i++ ){var u=q[i];for(var j=0;j<r.length;j++ ){var v=r[j];var p=v.getModel?v.getModel():null;if(u===p){s.push(v);break;}
;}
;}
;this.setSelection(s);this.__ph=false;var t=this.getSelection();if(!qx.lang.Array.equals(t,s)){this.__pi();}
;}
,getModelSelection:function(){return this.__pg;}
,setModelSelection:function(w){if(!w){this.__pg.removeAll();return;}
;if(qx.core.Environment.get(f)){this.assertArray(w,c);}
;w.unshift(this.__pg.getLength());w.unshift(0);var x=this.__pg.splice.apply(this.__pg,w);x.dispose();}
...
;}
,remove:function(w){var x=this.__ru;if(qx.lang.Array.contains(x,w)){qx.lang.Array.remove(x,w);if(w.getGroup()===this){w.resetGroup();}
;w.removeListener(p,this._onItemChangeChecked,this);if(w.getValue()){this.resetSelection();}
;}
;}
,getChildren:function(){return this.__ru;}
...
;}
,_applyInvalidMessage:function(A,z){for(var i=0;i<this.__ru.length;i++ ){this.__ru[i].setInvalidMessage(A);}
;}
,_applyValid:function(C,B){for(var i=0;i<this.__ru.length;i++ ){this.__ru[i].setValid(C);}
;}
,_applyEnabled:function(F,E){var D=this.__ru;if(F==null){for(var i=0,l=D.length;i<l;i++ ){D[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var J=this.getSelection()[0];var K=this.__ru;var I=K.indexOf(J);if(I==-1){return;}
...
,selectPrevious:function(){var M=this.getSelection()[0];var N=this.__ru;var L=N.indexOf(M);if(L==-1){return;}
...
,_isItemSelectable:function(O){return this.__ru.indexOf(O)!=-1;}
,__oQ:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
...
;return Y+ba;}
,escapeHTML:function(bd){return String(bd).replace(/[<>&"']/g,this.__zc);}
,__zc:function(bf){var be={"<":m,">":e,"&":s,"'":t,'"':D};return be[bf]||L;}
