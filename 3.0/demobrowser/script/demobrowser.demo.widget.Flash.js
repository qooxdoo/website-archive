...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.e77b1179aeeb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__cx",c="Flash Player Version",d="__RP",f="__RO",g="right",h="qooxdoo is the best!",i="Message from Flash:",j="execute",k="__Fe",l="Simple demo with FlashVars",m="bgcolor",n="demobrowser.demo.widget.Flash",o="demobrowser/demo/flash/TestFlash.swf",p="1) no pop-up or advertising blocker is activated.\n",q="Send to Flash",r="demobrowser/demo/flash/FlashVersion.swf",s="No message.",t="Flash:",u="<b>qooxdoo:</b>",v="demobrowser.demo.widget.Flash.sendMessage",w="__RQ",x="demobrowser.demo.widget.Flash.flashReady",y="Couldn't connect to Flash Player! Please make sure that:\n",z="demobrowser/demo/flash/fo_tester.swf",A="this is passed in via FlashVars",B="Two way communication (ActionScript <-> JavaScript)",C="Message to Flash:",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(n,{extend:qx.application.Standalone,members:{__cx:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(l);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(B);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cx=this.createWindow();G.add(this.__cx,{top:20,left:20});}
,createWindow:function(){var K=new qx.ui.window.Window(c).set({width:300,height:200,contentPadding:[0,0,0,0]});K.setLayout(new qx.ui.layout.Canvas());K.add(new qx.ui.embed.Flash(r),{edge:0});return K;}
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:A};var M=new qx.ui.embed.Flash(z).set({scale:E,variables:L});M.getContentElement().setParam(m,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(j,function(){this.__cx.open();}
,this);N.add(O);return N;}
,__Fe:null,__RO:null,__RP:null,__RQ:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(u).set({rich:true}));Q.add(new qx.ui.basic.Label(i));this.__RO=new qx.ui.form.TextArea(s);this.__RO.setEnabled(false);Q.add(this.__RO,{flex:1});Q.add(new qx.ui.basic.Label(C));this.__RP=new qx.ui.form.TextArea(h);Q.add(this.__RP,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,g));this.__RQ=new qx.ui.form.Button(q);this.__RQ.setEnabled(false);this.__RQ.addListener(j,function(e){this.__Fe.getFlashElement().sendMessage(this.__RP.getValue());}
,this);S.add(this.__RQ);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(t).set({rich:true}));this.__Fe=new qx.ui.embed.Flash(o);this.__Fe.setVariables({init:x});P.add(this.__Fe,{flex:1});return R;}
,sendMessage:function(T){this.__RO.setValue(T);}
,initFlash:function(){if(this.__Fe.getFlashElement().setup){this.__Fe.getFlashElement().setup(v);this.__RQ.setEnabled(true);}
else {alert(y+p+a);}
;}
},statics:{__RR:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__RR=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__RR.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__RR.initFlash();}
},destruct:function(){this._disposeObjects(f,d,w,k,b);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__EY){this.__EY=new Date().getTime();}
;var bp=new Date().getTime()-this.__EY;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__EY=null;}
;}
else {this.fireEvent(p);this.__EY=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__Fa(c,bB);}
,_applyScale:function(bD,bC){this.__Fa(h,bD);}
,_applyWmode:function(bF,bE){this.__Fa(m,bF);}
,_applyPlay:function(bH,bG){this.__Fa(I,bH);}
,_applyLoop:function(bJ,bI){this.__Fa(s,bJ);}
,_applyMenu:function(bL,bK){this.__Fa(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__Fa(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__Fa(z,bP);}
,__Fa:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="Invalid attribute 'value'.",b="The id cannot be modified after initial creation",c="The variables cannot be modified after initial creation",d="qx.debug",e="Invalid attribute 'key'.",f="movie",g="div",h="The attributes cannot be modified after initial creation",i="The source cannot be modified after initial creation",j="The params cannot be modified after initial creation",k="Invalid attribute 'value' expected String, Boolean or null.",l="id",m="qx.html.Flash";qx.Class.define(m,{extend:qx.html.Element,construct:function(n,o){qx.html.Element.call(this,g,n,o);this.__Fb={};this.__Fc={};this.__Fd={};}
,members:{__Fb:null,__Fd:null,__Fc:null,__Fe:null,_createDomElement:function(){return qx.dom.Element.create(g);}
,createFlash:function(){this.__Fe=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Fc,this.__Fb);}
,setSource:function(p){if(qx.core.Environment.get(d)){qx.core.Assert.assertString(p,a);}
;if(this.__Fe){throw new Error(i);}
;this.setAttribute(f,p);}
,setId:function(q){if(qx.core.Environment.get(d)){qx.core.Assert.assertString(q,a);}
;if(this.__Fe){throw new Error(b);}
;this.setAttribute(l,q);}
,getVariables:function(){return this.__Fc;}
,setVariables:function(r){if(qx.core.Environment.get(d)){qx.core.Assert.assertMap(r,a);}
;if(this.__Fe){throw new Error(c);}
;this.__Fc=r;}
,getAttributes:function(){return this.__Fd;}
,setAttribute:function(s,t){if(qx.core.Environment.get(d)){qx.core.Assert.assertString(s,e);if(arguments.length>1&&t!==null){if(!qx.lang.Type.isBoolean(t)&&!qx.lang.Type.isString(t)){throw new Error(k);}
;}
;}
;if(this.__Fe){throw new Error(h);}
;qx.html.Element.prototype.setAttribute.call(this,s,t);if(t===null||t===undefined){delete this.__Fd[s];}
else {this.__Fd[s]=t;}
;}
,getParams:function(){return this.__Fb;}
,setParam:function(u,v){if(qx.core.Environment.get(d)){qx.core.Assert.assertString(u,e);if(arguments.length>1&&v!==null){if(!qx.lang.Type.isBoolean(v)&&!qx.lang.Type.isString(v)){throw new Error(k);}
;}
;}
;if(this.__Fe){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Fb[u];}
else {this.__Fb[u]=v;}
;}
,getFlashElement:function(){return this.__Fe;}
},destruct:function(){if(this.__Fe){qx.bom.Flash.destroy(this.__Fe);}
;this.__Fb=this.__Fc=this.__Fd=null;}
});}
)();
