...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.026c94f14e05.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__vs:null,__Jh:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
...
;}
;if(this.getActive()===m){this.__Jh=null;}
...
;return false;}
;for(var i=0;i<this.__vs.length;i++ ){var n=this.__vs[i];if(n==o){n.setActive(true);this.__Jh=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__Jh;}
,block:function(){if(this.__Jh){this.__Jh.setActive(false);}
;}
,unblock:function(){if(this.__Jh){this.__Jh.setActive(true);}
;}
,_getGroup:function(q){var p=this.__vs.indexOf(q);if(p===-1){return null;}
;return this.__vs[p];}
},destruct:function(){this.__vs=this.__Jh=null;}
});}
)();
