...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling.56cd484d4bef.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__OJ=f+p.join(c)+a;this.__OK=o||50;this.__OL=n;this._clearLog();}
,_clearLog:function(){this.__OL.innerHTML=this.__OJ+k;this.__OM=[];}
,_log:function(q){this.__OM.unshift(q);this.__OM=this.__OM.slice(0,this.__OK);var r=[this.__OJ];for(var i=0;i<this.__OM.length;i++ ){r.push(g,this.__OM[i].join(e),l);}
;r.push(k);this.__OL.innerHTML=r.join(d);this.__OL.scrollTop=0;}
,__OJ:null,__OK:null,__OL:null,__OM:null},destruct:function(){this.__OL=this.__OM=null;}
});}
)();
