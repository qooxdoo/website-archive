...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.257344075d01.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Qc:4,__Qd:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Qd/this.__Qc),column:this.__Qd%this.__Qc});this.__Qd+=1;}
