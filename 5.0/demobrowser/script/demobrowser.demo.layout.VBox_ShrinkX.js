...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_ShrinkX.b909524009bd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.layout.VBox_ShrinkX",b="green",c="main",d="yellow";qx.Class.define(a,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var e=new qx.ui.layout.VBox();var g=(new qx.ui.container.Composite(e)).set({decorator:c,backgroundColor:d,maxWidth:100});e.setSpacing(5);var i=new qx.ui.core.Widget().set({decorator:c,backgroundColor:b});var h=new qx.ui.core.Widget().set({decorator:c,backgroundColor:b});var f=new qx.ui.core.Widget().set({decorator:c,backgroundColor:b});i.setWidth(200);h.setWidth(300);f.setWidth(400);g.add(i);g.add(h);g.add(f);this.getRoot().add(g,{left:10,top:10});}
}});}
)();
