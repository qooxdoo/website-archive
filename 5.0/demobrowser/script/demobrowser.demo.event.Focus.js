...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Focus.c84037a2541a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.event.Focus",b="mshtml",c="engine.name",d="blur",f="",g="focusout",h="webkit",i="1px solid black",j="Activate: ",k="1px dotted red",l="FocusIn: ",m="focus",n="Window focussed",o="Deactivate: ",p="Window blurred",q="#E8ECF6",r="deactivate",s="activate",t="FocusOut: ",u="focusin";qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.event.Registration.addListener(document.documentElement,s,this._onActivate,this,true);qx.event.Registration.addListener(document.documentElement,r,this._onDeactivate,this,true);qx.event.Registration.addListener(document.documentElement,u,this._onFocusIn,this);qx.event.Registration.addListener(document.documentElement,g,this._onFocusOut,this);qx.event.Registration.addListener(window,m,this._onWindowFocus,this);qx.event.Registration.addListener(window,d,this._onWindowBlur,this);}
,_onWindowFocus:function(e){this.debug(n);}
,_onWindowBlur:function(e){this.debug(p);}
,_onActivate:function(e){this.debug(j+e.getTarget());e.getTarget().style.background=q;}
,_onDeactivate:function(e){this.debug(o+e.getTarget());e.getTarget().style.background=f;}
,_onFocusIn:function(e){this.debug(l+e.getTarget());if(qx.core.Environment.get(c)==h){e.getTarget().style.border=k;}
else {e.getTarget().style.outline=k;}
;}
,_onFocusOut:function(e){this.debug(t+e.getTarget());if(qx.core.Environment.get(c)==b){e.getTarget().style.border=i;}
else {e.getTarget().style.outline=f;}
;}
}});}
)();
