...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.80b4d8a68b67.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__DC.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__DB:null,__DC:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__DB);l.dispose();this.__DB=null;}
;if(m){this.__DB=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__DD:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__DE:null,__DF:null,getLocal:function(){if(this.__DE){return this.__DE;}
;return this.__DE=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__DF){return this.__DF;}
;return this.__DF=new qx.bom.storage.Web(b);}
},construct:function(g){this.__py=g;}
,members:{__py:null,getStorage:function(){return window[this.__py+c];}
,getLength:function(){return this.getStorage(this.__py).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__py).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__py).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__py).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__py);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__py).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__DE:null,__DF:null,__cl:0,getLocal:function(){if(this.__DE){return this.__DE;}
;return this.__DE=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__DF){return this.__DF;}
;return this.__DF=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__DG=document.createElement(f);this.__DG.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__DG);this.__DG.addBehavior(j);this.__DH=m;this.__DG.load(this.__DH);this.__cX={};this.__DI={};var l=this.__DG.getAttribute(d+qx.bom.storage.UserData.__cl);while(l!=undefined){l=qx.lang.Json.parse(l);this.__cX[l.key]=l.value;this.__DI[l.key]=d+qx.bom.storage.UserData.__cl;qx.bom.storage.UserData.__cl++ ;l=this.__DG.getAttribute(d+qx.bom.storage.UserData.__cl);}
;}
,members:{__DG:null,__DH:h,__cX:null,__DI:null,getStorage:function(){return this.__cX;}
,getLength:function(){return Object.keys(this.__cX).length;}
,setItem:function(n,p){if(this.__DI[n]){var o=this.__DI[n];}
else {var o=d+qx.bom.storage.UserData.__cl;qx.bom.storage.UserData.__cl++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__DG.setAttribute(o,q);this.__DG.save(this.__DH);this.__cX[n]=p;this.__DI[n]=o;}
,getItem:function(r){return this.__cX[r]||null;}
,removeItem:function(v){var u=this.__DI[v];if(u==undefined){return;}
;this.__DG.removeAttribute(u);qx.bom.storage.UserData.__cl-- ;delete this.__cX[v];delete this.__DI[v];var t=d+qx.bom.storage.UserData.__cl;if(this.__DG.getAttribute(t)){var w=this.__DG.getAttribute(d+qx.bom.storage.UserData.__cl);this.__DG.removeAttribute(t);this.__DG.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__DI[s]=u;}
;this.__DG.save(this.__DH);}
,clear:function(){for(var x in this.__DI){this.__DG.removeAttribute(this.__DI[x]);}
;this.__DG.save(this.__DH);this.__cX={};this.__DI={};}
,getKey:function(y){return Object.keys(this.__cX)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__DE:null,__DF:null,getLocal:function(){if(this.__DE){return this.__DE;}
;return this.__DE=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__DF){return this.__DF;}
;return this.__DF=new qx.bom.storage.Memory();}
},construct:function(){this.__cX={};}
,members:{__cX:null,getStorage:function(){return this.__cX;}
,getLength:function(){return Object.keys(this.__cX).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__cX[b]=c;}
,getItem:function(e){var d=this.__cX[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__cX[f];}
,clear:function(){this.__cX={};}
,getKey:function(h){var g=Object.keys(this.__cX);return g[h];}
,forEach:function(j,l){var length=this.getLength();for(var i=0;i<length;i++ ){var k=this.getKey(i);j.call(l,k,this.getItem(k));}
;}
}});}
)();
(function(){var a="qx.util.Function",b="undefined";qx.Bootstrap.define(a,{statics:{debounce:function(d,c,e){var f=function(){arguments.callee.immediate=!!(e);arguments.callee.args=qx.lang.Array.fromArguments(arguments);var g=this;var i=arguments.callee.intervalId;if(typeof i===b){var h=window.setInterval((function(){if(!this.fired){window.clearInterval(this.intervalId);delete this.intervalId;if(this.immediate===false){d.apply(g,this.args);}
;}
;this.fired=false;}
