...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Reversed.6d8521f4683a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="tap to reverse",b="demobrowser.demo.layout.VBox_Reversed",c="yellow",d="pointerdown",f="gray",g="blue",h="green",i="top",j="bottom",k="middle",l="main";qx.Class.define(b,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var m=new qx.ui.layout.VBox();var o=new qx.ui.container.Composite(m).set({decorator:l,backgroundColor:c,width:120});m.setSpacing(5);m.setReversed(true);var q=new qx.ui.core.Widget().set({decorator:l,backgroundColor:g,maxHeight:60,alignY:i});var p=new qx.ui.basic.Label(a).set({decorator:l,rich:true,backgroundColor:h,padding:5,height:60,maxHeight:60,alignY:k,allowGrowX:true,allowGrowY:true});var n=new qx.ui.core.Widget().set({decorator:l,backgroundColor:f,maxHeight:60,alignY:j});o.add(q);o.add(p);o.add(n);o.addListener(d,function(e){m.setReversed(!m.getReversed());}
