...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.9608cf3159f4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__Jb].values;var bo=this.__IW[this.__Jb];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__Jc){bn.shift();}
...
;this.__IY.setRed(bx);this.__IY.setGreen(bw);this.__IY.setBlue(bv);this.__IX.open();}
,_onColorSelectorOk:function(){var by=this.__IY;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__IX.close();}
,_onColorSelectorCancel:function(){this.__IX.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__IX){this.__IX.destroy();this.__IY.destroy();this.__Ja.destroy();}
;this._tables=this.__IW=null;}
});}
)();
