...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Spacer_Grid.4714e9e622cb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="yellow",b="green",c="main",d="demobrowser.demo.layout.Spacer_Grid";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var e=new qx.ui.layout.VBox();e.setSpacing(10);var f=new qx.ui.container.Composite(e);f.setPadding(20);this.getRoot().add(f,{edge:0});f.add(this.getGrid1());f.add(this.getGrid2());}
,getGrid1:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:c,backgroundColor:a,allowGrowX:false,allowGrowY:false});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:0,column:0});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:0,column:1});g.add(new qx.ui.core.Spacer(0,10),{row:1,column:0});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:2,column:0});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:2,column:1});g.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:4,column:0});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:4,column:1});return g;}
,getGrid2:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:c,backgroundColor:a,allowGrowX:false,allowGrowY:false});h.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:0,column:0});h.add(new qx.ui.core.Spacer(10,0),{row:0,column:2});h.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:0,column:3});h.add(new qx.ui.core.Spacer(30,0),{row:1,column:4});h.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:0,column:5});h.add(new qx.ui.core.Spacer(0,5),{row:1,column:0});h.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:2,column:0});h.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:2,column:3});h.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:b}),{row:2,column:5});return h;}
}});}
)();
