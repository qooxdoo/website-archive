...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.TabView","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.TabView.33b8d9c9dfd2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="icon/16/apps/utilities-calculator.png",b="demobrowser.demo.widget.TabView",c="bottom",d="Notes",f="execute",g="Page #",h="Remove first page",j="Layout",k="icon/16/apps/utilities-help.png",l="Add new page",m="changeSelection",n="Calculator...",o="icon/32/apps/utilities-terminal.png",p="icon/16/apps/utilities-notes.png",q="Bar Position",r="top",s="Calculator",t="right",u="Help",v="Help...",w="Notes...",x="Layout-Settings",y="icon/16/apps/utilities-terminal.png",z="Remove last page",A="left",B=" with close button.";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var D=new qx.ui.container.Scroll();var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));C.setPadding(20);C.setAllowStretchX(false);D.add(C);this.getRoot().add(D,{edge:0});C.add(this.getTabView1());C.add(this.getTabView2());C.add(this.getTabView3());}
,getTabView1:function(){var E=new qx.ui.tabview.TabView();E.setWidth(500);var I=new qx.ui.tabview.Page(j,y);I.setLayout(new qx.ui.layout.VBox());I.add(new qx.ui.basic.Label(x));E.add(I);var G=new qx.ui.tabview.Page(d,p);G.setLayout(new qx.ui.layout.VBox());G.add(new qx.ui.basic.Label(w));E.add(G);var H=new qx.ui.tabview.Page(s,a);H.setLayout(new qx.ui.layout.VBox());H.add(new qx.ui.basic.Label(n));E.add(H);var F=new qx.ui.tabview.Page(u,k);F.setLayout(new qx.ui.layout.VBox());F.add(new qx.ui.basic.Label(v));E.add(F);return E;}
,getTabView2:function(){var J=new qx.ui.tabview.TabView();J.setWidth(500);for(var i=1;i<=20;i++ ){var K=new qx.ui.tabview.Page(g+i,y);K.setLayout(new qx.ui.layout.VBox());K.setShowCloseButton(true);K.add(new qx.ui.basic.Label(g+i+B));J.add(K);}
;return J;}
,getTabView3:function(){var V=new qx.ui.tabview.TabView();V.setWidth(500);V.setHeight(300);for(var i=1;i<=3;i++ ){var W=new qx.ui.tabview.Page(g+i,o);W.setLayout(new qx.ui.layout.VBox(4));V.add(W);W.add(new qx.ui.basic.Label(g+i));}
;var P=V.getChildren()[0];var N=new qx.ui.basic.Label(q);var S=new qx.ui.form.RadioButton(r);var M=new qx.ui.form.RadioButton(c);var R=new qx.ui.form.RadioButton(A);var T=new qx.ui.form.RadioButton(t);P.add(new qx.ui.core.Spacer(10,10));P.add(N);P.add(S);P.add(M);P.add(R);P.add(T);var L=new qx.ui.form.RadioGroup(S,M,R,T);L.addListener(m,function(e){this.setBarPosition(e.getData()[0].getLabel());}
,V);R.setValue(true);var O=new qx.ui.form.Button(l);var Q=new qx.ui.form.Button(h);var U=new qx.ui.form.Button(z);P.add(new qx.ui.core.Spacer(10,10));P.add(O);P.add(Q);P.add(U);O.addListener(f,function(e){var X=V.getChildren().length+1;var Y=new qx.ui.tabview.Page(g+X,o);V.add(Y);}
);Q.addListener(f,function(e){var ba=V.getChildren();if(ba.length>0){V.remove(ba[0]);}
;}
);U.addListener(f,function(e){var bb=V.getChildren();if(bb.length>0){V.remove(bb[bb.length-1]);}
;}
);return V;}
}});}
)();
