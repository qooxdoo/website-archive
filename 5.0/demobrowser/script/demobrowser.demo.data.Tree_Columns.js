...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Tree_Columns","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Tree_Columns.61595e88f77a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Windows (C:)",b="Documents (D:)",c="demobrowser.demo.data.Tree_Columns",d="Inbox",e="Desktop",f="Trash",g="Personal",h="-rw-r--r--",j="Presets",k="size",l="Network",m="light",n="Sent",o="children",p="Big",q="Files",r="mode",s=" 2010",t="Workspace",u="date",v="Spam",w="Data",x="May ",y="Root",z="label",A="Lists",B="kb",C="Item ",D="checked",E="Edit";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var G=new qx.ui.container.Scroll();var F=new qx.ui.container.Composite(new qx.ui.layout.Basic());F.setAllowGrowX(false);F.setAllowStretchX(false);G.add(F);this.getRoot().add(G,{edge:0});var H=new qx.ui.tree.Tree().set({width:600,height:500});F.add(H,{left:20,top:48});var J={label:y,children:[{label:e,children:[{label:q},{label:t,children:[{label:a},{label:b}]},{label:l},{label:f}]},{label:d,children:[{label:j},{label:n},{label:f},{label:w},{label:E},{label:A},{label:g},{label:p,children:[]},{label:v}]}]};for(var i=0;i<50;i++ ){J.children[1].children[7].children[i]={label:C+i};}
;this.extendData(J);var I=qx.data.marshal.Json.createModel(J);var K=new qx.data.controller.Tree(null,H,o,z);K.setDelegate(this);K.setModel(I);H.getRoot().setOpen(true);}
,extendData:function(L){L.date=x+Math.round(Math.random()*30+1)+s;L.size=Math.round(Math.random()*100)+B;L.light=Math.floor(Math.random()*4)==0;L.mode=h;L.checked=Math.random()>=0.5;if(L.children){for(var i=0;i<L.children.length;i++ ){this.extendData(L.children[i]);}
;}
;}
,bindItem:function(N,M,O){N.bindDefaultProperties(M,O);N.bindProperty(k,k,null,M,O);N.bindProperty(D,D,null,M,O);N.bindPropertyReverse(D,D,null,M,O);N.bindProperty(u,u,null,M,O);N.bindProperty(r,r,null,M,O);N.bindProperty(m,m,null,M,O);}
,createItem:function(){return new demobrowser.demo.data.TreeColumn();}
}});}
)();
...
(function(){var a="open",b="abstract",c="qx.debug",d="'. It is not a child of this tree item.",e="addItem",f="__nL",g="visible",h="excluded",j="__gW",k="removeItem",m="Invalid child index: ",n="Cannot remove treeitem '",o="qx.ui.tree.core.AbstractTreeItem";qx.Class.define(o,{extend:qx.ui.tree.core.AbstractItem,type:b,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__gW=[];}
,properties:{parent:{check:o,nullable:true}},members:{__gW:null,__nL:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
;}
;}
,getChildrenContainer:function(){if(!this.__nL){this.__nL=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?g:h});}
;return this.__nL;}
,hasChildrenContainer:function(){return this.__nL;}
...
;}
,__nM:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);}
;}
...
;this.__gW.push(Q);if(!N){this.__nM();}
...
;qx.lang.Array.insertAt(this.__gW,X,T);if(!V){this.__nM();}
...
(function(){var a="Enter",b="_applyOpenMode",c="excluded",d="Space",f="Left",g="Boolean",h="changeOpenMode",j="_applyRootOpenClose",k="__nO",l="visible",m="changeSelection",n="qx.ui.tree.Tree",o="qx.event.type.Data",p="qx.ui.tree.core.AbstractTreeItem",q="tree",r="dbltap",s="_applyHideRoot",t="changeRoot",u="_applyRoot",v="keypress",w="none",x="pane",y="tap",z="Right";qx.Class.define(n,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__nO=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(x).add(this.__nO);this.initOpenMode();this.initRootOpenClose();this.addListener(m,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
...
(function(){var a="changeModel",b="_applyDelegate",c="qx.core.Object",d="_applyLabelPath",f="icon",g="change",h="label",k="' twice.",l="_applyTarget",m="changeTarget",n="_applyIconPath",o="Can not reverse bind the same target property '",p="_applyLabelOptions",q="_applyChildPath",r="_applyIconOptions",s="qx.data.controller.Tree",t="String",u="Can not bind the same target property '",v="_applyModel",w="get";qx.Class.define(s,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(y,z,A,x){qx.core.Object.call(this);this.__bb={};this.__yC=[];this.__Jm={};if(A!=null){this.setChildPath(A);}
;if(x!=null){this.setLabelPath(x);}
;if(y!=null){this.setModel(y);}
;if(z!=null){this.setTarget(z);}
;}
,properties:{model:{check:c,apply:v,event:a,nullable:true,dereference:true},target:{apply:l,event:m,init:null,nullable:true,dereference:true},childPath:{check:t,apply:q,nullable:true},labelPath:{check:t,apply:d,nullable:true},iconPath:{check:t,apply:n,nullable:true},labelOptions:{apply:p,nullable:true},iconOptions:{apply:r,nullable:true},delegate:{apply:b,init:null,nullable:true}},members:{__Jm:null,__bb:null,__yC:null,__Jn:null,_applyDelegate:function(C,B){this._setConfigureItem(C,B);this._setCreateItem(C,B);this._setBindItem(C,B);}
,_applyIconOptions:function(E,D){this.__yN();}
,_applyLabelOptions:function(G,F){this.__yN();}
,_applyTarget:function(I,H){if(H!=undefined){this.__CU(H);}
;if(this.getModel()!=null){this.__Jq();}
;this._addChangeTargetListener(I,H);}
,_applyModel:function(K,J){this.__Jq();}
,_applyChildPath:function(M,L){this.__Jn=L;this.__Jq();this.__Jn=null;}
,_applyIconPath:function(O,N){this.__yN();}
,_applyLabelPath:function(Q,P){this.__Jq();}
,__Jo:function(R){var T=R.getTarget();var S=this.__Jm[T.toHashCode()].treeNode;var U=this.__Jm[T.toHashCode()].modelNode;this.__Jr(S,U);this._updateSelection();}
,__Jp:function(e){var X=e.getData();var bc=e.getOldData();var V=this.__Jm[bc.toHashCode()];bc.removeListenerById(V.changeListenerId);delete this.__Jm[bc.toHashCode()];V.modelNode.removeListenerById(V.changeChildernListenerId);var bd=V.modelNode;var bb=qx.Class.getPropertyDefinition(V.modelNode.constructor,this.getChildPath());var Y=bb.event;var ba=bd.addListener(Y,this.__Jp,this);var W=V.treeNode;this.__Jm[X.toHashCode()]={modelNode:bd,treeNode:W,changeListenerId:V.changeListenerId,changeChildernListenerId:ba};this.__Jr(W,bd);this._updateSelection();}
...
;return be;}
,__Jq:function(){if(this.getTarget()==null||this.getChildPath()==null){return;}
...
;this.__CU();if(this.getModel()!=null){var bg=this._createItem();bg.setModel(this.getModel());this.__xE(this.getModel(),bg);this.__Jr(bg,this.getModel());this.getTarget().setRoot(bg);}
;}
,__Jr:function(bn,br){if(br[w+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;}
;var bj=br[w+qx.lang.String.firstUp(this.getChildPath())]();if(this.__Jm[bj.toHashCode()]==undefined){var bl=bj.addListener(g,this.__Jo,this);var bp=qx.Class.getPropertyDefinition(br.constructor,this.getChildPath());var bm=bp.event;var bq=br.addListener(bm,this.__Jp,this);this.__Jm[bj.toHashCode()]={modelNode:br,treeNode:bn,changeListenerId:bl,changeChildernListenerId:bq};}
...
;}
else {var bo=this._createItem();bo.setModel(bj.getItem(i));bn.addAt(bo,i);this.__xE(bj.getItem(i),bo);this.__Jr(bo,bj.getItem(i));}
;}
;}
;for(var i=bn.getChildren().length-1;i>=bj.length;i-- ){var bk=bn.getChildren()[i];this.__Jt(bk,bn);}
;}
,__CU:function(bt){if(bt==null){bt=this.getTarget();}
;if(bt==null){return;}
;var bv=bt.getRoot();if(bv!=null){bt.setRoot(null);this.__Js(bv);var bu=bv.getModel();if(bu){this.__mP(bu);}
;bv.destroy();this.__Jm={};}
;}
,__Js:function(bw){var bx=bw.getChildren()||[];for(var i=bx.length-1;i>=0;i-- ){if(bx[i].getChildren().length>0){this.__Js(bx[i]);}
;this.__Jt(bx[i],bw);}
;}
,__Jt:function(bz,bC){var bD=bz.getModel();var by=this.__Jn||this.getChildPath();var bA=w+qx.lang.String.firstUp(by);if(bD[bA]!=undefined){var bE=bD[bA]();var bB=this.__Jm[bE.toHashCode()];bE.removeListenerById(bB.changeListenerId);bD.removeListenerById(bB.changeChildernListenerId);this.__Js(bz);delete this.__Jm[bE.toHashCode()];}
;this.__mP(bD);bC.remove(bz);bz.destroy();}
...
;if(!qx.lang.Array.contains(this.__yC,bJ)){this.__yC.push(bJ);}
;}
...
;if(!qx.lang.Array.contains(this.__yC,bM)){this.__yC.push(bM);}
;}
...
;}
,__yN:function(){var bW;for(var ca in this.__bb){bW=ca;break;}
;for(var bX in this.__bb[bW]){var bV=this.__bb[bW][bX].treeNode;var bY=qx.core.ObjectRegistry.fromHashCode(bX);this.__mP(bY);this.__xE(bY,bV);}
;}
,__xE:function(cd,cb){var cc=this.getDelegate();if(cc!=null&&cc.bindItem!=null){cc.bindItem(this,cb,cd);}
else {this.bindDefaultProperties(cb,cd);}
;}
,__mP:function(cg){for(var i=0;i<this.__yC.length;i++ ){var ce=this.__yC[i];var cf=this.__bb[ce][cg.toHashCode()];if(cf!=null){if(cf.id){cg.removeBinding(cf.id);cf.id=null;}
...
;this._startSelectionModification();this.__CU();this.__Jq();this._endSelectionModification();this._updateSelection();}
,_setBindItem:function(cn,cm){if(cn!=null&&cn.bindItem!=null){if(cm!=null&&cm.bindItem!=null&&cn.bindItem==cm.bindItem){return;}
;this.__Jq();}
;}
},destruct:function(){this.setTarget(null);this.setModel(null);this.__bb=this.__Jm=this.__yC=null;}
});}
)();
...
(function(){var a="icon/16/status/dialog-information.png",b="source",c="size",d="changeSize",e="",f="changeMode",g="changeDate",h="mode",i="changeChecked",j="value",k="date",l="changeLight",m="demobrowser.demo.data.TreeColumn",n="checked",o="icon/16/places/user-desktop.png",p="light";qx.Class.define(m,{extend:qx.ui.tree.TreeFolder,construct:function(){qx.ui.tree.TreeFolder.call(this);var t=new qx.ui.basic.Image();t.setWidth(16);this.addWidget(t);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(o);var r=new qx.ui.form.CheckBox();r.setFocusable(false);this.addWidget(r);this.addLabel(e);this.addWidget(new qx.ui.core.Spacer(),{flex:1});var u=new qx.ui.basic.Label();u.setWidth(50);this.addWidget(u);var q=new qx.ui.basic.Label();q.setWidth(150);this.addWidget(q);var s=new qx.ui.basic.Label();s.setWidth(80);this.addWidget(s);this.bind(p,t,b,{converter:function(v){return v?a:e;}
});this.bind(n,r,j);r.bind(j,this,n);this.bind(c,u,j);this.bind(k,q,j);this.bind(h,s,j);}
,properties:{size:{event:d,nullable:true},checked:{event:i,nullable:true},date:{event:g,nullable:true},mode:{event:f,nullable:true},light:{event:l,nullable:true}}});}
)();
