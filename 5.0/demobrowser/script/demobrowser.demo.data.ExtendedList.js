...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ExtendedList.44cda072d325.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Jack",b="kiss",c="demobrowser.demo.data.ExtendedList",d="Jim",e="sad",f="execute",g="<b>Displaying Checkboxes in a list</b><br/>",h="plain",j="surprise",k="embarrassed",l="value",m="online",n="name",o="Write data to log",p="Jakob",q="",r="Dan",s="Tim",t="Karl",u="model",v="Online <> Offline",w="This list display a set of persons in a list as checkbox. Every ",x="label",y="Dustin",z="angel",A="Max",B="person does have a name as label and an online status as checkbox.";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var D=[A,p,s,a,r,y,t,d];var F=[k,b,h,e,j,z];var M=[];for(var i=0;i<20;i++ ){var H=new demobrowser.demo.data.model.Person();H.setName(D[i%D.length]);H.setEmote(F[i%F.length]);H.setOnline(i%3==0);M.push(H);}
;var L=new qx.data.Array(M);var E=new qx.ui.form.List();E.setWidth(150);this.getRoot().add(E,{left:10,top:80});var I=new qx.data.controller.List(null,E);var K={configureItem:function(N){N.setPadding(3);}
,createItem:function(){return new qx.ui.form.CheckBox();}
,bindItem:function(P,O,Q){P.bindProperty(q,u,null,O,Q);P.bindProperty(n,x,null,O,Q);P.bindProperty(m,l,null,O,Q);P.bindPropertyReverse(m,l,null,O,Q);}
};I.setDelegate(K);I.setModel(L);var C=new qx.ui.form.Button(v);C.setWidth(120);this.getRoot().add(C,{left:180,top:80});C.addListener(f,function(){for(var i=0;i<L.length;i++ ){L.getItem(i).toggleOnline();}
;}
,this);var J=new qx.ui.form.Button(o);J.setWidth(120);this.getRoot().add(J,{left:180,top:115});J.addListener(f,function(){qx.log.appender.Console.show();this.info(L.toString());}
,this);var G=new qx.ui.basic.Label();G.setRich(true);G.setWidth(410);G.setValue(g+w+B);this.getRoot().add(G,{left:10,top:10});}
}});}
)();
