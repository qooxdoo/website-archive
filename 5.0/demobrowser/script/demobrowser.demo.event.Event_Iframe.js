...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Iframe.4a4c51344b0c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" (inner): ",b="inner",c="div",d="capture: ",f="juhu",g="contextmenu",h=": ",j="bubble: ",k=" 2: ",l="input",m="load",n="keydown: ",o="iframe",p="keydown",q=" ",r="tap",s="demobrowser.demo.event.Event_Iframe",t=" 1: ",u="scroll",v="data/Event_2_frame.html";qx.Class.define(s,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var w=qx.bom.Iframe.create({name:o,src:v});w.id=o;document.body.appendChild(w);qx.event.Registration.addListener(w,m,this.bindIFrameEvents,this);}
,bindIFrameEvents:function(){var z=window.document.getElementById(o);var y=qx.bom.Iframe.getDocument(z);this._juhu=y.getElementById(f);this._inner=y.getElementById(b);qx.event.Registration.addListener(this._juhu,g,this._preventDefault,this);qx.event.Registration.addListener(this._inner,r,this._stopPropagation,this);qx.event.Registration.addListener(this._juhu,r,this._onTap1,this);qx.event.Registration.addListener(this._juhu,r,this._onTap2,this);qx.event.Registration.addListener(y.getElementById(l),p,this._onkeydown,this);for(var i=1;i<10;i++ ){var x=y.getElementById(c+i);qx.event.Registration.addListener(x,r,this._cascadeCapture,this,true);qx.event.Registration.addListener(x,r,this._cascadeBubble,this,false);}
;qx.event.Registration.addListener(y.getElementById(u),u,this._scroll,this);}
,_onkeydown:function(e){this.debug(n+e.getKeyIdentifier());}
,_scroll:function(e){this.debug(u);}
...
,_onTap1:function(e){this.debug(e.getType()+t+e);qx.event.Registration.removeListener(this._juhu,r,this._onTap1);}
,_onTap2:function(e){this.debug(e.getType()+k+e);}
