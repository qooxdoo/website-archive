...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.516b81696bb3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__zj:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__zj=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__zj[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__zj[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__zj[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__lr:null,__Jv:null,__eg:null,__Jw:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__Jx:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Jy:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__Jz(H,E&&A);if(E){if(this.__Jy()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__eg==null){this.__eg=new qx.event.Timer(500);this.__eg.addListener(f,this.__JA,this);}
;this.__Jv=window.open(z,name,G);this.__eg.restart();C=this.__Jv;}
;}
else {C=window.open(z,name,G);}
;if(C&&D&&(D instanceof Function)){var F=self||C;var B=qx.lang.Function.bind(D,F);qx.bom.Event.addNativeListener(C,t,function(){B();qx.bom.Event.removeNativeListener(C,t,arguments.callee);}
);}
;return C;}
,__Jz:function(K,O){var M;var J;var N=[];if(O&&this.__Jy()){for(var L in K){if(qx.bom.Window.__Jw[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__Jw[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Jx[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
else {qx.log.Logger.warn(o+L+e);}
;}
;M=N.join(y);}
;return M;}
,__JA:function(){if(this.isClosed(this.__Jv)){this.getBlocker().unblock();this.__eg.stop();}
;}
,getBlocker:function(){if(this.__lr==null){this.__lr=new qx.bom.Blocker;}
;return this.__lr;}
,close:function(P){if(P){return P.close();}
;}
,isClosed:function(Q){var closed=true;if(Q){try{closed=Q.closed;}
catch(R){}
;}
;return closed;}
,moveTo:function(S,top,T){if(!qx.bom.Window.isClosed(S)){try{S.moveTo(T,top);}
catch(U){qx.log.Logger.error(m,U);}
;}
;}
,resizeTo:function(V,W,X){if(!qx.bom.Window.isClosed(V)){try{V.resizeTo(W,X);}
catch(Y){qx.log.Logger.error(d,Y);}
;}
;}
}});}
)();
...
;return d;}
,__oo:function(I){var H=function(){qx.bom.Event.removeNativeListener(I,j,H);I.$$url=qx.bom.Iframe.queryCurrentUrl(I);}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__cR();}
,members:{__JB:null,__CI:null,__JC:null,__JD:false,__JE:10000,__JF:0,__JG:f,block:function(r){if(!this.__JD){this.__JC=r;var q=this.__JJ();this.__JK(q);this.__JD=true;}
;}
,unblock:function(){if(this.__JD){this.__JL();this.__JD=false;}
;}
,isBlocked:function(){return this.__JD;}
,getBlockerElement:function(){return this.__CI;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__CI,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__CI,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__CI,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__CI);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__CI,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__CI,h);}
,__cR:function(){this.__JH();if((qx.core.Environment.get(j)==b)){this.__JI();}
;qx.event.Registration.addListener(window,a,this.__yQ,this);}
,__JH:function(){this.__CI=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__CI,{display:d,opacity:this.__JF,backgroundColor:this.__JG});this.setBlockerZIndex(this.__JE);}
,__JI:function(){this.__JB=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__JB,l,false);qx.bom.element.Attribute.set(this.__JB,i,n);qx.bom.element.Style.setStyles(this.__JB,{display:d,opacity:this.__JF});}
,__JJ:function(){var v={position:p};if(this.__JN()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__JC)+g;v.height=qx.bom.element.Dimension.getHeight(this.__JC)+g;v.left=qx.bom.element.Location.getLeft(this.__JC)+g;v.top=qx.bom.element.Location.getTop(this.__JC)+g;}
;return v;}
,__JK:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__CI,w);qx.dom.Element.insertEnd(this.__CI,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__JB,w);qx.dom.Element.insertEnd(this.__JB,document.body);}
;}
,__JL:function(){qx.dom.Element.remove(this.__CI);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__JB);}
;}
,__yQ:function(e){if(this.__JN()){this.__JM({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__JM(y);}
,this,0);}
;}
,__JM:function(z){qx.bom.element.Style.setStyles(this.__CI,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__JB,z);}
;}
,__JN:function(){return (this.__JC==null||qx.dom.Node.isWindow(this.__JC)||qx.dom.Node.isDocument(this.__JC));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__yQ,this);this.__JB=this.__CI=this.__JC=null;}
});}
)();
