...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Flickr","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr.dd0a3756b540.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.fireDataEvent(e,this.getModel());if(this.__or){this.__or.dispose();this.__or=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__or!=null){this._disposeObjects(s);}
...
;this.__ob={};var S=this._transport=this._createTransport();this._setPhase(H);this.__ud=qx.lang.Function.bind(this._onReadyStateChange,this);this.__ue=qx.lang.Function.bind(this._onLoad,this);this.__uf=qx.lang.Function.bind(this._onLoadEnd,this);this.__ug=qx.lang.Function.bind(this._onAbort,this);this.__uh=qx.lang.Function.bind(this._onTimeout,this);this.__ui=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__ud;S.onload=this.__ue;S.onloadend=this.__uf;S.onabort=this.__ug;S.ontimeout=this.__uh;S.onerror=this.__ui;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__ud:null,__ue:null,__uf:null,__ug:null,__uh:null,__ui:null,__uj:null,__uk:null,__ul:null,__ob:null,__um:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__uk=true;this.__ul=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__un());qx.lang.Object.mergeWith(bd,this.__um);qx.lang.Object.mergeWith(bd,this.__ob);return bd;}
,__un:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__ob[bh]=bi;}
,getRequestHeader:function(bj){return this.__ob[bj];}
,removeRequestHeader:function(bk){if(this.__ob[bk]){delete this.__ob[bk];}
;}
...
,_setResponse:function(bo){var bn=bo;if(this.__uj!==bo){this.__uj=bo;this.fireEvent(I,qx.event.type.Data,[this.__uj,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__uk){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__uo();}
;}
,__uo:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__ul;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__ul=br;this.fireDataEvent(c,br,bs);}
...
(function(){var a="url: ",b="qx.debug.io",c="qx.bom.request.Script",d="Invalid state",e="head",f="error",g="loadend",h="qx.debug",i="script",j="load",k="Unknown response headers",l="browser.documentmode",m="abort",n="",o="Received native readyState: loaded",p="readystatechange",q="Response header cannot be determined for ",r="requests made with script transport.",s="opera",t="unknown",u="Open native request with ",v="Response headers cannot be determined for",w="mshtml",x="engine.name",y="Detected error",z="Send native request",A="on",B="timeout",C="Unknown environment key at this phase",D="Received native load";qx.Bootstrap.define(c,{construct:function(){this.__yn();this.__yi=qx.Bootstrap.bind(this._onNativeLoad,this);this.__yj=qx.Bootstrap.bind(this._onNativeError,this);this.__uh=qx.Bootstrap.bind(this._onTimeout,this);this.__yk=document.head||document.getElementsByTagName(e)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__yp()?0:15000;}
,events:{"readystatechange":c,"error":c,"loadend":c,"timeout":c,"abort":c,"load":c},members:{readyState:null,status:null,statusText:null,timeout:null,__yl:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(H,G){if(this.__uB){return;}
;this.__yn();this.__uk=null;this.__uw=G;if(this.__ys(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__uB){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__uw=qx.util.Uri.appendParamsToUrl(this.__uw,K);return this;}
,send:function(){if(this.__uB){return null;}
;var M=this.__yq(),L=this.__yk,N=this;if(this.timeout>0){this.__gw=window.setTimeout(this.__uh,this.timeout);}
;if(this.__ys(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;L.insertBefore(M,L.firstChild);window.setTimeout(function(){N._readyStateChange(2);N._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__uB){return null;}
;this.__uk=true;this.__yr();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__uB){return null;}
;if(this.__ys(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__uB){return null;}
;if(this.__ys(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__yl=P;}
,dispose:function(){var Q=this.__ym;if(!this.__uB){if(Q){Q.onload=Q.onreadystatechange=null;this.__yr();}
;if(this.__gw){window.clearTimeout(this.__gw);}
;this.__uB=true;}
;}
,isDisposed:function(){return !!this.__uB;}
,_getUrl:function(){return this.__uw;}
,_getScriptElement:function(){return this.__ym;}
,_onTimeout:function(){this.__yo();if(!this.__yp()){this._emit(f);}
;this._emit(B);if(!this.__yp()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__ym,R=this.__yl,T=this;if(this.__uk){return;}
;if(this.__ys(x)===w&&this.__ys(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__ys(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__ys(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__ys(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__gw){window.clearTimeout(this.__gw);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__yo();this._emit(f);this._emit(g);}
,__ym:null,__yk:null,__uw:n,__yi:null,__yj:null,__uh:null,__gw:null,__uk:null,__uB:null,__yn:function(){this.readyState=0;this.status=0;this.statusText=n;}
,_readyStateChange:function(U){this.readyState=U;this._emit(p);}
,_success:function(){this.__yr();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=n+this.status;}
,__yo:function(){this.__yr();this.readyState=4;this.status=0;this.statusText=null;}
,__yp:function(){var W=this.__ys(x)===w&&this.__ys(l)<9;var V=this.__ys(x)===s;return !(W||V);}
,__yq:function(){var X=this.__ym=document.createElement(i);X.src=this.__uw;X.onerror=this.__yj;X.onload=this.__yi;if(this.__ys(x)===w&&this.__ys(l)<9){X.onreadystatechange=this.__yi;}
;return X;}
,__yr:function(){var Y=this.__ym;if(Y&&Y.parentNode){this.__yk.removeChild(Y);}
;}
,__ys:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__uW();}
,members:{responseJson:null,__cl:null,__uP:null,__uQ:null,__uR:null,__uS:null,__uT:null,__uB:null,__uU:e,open:function(t,p){if(this.__uB){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__uR=false;q=this.__uP||b;s=this.__uQ||this.__uU+n+this.__cl+m;if(!this.__uQ){this.constructor[this.__cl]=this;}
else {if(!window[this.__uQ]){this.__uS=true;window[this.__uQ]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__uQ+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__uT=p=qx.util.Uri.appendParamsToUrl(p,r);this.__ho(c,[t,p]);}
,callback:function(v){if(this.__uB){return;}
;this.__uR=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cl]=undefined;this.__uV();}
,setCallbackParam:function(w){this.__uP=w;return this;}
,setCallbackName:function(name){this.__uQ=name;return this;}
,setPrefix:function(x){this.__uU=x;}
,getGeneratedUrl:function(){return this.__uT;}
,dispose:function(){this.__uV();this.__ho(d);}
,_onNativeLoad:function(){this.status=this.__uR?200:500;this.__ho(i);}
,__uV:function(){if(this.__uS&&window[this.__uQ]){window[this.__uQ]=undefined;this.__uS=false;}
;}
,__ho:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__uW:function(){this.__cl=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
...
(function(){var a="Enter",b="qooxdoo",c="keydown",d="model.photos.photo",f=".jpg",g="execute",h="source",i="selection[0]",j="_s.jpg",k="<span style='font-size: 20px'>Flickr</span>",l="loading",m="value",n="demobrowser.demo.data.store.Flickr",o="/",p=".static.flickr.com/",q="demobrowser.demo.data.Flickr",r="http://api.flickr.com/services/rest/?tags=",s="title",t="",u="icon",v="_",w="state",x="http://farm",y="Search",z="jsonFlickrApi",A="horizontal",B="model",C="&method=flickr.photos.search&api_key=63a8042eead205f7e0040f488c02afd9&format=json",D="id";qx.Class.define(q,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var L=new demobrowser.demo.data.store.Flickr(b);var E=new qx.ui.form.TextField(b);this.getRoot().add(E,{left:30,top:50});var F=new qx.ui.form.Button(y);this.getRoot().add(F,{left:140,top:49});F.addListener(g,function(){L.searchForTag(E.getValue());}
,this);E.addListener(c,function(e){if(e.getKeyIdentifier()==a){L.searchForTag(E.getValue());}
;}
,this);var status=new qx.ui.basic.Label(l);this.getRoot().add(status,{left:210,top:52});L.bind(w,status,m);var I=new qx.ui.form.List();I.setWidth(700);I.setHeight(110);I.setOrientation(A);this.getRoot().add(I,{left:30,right:30,top:80});var K=new qx.data.controller.List(null,I);K.setLabelPath(s);K.setDelegate({configureItem:function(N){N.setShow(u);}
});var G={converter:function(P,O){return (x+O.getFarm()+p+O.getServer()+o+P+v+O.getSecret()+j);}
};K.setIconOptions(G);K.setIconPath(D);L.bind(d,K,B);var H=new qx.ui.basic.Image();this.getRoot().add(H,{left:30,top:200});var M={converter:function(Q){if(Q){return (x+Q.getFarm()+p+Q.getServer()+o+Q.getId()+v+Q.getSecret()+f);}
;return t;}
};K.bind(i,H,h,M);var J=new qx.ui.basic.Label();J.setRich(true);J.setWidth(260);J.setValue(k);this.getRoot().add(J,{left:10,top:10});}
}});qx.Class.define(n,{extend:qx.data.store.Jsonp,construct:function(R){this.setCallbackName(z);qx.data.store.Jsonp.call(this,this.__OH(R));}
,members:{searchForTag:function(S){if(S!=t){this.setUrl(this.__OH(S));}
;}
,__OH:function(U){if(!U){return;}
;var T=r+U;T+=C;return T;}
}});}
)();
...
(function(){var a="indexOf",b="addAfter",c="add",d="addBefore",e="_",f="addAt",g="hasChildren",h="removeAt",i="removeAll",j="getChildren",k="remove",l="qx.ui.core.MRemoteChildrenHandling";qx.Mixin.define(l,{members:{__nT:function(q,m,o,n){var p=this.getChildrenContainer();if(p===this){q=e+q;}
;return (p[q])(m,o,n);}
,getChildren:function(){return this.__nT(j);}
,hasChildren:function(){return this.__nT(g);}
,add:function(s,r){return this.__nT(c,s,r);}
,remove:function(t){return this.__nT(k,t);}
,removeAll:function(){return this.__nT(i);}
,indexOf:function(u){return this.__nT(a,u);}
,addAt:function(x,v,w){this.__nT(f,x,v,w);}
,addBefore:function(y,A,z){this.__nT(d,y,A,z);}
,addAfter:function(D,B,C){this.__nT(b,D,B,C);}
,removeAt:function(E){return this.__nT(h,E);}
}});}
)();
...
(function(){var a="vertical",b="under",c="above",d="qx.ui.core.selection.Widget",e="left",f="right";qx.Class.define(d,{extend:qx.ui.core.selection.Abstract,construct:function(g){qx.ui.core.selection.Abstract.call(this);this.__mm=g;}
,members:{__mm:null,_isSelectable:function(h){return this._isItemSelectable(h)&&h.getLayoutParent()===this.__mm;}
,_selectableToHashCode:function(j){return j.$$hash;}
,_styleSelectable:function(k,m,n){n?k.addState(m):k.removeState(m);}
,_capture:function(){this.__mm.capture();}
,_releaseCapture:function(){this.__mm.releaseCapture();}
,_isItemSelectable:function(o){if(this._userInteraction){return o.isVisible()&&o.isEnabled();}
else {return o.isVisible();}
;}
,_getWidget:function(){return this.__mm;}
,_getLocation:function(){var p=this.__mm.getContentElement().getDomElement();return p?qx.bom.element.Location.get(p):null;}
,_getDimension:function(){return this.__mm.getInnerSize();}
...
,_scrollItemIntoView:function(w){this.__mm.scrollChildIntoView(w);}
,getSelectables:function(x){var y=false;if(!x){y=this._userInteraction;this._userInteraction=true;}
;var B=this.__mm.getChildren();var z=[];var A;for(var i=0,l=B.length;i<l;i++ ){A=B[i];if(this._isItemSelectable(A)){z.push(A);}
;}
;this._userInteraction=y;return z;}
,_getSelectableRange:function(C,D){if(C===D){return [C];}
;var H=this.__mm.getChildren();var E=[];var G=false;var F;for(var i=0,l=H.length;i<l;i++ ){F=H[i];if(F===C||F===D){if(G){E.push(F);break;}
else {G=true;}
;}
;if(G&&this._isItemSelectable(F)){E.push(F);}
;}
;return E;}
,_getFirstSelectable:function(){var I=this.__mm.getChildren();for(var i=0,l=I.length;i<l;i++ ){if(this._isItemSelectable(I[i])){return I[i];}
;}
;return null;}
,_getLastSelectable:function(){var J=this.__mm.getChildren();for(var i=J.length-1;i>0;i-- ){if(this._isItemSelectable(J[i])){return J[i];}
;}
;return null;}
,_getRelatedSelectable:function(N,O){var L=this.__mm.getOrientation()===a;var P=this.__mm.getChildren();var K=P.indexOf(N);var M;if((L&&O===c)||(!L&&O===e)){for(var i=K-1;i>=0;i-- ){M=P[i];if(this._isItemSelectable(M)){return M;}
;}
;}
...
,_applyOrientation:function(F,C){var D=F===x;var E=D?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__nO;content.setLayout(E);content.setAllowGrowX(!D);content.setAllowGrowY(D);this._applySpacing(this.getSpacing());}
,_applySpacing:function(H,G){this.__nO.getLayout().setSpacing(H);}
...
;if(((new Date).valueOf()-this.__yu)>1000){this.__yt=s;}
...
;}
;}
else if(this.__yA()){var r=this.getSelection().getItem(this.getSelection().length-1);if(r!==undefined){this.__te(r);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
...
,__te:function(x){var y=this.__yB(x);if(y==null){return;}
...
;if(S!=null){if(this.getModel()!=null){for(var i=0;i<this.__xi.length;i++ ){this.__yL(this.__yP(i));}
;}
;}
;}
,__yI:function(){this.__yH=true;qx.ui.core.queue.Widget.add(this);if(this.__xi.length!=this.getModel().getLength()){this.update();}
;}
...
;this.__xq();var U=this.__xi.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++ ){this.__yL(this.__yP(j));}
;}
...
;var bQ=this.__xi;this.__xq();if(bQ.length>this.__xi.length){for(var j=bQ.length;j>this.__xi.length;j-- ){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bQ.length<this.__xi.length){for(var j=bQ.length;j<this.__xi.length;j++ ){var bT=this._createItem();this.getTarget().add(bT);}
;}
...
;this.__xi=[];for(var i=0;i<bW.getLength();i++ ){if(bV==null||bV(bW.getItem(i))){this.__xi.push(i);}
;}
;}
,__yP:function(bY){return this.__xi[bY];}
},destruct:function(){this.__xi=this.__yE=this.__yC=null;this.__yD=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
