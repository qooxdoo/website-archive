...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Form.0f27d0a7f71a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__hj:null,__bb:null,_applyModel:function(o,l){for(var i=0;i<this.__hj.length;i++ ){var t=this.__hj[i][0];var q=this.__hj[i][1];var n=this.__hj[i][2];var r=this.__hj[i][3];var p=this.__hj[i][4];var m=this.__hj[i][5];if(l!=undefined&&!l.isDisposed()){this.__wx(t,q,n,l);}
;if(o!=undefined){this.__ww(t,q,n,r,p,m);}
...
;}
;}
,addTarget:function(z,w,u,x,y,v){this.__hj.push([z,w,u,x,y,v]);this.__ww(z,w,u,x,y,v);}
,__ww:function(F,D,B,G,E,A){if(this.getModel()==null){return;}
...
,removeTarget:function(K,J,L){this.__wx(K,J,L,this.getModel());for(var i=0;i<this.__hj.length;i++ ){if(this.__hj[i][0]==K&&this.__hj[i][1]==J&&this.__hj[i][2]==L){this.__hj.splice(i,1);}
;}
;}
,__wx:function(R,O,N,M){if(!(R instanceof qx.core.Object)){return;}
