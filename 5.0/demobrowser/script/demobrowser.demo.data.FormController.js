...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController.0ace9b9fea03.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="modelSelection[0]",c="qx.core.Object",d="qx.debug",e="_applyTarget",f="qx.data.controller.Form",g="changeTarget",h="value",j=" of ",k="Could not bind property ",l=".",m="No target is set.",n="qx.ui.form.Form",o="_applyModel";qx.Class.define(f,{extend:qx.core.Object,construct:function(p,r,q){qx.core.Object.call(this);this._selfUpdate=!!q;this.__GC={};if(p!=null){this.setModel(p);}
;if(r!=null){this.setTarget(r);}
;}
,properties:{model:{check:c,apply:o,event:a,nullable:true,dereference:true},target:{check:n,apply:e,event:g,nullable:true,init:null,dereference:true}},members:{__GD:null,__GC:null,addBindingOptions:function(name,u,v){this.__GC[name]=[u,v];if(this.getModel()==null||this.getTarget()==null){return;}
;var s=this.getTarget().getItems()[name];var t=this.__GG(s)?b:h;this.__GD.removeTarget(s,t,name);this.__GD.addTarget(s,t,name,!this._selfUpdate,u,v);}
...
;if(this.__GC[name]&&this.__GC[name][1]){A=this.__GC[name][1].converter(A);}
;D[E[i]]=A;}
else {if(!D[E[i]]){D[E[i]]={};}
;D=D[E[i]];}
;}
...
;var F=this.getTarget().getItems();for(var name in F){var I=F[name];var H=this.__GG(I)?b:h;var G=this.__GC[name];G=G&&this.__GC[name][1];qx.data.SingleValueBinding.updateTarget(I,H,this.getModel(),name,G);}
;}
,_applyTarget:function(K,J){if(J!=null){this.__GF(J);}
;if(this.getModel()==null){return;}
;if(K!=null){this.__GE();}
;}
,_applyModel:function(N,L){if(this.__GD!=null&&N==null){this.__GD.setModel(null);}
;if(this.__GD!=null){var M=this.getTarget().getItems();for(var name in M){var O=M[name];var P=this.__GG(O)?b:h;this.__GD.removeTarget(O,P,name);}
;}
;if(this.__GD!=null){this.__GD.setModel(N);}
;if(this.getTarget()==null){return;}
;if(N!=null){this.__GE();}
;}
,__GE:function(){if(this.__GD==null){this.__GD=new qx.data.controller.Object(this.getModel());}
;var T=this.getTarget().getItems();for(var name in T){var Q=T[name];var R=this.__GG(Q)?b:h;var S=this.__GC[name];try{if(S==null){this.__GD.addTarget(Q,R,name,!this._selfUpdate);}
else {this.__GD.addTarget(Q,R,name,!this._selfUpdate,S[0],S[1]);}
;}
catch(U){if(qx.core.Environment.get(d)){this.warn(k+name+j+this.getModel());}
;}
;}
;this.getTarget().redefineResetter();}
,__GF:function(V){if(this.__GD==null){return;}
;var Y=V.getItems();for(var name in Y){var X=Y[name];var W=this.__GG(X)?b:h;this.__GD.removeTarget(X,W,name);}
;}
,__GG:function(ba){return qx.Class.hasInterface(ba.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(ba.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__GD){this.__GD.dispose();}
;}
});}
)();
