...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns.5d1a01509754.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="scrollY",b="__wL",c="cellTap",d="__wR",f="qx.event.type.Data",g="change",h="qx.debug",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="scrollX",p="appear",q="__wS",r="pointerdown",s="qx.ui.virtual.core.Pane",t="qx.ui.virtual.core.CellEvent",u="update",v="contextmenu",w="tap",x="__wK";qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__wK=new qx.ui.virtual.core.Axis(A,B);this.__wL=new qx.ui.virtual.core.Axis(z,y);this.__wM=0;this.__wN=0;this.__wO=0;this.__wP=0;this.__wQ={};this.__jh={};this.__wR=new qx.ui.container.Composite();this.__wR.setUserBounds(0,0,0,0);this._add(this.__wR);this.__wS=[];this.__wK.addListener(g,this.fullUpdate,this);this.__wL.addListener(g,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(p,this._onAppear,this);this.addListener(r,this._onPointerDown,this);this.addListener(w,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(v,this._onContextmenu,this);}
,events:{cellTap:t,cellContextmenu:t,cellDbltap:t,update:j,scrollX:f,scrollY:f},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__wK:null,__wL:null,__wM:null,__wN:null,__wO:null,__wP:null,__wQ:null,__jh:null,__wR:null,__wS:null,__wT:null,__qj:null,__wU:null,__wV:null,getRowConfig:function(){return this.__wK;}
...
,__wW:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__wV;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
...
;this.__jh={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__wK.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__wK.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__wL.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__wL.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__wQ={top:bU,bottom:bQ,left:bS,right:bI};this.__wR.setUserBounds((this.getPaddingLeft()||0)+(this.__wQ.left-this.__wN),(this.getPaddingTop()||0)+(this.__wQ.top-this.__wM),bO,bM);this.__qj=bH;this.__wU=bR;for(var i=0;i<this.__wS.length;i++ ){var bG=this.__wS[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__wX:function(){if(this.__wT){return;}
;var bW=this.getScrollSize();if(this.__wO!==bW.height||this.__wP!==bW.width){this.__wO=bW.height;this.__wP=bW.width;this.fireEvent(u);}
;}
...
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__wX();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__wN,this.__wM,bY.width,bY.height,true);this.__wX();}
,_deferredUpdateScrollPosition:function(){this.__jh._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__wX();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__wM,bottom:this.__wM+cc.height,left:this.__wN,right:this.__wN+cc.width};if(this.__wQ.top<=cb.top&&this.__wQ.bottom>=cb.bottom&&this.__wQ.left<=cb.left&&this.__wQ.right>=cb.right){this.__wR.setUserBounds((this.getPaddingLeft()||0)+(this.__wQ.left-cb.left),(this.getPaddingTop()||0)+(this.__wQ.top-cb.top),this.__wQ.right-this.__wQ.left,this.__wQ.bottom-this.__wQ.top);}
else {this._setLayerWindow(ca,this.__wN,this.__wM,cc.width,cc.height,false);}
;this.__wX();}
},destruct:function(){this._disposeArray(q);this._disposeObjects(x,b,d);this.__wQ=this.__jh=this.__qj=this.__wU=null;}
});}
)();
...
(function(){var a="one",b="Boolean",c="qx.ui.virtual.selection.MModel",d="qx.data.Array",f="multi",g="selected",h="_applySelection",j="change",k="_applyDragSelection",l="single",m="_applyQuickSelection",n="changeSelection",o="_applySelectionMode",p="additive",q="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this._initSelectionManager();this.__wz=new qx.data.Array();this.initSelection(this.__wz);}
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__xd:false,__xe:false,__wz:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
;this.__xd=true;var G=this.getSelection();var I=[];for(var i=0;i<G.getLength();i++ ){var H=G.getItem(i);var J=this._getSelectables();var F=-1;if(J!=null){F=J.indexOf(H);}
...
;this.__wE();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__xd=false;}
,_onManagerChangeSelection:function(e){if(this.__xd==true){return;}
;this.__xe=true;this.__wE();this.__xe=false;}
,__wE:function(){if(this.__xg()){return;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__wz){this.__wz.dispose();}
;}
});}
)();
...
;this._fireChange();}
,_setLeadItem:function(cb){var ca=this.__nv;if(ca!==null){this._styleSelectable(ca,u,false);}
;if(cb!==null){this._styleSelectable(cb,u,true);}
;this.__nv=cb;}
,getLeadItem:function(){return this.__nv;}
,_setAnchorItem:function(cd){var cc=this.__nw;if(cc!=null){this._styleSelectable(cc,J,false);}
;if(cd!=null){this._styleSelectable(cd,J,true);}
;this.__nw=cd;}
,_getAnchorItem:function(){return this.__nw!==null?this.__nw:null;}
...
;this._fireChange();}
,handlePointerOver:function(event){if(this.__ny!=null&&this.__ny!=this._getScroll().top){this.__ny=null;return;}
...
;var cD=event.isCtrlPressed()||(qx.core.Environment.get(c)==F&&event.isMetaPressed());var cA=event.isShiftPressed();if(this.isItemSelected(cB)&&!cA&&!cD&&!this.getDrag()){this.__nx=cB;this._userInteraction=false;return;}
else {this.__nx=null;}
;this._scrollItemIntoView(cB);var cC=this.getMode();if(this.getDrag()&&cC!==bu&&cC!==h&&!cA&&!cD&&event.getPointerType()==G){this._setAnchorItem(cB);this._setLeadItem(cB);this.__nl=this._getLocation();this.__ni=this._getScroll();this.__nm=event.getDocumentLeft()+this.__ni.left;this.__nn=event.getDocumentTop()+this.__ni.top;this.__no=true;this._capture();}
;this._fireChange(bD);this._userInteraction=false;}
,handleTap:function(event){this._userInteraction=true;var cH=event.isCtrlPressed()||(qx.core.Environment.get(c)==F&&event.isMetaPressed());var cE=event.isShiftPressed();if(!cH&&!cE&&this.__nx!=null){this._userInteraction=false;var cF=this._getSelectableFromPointerEvent(event);if(cF===null||!this.isItemSelected(cF)){return;}
;}
...
,handlePointerMove:function(event){if(!this.__no){return;}
;this.__np=event.getDocumentLeft();this.__nq=event.getDocumentTop();this._userInteraction=true;var cI=this.__np+this.__ni.left;if(cI>this.__nm){this.__nr=1;}
else if(cI<this.__nm){this.__nr=-1;}
else {this.__nr=0;}
;var cJ=this.__nq+this.__ni.top;if(cJ>this.__nn){this.__ns=1;}
else if(cJ<this.__nn){this.__ns=-1;}
else {this.__ns=0;}
;var location=this.__nl;if(this.__np<location.left){this.__nf=this.__np-location.left;}
else if(this.__np>location.right){this.__nf=this.__np-location.right;}
else {this.__nf=0;}
;if(this.__nq<location.top){this.__ng=this.__nq-location.top;}
else if(this.__nq>location.bottom){this.__ng=this.__nq-location.bottom;}
else {this.__ng=0;}
;if(!this.__nh){this.__nh=new qx.event.Timer(100);this.__nh.addListener(H,this._onInterval,this);}
;this.__nh.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
,handleAddItem:function(e){var cK=e.getData();if(this.getMode()===h&&this.isSelectionEmpty()){this.addItem(cK);}
;}
,handleRemoveItem:function(e){this.removeItem(e.getData());}
,_cleanup:function(){if(!this.getDrag()&&this.__no){return;}
;if(this.__nt){this._fireChange(bD);}
;delete this.__no;delete this.__nj;delete this.__nk;this._releaseCapture();if(this.__nh){this.__nh.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__nf,this.__ng);this.__ni=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cT=this._getDimension();var cM=Math.max(0,Math.min(this.__np-this.__nl.left,cT.width))+this.__ni.left;var cL=Math.max(0,Math.min(this.__nq-this.__nl.top,cT.height))+this.__ni.top;if(this.__nj===cM&&this.__nk===cL){return;}
;this.__nj=cM;this.__nk=cL;var cQ=this._getAnchorItem();var cO=cQ;var cR=this.__nr;var cU,cN;while(cR!==0){cU=cR>0?this._getRelatedSelectable(cO,t):this._getRelatedSelectable(cO,W);if(cU!==null){cN=this._getSelectableLocationX(cU);if((cR>0&&cN.left<=cM)||(cR<0&&cN.right>=cM)){cO=cU;continue;}
;}
;break;}
;var cS=this.__ns;var cV,cP;while(cS!==0){cV=cS>0?this._getRelatedSelectable(cO,A):this._getRelatedSelectable(cO,bB);if(cV!==null){cP=this._getSelectableLocationY(cV);if((cS>0&&cP.top<=cL)||(cS<0&&cP.bottom>=cL)){cO=cV;continue;}
;}
;break;}
...
;this._fireChange(bw);}
,__nz:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;var dd,dc;var df=event.getKeyIdentifier();var de=this.getMode();var cY=event.isCtrlPressed()||(qx.core.Environment.get(c)==F&&event.isMetaPressed());var da=event.isShiftPressed();var db=false;if(df===B&&cY){if(de!==bu&&de!==h){this._selectAllItems();db=true;}
;}
...
;}
;break;};this.__ny=this._getScroll().top;this._scrollItemIntoView(dc);}
;}
...
;this.__gD={};}
,_selectItemRange:function(dk,dp,dm){var dq=this._getSelectableRange(dk,dp);if(!dm){var dn=this.__gD;var dr=this.__nA(dq);for(var dl in dn){if(!dr[dl]){this._removeFromSelection(dn[dl]);}
;}
;}
...
;}
,__nA:function(dw){var dx={};var dv;for(var i=0,l=dw.length;i<l;i++ ){dv=dw[i];dx[this._selectableToHashCode(dv)]=dv;}
;return dx;}
...
;}
;}
,_addToSelection:function(dC){var dD=this._selectableToHashCode(dC);if(this.__gD[dD]==null&&this._isSelectable(dC)){this.__gD[dD]=dC;this._styleSelectable(dC,S,true);this.__nt=true;}
;}
,_toggleInSelection:function(dE){var dF=this._selectableToHashCode(dE);if(this.__gD[dF]==null){this.__gD[dF]=dE;this._styleSelectable(dE,S,true);}
else {delete this.__gD[dF];this._styleSelectable(dE,S,false);}
;this.__nt=true;}
,_removeFromSelection:function(dG){var dH=this._selectableToHashCode(dG);if(this.__gD[dH]!=null){delete this.__gD[dH];this._styleSelectable(dG,S,false);this.__nt=true;}
;}
...
;if(!dL){return false;}
;this._scrollItemIntoView(dI);this._setLeadItem(dP);this._setAnchorItem(dP);this.__nt=true;this._fireChange();}
,_fireChange:function(dQ){if(this.__nt){this.__nu=dQ||null;this.fireDataEvent(bA,this.getSelection());delete this.__nt;}
;}
...
;return dS;}
;return null;}
},destruct:function(){this._disposeObjects(y);this.__gD=this.__nx=this.__nw=null;this.__nv=null;}
});}
)();
...
,openNodeAndParents:function(bk){this.__Dh(this.getModel(),bk);this.buildLookupTable();}
,closeNode:function(bl){if(qx.lang.Array.contains(this.__Db,bl)){qx.lang.Array.remove(this.__Db,bl);this.fireDataEvent(G,bl);this.buildLookupTable();}
;}
...
,isNodeOpen:function(bo){return qx.lang.Array.contains(this.__Db,bo);}
,_init:function(){this.__xi=new qx.data.Array();this.__Db=[];this.__Dc=[];this._initLayer();}
...
,this);}
,getLookupTable:function(){return this.__xi;}
,_reverseLookup:function(bp){return bp;}
,_getDataFromRow:function(bq){return this.__xi.getItem(bq);}
,_getSelectables:function(){return this.__xi;}
,getOpenNodes:function(){return this.__Db;}
,isNode:function(br){return qx.ui.tree.core.Util.isNode(br,this.getChildProperty());}
,getLevel:function(bs){return this.__Dc[bs];}
...
,_applyModel:function(bQ,bP){this.__Db=[];if(bQ!=null){if(qx.core.Environment.get(w)){if(!qx.Class.hasMixin(bQ.constructor,qx.data.marshal.MEventBubbling)){this.warn(H+h+k);}
;}
;bQ.addListener(J,this._onChangeBubble,this);this.__Dg(bQ);}
...
;}
;if(this.__xi.indexOf(bV)!=-1){this.__De();}
;}
;}
,_onUpdated:function(event){if(this.__hi==null){this.__hi=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__hi.schedule();}
,_onOpen:function(event){var ca=event.getRow();var bY=this.__xi.getItem(ca);if(this.isNode(bY)){if(this.isNodeOpen(bY)){this.closeNode(bY);}
...
;break;};}
;}
,_beforeApplySelection:function(cg){if(cg.length===0&&this.getSelectionMode()===g){var cf=this.__Dj();var ch=this.getLookupTable().indexOf(cf);if(ch>=0){cg.push(ch);}
;}
;}
,_afterApplySelection:function(){var ci=this.getSelection();if(ci.getLength()>0&&this.getSelectionMode()===g){this.__Di(ci.getItem(0));}
else {this.__Dd=[];}
;}
,__De:function(){this.buildLookupTable();this._applyDefaultSelection();}
,buildLookupTable:function(){if(this.getModel()!=null&&(this.getChildProperty()==null||this.getLabelPath()==null)){throw new Error(Q+f);}
;this._itemWidth=0;var cm=[];this.__Dc=[];var ck=-1;var cl=this.getModel();if(cl!=null){if(!this.isHideRoot()){ck++ ;cm.push(cl);this.__Dc.push(ck);}
;if(this.isNodeOpen(cl)){var cj=this.__Df(cl,ck);cm=cm.concat(cj);}
;}
;if(!qx.lang.Array.equals(this.__xi.toArray(),cm)){this._provider.removeBindings();this.__xi.removeAll();this.__xi.append(cm);this.__xo();this._updateSelection();}
;}
,__Df:function(cn,cs){var cr=[];cs++ ;if(!this.isNode(cn)){return cr;}
...
;if(this.isNode(cu)){this.__Dc.push(cs);cr.push(cu);if(this.isNodeOpen(cu)){var co=this.__Df(cu,cs);cr=cr.concat(co);}
;}
else {if(this.isShowLeafs()){this.__Dc.push(cs);cr.push(cu);}
;}
;}
;cv.dispose();return cr;}
,__Dg:function(cw){if(!qx.lang.Array.contains(this.__Db,cw)){this.__Db.push(cw);this.fireDataEvent(t,cw);}
;}
,__Dh:function(cx,cy){if(cx===cy){this.__Dg(cy);return true;}
;if(!this.isNode(cx)){return false;}
;var cB=cx.get(this.getChildProperty());if(cB==null){return false;}
;for(var i=0;i<cB.getLength();i++ ){var cA=cB.getItem(i);var cz=this.__Dh(cA,cy);if(cz===true){this.__Dg(cA);return true;}
;}
;return false;}
,__xo:function(){this.getPane().getRowConfig().setItemCount(this.__xi.getLength());this.getPane().fullUpdate();}
,getParent:function(cD){var cE=this.__xi.indexOf(cD);if(cE<0){return null;}
;var cF=this.__Dc[cE];while(cE>0){cE-- ;var cC=this.__Dc[cE];if(cC<cF){return this.__xi.getItem(cE);}
;}
;return null;}
,__Di:function(cG){this.__Dd=[];var parent=this.getParent(cG);while(parent!=null){this.__Dd.unshift(parent);parent=this.getParent(parent);}
;}
,__Dj:function(){if(this.__Dd==null){return this.getModel();}
;var cH=this.getLookupTable();var parent=this.__Dd.pop();while(parent!=null){if(cH.contains(parent)){return parent;}
;parent=this.__Dd.pop();}
...
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__hi!=null){this.__hi.cancel();this.__hi.dispose();}
;var cI=this.getModel();if(cI!=null){cI.removeListener(J,this._onChangeBubble,this);}
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__xi.dispose();this._layer=this._provider=this.__xi=this.__Db=this.__hi=null;}
});}
)();
...
(function(){var a="BindingIds",b="model",c="",d="changeDelegate",f="virtual-tree-file",g="label",h="appearance",i="icon",j="bindItem",k=".length",l="]",m="virtual-tree-folder",n="[",o=".",p="String",q="qx.ui.tree.core.MWidgetController";qx.Mixin.define(q,{construct:function(){this.__xC=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:p,nullable:true},delegate:{event:d,init:null,nullable:true}},members:{__xC:null,bindDefaultProperties:function(u,s){this.bindProperty(c,b,null,u,s);this.bindProperty(this.getLabelPath(),g,this.getLabelOptions(),u,s);var r=this.__xD(s);var t=this._tree.getLookupTable();t=qx.data.SingleValueBinding.resolvePropertyChain(t,r);if(qx.util.OOUtil.hasProperty(t.constructor,this.getChildProperty())){this.bindProperty(this.getChildProperty()+k,h,{converter:function(){return m;}
},u,s);}
else {u.setAppearance(f);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),i,this.getIconOptions(),u,s);}
;}
,bindProperty:function(y,B,z,x,v){var A=this.__xD(v,y);var w=this._tree.getLookupTable();var C=w.bind(A,x,B,z);this.__xE(x,C);}
,bindPropertyReverse:function(J,F,H,I,D){var G=this.__xD(D,J);var E=this._tree.getLookupTable();var K=I.bind(F,E,G,H);this.__xE(I,K);}
,removeBindings:function(){while(this.__xC.length>0){var L=this.__xC.pop();this._removeBindingsFrom(L);}
;}
...
;}
,_removeBindingsFrom:function(P){var Q=this.__xF(P);while(Q.length>0){var R=Q.pop();try{this._tree.getLookupTable().removeBinding(R);}
catch(e){P.removeBinding(R);}
;}
;if(qx.lang.Array.contains(this.__xC,P)){qx.lang.Array.remove(this.__xC,P);}
;}
,__xD:function(T,U){var S=n+T+l;if(U!=null&&U!=c){S+=o+U;}
;return S;}
,__xE:function(W,X){var V=this.__xF(W);if(!qx.lang.Array.contains(V,X)){V.push(X);}
;if(!qx.lang.Array.contains(this.__xC,W)){this.__xC.push(W);}
;}
,__xF:function(Y){var ba=Y.getUserData(a);if(ba==null){ba=[];Y.setUserData(a,ba);}
;return ba;}
...
;var o=this._renderer.getCellWidget();o.setOpen(p&&this._tree.isNodeOpen(s));o.addListener(a,this.__Dk,this);o.setUserData(b,this.getChildProperty());o.setUserData(g,this._tree.isShowLeafs());if(this._tree.getSelection().contains(s)){this._styleSelectabled(o);}
...
,poolCellWidget:function(u){u.removeListener(a,this.__Dk,this);this._removeBindingsFrom(u);this._renderer.pool(u);this._onPool(u);}
...
,__Dk:function(event){var K=event.getTarget();var L=K.getUserData(k);var J=this._tree.getLookupTable().getItem(L);if(event.getData()){this._tree.openNodeWithoutScrolling(J);}
...
,properties:{anonymous:{refine:true,init:true}},members:{__jh:null,__bM:null,__xv:null,__xw:null,__wU:null,__qj:null,getFirstRow:function(){return this.__xv;}
,getFirstColumn:function(){return this.__xw;}
,getRowSizes:function(){return this.__wU||[];}
,getColumnSizes:function(){return this.__qj||[];}
...
else if(this.__jh.updateLayerData&&this.__wU){this._updateLayerData();}
;if(this.__jh.fullUpdate||this.__jh.updateLayerWindow){var d=this.__bM;this.__xv=d[0];this.__xw=d[1];this.__wU=d[2];this.__qj=d[3];}
;this.__jh={};}
,_updateLayerData:function(){this._fullUpdate(this.__xv,this.__xw,this.__wU,this.__qj);}
...
},destruct:function(){this.__jh=this.__bM=this.__wU=this.__qj=null;}
});}
)();
...
;this._cellProvider=h;this.__xI=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__xI:null,getRenderedCellWidget:function(q,n){if(this._getChildren().length===0){return null;}
...
;}
,_getSpacer:function(){var r=this.__xI.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(B,v,A,z){var C=this._cellProvider;var H=this._getChildren().concat();for(var i=0;i<H.length;i++ ){var F=H[i];if(F.getUserData(g)){this.__xI.push(F);}
...
;}
;}
;var L=this._cellProvider;var P=this._getChildren().concat();for(var i=0;i<P.length;i++ ){if(!bb[i]){var W=P[i];if(W.getUserData(g)){this.__xI.push(W);}
...
;this._cellProvider=this.__xI=null;}
});}
)();
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__xJ();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cO.push(p);}
,_cleanupPool:function(){var q=this.__cO.pop();while(q){q.destroy();q=this.__cO.pop();}
;}
,__xJ:function(){var r=this.__cO.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
...
;}
,addIcon:function(){var L=this.getChildControl(s);if(this.__nC){this._remove(L);}
;this._add(L);this.__nC=true;}
,addLabel:function(M){var N=this.getChildControl(D);if(this.__nB){this._remove(N);}
;if(M){this.setLabel(M);}
else {N.setValue(this.getLabel());}
;this._add(N);this.__nB=true;}
,_applyIcon:function(P,O){if(!this.__nF()){this.__nG(P);}
else if(!this.isOpen()){this.__nG(P);}
;}
,_applyIconOpened:function(R,Q){if(this.isOpen()){if(this.__nE()&&this.__nF()){this.__nG(R);}
else if(!this.__nE()&&this.__nF()){this.__nG(R);}
;}
;}
...
;var X;if(W){X=this.__nF()?this.getIconOpened():null;}
else {X=this.getIcon();}
;if(X){this.__nG(X);}
;W?this.addState(t):this.removeState(t);}
,__nE:function(){return qx.util.PropertyUtil.getUserValue(this,s);}
,__nF:function(){return qx.util.PropertyUtil.getUserValue(this,u);}
,__nG:function(Y){var ba=this.getChildControl(s,true);if(ba){ba.setSource(Y);}
;}
...
;}
;if(this.__nD){this.__nD.setWidth((this.getLevel()+1)*this.getIndent()-bf);}
;}
...
},members:{__tz:null,__tA:function(z){return Object.keys(z).sort().join(a);}
,toClass:function(A,B){this.__tB(A,B,null,0);}
,__tB:function(N,I,C,K){if(!qx.lang.Type.isObject(N)||!!N.$$isString||N instanceof qx.core.Object){if(N instanceof Array||qx.Bootstrap.getClass(N)==h){for(var i=0;i<N.length;i++ ){this.__tB(N[i],I,C+o+i+m,K+1);}
;}
;return;}
;var E=this.__tA(N);if(this.__tF(E,C,K)){return;}
;for(var M in N){this.__tB(N[M],I,M,K+1);}
;if(qx.Class.isDefined(s+E)){return;}
;if(this.__tz&&this.__tz.getModelClass&&this.__tz.getModelClass(E,N,C,K)!=null){return;}
;var O={};var F={__tC:this.__tC};for(var M in N){if(this.__tz&&this.__tz.getPropertyMapping){M=this.__tz.getPropertyMapping(M,E);}
...
;if(this.__tz&&this.__tz.getValidationRule){var H=this.__tz.getValidationRule(E,M);if(H){O[M].validate=k+M;F[k+M]=H;}
;}
;}
;if(this.__tz&&this.__tz.getModelSuperClass){var L=this.__tz.getModelSuperClass(E,C,K)||qx.core.Object;}
else {var L=qx.core.Object;}
;var G=[];if(this.__tz&&this.__tz.getModelMixins){var J=this.__tz.getModelMixins(E,C,K);if(!qx.lang.Type.isArray(J)){if(J!=null){G=[J];}
;}
else {G=J;}
;}
;if(I){G.push(qx.data.marshal.MEventBubbling);}
;var D={extend:L,include:G,properties:O,members:F,destruct:this.__tD};qx.Class.define(s+E,D);}
,__tD:function(){var P=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var Q in P){this.__tC(this.get(P[Q].name));}
;}
,__tC:function(R){if(!(R instanceof qx.core.Object)){return;}
;if(R.isDisposed()){return;}
;R.dispose();}
,__tE:function(S,W,X,V){var Y;if(this.__tz&&this.__tz.getModelClass){Y=this.__tz.getModelClass(S,W,X,V);}
;if(Y!=null){return (new Y());}
else {var U=s+S;var T=qx.Class.getByName(U);if(!T){throw new Error(b+U+l);}
;return (new T());}
;}
,__tF:function(ba,bd,bb){var bc=this.__tz;return bc&&bc.ignore&&bc.ignore(ba,bd,bb);}
,toModel:function(be){return this.__tG(be,null,0);}
,__tG:function(bq,bg,bm){var bk=qx.lang.Type.isObject(bq);var bf=bq instanceof Array||qx.Bootstrap.getClass(bq)==h;if((!bk&&!bf)||!!bq.$$isString||bq instanceof qx.core.Object){return bq;}
else if(this.__tF(this.__tA(bq),bg,bm)){return bq;}
else if(bf){var bo=qx.data.Array;if(this.__tz&&this.__tz.getArrayClass){var bl=this.__tz.getArrayClass(bg,bm);bo=bl||bo;}
;var br=new bo();br.setAutoDisposeItems(true);for(var i=0;i<bq.length;i++ ){br.push(this.__tG(bq[i],bg+o+i+m,bm+1));}
;return br;}
else if(bk){var bh=this.__tA(bq);var bp=this.__tE(bh,bq,bg,bm);for(var bn in bq){var bi=bn;if(this.__tz&&this.__tz.getPropertyMapping){bi=this.__tz.getPropertyMapping(bn,bh);}
;var bs=bi.replace(/-|\.|\s+/g,d);if((qx.core.Environment.get(t))&&qx.core.Environment.get(e)){if(bs!=bi){this.warn(c+bn+n+bi+v);}
;}
;bi=bs;var bj=p+qx.lang.String.firstUp(bi);if(bp[bj]){bp[bj](this.__tG(bq[bn],bn,bm+1));}
;}
;return bp;}
;throw new Error(j);}
...
(function(){var a="source",b="changeLeadIcon",c="changeSize",d="changeMode",e="changeDate",f="checked",g="changeChecked",h="icon/16/places/user-desktop.png",i="value",j="size",k="leadIcon",l="date",m="mode",n="demobrowser.demo.virtual.tree.TreeItem",o="String",p="Boolean";qx.Class.define(n,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:o,event:b,nullable:true},checked:{check:p,event:g,nullable:true},size:{check:o,event:c,nullable:true},date:{check:o,event:e,nullable:true},mode:{check:o,event:d,nullable:true}},members:{__PK:null,__PL:null,__PM:null,__PN:null,__iN:null,_addWidgets:function(){var q=this.__PK=new qx.ui.basic.Image();this.bind(k,q,a);q.setWidth(16);this.addWidget(q);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(h);var r=this.__PL=new qx.ui.form.CheckBox();this.bind(f,r,i);r.bind(i,this,f);r.setFocusable(false);r.setTriState(true);r.setMarginRight(4);this.addWidget(r);this.addLabel();this.addWidget(new qx.ui.core.Spacer(),{flex:1});var s=this.__PM=new qx.ui.basic.Label();this.bind(j,s,i);s.setWidth(50);this.addWidget(s);s=this.__PN=new qx.ui.basic.Label();this.bind(l,s,i);s.setWidth(150);this.addWidget(s);s=this.__iN=new qx.ui.basic.Label();this.bind(m,s,i);s.setWidth(80);this.addWidget(s);}
}});}
)();
