...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ProgressBar.894ab0dba412.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="black",b="%)",c="Completed: ",d="change",f="demobrowser.demo.widget.ProgressBar",g=" (",h="changeValue",i="green",j="Completed: 0 (0%)",k="complete";qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var q=this.getRoot();var l=new qx.ui.layout.VBox();var n=new qx.ui.container.Composite(l);var o=new qx.ui.indicator.ProgressBar(0,200);var p=new qx.ui.form.Slider().set({minimum:0,maximum:200});var m=new qx.ui.basic.Label();q.add(n,{left:0,top:0});n.add(o);n.add(p);n.add(m);l.setSpacing(10);n.setPadding(20);m.setValue(j);p.addListener(h,function(e){o.setValue(e.getData());}
);o.addListener(d,function(e){m.setValue(c+o.getValue()+g+e.getData()+b);m.setTextColor(a);}
);o.addListener(k,function(e){m.setTextColor(i);}
);}
}});}
)();
