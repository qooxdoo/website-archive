...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.7dbde7fad276.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="Flash Player Version",c="right",d="qooxdoo is the best!",f="Message from Flash:",g="__Ff",h="execute",i="Simple demo with FlashVars",j="bgcolor",k="__cz",l="demobrowser.demo.widget.Flash",m="demobrowser/demo/flash/TestFlash.swf",n="1) no pop-up or advertising blocker is activated.\n",o="__PP",p="Send to Flash",q="demobrowser/demo/flash/FlashVersion.swf",r="No message.",s="Flash:",t="<b>qooxdoo:</b>",u="demobrowser.demo.widget.Flash.sendMessage",v="demobrowser.demo.widget.Flash.flashReady",w="Couldn't connect to Flash Player! Please make sure that:\n",x="demobrowser/demo/flash/fo_tester.swf",y="this is passed in via FlashVars",z="Two way communication (ActionScript <-> JavaScript)",A="__PO",B="Message to Flash:",C="Show Flash Player version",D="noscale",E="__PQ",F="#FF6600";qx.Class.define(l,{extend:qx.application.Standalone,members:{__cz:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(i);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(z);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cz=this.createWindow();G.add(this.__cz,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:y};var M=new qx.ui.embed.Flash(x).set({scale:D,variables:L});M.getContentElement().setParam(j,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(C);O.addListener(h,function(){this.__cz.open();}
,this);N.add(O);return N;}
,__Ff:null,__PO:null,__PP:null,__PQ:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(t).set({rich:true}));Q.add(new qx.ui.basic.Label(f));this.__PO=new qx.ui.form.TextArea(r);this.__PO.setEnabled(false);Q.add(this.__PO,{flex:1});Q.add(new qx.ui.basic.Label(B));this.__PP=new qx.ui.form.TextArea(d);Q.add(this.__PP,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,c));this.__PQ=new qx.ui.form.Button(p);this.__PQ.setEnabled(false);this.__PQ.addListener(h,function(e){this.__Ff.getFlashElement().sendMessage(this.__PP.getValue());}
,this);S.add(this.__PQ);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(s).set({rich:true}));this.__Ff=new qx.ui.embed.Flash(m);this.__Ff.setVariables({init:v});P.add(this.__Ff,{flex:1});return R;}
,sendMessage:function(T){this.__PO.setValue(T);}
,initFlash:function(){if(this.__Ff.getFlashElement().setup){this.__Ff.getFlashElement().setup(u);this.__PQ.setEnabled(true);}
else {alert(w+n+a);}
;}
},statics:{__PR:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__PR=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__PR.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__PR.initFlash();}
},destruct:function(){this._disposeObjects(A,o,E,g,k);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__EU){this.__EU=new Date().getTime();}
;var bp=new Date().getTime()-this.__EU;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__EU=null;}
;}
else {this.fireEvent(p);this.__EU=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__EV(c,bB);}
,_applyScale:function(bD,bC){this.__EV(h,bD);}
,_applyWmode:function(bF,bE){this.__EV(m,bF);}
,_applyPlay:function(bH,bG){this.__EV(I,bH);}
,_applyLoop:function(bJ,bI){this.__EV(s,bJ);}
,_applyMenu:function(bL,bK){this.__EV(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__EV(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__EV(z,bP);}
,__EV:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__Fc={};this.__Fd={};this.__Fe={};}
,members:{__Fc:null,__Fe:null,__Fd:null,__Ff:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__Ff=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Fd,this.__Fc);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__Ff){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__Ff){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__Fd;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__Ff){throw new Error(d);}
;this.__Fd=t;}
,getAttributes:function(){return this.__Fe;}
...
else if(this.__Ff){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Fe[u];}
else {this.__Fe[u]=v;}
;}
,getParams:function(){return this.__Fc;}
...
;}
;}
;if(this.__Ff){throw new Error(l);}
;if(x===null||x===undefined){delete this.__Fc[w];}
else {this.__Fc[w]=x;}
;}
,getFlashElement:function(){return this.__Ff;}
},destruct:function(){if(this.__Ff){qx.bom.Flash.destroy(this.__Ff);}
;this.__Fc=this.__Fd=this.__Fe=null;}
});}
)();
