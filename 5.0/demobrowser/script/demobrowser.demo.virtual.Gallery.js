...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery.68078c223085.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
}});qx.Class.define(g,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bv){demobrowser.demo.virtual.AbstractGallery.call(this,bv);this.__PE=new demobrowser.demo.virtual.GalleryCell();}
,members:{__PE:null,_createScroller:function(){var bw=new qx.ui.virtual.core.Scroller(1,this.itemPerLine,this.itemHeight,this.itemWidth);this.layer=new qx.ui.virtual.layer.WidgetCell(this);bw.getPane().addLayer(this.layer);new qx.ui.virtual.behavior.Prefetch(bw,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:200,maxAbove:300,minBelow:600,maxBelow:800}).set({interval:500});return bw;}
...
;if(by){this.__PE.updateStates(bx,{selected:1});}
else {this.__PE.updateStates(bx,{});}
;}
;}
...
;var bE=this.__PE.getCellWidget(bF,bD);bE.setUserData(o,bH);return bE;}
,poolCellWidget:function(bJ){this.__PE.pool(bJ);}
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:b}},members:{__wk:null,__wl:null,__eg:null,__wm:null,__wn:null,setPrefetchX:function(o,r,p,q){this.__wk=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__wl=[v,u,t,s];}
,_onInterval:function(){var w=this.__wk;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__wl;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__wm){y.getChildControl(j).removeListenerById(this.__wm);}
;if(this.__wn){y.getChildControl(l).removeListenerById(this.__wn);}
;}
...
;this.__wm=z.getChildControl(j).addListener(g,this.__eg.restart,this.__eg);this.__wn=z.getChildControl(l).addListener(g,this.__eg.restart,this.__eg);}
else {this.__eg.stop();}
;}
,_applyInterval:function(B,A){this.__eg.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__wk=this.__wl=null;this._disposeObjects(a);}
});}
)();
