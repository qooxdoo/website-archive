...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.7e05de4f2190.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__oY=document||window.document;this.__EK();var self=this;qx.bom.Event.addNativeListener(this.__oY,this.__dx,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__oY:null,__Ib:null,__Ic:null,__dx:null,__EK:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__oY[m]!=undefined){this.__Ib=m;this.__dx=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__oY[m]!=undefined){this.__Ic=m;break;}
;}
;if(this.__Ib==null){this.__Ib=k;this.__dx=c;}
;if(this.__Ic==null){this.__Ic=b;}
;}
,isHidden:function(){return !!this.__oY[this.__Ib];}
,getVisibilityState:function(){return this.__oY[this.__Ic]||d;}
}});}
)();
