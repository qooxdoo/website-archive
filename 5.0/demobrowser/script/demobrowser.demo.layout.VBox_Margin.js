...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_Margin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Margin.c676848d89a8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="green",b="main",c="yellow",d="center",e="demobrowser.demo.layout.VBox_Margin";qx.Class.define(e,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var f=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});scroll.add(f);f.add(this.getBox1());f.add(this.getBox2());f.add(this.getBox3());f.add(this.getBox4());f.add(this.getBox5());}
,getBox1:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:b,backgroundColor:c,allowGrowY:false});var j=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var i=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var h=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});g.add(j);g.add(i);g.add(h);j.setAllowGrowX(false);i.setAllowGrowX(false);h.setAllowGrowX(false);j.setMarginLeft(20);h.setMarginRight(30);return g;}
,getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:b,backgroundColor:c,allowGrowY:false});var n=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var m=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var l=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});k.add(n);k.add(m);k.add(l);n.setMarginLeft(20);l.setMarginRight(30);return k;}
,getBox3:function(){var o=new qx.ui.layout.VBox();var q=new qx.ui.container.Composite(o).set({decorator:b,backgroundColor:c,width:150,allowGrowY:false});o.setSpacing(5);o.setAlignX(d);var s=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var r=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var p=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});q.add(s);q.add(r);q.add(p);s.setAllowGrowX(false);r.setAllowGrowX(false);p.setAllowGrowX(false);s.setMarginLeft(20);p.setMarginRight(30);return q;}
,getBox4:function(){var t=new qx.ui.layout.VBox();var v=new qx.ui.container.Composite(t).set({decorator:b,backgroundColor:c,width:150,allowGrowY:false});t.setSpacing(5);t.setAlignX(d);var x=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var w=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var u=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});v.add(x);v.add(w);v.add(u);x.setMarginLeft(20);u.setMarginLeft(5);u.setMinWidth(50);u.setMarginRight(20);return v;}
,getBox5:function(){var y=new qx.ui.layout.VBox();var A=new qx.ui.container.Composite(y).set({decorator:b,backgroundColor:c,width:150,allowGrowY:false});y.setSpacing(5);y.setAlignX(d);var C=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var B=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});var z=new qx.ui.core.Widget().set({decorator:b,backgroundColor:a});A.add(C);A.add(B);A.add(z);C.setMarginLeft(20);z.setMarginLeft(5);z.setMinWidth(50);z.setMarginRight(200);return A;}
}});}
)();
