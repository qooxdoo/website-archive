...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline-qx.theme.Indigo.6ede46773230.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:c,apply:a}},members:{_storage:null,__Cy:null,_applyModel:function(j,k){if(k){k.removeListenerById(this.__Cy);k.dispose();this.__Cy=null;}
;if(j){this.__Cy=j.addListener(b,this.__Cz,this);this.__Cz();}
else {this._storage.removeItem(this._key);}
;}
,__Cz:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
