...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Modern.d98a726b53f5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cn="Online Forum",cm="__RL",cl="icon/16/actions/format-justify-fill.png",ck="Search in files",cj="C",ci="Left aligned",ch="__wB",cg="Perl",cf="View",ce="C Dialect",bu="Info...",bt="Save as...",bs="Show line numbers",br="Quickstart",bq="icon/16/actions/contact-new.png",bp="Ctrl+N",bo="Actions",bn="Show console",bm="Search",bl="Help",cu="__RG",cv="Show status bar",cs="icon/16/actions/format-justify-left.png",ct="ANSI to OEM",cq="Centered",cr="Website 3",co="Edit",cp="icon/16/actions/format-justify-center.png",cw="Ctrl+O",cx="icon/16/actions/go-previous.png",bS="C Sharp",bR="Close",bU="Split Button",bT="Website 2",bW="icon/16/actions/document-save-as.png",bV="Python",bY="icon/16/apps/utilities-help.png",bX="Show tree",bQ="Options",bP="Spaces to tabs",a="Right aligned",b="Action 1",c="OEM to ANSI",d="Line 431",f="JavaScript",g="__RJ",h="icon",j="Action 2",k="Folder ",l="XML",cB="Line 313",cA="Paragraph",cz="demobrowser.demo.widget.Menu",cy="icon/16/actions/application-exit.png",cF="C Plus Plus",cE="Line 26",cD="Item ",cC="ASCII table",cH="__RK",cG="Option 1",K="Search next...",L="Line 12",I="Action 3",J="Replace in files",O="Uppercase",P="Ctrl+P",M="Topics",N="Panes",G="Justified",H="Ctrl+X",t="__RH",s="Search previous...",v="Change selection: ",u="__RI",p="Back",o="main",r=" = ",q="Execute command: ",n="Show ruler",m="__wI",U="icon/16/actions/format-justify-right.png",V="icon/16/actions/go-next.png",W="Ctrl+Z",X="command ",Q="Option 3",R="Next",S="Ctrl+R",T="Show macros",Y="Show tags",ba="Capitals",D="Execute button: ",C="Format",B="File",A="Change checked: ",z="Show tabs",y="Tabs to spaces",x="Search...",w="Line 1039",F="Option 2",E="Objective C",bb="Exit",bc="move to",bd="Ctrl+S",be="Syntax",bf="Ctrl+C",bg="Website 1",bh="Menu Button",bi="Line 30",bj="Lowercase",bk="Replace",by="HTML",bx="New",bw="Undo",bv="icon/16/actions/document-save.png",bC="Redo",bB="icon/22/apps/preferences-users.png",bA="icon/16/actions/document-print.png",bz="icon/16/actions/document-open.png",bE="icon/16/actions/edit-undo.png",bD="Save",bL="icon/16/actions/edit-redo.png",bM="Print",bJ="Open",bK="icon/16/actions/document-new.png",bH="icon/16/actions/edit-cut.png",bI="changeSelection",bF="icon/16/actions/edit-paste.png",bG="Copy",bN="Paste",bO="icon/16/actions/edit-copy.png",cb="Cut",ca="icon/16/actions/system-search.png",cd="changeValue",cc="execute";qx.Class.define(cz,{extend:qx.application.Standalone,members:{__RG:null,__RH:null,__RI:null,__wB:null,__wI:null,__RJ:null,__RK:null,__RL:null,main:function(){qx.application.Standalone.prototype.main.call(this);var cJ=new qx.ui.container.Scroll();var cI=new qx.ui.container.Composite(new qx.ui.layout.Canvas);cI.setPadding(20);cI.setAllowStretchX(false);cJ.add(cI);this.getRoot().add(cJ,{edge:0});this.createCommands();cI.add(this.getMenuButton(),{left:20,top:20});cI.add(this.getSplitButton(),{left:150,top:20});cI.add(this.getMenuBar(),{left:20,top:100});cI.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
...
;return cK;}
,debugRadio:function(e){this.debug(v+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(q+this.getShortcut());}
,debugButton:function(e){this.debug(D+this.getLabel());}
,debugCheckBox:function(e){this.debug(A+this.getLabel()+r+e.getData());}
,createCommands:function(){this.__RG=new qx.ui.core.Command(bp);this.__RG.addListener(cc,this.debugCommand);this.__RH=new qx.ui.core.Command(cw);this.__RH.addListener(cc,this.debugCommand);this.__RI=new qx.ui.core.Command(bd);this.__RI.addListener(cc,this.debugCommand);this.__wB=new qx.ui.core.Command(W);this.__wB.addListener(cc,this.debugCommand);this.__wI=new qx.ui.core.Command(S);this.__wI.addListener(cc,this.debugCommand);this.__RJ=new qx.ui.core.Command(H);this.__RJ.addListener(cc,this.debugCommand);this.__RK=new qx.ui.core.Command(bf);this.__RK.addListener(cc,this.debugCommand);this.__RL=new qx.ui.core.Command(P);this.__RL.addListener(cc,this.debugCommand);this.__RL.setEnabled(false);}
,getMenuButton:function(){var cM=new qx.ui.menu.Menu;cM.add(new qx.ui.menu.RadioButton(cG));cM.add(new qx.ui.menu.RadioButton(F));cM.add(new qx.ui.menu.RadioButton(Q));var cU=new qx.ui.menu.Menu;cU.add(new qx.ui.menu.RadioButton(b));cU.add(new qx.ui.menu.RadioButton(j));cU.add(new qx.ui.menu.RadioButton(I));var cT=new qx.ui.form.RadioGroup;cT.add.apply(cT,cM.getChildren());cT.addListener(bI,this.debugRadio);var cR=new qx.ui.form.RadioGroup;cR.add.apply(cR,cU.getChildren());cR.addListener(bI,this.debugRadio);var cP=new qx.ui.menu.Menu();var cS=new qx.ui.menu.Button(bw,bE,this.__wB);var da=new qx.ui.menu.Button(bC,bL,this.__wI);var cO=new qx.ui.menu.Button(cb,bH,this.__RJ);var cW=new qx.ui.menu.Button(bG,bO,this.__RK);var cQ=new qx.ui.menu.Button(bN,bF,this.__RL);var cN=new qx.ui.menu.Button(bQ,ca,null,cM);var cX=new qx.ui.menu.Button(bo,bq,null,cU);var cV=new qx.ui.menu.Button(bM,bA);cS.addListener(cc,this.debugButton);da.addListener(cc,this.debugButton);cO.addListener(cc,this.debugButton);cW.addListener(cc,this.debugButton);cQ.addListener(cc,this.debugButton);cN.addListener(cc,this.debugButton);cX.addListener(cc,this.debugButton);cV.addListener(cc,this.debugButton);cP.add(cS);cP.add(da);cP.addSeparator();cP.add(cO);cP.add(cW);cP.add(cQ);cP.addSeparator();cP.add(cN);cP.add(cX);cP.addSeparator();cP.add(cV);var cY=new qx.ui.form.MenuButton(bh,bB,cP);return cY;}
,getSplitButton:function(){var db=new qx.ui.menu.Menu;var df=new qx.ui.menu.Button(bg);var dd=new qx.ui.menu.Button(bT);var de=new qx.ui.menu.Button(cr);db.setMinWidth(120);df.addListener(cc,this.debugButton);dd.addListener(cc,this.debugButton);de.addListener(cc,this.debugButton);db.add(df);db.add(dd);db.add(de);var dc=new qx.ui.form.SplitButton(bU,bB,db);dc.addListener(cc,this.debugButton);return dc;}
,getMenuBar:function(){var dk=new qx.ui.container.Composite(new qx.ui.layout.Grow);dk.setDecorator(o);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);dk.add(toolbar);var du=new qx.ui.toolbar.Part;var dj=new qx.ui.toolbar.Part;var dn=new qx.ui.toolbar.Part;toolbar.add(du);toolbar.add(dj);toolbar.addSpacer();toolbar.add(dn);var dt=new qx.ui.toolbar.SplitButton(p,cx,this.getBackMenu());var dq=new qx.ui.toolbar.SplitButton(R,V,this.getForwardMenu());var di=new qx.ui.toolbar.Button(bx,bK,this.__RG);var dm=new qx.ui.toolbar.Button(bJ,bz,this.__RH);var ds=new qx.ui.toolbar.Button(bD,bv,this.__RI);dt.addListener(cc,this.debugButton);dq.addListener(cc,this.debugButton);di.addListener(cc,this.debugButton);dm.addListener(cc,this.debugButton);ds.addListener(cc,this.debugButton);du.add(dt);du.add(dq);du.addSeparator();du.add(di);du.add(dm);du.add(ds);du.setShow(h);var dl=new qx.ui.toolbar.MenuButton(B);var dh=new qx.ui.toolbar.MenuButton(co);var dg=new qx.ui.toolbar.MenuButton(bm);var dv=new qx.ui.toolbar.MenuButton(cf);var dr=new qx.ui.toolbar.MenuButton(C);dl.setMenu(this.getFileMenu());dh.setMenu(this.getEditMenu());dg.setMenu(this.getSearchMenu());dv.setMenu(this.getViewMenu());dr.setMenu(this.getFormatMenu());dj.add(dl);dj.add(dh);dj.add(dg);dj.add(dv);dj.add(dr);var dp=new qx.ui.toolbar.MenuButton(bl);dp.setMenu(this.getHelpMenu());dn.add(dp);return dk;}
,getBackMenu:function(){var dx=new qx.ui.menu.Menu;var dy=new qx.ui.menu.Button(cB);var dA=new qx.ui.menu.Button(w);var dw=new qx.ui.menu.Button(L);var dz=new qx.ui.menu.Button(cE);dy.addListener(cc,this.debugButton);dA.addListener(cc,this.debugButton);dw.addListener(cc,this.debugButton);dz.addListener(cc,this.debugButton);dx.add(dy);dx.add(dA);dx.add(dw);dx.add(dz);return dx;}
,getForwardMenu:function(){var dB=new qx.ui.menu.Menu;var dC=new qx.ui.menu.Button(d);var dD=new qx.ui.menu.Button(bi);dC.addListener(cc,this.debugButton);dD.addListener(cc,this.debugButton);dB.add(dC);dB.add(dD);return dB;}
,getFileMenu:function(){var dG=new qx.ui.menu.Menu;var dE=new qx.ui.menu.Button(bx,bK,this.__RG);var dI=new qx.ui.menu.Button(bJ,bz,this.__RH);var dH=new qx.ui.menu.Button(bR);var dL=new qx.ui.menu.Button(bD,bv,this.__RI);var dK=new qx.ui.menu.Button(bt,bW);var dJ=new qx.ui.menu.Button(bM,bA);var dF=new qx.ui.menu.Button(bb,cy);dE.addListener(cc,this.debugButton);dI.addListener(cc,this.debugButton);dH.addListener(cc,this.debugButton);dL.addListener(cc,this.debugButton);dK.addListener(cc,this.debugButton);dJ.addListener(cc,this.debugButton);dF.addListener(cc,this.debugButton);dG.add(dE);dG.add(dI);dG.add(dH);dG.add(dL);dG.add(dK);dG.add(dJ);dG.add(dF);return dG;}
,getEditMenu:function(){var dN=new qx.ui.menu.Menu;var dQ=new qx.ui.menu.Button(bw,bE,this.__wB);var dP=new qx.ui.menu.Button(bC,bL,this.__wI);var dM=new qx.ui.menu.Button(cb,bH,this.__RJ);var dR=new qx.ui.menu.Button(bG,bO,this.__RK);var dO=new qx.ui.menu.Button(bN,bF,this.__RL);dQ.addListener(cc,this.debugButton);dP.addListener(cc,this.debugButton);dM.addListener(cc,this.debugButton);dR.addListener(cc,this.debugButton);dO.addListener(cc,this.debugButton);dN.add(dQ);dN.add(dP);dN.addSeparator();dN.add(dM);dN.add(dR);dN.add(dO);return dN;}
,getSearchMenu:function(){var dV=new qx.ui.menu.Menu;var dT=new qx.ui.menu.Button(x,ca);var dY=new qx.ui.menu.Button(K);var dU=new qx.ui.menu.Button(s);var dX=new qx.ui.menu.Button(bk);var dS=new qx.ui.menu.Button(ck,ca);var dW=new qx.ui.menu.Button(J);dU.setEnabled(false);dT.addListener(cc,this.debugButton);dY.addListener(cc,this.debugButton);dU.addListener(cc,this.debugButton);dX.addListener(cc,this.debugButton);dS.addListener(cc,this.debugButton);dW.addListener(cc,this.debugButton);dV.add(dT);dV.add(dY);dV.add(dU);dV.add(dX);dV.addSeparator();dV.add(dS);dV.add(dW);return dV;}
,getViewMenu:function(){var ea=new qx.ui.menu.Menu;var ec=new qx.ui.menu.Button(N,null,null,this.getPanesMenu());var ef=new qx.ui.menu.Button(be,null,null,this.getSyntaxMenu());var ee=new qx.ui.menu.CheckBox(n);var ed=new qx.ui.menu.CheckBox(bs);var eb=new qx.ui.menu.Button(cC);ee.addListener(cd,this.debugCheckBox);ed.addListener(cd,this.debugCheckBox);eb.addListener(cc,this.debugButton);ea.add(ec);ea.add(ef);ea.addSeparator();ea.add(ee);ea.add(ed);ea.addSeparator();ea.add(eb);return ea;}
,getPanesMenu:function(){var eh=new qx.ui.menu.Menu;var ej=new qx.ui.menu.CheckBox(z);var el=new qx.ui.menu.CheckBox(cv);var em=new qx.ui.menu.CheckBox(bX);var ei=new qx.ui.menu.CheckBox(T);var ek=new qx.ui.menu.CheckBox(Y);var eg=new qx.ui.menu.CheckBox(bn);ej.setValue(true);el.setValue(true);ei.setValue(true);ej.addListener(cd,this.debugCheckBox);el.addListener(cd,this.debugCheckBox);em.addListener(cd,this.debugCheckBox);ei.addListener(cd,this.debugCheckBox);ek.addListener(cd,this.debugCheckBox);eg.addListener(cd,this.debugCheckBox);eh.add(el);eh.add(ej);eh.addSeparator();eh.add(em);eh.add(ei);eh.add(ek);eh.add(eg);return eh;}
,getSyntaxMenu:function(){var er=new qx.ui.menu.Menu;var en=new qx.ui.menu.RadioButton(by);var ep=new qx.ui.menu.RadioButton(l);var eo=new qx.ui.menu.RadioButton(f);var eq=new qx.ui.menu.Button(ce,null,null,this.getSyntaxCMenu());var eu=new qx.ui.menu.RadioButton(cg);var es=new qx.ui.menu.RadioButton(bV);er.add(en);er.add(ep);er.add(eo);er.add(eq);er.add(eu);er.add(es);var et=new qx.ui.form.RadioGroup;et.add(en,ep,eo,eu,es);et.add.apply(et,eq.getMenu().getChildren());et.addListener(bI,this.debugRadio);return er;}
,getSyntaxCMenu:function(){var ew=new qx.ui.menu.Menu;var ev=new qx.ui.menu.RadioButton(cj);var ez=new qx.ui.menu.RadioButton(bS);var ey=new qx.ui.menu.RadioButton(E);var ex=new qx.ui.menu.RadioButton(cF);ew.add(ev);ew.add(ez);ew.add(ey);ew.add(ex);return ew;}
,getFormatMenu:function(){var eD=new qx.ui.menu.Menu;var eC=new qx.ui.menu.Button(cA,null,null,this.getParagraphMenu());var eF=new qx.ui.menu.Button(y);var eG=new qx.ui.menu.Button(bP);var eB=new qx.ui.menu.Button(O);var eE=new qx.ui.menu.Button(bj);var eA=new qx.ui.menu.Button(ba);var eI=new qx.ui.menu.Button(c);var eH=new qx.ui.menu.Button(ct);eF.addListener(cc,this.debugButton);eG.addListener(cc,this.debugButton);eB.addListener(cc,this.debugButton);eE.addListener(cc,this.debugButton);eA.addListener(cc,this.debugButton);eI.addListener(cc,this.debugButton);eH.addListener(cc,this.debugButton);eD.add(eC);eD.add(eF);eD.add(eG);eD.addSeparator();eD.add(eB);eD.add(eE);eD.add(eA);eD.addSeparator();eD.add(eI);eD.add(eH);return eD;}
,getParagraphMenu:function(){var eJ=new qx.ui.menu.Menu;var eM=new qx.ui.menu.Button(ci,cs);var eN=new qx.ui.menu.Button(a,U);var eK=new qx.ui.menu.Button(cq,cp);var eL=new qx.ui.menu.Button(G,cl);eM.addListener(cc,this.debugButton);eN.addListener(cc,this.debugButton);eK.addListener(cc,this.debugButton);eL.addListener(cc,this.debugButton);eJ.add(eM);eJ.add(eN);eJ.add(eK);eJ.add(eL);return eJ;}
,getHelpMenu:function(){var eO=new qx.ui.menu.Menu;var eQ=new qx.ui.menu.Button(M,bY);var eS=new qx.ui.menu.Button(br);var eR=new qx.ui.menu.Button(cn);var eP=new qx.ui.menu.Button(bu);eQ.addListener(cc,this.debugButton);eS.addListener(cc,this.debugButton);eR.addListener(cc,this.debugButton);eP.addListener(cc,this.debugButton);eO.add(eQ);eO.add(eS);eO.addSeparator();eO.add(eR);eO.addSeparator();eO.add(eP);return eO;}
...
;return eT;}
,getContextMenu:function(){var eU=new qx.ui.menu.Menu;var eW=new qx.ui.menu.Button(cb,bH,this.__RJ);var eX=new qx.ui.menu.Button(bG,bO,this.__RK);var eV=new qx.ui.menu.Button(bN,bF,this.__RL);eW.addListener(cc,this.debugButton);eX.addListener(cc,this.debugButton);eV.addListener(cc,this.debugButton);eU.add(eW);eU.add(eX);eU.add(eV);return eU;}
},destruct:function(){this._disposeObjects(cu,t,u,ch,m,g,cH,cm);}
});}
)();
...
,_onMouseOver:function(e){e.stopPropagation();this.addState(l);delete this.__vU;}
...
;var T=this.getMenu();if(T&&T.isVisible()){this.__vU=true;return;}
;this.removeState(l);}
...
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__vU){this.removeState(l);}
;}
}});}
)();
