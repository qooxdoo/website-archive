...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip-qx.theme.Classic.01d452e2f391.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__RN:4,__RO:0,add:function(B){this.container.add(B,{row:Math.floor(this.__RO/this.__RN),column:this.__RO%this.__RN});this.__RO+=1;}
