...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ResizeEvent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ResizeEvent-qx.theme.Indigo.5ab13b403912.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="resize",f="demobrowser.demo.test.ResizeEvent",d="click",c="red",b="Resize red",a="blue";qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var i=new qx.ui.core.Widget().set({backgroundColor:c,width:80});var h=new qx.ui.core.Widget().set({backgroundColor:a});this.getRoot().add(i,{left:10,top:10});this.getRoot().add(h,{left:10,top:110});i.addListener(g,function(e){this.debug(b);h.setWidth(e.getData().width);}
);i.addListener(d,function(){i.setWidth(i.getWidth()+10);}
);}
}});}
)();
