...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.WebFonts","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.WebFonts-qx.theme.Simple.9df981e8820d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="demobrowser/demo/fonts/fineliner_script-webfont.woff",j="Cras interdum sollicitudin ante. Sed placerat scelerisque magna. Vestibulum ",h="demobrowser/demo/fonts/fineliner_script-webfont.ttf",g="demobrowser/demo/fonts/fineliner_script-webfont.eot",f="Select Font",e="demobrowser/demo/fonts/tobec___-webfont.eot",d="FinelinerScriptRegular",c="qx.debug",b="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.woff",a="rutrum nibh a eros. Cum sociis natoque penatibus et magnis dis parturient ",D="changeSelection",C="demobrowser/demo/fonts/tobec___-webfont.ttf",B="YanoneKaffeesatzRegular",A="Lorem ipsum dolor sit amet, consectetuer adipiscing elit.",z="Nam lectus justo, porttitor ac, ullamcorper ac, cursus in, ante. Duis mi ante,",y="demobrowser.demo.ui.WebFonts",x="ToBeContinuedRegular",w="demobrowser/demo/fonts/tobec___-webfont.woff",v="sodales in, auctor vel, vehicula eget, sapien. Proin iaculis dui vitae leo. ",u="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.ttf",s="bold",t="The quick brown fox jumps over the lazy dog",q="label",r="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.eot",o="montes, nascetur ridiculus mus.",p="Integer blandit tempus leo. Morbi turpis. Suspendisse turpis. Nulla eget leo.",m="fontId",n="sans-serif";qx.Class.define(y,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);if(qx.core.Environment.get(c)){qx.log.appender.Native;qx.log.appender.Console;}
;var I={"webFont0":{size:16,family:[n],sources:[{family:d,source:[g,h,k]}]},"webFont1":{size:13,family:[n],sources:[{family:x,source:[e,C,w]}]},"webFont2":{size:16,family:[n],sources:[{family:B,source:[r,u,b]}]}};var F={};for(var H in I){F[H]=new qx.bom.webfonts.WebFont().set(I[H]);}
;var R=t;var P=A+z+v+p+j+a+o;var Q=[];var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(S,{edge:10});var G=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));S.add(G);var K=new qx.ui.basic.Label(f);K.setFont(s);G.add(K);var L=new qx.ui.form.SelectBox();L.setMinWidth(300);for(var H in F){var N=new qx.ui.form.ListItem(F[H].getFamily()[0]);N.getChildControl(q).setFont(F[H]);N.setUserData(m,H);L.add(N);}
;L.addListener(D,function(T){var V=T.getData()[0];var U=V.getUserData(m);for(var i=0,l=Q.length;i<l;i++){Q[i].setFont(F[U]);}
;}
,this);G.add(L);var O=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));S.add(O);var M=new qx.ui.basic.Label(R);Q.push(M);M.setFont(F.webFont0);O.add(M);var E=new qx.ui.form.TextField(R);Q.push(E);E.setFont(F.webFont0);O.add(E);var J=new qx.ui.form.TextArea(P);Q.push(J);J.setFont(F.webFont0);O.add(J);}
}});}
)();
