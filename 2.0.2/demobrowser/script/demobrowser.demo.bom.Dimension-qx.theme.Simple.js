...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Dimension-qx.theme.Simple.cd912fd441c1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="Block ",e="demobrowser.demo.bom.Dimension",d="block",c=": Box=",b="; Content=",a="x";qx.Class.define(e,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);for(var i=1;i<1000;i++){var g=document.getElementById(d+i);if(!g){break;}
;var k=f+i+c+h(g)+b+j(g);this.debug(k);}
;function h(l){var m=qx.bom.element.Dimension;return m.getWidth(l)+a+m.getHeight(l);}
;function j(n){var o=qx.bom.element.Dimension;return o.getContentWidth(n)+a+o.getContentHeight(n);}
;}
}});}
)();
