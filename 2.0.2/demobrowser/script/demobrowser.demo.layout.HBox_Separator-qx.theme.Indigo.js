...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Separator-qx.theme.Indigo.3455e3e8b252.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="demobrowser.demo.layout.HBox_Separator",g="top",f="bottom",e="middle",d="yellow",c="separator-horizontal",b="green",a="main";qx.Class.define(h,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var i=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(i);i.add(this.getBox1());i.add(this.getBox2());i.add(this.getBox3());}
,getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,c)).set({decorator:a,backgroundColor:d,allowGrowX:false});j.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));j.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));j.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b}));return j;}
,getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,c)).set({decorator:a,backgroundColor:d,minHeight:60,allowGrowX:false});k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:g}));k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:e}));k.add(new qx.ui.core.Widget().set({decorator:a,backgroundColor:b,maxHeight:40,alignY:f}));return k;}
,getBox3:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,c)).set({decorator:a,backgroundColor:d,allowGrowX:false});var o=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var n=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var l=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});m.add(o);m.add(n);m.add(l);o.setMarginRight(10);n.setMarginLeft(20);n.setMarginRight(10);l.setMarginRight(10);return m;}
}});}
)();
