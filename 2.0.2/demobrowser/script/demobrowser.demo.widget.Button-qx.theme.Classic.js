...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Button","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Button-qx.theme.Classic.af701c3ca288.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="Off",r="Button A",q="#AAA",p="icon/22/actions/list-add.png",o="Button B",n="demobrowser.demo.widget.Button",m="icon/22/apps/internet-web-browser.png",l="Hover",k="icon/22/apps/media-video-player.png",j="icon/22/apps/internet-mail.png",c="changeValue",i="On",g="Checked: ",b="Toggle Button",a="0",f="white",d="main",h="execute";qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var t=new qx.ui.layout.HBox();t.setSpacing(10);var u=new qx.ui.container.Composite(t);u.setPadding(20);this.getRoot().add(u,{left:0,top:0});this.addNormalButtons(u);this.addToggleButton(u);this.addToggleButtonGroup(u);this.addRepeatButton(u);this.addHoverButton(u);}
,addNormalButtons:function(v){var w=new qx.ui.form.Button(r,k);v.add(w);var x=new qx.ui.form.Button(o,j);x.setEnabled(false);v.add(x);}
,addToggleButton:function(y){var z=new qx.ui.form.ToggleButton(b,m);z.focus();y.add(z);z.addListener(c,function(e){this.debug(g+e.getData());}
,this);}
,addToggleButtonGroup:function(A){var C=new qx.ui.form.ToggleButton(i);var B=new qx.ui.form.ToggleButton(s);var D=new qx.ui.form.RadioGroup();D.add(C,B);A.add(C);A.add(B);}
,addRepeatButton:function(E){var F=new qx.ui.form.RepeatButton(null,p);E.add(F);var G=new qx.ui.basic.Label(a);G.setDecorator(d);G.setPadding(2,4);G.setBackgroundColor(f);E.add(G);F.addListener(h,function(){var H=parseInt(G.getValue())+1;G.setValue(H.toString());}
);}
,addHoverButton:function(I){var J=new qx.ui.form.HoverButton(l).set({padding:10,backgroundColor:q});I.add(J);var K=new qx.ui.basic.Label(a);K.setDecorator(d);K.setPadding(2,4);K.setBackgroundColor(f);I.add(K);J.addListener(h,function(){var L=parseInt(K.getValue())+1;K.setValue(L.toString());}
);}
}});}
)();
