...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Flow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow-qx.theme.Classic.39c774e10fbc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var x=new qx.ui.layout.LineSizeIterator(A,this.getSpacingX());var y=0;while(x.hasMoreLines()){var z=x.computeNextLine(v);this.__Ln(z,y,v);y+=z.height+this.getSpacingY();}
;}
,__Ln:function(B,C,D){var F=qx.ui.layout.Util;var I=0;if(this.getAlignX()!=c){I=D-B.width;if(this.getAlignX()==e){I=Math.round(I/2);}
;}
...
;}
,_computeSizeHint:function(){return this.__Lo(Infinity);}
,hasHeightForWidth:function(){return true;}
,getHeightForWidth:function(K){return this.__Lo(K).height;}
,__Lo:function(L){var M=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());var Q=0;var N=0;var O=0;while(M.hasMoreLines()){var P=M.computeNextLine(L);O+=1;N=Math.max(N,P.width);Q+=P.height;}
;return {width:N,height:Q+this.getSpacingY()*(O-1)};}
}});}
)();
(function(){var b="No more lines to compute",a="qx.ui.layout.LineSizeIterator";qx.Class.define(a,{extend:Object,construct:function(c,d){this.__dW=c;this.__JQ=d;this.__JR=c.length>0;this.__JS=0;}
,members:{__dW:null,__JQ:null,__JR:null,__JS:null,computeNextLine:function(e){var e=e||Infinity;if(!this.__JR){throw new Error(b);}
;var p=this.__dW;var n=0;var g=0;var o=[];var k=[];for(var i=this.__JS;i<p.length;i++){var m=p[i];var q=m.getSizeHint();var j=this.__JT(i);var h=q.width+j;var f=i==this.__JS;if(!f&&g+h>e){this.__JS=i;break;}
;var l=q.height+m.getMarginTop()+m.getMarginBottom();o.push(m);k.push(j);g+=h;n=Math.max(n,l);if(m.getLayoutProperties().lineBreak){this.__JS=i+1;break;}
;}
;if(i>=p.length){this.__JR=false;}
;return {height:n,width:g,children:o,gapsBefore:k};}
,__JT:function(r){var s=r==this.__JS;if(s){return this.__dW[r].getMarginLeft();}
else {return Math.max(this.__dW[r-1].getMarginRight(),this.__dW[r].getMarginLeft(),this.__JQ);}
;}
,hasMoreLines:function(){return this.__JR;}
}});}
)();
