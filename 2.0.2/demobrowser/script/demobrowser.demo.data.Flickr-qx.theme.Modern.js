...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Flickr","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr-qx.theme.Modern.7e2a18044dae.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="changeModel",i="__qL",h="application/json",g="json",f="loaded",e="error",d="fail",c="queued",b="changeState",a="success",x="String",w="changePhase",v="_marshaler",u="qx.data.store.Json",t="changeUrl",s="_applyUrl",r="aborted",q="qx.event.type.Data",p="receiving",o="sending",m="completed",n="failed",k="timeout",l="configured";qx.Class.define(u,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":q,"error":q},properties:{model:{nullable:true,event:j},state:{check:[l,c,o,p,m,r,k,n],init:l,event:b},url:{check:x,apply:s,event:t,nullable:true}},members:{_marshaler:null,_delegate:null,__qL:null,_applyUrl:function(A,B){if(A!=null){A=qx.util.AliasManager.getInstance().resolve(A);A=qx.util.ResourceManager.getInstance().toUri(A);this._createRequest(A);}
;}
,_getRequest:function(){return this.__qL;}
,_setRequest:function(C){this.__qL=C;}
,_createRequest:function(D){if(this.__qL){this.__qL.dispose();this.__qL=null;}
;var E=new qx.io.request.Xhr(D);this._setRequest(E);E.setAccept(h);E.setParser(g);E.addListener(a,this._onSuccess,this);var F=this._delegate;if(F&&qx.lang.Type.isFunction(F.configureRequest)){this._delegate.configureRequest(E);}
...
;}
,_onFail:function(K){var L=K.getTarget();this.fireDataEvent(e,L);}
...
;this.fireDataEvent(f,this.getModel());if(this.__qL){this.__qL.dispose();this.__qL=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__qL!=null){this._disposeObjects(i);}
...
;this.__qu={};var O=this._transport=this._createTransport();this._setPhase(p);this.__uo=qx.lang.Function.bind(this._onReadyStateChange,this);this.__up=qx.lang.Function.bind(this._onLoad,this);this.__uq=qx.lang.Function.bind(this._onLoadEnd,this);this.__ur=qx.lang.Function.bind(this._onAbort,this);this.__sV=qx.lang.Function.bind(this._onTimeout,this);this.__us=qx.lang.Function.bind(this._onError,this);O.onreadystatechange=this.__uo;O.onload=this.__up;O.onloadend=this.__uq;O.onabort=this.__ur;O.ontimeout=this.__sV;O.onerror=this.__us;}
...
,nullable:true},authentication:{check:c,nullable:true}},members:{__uo:null,__up:null,__uq:null,__ur:null,__sV:null,__us:null,__ut:null,__sX:null,__uu:null,__qu:null,__uv:null,_transport:null,_createTransport:function(){throw new Error(A);}
...
;this.__sX=true;this.__uu=x;this._transport.abort();}
,_setRequestHeaders:function(){var X=this._transport,V=this._getAllRequestHeaders();for(var W in V){X.setRequestHeader(W,V[W]);}
;}
,_getAllRequestHeaders:function(){var Y=qx.lang.Object.merge({},this._getConfiguredRequestHeaders(),this.__uw(),this.__uv,this.__qu);return Y;}
,__uw:function(){var bb=this.getAuthentication(),ba={};if(bb){bb.getAuthHeaders().forEach(function(bc){ba[bc.key]=bc.value;}
);return ba;}
;}
,setRequestHeader:function(bd,be){this.__qu[bd]=be;}
,getRequestHeader:function(bf){return this.__qu[bf];}
,removeRequestHeader:function(bg){if(this.__qu[bg]){delete this.__qu[bg];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__uu;}
...
,getResponse:function(){return this.__ut;}
,_setResponse:function(bi){var bj=bi;if(this.__ut!==bi){this.__ut=bi;this.fireEvent(m,qx.event.type.Data,[this.__ut,bj]);}
;}
,_onReadyStateChange:function(){var bk=this.getReadyState();if(qx.core.Environment.get(C)){this.debug(D+bk);}
;this.fireEvent(r);if(this.__sX){return;}
;if(bk===3){this._setPhase(M);}
;if(this.isDone()){this.__ux();}
;}
,__ux:function(){var bl;if(qx.core.Environment.get(C)){this.debug(E+this.getStatus());}
...
,_setPhase:function(bn){var bo=this.__uu;if(qx.core.Environment.get(v)){qx.core.Assert.assertString(bn);qx.core.Assert.assertMatch(bn,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__uu=bn;this.fireDataEvent(h,bn,bo);}
...
,init:true}},members:{__uy:null,_createTransport:function(){return new qx.bom.request.Xhr();}
...
;}
;return C;}
,setParser:function(D){var E=qx.io.request.Xhr;if(typeof E.PARSER[D]===h){return this.__uy=E.PARSER[D];}
;if(qx.core.Environment.get(o)){qx.core.Assert.assertFunction(D);}
;return this.__uy=D;}
,_getParser:function(){var F=this.__uy,G;if(F){return F;}
...
(function(){var k="Retry open native request with method: ",j="activex",i="No XHR support available.",h="If-None-Match",g="xhr",f="engine.version",d="GET",c="-1",b="Open native request with method: ",a="Received native readyState: ",P="abort",O="Microsoft.XMLHTTP",N="Already disposed",M="browser.version",L="on",K="If-Match",J="Microsoft.XMLDOM",I="Send native request",H="If-Range",G="Content-Type",r="io.xhr",s="Not enough arguments",p="timeout",q="If-Modified-Since",n="onunload",o="load",l=", url: ",m="browser.documentmode",t=", async: ",u="loadend",y="opera",x="gecko",A="file:",z="error",C="mshtml",B="undefined",w="qx.debug.io",F="",E="readystatechange",D="qx.bom.request.Xhr",v="engine.name";qx.Bootstrap.define(D,{construct:function(){this.__sT=qx.Bootstrap.bind(this.__tj,this);this.__sU=qx.Bootstrap.bind(this.__ti,this);this.__sV=qx.Bootstrap.bind(this.__tn,this);this.__th();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sW=qx.Bootstrap.bind(this.__tq,this);window.attachEvent(n,this.__sW);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":D,"error":D,"loadend":D,"timeout":D,"abort":D,"load":D},members:{readyState:0,responseText:F,responseXML:null,status:0,statusText:F,timeout:0,open:function(Q,R,S,T,U){this.__ts();if(typeof R===B){throw new Error(s);}
else if(typeof Q===B){Q=d;}
;this.__sX=false;this.__sY=false;this.__ta=false;this.__tb=R;if(typeof S==B){S=true;}
;this.__tc=S;if(!this.__tr()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__th();}
;this.__te.onreadystatechange=this.__sT;try{if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+Q+l+R+t+S);}
;this.__te.open(Q,R,S,T,U);}
catch(V){if(!qx.util.Request.isCrossDomain(R)){throw V;}
;if(!this.__tc){this.__td=V;}
;if(this.__tc){if(window.XDomainRequest){this.readyState=4;this.__te=new XDomainRequest();this.__te.onerror=qx.Bootstrap.bind(function(){this._emit(E);this._emit(z);this._emit(u);}
,this);if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,k+Q+l+R+t+S);}
;this.__te.open(Q,R,S,T,U);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__tg){return;}
;this.readyState=4;this._emit(E);this._emit(z);this._emit(u);}
,this));}
;}
;if(qx.core.Environment.get(v)===C&&qx.core.Environment.get(m)<9&&this.__te.readyState>0){this.__te.setRequestHeader(q,c);}
;if(qx.core.Environment.get(v)===x&&parseInt(qx.core.Environment.get(f),10)<2&&!this.__tc){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(E);}
;}
,setRequestHeader:function(W,X){this.__ts();if(W==K||W==q||W==h||W==H){this.__ta=true;}
;this.__te.setRequestHeader(W,X);return this;}
,send:function(Y){this.__ts();if(!this.__tc&&this.__td){throw this.__td;}
;if(qx.core.Environment.get(v)===y&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__tf=window.setTimeout(this.__sV,this.timeout);}
;Y=typeof Y==B?null:Y;try{if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,I);}
;this.__te.send(Y);}
catch(bb){if(!this.__tc){throw bb;}
;if(this._getProtocol()===A){this.readyState=2;this.__tk();var ba=this;window.setTimeout(function(){if(ba.__tg){return;}
;ba.readyState=3;ba.__tk();ba.readyState=4;ba.__tk();}
);}
;}
;if(qx.core.Environment.get(v)===x&&!this.__tc){this.__tj();}
;this.__sY=true;return this;}
,abort:function(){this.__ts();this.__sX=true;this.__te.abort();if(this.__te){this.readyState=this.__te.readyState;}
;return this;}
...
,getResponseHeader:function(be){this.__ts();return this.__te.getResponseHeader(be);}
,getAllResponseHeaders:function(){this.__ts();return this.__te.getAllResponseHeaders();}
,getRequest:function(){return this.__te;}
,dispose:function(){if(this.__tg){return false;}
;window.clearTimeout(this.__tf);if(window.detachEvent){window.detachEvent(n,this.__sW);}
;try{this.__te.onreadystatechange;}
catch(bg){return;}
;var bf=function(){}
;this.__te.onreadystatechange=bf;this.__te.onload=bf;this.__te.onerror=bf;this.abort();this.__te=null;this.__tg=true;return true;}
...
,_getProtocol:function(){var bi=this.__tb;var bj=/^(\w+:)\/\//;if(bi!==null&&bi.match){var bk=bi.match(bj);if(bk&&bk[1]){return bk[1];}
;}
;return window.location.protocol;}
,__te:null,__tc:null,__sT:null,__sU:null,__sW:null,__sV:null,__sY:null,__tb:null,__sX:null,__dy:null,__tg:null,__tf:null,__td:null,__ta:null,__th:function(){this.__te=this._createNativeXhr();this.__te.onreadystatechange=this.__sT;if(this.__te.onabort){this.__te.onabort=this.__sU;}
;this.__tg=this.__sY=this.__sX=false;}
,__ti:function(){if(!this.__sX){this.abort();}
;}
,__tj:function(){var bl=this.__te,bm=true;if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+bl.readyState);}
;if(this.readyState==bl.readyState){return;}
;this.readyState=bl.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sX&&!this.__sY){return;}
;if(!this.__tc&&(bl.readyState==2||bl.readyState==3)){return;}
...
;if(bm){this.__to();this.__tp();}
;}
;this.__tk();if(this.readyState==qx.bom.request.Xhr.DONE){if(bl){bl.onreadystatechange=function(){}
;}
;}
;}
,__tk:function(){var bo=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__tf);}
;if(qx.core.Environment.get(v)==C&&qx.core.Environment.get(m)<8){if(this.__tc&&!this.__sY&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(bo.__tg){return;}
;bo.readyState=3;bo._emit(E);bo.readyState=4;bo._emit(E);bo.__tl();}
);return;}
;}
;}
;this._emit(E);if(this.readyState===qx.bom.request.Xhr.DONE){this.__tl();}
;}
,__tl:function(){if(this.__dy){this._emit(p);if(qx.core.Environment.get(v)===y){this._emit(z);}
;this.__dy=false;}
else {if(this.__sX){this._emit(P);}
else {if(this.__tm()){this._emit(z);}
else {this._emit(o);this._emitter.emit(o);}
;}
;}
;this._emit(u);}
,__tm:function(){var bp;if(this._getProtocol()===A){bp=!this.responseText;}
else {bp=!this.statusText;}
;return bp;}
,__tn:function(){var bq=this.__te;this.readyState=qx.bom.request.Xhr.DONE;this.__dy=true;bq.abort();this.responseText=F;this.responseXML=null;this.__tk();}
,__to:function(){var br=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===A&&this.status===0&&br){if(!this.__tm()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(v)===y){if(br&&this.__ta&&!this.__sX&&this.status===0){this.status=304;}
;}
;}
,__tp:function(){if(qx.core.Environment.get(v)==C&&(this.getResponseHeader(G)||F).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bs=new window.ActiveXObject(J);bs.async=false;bs.validateOnParse=false;bs.loadXML(this.responseText);this.responseXML=bs;}
;}
,__tq:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__tr:function(){var name=qx.core.Environment.get(v);var bt=qx.core.Environment.get(M);return !(name==C&&bt<9||name==x&&bt<3.5);}
,__ts:function(){if(this.__tg){throw new Error(N);}
;}
...
(function(){var m="qx.bom.request.Jsonp",l="callback",k="open",j="dispose",i="qx.debug",h="_onNativeLoad",g="Expecting JavaScript response to call: ",f="].callback",e=" already exists",d="Callback ",a="qx.bom.request.Jsonp[",c="",b="qx.debug.io";qx.Bootstrap.define(m,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__tK();}
,members:{responseJson:null,__bV:null,__tE:null,__tF:null,__tG:null,__tH:null,__tg:null,__tI:c,open:function(n,o){if(this.__tg){return;}
;var p={},r,q,s=this;this.responseJson=null;this.__tG=false;r=this.__tE||l;q=this.__tF||this.__tI+a+this.__bV+f;if(!this.__tF){this.constructor[this.__bV]=this;}
else {if(!window[this.__tF]){this.__tH=true;window[this.__tF]=function(t){s.callback(t);}
;}
else {if(qx.core.Environment.get(b)){qx.Bootstrap.debug(qx.bom.request.Jsonp,d+this.__tF+e);}
;}
;}
;if(qx.core.Environment.get(b)){qx.Bootstrap.debug(qx.bom.request.Jsonp,g+q);}
;p[r]=q;o=qx.util.Uri.appendParamsToUrl(o,p);this.__fK(k,[n,o]);}
,callback:function(u){if(this.__tg){return;}
;this.__tG=true;if(qx.core.Environment.get(i)){u=qx.lang.Json.stringify(u);u=qx.lang.Json.parse(u);}
;this.responseJson=u;this.constructor[this.__bV]=undefined;this.__tJ();}
,setCallbackParam:function(v){this.__tE=v;return this;}
,setCallbackName:function(name){this.__tF=name;return this;}
,setPrefix:function(w){this.__tI=w;}
,dispose:function(){this.__tJ();this.__fK(j);}
,_onNativeLoad:function(){this.status=this.__tG?200:500;this.__fK(h);}
,__tJ:function(){if(this.__tH&&window[this.__tF]){window[this.__tF]=undefined;this.__tH=false;}
;}
,__fK:function(x,y){qx.bom.request.Script.prototype[x].apply(this,y||[]);}
,__tK:function(){this.__bV=(new Date().valueOf())+(c+Math.random()).substring(2,5);}
}});}
)();
...
(function(){var k="Enter",j="keydown",i="model.photos.photo",h=".jpg",g="execute",f="source",d="selection[0]",c="_s.jpg",b="<span style='font-size: 20px'>Flickr</span>",a="loading",B="value",A="demobrowser.demo.data.store.Flickr",z="demobrowser.demo.data.Flickr",y="title",x="icon",w="state",v="Search",u="jsonFlickrApi",t="horizontal",s="model",q="id",r="qooxdoo",o="/",p=".static.flickr.com/",m="",n="_",l="http://farm";qx.Class.define(z,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var K=new demobrowser.demo.data.store.Flickr(r);var C=new qx.ui.form.TextField(r);this.getRoot().add(C,{left:30,top:50});var D=new qx.ui.form.Button(v);this.getRoot().add(D,{left:140,top:49});D.addListener(g,function(){K.searchForTag(C.getValue());}
,this);C.addListener(j,function(e){if(e.getKeyIdentifier()==k){K.searchForTag(C.getValue());}
;}
,this);var status=new qx.ui.basic.Label(a);this.getRoot().add(status,{left:210,top:52});K.bind(w,status,B);var G=new qx.ui.form.List();G.setWidth(700);G.setHeight(110);G.setOrientation(t);this.getRoot().add(G,{left:30,right:30,top:80});var I=new qx.data.controller.List(null,G);I.setLabelPath(y);I.setDelegate({configureItem:function(L){L.setShow(x);}
});var E={converter:function(M,N){return (l+N.getFarm()+p+N.getServer()+o+M+n+N.getSecret()+c);}
};I.setIconOptions(E);I.setIconPath(q);K.bind(i,I,s);var F=new qx.ui.basic.Image();this.getRoot().add(F,{left:30,top:200});var J={converter:function(O){if(O){return (l+O.getFarm()+p+O.getServer()+o+O.getId()+n+O.getSecret()+h);}
;return m;}
};I.bind(d,F,f,J);var H=new qx.ui.basic.Label();H.setRich(true);H.setWidth(260);H.setValue(b);this.getRoot().add(H,{left:10,top:10});}
}});qx.Class.define(A,{extend:qx.data.store.Jsonp,construct:function(P){this.setCallbackName(u);qx.data.store.Jsonp.call(this,this.__PU(P));}
,members:{searchForTag:function(Q){if(Q!=m){this.setUrl(this.__PU(Q));}
;}
,__PU:function(R){if(!R){return;}
;var S="http://api.flickr.com/services/rest/?tags="+R;S+="&method=flickr.photos.search&api_key=63a8042eead205f7e0040f488c02afd9&format=json";return S;}
}});}
)();
...
;if(this.getSelection()==null){this.__Bt=new qx.data.Array();this.setSelection(this.__Bt);}
;}
,properties:{selection:{check:f,event:a,apply:d,init:null}},members:{_modifingSelection:0,__Bu:null,__Bv:null,__Bt:null,_applySelection:function(h,j){if(this.__Bv!=undefined&&j!=undefined){j.removeListenerById(this.__Bv);}
;this.__Bv=h.addListener(g,this.__Bw,this);this._updateSelection();}
,__Bw:function(){this._updateSelection();}
,_changeTargetSelection:function(){if(this.getTarget()==null){return;}
;if(!this.__Bx()&&!this.__By()){return;}
;if(this._inSelectionModification()){return;}
;var l=this.getTarget().getSelection();var k=this.getSelection();if(k==null){k=new qx.data.Array();this.__Bt=k;this.setSelection(k);}
...
,_addChangeTargetListener:function(n,o){if(this.__Bu!=undefined&&o!=undefined){o.removeListenerById(this.__Bu);}
;if(n!=null){if(this.__Bx()||this.__By()){this.__Bu=n.addListener(a,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()){return;}
;this._startSelectionModification();if(this.__Bx()){var r=[];for(var i=0;i<this.getSelection().length;i++){var s=this.getSelection().getItem(i);var t=this.__Bz(s);if(t!=null){r.push(t);}
;}
...
;}
;}
else if(this.__By()){var q=this.getSelection().getItem(this.getSelection().length-1);if(q!==undefined){this.__rE(q);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__Bx:function(){var u=this.getTarget().constructor;return qx.Class.implementsInterface(u,qx.ui.core.IMultiSelection);}
,__By:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.ISingleSelection);}
,__rE:function(w){var x=this.__Bz(w);if(x==null){return;}
;if(this.__Bx()){this.getTarget().addToSelection(x);}
else if(this.__By()){this.getTarget().setSelection([x]);}
;}
,__Bz:function(y){var z=this.getTarget().getSelectables(true);for(var i=0;i<z.length;i++){if(z[i].getModel()==y){return z[i];}
;}
;return null;}
...
},destruct:function(){if(this.__Bt){this.__Bt.dispose();}
;}
});}
)();
...
(function(){var m="changeModel",k="_applyLabelOptions",h="_applyLabelPath",g="changeTarget",f="_applyModel",e="icon",d="qx.data.controller.List",c="_applyIconPath",b="_applyDelegate",a="changeDelegate",z="_applyTarget",y="qx.data.IListData",x="model",w="label",v="_applyIconOptions",u="change",t="ReverseBindingId",s="BindingId",r="]",q="model[",o="String",p=".",n="";qx.Class.define(d,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__zA=[];this.__Bf=[];this.__Bg=[];this.__Bh={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:y,apply:f,event:m,nullable:true,dereference:true},target:{apply:z,event:g,nullable:true,init:null,dereference:true},labelPath:{check:o,apply:h,nullable:true},iconPath:{check:o,apply:c,nullable:true},labelOptions:{apply:k,nullable:true},iconOptions:{apply:v,nullable:true},delegate:{apply:b,event:a,init:null,nullable:true}},members:{__Bi:null,__zA:null,__Bh:null,__Bf:null,__Bg:null,__Bj:null,__Bk:null,update:function(){this.__Bm();this.__Bq();this._updateSelection();}
,_applyDelegate:function(D,E){this._setConfigureItem(D,E);this._setFilter(D,E);this._setCreateItem(D,E);this._setBindItem(D,E);}
,_applyIconOptions:function(F,G){this.__Bq();}
,_applyLabelOptions:function(H,I){this.__Bq();}
,_applyIconPath:function(J,K){this.__Bq();}
,_applyLabelPath:function(L,M){this.__Bq();}
,_applyModel:function(N,O){if(O!=undefined){if(this.__Bi!=undefined){O.removeListenerById(this.__Bi);}
;}
;if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length).dispose();}
;if(N!=null){this.__Bi=N.addListener(u,this.__Bl,this);this.__zH();this.__Bm();if(O==null){this._changeTargetSelection();}
else {this.__Bj=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var P=this.getTarget();if(P!=null){var length=P.getChildren().length;for(var i=0;i<length;i++){this.__Bp();}
;}
;}
;}
...
;if(Q!=null){if(this.getModel()!=null){for(var i=0;i<this.__zA.length;i++){this.__Bo(this.__Bs(i));}
;}
;}
;}
,__Bl:function(){this.__Bk=true;qx.ui.core.queue.Widget.add(this);if(this.__zA.length!=this.getModel().getLength()){this.update();}
;}
,syncWidget:function(){if(this.__Bj){this._changeTargetSelection();}
;if(this.__Bk){this._updateSelection();}
;this.__Bk=this.__Bj=null;}
,__Bm:function(){if(this.getTarget()==null){return;}
;this.__zH();var U=this.__zA.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++){this.__Bo(this.__Bs(j));}
;}
else if(U<T){for(var j=T;j>U;j--){this.__Bp();}
;}
;this.__Bj=true;qx.ui.core.queue.Widget.add(this);}
,__Bn:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__Bi);this.__Bi=V.addListener(u,this.__Bl,this);}
;}
...
;return W;}
,__Bo:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__Bp:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bm,bn,bo,bp,bq){if(bo!=null){var bo=qx.lang.Object.clone(bo);this.__Bh[bn]=bo.onUpdate;delete bo.onUpdate;}
else {bo={};this.__Bh[bn]=null;}
;bo.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bq);var br=q+bq+r;if(bm!=null&&bm!=n){br+=p+bm;}
;var bs=this.bind(br,bp,bn,bo);bp.setUserData(bn+s,bs);if(!qx.lang.Array.contains(this.__Bf,bn)){this.__Bf.push(bn);}
;}
,bindPropertyReverse:function(bt,bu,bv,bw,bx){var by=q+bx+r;if(bt!=null&&bt!=n){by+=p+bt;}
;var bz=bw.bind(bu,this,by,bv);bw.setUserData(bt+t,bz);if(!qx.lang.Array.contains(this.__Bg,bt)){this.__Bg.push(bt);}
;}
,_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;}
;for(var i=0;i<this.__Bf.length;i++){if(this.__Bh[this.__Bf[i]]!=null){this.__Bh[this.__Bf[i]]();}
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__Bf.length;i++){var bE=bD.getUserData(this.__Bf[i]+s);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__Bg.length;i++){var bE=bD.getUserData(this.__Bg[i]+t);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__Bq:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__Bs(i));}
;this.__Bn();}
...
,_setFilter:function(bP,bQ){if((bP==null||bP.filter==null)&&(bQ!=null&&bQ.filter!=null)){this.__Br();}
...
;var bS=this.__zA;this.__zH();if(bS.length>this.__zA.length){for(var j=bS.length;j>this.__zA.length;j--){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bS.length<this.__zA.length){for(var j=bS.length;j<this.__zA.length;j++){var bT=this._createItem();this.getTarget().add(bT);}
;}
;var bR=this.getTarget().getChildren();for(var i=0;i<bR.length;i++){this._bindListItem(bR[i],this.__Bs(i));}
;this.__Bn();this._endSelectionModification();this._updateSelection();}
,__Br:function(){this.__zH();this.__Bm();this.__Bq();this.__Bk=true;qx.ui.core.queue.Widget.add(this);}
,__zH:function(){var bW=this.getModel();if(bW==null){return;}
;var bX=this.getDelegate();if(bX!=null){var bV=bX.filter;}
;this.__zA=[];for(var i=0;i<bW.getLength();i++){if(bV==null||bV(bW.getItem(i))){this.__zA.push(i);}
;}
;}
,__Bs:function(bY){return this.__zA[bY];}
},destruct:function(){this.__zA=this.__Bh=this.__Bf=null;this.__Bg=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
