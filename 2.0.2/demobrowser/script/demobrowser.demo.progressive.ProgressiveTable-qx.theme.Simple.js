...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable-qx.theme.Simple.17fbadadf7ce.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Last item is intentionally ",l="demobrowser.demo.progressive.ProgressiveTable",k="start",j="</span>",i="Number",h="1*",g="<span style='color:red;'>",f="inserted at the top to show how ",e="it's done",d="end",a="Date",c="Id",b="row";qx.Class.define(l,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var v=0;var r=function(z){var C=[];var B=new Date().getTime();var D=400*24*60*60*1000;for(var E=0;E<z;E++){var A=new Date(B+Math.random()*D-D/2);C.push({renderer:b,location:E==z-1?k:d,data:[v++,Math.random()*10000,A]});}
;return C;}
;var u=new qx.ui.progressive.renderer.table.Widths(3);u.setWidth(0,100);u.setWidth(1,h);u.setMaxWidth(1,200);u.setWidth(2,300);var p=[c,i,a];var q=new qx.ui.progressive.headfoot.TableHeading(u,p);var o=new qx.ui.progressive.headfoot.Progress(u,p);var x=new qx.ui.progressive.structure.Default(q,o);var n=new qx.ui.progressive.Progressive(x);var w=new qx.ui.basic.Atom(g+m+f+e+j);w.setRich(true);w.setHeight(16);n.add(w);var t=new qx.ui.progressive.model.Default();var s=r(500);t.addElements(s);n.setDataModel(t);var y=new qx.ui.progressive.renderer.table.Row(u);n.addRenderer(b,y);n.set({width:500,maxWidth:500});this.getRoot().add(n,{left:50,top:50,bottom:50});n.render();}
}});}
)();
