...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window-qx.theme.Modern.d20bb22344a2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Open Native Window",p="Open Native Modal Window",o="demobrowser.demo.bom.Window",n="Modal Window closed?",m="http://sourceforge.net",l="window1",k="window3",j="http://slashdot.org",i="Window closed?",h="http://qooxdoo.org",c="demobrowser/demo/html/ModalWindow.html",g="Open Faked Native Modal Window",f="window2",b="#eee",a="click",d="button";qx.Class.define(o,{extend:qx.application.Native,members:{__BK:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__BK=[h,m,j,r.toUri(c)];var u=qx.bom.Input.create(d);qx.bom.Input.setValue(u,q);document.body.appendChild(u);qx.event.Registration.addListener(u,a,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__BK[0],l,x);}
...
,this);var s=qx.bom.Input.create(d);qx.bom.Input.setValue(s,p);document.body.appendChild(s);qx.event.Registration.addListener(s,a,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__BK[3],f,y,true);}
...
,this);var v=qx.bom.Input.create(d);qx.bom.Input.setValue(v,g);document.body.appendChild(v);qx.event.Registration.addListener(v,a,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(b);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__BK[0],k,A,true,false);}
,this);}
...
(function(){var t="Cross-Domain Scripting problem: Could not move window!",s="no",r="' is not supported for modal windows.",q="yes",p="",o="' is not supported for native windows.",n="qx.bom.Window",m="interval",l="Cross-Domain Scripting problem: Could not resize window!",k="resizable",d="scrollbars",j="px",g="javascript:/",c=":",b=";",f="qxNativeWindow",e=",",h='load',a="=",i="Option '";qx.Class.define(n,{statics:{__jI:null,__MX:null,__iG:null,__MY:{"top":"dialogTop",left:"dialogLeft",width:"dialogWidth",height:"dialogHeight",scrollbars:"scroll",resizable:"resizable"},__Na:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Nb:function(){return window.showModalDialog!=null;}
,open:function(u,name,v,w,x,y,self){var C=null;if(u==null){u=g;}
;if(name==null){name=f+new Date().getTime();}
;if(x==null){x=true;}
;var z=this.__Nc(v,w&&x);if(w){if(this.__Nb()&&x){C=window.showModalDialog(u,[window.self],z);}
else {this.getBlocker().block();if(this.__iG==null){this.__iG=new qx.event.Timer(500);this.__iG.addListener(m,this.__Nd,this);}
;this.__MX=window.open(u,name,z);this.__iG.restart();C=this.__MX;}
;}
...
;return C;}
,__Nc:function(D,E){var F;var I;var G=[];if(E&&this.__Nb()){for(var H in D){if(qx.bom.Window.__MY[H]){var J=p;if(H!=d&&H!=k){J=j;}
;I=qx.bom.Window.__MY[H]+c+D[H]+J;G.push(I);}
else {qx.log.Logger.warn(i+H+r);}
;}
;F=G.join(b);}
else {for(var H in D){if(qx.bom.Window.__Na[H]){if(qx.lang.Type.isBoolean(D[H])){I=H+a+(D[H]?q:s);}
else {I=H+a+D[H];}
;G.push(I);}
...
;F=G.join(e);}
;return F;}
,__Nd:function(){if(this.isClosed(this.__MX)){this.getBlocker().unblock();this.__iG.stop();}
;}
