...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_AutoSize","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_AutoSize-qx.theme.Classic.ed427889fc38.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="x",n="y",m="demobrowser.demo.layout.Dock_AutoSize",l="east",k="yellow",j="center",i="red",h="north",g="south",f="west",c="green",e="blue",d="fuchsia",b="orange",a="main";qx.Class.define(m,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(q);var p=new qx.ui.container.Composite(new qx.ui.layout.Dock(3,10)).set({decorator:a,backgroundColor:k,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:i});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});p.add(w,{edge:h});p.add(v,{edge:f});p.add(u,{edge:g});p.add(t,{edge:l});p.add(s,{edge:j});q.add(p);var r=new qx.ui.layout.Dock(3,10);r.setSort(n);var p=(new qx.ui.container.Composite(r)).set({decorator:a,backgroundColor:k,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:i});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});p.add(w,{edge:h});p.add(v,{edge:f});p.add(u,{edge:g});p.add(t,{edge:l});p.add(s,{edge:j});q.add(p);var r=new qx.ui.layout.Dock(3,10);r.setSort(o);var p=(new qx.ui.container.Composite(r)).set({decorator:a,backgroundColor:k,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:i});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});p.add(w,{edge:h});p.add(v,{edge:f});p.add(u,{edge:g});p.add(t,{edge:l});p.add(s,{edge:j});q.add(p);}
}});}
)();
