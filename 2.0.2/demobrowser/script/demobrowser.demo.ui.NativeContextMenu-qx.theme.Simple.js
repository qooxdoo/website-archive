...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.NativeContextMenu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.NativeContextMenu-qx.theme.Simple.8e4c762edc43.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="Native context menu allowed",f="No native context menu",e="demobrowser.demo.ui.NativeContextMenu",d="<b>rich</b> label",c="plain label",b="bold",a="text field";qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var i=new qx.ui.container.Composite().set({padding:20});this.getRoot().add(i);var h=new qx.ui.layout.Grid(10,10);i.setLayout(h);i.add(new qx.ui.basic.Label(g).set({font:b}),{row:0,column:0});i.add(new qx.ui.basic.Label(c).set({nativeContextMenu:true,selectable:true}),{row:1,column:0});i.add(new qx.ui.basic.Label(d).set({nativeContextMenu:true,selectable:true,rich:true}),{row:2,column:0});i.add(new qx.ui.form.TextField(a).set({nativeContextMenu:true}),{row:3,column:0});i.add(new qx.ui.basic.Label(f).set({font:b}),{row:0,column:1});i.add(new qx.ui.basic.Label(c).set({selectable:true}),{row:1,column:1});i.add(new qx.ui.basic.Label(d).set({rich:true,selectable:true}),{row:2,column:1});i.add(new qx.ui.form.TextField(a),{row:3,column:1});}
}});}
)();
