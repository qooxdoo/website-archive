...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional-qx.theme.Classic.1be9af4aea8a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="regex cannot be null!",u="font-weight",t="Condition not recognized or value1/value2 is null!",s="Condition not recognized or value is null!",r="text-align",q='g',p="qx.ui.progressive.renderer.table.cell.Conditional",o=":",n=";",m="color",e="font-style",l="==",h=">",c="between",b="regex",g="<",f="!between",j=">=",a="!=",k="<=",d="";qx.Class.define(p,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(w,x,y,z){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__Kn=[l,a,h,g,j,k];this.__Ko=[c,f];this.__Kp=[];this.__yY=w||d;this.__za=x||d;this.__zb=y||d;this.__zc=z||d;}
,members:{__Kn:null,__Ko:null,__Kp:null,__yY:null,__za:null,__zb:null,__zc:null,__zd:function(A,B){if(A.align){B[r]=A.align;}
;if(A.color){B[m]=A.color;}
;if(A.style){B[e]=A.style;}
;if(A.weight){B[u]=A.weight;}
;}
,addNumericCondition:function(C,D,E,F,G,H,I){if(!qx.lang.Array.contains(this.__Kn,C)||D==null){throw new Error(s);}
;this.__Kp.push({condition:C,align:E,color:F,style:G,weight:H,value1:D,target:I});}
,addBetweenCondition:function(J,K,L,M,N,O,P,Q){if(!qx.lang.Array.contains(this.__Ko,J)||K==null||L==null){throw new Error(t);}
;this.__Kp.push({condition:J,align:M,color:N,style:O,weight:P,value1:K,value2:L,target:Q});}
,addRegex:function(R,S,T,U,V,W){if(!R){throw new Error(v);}
;this.__Kp.push({condition:b,align:S,color:T,style:U,weight:V,regex:R,target:W});}
,_getCellStyle:function(X){if(this.__Kp.length==0){return X.style||d;}
;var i;var bc;var Y;var bb={"text-align":this.__yY,"color":this.__za,"font-style":this.__zb,"font-weight":this.__zc};for(i=0;i<this.__Kp.length;i++){var bf=this.__Kp[i];bc=false;if(qx.lang.Array.contains(this.__Kn,bf.condition)){if(bf.target==null){Y=X.cellData;}
...
;break;};}
else if(qx.lang.Array.contains(this.__Ko,bf.condition)){if(bf.target==null){Y=X.cellData;}
else {Y=X.element.data[bf.target];}
...
;;if(bc){this.__zd(bf,bb);}
;var bd=[];for(var be in bb){if(bb[be]){bd.push(be,o,bb[be],n);}
;}
;}
;return bd.join(d);}
},destruct:function(){this.__Kn=this.__Ko=this.__Kp=null;}
});}
)();
