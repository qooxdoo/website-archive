...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ComboBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox-qx.theme.Classic.2211d77097f6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_handleKeyboard:function(event){if(this.isVisible()&&event.getKeyIdentifier()===k){this.__Am();return;}
;var v=event.clone();v.setTarget(this.getChildControl(b));v.setBubbles(false);this.getChildControl(b).dispatchEvent(v);}
,_handleMouse:function(event){this.__Am();}
,__mR:function(event){if(this.__Aj){return;}
;var w=this.getSelection();var x=this.getChildControl(b).getSelection();this.__Ak=true;this.__An(w,x);this.__Ak=false;this.__Aj=true;this.__An(x,w);this.__Aj=false;}
,_onListChangeSelection:function(event){if(this.__Ak){return;}
;var y=this.getChildControl(b).getSelection();if(this.isVisible()){this.setPreselected(y.getItem(0));}
else {this.__Aj=true;this.__An(y,this.getSelection());this.__Aj=false;}
;}
,__Al:function(event){if(this.isVisible()){if(this._preselected==null){var z=this.getSelection();var A=this.getChildControl(b).getSelection();this.__An(z,A);}
;this.__Ao();}
...
,_applySelection:function(B,C){B.addListener(a,this.__mR,this);if(C!=null){C.removeListener(a,this.__mR,this);}
;this.__An(B,this.getChildControl(b).getSelection(B));}
,__Am:function(){if(this._preselected!=null){var D=this.getSelection();D.splice(0,1,this._preselected);this._preselected=null;this.close();}
;}
,__An:function(E,F){if(E.equals(F)){return;}
...
;}
,__Ao:function(){this.__Ap();this.__Aq();}
,__Ap:function(){var J=this._target.getBounds().width;this.setWidth(J);}
,__Aq:function(){var K=this.__Ar();var N=this._target.getMaxListHeight();var L=this.getChildControl(b);var M=L.getPane().getRowConfig().getTotalSize();if(N==null||M<N){N=M;}
;if(N>K){L.setMaxHeight(K);}
else if(N<K){L.setMaxHeight(N);}
;}
,__Ar:function(){var O=this.getLayoutLocation(this._target);var Q=qx.bom.Viewport.getHeight();var R=O.top;var P=Q-O.bottom;return R>P?R:P;}
},destruct:function(){if(this.__Ai){this.__Ai.dispose();}
;}
});}
)();
...
(function(){var w="Function",v="list",u="virtual-combobox",t="click",s="_applyPlaceholder",r="single",q="converter",p="changeValue",o="qx.ui.form.VirtualComboBox",n="String",d="Enter",m="inner",h="focusout",c="change",b="dropdown",g="select",f="focusin",j="button",a="value",k="textfield";qx.Class.define(o,{extend:qx.ui.form.core.AbstractVirtualBox,implement:[qx.ui.form.IStringForm],construct:function(x){qx.ui.form.core.AbstractVirtualBox.call(this,x);var y=this._createChildControl(k);this._createChildControl(j);var z=this.getChildControl(b);z.getChildControl(v).setSelectionMode(r);this.__dD=z.getSelection();this.__dD.addListener(c,this.__AA,this);this.bind(a,y,a);y.bind(a,this,a);this.addListener(f,function(e){y.fireNonBubblingEvent(f,qx.event.type.Focus);}
,this);this.addListener(h,function(e){y.fireNonBubblingEvent(h,qx.event.type.Focus);}
,this);}
,properties:{appearance:{refine:true,init:u},width:{refine:true,init:120},value:{nullable:true,event:p},placeholder:{check:n,nullable:true,apply:s},defaultFormat:{check:w,init:null,nullable:true}},members:{__Ax:null,__Ay:null,__dD:null,__Az:null,getTextSelection:function(){return this.getChildControl(k).getTextSelection();}
...
,_beforeOpen:function(){this.__AB();}
...
;}
,__AA:function(event){if(this.__Az==true){return;}
;var M=this.__dD.getItem(0);M=this.__br(M);this.setValue(M);}
,_applyPlaceholder:function(N,O){this.getChildControl(k).setPlaceholder(N);}
,__AB:function(){var R=this.getValue();var Q=this.getChildControl("dropdown");var P=Q.getSelection();if(this.__br(P.getItem(0))!==R){this.__Az=true;P.removeAll();this.__Az=false;if(R==null||R==""){return;}
...
;return ba;}
},destruct:function(){var bd=this.getChildControl(k);this.removeAllBindings();bd.removeAllBindings();this.__dD.removeListener(c,this.__AA,this);this.__dD=null;}
});}
)();
