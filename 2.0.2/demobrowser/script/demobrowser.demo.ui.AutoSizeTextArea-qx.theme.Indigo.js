...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea-qx.theme.Indigo.f5b69601a59a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var p=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));this.getRoot().add(p,{top:20,left:20});var s=new qx.ui.basic.Label();s.setValue(a);var q=new qx.ui.form.TextArea();q.set({allowStretchY:false,value:this.__Rj()});p.add(s,{row:0,column:0});p.add(q,{row:1,column:0});s=new qx.ui.basic.Label();s.setValue(c);var w=new qx.ui.form.TextArea();w.set({allowStretchY:false,value:this.__Rj(),autoSize:true});p.add(s,{row:0,column:1});p.add(w,{row:1,column:1});s=new qx.ui.basic.Label();s.setValue(g);var x=new qx.ui.form.TextArea();x.set({allowStretchY:false,value:e,autoSize:true,minimalLineHeight:1,maxHeight:300});p.add(s,{row:0,column:2});p.add(x,{row:1,column:2});s=new qx.ui.basic.Label();s.setValue(k);var t=new qx.ui.form.TextArea();t.set({allowStretchY:false,value:this.__Rj(),autoSize:true,minHeight:200});p.add(s,{row:2,column:0});p.add(t,{row:3,column:0});s=new qx.ui.basic.Label();s.setValue(n);var r=new qx.ui.form.TextArea();r.set({allowStretchY:false,value:this.__Rj(),autoSize:true,minHeight:200,maxHeight:300});p.add(s,{row:2,column:1});p.add(r,{row:3,column:1});s=new qx.ui.basic.Label();s.setValue(l);var u=new qx.ui.form.TextArea();u.set({allowStretchY:false,value:this.__Rj(),autoSize:true,minimalLineHeight:2});var o=new qx.ui.form.CheckBox(b);o.setValue(false);o.setAllowStretchX(false);o.bind(h,u,m);p.add(s,{row:2,column:2});var v=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));p.add(v,{row:3,column:2});v.add(u,{row:0,column:0});v.add(o,{row:1,column:0});}
,__Rj:function(){var y=new qx.type.Array(2);for(var i=0;i<y.length;i++){y[i]=d;}
;return y.join(j);}
}});}
)();
...
,append:function(k){var l=this.__Jz(k);Array.prototype.push.apply(this,l);return this;}
,prepend:function(m){var n=this.__Jz(m);Array.prototype.splice.apply(this,[0,0].concat(n));return this;}
,__Jz:function(o){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(o,a);}
