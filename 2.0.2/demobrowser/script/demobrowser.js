...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.aeb67a5f079a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.log.Logger.debug(this,h+(new Date-qx.Bootstrap.LOADSTART)+a);var q=l;var r=qx.Class.getByName(q);if(r){this.__gY=new r;var p=new Date;this.__gY.main();qx.log.Logger.debug(this,m+(new Date-p)+a);var p=new Date;this.__gY.finalize();qx.log.Logger.debug(this,f+(new Date-p)+a);}
...
(function(){var bO="-",bN="_leftComposite",bM="^.*",bL="filled",bK="changeValue",bJ="?qxenv:demobrowser.withTests:true",bI="demobrowser.DemoBrowser",bH="_infosplit",bG="_history",bF="_status",bu="__OA",bt="instead.",bs="_searchTextField",br="f1",bq="__Os",bp='changeSelection',bo="Couldn't load file: ",bn="logappender",bm=".html",bl="__Oz",bV="f2",bW="visible",bT="ig",bU="success",bR='excluded',bS="noPlayground",bP="__kD",bQ="__OC",bX="_urlWindow",bY='_cmdDisposeSample',by="toolbar",bx="tree1",bA="demo/welcome.html",bz='_cmdSampleInOwnWindow',bC=".*",bB=" ",bE='demo/',bD="__Ot",bw="default",bv="__OB",a="index.html",b="when using the file protocol. Please try the http protocol ",c="Filter...",d="qx.theme.Indigo",f="/playground/",g='label',h="changeState",n="/apiviewer/",o="icon/16/actions/edit-find.png",p="_",cd="__kF",cc="__OE",cb="http://manual.qooxdoo.org/",ca="right",ch="main",cg='_cmdObjectSummary',cf="Info",ce="_prevButton",cj="file:",ci='_cmdNextSample',S="The security settings of your browser may prohibit AJAX ",T="_tree",Q="left",R=".",W='_cmdPrevSample',X='_cmdRunSample',U="__OD",V="excluded",O="__Oo",P="bottom-left",B="Failed to load demo data from the file system.\n\n",A="right-top",D="runbutton",C="_runbutton",x="_demoView",w="_navPart",z="?qx.theme=",y="textfield",v="mainsplit",q="app-header",bd="Demo Browser",be="__OG",bf="_nextButton",bg="app-splitpane",Y="__Oy",ba="fail",bb="_iframe",bc="node",bh="horizontal",bi='execute',L='value',K="~",J="widget",I="http://demo.qooxdoo.org/",H="interval",G="modelLink",F="tags",E="2.0.2",N="",M="value",bj="/",bk="enabled";qx.Class.define(bI,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__kD={};var cn=new qx.ui.layout.VBox;this.setLayout(cn);this.add(this._createHeader());this.widgets={};this.tests={};this.__On=d;this.__OH();this.__Oo=this.__OO();this.add(this.__Oo);var cr=new qx.ui.splitpane.Pane(bh);cr.setAppearance(bg);this.mainsplit=cr;var co=new qx.ui.splitpane.Pane(bh);co.setDecorator(null);this._infosplit=co;this.add(cr,{flex:1});var ct=this._leftComposite=new qx.ui.container.Composite();ct.setLayout(new qx.ui.layout.VBox(3));cr.add(ct,0);{}
;var cm=new qx.ui.container.Composite();cm.setLayout(new qx.ui.layout.HBox(3));cm.setAppearance(y);ct.add(cm);var cu=new qx.ui.basic.Image(o);cm.add(cu);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(J);this._searchTextField.setPlaceholder(c);var cs=new qx.event.Timer(500);cs.addListener(H,function(cv){this.filter(this._searchTextField.getValue());cs.stop();}
,this);this._searchTextField.addListener(bK,function(cx){cs.restart();}
,this);cm.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(N);this._status.setAppearance(J);this._status.setWidth(80);this._status.setTextAlign(ca);cm.add(this._status);cr.add(co,1);this._tree=this.__OS();ct.add(this._tree,{flex:1});this.__OT();this._demoView=this.__OP();co.add(this._demoView,2);var ck=this.__Op=this.__OQ();var cl=this.__Oq=this.__OR();var cp=this.__Or=new qxc.ui.logpane.LogView();cp.setDecorator(null);var cq=this.__cG=new qx.ui.container.Stack();cq.setDecorator(ch);cq.add(ck);cq.add(cl);cq.add(cp);co.add(cq,1);cq.resetSelection();cq.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(h,function(e){var cy=e.getData().replace(K,bj);if(this._currentSample!=cy){this.setCurrentSample(cy);}
;}
,this);this.__Os=[this.__Oy,this.__Oz,this.__OC];this.__Os.push(this.__Ow);this.__Os.push(this.__OA);this.__Os.push(this.__OE);this.__Ot=new qx.event.Timer(250);this.__Ot.addListener(H,this.__OV,this);this.__Ot.start();this.__Ou=new demobrowser.InfoWindow(this.tr(cf));this.__Ou.setAutoCenter(true);}
,members:{_iframe:null,__On:null,__Ot:null,__Ov:null,_tree:null,_status:null,_searchTextField:null,__Ow:null,__Ox:null,__Os:null,_versionFilter:null,_navPart:null,__Oy:null,__Oz:null,__OA:null,__OB:null,__OC:null,__OD:null,__OE:null,__Oo:null,_leftComposite:null,_infosplit:null,_demoView:null,__kF:null,__kD:null,__OF:null,_urlWindow:null,__Ou:null,__cG:null,__Op:null,__Oq:null,__Or:null,__OG:null,defaultUrl:bA,playgroundUrl:I+E+f,__OH:function(){this._cmdObjectSummary=new qx.ui.core.Command("Ctrl+O");this._cmdObjectSummary.addListener("execute",this.__OJ,this);this._cmdRunSample=new qx.ui.core.Command("F5");this._cmdRunSample.addListener("execute",this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command("Ctrl+Left");this._cmdPrevSample.addListener("execute",this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command("Ctrl+Right");this._cmdNextSample.addListener("execute",this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command("Ctrl+N");this._cmdSampleInOwnWindow.addListener("execute",this.__OK,this);this._cmdDisposeSample=new qx.ui.core.Command("Ctrl+D");this._cmdDisposeSample.addListener("execute",this.__ON,this);}
,__OI:function(e){var cB=e.getTarget()===this.__OG?this.__OF:this.__OG;var cA=e.getData()[0];if(cB&&cA){cB.setModelSelection([cA.getModel()]);}
;var cz=cA!=null?cA.getUserData("value"):"";switch(cz){case "html":this.__cG.setSelection([this.__Op]);this.__cG.show();break;case "js":this.__cG.setSelection([this.__Oq]);this.__cG.show();break;case "log":this.__cG.setSelection([this.__Or]);this.__cG.show();break;default:this.__cG.resetSelection();this.__cG.exclude();};}
,__OJ:function(){var cD=this._iframe.getWindow();var cC;if(cD&&cD.qx){cC=cD.qx.dev.ObjectSummary.getInfo();}
else {cC="Unable to access namespace. Maybe no demo loaded.";}
;var cE=new qx.ui.form.TextArea(cC);cE.setDecorator(null);cE.setAutoSize(true);cE.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__Ou.setContent(cE);this.__Ou.setWidth(400);this.__Ou.show();}
,__OK:function(){var cF=this._iframe.getSource();window.open(cF,"_blank");}
,__OL:function(cG){var cH=!!cG;var cI=this._tree.getSelection()[0].getUserData("tags");if(cI){cH=cH&&!qx.lang.Array.contains(cI,"noPlayground");}
;this.__Ow.setEnabled(cH);this.__Ox=cG;}
,__OM:function(){if(this.__Ox){var cL=this.__Ox;var cK='{"code": '+'"'+encodeURIComponent(cL)+'"}';var cJ=this.playgroundUrl+"#"+encodeURIComponent(cK);window.open(cJ,"_blank");}
else {var cM=new qx.ui.basic.Label(this.tr("Could not open the Playground."));this.__Ou.setContent(cM);this.__Ou.setWidth(200);this.__Ou.show();}
;}
,__Hg:function(){window.open(I+E+n);}
,__Hh:function(){var cN=(E.split(bO)[0]);window.open(cb+cN);}
,_onHideShowTests:function(event){var cP=window.location.search;var cQ=window.location.hash;var cO=a;if(cP==N){cO+=bJ;}
;cO+=cQ;location.replace(cO);}
,__ON:function(e){var cS=this._iframe.getWindow();var cR;if(cS&&cS.qx){cS.qx.core.ObjectRegistry.shutdown();cR=this.tr("Demo has been disposed.");}
else {cR=this.tr("Unable to access application.");}
;var cT=new qx.ui.basic.Label(cR);cT.setRich(true);cT.setWrap(true);this.__Ou.setContent(cT);this.__Ou.setWidth(350);this.__Ou.show();}
,__OO:function(){var ds=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr("Run"),"icon/22/actions/media-playback-start.png");this._runbutton.addListener("execute",this.runSample,this);this._runbutton.setToolTipText("Run the selected demo");ds.add(this._runbutton);var dv=new qx.ui.toolbar.Part();ds.add(dv);var dd=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");dd.addListener("execute",this.playPrev,this);dd.setToolTipText("Run previous demo");dv.add(dd);this._prevButton=dd;var dq=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");dq.addListener("execute",this.playNext,this);dq.setToolTipText("Run next demo");dv.add(dq);this._nextButton=dq;var dg={converter:function(dA){return dA=="visible";}
};qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dd,"enabled",dg);qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dq,"enabled",dg);var dy=this._navPart=new qx.ui.toolbar.Part();ds.add(dy);var dz=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");dz.addListener("execute",this.__OK,this);dz.setToolTipText("Open demo in new window");this.__Oy=dz;dy.add(dz);var dm=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");dm.addListener("execute",this.__OM,this);dm.setToolTipText("Open demo in the playground");dm.setEnabled(false);if(qx.core.Environment.get("browser.name")=="ie"){dm.exclude();}
;this.__Ow=dm;dy.add(dm);var cX=new qx.ui.toolbar.Part();ds.add(cX);var dk=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");cX.add(dk);dk.setToolTipText(this.tr("Open the qooxdoo API Viewer"));dk.addListener("execute",this.__Hg,this);var cV=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");cX.add(cV);cV.setToolTipText(this.tr("Open the qooxdoo Manual"));cV.addListener("execute",this.__Hh,this);var dt=new qx.ui.toolbar.Part;ds.add(dt);var dp=new qx.ui.menu.Menu;this.__OB=dp;var de=new qx.ui.menu.RadioButton("Modern Theme");var dw=new qx.ui.menu.RadioButton("Classic Theme");var dx=new qx.ui.menu.RadioButton("Simple Theme");var du=new qx.ui.menu.RadioButton("Indigo Theme");de.setUserData("value","qx.theme.Modern");dw.setUserData("value","qx.theme.Classic");dx.setUserData("value","qx.theme.Simple");du.setUserData("value","qx.theme.Indigo");du.setValue(true);var dh=new qx.ui.form.RadioGroup(de,dw,dx,du);dh.addListener("changeSelection",this.__Pa,this);dp.add(du);dp.add(de);dp.add(dw);dp.add(dx);var df=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dp);this.__OA=dt;df.setToolTipText("Choose theme");dt.add(df);var di=new qx.ui.menu.Menu;var dj=new qx.ui.menu.Button(this.tr("Object Summary"));this.__OE=dj;dj.setCommand(this._cmdObjectSummary);di.add(dj);var db=new qx.ui.menu.Button(this.tr("Dispose Demo"));this.__OC=db;db.setCommand(this._cmdDisposeSample);di.add(db);di.addSeparator();var cY=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));cY.setValue(!!qx.core.Environment.get("demobrowser.withTests"));cY.addListener("changeValue",this._onHideShowTests,this);di.add(cY);var dc=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",di);this.__OD=dc;dc.setToolTipText("Debugging options");dt.add(dc);var dl=new qx.ui.toolbar.Part;this.__Oz=dl;ds.addSpacer();ds.add(dl);var dr=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");dr.setToolTipText("Display HTML source");dr.setModel('html');var da=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");da.setToolTipText("Display JavaScript source");da.setModel('js');dr.setUserData("value","html");da.setUserData("value","js");dl.add(dr);dl.add(da);var dn=new qx.ui.toolbar.RadioButton("Log File","icon/22/apps/utilities-log-viewer.png");dn.setToolTipText("Display log file");dn.setUserData("value","log");dn.setModel('log');dl.add(dn);var cU=this.__OG=new qx.ui.form.RadioGroup;cU.setAllowEmptySelection(true);cU.add(dn);cU.addListener('changeSelection',this.__OI,this);cU.add(dr,da);ds.setOverflowHandling(true);var cW=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");cW.setAppearance("toolbar-button");ds.add(cW);ds.setOverflowIndicator(cW);ds.setRemovePriority(dl,6);ds.setRemovePriority(dt,5);ds.setRemovePriority(cX,4);ds.setRemovePriority(dy,3);ds.setRemovePriority(dv,2);ds.setRemovePriority(this._navPart,1);this.__kF=new qx.ui.menu.Menu();cW.setMenu(this.__kF);ds.addListener("hideItem",this._onHideItem,this);ds.addListener("showItem",this._onShowItem,this);return ds;}
,_onHideItem:function(e){var dB=e.getData();var dC=this._getMenuItems(dB);for(var i=0,l=dC.length;i<l;i++){dC[i].setVisibility(bW);if(dB===this.__OA&&!(dC[i] instanceof qx.ui.menu.Separator)){dC[i].getMenu().setPosition(A);}
;}
;}
,_onShowItem:function(e){var dD=e.getData();var dF=this._getMenuItems(dD);for(var i=0,l=dF.length;i<l;i++){dF[i].setVisibility(V);}
;if(dD===this.__OA){var dE=dD.getMenuButtons();for(var i=0,l=dE.length;i<l;i++){dE[i].getMenu().setPosition(P);}
;}
;}
,_getMenuItems:function(dG){var dI=[];if(dG instanceof qx.ui.toolbar.Part){var dN=dG.getChildren();var dM=null;var dH=false;var dJ=this.__kF.getChildren();if(dG!=this.__Oz){dM=this.__kD[dG.toHashCode()];if(!dM){dM=new qx.ui.menu.Separator();this.__kF.addBefore(dM,dJ[0]);this.__kD[dG.toHashCode()]=dM;}
;dI.push(dM);}
else {dH=true;}
;for(var i=0,l=dN.length;i<l;i++){if(dN[i].getVisibility()==bR){continue;}
;var dK=this.__kD[dN[i].toHashCode()];if(!dK){if(dN[i] instanceof qx.ui.toolbar.RadioButton){dK=new qx.ui.menu.RadioButton(dN[i].getLabel());dK.setToolTipText(dN[i].getToolTipText());dK.setEnabled(dN[i].getEnabled());dK.setUserData(L,dN[i].getUserData(L));dK.setModel(dN[i].getModel());dN[i].bind(bk,dK,bk);dN[i].bind(M,dK,M);dK.bind(M,dN[i],M);if(!this.__OF){this.__OF=new qx.ui.form.RadioGroup();this.__OF.setAllowEmptySelection(true);this.__OF.addListener(bp,this.__OI,this);}
;this.__OF.add(dK);}
else if(dN[i] instanceof qx.ui.toolbar.MenuButton){dK=new qx.ui.menu.Button(dN[i].getLabel().translate(),dN[i].getIcon(),dN[i].getCommand(),dN[i].getMenu());dK.setToolTipText(dN[i].getToolTipText());dK.setEnabled(dN[i].getEnabled());dN[i].bind(bk,dK,bk);}
else if(dN[i] instanceof qx.ui.toolbar.Button){dK=new qx.ui.menu.Button(dN[i].getLabel().translate(),dN[i].getIcon());dK.getChildControl(g,false).setRich(true);dK.setTextColor(dN[i].getTextColor());dK.setToolTipText(dN[i].getToolTipText());dK.setEnabled(dN[i].getEnabled());dN[i].bind(bk,dK,bk);var dL=qx.event.Registration.getManager(dN[i]).getListeners(dN[i],bi);if(dL&&dL.length>0){for(var j=0,k=dL.length;j<k;j++){dK.addListener(bi,qx.lang.Function.bind(dL[j].handler,dL[j].context));}
;}
;}
else if(dN[i] instanceof qx.ui.toolbar.CheckBox){dK=new qx.ui.menu.CheckBox(dN[i].getLabel());dK.setToolTipText(dN[i].getToolTipText());dK.setEnabled(dN[i].getEnabled());dN[i].bind(bk,dK,bk);}
else {dK=new qx.ui.menu.Separator();}
;;;if(dH){this.__kF.add(dK);}
else {this.__kF.addBefore(dK,dM);}
;this.__kD[dN[i].toHashCode()]=dK;}
;dI.push(dK);}
;}
;return dI;}
,__OP:function(){var dO=new qx.ui.embed.Iframe().set({nativeContextMenu:true});dO.addListener("load",this.__OU,this);this._iframe=dO;return dO;}
,__OQ:function(){var dP=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");dP.setOverflow("auto","auto");dP.setFont("monospace");dP.setBackgroundColor("white");this.widgets["outputviews.sourcepage.html.page"]=dP;dP.getContentElement().setAttribute("id","qx_srcview");return dP;}
,__OR:function(){var dQ=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");dQ.setOverflow("auto","auto");dQ.setFont("monospace");dQ.setBackgroundColor("white");this.widgets["outputviews.sourcepage.js.page"]=dQ;dQ.getContentElement().setAttribute("id","qx_srcview");return dQ;}
,__OS:function(){var dS=new qx.ui.tree.Tree();var dR=new qx.ui.tree.TreeFolder("Demos");dS.setAppearance("demo-tree");dS.setRoot(dR);this.tree=this.widgets["treeview.flat"]=dS;dS.addListener("changeSelection",this.treeGetSelection,this);dS.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return dS;}
,__OT:function(){var dT=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");dT.setLayout(new qx.ui.layout.VBox(10));dT.setAllowMaximize(false);dT.setAllowMinimize(false);var dW=new qx.ui.basic.Label("");dW.setSelectable(true);dW.setNativeContextMenu(true);dT.add(dW);this._urlWindow=dT;var dX=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(dX<0){dX=0;}
;var top=Math.ceil((qx.bom.Viewport.getHeight()/2)-25);if(top<0){top=0;}
;dT.moveTo(dX,top);this.getApplicationRoot().add(dT);var dU=new qx.ui.menu.Menu();var dV=new qx.ui.menu.Button(this.tr("Get Demo Link"),"icon/22/mimetypes/text-html.png");dV.addListener("execute",function(e){var ea=this.tree.getSelection()[0];var ec=ea.getUserData("modelLink");var dY=this.tests.handler.getFullName(ec);dY=dY.replace(".","~");var eb=location.protocol+"//"+location.host+location.pathname+"#"+dY;this._urlWindow.getChildren()[0].setValue(eb);this._urlWindow.open();}
,this);dU.add(dV);this._tree.setContextMenu(dU);}
,treeGetSelection:function(e){var ed=this.tree.getSelection()[0];this._runbutton.setEnabled(!ed.hasChildren());var ee=ed.getUserData(G);this.tests.selected=this.tests.handler.getFullName(ee);}
,leftReloadTree:function(e){this._sampleToTreeNodeMap={};var ef=this._sampleToTreeNodeMap;var el=null;var en=null;var ek=this._history.getState();var ei=ek.match(/([^~]+)~/);if(ei){el=ei[1];}
else {var eg=ek.match(/([^~][\w]*)/);if(eg){el=eg[1];}
;}
;function em(eo,ep){var et=ep.getChildren();var t;for(var i=0;i<et.length;i++){var eq=et[i];if(eq.hasChildren()){t=new qx.ui.tree.TreeFolder(eh.polish(eq.label));t.setUserData(bL,false);t.setUserData(bc,eq);em(t,t.getUserData(bc));if(eq.label==el){en=t;t.setOpen(true);}
;}
else {if(!eq.type){continue;}
;t=new qx.ui.tree.TreeFile(eh.polish(eq.label));var es=eq.pwd().slice(1).join(bj)+bj+eq.label;if(eq.tags){var j,m,er;t.setUserData(F,eq.tags);{}
;}
;ef[es]=t;}
;eo.add(t);t.setUserData(G,eq);eq.widgetLinkFull=t;}
;}
;var ej=this.tests.handler.ttree;var eh=this;this.tree.setUserData(G,ej);this.tree.getRoot().setOpen(true);em(this.tree.getRoot(),ej);{}
;if(en!=null){this.tree.setSelection([en]);}
else {this.tree.setSelection([this.tree.getRoot()]);}
;}
,runSample:function(e){if(this.tests.selected&&this.tests.selected!=N){var eu=this.tests.selected.replace(R,bj);this.setCurrentSample(eu);}
else {this.playNext();}
;}
,setCurrentSample:function(ew){if(!ew){return;}
;if(!this._sampleToTreeNodeMap){return;}
;var ey;var eA=this._sampleToTreeNodeMap[ew];if(eA){eA.getTree().setSelection([eA]);ey=bE+ew;ey+=z+this.__On;var ez=eA.getUserData(F);if(ez){this.__Ow.setEnabled(!qx.lang.Array.contains(ez,bS));}
;}
else {ey=this.defaultUrl;}
;if(this._iframe.getSource()==ey){this._iframe.reload();}
else {this.__Ov=false;this._iframe.setSource(ey);}
;if(ey==this.defaultUrl){this.disableMenuButtons();}
else {this.enableMenuButtons();}
;this._currentSample=ew;this._currentSampleUrl=ey;}
,__OU:function(){var eE=this._iframe.getWindow();var eK=this._iframe.getSource();if(eK!=null&&eK!=this.defaultUrl){var eD;try{eD=eE.location.href;}
catch(eM){eD=window.location.href;var eL=eD.lastIndexOf("/");if(eL!=-1){eD=eD.substring(0,eL+1);}
;eD+=eK;}
;var eI=eD.indexOf("/demo/")+6;var eF=eD.indexOf("?");eF=eF==-1?eD.length:eF;var eG=eD.substring(eI,eF).split("/");var eJ=String.fromCharCode(187);if(eG.length==2){var eB=eG[0];eB=eB.charAt(0).toUpperCase()+eB.substring(1);var eH=eG[1].replace(".html","").replace("_"," ");eH=eH.charAt(0).toUpperCase()+eH.substring(1);var eC="qooxdoo "+eJ+" Demo Browser "+eJ+" "+eB+" "+eJ+" "+eH;}
else {var eC="qooxdoo "+eJ+" Demo Browser "+eJ+" Start";}
;document.title=eC;}
;}
,__OV:function(e){var eN=this._iframe.getWindow();try{if(eN&&eN.qx&&eN.qx.log&&eN.qx.log.appender){if(!this.__Ov){this.__Ov=true;this.debug("Demo loaded: "+this._currentSample);this.__Or.clear();try{this.__Or.fetch(eN.qx.log.Logger);}
catch(e){return;}
;this._history.addToHistory(this._currentSample.replace("/","~"),document.title);if(this._currentSampleUrl!=this.defaultUrl){this.__OW(this._currentSampleUrl);}
;}
;}
else {this.__Ov=false;}
;}
catch(eO){this.__Ov=false;}
;}
,filter:function(eP){var eX=new RegExp(bM+eP+bC,bT);var eV=this._tree.getRoot().getItems(true,true);var eW=0;var eQ=0;for(var i=0;i<eV.length;i++){var eY=eV[i];var parent=eY.getParent();var eU=eY.getUserData(F);var eR=false;if(eU!=null){for(var j=0;j<eU.length;j++){eR=!!eU[j].match(eX);if(eR){break;}
;}
;}
;if(eY.getChildren().length==0){eQ++;}
;if((eR||(eY.getLabel().search(eX)!=-1)||(parent.getLabel().search(eX)!=-1))){if(eY.getChildren().length==0){eW++;}
;eY.show();eY.getParent().setOpen(true);eY.getParent().show();}
else {eY.exclude();}
;}
;if(eP==N){var eT=this._tree.getRoot().getItems(false,true);var eS=this._tree.getSelection();for(var i=0;i<eT.length;i++){if(eT[i]==eS[0]||eT[i]==eS[0].getParent()){continue;}
;eT[i].setOpen(false);}
;}
;this._status.setValue(eW+bj+eQ);}
,__OW:function(fa){if(typeof (fa)!="string"){return;}
;var fb=new qx.io.request.Xhr(fa);fb.setTimeout(180000);fb.addListener("success",function(fc){var content=fc.getTarget().getResponse();if(content){var ff=content.indexOf("<script",content.indexOf("<script")+7);var fl=content.indexOf("src",ff);var fe=content.indexOf("\"",fl+5);var fg=content.substring(fl+5,fe);var fj=fg.substring(4,fg.length-3)+".src.js";var u="script/demobrowser.demo";var fi=fa.split('/');var fh=fi[1];var fk=fi[2];fk=fk.substr(0,fk.indexOf('.html'));u+="."+fh+"."+fk+".src.js";fj=u;var fd=new qx.io.request.Xhr(fj);fd.setTimeout(18000);fd.addListener("success",function(){var fm=fd.getResponse();this.__OL(fm);if(fm){this.widgets["outputviews.sourcepage.js.page"].setHtml(this.__OX(fm,"javascript"));}
;}
,this);fd.addListener("fail",function(){this.error("Couldn't load file: "+fa);}
,this);fd.send();this.widgets["outputviews.sourcepage.html.page"].setHtml(this.__OX(content));}
;}
,this);fb.addListener("fail",function(fn){this.error("Couldn't load file: "+fa);}
,this);fb.send();}
,dataLoader:function(fo){var fp=new qx.io.request.Xhr(fo);fp.setTimeout(180000);fp.addListener(bU,function(fq){var content=fq.getTarget().getResponse();if(!content){if(window.location.protocol==cj){alert(B+S+b+bt);}
;return;}
;var fr=eval(content);qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(fr);this.leftReloadTree();var fs=this._history.getState();if(fs){this.setCurrentSample(fs.replace(K,bj));}
else {this.setCurrentSample(this.defaultUrl);}
;}
,this,0);}
,this);fp.addListener(ba,function(ft){this.error(bo+fo);}
,this);fp.send();}
,playPrev:function(e){var fx=this.tree.getSelection()[0];if(fx){var fu=this.tree.getPreviousNodeOf(fx,false);if(!fu||fu==this.tree.getRoot()){return;}
;while(fu.isVisible&&!fu.isVisible()){fu=this.tree.getPreviousNodeOf(fu,false);}
;if(fu.getParent()==this.tree.getRoot()){var fw=this.tree.getPreviousNodeOf(fu,false);while(fw.isVisible&&!fw.isVisible()){fw=this.tree.getPreviousNodeOf(fw,false);}
;if(fw.getParent()==this.tree.getRoot()){fw.setOpen(true);var fv=this.tree.getPreviousNodeOf(fu,false);while(fv.isVisible&&!fv.isVisible()){fv=this.tree.getPreviousNodeOf(fv,false);}
;if(fw!==fv){fu=fv;}
;}
else {fu=fw;}
;}
;if(!fu||fu===fx){return;}
else {this.tree.setSelection([fu]);this.runSample();}
;}
;}
,playNext:function(e){this._nextButton.setEnabled(true);this._prevButton.setEnabled(true);var fA=this.tree.getSelection()[0];if(fA){var fy=this.tree.getNextNodeOf(fA);if(!fy){return;}
;if(fy.getParent()==this.tree.getRoot()){fy.setOpen(true);fy=this.tree.getNextNodeOf(fy);}
;if(!fy){return;}
;while(!fy.isVisible()){var fz=this.tree.getNextNodeOf(fy);if(!fz){return;}
;if(fz.getParent()==this.tree.getRoot()){fy.setOpen(true);var fz=this.tree.getNextNodeOf(fz);}
;fy=fz;}
;if(fy){this.tree.setSelection([fy]);this.runSample();}
;}
;}
,__OX:function(fB,fC){var fD=new qx.util.StringBuilder("<pre class='script'>");var fF=[];var fG=new qx.util.StringBuilder();var fH=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var fE=/^\s*<\/script>\s*$/i;fB=fB.replace(/\r\n/g,"\n").replace(/\r/g,"\n");var fF=fB.split('\n');if(fC=="javascript"){return "<pre ><div class='script'>"+qx.dev.Tokenizer.javaScriptToHtml(fB)+"</div></pre>";}
;for(var i=0;i<fF.length;i++){if(fH.exec(fF[i])){fD.add(this.__OY(qx.bom.String.escape(fG.get()+fF[i])));fG.clear();}
else if(fE.exec(fF[i])){var fI=qx.dev.Tokenizer.javaScriptToHtml(fG.get());fD.add('<div class="script">',fI,'</div>');fG.clear();fG.add(fF[i],'\n');}
else {fG.add(fF[i],'\n');}
;}
;fD.add(this.__OY(qx.bom.String.escape(fG.get())),"</pre>");return fD.get();}
,disableMenuButtons:function(){var fJ=this.__Os;for(var i=0;i<fJ.length;i++){fJ[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var fK=this.__Os;for(var i=0;i<fK.length;i++){fK[i].setEnabled(true);}
;}
,__OY:function(fL){var fN=fL;function fM(fO){var s=new qx.util.StringBuilder(arguments[1],'<span class="html-tag-name">',arguments[2],'</span>');var fP;var fQ=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){fP=arguments[i];if(fP=="/"){fQ=true;break;}
else {var m=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;var r;while((r=m.exec(fP))!=null){s.add(' <span class="keyword">',r[1],'</span>=<span class="string">',r[2].replace(/\s*$/,""),'</span>');}
;}
;}
;s.add((fQ?"/":""));}
;s.add('&gt;');return s.get();}
;fN=fN.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,fM);return fN;}
,polish:function(fR){return fR.replace(bm,N).replace(p,bB);}
,__Pa:function(e){this.__On=e.getData()[0].getUserData(M);this.runSample();}
,_createHeader:function(){var fU=new qx.ui.layout.HBox();var fS=new qx.ui.container.Composite(fU);fS.setAppearance(q);var fV=new qx.ui.basic.Label(bd);var fT=new qxc.ui.versionlabel.VersionLabel();fT.setFont(bw);fS.add(fV);fS.add(new qx.ui.core.Spacer,{flex:1});fS.add(fT);return fS;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(v,bx,Q,D,by,br,bV,bG,bn,cg,X,W,ci,bz,bY,bQ,U,w,C,Y,bu,bv,bl,be,O,bH,bs,bF,T,bb,x,bq,cc,bD,bN,bX,bf,ce,bP,cd);}
});}
)();
...
(function(){var k="mousedown",j="mouseout",i="Integer",h="height",g="mousemove",f="move",d="maxHeight",c="resize",b="width",a="_applyOrientation",D="_applyOffset",C="splitpane",B="qx.ui.splitpane.Pane",A="top",z="minHeight",w="mouseup",v="minWidth",u="appear",t="losecapture",s="left",q="maxWidth",r="px",o="vertical",p="knob",m="horizontal",n="slider",l="splitter";qx.Class.define(B,{extend:qx.ui.core.Widget,construct:function(E){qx.ui.core.Widget.call(this);this.__dW=[];if(E){this.setOrientation(E);}
else {this.initOrientation();}
;this.__jI.addListener(k,this._onMouseDown,this);this.__jI.addListener(w,this._onMouseUp,this);this.__jI.addListener(g,this._onMouseMove,this);this.__jI.addListener(j,this._onMouseOut,this);this.__jI.addListener(t,this._onMouseUp,this);}
,properties:{appearance:{refine:true,init:C},offset:{check:i,init:6,apply:D},orientation:{init:m,check:[m,o],apply:a}},members:{__qQ:null,__qR:false,__qS:null,__qT:null,__ma:null,__qU:null,__qV:null,__dW:null,__jI:null,_createChildControlImpl:function(F,G){var H;switch(F){case n:H=new qx.ui.splitpane.Slider(this);H.exclude();this._add(H,{type:F});break;case l:H=new qx.ui.splitpane.Splitter(this);this._add(H,{type:F});H.addListener(f,this.__qW,this);break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);}
,__qW:function(e){this.__qY(e.getData());}
,__qX:function(I){this.__jI=new qx.ui.splitpane.Blocker(I);this.getContentElement().add(this.__jI);var J=this.getChildControl(l);var K=J.getWidth();if(!K){J.addListenerOnce(u,function(){this.__qY();}
,this);}
;J.addListener(c,function(e){var L=e.getData();if(L.height==0||L.width==0){this.__jI.hide();}
else {this.__jI.show();}
;}
,this);}
,getBlocker:function(){return this.__jI;}
,_applyOrientation:function(M,N){var O=this.getChildControl(n);var R=this.getChildControl(l);this.__ma=M===m;if(!this.__jI){this.__qX(M);}
;this.__jI.setOrientation(M);var Q=this._getLayout();if(Q){Q.dispose();}
;var P=M===o?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;this._setLayout(P);R.removeState(N);R.addState(M);R.getChildControl(p).removeState(N);R.getChildControl(p).addState(M);O.removeState(N);O.addState(M);qx.ui.core.queue.Manager.flush();this.__qY();}
,_applyOffset:function(S,T){this.__qY();}
,__qY:function(U){var V=this.getChildControl(l);var ba=this.getOffset();var bb=V.getBounds();var Y=V.getContainerElement().getDomElement();if(!Y){return;}
;if(this.__ma){var X=null;if(U){X=U.width;}
else if(bb){X=bb.width;}
;var bc=U&&U.left;if(X){if(isNaN(bc)){bc=qx.bom.element.Location.getPosition(Y).left;}
;this.__jI.setWidth(ba,X);this.__jI.setLeft(ba,bc);}
;}
...
;this.__jI.setHeight(ba,W);this.__jI.setTop(ba,top);}
;}
;}
,add:function(bd,be){if(be==null){this._add(bd);}
else {this._add(bd,{flex:be});}
;this.__dW.push(bd);}
,remove:function(bf){this._remove(bf);qx.lang.Array.remove(this.__dW,bf);}
,getChildren:function(){return this.__dW;}
,_onMouseDown:function(e){if(!e.isLeftPressed()){return;}
;var bg=this.getChildControl(l);var bi=bg.getContainerLocation();var bh=this.getContentLocation();this.__qQ=this.__ma?e.getDocumentLeft()-bi.left+bh.left:e.getDocumentTop()-bi.top+bh.top;var bk=this.getChildControl(n);var bj=bg.getBounds();bk.setUserBounds(bj.left,bj.top,bj.width,bj.height);bk.setZIndex(bg.getZIndex()+1);bk.show();this.__qR=true;this.__jI.capture();e.stop();}
,_onMouseMove:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__qR){this.__ra();var bl=this.getChildControl(n);var bm=this.__qU;if(this.__ma){bl.setDomLeft(bm);this.__jI.setStyle(s,(bm-this.getOffset())+r);}
else {bl.setDomTop(bm);this.__jI.setStyle(A,(bm-this.getOffset())+r);}
;e.stop();}
;}
...
;this._finalizeSizes();var bn=this.getChildControl(n);bn.exclude();this.__qR=false;this.releaseCapture();e.stop();}
,_finalizeSizes:function(){var br=this.__qU;var bo=this.__qV;if(br==null){return;}
...
else {if(this.__ma){bs.setWidth(br);bp.setWidth(bo);}
else {bs.setHeight(br);bp.setHeight(bo);}
;}
;}
,__ra:function(){if(this.__ma){var bx=v,bE=b,by=q,bC=this.__qS;}
else {var bx=z,bE=h,by=d,bC=this.__qT;}
;var bD=this._getChildren();var bv=bD[2].getSizeHint();var bA=bD[3].getSizeHint();var bB=bD[2].getBounds()[bE]+bD[3].getBounds()[bE];var bz=bC-this.__qQ;var bw=bB-bz;if(bz<bv[bx]){bw-=bv[bx]-bz;bz=bv[bx];}
else if(bw<bA[bx]){bz-=bA[bx]-bw;bw=bA[bx];}
;if(bz>bv[by]){bw+=bz-bv[by];bz=bv[by];}
else if(bw>bA[by]){bz+=bw-bA[by];bw=bA[by];}
;this.__qU=bz;this.__qV=bw;}
,_isActiveDragSession:function(){return this.__qR;}
,_setLastMousePosition:function(x,y){this.__qS=x;this.__qT=y;}
...
(function(){var m="separator-vertical",k="_applyShowLogLevel",j="Boolean",h="qxc.ui.logpane.LogView",g='',f="Debug",d="Log",c="auto",b="execute",a="icon/16/actions/edit-clear.png",I="Clear",H="DIV",G="middle",F="icon/16/status/dialog-information.png",E="Warning",D="Error",C="appear",B="__HG",A="main",z="changeLogLevel",t="Info",u="bold",r="icon/16/categories/system.png",s="icon/16/status/dialog-error.png",p="monospace",q="icon/16/status/dialog-warning.png",n="scroll",o="warn",v="error",w="info",y="white",x="debug";qx.Class.define(h,{extend:qx.ui.container.Composite,construct:function(){this.__HF=[[x,f,r],[w,t,F],[o,E,q],[v,D,s]];var M=new qx.ui.layout.VBox();M.setSeparator(m);qx.ui.container.Composite.call(this,M);this.setDecorator(A);var K=new qx.ui.basic.Label(this.tr(d)).set({font:u,padding:10,alignY:G,allowGrowX:true,allowGrowY:true});this.__Fc=new qx.ui.toolbar.ToolBar();this.__Fc.add(K);this.__Fc.addSpacer();this.__Fc.setBackgroundColor(y);var J=new qx.ui.toolbar.Button(this.tr(I),a);J.addListener(b,function(e){this.clear();}
,this);this.__Fc.add(J);this.add(this.__Fc);var L=new qx.ui.embed.Html(g);L.set({backgroundColor:y,overflowY:n,overflowX:c,font:p,padding:3});this.add(L,{flex:1});this.__HG=new qx.log.appender.Element();qx.log.Logger.unregister(this.__HG);this.__HH=document.createElement(H);this.__HG.setElement(this.__HH);L.addListenerOnce(C,function(){L.getContentElement().getDomElement().appendChild(this.__HH);}
,this);}
,properties:{showLogLevel:{check:j,apply:k,init:false},logLevel:{check:[x,w,o,v],init:x,event:z}},members:{__HH:null,__HG:null,__HF:null,__HI:null,__Fc:null,clear:function(){this.__HG.clear();}
,fetch:function(N){if(!N){N=qx.log.Logger;}
;N.register(this.__HG);N.clear();}
,getAppenderElement:function(){return this.__HH;}
,_applyShowLogLevel:function(O,P){if(!this.__HI){this.__HI=this.__HJ();this.__Fc.add(this.__HI);}
;if(O){this.__HI.show();}
else {this.__HI.exclude();}
;}
,__HJ:function(){var Q=new qx.ui.menu.Menu();var T=new qx.ui.toolbar.MenuButton("Log Level","icon/16/categories/system.png");T.setMenu(Q);for(var i=0,l=this.__HF.length;i<l;i++){var S=this.__HF[i];var R=new qx.ui.menu.Button(S[1],S[2]);R.setUserData("model",S[0]);R.addListener("execute",function(U){var V=U.getTarget();this.setLogLevel(V.getUserData("model"));T.setIcon(V.getIcon());}
,this);Q.add(R);}
;return T;}
},destruct:function(){this._disposeObjects(B);this.__HH=null;}
});}
)();
...
,members:{__dJ:null,setElement:function(t){this.clear();if(t){qx.bom.element.Class.add(t,k);}
;this.__dJ=t;}
,clear:function(){var u=this.__dJ;if(u){u.innerHTML=d;}
;}
,process:function(v){var w=this.__dJ;if(!w){return;}
...
(function(){var j="qx.blankpage",i="undefined",h="#",g="hidden",f="can't initialize iframe",e="qx.bom.HashHistory",d="absolute",c="interval",b="-1000px",a="";qx.Class.define(e,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this._baseUrl=null;this.__rP();}
,members:{__rM:null,__rN:null,__rO:false,addToHistory:function(k,l){if(!qx.lang.Type.isString(k)){k=k+a;}
;if(qx.lang.Type.isString(l)){this.setTitle(l);this._titles[k]=l;}
;if(this.getState()!==k){this.setState(k);}
;}
,__rP:function(){this.__rN=this.__rQ();document.body.appendChild(this.__rN);this.__rR(function(){this._baseUrl=this.__rN.contentWindow.document.location.href;this.__rS();}
,this);}
,__rQ:function(){var m=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(j))+h});m.style.visibility=g;m.style.position=d;m.style.left=b;m.style.top=b;return m;}
,__rR:function(n,o,p){if(typeof p===i){p=0;}
;if(!this.__rN.contentWindow||!this.__rN.contentWindow.document){if(p>20){throw new Error(f);}
;qx.event.Timer.once(function(){this.__rR(n,o,++p);}
,this,10);return;}
;this.__rO=true;n.call(o||window);}
,__rS:function(){qx.event.Idle.getInstance().addListener(c,this.__rU,this);}
,__rT:function(){qx.event.Idle.getInstance().removeListener(c,this.__rU,this);}
,__rU:function(){var q=this._readState();if(qx.lang.Type.isString(q)&&q!=this.getState()){this._onHistoryLoad(q);}
;}
,_readState:function(){var r=!this._getHash()?a:this._getHash().substr(1);return this._decode(r);}
,_getHash:function(){if(!this.__rO){return;}
;return this.__rN.contentWindow.document.location.hash;}
,_writeState:function(s){this._setHash(this._encode(s));}
,_setHash:function(t){if(!this.__rN||!this._baseUrl){return;}
;var u=!this.__rN.contentWindow.document.location.hash?a:this.__rN.contentWindow.document.location.hash.substr(1);if(t!=u){this.__rN.contentWindow.document.location.hash=t;}
;}
},destruct:function(){this.__rT();this.__rN=null;}
});}
)();
...
(function(){var q="request",p="qx.bom.IframeHistory",o="engine.name",n="can't initialize iframe",m="mshtml",l="state",k='<html><body><div id="state">',j="browser.version",i="hidden",h="qx.blankpage",c="undefined",g='</div></body></html>',f="absolute",b="",a="interval",d="-1000px";qx.Class.define(p,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__sa();}
,members:{__rN:null,__rO:false,__rV:null,__rW:null,__rX:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);this.__rX=this._getHash();}
,_setHash:function(r){qx.bom.History.prototype._setHash.call(this,r);this.__rX=this._encode(r);}
...
;}
,_setState:function(v){this.__rW=true;this.setState(v);this.__rW=false;}
,_applyState:function(w,x){if(this.__rW){return;}
;this._writeState(w);}
,_readState:function(){if(!this.__rO){return this._decode(this._getHash());}
;var y=this.__rN.contentWindow.document;var z=y.getElementById(l);return z?this._decode(z.innerText):b;}
,_writeState:function(A){if(!this.__rO){this.__rY();this.__rV=qx.event.Timer.once(function(){this._writeState(A);}
,this,50);return;}
;this.__rY();var A=this._encode(A);if(qx.core.Environment.get(o)==m&&qx.core.Environment.get(j)!=8){this._setHash(A);}
;var B=this.__rN.contentWindow.document;B.open();B.write(k+A+g);B.close();}
,__rY:function(){if(this.__rV){this.__rV.stop();this.__rV.dispose();}
;}
,__sa:function(){this.__rP(function(){qx.event.Idle.getInstance().addListener(a,this.__rU,this);}
);}
,__rU:function(e){var D=null;var C=this._getHash();if(!this.__sc(C)){D=this.__sb(C);}
else {D=this._readState();}
;if(qx.lang.Type.isString(D)&&D!=this.getState()){this._onHistoryLoad(D);}
;}
,__sb:function(E){E=this._decode(E);this._writeState(E);return E;}
,__sc:function(F){return qx.lang.Type.isString(F)&&F==this.__rX;}
,__rP:function(G){this.__rN=this.__rQ();document.body.appendChild(this.__rN);this.__rR(function(){this._writeState(this.getState());if(G){G.call(this);}
;}
,this);}
,__rQ:function(){var H=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(h))});H.style.visibility=i;H.style.position=f;H.style.left=d;H.style.top=d;return H;}
,__rR:function(I,J,K){if(typeof K===c){K=0;}
;if(!this.__rN.contentWindow||!this.__rN.contentWindow.document){if(K>20){throw new Error(n);}
;qx.event.Timer.once(function(){this.__rR(I,J,++K);}
,this,10);return;}
;this.__rO=true;I.call(J||window);}
},destruct:function(){this.__rN=null;if(this.__rV){this.__rV.dispose();this.__rV=null;}
;qx.event.Idle.getInstance().removeListener(a,this.__rU,this);}
});}
)();
(function(){var d="qx.bom.NativeHistory",c="engine.name",b="hashchange",a="interval";qx.Class.define(d,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__rS();}
,members:{__rM:null,__rS:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__rM=qx.lang.Function.bind(this.__rU,this);qx.bom.Event.addNativeListener(window,b,this.__rM);}
else {qx.event.Idle.getInstance().addListener(a,this.__rU,this);}
;}
,__rT:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,b,this.__rM);}
else {qx.event.Idle.getInstance().removeListener(a,this.__rU,this);}
;}
,__rU:function(){var e=this._readState();if(qx.lang.Type.isString(e)&&e!=this.getState()){this._onHistoryLoad(e);}
;}
...
(function(){var g="resize",f="demobrowser.InfoWindow",e="Boolean",d="_applyContent",c="center",b="OK",a="execute";qx.Class.define(f,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);this.setLayout(new qx.ui.layout.VBox(10));this.setMinWidth(200);this.setMaxWidth(qx.bom.Viewport.getWidth()-10);this.setMaxHeight(qx.bom.Viewport.getHeight()-10);this.setShowMinimize(false);this.setShowMaximize(false);this.add(this._getContentContainer(),{flex:1});this.add(this._makeOkButton(),{flex:0});this.addListener(g,this.__Pb,this);}
,properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__Cl:null,_getContentContainer:function(){if(!this.__Cl){this.__Cl=new qx.ui.container.Composite(new qx.ui.layout.VBox());this.__Cl.setMinHeight(20);}
;return this.__Cl;}
...
,__Pb:function(){if(this.getAutoCenter()){this.center();}
;}
}});}
)();
...
(function(){var m="-",l="PageUp",k="Escape",j="qx.event.type.Data",h="_applyShortcut",g="PrintScreen",f="NumLock",d="5",c="8",b="execute",S="Meta",R="0",Q="2",P="Shift",O="You can only specify one non modifier key!",N="3",M="/",L="Delete",K="String",J="changeEnabled",t="*",u="qx.bom.Shortcut",r="6",s="4",p="1",q="Alt",n="Not a valid key name for a shortcut: ",o="PageDown",v="Whitespaces are not allowed within shortcuts",w="_applyEnabled",B="7",A="a",D="z",C="9",F="Boolean",E="+",y="short",I="keydown",H="",G="Control",x="keypress",z="Unidentified";qx.Class.define(u,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__zp={};this.__zq=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":j},properties:{enabled:{init:true,check:F,event:J,apply:w},shortcut:{check:K,apply:h,nullable:true},autoRepeat:{check:F,init:false}},members:{__zp:H,__zq:H,execute:function(U){this.fireDataEvent(b,U);}
,__zr:function(event){if(this.getEnabled()&&this.__zs(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__eJ:function(event){if(this.getEnabled()&&this.__zs(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(V,W){if(V){qx.event.Registration.addListener(document.documentElement,I,this.__zr,this);qx.event.Registration.addListener(document.documentElement,x,this.__eJ,this);}
else {qx.event.Registration.removeListener(document.documentElement,I,this.__zr,this);qx.event.Registration.removeListener(document.documentElement,x,this.__eJ,this);}
;}
,_applyShortcut:function(X,Y){if(X){if(X.search(/[\s]+/)!=-1){var bc=v;this.error(bc);throw new Error(bc);}
;this.__zp={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__zq=null;var ba;var a=[];while(X.length>0&&ba!=-1){ba=X.search(/[-+]+/);a.push((X.length==1||ba==-1)?X:X.substring(0,ba));X=X.substring(ba+1);}
;var bb=a.length;for(var i=0;i<bb;i++){var bd=this.__zu(a[i]);switch(bd){case G:case P:case S:case q:this.__zp[bd]=true;break;case z:var bc=n+a[i];this.error(bc);throw bc;default:if(this.__zq){var bc=O;this.error(bc);throw bc;}
;this.__zq=bd;};}
;}
;return true;}
,__zs:function(e){var be=this.__zq;if(!be){return;}
;if((!this.__zp.Shift&&e.isShiftPressed())||(this.__zp.Shift&&!e.isShiftPressed())||(!this.__zp.Control&&e.isCtrlPressed())||(this.__zp.Control&&!e.isCtrlPressed())||(!this.__zp.Meta&&e.isMetaPressed())||(this.__zp.Meta&&!e.isMetaPressed())||(!this.__zp.Alt&&e.isAltPressed())||(this.__zp.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__zt:{esc:k,ctrl:G,print:g,del:L,pageup:l,pagedown:o,numlock:f,numpad_0:R,numpad_1:p,numpad_2:Q,numpad_3:N,numpad_4:s,numpad_5:d,numpad_6:r,numpad_7:B,numpad_8:c,numpad_9:C,numpad_divide:M,numpad_multiply:t,numpad_minus:m,numpad_plus:E},__zu:function(bf){var bg=qx.event.util.Keyboard;var bh=z;if(bg.isValidKeyIdentifier(bf)){return bf;}
;if(bf.length==1&&bf>=A&&bf<=D){return bf.toUpperCase();}
;bf=bf.toLowerCase();var bh=this.__zt[bf]||qx.lang.String.firstUp(bf);if(bg.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bk=this.__zq;var bj=[];for(var bi in this.__zp){if(this.__zp[bi]){bj.push(qx.locale.Key.getKeyName(y,bi));}
;}
;if(bk){bj.push(qx.locale.Key.getKeyName(y,bk));}
;return bj.join(E);}
},destruct:function(){this.setEnabled(false);this.__zp=this.__zq=null;}
});}
)();
...
(function(){var k="qx.ui.embed.AbstractIframe",j="name",i="Abstract method call",h="",g="_applySource",f="navigate",d="qx.event.type.Event",c="_applyFrameName",b="qx.event.type.Data",a="String";qx.Class.define(k,{extend:qx.ui.core.Widget,construct:function(l){qx.ui.core.Widget.call(this);if(l){this.setSource(l);}
;this._getIframeElement().addListener(f,this.__IG,this);}
,events:{"load":d,"navigate":b},properties:{source:{check:a,apply:g,nullable:true},frameName:{check:a,init:h,apply:c}},members:{_getIframeElement:function(){throw new Error(i);}
...
,__IG:function(e){var q=e.getData();if(q){this.setSource(q);}
;this.fireDataEvent("navigate",q);}
}});}
)();
(function(){var k="__wc",j="no",i="Boolean",h="px",g="event.help",f="gecko",d="auto",c="_applyScrollbar",b="DOMNodeInserted",a="_applyNativeHelp",A="yes",z="scrolling",y="/",x="appear",w="engine.name",v="block",u="qx.ui.embed.Iframe",t="iframe",s="mousedown",r="load",p="help",q="mouseup",n="losecapture",o="contextmenu",l="none",m="display";qx.Class.define(u,{extend:qx.ui.embed.AbstractIframe,construct:function(B){if(B!=null){this.__IJ=B;}
;qx.ui.embed.AbstractIframe.call(this,B);qx.event.Registration.addListener(document.body,s,this.block,this,true);qx.event.Registration.addListener(document.body,q,this.release,this,true);qx.event.Registration.addListener(document.body,n,this.release,this,true);this.__wc=this._createBlockerElement();this.getContainerElement().add(this.__wc);if((qx.core.Environment.get(w)==f)){this.addListenerOnce(x,function(e){var C=this.getContainerElement().getDomElement();qx.bom.Event.addNativeListener(C,b,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:t},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:i,init:false,apply:a},scrollbar:{check:[d,j,A],nullable:true,themeable:true,apply:c}},members:{__IJ:null,__wc:null,renderLayout:function(D,top,E,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,D,top,E,F);var H=h;var G=this.getInsets();this.__wc.setStyles({"left":G.left+H,"top":G.top+H,"width":(E-G.left-G.right)+H,"height":(F-G.top-G.bottom)+H});}
,_createContentElement:function(){var I=new qx.html.Iframe(this.__IJ);I.addListener(r,this._onIframeLoad,this);return I;}
...
,block:function(){this.__wc.setStyle(m,v);}
,release:function(){this.__wc.setStyle(m,l);}
...
,_applyNativeHelp:function(O,P){if(qx.core.Environment.get(g)){var document=this.getDocument();if(!document){return;}
...
},destruct:function(){this._disposeObjects(k);qx.event.Registration.removeListener(document.body,s,this.block,this,true);qx.event.Registration.removeListener(document.body,q,this.release,this,true);qx.event.Registration.removeListener(document.body,n,this.release,this,true);}
});}
)();
(function(){var i="element",h="qx.event.type.Event",g="iframe",f="qx.html.Iframe",d="navigate",c="qx.event.type.Data",b="name",a="source";qx.Class.define(f,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,g,k,l);this.setSource(j);this.addListener(d,this.__IG,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(i);}
...
;}
,__IG:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
...
(function(){var l="_applyOpenMode",k="Space",j="Left",h="Enter",g="changeOpenMode",f="_applyRootOpenClose",d="__mr",c="changeSelection",b="qx.ui.tree.Tree",a="qx.ui.tree.core.AbstractTreeItem",z="tree",y="_applyHideRoot",x="changeRoot",w="_applyRoot",v="keypress",u="none",t="pane",s="Right",r="Boolean",q="excluded",o="visible",p="qx.event.type.Data",m="click",n="dblclick";qx.Class.define(b,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__mr=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(t).add(this.__mr);this.initOpenMode();this.initRootOpenClose();this.addListener(c,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:p,removeItem:p},properties:{openMode:{check:[m,n,u],init:n,apply:l,event:g,themeable:true},root:{check:a,init:null,nullable:true,event:x,apply:w},hideRoot:{check:r,init:false,apply:y},rootOpenClose:{check:r,init:false,apply:f},appearance:{refine:true,init:z},focusable:{refine:true,init:true}},members:{__mr:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__mr;}
...
,_getContentPaddingTarget:function(){return this.__mr;}
...
(function(){var p="No target to insert tests",o="^",n="demobrowser.TreeDataHandler",m="ttree",l="\\.[^\\.]+$",h="demobrowser.withTests",g="depth",f="All",e=".",d="",c="test";qx.Class.define(n,{extend:qx.core.Object,construct:function(q){qx.core.Object.call(this);this.tmap=q;this.ttree=this.__Pc(q);}
,members:{__Pc:function(r){var t=r;function s(x,y){var B=y.classname;var z=B.split(e);function A(parent,D){if(!D.length){return parent;}
...
(function(){var g="qxc.ui.versionlabel.VersionLabel",f="qooxdoo",e=" ",d="2.0.2",c="versionLabel.name",b="",a="versionLabel.version";qx.Class.define(g,{extend:qx.ui.basic.Label,construct:function(h,i){if(h==undefined){h=qx.core.Environment.get(c);}
;if(i==undefined){i=qx.core.Environment.get(a);if(i==null){i=b;if(i==b){i=d;}
;}
;}
...
;}
;O[A]=y;O[i]=0;O[F]=0;return this.__sd=this._generateBackgroundMarkup(O,S);}
,__sg:function(W,X,Y){var ba=this.getInsets();X-=ba.left+ba.right;Y-=ba.top+ba.bottom;var bb=ba.left-this.getWidthLeft()-this.getInnerWidthLeft();var top=ba.top-this.getWidthTop()-this.getInnerWidthTop();return {left:bb,top:top,width:X,height:Y,elementToApplyDimensions:W.firstChild};}
...
(function(){var j="),to(",i="from(",h="background-image",g="background",f="<div style=\"position: absolute; width: 100%; height: 100%; filter:progid:DXImageTransform.Microsoft.Gradient",e="StartColorStr='#FF",d="', ",c="-webkit-gradient(linear,",b="startColorPosition",a="qx.debug",O="deg, ",N="css.gradient.legacywebkit",M="EndColorStr='#FF",L="startColor",K="(GradientType=",J="qx.ui.decoration.MLinearBackgroundGradient",I="(",H="endColorPosition",G="';)\"></div>",F="endColor",q=", ",r="overflow",o="hidden",p="This decorator is already in-use. Modification is not possible anymore!",m="linear-gradient",n=" 0",k="px",l="0",s="shorthand",t="Color",x="vertical",w="",z="css.gradient.filter",y="Number",B="%",A=")",v="css.gradient.linear",E=",",D=" ",C="horizontal",u="_applyLinearBackgroundGradient";qx.Mixin.define(J,{properties:{startColor:{check:t,nullable:true,apply:u},endColor:{check:t,nullable:true,apply:u},orientation:{check:[C,x],init:x,apply:u},startColorPosition:{check:y,init:0,apply:u},endColorPosition:{check:y,init:100,apply:u},colorPositionUnit:{check:[k,B],init:B,apply:u},gradientStart:{group:[L,b],mode:s},gradientEnd:{group:[F,H],mode:s}},members:{_styleLinearBackgroundGradient:function(P){var V=this.__si();var ba=V.start;var T=V.end;var bb=this.getColorPositionUnit();if(qx.core.Environment.get(N)){bb=bb===k?w:bb;if(this.getOrientation()==C){var Y=this.getStartColorPosition()+bb+n+bb;var W=this.getEndColorPosition()+bb+n+bb;}
else {var Y=l+bb+D+this.getStartColorPosition()+bb;var W=l+bb+D+this.getEndColorPosition()+bb;}
;var R=i+ba+j+T+A;var S=c+Y+E+W+E+R+A;P[g]=S;}
else if(qx.core.Environment.get(z)&&!qx.core.Environment.get(v)){P[r]=o;}
else {var bc=this.getOrientation()==C?0:270;var U=ba+D+this.getStartColorPosition()+bb;var Q=T+D+this.getEndColorPosition()+bb;var X=qx.core.Environment.get(v);if(X===m){bc=this.getOrientation()==C?bc+90:bc-90;}
;P[h]=X+I+bc+O+U+E+Q+A;}
;}
,__si:function(){var bd=qx.theme.manager.Color.getInstance();var bf=bd.resolve(this.getStartColor());var be=bd.resolve(this.getEndColor());return {start:bf,end:be};}
,_getContent:function(){if(qx.core.Environment.get(z)&&!qx.core.Environment.get(v)){var bh=this.__si();var bj=this.getOrientation()==C?1:0;var bi=qx.util.ColorUtil.hex3StringToHex6String(bh.start);var bg=qx.util.ColorUtil.hex3StringToHex6String(bh.end);bi=bi.substring(1,bi.length);bg=bg.substring(1,bg.length);return f+K+bj+q+e+bi+d+M+bg+G;}
;return w;}
,_resizeLinearBackgroundGradient:function(bk,bl,bm){var bn=this.getInsets();bl-=bn.left+bn.right;bm-=bn.top+bn.bottom;return {left:bn.left,top:bn.top,width:bl,height:bm};}
,_applyLinearBackgroundGradient:function(){if(qx.core.Environment.get(a)){if(this._isInitialized()){throw new Error(p);}
;}
;}
}});}
)();
