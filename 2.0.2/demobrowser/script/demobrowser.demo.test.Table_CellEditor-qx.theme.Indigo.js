...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellEditor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellEditor-qx.theme.Indigo.5451864ec9c8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="rat",k="demobrowser.demo.test.Table_CellEditor",j="Add/Remove editor",i="Get value",h="_container",g="boolean",f="mouse",e="dog",d="execute",c="Juhu",a="",b="cat";qx.Class.define(k,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Standalone.prototype.main.call(this);this._container=new qx.ui.container.Composite(new qx.ui.layout.VBox(15)).set({padding:20});this.getRoot().add(this._container);this.testCheckBoxEditor();this.testComboBoxEditor();this.testSelectBoxEditor();this.testPasswordEditor();this.testTextfieldEditor();this.testTextfieldEditorDynamic();}
,_addEditor:function(m,n){n=qx.lang.Object.clone(n);var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));var s=m.createCellEditor(n);var t=new qx.ui.container.Composite().set({width:200,height:20});s.setUserBounds(0,0,200,20);t.add(s);o.add(t);var q=new qx.ui.form.Button(i);o.add(q);q.addListener(d,function(){r.setValue(m.getCellEditorValue(s)+a);}
);var p=new qx.ui.form.Button(j);o.add(p);p.addListener(d,function(){s.destroy();qx.ui.core.queue.Manager.flush();s=m.createCellEditor(n);s.setUserBounds(0,0,200,20);t.add(s);qx.ui.core.queue.Manager.flush();}
);var r=new qx.ui.basic.Label(a);o.add(r);this._container.add(o);q.execute();}
,testCheckBoxEditor:function(){var u={value:[true,false]};qx.util.Permutation.permute(u,function(v){this._addEditor(new qx.ui.table.celleditor.CheckBox(),v);}
,this);}
,testComboBoxEditor:function(){var w={value:[a,b,l,2],table:[this.getTableMock()]};var x=new qx.ui.table.celleditor.ComboBox();x.setListData([e,b,f]);qx.util.Permutation.permute(w,function(y){this._addEditor(x,y);}
,this);}
,testSelectBoxEditor:function(){var z={value:[a,b],table:[this.getTableMock()]};var A=new qx.ui.table.celleditor.SelectBox();A.setListData([e,b,f]);qx.util.Permutation.permute(z,function(B){this._addEditor(A,B);}
,this);}
,testPasswordEditor:function(){var C={value:[null,10,c]};qx.util.Permutation.permute(C,function(D){this._addEditor(new qx.ui.table.celleditor.PasswordField(),D);}
,this);}
,testTextfieldEditor:function(){var E={value:[null,10,c]};qx.util.Permutation.permute(E,function(F){this._addEditor(new qx.ui.table.celleditor.TextField(),F);}
,this);}
,testTextfieldEditorDynamic:function(){var G={value:[true,c]};var H=new qx.ui.table.celleditor.Dynamic();H.setCellEditorFactoryFunction(function(I){if(typeof I.value==g){return new qx.ui.table.celleditor.CheckBox();}
...
(function(){var i="keypress",h="Enter",g="qx.ui.table.celleditor.CheckBox",f="focus",d="center",c="keydown",b="middle",a="activate";qx.Class.define(g,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,members:{createCellEditor:function(j){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox().set({alignX:d,alignY:b})).set({focusable:true});var k=new qx.ui.form.CheckBox().set({value:j.value});l.add(k);l.addListener(f,function(){k.focus();}
);l.addListener(a,function(){k.activate();}
);k.addListener(c,function(e){if(e.getKeyIdentifier()==h){var m=qx.event.Pool.getInstance().getObject(qx.event.type.KeySequence);var n=l.getContainerElement().getDomElement();m.init(e.getNativeEvent(),n,e.getKeyIdentifier());m.setType(i);qx.event.Registration.dispatchEvent(n,m);}
;}
,this);return l;}
...
(function(){var g="Function",f="qx.ui.table.celleditor.ComboBox",e="number",d="Array",c="table-editor-combobox",b="appear",a="";qx.Class.define(f,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,properties:{validationFunction:{check:g,nullable:true,init:null},listData:{check:d,init:null,nullable:true}},members:{createCellEditor:function(h){var k=new qx.ui.form.ComboBox().set({appearance:c});var m=h.value;k.originalValue=m;var p=h.table.getTableColumnModel().getDataCellRenderer(h.col);var n=p._getContentHtml(h);if(m!=n){m=n;}
;if(m===null||m===undefined){m=a;}
;var j=this.getListData();if(j){var o;for(var i=0,l=j.length;i<l;i++){var q=j[i];if(q instanceof Array){o=new qx.ui.form.ListItem(q[0],q[1]);}
else {o=new qx.ui.form.ListItem(q,null);}
;k.add(o);}
;}
;k.setValue(a+m);k.addListener(b,function(){k.selectAllText();}
);return k;}
,getCellEditorValue:function(r){var t=r.getValue()||a;var s=this.getValidationFunction();if(s){t=s(t,r.originalValue);}
;if(typeof r.originalValue==e){t=parseFloat(t);}
;return t;}
}});}
)();
...
,this);}
,properties:{appearance:{refine:true,init:w},placeholder:{check:c,nullable:true,apply:u}},events:{"changeValue":g},members:{__zk:null,__zl:null,_applyPlaceholder:function(y,z){this.getChildControl(m).setPlaceholder(y);}
...
,_setPreselectedItem:function(){if(this.__zk){var J=this.__zk.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__zk);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__zk=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(n);var L=M.getSelectionContext();if(L==d||L==i){this.__zk=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__zk=null;}
;}
;}
...
(function(){var h="Function",g="qx.ui.table.celleditor.SelectBox",f="number",e="table-editor-selectbox",d="appear",c="Array",b="",a="row";qx.Class.define(g,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,properties:{validationFunction:{check:h,nullable:true,init:null},listData:{check:c,init:null,nullable:true}},members:{createCellEditor:function(j){var n=new qx.ui.form.SelectBox().set({appearance:e});var o=j.value;n.originalValue=o;var r=j.table.getTableColumnModel().getDataCellRenderer(j.col);var p=r._getContentHtml(j);if(o!=p){o=p;}
;if(o===null){o=b;}
;var m=this.getListData();if(m){var q;for(var i=0,l=m.length;i<l;i++){var s=m[i];if(s instanceof Array){q=new qx.ui.form.ListItem(s[0],s[1]);q.setUserData(a,s[2]);}
else {q=new qx.ui.form.ListItem(s,null);q.setUserData(a,s);}
;n.add(q);}
;}
;var k=n.getChildrenContainer().findItem(b+o);if(k){n.setSelection([k]);}
else {n.resetSelection();}
;n.addListener(d,function(){n.open();}
);return n;}
,getCellEditorValue:function(t){var v=t.getSelection();var x=b;if(v&&v[0]){var u=v[0].getUserData(a);x=u===undefined?v[0].getLabel():u;}
;var w=this.getValidationFunction();if(w){x=w(x,t.originalValue);}
;if(typeof t.originalValue==f){x=parseFloat(x);}
;return x;}
}});}
)();
...
(function(){var b="qx.ui.table.celleditor.PasswordField",a="table-editor-textfield";qx.Class.define(b,{extend:qx.ui.table.celleditor.AbstractField,members:{_createEditor:function(){var c=new qx.ui.form.PasswordField();c.setAppearance(a);return c;}
}});}
)();
...
(function(){var d="Function",c="qx.ui.table.celleditor.Dynamic",b="No function provided! Aborting.",a="qx.debug";qx.Class.define(c,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,construct:function(e){qx.core.Object.call(this);if(e){this.setCellEditorFactoryFunction(e);}
;this.__ML={};}
,properties:{cellEditorFactoryFunction:{check:d,nullable:true,init:null}},members:{__pw:null,__ML:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();if(qx.core.Environment.get(a)){this.assertFunction(g,b);}
;this.__pw=g(f);var h=this.__pw.createCellEditor(f);this.__ML[h.toHashCode()]=f;return h;}
,getCellEditorValue:function(i){var k=this.getCellEditorFactoryFunction();if(qx.core.Environment.get(a)){this.assertFunction(k,b);}
;var j=this.__ML[i.toHashCode()];this.__pw=k(j);var l=this.__pw.getCellEditorValue(i);return l;}
