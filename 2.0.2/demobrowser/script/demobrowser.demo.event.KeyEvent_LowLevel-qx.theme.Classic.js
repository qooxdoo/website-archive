...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.KeyEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.KeyEvent_LowLevel-qx.theme.Classic.72b49165381b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(n,o,p){this.__Qe=f+n.join(j)+l;this.__Qf=p||50;this.__Qg=o;this._clearLog();}
,_clearLog:function(){this.__Qg.innerHTML=this.__Qe+a;this.__Qh=[];}
,_log:function(q){this.__Qh.unshift(q);this.__Qh=this.__Qh.slice(0,this.__Qf);var r=[this.__Qe];for(var i=0;i<this.__Qh.length;i++){r.push(e,this.__Qh[i].join(g),b);}
;r.push(a);this.__Qg.innerHTML=r.join(h);this.__Qg.scrollTop=0;}
,__Qe:null,__Qf:null,__Qg:null,__Qh:null},destruct:function(){this.__Qg=this.__Qh=null;}
});}
)();
