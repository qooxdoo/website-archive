...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Indigo.fc4493884374.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="border-left",j="green",i="demobrowser.demo.mobile.PingPong",h="30px",g="qx.debug",f="interval",d="0px",c="12px",b='Lucida Grande',a="<b>This demo is supposed to be run in a WebKit-based browser.</b>",E="engine.name",D="20px",C="webkit",B="none",A="border-right",z="touchmove",w="black",v="px",u="200px",t="1px solid white",r="top",s="right",p="50%",q="absolute",n="div",o="100%",l="innerHTML",m="left";qx.Class.define(i,{extend:qx.application.Native,members:{__Qm:null,__Qn:null,__Qo:null,__Qp:null,__Qq:5,__Qr:1,__Qs:1,__Qt:null,__Qu:null,__Qv:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(g)){qx.log.appender.Native;qx.log.appender.Console;}
;var H={"width":o,"height":o,"backgroundColor":w,"margin":d,"userSelect":B};var K=new qx.html.Element(n,H);K.useElement(document.body);K.setRoot(true);if(qx.core.Environment.get(E)!=C){var J={"color":j,"font-family":b,"font-size":c,"position":q,"left":h,"top":D};var I=new qx.html.Element(n,J);K.add(I);I.setAttribute(l,a);return;}
;var F=this.__Qz(m);K.add(F);var G=this.__Qz(s);K.add(G);this.__Qn=this.__QA(m);F.add(this.__Qn);F.addListener(z,qx.lang.Function.bind(this.__DA,this,this.__Qn),this);this.__Qm=this.__QA(s);G.add(this.__Qm);G.addListener(z,qx.lang.Function.bind(this.__DA,this,this.__Qm),this);this.__Qo=this.__QB();K.add(this.__Qo);this.__Qu=this.__QC();F.add(this.__Qu);this.__Qv=this.__QC();G.add(this.__Qv);this.__Qt=[0,0];this.__Qw();}
,__Qw:function(){this.__Qo.setStyles({"left":u,"top":u});this.__Qp=new qx.event.Timer(40);this.__Qp.addListener(f,function(){var x=(parseInt(this.__Qo.getStyle(m))+this.__Qq*this.__Qr);var y=(parseInt(this.__Qo.getStyle(r))+this.__Qq*this.__Qs);this.__Qo.setStyle(m,x+v);this.__Qo.setStyle(r,y+v);this.__Qy();}
,this);this.__Qp.start();}
,__Qx:function(L){this.__Qp.stop();this.__Qp.dispose();this.__Qq=5;this.__Qt[L]=this.__Qt[L]+1;this.__Qu.setAttribute(l,this.__Qt[0]);this.__Qv.setAttribute(l,this.__Qt[1]);this.__Qw();}
,__Qy:function(){var N=this.getBoundsFor(this.__Qo);if(N.top<=0){this.__Qs=1;}
;if(N.bottom>=window.innerHeight-5){this.__Qs=-1;}
;if(N.left<=0||N.right>=window.innerWidth){this.__Qx(N.left<=0?1:0);}
;var O=this.getBoundsFor(this.__Qn);if(N.left<=O.right&&N.bottom>=O.top&&N.top<=O.bottom){this.__Qr=1;this.__Qq=Math.min(this.__Qq+1,20);}
;var M=this.getBoundsFor(this.__Qm);if(N.right>=M.left&&N.bottom>=M.top&&N.top<=M.bottom){this.__Qr=-1;this.__Qq=Math.min(this.__Qq+1,20);}
;}
,__DA:function(P,e){P.setStyles({"top":(e.getDocumentTop()-50)+"px"});}
,getBoundsFor:function(Q){return qx.bom.element.Location.get(Q.getDomElement());}
,__Qz:function(R){var S={"width":p,"height":o,"position":q,"backgroundColor":w};if(R==m){S[A]=t;}
else {S[m]=p;S[k]=t;}
;return new qx.html.Element(n,S);}
,__QA:function(T){var U={"width":"30px","height":"100px","top":"100px","position":"absolute","backgroundColor":"white"};U[T]="20px";return new qx.html.Element("div",U);}
,__QB:function(){var V={"width":"20px","height":"20px","position":"absolute","backgroundColor":"white","userSelect":"none"};return new qx.html.Element("div",V);}
,__QC:function(){var W={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};var X=new qx.html.Element("div",W);X.setAttribute("innerHTML","0");return X;}
}});}
)();
