...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_4","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_4-qx.theme.Simple.796aa3ad4d25.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="Exclude & show together",n="el2",m="Create five elements (2 hidden)",l="el5",k="doc",j="demobrowser.demo.test.Element_4",i="Hide a rendered element",h="el3",g="el4",f="el1",c="Create document",e="test",d="Show one of the two hidden elements",b="Include one and hide another element",a="id";qx.Class.define(j,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);this.info(c);var p=new qx.html.Root(document.getElementById(e));p.setAttribute(a,k);this.info(m);var s=new qx.html.Element;s.setAttribute(a,f);var q=new qx.html.Element;q.setAttribute(a,n);var r=new qx.html.Element;r.setAttribute(a,h);var t=new qx.html.Element;t.setAttribute(a,g);var u=new qx.html.Element;u.setAttribute(a,l);p.add(s,q,r,t,u);q.hide();t.hide();qx.html.Element.flush();this.info(d);q.show();qx.html.Element.flush();this.info(i);r.hide();qx.html.Element.flush();this.info(o);r.exclude();r.show();qx.html.Element.flush();this.info(b);r.include();q.hide();qx.html.Element.flush();}
}});}
)();
