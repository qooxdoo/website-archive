...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_3","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_3-qx.theme.Indigo.1fa416ba55ff.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="text",k="blur",j="demobrowser.demo.test.Element_3",i="Element blurred",h="Element focused",g="FocusIn: ",f="focus",d="type",c="test",b="input",a="focusin";qx.Class.define(j,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var m=new qx.html.Root(document.getElementById(c));var n=new qx.html.Element(b);n.setAttribute(d,l);n.focus();n.addListener(f,function(e){qx.log.Logger.debug(h);}
);n.addListener(k,function(e){qx.log.Logger.debug(i);}
);qx.bom.Element.addListener(document.documentElement,a,function(e){qx.log.Logger.debug(g,e.getTarget());}
);m.add(n);qx.html.Element.flush();}
}});}
)();
