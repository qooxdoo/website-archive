...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.AttributeStyle_2","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.AttributeStyle_2-qx.theme.Indigo.7b40df83fb0d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="text",f="Checkbox #1",e="demobrowser.demo.bom.AttributeStyle_2",d="label",c="checkbox",b="input",a="chk";qx.Class.define(e,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var h=qx.dom.Element.create(b,{type:c,checked:true,id:a});document.body.appendChild(h);var i=qx.dom.Element.create(d,{"for":a});qx.bom.element.Attribute.set(i,g,f);document.body.appendChild(i);}
}});}
)();
