...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButtonGroup-qx.theme.Indigo.fe29df2dd389.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="__qP",m="_applyValid",l="",k="changeRequired",j="changeValid",h="_applyInvalidMessage",g="qx.ui.form.RadioButtonGroup",f="qx.event.type.Data",d="Boolean",c="changeInvalidMessage",a="changeSelection",b="String";qx.Class.define(g,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__qP=new qx.ui.form.RadioGroup();this.__qP.addListener(a,function(e){this.fireDataEvent(a,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:d,init:true,apply:m,event:j},required:{check:d,init:false,event:k},invalidMessage:{check:b,init:l,event:c,apply:h},requiredInvalidMessage:{check:b,nullable:true,event:c}},events:{"changeSelection":f},members:{__qP:null,_applyInvalidMessage:function(p,q){var r=this._getChildren();for(var i=0;i<r.length;i++){r[i].setInvalidMessage(p);}
;}
,_applyValid:function(s,t){var u=this._getChildren();for(var i=0;i<u.length;i++){u[i].setValid(s);}
;}
,getRadioGroup:function(){return this.__qP;}
,getChildren:function(){return this._getChildren();}
,add:function(v,w){this.__qP.add(v);this._add(v,w);}
,remove:function(x){this.__qP.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__qP.getItems();for(var i=0;i<y.length;i++){this.__qP.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__qP.getSelection();}
,setSelection:function(z){return this.__qP.setSelection(z);}
,resetSelection:function(){return this.__qP.resetSelection();}
,isSelected:function(A){return this.__qP.isSelected(A);}
,isSelectionEmpty:function(){return this.__qP.isSelectionEmpty();}
,getSelectables:function(B){return this.__qP.getSelectables(B);}
