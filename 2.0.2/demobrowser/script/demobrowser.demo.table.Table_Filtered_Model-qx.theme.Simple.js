...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Filtered_Model-qx.theme.Simple.582f43a2748c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="regex cannot be null!",s="qx.ui.table.model.Filtered",r="Filter not recognized or value1/value2 is null!",q='',p="notregex cannot be null!",o="Filter not recognized: value or target is null!",n="==",m=">",l="notregex",k="between",d="<",j="regex",g='gi',c="!between",b=">=",f="dataChanged",e="!=",h="<=",a='g';qx.Class.define(s,{extend:qx.ui.table.model.Simple,construct:function(){qx.ui.table.model.Simple.call(this);this.numericAllowed=new Array(n,e,m,d,b,h);this.betweenAllowed=new Array(k,c);this.__Mw=false;this.Filters=new Array();}
,members:{__Mx:null,__Mw:null,_js_in_array:function(u,v){var w=v.toString();if(w==q){return false;}
...
,hideRows:function(ba,bb,dispatchEvent){var bd=this.getData();dispatchEvent=(dispatchEvent!=null?dispatchEvent:true);if(!this.__Mw){this.__Mx=bd.slice(0);this.__Mw=true;}
...
;}
,resetHiddenRows:function(){if(!this.__Mx){return;}
;this.Filters=[];this.setData(qx.lang.Array.clone(this.__Mx));}
,setData:function(bf,bg){this.__Mx=qx.lang.Array.clone(bf);this.Filters=[];qx.ui.table.model.Simple.prototype.setData.call(this,bf,bg);}
},destruct:function(){this.__Mx=this.numericAllowed=this.betweenAllowed=this.Filters=null;}
});}
)();
