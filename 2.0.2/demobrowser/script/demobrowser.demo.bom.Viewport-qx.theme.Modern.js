...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Viewport","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Viewport-qx.theme.Modern.2b517bce65f3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="Document Dimension: ",e="Viewport Dimension: ",d="click",c="Viewport Scroll: ",b="demobrowser.demo.bom.Viewport",a="x";qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.bom.Element.addListener(document.body,d,function(){this.debug(f+qx.bom.Document.getWidth()+a+qx.bom.Document.getHeight());this.debug(e+qx.bom.Viewport.getWidth()+a+qx.bom.Viewport.getHeight());this.debug(c+qx.bom.Viewport.getScrollLeft()+a+qx.bom.Viewport.getScrollTop());}
,this);}
}});}
)();
