...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Modern.5558b0384e04.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="touchmove",j="url(",i=")",h="green",g="200px",f="30px",d="qx.debug",c="12px",b="event.touch",a="touchend",w='Lucida Grande',v="innerHTML",u="demobrowser.demo.mobile.ScaleImage",t="59px",s="engine.name",r="demobrowser/demo/mobile/qooxdoo-logo.png",q="20px",p="webkit",o="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",n="50px",l="absolute",m="div";qx.Class.define(u,{extend:qx.application.Native,members:{__En:null,__QD:1,__QE:0,__QF:0,__QG:0,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(d)){qx.log.appender.Native;qx.log.appender.Console;}
;var z=new qx.html.Element(m);z.useElement(document.body);z.setRoot(true);if(qx.core.Environment.get(s)!=p||!qx.core.Environment.get(b)){var y={"color":h,"position":l,"font-family":w,"font-size":c,"left":f,"top":q};var B=new qx.html.Element(m,y);z.add(B);B.setAttribute(v,o);return;}
;var A=qx.util.ResourceManager.getInstance().toUri(r);var x={"width":g,"height":t,"position":l,"left":n,"top":n,"background":j+A+i};this.__En=new qx.html.Element(m,x);this.__En.addListener(k,this.__DA,this);this.__En.addListener(a,this.__Dz,this);z.add(this.__En);}
,__DA:function(e){if(e.isMultiTouch()){this.__QF=e.getRotation()+this.__QE;this.__QG=e.getScale()*this.__QD;this.__En.setStyle("-webkit-transform","rotate("+this.__QF+"deg) scale("+this.__QG+")");}
else {var C=parseInt(e.getDocumentLeft())-(parseInt(this.__En.getStyle("width"))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__En.getStyle("height"))/2);this.__En.setStyles({"left":C+"px","top":top+"px"});}
;}
,__Dz:function(e){if(e.isMultiTouch()){this.__QE=this.__QF;this.__QD=this.__QG;}
;}
}});}
)();
