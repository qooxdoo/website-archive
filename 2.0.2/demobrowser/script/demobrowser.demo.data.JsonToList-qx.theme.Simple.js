...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.JsonToList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.JsonToList-qx.theme.Simple.4675fd9263a5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="icon/16/mimetypes/",o="name",n="demobrowser/demo/data/list.json",m="model.items",l="Loading...",k=" will be created by a converter which converts the type to an icon url.",j=".png",i="model",h="state",g="type",c="list.json</a> and bind the items to the list widget. The icons ",f="' target='_blank'>",e="demobrowser.demo.data.JsonToList",b="<b>List bound to data in a json file</b><br/>",a="Loading the json file <a href='",d="value";qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var s=new qx.ui.form.List();this.getRoot().add(s,{left:10,top:80});var t=new qx.data.controller.List(null,s);t.setLabelPath(o);t.setIconOptions({converter:function(v){return p+v+j;}
});t.setIconPath(g);var r=qx.util.ResourceManager.getInstance().toUri(n);var u=new qx.data.store.Json(r);var status=new qx.ui.basic.Label(l);this.getRoot().add(status,{left:120,top:80});u.bind(m,t,i);u.bind(h,status,d);var q=new qx.ui.basic.Label();q.setRich(true);q.setWidth(450);q.setValue(b+a+r+f+c+k);this.getRoot().add(q,{left:10,top:10});}
}});}
)();
