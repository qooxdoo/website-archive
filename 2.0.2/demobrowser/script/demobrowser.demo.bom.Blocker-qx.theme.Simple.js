...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Blocker","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker-qx.theme.Simple.fb9a105cd505.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="Block Document for 5s",o="demobrowser.demo.bom.Blocker",n="red",m="Block Element for 5s",l="320px",k="green",j="div",i="orange",h="150px",g="300px",c="click",f="button",d="100px",b="200px",a="absolute";qx.Class.define(o,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var r=qx.bom.Input.create(f,{value:p});qx.bom.element.Style.setStyles(r,{position:a,left:d,top:d,width:b});var u=new qx.bom.Blocker;u.setBlockerOpacity(0.5);u.setBlockerColor(n);qx.event.Registration.addListener(r,c,function(e){u.block();qx.event.Timer.once(function(e){u.unblock();}
,window,5000);}
);qx.dom.Element.insertEnd(r,document.body);var q=qx.bom.Input.create(f,{value:m});qx.bom.element.Style.setStyles(q,{position:a,left:l,top:d,width:b});var t=qx.dom.Element.create(j);qx.bom.element.Style.setStyles(t,{position:a,left:g,top:h,width:g,height:b,backgroundColor:i,zIndex:500});qx.dom.Element.insertBegin(t,document.body);var s=new qx.bom.Blocker;s.setBlockerOpacity(0.5);s.setBlockerColor(k);qx.event.Registration.addListener(q,c,function(e){s.block(t);qx.event.Timer.once(function(e){s.unblock();}
,window,5000);}
...
(function(){var p="transparent",o="src",n="allowTransparency",m="div",l="javascript:false;",k="qx.bom.Blocker",j="absolute",i="resize",h="backgroundColor",g="block",c="zIndex",f="mshtml",d="engine.name",b="0px",a="px";qx.Class.define(k,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__bf();}
,members:{__Ne:null,__wc:null,__Nf:null,__Ng:false,__Nh:10000,__Ni:0,__Nj:p,block:function(q){if(!this.__Ng){this.__Nf=q;var r=this.__Nm();this.__Nn(r);this.__Ng=true;}
;}
,unblock:function(){if(this.__Ng){this.__No();this.__Ng=false;}
;}
,isBlocked:function(){return this.__Ng;}
,getBlockerElement:function(){return this.__wc;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__wc,h,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wc,h);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wc,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wc);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wc,c,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wc,c);}
,__bf:function(){this.__Nk();if((qx.core.Environment.get(d)==f)){this.__Nl();}
;qx.event.Registration.addListener(window,i,this.__jP,this);}
,__Nk:function(){this.__wc=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wc,{display:g,opacity:this.__Ni,backgroundColor:this.__Nj});this.setBlockerZIndex(this.__Nh);}
,__Nl:function(){this.__Ne=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Ne,n,false);qx.bom.element.Attribute.set(this.__Ne,o,l);qx.bom.element.Style.setStyles(this.__Ne,{display:g,opacity:this.__Ni});}
,__Nm:function(){var v={position:j};if(this.__Nq()){v.left=b;v.top=b;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+a;v.height=qx.bom.Document.getHeight()+a;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Nf)+a;v.height=qx.bom.element.Dimension.getHeight(this.__Nf)+a;v.left=qx.bom.element.Location.getLeft(this.__Nf)+a;v.top=qx.bom.element.Location.getTop(this.__Nf)+a;}
;return v;}
,__Nn:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wc,w);qx.dom.Element.insertEnd(this.__wc,x);if((qx.core.Environment.get(d)==f)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Ne,w);qx.dom.Element.insertEnd(this.__Ne,document.body);}
;}
,__No:function(){qx.dom.Element.remove(this.__wc);if((qx.core.Environment.get(d)==f)){qx.dom.Element.remove(this.__Ne);}
;}
,__jP:function(e){if(this.__Nq()){this.__Np({width:b,height:b});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+a,height:qx.bom.Document.getHeight()+a};this.__Np(y);}
,this,0);}
;}
,__Np:function(z){qx.bom.element.Style.setStyles(this.__wc,z);if((qx.core.Environment.get(d)==f)){qx.bom.element.Style.setStyles(this.__Ne,z);}
;}
,__Nq:function(){return (this.__Nf==null||qx.dom.Node.isWindow(this.__Nf)||qx.dom.Node.isDocument(this.__Nf));}
},destruct:function(){qx.event.Registration.removeListener(window,i,this.__jP,this);this.__Ne=this.__wc=this.__Nf=null;}
});}
)();
