...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererCustom","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererCustom-qx.theme.Modern.b890c4d1ee0c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="demobrowser.demo.ui.FormRendererCustom",j="Registration",h="Please tell us some details about you...",g="Personal Information",f="Phone",e="Email",d="abc@def.gh",c="demobrowser.demo.ui.CustomRenderer",b="bio",a="+01 234 56789",w="Reset",v="Password",u="Bio",t="Send",s="send...",r="Contact",q="right",p="Name",o="Country",n="phone",l="email",m="execute";qx.Class.define(k,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var y=new qx.ui.form.Form();y.addGroupHeader(j);var x=new qx.ui.form.TextField();x.setRequired(true);y.add(x,p);var C=new qx.ui.form.TextField();C.setRequired(true);y.add(C,v);y.addGroupHeader(r);y.add(new qx.ui.form.TextField(),e,qx.util.Validate.email(),l,null,{placeholder:d});y.add(new qx.ui.form.TextField(),f,null,n,null,{placeholder:a});y.addGroupHeader(g);y.add(new qx.ui.form.TextField(),o);y.add(new qx.ui.form.TextArea(),u,null,b,null,{placeholder:h});var A=new qx.ui.form.Button(t);A.addListener(m,function(){if(y.validate()){alert(s);}
;}
,this);y.addButton(A);var z=new qx.ui.form.Button(w);z.addListener(m,function(){y.reset();}
,this);y.addButton(z);var B=new demobrowser.demo.ui.CustomRenderer(y);this.getRoot().add(B,{left:10,top:10});}
}});qx.Class.define(c,{extend:qx.ui.form.renderer.Single,members:{__Rm:0,__Rn:0,addItems:function(D,E,F,G){var J=0;if(F!=null){this._add(this._createHeader(F),{row:J,column:this.__Rm,colSpan:2});J++;}
;for(var i=0;i<D.length;i++){var I=this._createLabel(E[i],D[i]);this._add(I,{row:J,column:this.__Rm});var H=D[i];I.setBuddy(H);if(H instanceof qx.ui.form.RadioGroup){H=this._createWidgetForRadioGroup(H);}
;this._add(H,{row:J,column:this.__Rm+1});if(G[i]&&G[i].placeholder){H.setPlaceholder(G[i].placeholder);}
;J++;}
;this.__Rm+=2;this.__Rn<J?this.__Rn=J:null;}
,addButton:function(K){if(this._buttonRow==null){this._buttonRow=new qx.ui.container.Composite();this._buttonRow.setMarginTop(5);var L=new qx.ui.layout.HBox();L.setAlignX(q);L.setSpacing(5);this._buttonRow.setLayout(L);this._add(this._buttonRow,{row:this.__Rn,column:0,colSpan:this.__Rm});}
;this._buttonRow.add(K);}
}});}
)();
(function(){var b="qx.ui.form.Form",a="";qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__vS=[];this._buttons=[];this._buttonOptions=[];this._validationManager=new qx.ui.form.validation.Manager();this._resetter=this._createResetter();}
,members:{__vS:null,_validationManager:null,_groupCounter:0,_buttons:null,_buttonOptions:null,_resetter:null,add:function(c,d,e,name,f,g){if(this.__vT()){this.__vS.push({title:null,items:[],labels:[],names:[],options:[],headerOptions:{}});}
;this.__vS[this._groupCounter].items.push(c);this.__vS[this._groupCounter].labels.push(d);this.__vS[this._groupCounter].options.push(g);if(name==null){name=d.replace(/\s+|&|-|\+|\*|\/|\||!|\.|,|:|\?|;|~|%|\{|\}|\(|\)|\[|\]|<|>|=|\^|@|\\/g,a);}
;this.__vS[this._groupCounter].names.push(name);this._validationManager.add(c,e,f);this._resetter.add(c);}
,addGroupHeader:function(h,k){if(!this.__vT()){this._groupCounter++;}
;this.__vS.push({title:h,items:[],labels:[],names:[],options:[],headerOptions:k});}
,addButton:function(l,m){this._buttons.push(l);this._buttonOptions.push(m||null);}
,__vT:function(){return this.__vS.length===0;}
...
,getGroups:function(){return this.__vS;}
,getButtons:function(){return this._buttons;}
,getButtonOptions:function(){return this._buttonOptions;}
,getItems:function(){var n={};for(var i=0;i<this.__vS.length;i++){var o=this.__vS[i];for(var j=0;j<o.names.length;j++){var name=o.names[j];n[name]=o.items[j];}
;}
;return n;}
,_createResetter:function(){return new qx.ui.form.Resetter();}
},destruct:function(){this.__vS=this._buttons=this._buttonOptions=null;this._validationManager.dispose();this._resetter.dispose();}
});}
)();
(function(){var n="Widgets supporting selection can only be validated ",m="Added widget not supported.",l="in the form validator",k="changeValid",j="qx.event.type.Event",h="value instanceof Function || qx.Class.isSubClassOf(value.constructor, qx.ui.form.validation.AsyncValidator)",g="qx.ui.form.validation.Manager",f="This field is required",d="qx.event.type.Data",c="complete",a="String",b="";qx.Class.define(g,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__vf=[];this.__vg={};this.setRequiredFieldMessage(qx.locale.Manager.tr(f));}
,events:{"changeValid":d,"complete":j},properties:{validator:{check:h,init:null,nullable:true},invalidMessage:{check:a,init:b},requiredFieldMessage:{check:a,init:b},context:{nullable:true}},members:{__vf:null,__vh:null,__vg:null,__vi:null,add:function(o,p,q){if(!this.__vn(o)){throw new Error(m);}
;if(this.__vd(o)&&!o.getValue){if(p!=null){throw new Error(n+l);}
;}
;var r={item:o,validator:p,valid:null,context:q};this.__vf.push(r);}
,remove:function(s){var t=this.__vf;for(var i=0,u=t.length;i<u;i++){if(s===t[i].item){t.splice(i,1);return s;}
;}
;return null;}
,getItems:function(){var v=[];for(var i=0;i<this.__vf.length;i++){v.push(this.__vf[i].item);}
;return v;}
,validate:function(){var A=true;this.__vi=true;var x=[];for(var i=0;i<this.__vf.length;i++){var y=this.__vf[i].item;var B=this.__vf[i].validator;x.push(y);if(B==null){var w=this.__vj(y);A=A&&w;this.__vi=w&&this.__vi;continue;}
;var w=this.__vk(this.__vf[i],y.getValue());A=w&&A;if(w!=null){this.__vi=w&&this.__vi;}
;}
;var z=this.__vl(x);if(qx.lang.Type.isBoolean(z)){this.__vi=z&&this.__vi;}
;A=z&&A;this.__vo(A);if(qx.lang.Object.isEmpty(this.__vg)){this.fireEvent(c);}
;return A;}
,__vj:function(C){if(C.getRequired()){if(this.__vd(C)){var D=!!C.getSelection()[0];}
...
;return true;}
,__vk:function(G,H){var M=G.item;var L=G.context;var K=G.validator;if(this.__vm(K)){this.__vg[M.toHashCode()]=null;K.validate(M,M.getValue(),this,L);return null;}
...
,__vl:function(N){var P=this.getValidator();var Q=this.getContext()||this;if(P==null){return true;}
;this.setInvalidMessage(b);if(this.__vm(P)){this.__vg[this.toHashCode()]=null;P.validateForm(N,this,Q);return null;}
...
;}
;return R;}
,__vm:function(S){var T=false;if(!qx.lang.Type.isFunction(S)){T=qx.Class.isSubClassOf(S.constructor,qx.ui.form.validation.AsyncValidator);}
;return T;}
,__vn:function(U){var V=U.constructor;return qx.Class.hasInterface(V,qx.ui.form.IForm);}
,__vd:function(W){var X=W.constructor;return qx.Class.hasInterface(X,qx.ui.core.ISingleSelection);}
,__vo:function(Y){var ba=this.__vh;this.__vh=Y;if(ba!=Y){this.fireDataEvent(k,Y,ba);}
;}
,getValid:function(){return this.__vh;}
,isValid:function(){return this.getValid();}
,getInvalidMessages:function(){var bb=[];for(var i=0;i<this.__vf.length;i++){var bc=this.__vf[i].item;if(!bc.getValid()){bb.push(bc.getInvalidMessage());}
;}
;if(this.getInvalidMessage()!=b){bb.push(this.getInvalidMessage());}
;return bb;}
,getInvalidFormItems:function(){var bd=[];for(var i=0;i<this.__vf.length;i++){var be=this.__vf[i].item;if(!be.getValid()){bd.push(be);}
;}
;return bd;}
,reset:function(){for(var i=0;i<this.__vf.length;i++){var bf=this.__vf[i];bf.item.setValid(true);}
;this.__vh=null;}
,setItemValid:function(bg,bh){this.__vg[bg.toHashCode()]=bh;bg.setValid(bh);this.__vp();}
,setFormValid:function(bi){this.__vg[this.toHashCode()]=bi;this.__vp();}
,__vp:function(){var bk=this.__vi;for(var bl in this.__vg){var bj=this.__vg[bl];bk=bj&&bk;if(bj==null){return;}
;}
;this.__vo(bk);this.__vg={};this.fireEvent(c);}
},destruct:function(){this.__vf=null;}
});}
)();
(function(){var a="qx.ui.form.validation.AsyncValidator";qx.Class.define(a,{extend:qx.core.Object,construct:function(b){qx.core.Object.call(this);this.__vq=b;}
,members:{__vq:null,__vr:null,__dz:null,__vs:null,validate:function(c,d,e,f){this.__vs=false;this.__vr=c;this.__dz=e;this.__vq.call(f||this,this,d);}
,validateForm:function(g,h,i){this.__vs=true;this.__dz=h;this.__vq.call(i,g,this);}
,setValid:function(j,k){if(this.__vs){if(k!==undefined){this.__dz.setInvalidMessage(k);}
;this.__dz.setFormValid(j);}
else {if(k!==undefined){this.__vr.setInvalidMessage(k);}
;this.__dz.setItemValid(this.__vr,j);}
;}
},destruct:function(){this.__dz=this.__vr=null;}
});}
)();
...
(function(){var d="qx.ui.form.Resetter",c=" not supported for reseting.",b="Item ",a="The given item has not been added.";qx.Class.define(d,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__mQ=[];}
,members:{__mQ:null,add:function(e){if(this._supportsValue(e)){var f=e.getValue();}
else if(this.__vd(e)){var f=e.getSelection();}
else if(this.__ve(e)){var f=e.getSelection().concat();}
else {throw new Error(b+e+c);}
;;this.__mQ.push({item:e,init:f});}
,reset:function(){for(var i=0;i<this.__mQ.length;i++){var g=this.__mQ[i];this.__vb(g.item,g.init);}
;}
,resetItem:function(h){var j;for(var i=0;i<this.__mQ.length;i++){var k=this.__mQ[i];if(k.item===h){j=k.init;break;}
;}
;if(j===undefined){throw new Error(a);}
;this.__vb(h,j);}
,__vb:function(l,m){if(this._supportsValue(l)){l.setValue(m);}
else if(this.__vd(l)||this.__ve(l)){l.setSelection(m);}
;}
,redefine:function(){for(var i=0;i<this.__mQ.length;i++){var n=this.__mQ[i].item;this.__mQ[i].init=this.__vc(n);}
;}
,redefineItem:function(o){var p;for(var i=0;i<this.__mQ.length;i++){if(this.__mQ[i].item===o){p=this.__mQ[i];break;}
;}
;if(p===undefined){throw new Error(a);}
;p.init=this.__vc(p.item);}
,__vc:function(q){if(this._supportsValue(q)){return q.getValue();}
else if(this.__vd(q)||this.__ve(q)){return q.getSelection();}
;}
,__vd:function(r){var s=r.constructor;return qx.Class.hasInterface(s,qx.ui.core.ISingleSelection);}
,__ve:function(t){var u=t.constructor;return qx.Class.hasInterface(u,qx.data.controller.ISelection);}
...
},destruct:function(){this.__mQ=null;}
});}
)();
...
(function(){var n="%1 is not a number.",m="%1 is not a color! %2",l="",k="%1 is not a string.",j="number",i="'%1' is not an email address.",h="qx.util.Validate",g="%1 is not an url.",f="%1 is not in %2",d="%1 does not fit %2.",a="string",c="%1 is not in the range from [%2, %3].",b="Validation Error";qx.Class.define(h,{statics:{number:function(o){return function(p){qx.util.Validate.checkNumber(p,null,o);}
;}
,checkNumber:function(q,r,s){s=s||qx.locale.Manager.tr(n,q);if((typeof q!==j&&(!(q instanceof Number)))||(!(isFinite(q)))){throw new qx.core.ValidationError(b,s);}
;}
,email:function(t){return function(u){qx.util.Validate.checkEmail(u,null,t);}
;}
,checkEmail:function(v,w,x){x=x||qx.locale.Manager.tr(i,(v||l));var y=/^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;if(y.test(v)===false){throw new qx.core.ValidationError(b,x);}
;}
,string:function(z){return function(A){qx.util.Validate.checkString(A,null,z);}
;}
,checkString:function(B,C,D){D=D||qx.locale.Manager.tr(k,B);if(typeof B!==a&&(!(B instanceof String))){throw new qx.core.ValidationError(b,D);}
;}
,url:function(E){return function(F){qx.util.Validate.checkUrl(F,null,E);}
;}
,checkUrl:function(G,H,I){I=I||qx.locale.Manager.tr(g,G);var J=/([A-Za-z0-9])+:\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/;if(!J.test(G)){throw new qx.core.ValidationError(b,I);}
;}
...
catch(e){var P=O||qx.locale.Manager.tr(m,M,e);throw new qx.core.ValidationError(b,P);}
;}
,range:function(Q,R,S){return function(T){var U=S||qx.locale.Manager.tr(c,T,Q,R);if(T<Q||T>R){throw new qx.core.ValidationError(b,U);}
;}
;}
,inArray:function(V,W){return function(X){var Y=W||qx.locale.Manager.tr(f,X,V);if(V.indexOf(X)===-1){throw new qx.core.ValidationError(b,Y);}
;}
;}
,regExp:function(ba,bb){return function(bc){var bd=bb||qx.locale.Manager.tr(d,bc,ba);if(!ba.test(bc)){throw new qx.core.ValidationError(b,bd);}
;}
;}
}});}
)();
