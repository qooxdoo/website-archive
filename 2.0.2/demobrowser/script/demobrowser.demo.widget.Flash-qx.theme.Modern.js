...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash-qx.theme.Modern.7ba815144bb9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="2) this html page is not loaded from the file system, but a webserver.",j="Flash Player Version",i="right",h="qooxdoo is the best!",g="Message from Flash:",f="__RC",d="Simple demo with FlashVars",c="__ce",b="__RD",a="bgcolor",F="demobrowser.demo.widget.Flash",E="demobrowser/demo/flash/TestFlash.swf",D="1) no pop-up or advertising blocker is activated.\n",C="Send to Flash",B="demobrowser/demo/flash/FlashVersion.swf",A="No message.",z="Flash:",y="<b>qooxdoo:</b>",x="demobrowser.demo.widget.Flash.sendMessage",w="demobrowser.demo.widget.Flash.flashReady",r="Couldn't connect to Flash Player! Please make sure that:\n",s="demobrowser/demo/flash/fo_tester.swf",p="this is passed in via FlashVars",q="Two way communication (ActionScript <-> JavaScript)",n="__RE",o="__KB",l="Message to Flash:",m="Show Flash Player version",t="noscale",u="#FF6600",v="execute";qx.Class.define(F,{extend:qx.application.Standalone,members:{__ce:null,main:function(){qx.application.Standalone.prototype.main.call(this);var G=new qx.ui.tabview.TabView();G.setContentPadding([8,8,8,8]);var J=this.getRoot();J.add(G,{edge:0});var H=new qx.ui.tabview.Page(d);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});G.add(H);var I=new qx.ui.tabview.Page(q);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});G.add(I);this.__ce=this.createWindow();J.add(this.__ce,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:p};var M=new qx.ui.embed.Flash(s).set({scale:t,variables:L});M.getContentElement().setParam(a,u);N.add(M,{flex:1});var O=new qx.ui.form.Button(m);O.addListener(v,function(){this.__ce.open();}
,this);N.add(O);return N;}
,__KB:null,__RC:null,__RD:null,__RE:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(y).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__RC=new qx.ui.form.TextArea(A);this.__RC.setEnabled(false);Q.add(this.__RC,{flex:1});Q.add(new qx.ui.basic.Label(l));this.__RD=new qx.ui.form.TextArea(h);Q.add(this.__RD,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,i));this.__RE=new qx.ui.form.Button(C);this.__RE.setEnabled(false);this.__RE.addListener(v,function(e){this.__KB.getFlashElement().sendMessage(this.__RD.getValue());}
,this);S.add(this.__RE);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(z).set({rich:true}));this.__KB=new qx.ui.embed.Flash(E);this.__KB.setVariables({init:w});P.add(this.__KB,{flex:1});return R;}
,sendMessage:function(T){this.__RC.setValue(T);}
,initFlash:function(){if(this.__KB.getFlashElement().setup){this.__KB.getFlashElement().setup(x);this.__RE.setEnabled(true);}
else {alert(r+D+k);}
;}
},statics:{__RF:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__RF=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__RF.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__RF.initFlash();}
},destruct:function(){this._disposeObjects(f,b,n,o,c);}
});}
)();
...
(function(){var m="qx.event.type.Data",k="barRight",j="beforeChangeSelection",h="horizontal",g="close-button",f="Index should be less than : ",d="tabview",c="vertical",b="_applyBarPosition",a="barLeft",E="qx.ui.tabview.TabView",D="__qP",C="barTop",B="barBottom",A="bottom",z="button",y="qx.debug",x="changeSelection",w="Incompatible child for TabView: ",v="top",t="left",u="close",r="right",s="page",p="firstTab",q="bar",n="lastTab",o="pane";qx.Class.define(E,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(F){qx.ui.core.Widget.call(this);this.__qO={top:C,right:k,bottom:B,left:a};this._createChildControl(q);this._createChildControl(o);var G=this.__qP=new qx.ui.form.RadioGroup;G.setWrap(false);G.addListener(x,this._onChangeSelection,this);if(F!=null){this.setBarPosition(F);}
else {this.initBarPosition();}
;}
,events:{"changeSelection":m},properties:{appearance:{refine:true,init:d},barPosition:{check:[t,r,v,A],init:v,apply:b}},members:{__qP:null,_createChildControlImpl:function(H,I){var J;switch(H){case q:J=new qx.ui.container.SlideBar();J.setZIndex(10);this._add(J);break;case o:J=new qx.ui.container.Stack;J.setZIndex(5);this._add(J,{flex:1});break;};return J||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
...
;}
;var L=K.getButton();var M=this.getChildControl(q);var O=this.getChildControl(o);K.exclude();M.add(L);O.add(K);this.__qP.add(L);K.addState(this.__qO[this.getBarPosition()]);K.addState(n);var N=this.getChildren();if(N[0]==K){K.addState(p);}
...
;var R=P.getButton();var S=this.getChildControl(q);var U=this.getChildControl(o);P.exclude();S.addAt(R,Q);U.addAt(P,Q);this.__qP.add(R);P.addState(this.__qO[this.getBarPosition()]);T=this.getChildren();if(Q==T.length-1){P.addState(n);}
...
;}
;Y.remove(X);bb.remove(V);this.__qP.remove(X);V.removeState(this.__qO[this.getBarPosition()]);if(V.hasState(p)){V.removeState(p);if(ba[0]){ba[0].addState(p);}
;}
...
,__qO:null,_applyBarPosition:function(bd,be){var bf=this.getChildControl(q);var bk=bd==t||bd==r;var bi=bd==r||bd==A;var bj=bk?qx.ui.layout.HBox:qx.ui.layout.VBox;var bm=this._getLayout();if(bm&&bm instanceof bj){}
else {this._setLayout(bm=new bj);}
;bm.setReversed(bi);bf.setOrientation(bk?c:h);var bl=this.getChildren();if(be){var bg=this.__qO[be];bf.removeState(bg);for(var i=0,l=bl.length;i<l;i++){bl[i].removeState(bg);}
;}
;if(bd){var bh=this.__qO[bd];bf.addState(bh);for(var i=0,l=bl.length;i<l;i++){bl[i].addState(bh);}
;}
;}
,getSelection:function(){var bn=this.__qP.getSelection();var bo=[];for(var i=0;i<bn.length;i++){bo.push(bn[i].getUserData(s));}
;return bo;}
,setSelection:function(bp){var bq=[];for(var i=0;i<bp.length;i++){bq.push(bp[i].getChildControl(z));}
;this.__qP.setSelection(bq);}
,resetSelection:function(){this.__qP.resetSelection();}
,isSelected:function(br){var bs=br.getChildControl(z);return this.__qP.isSelected(bs);}
,isSelectionEmpty:function(){return this.__qP.isSelectionEmpty();}
,getSelectables:function(bt){var bu=this.__qP.getSelectables(bt);var bv=[];for(var i=0;i<bu.length;i++){bv.push(bu[i].getUserData(s));}
;return bv;}
...
},destruct:function(){this._disposeObjects(D);this.__qO=null;}
});}
)();
...
,__mR:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
,_checkLoading:function(){var bi=this.getSource();if(bi!=t&&bi!=null&&bi!=J){if(!this.isLoaded()){if(!this.__Kw){this.__Kw=new Date().getTime();}
;var bj=new Date().getTime()-this.__Kw;if(this.getLoadTimeout()>bj){var bk=qx.util.TimerManager.getInstance();bk.start(this._checkLoading,0,this,null,10);this.fireEvent(S);}
else {if(qx.core.Environment.get(N)){this.debug(r+bj);}
;this.fireEvent(F);this.__Kw=null;}
;}
else {this.fireEvent(ba);this.__Kw=null;}
;}
;}
...
,_applyQuality:function(bu,bv){this.__Kx(j,bu);}
,_applyScale:function(bw,bx){this.__Kx(f,bw);}
,_applyWmode:function(by,bz){this.__Kx(a,by);}
,_applyPlay:function(bA,bB){this.__Kx(l,bA);}
,_applyLoop:function(bC,bD){this.__Kx(W,bC);}
,_applyMenu:function(bE,bF){this.__Kx(U,bE);}
,_applyAllowScriptAccess:function(bG,bH){this.__Kx(V,bG);}
,_applyLiveConnect:function(bI,bJ){this.__Kx(q,bI);}
,__Kx:function(bK,bL){this.getContentElement().setParam(bK,bL);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var m="The id cannot be modified after initial creation",l="The variables cannot be modified after initial creation",k="movie",j="The attributes cannot be modified after initial creation",i="The source cannot be modified after initial creation",h="The params cannot be modified after initial creation",g="id",f="qx.html.Flash",e="Invalid attribute 'key'.",d="div",a="Invalid attribute 'value' expected String, Boolean or null.",c="Invalid attribute 'value'.",b="qx.debug";qx.Class.define(f,{extend:qx.html.Element,construct:function(n,o){qx.html.Element.call(this,d,n,o);this.__Ky={};this.__Kz={};this.__KA={};}
,members:{__Ky:null,__KA:null,__Kz:null,__KB:null,_createDomElement:function(){return qx.dom.Element.create(d);}
...
;if(this.__KB){throw new Error(l);}
;this.__Kz=r;}
...
;}
;}
;if(this.__KB){throw new Error(j);}
;if(t===null||t===undefined){delete this.__KA[s];}
else {this.__KA[s]=t;}
;}
...
;}
;}
;if(this.__KB){throw new Error(h);}
;if(v===null||v===undefined){delete this.__Ky[u];}
else {this.__Ky[u]=v;}
;}
...
;}
;}
;var x=this.__KH(s,t,v,w);this._flashObjects[t.id]=x;return x;}
,destroy:qx.core.Environment.select(d,{"mshtml":function(y,z){y=this.__KC(y);if(y.readyState==4){this.__KD(y);}
else {if(!z){z=window;}
;qx.bom.Event.addNativeListener(z,k,function(){qx.bom.Flash.__KD(y);}
);}
;}
,"default":function(A,B){A=this.__KC(A);if(A.parentNode){A.parentNode.removeChild(A);}
;delete this._flashObjects[A.id];}
}),__KC:function(C){if(!C){throw new Error("DOM element is null or undefined!");}
...
;return C;}
,__KD:qx.core.Environment.select("engine.name",{"mshtml":qx.event.GlobalError.observeMethod(function(D){for(var i in D){if(typeof D[i]=="function"){D[i]=null;}
;}
;if(D.parentNode){D.parentNode.removeChild(D);}
;delete this._flashObjects[D.id];}
),"default":null}),__KE:qx.event.GlobalError.observeMethod(function(){for(var E in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[E]);}
;window.__KF=function(){}
;window.__KG=function(){}
;qx.bom.Event.removeNativeListener(window,"beforeunload",qx.bom.Flash.__KE);}
),__KH:qx.core.Environment.select("engine.name",{"mshtml":function(F,G,H,I){H.movie=G.data;delete G.data;delete G.classid;var J="";for(name in H){J+='<param name="'+name+'" value="'+H[name]+'" />';}
...
})},defer:function(Q){if((qx.core.Environment.get(d)==o)){qx.bom.Event.addNativeListener(window,m,Q.__KE);}
;}
});}
)();
(function(){var c="qx.util.TimerManager",b="interval",a="singleton";qx.Class.define(c,{extend:qx.core.Object,type:a,statics:{__KI:[],__KJ:{},__tf:0},members:{__KK:false,start:function(d,e,f,g,h){if(!h){h=e||0;}
;var j=(new Date()).getTime()+h;this.self(arguments).__KJ[++this.self(arguments).__tf]={callback:d,userData:g||null,expireAt:j,recurTime:e,context:f||this};this.__KL(j,this.self(arguments).__tf);return this.self(arguments).__tf;}
,stop:function(k){var l=this.self(arguments).__KI;var length=l.length;for(var i=0;i<length;i++){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__KJ[k];if(l.length==0&&this.__KK){qx.event.Idle.getInstance().removeListener(b,this.__KM,this);this.__KK=false;}
;}
,__KL:function(m,n){var p=this.self(arguments).__KI;var o=this.self(arguments).__KJ;var length=p.length;for(var i=0;i<length;i++){if(o[p[i]].expireAt>m){p.splice(i,0,n);break;}
;}
;if(p.length==length){p.push(n);}
;if(!this.__KK){qx.event.Idle.getInstance().addListener("interval",this.__KM,this);this.__KK=true;}
;}
,__KM:function(){var t=(new Date()).getTime();var r=this.self(arguments).__KI;var s=this.self(arguments).__KJ;while(r.length>0&&s[r[0]].expireAt<=t){var v=r.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__KL(q.expireAt,v);}
else {delete s[v];}
;}
;if(r.length==0&&this.__KK){qx.event.Idle.getInstance().removeListener("interval",this.__KM,this);this.__KK=false;}
;}
}});}
)();
...
,properties:{wrap:{check:x,init:true,apply:j},appearance:{refine:true,init:n},singleStep:{check:w,init:20},minimalLineHeight:{check:w,apply:h,init:4},autoSize:{check:x,apply:E,init:false}},members:{__vJ:null,__vK:null,__vL:null,setValue:function(G){G=qx.ui.form.AbstractField.prototype.setValue.call(this,G);this.__vM();return G;}
...
;}
,__vM:function(){if(this.isAutoSize()){var L=this.__vN();if(L){this.__vL=this.__vL||this._getAreaHeight();var N=this._getScrolledAreaHeight();if(this.getMaxHeight()){var J=this.getInsets();var K=-J.top+this.getMaxHeight()-J.bottom;if(N>K){this.getContentElement().setStyle(u,l);}
else {this.getContentElement().setStyle(u,t);}
;}
;var M=Math.max(N,this.__vL);this._setAreaHeight(M);}
else {this.getContentElement().addListenerOnce(r,function(){this.__vM();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(O){if(this._getAreaHeight()!==O){this.__vK=O;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__vQ();}
;}
,_getScrolledAreaHeight:function(){var Q=this.__vN();var P=Q.getDomElement();if(P){if(!P.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;Q.setValue(this.getValue());this.__vP(Q);if(qx.core.Environment.get(m)==s){if(!P.scrollTop){qx.html.Element.flush();}
;return P.scrollTop+this._getTextSize().height;}
;return P.scrollTop;}
;}
,__vN:function(){this.__vJ=this.__vJ||this.__vO();return this.__vJ;}
,__vO:function(){var U,S,R,T;U=this.getContentElement();if(!U.getDomElement()){return;}
;R=qx.bom.Collection.create(U.getDomElement()).clone()[0];T=new qx.html.Input(n);T.useElement(R);S=T;S.setStyles({position:y,top:0,left:-9999,height:0,overflow:t},true);S.removeAttribute(A);S.removeAttribute(C);S.setAttribute(D,i);S.setValue(U.getValue());S.insertBefore(U);this.__vP(S);return S;}
,__vP:function(V){V=V.getDomElement();if(V){V.scrollTop=10000;}
;}
,_createInputElement:function(){return new qx.html.Input(n,{overflowX:l,overflowY:l});}
,_applyWrap:function(W,X){this.getContentElement().setWrap(W);this.__vM();}
,_applyMinimalLineHeight:function(){qx.ui.core.queue.Layout.add(this);}
,_applyAutoSize:function(Y,ba){if(qx.core.Environment.get(q)){this.__vR();}
;if(Y){this.__vM();this.addListener(v,this.__vM,this);this.addListenerOnce(r,function(){this.getContentElement().setStyle(u,t);}
);}
else {this.removeListener(v,this.__vM);this.getContentElement().setStyle(u,l);}
;}
,_applyDimension:function(bb){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(q)){this.__vR();}
;if(bb===this.getMaxHeight()){this.__vM();}
;}
,__vQ:function(){var content=this.getContentElement();var bd=content.getDomElement();var bc=content.getStyle(o);content.setStyle(o,parseInt(bc,10)+1000+k,true);if(bd){qx.bom.element.Dimension.getWidth(bd);}
;content.setStyle(o,bc,true);}
,__vR:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(f+z+a);}
;}
,_getContentHint:function(){var be=qx.ui.form.AbstractField.prototype._getContentHint.call(this);be.height=be.height*this.getMinimalLineHeight();be.width=this._getTextSize().width*20;if(this.isAutoSize()){be.height=this.__vK||be.height;}
;return be;}
}});}
)();
...
;var e={position:b,top:0,left:0};var f=this._generateBackgroundMarkup(e);return this.__BI=f;}
