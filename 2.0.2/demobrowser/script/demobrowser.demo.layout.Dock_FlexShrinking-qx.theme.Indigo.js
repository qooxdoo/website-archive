...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_FlexShrinking","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_FlexShrinking-qx.theme.Indigo.7c78571f5df4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="demobrowser.demo.layout.Dock_FlexShrinking",n="x",m="y",l="east",k="yellow",j="center",i="north",h="south",g="west",f="green",c="blue",e="fuchsia",d="orange",b="red",a="main";qx.Class.define(o,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(q);var p=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:a,backgroundColor:k,width:150,height:100,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});p.add(w,{edge:i,flex:1});p.add(v,{edge:g,flex:1});p.add(u,{edge:h,flex:1});p.add(t,{edge:l,flex:1});p.add(s,{edge:j});q.add(p);var r=new qx.ui.layout.Dock();r.setSort(m);var p=(new qx.ui.container.Composite(r)).set({decorator:a,backgroundColor:k,width:150,height:100,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});p.add(w,{edge:i,flex:1});p.add(v,{edge:g,flex:1});p.add(u,{edge:h,flex:1});p.add(t,{edge:l,flex:1});p.add(s,{edge:j});q.add(p);var r=new qx.ui.layout.Dock();r.setSort(n);var p=(new qx.ui.container.Composite(r)).set({decorator:a,backgroundColor:k,width:150,height:100,allowGrowX:false});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:c});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:e});p.add(w,{edge:i,flex:1});p.add(v,{edge:g,flex:1});p.add(u,{edge:h,flex:1});p.add(t,{edge:l,flex:1});p.add(s,{edge:j});q.add(p);}
}});}
)();
