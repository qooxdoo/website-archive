...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents-qx.theme.Indigo.0507d85f0a4a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=m+e.getRow()+b+e.getColumn()+c;this.__Ro(q);}
,_onContextMenu:function(e){var r=j+e.getRow()+b+e.getColumn()+c;this.__Ro(r);}
,_onDblclickPane:function(e){var s=i+e.getRow()+b+e.getColumn()+c;this.__Ro(s);}
,__Ro:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
