...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellSpan","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellSpan-qx.theme.Classic.d8c9810ac0bb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,getCellProperties:function(q,r){var s=(q+r)%2==0?d:a;this.__Rp.setBackgroundColor(s);return this.__Rp.getCellProperties(q+j+r);}
...
;this.__jy=qx.bom.Stylesheet.createElement(p);this.__Jh={};this.__lF={};}
,members:{__jy:null,__Jh:null,__lF:null,getStylesheet:function(){return this.__jy;}
,getCssClass:function(q){return this.__Jh[q]||null;}
,computeClassForStyles:function(r,s){var t=this.__lF[s];if(!t){var t=this.__Ji();qx.bom.Stylesheet.addRule(this.__jy,f+t,s);this.__lF[s]=t;}
;this.__Jh[r]=t;return t;}
,__Ji:function(){return k+this.toHashCode()+o+(this.__Jj++);}
,__Jj:0},destruct:function(){this.__jy=this.__Jh=this.__lF=null;}
});}
)();
(function(){var k="backgroundColor",j="_applyTextAlign",h="px",g="_applyFont",f="_applyBackgroundColor",e="cell",d="center",c="font",b=":",a="shorthand",H="String",G="_applyAppearance",F="background-color:",E="textAlign",D="qx-cell ",C="left",B="textColor",A="text-align:",z="Font",y="right",r="_applyTextColor",s="justify",p="color:",q=";",n="qx.ui.virtual.cell.Cell",o="paddingLeft",l="Color",m="",t="paddingBottom",u="paddingTop",w="paddingRight",v="Integer",x="_applyPadding";qx.Class.define(n,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__jy=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__JA={};this.__JB={};this.__JC={};this.__JD={};this.__hy={};this.__JE={};this.initAppearance();this.__JI();}
,properties:{appearance:{check:H,init:e,apply:G},backgroundColor:{nullable:true,check:l,apply:f,themeable:true},textColor:{nullable:true,check:l,apply:r,themeable:true},textAlign:{check:[C,d,y,s],nullable:true,themeable:true,apply:j},font:{nullable:true,apply:g,check:z,themeable:true},paddingTop:{check:v,init:0,apply:x,themeable:true},paddingRight:{check:v,nullable:true,apply:x,themeable:true},paddingBottom:{check:v,nullable:true,apply:x,themeable:true},paddingLeft:{check:v,nullable:true,apply:x,themeable:true},padding:{group:[u,w,t,o],mode:a,themeable:true}},members:{__JF:null,__JG:null,__hy:null,__JE:null,__JB:null,__JA:null,__JC:null,__JD:null,__JH:false,__jy:null,__JI:function(){var K=qx.util.PropertyUtil;var M=qx.lang.Object.fromArray(this._getCssProperties());this.__JF=[];var J=this.constructor;while(J){var L=K.getProperties(J);for(var I in L){if(!M[I]){this.__JF.push(I);}
;}
;J=J.superclass;}
;}
,_getCssProperties:function(){return [k,B,c,E,u,w,t,o];}
,_applyAppearance:function(N,O){if(O){this.__JB={};}
;}
,_getValue:function(P){if(this.__JH){return qx.util.PropertyUtil.getThemeValue(this,P);}
else {return qx.util.PropertyUtil.getUserValue(this,P);}
;}
,_storeStyle:function(Q,R){var S;if(this.__JH){S=this.__JB;}
else {S=this.__JA;}
...
;}
,_applyPadding:function(bd,be,name){var bd=this._getValue(name);if(this.__JH){var bg=this.__JD;}
else {bg=this.__JC;}
...
;}
,getCellProperties:function(bh,bi){this.__JJ(bi);return {classes:this.getCssClasses(bh,bi),style:this.getStyles(bh,bi),attributes:this.getAttributes(bh,bi),content:this.getContent(bh,bi),insets:this.getInsets(bh,bi)};}
,getAttributes:function(bj,bk){return m;}
,getContent:function(bl,bm){return bl;}
,getCssClasses:function(bn,bo){var bp=this.__jy.getCssClass(this.__JG)||m;return D+bp;}
,__JJ:function(bq){if(!bq){bq={};}
;var bs=this.getAppearance();var br=bs+"-"+qx.lang.Object.getKeys(bq).sort().join(" ");if(this.__JG==br){return;}
;this.__JG=br;var bt=this.__hy[this.__JG];if(!bt){this.__JK();this.__JL(bq);this.__JM(bq);this.__JN();this.__hy[this.__JG]=1;}
;this.__JO();}
,__JK:function(){var bu=qx.util.PropertyUtil;var bv=this._getCssProperties();for(var i=0;i<bv.length;i++){bu.deleteThemeValue(this,bv[i]);}
;}
,__JL:function(bw){this.__JB={};this.__JH=true;var bz=this.getAppearance();var by=qx.util.PropertyUtil;var bx=qx.theme.manager.Appearance.getInstance().styleFrom(bz,bw);for(var bA in bx){if(bx[bA]!==undefined){by.setThemed(this,bA,bx[bA]);}
;}
;this.__JH=false;}
,__JM:function(){var bB=qx.lang.Object.getValues(this.__JB).join(";");this.__jy.computeClassForStyles(this.__JG,bB);}
,__JN:function(){var bG=this.__JF;var bC=qx.util.PropertyUtil;var bE={};for(var i=0;i<bG.length;i++){var bF=bG[i];var bD=bC.getThemeValue(this,bF);if(bD!==undefined){bE[bF]=bD;}
;}
;this.__JE[this.__JG]=bE;}
,__JO:function(){var bI=qx.util.PropertyUtil;var bH=this.__JE[this.__JG]||{};for(var bJ in bH){bI.setThemed(this,bJ,bH[bJ]);}
;}
,getStyles:function(bK,bL){return qx.lang.Object.getValues(this.__JA).join(q);}
,getInsets:function(bM,bN){var bR=this.__JC;var bQ=this.__JD;var top=(bR.paddingTop!==undefined?bR.paddingTop:bQ.paddingTop)||0;var bO=(bR.paddingRight!==undefined?bR.paddingRight:bQ.paddingRight)||0;var bP=(bR.paddingBottom!==undefined?bR.paddingBottom:bQ.paddingBottom)||0;var bS=(bR.paddingLeft!==undefined?bR.paddingLeft:bQ.paddingLeft)||0;return [bS+bO,top+bP];}
},destruct:function(){this.__jy=this.__JA=this.__JB=this.__JC=this.__JD=this.__hy=this.__JE=this.__JF=null;}
});}
)();
...
(function(){var e="qx.ui.virtual.layer.HtmlCellSpan",d="x",c="_spanManager",b="",a="html";qx.Class.define(e,{extend:qx.ui.virtual.layer.HtmlCell,construct:function(f,g,h){qx.ui.virtual.layer.HtmlCell.call(this,f);this._spanManager=new qx.ui.virtual.layer.CellSpanManager(g,h);}
,members:{setCellSpan:function(j,k,m,n){var o=j+d+k;this._spanManager.removeCell(o);if(m>1||n>1){this._spanManager.addCell(o,j,k,m,n);}
;qx.ui.core.queue.Widget.add(this);}
,__LC:function(p,q,r,s,top,t,u){var w=this._cellProvider.getCellProperties(q,r);var v=w.insets||[0,0];p.push("<div ","style='","left:",s,"px;","top:",top,"px;",this._getCellSizeStyle(t,u,v[0],v[1]),w.style||"","' ","class='",w.classes||"","' ",w.attributes||"",">",w.content||"","</div>");}
,_fullUpdate:function(z,A,B,C){var L=[];var H=this._spanManager.findCellsInWindow(z,A,B.length,C.length);if(H.length>0){var I=this._spanManager.getCellBounds(H,z,A);var F=this._spanManager.computeCellSpanMap(H,z,A,B.length,C.length);for(var i=0,l=H.length;i<l;i++){var J=H[i];var N=I[i];this.__LC(L,J.firstRow,J.firstColumn,N.left,N.top,N.width,N.height);}
;}
else {F=[];for(var i=0;i<B.length;i++){F[z+i]=[];}
;}
;var M=0;var top=0;var E=z;var K=A;for(var x=0;x<B.length;x++){var M=0;var K=A;var D=B[x];for(var y=0;y<C.length;y++){var G=C[y];if(!F[E][K]){this.__LC(L,E,K,M,top,G,D);}
;K++;M+=G;}
;top+=D;E++;}
...
;return D;}
,findCellsInWindow:function(F,G,H,I){var M={};if(H>0){var K=F+H-1;qx.lang.Object.merge(M,this._findCellsInRange(g,F,K),this._findCellsInRange(d,F,K));}
;var J={};if(I>0){var L=G+I-1;qx.lang.Object.merge(J,this._findCellsInRange(h,G,L),this._findCellsInRange(k,G,L));}
;return this.__Jm(J,M);}
,__Jm:function(N,O){var P=[];for(var Q in N){if(O[Q]){P.push(O[Q]);}
;}
;return P;}
...
(function(){var j="cell.rowspan",h="x",g="cell.column",f="cell.colspan",e="qx.ui.virtual.layer.WidgetCellSpan",d="_spanManager",c="_cellLayer",b="cell.spanning",a="cell.row";qx.Class.define(e,{extend:qx.ui.virtual.layer.Abstract,include:[qx.ui.core.MChildrenHandling],construct:function(k,m,n){qx.ui.virtual.layer.Abstract.call(this);this.setZIndex(2);this._spanManager=new qx.ui.virtual.layer.CellSpanManager(m,n);this._cellProvider=k;this.__Ah=[];this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__MB());this._cellLayer.setZIndex(0);this._setLayout(new qx.ui.layout.Grow());this._add(this._cellLayer);}
,properties:{anonymous:{refine:true,init:false}},members:{getRenderedCellWidget:function(o,p){var q=this._cellLayer.getRenderedCellWidget(o,p);if(!q||q.getUserData(b)){var t=this._getChildren();for(var i=0,l=t.length;i<l;i++){var s=t[i];if(s==this._cellLayer){continue;}
;var r={row:s.getUserData(a),column:s.getUserData(g),rowSpan:s.getUserData(j),colSpan:s.getUserData(f)};if(r.row<=o&&o<r.row+r.rowSpan&&r.column<=p&&p<r.column+r.colSpan){return s;}
;}
;return null;}
;return q;}
,__Ah:null,setCellSpan:function(u,v,w,x){var y=u+h+v;this._spanManager.removeCell(y);if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);}
;qx.ui.core.queue.Widget.add(this);}
,__MB:function(){var self=this;var B=this._cellProvider;var A=this.__Ah;var z={getCellWidget:function(C,D){if(!self._spanMap[C][D]){var E=B.getCellWidget(C,D);}
else {var E=A.pop();if(!E){E=new qx.ui.core.Spacer();E.setUserData("cell.spanning",1);}
;}
;return E;}
...
,__MC:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);if(this._cells.length>0){this._bounds=this._spanManager.getCellBounds(this._cells,G,H);this._spanMap=this._spanManager.computeCellSpanMap(this._cells,G,H,I,J);}
else {this._bounds=[];this._spanMap=[];for(var i=0;i<I;i++){this._spanMap[G+i]=[];}
;}
;}
,__MD:function(){var O=this.getChildren();for(var i=O.length-1;i>=0;i--){var N=O[i];if(N!==this._cellLayer){this._cellProvider.poolCellWidget(N);this._remove(N);}
;}
;for(var i=0,l=this._cells.length;i<l;i++){var M=this._cells[i];var K=this._bounds[i];var L=this._cellProvider.getCellWidget(M.firstRow,M.firstColumn);if(L){L.setUserBounds(K.left,K.top,K.width,K.height);L.setUserData("cell.row",M.firstRow);L.setUserData("cell.column",M.firstColumn);L.setUserData("cell.rowspan",M.lastRow-M.firstRow+1);L.setUserData("cell.colspan",M.lastColumn-M.firstColumn+1);this._add(L);}
;}
;}
,_fullUpdate:function(P,Q,R,S){this.__MC(P,Q,R.length,S.length);this.__MD();this._cellLayer.fullUpdate(P,Q,R,S);}
,_updateLayerWindow:function(T,U,V,W){this.__MC(T,U,V.length,W.length);this.__MD();this._cellLayer.updateLayerWindow(T,U,V,W);}
},destruct:function(){var X=this._getChildren();for(var i=0;i<X.length;i++){X[i].dispose();}
;this._disposeObjects(d,c);this._cellProvider=this.__Ah=this._cells=this._bounds=this._spanMap=null;}
});}
)();
