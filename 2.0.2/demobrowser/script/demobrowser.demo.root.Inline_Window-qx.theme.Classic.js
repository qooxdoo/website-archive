...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline_Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window-qx.theme.Classic.d645ce28dc45.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__BU=r;r.style.overflow=k;r.style.textAlign=g;this.__BV=s||false;this.__BW=t||false;this.__BX();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;var window=qx.dom.Node.getWindow(r);qx.event.Registration.addListener(window,b,this._onWindowResize,this);}
,members:{__BV:false,__BW:false,__BU:null,__BX:function(){if(this.__BV||this.__BW){var u=qx.bom.element.Dimension.getSize(this.__BU);if(this.__BV&&u.width<1){throw new Error("The root element "+this.__BU+" of "+this+" needs a width when its width size should be used!");}
;if(this.__BW){if(u.height<1){throw new Error("The root element "+this.__BU+" of "+this+" needs a height when its height size should be used!");}
;if(u.height>=1&&qx.bom.element.Style.get(this.__BU,"height",3)==""){qx.bom.element.Style.set(this.__BU,"height",u.height+"px");}
;}
;qx.event.Registration.addListener(this.__BU,"resize",this._onResize,this);}
;}
,_createContainerElement:function(){var v=this.__BU;if(this.__BV||this.__BW){var z=document.createElement(h);v.appendChild(z);if((qx.core.Environment.get(c)==d)&&qx.core.Environment.get(n)==6){var y=qx.dom.Node.getBodyElement(v);var x;var B;var A=false;var w=qx.dom.Hierarchy.getAncestors(v);for(var i=0,j=w.length;i<j;i++){x=w[i];if(x!=y){B=qx.bom.element.Style.get(x,p);if(B==a){A=true;break;}
;}
else {break;}
;}
...
,this,0);return C;}
,_onResize:function(e){var D=e.getData();if((D.oldWidth!==D.width)&&this.__BV||(D.oldHeight!==D.height)&&this.__BW){qx.ui.core.queue.Layout.add(this);}
;}
,_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();}
;if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();}
;}
,_computeSizeHint:function(){var I=this.__BV;var F=this.__BW;if(!I||!F){var E=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {E={};}
;var J=qx.bom.element.Dimension;if(I){var H=J.getContentWidth(this.__BU);E.width=H;E.minWidth=H;E.maxWidth=H;}
;if(F){var G=J.getContentHeight(this.__BU);E.height=G;E.minHeight=G;E.maxHeight=G;}
;return E;}
},defer:function(K,L){qx.ui.core.MLayoutHandling.remap(L);}
,destruct:function(){qx.event.Registration.removeListener(this.__BU,b,this._onResize,this);this.__BU=null;}
});}
)();
(function(){var f="resize",d="interval",c="__iG",b="body",a="qx.event.handler.ElementResize";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__dz=g;this.__Cs={};this.__iG=new qx.event.Timer(200);this.__iG.addListener(d,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__Cs:null,__dz:null,__iG:null,canHandleEvent:function(h,i){return h.tagName.toLowerCase()!==b;}
,registerEvent:function(j,k,l){var n=qx.core.ObjectRegistry.toHashCode(j);var m=this.__Cs;if(!m[n]){m[n]={element:j,width:qx.bom.element.Dimension.getWidth(j),height:qx.bom.element.Dimension.getHeight(j)};this.__iG.start();}
;}
,unregisterEvent:function(o,p,q){var s=qx.core.ObjectRegistry.toHashCode(o);var r=this.__Cs;if(r[s]){delete r[s];if(qx.lang.Object.isEmpty(r)){this.__iG.stop();}
;}
;}
,_onInterval:function(e){var u=this.__Cs;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,f,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__dz=this.__Cs=null;this._disposeObjects(c);}
