...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_Scroller-qx.theme.Indigo.0a65e5db41bd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="demobrowser.demo.test.DummyTable",d="main",c="demobrowser.demo.test.Table_Scroller",b="#FFE",a="table";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var f=new demobrowser.demo.test.DummyTable();this.getRoot().add(f,{left:10,top:10});}
}});qx.Class.define(e,{extend:qx.ui.container.Composite,include:[demobrowser.demo.table.MUtil],construct:function(){qx.ui.container.Composite.call(this,new qx.ui.layout.Canvas());this.setAppearance(a);this.set({decorator:d,backgroundColor:b,width:600,height:400});var h=new qx.ui.table.pane.Scroller(this.getTableMock());this.add(h,{edge:0});var g=new qx.ui.table.pane.Model(this.getColumnModelMock());h.setTablePaneModel(g);h._onPaneModelChanged();h.getTablePane().setVisibleRowCount(20);h.getTablePane()._updateAllRows();}
});}
)();
