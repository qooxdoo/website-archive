...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ComboBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ComboBox-qx.theme.Classic.634c9e59c2ef.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u=" = ",t="... &gt; (as literal HTML entity)",s="... &gt; (as Richtext)",r="ChangeValue: ",q="Wide, long list",p="<u>Underlined Text</u>",o="<b>Bold Text</b>",n="'s Icon",m="'s Item",l="With icons",d="Default",k="changeValue",h="2^ ",c="<i>Italic Text</i>",b="HTML entities: &laquo; &lt; &amp; &gt; &raquo;",g="icon/16/places/folder.png",f="With HTML (rich) text",j="demobrowser.demo.widget.ComboBox",a="bold";qx.Class.define(j,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this._createDefaultExample();this._createIconExample();this._createWideExample();this._createHtmlExample();}
,_createDefaultExample:function(){var x=new qx.ui.basic.Label(d);x.setFont(a);this.getRoot().add(x,{left:20,top:20});var v=new qx.ui.form.ComboBox();for(var i=1;i<31;i++){var w=new qx.ui.form.ListItem(h+i+u+Math.pow(2,i));v.add(w);}
;v.addListener(k,function(e){this.debug(r+e.getData());}
);this.getRoot().add(v,{left:20,top:40});}
,_createIconExample:function(){var A=new qx.ui.basic.Label(l);A.setFont(a);this.getRoot().add(A,{left:160,top:20});var y=new qx.ui.form.ComboBox();for(var i=1;i<31;i++){var z=new qx.ui.form.ListItem(i+n,g);y.add(z);}
;this.getRoot().add(y,{left:160,top:40});}
,_createHtmlExample:function(){var E=new qx.ui.basic.Label(f);E.setFont(a);this.getRoot().add(E,{left:300,top:20});var B=new qx.ui.form.ComboBox().set({width:200});var C=[t,s,o,p,c,b];for(var i=0;i<C.length;i++){var D=new qx.ui.form.ListItem(C[i]);if(i>0){D.setRich(true);}
;B.add(D);}
;this.getRoot().add(B,{left:300,top:40});}
,_createWideExample:function(){var H=new qx.ui.basic.Label(q);H.setFont(a);this.getRoot().add(H,{left:20,top:280});var F=new qx.ui.form.ComboBox();F.setWidth(300);for(var i=1;i<101;i++){var G=new qx.ui.form.ListItem(i+m);F.add(G);}
;F.setValue(F.getChildrenContainer().getSelectables()[0].getLabel());this.getRoot().add(F,{left:20,top:300});}
}});}
)();
