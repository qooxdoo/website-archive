...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ScrollContainer_EdgeCaseHeight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ScrollContainer_EdgeCaseHeight-qx.theme.Simple.4c8569aa44c4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="ScrollbarX:",s="ScrollbarY:",r="Toggle content",q="blue",p="black",o="auto",n="demobrowser.demo.test.ScrollContainer_EdgeCaseHeight",m="Off",l="white",k="off",d="On",j="Content size: 300x300",h="Toggle pane",c="solid",b="Auto",g="on",f="changeSelection",i="execute",a="value";qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var v=new qx.ui.container.Scroll();v.set({width:200,height:300});this.getRoot().add(v,{left:10,top:10});v.add(this.generateBox());var x=new qx.ui.form.Button(h);var A=true;x.addListener(i,function(){v.setWidth(A?300:200);A=!A;}
);this.getRoot().add(x,{left:330,top:20});var w=new qx.ui.form.Button(r);var z=true;w.addListener(i,function(){v.getChildren()[0].setWidth(z?100:300);z=!z;}
);this.getRoot().add(w,{left:430,top:20});var y=this.generateScrollbarConfig(t,100);var u=this.generateScrollbarConfig(s,120);y.addListener(f,function(e){v.setScrollbarX(e.getData()[0].getUserData(a));}
);u.addListener(f,function(e){v.setScrollbarY(e.getData()[0].getUserData(a));}
);}
,generateScrollbarConfig:function(B,top){var F=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));var B=new qx.ui.basic.Label(B);B.setMarginRight(20);var C=new qx.ui.form.RadioButton(b);var E=new qx.ui.form.RadioButton(d);var D=new qx.ui.form.RadioButton(m);C.setUserData(a,o);E.setUserData(a,g);D.setUserData(a,k);C.setValue(true);var G=new qx.ui.form.RadioGroup(C,E,D);F.add(B);F.add(C);F.add(E);F.add(D);this.getRoot().add(F,{left:330,top:top});return G;}
,generateBox:function(){var H=new qx.ui.basic.Label(j).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:q,textColor:l,padding:10,decorator:new qx.ui.decoration.Single(4,c,p)});return H;}
}});}
)();
