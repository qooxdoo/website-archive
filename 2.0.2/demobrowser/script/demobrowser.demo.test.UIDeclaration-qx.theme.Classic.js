...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration-qx.theme.Classic.20d12aa242e1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,addFromDefinition:function(F){var G=this.getRoot();this.__Bo(G,F);}
,__Bo:function(H,I){var J=new I.clazz();var N=qx.lang.Object.clone(I);delete N.clazz;delete N.layout;delete N.children;delete N.id;delete N.listeners;J.set(N);if(I.id!=null){this[I.id]=J;}
;if(I.layout!=null){var K=new I.layout.clazz();var N=qx.lang.Object.clone(I.layout);delete N.clazz;K.set(N);J.setLayout(K);}
;var M=I.children;if(M!=null){for(var i=0;i<M.length;i++){if(J instanceof qx.ui.form.Form){this.__Rc(J,M[i]);}
else {this.__Bo(J,M[i]);}
;}
;}
...
;}
;}
,__Rc:function(O,P){if(P.type===q){O.addGroupHeader(P.label);return;}
