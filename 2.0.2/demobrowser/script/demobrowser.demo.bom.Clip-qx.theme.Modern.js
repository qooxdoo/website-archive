...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Clip","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Clip-qx.theme.Modern.fa441a58d00b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="Setting to: 20,null  120,40",k="Setting to: 20,20  120,40",j="Setting to: null,20  120,40",i="Clip init: ",h="demobrowser.demo.bom.Clip",g="Resetting",f="Setting to: 20,20  null,40",e="Setting to: 20,20  120,null",d="Clip after: ",c="test1",a="  ",b=",";qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);window.APPLICATION=this;var m=document.getElementById(c);var n=qx.bom.element.Clip.get(m)||{};qx.log.Logger.debug(i+n.left+b+n.top+a+n.width+b+n.height);}
,set0:function(){var o=document.getElementById(c);qx.log.Logger.debug(k);qx.bom.element.Clip.set(o,{left:20,top:20,width:120,height:40});var p=qx.bom.element.Clip.get(o)||{};qx.log.Logger.debug(d+p.left+b+p.top+a+p.width+b+p.height);}
,set1:function(){var q=document.getElementById(c);qx.log.Logger.debug(f);qx.bom.element.Clip.set(q,{left:20,top:20,height:40});var r=qx.bom.element.Clip.get(q)||{};qx.log.Logger.debug(d+r.left+b+r.top+a+r.width+b+r.height);}
,set2:function(){var s=document.getElementById(c);qx.log.Logger.debug(e);qx.bom.element.Clip.set(s,{left:20,top:20,width:120});var t=qx.bom.element.Clip.get(s)||{};qx.log.Logger.debug(d+t.left+b+t.top+a+t.width+b+t.height);}
,set3:function(){var u=document.getElementById(c);qx.log.Logger.debug(j);qx.bom.element.Clip.set(u,{top:20,width:120,height:40});var v=qx.bom.element.Clip.get(u)||{};qx.log.Logger.debug(d+v.left+b+v.top+a+v.width+b+v.height);}
,set4:function(){var w=document.getElementById(c);qx.log.Logger.debug(l);qx.bom.element.Clip.set(w,{left:20,width:120,height:40});var x=qx.bom.element.Clip.get(w)||{};qx.log.Logger.debug(d+x.left+b+x.top+a+x.width+b+x.height);}
,reset:function(){var y=document.getElementById(c);qx.log.Logger.debug(g);qx.bom.element.Clip.reset(y);var z=qx.bom.element.Clip.get(y)||{};qx.log.Logger.debug(d+z.left+b+z.top+a+z.width+b+z.height);}
}});}
)();
