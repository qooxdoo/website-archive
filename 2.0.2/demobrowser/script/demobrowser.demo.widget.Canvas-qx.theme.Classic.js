...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas-qx.theme.Classic.e9208fbc4858.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="resize",h="__JU",g="_applyCanvasWidth",f="Boolean",d="_applyCanvasHeight",c="qx.ui.embed.Canvas",b="qx.event.type.Data",a="Integer";qx.Class.define(c,{extend:qx.ui.core.Widget,construct:function(j,k){qx.ui.core.Widget.call(this);this.__JU=new qx.util.DeferredCall(this.__JV,this);this.addListener(i,this._onResize,this);if(j!==undefined){this.setCanvasWidth(j);}
;if(k!==undefined){this.setCanvasHeight(k);}
;}
,events:{"redraw":b},properties:{syncDimension:{check:f,init:false},canvasWidth:{check:a,init:300,apply:g},canvasHeight:{check:a,init:150,apply:d}},members:{__JU:null,_createContentElement:function(){return new qx.html.Canvas();}
,__JV:function(){var m=this.getContentElement();var o=m.getHeight();var l=m.getWidth();var n=m.getContext2d();this._draw(l,o,n);this.fireNonBubblingEvent("redraw",qx.event.type.Data,[{width:l,height:o,context:n}]);}
,_applyCanvasWidth:function(p,q){this.getContentElement().setWidth(p);this.__JU.schedule();}
,_applyCanvasHeight:function(r,s){this.getContentElement().setHeight(r);this.__JU.schedule();}
,update:function(){this.__JU.schedule();}
...
(function(){var c="2d",b="qx.html.Canvas",a="canvas";qx.Class.define(b,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__JW=document.createElement(a);}
,members:{__JW:null,_createDomElement:function(){return this.__JW;}
,getCanvas:function(){return this.__JW;}
,setWidth:function(f){this.__JW.width=f;}
,getWidth:function(){return this.__JW.width;}
,setHeight:function(g){this.__JW.height=g;}
,getHeight:function(){return this.__JW.height;}
,getContext2d:function(){return this.__JW.getContext(c);}
