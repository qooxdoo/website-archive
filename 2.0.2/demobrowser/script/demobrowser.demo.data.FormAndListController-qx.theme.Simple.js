...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormAndListController-qx.theme.Simple.ae59a6281f9f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="changeModel",n="qx.core.Object",m="qx.debug",l="_applyTarget",k="qx.data.controller.Form",j="changeTarget",h=" of ",g="Could not bind property ",f=".",e="No target is set.",b="qx.ui.form.Form",d="_applyModel",c="modelSelection[0]",a="value";qx.Class.define(k,{extend:qx.core.Object,construct:function(p,q,r){qx.core.Object.call(this);this._selfUpdate=!!r;this.__Lp={};if(p!=null){this.setModel(p);}
;if(q!=null){this.setTarget(q);}
;}
,properties:{model:{check:n,apply:d,event:o,nullable:true,dereference:true},target:{check:b,apply:l,event:j,nullable:true,init:null,dereference:true}},members:{__Lq:null,__Lp:null,addBindingOptions:function(name,s,t){this.__Lp[name]=[s,t];if(this.getModel()==null||this.getTarget()==null){return;}
;var u=this.getTarget().getItems()[name];var v=this.__Lt(u)?c:a;this.__Lq.removeTarget(u,v,name);this.__Lq.addTarget(u,v,name,!this._selfUpdate,s,t);}
...
;if(this.__Lp[name]&&this.__Lp[name][1]){x=this.__Lp[name][1].converter(x);}
;E[B[i]]=x;}
else {if(!E[B[i]]){E[B[i]]={};}
;E=E[B[i]];}
;}
...
;var F=this.getTarget().getItems();for(var name in F){var I=F[name];var H=this.__Lt(I)?c:a;var G=this.__Lp[name];G=G&&this.__Lp[name][1];qx.data.SingleValueBinding.updateTarget(I,H,this.getModel(),name,G);}
;}
,_applyTarget:function(J,K){if(K!=null){this.__Ls(K);}
;if(this.getModel()==null){return;}
;if(J!=null){this.__Lr();}
;}
,_applyModel:function(L,M){if(this.__Lq!=null){var N=this.getTarget().getItems();for(var name in N){var P=N[name];var O=this.__Lt(P)?c:a;this.__Lq.removeTarget(P,O,name);}
;}
;if(this.__Lq!=null){this.__Lq.setModel(L);}
;if(this.getTarget()==null){return;}
;if(L!=null){this.__Lr();}
;}
,__Lr:function(){if(this.__Lq==null){this.__Lq=new qx.data.controller.Object(this.getModel());}
;var Q=this.getTarget().getItems();for(var name in Q){var T=Q[name];var R=this.__Lt(T)?c:a;var S=this.__Lp[name];try{if(S==null){this.__Lq.addTarget(T,R,name,!this._selfUpdate);}
else {this.__Lq.addTarget(T,R,name,!this._selfUpdate,S[0],S[1]);}
;}
catch(U){if(qx.core.Environment.get(m)){this.warn(g+name+h+this.getModel());}
;}
;}
;this.getTarget().redefineResetter();}
,__Ls:function(V){if(this.__Lq==null){return;}
;var W=V.getItems();for(var name in W){var Y=W[name];var X=this.__Lt(Y)?c:a;this.__Lq.removeTarget(Y,X,name);}
;}
,__Lt:function(ba){return qx.Class.hasInterface(ba.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(ba.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__Lq){this.__Lq.dispose();}
;}
});}
)();
...
;return br;}
;;return C;}
,startDisposeProfiling:qx.core.Environment.select(y,{"true":function(){this.disposeProfilingActive=true;this.__PV=qx.core.ObjectRegistry.getNextHash();}
,"default":qx.lang.Function.empty}),stopDisposeProfiling:qx.core.Environment.select(y,{"true":function(bt){if(!this.__PV){qx.log.Logger.error(K+this.classname+E);return [];}
;this.disposeProfilingActive=false;var bv=[];while(!qx.ui.core.queue.Dispose.isEmpty()){qx.ui.core.queue.Dispose.flush();}
;var bw=qx.core.ObjectRegistry.getNextHash();var by=qx.core.ObjectRegistry.getPostId();var bz=qx.core.ObjectRegistry.getStackTraces();for(var bu=this.__PV;bu<bw;bu++){var bx=qx.core.ObjectRegistry.fromHashCode(bu+by);if(bx&&bx.isDisposed&&!bx.isDisposed()){if(bt&&typeof bt==g&&!bt(bx)){continue;}
