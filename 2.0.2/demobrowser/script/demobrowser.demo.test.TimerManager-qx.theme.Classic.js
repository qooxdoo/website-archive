...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager-qx.theme.Classic.334d5ce3d7bf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="__Hx",e="One-shot 1-second timer: ",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";qx.Class.define(d,{extend:qx.application.Standalone,members:{__Hx:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();i.start(function(j,k){this.__QU(c+k);}
,5000,this,null,0);i.start(function(l,m){this.__QU(e+m);}
,0,this,null,1000);i.start(function(n,o){this.__QU(g+o);if(++n.count==3){this.__QU(h);i.stop(o);}
;}
,2000,this,{count:0},2000);}
,__QU:function(p){p=Date.parse(new Date)+" "+p+"\n";this.__Hx.setValue(this.__Hx.getValue()+p);}
...
,this);var t=new qx.ui.form.TextArea();t.set({width:400,height:300});this.__Hx=t;q.add(t);q.add(s);this.getRoot().add(q,{left:20,top:10});}
},destruct:function(){this._disposeObjects(f);}
});}
)();
