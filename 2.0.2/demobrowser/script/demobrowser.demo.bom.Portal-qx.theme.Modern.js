...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal-qx.theme.Modern.abbcf02415e0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="groupBoxes",h="demobrowser.demo.bom.portal.box.Manager",g="boxData",f="qx.event.type.Event",e="boxes",d="demobrowser.demo.bom.portal.box.Box",c="_applyActiveBox",b="loaded",a="singleton";qx.Class.define(h,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Pg=[];this.__Ph=[];this.__Pi={};}
,statics:{dataKeyRoot:g,dataKeyGroupBoxes:m,dataKeyBoxes:e},events:{"loaded":f},properties:{activeBox:{init:null,check:d,apply:c}},members:{__Pg:null,__Ph:null,__Pi:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);}
;n.setActive(true);}
...
,__bf:function(p){var t,w,u,v,x,p;var q=p[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var s=p[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in q){t=q[w];u=t.boxes;w=t.id;v={id:w,element:document.getElementById(w)};this.__Ph.push(v);this.__Pi[w]=[];for(var k=0,l=u.length;k<l;k++){p=s[u[k]];var r=document.getElementById(p.id);var x=new demobrowser.demo.bom.portal.box.Box(p,r,null,w);this.__Pg.push(x);this.__Pi[w].push(x);}
;}
;}
,getBoxes:function(){return this.__Pg;}
,getGroupBoxes:function(){return this.__Ph;}
,updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());qx.lang.Array.remove(this.__Pi[z],A);qx.lang.Array.insertAt(this.__Pi[y],A,B);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__Ph.length,D;i<j;i++){D=this.__Pi[this.__Ph[i].id];for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__Ph[i];}
;}
;}
;return null;}
...
(function(){var s="click",r="1px solid #444444",q="height",p="position",o="zIndex",n="_applyActive",m="width",l="box_content",k=" It does contain no UI widget code at all.",j="relative",c="demobrowser.demo.bom.portal.box.Box",i="1px solid orange",g="This is a demo application showing the low-level capabilities.",b="div",a="String",f="<br/><br/>",d="border",h="Boolean";qx.Class.define(c,{extend:qx.core.Object,construct:function(t,u,v,w){qx.core.Object.call(this);this.__Pj=t;this.__bV=t.id;if(u!=null){qx.bom.element.Style.set(u,m,t.width);qx.bom.element.Style.set(u,q,t.height);this.__Pm(u,v);}
;this.setElement(u);this.setGroupBoxId(w);this.__Pk=null;this.__Pl=null;if(t.resizable){this.setResizable(true);var x={minWidth:parseInt(t.minWidth),minHeight:parseInt(t.minHeight),maxWidth:parseInt(t.maxWidth),maxHeight:parseInt(t.maxHeight),handles:t.resizeHandles};this.__Pk=new demobrowser.demo.bom.portal.box.Resizable(this,x);}
;if(t.draggable){this.setDraggable(true);this.__Pl=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__Pn();}
,properties:{element:{init:null},groupBoxId:{init:null,check:a},active:{check:h,init:false,apply:n},resizable:{check:h,init:false},draggable:{check:h,init:false}},members:{__bV:null,__Pj:null,__Pl:null,__Pk:null,_applyActive:function(y,z){if(y){qx.bom.element.Style.set(this.getElement(),d,i);}
else {qx.bom.element.Style.set(this.getElement(),d,r);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__Pj;}
,getDraggableComponent:function(){return this.__Pl;}
,getResizableComponent:function(){return this.__Pk;}
,__Pm:function(A,B){if(B){for(var C in B){qx.bom.element.Style.set(C,B[C]);}
;}
;qx.bom.element.Style.set(A,p,j);qx.bom.element.Style.set(A,o,0);qx.bom.Element.addListener(A,s,this.__Po,this,true);}
,__Pn:function(){var E=g+k;E=E+f+E+f+E;var D=qx.dom.Element.create(b,{"class":l});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__Po:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__Pj=this.__Pk=this.__Pl=null;}
});}
)();
...
(function(){var n="mouseup",m="mousedown",l="_",k="div",j="demobrowser.demo.bom.portal.box.Resizable",i="Handle",h="mouseover",g="mouseout",f="visible",d="mousemove",a="orientation",c="hidden",b="visibility";qx.Class.define(j,{extend:qx.core.Object,construct:function(o,p){qx.core.Object.call(this);this.__Pp=o;this.__dJ=this.__Pp.getElement();this.__Pq={};this.__Pr=false;this.__Ps={orientation:null,lastCoord:{left:null,top:null}};this.__Pt={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__Pt){if(p[name]){this.__Pt[name]=p[name];}
;}
;this.__Pm();}
,members:{__Ps:null,__Pp:null,__dJ:null,__Pq:null,__Pt:null,__Pr:false,getBox:function(){return this.__Pp;}
,__Pm:function(){switch(this.__Pt.handles){case 1:this.__Pq.east=null;break;case 2:this.__Pq.south=null;break;case 3:this.__Pq.south=null;this.__Pq.southeast=null;this.__Pq.east=null;break;};for(var r in this.__Pq){var q=this.__Pq[r]=qx.dom.Element.create(k);qx.bom.element.Attribute.set(q,a,r);qx.dom.Element.insertEnd(q,this.__dJ);if(this.__dJ.id){q.id=this.__dJ.id+l+r;}
;this.__Pu(r);this.__Pv(r);}
;}
,__Pu:function(s){qx.bom.element.Class.add(this.__Pq[s],s+i);qx.bom.element.Style.set(this.__Pq[s],b,this.__Pt.autoHide?c:f);}
,__Pv:function(t){var v=qx.event.Registration;var u=this.__Pq[t];v.addListener(u,m,this.__Py,this);v.addListener(document,n,this.__Pz,this);if(this.__Pt.autoHide){v.addListener(this.__Pp.getElement(),h,this.__Pw,this);v.addListener(this.__Pp.getElement(),g,this.__Px,this);}
;}
,__Pw:function(e){for(var w in this.__Pq){qx.bom.element.Style.set(this.__Pq[w],b,f);}
;}
,__Px:function(e){if(!this.__Pr){for(var x in this.__Pq){qx.bom.element.Style.set(this.__Pq[x],b,c);}
;}
;}
,__Py:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,d,this.__PA,this,true);this.__Pr=true;var y=e.getTarget();this.__Ps.orientation=qx.bom.element.Attribute.get(y,a);this.__Ps.lastCoord.left=e.getDocumentLeft();this.__Ps.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__dJ);}
;}
,__Pz:function(e){e.stopPropagation();if(this.__Pr){qx.event.Registration.removeListener(document,d,this.__PA,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__dJ);if(this.__Pt.autoHide){for(var z in this.__Pq){qx.bom.element.Style.set(this.__Pq[z],b,c);}
;}
;this.__Pr=false;qx.bom.Selection.clear(document.body);}
;}
,__PA:function(e){e.stopPropagation();if(this.__Pr){var A={left:null,top:null};switch(this.__Ps.orientation){case "south":A.top=e.getDocumentTop();break;case "southeast":A.top=e.getDocumentTop();A.left=e.getDocumentLeft();break;case "east":A.left=e.getDocumentLeft();break;};this.__PB(A,this.__Ps.lastCoord);this.__Ps.lastCoord.left=e.getDocumentLeft();this.__Ps.lastCoord.top=e.getDocumentTop();}
;}
,__PB:function(B,C){var J=qx.bom.element.Dimension;var G=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Pp.getId());var I=J.getContentSize(G.element);if(B.left){var F=B.left-C.left;if(F!==0){var E=J.getContentWidth(this.__dJ)+F;var H=J.getWidth(this.__dJ)+F;if((this.__Pt.minWidth==null||E>this.__Pt.minWidth)&&(this.__Pt.maxWidth==null||E<=this.__Pt.maxWidth)){if(I.width>=H){qx.bom.element.Style.set(this.__dJ,"width",E+'px');this.__Pp.getData().width=E;}
;}
;}
;}
;if(B.top){var F=B.top-C.top;if(F!==0){var D=J.getContentHeight(this.__dJ)+F;if((this.__Pt.minHeight==null||D>this.__Pt.minHeight)&&(this.__Pt.maxHeight==null||D<=this.__Pt.maxHeight)){qx.bom.element.Style.set(this.__dJ,"height",D+"px");}
;}
;}
;}
},destruct:function(){if(this.__Pt.autoHide){qx.event.Registration.removeListener(this.__Pp.getElement(),h,this.__Pw,this);qx.event.Registration.removeListener(this.__Pp.getElement(),g,this.__Px,this);}
;this.__Pp=this.__Pt=this.__dJ=this.__Pq=null;this.__Ps=null;}
});}
)();
...
(function(){var c="auto",b="demobrowser.demo.bom.portal.box.Util",a="zIndex";qx.Class.define(b,{statics:{__PC:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,a);e=e==c?0:e;qx.bom.element.Style.set(d,a,e+this.__PC);}
,sendToBack:function(f){var g=qx.bom.element.Style.get(f,a);qx.bom.element.Style.set(f,a,g-this.__PC);}
}});}
)();
...
(function(){var k="mouseup",j="mousedown",i="mouseover",h="drag",g="dragend",f="move",d="demobrowser.demo.bom.portal.box.Draggable",c="cursor",b="mousemove",a="dragstart";qx.Class.define(d,{extend:qx.core.Object,construct:function(l){qx.core.Object.call(this);this.__Pp=l;this.__dJ=l.getElement();this.__PD=null;this.__PE=null;this.__Pm();}
,members:{__Pp:null,__dJ:null,__PD:null,__PE:null,getBox:function(){return this.__Pp;}
,getElement:function(){return this.__dJ;}
,__Pm:function(){this.__PF();this.__Pv();}
,__PF:function(){this.__PD=qx.dom.Element.create("div");qx.bom.element.Class.add(this.__PD,"dragHandle");qx.dom.Element.insertBegin(this.__PD,this.__dJ);}
,__Pv:function(){qx.bom.Element.addListener(this.__PD,j,this.__nC,this);qx.bom.Element.addListener(this.__PD,i,function(e){qx.bom.element.Style.set(this,c,f);}
,this.__PD);qx.bom.Element.addListener(this.__PD,a,this.__ul,this);qx.bom.Element.addListener(this.__PD,g,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__PD,h,this.__PI,this);}
,__nC:function(e){if(e.isLeftPressed()){this.__PE={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__dJ),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__dJ)};qx.bom.Element.addListener(document.body,k,this.__PH,this,true);this.__PG();qx.event.Registration.fireEvent(this.__PD,a,qx.event.type.Event);}
;}
,__PG:qx.core.Environment.select("engine.name",{"mshtml":function(){var n=this;var m=qx.lang.Function.bind(this.__PH,n);document.getElementsByTagName("html")[0].onmouseleave=m;}
,"default":qx.lang.Function.empty}),__PH:function(e){try{e.stopPropagation();}
catch(o){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,"mousemove",this.__PI,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,"mouseup",this.__PH,this,true);}
,__ul:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__Pp);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__Pp);qx.event.Registration.addListener(document.body,b,this.__PI,this,true);}
,__PI:function(e){e.stopPropagation();var p=e.getDocumentLeft()-this.__PE.left;var top=e.getDocumentTop()-this.__PE.top;qx.event.Timer.once(function(){this.checkGroupBox(p,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,p);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__Pp=this.__PD=this.__dJ=this.__PE=null;}
});}
)();
(function(){var m="Boolean",l="left",k="demobrowser.demo.bom.portal.dragdrop.Manager",h="end",g="border",f="top",d="demobrowser.demo.bom.portal.box.Box",c="ease-out",b="singleton",a="px";qx.Class.define(k,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__PJ={top:null,height:null};this.__PK={top:0,left:0};}
,properties:{activeBox:{check:d,init:null,nullable:true},sessionActive:{check:m,init:false}},members:{__PJ:null,__PL:null,__PM:false,__PK:null,__PN:null,__PO:null,startSession:function(n){this.setSessionActive(true);this.setActiveBox(n);this.__PL=n.getGroupBoxId();this.__PP();if(this.__PN==null){this.__PN={};var o=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=o.length;i<j;i++){this.__PN[o[i].element.id]={left:qx.bom.element.Location.getLeft(o[i].element),right:qx.bom.element.Location.getLeft(o[i].element)+qx.bom.element.Dimension.getWidth(o[i].element)};}
;}
;}
,__PP:function(){if(!this.__PO){this.__PO=qx.dom.Element.create("div");}
;var r=this.getActiveBox().getElement();var p=qx.bom.element.Dimension.getContentSize(r);this.__PQ(r,this.__PO);qx.bom.element.Class.add(this.__PO,qx.bom.element.Class.get(r));var q="opacity:0.5;margin:0;position:absolute;"+"top:"+qx.bom.element.Location.getTop(r)+"px;"+"left:"+qx.bom.element.Location.getLeft(r)+"px;"+"width:"+p.width+"px;"+"height:"+p.height+"px";qx.bom.element.Style.setCss(this.__PO,q);qx.bom.element.Style.set(r,"border","1px dashed red");qx.dom.Node.getBodyElement(r).appendChild(this.__PO);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__PO);}
,__PQ:function(s,t){while(s.firstChild){t.appendChild(s.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var y=this.getActiveBox();var v=y.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(y.getGroupBoxId(),this.__PL,y);y.setGroupBoxId(this.__PL);var x={left:qx.bom.element.Location.getLeft(this.__PO)+a,top:qx.bom.element.Location.getTop(this.__PO)+a};var w={left:qx.bom.element.Location.getLeft(v)+a,top:qx.bom.element.Location.getTop(v)+a};var z={timing:c,duration:300,keep:100,keyFrames:{'0':x,'100':w}};var u=qx.bom.element.Animation.animate(this.__PO,z);u.addListener(h,function(){this.__PQ(this.__PO,v);qx.bom.element.Style.reset(v,g);this.__PO.parentNode.removeChild(this.__PO);if(y.isActive()){y._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(y);}
;}
,this);}
,onDragMove:function(top,A){if(this.__PK.left!=A){qx.bom.element.Style.set(this.__PO,l,A+a);}
;if(this.__PK.top!=top){qx.bom.element.Style.set(this.__PO,f,top+a);}
;var B=this.getActiveBox().getElement();if(this.__PJ.top==null){this.__PJ.top=qx.bom.element.Location.getTop(B);}
;if(this.__PJ.height==null){this.__PJ.height=qx.bom.element.Dimension.getHeight(B);}
;if(this.__PM==false&&top>=this.__PJ.top&&top<=(this.__PJ.top+this.__PJ.height)){return;}
;var C;if(this.__PM){C=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__PL));while(C!=null){if(this.__PR(true,top,B,C)){this.__PM=false;return;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {C=B;}
;if(top-this.__PK.top>0){C=qx.dom.Hierarchy.getNextElementSibling(C);while(C!=null){if(C){if(this.__PR(true,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {var C=qx.dom.Hierarchy.getPreviousElementSibling(C);while(C!=null){if(C){if(this.__PR(false,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getPreviousElementSibling(C);}
;}
;this.__PK.left=A;this.__PK.top=top;}
,__PR:function(D,top,E,F){var G=qx.bom.element.Location.getTop(F);var I=parseInt(qx.bom.element.Style.get(F,"paddingTop"));var J=parseInt(qx.bom.element.Style.get(F,"paddingBottom"));var H=qx.bom.element.Dimension.getContentHeight(F)+J+I;var K;if(D){if(top>=(G+(H/3))){K=qx.dom.Hierarchy.getNextElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertAfter(E,F);this.__PJ.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
else {if(top<=(G+H*2/3)){K=qx.dom.Hierarchy.getPreviousElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertBefore(E,F);this.__PJ.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
;return false;}
,checkGroupBox:function(L,M){if(this.__PN[this.__PL].left<=L&&this.__PN[this.__PL].right>=L){return;}
;for(var N in this.__PN){if(N!=this.__PL){if(this.__PN[N].left<=L+M&&this.__PN[N].right>=L){this.__PL=N;this.__PM=true;return;}
;}
;}
;}
},destruct:function(){this.__PJ=this.__PK=this.__PL=null;this.__PS=this.__PO=this.__PN=null;}
});}
)();
