...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Modern.c1c3f26f22bc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__LC:function(Q,top,R,S,T){var U=["<div style='position:absolute;height:20px;width:",R,"px;top:",top,"px'>"];S.createDataCellHtml(T,U);U.push("</div>");Q.innerHTML+=U.join("");}
,testDefaultRenderer:function(V){var W=100;var Y={value:[null,D,32,new Date()],styleLeft:[0],styleWidth:[W],styleHeight:[20],style:[C]};var X=this._getNewTableDiv(W);var top=0;qx.util.Permutation.permute(Y,function(ba){this.__LC(X,top,W,V,ba);top+=20;}
,this);}
,testBooleanRenderer:function(){var be=70;var bd=30;var bf=new qx.ui.table.cellrenderer.Boolean();var bb={value:[null,true,false],styleLeft:[0],styleWidth:[be],styleHeight:[bd],style:[C]};var bc=this._getNewTableDiv(be);var top=0;qx.util.Permutation.permute(bb,function(bg){this.__LC(bc,top,be,bf,bg);top+=bd;}
,this);bf.setIconFalse(l);bf.setIconTrue(m);qx.util.Permutation.permute(bb,function(bh){this.__LC(bc,top,be,bf,bh);top+=bd;}
,this);}
,testDateRenderer:function(){var bl=180;var bm=new qx.ui.table.cellrenderer.Date();var bo={value:new Date(),styleLeft:[0],styleWidth:[bl],styleHeight:[20],style:[C]};var bk=qx.util.format.DateFormat;var bn=[bk.getDateTimeInstance(),bk.getDateInstance()];var bi=this._getNewTableDiv(bl);var top=0;for(var i=0;i<bn.length;i++){var bj=bn[i];bm.setDateFormat(bj);this.__LC(bi,top,bl,bm,bo);top+=20;}
;}
,testNumberRenderer:function(){var bt=new qx.ui.table.cellrenderer.Number();var bs=100;var bv={value:Math.PI,styleLeft:[0],styleWidth:[bs],styleHeight:[20],style:[C]};var br=qx.util.format.NumberFormat;var bu=[new br().set({maximumFractionDigits:0}),new br().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:e})];var bp=this._getNewTableDiv(bs);var top=0;for(var i=0;i<bu.length;i++){var bq=bu[i];bt.setNumberFormat(bq);this.__LC(bp,top,bs,bt,bv);top+=20;}
;}
,testImageRenderer:function(){var by=new qx.ui.table.cellrenderer.Image();var bw=50;var bz={value:[null,y,r,K,h,f],styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[C],tooltip:[C,n]};var bx=this._getNewTableDiv(bw);var top=0;qx.util.Permutation.permute(bz,function(bA){this.__LC(bx,top,bw,by,bA);top+=20;}
,this);}
,testStringRenderer:function(){var bF=new qx.ui.table.cellrenderer.String();var bE=100;var bD=20;var bB={value:[null,z,B],styleLeft:[0],styleWidth:[bE],styleHeight:[bD],style:[C]};var bC=this._getNewTableDiv(bE);var top=0;qx.util.Permutation.permute(bB,function(bG){this.__LC(bC,top,bE,bF,bG);top+=20;}
,this);}
,testPasswordRenderer:function(){var bL=new qx.ui.table.cellrenderer.Password();var bK=100;var bJ=20;var bH={value:[null,z,B],styleLeft:[0],styleWidth:[bK],styleHeight:[bJ],style:[C]};var bI=this._getNewTableDiv(bK);var top=0;qx.util.Permutation.permute(bH,function(bM){this.__LC(bI,top,bK,bL,bM);top+=20;}
,this);}
,testHtmlRenderer:function(){var bR=new qx.ui.table.cellrenderer.Html();var bQ=100;var bP=50;var bN={value:[null,E,H,a],styleLeft:[0],styleWidth:[bQ],styleHeight:[bP],style:[C]};var bO=this._getNewTableDiv(bQ);var top=0;qx.util.Permutation.permute(bN,function(bS){this.__LC(bO,top,bQ,bR,bS);top+=20;}
,this);}
,testConditionalRenderer:function(){var bX=new qx.ui.table.cellrenderer.Conditional();bX.addNumericCondition(M,0,null,o,null,null);bX.addNumericCondition(u,100,t,null,null,null);bX.addBetweenCondition(N,0,2,null,null,null,v,null);bX.addRegex(G,null,null,v,c);var bW=100;var bV=20;var bT={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bW],table:[this.tableMock],styleHeight:[bV],style:[C]};var bU=this._getNewTableDiv(bW);var top=0;qx.util.Permutation.permute(bT,function(bY){this.__LC(bU,top,bW,bX,bY);top+=20;}
,this);}
...
);var cd=100;var cc=20;var ca={value:[null,D,new Date(),30,y,false],styleLeft:[0],styleWidth:[cd],styleHeight:[cc],table:[this.tableMock],style:[C]};var cb=this._getNewTableDiv(cd);var top=0;qx.util.Permutation.permute(ca,function(ci){this.__LC(cb,top,cd,ce,ci);top+=20;}
,this);}
,testReplaceRenderer:function(){var cn=new qx.ui.table.cellrenderer.Replace();cn.setReplaceMap({'1':x,'2':L,'3':j});cn.addReversedReplaceMap();var cm=100;var cl=20;var cj={value:[1,2,3],styleLeft:[0],styleWidth:[cm],table:[this.tableMock],styleHeight:[cl],style:[C]};var ck=this._getNewTableDiv(cm);var top=0;qx.util.Permutation.permute(cj,function(co){this.__LC(ck,top,cm,cn,co);top+=20;}
,this);}
...
,init:l}},members:{__qn:16,__qo:16,__qp:null,_insetY:2,_identifyImage:function(B){throw new Error(g);}
,_getImageInfos:function(C){var D=this._identifyImage(C);if(D==null||typeof D==f){D={url:D,tooltip:null};}
;if(!D.imageWidth||!D.imageHeight){var E=this.__qq(D.url);D.imageWidth=E.width;D.imageHeight=E.height;}
;D.width=D.imageWidth;D.height=D.imageHeight;return D;}
,__qq:function(F){var I=qx.util.ResourceManager.getInstance();var H=qx.io.ImageLoader;var G,J;if(I.has(F)){G=I.getImageWidth(F);J=I.getImageHeight(F);}
else if(H.isLoaded(F)){G=H.getWidth(F);J=H.getHeight(F);}
else {G=this.__qn;J=this.__qo;}
;return {width:G,height:J};}
,createDataCellHtml:function(K,L){this.__qp=this._getImageInfos(K);return qx.ui.table.cellrenderer.Abstract.prototype.createDataCellHtml.call(this,K,L);}
,_getCellClass:function(M){return qx.ui.table.cellrenderer.Abstract.prototype._getCellClass.call(this)+q;}
,_getContentHtml:function(N){var content=t;if(this.__qp.url){content=qx.bom.element.Decoration.create(this.__qp.url,this.getRepeat(),{width:this.__qp.width+k,height:this.__qp.height+k,display:qx.core.Environment.get(j),verticalAlign:s,position:e});}
;return content;}
,_getCellAttributes:function(O){var P=this.__qp.tooltip;if(P){return m+P+d;}
else {return u;}
;}
},destruct:function(){this.__qp=null;}
});}
)();
(function(){var g="_applyIconTrue",f="decoration/table/boolean-true.png",e="qx.ui.table.cellrenderer.Boolean",d=";padding-top:4px;",c="decoration/table/boolean-false.png",b="_applyIconFalse",a="String";qx.Class.define(e,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(){qx.ui.table.cellrenderer.AbstractImage.call(this);this.__ze=qx.util.AliasManager.getInstance();this.initIconTrue();this.initIconFalse();}
,properties:{iconTrue:{check:a,init:f,apply:g},iconFalse:{check:a,init:c,apply:b}},members:{__zf:null,__zg:false,__ze:null,_applyIconTrue:function(h){this.__zf=this.__ze.resolve(h);}
,_applyIconFalse:function(i){this.__zg=this.__ze.resolve(i);}
,_insetY:5,_getCellStyle:function(j){return qx.ui.table.cellrenderer.AbstractImage.prototype._getCellStyle.call(this,j)+d;}
,_identifyImage:function(k){var l={imageWidth:11,imageHeight:11};switch(k.value){case true:l.url=this.__zf;break;case false:l.url=this.__zg;break;default:l.url=null;break;};return l;}
},destruct:function(){this.__ze=null;}
});}
)();
(function(){var v="regex cannot be null!",u="font-weight",t="Condition not recognized or value1/value2 is null!",s="Condition not recognized or value is null!",r="text-align",q=";",p='g',o=":",n="qx.ui.table.cellrenderer.Conditional",m="color",e="font-style",l="==",h=">",c="between",b="<",g="regex",f="!between",j=">=",a="!=",k="<=",d="";qx.Class.define(n,{extend:qx.ui.table.cellrenderer.Default,construct:function(w,x,y,z){qx.ui.table.cellrenderer.Default.call(this);this.numericAllowed=[l,a,h,b,j,k];this.betweenAllowed=[c,f];this.conditions=[];this.__yY=w||d;this.__za=x||d;this.__zb=y||d;this.__zc=z||d;}
,members:{__yY:null,__za:null,__zb:null,__zc:null,__zd:function(A,B){if(A[1]!=null){B[r]=A[1];}
;if(A[2]!=null){B[m]=A[2];}
;if(A[3]!=null){B[e]=A[3];}
;if(A[4]!=null){B[u]=A[4];}
;}
...
;var bg=bb.table.getTableModel();var i;var bi;var bc;var be={"text-align":this.__yY,"color":this.__za,"font-style":this.__zb,"font-weight":this.__zc};for(i in this.conditions){bi=false;if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){bc=bb.value;}
...
;;if(bi==true){this.__zd(this.conditions[i],be);}
;}
...
(function(){var b="qx.ui.table.cellrenderer.Image",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__qr=c;}
;if(d){this.__qs=d;}
;this.__qt=qx.util.AliasManager.getInstance();}
,members:{__qt:null,__qs:16,__qr:16,_identifyImage:function(e){var f={imageWidth:this.__qr,imageHeight:this.__qs};if(e.value==a){f.url=null;}
else {f.url=this.__qt.resolve(e.value);}
