...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Animation_Compare","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_Compare-qx.theme.Indigo.b4e7a6464874.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Reverse",l="demobrowser.demo.animation.Animation_Compare",k="1%",j="10%",g="JavaScript Animation",f="infinite",d="#124589",c="end",b="2em",a="60px",bb="0",ba="20%",Y="CSS3 Animation",X="ease",W="30px",V="200px",U="Waiting 2s",T="linear",S="0.3",R="start",t="Stop",u="400px",r="5px",s="Play",p="2",q="1",n="Ended",o="ease-in-out",x="none",y="red",F="#00FF00",D="Running",J="20px",H="ease-in",N="-50px",L="ease-out",A="auto",Q="Pause",P="h1",O="1em",z="iteration",B="40px",C="100px",E="50px",G="10px",I="button",K="click",M="div",v="-10px",w="0px";qx.Class.define(l,{extend:qx.application.Native,members:{createButton:function(name,bc){var bd=[];for(var i=0;i<this.aniClasses.length;i++){var be=document.createElement(M);be.innerHTML=name;be.className=I;bd[i]=be;}
;var bf=(function(bg,name){return function(e){if(name.indexOf(m)!=-1){qx.bom.element.AnimationCss.animateReverse(bd[0],bg);qx.bom.element.AnimationJs.animateReverse(bd[1],bg);}
else {qx.bom.element.AnimationCss.animate(bd[0],bg);qx.bom.element.AnimationJs.animate(bd[1],bg);}
;}
;}
)(bc,name);qx.bom.Event.addNativeListener(bd[0],K,bf);qx.bom.Event.addNativeListener(bd[1],K,bf);return bd;}
,main:function(){qx.application.Native.prototype.main.call(this);this.aniClasses=[qx.bom.element.AnimationCss,qx.bom.element.AnimationJs];var bx={duration:1000,keyFrames:{'0':{"width":C},'70':{"width":V},'100':{"width":C}}};var bo={duration:1000,keyFrames:{'0':{"height":B},'70':{"height":a},'100':{"height":B}}};var by={duration:500,keyFrames:{'0':{"opacity":1},'50':{"opacity":0},'100':{"opacity":1}}};var bG={duration:500,keep:100,keyFrames:{'0':{"opacity":1},'100':{"opacity":0,display:x}}};var bn={duration:500,keyFrames:{'0':{"left":w,"top":w},'80':{"left":E,"top":C},'100':{"left":w,"top":w}}};var bp={duration:500,keyFrames:{'0':{"left":w},'30':{"left":v},'60':{"left":G},'80':{"left":v},'100':{"left":w}}};var bk={duration:500,keyFrames:{'0':{"left":w,"top":w},'30':{"left":v,"top":v},'60':{"left":G,"top":v},'80':{"left":v,"top":G},'100':{"left":w,"top":w}}};var bO={duration:1000,keep:70,keyFrames:{'0':{"top":w},'70':{"top":r},'100':{"top":W}}};var bA={duration:1000,keyFrames:{'0':{"line-height":q},'88':{"line-height":p},'100':{"line-height":S}}};var bh={duration:2000,keyFrames:{'0':{"font-size":O},'88':{"font-size":b},'100':{"font-size":O}}};var bl={duration:1000,keyFrames:{'0':{"width":j},'40':{"width":ba},'100':{"width":k}}};var bL={duration:1000,keyFrames:{'0':{"color":y},'50':{"color":d},'100':{"color":F}}};var bP={duration:500,repeat:2,keyFrames:{'0':{"top":w},'50':{"top":v},'100':{"top":w}}};var bu={duration:500,alternate:true,repeat:2,keyFrames:{'0':{"top":w},'100':{"top":N}}};var bi={duration:1000,timing:H,keep:100,keyFrames:{'0':{"left":w},'100':{"left":u}}};var bB=qx.lang.Object.clone(bi);bB.timing=L;var bE=qx.lang.Object.clone(bi);bE.timing=T;var bt=qx.lang.Object.clone(bi);bt.timing=X;var bv=qx.lang.Object.clone(bi);bv.timing=o;var bF={duration:1000,keyFrames:{'0':{},'50':{"opacity":0},'100':{}}};var bj={duration:500,alternate:true,repeat:2,keep:100,keyFrames:{'0':{"top":w},'100':{"top":E}}};var bs={duration:1000,keep:100,keyFrames:{'0':{"top":w},'100':{"top":E}}};var bz={duration:500,alternate:true,repeat:3,keep:100,keyFrames:{'0':{"top":w},'100':{"top":J}}};var bC={"Width":bx,"Height":bo,"Fade":by,"FadeOut":bG,"Move":bn,"Shake":bp,"Dance":bk,"Dance Reverse":bk,"Keep":bO,"Keep (Alt.)":bj,"Keep (Reverse)":bs,"Keep (Reverse/Alt)":bz,"Font-Size":bh,"Line Height":bA,"Percent Width":bl,"Color":bL,"Twice":bP,"Alternate":bu,"Ease In":bi,"Ease Out":bB,"Linear":bE,"Ease":bt,"Ease In Out":bv,"Missing Values":bF};var h=document.createElement(P);h.innerHTML=Y;document.body.appendChild(h);var bm=document.createElement(M);document.body.appendChild(bm);h=document.createElement(P);h.innerHTML=g;document.body.appendChild(h);var bS=document.createElement(M);document.body.appendChild(bS);for(var bI in bC){var bw=this.createButton(bI,bC[bI]);bm.appendChild(bw[0]);bS.appendChild(bw[1]);}
;var bK={duration:500,alternate:true,repeat:f,keyFrames:{'0':{left:w},'100':{left:G}}};var bw=[];for(var i=0;i<this.aniClasses.length;i++){var bN=document.createElement(M);bN.innerHTML=t;bN.className=I;bw[i]=bN;}
;var bJ=(function(bT){return function(e){for(var i=0;i<bD.length;i++){bD[i].stop();}
;}
;}
)(bK);qx.bom.Event.addNativeListener(bw[0],K,bJ);qx.bom.Event.addNativeListener(bw[1],K,bJ);var bD=[];bD.push(qx.bom.element.AnimationCss.animate(bw[0],bK));bD.push(qx.bom.element.AnimationJs.animate(bw[1],bK));bm.appendChild(bw[0]);bS.appendChild(bw[1]);bw=[];for(var i=0;i<this.aniClasses.length;i++){var bN=document.createElement(M);bN.innerHTML=Q;bN.className=I;bw[i]=bN;}
;var bJ=(function(bU){return function(e){for(var i=0;i<bD.length;i++){if(bR[i].el){if(bR[i].isPlaying()){bR[i].pause();bR[i].el.innerHTML=s;}
else {bR[i].play();bR[i].el.innerHTML=Q;}
;}
;}
;}
;}
)(bK);qx.bom.Event.addNativeListener(bw[0],K,bJ);qx.bom.Event.addNativeListener(bw[1],K,bJ);var bR=[];bR.push(qx.bom.element.AnimationCss.animate(bw[0],bK));bR.push(qx.bom.element.AnimationJs.animate(bw[1],bK));bm.appendChild(bw[0]);bS.appendChild(bw[1]);bw=[];for(var i=0;i<this.aniClasses.length;i++){var bN=document.createElement(M);bN.innerHTML=bb;bN.className=I;bw[i]=bN;bN.style.cursor=A;}
;var bq=function(e){e.innerHTML=parseInt(e.innerHTML)+1;}
;qx.bom.element.AnimationCss.animate(bw[0],bK).on(z,bq);qx.bom.element.AnimationJs.animate(bw[1],bK).on(z,bq);bm.appendChild(bw[0]);bS.appendChild(bw[1]);var br={duration:500,repeat:10,delay:2000,alternate:true,keyFrames:{'0':{left:w},'100':{left:G}}};bw=[];for(var i=0;i<this.aniClasses.length;i++){var bN=document.createElement(M);bN.innerHTML=U;bN.className=I;bw[i]=bN;bN.style.cursor=A;}
;var bH=function(e){e.innerHTML=D;}
;var bM=function(e){e.innerHTML=n;}
;var bQ=[];bQ.push(qx.bom.element.AnimationCss.animate(bw[0],br));bQ.push(qx.bom.element.AnimationJs.animate(bw[1],br));for(var i=0;i<bQ.length;i++){bQ[i].on(R,bH);bQ[i].on(c,bM);}
;bm.appendChild(bw[0]);bS.appendChild(bw[1]);}
}});}
)();
