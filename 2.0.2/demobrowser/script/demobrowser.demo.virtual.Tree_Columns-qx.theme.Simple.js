...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree_Columns","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns-qx.theme.Simple.0097508612be.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="Windows (C:)",j="Documents (D:)",h="Inbox",g="Desktop",f="Personal",e="-rw-r--r--",d="Presets",c="Network",b="light",a="Sent",H="children",G="Big",F="Files",E="icon/16/status/dialog-information.png",D="",C=" 2010",B="Workspace",A="demobrowser.demo.virtual.Tree_Columns",z="Spam",y="Data",r="May ",s="Root",p="label",q="Lists",n="kb",o="Item ",l="Edit",m="leadIcon",t="Trash",u="size",w="mode",v="date",x="checked";qx.Class.define(A,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.container.Scroll();var I=new qx.ui.container.Composite(new qx.ui.layout.Basic());I.setAllowGrowX(false);I.setAllowStretchX(false);J.add(I);this.getRoot().add(J,{edge:0});var K=new qx.ui.tree.VirtualTree(null,p,H).set({width:600,height:500});I.add(K,{left:20,top:48});var M={label:s,children:[{label:g,children:[{label:F},{label:B,children:[{label:k},{label:j}]},{label:c},{label:t}]},{label:h,children:[{label:d},{label:a},{label:t},{label:y},{label:l},{label:q},{label:f},{label:G,children:[]},{label:z}]}]};for(var i=0;i<50;i++){M.children[1].children[7].children[i]={label:o+i};}
;this.extendData(M);var L=qx.data.marshal.Json.createModel(M,true);this.configureTriState(L);K.setModel(L);K.setDelegate(this);}
,extendData:function(N){N.date=r+Math.round(Math.random()*30+1)+C;N.size=Math.round(Math.random()*100)+n;N.light=Math.floor(Math.random()*4)==0;N.mode=e;N.checked=Math.random()>=0.5;if(N.children){for(var i=0;i<N.children.length;i++){this.extendData(N.children[i]);}
;}
;}
,configureTriState:function(O){O.getModel=function(){return this;}
;if(O.getChildren!=null){var P=O.getChildren();for(var i=0;i<P.getLength();i++){var Q=P.getItem(i);this.configureTriState(Q);O.bind(x,Q,x,{converter:function(R,S){if(R===null){return S.getChecked();}
;return R;}
});Q.bind(x,O,x,{converter:function(T,parent){var W=parent.getChildren().toArray();var U=W.every(function(X){return X.getChecked();}
);var V=W.some(function(Y){return Y.getChecked()||Y.getChecked()==null;}
);if(V){return U?true:null;}
else {return false;}
;}
});}
;}
;}
,bindItem:function(ba,bb,bc){ba.bindDefaultProperties(bb,bc);ba.bindProperty(u,u,null,bb,bc);ba.bindProperty(x,x,null,bb,bc);ba.bindPropertyReverse(x,x,null,bb,bc);ba.bindProperty(v,v,null,bb,bc);ba.bindProperty(w,w,null,bb,bc);ba.bindProperty(b,m,{converter:function(bd){return bd?E:D;}
},bb,bc);}
...
(function(){var k="scrollY",j="The method 'getItemRight' is not implemented!",i="update",h="scrollX",g="The method 'getItemLeft' is not implemented!",f="The method 'getItemBottom' is not implemented!",d="The method 'getItemTop' is not implemented!",c="pane",b="os.scrollBarOverlayed",a="qx.ui.virtual.core.Scroller";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(l,m,n,o){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__AG=new qx.ui.virtual.core.Pane(l,m,n,o);this.__AG.addListener(i,this._computeScrollbars,this);this.__AG.addListener(h,this._onScrollPaneX,this);this.__AG.addListener(k,this._onScrollPaneY,this);if(qx.core.Environment.get(b)){this._add(this.__AG,{edge:0});}
else {this._add(this.__AG,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__AG:null,getPane:function(){return this.__AG;}
,_createChildControlImpl:function(p,q){if(p==c){return this.__AG;}
...
,_onScrollBarX:function(e){this.__AG.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__AG.setScrollY(e.getData());}
},destruct:function(){this.__AG.dispose();this.__AG=null;}
});}
)();
(function(){var w="qx.ui.virtual.core.Pane",v="resize",u="click",t="scrollX",s="dblclick",r="contextmenu",q="qx.debug",p="cellClick",o="cellContextmenu",n="qx.event.type.Event",f="__zT",m="__zU",j="__Ac",c="__Ab",b="cellDblclick",h="scrollY",g="update",k="change",a="qx.event.type.Data",l="qx.ui.virtual.core.CellEvent",d="appear";qx.Class.define(w,{extend:qx.ui.core.Widget,construct:function(x,y,z,A){qx.ui.core.Widget.call(this);this.__zT=new qx.ui.virtual.core.Axis(z,x);this.__zU=new qx.ui.virtual.core.Axis(A,y);this.__zV=0;this.__zW=0;this.__zX=0;this.__zY=0;this.__Aa={};this.__gR={};this.__Ab=new qx.ui.container.Composite();this.__Ab.setUserBounds(0,0,0,0);this._add(this.__Ab);this.__Ac=[];this.__zT.addListener(k,this.fullUpdate,this);this.__zU.addListener(k,this.fullUpdate,this);this.addListener(v,this._onResize,this);this.addListenerOnce(d,this._onAppear,this);this.addListener(u,this._onClick,this);this.addListener(s,this._onDblclick,this);this.addListener(r,this._onContextmenu,this);}
,events:{cellClick:l,cellContextmenu:l,cellDblclick:l,update:n,scrollX:a,scrollY:a},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__zT:null,__zU:null,__zV:null,__zW:null,__zX:null,__zY:null,__Aa:null,__gR:null,__Ab:null,__Ac:null,__Ad:null,__or:null,__zS:null,getRowConfig:function(){return this.__zT;}
,getColumnConfig:function(){return this.__zU;}
,getChildren:function(){return [this.__Ab];}
,addLayer:function(B){if(qx.core.Environment.get(q)){this.assertInterface(B,qx.ui.virtual.core.ILayer);}
;this.__Ac.push(B);B.setUserBounds(0,0,0,0);this.__Ab.add(B);}
,getLayers:function(){return this.__Ac;}
,getVisibleLayers:function(){var C=[];for(var i=0;i<this.__Ac.length;i++){var D=this.__Ac[i];if(D.isVisible()){C.push(D);}
;}
;return C;}
,getScrollMaxX:function(){var E=this.getInnerSize();if(E){return Math.max(0,this.__zU.getTotalSize()-E.width);}
;return 0;}
,getScrollMaxY:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__zT.getTotalSize()-F.height);}
;return 0;}
,setScrollY:function(G){var H=this.getScrollMaxY();if(G<0){G=0;}
else if(G>H){G=H;}
;if(this.__zV!==G){var I=this.__zV;this.__zV=G;this._deferredUpdateScrollPosition();this.fireDataEvent(h,G,I);}
;}
,getScrollY:function(){return this.__zV;}
,setScrollX:function(J){var K=this.getScrollMaxX();if(J<0){J=0;}
else if(J>K){J=K;}
;if(J!==this.__zW){var L=this.__zW;this.__zW=J;this._deferredUpdateScrollPosition();this.fireDataEvent(t,J,L);}
;}
,getScrollX:function(){return this.__zW;}
,getScrollSize:function(){return {width:this.__zU.getTotalSize(),height:this.__zT.getTotalSize()};}
...
,this,0);}
,this);return;}
;var Q=this.__zT.getItemPosition(M);var O=Q+this.__zT.getItemSize(M);var N=this.getScrollY();if(Q<N){this.setScrollY(Q);}
...
,this,0);}
,this);return;}
;var T=this.__zU.getItemPosition(R);var S=T+this.__zU.getItemSize(R);var V=this.getScrollX();if(T<V){this.setScrollX(T);}
...
;bc=this.__zT.getItemAtPosition(this.getScrollY()+bb-be.top);bd=this.__zU.getItemAtPosition(this.getScrollX()+ba-be.left);if(!bc||!bd){return null;}
...
;var bm=this.__zW+bl.width;var bn=this.__zY-bm;if(this.__zW-this.__Aa.left<Math.min(this.__zW,bf)||this.__Aa.right-bm<Math.min(bn,bh)){var bo=Math.min(this.__zW,bg);var bk=Math.min(bn,bi);this._setLayerWindow(bj,this.__zW-bo,this.__zV,bl.width+bo+bk,bl.height,false);}
;}
,prefetchY:function(bp,bq,br,bs){var bt=this.getVisibleLayers();if(bt.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bu=this.__zV+bw.height;var bv=this.__zX-bu;if(this.__zV-this.__Aa.top<Math.min(this.__zV,bp)||this.__Aa.bottom-bu<Math.min(bv,br)){var by=Math.min(this.__zV,bq);var bx=Math.min(bv,bs);this._setLayerWindow(bt,this.__zW,this.__zV-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContainerElement().getDomElement()){this.__Ad=true;this._updateScrollPosition();this.__Ad=null;this.fireEvent(g);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onClick:function(e){this.__Ae(e,p);}
,_onContextmenu:function(e){this.__Ae(e,o);}
,_onDblclick:function(e){this.__Ae(e,b);}
,__Ae:function(e,bz){var bA=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bA){return;}
...
;this.__gR={};}
,_setLayerWindow:function(bC,bD,top,bE,bF,bG){var bL=this.__zT.getItemAtPosition(top);if(bL){var bN=bL.index;var bR=this.__zT.getItemSizes(bN,bF+bL.offset);var bM=qx.lang.Array.sum(bR);var bT=top-bL.offset;var bQ=top-bL.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bT=0;var bQ=0;}
;var bP=this.__zU.getItemAtPosition(bD);if(bP){var bJ=bP.index;var bI=this.__zU.getItemSizes(bJ,bE+bP.offset);var bO=qx.lang.Array.sum(bI);var bS=bD-bP.offset;var bK=bD-bP.offset+bO;}
else {var bJ=0;var bI=[];var bO=0;var bS=0;var bK=0;}
;this.__Aa={top:bT,bottom:bQ,left:bS,right:bK};this.__Ab.setUserBounds(this.__Aa.left-this.__zW,this.__Aa.top-this.__zV,bO,bM);this.__or=bI;this.__zS=bR;for(var i=0;i<this.__Ac.length;i++){var bH=this.__Ac[i];bH.setUserBounds(0,0,bO,bM);if(bG){bH.fullUpdate(bN,bJ,bR,bI);}
else {bH.updateLayerWindow(bN,bJ,bR,bI);}
;}
;}
,__Af:function(){if(this.__Ad){return;}
;var bU=this.getScrollSize();if(this.__zX!==bU.height||this.__zY!==bU.width){this.__zX=bU.height;this.__zY=bU.width;this.fireEvent(g);}
;}
...
,_fullUpdate:function(){var bV=this.getVisibleLayers();if(bV.length==0){this.__Af();return;}
;var bW=this.getBounds();if(!bW){return;}
;this._setLayerWindow(bV,this.__zW,this.__zV,bW.width,bW.height,true);this.__Af();}
,_deferredUpdateScrollPosition:function(){this.__gR._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__Af();return;}
;var ca=this.getBounds();if(!ca){return;}
;var bY={top:this.__zV,bottom:this.__zV+ca.height,left:this.__zW,right:this.__zW+ca.width};if(this.__Aa.top<=bY.top&&this.__Aa.bottom>=bY.bottom&&this.__Aa.left<=bY.left&&this.__Aa.right>=bY.right){this.__Ab.setUserBounds(this.__Aa.left-bY.left,this.__Aa.top-bY.top,this.__Aa.right-this.__Aa.left,this.__Aa.bottom-this.__Aa.top);}
else {this._setLayerWindow(bX,this.__zW,this.__zV,ca.width,ca.height,false);}
;this.__Af();}
},destruct:function(){this._disposeArray(j);this._disposeObjects(f,m,c);this.__Aa=this.__gR=this.__or=this.__zS=null;}
});}
)();
...
,events:{"change":f},members:{__AC:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__AC=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__AC=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__AC=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__AC=null;this.fireNonBubblingEvent(c);}
,__AD:function(){if(this.__AC){return this.__AC;}
;var r=this.defaultItemSize;var y=this.itemCount;var t=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<y){t.push(p);}
;}
;if(t.length==0){var u=[{startIndex:0,endIndex:y-1,firstItemSize:r,rangeStart:0,rangeEnd:y*r-1}];this.__AC=u;return u;}
...
;var z=u[u.length-1];var w=(y-z.startIndex-1)*r;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=y-1;this.__AC=u;return u;}
,__AE:function(A){var B=this.__AC||this.__AD();var C=0;var E=B.length-1;while(true){var F=C+((E-C)>>1);var D=B[F];if(D.rangeEnd<A){C=F+1;}
else if(D.rangeStart>A){E=F-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(G){if(G<0||G>=this.getTotalSize()){return null;}
;var I=this.__AE(G);var K=I.rangeStart;var H=I.startIndex;var L=I.firstItemSize;if(K+L>G){return {index:H,offset:G-K};}
else {var J=this.defaultItemSize;return {index:H+1+Math.floor((G-K-L)/J),offset:(G-K-L)%J};}
;}
,__AF:function(M){var N=this.__AC||this.__AD();var O=0;var Q=N.length-1;while(true){var R=O+((Q-O)>>1);var P=N[R];if(P.endIndex<M){O=R+1;}
else if(P.startIndex>M){Q=R-1;}
else {return P;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__AF(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__AC||this.__AD();return U[U.length-1].rangeEnd+1;}
...
;}
;return Y;}
},destruct:function(){this.customSizes=this.__AC=null;}
});}
)();
...
,_onChangeSelection:function(e){if(this.__AH==true){return;}
;this.__Az=true;var E=this.getSelection();var G=[];for(var i=0;i<E.getLength();i++){var F=E.getItem(i);var H=this._getSelectables();var D=-1;if(H!=null){D=H.indexOf(F);}
...
;this.__An();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__Az=false;}
,_onManagerChangeSelection:function(e){if(this.__Az==true){return;}
;this.__AH=true;this.__An();this.__AH=false;}
,__An:function(){if(this.__AJ()){return;}
;var J=this._manager.getSelection();var K=[];for(var i=0;i<J.length;i++){var L=this._getDataFromRow(J[i]);if(L!=null){K.push(L);}
;}
;this.__AI(K);}
,__AI:function(M){var N=this.getSelection();if(M.length>0){var P=[0,N.getLength()];P=P.concat(M);var O=N.splice.apply(N,P);O.dispose();}
else {N.removeAll();}
;}
,__AJ:function(){var R=this.getSelection();var T=this._manager.getSelection();if(R.getLength()!==T.length){return false;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__Ai){this.__Ai.dispose();}
;}
});}
)();
...
(function(){var l="changeModel",k="or 'labelPath' is 'null'!",j="_applyLabelOptions",h="marshal.MEventBubbling'. Therefore the tree can not update ",g="_applyOpenMode",f="the view automatically on model changes.",d="qx.core.Object",c="Space",b="Left",a="Integer",S="_applyModel",R="_applyShowTopLevelOpenCloseIcons",Q="_applyLabelPath",P="changeOpenMode",O="qx.debug",N="changeDelegate",M="virtual-tree",L="_applyChildProperty",K="_applyIconPath",J="_applyDelegate",s="_applyHideRoot",t="close",q="The model item doesn't support the Mixin 'qx.data.",r="_applyRowHeight",o="Right",p="Enter",m="qx.ui.tree.VirtualTree",n="keypress",u="none",v="Could not build tree, because 'childProperty' and/",B="_applyShowLeafs",A="_applyIconOptions",D=".",C="one",F="qx.event.type.Data",E="updated",x="changeBubble",I="Boolean",H="click",G="String",w="dblclick",y="cellDblclick",z="cellClick";qx.Class.define(m,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.tree.core.IVirtualTree,qx.data.controller.ISelection],include:[qx.ui.virtual.selection.MModel,qx.ui.core.MContentPadding],construct:function(T,U,V){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);this._init();if(U!=null){this.setLabelPath(U);}
;if(V!=null){this.setChildProperty(V);}
;if(T!=null){this.initModel(T);}
;this.initItemHeight();this.initOpenMode();this.addListener(n,this._onKeyPress,this);}
,events:{open:F,close:F},properties:{appearance:{refine:true,init:M},focusable:{refine:true,init:true},width:{refine:true,init:100},height:{refine:true,init:200},itemHeight:{check:a,init:25,apply:r,themeable:true},openMode:{check:[H,w,u],init:w,apply:g,event:P,themeable:true},hideRoot:{check:I,init:false,apply:s},showTopLevelOpenCloseIcons:{check:I,init:false,apply:R},showLeafs:{check:I,init:true,apply:B},childProperty:{check:G,apply:L,nullable:true},labelPath:{check:G,apply:Q,nullable:true},iconPath:{check:G,apply:K,nullable:true},labelOptions:{apply:j,nullable:true},iconOptions:{apply:A,nullable:true},model:{check:d,apply:S,event:l,nullable:true,deferredInit:true},delegate:{event:N,apply:J,init:null,nullable:true}},members:{_provider:null,_layer:null,__zA:null,__IR:null,__IS:null,__ei:null,__IT:0,__IU:null,syncWidget:function(W){var bb=this._layer.getFirstRow();var X=this._layer.getRowSizes().length;for(var bc=bb;bc<bb+X;bc++){var Y=this._layer.getRenderedCellWidget(bc,0);if(Y!=null){this.__IT=Math.max(this.__IT,Y.getSizeHint().width);}
;}
;var ba=this.getPane().getInnerSize().width;this.getPane().getColumnConfig().setItemSize(0,Math.max(this.__IT,ba));}
,openNode:function(bd){this.__IX(bd);this.buildLookupTable();}
,refresh:function(){this.buildLookupTable();}
,openNodeAndParents:function(be){this.__IY(this.getModel(),be);this.buildLookupTable();}
,closeNode:function(bf){if(qx.lang.Array.contains(this.__IR,bf)){qx.lang.Array.remove(this.__IR,bf);this.fireDataEvent(t,bf);this.buildLookupTable();}
;}
,isNodeOpen:function(bg){return qx.lang.Array.contains(this.__IR,bg);}
,_init:function(){this.__zA=new qx.data.Array();this.__IR=[];this.__IS=[];this._initLayer();}
,_initLayer:function(){this._provider=new qx.ui.tree.provider.WidgetProvider(this);this._layer=this._provider.createLayer();this._layer.addListener(E,this._onUpdated,this);this.getPane().addLayer(this._layer);}
,getLookupTable:function(){return this.__zA;}
,_reverseLookup:function(bh){return bh;}
,_getDataFromRow:function(bi){return this.__zA.getItem(bi);}
,_getSelectables:function(){return this.__zA;}
,getOpenNodes:function(){return this.__IR;}
,isNode:function(bj){return qx.Class.hasProperty(bj.constructor,this.getChildProperty());}
,getLevel:function(bk){return this.__IS[bk];}
,hasChildren:function(bl){var bm=bl.get(this.getChildProperty());if(bm==null){return false;}
;if(this.isShowLeafs()){return bm.length>0;}
else {for(var i=0;i<bm.getLength();i++){var bn=bm.getItem(i);if(this.isNode(bn)){return true;}
;}
;}
;return false;}
,_getContentPaddingTarget:function(){return this.getPane();}
,_applyRowHeight:function(bo,bp){this.getPane().getRowConfig().setDefaultItemSize(bo);}
,_applyOpenMode:function(bq,br){var bs=this.getPane();if(bq===w){bs.addListener(y,this._onOpen,this);}
else if(bq===H){bs.addListener(z,this._onOpen,this);}
;if(br===w){bs.removeListener(y,this._onOpen,this);}
else if(br===H){bs.removeListener(z,this._onOpen,this);}
;}
,_applyHideRoot:function(bt,bu){this.buildLookupTable();}
,_applyShowTopLevelOpenCloseIcons:function(bv,bw){this.buildLookupTable();}
,_applyShowLeafs:function(bx,by){this.buildLookupTable();}
,_applyChildProperty:function(bz,bA){this._provider.setChildProperty(bz);}
,_applyLabelPath:function(bB,bC){this._provider.setLabelPath(bB);}
,_applyIconPath:function(bD,bE){this._provider.setIconPath(bD);}
,_applyLabelOptions:function(bF,bG){this._provider.setLabelOptions(bF);}
,_applyIconOptions:function(bH,bI){this._provider.setIconOptions(bH);}
,_applyModel:function(bJ,bK){this.__IR=[];if(bJ!=null){if(qx.core.Environment.get(O)){if(!qx.Class.hasMixin(bJ.constructor,qx.data.marshal.MEventBubbling)){this.warn(q+h+f);}
;}
;bJ.addListener(x,this._onChangeBubble,this);this.__IX(bJ);}
;if(bK!=null){bK.removeListener(x,this._onChangeBubble,this);}
;this.__IV();}
,_applyDelegate:function(bL,bM){this._provider.setDelegate(bL);this.buildLookupTable();}
,_onChangeBubble:function(event){var bO=event.getData().name;var bN=bO.lastIndexOf(D);if(bN!=-1){bO=bO.substr(bN+1,bO.length);}
;if(qx.lang.String.startsWith(bO,this.getChildProperty())){this.__IV();}
;}
,_onUpdated:function(event){if(this.__ei==null){this.__ei=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__ei.schedule();}
,_onOpen:function(event){var bQ=event.getRow();var bP=this.__zA.getItem(bQ);if(this.isNode(bP)){if(this.isNodeOpen(bP)){this.closeNode(bP);}
else {this.openNode(bP);}
;}
;}
,_onKeyPress:function(e){var bT=this.getSelection();if(bT.getLength()>0){var bR=bT.getItem(0);var bS=this.isNode(bR);switch(e.getKeyIdentifier()){case b:if(bS&&this.isNodeOpen(bR)){this.closeNode(bR);}
else {var parent=this.getParent(bR);if(parent!=null){bT.splice(0,1,parent);}
;}
;break;case o:if(bS&&!this.isNodeOpen(bR)){this.openNode(bR);}
else {if(bS){var bU=bR.get(this.getChildProperty());if(bU!=null&&bU.getLength()>0){bT.splice(0,1,bU.getItem(0));}
;}
;}
;break;case p:case c:if(!bS){return;}
;if(this.isNodeOpen(bR)){this.closeNode(bR);}
else {this.openNode(bR);}
;break;};}
;}
,_beforeApplySelection:function(bV){if(bV.length===0&&this.getSelectionMode()===C){var bW=this.__Jb();var bX=this.getLookupTable().indexOf(bW);if(bX>=0){bV.push(bX);}
;}
;}
,_afterApplySelection:function(){var bY=this.getSelection();if(bY.getLength()>0&&this.getSelectionMode()===C){this.__Ja(bY.getItem(0));}
else {this.__IU=[];}
;}
,__IV:function(){this.buildLookupTable();this._applyDefaultSelection();}
,buildLookupTable:function(){if(this.getModel()!=null&&(this.getChildProperty()==null||this.getLabelPath()==null)){throw new Error(v+k);}
;this.__IT=0;var cd=[];this.__IS=[];var cb=-1;var cc=this.getModel();if(cc!=null){if(!this.isHideRoot()){cb++;cd.push(cc);this.__IS.push(cb);}
;if(this.isNodeOpen(cc)){var ca=this.__IW(cc,cb);cd=cd.concat(ca);}
;}
;this._provider.removeBindings();this.__zA.removeAll();this.__zA.append(cd);this.__zG();this._updateSelection();}
,__IW:function(ce,cf){var cg=[];cf++;if(!this.isNode(ce)){return cg;}
;var ci=ce.get(this.getChildProperty());if(ci==null){return cg;}
;for(var i=0;i<ci.getLength();i++){var cj=ci.getItem(i);if(this.isNode(cj)){this.__IS.push(cf);cg.push(cj);if(this.isNodeOpen(cj)){var ch=this.__IW(cj,cf);cg=cg.concat(ch);}
;}
else {if(this.isShowLeafs()){this.__IS.push(cf);cg.push(cj);}
;}
;}
;return cg;}
,__IX:function(ck){if(!qx.lang.Array.contains(this.__IR,ck)){this.__IR.push(ck);this.fireDataEvent("open",ck);}
;}
,__IY:function(cl,cm){if(cl===cm){this.__IX(cm);return true;}
;if(!this.isNode(cl)){return false;}
;var co=cl.get(this.getChildProperty());if(co==null){return false;}
;for(var i=0;i<co.getLength();i++){var cp=co.getItem(i);var cn=this.__IY(cp,cm);if(cn===true){this.__IX(cp);return true;}
;}
;return false;}
,__zG:function(){this.getPane().getRowConfig().setItemCount(this.__zA.getLength());this.getPane().fullUpdate();}
,getParent:function(cq){var cs=this.__zA.indexOf(cq);if(cs<0){return null;}
;var ct=this.__IS[cs];while(cs>0){cs--;var cr=this.__IS[cs];if(cr<ct){return this.__zA.getItem(cs);}
;}
;return null;}
,__Ja:function(cu){this.__IU=[];var parent=this.getParent(cu);while(parent!=null){this.__IU.unshift(parent);parent=this.getParent(parent);}
;}
,__Jb:function(){if(this.__IU==null){return this.getModel();}
;var cv=this.getLookupTable();var parent=this.__IU.pop();while(parent!=null){if(cv.contains(parent)){return parent;}
;parent=this.__IU.pop();}
;return this.getModel();}
},destruct:function(){var cw=this.getPane();if(cw!=null){if(cw.hasListener(y)){cw.addListener(y,this._onOpen,this);}
else if(cw.hasListener(z)){cw.removeListener(z,this._onOpen,this);}
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__ei!=null){this.__ei.cancel();this.__ei.dispose();}
;this._layer.removeListener(E,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__zA.dispose();this._layer=this._provider=this.__zA=this.__IR=this.__ei=null;}
});}
)();
...
(function(){var q="model",p="changeDelegate",o="virtual-tree-file",n="label",m="appearance",l="icon",k="bindItem",j=".length",i="]",h="virtual-tree-folder",c="[",g=".",f="qx.ui.tree.core.MWidgetController",b="BindingIds",a="",d="String";qx.Mixin.define(f,{construct:function(){this.__zM=[];}
,properties:{labelPath:{check:d,nullable:true},iconPath:{check:d,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:d,nullable:true},delegate:{event:p,init:null,nullable:true}},members:{__zM:null,bindDefaultProperties:function(r,s){this.bindProperty(a,q,null,r,s);this.bindProperty(this.getLabelPath(),n,this.getLabelOptions(),r,s);try{this.bindProperty(this.getChildProperty()+j,m,{converter:function(){return h;}
},r,s);}
catch(t){r.setAppearance(o);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),l,this.getIconOptions(),r,s);}
;}
,bindProperty:function(u,v,w,x,y){var z=this.__zN(y,u);var A=this._tree.getLookupTable();var B=A.bind(z,x,v,w);this.__zO(x,B);}
,bindPropertyReverse:function(C,D,E,F,G){var H=this.__zN(G,C);var I=this._tree.getLookupTable();var J=F.bind(D,I,H,E);this.__zO(F,J);}
,removeBindings:function(){while(this.__zM.length>0){var K=this.__zM.pop();this._removeBindingsFrom(K);}
;}
...
;}
,_removeBindingsFrom:function(O){var P=this.__zP(O);while(P.length>0){var Q=P.pop();try{this._tree.getLookupTable().removeBinding(Q);}
catch(e){O.removeBinding(Q);}
;}
;if(qx.lang.Array.contains(this.__zM,O)){qx.lang.Array.remove(this.__zM,O);}
;}
,__zN:function(R,S){var T=c+R+i;if(S!=null&&S!=a){T+=g+S;}
;return T;}
,__zO:function(U,V){var W=this.__zP(U);if(!qx.lang.Array.contains(W,V)){W.push(V);}
;if(!qx.lang.Array.contains(this.__zM,U)){this.__zM.push(U);}
;}
,__zP:function(X){var Y=X.getUserData(b);if(Y==null){Y=[];X.setUserData(b,Y);}
;return Y;}
...
;var q=this._renderer.getCellWidget();q.setOpen(r&&this._tree.isNodeOpen(p));q.setUserData(g,r);q.addListener(b,this.__Jc,this);if(this._tree.getSelection().contains(p)){this._styleSelectabled(q);}
...
,poolCellWidget:function(t){t.removeListener(b,this.__Jc,this);this._removeBindingsFrom(t);this._renderer.pool(t);this._onPool(t);}
...
,__Jc:function(event){var J=event.getTarget();var K=J.getUserData(c);var I=this._tree.getLookupTable().getItem(K);if(event.getData()){this._tree.openNode(I);}
...
,properties:{anonymous:{refine:true,init:true}},members:{__gR:null,__cx:null,__zQ:null,__zR:null,__zS:null,__or:null,getFirstRow:function(){return this.__zQ;}
,getFirstColumn:function(){return this.__zR;}
,getRowSizes:function(){return this.__zS||[];}
,getColumnSizes:function(){return this.__or||[];}
...
else if(this.__gR.updateLayerData&&this.__zS){this._updateLayerData();}
;;if(this.__gR.fullUpdate||this.__gR.updateLayerWindow){var e=this.__cx;this.__zQ=e[0];this.__zR=e[1];this.__zS=e[2];this.__or=e[3];}
;this.__gR={};}
,_updateLayerData:function(){this._fullUpdate(this.__zQ,this.__zR,this.__zS,this.__or);}
...
},destruct:function(){this.__gR=this.__cx=this.__zS=this.__or=null;}
});}
)();
...
;this._cellProvider=h;this.__Ah=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:g},members:{__Ah:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;var q=this.getRowSizes().length;var p=this.getFirstRow();var o=this.getFirstColumn();if(j<p||j>=p+q||k<o||k>=o+l){return null;}
;var n=(k-o)+(j-p)*l;var m=this._getChildren()[n];if(m.getUserData(a)){return null;}
else {return m;}
;}
,_getSpacer:function(){var r=this.__Ah.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(a,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(v,w,z,A){var C=this._cellProvider;var G=this._getChildren();for(var i=0;i<G.length;i++){var E=G[i];if(E.getUserData(a)){this.__Ah.push(E);}
...
;}
;}
;var U=this._cellProvider;var Y=this._getChildren();for(var i=0;i<Y.length;i++){if(!S[i]){var W=Y[i];if(W.getUserData(a)){this.__Ah.push(W);}
...
;}
;h.setUserData(b,i);}
,getCellWidget:function(m,n){var o=this.__Aw();this.updateStates(o,n);this.updateData(o,m);return o;}
,pool:function(p){this.__cQ.push(p);}
,_cleanupPool:function(){var q=this.__cQ.pop();while(q){q.destroy();q=this.__cQ.pop();}
;}
,__Aw:function(){var r=this.__cQ.pop();if(r==null){r=this._createWidget();this.fireDataEvent(e,r);}
;return r;}
...
(function(){var r='"',q="The model contained an illegal name: '",p="qx.debug.databinding",o="change",n="qx.data.marshal.Json",m="Unsupported type!",l="'.",k="'. Replaced it with '",j="set",h="' is not a valid JavaScript identifier.",c="_applyEventPropagation",g="The key '",f="",b="Array",a="_validate",e="qx.debug",d="qx.data.model.";qx.Class.define(n,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(s){qx.core.Object.call(this);this.__tX=s;}
...
},members:{__tX:null,__tY:function(v){return qx.Bootstrap.getKeys(v).sort().join(r);}
...
;}
;return;}
;var z=this.__tY(w);for(var A in w){this.toClass(w[A],x);}
;if(qx.Class.isDefined(d+z)){return;}
;if(this.__tX&&this.__tX.getModelClass&&this.__tX.getModelClass(z)!=null){return;}
;var G={};var F={__ua:this.__ua};for(var A in w){if(this.__tX&&this.__tX.getPropertyMapping){A=this.__tX.getPropertyMapping(A,z);}
...
;if(this.__tX&&this.__tX.getValidationRule){var C=this.__tX.getValidationRule(z,A);if(C){G[A].validate=a+A;F[a+A]=C;}
;}
;}
;if(this.__tX&&this.__tX.getModelSuperClass){var E=this.__tX.getModelSuperClass(z)||qx.core.Object;}
else {var E=qx.core.Object;}
;var B=[];if(this.__tX&&this.__tX.getModelMixins){var D=this.__tX.getModelMixins(z);if(!qx.lang.Type.isArray(D)){if(D!=null){B=[D];}
;}
else {B=D;}
;}
;if(x){B.push(qx.data.marshal.MEventBubbling);}
;var y={extend:E,include:B,properties:G,members:F,destruct:this.__ub};qx.Class.define(d+z,y);}
,__ub:function(){var H=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var I in H){this.__ua(this.get(H[I].name));}
;}
,__ua:function(J){if(!(J instanceof qx.core.Object)){return;}
;if(J.isDisposed()){return;}
;J.dispose();}
,__uc:function(K){var L;if(this.__tX&&this.__tX.getModelClass){L=this.__tX.getModelClass(K);}
...
;return U;}
else if(S){var P=this.__tY(N);var V=this.__uc(P);for(var T in N){var Q=T;if(this.__tX&&this.__tX.getPropertyMapping){Q=this.__tX.getPropertyMapping(T,P);}
...
;return V;}
;;throw new Error(m);}
},destruct:function(){this.__tX=null;}
});}
)();
(function(){var p="source",o="changeLeadIcon",n="changeSize",m="changeMode",l="changeDate",k="changeChecked",j="icon/16/places/user-desktop.png",i="size",h="leadIcon",g="date",c="mode",f="demobrowser.demo.virtual.tree.TreeItem",e="Boolean",b="checked",a="String",d="value";qx.Class.define(f,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:a,event:o,nullable:true},checked:{check:e,event:k,nullable:true},size:{check:a,event:n,nullable:true},date:{check:a,event:l,nullable:true},mode:{check:a,event:m,nullable:true}},members:{__Ry:null,__Rz:null,__RA:null,__RB:null,__fr:null,_addWidgets:function(){var q=this.__Ry=new qx.ui.basic.Image();this.bind(h,q,p);q.setWidth(16);this.addWidget(q);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(j);var r=this.__Rz=new qx.ui.form.CheckBox();this.bind(b,r,d);r.bind(d,this,b);r.setFocusable(false);r.setTriState(true);r.setMarginRight(4);this.addWidget(r);this.addLabel();this.addWidget(new qx.ui.core.Spacer(),{flex:1});var s=this.__RA=new qx.ui.basic.Label();this.bind(i,s,d);s.setWidth(50);this.addWidget(s);s=this.__RB=new qx.ui.basic.Label();this.bind(g,s,d);s.setWidth(150);this.addWidget(s);s=this.__fr=new qx.ui.basic.Label();this.bind(c,s,d);s.setWidth(80);this.addWidget(s);}
}});}
)();
...
(function(){var r="_applyAllowEmptySelection",q="_applyInvalidMessage",p="qx.ui.form.RadioGroup",o="_applyValid",n="",m="changeRequired",k="changeValid",j="changeEnabled",h="__mQ",g="changeSelection",c="_applyEnabled",f="changeInvalidMessage",d="changeValue",b="String",a="Boolean";qx.Class.define(p,{extend:qx.core.Object,implement:[qx.ui.core.ISingleSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MSingleSelectionHandling,qx.ui.form.MModelSelection],construct:function(s){qx.core.Object.call(this);this.__mQ=[];this.addListener(g,this.__mR,this);if(s!=null){this.add.apply(this,arguments);}
;}
,properties:{enabled:{check:a,apply:c,event:j,init:true},wrap:{check:a,init:true},allowEmptySelection:{check:a,init:false,apply:r},valid:{check:a,init:true,apply:o,event:k},required:{check:a,init:false,event:m},invalidMessage:{check:b,init:n,event:f,apply:q},requiredInvalidMessage:{check:b,nullable:true,event:f}},members:{__mQ:null,getItems:function(){return this.__mQ;}
,add:function(t){var u=this.__mQ;var v;for(var i=0,l=arguments.length;i<l;i++){v=arguments[i];if(qx.lang.Array.contains(u,v)){continue;}
...
;}
,remove:function(w){var x=this.__mQ;if(qx.lang.Array.contains(x,w)){qx.lang.Array.remove(x,w);if(w.getGroup()===this){w.resetGroup();}
...
;}
,_applyInvalidMessage:function(z,A){for(var i=0;i<this.__mQ.length;i++){this.__mQ[i].setInvalidMessage(z);}
;}
,_applyValid:function(B,C){for(var i=0;i<this.__mQ.length;i++){this.__mQ[i].setValid(B);}
;}
,_applyEnabled:function(D,E){var F=this.__mQ;if(D==null){for(var i=0,l=F.length;i<l;i++){F[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var I=this.getSelection()[0];var K=this.__mQ;var J=K.indexOf(I);if(J==-1){return;}
...
,selectPrevious:function(){var L=this.getSelection()[0];var N=this.__mQ;var M=N.indexOf(L);if(M==-1){return;}
...
,_isItemSelectable:function(O){return this.__mQ.indexOf(O)!=-1;}
,__mR:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
