...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Cookie","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Cookie-qx.theme.Classic.50c2a6ee83d7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="demobrowser.demo.bom.Cookie",f="Save",d="Restore",c="Delete",b="execute",a="";qx.Class.define(g,{extend:qx.application.Standalone,statics:{COOKIE_KEY:"TextFieldContent"},members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));this.getRoot().add(k,{left:20,top:20});var i=new qx.ui.form.TextField();k.add(i);var h=new qx.ui.form.Button(f);k.add(h);h.addListener(b,function(e){if(i.getValue()!=a){qx.bom.Cookie.set(demobrowser.demo.bom.Cookie.COOKIE_KEY,i.getValue());i.setValue(a);}
;}
,this);var j=new qx.ui.form.Button(d);k.add(j);j.addListener(b,function(e){var m=qx.bom.Cookie.get(demobrowser.demo.bom.Cookie.COOKIE_KEY);i.setValue(m!=null?m:a);}
,this);var l=new qx.ui.form.Button(c);k.add(l);l.addListener(b,function(e){qx.bom.Cookie.del(demobrowser.demo.bom.Cookie.COOKIE_KEY);i.setValue(a);}
,this);}
}});}
)();
