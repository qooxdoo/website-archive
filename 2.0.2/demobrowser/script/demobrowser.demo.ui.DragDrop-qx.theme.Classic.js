...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop-qx.theme.Classic.2b363233f1b0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
);var K=new qx.ui.basic.Label(h);G.add(K,{left:500,top:20});var E=this.__Di=new qx.ui.form.List;E.setDraggable(true);E.setDroppable(true);E.setSelectionMode(s);G.add(E,{left:500,top:40});for(var i=0;i<20;i++){E.add(new qx.ui.form.ListItem(v+i,x));}
...
);E.addListener(m,function(e){var X=e.getOriginalTarget();if(X instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Rk=X;}
...
;}
);E.addListener(q,function(e){this.__Rl(e.getOriginalTarget());}
,this);F.addListener(q,function(e){this.__Rl(this.__Rk);}
,this);}
,__Rl:function(Y){if(Y.classname!=g){return;}
;var ba=this.__Di.getSortedSelection();for(var i=0,l=ba.length;i<l;i++){this.__Di.addBefore(ba[i],Y);this.__Di.addToSelection(ba[i]);}
;}
