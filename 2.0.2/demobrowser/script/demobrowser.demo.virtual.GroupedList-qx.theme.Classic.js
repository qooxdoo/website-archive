...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Classic.f1eae5a86e0e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
};T.setDelegate(V);T.setSelection(this.__Di.getSelection());return U;}
,createThirdExample:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var be=new qx.ui.basic.Label(z).set({font:n});bc.add(be);var bb=this.__Ru=new qx.ui.list.List().set({height:280,width:150,labelPath:p,labelOptions:{converter:function(bf,bg){return bg?bf+o+bg.getLastname():v;}
...
};bb.setDelegate(bd);bb.setSelection(this.__Di.getSelection());return bc;}
},destruct:function(){this.__Di.dispose();this.__Rt.dispose();this.__Ru.dispose();this.__Di=this.__Rt=this.__Ru=null;}
});}
)();
