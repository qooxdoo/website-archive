...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_5","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_5-qx.theme.Modern.d69a4640876a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="backgroundColor",u="col",t="fontSize",s="width",r="red",q="height",p="marginBottom",o="1px",n="demobrowser.demo.test.Element_5",m="marginRight",d="clear",l="test",g="2px solid black",c="border",b="2px",f="row",e="12px",h="id",a="float",k="left";qx.Class.define(n,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var w=new qx.html.Root(document.getElementById(l));var x=new qx.html.Element;x.setStyle(a,k);x.setStyle(c,g);x.setStyle(t,o);w.add(x);var z,y;for(var i=0;i<40;i++){z=new qx.html.Element;z.setAttribute(h,f+i);z.setStyle(p,b);z.setStyle(a,k);z.setStyle(d,k);x.add(z);for(var j=0;j<40;j++){y=new qx.html.Element;y.setAttribute(h,f+i+u+j);y.setStyle(m,b);y.setStyle(a,k);y.setStyle(s,e);y.setStyle(q,e);y.setStyle(v,r);z.add(y);}
;}
;}
}});}
)();
