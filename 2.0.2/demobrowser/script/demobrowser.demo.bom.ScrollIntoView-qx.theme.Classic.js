...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.ScrollIntoView","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.ScrollIntoView-qx.theme.Classic.624493a9fbc0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="z6",o="z8",n="z5",m="z4",k="Height: ",j="z1",h="Width: ",g="z7",f="z3",e="z2",b="demobrowser.demo.bom.ScrollIntoView",d=", scroll=",c=", client=",a=": offset=";qx.Class.define(b,{extend:qx.application.Native,statics:{test:function(){var r=[j,e,f,m,n,p,g,o];for(var i=0,l=r.length;i<l;i++){var q=document.getElementById(r[i]);qx.log.Logger.info(h+r[i]+a+q.offsetWidth+d+q.scrollWidth+c+q.clientWidth);qx.log.Logger.info(k+r[i]+a+q.offsetHeight+d+q.scrollHeight+c+q.clientHeight);}
;}
}});}
)();
