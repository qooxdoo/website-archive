...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Background-qx.theme.Indigo.3f1ab4064530.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="#box1_7",i="#box2_3",h="#box1_1",g="#box2_1",f="#box1_5",e="#box2_4",d="#box1_2",c="#box2_6",b="demobrowser.demo.bom.Background",a="#box1_8",z="#box2_8",y="#box2_2",x="#box1_4",w="#box1_6",v="#box2_5",u="#box1_3",t="#box2_7",s="qx/icon/Tango/48/devices/drive-optical.png",r="bottom",p="repeat-y",n="right",o="repeat-x",l="no-repeat",m="center",k="repeat";qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var q=qx.bom.Collection;var A=qx.util.ResourceManager.getInstance().toUri(s);q.query(h).setCss(qx.bom.element.Background.compile(A));q.query(d).setCss(qx.bom.element.Background.compile(A,o));q.query(u).setCss(qx.bom.element.Background.compile(A,p));q.query(x).setCss(qx.bom.element.Background.compile(A,k,10));q.query(f).setCss(qx.bom.element.Background.compile(A,k,0,10));q.query(w).setCss(qx.bom.element.Background.compile(A,k,10,10));q.query(j).setCss(qx.bom.element.Background.compile(A,l,m,m));q.query(a).setCss(qx.bom.element.Background.compile(A,l,n,r));q.query(g).setStyles(qx.bom.element.Background.getStyles(A));q.query(y).setStyles(qx.bom.element.Background.getStyles(A,o));q.query(i).setStyles(qx.bom.element.Background.getStyles(A,p));q.query(e).setStyles(qx.bom.element.Background.getStyles(A,k,10));q.query(v).setStyles(qx.bom.element.Background.getStyles(A,k,0,10));q.query(c).setStyles(qx.bom.element.Background.getStyles(A,k,10,10));q.query(t).setStyles(qx.bom.element.Background.getStyles(A,l,m,m));q.query(z).setStyles(qx.bom.element.Background.getStyles(A,l,n,r));}
}});}
)();
