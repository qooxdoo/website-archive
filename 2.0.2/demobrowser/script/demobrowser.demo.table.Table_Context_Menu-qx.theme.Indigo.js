...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Context_Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Context_Menu-qx.theme.Indigo.d3de0b7e4b2c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var k=this.__MW[l];var i=this.getTableModel();g=new qx.ui.menu.Menu();g.addListener(f,function(e){e.preventDefault();}
...
,this);this.__MV=[];this.__MW=[];}
,members:{__MV:null,__MW:null,setContextMenuHandler:function(m,n,o){this.__MV[m]=n;this.__MW[m]=o||this;}
,getContextMenuHandler:function(p){return this.__MV[p];}
},destruct:function(){this.__MV=null;this.__MW=null;}
});}
)();
