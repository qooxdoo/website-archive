...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ScrollBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ScrollBar.0779f38418f7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="horizontal",d="demobrowser.demo.widget.ScrollBar",c="vertical",b="scroll",a="Value: ";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({padding:20});this.getRoot().add(h,{edge:0});var j=new qx.ui.basic.Label(a).set({padding:30});h.add(j,{row:0,column:0});var i=new qx.ui.core.scroll.ScrollBar(c).set({height:200,maximum:500});i.addListener(b,function(e){g.setPosition(e.getData());}
);h.add(i,{row:0,column:1});var g=new qx.ui.core.scroll.NativeScrollBar(f).set({width:300,maximum:500});g.addListener(b,function(e){i.setPosition(e.getData());j.setValue(a+e.getData());}
);h.add(g,{row:1,column:0});g.setPosition(170);}
}});}
)();
