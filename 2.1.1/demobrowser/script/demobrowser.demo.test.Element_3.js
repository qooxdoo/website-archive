...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_3.ac60f2a94776.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="text",h="blur",g="demobrowser.demo.test.Element_3",f="focus",d="type",c="test",b="input",a="focusin";qx.Class.define(g,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var j=new qx.html.Root(document.getElementById(c));var k=new qx.html.Element(b);k.setAttribute(d,i);k.focus();k.addListener(f,function(e){qx.log.Logger.debug("Element focused");}
