...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererCustom.7a57c250d0f9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(s,{extend:qx.ui.form.renderer.Single,members:{__Tb:0,__Tc:0,addItems:function(C,D,E,F){var I=0;if(E!=null){this._add(this._createHeader(E),{row:I,column:this.__Tb,colSpan:2});I++;}
;for(var i=0;i<C.length;i++){var H=this._createLabel(D[i],C[i]);this._add(H,{row:I,column:this.__Tb});var G=C[i];H.setBuddy(G);if(G instanceof qx.ui.form.RadioGroup){G=this._createWidgetForRadioGroup(G);}
;this._add(G,{row:I,column:this.__Tb+1});if(F[i]&&F[i].placeholder){G.setPlaceholder(F[i].placeholder);}
;I++;}
;this.__Tb+=2;this.__Tc<I?this.__Tc=I:null;}
,addButton:function(J){if(this._buttonRow==null){this._buttonRow=new qx.ui.container.Composite();this._buttonRow.setMarginTop(5);var K=new qx.ui.layout.HBox();K.setAlignX(f);K.setSpacing(5);this._buttonRow.setLayout(K);this._add(this._buttonRow,{row:this.__Tc,column:0,colSpan:this.__Tb});}
