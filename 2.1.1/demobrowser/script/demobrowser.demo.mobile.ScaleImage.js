...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.1091e630d77e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="touchmove",j="height",i="url(",h="green",g="deg) scale(",f="200px",d="30px",c="qx.debug",b="12px",a="event.touch",C="-webkit-transform",B="touchend",A="width",z='Lucida Grande',y="innerHTML",x="demobrowser.demo.mobile.ScaleImage",w="59px",v="engine.name",u="demobrowser/demo/mobile/qooxdoo-logo.png",t="20px",r="rotate(",s="webkit",p="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",q="px",n=")",o="50px",l="absolute",m="div";qx.Class.define(x,{extend:qx.application.Native,members:{__GI:null,__MQ:1,__MR:0,__MS:0,__MT:0,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(c)){qx.log.appender.Native;qx.log.appender.Console;}
;var F=new qx.html.Element(m);F.useElement(document.body);F.setRoot(true);if(qx.core.Environment.get(v)!=s||!qx.core.Environment.get(a)){var E={"color":h,"position":l,"font-family":z,"font-size":b,"left":d,"top":t};var H=new qx.html.Element(m,E);F.add(H);H.setAttribute(y,p);return;}
;var G=qx.util.ResourceManager.getInstance().toUri(u);var D={"width":f,"height":w,"position":l,"left":o,"top":o,"background":i+G+n};this.__GI=new qx.html.Element(m,D);this.__GI.addListener(k,this.__Dx,this);this.__GI.addListener(B,this.__Dw,this);F.add(this.__GI);}
,__Dx:function(e){if(e.isMultiTouch()){this.__MS=e.getRotation()+this.__MR;this.__MT=e.getScale()*this.__MQ;this.__GI.setStyle(C,r+this.__MS+g+this.__MT+n);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__GI.getStyle(A))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__GI.getStyle(j))/2);this.__GI.setStyles({"left":I+q,"top":top+q});}
;}
,__Dw:function(e){if(e.isMultiTouch()){this.__MR=this.__MS;this.__MQ=this.__MT;}
;}
}});}
)();
