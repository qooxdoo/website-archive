...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_VarRowHeight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight.453640eac7a6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="small icon",u="This, too, is tall.",t="No attributes specified.",s="1*",q="demobrowser/demo/icons/",p="",o="TALL ICON",n="I am tall.",m="red",l="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",d="format-justify-left.png",k="I am small.",g="end",c="multimedia-player.png",b="This, too, is small.",f="Id",e="Image",h="Note variable row heights in this table.",a="row";qx.Class.define(l,{extend:qx.application.Standalone,members:{__Sy:null,main:function(){qx.application.Standalone.prototype.main.call(this);var A=q;this.imageData=[{url:A+d,height:4,tooltip:v},{url:A+c,height:4,tooltip:o},p];this.__Sy=0;var y=qx.util.AliasManager.getInstance();var x=qx.util.ResourceManager.getInstance();var w;var z;for(var i=0;i<this.imageData.length;i++){if(!this.imageData[i]){continue;}
;w=y.resolve(this.imageData[i].url);z=x.toUri(w);this.imageData[i].url=z;++this.__Sy;qx.io.ImageLoader.load(z,function(B,C){this.info("Searching for ["+B+"]");for(var j=0;j<this.imageData.length;j++){if(this.imageData[j].url==B){this.imageData[j].height=C.height;--this.__Sy;this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Sy+", end="+this.imageData.length);if(this.__Sy==0){this.doLoad();}
;return;}
;}
;throw new Error("Image data for "+B+" not found");}
,this);}
;if(this.__Sy==0){this.doLoad();}
;}
,doLoad:function(){var E=this;var L=function(P,Q){var R={renderer:a,location:g,data:[Q,E.imageData[P]]};return R;}
;var K=new qx.ui.progressive.renderer.table.Widths(2);K.setWidth(0,200);K.setWidth(1,s);var G=[f,e];var H=new qx.ui.progressive.headfoot.TableHeading(K,G);var F=new qx.ui.progressive.headfoot.Progress(K,G);var O=new qx.ui.progressive.structure.Default(H,F);var D=new qx.ui.progressive.Progressive(O);var M=new qx.ui.basic.Atom(h);M.setHeight(16);M.setTextColor(m);D.add(M);var J=new qx.ui.progressive.model.Default();var I=[];I.push(L(0,k));I.push(L(1,n));I.push(L(0,b));I.push(L(1,u));I.push(L(2,t));J.addElements(I);D.setDataModel(J);var N=new qx.ui.progressive.renderer.table.Row(K);D.addRenderer(a,N);var r=new qx.ui.progressive.renderer.table.cell.Image();N.addRenderer(1,r);D.set({width:400,maxWidth:400});this.getRoot().add(D,{left:50,top:50,bottom:50});D.render();}
}});}
)();
...
(function(){var c="qx.ui.progressive.renderer.table.cell.Image",b="string",a="";qx.Class.define(c,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(d,e){qx.ui.progressive.renderer.table.cell.Icon.call(this);if(d===undefined){this.__rl=d;}
else {this.__rl=16;}
;if(e===undefined){this.__rm=e;}
else {this.__rm=16;}
;}
,members:{__rl:null,__rm:null,_identifyImage:function(f){var j={imageWidth:this.__rl,imageHeight:this.__rm};var k;if(typeof (f.cellData)==b){j.url=f.cellData;}
