...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Window.6e40db559398.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="resize",l="qx.ui.root.Page",k="mshtml",j="gecko",i="paddingLeft",h="$$widget",g="left",f="paddingTop",d="qxIsRootPage",c="absolute",a="engine.name",b="div";qx.Class.define(l,{extend:qx.ui.root.Abstract,construct:function(n){this.__li=n;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(m,this.__kI,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(a)==k)){this.setKeepFocus(true);}
;}
,members:{__jC:null,__li:null,_createContainerElement:function(){var p=this.__li.createElement(b);this.__li.body.appendChild(p);var o=new qx.html.Root(p);o.setStyles({position:c,textAlign:g});o.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(a)==j)){o.setAttribute(d,1);}
;return o;}
...
,__kI:function(e){this.getContainerElement().setStyles({width:0,height:0});this.getContentElement().setStyles({width:0,height:0});}
...
;this.__Cv=u;u.style.overflow=m;u.style.textAlign=k;this.__Cw=v||false;this.__Cx=w||false;this.__Cy();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(b)==g)){this.setKeepFocus(true);}
;var window=qx.dom.Node.getWindow(u);qx.event.Registration.addListener(window,f,this._onWindowResize,this);}
,members:{__Cw:false,__Cx:false,__Cv:null,__Cy:function(){if(this.__Cw||this.__Cx){var x=qx.bom.element.Dimension.getSize(this.__Cv);if(this.__Cw&&x.width<1){throw new Error("The root element "+this.__Cv+" of "+this+" needs a width when its width size should be used!");}
;if(this.__Cx){if(x.height<1){throw new Error("The root element "+this.__Cv+" of "+this+" needs a height when its height size should be used!");}
;if(x.height>=1&&qx.bom.element.Style.get(this.__Cv,a,3)==t){qx.bom.element.Style.set(this.__Cv,a,x.height+s);}
;}
;qx.event.Registration.addListener(this.__Cv,f,this._onResize,this);}
;}
,_createContainerElement:function(){var y=this.__Cv;if(this.__Cw||this.__Cx){var C=document.createElement(l);y.appendChild(C);if((qx.core.Environment.get(b)==g)&&qx.core.Environment.get(p)==6){var B=qx.dom.Node.getBodyElement(y);var A;var E;var D=false;var z=qx.dom.Hierarchy.getAncestors(y);for(var i=0,j=z.length;i<j;i++){A=z[i];if(A!=B){E=qx.bom.element.Style.get(A,r);if(E==d){D=true;break;}
;}
else {break;}
;}
...
,this,0);return F;}
,_onResize:function(e){var G=e.getData();if((G.oldWidth!==G.width)&&this.__Cw||(G.oldHeight!==G.height)&&this.__Cx){qx.ui.core.queue.Layout.add(this);}
;}
,_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();}
;if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();}
;}
,_computeSizeHint:function(){var L=this.__Cw;var I=this.__Cx;if(!L||!I){var H=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {H={};}
;var M=qx.bom.element.Dimension;if(L){var K=M.getContentWidth(this.__Cv);H.width=K;H.minWidth=K;H.maxWidth=K;}
;if(I){var J=M.getContentHeight(this.__Cv);H.height=J;H.minHeight=J;H.maxHeight=J;}
;return H;}
},defer:function(N,O){qx.ui.core.MLayoutHandling.remap(O);}
,destruct:function(){qx.event.Registration.removeListener(this.__Cv,f,this._onResize,this);this.__Cv=null;}
});}
)();
(function(){var f="resize",d="interval",c="__jC",b="body",a="qx.event.handler.ElementResize";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__eH=g;this.__CS={};this.__jC=new qx.event.Timer(200);this.__jC.addListener(d,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__CS:null,__eH:null,__jC:null,canHandleEvent:function(h,i){return h.tagName.toLowerCase()!==b;}
,registerEvent:function(j,k,l){var n=qx.core.ObjectRegistry.toHashCode(j);var m=this.__CS;if(!m[n]){m[n]={element:j,width:qx.bom.element.Dimension.getWidth(j),height:qx.bom.element.Dimension.getHeight(j)};this.__jC.start();}
;}
,unregisterEvent:function(o,p,q){var s=qx.core.ObjectRegistry.toHashCode(o);var r=this.__CS;if(r[s]){delete r[s];if(qx.lang.Object.isEmpty(r)){this.__jC.stop();}
;}
;}
...
;}
;}
},destruct:function(){this.__eH=this.__CS=null;this._disposeObjects(c);}
