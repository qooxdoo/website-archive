...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Basic.d56f1396cc3d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="black",f="red",e="demobrowser.demo.layout.Basic",d="green",c="yellow",b="solid",a="blue";qx.Class.define(e,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var h=g;var n=new qx.ui.decoration.Single(3,b,h);var m=new qx.ui.core.Widget().set({backgroundColor:f,decorator:n,marginLeft:10,minHeight:200});var l=new qx.ui.core.Widget().set({backgroundColor:a,decorator:n});var k=new qx.ui.core.Widget().set({backgroundColor:d,decorator:n,padding:3,height:300});var j=new qx.ui.core.Widget().set({backgroundColor:c,decorator:n,padding:10,width:400});var i=new qx.ui.container.Composite(new qx.ui.layout.Basic());i.add(m,{left:10,top:10});i.add(l,{left:200,top:20});i.add(k,{left:350,top:50});i.add(j,{left:50,top:200});this.getRoot().add(i,{edge:0});}
}});}
)();
