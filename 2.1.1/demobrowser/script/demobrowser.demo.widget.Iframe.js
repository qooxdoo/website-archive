...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.3aee4be955c2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="qx.event.type.DataEvent",j="W3C",i="../welcome.html",h="load",g="demobrowser.demo.widget.Iframe",f="changeSelection",c="local",b="http://www.w3.org/",a="url";qx.Class.define(g,{extend:qx.application.Standalone,events:{"surfTo":k},members:{main:function(){qx.application.Standalone.prototype.main.call(this);var m=new qx.ui.embed.ThemedIframe();var d=this.getRoot();m.addListener(h,function(e){this.debug("Loaded: "+this.getSource());}
);m.setSource(b);d.add(m,{top:100,right:20,bottom:20,left:20});var n=new qx.ui.form.RadioButton(j);n.setUserData(a,b);var o=new qx.ui.form.RadioButton(c);o.setUserData(a,i);n.setValue(true);var l=new qx.ui.form.RadioGroup(n,o);l.addListener(f,function(e){this.setSource(e.getData()[0].getUserData(a));}
,m);d.add(n,{left:20,top:48});d.add(o,{left:120,top:48});}
}});}
)();
...
,properties:{appearance:{refine:true,init:n},scrollbarX:{check:[j,f,c],init:j,themeable:true,apply:k},scrollbarY:{check:[j,f,c],init:j,themeable:true,apply:k},scrollbar:{group:[p,o]}},members:{__FP:null,__FQ:null,_getIframeElement:function(){return this.getChildControl(a).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__FQ){this._stopIframeObserver();}
;var E=qx.event.Idle.getInstance();this.__FQ=E.addListener(t,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__FP=null;if(!this.__FQ){return;}
;var F=qx.event.Idle.getInstance();F.removeListenerById(this.__FQ);}
,_onIframeObserverInterval:function(){var G=this._getIframeSize();if(!G){this._disableScollbars();return;}
;if(this.__FP&&G.width==this.__FP.width&&G.height==this.__FP.height){return;}
;this.__FP=G;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var J=this.__FP;var M=this.getChildControl(a).getBounds();var K=this.getChildControl(a).getInnerSize();if(!J||!K||!K){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__FP=null;}
});}
)();
