...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Overflow.133a764356a3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.bom.Overflow";qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var b=qx.bom.element.Overflow;this.info("#0");this.debug("1: "+b.getX(document.getElementById("test1"))+", "+b.getY(document.getElementById("test1")));this.debug("2: "+b.getX(document.getElementById("test2"))+", "+b.getY(document.getElementById("test2")));this.debug("3: "+b.getX(document.getElementById("test3"))+", "+b.getY(document.getElementById("test3")));this.info("#1");this.debug("9a: "+b.getX(document.getElementById("test9a"))+", "+b.getY(document.getElementById("test9a")));this.debug("9b: "+b.getX(document.getElementById("test9b"))+", "+b.getY(document.getElementById("test9b")));this.debug("9c: "+b.getX(document.getElementById("test9c"))+", "+b.getY(document.getElementById("test9c")));this.debug("9d: "+b.getX(document.getElementById("test9d"))+", "+b.getY(document.getElementById("test9d")));this.info("#2");this.debug("9e: "+b.getX(document.getElementById("test9e"))+", "+b.getY(document.getElementById("test9e")));this.debug("9f: "+b.getX(document.getElementById("test9f"))+", "+b.getY(document.getElementById("test9f")));this.debug("9g: "+b.getX(document.getElementById("test9g"))+", "+b.getY(document.getElementById("test9g")));this.debug("9h: "+b.getX(document.getElementById("test9h"))+", "+b.getY(document.getElementById("test9h")));this.info("#3");this.debug("9i: "+b.getX(document.getElementById("test9i"))+", "+b.getY(document.getElementById("test9i")));this.debug("9j: "+b.getX(document.getElementById("test9j"))+", "+b.getY(document.getElementById("test9j")));this.debug("9k: "+b.getX(document.getElementById("test9k"))+", "+b.getY(document.getElementById("test9k")));this.debug("9l: "+b.getX(document.getElementById("test9l"))+", "+b.getY(document.getElementById("test9l")));this.info("#4");this.debug("9m: "+b.getX(document.getElementById("test9m"))+", "+b.getY(document.getElementById("test9m")));this.debug("9n: "+b.getX(document.getElementById("test9n"))+", "+b.getY(document.getElementById("test9n")));this.debug("9o: "+b.getX(document.getElementById("test9o"))+", "+b.getY(document.getElementById("test9o")));this.debug("9p: "+b.getX(document.getElementById("test9p"))+", "+b.getY(document.getElementById("test9p")));}
}});}
)();
