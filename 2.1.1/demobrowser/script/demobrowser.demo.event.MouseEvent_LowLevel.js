...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel.c34587dfba0f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="demobrowser.demo.event.MouseEvent_LowLevel",k="mouseout",j="mousedown",h="clientX",g="dblclick",f="relatedTarget",d="button",c="mousemove",b="screenX",a="logger",y="",x="_",w="mouseover",v="check_",u="click",t="Event",s="Target",r="clientY",q="mouseup",p="contextmenu",n="change",o="screenY",m="mouse";qx.Class.define(l,{extend:demobrowser.demo.event.EventDemo,members:{__Sc:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this.__Sc=qx.lang.Function.bind(this.logMouseEvent,this);this._initLogger([s,t,d,h,r,b,o,f],document.getElementById(a),50);var z=document.getElementById(m);var A=[j,q,u,g,p,c,w,k];for(var i=0;i<A.length;i++){var B=document.getElementById(v+A[i]);if(B.checked){qx.bom.Event.addNativeListener(z,A[i],this.__Sc);}
;qx.bom.Event.addNativeListener(B,n,qx.lang.Function.bind(this.__Sb,this));}
;}
,__Sb:function(e){var F=qx.bom.Event.getTarget(e);var E=F.id.split(x)[1];var C=F.checked;var D=document.getElementById(m);if(C){qx.bom.Event.addNativeListener(D,E,this.__Sc);}
else {qx.bom.Event.removeNativeListener(D,E,this.__Sc);}
;}
