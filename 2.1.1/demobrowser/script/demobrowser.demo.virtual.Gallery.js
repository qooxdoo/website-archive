...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery.9bdf0f92b91b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
}});qx.Class.define(g,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bv){demobrowser.demo.virtual.AbstractGallery.call(this,bv);this.__Th=new demobrowser.demo.virtual.GalleryCell();}
,members:{__Th:null,_createScroller:function(){var bw=new qx.ui.virtual.core.Scroller(1,this.itemPerLine,this.itemHeight,this.itemWidth);this.layer=new qx.ui.virtual.layer.WidgetCell(this);bw.getPane().addLayer(this.layer);new qx.ui.virtual.behavior.Prefetch(bw,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:200,maxAbove:300,minBelow:600,maxBelow:800}).set({interval:500});return bw;}
...
;if(bz){this.__Th.updateStates(bB,{selected:1});}
else {this.__Th.updateStates(bB,{});}
;}
;}
...
;var bH=this.__Th.getCellWidget(bI,bG);bH.setUserData(x,bF);return bH;}
,poolCellWidget:function(bJ){this.__Th.pool(bJ);}
...
;var bU=this.manager.isItemSelected({row:bR,column:bS});var bT=bU?a:y;return {style:[u,d,this._fontCss,bT].join(y),content:[Q,bV.resolvedIcon,O,z,bV.label].join(y)};}
