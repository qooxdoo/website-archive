...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.a1b857f281d4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="_applySearchString",c="demobrowser.demo.data.filter.SearchAsYouTypeFilter",b="String",a="";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__uE=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__tI=null;}
,properties:{searchString:{check:b,apply:d,init:a}},members:{__tI:null,__uE:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();if(this.__tI!=null){i.stop(this.__tI);this.__tI=null;}
;this.__tI=i.start(function(){this.__uE.update();this.__tI=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__uE=null;}
});}
)();
