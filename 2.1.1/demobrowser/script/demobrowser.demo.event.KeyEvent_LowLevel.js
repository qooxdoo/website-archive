...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.KeyEvent_LowLevel.e5515807b91d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(n,o,p){this.__RW=f+n.join(j)+l;this.__RX=p||50;this.__RY=o;this._clearLog();}
,_clearLog:function(){this.__RY.innerHTML=this.__RW+a;this.__Sa=[];}
,_log:function(q){this.__Sa.unshift(q);this.__Sa=this.__Sa.slice(0,this.__RX);var r=[this.__RW];for(var i=0;i<this.__Sa.length;i++){r.push(e,this.__Sa[i].join(g),b);}
;r.push(a);this.__RY.innerHTML=r.join(h);this.__RY.scrollTop=0;}
,__RW:null,__RX:null,__RY:null,__Sa:null},destruct:function(){this.__RY=this.__Sa=null;}
});}
)();
...
(function(){var n="logger",m="keypress",l="",k="char code",j="Ctrl",h="key identifier",g="Shift",f="demobrowser.demo.event.KeyEvent_LowLevel",e="keydown",d="Event",a="Alt",c="keyup",b="key code";qx.Class.define(f,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this.debug(qx.core.Environment.get("engine.version"));this._initLogger([d,b,k,h,g,j,a],document.getElementById(n),50);var o=[e,m,c];for(var i=0;i<o.length;i++){qx.bom.Event.addNativeListener(document.documentElement,o[i],qx.lang.Function.bind(this.logKeyEvent,this));}
;}
,logKeyEvent:function(p){var q=p.type;this._log([q,p.keyCode,p.charCode,p.keyIdentifier||l,p.shiftKey,p.ctrlKey,p.altKey]);qx.bom.Event.preventDefault(p);}
}});}
)();
