...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation.3dca2bf72b05.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="360deg",j="bottom left",i="div",h="3D",g="both",f="button",d="demobrowser.demo.animation.Animation",c="200px",b="10deg",a="h1",M="Sorry, no CSS transforms supported",L="3d",K="50px",J="click",I='label',H="Fast Width",G="ease-in",F="css.animation",E="padding-top",D="CSS animations not supported, sorry!",r="180deg",s="-20deg",p="-50px",q="name",n="bottom center",o="left bottom",l="20px",m="not-allowed",t="ease-out",u="red",x="css.transform",w="3deg",z="90deg",y="-10px",B="10px",A="-3deg",v="0px",C="0deg";qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(F)==null){var U=document.createElement(I);U.innerHTML=D;document.body.appendChild(U);return;}
;var bf={duration:1000,timing:t,keyFrames:{'0':{},'70':{"width":c},'100':{}}};var S={duration:1000,keyFrames:{'0':{"scale":[1,1],"rotate":[C,C],"skew":C,"translate":v},'50':{"scale":[1,0.2],"rotate":[C,z],"skew":b,"translate":p},'100':{"scale":[1,1],"rotate":[C,C],"skew":C,"translate":v}}};var P={duration:1000,keyFrames:{'0':{"translate":[v,v]},'50':{"translate":[K,l]},'100':{"translate":[v,v]}}};var O={duration:1000,origin:n,keyFrames:{'0':{"scale":[1,1]},'50':{"scale":[2,0.1]},'100':{"scale":[1,1]}}};var bc={duration:1000,keep:100,keyFrames:{'0':{"rotate":C},'100':{"rotate":k}}};var bb={duration:1000,keyFrames:{'0':{"rotate":[C,C,C]},'50':{"rotate":[r,r,z]},'100':{"rotate":[C,C,C]}}};var Q={duration:1000,origin:j,keyFrames:{'0':{"skew":C},'50':{"skew":s},'100':{"skew":C}}};var ba={duration:1000,keyFrames:{'0':{translate:v},'10':{translate:y},'20':{translate:B},'30':{translate:y},'40':{translate:B},'50':{translate:y},'60':{translate:B},'70':{translate:y},'80':{translate:B},'90':{translate:y},'100':{translate:v}}};var bd={duration:1000,keyFrames:{'0':{scale:1,rotate:C},'10':{scale:0.9,rotate:A},'20':{scale:0.9,rotate:A},'30':{scale:1.1,rotate:w},'40':{scale:1.1,rotate:A},'50':{scale:1.1,rotate:w},'60':{scale:1.1,rotate:A},'70':{scale:1.1,rotate:w},'80':{scale:1.1,rotate:A},'90':{scale:1.1,rotate:w},'100':{scale:1,rotate:C}}};var N={duration:500,origin:o,keyFrames:{'0':{opacity:1,rotate:C},'100':{opacity:0,rotate:z}}};var X={duration:500,origin:o,keyFrames:{'0':{opacity:0,rotate:z},'100':{opacity:1,rotate:C}}};var be={duration:500,timing:t,keyFrames:{'0':{translate:[null,v],opacity:1},'30':{translate:[null,B],opacity:1},'100':{translate:[null,p],opacity:0}}};var R={duration:1000,keep:100,timing:G,origin:n,keyFrames:{'0':{rotate:[C],skew:[C]},'30':{rotate:[z],skew:[s]},'100':{rotate:[C],skew:[C]}}};var T={"Tada":bd,"Shake":ba,"Skew":Q,"Rotate":bc,"Scale":O,"translate":P,"Width":bf,"Fast Width":bf,"Rotate Out":N,"Rotate In":X,"Up and out":be,"3D Rotate":bb,"3D Transform":S,"3D Fall":R};for(var V in T){var Y=document.createElement(i);Y.innerHTML=V;Y.className=f;document.body.appendChild(Y);if(!(qx.core.Environment.get(x)[q])){Y.style.color=u;Y.style.cursor=m;continue;}
;if(V.indexOf(h)!=-1&&!(qx.core.Environment.get(x)[L])){Y.style.color=u;Y.style.cursor=m;continue;}
;Y.addEventListener(J,(function(bg,bh){return function(e){qx.bom.element.Animation.animate(e.target,bg,bh==H?300:undefined);}
;}
)(T[V],V));}
;if(!(qx.core.Environment.get(x)[q])){var W=document.createElement(a);W.style.color=u;W.style.clear=g;W.style[E]=l;W.innerHTML=M;document.body.appendChild(W);}
;}
}});}
)();
