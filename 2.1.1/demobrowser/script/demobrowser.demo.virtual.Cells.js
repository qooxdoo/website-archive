...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells.9dedbf1b9921.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,testStringCell:function(){var C={value:[m,o,k,null],states:[{},{selected:1}]};var B=new qx.ui.virtual.cell.String;qx.util.Permutation.permute(C,function(D){var E=this.__KN(B,D.value,D.states);this.container.add(E);}
,this);}
...
;var I=this.__KN(G,H.value,H.states);this.container.add(I);}
,this);}
...
;var M=this.__KN(K,L.value,L.states);this.container.add(M);}
,this);}
,testHtmlCell:function(){var N={value:[m,o,k,null],states:[{},{selected:1}]};var O=new qx.ui.virtual.cell.Html;qx.util.Permutation.permute(N,function(P){var Q=this.__KN(O,P.value,P.states);this.container.add(Q);}
,this);}
,testImageCell:function(){var R={value:[{url:q,tooltip:n},{url:t,tooltip:v},null],states:[{},{selected:1}]};var S=new qx.ui.virtual.cell.Image;qx.util.Permutation.permute(R,function(T){var U=this.__KN(S,T.value,T.states);this.container.add(U);}
,this);}
,testBooleanCell:function(){var V={value:[true,false,null],states:[{},{selected:1}]};var W=new qx.ui.virtual.cell.Boolean;qx.util.Permutation.permute(V,function(X){var Y=this.__KN(W,X.value,X.states);this.container.add(Y);}
,this);}
,testBooleanCellCustomImage:function(){var ba={value:[true,false,null],states:[{},{selected:1}]};var bb=new qx.ui.virtual.cell.Boolean;bb.setIconFalse(r);bb.setIconTrue(p);qx.util.Permutation.permute(ba,function(bc){var bd=this.__KN(bb,bc.value,bc.states);this.container.add(bd);}
,this);}
,__KN:function(be,bf,bg){var bk=100;var bi=30;var bm=new qx.ui.embed.Html().set({width:bk,height:bi,decorator:bg.selected?null:"main"});var bh=be.getCellProperties(bf,bg);var bj=bh.insets;var bl=["<div ","style='",this._getCellSizeStyle(bk,bi,bj[0],bj[1]),bh.style,"' ","class='",bh.classes,"' ",bh.attributes,">",bh.content,"</div>"].join("");bm.setHtml(bl);return bm;}
...
(function(){var u="engine.version",t="engine.name",s='" style="',r="abstract",q='<div style="',p='"',o='></div>',n="qx.ui.virtual.cell.AbstractImage",m="gecko",l="img",e="inline-block",k='/>',h="static",c="top",b='<img src="',g='title="',f="-moz-inline-box",i="px",a='" ',j="no-repeat",d="";qx.Class.define(n,{extend:qx.ui.virtual.cell.Cell,type:r,construct:function(){qx.ui.virtual.cell.Cell.call(this);this._aliasManager=qx.util.AliasManager.getInstance();}
,members:{__rh:16,__ri:16,_aliasManager:null,__rk:function(v){var y=qx.util.ResourceManager.getInstance();var x=qx.io.ImageLoader;var w,z;if(y.has(v)){w=y.getImageWidth(v),z=y.getImageHeight(v);}
else if(x.isLoaded(v)){w=x.getWidth(v);z=x.getHeight(v);}
else {w=this.__rh;z=this.__ri;}
;return {width:w,height:z};}
,__GY:function(A){if(typeof (A)=="string"){A={url:A};}
;var B=this._aliasManager.resolve(A.url||null);var C;if(A.width&&A.height){C={width:A.width,height:A.height};}
else {C=this.__rk(B);}
...
,getContent:function(E,F){if(E===null){return d;}
;var content=d;var H=this.__GY(this._identifyImage(E));var L=qx.core.Environment.get(t)==m&&qx.core.Environment.get(u)<1.9;var I=H.tooltip?g+H.tooltip+p:d;var G={width:H.width+i,height:H.height+i,display:L?f:e,verticalAlign:c,position:h};var J=qx.bom.element.Decoration.getTagName(j,H.url);var K=qx.bom.element.Decoration.getAttributes(H.url,j,G);var M=qx.bom.element.Style.compile(K.style);if(J===l){content=b+K.src+s+M+a;content+=I+k;}
else {content=q+M+a;content+=I+o;}
;return content;}
}});}
)();
...
(function(){var e="_applyIconFalse",d="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",b="cell-boolean",a="String";qx.Class.define(d,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__zv=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:b},iconTrue:{check:a,themeable:true,apply:c},iconFalse:{check:a,themeable:true,apply:e}},members:{__Ix:null,__Iy:null,__zv:null,_applyIconTrue:function(f){this.__Ix=this.__zv.resolve(f);}
,_applyIconFalse:function(g){this.__Iy=this.__zv.resolve(g);}
,_identifyImage:function(h){return h==true?this.__Ix:this.__Iy;}
}});}
)();
