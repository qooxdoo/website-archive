...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.aef5e641caf6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="#333",j="border-left",i="green",h="demobrowser.demo.mobile.PingPong",g="0",f="qx.debug",d="interval",c="0px",b="12px",a="15em",L="center",K='Lucida Grande',J="Arial",I="<b>This demo is supposed to be run in a WebKit-based browser.</b>",H="engine.name",G="webkit",F="border-right",E="touchmove",D="black",C="200px",r="30px",s="100px",p="1px solid white",q="top",n="right",o="50%",l="none",m="white",t="px",u="innerHTML",w="20px",v="absolute",A="100%",z="div",B="left";qx.Class.define(h,{extend:qx.application.Native,members:{__Sf:null,__Sg:null,__Sh:null,__Si:null,__Sj:5,__Sk:1,__Sl:1,__Sm:null,__Sn:null,__So:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(f)){qx.log.appender.Native;qx.log.appender.Console;}
...
;var M=this.__Ss(B);R.add(M);var N=this.__Ss(n);R.add(N);this.__Sg=this.__St(B);M.add(this.__Sg);M.addListener(E,qx.lang.Function.bind(this.__Dx,this,this.__Sg),this);this.__Sf=this.__St(n);N.add(this.__Sf);N.addListener(E,qx.lang.Function.bind(this.__Dx,this,this.__Sf),this);this.__Sh=this.__Su();R.add(this.__Sh);this.__Sn=this.__Sv();M.add(this.__Sn);this.__So=this.__Sv();N.add(this.__So);this.__Sm=[0,0];this.__Sp();}
,__Sp:function(){this.__Sh.setStyles({"left":C,"top":C});this.__Si=new qx.event.Timer(40);this.__Si.addListener(d,function(){var x=(parseInt(this.__Sh.getStyle(B))+this.__Sj*this.__Sk);var y=(parseInt(this.__Sh.getStyle(q))+this.__Sj*this.__Sl);this.__Sh.setStyle(B,x+t);this.__Sh.setStyle(q,y+t);this.__Sr();}
,this);this.__Si.start();}
,__Sq:function(S){this.__Si.stop();this.__Si.dispose();this.__Sj=5;this.__Sm[S]=this.__Sm[S]+1;this.__Sn.setAttribute(u,this.__Sm[0]);this.__So.setAttribute(u,this.__Sm[1]);this.__Sp();}
,__Sr:function(){var U=this.getBoundsFor(this.__Sh);if(U.top<=0){this.__Sl=1;}
;if(U.bottom>=window.innerHeight-5){this.__Sl=-1;}
;if(U.left<=0||U.right>=window.innerWidth){this.__Sq(U.left<=0?1:0);}
;var V=this.getBoundsFor(this.__Sg);if(U.left<=V.right&&U.bottom>=V.top&&U.top<=V.bottom){this.__Sk=1;this.__Sj=Math.min(this.__Sj+1,20);}
;var T=this.getBoundsFor(this.__Sf);if(U.right>=T.left&&U.bottom>=T.top&&U.top<=T.bottom){this.__Sk=-1;this.__Sj=Math.min(this.__Sj+1,20);}
;}
,__Dx:function(W,e){W.setStyles({"top":(e.getDocumentTop()-50)+t});}
,getBoundsFor:function(X){return qx.bom.element.Location.get(X.getDomElement());}
,__Ss:function(Y){var ba={"width":o,"height":A,"position":v,"backgroundColor":D};if(Y==B){ba[F]=p;}
else {ba[B]=o;ba[j]=p;}
;return new qx.html.Element(z,ba);}
,__St:function(bb){var bc={"width":r,"height":s,"top":s,"position":v,"backgroundColor":m};bc[bb]=w;return new qx.html.Element(z,bc);}
,__Su:function(){var bd={"width":w,"height":w,"position":v,"backgroundColor":m,"userSelect":l};return new qx.html.Element(z,bd);}
,__Sv:function(){var be={"width":A,"height":A,"textAlign":L,"fontSize":a,"color":k,"fontFamily":J};var bf=new qx.html.Element(z,be);bf.setAttribute(u,g);return bf;}
}});}
)();
