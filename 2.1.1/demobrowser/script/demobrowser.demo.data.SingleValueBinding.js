...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SingleValueBinding.ab25a7cd5e43.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="changeNames",p="changeName",o="\n",n="- ",m="",l="changeChild",k="changeColor",j="Marge",h="AFFE",g="Homer",c="__RT",f="changeName2",e="changeChildren",b="qx.data.Array",a="demobrowser.demo.data.model.Node",d="String";qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.setChildren(new qx.data.Array());}
,properties:{children:{check:b,event:e},child:{check:a,event:l,nullable:true},names:{check:b,event:q,init:new qx.data.Array(g,j)},name:{check:d,init:h,event:p},name2:{check:d,event:f},number:{init:10,validate:c},color:{event:k,nullable:true}},members:{__RT:function(r){if(!isNaN(parseFloat(r))){if(/^\d+$/.test(r)){return;}
;}
...
;t+=this.getName();for(var i=0;i<this.getChildren().length;i++){t+=o+this.getChildren().getItem(i).toString(s+1);}
;return t;}
}});}
)();
