...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Virtual_List","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.db9e03d80b12.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="Julian",n="Moritz",m="Jannis",l="Kevin",k="Robin",j="Felix",h="Vincent",g="Erik",f="Additive Selection",d="/places/folder.png",bB="Nils",bA="Nick",bz="Leon",by="Jannick",bx="Linus",bw="Configurable",bv="Marc",bu="icon/16/places/folder.png",bt="demobrowser.demo.test.Virtual_List",bs="addaptive",v="Colin",w="Lennard",t="changeSelection",u="Jason",r="Tobias",s="Florian",p="16",q="Jonas",D="icon/",E="Jakob",T="Enable drag selection",P="Joel",bc="David",W="Maximilian",bo="48",bi="Marlon",K="Lukas",br="Luca",bq="Julius",bp="Fabian",I="Tim",M="Justin",O="Single Selection",R="Simon",U="Luis",X="Johannes",be="Nico",bk="Alexander",x="Jan",y="Dominic",L="Noah",bb="Enable quick selection",ba="Daniel",Y="Paul",bg="Philipp",bf="Niclas",V="Max",bd="One Selection",a="Additive selection",bj="Jonathan",z="Tom",A="Finn",Q="Ben",b="on",c="One as selection mode",H="Elias",B="Mika",C="Multi Selection",G="Marvin",S="Item No ",bm="changeValue",bl="single",N="additive",bn="bold",J="one",bh="multi",F="value";qx.Class.define(bt,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var bN=new qx.ui.basic.Label(bw);bN.setFont(bn);this.getRoot().add(bN,{left:20,top:20});var bO=new demobrowser.demo.virtual.list.List();bO.setScrollbarX(b);bO.set({height:280,width:150,selectionMode:bh});var bK;for(var i=1;i<=2500;i++){bK=new demobrowser.demo.virtual.list.ListItem(S+i,D+((i%4)?p:bo)+d);if(i%4==0){bK.setHeight(56);}
;bO.add(bK);if(i==20){bO.setSelected(bK);}
;}
;bO.addListener(bm,function(e){this.debug("Value: "+e.getData());}
);this.getRoot().add(bO,{left:20,top:40});var bG=new qx.ui.form.RadioButton(O);var bD=new qx.ui.form.RadioButton(C);var bE=new qx.ui.form.RadioButton(f);var bC=new qx.ui.form.RadioButton(bd);bG.setUserData(F,bl);bD.setUserData(F,bh);bE.setUserData(F,N);bC.setUserData(F,J);bD.setValue(true);this.getRoot().add(bG,{left:180,top:40});this.getRoot().add(bD,{left:180,top:60});this.getRoot().add(bE,{left:180,top:80});this.getRoot().add(bC,{left:180,top:100});var bF=new qx.ui.form.RadioGroup(bG,bD,bE,bC);var bJ=new qx.ui.form.CheckBox(T);var bM=new qx.ui.form.CheckBox(bb).set({enabled:false});this.getRoot().add(bJ,{left:180,top:220});this.getRoot().add(bM,{left:180,top:240});bJ.addListener(bm,function(e){if(e.getData()){var bR=bO.getSelectionMode();if(bR==bl||bR==J){this.debug("Drag selection is only available for the modes multi or additive");}
;}
;bO.setDragSelection(e.getData());}
);bM.addListener(bm,function(e){if(e.getData()){var bS=bO.getSelectionMode();if(bS==bh||bS==N){this.debug("Quick selection is only available for the modes multi or additive");}
;}
;bO.setQuickSelection(e.getData());}
);bF.addListener(t,function(e){var bT=e.getData()[0].getUserData(F);bO.setSelectionMode(bT);if(bT==bl||bT==J){bJ.setEnabled(false);bM.setEnabled(true);}
else if(bT==bh||bT==bs){bJ.setEnabled(true);bM.setEnabled(false);}
;}
);var bQ=new qx.ui.basic.Label(c);bQ.setFont(bn);this.getRoot().add(bQ,{left:330,top:20});var bL=new demobrowser.demo.virtual.list.List();bL.set({height:280,width:150,selectionMode:J});var bK;for(var i=1;i<=25;i++){bK=new demobrowser.demo.virtual.list.ListItem(S+i,bu);bL.add(bK);if(i==16){bL.setSelected(bK);}
;}
;this.getRoot().add(bL,{left:330,top:40});var bN=new qx.ui.basic.Label(a);bN.setFont(bn);this.getRoot().add(bN,{left:520,top:20});var bP=new demobrowser.demo.virtual.list.List;var bH;bP.set({width:150,selectionMode:N});var bI=[bz,K,br,A,I,j,q,U,W,o,V,Y,bf,x,Q,H,by,bg,L,z,n,be,bc,bB,R,bp,g,M,bk,E,s,bA,bx,B,u,ba,w,G,m,r,y,bi,bv,X,bj,bq,v,P,l,h,k];for(var i=0;i<bI.length;i++){bH=new demobrowser.demo.virtual.list.ListItem(bI[i]);bP.add(bH);if(i==10||i==12||i==16){bP.addToSelection(bH);}
;}
...
(function(){var n="one",m="_applySpacing",k="Integer",h="_applyDragSelection",g="String",f="resize",d="demobrowser.demo.virtual.list.List",c="list",b="multi",a="_applyQuickSelection",C="_applyItemHeight",B="_applySelectionMode",A="additive",z="changeName",y="Number",x="addItem",w="removeItem",v="changeSelection",u="row",t="single",r="changeHeight",s=",",p="Boolean",q="selected",o="qx.event.type.Data";qx.Class.define(d,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__SS=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__SS);this.getPane().addListener(f,this._onResize,this);this.__nK=[];this.__cQ=[];this.__oO=new qx.ui.virtual.selection.Row(this.getPane());this.__oO.addListener(v,this._onChangeSelection,this);this.__oO.attachMouseEvents();this.__oO.attachKeyEvents(this);this.__oO.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:o,removeItem:o,changeValue:o,changeSelection:o},properties:{appearance:{refine:true,init:c},focusable:{refine:true,init:true},spacing:{check:k,init:0,apply:m,themeable:true},enableInlineFind:{check:p,init:true},name:{check:g,nullable:true,event:z},itemHeight:{init:24,themeable:true,check:y,apply:C},selectionMode:{check:[t,b,A,n],init:t,apply:B},dragSelection:{check:p,init:false,apply:h},quickSelection:{check:p,init:false,apply:a}},members:{__nK:null,__cQ:null,__oO:null,__SS:null,syncWidget:function(){this.update();}
,update:function(){var E=this.getPane().getRowConfig();E.setItemCount(this.__nK.length);E.resetItemSizes();for(var i=0;i<this.__nK.length;i++){var D=this.__nK[i].getHeight();if(D!==null){E.setItemSize(i,D);}
;}
;}
,updateSelection:function(){var F=this.__SS.getChildren();for(var i=0;i<F.length;i++){var G=F[i];var H=G.getUserData(u);if(this.__oO.isItemSelected(H)){G.addState(q);}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(v,this.__SW(e.getData()));}
,getCellWidget:function(I,J){var L=this.__nK[I];if(!L){return null;}
;var K=this.__cQ.pop()||new qx.ui.form.ListItem();K.set({label:L.getLabel(),icon:L.getIcon()});if(this.__oO.isItemSelected(I)){K.addState(q);}
...
,hasChildren:function(){return this.__nK.length>0;}
...
,add:function(W){this.__nK.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__nK,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__nK.length;i<j;i++){this._removeHelper(this.__nK[i]);}
;this.__nK=[];}
,indexOf:function(Y){return this.__nK.indexOf(Y);}
,addAt:function(ba,bb){qx.lang.Array.insertAt(this.__nK,ba,bb);this._addHelper(ba);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__nK,bc,bd);this._addHelper(bc);}
,addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__nK,be,bf);this._addHelper(be);}
,removeAt:function(bg){this.__nK.splice(bg,1);this._removeHelper(this.__nK[bg]);}
,__ST:function(bh){var bi=this.__nK.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__SU:function(bj){var bk=this.__nK[bj];return bk;}
,__SV:function(bl){var bm=[];for(var i=0;i<bl.length;i++){bm.push(this.__ST(bl[i]));}
;return bm;}
,__SW:function(bn){var bo=[];for(var i=0;i<bn.length;i++){bo.push(this.__nK[bn[i]]);}
;return bo;}
,selectAll:function(){this.__oO.selectAll();}
,setSelected:function(bp){this.__oO.selectItem(this.__ST(bp));}
,isSelected:function(bq){return this.__oO.isItemSelected(this.__ST(bq));}
,addToSelection:function(br){this.__oO.addItem(this.__ST(br));}
,removeFromSelection:function(bs){this.__oO.removeItem(this.__ST(bs));}
,selectRange:function(bt,bu){this.__oO.selectItemRange(this.__ST(bt),this.__ST(bu));}
,resetSelection:function(){this.__oO.clearSelection();}
,setSelection:function(bv){this.__oO.replaceSelection(this.__SV(bv));}
,getSelectedItem:function(){return this.__nK[this.getSelected()];}
,getSelected:function(){return this.__nK[this.__oO.getSelectedItem()];}
,getSelection:function(){return this.__SW(this.__oO.getSelection());}
,getSortedSelection:function(){return this.__SW(this.__oO.getSortedSelection());}
,isSelectionEmpty:function(){return this.__oO.isSelectionEmpty();}
,getSelectionContext:function(){return this.__oO.getSelectionContext();}
,getSelectables:function(){return this.__SW(this.__oO.getSelectables());}
,_applySelectionMode:function(bw,bx){this.__oO.setMode(bw);}
,_applyDragSelection:function(by,bz){this.__oO.setDrag(by);}
,_applyQuickSelection:function(bA,bB){this.__oO.setQuick(bA);}
}});}
)();
...
(function(){var l="_applyInterval",k="appear",j="qx.debug",i="interval",h="__jC",g="qx.ui.virtual.behavior.Prefetch",f="_applyScroller",e="qx.ui.virtual.core.Scroller",d="Integer",c="scroll",a="scrollbar-x",b="scrollbar-y";qx.Class.define(g,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(j)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__jC=new qx.event.Timer(this.getInterval());this.__jC.addListener(i,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:e,nullable:true,init:null,apply:f},interval:{check:d,init:200,apply:l}},members:{__vv:null,__vw:null,__jC:null,__vx:null,__vy:null,setPrefetchX:function(o,p,q,r){this.__vv=[o,p,q,r];}
,setPrefetchY:function(s,t,u,v){this.__vw=[s,t,u,v];}
,_onInterval:function(){var w=this.__vv;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__vw;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(y,z){if(z){if(this.__vx){z.getChildControl(a).removeListenerById(this.__vx);}
;if(this.__vy){z.getChildControl(b).removeListenerById(this.__vy);}
;}
;if(y){if(!y.getContainerElement().getDomElement()){this.__jC.stop();y.addListenerOnce(k,this.__jC.start,this.__jC);}
else {this.__jC.restart();}
;this.__vx=y.getChildControl(a).addListener(c,this.__jC.restart,this.__jC);this.__vy=y.getChildControl(b).addListener(c,this.__jC.restart,this.__jC);}
else {this.__jC.stop();}
;}
,_applyInterval:function(A,B){this.__jC.setInterval(A);}
},destruct:function(){this.setScroller(null);this.__vv=this.__vw=null;this._disposeObjects(h);}
});}
)();
