...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Touch.82f6f83c28da.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="engine.name",s="Two",r="20px",q="30px",p="qx.debug",o="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",n="webkit",m="12px",l="innerHTML",k="qx.mobile.emulatetouch",c="event.touch",j='Lucida Grande',g="One",b="demobrowser.demo.test.Touch",a="blue",f="absolute",d="div",h="green";qx.Class.define(b,{extend:qx.application.Native,members:{__SK:null,__SL:null,main:function(){qx.application.Native.prototype.main.call(this);if((qx.core.Environment.get(p))){qx.log.appender.Native;qx.log.appender.Console;}
...
;v.add(this.__SM(10,10,h,g));v.add(this.__SM(110,10,a,s));this.__SK=this.__SN(10,110);v.add(this.__SK);this.__SL=this.__SN(110,110);v.add(this.__SL);v.add(this.__SO(210,10));}
,__SM:function(x,y,z,A){var B={"position":"absolute","left":x+"px","top":y+"px","width":"90px","height":"90px","backgroundColor":z,"fontFamily":"Arial","fontSize":"12px"};var C=new qx.html.Element("div",B,{"id":A});C.setAttribute("innerHTML","<b>Touch me:<br>"+A+"</b>");C.addListener("touchstart",this.__SP,this);C.addListener("touchmove",this.__SP,this);C.addListener("touchend",this.__SP,this);C.addListener("touchcancel",this.__SP,this);return C;}
,__SN:function(x,y){var D={"position":"absolute","left":x+"px","top":y+"px","width":"90px","fontFamily":"Arial","fontSize":"9px"};return new qx.html.Element("div",D);}
,__SO:function(x,y){var E={"position":"absolute","left":x+"px","top":y+"px","width":"55px","height":"55px","backgroundColor":"red","fontFamily":"Arial","fontSize":"12px"};var F=new qx.html.Element("div",E);F.setAttribute("innerHTML","<b>Cancel Touch</b>");F.addListener("click",function(){window.setTimeout(function(){alert("Touch canceled");}
,0);}
,this);return F;}
,__SP:function(e){var G=[];G.push("Type: "+e.getType());G.push("==============");G.push("Is Multi-Touch: "+e.isMultiTouch());G.push("All Touches: "+e.getAllTouches().length);G.push("Target Touches: "+e.getTargetTouches().length);G.push("Changed Target Touches: "+e.getChangedTargetTouches().length);G.push("==============");G.push("Document: Left = "+e.getDocumentLeft()+" / Top = "+e.getDocumentTop());G.push("Screen: Left = "+e.getScreenLeft()+" / Top = "+e.getScreenTop());G.push("Viewport: Left = "+e.getViewportLeft()+" / Top = "+e.getViewportTop());G.push("Identifier: "+e.getIdentifier());var I=e.getTarget();var H=false;var K=e.getTargetTouches().length>0?e.getTargetTouches():e.getChangedTargetTouches();for(var i=0;i<K.length;i++){H=K[0].target==I;if(!H){break;}
;}
