...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration.06af918764c7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,addFromDefinition:function(C){var D=this.getRoot();this.__BH(D,C);}
,__BH:function(E,F){var G=new F.clazz();var K=qx.lang.Object.clone(F);delete K.clazz;delete K.layout;delete K.children;delete K.id;delete K.listeners;G.set(K);if(F.id!=null){this[F.id]=G;}
;if(F.layout!=null){var H=new F.layout.clazz();var K=qx.lang.Object.clone(F.layout);delete K.clazz;H.set(K);G.setLayout(H);}
;var J=F.children;if(J!=null){for(var i=0;i<J.length;i++){if(G instanceof qx.ui.form.Form){this.__SQ(G,J[i]);}
else {this.__BH(G,J[i]);}
;}
;}
...
;}
;}
,__SQ:function(L,M){if(M.type==="Header"){L.addGroupHeader(M.label);return;}
