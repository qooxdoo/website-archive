...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Placement.230e91c5770e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var w="demobrowser.demo.ui.Placement",v="Open DOM-Popup",u="DOM Popup",t="Open Popup",s="Content",r="DOM align control",q="domanchor",p="left-middle",o="right-middle",n="top-center",f="mousedown",m="changeSelection",j="top-left",c="bottom-right",b="right-bottom",h="right-top",g="bottom-center",k="bottom-left",a="left-bottom",l="top-right",d="left-top";qx.Class.define(w,{extend:qx.application.Standalone,members:{__RK:null,main:function(){qx.application.Standalone.prototype.main.call(this);var x=this.getRoot();this.__RK=[k,g,c,j,n,l,h,o,b,d,p,a];x.add(this.createTestField(k),{left:20,top:20});x.add(this.createTestField(c),{right:20,top:20});x.add(this.createTestField(l),{right:20,bottom:20});x.add(this.createTestField(j),{left:20,bottom:20});x.add(this.createTestField(g),{left:400,top:20});x.add(this.createTestField(n),{left:400,bottom:20});x.add(this.createTestField(h),{left:20,top:200});x.add(this.createTestField(o),{left:20,top:275});x.add(this.createTestField(b),{left:20,top:350});x.add(this.createTestField(d),{right:20,top:200});x.add(this.createTestField(p),{right:20,top:275});x.add(this.createTestField(a),{right:20,top:350});x.add(this.createDomClick(),{left:200,top:100});}
,createTestField:function(y){var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var A=new qx.ui.popup.Popup(new qx.ui.layout.Grow);A.add(new qx.ui.basic.Atom(s));A.setPadding(20);var z=new qx.ui.form.SelectBox;var D=null;for(var i=0;i<this.__RK.length;i++){var B=new qx.ui.form.ListItem(this.__RK[i]);z.add(B);if(this.__RK[i]==y){D=B;}
;}
;C.add(z);z.addListener(m,function(e){A.setPosition(e.getData()[0].getLabel());}
);z.setSelection([D]);var E=new qx.ui.form.Button(t);C.add(E);E.addListener(f,function(e){A.placeToWidget(E);A.show();}
);return C;}
,createDomClick:function(){var H=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var J=new qx.ui.basic.Label(r);H.add(J);var G=new qx.ui.popup.Popup(new qx.ui.layout.Grow);G.add(new qx.ui.basic.Atom(u));G.setPadding(20);var F=new qx.ui.form.SelectBox;for(var i=0;i<this.__RK.length;i++){F.add(new qx.ui.form.ListItem(this.__RK[i]));}
;H.add(F);F.addListener(m,function(e){G.setPosition(e.getData()[0].getLabel());}
);var I=new qx.ui.form.Button(v);H.add(I);I.addListener(f,function(e){G.placeToElement(document.getElementById(q));G.show();}
);return H;}
