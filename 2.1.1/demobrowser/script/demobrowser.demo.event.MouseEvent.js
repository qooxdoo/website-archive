...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent.e98da2bf35b1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.bom.Element.addListener(G,m,this.__Sb,this);}
...
,this);}
,__Sb:function(e){var K=e.getTarget().id.split(z)[1];var I=e.getTarget().checked;var J=document.getElementById(o);if(I){qx.bom.Element.addListener(J,K,this.logMouseEvent,this);}
