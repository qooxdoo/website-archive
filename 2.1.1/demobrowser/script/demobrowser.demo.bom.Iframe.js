...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Iframe.1644bddcdf3b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="demobrowser.demo.bom.Iframe",f="http://www.qooxdoo.org",d="testFrame",c="",b="load",a="dummy";qx.Class.define(g,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var h=qx.bom.Iframe.create({name:d,src:f});qx.bom.Element.addListener(h,b,function(e){this.debug("Content loaded.");}
,this);document.body.appendChild(h);document.getElementById(a).innerHTML=c;}
}});}
)();
