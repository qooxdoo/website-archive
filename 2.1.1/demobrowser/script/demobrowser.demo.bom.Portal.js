...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.91a43d11fd7c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="groupBoxes",h="demobrowser.demo.bom.portal.box.Manager",g="boxData",f="qx.event.type.Event",e="boxes",d="demobrowser.demo.bom.portal.box.Box",c="_applyActiveBox",b="loaded",a="singleton";qx.Class.define(h,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Rg=[];this.__Rh=[];this.__Ri={};}
,statics:{dataKeyRoot:g,dataKeyGroupBoxes:m,dataKeyBoxes:e},events:{"loaded":f},properties:{activeBox:{init:null,check:d,apply:c}},members:{__Rg:null,__Rh:null,__Ri:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);}
;n.setActive(true);}
...
,__bf:function(p){var t,w,u,v,x,p;var q=p[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var s=p[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in q){t=q[w];u=t.boxes;w=t.id;v={id:w,element:document.getElementById(w)};this.__Rh.push(v);this.__Ri[w]=[];for(var k=0,l=u.length;k<l;k++){p=s[u[k]];var r=document.getElementById(p.id);var x=new demobrowser.demo.bom.portal.box.Box(p,r,null,w);this.__Rg.push(x);this.__Ri[w].push(x);}
;}
;}
,getBoxes:function(){return this.__Rg;}
,getGroupBoxes:function(){return this.__Rh;}
,updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());qx.lang.Array.remove(this.__Ri[z],A);qx.lang.Array.insertAt(this.__Ri[y],A,B);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__Rh.length,D;i<j;i++){D=this.__Ri[this.__Rh[i].id];for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__Rh[i];}
;}
;}
;return null;}
},destruct:function(){this.__Rg=this.__Rh=this.__Ri=null;}
});}
)();
(function(){var s="click",r="1px solid #444444",q="height",p="position",o="zIndex",n="_applyActive",m="width",l="box_content",k=" It does contain no UI widget code at all.",j="relative",c="demobrowser.demo.bom.portal.box.Box",i="1px solid orange",g="This is a demo application showing the low-level capabilities.",b="div",a="String",f="<br/><br/>",d="border",h="Boolean";qx.Class.define(c,{extend:qx.core.Object,construct:function(t,u,v,w){qx.core.Object.call(this);this.__Rj=t;this.__bV=t.id;if(u!=null){qx.bom.element.Style.set(u,m,t.width);qx.bom.element.Style.set(u,q,t.height);this.__Rm(u,v);}
;this.setElement(u);this.setGroupBoxId(w);this.__Rk=null;this.__Rl=null;if(t.resizable){this.setResizable(true);var x={minWidth:parseInt(t.minWidth),minHeight:parseInt(t.minHeight),maxWidth:parseInt(t.maxWidth),maxHeight:parseInt(t.maxHeight),handles:t.resizeHandles};this.__Rk=new demobrowser.demo.bom.portal.box.Resizable(this,x);}
;if(t.draggable){this.setDraggable(true);this.__Rl=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__Rn();}
,properties:{element:{init:null},groupBoxId:{init:null,check:a},active:{check:h,init:false,apply:n},resizable:{check:h,init:false},draggable:{check:h,init:false}},members:{__bV:null,__Rj:null,__Rl:null,__Rk:null,_applyActive:function(y,z){if(y){qx.bom.element.Style.set(this.getElement(),d,i);}
else {qx.bom.element.Style.set(this.getElement(),d,r);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__Rj;}
,getDraggableComponent:function(){return this.__Rl;}
,getResizableComponent:function(){return this.__Rk;}
,__Rm:function(A,B){if(B){for(var C in B){qx.bom.element.Style.set(C,B[C]);}
;}
;qx.bom.element.Style.set(A,p,j);qx.bom.element.Style.set(A,o,0);qx.bom.Element.addListener(A,s,this.__Ro,this,true);}
,__Rn:function(){var E=g+k;E=E+f+E+f+E;var D=qx.dom.Element.create(b,{"class":l});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__Ro:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__Rj=this.__Rk=this.__Rl=null;}
});}
)();
...
(function(){var n="mouseup",m="mousedown",l="_",k="div",j="demobrowser.demo.bom.portal.box.Resizable",i="Handle",h="mouseover",g="mouseout",f="visible",d="mousemove",a="orientation",c="hidden",b="visibility";qx.Class.define(j,{extend:qx.core.Object,construct:function(o,p){qx.core.Object.call(this);this.__Rp=o;this.__eR=this.__Rp.getElement();this.__Rq={};this.__Rr=false;this.__Rs={orientation:null,lastCoord:{left:null,top:null}};this.__Rt={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__Rt){if(p[name]){this.__Rt[name]=p[name];}
;}
;this.__Rm();}
,members:{__Rs:null,__Rp:null,__eR:null,__Rq:null,__Rt:null,__Rr:false,getBox:function(){return this.__Rp;}
,__Rm:function(){switch(this.__Rt.handles){case 1:this.__Rq.east=null;break;case 2:this.__Rq.south=null;break;case 3:this.__Rq.south=null;this.__Rq.southeast=null;this.__Rq.east=null;break;};for(var r in this.__Rq){var q=this.__Rq[r]=qx.dom.Element.create(k);qx.bom.element.Attribute.set(q,a,r);qx.dom.Element.insertEnd(q,this.__eR);if(this.__eR.id){q.id=this.__eR.id+l+r;}
;this.__Ru(r);this.__Rv(r);}
;}
,__Ru:function(s){qx.bom.element.Class.add(this.__Rq[s],s+i);qx.bom.element.Style.set(this.__Rq[s],b,this.__Rt.autoHide?c:f);}
,__Rv:function(t){var v=qx.event.Registration;var u=this.__Rq[t];v.addListener(u,m,this.__Ry,this);v.addListener(document,n,this.__Rz,this);if(this.__Rt.autoHide){v.addListener(this.__Rp.getElement(),h,this.__Rw,this);v.addListener(this.__Rp.getElement(),g,this.__Rx,this);}
;}
,__Rw:function(e){for(var w in this.__Rq){qx.bom.element.Style.set(this.__Rq[w],b,f);}
;}
,__Rx:function(e){if(!this.__Rr){for(var x in this.__Rq){qx.bom.element.Style.set(this.__Rq[x],b,c);}
;}
;}
,__Ry:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,d,this.__RA,this,true);this.__Rr=true;var y=e.getTarget();this.__Rs.orientation=qx.bom.element.Attribute.get(y,a);this.__Rs.lastCoord.left=e.getDocumentLeft();this.__Rs.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__eR);}
;}
,__Rz:function(e){e.stopPropagation();if(this.__Rr){qx.event.Registration.removeListener(document,d,this.__RA,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__eR);if(this.__Rt.autoHide){for(var z in this.__Rq){qx.bom.element.Style.set(this.__Rq[z],b,c);}
;}
;this.__Rr=false;qx.bom.Selection.clear(document.body);}
;}
,__RA:function(e){e.stopPropagation();if(this.__Rr){var A={left:null,top:null};switch(this.__Rs.orientation){case "south":A.top=e.getDocumentTop();break;case "southeast":A.top=e.getDocumentTop();A.left=e.getDocumentLeft();break;case "east":A.left=e.getDocumentLeft();break;};this.__RB(A,this.__Rs.lastCoord);this.__Rs.lastCoord.left=e.getDocumentLeft();this.__Rs.lastCoord.top=e.getDocumentTop();}
;}
,__RB:function(B,C){var J=qx.bom.element.Dimension;var G=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Rp.getId());var I=J.getContentSize(G.element);if(B.left){var F=B.left-C.left;if(F!==0){var E=J.getContentWidth(this.__eR)+F;var H=J.getWidth(this.__eR)+F;if((this.__Rt.minWidth==null||E>this.__Rt.minWidth)&&(this.__Rt.maxWidth==null||E<=this.__Rt.maxWidth)){if(I.width>=H){qx.bom.element.Style.set(this.__eR,"width",E+'px');this.__Rp.getData().width=E;}
;}
;}
;}
;if(B.top){var F=B.top-C.top;if(F!==0){var D=J.getContentHeight(this.__eR)+F;if((this.__Rt.minHeight==null||D>this.__Rt.minHeight)&&(this.__Rt.maxHeight==null||D<=this.__Rt.maxHeight)){qx.bom.element.Style.set(this.__eR,"height",D+"px");}
;}
;}
;}
},destruct:function(){if(this.__Rt.autoHide){qx.event.Registration.removeListener(this.__Rp.getElement(),h,this.__Rw,this);qx.event.Registration.removeListener(this.__Rp.getElement(),g,this.__Rx,this);}
;this.__Rp=this.__Rt=this.__eR=this.__Rq=null;this.__Rs=null;}
});}
)();
...
(function(){var c="auto",b="demobrowser.demo.bom.portal.box.Util",a="zIndex";qx.Class.define(b,{statics:{__RC:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,a);e=e==c?0:e;qx.bom.element.Style.set(d,a,e+this.__RC);}
,sendToBack:function(f){var g=qx.bom.element.Style.get(f,a);qx.bom.element.Style.set(f,a,g-this.__RC);}
}});}
)();
...
(function(){var k="mouseup",j="mousedown",i="mouseover",h="drag",g="dragend",f="move",d="demobrowser.demo.bom.portal.box.Draggable",c="cursor",b="mousemove",a="dragstart";qx.Class.define(d,{extend:qx.core.Object,construct:function(l){qx.core.Object.call(this);this.__Rp=l;this.__eR=l.getElement();this.__RD=null;this.__RE=null;this.__Rm();}
,members:{__Rp:null,__eR:null,__RD:null,__RE:null,getBox:function(){return this.__Rp;}
,getElement:function(){return this.__eR;}
,__Rm:function(){this.__RF();this.__Rv();}
,__RF:function(){this.__RD=qx.dom.Element.create("div");qx.bom.element.Class.add(this.__RD,"dragHandle");qx.dom.Element.insertBegin(this.__RD,this.__eR);}
,__Rv:function(){qx.bom.Element.addListener(this.__RD,j,this.__ow,this);qx.bom.Element.addListener(this.__RD,i,function(e){qx.bom.element.Style.set(this,c,f);}
,this.__RD);qx.bom.Element.addListener(this.__RD,a,this.__uM,this);qx.bom.Element.addListener(this.__RD,g,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__RD,h,this.__RI,this);}
,__ow:function(e){if(e.isLeftPressed()){this.__RE={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__eR),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__eR)};qx.bom.Element.addListener(document.body,k,this.__RH,this,true);this.__RG();qx.event.Registration.fireEvent(this.__RD,a,qx.event.type.Event);}
;}
,__RG:qx.core.Environment.select("engine.name",{"mshtml":function(){var n=this;var m=qx.lang.Function.bind(this.__RH,n);document.getElementsByTagName("html")[0].onmouseleave=m;}
,"default":(function(){}
)}),__RH:function(e){try{e.stopPropagation();}
catch(o){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,"mousemove",this.__RI,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,"mouseup",this.__RH,this,true);}
,__uM:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__Rp);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__Rp);qx.event.Registration.addListener(document.body,b,this.__RI,this,true);}
,__RI:function(e){e.stopPropagation();var p=e.getDocumentLeft()-this.__RE.left;var top=e.getDocumentTop()-this.__RE.top;qx.event.Timer.once(function(){this.checkGroupBox(p,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,p);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__Rp=this.__RD=this.__eR=this.__RE=null;}
});}
)();
(function(){var m="Boolean",l="left",k="demobrowser.demo.bom.portal.dragdrop.Manager",h="end",g="border",f="top",d="demobrowser.demo.bom.portal.box.Box",c="ease-out",b="singleton",a="px";qx.Class.define(k,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__RJ={top:null,height:null};this.__RK={top:0,left:0};}
,properties:{activeBox:{check:d,init:null,nullable:true},sessionActive:{check:m,init:false}},members:{__RJ:null,__RL:null,__RM:false,__RK:null,__RN:null,__RO:null,startSession:function(n){this.setSessionActive(true);this.setActiveBox(n);this.__RL=n.getGroupBoxId();this.__RP();if(this.__RN==null){this.__RN={};var o=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=o.length;i<j;i++){this.__RN[o[i].element.id]={left:qx.bom.element.Location.getLeft(o[i].element),right:qx.bom.element.Location.getLeft(o[i].element)+qx.bom.element.Dimension.getWidth(o[i].element)};}
;}
;}
,__RP:function(){if(!this.__RO){this.__RO=qx.dom.Element.create("div");}
;var r=this.getActiveBox().getElement();var p=qx.bom.element.Dimension.getContentSize(r);this.__RQ(r,this.__RO);qx.bom.element.Class.add(this.__RO,qx.bom.element.Class.get(r));var q="opacity:0.5;margin:0;position:absolute;"+"top:"+qx.bom.element.Location.getTop(r)+"px;"+"left:"+qx.bom.element.Location.getLeft(r)+"px;"+"width:"+p.width+"px;"+"height:"+p.height+"px";qx.bom.element.Style.setCss(this.__RO,q);qx.bom.element.Style.set(r,"border","1px dashed red");qx.dom.Node.getBodyElement(r).appendChild(this.__RO);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__RO);}
,__RQ:function(s,t){while(s.firstChild){t.appendChild(s.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var y=this.getActiveBox();var v=y.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(y.getGroupBoxId(),this.__RL,y);y.setGroupBoxId(this.__RL);var x={left:qx.bom.element.Location.getLeft(this.__RO)+a,top:qx.bom.element.Location.getTop(this.__RO)+a};var w={left:qx.bom.element.Location.getLeft(v)+a,top:qx.bom.element.Location.getTop(v)+a};var z={timing:c,duration:300,keep:100,keyFrames:{'0':x,'100':w}};var u=qx.bom.element.Animation.animate(this.__RO,z);u.addListener(h,function(){this.__RQ(this.__RO,v);qx.bom.element.Style.reset(v,g);this.__RO.parentNode.removeChild(this.__RO);if(y.isActive()){y._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(y);}
;}
,this);}
,onDragMove:function(top,A){if(this.__RK.left!=A){qx.bom.element.Style.set(this.__RO,l,A+a);}
;if(this.__RK.top!=top){qx.bom.element.Style.set(this.__RO,f,top+a);}
;var B=this.getActiveBox().getElement();if(this.__RJ.top==null){this.__RJ.top=qx.bom.element.Location.getTop(B);}
;if(this.__RJ.height==null){this.__RJ.height=qx.bom.element.Dimension.getHeight(B);}
;if(this.__RM==false&&top>=this.__RJ.top&&top<=(this.__RJ.top+this.__RJ.height)){return;}
;var C;if(this.__RM){C=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__RL));while(C!=null){if(this.__RR(true,top,B,C)){this.__RM=false;return;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {C=B;}
;if(top-this.__RK.top>0){C=qx.dom.Hierarchy.getNextElementSibling(C);while(C!=null){if(C){if(this.__RR(true,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {var C=qx.dom.Hierarchy.getPreviousElementSibling(C);while(C!=null){if(C){if(this.__RR(false,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getPreviousElementSibling(C);}
;}
;this.__RK.left=A;this.__RK.top=top;}
,__RR:function(D,top,E,F){var G=qx.bom.element.Location.getTop(F);var I=parseInt(qx.bom.element.Style.get(F,"paddingTop"));var J=parseInt(qx.bom.element.Style.get(F,"paddingBottom"));var H=qx.bom.element.Dimension.getContentHeight(F)+J+I;var K;if(D){if(top>=(G+(H/3))){K=qx.dom.Hierarchy.getNextElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertAfter(E,F);this.__RJ.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
else {if(top<=(G+H*2/3)){K=qx.dom.Hierarchy.getPreviousElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertBefore(E,F);this.__RJ.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
;return false;}
,checkGroupBox:function(L,M){if(this.__RN[this.__RL].left<=L&&this.__RN[this.__RL].right>=L){return;}
;for(var N in this.__RN){if(N!=this.__RL){if(this.__RN[N].left<=L+M&&this.__RN[N].right>=L){this.__RL=N;this.__RM=true;return;}
;}
;}
;}
},destruct:function(){this.__RJ=this.__RK=this.__RL=null;this.__RS=this.__RO=this.__RN=null;}
});}
)();
