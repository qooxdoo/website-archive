...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer.5689f748193a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__KN:function(Q,top,R,S,T){var U=["<div style='position:absolute;height:20px;width:",R,"px;top:",top,"px'>"];S.createDataCellHtml(T,U);U.push("</div>");Q.innerHTML+=U.join("");}
,testDefaultRenderer:function(V){var W=100;var Y={value:[null,D,32,new Date()],styleLeft:[0],styleWidth:[W],styleHeight:[20],style:[C]};var X=this._getNewTableDiv(W);var top=0;qx.util.Permutation.permute(Y,function(ba){this.__KN(X,top,W,V,ba);top+=20;}
,this);}
,testBooleanRenderer:function(){var be=70;var bd=30;var bf=new qx.ui.table.cellrenderer.Boolean();var bb={value:[null,true,false],styleLeft:[0],styleWidth:[be],styleHeight:[bd],style:[C]};var bc=this._getNewTableDiv(be);var top=0;qx.util.Permutation.permute(bb,function(bg){this.__KN(bc,top,be,bf,bg);top+=bd;}
,this);bf.setIconFalse(l);bf.setIconTrue(m);qx.util.Permutation.permute(bb,function(bh){this.__KN(bc,top,be,bf,bh);top+=bd;}
,this);}
,testDateRenderer:function(){var bl=180;var bm=new qx.ui.table.cellrenderer.Date();var bo={value:new Date(),styleLeft:[0],styleWidth:[bl],styleHeight:[20],style:[C]};var bk=qx.util.format.DateFormat;var bn=[bk.getDateTimeInstance(),bk.getDateInstance()];var bi=this._getNewTableDiv(bl);var top=0;for(var i=0;i<bn.length;i++){var bj=bn[i];bm.setDateFormat(bj);this.__KN(bi,top,bl,bm,bo);top+=20;}
;}
,testNumberRenderer:function(){var bt=new qx.ui.table.cellrenderer.Number();var bs=100;var bv={value:Math.PI,styleLeft:[0],styleWidth:[bs],styleHeight:[20],style:[C]};var br=qx.util.format.NumberFormat;var bu=[new br().set({maximumFractionDigits:0}),new br().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:e})];var bp=this._getNewTableDiv(bs);var top=0;for(var i=0;i<bu.length;i++){var bq=bu[i];bt.setNumberFormat(bq);this.__KN(bp,top,bs,bt,bv);top+=20;}
;}
,testImageRenderer:function(){var by=new qx.ui.table.cellrenderer.Image();var bw=50;var bz={value:[null,y,r,K,h,f],styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[C],tooltip:[C,n]};var bx=this._getNewTableDiv(bw);var top=0;qx.util.Permutation.permute(bz,function(bA){this.__KN(bx,top,bw,by,bA);top+=20;}
,this);}
,testStringRenderer:function(){var bF=new qx.ui.table.cellrenderer.String();var bE=100;var bD=20;var bB={value:[null,z,B],styleLeft:[0],styleWidth:[bE],styleHeight:[bD],style:[C]};var bC=this._getNewTableDiv(bE);var top=0;qx.util.Permutation.permute(bB,function(bG){this.__KN(bC,top,bE,bF,bG);top+=20;}
,this);}
,testPasswordRenderer:function(){var bL=new qx.ui.table.cellrenderer.Password();var bK=100;var bJ=20;var bH={value:[null,z,B],styleLeft:[0],styleWidth:[bK],styleHeight:[bJ],style:[C]};var bI=this._getNewTableDiv(bK);var top=0;qx.util.Permutation.permute(bH,function(bM){this.__KN(bI,top,bK,bL,bM);top+=20;}
,this);}
,testHtmlRenderer:function(){var bR=new qx.ui.table.cellrenderer.Html();var bQ=100;var bP=50;var bN={value:[null,E,H,a],styleLeft:[0],styleWidth:[bQ],styleHeight:[bP],style:[C]};var bO=this._getNewTableDiv(bQ);var top=0;qx.util.Permutation.permute(bN,function(bS){this.__KN(bO,top,bQ,bR,bS);top+=20;}
,this);}
,testConditionalRenderer:function(){var bX=new qx.ui.table.cellrenderer.Conditional();bX.addNumericCondition(M,0,null,o,null,null);bX.addNumericCondition(u,100,t,null,null,null);bX.addBetweenCondition(N,0,2,null,null,null,v,null);bX.addRegex(G,null,null,v,c);var bW=100;var bV=20;var bT={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bW],table:[this.tableMock],styleHeight:[bV],style:[C]};var bU=this._getNewTableDiv(bW);var top=0;qx.util.Permutation.permute(bT,function(bY){this.__KN(bU,top,bW,bX,bY);top+=20;}
,this);}
...
);var cd=100;var cc=20;var ca={value:[null,D,new Date(),30,y,false],styleLeft:[0],styleWidth:[cd],styleHeight:[cc],table:[this.tableMock],style:[C]};var cb=this._getNewTableDiv(cd);var top=0;qx.util.Permutation.permute(ca,function(ci){this.__KN(cb,top,cd,ce,ci);top+=20;}
,this);}
,testReplaceRenderer:function(){var cn=new qx.ui.table.cellrenderer.Replace();cn.setReplaceMap({'1':x,'2':L,'3':j});cn.addReversedReplaceMap();var cm=100;var cl=20;var cj={value:[1,2,3],styleLeft:[0],styleWidth:[cm],table:[this.tableMock],styleHeight:[cl],style:[C]};var ck=this._getNewTableDiv(cm);var top=0;qx.util.Permutation.permute(cj,function(co){this.__KN(ck,top,cm,cn,co);top+=20;}
,this);}
},destruct:function(){this.tableMock=null;}
});}
)();
(function(){var a="qx.util.Permutation";qx.Class.define(a,{statics:{permute:function(b,c,d){var f=Object.keys(b);var e={};var j=[];for(var i=0;i<f.length;i++){j[i]=0;var h=f[i];e[h]=b[h][0];}
...
,init:k}},members:{__rh:16,__ri:16,__rj:null,_insetY:2,_identifyImage:function(A){throw new Error("_identifyImage is abstract");}
,_getImageInfos:function(B){var C=this._identifyImage(B);if(C==null||typeof C==g){C={url:C,tooltip:null};}
;if(!C.imageWidth||!C.imageHeight){var D=this.__rk(C.url);C.imageWidth=D.width;C.imageHeight=D.height;}
;C.width=C.imageWidth;C.height=C.imageHeight;return C;}
,__rk:function(E){var H=qx.util.ResourceManager.getInstance();var G=qx.io.ImageLoader;var F,I;if(H.has(E)){F=H.getImageWidth(E);I=H.getImageHeight(E);}
else if(G.isLoaded(E)){F=G.getWidth(E);I=G.getHeight(E);}
else {F=this.__rh;I=this.__ri;}
;return {width:F,height:I};}
,createDataCellHtml:function(J,K){this.__rj=this._getImageInfos(J);return qx.ui.table.cellrenderer.Abstract.prototype.createDataCellHtml.call(this,J,K);}
,_getCellClass:function(L){return qx.ui.table.cellrenderer.Abstract.prototype._getCellClass.call(this)+q;}
,_getContentHtml:function(M){var content=t;if(this.__rj.url){content=qx.bom.element.Decoration.create(this.__rj.url,this.getRepeat(),{width:this.__rj.width+m,height:this.__rj.height+m,display:qx.core.Environment.get(j),verticalAlign:s,position:f});}
;return content;}
,_getCellAttributes:function(N){var O=this.__rj.tooltip;if(O){return n+O+e;}
else {return u;}
;}
},destruct:function(){this.__rj=null;}
});}
)();
(function(){var h="_applyIconTrue",g="decoration/table/boolean-true.png",f="qx.ui.table.cellrenderer.Boolean",e=";padding-top:4px;",d="decoration/table/boolean-false.png",c="_applyIconFalse",b="changeTheme",a="String";qx.Class.define(f,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(){qx.ui.table.cellrenderer.AbstractImage.call(this);this.__zv=qx.util.AliasManager.getInstance();this.initIconTrue();this.initIconFalse();qx.theme.manager.Appearance.getInstance().addListener(b,this._onChangeTheme,this);}
,properties:{iconTrue:{check:a,init:g,apply:h},iconFalse:{check:a,init:d,apply:c}},members:{__zw:null,__zx:false,__zv:null,_onChangeTheme:function(){this._applyIconTrue(this.getIconTrue());this._applyIconFalse(this.getIconFalse());}
,_applyIconTrue:function(i){this.__zw=this.__zv.resolve(i);}
,_applyIconFalse:function(j){this.__zx=this.__zv.resolve(j);}
,_insetY:5,_getCellStyle:function(k){return qx.ui.table.cellrenderer.AbstractImage.prototype._getCellStyle.call(this,k)+e;}
,_identifyImage:function(l){var m={imageWidth:11,imageHeight:11};switch(l.value){case true:m.url=this.__zw;break;case false:m.url=this.__zx;break;default:m.url=null;break;};return m;}
},destruct:function(){this.__zv=null;qx.theme.manager.Appearance.getInstance().removeListener(b,this._onChangeTheme,this);}
});}
)();
(function(){var s="font-weight",r=";",q="text-align",p='g',o=":",n="qx.ui.table.cellrenderer.Conditional",m="color",l="font-style",k="==",j=">",c="between",h="<",f="regex",b="!between",a=">=",e="!=",d="<=",g="";qx.Class.define(n,{extend:qx.ui.table.cellrenderer.Default,construct:function(t,u,v,w){qx.ui.table.cellrenderer.Default.call(this);this.numericAllowed=[k,e,j,h,a,d];this.betweenAllowed=[c,b];this.conditions=[];this.__zq=t||g;this.__zr=u||g;this.__zs=v||g;this.__zt=w||g;}
,members:{__zq:null,__zr:null,__zs:null,__zt:null,__zu:function(x,y){if(x[1]!=null){y[q]=x[1];}
;if(x[2]!=null){y[m]=x[2];}
;if(x[3]!=null){y[l]=x[3];}
;if(x[4]!=null){y[s]=x[4];}
;}
,addNumericCondition:function(z,A,B,C,D,E,F){var G=null;if(qx.lang.Array.contains(this.numericAllowed,z)){if(A!=null){G=[z,B,C,D,E,A,F];}
;}
...
;}
,addRegex:function(Q,R,S,T,U,V){if(Q!=null){var W=[f,R,S,T,U,Q,V];}
;if(W!=null){this.conditions.push(W);}
else {throw new Error("regex cannot be null!");}
;}
,_getCellStyle:function(X){if(!this.conditions.length){return X.style||g;}
;var bd=X.table.getTableModel();var i;var bf;var Y;var bb={"text-align":this.__zq,"color":this.__zr,"font-style":this.__zs,"font-weight":this.__zt};for(i in this.conditions){bf=false;if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){Y=X.value;}
else {Y=bd.getValueById(this.conditions[i][6],X.row);}
;switch(this.conditions[i][0]){case k:if(Y==this.conditions[i][5]){bf=true;}
;break;case e:if(Y!=this.conditions[i][5]){bf=true;}
;break;case j:if(Y>this.conditions[i][5]){bf=true;}
;break;case h:if(Y<this.conditions[i][5]){bf=true;}
;break;case a:if(Y>=this.conditions[i][5]){bf=true;}
;break;case d:if(Y<=this.conditions[i][5]){bf=true;}
;break;};}
...
;switch(this.conditions[i][0]){case c:if(Y>=this.conditions[i][5]&&Y<=this.conditions[i][6]){bf=true;}
;break;case b:if(Y<this.conditions[i][5]||Y>this.conditions[i][6]){bf=true;}
;break;};}
else if(this.conditions[i][0]==f){if(this.conditions[i][6]==null){Y=X.value;}
else {Y=bd.getValueById(this.conditions[i][6],X.row);}
;var ba=new RegExp(this.conditions[i][5],p);bf=ba.test(Y);}
;if(bf==true){this.__zu(this.conditions[i],bb);}
;}
;var be=[];for(var bc in bb){if(bb[bc]){be.push(bc,o,bb[bc],r);}
;}
;return be.join(g);}
...
(function(){var b="qx.ui.table.cellrenderer.Image",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__rl=c;}
;if(d){this.__rm=d;}
;this.__rn=qx.util.AliasManager.getInstance();}
,members:{__rn:null,__rm:16,__rl:16,_identifyImage:function(e){var f={imageWidth:this.__rl,imageHeight:this.__rm};if(e.value==a){f.url=null;}
else {f.url=this.__rn.resolve(e.value);}
...
(function(){var b="Function",a="qx.ui.table.cellrenderer.Dynamic";qx.Class.define(a,{extend:qx.ui.table.cellrenderer.Default,construct:function(c){qx.ui.table.cellrenderer.Default.call(this);if(c){this.setCellRendererFactoryFunction(c);}
;}
,properties:{cellRendererFactoryFunction:{check:b,nullable:true,init:null}},members:{createDataCellHtml:function(d,e){var g=this.getCellRendererFactoryFunction();if(!g){throw new Error("No function provided! Aborting.");}
;var f=g(d);return f.createDataCellHtml(d,e);}
}});}
)();
