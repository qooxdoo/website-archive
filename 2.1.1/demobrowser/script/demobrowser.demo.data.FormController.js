...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController.c6cab9711056.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="changeModel",k="qx.core.Object",j="qx.debug",h="_applyTarget",g="qx.data.controller.Form",f="changeTarget",e=".",d="qx.ui.form.Form",c="_applyModel",b="modelSelection[0]",a="value";qx.Class.define(g,{extend:qx.core.Object,construct:function(m,n,o){qx.core.Object.call(this);this._selfUpdate=!!o;this.__Je={};if(m!=null){this.setModel(m);}
;if(n!=null){this.setTarget(n);}
;}
,properties:{model:{check:k,apply:c,event:l,nullable:true,dereference:true},target:{check:d,apply:h,event:f,nullable:true,init:null,dereference:true}},members:{__Jf:null,__Je:null,addBindingOptions:function(name,p,q){this.__Je[name]=[p,q];if(this.getModel()==null||this.getTarget()==null){return;}
;var r=this.getTarget().getItems()[name];var s=this.__Ji(r)?b:a;this.__Jf.removeTarget(r,s,name);this.__Jf.addTarget(r,s,name,!this._selfUpdate,p,q);}
,createModel:function(t){var v=this.getTarget();if(v==null){throw new Error("No target is set.");}
;var w=v.getItems();var x={};for(var name in w){var y=name.split(e);var B=x;for(var i=0;i<y.length;i++){if(i+1==y.length){var A=w[name].constructor;var u=null;if(qx.Class.hasInterface(A,qx.ui.core.ISingleSelection)){u=w[name].getModelSelection().getItem(0)||null;}
else {u=w[name].getValue();}
;if(this.__Je[name]&&this.__Je[name][1]){u=this.__Je[name][1].converter(u);}
;B[y[i]]=u;}
else {if(!B[y[i]]){B[y[i]]={};}
;B=B[y[i]];}
;}
...
;var C=this.getTarget().getItems();for(var name in C){var F=C[name];var E=this.__Ji(F)?b:a;var D=this.__Je[name];D=D&&this.__Je[name][1];qx.data.SingleValueBinding.updateTarget(F,E,this.getModel(),name,D);}
;}
,_applyTarget:function(G,H){if(H!=null){this.__Jh(H);}
;if(this.getModel()==null){return;}
;if(G!=null){this.__Jg();}
;}
,_applyModel:function(I,J){if(this.__Jf!=null&&I==null){this.__Jf.setModel(null);}
;if(this.__Jf!=null){var K=this.getTarget().getItems();for(var name in K){var M=K[name];var L=this.__Ji(M)?b:a;this.__Jf.removeTarget(M,L,name);}
;}
;if(this.__Jf!=null){this.__Jf.setModel(I);}
;if(this.getTarget()==null){return;}
;if(I!=null){this.__Jg();}
;}
,__Jg:function(){if(this.__Jf==null){this.__Jf=new qx.data.controller.Object(this.getModel());}
;var N=this.getTarget().getItems();for(var name in N){var Q=N[name];var O=this.__Ji(Q)?b:a;var P=this.__Je[name];try{if(P==null){this.__Jf.addTarget(Q,O,name,!this._selfUpdate);}
else {this.__Jf.addTarget(Q,O,name,!this._selfUpdate,P[0],P[1]);}
;}
catch(R){if(qx.core.Environment.get(j)){this.warn("Could not bind property "+name+" of "+this.getModel());}
;}
;}
;this.getTarget().redefineResetter();}
,__Jh:function(S){if(this.__Jf==null){return;}
;var T=S.getItems();for(var name in T){var V=T[name];var U=this.__Ji(V)?b:a;this.__Jf.removeTarget(V,U,name);}
;}
,__Ji:function(W){return qx.Class.hasInterface(W.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(W.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__Jf){this.__Jf.dispose();}
;}
});}
)();
