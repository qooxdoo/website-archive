...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional.6ba7da04cfa6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="font-weight",r="text-align",q='g',p="qx.ui.progressive.renderer.table.cell.Conditional",o=":",n=";",m="color",l="font-style",k="==",j=">",c="between",h="regex",f="<",b="!between",a=">=",e="!=",d="<=",g="";qx.Class.define(p,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(t,u,v,w){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__Io=[k,e,j,f,a,d];this.__Ip=[c,b];this.__Iq=[];this.__zq=t||g;this.__zr=u||g;this.__zs=v||g;this.__zt=w||g;}
,members:{__Io:null,__Ip:null,__Iq:null,__zq:null,__zr:null,__zs:null,__zt:null,__zu:function(x,y){if(x.align){y[r]=x.align;}
;if(x.color){y[m]=x.color;}
;if(x.style){y[l]=x.style;}
;if(x.weight){y[s]=x.weight;}
;}
,addNumericCondition:function(z,A,B,C,D,E,F){if(!qx.lang.Array.contains(this.__Io,z)||A==null){throw new Error("Condition not recognized or value is null!");}
;this.__Iq.push({condition:z,align:B,color:C,style:D,weight:E,value1:A,target:F});}
,addBetweenCondition:function(G,H,I,J,K,L,M,N){if(!qx.lang.Array.contains(this.__Ip,G)||H==null||I==null){throw new Error("Condition not recognized or value1/value2 is null!");}
;this.__Iq.push({condition:G,align:J,color:K,style:L,weight:M,value1:H,value2:I,target:N});}
,addRegex:function(O,P,Q,R,S,T){if(!O){throw new Error("regex cannot be null!");}
;this.__Iq.push({condition:h,align:P,color:Q,style:R,weight:S,regex:O,target:T});}
,_getCellStyle:function(U){if(this.__Iq.length==0){return U.style||g;}
;var i;var Y;var V;var X={"text-align":this.__zq,"color":this.__zr,"font-style":this.__zs,"font-weight":this.__zt};for(i=0;i<this.__Iq.length;i++){var bc=this.__Iq[i];Y=false;if(qx.lang.Array.contains(this.__Io,bc.condition)){if(bc.target==null){V=U.cellData;}
...
;break;};}
else if(qx.lang.Array.contains(this.__Ip,bc.condition)){if(bc.target==null){V=U.cellData;}
else {V=U.element.data[bc.target];}
...
;}
;return ba.join(g);}
},destruct:function(){this.__Io=this.__Ip=this.__Iq=null;}
});}
)();
