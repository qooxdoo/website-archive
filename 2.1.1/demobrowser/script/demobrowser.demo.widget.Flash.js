...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.de0efbdf0bc2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="Flash Player Version",j="right",i="qooxdoo is the best!",h="Message from Flash:",g="__Tt",f="Simple demo with FlashVars",d="__ce",c="bgcolor",b="demobrowser.demo.widget.Flash",a="demobrowser/demo/flash/TestFlash.swf",C="Send to Flash",B="demobrowser/demo/flash/FlashVersion.swf",A="No message.",z="Flash:",y="<b>qooxdoo:</b>",x="__IG",w="demobrowser.demo.widget.Flash.sendMessage",v="demobrowser.demo.widget.Flash.flashReady",u="__Tr",t="demobrowser/demo/flash/fo_tester.swf",r="this is passed in via FlashVars",s="Two way communication (ActionScript <-> JavaScript)",p="__Ts",q="Message to Flash:",n="Show Flash Player version",o="noscale",l="#FF6600",m="execute";qx.Class.define(b,{extend:qx.application.Standalone,members:{__ce:null,main:function(){qx.application.Standalone.prototype.main.call(this);var D=new qx.ui.tabview.TabView();D.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(D,{edge:0});var E=new qx.ui.tabview.Page(f);E.setLayout(new qx.ui.layout.Canvas());E.add(this.createFlashDemo1(),{edge:0});D.add(E);var F=new qx.ui.tabview.Page(s);F.setLayout(new qx.ui.layout.Canvas());F.add(this.createFlashDemo2(),{edge:0});D.add(F);this.__ce=this.createWindow();G.add(this.__ce,{top:20,left:20});}
,createWindow:function(){var H=new qx.ui.window.Window(k).set({width:300,height:200,contentPadding:[0,0,0,0]});H.setLayout(new qx.ui.layout.Canvas());H.add(new qx.ui.embed.Flash(B),{edge:0});return H;}
,createFlashDemo1:function(){var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var I={flashVarText:r};var J=new qx.ui.embed.Flash(t).set({scale:o,variables:I});J.getContentElement().setParam(c,l);K.add(J,{flex:1});var L=new qx.ui.form.Button(n);L.addListener(m,function(){this.__ce.open();}
,this);K.add(L);return K;}
,__IG:null,__Tr:null,__Ts:null,__Tt:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var O=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));O.add(N,{flex:1});N.add(new qx.ui.basic.Label(y).set({rich:true}));N.add(new qx.ui.basic.Label(h));this.__Tr=new qx.ui.form.TextArea(A);this.__Tr.setEnabled(false);N.add(this.__Tr,{flex:1});N.add(new qx.ui.basic.Label(q));this.__Ts=new qx.ui.form.TextArea(i);N.add(this.__Ts,{flex:1});var P=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,j));this.__Tt=new qx.ui.form.Button(C);this.__Tt.setEnabled(false);this.__Tt.addListener(m,function(e){this.__IG.getFlashElement().sendMessage(this.__Ts.getValue());}
,this);P.add(this.__Tt);N.add(P);var M=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));O.add(M,{flex:1});M.add(new qx.ui.basic.Label(z).set({rich:true}));this.__IG=new qx.ui.embed.Flash(a);this.__IG.setVariables({init:v});M.add(this.__IG,{flex:1});return O;}
,sendMessage:function(Q){this.__Tr.setValue(Q);}
,initFlash:function(){if(this.__IG.getFlashElement().setup){this.__IG.getFlashElement().setup(w);this.__Tt.setEnabled(true);}
...
;}
},statics:{__Tu:null,setCallBackInstance:function(R){demobrowser.demo.widget.Flash.__Tu=R;}
,sendMessage:function(S){demobrowser.demo.widget.Flash.__Tu.sendMessage(S);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Tu.initFlash();}
},destruct:function(){this._disposeObjects(u,p,g,x,d);}
});}
)();
...
,_checkLoading:function(){var bh=this.getSource();if(bh!=s&&bh!=null&&bh!=y){if(!this.isLoaded()){if(!this.__IB){this.__IB=new Date().getTime();}
;var bi=new Date().getTime()-this.__IB;if(this.getLoadTimeout()>bi){var bj=qx.util.TimerManager.getInstance();bj.start(this._checkLoading,0,this,null,10);this.fireEvent(R);}
else {if(qx.core.Environment.get(K)){this.debug("Timeout after: "+bi);}
;this.fireEvent(J);this.__IB=null;}
;}
else {this.fireEvent(Y);this.__IB=null;}
;}
;}
...
,_applyQuality:function(bt,bu){this.__IC(j,bt);}
,_applyScale:function(bv,bw){this.__IC(f,bv);}
,_applyWmode:function(bx,by){this.__IC(a,bx);}
,_applyPlay:function(bz,bA){this.__IC(k,bz);}
,_applyLoop:function(bB,bC){this.__IC(V,bB);}
,_applyMenu:function(bD,bE){this.__IC(T,bD);}
,_applyAllowScriptAccess:function(bF,bG){this.__IC(U,bF);}
,_applyLiveConnect:function(bH,bI){this.__IC(q,bH);}
,__IC:function(bJ,bK){this.getContentElement().setParam(bJ,bK);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var g="movie",f="id",e="qx.html.Flash",d="Invalid attribute 'key'.",c="div",b="Invalid attribute 'value'.",a="qx.debug";qx.Class.define(e,{extend:qx.html.Element,construct:function(h,i){qx.html.Element.call(this,c,h,i);this.__ID={};this.__IE={};this.__IF={};}
,members:{__ID:null,__IF:null,__IE:null,__IG:null,_createDomElement:function(){return qx.dom.Element.create(c);}
