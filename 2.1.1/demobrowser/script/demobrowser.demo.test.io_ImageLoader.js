...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.io_ImageLoader.73fa585de736.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="img",d="absolute",c="demobrowser.demo.test.io_ImageLoader",b="http://resources.qooxdoo.org/images/logo.gif",a="100px";qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.io.ImageLoader.load(b,function(f,g){qx.log.Logger.debug("Image loaded ("+g.width+"x"+g.height+")");var h=document.createElement(e);h.src=f;h.width=Math.round(g.width*1.5);h.height=Math.round(g.height*1.5);h.style.position=d;h.style.left=a;h.style.top=a;document.body.appendChild(h);}
);}
}});}
)();
