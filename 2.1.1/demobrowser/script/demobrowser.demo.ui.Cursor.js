...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Cursor.7953294e495a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="nw-resize",u="main",t="#DDD",s="w-resize",r="text",q="#555",p="se-resize",o="crosshair",n="sw-resize",m="n-resize",e="default",l="s-resize",h="nesw-resize",c="pointer",b="help ",g="demobrowser.demo.ui.Cursor",f="move",j="ne-resize",a="e-resize",k="nwse-resize",d="wait";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var y=new qx.ui.container.Scroll();var w=new qx.ui.layout.HBox();w.setSpacing(10);var x=new qx.ui.container.Composite(w);x.setPadding(20);y.add(x);this.getRoot().add(y,{edge:0});x.add(this.getGrid1());}
,getGrid1:function(){var A=new qx.ui.container.Composite().set({textColor:t});var z=new qx.ui.layout.Grid();z.setSpacing(20);A.setLayout(z);var B=[e,o,c,f,m,j,a,p,l,n,s,v,h,k,r,d,b];var i=0;for(var i=0;i<B.length;i++){A.add(new qx.ui.basic.Label(B[i]).set({decorator:u,backgroundColor:q,cursor:B[i],padding:5,height:100,width:100}),{row:Math.floor(i/5),column:i%5});}
;return A;}
}});}
)();
