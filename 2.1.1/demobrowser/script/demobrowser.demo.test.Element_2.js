...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_2.ee6a4b4de0e0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="backgroundColor",r="#ccc",q="fontSize",p="demobrowser.demo.test.Element_2",o="20px",n="el5",m="red",l="el4_3",k="el2",j="el3",d="el4",i="test",g="doc",c="color",b="el1",f="text",e="el4_2",h="el4_1",a="id";qx.Class.define(p,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);this.info("Create document");var t=new qx.html.Root(document.getElementById(i));t.setAttribute(a,g);this.info("Create five elements (2 hidden)");var z=new qx.html.Element;z.setAttribute(a,b);var x=new qx.html.Element;x.setAttribute(a,k);var y=new qx.html.Element;y.setAttribute(a,j);var A=new qx.html.Element;A.setAttribute(a,d);var B=new qx.html.Element;B.setAttribute(a,n);t.add(z,x,y,A,B);x.exclude();A.exclude();qx.html.Element.flush();this.info("Make simple hidden element visible");x.include();qx.html.Element.flush();this.info("Make complex hidden element visible");var u=new qx.html.Element;u.setAttribute(a,h);var w=new qx.html.Element;w.setAttribute(a,e);w.setStyle(c,m);w.setAttribute(f,e);w.exclude();var v=new qx.html.Element;v.setAttribute(a,l);A.add(u,w,v);A.include();qx.html.Element.flush();this.info("Show inner element");w.include();qx.html.Element.flush();this.info("Internal move while hidden");A.exclude();v.moveTo(0);A.remove(w);u.setStyle(q,o);u.setAttribute(f,h);A.setStyle(s,r);qx.html.Element.flush();this.info("Internal move while hidden -> show again");A.include();qx.html.Element.flush();}
}});}
)();
