...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr.934f1507de44.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(A,{extend:qx.data.store.Jsonp,construct:function(P){this.setCallbackName(u);qx.data.store.Jsonp.call(this,this.__RU(P));}
,members:{searchForTag:function(Q){if(Q!=m){this.setUrl(this.__RU(Q));}
;}
,__RU:function(R){if(!R){return;}
