...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.ScrollIntoView.66410f6faa9f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="z6",h="z8",g="z5",f="z4",e="z1",d="z7",c="z3",b="z2",a="demobrowser.demo.bom.ScrollIntoView";qx.Class.define(a,{extend:qx.application.Native,statics:{test:function(){var m=[e,b,c,f,g,j,d,h];for(var i=0,l=m.length;i<l;i++){var k=document.getElementById(m[i]);qx.log.Logger.info("Width: "+m[i]+": offset="+k.offsetWidth+", scroll="+k.scrollWidth+", client="+k.clientWidth);qx.log.Logger.info("Height: "+m[i]+": offset="+k.offsetHeight+", scroll="+k.scrollHeight+", client="+k.clientHeight);}
;}
}});}
)();
