...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.d5b9493415f8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellClick:function(e){var q=m+e.getRow()+b+e.getColumn()+c;this.__Td(q);}
,_onContextMenu:function(e){var r=j+e.getRow()+b+e.getColumn()+c;this.__Td(r);}
,_onDblclickPane:function(e){var s=i+e.getRow()+b+e.getColumn()+c;this.__Td(s);}
,__Td:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
