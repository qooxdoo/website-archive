...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor_Flash.b8c358ed63c0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="demobrowser.demo.test.Destructor_Flash",h="300px",g="interval",f="height",e="TestFlash.swf",d="400px",c="width",b="div",a="FlashMovie";qx.Class.define(j,{extend:qx.application.Native,members:{__cR:null,__Fq:0,main:function(){qx.application.Native.prototype.main.call(this);this.__cR=[];var k=new qx.event.Timer(5000);k.addListener(g,this.runTest,this);k.start();this.runTest();}
,runTest:function(){for(var i=0;i<5;i++){var m=qx.dom.Element.create(b);qx.bom.element.Style.set(m,c,d);qx.bom.element.Style.set(m,f,h);document.body.appendChild(m);var n=a+this.__Fq;this.__Fq++;qx.bom.Flash.create(m,{movie:e,id:n});this.debug("created: "+n);this.__cR.push(m);}
