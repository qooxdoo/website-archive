...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.adebfcb261f0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__TC:4,__TD:0,add:function(B){this.container.add(B,{row:Math.floor(this.__TD/this.__TC),column:this.__TD%this.__TC});this.__TD+=1;}
