...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea.f35928174798.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cc="clear:both",cb="Insert Table",ca="Color (Hex): ",bY="Georgia",bX="<p>This low-level widget can be used separately at ",bW="http://",bV="BgColor (Hex): ",bU="Indent More",bT="Change font family",bS="demobrowser/demo/icons/htmlarea/format-fill-color.png",bw="Align Right",bv="Format Italic",bu="qx/icon/Oxygen/16/actions/format-text-underline.png",bt="350px",bs='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',br="white",bq="buttons at the toolbar.</p>",bp="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bo="qx/icon/Oxygen/16/actions/format-indent-more.png",bn="Comic Sans MS",cj="Tahoma",ck="20px 20px",ch="float",ci="<h1>HtmlArea low-level widget</h1>",cf="<td>First Row, First cell</td>",cg="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",cd="Align Left",ce="qx/icon/Oxygen/16/actions/format-justify-center.png",cl="input",cm="Align Justify",bL="demobrowser/demo/icons/htmlarea/insert-text.png",bK="Insert Horizontal Ruler",bN="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bM="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bP="HTML Code:",bO="Set Text Background Color",bR="Insert Link",bQ="on",bJ="You can play around with this widget by hitting the ",bI="<td>Second Row, First cell</td>",a="</tbody>",b="Set Text Color",c="demobrowser/demo/icons/htmlarea/format-text-color.png",d="traditional web pages / single-page applications.<br/> ",f="demobrowser/demo/icons/htmlarea/insert-table.png",g="qx/icon/Oxygen/16/actions/edit-undo.png",h="qx/icon/Oxygen/16/actions/edit-clear.png",k="Arial Black",l="Impact",m="Change font size",cq="Link: ",cp="Redo Last Undo Step",co="Format Bold",cn="off",cu="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",ct="br",cs="marginRight",cr="image",cw="<option qxKeepFocus='on' qxSelectable='off'",cv="click",M="<option qxKeepFocus='on' qxSelectable='off' ",N="Remove Format",K="blank.html",L="qx/icon/Oxygen/16/actions/insert-image.png",Q="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",R="</table>",O="<td>First Row, Second cell</td>",P="Insert HTML Code",I="qx/icon/Oxygen/16/actions/insert-link.png",J="Insert Ordered List",v="demobrowser.demo.bom.HtmlArea",u="qx/icon/Oxygen/16/actions/format-justify-left.png",x="Courier",w="Courier New",r="4px",p="qx/icon/Oxygen/16/actions/format-justify-right.png",t="qx/icon/Oxygen/16/actions/format-text-bold.png",s="<td>Second Row, Second cell</td>",o="Insert Image",n="qx/icon/Oxygen/16/actions/format-indent-less.png",W="<tbody>",X="Times New Roman",Y="Align Center",ba="qx/icon/Oxygen/16/actions/edit-redo.png",S="Lucida Console",T="innerHTML",U="Undo Last Change",V="qx/icon/Oxygen/16/actions/format-text-italic.png",bb="Arial",bc="qx/icon/Oxygen/16/actions/format-justify-fill.png",F="Verdana",E="Indent Less",D="Format Strikethrough",C="Format Underline",B="<table border='1'>",A="Inserted Unordered List",z="FontSize: ",y="It is the foundation for the UI widget component.</p>",H="<tr>",G="<option value=''></option>",bd="1px solid #AAA",be="'>",bf="value='",bg="#",bh="</option>",bi="qooxdoo logo",bj="change",bk="select",bl="</tr>",bm="",bA="840px",bz="left",by="16px",bx="outline",bE="mshtml",bD="hideFocus",bC="none",bB="engine.name",bG="true",bF="div",bH="0px";qx.Class.define(v,{extend:qx.application.Native,members:{__Ik:null,__Rd:null,__Re:null,__zd:null,__lj:null,main:function(){qx.application.Native.prototype.main.call(this);this.__Ik=qx.dom.Element.create(bF);qx.bom.element.Style.setStyles(this.__Ik,{margin:ck});var cz=qx.dom.Element.create(bF);qx.bom.element.Style.setStyles(cz,{width:bA,padding:bH,margin:bH});var cy=ci+bX+d+y+Q+bJ+bq;qx.bom.element.Attribute.set(cz,T,cy);this.__Rd=qx.dom.Element.create(bF);qx.bom.element.Style.setStyles(this.__Rd,{width:bA,padding:bH,margin:bH,lineHeight:bH,border:bd});this.__Re=qx.dom.Element.create(bF);qx.bom.element.Style.setStyles(this.__Re,{width:bA,height:bt,border:bd,borderTop:bH,backgroundColor:br});qx.dom.Element.insertEnd(this.__Re,this.__Ik);var cx=bs;this.__zd=new qx.bom.htmlarea.HtmlArea(this.__Re,cx,null,K);this.__zn();qx.dom.Element.insertBegin(this.__Rd,this.__Ik);qx.dom.Element.insertBegin(cz,this.__Ik);qx.dom.Element.insertBegin(this.__Ik,document.body);}
,__Rf:function(e){var cA=window.prompt(z,bm);this.setFontSize(parseInt(cA));}
,__ze:function(e){var cB=window.prompt(ca,bg);this.setTextColor(cB);}
,__zf:function(e){var cC=window.prompt(bV,bg);this.setTextBackgroundColor(cC);}
,__zg:function(e){var cD={src:qx.util.ResourceManager.getInstance().toUri(cg),border:0,title:bi,alt:bi};this.insertImage(cD);}
,__zh:function(e){var cE=B+W+H+cf+O+bl+H+bI+s+bl+a+R;this.insertHtml(cE);}
,__zi:function(e){var cF=window.prompt(cq,bW);this.insertHyperLink(cF);}
,__zj:function(e){var cG=window.prompt(bP,bm);this.insertHtml(cG);}
,__zk:function(){var cI=qx.dom.Element.create(bF);qx.bom.element.Style.setStyles(cI,{"float":bz});var cK;var cJ=qx.dom.Element.create(bk,{title:bT});if(qx.core.Environment.get(bB)==bE){qx.bom.element.Attribute.set(cJ,bD,bG);}
else {qx.bom.element.Style.set(cJ,bx,bC);}
;cK=q.create(G);qx.dom.Element.insertEnd(cK[0],cJ);var cL=[cj,F,X,bb,k,w,x,bY,l,bn,S];var cH;var cM;for(var i=0,j=cL.length;i<j;i++){cH=cw+bf+cL[i]+be+cL[i]+bh;cM=q.create(cH);if(qx.core.Environment.get(bB)==bE){qx.bom.element.Attribute.set(cM[0],bD,bG);}
else {qx.bom.element.Style.set(cM[0],bx,bC);}
;qx.dom.Element.insertEnd(cM[0],cJ);}
;qx.event.Registration.addListener(cJ,bj,function(e){var cN=e.getTarget();var cO=cN.selectedIndex;if(cO!=0){this.setFontFamily(cN.options[cO].value);cN.options[0].selected=true;}
;}
,this.__zd);qx.dom.Element.insertBegin(cJ,cI);return cI;}
,__zl:function(){var cQ=qx.dom.Element.create(bF);qx.bom.element.Style.setStyles(cQ,{"marginRight":by,"float":bz});var cS;var cR=qx.dom.Element.create(bk,{title:m});if(qx.core.Environment.get(bB)==bE){qx.bom.element.Attribute.set(cR,bD,bG);}
else {qx.bom.element.Style.set(cR,bx,bC);}
;cS=q.create(G);qx.dom.Element.insertEnd(cS[0],cR);var cT;var cP;for(var i=1;i<=7;i++){cP=M+bf+i+be+i+bh;cT=q.create(cP);if(qx.core.Environment.get(bB)==bE){qx.bom.element.Attribute.set(cT[0],bD,bG);}
else {qx.bom.element.Style.set(cT[0],bx,bC);}
;qx.dom.Element.insertEnd(cT[0],cR);}
;qx.event.Registration.addListener(cR,bj,function(e){var cU=e.getTarget();var cV=cU.selectedIndex;if(cV!=0){this.setFontSize(cU.options[cV].value);cU.options[0].selected=true;}
;}
,this.__zd);qx.dom.Element.insertBegin(cR,cQ);return cQ;}
,__zn:function(){var cX=[{bold:{text:co,image:t,action:this.__zd.setBold},italic:{text:bv,image:V,action:this.__zd.setItalic},underline:{text:C,image:bu,action:this.__zd.setUnderline},strikethrough:{text:D,image:cu,action:this.__zd.setStrikeThrough},removeFormat:{text:N,image:h,action:this.__zd.removeFormat}},{alignLeft:{text:cd,image:u,action:this.__zd.setJustifyLeft},alignCenter:{text:Y,image:ce,action:this.__zd.setJustifyCenter},alignRight:{text:bw,image:p,action:this.__zd.setJustifyRight},alignJustify:{text:cm,image:bc,action:this.__zd.setJustifyFull}},{fontFamily:{custom:this.__zk},fontSize:{custom:this.__zl},fontColor:{text:b,image:c,action:this.__ze},textBackgroundColor:{text:bO,image:bS,action:this.__zf}},{indent:{text:bU,image:bo,action:this.__zd.insertIndent},outdent:{text:E,image:n,action:this.__zd.insertOutdent}},{insertImage:{text:o,image:L,action:this.__zg},insertTable:{text:cb,image:f,action:this.__zh},insertLink:{text:bR,image:I,action:this.__zi},insertHTML:{text:P,image:bL,action:this.__zj},insertHR:{text:bK,image:bN,action:this.__zd.insertHorizontalRuler}},{ol:{text:J,image:bp,action:this.__zd.insertOrderedList},ul:{text:A,image:bM,action:this.__zd.insertUnorderedList}},{undo:{text:U,image:g,action:this.__zd.undo},redo:{text:cp,image:ba,action:this.__zd.redo}}];var da,de,cW,dc;for(var i=0,j=cX.length;i<j;i++){de={};de[cs]=i==j-1?bH:by;de[ch]=bz;da=qx.dom.Element.create(bF);qx.bom.element.Style.setStyles(da,de);for(var db in cX[i]){var dd=cX[i][db];if(dd.custom){cW=dd.custom.call(this);}
else {var cY=qx.util.AliasManager.getInstance().resolve(dd.image);dc={type:cr,src:qx.util.ResourceManager.getInstance().toUri(cY),title:dd.text,qxKeepFocus:bQ,qxSelectable:cn};cW=qx.dom.Element.create(cl,dc);qx.bom.element.Style.setStyles(cW,{width:by,height:by,padding:r});if(qx.core.Environment.get(bB)==bE){qx.bom.element.Attribute.set(cW,bD,bG);}
else {qx.bom.element.Style.set(cW,bx,bC);}
;qx.event.Registration.addListener(cW,cv,dd.action,this.__zd);}
;qx.dom.Element.insertEnd(cW,da);}
;qx.dom.Element.insertEnd(da,this.__Rd);}
;qx.dom.Element.insertEnd(qx.dom.Element.create(ct,{style:cc}),this.__Rd);}
}});}
)();
(function(){var dO="qx.blankpage",dN='</span>',dM="backgroundColor",dL="li",dK='undo',dJ="<br class='webkit-block-placeholder' />",dI="textbackgroundcolor",dH="Function",dG="fontSize",dF="textcolor",cs="home",cr="<",cq="focused",cp="fontFamily",co="load",cn='<font ',cl='id="__elementToFocus__"',ck="setUnderline",cj="backgroundPosition",ci="<!--",dV=' size="',dW='/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',dT="'>",dU='underline',dR='bold',dS="&copy;",dP="ul",dQ="cursorContext",dX="__wE",dY="readyAfterInvalid",dn="styleWithCSS",dm="span",dq=" />",dp="setBold",ds="<P>&nbsp;</P>",dr="</",du="&gt;",dt='="',dl="paddingLeft",dk="inserthorizontalrule",o='<p>',p='</font>',q="backgroundRepeat",r="insertimage",t="a",u="&amp;",v="removeformat",w="marginLeft",x="ready",y="<p>&nbsp;</p>",eo='DOCTYPE html PUBLIC "-/',en="browser.version",em=" html, body {overflow-x: visible; } ",ek='<body>',es="insertorderedlist",er='body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } ',eq="hideFocus",ep="none",eu='/DTD XHTML 1.0 Transitional/',et='<html xmlns="http:/',br="outline",bs="setItalic",bp="font-style",bq="marginBottom",bv="xhtml",bw="focusOut",bt="justifyleft",bu='</p>',bn="paddingTop",bo="Please use the method 'qx.dom.Node.isBlockNode' instead.",S='<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',R="Control",U='<span style="font-family:',T='/W3C/',O="placeholder",N='size',Q="backgroundImage",P="marginTop",M="> ",L=" { ",bC="font-weight",bD="LI",bE='italic',bF='<!',by="\ufeff",bz="&quot;",bA="marginRight",bB="STYLE",bG="justifyfull",bH="inserthyperlink",bg="<br />",bf='html { margin:0px; padding:0px; } ',be="<br>",bd='/EN" "http:/',bc="justifycenter",bb="<br /><div id='placeholder'></div>",ba="useCSS",Y="object",bk="strikethrough",bj="text/html",bI="true",bJ="1.9",bK='',bL=' style="',bM="indent",bN="messengerContent",bO="Integer",bP="insertunorderedlist",bQ="Text",bR="&lt;",cA='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>',cz='<br/><div class="placeholder"></div>',cy="selectall",cx="transparent",cE=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",cD="justifyright",cC='/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',cB="ol",cI="//text()[string-length(normalize-space(.))>0]",cH="outdent",dg="about:blank",dh="<body style='",de="qx.bom.htmlarea.HtmlArea",df="paddingBottom",dc="Verdana",dd="$",da="-->",db=" }",di="paddingRight",dj='html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } ',dy="Off",dx='p { margin:0px; padding:0px; }',dA='body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ',dz="pageup",dC="backgroundcolor",dB="end",dE="div",dD='On',dw="redo",dv="i",eg="backspace",eh="bold",ei="mouseup",ej="y",ec="style",ed="backgroundimage",ee="100%",ef='</head>',ea='<head>',eb="k",n=":",m='redo',l='Off',k='">',h="down",g="font-family",f="g",d="keypress",c="fontsize",b="undo",B="text-decoration",C="pagedown",z="justify",A="center",F="p",G='</style>',D="u",E="focus",I="control",J="click",cM='<style type="text/css">',cG="up",cT="blur",cP="font-size",cv="None",ct="'",W="delete",cw="_moz_dirty",bi=">",bh='</body></html>',ca="line-through",cb="String",cc="z",cd=";",ce="fontfamily",cf="keydown",cg="keyup",ch="focusout",bX="engine.version",bY="br",cu="inserthtml",cS="italic",cR="body",cQ="underline",cX="old_id",cW="b",cV="loadingError",cU="contextmenu",cO="enter",cN='"',H="left",bm="text-align",bl="right",cF="qx.bom.htmlarea.HtmlArea.debug",bx="qx.event.type.Data",cL="opera",cK="id",cJ="qx.event.type.Event",V=" ",cY="Boolean",K="__elementToFocus__",X="qx.debug",bS="webkit",bT="gecko",bU="mshtml",bV="",bW="engine.name";qx.Class.define(de,{extend:qx.core.Object,construct:function(ev,ew,ey,ez){qx.core.Object.call(this);var eA=ez||qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(dO));this.__xK(ev);this.__xL();this._createAndAddIframe(eA);this._addIframeLoadListener();this.__xs=qx.bom.htmlarea.HtmlArea.__xu(ey);if(qx.lang.Type.isString(ew)){this.__xt=ew;}
;this.__wE=this.__xY();}
,events:{"load":cJ,"loadingError":bx,"messengerContent":bx,"cursorContext":bx,"ready":cJ,"readyAfterInvalid":cJ,"focused":cJ,"focusOut":cJ,"contextmenu":bx,"undoRedoState":bx},statics:{simpleLinebreak:be,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:dp},italic:{method:bs},underline:{method:ck},undo:{method:b},redo:{method:dw}},__xu:function(eB){if(eB==null||eB==bV){return bV;}
else if(typeof eB==Y){var eC=bV;for(var i in eB){eC+=i+L+eB[i]+db;}
;return eC;}
else {return eB;}
;}
,__xv:function(eD){var eE={};var a=eD.split(cd);var i;for(i=0;i<a.length;i++){var eF=a[i],eG=eF.indexOf(n);if(eG===-1){continue;}
;var name=eF.substring(0,eG).trim();var eH=eF.substring(eG+1,eF.length).trim();if(name&&eH){eE[name]=eH;}
;}
;return eE;}
,__xw:function(eI,eJ,eK,eL){var eQ=[];switch(eI.nodeType){case 1:case 11:var i;var eO=eI.tagName.toLowerCase();var eS={};var eM={};var closed=(!(eI.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__xx(eI)));if(eJ){if((qx.core.Environment.get(bW)==bU)){if(eO==dE&&eI.className&&eI.className==O){for(i=eI.firstChild;i;i=i.nextSibling){eQ.push(qx.bom.htmlarea.HtmlArea.__xw(i,true,eK,eL));}
;return eQ.join(bV);}
;}
;var eR=eI.attributes;var eP=eR.length;var a;if((qx.core.Environment.get(bW)==bT)){if(eO==dm&&eP==1&&eR[0].name==cw&&eI.childNodes.length==0){return bV;}
;}
...
;if(name!=ec){if(qx.core.Environment.get(bW)==bU){if(name==cK&&eI.getAttribute(cX)){eT=eI.getAttribute(cX);}
else if(!isNaN(eT)){eT=eI.getAttribute(name);}
else {eT=a.nodeValue;}
;}
else {eT=a.nodeValue;}
;}
else {eT=eI.style.cssText;}
;if(/(_moz|^$)/.test(eT)){continue;}
;if(name==cX){continue;}
;if(!eT){continue;}
;if(name==cK&&eT==K){continue;}
;if(name.charAt(0)===dd){continue;}
;eS[name]=eT;}
;if(eS.style!==undefined){eM=qx.bom.htmlarea.HtmlArea.__xv(eS.style);delete eS.style;}
;if(eL){var eN={domElement:eI,tag:eO,attributes:eS,styles:eM};eL(eN);eN.domElement=null;eO=eN.tag;}
;if(eO){eQ.push(cr,eO);for(var name in eS){var eT=eS[name];eQ.push(V,name,dt,eT.toString().replace(new RegExp(cN,f),ct),cN);}
;if(!qx.lang.Object.isEmpty(eM)){eQ.push(bL);for(var name in eM){var eT=eM[name];eQ.push(name,n,eT.toString().replace(new RegExp(cN,f),ct),cd);}
;eQ.push(cN);}
;eQ.push(closed?dq:bi);}
;}
;for(i=eI.firstChild;i;i=i.nextSibling){eQ.push(qx.bom.htmlarea.HtmlArea.__xw(i,true,eK,eL));}
;if(eJ&&!closed&&eO){eQ.push(dr,eO,bi);}
;break;case 3:eQ.push(eK?eI.data:qx.bom.htmlarea.HtmlArea.__xy(eI.data));break;case 8:eQ.push(ci,eI.data,da);break;};return eQ.join(bV);}
,closingTags:cE,__xx:function(eU){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(V+eU.tagName+V)!=-1);}
,__xy:function(s){s=s.replace(/&/ig,u);s=s.replace(/</ig,bR);s=s.replace(/>/ig,du);s=s.replace(/\x22/ig,bz);s=s.replace(/\xA9/ig,dS);return s;}
,isBlockNode:function(eV){var eW=qx.bom.htmlarea.HtmlArea.isBlockNode;var eX=bo;qx.log.Logger.deprecatedMethodWarning(eW,eX);return qx.dom.Node.isBlockNode(eV);}
,isParagraphParent:function(eY){if(!qx.dom.Node.isElement(eY)){return false;}
;eY=qx.dom.Node.getName(eY);return /^(body|td|th|caption|fieldset|div)$/.test(eY);}
,isHeadlineNode:function(fa){if(!qx.dom.Node.isElement(fa)){return false;}
;var fb=qx.dom.Node.getName(fa);return /^h[1-6]$/.test(fb);}
},properties:{contentType:{check:cb,init:bv},messengerMode:{check:cY,init:false},insertParagraphOnLinebreak:{check:cY,init:true},insertLinebreakOnCtrlEnter:{check:cY,init:true},postProcess:{check:dH,nullable:true,init:null},useUndoRedo:{check:cY,init:true},nativeContextMenu:{check:cY,init:false},defaultFontFamily:{check:cb,init:dc},defaultFontSize:{check:bO,init:4}},members:{__lj:null,__dR:false,__xz:false,__xA:false,__xB:false,__xC:false,__wE:null,__xD:null,__xE:null,__xF:null,__sG:null,__xs:null,__xG:null,__xH:null,__xI:false,__xJ:false,__xK:function(fc){if(qx.dom.Node.isElement(fc)&&qx.dom.Node.isNodeName(fc,dE)){this.__lj=fc;}
;}
,_createAndAddIframe:function(fd){this.__sG=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__sG,fd);if((qx.core.Environment.get(bW)==bU)){qx.bom.element.Attribute.set(this.__sG,eq,bI);}
else {qx.bom.element.Style.set(this.__sG,br,ep);}
;qx.bom.element.Style.setStyles(this.__sG,{width:ee,height:ee});qx.dom.Element.insertBegin(this.__sG,this.__lj);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__sG);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__sG);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__sG,co,this._loaded,this);}
,__xL:function(){this.__xG={"xhtml":{doctype:bF+eo+T+eu+bd+cC,html:et+dW,meta:S,style:qx.core.Environment.select(bW,{"mshtml":bf+dA,"default":dj+er}),contentStyle:dx,body:ek,footer:bh}};}
,__xt:bV,getIframeObject:function(){return this.__sG;}
,getCommandManager:function(){return this.__wE;}
,setValue:function(fe){if(qx.lang.Type.isString(fe)){this.__xt=fe;var ff=this._getIframeDocument();if(ff&&ff.body){ff.body.innerHTML=this.__xM(fe);}
;}
;}
,__xM:function(fg){var fj=bV;if((qx.core.Environment.get(bW)==bT)){if(qx.core.Environment.get(en)<=2){fj+=cA;}
;}
;var fk=fg.length==0?by:bV;var fi=qx.core.Environment.get(bW)==bT||qx.core.Environment.get(bW)==bS?cl:bK;var fh=o+U+this.getDefaultFontFamily()+k+cn+fi+dV+this.getDefaultFontSize()+k+fj+fg+fk+p+dN+bu;return fh;}
,getValue:function(){return this.__xt;}
,getComputedValue:function(fl){return this.getHtml(fl);}
,getCompleteHtml:function(){var fn=this.__xG[this.getContentType()];var fm=fn.html+ea+fn.meta+cM+fn.contentStyle+G+ef;fm+=dh+this.__xN()+dT;fm+=this.getHtml()+bh;return fm;}
,__xN:function(){var fq=[dM,Q,q,cj,cp,dG,P,bq,w,bA,bn,df,dl,di];var fp=qx.bom.element.Style;var fo=this.getContentBody();var ft={};var fs,fu;var fr=qx.core.Environment.get(bW)==bU?2:1;for(var i=0,j=fq.length;i<j;i++){fs=fq[i];fu=fp.get(fo,fs,fr);if(fu!==undefined&&fu!=bV){ft[fs]=fu;}
;}
;return qx.bom.element.Style.compile(ft);}
,getContentDocument:function(){if(this.__dR){return this._getIframeDocument();}
;}
,getContentBody:function(){if(this.__dR){return this._getIframeDocument().body;}
;}
,getContentWindow:function(){if(this.__dR){return this._getIframeWindow();}
;}
,getWords:function(fv){if(!fv){fv=this.getContentBody();}
;if(!fv){return [];}
;var fx=fv.cloneNode(true);var fz=fx.innerHTML;fz=fz.replace(/>/gi,M);fz=fz.replace(/\n/gi,V);fz=fz.replace(/<!--.*-->/gi,bV);fx.innerHTML=fz;var fw=qx.core.Environment.get(bW)==bU||qx.core.Environment.get(bW)==cL?fx.innerText:fx.textContent;var fy=fw.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);return !fy?[]:fy;}
,getWordsWithElement:function(){var fB=this.getTextNodes();var fF={};var i,j,fG,fC,fA;for(var i=0,fE=fB.length;i<fE;++i){fC=fB[i];fG=fC.nodeValue.split(V);for(var j=0,fD=fG.length;j<fD;++j){fA=this._cleanupWord(fG[j]);if(fA!=null&&fA.length>1){if(!fF[fA]){fF[fA]=[];}
;fF[fA].push(fC);}
;}
;}
;return fF;}
,_cleanupWord:function(fH){if(!fH){return null;}
;return fH.replace(qx.bom.htmlarea.HtmlArea.CleanupWordsRegExp,bV);}
,getTextNodes:function(){return this._fetchTextNodes(this.getContentBody());}
,_fetchTextNodes:function(fI){var fK=[];var fJ;if(fI.hasChildNodes){for(var i=0;i<fI.childNodes.length;i++){fJ=this._fetchTextNodes(fI.childNodes[i]);qx.lang.Array.append(fK,fJ);}
;}
;if(fI.nodeType==3){if(fI.nodeValue.length>1){fK.push(fI);}
;}
;return fK;}
,__xO:0,__xP:function(){var fL=this._getIframeDocument();if(!fL){this.__xO++;if(this.__xO>5){this.error('cant load HtmlArea. Document is not available. '+fL);this.fireDataEvent(cV);}
else {if(qx.core.Environment.get(X)){this.error('document not available, try again...');}
;qx.event.Timer.once(function(){this.__xP();}
,this,0);}
;}
else {this.__xO=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__xA){return;}
;if(this.__xz){this.__xQ();return;}
;if((qx.core.Environment.get(bW)==bU)){this.__xP();}
else {this._onDocumentIsReady();}
;}
,isReady:function(){return this.__dR;}
,_onDocumentIsReady:function(){var fM=new qx.bom.htmlarea.manager.Command(this);if(this.getUseUndoRedo()){fM=new qx.bom.htmlarea.manager.UndoRedo(fM,this);}
;this.__xA=true;if((qx.core.Environment.get(bW)==bU)){this.setEditable(true);}
;this.__xT();if(!(qx.core.Environment.get(bW)==cL)){this.__xU();}
;if(!(qx.core.Environment.get(bW)==bU)){this.setEditable(true);}
;this.__dR=true;this.__wE=fM;fM.setContentDocument(this._getIframeDocument());this.__ya();if((qx.core.Environment.get(bW)==cL)){this.__xU();}
;this.fireEvent(x);}
,forceEditable:qx.core.Environment.select(bW,{"gecko":function(){var fN=this._getIframeDocument();if(fN){if(parseFloat(qx.core.Environment.get(bX))>=bJ){fN.designMode=dy;fN.body.contentEditable=false;fN.body.contentEditable=true;}
else {fN.body.contentEditable=true;this.__yb(true);}
;}
;}
,"default":(function(){}
)}),invalidateEditor:qx.core.Environment.select(bW,{"gecko":function(){this.__xA=false;this.__dR=false;this.__xz=true;}
,"default":function(){}
}),__xQ:qx.core.Environment.select(bW,{"gecko":function(){this.__xT();this.__xU();this.__wE.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__xA=true;this.__dR=true;this.__xz=false;this.fireEvent(dY);}
,"default":function(){}
}),__xR:function(fO){var fQ=bV;if(!fO){return fQ;}
;try{var fP=fO.getAttribute(ec);if(!fP){return fQ;}
;if((qx.core.Environment.get(bW)==bU)){fQ=fP.cssText;}
else {fQ=fP;}
;}
catch(fR){this.error("can't extract style from elem. ");}
;return fQ;}
,__xS:function(fS){var fT=qx.core.Environment.get(bW)==bT?em:bV;var fU=this.__xG[this.getContentType()];var fV=ea+fU.meta+cM+fT+fU.style+fU.contentStyle+this.__xs+G+ef;var content=fU.body+fS;return fU.html+fV+content+fU.footer;}
,__xT:function(){var fX=this.__xM(this.getValue());if(qx.lang.Type.isString(fX)){var fW=this._getIframeDocument();try{fW.open(bj,true);fW.write(this.__xS(fX));fW.close();}
catch(e){this.error("cant open document on source '"+qx.bom.Iframe.queryCurrentUrl(this.__sG)+"'",e);this.fireDataEvent(cV,e);}
;}
;}
,__xU:function(){this.__xV();this.__xX();this.__xW();}
,__xV:function(){var ga=qx.event.Registration;var fY=this._getIframeDocument();ga.addListener(fY.body,d,this._handleKeyPress,this);ga.addListener(fY.body,cg,this._handleKeyUp,this);ga.addListener(fY.body,cf,this._handleKeyDown,this);}
,__xW:function(){var gd=qx.event.Registration;var gb=this._getIframeDocument();var gc=qx.core.Environment.get(bW)==bS?this._getIframeWindow():gb.body;gd.addListener(gc,E,this._handleFocusEvent,this);gd.addListener(gc,cT,this._handleBlurEvent,this);gd.addListener(gb,ch,this._handleFocusOutEvent,this);}
,__xX:function(){var gg=qx.event.Registration;var gf=this._getIframeDocument();var ge=qx.core.Environment.get(bW)==bU?J:ei;gg.addListener(gf.body,ge,this._handleMouseUpOnBody,this);gg.addListener(gf.documentElement,ge,this._handleMouseUpOnDocument,this);gg.addListener(gf.documentElement,cU,this._handleContextMenuEvent,this);}
,__xY:function(){if(this.__xD==null){this.__xD={execute:function(gh,gi){this.stackedCommands=true;this.commandStack.push({command:gh,value:gi});}
,commandStack:[],stackedCommands:false};}
;this.__xD.stackedCommands=false;return this.__xD;}
,__ya:function(){var gj=this.__xD;if(gj!=null&&gj.stackedCommands){var gk=gj.commandStack;if(gk!=null){for(var i=0,j=gk.length;i<j;i++){this.__wE.execute(gk[i].command,gk[i].value);}
;}
;}
;}
,__yb:function(gl){var gm=this._getIframeDocument();if(this.__xA&&gm){try{if((qx.core.Environment.get(bW)==bT)){gm.designMode=(gl!==false)?l:dD;}
;gm.designMode=(gl!==false)?dD:l;}
catch(e){}
;}
;}
,setEditable:function(gn){if(this.__xA){this.__yb(true);if((qx.core.Environment.get(bW)==bT)){try{var go=this._getIframeDocument();go.execCommand(dn,false,true);}
catch(gp){try{var go=this._getIframeDocument();go.execCommand(ba,false,false);}
catch(gq){if(!this.__dR){this.error("Failed to enable rich edit functionality");this.fireDataEvent(cV,gq);}
...
;this.__xB=gn;}
;}
,getEditable:function(){return this.__xB;}
,isEditable:function(){return this.__xB;}
,__yc:false,_handleKeyUp:function(e){var gr=e.getKeyIdentifier().toLowerCase();this.__xE=e;if((qx.core.Environment.get(X))&&qx.core.Environment.get(cF)){this.debug(e.getType()+" | "+gr);}
;if(qx.core.Environment.get(bW)==bU||qx.core.Environment.get(bW)==bS){if(this.__yc){switch(gr){case cO:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(bW)==bS)){this.__yd();e.preventDefault();e.stopPropagation();}
else {var gs=this.__yn(this.getSelection());if(gs){gs.collapse(true);gs.pasteHTML(cz);}
;}
;this.__yi();}
;break;case I:this.__yc=false;return;break;};}
;}
else if((qx.core.Environment.get(bW)==bT)){switch(gr){case H:case bl:case cG:case h:case dz:case C:case W:case dB:case eg:this.__xC=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__yd:function(){var gt=this.getSelection();var gu=bV;if(gt&&(gt.focusNode.textContent==bV||gt.focusNode.parentElement.tagName==bD)){gu=dJ;}
;this.__wE.execute(cu,gu+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
,_handleKeyDown:qx.core.Environment.select(bW,{"mshtml|webkit":function(e){var gv=e.getKeyIdentifier().toLowerCase();if((qx.core.Environment.get(X))&&qx.core.Environment.get(cF)){}
;if(this.__yc&&(gv==cc||gv==ej||gv==cW||gv==D||gv==dv||gv==eb)){e.preventDefault();e.stopPropagation();}
;if(gv==I){this.__yc=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var gA=this.getContentDocument();var gw=e.getKeyIdentifier().toLowerCase();var gy=e.isCtrlPressed();var gz=e.isShiftPressed();this.__xE=e;if((qx.core.Environment.get(X))&&qx.core.Environment.get(cF)){this.debug(e.getType()+" | "+gw);}
;if(this.__xI){var gG=!((qx.core.Environment.get(bW)==bU)&&gw==cO)||!((qx.core.Environment.get(bW)==bT)&&gw==cO);if(gG){this.__yi();this.__xI=false;}
;}
;switch(gw){case cO:if(!gz&&!gy&&this.getMessengerMode()){e.preventDefault();e.stopPropagation();this.fireDataEvent(bN,this.getComputedValue());this.resetHtml();}
;if(gy){if(!this.getInsertLinebreakOnCtrlEnter()){return;}
;e.preventDefault();e.stopPropagation();if((qx.core.Environment.get(bW)==bT)){if(this.__yl()){this.insertHtml(bg);this.__yi();return;}
;this.insertHtml(bb);}
else if((qx.core.Environment.get(bW)==cL)){var gF=this.getSelection();var gB=this.__yn(gF);if(gF&&gB){var gC=gA.createElement(bY);gB.collapse(true);gB.insertNode(gC);gB.collapse(true);gB.selectNode(gC);gF.addRange(gB);gB.collapse(true);}
;}
;this.__yi();}
;if((qx.core.Environment.get(bW)==bU)){if(!this.getInsertParagraphOnLinebreak()){if(this.__wE.execute(cu,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__yi();e.preventDefault();e.stopPropagation();}
;}
;}
else if((qx.core.Environment.get(bW)==bT)){if(this.getInsertParagraphOnLinebreak()&&!gz&&!gy){var gF=this.getSelection();if(gF){var gx=gF.focusNode;if(this.__yl()){this.__yi();return;}
;if(this.__ym()){this.__yi();return;}
;while(!qx.dom.Node.isNodeName(gx,cR)){if(qx.dom.Node.isNodeName(gx,dL)){this.__yi();return;}
;gx=gx.parentNode;}
;}
;this.__wE.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__yi();this.__xI=true;}
;}
else if((qx.core.Environment.get(bW)==bS)){if(this.getInsertParagraphOnLinebreak()&&gz){this.__yd();e.preventDefault();e.stopPropagation();this.__yi();}
;}
;break;case cG:if(qx.core.Environment.get(bW)==bT&&qx.core.Environment.get(bX)<1.9&&gz){var gF=this.getSelection();if(gF&&gF.focusNode==gA.body.firstChild){if(this.__xC){if(gF.focusOffset!=0){gF.extend(gF.focusNode,0);}
;}
;}
;}
;this.__yi();break;case cs:if(qx.core.Environment.get(bW)==bT&&qx.core.Environment.get(bX)<1.9){if(gy){var gF=this.getSelection();if(gz){if(gF&&(gF.focusOffset!=0)||(gF.focusNode!=gA.body.firstChild)){gF.extend(gA.body.firstChild,0);}
;}
else {var gD=null;var gE;if(gA){gD=gA.evaluate(cI,gA.body,null,XPathResult.ANY_TYPE,null);}
;if(gD&&gF){while(gE=gD.iterateNext()){if(gE&&gE.parentNode&&gE.parentNode.tagName!=bB){try{gF.extend(gE,0);if(!this.isSelectionCollapsed()){gF.collapseToStart();}
;}
catch(gH){}
;break;}
;}
...
;}
;}
;this.__yi();break;case H:case bl:case h:case dz:case C:case W:case dB:case eg:this.__yi();break;case cW:if(gy){this.__ye(dR,true);}
;break;case dv:case eb:if(gy){this.__ye(bE,true);}
;break;case D:if(gy){this.__ye(dU,true);}
;break;case cc:if(gy&&!gz){this.__ye(dK,true);}
else if(gy&&gz){this.__ye(m,true);}
;break;case ej:if(gy){this.__ye(m,true);}
;break;case t:if(gy){this.selectAll();}
;break;};this.__xE=null;}
,__ye:function(gI,gJ){var gL=null;var gK=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(gK[gI]){gL=gK[gI].method;}
;if(gL!=null&&this[gL]){this[gL]();if(gJ){this.__xE.preventDefault();this.__xE.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__xI=true;}
;this.__yi();}
;}
,_handleFocusEvent:function(e){this.__xF=null;if(qx.core.Environment.get(bW)==bT||qx.core.Environment.get(bW)==bS){var gM=this.getContentDocument().getElementById(K);if(gM){qx.bom.element.Attribute.reset(gM,cK);}
;}
;this.fireEvent(cq);}
,_handleBlurEvent:function(e){this.__xt=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__yc=false;if(this.__xF==null){this.__xF=this.getSelectedHtml();}
;this.fireEvent(bw);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(X))&&qx.core.Environment.get(cF)){this.debug("handleMouse "+e.getType());}
;this.__xJ=true;this.__yi();}
,_handleMouseUpOnDocument:qx.core.Environment.select(bW,{"mshtml":(function(){}
),"default":function(e){if(!this.__xJ){qx.bom.Element.activate(this.getContentBody());}
;this.__xJ=false;}
}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var gP=e.getViewportLeft();var gO=e.getViewportTop();var gQ=qx.bom.element.Location.getLeft(this.__lj)+gP;var gR=qx.bom.element.Location.getTop(this.__lj)+gO;var gN={x:gQ,y:gR,relX:gP,relY:gO,target:e.getTarget()};e.preventDefault();e.stopPropagation();qx.event.Timer.once(function(){this.fireDataEvent(cU,gN);}
,this,0);}
;}
,isLoaded:function(){return this.__xA;}
,insertHtml:function(gS){return this.__wE.execute(cu,gS);}
,removeFormat:function(){var gT=this.__wE.execute(v);this.__wE.execute(c,this.getDefaultFontSize());this.__wE.execute(ce,this.getDefaultFontFamily());return gT;}
,setBold:function(){return this.__wE.execute(eh);}
,setItalic:function(){return this.__wE.execute(cS);}
,setUnderline:function(){return this.__wE.execute(cQ);}
,setStrikeThrough:function(){return this.__wE.execute(bk);}
,setFontSize:function(gU){return this.__wE.execute(c,gU);}
,setFontFamily:function(gV){return this.__wE.execute(ce,gV);}
,setTextColor:function(gW){return this.__wE.execute(dF,gW);}
,setTextBackgroundColor:function(gX){return this.__wE.execute(dI,gX);}
,setJustifyLeft:function(){return this.__wE.execute(bt);}
,setJustifyCenter:function(){return this.__wE.execute(bc);}
,setJustifyRight:function(){return this.__wE.execute(cD);}
,setJustifyFull:function(){return this.__wE.execute(bG);}
,insertIndent:function(){return this.__wE.execute(bM);}
,insertOutdent:function(){return this.__wE.execute(cH);}
,insertOrderedList:function(){return this.__wE.execute(es);}
,insertUnorderedList:function(){return this.__wE.execute(bP);}
,insertHorizontalRuler:function(){return this.__wE.execute(dk);}
,insertImage:function(gY){return this.__wE.execute(r,gY);}
,insertHyperLink:function(ha){return this.__wE.execute(bH,ha);}
,removeBackgroundColor:function(){return this.__wE.execute(dC,cx);}
,setBackgroundColor:function(hb){return this.__wE.execute(dC,hb);}
,removeBackgroundImage:function(){return this.__wE.execute(ed);}
,setBackgroundImage:function(hc,hd,he){return this.__wE.execute(ed,[hc,hd,he]);}
,selectAll:function(){return this.__wE.execute(cy);}
,undo:function(){if(this.getUseUndoRedo()){return this.__wE.execute(b);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__wE.execute(dw);}
else {return true;}
;}
,resetHtml:function(){var hf=this._getIframeDocument();while(hf.body.firstChild){hf.body.removeChild(hf.body.firstChild);}
;if(qx.core.Environment.get(bW)==bT){hf.body.innerHTML=y;}
else if(qx.core.Environment.get(bW)==bS){var hg=this.getSelection();var hh=hf.createRange();if(hh&&hg){hg.addRange(hh);}
;}
;}
,getHtml:function(hi){var hj=this._getIframeDocument();if(hj==null){return null;}
;return qx.bom.htmlarea.HtmlArea.__xw(hj.body,false,hi,this.getPostProcess());}
,containsOnlyPlaceholder:qx.core.Environment.select(bW,{"mshtml":function(){var hk=this._getIframeDocument();return (hk.body.innerHTML==ds);}
,"default":(function(){return false;}
)}),_selectElement:function(hl){var hn=this.getContentWindow().getSelection();var hm=this.getContentDocument().createRange();hm.setStart(hl,0);hn.removeAllRanges();hn.addRange(hm);}
,focusContent:qx.core.Environment.select(bW,{"gecko":function(){var hp=this.getContentDocument();var ho=hp.getElementById(K);this.getContentWindow().focus();qx.bom.Element.focus(this.getContentBody());if(ho){this._selectElement(ho);}
else {this.__yf();}
;}
,"webkit":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());var hq=this.getContentDocument().getElementById(K);if(hq){qx.bom.element.Attribute.reset(hq,cK);}
;this.__yf();}
,"opera":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());this.__yf();}
,"default":function(){qx.bom.Element.focus(this.getContentBody());this.__yf();}
}),__yf:function(){if(!this.__yg()){this.__yh();}
;}
,__yg:qx.core.Environment.select(bW,{"gecko":function(){var hr=this.getContentBody().childNodes;if(hr.length==0){return false;}
else if(hr.length==1){return !(hr[0]&&qx.dom.Node.isNodeName(hr[0],bY)&&qx.bom.element.Attribute.get(hr[0],cw)!=null);}
else {return true;}
;}
,"webkit":function(){var hs=this.getContentBody().childNodes;if(hs.length==0){return false;}
else if(hs.length==1){return !(hs[0]&&qx.dom.Node.isNodeName(hs[0],bY));}
else {return true;}
;}
,"default":function(){var ht=this.getContentBody().childNodes;if(ht.length==0){return false;}
else if(ht.length==1){return !(ht[0]&&qx.dom.Node.isNodeName(ht[0],F)&&ht[0].firstChild==null);}
else {return true;}
;}
}),__yh:qx.core.Environment.select(bW,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__xM(bV);var hu=this.getContentDocument().getElementById(K);qx.bom.element.Attribute.reset(hu,cK);this._selectElement(hu);}
,"default":function(){var hv=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());if(qx.dom.Node.isNodeName(hv,F)){qx.bom.element.Style.set(hv,g,this.getDefaultFontFamily());qx.bom.element.Style.set(hv,cP,this.getDefaultFontSize());}
;}
}),getContextInformation:function(){return this.__yj();}
,__yi:function(){qx.event.Timer.once(function(e){var hw=this.__yj();this.fireDataEvent(dQ,hw);}
,this,200);}
,__yj:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return null;}
;this._processingExamineCursorContext=true;if(!this.__yg()){this.__yh();}
;var hA=this.getFocusNode();if(hA==null){return null;}
;if(qx.dom.Node.isText(hA)){hA=hA.parentNode;}
;var hE=this._getIframeDocument();var hN=(qx.core.Environment.get(bW)==bU)?hA.currentStyle:hE.defaultView.getComputedStyle(hA,null);var hH=false;var hx=false;var hC=false;var hB=false;var hI=false;var hM=false;var hD=false;var hO=false;var hz=false;var hK=false;var hL=null;var hP=null;var hG=null;if(hN!=null){if((qx.core.Environment.get(bW)==bU)){hx=hN.fontStyle==cS;hC=hN.textDecoration.indexOf(cQ)!==-1;hB=hN.textDecoration.indexOf(ca)!==-1;hL=hN.fontSize;hG=hN.fontFamily;hD=hN.textAlign==H;hO=hN.textAlign==A;hz=hN.textAlign==bl;hK=hN.textAlign==z;}
else {hx=hN.getPropertyValue(bp)==cS;hC=hN.getPropertyValue(B).indexOf(cQ)!==-1;hB=hN.getPropertyValue(B).indexOf(ca)!==-1;hL=hN.getPropertyValue(cP);hG=hN.getPropertyValue(g);hD=hN.getPropertyValue(bm)==H;hO=hN.getPropertyValue(bm)==A;hz=hN.getPropertyValue(bm)==bl;hK=hN.getPropertyValue(bm)==z;}
;if(qx.core.Environment.get(bW)==bU||qx.core.Environment.get(bW)==cL){hH=hN.fontWeight==700;}
else {hH=hN.getPropertyValue(bC)==eh||qx.dom.Node.isNodeName(hA,cW);}
;}
;var hy=hA;if(hy!=null&&hy.parentNode!=null&&!qx.dom.Node.isDocument(hy.parentNode)){while(hy!=null&&!qx.dom.Node.isNodeName(hy,cR)){var hF=qx.dom.Node.getName(hy);if(hF==cB){hM=true;break;}
else if(hF==dP){hI=true;break;}
;if(hP==null||hP==bV){hP=qx.bom.element.Attribute.get(hy,N);}
;hy=hy.parentNode;}
;}
;var hJ={bold:hH?1:0,italic:hx?1:0,underline:hC?1:0,strikethrough:hB?1:0,fontSize:(hP==null)?hL:hP,fontFamily:hG,insertUnorderedList:hI?1:0,insertOrderedList:hM?1:0,justifyLeft:hD?1:0,justifyCenter:hO?1:0,justifyRight:hz?1:0,justifyFull:hK?1:0};this._processingExamineCursorContext=false;return hJ;}
,getSelection:qx.core.Environment.select(bW,{"mshtml":function(){return this._getIframeDocument()?this._getIframeDocument().selection:null;}
,"default":function(){return this._getIframeWindow()?this._getIframeWindow().getSelection():null;}
}),isSelectionCollapsed:qx.core.Environment.select(bW,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==cv;}
,"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;}
}),getSelectedText:qx.core.Environment.select(bW,{"mshtml":function(){return this.getRange()?this.getRange().text:bV;}
,"default":function(){return this.getRange()?this.getRange().toString():bV;}
}),getSelectedHtml:function(){if(this.__xF!=null){return this.__xF;}
;var hQ=this.getRange();if(!hQ){return bV;}
else {return this.__yk(hQ);}
;}
,__yk:qx.core.Environment.select(bW,{"mshtml":function(hR){if(!hR){return bV;}
;return hR.item?hR.item(0).outerHTML:hR.htmlText;}
,"default":function(hS){var hT=this._getIframeDocument();if(hT&&hS){try{var hU=hT.createElement(cR);hU.appendChild(hS.cloneContents());return hU.innerHTML;}
catch(hV){}
;return hS+bV;}
;return bV;}
}),clearSelection:qx.core.Environment.select(bW,{"mshtml":function(){var hW=this.getSelection();if(hW){hW.empty();}
;}
,"default":function(){var hX=this.getSelection();if(hX){hX.collapseToStart();}
;}
}),__yl:qx.core.Environment.select(bW,{"gecko":function(){var hY=this.getSelection();var ia=this.getFocusNode();return hY&&this.isSelectionCollapsed()&&ia!=null&&qx.dom.Node.isText(ia)&&hY.anchorOffset<ia.length;}
,"default":function(){return false;}
}),__ym:qx.core.Environment.select(bW,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());}
,"default":function(){return false;}
}),getRange:function(){return this.__yn(this.getSelection());}
,__yn:qx.core.Environment.select(bW,{"mshtml":function(ib){var ic=this._getIframeDocument();if(ib){try{return ib.createRange();}
catch(id){return ic?ic.body.createTextRange():null;}
;}
else {return ic?ic.body.createTextRange():null;}
;}
,"default":function(ie){var ig=this._getIframeDocument();if(ie){try{return ie.getRangeAt(0);}
catch(ih){return ig?ig.createRange():null;}
;}
else {return ig?ig.createRange():null;}
;}
}),saveRange:qx.core.Environment.select(bW,{"mshtml":function(){this.__xH=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(bW,{"mshtml":function(){return this.__xH;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(bW,{"mshtml":function(){this.__xH=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(bW,{"mshtml":function(){var ii=this.getSelection();var ij;switch(ii.type){case bQ:case cv:ij=this.__yn(ii);if(ij){ij.collapse(false);return ij.parentElement();}
else {return null;}
;break;case R:ij=this.__yn(ii);if(ij){try{ij.collapse(false);}
catch(ik){}
;return ij.item(0);}
else {return null;}
;break;default:return this._getIframeDocument().body;};}
,"default":function(){var il=this.getSelection();if(il&&il.focusNode){return il.focusNode;}
;return this._getIframeDocument().body;}
})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var io=this._getIframeDocument();var iq=qx.event.Registration;iq.removeListener(io.body,d,this._handleKeyPress,this);iq.removeListener(io.body,cg,this._handleKeyUp,this);iq.removeListener(io.body,cf,this._handleKeyDown,this);var ip=qx.core.Environment.get(bW)==bS?this._getIframeWindow():io.body;iq.removeListener(ip,E,this._handleFocusEvent);iq.removeListener(ip,cT,this._handleBlurEvent);iq.removeListener(io,ch,this._handleFocusOutEvent);var im=qx.core.Environment.get(bW)==bU?J:ei;iq.removeListener(io.body,im,this._handleMouseUpOnBody,this);iq.removeListener(io.documentElement,im,this._handleMouseUpOnDocument,this);iq.removeListener(io.documentElement,cU,this._handleContextMenuEvent,this);if((qx.core.Environment.get(bW)==bU)){qx.bom.Iframe.setSource(this.__sG,dg);}
;}
catch(ir){}
;if(this.__wE instanceof qx.core.Object){this._disposeObjects(dX);}
else {this.__wE=null;}
;this.__xG=this.__sG=this.__lj=this.__xD=null;}
});}
)();
...
(function(){var cw="backgroundColor",cv="_moz",cu="formatBlock",ct="__yS",cs="li",cr='<span style="',cq="no-repeat",cp=' <a href="',co="FONT",cn="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",bx="__placeholder__",bw='font-family:',bv="outdent",bu='</a> ',bt="__yR",bs="__yI",br="__resetHtml",bq="FontName",bp="insertParagraph",bo="bold",cD="__yy",cE="blockquote",cB="underline",cC="style",cz="__yY",cA="qx.bom.htmlarea.manager.Command",cx="__yH",cy="'><br class='webkit-block-placeholder' />",cF="__yQ",cG='"',bV="a",bU="<span></span>",bX="type",bW="CreateLink",ca="italic",bY="__zb",cc='" ',cb="qx_link",bT="none",bS='"></span>',a="Italic",b="fontStyle",c="InsertUnorderedList",d="OL",f='text-align:',g="Bold",h="ForeColor",m="url(",n="__yW",o="repeat repeat-x repeat-y no-repeat",cS='</p>',cR="<hr />",cQ="__zc",cP="__yF",cW='<font style="',cV="IMG",cU='<p id="',cT="StrikeThrough",cY="LI",cX="__getHtml",N='>',O="__yV",L='" size="',M="Indent",R="top",S="HiliteColor",P="br",Q="fontWeight",J="Copy",K="</span>",w="Paste",v="Cut",y="RemoveFormat",x="JustifyRight",s="__yU",r='',u='style="',t="__za",q="JustifyCenter",p="_moz_dirty",X="color",Y="JustifyLeft",ba="Underline",bb="SelectAll",T="<p style='",U="line-through",V=")",W="href",bc='<span id="',bd="__yT",G="UL",F="JustifyFull",E="Outdent",D="indent",C="InsertImage",B="selectall",A="InsertOrderedList",z="/>",I="<img ",H="</font>",be="backgroundPosition",bf=':',bg='|',bh="font-size",bi="string",bj="background-color",bk="backgroundRepeat",bl="font",bm=":",bn="='",bB=" ",bA=";",bz="body",by="px",bF="backgroundImage",bE="Control",bD="__paragraph__",bC="qx.bom.htmlarea.HtmlArea.debug",bH="size",bG="' ",bO="webkit",bP="textDecoration",bM="BODY",bN="__yD",bK="undefined",bL="transparent",bI="id",bJ="InsertHtml",bQ='">',bR="child",cg="gecko",cf="font-family",ci="text-align",ch='text-decoration',ck="BackColor",cj="FontSize",cm=';',cl="__yC",ce="p",cd="span",cL='color',cM="text-decoration",cN="inserthtml",cO="qx.debug",cH="mshtml",cI="legacy-font-size",cJ="",cK="engine.name";qx.Class.define(cA,{extend:qx.core.Object,construct:function(da){qx.core.Object.call(this);this.__wF=da;this.__li=null;this._commands=null;this.__xi();this.__yo={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__yp=[10,12,16,18,24,32,48];this.__yq=0;}
,statics:{__yr:cn,__ys:o},members:{__li:null,__wF:null,__yt:false,__yo:null,__yp:null,__yq:null,setContentDocument:function(db){this.__li=db;}
,getCommandObject:function(dc){if(this._commands[dc]){return this._commands[dc];}
else {return null;}
;}
,__xi:function(){this._commands={bold:{useBuiltin:false,identifier:g,method:cz},italic:{useBuiltin:false,identifier:a,method:t},underline:{useBuiltin:false,identifier:ba,method:bY},strikethrough:{useBuiltin:false,identifier:cT,method:cQ},fontfamily:{useBuiltin:true,identifier:bq,method:null},fontsize:{useBuiltin:false,identifier:cj,method:cF},textcolor:{useBuiltin:true,identifier:h,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:bt},backgroundcolor:{useBuiltin:false,identifier:null,method:ct},backgroundimage:{useBuiltin:false,identifier:null,method:bd},justifyleft:{useBuiltin:false,identifier:Y,method:cl},justifyright:{useBuiltin:false,identifier:x,method:cl},justifycenter:{useBuiltin:false,identifier:q,method:cl},justifyfull:{useBuiltin:false,identifier:F,method:cl},indent:{useBuiltin:true,identifier:M,method:null},outdent:{useBuiltin:true,identifier:E,method:null},copy:{useBuiltin:true,identifier:J,method:null},cut:{useBuiltin:true,identifier:v,method:null},paste:{useBuiltin:true,identifier:w,method:null},insertorderedlist:{useBuiltin:false,identifier:A,method:bN},insertunorderedlist:{useBuiltin:false,identifier:c,method:bN},inserthorizontalrule:{useBuiltin:false,identifier:bJ,method:bs},insertimage:{useBuiltin:false,identifier:C,method:cP},inserthyperlink:{useBuiltin:false,identifier:bW,method:cx},selectall:{useBuiltin:false,identifier:bb,method:s},selectedtext:{useBuiltin:false,identifier:null,method:O},selectedhtml:{useBuiltin:false,identifier:null,method:n},inserthtml:{useBuiltin:false,identifier:bJ,method:cD},resethtml:{useBuiltin:false,identifier:null,method:br},gethtml:{useBuiltin:false,identifier:null,method:cX},removeformat:{useBuiltin:true,identifier:y,method:null}};}
,execute:function(dd,de){if(!this.__wF.isReady()){this.error("editor not ready! '"+dd+"':'"+de+"'");return false;}
;dd=dd.toLowerCase();de=de!=null?de:null;if(this._commands[dd]){var df;var dg=this._commands[dd];if(!((qx.core.Environment.get(cK)==bO)&&(dd==D||dd==bv))){if(this.__yu()){this.__yv();}
;}
;if(dg.useBuiltin){df=this.__yw(dg.identifier,false,de);}
...
;}
;this.__wF.resetSavedRange();return df;}
else {this.error("Command "+dd+" is currently not supported!");}
;}
,__yu:function(){var Node=qx.dom.Node;var dh=this.__wF.getFocusNode();var dk=false;var di=false;if(dh){if(Node.isText(dh)){var dj=qx.dom.Hierarchy.getAncestors(dh);for(var i=0,j=dj.length;i<j;i++){if(Node.isNodeName(dj[i],ce)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(dj[i])){dk=true;break;}
;}
;}
else if(Node.isNodeName(dh,bz)){di=true;}
;}
;return di||!dk;}
,__yv:function(){this.__yw(cu,false,ce);}
,__yw:function(dl,dm,dn){try{var dr=this.__li;var dp=false;var dq=this.__wF.getRange();this.__li.body.focus();if((qx.core.Environment.get(cK)==cH)){if(dl!=B){dq.select();if(((dq.text)&&(dq.text.length>0))||((dq.length==1)&&(dq.item(0))&&(dq.item(0).tagName==cV))){dr=dq;}
else {dr=this.__li;}
;}
;if(((qx.core.Environment.get(cK)==cH))&&(this.__yo[dl])){if(dq.text==cJ){dp=true;}
;}
;}
;var ds=dr.execCommand(dl,dm,dn);if(dp&&dq.text!=cJ){dq.collapse();}
;if((qx.core.Environment.get(cO))&&qx.core.Environment.get(bC)){this.debug("execCommand "+dl+" with value "+dn+" succeded");}
;this.__yt=false;}
catch(dt){if((qx.core.Environment.get(cO))&&qx.core.Environment.get(bC)){this.debug("execCommand "+dl+" with value "+dn+" failed");}
;return false;}
;return ds;}
,__yx:qx.core.Environment.select(cK,{"mshtml":function(){var dv=this.__wF;var du=dv.getSavedRange()!=null?dv.getSavedRange():dv.getRange();return du;}
,"default":function(){return this.__wF.getRange();}
}),__yy:qx.core.Environment.select(cK,{"mshtml":function(dw,dx){var dA;if(dw==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__yB();}
else {this.__li.body.focus();var dz=this.__wF.getSelection();var dy=this.__yx();if(dy&&dz&&dz.type!=bE){try{dy.pasteHTML(dw);dy.collapse(false);dy.select();dA=true;}
catch(e){}
;}
else {dA=false;}
;this.__wF.resetSavedRange();return dA;}
;}
,"default":function(dB,dC){this.__li.body.focus();return this.__li.execCommand(dC.identifier,false,dB);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(cK,{"gecko":function(){var dK=this.__yL();var dO=this.__yz(dK);var dG=this.__yJ(dK);var dL=bx+Date.parse(new Date());var dM=bD+Date.parse(new Date());var dE=r;var dI=bc+dL+bS;dE+=dI;dE+=cU+dM+cc+dO+N;dE+=dG+cS;this.__wF.getCommandManager().addUndoStep(cN,bp,this.getCommandObject(cN));this.execute(cN,dE);this.__yA();qx.bom.element.Attribute.reset(this.__li.getElementById(dL),bI);var dJ=this.__li.getElementById(dM);if(dJ.previousSibling.innerHTML==dI){var dD=this.__yK();var dH=this.__li.createElement(P);var dF=this.__li.createAttribute(p);dF.nodeValue=cJ;dH.setAttributeNode(dF);var dN=this.__li.createAttribute(bX);dN.nodeValue=cv;dH.setAttributeNode(dN);dJ.previousSibling.appendChild(dD);dJ.previousSibling.appendChild(dH);}
;qx.bom.element.Attribute.reset(dJ,bI);return true;}
,"webkit":function(){var dP=this.getCurrentStyles();var dQ=cJ;var dS={"background-color":true,"text-align":true};for(var dR in dP){if(dS[dR]){dQ+=dR+bm+dP[dR]+bA;}
;}
;this.__wF.insertHtml(T+dQ+cy);}
,"default":(function(){}
)}),__yz:qx.core.Environment.select(cK,{"gecko":function(dT){var dY=u;var dX=dT.child;if(dX[ci]){dY+=f+dX[ci]+cm;delete dT.child[ci];}
;if(dX[cf]){dY+=bw+dX[cf]+cm;delete dT.child[cf];}
;var dW={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};var dU={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};for(var dV in dX){if(dW[dV]||dU[dV]){dY+=dV+bf+dX[dV]+cm;delete dT.child[dV];}
;}
;dY+=cG;return dY;}
,"default":function(){return cJ;}
}),__yA:qx.core.Environment.select(cK,{"gecko":function(){var eh=this.__wF.getSelection();if(!eh||!eh.focusNode){return;}
;var ea=eh.focusNode;var ef=eh.focusNode;while(!qx.dom.Node.isNodeName(ef,ce)){ef=ef.parentNode;}
;var ee=ef.previousSibling.id;var ei=ef.nextSibling?ef.nextSibling.id:null;if(qx.lang.String.startsWith(ee,bD)&&ee==ei){var eg=ef.nextSibling;var ec=this.__wF.getRange();ec.selectNode(eg);eh.addRange(ec);var eb=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__wF.getCommandManager().addUndoStep(cN,eb,this.getCommandObject(cN));this.execute(cN,eb);var ed=this.__wF.getRange();if(ea){while(ea&&ea.firstChild&&qx.dom.Node.isElement(ea.firstChild)){ea=ea.firstChild;}
;}
;ed.selectNode(ea);eh.addRange(ed);ed.collapse(true);}
;}
,"default":(function(){}
)}),__yB:qx.core.Environment.select(cK,{"mshtml":function(){var ej=this.__wF.getRange();if(ej&&!qx.dom.Node.isNodeName(ej.parentElement(),cs)){ej.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);ej.collapse(false);ej.select();return true;}
;return false;}
,"default":function(){return false;}
}),__yC:function(ek,el){var em=(qx.core.Environment.get(cK)==cH)?this.__wF.getRange():this.__li;return em.execCommand(el.identifier,false,ek);}
,__yD:function(en,eo){if((qx.core.Environment.get(cK)==cH)){var ep=this.__wF.getFocusNode();this.__yE(ep);}
;this.__li.body.focus();var eq=this.__li.execCommand(eo.identifier,false,en);if((qx.core.Environment.get(cK)==bO)){var ep=this.__wF.getFocusNode();this.__yE(ep.parentNode);}
;return eq;}
,__yE:function(er){var es=[];var parent=er.parentNode;while(qx.dom.Node.isNodeName(parent,cE)){es.push(parent);parent=parent.parentNode;}
;if(es.length>0){parent.appendChild(er);parent.removeChild(es[es.length-1]);}
;}
,__yF:qx.core.Environment.select(cK,{"gecko":function(et,eu){if(et.src){this.__li.execCommand(eu.identifier,false,et.src);delete et.src;var eI=this.__wF.getSelection();if(eI){var eH=eI.anchorNode;var eC=eI.anchorOffset;var ez=eH.childNodes[eC-1];var eF;for(var eB in et){eF=this.__li.createAttribute(eB);eF.nodeValue=et[eB];ez.setAttributeNode(eF);}
;var eA={"font":true,"span":true};var ew=null;var eE=true;if(qx.dom.Node.isElement(ez.previousSibling)&&eA[qx.dom.Node.getName(ez.previousSibling)]){ew=ez.previousSibling;}
else if(eA[qx.dom.Node.getName(ez.parentNode)]){ew=ez.parentNode;eE=false;}
;var ey=this.__li.createDocumentFragment();var eJ;if(eE&&ew!=null){var eA=this.__yG(ew);ey.appendChild(eA.root);eJ=eA.inline;}
else {eJ=this.__li.createElement(cd);ey.appendChild(eJ);}
;var eG=this.__li.createTextNode(cJ);eJ.appendChild(eG);var eD=ez.parentNode;if(ez==eD.lastChild){eD.appendChild(ey);}
else {eD.insertBefore(ey,ez.nextSibling);}
;var ev=this.__wF.getRange();ev.selectNodeContents(eJ);}
;return true;}
else {return false;}
;}
,"mshtml":function(eK,eL){var eP=false;var eQ=I;for(var eM in eK){eQ+=eM+bn+eK[eM]+bG;}
;eQ+=z;var eN=this.__wF.getSelection();var eO=this.__yx();if(eN&&eN.type!=bE){try{eO.select();eO.pasteHTML(eQ);eP=true;}
catch(e){}
;}
;this.__wF.resetSavedRange();return eP;}
,"default":function(eR,eS){if(eR.src){var eU=I;for(var eT in eR){eU+=eT+bn+eR[eT]+bG;}
;eU+=z;return this.__li.execCommand(bJ,false,eU);}
else {return false;}
;}
}),__yG:function(eV){while(eV.firstChild&&eV.firstChild.nodeType==1){eV=eV.firstChild;}
;var fa=this.__yL(eV);var fe,eX,fc;var eW=cJ;var parent=null;var fd=null;var fb=fa.child;while(fb){fd=this.__li.createElement(fb[cI]?bl:cd);eX=this.__li.createAttribute(cC);fd.setAttributeNode(eX);for(var eY in fb){if(eY!=bR&&eY!=cI){eW+=eY+bm+fb[eY]+bA;}
else if(eY==cI){fc=this.__li.createAttribute(bH);fc.nodeValue=fb[eY];fd.setAttributeNode(fc);}
;}
;eX.nodeValue=eW;if(parent!=null){parent.appendChild(fd);}
else {fe=fd;}
;parent=fd;fb=fb.child;eW=cJ;}
;return {root:fe,inline:fd};}
,__yH:qx.core.Environment.select(cK,{"gecko|opera":function(ff,fg){var fm=this.__wF.getSelection();var fj=this.__wF.getRange();if(fm.isCollapsed){var fi=cb+(++this.__yq);var fn=this.__li.createElement(bV);var fk=this.__li.createAttribute(W);var fh=this.__li.createAttribute(bI);var fl=this.__li.createTextNode(ff);fh.nodeValue=fi;fn.setAttributeNode(fh);fk.nodeValue=ff;fn.setAttributeNode(fk);fn.appendChild(fl);fj.insertNode(fn);fj.selectNode(fn);fm.collapseToEnd();return true;}
else {return this.__li.execCommand(fg.identifier,false,ff);}
;}
,"mshtml":function(fo,fp){try{var fr;var fq=this.__yx();var fs=this.__wF;var fq=fs.getSavedRange()!=null?fs.getSavedRange():fs.getRange();if(fq!=null&&fq.text!=cJ){fr=fq.execCommand(fp.identifier,false,fo);}
else {fr=this.__yy(cp+fo+bQ+fo+bu,fp);}
;this.__wF.resetSavedRange();return fr;}
catch(e){if(qx.core.Environment.get(cO)){this.error("inserthyperlink failed!");}
;return false;}
;}
,"default":function(ft,fu){return this.__li.execCommand(fu.identifier,false,ft);}
}),__yI:function(fv,fw){var fx=cR;if((qx.core.Environment.get(cK)==cg)){fx+=this.__yJ();}
;return this.__yy(fx,fw);}
,__yJ:function(fy){var fC=cJ;var fB=cr;var fA=[];var fF=typeof fy!==bK?fy:this.__yL();var fD=fF.child;var fE=false;if(qx.lang.Object.isEmpty(fD)){return cJ;}
;while(fD){fE=fD[cI]!=null;fC+=fE?cW:fB;for(var fz in fD){fC+=(fz!=bR&&fz!=cI)?fz+bf+fD[fz]+cm:cJ;}
;fC+=fE?L+fD[cI]+bQ:bQ;fA.unshift(fE?H:K);fD=fD.child;}
;if(fA.length==1&&fA[0]==H){fC+=bU;}
;for(var i=0,j=fA.length;i<j;i++){fC+=fA[i];}
;return fC;}
,__yK:function(){var fH=this.__li.createDocumentFragment();var fM=this.__yL();var parent=fH;var fK=fM.child;var fI;var fL=false;while(fK){fL=fK[cI]!=null;fI=this.__li.createElement(fL?bl:cd);parent.appendChild(fI);for(var fG in fK){if(fG!=bR&&fG!=cI){qx.bom.element.Style.set(fI,fG,fK[fG]);}
;}
;if(fL){var fJ=this.__li.createAttribute(bH);fJ.nodeValue=fK[cI];fI.setAttributeNode(fJ);}
;parent=fI;fK=fK.child;}
;return fH;}
,__yL:function(fN){var fP={};var fQ=null;var fR=this.getCurrentStyles(fN);fQ=fP.child={};for(var fO in fR){if(fO!=cM){fQ[fO]=fR[fO];}
;}
;if(fR[cM]){var fS=fR[cM];for(var i=0,j=fS.length;i<j;i++){if(fQ==null){fQ=fP.child={};}
else {fQ=fQ.child={};}
;fQ[cL]=fS[i][cL];fQ[ch]=fS[i][ch];}
;}
;if(fR[cL]&&fR[ch]){fQ=fQ.child={};fQ[cL]=fR[cL];}
;return fP;}
,getCurrentStyles:function(fT){if(fT==null){var fV=this.__wF.getSelection();if(!fV||fV.focusNode==null){return {};}
;fT=(fV.focusNode.nodeType==3)?fV.focusNode.parentNode:fV.focusNode;}
;var fW=qx.dom.Hierarchy.getAncestors(fT);var fY=qx.lang.Array.insertBefore(fW,fT,fW[0]);var fU=this.__yM(fY);var fX=this.__yN(fU,fY);return fX;}
,__yM:function(ga){var gd={};var gb,gc;for(var i=0,j=ga.length;i<j;i++){gc=ga[i];for(var k=0,l=gc.style.length;k<l;k++){gb=gc.style[k];if(gb.length>0&&typeof gd[gb]===bK){gd[gb]=gc.style.getPropertyValue(gb);}
;}
;if(gc.tagName.toUpperCase()==co&&gc.size&&gd[cI]===undefined){gd[cI]=gc.size;}
;}
;if(gd[cI]&&gd[bh]){delete gd[bh];}
;return gd;}
,__yN:function(ge,gf){var gk=gf[0];var gi=this.__wF.getContentWindow().getComputedStyle(gk,null);var gg;var gj={};for(var gh in ge){if(gh!=cI){gg=gi.getPropertyValue(gh);}
else {gg=ge[gh];}
;if(gh==bj&&gg==bL){gj[gh]=this.__yP(gf);}
else if(gh==cM){gj[gh]=this.__yO(gf);}
else {gj[gh]=gg;}
;}
;return gj;}
,__yO:function(gl){var go,gq,gm;var gp=[];var gn=this.__wF.getContentWindow();for(var i=0,j=gl.length;i<j;i++){gm=gn.getComputedStyle(gl[i],null);go=gm.getPropertyValue(cM);gq=gm.getPropertyValue(X);if(go!=bT){gp.push({'text-decoration':go,'color':gq});}
;}
;return gp;}
,__yP:function(gr){var gt,gs,gu;for(var i=0;i<gr.length;i++){gt=gr[i];gs=this.__wF.getContentWindow().getComputedStyle(gt,null);gu=gs.getPropertyValue(bj);if(gu!=bL){return gu;}
;}
;}
,__yQ:function(gv,gw){var gI=this.__wF.getSelection();var gD=((qx.core.Environment.get(cK)==cH))?this.__wF.getRange():gD=gI.getRangeAt(0);var gE=[];var gH;var gC=[d,G];var gx,i,j,gF;gF=((qx.core.Environment.get(cK)==cH))?gD.parentElement():gD.commonAncestorContainer;if(gF.tagName==bM){for(var i=0;i<gC.length;i++){gx=gF.getElementsByTagName(gC[i]);for(var j=0;j<gx.length;j++){if(gx[j]){gE.push(gx[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(gC,gF.tagName)){gE.push(gF);}
;if(gE.length>0){for(var i=0;i<gE.length;i++){var gz=gE[i];gH=((qx.core.Environment.get(cK)==cH))?((gz==gF)||(gF.tagName==bM)):gI.containsNode(gz,false);for(j=0;j<gz.childNodes.length;j++){var gB=gz.childNodes[j];if(gH||(gI.focusNode.nodeValue&&qx.dom.Hierarchy.contains(gB,gI.focusNode)&&(gI.focusOffset==gI.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(gB,gI.anchorNode)&&(gI.anchorOffset==0))||(gI.containsNode(gB,false))){gB.style.fontSize=(this.__yp[gv]||gv)+by;}
;}
;}
;}
else {var gA=((qx.core.Environment.get(cK)==cH))?gF:gI.focusNode;var gG=qx.dom.Hierarchy.getAncestors(gA);for(i=0;i<gG.length;i++){if(gG[i].tagName==cY){if((((qx.core.Environment.get(cK)==cg))&&((gI.anchorOffset==0)&&(gI.focusNode.nodeValue&&(gI.focusOffset==gI.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(gG[i].firstChild,gI.anchorNode)&&qx.dom.Hierarchy.contains(gG[i].lastChild,gI.focusNode)))||(((qx.core.Environment.get(cK)==cH))&&(gD.htmlText==gG[i].innerHTML))){gG[i].style.fontSize=(this.__yp[gv]||gv)+by;}
;break;}
;}
;}
;if((qx.core.Environment.get(cK)==cH)){this.__li.body.focus();this.__wF.getRange().select();return this.__li.execCommand(cj,false,gv);}
else if((qx.core.Environment.get(cK)==cg)){var parent=gD.commonAncestorContainer;if(parent.nodeType===1){var gy=parent.getElementsByTagName(cd);for(i=0;i<gy.length;i++){if(gy[i].style.fontSize){gy[i].style.fontSize=null;}
;}
;}
;}
;return this.__li.execCommand(cj,false,gv);}
,__yR:qx.core.Environment.select(cK,{"mshtml":function(gJ,gK){this.__li.body.focus();return this.__li.execCommand(ck,false,gJ);}
,"gecko|opera":function(gL,gM){this.__li.body.focus();return this.__li.execCommand(S,false,gL);}
,"webkit":function(gN,gO){var gP=this.__wF.getSelection();var gQ=this.__wF.getRange();if(!gP||!gP.isCollapsed){this.__li.body.focus();this.__li.execCommand(ck,false,gN);if(gP){gP.collapseToEnd();}
;return true;}
else {var gS=gP.anchorOffset;var gT=gP.anchorOffset;var gQ=gP.getRangeAt(0);var gR=gP.anchorNode;while(gT>0){if(gR.nodeValue.charCodeAt(gT)==160||gR.nodeValue.charCodeAt(gT)==32){break;}
else {gT--;}
;}
;while(gS<gR.nodeValue.length){if(gR.nodeValue.charCodeAt(gS)==160||gR.nodeValue.charCodeAt(gS)==32){break;}
else {gS++;}
;}
;gQ.setStart(gP.anchorNode,gP.anchorNode.nodeValue.charAt(gT)==bB?gT+1:gT);gQ.setEnd(gP.anchorNode,gS);gP.addRange(gQ);this.__li.body.focus();this.__li.execCommand(ck,false,gN);gP.collapseToEnd();return true;}
;}
}),__yS:function(gU,gV){gU=gU!=null&&typeof gU==bi?gU:bL;qx.bom.element.Style.set(this.__li.body,cw,gU);return true;}
,__yT:function(gW,gX){var gY,hb,ha;var hc=qx.bom.htmlarea.manager.Command;if(gW==null){gY=null;}
else {gY=gW[0];hb=gW[1];ha=gW[2];}
;if(gY==null||typeof gY!=bi){qx.bom.element.Style.set(this.__li.body,bF,cJ);qx.bom.element.Style.set(this.__li.body,bk,cJ);qx.bom.element.Style.set(this.__li.body,be,cJ);return true;}
else {if(gY.search(/^url.*\(/)==-1){gY=m+gY+V;}
;}
;if(hb!=null&&!qx.lang.String.contains(hc.__ys,hb)){if(qx.core.Environment.get(cO)){this.error("The value '"+hb+"' is not allowed for parameter 'repeat'. Possible values are '"+hc.__ys+"'");}
;return false;}
else {hb=cq;}
;if(ha!=null){if(qx.lang.Type.isString(ha)&&!qx.lang.String.contains(hc.__yr,bg+ha+bg)){if(qx.core.Environment.get(cO)){this.error("The value '"+ha+"' is not allowed for parameter 'position'. Possible values are '"+hc.__yr+"'");}
;return false;}
else {if(qx.lang.Type.isArray(ha)&&ha.length==2){ha=ha[0]+bB+ha[1];}
else {if(qx.core.Environment.get(cO)){this.error("If an array is provided for parameter 'position' it has to define two elements!");}
;return false;}
;}
;}
else {ha=R;}
;qx.bom.element.Style.set(this.__li.body,bF,gY);qx.bom.element.Style.set(this.__li.body,bk,hb);qx.bom.element.Style.set(this.__li.body,be,ha);return true;}
,__yU:qx.core.Environment.select(cK,{"mshtml":function(hd,he){var hf=this.__li.body.createTextRange();hf.select();return true;}
,"default":function(hg,hh){return this.__yw(hh.identifier,false,hg);}
}),__yV:function(){return this.__wF.getSelectedText();}
,__yW:function(){return this.__wF.getSelectedHtml();}
,__yX:function(hi,hj){var hn=this.__wF.getFocusNode();if(hn.textContent==cJ){var hl=qx.dom.Hierarchy.getAncestors(hn);hl.unshift(hn);var Node=qx.dom.Node;var hk=qx.bom.element.Style;var hm=hl.shift();while(hl.length>0){if(Node.getName(hm)==ce||Node.getName(hm)==bz){break;}
;if(hk.get(hm,hi,hk.LOCAL_MODE)==hj){hk.reset(hm,hi);return true;}
;hm=hl.shift();}
;}
;return false;}
,__yY:qx.core.Environment.select(cK,{"gecko":function(ho,hp){if(this.__yX(Q,bo)){return true;}
else {return this.__yw(hp.identifier,false,ho);}
;}
,"default":function(hq,hr){return this.__yw(hr.identifier,false,hq);}
}),__za:qx.core.Environment.select(cK,{"gecko":function(hs,ht){if(this.__yX(b,ca)){return true;}
else {return this.__yw(ht.identifier,false,hs);}
;}
,"default":function(hu,hv){return this.__yw(hv.identifier,false,hu);}
}),__zb:qx.core.Environment.select(cK,{"gecko":function(hw,hx){if(this.__yX(bP,cB)){return true;}
else {return this.__yw(hx.identifier,false,hw);}
;}
,"default":function(hy,hz){return this.__yw(hz.identifier,false,hy);}
}),__zc:qx.core.Environment.select(cK,{"gecko":function(hA,hB){if(this.__yX(bP,U)){return true;}
else {return this.__yw(hB.identifier,false,hA);}
;}
,"default":function(hC,hD){return this.__yw(hD.identifier,false,hC);}
})},destruct:function(){this.__li=this.__wF=this._commands=null;this.__yo=this.__yp=null;}
});}
)();
(function(){var m="undo",l="pageup",k="b",h="control",g="shift",f="end",d="right",c="qx_link",b="insertunorderedlist",a="Undo",bi="pagedown",bh="k",bg="home",bf="a",be="insertorderedlist",bd="y",bc="justifyright",bb="redo",ba="insertParagraph",Y="qx.bom.htmlarea.manager.UndoRedo",t="left",u="i",r="u",s="enter",p="Redo",q="__wE",n="insertimage",o="z",x="undoRedoState",y="down",G="up",E="body",O="backgroundColor",J="mousedown",U="table",S="backgroundImage",A="backgroundRepeat",X="p",W="backgroundPosition",V="td",z="img",C="inserthyperlink",D="mouseup",F="keypress",H="qx.bom.htmlarea.HtmlArea.debug",K="backgroundimage",P="qx.debug",T="backgroundcolor",v="webkit",w="Content",B="Internal",N="inserthtml",M="gecko",L="Custom",R="Command",Q="mshtml",I="engine.name";qx.Class.define(Y,{extend:qx.core.Object,construct:function(bj,bk){qx.core.Object.call(this);this.__wE=bj;this.__wF=bk;this.__wG=[];this.__wH=[];this._commands=null;this.__li=null;this.__wI={};this.__wJ={command:true,content:true,custom:true};this.__xi();this.__wK=qx.lang.Function.bind(this._handleKeyPress,this);this.__wL=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(I)==Q)){this.__wM=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__wN:false,__wO:false,__wP:false,__wJ:null,__wI:null,__wE:null,__li:null,__wG:null,__wH:null,__wF:null,__wK:null,__wL:null,__wM:null,__wQ:null,setContentDocument:function(bl){this.__li=bl;this.__wE.setContentDocument(bl);qx.event.Registration.addListener(bl.body,F,this.__wK,this);qx.event.Registration.addListener(bl.body,D,this.__wL,this);if((qx.core.Environment.get(I)==Q)){qx.event.Registration.addListener(bl.body,J,this.__wM,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__wE.insertParagraphOnLinebreak();}
,execute:function(bm,bn){var bo;bm=bm.toLowerCase();if(this._commands[bm]){if(this._commands[bm].passthrough){bo=this.__wE.execute(bm,bn);}
else {bo=this[bm].call(this);}
;}
else {if((qx.core.Environment.get(I)==Q)||(qx.core.Environment.get(I)==v)){this.__xj(bm,bn,this.__wE.getCommandObject(bm));bo=this.__wE.execute(bm,bn);if(!bo){this.__wG.pop();}
;}
else {bo=this.__wE.execute(bm,bn);if(bo){this.__xj(bm,bn,this.__wE.getCommandObject(bm));}
;}
;if(bm==m&&this.__wG.length==0){this.__wO=false;this.__xr();}
else if(bm==bb&&this.__wH.length==0){this.__wN=false;this.__xr();}
;}
;this.__wP=false;return bo;}
,addUndoStep:function(bp,bq,br){this.__xj(bp,bq,br);}
,registerHandler:function(bs,bt,bu,bv){this.__wI[bs]={undo:bt,redo:bu,context:bv};}
,isUndoPossible:function(){return this.__wO;}
,undo:function(){var by;if(this.__wP){this.__xl();}
;if(this.__wG.length>0){var bx=this.__wG.pop();if(this.__wJ[bx.actionType.toLowerCase()]){switch(bx.actionType){case R:by=this.__wS(bx);break;case w:by=this.__wW(bx);break;case B:by=this.__wV(bx);break;case L:by=this.__wR(bx);break;};}
else if(this.__wI[bx.actionType]){var bw=this.__wI[bx.actionType];by=bw.undo.call(bw.context?bw.context:this,bx);this.__xn(bx);}
else {this.error("actionType "+bx.actionType+" is not managed! Please provide a handler method!");}
;this.__wN=true;this.__xr();return by;}
;}
,__wR:qx.core.Environment.select(I,{"mshtml|webkit":function(bz){var bA=this.__li.body.innerHTML;var bC=bz.content;this.__li.body.innerHTML=bC;var bB=bz;bB.content=bA;this.__xn(bB);return true;}
,"default":function(bD){var bH=bD;var bG=qx.bom.element.Style;switch(bD.command){case T:bH.parameter=[bG.get(this.__li.body,O)];break;case K:bH.parameter=[bG.get(this.__li.body,S),bG.get(this.__li.body,A),bG.get(this.__li.body,W)];break;};this.__xn(bH);if(bD.command==C){if((qx.core.Environment.get(I)==M)){var bF=c+this.__wE.__hyperLinkId;var bE=this.__li.getElementById(bF);if(bE){bE.parentNode.removeChild(bE);return true;}
else {return false;}
;}
;}
else {return this.__wE.execute(bD.command,bD.value);}
;}
}),__wS:qx.core.Environment.select(I,{"mshtml|webkit":function(bI){}
,"default":function(bJ){this.__xn(bJ);if((qx.core.Environment.get(I)==M)){if(bJ.command==N&&bJ.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__wT(N,ba)){this.__wU();}
;}
;return this.__wX();}
}),__wT:function(bK,bL){if(this.__wG.length>0){var bM=this.__wG[this.__wG.length-1];return (bM.command==bK&&bM.value==bL);}
;return false;}
,__wU:function(){this.__wX();if(this.__wG.length>0){var bN=this.__wG.pop();this.__xn(bN);}
;}
,__wV:function(bO){this.__xn(bO);return this.__wX();}
,__wW:qx.core.Environment.select(I,{"gecko":function(bP){this.__xn(bP);try{return this.__wX();}
catch(bQ){if(qx.core.Environment.get(P)){this.error("execCommand failed! Details: "+bQ);}
;}
;}
,"mshtml|webkit":function(bR){}
,"default":function(bS){this.__xn(bS);return this.__wX();}
}),__wX:function(){try{return this.__li.execCommand(a,false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__wN;}
,redo:function(){if(this.__wN){var bU;if(this.__wH.length>0){var bV=this.__wH.pop();if(this.__wJ[bV.actionType.toLowerCase()]){switch(bV.actionType){case R:bU=this.__xa(bV);break;case w:bU=this.__xg(bV);break;case B:bU=this.__xf(bV);break;case L:bU=this.__wY(bV);break;};}
else if(this.__wI[bV.actionType]){var bT=this.__wI[bV.actionType];bU=bT.redo.call(bT.context?bT.context:this,bV);this.__xm(bV);}
else {this.error("actionType "+bV.actionType+" is not managed! Please provide a handler method!");}
;this.__wO=true;this.__xr();}
;return bU;}
;}
,__wY:qx.core.Environment.select(I,{"mshtml|webkit":function(bW){var bX=this.__li.body.innerHTML;var ca=bW.content;this.__li.body.innerHTML=ca;var bY=bW;bY.content=bX;this.__xm(bY);return true;}
,"default":function(cb){this.__xm(cb);return this.__xh();}
}),__xa:qx.core.Environment.select(I,{"mshtml|webkit":function(cc){}
,"default":function(cd){this.__xm(cd);var ce=this.__xh();if((qx.core.Environment.get(I)==M)){if(this.__xb(N,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cf=this.__xc();this.__xd();if(cf!=null){this.__xe(cf);}
;}
;}
;return ce;}
}),__xb:function(cg,ch){if(this.__wH.length>0){var ci=this.__wH[this.__wH.length-1];return (ci.command==cg&&ci.value==ch);}
;return false;}
,__xc:function(){if(this.__wF==null){return null;}
;var cj=this.__wF.getSelection();var ck=cj?cj.focusNode:null;if(ck==null){return null;}
;try{while(ck.nodeName.toLowerCase()!=X){ck=ck.parentNode;if(!ck||qx.dom.Node.isNodeName(ck,E)){return null;}
;}
;}
catch(cl){return null;}
;if(ck!=null&&qx.dom.Node.isNodeName(ck,X)){return ck;}
else {return null;}
;}
,__xd:function(){var cm=this.__wH.pop();this.__xm(cm);this.__xh();}
,__xe:qx.core.Environment.select(I,{"gecko":function(cn){if(cn==this.__wF.getContentBody().lastChild){return;}
;var cq=cn.firstChild;while(cq.firstChild){cq=cq.firstChild;}
;var co=this.__wF.getSelection();var cp=this.__wF.getRange();if(co&&cp){cp.selectNode(cq);co.addRange(cp);cp.collapse(true);}
;}
,"default":(function(){}
)}),__xf:function(cr){this.__xm(cr);return this.__xh();}
,__xg:qx.core.Environment.select(I,{"mshtml|webkit":function(cs){}
,"default":function(ct){this.__xm(ct);return this.__xh();}
}),__xh:function(){try{return this.__li.execCommand(p,false,null);}
catch(e){return false;}
;}
,__xi:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__wE.getCommandObject(T).customUndo=true;this.__wE.getCommandObject(K).customUndo=true;if((qx.core.Environment.get(I)==M)){}
;}
,__xj:qx.core.Environment.select(I,{"mshtml|webkit":function(cu,cv,cw){var cx=this.getUndoRedoObject();cx.commandObject=cw;cx.command=cu;cx.value=cv;cx.actionType=L;cx.content=this.__li.body.innerHTML;this.__xk(cx);}
,"default":function(cy,cz,cA){if(this.__wF==null){return;}
;var cC=this.getUndoRedoObject();cC.commandObject=cA;cC.command=cy;cC.value=cz;cC.actionType=L;var cB=this.__wF.getSelection();if(cA.customUndo){var cD=[];switch(cy){case T:cD.push(qx.bom.element.Style.get(this.__li.body,O));break;case K:cD.push(qx.bom.element.Style.get(this.__li.body,S),qx.bom.element.Style.get(this.__li.body,A),qx.bom.element.Style.get(this.__li.body,W));break;case C:if(cB&&!cB.isCollapsed){cC.actionType=R;}
;break;};cC.parameter=cD;}
else {if((qx.core.Environment.get(I)==M)){if(cB&&cB.isCollapsed){switch(cy){case be:case b:case bc:case N:case n:cC.actionType=R;break;default:return;};}
else {cC.actionType=R;}
;}
else {cC.actionType=R;}
;}
;this.__xk(cC);}
}),__xk:function(cE){if(this.__wP){this.__xl();}
;this.__xm(cE);this.__wN=false;this.__wH=[];this.__xr();}
,__xl:function(){var cF=this.__wG[this.__wG.length-1];if(cF==null||cF.actionType!=w){var cG=this.getUndoRedoObject();cG.actionType=w;if((qx.core.Environment.get(I)==Q)||(qx.core.Environment.get(I)==v)){cG.content=this.__wQ;cG.actionType=L;this.__wQ=null;}
;this.__xm(cG);this.__wP=false;}
;}
...
,__xm:function(cH){if((qx.core.Environment.get(P))&&qx.core.Environment.get(H)){this.debug("ADD TO UNDO STACK");this.debug(cH.actionType+" "+cH.command+" "+cH.value);}
;this.__wG.push(cH);}
,__xn:function(cI){if((qx.core.Environment.get(P))&&qx.core.Environment.get(H)){this.debug("ADD TO REDO STACK");this.debug(cI.actionType+" "+cI.command+" "+cI.value);}
;this.__wH.push(cI);}
,_handleKeyPress:function(e){var cJ=e.getKeyIdentifier().toLowerCase();var cK=e.isCtrlPressed();switch(cJ){case h:case g:case t:case d:case G:case y:case l:case bi:case bg:case f:case s:break;case bf:case k:case u:case r:case bh:case bd:case o:if(!cK){this.__xo();}
;break;default:this.__wN=false;this.__wH=[];this.__xo();};}
,__xo:function(){if(!this.__wP){this.__wP=true;this.__wO=true;if((qx.core.Environment.get(I)==Q)||(qx.core.Environment.get(I)==v)){this.__wQ=this.__li.body.innerHTML;}
;this.__xr();}
;}
,__xp:null,_handleMouseDown:qx.core.Environment.select(I,{"mshtml":function(e){var cL=e.getOriginalTarget();if(qx.dom.Node.isElement(cL)&&(qx.dom.Node.isNodeName(cL,z)||qx.dom.Node.isNodeName(cL,U))){this.__xp={node:cL,content:cL.outerHTML};}
else {this.__xp=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(I,{"gecko":function(e){if(this.__wF==null){return;}
;var cN=this.__wF.getSelection();if(!cN){this.__xp=null;return;}
;var cM=cN.anchorNode;var cO=cM.childNodes[cN.anchorOffset];if(qx.dom.Node.isNodeName(cO,z)){if(this.__xp==null){this.__xp=cO.cloneNode(true);}
else {if(this.__xp.style.width!=cO.style.width||this.__xp.style.height!=cO.style.height){this.__xq();this.__xp=cO.cloneNode(true);}
;}
;}
else if(qx.dom.Node.isNodeName(cM,V)||qx.dom.Node.isNodeName(cM.parentNode,V)){var cP=cM.parentNode;while(qx.dom.Node.isNodeName(cP,U)){cP=cP.parentNode;}
;if(this.__xp==null){this.__xp=cP.cloneNode(true);}
else {qx.event.Timer.once(function(){if(cP.style.width!=this.__xp.style.width||cP.style.height!=this.__xp.style.height||cP.innerHTML!=this.__xp.innerHTML){this.__xq();this.__xp=cP.cloneNode(true);}
;}
,this,0);}
;}
else {this.__xp=null;}
;}
,"default":function(e){var cQ=qx.bom.Event.getTarget(e);if(this.__xp!=null){if(cQ.nodeType==1){if(cQ==this.__xp.node){if(cQ.outerHTML!=this.__xp.content){this.__xp.content=cQ.outerHTML;this.__xq();}
;}
else {for(var i=0,j=cQ.childNodes.length;i<j;i++){if(cQ.childNodes[i]==this.__xp.node){if(cQ.childNodes[i].outerHTML!=this.__xp.content){this.__xp.content=cQ.childNodes[i].outerHTML;this.__xq();}
;}
;}
;}
;}
...
;}
;}
}),__xq:qx.core.Environment.select(I,{"mshtml|webkit":function(){this.__xj(B,null,null);}
,"default":function(){var cR=this.getUndoRedoObject();cR.actionType=B;this.__xm(cR);}
}),__xr:function(){qx.event.Timer.once(function(e){if(this.__wF!=null){var cS={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__wF.fireDataEvent(x,cS);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__li.body,F,this.__wK);qx.event.Registration.removeListener(this.__li,D,this.__wL);if((qx.core.Environment.get(I)==Q)){qx.event.Registration.removeListener(this.__li,J,this.__wM);}
;}
catch(e){}
;this._disposeObjects(q);this.__wF=this.__wG=this.__wH=this._commands=this.__li=null;this.__wJ=this.__wI=null;}
});}
)();
