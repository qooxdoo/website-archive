...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.ScrollContainer.3354073610da.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="scrollAnimationYEnd",g="Scroll down",f="Toggle size",e="demobrowser.demo.ui.ScrollContainer",d="blue",c="red",b="Animate down",a="execute";qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.container.Scroll();k.set({width:300,height:200});k.add(this.generateBoxes());this.getRoot().add(k,{left:10,top:50});var j=new qx.ui.form.Button(f);var l=true;j.addListener(a,function(){k.setWidth(l?800:300);l=!l;}
);this.getRoot().add(j,{left:10,top:10});var scroll=new qx.ui.form.Button(g);scroll.addListener(a,function(){k.scrollByY(150);}
);this.getRoot().add(scroll,{left:110,top:10});var i=new qx.ui.form.Button(b);i.addListener(a,function(){k.scrollByY(150,300);i.setEnabled(false);}
);this.getRoot().add(i,{left:210,top:10});k.addListener(h,function(){i.setEnabled(true);}
);}
,generateBoxes:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.Grid());for(var y=0;y<20;y++){for(var x=0;x<10;x++){m.add((new qx.ui.core.Widget()).set({backgroundColor:((x+y)%2==0)?c:d,width:60,allowShrinkY:false,allowShrinkX:false,height:60}),{column:x,row:y});}
;}
;return m;}
}});}
)();
