...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.c29168a6f13e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Open Native Window",p="Open Native Modal Window",o="demobrowser.demo.bom.Window",n="Modal Window closed?",m="http://sourceforge.net",l="window1",k="window3",j="http://slashdot.org",i="Window closed?",h="http://qooxdoo.org",c="demobrowser/demo/html/ModalWindow.html",g="Open Faked Native Modal Window",f="window2",b="#eee",a="click",d="button";qx.Class.define(o,{extend:qx.application.Native,members:{__Ce:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__Ce=[h,m,j,r.toUri(c)];var u=qx.bom.Input.create(d);qx.bom.Input.setValue(u,q);document.body.appendChild(u);qx.event.Registration.addListener(u,a,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__Ce[0],l,x);}
...
,this);var s=qx.bom.Input.create(d);qx.bom.Input.setValue(s,p);document.body.appendChild(s);qx.event.Registration.addListener(s,a,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__Ce[3],f,y,true);}
...
,this);var v=qx.bom.Input.create(d);qx.bom.Input.setValue(v,g);document.body.appendChild(v);qx.event.Registration.addListener(v,a,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(b);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__Ce[0],k,A,true,false);}
,this);}
...
(function(){var e="qx.bom.Window",d="interval",c="javascript:/",b="qxNativeWindow",a='load';qx.Class.define(e,{statics:{__kB:null,__LJ:null,__jC:null,__LK:{"top":"dialogTop",left:"dialogLeft",width:"dialogWidth",height:"dialogHeight",scrollbars:"scroll",resizable:"resizable"},__LL:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__LM:function(){return window.showModalDialog!=null;}
,open:function(f,name,g,h,i,j,self){var n=null;if(f==null){f=c;}
;if(name==null){name=b+new Date().getTime();}
;if(i==null){i=true;}
;var k=this.__LN(g,h&&i);if(h){if(this.__LM()&&i){n=window.showModalDialog(f,[window.self],k);}
else {this.getBlocker().block();if(this.__jC==null){this.__jC=new qx.event.Timer(500);this.__jC.addListener(d,this.__LO,this);}
;this.__LJ=window.open(f,name,k);this.__jC.restart();n=this.__LJ;}
;}
else {n=window.open(f,name,k);}
;if(n&&j&&(j instanceof Function)){var m=self||n;var l=qx.lang.Function.bind(j,m);qx.bom.Event.addNativeListener(n,a,function(){l();qx.bom.Event.removeNativeListener(n,a,arguments.callee);}
);}
;return n;}
,__LN:function(o,p){var q;var t;var r=[];if(p&&this.__LM()){for(var s in o){if(qx.bom.Window.__LK[s]){var u="";if(s!="scrollbars"&&s!="resizable"){u="px";}
;t=qx.bom.Window.__LK[s]+":"+o[s]+u;r.push(t);}
else {qx.log.Logger.warn("Option '"+s+"' is not supported for modal windows.");}
;}
;q=r.join(";");}
else {for(var s in o){if(qx.bom.Window.__LL[s]){if(qx.lang.Type.isBoolean(o[s])){t=s+"="+(o[s]?"yes":"no");}
else {t=s+"="+o[s];}
;r.push(t);}
...
;q=r.join(",");}
;return q;}
,__LO:function(){if(this.isClosed(this.__LJ)){this.getBlocker().unblock();this.__jC.stop();}
;}
,getBlocker:function(){if(this.__kB==null){this.__kB=new qx.bom.Blocker;}
;return this.__kB;}
,close:function(v){if(v){return v.close();}
;}
,isClosed:function(w){var closed=true;if(w){try{closed=w.closed;}
catch(x){}
;}
;return closed;}
