...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Boolean","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean.274b8687d19e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="Boolean",d="end",c="demobrowser.demo.progressive.ProgressiveTable_Boolean",b="Id",a="row";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var o=0;var k=function(r){var s=[];for(var t=0;t<r;t++){s.push({renderer:a,location:d,data:[o++,(Math.floor(Math.random()*2)==0?false:true)]});}
;return s;}
;var n=new qx.ui.progressive.renderer.table.Widths(2);n.setWidth(0,100);n.setWidth(1,100);var i=[b,e];var j=new qx.ui.progressive.headfoot.TableHeading(n,i);var h=new qx.ui.progressive.headfoot.Progress(n,i);var q=new qx.ui.progressive.structure.Default(j,h);var g=new qx.ui.progressive.Progressive(q);var m=new qx.ui.progressive.model.Default();var l=k(20);m.addElements(l);g.setDataModel(m);var p=new qx.ui.progressive.renderer.table.Row(n);g.addRenderer(a,p);var f=new qx.ui.progressive.renderer.table.cell.Boolean();f.setAllowToggle(true);p.addRenderer(1,f);g.set({width:200+qx.bom.element.Overflow.getScrollbarWidth(),maxWidth:200+qx.bom.element.Overflow.getScrollbarWidth()});this.getRoot().add(g,{left:50,top:50,bottom:50});g.render();}
}});}
)();
(function(){var d="maxWidth",c="qx.ui.progressive.renderer.table.Widths",b="minWidth",a="width";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__KF=[];for(var i=0;i<e;i++){this.__KF[i]=new qx.ui.core.ColumnData();}
;}
,members:{__KF:null,getData:function(){return this.__KF;}
,set:function(f,g){for(var h in g){switch(h){case a:this.setWidth(f,g[h]);break;case b:this.setMinWidth(f,g[h]);break;case d:this.setMaxWidth(f,g[h]);break;default:throw new Error("Unrecognized key: "+h);};}
;}
,setWidth:function(j,k){if(j>this.__KF.length-1||j<0){throw new Error("Column number out of range");}
;this.__KF[j].setColumnWidth(k);}
,setMinWidth:function(l,m){if(l>this.__KF.length-1||l<0){throw new Error("Column number out of range");}
;this.__KF[l].setMinWidth(m);}
,setMaxWidth:function(n,o){if(n>this.__KF.length-1||n<0){throw new Error("Column number out of range");}
;this.__KF[n].setMaxWidth(o);}
}});}
)();
...
(function(){var b="qx.ui.progressive.headfoot.Abstract",a="abstract";qx.Class.define(b,{type:a,extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this,new qx.ui.layout.HBox());}
,members:{__GP:null,join:function(c){this.__GP=c;}
},destruct:function(){this.__GP=null;}
});}
)();
...
(function(){var f="resize",d="progressive-table-header",c="_layout",b="qx.ui.progressive.headfoot.TableHeading",a="progressive-table-header-cell";qx.Class.define(b,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(g,h){qx.ui.progressive.headfoot.Abstract.call(this);this.__GM=g;var k=g.getData();this.__Hz=[];for(var i=0;i<k.length;i++){var l=new qx.ui.basic.Atom(h[i]);l.setAppearance(a);this.add(l);this.__Hz[i]=l;}
;var j=new qx.ui.core.Widget();j.set({height:16,appearance:a,minWidth:0,width:0});this.add(j,{flex:1});this.addListener(f,this._resizeColumns,this);this.__oI=new qx.ui.layout.HBox();this.__oI.connectToWidget(this);}
,properties:{appearance:{refine:true,init:d}},members:{__GM:null,__Iz:null,__Hz:null,__oI:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__Iz){return this.__GM.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var n=this.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();this.__Iz=true;this.__oI.renderLayout(n,100);this.__Iz=false;var o=this.__GM.getData();for(var i=0;i<o.length;i++){this.__Hz[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__GM=this.__Hz=null;this._disposeObjects(c);}
});}
)();
(function(){var i="__JU",h="%",g="renderStart",f="progress",d="0%",c="qx.ui.progressive.headfoot.Progress",b="__JV",a="renderEnd";qx.Class.define(c,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(j,k){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__GQ={};this.__GU();this.set({backgroundColor:this.__GQ.background});this.__JU=new qx.ui.core.Widget();this.__JU.set({width:0,backgroundColor:this.__GQ.indicatorDone});this.add(this.__JU);var l=new qx.ui.core.Widget();l.set({backgroundColor:this.__GQ.indicatorUndone});this.add(l,{flex:1});this.__JV=new qx.ui.basic.Atom(d);this.__JV.set({width:100,backgroundColor:this.__GQ.percentBackground,textColor:this.__GQ.percentText});this.add(this.__JV);this.exclude();}
,members:{__JW:null,__GQ:null,__JU:null,__JV:null,_onChangeTheme:function(){qx.ui.progressive.headfoot.Abstract.prototype._onChangeTheme.call(this);this.__GU();}
,__GU:function(){var m=qx.theme.manager.Color.getInstance();this.__GQ.background=m.resolve("progressive-progressbar-background");this.__GQ.indicatorDone=m.resolve("progressive-progressbar-indicator-done");this.__GQ.indicatorUndone=m.resolve("progressive-progressbar-indicator-undone");this.__GQ.percentBackground=m.resolve("progressive-progressbar-percent-background");this.__GQ.percentText=m.resolve("progressive-progressbar-percent-text");}
,join:function(n){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,n);n.addListener(g,function(e){this.__JW=e.getData().initial;this.show();}
,this);n.addListener(f,function(e){var q=1.0-(e.getData().remaining/this.__JW);var r=this.getBounds();if(r){var o=Math.floor((r.width-this.__JV.getBounds().width)*q);var p=Math.floor(q*100)+h;if(!isNaN(o)){this.__JU.setMinWidth(o);this.__JV.setLabel(p);}
;}
;}
,this);n.addListener(a,function(e){this.exclude();}
,this);}
},destruct:function(){this.__GQ=null;this._disposeObjects(i,b);}
});}
)();
(function(){var d="abstract",c="qx.ui.progressive.structure.Abstract",b="overflowY",a="auto";qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);if(!e){this.__Ik=new qx.ui.core.Widget();this.__AY=this.__Ik;}
else {this.__Ik=null;this.__AY=e;}
;this.__AY.getContentElement().setStyle(b,a);}
,members:{__Ik:null,__AY:null,applyStructure:function(f){throw new Error("applyStructure() is abstract");}
,getPane:function(){return this.__AY;}
},destruct:function(){if(this.__Ik){this.__Ik.dispose();}
;this.__Ik=this.__AY=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,c,d){qx.ui.progressive.structure.Abstract.call(this,d);if(!b){this.__Il=new qx.ui.progressive.headfoot.Null();this.__pP=this.__Il;}
else {this.__Il=null;this.__pP=b;}
;if(!c){this.__Im=new qx.ui.progressive.headfoot.Null();this.__In=this.__Im;}
else {this.__Im=null;this.__In=c;}
;}
,members:{__pP:null,__In:null,__Il:null,__Im:null,applyStructure:function(e){this.__pP.join(e);this.__In.join(e);e.add(this.__pP);e.add(this.getPane(),{flex:1});e.add(this.__In);}
,getHeader:function(){return this.__pP;}
,getFooter:function(){return this.__In;}
},destruct:function(){if(this.__Il){this.__Il.dispose();this.__Il=null;}
;if(this.__Im){this.__Im.dispose();this.__Im=null;}
;this.__pP=this.__In=null;}
});}
)();
(function(){var a="qx.ui.progressive.headfoot.Null";qx.Class.define(a,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(){qx.ui.progressive.headfoot.Abstract.call(this);this.exclude();}
});}
)();
(function(){var n="_applyDataModel",m="Boolean",l="qx.ui.progressive.model.Abstract",k="progress",j="white",h="qx.ui.progressive.Progressive",g="progressDetail",f="renderEnd",d="dataAvailable",c="renderStart",a="Integer",b="qx.event.type.Data";qx.Class.define(h,{extend:qx.ui.container.Composite,construct:function(o){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__Jj={};this.set({backgroundColor:j});if(!o){o=new qx.ui.progressive.structure.Default();}
;this.__Jk=o;o.applyStructure(this);this.__Jl=false;this.__Jm=false;this.__Jn=0;}
,events:{"renderStart":b,"renderEnd":b,"progress":b,"progressDetail":b},properties:{dataModel:{check:l,apply:n},batchSize:{check:a,init:20},flushWidgetQueueAfterBatch:{check:m,init:false},interElementTimeout:{check:a,init:0}},members:{__Jj:null,__Jm:null,__Jo:null,__Jn:null,__Jl:null,__Jk:null,getStructure:function(){return this.__Jk;}
,addRenderer:function(name,p){this.__Jj[name]=p;p.join(this,name);}
,removeRenderer:function(name){if(!this.__Jj[name]){throw new Error("No existing renderer named "+name);}
;delete this.__Jj[name];}
,render:function(){if(this.__Jm){return;}
;this.__Jm=true;var q=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__Jk.getPane(),batchSize:this.getBatchSize(),rendererData:this.__Jq(),userData:{}});this.__Jo=new Date();if(this.__Jl){this.__Jn=q.getModel().getElementCount();this.fireDataEvent(c,{state:q,initial:this.__Jn});this.__Jp(q);}
else {qx.event.Timer.once(function(){this.__Jn=q.getModel().getElementCount();this.fireDataEvent(c,{state:q,initial:this.__Jn});this.__Jp(q);this.__Jl=true;}
,this,10);}
;}
,_applyDataModel:function(r,s){if(s){s.removeListener(d,this.__Jr,this);s.dispose();}
;r.addListener(d,this.__Jr,this);}
,__Jp:function(t){var u;var w;var v;for(var i=t.getBatchSize();i>0;i--){u=t.getModel().getNextElement();if(!u){this.debug("Render time: "+(new Date()-this.__Jo)+"ms");this.__Jm=false;this.fireDataEvent(f,t);t.dispose();return;}
;w=u.element;v=this.__Jj[w.renderer];v.render(t,w);this.fireDataEvent(g,{initial:this.__Jn,remaining:u.remaining,element:w});}
;this.fireDataEvent(k,{initial:this.__Jn,remaining:u.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__Jp(t);}
,this,this.getInterElementTimeout());}
,__Jq:function(){var x={};for(var name in this.__Jj){x[name]={};}
;return x;}
,__Jr:function(e){this.__Jn=e.getData();this.render();}
},destruct:function(){for(var name in this.__Jj){this.__Jj[name].dispose();}
;this.__Jo=this.__Jj=this.__Jk=null;}
});}
)();
...
(function(){var a="qx.ui.progressive.State";qx.Class.define(a,{extend:qx.core.Object,construct:function(b){qx.core.Object.call(this);this.setProgressive(b.progressive);this.setModel(b.model);this.setPane(b.pane);this.setBatchSize(b.batchSize);this.setRendererData(b.rendererData);this.setUserData(b.userData);}
,properties:{progressive:{nullable:true},model:{nullable:true},pane:{nullable:true},batchSize:{},rendererData:{},userData:{}},destruct:function(){this.setProgressive(null);this.setModel(null);this.setPane(null);}
});}
)();
(function(){var c="abstract",b="qx.ui.progressive.model.Abstract",a="qx.event.type.Data";qx.Class.define(b,{type:c,extend:qx.core.Object,events:{"dataAvailable":a},members:{getElementCount:function(){throw new Error("getElementCount() is abstract");}
,getNextElement:function(){throw new Error("getNextElement() is abstract");}
}});}
)();
(function(){var b="qx.ui.progressive.model.Default",a="dataAvailable";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__CS=[];}
,members:{__CS:null,addElements:function(c){this.__CS=this.__CS.concat(c);this.fireDataEvent(a,this.__CS.length);}
,addElement:function(d){this.__CS.push(d);this.fireDataEvent(a,this.__CS.length);}
,getElementCount:function(){return this.__CS.length;}
,getNextElement:function(){if(this.__CS.length>0){return ({element:this.__CS.shift(),remaining:this.__CS.length});}
;return null;}
},destruct:function(){this.__CS=null;}
});}
)();
(function(){var b="qx.ui.progressive.renderer.Abstract",a="abstract";qx.Class.define(b,{type:a,extend:qx.core.Object,members:{render:function(c,d){throw new Error("render() is abstract");}
,join:function(e,name){}
}});}
)();
(function(){var l="px",k="content",j="px ",h="end",g="div",f="qx.tableResizeDebug",d="  width : 100%;",c=" {",b="__columnData",a="css.boxmodel",F="qx.debug",E="relative",D="-row {",C="resize",B="start",A="",z="padding: ",y="qx.ui.progressive.renderer.table.Row",x="__oI",w="left: ",s="__GO",t="changeTheme",q="}",r="width: ",o="0px ",p="qx-progressive-",m="-row",n="-col-",u="px;",v=".qx-progressive-";qx.Class.define(y,{extend:qx.ui.progressive.renderer.Abstract,construct:function(G){qx.ui.progressive.renderer.Abstract.call(this);this.__GM=G;this.__GN={};this.__GO=new qx.ui.progressive.renderer.table.cell.Default();this.__GP=null;this.__GQ={};this.__GU();this.__oI=new qx.ui.layout.HBox();this.__oI.connectToWidget(this);qx.theme.manager.Appearance.getInstance().addListener(t,this.__GU,this);}
,statics:{__nW:null,__GR:6,__GS:"  position: absolute;"+"  top: 0px;"+"  height: 100%;"+"  overflow:hidden;"+(qx.core.Environment.get("css.textoverflow")?qx.bom.Style.getCssName(qx.core.Environment.get("css.textoverflow"))+':ellipsis;':"")+"  white-space:nowrap;"+"  border-right:1px solid #f2f2f2;"+"  border-bottom:1px solid #eeeeee;"+"  padding : 0px 6px 0px 6px;"+"  cursor:default;"+"  font-size: 11px;"+"  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;"+(qx.core.Environment.get("css.userselect")?qx.bom.Style.getCssName(qx.core.Environment.get("css.userselect"))+':'+qx.core.Environment.get("css.userselect.none")+';':'')},properties:{defaultRowHeight:{init:16}},members:{__GP:null,__Cb:null,__GT:null,__GM:null,__GN:null,__GO:null,__GQ:null,__oI:null,__GU:function(){var H=qx.theme.manager.Color.getInstance();this.__GQ.bgcol=[];this.__GQ.bgcol[0]=H.resolve("progressive-table-row-background-even");this.__GQ.bgcol[1]=H.resolve("progressive-table-row-background-odd");}
,join:function(I,name){if(this.__GP){throw new Error("Renderer is already joined to a Progressive.");}
;this.__GP=I;this.__Cb=name;var K=qx.ui.progressive.renderer.table.Row;if(!K.__nW){K.__nW={};}
;var J=I.toHashCode();if(!K.__nW[J]){K.__nW[J]={rowstylesheet:null,cellstylesheet:[]};var L=v+J+D+d+q;K.__nW[J].rowstylesheet=qx.bom.Stylesheet.createElement(L);var M=this.__GM.getData();for(var i=0;i<M.length;i++){var L=v+J+n+i+c+K.__GS+q;K.__nW[J].cellstylesheet[i]=qx.bom.Stylesheet.createElement(L);}
;this.__GT=J;var N=I.getStructure().getPane();N.addListener(C,this._resizeColumns,this);}
;}
,addRenderer:function(O,P){var Q=this.__GM.getData();if(O<0||O>=Q.length){throw new Error("Column "+O+" out of range (max: "+(Q.length-1)+")");}
;this.__GN[O]=P;}
,removeRenderer:function(R){var S=this.__GM.getData();if(R<0||R>=S.length){throw new Error("Column "+R+" out of range (max: "+(S.length-1)+")");}
;if(!this.__GN[R]){throw new Error("No existing renderer for column "+R);}
;delete this.__GN[R];}
,render:function(T,U){var bf=U.data;var ba=[];var bc;var bb;var X=0;if(T.getRendererData()[this.__Cb].end===undefined){T.getRendererData()[this.__Cb]={end:0,start:1,rows:0,totalHeight:0};}
;var be=document.createElement(g);for(var i=0;i<bf.length;i++){var Y=p+this.__GT+n+i;bb=this.__GN[i]||this.__GO;bc={state:T,rowDiv:be,stylesheet:Y,element:U,dataIndex:i,cellData:bf[i],height:X};ba.push(bb.render(bc));if(bc.height>X){X=bc.height;}
;}
;X=(X>0?X:this.getDefaultRowHeight());var bd=T.getRendererData()[this.__Cb];bd.totalHeight+=X;be.style.position=E;be.style.height=X+l;be.className=p+this.__GT+m;be.innerHTML=ba.join(A);switch(U.location){case h:var V=bd.end||0;be.style.backgroundColor=this.__GQ.bgcol[V];bd.end=(V==0?1:0);T.getPane().getContentElement().getDomElement().appendChild(be);break;case B:var W=T.getPane().getContentElement().getDomElement();var bg=W.childNodes;if(bg.length>0){var V=bd.start;be.style.backgroundColor=this.__GQ.bgcol[V];bd.start=(V==0?1:0);W.insertBefore(be,bg[0]);break;}
else {W.appendChild(be);}
;break;default:throw new Error("Invalid location: "+U.location);};++bd.rows;}
,getLayoutChildren:function(){return this.__GM.getData();}
,_resizeColumns:function(e){var bo=this.__GP.getStructure().getPane();var bl=bo.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();var bm=v+this.__GT+m;var bi=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bi.__nW[this.__GT].rowstylesheet,bm);var bk=r+bl+u;qx.bom.Stylesheet.addRule(bi.__nW[this.__GT].rowstylesheet,bm,bk);this.__oI.renderLayout(bl,100);var bn=this.__GM.getData();for(var i=0,br=0;i<bn.length;i++,br+=bl){var bm=v+this.__GT+n+i;var bi=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bi.__nW[this.__GT].cellstylesheet[i],bm);bl=bn[i].getComputedWidth();if(qx.core.Environment.get(F)){if(qx.core.Environment.get(f)){this.debug("col "+i+": width="+bl);}
;}
;var bj;if(qx.core.Environment.get(a)==k){bj=qx.ui.progressive.renderer.table.Row.__GR*2;}
else {bj=-1;}
;var bq=(bl-bj)+u;var bp=o+qx.ui.progressive.renderer.table.Row.__GR+j+o+qx.ui.progressive.renderer.table.Row.__GR+u;var bh=br+u;var bk=bi.__GS+r+bq+w+bh+z+bp;qx.bom.Stylesheet.addRule(bi.__nW[this.__GT].cellstylesheet[i],bm,bk);}
;}
},destruct:function(){qx.theme.manager.Appearance.getInstance().removeListener(t,this.__GU,this);var name;for(name in this.__GN){this.__GN[name]=null;}
;var bt=qx.ui.progressive.renderer.table.Row;var bs=this.__GP.toHashCode();if(bt.__nW&&bt.__nW[bs]){if(bt.__nW[bs].rowstylesheet){var bv=v+this.__GT+m;var bt=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bt.__nW[this.__GT].rowstylesheet,bv);}
;if(bt.__nW[bs].cellstylesheet){for(var i=bt.__nW[bs].cellstylesheet.length-1;i>=0;i--){var bv=v+this.__GT+n+i;var bu=bt.__nW[this.__GT].cellstylesheet[i];var bt=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bu,bv);}
;}
;}
;if(this.__GP&&this.__GP.getRendererData){var bw=this.__GP.getRendererData();if(bw&&bw[this.__Cb]&&bw[this.__Cb].end!==undefined){bw[this.__Cb]=null;}
;}
;this.__GQ=this.__GN=this.__GP=this.__GM=null;this._disposeObjects(x,s,b);}
});}
)();
(function(){var j="'",i="abstract",h=">",g="</div>",f="<div ",e="' ",d="style='",c="qx.ui.progressive.renderer.table.cell.Abstract",b="class='",a="";qx.Class.define(c,{type:i,extend:qx.core.Object,members:{_getCellStyle:function(k){return a;}
,_getCellExtras:function(l){return a;}
,_getContentHtml:function(m){return m.cellData||a;}
,render:function(n){var p=[];var o=this._getCellStyle(n);p.push(f,b,n.stylesheet,e);if(o){p.push(d,o,j);}
;p.push(this._getCellExtras(n),h,this._getContentHtml(n),g);return p.join(a);}
}});}
)();
(function(){var d="number",c="qx.ui.progressive.renderer.table.cell.Default",b="",a="string";qx.Class.define(c,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);}
,members:{_getContentHtml:function(e){return qx.bom.String.escape(this._formatValue(e.cellData));}
,_formatValue:function(f){var h;if(f==null){return b;}
;if(typeof f==a){return f;}
else if(typeof f==d){if(!qx.ui.progressive.renderer.table.Row._numberFormat){var g=new qx.util.format.NumberFormat();g.setMaximumFractionDigits(2);qx.ui.progressive.renderer.table.Row._numberFormat=g;}
...
(function(){var t='(',s="g",r="Boolean",q="$",p="NaN",o='([0-9]{1,3}(?:',n='{0,1}[0-9]{3}){0,})',m='\\d+){0,1}',l="qx.util.format.NumberFormat",k="Infinity",d="^",j=".",g="-Infinity",c='([-+]){0,1}',b="0",f="String",e="changeNumberFormat",h="-",a="Number",i="";qx.Class.define(l,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(u){qx.core.Object.call(this);this.__iQ=u;}
,properties:{minimumIntegerDigits:{check:a,init:0},maximumIntegerDigits:{check:a,nullable:true},minimumFractionDigits:{check:a,init:0},maximumFractionDigits:{check:a,nullable:true},groupingUsed:{check:r,init:true},prefix:{check:f,init:i,event:e},postfix:{check:f,init:i,event:e}},members:{__iQ:null,format:function(v){switch(v){case Infinity:return k;case -Infinity:return g;case NaN:return p;};var z=(v<0);if(z){v=-v;}
...
;if(this.getGroupingUsed()){var y=C;C=i;var E;for(E=y.length;E>3;E-=3){C=i+qx.locale.Number.getGroupSeparator(this.__iQ)+y.substring(E-3,E)+C;}
;C=y.substring(0,E)+C;}
;var A=this.getPrefix()?this.getPrefix():i;var x=this.getPostfix()?this.getPostfix():i;var D=A+(z?h:i)+C;if(B.length>0){D+=i+qx.locale.Number.getDecimalSeparator(this.__iQ)+B;}
;D+=x;return D;}
,parse:function(H){var M=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__iQ)+i);var K=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__iQ)+i);var I=new RegExp(d+qx.lang.String.escapeRegexpChars(this.getPrefix())+c+o+M+n+t+K+m+qx.lang.String.escapeRegexpChars(this.getPostfix())+q);var L=I.exec(H);if(L==null){throw new Error("Number string '"+H+"' does not match the number format");}
...
(function(){var cO='W',cN="The constant 'LOGGING_DATE_TIME__format' will be removed (hasn't been used anyway!)",cM="qqqq",cL="h",cK="KK",cJ="Z",cI="GGGGG",cH="LL",cG="LOGGING_DATE_TIME__format",cF="^",bP='4th quarter',bO="SSS",bN="qqq",bM="K",bL='q',bK='G',bJ="a",bI='2nd quarter',bH="dd",bG="qx.util.format.DateFormat",cV='weekDay',cW="ee",cT="q",cU="QQQQ",cR="ww",cS="H",cP='Y+',cQ='wide',cX="(\\d\\d\\d?)",cY="(GMT[\\+\\-]\\d\\d:\\d\\d)",co="_applyLocale",cn="Q",cq="c",cp="weekOfMonth",cs="GGG",cr='-',cu="w",ct="mm",cm='h',cl="S",o='s',p="QQQ",q="G",r="GG",s="kk",t="ss",u="([\\+\\-]\\d\\d\\d\\d)",v='H',w='S',x='1st quarter',dn='Q1',dm='3rd quarter',dl="QQ",dk="HH",ds='k',dr="m",dq="DDD",dp='D',du='K',dt="L",bg="hh",bh="e",be="W",bf="GGGG",bk='Q2',bl="MM",bi="y+",bj='narrow',bc="yyyy-MM-dd HH:mm:ss",bd="short",O='d',N="unkown",Q="\\d?",P="k",K='m',J="String",M='Q3',L="z",I="DD",H='isoUtcDateTime',bq="SS",br="s",bs="M",bt='w',bm="$",bn="?",bo='Q4',bp='month',bu="qq",bv='L',Y='abbreviated',X="Y+",W=":",V='y',U="quoted_literal",T="weekOfYear",S='a',R="day",bb="(-*",ba="locale",bw="GMT",bx="HH:mm:ss",by='y+',bz="HHmmss",bA="long",bB='Y',bC='z',bD='BC',bE='c',bF="d",bT="D",bS='e',bR='B',bQ='',bX='Before Christ',bW='Z',bV="qx.debug",bU=" ",ca="min",bY='M',ch="sec",ci="\\d",cf="+?",cg='E',cd="eeeee",ce="EEEE",cb='Anno Domini',cc="+",cj="eee",ck="ccc",cy="EEEEE",cx="EE",cA="MMMM",cz='Q',cC="eeee",cB="LLLLL",cE="LLLL",cD="ms",cw="(\\d\\d?\\d?)",cv="cccc",dg="dayOfYear",dh='AD',di="ccccc",dj="E",dc="MMM",dd="EEE",de="MMMMM",df="LLL",da="quarter",db='A',n="default",m="0",h="literal",g="wildcard",f="'",e="(\\d?)",d="hour",c="abbreviated",b="wide",a="(\\d\\d*?)",A="narrow",B="-",y="stand-alone",z="",E="format",F="(\\d\\d?)",C="(",D="|",G=")";qx.Class.define(bG,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(dv,dw){qx.core.Object.call(this);if(!dw){this.__iQ=qx.locale.Manager.getInstance().getLocale();this.__nX=qx.locale.Manager.getInstance().bind(ba,this,ba);}
else {this.__iQ=dw;this.setLocale(dw);}
;this.__nY=this.__iQ;if(dv!=null){this.__oa=dv.toString();if(this.__oa in qx.util.format.DateFormat.ISO_MASKS){if(this.__oa===H){this.__ob=true;}
;this.__oa=qx.util.format.DateFormat.ISO_MASKS[this.__oa];}
;}
else {this.__oa=qx.locale.Date.getDateFormat(bA,this.__iQ)+bU+qx.locale.Date.getDateTimeFormat(bz,bx,this.__iQ);}
;}
,properties:{locale:{apply:co,nullable:true,check:J}},statics:{getDateInstance:function(){var dy=qx.util.format.DateFormat;var dx=qx.locale.Date.getDateFormat(bd)+z;if(dy._dateInstance==null||dy._dateInstance.__oa!=dx){dy._dateInstance=new dy(dx);}
;return dy._dateInstance;}
,getDateTimeInstance:function(){var dA=qx.util.format.DateFormat;var dz=qx.locale.Date.getDateFormat(bA)+bU+qx.locale.Date.getDateTimeFormat(bz,bx);if(dA._dateTimeInstance==null||dA._dateTimeInstance.__oa!=dz){dA._dateTimeInstance=new dA(dz);}
;return dA._dateTimeInstance;}
,ASSUME_YEAR_2000_THRESHOLD:30,LOGGING_DATE_TIME__format:bc,ISO_MASKS:{isoDate:"yyyy-MM-dd",isoTime:"HH:mm:ss",isoDateTime:"yyyy-MM-dd'T'HH:mm:ss",isoUtcDateTime:"yyyy-MM-dd'T'HH:mm:ss'Z'"},AM_MARKER:"am",PM_MARKER:"pm"},members:{__nX:null,__iQ:null,__nY:null,__oa:null,__oc:null,__od:null,__oe:null,__ob:null,__of:function(dB,dC){var dD=z+(dB<0?((-1)*dB):dB);while(dD.length<dC){dD=m+dD;}
;return dB<0?B+dD:dD;}
,__og:function(dE){var dF=new Date(dE.getTime());var dG=dF.getDate();while(dF.getMonth()!=0){dF.setDate(-1);dG+=dF.getDate()+1;}
;return dG;}
,__oh:function(dH){return new Date(dH.getTime()+(3-((dH.getDay()+6)%7))*86400000);}
,__oi:function(dI){var dK=this.__oh(dI);var dL=dK.getFullYear();var dJ=this.__oh(new Date(dL,0,4));return Math.floor(1.5+(dK.getTime()-dJ.getTime())/86400000/7);}
,__oj:function(dM){var dO=this.__oh(dM);var dN=this.__oh(new Date(dM.getFullYear(),dM.getMonth(),4));return Math.floor(1.5+(dO.getTime()-dN.getTime())/86400000/7);}
,__ok:function(dP){var dQ=this.__oh(dP);return dQ.getFullYear();}
,__ol:function(dR){var dS=new Date(dR,2,1);dS.setDate(-1);return dS.getDate()+1===29;}
,__om:function(dT,dU){var dY=0;var ea=0;if(!dU){dU=1971;}
;var dV=0;for(var i=1;i<=12;i++){var dX=new Date(dU,i,1);dX.setDate(-1);var dW=dX.getDate()+1;dV+=dW;if(dV<dT){dY++;ea+=dW;}
else {ea=dT-(dV-dW);break;}
;}
;return {month:dY,day:ea};}
,__on:function(eb,ec,ed){var ee;switch(ec){case 11:ee=eb-1;if(eb!=this.__ok(new Date(ee,ec,ed))){ee=eb;}
;break;case 0:ee=eb+1;if(eb!=this.__ok(new Date(ee,ec,ed))){ee=eb;}
;break;default:ee=eb;};return ee;}
,_applyLocale:function(ef,eg){this.__iQ=ef===null?this.setLocale(this.__nY):ef;}
,format:function(eh){if(eh==null){return null;}
;if(isNaN(eh.getTime())){if(qx.core.Environment.get(bV)){qx.log.Logger.error("Provided date is invalid");}
;return null;}
;if(this.__ob){eh=new Date(eh.getUTCFullYear(),eh.getUTCMonth(),eh.getUTCDate(),eh.getUTCHours(),eh.getUTCMinutes(),eh.getUTCSeconds(),eh.getUTCMilliseconds());}
;var ek=this.__iQ;var ep=eh.getFullYear();var el=eh.getMonth();var eo=eh.getDate();var es=eh.getDay();var ev=eh.getHours();var eB=eh.getMinutes();var et=eh.getSeconds();var ez=eh.getMilliseconds();var er=eh.getTimezoneOffset();var ew=er>0?1:-1;var ei=Math.floor(Math.abs(er)/60);var ey=Math.abs(er)%60;this.__oo();var eA=z;for(var i=0;i<this.__oe.length;i++){var eq=this.__oe[i];if(eq.type==h){eA+=eq.text;}
else {var ej=eq.character;var eu=eq.size;var eC=bn;switch(ej){case V:if(eu==2){eC=this.__of(ep%100,2);}
else {var em=Math.abs(ep);eC=em+z;if(eu>eC.length){for(var j=eC.length;j<eu;j++){eC=m+eC;}
;}
;if(ep<0){eC=B+eC;}
;}
;break;case bB:eC=this.__ok(eh)+z;var em=eC.replace(cr,bQ);if(eu>eC.length){for(var j=em.length;j<eu;j++){em=m+em;}
;}
;eC=eC.indexOf(B)!=-1?B+em:em;break;case bK:if(eu>=1&&eu<=3){eC=ep>0?dh:bD;}
else if(eu==4){eC=ep>0?cb:bX;}
else if(eu==5){eC=ep>0?db:bR;}
;break;case cz:if(eu==1||eu==2){eC=this.__of(parseInt(el/4)+1,eu);}
;if(eu==3){eC=cz+(parseInt(el/4)+1);}
;break;case bL:if(eu==1||eu==2){eC=this.__of(parseInt(el/4)+1,eu);}
;if(eu==3){eC=cz+(parseInt(el/4)+1);}
;break;case dp:eC=this.__of(this.__og(eh),eu);break;case O:eC=this.__of(eo,eu);break;case bt:eC=this.__of(this.__oi(eh),eu);break;case cO:eC=this.__oj(eh);break;case cg:if(eu>=1&&eu<=3){eC=qx.locale.Date.getDayName(c,es,ek,E,true);}
else if(eu==4){eC=qx.locale.Date.getDayName(b,es,ek,E,true);}
else if(eu==5){eC=qx.locale.Date.getDayName(A,es,ek,E,true);}
;break;case bS:var en=qx.locale.Date.getWeekStart(ek);var ex=1+((es-en>=0)?(es-en):7+(es-en));if(eu>=1&&eu<=2){eC=this.__of(ex,eu);}
else if(eu==3){eC=qx.locale.Date.getDayName(c,es,ek,E,true);}
else if(eu==4){eC=qx.locale.Date.getDayName(b,es,ek,E,true);}
else if(eu==5){eC=qx.locale.Date.getDayName(A,es,ek,E,true);}
;break;case bE:var en=qx.locale.Date.getWeekStart(ek);var ex=1+((es-en>=0)?(es-en):7+(es-en));if(eu==1){eC=bQ+ex;}
else if(eu==3){eC=qx.locale.Date.getDayName(c,es,ek,y,true);}
else if(eu==4){eC=qx.locale.Date.getDayName(b,es,ek,y,true);}
else if(eu==5){eC=qx.locale.Date.getDayName(A,es,ek,y,true);}
;break;case bY:if(eu==1||eu==2){eC=this.__of(el+1,eu);}
else if(eu==3){eC=qx.locale.Date.getMonthName(c,el,ek,E,true);}
else if(eu==4){eC=qx.locale.Date.getMonthName(b,el,ek,E,true);}
else if(eu==5){eC=qx.locale.Date.getMonthName(A,el,ek,E,true);}
;break;case bv:if(eu==1||eu==2){eC=this.__of(el+1,eu);}
else if(eu==3){eC=qx.locale.Date.getMonthName(c,el,ek,y,true);}
else if(eu==4){eC=qx.locale.Date.getMonthName(b,el,ek,y,true);}
else if(eu==5){eC=qx.locale.Date.getMonthName(A,el,ek,y,true);}
;break;case S:eC=(ev<12)?qx.locale.Date.getAmMarker(ek):qx.locale.Date.getPmMarker(ek);break;case v:eC=this.__of(ev,eu);break;case ds:eC=this.__of((ev==0)?24:ev,eu);break;case du:eC=this.__of(ev%12,eu);break;case cm:eC=this.__of(((ev%12)==0)?12:(ev%12),eu);break;case K:eC=this.__of(eB,eu);break;case o:eC=this.__of(et,eu);break;case w:eC=this.__of(ez,3);if(eu<eC.length){eC=eC.substr(0,eu);}
else {while(eu>eC.length){eC+=m;}
;}
;break;case bC:if(eu>=1&&eu<=4){eC=bw+((ew>0)?B:cc)+this.__of(Math.abs(ei),2)+W+this.__of(ey,2);}
;break;case bW:if(eu>=1&&eu<=3){eC=((ew>0)?B:cc)+this.__of(Math.abs(ei),2)+this.__of(ey,2);}
else {eC=bw+((ew>0)?B:cc)+this.__of(Math.abs(ei),2)+W+this.__of(ey,2);}
;break;};eA+=eC;}
;}
;return eA;}
,parse:function(eD){this.__op();var eM=this.__oc.regex.exec(eD);if(eM==null){throw new Error("Date string '"+eD+"' does not match the date format: "+this.__oa);}
;var eE={era:1,year:1970,quarter:1,month:0,day:1,dayOfYear:1,hour:0,ispm:false,weekDay:4,weekYear:1970,weekOfMonth:1,weekOfYear:1,min:0,sec:0,ms:0};var eG=1;var eF=false;var eH=false;for(var i=0;i<this.__oc.usedRules.length;i++){var eI=this.__oc.usedRules[i];var eJ=eM[eG];if(eI.field!=null){eE[eI.field]=parseInt(eJ,10);}
else {eI.manipulator(eE,eJ,eI.pattern);}
;if(eI.pattern==X){var eK=false;for(var k=0;k<this.__oc.usedRules.length;k++){if(this.__oc.usedRules[k].pattern==by){eK=true;break;}
;}
;if(!eK){eF=true;}
;}
;if(eI.pattern.indexOf(bT)!=-1){var eO=false;for(var k=0;k<this.__oc.usedRules.length;k++){if(this.__oc.usedRules[k].pattern.indexOf(bF)!=-1){eO=true;break;}
;}
;if(!eO){eH=true;}
;}
;eG+=(eI.groups==null)?1:eI.groups;}
;if(eF){eE.year=this.__on(eE.weekYear,eE.month,eE.day);}
;if(eH){var eN=this.__om(eE.dayOfYear,eE.year);eE.month=eN.month;eE.day=eN.day;}
;if(eE.era<0&&(eE.year*eE.era<0)){eE.year=eE.year*eE.era;}
;var eL=new Date(eE.year,eE.month,eE.day,(eE.ispm)?(eE.hour+12):eE.hour,eE.min,eE.sec,eE.ms);if(this.__ob){eL=new Date(eL.getUTCFullYear(),eL.getUTCMonth(),eL.getUTCDate(),eL.getUTCHours(),eL.getUTCMinutes(),eL.getUTCSeconds(),eL.getUTCMilliseconds());}
;if(eE.month!=eL.getMonth()||eE.year!=eL.getFullYear()){throw new Error("Error parsing date '"+eD+"': the value for day or month is too large");}
;return eL;}
,__oo:function(){if(this.__oe!=null){return;}
;this.__oe=[];var eT;var eR=0;var eV=z;var eP=this.__oa;var eS=n;var i=0;while(i<eP.length){var eU=eP.charAt(i);switch(eS){case U:if(eU==f){if(i+1>=eP.length){i++;break;}
;var eQ=eP.charAt(i+1);if(eQ==f){eV+=eU;i++;}
else {i++;eS=N;}
;}
else {eV+=eU;i++;}
;break;case g:if(eU==eT){eR++;i++;}
else {this.__oe.push({type:g,character:eT,size:eR});eT=null;eR=0;eS=n;}
;break;default:if((eU>=S&&eU<=bC)||(eU>=db&&eU<=bW)){eT=eU;eS=g;}
else if(eU==f){if(i+1>=eP.length){eV+=eU;i++;break;}
;var eQ=eP.charAt(i+1);if(eQ==f){eV+=eU;i++;}
;i++;eS=U;}
else {eS=n;}
;if(eS!=n){if(eV.length>0){this.__oe.push({type:h,text:eV});eV=z;}
;}
else {eV+=eU;i++;}
;break;};}
;if(eT!=null){this.__oe.push({type:g,character:eT,size:eR});}
else if(eV.length>0){this.__oe.push({type:h,text:eV});}
;}
,__op:function(){if(this.__oc!=null){return;}
;var fa=this.__oa;this.__or();this.__oo();var fg=[];var fc=cF;for(var eX=0;eX<this.__oe.length;eX++){var fh=this.__oe[eX];if(fh.type==h){fc+=qx.lang.String.escapeRegexpChars(fh.text);}
else {var eY=fh.character;var fd=fh.size;var fb;for(var fi=0;fi<this.__od.length;fi++){var fe=this.__od[fi];if(this.__oq(fe,eY,fd)){fb=fe;break;}
;}
;if(fb==null){var ff=z;for(var i=0;i<fd;i++){ff+=eY;}
;throw new Error("Malformed date format: "+fa+". Wildcard "+ff+" is not supported");}
else {fg.push(fb);fc+=fb.regex;}
;}
;}
;fc+=bm;var eW;try{eW=new RegExp(fc);}
catch(fj){throw new Error("Malformed date format: "+fa);}
;this.__oc={regex:eW,"usedRules":fg,pattern:fc};}
,__oq:function(fk,fl,fm){if(fl===V&&fk.pattern===by){fk.regex=fk.regexFunc(fm);return true;}
else if(fl===bB&&fk.pattern===cP){fk.regex=fk.regexFunc(fm);return true;}
else {return fl==fk.pattern.charAt(0)&&fm==fk.pattern.length;}
;}
,__or:function(){var fA=qx.util.format.DateFormat;var fC=qx.lang.String;if(this.__od!=null){return;}
;var fB=this.__od=[];var fw=qx.locale.Date.getAmMarker(this.__iQ).toString()||fA.AM_MARKER;var fJ=qx.locale.Date.getPmMarker(this.__iQ).toString()||fA.PM_MARKER;var fo=this.__iQ;var ft=function(fN,fO){fO=parseInt(fO,10);if(fO>0){if(fO<fA.ASSUME_YEAR_2000_THRESHOLD){fO+=2000;}
else if(fO<100){fO+=1900;}
;}
;fN.year=fO;}
;var fL=function(fP,fQ){fQ=parseInt(fQ,10);if(fQ>0){if(fQ<fA.ASSUME_YEAR_2000_THRESHOLD){fQ+=2000;}
else if(fQ<100){fQ+=1900;}
;}
;fP.weekYear=fQ;}
;var fM=function(fR,fS){fR.month=parseInt(fS,10)-1;}
;var fr=function(fT,fU){var fW=qx.locale.Date.getWeekStart(fo);var fV=(parseInt(fU,10)-1+fW)<=6?parseInt(fU,10)-1+fW:(parseInt(fU,10)-1+fW)-7;fT.weekDay=fV;}
;var fq=function(fX,fY){var ga=qx.locale.Date.getPmMarker(fo).toString()||fA.PM_MARKER;fX.ispm=(fY==ga);}
;var fv=function(gb,gc){gb.hour=parseInt(gc,10)%24;}
;var fp=function(gd,ge){gd.hour=parseInt(ge,10)%12;}
;var fE=function(gf,gg){return;}
;var fF=[db,bR];var fG=function(gh,gi){gh.era=gi==db?1:-1;}
;var fz=[dh,bD];var fy=function(gj,gk){gj.era=gk==dh?1:-1;}
;var fI=[cb,bX];var fx=function(gl,gm){gl.era=gm==cb?1:-1;}
;var fK=[dn,bk,M,bo];var fn=function(gn,go){gn.quarter=fK.indexOf(go);}
;var fH=[x,bI,dm,bP];var fD=function(gp,gq){gp.quarter=fH.indexOf(gq);}
;var fu={};var fs=function(gr){var gw=[bv,bY];var gs=[bE,bS,cg];var gz=gr.charAt(0);var gu=gw.indexOf(gz)>=0;var gv=function(){var gB=gu?gw:gs;var gC=gz===gB[0]?y:E;var gD=gr.length;var gA=Y;switch(gD){case 4:gA=cQ;break;case 5:gA=bj;break;default:gA=Y;};return [gC,gA];}
;if(!fu[gr]){fu[gr]={};var gy=gv();var gt=gu?qx.locale.Date.getMonthNames:qx.locale.Date.getDayNames;var gx=gt.call(qx.locale.Date,gy[1],fo,gy[0],true);for(var i=0,l=gx.length;i<l;i++){gx[i]=fC.escapeRegexpChars(gx[i].toString());}
;fu[gr].data=gx;fu[gr].func=function(gE,gF){gF=fC.escapeRegexpChars(gF);gE[gu?bp:cV]=gx.indexOf(gF);}
;}
;return fu[gr];}
;fB.push({pattern:bi,regexFunc:function(gG){var gH=bb;for(var i=0;i<gG;i++){gH+=ci;if(i===gG-1&&i!==1){gH+=cf;}
;}
;gH+=G;return gH;}
,manipulator:ft});fB.push({pattern:X,regexFunc:function(gI){var gJ=bb;for(var i=0;i<gI;i++){gJ+=ci;if(i===gI-1){gJ+=cf;}
;}
;gJ+=G;return gJ;}
,manipulator:fL});fB.push({pattern:q,regex:C+fz.join(D)+G,manipulator:fy});fB.push({pattern:r,regex:C+fz.join(D)+G,manipulator:fy});fB.push({pattern:cs,regex:C+fz.join(D)+G,manipulator:fy});fB.push({pattern:bf,regex:C+fI.join(D)+G,manipulator:fx});fB.push({pattern:cI,regex:C+fF.join(D)+G,manipulator:fG});fB.push({pattern:cn,regex:a,field:da});fB.push({pattern:dl,regex:F,field:da});fB.push({pattern:p,regex:C+fK.join(D)+G,manipulator:fn});fB.push({pattern:cU,regex:C+fH.join(D)+G,manipulator:fD});fB.push({pattern:cT,regex:a,field:da});fB.push({pattern:bu,regex:F,field:da});fB.push({pattern:bN,regex:C+fK.join(D)+G,manipulator:fn});fB.push({pattern:cM,regex:C+fH.join(D)+G,manipulator:fD});fB.push({pattern:bs,regex:a,manipulator:fM});fB.push({pattern:bl,regex:F,manipulator:fM});fB.push({pattern:dc,regex:C+fs(dc).data.join(D)+G,manipulator:fs(dc).func});fB.push({pattern:cA,regex:C+fs(cA).data.join(D)+G,manipulator:fs(cA).func});fB.push({pattern:de,regex:C+fs(de).data.join(D)+G,manipulator:fs(de).func});fB.push({pattern:dt,regex:a,manipulator:fM});fB.push({pattern:cH,regex:F,manipulator:fM});fB.push({pattern:df,regex:C+fs(df).data.join(D)+G,manipulator:fs(df).func});fB.push({pattern:cE,regex:C+fs(cE).data.join(D)+G,manipulator:fs(cE).func});fB.push({pattern:cB,regex:C+fs(cB).data.join(D)+G,manipulator:fs(cB).func});fB.push({pattern:bH,regex:F,field:R});fB.push({pattern:bF,regex:a,field:R});fB.push({pattern:bT,regex:e,field:dg});fB.push({pattern:I,regex:F,field:dg});fB.push({pattern:dq,regex:cX,field:dg});fB.push({pattern:dj,regex:C+fs(dj).data.join(D)+G,manipulator:fs(dj).func});fB.push({pattern:cx,regex:C+fs(cx).data.join(D)+G,manipulator:fs(cx).func});fB.push({pattern:dd,regex:C+fs(dd).data.join(D)+G,manipulator:fs(dd).func});fB.push({pattern:ce,regex:C+fs(ce).data.join(D)+G,manipulator:fs(ce).func});fB.push({pattern:cy,regex:C+fs(cy).data.join(D)+G,manipulator:fs(cy).func});fB.push({pattern:bh,regex:e,manipulator:fr});fB.push({pattern:cW,regex:F,manipulator:fr});fB.push({pattern:cj,regex:C+fs(cj).data.join(D)+G,manipulator:fs(cj).func});fB.push({pattern:cC,regex:C+fs(cC).data.join(D)+G,manipulator:fs(cC).func});fB.push({pattern:cd,regex:C+fs(cd).data.join(D)+G,manipulator:fs(cd).func});fB.push({pattern:cq,regex:Q,manipulator:fr});fB.push({pattern:ck,regex:C+fs(ck).data.join(D)+G,manipulator:fs(ck).func});fB.push({pattern:cv,regex:C+fs(cv).data.join(D)+G,manipulator:fs(cv).func});fB.push({pattern:di,regex:C+fs(di).data.join(D)+G,manipulator:fs(di).func});fB.push({pattern:bJ,regex:C+fw+D+fJ+G,manipulator:fq});fB.push({pattern:be,regex:e,field:cp});fB.push({pattern:cu,regex:e,field:T});fB.push({pattern:cR,regex:F,field:T});fB.push({pattern:dk,regex:F,field:d});fB.push({pattern:cS,regex:F,field:d});fB.push({pattern:s,regex:F,manipulator:fv});fB.push({pattern:P,regex:F,manipulator:fv});fB.push({pattern:cK,regex:F,field:d});fB.push({pattern:bM,regex:F,field:d});fB.push({pattern:bg,regex:F,manipulator:fp});fB.push({pattern:cL,regex:F,manipulator:fp});fB.push({pattern:ct,regex:F,field:ca});fB.push({pattern:dr,regex:F,field:ca});fB.push({pattern:t,regex:F,field:ch});fB.push({pattern:br,regex:F,field:ch});fB.push({pattern:bO,regex:cw,field:cD});fB.push({pattern:bq,regex:cw,field:cD});fB.push({pattern:cl,regex:cw,field:cD});fB.push({pattern:cJ,regex:u,manipulator:fE});fB.push({pattern:L,regex:cY,manipulator:fE});}
},destruct:function(){if(this.__nX!=null){qx.locale.Manager.getInstance().removeBinding(this.__nX);}
;this.__oe=this.__oc=this.__od=null;}
});if(qx.core.Environment.get(bV)){qx.log.Logger.deprecatedConstantWarning(qx.util.format.DateFormat,cG,cN);}
;}
)();
(function(){var k="HH:mm",j="HHmmsszz",h="cldr_date_format_",g="HHmm",f="HHmmss",e="cldr_time_format_",d="HH:mm:ss zz",c="cldr_pm",b="cldr_am",a="qx.locale.Date",J="cldr_date_time_format_",I="HH:mm:ss",H="sat",G="cldr_day_",F="cldr_month_",E="wed",D="fri",C="tue",B="mon",A="sun",r="thu",s="short",p="full",q="long",n="medium",o='_',l="stand-alone",m="narrow",t="abbreviated",u="wide",w='stand-alone',v="qx.debug",y='format',x="format",z="_";qx.Class.define(a,{statics:{__os:qx.locale.Manager.getInstance(),getAmMarker:function(K){return this.__os.localize(b,[],K);}
,getPmMarker:function(L){return this.__os.localize(c,[],L);}
,getDayNames:function(length,M,N,O){var N=N?N:x;if(qx.core.Environment.get(v)){qx.core.Assert.assertInArray(length,[t,m,u]);qx.core.Assert.assertInArray(N,[x,l]);}
;var Q=[A,B,C,E,r,D,H];var R=[];for(var i=0;i<Q.length;i++){var P=G+N+z+length+z+Q[i];R.push(O?this.__ot(N,N===y?w:y,P,M):this.__os.localize(P,[],M));}
;return R;}
,getDayName:function(length,S,T,U,V){var U=U?U:x;if(qx.core.Environment.get(v)){qx.core.Assert.assertInArray(length,[t,m,u]);qx.core.Assert.assertInteger(S);qx.core.Assert.assertInRange(S,0,6);qx.core.Assert.assertInArray(U,[x,l]);}
;var X=[A,B,C,E,r,D,H];var W=G+U+z+length+z+X[S];return V?this.__ot(U,U===y?w:y,W,T):this.__os.localize(W,[],T);}
,getMonthNames:function(length,Y,ba,bb){var ba=ba?ba:x;if(qx.core.Environment.get(v)){qx.core.Assert.assertInArray(length,[t,m,u]);qx.core.Assert.assertInArray(ba,[x,l]);}
;var bd=[];for(var i=0;i<12;i++){var bc=F+ba+z+length+z+(i+1);bd.push(bb?this.__ot(ba,ba===y?w:y,bc,Y):this.__os.localize(bc,[],Y));}
;return bd;}
,getMonthName:function(length,be,bf,bg,bh){var bg=bg?bg:x;if(qx.core.Environment.get(v)){qx.core.Assert.assertInArray(length,[t,m,u]);qx.core.Assert.assertInArray(bg,[x,l]);}
;var bi=F+bg+z+length+z+(be+1);return bh?this.__ot(bg,bg===y?w:y,bi,bf):this.__os.localize(bi,[],bf);}
,getDateFormat:function(bj,bk){if(qx.core.Environment.get(v)){qx.core.Assert.assertInArray(bj,[s,n,q,p]);}
;var bl=h+bj;return this.__os.localize(bl,[],bk);}
,getDateTimeFormat:function(bm,bn,bo){var bq=J+bm;var bp=this.__os.localize(bq,[],bo);if(bp==bq){bp=bn;}
;return bp;}
,getTimeFormat:function(br,bs){if(qx.core.Environment.get(v)){qx.core.Assert.assertInArray(br,[s,n,q,p]);}
;var bu=e+br;var bt=this.__os.localize(bu,[],bs);if(bt!=bu){return bt;}
;switch(br){case s:case n:return qx.locale.Date.getDateTimeFormat(g,k);case q:return qx.locale.Date.getDateTimeFormat(f,I);case p:return qx.locale.Date.getDateTimeFormat(j,d);default:throw new Error("This case should never happen.");};}
,getWeekStart:function(bv){var bw={"MV":5,"AE":6,"AF":6,"BH":6,"DJ":6,"DZ":6,"EG":6,"ER":6,"ET":6,"IQ":6,"IR":6,"JO":6,"KE":6,"KW":6,"LB":6,"LY":6,"MA":6,"OM":6,"QA":6,"SA":6,"SD":6,"SO":6,"TN":6,"YE":6,"AS":0,"AU":0,"AZ":0,"BW":0,"CA":0,"CN":0,"FO":0,"GE":0,"GL":0,"GU":0,"HK":0,"IE":0,"IL":0,"IS":0,"JM":0,"JP":0,"KG":0,"KR":0,"LA":0,"MH":0,"MN":0,"MO":0,"MP":0,"MT":0,"NZ":0,"PH":0,"PK":0,"SG":0,"TH":0,"TT":0,"TW":0,"UM":0,"US":0,"UZ":0,"VI":0,"ZA":0,"ZW":0,"MW":0,"NG":0,"TJ":0};var bx=qx.locale.Date._getTerritory(bv);return bw[bx]!=null?bw[bx]:1;}
,getWeekendStart:function(by){var bA={"EG":5,"IL":5,"SY":5,"IN":0,"AE":4,"BH":4,"DZ":4,"IQ":4,"JO":4,"KW":4,"LB":4,"LY":4,"MA":4,"OM":4,"QA":4,"SA":4,"SD":4,"TN":4,"YE":4};var bz=qx.locale.Date._getTerritory(by);return bA[bz]!=null?bA[bz]:6;}
,getWeekendEnd:function(bB){var bC={"AE":5,"BH":5,"DZ":5,"IQ":5,"JO":5,"KW":5,"LB":5,"LY":5,"MA":5,"OM":5,"QA":5,"SA":5,"SD":5,"TN":5,"YE":5,"AF":5,"IR":5,"EG":6,"IL":6,"SY":6};var bD=qx.locale.Date._getTerritory(bB);return bC[bD]!=null?bC[bD]:0;}
,isWeekend:function(bE,bF){var bH=qx.locale.Date.getWeekendStart(bF);var bG=qx.locale.Date.getWeekendEnd(bF);if(bG>bH){return ((bE>=bH)&&(bE<=bG));}
else {return ((bE>=bH)||(bE<=bG));}
;}
,_getTerritory:function(bI){if(bI){var bJ=bI.split(z)[1]||bI;}
else {bJ=this.__os.getTerritory()||this.__os.getLanguage();}
;return bJ.toUpperCase();}
,__ot:function(bK,bL,bM,bN){var bP=this.__os.localize(bM,[],bN);if(bP==bM){var bO=bM.replace(o+bK+o,o+bL+o);return this.__os.localize(bO,[],bN);}
else {return bP;}
;}
}});}
)();
(function(){var t=" height='",s="vertical-align:middle;",r="text-align:center;",q="abstract",p="",o='<img ',n='" style="filter:',m=" title='",l=" width='",k="qx.ui.progressive.renderer.table.cell.Icon",d="'",j=" style='padding-top:2px;'",g=">",c="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",b="qx/static/blank.gif",f="string",e="',sizingMethod='scale')",h="px'",a='" ',i='src="';qx.Class.define(k,{type:q,extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);var u=qx.util.AliasManager.getInstance();var v=qx.util.ResourceManager.getInstance();var w=u.resolve(b);this.__Gb=v.toUri(w);}
,members:{__Gb:null,getBlankImage:function(){return this.__Gb;}
,_identifyImage:function(x){throw new Error("_identifyImage() is abstract");}
,_getCellStyle:function(y){var z=qx.ui.progressive.renderer.table.cell.Abstract.prototype._getCellStyle.call(this,y)+r+s;return z;}
,_getContentHtml:function(A){var B=[];var C=this.__Gc(A);B.push(o);if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(C.url)){B.push(i,this.__Gb,n,c,C.url,e,a);}
else {B.push(i,C.url,a);}
;if(C.imageWidth){B.push(l,C.imageWidth,h);}
;if(C.imageHeight){B.push(t,C.imageHeight,h);}
;B.push(j);if(C.tooltip){B.push(m,C.tooltip,d);}
;if(C.extras){B.push(C.extras);}
;B.push(g);return B.join(p);}
,__Gc:function(D){var E=this._identifyImage(D);if(E==null||typeof E==f){E={url:E,tooltip:null};}
;if(E.url==null){E.url=this.__Gb;}
;return E;}
}});}
)();
(function(){var j="\"",i="Boolean",h="  this.attributes.setNamedItem(namedItem); ",g="} catch (e) { ",f="var node = this.attributes.getNamedItem('celldata'); ",e="qx.ui.progressive.renderer.table.cell.Boolean",d="decoration/table/boolean-true.png",c="var value = node.nodeValue; ",b="decoration/table/boolean-false.png",a="celldata='1' ",E="  node.nodeValue='0'; ",D="  this.attributes.setNamedItem(node); ",C="if (value == '0') ",B="celldata='0' ",A="  node.nodeValue='1'; ",z="onclick=\"",y="  namedItem.value = node.nodeValue; ",x="var src; ",w="try { ",v="  var namedItem = document.createAttribute('celldata'); ",q="} ",r="else ",o="  var filters = this.filters.item(loader); ",p="changeTheme",m="}",n="{",k="  var loader = 'DXImageTransform.Microsoft.AlphaImageLoader'; ",l="  filters.sizingMethod = 'scale'; ",s="  filters.src='",t="  this.src='",u="'; ";qx.Class.define(e,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(){qx.ui.progressive.renderer.table.cell.Icon.call(this);this.__Kp();qx.theme.manager.Appearance.getInstance().addListener(p,this.__Kp,this);}
,properties:{allowToggle:{check:i,init:false}},members:{__zw:null,__zx:null,__Io:null,__Iq:null,__zq:null,__zr:null,__zs:null,__zt:null,__Kp:function(){var H=qx.util.AliasManager.getInstance();var I=qx.util.ResourceManager.getInstance();var G=H.resolve(d);var F=H.resolve(b);this.__zw=I.toUri(G);this.__zx=I.toUri(F);}
,_identifyImage:function(J){var K={imageWidth:11,imageHeight:11};switch(J.cellData){case true:K.url=this.__zw;K.extras=a;break;case false:K.url=this.__zx;K.extras=B;break;default:K.url=null;break;};if(this.getAllowToggle()){K.extras+=z+f+c+x+C+n;if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__zw)){K.extras+=t+this.getBlankImage()+u+k+o+s+this.__zw+u+l;}
else {K.extras+=t+this.__zw+u;}
;K.extras+=A+q+r+n;if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__zx)){K.extras+=t+this.getBlankImage()+u+k+o+s+this.__zx+u+l;}
else {K.extras+=t+this.__zx+u;}
;K.extras+=E+m;K.extras+=w+D+g+v+y+h+m+j;}
;return K;}
,_getCellStyle:function(L){var M=qx.ui.progressive.renderer.table.cell.Icon.prototype._getCellStyle.call(this,L);return M;}
},destruct:function(){this.__zw=this.__zx=null;qx.theme.manager.Appearance.getInstance().removeListener(p,this.__Kp,this);}
});}
)();
(function(){var j="Use qx.bom.element.Style.get(element, 'overflowY', mode) instead.",i="Use qx.bom.element.Style.compile({'overflowX': value}) instead.",h="DEFAULT_SCROLLBAR_WIDTH",g="Use qx.bom.element.Scroll.getScrollbarWidth() instead.",f="Please use 'qx.ui.core.scroll.AbstractScrollArea.DEFAULT_SCROLLBAR_WIDTH' instead.",e="Use qx.bom.element.Style.compile({'overflowY': value}) instead.",d="Use qx.bom.element.Style.reset(element, 'overflowX') instead.",c="Use qx.bom.element.Style.set(element, 'overflowX', value) instead.",b="overflow-y",a=":",v="overflowY",u="Use qx.bom.element.Style.get(element, 'overflowX', mode) instead.",t="Use qx.bom.element.Style.reset(element, 'overflowY') instead.",s="qx.bom.element.Overflow",r="overflow-x",q=";",p="Use qx.bom.element.Style.set(element, 'overflowY', value) instead.",o="overflowX",n="overflow",m="",k="css.overflowxy",l="qx.debug";qx.Bootstrap.define(s,{statics:{DEFAULT_SCROLLBAR_WIDTH:14,getScrollbarWidth:function(){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);}
;return qx.bom.element.Scroll.getScrollbarWidth();}
,_compile:function(w,x){return w+a+x+q;}
,compileX:function(y){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,i);}
;return this._compile(r,y);}
,compileY:function(z){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,e);}
;return this._compile(b,z);}
,getX:function(A,B){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,u);}
;if(qx.core.Environment.get(k)){return qx.bom.element.Style.get(A,o,B,false);}
;return qx.bom.element.Style.get(A,n,B,false);}
,setX:function(C,D){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,c);}
;if(qx.core.Environment.get(k)){C.style.overflowX=D;}
else {C.style.overflow=D;}
;}
,resetX:function(E){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,d);}
;if(qx.core.Environment.get(k)){E.style.overflowX=m;}
else {E.style.overflow=m;}
;}
,getY:function(F,G){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,j);}
;if(qx.core.Environment.get(k)){return qx.bom.element.Style.get(F,v,G,false);}
;return qx.bom.element.Style.get(F,n,G,false);}
,setY:function(H,I){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,p);}
;if(qx.core.Environment.get(k)){H.style.overflowY=I;}
else {H.style.overflow=I;}
;}
,resetY:function(J){if(qx.core.Environment.get(l)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,t);}
;if(qx.core.Environment.get(k)){J.style.overflowY=m;}
else {J.style.overflow=m;}
;}
}});qx.log.Logger.deprecatedConstantWarning(qx.bom.element.Overflow,h,f);}
)();
