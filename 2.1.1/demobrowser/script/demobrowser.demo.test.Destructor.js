...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.2d88a3cb091b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="Window: ",d="interval",c="__jC",b="Label: ",a="demobrowser.demo.test.Destructor";qx.Class.define(a,{extend:qx.application.Standalone,members:{__cR:null,__SI:0,__jC:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cR=[];this.currentTest=this.testWindows;this.__jC=new qx.event.Timer(1000);this.__jC.addListener(d,this.runTest,this);this.__jC.start();}
,runTest:function(){this.__SI++;var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug("Round: "+this.__SI+" (Registry: "+g+")");this.currentTest();qx.ui.core.queue.Manager.flush();var f=this.__cR;for(var i=0,l=f.length;i<l;i++){f[i].destroy();}
...
,testLabels:function(){for(var i=0;i<250;i++){var h=new qx.ui.basic.Label(b+i);this.getRoot().add(h,{left:50,top:50+i*20});this.__cR.push(h);}
;}
,testWindows:function(){for(var i=0;i<5;i++){var j=new qx.ui.window.Window(e+i);j.open();this.__cR.push(j);}
;}
