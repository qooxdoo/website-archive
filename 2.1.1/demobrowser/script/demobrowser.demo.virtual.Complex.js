...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.088d2f1b02ec.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="icon/",q="",p="folder.png",o="places/",n="demobrowser.demo.virtual.DemoLayer",m="network-server.png",l="mouseover",k="user-trash.png",i="changeValue",h="network-workgroup.png",c="qx.ui.basic.Atom",g="/",f="user-desktop.png",b=" / ",a="row",e="foobar!",d="column";qx.Class.define(n,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__mW=[];}
,members:{_pool:null,__mW:null,getCellData:function(s,t){if(!this.__mW[s]){this.__mW[s]=[];}
;if(!this.__mW[s][t]){this.__mW[s][t]={label:this.__Tf(),icon:this.__Tg()};}
;return this.__mW[s][t];}
,getCellWidget:function(u,v){var w;if(v%2==0){w=this._pool.atom.pop();if(!w){w=new qx.ui.basic.Atom();w.addListener(l,function(){var x=this.__Tg();w.setIcon(x);this.__mW[u][v].icon=x;}
,this);}
...
;}
,__Tf:function(){var name=q;for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__Tg:function(){var z=r;var B=o;var C=[p,k,m,h,f];var A=Math.floor(Math.random()*4);return (z+16+g+B+C[A]);}
},destruct:function(){this._pool=this.__mW=null;}
});}
)();
