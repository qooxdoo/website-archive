...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling.644693314578.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(n,o,p){this.__QP=f+n.join(j)+l;this.__QQ=p||50;this.__QR=o;this._clearLog();}
,_clearLog:function(){this.__QR.innerHTML=this.__QP+a;this.__QS=[];}
,_log:function(q){this.__QS.unshift(q);this.__QS=this.__QS.slice(0,this.__QQ);var r=[this.__QP];for(var i=0;i<this.__QS.length;i++){r.push(e,this.__QS[i].join(g),b);}
;r.push(a);this.__QR.innerHTML=r.join(h);this.__QR.scrollTop=0;}
,__QP:null,__QQ:null,__QR:null,__QS:null},destruct:function(){this.__QR=this.__QS=null;}
});}
)();
