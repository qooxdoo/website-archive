...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.Fingers.163c00512c86.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="touchmove",k="black",j="yellow",h="qx.debug",g="0px",f="12px",d="demobrowser.demo.mobile.Fingers",c='Lucida Grande',b="touchstart",a="<b>This demo is supposed to be run in a WebKit-based browser.</b>",B="engine.name",A="red",z="webkit",y="<b>Use your fingers to move the dots</b>",x="blue",w="green",v="100%",u="30px",t="100px",s="innerHTML",q="20px",r="white",o="50px",p="absolute",m="px",n="div";qx.Class.define(d,{extend:qx.application.Native,members:{__QV:null,__QW:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(h)){qx.log.appender.Native;qx.log.appender.Console;}
...
;this.__QV=[];this.__QW=[];J.addListener(b,this._onTouchStart,this);J.addListener(l,this._onTouchMove,this);}
,_onTouchStart:function(e){var L=e.getAllTouches();for(var i=0;i<L.length;i++){var K=L[i];this.__QV[i]=parseInt(K.target.style.left)-K.pageX;this.__QW[i]=parseInt(K.target.style.top)-K.pageY;}
;}
,_onTouchMove:function(e){var N=e.getAllTouches();for(var i=0;i<N.length;i++){var M=N[i];if(N.target==document.body){continue;}
;qx.bom.element.Style.setStyles(M.target,{"left":(M.pageX+this.__QV[i])+m,"top":(M.pageY+this.__QW[i])+m});}
;e.stop();}
}});}
)();
