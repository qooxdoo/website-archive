...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.AttributeStyle_1","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.AttributeStyle_1.b7f00cd20ca6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="backgroundColor",e="black",d="red",c="demobrowser.demo.bom.AttributeStyle_1",b="color",a="test8";qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var g=qx.bom.element.Attribute;var h=qx.bom.element.Style;var i=qx.bom.element.Opacity;this.info("test1");this.debug("classname: "+g.get(document.getElementById("test1"),"class"));this.debug("title: "+g.get(document.getElementById("test1"),"title"));this.debug("top: "+h.get(document.getElementById("test1"),"top"));this.info("test2");this.debug("name: "+g.get(document.getElementById("test2"),"name"));this.debug("value: "+g.get(document.getElementById("test2"),"value"));this.debug("type: "+g.get(document.getElementById("test2"),"type"));this.debug("max: "+g.get(document.getElementById("test2"),"maxlength"));this.debug("left: "+h.get(document.getElementById("test2"),"left"));this.info("test3");this.debug("name: "+g.get(document.getElementById("test3"),"name"));this.debug("value: "+g.get(document.getElementById("test3"),"value"));this.debug("type: "+g.get(document.getElementById("test3"),"type"));this.debug("checked: "+g.get(document.getElementById("test3"),"checked"));this.debug("disabled: "+g.get(document.getElementById("test3"),"disabled"));this.debug("tabindex: "+g.get(document.getElementById("test3"),"tabindex"));this.info("test4");this.debug("disabled: "+g.get(document.getElementById("test4"),"disabled"));this.debug("readonly: "+g.get(document.getElementById("test4"),"readonly"));this.info("test5");this.debug("disabled: "+g.get(document.getElementById("test5"),"disabled"));this.debug("readonly: "+g.get(document.getElementById("test5"),"readonly"));this.info("test6");this.debug("href: "+g.get(document.getElementById("test6"),"href"));this.debug("style: "+g.get(document.getElementById("test6"),"style"));this.debug("css: "+h.getCss(document.getElementById("test6")));this.debug("color: "+h.get(document.getElementById("test6"),"color"));this.debug("bg: "+h.get(document.getElementById("test6"),"backgroundColor"));this.debug("family: "+h.get(document.getElementById("test6"),"fontFamily"));this.debug("text: "+g.get(document.getElementById("test6"),"text"));this.debug("html: "+g.get(document.getElementById("test6"),"html"));this.debug("opacity: "+i.get(document.getElementById("test6")));this.info("test7");this.debug("valign: "+g.get(document.getElementById("test7"),"valign"));this.debug("colspan: "+g.get(document.getElementById("test7").getElementsByTagName("td")[0],"colspan"));this.info("test8");h.set(document.getElementById(a),b,d);h.set(document.getElementById(a),f,e);i.set(document.getElementById(a),0.5);this.debug("opacity: "+i.get(document.getElementById("test8")));this.info("test9");this.debug("Document: "+qx.bom.Document.getWidth()+"x"+qx.bom.Document.getHeight());this.debug("Viewport: "+qx.bom.Viewport.getWidth()+"x"+qx.bom.Viewport.getHeight());}
}});}
)();
