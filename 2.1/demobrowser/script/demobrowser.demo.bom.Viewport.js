...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Viewport.3855403892e8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var b="click",a="demobrowser.demo.bom.Viewport";qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.bom.Element.addListener(document.body,b,function(){this.debug("Document Dimension: "+qx.bom.Document.getWidth()+"x"+qx.bom.Document.getHeight());this.debug("Viewport Dimension: "+qx.bom.Viewport.getWidth()+"x"+qx.bom.Viewport.getHeight());this.debug("Viewport Scroll: "+qx.bom.Viewport.getScrollLeft()+"x"+qx.bom.Viewport.getScrollTop());}
,this);}
}});}
)();
