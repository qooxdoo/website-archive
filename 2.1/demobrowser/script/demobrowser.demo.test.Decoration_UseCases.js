...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Decoration_UseCases.75cd72426f7d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="backgroundColor",i="demobrowser/demo/test/logo.gif",h="qx/decoration/Modern/cursors/alias.gif",g="scale",f="<div style='position:absolute;left:600px;top:1100px;font-size:36px;font-weight:bold;color:red'>Scaled Clipped Alpha PNG</div>",e="demobrowser/demo/test/demobrowser_thumb.png",d="41px",c="500px",b="136px",a="scale-y",T="qx/decoration/Modern/app-header.png",S="scale-x",R="qx/icon/Tango/22/places/folder-open.png",Q="<div style='position:absolute;left:600px;top:20px;font-size:36px;font-weight:bold;color:red'>Single PNG</div>",P="demobrowser/demo/test/alphaPNG.png",O="400px",N="qx/decoration/Modern/form/checkbox-focused.png",M="<div style='position:absolute;left:600px;top:230px;font-size:36px;font-weight:bold;color:red'>Clipped PNG</div>",L="120px",K="250px",r="15px",s="<div style='position:absolute;left:600px;top:1700px;font-size:36px;font-weight:bold;color:red'>Clipped GIF</div>",o="<div style='position:absolute;left:600px;top:1400px;font-size:36px;font-weight:bold;color:red'>Single GIF</div>",p="body",m="<div style='position:absolute;left:600px;top:650px;font-size:36px;font-weight:bold;color:red'>Repeated Single Alpha PNG</div>",n="orange",k="<div style='position:absolute;left:600px;top:880px;font-size:36px;font-weight:bold;color:red'>Repeated Clipped Alpha PNG</div>",l="demobrowser.demo.test.Decoration_UseCases",t="450px",u="230px",B="1700px",z="19px",E="420px",D="880px",G="650px",F="50px",w="1100px",J="350px",I="150px",H="1400px",v="repeat-x",x="20px",y="repeat-y",A="no-repeat",C="200px";qx.Class.define(l,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var bi=q(p);var V=T;var bl=e;var bh=P;var bj=R;var bk=N;var Y=i;var bm=h;var bu=qx.bom.element.Decoration;var bt=bu.create(V,A,{top:x});bi.append(bt);var bq=bu.create(V,v,{width:J,height:x,top:x,left:L});bi.append(bq);var br=bu.create(V,y,{width:x,height:C,top:x,left:c});bi.append(br);bi.append(q.create(Q));var bs=bu.create(bl,A,{top:u});bi.append(bs);var bc=bu.create(bl,y,{height:O,top:u,left:C});bi.append(bc);bi.append(q.create(M));var be=bu.create(bh,A,{top:G});bi.append(be);var ba=bu.create(bh,v,{width:J,top:G,left:F});bi.append(ba);var U=bu.create(bh,y,{height:C,top:G,left:E});bi.append(U);bi.append(q.create(m));var bs=bu.create(bj,A,{top:D});bi.append(bs);var bb=bu.create(bj,v,{width:J,top:D,left:F});bi.append(bb);var bc=bu.create(bk,y,{height:C,top:D,left:E});bi.append(bc);bi.append(q.create(k));var bd=bu.create(bk,g,{width:I,height:I,top:w});bi.append(bd);var bf=bu.create(bk,S,{width:C,top:w,left:C});bi.append(bf);var bg=bu.create(bk,a,{height:C,top:w,left:t});bi.append(bg);bi.append(q.create(f));var bo=bu.create(Y,A,{width:b,height:d,top:H});bi.append(bo);var X=bu.create(Y,v,{width:K,top:H,left:I});bi.append(X);var W=bu.create(Y,y,{height:C,top:H,left:t});bi.append(W);bi.append(q.create(o));var bn=bu.create(bm,A,{width:z,height:r,top:B});bi.append(bn);var bp=bu.create(bm,y,{width:z,height:C,top:B,left:F});bi.append(bp);bi.append(q.create(s));bi.setStyle(j,n);}
}});}
)();
