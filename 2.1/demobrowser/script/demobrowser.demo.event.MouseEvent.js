...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent.7cf5e7056e86.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.bom.Element.addListener(F,n,this.__QT,this);}
...
,this);}
,__QT:function(e){var J=e.getTarget().id.split("_")[1];var H=e.getTarget().checked;var I=document.getElementById("mouse");if(H){qx.bom.Element.addListener(I,J,this.logMouseEvent,this);}
