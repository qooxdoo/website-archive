...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.48d8d9204a8d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="groupBoxes",h="demobrowser.demo.bom.portal.box.Manager",g="boxData",f="qx.event.type.Event",e="boxes",d="demobrowser.demo.bom.portal.box.Box",c="_applyActiveBox",b="loaded",a="singleton";qx.Class.define(h,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__PR=[];this.__PS=[];this.__PT={};}
,statics:{dataKeyRoot:g,dataKeyGroupBoxes:m,dataKeyBoxes:e},events:{"loaded":f},properties:{activeBox:{init:null,check:d,apply:c}},members:{__PR:null,__PS:null,__PT:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);}
;n.setActive(true);}
...
,__bf:function(p){var t,w,u,v,x,p;var q=p[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var s=p[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in q){t=q[w];u=t.boxes;w=t.id;v={id:w,element:document.getElementById(w)};this.__PS.push(v);this.__PT[w]=[];for(var k=0,l=u.length;k<l;k++){p=s[u[k]];var r=document.getElementById(p.id);var x=new demobrowser.demo.bom.portal.box.Box(p,r,null,w);this.__PR.push(x);this.__PT[w].push(x);}
;}
;}
,getBoxes:function(){return this.__PR;}
,getGroupBoxes:function(){return this.__PS;}
,updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());qx.lang.Array.remove(this.__PT[z],A);qx.lang.Array.insertAt(this.__PT[y],A,B);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__PS.length,D;i<j;i++){D=this.__PT[this.__PS[i].id];for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__PS[i];}
;}
;}
;return null;}
},destruct:function(){this.__PR=this.__PS=this.__PT=null;}
});}
)();
(function(){var j="1px solid #444444",i="height",h="_applyActive",g="width",f="demobrowser.demo.bom.portal.box.Box",d="1px solid orange",c="String",b="border",a="Boolean";qx.Class.define(f,{extend:qx.core.Object,construct:function(k,l,m,n){qx.core.Object.call(this);this.__PU=k;this.__bV=k.id;if(l!=null){qx.bom.element.Style.set(l,g,k.width);qx.bom.element.Style.set(l,i,k.height);this.__PX(l,m);}
;this.setElement(l);this.setGroupBoxId(n);this.__PV=null;this.__PW=null;if(k.resizable){this.setResizable(true);var o={minWidth:parseInt(k.minWidth),minHeight:parseInt(k.minHeight),maxWidth:parseInt(k.maxWidth),maxHeight:parseInt(k.maxHeight),handles:k.resizeHandles};this.__PV=new demobrowser.demo.bom.portal.box.Resizable(this,o);}
;if(k.draggable){this.setDraggable(true);this.__PW=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__PY();}
,properties:{element:{init:null},groupBoxId:{init:null,check:c},active:{check:a,init:false,apply:h},resizable:{check:a,init:false},draggable:{check:a,init:false}},members:{__bV:null,__PU:null,__PW:null,__PV:null,_applyActive:function(p,q){if(p){qx.bom.element.Style.set(this.getElement(),b,d);}
else {qx.bom.element.Style.set(this.getElement(),b,j);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__PU;}
,getDraggableComponent:function(){return this.__PW;}
,getResizableComponent:function(){return this.__PV;}
,__PX:function(r,s){if(s){for(var t in s){qx.bom.element.Style.set(t,s[t]);}
;}
;qx.bom.element.Style.set(r,"position","relative");qx.bom.element.Style.set(r,"zIndex",0);qx.bom.Element.addListener(r,"click",this.__Qa,this,true);}
,__PY:function(){var v="This is a demo application showing the low-level capabilities."+" It does contain no UI widget code at all.";v=v+"<br/><br/>"+v+"<br/><br/>"+v;var u=qx.dom.Element.create("div",{"class":"box_content"});u.innerHTML=v;qx.dom.Element.insertEnd(u,this.getElement());}
,__Qa:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__PU=this.__PV=this.__PW=null;}
});}
)();
...
(function(){var s="south",r="mouseup",q="mousedown",p='px',o="width",n="Handle",m="height",l="px",k="east",j="orientation",c="demobrowser.demo.bom.portal.box.Resizable",i="southeast",g="mouseover",b="mouseout",a="visible",f="mousemove",d="hidden",h="visibility";qx.Class.define(c,{extend:qx.core.Object,construct:function(t,u){qx.core.Object.call(this);this.__Qb=t;this.__fX=this.__Qb.getElement();this.__Qc={};this.__Qd=false;this.__Qe={orientation:null,lastCoord:{left:null,top:null}};this.__Qf={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__Qf){if(u[name]){this.__Qf[name]=u[name];}
;}
;this.__PX();}
,members:{__Qe:null,__Qb:null,__fX:null,__Qc:null,__Qf:null,__Qd:false,getBox:function(){return this.__Qb;}
,__PX:function(){switch(this.__Qf.handles){case 1:this.__Qc.east=null;break;case 2:this.__Qc.south=null;break;case 3:this.__Qc.south=null;this.__Qc.southeast=null;this.__Qc.east=null;break;};for(var w in this.__Qc){var v=this.__Qc[w]=qx.dom.Element.create("div");qx.bom.element.Attribute.set(v,"orientation",w);qx.dom.Element.insertEnd(v,this.__fX);if(this.__fX.id){v.id=this.__fX.id+"_"+w;}
;this.__Qg(w);this.__Qh(w);}
;}
,__Qg:function(x){qx.bom.element.Class.add(this.__Qc[x],x+n);qx.bom.element.Style.set(this.__Qc[x],h,this.__Qf.autoHide?d:a);}
,__Qh:function(y){var A=qx.event.Registration;var z=this.__Qc[y];A.addListener(z,q,this.__Qk,this);A.addListener(document,r,this.__Ql,this);if(this.__Qf.autoHide){A.addListener(this.__Qb.getElement(),g,this.__Qi,this);A.addListener(this.__Qb.getElement(),b,this.__Qj,this);}
;}
,__Qi:function(e){for(var B in this.__Qc){qx.bom.element.Style.set(this.__Qc[B],h,a);}
;}
,__Qj:function(e){if(!this.__Qd){for(var C in this.__Qc){qx.bom.element.Style.set(this.__Qc[C],h,d);}
;}
;}
,__Qk:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,f,this.__Qm,this,true);this.__Qd=true;var D=e.getTarget();this.__Qe.orientation=qx.bom.element.Attribute.get(D,j);this.__Qe.lastCoord.left=e.getDocumentLeft();this.__Qe.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__fX);}
;}
,__Ql:function(e){e.stopPropagation();if(this.__Qd){qx.event.Registration.removeListener(document,f,this.__Qm,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__fX);if(this.__Qf.autoHide){for(var E in this.__Qc){qx.bom.element.Style.set(this.__Qc[E],h,d);}
;}
;this.__Qd=false;qx.bom.Selection.clear(document.body);}
;}
,__Qm:function(e){e.stopPropagation();if(this.__Qd){var F={left:null,top:null};switch(this.__Qe.orientation){case s:F.top=e.getDocumentTop();break;case i:F.top=e.getDocumentTop();F.left=e.getDocumentLeft();break;case k:F.left=e.getDocumentLeft();break;};this.__Qn(F,this.__Qe.lastCoord);this.__Qe.lastCoord.left=e.getDocumentLeft();this.__Qe.lastCoord.top=e.getDocumentTop();}
;}
,__Qn:function(G,H){var O=qx.bom.element.Dimension;var L=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Qb.getId());var N=O.getContentSize(L.element);if(G.left){var K=G.left-H.left;if(K!==0){var J=O.getContentWidth(this.__fX)+K;var M=O.getWidth(this.__fX)+K;if((this.__Qf.minWidth==null||J>this.__Qf.minWidth)&&(this.__Qf.maxWidth==null||J<=this.__Qf.maxWidth)){if(N.width>=M){qx.bom.element.Style.set(this.__fX,o,J+p);this.__Qb.getData().width=J;}
;}
;}
;}
;if(G.top){var K=G.top-H.top;if(K!==0){var I=O.getContentHeight(this.__fX)+K;if((this.__Qf.minHeight==null||I>this.__Qf.minHeight)&&(this.__Qf.maxHeight==null||I<=this.__Qf.maxHeight)){qx.bom.element.Style.set(this.__fX,m,I+l);}
;}
;}
;}
},destruct:function(){if(this.__Qf.autoHide){qx.event.Registration.removeListener(this.__Qb.getElement(),g,this.__Qi,this);qx.event.Registration.removeListener(this.__Qb.getElement(),b,this.__Qj,this);}
;this.__Qb=this.__Qf=this.__fX=this.__Qc=null;this.__Qe=null;}
});}
)();
...
(function(){var c="auto",b="demobrowser.demo.bom.portal.box.Util",a="zIndex";qx.Class.define(b,{statics:{__Qo:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,a);e=e==c?0:e;qx.bom.element.Style.set(d,a,e+this.__Qo);}
,sendToBack:function(f){var g=qx.bom.element.Style.get(f,a);qx.bom.element.Style.set(f,a,g-this.__Qo);}
}});}
)();
...
(function(){var o="engine.name",n="mousedown",m="mouseover",l="drag",k="dragend",j="div",i="move",h="dragHandle",g="demobrowser.demo.bom.portal.box.Draggable",f="cursor",b="html",d="mousemove",c="mouseup",a="dragstart";qx.Class.define(g,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.__Qb=p;this.__fX=p.getElement();this.__Qp=null;this.__Qq=null;this.__PX();}
,members:{__Qb:null,__fX:null,__Qp:null,__Qq:null,getBox:function(){return this.__Qb;}
,getElement:function(){return this.__fX;}
,__PX:function(){this.__Qr();this.__Qh();}
,__Qr:function(){this.__Qp=qx.dom.Element.create(j);qx.bom.element.Class.add(this.__Qp,h);qx.dom.Element.insertBegin(this.__Qp,this.__fX);}
,__Qh:function(){qx.bom.Element.addListener(this.__Qp,n,this.__kO,this);qx.bom.Element.addListener(this.__Qp,m,function(e){qx.bom.element.Style.set(this,f,i);}
,this.__Qp);qx.bom.Element.addListener(this.__Qp,a,this.__Nb,this);qx.bom.Element.addListener(this.__Qp,k,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__Qp,l,this.__Qu,this);}
,__kO:function(e){if(e.isLeftPressed()){this.__Qq={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__fX),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__fX)};qx.bom.Element.addListener(document.body,c,this.__Qt,this,true);this.__Qs();qx.event.Registration.fireEvent(this.__Qp,a,qx.event.type.Event);}
;}
,__Qs:qx.core.Environment.select(o,{"mshtml":function(){var r=this;var q=qx.lang.Function.bind(this.__Qt,r);document.getElementsByTagName(b)[0].onmouseleave=q;}
,"default":(function(){}
)}),__Qt:function(e){try{e.stopPropagation();}
catch(s){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,d,this.__Qu,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,c,this.__Qt,this,true);}
,__Nb:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__Qb);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__Qb);qx.event.Registration.addListener(document.body,d,this.__Qu,this,true);}
,__Qu:function(e){e.stopPropagation();var t=e.getDocumentLeft()-this.__Qq.left;var top=e.getDocumentTop()-this.__Qq.top;qx.event.Timer.once(function(){this.checkGroupBox(t,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,t);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__Qb=this.__Qp=this.__fX=this.__Qq=null;}
});}
)();
(function(){var m="Boolean",l="left",k="demobrowser.demo.bom.portal.dragdrop.Manager",h="end",g="border",f="top",d="demobrowser.demo.bom.portal.box.Box",c="ease-out",b="singleton",a="px";qx.Class.define(k,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Qv={top:null,height:null};this.__Qw={top:0,left:0};}
,properties:{activeBox:{check:d,init:null,nullable:true},sessionActive:{check:m,init:false}},members:{__Qv:null,__Qx:null,__Qy:false,__Qw:null,__Qz:null,__QA:null,startSession:function(n){this.setSessionActive(true);this.setActiveBox(n);this.__Qx=n.getGroupBoxId();this.__QB();if(this.__Qz==null){this.__Qz={};var o=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=o.length;i<j;i++){this.__Qz[o[i].element.id]={left:qx.bom.element.Location.getLeft(o[i].element),right:qx.bom.element.Location.getLeft(o[i].element)+qx.bom.element.Dimension.getWidth(o[i].element)};}
;}
;}
,__QB:function(){if(!this.__QA){this.__QA=qx.dom.Element.create("div");}
;var r=this.getActiveBox().getElement();var p=qx.bom.element.Dimension.getContentSize(r);this.__QC(r,this.__QA);qx.bom.element.Class.add(this.__QA,qx.bom.element.Class.get(r));var q="opacity:0.5;margin:0;position:absolute;"+"top:"+qx.bom.element.Location.getTop(r)+"px;"+"left:"+qx.bom.element.Location.getLeft(r)+"px;"+"width:"+p.width+"px;"+"height:"+p.height+"px";qx.bom.element.Style.setCss(this.__QA,q);qx.bom.element.Style.set(r,"border","1px dashed red");qx.dom.Node.getBodyElement(r).appendChild(this.__QA);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__QA);}
,__QC:function(s,t){while(s.firstChild){t.appendChild(s.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var y=this.getActiveBox();var v=y.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(y.getGroupBoxId(),this.__Qx,y);y.setGroupBoxId(this.__Qx);var x={left:qx.bom.element.Location.getLeft(this.__QA)+a,top:qx.bom.element.Location.getTop(this.__QA)+a};var w={left:qx.bom.element.Location.getLeft(v)+a,top:qx.bom.element.Location.getTop(v)+a};var z={timing:c,duration:300,keep:100,keyFrames:{'0':x,'100':w}};var u=qx.bom.element.Animation.animate(this.__QA,z);u.addListener(h,function(){this.__QC(this.__QA,v);qx.bom.element.Style.reset(v,g);this.__QA.parentNode.removeChild(this.__QA);if(y.isActive()){y._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(y);}
;}
,this);}
,onDragMove:function(top,A){if(this.__Qw.left!=A){qx.bom.element.Style.set(this.__QA,l,A+a);}
;if(this.__Qw.top!=top){qx.bom.element.Style.set(this.__QA,f,top+a);}
;var B=this.getActiveBox().getElement();if(this.__Qv.top==null){this.__Qv.top=qx.bom.element.Location.getTop(B);}
;if(this.__Qv.height==null){this.__Qv.height=qx.bom.element.Dimension.getHeight(B);}
;if(this.__Qy==false&&top>=this.__Qv.top&&top<=(this.__Qv.top+this.__Qv.height)){return;}
;var C;if(this.__Qy){C=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__Qx));while(C!=null){if(this.__QD(true,top,B,C)){this.__Qy=false;return;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {C=B;}
;if(top-this.__Qw.top>0){C=qx.dom.Hierarchy.getNextElementSibling(C);while(C!=null){if(C){if(this.__QD(true,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {var C=qx.dom.Hierarchy.getPreviousElementSibling(C);while(C!=null){if(C){if(this.__QD(false,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getPreviousElementSibling(C);}
;}
;this.__Qw.left=A;this.__Qw.top=top;}
,__QD:function(D,top,E,F){var G=qx.bom.element.Location.getTop(F);var I=parseInt(qx.bom.element.Style.get(F,"paddingTop"));var J=parseInt(qx.bom.element.Style.get(F,"paddingBottom"));var H=qx.bom.element.Dimension.getContentHeight(F)+J+I;var K;if(D){if(top>=(G+(H/3))){K=qx.dom.Hierarchy.getNextElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertAfter(E,F);this.__Qv.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
else {if(top<=(G+H*2/3)){K=qx.dom.Hierarchy.getPreviousElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertBefore(E,F);this.__Qv.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
;return false;}
,checkGroupBox:function(L,M){if(this.__Qz[this.__Qx].left<=L&&this.__Qz[this.__Qx].right>=L){return;}
;for(var N in this.__Qz){if(N!=this.__Qx){if(this.__Qz[N].left<=L+M&&this.__Qz[N].right>=L){this.__Qx=N;this.__Qy=true;return;}
;}
;}
;}
},destruct:function(){this.__Qv=this.__Qw=this.__Qx=null;this.__QE=this.__QA=this.__Qz=null;}
});}
)();
