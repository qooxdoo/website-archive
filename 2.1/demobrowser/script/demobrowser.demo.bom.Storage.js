...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.8eef09f0c835.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="<em>no content</em>",q="Memory Storage",p="html.storage.userdata",o="list",n="save",m="value",l="Web Storage",k="demobrowser.demo.bom.Storage",j="<br>",i="userData Storage",c="clear",h="html.storage.local",f=":",b="using",a="remove",e="key",d="",g="click";qx.Class.define(k,{extend:qx.application.Native,members:{__eR:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__eR=qx.bom.Storage.getLocal();var t=document.getElementById(n);var s=document.getElementById(c);var u=document.getElementById(a);var self=this;qx.bom.Event.addNativeListener(t,g,function(){var w=qx.bom.Input.getValue(document.getElementById(e));var v=qx.bom.Input.getValue(document.getElementById(m));self.__eR.setItem(w,v);self.updateList();}
);qx.bom.Event.addNativeListener(s,g,function(){self.__eR.clear();self.updateList();}
);qx.bom.Event.addNativeListener(u,g,function(){self.__eR.removeItem(self.__eR.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var x=document.getElementById(o);x.innerHTML=d;this.__eR.forEach(function(y,z){x.innerHTML+=y+f+z+j;}
...
(function(){var c="qx.bom.Storage",b="html.storage.local",a="html.storage.userdata";qx.Bootstrap.define(c,{statics:{__zl:null,getLocal:function(){if(qx.core.Environment.get(b)){return qx.bom.storage.Web.getLocal();}
...
(function(){var d="local",c="session",b="Storage",a="qx.bom.storage.Web";qx.Bootstrap.define(a,{statics:{__zm:null,__zn:null,getLocal:function(){if(this.__zm){return this.__zm;}
;return this.__zm=new qx.bom.storage.Web(d);}
,getSession:function(){if(this.__zn){return this.__zn;}
;return this.__zn=new qx.bom.storage.Web(c);}
},construct:function(f){this.__nh=f;}
,members:{__nh:null,getStorage:function(){return window[this.__nh+b];}
,getLength:function(){return this.getStorage(this.__nh).length;}
,setItem:function(g,h){h=qx.lang.Json.stringify(h);try{this.getStorage(this.__nh).setItem(g,h);}
catch(e){throw new Error("Storage full.");}
;}
,getItem:function(j){var k=this.getStorage(this.__nh).getItem(j);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(l){this.getStorage(this.__nh).removeItem(l);}
,clear:function(){var m=this.getStorage(this.__nh);if(!m.clear){for(var i=m.length-1;i>=0;i--){m.removeItem(m.key(i));}
;}
else {m.clear();}
;}
,getKey:function(n){return this.getStorage(this.__nh).key(n);}
,forEach:function(o,p){var length=this.getLength();for(var i=0;i<length;i++){var q=this.getKey(i);o.call(p,q,this.getItem(q));}
;}
}});}
)();
(function(){var k="session",j="head",h="none",g="qx.bom.storage.UserData",f="div",e="local",d="qxtest",c="#default#userdata",b="display",a="qx";qx.Bootstrap.define(g,{statics:{__zm:null,__zn:null,__bV:0,getLocal:function(){if(this.__zm){return this.__zm;}
;return this.__zm=new qx.bom.storage.UserData(e);}
,getSession:function(){if(this.__zn){return this.__zn;}
;return this.__zn=new qx.bom.storage.UserData(k);}
},construct:function(l){this.__zo=document.createElement(f);this.__zo.style[b]=h;document.getElementsByTagName(j)[0].appendChild(this.__zo);this.__zo.addBehavior(c);this.__zp=l;this.__zo.load(this.__zp);this.__eR={};this.__zq={};var m=this.__zo.getAttribute(a+qx.bom.storage.UserData.__bV);while(m!=undefined){m=qx.lang.Json.parse(m);this.__eR[m.key]=m.value;this.__zq[m.key]=a+qx.bom.storage.UserData.__bV;qx.bom.storage.UserData.__bV++;m=this.__zo.getAttribute(a+qx.bom.storage.UserData.__bV);}
;}
,members:{__zo:null,__zp:d,__eR:null,__zq:null,getStorage:function(){return this.__eR;}
,getLength:function(){return Object.keys(this.__eR).length;}
,setItem:function(n,o){if(this.__zq[n]){var p=this.__zq[n];}
else {var p=a+qx.bom.storage.UserData.__bV;qx.bom.storage.UserData.__bV++;}
;var q=qx.lang.Json.stringify({key:n,value:o});this.__zo.setAttribute(p,q);this.__zo.save(this.__zp);this.__eR[n]=o;this.__zq[n]=p;}
,getItem:function(r){return this.__eR[r]||null;}
,removeItem:function(s){var v=this.__zq[s];if(v==undefined){return;}
;this.__zo.removeAttribute(v);qx.bom.storage.UserData.__bV--;delete this.__eR[s];delete this.__zq[s];var u=a+qx.bom.storage.UserData.__bV;if(this.__zo.getAttribute(u)){var w=this.__zo.getAttribute(a+qx.bom.storage.UserData.__bV);this.__zo.removeAttribute(u);this.__zo.setAttribute(v,w);var t=qx.lang.Json.parse(w).key;this.__zq[t]=v;}
;this.__zo.save(this.__zp);}
,clear:function(){for(var x in this.__zq){this.__zo.removeAttribute(this.__zq[x]);}
;this.__zo.save(this.__zp);this.__eR={};this.__zq={};}
,getKey:function(y){return Object.keys(this.__eR)[y];}
,forEach:function(z,A){var length=this.getLength();for(var i=0;i<length;i++){var B=this.getKey(i);z.call(A,B,this.getItem(B));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__zm:null,__zn:null,getLocal:function(){if(this.__zm){return this.__zm;}
;return this.__zm=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__zn){return this.__zn;}
;return this.__zn=new qx.bom.storage.Memory();}
},construct:function(){this.__eR={};}
,members:{__eR:null,getStorage:function(){return this.__eR;}
,getLength:function(){return Object.keys(this.__eR).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__eR[b]=c;}
,getItem:function(d){var e=this.__eR[d];if(qx.lang.Type.isString(e)){e=qx.lang.Json.parse(e);}
;return e;}
,removeItem:function(f){delete this.__eR[f];}
,clear:function(){this.__eR={};}
,getKey:function(g){var h=Object.keys(this.__eR);return h[g];}
