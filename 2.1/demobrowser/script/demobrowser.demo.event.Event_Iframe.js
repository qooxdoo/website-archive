...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Iframe.f94e30d86974.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="inner",m="div",l="juhu",k="contextmenu",j="input",h="load",g="keydown",f="demobrowser.demo.event.Event_Iframe",d="data/Event_2_frame.html",c="scroll",a="iframe",b="click";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var o=qx.bom.Iframe.create({name:a,src:d});o.id=a;document.body.appendChild(o);qx.event.Registration.addListener(o,h,this.bindIFrameEvents,this);}
,bindIFrameEvents:function(){var r=window.document.getElementById(a);var q=qx.bom.Iframe.getDocument(r);this._juhu=q.getElementById(l);this._inner=q.getElementById(n);qx.event.Registration.addListener(this._juhu,k,this._preventDefault,this);qx.event.Registration.addListener(this._inner,b,this._stopPropagation,this);qx.event.Registration.addListener(this._juhu,b,this._onclick1,this);qx.event.Registration.addListener(this._juhu,b,this._onclick2,this);qx.event.Registration.addListener(q.getElementById(j),g,this._onkeydown,this);for(var i=1;i<10;i++){var p=q.getElementById(m+i);qx.event.Registration.addListener(p,b,this._cascadeCapture,this,true);qx.event.Registration.addListener(p,b,this._cascadeBubble,this,false);}
;qx.event.Registration.addListener(q.getElementById(c),c,this._scroll,this);}
,_onkeydown:function(e){this.debug("keydown: "+e.getKeyIdentifier());}
,_scroll:function(e){this.debug("scroll");}
,_cascadeCapture:function(e){var s=e.getCurrentTarget();this.debug("capture: "+s.id+" "+e.getEventPhase());}
,_cascadeBubble:function(e){var t=e.getCurrentTarget();this.debug("bubble: "+t.id+" "+e.getEventPhase());}
,_preventDefault:function(e){this.debug(e.getType()+": "+e);e.preventDefault();}
,_stopPropagation:function(e){this.debug(e.getType()+" (inner): "+e);e.stopPropagation();}
,_onclick1:function(e){this.debug(e.getType()+" 1: "+e);qx.event.Registration.removeListener(this._juhu,b,this._onclick1);}
