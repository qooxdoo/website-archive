...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea.a122e615ce72.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="white",u="350px",t='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',s="demobrowser.demo.bom.HtmlArea",r="traditional web pages / single-page applications.<br/> ",p="innerHTML",o="<p>This low-level widget can be used separately at ",n="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",m="blank.html",l="20px 20px",c="You can play around with this widget by hitting the ",k="<h1>HtmlArea low-level widget</h1>",g="buttons at the toolbar.</p>",b="It is the foundation for the UI widget component.</p>",a="1px solid #AAA",f="840px",d="div",h="0px";qx.Class.define(s,{extend:qx.application.Native,members:{__Fc:null,__PO:null,__PP:null,__NC:null,__kP:null,main:function(){qx.application.Native.prototype.main.call(this);this.__Fc=qx.dom.Element.create(d);qx.bom.element.Style.setStyles(this.__Fc,{margin:l});var y=qx.dom.Element.create(d);qx.bom.element.Style.setStyles(y,{width:f,padding:h,margin:h});var x=k+o+r+b+n+c+g;qx.bom.element.Attribute.set(y,p,x);this.__PO=qx.dom.Element.create(d);qx.bom.element.Style.setStyles(this.__PO,{width:f,padding:h,margin:h,lineHeight:h,border:a});this.__PP=qx.dom.Element.create(d);qx.bom.element.Style.setStyles(this.__PP,{width:f,height:u,border:a,borderTop:h,backgroundColor:v});qx.dom.Element.insertEnd(this.__PP,this.__Fc);var w=t;this.__NC=new qx.bom.htmlarea.HtmlArea(this.__PP,w,null,m);this.__NM();qx.dom.Element.insertBegin(this.__PO,this.__Fc);qx.dom.Element.insertBegin(y,this.__Fc);qx.dom.Element.insertBegin(this.__Fc,document.body);}
,__PQ:function(e){var z=window.prompt("FontSize: ","");this.setFontSize(parseInt(z));}
,__ND:function(e){var A=window.prompt("Color (Hex): ","#");this.setTextColor(A);}
,__NE:function(e){var B=window.prompt("BgColor (Hex): ","#");this.setTextBackgroundColor(B);}
,__NF:function(e){var C={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};this.insertImage(C);}
,__NG:function(e){var D="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";this.insertHtml(D);}
,__NH:function(e){var E=window.prompt("Link: ","http://");this.insertHyperLink(E);}
,__NI:function(e){var F=window.prompt("HTML Code:","");this.insertHtml(F);}
,__NJ:function(){var H=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(H,{"float":"left"});var J;var I=qx.dom.Element.create("select",{title:"Change font family"});if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(I,"hideFocus","true");}
else {qx.bom.element.Style.set(I,"outline","none");}
;J=q.create("<option value=''></option>");qx.dom.Element.insertEnd(J[0],I);var K=["Tahoma","Verdana","Times New Roman","Arial","Arial Black","Courier New","Courier","Georgia","Impact","Comic Sans MS","Lucida Console"];var G;var L;for(var i=0,j=K.length;i<j;i++){G="<option qxKeepFocus='on' qxSelectable='off'"+"value='"+K[i]+"'>"+K[i]+"</option>";L=q.create(G);if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(L[0],"hideFocus","true");}
else {qx.bom.element.Style.set(L[0],"outline","none");}
;qx.dom.Element.insertEnd(L[0],I);}
;qx.event.Registration.addListener(I,"change",function(e){var M=e.getTarget();var N=M.selectedIndex;if(N!=0){this.setFontFamily(M.options[N].value);M.options[0].selected=true;}
;}
,this.__NC);qx.dom.Element.insertBegin(I,H);return H;}
,__NK:function(){var P=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(P,{"marginRight":"16px","float":"left"});var R;var Q=qx.dom.Element.create("select",{title:"Change font size"});if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(Q,"hideFocus","true");}
else {qx.bom.element.Style.set(Q,"outline","none");}
;R=q.create("<option value=''></option>");qx.dom.Element.insertEnd(R[0],Q);var S;var O;for(var i=1;i<=7;i++){O="<option qxKeepFocus='on' qxSelectable='off' "+"value='"+i+"'>"+i+"</option>";S=q.create(O);if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(S[0],"hideFocus","true");}
else {qx.bom.element.Style.set(S[0],"outline","none");}
;qx.dom.Element.insertEnd(S[0],Q);}
;qx.event.Registration.addListener(Q,"change",function(e){var T=e.getTarget();var U=T.selectedIndex;if(U!=0){this.setFontSize(T.options[U].value);T.options[0].selected=true;}
;}
,this.__NC);qx.dom.Element.insertBegin(Q,P);return P;}
,__NM:function(){var W=[{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__NC.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__NC.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__NC.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__NC.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__NC.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__NC.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__NC.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__NC.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__NC.setJustifyFull}},{fontFamily:{custom:this.__NJ},fontSize:{custom:this.__NK},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__ND},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__NE}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__NC.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__NC.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__NF},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__NG},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__NH},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__NI},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__NC.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__NC.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__NC.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__NC.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__NC.redo}}];var Y,bd,V,bb;for(var i=0,j=W.length;i<j;i++){bd={};bd["marginRight"]=i==j-1?"0px":"16px";bd["float"]="left";Y=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(Y,bd);for(var ba in W[i]){var bc=W[i][ba];if(bc.custom){V=bc.custom.call(this);}
else {var X=qx.util.AliasManager.getInstance().resolve(bc.image);bb={type:"image",src:qx.util.ResourceManager.getInstance().toUri(X),title:bc.text,qxKeepFocus:"on",qxSelectable:"off"};V=qx.dom.Element.create("input",bb);qx.bom.element.Style.setStyles(V,{width:"16px",height:"16px",padding:"4px"});if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(V,"hideFocus","true");}
else {qx.bom.element.Style.set(V,"outline","none");}
;qx.event.Registration.addListener(V,"click",bc.action,this.__NC);}
;qx.dom.Element.insertEnd(V,Y);}
;qx.dom.Element.insertEnd(Y,this.__PO);}
;qx.dom.Element.insertEnd(qx.dom.Element.create("br",{style:"clear:both"}),this.__PO);}
}});}
)();
(function(){var cP="qx.blankpage",cO="li",cN="xhtml",cM='undo',cL="div",cK="textbackgroundcolor",cJ="Function",cI="home",cH="<",cG="focused",bP="load",bO="mouseup",bN="setUnderline",bM="<br /><div id='placeholder'></div>",bL="<!--",bK="transparent",bJ="'>",bI="insertimage",bH='bold',bG="&copy;",cW="ul",cX="cursorContext",cU=" />",cV="style",cS="setBold",cT="<P>&nbsp;</P>",cQ="</",cR="&gt;",cY='="',da="__Ap",cp="click",co="inserthorizontalrule",cr='</head>',cq='<head>',ct="textcolor",cs="a",cv="&amp;",cu="removeformat",cn="ready",cl="<p>&nbsp;</p>",o="outline",p="insertorderedlist",q="span",r="> ",t="hideFocus",u="keypress",v="none",w="setItalic",x="font-style",y="focusOut",dp="justifyleft",dn="Please use the method 'qx.dom.Node.isBlockNode' instead.",dm="placeholder",dl='size',dt="keyup",ds="Control",dr=" { ",dq="font-weight",dv='italic',du="styleWithCSS",bg='</style>',bh="focus",be="&quot;",bf="STYLE",bk="justifyfull",bl='underline',bi="inserthyperlink",bj="<br />",bc='<style type="text/css">',bd="<br>",O="justifycenter",N="useCSS",Q="object",P="strikethrough",K="blur",J="true",M="1.9",L=' style="',I="indent",H="messengerContent",bq="Integer",br="insertunorderedlist",bs="Text",bt="&lt;",bm='</body></html>',bn='<br/><div class="placeholder"></div>',bo="selectall",bp=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",bu="justifyright",bv="ol",Y="//text()[string-length(normalize-space(.))>0]",X="outdent",W="about:blank",V="<body style='",U="qx.bom.htmlarea.HtmlArea",T="keydown",S="loadingError",R="Verdana",bb="focusout",ba="$",bw="-->",bx=" }",by="Off",bz="backgroundcolor",bA="end",bB="redo",bC="i",bD="backspace",bE="bold",bF="p",bT="inserthtml",bS="down",bR="100%",bQ="k",bX=":",bW='redo',bV="y",bU="font-family",ca="g",bY=";",ch="fontsize",ci="undo",cf="pageup",cg="text-decoration",cd="pagedown",ce="center",cb="u",cc="backgroundimage",cj="up",ck="font-size",cz="None",cy="control",cB="'",cA="delete",cD="_moz_dirty",cC=">",cF="line-through",cE="String",cx="fontfamily",cw="justify",dh="contextmenu",di="z",dj="engine.version",dk="br",dd="italic",de="body",df="underline",dg="old_id",db="b",dc="enter",n='"',m="text-align",l="right",k="qx.bom.htmlarea.HtmlArea.debug",h="left",g="qx.debug",f="qx.event.type.Data",d="opera",c="id",b="qx.event.type.Event",B=" ",C="Boolean",z="__elementToFocus__",A="webkit",F="gecko",G="mshtml",D="",E="engine.name";qx.Class.define(U,{extend:qx.core.Object,construct:function(dw,dx,dy,dz){qx.core.Object.call(this);var dA=dz||qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(cP));this.__AG(dw);this.__AH();this._createAndAddIframe(dA);this._addIframeLoadListener();this.__Ao=qx.bom.htmlarea.HtmlArea.__Aq(dy);if(qx.lang.Type.isString(dx)){this.__Aa=dx;}
;this.__Ap=this.__AT();}
,events:{"load":b,"loadingError":f,"messengerContent":f,"cursorContext":f,"ready":b,"readyAfterInvalid":b,"focused":b,"focusOut":b,"contextmenu":f,"undoRedoState":f},statics:{simpleLinebreak:bd,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:cS},italic:{method:w},underline:{method:bN},undo:{method:ci},redo:{method:bB}},__Aq:function(dB){if(dB==null||dB==D){return D;}
else if(typeof dB==Q){var dC=D;for(var i in dB){dC+=i+dr+dB[i]+bx;}
;return dC;}
else {return dB;}
;}
,__Ar:function(dD){var dE={};var a=dD.split(bY);var i;for(i=0;i<a.length;i++){var dF=a[i],dG=dF.indexOf(bX);if(dG===-1){continue;}
;var name=dF.substring(0,dG).trim();var dH=dF.substring(dG+1,dF.length).trim();if(name&&dH){dE[name]=dH;}
;}
;return dE;}
,__As:function(dI,dJ,dK,dL){var dQ=[];switch(dI.nodeType){case 1:case 11:var i;var dO=dI.tagName.toLowerCase();var dS={};var dM={};var closed=(!(dI.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__At(dI)));if(dJ){if((qx.core.Environment.get(E)==G)){if(dO==cL&&dI.className&&dI.className==dm){for(i=dI.firstChild;i;i=i.nextSibling){dQ.push(qx.bom.htmlarea.HtmlArea.__As(i,true,dK,dL));}
;return dQ.join(D);}
;}
;var dR=dI.attributes;var dP=dR.length;var a;if((qx.core.Environment.get(E)==F)){if(dO==q&&dP==1&&dR[0].name==cD&&dI.childNodes.length==0){return D;}
;}
;for(i=0;i<dP;i++){a=dR[i];if(!a.specified){continue;}
;var name=qx.dom.Node.getName(a);var dT=a.nodeValue;if(/(_moz|contenteditable)/.test(name)){continue;}
;if(name!=cV){if(qx.core.Environment.get(E)==G){if(name==c&&dI.getAttribute(dg)){dT=dI.getAttribute(dg);}
else if(!isNaN(dT)){dT=dI.getAttribute(name);}
else {dT=a.nodeValue;}
;}
else {dT=a.nodeValue;}
;}
else {dT=dI.style.cssText;}
;if(/(_moz|^$)/.test(dT)){continue;}
;if(name==dg){continue;}
;if(!dT){continue;}
;if(name==c&&dT==z){continue;}
;if(name.charAt(0)===ba){continue;}
;dS[name]=dT;}
;if(dS.style!==undefined){dM=qx.bom.htmlarea.HtmlArea.__Ar(dS.style);delete dS.style;}
;if(dL){var dN={domElement:dI,tag:dO,attributes:dS,styles:dM};dL(dN);dN.domElement=null;dO=dN.tag;}
;if(dO){dQ.push(cH,dO);for(var name in dS){var dT=dS[name];dQ.push(B,name,cY,dT.toString().replace(new RegExp(n,ca),cB),n);}
;if(!qx.lang.Object.isEmpty(dM)){dQ.push(L);for(var name in dM){var dT=dM[name];dQ.push(name,bX,dT.toString().replace(new RegExp(n,ca),cB),bY);}
;dQ.push(n);}
;dQ.push(closed?cU:cC);}
;}
;for(i=dI.firstChild;i;i=i.nextSibling){dQ.push(qx.bom.htmlarea.HtmlArea.__As(i,true,dK,dL));}
;if(dJ&&!closed&&dO){dQ.push(cQ,dO,cC);}
;break;case 3:dQ.push(dK?dI.data:qx.bom.htmlarea.HtmlArea.__Au(dI.data));break;case 8:dQ.push(bL,dI.data,bw);break;};return dQ.join(D);}
,closingTags:bp,__At:function(dU){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(B+dU.tagName+B)!=-1);}
,__Au:function(s){s=s.replace(/&/ig,cv);s=s.replace(/</ig,bt);s=s.replace(/>/ig,cR);s=s.replace(/\x22/ig,be);s=s.replace(/\xA9/ig,bG);return s;}
,isBlockNode:function(dV){var dW=qx.bom.htmlarea.HtmlArea.isBlockNode;var dX=dn;qx.log.Logger.deprecatedMethodWarning(dW,dX);return qx.dom.Node.isBlockNode(dV);}
,isParagraphParent:function(dY){if(!qx.dom.Node.isElement(dY)){return false;}
;dY=qx.dom.Node.getName(dY);return /^(body|td|th|caption|fieldset|div)$/.test(dY);}
,isHeadlineNode:function(ea){if(!qx.dom.Node.isElement(ea)){return false;}
;var eb=qx.dom.Node.getName(ea);return /^h[1-6]$/.test(eb);}
},properties:{contentType:{check:cE,init:cN},messengerMode:{check:C,init:false},insertParagraphOnLinebreak:{check:C,init:true},insertLinebreakOnCtrlEnter:{check:C,init:true},postProcess:{check:cJ,nullable:true,init:null},useUndoRedo:{check:C,init:true},nativeContextMenu:{check:C,init:false},defaultFontFamily:{check:cE,init:R},defaultFontSize:{check:bq,init:4}},members:{__kP:null,__dc:false,__Av:false,__Aw:false,__Ax:false,__Ay:false,__Ap:null,__Az:null,__AA:null,__AB:null,__pm:null,__Ao:null,__AC:null,__AD:null,__AE:false,__AF:false,__AG:function(ec){if(qx.dom.Node.isElement(ec)&&qx.dom.Node.isNodeName(ec,"div")){this.__kP=ec;}
;}
,_createAndAddIframe:function(ed){this.__pm=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__pm,ed);if((qx.core.Environment.get(E)==G)){qx.bom.element.Attribute.set(this.__pm,t,J);}
else {qx.bom.element.Style.set(this.__pm,o,v);}
;qx.bom.element.Style.setStyles(this.__pm,{width:bR,height:bR});qx.dom.Element.insertBegin(this.__pm,this.__kP);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__pm);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__pm);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__pm,bP,this._loaded,this);}
,__AH:function(){this.__AC={"xhtml":{doctype:'<!'+'DOCTYPE html PUBLIC "-/'+'/W3C/'+'/DTD XHTML 1.0 Transitional/'+'/EN" "http:/'+'/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',html:'<html xmlns="http:/'+'/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',meta:'<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',style:qx.core.Environment.select("engine.name",{"mshtml":'html { margin:0px; padding:0px; } '+'body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ',"default":'html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } '+'body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } '}),contentStyle:'p { margin:0px; padding:0px; }',body:'<body>',footer:'</body></html>'}};}
,__Aa:D,getIframeObject:function(){return this.__pm;}
,getCommandManager:function(){return this.__Ap;}
,setValue:function(ee){if(qx.lang.Type.isString(ee)){this.__Aa=ee;var ef=this._getIframeDocument();if(ef&&ef.body){ef.body.innerHTML=this.__AI(ee);}
;}
;}
,__AI:function(eg){var ej="";if((qx.core.Environment.get("engine.name")=="gecko")){if(qx.core.Environment.get("browser.version")<=2){ej+='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>';}
;}
;var ek=eg.length==0?"\ufeff":"";var ei=qx.core.Environment.get("engine.name")=="gecko"||qx.core.Environment.get("engine.name")=="webkit"?'id="__elementToFocus__"':'';var eh='<p>'+'<span style="font-family:'+this.getDefaultFontFamily()+'">'+'<font '+ei+' size="'+this.getDefaultFontSize()+'">'+ej+eg+ek+'</font>'+'</span>'+'</p>';return eh;}
,getValue:function(){return this.__Aa;}
,getComputedValue:function(em){return this.getHtml(em);}
,getCompleteHtml:function(){var eo=this.__AC[this.getContentType()];var en=eo.html+cq+eo.meta+bc+eo.contentStyle+bg+cr;en+=V+this.__AJ()+bJ;en+=this.getHtml()+bm;return en;}
,__AJ:function(){var er=["backgroundColor","backgroundImage","backgroundRepeat","backgroundPosition","fontFamily","fontSize","marginTop","marginBottom","marginLeft","marginRight","paddingTop","paddingBottom","paddingLeft","paddingRight"];var eq=qx.bom.element.Style;var ep=this.getContentBody();var eu={};var et,ev;var es=qx.core.Environment.get("engine.name")=="mshtml"?2:1;for(var i=0,j=er.length;i<j;i++){et=er[i];ev=eq.get(ep,et,es);if(ev!==undefined&&ev!=""){eu[et]=ev;}
;}
;return qx.bom.element.Style.compile(eu);}
...
;}
,getWords:function(ew){if(!ew){ew=this.getContentBody();}
;if(!ew){return [];}
;var ez=ew.cloneNode(true);var eB=ez.innerHTML;eB=eB.replace(/>/gi,r);eB=eB.replace(/\n/gi,B);eB=eB.replace(/<!--.*-->/gi,D);ez.innerHTML=eB;var ey=qx.core.Environment.get(E)==G||qx.core.Environment.get(E)==d?ez.innerText:ez.textContent;var eA=ey.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);return !eA?[]:eA;}
,getWordsWithElement:function(){var eD=this.getTextNodes();var eH={};var i,j,eI,eE,eC;for(var i=0,eG=eD.length;i<eG;++i){eE=eD[i];eI=eE.nodeValue.split(B);for(var j=0,eF=eI.length;j<eF;++j){eC=this._cleanupWord(eI[j]);if(eC!=null&&eC.length>1){if(!eH[eC]){eH[eC]=[];}
;eH[eC].push(eE);}
;}
;}
;return eH;}
,_cleanupWord:function(eJ){if(!eJ){return null;}
;return eJ.replace(qx.bom.htmlarea.HtmlArea.CleanupWordsRegExp,D);}
,getTextNodes:function(){return this._fetchTextNodes(this.getContentBody());}
,_fetchTextNodes:function(eK){var eM=[];var eL;if(eK.hasChildNodes){for(var i=0;i<eK.childNodes.length;i++){eL=this._fetchTextNodes(eK.childNodes[i]);qx.lang.Array.append(eM,eL);}
;}
;if(eK.nodeType==3){if(eK.nodeValue.length>1){eM.push(eK);}
;}
;return eM;}
,__AK:0,__AL:function(){var eN=this._getIframeDocument();if(!eN){this.__AK++;if(this.__AK>5){this.error('cant load HtmlArea. Document is not available. '+eN);this.fireDataEvent("loadingError");}
else {if(qx.core.Environment.get("qx.debug")){this.error('document not available, try again...');}
;qx.event.Timer.once(function(){this.__AL();}
,this,0);}
;}
else {this.__AK=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__Aw){return;}
;if(this.__Av){this.__AM();return;}
;if((qx.core.Environment.get(E)==G)){this.__AL();}
else {this._onDocumentIsReady();}
;}
,isReady:function(){return this.__dc;}
,_onDocumentIsReady:function(){var eO=new qx.bom.htmlarea.manager.Command(this);if(this.getUseUndoRedo()){eO=new qx.bom.htmlarea.manager.UndoRedo(eO,this);}
;this.__Aw=true;if((qx.core.Environment.get(E)==G)){this.setEditable(true);}
;this.__AP();if(!(qx.core.Environment.get(E)==d)){this.__ze();}
;if(!(qx.core.Environment.get(E)==G)){this.setEditable(true);}
;this.__dc=true;this.__Ap=eO;eO.setContentDocument(this._getIframeDocument());this.__AU();if((qx.core.Environment.get(E)==d)){this.__ze();}
;this.fireEvent(cn);}
,forceEditable:qx.core.Environment.select(E,{"gecko":function(){var eP=this._getIframeDocument();if(eP){if(parseFloat(qx.core.Environment.get(dj))>=M){eP.designMode=by;eP.body.contentEditable=false;eP.body.contentEditable=true;}
else {eP.body.contentEditable=true;this.__AV(true);}
;}
;}
,"default":(function(){}
)}),invalidateEditor:qx.core.Environment.select(E,{"gecko":function(){this.__Aw=false;this.__dc=false;this.__Av=true;}
,"default":function(){}
}),__AM:qx.core.Environment.select("engine.name",{"gecko":function(){this.__AP();this.__ze();this.__Ap.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__Aw=true;this.__dc=true;this.__Av=false;this.fireEvent("readyAfterInvalid");}
,"default":function(){}
}),__AN:function(eQ){var eS="";if(!eQ){return eS;}
;try{var eR=eQ.getAttribute("style");if(!eR){return eS;}
;if((qx.core.Environment.get("engine.name")=="mshtml")){eS=eR.cssText;}
else {eS=eR;}
;}
catch(eT){this.error("can't extract style from elem. ");}
;return eS;}
,__AO:function(eU){var eV=qx.core.Environment.get("engine.name")=="gecko"?" html, body {overflow-x: visible; } ":"";var eW=this.__AC[this.getContentType()];var eX='<head>'+eW.meta+'<style type="text/css">'+eV+eW.style+eW.contentStyle+this.__Ao+'</style>'+'</head>';var content=eW.body+eU;return eW.html+eX+content+eW.footer;}
,__AP:function(){var fa=this.__AI(this.getValue());if(qx.lang.Type.isString(fa)){var eY=this._getIframeDocument();try{eY.open("text/html",true);eY.write(this.__AO(fa));eY.close();}
catch(e){this.error("cant open document on source '"+qx.bom.Iframe.queryCurrentUrl(this.__pm)+"'",e);this.fireDataEvent("loadingError",e);}
;}
;}
,__ze:function(){this.__AQ();this.__AS();this.__AR();}
,__AQ:function(){var fc=qx.event.Registration;var fb=this._getIframeDocument();fc.addListener(fb.body,"keypress",this._handleKeyPress,this);fc.addListener(fb.body,"keyup",this._handleKeyUp,this);fc.addListener(fb.body,"keydown",this._handleKeyDown,this);}
,__AR:function(){var ff=qx.event.Registration;var fd=this._getIframeDocument();var fe=qx.core.Environment.get("engine.name")=="webkit"?this._getIframeWindow():fd.body;ff.addListener(fe,"focus",this._handleFocusEvent,this);ff.addListener(fe,"blur",this._handleBlurEvent,this);ff.addListener(fd,"focusout",this._handleFocusOutEvent,this);}
,__AS:function(){var fi=qx.event.Registration;var fh=this._getIframeDocument();var fg=qx.core.Environment.get("engine.name")=="mshtml"?"click":"mouseup";fi.addListener(fh.body,fg,this._handleMouseUpOnBody,this);fi.addListener(fh.documentElement,fg,this._handleMouseUpOnDocument,this);fi.addListener(fh.documentElement,"contextmenu",this._handleContextMenuEvent,this);}
,__AT:function(){if(this.__Az==null){this.__Az={execute:function(fj,fk){this.stackedCommands=true;this.commandStack.push({command:fj,value:fk});}
,commandStack:[],stackedCommands:false};}
;this.__Az.stackedCommands=false;return this.__Az;}
,__AU:function(){var fl=this.__Az;if(fl!=null&&fl.stackedCommands){var fm=fl.commandStack;if(fm!=null){for(var i=0,j=fm.length;i<j;i++){this.__Ap.execute(fm[i].command,fm[i].value);}
;}
;}
;}
,__AV:function(fn){var fo=this._getIframeDocument();if(this.__Aw&&fo){try{if((qx.core.Environment.get("engine.name")=="gecko")){fo.designMode=(fn!==false)?'Off':'On';}
;fo.designMode=(fn!==false)?'On':'Off';}
catch(e){}
;}
;}
,setEditable:function(fp){if(this.__Aw){this.__AV(true);if((qx.core.Environment.get(E)==F)){try{var fq=this._getIframeDocument();fq.execCommand(du,false,true);}
catch(fr){try{var fq=this._getIframeDocument();fq.execCommand(N,false,false);}
catch(fs){if(!this.__dc){this.error("Failed to enable rich edit functionality");this.fireDataEvent(S,fs);}
...
;this.__Ax=fp;}
;}
,getEditable:function(){return this.__Ax;}
,isEditable:function(){return this.__Ax;}
,__AW:false,_handleKeyUp:function(e){var ft=e.getKeyIdentifier().toLowerCase();this.__AA=e;if((qx.core.Environment.get(g))&&qx.core.Environment.get(k)){this.debug(e.getType()+" | "+ft);}
;if(qx.core.Environment.get(E)==G||qx.core.Environment.get(E)==A){if(this.__AW){switch(ft){case dc:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(E)==A)){this.__AX();e.preventDefault();e.stopPropagation();}
else {var fu=this.__Bi(this.getSelection());if(fu){fu.collapse(true);fu.pasteHTML(bn);}
;}
;this.__Bd();}
;break;case cy:this.__AW=false;return;break;};}
;}
else if((qx.core.Environment.get(E)==F)){switch(ft){case h:case l:case cj:case bS:case cf:case cd:case cA:case bA:case bD:this.__Ay=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__AX:function(){var fv=this.getSelection();var fw="";if(fv&&(fv.focusNode.textContent==""||fv.focusNode.parentElement.tagName=="LI")){fw="<br class='webkit-block-placeholder' />";}
;this.__Ap.execute("inserthtml",fw+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
,_handleKeyDown:qx.core.Environment.select(E,{"mshtml|webkit":function(e){var fx=e.getKeyIdentifier().toLowerCase();if((qx.core.Environment.get(g))&&qx.core.Environment.get(k)){}
;if(this.__AW&&(fx==di||fx==bV||fx==db||fx==cb||fx==bC||fx==bQ)){e.preventDefault();e.stopPropagation();}
;if(fx==cy){this.__AW=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var fC=this.getContentDocument();var fy=e.getKeyIdentifier().toLowerCase();var fA=e.isCtrlPressed();var fB=e.isShiftPressed();this.__AA=e;if((qx.core.Environment.get(g))&&qx.core.Environment.get(k)){this.debug(e.getType()+" | "+fy);}
;if(this.__AE){var fI=!((qx.core.Environment.get(E)==G)&&fy==dc)||!((qx.core.Environment.get(E)==F)&&fy==dc);if(fI){this.__Bd();this.__AE=false;}
;}
;switch(fy){case dc:if(!fB&&!fA&&this.getMessengerMode()){e.preventDefault();e.stopPropagation();this.fireDataEvent(H,this.getComputedValue());this.resetHtml();}
;if(fA){if(!this.getInsertLinebreakOnCtrlEnter()){return;}
;e.preventDefault();e.stopPropagation();if((qx.core.Environment.get(E)==F)){if(this.__Bg()){this.insertHtml(bj);this.__Bd();return;}
;this.insertHtml(bM);}
else if((qx.core.Environment.get(E)==d)){var fH=this.getSelection();var fD=this.__Bi(fH);if(fH&&fD){var fE=fC.createElement(dk);fD.collapse(true);fD.insertNode(fE);fD.collapse(true);fD.selectNode(fE);fH.addRange(fD);fD.collapse(true);}
;}
;this.__Bd();}
;if((qx.core.Environment.get(E)==G)){if(!this.getInsertParagraphOnLinebreak()){if(this.__Ap.execute(bT,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__Bd();e.preventDefault();e.stopPropagation();}
;}
;}
else if((qx.core.Environment.get(E)==F)){if(this.getInsertParagraphOnLinebreak()&&!fB&&!fA){var fH=this.getSelection();if(fH){var fz=fH.focusNode;if(this.__Bg()){this.__Bd();return;}
;if(this.__Bh()){this.__Bd();return;}
;while(!qx.dom.Node.isNodeName(fz,de)){if(qx.dom.Node.isNodeName(fz,cO)){this.__Bd();return;}
;fz=fz.parentNode;}
;}
;this.__Ap.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__Bd();this.__AE=true;}
;}
else if((qx.core.Environment.get(E)==A)){if(this.getInsertParagraphOnLinebreak()&&fB){this.__AX();e.preventDefault();e.stopPropagation();this.__Bd();}
;}
;break;case cj:if(qx.core.Environment.get(E)==F&&qx.core.Environment.get(dj)<1.9&&fB){var fH=this.getSelection();if(fH&&fH.focusNode==fC.body.firstChild){if(this.__Ay){if(fH.focusOffset!=0){fH.extend(fH.focusNode,0);}
;}
;}
;}
;this.__Bd();break;case cI:if(qx.core.Environment.get(E)==F&&qx.core.Environment.get(dj)<1.9){if(fA){var fH=this.getSelection();if(fB){if(fH&&(fH.focusOffset!=0)||(fH.focusNode!=fC.body.firstChild)){fH.extend(fC.body.firstChild,0);}
;}
else {var fF=null;var fG;if(fC){fF=fC.evaluate(Y,fC.body,null,XPathResult.ANY_TYPE,null);}
;if(fF&&fH){while(fG=fF.iterateNext()){if(fG&&fG.parentNode&&fG.parentNode.tagName!=bf){try{fH.extend(fG,0);if(!this.isSelectionCollapsed()){fH.collapseToStart();}
;}
catch(fJ){}
;break;}
;}
...
;}
;}
;this.__Bd();break;case h:case l:case bS:case cf:case cd:case cA:case bA:case bD:this.__Bd();break;case db:if(fA){this.__AY(bH,true);}
;break;case bC:case bQ:if(fA){this.__AY(dv,true);}
;break;case cb:if(fA){this.__AY(bl,true);}
;break;case di:if(fA&&!fB){this.__AY(cM,true);}
else if(fA&&fB){this.__AY(bW,true);}
;break;case bV:if(fA){this.__AY(bW,true);}
;break;case cs:if(fA){this.selectAll();}
;break;};this.__AA=null;}
,__AY:function(fK,fL){var fN=null;var fM=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(fM[fK]){fN=fM[fK].method;}
;if(fN!=null&&this[fN]){this[fN]();if(fL){this.__AA.preventDefault();this.__AA.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__AE=true;}
;this.__Bd();}
;}
,_handleFocusEvent:function(e){this.__AB=null;if(qx.core.Environment.get(E)==F||qx.core.Environment.get(E)==A){var fO=this.getContentDocument().getElementById(z);if(fO){qx.bom.element.Attribute.reset(fO,c);}
;}
;this.fireEvent(cG);}
,_handleBlurEvent:function(e){this.__Aa=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__AW=false;if(this.__AB==null){this.__AB=this.getSelectedHtml();}
;this.fireEvent(y);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(g))&&qx.core.Environment.get(k)){this.debug("handleMouse "+e.getType());}
;this.__AF=true;this.__Bd();}
,_handleMouseUpOnDocument:qx.core.Environment.select(E,{"mshtml":(function(){}
),"default":function(e){if(!this.__AF){qx.bom.Element.activate(this.getContentBody());}
;this.__AF=false;}
}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var fR=e.getViewportLeft();var fQ=e.getViewportTop();var fS=qx.bom.element.Location.getLeft(this.__kP)+fR;var fT=qx.bom.element.Location.getTop(this.__kP)+fQ;var fP={x:fS,y:fT,relX:fR,relY:fQ,target:e.getTarget()};e.preventDefault();e.stopPropagation();qx.event.Timer.once(function(){this.fireDataEvent(dh,fP);}
,this,0);}
;}
,isLoaded:function(){return this.__Aw;}
,insertHtml:function(fU){return this.__Ap.execute(bT,fU);}
,removeFormat:function(){var fV=this.__Ap.execute(cu);this.__Ap.execute(ch,this.getDefaultFontSize());this.__Ap.execute(cx,this.getDefaultFontFamily());return fV;}
,setBold:function(){return this.__Ap.execute(bE);}
,setItalic:function(){return this.__Ap.execute(dd);}
,setUnderline:function(){return this.__Ap.execute(df);}
,setStrikeThrough:function(){return this.__Ap.execute(P);}
,setFontSize:function(fW){return this.__Ap.execute(ch,fW);}
,setFontFamily:function(fX){return this.__Ap.execute(cx,fX);}
,setTextColor:function(fY){return this.__Ap.execute(ct,fY);}
,setTextBackgroundColor:function(ga){return this.__Ap.execute(cK,ga);}
,setJustifyLeft:function(){return this.__Ap.execute(dp);}
,setJustifyCenter:function(){return this.__Ap.execute(O);}
,setJustifyRight:function(){return this.__Ap.execute(bu);}
,setJustifyFull:function(){return this.__Ap.execute(bk);}
,insertIndent:function(){return this.__Ap.execute(I);}
,insertOutdent:function(){return this.__Ap.execute(X);}
,insertOrderedList:function(){return this.__Ap.execute(p);}
,insertUnorderedList:function(){return this.__Ap.execute(br);}
,insertHorizontalRuler:function(){return this.__Ap.execute(co);}
,insertImage:function(gb){return this.__Ap.execute(bI,gb);}
,insertHyperLink:function(gc){return this.__Ap.execute(bi,gc);}
,removeBackgroundColor:function(){return this.__Ap.execute(bz,bK);}
,setBackgroundColor:function(gd){return this.__Ap.execute(bz,gd);}
,removeBackgroundImage:function(){return this.__Ap.execute(cc);}
,setBackgroundImage:function(ge,gf,gg){return this.__Ap.execute(cc,[ge,gf,gg]);}
,selectAll:function(){return this.__Ap.execute(bo);}
,undo:function(){if(this.getUseUndoRedo()){return this.__Ap.execute(ci);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__Ap.execute(bB);}
else {return true;}
;}
,resetHtml:function(){var gh=this._getIframeDocument();while(gh.body.firstChild){gh.body.removeChild(gh.body.firstChild);}
;if(qx.core.Environment.get(E)==F){gh.body.innerHTML=cl;}
else if(qx.core.Environment.get(E)==A){var gi=this.getSelection();var gj=gh.createRange();if(gj&&gi){gi.addRange(gj);}
;}
;}
,getHtml:function(gk){var gl=this._getIframeDocument();if(gl==null){return null;}
;return qx.bom.htmlarea.HtmlArea.__As(gl.body,false,gk,this.getPostProcess());}
,containsOnlyPlaceholder:qx.core.Environment.select(E,{"mshtml":function(){var gm=this._getIframeDocument();return (gm.body.innerHTML==cT);}
,"default":(function(){return false;}
)}),_selectElement:function(gn){var gp=this.getContentWindow().getSelection();var go=this.getContentDocument().createRange();go.setStart(gn,0);gp.removeAllRanges();gp.addRange(go);}
,focusContent:qx.core.Environment.select(E,{"gecko":function(){var gr=this.getContentDocument();var gq=gr.getElementById(z);this.getContentWindow().focus();qx.bom.Element.focus(this.getContentBody());if(gq){this._selectElement(gq);}
else {this.__Ba();}
;}
,"webkit":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());var gs=this.getContentDocument().getElementById(z);if(gs){qx.bom.element.Attribute.reset(gs,c);}
;this.__Ba();}
,"opera":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());this.__Ba();}
,"default":function(){qx.bom.Element.focus(this.getContentBody());this.__Ba();}
}),__Ba:function(){if(!this.__Bb()){this.__Bc();}
;}
,__Bb:qx.core.Environment.select(E,{"gecko":function(){var gt=this.getContentBody().childNodes;if(gt.length==0){return false;}
else if(gt.length==1){return !(gt[0]&&qx.dom.Node.isNodeName(gt[0],dk)&&qx.bom.element.Attribute.get(gt[0],cD)!=null);}
else {return true;}
;}
,"webkit":function(){var gu=this.getContentBody().childNodes;if(gu.length==0){return false;}
else if(gu.length==1){return !(gu[0]&&qx.dom.Node.isNodeName(gu[0],dk));}
else {return true;}
;}
,"default":function(){var gv=this.getContentBody().childNodes;if(gv.length==0){return false;}
else if(gv.length==1){return !(gv[0]&&qx.dom.Node.isNodeName(gv[0],bF)&&gv[0].firstChild==null);}
else {return true;}
;}
}),__Bc:qx.core.Environment.select(E,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__AI(D);var gw=this.getContentDocument().getElementById(z);qx.bom.element.Attribute.reset(gw,c);this._selectElement(gw);}
,"default":function(){var gx=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());if(qx.dom.Node.isNodeName(gx,bF)){qx.bom.element.Style.set(gx,bU,this.getDefaultFontFamily());qx.bom.element.Style.set(gx,ck,this.getDefaultFontSize());}
;}
}),getContextInformation:function(){return this.__Be();}
,__Bd:function(){qx.event.Timer.once(function(e){var gy=this.__Be();this.fireDataEvent(cX,gy);}
,this,200);}
,__Be:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return null;}
;this._processingExamineCursorContext=true;if(!this.__Bb()){this.__Bc();}
;var gC=this.getFocusNode();if(gC==null){return null;}
;if(qx.dom.Node.isText(gC)){gC=gC.parentNode;}
;var gG=this._getIframeDocument();var gP=(qx.core.Environment.get(E)==G)?gC.currentStyle:gG.defaultView.getComputedStyle(gC,null);var gJ=false;var gz=false;var gE=false;var gD=false;var gK=false;var gO=false;var gF=false;var gQ=false;var gB=false;var gM=false;var gN=null;var gR=null;var gI=null;if(gP!=null){if((qx.core.Environment.get(E)==G)){gz=gP.fontStyle==dd;gE=gP.textDecoration.indexOf(df)!==-1;gD=gP.textDecoration.indexOf(cF)!==-1;gN=gP.fontSize;gI=gP.fontFamily;gF=gP.textAlign==h;gQ=gP.textAlign==ce;gB=gP.textAlign==l;gM=gP.textAlign==cw;}
else {gz=gP.getPropertyValue(x)==dd;gE=gP.getPropertyValue(cg).indexOf(df)!==-1;gD=gP.getPropertyValue(cg).indexOf(cF)!==-1;gN=gP.getPropertyValue(ck);gI=gP.getPropertyValue(bU);gF=gP.getPropertyValue(m)==h;gQ=gP.getPropertyValue(m)==ce;gB=gP.getPropertyValue(m)==l;gM=gP.getPropertyValue(m)==cw;}
;if(qx.core.Environment.get(E)==G||qx.core.Environment.get(E)==d){gJ=gP.fontWeight==700;}
else {gJ=gP.getPropertyValue(dq)==bE||qx.dom.Node.isNodeName(gC,db);}
;}
;var gA=gC;if(gA!=null&&gA.parentNode!=null&&!qx.dom.Node.isDocument(gA.parentNode)){while(gA!=null&&!qx.dom.Node.isNodeName(gA,de)){var gH=qx.dom.Node.getName(gA);if(gH==bv){gO=true;break;}
else if(gH==cW){gK=true;break;}
;if(gR==null||gR==D){gR=qx.bom.element.Attribute.get(gA,dl);}
;gA=gA.parentNode;}
;}
;var gL={bold:gJ?1:0,italic:gz?1:0,underline:gE?1:0,strikethrough:gD?1:0,fontSize:(gR==null)?gN:gR,fontFamily:gI,insertUnorderedList:gK?1:0,insertOrderedList:gO?1:0,justifyLeft:gF?1:0,justifyCenter:gQ?1:0,justifyRight:gB?1:0,justifyFull:gM?1:0};this._processingExamineCursorContext=false;return gL;}
,getSelection:qx.core.Environment.select(E,{"mshtml":function(){return this._getIframeDocument()?this._getIframeDocument().selection:null;}
,"default":function(){return this._getIframeWindow()?this._getIframeWindow().getSelection():null;}
}),isSelectionCollapsed:qx.core.Environment.select(E,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==cz;}
,"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;}
}),getSelectedText:qx.core.Environment.select(E,{"mshtml":function(){return this.getRange()?this.getRange().text:D;}
,"default":function(){return this.getRange()?this.getRange().toString():D;}
}),getSelectedHtml:function(){if(this.__AB!=null){return this.__AB;}
;var gS=this.getRange();if(!gS){return D;}
else {return this.__Bf(gS);}
;}
,__Bf:qx.core.Environment.select(E,{"mshtml":function(gT){if(!gT){return D;}
;return gT.item?gT.item(0).outerHTML:gT.htmlText;}
,"default":function(gU){var gV=this._getIframeDocument();if(gV&&gU){try{var gW=gV.createElement(de);gW.appendChild(gU.cloneContents());return gW.innerHTML;}
catch(gX){}
;return gU+D;}
;return D;}
}),clearSelection:qx.core.Environment.select(E,{"mshtml":function(){var gY=this.getSelection();if(gY){gY.empty();}
;}
,"default":function(){var ha=this.getSelection();if(ha){ha.collapseToStart();}
;}
}),__Bg:qx.core.Environment.select(E,{"gecko":function(){var hb=this.getSelection();var hc=this.getFocusNode();return hb&&this.isSelectionCollapsed()&&hc!=null&&qx.dom.Node.isText(hc)&&hb.anchorOffset<hc.length;}
,"default":function(){return false;}
}),__Bh:qx.core.Environment.select(E,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());}
,"default":function(){return false;}
}),getRange:function(){return this.__Bi(this.getSelection());}
,__Bi:qx.core.Environment.select(E,{"mshtml":function(hd){var he=this._getIframeDocument();if(hd){try{return hd.createRange();}
catch(hf){return he?he.body.createTextRange():null;}
;}
else {return he?he.body.createTextRange():null;}
;}
,"default":function(hg){var hh=this._getIframeDocument();if(hg){try{return hg.getRangeAt(0);}
catch(hi){return hh?hh.createRange():null;}
;}
else {return hh?hh.createRange():null;}
;}
}),saveRange:qx.core.Environment.select(E,{"mshtml":function(){this.__AD=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(E,{"mshtml":function(){return this.__AD;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(E,{"mshtml":function(){this.__AD=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(E,{"mshtml":function(){var hj=this.getSelection();var hk;switch(hj.type){case bs:case cz:hk=this.__Bi(hj);if(hk){hk.collapse(false);return hk.parentElement();}
else {return null;}
;break;case ds:hk=this.__Bi(hj);if(hk){try{hk.collapse(false);}
catch(hl){}
;return hk.item(0);}
else {return null;}
;break;default:return this._getIframeDocument().body;};}
,"default":function(){var hm=this.getSelection();if(hm&&hm.focusNode){return hm.focusNode;}
;return this._getIframeDocument().body;}
})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var ho=this._getIframeDocument();var hq=qx.event.Registration;hq.removeListener(ho.body,u,this._handleKeyPress,this);hq.removeListener(ho.body,dt,this._handleKeyUp,this);hq.removeListener(ho.body,T,this._handleKeyDown,this);var hp=qx.core.Environment.get(E)==A?this._getIframeWindow():ho.body;hq.removeListener(hp,bh,this._handleFocusEvent);hq.removeListener(hp,K,this._handleBlurEvent);hq.removeListener(ho,bb,this._handleFocusOutEvent);var hn=qx.core.Environment.get(E)==G?cp:bO;hq.removeListener(ho.body,hn,this._handleMouseUpOnBody,this);hq.removeListener(ho.documentElement,hn,this._handleMouseUpOnDocument,this);hq.removeListener(ho.documentElement,dh,this._handleContextMenuEvent,this);if((qx.core.Environment.get(E)==G)){qx.bom.Iframe.setSource(this.__pm,W);}
;}
catch(hr){}
;if(this.__Ap instanceof qx.core.Object){this._disposeObjects(da);}
else {this.__Ap=null;}
;this.__AC=this.__pm=this.__kP=this.__Az=null;}
});}
)();
...
(function(){var bv="__BW",bu="formatBlock",bt="insertParagraph",bs="_moz",br="__BO",bq="__BF",bp="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",bo="__placeholder__",bn='font-family:',bm="<p style='",bb="outdent",ba="__BX",Y="__BT",X="InsertImage",W="__resetHtml",V="FontName",U="__Bv",T="li",S="qx.bom.htmlarea.manager.Command",R="'><br class='webkit-block-placeholder' />",bC='"',bD="type",bA="CreateLink",bB=":",by='"></span>',bz="Italic",bw=";",bx="__BE",bE="InsertUnorderedList",bF="__BR",bf="body",be='text-align:',bh="Bold",bg="ForeColor",bj='" ',bi="repeat repeat-x repeat-y no-repeat",bl='</p>',bk="Control",bd="IMG",bc="__BS",a="StrikeThrough",b="__getHtml",c='>',d="Indent",f=':',g="br",h="Copy",m="Paste",n="__BC",o="__BP",bJ='<p id="',bI="RemoveFormat",bH="JustifyRight",bG="__BQ",bN="FontSize",bM='',bL="webkit",bK='style="',bP="JustifyCenter",bO="_moz_dirty",D="JustifyLeft",E="__BY",B="Underline",C="SelectAll",H="Cut",I="__BV",F='<span id="',G="__BN",z="JustifyFull",A="Outdent",w="indent",v="selectall",y="InsertOrderedList",x="id",s="InsertHtml",r="__paragraph__",u="qx.bom.htmlarea.HtmlArea.debug",t="qx.debug",q="__BA",p=';',N="p",O="mshtml",P="font-family",Q="text-align",J="__Bz",K="",L="inserthtml",M="engine.name";qx.Class.define(S,{extend:qx.core.Object,construct:function(bQ){qx.core.Object.call(this);this.__Bj=bQ;this.__lM=null;this._commands=null;this.__Bq();this.__Bk={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__Bl=[10,12,16,18,24,32,48];this.__Bm=0;}
,statics:{__Bn:bp,__Bo:bi},members:{__lM:null,__Bj:null,__Bp:false,__Bk:null,__Bl:null,__Bm:null,setContentDocument:function(bR){this.__lM=bR;}
,getCommandObject:function(bS){if(this._commands[bS]){return this._commands[bS];}
else {return null;}
;}
,__Bq:function(){this._commands={bold:{useBuiltin:false,identifier:bh,method:I},italic:{useBuiltin:false,identifier:bz,method:bv},underline:{useBuiltin:false,identifier:B,method:ba},strikethrough:{useBuiltin:false,identifier:a,method:E},fontfamily:{useBuiltin:true,identifier:V,method:null},fontsize:{useBuiltin:false,identifier:bN,method:G},textcolor:{useBuiltin:true,identifier:bg,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:br},backgroundcolor:{useBuiltin:false,identifier:null,method:o},backgroundimage:{useBuiltin:false,identifier:null,method:bG},justifyleft:{useBuiltin:false,identifier:D,method:J},justifyright:{useBuiltin:false,identifier:bH,method:J},justifycenter:{useBuiltin:false,identifier:bP,method:J},justifyfull:{useBuiltin:false,identifier:z,method:J},indent:{useBuiltin:true,identifier:d,method:null},outdent:{useBuiltin:true,identifier:A,method:null},copy:{useBuiltin:true,identifier:h,method:null},cut:{useBuiltin:true,identifier:H,method:null},paste:{useBuiltin:true,identifier:m,method:null},insertorderedlist:{useBuiltin:false,identifier:y,method:q},insertunorderedlist:{useBuiltin:false,identifier:bE,method:q},inserthorizontalrule:{useBuiltin:false,identifier:s,method:bq},insertimage:{useBuiltin:false,identifier:X,method:n},inserthyperlink:{useBuiltin:false,identifier:bA,method:bx},selectall:{useBuiltin:false,identifier:C,method:bF},selectedtext:{useBuiltin:false,identifier:null,method:bc},selectedhtml:{useBuiltin:false,identifier:null,method:Y},inserthtml:{useBuiltin:false,identifier:s,method:U},resethtml:{useBuiltin:false,identifier:null,method:W},gethtml:{useBuiltin:false,identifier:null,method:b},removeformat:{useBuiltin:true,identifier:bI,method:null}};}
,execute:function(bT,bU){if(!this.__Bj.isReady()){this.error("editor not ready! '"+bT+"':'"+bU+"'");return false;}
;bT=bT.toLowerCase();bU=bU!=null?bU:null;if(this._commands[bT]){var bV;var bW=this._commands[bT];if(!((qx.core.Environment.get(M)==bL)&&(bT==w||bT==bb))){if(this.__Br()){this.__Bs();}
;}
;if(bW.useBuiltin){bV=this.__Bt(bW.identifier,false,bU);}
...
;}
;this.__Bj.resetSavedRange();return bV;}
else {this.error("Command "+bT+" is currently not supported!");}
;}
,__Br:function(){var Node=qx.dom.Node;var bX=this.__Bj.getFocusNode();var cb=false;var bY=false;if(bX){if(Node.isText(bX)){var ca=qx.dom.Hierarchy.getAncestors(bX);for(var i=0,j=ca.length;i<j;i++){if(Node.isNodeName(ca[i],N)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(ca[i])){cb=true;break;}
;}
;}
else if(Node.isNodeName(bX,bf)){bY=true;}
;}
;return bY||!cb;}
,__Bs:function(){this.__Bt(bu,false,N);}
,__Bt:function(cc,cd,ce){try{var ch=this.__lM;var cf=false;var cg=this.__Bj.getRange();this.__lM.body.focus();if((qx.core.Environment.get(M)==O)){if(cc!=v){cg.select();if(((cg.text)&&(cg.text.length>0))||((cg.length==1)&&(cg.item(0))&&(cg.item(0).tagName==bd))){ch=cg;}
else {ch=this.__lM;}
;}
;if(((qx.core.Environment.get(M)==O))&&(this.__Bk[cc])){if(cg.text==K){cf=true;}
;}
;}
;var ci=ch.execCommand(cc,cd,ce);if(cf&&cg.text!=K){cg.collapse();}
;if((qx.core.Environment.get(t))&&qx.core.Environment.get(u)){this.debug("execCommand "+cc+" with value "+ce+" succeded");}
;this.__Bp=false;}
catch(cj){if((qx.core.Environment.get(t))&&qx.core.Environment.get(u)){this.debug("execCommand "+cc+" with value "+ce+" failed");}
;return false;}
;return ci;}
,__Bu:qx.core.Environment.select(M,{"mshtml":function(){var cl=this.__Bj;var ck=cl.getSavedRange()!=null?cl.getSavedRange():cl.getRange();return ck;}
,"default":function(){return this.__Bj.getRange();}
}),__Bv:qx.core.Environment.select(M,{"mshtml":function(cm,cn){var cq;if(cm==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__By();}
else {this.__lM.body.focus();var cp=this.__Bj.getSelection();var co=this.__Bu();if(co&&cp&&cp.type!=bk){try{co.pasteHTML(cm);co.collapse(false);co.select();cq=true;}
catch(e){}
;}
else {cq=false;}
;this.__Bj.resetSavedRange();return cq;}
;}
,"default":function(cr,cs){this.__lM.body.focus();return this.__lM.execCommand(cs.identifier,false,cr);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(M,{"gecko":function(){var cA=this.__BI();var cE=this.__Bw(cA);var cw=this.__BG(cA);var cB=bo+Date.parse(new Date());var cC=r+Date.parse(new Date());var cu=bM;var cy=F+cB+by;cu+=cy;cu+=bJ+cC+bj+cE+c;cu+=cw+bl;this.__Bj.getCommandManager().addUndoStep(L,bt,this.getCommandObject(L));this.execute(L,cu);this.__Bx();qx.bom.element.Attribute.reset(this.__lM.getElementById(cB),x);var cz=this.__lM.getElementById(cC);if(cz.previousSibling.innerHTML==cy){var ct=this.__BH();var cx=this.__lM.createElement(g);var cv=this.__lM.createAttribute(bO);cv.nodeValue=K;cx.setAttributeNode(cv);var cD=this.__lM.createAttribute(bD);cD.nodeValue=bs;cx.setAttributeNode(cD);cz.previousSibling.appendChild(ct);cz.previousSibling.appendChild(cx);}
;qx.bom.element.Attribute.reset(cz,x);return true;}
,"webkit":function(){var cF=this.getCurrentStyles();var cG=K;var cI={"background-color":true,"text-align":true};for(var cH in cF){if(cI[cH]){cG+=cH+bB+cF[cH]+bw;}
;}
;this.__Bj.insertHtml(bm+cG+R);}
,"default":(function(){}
)}),__Bw:qx.core.Environment.select(M,{"gecko":function(cJ){var cO=bK;var cN=cJ.child;if(cN[Q]){cO+=be+cN[Q]+p;delete cJ.child[Q];}
;if(cN[P]){cO+=bn+cN[P]+p;delete cJ.child[P];}
;var cM={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};var cK={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};for(var cL in cN){if(cM[cL]||cK[cL]){cO+=cL+f+cN[cL]+p;delete cJ.child[cL];}
;}
;cO+=bC;return cO;}
,"default":function(){return K;}
}),__Bx:qx.core.Environment.select(M,{"gecko":function(){var cW=this.__Bj.getSelection();if(!cW||!cW.focusNode){return;}
;var cP=cW.focusNode;var cU=cW.focusNode;while(!qx.dom.Node.isNodeName(cU,N)){cU=cU.parentNode;}
;var cT=cU.previousSibling.id;var cX=cU.nextSibling?cU.nextSibling.id:null;if(qx.lang.String.startsWith(cT,r)&&cT==cX){var cV=cU.nextSibling;var cR=this.__Bj.getRange();cR.selectNode(cV);cW.addRange(cR);var cQ=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__Bj.getCommandManager().addUndoStep(L,cQ,this.getCommandObject(L));this.execute(L,cQ);var cS=this.__Bj.getRange();if(cP){while(cP&&cP.firstChild&&qx.dom.Node.isElement(cP.firstChild)){cP=cP.firstChild;}
;}
;cS.selectNode(cP);cW.addRange(cS);cS.collapse(true);}
;}
,"default":(function(){}
)}),__By:qx.core.Environment.select(M,{"mshtml":function(){var cY=this.__Bj.getRange();if(cY&&!qx.dom.Node.isNodeName(cY.parentElement(),T)){cY.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);cY.collapse(false);cY.select();return true;}
;return false;}
,"default":function(){return false;}
}),__Bz:function(da,db){var dc=(qx.core.Environment.get(M)==O)?this.__Bj.getRange():this.__lM;return dc.execCommand(db.identifier,false,da);}
,__BA:function(dd,de){if((qx.core.Environment.get("engine.name")=="mshtml")){var df=this.__Bj.getFocusNode();this.__BB(df);}
;this.__lM.body.focus();var dg=this.__lM.execCommand(de.identifier,false,dd);if((qx.core.Environment.get("engine.name")=="webkit")){var df=this.__Bj.getFocusNode();this.__BB(df.parentNode);}
;return dg;}
,__BB:function(dh){var di=[];var parent=dh.parentNode;while(qx.dom.Node.isNodeName(parent,"blockquote")){di.push(parent);parent=parent.parentNode;}
;if(di.length>0){parent.appendChild(dh);parent.removeChild(di[di.length-1]);}
;}
,__BC:qx.core.Environment.select("engine.name",{"gecko":function(dj,dk){if(dj.src){this.__lM.execCommand(dk.identifier,false,dj.src);delete dj.src;var dy=this.__Bj.getSelection();if(dy){var dx=dy.anchorNode;var ds=dy.anchorOffset;var dp=dx.childNodes[ds-1];var dv;for(var dr in dj){dv=this.__lM.createAttribute(dr);dv.nodeValue=dj[dr];dp.setAttributeNode(dv);}
;var dq={"font":true,"span":true};var dm=null;var du=true;if(qx.dom.Node.isElement(dp.previousSibling)&&dq[qx.dom.Node.getName(dp.previousSibling)]){dm=dp.previousSibling;}
else if(dq[qx.dom.Node.getName(dp.parentNode)]){dm=dp.parentNode;du=false;}
;var dn=this.__lM.createDocumentFragment();var dz;if(du&&dm!=null){var dq=this.__BD(dm);dn.appendChild(dq.root);dz=dq.inline;}
else {dz=this.__lM.createElement("span");dn.appendChild(dz);}
;var dw=this.__lM.createTextNode("");dz.appendChild(dw);var dt=dp.parentNode;if(dp==dt.lastChild){dt.appendChild(dn);}
else {dt.insertBefore(dn,dp.nextSibling);}
;var dl=this.__Bj.getRange();dl.selectNodeContents(dz);}
;return true;}
else {return false;}
;}
,"mshtml":function(dA,dB){var dF=false;var dG="<img ";for(var dC in dA){dG+=dC+"='"+dA[dC]+"' ";}
;dG+="/>";var dD=this.__Bj.getSelection();var dE=this.__Bu();if(dD&&dD.type!="Control"){try{dE.select();dE.pasteHTML(dG);dF=true;}
catch(e){}
;}
;this.__Bj.resetSavedRange();return dF;}
,"default":function(dH,dI){if(dH.src){var dK="<img ";for(var dJ in dH){dK+=dJ+"='"+dH[dJ]+"' ";}
;dK+="/>";return this.__lM.execCommand("InsertHtml",false,dK);}
else {return false;}
;}
}),__BD:function(dL){while(dL.firstChild&&dL.firstChild.nodeType==1){dL=dL.firstChild;}
;var dP=this.__BI(dL);var dT,dN,dR;var dM="";var parent=null;var dS=null;var dQ=dP.child;while(dQ){dS=this.__lM.createElement(dQ["legacy-font-size"]?"font":"span");dN=this.__lM.createAttribute("style");dS.setAttributeNode(dN);for(var dO in dQ){if(dO!="child"&&dO!="legacy-font-size"){dM+=dO+":"+dQ[dO]+";";}
else if(dO=="legacy-font-size"){dR=this.__lM.createAttribute("size");dR.nodeValue=dQ[dO];dS.setAttributeNode(dR);}
;}
;dN.nodeValue=dM;if(parent!=null){parent.appendChild(dS);}
else {dT=dS;}
;parent=dS;dQ=dQ.child;dM="";}
;return {root:dT,inline:dS};}
,__BE:qx.core.Environment.select("engine.name",{"gecko|opera":function(dU,dV){var ec=this.__Bj.getSelection();var dY=this.__Bj.getRange();if(ec.isCollapsed){var dX="qx_link"+(++this.__Bm);var ed=this.__lM.createElement("a");var ea=this.__lM.createAttribute("href");var dW=this.__lM.createAttribute("id");var eb=this.__lM.createTextNode(dU);dW.nodeValue=dX;ed.setAttributeNode(dW);ea.nodeValue=dU;ed.setAttributeNode(ea);ed.appendChild(eb);dY.insertNode(ed);dY.selectNode(ed);ec.collapseToEnd();return true;}
else {return this.__lM.execCommand(dV.identifier,false,dU);}
;}
,"mshtml":function(ee,ef){try{var eh;var eg=this.__Bu();var ei=this.__Bj;var eg=ei.getSavedRange()!=null?ei.getSavedRange():ei.getRange();if(eg!=null&&eg.text!=""){eh=eg.execCommand(ef.identifier,false,ee);}
else {eh=this.__Bv(' <a href="'+ee+'">'+ee+'</a> ',ef);}
;this.__Bj.resetSavedRange();return eh;}
catch(e){if(qx.core.Environment.get("qx.debug")){this.error("inserthyperlink failed!");}
;return false;}
;}
,"default":function(ej,ek){return this.__lM.execCommand(ek.identifier,false,ej);}
}),__BF:function(el,em){var en="<hr />";if((qx.core.Environment.get("engine.name")=="gecko")){en+=this.__BG();}
;return this.__Bv(en,em);}
,__BG:function(eo){var es="";var er='<span style="';var eq=[];var ev=typeof eo!=="undefined"?eo:this.__BI();var et=ev.child;var eu=false;if(qx.lang.Object.isEmpty(et)){return "";}
;while(et){eu=et["legacy-font-size"]!=null;es+=eu?'<font style="':er;for(var ep in et){es+=(ep!="child"&&ep!="legacy-font-size")?ep+':'+et[ep]+';':"";}
;es+=eu?'" size="'+et["legacy-font-size"]+'">':'">';eq.unshift(eu?"</font>":"</span>");et=et.child;}
;if(eq.length==1&&eq[0]=="</font>"){es+="<span></span>";}
;for(var i=0,j=eq.length;i<j;i++){es+=eq[i];}
;return es;}
,__BH:function(){var ey=this.__lM.createDocumentFragment();var eD=this.__BI();var parent=ey;var eB=eD.child;var ez;var eC=false;while(eB){eC=eB["legacy-font-size"]!=null;ez=this.__lM.createElement(eC?"font":"span");parent.appendChild(ez);for(var ew in eB){if(ew!="child"&&ew!="legacy-font-size"){qx.bom.element.Style.set(ez,ew,eB[ew]);}
;}
;if(eC){var eA=this.__lM.createAttribute("size");eA.nodeValue=eB["legacy-font-size"];ez.setAttributeNode(eA);}
;parent=ez;eB=eB.child;}
;return ey;}
,__BI:function(eE){var eG={};var eH=null;var eI=this.getCurrentStyles(eE);eH=eG.child={};for(var eF in eI){if(eF!="text-decoration"){eH[eF]=eI[eF];}
;}
;if(eI["text-decoration"]){var eJ=eI["text-decoration"];for(var i=0,j=eJ.length;i<j;i++){if(eH==null){eH=eG.child={};}
else {eH=eH.child={};}
;eH['color']=eJ[i]['color'];eH['text-decoration']=eJ[i]['text-decoration'];}
;}
;if(eI['color']&&eI['text-decoration']){eH=eH.child={};eH['color']=eI['color'];}
;return eG;}
,getCurrentStyles:function(eK){if(eK==null){var eM=this.__Bj.getSelection();if(!eM||eM.focusNode==null){return {};}
;eK=(eM.focusNode.nodeType==3)?eM.focusNode.parentNode:eM.focusNode;}
;var eN=qx.dom.Hierarchy.getAncestors(eK);var eP=qx.lang.Array.insertBefore(eN,eK,eN[0]);var eL=this.__BJ(eP);var eO=this.__BK(eL,eP);return eO;}
,__BJ:function(eQ){var eT={};var eR,eS;for(var i=0,j=eQ.length;i<j;i++){eS=eQ[i];for(var k=0,l=eS.style.length;k<l;k++){eR=eS.style[k];if(eR.length>0&&typeof eT[eR]==="undefined"){eT[eR]=eS.style.getPropertyValue(eR);}
;}
...
;return eT;}
,__BK:function(eU,eV){var fb=eV[0];var eY=this.__Bj.getContentWindow().getComputedStyle(fb,null);var eW;var fa={};for(var eX in eU){if(eX!="legacy-font-size"){eW=eY.getPropertyValue(eX);}
else {eW=eU[eX];}
;if(eX=="background-color"&&eW=="transparent"){fa[eX]=this.__BM(eV);}
else if(eX=="text-decoration"){fa[eX]=this.__BL(eV);}
else {fa[eX]=eW;}
;}
;return fa;}
,__BL:function(fc){var ff,fh,fd;var fg=[];var fe=this.__Bj.getContentWindow();for(var i=0,j=fc.length;i<j;i++){fd=fe.getComputedStyle(fc[i],null);ff=fd.getPropertyValue("text-decoration");fh=fd.getPropertyValue("color");if(ff!="none"){fg.push({'text-decoration':ff,'color':fh});}
;}
;return fg;}
,__BM:function(fi){var fk,fj,fl;for(var i=0;i<fi.length;i++){fk=fi[i];fj=this.__Bj.getContentWindow().getComputedStyle(fk,null);fl=fj.getPropertyValue("background-color");if(fl!="transparent"){return fl;}
;}
;}
,__BN:function(fm,fn){var fz=this.__Bj.getSelection();var fu=((qx.core.Environment.get("engine.name")=="mshtml"))?this.__Bj.getRange():fu=fz.getRangeAt(0);var fv=[];var fy;var ft=["OL","UL"];var fo,i,j,fw;fw=((qx.core.Environment.get("engine.name")=="mshtml"))?fu.parentElement():fu.commonAncestorContainer;if(fw.tagName=="BODY"){for(var i=0;i<ft.length;i++){fo=fw.getElementsByTagName(ft[i]);for(var j=0;j<fo.length;j++){if(fo[j]){fv.push(fo[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(ft,fw.tagName)){fv.push(fw);}
;if(fv.length>0){for(var i=0;i<fv.length;i++){var fq=fv[i];fy=((qx.core.Environment.get("engine.name")=="mshtml"))?((fq==fw)||(fw.tagName=="BODY")):fz.containsNode(fq,false);for(j=0;j<fq.childNodes.length;j++){var fs=fq.childNodes[j];if(fy||(fz.focusNode.nodeValue&&qx.dom.Hierarchy.contains(fs,fz.focusNode)&&(fz.focusOffset==fz.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(fs,fz.anchorNode)&&(fz.anchorOffset==0))||(fz.containsNode(fs,false))){fs.style.fontSize=(this.__Bl[fm]||fm)+"px";}
;}
;}
;}
else {var fr=((qx.core.Environment.get("engine.name")=="mshtml"))?fw:fz.focusNode;var fx=qx.dom.Hierarchy.getAncestors(fr);for(i=0;i<fx.length;i++){if(fx[i].tagName=="LI"){if((((qx.core.Environment.get("engine.name")=="gecko"))&&((fz.anchorOffset==0)&&(fz.focusNode.nodeValue&&(fz.focusOffset==fz.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(fx[i].firstChild,fz.anchorNode)&&qx.dom.Hierarchy.contains(fx[i].lastChild,fz.focusNode)))||(((qx.core.Environment.get("engine.name")=="mshtml"))&&(fu.htmlText==fx[i].innerHTML))){fx[i].style.fontSize=(this.__Bl[fm]||fm)+"px";}
;break;}
;}
;}
;if((qx.core.Environment.get("engine.name")=="mshtml")){this.__lM.body.focus();this.__Bj.getRange().select();return this.__lM.execCommand("FontSize",false,fm);}
else if((qx.core.Environment.get("engine.name")=="gecko")){var parent=fu.commonAncestorContainer;if(parent.nodeType===1){var fp=parent.getElementsByTagName("span");for(i=0;i<fp.length;i++){if(fp[i].style.fontSize){fp[i].style.fontSize=null;}
;}
;}
;}
;return this.__lM.execCommand("FontSize",false,fm);}
,__BO:qx.core.Environment.select("engine.name",{"mshtml":function(fA,fB){this.__lM.body.focus();return this.__lM.execCommand("BackColor",false,fA);}
,"gecko|opera":function(fC,fD){this.__lM.body.focus();return this.__lM.execCommand("HiliteColor",false,fC);}
,"webkit":function(fE,fF){var fG=this.__Bj.getSelection();var fH=this.__Bj.getRange();if(!fG||!fG.isCollapsed){this.__lM.body.focus();this.__lM.execCommand("BackColor",false,fE);if(fG){fG.collapseToEnd();}
;return true;}
else {var fJ=fG.anchorOffset;var fK=fG.anchorOffset;var fH=fG.getRangeAt(0);var fI=fG.anchorNode;while(fK>0){if(fI.nodeValue.charCodeAt(fK)==160||fI.nodeValue.charCodeAt(fK)==32){break;}
else {fK--;}
;}
;while(fJ<fI.nodeValue.length){if(fI.nodeValue.charCodeAt(fJ)==160||fI.nodeValue.charCodeAt(fJ)==32){break;}
else {fJ++;}
;}
;fH.setStart(fG.anchorNode,fG.anchorNode.nodeValue.charAt(fK)==" "?fK+1:fK);fH.setEnd(fG.anchorNode,fJ);fG.addRange(fH);this.__lM.body.focus();this.__lM.execCommand("BackColor",false,fE);fG.collapseToEnd();return true;}
;}
}),__BP:function(fL,fM){fL=fL!=null&&typeof fL=="string"?fL:"transparent";qx.bom.element.Style.set(this.__lM.body,"backgroundColor",fL);return true;}
,__BQ:function(fN,fO){var fP,fR,fQ;var fS=qx.bom.htmlarea.manager.Command;if(fN==null){fP=null;}
else {fP=fN[0];fR=fN[1];fQ=fN[2];}
;if(fP==null||typeof fP!="string"){qx.bom.element.Style.set(this.__lM.body,"backgroundImage","");qx.bom.element.Style.set(this.__lM.body,"backgroundRepeat","");qx.bom.element.Style.set(this.__lM.body,"backgroundPosition","");return true;}
else {if(fP.search(/^url.*\(/)==-1){fP="url("+fP+")";}
;}
;if(fR!=null&&!qx.lang.String.contains(fS.__Bo,fR)){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+fR+"' is not allowed for parameter 'repeat'. Possible values are '"+fS.__Bo+"'");}
;return false;}
else {fR="no-repeat";}
;if(fQ!=null){if(qx.lang.Type.isString(fQ)&&!qx.lang.String.contains(fS.__Bn,'|'+fQ+'|')){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+fQ+"' is not allowed for parameter 'position'. Possible values are '"+fS.__Bn+"'");}
;return false;}
...
;qx.bom.element.Style.set(this.__lM.body,"backgroundImage",fP);qx.bom.element.Style.set(this.__lM.body,"backgroundRepeat",fR);qx.bom.element.Style.set(this.__lM.body,"backgroundPosition",fQ);return true;}
,__BR:qx.core.Environment.select("engine.name",{"mshtml":function(fT,fU){var fV=this.__lM.body.createTextRange();fV.select();return true;}
,"default":function(fW,fX){return this.__Bt(fX.identifier,false,fW);}
}),__BS:function(){return this.__Bj.getSelectedText();}
,__BT:function(){return this.__Bj.getSelectedHtml();}
,__BU:function(fY,ga){var ge=this.__Bj.getFocusNode();if(ge.textContent==""){var gc=qx.dom.Hierarchy.getAncestors(ge);gc.unshift(ge);var Node=qx.dom.Node;var gb=qx.bom.element.Style;var gd=gc.shift();while(gc.length>0){if(Node.getName(gd)=="p"||Node.getName(gd)=="body"){break;}
;if(gb.get(gd,fY,gb.LOCAL_MODE)==ga){gb.reset(gd,fY);return true;}
;gd=gc.shift();}
;}
;return false;}
,__BV:qx.core.Environment.select("engine.name",{"gecko":function(gf,gg){if(this.__BU("fontWeight","bold")){return true;}
else {return this.__Bt(gg.identifier,false,gf);}
;}
,"default":function(gh,gi){return this.__Bt(gi.identifier,false,gh);}
}),__BW:qx.core.Environment.select("engine.name",{"gecko":function(gj,gk){if(this.__BU("fontStyle","italic")){return true;}
else {return this.__Bt(gk.identifier,false,gj);}
;}
,"default":function(gl,gm){return this.__Bt(gm.identifier,false,gl);}
}),__BX:qx.core.Environment.select("engine.name",{"gecko":function(gn,go){if(this.__BU("textDecoration","underline")){return true;}
else {return this.__Bt(go.identifier,false,gn);}
;}
,"default":function(gp,gq){return this.__Bt(gq.identifier,false,gp);}
}),__BY:qx.core.Environment.select("engine.name",{"gecko":function(gr,gs){if(this.__BU("textDecoration","line-through")){return true;}
else {return this.__Bt(gs.identifier,false,gr);}
;}
,"default":function(gt,gu){return this.__Bt(gu.identifier,false,gt);}
})},destruct:function(){this.__lM=this.__Bj=this._commands=null;this.__Bk=this.__Bl=null;}
});}
)();
(function(){var m="undo",l="backgroundColor",k="pageup",h="b",g="__Ap",f="control",d="shift",c="end",b="right",a="qx_link",bb="Undo",ba="pagedown",Y="k",X="qx.debug",W="home",V="backgroundImage",U="backgroundRepeat",T="a",S="y",R="backgroundPosition",t="redo",u="insertParagraph",r="qx.bom.htmlarea.manager.UndoRedo",s="left",p="i",q="u",n="inserthyperlink",o="enter",x="webkit",y="z",F="down",D="up",J="body",H="mousedown",N="backgroundimage",L="Command",A="Content",Q="table",P="p",O="backgroundcolor",z="td",B="img",C="Internal",E="mouseup",G="keypress",I="Custom",K="inserthtml",M="gecko",v="mshtml",w="engine.name";qx.Class.define(r,{extend:qx.core.Object,construct:function(bc,bd){qx.core.Object.call(this);this.__Ap=bc;this.__Bj=bd;this.__Ca=[];this.__Cb=[];this._commands=null;this.__lM=null;this.__Cc={};this.__Cd={command:true,content:true,custom:true};this.__Bq();this.__Ce=qx.lang.Function.bind(this._handleKeyPress,this);this.__Cf=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(w)==v)){this.__Cg=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__Ch:false,__Ci:false,__Cj:false,__Cd:null,__Cc:null,__Ap:null,__lM:null,__Ca:null,__Cb:null,__Bj:null,__Ce:null,__Cf:null,__Cg:null,__Ck:null,setContentDocument:function(be){this.__lM=be;this.__Ap.setContentDocument(be);qx.event.Registration.addListener(be.body,G,this.__Ce,this);qx.event.Registration.addListener(be.body,E,this.__Cf,this);if((qx.core.Environment.get(w)==v)){qx.event.Registration.addListener(be.body,H,this.__Cg,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__Ap.insertParagraphOnLinebreak();}
,execute:function(bf,bg){var bh;bf=bf.toLowerCase();if(this._commands[bf]){if(this._commands[bf].passthrough){bh=this.__Ap.execute(bf,bg);}
else {bh=this[bf].call(this);}
;}
else {if((qx.core.Environment.get(w)==v)||(qx.core.Environment.get(w)==x)){this.__CB(bf,bg,this.__Ap.getCommandObject(bf));bh=this.__Ap.execute(bf,bg);if(!bh){this.__Ca.pop();}
;}
else {bh=this.__Ap.execute(bf,bg);if(bh){this.__CB(bf,bg,this.__Ap.getCommandObject(bf));}
;}
;if(bf==m&&this.__Ca.length==0){this.__Ci=false;this.__CJ();}
else if(bf==t&&this.__Cb.length==0){this.__Ch=false;this.__CJ();}
;}
;this.__Cj=false;return bh;}
,addUndoStep:function(bi,bj,bk){this.__CB(bi,bj,bk);}
,registerHandler:function(bl,bm,bn,bo){this.__Cc[bl]={undo:bm,redo:bn,context:bo};}
,isUndoPossible:function(){return this.__Ci;}
,undo:function(){var br;if(this.__Cj){this.__CD();}
;if(this.__Ca.length>0){var bq=this.__Ca.pop();if(this.__Cd[bq.actionType.toLowerCase()]){switch(bq.actionType){case L:br=this.__Cm(bq);break;case A:br=this.__Cq(bq);break;case C:br=this.__Cp(bq);break;case I:br=this.__Cl(bq);break;};}
else if(this.__Cc[bq.actionType]){var bp=this.__Cc[bq.actionType];br=bp.undo.call(bp.context?bp.context:this,bq);this.__CF(bq);}
else {this.error("actionType "+bq.actionType+" is not managed! Please provide a handler method!");}
;this.__Ch=true;this.__CJ();return br;}
;}
,__Cl:qx.core.Environment.select(w,{"mshtml|webkit":function(bs){var bt=this.__lM.body.innerHTML;var bv=bs.content;this.__lM.body.innerHTML=bv;var bu=bs;bu.content=bt;this.__CF(bu);return true;}
,"default":function(bw){var bA=bw;var bz=qx.bom.element.Style;switch(bw.command){case O:bA.parameter=[bz.get(this.__lM.body,l)];break;case N:bA.parameter=[bz.get(this.__lM.body,V),bz.get(this.__lM.body,U),bz.get(this.__lM.body,R)];break;};this.__CF(bA);if(bw.command==n){if((qx.core.Environment.get(w)==M)){var by=a+this.__Ap.__hyperLinkId;var bx=this.__lM.getElementById(by);if(bx){bx.parentNode.removeChild(bx);return true;}
else {return false;}
;}
;}
else {return this.__Ap.execute(bw.command,bw.value);}
;}
}),__Cm:qx.core.Environment.select(w,{"mshtml|webkit":function(bB){}
,"default":function(bC){this.__CF(bC);if((qx.core.Environment.get(w)==M)){if(bC.command==K&&bC.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__Cn(K,u)){this.__Co();}
;}
;return this.__Cr();}
}),__Cn:function(bD,bE){if(this.__Ca.length>0){var bF=this.__Ca[this.__Ca.length-1];return (bF.command==bD&&bF.value==bE);}
;return false;}
,__Co:function(){this.__Cr();if(this.__Ca.length>0){var bG=this.__Ca.pop();this.__CF(bG);}
;}
,__Cp:function(bH){this.__CF(bH);return this.__Cr();}
,__Cq:qx.core.Environment.select(w,{"gecko":function(bI){this.__CF(bI);try{return this.__Cr();}
catch(bJ){if(qx.core.Environment.get(X)){this.error("execCommand failed! Details: "+bJ);}
;}
;}
,"mshtml|webkit":function(bK){}
,"default":function(bL){this.__CF(bL);return this.__Cr();}
}),__Cr:function(){try{return this.__lM.execCommand(bb,false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__Ch;}
,redo:function(){if(this.__Ch){var bN;if(this.__Cb.length>0){var bO=this.__Cb.pop();if(this.__Cd[bO.actionType.toLowerCase()]){switch(bO.actionType){case L:bN=this.__Ct(bO);break;case A:bN=this.__Cz(bO);break;case C:bN=this.__Cy(bO);break;case I:bN=this.__Cs(bO);break;};}
else if(this.__Cc[bO.actionType]){var bM=this.__Cc[bO.actionType];bN=bM.redo.call(bM.context?bM.context:this,bO);this.__CE(bO);}
else {this.error("actionType "+bO.actionType+" is not managed! Please provide a handler method!");}
;this.__Ci=true;this.__CJ();}
;return bN;}
;}
,__Cs:qx.core.Environment.select(w,{"mshtml|webkit":function(bP){var bQ=this.__lM.body.innerHTML;var bS=bP.content;this.__lM.body.innerHTML=bS;var bR=bP;bR.content=bQ;this.__CE(bR);return true;}
,"default":function(bT){this.__CE(bT);return this.__CA();}
}),__Ct:qx.core.Environment.select(w,{"mshtml|webkit":function(bU){}
,"default":function(bV){this.__CE(bV);var bW=this.__CA();if((qx.core.Environment.get(w)==M)){if(this.__Cu(K,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var bX=this.__Cv();this.__Cw();if(bX!=null){this.__Cx(bX);}
;}
;}
;return bW;}
}),__Cu:function(bY,ca){if(this.__Cb.length>0){var cb=this.__Cb[this.__Cb.length-1];return (cb.command==bY&&cb.value==ca);}
;return false;}
,__Cv:function(){if(this.__Bj==null){return null;}
;var cc=this.__Bj.getSelection();var cd=cc?cc.focusNode:null;if(cd==null){return null;}
;try{while(cd.nodeName.toLowerCase()!=P){cd=cd.parentNode;if(!cd||qx.dom.Node.isNodeName(cd,J)){return null;}
;}
;}
catch(ce){return null;}
;if(cd!=null&&qx.dom.Node.isNodeName(cd,P)){return cd;}
else {return null;}
;}
,__Cw:function(){var cf=this.__Cb.pop();this.__CE(cf);this.__CA();}
,__Cx:qx.core.Environment.select(w,{"gecko":function(cg){if(cg==this.__Bj.getContentBody().lastChild){return;}
;var cj=cg.firstChild;while(cj.firstChild){cj=cj.firstChild;}
;var ch=this.__Bj.getSelection();var ci=this.__Bj.getRange();if(ch&&ci){ci.selectNode(cj);ch.addRange(ci);ci.collapse(true);}
;}
,"default":(function(){}
)}),__Cy:function(ck){this.__CE(ck);return this.__CA();}
,__Cz:qx.core.Environment.select(w,{"mshtml|webkit":function(cl){}
,"default":function(cm){this.__CE(cm);return this.__CA();}
}),__CA:function(){try{return this.__lM.execCommand("Redo",false,null);}
catch(e){return false;}
;}
,__Bq:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__Ap.getCommandObject(O).customUndo=true;this.__Ap.getCommandObject(N).customUndo=true;if((qx.core.Environment.get(w)==M)){}
;}
,__CB:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(cn,co,cp){var cq=this.getUndoRedoObject();cq.commandObject=cp;cq.command=cn;cq.value=co;cq.actionType="Custom";cq.content=this.__lM.body.innerHTML;this.__CC(cq);}
,"default":function(cr,cs,ct){if(this.__Bj==null){return;}
;var cv=this.getUndoRedoObject();cv.commandObject=ct;cv.command=cr;cv.value=cs;cv.actionType="Custom";var cu=this.__Bj.getSelection();if(ct.customUndo){var cw=[];switch(cr){case "backgroundcolor":cw.push(qx.bom.element.Style.get(this.__lM.body,"backgroundColor"));break;case "backgroundimage":cw.push(qx.bom.element.Style.get(this.__lM.body,"backgroundImage"),qx.bom.element.Style.get(this.__lM.body,"backgroundRepeat"),qx.bom.element.Style.get(this.__lM.body,"backgroundPosition"));break;case "inserthyperlink":if(cu&&!cu.isCollapsed){cv.actionType="Command";}
;break;};cv.parameter=cw;}
else {if((qx.core.Environment.get("engine.name")=="gecko")){if(cu&&cu.isCollapsed){switch(cr){case "insertorderedlist":case "insertunorderedlist":case "justifyright":case "inserthtml":case "insertimage":cv.actionType="Command";break;default:return;};}
else {cv.actionType="Command";}
;}
else {cv.actionType="Command";}
;}
;this.__CC(cv);}
}),__CC:function(cx){if(this.__Cj){this.__CD();}
;this.__CE(cx);this.__Ch=false;this.__Cb=[];this.__CJ();}
,__CD:function(){var cy=this.__Ca[this.__Ca.length-1];if(cy==null||cy.actionType!="Content"){var cz=this.getUndoRedoObject();cz.actionType="Content";if((qx.core.Environment.get("engine.name")=="mshtml")||(qx.core.Environment.get("engine.name")=="webkit")){cz.content=this.__Ck;cz.actionType="Custom";this.__Ck=null;}
;this.__CE(cz);this.__Cj=false;}
;}
...
,__CE:function(cA){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("ADD TO UNDO STACK");this.debug(cA.actionType+" "+cA.command+" "+cA.value);}
;this.__Ca.push(cA);}
,__CF:function(cB){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("ADD TO REDO STACK");this.debug(cB.actionType+" "+cB.command+" "+cB.value);}
;this.__Cb.push(cB);}
,_handleKeyPress:function(e){var cC=e.getKeyIdentifier().toLowerCase();var cD=e.isCtrlPressed();switch(cC){case f:case d:case s:case b:case D:case F:case k:case ba:case W:case c:case o:break;case T:case h:case p:case q:case Y:case S:case y:if(!cD){this.__CG();}
;break;default:this.__Ch=false;this.__Cb=[];this.__CG();};}
,__CG:function(){if(!this.__Cj){this.__Cj=true;this.__Ci=true;if((qx.core.Environment.get("engine.name")=="mshtml")||(qx.core.Environment.get("engine.name")=="webkit")){this.__Ck=this.__lM.body.innerHTML;}
;this.__CJ();}
;}
,__CH:null,_handleMouseDown:qx.core.Environment.select(w,{"mshtml":function(e){var cE=e.getOriginalTarget();if(qx.dom.Node.isElement(cE)&&(qx.dom.Node.isNodeName(cE,B)||qx.dom.Node.isNodeName(cE,Q))){this.__CH={node:cE,content:cE.outerHTML};}
else {this.__CH=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(w,{"gecko":function(e){if(this.__Bj==null){return;}
;var cG=this.__Bj.getSelection();if(!cG){this.__CH=null;return;}
;var cF=cG.anchorNode;var cH=cF.childNodes[cG.anchorOffset];if(qx.dom.Node.isNodeName(cH,B)){if(this.__CH==null){this.__CH=cH.cloneNode(true);}
else {if(this.__CH.style.width!=cH.style.width||this.__CH.style.height!=cH.style.height){this.__CI();this.__CH=cH.cloneNode(true);}
;}
;}
else if(qx.dom.Node.isNodeName(cF,z)||qx.dom.Node.isNodeName(cF.parentNode,z)){var cI=cF.parentNode;while(qx.dom.Node.isNodeName(cI,Q)){cI=cI.parentNode;}
;if(this.__CH==null){this.__CH=cI.cloneNode(true);}
else {qx.event.Timer.once(function(){if(cI.style.width!=this.__CH.style.width||cI.style.height!=this.__CH.style.height||cI.innerHTML!=this.__CH.innerHTML){this.__CI();this.__CH=cI.cloneNode(true);}
;}
,this,0);}
;}
else {this.__CH=null;}
;}
,"default":function(e){var cJ=qx.bom.Event.getTarget(e);if(this.__CH!=null){if(cJ.nodeType==1){if(cJ==this.__CH.node){if(cJ.outerHTML!=this.__CH.content){this.__CH.content=cJ.outerHTML;this.__CI();}
;}
else {for(var i=0,j=cJ.childNodes.length;i<j;i++){if(cJ.childNodes[i]==this.__CH.node){if(cJ.childNodes[i].outerHTML!=this.__CH.content){this.__CH.content=cJ.childNodes[i].outerHTML;this.__CI();}
;}
;}
;}
;}
...
;}
;}
}),__CI:qx.core.Environment.select("engine.name",{"mshtml|webkit":function(){this.__CB("Internal",null,null);}
,"default":function(){var cK=this.getUndoRedoObject();cK.actionType="Internal";this.__CE(cK);}
}),__CJ:function(){qx.event.Timer.once(function(e){if(this.__Bj!=null){var cL={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__Bj.fireDataEvent("undoRedoState",cL);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__lM.body,G,this.__Ce);qx.event.Registration.removeListener(this.__lM,E,this.__Cf);if((qx.core.Environment.get(w)==v)){qx.event.Registration.removeListener(this.__lM,H,this.__Cg);}
;}
catch(e){}
;this._disposeObjects(g);this.__Bj=this.__Ca=this.__Cb=this._commands=this.__lM=null;this.__Cd=this.__Cc=null;}
});}
)();
