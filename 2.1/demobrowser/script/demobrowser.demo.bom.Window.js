...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.52fd87a90c77.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Open Native Window",p="Open Native Modal Window",o="demobrowser.demo.bom.Window",n="Modal Window closed?",m="http://sourceforge.net",l="window1",k="window3",j="http://slashdot.org",i="Window closed?",h="http://qooxdoo.org",c="demobrowser/demo/html/ModalWindow.html",g="Open Faked Native Modal Window",f="window2",b="#eee",a="click",d="button";qx.Class.define(o,{extend:qx.application.Native,members:{__rs:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__rs=[h,m,j,r.toUri(c)];var u=qx.bom.Input.create(d);qx.bom.Input.setValue(u,q);document.body.appendChild(u);qx.event.Registration.addListener(u,a,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__rs[0],l,x);}
,this);var t=qx.bom.Input.create(d);qx.bom.Input.setValue(t,i);document.body.appendChild(t);qx.event.Registration.addListener(t,a,function(e){alert(qx.bom.Window.isClosed(this.window1));}
,this);var s=qx.bom.Input.create(d);qx.bom.Input.setValue(s,p);document.body.appendChild(s);qx.event.Registration.addListener(s,a,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__rs[3],f,y,true);}
,this);var w=qx.bom.Input.create(d);qx.bom.Input.setValue(w,n);document.body.appendChild(w);qx.event.Registration.addListener(w,a,function(e){alert(qx.bom.Window.isClosed(this.window2));}
,this);var v=qx.bom.Input.create(d);qx.bom.Input.setValue(v,g);document.body.appendChild(v);qx.event.Registration.addListener(v,a,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(b);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__rs[0],k,A,true,false);}
,this);}
...
(function(){var t="dialogHeight",s="no",r="yes",q="",p="qx.bom.Window",o="interval",n="dialogWidth",m="dialogLeft",l="px",k="javascript:/",d=":",j=";",g="dialogTop",c="qxNativeWindow",b="scrollbars",f="scroll",e=",",h='load',a="resizable",i="=";qx.Class.define(p,{statics:{__lh:null,__Jt:null,__kp:null,__Ju:{"top":g,left:m,width:n,height:t,scrollbars:f,resizable:a},__Jv:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Jw:function(){return window.showModalDialog!=null;}
,open:function(u,name,v,w,x,y,self){var C=null;if(u==null){u=k;}
;if(name==null){name=c+new Date().getTime();}
;if(x==null){x=true;}
;var z=this.__Jx(v,w&&x);if(w){if(this.__Jw()&&x){C=window.showModalDialog(u,[window.self],z);}
else {this.getBlocker().block();if(this.__kp==null){this.__kp=new qx.event.Timer(500);this.__kp.addListener(o,this.__Jy,this);}
;this.__Jt=window.open(u,name,z);this.__kp.restart();C=this.__Jt;}
;}
else {C=window.open(u,name,z);}
;if(C&&y&&(y instanceof Function)){var B=self||C;var A=qx.lang.Function.bind(y,B);qx.bom.Event.addNativeListener(C,h,function(){A();qx.bom.Event.removeNativeListener(C,h,arguments.callee);}
);}
;return C;}
,__Jx:function(D,E){var F;var I;var G=[];if(E&&this.__Jw()){for(var H in D){if(qx.bom.Window.__Ju[H]){var J=q;if(H!=b&&H!=a){J=l;}
;I=qx.bom.Window.__Ju[H]+d+D[H]+J;G.push(I);}
else {qx.log.Logger.warn("Option '"+H+"' is not supported for modal windows.");}
;}
;F=G.join(j);}
else {for(var H in D){if(qx.bom.Window.__Jv[H]){if(qx.lang.Type.isBoolean(D[H])){I=H+i+(D[H]?r:s);}
else {I=H+i+D[H];}
;G.push(I);}
...
;F=G.join(e);}
;return F;}
,__Jy:function(){if(this.isClosed(this.__Jt)){this.getBlocker().unblock();this.__kp.stop();}
;}
,getBlocker:function(){if(this.__lh==null){this.__lh=new qx.bom.Blocker;}
;return this.__lh;}
,close:function(K){if(K){return K.close();}
;}
,isClosed:function(L){var closed=true;if(L){try{closed=L.closed;}
catch(M){}
;}
;return closed;}
...
(function(){var i="mshtml",h="engine.name",g="qx.bom.Blocker",f="resize",d="backgroundColor",c="px",b="zIndex",a="0px";qx.Class.define(g,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__bf();}
,members:{__Jz:null,__wk:null,__JA:null,__JB:false,__JC:10000,__JD:0,__JE:"transparent",block:function(j){if(!this.__JB){this.__JA=j;var k=this.__JH();this.__JI(k);this.__JB=true;}
;}
,unblock:function(){if(this.__JB){this.__JJ();this.__JB=false;}
;}
,isBlocked:function(){return this.__JB;}
,getBlockerElement:function(){return this.__wk;}
,setBlockerColor:function(l){qx.bom.element.Style.set(this.__wk,d,l);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wk,d);}
,setBlockerOpacity:function(m){qx.bom.element.Opacity.set(this.__wk,m);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wk);}
,setBlockerZIndex:function(n){qx.bom.element.Style.set(this.__wk,b,n);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wk,b);}
,__bf:function(){this.__JF();if((qx.core.Environment.get(h)==i)){this.__JG();}
;qx.event.Registration.addListener(window,f,this.__lo,this);}
,__JF:function(){this.__wk=qx.dom.Element.create("div");qx.bom.element.Style.setStyles(this.__wk,{display:"block",opacity:this.__JD,backgroundColor:this.__JE});this.setBlockerZIndex(this.__JC);}
,__JG:function(){this.__Jz=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Jz,"allowTransparency",false);qx.bom.element.Attribute.set(this.__Jz,"src","javascript:false;");qx.bom.element.Style.setStyles(this.__Jz,{display:"block",opacity:this.__JD});}
,__JH:function(){var o={position:"absolute"};if(this.__JL()){o.left="0px";o.top="0px";o.right=null;o.bottom=null;o.width=qx.bom.Document.getWidth()+"px";o.height=qx.bom.Document.getHeight()+"px";}
else {o.width=qx.bom.element.Dimension.getWidth(this.__JA)+"px";o.height=qx.bom.element.Dimension.getHeight(this.__JA)+"px";o.left=qx.bom.element.Location.getLeft(this.__JA)+"px";o.top=qx.bom.element.Location.getTop(this.__JA)+"px";}
;return o;}
,__JI:function(p){var q=document.body;qx.bom.element.Style.setStyles(this.__wk,p);qx.dom.Element.insertEnd(this.__wk,q);if((qx.core.Environment.get("engine.name")=="mshtml")){p.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Jz,p);qx.dom.Element.insertEnd(this.__Jz,document.body);}
;}
,__JJ:function(){qx.dom.Element.remove(this.__wk);if((qx.core.Environment.get("engine.name")=="mshtml")){qx.dom.Element.remove(this.__Jz);}
;}
,__lo:function(e){if(this.__JL()){this.__JK({width:a,height:a});qx.event.Timer.once(function(){var r={width:qx.bom.Document.getWidth()+c,height:qx.bom.Document.getHeight()+c};this.__JK(r);}
,this,0);}
;}
,__JK:function(s){qx.bom.element.Style.setStyles(this.__wk,s);if((qx.core.Environment.get("engine.name")=="mshtml")){qx.bom.element.Style.setStyles(this.__Jz,s);}
;}
,__JL:function(){return (this.__JA==null||qx.dom.Node.isWindow(this.__JA)||qx.dom.Node.isDocument(this.__JA));}
},destruct:function(){qx.event.Registration.removeListener(window,f,this.__lo,this);this.__Jz=this.__wk=this.__JA=null;}
});}
)();
