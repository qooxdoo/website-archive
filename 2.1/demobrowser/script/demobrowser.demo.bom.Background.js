...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Background.1ed66eadaf1a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="#box1_7",i="#box2_3",h="#box1_1",g="#box2_1",f="#box1_5",e="#box2_4",d="#box1_2",c="#box2_6",b="demobrowser.demo.bom.Background",a="#box1_8",A="#box2_8",z="#box2_2",y="#box1_4",x="#box1_6",w="#box2_5",v="#box1_3",u="#box2_7",t="qx/icon/Tango/48/devices/drive-optical.png",s="bottom",r="repeat-y",o="right",p="repeat-x",m="no-repeat",n="center",k="repeat",l="style";qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var B=qx.util.ResourceManager.getInstance().toUri(t);q(h).setAttribute(l,qx.bom.element.Background.compile(B));q(d).setAttribute(l,qx.bom.element.Background.compile(B,p));q(v).setAttribute(l,qx.bom.element.Background.compile(B,r));q(y).setAttribute(l,qx.bom.element.Background.compile(B,k,10));q(f).setAttribute(l,qx.bom.element.Background.compile(B,k,0,10));q(x).setAttribute(l,qx.bom.element.Background.compile(B,k,10,10));q(j).setAttribute(l,qx.bom.element.Background.compile(B,m,n,n));q(a).setAttribute(l,qx.bom.element.Background.compile(B,m,o,s));q(g).setStyles(qx.bom.element.Background.getStyles(B));q(z).setStyles(qx.bom.element.Background.getStyles(B,p));q(i).setStyles(qx.bom.element.Background.getStyles(B,r));q(e).setStyles(qx.bom.element.Background.getStyles(B,k,10));q(w).setStyles(qx.bom.element.Background.getStyles(B,k,0,10));q(c).setStyles(qx.bom.element.Background.getStyles(B,k,10,10));q(u).setStyles(qx.bom.element.Background.getStyles(B,m,n,n));q(A).setStyles(qx.bom.element.Background.getStyles(B,m,o,s));}
}});}
)();
