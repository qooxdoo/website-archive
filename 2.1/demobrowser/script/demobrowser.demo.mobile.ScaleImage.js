...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.4694e595afb3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(u);var D={"width":f,"height":w,"position":l,"left":o,"top":o,"background":i+G+n};this.__zM=new qx.html.Element(m,D);this.__zM.addListener(k,this.__oo,this);this.__zM.addListener(B,this.__on,this);F.add(this.__zM);}
,__oo:function(e){if(e.isMultiTouch()){this.__KG=e.getRotation()+this.__KF;this.__KH=e.getScale()*this.__KE;this.__zM.setStyle(C,r+this.__KG+g+this.__KH+n);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__zM.getStyle(A))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__zM.getStyle(j))/2);this.__zM.setStyles({"left":I+q,"top":top+q});}
;}
,__on:function(e){if(e.isMultiTouch()){this.__KF=this.__KG;this.__KE=this.__KH;}
;}
}});}
)();
