...
var envinfo = {"qx.application":"showcase.Application","qx.debug":false,"qx.debug.databinding":false,"qx.debug.dispose":false,"qx.optimization.basecalls":true,"qx.optimization.comments":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"","qx.theme":"showcase.theme.Theme","qx.version":"1.6"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script"},"qxc.application.formdemo":{"resourceUri":"resource","sourceUri":"script"},"qxc.application.twitterdemo":{"resourceUri":"resource","sourceUri":"script"},"showcase":{"resourceUri":"resource","sourceUri":"script"}};
for (var k in libinfo) qx.$$libraries[k] = libinfo[k];

qx.$$resources = {};
qx.$$translations = {"C":null,"de":null,"de_AT":null,"de_DE":null,"en":null,"en_GB":null,"en_US":null,"es":null,"es_ES":null,"es_MX":null,"ro":null,"ro_RO":null,"sv":null,"sv_SE":null};
qx.$$locales = {"C":null,"de":null,"de_AT":null,"de_DE":null,"en":null,"en_GB":null,"en_US":null,"es":null,"es_ES":null,"es_MX":null,"ro":null,"ro_RO":null,"sv":null,"sv_SE":null};
qx.$$packageData = {};

qx.$$loader = {
  parts : {"animation":[],"boot":[2015],"data":[2015,1923,1024],"dragdrop":[2015],"form":[2015,1923,899,131,386,130,514,2],"htmleditor":[2015,1923,899,789,131,1],"i18n":[2015,1923,899,131,386,130],"table":[2015,1923,899,789,386,256],"theme":[2015,789,16],"tree":[2015,789,4],"virtuallist":[2015,1923,899,789,514,512]},
  packages : {"1":{"uris":["__out__:showcase.a1571ae7353e.js"]},"2":{"uris":["__out__:showcase.3b51293dbe73.js"]},"4":{"uris":["__out__:showcase.f1646053c433.js"]},"16":{"uris":["__out__:showcase.ef22f1b76df0.js"]},"130":{"uris":["__out__:showcase.9abd5a8f1c50.js"]},"131":{"uris":["__out__:showcase.a29b074e4991.js"]},"256":{"uris":["__out__:showcase.76cf0ac85d7d.js"]},"386":{"uris":["__out__:showcase.38bdd3f8f902.js"]},"512":{"uris":["__out__:showcase.6307b447e28f.js"]},"514":{"uris":["__out__:showcase.e3c992aeadbd.js"]},"789":{"uris":["__out__:showcase.67e0964e6719.js"]},"899":{"uris":["__out__:showcase.bc6d95e2ff7a.js"]},"1024":{"uris":["__out__:showcase.647c3362672a.js"]},"1923":{"uris":["__out__:showcase.9461afc24eb9.js"]},"2015":{"uris":["__out__:showcase.a8109ab0f38f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {"data":true,"form":true,"htmleditor":true,"i18n":true,"table":true,"theme":true,"tree":true,"virtuallist":true},
  bootIsInline : true,
...
this.set({name:j,part:a,icon:c,contentClass:d,description:showcase.page.DescriptionBuilder.build(j,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:f+s+k+g+o,__Lh:{"Text Formatting":i,"Alignment":v,"Lists":h,"Redo/Undo":m},__Ld:{"Inserting":p},__Le:{"pages/gui_toolkit/ui_html_editing.html":t},__Lf:{"#bom~HtmlArea.html":b,"#widget~HtmlArea.html":e},__Lg:{"#qx.bom.htmlarea":q,"#qx.ui.toolbar":l,"#qx.ui.menubar":r,"#qx.ui.menu":u}}});
})();
...
},members:{__Kk:null,__Kl:null,_createView:function(){var bt=new qx.ui.layout.Grid();
bt.setRowFlex(1,1);
...
bn.addListener(f,this.__uc,this);
bn.addListener(g,this.__Kn,this);
bn.addListener(h,this.__Km,this);
bn.addListener(k,this.__Kp,this);
bn.addListener(j,this.__Ko,this);
...
bs.addListener(f,this.__uc,this);
bs.addListener(g,this.__Kn,this);
bs.addListener(h,this.__Km,this);
bs.addListener(k,this.__Kp,this);
bs.addListener(j,this.__Ko,this);
...
return bu;
},__Km:function(e){var bw=e.getData(m);
...
}}},__Kn:function(e){var bA=e.getTarget();
var bz=bA.getSelection().concat();
e.addData(m,bz);
},__uc:function(e){e.addType(m);
e.addAction(z);
var bB=e.getTarget().getSelection()[0];
this.__Kk.set({label:bB.getLabel(),icon:bB.getIcon(),width:bB.getBounds().width});
},__Ko:function(e){this.__Kl&&this.__Kl.removeState(n);
this.__Kk.setDomPosition(-1000,-1000);
},__Kp:function(e){var bC=e.getOriginalTarget();

if(bC instanceof qx.ui.form.ListItem){if(bC!=this.__Kl){this.__Kl&&this.__Kl.removeState(n);
bC.addState(n);
this.__Kl=bC;
}}else{this.__Kl&&this.__Kl.removeState(n);
}this.__Kk.setDomPosition(e.getDocumentLeft()+15,e.getDocumentTop()+15);
}}});
})();
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="showcase.Application",a="engine.version";
...
(function(){var k="complete",j="display",h="_applySelectedPage",g="Boolean",f="showcase/images/welcome.png",e="showcase.Application",d="stack",c="showcase/images/loading66.gif",b="selection[0]",a="selection[0].readyState",I="none",H="__rn",G="value",F="__Lm",E="selection[0].description",D="showcase",C="name",B="icon",A="selectedPage",z="showcase.Page",r="state",s="_applyShowLoadIndicator",p="en_US",q="page-preview",n="50%",o="mshtml",l="engine.name",m="update",t="block",u="selection[0].part",w="__oK",v="__cd",y="__Ll",x="showLoadIndicator";
qx.Class.define(e,{extend:qx.application.Inline,properties:{selectedPage:{check:z,apply:h,nullable:true},showLoadIndicator:{check:g,init:false,apply:s}},members:{__cd:null,__Lk:null,__rn:null,__oK:null,__Ll:null,__Lm:null,main:function(){qx.application.Inline.prototype.main.call(this);
...
this.__cd=new qx.ui.container.Stack();
this.__cd.set({appearance:d,maxWidth:600,allowGrowX:false});
J.add(this.__cd,{row:T,column:0});
var N=new qx.ui.basic.Image(f).set({allowGrowX:true,allowGrowY:true,allowShrinkX:true,padding:[5,0,0,180]});
this.__cd.add(N);
this.__rn=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var Q=new qx.ui.basic.Image(c).set({marginLeft:-33});
this.__rn.add(Q,{left:n,top:200});
this.__cd.add(this.__rn);
this.__oK=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
this.__cd.add(this.__oK);
this.__Lm=new showcase.ui.Description();
J.add(this.__Lm,{row:T++,column:1});
this.__Lm.exclude();
var R=new qx.data.Array();
R.push(new showcase.page.table.Page(),new showcase.page.form.Page(),new showcase.page.virtuallist.Page(),new showcase.page.databinding.Page(),new showcase.page.tree.Page(),new showcase.page.theme.Page(),new showcase.page.i18n.Page(),new showcase.page.dragdrop.Page(),new showcase.page.htmleditor.Page());
var S=new qx.data.controller.List(R,K,C);
S.setIconPath(B);
S.bind(b,this,A);
S.bind(E,this.__Lm,G);
S.bind(a,this,x,{converter:function(U){return U!==k;
}});
...
}}},_applyShowLoadIndicator:function(W){if(W){this.__cd.setSelection([this.__rn]);
}else{this.__cd.setSelection([this.__oK]);
...
this.__Ln();
}}},_showPage:function(bb){this.__Lm.show();
bb.load(function(bc){if(this.getSelectedPage()==bc){var bd=bc.getContent().getView();
this.__oK.add(bd,{edge:0});
bd.show();
this.__Lo(bd);
}},this);
},__Ln:function(){if(this.__Ll){this.__Ll.cancel();
this.__Ll.dispose();
this.__Ll=null;
}},__Lo:function(be){if(qx.core.Environment.get(l)==o){return;
}be.getContentElement().setStyle(j,I,true);
this.__Ln();
qx.event.Timer.once(function(){var bf=be.getContentElement().getDomElement();
this.__Ll=new qx.fx.effect.core.Fade(bf);
this.__Ll.set({from:0,to:1});
this.__Ll.addListenerOnce(m,function(){be.getContentElement().setStyle(j,t);
},this);
this.__Ll.start();
},this,0);
}},destruct:function(){this._disposeObjects(v,H,w,F,y);
}});
})();
...
}},properties:{title:{check:k,event:g,nullable:true,apply:c},state:{check:k,event:d,nullable:true,apply:e}},members:{__yf:null,_applyState:function(n,o){this._writeState(n);
...
if(this.__yf[u]!=null){this.setTitle(this.__yf[u]);
...
this.set({name:j,part:o,icon:e,contentClass:f,description:showcase.page.DescriptionBuilder.build(j,this.__Lc,null,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:v+q+g+t+a+c+i,__Ld:{"States":h+p,"Decorators":k+b+n},__Le:{"pages/gui_toolkit/ui_theming.html":j,"pages/gui_toolkit/ui_appearance.html":s,"pages/gui_toolkit/ui_custom_themes.html":d,"pages/gui_toolkit/ui_decorators.html":m},__Lf:{"#ui~Decoration.html":u},__Lg:{"#qx.theme":l}}});
})();
...
qx.Class.define(g,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(s,t,u){this.__mJ=s;
s.style.overflow=f;
s.style.textAlign=b;
this.__vS=t||false;
this.__vT=u||false;
...
},members:{__vS:false,__vT:false,__mJ:null,__vU:function(){if(this.__vS||this.__vT){var v=qx.bom.element.Dimension.getSize(this.__mJ);

if(this.__vS&&v.width<1){throw new Error("The root element "+this.__mJ+" of "+this+" needs a width when its width size should be used!");
}
if(this.__vT){if(v.height<1){throw new Error("The root element "+this.__mJ+" of "+this+" needs a height when its height size should be used!");
}if(v.height>=1&&qx.bom.element.Style.get(this.__mJ,n,3)==m){qx.bom.element.Style.set(this.__mJ,n,v.height+l);
}}qx.event.Registration.addListener(this.__mJ,r,this._onResize,this);
}},_createContainerElement:function(){var w=this.__mJ;

if(this.__vS||this.__vT){var A=document.createElement(d);
w.appendChild(A);
...
if((E.oldWidth!==E.width)&&this.__vS||(E.oldHeight!==E.height)&&this.__vT){qx.ui.core.queue.Layout.add(this);
...
}},_computeSizeHint:function(){var J=this.__vS;
var G=this.__vT;
...
if(J){var I=K.getContentWidth(this.__mJ);
F.width=I;
F.minWidth=I;
F.maxWidth=I;
}
if(G){var H=K.getContentHeight(this.__mJ);
F.height=H;
F.minHeight=H;
F.maxHeight=H;
}return F;
}},defer:function(L,M){qx.ui.core.MLayoutHandling.remap(M);
},destruct:function(){qx.event.Registration.removeListener(this.__mJ,r,this._onResize,this);
this.__mJ=null;
}});
})();
...
this.set({name:j,part:w,icon:u,contentClass:a,description:showcase.page.DescriptionBuilder.build(j,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:v+e,__Lh:{"Selection":d,"Text":q,"Buttons":m,"MenuButton":i},__Ld:{"Widgets":p,"Keyboard Navigation":n},__Le:{"pages/gui_toolkit/ui_form_handling.html":o},__Lf:{"#ui~FormRenderer.html":r,"#ui~FormRendererCustom.html":z,"#ui~FormRendererDouble.html":c,"#ui~FormRendererPlaceholder.html":k,"#ui~FormValidator.html":x,"#ui~MultiPageForm.html":b,"#showcase~Form.html":g,"#data~FormController.html":t,"#data~Form.html":f},__Lg:{"#qx.ui.form":l,"#qx.ui.form.renderer":y,"#qx.data.controller.Form":h}}});
})();
...
qx.Class.define(j,{extend:qx.ui.root.Abstract,construct:function(n){this.__nO=n;
qx.ui.root.Abstract.call(this);
this._setLayout(new qx.ui.layout.Basic());
this.setZIndex(10000);
qx.ui.core.queue.Layout.add(this);
this.addListener(k,this.__qq,this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
if((qx.core.Environment.get(m)==i)){this.setKeepFocus(true);
}},members:{__lh:null,__nO:null,_createContainerElement:function(){var p=this.__nO.createElement(l);
this.__nO.body.appendChild(p);
...
},__qq:function(e){this.getContainerElement().setStyles({width:0,height:0});
...
}}},destruct:function(){this.__nO=null;
}});
})();
...
this.set({name:j,part:C,icon:m,contentClass:s,description:showcase.page.DescriptionBuilder.build(j,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:e+f+r+w+u+n,__Lh:{"Sorting":c,"Reordering":x,"Column Resizing":p,"Hide Columns":o,"Table Resize":t},__Ld:{"Cell Renderer":d,"Header Renderer":y},__Le:{"pages/widget/table_remote_model.html":z},__Lf:{"#table~Table.html":q,"#table~Table_Cell_Editor.html":A,"#table~Table_Conditional.html":v,"#table~Table_Context_Menu.html":l,"#table~Table_Events.html":k,"#table~Table_Filtered_Model.html":g,"#table~Table_Huge.html":h,"#table~Table_Meta_Columns.html":b,"#table~Table_Resize_Columns.html":i,"#table~Table_Selection.html":D,"#table~Table_Window_Editor.html":a},__Lg:{"#qx.ui.table.Table":j}}});
})();
...
},properties:{appearance:{refine:true,init:k},allowGrowX:{refine:true,init:false},nativeContextMenu:{init:true,refine:true},allowGrowY:{refine:true,init:true}},members:{__Lp:function(){var D=[A,t,i,C,u,z,j,n,a,i,j,s,B,j,y,b,v,f,h,j,d,e,g,q,l,h,j,x,m,j,p,i,j,c,w,j];
qx.bom.Stylesheet.createElement(D.join(o));
}}});
})();
(function(){var f="resize",d="interval",c="__lh",b="body",a="qx.event.handler.ElementResize";
qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);
this.__dy=g;
this.__vV={};
this.__lh=new qx.event.Timer(200);
this.__lh.addListener(d,this._onInterval,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__vV:null,__dy:null,__lh:null,canHandleEvent:function(h,i){return h.tagName.toLowerCase()!==b;
...
if(qx.lang.Object.isEmpty(r)){this.__lh.stop();
}}},_onInterval:function(e){var u=this.__vV;
...
y.width=w;
y.height=v;
}}}},destruct:function(){this.__dy=this.__vV=null;
this._disposeObjects(c);
...
this.set({name:j,part:u,icon:e,contentClass:a,description:showcase.page.DescriptionBuilder.build(j,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:t+w+g+l+m,__Lh:{"Detail View":b,"Change Tweet":A},__Ld:{"Loading Data":h,"Binding":q},__Le:{"pages/data_binding/data_binding.html":r,"pages/data_binding/single_value_binding.html":k,"pages/data_binding/controller.html":x,"pages/data_binding/stores.html":v},__Lf:{"#data~SingleValueBinding.html":d,"#data~ListControllerWith3Widgets.html":n,"#data~TreeController.html":s,"#data~FormController.html":i,"#data~Flickr.html":y},__Lg:{"#qx.data":c,"#qx.data.store.Jsonp":f,"#qx.data.controller.List":o,"#qx.data.controller.Object":p}}});
})();
...
this.set({name:g,part:c,icon:k,contentClass:f,description:showcase.page.DescriptionBuilder.build(p,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:d+b+m+e,__Lh:{"Drag":a,"Reorder":j,"Move":n},__Ld:null,__Le:{"pages/gui_toolkit/ui_dragdrop.html":p},__Lf:{"#ui~DragDrop.html":l},__Lg:{"#qx.ui.core.Widget~drag":h,"#qx.ui.core.DragDropCursor":i}}});
})();
...
}},properties:{baseImage:{check:d,nullable:true,apply:f}},members:{__nx:null,__BD:null,__pj:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__nx;
...
}}}},tint:function(D,E){},_applyBaseImage:function(F,G){var H=qx.util.ResourceManager.getInstance();
...
var K=M[1];
var I=M[2];
var N=this.__BD={t:K+"-t"+I,b:K+"-b"+I,c:K+"-c"+I,l:K+"-l"+I,r:K+"-r"+I};
this.__pj={top:H.getImageHeight(N.t),bottom:H.getImageHeight(N.b),left:H.getImageWidth(N.l),right:H.getImageWidth(N.r)};
}}},destruct:function(){this.__nx=this.__BD=this.__pj=null;
}});
})();
...
this.__yh();
},members:{__yg:null,__yh:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__yg=qx.lang.Function.bind(this.__uP,this);
qx.bom.Event.addNativeListener(window,d,this.__yg);
}else{qx.event.Idle.getInstance().addListener(c,this.__uP,this);
}},__yi:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,d,this.__yg);
}else{qx.event.Idle.getInstance().removeListener(c,this.__uP,this);
}},__uP:function(){var e=this._readState();
...
this.__ym();
},members:{__yj:null,__yk:false,__yl:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);
this.__yl=this._getHash();
},_setHash:function(o){qx.bom.History.prototype._setHash.call(this,o);
this.__yl=this._encode(o);
},_readState:function(){if(!this.__yk){return this._decode(this._getHash());
}var p=this.__yj.contentWindow.document;
...
try{var s=this.__yj.contentWindow.document;
s.open();
s.write(f+r+d);
s.close();
}catch(t){}},__ym:function(){this.__yp(function(){qx.event.Idle.getInstance().addListener(n,this.__uP,this);
});
},__uP:function(e){var v=null;
var u=this._getHash();

if(!this.__yo(u)){v=this.__yn(u);
}else{v=this._readState();
}
if(qx.lang.Type.isString(v)&&v!=this.getState()){this._onHistoryLoad(v);
}},__yn:function(w){w=this._decode(w);
this._writeState(w);
return w;
},__yo:function(x){return qx.lang.Type.isString(x)&&x==this.__yl;
},__yp:function(y){this.__yj=this.__yq();
document.body.appendChild(this.__yj);
this.__yr(function(){this._writeState(this.getState());

if(y){y.call(this);
}},this);
},__yq:function(){var z=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(h)});
z.style.visibility=a;
z.style.position=b;
z.style.left=m;
z.style.top=m;
return z;
},__yr:function(A,B,C){if(typeof C===c){C=0;
}
if(!this.__yj.contentWindow||!this.__yj.contentWindow.document){if(C>20){throw new Error("can't initialize iframe");
}qx.event.Timer.once(function(){this.__yr(A,B,++C);
},this,10);
return;
}this.__yk=true;
A.call(B||window);
}},destruct:function(){this.__yj=null;
qx.event.Idle.getInstance().addListener(n,this.__uP,this);
}});
}})();
...
if(j){this.__nw(j,l);
}if(k!=null){this.__nv.setInsets(k);
}}else{this.__nv=new qx.ui.decoration.BoxDiv(j,k,l);
}},properties:{baseImage:{check:b,nullable:true,apply:e}},members:{__nv:null,_isHorizontal:null,_setOrientation:function(m){this._isHorizontal=m==h;
},getMarkup:function(){return this.__nv.getMarkup();
},resize:function(n,o,p){this.__nv.resize(n,o,p);
},tint:function(q,r){},getInsets:function(){return this.__nv.getInsets();
},_applyInsets:function(s,t,name){var u=f+qx.lang.String.firstUp(name);
this.__nv[u](s);
},_applyBaseImage:function(v,w){if(this.__nv instanceof qx.ui.decoration.BoxDiv){this.__nv.setBaseImage(v);
}else{this.__nw(v);
}},__nw:function(x){this.__nv.setBorderImage(x);
...
this.set({name:x,part:f,icon:h,contentClass:t,description:showcase.page.DescriptionBuilder.build(j,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:v+n+c+r,__Lh:{"Change the language":l+d+a,"Change the country":u+m+w+q+o,"Open the command menu":s+z},__Ld:{"Standards based translation":p+i+y,"CLDR":"Localisation data like date and time formats are taken from the "+"<a href='http://cldr.unicode.org/'>Unicode Common Locale Data Repository</a> (CLDR). This "+"guarantees that qooxdoo uses the standardized data for even the smallest "+"countries.","Live locale switching":k},__Le:{"pages/development/internationalization.html":j},__Lf:{"#showcase~Localization.html":e},__Lg:{"#qx.locale":b}}});
})();
...
(function(){var j="Virtual List",i="You can sort the list with a custom algorithm.",h=" items and reuses them. This saves both creation time and memory.",g="List delegate",f="You can configure the used widgets or create your own.",e="You can use different selection modes (single selection,",d=" because the virtual infrastructure only creates widgets for visible",c="showcase/virtuallist/icon.png",b="Custom rendering example",a="showcase.page.virtuallist.Content",y=" multi selection).",x="Using the virtual infrastructure has considerable",w="Select a user and change values for e.g. status.",v=" advantages when there is a huge amount of model items to render",u="Filtering example",t="List overview",s="virtuallist",r="You can use a filter to hide model items.",q="Grouping example",p="showcase.page.virtuallist.Page",n="You can define a group for each mode item.",o="You can bind model values with the rendered widget.",l="Select a user and press the delete button.",m="Click on the arrow of a group item to close the group.",k="Press the add user button and enter name and group.";
qx.Class.define(p,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:j,part:s,icon:c,contentClass:a,description:showcase.page.DescriptionBuilder.build(j,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:x+v+d+h,__Lh:{"Close Group":m,"Change User Data":w,"Add User":k,"Delete User":l},__Ld:{"Filtering":r,"Sorting":i,"Grouping":n,"Selection":e+y,"Data Binding":o,"Custom Rendering":f},__Le:{"pages/widget/virtuallist.html":j},__Lf:{"#virtual~List.html":t,"#virtual~ListWithFilter.html":u,"#virtual~ExtendedList.html":b,"#virtual~GroupedList.html":q},__Lg:{"#qx.ui.list.List":j,"#qx.ui.list.core.IListDelegate":g}}});
})();
...
qx.Class.define(p,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:u,part:d,icon:f,contentClass:g,description:showcase.page.DescriptionBuilder.build(u,this.__Lc,this.__Lh,this.__Ld,this.__Le,this.__Lf,this.__Lg)});
},members:{__Lc:r+m+b,__Lh:{"Expand":e,"Resize":k,"Selection":o},__Ld:{"Configurable":q,"Scrolling":c,"Multi Columns":t},__Le:{"pages/widget/tree.html":a},__Lf:{"#widget~Tree.html":s,"#widget~Tree_Columns.html":j,"#data~TreeController.html":l,"#data~JsonToTree.html":n,"#data~ExtendedTree.html":h},__Lg:{"#qx.ui.tree":i}}});
})();
...
(function(){var j="1.6",i="",h="http://demo.qooxdoo.org/",g="<ul>",f="</ul>",e="<h1>",d="<li><a href='",c="<h2>Features</h2>",b="</div>",a="</h1>",A="</strong>: ",z="</a></li>",y="<h2>Try This</h2>",x="<h2>Api</h2>",w="<h2>Documentation</h2>",v="http://manual.qooxdoo.org/",u="/",t="<h2>Demos</h2>",s="showcase.page.DescriptionBuilder",r="/demobrowser/",p="' target='_blank'>",q="<div id='description'>",n="/apiviewer/",o="<p>",l="</p>",m="</li>",k="<li><strong>";
qx.Class.define(s,{statics:{_demoPrefix:h+j+r,_apiPrefix:h+j+n,_manualPrefix:v+j+u,build:function(B,C,D,E,F,G,H){var I=[];
I.push(q,e,B,a,o,C,l);

if(D){I.push(y,this.__Lj(D));
}
if(E){I.push(c,this.__Lj(E));
}
if(F){I.push(w,this.__Li(this._manualPrefix,F));
}
if(G){I.push(t,this.__Li(this._demoPrefix,G));
}
if(H){I.push(x,this.__Li(this._apiPrefix,H));
}I.push(b);
return I.join(i);
},__Li:function(J,K){var L=[g];

for(var M in K){L.push(d,J,M,p,K[M],z);
}L.push(f);
return L.join(i);
},__Lj:function(N){var O=[g];
