...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.Fingers-qx.theme.Modern.6d5e60e5d07c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(u,{extend:qx.application.Native,members:{__NB:null,__NC:null,main:function(){qx.application.Native.prototype.main.call(this);
...
this.__NB[i]=parseInt(K.target.style.left)-K.pageX;
this.__NC[i]=parseInt(K.target.style.top)-K.pageY;
}},_onTouchMove:function(e){var N=e.getAllTouches();

for(var i=0;i<N.length;i++){var M=N[i];

if(N.target==document.body){continue;
}qx.bom.element.Style.setStyles(M.target,{"left":(M.pageX+this.__NB[i])+l,"top":(M.pageY+this.__NC[i])+l});
}e.stop();
}}});
})();
