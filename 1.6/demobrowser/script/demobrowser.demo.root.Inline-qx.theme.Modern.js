...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline-qx.theme.Modern.7c71917cf749.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},members:{__vS:false,__vT:false,__mJ:null,__vU:function(){if(this.__vS||this.__vT){var x=qx.bom.element.Dimension.getSize(this.__mJ);

if(this.__vS&&x.width<1){throw new Error("The root element "+this.__mJ+" of "+this+" needs a width when its width size should be used!");
}
if(this.__vT){if(x.height<1){throw new Error("The root element "+this.__mJ+" of "+this+" needs a height when its height size should be used!");
}if(x.height>=1&&qx.bom.element.Style.get(this.__mJ,p,3)==o){qx.bom.element.Style.set(this.__mJ,p,x.height+n);
}}qx.event.Registration.addListener(this.__mJ,t,this._onResize,this);
}},_createContainerElement:function(){var y=this.__mJ;

if(this.__vS||this.__vT){var C=document.createElement(b);
y.appendChild(C);
...
if((G.oldWidth!==G.width)&&this.__vS||(G.oldHeight!==G.height)&&this.__vT){qx.ui.core.queue.Layout.add(this);
}},_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();
}if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();
}},_computeSizeHint:function(){var L=this.__vS;
var I=this.__vT;
...
if(L){var K=M.getContentWidth(this.__mJ);
H.width=K;
H.minWidth=K;
H.maxWidth=K;
}
if(I){var J=M.getContentHeight(this.__mJ);
H.height=J;
H.minHeight=J;
H.maxHeight=J;
}return H;
}},defer:function(N,O){qx.ui.core.MLayoutHandling.remap(O);
},destruct:function(){qx.event.Registration.removeListener(this.__mJ,t,this._onResize,this);
this.__mJ=null;
}});
})();
