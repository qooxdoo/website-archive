...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Context_Menu-qx.theme.Simple.482e306566ad.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__Hv=[];
this.__Hw=[];
},members:{__Hv:null,__Hw:null,setContextMenuHandler:function(m,n,o){this.__Hv[m]=n;
this.__Hw[m]=o||this;
},getContextMenuHandler:function(p){return this.__Hv[p];
