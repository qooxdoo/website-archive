...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Table","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table-qx.theme.Simple.2c0a85648361.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="white",c="#EEE",b="vertical",a="__OG";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__OG:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
h.getPane().addLayer(new qx.ui.virtual.layer.Row(d,c));
h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(f));
h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));
h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));
this.__OG=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__OG.getCellProperties(j+g+k);
