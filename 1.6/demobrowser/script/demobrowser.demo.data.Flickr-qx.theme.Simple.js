...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr-qx.theme.Simple.789ba5a3640a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.data.store.Jsonp.call(this,this.__Nm(R));
},members:{searchForTag:function(S){if(S!=h){this.setUrl(this.__Nm(S));
}},__Nm:function(T){if(!T){return;
}var U=u+T;
U+=m;
return U;
}}});
