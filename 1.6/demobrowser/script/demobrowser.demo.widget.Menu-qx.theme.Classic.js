...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Classic.03fd81f82109.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cf="execute",ce="changeValue",cd="icon/16/actions/edit-cut.png",cc="changeSelection",cb="icon/16/actions/edit-paste.png",ca="Copy",bY="Paste",bX="icon/16/actions/edit-copy.png",bW="Cut",bV="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",cm="Print",cn="Open",ck="icon/16/actions/document-new.png",cl="__Fy",ci="Online Forum",cj="icon/16/actions/format-justify-fill.png",cg="Search in files",ch="C",co="__OY",cp="Left aligned",bO="Perl",bN="View",bQ="C Dialect",bP="Info...",bS="Save as...",bR="Show line numbers",bU="Quickstart",bT="__OX",bM="icon/16/actions/contact-new.png",bL="Actions",a="Show console",b="Search",c="Help",d="Show status bar",f="icon/16/actions/format-justify-left.png",g="ANSI to OEM",h="__Pa",j="Centered",k="Website 3",l="Edit",ct="icon/16/actions/format-justify-center.png",cs="icon/16/actions/go-previous.png",cr="C Sharp",cq="Close",cx="Split Button",cw="Website 2",cv="icon/16/actions/document-save-as.png",cu="Python",cz="icon/16/apps/utilities-help.png",cy="Show tree",K="Options",L="Spaces to tabs",I="Right aligned",J="__Pb",O="Action 1",P="OEM to ANSI",M="Line 431",N="JavaScript",G="icon",H="Action 2",t="Folder ",s="XML",v="Line 313",u="Paragraph",p="demobrowser.demo.widget.Menu",o="icon/16/actions/application-exit.png",r="__Pc",q="C Plus Plus",n="Line 26",m="Item ",U="ASCII table",V="Option 1",W="Search next...",X="Line 12",Q="Action 3",R="Replace in files",S="Uppercase",T="Ctrl+P",Y="__Pd",ba="Topics",D="Panes",C="Justified",B="Ctrl+X",A="Show macros",z="Search previous...",y="Back",x="main",w="Show ruler",F="icon/16/actions/format-justify-right.png",E="icon/16/actions/go-next.png",bb="Ctrl+Z",bc="command ",bd="Option 3",be="Next",bf="Show tags",bg="Capitals",bh="Format",bi="File",bj="Show tabs",bk="Tabs to spaces",by="Search...",bx="Line 1039",bw="Option 2",bv="Objective C",bC="Exit",bB="move to",bA="Ctrl+S",bz="Syntax",bE="Ctrl+C",bD="Website 1",bJ="Menu Button",bK="Line 30",bH="Lowercase",bI="Replace",bF="__FF",bG="HTML";
qx.Class.define(p,{extend:qx.application.Standalone,members:{__OX:null,__OY:null,__Pa:null,__Fy:null,__FF:null,__Pb:null,__Pc:null,__Pd:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cB=new qx.ui.container.Scroll();
var cA=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cA.setPadding(20);
cA.setAllowStretchX(false);
cB.add(cA);
this.getRoot().add(cB,{edge:0});
this.createCommands();
cA.add(this.getMenuButton(),{left:20,top:20});
cA.add(this.getSplitButton(),{left:150,top:20});
cA.add(this.getMenuBar(),{left:20,top:100});
cA.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var cC=new qx.ui.menu.Menu();
var cD=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){cD.add(new qx.ui.menu.Button(t+(i+1)));
}cC.add(new qx.ui.menu.Button(bB,null,null,cD));
cC.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cC.add(new qx.ui.menu.Button(bc+(i+1)));
}return cC;
...
},createCommands:function(){this.__OX=new qx.ui.core.Command("Ctrl+N");
this.__OX.addListener(cf,this.debugCommand);
this.__OY=new qx.ui.core.Command("Ctrl+O");
this.__OY.addListener(cf,this.debugCommand);
this.__Pa=new qx.ui.core.Command(bA);
this.__Pa.addListener(cf,this.debugCommand);
this.__Fy=new qx.ui.core.Command(bb);
this.__Fy.addListener(cf,this.debugCommand);
this.__FF=new qx.ui.core.Command("Ctrl+R");
this.__FF.addListener(cf,this.debugCommand);
this.__Pb=new qx.ui.core.Command(B);
this.__Pb.addListener(cf,this.debugCommand);
this.__Pc=new qx.ui.core.Command(bE);
this.__Pc.addListener(cf,this.debugCommand);
this.__Pd=new qx.ui.core.Command(T);
this.__Pd.addListener(cf,this.debugCommand);
this.__Pd.setEnabled(false);
},getMenuButton:function(){var cE=new qx.ui.menu.Menu;
cE.add(new qx.ui.menu.RadioButton(V));
cE.add(new qx.ui.menu.RadioButton(bw));
cE.add(new qx.ui.menu.RadioButton(bd));
var cM=new qx.ui.menu.Menu;
cM.add(new qx.ui.menu.RadioButton(O));
cM.add(new qx.ui.menu.RadioButton(H));
cM.add(new qx.ui.menu.RadioButton(Q));
var cL=new qx.ui.form.RadioGroup;
cL.add.apply(cL,cE.getChildren());
cL.addListener(cc,this.debugRadio);
var cJ=new qx.ui.form.RadioGroup;
cJ.add.apply(cJ,cM.getChildren());
cJ.addListener(cc,this.debugRadio);
var cH=new qx.ui.menu.Menu();
var cK=new qx.ui.menu.Button(bt,bn,this.__Fy);
var cR=new qx.ui.menu.Button(br,bl,this.__FF);
var cG=new qx.ui.menu.Button(bW,cd,this.__Pb);
var cO=new qx.ui.menu.Button(ca,bX,this.__Pc);
var cI=new qx.ui.menu.Button(bY,cb,this.__Pd);
var cF=new qx.ui.menu.Button(K,bV,null,cE);
var cP=new qx.ui.menu.Button(bL,bM,null,cM);
var cN=new qx.ui.menu.Button(cm,bp);
cK.addListener(cf,this.debugButton);
cR.addListener(cf,this.debugButton);
cG.addListener(cf,this.debugButton);
cO.addListener(cf,this.debugButton);
cI.addListener(cf,this.debugButton);
cF.addListener(cf,this.debugButton);
cP.addListener(cf,this.debugButton);
cN.addListener(cf,this.debugButton);
cH.add(cK);
cH.add(cR);
cH.addSeparator();
cH.add(cG);
...
cH.addSeparator();
cH.add(cN);
var cQ=new qx.ui.form.MenuButton(bJ,bq,cH);
return cQ;
},getSplitButton:function(){var cS=new qx.ui.menu.Menu;
var cW=new qx.ui.menu.Button(bD);
var cU=new qx.ui.menu.Button(cw);
var cV=new qx.ui.menu.Button(k);
cS.setMinWidth(120);
cW.addListener(cf,this.debugButton);
cU.addListener(cf,this.debugButton);
cV.addListener(cf,this.debugButton);
cS.add(cW);
cS.add(cU);
cS.add(cV);
var cT=new qx.ui.form.SplitButton(cx,bq,cS);
cT.addListener(cf,this.debugButton);
return cT;
},getMenuBar:function(){var dc=new qx.ui.container.Composite(new qx.ui.layout.Grow);
dc.setDecorator(x);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
dc.add(toolbar);
var dl=new qx.ui.toolbar.Part;
var db=new qx.ui.toolbar.Part;
var df=new qx.ui.toolbar.Part;
toolbar.add(dl);
toolbar.add(db);
toolbar.addSpacer();
toolbar.add(df);
var dk=new qx.ui.toolbar.SplitButton(y,cs,this.getBackMenu());
var dh=new qx.ui.toolbar.SplitButton(be,E,this.getForwardMenu());
var da=new qx.ui.toolbar.Button(bu,ck,this.__OX);
var de=new qx.ui.toolbar.Button(cn,bo,this.__OY);
var dj=new qx.ui.toolbar.Button(bm,bs,this.__Pa);
dk.addListener(cf,this.debugButton);
dh.addListener(cf,this.debugButton);
da.addListener(cf,this.debugButton);
de.addListener(cf,this.debugButton);
dj.addListener(cf,this.debugButton);
dl.add(dk);
dl.add(dh);
dl.addSeparator();
dl.add(da);
...
dl.add(dj);
dl.setShow(G);
var dd=new qx.ui.toolbar.MenuButton(bi);
var cY=new qx.ui.toolbar.MenuButton(l);
var cX=new qx.ui.toolbar.MenuButton(b);
var dm=new qx.ui.toolbar.MenuButton(bN);
var di=new qx.ui.toolbar.MenuButton(bh);
dd.setMenu(this.getFileMenu());
cY.setMenu(this.getEditMenu());
cX.setMenu(this.getSearchMenu());
dm.setMenu(this.getViewMenu());
di.setMenu(this.getFormatMenu());
db.add(dd);
db.add(cY);
db.add(cX);
db.add(dm);
db.add(di);
var dg=new qx.ui.toolbar.MenuButton(c);
dg.setMenu(this.getHelpMenu());
df.add(dg);
return dc;
},getBackMenu:function(){var dp=new qx.ui.menu.Menu;
var dq=new qx.ui.menu.Button(v);
var ds=new qx.ui.menu.Button(bx);
var dn=new qx.ui.menu.Button(X);
var dr=new qx.ui.menu.Button(n);
dq.addListener(cf,this.debugButton);
ds.addListener(cf,this.debugButton);
dn.addListener(cf,this.debugButton);
dr.addListener(cf,this.debugButton);
dp.add(dq);
dp.add(ds);
dp.add(dn);
dp.add(dr);
return dp;
},getForwardMenu:function(){var dt=new qx.ui.menu.Menu;
var du=new qx.ui.menu.Button(M);
var dv=new qx.ui.menu.Button(bK);
du.addListener(cf,this.debugButton);
dv.addListener(cf,this.debugButton);
dt.add(du);
dt.add(dv);
return dt;
},getFileMenu:function(){var dy=new qx.ui.menu.Menu;
var dw=new qx.ui.menu.Button(bu,ck,this.__OX);
var dA=new qx.ui.menu.Button(cn,bo,this.__OY);
var dz=new qx.ui.menu.Button(cq);
var dD=new qx.ui.menu.Button(bm,bs,this.__Pa);
var dC=new qx.ui.menu.Button(bS,cv);
var dB=new qx.ui.menu.Button(cm,bp);
var dx=new qx.ui.menu.Button(bC,o);
dw.addListener(cf,this.debugButton);
dA.addListener(cf,this.debugButton);
dz.addListener(cf,this.debugButton);
dD.addListener(cf,this.debugButton);
dC.addListener(cf,this.debugButton);
dB.addListener(cf,this.debugButton);
dx.addListener(cf,this.debugButton);
dy.add(dw);
dy.add(dA);
dy.add(dz);
dy.add(dD);
...
dy.add(dx);
return dy;
},getEditMenu:function(){var dF=new qx.ui.menu.Menu;
var dI=new qx.ui.menu.Button(bt,bn,this.__Fy);
var dH=new qx.ui.menu.Button(br,bl,this.__FF);
var dE=new qx.ui.menu.Button(bW,cd,this.__Pb);
var dJ=new qx.ui.menu.Button(ca,bX,this.__Pc);
var dG=new qx.ui.menu.Button(bY,cb,this.__Pd);
dI.addListener(cf,this.debugButton);
dH.addListener(cf,this.debugButton);
dE.addListener(cf,this.debugButton);
dJ.addListener(cf,this.debugButton);
dG.addListener(cf,this.debugButton);
dF.add(dI);
dF.add(dH);
dF.addSeparator();
dF.add(dE);
...
dF.add(dG);
return dF;
},getSearchMenu:function(){var dN=new qx.ui.menu.Menu;
var dL=new qx.ui.menu.Button(by,bV);
var dQ=new qx.ui.menu.Button(W);
var dM=new qx.ui.menu.Button(z);
var dP=new qx.ui.menu.Button(bI);
var dK=new qx.ui.menu.Button(cg,bV);
var dO=new qx.ui.menu.Button(R);
dM.setEnabled(false);
dL.addListener(cf,this.debugButton);
dQ.addListener(cf,this.debugButton);
dM.addListener(cf,this.debugButton);
dP.addListener(cf,this.debugButton);
dK.addListener(cf,this.debugButton);
dO.addListener(cf,this.debugButton);
dN.add(dL);
dN.add(dQ);
dN.add(dM);
dN.add(dP);
...
dN.add(dO);
return dN;
},getViewMenu:function(){var dR=new qx.ui.menu.Menu;
var dT=new qx.ui.menu.Button(D,null,null,this.getPanesMenu());
var dW=new qx.ui.menu.Button(bz,null,null,this.getSyntaxMenu());
var dV=new qx.ui.menu.CheckBox(w);
var dU=new qx.ui.menu.CheckBox(bR);
var dS=new qx.ui.menu.Button(U);
dV.addListener(ce,this.debugCheckBox);
dU.addListener(ce,this.debugCheckBox);
dS.addListener(cf,this.debugButton);
dR.add(dT);
dR.add(dW);
dR.addSeparator();
...
var eb=new qx.ui.menu.CheckBox(bj);
var ed=new qx.ui.menu.CheckBox(d);
var ee=new qx.ui.menu.CheckBox(cy);
var ea=new qx.ui.menu.CheckBox(A);
var ec=new qx.ui.menu.CheckBox(bf);
var dX=new qx.ui.menu.CheckBox(a);
eb.setValue(true);
ed.setValue(true);
ea.setValue(true);
eb.addListener(ce,this.debugCheckBox);
ed.addListener(ce,this.debugCheckBox);
ee.addListener(ce,this.debugCheckBox);
ea.addListener(ce,this.debugCheckBox);
ec.addListener(ce,this.debugCheckBox);
dX.addListener(ce,this.debugCheckBox);
dY.add(ed);
dY.add(eb);
dY.addSeparator();
dY.add(ee);
...
var ef=new qx.ui.menu.RadioButton(bG);
var eh=new qx.ui.menu.RadioButton(s);
var eg=new qx.ui.menu.RadioButton(N);
var ei=new qx.ui.menu.Button(bQ,null,null,this.getSyntaxCMenu());
var em=new qx.ui.menu.RadioButton(bO);
var ek=new qx.ui.menu.RadioButton(cu);
ej.add(ef);
ej.add(eh);
ej.add(eg);
ej.add(ei);
...
el.addListener(cc,this.debugRadio);
return ej;
},getSyntaxCMenu:function(){var eo=new qx.ui.menu.Menu;
var en=new qx.ui.menu.RadioButton(ch);
var er=new qx.ui.menu.RadioButton(cr);
var eq=new qx.ui.menu.RadioButton(bv);
var ep=new qx.ui.menu.RadioButton(q);
eo.add(en);
eo.add(er);
eo.add(eq);
eo.add(ep);
return eo;
},getFormatMenu:function(){var ev=new qx.ui.menu.Menu;
var eu=new qx.ui.menu.Button(u,null,null,this.getParagraphMenu());
var ex=new qx.ui.menu.Button(bk);
var ey=new qx.ui.menu.Button(L);
var et=new qx.ui.menu.Button(S);
var ew=new qx.ui.menu.Button(bH);
var es=new qx.ui.menu.Button(bg);
var eA=new qx.ui.menu.Button(P);
var ez=new qx.ui.menu.Button(g);
ex.addListener(cf,this.debugButton);
ey.addListener(cf,this.debugButton);
et.addListener(cf,this.debugButton);
ew.addListener(cf,this.debugButton);
es.addListener(cf,this.debugButton);
eA.addListener(cf,this.debugButton);
ez.addListener(cf,this.debugButton);
ev.add(eu);
ev.add(ex);
ev.add(ey);
ev.addSeparator();
...
ev.add(ez);
return ev;
},getParagraphMenu:function(){var eB=new qx.ui.menu.Menu;
var eE=new qx.ui.menu.Button(cp,f);
var eF=new qx.ui.menu.Button(I,F);
var eC=new qx.ui.menu.Button(j,ct);
var eD=new qx.ui.menu.Button(C,cj);
eE.addListener(cf,this.debugButton);
eF.addListener(cf,this.debugButton);
eC.addListener(cf,this.debugButton);
eD.addListener(cf,this.debugButton);
eB.add(eE);
eB.add(eF);
eB.add(eC);
eB.add(eD);
return eB;
},getHelpMenu:function(){var eG=new qx.ui.menu.Menu;
var eI=new qx.ui.menu.Button(ba,cz);
var eK=new qx.ui.menu.Button(bU);
var eJ=new qx.ui.menu.Button(ci);
var eH=new qx.ui.menu.Button(bP);
eI.addListener(cf,this.debugButton);
eK.addListener(cf,this.debugButton);
eJ.addListener(cf,this.debugButton);
eH.addListener(cf,this.debugButton);
eG.add(eI);
eG.add(eK);
eG.addSeparator();
eG.add(eJ);
...
eG.add(eH);
return eG;
},getList:function(){var eL=new qx.ui.form.List;
eL.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){eL.add(new qx.ui.form.ListItem(m+i));
}return eL;
},getContextMenu:function(){var eM=new qx.ui.menu.Menu;
var eO=new qx.ui.menu.Button(bW,cd,this.__Pb);
var eP=new qx.ui.menu.Button(ca,bX,this.__Pc);
var eN=new qx.ui.menu.Button(bY,cb,this.__Pd);
eO.addListener(cf,this.debugButton);
eP.addListener(cf,this.debugButton);
eN.addListener(cf,this.debugButton);
eM.add(eO);
eM.add(eP);
eM.add(eN);
return eM;
}},destruct:function(){this._disposeObjects(bT,co,h,cl,bF,J,r,Y);
}});
})();
