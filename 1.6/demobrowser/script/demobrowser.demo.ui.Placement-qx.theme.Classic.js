...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Placement-qx.theme.Classic.84a156042c93.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(k,{extend:qx.application.Standalone,members:{__uf:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__uf=[n,p,q,l,o,b,d,m];
...
for(var i=0;i<this.__uf.length;i++){var x=new qx.ui.form.ListItem(this.__uf[i]);
v.add(x);

if(this.__uf[i]==u){z=x;
}}y.add(v);
...
for(var i=0;i<this.__uf.length;i++){B.add(new qx.ui.form.ListItem(this.__uf[i]));
}D.add(B);
