...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Modern.80c244f32962.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(k,{extend:demobrowser.demo.event.EventDemo,members:{__NA:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__NA=qx.lang.Function.bind(this.logMouseEvent,this);
...
if(B.checked){qx.bom.Event.addNativeListener(z,A[i],this.__NA);
}qx.bom.Event.addNativeListener(B,o,qx.lang.Function.bind(this.__Nz,this));
}},__Nz:function(e){var F=qx.bom.Event.getTarget(e);
var E=F.id.split(w)[1];
var C=F.checked;
var D=document.getElementById(l);

if(C){qx.bom.Event.addNativeListener(D,E,this.__NA);
}else{qx.bom.Event.removeNativeListener(D,E,this.__NA);
