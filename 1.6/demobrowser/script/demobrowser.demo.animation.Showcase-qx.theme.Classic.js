...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Showcase","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Showcase-qx.theme.Classic.5ba47dc9ec5f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="linear",q="Number",p="reverse",o="Boolean",n="none",m="wobble",l="flicker",k="pulse",j="sinodial",i="easeOutQuad",c="spring",h="easeInQuad",f="full",b="Color",a="__BK",e="#ffffff",d="qx.fx.effect.combination.ColorFlow",g="#ffffaa";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(s){qx.fx.Base.call(this,s);
this.__BK=[new qx.fx.effect.core.Highlight(s),new qx.fx.effect.core.Highlight(s)];
},properties:{startColor:{init:e,check:b},endColor:{init:g,check:b},forwardTransition:{init:r,check:[r,h,i,j,p,l,m,k,c,n,f]},backwardTransition:{init:r,check:[r,h,i,j,p,l,m,k,c,n,f]},forwardDuration:{init:1.0,check:q},backwardDuration:{init:1.0,check:q},delayBetween:{init:0.3,check:q},restoreBackground:{init:true,check:o},keepBackgroundImage:{init:false,check:o}},members:{__BL:null,__BK:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var t=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__BL={backgroundImage:qx.bom.element.Style.get(t,"backgroundImage"),backgroundColor:qx.bom.element.Style.get(t,"backgroundColor")};
this.__BK[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__BK[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__BK[0].afterFinishInternal=function(){self.__BK[1].start();
};
this.__BK[0].start();
}},destruct:function(){this._disposeArray(a);
}});
})();
(function(){var e="opacity",d="qx.fx.effect.combination.Pulsate",c="__GQ",b="__GP",a="sinodial";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
var g=this.getDuration()/6;
var h=0;
this.__GP=[new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f)];

for(var i=0,l=this.__GP.length;i<l;i++){this.__GP[i].set({duration:g,to:((h%2)!=0)?1:0,from:((h%2)!=0)?0:1,transition:a,modifyDisplay:false});
h++;
}},properties:{duration:{init:2,refine:true}},members:{__fM:null,__GP:null,__GQ:null,__GR:false,beforeSetup:function(){this.__fM=qx.bom.element.Style.get(this._getElement(),e);
},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}this.__GQ=[];
this.__GR=false;
var j=0;
...
for(var i=0,l=this.__GP.length;i<l;i++){this.__GP[i].id=j;
this.__GQ.push(this.__GP[i]);
this.__GP[i].afterFinishInternal=function(){qx.lang.Array.remove(self.__GQ,this);
if(this.id<5){self.__GP[this.id+1].start();
}else{if(self.__GR){self.end();
}}};
j++;
}this.__GP[0].start();
},end:function(){if(this.__GQ.length==0){qx.fx.Base.prototype.end.call(this);
}else{this.__GR=true;
}},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),e,this.__fM);
},_applyDuration:function(k,m){var n=k/6;

for(var i=0,l=this.__GP.length;i<l;i++){this.__GP[i].set({duration:n});
}},cancel:function(){for(var i=0,l=this.__GQ.length;i<l;i++){this.__GQ[i].cancel();
}qx.fx.Base.prototype.cancel.call(this);
}},destruct:function(){this._disposeArray(b);
this._disposeArray(c);
}});
})();
(function(){var i="__Bv",h="opacity",g="Boolean",f="none",e="__Bu",d="qx.fx.effect.combination.Puff",c="_effects",b="__Ge",a="display";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(j){qx.fx.Base.call(this,j);
this.__Bu=new qx.fx.effect.core.Scale(j);
this.__Ge=new qx.fx.effect.core.Fade(j);
this.__Bv=new qx.fx.effect.core.Parallel(this.__Bu,this.__Ge);
},properties:{modifyDisplay:{init:true,check:g}},members:{__Ge:null,__Bu:null,__Bv:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var l=this._getElement();
var k={opacity:qx.bom.element.Style.get(l,h)};
this.__Ge.afterFinishInternal=function(){var n=this._getElement();

for(var m in k){qx.bom.element.Style.set(n,m,k[m]);
}};
this.__Bu.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__Ge.set({sync:true,to:0.0,modifyDisplay:false});
this.__Bv.setDuration(this.getDuration());
this.__Bv.start();
}},destruct:function(){this._disposeArray(c);
this._disposeObjects(i,e,b);
}});
})();
...
(function(){var u="out",t="px",s="south",r="Number",q="north-west",p="west",o="in",n="north",m="south-east",l="south-west",e="east",k="north-east",h="display",c="__Bt",b="top",g="Boolean",f="block",i="left",a="__Ge",j="__Bv",d="qx.fx.effect.combination.Drop";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(v){qx.fx.Base.call(this,v);
this.__Bt=new qx.fx.effect.core.Move(v);
this.__Ge=new qx.fx.effect.core.Fade(v);
this.__Bv=new qx.fx.effect.core.Parallel(this.__Bt,this.__Ge);
},properties:{direction:{init:s,check:[s,p,e,n,l,m,k,q]},xAmount:{init:100,check:r},yAmount:{init:100,check:r},mode:{init:u,check:[o,u]},modifyDisplay:{init:true,check:g}},members:{__Ge:null,__Bt:null,__Bv:null,start:function(){qx.fx.Base.prototype.start.call(this);
...
this.__Ge.afterFinishInternal=function(){for(var B in z){qx.bom.element.Style.set(A,B,z[B]+t);
}};
this.__Ge.set({duration:Math.min(0.5,this.getDuration()),sync:true,from:(this.getMode()==u)?1:0,to:(this.getMode()==u)?0:1,modifyDisplay:true});
this.__Bv.setDuration(this.getDuration());
this.__Bv.start();
}},destruct:function(){this._disposeObjects(c,a,j);
}});
})();
(function(){var q="display",p="in",o="overflow",n="block",m="none",l="visible",k="0px",j="hidden",i="visiblity",h="Boolean",c="height",g="width",f="px",b="__II",a="qx.fx.effect.combination.Fold",e="__IJ",d="out";
qx.Class.define(a,{extend:qx.fx.Base,construct:function(r){qx.fx.Base.call(this,r);
},properties:{modifyDisplay:{init:true,check:h},mode:{init:p,check:[p,d]}},members:{__II:null,__IJ:null,__BL:null,afterFinish:function(){var s=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==p)){qx.bom.element.Style.set(s,q,n);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var t=this._getElement();
var self=this;
this.__II=new qx.fx.effect.core.Scale(t);
this.__IJ=new qx.fx.effect.core.Scale(t);
this.__II.afterFinishInternal=function(){self.__IJ.start();
};
this.__IJ.afterFinishInternal=function(){self._cleanUp();
};
this.__BL=this._getStyle();
qx.bom.element.Style.set(t,o,j);

if(this.getMode()==p){this.__II.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__IJ.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__II.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__BL.width,this.__BL.height]});
this.__IJ.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__BL.width,this.__BL.height]});
...
for(var u in this.__BL){v=this.__BL[u];
...
(function(){var j="off",i="overflow",h="Boolean",g="qx.fx.effect.combination.Switch",f="none",e="__Bu",d="flicker",c="__Hm",b="hidden",a="display";
qx.Class.define(g,{extend:qx.fx.Base,construct:function(k){qx.fx.Base.call(this,k);
this.setTransition(d);
var l=this.__Bu=new qx.fx.effect.core.Scale(k);
this.__Bu.beforeSetup=function(){qx.bom.element.Style.set(k,i,b);
};
this.__Hm=new qx.fx.effect.core.Fade(k);
this.__Hm.afterFinishInternal=function(){l.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:h},mode:{init:j,check:[j]}},members:{__Bu:null,__Hm:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var n=this._getElement();
var m=qx.bom.element.Style.get(n,i);
this.__Bu.afterFinishInternal=function(){qx.bom.element.Style.set(n,i,m);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==j)){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}
if(this.getMode()==j){this.__Bu.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__Hm.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__Hm.start();
},_applyDuration:function(o,p){this.__Bu.setDuration(o/2);
this.__Hm.setDuration(o/2);
