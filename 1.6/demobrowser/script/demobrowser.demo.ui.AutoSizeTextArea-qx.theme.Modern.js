...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.AutoSizeTextArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea-qx.theme.Modern.adf7a720181a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
o.set({allowStretchY:false,value:this.__OA()});
n.add(q,{row:0,column:0});
n.add(o,{row:1,column:0});
q=new qx.ui.basic.Label();
q.setValue(b);
var u=new qx.ui.form.TextArea();
u.set({allowStretchY:false,value:this.__OA(),autoSize:true});
...
r.set({allowStretchY:false,value:this.__OA(),autoSize:true,minHeight:200});
n.add(q,{row:2,column:0});
n.add(r,{row:3,column:0});
q=new qx.ui.basic.Label();
q.setValue(l);
var p=new qx.ui.form.TextArea();
p.set({allowStretchY:false,value:this.__OA(),autoSize:true,minHeight:200,maxHeight:300});
n.add(q,{row:2,column:1});
n.add(p,{row:3,column:1});
q=new qx.ui.basic.Label();
q.setValue(j);
var s=new qx.ui.form.TextArea();
s.set({allowStretchY:false,value:this.__OA(),autoSize:true,minimalLineHeight:2});
...
},__OA:function(){var w=new qx.type.Array(2);
