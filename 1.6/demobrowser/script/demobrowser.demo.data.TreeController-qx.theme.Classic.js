...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.TreeController","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.TreeController-qx.theme.Classic.d0a60bdf3063.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="execute",r="name",q="name2",p="Thing ",o="Item ",n="Change the label binding",m="Write data to log",l="Remove an item from root",k="'Thing i'.",j="A list containing the selected items of the tree.",c="multi",h="<b>Tree binding</b><br/>",f="Add an item to root",b="<b>Selected Items</b><br/>",a="This tree is bound to a set of randomly generated nodes. Every node",e="children",d="demobrowser.demo.data.TreeController",g=" does have a name and a name2 property, containing 'Item i' and ";
...
t.setSelectionMode(c);
this.getRoot().add(t,{left:10,top:100});
t.setWidth(250);
t.setHeight(300);
var B=new qx.data.controller.Tree(z[0],t,e,r);
t.getRoot().setOpen(true);
var u=new qx.ui.form.List();
u.setHeight(300);
this.getRoot().add(u,{left:270,top:100});
new qx.data.controller.List(B.getSelection(),u,q);
var A=new qx.ui.form.Button(f);
A.setWidth(180);
this.getRoot().add(A,{left:390,top:100});
A.addListener(s,function(){var D=new demobrowser.demo.data.model.Node();
D.setName(o+t.getItems(true).length);
D.setName2(p+t.getItems(true).length);
z[0].getChildren().push(D);
},this);
var v=new qx.ui.form.Button(l);
v.setWidth(180);
this.getRoot().add(v,{left:390,top:135});
v.addListener(s,function(){z[0].getChildren().pop();
},this);
var w=new qx.ui.form.Button(n);
w.setWidth(180);
this.getRoot().add(w,{left:390,top:170});
w.addListener(s,function(){if(B.getLabelPath()==r){B.setLabelPath(q);
}else{B.setLabelPath(r);
}},this);
var x=new qx.ui.form.Button(m);
x.setWidth(180);
this.getRoot().add(x,{left:390,top:205});
x.addListener(s,function(){this.info(z[0].toString());
},this);
var y=new qx.ui.basic.Label();
y.setRich(true);
y.setWidth(240);
y.setValue(h+a+g+k);
this.getRoot().add(y,{left:20,top:10});
var C=new qx.ui.basic.Label();
C.setRich(true);
C.setWidth(100);
C.setValue(b+j);
this.getRoot().add(C,{left:270,top:10});
}}});
})();
...
(function(){var s="qx.data.Array",r="demobrowser.demo.data.model.Node",q="String",p="changeNames",o="changeName",n="Validation Error: ",m="",l="is no number (parseFloat says so!).",k="changeChild",j="- ",c="__Nl",h="Marge",f="AFFE",b="changeColor",a="Homer",e="\n",d="changeName2",g="changeChildren";
qx.Class.define(r,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:s,event:g},child:{check:r,event:k,nullable:true},names:{check:s,event:p,init:new qx.data.Array(a,h)},name:{check:q,init:f,event:o},name2:{check:q,event:d},number:{init:10,validate:c},color:{event:b,nullable:true}},members:{__Nl:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
}}throw new qx.core.ValidationError(n+t+l);
