...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Save_Dialog","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Save_Dialog-qx.theme.Simple.f0ce02b80e1c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="execute",s="mshtml",r="engine.name",q="middle",p="Cancel",o="demobrowser.demo.animation.Save_Dialog",n="appear",m="Your changes will be lost if you don't save them.",l="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",k="__sO",d="center",j="__Ng",g="Save...",c='<b "font-size:12pt;">Do you want to save the changes you made in the doc "Untitled"?</b>',b="close",f="right",e="__Nf",h="__Ne",a="Don't save";
qx.Class.define(o,{extend:qx.application.Standalone,members:{__Ne:null,__Nf:null,__Ng:null,__sO:null,__Nh:function(){if(qx.core.Environment.get(r)==s){this.__Ne=new qx.fx.effect.core.Fade(this.__Nf.getContainerElement().getDomElement()).set({from:0,to:1});
this.__Ng=new qx.fx.effect.core.Fade(this.__Nf.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__Ne=new qx.fx.effect.combination.Grow(this.__Nf.getContainerElement().getDomElement());
this.__Ng=new qx.fx.effect.combination.Shrink(this.__Nf.getContainerElement().getDomElement());
}},showDialog:function(){this.__Nf.setZIndex(1);
this.__Ne.start();
},hideDialog:function(){this.__Ng.start();
...
v.add(this.__sO,{left:40,top:40});
var z=new qx.ui.form.Button(b);
z.set({allowStretchX:false,alignX:f,marginBottom:15});
z.addListener(t,this.showDialog,this);
this.__sO.add(z);
var B=l;
var x=new qx.ui.form.TextArea(B);
x.set({width:400,height:250});
this.__sO.add(x);
var A=new qx.ui.layout.Grid(3,4);
A.setColumnWidth(0,120);
A.setColumnWidth(1,110);
A.setColumnWidth(2,110);
A.setRowHeight(2,10);
A.setRowAlign(3,d,q);
this.__Nf=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__Nf.setLayout(A);
v.add(this.__Nf,{left:65,top:125});
this.__Nf.addListenerOnce(n,this.__Nh,this);
var C=new qx.ui.basic.Label(c);
var w=new qx.ui.basic.Label(m);
C.setRich(true);
this.__Nf.add(C,{row:0,column:0,colSpan:3});
this.__Nf.add(w,{row:1,column:0,colSpan:3});
var y=[a,p,g];

for(var i=0;i<y.length;i++){var u=new qx.ui.form.Button(y[i]);
u.setAllowStretchX(false);
this.__Nf.add(u,{row:3,column:i});
u.addListener(t,this.hideDialog,this);
}}},destruct:function(){this._disposeObjects(k,e,h,j);
}});
})();
...
(function(){var j="sinodial",i="px",h="flicker",g="0px",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",J="easeInQuad",I="reverse",H="none",G="overflow",F="linear",E="height",D='bottom-left',C='top-left',B='bottom-right',A="bottom-right",q="qx.fx.effect.combination.Grow",r="__Bu",o="bottom-left",p="visible",m="width",n="top-left",k="top",l="top-right",s='top-right',t="__Bv",v="block",u='center',x="__Bt",w="hidden",z="left",y="display";
qx.Class.define(q,{extend:qx.fx.Base,construct:function(K){qx.fx.Base.call(this,K);
this.__Bt=new qx.fx.effect.core.Move(K);
this.__Bu=new qx.fx.effect.core.Scale(K);
this.__Bv=new qx.fx.effect.core.Parallel(this.__Bt,this.__Bu);
},properties:{direction:{init:f,check:[n,l,o,A,f]},scaleTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]},moveTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]}},members:{__Bu:null,__Bt:null,__Bv:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
...
this.__Bu.afterFinishInternal=function(){var S;
...
break;
}this.__Bt.set({x:P,y:Q,sync:true,transition:this.getMoveTransition()});
this.__Bu.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[N.width,N.height]});
...
this.__Bv.setDuration(this.getDuration());
this.__Bv.start();
}},destruct:function(){this._disposeObjects(x,r,t);
}});
})();
...
this.__Bw=qx.fx.effect.core.Scale.originalStyle;
this.__Bx=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:p},scaleY:{init:true,check:p},scaleContent:{init:true,check:p},scaleFromCenter:{init:true,check:p},scaleFrom:{init:100.0,check:o},scaleTo:{init:100,check:o},restoreAfterFinish:{init:false,check:p},alternateDimensions:{init:[],check:k}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':c,'px':q,'%':f,'pt':h}},members:{__By:null,__uB:null,__uA:null,__Bz:null,__BA:null,__BB:null,__BC:null,__Bw:null,__Bx:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var w=this._getElement();
this.__By=qx.bom.element.Style.get(w,g);

for(var u in this.__Bw){this.__Bw[u]=w.style[u];
}this.__uB=qx.bom.element.Location.getTop(w);
this.__uA=qx.bom.element.Location.getLeft(w);

try{var v=qx.bom.element.Style.get(w,n);
}catch(x){if(typeof (v)!=a){v=(qx.core.Environment.get(l)==m)?i:b;
}}
for(var s in this.__Bx){if(v.indexOf(s)>0){this.__Bz=parseFloat(v);
this.__BA=s;
break;
}}this.__BB=(this.getScaleTo()-this.getScaleFrom())/100;
var t=this.getAlternateDimensions();

if(t.length==0){this.__BC=[w.offsetWidth,w.offsetHeight];
}else{this.__BC=t;
}},update:function(y){var A=this._getElement();
qx.fx.Base.prototype.update.call(this);
var z=(this.getScaleFrom()/100.0)+(this.__BB*y);

if(this.getScaleContent()&&this.__Bz){qx.bom.element.Style.set(A,n,this.__Bz*z+this.__BA);
}this._setDimensions(this.__BC[0]*z,this.__BC[1]*z);
},finish:function(){qx.fx.Base.prototype.finish.call(this);
var D=this._getElement();

if(this.getRestoreAfterFinish()){for(var B in this.__Bw){var C=this.__Bw[B];
...
if(this.getScaleFromCenter()){var K=(E-this.__BC[0])/2;
var L=(F-this.__BC[1])/2;

if(this.__By==e){if(I){d.top=this.__uB-L+q;
}
if(H){d.left=this.__uA-K+q;
}}else{if(I){d.top=-L+q;
}
if(H){d.left=-K+q;
}}}
for(var G in d){qx.bom.element.Style.set(J,G,d[G]);
}}},destruct:function(){this.__BC=this.__Bw=this.__Bx=null;
}});
})();
(function(){var b="qx.fx.effect.core.Parallel",a="__uw";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(c){qx.fx.Base.call(this);
this.__uw=arguments;
},members:{__uw:null,finish:function(){qx.fx.Base.prototype.finish.call(this);
var d=this.__uw;
...
(function(){var j="sinodial",i="none",h="overflow",g="flicker",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",E="easeInQuad",D="reverse",C="linear",B="Boolean",A="px",z='bottom-left',y='top-left',x='bottom-right',w="bottom-right",v="__Bu",q="bottom-left",r="visible",o="qx.fx.effect.combination.Shrink",p="top-left",m="top-right",n='top-right',k="__Bv",l='center',s="__Bt",t="hidden",u="display";
qx.Class.define(o,{extend:qx.fx.Base,construct:function(F){qx.fx.Base.call(this,F);
this.__Bt=new qx.fx.effect.core.Move(F);
this.__Bu=new qx.fx.effect.core.Scale(F);
this.__Bv=new qx.fx.effect.core.Parallel(this.__Bt,this.__Bu);
},properties:{direction:{init:f,check:[p,m,q,w,f]},moveTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},scaleTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},modifyDisplay:{init:true,check:B}},members:{__BL:null,__Bt:null,__Bu:null,__Bv:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
...
for(var G in this.__BL){H=this.__BL[G];
...
var J,K;
this.__BL={top:qx.bom.element.Location.getTop(L,"scroll"),left:qx.bom.element.Location.getLeft(L,"scroll"),width:qx.bom.element.Dimension.getContentWidth(L),height:qx.bom.element.Dimension.getContentHeight(L),opacity:qx.bom.element.Style.get(L,"opacity")};

switch(this.getDirection()){case y:J=K=0;
break;
case n:J=this.__BL.width;
K=0;
break;
case z:J=0;
K=this.__BL.height;
break;
case x:J=this.__BL.width;
K=this.__BL.height;
break;
case l:J=this.__BL.width/2;
K=this.__BL.height/2;
break;
}this.__Bt.set({x:J,y:K,sync:true,transition:this.getMoveTransition()});
this.__Bu.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__Bv.setDuration(this.getDuration());
this.__Bv.start();
}},destruct:function(){this._disposeObjects(s,v,k);
}});
})();
