...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Simple.e5098da3df55.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
M.bind(l,this.__rm,j);
M.bind(l,this.__OK,j);
M.bind(l,this.__OL,j);
...
O.add(P);
var N=this.__rm=new qx.ui.list.List().set({height:280,width:150,labelPath:g,labelOptions:{converter:function(Q,R){return R?Q+m+R.getLastname():o;
}}});
O.add(N,{top:20});
return O;
},createSecondExample:function(){var T=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var V=new qx.ui.basic.Label(B).set({font:k});
T.add(V);
var S=this.__OK=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(W,X){return X?X.getLastname()+", "+W:"no model...";
}}});
T.add(S,{top:20});
...
S.setDelegate(U);
S.setSelection(this.__rm.getSelection());
return T;
...
bb.add(bd);
var ba=this.__OL=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(be,bf){return bf?be+" "+bf.getLastname():"no model...";
}}});
bb.add(ba,{top:20});
...
ba.setDelegate(bc);
ba.setSelection(this.__rm.getSelection());
return bb;
}},destruct:function(){this.__rm.dispose();
this.__OK.dispose();
this.__OL.dispose();
this.__rm=this.__OK=this.__OL=null;
}});
})();
