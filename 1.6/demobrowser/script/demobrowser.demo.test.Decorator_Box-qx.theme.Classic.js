...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Decorator_Box","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Decorator_Box-qx.theme.Classic.1e907cae5e5b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="-l",j="horizontal",i="qx.debug.dispose",h="qx.ui.decoration.AbstractBox",g="set",f="qx.debug",e="_applyBaseImage",d="-b",c="-t",b="String",a="-r";
qx.Class.define(h,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],construct:function(l,m,n){qx.ui.decoration.Abstract.call(this);
this._setOrientation(n);

if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__nv=new qx.ui.decoration.css3.BorderImage();

if(l){this.__nw(l,n);
}if(m!=null){this.__nv.setInsets(m);
}}else{this.__nv=new qx.ui.decoration.BoxDiv(l,m,n);
}if(qx.core.Environment.get(i)){this.__nv.$$ignoreDisposeWarning=true;
}},properties:{baseImage:{check:b,nullable:true,apply:e}},members:{__nv:null,_isHorizontal:null,_setOrientation:function(o){this._isHorizontal=o==j;
},getMarkup:function(){return this.__nv.getMarkup();
},resize:function(p,q,r){this.__nv.resize(p,q,r);
},tint:function(s,t){},getInsets:function(){return this.__nv.getInsets();
},_applyInsets:function(u,v,name){var w=g+qx.lang.String.firstUp(name);
this.__nv[w](u);
},_applyBaseImage:function(x,y){if(this.__nv instanceof qx.ui.decoration.BoxDiv){this.__nv.setBaseImage(x);
}else{this.__nw(x);
}},__nw:function(z){this.__nv.setBorderImage(z);
var F=qx.util.AliasManager.getInstance().resolve(z);
var G=/(.*)(\.[a-z]+)$/.exec(F);
var D=G[1];
var E=G[2];
var C=qx.util.ResourceManager.getInstance();
if(qx.core.Environment.get(f)){if(!C.has(F)){this.warn("The border image '"+F+"' is not available!");
}}
if(this._isHorizontal){var I=C.getImageWidth(D+k+E);
var A=C.getImageWidth(D+a+E);
this.__nv.setSlice([0,A,0,I]);
}else{var B=C.getImageHeight(D+d+E);
var H=C.getImageHeight(D+c+E);
this.__nv.setSlice([H,0,B,0]);
...
}},properties:{baseImage:{check:g,nullable:true,apply:b}},members:{__nx:null,__BD:null,__pj:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__nx;
...
}}}},tint:function(E,F){},_applyBaseImage:function(G,H){if(qx.core.Environment.get(h)){if(this.__nx){throw new Error("This decorator is already in-use. Modification is not possible anymore!");
...
var L=N[1];
var J=N[2];
var O=this.__BD={t:L+"-t"+J,b:L+"-b"+J,c:L+"-c"+J,l:L+"-l"+J,r:L+"-r"+J};
this.__pj={top:I.getImageHeight(O.t),bottom:I.getImageHeight(O.b),left:I.getImageWidth(O.l),right:I.getImageWidth(O.r)};
}}},destruct:function(){this.__nx=this.__BD=this.__pj=null;
}});
})();
