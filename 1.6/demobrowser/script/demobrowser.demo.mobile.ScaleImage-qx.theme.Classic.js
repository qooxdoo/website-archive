...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Classic.ae68858df033.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="div",j="px",i=")",h="50px",g="absolute",f="touchmove",d="height",c="url(",b="green",a="deg) scale(",C="200px",B="30px",A="qx.debug",z="12px",y="event.touch",x="-webkit-transform",w="touchend",v="width",u='Lucida Grande',t="innerHTML",r="demobrowser.demo.mobile.ScaleImage",s="59px",p="engine.name",q="demobrowser/demo/mobile/qooxdoo-logo.png",n="20px",o="rotate(",l="webkit",m="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(r,{extend:qx.application.Native,members:{__sM:null,__NU:1,__NV:0,__NW:0,__NX:0,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(A)){qx.log.appender.Native;
qx.log.appender.Console;
}var F=new qx.html.Element(k);
F.useElement(document.body);
F.setRoot(true);

if(qx.core.Environment.get(p)!=l||!qx.core.Environment.get(y)){var E={"color":b,"position":g,"font-family":u,"font-size":z,"left":B,"top":n};
var H=new qx.html.Element(k,E);
F.add(H);
H.setAttribute(t,m);
return;
}var G=qx.util.ResourceManager.getInstance().toUri(q);
var D={"width":C,"height":s,"position":g,"left":h,"top":h,"background":c+G+i};
this.__sM=new qx.html.Element(k,D);
this.__sM.addListener(f,this.__rQ,this);
this.__sM.addListener(w,this.__rP,this);
F.add(this.__sM);
},__rQ:function(e){if(e.isMultiTouch()){this.__NW=e.getRotation()+this.__NV;
this.__NX=e.getScale()*this.__NU;
this.__sM.setStyle(x,o+this.__NW+a+this.__NX+i);
}else{var I=parseInt(e.getDocumentLeft())-(parseInt(this.__sM.getStyle(v))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__sM.getStyle(d))/2);
this.__sM.setStyles({"left":I+j,"top":top+j});
}},__rP:function(e){if(e.isMultiTouch()){this.__NV=this.__NW;
this.__NU=this.__NX;
}}}});
})();
