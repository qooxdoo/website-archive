...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.WebWorker","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.WebWorker-qx.theme.Modern.ef466663b00f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="error",c="message",b="qx.event.type.Data",a="qx.bom.WebWorker";
qx.Class.define(a,{extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);
this.__JO=qx.core.Environment.get("html.webworker");
this.__JO?this.__JQ(f):this.__JR(f);
},events:{"message":b,"error":b},members:{_worker:null,_handleErrorBound:null,_handleMessageBound:null,__JO:true,__JP:null,__JQ:function(g){this._worker=new window.Worker(g);
...
},__JR:function(h){var j=this;
var i=new qx.bom.request.Xhr();
i.onload=function(){j.__JP=(function(){var k=function(e){j.fireDataEvent('message',e);
};
eval("var onmessage = null, postMessage = "+k+";"+i.responseText);
return {onmessage:eval("onmessage"),postMessage:k};
})();
};
i.open("GET",h,false);
i.send();
},postMessage:function(l){var m=this;

if(this.__JO){this._worker.postMessage(l);
}else{setTimeout(function(){try{m.__JP.onmessage&&m.__JP.onmessage({data:l});
}catch(n){m.fireDataEvent(d,n);
}},0);
}},_handleMessage:function(e){this.fireDataEvent(c,e.data);
},_handleError:function(e){this.fireDataEvent(d,e.message);
}},destruct:function(){if(this.__JO){qx.bom.Event.removeNativeListener(this._worker,c,this._handleMessageBound);
qx.bom.Event.removeNativeListener(this._worker,d,this._handleErrorBound);

if(this._worker){this._worker.terminate();
this._worker=null;
}}else{if(this.__JP){this.__JP=null;
}}}});
})();
