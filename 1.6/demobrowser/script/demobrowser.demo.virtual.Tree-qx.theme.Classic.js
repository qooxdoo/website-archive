...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree-qx.theme.Classic.29ae6bb93e46.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="changeValue",k="execute",j="mode",h="multi",g="model",f="Show Leafs",d="Show top level open/close icons",c="loaded",b="File #",a="demobrowser.demo.virtual.Tree",H="Enable drag selection",G="Open mode:",F="change",E="Hide Root Node",D="Update Model",C="Control",B=" items",A="changeSelection",z="children",y="Enable multi selection",s="name",t="",q="single",r="Selection: ",o="Tree:",p="click",m="json/tree.json",n="none",u="double click",v="Selection:",x="Root node:",w="Toggle Height";
...
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
this.getRoot().add(L,{top:20,left:20});
var J=new qx.ui.tree.VirtualTree(null,s,z).set({width:200,height:400});
L.add(J);
var I=m;
var M=new qx.data.store.Json(I);
M.bind(g,J,g);
M.addListener(c,function(){J.openNode(J.getModel().getChildren().getItem(0));
},this);
var K=this.getCommandFrame(J);
L.add(K);
},getCommandFrame:function(N){var W=new qx.ui.groupbox.GroupBox(C);
var T=4;
W.setLayout(new qx.ui.layout.Grid(5,3));
var be=0;
W.add(new qx.ui.basic.Label(r).set({paddingTop:4}),{row:be,column:0});
var ba=new qx.ui.form.TextField().set({readOnly:true});
W.add(ba,{row:be++,column:1});
N.getSelection().addListener(F,function(e){var bf=N.getSelection();

if(bf.getLength()>0){if(N.getSelectionMode()===h){ba.setValue(bf.getLength()+B);
}else{ba.setValue(bf.getItem(0).getName());
}}else{ba.setValue(t);
}});
W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});
W.add(new qx.ui.basic.Label(G),{row:be,column:0});
var Q={"click":p,"dblclick":u,"none":n};
var O=new qx.ui.form.RadioGroup();

for(var X in Q){var P=new qx.ui.form.RadioButton(Q[X]).set({value:X==N.getOpenMode()});
P.setUserData(j,X);
O.add(P);
W.add(P,{row:be++,column:1});
}O.addListener(A,function(e){N.setOpenMode(e.getData()[0].getUserData(j));
});
W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});
W.add(new qx.ui.basic.Label(v),{row:be,column:0});
var R=new qx.ui.form.CheckBox(y);
W.add(R,{row:be++,column:1});
R.addListener(l,function(e){var bg=e.getData();
N.setSelectionMode(bg?h:q);
});
var S=new qx.ui.form.CheckBox(H);
W.add(S,{row:be++,column:1});
S.addListener(l,function(e){var bh=e.getData();
N.setDragSelection(bh);

if(!R.getValue()){R.setValue(true);
}});
W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});
W.add(new qx.ui.basic.Label(x),{row:be,column:0});
var bc=new qx.ui.form.CheckBox(E);
W.add(bc,{row:be++,column:1});
bc.addListener(l,function(e){N.setHideRoot(e.getData());
});
var V=new qx.ui.form.CheckBox(d);
W.add(V,{row:be++,column:1});
V.addListener(l,function(e){N.setShowTopLevelOpenCloseIcons(e.getData());
});
W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});
W.add(new qx.ui.basic.Label(o),{row:be,column:0});
var Y=new qx.ui.form.CheckBox(f);
Y.setValue(N.isShowLeafs());
W.add(Y,{row:be++,column:1});
Y.addListener(l,function(e){N.setShowLeafs(e.getData());
});
W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});
var bb=new qx.ui.form.Button(D);
bb.addListener(k,function(e){var bl=N.getModel().getChildren().getItem(0);
var bi=bl.getChildren().getItem(2);
var bj=[];

for(var i=0;i<10;i++){bj.push({"name":b+(bi.getChildren().getLength()+i)});
}var bk=qx.data.marshal.Json.createModel(bj,true);
bi.getChildren().append(bk);
},this);
W.add(bb,{row:be++,column:1});
var U=new qx.ui.form.Button(w);
W.add(U,{row:be++,column:1});
var bd=true;
U.addListener(k,function(e){N.setHeight(bd?600:400);
bd=!bd;
});
return W;
}}});
...
var S=this._layer.getRowSizes().length;

for(var W=V;W<V+S;W++){var T=this._layer.getRenderedCellWidget(W,0);

if(T!=null){this.__Gh=Math.max(this.__Gh,T.getSizeHint().width);
}}var U=this.getPane().getBounds().width;
this.getPane().getColumnConfig().setItemSize(0,Math.max(this.__Gh,U));
},openNode:function(X){this.__Gl(X);
this.buildLookupTable();
},refresh:function(){this.buildLookupTable();
},openNodeAndParents:function(Y){this.__Gm(this.getModel(),Y);
this.buildLookupTable();
},closeNode:function(ba){if(qx.lang.Array.contains(this.__Gf,ba)){qx.lang.Array.remove(this.__Gf,ba);
this.fireDataEvent(v,ba);
this.buildLookupTable();
}},isNodeOpen:function(bb){return qx.lang.Array.contains(this.__Gf,bb);
},_init:function(){this.__nP=new qx.data.Array();
this.__Gf=[];
this.__Gg=[];
this._initLayer();
...
},getLookupTable:function(){return this.__nP;
},_reverseLookup:function(bc){return bc;
},_getDataFromRow:function(bd){return this.__nP.getItem(bd);
},_getSelectables:function(){return this.__nP;
},getOpenNodes:function(){return this.__Gf;
},isNode:function(be){return qx.Class.hasProperty(be.constructor,this.getChildProperty());
},getLevel:function(bf){return this.__Gg[bf];
},hasChildren:function(bg){var bh=bg.get(this.getChildProperty());

if(bh==null){return false;
}
if(this.isShowLeafs()){return bh.length>0;
}else{for(var i=0;i<bh.getLength();i++){var bi=bh.getItem(i);

if(this.isNode(bi)){return true;
}}}return false;
},_getContentPaddingTarget:function(){return this.getPane();
},_applyRowHeight:function(bj,bk){this.getPane().getRowConfig().setDefaultItemSize(bj);
},_applyOpenMode:function(bl,bm){var bn=this.getPane();
if(bl===l){bn.addListener(k,this._onOpen,this);
}else if(bl===g){bn.addListener(j,this._onOpen,this);
}
if(bm===l){bn.removeListener(k,this._onOpen,this);
}else if(bm===g){bn.removeListener(j,this._onOpen,this);
}},_applyHideRoot:function(bo,bp){this.buildLookupTable();
},_applyShowTopLevelOpenCloseIcons:function(bq,br){this.buildLookupTable();
},_applyShowLeafs:function(bs,bt){this.buildLookupTable();
},_applyChildProperty:function(bu,bv){this._provider.setChildProperty(bu);
},_applyLabelPath:function(bw,bx){this._provider.setLabelPath(bw);
},_applyIconPath:function(by,bz){this._provider.setIconPath(by);
...
},_applyModel:function(bE,bF){this.__Gf=[];

if(bE!=null){if(qx.core.Environment.get(q)){if(!qx.Class.hasMixin(bE.constructor,qx.data.marshal.MEventBubbling)){this.warn("The model item doesn't support the Mixin 'qx.data."+"marshal.MEventBubbling'. Therefore the tree can not update "+"the view automatically on model changes.");
}}bE.addListener(a,this._onChangeBubble,this);
this.__Gl(bE);
}
if(bF!=null){bF.removeListener(a,this._onChangeBubble,this);
}this.__Gj();
},_applyDelegate:function(bG,bH){this._provider.setDelegate(bG);
this.buildLookupTable();
},_onChangeBubble:function(event){var bJ=event.getData().name;
var bI=bJ.lastIndexOf(D);

if(bI!=-1){bJ=bJ.substr(bI+1,bJ.length);
}
if(qx.lang.String.startsWith(bJ,this.getChildProperty())){this.__Gj();
}},_onUpdated:function(event){if(this.__iE==null){this.__iE=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);
},this);
}this.__iE.schedule();
},_onOpen:function(event){var bL=event.getRow();
var bK=this.__nP.getItem(bL);

if(this.isNode(bK)){if(this.isNodeOpen(bK)){this.closeNode(bK);
}else{this.openNode(bK);
}}},_onKeyPress:function(e){var bO=this.getSelection();

if(bO.getLength()>0){var bM=bO.getItem(0);
var bN=this.isNode(bM);

switch(e.getKeyIdentifier()){case J:if(bN&&this.isNodeOpen(bM)){this.closeNode(bM);
}else{var parent=this.getParent(bM);

if(parent!=null){bO.splice(0,1,parent);
}}break;
case x:if(bN&&!this.isNodeOpen(bM)){this.openNode(bM);
}else{if(bN){var bP=bM.get(this.getChildProperty());

if(bP!=null&&bP.getLength()>0){bO.splice(0,1,bP.getItem(0));
}}}break;
case A:case K:if(!bN){return;
}
if(this.isNodeOpen(bM)){this.closeNode(bM);
}else{this.openNode(bM);
}break;
}}},_beforeApplySelection:function(bQ){if(bQ.length===0&&this.getSelectionMode()===d){var bR=this.__Go();
var bS=this.getLookupTable().indexOf(bR);

if(bS>=0){bQ.push(bS);
}}},_afterApplySelection:function(){var bT=this.getSelection();

if(bT.getLength()>0&&this.getSelectionMode()===d){this.__Gn(bT.getItem(0));
}else{this.__Gi=[];
}},__Gj:function(){this.buildLookupTable();
...
this.__Gg=[];
var bV=-1;
var bW=this.getModel();

if(bW!=null){if(!this.isHideRoot()){bV++;
bX.push(bW);
this.__Gg.push(bV);
}
if(this.isNodeOpen(bW)){var bU=this.__Gk(bW,bV);
bX=bX.concat(bU);
...
this.__xs();
},__Gk:function(bY,ca){var cb=[];
ca++;

if(!this.isNode(bY)){return cb;
}var cd=bY.get(this.getChildProperty());

if(cd==null){return cb;
}
for(var i=0;i<cd.getLength();i++){var ce=cd.getItem(i);

if(this.isNode(ce)){this.__Gg.push(ca);
cb.push(ce);

if(this.isNodeOpen(ce)){var cc=this.__Gk(ce,ca);
cb=cb.concat(cc);
}}else{if(this.isShowLeafs()){this.__Gg.push(ca);
cb.push(ce);
}}}return cb;
},__Gl:function(cf){if(!qx.lang.Array.contains(this.__Gf,cf)){this.__Gf.push(cf);
this.fireDataEvent(s,cf);
}},__Gm:function(cg,ch){if(cg===ch){this.__Gl(ch);
return true;
}
if(!this.isNode(cg)){return false;
}var cj=cg.get(this.getChildProperty());

if(cj==null){return false;
}
for(var i=0;i<cj.getLength();i++){var ck=cj.getItem(i);
var ci=this.__Gm(ck,ch);

if(ci===true){this.__Gl(ck);
return true;
}}return false;
},__xs:function(){this.getPane().getRowConfig().setItemCount(this.__nP.getLength());
this.getPane().fullUpdate();
},getParent:function(cl){var cn=this.__nP.indexOf(cl);
...
if(cm<co){return this.__nP.getItem(cn);
}}return null;
},__Gn:function(cp){this.__Gi=[];
var parent=this.getParent(cp);

while(parent!=null){this.__Gi.unshift(parent);
parent=this.getParent(parent);
}},__Go:function(){if(this.__Gi==null){return this.getModel();
}var cq=this.getLookupTable();
var parent=this.__Gi.pop();

while(parent!=null){if(cq.contains(parent)){return parent;
}parent=this.__Gi.pop();
}return this.getModel();
}},destruct:function(){var cr=this.getPane();

if(cr!=null){if(cr.hasListener(k)){cr.addListener(k,this._onOpen,this);
}else if(cr.hasListener(j)){cr.removeListener(j,this._onOpen,this);
}}this._layer.removeListener(b,this._onUpdated,this);
this._layer.destroy();
this._provider.dispose();
this.__nP.dispose();
this._layer=this._provider=this.__nP=this.__Gf=null;
}});
})();
...
qx.Mixin.define(d,{construct:function(){this.__xE=[];
},properties:{labelPath:{check:q,nullable:true},iconPath:{check:q,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:q,nullable:true},delegate:{event:m,init:null,nullable:true}},members:{__xE:null,bindDefaultProperties:function(r,s){this.bindProperty(o,n,null,r,s);
...
}},bindProperty:function(u,v,w,x,y){var z=this.__xF(y,u);
var A=this._tree.getLookupTable();
var B=A.bind(z,x,v,w);
this.__rE(x,B);
},bindPropertyReverse:function(C,D,E,F,G){var H=this.__xF(G,C);
var I=this._tree.getLookupTable();
var J=F.bind(D,I,H,E);
this.__rE(F,J);
},removeBindings:function(){while(this.__xE.length>0){var K=this.__xE.pop();
...
}},_removeBindingsFrom:function(O){var P=this.__xG(O);
...
if(qx.lang.Array.contains(this.__xE,O)){qx.lang.Array.remove(this.__xE,O);
}},__xF:function(R,S){var T=b+R+g;

if(S!=null&&S!=o){T+=a+S;
}return T;
},__rE:function(U,V){var W=this.__xG(U);

if(!qx.lang.Array.contains(W,V)){W.push(V);
}
if(!qx.lang.Array.contains(this.__xE,U)){this.__xE.push(U);
}},__xG:function(X){var Y=X.getUserData(p);
...
q.setUserData(f,r);
q.addListener(l,this.__Gp,this);
...
return q;
},poolCellWidget:function(t){t.removeListener(l,this.__Gp,this);
...
},__Gp:function(event){var J=event.getTarget();
