...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex-qx.theme.Simple.48b821d67c4f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__js=[];
},members:{_pool:null,__js:null,getCellData:function(i,k){if(!this.__js[i]){this.__js[i]=[];
}
if(!this.__js[i][k]){this.__js[i][k]={label:this.__OH(),icon:this.__OI()};
}return this.__js[i][k];
},getCellWidget:function(l,m){var n;

if(m%2==0){n=this._pool.atom.pop();

if(!n){n=new qx.ui.basic.Atom();
n.addListener(c,function(){var o=this.__OI();
n.setIcon(o);
this.__js[l][m].icon=o;
},this);
