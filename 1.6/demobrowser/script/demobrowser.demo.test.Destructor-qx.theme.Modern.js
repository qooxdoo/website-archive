...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor-qx.theme.Modern.29ffe4fa954f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Class.define(a,{extend:qx.application.Standalone,members:{__cP:null,__Ol:0,__lh:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__cP=[];
this.currentTest=this.testWindows;
this.__lh=new qx.event.Timer(1000);
this.__lh.addListener(d,this.runTest,this);
this.__lh.start();
},runTest:function(){this.__Ol++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Ol+" (Registry: "+g+")");
this.currentTest();
