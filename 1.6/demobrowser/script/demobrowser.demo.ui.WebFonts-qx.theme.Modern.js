...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.WebFonts","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.WebFonts-qx.theme.Modern.6aa22f164c16.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="sans-serif",j="fontId",h="demobrowser/demo/fonts/fineliner_script-webfont.woff",g="Cras interdum sollicitudin ante. Sed placerat scelerisque magna. Vestibulum ",f="demobrowser/demo/fonts/fineliner_script-webfont.ttf",e="demobrowser/demo/fonts/fineliner_script-webfont.eot",d="Select Font",c="demobrowser/demo/fonts/tobec___-webfont.eot",b="FinelinerScriptRegular",a="qx.debug",D="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.woff",C="rutrum nibh a eros. Cum sociis natoque penatibus et magnis dis parturient ",B="changeSelection",A="demobrowser/demo/fonts/tobec___-webfont.ttf",z="YanoneKaffeesatzRegular",y="Lorem ipsum dolor sit amet, consectetuer adipiscing elit.",x="Nam lectus justo, porttitor ac, ullamcorper ac, cursus in, ante. Duis mi ante,",w="demobrowser.demo.ui.WebFonts",v="ToBeContinuedRegular",u="demobrowser/demo/fonts/tobec___-webfont.woff",s="sodales in, auctor vel, vehicula eget, sapien. Proin iaculis dui vitae leo. ",t="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.ttf",q="bold",r="The quick brown fox jumps over the lazy dog",o="label",p="demobrowser/demo/fonts/yanonekaffeesatz-regular-webfont.eot",m="montes, nascetur ridiculus mus.",n="Integer blandit tempus leo. Morbi turpis. Suspendisse turpis. Nulla eget leo.";
qx.Class.define(w,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);
if(qx.core.Environment.get(a)){qx.log.appender.Native;
qx.log.appender.Console;
}var I={"webFont0":{size:16,family:[k],sources:[{family:b,source:[e,f,h]}]},"webFont1":{size:13,family:[k],sources:[{family:v,source:[c,A,u]}]},"webFont2":{size:16,family:[k],sources:[{family:z,source:[p,t,D]}]}};
var F={};

for(var H in I){F[H]=new qx.bom.webfonts.WebFont().set(I[H]);
}var R=r;
var P=y+x+s+n+g+C+m;
var Q=[];
var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
this.getRoot().add(S,{edge:10});
var G=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
S.add(G);
var K=new qx.ui.basic.Label(d);
K.setFont(q);
G.add(K);
var L=new qx.ui.form.SelectBox();
L.setMinWidth(300);

for(var H in F){var N=new qx.ui.form.ListItem(F[H].getFamily()[0]);
N.getChildControl(o).setFont(F[H]);
N.setUserData(j,H);
L.add(N);
}L.addListener(B,function(T){var V=T.getData()[0];
var U=V.getUserData(j);

for(var i=0,l=Q.length;i<l;i++){Q[i].setFont(F[U]);
}},this);
G.add(L);
var O=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
S.add(O);
var M=new qx.ui.basic.Label(R);
Q.push(M);
M.setFont(F.webFont0);
O.add(M);
var E=new qx.ui.form.TextField(R);
Q.push(E);
E.setFont(F.webFont0);
O.add(E);
var J=new qx.ui.form.TextArea(P);
Q.push(J);
J.setFont(F.webFont0);
O.add(J);
}}});
})();
