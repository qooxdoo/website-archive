...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellSpan-qx.theme.Simple.c6df734e6093.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="yellow",i="bold",h="table-scroller-header",g="green",f=" / ",e="Widget Cells",d="demobrowser.demo.virtual.CellSpan",c="HTML Cells",b="x",a="__OG";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__OG:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__OG=new qx.ui.virtual.cell.Cell();
...
this.__OG.setBackgroundColor(s);
return this.__OG.getCellProperties(q+f+r);
...
},__Iy:function(A,B,C,D,top,E,F){var H=this._cellProvider.getCellProperties(B,C);
var G=H.insets||[0,0];
...
var W=R[i];
this.__Iy(U,S.firstRow,S.firstColumn,W.left,W.top,W.width,W.height);
}}else{O=[];
...
if(!O[N][T]){this.__Iy(U,N,T,V,top,P,M);
}T++;
V+=P;
}top+=M;
N++;
...
}return this.__yw(J,M);
},__yw:function(N,O){var P=[];
...
this.__xJ=[];
this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__yt());
...
},__xJ:null,setCellSpan:function(u,v,w,x){var y=u+d+v;
this._spanManager.removeCell(y);

if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);
}qx.ui.core.queue.Widget.add(this);
},__yt:function(){var self=this;
...
return z;
},__yu:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);
...
}}},__yv:function(){var O=this.getChildren();
...
this._add(L);
}}},_fullUpdate:function(P,Q,R,S){this.__yu(P,Q,R.length,S.length);
this.__yv();
this._cellLayer.fullUpdate(P,Q,R,S);
},_updateLayerWindow:function(T,U,V,W){this.__yu(T,U,V.length,W.length);
this.__yv();
...
this._cellProvider=this.__xJ=this._cells=this._bounds=this._spanMap=null;
}});
})();
