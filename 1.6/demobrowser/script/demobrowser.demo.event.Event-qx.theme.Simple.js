...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event-qx.theme.Simple.bbbb2ebe0836.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},_initLogger:function(n,o,p){this.__Nv=e+n.join(h)+k;
this.__Nw=p||50;
this.__Nx=o;
this._clearLog();
},_clearLog:function(){this.__Nx.innerHTML=this.__Nv+l;
this.__Ny=[];
},_log:function(q){this.__Ny.unshift(q);
this.__Ny=this.__Ny.slice(0,this.__Nw);
var r=[this.__Nv];

for(var i=0;i<this.__Ny.length;i++){r.push(d,this.__Ny[i].join(f),a);
}r.push(l);
this.__Nx.innerHTML=r.join(g);
this.__Nx.scrollTop=0;
},__Nv:null,__Nw:null,__Nx:null,__Ny:null},destruct:function(){this.__Nx=this.__Ny=null;
}});
})();
