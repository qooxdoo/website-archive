...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Boolean","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean-qx.theme.Classic.08e8ae2648ff.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__Dd=H.toUri(F);
this.__De=H.toUri(E);
},properties:{allowToggle:{check:a,init:false}},members:{__Dd:null,__De:null,__Jr:null,__Js:null,__Cz:null,__CA:null,__CB:null,__CC:null,_identifyImage:function(I){var J={imageWidth:11,imageHeight:11};

switch(I.cellData){case true:J.url=this.__Dd;
J.extras=w;
break;
case false:J.url=this.__De;
J.extras=r;
break;
default:J.url=null;
break;
...
if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__Dd)){J.extras+=i+this.getBlankImage()+j+e+h+c+this.__Dd+j+d;
}else{J.extras+=i+this.__Dd+j;
}J.extras+=o+s+t+f;

if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(this.__De)){J.extras+=i+this.getBlankImage()+j+e+h+c+this.__De+j+d;
}else{J.extras+=i+this.__De+j;
}J.extras+=v+g;
