...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Desktop","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Desktop-qx.theme.Modern.95ce691445f7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="pane",k="lastTab",j="bar",h="page",g="firstTab",f="close",d="right",c="bottom",b="button",a="qx.debug",C="changeSelection",B="top",A="left",z="qx.event.type.Data",y="barRight",x="beforeChangeSelection",w="close-button",v="tabview",u="vertical",t="_applyBarPosition",r="barLeft",s="horizontal",p="qx.ui.tabview.TabView",q="__Bs",n="barTop",o="barBottom";
qx.Class.define(p,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(D){qx.ui.core.Widget.call(this);
this.__Gd={top:n,right:y,bottom:o,left:r};
this._createChildControl(j);
this._createChildControl(m);
var E=this.__Bs=new qx.ui.form.RadioGroup;
E.setWrap(false);
E.addListener(C,this._onChangeSelection,this);
if(D!=null){this.setBarPosition(D);
}else{this.initBarPosition();
}},events:{"changeSelection":z},properties:{appearance:{refine:true,init:v},barPosition:{check:[A,d,B,c],init:B,apply:t}},members:{__Bs:null,_createChildControlImpl:function(F,G){var H;
...
M.add(I);
this.__Bs.add(J);
I.addState(this.__Gd[this.getBarPosition()]);
I.addState(k);
...
S.addAt(N,O);
this.__Bs.add(P);
N.addState(this.__Gd[this.getBarPosition()]);
R=this.getChildren();
...
Y.remove(T);
this.__Bs.remove(V);
T.removeState(this.__Gd[this.getBarPosition()]);
...
},__Gd:null,_applyBarPosition:function(bb,bc){var bd=this.getChildControl(j);
var bi=bb==A||bb==d;
var bg=bb==d||bb==c;
...
bd.setOrientation(bi?u:s);
var bj=this.getChildren();
if(bc){var be=this.__Gd[bc];
bd.removeState(be);
for(var i=0,l=bj.length;i<l;i++){bj[i].removeState(be);
}}
if(bb){var bf=this.__Gd[bb];
bd.addState(bf);
for(var i=0,l=bj.length;i<l;i++){bj[i].addState(bf);
}}},getSelection:function(){var bl=this.__Bs.getSelection();
var bm=[];
