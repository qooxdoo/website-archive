...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker-qx.theme.Simple.6011c7d52080.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="resize",h="backgroundColor",g="px",f="zIndex",d="0px",c="mshtml",b="engine.name",a="qx.bom.Blocker";
qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__bf();
},members:{__GC:null,__CL:null,__GD:null,__GE:false,__GF:10000,__GG:0,__GH:"transparent",block:function(j){if(!this.__GE){this.__GD=j;
var k=this.__GK();
this.__GL(k);
this.__GE=true;
}},unblock:function(){if(this.__GE){this.__GM();
this.__GE=false;
}},isBlocked:function(){return this.__GE;
},getBlockerElement:function(){return this.__CL;
},setBlockerColor:function(l){qx.bom.element.Style.set(this.__CL,h,l);
},getBlockerColor:function(){return qx.bom.element.Style.get(this.__CL,h);
},setBlockerOpacity:function(m){qx.bom.element.Opacity.set(this.__CL,m);
},getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__CL);
},setBlockerZIndex:function(n){qx.bom.element.Style.set(this.__CL,f,n);
},getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__CL,f);
},__bf:function(){this.__GI();

if((qx.core.Environment.get(b)==c)){this.__GJ();
}qx.event.Registration.addListener(window,i,this.__qq,this);
},__GI:function(){this.__CL=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__CL,{display:"block",opacity:this.__GG,backgroundColor:this.__GH});
this.setBlockerZIndex(this.__GF);
},__GJ:function(){this.__GC=qx.bom.Iframe.create();
qx.bom.element.Attribute.set(this.__GC,"allowTransparency",false);
qx.bom.element.Attribute.set(this.__GC,"src","javascript:false;");
qx.bom.element.Style.setStyles(this.__GC,{display:"block",opacity:this.__GG});
},__GK:function(){var o={position:"absolute"};

if(this.__GO()){o.left="0px";
o.top="0px";
o.right=null;
o.bottom=null;
o.width=qx.bom.Document.getWidth()+"px";
o.height=qx.bom.Document.getHeight()+"px";
}else{o.width=qx.bom.element.Dimension.getWidth(this.__GD)+"px";
o.height=qx.bom.element.Dimension.getHeight(this.__GD)+"px";
o.left=qx.bom.element.Location.getLeft(this.__GD)+"px";
o.top=qx.bom.element.Location.getTop(this.__GD)+"px";
}return o;
},__GL:function(p){var q=document.body;
qx.bom.element.Style.setStyles(this.__CL,p);
qx.dom.Element.insertEnd(this.__CL,q);

if((qx.core.Environment.get("engine.name")=="mshtml")){p.zIndex=this.getBlockerZIndex()-1;
qx.bom.element.Style.setStyles(this.__GC,p);
qx.dom.Element.insertEnd(this.__GC,document.body);
}},__GM:function(){qx.dom.Element.remove(this.__CL);

if((qx.core.Environment.get("engine.name")=="mshtml")){qx.dom.Element.remove(this.__GC);
}},__qq:function(e){if(this.__GO()){this.__GN({width:d,height:d});
qx.event.Timer.once(function(){var r={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};
this.__GN(r);
},this,0);
}},__GN:function(s){qx.bom.element.Style.setStyles(this.__CL,s);

if((qx.core.Environment.get("engine.name")=="mshtml")){qx.bom.element.Style.setStyles(this.__GC,s);
}},__GO:function(){return (this.__GD==null||qx.dom.Node.isWindow(this.__GD)||qx.dom.Node.isDocument(this.__GD));
}},destruct:function(){qx.event.Registration.removeListener(window,i,this.__qq,this);
this.__GC=this.__CL=this.__GD=null;
}});
})();
