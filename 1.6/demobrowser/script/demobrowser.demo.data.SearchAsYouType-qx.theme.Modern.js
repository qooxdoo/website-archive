...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Modern.c4f3145b9aa9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__qL=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__qL:null,__gh:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__qL!=null){i.stop(this.__qL);
this.__qL=null;
}this.__qL=i.start(function(){this.__gh.update();
this.__qL=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__gh=null;
}});
})();
