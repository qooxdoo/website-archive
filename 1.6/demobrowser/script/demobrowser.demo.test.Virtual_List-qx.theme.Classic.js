...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List-qx.theme.Classic.1070f8af6182.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__Ov=new qx.ui.virtual.layer.WidgetCell(this);
this.getPane().addLayer(this.__Ov);
this.getPane().addListener(z,this._onResize,this);
this.__fI=[];
this.__cO=[];
this.__zC=new qx.ui.virtual.selection.Row(this.getPane());
this.__zC.addListener(h,this._onChangeSelection,this);
this.__zC.attachMouseEvents();
this.__zC.attachKeyEvents(this);
this.__zC.attachListEvents(this);
...
this.fireDataEvent(h,this.__Oz(e.getData()));
},getCellWidget:function(I,J){var L=this.__fI[I];

if(!L){return null;
}var K=this.__cO.pop()||new qx.ui.form.ListItem();
K.set({label:L.getLabel(),icon:L.getIcon()});

if(this.__zC.isItemSelected(I)){K.addState(n);
...
},hasChildren:function(){return this.__fI.length>0;
...
qx.ui.core.queue.Widget.add(this);
},add:function(W){this.__fI.push(W);
this._addHelper(W);
return this;
},remove:function(X){qx.lang.Array.remove(this.__fI,X);
this._removeHelper(X);
return this;
},removeAll:function(){for(var i=0,j=this.__fI.length;i<j;i++){this._removeHelper(this.__fI[i]);
}this.__fI=[];
},indexOf:function(Y){return this.__fI.indexOf(Y);
},addAt:function(ba,bb){qx.lang.Array.insertAt(this.__fI,ba,bb);
this._addHelper(ba);
},addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__fI,bc,bd);
this._addHelper(bc);
},addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__fI,be,bf);
this._addHelper(be);
},removeAt:function(bg){this.__fI.splice(bg,1);
this._removeHelper(this.__fI[bg]);
},__Ow:function(bh){var bi=this.__fI.indexOf(bh);

if(bi<0){return null;
}else{return bi;
}},__Ox:function(bj){var bk=this.__fI[bj];
return bk;
},__Oy:function(bl){var bm=[];

for(var i=0;i<bl.length;i++){bm.push(this.__Ow(bl[i]));
}return bm;
},__Oz:function(bn){var bo=[];

for(var i=0;i<bn.length;i++){bo.push(this.__fI[bn[i]]);
}return bo;
},selectAll:function(){this.__zC.selectAll();
},setSelected:function(bp){this.__zC.selectItem(this.__Ow(bp));
},isSelected:function(bq){return this.__zC.isItemSelected(this.__Ow(bq));
},addToSelection:function(br){this.__zC.addItem(this.__Ow(br));
},removeFromSelection:function(bs){this.__zC.removeItem(this.__Ow(bs));
},selectRange:function(bt,bu){this.__zC.selectItemRange(this.__Ow(bt),this.__Ow(bu));
},resetSelection:function(){this.__zC.clearSelection();
},setSelection:function(bv){this.__zC.replaceSelection(this.__Oy(bv));
},getSelectedItem:function(){return this.__fI[this.getSelected()];
},getSelected:function(){return this.__fI[this.__zC.getSelectedItem()];
},getSelection:function(){return this.__Oz(this.__zC.getSelection());
},getSortedSelection:function(){return this.__Oz(this.__zC.getSortedSelection());
},isSelectionEmpty:function(){return this.__zC.isSelectionEmpty();
},getSelectionContext:function(){return this.__zC.getSelectionContext();
},getSelectables:function(){return this.__Oz(this.__zC.getSelectables());
},_applySelectionMode:function(bw,bx){this.__zC.setMode(bw);
},_applyDragSelection:function(by,bz){this.__zC.setDrag(by);
},_applyQuickSelection:function(bA,bB){this.__zC.setQuick(bA);
}}});
})();
