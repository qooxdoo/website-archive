...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ScrollContainer_EdgeCaseHeight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ScrollContainer_EdgeCaseHeight-qx.theme.Modern.2c923780b369.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="value",s="changeSelection",r="execute",q="ScrollbarX:",p="ScrollbarY:",o="Toggle content",n="blue",m="black",l="auto",k="demobrowser.demo.test.ScrollContainer_EdgeCaseHeight",d="Off",j="white",h="off",c="On",b="Content size: 300x300",g="Toggle pane",f="solid",i="Auto",a="on";
...
var D=new qx.ui.form.RadioButton(d);
C.setUserData(t,l);
E.setUserData(t,a);
D.setUserData(t,h);
C.setValue(true);
...
return G;
},generateBox:function(){var H=new qx.ui.basic.Label(b).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:n,textColor:j,padding:10,decorator:new qx.ui.decoration.Single(4,f,m)});
return H;
}}});
})();
