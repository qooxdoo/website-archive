...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea-qx.theme.Simple.94920c28947f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="div",o="0px",n="true",m="outline",l="mshtml",k="engine.name",h="hideFocus",g="none",f="840px",d="<tr>",bs="'>",br="change",bq="#",bp="select",bo="qooxdoo logo",bn="<option value=''></option>",bm="",bl="1px solid #AAA",bk="</option>",bj="value='",w="</tr>",x="left",u="<td>First Row, Second cell</td>",v="Verdana",s="Courier",t="Comic Sans MS",q="demobrowser.demo.bom.HtmlArea",r="traditional web pages / single-page applications.<br/> ",D="Tahoma",E="16px",O="Link: ",L="20px 20px",W="Courier New",R="<h1>HtmlArea low-level widget</h1>",bf="<td>First Row, First cell</td>",bc="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",H="<td>Second Row, Second cell</td>",bi="<p>This low-level widget can be used separately at ",bh="Impact",bg="http://",G="Change font size",J="Arial Black",K="BgColor (Hex): ",N="Arial",P="<tbody>",S="Times New Roman",Y="<option qxKeepFocus='on' qxSelectable='off'",be="HTML Code:",y="Georgia",z="<table border='1'>",I="Change font family",V="Lucida Console",U="innerHTML",T="You can play around with this widget by hitting the ",bb="Color (Hex): ",ba="<td>Second Row, First cell</td>",Q="buttons at the toolbar.</p>",X="<option qxKeepFocus='on' qxSelectable='off' ",a="350px",bd='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',A="</tbody>",B="blank.html",M="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",b="white",c="</table>",F="FontSize: ",C="It is the foundation for the UI widget component.</p>";
qx.Class.define(q,{extend:qx.application.Native,members:{__sO:null,__Ni:null,__Nj:null,__Kq:null,__hE:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__sO=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(this.__sO,{margin:L});
var bv=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(bv,{width:f,padding:o,margin:o});
var bu=R+bi+r+C+M+T+Q;
qx.bom.element.Attribute.set(bv,U,bu);
this.__Ni=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(this.__Ni,{width:f,padding:o,margin:o,lineHeight:o,border:bl});
this.__Nj=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(this.__Nj,{width:f,height:a,border:bl,borderTop:o,backgroundColor:b});
qx.dom.Element.insertEnd(this.__Nj,this.__sO);
var bt=bd;
this.__Kq=new qx.bom.htmlarea.HtmlArea(this.__Nj,bt,null,B);
this.__KA();
qx.dom.Element.insertBegin(this.__Ni,this.__sO);
qx.dom.Element.insertBegin(bv,this.__sO);
qx.dom.Element.insertBegin(this.__sO,document.body);
},__Nk:function(e){var bw=window.prompt(F,bm);
this.setFontSize(parseInt(bw));
},__Kr:function(e){var bx=window.prompt(bb,bq);
this.setTextColor(bx);
},__Ks:function(e){var by=window.prompt(K,bq);
this.setTextBackgroundColor(by);
},__Kt:function(e){var bz={src:qx.util.ResourceManager.getInstance().toUri(bc),border:0,title:bo,alt:bo};
this.insertImage(bz);
},__Ku:function(e){var bA=z+P+d+bf+u+w+d+ba+H+w+A+c;
this.insertHtml(bA);
},__Kv:function(e){var bB=window.prompt(O,bg);
this.insertHyperLink(bB);
},__Kw:function(e){var bC=window.prompt(be,bm);
this.insertHtml(bC);
},__Kx:function(){var bE=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(bE,{"float":x});
var bG;
var bF=qx.bom.Element.create(bp,{title:I});

if(qx.core.Environment.get(k)==l){qx.bom.element.Attribute.set(bF,h,n);
}else{qx.bom.element.Style.set(bF,m,g);
}bG=qx.bom.Collection.html(bn);
qx.dom.Element.insertEnd(bG[0],bF);
var bH=[D,v,S,N,J,W,s,y,bh,t,V];
var bD;
var bI;

for(var i=0,j=bH.length;i<j;i++){bD=Y+bj+bH[i]+bs+bH[i]+bk;
bI=qx.bom.Collection.html(bD);

if(qx.core.Environment.get(k)==l){qx.bom.element.Attribute.set(bI[0],h,n);
}else{qx.bom.element.Style.set(bI[0],m,g);
}qx.dom.Element.insertEnd(bI[0],bF);
}qx.event.Registration.addListener(bF,br,function(e){var bJ=e.getTarget();
var bK=bJ.selectedIndex;

if(bK!=0){this.setFontFamily(bJ.options[bK].value);
bJ.options[0].selected=true;
}},this.__Kq);
qx.dom.Element.insertBegin(bF,bE);
return bE;
},__Ky:function(){var bM=qx.bom.Element.create(p);
qx.bom.element.Style.setStyles(bM,{"marginRight":E,"float":x});
var bO;
var bN=qx.bom.Element.create(bp,{title:G});

if(qx.core.Environment.get(k)==l){qx.bom.element.Attribute.set(bN,h,n);
}else{qx.bom.element.Style.set(bN,m,g);
}bO=qx.bom.Collection.html(bn);
qx.dom.Element.insertEnd(bO[0],bN);
var bP;
var bL;

for(var i=1;i<=7;i++){bL=X+bj+i+bs+i+bk;
bP=qx.bom.Collection.html(bL);

if(qx.core.Environment.get(k)==l){qx.bom.element.Attribute.set(bP[0],h,n);
}else{qx.bom.element.Style.set(bP[0],m,g);
}qx.dom.Element.insertEnd(bP[0],bN);
}qx.event.Registration.addListener(bN,br,function(e){var bQ=e.getTarget();
var bR=bQ.selectedIndex;

if(bR!=0){this.setFontSize(bQ.options[bR].value);
bQ.options[0].selected=true;
}},this.__Kq);
qx.dom.Element.insertBegin(bN,bM);
return bM;
},__KA:function(){var bT=[{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__Kq.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__Kq.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__Kq.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__Kq.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__Kq.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__Kq.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__Kq.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__Kq.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__Kq.setJustifyFull}},{fontFamily:{custom:this.__Kx},fontSize:{custom:this.__Ky},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__Kr},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__Ks}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__Kq.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__Kq.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__Kt},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__Ku},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__Kv},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__Kw},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__Kq.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__Kq.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__Kq.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__Kq.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__Kq.redo}}];
var bV,ca,bS,bX;

for(var i=0,j=bT.length;i<j;i++){ca={};
ca["marginRight"]=i==j-1?"0px":"16px";
ca["float"]="left";
bV=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(bV,ca);

for(var bW in bT[i]){var bY=bT[i][bW];

if(bY.custom){bS=bY.custom.call(this);
}else{var bU=qx.util.AliasManager.getInstance().resolve(bY.image);
bX={type:"image",src:qx.util.ResourceManager.getInstance().toUri(bU),title:bY.text,qxKeepFocus:"on",qxSelectable:"off"};
bS=qx.bom.Element.create("input",bX);
qx.bom.element.Style.setStyles(bS,{width:"16px",height:"16px",padding:"4px"});

if(qx.core.Environment.get("engine.name")=="mshtml"){qx.bom.element.Attribute.set(bS,"hideFocus","true");
}else{qx.bom.element.Style.set(bS,"outline","none");
}qx.event.Registration.addListener(bS,"click",bY.action,this.__Kq);
}qx.dom.Element.insertEnd(bS,bV);
}qx.dom.Element.insertEnd(bV,this.__Ni);
}qx.dom.Element.insertEnd(qx.bom.Element.create("br",{style:"clear:both"}),this.__Ni);
}}});
})();
