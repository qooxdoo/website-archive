...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Validation-qx.theme.Simple.6360843a3ab9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
S.setRich(true);
S.setWidth(250);
S.setValue(w+C+a+r+s);
this.getRoot().add(S,{left:280,top:10});
}}});
qx.Class.define(k,{extend:qx.core.Object,properties:{name:{init:F,validate:p},age:{init:18,validate:qx.util.Validate.number()},gender:{init:g,validate:qx.util.Validate.inArray([g,f])}},members:{__Ou:function(W){if(W.length<2){throw new qx.core.ValidationError(B+I+W+O);
}}}});
})();
