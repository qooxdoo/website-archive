...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Classic.de75c8fa66b7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},__Iy:function(U,top,V,W,X){var Y=[s,V,p,top,o];
...
var top=0;
qx.util.Permutation.permute(bd,function(be){this.__Iy(bc,top,bb,ba,be);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bf,function(bk){this.__Iy(bg,top,bi,bj,bk);
top+=bh;
},this);
bj.setIconFalse(H);
bj.setIconTrue(G);
qx.util.Permutation.permute(bf,function(bl){this.__Iy(bg,top,bi,bj,bl);
top+=bh;
},this);
...
this.__Iy(bt,top,bw,bx,bz);
top+=20;
}},testImageRenderer:function(){var bC=new qx.ui.table.cellrenderer.Image();
var bA=50;
var bD={value:[null,h,z,q,R,P],styleLeft:[0],styleWidth:[bA],styleHeight:[20],style:[k],tooltip:[k,D]};
var bB=this._getNewTableDiv(bA);
var top=0;
qx.util.Permutation.permute(bD,function(bE){this.__Iy(bB,top,bA,bC,bE);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bL,function(bQ){this.__Iy(bM,top,bO,bP,bQ);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bR,function(bW){this.__Iy(bS,top,bU,bV,bW);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(bX,function(cd){this.__Iy(bY,top,cb,cc,cd);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(ce,function(cm){this.__Iy(cf,top,ch,ci,cm);
top+=20;
},this);
...
var top=0;
qx.util.Permutation.permute(cn,function(ct){this.__Iy(co,top,cq,cs,ct);
top+=20;
},this);
...
if(d){this.__Hi=d;
}this.__AV=qx.util.AliasManager.getInstance();
},members:{__AV:null,__Hi:16,__Hh:16,_identifyImage:function(e){var f={imageWidth:this.__Hh,imageHeight:this.__Hi};

if(e.value==a){f.url=null;
}else{f.url=this.__AV.resolve(e.value);
}f.tooltip=e.tooltip;
return f;
