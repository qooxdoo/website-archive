...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ProgressBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ProgressBar-qx.theme.Simple.4dafbefc3085.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
if(g!=null){this.setValue(g);
}},properties:{appearance:{refine:true,init:d}},events:{complete:b,change:a},members:{__vJ:0,__HD:100,getValue:function(){return this.__vJ;
...
this.__HE(i/j);
return i;
},getMaximum:function(){return this.__HD;
...
},__HE:function(q){var s=this.getChildControl("progress");
