...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Cells","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Modern.decf62cc13de.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="",i="' ",h="<b>HTML</b>",g="px;",f="Juhu",e="testImageCell",d="qx.theme",c="</div>",b="<div ",a="testNumberCell",F="class='",E="width:",D="testHtmlCell",C="testDateCell",B="css.boxmodel",A=">",z="height:",y="testStringCell",x="testBooleanCellCustomImage",w="demobrowser.demo.virtual.Cells",q="content",r="testBooleanCell",o="foobar!",p="qx.theme.Modern",m="icon/32/apps/utilities-notes.png",n="medium",k="main",l="icon/16/emotes/face-sad.png",s="icon/16/apps/internet-feed-reader.png",t="icon/16/emotes/face-smile.png",v="This is a feed reader!",u="style='";
...
var G=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(G);
this.runTest(y);
this.runTest(a);
this.runTest(C);
this.runTest(D);
if(qx.core.Environment.get(d)==p){this.runTest(e);
this.runTest(r);
this.runTest(x);
}this.getRoot().add(this.topContainer,{edge:5});
},runTest:function(H){this.setUp();
this[H]();
...
},testStringCell:function(){var J={value:[f,h,j,null],states:[{},{selected:1}]};
var I=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(J,function(K){var L=this.__Iy(I,K.value,K.states);
this.container.add(L);
},this);
},testNumberCell:function(){var M={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var N=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(M,function(O){if(O.format){N.setNumberFormat(O.format);
}else{N.resetNumberFormat();
}var P=this.__Iy(N,O.value,O.states);
this.container.add(P);
},this);
},testDateCell:function(){var Q={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(n))],states:[{},{selected:1}]};
var R=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(Q,function(S){if(S.format){R.setDateFormat(S.format);
}else{R.resetDateFormat();
}var T=this.__Iy(R,S.value,S.states);
this.container.add(T);
},this);
},testHtmlCell:function(){var U={value:[f,h,j,null],states:[{},{selected:1}]};
var V=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(U,function(W){var X=this.__Iy(V,W.value,W.states);
this.container.add(X);
},this);
},testImageCell:function(){var Y={value:[{url:s,tooltip:v},{url:m,tooltip:o},null],states:[{},{selected:1}]};
var ba=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(Y,function(bb){var bc=this.__Iy(ba,bb.value,bb.states);
this.container.add(bc);
},this);
},testBooleanCell:function(){var bd={value:[true,false,null],states:[{},{selected:1}]};
var be=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(bd,function(bf){var bg=this.__Iy(be,bf.value,bf.states);
this.container.add(bg);
},this);
},testBooleanCellCustomImage:function(){var bh={value:[true,false,null],states:[{},{selected:1}]};
var bi=new qx.ui.virtual.cell.Boolean;
bi.setIconFalse(l);
bi.setIconTrue(t);
qx.util.Permutation.permute(bh,function(bj){var bk=this.__Iy(bi,bj.value,bj.states);
this.container.add(bk);
},this);
},__Iy:function(bl,bm,bn){var br=100;
var bp=30;
var bt=new qx.ui.embed.Html().set({width:br,height:bp,decorator:bn.selected?null:k});
var bo=bl.getCellProperties(bm,bn);
var bq=bo.insets;
var bs=[b,u,this._getCellSizeStyle(br,bp,bq[0],bq[1]),bo.style,i,F,bo.classes,i,bo.attributes,A,bo.content,c].join(j);
bt.setHtml(bs);
return bt;
},_getCellSizeStyle:function(bu,bv,bw,bx){var by=j;

if(qx.core.Environment.get(B)==q){bu-=bw;
bv-=bx;
}by+=E+bu+g;
by+=z+bv+g;
return by;
...
}this.__iM=qx.bom.Stylesheet.createElement(p);
this.__yx={};
this.__iF={};
},members:{__iM:null,__yx:null,__iF:null,getStylesheet:function(){return this.__iM;
},getCssClass:function(q){return this.__yx[q]||null;
},computeClassForStyles:function(r,s){var t=this.__iF[s];

if(!t){var t=this.__yy();
qx.bom.Stylesheet.addRule(this.__iM,c+t,s);
this.__iF[s]=t;
}this.__yx[r]=t;
return t;
},__yy:function(){return j+this.toHashCode()+n+(this.__yz++);
},__yz:0},destruct:function(){this.__iM=this.__yx=this.__iF=null;
}});
})();
...
this.__iM=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__yA={};
this.__yB={};
this.__yC={};
this.__yD={};
...
for(var K in N){if(!O[K]){this.__yF.push(K);
}}L=L.superclass;
}},_getCssProperties:function(){return [J,l,C,q,d,c,e,h];
},_applyAppearance:function(P,Q){if(Q){this.__yB={};
}},_getValue:function(R){if(this.__yH){return qx.util.PropertyUtil.getThemeValue(this,R);
}else{return qx.util.PropertyUtil.getUserValue(this,R);
}},_storeStyle:function(S,T){var U;

if(this.__yH){U=this.__yB;
}else{U=this.__yA;
}
...
}},getCellProperties:function(bj,bk){this.__yJ(bk);
...
},getCssClasses:function(bp,bq){var br=this.__iM.getCssClass(this.__yG)||f;
return n+br;
},__yJ:function(bs){if(!bs){bs={};
}var bu=this.getAppearance();
var bt=bu+a+qx.lang.Object.getKeys(bs).sort().join(x);

if(this.__yG==bt){return;
}this.__yG=bt;
var bv=this.__kX[this.__yG];

if(!bv){this.__yK();
this.__yL(bs);
this.__yM(bs);
this.__yN();
this.__kX[this.__yG]=1;
}this.__yO();
},__yK:function(){var bw=qx.util.PropertyUtil;
var bx=this._getCssProperties();

for(var i=0;i<bx.length;i++){bw.deleteThemeValue(this,bx[i]);
}},__yL:function(by){this.__yB={};
this.__yH=true;
...
},__yM:function(){var bD=qx.lang.Object.getValues(this.__yB).join(b);
this.__iM.computeClassForStyles(this.__yG,bD);
},__yN:function(){var bI=this.__yF;
...
}}this.__yE[this.__yG]=bG;
},__yO:function(){var bK=qx.util.PropertyUtil;
var bJ=this.__yE[this.__yG]||{};

for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);
}},getStyles:function(bM,bN){return qx.lang.Object.getValues(this.__yA).join(b);
},getInsets:function(bO,bP){var bT=this.__yC;
var bS=this.__yD;
...
return [bU+bQ,top+bR];
}},destruct:function(){this.__iM=this.__yA=this.__yB=this.__yC=this.__yD=this.__kX=this.__yE=this.__yF=null;
}});
})();
...
(function(){var j="",i="px",h='" ',g="no-repeat",f="qx.ui.virtual.cell.AbstractImage",e="engine.version",d="string",c="static",b='"',a='<div style="',v="inline-block",u='<img src="',t='title="',s='></div>',r="img",q="top",p="gecko",o="engine.name",n='" style="',m="abstract",k='/>',l="-moz-inline-box";
...
},members:{__Bo:16,__Bp:16,_aliasManager:null,__Bq:function(w){var z=qx.util.ResourceManager.getInstance();
...
},__Br:function(B){if(typeof (B)==d){B={url:B};
...
var I=this.__Br(this._identifyImage(F));
var M=qx.core.Environment.get(o)==p&&qx.core.Environment.get(e)<1.9;
var J=I.tooltip?t+I.tooltip+b:j;
var H={width:I.width+i,height:I.height+i,display:M?l:v,verticalAlign:q,position:c};
...
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__Hq:null,__Hr:null,__Dc:null,_applyIconTrue:function(f){this.__Hq=this.__Dc.resolve(f);
},_applyIconFalse:function(g){this.__Hr=this.__Dc.resolve(g);
},_identifyImage:function(h){return h==true?this.__Hq:this.__Hr;
}}});
})();
