...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Window_Editor-qx.theme.Classic.2b89b42e516d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
z.moveTo(300,250);
z.addListener(f,function(e){z.__AH.focus();
z.__AH.setTextSelection(0,z.__AH.getValue().length);
});
z.__AH=new qx.ui.form.TextField(w.value+"").set({allowGrowY:true});
z.add(z.__AH);
...
return z;
},getCellEditorValue:function(A){return parseFloat(A.__AH.getValue());
}}});
})();
