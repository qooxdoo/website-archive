...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.List","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List-qx.theme.Modern.df9df970f89f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="value",o="label",n="one",m="icon",l="both",k="multi",j="single",h="additive",g="bold",f="changeValue",bI="changeSelection",bH="Item No ",bG="Marc",bF="Julian",bE="Moritz",bD="Show Icon",bC="Jannis",bB="Kevin",bA="Robin",bz="showMode",w="Felix",x="Vincent",u="demobrowser.demo.virtual.List",v="Additive Selection",s="Nils",t="Nick",q="Leon",r="Jannick",E="Linus",F="Configurable",ba="Julius",V="Alexander",bi="icon/16/places/folder.png",bd="Jason",bu="change",bo="Erik",N="addaptive",by="Colin",bw="Lennard",bv="enabled",L="Tobias",R="Florian",T="show",X="Jonas",bb="Maximilian",be="Jakob",bk="",bq="David",y="Finn",z="48",P="Marlon",bh="Lukas",bg="Luca",bf="changeShowMode",bm="Fabian",bl="Tim",bc="Justin",bj="Single Selection",a="Simon",bp="Luis",A="Johannes",B="Elias",W="Jan",b="Dominic",d="Show Label",K="Noah",C="Daniel",D="Paul",J="Philipp",Y="Niclas",bs="Max",br="One Selection",S="Additive selection",bt="Jonathan",M="Tom",bn="Joel",G="Show Both",I="Ben",O="Nico",U="One as selection mode",H="16",bx="Mika",Q="Multi Selection",c="Marvin";
qx.Class.define(u,{extend:qx.application.Standalone,properties:{showMode:{init:l,check:[o,m,l],event:bf}},members:{__OM:null,__ON:null,__OO:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bJ=this.getRoot();
...
var bO=new qx.ui.basic.Label(F).set({font:g});
bM.add(bO);
var bW=[];

for(var i=0;i<2500;i++){bW[i]={label:bH+i,icon:(i%4)?H:z};
}var ca=qx.data.marshal.Json.createModel(bW);
var bR=this.__OM=new qx.ui.list.List(ca).set({scrollbarX:"on",selectionMode:"multi",height:280,width:150,labelPath:"label",iconPath:"icon",iconOptions:{converter:function(ce){return "icon/"+ce+"/places/folder.png";
}}});
bM.add(bR,{top:20});
var bQ=this;
var cd={configureItem:function(cf){bQ.bind(bz,cf,T);
},bindItem:function(cg,ch,ci){cg.bindDefaultProperties(ch,ci);
cg.bindProperty(o,bv,{converter:function(cj){return parseInt(cj.replace(/Item No /g,bk))%9!=0;
}},ch,ci);
}};
bR.setDelegate(cd);
...
var bY=new qx.ui.form.RadioButton(v);
...
var bS=new qx.ui.form.RadioButton(d);
var bN=new qx.ui.form.RadioButton(bD);
var bK=new qx.ui.form.RadioButton(G);
bS.setUserData(p,o);
bN.setUserData(p,m);
bK.setUserData(p,l);
...
var bT=this.__ON=new qx.ui.form.CheckBox("Enable drag selection");
var bX=this.__OO=new qx.ui.form.CheckBox("Enable quick selection").set({enabled:false});
...
bT.addListener(f,this.onDragCheckChange,this);
bX.addListener(f,this.onQuickCheckChange,this);
return bM;
},createOneSelectionList:function(){var cl=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var cm=new qx.ui.basic.Label(U).set({font:g});
cl.add(cm);
var cp=new qx.data.Array();

for(var i=0;i<250;i++){var co=new demobrowser.demo.virtual.model.Item(bH+i,bi);
cp.push(co);
}var cn=new qx.ui.list.List(cp).set({selectionMode:n,height:280,width:150,labelPath:o,iconPath:m});
cl.add(cn,{top:20});
...
var cs=new qx.ui.basic.Label(S).set({font:g});
cr.add(cs);
var ct=[q,bh,bg,y,bl,w,X,bp,bb,bF,bs,D,Y,W,I,B,r,J,K,M,bE,O,bq,s,a,bm,bo,bc,V,be,R,t,E,bx,bd,C,bw,c,bC,L,b,P,bG,A,bt,ba,by,bn,bB,x,bA];
...
}}var cu=new qx.ui.list.List(cw).set({selectionMode:h,height:200,width:150,labelPath:o,iconPath:m});
cr.add(cu,{top:20});
cu.setSelection(cq);
return cr;
},onSelectionModeChange:function(e){var cx=e.getData()[0].getUserData(p);
this.__OM.setSelectionMode(cx);

if(cx==j||cx==n){this.__ON.setEnabled(false);
this.__OO.setEnabled(true);
}else if(cx==k||cx==N){this.__ON.setEnabled(true);
this.__OO.setEnabled(false);
}},onShowModeChange:function(e){var cy=e.getData()[0].getUserData(p);
this.setShowMode(cy);
},onDragCheckChange:function(e){if(e.getData()){var cz=this.__OM.getSelectionMode();

if(cz==j||cz==n){this.debug("Drag selection is only available for the modes multi or additive");
}}this.__OM.setDragSelection(e.getData());
},onQuickCheckChange:function(e){if(e.getData()){var cA=this.__OM.getSelectionMode();

if(cA==k||cA==h){this.debug("Quick selection is only available for the modes multi or additive");
}}this.__OM.setQuickSelection(e.getData());
}}});
})();
