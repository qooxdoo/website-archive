...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Classic.2e06d0881f09.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var bA="",bz="<tr>",by="changeSelection",bx="execute",bw="#",bv="qooxdoo logo",bu="</tr>",bt="qx/icon/Oxygen/16/actions/format-indent-more.png",bs="Color (Hex): ",br="Georgia",bg="http://",bf="Change Font Size",be="BgColor (Hex): ",bd="Indent More",bc="<p>You can play around with this widget by hitting the ",bb="Inserted Unordered List",ba="Align Right",Y="Format Italic",X="qx/icon/Oxygen/16/actions/format-text-underline.png",W='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bH="OK",bI="buttons at the toolbar.</p>",bF="demobrowser.demo.widget.HtmlArea",bG="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bD="Comic Sans MS",bE="<p>This UI-level widget can be used at RIA (Rich ",bB="Tahoma",bC="<td>First Row, First cell</td>",bJ="solid",bK="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",bk="qx/icon/Oxygen/16/actions/format-justify-center.png",bj="Align Justify",bm="demobrowser/demo/icons/htmlarea/format-fill-color.png",bl="demobrowser/demo/icons/htmlarea/insert-text.png",bo="Insert Horizontal Ruler",bn="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bq="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bp="HTML Code:",bi="Set Text Background Color",bh="Internet Applications) and inline applications.<br/>",a="Insert Link",b="<td>Second Row, First cell</td>",c="</tbody>",d="Set Text Color",f="Insert Table",g="Cancel",h="As an application developer you can <b>use the same API.</b></p>",k="demobrowser/demo/icons/htmlarea/format-text-color.png",l="demobrowser/demo/icons/htmlarea/insert-table.png",m="qx/icon/Oxygen/16/actions/edit-undo.png",bO="qx/icon/Oxygen/16/actions/edit-clear.png",bN="Arial Black",bM="Impact",bL="Undo Last Change",bS="Redo Last Undo Step",bR="Format Bold",bQ="Change Font Family",bP="right",bU="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bT="Insert Hyperlink",G="Remove Format",H="blank.html",E="qx/icon/Oxygen/16/actions/insert-image.png",F="so code-duplication is avoided.<br/>",K="</table>",L="12px ",I="<td>First Row, Second cell</td>",J="Insert HTML Code",C="qx/icon/Oxygen/16/actions/insert-link.png",D="Insert Ordered List",u="qx/icon/Oxygen/16/actions/format-justify-left.png",t="Courier",w="Courier New",v="qx/icon/Oxygen/16/actions/format-justify-right.png",q="qx/icon/Oxygen/16/actions/format-text-bold.png",p="<td>Second Row, Second cell</td>",s="Insert Image",r="<h1>HtmlArea UI-level widget</h1>",o="Align Left",n="<table border='1'>",Q="The UI widget does use the low-level component internally ",R="qx/icon/Oxygen/16/actions/format-indent-less.png",S="<tbody>",T="Times New Roman",M="Align Center",N="qx/icon/Oxygen/16/actions/edit-redo.png",O="Lucida Console",P="border-main",U="qx/icon/Oxygen/16/actions/format-text-italic.png",V="Arial",B="qx/icon/Oxygen/16/actions/format-justify-fill.png",A="Verdana",z="Indent Less",y="Format Strikethrough",x="Format Underline";
qx.Class.define(bF,{extend:qx.application.Standalone,members:{__Kq:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cc=r+bE+bh+Q+F+h+bc+bI;
var bW=new qx.ui.basic.Label(cc);
bW.set({rich:true,marginBottom:10});
var cb=W;
var ca=this.getRoot();
var bY=new qx.ui.decoration.Single(1,bJ,P);
bY.setWidthTop(0);
this.__Kq=new qx.ui.embed.HtmlArea(cb,null,H);
this.__Kq.set({width:600,height:400,decorator:bY});
var toolbar=this.__KA();
var bV=new qx.ui.layout.VBox(0);
var bX=new qx.ui.container.Composite(bV);
bX.add(bW);
bX.add(toolbar);
bX.add(this.__Kq);
ca.add(bX,{left:20,top:20});
},__Kr:function(e){var cd=window.prompt(bs,bw);
this.setTextColor(cd);
},__Ks:function(e){var ce=window.prompt(be,bw);
this.setTextBackgroundColor(ce);
},__Kt:function(e){var cf={src:qx.util.ResourceManager.getInstance().toUri(bK),border:0,title:bv,alt:bv};
this.insertImage(cf);
},__Ku:function(e){var cg=n+S+bz+bC+I+bu+bz+b+p+bu+c+K;
this.insertHtml(cg);
},__Kv:function(e){var ci=new qx.ui.window.Window(bT);
ci.setLayout(new qx.ui.layout.VBox(20));
ci.set({width:400,showMaximize:false,showMinimize:false});
var cm=new qx.ui.form.TextField(bg);
ci.add(cm);
var ck=new qx.ui.layout.HBox(10);
ck.setAlignX(bP);
var cl=new qx.ui.container.Composite(ck);
var ch=new qx.ui.form.Button(bH);
ch.setWidth(60);
ch.addListener(bx,function(e){this.insertHyperLink(cm.getValue());
ci.close();
},this);
cl.add(ch);
var cj=new qx.ui.form.Button(g);
cj.setWidth(60);
cj.addListener(bx,function(e){ci.close();
},this);
cl.add(cj);
ci.add(cl);
ci.center();
ci.open();
this.saveRange();
},__Kw:function(e){var cn=window.prompt(bp,bA);
this.insertHtml(cn);
},__Kx:function(){var cp=new qx.ui.form.SelectBox;
cp.set({toolTipText:bQ,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
cp.add(new qx.ui.form.ListItem(bA));
var cq=[bB,A,T,V,bN,w,t,br,bM,bD,O];
var co;

for(var i=0,j=cq.length;i<j;i++){co=new qx.ui.form.ListItem(cq[i]);
co.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(L+cq[i])});
cp.add(co);
}cp.addListener(by,function(e){var cr=e.getData()[0].getLabel();

if(cr!=bA){this.setFontFamily(cr);
cp.setSelection([cp.getChildren()[0]]);
}},this.__Kq);
return cp;
},__Ky:function(){var ct=new qx.ui.form.SelectBox;
ct.set({toolTipText:bf,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
ct.add(new qx.ui.form.ListItem(bA));
var cs;

for(var i=1;i<=7;i++){cs=new qx.ui.form.ListItem(i+bA);
cs.set({focusable:false,keepFocus:true});
ct.add(cs);
}ct.addListener(by,function(e){var cu=e.getData()[0].getLabel();

if(cu!=bA){this.setFontSize(cu);
ct.setSelection([ct.getChildren()[0]]);
}},this.__Kq);
return ct;
},__Kz:function(){return [{bold:{text:bR,image:q,action:this.__Kq.setBold},italic:{text:Y,image:U,action:this.__Kq.setItalic},underline:{text:x,image:X,action:this.__Kq.setUnderline},strikethrough:{text:y,image:bU,action:this.__Kq.setStrikeThrough},removeFormat:{text:G,image:bO,action:this.__Kq.removeFormat}},{alignLeft:{text:o,image:u,action:this.__Kq.setJustifyLeft},alignCenter:{text:M,image:bk,action:this.__Kq.setJustifyCenter},alignRight:{text:ba,image:v,action:this.__Kq.setJustifyRight},alignJustify:{text:bj,image:B,action:this.__Kq.setJustifyFull}},{fontFamily:{custom:this.__Kx},fontSize:{custom:this.__Ky},fontColor:{text:d,image:k,action:this.__Kr},textBackgroundColor:{text:bi,image:bm,action:this.__Ks}},{indent:{text:bd,image:bt,action:this.__Kq.insertIndent},outdent:{text:z,image:R,action:this.__Kq.insertOutdent}},{insertImage:{text:s,image:E,action:this.__Kt},insertTable:{text:f,image:l,action:this.__Ku},insertLink:{text:a,image:C,action:this.__Kv},insertHTML:{text:J,image:bl,action:this.__Kw},insertHR:{text:bo,image:bn,action:this.__Kq.insertHorizontalRuler}},{ol:{text:D,image:bG,action:this.__Kq.insertOrderedList},ul:{text:bb,image:bq,action:this.__Kq.insertUnorderedList}},{undo:{text:bL,image:m,action:this.__Kq.undo},redo:{text:bS,image:N,action:this.__Kq.redo}}];
},__KA:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator("main");
var cv;
var cw=this.__Kz();

for(var i=0,j=cw.length;i<j;i++){var cx=new qx.ui.toolbar.Part;
toolbar.add(cx);

for(var cy in cw[i]){var cz=cw[i][cy];

if(cz.custom){cv=cz.custom.call(this);
}else{cv=new qx.ui.toolbar.Button(null,cz.image);
cv.set({focusable:false,keepFocus:true,center:true,toolTipText:cz.text?cz.text:""});
cv.addListener("execute",cz.action,this.__Kq);
}cx.add(cv);
}}return toolbar;
}}});
})();
...
(function(){var cz="engine.name",cy="mshtml",cx="",cw="gecko",cv="webkit",cu="opera",ct="qx.event.type.Data",cs="qx.event.type.Event",cr="Boolean",cq="enter",bz="text-align",by="right",bx="__elementToFocus__",bw="qx.bom.htmlarea.HtmlArea.debug",bv="left",bu="qx.debug",bt="engine.version",bs="inserthtml",br="id",bq="italic",cG="body",cH="underline",cE="br",cF="b",cC="contextmenu",cD="pageup",cA="end",cB="keydown",cI='On',cJ="redo",bX="i",bW="backspace",ca="bold",bY="mouseup",cc="down",cb="100%",ce='</head>',cd='<head>',bV="k",bU='redo',d="y",f='Off',g="font-family",h="keypress",k=" ",l="fontsize",m="undo",n="pagedown",o="justify",p="p",cX="center",cW="backgroundcolor",cV='</style>',cU="u",dc="focus",db="backgroundimage",da="click",cY='<style type="text/css">',de="up",dd="text-decoration",P="blur",Q="font-size",N="None",O="control",T="delete",U="line-through",R="String",S="fontfamily",L="keyup",M="loadingError",y="focusout",x="z",A="-",z="li",u='undo',t="<br class='webkit-block-placeholder' />",w="textbackgroundcolor",v="Function",r="home",q="focused",ba="load",bb="setUnderline",bc="<br /><div id='placeholder'></div>",bd="transparent",V="'>",W='underline',X='bold',Y="ul",be="S",bf="setBold",I="P",H="<P>&nbsp;</P>",G="qx/static/blank.html",F="X",E="inserthorizontalrule",D="//text()[string-length(normalize-space(.))>0]",C="#",B="textcolor",K="a",J="cursorContext",bg="removeformat",bh="__DA",bi="ready",bj="<p>&nbsp;</p>",bk="outline",bl=" html, body {overflow-x: visible; } ",bm="insertorderedlist",bn="> ",bo="styleWithCSS",bp="hideFocus",bD="none",bC="setItalic",bB="font-style",bA="xhtml",bH="focusOut",bG="Please use the method 'qx.dom.Node.isBlockNode' instead.",bF="Control",bE="justifyleft",bJ='size',bI="font-weight",bQ="LI",bR='italic',bO="STYLE",bP="justifyfull",bM="inserthyperlink",bN="<br />",bK="<br>",bL="justifycenter",bS="useCSS",bT="strikethrough",ci="text/html",ch="true",ck="1.9",cj="indent",cn="messengerContent",cl="insertunorderedlist",cp="Text",co="Integer",cg="_moz_dirty",cf='</body></html>',cQ='<br/><div class="placeholder"></div>',cR="selectall",cS=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",cT="justifyright",cM="ol",cN="outdent",cO="about:blank",cP="<body style='",cK="qx.bom.htmlarea.HtmlArea",cL="Verdana",c="insertimage",b="Off";
qx.Class.define(cK,{extend:qx.core.Object,construct:function(df,dg,dh,di){qx.core.Object.call(this);
var dk=di||qx.util.ResourceManager.getInstance().toUri(G);
this.__DR(df);
this.__DS();
this._createAndAddIframe(dk);
this._addIframeLoadListener();
this.__Dz=qx.bom.htmlarea.HtmlArea.__DB(dh);
if(qx.lang.Type.isString(dg)){this.__vJ=dg;
}if((qx.core.Environment.get(cz)==cu)){var dj=qx.dom.Node.getWindow(df);
var dl=qx.event.Registration.getManager(dj).getHandler(qx.event.handler.Keyboard);
dl._keyCodeToIdentifierMap[35]=C;
dl._keyCodeToIdentifierMap[45]=A;
dl._keyCodeToIdentifierMap[112]=I;
dl._keyCodeToIdentifierMap[115]=be;
dl._keyCodeToIdentifierMap[120]=F;
}this.__DA=this.__Eg();
},events:{"load":cs,"loadingError":ct,"messengerContent":ct,"cursorContext":ct,"ready":cs,"readyAfterInvalid":cs,"focused":cs,"focusOut":cs,"contextmenu":ct,"undoRedoState":ct},statics:{simpleLinebreak:bK,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:bf},italic:{method:bC},underline:{method:bb},undo:{method:m},redo:{method:cJ}},__DB:function(dm){if(dm==null||dm==""){return "";
}else if(typeof dm=="object"){var dn="";

for(var i in dm){dn+=i+" { "+dm[i]+" }";
}return dn;
}else{return dm;
}},__DC:function(dp){var dq={};
var a=dp.split(";");
var i;

for(i=0;i<a.length;i++){var dr=a[i],ds=dr.indexOf(":");

if(ds===-1){continue;
}var name=qx.lang.String.trim(dr.substring(0,ds));
var dt=qx.lang.String.trim(dr.substring(ds+1,dr.length));

if(name&&dt){dq[name]=dt;
}}return dq;
},__DD:function(du,dv,dw,dx){var dC=[];

switch(du.nodeType){case 1:case 11:var i;
var dA=du.tagName.toLowerCase();
var dE={};
var dy={};
var closed=(!(du.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__DE(du)));

if(dv){if((qx.core.Environment.get("engine.name")=="mshtml")){if(dA=="div"&&du.className&&du.className=="placeholder"){for(i=du.firstChild;i;i=i.nextSibling){dC.push(qx.bom.htmlarea.HtmlArea.__DD(i,true,dw,dx));
}return dC.join("");
}}var dD=du.attributes;
var dB=dD.length;
var a;

if((qx.core.Environment.get("engine.name")=="gecko")){if(dA=="span"&&dB==1&&dD[0].name=="_moz_dirty"&&du.childNodes.length==0){return "";
}}
for(i=0;i<dB;i++){a=dD[i];
if(!a.specified){continue;
}var name=qx.dom.Node.getName(a);
var dF=a.nodeValue;
if(/(_moz|contenteditable)/.test(name)){continue;
}
if(name!="style"){if(qx.core.Environment.get("engine.name")=="mshtml"){if(name=="id"&&du.getAttribute("old_id")){dF=du.getAttribute("old_id");
}else if(!isNaN(dF)){dF=du.getAttribute(name);
}else{dF=a.nodeValue;
}}else{dF=a.nodeValue;
}}else{dF=du.style.cssText;
}
if(/(_moz|^$)/.test(dF)){continue;
}if(name=="old_id"){continue;
}if(!dF){continue;
}if(name=="id"&&dF=="__elementToFocus__"){continue;
}if(name.charAt(0)==="$"){continue;
}dE[name]=dF;
}if(dE.style!==undefined){dy=qx.bom.htmlarea.HtmlArea.__DC(dE.style);
delete dE.style;
}if(dx){var dz={domElement:du,tag:dA,attributes:dE,styles:dy};
dx(dz);
dz.domElement=null;
dA=dz.tag;
}if(dA){dC.push("<",dA);
for(var name in dE){var dF=dE[name];
dC.push(" ",name,'="',dF.toString().replace(new RegExp('"',"g"),"'"),'"');
}if(!qx.lang.Object.isEmpty(dy)){dC.push(' style="');

for(var name in dy){var dF=dy[name];
dC.push(name,":",dF.toString().replace(new RegExp('"',"g"),"'"),";");
}dC.push('"');
}dC.push(closed?" />":">");
}}for(i=du.firstChild;i;i=i.nextSibling){dC.push(qx.bom.htmlarea.HtmlArea.__DD(i,true,dw,dx));
}if(dv&&!closed&&dA){dC.push("</",dA,">");
}break;
case 3:dC.push(dw?du.data:qx.bom.htmlarea.HtmlArea.__DF(du.data));
break;
case 8:dC.push("<!--",du.data,"-->");
break;
}return dC.join("");
},closingTags:cS,__DE:function(dG){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(" "+dG.tagName+" ")!=-1);
...
return s;
},isBlockNode:function(dH){var dI=qx.bom.htmlarea.HtmlArea.isBlockNode;
var dJ=bG;
qx.log.Logger.deprecatedMethodWarning(dI,dJ);
return qx.dom.Node.isBlockNode(dH);
},isParagraphParent:function(dK){if(!qx.dom.Node.isElement(dK)){return false;
}dK=qx.dom.Node.getName(dK);
return /^(body|td|th|caption|fieldset|div)$/.test(dK);
},isHeadlineNode:function(dL){if(!qx.dom.Node.isElement(dL)){return false;
}var dM=qx.dom.Node.getName(dL);
return /^h[1-6]$/.test(dM);
}},properties:{contentType:{check:R,init:bA},messengerMode:{check:cr,init:false},insertParagraphOnLinebreak:{check:cr,init:true},insertLinebreakOnCtrlEnter:{check:cr,init:true},postProcess:{check:v,nullable:true,init:null},useUndoRedo:{check:cr,init:true},nativeContextMenu:{check:cr,init:false},defaultFontFamily:{check:R,init:cL},defaultFontSize:{check:co,init:4}},members:{__hE:null,__cX:false,__DG:false,__DH:false,__DI:false,__DJ:false,__DA:null,__DK:null,__DL:null,__DM:null,__yj:null,__Dz:null,__DN:null,__DO:null,__DP:false,__DQ:false,__DR:function(dN){if(qx.dom.Node.isElement(dN)&&qx.dom.Node.isNodeName(dN,"div")){this.__hE=dN;
}},_createAndAddIframe:function(dO){this.__yj=qx.bom.Iframe.create();
qx.bom.Iframe.setSource(this.__yj,dO);
if((qx.core.Environment.get(cz)==cy)){qx.bom.element.Attribute.set(this.__yj,bp,ch);
}else{qx.bom.element.Style.set(this.__yj,bk,bD);
...
},_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__yj,ba,this._loaded,this);
...
},setValue:function(dP){if(qx.lang.Type.isString(dP)){this.__vJ=dP;
var dQ=this._getIframeDocument();

if(dQ&&dQ.body){dQ.body.innerHTML=this.__DT(dP);
}}},__DT:function(dR){var dU="";

if((qx.core.Environment.get("engine.name")=="gecko")){if(qx.core.Environment.get("browser.version")<=2){dU+='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>';
}}var dV=dR.length==0?"\ufeff":"";
var dT=qx.core.Environment.get("engine.name")=="gecko"||qx.core.Environment.get("engine.name")=="webkit"?'id="__elementToFocus__"':'';
var dS='<p>'+'<span style="font-family:'+this.getDefaultFontFamily()+'">'+'<font '+dT+' size="'+this.getDefaultFontSize()+'">'+dU+dR+dV+'</font>'+'</span>'+'</p>';
return dS;
},getValue:function(){return this.__vJ;
},getComputedValue:function(dW){return this.getHtml(dW);
},getCompleteHtml:function(){var dY=this.__DN[this.getContentType()];
var dX=dY.html+cd+dY.meta+cY+dY.contentStyle+cV+ce;
dX+=cP+this.__DU()+V;
dX+=this.getHtml()+cf;
return dX;
},__DU:function(){var ec=["backgroundColor","backgroundImage","backgroundRepeat","backgroundPosition","fontFamily","fontSize","marginTop","marginBottom","marginLeft","marginRight","paddingTop","paddingBottom","paddingLeft","paddingRight"];
var eb=qx.bom.element.Style;
var ea=this.getContentBody();
var ef={};
var ee,eg;
var ed=qx.core.Environment.get("engine.name")=="mshtml"?2:1;
...
em=em.replace(/<!--.*-->/gi,cx);
ej.innerHTML=em;
var ei=qx.core.Environment.get(cz)==cy||qx.core.Environment.get(cz)==cu?ej.innerText:ej.textContent;
...
},_fetchTextNodes:function(ev){var ey=[];
var ew;
if(ev.hasChildNodes){for(var i=0;i<ev.childNodes.length;i++){ew=this._fetchTextNodes(ev.childNodes[i]);
qx.lang.Array.append(ey,ew);
}}if(ev.nodeType==3){if(ev.nodeValue.length>1){ey.push(ev);
}}return ey;
},__DV:0,__DW:function(){var ez=this._getIframeDocument();
if(!ez){this.__DV++;

if(this.__DV>5){this.error('cant load HtmlArea. Document is not available. '+ez);
this.fireDataEvent("loadingError");
}else{if(qx.core.Environment.get("qx.debug")){this.error('document not available, try again...');
}qx.event.Timer.once(function(){this.__DW();
},this,0);
}}else{this.__DV=0;
...
return;
}if((qx.core.Environment.get(cz)==cy)){this.__DW();
}else{this._onDocumentIsReady();
}},isReady:function(){return this.__cX;
},_onDocumentIsReady:function(){var eA=new qx.bom.htmlarea.manager.Command(this);

if(this.getUseUndoRedo()){eA=new qx.bom.htmlarea.manager.UndoRedo(eA,this);
}this.__DH=true;
if((qx.core.Environment.get(cz)==cy)){this.setEditable(true);
}this.__Eb();

if(!(qx.core.Environment.get(cz)==cu)){this.__Ec();
}if(!(qx.core.Environment.get(cz)==cy)){this.setEditable(true);
}this.__cX=true;
this.__DA=eA;
eA.setContentDocument(this._getIframeDocument());
this.__Eh();
if((qx.core.Environment.get(cz)==cu)){this.__Ec();
}this.fireEvent(bi);
},forceEditable:qx.core.Environment.select(cz,{"gecko":function(){var eB=this._getIframeDocument();

if(eB){if(parseFloat(qx.core.Environment.get(bt))>=ck){eB.designMode=b;
eB.body.contentEditable=false;
eB.body.contentEditable=true;
}else{eB.body.contentEditable=true;
this.__Ei(true);
}}},"default":qx.lang.Function.empty}),invalidateEditor:qx.core.Environment.select(cz,{"gecko":function(){this.__DH=false;
this.__cX=false;
this.__DG=true;
...
},"default":function(){}}),__DY:function(eC){var eE="";

if(!eC){return eE;
}
try{var eD=eC.getAttribute("style");

if(!eD){return eE;
}if((qx.core.Environment.get("engine.name")=="mshtml")){eE=eD.cssText;
}else{eE=eD;
}}catch(eF){this.error("can't extract style from elem. ");
}return eE;
},__Ea:function(eG){var eH=qx.core.Environment.get(cz)==cw?bl:cx;
var eI=this.__DN[this.getContentType()];
var eJ=cd+eI.meta+cY+eH+eI.style+eI.contentStyle+this.__Dz+cV+ce;
var content=eI.body+eG;
return eI.html+eJ+content+eI.footer;
},__Eb:function(){var eL=this.__DT(this.getValue());

if(qx.lang.Type.isString(eL)){var eK=this._getIframeDocument();

try{eK.open(ci,true);
eK.write(this.__Ea(eL));
eK.close();
...
this.__Ef();
this.__Ee();
},__Ed:function(){var eN=qx.event.Registration;
var eM=this._getIframeDocument();
eN.addListener(eM.body,h,this._handleKeyPress,this);
eN.addListener(eM.body,L,this._handleKeyUp,this);
eN.addListener(eM.body,cB,this._handleKeyDown,this);
},__Ee:function(){var eQ=qx.event.Registration;
var eO=this._getIframeDocument();
var eP=qx.core.Environment.get(cz)==cv?this._getIframeWindow():eO.body;
eQ.addListener(eP,dc,this._handleFocusEvent,this);
eQ.addListener(eP,P,this._handleBlurEvent,this);
eQ.addListener(eO,y,this._handleFocusOutEvent,this);
},__Ef:function(){var eT=qx.event.Registration;
var eS=this._getIframeDocument();
var eR=qx.core.Environment.get(cz)==cy?da:bY;
eT.addListener(eS.body,eR,this._handleMouseUpOnBody,this);
eT.addListener(eS.documentElement,eR,this._handleMouseUpOnDocument,this);
eT.addListener(eS.documentElement,cC,this._handleContextMenuEvent,this);
},__Eg:function(){if(this.__DK==null){this.__DK={execute:function(eU,eV){this.stackedCommands=true;
this.commandStack.push({command:eU,value:eV});
},commandStack:[],stackedCommands:false};
}this.__DK.stackedCommands=false;
return this.__DK;
},__Eh:function(){var eW=this.__DK;

if(eW!=null&&eW.stackedCommands){var eX=eW.commandStack;

if(eX!=null){for(var i=0,j=eX.length;i<j;i++){this.__DA.execute(eX[i].command,eX[i].value);
}}}},__Ei:function(eY){var fa=this._getIframeDocument();

if(this.__DH&&fa){try{if((qx.core.Environment.get(cz)==cw)){fa.designMode=(eY!==false)?f:cI;
}fa.designMode=(eY!==false)?cI:f;
}catch(e){}}},setEditable:function(fb){if(this.__DH){this.__Ei(true);
if((qx.core.Environment.get(cz)==cw)){try{var fc=this._getIframeDocument();
fc.execCommand(bo,false,true);
}catch(fd){try{var fc=this._getIframeDocument();
fc.execCommand(bS,false,false);
}catch(fe){if(!this.__cX){this.error("Failed to enable rich edit functionality");
this.fireDataEvent(M,fe);
...
},__Ej:false,_handleKeyUp:function(e){var ff=e.getKeyIdentifier().toLowerCase();
this.__DL=e;

if((qx.core.Environment.get(bu))&&qx.core.Environment.get(bw)){this.debug(e.getType()+" | "+ff);
}if(qx.core.Environment.get(cz)==cy||qx.core.Environment.get(cz)==cv){if(this.__Ej){switch(ff){case cq:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(cz)==cv)){this.__Ek();
e.preventDefault();
e.stopPropagation();
}else{var fg=this.__Eu(this.getSelection());

if(fg){fg.collapse(true);
fg.pasteHTML(cQ);
}}this.__Ep();
}break;
case O:this.__Ej=false;
return;
break;
}}}else if((qx.core.Environment.get(cz)==cw)){switch(ff){case bv:case by:case de:case cc:case cD:case n:case T:case cA:case bW:this.__DJ=(this.getFocusNode()==this.getContentBody().firstChild);
break;
}}},__Ek:function(){var fh=this.getSelection();
var fi=cx;
if(fh&&(fh.focusNode.textContent==cx||fh.focusNode.parentElement.tagName==bQ)){fi=t;
}this.__DA.execute(bs,fi+qx.bom.htmlarea.HtmlArea.simpleLinebreak);
},_handleKeyDown:qx.core.Environment.select(cz,{"mshtml|webkit":function(e){var fj=e.getKeyIdentifier().toLowerCase();

if((qx.core.Environment.get(bu))&&qx.core.Environment.get(bw)){}if(this.__Ej&&(fj==x||fj==d||fj==cF||fj==cU||fj==bX||fj==bV)){e.preventDefault();
e.stopPropagation();
}if(fj==O){this.__Ej=true;
}},"default":function(e){}}),_handleKeyPress:function(e){var fo=this.getContentDocument();
var fk=e.getKeyIdentifier().toLowerCase();
var fm=e.isCtrlPressed();
var fn=e.isShiftPressed();
this.__DL=e;

if((qx.core.Environment.get(bu))&&qx.core.Environment.get(bw)){this.debug(e.getType()+" | "+fk);
}if(this.__DP){var fu=!((qx.core.Environment.get(cz)==cy)&&fk==cq)||!((qx.core.Environment.get(cz)==cw)&&fk==cq);

if(fu){this.__Ep();
this.__DP=false;
}}
switch(fk){case cq:if(!fn&&!fm&&this.getMessengerMode()){e.preventDefault();
e.stopPropagation();
this.fireDataEvent(cn,this.getComputedValue());
this.resetHtml();
}if(fm){if(!this.getInsertLinebreakOnCtrlEnter()){return;
}e.preventDefault();
e.stopPropagation();

if((qx.core.Environment.get(cz)==cw)){if(this.__Es()){this.insertHtml(bN);
this.__Ep();
return;
}this.insertHtml(bc);
}else if((qx.core.Environment.get(cz)==cu)){var ft=this.getSelection();
var fp=this.__Eu(ft);

if(ft&&fp){var fq=fo.createElement(cE);
fp.collapse(true);
fp.insertNode(fq);
fp.collapse(true);
fp.selectNode(fq);
...
}if((qx.core.Environment.get(cz)==cy)){if(!this.getInsertParagraphOnLinebreak()){if(this.__DA.execute(bs,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__Ep();
e.preventDefault();
e.stopPropagation();
}}}else if((qx.core.Environment.get(cz)==cw)){if(this.getInsertParagraphOnLinebreak()&&!fn&&!fm){var ft=this.getSelection();

if(ft){var fl=ft.focusNode;
if(this.__Es()){this.__Ep();
return;
}if(this.__Et()){this.__Ep();
return;
}while(!qx.dom.Node.isNodeName(fl,cG)){if(qx.dom.Node.isNodeName(fl,z)){this.__Ep();
return;
}fl=fl.parentNode;
...
this.__Ep();
this.__DP=true;
}}else if((qx.core.Environment.get(cz)==cv)){if(this.getInsertParagraphOnLinebreak()&&fn){this.__Ek();
e.preventDefault();
e.stopPropagation();
this.__Ep();
}}break;
case de:if(qx.core.Environment.get(cz)==cw&&qx.core.Environment.get(bt)<1.9&&fn){var ft=this.getSelection();
if(ft&&ft.focusNode==fo.body.firstChild){if(this.__DJ){if(ft.focusOffset!=0){ft.extend(ft.focusNode,0);
}}}}this.__Ep();
break;
case r:if(qx.core.Environment.get(cz)==cw&&qx.core.Environment.get(bt)<1.9){if(fm){var ft=this.getSelection();
if(fn){if(ft&&(ft.focusOffset!=0)||(ft.focusNode!=fo.body.firstChild)){ft.extend(fo.body.firstChild,0);
}}else{var fr=null;
var fs;
if(fo){fr=fo.evaluate(D,fo.body,null,XPathResult.ANY_TYPE,null);
}
if(fr&&ft){while(fs=fr.iterateNext()){if(fs&&fs.parentNode&&fs.parentNode.tagName!=bO){try{ft.extend(fs,0);

if(!this.isSelectionCollapsed()){ft.collapseToStart();
}}catch(e){}break;
}}}}}}this.__Ep();
break;
case bv:case by:case cc:case cD:case n:case T:case cA:case bW:this.__Ep();
break;
case cF:if(fm){this.__El(X,true);
}break;
case bX:case bV:if(fm){this.__El(bR,true);
}break;
case cU:if(fm){this.__El(W,true);
}break;
case x:if(fm&&!fn){this.__El(u,true);
}else if(fm&&fn){this.__El(bU,true);
}break;
case d:if(fm){this.__El(bU,true);
}break;
case K:if(fm){this.selectAll();
}break;
}this.__DL=null;
},__El:function(fv,fw){var fy=null;
...
if(fw){this.__DL.preventDefault();
...
if(qx.core.Environment.get(cz)==cw||qx.core.Environment.get(cz)==cv){var fz=this.getContentDocument().getElementById(bx);

if(fz){qx.bom.element.Attribute.reset(fz,br);
}}this.fireEvent(q);
...
},_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(bu))&&qx.core.Environment.get(bw)){this.debug("handleMouse "+e.getType());
}this.__DQ=true;
this.__Ep();
},_handleMouseUpOnDocument:qx.core.Environment.select(cz,{"mshtml":qx.lang.Function.empty,"default":function(e){if(!this.__DQ){qx.bom.Element.activate(this.getContentBody());
}this.__DQ=false;
}}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var fC=e.getViewportLeft();
var fB=e.getViewportTop();
var fD=qx.bom.element.Location.getLeft(this.__hE)+fC;
var fE=qx.bom.element.Location.getTop(this.__hE)+fB;
var fA={x:fD,y:fE,relX:fC,relY:fB,target:e.getTarget()};
e.preventDefault();
e.stopPropagation();
qx.event.Timer.once(function(){this.fireDataEvent(cC,fA);
},this,0);
}},isLoaded:function(){return this.__DH;
},insertHtml:function(fF){return this.__DA.execute(bs,fF);
},removeFormat:function(){var fG=this.__DA.execute(bg);
this.__DA.execute(l,this.getDefaultFontSize());
this.__DA.execute(S,this.getDefaultFontFamily());
return fG;
},setBold:function(){return this.__DA.execute(ca);
},setItalic:function(){return this.__DA.execute(bq);
},setUnderline:function(){return this.__DA.execute(cH);
},setStrikeThrough:function(){return this.__DA.execute(bT);
},setFontSize:function(fH){return this.__DA.execute(l,fH);
},setFontFamily:function(fI){return this.__DA.execute(S,fI);
},setTextColor:function(fJ){return this.__DA.execute(B,fJ);
},setTextBackgroundColor:function(fK){return this.__DA.execute(w,fK);
},setJustifyLeft:function(){return this.__DA.execute(bE);
},setJustifyCenter:function(){return this.__DA.execute(bL);
},setJustifyRight:function(){return this.__DA.execute(cT);
},setJustifyFull:function(){return this.__DA.execute(bP);
},insertIndent:function(){return this.__DA.execute(cj);
},insertOutdent:function(){return this.__DA.execute(cN);
},insertOrderedList:function(){return this.__DA.execute(bm);
},insertUnorderedList:function(){return this.__DA.execute(cl);
},insertHorizontalRuler:function(){return this.__DA.execute(E);
},insertImage:function(fL){return this.__DA.execute(c,fL);
},insertHyperLink:function(fM){return this.__DA.execute(bM,fM);
},removeBackgroundColor:function(){this.__DA.execute(cW,bd);
},setBackgroundColor:function(fN){this.__DA.execute(cW,fN);
},removeBackgroundImage:function(){this.__DA.execute(db);
},setBackgroundImage:function(fO,fP,fQ){return this.__DA.execute(db,[fO,fP,fQ]);
},selectAll:function(){return this.__DA.execute(cR);
},undo:function(){if(this.getUseUndoRedo()){return this.__DA.execute(m);
}else{return true;
}},redo:function(){if(this.getUseUndoRedo()){return this.__DA.execute(cJ);
}else{return true;
}},resetHtml:function(){var fR=this._getIframeDocument();
while(fR.body.firstChild){fR.body.removeChild(fR.body.firstChild);
}if(qx.core.Environment.get(cz)==cw){fR.body.innerHTML=bj;
}else if(qx.core.Environment.get(cz)==cv){var fS=this.getSelection();
var fT=fR.createRange();

if(fT&&fS){fS.addRange(fT);
}}},getHtml:function(fU){var fV=this._getIframeDocument();

if(fV==null){return null;
}return qx.bom.htmlarea.HtmlArea.__DD(fV.body,false,fU,this.getPostProcess());
},containsOnlyPlaceholder:qx.core.Environment.select(cz,{"mshtml":function(){var fW=this._getIframeDocument();
return (fW.body.innerHTML==H);
},"default":qx.lang.Function.returnFalse}),_selectElement:function(fX){var ga=this.getContentWindow().getSelection();
var fY=this.getContentDocument().createRange();
fY.setStart(fX,0);
ga.removeAllRanges();
ga.addRange(fY);
},focusContent:qx.core.Environment.select(cz,{"gecko":function(){var gc=this.getContentDocument();
var gb=gc.getElementById(bx);
...
qx.bom.Element.focus(this.getContentBody());
var gd=this.getContentDocument().getElementById(bx);

if(gd){qx.bom.element.Attribute.reset(gd,br);
}this.__Em();
...
}},__En:qx.core.Environment.select(cz,{"gecko":function(){var ge=this.getContentBody().childNodes;

if(ge.length==0){return false;
}else if(ge.length==1){return !(ge[0]&&qx.dom.Node.isNodeName(ge[0],cE)&&qx.bom.element.Attribute.get(ge[0],cg)!=null);
}else{return true;
}},"webkit":function(){var gf=this.getContentBody().childNodes;

if(gf.length==0){return false;
}else if(gf.length==1){return !(gf[0]&&qx.dom.Node.isNodeName(gf[0],cE));
}else{return true;
}},"default":function(){var gg=this.getContentBody().childNodes;

if(gg.length==0){return false;
}else if(gg.length==1){return !(gg[0]&&qx.dom.Node.isNodeName(gg[0],p)&&gg[0].firstChild==null);
}else{return true;
}}}),__Eo:qx.core.Environment.select(cz,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__DT(cx);
var gh=this.getContentDocument().getElementById(bx);
qx.bom.element.Attribute.reset(gh,br);
this._selectElement(gh);
},"default":function(){var gi=qx.dom.Hierarchy.getFirstDescendant(this.getContentBody());

if(qx.dom.Node.isNodeName(gi,p)){qx.bom.element.Style.set(gi,g,this.getDefaultFontFamily());
qx.bom.element.Style.set(gi,Q,this.getDefaultFontSize());
}}}),getContextInformation:function(){return this.__Eq();
},__Ep:function(){qx.event.Timer.once(function(e){var gj=this.__Eq();
this.fireDataEvent(J,gj);
},this,200);
...
var gA=(qx.core.Environment.get(cz)==cy)?gn.currentStyle:gr.defaultView.getComputedStyle(gn,null);
var gu=false;
var gk=false;
var gp=false;
var go=false;
...
if(gA!=null){if((qx.core.Environment.get(cz)==cy)){gk=gA.fontStyle==bq;
gp=gA.textDecoration.indexOf(cH)!==-1;
go=gA.textDecoration.indexOf(U)!==-1;
gy=gA.fontSize;
gt=gA.fontFamily;
gq=gA.textAlign==bv;
gB=gA.textAlign==cX;
gm=gA.textAlign==by;
gx=gA.textAlign==o;
}else{gk=gA.getPropertyValue(bB)==bq;
gp=gA.getPropertyValue(dd).indexOf(cH)!==-1;
go=gA.getPropertyValue(dd).indexOf(U)!==-1;
gy=gA.getPropertyValue(Q);
gt=gA.getPropertyValue(g);
gq=gA.getPropertyValue(bz)==bv;
gB=gA.getPropertyValue(bz)==cX;
gm=gA.getPropertyValue(bz)==by;
gx=gA.getPropertyValue(bz)==o;
}
if(qx.core.Environment.get(cz)==cy||qx.core.Environment.get(cz)==cu){gu=gA.fontWeight==700;
}else{gu=gA.getPropertyValue(bI)==ca||qx.dom.Node.isNodeName(gn,cF);
}}var gl=gn;
if(gl!=null&&gl.parentNode!=null&&!qx.dom.Node.isDocument(gl.parentNode)){while(gl!=null&&!qx.dom.Node.isNodeName(gl,cG)){var gs=qx.dom.Node.getName(gl);

if(gs==cM){gz=true;
break;
}else if(gs==Y){gv=true;
break;
}
if(gC==null||gC==cx){gC=qx.bom.element.Attribute.get(gl,bJ);
}gl=gl.parentNode;
}}var gw={bold:gu?1:0,italic:gk?1:0,underline:gp?1:0,strikethrough:go?1:0,fontSize:(gC==null)?gy:gC,fontFamily:gt,insertUnorderedList:gv?1:0,insertOrderedList:gz?1:0,justifyLeft:gq?1:0,justifyCenter:gB?1:0,justifyRight:gm?1:0,justifyFull:gx?1:0};
this._processingExamineCursorContext=false;
return gw;
},getSelection:qx.core.Environment.select(cz,{"mshtml":function(){return this._getIframeDocument()?this._getIframeDocument().selection:null;
},"default":function(){return this._getIframeWindow()?this._getIframeWindow().getSelection():null;
}}),isSelectionCollapsed:qx.core.Environment.select(cz,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==N;
},"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;
}}),getSelectedText:qx.core.Environment.select(cz,{"mshtml":function(){return this.getRange()?this.getRange().text:cx;
...
}var gD=this.getRange();

if(!gD){return cx;
}else{return this.__Er(gD);
}},__Er:qx.core.Environment.select(cz,{"mshtml":function(gE){if(!gE){return cx;
}return gE.item?gE.item(0).outerHTML:gE.htmlText;
},"default":function(gF){var gG=this._getIframeDocument();

if(gG&&gF){try{var gH=gG.createElement(cG);
gH.appendChild(gF.cloneContents());
return gH.innerHTML;
}catch(gI){}return gF+cx;
}return cx;
}}),clearSelection:qx.core.Environment.select(cz,{"mshtml":function(){var gJ=this.getSelection();

if(gJ){gJ.empty();
}},"default":function(){var gK=this.getSelection();

if(gK){gK.collapseToStart();
}}}),__Es:qx.core.Environment.select(cz,{"gecko":function(){var gL=this.getSelection();
var gM=this.getFocusNode();
return gL&&this.isSelectionCollapsed()&&gM!=null&&qx.dom.Node.isText(gM)&&gL.anchorOffset<gM.length;
},"default":function(){return false;
}}),__Et:qx.core.Environment.select(cz,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());
},"default":function(){return false;
}}),getRange:function(){return this.__Eu(this.getSelection());
},__Eu:qx.core.Environment.select(cz,{"mshtml":function(gN){var gO=this._getIframeDocument();

if(gN){try{return gN.createRange();
}catch(gP){return gO?gO.body.createTextRange():null;
}}else{return gO?gO.body.createTextRange():null;
}},"default":function(gQ){var gR=this._getIframeDocument();

if(gQ){try{return gQ.getRangeAt(0);
}catch(gS){return gR?gR.createRange():null;
}}else{return gR?gR.createRange():null;
}}}),saveRange:qx.core.Environment.select(cz,{"mshtml":function(){this.__DO=this.getRange();
},"default":function(){}}),getSavedRange:qx.core.Environment.select(cz,{"mshtml":function(){return this.__DO;
},"default":function(){}}),resetSavedRange:qx.core.Environment.select(cz,{"mshtml":function(){this.__DO=null;
},"default":function(){}}),getFocusNode:qx.core.Environment.select(cz,{"mshtml":function(){var gT=this.getSelection();
var gU;

switch(gT.type){case cp:case N:gU=this.__Eu(gT);

if(gU){gU.collapse(false);
return gU.parentElement();
}else{return null;
}break;
case bF:gU=this.__Eu(gT);

if(gU){try{gU.collapse(false);
}catch(gV){}return gU.item(0);
}else{return null;
}break;
...
}})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var gY=this._getIframeDocument();
var hb=qx.event.Registration;
hb.removeListener(gY.body,h,this._handleKeyPress,this);
hb.removeListener(gY.body,L,this._handleKeyUp,this);
hb.removeListener(gY.body,cB,this._handleKeyDown,this);
var ha=qx.core.Environment.get(cz)==cv?this._getIframeWindow():gY.body;
hb.removeListener(ha,dc,this._handleFocusEvent);
hb.removeListener(ha,P,this._handleBlurEvent);
hb.removeListener(gY,y,this._handleFocusOutEvent);
var gX=qx.core.Environment.get(cz)==cy?da:bY;
hb.removeListener(gY.body,gX,this._handleMouseUpOnBody,this);
hb.removeListener(gY.documentElement,gX,this._handleMouseUpOnDocument,this);
hb.removeListener(gY.documentElement,cC,this._handleContextMenuEvent,this);

if((qx.core.Environment.get(cz)==cy)){qx.bom.Iframe.setSource(this.__yj,cO);
}}catch(hc){}
if(this.__DA instanceof qx.core.Object){this._disposeObjects(bh);
}else{this.__DA=null;
...
},__ys:function(F){var G=function(){qx.bom.Event.removeNativeListener(F,j,G);
F.$$url=qx.bom.Iframe.queryCurrentUrl(F);
};
qx.bom.Event.addNativeListener(F,j,G);
}}});
})();
(function(){var p="engine.name",o="",n="mshtml",m="qx.debug",h="inserthtml",g="BackColor",f="FontSize",d="px",c="string",b="textDecoration",bn="backgroundImage",bm="backgroundRepeat",bl="backgroundPosition",bk="BODY",bj='|',bi="gecko",bh=" ",bg="id",bf="fontStyle",be="backgroundColor",w="_moz",x="webkit",u='" ',v="qx.bom.htmlarea.manager.Command",s='</p>',t="insertParagraph",q="OL",r='"></span>',A="'><br class='webkit-block-placeholder' />",B="_moz_dirty",J="no-repeat",H="transparent",R="italic",M="fontWeight",ba="type",W="url(",D=":",bd="<p style='",bc="line-through",bb="__paragraph__",C='<p id="',F="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",G="LI",I="__placeholder__",K='>',N="outdent",T='<span id="',Y="top",y="HiliteColor",z="UL",E="br",Q=")",P='',O="p",V="bold",U="indent",L=";",S="underline",a="span",X="body";
qx.Class.define(v,{extend:qx.core.Object,construct:function(bo){qx.core.Object.call(this);
this.__Ev=bo;
this.__nO=null;
this._commands=null;
this.__EC();
...
this.__Ey=0;
},statics:{__Ez:F,__EA:"repeat repeat-x repeat-y no-repeat"},members:{__nO:null,__Ev:null,__EB:false,__Ew:null,__Ex:null,__Ey:null,setContentDocument:function(bp){this.__nO=bp;
},getCommandObject:function(bq){if(this._commands[bq]){return this._commands[bq];
}else{return null;
...
},execute:function(br,bs){if(!this.__Ev.isReady()){this.error("editor not ready! '"+br+"':'"+bs+"'");
return false;
}br=br.toLowerCase();
bs=bs!=null?bs:null;
if(this._commands[br]){var bt;
var bu=this._commands[br];
if(!((qx.core.Environment.get(p)==x)&&(br==U||br==N))){if(this.__ED()){this.__EE();
}}if(bu.useBuiltin){bt=this.__EF(bu.identifier,false,bs);
}else{if(bu.method!=null&&this[bu.method]){bt=this[bu.method].call(this,bs,bu);
}else{this.error("The method '"+bu.method+"' you calling to execute the command '"+br+"' is not available!");
}}this.__Ev.resetSavedRange();
return bt;
}else{this.error("Command "+br+" is currently not supported!");
}},__ED:function(){var Node=qx.dom.Node;
var bv=this.__Ev.getFocusNode();
var by=false;
var bw=false;

if(bv){if(Node.isText(bv)){var bx=qx.dom.Hierarchy.getAncestors(bv);

for(var i=0,j=bx.length;i<j;i++){if(Node.isNodeName(bx[i],"p")||qx.bom.htmlarea.HtmlArea.isHeadlineNode(bx[i])){by=true;
break;
}}}else if(Node.isNodeName(bv,"body")){bw=true;
}}return bw||!by;
},__EE:function(){this.__EF("formatBlock",false,"p");
},__EF:function(bz,bA,bB){try{var bE=this.__nO;
var bC=false;
var bD=this.__Ev.getRange();
this.__nO.body.focus();
if((qx.core.Environment.get("engine.name")=="mshtml")){if(bz!="selectall"){bD.select();
if(((bD.text)&&(bD.text.length>0))||((bD.length==1)&&(bD.item(0))&&(bD.item(0).tagName=="IMG"))){bE=bD;
}else{bE=this.__nO;
}}if(((qx.core.Environment.get("engine.name")=="mshtml"))&&(this.__Ew[bz])){if(bD.text==""){bC=true;
}}}var bF=bE.execCommand(bz,bA,bB);

if(bC&&bD.text!=""){bD.collapse();
}
if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("execCommand "+bz+" with value "+bB+" succeded");
}this.__EB=false;
}catch(bG){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("execCommand "+bz+" with value "+bB+" failed");
}return false;
}return bF;
},__EG:qx.core.Environment.select("engine.name",{"mshtml":function(){var bI=this.__Ev;
var bH=bI.getSavedRange()!=null?bI.getSavedRange():bI.getRange();
return bH;
},"default":function(){return this.__Ev.getRange();
}}),__EH:qx.core.Environment.select("engine.name",{"mshtml":function(bJ,bK){var bN;
if(bJ==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__EK();
}else{this.__nO.body.focus();
var bM=this.__Ev.getSelection();
var bL=this.__EG();
if(bL&&bM&&bM.type!="Control"){try{bL.pasteHTML(bJ);
bL.collapse(false);
bL.select();
bN=true;
}catch(e){}}else{bN=false;
}this.__Ev.resetSavedRange();
return bN;
}},"default":function(bO,bP){this.__nO.body.focus();
return this.__nO.execCommand(bP.identifier,false,bO);
}}),insertParagraphOnLinebreak:qx.core.Environment.select(p,{"gecko":function(){var bX=this.__EU();
var cc=this.__EI(bX);
var bT=this.__ES(bX);
var bY=I+Date.parse(new Date());
var ca=bb+Date.parse(new Date());
var bR=P;
var bV=T+bY+r;
bR+=bV;
bR+=C+ca+u+cc+K;
bR+=bT+s;
this.__Ev.getCommandManager().addUndoStep(h,t,this.getCommandObject(h));
this.execute(h,bR);
this.__EJ();
qx.bom.element.Attribute.reset(this.__nO.getElementById(bY),bg);
var bW=this.__nO.getElementById(ca);

if(bW.previousSibling.innerHTML==bV){var bQ=this.__ET();
var bU=this.__nO.createElement(E);
var bS=this.__nO.createAttribute(B);
bS.nodeValue=o;
bU.setAttributeNode(bS);
var cb=this.__nO.createAttribute(ba);
cb.nodeValue=w;
bU.setAttributeNode(cb);
bW.previousSibling.appendChild(bQ);
bW.previousSibling.appendChild(bU);
}qx.bom.element.Attribute.reset(bW,bg);
return true;
},"webkit":function(){var cd=this.getCurrentStyles();
var ce=o;
var cg={"background-color":true,"text-align":true};
for(var cf in cd){if(cg[cf]){ce+=cf+D+cd[cf]+L;
}}this.__Ev.insertHtml(bd+ce+A);
},"default":qx.lang.Function.empty}),__EI:qx.core.Environment.select("engine.name",{"gecko":function(ch){var cm='style="';
var cl=ch.child;
if(cl["text-align"]){cm+='text-align:'+cl["text-align"]+';';
delete ch.child["text-align"];
}if(cl["font-family"]){cm+='font-family:'+cl["font-family"]+';';
delete ch.child["font-family"];
}var ck={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};
var ci={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};

for(var cj in cl){if(ck[cj]||ci[cj]){cm+=cj+':'+cl[cj]+';';
delete ch.child[cj];
}}cm+='"';
return cm;
},"default":function(){return "";
}}),__EJ:qx.core.Environment.select("engine.name",{"gecko":function(){var cu=this.__Ev.getSelection();

if(!cu||!cu.focusNode){return;
}var cn=cu.focusNode;
var cs=cu.focusNode;

while(!qx.dom.Node.isNodeName(cs,"p")){cs=cs.parentNode;
}var cr=cs.previousSibling.id;
var cv=cs.nextSibling?cs.nextSibling.id:null;

if(qx.lang.String.startsWith(cr,"__paragraph__")&&cr==cv){var ct=cs.nextSibling;
var cp=this.__Ev.getRange();
cp.selectNode(ct);
cu.addRange(cp);
var co=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;
this.__Ev.getCommandManager().addUndoStep("inserthtml",co,this.getCommandObject("inserthtml"));
this.execute("inserthtml",co);
var cq=this.__Ev.getRange();

if(cn){while(cn&&cn.firstChild&&qx.dom.Node.isElement(cn.firstChild)){cn=cn.firstChild;
}}cq.selectNode(cn);
cu.addRange(cq);
cq.collapse(true);
}},"default":qx.lang.Function.empty}),__EK:qx.core.Environment.select("engine.name",{"mshtml":function(){var cw=this.__Ev.getRange();
if(cw&&!qx.dom.Node.isNodeName(cw.parentElement(),"li")){cw.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);
cw.collapse(false);
cw.select();
return true;
}return false;
},"default":function(){return false;
}}),__EL:function(cx,cy){var cz=(qx.core.Environment.get("engine.name")=="mshtml")?this.__Ev.getRange():this.__nO;
return cz.execCommand(cy.identifier,false,cx);
},__EM:function(cA,cB){if((qx.core.Environment.get("engine.name")=="mshtml")){var cC=this.__Ev.getFocusNode();
this.__EN(cC);
}this.__nO.body.focus();
var cD=this.__nO.execCommand(cB.identifier,false,cA);

if((qx.core.Environment.get("engine.name")=="webkit")){var cC=this.__Ev.getFocusNode();
this.__EN(cC.parentNode);
}return cD;
},__EN:function(cE){var cF=[];
var parent=cE.parentNode;

while(qx.dom.Node.isNodeName(parent,"blockquote")){cF.push(parent);
parent=parent.parentNode;
}if(cF.length>0){parent.appendChild(cE);
parent.removeChild(cF[cF.length-1]);
}},__EO:qx.core.Environment.select("engine.name",{"gecko":function(cG,cH){if(cG.src){this.__nO.execCommand(cH.identifier,false,cG.src);
delete cG.src;
var cU=this.__Ev.getSelection();
if(cU){var cT=cU.anchorNode;
var cO=cU.anchorOffset;
var cL=cT.childNodes[cO-1];
var cR;

for(var cN in cG){cR=this.__nO.createAttribute(cN);
cR.nodeValue=cG[cN];
cL.setAttributeNode(cR);
}var cM={"font":true,"span":true};
var cJ=null;
var cQ=true;
if(qx.dom.Node.isElement(cL.previousSibling)&&cM[qx.dom.Node.getName(cL.previousSibling)]){cJ=cL.previousSibling;
}else if(cM[qx.dom.Node.getName(cL.parentNode)]){cJ=cL.parentNode;
cQ=false;
}var cK=this.__nO.createDocumentFragment();
var cV;

if(cQ&&cJ!=null){var cM=this.__EP(cJ);
cK.appendChild(cM.root);
cV=cM.inline;
}else{cV=this.__nO.createElement("span");
cK.appendChild(cV);
}var cS=this.__nO.createTextNode("");
cV.appendChild(cS);
var cP=cL.parentNode;
if(cL==cP.lastChild){cP.appendChild(cK);
}else{cP.insertBefore(cK,cL.nextSibling);
}var cI=this.__Ev.getRange();
cI.selectNodeContents(cV);
}return true;
}else{return false;
}},"mshtml":function(cW,cX){var dc=false;
var dd="<img ";

for(var cY in cW){dd+=cY+"='"+cW[cY]+"' ";
}dd+="/>";
var da=this.__Ev.getSelection();
var db=this.__EG();
if(da&&da.type!="Control"){try{db.select();
db.pasteHTML(dd);
dc=true;
}catch(e){}}this.__Ev.resetSavedRange();
return dc;
},"default":function(de,df){if(de.src){var dh="<img ";

for(var dg in de){dh+=dg+"='"+de[dg]+"' ";
}dh+="/>";
return this.__nO.execCommand("InsertHtml",false,dh);
}else{return false;
}}}),__EP:function(di){while(di.firstChild&&di.firstChild.nodeType==1){di=di.firstChild;
}var dm=this.__EU(di);
var dr,dk,dp;
var dj="";
var parent=null;
...
while(dn){dq=this.__nO.createElement(dn["legacy-font-size"]?"font":"span");
dk=this.__nO.createAttribute("style");
dq.setAttributeNode(dk);
for(var dl in dn){if(dl!="child"&&dl!="legacy-font-size"){dj+=dl+":"+dn[dl]+";";
}else if(dl=="legacy-font-size"){dp=this.__nO.createAttribute("size");
dp.nodeValue=dn[dl];
dq.setAttributeNode(dp);
}}dk.nodeValue=dj;

if(parent!=null){parent.appendChild(dq);
}else{dr=dq;
}parent=dq;
dn=dn.child;
dj="";
}return {root:dr,inline:dq};
},__EQ:qx.core.Environment.select("engine.name",{"gecko|opera":function(ds,dt){var dz=this.__Ev.getSelection();
var dw=this.__Ev.getRange();
if(dz.isCollapsed){var dv="qx_link"+(++this.__Ey);
var dA=this.__nO.createElement("a");
var dx=this.__nO.createAttribute("href");
var du=this.__nO.createAttribute("id");
var dy=this.__nO.createTextNode(ds);
du.nodeValue=dv;
dA.setAttributeNode(du);
dx.nodeValue=ds;
dA.setAttributeNode(dx);
dA.appendChild(dy);
dw.insertNode(dA);
dw.selectNode(dA);
dz.collapseToEnd();
return true;
}else{return this.__nO.execCommand(dt.identifier,false,ds);
}},"mshtml":function(dB,dC){try{var dE;
var dD=this.__EG();
var dF=this.__Ev;
var dD=dF.getSavedRange()!=null?dF.getSavedRange():dF.getRange();

if(dD!=null&&dD.text!=""){dE=dD.execCommand(dC.identifier,false,dB);
}else{dE=this.__EH(' <a href="'+dB+'">'+dB+'</a> ',dC);
}this.__Ev.resetSavedRange();
return dE;
}catch(e){if(qx.core.Environment.get("qx.debug")){this.error("inserthyperlink failed!");
}return false;
}},"default":function(dG,dH){return this.__nO.execCommand(dH.identifier,false,dG);
}}),__ER:function(dI,dJ){var dK="<hr />";
if((qx.core.Environment.get("engine.name")=="gecko")){dK+=this.__ES();
}return this.__EH(dK,dJ);
},__ES:function(dL){var dP="";
var dO='<span style="';
var dN=[];
var dS=typeof dL!=="undefined"?dL:this.__EU();
var dQ=dS.child;
var dR=false;
if(qx.lang.Object.isEmpty(dQ)){return "";
}
while(dQ){dR=dQ["legacy-font-size"]!=null;
dP+=dR?'<font style="':dO;

for(var dM in dQ){dP+=(dM!="child"&&dM!="legacy-font-size")?dM+':'+dQ[dM]+';':"";
}dP+=dR?'" size="'+dQ["legacy-font-size"]+'">':'">';
dN.unshift(dR?"</font>":"</span>");
dQ=dQ.child;
}if(dN.length==1&&dN[0]=="</font>"){dP+="<span></span>";
}for(var i=0,j=dN.length;i<j;i++){dP+=dN[i];
}return dP;
},__ET:function(){var dU=this.__nO.createDocumentFragment();
var ea=this.__EU();
var parent=dU;
var dX=ea.child;
var dV;
...
while(dX){dY=dX["legacy-font-size"]!=null;
dV=this.__nO.createElement(dY?"font":"span");
parent.appendChild(dV);
for(var dT in dX){if(dT!="child"&&dT!="legacy-font-size"){qx.bom.element.Style.set(dV,dT,dX[dT]);
}}
if(dY){var dW=this.__nO.createAttribute("size");
dW.nodeValue=dX["legacy-font-size"];
dV.setAttributeNode(dW);
}parent=dV;
dX=dX.child;
}return dU;
},__EU:function(eb){var ed={};
var ee=null;
var ef=this.getCurrentStyles(eb);
ee=ed.child={};

for(var ec in ef){if(ec!="text-decoration"){ee[ec]=ef[ec];
}}if(ef["text-decoration"]){var eg=ef["text-decoration"];
for(var i=0,j=eg.length;i<j;i++){if(ee==null){ee=ed.child={};
}else{ee=ee.child={};
}ee['color']=eg[i]['color'];
ee['text-decoration']=eg[i]['text-decoration'];
}}if(ef['color']&&ef['text-decoration']){ee=ee.child={};
ee['color']=ef['color'];
}return ed;
},getCurrentStyles:function(eh){if(eh==null){var ej=this.__Ev.getSelection();

if(!ej||ej.focusNode==null){return {};
}eh=(ej.focusNode.nodeType==3)?ej.focusNode.parentNode:ej.focusNode;
}var ek=qx.dom.Hierarchy.getAncestors(eh);
var em=qx.lang.Array.insertBefore(ek,eh,ek[0]);
var ei=this.__EV(em);
var el=this.__EW(ei,em);
return el;
},__EV:function(en){var eq={};
var eo,ep;

for(var i=0,j=en.length;i<j;i++){ep=en[i];

for(var k=0,l=ep.style.length;k<l;k++){eo=ep.style[k];

if(eo.length>0&&typeof eq[eo]==="undefined"){eq[eo]=ep.style.getPropertyValue(eo);
}}if(ep.tagName.toUpperCase()=="FONT"&&ep.size&&eq["legacy-font-size"]===undefined){eq["legacy-font-size"]=ep.size;
}}if(eq["legacy-font-size"]&&eq["font-size"]){delete eq["font-size"];
}return eq;
},__EW:function(er,es){var ey=es[0];
var ev=this.__Ev.getContentWindow().getComputedStyle(ey,null);
var et;
var ew={};

for(var eu in er){if(eu!="legacy-font-size"){et=ev.getPropertyValue(eu);
}else{et=er[eu];
}if(eu=="background-color"&&et=="transparent"){ew[eu]=this.__EY(es);
}else if(eu=="text-decoration"){ew[eu]=this.__EX(es);
}else{ew[eu]=et;
}}return ew;
},__EX:function(ez){var eC,eE,eA;
var eD=[];
var eB=this.__Ev.getContentWindow();

for(var i=0,j=ez.length;i<j;i++){eA=eB.getComputedStyle(ez[i],null);
eC=eA.getPropertyValue("text-decoration");
eE=eA.getPropertyValue("color");
if(eC!="none"){eD.push({'text-decoration':eC,'color':eE});
}}return eD;
},__EY:function(eF){var eH,eG,eI;

for(var i=0;i<eF.length;i++){eH=eF[i];
eG=this.__Ev.getContentWindow().getComputedStyle(eH,null);
eI=eG.getPropertyValue("background-color");
if(eI!="transparent"){return eI;
}}},__Fa:function(eJ,eK){var eW=this.__Ev.getSelection();
var eR=((qx.core.Environment.get(p)==n))?this.__Ev.getRange():eR=eW.getRangeAt(0);
var eS=[];
var eV;
var eQ=[q,z];
var eL,i,j,eT;
eT=((qx.core.Environment.get(p)==n))?eR.parentElement():eR.commonAncestorContainer;
if(eT.tagName==bk){for(var i=0;i<eQ.length;i++){eL=eT.getElementsByTagName(eQ[i]);

for(var j=0;j<eL.length;j++){if(eL[j]){eS.push(eL[j]);
}}}}else if(qx.lang.Array.contains(eQ,eT.tagName)){eS.push(eT);
}
if(eS.length>0){for(var i=0;i<eS.length;i++){var eN=eS[i];
eV=((qx.core.Environment.get(p)==n))?((eN==eT)||(eT.tagName==bk)):eW.containsNode(eN,false);
for(j=0;j<eN.childNodes.length;j++){var eP=eN.childNodes[j];
if(eV||(eW.focusNode.nodeValue&&qx.dom.Hierarchy.contains(eP,eW.focusNode)&&(eW.focusOffset==eW.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(eP,eW.anchorNode)&&(eW.anchorOffset==0))||(eW.containsNode(eP,false))){eP.style.fontSize=(this.__Ex[eJ]||eJ)+d;
}}}}else{var eO=((qx.core.Environment.get(p)==n))?eT:eW.focusNode;
var eU=qx.dom.Hierarchy.getAncestors(eO);

for(i=0;i<eU.length;i++){if(eU[i].tagName==G){if((((qx.core.Environment.get(p)==bi))&&((eW.anchorOffset==0)&&(eW.focusNode.nodeValue&&(eW.focusOffset==eW.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(eU[i].firstChild,eW.anchorNode)&&qx.dom.Hierarchy.contains(eU[i].lastChild,eW.focusNode)))||(((qx.core.Environment.get(p)==n))&&(eR.htmlText==eU[i].innerHTML))){eU[i].style.fontSize=(this.__Ex[eJ]||eJ)+d;
}break;
}}}if((qx.core.Environment.get(p)==n)){this.__nO.body.focus();
this.__Ev.getRange().select();
return this.__nO.execCommand(f,false,eJ);
}else if((qx.core.Environment.get(p)==bi)){var parent=eR.commonAncestorContainer;
if(parent.nodeType===1){var eM=parent.getElementsByTagName(a);

for(i=0;i<eM.length;i++){if(eM[i].style.fontSize){eM[i].style.fontSize=null;
}}}}return this.__nO.execCommand(f,false,eJ);
},__Fb:qx.core.Environment.select(p,{"mshtml":function(eX,eY){this.__nO.body.focus();
return this.__nO.execCommand(g,false,eX);
},"gecko|opera":function(fa,fb){this.__nO.body.focus();
return this.__nO.execCommand(y,false,fa);
},"webkit":function(fc,fd){var fe=this.__Ev.getSelection();
var ff=this.__Ev.getRange();
if(!fe||!fe.isCollapsed){this.__nO.body.focus();
this.__nO.execCommand(g,false,fc);
if(fe){fe.collapseToEnd();
}return true;
}else{var fh=fe.anchorOffset;
var fi=fe.anchorOffset;
var ff=fe.getRangeAt(0);
var fg=fe.anchorNode;
while(fi>0){if(fg.nodeValue.charCodeAt(fi)==160||fg.nodeValue.charCodeAt(fi)==32){break;
}else{fi--;
}}while(fh<fg.nodeValue.length){if(fg.nodeValue.charCodeAt(fh)==160||fg.nodeValue.charCodeAt(fh)==32){break;
}else{fh++;
}}ff.setStart(fe.anchorNode,fe.anchorNode.nodeValue.charAt(fi)==bh?fi+1:fi);
ff.setEnd(fe.anchorNode,fh);
fe.addRange(ff);
this.__nO.body.focus();
this.__nO.execCommand(g,false,fc);
fe.collapseToEnd();
return true;
}}}),__Fc:function(fj,fk){fj=fj!=null&&typeof fj==c?fj:H;
qx.bom.element.Style.set(this.__nO.body,be,fj);
return true;
},__Fd:function(fl,fm){var fn,fp,fo;
var fq=qx.bom.htmlarea.manager.Command;

if(fl==null){fn=null;
}else{fn=fl[0];
fp=fl[1];
fo=fl[2];
}if(fn==null||typeof fn!=c){qx.bom.element.Style.set(this.__nO.body,bn,o);
qx.bom.element.Style.set(this.__nO.body,bm,o);
qx.bom.element.Style.set(this.__nO.body,bl,o);
return true;
}else{if(fn.search(/^url.*\(/)==-1){fn=W+fn+Q;
}}if(fp!=null&&!qx.lang.String.contains(fq.__EA,fp)){if(qx.core.Environment.get(m)){this.error("The value '"+fp+"' is not allowed for parameter 'repeat'. Possible values are '"+fq.__EA+"'");
}return false;
}else{fp=J;
}
if(fo!=null){if(qx.lang.Type.isString(fo)&&!qx.lang.String.contains(fq.__Ez,bj+fo+bj)){if(qx.core.Environment.get(m)){this.error("The value '"+fo+"' is not allowed for parameter 'position'. Possible values are '"+fq.__Ez+"'");
}return false;
}else{if(qx.lang.Type.isArray(fo)&&fo.length==2){fo=fo[0]+bh+fo[1];
}else{if(qx.core.Environment.get(m)){this.error("If an array is provided for parameter 'position' it has to define two elements!");
}return false;
}}}else{fo=Y;
}qx.bom.element.Style.set(this.__nO.body,bn,fn);
qx.bom.element.Style.set(this.__nO.body,bm,fp);
qx.bom.element.Style.set(this.__nO.body,bl,fo);
return true;
},__Fe:qx.core.Environment.select(p,{"mshtml":function(fr,fs){var ft=this.__nO.body.createTextRange();
ft.select();
return true;
},"default":function(fu,fv){return this.__EF(fv.identifier,false,fu);
}}),__Ff:function(){return this.__Ev.getSelectedText();
},__Fg:function(){return this.__Ev.getSelectedHtml();
},__Fh:function(fw,fx){var fB=this.__Ev.getFocusNode();

if(fB.textContent==o){var fz=qx.dom.Hierarchy.getAncestors(fB);
fz.unshift(fB);
var Node=qx.dom.Node;
var fy=qx.bom.element.Style;
var fA=fz.shift();

while(fz.length>0){if(Node.getName(fA)==O||Node.getName(fA)==X){break;
}if(fy.get(fA,fw,fy.LOCAL_MODE)==fx){fy.reset(fA,fw);
return true;
}fA=fz.shift();
}}return false;
},__Fi:qx.core.Environment.select(p,{"gecko":function(fC,fD){if(this.__Fh(M,V)){return true;
}else{return this.__EF(fD.identifier,false,fC);
}},"default":function(fE,fF){return this.__EF(fF.identifier,false,fE);
}}),__Fj:qx.core.Environment.select(p,{"gecko":function(fG,fH){if(this.__Fh(bf,R)){return true;
}else{return this.__EF(fH.identifier,false,fG);
}},"default":function(fI,fJ){return this.__EF(fJ.identifier,false,fI);
}}),__Fk:qx.core.Environment.select(p,{"gecko":function(fK,fL){if(this.__Fh(b,S)){return true;
}else{return this.__EF(fL.identifier,false,fK);
}},"default":function(fM,fN){return this.__EF(fN.identifier,false,fM);
}}),__Fl:qx.core.Environment.select(p,{"gecko":function(fO,fP){if(this.__Fh(b,bc)){return true;
}else{return this.__EF(fP.identifier,false,fO);
}},"default":function(fQ,fR){return this.__EF(fR.identifier,false,fQ);
...
}catch(bF){if(qx.core.Environment.get("qx.debug")){this.error("execCommand failed! Details: "+bF);
}}},"mshtml|webkit":function(bG){},"default":function(bH){this.__FR(bH);
return this.__FD();
...
},__FQ:function(cw){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("ADD TO UNDO STACK");
this.debug(cw.actionType+" "+cw.command+" "+cw.value);
}this.__Fm.push(cw);
},__FR:function(cx){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("ADD TO REDO STACK");
...
(function(){var j="Boolean",h="qx.ui.core.SingleSelectionManager",g="qx.debug",f="__mP",e="Invalid selectionProvider!",d="__mO",c="__mN",b="changeSelected",a="qx.event.type.Data";
...
},events:{"changeSelected":a},properties:{allowEmptySelection:{check:j,init:true,apply:f}},members:{__mO:null,__mN:null,getSelected:function(){return this.__mO;
},setSelected:function(l){if(!this.__mR(l)){throw new Error("Could not select "+l+", because it is not a child element!");
}this.__mQ(l);
},resetSelected:function(){this.__mQ(null);
},isSelected:function(m){if(!this.__mR(m)){throw new Error("Could not check if "+m+" is selected,"+" because it is not a child element!");
}return this.__mO===m;
},isSelectionEmpty:function(){return this.__mO==null;
},getSelectables:function(n){var o=this.__mN.getItems();
var p=[];

for(var i=0;i<o.length;i++){if(this.__mN.isItemSelectable(o[i])){p.push(o[i]);
}}if(!n){for(var i=p.length-1;i>=0;i--){if(!p[i].getEnabled()){p.splice(i,1);
}}}return p;
},__mP:function(q,r){if(!q){this.__mQ(this.__mO);
}},__mQ:function(s){var v=this.__mO;
var u=s;
...
},__mR:function(w){var x=this.__mN.getItems();
...
(function(){var h="Please use an array as parameter.",g="qx.ui.form.MModelSelection",f="change",d="qx.debug",c="__mu",b="changeSelection",a="qx.event.type.Data";
qx.Mixin.define(g,{construct:function(){this.__mu=new qx.data.Array();
this.__mu.addListener(f,this.__mx,this);
this.addListener(b,this.__mw,this);
},events:{changeModelSelection:a},members:{__mu:null,__mv:false,__mw:function(){if(this.__mv){return;
...
if(!qx.lang.Array.equals(s,r)){this.__mw();
}},getModelSelection:function(){return this.__mu;
},setModelSelection:function(v){if(!v){this.__mu.removeAll();
return;
}
if(qx.core.Environment.get(d)){this.assertArray(v,h);
}v.unshift(this.__mu.getLength());
v.unshift(0);
var w=this.__mu.splice.apply(this.__mu,v);
w.dispose();
...
if(s==undefined){this.__ds=[];
}else if(arguments.length>1){this.__ds=[];

for(var i=0;i<arguments.length;i++){this.__ds.push(arguments[i]);
}}else if(typeof s==e){this.__ds=new Array(s);
}else if(s instanceof Array){this.__ds=qx.lang.Array.clone(s);
}else{this.__ds=[];
this.dispose();
...
}},properties:{autoDisposeItems:{check:c,init:false}},events:{"change":h,"changeLength":h},members:{__ds:null,concat:function(t){if(t){var u=this.__ds.concat(t);
}else{var u=this.__ds.concat();
}return new qx.data.Array(u);
},join:function(v){return this.__ds.join(v);
},pop:function(){var w=this.__ds.pop();
this.__dt();
...
return w;
},push:function(x){for(var i=0;i<arguments.length;i++){this.__ds.push(arguments[i]);
this.__dt();
...
}var y=this.__ds.concat();
this.__ds.reverse();
this.fireDataEvent(r,{start:0,end:this.length-1,type:m,items:null},null);
this.fireDataEvent(q,{value:this.__ds,name:n+(this.__ds.length-1),old:y});
},shift:function(){if(this.length==0){return;
}var z=this.__ds.shift();
this.__dt();
...
return z;
},slice:function(A,B){return new qx.data.Array(this.__ds.slice(A,B));
},splice:function(C,D,E){var M=this.__ds.length;
var I=this.__ds.splice.apply(this.__ds,arguments);
if(this.__ds.length!=M){this.__dt();
}var K=D>0;
var G=arguments.length>2;
var H=null;

if(K||G){if(this.__ds.length>M){var L=p;
}else if(this.__ds.length<M){var L=o;
H=I;
}else{var L=m;
...
}var O=this.__ds.concat();
this.__ds.sort.apply(this.__ds,arguments);
this.fireDataEvent(r,{start:0,end:this.length-1,type:m,items:null},null);
this.fireDataEvent(q,{value:this.__ds,name:n+(this.length-1),old:O});
},unshift:function(P){for(var i=arguments.length-1;i>=0;i--){this.__ds.unshift(arguments[i]);
this.__dt();
this._registerEventChaining(arguments[i],null,0);
this.fireDataEvent(q,{value:[this.__ds[0]],name:j,old:[this.__ds[1]]});
this.fireDataEvent(r,{start:0,end:this.length-1,type:p,items:[arguments[i]]},null);
}return this.length;
},toArray:function(){return this.__ds;
},getItem:function(Q){return this.__ds[Q];
},setItem:function(R,S){var T=this.__ds[R];
if(T===S){return;
}this.__ds[R]=S;
...
},indexOf:function(U){return this.__ds.indexOf(U);
},toString:function(){if(this.__ds!=null){return this.__ds.toString();
}return g;
},contains:function(V){return this.__ds.indexOf(V)!==-1;
...
}Array.prototype.push.apply(this.__ds,bk);
for(var i=0;i<bk.length;i++){this._registerEventChaining(bk[i],null,this.__ds.length+i);
}var bl=this.length;
this.__dt();
...
},forEach:function(bs,bt){for(var i=0;i<this.__ds.length;i++){bs.call(bt,this.__ds[i],i,this);
}},__dt:function(){var bu=this.length;
this.length=this.__ds.length;
this.fireDataEvent(d,this.length,bu);
}},destruct:function(){for(var i=0;i<this.__ds.length;i++){var bv=this.__ds[i];
...
(function(){var v="keypress",u="qx.debug",t="interval",s="keydown",r="mousedown",q="keyup",p="__nA",o="blur",n="Enter",m="Up",d="__or",l="Escape",h="event.touch",c="qx.ui.menu.Manager",b="Left",g="Down",f="Right",j="__oq",a="singleton",k="Space";
...
},members:{__os:null,__ot:null,__oq:null,__or:null,__nA:null,_getChild:function(y,z,A,B){var C=y.getChildren();
var length=C.length;
var D;
...
}},hideAll:function(){var K=this.__nA;

if(K){for(var i=K.length-1;i>=0;i--){K[i].exclude();
}}},getActiveMenu:function(){var L=this.__nA;
return L.length>0?L[L.length-1]:null;
},scheduleOpen:function(M){this.cancelClose(M);
if(M.isVisible()){if(this.__os){this.cancelOpen(this.__os);
}}else if(this.__os!=M){this.__os=M;
this.__oq.restartWith(M.getOpenInterval());
}},scheduleClose:function(N){this.cancelOpen(N);
if(!N.isVisible()){if(this.__ot){this.cancelClose(this.__ot);
}}else if(this.__ot!=N){this.__ot=N;
this.__or.restartWith(N.getCloseInterval());
}},cancelOpen:function(O){if(this.__os==O){this.__oq.stop();
this.__os=null;
}},cancelClose:function(P){if(this.__ot==P){this.__or.stop();
this.__ot=null;
...
}if(this.__nA.length>0&&!this._isInMenu(Q)){this.hideAll();
}},__ou:{"Enter":1,"Space":1},__ov:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var R=this.getActiveMenu();

if(!R){return;
}var S=e.getKeyIdentifier();

if(this.__ov[S]||(this.__ou[S]&&R.getSelectedButton())){e.stopPropagation();
...
if(W){switch(U){case m:this._onKeyPressUp(T);
break;
case g:this._onKeyPressDown(T);
break;
case b:this._onKeyPressLeft(T);
break;
case f:this._onKeyPressRight(T);
break;
case l:this.hideAll();
break;
}e.stopPropagation();
...
}},__rh:function(z){while(!(z instanceof qx.ui.menu.Menu)){z=z.getLayoutParent();
}return z;
