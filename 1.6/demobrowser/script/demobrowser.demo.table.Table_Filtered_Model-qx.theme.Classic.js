...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Filtered_Model-qx.theme.Classic.76e494ff5581.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},members:{__Co:null,__Cn:null,_js_in_array:function(q,r){var s=r.toString();
...
if(!this.__Cn){this.__Co=Y.slice(0);
this.__Cn=true;
}
if(W==null||W<1){W=1;
}
...
}},resetHiddenRows:function(){if(!this.__Co){return ;
}this.Filters=[];
this.setData(qx.lang.Array.clone(this.__Co));
},setData:function(bb,bc){this.__Co=qx.lang.Array.clone(bb);
this.Filters=[];
qx.ui.table.model.Simple.prototype.setData.call(this,bb,bc);
}},destruct:function(){this.__Co=this.numericAllowed=this.betweenAllowed=this.Filters=null;
}});
})();
