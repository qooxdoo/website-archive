...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ModelDebugging","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ModelDebugging-qx.theme.Simple.4730733cb5b6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
qx.Bootstrap.define(b,{construct:function(){this.__no();
...
},members:{readyState:null,status:null,statusText:null,timeout:null,__nk:null,open:function(m,n){if(this.__mL){return;
}this.__no();
this.__nl=null;
this.__nm=n;
...
},setRequestHeader:function(o,p){if(this.__mL){return;
}var q={};

if(this.readyState!==1){throw new Error("Invalid state");
}q[o]=p;
this.__nm=qx.util.Uri.appendParamsToUrl(this.__nm,q);
},send:function(){if(this.__mL){return;
}var t=this.__nt(),r=this.__nj,s=this;
...
window.setTimeout(function(){s.__np(2);
s.__np(3);
});
...
this.__nu();
this.onabort();
},onreadystatechange:function(){},onload:function(){},onloadend:function(){},onerror:function(){},onabort:function(){},ontimeout:function(){},getResponseHeader:function(u){if(this.__mL){return;
}
...
this.__nk=v;
},dispose:function(){var w=this.__nn;

if(!this.__mL){if(w){w.onload=w.onreadystatechange=null;
this.__nu();
}
...
}},_onNativeLoad:function(){var z=this.__nn,x=this.__nk,y=this;
if(this.__nl){return;
...
if(this.__ht){window.clearTimeout(this.__ht);
}window.setTimeout(function(){y.__nq();
y.__np(4);
y.onload();
y.onloadend();
});
...
this.onerror();
this.onloadend();
},__nn:null,__nj:null,__nm:i,__ng:null,__nh:null,__ni:null,__ht:null,__nl:null,__mL:null,__no:function(){this.readyState=0;
this.status=0;
this.statusText=i;
},__np:function(A){this.readyState=A;
this.onreadystatechange();
...
},__ns:function(){var C=qx.core.Environment.get(k)===j&&qx.core.Environment.get(h)<9;
var B=qx.core.Environment.get(k)===d;
return !(C||B);
},__nt:function(){var D=this.__nn=document.createElement(e);
D.src=this.__nm;
D.onerror=this.__nh;
D.onload=this.__ng;
if(qx.core.Environment.get(k)===j&&qx.core.Environment.get(h)<9){D.onreadystatechange=this.__ng;
}return D;
},__nu:function(){var E=this.__nn;

if(E&&E.parentNode){this.__nj.removeChild(E);
...
this.__ol();
},members:{responseJson:null,__cq:null,__of:null,__og:null,__oh:null,__oi:null,__mL:null,open:function(k,l){if(this.__mL){return;
}var m={},o,n,p=this;
this.responseJson=null;
this.__oh=false;
o=this.__of||h;
n=this.__og||a+this.__cq+b;
if(!this.__og){this.constructor[this.__cq]=this;
}else{if(!window[this.__og]){this.__oi=true;
window[this.__og]=function(q){p.callback(q);
};
}else{if(qx.core.Environment.get(j)){qx.log.Logger.debug(qx.bom.request.Jsonp,"Callback "+this.__og+" already exists");
}}}
...
this.__ok(g,[k,l]);
},callback:function(r){if(this.__mL){return;
}this.__oh=true;
...
this.__oj();
},setCallbackParam:function(s){this.__of=s;
...
this.__oi=false;
}},__ok:function(t,u){qx.bom.request.Script.prototype[t].apply(this,u||[]);
},__ol:function(){this.__cq=(new Date().valueOf())+(e+Math.random()).substring(2,5);
}}});
})();
...
this.__Nn=qx.core.ObjectRegistry.getNextHash();
},"default":qx.lang.Function.empty}),stopDisposeProfiling:qx.core.Environment.select(f,{"true":function(br){if(!this.__Nn){qx.log.Logger.error("Call "+this.classname+".startDisposeProfiling first.");
return [];
...
for(var bs=this.__Nn;bs<bu;bs++){var bv=qx.core.ObjectRegistry.fromHashCode(bs+bw);
