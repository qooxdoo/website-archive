...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Canvas_MinMaxSizes","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Canvas_MinMaxSizes-qx.theme.Classic.e6ea5b886624.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="20%",o="9%",n="3%",m="6%",l="12%",k="black",j="teal",i="red",h="maxHeight=300",g="minWidth=400",c="green",f="yellow",e="orange",b="solid",a="blue",d="demobrowser.demo.layout.Canvas_MinMaxSizes";
...
var x=new qx.ui.decoration.Single(3,b,k);
var w=new qx.ui.core.Widget().set({backgroundColor:i,decorator:x});
var v=new qx.ui.core.Widget().set({backgroundColor:a,decorator:x});
var u=new qx.ui.basic.Label(h).set({backgroundColor:c,decorator:x,padding:5,maxHeight:300,allowStretchX:true,allowStretchY:true});
var t=new qx.ui.core.Widget().set({backgroundColor:f,decorator:x});
var s=new qx.ui.core.Widget().set({backgroundColor:e,decorator:x});
var r=new qx.ui.basic.Label(g).set({backgroundColor:j,decorator:x,padding:5,minWidth:400,allowStretchX:true,allowStretchY:true});
var q=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
q.add(w,{left:n,top:n,right:n,bottom:n,width:p,height:p});
q.add(v,{left:m,top:m,right:m,width:p,height:p});
q.add(u,{left:o,top:o,bottom:o,width:p,height:p});
q.add(t,{left:l,top:l,width:p,height:p});
q.add(s,{top:o,right:o,width:p,height:p});
q.add(r,{right:o,bottom:o,width:p,height:p});
this.getRoot().add(q,{edge:0});
}}});
})();
