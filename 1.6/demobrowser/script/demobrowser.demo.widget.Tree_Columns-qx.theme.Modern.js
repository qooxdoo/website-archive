...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Tree_Columns","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tree_Columns-qx.theme.Modern.496f56f3e0e4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
var bj=new qx.ui.container.Composite(new qx.ui.layout.Basic());
bj.setAllowGrowX(false);
bj.setAllowStretchX(false);
Y.add(bj);
this.getRoot().add(Y,{edge:0});
var bE=new qx.ui.tree.Tree().set({width:600,height:500});
bj.add(bE,{left:20,top:48});
var bF=this.configureTreeItem(new qx.ui.tree.TreeFolder(),w);
bF.setOpen(true);
bE.setRoot(bF);
var bx=this.configureTreeItem(new qx.ui.tree.TreeFolder(),b);
bF.add(bx);
var ba=this.configureTreeItem(new qx.ui.tree.TreeFolder(),J);
var W=this.configureTreeItem(new qx.ui.tree.TreeFolder(),o);
var X=this.configureTreeItem(new qx.ui.tree.TreeFolder(),N);
var V=this.configureTreeItem(new qx.ui.tree.TreeFolder(),j);
bx.add(ba,W,X,V);
var bD=this.configureTreeItem(new qx.ui.tree.TreeFile(),h,k);
var bC=this.configureTreeItem(new qx.ui.tree.TreeFile(),g,k);
W.add(bD,bC);
var by=this.configureTreeItem(new qx.ui.tree.TreeFolder(),c);
var bb=this.configureTreeItem(new qx.ui.tree.TreeFolder(),P);
var be=this.configureTreeItem(new qx.ui.tree.TreeFolder(),L);
var bd=this.configureTreeItem(new qx.ui.tree.TreeFolder(),j,m);
var bg=this.configureTreeItem(new qx.ui.tree.TreeFolder(),D);
var bf=this.configureTreeItem(new qx.ui.tree.TreeFolder(),A);
var bt=this.configureTreeItem(new qx.ui.tree.TreeFolder(),t);
var bs=this.configureTreeItem(new qx.ui.tree.TreeFolder(),G);
var br=this.configureTreeItem(new qx.ui.tree.TreeFolder(),e);
var bB=this.configureTreeItem(new qx.ui.tree.TreeFolder(),a);
var bA=this.configureTreeItem(new qx.ui.tree.TreeFolder(),n);
br.add(bB,bA);
bf.add(bt,bs,br);
var bi=this.configureTreeItem(new qx.ui.tree.TreeFolder(),x);
var bo=this.configureTreeItem(new qx.ui.tree.TreeFolder(),v);
var bp=this.configureTreeItem(new qx.ui.tree.TreeFolder(),q);
var bq=this.configureTreeItem(new qx.ui.tree.TreeFolder(),M);
var bk=this.configureTreeItem(new qx.ui.tree.TreeFolder(),C);
var bl=this.configureTreeItem(new qx.ui.tree.TreeFolder(),R);
var bm=this.configureTreeItem(new qx.ui.tree.TreeFolder(),z);
var bn=this.configureTreeItem(new qx.ui.tree.TreeFolder(),d);
var bu=this.configureTreeItem(new qx.ui.tree.TreeFolder(),O);
bi.add(bo,bp,bq,bk,bl,bm,bn,bu);
var bh=this.configureTreeItem(new qx.ui.tree.TreeFolder(),S);
var bv=this.configureTreeItem(new qx.ui.tree.TreeFolder(),s);
var bz=this.configureTreeItem(new qx.ui.tree.TreeFolder(),f);
var bw=this.configureTreeItem(new qx.ui.tree.TreeFolder(),p);
var bc=this.configureTreeItem(new qx.ui.tree.TreeFolder(),l);
bh.add(bv,bz,bw,bc);
var U=this.configureTreeItem(new qx.ui.tree.TreeFolder(),B);

for(var i=0;i<50;i++){U.add(this.configureTreeItem(new qx.ui.tree.TreeFolder(),y+i));
}var T=this.configureTreeItem(new qx.ui.tree.TreeFolder(),K);
by.add(bb,be,bd,bg,bf,bi,bh,U,T);
bF.add(by);
},configureTreeItem:function(bG,bH,bI){if(Math.floor(Math.random()*4)==0){var bL=new qx.ui.basic.Image(r);
bG.addWidget(bL);
}else{bG.addWidget(new qx.ui.core.Spacer(16,16));
}bG.addSpacer();

if(bG instanceof qx.ui.tree.TreeFolder){bG.addOpenButton();
}bG.addIcon();
bG.setIcon(arguments.length>=3?bI:I);
var bK=new qx.ui.form.CheckBox();
bK.setFocusable(false);
bG.addWidget(bK);
bG.addLabel(bH);
bG.addWidget(new qx.ui.core.Spacer(),{flex:1});
var bJ=new qx.ui.basic.Label(Math.round(Math.random()*100)+H);
bJ.setWidth(50);
bG.addWidget(bJ);
bJ=new qx.ui.basic.Label(E+Math.round(Math.random()*30+1)+u);
bJ.setWidth(150);
bG.addWidget(bJ);
bJ=new qx.ui.basic.Label(Q);
bJ.setWidth(80);
bG.addWidget(bJ);
return bG;
}}});
