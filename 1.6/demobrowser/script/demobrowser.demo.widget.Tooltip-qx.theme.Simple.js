...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Tooltip","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip-qx.theme.Simple.aba4ebc4285d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="icon/16/actions/help-about.png",j="Tooltip text",i="icon/32/actions/help-about.png",h="Button #2 (Shared ToolTip)",g="Short timeout ToolTip",f="demobrowser.demo.widget.Tooltip",d="Hello World #3",c="Button with ToolTipText and ToolTipIcon",b="ToolTip with icon and label",a="Shared tool tip of button #",y="ToolTip with icon and rich text",x="Such a great tooltip with a (show) timeout of 50ms.",w="Icon only ToolTip",v="Button #1 (Shared ToolTip)",u="container",t="This also may contain <b style='color:red'>rich HTML</b> markup ",s="appear",r="2",q="Shared ToolTip",p="1",n="Button with ToolTipText",o="A long label text with auto-wrapping. ",l="Button with ToolTipIcon",m="and with a (show) timeout of 50ms.";
...
this.getRoot().add(A,{edge:0});
var z=new qx.ui.layout.Grid(10,10);
this.container=new qx.ui.container.Composite(z).set({padding:20});
...
},__Pf:4,__Pg:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Pg/this.__Pf),column:this.__Pg%this.__Pf});
this.__Pg+=1;
},createSharedToolTip:function(){var E=new qx.ui.tooltip.ToolTip(q);
E.addListener(s,function(e){var F=a;

if(this.getOpener()==D){F+=p;
}else{F+=r;
}E.setLabel(F);
});
var D=new qx.ui.form.Button(v);
D.setToolTip(E);
this.add(D);
var C=new qx.ui.form.Button(h);
C.setToolTip(E);
this.add(C);
},createIconToolTip:function(){var G=new qx.ui.form.Button(w).set({toolTip:new qx.ui.tooltip.ToolTip(null,k)});
this.add(G);
},createToolTip:function(){var H=new qx.ui.form.Button(b).set({toolTip:new qx.ui.tooltip.ToolTip(d,k)});
this.add(H);
},createShortTimeoutToolTip:function(){var J=new qx.ui.tooltip.ToolTip(x,i);
J.setShowTimeout(50);
var I=new qx.ui.form.Button(g);
this.add(I);
I.setToolTip(J);
},createRichToolTip:function(){var L=new qx.ui.tooltip.ToolTip(o+t+m,i);
L.setWidth(200);
L.setRich(true);
L.setShowTimeout(50);
var K=new qx.ui.form.Button(y);
this.add(K);
K.setToolTip(L);
},createToolTipText:function(){var M=new qx.ui.form.Button(n).set({toolTipText:j});
this.add(M);
},createToolTipIcon:function(){var N=new qx.ui.form.Button(l).set({toolTipIcon:k});
this.add(N);
},createToolTipTextIcon:function(){var O=new qx.ui.form.Button(c).set({toolTipText:j,toolTipIcon:k});
this.add(O);
