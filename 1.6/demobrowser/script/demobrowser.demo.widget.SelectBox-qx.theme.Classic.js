...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SelectBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SelectBox-qx.theme.Classic.73837ee11b13.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="icon/16/devices/",k="phone.png",j="audio-card.png",h="battery.png",g="printer.png",f="Simple",d="display.png",c="audio-input-microphone.png",b="Empty Item",a="computer.png",G="Random Value ",F="input-keyboard.png",E="drive-optical.png",D="",C="media-optical.png",B="changeSelection",A="pda.png",z="network-wired.png",y=".",x="camera-photo.png",s="network-wireless.png",t="media-flash.png",q="Option ",r="input-mouse.png",o="demobrowser.demo.widget.SelectBox",p="With icons",m="drive-harddisk.png",n="camera-web.png",u="multimedia-player.png",v="Item ",w="Long text";
...
var H=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
H.setPadding(20);
H.add(this.createBox1());
H.add(this.createBox2());
H.add(this.createBox3());
H.add(this.createBox4());
I.add(H,{left:20,top:20});
this.getRoot().add(I,{edge:0});
},createBox1:function(){var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
K.add(new qx.ui.basic.Label(f));
var J=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var L=new qx.ui.form.ListItem(v+(i+1));
J.add(L);
if(i==5){J.setSelection([L]);
}}J.addListener(B,function(e){this.debug("changeSelection: "+e.getData()[0]);
});
K.add(J);
return K;
},createBox2:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
N.add(new qx.ui.basic.Label(w));
var M=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var O=new qx.ui.form.ListItem(G+Math.round(Math.random()*100000000));
M.add(O);
}N.add(M);
return N;
},createBox3:function(){var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
Q.add(new qx.ui.basic.Label(p));
var S=[j,c,h,x,n,a,d,m,E,F,r,t,C,u,z,s,A,k,g];
var T=l;
var P=new qx.ui.form.SelectBox();

for(var i=0;i<S.length;i++){var R=new qx.ui.form.ListItem(S[i].substr(0,S[i].indexOf(y)),T+S[i]);
P.add(R);
}Q.add(P);
return Q;
},createBox4:function(){var V=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
V.add(new qx.ui.basic.Label(b));
var U=new qx.ui.form.SelectBox();
U.add(new qx.ui.form.ListItem(D));

for(var i=0;i<10;i++){U.add(new qx.ui.form.ListItem(q+(i+1)));
}V.add(U);
return V;
}}});
})();
