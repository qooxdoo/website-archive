...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Flow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow-qx.theme.Simple.9edfc3f5a00d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}},__Ir:function(B,C,D){var F=qx.ui.layout.Util;
var I=0;
...
}},_computeSizeHint:function(){return this.__Is(Infinity);
},hasHeightForWidth:function(){return true;
},getHeightForWidth:function(K){return this.__Is(K).height;
},__Is:function(L){var M=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());
var Q=0;
var N=0;
var O=0;
...
qx.Class.define(a,{extend:Object,construct:function(b,c){this.__kv=b;
this.__Gq=c;
this.__Gr=b.length>0;
this.__Gs=0;
},members:{__kv:null,__Gq:null,__Gr:null,__Gs:null,computeNextLine:function(d){var d=d||Infinity;

if(!this.__Gr){throw new Error("No more lines to compute");
}var o=this.__kv;
var m=0;
var f=0;
var n=[];
...
for(var i=this.__Gs;i<o.length;i++){var l=o[i];
var p=l.getSizeHint();
var h=this.__Gt(i);
var g=p.width+h;
var e=i==this.__Gs;

if(!e&&f+g>d){this.__Gs=i;
break;
...
if(l.getLayoutProperties().lineBreak){this.__Gs=i+1;
break;
}}
if(i>=o.length){this.__Gr=false;
}return {height:m,width:f,children:n,gapsBefore:j};
},__Gt:function(q){var r=q==this.__Gs;

if(r){return this.__kv[q].getMarginLeft();
}else{return Math.max(this.__kv[q-1].getMarginRight(),this.__kv[q].getMarginLeft(),this.__Gq);
}},hasMoreLines:function(){return this.__Gr;
}}});
})();
