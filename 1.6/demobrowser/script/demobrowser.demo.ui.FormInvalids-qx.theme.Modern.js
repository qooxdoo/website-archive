...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormInvalids","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormInvalids-qx.theme.Modern.9ebcb6aad502.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="changeValue",r="I am a box",q=" invalidate all shown widgets. Try the invalid focus and tooltip.",p="RadioGroup 2",o="root",n=")",m="disable tooltips",l="RadioGroup 1",k="Invalid (",j="File 3",c="demobrowser.demo.ui.FormInvalids",h="disabled",g="<b>Validation</b><br/>Press the button to",b="File 1",a="Item ",f="File 2",d="invalid";
...
var B=[];
B.push(new qx.ui.form.Spinner());
this.getRoot().add(B[0],{left:20,top:70});
B.push(new qx.ui.form.Slider());
B[1].setWidth(200);
this.getRoot().add(B[1],{left:20,top:100});
B.push(new qx.ui.form.TextField());
this.getRoot().add(B[2],{left:20,top:130});
B.push(new qx.ui.form.TextArea());
this.getRoot().add(B[3],{left:20,top:160});
B.push(new qx.ui.form.PasswordField());
this.getRoot().add(B[4],{left:20,top:240});
B.push(new qx.ui.form.ComboBox());
this.getRoot().add(B[5],{left:20,top:270});
B.push(new qx.ui.form.SelectBox());
this.getRoot().add(B[6],{left:20,top:300});
B.push(new qx.ui.form.CheckBox());
this.getRoot().add(B[7],{left:20,top:330});
B.push(new qx.ui.form.CheckBox().set({triState:true,value:null}));
this.getRoot().add(B[8],{left:20,top:350});
B.push(new qx.ui.form.RadioButton());
this.getRoot().add(B[9],{left:20,top:370});
B.push(new qx.ui.groupbox.GroupBox(r));
this.getRoot().add(B[10],{left:240,top:70});
B.push(new qx.ui.groupbox.RadioGroupBox(r));
this.getRoot().add(B[11],{left:240,top:170});
B.push(new qx.ui.groupbox.CheckGroupBox(r));
this.getRoot().add(B[12],{left:240,top:270});
B.push(new qx.ui.form.List());
this.getRoot().add(B[13],{left:390,top:70});

for(var i=0;i<10;i++){B[13].add(new qx.ui.form.ListItem(a+(i+1)));
}B.push(new qx.ui.form.DateField());
this.getRoot().add(B[14],{left:390,top:280});
B.push(new qx.ui.control.DateChooser());
this.getRoot().add(B[15],{left:530,top:70});
var y=new qx.ui.form.RadioGroup();
var t=new qx.ui.form.RadioButton(l);
y.add(t);
this.getRoot().add(t,{left:530,top:250});
var u=new qx.ui.form.RadioButton(p);
y.add(u);
this.getRoot().add(u,{left:530,top:270});
B.push(y);
var x=new qx.ui.tree.Tree();
B.push(x);
this.getRoot().add(x,{left:530,top:300});
var C=new qx.ui.tree.TreeFolder(o);
C.setOpen(true);
x.setRoot(C);
C.add(new qx.ui.tree.TreeFile(b));
C.add(new qx.ui.tree.TreeFile(f));
C.add(new qx.ui.tree.TreeFile(j));
var w=new qx.ui.form.ToggleButton(d);
this.getRoot().add(w,{left:260,top:20});
w.addListener(s,function(e){for(var i=0;i<B.length;i++){B[i].setInvalidMessage(k+i+n);
B[i].setValid(!e.getData());
}},this);
var z=new qx.ui.form.ToggleButton(h);
this.getRoot().add(z,{left:330,top:20});
z.addListener(s,function(e){for(var i=0;i<B.length;i++){B[i].setEnabled(!e.getData());
}},this);
var v=new qx.ui.form.ToggleButton(m);
this.getRoot().add(v,{left:410,top:20});
v.addListener(s,function(e){qx.ui.tooltip.Manager.getInstance().setShowInvalidToolTips(!e.getData());
},this);
var A=new qx.ui.basic.Label();
A.setRich(true);
A.setWidth(250);
A.setValue(g+q);
this.getRoot().add(A,{left:20,top:10});
}}});
})();
