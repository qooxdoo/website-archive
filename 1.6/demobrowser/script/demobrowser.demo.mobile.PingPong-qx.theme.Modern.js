...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Modern.ddc8e5737c8b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="touchmove",u="div",t="100%",s="demobrowser.demo.mobile.PingPong",r="<b>This demo is supposed to be run in a WebKit-based browser.</b>",q="engine.name",p="black",o="20px",n="none",m="30px",f="qx.debug",l="0px",i="webkit",c="12px",b="innerHTML",h="green",g='Lucida Grande',j="left",a="right",k="px",d="absolute";
qx.Class.define(s,{extend:qx.application.Native,members:{__ND:null,__NE:null,__NF:null,__NG:null,__NH:5,__NI:1,__NJ:1,__NK:null,__NL:null,__NM:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(f)){qx.log.appender.Native;
qx.log.appender.Console;
}var A={"width":t,"height":t,"backgroundColor":p,"margin":l,"userSelect":n};
var D=new qx.html.Element(u,A);
D.useElement(document.body);
D.setRoot(true);

if(qx.core.Environment.get(q)!=i){var C={"color":h,"font-family":g,"font-size":c,"position":d,"left":m,"top":o};
var B=new qx.html.Element(u,C);
D.add(B);
B.setAttribute(b,r);
return;
}var w=this.__NQ(j);
...
var z=this.__NQ(a);
D.add(z);
this.__NE=this.__NR("left");
w.add(this.__NE);
w.addListener(v,qx.lang.Function.bind(this.__rQ,this,this.__NE),this);
this.__ND=this.__NR("right");
z.add(this.__ND);
z.addListener(v,qx.lang.Function.bind(this.__rQ,this,this.__ND),this);
this.__NF=this.__NS();
D.add(this.__NF);
this.__NL=this.__NT();
w.add(this.__NL);
...
this.__NK=[0,0];
this.__NN();
},__NN:function(){this.__NF.setStyles({"left":"200px","top":"200px"});
this.__NG=new qx.event.Timer(40);
this.__NG.addListener("interval",function(){var x=(parseInt(this.__NF.getStyle("left"))+this.__NH*this.__NI);
var y=(parseInt(this.__NF.getStyle("top"))+this.__NH*this.__NJ);
this.__NF.setStyle("left",x+"px");
this.__NF.setStyle("top",y+"px");
this.__NP();
},this);
this.__NG.start();
},__NO:function(E){this.__NG.stop();
this.__NG.dispose();
this.__NH=5;
this.__NK[E]=this.__NK[E]+1;
this.__NL.setAttribute("innerHTML",this.__NK[0]);
this.__NM.setAttribute("innerHTML",this.__NK[1]);
this.__NN();
},__NP:function(){var G=this.getBoundsFor(this.__NF);
if(G.top<=0){this.__NJ=1;
}if(G.bottom>=window.innerHeight-5){this.__NJ=-1;
}if(G.left<=0||G.right>=window.innerWidth){this.__NO(G.left<=0?1:0);
}var H=this.getBoundsFor(this.__NE);

if(G.left<=H.right&&G.bottom>=H.top&&G.top<=H.bottom){this.__NI=1;
this.__NH=Math.min(this.__NH+1,20);
}var F=this.getBoundsFor(this.__ND);

if(G.right>=F.left&&G.bottom>=F.top&&G.top<=F.bottom){this.__NI=-1;
this.__NH=Math.min(this.__NH+1,20);
}},__rQ:function(I,e){I.setStyles({"top":(e.getDocumentTop()-50)+k});
},getBoundsFor:function(J){return qx.bom.element.Location.get(J.getDomElement());
},__NQ:function(K){var L={"width":"50%","height":"100%","position":"absolute","backgroundColor":"black"};

if(K=="left"){L["border-right"]="1px solid white";
}else{L["left"]="50%";
L["border-left"]="1px solid white";
}return new qx.html.Element("div",L);
},__NR:function(M){var N={"width":"30px","height":"100px","top":"100px","position":"absolute","backgroundColor":"white"};
N[M]="20px";
return new qx.html.Element("div",N);
},__NS:function(){var O={"width":"20px","height":"20px","position":"absolute","backgroundColor":"white","userSelect":"none"};
return new qx.html.Element("div",O);
},__NT:function(){var P={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};
var Q=new qx.html.Element("div",P);
Q.setAttribute("innerHTML","0");
return Q;
}}});
})();
