...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_Margin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Margin-qx.theme.Modern.9960442edb31.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="main",d="green",c="yellow",b="center",a="demobrowser.demo.layout.VBox_Margin";
...
var f=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(f);
f.add(this.getBox1());
f.add(this.getBox2());
f.add(this.getBox3());
f.add(this.getBox4());
f.add(this.getBox5());
},getBox1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
var j=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var i=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var g=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
h.add(j);
h.add(i);
h.add(g);
j.setAllowGrowX(false);
i.setAllowGrowX(false);
g.setAllowGrowX(false);
j.setMarginLeft(20);
g.setMarginRight(30);
return h;
},getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
var n=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var m=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var k=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
l.add(n);
l.add(m);
l.add(k);
n.setMarginLeft(20);
k.setMarginRight(30);
return l;
},getBox3:function(){var o=new qx.ui.layout.VBox();
var q=new qx.ui.container.Composite(o).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
o.setSpacing(5);
o.setAlignX(b);
var s=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var r=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var p=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
q.add(s);
q.add(r);
q.add(p);
...
p.setMarginRight(30);
return q;
},getBox4:function(){var t=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(t).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
t.setSpacing(5);
t.setAlignX(b);
var x=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var w=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var u=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
v.add(x);
v.add(w);
v.add(u);
x.setMarginLeft(20);
...
u.setMarginRight(20);
return v;
},getBox5:function(){var y=new qx.ui.layout.VBox();
var A=new qx.ui.container.Composite(y).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
y.setSpacing(5);
y.setAlignX(b);
var C=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var B=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var z=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
A.add(C);
A.add(B);
A.add(z);
C.setMarginLeft(20);
