...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_AutoSize","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_AutoSize-qx.theme.Modern.bfd6671bf403.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="main",n="east",m="yellow",l="center",k="red",j="north",i="south",h="west",g="green",f="blue",c="fuchsia",e="orange",d="x",b="y",a="demobrowser.demo.layout.Dock_AutoSize";
...
scroll.add(q);
var p=new qx.ui.container.Composite(new qx.ui.layout.Dock(3,10)).set({decorator:o,backgroundColor:m,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:k});
var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:f});
var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});
var t=new qx.ui.core.Widget().set({decorator:o,backgroundColor:g});
var s=new qx.ui.core.Widget().set({decorator:o,backgroundColor:c});
p.add(w,{edge:j});
p.add(v,{edge:h});
p.add(u,{edge:i});
p.add(t,{edge:n});
p.add(s,{edge:l});
q.add(p);
var r=new qx.ui.layout.Dock(3,10);
r.setSort(b);
var p=(new qx.ui.container.Composite(r)).set({decorator:o,backgroundColor:m,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:k});
var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:f});
var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});
var t=new qx.ui.core.Widget().set({decorator:o,backgroundColor:g});
