...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.DateChooser","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.DateChooser-qx.theme.Modern.e77b545d84d3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="execute",q="- Use the cursors keys to move the selection.",p="- Double-click or enter/space-key will fire an execute event.",o="bold",n="- Page-keys / shift + page-keys switch months/years.",m="Description",l="select a date",k="Show January 1981",j="Set current date",i="Execute: ",c="Change: ",h="center",g="en",b="changeValue",a="demobrowser.demo.widget.DateChooser",f="Remove the selection",d="- Escape will remove the selection.";
...
var A=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var x=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var E=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var t=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
E.add(t);
E.add(C);
x.add(E);
x.add(y);
D.add(x);
A.add(D);
this.getRoot().add(A,{left:20,top:20});
var v=new qx.ui.control.DateChooser();
D.addBefore(v,x);
var B=new qx.ui.basic.Label(l);
A.add(B);
v.addListener(b,function(e){B.setValue(c+e.getData());
},this);
v.addListener(r,function(e){var F=v.getValue();
B.setValue(i+F);
},this);
var w=new qx.ui.form.Button(j);
w.setAlignX(h);
t.add(w);
w.addListener(r,function(e){v.setValue(new Date());
});
var z=new qx.ui.form.Button(k);
t.add(z);
z.addListener(r,function(e){v.showMonth(0,1981);
});
var u=new qx.ui.form.Button(f);
t.add(u);
u.addListener(r,function(e){v.setValue(null);
});
var s=new qx.ui.basic.Label(m);
s.setFont(o);
C.add(s);
C.add(new qx.ui.basic.Label(q));
C.add(new qx.ui.basic.Label(n));
C.add(new qx.ui.basic.Label(p));
C.add(new qx.ui.basic.Label(d));
}}});
})();
