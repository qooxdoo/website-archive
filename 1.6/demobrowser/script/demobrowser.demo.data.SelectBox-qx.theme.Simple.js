...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SelectBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SelectBox-qx.theme.Simple.257ff493b007.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="selection[0]",s="value",r="C",q="A",p="F",o="G",n="<b>Change Selection</b><br/>",m="J",l="D",k="E",d="H",j="I",g="B",c="<b>Synchronized Selection</b><br/>",b="Type in the textfield or set the selection with the button.",f="execute",e="demobrowser.demo.data.SelectBox",h="Bound to the same data and share the selection. The label is also bound to the selection.",a="The selection is: ",i="Set Selection to 'C'";
...
var C=new qx.data.Array([q,g,r,l,k,p,o,d,j,m]);
var D=new qx.ui.form.SelectBox();
this.getRoot().add(D,{left:10,top:80});
var A=new qx.data.controller.List(C,D);
var B=new qx.ui.form.SelectBox();
this.getRoot().add(B,{left:150,top:80});
var z=new qx.data.controller.List(C,B);
A.setSelection(z.getSelection());
var y=new qx.ui.basic.Label();
this.getRoot().add(new qx.ui.basic.Label(a),{left:10,top:110});
this.getRoot().add(y,{left:100,top:110});
A.bind(t,y,s);
var v=new qx.ui.form.TextField(q);
v.setLiveUpdate(true);
v.setWidth(150);
this.getRoot().add(v,{left:290,top:80});
v.bind(s,A,t);
A.bind(t,v,s);
var w=new qx.ui.form.Button(i);
w.setWidth(150);
this.getRoot().add(w,{left:290,top:110});
w.addListener(f,function(){A.getSelection().setItem(0,r);
},this);
...
x.setWidth(130);
x.setValue(n+b);
this.getRoot().add(x,{left:300,top:10});
}}});
})();
