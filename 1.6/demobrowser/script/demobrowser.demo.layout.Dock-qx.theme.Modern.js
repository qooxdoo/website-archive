...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock-qx.theme.Modern.044660716bca.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="main",n="east",m="yellow",l="west",k="red",j="center",i="north",h="south",g="green",f="fuchsia",c="orange",e="blue",d="demobrowser.demo.layout.Dock",b="x",a="y";
...
scroll.add(q);
var p=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:o,backgroundColor:m,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:k});
var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});
