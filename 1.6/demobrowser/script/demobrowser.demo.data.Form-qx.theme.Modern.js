...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Form","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Form-qx.theme.Modern.19362e393fe9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var u="value",t="demobrowser.demo.data.Form",s="M",r="x",q="Registration",p="male",o="Send",n="F",m="modelSelection[0]",l="Ok:",e="gender",k="execute",h="-please select-",c="female",b="ok",g="left",f="Name:",i="middle",a="X",j="Gender:",d="name";
...
var I=new qx.ui.groupbox.GroupBox(q);
I.setWidth(200);
this.getRoot().add(I,{left:10,top:10});
var F=new qx.ui.layout.Grid();
F.setSpacing(5);
F.setColumnAlign(0,g,i);
I.setLayout(F);
var v=new qx.ui.basic.Label(f);
I.add(v,{row:0,column:0});
var y=new qx.ui.form.TextField();
I.add(y,{row:0,column:1});
var L=new qx.ui.basic.Label(j);
I.add(L,{row:1,column:0});
var G=new qx.ui.form.SelectBox();
var H=new qx.ui.form.ListItem(h,null,a);
G.add(H);
var D=new qx.ui.form.ListItem(p,null,s);
G.add(D);
var B=new qx.ui.form.ListItem(c,null,n);
G.add(B);
I.add(G,{row:1,column:1});
var N=new qx.ui.basic.Label(l);
I.add(N,{row:2,column:0});
var K=new qx.ui.form.CheckBox();
I.add(K,{row:2,column:1});
var C=new qx.ui.form.Button(o);
I.add(C,{row:3,column:0});
var x={name:null,gender:null,ok:0,hidden:r};
var J=qx.data.marshal.Json.createModel(x);
var A=new qx.data.controller.Object(J);
A.addTarget(y,u,d,true);
A.addTarget(G,m,e,true);
var w={converter:function(O){return O===1;
}};
var z={converter:function(P){return P?1:0;
}};
A.addTarget(K,u,b,true,w,z);
y.setRequired(true);
K.setRequired(true);
var M=new qx.ui.form.validation.Manager();
y.setRequired(true);
M.add(y);
M.add(K);
M.setValidator(function(Q){var R=G.getSelection()[0]!==H;
G.setValid(R);
return R;
});
var E=function(S){if(S instanceof qx.ui.form.ListItem){return S.getLabel();
}};
C.addListener(k,function(){if(M.validate()){alert("You are sending: "+qx.util.Serializer.toUriParameter(J,E));
}},this);
}}});
})();
