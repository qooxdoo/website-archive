...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.CheckBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.CheckBox-qx.theme.Modern.48f2be0f887e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="",l=", ",k="demobrowser.demo.widget.CheckBox",j="Bathing togs",h="_checkBoxes",g="OK",f="Towel",d="Sun Oil",c="Beer",b="What do you need for the beach?",a="execute";
...
o.add(r);
var n=new qx.ui.form.CheckBox(d);
var u=new qx.ui.form.CheckBox(f);
var s=new qx.ui.form.CheckBox(c);
var t=new qx.ui.form.CheckBox(j);
this._checkBoxes=[n,u,s,t];
o.add(n);
o.add(u);
o.add(s);
o.add(t);
var q=new qx.ui.form.Button(g);
q.addListener(a,this._onExecute,this);
q.setAllowGrowX(false);
o.add(q);
},_onExecute:function(e){var w=this._checkBoxes;
var v=0;
var x=m;

for(var i=0;i<w.length;i++){if(w[i].getValue()){v++;
x+=(w[i].getLabel()+l);
}}
if(v>0){x=x.substring(0,x.length-2);
alert("You need these things for the beach: "+x);
}else{alert("Are you sure you need nothing for the beach?");
