...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SplitPane","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane-qx.theme.Modern.7fad83d35383.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="value",k="horizontal",j="first",h="Trash",g="both",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",K="Windows (C:)",J="Toggle Splitpane Orientation",I="__wP",H="Inbox",G="Desktop",F="_container1",E="execute",D="):",C="Presets",B="Network",s="changeSelection",t="Sent",q="Offset (",r="/",o="offset",p="Files",m="_container2",n="vertical",u="Workspace",v="Junk #",x="Data",w="Show both panes",z="Show second pane",y="demobrowser.demo.widget.SplitPane",A="Edit";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__wP:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},_toggle:function(){var bd=this.__wP.getOrientation();
this.__wP.setOrientation(bd==k?n:k);
...
this._container2.show();
}},__Pe:function(){var bo=new qx.ui.tree.Tree();
...
bt.add(bs);
return bo;
}},destruct:function(){this._disposeObjects(I,F,m);
}});
})();
