...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Separator","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Separator-qx.theme.Classic.37988b6082c6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="main",g="green",f="yellow",e="separator-horizontal",d="demobrowser.demo.layout.HBox_Separator",c="top",b="bottom",a="middle";
qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var i=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(i);
i.add(this.getBox1());
i.add(this.getBox2());
i.add(this.getBox3());
},getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return j;
},getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,minHeight:60,allowGrowX:false});
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:c}));
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:a}));
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:b}));
return k;
},getBox3:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
var o=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
var n=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
var l=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
m.add(o);
m.add(n);
m.add(l);
o.setMarginRight(10);
