...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Flash","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash-qx.theme.Classic.e653fee17c31.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="execute",j="Flash Player Version",i="__IY",h="right",g="Message from Flash:",f="__OT",d="__OV",c="Simple demo with FlashVars",b="bgcolor",a="demobrowser.demo.widget.Flash",y="demobrowser/demo/flash/FlashVersion.swf",x="Flash:",w="<b>qooxdoo:</b>",v="demobrowser.demo.widget.Flash.sendMessage",u="demobrowser.demo.widget.Flash.flashReady",t="demobrowser/demo/flash/fo_tester.swf",s="__OU",r="this is passed in via FlashVars",q="Two way communication (ActionScript <-> JavaScript)",p="__cy",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__cy:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
z.add(B);
this.__cy=this.createWindow();
C.add(this.__cy,{top:20,left:20});
...
var F=new qx.ui.embed.Flash(t).set({scale:l,variables:E});
F.getContentElement().setParam(b,m);
G.add(F,{flex:1});
var H=new qx.ui.form.Button(o);
H.addListener(k,function(){this.__cy.open();
},this);
G.add(H);
return G;
},__IY:null,__OT:null,__OU:null,__OV:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
...
J.add(new qx.ui.basic.Label(g));
this.__OT=new qx.ui.form.TextArea("No message.");
this.__OT.setEnabled(false);
J.add(this.__OT,{flex:1});
J.add(new qx.ui.basic.Label(n));
this.__OU=new qx.ui.form.TextArea("qooxdoo is the best!");
J.add(this.__OU,{flex:1});
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));
this.__OV=new qx.ui.form.Button("Send to Flash");
this.__OV.setEnabled(false);
this.__OV.addListener(k,function(e){this.__IY.getFlashElement().sendMessage(this.__OU.getValue());
},this);
L.add(this.__OV);
J.add(L);
...
this.__IY=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__IY.setVariables({init:u});
I.add(this.__IY,{flex:1});
return K;
},sendMessage:function(M){this.__OT.setValue(M);
},initFlash:function(){if(this.__IY.getFlashElement().setup){this.__IY.getFlashElement().setup(v);
this.__OV.setEnabled(true);
...
}}},statics:{__OW:null,setCallBackInstance:function(N){demobrowser.demo.widget.Flash.__OW=N;
},sendMessage:function(O){demobrowser.demo.widget.Flash.__OW.sendMessage(O);
},flashReady:function(){demobrowser.demo.widget.Flash.__OW.initFlash();
}},destruct:function(){this._disposeObjects(f,s,d,i,p);
}});
})();
...
},events:{"loading":i,"loaded":i,"timeout":i},properties:{source:{check:e,apply:Q},id:{check:e,apply:B},quality:{check:[ba,I,x,O,J,c],init:c,nullable:true,apply:C},scale:{check:[V,l,N,t],nullable:true,apply:G},wmode:{check:[o,g,F],init:g,nullable:true,apply:y},play:{check:j,nullable:true,apply:p},loop:{check:j,nullable:true,apply:Y},mayScript:{check:j,nullable:false,apply:A},menu:{check:j,nullable:true,apply:q},allowScriptAccess:{check:[h,M,E],init:h,nullable:true,apply:W},liveConnect:{check:j,init:true,nullable:true,apply:T},variables:{init:{},check:U,apply:bb},loadTimeout:{check:R,init:10000}},members:{__JX:null,getFlashElement:function(){var be=this.getContentElement();
...
if(bh!=d&&bh!=null&&bh!=b){if(!this.isLoaded()){if(!this.__JX){this.__JX=new Date().getTime();
}var bi=new Date().getTime()-this.__JX;
...
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bt,bu){this.__JY(a,bt);
},_applyScale:function(bv,bw){this.__JY(X,bv);
},_applyWmode:function(bx,by){this.__JY(S,bx);
},_applyPlay:function(bz,bA){this.__JY(L,bz);
},_applyLoop:function(bB,bC){this.__JY(m,bB);
},_applyMenu:function(bD,bE){this.__JY(k,bD);
},_applyAllowScriptAccess:function(bF,bG){this.__JY(n,bF);
},_applyLiveConnect:function(bH,bI){this.__JY(v,bH);
},__JY:function(bJ,bK){this.getContentElement().setParam(bJ,bK);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
this.__IW={};
this.__IX={};
},members:{__IV:null,__IX:null,__IW:null,__IY:null,_createDomElement:function(){return qx.bom.Element.create(d);
},createFlash:function(){this.__IY=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__IW,this.__IV);
},setSource:function(j){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(j,f);
}
if(this.__IY){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,j);
},setId:function(k){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(k,f);
}
if(this.__IY){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(b,k);
},getVariables:function(){return this.__IW;
},setVariables:function(l){if(qx.core.Environment.get(g)){qx.core.Assert.assertMap(l,f);
}
if(this.__IY){throw new Error("The variables cannot be modified after initial creation");
}this.__IW=l;
},getAttributes:function(){return this.__IX;
...
if(this.__IY){throw new Error("The attributes cannot be modified after initial creation");
}
if(n===null||n===undefined){delete this.__IX[m];
}else{this.__IX[m]=n;
}},getParams:function(){return this.__IV;
...
if(this.__IY){throw new Error("The params cannot be modified after initial creation");
}
if(p===null||p===undefined){delete this.__IV[o];
}else{this.__IV[o]=p;
}},getFlashElement:function(){return this.__IY;
}},destruct:function(){if(this.__IY){qx.bom.Flash.destroy(this.__IY);
}this.__IV=this.__IW=this.__IX=null;
}});
})();
...
qx.Class.define(b,{extend:qx.core.Object,type:a,statics:{__Bj:[],__Bk:{},__qL:0},members:{__Bl:false,start:function(d,e,f,g,h){if(!h){h=e||0;
}var j=(new Date()).getTime()+h;
this.self(arguments).__Bk[++this.self(arguments).__qL]={callback:d,userData:g||null,expireAt:j,recurTime:e,context:f||this};
this.__Bm(j,this.self(arguments).__qL);
return this.self(arguments).__qL;
},stop:function(k){var l=this.self(arguments).__Bj;
var length=l.length;

for(var i=0;i<length;i++){if(l[i]==k){l.splice(i,1);
break;
}}delete this.self(arguments).__Bk[k];
if(l.length==0&&this.__Bl){qx.event.Idle.getInstance().removeListener(c,this.__Bn,this);
this.__Bl=false;
}},__Bm:function(m,n){var p=this.self(arguments).__Bj;
var o=this.self(arguments).__Bk;
var length=p.length;

for(var i=0;i<length;i++){if(o[p[i]].expireAt>m){p.splice(i,0,n);
break;
}}if(p.length==length){p.push(n);
}if(!this.__Bl){qx.event.Idle.getInstance().addListener(c,this.__Bn,this);
this.__Bl=true;
}},__Bn:function(){var t=(new Date()).getTime();
var r=this.self(arguments).__Bj;
var s=this.self(arguments).__Bk;
...
this.__Bm(q.expireAt,v);
}else{delete s[v];
}}if(r.length==0&&this.__Bl){qx.event.Idle.getInstance().removeListener(c,this.__Bn,this);
this.__Bl=false;
}}}});
})();
