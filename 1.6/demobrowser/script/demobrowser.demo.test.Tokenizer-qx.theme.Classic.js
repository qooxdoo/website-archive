...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Tokenizer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Tokenizer-qx.theme.Classic.5886aee266c1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
n.innerHTML=qx.bom.String.escape(qx.lang.Json.stringify(o,true));
};
...
var bA={"void":1,"null":1,"true":1,"false":1,"NaN":1,"Infinity":1,"this":1};
var bm={"statics":1,"members":1,"construct":1,"destruct":1,"events":1,"properties":1,"extend":1,"implement":1};
var bw=function(bO){return new RegExp(q+bO+A);
};
var bG=K;
var bx=u;
var bq=n;
...
var bL=t;
var bv=B;
var by=[O+bv+U,S+bv+E,F+bv+z,H+bv+s,G+bv+p].join(bd);
var bH=bw(bG);
var br=bw(bx);
var bE=bw(bq);
var bn=bw(bz);
...
var bk=bw(bL);
var bp=bw(by);
var bD=new RegExp([bG,bx,bq,bz,bu,bC,bB,bB,bo,bJ,bL,by,C].join(bd),P);
var bI=[];
var a=bj.match(bD);
...
}else if(bM.match(bt)){bI.push({type:e,value:bM});
}else if(bN[bM]){bI.push({type:bh,value:bM});
}else if(bA[bM]){bI.push({type:ba,value:bM});
}else if(bm[bM]){bI.push({type:h,value:bM});
...
}else if(bM.match(bw(bk))){bI.push({type:g,value:bM});
