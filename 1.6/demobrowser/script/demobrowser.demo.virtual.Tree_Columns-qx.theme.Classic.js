...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns-qx.theme.Classic.ad905c663c40.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.addIcon();
this.setIcon(g);
var r=this.__OQ=new qx.ui.form.CheckBox();
this.bind(n,r,p);
r.bind(p,this,n);
...
var s=this.__OR=new qx.ui.basic.Label();
this.bind(c,s,p);
s.setWidth(50);
this.addWidget(s);
s=this.__OS=new qx.ui.basic.Label();
this.bind(e,s,p);
s.setWidth(150);
this.addWidget(s);
s=this.__eK=new qx.ui.basic.Label();
this.bind(b,s,p);
s.setWidth(80);
this.addWidget(s);
}}});
