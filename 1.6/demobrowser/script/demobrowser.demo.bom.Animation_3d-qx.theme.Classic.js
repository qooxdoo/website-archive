...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Animation_3d","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Animation_3d-qx.theme.Classic.8b18ffa4e0b6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="preserve-3d",s="360deg",r="infinite",q="css.transform.3d",p="45deg",o="",n="demobrowser.demo.bom.Animation_3d",m="container",l="flat",k="parent",d="0deg",j="mouseover",g="50px",c="mouseout",b="center top",f="css.animation",e="-100px",h='label',a="20deg",i="CSS animations not supported, sorry!";
qx.Class.define(n,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(f)==null||!qx.core.Environment.get(q)){document.body.innerHTML=o;
var w=document.createElement(h);
w.innerHTML=i;
document.body.appendChild(w);
return;
}var v={duration:10000,repeat:r,keyFrames:{0:{rotate:[null,d]},100:{rotate:[null,s]}}};
var parent=document.getElementById(k);
qx.bom.element.Animation.animate(parent,v);
qx.bom.element.Transform.setStyle(parent,t);
qx.bom.element.Transform.transform(parent.children[0],{translate:[null,null,e],rotate:[null,p]});
qx.bom.element.Transform.transform(parent.children[1],{translate:[null,null,g],rotate:[a]});
qx.bom.element.Transform.setOrigin(parent.children[1],b);
var u=document.getElementById(m);
qx.bom.element.Transform.setPerspective(u,500);
qx.bom.Event.addNativeListener(u,j,function(){qx.bom.element.Transform.setStyle(parent,l);
});
qx.bom.Event.addNativeListener(u,c,function(){qx.bom.element.Transform.setStyle(parent,t);
});
}}});
})();
