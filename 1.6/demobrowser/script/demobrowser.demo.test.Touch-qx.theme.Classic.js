...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Touch","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Touch-qx.theme.Classic.e1bee724be0e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="px",k="div",j="innerHTML",h="absolute",g="12px",f="Arial",d="90px",c="green",b="55px",a="touchmove",K="Two",J="<b>Cancel Touch</b>",I="30px",H="qx.debug",G="event.touch",F="touchend",E='Lucida Grande',D="qx.mobile.emulatetouch",C="touchstart",B="__infoArea",s="demobrowser.demo.test.Touch",t="9px",q="engine.name",r="click",o="20px",p="red",m="</b>",n="webkit",u="touchcancel",v="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",z="One",w="blue",A="<b>Touch me:<br>";
qx.Class.define(s,{extend:qx.application.Native,members:{__On:null,__Oo:null,main:function(){qx.application.Native.prototype.main.call(this);
if((qx.core.Environment.get(H))){qx.log.appender.Native;
qx.log.appender.Console;
}var M=new qx.html.Element(k);
M.useElement(document.body);
M.setRoot(true);

if(qx.core.Environment.get(q)!=n||(!qx.core.Environment.get(G)&&qx.core.Environment.get(D)==false)){var L={"color":c,"position":h,"font-family":E,"font-size":g,"left":I,"top":o};
var N=new qx.html.Element(k,L);
M.add(N);
N.setAttribute(j,v);
return;
}M.add(this.__Op(10,10,c,z));
M.add(this.__Op(110,10,w,K));
this.__On=this.__Oq(10,110);
M.add(this.__On);
this.__Oo=this.__Oq(110,110);
M.add(this.__Oo);
M.add(this.__Or(210,10));
},__Op:function(x,y,O,P){var Q={"position":h,"left":x+l,"top":y+l,"width":d,"height":d,"backgroundColor":O,"fontFamily":f,"fontSize":g};
var R=new qx.html.Element(k,Q,{"id":P});
R.setAttribute(j,A+P+m);
R.addListener(C,this.__Os,this);
R.addListener(a,this.__Os,this);
R.addListener(F,this.__Os,this);
R.addListener(u,this.__Os,this);
return R;
},__Oq:function(x,y){var S={"position":h,"left":x+l,"top":y+l,"width":d,"fontFamily":f,"fontSize":t};
return new qx.html.Element(k,S);
},__Or:function(x,y){var T={"position":h,"left":x+l,"top":y+l,"width":b,"height":b,"backgroundColor":p,"fontFamily":f,"fontSize":g};
var U=new qx.html.Element(k,T);
U.setAttribute(j,J);
U.addListener(r,function(){window.setTimeout(function(){alert("Touch canceled");
},0);
},this);
return U;
},__Os:function(e){var V=[];
V.push("Type: "+e.getType());
V.push("==============");
V.push("Is Multi-Touch: "+e.isMultiTouch());
V.push("All Touches: "+e.getAllTouches().length);
V.push("Target Touches: "+e.getTargetTouches().length);
V.push("Changed Target Touches: "+e.getChangedTargetTouches().length);
V.push("==============");
V.push("Document: Left = "+e.getDocumentLeft()+" / Top = "+e.getDocumentTop());
V.push("Screen: Left = "+e.getScreenLeft()+" / Top = "+e.getScreenTop());
V.push("Viewport: Left = "+e.getViewportLeft()+" / Top = "+e.getViewportTop());
V.push("Identifier: "+e.getIdentifier());
var X=e.getTarget();
var W=false;
var ba=e.getTargetTouches().length>0?e.getTargetTouches():e.getChangedTargetTouches();

for(var i=0;i<ba.length;i++){W=ba[0].target==X;

if(!W){break;
}}V.push("Are all touch targets div "+X.id+":"+W);
var Y=this[B+X.id];

if(Y){Y.setAttribute(j,V.join("<br>"));
}}}});
})();
