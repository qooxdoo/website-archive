...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Transition_Color","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Transition_Color-qx.theme.Simple.24693b5809ca.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
H.setCssClass(g);
y.add(H);
var E={linear:p,easeInQuad:t,easeOutQuad:h,sinodial:j,reverse:a,wobble:o,spring:c,flicker:i,pulse:u};
var w=new qx.ui.form.SelectBox();
var G=new qx.ui.form.Button(b);
var A=new qx.ui.basic.Label(v);
var B=new qx.ui.basic.Label(r);
var F=new qx.ui.basic.Label(l);
var B=new qx.ui.basic.Label(E.linear);
var C=new qx.ui.form.Spinner;

for(var z in E){w.add(new qx.ui.form.ListItem(z));
}w.addListener(q,function(e){B.setValue(E[B.setValue(e.getData()[0].getLabel())]);
});
C.set({maximum:10.0,minimum:0.1,value:1.0});
var x;
H.addListenerOnce(f,function(){x=new qx.fx.effect.core.Highlight(H.getContentElement().getDomElement());
x.set({startColor:k,endColor:s});
},this);
var D=new qx.util.format.NumberFormat();
D.setMaximumFractionDigits(2);
C.setNumberFormat(D);
G.addListener(m,function(){var I=w.getSelection()[0].getLabel();
x.set({transition:I,duration:C.getValue()});
x.start();
});
y.add(A,{left:25,top:50});
y.add(B,{left:25,top:75});
y.add(F,{left:25,top:25});
y.add(w,{left:90,top:50});
y.add(B,{left:90,top:75});
y.add(C,{left:90,top:25});
y.add(G,{left:23,top:100});
}}});
})();
...
qx.Class.define(e,{extend:qx.fx.Base,properties:{startColor:{init:d,check:h},endColor:{init:a,check:h},restoreBackground:{init:true,check:i},keepBackgroundImage:{init:false,check:i}},members:{__BL:null,__BM:null,__BN:null,__BO:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var j=this._getElement();
this.__BL={backgroundImage:qx.bom.element.Style.get(j,"backgroundImage"),backgroundColor:qx.bom.element.Style.get(j,"backgroundColor")};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,b,f);
}this.__BM=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__BN=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__BO=[this.__BN[0]-this.__BM[0],this.__BN[1]-this.__BM[1],this.__BN[2]-this.__BM[2]];
},update:function(k){qx.fx.Base.prototype.update.call(this);
var l=[this.__BM[0]+Math.round(this.__BO[0]*k),this.__BM[1]+Math.round(this.__BO[1]*k),this.__BM[2]+Math.round(this.__BO[2]*k)];
...
for(var n in this.__BL){qx.bom.element.Style.set(o,n,this.__BL[n]);
}}},destruct:function(){this.__BM=this.__BN=this.__BO=null;
}});
})();
