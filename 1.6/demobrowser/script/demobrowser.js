...
var envinfo = {"qx.allowUrlSettings":true,"qx.application":"demobrowser.Application","qx.contrib":false,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.variants":true,"qx.revision":"","qx.theme":"demobrowser.Theme","qx.version":"1.6"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"demobrowser":{"resourceUri":"resource","sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script"},"qxc.ui.logpane":{"resourceUri":"resource","sourceUri":"script"},"qxc.ui.versionlabel":{"resourceUri":"resource","sourceUri":"script"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.d5f64cf7f225.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
var g=qx.util.ResourceManager.getInstance().toUri(a);
qx.bom.Stylesheet.includeFile(g);
g=qx.util.ResourceManager.getInstance().toUri(b);
qx.bom.Stylesheet.includeFile(g);
...
(function(){var bJ="enabled",bI="/",bH="",bG="value",bF="modelLink",bE="tags",bD="1.6",bC="node",bB="horizontal",bA='execute',bp='value',bo="~",bn="widget",bm="http://demo.qooxdoo.org/",bl="interval",bk="separator-vertical",bj="request",bi="_leftComposite",bh="^.*",bg="filled",bQ="changeValue",bR="?qxenv:demobrowser.withTests:true",bO="demobrowser.DemoBrowser",bP="http://manual.qooxdoo.org/",bM="__MF",bN="_history",bK="_status",bL="__Ms",bS="_searchTextField",bT="f1",bt="__MD",bs='changeSelection',bv="__qj",bu="logappender",bx="__Mr",bw=".html",bz="_tree",by="f2",br="visible",bq="ig",a="success",b="__Mz",c="noPlayground",d='excluded',f="_urlWindow",g='_cmdDisposeSample',h="qx.theme.Modern",n="toolbar",o="tree1",p="demo/welcome.html",bX='_cmdSampleInOwnWindow',bW=".*",bV=" ",bU="__MC",cc="background-splitpane",cb="__My",ca='demo/',bY="__Mx",ce="index.html",cd="Filter...",P="/playground/",Q='label',N="__MB",O="/apiviewer/",T="__qf",U="icon/16/actions/edit-find.png",R="_",S="right",L="main",M='_cmdObjectSummary',B="Info",A="right-top",D="_prevButton",C="file:",x='_cmdNextSample',w="__MA",z="left",y=".",v='_cmdPrevSample',q='_cmdRunSample',ba="excluded",bb="bottom-left",bc="_infosplit",bd="runbutton",V="_runbutton",W="_demoView",X="_navPart",Y="?qx.theme=",be="textfield",bf="mainsplit",K="-",J="app-header",I="Demo Browser",H="_nextButton",G="fail",F="__Mn",E="_iframe";
...
this.__Mn=this.__MN();
this.add(this.__Mn);
var cm=new qx.ui.splitpane.Pane(bB);
this.mainsplit=cm;
var cj=new qx.ui.splitpane.Pane(bB);
cj.setDecorator(null);
this._infosplit=cj;
this.add(cm,{flex:1});
var co=this._leftComposite=new qx.ui.container.Composite();
co.setLayout(new qx.ui.layout.VBox(3));
co.setBackgroundColor(cc);
cm.add(co,0);
var ch=new qx.ui.container.Composite();
ch.setLayout(new qx.ui.layout.HBox(3));
ch.setAppearance(be);
co.add(ch);
var cp=new qx.ui.basic.Image(U);
ch.add(cp);
this._searchTextField=new qx.ui.form.TextField();
this._searchTextField.setLiveUpdate(true);
this._searchTextField.setAppearance(bn);
this._searchTextField.setPlaceholder(cd);
var cn=new qx.event.Timer(500);
cn.addListener(bl,function(cq){this.filter(this._searchTextField.getValue());
cn.stop();
},this);
this._searchTextField.addListener(bQ,function(cr){cn.restart();
},this);
ch.add(this._searchTextField,{flex:1});
this._status=new qx.ui.basic.Label(bH);
this._status.setAppearance(bn);
this._status.setWidth(80);
this._status.setTextAlign(S);
ch.add(this._status);
cm.add(cj,1);
this._tree=this.__MR();
co.add(this._tree,{flex:1});
this.__MS();
this._demoView=this.__MO();
{cj.add(this._demoView,2);
};
var cf=this.__Mo=this.__MP();
var cg=this.__Mp=this.__MQ();
var ck=this.__Mq=new qxc.ui.logpane.LogView();
var cl=this.__cd=new qx.ui.container.Stack;
cl.setDecorator(L);
cl.add(cf);
cl.add(cg);
cl.add(ck);
...
this._history.addListener(bj,function(e){var cs=e.getData().replace(bo,bI);

if(this._currentSample!=cs){this.setCurrentSample(cs);
}},this);
this.__Mr=[this.__Mx,this.__My,this.__MB];
{this.__Mr.push(this.__Mv);
this.__Mr.push(this.__Mz);
this.__Mr.push(this.__MD);
};
this.__Ms=new qx.event.Timer(250);
this.__Ms.addListener(bl,this.__MU,this);
this.__Ms.start();
this.__Mt=new demobrowser.InfoWindow(this.tr(B));
this.__Mt.setAutoCenter(true);
},members:{_iframe:null,__Mm:null,__Ms:null,__Mu:null,_tree:null,_status:null,_searchTextField:null,__Mv:null,__Mw:null,__Mr:null,_versionFilter:null,_navPart:null,__Mx:null,__My:null,__Mz:null,__MA:null,__MB:null,__MC:null,__MD:null,__Mn:null,_leftComposite:null,_infosplit:null,_demoView:null,__qj:null,__qf:null,__ME:null,_urlWindow:null,__Mt:null,__cd:null,__Mo:null,__Mp:null,__Mq:null,__MF:null,defaultUrl:p,playgroundUrl:bm+bD+P,__MG:function(){this._cmdObjectSummary=new qx.ui.core.Command("Ctrl+O");
this._cmdObjectSummary.addListener("execute",this.__MI,this);
...
this._cmdSampleInOwnWindow.addListener("execute",this.__MJ,this);
this._cmdDisposeSample=new qx.ui.core.Command("Ctrl+D");
this._cmdDisposeSample.addListener("execute",this.__MM,this);
},__MH:function(e){var cv=e.getTarget()===this.__MF?this.__ME:this.__MF;
var cu=e.getData()[0];

if(cv&&cu){cv.setModelSelection([cu.getModel()]);
}var ct=cu!=null?cu.getUserData("value"):"";

switch(ct){case "html":this.__cd.setSelection([this.__Mo]);
this.__cd.show();
break;
case "js":this.__cd.setSelection([this.__Mp]);
this.__cd.show();
break;
case "log":this.__cd.setSelection([this.__Mq]);
this.__cd.show();
break;
default:this.__cd.resetSelection();
this.__cd.exclude();
}},__MI:function(){var cy=this._iframe.getWindow();
var cx;

if(cy&&cy.qx){cx=cy.qx.dev.ObjectSummary.getInfo();
}else{cx="Unable to access namespace. Maybe no demo loaded.";
}var cz=new qx.ui.form.TextArea(cx);
cz.setDecorator(null);
cz.setAutoSize(true);
cz.setMaxHeight(qx.bom.Viewport.getHeight()-100);
this.__Mt.setContent(cz);
this.__Mt.setWidth(400);
this.__Mt.show();
},__MJ:function(){var cA=this._iframe.getSource();
window.open(cA,"_blank");
},__MK:function(cB){var cC=!!cB;
var cD=this._tree.getSelection()[0].getUserData("tags");

if(cD){cC=cC&&!qx.lang.Array.contains(cD,"noPlayground");
}this.__Mv.setEnabled(cC);
this.__Mw=cB;
},__ML:function(){if(this.__Mw){var cG=this.__Mw;
var cF='{"code": '+'"'+encodeURIComponent(cG)+'"}';
var cE=this.playgroundUrl+"#"+encodeURIComponent(cF);
window.open(cE,"_blank");
}else{var cH=new qx.ui.basic.Label(this.tr("Could not open the Playground."));
this.__Mt.setContent(cH);
this.__Mt.setWidth(200);
this.__Mt.show();
}},__wy:function(){window.open(bm+bD+O);
},__wz:function(){var cI=(bD.split(K)[0]);
window.open(bP+cI);
},_onHideShowTests:function(event){var cK=window.location.search;
...
location.replace(cJ);
},__MM:function(e){var cN=this._iframe.getWindow();
var cM;

if(cN&&cN.qx){cN.qx.core.ObjectRegistry.shutdown();
cM=this.tr("Demo has been disposed.");
}else{cM=this.tr("Unable to access application.");
}var cO=new qx.ui.basic.Label(cM);
cO.setRich(true);
cO.setWrap(true);
this.__Mt.setContent(cO);
this.__Mt.setWidth(350);
this.__Mt.show();
},__MN:function(){var dm=new qx.ui.toolbar.ToolBar();
this._navPart=new qx.ui.toolbar.Part();
dm.add(this._navPart);
...
dm.add(dp);
var cX=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");
cX.addListener("execute",this.playPrev,this);
cX.setToolTipText("Run previous demo");
dp.add(cX);
this._prevButton=cX;
var dk=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");
dk.addListener("execute",this.playNext,this);
dk.setToolTipText("Run next demo");
dp.add(dk);
this._nextButton=dk;
var db={converter:function(du){return du=="visible";
}};
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",cX,"enabled",db);
qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dk,"enabled",db);
var ds=this._navPart=new qx.ui.toolbar.Part();
dm.add(ds);
var dt=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");
dt.addListener("execute",this.__MJ,this);
dt.setToolTipText("Open demo in new window");
this.__Mx=dt;
ds.add(dt);
{var dh=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");
dh.addListener("execute",this.__ML,this);
dh.setToolTipText("Open demo in the playground");
dh.setEnabled(false);
if(qx.core.Environment.get("browser.name")=="ie"){dh.exclude();
}this.__Mv=dh;
ds.add(dh);
var cS=new qx.ui.toolbar.Part();
dm.add(cS);
var df=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");
cS.add(df);
df.setToolTipText(this.tr("Open the qooxdoo API Viewer"));
df.addListener("execute",this.__wy,this);
var cQ=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");
cS.add(cQ);
cQ.setToolTipText(this.tr("Open the qooxdoo Manual"));
cQ.addListener("execute",this.__wz,this);
};
var dn=new qx.ui.toolbar.Part;
dm.add(dn);
{var dj=new qx.ui.menu.Menu;
this.__MA=dj;
var cY=new qx.ui.menu.RadioButton("Modern Theme");
var dq=new qx.ui.menu.RadioButton("Classic Theme");
var dr=new qx.ui.menu.RadioButton("Simple Theme");
cY.setUserData("value","qx.theme.Modern");
cY.setValue(true);
dq.setUserData("value","qx.theme.Classic");
dr.setUserData("value","qx.theme.Simple");
var dc=new qx.ui.form.RadioGroup(cY,dq,dr);
dc.addListener("changeSelection",this.__MY,this);
dj.add(cY);
dj.add(dq);
dj.add(dr);
var da=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dj);
this.__Mz=da;
da.setToolTipText("Choose theme");
dn.add(da);
};
var dd=new qx.ui.menu.Menu;
{var de=new qx.ui.menu.Button(this.tr("Object Summary"));
this.__MD=de;
de.setCommand(this._cmdObjectSummary);
dd.add(de);
};
var cV=new qx.ui.menu.Button(this.tr("Dispose Demo"));
this.__MB=cV;
cV.setCommand(this._cmdDisposeSample);
dd.add(cV);
{dd.addSeparator();
var cT=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));
cT.setValue(!!qx.core.Environment.get("demobrowser.withTests"));
cT.addListener("changeValue",this._onHideShowTests,this);
dd.add(cT);
};
var cW=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",dd);
this.__MC=cW;
cW.setToolTipText("Debugging options");
dn.add(cW);
var dg=new qx.ui.toolbar.Part;
this.__My=dg;
dm.addSpacer();
dm.add(dg);
{var dl=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");
dl.setToolTipText("Display HTML source");
dl.setModel('html');
var cU=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");
cU.setToolTipText("Display JavaScript source");
cU.setModel('js');
dl.setUserData("value","html");
cU.setUserData("value","js");
dg.add(dl);
dg.add(cU);
};
var di=new qx.ui.toolbar.RadioButton("Log File","icon/22/apps/utilities-log-viewer.png");
di.setToolTipText("Display log file");
di.setUserData("value","log");
di.setModel('log');
dg.add(di);
var cP=this.__MF=new qx.ui.form.RadioGroup;
cP.setAllowEmptySelection(true);
cP.add(di);
cP.addListener('changeSelection',this.__MH,this);
{cP.add(dl,cU);
};
dm.setOverflowHandling(true);
var cR=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");
cR.setAppearance("toolbar-button");
dm.add(cR);
dm.setOverflowIndicator(cR);
dm.setRemovePriority(dg,6);
dm.setRemovePriority(dn,5);
dm.setRemovePriority(cS,4);
dm.setRemovePriority(ds,3);
dm.setRemovePriority(dp,2);
dm.setRemovePriority(this._navPart,1);
this.__qj=new qx.ui.menu.Menu();
cR.setMenu(this.__qj);
dm.addListener("hideItem",this._onHideItem,this);
dm.addListener("showItem",this._onShowItem,this);
return dm;
},_onHideItem:function(e){var dv=e.getData();
var dw=this._getMenuItems(dv);

for(var i=0,l=dw.length;i<l;i++){dw[i].setVisibility(br);

if(dv===this.__Mz&&!(dw[i] instanceof qx.ui.menu.Separator)){dw[i].getMenu().setPosition(A);
}}},_onShowItem:function(e){var dx=e.getData();
var dz=this._getMenuItems(dx);

for(var i=0,l=dz.length;i<l;i++){dz[i].setVisibility(ba);
}
if(dx===this.__Mz){var dy=dx.getMenuButtons();

for(var i=0,l=dy.length;i<l;i++){dy[i].getMenu().setPosition(bb);
}}},_getMenuItems:function(dA){var dC=[];

if(dA instanceof qx.ui.toolbar.Part){var dH=dA.getChildren();
var dG=null;
var dB=false;
var dD=this.__qj.getChildren();

if(dA!=this.__My){dG=this.__qf[dA.toHashCode()];

if(!dG){dG=new qx.ui.menu.Separator();
this.__qj.addBefore(dG,dD[0]);
this.__qf[dA.toHashCode()]=dG;
}dC.push(dG);
}else{dB=true;
}
for(var i=0,l=dH.length;i<l;i++){if(dH[i].getVisibility()==d){continue;
}var dE=this.__qf[dH[i].toHashCode()];

if(!dE){if(dH[i] instanceof qx.ui.toolbar.RadioButton){dE=new qx.ui.menu.RadioButton(dH[i].getLabel());
dE.setToolTipText(dH[i].getToolTipText());
dE.setEnabled(dH[i].getEnabled());
dE.setUserData(bp,dH[i].getUserData(bp));
dE.setModel(dH[i].getModel());
dH[i].bind(bJ,dE,bJ);
dH[i].bind(bG,dE,bG);
dE.bind(bG,dH[i],bG);

if(!this.__ME){this.__ME=new qx.ui.form.RadioGroup();
this.__ME.setAllowEmptySelection(true);
this.__ME.addListener(bs,this.__MH,this);
}this.__ME.add(dE);
}else if(dH[i] instanceof qx.ui.toolbar.MenuButton){dE=new qx.ui.menu.Button(dH[i].getLabel().translate(),dH[i].getIcon(),dH[i].getCommand(),dH[i].getMenu());
dE.setToolTipText(dH[i].getToolTipText());
dE.setEnabled(dH[i].getEnabled());
dH[i].bind(bJ,dE,bJ);
}else if(dH[i] instanceof qx.ui.toolbar.Button){dE=new qx.ui.menu.Button(dH[i].getLabel().translate(),dH[i].getIcon());
dE.getChildControl(Q,false).setRich(true);
dE.setTextColor(dH[i].getTextColor());
dE.setToolTipText(dH[i].getToolTipText());
dE.setEnabled(dH[i].getEnabled());
dH[i].bind(bJ,dE,bJ);
var dF=qx.event.Registration.getManager(dH[i]).getListeners(dH[i],bA);

if(dF&&dF.length>0){for(var j=0,k=dF.length;j<k;j++){dE.addListener(bA,qx.lang.Function.bind(dF[j].handler,dF[j].context));
}}}else if(dH[i] instanceof qx.ui.toolbar.CheckBox){dE=new qx.ui.menu.CheckBox(dH[i].getLabel());
dE.setToolTipText(dH[i].getToolTipText());
dE.setEnabled(dH[i].getEnabled());
dH[i].bind(bJ,dE,bJ);
}else{dE=new qx.ui.menu.Separator();
}
if(dB){this.__qj.add(dE);
}else{this.__qj.addBefore(dE,dG);
}this.__qf[dH[i].toHashCode()]=dE;
}dC.push(dE);
}}return dC;
},__MO:function(){var dI=new qx.ui.embed.Iframe().set({nativeContextMenu:true});
dI.addListener("load",this.__MT,this);
this._iframe=dI;
return dI;
},__MP:function(){var dJ=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");
dJ.setOverflow("auto","auto");
dJ.setFont("monospace");
dJ.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.html.page"]=dJ;
dJ.getContentElement().setAttribute("id","qx_srcview");
return dJ;
},__MQ:function(){var dK=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");
dK.setOverflow("auto","auto");
dK.setFont("monospace");
dK.setBackgroundColor("white");
this.widgets["outputviews.sourcepage.js.page"]=dK;
dK.getContentElement().setAttribute("id","qx_srcview");
return dK;
},__MR:function(){var dM=new qx.ui.tree.Tree();
var dL=new qx.ui.tree.TreeFolder("Demos");
dM.setAppearance("demo-tree");
dM.setRoot(dL);
this.tree=this.widgets["treeview.flat"]=dM;
dM.addListener("changeSelection",this.treeGetSelection,this);
dM.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);
},this);
return dM;
},__MS:function(){var dN=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");
dN.setLayout(new qx.ui.layout.VBox(10));
dN.setAllowMaximize(false);
dN.setAllowMinimize(false);
var dQ=new qx.ui.basic.Label("");
dQ.setSelectable(true);
dQ.setNativeContextMenu(true);
dN.add(dQ);
this._urlWindow=dN;
var dR=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);
...
this.getApplicationRoot().add(dN);
var dO=new qx.ui.menu.Menu();
var dP=new qx.ui.menu.Button(this.tr("Get Demo Link"),"icon/22/mimetypes/text-html.png");
dP.addListener("execute",function(e){var dT=this.tree.getSelection()[0];
var dV=dT.getUserData("modelLink");
var dS=this.tests.handler.getFullName(dV);
dS=dS.replace(".","~");
var dU=location.protocol+"//"+location.host+location.pathname+"#"+dS;
this._urlWindow.getChildren()[0].setValue(dU);
this._urlWindow.open();
},this);
dO.add(dP);
this._tree.setContextMenu(dO);
},treeGetSelection:function(e){var dW=this.tree.getSelection()[0];
this._runbutton.setEnabled(!dW.hasChildren());
var dX=dW.getUserData(bF);
this.tests.selected=this.tests.handler.getFullName(dX);
},leftReloadTree:function(e){this._sampleToTreeNodeMap={};
var dY=this._sampleToTreeNodeMap;
var ef=null;
var eh=null;
...
if(ea){ef=ea[1];
}}function eg(ei,ej){var en=ej.getChildren();
var t;

for(var i=0;i<en.length;i++){var ek=en[i];

if(ek.hasChildren()){t=new qx.ui.tree.TreeFolder(eb.polish(ek.label));
t.setUserData(bg,false);
t.setUserData(bC,ek);
eg(t,t.getUserData(bC));

if(ek.label==ef){eh=t;
t.setOpen(true);
}}else{if(!ek.type){continue;
}t=new qx.ui.tree.TreeFile(eb.polish(ek.label));
var em=ek.pwd().slice(1).join(bI)+bI+ek.label;

if(ek.tags){var j,m,el;
t.setUserData(bE,ek.tags);
}dY[em]=t;
}ei.add(t);
t.setUserData(bF,ek);
ek.widgetLinkFull=t;
...
var eb=this;
this.tree.setUserData(bF,ed);
this.tree.getRoot().setOpen(true);
eg(this.tree.getRoot(),ed);

if(eh!=null){this.tree.setSelection([eh]);
}else{this.tree.setSelection([this.tree.getRoot()]);
}},runSample:function(e){if(this.tests.selected&&this.tests.selected!=bH){var eo=this.tests.selected.replace(y,bI);
this.setCurrentSample(eo);
}else{this.playNext();
}},setCurrentSample:function(ep){if(!ep){return;
}
if(!this._sampleToTreeNodeMap){return;
}var eq;
var es=this._sampleToTreeNodeMap[ep];

if(es){es.getTree().setSelection([es]);
eq=ca+ep;
{eq+=Y+this.__Mm;
};
var er=es.getUserData(bE);

if(er){this.__Mv.setEnabled(!qx.lang.Array.contains(er,c));
}}else{eq=this.defaultUrl;
}
if(this._iframe.getSource()==eq){this._iframe.reload();
}else{this.__Mu=false;
this._iframe.setSource(eq);
}if(eq==this.defaultUrl){this.disableMenuButtons();
}else{this.enableMenuButtons();
}this._currentSample=ep;
this._currentSampleUrl=eq;
},__MT:function(){var ey=this._iframe.getWindow();
var eE=this._iframe.getSource();

if(eE!=null&&eE!=this.defaultUrl){var ew;

try{ew=ey.location.href;
}catch(eG){ew=window.location.href;
var eF=ew.lastIndexOf("/");

if(eF!=-1){ew=ew.substring(0,eF+1);
}ew+=eE;
}var eC=ew.indexOf("/demo/")+6;
var ez=ew.indexOf("?");
ez=ez==-1?ew.length:ez;
var eA=ew.substring(eC,ez).split("/");
var eD=String.fromCharCode(187);

if(eA.length==2){var et=eA[0];
et=et.charAt(0).toUpperCase()+et.substring(1);
var eB=eA[1].replace(".html","").replace("_"," ");
eB=eB.charAt(0).toUpperCase()+eB.substring(1);
var eu="qooxdoo "+eD+" Demo Browser "+eD+" "+et+" "+eD+" "+eB;
}else{var eu="qooxdoo "+eD+" Demo Browser "+eD+" Start";
}document.title=eu;
}},__MU:function(e){var eH=this._iframe.getWindow();

try{if(eH&&eH.qx&&eH.qx.log&&eH.qx.log.appender){if(!this.__Mu){this.__Mu=true;
this.debug("Demo loaded: "+this._currentSample);
this.__Mq.clear();

try{this.__Mq.fetch(eH.qx.log.Logger);
}catch(e){return ;
}this._history.addToHistory(this._currentSample.replace("/","~"),document.title);
if(this._currentSampleUrl!=this.defaultUrl){this.__MV(this._currentSampleUrl);
}}}else{this.__Mu=false;
}}catch(eI){this.__Mu=false;
}},filter:function(eJ){var eR=new RegExp(bh+eJ+bW,bq);
var eP=this._tree.getRoot().getItems(true,true);
var eQ=0;
var eK=0;

for(var i=0;i<eP.length;i++){var eS=eP[i];
var parent=eS.getParent();
var eO=eS.getUserData(bE);
var eL=false;

if(eO!=null){for(var j=0;j<eO.length;j++){eL=!!eO[j].match(eR);

if(eL){break;
}}}
if(eS.getChildren().length==0){eK++;
}
if((eL||(eS.getLabel().search(eR)!=-1)||(parent.getLabel().search(eR)!=-1))){if(eS.getChildren().length==0){eQ++;
}eS.show();
eS.getParent().setOpen(true);
eS.getParent().show();
}else{eS.exclude();
}}if(eJ==bH){var eN=this._tree.getRoot().getItems(false,true);
var eM=this._tree.getSelection();
for(var i=0;i<eN.length;i++){if(eN[i]==eM[0]||eN[i]==eM[0].getParent()){continue;
}eN[i].setOpen(false);
}}this._status.setValue(eQ+bI+eK);
},__MV:function(eT){if(typeof (eT)!="string"){return;
}var eU=new qx.io.request.Xhr(eT);
eU.setTimeout(180000);
eU.addListener("success",function(eV){var content=eV.getTarget().getResponse();
if(content){{var eY=content.indexOf("<script",content.indexOf("<script")+7);
var ff=content.indexOf("src",eY);
var eX=content.indexOf("\"",ff+5);
var fa=content.substring(ff+5,eX);
var fd=fa.substring(4,fa.length-3)+".src.js";
var u="script/demobrowser.demo";
var fc=eT.split('/');
var fb=fc[1];
var fe=fc[2];
fe=fe.substr(0,fe.indexOf('.html'));
u+="."+fb+"."+fe+".src.js";
fd=u;
var eW=new qx.io.request.Xhr(fd);
eW.setTimeout(18000);
eW.addListener("success",function(){var fg=eW.getResponse();
this.__MK(fg);

if(fg){this.widgets["outputviews.sourcepage.js.page"].setHtml(this.__MW(fg,"javascript"));
}},this);
eW.addListener("fail",function(){this.error("Couldn't load file: "+eT);
},this);
eW.send();
this.widgets["outputviews.sourcepage.html.page"].setHtml(this.__MW(content));
};
}},this);
eU.addListener("fail",function(fh){this.error("Couldn't load file: "+eT);
},this);
eU.send();
},dataLoader:function(fi){var fj=new qx.io.request.Xhr(fi);
fj.setTimeout(180000);
fj.addListener(a,function(fk){var content=fk.getTarget().getResponse();
if(!content){if(window.location.protocol==C){alert("Failed to load demo data from the file system.\n\n"+"The security settings of your browser may prohibit AJAX "+"when using the file protocol. Please try the http protocol "+"instead.");
}return;
}var fl=eval(content);
qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(fl);
this.leftReloadTree();
var fm=this._history.getState();

if(fm){this.setCurrentSample(fm.replace(bo,bI));
}else{this.setCurrentSample(this.defaultUrl);
}},this,0);
},this);
fj.addListener(G,function(fn){this.error("Couldn't load file: "+fi);
},this);
fj.send();
},playPrev:function(e){var fr=this.tree.getSelection()[0];

if(fr){var fo=this.tree.getPreviousNodeOf(fr,false);

if(!fo||fo==this.tree.getRoot()){return;
}
while(fo.isVisible&&!fo.isVisible()){fo=this.tree.getPreviousNodeOf(fo,false);
}
if(fo.getParent()==this.tree.getRoot()){var fq=this.tree.getPreviousNodeOf(fo,false);

while(fq.isVisible&&!fq.isVisible()){fq=this.tree.getPreviousNodeOf(fq,false);
}
if(fq.getParent()==this.tree.getRoot()){fq.setOpen(true);
var fp=this.tree.getPreviousNodeOf(fo,false);
...
if(!fo||fo===fr){return;
}else{this.tree.setSelection([fo]);
this.runSample();
}}},playNext:function(e){this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
var fu=this.tree.getSelection()[0];

if(fu){var fs=this.tree.getNextNodeOf(fu);

if(!fs){return;
}
if(fs.getParent()==this.tree.getRoot()){fs.setOpen(true);
fs=this.tree.getNextNodeOf(fs);
}
if(!fs){return;
}
while(!fs.isVisible()){var ft=this.tree.getNextNodeOf(fs);

if(!ft){return ;
}
if(ft.getParent()==this.tree.getRoot()){fs.setOpen(true);
var ft=this.tree.getNextNodeOf(ft);
}fs=ft;
}
if(fs){this.tree.setSelection([fs]);
this.runSample();
}}},__MW:function(fv,fw){var fx=new qx.util.StringBuilder("<pre class='script'>");
var fz=[];
var fA=new qx.util.StringBuilder();
var fB=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;
var fy=/^\s*<\/script>\s*$/i;
fv=fv.replace(/\r\n/g,"\n").replace(/\r/g,"\n");
var fz=fv.split('\n');
if(fw=="javascript"){return "<pre ><div class='script'>"+qx.dev.Tokenizer.javaScriptToHtml(fv)+"</div></pre>";
}
for(var i=0;i<fz.length;i++){if(fB.exec(fz[i])){fx.add(this.__MX(qx.bom.String.escape(fA.get()+fz[i])));
fA.clear();
}else if(fy.exec(fz[i])){var fC=qx.dev.Tokenizer.javaScriptToHtml(fA.get());
fx.add('<div class="script">',fC,'</div>');
fA.clear();
fA.add(fz[i],'\n');
}else{fA.add(fz[i],'\n');
}}fx.add(this.__MX(qx.bom.String.escape(fA.get())),"</pre>");
return fx.get();
},disableMenuButtons:function(){var fD=this.__Mr;

for(var i=0;i<fD.length;i++){fD[i].setEnabled(false);
}},enableMenuButtons:function(){var fE=this.__Mr;

for(var i=0;i<fE.length;i++){fE[i].setEnabled(true);
}},__MX:function(fF){var fH=fF;
function fG(fI){var s=new qx.util.StringBuilder(arguments[1],'<span class="html-tag-name">',arguments[2],'</span>');
var fJ;
var fK=false;
if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){fJ=arguments[i];
...
while((r=m.exec(fJ))!=null){s.add(' <span class="keyword">',r[1],'</span>=<span class="string">',r[2].replace(/\s*$/,""),'</span>');
}}}s.add((fK?"/":""));
}s.add('&gt;');
return s.get();
}fH=fH.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,fG);
return fH;
},polish:function(fL){return fL.replace(bw,bH).replace(R,bV);
},__MY:function(e){this.__Mm=e.getData()[0].getUserData("value");
this.runSample();
},_createHeader:function(){var fO=new qx.ui.layout.HBox();
var fM=new qx.ui.container.Composite(fO);
fM.setAppearance(J);
var fP=new qx.ui.basic.Label(I);
var fN=new qxc.ui.versionlabel.VersionLabel();
fM.add(fP);
fM.add(new qx.ui.core.Spacer,{flex:1});
fM.add(fN);
return fM;
}},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;
this._disposeObjects(bf,o,z,bd,n,bT,by,bN,bu,M,q,v,x,bX,g,N,bU,X,V,bY,b,w,cb,bM,F,bc,bS,bK,bz,E,W,bx,bt,bL,bi,f,H,D,T,bv);
}});
})();
...
qx.Class.define(J,{extend:qx.ui.container.Composite,construct:function(){this.__xY=[[m,G,d],[g,n,A],[k,t,y],[h,r,v]];
var N=new qx.ui.layout.VBox();
N.setSeparator(c);
qx.ui.container.Composite.call(this,N);
this.setDecorator(p);
var L=new qx.ui.basic.Label(this.tr(F)).set({font:o,padding:6,allowGrowX:true,allowGrowY:true});
this.__uT=new qx.ui.toolbar.ToolBar();
this.__uT.add(L);
this.__uT.addSpacer();
var K=new qx.ui.toolbar.Button(this.tr(C),D);
K.addListener(j,function(e){this.clear();
},this);
this.__uT.add(K);
this.add(this.__uT);
var M=new qx.ui.embed.Html(H);
M.set({backgroundColor:x,overflowY:z,overflowX:E,font:w,padding:3});
this.add(M,{flex:1});
this.__ya=new qx.log.appender.Element();
qx.log.Logger.unregister(this.__ya);
this.__yb=document.createElement(B);
this.__ya.setElement(this.__yb);
M.addListenerOnce(s,function(){M.getContentElement().getDomElement().appendChild(this.__yb);
},this);
},properties:{showLogLevel:{check:a,apply:b,init:false},logLevel:{check:[m,g,k,h],init:m,event:q}},members:{__yb:null,__ya:null,__xY:null,__yc:null,__uT:null,clear:function(){this.__ya.clear();
},fetch:function(O){if(!O){O=qx.log.Logger;
}O.register(this.__ya);
O.clear();
},getAppenderElement:function(){return this.__yb;
},_applyShowLogLevel:function(P,Q){if(!this.__yc){this.__yc=this.__yd();
this.__uT.add(this.__yc);
}
if(P){this.__yc.show();
}else{this.__yc.exclude();
}},__yd:function(){var R=new qx.ui.menu.Menu();
var U=new qx.ui.toolbar.MenuButton(u,d);
U.setMenu(R);

for(var i=0,l=this.__xY.length;i<l;i++){var T=this.__xY[i];
...
this.addListener(g,this.__Na,this);
},properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__Lk:null,_getContentContainer:function(){if(!this.__Lk){this.__Lk=new qx.ui.container.Composite(new qx.ui.layout.VBox());
this.__Lk.setMinHeight(20);
}return this.__Lk;
...
y=y>=0?y:0;
this.moveTo(x,y);
},__Na:function(){if(this.getAutoCenter()){this.center();
}}}});
})();
...
(function(){var o="test",n="",m="All",l=".",h="^",g="demobrowser.TreeDataHandler",f="ttree",e="\\.[^\\.]+$",d="demobrowser.withTests",c="depth";
qx.Class.define(g,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);
this.tmap=p;
this.ttree=this.__Nb(p);
},members:{__Nb:function(q){var s=q;
...
},getChildren:function(bb){if(bb==m){var bc=this.tmap;
var bd=[];
...
qx.Mixin.define(e,{properties:{backgroundColor:{check:c,nullable:true,apply:b}},members:{_tintBackgroundColor:function(f,g,h){if(g==null){g=this.getBackgroundColor();
...
var L=H.resolve(this.getColorTop());
var I=H.resolve(this.getColorRight());
var G=H.resolve(this.getColorBottom());
var K=H.resolve(this.getColorLeft());
};
var J=this.getWidthTop();

if(J>0){F[n]=J+g+this.getStyleTop()+E+(L||c);
}var J=this.getWidthRight();

if(J>0){F[l]=J+g+this.getStyleRight()+E+(I||c);
}var J=this.getWidthBottom();

if(J>0){F[t]=J+g+this.getStyleBottom()+E+(G||c);
}var J=this.getWidthLeft();

if(J>0){F[k]=J+g+this.getStyleLeft()+E+(K||c);
...
F.top=0;
F.left=0;
},_resizeBorder:function(M,N,O){var P=this.getInsets();
N-=P.left+P.right;
O-=P.top+P.bottom;
if(N<0){N=0;
}
...
(function(){var j="_applyLinearBackgroundGradient",i=" ",h=")",g="horizontal",f=",",e=" 0",d="px",c="0",b="shorthand",a="Color",C="vertical",B="Number",A="%",z="),to(",y="from(",x="background-image",w="background",v="-webkit-gradient(linear,",u="startColorPosition",t="qx.debug",q="deg, ",r="css.gradient.legacywebkit",o="startColor",p="",m="qx.ui.decoration.MLinearBackgroundGradient",n="(",k="endColorPosition",l="css.gradient.linear",s="endColor";
qx.Mixin.define(m,{properties:{startColor:{check:a,nullable:true,apply:j},endColor:{check:a,nullable:true,apply:j},orientation:{check:[g,C],init:C,apply:j},startColorPosition:{check:B,init:0,apply:j},endColorPosition:{check:B,init:100,apply:j},colorPositionUnit:{check:[d,A],init:A,apply:j},gradientStart:{group:[o,u],mode:b},gradientEnd:{group:[s,k],mode:b}},members:{_styleLinearBackgroundGradient:function(D){{var G=qx.theme.manager.Color.getInstance();
var N=G.resolve(this.getStartColor());
var I=G.resolve(this.getEndColor());
};
var O=this.getColorPositionUnit();
if(qx.core.Environment.get(r)){O=O===d?p:O;

if(this.getOrientation()==g){var M=this.getStartColorPosition()+O+e+O;
var K=this.getEndColorPosition()+O+e+O;
}else{var M=c+O+i+this.getStartColorPosition()+O;
var K=c+O+i+this.getEndColorPosition()+O;
}var J=y+N+z+I+h;
var H=v+M+f+K+f+J+h;
D[w]=H;
}else{var P=this.getOrientation()==g?0:270;
var F=N+i+this.getStartColorPosition()+O;
var E=I+i+this.getEndColorPosition()+O;
var L=qx.core.Environment.get(l);
D[x]=L+n+P+q+F+f+E+h;
}},_resizeLinearBackgroundGradient:function(Q,R,S){var T=this.getInsets();
R-=T.left+T.right;
S-=T.top+T.bottom;
return {left:T.left,top:T.top,width:R,height:S};
},_applyLinearBackgroundGradient:function(){if(qx.core.Environment.get(t)){if(this._isInitialized()){throw new Error("This decorator is already in-use. Modification is not possible anymore!");
}}}}});
})();
...
qx.Mixin.define(p,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__rg;
...
var H=G.resolve(this.getInnerColorTop());
var K=G.resolve(this.getInnerColorRight());
var I=G.resolve(this.getInnerColorBottom());
var J=G.resolve(this.getInnerColorLeft());
};
E.position=q;
var F=this.getInnerWidthTop();

if(F>0){E[g]=F+i+this.getStyleTop()+h+H;
}var F=this.getInnerWidthRight();

if(F>0){E[d]=F+i+this.getStyleRight()+h+K;
}var F=this.getInnerWidthBottom();

if(F>0){E[e]=F+i+this.getStyleBottom()+h+I;
}var F=this.getInnerWidthLeft();

if(F>0){E[f]=F+i+this.getStyleLeft()+h+J;
}
...
}}},__re:function(L){var P=this._generateBackgroundMarkup(L);
{var N=qx.theme.manager.Color.getInstance();
var S=N.resolve(this.getColorTop());
var O=N.resolve(this.getColorRight());
var M=N.resolve(this.getColorBottom());
var R=N.resolve(this.getColorLeft());
};
L[g]=j;
L[d]=j;
L[e]=j;
L[f]=j;
L[C]=0;
if((qx.core.Environment.get(B)==A&&parseFloat(qx.core.Environment.get(n))<8)||(qx.core.Environment.get(B)==A&&qx.core.Environment.get(r)<8)){L[C]=j;
}var Q=this.getWidthTop();

if(Q>0){L[g]=Q+i+this.getStyleTop()+h+S;
}var Q=this.getWidthRight();

if(Q>0){L[d]=Q+i+this.getStyleRight()+h+O;
}var Q=this.getWidthBottom();

if(Q>0){L[e]=Q+i+this.getStyleBottom()+h+M;
}var Q=this.getWidthLeft();

if(Q>0){L[f]=Q+i+this.getStyleLeft()+h+R;
}
if(qx.core.Environment.get(a)){if(L[g]==j&&L[d]==j&&L[e]==j&&L[f]==j){throw new Error("Invalid Double decorator (zero outer border width). Use qx.ui.decoration.Single instead!");
}}L[s]=t;
L[y]=0;
L[m]=0;
return this.__rc=this._generateBackgroundMarkup(L,P);
},__rf:function(T,U,V){var W=this.getInsets();
U-=W.left+W.right;
V-=W.top+W.bottom;
var X=W.left-this.getWidthLeft()-this.getInnerWidthLeft();
var top=W.top-this.getWidthTop()-this.getInnerWidthTop();
return {left:X,top:top,width:U,height:V,elementToApplyDimensions:T.firstChild};
