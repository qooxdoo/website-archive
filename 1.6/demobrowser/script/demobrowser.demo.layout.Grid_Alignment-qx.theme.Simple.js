...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Grid_Alignment","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Grid_Alignment-qx.theme.Simple.ce8fc7efac59.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="main",l="yellow",k="bottom",j="top",h="left",g="right",f="center",e="middle",d="orange",c="gray",a="green",b="demobrowser.demo.layout.Grid_Alignment";
...
var n=new qx.ui.container.Composite(new qx.ui.layout.Grid(20)).set({padding:20});
scroll.add(n);
n.add(this.getCellAlignGrid(),{row:0,column:0});
n.add(this.getRowColumnAlignGrid(),{row:0,column:1});
n.add(this.getColumnAlignGrid(),{row:0,column:2});
n.add(this.getRowAlignGrid(),{row:1,column:0});
},getNewWidget:function(){var o=new qx.ui.core.Widget().set({decorator:m,backgroundColor:a,allowGrowX:false,allowGrowY:false,height:Math.round((Math.random()*30)+30),width:Math.round((Math.random()*30)+30)});
return o;
},getColumnAlignGrid:function(){var p=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var q=new qx.ui.layout.Grid();
q.setSpacing(3);
q.setColumnAlign(0,h,j);
q.setColumnAlign(1,f,e);
q.setColumnAlign(2,g,k);
p.setLayout(q);

for(var x=0;x<3;x++){for(var y=0;y<6;y++){p.add(this.getNewWidget(),{row:y,column:x});
}}return p;
},getRowAlignGrid:function(){var r=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var s=new qx.ui.layout.Grid();
s.setSpacing(3);
s.setRowAlign(0,h,j);
s.setRowAlign(1,f,e);
s.setRowAlign(2,g,k);
...
for(var x=0;x<6;x++){for(var y=0;y<3;y++){r.add(this.getNewWidget(),{row:y,column:x});
}}return r;
},getCellAlignGrid:function(){var t=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var v=new qx.ui.layout.Grid();
v.setSpacing(3);
t.setLayout(v);

for(var x=0;x<5;x++){v.setColumnAlign(x,f,e);

for(var y=0;y<5;y++){t.add(this.getNewWidget(),{row:y,column:x});
}}var u=v.getCellWidget(0,0);
u.set({alignX:h,alignY:j});
u.set({backgroundColor:d,width:20,height:20});
var u=v.getCellWidget(4,4);
u.set({alignX:g,alignY:k});
u.set({backgroundColor:d,width:20,height:20});
return t;
},getRowColumnAlignGrid:function(){var w=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var A=new qx.ui.layout.Grid();
A.setSpacing(3);
w.setLayout(A);

for(var x=0;x<5;x++){for(var y=0;y<5;y++){w.add(this.getNewWidget(),{row:y,column:x});
}}A.setColumnAlign(2,h,j);
A.setRowAlign(2,g,k);

for(var i=0;i<5;i++){A.getCellWidget(2,i).setBackgroundColor(c);
A.getCellWidget(i,2).setBackgroundColor(c);
}var z=A.getCellWidget(2,2);
z.set({backgroundColor:d,width:20,height:20});
return w;
}}});
})();
