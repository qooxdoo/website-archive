...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas-qx.theme.Classic.2d323681a6e3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="Integer",i="resize",h="_applyCanvasWidth",g="redraw",f="Boolean",d="__Hn",c="_applyCanvasHeight",b="qx.ui.embed.Canvas",a="qx.event.type.Data";
qx.Class.define(b,{extend:qx.ui.core.Widget,construct:function(k,l){qx.ui.core.Widget.call(this);
this.__Hn=new qx.util.DeferredCall(this.__Ho,this);
this.addListener(i,this._onResize,this);

if(k!==undefined){this.setCanvasWidth(k);
}
if(l!==undefined){this.setCanvasHeight(l);
}},events:{"redraw":a},properties:{syncDimension:{check:f,init:false},canvasWidth:{check:j,init:300,apply:h},canvasHeight:{check:j,init:150,apply:c}},members:{__Hn:null,_createContentElement:function(){return new qx.html.Canvas();
},__Ho:function(){var n=this.getContentElement();
var p=n.getHeight();
var m=n.getWidth();
...
this.__Hn.schedule();
},update:function(){this.__Hn.schedule();
...
this.__Hp=document.createElement(c);
},members:{__Hp:null,_createDomElement:function(){return this.__Hp;
},getCanvas:function(){return this.__Hp;
},setWidth:function(f){this.__Hp.width=f;
},getWidth:function(){return this.__Hp.width;
},setHeight:function(g){this.__Hp.height=g;
},getHeight:function(){return this.__Hp.height;
},getContext2d:function(){return this.__Hp.getContext(b);
