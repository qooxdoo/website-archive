...
(function(){var l="execute",k="settings",j="loading",h="main",g="addfeed",f="selection[0]",d="title",c="north",b="new",a="changeModel",bb="__pA",ba="article",Y="__px",X="F1",W="selection[0].state",V="partLoaded",U="Control+A",T="loaded",S="icon/22/places/folder.png",R="__pF",s="feedreader/images/loading22.gif",t="error",q="change",r="user",o="__pz",p="__pv",m="feeds",n="__pt",w="__pB",x="enabled",F="cached",D="__pE",J="vertical",H="state",N="__pD",L="__py",z="Control+D",Q="icon/22/actions/process-stop.png",P="selection[0].articles",O="static",y="icon/22/apps/internet-feed-reader.png",B="model",C="feedreader.Application",E="Control+P",G="__pG",I="Control+R",K="icon/22/apps/preferences-clock.png",M="__pC",u="feedreader.model.Feed",v="__pu",A="__pw";
qx.Class.define(C,{extend:qx.application.Standalone,members:{__pt:null,__pu:null,__gl:null,__pv:null,__pw:null,__px:null,__py:null,__pz:null,__pA:null,__pB:null,__pC:null,__pD:null,__pE:null,__pF:null,__pG:null,__pH:false,__pI:false,main:function(){qx.application.Standalone.prototype.main.call(this);
qx.io.PartLoader.getInstance().addListener(V,function(e){this.debug("part loaded: "+e.getData().getName());
},this);
var bd=qx.locale.Manager.getInstance().getLanguage();
var bc=qx.Part.getInstance().getParts();
if(bc[bd]){qx.io.PartLoader.require([bd],function(){qx.locale.Manager.getInstance().setLocale(bd);
this.buildUpGui();
},this);
}else{this.warn("Cannot load locale part for current language "+bd+", falling back to English.");
this.buildUpGui();
}},buildUpGui:function(){this._initializeCommands();
this._createLayout();
var be=new feedreader.model.Model();
this.__pE=be.getFeedFolder();
this.__pG=be.getStaticFeedFolder();
this.__pF=be.getUserFeedFolder();
this._setUpBinding();
this.__pv.getRoot().setOpen(true);
this.__pv.getRoot().getChildren()[0].setOpen(true);
this.__pv.getRoot().getChildren()[1].setOpen(true);
this.__pv.setHideRoot(true);
this.__pt.getSelection().push(this.__pG.getFeeds().getItem(0));
this.reload();
},_setUpBinding:function(){var bf={converter:this._state2iconConverter};
this.__pt=new qx.data.controller.Tree(this.__pE,this.__pv,m,d);
this.__pt.setIconOptions(bf);
this.__pt.setIconPath(H);
this.__pu=new qx.data.controller.List(null,this.__py.getList(),d);
this.__pt.bind(P,this.__pu,B);
this.__pu.bind(f,this.__pC,ba);
this.__pu.getSelection().addListener(q,this._listControllerChange,this);
this.__pu.addListener(a,this._treeControllerChange,this);
var bg={converter:this._state2loadingConverter};
this.__pt.bind(W,this.__py,j,bg);
bg={converter:this._category2enabledConverter};
this.__pt.bind(f,this.__px.getRemoveButton(),x,bg);
},_category2enabledConverter:function(bh){return !!bh&&bh.getCategory()==r;
},_state2iconConverter:function(bi){if(bi==b||bi==j){return s;
}else if(bi==T){return y;
}else if(bi==t){return Q;
}else if(bi==F){return K;
}return S;
},_state2loadingConverter:function(bj){if(bj==b||bj==j){return true;
}return false;
},_listControllerChange:function(bk){var bl=this.__pt.getSelection().getItem(0);
var bm=this.__pu.getSelection().getItem(0);
if(bm!=undefined){bl.setSelectedArticle(bm);
}},_treeControllerChange:function(bn){var bo=this.__pt.getSelection().getItem(0);
if(bo!=null&&bo.classname==u&&bo.getSelectedArticle()!=null&&bo.getArticles().contains(bo.getSelectedArticle())){qx.event.Timer.once(function(){this.__pu.getSelection().push(bo.getSelectedArticle());
},this,0);
}else{this.__py.getList().scrollToY(0);
}},_createLayout:function(){var bp=new qx.ui.layout.Dock();
var bq=new qx.ui.container.Composite(bp);
this.getRoot().add(bq,{edge:0});
this.__pw=new feedreader.view.desktop.Header();
bq.add(this.__pw,{edge:c});
this.__px=new feedreader.view.desktop.ToolBar(this);
bq.add(this.__px,{edge:c});
this.__pz=new qx.ui.splitpane.Pane();
bq.add(this.__pz);
this.__pv=new qx.ui.tree.Tree();
this.__pv.setWidth(250);
this.__pv.setDecorator(h);
this.__pv.setPadding(0);
this.__pz.add(this.__pv,0);
this.__pA=new qx.ui.splitpane.Pane(J);
this.__pA.setDecorator(null);
this.__pz.add(this.__pA,1);
this.__py=new feedreader.view.desktop.List(this.__pE);
this.__py.setHeight(200);
this.__py.setDecorator(h);
this.__pA.add(this.__py,0);
this.__pC=new feedreader.view.desktop.Article();
this.__pC.setDecorator(h);
this.__pA.add(this.__pC,1);
},_initializeCommands:function(){var br={};
br.reload=new qx.ui.core.Command(I);
br.reload.addListener(l,this.reload,this);
br.about=new qx.ui.core.Command(X);
br.about.addListener(l,this.showAbout,this);
br.preferences=new qx.ui.core.Command(E);
br.preferences.addListener(l,this.showPreferences,this);
br.addFeed=new qx.ui.core.Command(U);
br.addFeed.addListener(l,this.showAddFeed,this);
br.removeFeed=new qx.ui.core.Command(z);
br.removeFeed.addListener(l,this.removeFeed,this);
this.__gl=br;
},getCommand:function(bs){return this.__gl[bs];
},addFeed:function(bt,bu,bv){var bw=new feedreader.model.Feed(bt,bu,bv);
this.__pF.getFeeds().push(bw);
var bx=feedreader.io.FeedLoader.getInstance();
bx.load(bw);
},removeFeed:function(){var by=this.__pt.getSelection().getItem(0);
if(by&&by.getCategory&&by.getCategory()!==O){var bz=this.__pF.getFeeds();
for(var i=0;i<bz.length;i++){if(by===bz.getItem(i)){bz.splice(i,1);
return;
}}}},reload:function(){var bA=feedreader.io.FeedLoader.getInstance();
bA.loadAll(this.__pE);
this.__pC.setArticle(null);
},showPreferences:function(){if(!this.__pI){this.__px.signalLoading(k,true);
}qx.io.PartLoader.require([k],function(){this.__pI=true;
if(!this.__pB){this.__pB=new feedreader.view.desktop.PreferenceWindow();
this.getRoot().add(this.__pB);
}this.__pB.center();
this.__pB.open();
this.__px.signalLoading(k,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){if(!this.__pH){this.__px.signalLoading(g,true);
}qx.io.PartLoader.require([g],function(){this.__pH=true;
if(!this.__pD){this.__pD=new feedreader.view.desktop.AddFeedWindow(this);
this.getRoot().add(this.__pD);
}this.__pD.center();
this.__pD.open();
this.__px.signalLoading(g,false);
},this);
}},destruct:function(){this.__gl=null;
this._disposeObjects(Y,L,M,p,D,o,bb,A,G,R,n,v,w,N);
}});
})();
...
if(!feedreader.view.desktop.Article.__nz){feedreader.view.desktop.Article.__nz=true;
...
(function(){var m="separator-vertical",l="Posts",k="bold",j="__rm",i="__rn",h="__cd",g="center",f="_applyLoading",e="single",d="feedreader.view.desktop.List",a="middle",c="feedreader/images/loading66.gif",b="Boolean";
...
this.__rm=new qx.ui.form.List();
this.__rm.setDecorator(null);
this.__rm.setSelectionMode(e);
this.__rm.setPadding(0);
this.__rm.setMargin(0);
this.__cd.add(this.__rm);
this.__rn=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,g));
var n=new qx.ui.basic.Image(c);
n.setAlignY(a);
this.__rn.add(n);
this.__cd.add(this.__rn);
},properties:{loading:{check:b,init:false,apply:f}},members:{__cd:null,__rm:null,__rn:null,_applyLoading:function(q,r){if(q){this.__cd.setSelection([this.__rn]);
}else{this.__cd.setSelection([this.__rm]);
}},getList:function(){return this.__rm;
}},destruct:function(){this._disposeObjects(j,h,i);
}});
})();
...
(function(){var k="enabled",j="originalIcon",i=")",h="Remove feed",g="Preferences",f="excluded",d="addFeed",c="__qj",b="removeFeed",a="icon/22/actions/help-about.png",H="Reload the feeds. (%1)",G="__qh",F="visible",E="about",D="icon/22/actions/media-seek-forward.png",C="toolbar-button",B="Add feed",A="addfeed",z="icon/22/actions/view-refresh.png",y="(",r="reload",s="showItem",p="settings",q="feedreader.view.desktop.ToolBar",n="Help",o="icon/22/actions/dialog-cancel.png",l="Reload",m="preferences",t="icon/22/actions/dialog-ok.png",u="icon/22/apps/preferences-theme.png",w="hideItem",v="Open preferences window.",x="feedreader/images/loading22.gif";
qx.Class.define(q,{extend:qx.ui.toolbar.ToolBar,construct:function(I){qx.ui.toolbar.ToolBar.call(this);
this.__qf={};
this.__qg=new qx.ui.toolbar.Button(this.tr(B),t);
this.__qg.setCommand(I.getCommand(d));
this.add(this.__qg);
this.__qh=new qx.ui.toolbar.Button(this.tr(h),o);
this.__qh.setCommand(I.getCommand(b));
this.__qh.setEnabled(false);
this.add(this.__qh);
this.addSeparator();
...
this.add(L);
this.addSeparator();
this.__qi=new qx.ui.toolbar.Button(this.tr(g),u);
this.__qi.setCommand(I.getCommand(m));
this.__qi.setToolTipText(this.tr(v));
this.add(this.__qi);
this.addSpacer();
var M=new qx.ui.toolbar.Button(this.tr(n),a);
var K=I.getCommand(E);
M.setCommand(K);
...
},members:{__qh:null,__qj:null,__qf:null,__qg:null,__qi:null,getRemoveButton:function(){return this.__qh;
...
Q.setVisibility(f);
},_getMenuItem:function(S){var T=this.__qf[S.toHashCode()];
...
this.__qf[S.toHashCode()]=T;
}return T;
},signalLoading:function(U,V){if(U==A){var W=this.__qg;
}else if(U==p){var W=this.__qi;
}else{return ;
