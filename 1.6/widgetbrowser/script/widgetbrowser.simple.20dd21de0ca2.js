...
this.__zq=null;
},properties:{filter:{check:h,nullable:true,apply:d}},members:{__zr:null,__zq:null,__zs:null,__zt:null,_rowArr:null,_nodeArr:null,_nodeRowMap:null,_treeColumn:null,_selections:null,setTree:function(o){this.__zr=o;
},getTree:function(){return this.__zr;
},setEditable:function(p){this.__zq=[];

for(var q=0;q<this.getColumnCount();q++){this.__zq[q]=p;
}this.fireEvent(k);
},setColumnEditable:function(r,s){if(s!=this.isColumnEditable(r)){if(this.__zq==null){this.__zq=[];
}this.__zq[r]=s;
this.fireEvent(k);
}},isColumnEditable:function(t){if(t==this._treeColumn){return false;
}return (this.__zq?this.__zq[t]==true:false);
...
},__zu:function(bd,be){var bh=this.getFilter();
var bk=null;
var bj;
...
bk=this._nodeArr[bj];
if(bk==null||(bh&&!bh.call(this,bk))){this.__zt=true;
continue;
}bl.push(bk);
bk.level=be;
bk.bFirstChild=(bf==0);
if(!this.__zt){this.__zw(bk,i==bg-1);
...
}if(bk.bOpened){this.__zu(bj,be+1);
}bf++;
}},__zv:function(bm){var bn=this.__zs;
var br=bn[bm];
var bp=br.length;
...
if(bo){this.__zv(bq.nodeId);
}}},__zw:function(bs,bt){bs.lastChild=[bt];
...
}},__sK:function(){this.__zs=[];
this.__zt=false;
this._rowArr=[];
this._nodeRowMap=[];
this._selections={};
this.__zu(0,1);
if(this.__zt){this.__zv(0);
}this.__zs=null;
...
}},destruct:function(){this._rowArr=this._nodeArr=this._nodeRowMap=this._selections=this.__zr=this.__zs=null;
...
this.add(this.__ju);
this.initWidgets();
},members:{__ju:null,initWidgets:function(){var l;
var g=this._widgets;
l=new qx.ui.basic.Label(a);
this.__ju.add(l,{row:0,column:0});
var j=this.__LA();
this.__ju.add(j,{row:1,column:0});
g.push(j);
l=new qx.ui.basic.Label(b);
l.setToolTip(new qx.ui.tooltip.ToolTip(d));
this.__ju.add(l,{row:0,column:1});
var k=this.__LB();
this.__ju.add(k,{row:1,column:1});
g.push(k);
l=new qx.ui.basic.Label(e);
l.setToolTip(new qx.ui.tooltip.ToolTip(f));
this.__ju.add(l,{row:0,column:2});
var h=this.__LC();
this.__ju.add(h,{row:1,column:2});
g.push(h);
},__LA:function(){var v=new qx.ui.tree.Tree().set({width:200,height:400});
...
A.add(z);
return v;
},__LB:function(){var C=new qx.ui.tree.VirtualTree(null,"name","children").set({width:200,height:400});
...
return C;
},__LC:function(){var G=new qx.ui.treevirtual.TreeVirtual("TreeVirtual");
G.setWidth(200);
...
(function(){var l='px;',k="",j="Boolean",h='',g='px',e='</div>',d='<div style="position:absolute;',c='">',b='left:',a=";",L='</span>',K='background-image:url(',J='">&nbsp;</div>',I="treevirtual-file",H="qx.ui.treevirtual.SimpleTreeDataCellRenderer",G='height:',F='style="',E='top:0;',D='background-repeat:no-repeat;',C='right:',t='<div style="',u='" title="',r=');',s='<span',p=';width:',q=';"',m='>',n='bottom:',v="qx.dynlocale",w='top:',y="content-box",x="css.boxsizing",A="treevirtual-folder",z='width:',B=';height:';
...
this.__AW=qx.util.ResourceManager.getInstance();
this.__AX=qx.theme.manager.Appearance.getInstance();
this.BLANK=this.__AW.toUri(this.__AV.resolve("static/blank.gif"));
},statics:{__sD:{},__AU:true,__AY:function(){qx.theme.manager.Meta.getInstance().initialize();
var N=qx.ui.treevirtual.SimpleTreeDataCellRenderer;
var Q=qx.io.ImageLoader;
var O=qx.util.AliasManager.getInstance();
var R=qx.util.ResourceManager.getInstance();
var P=qx.theme.manager.Appearance.getInstance();
var S=function(f){Q.load(R.toUri(O.resolve(f)));
};
N.__sD.line=P.styleFrom("treevirtual-line");
S(N.__sD.line.icon);
N.__sD.contract=P.styleFrom("treevirtual-contract");
S(N.__sD.contract.icon);
N.__sD.expand=P.styleFrom("treevirtual-expand");
S(N.__sD.expand.icon);
N.__sD.onlyContract=P.styleFrom("treevirtual-only-contract");
S(N.__sD.onlyContract.icon);
N.__sD.onlyExpand=P.styleFrom("treevirtual-only-expand");
S(N.__sD.onlyExpand.icon);
N.__sD.startContract=P.styleFrom("treevirtual-start-contract");
S(N.__sD.startContract.icon);
N.__sD.startExpand=P.styleFrom("treevirtual-start-expand");
S(N.__sD.startExpand.icon);
N.__sD.endContract=P.styleFrom("treevirtual-end-contract");
S(N.__sD.endContract.icon);
N.__sD.endExpand=P.styleFrom("treevirtual-end-expand");
S(N.__sD.endExpand.icon);
N.__sD.crossContract=P.styleFrom("treevirtual-cross-contract");
S(N.__sD.crossContract.icon);
N.__sD.crossExpand=P.styleFrom("treevirtual-cross-expand");
S(N.__sD.crossExpand.icon);
N.__sD.end=P.styleFrom("treevirtual-end");
S(N.__sD.end.icon);
N.__sD.cross=P.styleFrom("treevirtual-cross");
S(N.__sD.cross.icon);
}},properties:{useTreeLines:{check:j,init:true},excludeFirstLevelTreeLines:{check:j,init:false},alwaysShowOpenCloseSymbol:{check:j,init:false}},members:{__AV:null,__AX:null,__AW:null,_getCellStyle:function(T){var U=T.value;
var V=qx.ui.table.cellrenderer.Abstract.prototype._getCellStyle.call(this,T)+(U.cellStyle?U.cellStyle+a:k);
return V;
...
var be=this.__AW.toUri(this.__AV.resolve(bd.url));
if(bd.position){var bg=bd.position;
bf.push(d);

if(qx.core.Environment.get(x)){bf.push(qx.bom.element.BoxSizing.compile(y));
}
if(bg.top!==undefined){bf.push(w+bg.top+l);
}
if(bg.right!==undefined){bf.push(C+bg.right+l);
}
if(bg.bottom!==undefined){bf.push(n+bg.bottom+l);
}
if(bg.left!==undefined){bf.push(b+bg.left+l);
}
if(bg.width!==undefined){bf.push(z+bg.width+l);
}
if(bg.height!==undefined){bf.push(G+bg.height+l);
}bf.push(c);
}bf.push(t);
bf.push(K+be+r);
bf.push(D);

if(bd.imageWidth&&bd.imageHeight){bf.push(p+bd.imageWidth+g+B+bd.imageHeight+g);
}var bh=bd.tooltip;

if(bh!=null){bf.push(u+bh);
}bf.push(J);

if(bd.position){bf.push(e);
}return bf.join(k);
},_addIndentation:function(bi,bj){var bk=bi.value;
var bm;
var bn=k;
...
for(var i=0;i<bk.level;i++){bm=this._getIndentSymbol(i,bk,bq,bp,bo);
var bl=bi.table.getRowHeight();
bn+=this._addImage({url:bm.icon,position:{top:0+(bm.paddingTop||0),left:bj+(bm.paddingLeft||0),width:bl+3,height:bl},imageWidth:bl,imageHeight:bl});
bj+=bl+3;
}return ({html:bn,pos:bj});
},_addIcon:function(br,bs){var bt=br.value;
var bv=(bt.bSelected?bt.iconSelected:bt.icon);

if(!bv){if(bt.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF){var o=this.__AX.styleFrom(I);
}else{var bw={opened:bt.bOpened};
var o=this.__AX.styleFrom(A,bw);
}bv=o.icon;
}var bu=br.table.getRowHeight();
var bx=this._addImage({url:bv,position:{top:0,left:bs,width:bu+3,height:bu},imageWidth:bu,imageHeight:bu});
return ({html:bx,pos:bs+bu+3});
},_addLabel:function(by,bz){var bA=by.value;
var bC=bA.label;

if(qx.core.Environment.get(v)){if(bC&&bC.translate){bC=bC.translate();
}}var bB=d+b+bz+l+E+(bA.labelStyle?bA.labelStyle+a:k)+c+s+(by.labelSpanStyle?F+by.labelSpanStyle+q:k)+m+bC+L+e;
return bB;
},_addExtraContentBeforeIndentation:function(bD,bE){return {html:h,pos:bE};
},_addExtraContentBeforeIcon:function(bF,bG){return {html:h,pos:bG};
},_addExtraContentBeforeLabel:function(bH,bI){return {html:h,pos:bI};
},_getIndentSymbol:function(bJ,bK,bL,bM,bN){var bO=qx.ui.treevirtual.SimpleTreeDataCellRenderer;
if(bJ==0&&bN){bL=false;
}if(bJ<bK.level-1){return (bL&&!bK.lastChild[bJ]?bO.__sD.line:{icon:this.BLANK});
}var bP=bK.lastChild[bK.lastChild.length-1];
if(bK.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH&&!bK.bHideOpenClose){if(bK.children.length>0||bM){if(!bL){return (bK.bOpened?bO.__sD.contract:bO.__sD.expand);
}if(bJ==0&&bK.bFirstChild){if(bP){return (bK.bOpened?bO.__sD.onlyContract:bO.__sD.onlyExpand);
}else{return (bK.bOpened?bO.__sD.startContract:bO.__sD.startExpand);
}}if(bP){return (bK.bOpened?bO.__sD.endContract:bO.__sD.endExpand);
}return (bK.bOpened?bO.__sD.crossContract:bO.__sD.crossExpand);
}}if(bL){if(bK.parentNodeId==0){if(bP&&bK.bFirstChild){return {icon:this.BLANK};
}if(bP){return bO.__sD.end;
}if(bK.bFirstChild){return (bK.bOpened?bO.__sD.startContract:bO.__sD.startExpand);
}}return (bP?bO.__sD.end:bO.__sD.cross);
}return {icon:this.BLANK};
}},destruct:function(){this.__AV=this.__AW=this.__AX=null;
}});
})();
...
this.__Aj=d;
},members:{__Aj:null,getTable:function(){return this.__Aj;
...
},_getDataFromRow:function(bc){return this.__nP.getItem(bc);
...
},getLevel:function(be){return this.__Gg[be];
...
},_applyModel:function(bD,bE){this.__Gf=[];
...
if(qx.lang.String.startsWith(bI,this.getChildProperty())){this.__Gj();
...
}}},_beforeApplySelection:function(bP){if(bP.length===0&&this.getSelectionMode()===d){var bQ=this.__Go();
var bR=this.getLookupTable().indexOf(bQ);

if(bR>=0){bP.push(bR);
}}},_afterApplySelection:function(){var bS=this.getSelection();

if(bS.getLength()>0&&this.getSelectionMode()===d){this.__Gn(bS.getItem(0));
}else{this.__Gi=[];
...
if(this.isNodeOpen(bV)){var bT=this.__Gk(bV,bU);
bW=bW.concat(bT);
...
if(this.isNode(cd)){this.__Gg.push(bY);
ca.push(cd);

if(this.isNodeOpen(cd)){var cb=this.__Gk(cd,bY);
ca=ca.concat(cb);
}}else{if(this.isShowLeafs()){this.__Gg.push(bY);
ca.push(cd);
}}}return ca;
},__Gl:function(ce){if(!qx.lang.Array.contains(this.__Gf,ce)){this.__Gf.push(ce);
this.fireDataEvent(s,ce);
}},__Gm:function(cf,cg){if(cf===cg){this.__Gl(cg);
return true;
}
...
var ch=this.__Gm(cj,cg);

if(ch===true){this.__Gl(cj);
return true;
}}return false;
},__xs:function(){this.getPane().getRowConfig().setItemCount(this.__nP.getLength());
this.getPane().fullUpdate();
},getParent:function(ck){var cm=this.__nP.indexOf(ck);
...
if(cl<cn){return this.__nP.getItem(cm);
}}return null;
},__Gn:function(co){this.__Gi=[];
