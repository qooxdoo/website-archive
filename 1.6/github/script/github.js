...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:github.c3d9c57aef3f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
try{if(typeof r!==q){this.__dc(r);
}}catch(e){this.dispose();
throw e;
}},events:{"success":p,"actionSuccess":p,"error":p,"actionError":p},statics:{POLL_THROTTLE_LIMIT:100,POLL_THROTTLE_COUNT:30,REQUIRED:true},members:{__cR:null,__cS:null,__cV:null,__cT:null,__cU:null,__cW:null,configureRequest:function(s){this.__cW=s;
},_getRequest:function(){return new qx.io.request.Xhr();
},__cX:function(t){var u=this._getRequest();

if(!qx.lang.Type.isArray(this.__cR[t])){this.__cR[t]=[];
}this.__cR[t].push(u);
return u;
},map:function(v,w,x,y){this.__cS[v]=[w,x,y];
this.__cR[v]=[];
...
this[v].action=true;
},invoke:function(z,A){var D=this.__cX(z),G=this._getRequestConfig(z,A),A=A==null?{}:A,C=qx.lang.Object.clone(A);
this.__cS[z].params=A;
if(A){this.__db(this.__cS[z][1]).forEach(function(H){delete C[H];
});
}this.__cY(A,G.check);

if(this.__cW){this.__cW.call(this,D,z,A);
}this.__da(D,C,z,G);
...
},setBaseUrl:function(K){this.__cV=K;
},__cY:function(L,M){if(typeof M!==q){qx.lang.Object.getKeys(M).forEach(function(N){if(M[N]===qx.io.rest.Resource.REQUIRED&&typeof L[N]===q){throw new Error("Missing parameter '"+N+"'");
}if(!(M[N]&&typeof M[N].test==l)){return;
}if(!M[N].test(L[N])){throw new Error("Parameter '"+N+"' is invalid");
}});
}},__da:function(O,P,Q,R){O.set({method:R.method,url:R.url});
...
if(this.__cR[U]){Y.forEach(function(ba){ba.abort();
});
}}},refresh:function(bb){this.invoke(bb,this.__cS[bb].params);
},poll:function(bc,bd,be){if(this.__cT[bc]){this.__cT[bc].dispose();
}if(typeof be==q){be=this.__cS[bc].params;
}this.invoke(bc,be);
var bf=this.__cT[bc]=new qx.event.Timer(bd);
bf.addListener(h,function bg(){var bh=this.__cR[bc][0];
...
}var bl=this.__cU[bi]=this.addListener(bi+o,function bp(){if(bk.isDisposed()){return;
}
if(!bj()){bn=new Date();
bk.refresh(bi);
}},bm);
this.invoke(bi);
return bl;
},_getRequestConfig:function(br,bs){var bu=this.__cS[br];

if(!qx.lang.Type.isArray(bu)){throw new Error("No route for action "+br);
}var bw=bu[0],bt=this.__cV!==null?this.__cV+bu[1]:bu[1],bx=bu[2],bv=this.__db(bt);
bs=bs||{};
...
},__db:function(bB){var bD=/\{(\w+)(=\w+)?\}/g,bE,bC=[];
while((bE=bD.exec(bB))){bC.push(bE[1]);
}return bC;
},__dc:function(bF){qx.lang.Object.getKeys(bF).forEach(function(bG){var bI=bF[bG],bJ=bI.method,bH=bI.url,bK=bI.check;
this.map(bG,bJ,bH,bK);
},this);
},__dd:function(bL){if(!this.constructor.$$events){this.constructor.$$events={};
}
if(!this.constructor.$$events[bL]){this.constructor.$$events[bL]=p;
}}},destruct:function(){var bM;

for(bM in this.__cR){if(this.__cR[bM]){this.__cR[bM].forEach(function(bP){bP.dispose();
});
}}
if(this.__cT){for(bM in this.__cT){var bO=this.__cT[bM];
bO.stop();
bO.dispose();
}}
if(this.__cU){for(bM in this.__cU){var bN=this.__cU[bM];
...
},__de:{quicktime:{plugin:[E],control:H},wmv:{plugin:[z],control:n},divx:{plugin:[q],control:w},silverlight:{plugin:[c],control:r},pdf:{plugin:[A,G],control:u}},getQuicktimeVersion:function(){var I=qx.bom.client.Plugin.__de[f];
return qx.bom.client.Plugin.__df(I.control,I.plugin);
},getWindowsMediaVersion:function(){var J=qx.bom.client.Plugin.__de[h];
return qx.bom.client.Plugin.__df(J.control,J.plugin);
},getDivXVersion:function(){var K=qx.bom.client.Plugin.__de[g];
return qx.bom.client.Plugin.__df(K.control,K.plugin);
},getSilverlightVersion:function(){var L=qx.bom.client.Plugin.__de[d];
return qx.bom.client.Plugin.__df(L.control,L.plugin);
},getPdfVersion:function(){var M=qx.bom.client.Plugin.__de[k];
return qx.bom.client.Plugin.__df(M.control,M.plugin);
},getQuicktime:function(){var N=qx.bom.client.Plugin.__de[f];
return qx.bom.client.Plugin.__dg(N.control,N.plugin);
},getWindowsMedia:function(){var O=qx.bom.client.Plugin.__de[h];
return qx.bom.client.Plugin.__dg(O.control,O.plugin);
},getDivX:function(){var P=qx.bom.client.Plugin.__de[g];
return qx.bom.client.Plugin.__dg(P.control,P.plugin);
},getSilverlight:function(){var Q=qx.bom.client.Plugin.__de[d];
return qx.bom.client.Plugin.__dg(Q.control,Q.plugin);
},getPdf:function(){var R=qx.bom.client.Plugin.__de[k];
return qx.bom.client.Plugin.__dg(R.control,R.plugin);
},__df:function(S,T){var U=qx.bom.client.Plugin.__dg(S,T);
if(!U){return l;
...
}},__dg:function(bc,bd){if(qx.bom.client.Engine.getName()==e){var be=window.ActiveXObject;
...
this._setPhase(n);
this.__di=qx.lang.Function.bind(this._onReadyStateChange,this);
this.__dj=qx.lang.Function.bind(this._onLoad,this);
this.__dk=qx.lang.Function.bind(this._onLoadEnd,this);
this.__dl=qx.lang.Function.bind(this._onAbort,this);
this.__dm=qx.lang.Function.bind(this._onTimeout,this);
this.__dn=qx.lang.Function.bind(this._onError,this);
G.onreadystatechange=this.__di;
G.onload=this.__dj;
G.onloadend=this.__dk;
G.onabort=this.__dl;
G.ontimeout=this.__dm;
G.onerror=this.__dn;
...
},nullable:true},authentication:{check:B,nullable:true}},members:{__di:null,__dj:null,__dk:null,__dl:null,__dm:null,__dn:null,__do:null,__dp:null,__dq:null,__dh:null,__dr:null,_transport:null,_createTransport:function(){throw new Error("Abstract method call");
...
}},_getAllRequestHeaders:function(){var Q=qx.lang.Object.merge({},this._getConfiguredRequestHeaders(),this.__ds(),this.__dr,this.__dh);
return Q;
},__ds:function(){var S=this.getAuthentication(),R={};

if(S){S.getAuthHeaders().forEach(function(T){R[T.key]=T.value;
});
return R;
}},setRequestHeader:function(U,V){this.__dh[U]=V;
},getRequestHeader:function(W){return this.__dh[W];
},removeRequestHeader:function(X){if(this.__dh[X]){delete this.__dh[X];
...
},getPhase:function(){return this.__dq;
...
},getResponse:function(){return this.__do;
},_setResponse:function(bb){var bc=bb;

if(this.__do!==bb){this.__do=bb;
this.fireEvent(k,qx.event.type.Data,[this.__do,bc]);
...
if(this.isDone()){this.__dt();
}},__dt:function(){var be;
...
this.fireEvent(bf);
},_setPhase:function(bg){var bh=this.__dq;
this.__dq=bg;
...
},init:true}},members:{__dv:null,_createTransport:function(){return new qx.bom.request.Xhr();
...
if(typeof B.PARSER[A]===o){return this.__dv=B.PARSER[A];
}return this.__dv=A;
},_getParser:function(){var C=this.__dv,D;
if(C){return C;
...
qx.Bootstrap.define(p,{construct:function(){this.__dw=qx.Bootstrap.bind(this.__dK,this);
this.__dx=qx.Bootstrap.bind(this.__dJ,this);
this.__dm=qx.Bootstrap.bind(this.__dO,this);
this.__dI();
if(window.attachEvent){this.__dy=qx.Bootstrap.bind(this.__dR,this);
window.attachEvent(a,this.__dy);
}},statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},members:{readyState:0,responseText:i,responseXML:null,status:0,statusText:i,timeout:0,open:function(x,y,z,A,B){this.__dT();
...
if(!this.__dS()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();
this.__dI();
}this.__dE.onreadystatechange=this.__dw;

try{if(qx.core.Environment.get(j)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Open native request with method: "+x+", url: "+y+", async: "+z);
}this.__dE.open(x,y,z,A,B);
}catch(C){if(!qx.util.Request.isCrossDomain(y)){throw C;
}
if(!this.__dC){this.__dD=C;
}
if(this.__dC){if(window.XDomainRequest){this.readyState=4;
this.__dE=new XDomainRequest();
this.__dE.onerror=qx.Bootstrap.bind(function(){this.onreadystatechange();
this.onerror();
this.onloadend();
},this);
...
return;
}window.setTimeout(qx.Bootstrap.bind(function(){if(this.__dG){return;
}this.readyState=4;
this.onreadystatechange();
this.onerror();
this.onloadend();
},this));
}}if(qx.core.Environment.get(k)===d&&parseInt(qx.core.Environment.get(b),10)<2&&!this.__dC){this.readyState=qx.bom.request.Xhr.OPENED;
this.onreadystatechange();
}},setRequestHeader:function(D,E){this.__dT();
if(D==s||D==t||D==v||D==n){this.__dA=true;
}this.__dE.setRequestHeader(D,E);
},send:function(F){this.__dT();
if(!this.__dC&&this.__dD){throw this.__dD;
}if(qx.core.Environment.get(k)===f&&this.timeout===0){this.timeout=10000;
}if(this.timeout>0){this.__dF=window.setTimeout(this.__dm,this.timeout);
}F=typeof F==h?null:F;
try{if(qx.core.Environment.get(j)){qx.Bootstrap.debug(qx.bom.request.Xhr,"Send native request");
}this.__dE.send(F);
}catch(H){if(!this.__dC){throw H;
}if(this._getProtocol()===c){this.readyState=2;
this.__dL();
var G=this;
window.setTimeout(function(){if(G.__dG){return;
}G.readyState=3;
G.__dL();
G.readyState=4;
G.__dL();
});
}}if(qx.core.Environment.get(k)===d&&!this.__dC){this.__dK();
}this.__dz=true;
},abort:function(){this.__dT();
this.__dp=true;
this.__dE.abort();

if(this.__dE){this.readyState=this.__dE.readyState;
}},onreadystatechange:function(){},onload:function(){},onloadend:function(){},onerror:function(){},onabort:function(){},ontimeout:function(){},getResponseHeader:function(I){this.__dT();
return this.__dE.getResponseHeader(I);
},getAllResponseHeaders:function(){this.__dT();
return this.__dE.getAllResponseHeaders();
},getRequest:function(){return this.__dE;
},dispose:function(){if(this.__dG){return false;
}window.clearTimeout(this.__dF);
if(window.detachEvent){window.detachEvent(a,this.__dy);
}try{this.__dE.onreadystatechange;
}catch(K){return;
}var J=function(){};
this.__dE.onreadystatechange=J;
this.__dE.onload=J;
this.__dE.onerror=J;
this.abort();
this.__dE=null;
...
},_getProtocol:function(){var M=this.__dB;
var N=/^(\w+:)\/\//;
if(M!==null&&M.match){var O=M.match(N);

if(O&&O[1]){return O[1];
}}return window.location.protocol;
},__dE:null,__dC:null,__dw:null,__dx:null,__dy:null,__dm:null,__dz:null,__dB:null,__dp:null,__dH:null,__dG:null,__dF:null,__dD:null,__dA:null,__dI:function(){this.__dE=this._createNativeXhr();
this.__dE.onreadystatechange=this.__dw;
if(this.__dE.onabort){this.__dE.onabort=this.__dx;
}this.__dG=this.__dz=this.__dp=false;
},__dJ:function(){if(!this.__dp){this.abort();
}},__dK:function(){var P=this.__dE,Q=true;
...
if(this.readyState===qx.bom.request.Xhr.DONE&&this.__dp&&!this.__dz){return;
}if(!this.__dC&&(P.readyState==2||P.readyState==3)){return;
}this.status=0;
...
}}},__dL:function(){var S=this;
if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__dF);
}if(qx.core.Environment.get(k)==g&&qx.core.Environment.get(b)<8){if(this.__dC&&!this.__dz&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return ;
}
if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(S.__dG){return;
}S.readyState=3;
...
if(this.readyState===qx.bom.request.Xhr.DONE){this.__dM();
}},__dM:function(){if(this.__dH){this.ontimeout();
if(qx.core.Environment.get(k)===f){this.onerror();
}this.__dH=false;
}else{if(this.__dp){this.onabort();
}else{this.__dN()?this.onerror():this.onload();
}}this.onloadend();
},__dN:function(){var T;
if(this._getProtocol()===c){T=!this.responseText;
}else{T=!this.statusText;
}return T;
},__dO:function(){var U=this.__dE;
...
this.responseXML=null;
this.__dL();
},__dP:function(){var V=this.readyState===qx.bom.request.Xhr.DONE;
if(this._getProtocol()===c&&this.status===0&&V){if(!this.__dN()){this.status=200;
}}if(this.status===1223){this.status=204;
}if(qx.core.Environment.get(k)===f){if(V&&this.__dA&&!this.__dp&&this.status===0){this.status=304;
}}},__dQ:function(){if(qx.core.Environment.get(k)==g&&(this.getResponseHeader(l)||i).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var W=new window.ActiveXObject(o);
W.async=false;
W.validateOnParse=false;
W.loadXML(this.responseText);
this.responseXML=W;
}},__dR:function(){try{if(this){this.dispose();
}}catch(e){}},__dS:function(){var name=qx.core.Environment.get(k);
var X=qx.core.Environment.get(q);
return !(name==g&&X<9||name==d&&X<3.5);
},__dT:function(){if(this.__dG){throw new Error("Already disposed");
...
},__dV:{"Windows NT 6.1":r,"Windows NT 6.0":N,"Windows NT 5.2":X,"Windows NT 5.1":C,"Windows NT 5.0":b,"Windows 2000":b,"Windows NT 4.0":I,"Win 9x 4.90":D,"Windows CE":q,"Windows 98":c,"Win98":c,"Windows 95":e,"Win95":e,"Mac OS X 10_7":g,"Mac OS X 10.7":g,"Mac OS X 10_6":a,"Mac OS X 10.6":a,"Mac OS X 10_5":f,"Mac OS X 10.5":f,"Mac OS X 10_4":bc,"Mac OS X 10.4":bc,"Mac OS X 10_3":h,"Mac OS X 10.3":h,"Mac OS X 10_2":d,"Mac OS X 10.2":d,"Mac OS X 10_1":i,"Mac OS X 10.1":i,"Mac OS X 10_0":bd,"Mac OS X 10.0":bd},getVersion:function(){var bi=[];

for(var bh in qx.bom.client.OperatingSystem.__dV){bi.push(bh);
}var bj=new RegExp(S+bi.join(m).replace(/\./g,l)+W,L);
var bg=bj.exec(navigator.userAgent);

if(bg&&bg[1]){return qx.bom.client.OperatingSystem.__dV[bg[1]];
}return j;
...
(function(){var g="",f="qx.core.BaseInit",d="engine.name",c="os.name",b="engine.version",a="github.Application";
qx.Class.define(f,{statics:{getApplication:function(){return this.__ea||null;
},ready:function(){if(this.__ea){return;
}
...
}},__eb:function(e){var k=this.__ea;

if(k){k.close();
}},__ec:function(){var l=this.__ea;
...
if(p){p.__eh();
}}},members:{canHandleEvent:function(q,r){},registerEvent:function(s,t,u){},unregisterEvent:function(v,w,x){},__ef:null,__ed:null,__ee:null,__eg:null,__eh:function(){if(!this.__ef&&this.__ed&&qx.$$loader.scriptLoaded){if((qx.core.Environment.get(n)==l)){if(qx.event.Registration.hasListener(this._window,m)){this.__ef=true;
qx.event.Registration.fireEvent(this._window,m);
}}else{this.__ef=true;
qx.event.Registration.fireEvent(this._window,m);
}}},isApplicationReady:function(){return this.__ef;
},_initObserver:function(){if(qx.$$domReady||document.readyState==h||document.readyState==m){this.__ed=true;
this.__eh();
...
},_onNativeLoad:qx.event.GlobalError.observeMethod(function(){this.__ed=true;
this.__eh();
}),_onNativeUnload:qx.event.GlobalError.observeMethod(function(){if(!this.__eg){this.__eg=true;
...
qx.Class.define(a,{statics:{getApplication:qx.core.BaseInit.getApplication,ready:qx.core.BaseInit.ready,__eb:function(e){var f=this.getApplication();

if(f){e.setReturnValue(f.close());
}},__ec:function(){var g=this.getApplication();

if(g){g.terminate();
}}},defer:function(h){qx.event.Registration.addListener(window,d,h.ready,h);
qx.event.Registration.addListener(window,c,h.__ec,h);
qx.event.Registration.addListener(window,b,h.__eb,h);
}});
})();
(function(){var b="abstract",a="qx.application.AbstractGui";
qx.Class.define(a,{type:b,extend:qx.core.Object,implement:[qx.application.IApplication],include:qx.locale.MTranslation,members:{__ei:null,_createRootWidget:function(){throw new Error("Abstract method call");
},getRoot:function(){return this.__ei;
},main:function(){qx.theme.manager.Meta.getInstance().initialize();
qx.ui.tooltip.Manager.getInstance();
this.__ei=this._createRootWidget();
},finalize:function(){this.render();
},render:function(){qx.ui.core.queue.Manager.flush();
},close:function(c){},terminate:function(){}},destruct:function(){this.__ei=null;
}});
})();
...
}else if(this.isRgbString(m)){return this.__ej();
}else if(this.isHex3String(m)){return this.__el();
}else if(this.isHex6String(m)){return this.__em();
}throw new Error("Could not parse color: "+m);
},cssStringToRgb:function(n){if(this.isNamedColor(n)){return this.NAMED[n];
}else if(this.isSystemColor(n)){throw new Error("Could not convert system colors to RGB: "+n);
}else if(this.isRgbString(n)){return this.__ej();
}else if(this.isRgbaString(n)){return this.__ek();
}else if(this.isHex3String(n)){return this.__el();
}else if(this.isHex6String(n)){return this.__em();
...
},__ej:function(){var D=parseInt(RegExp.$1,10);
var C=parseInt(RegExp.$2,10);
var B=parseInt(RegExp.$3,10);
return [D,C,B];
},__ek:function(){var G=parseInt(RegExp.$1,10);
var F=parseInt(RegExp.$2,10);
var E=parseInt(RegExp.$3,10);
return [G,F,E];
},__el:function(){var J=parseInt(RegExp.$1,16)*17;
var I=parseInt(RegExp.$2,16)*17;
var H=parseInt(RegExp.$3,16)*17;
return [J,I,H];
},__em:function(){var M=(parseInt(RegExp.$1,16)*16)+parseInt(RegExp.$2,16);
var L=(parseInt(RegExp.$3,16)*16)+parseInt(RegExp.$4,16);
var K=(parseInt(RegExp.$5,16)*16)+parseInt(RegExp.$6,16);
return [M,L,K];
},hex3StringToRgb:function(N){if(this.isHex3String(N)){return this.__el(N);
}throw new Error("Invalid hex3 value: "+N);
},hex6StringToRgb:function(O){if(this.isHex6String(O)){return this.__em(O);
}throw new Error("Invalid hex6 value: "+O);
},hexStringToRgb:function(P){if(this.isHex3String(P)){return this.__el(P);
}
if(this.isHex6String(P)){return this.__em(P);
...
(function(){var m="object",l="_applyTheme",k="",j="_",h="__en",g="qx.ui.decoration.",f="qx.theme.manager.Decoration",e=".",d="Theme",c="changeTheme",a="string",b="singleton";
qx.Class.define(f,{type:b,extend:qx.core.Object,properties:{theme:{check:d,nullable:true,apply:l,event:c}},members:{__en:null,resolve:function(n){if(!n){return null;
}
...
},isCached:function(A){return !this.__en?false:qx.lang.Object.contains(this.__en,A);
...
qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.decoration.IDecorator],type:g,properties:{insetLeft:{check:i,nullable:true,apply:h},insetRight:{check:i,nullable:true,apply:h},insetBottom:{check:i,nullable:true,apply:h},insetTop:{check:i,nullable:true,apply:h},insets:{group:[e,f,d,a],mode:b}},members:{__eo:null,_getDefaultInsets:function(){throw new Error("Abstract method called.");
},_isInitialized:function(){throw new Error("Abstract method called.");
},_resetInsets:function(){this.__eo=null;
},getInsets:function(){if(this.__eo){return this.__eo;
}var j=this._getDefaultInsets();
return this.__eo={left:this.getInsetLeft()==null?j.left:this.getInsetLeft(),right:this.getInsetRight()==null?j.right:this.getInsetRight(),bottom:this.getInsetBottom()==null?j.bottom:this.getInsetBottom(),top:this.getInsetTop()==null?j.top:this.getInsetTop()};
},_applyInsets:function(){this.__eo=null;
...
qx.Class.define(p,{statics:{DEFAULT_SCROLLBAR_WIDTH:14,__ep:null,getScrollbarWidth:function(){if(this.__ep!==null){return this.__ep;
...
qx.Bootstrap.define(q,{statics:{__eq:null,getBoxModel:function(){var content=qx.bom.client.Engine.getName()!==A||!qx.bom.client.Browser.getQuirksMode();
return content?X:I;
...
},getLinearGradient:function(){qx.bom.client.Css.__eq=false;
var bi=E;
...
if(bg){qx.bom.client.Css.__eq=true;
}}if(!bg){return null;
}var bh=/(.*?)\(/.exec(bg);
return bh?bh[1]:null;
...
return bl?bl[1]:null;
},getLegacyWebkitGradient:function(){if(qx.bom.client.Css.__eq===null){qx.bom.client.Css.getLinearGradient();
}return qx.bom.client.Css.__eq;
...
qx.Class.define(e,{statics:{__er:{tags:{button:true,select:true},types:{search:true,button:true,submit:true,reset:true,checkbox:true,radio:true}},__es:function(i){var j=this.__er;
...
if(qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(m))){if(!this.__es(m)){return c;
}}return f;
...
}},isPropertySupported:function(H){return (this.__ex[H]||this.__ev[H]||H in document.documentElement.style);
},COMPUTED_MODE:1,CASCADED_MODE:2,LOCAL_MODE:3,set:function(I,name,J,K){name=this.__ev[name]||name;
if(K!==false&&this.__ex[name]){return this.__ex[name].set(I,J);
}else{I.style[name]=J!==null?J:j;
}},setStyles:function(L,M,N){var Q=this.__ev;
var S=this.__ex;
var O=L.style;
...
}}}},reset:function(T,name,U){name=this.__ev[name]||name;
if(U!==false&&this.__ex[name]){return this.__ex[name].reset(T);
}else{T.style[name]=j;
}},get:qx.core.Environment.select(i,{"mshtml":function(V,name,W,X){name=this.__ev[name]||name;
if(X!==false&&this.__ex[name]){return this.__ex[name].get(V,W);
...
}},"default":function(bd,name,be,bf){name=this.__ev[name]||name;
if(bf!==false&&this.__ex[name]){return this.__ex[name].get(bd,be);
...
},__ey:function(){var t=this.getWidth()>this.getHeight()?90:0;
var u=window.orientation;

if(u==null||Math.abs(u%180)==t){return {"-270":90,"-180":180,"-90":-90,"0":0,"90":90,"180":180,"270":-90};
}else{return {"-270":180,"-180":-90,"-90":0,"0":90,"90":180,"180":-90,"270":0};
}},__ez:null,getOrientation:function(v){var w=(v||window).orientation;
...
}},defer:function(z){z.__ez=z.__ey();
}});
})();
...
this.__eA={};
this.add(a,h);
},members:{__eA:null,_preprocess:function(k){var n=this._getDynamic();

if(n[k]===false){return k;
}else if(n[k]===undefined){if(k.charAt(0)===j||k.charAt(0)===b||k.indexOf(g)===0||k.indexOf(f)===i||k.indexOf(e)===0){n[k]=false;
return k;
}
if(this.__eA[k]){return this.__eA[k];
}var m=k.substring(0,k.indexOf(j));
var l=this.__eA[m];

if(l!==undefined){n[k]=l+k.substring(m.length);
}}return k;
},add:function(o,p){this.__eA[o]=p;
...
for(var w in this.__eA){v[w]=this.__eA[w];
}return v;
...
if(k!==null&&k.fonts[i]){var m=this.__eC(k.fonts[i]);
...
if(p!==null&&n&&p.fonts[n]){var o=this.__eC(p.fonts[n]);
q[n]=(new o).set(p.fonts[n]);
return true;
}return false;
},__eB:function(r,s){if(r[s].include){var t=r[r[s].include];
r[s].include=null;
delete r[s].include;
...
for(var y in w){if(w[y].include&&w[w[y].include]){this.__eB(w,y);
}var x=this.__eC(w[y]);
v[y]=(new x).set(w[y]);
v[y].themed=true;
}}this._setDynamic(v);
},__eC:function(z){if(z.sources){return qx.bom.webfonts.WebFont;
}return qx.bom.Font;
...
this.__eD={fontFamily:k,fontSize:null,fontWeight:null,fontStyle:null,textDecoration:null,lineHeight:null,color:null};
...
I.set(H);
return I;
},__eE:{fontFamily:k,fontSize:k,fontWeight:k,fontStyle:k,textDecoration:k,lineHeight:1.2,color:k},getDefaultStyles:function(){return this.__eE;
}},properties:{size:{check:z,nullable:true,apply:p},lineHeight:{check:r,nullable:true,apply:x},family:{check:w,nullable:true,apply:y},bold:{check:h,nullable:true,apply:a},italic:{check:h,nullable:true,apply:b},decoration:{check:[j,v,u],nullable:true,apply:q},color:{check:t,nullable:true,apply:n}},members:{__eD:null,_applySize:function(J,K){this.__eD.fontSize=J===null?null:J+g;
},_applyLineHeight:function(L,M){this.__eD.lineHeight=L===null?null:L;
...
if(i!==l-1){P+=m;
}}this.__eD.fontFamily=P;
},_applyBold:function(Q,R){this.__eD.fontWeight=Q===null?null:Q?c:d;
},_applyItalic:function(S,T){this.__eD.fontStyle=S===null?null:S?e:d;
},_applyDecoration:function(U,V){this.__eD.textDecoration=U===null?null:U;
},_applyColor:function(W,X){this.__eD.color=W===null?null:W;
},getStyles:function(){return this.__eD;
}}});
})();
(function(){var g="'",f="qx.bom.webfonts.WebFont",e="",d="changeStatus",c=" ",b="_applySources",a="qx.event.type.Data";
qx.Class.define(f,{extend:qx.bom.Font,events:{"changeStatus":a},properties:{sources:{nullable:true,apply:b}},members:{__eF:null,_applySources:function(h,j){var n=[];
...
this.__eH={};
this.__eI=[];
this.__eJ=this.getPreferredFormats();
},statics:{FONT_FORMATS:["eot","woff","ttf","svg"],VALIDATION_TIMEOUT:5000},members:{__eG:null,__eK:null,__eH:null,__eJ:null,__eI:null,__eL:null,require:function(U,V,W,X){var Y=[];
...
}if(!(qx.core.Environment.get(g)==h&&qx.bom.client.Browser.getVersion()<9)){this.__eM(U,Y,W,X);
return;
}
if(!this.__eL){this.__eL=new qx.event.Timer(100);
this.__eL.addListener(q,this.__eN,this);
}
if(!this.__eL.isEnabled()){this.__eL.start();
}this.__eI.push([U,Y,W,X]);
},remove:function(bc){var bd=null;

for(var i=0,l=this.__eG.length;i<l;i++){if(this.__eG[i]==bc){bd=i;
this.__eT(bc);
break;
}}
if(bd){qx.lang.Array.removeAt(this.__eG,bd);
}
if(bc in this.__eH){this.__eH[bc].dispose();
delete this.__eH[bc];
...
},removeStyleSheet:function(){this.__eG=[];

if(this.__eK){var bj=this.__eK.ownerNode?this.__eK.ownerNode:this.__eK.owningElement;
qx.dom.Element.removeChild(bj,bj.parentNode);
}this.__eK=null;
},__eM:function(bk,bl,bm,bn){if(!qx.lang.Array.contains(this.__eG,bk)){var bq=this.__eP(bl);
var bp=this.__eQ(bk,bq);

if(!bp){throw new Error("Couldn't create @font-face rule for WebFont "+bk+"!");
}
if(!this.__eK){this.__eK=qx.bom.Stylesheet.createElement();
}
try{this.__eS(bp);
}catch(br){}this.__eG.push(bk);
}
if(!this.__eH[bk]){this.__eH[bk]=new qx.bom.webfonts.Validator(bk);
this.__eH[bk].setTimeout(qx.bom.webfonts.Manager.VALIDATION_TIMEOUT);
this.__eH[bk].addListenerOnce(f,this.__eO,this);
}
if(bm){var bo=bn||window;
this.__eH[bk].addListenerOnce(f,bm,bo);
}this.__eH[bk].validate();
},__eN:function(){if(this.__eI.length==0){this.__eL.stop();
return;
}var bs=this.__eI.shift();
this.__eM.apply(this,bs);
},__eO:function(bt){var bu=bt.getData();

if(bu.valid===false){qx.event.Timer.once(function(){this.remove(bu.family);
},this,250);
}},__eP:function(bv){var bx=qx.bom.webfonts.Manager.FONT_FORMATS;
var bA={};
...
},__eQ:function(bB,bC){var bF=[];
var bD=this.__eJ.length>0?this.__eJ:qx.bom.webfonts.Manager.FONT_FORMATS;

for(var i=0,l=bD.length;i<l;i++){var bE=bD[i];

if(bC[bE]){bF.push(this.__eR(bE,bC[bE]));
}}var bG=u+bF.join(K)+H;
bG=o+bB+C+bG;
bG=bG+J;
return bG;
},__eR:function(bH,bI){switch(bH){case a:return k+bI+y;
case Q:return k+bI+B;
case S:return k+bI+z;
case e:return k+bI+F;
default:return null;
}},__eS:function(bJ){var bL=t+bJ+r;

if(qx.core.Environment.get(g)==h&&qx.core.Environment.get(R)<9){var bK=this.__eU(this.__eK.cssText);
bK+=bL;
this.__eK.cssText=bK;
}else{this.__eK.insertRule(bL,this.__eK.cssRules.length);
}},__eT:function(bM){var bP=new RegExp(I+bM,P);
...
if(bP.exec(bO)){this.__eK.deleteRule(j);
return;
}}}}},__eU:function(bQ){return bQ.replace(s,A);
}},destruct:function(){delete this.__eG;
this.removeStyleSheet();

for(var bR in this.__eH){this.__eH[bR].dispose();
...
},statics:{__j:qx.$$resources||{},__eV:{}},members:{has:function(q){return !!this.self(arguments).__j[q];
...
if((qx.core.Environment.get(m)==n)&&qx.core.Environment.get(l)){G=this.self(arguments).__eV[H];
...
continue;
}if(P.match(/^\/\//)!=null){N.__eV[R]=window.location.protocol;
}else if(P.match(/^\//)!=null){N.__eV[R]=window.location.protocol+j+window.location.host;
}else if(P.match(/^\.\//)!=null){var O=document.URL;
N.__eV[R]=O.substring(0,O.lastIndexOf(o)+1);
}else if(P.match(/^http/)!=null){N.__eV[R]=p;
}else{var S=window.location.href.indexOf(i);
var Q;

if(S==-1){Q=window.location.href;
}else{Q=window.location.href.substring(0,S);
}N.__eV[R]=Q.substring(0,Q.lastIndexOf(o)+1);
}}}}}});
})();
...
qx.Bootstrap.define(f,{statics:{__eW:function(){if(!qx.bom.client.Stylesheet.__eX){qx.bom.client.Stylesheet.__eX=qx.bom.Stylesheet.createElement();
}return qx.bom.client.Stylesheet.__eX;
},getCreateStyleSheet:function(){return typeof document.createStyleSheet===h;
},getInsertRule:function(){return typeof qx.bom.client.Stylesheet.__eW().insertRule===g;
},getDeleteRule:function(){return typeof qx.bom.client.Stylesheet.__eW().deleteRule===g;
},getAddImport:function(){return (typeof qx.bom.client.Stylesheet.__eW().addImport===h);
},getRemoveImport:function(){return (typeof qx.bom.client.Stylesheet.__eW().removeImport===h);
...
}this.__eY=this._getRequestedHelpers();
},statics:{COMPARISON_FONTS:{sans:["Arial","Helvetica","sans-serif"],serif:["Times New Roman","Georgia","serif"]},HELPER_CSS:{position:"absolute",margin:"0",padding:"0",top:"-1000px",left:"-1000px",fontSize:"350px",width:"auto",height:"auto",lineHeight:"normal",fontVariant:"normal"},COMPARISON_STRING:"WEei",__fa:null,__fb:null,removeDefaultHelperElements:function(){var j=qx.bom.webfonts.Validator.__fb;

if(j){for(var k in j){document.body.removeChild(j[k]);
}}delete qx.bom.webfonts.Validator.__fb;
}},properties:{fontFamily:{nullable:true,init:null,apply:c},timeout:{check:a,init:5000}},events:{"changeStatus":e},members:{__eY:null,__fc:null,__fd:null,validate:function(){this.__fd=new Date().getTime();

if(this.__fc){this.__fc.restart();
}else{this.__fc=new qx.event.Timer(100);
this.__fc.addListener(g,this.__fe,this);
qx.event.Timer.once(function(){this.__fc.start();
},this,0);
}},_reset:function(){if(this.__eY){for(var m in this.__eY){var l=this.__eY[m];
document.body.removeChild(l);
}this.__eY=null;
}},_isFontValid:function(){if(!qx.bom.webfonts.Validator.__fa){this.__bf();
}
if(!this.__eY){this.__eY=this._getRequestedHelpers();
}var o=qx.bom.element.Dimension.getWidth(this.__eY.sans);
var n=qx.bom.element.Dimension.getWidth(this.__eY.serif);
var p=qx.bom.webfonts.Validator;

if(o!==p.__fa.sans&&n!==p.__fa.serif){return true;
}return false;
...
if(!x.__fb){x.__fb={sans:this._getHelperElement(x.COMPARISON_FONTS.sans),serif:this._getHelperElement(x.COMPARISON_FONTS.serif)};
}x.__fa={sans:qx.bom.element.Dimension.getWidth(x.__fb.sans),serif:qx.bom.element.Dimension.getWidth(x.__fb.serif)};
},__fe:function(){if(this._isFontValid()){this.__fc.stop();
this._reset();
this.fireDataEvent(f,{family:this.getFontFamily(),valid:true});
}else{var y=new Date().getTime();

if(y-this.__fd>=this.getTimeout()){this.__fc.stop();
this._reset();
this.fireDataEvent(f,{family:this.getFontFamily(),valid:false});
}}}},destruct:function(){this._reset();
this.__fc.stop();
this.__fc.removeListener(g,this.__fe,this);
this._disposeObjects(this.__fc);
}});
})();
...
},__ff:{visible:true,hidden:true},getContentWidth:function(r){var s=qx.bom.element.Style;
var t=qx.bom.element.Overflow.getX(r);
var u=parseInt(s.get(r,d)||i,10);
var x=parseInt(s.get(r,e)||i,10);

if(this.__ff[t]){var w=r.clientWidth;
...
if(this.__ff[C]){return y.clientHeight-B-A;
...
this.__fg={};
this.__fh={};
},properties:{theme:{check:d,nullable:true,event:c,apply:g}},members:{__fi:{},__fg:null,__fh:null,_applyTheme:function(j,k){this.__fh={};
this.__fg={};
},__fj:function(l,m,n){var s=m.appearances;
var v=s[l];
...
return this.__fj(r,m,n);
}}}for(var i=0;i<p.length-1;i++){p.shift();
var q=p.join(w);
var o=this.__fj(q,m);

if(o){return o;
}}if(n!=null){return this.__fj(n,m);
}return null;
}else if(typeof v===h){return this.__fj(v,m,n);
}else if(v.include&&!v.style){return this.__fj(v.include,m,n);
}return l;
},styleFrom:function(x,y,z,A){if(!z){z=this.getTheme();
}var F=this.__fh;
var B=F[x];

if(!B){B=F[x]=this.__fj(x,z,A);
...
}},destruct:function(){this.__fg=this.__fh=null;
}});
})();
...
}r.include=this.__fk(r.include);
r.patch=this.__fk(r.patch);
...
}},__fk:function(t){if(!t){return [];
}
if(qx.Bootstrap.isArray(t)){return t;
}else{return [t];
}},__fl:function(u,v){var w=v.aliases||{};
...
},__fm:function(x){for(var i=0,y=this.__fo,l=y.length;i<l;i++){if(x[y[i]]){return y[i];
}}},__fn:function(z,A){var D=this.__fm(A);
...
z[D]=new F;
},$$registry:{},__fo:[g,d,f,n,b,p,m,e],__h:null,__fp:null,__i:function(){},patch:function(G,H){this.__fq(H);
var J=this.__fm(H);

if(J!==this.__fm(G)){throw new Error("The mixins '"+G.name+"' are not compatible '"+H.name+"'!");
}var I=H[J];
var K=G.$$clazz.prototype;

for(var L in I){K[L]=I[L];
}},include:function(M,N){this.__fq(N);
var P=N.type;
...
}},__fq:function(S){if(typeof S===o||S==null){var T;
var U=new Error("Mixin theme is not a valid theme!");
throw U;
}}}});
})();
(function(){var p="Boolean",o="focusout",n="interval",m="mouseover",l="mouseout",k="mousemove",j="widget",i="qx.ui.tooltip.ToolTip",h="_applyCurrent",g="__fs",c="qx.ui.tooltip.Manager",f="__fr",d="tooltip-error",b="singleton",a="__fu";
qx.Class.define(c,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
qx.event.Registration.addListener(document.body,m,this.__fB,this,true);
this.__fr=new qx.event.Timer();
this.__fr.addListener(n,this.__fy,this);
this.__fs=new qx.event.Timer();
this.__fs.addListener(n,this.__fz,this);
this.__ft={left:0,top:0};
},properties:{current:{check:i,nullable:true,apply:h},showInvalidToolTips:{check:p,init:true},showToolTips:{check:p,init:true}},members:{__ft:null,__fs:null,__fr:null,__fu:null,__fv:null,__fw:function(){if(!this.__fu){this.__fu=new qx.ui.tooltip.ToolTip().set({rich:true});
}return this.__fu;
},__fx:function(){if(!this.__fv){this.__fv=new qx.ui.tooltip.ToolTip().set({appearance:d});
this.__fv.syncAppearance();
}return this.__fv;
...
var s=document.body;
if(q){this.__fr.startWith(q.getShowTimeout());
t.addListener(s,l,this.__fC,this,true);
t.addListener(s,o,this.__fD,this,true);
t.addListener(s,k,this.__fA,this,true);
}else{t.removeListener(s,l,this.__fC,this,true);
t.removeListener(s,o,this.__fD,this,true);
t.removeListener(s,k,this.__fA,this,true);
}},__fy:function(e){var u=this.getCurrent();

if(u&&!u.isDisposed()){this.__fs.startWith(u.getHideTimeout());

if(u.getPlaceMethod()==j){u.placeToWidget(u.getOpener());
}else{u.placeToPoint(this.__ft);
}u.show();
}this.__fr.stop();
},__fz:function(e){var v=this.getCurrent();

if(v&&!v.isDisposed()){v.exclude();
}this.__fs.stop();
this.resetCurrent();
},__fA:function(e){var w=this.__ft;
w.left=e.getDocumentLeft();
w.top=e.getDocumentTop();
},__fB:function(e){var z=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
...
if(x){A=this.__fx().set({label:x});
}
if(!A){A=this.__fw().set({label:B,icon:y});
}this.setCurrent(A);
A.setOpener(z);
},__fC:function(e){var C=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
...
}},__fD:function(e){var F=qx.ui.core.Widget.getWidgetByElement(e.getTarget());

if(!F){return;
}var G=this.getCurrent();
if(G&&G==F.getToolTip()){this.setCurrent(null);
}}},destruct:function(){qx.event.Registration.removeListener(document.body,m,this.__fB,this,true);
this._disposeObjects(f,g,a);
this.__ft=null;
}});
})();
...
this.__cO={};
},statics:{MAX_SIZE:15,__fE:a},members:{__cO:null,getDecoratorElement:function(c){var h=qx.ui.core.DecoratorFactory;
...
qx.Class.define(b,{extend:qx.core.Object,type:a,construct:function(){this.__fF={};
this.__fG=qx.lang.Function.bind(this.__dH,this);
this.__fH=false;
},members:{__fI:null,__fJ:null,__fF:null,__fH:null,__fG:null,schedule:function(c){if(this.__fI==null){this.__fI=window.setTimeout(this.__fG,0);
}var d=c.toHashCode();
if(this.__fJ&&this.__fJ[d]){return;
}this.__fF[d]=c;
this.__fH=true;
},cancel:function(e){var f=e.toHashCode();
if(this.__fJ&&this.__fJ[f]){this.__fJ[f]=null;
return;
}delete this.__fF[f];
if(qx.lang.Object.isEmpty(this.__fF)&&this.__fI!=null){window.clearTimeout(this.__fI);
this.__fI=null;
}},__dH:qx.event.GlobalError.observeMethod(function(){this.__fI=null;
while(this.__fH){this.__fJ=qx.lang.Object.clone(this.__fF);
this.__fF={};
this.__fH=false;

for(var h in this.__fJ){var g=this.__fJ[h];

if(g){this.__fJ[h]=null;
g.call();
}}}this.__fJ=null;
})},destruct:function(){if(this.__fI!=null){window.clearTimeout(this.__fI);
}this.__fG=this.__fF=null;
}});
})();
...
},members:{__bD:null,__bE:null,__fK:null,cancel:function(){this.__fK.cancel(this);
},schedule:function(){this.__fK.schedule(this);
},call:function(){var d;
this.__bE?this.__bD.apply(this.__bE):this.__bD();
}},destruct:function(){this.cancel();
this.__bE=this.__bD=this.__fK=null;
}});
})();
(function(){var m="element",k="div",j="",h="mshtml",g="engine.name",f="scroll",d="text",c="qx.html.Element",b="|capture|",a="activate",F="blur",E="deactivate",D="__gh",C="css.userselect",B="capture",A="visible",z="releaseCapture",w="|bubble|",v="qxSelectable",u="tabIndex",s="off",t="qx.html.Iframe",q="focus",r="none",o="css.userselect.none",p="hidden",n="on";
qx.Class.define(c,{extend:qx.core.Object,construct:function(G,H,I){qx.core.Object.call(this);
this.__fL=G||k;
this.__fM=H||null;
this.__fN=I||null;
},statics:{DEBUG:false,_modified:{},_visibility:{},_scroll:{},_actions:[],__fO:{},_scheduleFlush:function(J){qx.html.Element.__gs.schedule();
},flush:function(){var U;
var M=this.__fP();
var L=M.getFocus();

if(L&&this.__fT(L)){M.blur(L);
}var bc=M.getActive();

if(bc&&this.__fT(bc)){qx.bom.Element.deactivate(bc);
}var P=this.__fR();

if(P&&this.__fT(P)){qx.bom.Element.releaseCapture(P);
}var V=[];
var W=this._modified;

for(var T in W){U=W[T];
if(U.__gl()||U.classname==t){if(U.__fU&&qx.dom.Hierarchy.isRendered(U.__fU)){V.push(U);
}else{U.__gk();
}delete W[T];
}}
...
if(!X){delete R[T];
continue;
}if(!U.$$disposed){X.style.display=U.__fW?j:r;
if((qx.core.Environment.get(g)==h)){if(!(document.documentMode>=8)){X.style.visibility=U.__fW?A:p;
}}}delete R[T];
...
if(U.__ga!=null){U.__fU.scrollLeft=U.__ga;
delete U.__ga;
}if(U.__gb!=null){U.__fU.scrollTop=U.__gb;
delete U.__gb;
}var Y=U.__fX;
...
var X=bb.element.__fU;

if(!X||!N[bb.type]&&!bb.element.__gl()){continue;
}var Q=bb.args;
Q.unshift(X);
qx.bom.Element[bb.type].apply(qx.bom.Element,Q);
}this._actions=[];
for(var T in this.__fO){var K=this.__fO[T];
var bd=K.element.__fU;

if(bd){qx.bom.Selection.set(bd,K.start,K.end);
delete this.__fO[T];
}}qx.event.handler.Appear.refresh();
},__fP:function(){if(!this.__fQ){var be=qx.event.Registration.getManager(window);
this.__fQ=be.getHandler(qx.event.handler.Focus);
}return this.__fQ;
},__fR:function(){if(!this.__fS){var bf=qx.event.Registration.getManager(window);
this.__fS=bf.getDispatcher(qx.event.dispatch.MouseCapture);
}return this.__fS.getCaptureElement();
},__fT:function(bg){var bh=qx.core.ObjectRegistry.fromHashCode(bg.$$element);
return bh&&!bh.__gl();
}},members:{__fL:null,__fU:null,__ei:false,__fV:true,__fW:true,__fX:null,__fY:null,__ga:null,__gb:null,__gc:null,__gd:null,__ge:null,__fM:null,__fN:null,__gf:null,__gg:null,__gh:null,__gi:null,__gj:null,_scheduleChildrenUpdate:function(){if(this.__gi){return;
}this.__gi=true;
qx.html.Element._modified[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
},_createDomElement:function(){return qx.bom.Element.create(this.__fL);
},__gk:function(){var length;
var bi=this.__gh;
...
if(bj.__fW&&bj.__fV&&!bj.__fU){bj.__gk();
}}}
if(!this.__fU){this.__fU=this._createDomElement();
this.__fU.$$element=this.$$hash;
this._copyData(false);

if(bi&&length>0){this._insertChildren();
}}else{this._syncData();

if(this.__gi){this._syncChildren();
}}delete this.__gi;
},_insertChildren:function(){var bk=this.__gh;
...
if(bm.__fU&&bm.__fV){bl.appendChild(bm.__fU);
}}this.__fU.appendChild(bl);
}else{var bl=this.__fU;
...
if(!bs||!bs.__fV||bs.__gj!==this){bq.removeChild(bv);
}}for(var i=0;i<bu;i++){bo=bn[i];
if(bo.__fV){bs=bo.__fU;
bv=bt[bp];
...
}}},_copyData:function(bx){var bB=this.__fU;
var bA=this.__fN;
...
if(bF){var bK=this.__gf;

if(bK){var bI;

for(var bJ in bF){this._applyProperty(bJ,bK[bJ]);
}}this.__ge=null;
}},__gl:function(){var bL=this;
while(bL){if(bL.__ei){return true;
}
if(!bL.__fV||!bL.__fW){return false;
}bL=bL.__gj;
}return false;
},__gm:function(bM){if(bM.__gj===this){throw new Error("Child is already in: "+bM);
}
if(bM.__ei){throw new Error("Root elements could not be inserted into other ones.");
}if(bM.__gj){bM.__gj.remove(bM);
}bM.__gj=this;
if(!this.__gh){this.__gh=[];
}if(this.__fU){this._scheduleChildrenUpdate();
}},__gn:function(bN){if(bN.__gj!==this){throw new Error("Has no child: "+bN);
}if(this.__fU){this._scheduleChildrenUpdate();
}delete bN.__gj;
},__go:function(bO){if(bO.__gj!==this){throw new Error("Has no child: "+bO);
}if(this.__fU){this._scheduleChildrenUpdate();
}},getChildren:function(){return this.__gh||null;
},getChild:function(bP){var bQ=this.__gh;
return bQ&&bQ[bP]||null;
},hasChildren:function(){var bR=this.__gh;
return bR&&bR[0]!==undefined;
},indexOf:function(bS){var bT=this.__gh;
return bT?bT.indexOf(bS):-1;
},hasChild:function(bU){var bV=this.__gh;
return bV&&bV.indexOf(bU)!==-1;
},add:function(bW){if(arguments[1]){for(var i=0,l=arguments.length;i<l;i++){this.__gm(arguments[i]);
}this.__gh.push.apply(this.__gh,arguments);
}else{this.__gm(bW);
this.__gh.push(bW);
}return this;
},addAt:function(bX,bY){this.__gm(bX);
qx.lang.Array.insertAt(this.__gh,bX,bY);
return this;
},remove:function(ca){var cb=this.__gh;
...
},removeAt:function(cd){var ce=this.__gh;
...
qx.lang.Array.removeAt(this.__gh,cd);
return this;
},removeAll:function(){var cg=this.__gh;

if(cg){for(var i=0,l=cg.length;i<l;i++){this.__gn(cg[i]);
}cg.length=0;
}return this;
},getParent:function(){return this.__gj||null;
},insertInto:function(parent,ch){parent.__gm(this);

if(ch==null){parent.__gh.push(this);
}else{qx.lang.Array.insertAt(this.__gh,this,ch);
}return this;
},insertBefore:function(ci){var parent=ci.__gj;
parent.__gm(this);
qx.lang.Array.insertBefore(parent.__gh,this,ci);
return this;
},insertAfter:function(cj){var parent=cj.__gj;
parent.__gm(this);
qx.lang.Array.insertAfter(parent.__gh,this,cj);
return this;
},moveTo:function(ck){var parent=this.__gj;
parent.__go(this);
var cl=parent.__gh.indexOf(this);

if(cl===ck){throw new Error("Could not move to same index!");
}else if(cl<ck){ck--;
}qx.lang.Array.removeAt(parent.__gh,cl);
qx.lang.Array.insertAt(parent.__gh,this,ck);
return this;
},moveBefore:function(cm){var parent=this.__gj;
return this.moveTo(parent.__gh.indexOf(cm));
},moveAfter:function(cn){var parent=this.__gj;
return this.moveTo(parent.__gh.indexOf(cn)+1);
},free:function(){var parent=this.__gj;

if(!parent){throw new Error("Has no parent to remove from.");
}
if(!parent.__gh){return;
}parent.__gn(this);
qx.lang.Array.remove(parent.__gh,this);
return this;
},getDomElement:function(){return this.__fU||null;
},getNodeName:function(){return this.__fL;
},setNodeName:function(name){this.__fL=name;
},setRoot:function(co){this.__ei=co;
},useMarkup:function(cp){if(this.__fU){throw new Error("Could not overwrite existing element!");
...
return this.__fU;
},useElement:function(cr){if(this.__fU){throw new Error("Could not overwrite existing element!");
}this.__fU=cr;
this.__fU.$$element=this.$$hash;
this._copyData(true);
...
if(ct>=0&&cs[this.__fL]){return true;
}return false;
...
},include:function(){if(this.__fV){return;
}delete this.__fV;

if(this.__gj){this.__gj._scheduleChildrenUpdate();
}return this;
},exclude:function(){if(!this.__fV){return;
}this.__fV=false;

if(this.__gj){this.__gj._scheduleChildrenUpdate();
}return this;
},isIncluded:function(){return this.__fV===true;
},show:function(){if(this.__fW){return;
}
if(this.__fU){qx.html.Element._visibility[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
}if(this.__gj){this.__gj._scheduleChildrenUpdate();
}delete this.__fW;
},hide:function(){if(!this.__fW){return;
}
if(this.__fU){qx.html.Element._visibility[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
}this.__fW=false;
},isVisible:function(){return this.__fW===true;
},scrollChildIntoViewX:function(cw,cx,cy){var cz=this.__fU;
var cA=cw.getDomElement();

if(cy!==false&&cz&&cz.offsetWidth&&cA&&cA.offsetWidth){qx.bom.element.Scroll.intoViewX(cA,cz,cx);
}else{this.__fX={element:cw,align:cx};
qx.html.Element._scroll[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
}delete this.__ga;
},scrollChildIntoViewY:function(cB,cC,cD){var cE=this.__fU;
var cF=cB.getDomElement();

if(cD!==false&&cE&&cE.offsetWidth&&cF&&cF.offsetWidth){qx.bom.element.Scroll.intoViewY(cF,cE,cC);
}else{this.__fY={element:cB,align:cC};
qx.html.Element._scroll[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
}delete this.__gb;
},scrollToX:function(x,cG){var cH=this.__fU;
...
},getScrollX:function(){var cI=this.__fU;

if(cI){return cI.scrollLeft;
}return this.__ga||0;
},scrollToY:function(y,cJ){var cK=this.__fU;
...
},getScrollY:function(){var cL=this.__fU;
...
this.scrollToX(0);
this.scrollToY(0);
this.addListener(f,this.__gq,this);
},enableScrolling:function(){this.removeListener(f,this.__gq,this);
},__gp:null,__gq:function(e){if(!this.__gp){this.__gp=true;
this.__fU.scrollTop=0;
this.__fU.scrollLeft=0;
delete this.__gp;
}},getTextSelection:function(){var cM=this.__fU;

if(cM){return qx.bom.Selection.get(cM);
}return null;
},getTextSelectionLength:function(){var cN=this.__fU;

if(cN){return qx.bom.Selection.getLength(cN);
}return null;
},getTextSelectionStart:function(){var cO=this.__fU;

if(cO){return qx.bom.Selection.getStart(cO);
}return null;
},getTextSelectionEnd:function(){var cP=this.__fU;

if(cP){return qx.bom.Selection.getEnd(cP);
}return null;
},setTextSelection:function(cQ,cR){var cS=this.__fU;

if(cS){qx.bom.Selection.set(cS,cQ,cR);
return;
}qx.html.Element.__fO[this.toHashCode()]={element:this,start:cQ,end:cR};
qx.html.Element._scheduleFlush(m);
},clearTextSelection:function(){var cT=this.__fU;

if(cT){qx.bom.Selection.clear(cT);
}delete qx.html.Element.__fO[this.toHashCode()];
},__gr:function(cU,cV){var cW=qx.html.Element._actions;
cW.push({type:cU,element:this,args:cV||[]});
qx.html.Element._scheduleFlush(m);
},focus:function(){this.__gr(q);
},blur:function(){this.__gr(F);
},activate:function(){this.__gr(a);
},deactivate:function(){this.__gr(E);
},capture:function(cX){this.__gr(B,[cX!==false]);
},releaseCapture:function(){this.__gr(z);
},setStyle:function(cY,da,dc){if(!this.__fM){this.__fM={};
}
if(this.__fM[cY]==da){return;
}
if(da==null){delete this.__fM[cY];
}else{this.__fM[cY]=da;
}if(this.__fU){if(dc){qx.bom.element.Style.set(this.__fU,cY,da);
return this;
}if(!this.__gc){this.__gc={};
}this.__gc[cY]=true;
qx.html.Element._modified[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
}return this;
...
if(this.__fU){if(!this.__gc){this.__gc={};
}
for(var dh in dd){var dg=dd[dh];

if(this.__fM[dh]==dg){continue;
}
if(dg==null){delete this.__fM[dh];
}else{this.__fM[dh]=dg;
}if(de){df.set(this.__fU,dh,dg);
continue;
}this.__gc[dh]=true;
}qx.html.Element._modified[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
...
},getStyle:function(dk){return this.__fM?this.__fM[dk]:null;
},getAllStyles:function(){return this.__fM||null;
},setAttribute:function(dl,dm,dn){if(!this.__fN){this.__fN={};
}
if(this.__fN[dl]==dm){return;
}
if(dm==null){delete this.__fN[dl];
}else{this.__fN[dl]=dm;
}if(this.__fU){if(dn){qx.bom.element.Attribute.set(this.__fU,dl,dm);
return this;
...
},getAttribute:function(du){return this.__fN?this.__fN[du]:null;
},_applyProperty:function(name,dv){},_setProperty:function(dw,dx,dy){if(!this.__gf){this.__gf={};
}
if(this.__gf[dw]==dx){return;
}
if(dx==null){delete this.__gf[dw];
}else{this.__gf[dw]=dx;
}if(this.__fU){if(dy){this._applyProperty(dw,dx);
return this;
...
},_getProperty:function(dB){var dC=this.__gf;
...
if(this.__fU){return qx.event.Registration.addListener(this.__fU,dE,dF,self,dG);
}
...
var dJ=dE+(dG?b:w)+dI;
this.__gg[dJ]={type:dE,listener:dF,self:self,capture:dG,unique:dI};
return dJ;
},removeListener:function(dK,dL,self,dM){var dN;

if(this.$$disposed){return null;
}
if(this.__fU){qx.event.Registration.removeListener(this.__fU,dK,dL,self,dM);
}else{var dP=this.__gg;
var dO;
...
if(this.__fU){qx.event.Registration.removeListenerById(this.__fU,dR);
}else{delete this.__gg[dR];
}return this;
},hasListener:function(dS,dT){if(this.$$disposed){return false;
}
if(this.__fU){return qx.event.Registration.hasListener(this.__fU,dS,dT);
}var dV=this.__gg;
var dU;
...
}},defer:function(dX){dX.__gs=new qx.util.DeferredCall(dX.flush,dX);
},destruct:function(){var dY=this.__fU;

if(dY){qx.event.Registration.getManager(dY).removeAllListeners(dY);
dY.$$element=j;
}
if(!qx.core.ObjectRegistry.inShutDown){var parent=this.__gj;

if(parent&&!parent.$$disposed){parent.remove(this);
}}this._disposeArray(D);
this.__fN=this.__fM=this.__gg=this.__gf=this.__gd=this.__gc=this.__ge=this.__fU=this.__gj=this.__fX=this.__fY=null;
}});
})();
...
this.__fK=d;
this.__gt={};
qx.event.handler.Appear.__gu[this.$$hash]=this;
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{appear:true,disappear:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true,__gu:{},refresh:function(){var e=this.__gu;

for(var f in e){e[f].refresh();
}}},members:{__fK:null,__gt:null,canHandleEvent:function(g,h){},registerEvent:function(i,j,k){var l=qx.core.ObjectRegistry.toHashCode(i)+j;
var m=this.__gt;
...
if(r[q]){delete r[q];
}},refresh:function(){var v=this.__gt;
var w;
...
}}}},destruct:function(){this.__fK=this.__gt=null;
delete qx.event.handler.Appear.__gu[this.$$hash];
...
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{useraction:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__fK:null,__cy:null,canHandleEvent:function(c,d){},registerEvent:function(e,f,g){},unregisterEvent:function(h,i,j){}},destruct:function(){this.__fK=this.__cy=null;
...
this.__ei=this.__cy.document;
this._initButtonObserver();
this._initMoveObserver();
this._initWheelObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT+qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__gv:null,__gw:null,__gx:null,__gy:null,__gz:null,__fK:null,__cy:null,__ei:null,canHandleEvent:function(v,w){},registerEvent:qx.core.Environment.get(m)===d?function(x,y,z){x[g+y]=qx.lang.Function.returnNull;
}:qx.lang.Function.returnNull,unregisterEvent:qx.core.Environment.get(m)===d?function(A,B,C){A[g+B]=undefined;
}:qx.lang.Function.returnNull,__gA:function(D,E,F){if(!F){F=qx.bom.Event.getTarget(D);
...
},__gB:function(){var H=[this.__cy,this.__ei,this.__ei.body];
var I=this.__cy;
var G=h;
...
Event.addNativeListener(this.__ei,q,this.__gv);
Event.addNativeListener(this.__ei,t,this.__gv);
Event.addNativeListener(this.__ei,r,this.__gv);
Event.addNativeListener(this.__ei,n,this.__gv);
Event.addNativeListener(this.__ei,p,this.__gv);
},_initMoveObserver:function(){this.__gw=qx.lang.Function.listener(this._onMoveEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__ei,j,this.__gw);
Event.addNativeListener(this.__ei,l,this.__gw);
Event.addNativeListener(this.__ei,k,this.__gw);
},_initWheelObserver:function(){this.__gx=qx.lang.Function.listener(this._onWheelEvent,this);
var J=this.__gB();
qx.bom.Event.addNativeListener(J.target,J.type,this.__gx);
},_stopButtonObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__ei,q,this.__gv);
Event.removeNativeListener(this.__ei,t,this.__gv);
Event.removeNativeListener(this.__ei,r,this.__gv);
Event.removeNativeListener(this.__ei,n,this.__gv);
Event.removeNativeListener(this.__ei,p,this.__gv);
},_stopMoveObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__ei,j,this.__gw);
Event.removeNativeListener(this.__ei,l,this.__gw);
Event.removeNativeListener(this.__ei,k,this.__gw);
},_stopWheelObserver:function(){var K=this.__gB();
qx.bom.Event.removeNativeListener(K.target,K.type,this.__gx);
},_onMoveEvent:qx.event.GlobalError.observeMethod(function(L){this.__gA(L);
...
if(this.__gE){this.__gE(M,N,O);
}this.__gA(M,N,O);

if(this.__gD){this.__gD(M,N,O);
}
if(this.__gF){this.__gF(M,N,O);
}this.__gy=N;
}),_onWheelEvent:qx.event.GlobalError.observeMethod(function(P){this.__gA(P,o);
}),__gC:qx.core.Environment.select(s,{"webkit":function(Q,R,S){if(parseFloat(qx.core.Environment.get(c))<530){if(R==p){this.__gA(Q,t,S);
}}},"default":null}),__gD:qx.core.Environment.select(s,{"opera":function(T,U,V){if(U==t&&T.button==2){this.__gA(T,p,V);
}},"default":null}),__gE:qx.core.Environment.select(s,{"mshtml":function(W,X,Y){if(W.target!==undefined){return;
}
if(X==t&&this.__gy==r){this.__gA(W,q,Y);
}else if(X==n){this.__gA(W,r,Y);
}},"default":null}),__gF:qx.core.Environment.select(s,{"mshtml":null,"default":function(ba,bb,bc){switch(bb){case q:this.__gz=bc;
break;
case t:if(bc!==this.__gz){var bd=qx.dom.Hierarchy.getCommonParent(bc,this.__gz);
this.__gA(ba,r,bd);
}}}})},destruct:function(){this._stopButtonObserver();
this._stopMoveObserver();
this._stopWheelObserver();
this.__fK=this.__cy=this.__ei=this.__gz=null;
...
l.target=k.target;
return l;
},__gG:{0:j,2:i,1:h},__gH:{1:j,2:i,4:h},stop:function(){this.stopPropagation();
...
}default:if(this._native.target!==undefined){return this.__gG[this._native.button]||g;
}else{return this.__gH[this._native.button]||g;
...
this.preventDefault();
},__gI:function(m){var n=Math.abs(m);
...
},__gJ:function(){var q=qx.event.type.MouseWheel.MAXSCROLL||0;
...
if(e.wheelDelta!==undefined){if(e.wheelDeltaX!==undefined){x=e.wheelDeltaX?this.__gK(-e.wheelDeltaX):0;
}}else{if(e.axis&&e.axis==e.HORIZONTAL_AXIS){x=this.__gK(e.detail);
}}return x;
}if(u===a){var y=0;

if(e.wheelDelta!==undefined){if(e.wheelDeltaY!==undefined){y=e.wheelDeltaY?this.__gK(-e.wheelDeltaY):0;
}else{y=this.__gK(-e.wheelDelta);
}}else{if(!(e.axis&&e.axis==e.HORIZONTAL_AXIS)){y=this.__gK(e.detail);
}}return y;
}return 0;
},__gK:function(w){if(qx.core.Environment.get(f)){return this.__gI(w);
...
if((qx.core.Environment.get(l)==bt)){this.__ei=this.__cy;
}else{this.__ei=this.__cy.document.documentElement;
}this.__gL={};
...
}}},members:{__gM:null,__fK:null,__cy:null,__ei:null,__gL:null,__gN:null,__gO:null,__gP:null,canHandleEvent:function(bB,bC){},registerEvent:function(bD,bE,bF){},unregisterEvent:function(bG,bH,bI){},_fireInputEvent:function(bJ,bK){var bL=this.__gQ();
if(bL&&bL.offsetWidth!=0){var event=qx.event.Registration.createEvent(q,qx.event.type.KeyInput,[bJ,bL,bK]);
this.__fK.dispatchEvent(bL,event);
}if(this.__cy){qx.event.Registration.fireEvent(this.__cy,s,qx.event.type.Data,[q]);
}},_fireSequenceEvent:function(bM,bN,bO){var bP=this.__gQ();
var bQ=bM.keyCode;
var event=qx.event.Registration.createEvent(bN,qx.event.type.KeySequence,[bM,bP,bO]);
this.__fK.dispatchEvent(bP,event);
...
}},__gQ:function(){var bR=this.__fK.getHandler(qx.event.handler.Focus);
var bS=bR.getActive();
if(!bS||bS.offsetWidth==0){bS=bR.getFocus();
}if(!bS||bS.offsetWidth==0){bS=this.__fK.getWindow().document.body;
}return bS;
...
var Event=qx.bom.Event;
Event.addNativeListener(this.__ei,i,this.__gM);
Event.addNativeListener(this.__ei,m,this.__gM);
Event.addNativeListener(this.__ei,k,this.__gP);
},_stopKeyObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__ei,i,this.__gM);
Event.removeNativeListener(this.__ei,m,this.__gM);
Event.removeNativeListener(this.__ei,k,this.__gP);

for(var bU in (this.__gO||{})){var bT=this.__gO[bU];
Event.removeNativeListener(bT.target,k,bT.callback);
}delete (this.__gO);
},__gR:qx.event.GlobalError.observeMethod(qx.core.Environment.select(l,{"mshtml":function(bV){bV=window.event||bV;
var bY=bV.keyCode;
var bW=0;
var bX=bV.type;
if(!(this.__gL[bY]==m&&bX==m)){this._idealKeyHandler(bY,bW,bX,bV);
...
if(!(this.__gL[cb]==m&&cd==m)){this._idealKeyHandler(ce,cc,cd,ca);
}this.__gL[cb]=cd;
}else{this._idealKeyHandler(ce,cc,cd,ca);
}this.__gS(ca.target,cd,ce);
...
}},"opera":function(cj){this.__gN=cj.keyCode;
this._idealKeyHandler(cj.keyCode,0,cj.type,cj);
}})),__gS:qx.core.Environment.select(l,{"gecko":function(ck,cl,cm){if(cl===m&&(cm==33||cm==34||cm==38||cm==40)&&ck.type==v&&ck.tagName.toLowerCase()===S&&ck.getAttribute(bj)!==A){if(!this.__gO){this.__gO={};
}var co=qx.core.ObjectRegistry.toHashCode(ck);

if(this.__gO[co]){return;
}var self=this;
this.__gO[co]={target:ck,callback:function(cp){qx.bom.Event.stopPropagation(cp);
self.__gT(cp);
}};
var cn=qx.event.GlobalError.observeMethod(this.__gO[co].callback);
qx.bom.Event.addNativeListener(ck,k,cn);
}},"default":null}),__gT:qx.event.GlobalError.observeMethod(qx.core.Environment.select(l,{"mshtml":function(cq){cq=window.event||cq;
...
var cA=cz.type;
if(cB!=this.__gN){this._idealKeyHandler(0,this.__gN,cA,cz);
...
this.__gN=this.__fK=this.__cy=this.__ei=this.__gL=null;
...
}},__gA:function(U,V,W,X){var ba=qx.event.Registration;
var Y=ba.createEvent(W,qx.event.type.Focus,[U,V,X]);
ba.dispatchEvent(U,Y);
},_windowFocused:true,__hf:function(){if(this._windowFocused){this._windowFocused=false;
this.__gA(this._window,null,g,false);
}},__hg:function(){if(!this._windowFocused){this._windowFocused=true;
this.__gA(this._window,null,f,false);
}},_initObserver:qx.core.Environment.select(j,{"gecko":function(){this.__gU=qx.lang.Function.listener(this.__hm,this);
this.__gV=qx.lang.Function.listener(this.__hn,this);
this.__gW=qx.lang.Function.listener(this.__hl,this);
this.__gX=qx.lang.Function.listener(this.__hk,this);
this.__gY=qx.lang.Function.listener(this.__hh,this);
...
},"mshtml":function(){this.__gU=qx.lang.Function.listener(this.__hm,this);
this.__gV=qx.lang.Function.listener(this.__hn,this);
this.__hb=qx.lang.Function.listener(this.__hi,this);
this.__hc=qx.lang.Function.listener(this.__hj,this);
this.__ha=qx.lang.Function.listener(this.__hp,this);
...
},"webkit":function(){this.__gU=qx.lang.Function.listener(this.__hm,this);
this.__gV=qx.lang.Function.listener(this.__hn,this);
this.__hc=qx.lang.Function.listener(this.__hj,this);
this.__gW=qx.lang.Function.listener(this.__hl,this);
this.__gX=qx.lang.Function.listener(this.__hk,this);
...
qx.bom.Event.addNativeListener(this._window,f,this.__gW,true);
qx.bom.Event.addNativeListener(this._window,g,this.__gX,true);
},"opera":function(){this.__gU=qx.lang.Function.listener(this.__hm,this);
this.__gV=qx.lang.Function.listener(this.__hn,this);
this.__hb=qx.lang.Function.listener(this.__hi,this);
this.__hc=qx.lang.Function.listener(this.__hj,this);
qx.bom.Event.addNativeListener(this._document,i,this.__gU,true);
...
},_applyActive:function(cf,cg){if(cg){this.__gA(cg,cf,v,true);
}
if(cf){this.__gA(cf,cg,m,true);
}},_applyFocus:function(ch,ci){if(ci){this.__gA(ci,ch,a,true);
}
if(ch){this.__gA(ch,ci,b,true);
}if(ci){this.__gA(ci,ch,g,false);
}
if(ch){this.__gA(ch,ci,f,false);
}}},destruct:function(){this._stopObserver();
...
this._initObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{orientationchange:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__fK:null,__cy:null,__hw:null,__hx:null,__hy:null,canHandleEvent:function(g,h){},registerEvent:function(i,j,k){},unregisterEvent:function(l,m,n){},_initObserver:function(){this.__hy=qx.lang.Function.listener(this._onNative,this);
this.__hw=qx.bom.Event.supportsEvent(this.__cy,e)?e:d;
var Event=qx.bom.Event;
Event.addNativeListener(this.__cy,this.__hw,this.__hy);
},_stopObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__cy,this.__hw,this.__hy);
...
this.__fK=this.__cy=null;
},defer:function(s){qx.event.Registration.addHandler(s);
}});
})();
(function(){var c="landscape",b="qx.event.type.Orientation",a="portrait";
qx.Class.define(b,{extend:qx.event.type.Event,members:{__hz:null,__hA:null,init:function(d,e){qx.event.type.Event.prototype.init.call(this,false,false);
this.__hz=d;
this.__hA=e;
return this;
...
},isLandscape:function(){return this.__hA==c;
},isPortrait:function(){return this.__hA==a;
}}});
})();
...
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{touchstart:1,touchmove:1,touchend:1,touchcancel:1,tap:1,swipe:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT,IGNORE_CAN_HANDLE:true,MOUSE_TO_TOUCH_MAPPING:{"mousedown":"touchstart","mousemove":"touchmove","mouseup":"touchend"},SWIPE_DIRECTION:{x:["left","right"],y:["up","down"]},TAP_MAX_DISTANCE:qx.core.Environment.get("os.name")!="android"?10:40,SWIPE_MIN_DISTANCE:qx.core.Environment.get("os.name")!="android"?11:41,SWIPE_MIN_VELOCITY:0},members:{__hB:null,__hC:null,__fK:null,__cy:null,__ei:null,__hD:null,__hE:null,__hF:null,__hG:null,__hH:false,__hI:null,canHandleEvent:function(v,w){},registerEvent:function(x,y,z){},unregisterEvent:function(A,B,C){},__hJ:function(D){var E=qx.bom.Event.getTarget(D);
if((qx.core.Environment.get(n)==g)){if(E&&E.nodeType==3){E=E.parentNode;
}}return E;
},__gA:function(F,G,H,I){if(!H){H=this.__hJ(F);
}var G=G||F.type;
...
},__hK:function(J,K,L){if(!L){L=this.__hJ(J);
}var K=K||J.type;

if(K==r){this.__hL(J,L);
}else if(K==q){this.__hM(J,L);
}else if(K==s){this.__hN(J,L);
}},__hL:function(M,N){var O=M.changedTouches[0];
this.__hD=O.screenX;
this.__hE=O.screenY;
this.__hF=new Date().getTime();
this.__hG=M.changedTouches.length===1;
},__hM:function(P,Q){if(this.__hG&&P.changedTouches.length>1){this.__hG=false;
}},__hN:function(R,S){if(this.__hG){var T=R.changedTouches[0];
var V={x:T.screenX-this.__hD,y:T.screenY-this.__hE};
var W=qx.event.handler.Touch;

if(this.__hI==S&&Math.abs(V.x)<=W.TAP_MAX_DISTANCE&&Math.abs(V.y)<=W.TAP_MAX_DISTANCE){this.__gA(R,f,S,qx.event.type.Tap);
}else{var U=this.__hO(R,S,V);

if(U){R.swipe=U;
this.__gA(R,c,S,qx.event.type.Swipe);
}}}},__hO:function(X,Y,ba){var be=qx.event.handler.Touch;
var bf=new Date().getTime()-this.__hF;
...
if(Math.abs(bg)>=be.SWIPE_MIN_VELOCITY&&Math.abs(bb)>=be.SWIPE_MIN_DISTANCE){bd={startTime:this.__hF,duration:bf,axis:bh,direction:bc,distance:bb,velocity:bg};
}return bd;
},__hP:qx.core.Environment.select(t,{"true":function(bi){var bj=bi.type;
var bl=qx.event.handler.Touch.MOUSE_TO_TOUCH_MAPPING;

if(bl[bj]){bj=bl[bj];
if(bj==r&&this.__hQ(bi)){this.__hH=true;
}else if(bj==s){this.__hH=false;
}var bm=this.__hR(bi);
var bk=(bj==s?[]:[bm]);
bi.touches=bk;
bi.targetTouches=bk;
...
},"default":qx.lang.Function.empty}),__hQ:qx.core.Environment.select(t,{"true":function(bn){if((qx.core.Environment.get(n)==d)){var bo=1;
}else{var bo=0;
}return bn.button==bo;
},"default":qx.lang.Function.empty}),__hR:qx.core.Environment.select(t,{"true":function(bp){var bq=this.__hJ(bp);
...
},"default":qx.lang.Function.empty}),_initTouchObserver:function(){this.__hB=qx.lang.Function.listener(this._onTouchEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__ei,r,this.__hB);
Event.addNativeListener(this.__ei,q,this.__hB);
Event.addNativeListener(this.__ei,s,this.__hB);
Event.addNativeListener(this.__ei,m,this.__hB);
},_initMouseObserver:qx.core.Environment.select(t,{"true":function(){if(!qx.core.Environment.get(p)){this.__hC=qx.lang.Function.listener(this._onMouseEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__ei,k,this.__hC);
Event.addNativeListener(this.__ei,o,this.__hC);
Event.addNativeListener(this.__ei,l,this.__hC);
}},"default":qx.lang.Function.empty}),_stopTouchObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__ei,r,this.__hB);
Event.removeNativeListener(this.__ei,q,this.__hB);
Event.removeNativeListener(this.__ei,s,this.__hB);
Event.removeNativeListener(this.__ei,m,this.__hB);
},_stopMouseObserver:qx.core.Environment.select(t,{"true":function(){if(!qx.core.Environment.get(p)){var Event=qx.bom.Event;
Event.removeNativeListener(this.__ei,k,this.__hC);
Event.removeNativeListener(this.__ei,o,this.__hC);
Event.removeNativeListener(this.__ei,l,this.__hC);
...
}),_onMouseEvent:qx.core.Environment.select(t,{"true":qx.event.GlobalError.observeMethod(function(bs){if(!qx.core.Environment.get(p)){if(bs.type==o&&!this.__hH){return;
}var bt=this.__hP(bs);
...
if(bv==r){this.__hI=this.__hJ(bu);
}this.__gA(bu,bv);
this.__hK(bu,bv);
}},destruct:function(){this._stopTouchObserver();
this._stopMouseObserver();
this.__fK=this.__cy=this.__ei=this.__hI=null;
...
},getDocumentLeft:function(f){return this.__hS(f).pageX;
},getDocumentTop:function(g){return this.__hS(g).pageY;
},getScreenLeft:function(h){return this.__hS(h).screenX;
},getScreenTop:function(j){return this.__hS(j).screenY;
},getViewportLeft:function(k){return this.__hS(k).clientX;
},getViewportTop:function(l){return this.__hS(l).clientY;
},getIdentifier:function(m){return this.__hS(m).identifier;
},__hS:function(n){n=n==null?0:n;
return this.__hT()[n];
},__hT:function(){var o=(this._isTouchEnd()?this.getChangedTargetTouches():this.getTargetTouches());
return o;
...
this.__fK=E;
this.__ei=E.getWindow().document.documentElement;
this.__fK.addListener(this.__ei,x,this._onMouseDown,this);
this.__if();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1},IGNORE_CAN_HANDLE:true},members:{__fK:null,__ei:null,__hU:null,__hV:null,__hW:null,__hX:null,__hY:null,__c:null,__ia:null,__ib:null,__ic:false,__id:0,__ie:0,canHandleEvent:function(F,G){},registerEvent:function(H,I,J){},unregisterEvent:function(K,L,M){},addType:function(N){this.__hW[N]=true;
},addAction:function(O){this.__hX[O]=true;
},supportsType:function(P){return !!this.__hW[P];
},supportsAction:function(Q){return !!this.__hX[Q];
},getData:function(R){if(!this.__il||!this.__hU){throw new Error("This method must not be used outside the drop event listener!");
}
if(!this.__hW[R]){throw new Error("Unsupported data type: "+R+"!");
}
if(!this.__c[R]){this.__ia=R;
this.__gA(q,this.__hV,this.__hU,false);
}
...
},getCurrentAction:function(){return this.__ib;
},addData:function(S,T){this.__c[S]=T;
},getCurrentType:function(){return this.__ia;
},isSessionActive:function(){return this.__ic;
},__if:function(){this.__hW={};
this.__hX={};
this.__hY={};
this.__c={};
},__ig:function(){if(this.__hV==null){return;
}var W=this.__hX;
var U=this.__hY;
var V=null;

if(this.__il){if(U.Shift&&U.Control&&W.alias){V=k;
...
if(V!=this.__ib){this.__ib=V;
this.__gA(o,this.__hV,this.__hU,false);
}},__gA:function(X,Y,ba,bb,bc){var be=qx.event.Registration;
var bd=be.createEvent(X,qx.event.type.Drag,[bb,bc]);

if(Y!==ba){bd.setRelatedTarget(ba);
}return be.dispatchEvent(Y,bd);
},__ih:function(bf){while(bf&&bf.nodeType==1){if(bf.getAttribute(w)==y){return bf;
}bf=bf.parentNode;
}return null;
},__ii:function(bg){while(bg&&bg.nodeType==1){if(bg.getAttribute(s)==y){return bg;
}bg=bg.parentNode;
}return null;
},__ij:function(){this.__hV=null;
this.__fK.removeListener(this.__ei,c,this._onMouseMove,this,true);
this.__fK.removeListener(this.__ei,B,this._onMouseUp,this,true);
qx.event.Registration.removeListener(window,i,this._onWindowBlur,this);
this.__if();
},__ik:function(){if(this.__ic){this.__fK.removeListener(this.__ei,a,this._onMouseOver,this,true);
this.__fK.removeListener(this.__ei,h,this._onMouseOut,this,true);
this.__fK.removeListener(this.__ei,g,this._onKeyDown,this,true);
this.__fK.removeListener(this.__ei,C,this._onKeyUp,this,true);
this.__fK.removeListener(this.__ei,A,this._onKeyPress,this,true);
this.__gA(z,this.__hV,this.__hU,false);
this.__ic=false;
}this.__il=false;
this.__hU=null;
this.__ij();
},__il:false,_onWindowBlur:function(e){this.__ik();
},_onKeyDown:function(e){var bh=e.getKeyIdentifier();

switch(bh){case D:case f:case d:if(!this.__hY[bh]){this.__hY[bh]=true;
this.__ig();
}}},_onKeyUp:function(e){var bi=e.getKeyIdentifier();

switch(bi){case D:case f:case d:if(this.__hY[bi]){this.__hY[bi]=false;
this.__ig();
}}},_onKeyPress:function(e){var bj=e.getKeyIdentifier();

switch(bj){case v:this.__ik();
}},_onMouseDown:function(e){if(this.__ic||e.getButton()!==t){return;
}var bk=this.__ih(e.getTarget());

if(bk){this.__id=e.getDocumentLeft();
this.__ie=e.getDocumentTop();
this.__hV=bk;
this.__fK.addListener(this.__ei,c,this._onMouseMove,this,true);
this.__fK.addListener(this.__ei,B,this._onMouseUp,this,true);
qx.event.Registration.addListener(window,i,this._onWindowBlur,this);
}},_onMouseUp:function(e){if(this.__il){this.__gA(r,this.__hU,this.__hV,false,e);
}if(this.__ic){e.stopPropagation();
}this.__ik();
},_onMouseMove:function(e){if(this.__ic){if(!this.__gA(u,this.__hV,this.__hU,true,e)){this.__ik();
}}else{if(Math.abs(e.getDocumentLeft()-this.__id)>3||Math.abs(e.getDocumentTop()-this.__ie)>3){if(this.__gA(n,this.__hV,this.__hU,true,e)){this.__ic=true;
this.__fK.addListener(this.__ei,a,this._onMouseOver,this,true);
this.__fK.addListener(this.__ei,h,this._onMouseOut,this,true);
this.__fK.addListener(this.__ei,g,this._onKeyDown,this,true);
this.__fK.addListener(this.__ei,C,this._onKeyUp,this,true);
this.__fK.addListener(this.__ei,A,this._onKeyPress,this,true);
var bl=this.__hY;
bl.Control=e.isCtrlPressed();
bl.Shift=e.isShiftPressed();
bl.Alt=e.isAltPressed();
this.__ig();
}else{this.__gA(z,this.__hV,this.__hU,false);
this.__ij();
}}}},_onMouseOver:function(e){var bm=e.getTarget();
var bn=this.__ii(bm);

if(bn&&bn!=this.__hU){this.__il=this.__gA(m,bn,this.__hV,true,e);
this.__hU=bn;
this.__ig();
}},_onMouseOut:function(e){var bp=this.__ii(e.getTarget());
var bo=this.__ii(e.getRelatedTarget());

if(bp&&bp!==bo&&bp==this.__hU){this.__gA(l,this.__hU,bo,false,e);
this.__hU=null;
this.__il=false;
qx.event.Timer.once(this.__ig,this,0);
}}},destruct:function(){this.__hV=this.__hU=this.__fK=this.__ei=this.__hW=this.__hX=this.__hY=this.__c=null;
...
this._initObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{online:true,offline:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__fK:null,__cy:null,__hy:null,canHandleEvent:function(e,f){},registerEvent:function(g,h,i){},unregisterEvent:function(j,k,l){},_initObserver:function(){this.__hy=qx.lang.Function.listener(this._onNative,this);
qx.bom.Event.addNativeListener(this.__cy,c,this.__hy);
qx.bom.Event.addNativeListener(this.__cy,b,this.__hy);
},_stopObserver:function(){qx.bom.Event.removeNativeListener(this.__cy,c,this.__hy);
qx.bom.Event.removeNativeListener(this.__cy,b,this.__hy);
...
qx.Class.define(f,{statics:{__im:{"onload":true,"onpropertychange":true,"oninput":true,"onchange":true,"name":true,"type":true,"checked":true,"disabled":true},__in:{},__io:{},allowCreationWithMarkup:function(s){if(!s){s=window;
}var t=s.location.href;

if(qx.bom.Element.__io[t]==undefined){try{s.document.createElement(g);
qx.bom.Element.__io[t]=true;
}catch(e){qx.bom.Element.__io[t]=false;
}}return qx.bom.Element.__io[t];
},getHelperElement:function(u){if(!u){u=window;
}var w=u.location.href;

if(!qx.bom.Element.__in[w]){var v=qx.bom.Element.__in[w]=u.document.createElement(c);
if(qx.core.Environment.get(r)==b){v.style.display=h;
u.document.body.appendChild(v);
}}return qx.bom.Element.__in[w];
...
},statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST},members:{__cA:null,__iq:null,__ir:true,__cy:null,_getParent:function(l){return l.parentNode;
},canDispatchEvent:function(m,event,n){return !!(this.__iq&&this.__is[n]);
},dispatchEvent:function(o,event,p){if(p==d){event.stopPropagation();
this.releaseCapture();
return;
}
if(this.__ir||!qx.dom.Hierarchy.contains(this.__iq,o)){o=this.__iq;
}qx.event.dispatch.AbstractBubbling.prototype.dispatchEvent.call(this,o,event,p);
},__is:{"mouseup":1,"mousedown":1,"click":1,"dblclick":1,"mousemove":1,"mouseout":1,"mouseover":1},activateCapture:function(q,r){var r=r!==false;

if(this.__iq===q&&this.__ir==r){return;
}
if(this.__iq){this.releaseCapture();
...
},getCaptureElement:function(){return this.__iq;
},releaseCapture:function(){var s=this.__iq;
...
},"default":qx.lang.Function.empty})},destruct:function(){this.__iq=this.__cy=this.__cA=null;
...
qx.Class.define(B,{statics:{__it:function(F,G){return qx.bom.element.Style.get(F,G,qx.bom.element.Style.COMPUTED_MODE,false);
},__iu:function(H,I){return parseInt(qx.bom.element.Style.get(H,I,qx.bom.element.Style.COMPUTED_MODE,false),10)||0;
},__iv:function(J){var M=0,top=0;
...
},__iw:qx.core.Environment.select(h,{"mshtml":function(N){var P=qx.dom.Node.getDocument(N);
var O=P.body;
var Q=0;
var top=0;
...
if(!qx.core.Environment.get(C)){Q+=this.__iu(O,i);
top+=this.__iu(O,j);
...
var U=S.offsetLeft;
var top=S.offsetTop;
if(parseFloat(qx.core.Environment.get(f))<530.17){U+=this.__iu(S,i);
top+=this.__iu(S,j);
}return {left:U,top:top};
},"gecko":function(V){var W=qx.dom.Node.getDocument(V).body;
var X=W.offsetLeft;
var top=W.offsetTop;
if(parseFloat(qx.core.Environment.get(f))<1.9){X+=this.__iu(W,d);
top+=this.__iu(W,e);
}if(qx.bom.element.BoxSizing.get(W)!==c){X+=this.__iu(W,i);
top+=this.__iu(W,j);
...
}}),__ix:qx.core.Environment.select(h,{"mshtml|webkit":function(bc){var be=qx.dom.Node.getDocument(bc);
...
if(bj.get(bh)!==c){bl-=this.__iu(bh,i);
top-=this.__iu(bh,j);
}
...
if(bj.get(bh)!==c){bl+=this.__iu(bh,i);
top+=this.__iu(bh,j);
}if(bh.parentNode&&this.__it(bh.parentNode,l)!=x){bl+=this.__iu(bh.parentNode,i);
top+=this.__iu(bh.parentNode,j);
}bh=bh.offsetParent;
...
}}),get:function(bp,bq){if(bp.tagName==w){var location=this.__iy(bp);
var bx=location.left;
var top=location.top;
}else{var br=this.__iw(bp);
var bw=this.__ix(bp);
var scroll=this.__iv(bp);
...
if(bu==g||bu==E){bs+=bp.scrollWidth-bp.offsetWidth+this.__iu(bp,i)+this.__iu(bp,a);
}var bv=qx.bom.element.Overflow.getY(bp);

if(bv==g||bv==E){bt+=bp.scrollHeight-bp.offsetHeight+this.__iu(bp,j)+this.__iu(bp,b);
}}
switch(bq){case D:bx+=this.__iu(bp,A);
top+=this.__iu(bp,r);
bs-=this.__iu(bp,s);
bt-=this.__iu(bp,q);
...
bs-=bp.scrollLeft;
bt-=bp.scrollTop;
case u:bx+=this.__iu(bp,i);
top+=this.__iu(bp,j);
bs-=this.__iu(bp,a);
bt-=this.__iu(bp,b);
break;
case k:bx-=this.__iu(bp,d);
top-=this.__iu(bp,e);
bs+=this.__iu(bp,p);
bt+=this.__iu(bp,y);
break;
}}return {left:bx,top:top,right:bs,bottom:bt};
},__iy:function(by){var top=by.offsetTop;
var bz=by.offsetLeft;

if(qx.core.Environment.get(h)!==m||!((parseFloat(qx.core.Environment.get(f))<8||qx.core.Environment.get(t)<8)&&!qx.core.Environment.get(C))){top+=this.__iu(by,e);
bz+=this.__iu(by,d);
}
if(qx.core.Environment.get(h)===o){top+=this.__iu(by,i);
bz+=this.__iu(by,j);
...
},members:{__cq:null,__iz:null,getId:function(){return this.__cq;
},getDecorator:function(){return this.__iz;
},resize:function(h,i){this.__iz.resize(this.getDomElement(),h,i);
},tint:function(j){this.__iz.tint(this.getDomElement(),j);
},getInsets:function(){return this.__iz.getInsets();
}},destruct:function(){this.__iz=null;
}});
})();
...
if(E!=null&&E!==this.__iA){this.__iA=E;
...
G.width=B;
G.height=C;
}if(this.__iC){F.local=true;
delete this.__iC;
}
if(this.__iE){F.margin=true;
delete this.__iE;
}return F;
},isExcluded:function(){return false;
},hasValidLayout:function(){return !this.__iC;
},scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);
},invalidateLayoutCache:function(){this.__iC=true;
this.__iD=null;
},getSizeHint:function(H){var I=this.__iD;

if(I){return I;
}
if(H===false){return null;
}I=this.__iD=this._computeSizeHint();
if(this._hasHeightForWidth()&&this.__iA&&this.getHeight()==null){I.height=this.__iA;
...
},_applyMargin:function(){this.__iE=true;
...
},hasUserBounds:function(){return !!this.__iF;
},setUserBounds:function(S,top,T,U){this.__iF={left:S,top:top,width:T,height:U};
qx.ui.core.queue.Layout.add(this);
},resetUserBounds:function(){delete this.__iF;
qx.ui.core.queue.Layout.add(this);
},__iH:{},setLayoutProperties:function(V){if(V==null){return;
}var W=this.__iG;
...
}}},getLayoutProperties:function(){return this.__iG||this.__iH;
},clearLayoutProperties:function(){delete this.__iG;
...
if(bd){bc.__iG=qx.lang.Object.clone(bd);
}return bc;
}},destruct:function(){this.$$parent=this.$$subparent=this.__iG=this.__iB=this.__iF=this.__iD=null;
}});
})();
(function(){var b="qx.ui.core.queue.Layout",a="layout";
qx.Class.define(b,{statics:{__eI:{},remove:function(c){delete this.__eI[c.$$hash];
},add:function(d){this.__eI[d.$$hash]=d;
qx.ui.core.queue.Manager.scheduleFlush(a);
},isScheduled:function(e){return !!this.__eI[e.$$hash];
...
}}},getNestingLevel:function(k){var l=this.__iJ;
var n=0;
var parent=k;
...
},__iI:function(){var t=qx.ui.core.queue.Visibility;
this.__iJ={};
var s=[];
var r=this.__eI;
var o,q;
...
qx.Class.define(b,{statics:{__iL:false,__iM:{},__iN:0,MAX_RETRIES:10,scheduleFlush:function(i){var self=qx.ui.core.queue.Manager;
self.__iM[i]=true;

if(!self.__iL){self.__gs.schedule();
self.__iL=true;
...
self.__gs.cancel();
var j=self.__iM;
self.__iP(function(){while(j.visibility||j.widget||j.appearance||j.layout||j.element){if(j.widget){delete j.widget;
...
}}},function(){self.__iL=false;
});
self.__iP(function(){if(j.dispose){delete j.dispose;
{qx.ui.core.queue.Dispose.flush();
};
}},function(){self.__iO=false;
});
self.__iN=0;
},__iP:function(k,l){var self=qx.ui.core.queue.Manager;

try{k();
}catch(e){self.__iL=false;
self.__iO=false;
self.__iN+=1;
if(qx.core.Environment.get(a)==f&&qx.core.Environment.get(d)<=7){l();
}
if(self.__iN<=self.MAX_RETRIES){self.scheduleFlush();
}else{throw new Error("Fatal Error: Flush terminated "+(self.__iN-1)+" times in a row"+" due to exceptions in user code. The application has to be reloaded!");
}throw e;
}finally{l();
}},__iQ:function(e){var m=qx.ui.core.queue.Manager;
if(e.getData()==g){m.PAUSE=true;

if(m.__iR){window.clearTimeout(m.__iR);
}m.__iR=window.setTimeout(function(){m.PAUSE=false;
m.__iR=null;
m.flush();
},500);
}else{m.flush();
}}},defer:function(n){n.__gs=new qx.util.DeferredCall(n.flush);
qx.html.Element._scheduleFlush=n.scheduleFlush;
qx.event.Registration.addListener(window,h,qx.core.Environment.get(c)?n.__iQ:n.flush);
}});
})();
(function(){var b="qx.ui.core.queue.Widget",a="widget";
qx.Class.define(b,{statics:{__eI:[],remove:function(c){qx.lang.Array.remove(this.__eI,c);
},add:function(d){var e=this.__eI;

if(qx.lang.Array.contains(e,d)){return;
}e.unshift(d);
qx.ui.core.queue.Manager.scheduleFlush(a);
},flush:function(){var f=this.__eI;
var g;
...
qx.Class.define(b,{statics:{__eI:[],__cP:{},remove:function(c){delete this.__cP[c.$$hash];
qx.lang.Array.remove(this.__eI,c);
},isVisible:function(d){return this.__cP[d.$$hash]||false;
},__iS:function(e){var g=this.__cP;
var f=e.$$hash;
var h;
if(e.isExcluded()){h=false;
}else{var parent=e.$$parent;

if(parent){h=this.__iS(parent);
}else{h=e.isRootWidget();
}}return g[f]=h;
},add:function(j){var k=this.__eI;

if(qx.lang.Array.contains(k,j)){return;
}k.unshift(j);
qx.ui.core.queue.Manager.scheduleFlush(a);
},flush:function(){var o=this.__eI;
var p=this.__cP;
...
var n=m.$$hash;
o.splice(i,1);
if(p[n]==null){this.__iS(m);
}if(p[n]&&p[n]!=l[n]){m.checkAppearanceNeeds();
}}this.__eI=[];
}}});
})();
(function(){var b="appearance",a="qx.ui.core.queue.Appearance";
qx.Class.define(a,{statics:{__eI:[],remove:function(c){qx.lang.Array.remove(this.__eI,c);
},add:function(d){var e=this.__eI;

if(qx.lang.Array.contains(e,d)){return;
}e.unshift(d);
qx.ui.core.queue.Manager.scheduleFlush(b);
},has:function(f){return qx.lang.Array.contains(this.__eI,f);
...
qx.Class.define(a,{statics:{__eI:[],add:function(c){var d=this.__eI;

if(qx.lang.Array.contains(d,c)){return;
}d.unshift(c);
qx.ui.core.queue.Manager.scheduleFlush(b);
},isEmpty:function(){return this.__eI.length==0;
},flush:function(){var e=this.__eI;
...
(function(){var bY="px",bX="Boolean",bW="qx.event.type.Drag",bV="qx.event.type.Mouse",bU="visible",bT="qx.event.type.Focus",bS="Integer",bR="qx.event.type.Touch",bQ="qx.event.type.Data",bP="excluded",bx="_applyPadding",bw="qx.event.type.Event",bv="on",bu="hidden",bt="engine.name",bs="contextmenu",br="String",bq="tabIndex",bp="focused",bo="changeVisibility",cg="mshtml",ch="hovered",ce="qx.event.type.KeySequence",cf="absolute",cc="backgroundColor",cd="drag",ca="div",cb="disabled",ci="move",cj="dragstart",bI="qx.dynlocale",bH="dragchange",bK="dragend",bJ="resize",bM="Decorator",bL="zIndex",bO="opacity",bN="default",bG="Color",bF="changeToolTipText",c="beforeContextmenuOpen",d="_applyNativeContextMenu",f="_applyBackgroundColor",g="event.pointer",h="_applyFocusable",j="changeShadow",k="qx.event.type.KeyInput",m="createChildControl",n="Font",o="_applyShadow",cn="_applyEnabled",cm="_applySelectable",cl="Number",ck="_applyKeepActive",cr="__iY",cq="_applyVisibility",cp="repeat",co="qxDraggable",ct="syncAppearance",cs="paddingLeft",N="_applyDroppable",O="#",L="__iX",M="qx.event.type.MouseWheel",R="__jh",S="_applyCursor",P="_applyDraggable",Q="changeTextColor",J="$$widget",K="changeContextMenu",w="paddingTop",v="changeSelectable",y="hideFocus",x="none",s="__ja",r="outline",u="_applyAppearance",t="_applyOpacity",q="url(",p=")",X="qx.ui.core.Widget",Y="_applyFont",ba="cursor",bb="qxDroppable",T="__jf",U="changeZIndex",V="changeEnabled",W="changeFont",bc="_applyDecorator",bd="_applyZIndex",G="_applyTextColor",F="qx.ui.menu.Menu",E="__iU",D="_applyToolTipText",C="__iT",B="true",A="widget",z="changeDecorator",I="_applyTabIndex",H="changeAppearance",be="__jd",bf="shorthand",bg="/",bh="",bi="_applyContextMenu",bj="paddingBottom",bk="changeNativeContextMenu",bl="undefined",bm="qx.ui.tooltip.ToolTip",bn="qxKeepActive",bB="_applyKeepFocus",bA="paddingRight",bz="changeBackgroundColor",by="changeLocale",bE="qxKeepFocus",bD="opera",bC="qx/static/blank.gif";
...
},__iV:new qx.ui.core.DecoratorFactory(),__iW:new qx.ui.core.DecoratorFactory()},members:{__iT:null,__iU:null,__iX:null,__iY:null,__ja:null,__jb:null,__jc:null,__jd:null,_getLayout:function(){return this.__jd;
},_setLayout:function(cz){if(this.__jd){this.__jd.connectToWidget(null);
}
...
qx.ui.core.queue.Visibility.add(this);
},_updateInsets:null,__je:function(a,b){if(a==b){return false;
}
...
if(cP.size){var cO=this.__ja;

if(cO){cO.setStyles({width:cF+bY,height:cG+bY});
}}
if(cP.size||this._updateInsets){if(this.__iX){this.__iX.resize(cF,cG);
}}
if(cP.size){if(this.__iY){var cH=this.__iY.getInsets();
var cL=cF+cH.left+cH.right;
var cJ=cG+cH.top+cH.bottom;
this.__iY.resize(cL,cJ);
}}
if(cM||cP.local||cP.margin){if(this.__jd&&this.hasLayoutChildren()){this.__jd.renderLayout(innerWidth,innerHeight);
...
return cP;
},__jf:null,clearSeparators:function(){var cS=this.__jf;

if(!cS){return;
}var cT=qx.ui.core.Widget.__iV;
var content=this.getContentElement();
var cR;
...
},renderSeparator:function(cU,cV){var cW=qx.ui.core.Widget.__iV.getDecoratorElement(cU);
this.getContentElement().add(cW);
cW.resize(cV.width,cV.height);
cW.setStyles({left:cV.left+bY,top:cV.top+bY});
if(!this.__jf){this.__jf=[cW];
}else{this.__jf.push(cW);
...
if(this.__jd){this.__jd.invalidateLayoutCache();
}},_getContentHint:function(){var dj=this.__jd;
...
if(this.__iX){var dv=this.__iX.getInsets();
top+=dv.top;
dw+=dv.right;
dy+=dv.bottom;
dx+=dv.left;
...
},__jg:function(){var dE=this._createContentElement();
dE.setStyles({"position":cf,"zIndex":10});
return dE;
},_createContentElement:function(){return new qx.html.Element(ca,{overflowX:bu,overflowY:bu});
},getContainerElement:function(){return this.__iT;
},getContentElement:function(){return this.__iU;
},getDecoratorElement:function(){return this.__iX||null;
},getShadowElement:function(){return this.__iY||null;
},__jh:null,getLayoutChildren:function(){var dG=this.__jh;

if(!dG){return this.__ji;
}var dH;
...
},invalidateLayoutChildren:function(){var dI=this.__jd;

if(dI){dI.invalidateChildrenCache();
}qx.ui.core.queue.Layout.add(this);
},hasLayoutChildren:function(){var dJ=this.__jh;
...
},__ji:[],_getChildren:function(){return this.__jh||this.__ji;
},_indexOf:function(dL){var dM=this.__jh;

if(!dM){return -1;
}return dM.indexOf(dL);
},_hasChildren:function(){var dN=this.__jh;
return dN!=null&&(!!dN[0]);
},addChildrenToQueue:function(dO){var dP=this.__jh;
...
}},_add:function(dR,dS){if(dR.getLayoutParent()==this){qx.lang.Array.remove(this.__jh,dR);
}
if(this.__jh){this.__jh.push(dR);
}else{this.__jh=[dR];
}this.__jj(dR,dS);
},_addAt:function(dT,dU,dV){if(!this.__jh){this.__jh=[];
}if(dT.getLayoutParent()==this){qx.lang.Array.remove(this.__jh,dT);
}var dW=this.__jh[dU];

if(dW===dT){dT.setLayoutProperties(dV);
}
if(dW){qx.lang.Array.insertBefore(this.__jh,dT,dW);
}else{this.__jh.push(dT);
}this.__jj(dT,dV);
},_addBefore:function(dX,dY,ea){if(dX==dY){return;
}
if(!this.__jh){this.__jh=[];
}if(dX.getLayoutParent()==this){qx.lang.Array.remove(this.__jh,dX);
}qx.lang.Array.insertBefore(this.__jh,dX,dY);
this.__jj(dX,ea);
},_addAfter:function(eb,ec,ed){if(eb==ec){return;
}
if(!this.__jh){this.__jh=[];
}if(eb.getLayoutParent()==this){qx.lang.Array.remove(this.__jh,eb);
}qx.lang.Array.insertAfter(this.__jh,eb,ec);
this.__jj(eb,ed);
},_remove:function(ee){if(!this.__jh){throw new Error("This widget has no children!");
}qx.lang.Array.remove(this.__jh,ee);
this.__jk(ee);
},_removeAt:function(ef){if(!this.__jh){throw new Error("This widget has no children!");
}var eg=this.__jh[ef];
qx.lang.Array.removeAt(this.__jh,ef);
this.__jk(eg);
return eg;
},_removeAll:function(){if(!this.__jh){return [];
}var eh=this.__jh.concat();
this.__jh.length=0;

for(var i=eh.length-1;i>=0;i--){this.__jk(eh[i]);
}qx.ui.core.queue.Layout.add(this);
return eh;
},_afterAddChild:null,_afterRemoveChild:null,__jj:function(ei,ej){var parent=ei.getLayoutParent();
...
}},__jk:function(ek){if(ek.getLayoutParent()!==this){throw new Error("Remove Error: "+ek+" is not a child of this widget!");
}ek.setLayoutParent(null);
if(this.__jd){this.__jd.invalidateChildrenCache();
}qx.ui.core.queue.Layout.add(this);
...
qx.ui.core.queue.Layout.add(this);
},_createProtectorElement:function(){if(this.__ja){return;
}var ep=this.__ja=new qx.html.Element;
ep.setStyles({position:cf,top:0,left:0,zIndex:7});
var eq=this.getBounds();

if(eq){this.__ja.setStyles({width:eq.width+bY,height:eq.height+bY});
}if((qx.core.Environment.get(bt)==cg)){ep.setStyles({backgroundImage:q+qx.util.ResourceManager.getInstance().toUri(bC)+p,backgroundRepeat:cp});
}this.getContainerElement().add(ep);
},_applyDecorator:function(er,es){var ev=qx.ui.core.Widget.__iV;
var et=this.getContainerElement();
if(!this.__ja&&!qx.core.Environment.get(g)){this._createProtectorElement();
}if(es){et.remove(this.__iX);
ev.poolDecorator(this.__iX);
}if(er){var eu=this.__iX=ev.getDecoratorElement(er);
eu.setStyle(bL,5);
et.add(eu);
}else{delete this.__iX;
}this._applyBackgroundColor(this.getBackgroundColor());
if(this.__je(es,er)){this._updateInsets=true;
qx.ui.core.queue.Layout.add(this);
}else if(er){var ew=this.getBounds();

if(ew){eu.resize(ew.width,ew.height);
this.__ja&&this.__ja.setStyles({width:ew.width+bY,height:ew.height+bY});
}}},_applyShadow:function(ex,ey){var eF=qx.ui.core.Widget.__iW;
var eA=this.getContainerElement();
if(ey){eA.remove(this.__iY);
eF.poolDecorator(this.__iY);
}if(ex){var eC=this.__iY=eF.getDecoratorElement(ex);
eA.add(eC);
var eE=eC.getInsets();
...
}},_applyToolTipText:function(eG,eH){if(qx.core.Environment.get(bI)){if(this.__jc){return;
}var eI=qx.locale.Manager.getInstance();
this.__jc=eI.addListener(by,function(){var eJ=this.getToolTipText();
...
if(this.__iX){this.__iX.tint(eY);
fb.setStyle(cc,null);
}else{var fa=qx.theme.manager.Color.getInstance().resolve(eY);
fb.setStyle(cc,fa);
}},_applyFont:function(fc,fd){},__jl:null,$$stateChanges:null,_forwardStates:null,hasState:function(fe){var ff=this.__jl;
return !!ff&&!!ff[fe];
},addState:function(fg){var fh=this.__jl;
...
}}}},removeState:function(fl){var fm=this.__jl;
...
}}}},replaceState:function(fq,fr){var fs=this.__jl;
...
}}}},__jm:null,__jn:null,syncAppearance:function(){var fA=this.__jl;
var fz=this.__jm;
...
fz=fE.reverse().join(bg).replace(/#[0-9]+/g,bh);
this.__jm=fz;
...
}}this.fireDataEvent(ct,this.__jl);
},_applyAppearance:function(fG,fH){this.updateAppearance();
},checkAppearanceNeeds:function(){if(!this.__jb){qx.ui.core.queue.Appearance.add(this);
this.__jb=true;
}else if(this.$$stateChanges){qx.ui.core.queue.Appearance.add(this);
delete this.$$stateChanges;
}},updateAppearance:function(){this.__jn=true;
...
if((qx.core.Environment.get(bt)==cg)){fP.setAttribute(y,B);
}else{fP.setStyle(r,x);
...
}this.getContainerElement().setAttribute(co,gf?bv:null);
...
},scrollChildIntoView:function(gl,gm,gn,go){go=typeof go==bl?true:go;
...
},hasChildControl:function(gx){if(!this.__jo){return false;
}return !!this.__jo[gx];
},__jo:null,_getCreatedChildControls:function(){return this.__jo;
},getChildControl:function(gy,gz){if(!this.__jo){if(gz){return null;
}this.__jo={};
}var gA=this.__jo[gy];
...
},_createChildControl:function(gH){if(!this.__jo){this.__jo={};
}else if(this.__jo[gH]){throw new Error("Child control '"+gH+"' already created!");
}var gL=gH.indexOf(O);
...
}}}this.fireDataEvent(m,gI);
return this.__jo[gH]=gI;
},_createChildControlImpl:function(gM,gN){return null;
},_disposeChildControls:function(){var gR=this.__jo;
...
}},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Environment.get(bI)){if(this.__jc){qx.locale.Manager.getInstance().removeListenerById(this.__jc);
...
if(this.__iX){hg.remove(this.__iX);
hh.__iV.poolDecorator(this.__iX);
}
if(this.__iY){hg.remove(this.__iY);
hh.__iW.poolDecorator(this.__iY);
}this.clearSeparators();
this.__iX=this.__iY=this.__jf=null;
}else{this._disposeArray(T);
this._disposeObjects(L,cr);
}this._disposeArray(R);
this.__jl=this.__jo=null;
this._disposeObjects(be,C,E,s);
}});
})();
(function(){var f="blur",e="focus",d="input",c="load",b="qx.ui.core.EventHandler",a="activate";
qx.Class.define(b,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(){qx.core.Object.call(this);
this.__fK=qx.event.Registration.getManager(window);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1,keyup:1,keydown:1,keypress:1,keyinput:1,capture:1,losecapture:1,focusin:1,focusout:1,focus:1,blur:1,activate:1,deactivate:1,appear:1,disappear:1,dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1,touchstart:1,touchend:1,touchmove:1,touchcancel:1,tap:1,swipe:1},IGNORE_CAN_HANDLE:false},members:{__fK:null,__jp:{focusin:1,focusout:1,focus:1,blur:1},__jq:{mouseover:1,mouseout:1,appear:1,disappear:1},canHandleEvent:function(g,h){return g instanceof qx.ui.core.Widget;
...
}if(this.__jp[j.getType()]){o=o&&o.getFocusTarget();
if(!o){return;
...
if(w){if(this.__jp[j.getType()]){w=w.getFocusTarget();
}if(w===o){return;
}}}var s=j.getCurrentTarget();
var u=qx.ui.core.Widget.getWidgetByElement(s);

if(!u||u.isAnonymous()){return;
}if(this.__jp[j.getType()]){u=u.getFocusTarget();
}var v=j.getType();

if(!u||!(u.isEnabled()||this.__jq[v])){return;
}var k=j.getEventPhase()==qx.event.type.Event.CAPTURING_PHASE;
var r=this.__fK.getListeners(u,v,k);
...
},members:{$$isString:true,length:0,__jr:null,toString:function(){return this.__jr;
...
this.__js=c;
this.__jt=d;
},members:{__js:null,__jt:null,translate:function(){return qx.locale.Manager.getInstance().translate(this.__js,this.__jt);
}}});
})();
...
this.__ju=qx.$$translations||{};
this.__jv=qx.$$locales||{};
var m=qx.core.Environment.get(j);
var n=qx.core.Environment.get(e);

if(n!==k){m+=l+n;
}this.__jw=m;
this.setLocale(m||this.__jx);
...
}},properties:{locale:{check:b,nullable:true,apply:h,event:g}},members:{__jx:f,__jy:null,__jz:null,__ju:null,__jv:null,__jw:null,getLanguage:function(){return this.__jz;
},getTerritory:function(){return this.getLocale().split(l)[1]||k;
},getAvailableLocales:function(B){var D=[];

for(var C in this.__jv){if(C!=this.__jx){if(this.__jv[C]===null&&!B){continue;
}D.push(C);
}}return D;
},__jA:function(E){var G;
...
},_applyLocale:function(H,I){this.__jy=H;
this.__jz=this.__jA(H);
},addTranslation:function(J,K){var L=this.__ju;

if(L[J]){for(var M in K){L[J][M]=K[M];
}}else{L[J]=K;
}},addLocale:function(N,O){var P=this.__jv;

if(P[N]){for(var Q in O){P[N][Q]=O[Q];
}}else{P[N]=O;
}},translate:function(R,S,T){var U=this.__ju;
return this.__jB(U,R,S,T);
},localize:function(V,W,X){var Y=this.__jv;
return this.__jB(Y,V,W,X);
},__jB:function(ba,bb,bc,bd){var be;

if(!ba){return bb;
}
if(bd){var bg=this.__jA(bd);
}else{bd=this.__jy;
bg=this.__jz;
}if(!be&&ba[bd]){be=ba[bd][bb];
}if(!be&&ba[bg]){be=ba[bg][bb];
}if(!be&&ba[this.__jx]){be=ba[this.__jx][bb];
}
if(!be){be=bb;
}
...
}},destruct:function(){this.__ju=this.__jv=null;
}});
})();
(function(){var f="-",e="",d="qx.bom.client.Locale",c="locale",b="android",a="locale.variant";
qx.Bootstrap.define(d,{statics:{getLocale:function(){var g=qx.bom.client.Locale.__jC();
var h=g.indexOf(f);

if(h!=-1){g=g.substr(0,h);
}return g;
},getVariant:function(){var i=qx.bom.client.Locale.__jC();
var k=e;
var j=i.indexOf(f);

if(j!=-1){k=i.substr(j+1);
}return k;
},__jC:function(){var l=(navigator.userLanguage||navigator.language||e);
...
qx.Class.define(r,{statics:{DEBUG:false,__jD:{},__jE:(qx.core.Environment.get(g)==b)&&qx.core.Environment.get(D)<9,__jF:qx.core.Environment.select(g,{"mshtml":{"scale-x":true,"scale-y":true,"scale":true,"no-repeat":true},"default":null}),__jG:{"scale-x":i,"scale-y":i,"scale":i,"repeat":j,"no-repeat":j,"repeat-x":j,"repeat-y":j},update:function(J,K,L,M){var O=this.getTagName(L,K);
...
}},getTagName:function(W,X){if(X&&this.__jE&&this.__jF[W]&&qx.lang.String.endsWith(X,F)){return j;
}return this.__jG[W];
...
}else{if(ba===c){bc=this.__jK(bb,ba,Y);
...
this.__jD[ci]=true;
}}},isAlphaImageLoaderEnabled:function(){return qx.bom.element.Decoration.__jE;
}}});
})();
(function(){var c="html.image.naturaldimensions",b="load",a="qx.io.ImageLoader";
qx.Bootstrap.define(a,{statics:{__cP:{},__jR:{width:null,height:null},__jS:/\.(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(d){var e=this.__cP[d];
return !!(e&&e.loaded);
...
return o?{width:o.width,height:o.height}:this.__jR;
...
var x=qx.lang.Function.listener(this.__jT,this,y,t);
y.onload=x;
y.onerror=x;
y.src=t;
w.element=y;
...
},__jT:qx.event.GlobalError.observeMethod(function(event,D,E){var F=this.__cP[E];
if(event.type===b){F.loaded=true;
F.width=this.__jU(D);
F.height=this.__jV(D);
var G=this.__jS.exec(E);
...
}}),__jU:function(I){return qx.core.Environment.get(c)?I.naturalWidth:I.width;
},__jV:function(J){return qx.core.Environment.get(c)?J.naturalHeight:J.height;
}}});
})();
...
qx.Class.define(g,{statics:{__jW:[n,null,m,i,null,r,k,null,r],__jX:{backgroundImage:null,backgroundPosition:null,backgroundRepeat:null},__jY:function(v,top){var w=qx.core.Environment.get(d);
...
},__ka:function(A){var String=qx.lang.String;
var B=A.substr(0,50);
return String.startsWith(B,c)&&String.contains(B,a);
},compile:function(C,D,E,top){var F=this.__jY(E,top);
var G=qx.util.ResourceManager.getInstance().toUri(C);

if(this.__ka(G)){G=q+G+q;
}var H=this.__jW;
H[1]=G;
H[4]=F;
H[7]=D;
return H.join(l);
},getStyles:function(I,J,K,top){if(!I){return this.__jX;
}var L=this.__jY(K,top);
var N=qx.util.ResourceManager.getInstance().toUri(I);
var O;

if(this.__ka(N)){O=j+N+p;
}else{O=f+N+e;
...
qx.Mixin.define(x,{statics:{__fW:null,__kb:f,setVisibleElement:function(A){this.__fW=A;
},getVisibleElement:function(){return this.__fW;
},setMoveDirection:function(B){if(B===o||B===f){this.__kb=B;
...
}},properties:{position:{check:[s,p,c,z,w,l,k,n],init:c,themeable:true},placeMethod:{check:[y,d],init:d,themeable:true},domMove:{check:a,init:false},placementModeX:{check:[b,h,e],init:h,themeable:true},placementModeY:{check:[b,h,e],init:h,themeable:true},offsetLeft:{check:j,init:0,themeable:true},offsetTop:{check:j,init:0,themeable:true},offsetRight:{check:j,init:0,themeable:true},offsetBottom:{check:j,init:0,themeable:true},offset:{group:[m,v,q,t],mode:u,themeable:true}},members:{__kc:null,__kd:null,__ke:null,getLayoutLocation:function(C){var F,E,G,top;
E=C.getBounds();
G=E.left;
top=E.top;
var H=E;
...
}},placeToWidget:function(P,Q){if(Q){this.__kf();
this.__kc=qx.lang.Function.bind(this.placeToWidget,this,P,false);
qx.event.Idle.getInstance().addListener(i,this.__kc);
this.__ke=function(){this.__kf();
};
this.addListener(g,this.__ke,this);
}var R=P.getContainerLocation()||this.getLayoutLocation(P);
this.__kh(R);
},__kf:function(){if(this.__kc){qx.event.Idle.getInstance().removeListener(i,this.__kc);
this.__kc=null;
}
if(this.__ke){this.removeListener(g,this.__ke,this);
this.__ke=null;
...
if(V){this.__kc=qx.lang.Function.bind(this.placeToElement,this,U,false);
qx.event.Idle.getInstance().addListener(i,this.__kc);
this.addListener(g,function(){if(this.__kc){qx.event.Idle.getInstance().removeListener(i,this.__kc);
this.__kc=null;
}},this);
}this.__kh(W);
...
},__kg:function(ba){var bb=null;

if(this._computePlacementSize){var bb=this._computePlacementSize();
}else if(this.isVisible()){var bb=this.getBounds();
}
if(bb==null){this.addListenerOnce(r,function(){this.__kg(ba);
},this);
}else{ba.call(this,bb);
}},__kh:function(bc){this.__kg(function(bd){var be=qx.util.placement.Placement.compute(bd,this.getLayoutParent().getBounds(),bc,this._getPlacementOffsets(),this.getPosition(),this.getPlacementModeX(),this.getPlacementModeY());
...
(function(){var o="top",n="right",m="bottom",l="left",k="align-start",j="qx.util.placement.AbstractAxis",i="edge-start",h="align-end",g="edge-end",f="-",c="best-fit",e="qx.util.placement.Placement",d="keep-align",b="direct",a='__kj';
qx.Class.define(e,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__kj=new qx.util.placement.DirectAxis();
},properties:{axisX:{check:j},axisY:{check:j},edge:{check:[o,n,m,l],init:o},align:{check:[o,n,m,l],init:n}},statics:{__kk:null,compute:function(p,q,r,s,t,u,v){this.__kk=this.__kk||new qx.util.placement.Placement();
var y=t.split(f);
var x=y[0];
var w=y[1];
this.__kk.set({axisX:this.__ko(u),axisY:this.__ko(v),edge:x,align:w});
return this.__kk.compute(p,q,r,s);
},__kl:null,__km:null,__kn:null,__ko:function(z){switch(z){case b:this.__kl=this.__kl||new qx.util.placement.DirectAxis();
return this.__kl;
case d:this.__km=this.__km||new qx.util.placement.KeepAlignAxis();
return this.__km;
case c:this.__kn=this.__kn||new qx.util.placement.BestFitAxis();
return this.__kn;
default:throw new Error("Invalid 'mode' argument!'");
}}},members:{__kj:null,compute:function(A,B,C,D){var E=this.getAxisX()||this.__kj;
var G=E.computeStart(A.width,{start:C.left,end:C.right},{start:D.left,end:D.right},B.width,this.__kp());
var F=this.getAxisY()||this.__kj;
var top=F.computeStart(A.height,{start:C.top,end:C.bottom},{start:D.top,end:D.bottom},B.height,this.__kq());
return {left:G,top:top};
},__kp:function(){var I=this.getEdge();
var H=this.getAlign();
...
}},__kq:function(){var K=this.getEdge();
var J=this.getAlign();
...
(function(){var j="nonScaled",i="scaled",h="alphaScaled",g=".png",f="div",e="replacement",d="qx.event.type.Event",c="engine.name",b="hidden",a="Boolean",z="px",y="engine.version",x="scale",w="changeSource",v="qx.ui.basic.Image",u="loaded",t="-disabled.$1",s="loadingFailed",r="String",q="__kr",o="_applySource",p="img",m="image",n="mshtml",k="_applyScale",l="no-repeat";
qx.Class.define(v,{extend:qx.ui.core.Widget,construct:function(A){this.__kr={};
qx.ui.core.Widget.call(this);

if(A){this.setSource(A);
}},properties:{source:{check:r,init:null,nullable:true,event:w,apply:o,themeable:true},scale:{check:a,init:false,themeable:true,apply:k},appearance:{refine:true,init:m},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},events:{loadingFailed:d,loaded:d},members:{__ks:null,__kt:null,__hA:null,__kr:null,getContentElement:function(){return this.__kx();
...
},__ku:function(F){this.__hA=F;
},__kv:function(){if(this.__hA==null){var H=this.getSource();
var G=false;

if(H!=null){G=qx.lang.String.endsWith(H,g);
}
if(this.getScale()&&G&&qx.bom.element.Decoration.isAlphaImageLoaderEnabled()){this.__hA=h;
}else if(this.getScale()){this.__hA=i;
}else{this.__hA=j;
}}return this.__hA;
},__kw:function(I){var J;
var K;
...
return L;
},__kx:function(){var M=this.__kv();

if(this.__kr[M]==null){this.__kr[M]=this.__kw(M);
}return this.__kr[M];
...
}if(qx.util.ResourceManager.getInstance().has(N)){this.__kA(this.getContentElement(),N);
}else if(qx.io.ImageLoader.isLoaded(N)){this.__kB(this.getContentElement(),N);
}else{this.__kC(this.getContentElement(),N);
}},__ky:qx.core.Environment.select(c,{"mshtml":function(P){var R=qx.bom.element.Decoration.isAlphaImageLoaderEnabled();
var Q=qx.lang.String.endsWith(P,g);

if(R&&Q){if(this.getScale()&&this.__kv()!=h){this.__ku(h);
}else if(!this.getScale()&&this.__kv()!=j){this.__ku(j);
}}else{if(this.getScale()&&this.__kv()!=i){this.__ku(i);
}else if(!this.getScale()&&this.__kv()!=j){this.__ku(j);
}}this.__kz(this.__kx());
},"default":function(S){if(this.getScale()&&this.__kv()!=i){this.__ku(i);
}else if(!this.getScale()&&this.__kv(j)){this.__ku(j);
}this.__kz(this.__kx());
}}),__kz:function(T){var W=this.getContainerElement();
var X=W.getChild(0);
...
W.addAt(T,0);
}},__kA:function(bb,bc){var be=qx.util.ResourceManager.getInstance();
...
this.__kE(be.getImageWidth(bc),be.getImageHeight(bc));
},__kB:function(bf,bg){var bi=qx.io.ImageLoader;
bf.setSource(bg);
var bh=bi.getWidth(bg);
var bj=bi.getHeight(bg);
this.__kE(bh,bj);
},__kC:function(bk,bl){var self;
var bm=qx.io.ImageLoader;
if(!bm.isFailed(bl)){bm.load(bl,this.__kD,this);
}else{if(bk!=null){bk.resetSource();
}}},__kD:function(bn,bo){if(this.$$disposed===true){return;
...
},__kE:function(bp,bq){if(bp!==this.__ks||bq!==this.__kt){this.__ks=bp;
this.__kt=bq;
qx.ui.core.queue.Layout.add(this);
...
(function(){var f="mousedown",d="blur",c="__kF",b="singleton",a="qx.ui.popup.Manager";
qx.Class.define(a,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__kF=[];
qx.event.Registration.addListener(document.documentElement,f,this.__kH,this,true);
qx.bom.Element.addListener(window,d,this.hideAll,this);
},members:{__kF:null,add:function(g){this.__kF.push(g);
this.__kG();
},remove:function(h){if(this.__kF){qx.lang.Array.remove(this.__kF,h);
this.__kG();
...
}}},__kG:function(){var m=1e7;

for(var i=0;i<this.__kF.length;i++){this.__kF[i].setZIndex(m++);
}},__kH:function(e){var o=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
var p=this.__kF;
...
}}},destruct:function(){qx.event.Registration.removeListener(document.documentElement,f,this.__kH,this,true);
...
qx.Class.define(a,{type:b,extend:qx.core.Object,members:{__iD:null,_invalidChildrenCache:null,__kI:null,invalidateLayoutCache:function(){this.__iD=null;
},renderLayout:function(c,d){this.warn("Missing renderLayout() implementation!");
},getSizeHint:function(){if(this.__iD){return this.__iD;
}return this.__iD=this._computeSizeHint();
},hasHeightForWidth:function(){return false;
},getHeightForWidth:function(e){this.warn("Missing getHeightForWidth() implementation!");
return null;
},_computeSizeHint:function(){return null;
},invalidateChildrenCache:function(){this._invalidChildrenCache=true;
},verifyLayoutProperty:null,_clearSeparators:function(){var f=this.__kI;

if(f instanceof qx.ui.core.LayoutItem){f.clearSeparators();
}},_renderSeparator:function(g,h){this.__kI.renderSeparator(g,h);
},connectToWidget:function(i){if(i&&this.__kI){throw new Error("It is not possible to manually set the connected widget.");
}this.__kI=i;
this.invalidateChildrenCache();
},_getWidget:function(){return this.__kI;
},_applyLayoutChange:function(){if(this.__kI){this.__kI.scheduleLayoutUpdate();
}},_getLayoutChildren:function(){return this.__kI.getLayoutChildren();
}},destruct:function(){this.__kI=this.__iD=null;
}});
})();
...
}},properties:{rich:{check:i,init:false,event:q,apply:o},wrap:{check:i,init:true,apply:E},value:{check:v,apply:y,event:D,nullable:true},buddy:{check:d,apply:w,nullable:true,init:null,dereference:true},textAlign:{check:[t,x,s,p],nullable:true,themeable:true,apply:f,event:a},appearance:{refine:true,init:m},selectable:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},allowShrinkY:{refine:true,init:false}},members:{__kJ:null,__kK:null,__kL:null,__kM:null,__kN:null,_getContentHint:function(){if(this.__kK){this.__kO=this.__kP();
delete this.__kK;
}return {width:this.__kO.width,height:this.__kO.height};
...
}},__kO:{width:0,height:0},_applyFont:function(M,N){if(N&&this.__kJ&&this.__kN){this.__kJ.removeListenerById(this.__kN);
this.__kN=null;
}var O;

if(M){this.__kJ=qx.theme.manager.Font.getInstance().resolve(M);

if(this.__kJ instanceof qx.bom.webfonts.WebFont){this.__kN=this.__kJ.addListener(b,this._onWebFontStatusChange,this);
}O=this.__kJ.getStyles();
}else{this.__kJ=null;
...
this.__kK=true;
qx.ui.core.queue.Layout.add(this);
},__kP:function(P){var T=qx.bom.Label;
var R=this.getFont();
var Q=R?this.__kJ.getStyles():qx.bom.Font.getDefaultStyles();
var content=this.getValue()||u;
var S=this.getRich();
return S?T.getHtmlSize(content,Q,P):T.getTextSize(content,Q);
},_applyBuddy:function(U,V){if(V!=null){V.removeBinding(this.__kL);
this.__kL=null;
this.removeListenerById(this.__kM);
this.__kM=null;
}
if(U!=null){this.__kL=U.bind(h,this,h);
this.__kM=this.addListener(l,function(){if(U.isFocusable()){U.focus.apply(U);
}},this);
...
}},"false":null}),_onWebFontStatusChange:function(bb){if(bb.getData().valid===true){this.__kK=true;
qx.ui.core.queue.Layout.add(this);
...
}if(this.__kL!=null){var be=this.getBuddy();

if(be!=null&&!be.isDisposed()){be.removeBinding(this.__kL);
}}
if(this.__kJ&&this.__kN){this.__kJ.removeListenerById(this.__kN);
}this.__kJ=this.__kL=null;
}});
})();
(function(){var b="value",a="qx.html.Label";
qx.Class.define(a,{extend:qx.html.Element,members:{__kQ:null,_applyProperty:function(name,c){qx.html.Element.prototype._applyProperty.call(this,name,c);

if(name==b){var d=this.getDomElement();
qx.bom.Label.setValue(d,c);
}},_createDomElement:function(){var f=this.__kQ;
...
qx.Class.define(o,{statics:{__kR:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__kS:function(){var C=this.__kU(false);
document.body.insertBefore(C,document.body.firstChild);
return this._textElement=C;
},__kT:function(){var D=this.__kU(true);
document.body.insertBefore(D,document.body.firstChild);
return this._htmlElement=D;
},__kU:function(E){var F=qx.bom.Element.create(A);
var G=F.style;
G.width=G.height=h;
G.left=G.top=k;
G.visibility=b;
...
for(var I in this.__kR){G[I]=f;
}F.appendChild(H);
}}return F;
},__kV:function(J){var K={};
...
O.margin=g;
O.width=h;
for(var Q in this.__kR){P.style[Q]=f;
}P.setAttribute(u,s);
N.appendChild(P);
}else{qx.bom.element.Style.setStyles(N,this.__kV(L));
}
...
}},getHtmlSize:function(content,U,V){var W=this._htmlElement||this.__kT();
W.style.width=V!=undefined?V+v:h;
W.innerHTML=content;
return this.__kW(W,U);
},getTextSize:function(X,Y){var ba=this._textElement||this.__kS();
...
}return this.__kW(ba,Y);
},__kW:function(bb,bc){var bd=this.__kR;
...
(function(){var i="qx.ui.window.Window",h="changeModal",g="changeVisibility",f="changeActive",d="_applyActiveWindow",c="__fK",b="__kX",a="qx.ui.window.MDesktop";
qx.Mixin.define(a,{properties:{activeWindow:{check:i,apply:d,init:null,nullable:true}},members:{__kX:null,__fK:null,getWindowManager:function(){if(!this.__fK){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());
}return this.__fK;
},supportsMaximize:function(){return true;
},setWindowManager:function(j){if(this.__fK){this.__fK.setDesktop(null);
}j.setDesktop(this);
this.__fK=j;
...
this.getWindowManager().updateStack();
},getWindows:function(){if(!this.__kX){this.__kX=[];
}return this.__kX;
}},destruct:function(){this._disposeArray(b);
this._disposeObjects(c);
}});
})();
(function(){var f="_applyBlockerColor",e="Number",d="__kY",c="qx.ui.core.MBlocker",b="_applyBlockerOpacity",a="Color";
qx.Mixin.define(c,{construct:function(){this.__kY=this._createBlocker();
},properties:{blockerColor:{check:a,init:null,nullable:true,apply:f,themeable:true},blockerOpacity:{check:e,init:1,apply:b,themeable:true}},members:{__kY:null,_createBlocker:function(){return new qx.ui.core.Blocker(this);
},_applyBlockerColor:function(g,h){this.__kY.setColor(g);
},_applyBlockerOpacity:function(i,j){this.__kY.setOpacity(i);
},block:function(){this.__kY.block();
},isBlocked:function(){return this.__kY.isBlocked();
},unblock:function(){this.__kY.unblock();
},forceUnblock:function(){this.__kY.forceUnblock();
},blockContent:function(k){this.__kY.blockContent(k);
},isContentBlocked:function(){return this.__kY.isContentBlocked();
},unblockContent:function(){this.__kY.unblockContent();
},forceUnblockContent:function(){this.__kY.forceUnblockContent();
},getBlocker:function(){return this.__kY;
}},destruct:function(){this._disposeObjects(d);
}});
})();
(function(){var l="zIndex",k="px",j="keydown",h="deactivate",g="resize",f="keyup",d="keypress",c="__ki",b="backgroundColor",a="_applyOpacity",x="Boolean",w="opacity",v="interval",u="Tab",t="Color",s="qx.ui.root.Page",r="__kY",q="Number",p="qx.ui.core.Blocker",o="qx.ui.root.Application",m="__le",n="_applyColor";
...
if(this._isPageRoot){y.addListener(g,this.__lg,this);
}
if(qx.Class.isDefined(o)&&y instanceof qx.ui.root.Application){this.setKeepBlockerActive(true);
}this.__la=[];
this.__lb=[];
this.__lc=[];
},properties:{color:{check:t,init:null,nullable:true,apply:n,themeable:true},opacity:{check:q,init:1,apply:a,themeable:true},keepBlockerActive:{check:x,init:false}},members:{__kY:null,__ld:0,__le:null,__lc:null,__la:null,__lb:null,__lf:null,__ki:null,_isPageRoot:false,_widget:null,__lg:function(e){var z=e.getData();
...
this.__lh(b,C);
},_applyOpacity:function(D,E){this.__lh(w,D);
},__lh:function(F,G){var H=[];
this.__kY&&H.push(this.__kY);
this.__le&&H.push(this.__le);
...
this.__la.push(I.getActive());
this.__lb.push(I.getFocus());

if(this._widget.isFocusable()){this._widget.focus();
}},_restoreActiveWidget:function(){var L=this.__la.length;

if(L>0){var K=this.__la[L-1];

if(K){qx.bom.Element.activate(K);
}this.__la.pop();
}var J=this.__lb.length;

if(J>0){var K=this.__lb[J-1];

if(K){qx.bom.Element.focus(this.__lb[J-1]);
}this.__lb.pop();
}},__li:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());
},getBlockerElement:function(){if(!this.__kY){this.__kY=this.__li();
this.__kY.setStyle(l,15);
this._widget.getContainerElement().add(this.__kY);
this.__kY.exclude();
}return this.__kY;
},block:function(){this.__ld++;

if(this.__ld<2){this._backupActiveWidget();
var M=this.getBlockerElement();
M.include();
M.activate();
M.addListener(h,this.__ln,this);
M.addListener(d,this.__lm,this);
M.addListener(j,this.__lm,this);
M.addListener(f,this.__lm,this);
}},isBlocked:function(){return this.__ld>0;
},unblock:function(){if(!this.isBlocked()){return;
}this.__ld--;

if(this.__ld<1){this.__lj();
this.__ld=0;
}},forceUnblock:function(){if(!this.isBlocked()){return;
}this.__ld=0;
this.__lj();
},__lj:function(){this._restoreActiveWidget();
var N=this.getBlockerElement();
N.removeListener(h,this.__ln,this);
N.removeListener(d,this.__lm,this);
N.removeListener(j,this.__lm,this);
N.removeListener(f,this.__lm,this);
N.exclude();
},getContentBlockerElement:function(){if(!this.__le){this.__le=this.__li();
this._widget.getContentElement().add(this.__le);
this.__le.exclude();
}return this.__le;
...
if(this.__lc.length<2){P.include();

if(this._isPageRoot){if(!this.__ki){this.__ki=new qx.event.Timer(300);
this.__ki.addListener(v,this.__ll,this);
}this.__ki.start();
this.__ll();
}}},isContentBlocked:function(){return this.__lc.length>0;
},unblockContent:function(){if(!this.isContentBlocked()){return;
}this.__lc.pop();
var Q=this.__lc[this.__lc.length-1];
var R=this.getContentBlockerElement();
R.setStyle(l,Q);

if(this.__lc.length<1){this.__lk();
this.__lc=[];
...
S.setStyle(l,null);
this.__lk();
},__lk:function(){this.getContentBlockerElement().exclude();

if(this._isPageRoot){this.__ki.stop();
}},__ll:function(){var T=this._widget.getContainerElement().getDomElement();
...
},__lm:function(e){if(e.getKeyIdentifier()==u){e.stop();
}},__ln:function(){if(this.getKeepBlockerActive()){this.getBlockerElement().activate();
}}},destruct:function(){if(this._isPageRoot){this._widget.removeListener(g,this.__lg,this);
}this._disposeObjects(m,r,c);
this.__lf=this.__la=this.__lb=this._widget=this.__lc=null;
}});
})();
...
qx.ui.core.queue.Visibility.add(this);
this.initNativeHelp();
this.addListener(q,this.__lp,this);
},properties:{appearance:{refine:true,init:o},enabled:{refine:true,init:true},focusable:{refine:true,init:true},globalCursor:{check:a,nullable:true,themeable:true,apply:d,event:s},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:p,init:false,apply:h}},members:{__lo:null,isRootWidget:function(){return true;
},getLayout:function(){return this._getLayout();
},_applyGlobalCursor:qx.core.Environment.select(r,{"mshtml":function(v,w){},"default":function(x,y){var z=qx.bom.Stylesheet;
var A=this.__lo;

if(!A){this.__lo=A=z.createElement();
}z.removeAllRules(A);
...
},__lp:function(e){if(e.getKeyIdentifier()!==k){return;
}var E=e.getTarget();
...
(function(){var k="keypress",j="focusout",h="__lq",g="activate",f="Tab",d="singleton",c="deactivate",b="focusin",a="qx.ui.core.FocusHandler";
qx.Class.define(a,{extend:qx.core.Object,type:d,construct:function(){qx.core.Object.call(this);
this.__lq={};
},members:{__lq:null,__lr:null,__ls:null,__lt:null,connectTo:function(m){m.addListener(k,this.__gT,this);
...
},addRoot:function(n){this.__lq[n.$$hash]=n;
},removeRoot:function(o){delete this.__lq[o.$$hash];
},getActiveWidget:function(){return this.__lr;
},isActive:function(p){return this.__lr==p;
},getFocusedWidget:function(){return this.__ls;
},isFocused:function(q){return this.__ls==q;
},isFocusRoot:function(r){return !!this.__lq[r.$$hash];
},_onActivate:function(e){var t=e.getTarget();
this.__lr=t;
var s=this.__lu(t);

if(s!=this.__lt){this.__lt=s;
}},_onDeactivate:function(e){var u=e.getTarget();

if(this.__lr==u){this.__lr=null;
}},_onFocusIn:function(e){var v=e.getTarget();

if(v!=this.__ls){this.__ls=v;
v.visualizeFocus();
}},_onFocusOut:function(e){var w=e.getTarget();

if(w==this.__ls){this.__ls=null;
w.visualizeBlur();
}},__gT:function(e){if(e.getKeyIdentifier()!=f){return;
}
if(!this.__lt){return;
}e.stopPropagation();
e.preventDefault();
...
if(!e.isShiftPressed()){var y=x?this.__ly(x):this.__lw();
}else{var y=x?this.__lz(x):this.__lx();
}if(y){y.tabFocus();
}},__lu:function(z){var A=this.__lq;

while(z){if(A[z.$$hash]){return z;
}z=z.getLayoutParent();
}return null;
},__lv:function(B,C){if(B===C){return 0;
...
},__lw:function(){return this.__lC(this.__lt,null);
},__lx:function(){return this.__lD(this.__lt,null);
},__ly:function(M){var N=this.__lt;

if(N==M){return this.__lw();
}
...
O.sort(this.__lv);
var P=O.length;
return P>0?O[0]:this.__lw();
},__lz:function(Q){var R=this.__lt;

if(R==Q){return this.__lx();
}
...
S.sort(this.__lv);
var T=S.length;
return T>0?S[T-1]:this.__lx();
},__lA:function(parent,U,V){var W=parent.getLayoutChildren();
var X;

for(var i=0,l=W.length;i<l;i++){X=W[i];
if(!(X instanceof qx.ui.core.Widget)){continue;
}
if(!this.isFocusRoot(X)&&X.isEnabled()&&X.isVisible()){if(X.isTabable()&&this.__lv(U,X)<0){V.push(X);
}this.__lA(X,U,V);
}}},__lB:function(parent,Y,ba){var bb=parent.getLayoutChildren();
var bc;

for(var i=0,l=bb.length;i<l;i++){bc=bb[i];
if(!(bc instanceof qx.ui.core.Widget)){continue;
}
if(!this.isFocusRoot(bc)&&bc.isEnabled()&&bc.isVisible()){if(bc.isTabable()&&this.__lv(Y,bc)>0){ba.push(bc);
}this.__lB(bc,Y,ba);
}}},__lC:function(parent,bd){var be=parent.getLayoutChildren();
var bf;

for(var i=0,l=be.length;i<l;i++){bf=be[i];
if(!(bf instanceof qx.ui.core.Widget)){continue;
}if(!this.isFocusRoot(bf)&&bf.isEnabled()&&bf.isVisible()){if(bf.isTabable()){if(bd==null||this.__lv(bf,bd)<0){bd=bf;
}}bd=this.__lC(bf,bd);
}}return bd;
},__lD:function(parent,bg){var bh=parent.getLayoutChildren();
var bi;

for(var i=0,l=bh.length;i<l;i++){bi=bh[i];
if(!(bi instanceof qx.ui.core.Widget)){continue;
}if(!this.isFocusRoot(bi)&&bi.isEnabled()&&bi.isVisible()){if(bi.isTabable()){if(bg==null||this.__lv(bi,bg)>0){bg=bi;
}}bg=this.__lD(bi,bg);
}}return bg;
}},destruct:function(){this._disposeMap(h);
this.__ls=this.__lr=this.__lt=null;
}});
})();
...
},members:{__cy:null,__lE:null,_createContainerElement:function(){var p=this.__lE;
...
}}},destruct:function(){this.__cy=this.__lE=null;
}});
})();
...
this.addListener(t,this.__lF,this);
this.addListener(n,this.__lF,this);
},members:{_stopPropagation:function(e){e.stopPropagation();
},__lF:function(){var A=this.getStyle(k);
this.setStyle(k,null,true);
this.setStyle(k,A,true);
}}});
})();
(function(){var j="bold",i="GET",h="value",g="get",f="model",e="changeModel",d="model.user.avatar_url",c="application/json",b="github.view.Gist",a="model.description",H="west",G="/gists/{id}",F="Description",E="https://api.github.com",D="demobrowser.demo.data.Github",C="source",B="/gists",A="change",z="Content",y="center",q="#fff",r="Authorization",o="html",p="model.user.login",m="model.files",n="north",k="Gists",l="Accept",s="token ",t="github.rest.Resource",v="description",u="undefined",x="</pre>",w="<pre>";
qx.Class.define(D,{extend:qx.application.Standalone,members:{__lG:null,__lH:null,__lI:null,__lJ:null,__lK:null,__lL:null,main:function(){if(typeof GITHUB==u){return;
...
this._setUpBinding();
this.__lG.get();
this.__lK.addListener(e,function(I){var J=I.getData();
this.__lK.getSelection().push(J.getItem(0));
},this);
this.__lK.getSelection().addListener(A,function(K){var L=this.__lK.getSelection().getItem(0).getId();
this.__lH.get({id:L});
},this);
},_setUpResources:function(){this.__lG=new github.rest.Resource({"get":{method:i,url:B}});
this.__lH=new github.rest.Resource({"get":{method:i,url:G}});
},_setUpStores:function(){this.__lI=new qx.data.store.Rest(this.__lG,g);
this.__lJ=new qx.data.store.Rest(this.__lH,g);
},_createGui:function(){var M=new qx.ui.container.Composite(new qx.ui.layout.Dock());
M.setPadding(10);
var N=new qx.ui.basic.Label(k);
N.setFont(j);
N.setPaddingBottom(10);
M.add(N,{edge:n});
this.__lK=new qx.ui.list.List();
this.__lK.setWidth(200);
this.__lL=new github.view.Gist();
M.add(this.__lK,{edge:H});
M.add(this.__lL,{edge:y});
this.getRoot().add(M,{edge:0});
},_setUpBinding:function(){var P=this.__lK,O=this.__lI,Q=this.__lJ;
P.setLabelPath(v);
P.setLabelOptions({converter:function(S,T,U,V){if(S===null||!S.length){return T.getId();
}return S;
}});
O.bind(f,P,f);
var R=this.__lL;
Q.bind(a,R.getDescription(),h);
Q.bind(p,R.getUsername(),h);
Q.bind(d,R.getGravatar(),C);
Q.bind(m,R.getContent(),o,{converter:function(W){var X=qx.Class.getProperties(W.constructor);
var content=W.get(X[0]).getContent();
content=qx.bom.String.escape(content);
return w+content+x;
}});
}}});
qx.Class.define(t,{extend:qx.io.rest.Resource,construct:function(Y){qx.io.rest.Resource.call(this,Y);
this.configureRequest(function(ba){ba.setRequestHeader(l,c);
ba.setRequestHeader(r,s+GITHUB.access_token);
});
this.setBaseUrl(E);
}});
qx.Class.define(b,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);
var bb=new qx.ui.layout.Grid(5,5);
bb.setColumnFlex(0,1);
bb.setRowFlex(2,1);
this.setLayout(bb);
...
be.setFont(j);
this.__lM=new qx.ui.basic.Label();
bc.add(be);
bc.add(this.__lM);
this.add(bc,{row:0,column:0});
var bd=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
this.__lN=new qx.ui.basic.Image();
this.__lN.set({width:40,height:40,scale:true,backgroundColor:q});
this.__lO=new qx.ui.basic.Label();
bd.add(this.__lN);
bd.add(this.__lO);
this.add(bd,{row:0,column:1});
be=new qx.ui.basic.Label(z);
be.setFont(j);
var scroll=new qx.ui.container.Scroll();
this.__lP=new qx.ui.embed.Html();
this.__lP.setMinHeight(1000);
scroll.add(this.__lP);
this.add(be,{row:1,column:0});
this.add(scroll,{row:2,column:0,colSpan:2});
},members:{getDescription:function(){return this.__lM;
},getGravatar:function(){return this.__lN;
},getUsername:function(){return this.__lO;
},getContent:function(){return this.__lP;
}}});
})();
...
if(j&&qx.lang.Type.isFunction(j.configureRequest)){this.__da();
}this.__lQ=qx.lang.Function.bind(this.__lS,this);
this.__lR();
},properties:{resource:{check:d},actionName:{check:b},model:{nullable:true,event:g}},members:{_marshaler:null,_delegate:null,__lQ:null,__da:function(){var k=this.getResource(),l=this._delegate;
k.configureRequest(l.configureRequest);
},__lR:function(){var n=this.getResource(),m=this.getActionName();

if(n&&m){n.addListener(this.getActionName()+c,this.__lQ);
}},__lS:function(e){var p=e.getData(),o=this._marshaler,q,r=this.getModel(),s=this._delegate;
...
}},members:{__lT:null,__lU:function(n){return qx.Bootstrap.getKeys(n).sort().join(e);
...
}if(this.__lT&&this.__lT.getModelClass&&this.__lT.getModelClass(r)!=null){return;
}var y={};
var x={__lV:this.__lV};
...
if(p){y[s].apply=a;
}if(this.__lT&&this.__lT.getValidationRule){var u=this.__lT.getValidationRule(r,s);

if(u){y[s].validate=f+s;
x[f+s]=u;
}}}if(this.__lT&&this.__lT.getModelSuperClass){var w=this.__lT.getModelSuperClass(r)||qx.core.Object;
}else{var w=qx.core.Object;
}var t=[];

if(this.__lT&&this.__lT.getModelMixins){var v=this.__lT.getModelMixins(r);
if(!qx.lang.Type.isArray(v)){if(v!=null){t=[v];
}}}if(p){t.push(qx.data.marshal.MEventBubbling);
}var q={extend:w,include:t,properties:y,members:x,destruct:this.__lW};
qx.Class.define(j+r,q);
},__lW:function(){var z=qx.util.PropertyUtil.getAllProperties(this.constructor);

for(var A in z){this.__lV(this.get(z[A].name));
}},__lV:function(B){if(!(B instanceof qx.core.Object)){return ;
}if(B.isDisposed()){return;
}B.dispose();
},__lX:function(C){var D;
if(this.__lT&&this.__lT.getModelClass){D=this.__lT.getModelClass(C);
}
...
},_registerEventChaining:function(l,m,name){if((l instanceof qx.core.Object)&&qx.Class.hasMixin(l.constructor,qx.data.marshal.MEventBubbling)){var n=qx.lang.Function.bind(this.__lY,this,name);
...
}},__lY:function(name,e){var x=e.getData();
var t=x.value;
var r=x.old;
...
if(p==undefined){this.__ma=[];
}else if(arguments.length>1){this.__ma=[];

for(var i=0;i<arguments.length;i++){this.__ma.push(arguments[i]);
}}else if(typeof p==c){this.__ma=new Array(p);
}else if(p instanceof Array){this.__ma=qx.lang.Array.clone(p);
}else{this.__ma=[];
this.dispose();
throw new Error("Type of the parameter not supported!");
}for(var i=0;i<this.__ma.length;i++){this._applyEventPropagation(this.__ma[i],null,i);
}this.__mb();
},properties:{autoDisposeItems:{check:e,init:false}},events:{"change":f,"changeLength":f},members:{__ma:null,concat:function(q){if(q){var r=this.__ma.concat(q);
}else{var r=this.__ma.concat();
}return new qx.data.Array(r);
},join:function(s){return this.__ma.join(s);
},pop:function(){var t=this.__ma.pop();
this.__mb();
...
return t;
},push:function(u){for(var i=0;i<arguments.length;i++){this.__ma.push(arguments[i]);
this.__mb();
...
}var v=this.__ma.concat();
this.__ma.reverse();
this.fireDataEvent(o,{start:0,end:this.length-1,type:j,items:null},null);
this.fireDataEvent(n,{value:this.__ma,name:k+(this.__ma.length-1),old:v});
},shift:function(){if(this.length==0){return;
}var w=this.__ma.shift();
this.__mb();
...
return w;
},slice:function(x,y){return new qx.data.Array(this.__ma.slice(x,y));
},splice:function(z,A,B){var J=this.__ma.length;
var F=this.__ma.splice.apply(this.__ma,arguments);
if(this.__ma.length!=J){this.__mb();
}var H=A>0;
var D=arguments.length>2;
var E=null;

if(H||D){if(this.__ma.length>J){var I=m;
}else if(this.__ma.length<J){var I=l;
E=F;
}else{var I=j;
...
}var L=this.__ma.concat();
this.__ma.sort.apply(this.__ma,arguments);
this.fireDataEvent(o,{start:0,end:this.length-1,type:j,items:null},null);
this.fireDataEvent(n,{value:this.__ma,name:k+(this.length-1),old:L});
},unshift:function(M){for(var i=arguments.length-1;i>=0;i--){this.__ma.unshift(arguments[i]);
this.__mb();
this._registerEventChaining(arguments[i],null,0);
this.fireDataEvent(n,{value:[this.__ma[0]],name:g,old:[this.__ma[1]]});
this.fireDataEvent(o,{start:0,end:this.length-1,type:m,items:[arguments[i]]},null);
}return this.length;
},toArray:function(){return this.__ma;
},getItem:function(N){return this.__ma[N];
},setItem:function(O,P){var Q=this.__ma[O];
if(Q===P){return;
}this.__ma[O]=P;
...
},indexOf:function(R){return this.__ma.indexOf(R);
},toString:function(){if(this.__ma!=null){return this.__ma.toString();
}return b;
},contains:function(S){return this.__ma.indexOf(S)!==-1;
...
be.dispose();
return bd;
},removeAll:function(){for(var i=0;i<this.__ma.length;i++){this._registerEventChaining(null,this.__ma[i],i);
}if(this.getLength()==0){return;
}var bg=this.getLength();
var bf=this.__ma.concat();
this.__ma.length=0;
this.__mb();
...
}Array.prototype.push.apply(this.__ma,bh);
for(var i=0;i<bh.length;i++){this._registerEventChaining(bh[i],null,this.__ma.length+i);
}var bi=this.length;
this.__mb();
...
},forEach:function(bp,bq){for(var i=0;i<this.__ma.length;i++){bp.call(bq,this.__ma[i],i,this);
}},__mb:function(){var br=this.length;
this.length=this.__ma.length;
this.fireDataEvent(a,this.length,br);
}},destruct:function(){for(var i=0;i<this.__ma.length;i++){var bs=this.__ma[i];
...
}},properties:{sort:{check:[l,m,n],init:l,apply:j},separatorX:{check:p,nullable:true,apply:s},separatorY:{check:p,nullable:true,apply:s},connectSeparators:{check:e,init:false,apply:s},spacingX:{check:o,init:0,apply:s},spacingY:{check:o,init:0,apply:s}},members:{__gh:null,__mc:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__md:{north:1,south:2,west:3,east:4,center:5},__me:{1:q,2:d,3:r,4:g},__mf:function(){var x=this._getLayoutChildren();
var F,z;
var length=x.length;
var B=[];
var E=[];
...
},renderLayout:function(H,I){if(this._invalidChildrenCache){this.__mf();
...
}},destruct:function(){this.__mc=this.__gh=null;
}});
})();
...
}},properties:{appearance:{refine:true,init:l},orientation:{check:[k,h],init:k,apply:u},maximum:{check:r,apply:v,init:100},position:{check:n,init:0,apply:o,event:i},singleStep:{check:x,init:20},knobFactor:{check:A,nullable:true}},members:{__mg:null,__mh:null,_getScrollPaneElement:function(){if(!this.__mh){this.__mh=new qx.html.Element();
}return this.__mh;
...
return {width:this.__mg?100:G,maxWidth:this.__mg?null:G,minWidth:this.__mg?null:G,height:this.__mg?G:100,maxHeight:this.__mg?G:null,minHeight:this.__mg?G:null};
...
if(this.__mg){content.scrollToX(K);
}else{content.scrollToY(K);
}},_applyOrientation:function(L,M){var N=this.__mg=L===k;
...
qx.ui.core.queue.Layout.add(this);
},_updateScrollBar:function(){var P=this.__mg;
...
var W=this.__mg?X.getScrollX():X.getScrollY();
this.setPosition(W);
...
if(this.getOrientation()==h){if(R.height<S.minHeight+this.__mi){Q=true;
}}else{if(R.width<S.minWidth+this.__mi){Q=true;
}}
if(Q){P.exclude();
}else{P.show();
}}}});
...
qx.Mixin.define(d,{construct:function(){if(qx.core.Environment.get(l)){qx.locale.Manager.getInstance().addListener(j,this.__mj,this);
...
},__mj:qx.core.Environment.select(l,{"true":function(e){var o=this.getInvalidMessage();
...
}},"false":null})},destruct:function(){if(qx.core.Environment.get(l)){qx.locale.Manager.getInstance().removeListener(j,this.__mj,this);
}}});
})();
...
},_onMouseDown:function(e){if(this.__mn){return;
}var bk=this.__mg;
var bi=this.getChildControl(k);
var bj=bk?f:d;
var bm=bk?e.getDocumentLeft():e.getDocumentTop();
var bn=this.__mk=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bj];
var bl=this.__ml=qx.bom.element.Location.get(bi.getContainerElement().getDomElement())[bj];

if(e.getTarget()===bi){this.__mn=true;

if(!this.__ms){this.__ms=new qx.event.Timer(100);
this.__ms.addListener(W,this._fireValue,this);
}this.__ms.start();
this.__mo=bm+bn-bl;
bi.addState(b);
}else{this.__mp=true;
...
this.capture();
e.stopPropagation();
},_onMouseUp:function(e){if(this.__mn){this.releaseCapture();
delete this.__mn;
this.__ms.stop();
this._fireValue();
delete this.__mo;
...
if(this.__mg){bp=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__mk);
...
}else{bp=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__mk);
...
if(bq<0||bq>this.__mm||bp<0||bp>this.__mm){this.getChildControl(k).removeState(g);
}}}else if(this.__mp){this.__ki.stop();
this.releaseCapture();
delete this.__mp;
delete this.__mq;
delete this.__mr;
...
}},_onMouseMove:function(e){if(this.__mn){var bs=this.__mg?e.getDocumentLeft():e.getDocumentTop();
var br=bs-this.__mo;
this.slideTo(this._positionToValue(br));
}else if(this.__mp){this.__mw(e);
}e.stopPropagation();
},_onInterval:function(e){var bt=this.getValue()+(this.__mq*this.getPageStep());
if(bt<this.getMinimum()){bt=this.getMinimum();
}else if(bt>this.getMaximum()){bt=this.getMaximum();
}var bu=this.__mq==-1;

if((bu&&bt<=this.__mr)||(!bu&&bt>=this.__mr)){bt=this.__mr;
}this.slideTo(bt);
},_onUpdate:function(e){var bw=this.getInnerSize();
var bx=this.getChildControl(k).getBounds();
var bv=this.__mg?E:C;
this._updateKnobSize();
this.__mv=bw[bv]-bx[bv];
this.__mm=bx[bv];
this._updateKnobPosition();
},__mg:false,__mv:0,__mw:function(e){var by=this.__mg;
...
var bI=this.__mq<0?N:z;
bD=bE+(Math[bI]((bD-bE)/bC)*bC);
}if(this.__mr==null||(this.__mq==-1&&bD<=this.__mr)||(this.__mq==1&&bD>=this.__mr)){this.__mr=bD;
}},_positionToValue:function(bK){var bL=this.__mv;
...
},_valueToPosition:function(bO){var bP=this.__mv;
...
if(this.__mg){bT.setStyle(f,bS+a,true);
...
if(bU==null){return;
}if(this.__mg){this.getChildControl(k).setWidth(Math.round(bV*bU.width));
...
this.__mg=bY===j;
if(this.__mg){this.removeState(i);
cb.removeState(i);
this.addState(j);
cb.addState(j);
...
qx.Mixin.define(j,{events:{"execute":g},properties:{command:{check:b,apply:f,event:a,nullable:true}},members:{__mx:null,__my:false,__mz:null,_bindableProperties:[d,k,l,m,h,c],execute:function(){var o=this.getCommand();

if(o){if(this.__my){this.__my=false;
}else{this.__my=true;
o.execute(this);
}}this.fireEvent(n);
},__mA:function(e){if(this.__my){this.__my=false;
return;
}this.__my=true;
this.execute();
},_applyCommand:function(p,q){if(q!=null){q.removeListenerById(this.__mz);
}
if(p!=null){this.__mz=p.addListener(n,this.__mA,this);
}var t=this.__mx;

if(t==null){this.__mx=t={};
}var u;
...
},events:{"execute":j,"press":j,"release":j},properties:{interval:{check:l,init:100},firstInterval:{check:l,init:500},minTimer:{check:l,init:20},timerDecrease:{check:l,init:2}},members:{__mB:null,__ki:null,press:function(){if(this.isEnabled()){if(!this.hasState(n)){this.__mC();
}this.removeState(m);
this.addState(n);
}},release:function(q){if(!this.isEnabled()){return;
}if(this.hasState(n)){if(!this.__mB){this.execute();
}}this.removeState(n);
this.removeState(m);
this.__mD();
...
if(this.hasState(n)&&!this.__mB){this.execute();
}}this.__mD();
e.stopPropagation();
},_onKeyUp:function(e){switch(e.getKeyIdentifier()){case i:case h:if(this.hasState(n)){if(!this.__mB){this.execute();
}this.removeState(n);
this.removeState(m);
e.stopPropagation();
this.__mD();
...
this.fireEvent(b);
},__mC:function(){this.fireEvent(g);
this.__mB=false;
...
this.removeState(m);
this.addState(n);
},__mD:function(){this.fireEvent(a);
this.__ki.stop();
this.removeState(m);
this.removeState(n);
...
},events:{"interval":b},properties:{interval:{check:e,init:100},firstInterval:{check:e,init:500},minimum:{check:e,init:20},decrease:{check:e,init:2}},members:{__ki:null,__mE:null,start:function(){this.__ki.setInterval(this.getFirstInterval());
this.__ki.start();
},stop:function(){this.__ki.stop();
this.__mE=null;
},_onInterval:function(){this.__ki.stop();

if(this.__mE==null){this.__mE=this.getInterval();
}this.__mE=Math.max(this.getMinimum(),this.__mE-this.getDecrease());
this.__ki.setInterval(this.__mE);
this.__ki.start();
this.fireEvent(d);
...
}},properties:{alignX:{check:[m,k,c],init:m,apply:n},alignY:{check:[j,g,e],init:j,apply:n},spacing:{check:a,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:d,init:false,apply:f}},members:{__mF:null,__mG:null,__mH:null,__gh:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__mf:function(){var w=this._getLayoutChildren();
var length=w.length;
var t=false;
var r=this.__mF&&this.__mF.length!=length&&this.__mG&&this.__mF;
var u;
var s=r?this.__mF:new Array(length);
var v=r?this.__mG:new Array(length);
...
this.__gh=w;
delete this._invalidChildrenCache;
},verifyLayoutProperty:null,renderLayout:function(x,y){if(this._invalidChildrenCache){this.__mf();
}var E=this.__gh;
var length=E.length;
...
for(i=0;i<length;i+=1){J=this.__mF[i];
K=J!=null?Math.floor((x-B)*J):E[i].getSizeHint().width;
P.push(K);
F+=K;
}if(this.__mH&&F!=x){var H={};
var L,O;

for(i=0;i<length;i+=1){L=this.__mG[i];
...
}},destruct:function(){this.__mF=this.__mG=this.__gh=null;
}});
})();
...
if(q){this.setSeparator(q);
}},properties:{alignY:{check:[m,j,e],init:m,apply:n},alignX:{check:[k,g,a],init:k,apply:n},spacing:{check:c,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:b,init:false,apply:f}},members:{__mI:null,__mG:null,__mH:null,__gh:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__mf:function(){var w=this._getLayoutChildren();
var length=w.length;
var s=false;
var r=this.__mI&&this.__mI.length!=length&&this.__mG&&this.__mI;
var u;
var t=r?this.__mI:new Array(length);
var v=r?this.__mG:new Array(length);
if(this.getReversed()){w=w.concat().reverse();
}for(var i=0;i<length;i++){u=w[i].getLayoutProperties();
...
for(i=0;i<length;i+=1){J=this.__mI[i];
B=J!=null?Math.floor((y-C)*J):F[i].getSizeHint().height;
K.push(B);
Q+=B;
}if(this.__mH&&Q!=y){var H={};
var N,R;

for(i=0;i<length;i+=1){N=this.__mG[i];
...
}},destruct:function(){this.__mI=this.__mG=this.__gh=null;
}});
})();
...
this.__cQ={};
this.__mJ={};
}},properties:{appearance:{refine:true,init:r},width:{refine:true,init:100},height:{refine:true,init:200},scrollbarX:{check:[h,c,E],init:h,themeable:true,apply:b},scrollbarY:{check:[h,c,E],init:h,themeable:true,apply:b},scrollbar:{group:[x,u]}},members:{__cQ:null,__mJ:null,_createChildControlImpl:function(H,I){var J;
...
X.scrollBy(W);
if(this.__mJ[U]){clearTimeout(this.__mJ[U]);
this.__mJ[U]=null;
}this.__mJ[U]=setTimeout(qx.lang.Function.bind(function(ba){this.__mK(ba,U);
},this,W),100);
}},__mK:function(bb,bc){this.__mJ[bc]=null;
var be=this._isChildControlVisible(d+bc);

if(bb==0||!be){return;
}if(bb>0){bb=Math.max(0,bb-3);
}else{bb=Math.min(0,bb+3);
}this.__mJ[bc]=setTimeout(qx.lang.Function.bind(function(bf,bg){this.__mK(bf,bg);
},this,bb,bc),20);
...
}},properties:{spacingX:{check:h,init:0,apply:p},spacingY:{check:h,init:0,apply:p}},members:{__mN:null,__mL:null,__mM:null,__mO:null,__mP:null,__mQ:null,__mR:null,__mS:null,__mT:null,verifyLayoutProperty:null,__mU:function(){var B=[];
var A=[];
var C=[];
var w=-1;
var v=-1;
...
this.__mT=null;
delete this._invalidChildrenCache;
},_setRowData:function(G,H,I){var J=this.__mL[G];

if(!J){this.__mL[G]={};
this.__mL[G][H]=I;
}else{J[H]=I;
}},_setColumnData:function(K,L,M){var N=this.__mM[K];
...
for(var i=0,l=this.__mP.length;i<l;i++){var cl=this.__mP[i];
var ch=this.__mV(cl);
...
for(var i=0,l=this.__mO.length;i<l;i++){var ct=this.__mO[i];
var cv=this.__mV(ct);
...
for(var cO=0;cO<=cH;cO++){var cG=this.__mN[cQ][cO];
...
if(this.__mP.length>0){this._fixHeightsRowSpan(cP);
}this.__mS=cP;
return cP;
...
for(var dc=0;dc<=cU;dc++){var cR=this.__mN[dc][db];
...
if(this.__mO.length>0){this._fixWidthsColSpan(cV);
}this.__mT=cV;
return cV;
...
},renderLayout:function(ds,dt){if(this._invalidChildrenCache){this.__mU();
...
for(var dC=0;dC<=du;dC++){var dJ=this.__mN[dC][dP];
if(!dJ){top+=dV[dC]+dB;
continue;
...
this.__mW=new qx.ui.virtual.core.Pane(h,i,j,k);
this.__mW.addListener(f,this._computeScrollbars,this);
this.__mW.addListener(d,this._onScrollPaneX,this);
this.__mW.addListener(g,this._onScrollPaneY,this);

if(qx.core.Environment.get(b)){this._add(this.__mW,{edge:0});
}else{this._add(this.__mW,{row:0,column:0});
}},properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__mW:null,getPane:function(){return this.__mW;
},_createChildControlImpl:function(l,m){if(l==c){return this.__mW;
...
},_onScrollBarX:function(e){this.__mW.setScrollX(e.getData());
},_onScrollBarY:function(e){this.__mW.setScrollY(e.getData());
}},destruct:function(){this.__mW.dispose();
this.__mW=null;
}});
})();
(function(){var v="appear",u="qx.ui.virtual.core.CellEvent",t="update",s="change",r="qx.event.type.Data",q="qx.ui.virtual.core.Pane",p="resize",o="click",n="scrollX",m="dblclick",d="contextmenu",l="cellClick",h="__mX",c="qx.event.type.Event",b="scrollY",g="__ng",f="__nf",j="__mY",a="cellDblclick",k="cellContextmenu";
qx.Class.define(q,{extend:qx.ui.core.Widget,construct:function(w,x,y,z){qx.ui.core.Widget.call(this);
this.__mX=new qx.ui.virtual.core.Axis(y,w);
this.__mY=new qx.ui.virtual.core.Axis(z,x);
this.__na=0;
this.__nb=0;
this.__nc=0;
this.__nd=0;
this.__ne={};
this.__iM={};
this.__nf=new qx.ui.container.Composite();
this.__nf.setUserBounds(0,0,0,0);
this._add(this.__nf);
this.__ng=[];
this.__mX.addListener(s,this.fullUpdate,this);
this.__mY.addListener(s,this.fullUpdate,this);
...
},events:{cellClick:u,cellContextmenu:u,cellDblclick:u,update:c,scrollX:r,scrollY:r},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__mX:null,__mY:null,__na:null,__nb:null,__nc:null,__nd:null,__ne:null,__iM:null,__nf:null,__ng:null,__nh:null,__ni:null,__nj:null,getRowConfig:function(){return this.__mX;
},getColumnConfig:function(){return this.__mY;
},getChildren:function(){return [this.__nf];
},addLayer:function(A){this.__ng.push(A);
A.setUserBounds(0,0,0,0);
this.__nf.add(A);
},getLayers:function(){return this.__ng;
},getVisibleLayers:function(){var B=[];

for(var i=0;i<this.__ng.length;i++){var C=this.__ng[i];

if(C.isVisible()){B.push(C);
}}return B;
},getScrollMaxX:function(){var D=this.getInnerSize();

if(D){return Math.max(0,this.__mY.getTotalSize()-D.width);
}return 0;
},getScrollMaxY:function(){var E=this.getInnerSize();

if(E){return Math.max(0,this.__mX.getTotalSize()-E.height);
}return 0;
...
if(this.__na!==F){var H=this.__na;
this.__na=F;
this._deferredUpdateScrollPosition();
this.fireDataEvent(b,F,H);
}},getScrollY:function(){return this.__na;
},setScrollX:function(I){var J=this.getScrollMaxX();

if(I<0){I=0;
}else if(I>J){I=J;
}
if(I!==this.__nb){var K=this.__nb;
this.__nb=I;
this._deferredUpdateScrollPosition();
this.fireDataEvent(n,I,K);
}},getScrollX:function(){return this.__nb;
},getScrollSize:function(){return {width:this.__mY.getTotalSize(),height:this.__mX.getTotalSize()};
...
return;
}var P=this.__mX.getItemPosition(L);
var N=P+this.__mX.getItemSize(L);
...
return;
}var S=this.__mY.getItemPosition(Q);
var R=S+this.__mY.getItemSize(Q);
...
}bb=this.__mX.getItemAtPosition(this.getScrollY()+ba-bd.top);
bc=this.__mY.getItemAtPosition(this.getScrollX()+Y-bd.left);
...
if(!bk){return;
}var bl=this.__nb+bk.width;
var bm=this.__nd-bl;

if(this.__nb-this.__ne.left<Math.min(this.__nb,be)||this.__ne.right-bl<Math.min(bm,bg)){var bn=Math.min(this.__nb,bf);
var bj=Math.min(bm,bh);
this._setLayerWindow(bi,this.__nb-bn,this.__na,bk.width+bn+bj,bk.height,false);
...
if(!bv){return;
}var bt=this.__na+bv.height;
var bu=this.__nc-bt;

if(this.__na-this.__ne.top<Math.min(this.__na,bo)||this.__ne.bottom-bt<Math.min(bu,bq)){var bx=Math.min(this.__na,bp);
var bw=Math.min(bu,br);
this._setLayerWindow(bs,this.__nb,this.__na-bx,bv.width,bv.height+bx+bw,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__nh=true;
this._updateScrollPosition();
this.__nh=null;
this.fireEvent(t);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__nk(e,l);
},_onContextmenu:function(e){this.__nk(e,k);
},_onDblclick:function(e){this.__nk(e,a);
},__nk:function(e,by){var bz=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());

if(!bz){return;
}this.fireNonBubblingEvent(by,qx.ui.virtual.core.CellEvent,[this,e,bz.row,bz.column]);
},syncWidget:function(){if(this.__iM._fullUpdate){this._fullUpdate();
}else if(this.__iM._updateScrollPosition){this._updateScrollPosition();
}this.__iM={};
},_setLayerWindow:function(bA,bB,top,bC,bD,bE){var bJ=this.__mX.getItemAtPosition(top);

if(bJ){var bL=bJ.index;
var bP=this.__mX.getItemSizes(bL,bD+bJ.offset);
...
var bR=0;
var bO=0;
}var bN=this.__mY.getItemAtPosition(bB);

if(bN){var bH=bN.index;
var bG=this.__mY.getItemSizes(bH,bC+bN.offset);
...
var bQ=0;
var bI=0;
}this.__ne={top:bR,bottom:bO,left:bQ,right:bI};
this.__nf.setUserBounds(this.__ne.left-this.__nb,this.__ne.top-this.__na,bM,bK);
this.__ni=bG;
this.__nj=bP;

for(var i=0;i<this.__ng.length;i++){var bF=this.__ng[i];
bF.setUserBounds(0,0,bM,bK);

if(bE){bF.fullUpdate(bL,bH,bP,bG);
}else{bF.updateLayerWindow(bL,bH,bP,bG);
}}},__nl:function(){if(this.__nh){return;
}var bS=this.getScrollSize();

if(this.__nc!==bS.height||this.__nd!==bS.width){this.__nc=bS.height;
this.__nd=bS.width;
this.fireEvent(t);
}},fullUpdate:function(){this.__iM._fullUpdate=1;
qx.ui.core.queue.Widget.add(this);
},isUpdatePending:function(){return !!this.__iM._fullUpdate;
},_fullUpdate:function(){var bT=this.getVisibleLayers();

if(bT.length==0){this.__nl();
return;
}var bU=this.getBounds();

if(!bU){return ;
}this._setLayerWindow(bT,this.__nb,this.__na,bU.width,bU.height,true);
this.__nl();
},_deferredUpdateScrollPosition:function(){this.__iM._updateScrollPosition=1;
qx.ui.core.queue.Widget.add(this);
},_updateScrollPosition:function(){var bV=this.getVisibleLayers();

if(bV.length==0){this.__nl();
return;
}var bX=this.getBounds();

if(!bX){return ;
}var bW={top:this.__na,bottom:this.__na+bX.height,left:this.__nb,right:this.__nb+bX.width};

if(this.__ne.top<=bW.top&&this.__ne.bottom>=bW.bottom&&this.__ne.left<=bW.left&&this.__ne.right>=bW.right){this.__nf.setUserBounds(this.__ne.left-bW.left,this.__ne.top-bW.top,this.__ne.right-this.__ne.left,this.__ne.bottom-this.__ne.top);
}else{this._setLayerWindow(bV,this.__nb,this.__na,bX.width,bX.height,false);
}this.__nl();
}},destruct:function(){this._disposeArray(g);
this._disposeObjects(h,j,f);
this.__ne=this.__iM=this.__ni=this.__nj=null;
}});
})();
...
this.customSizes={};
},events:{"change":d},members:{__nm:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
this.__nm=null;
this.fireNonBubblingEvent(e);
},__nn:function(){if(this.__nm){return this.__nm;
...
this.__nm=s;
return s;
},__no:function(y){var z=this.__nm||this.__nn();
var A=0;
var C=z.length-1;
...
}},__np:function(K){var L=this.__nm||this.__nn();
var M=0;
var O=L.length-1;
...
}},getTotalSize:function(){var S=this.__nm||this.__nn();
...
}},destruct:function(){this.customSizes=this.__nm=null;
}});
})();
...
this.__nq=new qx.data.Array();
this.initSelection(this.__nq);
},properties:{selection:{check:j,event:m,apply:f,nullable:false,deferredInit:true},selectionMode:{check:[n,h,a,l],init:n,apply:c},dragSelection:{check:p,init:false,apply:b},quickSelection:{check:p,init:false,apply:d}},members:{_manager:null,__nr:false,__ns:false,__nq:null,_initSelectionManager:function(){var self=this;
...
},_onChangeSelection:function(e){if(this.__ns==true){return;
}this.__nr=true;
...
},_onManagerChangeSelection:function(e){if(this.__nr==true){return;
}this.__ns=true;
this.__nt();
this.__ns=false;
},__nt:function(){if(this.__nv()){return;
}var J=this._manager.getSelection();
var K=[];

for(var i=0;i<J.length;i++){K.push(this._getDataFromRow(J[i]));
}this.__nu(K);
},__nu:function(L){var M=this.getSelection();
...
}},__nv:function(){var Q=this.getSelection();
...
if(this.__nq){this.__nq.dispose();
}}});
})();
(function(){var o="one",n="single",m="selected",k="additive",j="multi",h="os.name",g="osx",f="under",d="PageUp",c="Left",O="lead",N="Down",M="Up",L="Boolean",K="PageDown",J="anchor",I="End",H="Home",G="Right",F="right",v="click",w="above",t="left",u="Escape",r="A",s="Space",p="_applyMode",q="interval",x="changeSelection",y="qx.event.type.Data",A="quick",z="key",C="abstract",B="__ny",E="drag",D="qx.ui.core.selection.Abstract";
qx.Class.define(D,{type:C,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__fO={};
},events:{"changeSelection":y},properties:{mode:{check:[n,j,k,o],init:n,apply:p},drag:{check:L,init:false},quick:{check:L,init:false}},members:{__nw:0,__nx:0,__ny:null,__nz:null,__nA:null,__nB:null,__nC:null,__nD:null,__nE:null,__nF:null,__nG:null,__nH:null,__nI:null,__nJ:null,__nK:null,__nL:null,__nM:null,__fO:null,__nN:null,__nO:null,_userInteraction:false,__nP:null,getSelectionContext:function(){return this.__nL;
...
},getSelection:function(){return qx.lang.Object.getValues(this.__fO);
},getSortedSelection:function(){var bg=this.getSelectables();
var bf=qx.lang.Object.getValues(this.__fO);
bf.sort(function(a,b){return bg.indexOf(a)-bg.indexOf(b);
});
return bf;
},isItemSelected:function(bh){var bi=this._selectableToHashCode(bh);
return this.__fO[bi]!==undefined;
},isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__fO);
...
},_setLeadItem:function(bl){var bm=this.__nM;

if(bm!==null){this._styleSelectable(bm,O,false);
}
if(bl!==null){this._styleSelectable(bl,O,true);
}this.__nM=bl;
},getLeadItem:function(){return this.__nM!==null?this.__nM:null;
},_setAnchorItem:function(bn){var bo=this.__nN;

if(bo!=null){this._styleSelectable(bo,J,false);
}
if(bn!=null){this._styleSelectable(bn,J,true);
}this.__nN=bn;
},_getAnchorItem:function(){return this.__nN!==null?this.__nN:null;
...
},handleMouseOver:function(event){if(this.__nP!=null&&this.__nP!=this._getScroll().top){this.__nP=null;
return;
...
if(this.isItemSelected(bM)&&!bL&&!bO&&!this.getDrag()){this.__nO=bM;
this._userInteraction=false;
return;
}else{this.__nO=null;
...
if(this.getDrag()&&bP!==n&&bP!==o&&!bL&&!bO){this.__nC=this._getLocation();
this.__nz=this._getScroll();
this.__nD=event.getDocumentLeft()+this.__nz.left;
this.__nE=event.getDocumentTop()+this.__nz.top;
this.__nF=true;
this._capture();
}this._fireChange(v);
this._userInteraction=false;
...
if(!bT&&!bQ&&this.__nO!=null){var bR=this._getSelectableFromMouseEvent(event);
...
},handleMouseMove:function(event){if(!this.__nF){return;
}this.__nG=event.getDocumentLeft();
this.__nH=event.getDocumentTop();
this._userInteraction=true;
var bV=this.__nG+this.__nz.left;

if(bV>this.__nD){this.__nI=1;
}else if(bV<this.__nD){this.__nI=-1;
}else{this.__nI=0;
}var bU=this.__nH+this.__nz.top;

if(bU>this.__nE){this.__nJ=1;
}else if(bU<this.__nE){this.__nJ=-1;
}else{this.__nJ=0;
}var location=this.__nC;

if(this.__nG<location.left){this.__nw=this.__nG-location.left;
}else if(this.__nG>location.right){this.__nw=this.__nG-location.right;
}else{this.__nw=0;
}
if(this.__nH<location.top){this.__nx=this.__nH-location.top;
}else if(this.__nH>location.bottom){this.__nx=this.__nH-location.bottom;
}else{this.__nx=0;
}if(!this.__ny){this.__ny=new qx.event.Timer(100);
this.__ny.addListener(q,this._onInterval,this);
}this.__ny.start();
this._autoSelect();
...
},_cleanup:function(){if(!this.getDrag()&&this.__nF){return;
}if(this.__nK){this._fireChange(v);
}delete this.__nF;
delete this.__nA;
delete this.__nB;
this._releaseCapture();
if(this.__ny){this.__ny.stop();
}},_onInterval:function(e){this._scrollBy(this.__nw,this.__nx);
this.__nz=this._getScroll();
this._autoSelect();
},_autoSelect:function(){var cg=this._getDimension();
var bY=Math.max(0,Math.min(this.__nG-this.__nC.left,cg.width))+this.__nz.left;
var bX=Math.max(0,Math.min(this.__nH-this.__nC.top,cg.height))+this.__nz.top;
if(this.__nA===bY&&this.__nB===bX){return;
}this.__nA=bY;
this.__nB=bX;
...
},__nQ:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;
var cp,co;
...
}},__nR:function(cG){var cI={};
var cH;

for(var i=0,l=cG.length;i<l;i++){cH=cG[i];
cI[this._selectableToHashCode(cH)]=cH;
}return cI;
},_getSelectedItem:function(){for(var cJ in this.__fO){return this.__fO[cJ];
}return null;
},_setSelectedItem:function(cK){if(this._isSelectable(cK)){var cL=this.__fO;
...
this.__nK=true;
this._fireChange();
},_fireChange:function(dc){if(this.__nK){this.__nL=dc||null;
...
this.__fO=this.__nO=this.__nN=null;
this.__nM=null;
}});
})();
...
}},_getLookupTable:function(){return this.__nT;
},_lookup:function(M){return this.__nT[M];
},_lookupGroup:function(N){return this.__nU.indexOf(N);
},_reverseLookup:function(O){if(O<0){return -1;
}return this.__nT.indexOf(O);
...
},_onModelChange:function(e){this.__ob();
this._applyDefaultSelection();
},__oa:function(){this.getPane().getRowConfig().setItemCount(this.__nT.length);
this.getPane().fullUpdate();
},__ob:function(){this.__nT=[];
this.__nU=[];
this.__nV={};
...
for(var i=0,l=bk.length;i<l;++i){if(bl==null||bl(bk.getItem(i))){this.__nT.push(i);
}}},_runDelegateSorter:function(bm){if(this.__nT.length==0){return;
}var bn=qx.util.Delegate.getMethod(this.getDelegate(),z);

if(bn!=null){this.__nT.sort(function(a,b){return bn(bm.getItem(a),bm.getItem(b));
});
}},_runDelegateGroup:function(bo){var bs=qx.util.Delegate.getMethod(this.getDelegate(),j);

if(bs!=null){for(var i=0,l=this.__nT.length;i<l;++i){var bp=this.__nT[i];
var br=this.getModel().getItem(bp);
var bq=bs(br);
this.__oc(bq,bp);
}this.__nT=this.__od();
}},__oc:function(bt,bu){if(bt==null){this.__nY=true;
bt=v;
}var name=this.__oe(bt);

if(this.__nV[name]==null){this.__nV[name]=[];

if(this.isAutoGrouping()){this.getGroups().push(bt);
}}this.__nV[name].push(bu);
},__od:function(){this.__of();
var by=[];
var bA=0;
...
},__oe:function(bB){var name=null;
...
},__of:function(){if(this.__nX&&this.__nY||this.__nX&&this.__nW){throw new Error("GroupingTypeError: You can't mix 'Objects' and 'Strings' as"+" group identifier!");
}}},destruct:function(){this._background.dispose();
this._provider.dispose();
this._layer.dispose();
this._background=this._provider=this._layer=this.__nT=this.__nU=this.__nV=null;

if(this.__nS){this.__nS.dispose();
}}});
})();
...
this.__iM={};
},properties:{anonymous:{refine:true,init:true}},members:{__iM:null,__bK:null,__og:null,__oh:null,__nj:null,__ni:null,getFirstRow:function(){return this.__og;
},getFirstColumn:function(){return this.__oh;
},getRowSizes:function(){return this.__nj||[];
},getColumnSizes:function(){return this.__ni||[];
},syncWidget:function(){if(!this.getContentElement().getDomElement()){return;
}
if(this.__iM.fullUpdate||this.__iM.updateLayerWindow&&this.__iM.updateLayerData){this._fullUpdate.apply(this,this.__bK);
}else if(this.__iM.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bK);
}else if(this.__iM.updateLayerData&&this.__nj){this._updateLayerData();
}
if(this.__iM.fullUpdate||this.__iM.updateLayerWindow){var c=this.__bK;
this.__og=c[0];
this.__oh=c[1];
this.__nj=c[2];
this.__ni=c[3];
}this.__iM={};
},_updateLayerData:function(){this._fullUpdate(this.__og,this.__oh,this.__nj,this.__ni);
...
},updateLayerData:function(){this.__iM.updateLayerData=true;
qx.ui.core.queue.Widget.add(this);
},fullUpdate:function(l,m,n,o){this.__bK=arguments;
this.__iM.fullUpdate=true;
qx.ui.core.queue.Widget.add(this);
},updateLayerWindow:function(p,q,r,s){this.__bK=arguments;
this.__iM.updateLayerWindow=true;
qx.ui.core.queue.Widget.add(this);
}},destruct:function(){this.__iM=this.__bK=this.__nj=this.__ni=null;
}});
})();
...
this.__oj={};
},properties:{colorEven:{nullable:true,check:d,apply:b,themeable:true},colorOdd:{nullable:true,check:d,apply:c,themeable:true}},members:{__ok:null,__ol:null,__oi:null,__oj:null,setColor:function(g,h){if(h){this.__oi[g]=qx.theme.manager.Color.getInstance().resolve(h);
}else{delete (this.__oi[g]);
}},clearCustomColors:function(){this.__oi={};
this.updateLayerData();
},getColor:function(i){var j=this.__oi[i];

if(j){return j;
}else{return i%2==0?this.__ok:this.__ol;
}},_applyColorEven:function(k,l){if(k){this.__ok=qx.theme.manager.Color.getInstance().resolve(k);
}else{this.__ok=null;
}this.updateLayerData();
},_applyColorOdd:function(m,n){if(m){this.__ol=qx.theme.manager.Color.getInstance().resolve(m);
}else{this.__ol=null;
}this.updateLayerData();
},setBackground:function(o,p){if(p){this.__oj[o]=qx.theme.manager.Decoration.getInstance().resolve(p);
}else{delete (this.__oj[o]);
}this.updateLayerData();
},getBackground:function(q){return this.__oj[q];
}},destruct:function(){this.__oi=this.__oj=null;
}});
})();
...
if(this.__om(J)){this.updateLayerData();
}},setBackground:function(L,M){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,L,M);

if(this.__om(L)){this.updateLayerData();
}},__om:function(N){var P=this.getFirstRow();
...
}},_removeBindingsFrom:function(T){var U=this.__oq(T);
...
if(qx.lang.Array.contains(this.__on,T)){qx.lang.Array.remove(this.__on,T);
}},__oo:function(W,X,Y){var ba=j+W+m;

if(Y==k){ba=i+W+m;
}
if(X!=null&&X!=n){ba+=a+X;
}return ba;
},__op:function(bb,bc){var bd=this.__oq(bb);

if(!qx.lang.Array.contains(bd,bc)){bd.push(bc);
}
if(!qx.lang.Array.contains(this.__on,bb)){this.__on.push(bb);
}},__oq:function(be){var bf=be.getUserData(l);

if(bf==null){bf=[];
be.setUserData(l,bf);
}return bf;
}},destruct:function(){this.__on=null;
}});
})();
...
return s;
},styleSelectabled:function(u){var v=this.__or(u);
this._styleSelectabled(v);
},styleUnselectabled:function(w){var x=this.__or(w);
...
}},_styleSelectabled:function(A){this.__os(A,{selected:1});
},_styleUnselectabled:function(B){this.__os(B,{});
...
},__or:function(G){return this._list._layer.getRenderedCellWidget(G,0);
},__os:function(H,I){if(H==null){return;
...
this.__ot=[];
},properties:{anonymous:{refine:true,init:false}},events:{updated:b},members:{__ot:null,getRenderedCellWidget:function(h,j){var k=this.getColumnSizes().length;
...
}},_getSpacer:function(){var q=this.__ot.pop();
...
if(D.getUserData(f)){this.__ot.push(D);
...
if(V.getUserData(f)){this.__ot.push(V);
...
}this._cellProvider=this.__ot=null;
}});
})();
...
},getCellWidget:function(l,m){var n=this.__ou();
...
while(p){p.destroy();
p=this.__cO.pop();
}},__ou:function(){var q=this.__cO.pop();
...
qx.Mixin.define(k,{properties:{contentPaddingTop:{check:p,init:0,apply:o,themeable:true},contentPaddingRight:{check:p,init:0,apply:o,themeable:true},contentPaddingBottom:{check:p,init:0,apply:o,themeable:true},contentPaddingLeft:{check:p,init:0,apply:o,themeable:true},contentPadding:{group:[e,a,d,c],mode:b,themeable:true}},members:{__ov:{contentPaddingTop:i,contentPaddingRight:h,contentPaddingBottom:m,contentPaddingLeft:f},__ow:{contentPaddingTop:l,contentPaddingRight:n,contentPaddingBottom:g,contentPaddingLeft:j},_applyContentPadding:function(q,r,name){var s=this._getContentPaddingTarget();
...
(function(){var a="github.Application";
qx.Class.define(a,{extend:demobrowser.demo.data.Github,members:{main:function(){demobrowser.demo.data.Github.prototype.main.call(this);
}}});
})();
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__ox=new qx.ui.decoration.css3.BorderImage();

if(p){this.__oy(p);
}}else{this.__ox=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__ox.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__ox:null,getMarkup:function(){return this.__ox.getMarkup();
},resize:function(r,s,t){this.__ox.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__ox.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__ox[y](w);
},_applyBaseImage:function(z,A){if(this.__ox instanceof qx.ui.decoration.GridDiv){this.__ox.setBaseImage(z);
}else{this.__oy(z);
}},__oy:function(B){var G,H,J,I;
this.__ox.setBorderImage(B);
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__oz:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__oz;
},getMarkup:function(){if(this.__oz){return this.__oz;
...
this.__oz=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__oz;
...
}},destruct:function(){this.__oz=null;
}});
})();
...
}},members:{__oz:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__oz;
},getMarkup:function(e){if(this.__oz){return this.__oz;
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__oz:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__oz;
},_applyStyle:function(){},getMarkup:function(){if(this.__oz){return this.__oz;
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__oE;
this._resizeBorder=this.__oD;
this._styleBorder=this.__oB;
this._generateMarkup=this.__oC;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__oA:null,__oB:function(D){{var F=qx.theme.manager.Color.getInstance();
...
}},__oC:function(K){var O=this._generateBackgroundMarkup(K);
...
K[y]=0;
K[p]=0;
return this.__oA=this._generateBackgroundMarkup(K,O);
},__oD:function(S,T,U){var V=this.getInsets();
T-=V.left+V.right;
U-=V.top+V.bottom;
...
},__oE:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
