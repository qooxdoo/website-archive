...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:portal.adc9fce3a020.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
this.__tA=[];
this.__tB={};
},statics:{dataKeyRoot:h,dataKeyGroupBoxes:m,dataKeyBoxes:d},events:{"loaded":e},properties:{activeBox:{init:null,check:g,apply:c}},members:{__tz:null,__tA:null,__tB:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);
}n.setActive(true);
...
qx.lang.Array.remove(this.__tB[z],A);
qx.lang.Array.insertAt(this.__tB[y],A,B);
},getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__tA.length,D;i<j;i++){D=this.__tB[this.__tA[i].id];

for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__tA[i];
}}}return null;
}},destruct:function(){this.__tz=this.__tA=this.__tB=null;
}});
})();
...
this.__tD=new portal.box.Resizable(this,x);
}if(t.draggable){this.setDraggable(true);
this.__tE=new portal.box.Draggable(this);
}this.__tG();
},properties:{element:{init:null},groupBoxId:{init:null,check:h},active:{check:s,init:false,apply:j},resizable:{check:s,init:false},draggable:{check:s,init:false}},members:{__cq:null,__tC:null,__tE:null,__tD:null,_applyActive:function(y,z){if(y){qx.bom.element.Style.set(this.getElement(),q,a);
...
},getDraggableComponent:function(){return this.__tE;
},getResizableComponent:function(){return this.__tD;
},__tF:function(A,B){if(B){for(var C in B){qx.bom.element.Style.set(C,B[C]);
}}qx.bom.element.Style.set(A,l,b);
qx.bom.element.Style.set(A,k,0);
qx.bom.Element.addListener(A,o,this.__tH,this,true);
},__tG:function(){var E=f+g;
E=E+r+E+r+E;
var D=qx.bom.Element.create(d,{"class":i});
D.innerHTML=E;
qx.dom.Element.insertEnd(D,this.getElement());
},__tH:function(e){portal.box.Manager.getInstance().setActiveBox(this);
}},destruct:function(){this.resetElement();
this.__tC=this.__tD=this.__tE=null;
}});
})();
...
this.__tI=v;
this.__kj=this.__tI.getElement();
this.__tJ={};
this.__tK=false;
this.__tL={orientation:null,lastCoord:{left:null,top:null}};
this.__tM={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};

for(var name in this.__tM){if(w[name]){this.__tM[name]=w[name];
}}this.__tF();
},members:{__tL:null,__tI:null,__kj:null,__tJ:null,__tM:null,__tK:false,getBox:function(){return this.__tI;
},__tF:function(){switch(this.__tM.handles){case 1:this.__tJ.east=null;
break;
case 2:this.__tJ.south=null;
break;
case 3:this.__tJ.south=null;
this.__tJ.southeast=null;
this.__tJ.east=null;
break;
}for(var y in this.__tJ){var x=this.__tJ[y]=qx.bom.Element.create(f);
qx.bom.element.Attribute.set(x,o,y);
qx.dom.Element.insertEnd(x,this.__kj);

if(this.__kj.id){x.id=this.__kj.id+h+y;
}this.__tN(y);
this.__tO(y);
}},__tN:function(z){qx.bom.element.Class.add(this.__tJ[z],z+j);
qx.bom.element.Style.set(this.__tJ[z],u,this.__tM.autoHide?t:q);
},__tO:function(A){var C=qx.event.Registration;
var B=this.__tJ[A];
C.addListener(B,i,this.__tR,this);
C.addListener(document,m,this.__tS,this);

if(this.__tM.autoHide){C.addListener(this.__tI.getElement(),s,this.__tP,this);
C.addListener(this.__tI.getElement(),r,this.__tQ,this);
}},__tP:function(e){for(var D in this.__tJ){qx.bom.element.Style.set(this.__tJ[D],u,q);
}},__tQ:function(e){if(!this.__tK){for(var E in this.__tJ){qx.bom.element.Style.set(this.__tJ[E],u,t);
}}},__tR:function(e){e.stopPropagation();
if(e.isLeftPressed()){qx.event.Registration.addListener(document,p,this.__tT,this,true);
this.__tK=true;
var F=e.getTarget();
this.__tL.orientation=qx.bom.element.Attribute.get(F,o);
this.__tL.lastCoord.left=e.getDocumentLeft();
this.__tL.lastCoord.top=e.getDocumentTop();
portal.box.Util.bringToFront(this.__kj);
}},__tS:function(e){e.stopPropagation();

if(this.__tK){qx.event.Registration.removeListener(document,p,this.__tT,this,true);
portal.box.Util.sendToBack(this.__kj);

if(this.__tM.autoHide){for(var G in this.__tJ){qx.bom.element.Style.set(this.__tJ[G],u,t);
}}this.__tK=false;
qx.bom.Selection.clear(document.body);
}},__tT:function(e){e.stopPropagation();

if(this.__tK){var H={left:null,top:null};

switch(this.__tL.orientation){case n:H.top=e.getDocumentTop();
break;
...
break;
}this.__tU(H,this.__tL.lastCoord);
this.__tL.lastCoord.left=e.getDocumentLeft();
this.__tL.lastCoord.top=e.getDocumentTop();
}},__tU:function(I,J){var Q=qx.bom.element.Dimension;
var N=portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__tI.getId());
var P=Q.getContentSize(N.element);

if(I.left){var M=I.left-J.left;

if(M!==0){var L=Q.getContentWidth(this.__kj)+M;
var O=Q.getWidth(this.__kj)+M;

if((this.__tM.minWidth==null||L>this.__tM.minWidth)&&(this.__tM.maxWidth==null||L<=this.__tM.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__kj,k,L+d);
this.__tI.getData().width=L;
}}}}
if(I.top){var M=I.top-J.top;

if(M!==0){var K=Q.getContentHeight(this.__kj)+M;

if((this.__tM.minHeight==null||K>this.__tM.minHeight)&&(this.__tM.maxHeight==null||K<=this.__tM.maxHeight)){qx.bom.element.Style.set(this.__kj,c,K+b);
}}}}},destruct:function(){if(this.__tM.autoHide){qx.event.Registration.removeListener(this.__tI.getElement(),s,this.__tP,this);
qx.event.Registration.removeListener(this.__tI.getElement(),r,this.__tQ,this);
}this.__tI=this.__tM=this.__kj=this.__tJ=null;
this.__tL=null;
}});
})();
...
qx.Class.define(b,{statics:{__tV:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,c);
e=e==a?0:e;
qx.bom.element.Style.set(d,c,e+this.__tV);
},sendToBack:function(f){var g=qx.bom.element.Style.get(f,c);
qx.bom.element.Style.set(f,c,g-this.__tV);
}}});
})();
...
this.__tI=p;
this.__kj=p.getElement();
this.__tW=null;
this.__tX=null;
this.__tF();
},members:{__tI:null,__kj:null,__tW:null,__tX:null,getBox:function(){return this.__tI;
},getElement:function(){return this.__kj;
},__tF:function(){this.__tY();
this.__tO();
},__tY:function(){this.__tW=qx.bom.Element.create(f);
qx.bom.element.Class.add(this.__tW,d);
qx.dom.Element.insertBegin(this.__tW,this.__kj);
},__tO:function(){qx.bom.Element.addListener(this.__tW,k,this.__nC,this);
qx.bom.Element.addListener(this.__tW,i,function(e){qx.bom.element.Style.set(this,c,b);
},this.__tW);
qx.bom.Element.addListener(this.__tW,m,this.__uc,this);
qx.bom.Element.addListener(this.__tW,g,portal.dragdrop.Manager.getInstance().stopSession,portal.dragdrop.Manager.getInstance());
qx.bom.Element.addListener(this.__tW,h,this.__ud,this);
},__nC:function(e){if(e.isLeftPressed()){this.__tX={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__kj),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__kj)};
qx.bom.Element.addListener(document.body,n,this.__ub,this,true);
this.__ua();
qx.event.Registration.fireEvent(this.__tW,m,qx.event.type.Event);
}},__ua:qx.core.Environment.select(l,{"mshtml":function(){var r=this;
var q=qx.lang.Function.bind(this.__ub,r);
document.getElementsByTagName(a)[0].onmouseleave=q;
},"default":qx.lang.Function.empty}),__ub:function(e){try{e.stopPropagation();
}catch(s){}
if(portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,o,this.__ud,this,true);
portal.dragdrop.Manager.getInstance().stopSession();
}qx.bom.Element.removeListener(document.body,n,this.__ub,this,true);
},__uc:function(e){if(portal.dragdrop.Manager.getInstance().isSessionActive()){return;
}portal.box.Manager.getInstance().setActiveBox(this.__tI);
portal.dragdrop.Manager.getInstance().startSession(this.__tI);
qx.event.Registration.addListener(document.body,o,this.__ud,this,true);
},__ud:function(e){e.stopPropagation();
var t=e.getDocumentLeft()-this.__tX.left;
var top=e.getDocumentTop()-this.__tX.top;
...
}},destruct:function(){this.__tI=this.__tW=this.__kj=this.__tX=null;
}});
})();
...
this.__ue={top:null,height:null};
this.__uf={top:0,left:0};
},properties:{activeBox:{check:u,init:null,nullable:true},sessionActive:{check:r,init:false}},members:{__ue:null,__ug:null,__uh:false,__uf:null,__ui:null,__uj:null,startSession:function(y){this.setSessionActive(true);
this.setActiveBox(y);
this.__ug=y.getGroupBoxId();
this.__uk();
if(this.__ui==null){this.__ui={};
var z=portal.box.Manager.getInstance().getGroupBoxes();

for(var i=0,j=z.length;i<j;i++){this.__ui[z[i].element.id]={left:qx.bom.element.Location.getLeft(z[i].element),right:qx.bom.element.Location.getLeft(z[i].element)+qx.bom.element.Dimension.getWidth(z[i].element)};
}}},__uk:function(){if(!this.__uj){this.__uj=qx.bom.Element.create(b);
}var C=this.getActiveBox().getElement();
var A=qx.bom.element.Dimension.getContentSize(C);
this.__ul(C,this.__uj);
qx.bom.element.Class.add(this.__uj,qx.bom.element.Class.get(C));
var B=k+d+qx.bom.element.Location.getTop(C)+w+c+qx.bom.element.Location.getLeft(C)+w+o+A.width+w+f+A.height+x;
qx.bom.element.Style.setCss(this.__uj,B);
qx.bom.element.Style.set(C,v,t);
qx.dom.Node.getBodyElement(C).appendChild(this.__uj);
portal.box.Util.bringToFront(this.__uj);
},__ul:function(D,E){while(D.firstChild){E.appendChild(D.firstChild);
}},stopSession:function(e){this.setSessionActive(false);
var G=this.getActiveBox();
var H=G.getElement();
portal.box.Manager.getInstance().updateGroupBoxMembers(G.getGroupBoxId(),this.__ug,G);
G.setGroupBoxId(this.__ug);
var F=new qx.fx.effect.core.Move(this.__uj);
F.set({x:qx.bom.element.Location.getLeft(H),y:qx.bom.element.Location.getTop(H),mode:h,duration:0.5,transition:g});
F.start();
F.addListener(n,function(){this.__ul(this.__uj,H);
qx.bom.element.Style.reset(H,v);
this.__uj.parentNode.removeChild(this.__uj);

if(G.isActive()){G._applyActive(true);
}else{portal.box.Manager.getInstance().setActiveBox(G);
}},this);
},onDragMove:function(top,I){if(this.__uf.left!=I){qx.bom.element.Style.set(this.__uj,q,I+x);
}
if(this.__uf.top!=top){qx.bom.element.Style.set(this.__uj,s,top+x);
}var J=this.getActiveBox().getElement();

if(this.__ue.top==null){this.__ue.top=qx.bom.element.Location.getTop(J);
}
if(this.__ue.height==null){this.__ue.height=qx.bom.element.Dimension.getHeight(J);
}if(this.__uh==false&&top>=this.__ue.top&&top<=(this.__ue.top+this.__ue.height)){return;
}var K;
if(this.__uh){K=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__ug));
while(K!=null){if(this.__um(true,top,J,K)){this.__uh=false;
return;
}K=qx.dom.Hierarchy.getNextElementSibling(K);
}}else{K=J;
}if(top-this.__uf.top>0){K=qx.dom.Hierarchy.getNextElementSibling(K);

while(K!=null){if(K){if(this.__um(true,top,J,K)){return;
}}K=qx.dom.Hierarchy.getNextElementSibling(K);
}}else{var K=qx.dom.Hierarchy.getPreviousElementSibling(K);

while(K!=null){if(K){if(this.__um(false,top,J,K)){return;
}}K=qx.dom.Hierarchy.getPreviousElementSibling(K);
}}this.__uf.left=I;
this.__uf.top=top;
},__um:function(L,top,M,N){var O=qx.bom.element.Location.getTop(N);
...
this.__ue.top=qx.bom.element.Location.getTop(M);
}return true;
...
},checkGroupBox:function(T,U){if(this.__ui[this.__ug].left<=T&&this.__ui[this.__ug].right>=T){return;
}
for(var V in this.__ui){if(V!=this.__ug){if(this.__ui[V].left<=T+U&&this.__ui[V].right>=T){this.__ug=V;
this.__uh=true;
return;
}}}}},destruct:function(){this.__ue=this.__uf=this.__ug=null;
this.__un=this.__uj=this.__ui=null;
}});
})();
