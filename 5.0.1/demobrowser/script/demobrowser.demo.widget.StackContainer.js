...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.StackContainer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.StackContainer.ed00c2e78108.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="x",c="Selected: ",d="yellow",f="teal",g="gray",h="red",j=")",k="Resize to: ",l="Next",m=" (",n="demobrowser.demo.widget.StackContainer",o="Previous",p="green",q="icon/22/actions/go-next.png",r="changeSelection",s="icon/22/actions/go-previous.png",t="orange",u="main",v="blue",w="execute";qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.addSimpleStack();this.addDynamicStack();}
,addSimpleStack:function(){var z=new qx.ui.container.Stack();z.setDecorator(u);z.setWidth(200);z.setHeight(120);this.getRoot().add(z,{left:20,top:20});var x=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));var C=new qx.ui.form.Button(o,s);var A=new qx.ui.form.Button(l,q);x.add(C);x.add(A);this.getRoot().add(x,{left:20,top:150});C.addListener(w,z.previous,z);A.addListener(w,z.next,z);var B=[h,g,v,t,f,d,p];var y;for(var i=0;i<B.length;i++ ){y=new qx.ui.core.Widget;y.setBackgroundColor(B[i]);z.add(y);}
;z.addListener(r,function(e){this.debug(c+e.getData()[0].getBackgroundColor());}
);}
,addDynamicStack:function(){var F=new qx.ui.container.Stack();F.setDecorator(u);F.setDynamic(true);this.getRoot().add(F,{left:250,top:20});var D=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));var I=new qx.ui.form.Button(o,s);var G=new qx.ui.form.Button(l,q);D.add(I);D.add(G);this.getRoot().add(D,{left:250,top:150});I.addListener(w,F.previous,F);G.addListener(w,F.next,F);var H=[h,g,v,t,f,d,p];var E;for(var i=0;i<H.length;i++ ){E=new qx.ui.core.Widget;E.setBackgroundColor(H[i]);E.setWidth((Math.round(i/2)+1)*50);E.setHeight((Math.round(i/3)+1)*40);F.add(E);}
;F.addListener(r,function(e){var J=e.getData()[0];this.debug(c+J.getBackgroundColor()+m+J.getWidth()+b+J.getHeight()+j);}
);F.addListener(a,function(e){var K=this.getBounds();this.debug(k+K.width+b+K.height);}
);}
}});}
)();
