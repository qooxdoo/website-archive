...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.bb04f604afeb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__IL=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__wL=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__wL:null,__IL:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__wL!=null){i.stop(this.__wL);this.__wL=null;}
;this.__wL=i.start(function(){this.__IL.update();this.__wL=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__IL=null;}
});}
)();
(function(){var a="qx.util.TimerManager",b="interval",c="singleton";qx.Class.define(a,{extend:qx.core.Object,type:c,statics:{__DE:[],__DF:{},__wL:0},members:{__DG:false,start:function(g,f,h,d,j){if(!j){j=f||0;}
;var e=(new Date()).getTime()+j;this.self(arguments).__DF[ ++this.self(arguments).__wL]={callback:g,userData:d||null,expireAt:e,recurTime:f,context:h||this};this.__DH(e,this.self(arguments).__wL);return this.self(arguments).__wL;}
