...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.d33e579dd39b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__HX].values;var bo=this.__HT[this.__HX];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__HY){bn.shift();}
...
;this.__HV.setRed(bx);this.__HV.setGreen(bw);this.__HV.setBlue(bv);this.__HU.open();}
,_onColorSelectorOk:function(){var by=this.__HV;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__HU.close();}
,_onColorSelectorCancel:function(){this.__HU.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__HU){this.__HU.destroy();this.__HV.destroy();this.__HW.destroy();}
;this._tables=this.__HT=null;}
});}
)();
