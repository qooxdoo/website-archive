...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.MultiPageForm","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.MultiPageForm.085c7f5d4f6a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeBubble",b="name",c="password",d="enabled",f="Birthdate:",g="valid",h="email",i="value",j="next",k="back",l="Email:",m="birthdate",n="demobrowser.demo.ui.MultiPageForm",o="Name:",p="Password:",q="submit",r="execute";qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var B=new qx.ui.container.Stack();this.getRoot().add(B,{left:10,top:10});var w=new qx.ui.layout.Grid();w.setSpacing(5);var K=new qx.ui.container.Composite(w);B.add(K);var s=new qx.ui.basic.Label(o);K.add(s,{row:0,column:0});var name=new qx.ui.form.TextField();name.setRequired(true);K.add(name,{row:0,column:1});var y=new qx.ui.basic.Label(p);K.add(y,{row:1,column:0});var H=new qx.ui.form.PasswordField();H.setRequired(true);K.add(H,{row:1,column:1});var t=new qx.ui.form.Button(j);K.add(t,{row:2,column:1});t.addListener(r,B.next,B);var z=new qx.ui.layout.Grid();z.setSpacing(5);var I=new qx.ui.container.Composite(z);B.add(I);var F=new qx.ui.basic.Label(l);I.add(F,{row:0,column:0});var J=new qx.ui.form.TextField();I.add(J,{row:0,column:1});var u=new qx.ui.basic.Label(f);I.add(u,{row:1,column:0});var A=new qx.ui.form.DateField();A.setRequired(true);I.add(A,{row:1,column:1});var v=new qx.ui.form.Button(k);I.add(v,{row:2,column:0});v.addListener(r,B.previous,B);var C=new qx.ui.form.Button(q);C;I.add(C,{row:2,column:1});var x={name:null,password:null,email:null,birthdate:null};var G=qx.data.marshal.Json.createModel(x,true);var D=new qx.data.controller.Object(G);D.addTarget(name,i,b,true);D.addTarget(H,i,c,true);D.addTarget(J,i,h,true);D.addTarget(A,i,m,true);C.addListener(r,function(){alert(qx.util.Serializer.toUriParameter(G));}
,this);var E=new qx.ui.form.validation.Manager();E.add(name);E.add(H);E.add(J,qx.util.Validate.email());E.add(A);G.addListener(a,function(e){E.validate();}
,this);E.validate();E.bind(g,C,d);}
}});}
)();
(function(){var a=" array contains ",b="__gz",c="qx.ui.core.MSingleSelectionHandling",d=" items!",f="changeSelection",g="changeSelected",h="Could only select one item, but the selection",i="qx.event.type.Data";qx.Mixin.define(c,{events:{"changeSelection":i},members:{__gz:null,getSelection:function(){var j=this.__lQ().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__lQ().setSelected(k[0]);break;default:throw new Error(h+a+k.length+d);};}
,resetSelection:function(){this.__lQ().resetSelected();}
,isSelected:function(l){return this.__lQ().isSelected(l);}
,isSelectionEmpty:function(){return this.__lQ().isSelectionEmpty();}
,getSelectables:function(m){return this.__lQ().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(f,o,n);}
,__lQ:function(){if(this.__gz==null){var p=this;this.__gz=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
...
(function(){var a=", because it is not a child element!",b="__lR",c="Boolean",d="qx.ui.core.SingleSelectionManager",e="qx.debug",f="__lS",g="Invalid selectionProvider!",h="Could not check if ",j="__lT",k="Could not select ",l="changeSelected",m=" because it is not a child element!",n=" is selected,",o="qx.event.type.Data";qx.Class.define(d,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(e)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,g);}
;this.__lR=p;}
,events:{"changeSelected":o},properties:{allowEmptySelection:{check:c,init:true,apply:j}},members:{__lS:null,__lR:null,getSelected:function(){return this.__lS;}
,setSelected:function(q){if(!this.__lV(q)){throw new Error(k+q+a);}
;this.__lU(q);}
,resetSelected:function(){this.__lU(null);}
,isSelected:function(r){if(!this.__lV(r)){throw new Error(h+r+n+m);}
;return this.__lS===r;}
,isSelectionEmpty:function(){return this.__lS==null;}
,getSelectables:function(t){var s=this.__lR.getItems();var u=[];for(var i=0;i<s.length;i++ ){if(this.__lR.isItemSelectable(s[i])){u.push(s[i]);}
;}
;if(!t){for(var i=u.length-1;i>=0;i-- ){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__lT:function(w,v){if(!w){this.__lU(this.__lS);}
;}
,__lU:function(x){var A=this.__lS;var y=x;if(y!=null&&A===y){return;}
;if(!this.isAllowEmptySelection()&&y==null){var z=this.getSelectables(true)[0];if(z){y=z;}
;}
;this.__lS=y;this.fireDataEvent(l,y,A);}
,__lV:function(B){var C=this.__lR.getItems();for(var i=0;i<C.length;i++ ){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__lR.toHashCode){this._disposeObjects(b);}
else {this.__lR=null;}
...
,__lP:function(e){var m=e.getOldData()[0];var n=e.getData()[0];if(m){if(this.isDynamic()){m.exclude();}
else {m.hide();}
;}
;if(n){n.show();}
;}
...
,_onHtmlInput:function(e){var dd=e.getData();var dc=true;this.__pt=false;if(this.__iU&&this.__iU===dd){dc=false;}
...
;}
;if(dc){this.fireDataEvent(r,dd,this.__iU);this.__iU=dd;if(this.getLiveUpdate()){this.__pv(dd);}
;}
;}
,_onWebFontStatusChange:function(dh){if(dh.getData().valid===true){var dg=this.__ml.getStyles();this.__pu=qx.bom.Label.getTextSize(D,dg);qx.ui.core.queue.Layout.add(this);}
;}
,__pv:function(dj){var di=this.__iT;this.__iT=dj;if(di!=dj){this.fireNonBubblingEvent(c,qx.event.type.Data,[dj,di]);}
;}
...
;}
;if(qx.lang.Type.isString(dn)){var dm=this.getContentElement();if(dm.getValue()!=dn){var dk=dm.getValue();dm.setValue(dn);var dl=this.__pt?null:dn;this.__iT=dk;this.__pv(dl);this.__iU=this.__iT;}
...
;if(!this.__ps&&qx.ui.form.AbstractField.__dP){qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__dP);qx.ui.form.AbstractField.__dP=null;qx.ui.form.AbstractField.__pr();}
;}
...
(function(){var a="indexOf",b="addAfter",c="add",d="addBefore",e="_",f="addAt",g="hasChildren",h="removeAt",i="removeAll",j="getChildren",k="remove",l="qx.ui.core.MRemoteChildrenHandling";qx.Mixin.define(l,{members:{__nR:function(q,m,o,n){var p=this.getChildrenContainer();if(p===this){q=e+q;}
;return (p[q])(m,o,n);}
,getChildren:function(){return this.__nR(j);}
,hasChildren:function(){return this.__nR(g);}
,add:function(s,r){return this.__nR(c,s,r);}
,remove:function(t){return this.__nR(k,t);}
,removeAll:function(){return this.__nR(i);}
,indexOf:function(u){return this.__nR(a,u);}
,addAt:function(x,v,w){this.__nR(f,x,v,w);}
,addBefore:function(y,A,z){this.__nR(d,y,A,z);}
,addAfter:function(D,B,C){this.__nR(b,D,B,C);}
,removeAt:function(E){return this.__nR(h,E);}
}});}
)();
...
(function(){var a="popupOpen",b="blur",c="qx.util.format.DateFormat",d="Escape",f="changeValue",g="Left",h="Down",i="button",j="Up",k="execute",l="qx.event.type.Data",m="inner",n="list",o="changeLocale",p="visible",q="middle",r="String",s="_applyDateFormat",t="pointerup",u="",v="changeVisibility",w="textfield",x="qx.dynlocale",y="medium",z="focusin",A="popup",B="qx.ui.form.DateField",C="focusout",D="datefield",E="_applyPlaceholder",F="hidden",G="tap",H="Right";qx.Class.define(B,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.form.MForm],implement:[qx.ui.form.IForm,qx.ui.form.IDateForm],construct:function(){qx.ui.core.Widget.call(this);var J=new qx.ui.layout.HBox();this._setLayout(J);J.setAlignY(q);var I=this._createChildControl(w);this._createChildControl(i);this.addListener(G,this._onTap,this);this.addListener(b,this._onBlur,this);this.addListener(z,function(e){I.fireNonBubblingEvent(z,qx.event.type.Focus);I.setTextSelection(0,0);}
,this);this.addListener(C,function(e){I.fireNonBubblingEvent(C,qx.event.type.Focus);}
,this);this._setDefaultDateFormat();this._addLocaleChangeListener();}
,events:{"changeValue":l},properties:{dateFormat:{check:c,apply:s},placeholder:{check:r,nullable:true,apply:E},appearance:{refine:true,init:D},focusable:{refine:true,init:true},width:{refine:true,init:120}},statics:{__HD:null,__HE:null,getDefaultDateFormatter:function(){var K=qx.locale.Date.getDateFormat(y).toString();if(K==this.__HD){return this.__HE;}
;if(this.__HE){this.__HE.dispose();}
;this.__HE=new qx.util.format.DateFormat(K,qx.locale.Manager.getInstance().getLocale());this.__HD=K;return this.__HE;}
},members:{__HF:null,_forwardStates:{focused:true,invalid:true},_setDefaultDateFormat:function(){this.setDateFormat(qx.ui.form.DateField.getDefaultDateFormatter());}
,_addLocaleChangeListener:function(){if(qx.core.Environment.get(x)){this.__HF=qx.locale.Manager.getInstance().addListener(o,function(){this._setDefaultDateFormat();}
,this);}
;}
,setValue:function(N){var L=this.getChildControl(w);L.setValue(this.getDateFormat().format(N));var M=this.getChildControl(n);M.setValue(N);}
,getValue:function(){var O=this.getChildControl(w).getValue();try{return this.getDateFormat().parse(O);}
catch(P){return null;}
;}
,resetValue:function(){var Q=this.getChildControl(w);Q.setValue(u);var R=this.getChildControl(n);R.setValue(null);}
,open:function(){var S=this.getChildControl(A);S.placeToWidget(this,true);S.show();}
,close:function(){this.getChildControl(A).hide();}
,toggle:function(){var T=this.getChildControl(A).isVisible();if(T){this.close();}
else {this.open();}
;}
,_applyDateFormat:function(Y,W){if(!W){return;}
;try{var V=this.getChildControl(w);var X=V.getValue();var U=W.parse(X);V.setValue(Y.format(U));}
catch(ba){}
;}
,_applyPlaceholder:function(bc,bb){this.getChildControl(w).setPlaceholder(bc);}
,_createChildControlImpl:function(bf,be){var bd;switch(bf){case w:bd=new qx.ui.form.TextField();bd.setFocusable(false);bd.addState(m);bd.addListener(f,this._onTextFieldChangeValue,this);bd.addListener(b,this.close,this);this._add(bd,{flex:1});break;case i:bd=new qx.ui.form.Button();bd.setFocusable(false);bd.setKeepActive(true);bd.addState(m);bd.addListener(k,this.toggle,this);this._add(bd);break;case n:bd=new qx.ui.control.DateChooser();bd.setFocusable(false);bd.setKeepFocus(true);bd.addListener(k,this._onChangeDate,this);break;case A:bd=new qx.ui.popup.Popup(new qx.ui.layout.VBox);bd.setAutoHide(false);bd.add(this.getChildControl(n));bd.addListener(t,this._onChangeDate,this);bd.addListener(v,this._onPopupChangeVisibility,this);break;};return bd||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bf);}
,_onChangeDate:function(e){var bg=this.getChildControl(w);var bh=this.getChildControl(n).getValue();bg.setValue(this.getDateFormat().format(bh));this.close();}
,_onTap:function(e){this.close();}
,_onBlur:function(e){this.close();}
,_onKeyPress:function(e){var bi=e.getKeyIdentifier();if(bi==h&&e.isAltPressed()){this.toggle();e.stopPropagation();return;}
;var bj=this.getChildControl(A);if(bj.getVisibility()==F){return;}
;if(bi==d){this.close();e.stopPropagation();return;}
;if(bi===g||bi===H||bi===h||bi===j){e.preventDefault();}
;this.getChildControl(n).handleKeyPress(e);}
,_onPopupChangeVisibility:function(e){e.getData()==p?this.addState(a):this.removeState(a);var bl=this.getChildControl(A);if(bl.isVisible()){var bm=this.getChildControl(n);var bk=this.getValue();bm.setValue(bk);}
;}
,_onTextFieldChangeValue:function(e){var bn=this.getValue();if(bn!=null){var bo=this.getChildControl(n);bo.setValue(bn);}
;this.fireDataEvent(f,this.getValue());}
,isEmpty:function(){var bp=this.getChildControl(w).getValue();return bp==null||bp==u;}
},destruct:function(){if(qx.core.Environment.get(x)){if(this.__HF){qx.locale.Manager.getInstance().removeListenerById(this.__HF);}
;}
;}
});}
)();
(function(){var a='format',b="short",c="HH:mm",d='_',e="stand-alone",f="HHmmsszz",g="cldr_date_format_",h="HHmm",j="narrow",k="HHmmss",l="qx.debug",m="This case should never happen.",n="cldr_time_format_",o="sat",p="abbreviated",q="wide",r="HH:mm:ss zz",s="full",t="cldr_pm",u="cldr_day_",v="_",w="cldr_month_",x="long",y="wed",z="medium",A="fri",B="cldr_am",C="tue",D="qx.locale.Date",E="mon",F="cldr_date_time_format_",G="sun",H="format",I="thu",J="HH:mm:ss",K='stand-alone';qx.Class.define(D,{statics:{__qP:qx.locale.Manager.getInstance(),getAmMarker:function(L){return this.__qP.localize(B,[],L);}
,getPmMarker:function(M){return this.__qP.localize(t,[],M);}
...
;var Q=[G,E,C,y,I,A,o];var R=[];for(var i=0;i<Q.length;i++ ){var N=u+S+v+length+v+Q[i];R.push(P?this.__qQ(S,S===a?K:a,N,O):this.__qP.localize(N,[],O));}
;return R;}
...
;var W=[G,E,C,y,I,A,o];var T=u+U+v+length+v+W[Y];return X?this.__qQ(U,U===a?K:a,T,V):this.__qP.localize(T,[],V);}
...
;var bd=[];for(var i=0;i<12;i++ ){var ba=w+be+v+length+v+(i+1);bd.push(bc?this.__qQ(be,be===a?K:a,ba,bb):this.__qP.localize(ba,[],bb));}
;return bd;}
...
;var bf=w+bg+v+length+v+(bi+1);return bj?this.__qQ(bg,bg===a?K:a,bf,bh):this.__qP.localize(bf,[],bh);}
,getDateFormat:function(bm,bk){if(qx.core.Environment.get(l)){qx.core.Assert.assertInArray(bm,[b,z,x,s]);}
;var bl=g+bm;return this.__qP.localize(bl,[],bk);}
,getDateTimeFormat:function(br,bp,bn){var bq=F+br;var bo=this.__qP.localize(bq,[],bn);if(bo==bq){bo=bp;}
;return bo;}
,getTimeFormat:function(bv,bs){if(qx.core.Environment.get(l)){qx.core.Assert.assertInArray(bv,[b,z,x,s]);}
;var bu=n+bv;var bt=this.__qP.localize(bu,[],bs);if(bt!=bu){return bt;}
...
else {bK=this.__qP.getTerritory()||this.__qP.getLanguage();}
;return bK.toUpperCase();}
,__qQ:function(bN,bM,bQ,bP){var bO=this.__qP.localize(bQ,[],bP);if(bO==bQ){var bL=bQ.replace(d+bN+d,d+bM+d);return this.__qP.localize(bL,[],bP);}
else {return bO;}
;}
}});}
)();
...
(function(){var a="-",b="QQQ",c='W',d="qqqq",e="h",f="KK",g='L',h=" is not supported",m="Z",n="Date string '",o="GGGGG",p='abbreviated',q="Y+",r=". Wildcard ",s="eeeee",t="(\\d\\d?)",u="LL",v="abbreviated",w="EEEE",x="^",y=":",z='y',A="quoted_literal",B="weekOfYear",C='3rd quarter',D="SSS",E='a',F="day",G="(-*",H="qqq",I="(\\d\\d)",J="locale",K="K",L='q',M="Provided date is invalid",N="pm",O="Error parsing date '",P='Anno Domini',Q='G',R="a",S='2nd quarter',T="yyyy-MM-dd'T'HH:mm:ss",U="GMT",V="HH:mm:ss",W="dd",X="+",Y="qx.util.format.DateFormat",eo='weekDay',ek="am",ep="eee",el="quarter",em="ee",ej="q",en="QQQQ",eu="HHmmss",ev="ww",ew="H",ex='Y+',eq="wide",er='wide',es="(\\d\\d\\d?)",et="(GMT[\\+\\-]\\d\\d:\\d\\d)",eB="_applyLocale",ff="Q",eC="c",eD="(",ey="weekOfMonth",ez="ccc",gg="long",eA="Malformed date format: ",eE="EEEEE",eF='Y',eG="EE",eL="GGG",eM='-',eN="w",eH="mm",eI='h',eJ="S",eK='s',eS='A',eT="yyyy-MM-dd",eU="G",eV='z',eO="GG",eP=")",eQ="kk",eR="ss",fa="([\\+\\-]\\d\\d\\d\\d)",fb="default",gk='BC',fc='H',eW='S',eX='1st quarter',gi="stand-alone",eY="0",fd="MMMM",fe='c',fq="d",fp='Q',fo='Q1',fu="eeee",ft="QQ",fs="LLLLL",fr="HH",fj='k',fi="m",fh="DDD",fg="D",fn='D',fm="LLLL",fl="(\\d\\d*?)",fk='e',fB="': the value for day or month is too large",fA="literal",fz='K',fy="L",fF="hh",fE="ms",fD="(\\d\\d?\\d?)",fC="cccc",fx="e",fw='y+',fv="|",fQ="W",fP="dayOfYear",fO="GGGG",fU='Q2',fT='B',fS="MM",fR='Q4',fJ="y+",fI='narrow',fH="ccccc",fG="E",fN="wildcard",fM='',fL="' does not match the date format: ",fK="short",gb='d',ga="unkown",fY="narrow",fX="\\d?",gf="'",ge="k",gd='Before Christ',gc='Z',fW="qx.debug",fV='m',dR=" ",dQ="yyyy-MM-dd'T'HH:mm:ss'Z'",gl="String",dO='Q3',dP="z",dN="DD",gj="min",dL="",dM='M',dK="sec",gh='isoUtcDateTime',dI='4th quarter',dJ="(\\d?)",dH="SS",eb="MMM",ec="s",dY="M",ea='w',dW="EEE",dX="$",dV="?",dG='AD',dT="\\d",dU="+?",dS="hour",ei="MMMMM",eg='E',eh='month',ee="LLL",ef="qq",ed="format";qx.Class.define(Y,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(gn,gm){qx.core.Object.call(this);if(!gm){this.__li=qx.locale.Manager.getInstance().getLocale();this.__qv=qx.locale.Manager.getInstance().bind(J,this,J);}
else {this.__li=gm;this.setLocale(gm);}
;this.__qw=this.__li;if(gn!=null){this.__qx=gn.toString();if(this.__qx in qx.util.format.DateFormat.ISO_MASKS){if(this.__qx===gh){this.__qy=true;}
;this.__qx=qx.util.format.DateFormat.ISO_MASKS[this.__qx];}
;}
else {this.__qx=qx.locale.Date.getDateFormat(gg,this.__li)+dR+qx.locale.Date.getDateTimeFormat(eu,V,this.__li);}
;}
,properties:{locale:{apply:eB,nullable:true,check:gl}},statics:{getDateInstance:function(){var go=qx.util.format.DateFormat;var gp=qx.locale.Date.getDateFormat(fK)+dL;if(go._dateInstance==null||go._dateInstance.__qx!=gp){go._dateInstance=new go(gp);}
;return go._dateInstance;}
,getDateTimeInstance:function(){var gq=qx.util.format.DateFormat;var gr=qx.locale.Date.getDateFormat(gg)+dR+qx.locale.Date.getDateTimeFormat(eu,V);if(gq._dateTimeInstance==null||gq._dateTimeInstance.__qx!=gr){gq._dateTimeInstance=new gq(gr);}
;return gq._dateTimeInstance;}
,ASSUME_YEAR_2000_THRESHOLD:30,ISO_MASKS:{isoDate:eT,isoTime:V,isoDateTime:T,isoUtcDateTime:dQ},AM_MARKER:ek,PM_MARKER:N},members:{__qv:null,__li:null,__qw:null,__qx:null,__qz:null,__qA:null,__qB:null,__qy:null,__qC:function(gt,gs){var gu=dL+(gt<0?((-1)*gt):gt);while(gu.length<gs){gu=eY+gu;}
;return gt<0?a+gu:gu;}
,__qD:function(gv){var gw=new Date(gv.getTime());var gx=gw.getDate();while(gw.getMonth()!=0){gw.setDate(-1);gx+=gw.getDate()+1;}
;return gx;}
,__qE:function(gy){return new Date(gy.getTime()+(3-((gy.getDay()+6)%7))*86400000);}
,__qF:function(gz){var gB=this.__qE(gz);var gC=gB.getFullYear();var gA=this.__qE(new Date(gC,0,4));return Math.floor(1.5+(gB.getTime()-gA.getTime())/86400000/7);}
,__qG:function(gD){var gF=this.__qE(gD);var gE=this.__qE(new Date(gD.getFullYear(),gD.getMonth(),4));return Math.floor(1.5+(gF.getTime()-gE.getTime())/86400000/7);}
,__qH:function(gG){var gH=this.__qE(gG);return gH.getFullYear();}
,__qI:function(gJ){var gI=new Date(gJ,2,1);gI.setDate(-1);return gI.getDate()+1===29;}
,__qJ:function(gO,gP){var gN=0;var gQ=0;if(!gP){gP=1971;}
...
,__qK:function(gU,gS,gR){var gT;switch(gS){case 11:gT=gU-1;if(gU!=this.__qH(new Date(gT,gS,gR))){gT=gU;}
;break;case 0:gT=gU+1;if(gU!=this.__qH(new Date(gT,gS,gR))){gT=gU;}
;break;default:gT=gU;};return gT;}
,_applyLocale:function(gW,gV){this.__li=gW===null?this.setLocale(this.__qw):gW;}
,format:function(hn){if(hn==null){return null;}
;if(isNaN(hn.getTime())){if(qx.core.Environment.get(fW)){qx.log.Logger.error(M);}
;return null;}
;if(this.__qy){hn=new Date(hn.getUTCFullYear(),hn.getUTCMonth(),hn.getUTCDate(),hn.getUTCHours(),hn.getUTCMinutes(),hn.getUTCSeconds(),hn.getUTCMilliseconds());}
;var ha=this.__li;var hf=hn.getFullYear();var hb=hn.getMonth();var he=hn.getDate();var hi=hn.getDay();var hl=hn.getHours();var hs=hn.getMinutes();var hj=hn.getSeconds();var hq=hn.getMilliseconds();var hh=hn.getTimezoneOffset();var hm=hh>0?1:-1;var gX=Math.floor(Math.abs(hh)/60);var hp=Math.abs(hh)%60;this.__qL();var hr=dL;for(var i=0;i<this.__qB.length;i++ ){var hg=this.__qB[i];if(hg.type==fA){hr+=hg.text;}
else {var gY=hg.character;var hk=hg.size;var ht=dV;switch(gY){case z:if(hk==2){ht=this.__qC(hf%100,2);}
else {var hc=Math.abs(hf);ht=hc+dL;if(hk>ht.length){for(var j=ht.length;j<hk;j++ ){ht=eY+ht;}
;}
;if(hf<0){ht=a+ht;}
;}
;break;case eF:ht=this.__qH(hn)+dL;var hc=ht.replace(eM,fM);if(hk>ht.length){for(var j=hc.length;j<hk;j++ ){hc=eY+hc;}
;}
;ht=ht.indexOf(a)!=-1?a+hc:hc;break;case Q:if(hk>=1&&hk<=3){ht=hf>0?dG:gk;}
else if(hk==4){ht=hf>0?P:gd;}
else if(hk==5){ht=hf>0?eS:fT;}
;break;case fp:if(hk==1||hk==2){ht=this.__qC(parseInt(hb/4)+1,hk);}
;if(hk==3){ht=fp+(parseInt(hb/4)+1);}
;break;case L:if(hk==1||hk==2){ht=this.__qC(parseInt(hb/4)+1,hk);}
;if(hk==3){ht=fp+(parseInt(hb/4)+1);}
;break;case fn:ht=this.__qC(this.__qD(hn),hk);break;case gb:ht=this.__qC(he,hk);break;case ea:ht=this.__qC(this.__qF(hn),hk);break;case c:ht=this.__qG(hn);break;case eg:if(hk>=1&&hk<=3){ht=qx.locale.Date.getDayName(v,hi,ha,ed,true);}
else if(hk==4){ht=qx.locale.Date.getDayName(eq,hi,ha,ed,true);}
else if(hk==5){ht=qx.locale.Date.getDayName(fY,hi,ha,ed,true);}
;break;case fk:var hd=qx.locale.Date.getWeekStart(ha);var ho=1+((hi-hd>=0)?(hi-hd):7+(hi-hd));if(hk>=1&&hk<=2){ht=this.__qC(ho,hk);}
else if(hk==3){ht=qx.locale.Date.getDayName(v,hi,ha,ed,true);}
else if(hk==4){ht=qx.locale.Date.getDayName(eq,hi,ha,ed,true);}
else if(hk==5){ht=qx.locale.Date.getDayName(fY,hi,ha,ed,true);}
;break;case fe:var hd=qx.locale.Date.getWeekStart(ha);var ho=1+((hi-hd>=0)?(hi-hd):7+(hi-hd));if(hk==1){ht=fM+ho;}
else if(hk==3){ht=qx.locale.Date.getDayName(v,hi,ha,gi,true);}
else if(hk==4){ht=qx.locale.Date.getDayName(eq,hi,ha,gi,true);}
else if(hk==5){ht=qx.locale.Date.getDayName(fY,hi,ha,gi,true);}
;break;case dM:if(hk==1||hk==2){ht=this.__qC(hb+1,hk);}
else if(hk==3){ht=qx.locale.Date.getMonthName(v,hb,ha,ed,true);}
else if(hk==4){ht=qx.locale.Date.getMonthName(eq,hb,ha,ed,true);}
else if(hk==5){ht=qx.locale.Date.getMonthName(fY,hb,ha,ed,true);}
;break;case g:if(hk==1||hk==2){ht=this.__qC(hb+1,hk);}
else if(hk==3){ht=qx.locale.Date.getMonthName(v,hb,ha,gi,true);}
else if(hk==4){ht=qx.locale.Date.getMonthName(eq,hb,ha,gi,true);}
else if(hk==5){ht=qx.locale.Date.getMonthName(fY,hb,ha,gi,true);}
;break;case E:ht=(hl<12)?qx.locale.Date.getAmMarker(ha):qx.locale.Date.getPmMarker(ha);break;case fc:ht=this.__qC(hl,hk);break;case fj:ht=this.__qC((hl==0)?24:hl,hk);break;case fz:ht=this.__qC(hl%12,hk);break;case eI:ht=this.__qC(((hl%12)==0)?12:(hl%12),hk);break;case fV:ht=this.__qC(hs,hk);break;case eK:ht=this.__qC(hj,hk);break;case eW:ht=this.__qC(hq,3);if(hk<ht.length){ht=ht.substr(0,hk);}
else {while(hk>ht.length){ht+=eY;}
;}
;break;case eV:if(hk>=1&&hk<=4){ht=U+((hm>0)?a:X)+this.__qC(Math.abs(gX),2)+y+this.__qC(hp,2);}
;break;case gc:if(hk>=1&&hk<=3){ht=((hm>0)?a:X)+this.__qC(Math.abs(gX),2)+this.__qC(hp,2);}
else {ht=U+((hm>0)?a:X)+this.__qC(Math.abs(gX),2)+y+this.__qC(hp,2);}
;break;};hr+=ht;}
;}
;return hr;}
,parse:function(hA){this.__qM();var hD=this.__qz.regex.exec(hA);if(hD==null){throw new Error(n+hA+fL+this.__qx);}
;var hu={era:1,year:1970,quarter:1,month:0,day:1,dayOfYear:1,hour:0,ispm:false,weekDay:4,weekYear:1970,weekOfMonth:1,weekOfYear:1,min:0,sec:0,ms:0};var hy=1;var hv=false;var hw=false;for(var i=0;i<this.__qz.usedRules.length;i++ ){var hx=this.__qz.usedRules[i];var hz=hD[hy];if(hx.field!=null){hu[hx.field]=parseInt(hz,10);}
else {hx.manipulator(hu,hz,hx.pattern);}
;if(hx.pattern==q){var hB=false;for(var k=0;k<this.__qz.usedRules.length;k++ ){if(this.__qz.usedRules[k].pattern==fw){hB=true;break;}
;}
;if(!hB){hv=true;}
;}
;if(hx.pattern.indexOf(fg)!=-1){var hF=false;for(var k=0;k<this.__qz.usedRules.length;k++ ){if(this.__qz.usedRules[k].pattern.indexOf(fq)!=-1){hF=true;break;}
;}
;if(!hF){hw=true;}
;}
;hy+=(hx.groups==null)?1:hx.groups;}
;if(hv){hu.year=this.__qK(hu.weekYear,hu.month,hu.day);}
;if(hw){var hE=this.__qJ(hu.dayOfYear,hu.year);hu.month=hE.month;hu.day=hE.day;}
;if(hu.era<0&&(hu.year*hu.era<0)){hu.year=hu.year*hu.era;}
;var hC=new Date(hu.year,hu.month,hu.day,(hu.ispm)?(hu.hour+12):hu.hour,hu.min,hu.sec,hu.ms);if(this.__qy){hC=new Date(hC.getUTCFullYear(),hC.getUTCMonth(),hC.getUTCDate(),hC.getUTCHours(),hC.getUTCMinutes(),hC.getUTCSeconds(),hC.getUTCMilliseconds());}
;if(hu.month!=hC.getMonth()||hu.year!=hC.getFullYear()){throw new Error(O+hA+fB);}
;return hC;}
,__qL:function(){if(this.__qB!=null){return;}
;this.__qB=[];var hK;var hI=0;var hM=dL;var hG=this.__qx;var hJ=fb;var i=0;while(i<hG.length){var hL=hG.charAt(i);switch(hJ){case A:if(hL==gf){if(i+1>=hG.length){i++ ;break;}
;var hH=hG.charAt(i+1);if(hH==gf){hM+=hL;i++ ;}
else {i++ ;hJ=ga;}
;}
else {hM+=hL;i++ ;}
;break;case fN:if(hL==hK){hI++ ;i++ ;}
else {this.__qB.push({type:fN,character:hK,size:hI});hK=null;hI=0;hJ=fb;}
;break;default:if((hL>=E&&hL<=eV)||(hL>=eS&&hL<=gc)){hK=hL;hJ=fN;}
else if(hL==gf){if(i+1>=hG.length){hM+=hL;i++ ;break;}
;var hH=hG.charAt(i+1);if(hH==gf){hM+=hL;i++ ;}
;i++ ;hJ=A;}
else {hJ=fb;}
;if(hJ!=fb){if(hM.length>0){this.__qB.push({type:fA,text:hM});hM=dL;}
;}
else {hM+=hL;i++ ;}
;break;};}
;if(hK!=null){this.__qB.push({type:fN,character:hK,size:hI});}
else if(hM.length>0){this.__qB.push({type:fA,text:hM});}
;}
,__qM:function(){if(this.__qz!=null){return;}
;var hQ=this.__qx;this.__qO();this.__qL();var hW=[];var hR=x;for(var hO=0;hO<this.__qB.length;hO++ ){var hX=this.__qB[hO];if(hX.type==fA){hR+=qx.lang.String.escapeRegexpChars(hX.text);}
else {var hP=hX.character;var hS=hX.size;var hU;for(var hY=0;hY<this.__qA.length;hY++ ){var hT=this.__qA[hY];if(this.__qN(hT,hP,hS)){hU=hT;break;}
;}
;if(hU==null){var hV=dL;for(var i=0;i<hS;i++ ){hV+=hP;}
;throw new Error(eA+hQ+r+hV+h);}
else {hW.push(hU);hR+=hU.regex;}
;}
;}
;hR+=dX;var hN;try{hN=new RegExp(hR);}
catch(ia){throw new Error(eA+hQ);}
;this.__qz={regex:hN,"usedRules":hW,pattern:hR};}
,__qN:function(ib,ic,id){if(ic===z&&ib.pattern===fw){ib.regex=ib.regexFunc(id);return true;}
else if(ic===eF&&ib.pattern===ex){ib.regex=ib.regexFunc(id);return true;}
else {return ic==ib.pattern.charAt(0)&&id==ib.pattern.length;}
;}
,__qO:function(){var it=qx.util.format.DateFormat;var iw=qx.lang.String;if(this.__qA!=null){return;}
;var iu=this.__qA=[];var ip=qx.locale.Date.getAmMarker(this.__li).toString()||it.AM_MARKER;var iD=qx.locale.Date.getPmMarker(this.__li).toString()||it.PM_MARKER;var ig=this.__li;var il=function(iG,iH){iH=parseInt(iH,10);if(iH>=0){if(iH<it.ASSUME_YEAR_2000_THRESHOLD){iH+=2000;}
...
;var iz=[eS,fT];var iA=function(ja,jb){ja.era=jb==eS?1:-1;}
;var is=[dG,gk];var ir=function(jc,jd){jc.era=jd==dG?1:-1;}
;var iC=[P,gd];var iq=function(je,jf){je.era=jf==P?1:-1;}
;var iE=[fo,fU,dO,fR];var ie=function(jg,jh){jg.quarter=iE.indexOf(jh);}
;var iB=[eX,S,C,dI];var ix=function(ji,jj){ji.quarter=iB.indexOf(jj);}
;var im={};var ik=function(jn){var jp=[g,dM];var jl=[fe,fk,eg];var js=jn.charAt(0);var jm=jp.indexOf(js)>=0;var jo=function(){var ju=jm?jp:jl;var jv=js===ju[0]?gi:ed;var jt=jn.length;var jw=p;switch(jt){case 4:jw=er;break;case 5:jw=fI;break;default:jw=p;};return [jv,jw];}
...
;}
;return im[jn];}
;iu.push({pattern:fJ,regexFunc:function(jA){var jz=G;for(var i=0;i<jA;i++ ){jz+=dT;if(i===jA-1&&i!==1){jz+=dU;}
;}
;jz+=eP;return jz;}
,manipulator:il});iu.push({pattern:q,regexFunc:function(jC){var jB=G;for(var i=0;i<jC;i++ ){jB+=dT;if(i===jC-1){jB+=dU;}
;}
;jB+=eP;return jB;}
,manipulator:iF});iu.push({pattern:eU,regex:eD+is.join(fv)+eP,manipulator:ir});iu.push({pattern:eO,regex:eD+is.join(fv)+eP,manipulator:ir});iu.push({pattern:eL,regex:eD+is.join(fv)+eP,manipulator:ir});iu.push({pattern:fO,regex:eD+iC.join(fv)+eP,manipulator:iq});iu.push({pattern:o,regex:eD+iz.join(fv)+eP,manipulator:iA});iu.push({pattern:ff,regex:fl,field:el});iu.push({pattern:ft,regex:t,field:el});iu.push({pattern:b,regex:eD+iE.join(fv)+eP,manipulator:ie});iu.push({pattern:en,regex:eD+iB.join(fv)+eP,manipulator:ix});iu.push({pattern:ej,regex:fl,field:el});iu.push({pattern:ef,regex:t,field:el});iu.push({pattern:H,regex:eD+iE.join(fv)+eP,manipulator:ie});iu.push({pattern:d,regex:eD+iB.join(fv)+eP,manipulator:ix});iu.push({pattern:dY,regex:fl,manipulator:io});iu.push({pattern:fS,regex:t,manipulator:io});iu.push({pattern:eb,regex:eD+ik(eb).data.join(fv)+eP,manipulator:ik(eb).func});iu.push({pattern:fd,regex:eD+ik(fd).data.join(fv)+eP,manipulator:ik(fd).func});iu.push({pattern:ei,regex:eD+ik(ei).data.join(fv)+eP,manipulator:ik(ei).func});iu.push({pattern:fy,regex:fl,manipulator:io});iu.push({pattern:u,regex:t,manipulator:io});iu.push({pattern:ee,regex:eD+ik(ee).data.join(fv)+eP,manipulator:ik(ee).func});iu.push({pattern:fm,regex:eD+ik(fm).data.join(fv)+eP,manipulator:ik(fm).func});iu.push({pattern:fs,regex:eD+ik(fs).data.join(fv)+eP,manipulator:ik(fs).func});iu.push({pattern:W,regex:t,field:F});iu.push({pattern:fq,regex:fl,field:F});iu.push({pattern:fg,regex:dJ,field:fP});iu.push({pattern:dN,regex:t,field:fP});iu.push({pattern:fh,regex:es,field:fP});iu.push({pattern:fG,regex:eD+ik(fG).data.join(fv)+eP,manipulator:ik(fG).func});iu.push({pattern:eG,regex:eD+ik(eG).data.join(fv)+eP,manipulator:ik(eG).func});iu.push({pattern:dW,regex:eD+ik(dW).data.join(fv)+eP,manipulator:ik(dW).func});iu.push({pattern:w,regex:eD+ik(w).data.join(fv)+eP,manipulator:ik(w).func});iu.push({pattern:eE,regex:eD+ik(eE).data.join(fv)+eP,manipulator:ik(eE).func});iu.push({pattern:fx,regex:dJ,manipulator:ij});iu.push({pattern:em,regex:t,manipulator:ij});iu.push({pattern:ep,regex:eD+ik(ep).data.join(fv)+eP,manipulator:ik(ep).func});iu.push({pattern:fu,regex:eD+ik(fu).data.join(fv)+eP,manipulator:ik(fu).func});iu.push({pattern:s,regex:eD+ik(s).data.join(fv)+eP,manipulator:ik(s).func});iu.push({pattern:eC,regex:fX,manipulator:ij});iu.push({pattern:ez,regex:eD+ik(ez).data.join(fv)+eP,manipulator:ik(ez).func});iu.push({pattern:fC,regex:eD+ik(fC).data.join(fv)+eP,manipulator:ik(fC).func});iu.push({pattern:fH,regex:eD+ik(fH).data.join(fv)+eP,manipulator:ik(fH).func});iu.push({pattern:R,regex:eD+ip+fv+iD+eP,manipulator:ii});iu.push({pattern:fQ,regex:dJ,field:ey});iu.push({pattern:eN,regex:t,field:B});iu.push({pattern:ev,regex:I,field:B});iu.push({pattern:fr,regex:t,field:dS});iu.push({pattern:ew,regex:t,field:dS});iu.push({pattern:eQ,regex:t,manipulator:iv});iu.push({pattern:ge,regex:t,manipulator:iv});iu.push({pattern:f,regex:t,field:dS});iu.push({pattern:K,regex:t,field:dS});iu.push({pattern:fF,regex:t,manipulator:ih});iu.push({pattern:e,regex:t,manipulator:ih});iu.push({pattern:eH,regex:t,field:gj});iu.push({pattern:fi,regex:t,field:gj});iu.push({pattern:eR,regex:t,field:dK});iu.push({pattern:ec,regex:t,field:dK});iu.push({pattern:D,regex:fD,field:fE});iu.push({pattern:dH,regex:fD,field:fE});iu.push({pattern:eJ,regex:fD,field:fE});iu.push({pattern:m,regex:fa,manipulator:iy});iu.push({pattern:dP,regex:et,manipulator:iy});}
},destruct:function(){if(this.__qv!=null){qx.locale.Manager.getInstance().removeBinding(this.__qv);}
;this.__qB=this.__qz=this.__qA=null;}
});}
)();
(function(){var a="PageUp",b="day",c="lastMonth",d="yyyyMMMM",f="Next month",g="Escape",h="Left",j="last-month-button",k="default",l="today",m="weekday",n="changeValue",o="Space",p="selected",q="Down",r="Integer",s="qx.ui.control.DateChooser",t="Up",u="Enter",v="PageDown",w="day#",z="changeLocale",A="Next year",B="ww",C="_applyValue",D="next-month-button",E="next-month-button-tooltip",F="weekday#",G="last-month-button-tooltip",H="datechooser",I="header",J="week",K="lastYear",L="pointerup",M="otherMonth",N="month-year-label",O="nextYear",P="last-year-button",Q="changeShownYear",R="week#",S="qx.dynlocale",T="next-year-button",U="Last month",V="Right",W="Last year",X="MMMM yyyy",Y="EE",bs="week#0",bt="keypress",bu="",bo="navigation-bar",bp="nextMonth",bq="last-year-button-tooltip",br="next-year-button-tooltip",by="Date",bz="tap",bA="pointerdown",bB="date-pane",bv="dbltap",bw="weekend",bx="changeShownMonth";qx.Class.define(s,{extend:qx.ui.core.Widget,include:[qx.ui.core.MExecutable,qx.ui.form.MForm],implement:[qx.ui.form.IExecutable,qx.ui.form.IForm,qx.ui.form.IDateForm],construct:function(bC){qx.ui.core.Widget.call(this);var bF=new qx.ui.layout.VBox();this._setLayout(bF);this._createChildControl(bo);this._createChildControl(bB);this.addListener(bt,this._onKeyPress);var bD=qx.ui.control.DateChooser;if(!bD.MONTH_YEAR_FORMAT){bD.MONTH_YEAR_FORMAT=qx.locale.Date.getDateTimeFormat(d,X);}
;var bE=(bC!=null)?bC:new Date();this.showMonth(bE.getMonth(),bE.getFullYear());if(qx.core.Environment.get(S)){qx.locale.Manager.getInstance().addListener(z,this._updateDatePane,this);}
;this.addListener(bA,this._onPointerUpDown,this);this.addListener(L,this._onPointerUpDown,this);}
,statics:{MONTH_YEAR_FORMAT:null,WEEKDAY_FORMAT:Y,WEEK_FORMAT:B},properties:{appearance:{refine:true,init:H},width:{refine:true,init:200},height:{refine:true,init:150},shownMonth:{check:r,init:null,nullable:true,event:bx},shownYear:{check:r,init:null,nullable:true,event:Q},value:{check:by,init:null,nullable:true,event:n,apply:C}},members:{__AB:null,__AC:null,__AD:null,_forwardStates:{invalid:true},_createChildControlImpl:function(bK,bH){var bG;switch(bK){case bo:bG=new qx.ui.container.Composite(new qx.ui.layout.HBox());bG.add(this.getChildControl(P));bG.add(this.getChildControl(j));bG.add(this.getChildControl(N),{flex:1});bG.add(this.getChildControl(D));bG.add(this.getChildControl(T));this._add(bG);break;case bq:bG=new qx.ui.tooltip.ToolTip(this.tr(W));break;case P:bG=new qx.ui.toolbar.Button();bG.addState(K);bG.setFocusable(false);bG.setToolTip(this.getChildControl(bq));bG.addListener(bz,this._onNavButtonTap,this);break;case G:bG=new qx.ui.tooltip.ToolTip(this.tr(U));break;case j:bG=new qx.ui.toolbar.Button();bG.addState(c);bG.setFocusable(false);bG.setToolTip(this.getChildControl(G));bG.addListener(bz,this._onNavButtonTap,this);break;case E:bG=new qx.ui.tooltip.ToolTip(this.tr(f));break;case D:bG=new qx.ui.toolbar.Button();bG.addState(bp);bG.setFocusable(false);bG.setToolTip(this.getChildControl(E));bG.addListener(bz,this._onNavButtonTap,this);break;case br:bG=new qx.ui.tooltip.ToolTip(this.tr(A));break;case T:bG=new qx.ui.toolbar.Button();bG.addState(O);bG.setFocusable(false);bG.setToolTip(this.getChildControl(br));bG.addListener(bz,this._onNavButtonTap,this);break;case N:bG=new qx.ui.basic.Label();bG.setAllowGrowX(true);bG.setAnonymous(true);break;case J:bG=new qx.ui.basic.Label();bG.setAllowGrowX(true);bG.setAllowGrowY(true);bG.setSelectable(false);bG.setAnonymous(true);bG.setCursor(k);break;case m:bG=new qx.ui.basic.Label();bG.setAllowGrowX(true);bG.setAllowGrowY(true);bG.setSelectable(false);bG.setAnonymous(true);bG.setCursor(k);break;case b:bG=new qx.ui.basic.Label();bG.setAllowGrowX(true);bG.setAllowGrowY(true);bG.setCursor(k);bG.addListener(bA,this._onDayTap,this);bG.addListener(bv,this._onDayDblTap,this);break;case bB:var bJ=new qx.ui.layout.Grid();bG=new qx.ui.container.Composite(bJ);for(var i=0;i<8;i++ ){bJ.setColumnFlex(i,1);}
;for(var i=0;i<7;i++ ){bJ.setRowFlex(i,1);}
;var bI=this.getChildControl(bs);bI.addState(I);bG.add(bI,{column:0,row:0});this.__AB=[];for(var i=0;i<7;i++ ){bI=this.getChildControl(F+i);bG.add(bI,{column:i+1,row:0});this.__AB.push(bI);}
;this.__AC=[];this.__AD=[];for(var y=0;y<6;y++ ){var bI=this.getChildControl(R+(y+1));bG.add(bI,{column:0,row:y+1});this.__AD.push(bI);for(var x=0;x<7;x++ ){var bI=this.getChildControl(w+((y*7)+x));bG.add(bI,{column:x+1,row:y+1});this.__AC.push(bI);}
;}
;this._add(bG);break;};return bG||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,bK);}
,_applyValue:function(bN,bM){if((bN!=null)&&(this.getShownMonth()!=bN.getMonth()||this.getShownYear()!=bN.getFullYear())){this.showMonth(bN.getMonth(),bN.getFullYear());}
else {var bL=(bN==null)?-1:bN.getDate();for(var i=0;i<6*7;i++ ){var bO=this.__AC[i];if(bO.hasState(M)){if(bO.hasState(p)){bO.removeState(p);}
;}
else {var bP=parseInt(bO.getValue(),10);if(bP==bL){bO.addState(p);}
else if(bO.hasState(p)){bO.removeState(p);}
;}
;}
;}
;}
,_onPointerUpDown:function(e){var bQ=e.getTarget();if(bQ==this.getChildControl(bo)||bQ==this.getChildControl(bB)){e.stopPropagation();return;}
;}
,_onNavButtonTap:function(bS){var bR=this.getShownYear();var bT=this.getShownMonth();switch(bS.getCurrentTarget()){case this.getChildControl(P):bR-- ;break;case this.getChildControl(j):bT-- ;if(bT<0){bT=11;bR-- ;}
;break;case this.getChildControl(D):bT++ ;if(bT>=12){bT=0;bR++ ;}
;break;case this.getChildControl(T):bR++ ;break;};this.showMonth(bT,bR);}
,_onDayTap:function(bU){var bV=bU.getCurrentTarget().dateTime;this.setValue(new Date(bV));}
,_onDayDblTap:function(){this.execute();}
,_onKeyPress:function(bY){var ca=null;var cb=null;var bX=null;if(bY.getModifiers()==0){switch(bY.getKeyIdentifier()){case h:ca=-1;break;case V:ca=1;break;case t:ca=-7;break;case q:ca=7;break;case a:cb=-1;break;case v:cb=1;break;case g:if(this.getValue()!=null){this.setValue(null);return;}
;break;case u:case o:if(this.getValue()!=null){this.execute();}
;return;};}
else if(bY.isShiftPressed()){switch(bY.getKeyIdentifier()){case a:bX=-1;break;case v:bX=1;break;};}
;if(ca!=null||cb!=null||bX!=null){var bW=this.getValue();if(bW!=null){bW=new Date(bW.getTime());}
;if(bW==null){bW=new Date();}
else {if(ca!=null){bW.setDate(bW.getDate()+ca);}
;if(cb!=null){bW.setMonth(bW.getMonth()+cb);}
;if(bX!=null){bW.setFullYear(bW.getFullYear()+bX);}
;}
;this.setValue(bW);}
;}
,showMonth:function(cc,cd){if((cc!=null&&cc!=this.getShownMonth())||(cd!=null&&cd!=this.getShownYear())){if(cc!=null){this.setShownMonth(cc);}
;if(cd!=null){this.setShownYear(cd);}
;this._updateDatePane();}
;}
,handleKeyPress:function(e){this._onKeyPress(e);}
,_updateDatePane:function(){var ct=qx.ui.control.DateChooser;var cq=new Date();var ci=cq.getFullYear();var co=cq.getMonth();var cl=cq.getDate();var cu=this.getValue();var cx=(cu==null)?-1:cu.getFullYear();var cE=(cu==null)?-1:cu.getMonth();var cn=(cu==null)?-1:cu.getDate();var cm=this.getShownMonth();var cB=this.getShownYear();var cj=qx.locale.Date.getWeekStart();var cv=new Date(this.getShownYear(),this.getShownMonth(),1);var cs=new qx.util.format.DateFormat(ct.MONTH_YEAR_FORMAT);this.getChildControl(N).setValue(cs.format(cv));var cD=cv.getDay();var cp=1+((7-cD)%7);var cw=new qx.util.format.DateFormat(ct.WEEKDAY_FORMAT);for(var i=0;i<7;i++ ){var cy=(i+cj)%7;var cA=this.__AB[i];cv.setDate(cp+cy);cA.setValue(cw.format(cv));if(qx.locale.Date.isWeekend(cy)){cA.addState(bw);}
else {cA.removeState(bw);}
;}
;cv=new Date(cB,cm,1,12,0,0);var cf=(7+cD-cj)%7;cv.setDate(cv.getDate()-cf);var cz=new qx.util.format.DateFormat(ct.WEEK_FORMAT);for(var cr=0;cr<6;cr++ ){this.__AD[cr].setValue(cz.format(cv));for(var i=0;i<7;i++ ){var cA=this.__AC[cr*7+i];var ch=cv.getFullYear();var cg=cv.getMonth();var ck=cv.getDate();var ce=(cx==ch&&cE==cg&&cn==ck);if(ce){cA.addState(p);}
else {cA.removeState(p);}
;if(cg!=cm){cA.addState(M);}
else {cA.removeState(M);}
;var cC=(ch==ci&&cg==co&&ck==cl);if(cC){cA.addState(l);}
else {cA.removeState(l);}
;cA.setValue(bu+ck);cA.dateTime=cv.getTime();cv.setDate(cv.getDate()+1);}
;}
;cs.dispose();cw.dispose();cz.dispose();}
},destruct:function(){if(qx.core.Environment.get(S)){qx.locale.Manager.getInstance().removeListener(z,this._updateDatePane,this);}
;this.__AB=this.__AC=this.__AD=null;}
});}
)();
...
(function(){var a="changeModel",b="qx.core.Object",c="qx.data.controller.Object",d="get",e="[",f="reset",g="_applyModel",h="last";qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bb={};this.__hj=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__hj:null,__bb:null,_applyModel:function(o,l){for(var i=0;i<this.__hj.length;i++ ){var t=this.__hj[i][0];var q=this.__hj[i][1];var n=this.__hj[i][2];var r=this.__hj[i][3];var p=this.__hj[i][4];var m=this.__hj[i][5];if(l!=undefined&&!l.isDisposed()){this.__Fj(t,q,n,l);}
;if(o!=undefined){this.__Fi(t,q,n,r,p,m);}
...
;}
;}
,addTarget:function(z,w,u,x,y,v){this.__hj.push([z,w,u,x,y,v]);this.__Fi(z,w,u,x,y,v);}
,__Fi:function(F,D,B,G,E,A){if(this.getModel()==null){return;}
;var C=this.getModel().bind(B,F,D,E);var I=null;if(G){I=F.bind(D,this.getModel(),B,A);}
;var H=F.toHashCode();if(this.__bb[H]==undefined){this.__bb[H]=[];}
;this.__bb[H].push([C,I,D,B,E,A]);}
,removeTarget:function(K,J,L){this.__Fj(K,J,L,this.getModel());for(var i=0;i<this.__hj.length;i++ ){if(this.__hj[i][0]==K&&this.__hj[i][1]==J&&this.__hj[i][2]==L){this.__hj.splice(i,1);}
;}
;}
,__Fj:function(R,O,N,M){if(!(R instanceof qx.core.Object)){return;}
;var P=this.__bb[R.toHashCode()];if(P==undefined||P.length==0){return;}
...
(function(){var a="Widgets supporting selection can only be validated ",b="Added widget not supported.",c="",d="in the form validator",f="mouse",g="changeValid",h="qx.event.type.Event",j="complete",k="value instanceof Function || qx.Class.isSubClassOf(value.constructor, qx.ui.form.validation.AsyncValidator)",l="qx.ui.form.validation.Manager",m="This field is required",n="String",o="qx.event.type.Data";qx.Class.define(l,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__BE=[];this.__BF={};this.setRequiredFieldMessage(qx.locale.Manager.tr(m));}
,events:{"changeValid":o,"complete":h},properties:{validator:{check:k,init:null,nullable:true},invalidMessage:{check:n,init:c},requiredFieldMessage:{check:n,init:c},context:{nullable:true}},members:{__BE:null,__BG:null,__BF:null,__BH:null,add:function(s,p,r){if(!this.__BM(s)){throw new Error(b);}
;if(this.__Br(s)&&!s.getValue){if(p!=null){throw new Error(a+d);}
;}
;var q={item:s,validator:p,valid:null,context:r};this.__BE.push(q);}
,remove:function(v){var t=this.__BE;for(var i=0,u=t.length;i<u;i++ ){if(v===t[i].item){t.splice(i,1);return v;}
;}
;return null;}
,getItems:function(){var w=[];for(var i=0;i<this.__BE.length;i++ ){w.push(this.__BE[i].item);}
;return w;}
,validate:function(){var B=true;this.__BH=true;var y=[];for(var i=0;i<this.__BE.length;i++ ){var z=this.__BE[i].item;var C=this.__BE[i].validator;y.push(z);if(C==null){var x=this.__BI(z);B=B&&x;this.__BH=x&&this.__BH;continue;}
;var x=this.__BJ(this.__BE[i],z.getValue());B=x&&B;if(x!=null){this.__BH=x&&this.__BH;}
;}
;var A=this.__BK(y);if(qx.lang.Type.isBoolean(A)){this.__BH=A&&this.__BH;}
;B=A&&B;this._setValid(B);if(qx.lang.Object.isEmpty(this.__BF)){this.fireEvent(j);}
;return B;}
,__BI:function(E){if(E.getRequired()){if(this.__Br(E)){var D=!!E.getSelection()[0];}
else {var G=E.getValue();var D=!!G||G===0;}
;E.setValid(D);var H=E.getRequiredInvalidMessage();var F=H?H:this.getRequiredFieldMessage();E.setInvalidMessage(F);return D;}
;return true;}
,__BJ:function(K,L){var M=K.item;var O=K.context;var N=K.validator;if(this.__BL(N)){this.__BF[M.toHashCode()]=null;N.validate(M,M.getValue(),this,O);return null;}
;var I=null;try{var I=N.call(O||this,L,M);if(I===undefined){I=true;}
;}
catch(e){if(e instanceof qx.core.ValidationError){I=false;if(e.message&&e.message!=qx.type.BaseError.DEFAULTMESSAGE){var J=e.message;}
else {var J=e.getComment();}
;M.setInvalidMessage(J);}
else {throw e;}
;}
;M.setValid(I);K.valid=I;return I;}
,__BK:function(Q){var R=this.getValidator();var S=this.getContext()||this;if(R==null){return true;}
;this.setInvalidMessage(c);if(this.__BL(R)){this.__BF[this.toHashCode()]=null;R.validateForm(Q,this,S);return null;}
;try{var T=R.call(S,Q,this);if(T===undefined){T=true;}
;}
catch(e){if(e instanceof qx.core.ValidationError){T=false;if(e.message&&e.message!=qx.type.BaseError.DEFAULTMESSAGE){var P=e.message;}
else {var P=e.getComment();}
;this.setInvalidMessage(P);}
else {throw e;}
;}
;return T;}
,__BL:function(V){var U=false;if(!qx.lang.Type.isFunction(V)){U=qx.Class.isSubClassOf(V.constructor,qx.ui.form.validation.AsyncValidator);}
;return U;}
,__BM:function(W){var X=W.constructor;return qx.Class.hasInterface(X,qx.ui.form.IForm);}
,__Br:function(Y){var ba=Y.constructor;return qx.Class.hasInterface(ba,qx.ui.core.ISingleSelection);}
,_setValid:function(bb){this._showToolTip(bb);var bc=this.__BG;this.__BG=bb;if(bc!=bb){this.fireDataEvent(g,bb,bc);}
;}
,_showToolTip:function(bg){if(!qx.ui.tooltip||!qx.ui.tooltip.Manager){return;}
;var be=qx.ui.tooltip.Manager.getInstance().getSharedErrorTooltip();if(!bg){var bd;for(var i=0;i<this.__BE.length;i++ ){var bf=this.__BE[i].item;if(!bf.isValid()){bd=bf;if(!(bf.getContentLocation)){return;}
;if(bf.isSeeable()===false){continue;}
;be.setLabel(bf.getInvalidMessage());if(be.getPlaceMethod()==f){var location=bf.getContentLocation();var top=location.top-be.getOffsetTop();be.placeToPoint({left:location.right,top:top});}
else {be.placeToWidget(bf);}
;be.show();return;}
;}
;}
else {be.exclude();}
;}
,getValid:function(){return this.__BG;}
,isValid:function(){return this.getValid();}
,getInvalidMessages:function(){var bh=[];for(var i=0;i<this.__BE.length;i++ ){var bi=this.__BE[i].item;if(!bi.getValid()){bh.push(bi.getInvalidMessage());}
;}
;if(this.getInvalidMessage()!=c){bh.push(this.getInvalidMessage());}
;return bh;}
,getInvalidFormItems:function(){var bj=[];for(var i=0;i<this.__BE.length;i++ ){var bk=this.__BE[i].item;if(!bk.getValid()){bj.push(bk);}
;}
;return bj;}
,reset:function(){for(var i=0;i<this.__BE.length;i++ ){var bl=this.__BE[i];bl.item.setValid(true);}
;this.__BG=null;this._showToolTip(true);}
,setItemValid:function(bn,bm){this.__BF[bn.toHashCode()]=bm;bn.setValid(bm);this.__BN();}
,setFormValid:function(bo){this.__BF[this.toHashCode()]=bo;this.__BN();}
,__BN:function(){var bq=this.__BH;for(var br in this.__BF){var bp=this.__BF[br];bq=bp&&bq;if(bp==null){return;}
;}
;this._setValid(bq);this.__BF={};this.fireEvent(j);}
},destruct:function(){this.__BE=null;}
});}
)();
(function(){var a="qx.ui.form.validation.AsyncValidator";qx.Class.define(a,{extend:qx.core.Object,construct:function(b){qx.core.Object.call(this);this.__BO=b;}
,members:{__BO:null,__BP:null,__gz:null,__BQ:null,validate:function(c,e,d,f){this.__BQ=false;this.__BP=c;this.__gz=d;this.__BO.call(f||this,this,e);}
,validateForm:function(g,h,i){this.__BQ=true;this.__gz=h;this.__BO.call(i,g,this);}
,setValid:function(k,j){if(this.__BQ){if(j!==undefined){this.__gz.setInvalidMessage(j);}
;this.__gz.setFormValid(k);}
else {if(j!==undefined){this.__BP.setInvalidMessage(j);}
;this.__gz.setItemValid(this.__BP,k);}
;}
},destruct:function(){this.__gz=this.__BP=null;}
});}
)();
...
;}
,checkEmail:function(x,y,v){v=v||qx.locale.Manager.tr(g,(x||c));var w=/^([A-Za-z0-9_\-\.\+])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,})$/;if(w.test(x)===false){throw new qx.core.ValidationError(n,v);}
;}
