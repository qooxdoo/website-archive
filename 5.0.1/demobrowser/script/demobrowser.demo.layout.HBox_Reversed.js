...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Reversed.11be119da40d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="tap to reverse",b="yellow",c="pointerdown",d="gray",f="blue",g="bottom",h="green",i="top",j="demobrowser.demo.layout.HBox_Reversed",k="middle",l="main";qx.Class.define(j,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var m=new qx.ui.layout.HBox();var o=(new qx.ui.container.Composite(m)).set({decorator:l,backgroundColor:b,height:80});m.setReversed(true);m.setSpacing(5);var q=new qx.ui.core.Widget().set({decorator:l,backgroundColor:f,maxHeight:60,alignY:i});var p=new qx.ui.basic.Label(a).set({decorator:l,rich:true,backgroundColor:h,maxHeight:60,alignY:k,allowGrowX:true,allowGrowY:true});var n=new qx.ui.core.Widget().set({decorator:l,backgroundColor:d,maxHeight:60,alignY:g});o.add(q);o.add(p);o.add(n);o.addListener(c,function(e){m.setReversed(!m.getReversed());}
