...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.ebfdf4dba334.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__Bw.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__Bv:null,__Bw:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__Bv);l.dispose();this.__Bv=null;}
;if(m){this.__Bv=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__Bx:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__By:null,__Bz:null,getLocal:function(){if(this.__By){return this.__By;}
;return this.__By=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__Bz){return this.__Bz;}
;return this.__Bz=new qx.bom.storage.Web(b);}
},construct:function(g){this.__pw=g;}
,members:{__pw:null,getStorage:function(){return window[this.__pw+c];}
,getLength:function(){return this.getStorage(this.__pw).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__pw).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__pw).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__pw).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__pw);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__pw).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__By:null,__Bz:null,__cl:0,getLocal:function(){if(this.__By){return this.__By;}
;return this.__By=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__Bz){return this.__Bz;}
;return this.__Bz=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__BA=document.createElement(f);this.__BA.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__BA);this.__BA.addBehavior(j);this.__BB=m;this.__BA.load(this.__BB);this.__cX={};this.__BC={};var l=this.__BA.getAttribute(d+qx.bom.storage.UserData.__cl);while(l!=undefined){l=qx.lang.Json.parse(l);this.__cX[l.key]=l.value;this.__BC[l.key]=d+qx.bom.storage.UserData.__cl;qx.bom.storage.UserData.__cl++ ;l=this.__BA.getAttribute(d+qx.bom.storage.UserData.__cl);}
;}
,members:{__BA:null,__BB:h,__cX:null,__BC:null,getStorage:function(){return this.__cX;}
,getLength:function(){return Object.keys(this.__cX).length;}
,setItem:function(n,p){if(this.__BC[n]){var o=this.__BC[n];}
else {var o=d+qx.bom.storage.UserData.__cl;qx.bom.storage.UserData.__cl++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__BA.setAttribute(o,q);this.__BA.save(this.__BB);this.__cX[n]=p;this.__BC[n]=o;}
,getItem:function(r){return this.__cX[r]||null;}
,removeItem:function(v){var u=this.__BC[v];if(u==undefined){return;}
;this.__BA.removeAttribute(u);qx.bom.storage.UserData.__cl-- ;delete this.__cX[v];delete this.__BC[v];var t=d+qx.bom.storage.UserData.__cl;if(this.__BA.getAttribute(t)){var w=this.__BA.getAttribute(d+qx.bom.storage.UserData.__cl);this.__BA.removeAttribute(t);this.__BA.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__BC[s]=u;}
;this.__BA.save(this.__BB);}
,clear:function(){for(var x in this.__BC){this.__BA.removeAttribute(this.__BC[x]);}
;this.__BA.save(this.__BB);this.__cX={};this.__BC={};}
...
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__By:null,__Bz:null,getLocal:function(){if(this.__By){return this.__By;}
;return this.__By=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__Bz){return this.__Bz;}
;return this.__Bz=new qx.bom.storage.Memory();}
