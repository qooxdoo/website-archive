...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ListWithFilter","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ListWithFilter.8c642e67e740.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Show all numbers.",b="Write data to log",c="Add an item",d="Remove an item",e="demobrowser.demo.virtual.ListWithFilter",f="Odd / Even filter",g="Remove filter",h="<b>Filtered List</b><br/>",j="Reverse order",k="Show only even numbers.",l="value",m="Show only odd numbers.",n="init",o="delegate",p="List showing numbered items, bound to a data array.",q="execute";qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var A=[];for(var i=0;i<8;i++ ){A.push(i);}
;var C=new qx.data.Array(A);var v=new qx.ui.list.List(C);this.getRoot().add(v,{left:10,top:80});var u={};u.filter=function(F){return parseInt(F)%2==1;}
;var w={};w.filter=function(G){return parseInt(G)%2==0;}
;var B=new qx.ui.basic.Label(n);this.getRoot().add(B,{left:10,top:290});var r={converter:function(H){if(H==w){return k;}
else if(H==u){return m;}
;return a;}
};v.bind(o,B,l,r);var D=new qx.ui.form.Button(c);D.setWidth(120);this.getRoot().add(D,{left:130,top:80});D.addListener(q,function(){C.push(C.length);}
,this);var x=new qx.ui.form.Button(d);x.setWidth(120);this.getRoot().add(x,{left:130,top:115});x.addListener(q,function(){C.pop();}
,this);var y=new qx.ui.form.Button(b);y.setWidth(120);this.getRoot().add(y,{left:130,top:150});y.addListener(q,function(){qx.log.appender.Console.show();this.info(C.toString());}
,this);var s=new qx.ui.form.Button(f);s.setWidth(120);this.getRoot().add(s,{left:130,top:185});s.addListener(q,function(){v.getDelegate()==u?v.setDelegate(w):v.setDelegate(u);}
,this);var z=new qx.ui.form.Button(g);z.setWidth(120);this.getRoot().add(z,{left:130,top:220});z.addListener(q,function(){v.setDelegate(null);}
,this);var E=new qx.ui.form.Button(j);E.setWidth(120);this.getRoot().add(E,{left:130,top:255});E.addListener(q,function(){C.reverse();}
,this);var t=new qx.ui.basic.Label();t.setRich(true);t.setWidth(200);t.setValue(h+p);this.getRoot().add(t,{left:10,top:10});}
}});}
)();
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__zK=new qx.ui.virtual.core.Pane(o,l,n,m);this.__zK.addListener(c,this._computeScrollbars,this);this.__zK.addListener(d,this._onScrollPaneX,this);this.__zK.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__zK,{edge:0});}
else {this._add(this.__zK,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__zK:null,getPane:function(){return this.__zK;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__zK;}
...
,_onScrollBarX:function(e){this.__zK.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__zK.setScrollY(e.getData());}
},destruct:function(){this.__zK.dispose();this.__zK=null;}
});}
)();
(function(){var a="scrollY",b="cellTap",c="qx.event.type.Data",d="change",f="qx.debug",g="qx.event.type.Event",h="__yi",j="__ye",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="__yd",p="scrollX",q="appear",r="pointerdown",s="qx.ui.virtual.core.Pane",t="qx.ui.virtual.core.CellEvent",u="update",v="contextmenu",w="__yj",x="tap";qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__yd=new qx.ui.virtual.core.Axis(A,B);this.__ye=new qx.ui.virtual.core.Axis(z,y);this.__uV=0;this.__uU=0;this.__yf=0;this.__yg=0;this.__yh={};this.__jh={};this.__yi=new qx.ui.container.Composite();this.__yi.setUserBounds(0,0,0,0);this._add(this.__yi);this.__yj=[];this.__yd.addListener(d,this.fullUpdate,this);this.__ye.addListener(d,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(q,this._onAppear,this);this.addListener(r,this._onPointerDown,this);this.addListener(x,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(v,this._onContextmenu,this);}
,events:{cellTap:t,cellContextmenu:t,cellDbltap:t,update:g,scrollX:c,scrollY:c},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__yd:null,__ye:null,__uV:null,__uU:null,__yf:null,__yg:null,__yh:null,__jh:null,__yi:null,__yj:null,__yk:null,__qh:null,__xP:null,__yl:null,getRowConfig:function(){return this.__yd;}
,getColumnConfig:function(){return this.__ye;}
,getChildren:function(){return [this.__yi];}
,addLayer:function(C){if(qx.core.Environment.get(f)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__yj.push(C);C.setUserBounds(0,0,0,0);this.__yi.add(C);}
,getLayers:function(){return this.__yj;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__yj.length;i++ ){var E=this.__yj[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__ye.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__yd.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__uV!==J){var I=this.__uV;this.__uV=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__uV;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__uU){var L=this.__uU;this.__uU=M;this._deferredUpdateScrollPosition();this.fireDataEvent(p,M,L);}
;}
,getScrollX:function(){return this.__uU;}
,getScrollSize:function(){return {width:this.__ye.getTotalSize(),height:this.__yd.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__yd.getItemPosition(P);var O=R+this.__yd.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__ye.getItemPosition(S);var T=U+this.__ye.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__yd.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__ye.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__uU+bl.width;var bo=this.__yg-bn;if(this.__uU-this.__yh.left<Math.min(this.__uU,bj)||this.__yh.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__uU,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__uU-bp,this.__uV,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__uV+bw.height;var bt=this.__yf-bs;if(this.__uV-this.__yh.top<Math.min(this.__uV,bz)||this.__yh.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__uV,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__uU,this.__uV-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__yk=true;this._updateScrollPosition();this.__yk=null;this.fireEvent(u);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__yl=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__ym(e,b);}
,_onContextmenu:function(e){this.__ym(e,k);}
,_onDbltap:function(e){this.__ym(e,n);}
,__ym:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__yl;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
;this.fireNonBubblingEvent(bC,qx.ui.virtual.core.CellEvent,[this,e,bB.row,bB.column]);}
,syncWidget:function(bD){if(this.__jh._fullUpdate){this._fullUpdate();}
else if(this.__jh._updateScrollPosition){this._updateScrollPosition();}
;this.__jh={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__yd.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__yd.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__ye.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__ye.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__yh={top:bU,bottom:bQ,left:bS,right:bI};this.__yi.setUserBounds((this.getPaddingLeft()||0)+(this.__yh.left-this.__uU),(this.getPaddingTop()||0)+(this.__yh.top-this.__uV),bO,bM);this.__qh=bH;this.__xP=bR;for(var i=0;i<this.__yj.length;i++ ){var bG=this.__yj[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__yn:function(){if(this.__yk){return;}
;var bW=this.getScrollSize();if(this.__yf!==bW.height||this.__yg!==bW.width){this.__yf=bW.height;this.__yg=bW.width;this.fireEvent(u);}
;}
...
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__yn();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__uU,this.__uV,bY.width,bY.height,true);this.__yn();}
,_deferredUpdateScrollPosition:function(){this.__jh._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__yn();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__uV,bottom:this.__uV+cc.height,left:this.__uU,right:this.__uU+cc.width};if(this.__yh.top<=cb.top&&this.__yh.bottom>=cb.bottom&&this.__yh.left<=cb.left&&this.__yh.right>=cb.right){this.__yi.setUserBounds((this.getPaddingLeft()||0)+(this.__yh.left-cb.left),(this.getPaddingTop()||0)+(this.__yh.top-cb.top),this.__yh.right-this.__yh.left,this.__yh.bottom-this.__yh.top);}
else {this._setLayerWindow(ca,this.__uU,this.__uV,cc.width,cc.height,false);}
;this.__yn();}
},destruct:function(){this._disposeArray(w);this._disposeObjects(o,j,h);this.__yh=this.__jh=this.__qh=this.__xP=null;}
});}
)();
...
,events:{"change":e},members:{__yo:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__yo=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__yo=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__yo=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__yo=null;this.fireNonBubblingEvent(c);}
,__yp:function(){if(this.__yo){return this.__yo;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__yo=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__yo=u;return u;}
,__yq:function(F){var B=this.__yo||this.__yp();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__yq(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__yr:function(M){var O=this.__yo||this.__yp();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__yr(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__yo||this.__yp();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__yo=null;}
});}
)();
...
(function(){var a="one",b="Boolean",c="qx.ui.virtual.selection.MModel",d="qx.data.Array",f="multi",g="selected",h="_applySelection",j="change",k="_applyDragSelection",l="single",m="_applyQuickSelection",n="changeSelection",o="_applySelectionMode",p="additive",q="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this._initSelectionManager();this.__zA=new qx.data.Array();this.initSelection(this.__zA);}
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__zL:false,__zM:false,__zA:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
;}
};this._manager=new qx.ui.virtual.selection.Row(this.getPane(),r);this._manager.attachPointerEvents(this.getPane());this._manager.attachKeyEvents(this);this._manager.addListener(n,this._onManagerChangeSelection,this);}
,setAutoScrollIntoView:function(w){this._manager._autoScrollIntoView=w;}
,getAutoScrollIntoView:function(){return this._manager._autoScrollIntoView;}
,_updateSelection:function(){if(this._manager==null){return;}
;this._onChangeSelection();}
,_applySelection:function(y,x){y.addListener(j,this._onChangeSelection,this);if(x!=null){x.removeListener(j,this._onChangeSelection,this);}
;this._onChangeSelection();}
,_applySelectionMode:function(A,z){this._manager.setMode(A);}
,_applyDragSelection:function(C,B){this._manager.setDrag(C);}
,_applyQuickSelection:function(E,D){this._manager.setQuick(E);}
,_onChangeSelection:function(e){if(this.__zM==true){return;}
;this.__zL=true;var G=this.getSelection();var I=[];for(var i=0;i<G.getLength();i++ ){var H=G.getItem(i);var J=this._getSelectables();var F=-1;if(J!=null){F=J.indexOf(H);}
;var K=this._reverseLookup(F);if(K>=0){I.push(K);}
;}
;if(this._beforeApplySelection!=null&&qx.lang.Type.isFunction(this._beforeApplySelection)){this._beforeApplySelection(I);}
;try{if(!qx.lang.Array.equals(I,this._manager.getSelection())){this._manager.replaceSelection(I);}
;}
catch(L){this._manager.selectItem(I[I.length-1]);}
;this.__zF();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__zL=false;}
,_onManagerChangeSelection:function(e){if(this.__zL==true){return;}
;this.__zM=true;this.__zF();this.__zM=false;}
,__zF:function(){if(this.__zO()){return;}
;var M=this._manager.getSelection();var N=[];for(var i=0;i<M.length;i++ ){var O=this._getDataFromRow(M[i]);if(O!=null){N.push(O);}
;}
;this.__zN(N);}
,__zN:function(R){var Q=this.getSelection();if(R.length>0){var P=[0,Q.getLength()];P=P.concat(R);var S=Q.splice.apply(Q,P);S.dispose();}
else {Q.removeAll();}
;}
,__zO:function(){var U=this.getSelection();var W=this._manager.getSelection();if(U.getLength()!==W.length){return false;}
;for(var i=0;i<U.getLength();i++ ){var V=U.getItem(i);var X=this._getSelectables();var T=-1;if(X!=null){T=X.indexOf(V);}
;var Y=this._reverseLookup(T);if(Y!==W[i]){return false;}
;}
;return true;}
,_applyDefaultSelection:function(){if(this._manager!=null){this._manager._applyDefaultSelection();}
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__zA){this.__zA.dispose();}
;}
});}
)();
...
(function(){var a="qx.ui.virtual.selection.Abstract",b="keypress",c="losecapture",d="qx.debug",e="addItem",f="pointerdown",g="removeItem",h="tap",i="pointermove",j="pointerover";qx.Class.define(a,{extend:qx.ui.core.selection.Abstract,construct:function(l,k){qx.ui.core.selection.Abstract.call(this);if(qx.core.Environment.get(d)){this.assertInstance(l,qx.ui.virtual.core.Pane);}
;this._pane=l;this._delegate=k||{};}
,members:{_autoScrollIntoView:true,_isSelectable:function(m){return this._delegate.isItemSelectable?this._delegate.isItemSelectable(m):true;}
,_styleSelectable:function(n,o,p){if(this._delegate.styleSelectable){this._delegate.styleSelectable(n,o,p);}
;}
,attachPointerEvents:function(){var q=this._pane.getContentElement();q.addListener(f,this.handlePointerDown,this);q.addListener(h,this.handleTap,this);q.addListener(j,this.handlePointerOver,this);q.addListener(i,this.handlePointerMove,this);q.addListener(c,this.handleLoseCapture,this);}
,detatchPointerEvents:function(){var r=this._pane.getContentElement();r.removeListener(f,this.handlePointerDown,this);r.removeListener(h,this.handleTap,this);r.removeListener(j,this.handlePointerOver,this);r.removeListener(i,this.handlePointerMove,this);r.removeListener(c,this.handleLoseCapture,this);}
...
,attachListEvents:function(u){u.addListener(e,this.handleAddItem,this);u.addListener(g,this.handleRemoveItem,this);}
,detachListEvents:function(v){v.removeListener(e,this.handleAddItem,this);v.removeListener(g,this.handleRemoveItem,this);}
...
,_getSelectableFromPointerEvent:function(event){var d=this._pane.getCellAtPosition(event.getDocumentLeft(),event.getDocumentTop());if(!d){return null;}
...
,_scrollItemIntoView:function(x){if(this._autoScrollIntoView){this._pane.scrollRowIntoView(x);}
;}
...
(function(){var c="changeModel",d="resize",f="_applyLabelOptions",g="_applyLabelPath",h="qx.data.Array",j="_applyGroupLabelOptions",m="changeLength",n="row-layer",o="_applyModel",p="changeGroups",q="Boolean",r="GroupingTypeError: You can't mix 'Objects' and 'Strings' as",s="Integer",t="sorter",u="_applyGroupRowHeight",v="group",w="_applyIconPath",x="_applyDelegate",y="changeDelegate",z=" group identifier!",A="???",B="_applyRowHeight",C="qx.data.IListData",D="filter",E="virtual-list",F="String",G="_applyGroupLabelPath",H="_applyIconOptions",I="qx.ui.list.List";qx.Class.define(I,{extend:qx.ui.virtual.core.Scroller,include:[qx.ui.virtual.selection.MModel],implement:qx.data.controller.ISelection,construct:function(J){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);this._init();this.__zP=new qx.data.Array();this.initGroups(this.__zP);if(J!=null){this.initModel(J);}
;this.initItemHeight();}
,properties:{appearance:{refine:true,init:E},focusable:{refine:true,init:true},width:{refine:true,init:100},height:{refine:true,init:200},model:{check:C,apply:o,event:c,nullable:true,deferredInit:true},itemHeight:{check:s,init:25,apply:B,themeable:true},groupItemHeight:{check:s,init:null,nullable:true,apply:u,themeable:true},labelPath:{check:F,apply:g,nullable:true},iconPath:{check:F,apply:w,nullable:true},groupLabelPath:{check:F,apply:G,nullable:true},labelOptions:{apply:f,nullable:true},iconOptions:{apply:H,nullable:true},groupLabelOptions:{apply:j,nullable:true},delegate:{apply:x,event:y,init:null,nullable:true},autoGrouping:{check:q,init:true},groups:{check:h,event:p,nullable:false,deferredInit:true}},members:{_background:null,_provider:null,_layer:null,__zQ:null,__zR:null,__zS:null,__zT:false,__zU:false,__zV:false,__zP:null,refresh:function(){this.__zY();}
,_createChildControlImpl:function(M,L){var K;switch(M){case n:K=new qx.ui.virtual.layer.Row(null,null);break;};return K||qx.ui.virtual.core.Scroller.prototype._createChildControlImpl.call(this,M);}
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__zQ=[];this.__zR=[];this.__zS={};this.__zT=false;this.__zU=false;this.__zV=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
,_initBackground:function(){this._background=this.getChildControl(n);this.getPane().addLayer(this._background);}
,_initLayer:function(){this._layer=this._provider.createLayer();this.getPane().addLayer(this._layer);}
,_getDataFromRow:function(P){var O=null;var N=this.getModel();if(N==null){return null;}
;if(this._isGroup(P)){O=this.getGroups().getItem(this._lookupGroup(P));}
else {O=N.getItem(this._lookup(P));}
;if(O!=null){return O;}
else {return null;}
;}
,_getLookupTable:function(){return this.__zQ;}
,_lookup:function(Q){return this.__zQ[Q];}
,_lookupGroup:function(R){return this.__zR.indexOf(R);}
,_reverseLookup:function(S){if(S<0){return -1;}
;return this.__zQ.indexOf(S);}
,_isGroup:function(T){return this._lookup(T)==-1;}
,_getSelectables:function(){return this.getModel();}
,_applyModel:function(V,U){if(V!=null){V.addListener(m,this._onModelChange,this);}
;if(U!=null){U.removeListener(m,this._onModelChange,this);}
;this._provider.removeBindings();this._onModelChange();}
,_applyRowHeight:function(X,W){this.getPane().getRowConfig().setDefaultItemSize(X);}
,_applyGroupRowHeight:function(ba,Y){this.__zX();}
,_applyLabelPath:function(bc,bb){this._provider.setLabelPath(bc);}
,_applyIconPath:function(be,bd){this._provider.setIconPath(be);}
,_applyGroupLabelPath:function(bg,bf){this._provider.setGroupLabelPath(bg);}
,_applyLabelOptions:function(bi,bh){this._provider.setLabelOptions(bi);}
,_applyIconOptions:function(bk,bj){this._provider.setIconOptions(bk);}
,_applyGroupLabelOptions:function(bm,bl){this._provider.setGroupLabelOptions(bm);}
,_applyDelegate:function(bo,bn){this._provider.setDelegate(bo);this.__zY();}
...
,__zW:function(){this.getPane().getRowConfig().setItemCount(this.__zQ.length);this.getPane().fullUpdate();}
,__zX:function(){var bp=this.getPane().getRowConfig();var bq=this.getGroupItemHeight();bp.resetItemSizes();if(bq){for(var i=0,l=this.__zQ.length;i<l; ++i){if(this.__zQ[i]==-1){bp.setItemSize(i,bq);}
;}
;}
;}
,__zY:function(){this.__zQ=[];this.__zR=[];this.__zS={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var br=this.getModel();if(br!=null){this._runDelegateFilter(br);this._runDelegateSorter(br);this._runDelegateGroup(br);}
;this._updateSelection();this.__zX();this.__zW();}
,_runDelegateFilter:function(bt){var bs=qx.util.Delegate.getMethod(this.getDelegate(),D);for(var i=0,l=bt.length;i<l; ++i){if(bs==null||bs(bt.getItem(i))){this.__zQ.push(i);}
;}
;}
,_runDelegateSorter:function(bu){if(this.__zQ.length==0){return;}
;var bv=qx.util.Delegate.getMethod(this.getDelegate(),t);if(bv!=null){this.__zQ.sort(function(a,b){return bv(bu.getItem(a),bu.getItem(b));}
);}
;}
,_runDelegateGroup:function(bz){var bA=qx.util.Delegate.getMethod(this.getDelegate(),v);if(bA!=null){for(var i=0,l=this.__zQ.length;i<l; ++i){var bw=this.__zQ[i];var by=this.getModel().getItem(bw);var bx=bA(by);this.__Aa(bx,bw);}
;this.__zQ=this.__Ab();}
;}
,__Aa:function(bC,bB){if(bC==null){this.__zV=true;bC=A;}
;var name=this.__Ac(bC);if(this.__zS[name]==null){this.__zS[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bC);}
;}
;this.__zS[name].push(bB);}
,__Ab:function(){this.__Ad();var bG=[];var bI=0;var bE=this.getGroups();for(var i=0;i<bE.getLength();i++ ){var bD=bE.getItem(i);bG.push(-1);this.__zR.push(bI);bI++ ;var bH=this.__Ac(bD);var bF=this.__zS[bH];if(bF!=null){for(var k=0;k<bF.length;k++ ){bG.push(bF[k]);bI++ ;}
;}
;}
;return bG;}
,__Ac:function(bK){var name=null;if(!qx.lang.Type.isString(bK)){var bJ=this.getGroups().indexOf(bK);this.__zU=true;name=v;if(bJ==-1){name+=this.getGroups().getLength();}
else {name+=bJ;}
;}
else {this.__zT=true;var name=bK;}
;return name;}
,__Ad:function(){if(this.__zU&&this.__zV||this.__zU&&this.__zT){throw new Error(r+z);}
;}
},destruct:function(){var bL=this.getModel();if(bL!=null){bL.removeListener(m,this._onModelChange,this);}
;var bM=this.getPane();if(bM!=null){bM.removeListener(d,this._onResize,this);}
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__zQ=this.__zR=this.__zS=null;if(this.__zP){this.__zP.dispose();}
;}
});}
)();
...
,properties:{anonymous:{refine:true,init:true}},members:{__jh:null,__bM:null,__xN:null,__xO:null,__xP:null,__qh:null,getFirstRow:function(){return this.__xN;}
,getFirstColumn:function(){return this.__xO;}
,getRowSizes:function(){return this.__xP||[];}
,getColumnSizes:function(){return this.__qh||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jh.fullUpdate||this.__jh.updateLayerWindow&&this.__jh.updateLayerData){this._fullUpdate.apply(this,this.__bM);}
else if(this.__jh.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bM);}
else if(this.__jh.updateLayerData&&this.__xP){this._updateLayerData();}
;if(this.__jh.fullUpdate||this.__jh.updateLayerWindow){var d=this.__bM;this.__xN=d[0];this.__xO=d[1];this.__xP=d[2];this.__qh=d[3];}
;this.__jh={};}
,_updateLayerData:function(){this._fullUpdate(this.__xN,this.__xO,this.__xP,this.__qh);}
...
,fullUpdate:function(p,q,o,n){this.__bM=arguments;this.__jh.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bM=arguments;this.__jh.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jh=this.__bM=this.__xP=this.__qh=null;}
});}
)();
...
;this.__Ae={};this.__Af={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__Ag:null,__Ah:null,__Ae:null,__Af:null,setColor:function(h,g){if(g){this.__Ae[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__Ae[h]);}
;}
,clearCustomColors:function(){this.__Ae={};this.updateLayerData();}
,getColor:function(i){var j=this.__Ae[i];if(j){return j;}
else {return i%2==0?this.__Ag:this.__Ah;}
;}
,_applyColorEven:function(l,k){if(l){this.__Ag=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__Ag=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__Ah=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__Ah=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__Af[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__Af[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__Af[q];}
},destruct:function(){this.__Ae=this.__Af=null;}
});}
)();
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__Ai(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__Ai(K)){this.updateLayerData();}
;}
,__Ai:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
(function(){var a="cell.type",b="model[",c="groups[",d="model",f="",g="changeDelegate",h="label",i="qx.ui.list.core.MWidgetController",j="icon",k="]",l="value",m="BindingIds",n=".",o="group",p="String";qx.Mixin.define(i,{construct:function(){this.__zr=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},groupLabelPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},groupLabelOptions:{nullable:true},delegate:{event:g,init:null,nullable:true}},members:{__zr:null,bindDefaultProperties:function(q,r){if(q.getUserData(a)!=o){this.bindProperty(f,d,null,q,r);this.bindProperty(this.getLabelPath(),h,this.getLabelOptions(),q,r);if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),j,this.getIconOptions(),q,r);}
;}
else {this.bindProperty(this.getGroupLabelPath(),l,this.getGroupLabelOptions(),q,r);}
;}
,bindProperty:function(u,x,v,t,s){var y=t.getUserData(a);var w=this.__zs(s,u,y);if(v){v.ignoreConverter=d;}
;var z=this._list.bind(w,t,x,v);this.__zt(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__zs(A,D,G);var H=F.bind(B,this._list,C,E);this.__zt(F,H);}
,removeBindings:function(){while(this.__zr.length>0){var I=this.__zr.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_removeBindingsFrom:function(T){var U=this.__zu(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__zr,T)){qx.lang.Array.remove(this.__zr,T);}
;}
,__zs:function(X,ba,Y){var W=b+X+k;if(Y==o){W=c+X+k;}
;if(ba!=null&&ba!=f){W+=n+ba;}
;return W;}
,__zt:function(bc,bd){var bb=this.__zu(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
;if(!qx.lang.Array.contains(this.__zr,bc)){this.__zr.push(bc);}
;}
,__zu:function(be){var bf=be.getUserData(m);if(bf==null){bf=[];be.setUserData(m,bf);}
;return bf;}
},destruct:function(){this.__zr=null;}
});}
)();
...
,styleSelectabled:function(v){var u=this.__zv(v);this._styleSelectabled(u);}
,styleUnselectabled:function(x){var w=this.__zv(x);this._styleUnselectabled(w);}
...
,__zw:function(I,H){if(I==null){return;}
...
;this._cellProvider=h;this.__zx=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__zx:null,getRenderedCellWidget:function(q,n){if(this._getChildren().length===0){return null;}
;var j=this.getColumnSizes().length;var p=this.getRowSizes().length;var o=this.getFirstRow();var m=this.getFirstColumn();if(q<o||q>=o+p||n<m||n>=m+j){return null;}
;var l=(n-m)+(q-o)*j;var k=this._getChildren()[l];if(!k||k.getUserData(g)){return null;}
else {return k;}
;}
,_getSpacer:function(){var r=this.__zx.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(B,v,A,z){var C=this._cellProvider;var H=this._getChildren().concat();for(var i=0;i<H.length;i++ ){var F=H[i];if(F.getUserData(g)){this.__zx.push(F);}
else {this._activateNotEmptyChild(F);C.poolCellWidget(F);}
;}
;var top=0;var G=0;var E=[];for(var y=0;y<A.length;y++ ){for(var x=0;x<z.length;x++ ){var I=B+y;var w=v+x;var D=C.getCellWidget(I,w)||this._getSpacer();E.push(D);D.setUserBounds(G,top,z[x],A[y]);D.setUserData(e,I);D.setUserData(a,w);this._add(D);G+=z[x];}
;top+=A[y];G=0;}
;H.forEach(function(J){if(E.indexOf(J)===-1){this._remove(J);}
;}
.bind(this));this.fireEvent(f);}
,_updateLayerWindow:function(X,K,N,bc){if(qx.core.Environment.get(b)){this.assertPositiveInteger(X);this.assertPositiveInteger(K);this.assertArray(N);this.assertArray(bc);}
;var O=X+N.length-1;var Y=K+bc.length-1;var M={firstRow:Math.max(X,this.getFirstRow()),lastRow:Math.min(O,this._lastRow),firstColumn:Math.max(K,this.getFirstColumn()),lastColumn:Math.min(Y,this._lastColumn)};this._lastColumn=Y;this._lastRow=O;if(M.firstRow>M.lastRow||M.firstColumn>M.lastColumn){return this._fullUpdate(X,K,N,bc);}
;var P=this._getChildren();var R=this.getColumnSizes().length;var U=[];var bb={};for(var Q=X;Q<=O;Q++ ){U[Q]=[];for(var ba=K;ba<=Y;ba++ ){if(Q>=M.firstRow&&Q<=M.lastRow&&ba>=M.firstColumn&&ba<=M.lastColumn){var x=ba-this.getFirstColumn();var y=Q-this.getFirstRow();var S=y*R+x;U[Q][ba]=P[S];bb[S]=true;}
;}
;}
;var L=this._cellProvider;var P=this._getChildren().concat();for(var i=0;i<P.length;i++ ){if(!bb[i]){var W=P[i];if(W.getUserData(g)){this.__zx.push(W);}
else {this._activateNotEmptyChild(W);L.poolCellWidget(W);}
;}
;}
;var top=0;var bd=0;var V=[];for(var y=0;y<N.length;y++ ){for(var x=0;x<bc.length;x++ ){var Q=X+y;var ba=K+x;var T=U[Q][ba]||L.getCellWidget(Q,ba)||this._getSpacer();V.push(T);T.setUserBounds(bd,top,bc[x],N[y]);T.setUserData(e,Q);T.setUserData(a,ba);this._add(T);bd+=bc[x];}
;top+=N[y];bd=0;}
;P.forEach(function(be){if(V.indexOf(be)===-1){this._remove(be);}
;}
.bind(this));this.fireEvent(f);}
},destruct:function(){var bf=this._getChildren();for(var i=0;i<bf.length;i++ ){bf[i].dispose();}
;this._cellProvider=this.__zx=null;}
});}
)();
...
(function(){var a="created",b="qx.ui.virtual.cell.AbstractWidget",c="cell.states",d="abstract method call",e="qx.event.type.Data";qx.Class.define(b,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){qx.core.Object.call(this);this.__cO=[];}
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__zy();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cO.push(p);}
,_cleanupPool:function(){var q=this.__cO.pop();while(q){q.destroy();q=this.__cO.pop();}
;}
,__zy:function(){var r=this.__cO.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
},destruct:function(){this._cleanupPool();this.__cO=null;}
});}
)();
