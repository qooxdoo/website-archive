...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.39e6d7df173b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__oW=document||window.document;this.__Dm();var self=this;qx.bom.Event.addNativeListener(this.__oW,this.__dx,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__oW:null,__GF:null,__GG:null,__dx:null,__Dm:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__oW[m]!=undefined){this.__GF=m;this.__dx=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__oW[m]!=undefined){this.__GG=m;break;}
;}
;if(this.__GF==null){this.__GF=k;this.__dx=c;}
;if(this.__GG==null){this.__GG=b;}
;}
,isHidden:function(){return !!this.__oW[this.__GF];}
,getVisibilityState:function(){return this.__oW[this.__GG]||d;}
}});}
)();
