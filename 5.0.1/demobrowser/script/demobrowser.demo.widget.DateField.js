...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.DateField","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.DateField.7469fec86c96.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="With date formater",b="demobrowser.demo.widget.DateField",c="",d="Change Value: ",f="dd.MM.yyyy",g="Set current date",h="Default",i="Set data",j="en",k="changeValue",l="Get data",m="MM/dd/yyyy",n="MM-yyyy",o="Reset",p="Get date",q="execute";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);qx.locale.Manager.getInstance().setLocale(j);this.getRoot().add(new qx.ui.basic.Label(h),{top:15,left:20});var r=new qx.ui.form.DateField();this.getRoot().add(r,{top:35,left:20});r.setValue(new Date());r.addListener(k,function(e){this.debug(d+e.getData());}
);this.getRoot().add(new qx.ui.basic.Label(a),{top:15,left:150});var t=new qx.ui.form.DateField();this.getRoot().add(t,{top:35,left:150});t.setValue(new Date());var B=new qx.util.format.DateFormat(n);var C=new qx.util.format.DateFormat(m);var v=new qx.util.format.DateFormat(f);t.setDateFormat(C);var A=new qx.ui.form.Button(n);A.setWidth(120);this.getRoot().add(A,{top:80,left:150});A.addListener(q,function(e){t.setDateFormat(B);}
);var D=new qx.ui.form.Button(m);D.setWidth(120);this.getRoot().add(D,{top:110,left:150});D.addListener(q,function(e){t.setDateFormat(C);}
);var w=new qx.ui.form.Button(f);w.setWidth(120);this.getRoot().add(w,{top:140,left:150});w.addListener(q,function(e){t.setDateFormat(v);}
);this.getRoot().add(new qx.ui.basic.Label(i),{top:15,left:280});var s=new qx.ui.form.DateField();this.getRoot().add(s,{top:35,left:280});var E=new qx.ui.form.Button(g);E.setWidth(120);this.getRoot().add(E,{top:80,left:280});E.addListener(q,function(e){s.setValue(new Date());}
);var x=new qx.ui.form.Button(o);x.setWidth(120);this.getRoot().add(x,{top:110,left:280});x.addListener(q,function(e){s.resetValue();}
);this.getRoot().add(new qx.ui.basic.Label(l),{top:15,left:410});var z=new qx.ui.form.DateField();this.getRoot().add(z,{top:35,left:410});var y=new qx.ui.basic.Label();this.getRoot().add(y,{left:410,top:88});var u=new qx.ui.form.Button(p);u.setWidth(120);this.getRoot().add(u,{left:410,top:80});u.addListener(q,function(e){y.setValue(z.getValue()+c);}
);}
}});}
)();
