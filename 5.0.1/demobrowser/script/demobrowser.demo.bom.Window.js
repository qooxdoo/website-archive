...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.4624330fa886.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__xj:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__xj=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__xj[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__xj[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__xj[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__lp:null,__Is:null,__eg:null,__It:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__Iu:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Iv:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__Iw(H,E&&A);if(E){if(this.__Iv()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__eg==null){this.__eg=new qx.event.Timer(500);this.__eg.addListener(f,this.__Ix,this);}
;this.__Is=window.open(z,name,G);this.__eg.restart();C=this.__Is;}
;}
...
;return C;}
,__Iw:function(K,O){var M;var J;var N=[];if(O&&this.__Iv()){for(var L in K){if(qx.bom.Window.__It[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__It[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Iu[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__Ix:function(){if(this.isClosed(this.__Is)){this.getBlocker().unblock();this.__eg.stop();}
;}
,getBlocker:function(){if(this.__lp==null){this.__lp=new qx.bom.Blocker;}
;return this.__lp;}
...
,members:{__Iy:null,__yO:null,__Iz:null,__IA:false,__IB:10000,__IC:0,__ID:f,block:function(r){if(!this.__IA){this.__Iz=r;var q=this.__IG();this.__IH(q);this.__IA=true;}
;}
,unblock:function(){if(this.__IA){this.__II();this.__IA=false;}
;}
,isBlocked:function(){return this.__IA;}
,getBlockerElement:function(){return this.__yO;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__yO,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__yO,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__yO,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__yO);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__yO,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__yO,h);}
,__cR:function(){this.__IE();if((qx.core.Environment.get(j)==b)){this.__IF();}
;qx.event.Registration.addListener(window,a,this.__Be,this);}
,__IE:function(){this.__yO=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__yO,{display:d,opacity:this.__IC,backgroundColor:this.__ID});this.setBlockerZIndex(this.__IB);}
,__IF:function(){this.__Iy=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Iy,l,false);qx.bom.element.Attribute.set(this.__Iy,i,n);qx.bom.element.Style.setStyles(this.__Iy,{display:d,opacity:this.__IC});}
,__IG:function(){var v={position:p};if(this.__IK()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Iz)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Iz)+g;v.left=qx.bom.element.Location.getLeft(this.__Iz)+g;v.top=qx.bom.element.Location.getTop(this.__Iz)+g;}
;return v;}
,__IH:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__yO,w);qx.dom.Element.insertEnd(this.__yO,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Iy,w);qx.dom.Element.insertEnd(this.__Iy,document.body);}
;}
,__II:function(){qx.dom.Element.remove(this.__yO);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Iy);}
;}
,__Be:function(e){if(this.__IK()){this.__IJ({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__IJ(y);}
,this,0);}
;}
,__IJ:function(z){qx.bom.element.Style.setStyles(this.__yO,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Iy,z);}
;}
,__IK:function(){return (this.__Iz==null||qx.dom.Node.isWindow(this.__Iz)||qx.dom.Node.isDocument(this.__Iz));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__Be,this);this.__Iy=this.__yO=this.__Iz=null;}
});}
)();
