...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox.346247d1a723.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{sort:{check:[m,o,A],init:m,apply:r},separatorX:{check:p,nullable:true,apply:h},separatorY:{check:p,nullable:true,apply:h},connectSeparators:{check:a,init:false,apply:h},spacingX:{check:f,init:0,apply:h},spacingY:{check:f,init:0,apply:h}},members:{__gW:null,__GK:null,verifyLayoutProperty:qx.core.Environment.select(j,{"true":function(F,name,G){this.assertInArray(name,[y,w,c,k],g+name+l);if(name===w){this.assertInArray(G,[s,x,d,v,n]);}
...
,__GL:{north:1,south:2,west:3,east:4,center:5},__GM:{'1':t,'2':e,'3':z,'4':u},__nI:function(){var H=this._getLayoutChildren();var P,J;var length=H.length;var L=[];var O=[];var K=[];var I=this.getSort()===o;var N=this.getSort()===A;for(var i=0;i<length;i++ ){P=H[i];K=P.getLayoutProperties().edge;if(K===n){if(J){throw new Error(b);}
;J=P;}
...
;this.__gW=Q;var M=[];for(var i=0;i<length;i++ ){K=Q[i].getLayoutProperties().edge;M[i]=this.__GL[K]||5;}
;this.__GK=M;delete this._invalidChildrenCache;}
,renderLayout:function(bl,bb,bt){if(this._invalidChildrenCache){this.__nI();}
;var bk=qx.ui.layout.Util;var W=this.__gW;var bm=this.__GK;var length=W.length;var ba,bu,Y,bf,bg,br,bd,T,S;var bx=[];var bc=[];var bs=this._getSeparatorWidths();var bB=this.getSpacingX();var bA=this.getSpacingY();var X=-bB;var bn=-bA;if(bs.x){X-=bs.x+bB;}
;if(bs.y){bn-=bs.y+bA;}
...
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__nI();}
;var bS=this.__gW;var cd=this.__GK;var length=bS.length;var bW,ce;var bY,bX;var ca=0,cl=0;var bP=0,cg=0;var cb=0,ck=0;var bQ=0,cf=0;var ch=this._getSeparatorWidths();var cj=this.getSpacingX(),ci=this.getSpacingY();var bU=-cj,bT=-ci;if(ch.x){bU-=ch.x+cj;}
;if(ch.y){bT-=ch.y+ci;}
...
},destruct:function(){this.__GK=this.__gW=null;}
});}
)();
...
,_applyValue:function(bi,bh){var bg=this.getChildControl(t);this._updateButtons();this.__yH=bi;if(bi!==null){if(this.getNumberFormat()){bg.setValue(this.getNumberFormat().format(bi));}
...
;if(bx===this.__yH){this._applyValue(this.__yH);}
...
,_countUp:function(){if(this.__yI){var bE=this.getValue()+this.getPageStep();}
...
;}
;this.gotoValue(bE);}
,_countDown:function(){if(this.__yJ){var bG=this.getValue()-this.getPageStep();}
...
(function(){var a="yellow",b="demobrowser.demo.layout.HBox",c="center",d="green",e="top",f="bottom",g="middle",h="main",i="right";qx.Class.define(b,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(j);j.add(this.getBox1());j.add(this.getBox2());j.add(this.getBox3());j.add(this.getBox4());j.add(this.getBox5());j.add(this.getBox6());j.add(this.getBox7());}
,getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:h,backgroundColor:a,allowGrowX:false});k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));return k;}
,getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:h,backgroundColor:a,minHeight:60,allowGrowX:false});l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:40,alignY:e}));l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:40,alignY:g}));l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:40,alignY:f}));return l;}
,getBox3:function(){var m=new qx.ui.layout.HBox();var n=new qx.ui.container.Composite(m).set({decorator:h,backgroundColor:a,width:500,allowGrowX:false});m.setSpacing(5);m.setAlignX(i);n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));return n;}
,getBox4:function(){var o=new qx.ui.layout.HBox();var p=new qx.ui.container.Composite(o).set({decorator:h,backgroundColor:a,width:500,allowGrowX:false});o.setSpacing(5);o.setAlignX(c);p.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));p.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));p.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}));return p;}
,getBox5:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:h,backgroundColor:a,allowGrowX:false});var t=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});var s=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});var r=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});q.add(t);q.add(s);q.add(r);t.setMarginRight(10);s.setMarginLeft(20);s.setMarginRight(10);r.setMarginRight(10);return q;}
,getBox6:function(){var u=new qx.ui.layout.HBox();var w=new qx.ui.container.Composite(u).set({decorator:h,backgroundColor:a,width:500,allowGrowX:false});u.setSpacing(5);u.setAlignX(i);var y=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});var x=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});var v=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});w.add(y);w.add(x);w.add(v);y.setMarginRight(10);x.setMarginLeft(20);x.setMarginRight(10);v.setMarginRight(10);return w;}
,getBox7:function(){var z=new qx.ui.layout.HBox();var B=new qx.ui.container.Composite(z).set({decorator:h,backgroundColor:a,width:500,allowGrowX:false});z.setSpacing(5);z.setAlignX(c);var D=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});var C=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});var A=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d});B.add(D);B.add(C);B.add(A);D.setMarginRight(10);C.setMarginLeft(20);C.setMarginRight(10);A.setMarginRight(10);return B;}
}});}
)();
