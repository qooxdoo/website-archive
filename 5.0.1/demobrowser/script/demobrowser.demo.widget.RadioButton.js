...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButton.e38e4ff68d44.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Yellow",b="Red",c="demobrowser.demo.widget.RadioButton",d="Green",f="Your favorite color is: ",g="changeSelection",h="Blue",i="What is your favorite color?";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var o=new qx.ui.basic.Label(i);var l=new qx.ui.layout.VBox();l.setSpacing(10);var j=new qx.ui.container.Composite(l);j.setPadding(20);this.getRoot().add(j,{left:0,top:0});j.add(o);var n=new qx.ui.form.RadioButton(b);var m=new qx.ui.form.RadioButton(d);var q=new qx.ui.form.RadioButton(a);var k=new qx.ui.form.RadioButton(h);j.add(n);j.add(m);j.add(q);j.add(k);var p=new qx.ui.form.RadioGroup(n,m,q,k);p.addListener(g,this._onChangeSelection,this);}
,_onChangeSelection:function(e){var s=e.getData()[0];var r=s.getLabel();alert(f+r);}
}});}
)();
