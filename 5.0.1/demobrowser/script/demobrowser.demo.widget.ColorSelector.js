...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorSelector.13274e311b14.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__yG=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__yG=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pt?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pt=true;this.__yG=true;this.setRed(255);this.setGreen(255);this.__yG=false;this.setBlue(255);}
,__pv:function(){if(!this.__yG){this.__pt=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__yA===null){this.__yA=bU;}
;if(this.__yA!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__yA!==n){this._setHexFromRgb();}
;switch(this.__yA){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yA===bU){this.__yA=null;}
;}
,_applyGreen:function(de,dd){if(this.__yA===null){this.__yA=cq;}
;if(this.__yA!==cK){this.getChildControl(O).setValue(de);}
;if(this.__yA!==n){this._setHexFromRgb();}
;switch(this.__yA){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yA===cq){this.__yA=null;}
;}
,_applyBlue:function(dg,df){if(this.__yA===null){this.__yA=d;}
;if(this.__yA!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__yA!==n){this._setHexFromRgb();}
;switch(this.__yA){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yA===d){this.__yA=null;}
;}
,_applyHue:function(di,dh){if(this.__yA===null){this.__yA=cr;}
;if(this.__yA!==F){this.getChildControl(cu).setValue(di);}
;if(this.__yA!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__yA){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__yA===cr){this.__yA=null;}
;}
,_applySaturation:function(dk,dj){if(this.__yA===null){this.__yA=s;}
;if(this.__yA!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__yA!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__yA){case F:case R:case s:this._setRgbFromHue();};if(this.__yA===s){this.__yA=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__yA===null){this.__yA=c;}
;if(this.__yA!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__yA!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__yA){case F:case P:case c:this._setRgbFromHue();};if(this.__yA===c){this.__yA=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__yC=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__yD=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__yC=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__yC===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__yD=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__yC=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__yD,0,256);this.__yA=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__yA=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__yC){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__yC=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__yC===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__yE=location.top+(du.height/2)-dv.top;this.__yF=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__yC=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__yE,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__yF,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__yA=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__yA=null;}
,_setRedFromSpinner:function(){if(this.__yA!==null){return;}
;this.__yA=cK;this.setRed(this.getChildControl(m).getValue());this.__yA=null;}
,_setGreenFromSpinner:function(){if(this.__yA!==null){return;}
;this.__yA=cK;this.setGreen(this.getChildControl(O).getValue());this.__yA=null;}
,_setBlueFromSpinner:function(){if(this.__yA!==null){return;}
;this.__yA=cK;this.setBlue(this.getChildControl(cG).getValue());this.__yA=null;}
,_setHueFromSpinner:function(){if(this.__yA!==null){return;}
;this.__yA=F;this.setHue(this.getChildControl(cu).getValue());this.__yA=null;}
,_setSaturationFromSpinner:function(){if(this.__yA!==null){return;}
;this.__yA=F;this.setSaturation(this.getChildControl(cx).getValue());this.__yA=null;}
,_setBrightnessFromSpinner:function(){if(this.__yA!==null){return;}
;this.__yA=F;this.setBrightness(this.getChildControl(bT).getValue());this.__yA=null;}
,_onHexFieldChange:function(e){if(this.__yA!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__yA=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__yA=null;}
...
,_setHueFromRgb:function(){switch(this.__yA){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__yA){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
