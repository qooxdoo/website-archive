...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Grid_Complex.3a8334a77bce.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="yellow",b="bottom",c="center",d="green",e="middle",f="demobrowser.demo.layout.Grid_Complex",g="orange",h="main",i="right";qx.Class.define(f,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(j);j.add(this.getGrid1());j.add(this.getGrid2());}
,getGrid1:function(){var k=new qx.ui.container.Composite().set({decorator:h,backgroundColor:a,allowGrowX:false});k.setLayout(new qx.ui.layout.Grid(5,20));k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:0,column:0});k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:0,column:1});k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,width:150,maxWidth:150}),{row:1,column:0,rowSpan:1,colSpan:2});return k;}
,getGrid2:function(){var l=new qx.ui.container.Composite().set({decorator:h,backgroundColor:a,width:500,allowShrinkX:false,allowShrinkY:false,allowGrowX:false});var o=new qx.ui.layout.Grid();o.setColumnFlex(1,2);o.setRowFlex(1,3);o.setColumnMinWidth(0,70);o.setColumnMinWidth(1,100);o.setColumnMaxWidth(2,150);o.setRowMinHeight(0,70);o.setSpacing(5);l.setLayout(o);l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:0,column:0});l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:0,column:1,rowSpan:1,colSpan:2});l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:1,column:0});var n=new qx.ui.container.Composite().set({decorator:h,backgroundColor:g,width:400,padding:5});l.add(n,{row:1,column:1,rowSpan:2,colSpan:2});l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:2,column:0});l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:3,column:0,rowSpan:1,colSpan:2});l.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d}),{row:3,column:2});var m=new qx.ui.layout.Grid();n.setLayout(m);m.setColumnAlign(1,c,e);m.setColumnAlign(0,i,b);m.setColumnMinWidth(1,40);m.setSpacing(5);m.setColumnFlex(1,1);n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,width:150}),{row:0,column:0});n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,height:70,allowGrowX:false}),{row:0,column:1});n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:60,allowGrowX:false}),{row:1,column:0});n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,minWidth:170}),{row:2,column:0});return l;}
}});}
)();
