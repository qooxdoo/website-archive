...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Viewport","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Viewport.325eb9647616.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Document Dimension: ",b="Viewport Dimension: ",c="Viewport Scroll: ",d="tap",e="x",f="demobrowser.demo.bom.Viewport";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.bom.Element.addListener(document.body,d,function(){this.debug(a+qx.bom.Document.getWidth()+e+qx.bom.Document.getHeight());this.debug(b+qx.bom.Viewport.getWidth()+e+qx.bom.Viewport.getHeight());this.debug(c+qx.bom.Viewport.getScrollLeft()+e+qx.bom.Viewport.getScrollTop());}
,this);}
}});}
)();
