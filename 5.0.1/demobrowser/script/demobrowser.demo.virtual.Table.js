...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.ee47cada8078.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="demobrowser.demo.virtual.Table",d="white",e="#EEE",f="vertical",g="__Pz";qx.Class.define(c,{extend:qx.application.Standalone,members:{__Pz:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(d,e));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(f));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__Pz=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__Pz.getCellProperties(k+a+j);}
...
;this.__dP=qx.bom.Stylesheet.createElement(p);this.__xv={};this.__mt={};}
,members:{__dP:null,__xv:null,__mt:null,getStylesheet:function(){return this.__dP;}
,getCssClass:function(q){return this.__xv[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__mt[r];if(!s){var s=this.__xw();qx.bom.Stylesheet.addRule(this.__dP,k+s,r);this.__mt[r]=s;}
;this.__xv[t]=s;return s;}
,__xw:function(){return e+this.toHashCode()+a+(this.__xx++ );}
,__xx:0},destruct:function(){this.__dP=this.__xv=this.__mt=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dP=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__xy={};this.__xz={};this.__xA={};this.__xB={};this.__jz={};this.__xC={};this.initAppearance();this.__xG();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__xD:null,__xE:null,__jz:null,__xC:null,__xz:null,__xy:null,__xA:null,__xB:null,__xF:false,__dP:null,__xG:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__xD=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__xD.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__xz={};}
;}
,_getValue:function(R){if(this.__xF){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__xF){U=this.__xz;}
else {U=this.__xy;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__xF){var bi=this.__xB;}
else {bi=this.__xA;}
...
;}
,getCellProperties:function(bk,bj){this.__xH(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dP.getCssClass(this.__xE)||t;return v+bq;}
,__xH:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__xE==bt){return;}
;this.__xE=bt;var bv=this.__jz[this.__xE];if(!bv){this.__xI();this.__xJ(bs);this.__xK(bs);this.__xL();this.__jz[this.__xE]=1;}
;this.__xM();}
,__xI:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__xJ:function(bz){this.__xz={};this.__xF=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__xF=false;}
,__xK:function(){var bD=qx.lang.Object.getValues(this.__xz).join(I);this.__dP.computeClassForStyles(this.__xE,bD);}
,__xL:function(){var bI=this.__xD;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__xC[this.__xE]=bG;}
,__xM:function(){var bK=qx.util.PropertyUtil;var bJ=this.__xC[this.__xE]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__xy).join(I);}
,getInsets:function(bQ,bR){var bT=this.__xA;var bS=this.__xB;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dP=this.__xy=this.__xz=this.__xA=this.__xB=this.__jz=this.__xC=this.__xD=null;}
});}
)();
