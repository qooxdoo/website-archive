...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.c492c10f5f48.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Qa:4,__Qb:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Qb/this.__Qa),column:this.__Qb%this.__Qa});this.__Qb+=1;}
