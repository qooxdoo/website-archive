...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_ShrinkY.60d8f7691da1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.layout.HBox_ShrinkY",b="green",c="main",d="yellow";qx.Class.define(a,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var e=new qx.ui.layout.HBox();var g=(new qx.ui.container.Composite(e)).set({decorator:c,backgroundColor:d,maxHeight:100});e.setSpacing(5);var i=new qx.ui.core.Widget().set({decorator:c,backgroundColor:b});var h=new qx.ui.core.Widget().set({decorator:c,backgroundColor:b});var f=new qx.ui.core.Widget().set({decorator:c,backgroundColor:b});i.setHeight(200);h.setHeight(300);f.setHeight(400);g.add(i);g.add(h);g.add(f);this.getRoot().add(g,{left:10,top:10});}
}});}
)();
