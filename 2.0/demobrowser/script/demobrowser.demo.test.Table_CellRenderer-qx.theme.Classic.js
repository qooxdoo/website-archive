...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellRenderer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Classic.74698942b88c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="</div>",j="qx/icon/Oxygen",h="waiting",g="icon/16/actions/go-next.png",f="qx.theme",e="http://resources.qooxdoo.org/images/logo.gif",d="$ ",c="string",b="border: 1px dotted green",a="inactive",R="decoration",Q="multi<br>line",P="between",O="<",N="<div style='position:absolute;height:20px;width:",M="px;top:",L="icon/16/actions/go-previous.png",K="number",J="px'>",I="Classic",r="<i>italic</i>",s="0$",p="qx/icon/Tango",q="<b>bold</b>",n="icon/16/actions/go-up.png",o="qx/decoration/",l="boolean",m="demobrowser.demo.test.Table_CellRenderer",t="tooltip",u="red",A="icon/16/emotes/face-sad.png",z="icon/16/emotes/face-smile.png",C="left",B=">=",E="active",D="object",w="Hello",H="icon/16/actions/go-down.png",G="World",F="icon",v="bold",x="Juhu",y="";qx.Class.define(m,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);this.setUp();this.testDefaultRenderer(new qx.ui.table.cellrenderer.Default());this.testDefaultRenderer(new qx.ui.table.cellrenderer.Default().set({useAutoAlign:false}));this.testBooleanRenderer();this.testDateRenderer();this.testNumberRenderer();this.testImageRenderer();this.testStringRenderer();this.testPasswordRenderer();this.testHtmlRenderer();this.testConditionalRenderer();this.testDynamicRenderer();this.testReplaceRenderer();}
,setUp:function(){this.tableMock=this.getTableMock();var T=qx.core.Environment.get(f);var S=/\.([a-z]+)$/i.exec(T)[1];qx.util.AliasManager.getInstance().add(R,o+S);if(S==I){qx.util.AliasManager.getInstance().add(F,j);}
else {qx.util.AliasManager.getInstance().add(F,p);}
;}
,__Lo:function(U,top,V,W,X){var Y=[N,V,M,top,J];W.createDataCellHtml(X,Y);Y.push(k);U.innerHTML+=Y.join(y);}
,testDefaultRenderer:function(ba){var bb=100;var bd={value:[null,x,32,new Date()],styleLeft:[0],styleWidth:[bb],styleHeight:[20],style:[y]};var bc=this._getNewTableDiv(bb);var top=0;qx.util.Permutation.permute(bd,function(be){this.__Lo(bc,top,bb,ba,be);top+=20;}
,this);}
,testBooleanRenderer:function(){var bi=70;var bh=30;var bj=new qx.ui.table.cellrenderer.Boolean();var bf={value:[null,true,false],styleLeft:[0],styleWidth:[bi],styleHeight:[bh],style:[y]};var bg=this._getNewTableDiv(bi);var top=0;qx.util.Permutation.permute(bf,function(bk){this.__Lo(bg,top,bi,bj,bk);top+=bh;}
,this);bj.setIconFalse(A);bj.setIconTrue(z);qx.util.Permutation.permute(bf,function(bl){this.__Lo(bg,top,bi,bj,bl);top+=bh;}
,this);}
,testDateRenderer:function(){var bp=180;var bq=new qx.ui.table.cellrenderer.Date();var bs={value:new Date(),styleLeft:[0],styleWidth:[bp],styleHeight:[20],style:[y]};var bo=qx.util.format.DateFormat;var br=[bo.getDateTimeInstance(),bo.getDateInstance()];var bm=this._getNewTableDiv(bp);var top=0;for(var i=0;i<br.length;i++){var bn=br[i];bq.setDateFormat(bn);this.__Lo(bm,top,bp,bq,bs);top+=20;}
;}
,testNumberRenderer:function(){var bx=new qx.ui.table.cellrenderer.Number();var bw=100;var bz={value:Math.PI,styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[y]};var bv=qx.util.format.NumberFormat;var by=[new bv().set({maximumFractionDigits:0}),new bv().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:d})];var bt=this._getNewTableDiv(bw);var top=0;for(var i=0;i<by.length;i++){var bu=by[i];bx.setNumberFormat(bu);this.__Lo(bt,top,bw,bx,bz);top+=20;}
;}
,testImageRenderer:function(){var bC=new qx.ui.table.cellrenderer.Image();var bA=50;var bD={value:[null,H,n,L,g,e],styleLeft:[0],styleWidth:[bA],styleHeight:[20],style:[y],tooltip:[y,t]};var bB=this._getNewTableDiv(bA);var top=0;qx.util.Permutation.permute(bD,function(bE){this.__Lo(bB,top,bA,bC,bE);top+=20;}
,this);}
,testStringRenderer:function(){var bJ=new qx.ui.table.cellrenderer.String();var bI=100;var bH=20;var bF={value:[null,w,G],styleLeft:[0],styleWidth:[bI],styleHeight:[bH],style:[y]};var bG=this._getNewTableDiv(bI);var top=0;qx.util.Permutation.permute(bF,function(bK){this.__Lo(bG,top,bI,bJ,bK);top+=20;}
,this);}
,testPasswordRenderer:function(){var bP=new qx.ui.table.cellrenderer.Password();var bO=100;var bN=20;var bL={value:[null,w,G],styleLeft:[0],styleWidth:[bO],styleHeight:[bN],style:[y]};var bM=this._getNewTableDiv(bO);var top=0;qx.util.Permutation.permute(bL,function(bQ){this.__Lo(bM,top,bO,bP,bQ);top+=20;}
,this);}
,testHtmlRenderer:function(){var bV=new qx.ui.table.cellrenderer.Html();var bU=100;var bT=50;var bR={value:[null,q,r,Q],styleLeft:[0],styleWidth:[bU],styleHeight:[bT],style:[y]};var bS=this._getNewTableDiv(bU);var top=0;qx.util.Permutation.permute(bR,function(bW){this.__Lo(bS,top,bU,bV,bW);top+=20;}
,this);}
,testConditionalRenderer:function(){var cc=new qx.ui.table.cellrenderer.Conditional();cc.addNumericCondition(O,0,null,u,null,null);cc.addNumericCondition(B,100,C,null,null,null);cc.addBetweenCondition(P,0,2,null,null,null,v,null);cc.addRegex(s,null,null,v,b);var cb=100;var ca=20;var bX={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[cb],table:[this.tableMock],styleHeight:[ca],style:[y]};var bY=this._getNewTableDiv(cb);var top=0;qx.util.Permutation.permute(bX,function(cd){this.__Lo(bY,top,cb,cc,cd);top+=20;}
,this);}
,testDynamicRenderer:function(){var ci=new qx.ui.table.cellrenderer.Dynamic();ci.setCellRendererFactoryFunction(function(cj){var cl=cj.value;var ck=qx.ui.table.cellrenderer;switch(typeof cl){case c:if(cl.match(/^icon\//)){return new ck.Image();}
else {return new ck.String();}
;case l:return new ck.Boolean();case K:return new ck.Number();case D:if(cl instanceof Date){return new ck.Date();}
;return new ck.Default();};}
);var ch=100;var cg=20;var ce={value:[null,x,new Date(),30,H,false],styleLeft:[0],styleWidth:[ch],styleHeight:[cg],table:[this.tableMock],style:[y]};var cf=this._getNewTableDiv(ch);var top=0;qx.util.Permutation.permute(ce,function(cm){this.__Lo(cf,top,ch,ci,cm);top+=20;}
,this);}
,testReplaceRenderer:function(){var cs=new qx.ui.table.cellrenderer.Replace();cs.setReplaceMap({'1':E,'2':a,'3':h});cs.addReversedReplaceMap();var cq=100;var cp=20;var cn={value:[1,2,3],styleLeft:[0],styleWidth:[cq],table:[this.tableMock],styleHeight:[cp],style:[y]};var co=this._getNewTableDiv(cq);var top=0;qx.util.Permutation.permute(cn,function(ct){this.__Lo(co,top,cq,cs,ct);top+=20;}
,this);}
},destruct:function(){this.tableMock=null;}
});}
)();
(function(){var a="qx.util.Permutation";qx.Class.define(a,{statics:{permute:function(b,c,d){var f=qx.lang.Object.getKeys(b);var e={};var j=[];for(var i=0;i<f.length;i++){j[i]=0;var h=f[i];e[h]=b[h][0];}
;var g=function(k,l){if(k>=f.length){return;}
;var n=f[k];var m=b[n];for(var i=0;i<m.length;i++){if(l!==i){j[k]=i;e[n]=m[i];c.call(d||window,e);}
;g(k+1,j[k+1]);}
;}
;g(0,-1);}
}});}
...
(function(){var v="regex cannot be null!",u="font-weight",t="Condition not recognized or value1/value2 is null!",s="Condition not recognized or value is null!",r="text-align",q=";",p='g',o=":",n="qx.ui.table.cellrenderer.Conditional",m="color",e="font-style",l="==",h=">",c="between",b="<",g="regex",f="!between",j=">=",a="!=",k="<=",d="";qx.Class.define(n,{extend:qx.ui.table.cellrenderer.Default,construct:function(w,x,y,z){qx.ui.table.cellrenderer.Default.call(this);this.numericAllowed=[l,a,h,b,j,k];this.betweenAllowed=[c,f];this.conditions=[];this.__xO=w||d;this.__xP=x||d;this.__xQ=y||d;this.__xR=z||d;}
,members:{__xO:null,__xP:null,__xQ:null,__xR:null,__xS:function(A,B){if(A[1]!=null){B[r]=A[1];}
;if(A[2]!=null){B[m]=A[2];}
;if(A[3]!=null){B[e]=A[3];}
;if(A[4]!=null){B[u]=A[4];}
;}
...
;var bg=bb.table.getTableModel();var i;var bi;var bc;var be={"text-align":this.__xO,"color":this.__xP,"font-style":this.__xQ,"font-weight":this.__xR};for(i in this.conditions){bi=false;if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){bc=bb.value;}
...
;;if(bi==true){this.__xS(this.conditions[i],be);}
;}
...
(function(){var d="qx.util.format.DateFormat",c="qooxdoo-table-cell",b="qx.ui.table.cellrenderer.Date",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.Conditional,properties:{dateFormat:{check:d,init:null,nullable:true}},members:{_getContentHtml:function(e){var f=this.getDateFormat();if(f){if(e.value){return qx.bom.String.escape(f.format(e.value));}
else {return a;}
;}
else {return e.value||a;}
;}
,_getCellClass:function(g){return c;}
}});}
)();
(function(){var e="qooxdoo-table-cell qooxdoo-table-cell-right",d="0",c="qx.util.format.NumberFormat",b="qx.ui.table.cellrenderer.Number",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.Conditional,properties:{numberFormat:{check:c,init:null,nullable:true}},members:{_getContentHtml:function(f){var g=this.getNumberFormat();if(g){if(f.value||f.value==0){return g.format(f.value);}
else {return a;}
;}
else {return f.value==0?d:(f.value||a);}
;}
,_getCellClass:function(h){return e;}
}});}
)();
(function(){var b="qx.ui.table.cellrenderer.Image",a="";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__qq=c;}
;if(d){this.__qr=d;}
;this.__qs=qx.util.AliasManager.getInstance();}
,members:{__qs:null,__qr:16,__qq:16,_identifyImage:function(e){var f={imageWidth:this.__qq,imageHeight:this.__qr};if(e.value==a){f.url=null;}
else {f.url=this.__qs.resolve(e.value);}
;f.tooltip=e.tooltip;return f;}
},destruct:function(){this.__qs=null;}
});}
)();
(function(){var c="qx.ui.table.cellrenderer.String",b="qooxdoo-table-cell",a="";qx.Class.define(c,{extend:qx.ui.table.cellrenderer.Conditional,members:{_getContentHtml:function(d){return qx.bom.String.escape(d.value||a);}
,_getCellClass:function(e){return b;}
}});}
)();
(function(){var c="",b="qx.ui.table.cellrenderer.Password",a="*";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.Default,members:{_getContentHtml:function(d){var e=d.value;if(e===null){e=c;}
;d.value=e.replace(/./g,a);return qx.bom.String.escape(this._formatValue(d));}
}});}
)();
...
(function(){var c="Function",b="No function provided! Aborting.",a="qx.ui.table.cellrenderer.Dynamic";qx.Class.define(a,{extend:qx.ui.table.cellrenderer.Default,construct:function(d){qx.ui.table.cellrenderer.Default.call(this);if(d){this.setCellRendererFactoryFunction(d);}
;}
,properties:{cellRendererFactoryFunction:{check:c,nullable:true,init:null}},members:{createDataCellHtml:function(e,f){var h=this.getCellRendererFactoryFunction();if(!h){throw new Error(b);}
;var g=h(e);return g.createDataCellHtml(e,f);}
}});}
)();
(function(){var d="Function",c="undefined",b="qx.ui.table.cellrenderer.Replace",a="Object";qx.Class.define(b,{extend:qx.ui.table.cellrenderer.Default,properties:{replaceMap:{check:a,nullable:true,init:null},replaceFunction:{check:d,nullable:true,init:null}},members:{_getContentHtml:function(e){var h=e.value;var f=this.getReplaceMap();var g=this.getReplaceFunction();var i;if(f){i=f[h];if(typeof i!=c){e.value=i;return qx.bom.String.escape(this._formatValue(e));}
;}
;if(g){e.value=g(h);}
;return qx.bom.String.escape(this._formatValue(e));}
,addReversedReplaceMap:function(){var j=this.getReplaceMap();for(var l in j){var k=j[l];j[k]=l;}
;return true;}
}});}
)();
