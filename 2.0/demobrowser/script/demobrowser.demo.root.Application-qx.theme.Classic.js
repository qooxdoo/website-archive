...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Application","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Application-qx.theme.Classic.d21893e25a59.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="yellow",e="red",d="demobrowser.demo.root.Application",c="green",b="blue",a="main";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.core.Widget().set({backgroundColor:e,decorator:a,padding:10});var j=new qx.ui.core.Widget().set({backgroundColor:b,decorator:a});var i=new qx.ui.core.Widget().set({backgroundColor:c,decorator:a});var h=new qx.ui.core.Widget().set({backgroundColor:f,decorator:a});var g=new qx.ui.container.Composite(new qx.ui.layout.HBox());g.setDecorator(a);g.add(k);g.add(j);g.add(i);g.add(h);this.getRoot().add(g,{edge:0});}
}});}
)();
