...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.DateChooser-qx.theme.Modern.8768fe0221f7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="- Use the cursors keys to move the selection.",q="- Double-click or enter/space-key will fire an execute event.",p="bold",o="- Page-keys / shift + page-keys switch months/years.",n="Description",m="select a date",l="Show January 1981",k="Set current date",j="Execute: ",i="Change: ",c="center",h="en",g="changeValue",b="demobrowser.demo.widget.DateChooser",a="Remove the selection",f="- Escape will remove the selection.",d="execute";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);qx.locale.Manager.getInstance().setLocale(h);var A=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));var x=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));var E=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var t=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));E.add(t);E.add(C);x.add(E);x.add(y);D.add(x);A.add(D);this.getRoot().add(A,{left:20,top:20});var v=new qx.ui.control.DateChooser();D.addBefore(v,x);var B=new qx.ui.basic.Label(m);A.add(B);v.addListener(g,function(e){B.setValue(i+e.getData());}
,this);v.addListener(d,function(e){var F=v.getValue();B.setValue(j+F);}
,this);var w=new qx.ui.form.Button(k);w.setAlignX(c);t.add(w);w.addListener(d,function(e){v.setValue(new Date());}
);var z=new qx.ui.form.Button(l);t.add(z);z.addListener(d,function(e){v.showMonth(0,1981);}
);var u=new qx.ui.form.Button(a);t.add(u);u.addListener(d,function(e){v.setValue(null);}
);var s=new qx.ui.basic.Label(n);s.setFont(p);C.add(s);C.add(new qx.ui.basic.Label(r));C.add(new qx.ui.basic.Label(o));C.add(new qx.ui.basic.Label(q));C.add(new qx.ui.basic.Label(f));}
}});}
)();
