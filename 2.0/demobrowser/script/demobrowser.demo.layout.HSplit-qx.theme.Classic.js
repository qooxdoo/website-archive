...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HSplit","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HSplit-qx.theme.Classic.e3bb0b93d86e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Flex:1; Max:100",l="Flex:1; Max:200",k="Flex:2; Min:250",j="Flex:0; Min:350",i="demobrowser.demo.layout.HSplit",h="Flex:1; Min:250",g="Auto",f="Flex:2",e="Flex:0",d="Flex:2; Max:100",a="Flex:1",c="horizontal",b="main";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.addSplitPaneTwoFlexSimple();this.addSplitPaneTwoFlexWithOneMin();this.addSplitPaneTwoFlexWithOneMax();this.addSplitPaneTwoFlexWithTwoMin();this.addSplitPaneTwoFlexWithTwoMax();this.addSplitPaneOneFlexSimple();this.addSplitPaneOneFlexSimpleWithMax();this.addSplitPaneOneFlexSimpleWithMin();this.addSplitPaneAuto();}
,addSplitPaneTwoFlexSimple:function(){var o=new qx.ui.splitpane.Pane(c);o.setWidth(400);o.setHeight(60);o.setDecorator(b);this.getRoot().add(o,{left:20,top:20});var n=new qx.ui.form.TextArea(a);n.setDecorator(null);n.setWrap(true);o.add(n,1);var p=new qx.ui.form.TextArea(f);p.setDecorator(null);p.setWrap(true);o.add(p,2);}
,addSplitPaneTwoFlexWithOneMin:function(){var r=new qx.ui.splitpane.Pane(c);r.setWidth(400);r.setHeight(60);r.setDecorator(b);this.getRoot().add(r,{left:20,top:100});var q=new qx.ui.form.TextArea(h);q.setDecorator(null);q.setWrap(true);q.setMinWidth(250);r.add(q,1);var s=new qx.ui.form.TextArea(f);s.setDecorator(null);s.setWrap(true);r.add(s,2);}
,addSplitPaneTwoFlexWithOneMax:function(){var u=new qx.ui.splitpane.Pane(c);u.setWidth(400);u.setHeight(60);u.setDecorator(b);this.getRoot().add(u,{left:20,top:180});var t=new qx.ui.form.TextArea(a);t.setDecorator(null);t.setWrap(true);u.add(t,1);var v=new qx.ui.form.TextArea(d);v.setDecorator(null);v.setWrap(true);v.setMaxWidth(100);u.add(v,2);}
,addSplitPaneTwoFlexWithTwoMin:function(){var x=new qx.ui.splitpane.Pane(c);x.setWidth(400);x.setHeight(60);x.setDecorator(b);this.getRoot().add(x,{left:20,top:260});var w=new qx.ui.form.TextArea(h);w.setDecorator(null);w.setWrap(true);w.setMinWidth(250);x.add(w,1);var y=new qx.ui.form.TextArea(k);y.setDecorator(null);y.setWrap(true);y.setMinWidth(250);x.add(y,2);}
,addSplitPaneTwoFlexWithTwoMax:function(){var A=new qx.ui.splitpane.Pane(c);A.setWidth(400);A.setHeight(60);A.setDecorator(b);this.getRoot().add(A,{left:20,top:340});var z=new qx.ui.form.TextArea(m);z.setDecorator(null);z.setWrap(true);z.setMaxWidth(100);A.add(z,1);var B=new qx.ui.form.TextArea(d);B.setDecorator(null);B.setWrap(true);B.setMaxWidth(100);A.add(B,2);}
,addSplitPaneOneFlexSimple:function(){var D=new qx.ui.splitpane.Pane(c);D.setWidth(400);D.setHeight(60);D.setDecorator(b);this.getRoot().add(D,{left:500,top:20});var C=new qx.ui.form.TextArea(e);C.setDecorator(null);C.setWrap(true);D.add(C,0);var E=new qx.ui.form.TextArea(a);E.setDecorator(null);E.setWrap(true);D.add(E);}
,addSplitPaneOneFlexSimpleWithMax:function(){var G=new qx.ui.splitpane.Pane(c);G.setWidth(400);G.setHeight(60);G.setDecorator(b);this.getRoot().add(G,{left:500,top:100});var F=new qx.ui.form.TextArea(e);F.setDecorator(null);F.setWrap(true);G.add(F,0);var H=new qx.ui.form.TextArea(l);H.setDecorator(null);H.setWrap(true);H.setMaxWidth(200);G.add(H);}
,addSplitPaneOneFlexSimpleWithMin:function(){var J=new qx.ui.splitpane.Pane(c);J.setWidth(400);J.setHeight(60);J.setDecorator(b);this.getRoot().add(J,{left:500,top:180});var I=new qx.ui.form.TextArea(j);I.setDecorator(null);I.setWrap(true);I.setMinWidth(350);J.add(I,0);var K=new qx.ui.form.TextArea(a);K.setDecorator(null);K.setWrap(true);J.add(K);}
,addSplitPaneAuto:function(){var M=new qx.ui.splitpane.Pane(c);M.setDecorator(b);this.getRoot().add(M,{left:500,top:340});var L=new qx.ui.form.TextArea(g);L.setDecorator(null);L.setWrap(true);M.add(L,0);var N=new qx.ui.form.TextArea(g);N.setDecorator(null);N.setWrap(true);M.add(N);}
}});}
)();
...
,properties:{appearance:{refine:true,init:C},offset:{check:i,init:6,apply:D},orientation:{init:m,check:[m,o],apply:a}},members:{__qP:null,__qQ:false,__qR:null,__qS:null,__lY:null,__qT:null,__qU:null,__dW:null,__jI:null,_createChildControlImpl:function(F,G){var H;switch(F){case n:H=new qx.ui.splitpane.Slider(this);H.exclude();this._add(H,{type:F});break;case l:H=new qx.ui.splitpane.Splitter(this);this._add(H,{type:F});H.addListener(f,this.__qV,this);break;};return H||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);}
,__qV:function(e){this.__qX(e.getData());}
,__qW:function(I){this.__jI=new qx.ui.splitpane.Blocker(I);this.getContentElement().add(this.__jI);var J=this.getChildControl(l);var K=J.getWidth();if(!K){J.addListenerOnce(u,function(){this.__qX();}
,this);}
...
,this);}
,getBlocker:function(){return this.__jI;}
,_applyOrientation:function(M,N){var O=this.getChildControl(n);var R=this.getChildControl(l);this.__lY=M===m;if(!this.__jI){this.__qW(M);}
;this.__jI.setOrientation(M);var Q=this._getLayout();if(Q){Q.dispose();}
;var P=M===o?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;this._setLayout(P);R.removeState(N);R.addState(M);R.getChildControl(p).removeState(N);R.getChildControl(p).addState(M);O.removeState(N);O.addState(M);qx.ui.core.queue.Manager.flush();this.__qX();}
,_applyOffset:function(S,T){this.__qX();}
,__qX:function(U){var V=this.getChildControl(l);var ba=this.getOffset();var bb=V.getBounds();var Y=V.getContainerElement().getDomElement();if(!Y){return;}
;if(this.__lY){var X=null;if(U){X=U.width;}
...
;var bg=this.getChildControl(l);var bi=bg.getContainerLocation();var bh=this.getContentLocation();this.__qP=this.__lY?e.getDocumentLeft()-bi.left+bh.left:e.getDocumentTop()-bi.top+bh.top;var bk=this.getChildControl(n);var bj=bg.getBounds();bk.setUserBounds(bj.left,bj.top,bj.width,bj.height);bk.setZIndex(bg.getZIndex()+1);bk.show();this.__qQ=true;this.__jI.capture();e.stop();}
,_onMouseMove:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__qQ){this.__qY();var bl=this.getChildControl(n);var bm=this.__qT;if(this.__lY){bl.setDomLeft(bm);this.__jI.setStyle(s,(bm-this.getOffset())+r);}
...
,_onMouseUp:function(e){if(!this.__qQ){return;}
;this._finalizeSizes();var bn=this.getChildControl(n);bn.exclude();this.__qQ=false;this.releaseCapture();e.stop();}
,_finalizeSizes:function(){var br=this.__qT;var bo=this.__qU;if(br==null){return;}
...
else {if(this.__lY){bs.setWidth(br);bp.setWidth(bo);}
else {bs.setHeight(br);bp.setHeight(bo);}
;}
;}
,__qY:function(){if(this.__lY){var bx=v,bE=b,by=q,bC=this.__qR;}
else {var bx=z,bE=h,by=d,bC=this.__qS;}
;var bD=this._getChildren();var bv=bD[2].getSizeHint();var bA=bD[3].getSizeHint();var bB=bD[2].getBounds()[bE]+bD[3].getBounds()[bE];var bz=bC-this.__qP;var bw=bB-bz;if(bz<bv[bx]){bw-=bv[bx]-bz;bz=bv[bx];}
else if(bw<bA[bx]){bz-=bA[bx]-bw;bw=bA[bx];}
;if(bz>bv[by]){bw+=bz-bv[by];bz=bv[by];}
else if(bw>bA[by]){bz+=bw-bA[by];bw=bA[by];}
;this.__qT=bz;this.__qU=bw;}
,_isActiveDragSession:function(){return this.__qQ;}
,_setLastMousePosition:function(x,y){this.__qR=x;this.__qS=y;}
