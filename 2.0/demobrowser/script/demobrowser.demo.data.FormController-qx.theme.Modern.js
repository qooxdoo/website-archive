...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController-qx.theme.Modern.1ec48b8312eb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="changeModel",n="qx.core.Object",m="qx.debug",l="_applyTarget",k="qx.data.controller.Form",j="changeTarget",h=" of ",g="Could not bind property ",f=".",e="No target is set.",b="qx.ui.form.Form",d="_applyModel",c="modelSelection[0]",a="value";qx.Class.define(k,{extend:qx.core.Object,construct:function(p,q,r){qx.core.Object.call(this);this._selfUpdate=!!r;this.__Lb={};if(p!=null){this.setModel(p);}
;if(q!=null){this.setTarget(q);}
;}
,properties:{model:{check:n,apply:d,event:o,nullable:true,dereference:true},target:{check:b,apply:l,event:j,nullable:true,init:null,dereference:true}},members:{__Lc:null,__Lb:null,addBindingOptions:function(name,s,t){this.__Lb[name]=[s,t];if(this.getModel()==null||this.getTarget()==null){return;}
;var u=this.getTarget().getItems()[name];var v=this.__Lf(u)?c:a;this.__Lc.removeTarget(u,v,name);this.__Lc.addTarget(u,v,name,!this._selfUpdate,s,t);}
...
;if(this.__Lb[name]&&this.__Lb[name][1]){x=this.__Lb[name][1].converter(x);}
;E[B[i]]=x;}
else {if(!E[B[i]]){E[B[i]]={};}
;E=E[B[i]];}
;}
...
;var F=this.getTarget().getItems();for(var name in F){var I=F[name];var H=this.__Lf(I)?c:a;var G=this.__Lb[name];G=G&&this.__Lb[name][1];qx.data.SingleValueBinding.updateTarget(I,H,this.getModel(),name,G);}
;}
,_applyTarget:function(J,K){if(K!=null){this.__Le(K);}
;if(this.getModel()==null){return;}
;if(J!=null){this.__Ld();}
;}
,_applyModel:function(L,M){if(this.__Lc!=null){var N=this.getTarget().getItems();for(var name in N){var P=N[name];var O=this.__Lf(P)?c:a;this.__Lc.removeTarget(P,O,name);}
;}
;if(this.__Lc!=null){this.__Lc.setModel(L);}
;if(this.getTarget()==null){return;}
;if(L!=null){this.__Ld();}
;}
,__Ld:function(){if(this.__Lc==null){this.__Lc=new qx.data.controller.Object(this.getModel());}
;var Q=this.getTarget().getItems();for(var name in Q){var T=Q[name];var R=this.__Lf(T)?c:a;var S=this.__Lb[name];try{if(S==null){this.__Lc.addTarget(T,R,name,!this._selfUpdate);}
else {this.__Lc.addTarget(T,R,name,!this._selfUpdate,S[0],S[1]);}
;}
catch(U){if(qx.core.Environment.get(m)){this.warn(g+name+h+this.getModel());}
;}
;}
;this.getTarget().redefineResetter();}
,__Le:function(V){if(this.__Lc==null){return;}
;var W=V.getItems();for(var name in W){var Y=W[name];var X=this.__Lf(Y)?c:a;this.__Lc.removeTarget(Y,X,name);}
;}
,__Lf:function(ba){return qx.Class.hasInterface(ba.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(ba.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__Lc){this.__Lc.dispose();}
;}
});}
)();
