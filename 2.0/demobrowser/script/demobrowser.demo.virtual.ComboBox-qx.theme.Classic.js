...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox-qx.theme.Classic.1049d91369d3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_beforeOpen:function(){this.__zr();}
...
;}
,__zq:function(event){if(this.__zp==true){return;}
...
,__zr:function(){var S=this.getValue();var R=this.getChildControl(k);var Q=R.getSelection();if(this.__br(Q.getItem(0))!==S){this.__zp=true;Q.removeAll();this.__zp=false;if(S==null||S==w){return;}
...
;return bb;}
},destruct:function(){var be=this.getChildControl(d);this.removeAllBindings();be.removeAllBindings();this.__dD.removeListener(b,this.__zq,this);this.__dD=null;}
});}
)();
