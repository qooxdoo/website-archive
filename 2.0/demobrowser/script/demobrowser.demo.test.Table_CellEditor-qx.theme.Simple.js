...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellEditor","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellEditor-qx.theme.Simple.6de4546d0a50.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__MI={};}
,properties:{cellEditorFactoryFunction:{check:d,nullable:true,init:null}},members:{__pv:null,__MI:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();if(qx.core.Environment.get(a)){this.assertFunction(g,b);}
;this.__pv=g(f);var h=this.__pv.createCellEditor(f);this.__MI[h.toHashCode()]=f;return h;}
...
;var j=this.__MI[i.toHashCode()];this.__pv=k(j);var l=this.__pv.getCellEditorValue(i);return l;}
