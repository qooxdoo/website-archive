...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Classic.b47ffdea1316.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;cK.add(new qx.ui.menu.Button(bc,null,null,cL));cK.add(new qx.ui.menu.Separator());for(var i=0;i<7;i++){cK.add(new qx.ui.menu.Button(W+(i+1)));}
;return cK;}
,debugRadio:function(e){this.debug(s+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(r+this.getShortcut());}
,debugButton:function(e){this.debug(ba+this.getLabel());}
,debugCheckBox:function(e){this.debug(B+this.getLabel()+o+e.getData());}
,createCommands:function(){this.__RE=new qx.ui.core.Command(br);this.__RE.addListener(cc,this.debugCommand);this.__RF=new qx.ui.core.Command(co);this.__RF.addListener(cc,this.debugCommand);this.__RG=new qx.ui.core.Command(bd);this.__RG.addListener(cc,this.debugCommand);this.__vr=new qx.ui.core.Command(V);this.__vr.addListener(cc,this.debugCommand);this.__vy=new qx.ui.core.Command(R);this.__vy.addListener(cc,this.debugCommand);this.__RH=new qx.ui.core.Command(G);this.__RH.addListener(cc,this.debugCommand);this.__RI=new qx.ui.core.Command(bf);this.__RI.addListener(cc,this.debugCommand);this.__RJ=new qx.ui.core.Command(O);this.__RJ.addListener(cc,this.debugCommand);this.__RJ.setEnabled(false);}
,getMenuButton:function(){var cM=new qx.ui.menu.Menu;cM.add(new qx.ui.menu.RadioButton(cH));cM.add(new qx.ui.menu.RadioButton(F));cM.add(new qx.ui.menu.RadioButton(X));var cU=new qx.ui.menu.Menu;cU.add(new qx.ui.menu.RadioButton(bP));cU.add(new qx.ui.menu.RadioButton(j));cU.add(new qx.ui.menu.RadioButton(L));var cT=new qx.ui.form.RadioGroup;cT.add.apply(cT,cM.getChildren());cT.addListener(bI,this.debugRadio);var cR=new qx.ui.form.RadioGroup;cR.add.apply(cR,cU.getChildren());cR.addListener(bI,this.debugRadio);var cP=new qx.ui.menu.Menu();var cS=new qx.ui.menu.Button(bw,bE,this.__vr);var da=new qx.ui.menu.Button(bC,bL,this.__vy);var cO=new qx.ui.menu.Button(cb,bH,this.__RH);var cW=new qx.ui.menu.Button(bG,bO,this.__RI);var cQ=new qx.ui.menu.Button(bN,bF,this.__RJ);var cN=new qx.ui.menu.Button(bY,ca,null,cM);var cX=new qx.ui.menu.Button(bq,bs,null,cU);var cV=new qx.ui.menu.Button(bM,bA);cS.addListener(cc,this.debugButton);da.addListener(cc,this.debugButton);cO.addListener(cc,this.debugButton);cW.addListener(cc,this.debugButton);cQ.addListener(cc,this.debugButton);cN.addListener(cc,this.debugButton);cX.addListener(cc,this.debugButton);cV.addListener(cc,this.debugButton);cP.add(cS);cP.add(da);cP.addSeparator();cP.add(cO);cP.add(cW);cP.add(cQ);cP.addSeparator();cP.add(cN);cP.add(cX);cP.addSeparator();cP.add(cV);var cY=new qx.ui.form.MenuButton(bh,bB,cP);return cY;}
...
,getMenuBar:function(){var dk=new qx.ui.container.Composite(new qx.ui.layout.Grow);dk.setDecorator(p);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);dk.add(toolbar);var du=new qx.ui.toolbar.Part;var dj=new qx.ui.toolbar.Part;var dn=new qx.ui.toolbar.Part;toolbar.add(du);toolbar.add(dj);toolbar.addSpacer();toolbar.add(dn);var dt=new qx.ui.toolbar.SplitButton(u,cp,this.getBackMenu());var dq=new qx.ui.toolbar.SplitButton(Q,U,this.getForwardMenu());var di=new qx.ui.toolbar.Button(bx,bK,this.__RE);var dm=new qx.ui.toolbar.Button(bJ,bz,this.__RF);var ds=new qx.ui.toolbar.Button(bD,bv,this.__RG);dt.addListener(cc,this.debugButton);dq.addListener(cc,this.debugButton);di.addListener(cc,this.debugButton);dm.addListener(cc,this.debugButton);ds.addListener(cc,this.debugButton);du.add(dt);du.add(dq);du.addSeparator();du.add(di);du.add(dm);du.add(ds);du.setShow(h);var dl=new qx.ui.toolbar.MenuButton(C);var dh=new qx.ui.toolbar.MenuButton(cq);var dg=new qx.ui.toolbar.MenuButton(bo);var dv=new qx.ui.toolbar.MenuButton(ch);var dr=new qx.ui.toolbar.MenuButton(D);dl.setMenu(this.getFileMenu());dh.setMenu(this.getEditMenu());dg.setMenu(this.getSearchMenu());dv.setMenu(this.getViewMenu());dr.setMenu(this.getFormatMenu());dj.add(dl);dj.add(dh);dj.add(dg);dj.add(dv);dj.add(dr);var dp=new qx.ui.toolbar.MenuButton(bn);dp.setMenu(this.getHelpMenu());dn.add(dp);return dk;}
,getBackMenu:function(){var dx=new qx.ui.menu.Menu;var dy=new qx.ui.menu.Button(cB);var dA=new qx.ui.menu.Button(w);var dw=new qx.ui.menu.Button(K);var dz=new qx.ui.menu.Button(cE);dy.addListener(cc,this.debugButton);dA.addListener(cc,this.debugButton);dw.addListener(cc,this.debugButton);dz.addListener(cc,this.debugButton);dx.add(dy);dx.add(dA);dx.add(dw);dx.add(dz);return dx;}
,getForwardMenu:function(){var dB=new qx.ui.menu.Menu;var dC=new qx.ui.menu.Button(c);var dD=new qx.ui.menu.Button(bi);dC.addListener(cc,this.debugButton);dD.addListener(cc,this.debugButton);dB.add(dC);dB.add(dD);return dB;}
,getFileMenu:function(){var dG=new qx.ui.menu.Menu;var dE=new qx.ui.menu.Button(bx,bK,this.__RE);var dI=new qx.ui.menu.Button(bJ,bz,this.__RF);var dH=new qx.ui.menu.Button(cx);var dL=new qx.ui.menu.Button(bD,bv,this.__RG);var dK=new qx.ui.menu.Button(ce,bU);var dJ=new qx.ui.menu.Button(bM,bA);var dF=new qx.ui.menu.Button(bb,cy);dE.addListener(cc,this.debugButton);dI.addListener(cc,this.debugButton);dH.addListener(cc,this.debugButton);dL.addListener(cc,this.debugButton);dK.addListener(cc,this.debugButton);dJ.addListener(cc,this.debugButton);dF.addListener(cc,this.debugButton);dG.add(dE);dG.add(dI);dG.add(dH);dG.add(dL);dG.add(dK);dG.add(dJ);dG.add(dF);return dG;}
,getEditMenu:function(){var dN=new qx.ui.menu.Menu;var dQ=new qx.ui.menu.Button(bw,bE,this.__vr);var dP=new qx.ui.menu.Button(bC,bL,this.__vy);var dM=new qx.ui.menu.Button(cb,bH,this.__RH);var dR=new qx.ui.menu.Button(bG,bO,this.__RI);var dO=new qx.ui.menu.Button(bN,bF,this.__RJ);dQ.addListener(cc,this.debugButton);dP.addListener(cc,this.debugButton);dM.addListener(cc,this.debugButton);dR.addListener(cc,this.debugButton);dO.addListener(cc,this.debugButton);dN.add(dQ);dN.add(dP);dN.addSeparator();dN.add(dM);dN.add(dR);dN.add(dO);return dN;}
...
,getPanesMenu:function(){var eh=new qx.ui.menu.Menu;var ej=new qx.ui.menu.CheckBox(A);var el=new qx.ui.menu.CheckBox(bl);var em=new qx.ui.menu.CheckBox(bV);var ei=new qx.ui.menu.CheckBox(S);var ek=new qx.ui.menu.CheckBox(T);var eg=new qx.ui.menu.CheckBox(bp);ej.setValue(true);el.setValue(true);ei.setValue(true);ej.addListener(cd,this.debugCheckBox);el.addListener(cd,this.debugCheckBox);em.addListener(cd,this.debugCheckBox);ei.addListener(cd,this.debugCheckBox);ek.addListener(cd,this.debugCheckBox);eg.addListener(cd,this.debugCheckBox);eh.add(el);eh.add(ej);eh.addSeparator();eh.add(em);eh.add(ei);eh.add(ek);eh.add(eg);return eh;}
,getSyntaxMenu:function(){var er=new qx.ui.menu.Menu;var en=new qx.ui.menu.RadioButton(by);var ep=new qx.ui.menu.RadioButton(l);var eo=new qx.ui.menu.RadioButton(f);var eq=new qx.ui.menu.Button(cg,null,null,this.getSyntaxCMenu());var eu=new qx.ui.menu.RadioButton(ci);var es=new qx.ui.menu.RadioButton(bT);er.add(en);er.add(ep);er.add(eo);er.add(eq);er.add(eu);er.add(es);var et=new qx.ui.form.RadioGroup;et.add(en,ep,eo,eu,es);et.add.apply(et,eq.getMenu().getChildren());et.addListener(bI,this.debugRadio);return er;}
,getSyntaxCMenu:function(){var ew=new qx.ui.menu.Menu;var ev=new qx.ui.menu.RadioButton(ck);var ez=new qx.ui.menu.RadioButton(cw);var ey=new qx.ui.menu.RadioButton(E);var ex=new qx.ui.menu.RadioButton(cF);ew.add(ev);ew.add(ez);ew.add(ey);ew.add(ex);return ew;}
,getFormatMenu:function(){var eD=new qx.ui.menu.Menu;var eC=new qx.ui.menu.Button(cA,null,null,this.getParagraphMenu());var eF=new qx.ui.menu.Button(y);var eG=new qx.ui.menu.Button(bX);var eB=new qx.ui.menu.Button(J);var eE=new qx.ui.menu.Button(bj);var eA=new qx.ui.menu.Button(Y);var eI=new qx.ui.menu.Button(a);var eH=new qx.ui.menu.Button(cv);eF.addListener(cc,this.debugButton);eG.addListener(cc,this.debugButton);eB.addListener(cc,this.debugButton);eE.addListener(cc,this.debugButton);eA.addListener(cc,this.debugButton);eI.addListener(cc,this.debugButton);eH.addListener(cc,this.debugButton);eD.add(eC);eD.add(eF);eD.add(eG);eD.addSeparator();eD.add(eB);eD.add(eE);eD.add(eA);eD.addSeparator();eD.add(eI);eD.add(eH);return eD;}
,getParagraphMenu:function(){var eJ=new qx.ui.menu.Menu;var eM=new qx.ui.menu.Button(cj,cu);var eN=new qx.ui.menu.Button(bQ,m);var eK=new qx.ui.menu.Button(cs,cr);var eL=new qx.ui.menu.Button(N,cm);eM.addListener(cc,this.debugButton);eN.addListener(cc,this.debugButton);eK.addListener(cc,this.debugButton);eL.addListener(cc,this.debugButton);eJ.add(eM);eJ.add(eN);eJ.add(eK);eJ.add(eL);return eJ;}
...
},destruct:function(){this._disposeObjects(n,d,bm,b,z,H,v,g);}
});}
)();
...
,_onMouseOver:function(e){e.stopPropagation();this.addState(l);delete this.__uK;}
...
;var T=this.getMenu();if(T&&T.isVisible()){this.__uK=true;return;}
;this.removeState(l);}
...
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__uK){this.removeState(l);}
;}
}});}
)();
