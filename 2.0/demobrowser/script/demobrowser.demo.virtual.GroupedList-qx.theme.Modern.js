...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Modern.1dbb2fc5b0f3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
};T.setDelegate(V);T.setSelection(this.__CQ.getSelection());return U;}
...
};bb.setDelegate(bd);bb.setSelection(this.__CQ.getSelection());return bc;}
},destruct:function(){this.__CQ.dispose();this.__Rr.dispose();this.__Rs.dispose();this.__CQ=this.__Rr=this.__Rs=null;}
});}
)();
