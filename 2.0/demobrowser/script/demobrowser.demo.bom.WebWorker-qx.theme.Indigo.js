...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.WebWorker-qx.theme.Indigo.dbd9829d4487.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="qx.bom.WebWorker",d="html.webworker",c="qx.event.type.Data",b="message",a="error";qx.Class.define(f,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__JM=qx.core.Environment.get(d);this.__JM?this.__JO(g):this.__JP(g);}
,events:{"message":c,"error":c},members:{_worker:null,_handleErrorBound:null,_handleMessageBound:null,__JM:true,__JN:null,__JO:function(h){this._worker=new window.Worker(h);this._handleMessageBound=qx.lang.Function.bind(this._handleMessage,this);this._handleErrorBound=qx.lang.Function.bind(this._handleError,this);qx.bom.Event.addNativeListener(this._worker,"message",this._handleMessageBound);qx.bom.Event.addNativeListener(this._worker,"error",this._handleErrorBound);}
,__JP:function(i){var k=this;var j=new qx.bom.request.Xhr();j.onload=function(){k.__JN=(function(){var l=function(e){k.fireDataEvent('message',e);}
;eval("var onmessage = null, postMessage = "+l+";"+j.responseText);return {onmessage:eval("onmessage"),postMessage:l};}
)();}
;j.open("GET",i,false);j.send();}
,postMessage:function(m){var n=this;if(this.__JM){this._worker.postMessage(m);}
else {setTimeout(function(){try{n.__JN.onmessage&&n.__JN.onmessage({data:m});}
catch(o){n.fireDataEvent(a,o);}
;}
,0);}
;}
,_handleMessage:function(e){this.fireDataEvent(b,e.data);}
,_handleError:function(e){this.fireDataEvent(a,e.message);}
},destruct:function(){if(this.__JM){qx.bom.Event.removeNativeListener(this._worker,b,this._handleMessageBound);qx.bom.Event.removeNativeListener(this._worker,a,this._handleErrorBound);if(this._worker){this._worker.terminate();this._worker=null;}
;}
else {if(this.__JN){this.__JN=null;}
;}
;}
});}
)();
