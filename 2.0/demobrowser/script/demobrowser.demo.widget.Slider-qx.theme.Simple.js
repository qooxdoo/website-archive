...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Slider","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Slider-qx.theme.Simple.9ba804d995ad.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="vertical",m="Max: ",l="changeValue",k="horizontal",j="top",h="middle",g="demobrowser.demo.widget.Slider",f="Min: ",d="right",c="center",a="left",b="bottom";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.getRoot().add(this._createVerticalLayout(),{left:20,top:20});this.getRoot().add(this._createHorizontalLayout(),{left:20,top:340});}
,_createVerticalLayout:function(){var p=[];p.push(this._createSliderGroup(new qx.ui.form.Slider().set({maximum:1000,value:100})));p.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-100,maximum:100,singleStep:5,pageStep:20,value:0})));p.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-600,maximum:-200,singleStep:10,pageStep:50,value:-300})));p.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:25,maximum:75,singleStep:5,pageStep:10,value:25})));var q=new qx.ui.layout.Grid();var o=new qx.ui.container.Composite(q);o.setPadding(20);o.setWidth(530);o.setHeight(300);q.setSpacing(5);q.setRowFlex(0,1);q.setRowFlex(1,1);q.setRowFlex(2,1);q.setRowAlign(0,a,j);q.setRowAlign(1,a,h);q.setRowAlign(2,a,b);var s=0;for(var i=0;i<p.length;i++){var r=p[i];r.slider.setOrientation(n);o.add(r.slider,{row:0,column:s,rowSpan:3,colSpan:1});o.add(r.minimum,{row:0,column:s+1});o.add(r.value,{row:1,column:s+1});o.add(r.maximum,{row:2,column:s+1});q.setColumnMinWidth(s+1,80);q.setColumnWidth(s+2,20);s+=3;}
;return o;}
,_createHorizontalLayout:function(){var u=[];u.push(this._createSliderGroup(new qx.ui.form.Slider().set({maximum:1000,value:100})));u.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-100,maximum:100,singleStep:5,pageStep:20,value:0})));u.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-600,maximum:-200,singleStep:10,pageStep:50,value:-300})));u.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:25,maximum:75,singleStep:5,pageStep:10,value:25})));var v=new qx.ui.layout.Grid();var t=new qx.ui.container.Composite(v);t.setPadding(20);t.setWidth(400);t.setHeight(400);v.setSpacing(5);v.setColumnFlex(0,1);v.setColumnFlex(1,1);v.setColumnFlex(2,1);v.setColumnAlign(0,a,b);v.setColumnAlign(1,c,b);v.setColumnAlign(2,d,b);var x=0;for(var i=0;i<u.length;i++){var w=u[i];w.slider.setOrientation(k);w.value.setWidth(100);w.value.setTextAlign(c);t.add(w.minimum,{row:x,column:0});t.add(w.value,{row:x,column:1});t.add(w.maximum,{row:x,column:2});t.add(w.slider,{row:x+1,column:0,colSpan:3,rowSpan:1});v.setRowHeight(x+2,20);x+=3;}
;return t;}
,_createSliderGroup:function(y){var z={slider:y,minimum:new qx.ui.basic.Label(f+y.getMinimum().toString()),maximum:new qx.ui.basic.Label(m+y.getMaximum().toString()),value:new qx.ui.basic.Label(y.getValue().toString())};y.addListener(l,function(e){z.value.setValue(y.getValue().toString());}
);return z;}
}});}
)();
