...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Shadow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Shadow-qx.theme.Indigo.277f0646e166.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var df="table-row-background-even",de="button-box-pressed-top-right",dd="arrow-left",dc="datechooser-weekday",db="arrow-up",da="icon/16/actions/dialog-ok.png",cY="button-box-top-right",cX="slidebar",cW="#BABABA",cV="button-box-hovered-bottom-right",bY="move-frame",bX="nodrop",bW="window-caption",bV="table-header-cell",bU="button-box-hovered-top-right",bT="row-layer",bS="treevirtual-plus-only",bR="move",bQ="treevirtual-plus-end",bP="vertical",dm="arrow-down-small",dn="tooltip-error",dk="window-restore",dl="resize-frame",di="scroll-knob",dj="tabview-close",dg="atom/label",dh="button-box-pressed-bottom-right",dp="button-box-pressed-hovered-bottom-right",dq="icon/16/actions/dialog-cancel.png",cE="qx.theme.simple.Appearance",cD="menu-slidebar",cG="treevirtual-minus-cross",cF="background-pane",cI="table-",cH="scroll-knob-pressed",cK="icon",cJ="arrow-rewind",cC="icon/16/apps/office-calendar.png",cB="headline",l="treevirtual-plus-start",m="treevirtual-minus-end",n="checkbox-undetermined",o="button-box-bottom-right",p="datechooser-week",q="descending",r="toolbar-separator",s="arrow-up-small",t="horizontal",u="border-light-shadow",dE="text-placeholder",dD="treevirtual-plus-cross",dC="scrollarea",dB="treevirtual-line",dI="menu-checkbox",dH="best-fit",dG="button-border",dF="treevirtual-cross",dK="tabview-page-button-right",dJ="button-hover",bh="tabview-page-button-top",bi="tabview-page-button-bottom",bf="tabview-page-button-left",bg="menubar-button-pressed",bl="progressbar",bm="tree-file",bj="tooltip-text",bk="keep-align",bd="alias",be="ascending",M="button-box-hovered-right-borderless",L="button-box-right-borderless",O="lead-item",N="checkbox-focused",I="window-minimize",H="button-box-pressed-hovered-top-right",K="knob-",J="treevirtual-minus-only",G="treevirtual-minus-start",F="checkbox-checked",br="window",bs="window-active",bt="table-header-cell-first",bu="button-box-pressed-right-borderless",bn="scroll-knob-hovered",bo="select-column-order",bp="button-box-pressed-hovered-right-borderless",bq="scroll-knob-pressed-hovered",bv="white-box",bw="datechooser-week-header",X="menubar-button-hovered",W="table-header-column-button",V="window-close",U="datechooser-date-pane",T="cursor-",S="-focused",R="menu-radiobutton",Q="window-maximize",bc="treevirtual-end",bb="table",bx="arrow-forward",by="copy",bz="table-row-background-selected",bA="radiobutton-focused",bB="scrollbar/slider/knob",bC="atom/icon",bD="table-header",bE="menu-separator",bF="icon/16/actions/view-refresh.png",bG="menu-slidebar-button",cg="scrollbar/button",cf="border-invalid",ce="tree-minus",cd="statusbar",ck="down",cj="text",ci="background-disabled-checked",ch="tree",cn="slidebar/button-forward",cm="icon/16/places/folder.png",cx="icon/16/mimetypes/text-plain.png",cy="tree-plus",cv="default",cw="datechooser",ct="button-box-focused",cu="blank",cr="treevirtual-folder",cs="virtual-list",cz="arrow-right",cA="left",cO="up",cN="right-top",cQ="focused-inset",cP="slidebar/button-backward",cS="link",cR="background-disabled",cU="-right",cT="radiobutton",cM="arrow-",cL="checkbox",dx="-left",dy="combobox",dz="tree-folder",dA="selectbox",dt="-invalid",du="icon/16/places/folder-open.png",dv="background-selected-dark",dw="invalid",dr="scrollbar",ds="inset",k="center",j="datechooser/button",h="right",g="light-background",f="button-frame",e="-middle",d="main",c="-invert",b="combobox/button",a="list",x="middle",y="menu-button",v="toolbar-button",w="button-box-hovered",B="button-box-pressed-hovered",C="spinner",z="button-box-pressed",A="arrow-down",D="white",E="background-selected",co="text-selected",cl="cell",cq="tooltip",cp="popup",cb="",ca="label",P="text-disabled",cc="groupbox",ba="image",Y="bold",bH="textfield",bI="background",bJ="main-dark",bK="button-box",bL="atom",bM="pointer",bN="button",bO="widget";qx.Theme.define(cE,{appearances:{"widget":{},"label":{style:function(dL){return {textColor:dL.disabled?P:undefined};}
},"image":{style:function(dM){return {opacity:!dM.replacement&&dM.disabled?0.3:undefined};}
},"atom":{},"atom/label":ca,"atom/icon":ba,"root":{style:function(dN){return {backgroundColor:bI,textColor:cj,font:cv};}
},"popup":{style:function(dO){return {decorator:cp,backgroundColor:cF};}
},"tooltip":{include:cp,style:function(dP){return {backgroundColor:cq,textColor:bj,decorator:cq,padding:[1,3,2,3],offset:[15,5,5,5]};}
},"tooltip/atom":bL,"tooltip-error":{include:cq,style:function(dQ){return {textColor:co,showTimeout:100,hideTimeout:10000,decorator:dn,font:Y,backgroundColor:undefined};}
},"tooltip-error/atom":bL,"iframe":{style:function(dR){return {backgroundColor:D,decorator:bJ};}
},"move-frame":{style:function(dS){return {decorator:bJ};}
},"resize-frame":bY,"dragdrop-cursor":{style:function(dT){var dU=bX;if(dT.copy){dU=by;}
else if(dT.move){dU=bR;}
else if(dT.alias){dU=bd;}
;;return {source:qx.theme.simple.Image.URLS[T+dU],position:cN,offset:[2,16,2,6]};}
},"slidebar":{},"slidebar/scrollpane":{},"slidebar/content":{},"slidebar/button-forward":{alias:bN,include:bN,style:function(dV){return {icon:qx.theme.simple.Image.URLS[cM+(dV.vertical?ck:h)]};}
},"slidebar/button-backward":{alias:bN,include:bN,style:function(dW){return {icon:qx.theme.simple.Image.URLS[cM+(dW.vertical?cO:cA)]};}
},"table":bO,"table/statusbar":{style:function(dX){return {decorator:cd,padding:[2,5]};}
},"table/column-button":{alias:bN,style:function(dY){return {decorator:W,padding:3,icon:qx.theme.simple.Image.URLS[bo]};}
},"table-column-reset-button":{include:y,alias:y,style:function(){return {icon:bF};}
},"table-scroller/scrollbar-x":dr,"table-scroller/scrollbar-y":dr,"table-scroller":bO,"table-scroller/header":{style:function(){return {decorator:bD};}
},"table-scroller/pane":{},"table-scroller/focus-indicator":{style:function(ea){return {decorator:d};}
},"table-scroller/resize-line":{style:function(eb){return {backgroundColor:dG,width:3};}
},"table-header-cell":{alias:bL,style:function(ec){return {decorator:ec.first?bt:bV,minWidth:13,font:Y,paddingTop:3,paddingLeft:5,cursor:ec.disabled?undefined:bM,sortIcon:ec.sorted?(qx.theme.simple.Image.URLS[cI+(ec.sortedAscending?be:q)]):undefined};}
},"table-header-cell/icon":{include:bC,style:function(ed){return {paddingRight:5};}
},"table-header-cell/sort-icon":{style:function(ee){return {alignY:x,alignX:h,paddingRight:5};}
},"table-editor-textfield":{include:bH,style:function(ef){return {decorator:undefined,padding:[2,2]};}
},"table-editor-selectbox":{include:dA,alias:dA,style:function(eg){return {padding:[0,2]};}
},"table-editor-combobox":{include:dy,alias:dy,style:function(eh){return {decorator:undefined};}
},"treevirtual":{include:bH,alias:bb,style:function(ei,ej){return {padding:[ej.padding[0]+2,ej.padding[1]+1]};}
},"treevirtual-folder":{style:function(ek){return {icon:(ek.opened?du:cm)};}
},"treevirtual-file":{include:cr,alias:cr,style:function(el){return {icon:cx};}
},"treevirtual-line":{style:function(em){return {icon:qx.theme.simple.Image.URLS[dB]};}
},"treevirtual-contract":{style:function(en){return {icon:qx.theme.simple.Image.URLS[ce]};}
},"treevirtual-expand":{style:function(eo){return {icon:qx.theme.simple.Image.URLS[cy]};}
},"treevirtual-only-contract":{style:function(ep){return {icon:qx.theme.simple.Image.URLS[J]};}
},"treevirtual-only-expand":{style:function(eq){return {icon:qx.theme.simple.Image.URLS[bS]};}
},"treevirtual-start-contract":{style:function(er){return {icon:qx.theme.simple.Image.URLS[G]};}
},"treevirtual-start-expand":{style:function(es){return {icon:qx.theme.simple.Image.URLS[l]};}
},"treevirtual-end-contract":{style:function(et){return {icon:qx.theme.simple.Image.URLS[m]};}
},"treevirtual-end-expand":{style:function(eu){return {icon:qx.theme.simple.Image.URLS[bQ]};}
},"treevirtual-cross-contract":{style:function(ev){return {icon:qx.theme.simple.Image.URLS[cG]};}
},"treevirtual-cross-expand":{style:function(ew){return {icon:qx.theme.simple.Image.URLS[dD]};}
},"treevirtual-end":{style:function(ex){return {icon:qx.theme.simple.Image.URLS[bc]};}
},"treevirtual-cross":{style:function(ey){return {icon:qx.theme.simple.Image.URLS[dF]};}
},"resizer":{style:function(ez){return {decorator:bJ};}
},"splitpane":{},"splitpane/splitter":{style:function(eA){return {backgroundColor:g};}
},"splitpane/splitter/knob":{style:function(eB){return {source:qx.theme.simple.Image.URLS[K+(eB.horizontal?t:bP)],padding:2};}
},"splitpane/slider":{style:function(eC){return {backgroundColor:u,opacity:0.3};}
},"menu":{style:function(eD){var eE={backgroundColor:bI,decorator:d,spacingX:6,spacingY:1,iconColumnWidth:16,arrowColumnWidth:4,padding:1,placementModeY:eD.submenu||eD.contextmenu?dH:bk};if(eD.submenu){eE.position=cN;eE.offset=[-2,-3];}
;if(eD.contextmenu){eE.offset=4;}
;return eE;}
},"menu/slidebar":cD,"menu-slidebar":bO,"menu-slidebar-button":{style:function(eF){return {backgroundColor:eF.hovered?E:undefined,padding:6,center:true};}
},"menu-slidebar/button-backward":{include:bG,style:function(eG){return {icon:qx.theme.simple.Image.URLS[db+(eG.hovered?c:cb)]};}
},"menu-slidebar/button-forward":{include:bG,style:function(eH){return {icon:qx.theme.simple.Image.URLS[A+(eH.hovered?c:cb)]};}
},"menu-separator":{style:function(eI){return {height:0,decorator:bE,marginTop:4,marginBottom:4,marginLeft:2,marginRight:2};}
},"menu-button":{alias:bL,style:function(eJ){return {backgroundColor:eJ.selected?E:undefined,textColor:eJ.selected?co:undefined,padding:[2,6]};}
},"menu-button/icon":{include:ba,style:function(eK){return {alignY:x};}
},"menu-button/label":{include:ca,style:function(eL){return {alignY:x,padding:1};}
},"menu-button/shortcut":{include:ca,style:function(eM){return {alignY:x,marginLeft:14,padding:1};}
},"menu-button/arrow":{include:ba,style:function(eN){return {source:qx.theme.simple.Image.URLS[cz+(eN.selected?c:cb)],alignY:x};}
},"menu-checkbox":{alias:y,include:y,style:function(eO){return {icon:!eO.checked?undefined:qx.theme.simple.Image.URLS[dI+(eO.selected?c:cb)]};}
},"menu-radiobutton":{alias:y,include:y,style:function(eP){return {icon:!eP.checked?undefined:qx.theme.simple.Image.URLS[R+(eP.selected?c:cb)]};}
},"menubar":{style:function(eQ){return {backgroundColor:g,padding:[4,2]};}
},"menubar-button":{style:function(eR){var eT;var eS=[2,6];if(!eR.disabled){if(eR.pressed){eT=bg;eS=[1,5,2,5];}
else if(eR.hovered){eT=X;eS=[1,5];}
;}
;return {padding:eS,cursor:eR.disabled?undefined:bM,textColor:cS,decorator:eT};}
},"virtual-list":a,"virtual-list/row-layer":bT,"row-layer":bO,"column-layer":bO,"group-item":{include:ca,alias:ca,style:function(eU){return {padding:4,backgroundColor:cW,textColor:D,font:Y};}
},"virtual-selectbox":dA,"virtual-selectbox/dropdown":cp,"virtual-selectbox/dropdown/list":{alias:cs},"virtual-combobox":dy,"virtual-combobox/dropdown":cp,"virtual-combobox/dropdown/list":{alias:cs},"virtual-tree":{include:ch,alias:ch,style:function(eV){return {itemHeight:21};}
},"virtual-tree-folder":dz,"virtual-tree-file":bm,"cell":{style:function(eW){return {backgroundColor:eW.selected?bz:df,textColor:eW.selected?co:cj,padding:[3,6]};}
},"cell-string":cl,"cell-number":{include:cl,style:function(eX){return {textAlign:h};}
},"cell-image":cl,"cell-boolean":cl,"cell-atom":cl,"cell-date":cl,"cell-html":cl,"htmlarea":{"include":bO,style:function(eY){return {backgroundColor:D};}
},"scrollbar":{},"scrollbar/slider":{},"scrollbar/slider/knob":{style:function(fa){var fb=di;if(!fa.disabled){if(fa.hovered&&!fa.pressed&&!fa.checked){fb=bn;}
else if(fa.hovered&&(fa.pressed||fa.checked)){fb=bq;}
else if(fa.pressed||fa.checked){fb=cH;}
;;}
;return {height:14,width:14,cursor:fa.disabled?undefined:bM,decorator:fb,minHeight:fa.horizontal?undefined:20,minWidth:fa.horizontal?20:undefined};}
},"scrollbar/button":{style:function(fc){var fd={};fd.padding=4;var fe=cb;if(fc.left){fe=cA;fd.marginRight=2;}
else if(fc.right){fe+=h;fd.marginLeft=2;}
else if(fc.up){fe+=cO;fd.marginBottom=2;}
else {fe+=ck;fd.marginTop=2;}
;;fd.icon=qx.theme.simple.Image.URLS[cM+fe];fd.cursor=bM;fd.decorator=bK;return fd;}
},"scrollbar/button-begin":cg,"scrollbar/button-end":cg,"scrollarea/corner":{style:function(ff){return {backgroundColor:bI};}
},"scrollarea":bO,"scrollarea/pane":bO,"scrollarea/scrollbar-x":dr,"scrollarea/scrollbar-y":dr,"textfield":{style:function(fg){var fi;if(fg.disabled){fi=P;}
else if(fg.showingPlaceholder){fi=dE;}
else {fi=undefined;}
;var fj;var fh;if(fg.disabled){fj=ds;fh=[2,3];}
else if(fg.invalid){fj=cf;fh=[1,2];}
else if(fg.focused){fj=cQ;fh=[1,2];}
else {fh=[2,3];fj=ds;}
;;return {decorator:fj,padding:fh,textColor:fi,backgroundColor:fg.disabled?cR:D};}
},"textarea":bH,"radiobutton/icon":{style:function(fk){var fm=cT;if(fk.focused&&!fk.invalid){fm=bA;}
;fm+=fk.invalid&&!fk.disabled?dt:cb;var fl;if(fk.disabled&&fk.checked){fl=ci;}
else if(fk.disabled){fl=cR;}
else if(fk.checked){fl=E;}
;;return {decorator:fm,width:12,height:12,backgroundColor:fl};}
},"radiobutton":{style:function(fn){return {icon:qx.theme.simple.Image.URLS[cu]};}
},"form-renderer-label":{include:ca,style:function(){return {paddingTop:3};}
},"checkbox":{alias:bL,style:function(fo){var fp;if(fo.checked){fp=qx.theme.simple.Image.URLS[F];}
else if(fo.undetermined){fp=qx.theme.simple.Image.URLS[n];}
else {fp=qx.theme.simple.Image.URLS[cu];}
;return {icon:fp,gap:6};}
},"checkbox/icon":{style:function(fq){var fs=cL;if(fq.focused&&!fq.invalid){fs=N;}
;fs+=fq.invalid&&!fq.disabled?dt:cb;var fr;if(fq.checked){fr=2;}
else if(fq.undetermined){fr=[4,2];}
;return {decorator:fs,width:12,height:12,padding:fr,backgroundColor:D};}
},"spinner":{style:function(ft){return {textColor:ft.disabled?P:undefined};}
},"spinner/textfield":bH,"spinner/upbutton":{alias:b,include:b,style:function(fu){var fv=cY;if(fu.hovered&&!fu.pressed&&!fu.checked){fv=bU;}
else if(fu.hovered&&(fu.pressed||fu.checked)){fv=H;}
else if(fu.pressed||fu.checked){fv=de;}
;;return {icon:qx.theme.simple.Image.URLS[s],decorator:fv,width:17};}
},"spinner/downbutton":{alias:b,include:b,style:function(fw){var fx=o;if(fw.hovered&&!fw.pressed&&!fw.checked){fx=cV;}
else if(fw.hovered&&(fw.pressed||fw.checked)){fx=dp;}
else if(fw.pressed||fw.checked){fx=dh;}
;;return {icon:qx.theme.simple.Image.URLS[dm],decorator:fx,width:17};}
},"selectbox":f,"selectbox/atom":bL,"selectbox/popup":cp,"selectbox/list":{alias:a,include:a,style:function(){return {decorator:undefined};}
},"selectbox/arrow":{include:ba,style:function(fy){return {source:qx.theme.simple.Image.URLS[A],paddingRight:4,paddingLeft:5};}
},"combobox":{},"combobox/button":{alias:f,include:f,style:function(fz){var fA=L;if(fz.hovered&&!fz.pressed&&!fz.checked){fA=M;}
else if(fz.hovered&&(fz.pressed||fz.checked)){fA=bp;}
else if(fz.pressed||fz.checked){fA=bu;}
;;return {icon:qx.theme.simple.Image.URLS[A],decorator:fA,padding:[0,5],width:19};}
},"combobox/popup":cp,"combobox/list":{alias:a},"combobox/textfield":bH,"datefield":bH,"datefield/button":{alias:b,include:b,style:function(fB){return {icon:cC,padding:[0,0,0,3],backgroundColor:undefined,decorator:undefined,width:19};}
},"datefield/textfield":{alias:bH,include:bH,style:function(fC){return {decorator:undefined,padding:0};}
},"datefield/list":{alias:cw,include:cw,style:function(fD){return {decorator:undefined};}
},"list":{alias:dC,include:bH},"listitem":{alias:bL,style:function(fE){return {gap:4,padding:fE.lead?[2,4]:[3,5],backgroundColor:fE.selected?E:undefined,textColor:fE.selected?co:undefined,decorator:fE.lead?O:undefined};}
},"slider":{style:function(fF){var fH;var fG;if(fF.disabled){fH=ds;fG=[2,3];}
else if(fF.invalid){fH=cf;fG=[1,2];}
else if(fF.focused){fH=cQ;fG=[1,2];}
else {fG=[2,3];fH=ds;}
;;return {decorator:fH,padding:fG};}
},"slider/knob":bB,"button-frame":{alias:bL,style:function(fI){var fJ=bK;if(!fI.disabled){if(fI.hovered&&!fI.pressed&&!fI.checked){fJ=w;}
else if(fI.hovered&&(fI.pressed||fI.checked)){fJ=B;}
else if(fI.pressed||fI.checked){fJ=z;}
;;}
;if(fI.invalid&&!fI.disabled){fJ+=dt;}
else if(fI.focused){fJ+=S;}
;return {decorator:fJ,padding:[3,8],cursor:fI.disabled?undefined:bM,minWidth:5,minHeight:5};}
},"button-frame/label":{alias:dg,style:function(fK){return {textColor:fK.disabled?P:undefined};}
},"button":{alias:f,include:f,style:function(fL){return {center:true};}
},"hover-button":{alias:bN,include:bN,style:function(fM){return {decorator:fM.hovered?dJ:undefined};}
},"splitbutton":{},"splitbutton/button":{alias:bL,style:function(fN){var fO=bK;if(fN.disabled){fO=bK;}
else if(fN.focused){fO=ct;}
else if(fN.hovered&&!fN.pressed&&!fN.checked){fO=w;}
else if(fN.hovered&&(fN.pressed||fN.checked)){fO=B;}
else if(fN.pressed||fN.checked){fO=z;}
;;;;fO+=dx;return {decorator:fO,padding:[3,8],cursor:fN.disabled?undefined:bM};}
},"splitbutton/arrow":{style:function(fP){var fQ=bK;if(fP.disabled){fQ=bK;}
else if(fP.focused){fQ=ct;}
else if(fP.hovered&&!fP.pressed&&!fP.checked){fQ=w;}
else if(fP.hovered&&(fP.pressed||fP.checked)){fQ=B;}
else if(fP.pressed||fP.checked){fQ=z;}
;;;;fQ+=cU;return {icon:qx.theme.simple.Image.URLS[A],decorator:fQ,cursor:fP.disabled?undefined:bM,padding:[3,4]};}
},"groupbox":{},"groupbox/legend":{alias:bL,style:function(fR){return {textColor:fR.invalid?dw:undefined,padding:5,margin:4,font:Y};}
},"groupbox/frame":{style:function(fS){return {backgroundColor:bI,padding:[6,9],margin:[18,2,2,2],decorator:bv};}
},"check-groupbox":cc,"check-groupbox/legend":{alias:cL,include:cL,style:function(fT){return {textColor:fT.invalid?dw:undefined,padding:5,margin:4,font:Y};}
},"radio-groupbox":cc,"radio-groupbox/legend":{alias:cT,include:cT,style:function(fU){return {textColor:fU.invalid?dw:undefined,padding:5,margin:4,font:Y};}
},"tree-folder/open":{include:ba,style:function(fV){return {source:fV.opened?qx.theme.simple.Image.URLS[ce]:qx.theme.simple.Image.URLS[cy]};}
},"tree-folder":{style:function(fW){return {padding:[2,8,2,5],icon:fW.opened?du:cm,backgroundColor:fW.selected?E:undefined,iconOpened:du};}
},"tree-folder/icon":{include:ba,style:function(fX){return {padding:[0,4,0,0]};}
},"tree-folder/label":{style:function(fY){return {padding:[1,2],textColor:fY.selected?co:undefined};}
},"tree-file":{include:dz,alias:dz,style:function(ga){return {icon:cx};}
},"tree":{include:a,alias:a,style:function(gb){return {contentPadding:gb.invalid&&!gb.disabled?[3,0]:[4,1],padding:gb.focused?0:1};}
},"window":{style:function(gc){return {contentPadding:[10,10,10,10],backgroundColor:bI,decorator:gc.maximized?undefined:gc.active?bs:br};}
},"window-resize-frame":dl,"window/pane":{},"window/captionbar":{style:function(gd){return {backgroundColor:gd.active?g:cR,padding:8,font:Y,decorator:bW};}
},"window/icon":{style:function(ge){return {marginRight:4};}
},"window/title":{style:function(gf){return {cursor:cv,font:Y,marginRight:20,alignY:x};}
},"window/minimize-button":{alias:bN,style:function(gg){return {icon:qx.theme.simple.Image.URLS[I],padding:[1,2],cursor:gg.disabled?undefined:bM};}
},"window/restore-button":{alias:bN,style:function(gh){return {icon:qx.theme.simple.Image.URLS[dk],padding:[1,2],cursor:gh.disabled?undefined:bM};}
},"window/maximize-button":{alias:bN,style:function(gi){return {icon:qx.theme.simple.Image.URLS[Q],padding:[1,2],cursor:gi.disabled?undefined:bM};}
},"window/close-button":{alias:bN,style:function(gj){return {marginLeft:2,icon:qx.theme.simple.Image.URLS[V],padding:[1,2],cursor:gj.disabled?undefined:bM};}
},"window/statusbar":{style:function(gk){return {decorator:cd,padding:[2,6]};}
},"window/statusbar-text":ca,"datechooser":{style:function(gl){return {decorator:d,minWidth:220};}
},"datechooser/navigation-bar":{style:function(gm){return {backgroundColor:bI,textColor:gm.disabled?P:gm.invalid?dw:undefined,padding:[2,10]};}
},"datechooser/last-year-button-tooltip":cq,"datechooser/last-month-button-tooltip":cq,"datechooser/next-year-button-tooltip":cq,"datechooser/next-month-button-tooltip":cq,"datechooser/last-year-button":j,"datechooser/last-month-button":j,"datechooser/next-year-button":j,"datechooser/next-month-button":j,"datechooser/button/icon":{},"datechooser/button":{style:function(gn){var go={width:17,show:cK,cursor:gn.disabled?undefined:bM};if(gn.lastYear){go.icon=qx.theme.simple.Image.URLS[cJ];}
else if(gn.lastMonth){go.icon=qx.theme.simple.Image.URLS[dd];}
else if(gn.nextYear){go.icon=qx.theme.simple.Image.URLS[bx];}
else if(gn.nextMonth){go.icon=qx.theme.simple.Image.URLS[cz];}
;;;return go;}
},"datechooser/month-year-label":{style:function(gp){return {font:Y,textAlign:k};}
},"datechooser/date-pane":{style:function(gq){return {decorator:U,backgroundColor:bI};}
},"datechooser/weekday":{style:function(gr){return {decorator:dc,font:Y,textAlign:k,textColor:gr.disabled?P:gr.weekend?dv:bI,backgroundColor:gr.weekend?bI:dv,paddingTop:2};}
},"datechooser/day":{style:function(gs){return {textAlign:k,decorator:gs.today?d:undefined,textColor:gs.disabled?P:gs.selected?co:gs.otherMonth?P:undefined,backgroundColor:gs.disabled?undefined:gs.selected?E:undefined,padding:[2,4]};}
},"datechooser/week":{style:function(gt){return {textAlign:k,textColor:dv,padding:[2,4],decorator:gt.header?bw:p};}
},"progressbar":{style:function(gu){return {decorator:bl,padding:1,backgroundColor:D,width:200,height:20};}
},"progressbar/progress":{style:function(gv){return {backgroundColor:gv.disabled?ci:E};}
},"toolbar":{style:function(gw){return {backgroundColor:g,padding:0};}
},"toolbar/part":{style:function(gx){return {margin:[0,15]};}
},"toolbar/part/container":{},"toolbar/part/handle":{},"toolbar-separator":{style:function(gy){return {decorator:r,margin:[7,0],width:4};}
},"toolbar-button":{alias:bL,style:function(gz){var gB=bK;if(gz.disabled){gB=bK;}
else if(gz.hovered&&!gz.pressed&&!gz.checked){gB=w;}
else if(gz.hovered&&(gz.pressed||gz.checked)){gB=B;}
else if(gz.pressed||gz.checked){gB=z;}
;;;if(gz.left){gB+=dx;}
else if(gz.right){gB+=cU;}
else if(gz.middle){gB+=e;}
;;var gA=[7,10];if(gz.left||gz.middle||gz.right){gA=[7,0];}
;return {cursor:gz.disabled?undefined:bM,decorator:gB,margin:gA,padding:[3,5]};}
},"toolbar-menubutton":{alias:v,include:v,style:function(gC){return {showArrow:true};}
},"toolbar-menubutton/arrow":{alias:ba,include:ba,style:function(gD){return {source:qx.theme.simple.Image.URLS[A],cursor:gD.disabled?undefined:bM,padding:[0,5],marginLeft:2};}
},"toolbar-splitbutton":{},"toolbar-splitbutton/button":{alias:v,include:v,style:function(gE){var gF=bK;if(gE.disabled){gF=bK;}
else if(gE.hovered&&!gE.pressed&&!gE.checked){gF=w;}
else if(gE.hovered&&(gE.pressed||gE.checked)){gF=B;}
else if(gE.pressed||gE.checked){gF=z;}
;;;if(gE.left){gF+=dx;}
else if(gE.right){gF+=e;}
else if(gE.middle){gF+=e;}
;;return {icon:qx.theme.simple.Image.URLS[A],decorator:gF};}
},"toolbar-splitbutton/arrow":{alias:v,include:v,style:function(gG){var gH=bK;if(gG.disabled){gH=bK;}
else if(gG.hovered&&!gG.pressed&&!gG.checked){gH=w;}
else if(gG.hovered&&(gG.pressed||gG.checked)){gH=B;}
else if(gG.pressed||gG.checked){gH=z;}
;;;if(gG.left){gH+=e;}
else if(gG.right){gH+=cU;}
else if(gG.middle){gH+=e;}
;;return {icon:qx.theme.simple.Image.URLS[A],decorator:gH};}
},"tabview":{},"tabview/bar":{alias:cX,style:function(gI){var gJ=0,gM=0,gK=0,gL=0;if(gI.barTop){gK-=1;}
else if(gI.barBottom){gJ-=1;}
else if(gI.barRight){gL-=1;}
else {gM-=1;}
;;return {marginBottom:gK,marginTop:gJ,marginLeft:gL,marginRight:gM};}
},"tabview/bar/button-forward":{include:cn,alias:cn,style:function(gN){if(gN.barTop){return {marginTop:4,marginBottom:2,decorator:null};}
else if(gN.barBottom){return {marginTop:2,marginBottom:4,decorator:null};}
else if(gN.barLeft){return {marginLeft:4,marginRight:2,decorator:null};}
else {return {marginLeft:2,marginRight:4,decorator:null};}
;;}
},"tabview/bar/button-backward":{include:cP,alias:cP,style:function(gO){if(gO.barTop){return {marginTop:4,marginBottom:2,decorator:null};}
else if(gO.barBottom){return {marginTop:2,marginBottom:4,decorator:null};}
else if(gO.barLeft){return {marginLeft:4,marginRight:2,decorator:null};}
else {return {marginLeft:2,marginRight:4,decorator:null};}
;;}
},"tabview/pane":{style:function(gP){return {backgroundColor:bI,decorator:d,padding:10};}
},"tabview-page":bO,"tabview-page/button":{style:function(gQ){var gS;if(gQ.barTop||gQ.barBottom){var gR=[8,16,8,13];}
else {var gR=[8,4,8,4];}
;if(gQ.checked){if(gQ.barTop){gS=bh;}
else if(gQ.barBottom){gS=bi;}
else if(gQ.barRight){gS=dK;}
else if(gQ.barLeft){gS=bf;}
;;;}
else {for(var i=0;i<gR.length;i++){gR[i]+=1;}
;if(gQ.barTop){gR[2]-=1;}
else if(gQ.barBottom){gR[0]-=1;}
else if(gQ.barRight){gR[3]-=1;}
else if(gQ.barLeft){gR[1]-=1;}
;;;}
;return {zIndex:gQ.checked?10:5,decorator:gS,textColor:gQ.disabled?P:gQ.checked?null:cS,padding:gR,cursor:bM};}
},"tabview-page/button/label":{alias:ca,style:function(gT){return {padding:[0,1,0,1]};}
},"tabview-page/button/icon":ba,"tabview-page/button/close-button":{alias:bL,style:function(gU){return {cursor:gU.disabled?undefined:bM,icon:qx.theme.simple.Image.URLS[dj]};}
},"colorpopup":{alias:cp,include:cp,style:function(gV){return {padding:5};}
},"colorpopup/field":{style:function(gW){return {margin:2,width:14,height:14,backgroundColor:bI,decorator:bJ};}
},"colorpopup/selector-button":bN,"colorpopup/auto-button":bN,"colorpopup/preview-pane":cc,"colorpopup/current-preview":{style:function(gX){return {height:20,padding:4,marginLeft:4,decorator:bJ,allowGrowX:true};}
},"colorpopup/selected-preview":{style:function(gY){return {height:20,padding:4,marginRight:4,decorator:bJ,allowGrowX:true};}
},"colorpopup/colorselector-okbutton":{alias:bN,include:bN,style:function(ha){return {icon:da};}
},"colorpopup/colorselector-cancelbutton":{alias:bN,include:bN,style:function(hb){return {icon:dq};}
},"colorselector":bO,"colorselector/control-bar":bO,"colorselector/visual-pane":cc,"colorselector/control-pane":bO,"colorselector/preset-grid":bO,"colorselector/colorbucket":{style:function(hc){return {decorator:bJ,width:16,height:16};}
},"colorselector/preset-field-set":cc,"colorselector/input-field-set":{include:cc,alias:cc,style:function(){return {paddingTop:12};}
},"colorselector/preview-field-set":{include:cc,alias:cc,style:function(){return {paddingTop:12};}
},"colorselector/hex-field-composite":bO,"colorselector/hex-field":bH,"colorselector/rgb-spinner-composite":bO,"colorselector/rgb-spinner-red":C,"colorselector/rgb-spinner-green":C,"colorselector/rgb-spinner-blue":C,"colorselector/hsb-spinner-composite":bO,"colorselector/hsb-spinner-hue":C,"colorselector/hsb-spinner-saturation":C,"colorselector/hsb-spinner-brightness":C,"colorselector/preview-content-old":{style:function(hd){return {decorator:bJ,width:50,height:25};}
},"colorselector/preview-content-new":{style:function(he){return {decorator:bJ,backgroundColor:D,width:50,height:25};}
},"colorselector/hue-saturation-field":{style:function(hf){return {decorator:bJ,margin:5};}
},"colorselector/brightness-field":{style:function(hg){return {decorator:bJ,margin:[5,7]};}
},"colorselector/hue-saturation-pane":bO,"colorselector/hue-saturation-handle":bO,"colorselector/brightness-pane":bO,"colorselector/brightness-handle":bO,"app-header":{style:function(hh){return {font:cB,textColor:co,backgroundColor:dv,padding:[8,12]};}
},"app-header-label":{style:function(hi){return {paddingTop:5};}
}}});}
)();
...
(function(){var j="button-box-dark-pressed",i="table-header",h="button-box-invalid",g="menubar-button-hovered",f="button-box-dark",e="#999999",d="qx/decoration/Simple",c="dotted",b="button",a="tooltip-text",V="table-focus-indicator",U="button-box-pressed-invalid",T="scrollbar-dark",S="qx.theme.simple.Decoration",R="table-header-cell",Q="border-lead",P="#FFF",O="button-box-pressed-focused",N="scrollbar-bright",M="border-light-shadow",q="white-box-border",r="window",o="scroll-knob-pressed",p="checkbox",m="window-border",n="radiobutton",k="scroll-knob",l="button-box-bright",s="window-border-inner",t="white",A="button-box-bright-pressed",y="tabview-page-button-top",E="shadow",C="border-separator",I="button-box-focused",G="border-main",v="background",L="border-light",K="button-border-hovered",J="gray",u="solid",w="invalid",x="button-border",z="button-box-hovered",B="button-box-pressed-hovered",D="background-selected",F="button-box-pressed",H="button-box";qx.Theme.define(S,{aliases:{decoration:d},decorations:{"border-blue":{decorator:qx.ui.decoration.Uniform,style:{width:4,color:D}},"main":{decorator:qx.ui.decoration.Uniform,style:{width:1,color:G}},"main-dark":{decorator:qx.ui.decoration.Uniform,style:{width:1,color:x}},"popup":{decorator:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBoxShadow,qx.ui.decoration.MBackgroundColor],style:{width:1,color:m,shadowLength:2,shadowBlurRadius:5,shadowColor:E}},"button-box":{decorator:[qx.ui.decoration.MLinearBackgroundGradient,qx.ui.decoration.MBorderRadius,qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundColor],style:{radius:3,width:1,color:x,gradientStart:[l,40],gradientEnd:[f,70],backgroundColor:l}},"button-box-pressed":{include:H,style:{gradientStart:[A,40],gradientEnd:[j,70],backgroundColor:A}},"button-box-pressed-hovered":{include:F,style:{color:K}},"button-box-hovered":{include:H,style:{color:K}},"button-box-invalid":{include:H,style:{color:w}},"button-box-pressed-invalid":{include:F,style:{color:w}},"button-box-hovered-invalid":{include:h},"button-box-pressed-hovered-invalid":{include:U},"button-box-focused":{include:H,style:{color:D}},"button-box-pressed-focused":{include:F,style:{color:D}},"button-box-hovered-focused":{include:I},"button-box-pressed-hovered-focused":{include:O},"button-box-right":{include:H,style:{radius:[0,3,3,0]}},"button-box-pressed-right":{include:F,style:{radius:[0,3,3,0]}},"button-box-pressed-hovered-right":{include:B,style:{radius:[0,3,3,0]}},"button-box-hovered-right":{include:z,style:{radius:[0,3,3,0]}},"button-box-focused-right":{include:I,style:{radius:[0,3,3,0]}},"button-box-right-borderless":{include:H,style:{radius:[0,3,3,0],width:[1,1,1,0]}},"button-box-pressed-right-borderless":{include:F,style:{radius:[0,3,3,0],width:[1,1,1,0]}},"button-box-pressed-hovered-right-borderless":{include:B,style:{radius:[0,3,3,0],width:[1,1,1,0]}},"button-box-hovered-right-borderless":{include:z,style:{radius:[0,3,3,0],width:[1,1,1,0]}},"button-box-top-right":{include:H,style:{radius:[0,3,0,0],width:[1,1,1,0]}},"button-box-pressed-top-right":{include:F,style:{radius:[0,3,0,0],width:[1,1,1,0]}},"button-box-pressed-hovered-top-right":{include:B,style:{radius:[0,3,0,0],width:[1,1,1,0]}},"button-box-hovered-top-right":{include:z,style:{radius:[0,3,0,0],width:[1,1,1,0]}},"button-box-bottom-right":{include:H,style:{radius:[0,0,3,0],width:[0,1,1,0]}},"button-box-pressed-bottom-right":{include:F,style:{radius:[0,0,3,0],width:[0,1,1,0]}},"button-box-pressed-hovered-bottom-right":{include:B,style:{radius:[0,0,3,0],width:[0,1,1,0]}},"button-box-hovered-bottom-right":{include:z,style:{radius:[0,0,3,0],width:[0,1,1,0]}},"button-box-bottom-left":{include:H,style:{radius:[0,0,0,3],width:[0,0,1,1]}},"button-box-pressed-bottom-left":{include:F,style:{radius:[0,0,0,3],width:[0,0,1,1]}},"button-box-pressed-hovered-bottom-left":{include:B,style:{radius:[0,0,0,3],width:[0,0,1,1]}},"button-box-hovered-bottom-left":{include:z,style:{radius:[0,0,0,3],width:[0,0,1,1]}},"button-box-top-left":{include:H,style:{radius:[3,0,0,0],width:[1,0,0,1]}},"button-box-pressed-top-left":{include:F,style:{radius:[3,0,0,0],width:[1,0,0,1]}},"button-box-pressed-hovered-top-left":{include:B,style:{radius:[3,0,0,0],width:[1,0,0,1]}},"button-box-hovered-top-left":{include:z,style:{radius:[3,0,0,0],width:[1,0,0,1]}},"button-box-middle":{include:H,style:{radius:0,width:[1,0,1,1]}},"button-box-pressed-middle":{include:F,style:{radius:0,width:[1,0,1,1]}},"button-box-pressed-hovered-middle":{include:B,style:{radius:0,width:[1,0,1,1]}},"button-box-hovered-middle":{include:z,style:{radius:0,width:[1,0,1,1]}},"button-box-left":{include:H,style:{radius:[3,0,0,3],width:[1,0,1,1]}},"button-box-pressed-left":{include:F,style:{radius:[3,0,0,3],width:[1,0,1,1]}},"button-box-pressed-hovered-left":{include:B,style:{radius:[3,0,0,3],width:[1,0,1,1]}},"button-box-hovered-left":{include:z,style:{radius:[3,0,0,3],width:[1,0,1,1]}},"button-box-focused-left":{include:I,style:{radius:[3,0,0,3],width:[1,0,1,1]}},"separator-horizontal":{decorator:qx.ui.decoration.Single,style:{widthLeft:1,colorLeft:C}},"separator-vertical":{decorator:qx.ui.decoration.Single,style:{widthTop:1,colorTop:C}},"scroll-knob":{decorator:[qx.ui.decoration.MBorderRadius,qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundColor],style:{radius:3,width:1,color:x,backgroundColor:N}},"scroll-knob-pressed":{include:k,style:{backgroundColor:T}},"scroll-knob-hovered":{include:k,style:{color:K}},"scroll-knob-pressed-hovered":{include:o,style:{color:K}},"button-hover":{decorator:[qx.ui.decoration.MBackgroundColor,qx.ui.decoration.MBorderRadius],style:{backgroundColor:b,radius:3}},"window":{decorator:[qx.ui.decoration.MDoubleBorder,qx.ui.decoration.MBoxShadow,qx.ui.decoration.MBackgroundColor],style:{width:1,color:m,innerWidth:4,innerColor:s,shadowLength:1,shadowBlurRadius:3,shadowColor:E,backgroundColor:v}},"window-active":{include:r,style:{shadowLength:2,shadowBlurRadius:5}},"window-caption":{decorator:qx.ui.decoration.Single,style:{width:[0,0,2,0],color:s}},"white-box":{decorator:[qx.ui.decoration.MBorderRadius,qx.ui.decoration.MBoxShadow,qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundColor],style:{width:1,color:q,shadowBlurRadius:2,shadowColor:e,radius:7,backgroundColor:t}},"inset":{decorator:qx.ui.decoration.Single,style:{width:1,color:[M,L,L,L]}},"focused-inset":{decorator:qx.ui.decoration.Uniform,style:{width:2,color:D}},"border-invalid":{decorator:qx.ui.decoration.Uniform,style:{width:2,color:w}},"lead-item":{decorator:qx.ui.decoration.Uniform,style:{width:1,style:c,color:Q}},"tooltip":{decorator:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundColor,qx.ui.decoration.MBoxShadow],style:{width:1,color:a,shadowLength:1,shadowBlurRadius:2,shadowColor:E}},"tooltip-error":{decorator:[qx.ui.decoration.MBorderRadius,qx.ui.decoration.MBackgroundColor],style:{radius:5,backgroundColor:w}},"toolbar-separator":{decorator:qx.ui.decoration.Single,style:{widthLeft:1,colorLeft:x}},"menu-separator":{decorator:qx.ui.decoration.Single,style:{widthTop:1,colorTop:D}},"menubar-button-hovered":{decorator:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBorderRadius,qx.ui.decoration.MBackgroundColor],style:{width:1,color:G,radius:3,backgroundColor:t}},"menubar-button-pressed":{include:g,style:{radius:[3,3,0,0],width:[1,1,0,1]}},"datechooser-date-pane":{decorator:qx.ui.decoration.Single,style:{widthTop:1,colorTop:J,style:u}},"datechooser-weekday":{decorator:qx.ui.decoration.Single,style:{widthBottom:1,colorBottom:J,style:u}},"datechooser-week":{decorator:qx.ui.decoration.Single,style:{widthRight:1,colorRight:J,style:u}},"datechooser-week-header":{decorator:qx.ui.decoration.Single,style:{widthBottom:1,colorBottom:J,widthRight:1,colorRight:J,style:u}},"tabview-page-button-top":{decorator:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBorderRadius,qx.ui.decoration.MBackgroundColor],style:{width:[1,1,0,1],backgroundColor:v,color:G,radius:[3,3,0,0]}},"tabview-page-button-bottom":{include:y,style:{radius:[0,0,3,3],width:[0,1,1,1]}},"tabview-page-button-left":{include:y,style:{radius:[3,0,0,3],width:[1,0,1,1]}},"tabview-page-button-right":{include:y,style:{radius:[0,3,3,0],width:[1,1,1,0]}},"statusbar":{decorator:qx.ui.decoration.Single,style:{widthTop:1,colorTop:D,styleTop:u}},"table-scroller-focus-indicator":{decorator:qx.ui.decoration.Single,style:{width:2,color:V,style:u}},"table-header":{include:H,style:{radius:0,width:[1,0,1,0]}},"table-header-column-button":{include:i,style:{width:1,color:x}},"table-header-cell":{decorator:qx.ui.decoration.Single,style:{widthRight:1,color:x}},"table-header-cell-first":{include:R,style:{widthLeft:1}},"progressbar":{decorator:qx.ui.decoration.Single,style:{backgroundColor:P,width:1,color:C}},"radiobutton":{decorator:[qx.ui.decoration.MBorderRadius,qx.ui.decoration.MDoubleBorder,qx.ui.decoration.MBackgroundColor],style:{radius:10,width:1,color:x,innerColor:v,innerWidth:2}},"radiobutton-focused":{include:n,style:{color:D}},"radiobutton-invalid":{include:n,style:{color:w}},"checkbox":{decorator:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundColor],style:{width:1,color:x}},"checkbox-focused":{include:p,style:{color:D}},"checkbox-invalid":{include:p,style:{color:w}}}});}
)();
...
(function(){var j="#D9D9D9",i="#BBBBBB",h="#24B",g="qx.theme.indigo.Color",f="#888888",e="#CCCCCC",d="rgba(0, 0, 0, 0.4)",c="#B7B7B7",b="#1866B5",a="#BABABA",L="black",K="#A7A6AA",J="#666666",I="#CBC8CD",H="#F9F9F9",G="#F7F7F7",F="#808080",E="#C00F00",D="#686868",C="#5583D0",q="css.rgba",r="#E3E3E3",o="#BBB",p="#FE0",m="#F1F1F1",n="#939393",k="#134983",l="#E8F0E3",s="#AAAAAA",t="#EBEBEB",w="#262626",v="#EEE",y="#323335",x="gray",A="#dddddd",z="#F4F4F4",u="#3D72C9",B="white";qx.Theme.define(g,{colors:{"background":B,"dark-blue":y,"light-background":z,"font":w,"highlight":u,"highlight-shade":C,"background-selected":u,"background-selected-dark":y,"background-disabled":G,"background-disabled-checked":i,"background-pane":B,"tabview-unselected":b,"tabview-button-border":k,"tabview-label-active-disabled":j,"link":h,"scrollbar-bright":m,"scrollbar-dark":t,"button":l,"button-border":o,"button-border-hovered":n,"invalid":E,"button-box-bright":H,"button-box-dark":r,"button-box-bright-pressed":a,"button-box-dark-pressed":t,"border-lead":f,"window-border":A,"window-border-inner":z,"white-box-border":A,"shadow":qx.core.Environment.get(q)?d:J,"border-main":A,"border-light":c,"border-light-shadow":D,"border-separator":F,"text":w,"text-disabled":K,"text-selected":B,"text-placeholder":I,"tooltip":p,"tooltip-text":L,"table-header":[242,242,242],"table-focus-indicator":u,"table-header-cell":[235,234,219],"table-row-background-focused-selected":u,"table-row-background-focused":z,"table-row-background-selected":[51,94,168],"table-row-background-even":B,"table-row-background-odd":B,"table-row-selected":[255,255,255],"table-row":[0,0,0],"table-row-line":v,"table-column-line":v,"progressive-table-header":s,"progressive-table-row-background-even":[250,248,243],"progressive-table-row-background-odd":[255,255,255],"progressive-progressbar-background":x,"progressive-progressbar-indicator-done":e,"progressive-progressbar-indicator-undone":B,"progressive-progressbar-percent-background":x,"progressive-progressbar-percent-text":B}});}
)();
