...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree-qx.theme.Simple.3871e7c1b50e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="Show Leafs",k="Show top level open/close icons",j="loaded",h="File #",g="demobrowser.demo.virtual.Tree",f="Enable drag selection",d="Open mode:",c="change",b="Hide Root Node",a="Update Model",H="Control",G=" items",F="changeSelection",E="children",D="Enable multi selection",C="name",B="",A="single",z="Selection: ",y="Tree:",s="click",t="json/tree.json",q="none",r="double click",o="Selection:",p="Root node:",m="Toggle Height",n="execute",u="mode",v="multi",x="model",w="changeValue";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));this.getRoot().add(L,{top:20,left:20});var J=new qx.ui.tree.VirtualTree(null,C,E).set({width:200,height:400});L.add(J);var I=t;var M=new qx.data.store.Json(I);M.bind(x,J,x);M.addListener(j,function(){J.openNode(J.getModel().getChildren().getItem(0));}
,this);var K=this.getCommandFrame(J);L.add(K);}
,getCommandFrame:function(N){var W=new qx.ui.groupbox.GroupBox(H);var T=4;W.setLayout(new qx.ui.layout.Grid(5,3));var be=0;W.add(new qx.ui.basic.Label(z).set({paddingTop:4}),{row:be,column:0});var ba=new qx.ui.form.TextField().set({readOnly:true});W.add(ba,{row:be++,column:1});N.getSelection().addListener(c,function(e){var bf=N.getSelection();if(bf.getLength()>0){if(N.getSelectionMode()===v){ba.setValue(bf.getLength()+G);}
else {ba.setValue(bf.getItem(0).getName());}
;}
else {ba.setValue(B);}
;}
);W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});W.add(new qx.ui.basic.Label(d),{row:be,column:0});var Q={"click":s,"dblclick":r,"none":q};var O=new qx.ui.form.RadioGroup();for(var X in Q){var P=new qx.ui.form.RadioButton(Q[X]).set({value:X==N.getOpenMode()});P.setUserData(u,X);O.add(P);W.add(P,{row:be++,column:1});}
;O.addListener(F,function(e){N.setOpenMode(e.getData()[0].getUserData(u));}
);W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});W.add(new qx.ui.basic.Label(o),{row:be,column:0});var R=new qx.ui.form.CheckBox(D);W.add(R,{row:be++,column:1});R.addListener(w,function(e){var bg=e.getData();N.setSelectionMode(bg?v:A);}
);var S=new qx.ui.form.CheckBox(f);W.add(S,{row:be++,column:1});S.addListener(w,function(e){var bh=e.getData();N.setDragSelection(bh);if(!R.getValue()){R.setValue(true);}
;}
);W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});W.add(new qx.ui.basic.Label(p),{row:be,column:0});var bc=new qx.ui.form.CheckBox(b);W.add(bc,{row:be++,column:1});bc.addListener(w,function(e){N.setHideRoot(e.getData());}
);var V=new qx.ui.form.CheckBox(k);W.add(V,{row:be++,column:1});V.addListener(w,function(e){N.setShowTopLevelOpenCloseIcons(e.getData());}
);W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});W.add(new qx.ui.basic.Label(y),{row:be,column:0});var Y=new qx.ui.form.CheckBox(l);Y.setValue(N.isShowLeafs());W.add(Y,{row:be++,column:1});Y.addListener(w,function(e){N.setShowLeafs(e.getData());}
);W.add(new qx.ui.core.Spacer(T,T),{row:be++,column:0});var bb=new qx.ui.form.Button(a);bb.addListener(n,function(e){var bl=N.getModel().getChildren().getItem(0);var bi=bl.getChildren().getItem(2);var bj=[];for(var i=0;i<10;i++){bj.push({"name":h+(bi.getChildren().getLength()+i)});}
;var bk=qx.data.marshal.Json.createModel(bj,true);bi.getChildren().append(bk);}
,this);W.add(bb,{row:be++,column:1});var U=new qx.ui.form.Button(m);W.add(U,{row:be++,column:1});var bd=true;U.addListener(n,function(e){N.setHeight(bd?600:400);bd=!bd;}
);return W;}
}});}
)();
...
,_onChangeSelection:function(e){if(this.__zx==true){return;}
;this.__zp=true;var E=this.getSelection();var G=[];for(var i=0;i<E.getLength();i++){var F=E.getItem(i);var H=this._getSelectables();var D=-1;if(H!=null){D=H.indexOf(F);}
...
;this.__zd();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__zp=false;}
,_onManagerChangeSelection:function(e){if(this.__zp==true){return;}
;this.__zx=true;this.__zd();this.__zx=false;}
,__zd:function(){if(this.__zz()){return;}
;var J=this._manager.getSelection();var K=[];for(var i=0;i<J.length;i++){var L=this._getDataFromRow(J[i]);if(L!=null){K.push(L);}
;}
;this.__zy(K);}
,__zy:function(M){var N=this.getSelection();if(M.length>0){var P=[0,N.getLength()];P=P.concat(M);var O=N.splice.apply(N,P);O.dispose();}
else {N.removeAll();}
;}
,__zz:function(){var R=this.getSelection();var T=this._manager.getSelection();if(R.getLength()!==T.length){return false;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__yX){this.__yX.dispose();}
;}
});}
)();
...
,getLookupTable:function(){return this.__yq;}
,_reverseLookup:function(bh){return bh;}
,_getDataFromRow:function(bi){return this.__yq.getItem(bi);}
,_getSelectables:function(){return this.__yq;}
...
,getLevel:function(bk){return this.__IB[bk];}
...
,_applyModel:function(bJ,bK){this.__IA=[];if(bJ!=null){if(qx.core.Environment.get(O)){if(!qx.Class.hasMixin(bJ.constructor,qx.data.marshal.MEventBubbling)){this.warn(q+h+f);}
;}
;bJ.addListener(x,this._onChangeBubble,this);this.__IG(bJ);}
...
;if(qx.lang.String.startsWith(bO,this.getChildProperty())){this.__IE();}
;}
,_onUpdated:function(event){if(this.__ei==null){this.__ei=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__ei.schedule();}
,_onOpen:function(event){var bQ=event.getRow();var bP=this.__yq.getItem(bQ);if(this.isNode(bP)){if(this.isNodeOpen(bP)){this.closeNode(bP);}
...
;break;};}
;}
,_beforeApplySelection:function(bV){if(bV.length===0&&this.getSelectionMode()===C){var bW=this.__IJ();var bX=this.getLookupTable().indexOf(bW);if(bX>=0){bV.push(bX);}
;}
;}
,_afterApplySelection:function(){var bY=this.getSelection();if(bY.getLength()>0&&this.getSelectionMode()===C){this.__II(bY.getItem(0));}
else {this.__ID=[];}
;}
,__IE:function(){this.buildLookupTable();this._applyDefaultSelection();}
,buildLookupTable:function(){if(this.getModel()!=null&&(this.getChildProperty()==null||this.getLabelPath()==null)){throw new Error(v+k);}
;this.__IC=0;var cd=[];this.__IB=[];var cb=-1;var cc=this.getModel();if(cc!=null){if(!this.isHideRoot()){cb++;cd.push(cc);this.__IB.push(cb);}
;if(this.isNodeOpen(cc)){var ca=this.__IF(cc,cb);cd=cd.concat(ca);}
;}
;this._provider.removeBindings();this.__yq.removeAll();this.__yq.append(cd);this.__yw();this._updateSelection();}
,__IF:function(ce,cf){var cg=[];cf++;if(!this.isNode(ce)){return cg;}
;var ci=ce.get(this.getChildProperty());if(ci==null){return cg;}
;for(var i=0;i<ci.getLength();i++){var cj=ci.getItem(i);if(this.isNode(cj)){this.__IB.push(cf);cg.push(cj);if(this.isNodeOpen(cj)){var ch=this.__IF(cj,cf);cg=cg.concat(ch);}
;}
else {if(this.isShowLeafs()){this.__IB.push(cf);cg.push(cj);}
;}
;}
;return cg;}
,__IG:function(ck){if(!qx.lang.Array.contains(this.__IA,ck)){this.__IA.push(ck);this.fireDataEvent("open",ck);}
;}
,__IH:function(cl,cm){if(cl===cm){this.__IG(cm);return true;}
;if(!this.isNode(cl)){return false;}
;var co=cl.get(this.getChildProperty());if(co==null){return false;}
;for(var i=0;i<co.getLength();i++){var cp=co.getItem(i);var cn=this.__IH(cp,cm);if(cn===true){this.__IG(cp);return true;}
;}
;return false;}
,__yw:function(){this.getPane().getRowConfig().setItemCount(this.__yq.getLength());this.getPane().fullUpdate();}
,getParent:function(cq){var cs=this.__yq.indexOf(cq);if(cs<0){return null;}
;var ct=this.__IB[cs];while(cs>0){cs--;var cr=this.__IB[cs];if(cr<ct){return this.__yq.getItem(cs);}
;}
;return null;}
,__II:function(cu){this.__ID=[];var parent=this.getParent(cu);while(parent!=null){this.__ID.unshift(parent);parent=this.getParent(parent);}
;}
,__IJ:function(){if(this.__ID==null){return this.getModel();}
;var cv=this.getLookupTable();var parent=this.__ID.pop();while(parent!=null){if(cv.contains(parent)){return parent;}
...
;this._layer.removeListener(E,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__yq.dispose();this._layer=this._provider=this.__yq=this.__IA=this.__ei=null;}
});}
)();
...
(function(){var q="model",p="changeDelegate",o="virtual-tree-file",n="label",m="appearance",l="icon",k="bindItem",j=".length",i="]",h="virtual-tree-folder",c="[",g=".",f="qx.ui.tree.core.MWidgetController",b="BindingIds",a="",d="String";qx.Mixin.define(f,{construct:function(){this.__yC=[];}
,properties:{labelPath:{check:d,nullable:true},iconPath:{check:d,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:d,nullable:true},delegate:{event:p,init:null,nullable:true}},members:{__yC:null,bindDefaultProperties:function(r,s){this.bindProperty(a,q,null,r,s);this.bindProperty(this.getLabelPath(),n,this.getLabelOptions(),r,s);try{this.bindProperty(this.getChildProperty()+j,m,{converter:function(){return h;}
},r,s);}
catch(t){r.setAppearance(o);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),l,this.getIconOptions(),r,s);}
;}
,bindProperty:function(u,v,w,x,y){var z=this.__yD(y,u);var A=this._tree.getLookupTable();var B=A.bind(z,x,v,w);this.__yE(x,B);}
,bindPropertyReverse:function(C,D,E,F,G){var H=this.__yD(G,C);var I=this._tree.getLookupTable();var J=F.bind(D,I,H,E);this.__yE(F,J);}
,removeBindings:function(){while(this.__yC.length>0){var K=this.__yC.pop();this._removeBindingsFrom(K);}
;}
...
;}
,_removeBindingsFrom:function(O){var P=this.__yF(O);while(P.length>0){var Q=P.pop();try{this._tree.getLookupTable().removeBinding(Q);}
catch(e){O.removeBinding(Q);}
;}
;if(qx.lang.Array.contains(this.__yC,O)){qx.lang.Array.remove(this.__yC,O);}
;}
,__yD:function(R,S){var T=c+R+i;if(S!=null&&S!=a){T+=g+S;}
;return T;}
,__yE:function(U,V){var W=this.__yF(U);if(!qx.lang.Array.contains(W,V)){W.push(V);}
;if(!qx.lang.Array.contains(this.__yC,U)){this.__yC.push(U);}
;}
,__yF:function(X){var Y=X.getUserData(b);if(Y==null){Y=[];X.setUserData(b,Y);}
;return Y;}
},destruct:function(){this.__yC=null;}
});}
)();
...
(function(){var k="never",j="changeDelegate",i="cell.level",h="createItem",g="auto",f="cell.children",e="configureItem",d="created",c="onPool",b="qx.ui.tree.provider.WidgetProvider",a="changeOpen";qx.Class.define(b,{extend:qx.core.Object,implement:[qx.ui.virtual.core.IWidgetCellProvider,qx.ui.tree.provider.IVirtualTreeProvider],include:[qx.ui.tree.core.MWidgetController],construct:function(l){qx.core.Object.call(this);this._tree=l;this.addListener(j,this._onChangeDelegate,this);this._onChangeDelegate();}
,members:{_tree:null,_renderer:null,getCellWidget:function(m,n){var o=this._tree.getLookupTable().getItem(m);var q=false;if(this._tree.isNode(o)){q=this._tree.hasChildren(o);}
;var p=this._renderer.getCellWidget();p.setOpen(q&&this._tree.isNodeOpen(o));p.setUserData(f,q);p.addListener(a,this.__IK,this);if(this._tree.getSelection().contains(o)){this._styleSelectabled(p);}
else {this._styleUnselectabled(p);}
;var r=this._tree.getLevel(m);if(!this._tree.isShowTopLevelOpenCloseIcons()){r-=1;}
;p.setUserData(i,r);if(!this._tree.isShowTopLevelOpenCloseIcons()&&r==-1){p.setOpenSymbolMode(k);}
else {p.setOpenSymbolMode(g);}
;this._bindItem(p,m);qx.ui.core.queue.Widget.add(p);return p;}
,poolCellWidget:function(s){s.removeListener(a,this.__IK,this);this._removeBindingsFrom(s);this._renderer.pool(s);this._onPool(s);}
,createLayer:function(){return new qx.ui.virtual.layer.WidgetCell(this);}
,createRenderer:function(){var t=qx.util.Delegate.getMethod(this.getDelegate(),h);if(t==null){t=function(){return new qx.ui.tree.VirtualTreeItem();}
;}
;var u=new qx.ui.virtual.cell.WidgetCell();u.setDelegate({createWidget:t});return u;}
,styleSelectabled:function(v){var w=this._tree._layer.getRenderedCellWidget(v,0);this._styleSelectabled(w);}
,styleUnselectabled:function(x){var y=this._tree._layer.getRenderedCellWidget(x,0);this._styleUnselectabled(y);}
,isSelectable:function(z){var A=this._tree._layer.getRenderedCellWidget(z,0);if(A!=null){return A.isEnabled();}
else {return true;}
;}
...
,_onPool:function(D){var E=qx.util.Delegate.getMethod(this.getDelegate(),c);if(E!=null){E(D);}
;}
,_onItemCreated:function(event){var G=qx.util.Delegate.getMethod(this.getDelegate(),e);if(G!=null){var F=event.getData();G(F);}
;}
,_onChangeDelegate:function(event){if(this._renderer!=null){this._renderer.dispose();this.removeBindings();}
;this._renderer=this.createRenderer();this._renderer.addListener(d,this._onItemCreated,this);}
,__IK:function(event){var I=event.getTarget();var J=I.getUserData("cell.row");var H=this._tree.getLookupTable().getItem(J);if(event.getData()){this._tree.openNode(H);}
else {this._tree.closeNode(H);}
;}
...
;}
;h.setUserData(b,i);}
,getCellWidget:function(m,n){var o=this.__zm();this.updateStates(o,n);this.updateData(o,m);return o;}
,pool:function(p){this.__cQ.push(p);}
,_cleanupPool:function(){var q=this.__cQ.pop();while(q){q.destroy();q=this.__cQ.pop();}
;}
,__zm:function(){var r=this.__cQ.pop();if(r==null){r=this._createWidget();this.fireDataEvent(e,r);}
;return r;}
...
(function(){var r='"',q="The model contained an illegal name: '",p="qx.debug.databinding",o="change",n="qx.data.marshal.Json",m="Unsupported type!",l="'.",k="'. Replaced it with '",j="set",h="' is not a valid JavaScript identifier.",c="_applyEventPropagation",g="The key '",f="",b="Array",a="_validate",e="qx.debug",d="qx.data.model.";qx.Class.define(n,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(s){qx.core.Object.call(this);this.__zB=s;}
...
},members:{__zB:null,__zC:function(v){return qx.Bootstrap.getKeys(v).sort().join(r);}
...
;}
;return;}
;var z=this.__zC(w);for(var A in w){this.toClass(w[A],x);}
;if(qx.Class.isDefined(d+z)){return;}
;if(this.__zB&&this.__zB.getModelClass&&this.__zB.getModelClass(z)!=null){return;}
;var G={};var F={__zD:this.__zD};for(var A in w){if(this.__zB&&this.__zB.getPropertyMapping){A=this.__zB.getPropertyMapping(A,z);}
...
;if(this.__zB&&this.__zB.getValidationRule){var C=this.__zB.getValidationRule(z,A);if(C){G[A].validate=a+A;F[a+A]=C;}
;}
;}
;if(this.__zB&&this.__zB.getModelSuperClass){var E=this.__zB.getModelSuperClass(z)||qx.core.Object;}
else {var E=qx.core.Object;}
;var B=[];if(this.__zB&&this.__zB.getModelMixins){var D=this.__zB.getModelMixins(z);if(!qx.lang.Type.isArray(D)){if(D!=null){B=[D];}
;}
else {B=D;}
;}
;if(x){B.push(qx.data.marshal.MEventBubbling);}
;var y={extend:E,include:B,properties:G,members:F,destruct:this.__zE};qx.Class.define(d+z,y);}
,__zE:function(){var H=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var I in H){this.__zD(this.get(H[I].name));}
;}
,__zD:function(J){if(!(J instanceof qx.core.Object)){return;}
;if(J.isDisposed()){return;}
;J.dispose();}
,__zF:function(K){var L;if(this.__zB&&this.__zB.getModelClass){L=this.__zB.getModelClass(K);}
...
;return U;}
else if(S){var P=this.__zC(N);var V=this.__zF(P);for(var T in N){var Q=T;if(this.__zB&&this.__zB.getPropertyMapping){Q=this.__zB.getPropertyMapping(T,P);}
