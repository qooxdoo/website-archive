...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor-qx.theme.Indigo.93b3a0a3716b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="Window: ",h="__iG",g="interval",f="Done! (Registry: ",e="Label: ",d=" (Registry: ",c="demobrowser.demo.test.Destructor",b="Round: ",a=")";qx.Class.define(c,{extend:qx.application.Standalone,members:{__cR:null,__QR:0,__iG:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cR=[];this.currentTest=this.testWindows;this.__iG=new qx.event.Timer(1000);this.__iG.addListener(g,this.runTest,this);this.__iG.start();}
,runTest:function(){this.__QR++;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(b+this.__QR+d+m+a);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cR;for(var i=0,l=k.length;i<l;i++){k[i].destroy();}
