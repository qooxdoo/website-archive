...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListControllerWith3Widgets-qx.theme.Modern.09f0eb394595.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Write data to log",l="Add an item",k="<b>SelectBox</b>",j="Remove an item",h="<b>List</b><br/>",g="multi",f="All 3 widgets share the same data model. The List and the SelectBox ",e="demobrowser.demo.data.ListControllerWith3Widgets",d="<b>ComboBox</b><br/>",c="also share the same selection.",a="Item ",b="execute";qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var w=[];for(var i=0;i<30;i++){w.push(a+i);}
;var y=new qx.data.Array(w);var q=new qx.ui.form.List();var n=new qx.ui.form.SelectBox();var p=new qx.ui.form.ComboBox();this.getRoot().add(q,{left:10,top:80});q.setSelectionMode(g);this.getRoot().add(n,{left:120,top:80});this.getRoot().add(p,{left:250,top:80});var u=new qx.data.controller.List(y,q);var t=new qx.data.controller.List(y,n);new qx.data.controller.List(y,p);t.setSelection(u.getSelection());var z=new qx.ui.form.Button(l);z.setWidth(120);this.getRoot().add(z,{left:380,top:80});z.addListener(b,function(){y.push(a+y.length);}
,this);var r=new qx.ui.form.Button(j);r.setWidth(120);this.getRoot().add(r,{left:380,top:115});r.addListener(b,function(){y.pop();}
,this);var v=new qx.ui.form.Button(m);v.setWidth(120);this.getRoot().add(v,{left:380,top:150});v.addListener(b,function(){qx.log.appender.Console.show();this.info(y.toString());}
,this);var x=new qx.ui.basic.Label();x.setRich(true);x.setWidth(100);x.setValue(h);this.getRoot().add(x,{left:20,top:10});var o=new qx.ui.basic.Label();o.setRich(true);o.setWidth(100);o.setValue(k);this.getRoot().add(o,{left:130,top:10});var A=new qx.ui.basic.Label();A.setRich(true);A.setWidth(100);A.setValue(d);this.getRoot().add(A,{left:260,top:10});var s=new qx.ui.basic.Label();s.setRich(true);s.setWidth(360);s.setValue(f+c);this.getRoot().add(s,{left:20,top:30});}
}});}
)();
...
,this);}
,properties:{appearance:{refine:true,init:w},placeholder:{check:c,nullable:true,apply:u}},events:{"changeValue":g},members:{__ya:null,__yb:null,_applyPlaceholder:function(y,z){this.getChildControl(m).setPlaceholder(y);}
...
,_setPreselectedItem:function(){if(this.__ya){var J=this.__ya.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__ya);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__ya=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(n);var L=M.getSelectionContext();if(L==d||L==i){this.__ya=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__ya=null;}
;}
;}
