...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.JsonToTree-qx.theme.Simple.ca90c7a231ee.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="name",l="Loading...",k="tree.json</a> and bind the items to the tree widget.",j="Loading the json file <a href='",i="state",h="kids",g="demobrowser/demo/data/tree.json",f="value",e="demobrowser.demo.data.JsonToTree",d="' target='_blank'>",a="<b>Tree bound to data in a json file</b><br/>",c="loaded",b="model";qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var p=new qx.ui.tree.Tree();this.getRoot().add(p,{left:10,top:80});p.setWidth(200);p.setHeight(300);var q=new qx.data.controller.Tree(null,p,h,m);var o=qx.util.ResourceManager.getInstance().toUri(g);var r=new qx.data.store.Json(o);var status=new qx.ui.basic.Label(l);this.getRoot().add(status,{left:220,top:80});r.bind(b,q,b);r.bind(i,status,f);r.addListener(c,function(s){p.getRoot().setOpen(true);}
,this);var n=new qx.ui.basic.Label();n.setRich(true);n.setWidth(260);n.setValue(a+j+o+d+k);this.getRoot().add(n,{left:10,top:10});}
}});}
)();
