...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas-qx.theme.Indigo.091c1dfae9be.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Window containing a Canvas - synced coordinates",l="Canvas is not supported by this browser!",k="Window containing a Canvas - static coordinates",j="Resize the windows to see the effect.",i="Canvas is not support by this browser!",h="rgba(0, 0, 200, 0.5)",g="demobrowser.demo.widget.Canvas",f="rgb(200,0,0)",d="redraw",c="html.canvas",a="center",b="middle";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.basic.Label(j);this.getRoot().add(r,{left:10,top:10});var q=new qx.ui.window.Window(k).set({width:200,height:200});q.setLayout(new qx.ui.layout.Canvas());if(!qx.core.Environment.get(c)){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox());p.add(new qx.ui.basic.Label(l).set({rich:true,alignX:a,alignY:b}));}
else {var p=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:false});p.addListener(d,this.draw,this);}
;q.add(p,{edge:0});this.getRoot().add(q,{left:30,top:40});q.open();var n=new qx.ui.window.Window(m).set({width:200,height:200});n.setLayout(new qx.ui.layout.Canvas());if(!qx.core.Environment.get(c)){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox());o.add(new qx.ui.basic.Label(i).set({rich:true,alignX:a,alignY:b}));}
else {var o=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:true});o.addListener(d,this.draw,this);}
;n.add(o,{edge:0});this.getRoot().add(n,{left:30,top:250});n.open();}
,draw:function(e){var t=e.getData();var s=t.context;s.fillStyle=f;s.fillRect(20,20,105,100);s.fillStyle=h;s.fillRect(70,70,105,100);}
}});}
)();
...
(function(){var i="resize",h="_applyCanvasWidth",g="Boolean",f="__JD",d="_applyCanvasHeight",c="qx.ui.embed.Canvas",b="qx.event.type.Data",a="Integer";qx.Class.define(c,{extend:qx.ui.core.Widget,construct:function(j,k){qx.ui.core.Widget.call(this);this.__JD=new qx.util.DeferredCall(this.__JE,this);this.addListener(i,this._onResize,this);if(j!==undefined){this.setCanvasWidth(j);}
;if(k!==undefined){this.setCanvasHeight(k);}
;}
,events:{"redraw":b},properties:{syncDimension:{check:g,init:false},canvasWidth:{check:a,init:300,apply:h},canvasHeight:{check:a,init:150,apply:d}},members:{__JD:null,_createContentElement:function(){return new qx.html.Canvas();}
,__JE:function(){var m=this.getContentElement();var o=m.getHeight();var l=m.getWidth();var n=m.getContext2d();this._draw(l,o,n);this.fireNonBubblingEvent("redraw",qx.event.type.Data,[{width:l,height:o,context:n}]);}
,_applyCanvasWidth:function(p,q){this.getContentElement().setWidth(p);this.__JD.schedule();}
,_applyCanvasHeight:function(r,s){this.getContentElement().setHeight(r);this.__JD.schedule();}
,update:function(){this.__JD.schedule();}
,_onResize:function(e){var t=e.getData();if(this.getSyncDimension()){this.setCanvasHeight(t.height);this.setCanvasWidth(t.width);}
;}
,getContext2d:function(){return this.getContentElement().getContext2d();}
,_draw:function(u,v,w){}
},destruct:function(){this._disposeObjects(f);}
});}
)();
(function(){var c="2d",b="qx.html.Canvas",a="canvas";qx.Class.define(b,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__JF=document.createElement(a);}
,members:{__JF:null,_createDomElement:function(){return this.__JF;}
,getCanvas:function(){return this.__JF;}
,setWidth:function(f){this.__JF.width=f;}
,getWidth:function(){return this.__JF.width;}
,setHeight:function(g){this.__JF.height=g;}
,getHeight:function(){return this.__JF.height;}
,getContext2d:function(){return this.__JF.getContext(c);}
