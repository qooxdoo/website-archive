...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SlideBar","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SlideBar-qx.theme.Modern.9f9ff330f7da.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="display.png",r="drive-optical.png",q="computer.png",p="audio-card.png",o="battery.png",n="main",m="Toggle size",l="icon/48/devices/",k="drive-harddisk.png",j="changeValue",c="camera-web.png",h="network-wired.png",g="input-keyboard.png",b="camera-photo.png",a="network-wireless.png",f="audio-input-microphone.png",d="demobrowser.demo.widget.SlideBar";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var u=new qx.ui.container.SlideBar();u.set({width:300});u.setLayout(new qx.ui.layout.HBox(3));var v=[p,f,o,b,c,q,s,k,r,g,h,a];for(var i=0;i<v.length;i++){u.add((new qx.ui.basic.Image(l+v[i])).set({decorator:n,padding:4}));}
;var t=new qx.ui.form.ToggleButton(m);t.addListener(j,function(e){u.setWidth(e.getData()?800:300);}
