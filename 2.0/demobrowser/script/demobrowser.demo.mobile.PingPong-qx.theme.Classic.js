...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Classic.20b10eecc6cd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="border-left",j="green",i="demobrowser.demo.mobile.PingPong",h="qx.debug",g="interval",f="0px",d="12px",c='Lucida Grande',b="<b>This demo is supposed to be run in a WebKit-based browser.</b>",a="engine.name",G="webkit",F="border-right",E="touchmove",D="black",C="200px",B="30px",A="100px",z="1px solid white",w="top",v="right",r="50%",s="none",p="white",q="px",n="100%",o="innerHTML",l="20px",m="absolute",t="div",u="left";qx.Class.define(i,{extend:qx.application.Native,members:{__Qk:null,__Ql:null,__Qm:null,__Qn:null,__Qo:5,__Qp:1,__Qq:1,__Qr:null,__Qs:null,__Qt:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(h)){qx.log.appender.Native;qx.log.appender.Console;}
;var J={"width":n,"height":n,"backgroundColor":D,"margin":f,"userSelect":s};var M=new qx.html.Element(t,J);M.useElement(document.body);M.setRoot(true);if(qx.core.Environment.get(a)!=G){var L={"color":j,"font-family":c,"font-size":d,"position":m,"left":B,"top":l};var K=new qx.html.Element(t,L);M.add(K);K.setAttribute(o,b);return;}
;var H=this.__Qx(u);M.add(H);var I=this.__Qx(v);M.add(I);this.__Ql=this.__Qy(u);H.add(this.__Ql);H.addListener(E,qx.lang.Function.bind(this.__Dj,this,this.__Ql),this);this.__Qk=this.__Qy(v);I.add(this.__Qk);I.addListener(E,qx.lang.Function.bind(this.__Dj,this,this.__Qk),this);this.__Qm=this.__Qz();M.add(this.__Qm);this.__Qs=this.__QA();H.add(this.__Qs);this.__Qt=this.__QA();I.add(this.__Qt);this.__Qr=[0,0];this.__Qu();}
,__Qu:function(){this.__Qm.setStyles({"left":C,"top":C});this.__Qn=new qx.event.Timer(40);this.__Qn.addListener(g,function(){var x=(parseInt(this.__Qm.getStyle(u))+this.__Qo*this.__Qp);var y=(parseInt(this.__Qm.getStyle(w))+this.__Qo*this.__Qq);this.__Qm.setStyle(u,x+q);this.__Qm.setStyle(w,y+q);this.__Qw();}
,this);this.__Qn.start();}
,__Qv:function(N){this.__Qn.stop();this.__Qn.dispose();this.__Qo=5;this.__Qr[N]=this.__Qr[N]+1;this.__Qs.setAttribute(o,this.__Qr[0]);this.__Qt.setAttribute(o,this.__Qr[1]);this.__Qu();}
,__Qw:function(){var P=this.getBoundsFor(this.__Qm);if(P.top<=0){this.__Qq=1;}
;if(P.bottom>=window.innerHeight-5){this.__Qq=-1;}
;if(P.left<=0||P.right>=window.innerWidth){this.__Qv(P.left<=0?1:0);}
;var Q=this.getBoundsFor(this.__Ql);if(P.left<=Q.right&&P.bottom>=Q.top&&P.top<=Q.bottom){this.__Qp=1;this.__Qo=Math.min(this.__Qo+1,20);}
;var O=this.getBoundsFor(this.__Qk);if(P.right>=O.left&&P.bottom>=O.top&&P.top<=O.bottom){this.__Qp=-1;this.__Qo=Math.min(this.__Qo+1,20);}
;}
,__Dj:function(R,e){R.setStyles({"top":(e.getDocumentTop()-50)+q});}
,getBoundsFor:function(S){return qx.bom.element.Location.get(S.getDomElement());}
,__Qx:function(T){var U={"width":r,"height":n,"position":m,"backgroundColor":D};if(T==u){U[F]=z;}
else {U[u]=r;U[k]=z;}
;return new qx.html.Element(t,U);}
,__Qy:function(V){var W={"width":B,"height":A,"top":A,"position":m,"backgroundColor":p};W[V]=l;return new qx.html.Element(t,W);}
,__Qz:function(){var X={"width":l,"height":l,"position":m,"backgroundColor":p,"userSelect":s};return new qx.html.Element(t,X);}
,__QA:function(){var Y={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};var ba=new qx.html.Element("div",Y);ba.setAttribute("innerHTML","0");return ba;}
}});}
)();
