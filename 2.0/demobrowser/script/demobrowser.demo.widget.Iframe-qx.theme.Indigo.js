...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe-qx.theme.Indigo.b4844db91e2a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:n},scrollbarX:{check:[j,f,c],init:j,themeable:true,apply:k},scrollbarY:{check:[j,f,c],init:j,themeable:true,apply:k},scrollbar:{group:[p,o]}},members:{__Iq:null,__Ir:null,_getIframeElement:function(){return this.getChildControl(a).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__Ir){this._stopIframeObserver();}
;var E=qx.event.Idle.getInstance();this.__Ir=E.addListener(t,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__Iq=null;if(!this.__Ir){return;}
;var F=qx.event.Idle.getInstance();F.removeListenerById(this.__Ir);}
,_onIframeObserverInterval:function(){var G=this._getIframeSize();if(!G){this._disableScollbars();return;}
;if(this.__Iq&&G.width==this.__Iq.width&&G.height==this.__Iq.height){return;}
;this.__Iq=G;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var J=this.__Iq;var M=this.getChildControl(a).getBounds();var K=this.getChildControl(a).getInnerSize();if(!J||!K||!K){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__Iq=null;}
});}
)();
