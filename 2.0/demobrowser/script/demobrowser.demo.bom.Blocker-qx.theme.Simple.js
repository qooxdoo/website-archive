...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker-qx.theme.Simple.5a1962975cdf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__Nc:null,__uR:null,__Nd:null,__Ne:false,__Nf:10000,__Ng:0,__Nh:p,block:function(q){if(!this.__Ne){this.__Nd=q;var r=this.__Nk();this.__Nl(r);this.__Ne=true;}
;}
,unblock:function(){if(this.__Ne){this.__Nm();this.__Ne=false;}
;}
,isBlocked:function(){return this.__Ne;}
,getBlockerElement:function(){return this.__uR;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__uR,h,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__uR,h);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__uR,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__uR);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__uR,c,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__uR,c);}
,__bf:function(){this.__Ni();if((qx.core.Environment.get(d)==f)){this.__Nj();}
;qx.event.Registration.addListener(window,i,this.__jP,this);}
,__Ni:function(){this.__uR=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__uR,{display:g,opacity:this.__Ng,backgroundColor:this.__Nh});this.setBlockerZIndex(this.__Nf);}
,__Nj:function(){this.__Nc=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Nc,n,false);qx.bom.element.Attribute.set(this.__Nc,o,l);qx.bom.element.Style.setStyles(this.__Nc,{display:g,opacity:this.__Ng});}
,__Nk:function(){var v={position:j};if(this.__No()){v.left=b;v.top=b;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+a;v.height=qx.bom.Document.getHeight()+a;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Nd)+a;v.height=qx.bom.element.Dimension.getHeight(this.__Nd)+a;v.left=qx.bom.element.Location.getLeft(this.__Nd)+a;v.top=qx.bom.element.Location.getTop(this.__Nd)+a;}
;return v;}
,__Nl:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__uR,w);qx.dom.Element.insertEnd(this.__uR,x);if((qx.core.Environment.get(d)==f)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Nc,w);qx.dom.Element.insertEnd(this.__Nc,document.body);}
;}
,__Nm:function(){qx.dom.Element.remove(this.__uR);if((qx.core.Environment.get(d)==f)){qx.dom.Element.remove(this.__Nc);}
;}
,__jP:function(e){if(this.__No()){this.__Nn({width:b,height:b});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+a,height:qx.bom.Document.getHeight()+a};this.__Nn(y);}
,this,0);}
;}
,__Nn:function(z){qx.bom.element.Style.setStyles(this.__uR,z);if((qx.core.Environment.get(d)==f)){qx.bom.element.Style.setStyles(this.__Nc,z);}
;}
,__No:function(){return (this.__Nd==null||qx.dom.Node.isWindow(this.__Nd)||qx.dom.Node.isDocument(this.__Nd));}
},destruct:function(){qx.event.Registration.removeListener(window,i,this.__jP,this);this.__Nc=this.__uR=this.__Nd=null;}
});}
)();
