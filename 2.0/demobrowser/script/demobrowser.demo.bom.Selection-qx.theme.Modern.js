...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Selection","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Selection-qx.theme.Modern.9000a1d4dd9d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="text",j="margin: 4px 0px",i="demobrowser.demo.bom.Selection",h="getEndSelectionDocument",g="getSelectionInput",f="this is a test",d="setSelectionInput",c="width:300px;height:250px",b="getStartSelectionDocument",a="setSelectionDocument",P="border:1px solid darkgrey;",O="test\ntest2\ntest3\ntest4\ntest5",N="<strong>Results</strong>",M="background-color: lightgrey",L="test test2 test3 test4 test5 test6",K="container",J="textfield",I="areaContainer",H="position:relative;padding:20px",G="width:20%;margin-right:10px",r="margin-bottom:20px",s="width:500px;height:200px;",p="textContainer",q="test text",n="setSelectionTextarea",o="inputContainer",l="<br/>",m="getSelectionDocument",t="getSelectionTextarea",u="textBlock",y="getEnd",x="textarea",A="getStart",z="plaintext",C="width:100%;margin-bottom:20px",B="results",w="margin: 4px",F="div",E="margin-right: 8px",D="button",v="click";qx.Class.define(i,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var T=qx.dom.Element.create(F,{id:K,style:H});var bj=qx.dom.Element.create(F,{id:p,style:C});qx.dom.Element.insertEnd(bj,T);var bc=qx.dom.Element.create(F,{id:u,style:r});bc.innerHTML=L;qx.dom.Element.insertEnd(bc,bj);var bg=qx.bom.Input.create(D,{value:m,style:w});qx.bom.Element.addListener(bg,v,this._getSelection,document);qx.dom.Element.insertEnd(bg,bj);var bd=qx.bom.Input.create(D,{value:a,style:w});qx.bom.Element.addListener(bd,v,function(e){qx.bom.Selection.set(document.getElementById(z).firstChild,0,4);this.debug(qx.bom.Selection.getLength(document));}
,this);qx.dom.Element.insertEnd(bd,bj);var W=qx.bom.Input.create(D,{value:b,style:w});qx.bom.Element.addListener(W,v,this._getStart,document);qx.dom.Element.insertEnd(W,bj);var Q=qx.bom.Input.create(D,{value:h,style:w});qx.bom.Element.addListener(Q,v,this._getEnd,document);qx.dom.Element.insertEnd(Q,bj);var V=qx.dom.Element.create(F,{id:o,style:C});qx.dom.Element.insertEnd(V,T);this._input=qx.bom.Input.create(k,{id:J,value:q,style:G});qx.dom.Element.insertEnd(this._input,V);var ba=qx.bom.Input.create(D,{value:g,style:E});qx.bom.Element.addListener(ba,v,this._getSelection,this._input);qx.dom.Element.insertEnd(ba,V);var bh=qx.bom.Input.create(D,{value:d,style:E});qx.bom.Element.addListener(bh,v,this._setSelection,this._input);qx.dom.Element.insertEnd(bh,V);var be=qx.bom.Input.create(D,{value:A,style:E});qx.bom.Element.addListener(be,v,this._getStart,this._input);qx.dom.Element.insertEnd(be,V);var bk=qx.bom.Input.create(D,{value:y,style:E});qx.bom.Element.addListener(bk,v,this._getEnd,this._input);qx.dom.Element.insertEnd(bk,V);var S=qx.dom.Element.create(F,{id:I,style:C});qx.dom.Element.insertEnd(S,T);this._textArea=qx.bom.Input.create(x,{id:x,rows:7,cols:20,value:O,style:c});qx.dom.Element.insertEnd(this._textArea,S);var bf=qx.bom.Input.create(D,{value:t,style:E});qx.bom.Element.addListener(bf,v,this._getSelection,this._textArea);qx.dom.Element.insertEnd(bf,S);var X=qx.bom.Input.create(D,{value:n,style:E});qx.bom.Element.addListener(X,v,this._setSelection,this._textArea);qx.dom.Element.insertEnd(X,S);var R=qx.bom.Input.create(D,{value:A,style:E});qx.bom.Element.addListener(R,v,this._getStart,this._textArea);qx.dom.Element.insertEnd(R,S);var bi=qx.bom.Input.create(D,{value:y,style:E});qx.bom.Element.addListener(bi,v,this._getEnd,this._textArea);qx.dom.Element.insertEnd(bi,S);var bb=qx.dom.Element.create(F,{style:j});bb.innerHTML=N;var U=qx.dom.Element.create(F,{id:B,style:s+P+M});qx.dom.Element.insertEnd(bb,T);qx.dom.Element.insertEnd(U,T);var Y=qx.dom.Element.create(F,{id:z});Y.innerHTML=f;qx.dom.Element.insertEnd(Y,document.body);qx.dom.Element.insertEnd(T,document.body);}
,_getSelection:function(e){document.getElementById(B).innerHTML=qx.bom.Selection.get(this)+l+qx.bom.Selection.getLength(this);}
,_getStart:function(e){document.getElementById(B).innerHTML=qx.bom.Selection.getStart(this);}
,_getEnd:function(e){document.getElementById(B).innerHTML=qx.bom.Selection.getEnd(this);}
