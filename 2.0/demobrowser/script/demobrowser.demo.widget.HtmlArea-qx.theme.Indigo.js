...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Indigo.b54cb9a8f335.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var bB="qx/icon/Oxygen/16/actions/format-indent-more.png",bA="Color (Hex): ",bz="Georgia",by="http://",bx="Change Font Size",bw="BgColor (Hex): ",bv="Indent More",bu="<p>You can play around with this widget by hitting the ",bt="Inserted Unordered List",bs="Align Right",bh="Format Italic",bg="qx/icon/Oxygen/16/actions/format-text-underline.png",bf='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',be="OK",bd="buttons at the toolbar.</p>",bc="demobrowser.demo.widget.HtmlArea",bb="demobrowser/demo/icons/htmlarea/format-list-ordered.png",ba="Comic Sans MS",Y="<p>This UI-level widget can be used at RIA (Rich ",X="Tahoma",bI="<td>First Row, First cell</td>",bJ="solid",bG="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",bH="qx/icon/Oxygen/16/actions/format-justify-center.png",bE="Align Justify",bF="demobrowser/demo/icons/htmlarea/format-fill-color.png",bC="demobrowser/demo/icons/htmlarea/insert-text.png",bD="Insert Horizontal Ruler",bK="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bL="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bl="HTML Code:",bk="Set Text Background Color",bn="Internet Applications) and inline applications.<br/>",bm="Insert Link",bp="<td>Second Row, First cell</td>",bo="</tbody>",br="Set Text Color",bq="Insert Table",bj="Cancel",bi="As an application developer you can <b>use the same API.</b></p>",a="demobrowser/demo/icons/htmlarea/format-text-color.png",b="demobrowser/demo/icons/htmlarea/insert-table.png",c="qx/icon/Oxygen/16/actions/edit-undo.png",d="qx/icon/Oxygen/16/actions/edit-clear.png",f="Arial Black",g="Impact",h="Undo Last Change",k="Redo Last Undo Step",l="Format Bold",m="Change Font Family",bP="right",bO="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bN="main",bM="Insert Hyperlink",bT="Remove Format",bS="blank.html",bR="qx/icon/Oxygen/16/actions/insert-image.png",bQ="so code-duplication is avoided.<br/>",bV="</table>",bU="12px ",H="<td>First Row, Second cell</td>",I="Insert HTML Code",F="qx/icon/Oxygen/16/actions/insert-link.png",G="Insert Ordered List",L="qx/icon/Oxygen/16/actions/format-justify-left.png",M="Courier",J="Courier New",K="qx/icon/Oxygen/16/actions/format-justify-right.png",D="qx/icon/Oxygen/16/actions/format-text-bold.png",E="<td>Second Row, Second cell</td>",u="Insert Image",t="<h1>HtmlArea UI-level widget</h1>",w="Align Left",v="<table border='1'>",q="The UI widget does use the low-level component internally ",p="qx/icon/Oxygen/16/actions/format-indent-less.png",s="<tbody>",r="Times New Roman",o="Align Center",n="qx/icon/Oxygen/16/actions/edit-redo.png",R="Lucida Console",S="border-main",T="qx/icon/Oxygen/16/actions/format-text-italic.png",U="Arial",N="qx/icon/Oxygen/16/actions/format-justify-fill.png",O="Verdana",P="Indent Less",Q="Format Strikethrough",V="Format Underline",W="<tr>",C="changeSelection",B="#",A="qooxdoo logo",z="</tr>",y="execute",x="";qx.Class.define(bc,{extend:qx.application.Standalone,members:{__xB:null,main:function(){qx.application.Standalone.prototype.main.call(this);var cd=t+Y+bn+q+bQ+bi+bu+bd;var bX=new qx.ui.basic.Label(cd);bX.set({rich:true,marginBottom:10});var cc=bf;var cb=this.getRoot();var ca=new qx.ui.decoration.Single(1,bJ,S);ca.setWidthTop(0);this.__xB=new qx.ui.embed.HtmlArea(cc,null,bS);this.__xB.set({width:600,height:400,decorator:ca});var toolbar=this.__xL();var bW=new qx.ui.layout.VBox(0);var bY=new qx.ui.container.Composite(bW);bY.add(bX);bY.add(toolbar);bY.add(this.__xB);cb.add(bY,{left:20,top:20});}
,__xC:function(e){var ce=window.prompt(bA,B);this.setTextColor(ce);}
,__xD:function(e){var cf=window.prompt(bw,B);this.setTextBackgroundColor(cf);}
,__xE:function(e){var cg={src:qx.util.ResourceManager.getInstance().toUri(bG),border:0,title:A,alt:A};this.insertImage(cg);}
,__xF:function(e){var ch=v+s+W+bI+H+z+W+bp+E+z+bo+bV;this.insertHtml(ch);}
,__xG:function(e){var cj=new qx.ui.window.Window(bM);cj.setLayout(new qx.ui.layout.VBox(20));cj.set({width:400,showMaximize:false,showMinimize:false});var cn=new qx.ui.form.TextField(by);cj.add(cn);var cl=new qx.ui.layout.HBox(10);cl.setAlignX(bP);var cm=new qx.ui.container.Composite(cl);var ci=new qx.ui.form.Button(be);ci.setWidth(60);ci.addListener(y,function(e){this.insertHyperLink(cn.getValue());cj.close();}
,this);cm.add(ci);var ck=new qx.ui.form.Button(bj);ck.setWidth(60);ck.addListener(y,function(e){cj.close();}
,this);cm.add(ck);cj.add(cm);cj.center();cj.open();this.saveRange();}
,__xH:function(e){var co=window.prompt(bl,x);this.insertHtml(co);}
,__xI:function(){var cq=new qx.ui.form.SelectBox;cq.set({toolTipText:m,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});cq.add(new qx.ui.form.ListItem(x));var cr=[X,O,r,U,f,J,M,bz,g,ba,R];var cp;for(var i=0,j=cr.length;i<j;i++){cp=new qx.ui.form.ListItem(cr[i]);cp.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(bU+cr[i])});cq.add(cp);}
;cq.addListener(C,function(e){var cs=e.getData()[0].getLabel();if(cs!=x){this.setFontFamily(cs);cq.setSelection([cq.getChildren()[0]]);}
;}
,this.__xB);return cq;}
,__xJ:function(){var cu=new qx.ui.form.SelectBox;cu.set({toolTipText:bx,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});cu.add(new qx.ui.form.ListItem(x));var ct;for(var i=1;i<=7;i++){ct=new qx.ui.form.ListItem(i+x);ct.set({focusable:false,keepFocus:true});cu.add(ct);}
;cu.addListener(C,function(e){var cv=e.getData()[0].getLabel();if(cv!=x){this.setFontSize(cv);cu.setSelection([cu.getChildren()[0]]);}
;}
,this.__xB);return cu;}
,__xK:function(){return [{bold:{text:l,image:D,action:this.__xB.setBold},italic:{text:bh,image:T,action:this.__xB.setItalic},underline:{text:V,image:bg,action:this.__xB.setUnderline},strikethrough:{text:Q,image:bO,action:this.__xB.setStrikeThrough},removeFormat:{text:bT,image:d,action:this.__xB.removeFormat}},{alignLeft:{text:w,image:L,action:this.__xB.setJustifyLeft},alignCenter:{text:o,image:bH,action:this.__xB.setJustifyCenter},alignRight:{text:bs,image:K,action:this.__xB.setJustifyRight},alignJustify:{text:bE,image:N,action:this.__xB.setJustifyFull}},{fontFamily:{custom:this.__xI},fontSize:{custom:this.__xJ},fontColor:{text:br,image:a,action:this.__xC},textBackgroundColor:{text:bk,image:bF,action:this.__xD}},{indent:{text:bv,image:bB,action:this.__xB.insertIndent},outdent:{text:P,image:p,action:this.__xB.insertOutdent}},{insertImage:{text:u,image:bR,action:this.__xE},insertTable:{text:bq,image:b,action:this.__xF},insertLink:{text:bm,image:F,action:this.__xG},insertHTML:{text:I,image:bC,action:this.__xH},insertHR:{text:bD,image:bK,action:this.__xB.insertHorizontalRuler}},{ol:{text:G,image:bb,action:this.__xB.insertOrderedList},ul:{text:bt,image:bL,action:this.__xB.insertUnorderedList}},{undo:{text:h,image:c,action:this.__xB.undo},redo:{text:k,image:n,action:this.__xB.redo}}];}
,__xL:function(){var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setDecorator(bN);var cw;var cx=this.__xK();for(var i=0,j=cx.length;i<j;i++){var cy=new qx.ui.toolbar.Part;toolbar.add(cy);for(var cz in cx[i]){var cA=cx[i][cz];if(cA.custom){cw=cA.custom.call(this);}
else {cw=new qx.ui.toolbar.Button(null,cA.image);cw.set({focusable:false,keepFocus:true,center:true,toolTipText:cA.text?cA.text:x});cw.addListener(y,cA.action,this.__xB);}
;cy.add(cw);}
;}
;return toolbar;}
}});}
...
(function(){var k="xhtml",j="_applyUseUndoRedo",i="focusOut",h="_applyMessengerMode",g="url(",f=")",d="InsertParagraphOnLinebreak",c="gecko",b="repeat",a="undoRedoState",bh="div",bg="messengerContent",bf="Integer",be="NativeContextMenu",bd="focused",bc="Function",bb="Please use the method 'qx.dom.Node.isBlockNode' instead.",ba="_applyInsertParagraphOnLinebreak",Y="PostProcess",X="_applyInsertLinebreakOnCtrlEnter",r="ContentType",s="px",p="set",q="DefaultFontSize",n="cursorContext",o="__uR",l="htmlarea",m="ready",v="loadingError",w="MessengerMode",E="_applyDefaultFontSize",C="UseUndoRedo",M="_applyDefaultFontFamily",H="__uQ",T="_applyContentType",R="qx.ui.embed.HtmlArea",y="mshtml",W="Verdana",V="block",U="DefaultFontFamily",x="contextmenu",A="readyAfterInvalid",B="InsertLinebreakOnCtrlEnter",D="qx/static/blank.gif",F="_applyPostProcess",I="absolute",O="mousedown",S="DOMNodeRemoved",t="String",u="none",z="engine.name",L="appear",K="mouseup",J="losecapture",Q="display",P="Boolean",G="qx.event.type.Event",N="qx.event.type.Data";qx.Class.define(R,{extend:qx.ui.core.Widget,construct:function(bi,bj,bk){this.__uO={};qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.Grow);this.__uT();this.__uP={content:bi,styleInfo:bj,source:bk};qx.event.Registration.addListener(document.body,O,this.block,this,true);qx.event.Registration.addListener(document.body,K,this.release,this,true);qx.event.Registration.addListener(document.body,J,this.release,this,true);}
,events:{"loadingError":N,"messengerContent":N,"cursorContext":N,"ready":G,"readyAfterInvalid":G,"focused":G,"focusOut":G,"contextmenu":N,"undoRedoState":N},statics:{isBlockNode:function(bl){var bm=qx.ui.embed.HtmlArea.isBlockNode;var bn=bb;qx.log.Logger.deprecatedMethodWarning(bm,bn);return qx.dom.Node.isBlockNode(bl);}
,isParagraphParent:function(bo){return qx.bom.htmlarea.HtmlArea.isParagraphParent(bo);}
},properties:{contentType:{check:t,init:k,apply:T},messengerMode:{check:P,init:false,apply:h},insertParagraphOnLinebreak:{check:P,init:true,apply:ba},insertLinebreakOnCtrlEnter:{check:P,init:true,apply:X},postProcess:{check:bc,nullable:true,init:null,apply:F},useUndoRedo:{check:P,init:true,apply:j},appearance:{refine:true,init:l},defaultFontFamily:{check:t,init:W,apply:M},defaultFontSize:{check:bf,init:4,apply:E},focusable:{refine:true,init:true}},members:{__uQ:null,__uO:null,__uR:null,__uP:null,__uS:null,_initBlockerElement:function(){if(!this.__uR){this.__uR=this._createBlockerElement();}
;}
,_applyContentType:function(bp,bq){if(this.__uQ!=null){this.__uQ.setContentType(bp);}
else {this.__uO[r]=bp;}
;}
,_applyMessengerMode:function(br,bs){if(this.__uQ!=null){this.__uQ.setMessengerMode(br);}
else {this.__uO[w]=br;}
;}
,_applyInsertParagraphOnLinebreak:function(bt,bu){if(this.__uQ!=null){this.__uQ.setInsertParagraphOnLinebreak(bt);}
else {this.__uO[d]=bt;}
;}
,_applyInsertLinebreakOnCtrlEnter:function(bv,bw){if(this.__uQ!=null){this.__uQ.setInsertLinebreakOnCtrlEnter(bv);}
else {this.__uO[B]=bv;}
;}
,_applyPostProcess:function(bx,by){if(this.__uQ!=null){this.__uQ.setPostProcess(bx);}
else {this.__uO[Y]=bx;}
;}
,_applyUseUndoRedo:function(bz,bA){if(this.__uQ!=null){this.__uQ.setUseUndoRedo(bz);}
else {this.__uO[C]=bz;}
;}
,_applyDefaultFontFamily:function(bB,bC){if(this.__uQ!=null){this.__uQ.setDefaultFontFamily(bB);}
else {this.__uO[U]=bB;}
;}
,_applyDefaultFontSize:function(bD,bE){if(this.__uQ!=null){this.__uQ.setDefaultFontSize(bD);}
else {this.__uO[q]=bD;}
;}
,_applyNativeContextMenu:function(bF,bG){if(this.__uQ!=null){this.__uQ.setNativeContextMenu(bF);}
else {this.__uO[be]=bF;}
;}
,_createBlockerElement:function(){var bH=new qx.html.Element(bh);bH.setStyles({zIndex:20,position:I,display:u});if((qx.core.Environment.get(z)==y)){bH.setStyles({backgroundImage:g+qx.util.ResourceManager.getInstance().toUri(D)+f,backgroundRepeat:b});}
;return bH;}
,__uT:function(){this.addListenerOnce(L,this.__uU);}
,__uU:function(){var bI=this.getContentElement().getDomElement();this.__uQ=new qx.bom.htmlarea.HtmlArea(bI,this.__uP.content,this.__uP.styleInfo,this.__uP.source);this.__uV();this.__uW();if((qx.core.Environment.get(z)==c)){this.__va();}
;this.addListener(L,this.forceEditable);}
,__uV:function(){for(var bJ in this.__uO){this.__uQ[p+bJ](this.__uO[bJ]);}
;}
,__uW:function(){this.__uQ.addListener(m,this.__uX,this);this.__uQ.addListener(A,this.__uX,this);this.__uQ.addListener(bd,this.__uX,this);this.__uQ.addListener(i,this.__uX,this);this.__uQ.addListener(v,this.__uY,this);this.__uQ.addListener(n,this.__uY,this);this.__uQ.addListener(x,this.__uY,this);this.__uQ.addListener(a,this.__uY,this);this.__uQ.addListener(bg,this.__uY,this);}
,__uX:function(e){var bK=e.clone();this.fireEvent(bK.getType());}
,__uY:function(e){var bL=e.clone();this.fireDataEvent(bL.getType(),e.getData());}
,__va:function(){this.__uS=qx.lang.Function.bind(this.__vb,this);var bM=this.getContainerElement().getDomElement();qx.bom.Event.addNativeListener(bM,S,this.__uS);}
,__vb:qx.event.GlobalError.observeMethod(function(e){if(this.__uQ&&!this.__uQ.isDisposed()){this.__uQ.invalidateEditor();}
;}
),renderLayout:function(bN,top,bO,bP){qx.ui.core.Widget.prototype.renderLayout.call(this,bN,top,bO,bP);var bR=s;var bQ=this.getInsets();if(!this.__uR){this._initBlockerElement();}
;this.__uR.setStyles({left:bQ.left+bR,top:bQ.top+bR,width:(bO-bQ.left-bQ.right)+bR,height:(bP-bQ.top-bQ.bottom)+bR});}
,getIframeObject:function(){return this.__uQ!=null?this.__uQ.getIframeObject():null;}
,getCommandManager:function(){return this.__uQ!=null?this.__uQ.getCommandManager():null;}
,setValue:function(bS){if(this.__uQ!=null){this.__uQ.setValue(bS);}
else {this.__uP.content=bS;}
;}
,getValue:function(){if(this.__uQ!=null){return this.__uQ.getValue();}
else {return this.__uP.content;}
;}
,getComputedValue:function(bT){return this.__uQ!=null?this.__uQ.getHtml(bT):null;}
,getCompleteHtml:function(){return this.__uQ!=null?this.__uQ.getCompleteHtml():null;}
,getContentDocument:function(){return this.__uQ!=null?this.__uQ.getContentDocument():null;}
,getContentBody:function(){return this.__uQ!=null?this.__uQ.getContentBody():null;}
,getContentWindow:function(){return this.__uQ!=null?this.__uQ.getContentWindow():null;}
,getWords:function(bU){return this.__uQ!=null?this.__uQ.getWords(bU):null;}
,getWordsWithElement:function(){return this.__uQ!=null?this.__uQ.getWordsWithElement():null;}
,getTextNodes:function(){return this.__uQ!=null?this.__uQ.getTextNodes():null;}
,isReady:function(){return this.__uQ!=null?this.__uQ.isReady():false;}
,forceEditable:function(){if(this.__uQ!=null){this.__uQ.forceEditable();}
;}
,isLoaded:function(){return this.__uQ!=null?this.__uQ.isLoaded():false;}
,setEditable:function(bV){if(this.__uQ!=null){this.__uQ.setEditable(bV);}
;}
,getEditable:function(){return this.__uQ!=null?this.__uQ.getEditable():false;}
,isEditable:function(){return this.__uQ!=null?this.__uQ.isEditable():false;}
,insertHtml:function(bW){return this.__uQ!=null?this.__uQ.insertHtml(bW):false;}
,removeFormat:function(){return this.__uQ!=null?this.__uQ.removeFormat():false;}
,setBold:function(){return this.__uQ!=null?this.__uQ.setBold():false;}
,setItalic:function(){return this.__uQ!=null?this.__uQ.setItalic():false;}
,setUnderline:function(){return this.__uQ!=null?this.__uQ.setUnderline():false;}
,setStrikeThrough:function(){return this.__uQ!=null?this.__uQ.setStrikeThrough():false;}
,setFontSize:function(bX){return this.__uQ!=null?this.__uQ.setFontSize(bX):false;}
,setFontFamily:function(bY){return this.__uQ!=null?this.__uQ.setFontFamily(bY):false;}
,setTextColor:function(ca){return this.__uQ!=null?this.__uQ.setTextColor(ca):false;}
,setTextBackgroundColor:function(cb){return this.__uQ!=null?this.__uQ.setTextBackgroundColor(cb):false;}
,setJustifyLeft:function(){return this.__uQ!=null?this.__uQ.setJustifyLeft():false;}
,setJustifyCenter:function(){return this.__uQ!=null?this.__uQ.setJustifyCenter():false;}
,setJustifyRight:function(){return this.__uQ!=null?this.__uQ.setJustifyRight():false;}
,setJustifyFull:function(){return this.__uQ!=null?this.__uQ.setJustifyFull():false;}
,insertIndent:function(){return this.__uQ!=null?this.__uQ.insertIndent():false;}
,insertOutdent:function(){return this.__uQ!=null?this.__uQ.insertOutdent():false;}
,insertOrderedList:function(){return this.__uQ!=null?this.__uQ.insertOrderedList():false;}
,insertUnorderedList:function(){return this.__uQ!=null?this.__uQ.insertUnorderedList():false;}
,insertHorizontalRuler:function(){return this.__uQ!=null?this.__uQ.insertHorizontalRuler():false;}
,insertImage:function(cc){return this.__uQ!=null?this.__uQ.insertImage(cc):false;}
,insertHyperLink:function(cd){return this.__uQ!=null?this.__uQ.insertHyperLink(cd):false;}
,removeBackgroundColor:function(){return this.__uQ!=null?this.__uQ.removeBackgroundColor():false;}
,setBackgroundColor:function(ce){return this.__uQ!=null?this.__uQ.setBackgroundColor(ce):false;}
,removeBackgroundImage:function(){return this.__uQ!=null?this.__uQ.removeBackgroundImage():false;}
,setBackgroundImage:function(cf,cg,ch){return this.__uQ!=null?this.__uQ.setBackgroundImage(cf,cg,ch):false;}
,selectAll:function(){return this.__uQ!=null?this.__uQ.selectAll():false;}
,undo:function(){return this.__uQ!=null?this.__uQ.undo():false;}
,redo:function(){return this.__uQ!=null?this.__uQ.redo():false;}
,resetHtml:function(){if(this.__uQ!=null){this.__uQ.resetHtml();}
;}
,getHtml:function(ci){return this.__uQ!=null?this.__uQ.getHtml(ci):null;}
,containsOnlyPlaceholder:function(){return this.__uQ!=null?this.__uQ.containsOnlyPlaceHolder():false;}
,getContextInformation:function(){return this.__uQ!=null?this.__uQ.getContextInformation():null;}
,getSelection:function(){return this.__uQ!=null?this.__uQ.getSelection():null;}
,getSelectedText:function(){return this.__uQ!=null?this.__uQ.getSelectedText():null;}
,getSelectedHtml:function(){return this.__uQ!=null?this.__uQ.getSelectedHtml():null;}
,clearSelection:function(){if(this.__uQ!=null){this.__uQ.clearSelection();}
;}
,getRange:function(){return this.__uQ.getRange();}
,saveRange:function(){this.__uQ.saveRange();}
,getSavedRange:function(){return this.__uQ.getSavedRange();}
,resetSavedRange:function(){this.__uQ.resetSavedRange();}
,getFocusNode:function(){return this.__uQ!=null?this.__uQ.getFocusNode():null;}
,block:function(){if(!this.__uR){this._initBlockerElement();}
;if(!this.getContainerElement().hasChild(this.__uR)){this.getContainerElement().add(this.__uR);}
;this.__uR.setStyle(Q,V);}
,release:function(){if(this.__uR){this.__uR.setStyle(Q,u);}
;}
,focus:function(){qx.ui.core.Widget.prototype.focus.call(this);this.__vc();}
,tabFocus:function(){qx.ui.core.Widget.prototype.tabFocus.call(this);this.__vc();}
,__vc:function(){if(this.__uQ!=null){qx.event.Timer.once(function(){this.__uQ.focusContent();}
,this,0);}
;}
},destruct:function(){this.__uO=this.__uP=null;qx.event.Registration.removeListener(document.body,O,this.block,this,true);qx.event.Registration.removeListener(document.body,K,this.release,this,true);qx.event.Registration.removeListener(document.body,J,this.release,this,true);var cj=this.getContainerElement().getDomElement();if(cj){qx.bom.Event.removeNativeListener(cj,S,this.__uS);}
;this._disposeObjects(o,H);}
});}
)();
(function(){var dV="qx.blankpage",dU='</span>',dT="backgroundColor",dS="li",dR='undo',dQ="<br class='webkit-block-placeholder' />",dP="Function",dO="fontSize",dN="textcolor",dM="cant open document on source '",cu="home",ct="<",cs="focused",cr="fontFamily",cq="load",cp='document not available, try again...',co='<font ',cn='id="__elementToFocus__"',cl="setUnderline",ck="backgroundPosition",ed="<!--",ee=' size="',eb='/www.w3.org/1999/xhtml" xml:lang="en" lang="en">',ec="'>",dY='underline',ea='bold',dW="&copy;",dX="ul",ef="cursorContext",eg="readyAfterInvalid",dr="styleWithCSS",dq="span",dt=" />",ds="setBold",dv="<P>&nbsp;</P>",du="</",dx="textbackgroundcolor",dw="&gt;",dp='="',dn="can't extract style from elem. ",o="paddingLeft",p='size',q="inserthorizontalrule",r='<p>',t='</font>',u="__vd",v="backgroundRepeat",w="insertimage",x="a",y="&amp;",ev="removeformat",eu="marginLeft",et="ready",es="<p>&nbsp;</p>",eA='DOCTYPE html PUBLIC "-/',ez="browser.version",ey=" html, body {overflow-x: visible; } ",ew='<body>',eC="insertorderedlist",eB='body { font-size:100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; background-color:transparent; overflow:visible; background-image:none; margin:0px; padding:5px; } ',br="hideFocus",bs="none",bp='/DTD XHTML 1.0 Transitional/',bq='<html xmlns="http:/',bv="outline",bw="setItalic",bt="font-style",bu="marginBottom",bn="xhtml",bo="focusOut",S="justifyleft",R="handleMouse ",U='</p>',T="paddingTop",O="Please use the method 'qx.dom.Node.isBlockNode' instead.",N='<title></title><meta http-equiv="Content-type" content="text/html; charset=UTF-8" />',Q="Control",P='<span style="font-family:',M='/W3C/',L="placeholder",bC='cant load HtmlArea. Document is not available. ',bD="backgroundImage",bE="marginTop",bF="> ",by=" { ",bz="font-weight",bA="LI",bB='italic',bG='<!',bH="\ufeff",bg="&quot;",bf="marginRight",be="STYLE",bd="justifyfull",bc="inserthyperlink",bb="<br />",ba='html { margin:0px; padding:0px; } ',Y="<br>",bk='/EN" "http:/',bj="justifycenter",bI="<br /><div id='placeholder'></div>",bJ="useCSS",bK="object",bL="strikethrough",bM="text/html",bN="true",bO="1.9",bP='',bQ=' style="',bR="indent",cC="messengerContent",cB="Integer",cA="insertunorderedlist",cz="Text",cG="&lt;",cF='<br _moz_editor_bogus_node="TRUE" _moz_dirty=""/>',cE='<br/><div class="placeholder"></div>',cD="selectall",cK="transparent",cJ=" SCRIPT STYLE DIV SPAN TR TD TBODY TABLE EM STRONG FONT A P B I U STRIKE H1 H2 H3 H4 H5 H6 ",di="justifyright",dj='/www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',dg="ol",dh="//text()[string-length(normalize-space(.))>0]",de="outdent",df="about:blank",dc="<body style='",dd="qx.bom.htmlarea.HtmlArea",dk="paddingBottom",dl="Verdana",dB="$",dA="-->",dD=" }",dC="paddingRight",dF='html { width:100%; height:100%; margin:0px; padding:0px; overflow-y:auto; overflow-x:auto; } ',dE="Off",dH='p { margin:0px; padding:0px; }',dG='body { font-size: 100.01%; font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; width:100%; height:100%; background-color:transparent; overflow:auto; background-image:none; margin:0px; padding:5px; } ',dz="pageup",dy="backgroundcolor",eo="Failed to enable rich edit functionality",ep="end",eq="div",er='On',ej="redo",ek="i",em="backspace",en="bold",eh="mouseup",ei="y",n="style",m="backgroundimage",l="100%",k='</head>',h='<head>',g="k",f=":",d='redo',c='Off',b='">',B="down",C="font-family",z="g",A="keypress",F="fontsize",G="undo",D="text-decoration",E="pagedown",I="justify",J="center",cO="p",cI='</style>',cV="u",cR=" | ",cx="focus",cv="control",W="click",cy='<style type="text/css">',bi="up",bh="blur",cc="font-size",cd="None",ce="delete",cf="_moz_dirty",cg=">",ch='</body></html>',ci="line-through",cj="String",bY="z",ca=";",cw="fontfamily",cU="keydown",cT="keyup",cS="focusout",da="engine.version",cY="inserthtml",cX="italic",cW="body",cQ="underline",cP="br",H="old_id",bm="'",bl="b",cH="loadingError",bx="contextmenu",cN="right",cM="enter",cL='"',V="left",db="text-align",K="qx.bom.htmlarea.HtmlArea.debug",X="qx.event.type.Data",bS="opera",bT="id",bU="qx.event.type.Event",bV=" ",bW="Boolean",bX="__elementToFocus__",dm="qx.debug",cb="webkit",dJ="gecko",dI="mshtml",dL="",dK="engine.name";qx.Class.define(dd,{extend:qx.core.Object,construct:function(eD,eE,eF,eG){qx.core.Object.call(this);var eH=eG||qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(dV));this.__wj(eD);this.__wk();this._createAndAddIframe(eH);this._addIframeLoadListener();this.__vQ=qx.bom.htmlarea.HtmlArea.__vS(eF);if(qx.lang.Type.isString(eE)){this.__vR=eE;}
;this.__vd=this.__wx();}
,events:{"load":bU,"loadingError":X,"messengerContent":X,"cursorContext":X,"ready":bU,"readyAfterInvalid":bU,"focused":bU,"focusOut":bU,"contextmenu":X,"undoRedoState":X},statics:{simpleLinebreak:Y,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:ds},italic:{method:bw},underline:{method:cl},undo:{method:G},redo:{method:ej}},__vS:function(eI){if(eI==null||eI==dL){return dL;}
else if(typeof eI==bK){var eJ=dL;for(var i in eI){eJ+=i+by+eI[i]+dD;}
;return eJ;}
else {return eI;}
;}
,__vT:function(eK){var eL={};var a=eK.split(ca);var i;for(i=0;i<a.length;i++){var eM=a[i],eN=eM.indexOf(f);if(eN===-1){continue;}
...
;}
;return eL;}
,__vU:function(eP,eQ,eR,eS){var eX=[];switch(eP.nodeType){case 1:case 11:var i;var eV=eP.tagName.toLowerCase();var fa={};var eT={};var closed=(!(eP.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__vV(eP)));if(eQ){if((qx.core.Environment.get(dK)==dI)){if(eV==eq&&eP.className&&eP.className==L){for(i=eP.firstChild;i;i=i.nextSibling){eX.push(qx.bom.htmlarea.HtmlArea.__vU(i,true,eR,eS));}
;return eX.join(dL);}
;}
...
;fa[name]=fb;}
;if(fa.style!==undefined){eT=qx.bom.htmlarea.HtmlArea.__vT(fa.style);delete fa.style;}
...
;}
;for(i=eP.firstChild;i;i=i.nextSibling){eX.push(qx.bom.htmlarea.HtmlArea.__vU(i,true,eR,eS));}
;if(eQ&&!closed&&eV){eX.push(du,eV,cg);}
;break;case 3:eX.push(eR?eP.data:qx.bom.htmlarea.HtmlArea.__vW(eP.data));break;case 8:eX.push(ed,eP.data,dA);break;};return eX.join(dL);}
,closingTags:cJ,__vV:function(fc){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(bV+fc.tagName+bV)!=-1);}
,__vW:function(s){s=s.replace(/&/ig,y);s=s.replace(/</ig,cG);s=s.replace(/>/ig,dw);s=s.replace(/\x22/ig,bg);s=s.replace(/\xA9/ig,dW);return s;}
,isBlockNode:function(fd){var fe=qx.bom.htmlarea.HtmlArea.isBlockNode;var ff=O;qx.log.Logger.deprecatedMethodWarning(fe,ff);return qx.dom.Node.isBlockNode(fd);}
...
},properties:{contentType:{check:cj,init:bn},messengerMode:{check:bW,init:false},insertParagraphOnLinebreak:{check:bW,init:true},insertLinebreakOnCtrlEnter:{check:bW,init:true},postProcess:{check:dP,nullable:true,init:null},useUndoRedo:{check:bW,init:true},nativeContextMenu:{check:bW,init:false},defaultFontFamily:{check:cj,init:dl},defaultFontSize:{check:cB,init:4}},members:{__kq:null,__he:false,__vX:false,__vY:false,__wa:false,__wb:false,__vd:null,__wc:null,__wd:null,__we:null,__rM:null,__vQ:null,__wf:null,__wg:null,__wh:false,__wi:false,__wj:function(fj){if(qx.dom.Node.isElement(fj)&&qx.dom.Node.isNodeName(fj,eq)){this.__kq=fj;}
;}
,_createAndAddIframe:function(fk){this.__rM=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__rM,fk);if((qx.core.Environment.get(dK)==dI)){qx.bom.element.Attribute.set(this.__rM,br,bN);}
else {qx.bom.element.Style.set(this.__rM,bv,bs);}
...
,__wk:function(){this.__wf={"xhtml":{doctype:bG+eA+M+bp+bk+dj,html:bq+eb,meta:N,style:qx.core.Environment.select(dK,{"mshtml":ba+dG,"default":dF+eB}),contentStyle:dH,body:ew,footer:ch}};}
,__vR:dL,getIframeObject:function(){return this.__rM;}
,getCommandManager:function(){return this.__vd;}
,setValue:function(fl){if(qx.lang.Type.isString(fl)){this.__vR=fl;var fm=this._getIframeDocument();if(fm&&fm.body){fm.body.innerHTML=this.__wl(fl);}
;}
;}
,__wl:function(fn){var fq=dL;if((qx.core.Environment.get(dK)==dJ)){if(qx.core.Environment.get(ez)<=2){fq+=cF;}
;}
;var fr=fn.length==0?bH:dL;var fp=qx.core.Environment.get(dK)==dJ||qx.core.Environment.get(dK)==cb?cn:bP;var fo=r+P+this.getDefaultFontFamily()+b+co+fp+ee+this.getDefaultFontSize()+b+fq+fn+fr+t+dU+U;return fo;}
,getValue:function(){return this.__vR;}
,getComputedValue:function(fs){return this.getHtml(fs);}
,getCompleteHtml:function(){var fu=this.__wf[this.getContentType()];var ft=fu.html+h+fu.meta+cy+fu.contentStyle+cI+k;ft+=dc+this.__wm()+ec;ft+=this.getHtml()+ch;return ft;}
,__wm:function(){var fx=[dT,bD,v,ck,cr,dO,bE,bu,eu,bf,T,dk,o,dC];var fw=qx.bom.element.Style;var fv=this.getContentBody();var fA={};var fz,fB;var fy=qx.core.Environment.get(dK)==dI?2:1;for(var i=0,j=fx.length;i<j;i++){fz=fx[i];fB=fw.get(fv,fz,fy);if(fB!==undefined&&fB!=dL){fA[fz]=fB;}
;}
...
;}
;return fR;}
,__wn:0,__wo:function(){var fS=this._getIframeDocument();if(!fS){this.__wn++;if(this.__wn>5){this.error(bC+fS);this.fireDataEvent(cH);}
else {if(qx.core.Environment.get(dm)){this.error(cp);}
;qx.event.Timer.once(function(){this.__wo();}
,this,0);}
;}
else {this.__wn=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__vY){return;}
;if(this.__vX){this.__wp();return;}
;if((qx.core.Environment.get(dK)==dI)){this.__wo();}
...
;this.__vY=true;if((qx.core.Environment.get(dK)==dI)){this.setEditable(true);}
;this.__ws();if(!(qx.core.Environment.get(dK)==bS)){this.__wt();}
;if(!(qx.core.Environment.get(dK)==dI)){this.setEditable(true);}
;this.__he=true;this.__vd=fT;fT.setContentDocument(this._getIframeDocument());this.__wy();if((qx.core.Environment.get(dK)==bS)){this.__wt();}
;this.fireEvent(et);}
...
else {fU.body.contentEditable=true;this.__wz(true);}
;}
;}
,"default":qx.lang.Function.empty}),invalidateEditor:qx.core.Environment.select(dK,{"gecko":function(){this.__vY=false;this.__he=false;this.__vX=true;}
,"default":function(){}
}),__wp:qx.core.Environment.select(dK,{"gecko":function(){this.__ws();this.__wt();this.__vd.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__vY=true;this.__he=true;this.__vX=false;this.fireEvent(eg);}
,"default":function(){}
}),__wq:function(fV){var fX=dL;if(!fV){return fX;}
...
;return fX;}
,__wr:function(ga){var gb=qx.core.Environment.get(dK)==dJ?ey:dL;var gc=this.__wf[this.getContentType()];var gd=h+gc.meta+cy+gb+gc.style+gc.contentStyle+this.__vQ+cI+k;var content=gc.body+ga;return gc.html+gd+content+gc.footer;}
,__ws:function(){var gf=this.__wl(this.getValue());if(qx.lang.Type.isString(gf)){var ge=this._getIframeDocument();try{ge.open(bM,true);ge.write(this.__wr(gf));ge.close();}
catch(e){this.error(dM+qx.bom.Iframe.queryCurrentUrl(this.__rM)+bm,e);this.fireDataEvent(cH,e);}
;}
;}
,__wt:function(){this.__wu();this.__ww();this.__wv();}
,__wu:function(){var gh=qx.event.Registration;var gg=this._getIframeDocument();gh.addListener(gg.body,A,this._handleKeyPress,this);gh.addListener(gg.body,cT,this._handleKeyUp,this);gh.addListener(gg.body,cU,this._handleKeyDown,this);}
,__wv:function(){var gk=qx.event.Registration;var gi=this._getIframeDocument();var gj=qx.core.Environment.get(dK)==cb?this._getIframeWindow():gi.body;gk.addListener(gj,cx,this._handleFocusEvent,this);gk.addListener(gj,bh,this._handleBlurEvent,this);gk.addListener(gi,cS,this._handleFocusOutEvent,this);}
,__ww:function(){var gn=qx.event.Registration;var gm=this._getIframeDocument();var gl=qx.core.Environment.get(dK)==dI?W:eh;gn.addListener(gm.body,gl,this._handleMouseUpOnBody,this);gn.addListener(gm.documentElement,gl,this._handleMouseUpOnDocument,this);gn.addListener(gm.documentElement,bx,this._handleContextMenuEvent,this);}
,__wx:function(){if(this.__wc==null){this.__wc={execute:function(go,gp){this.stackedCommands=true;this.commandStack.push({command:go,value:gp});}
,commandStack:[],stackedCommands:false};}
;this.__wc.stackedCommands=false;return this.__wc;}
,__wy:function(){var gq=this.__wc;if(gq!=null&&gq.stackedCommands){var gr=gq.commandStack;if(gr!=null){for(var i=0,j=gr.length;i<j;i++){this.__vd.execute(gr[i].command,gr[i].value);}
;}
;}
;}
,__wz:function(gs){var gt=this._getIframeDocument();if(this.__vY&&gt){try{if((qx.core.Environment.get(dK)==dJ)){gt.designMode=(gs!==false)?c:er;}
;gt.designMode=(gs!==false)?er:c;}
catch(e){}
;}
;}
,setEditable:function(gu){if(this.__vY){this.__wz(true);if((qx.core.Environment.get(dK)==dJ)){try{var gv=this._getIframeDocument();gv.execCommand(dr,false,true);}
...
;this.__wa=gu;}
;}
,getEditable:function(){return this.__wa;}
,isEditable:function(){return this.__wa;}
,__wA:false,_handleKeyUp:function(e){var gy=e.getKeyIdentifier().toLowerCase();this.__wd=e;if((qx.core.Environment.get(dm))&&qx.core.Environment.get(K)){this.debug(e.getType()+cR+gy);}
;if(qx.core.Environment.get(dK)==dI||qx.core.Environment.get(dK)==cb){if(this.__wA){switch(gy){case cM:if(this.getInsertLinebreakOnCtrlEnter()){if((qx.core.Environment.get(dK)==cb)){this.__wB();e.preventDefault();e.stopPropagation();}
else {var gz=this.__wL(this.getSelection());if(gz){gz.collapse(true);gz.pasteHTML(cE);}
;}
;this.__wG();}
;break;case cv:this.__wA=false;return;break;};}
;}
else if((qx.core.Environment.get(dK)==dJ)){switch(gy){case V:case cN:case bi:case B:case dz:case E:case ce:case ep:case em:this.__wb=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__wB:function(){var gA=this.getSelection();var gB=dL;if(gA&&(gA.focusNode.textContent==dL||gA.focusNode.parentElement.tagName==bA)){gB=dQ;}
;this.__vd.execute(cY,gB+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
...
;if(this.__wA&&(gC==bY||gC==ei||gC==bl||gC==cV||gC==ek||gC==g)){e.preventDefault();e.stopPropagation();}
;if(gC==cv){this.__wA=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var gH=this.getContentDocument();var gD=e.getKeyIdentifier().toLowerCase();var gF=e.isCtrlPressed();var gG=e.isShiftPressed();this.__wd=e;if((qx.core.Environment.get(dm))&&qx.core.Environment.get(K)){this.debug(e.getType()+cR+gD);}
;if(this.__wh){var gN=!((qx.core.Environment.get(dK)==dI)&&gD==cM)||!((qx.core.Environment.get(dK)==dJ)&&gD==cM);if(gN){this.__wG();this.__wh=false;}
;}
...
;e.preventDefault();e.stopPropagation();if((qx.core.Environment.get(dK)==dJ)){if(this.__wJ()){this.insertHtml(bb);this.__wG();return;}
;this.insertHtml(bI);}
else if((qx.core.Environment.get(dK)==bS)){var gM=this.getSelection();var gI=this.__wL(gM);if(gM&&gI){var gJ=gH.createElement(cP);gI.collapse(true);gI.insertNode(gJ);gI.collapse(true);gI.selectNode(gJ);gM.addRange(gI);gI.collapse(true);}
;}
;this.__wG();}
;if((qx.core.Environment.get(dK)==dI)){if(!this.getInsertParagraphOnLinebreak()){if(this.__vd.execute(cY,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__wG();e.preventDefault();e.stopPropagation();}
;}
;}
else if((qx.core.Environment.get(dK)==dJ)){if(this.getInsertParagraphOnLinebreak()&&!gG&&!gF){var gM=this.getSelection();if(gM){var gE=gM.focusNode;if(this.__wJ()){this.__wG();return;}
;if(this.__wK()){this.__wG();return;}
;while(!qx.dom.Node.isNodeName(gE,cW)){if(qx.dom.Node.isNodeName(gE,dS)){this.__wG();return;}
;gE=gE.parentNode;}
;}
;this.__vd.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__wG();this.__wh=true;}
;}
else if((qx.core.Environment.get(dK)==cb)){if(this.getInsertParagraphOnLinebreak()&&gG){this.__wB();e.preventDefault();e.stopPropagation();this.__wG();}
;}
;;break;case bi:if(qx.core.Environment.get(dK)==dJ&&qx.core.Environment.get(da)<1.9&&gG){var gM=this.getSelection();if(gM&&gM.focusNode==gH.body.firstChild){if(this.__wb){if(gM.focusOffset!=0){gM.extend(gM.focusNode,0);}
;}
;}
;}
;this.__wG();break;case cu:if(qx.core.Environment.get(dK)==dJ&&qx.core.Environment.get(da)<1.9){if(gF){var gM=this.getSelection();if(gG){if(gM&&(gM.focusOffset!=0)||(gM.focusNode!=gH.body.firstChild)){gM.extend(gH.body.firstChild,0);}
;}
...
;}
;}
;this.__wG();break;case V:case cN:case B:case dz:case E:case ce:case ep:case em:this.__wG();break;case bl:if(gF){this.__wC(ea,true);}
;break;case ek:case g:if(gF){this.__wC(bB,true);}
;break;case cV:if(gF){this.__wC(dY,true);}
;break;case bY:if(gF&&!gG){this.__wC(dR,true);}
else if(gF&&gG){this.__wC(d,true);}
;break;case ei:if(gF){this.__wC(d,true);}
;break;case x:if(gF){this.selectAll();}
;break;};this.__wd=null;}
,__wC:function(gO,gP){var gR=null;var gQ=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(gQ[gO]){gR=gQ[gO].method;}
;if(gR!=null&&this[gR]){this[gR]();if(gP){this.__wd.preventDefault();this.__wd.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__wh=true;}
;this.__wG();}
;}
,_handleFocusEvent:function(e){this.__we=null;if(qx.core.Environment.get(dK)==dJ||qx.core.Environment.get(dK)==cb){var gS=this.getContentDocument().getElementById(bX);if(gS){qx.bom.element.Attribute.reset(gS,bT);}
;}
;this.fireEvent(cs);}
,_handleBlurEvent:function(e){this.__vR=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__wA=false;if(this.__we==null){this.__we=this.getSelectedHtml();}
;this.fireEvent(bo);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(dm))&&qx.core.Environment.get(K)){this.debug(R+e.getType());}
;this.__wi=true;this.__wG();}
,_handleMouseUpOnDocument:qx.core.Environment.select(dK,{"mshtml":qx.lang.Function.empty,"default":function(e){if(!this.__wi){qx.bom.Element.activate(this.getContentBody());}
;this.__wi=false;}
...
,this,0);}
;}
,isLoaded:function(){return this.__vY;}
,insertHtml:function(gY){return this.__vd.execute(cY,gY);}
,removeFormat:function(){var ha=this.__vd.execute(ev);this.__vd.execute(F,this.getDefaultFontSize());this.__vd.execute(cw,this.getDefaultFontFamily());return ha;}
,setBold:function(){return this.__vd.execute(en);}
,setItalic:function(){return this.__vd.execute(cX);}
,setUnderline:function(){return this.__vd.execute(cQ);}
,setStrikeThrough:function(){return this.__vd.execute(bL);}
,setFontSize:function(hb){return this.__vd.execute(F,hb);}
,setFontFamily:function(hc){return this.__vd.execute(cw,hc);}
,setTextColor:function(hd){return this.__vd.execute(dN,hd);}
,setTextBackgroundColor:function(he){return this.__vd.execute(dx,he);}
,setJustifyLeft:function(){return this.__vd.execute(S);}
,setJustifyCenter:function(){return this.__vd.execute(bj);}
,setJustifyRight:function(){return this.__vd.execute(di);}
,setJustifyFull:function(){return this.__vd.execute(bd);}
,insertIndent:function(){return this.__vd.execute(bR);}
,insertOutdent:function(){return this.__vd.execute(de);}
,insertOrderedList:function(){return this.__vd.execute(eC);}
,insertUnorderedList:function(){return this.__vd.execute(cA);}
,insertHorizontalRuler:function(){return this.__vd.execute(q);}
,insertImage:function(hf){return this.__vd.execute(w,hf);}
,insertHyperLink:function(hg){return this.__vd.execute(bc,hg);}
,removeBackgroundColor:function(){this.__vd.execute(dy,cK);}
,setBackgroundColor:function(hh){this.__vd.execute(dy,hh);}
,removeBackgroundImage:function(){this.__vd.execute(m);}
,setBackgroundImage:function(hi,hj,hk){return this.__vd.execute(m,[hi,hj,hk]);}
,selectAll:function(){return this.__vd.execute(cD);}
,undo:function(){if(this.getUseUndoRedo()){return this.__vd.execute(G);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__vd.execute(ej);}
else {return true;}
;}
,resetHtml:function(){var hl=this._getIframeDocument();while(hl.body.firstChild){hl.body.removeChild(hl.body.firstChild);}
;if(qx.core.Environment.get(dK)==dJ){hl.body.innerHTML=es;}
...
;return qx.bom.htmlarea.HtmlArea.__vU(hp.body,false,ho,this.getPostProcess());}
...
;this.__wD();}
,"opera":function(){qx.bom.Element.focus(this.getContentWindow());qx.bom.Element.focus(this.getContentBody());this.__wD();}
,"default":function(){qx.bom.Element.focus(this.getContentBody());this.__wD();}
}),__wD:function(){if(!this.__wE()){this.__wF();}
;}
,__wE:qx.core.Environment.select(dK,{"gecko":function(){var hx=this.getContentBody().childNodes;if(hx.length==0){return false;}
...
;}
}),__wF:qx.core.Environment.select(dK,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__wl(dL);var hA=this.getContentDocument().getElementById(bX);qx.bom.element.Attribute.reset(hA,bT);this._selectElement(hA);}
...
;}
}),getContextInformation:function(){return this.__wH();}
,__wG:function(){qx.event.Timer.once(function(e){var hC=this.__wH();this.fireDataEvent(ef,hC);}
,this,200);}
,__wH:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return;}
;this._processingExamineCursorContext=true;if(!this.__wE()){this.__wF();}
...
else {hD=hT.getPropertyValue(bt)==cX;hI=hT.getPropertyValue(D).indexOf(cQ)!==-1;hH=hT.getPropertyValue(D).indexOf(ci)!==-1;hR=hT.getPropertyValue(cc);hM=hT.getPropertyValue(C);hJ=hT.getPropertyValue(db)==V;hU=hT.getPropertyValue(db)==J;hF=hT.getPropertyValue(db)==cN;hQ=hT.getPropertyValue(db)==I;}
...
}),getSelectedHtml:function(){if(this.__we!=null){return this.__we;}
;var hW=this.getRange();if(!hW){return dL;}
else {return this.__wI(hW);}
;}
,__wI:qx.core.Environment.select(dK,{"mshtml":function(hX){if(!hX){return dL;}
...
;}
}),__wJ:qx.core.Environment.select(dK,{"gecko":function(){var ig=this.getSelection();var ih=this.getFocusNode();return ig&&this.isSelectionCollapsed()&&ih!=null&&qx.dom.Node.isText(ih)&&ig.anchorOffset<ih.length;}
,"default":function(){return false;}
}),__wK:qx.core.Environment.select(dK,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());}
,"default":function(){return false;}
}),getRange:function(){return this.__wL(this.getSelection());}
,__wL:qx.core.Environment.select(dK,{"mshtml":function(ii){var ij=this._getIframeDocument();if(ii){try{return ii.createRange();}
...
;}
}),saveRange:qx.core.Environment.select(dK,{"mshtml":function(){this.__wg=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(dK,{"mshtml":function(){return this.__wg;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(dK,{"mshtml":function(){this.__wg=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(dK,{"mshtml":function(){var ip=this.getSelection();var iq;switch(ip.type){case cz:case cd:iq=this.__wL(ip);if(iq){iq.collapse(false);return iq.parentElement();}
else {return null;}
;break;case Q:iq=this.__wL(ip);if(iq){try{iq.collapse(false);}
catch(ir){}
;return iq.item(0);}
else {return null;}
...
;if(this.__vd instanceof qx.core.Object){this._disposeObjects(u);}
else {this.__vd=null;}
;this.__wf=this.__rM=this.__kq=this.__wc=null;}
});}
)();
...
(function(){var cL="backgroundColor",cK="_moz",cJ="__xg",cI="__xt",cH="url(",cG="formatBlock",cF="insertParagraph",cE=" succeded",cD="li",cC='<span style="',bM="underline",bL="' is not allowed for parameter 'position'. Possible values are '",bK="no-repeat",bJ="__xv",bI=' <a href="',bH="FONT",bG="inserthyperlink failed!",bF="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",bE="__placeholder__",bD="JustifyCenter",cS="Cut",cT="outdent",cQ='</a> ',cR="InsertImage",cO="__xx",cP="__resetHtml",cM="FontName",cN="bold",cU="__xh",cV="blockquote",cl="If an array is provided for parameter 'position' it has to define two elements!",ck="style",cn="The method '",cm="qx.bom.htmlarea.manager.Command",cp="__xy",co="'><br class='webkit-block-placeholder' />",cr="a",cq='"',cj="<span></span>",ci="__xp",p="type",q="CreateLink",r="':'",s="italic",t="' you calling to execute the command '",u=")",v="qx_link",w="__wW",x="none",y='"></span>',dk="Italic",dj="fontStyle",di="__xq",dh=" failed",dp="InsertUnorderedList",dn="OL",dm='text-align:',dl="Bold",dr="ForeColor",dq='" ',bd="repeat repeat-x repeat-y no-repeat",be='</p>',bb="<hr />",bc="__xA",bh="top",bi="editor not ready! '",bf="__xz",bg='<font style="',Y="Command ",ba="IMG",L="__xr",K='<p id="',N="StrikeThrough",M="LI",H="__getHtml",G='>',J='font-family:',I='" size="',F="Indent",E="HiliteColor",bn="br",bo="fontWeight",bp="Copy",bq="</span>",bj="Paste",bk="__xs",bl="RemoveFormat",bm="JustifyRight",br="' is not allowed for parameter 'repeat'. Possible values are '",bs='',V='style="',U="' is not available!",T="_moz_dirty",S="color",R="JustifyLeft",Q=" is currently not supported!",P="Underline",O="SelectAll",X="<p style='",W="line-through",bt="__xe",bu="href",bv='<span id="',bw="UL",bx="JustifyFull",by="Outdent",bz="indent",bA="__xu",bB="selectall",bC="InsertOrderedList",bQ="<img ",bP="</font>",bO="/>",bN="backgroundPosition",bU="font-size",bT='|',bS="string",bR="background-color",bW="backgroundRepeat",bV="font",ce=":",cf="='",cc=" with value ",cd=";",ca="body",cb="px",bX="__xc",bY="backgroundImage",cg="Control",ch="__paragraph__",cv=':',cu="The value '",cx="qx.bom.htmlarea.HtmlArea.debug",cw="size",cz="' ",cy="webkit",cB="execCommand ",cA="textDecoration",ct="BODY",cs=" ",dd="undefined",de="transparent",df="id",dg="InsertHtml",cY='">',da="font-family",db="child",dc="gecko",cW="text-align",cX='text-decoration',o="BackColor",n="FontSize",m="'",h=';',g="p",f="span",d="__xb",c='color',b="text-decoration",a="inserthtml",B="qx.debug",C="mshtml",z="legacy-font-size",A="",D="engine.name";qx.Class.define(cm,{extend:qx.core.Object,construct:function(ds){qx.core.Object.call(this);this.__ve=ds;this.__kp=null;this._commands=null;this.__vG();this.__wM={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__wN=[10,12,16,18,24,32,48];this.__wO=0;}
,statics:{__wP:bF,__wQ:bd},members:{__kp:null,__ve:null,__wR:false,__wM:null,__wN:null,__wO:null,setContentDocument:function(dt){this.__kp=dt;}
,getCommandObject:function(du){if(this._commands[du]){return this._commands[du];}
else {return null;}
;}
,__vG:function(){this._commands={bold:{useBuiltin:false,identifier:dl,method:cO},italic:{useBuiltin:false,identifier:dk,method:cp},underline:{useBuiltin:false,identifier:P,method:bf},strikethrough:{useBuiltin:false,identifier:N,method:bc},fontfamily:{useBuiltin:true,identifier:cM,method:null},fontsize:{useBuiltin:false,identifier:n,method:ci},textcolor:{useBuiltin:true,identifier:dr,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:di},backgroundcolor:{useBuiltin:false,identifier:null,method:L},backgroundimage:{useBuiltin:false,identifier:null,method:bk},justifyleft:{useBuiltin:false,identifier:R,method:d},justifyright:{useBuiltin:false,identifier:bm,method:d},justifycenter:{useBuiltin:false,identifier:bD,method:d},justifyfull:{useBuiltin:false,identifier:bx,method:d},indent:{useBuiltin:true,identifier:F,method:null},outdent:{useBuiltin:true,identifier:by,method:null},copy:{useBuiltin:true,identifier:bp,method:null},cut:{useBuiltin:true,identifier:cS,method:null},paste:{useBuiltin:true,identifier:bj,method:null},insertorderedlist:{useBuiltin:false,identifier:bC,method:bX},insertunorderedlist:{useBuiltin:false,identifier:dp,method:bX},inserthorizontalrule:{useBuiltin:false,identifier:dg,method:cU},insertimage:{useBuiltin:false,identifier:cR,method:bt},inserthyperlink:{useBuiltin:false,identifier:q,method:cJ},selectall:{useBuiltin:false,identifier:O,method:cI},selectedtext:{useBuiltin:false,identifier:null,method:bA},selectedhtml:{useBuiltin:false,identifier:null,method:bJ},inserthtml:{useBuiltin:false,identifier:dg,method:w},resethtml:{useBuiltin:false,identifier:null,method:cP},gethtml:{useBuiltin:false,identifier:null,method:H},removeformat:{useBuiltin:true,identifier:bl,method:null}};}
,execute:function(dv,dw){if(!this.__ve.isReady()){this.error(bi+dv+r+dw+m);return false;}
;dv=dv.toLowerCase();dw=dw!=null?dw:null;if(this._commands[dv]){var dx;var dy=this._commands[dv];if(!((qx.core.Environment.get(D)==cy)&&(dv==bz||dv==cT))){if(this.__wS()){this.__wT();}
;}
;if(dy.useBuiltin){dx=this.__wU(dy.identifier,false,dw);}
else {if(dy.method!=null&&this[dy.method]){dx=this[dy.method].call(this,dw,dy);}
else {this.error(cn+dy.method+t+dv+U);}
;}
;this.__ve.resetSavedRange();return dx;}
else {this.error(Y+dv+Q);}
;}
,__wS:function(){var Node=qx.dom.Node;var dz=this.__ve.getFocusNode();var dC=false;var dA=false;if(dz){if(Node.isText(dz)){var dB=qx.dom.Hierarchy.getAncestors(dz);for(var i=0,j=dB.length;i<j;i++){if(Node.isNodeName(dB[i],g)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(dB[i])){dC=true;break;}
;}
;}
else if(Node.isNodeName(dz,ca)){dA=true;}
;}
;return dA||!dC;}
,__wT:function(){this.__wU(cG,false,g);}
,__wU:function(dD,dE,dF){try{var dI=this.__kp;var dG=false;var dH=this.__ve.getRange();this.__kp.body.focus();if((qx.core.Environment.get(D)==C)){if(dD!=bB){dH.select();if(((dH.text)&&(dH.text.length>0))||((dH.length==1)&&(dH.item(0))&&(dH.item(0).tagName==ba))){dI=dH;}
else {dI=this.__kp;}
;}
;if(((qx.core.Environment.get(D)==C))&&(this.__wM[dD])){if(dH.text==A){dG=true;}
;}
;}
;var dJ=dI.execCommand(dD,dE,dF);if(dG&&dH.text!=A){dH.collapse();}
;if((qx.core.Environment.get(B))&&qx.core.Environment.get(cx)){this.debug(cB+dD+cc+dF+cE);}
;this.__wR=false;}
catch(dK){if((qx.core.Environment.get(B))&&qx.core.Environment.get(cx)){this.debug(cB+dD+cc+dF+dh);}
;return false;}
;return dJ;}
,__wV:qx.core.Environment.select(D,{"mshtml":function(){var dM=this.__ve;var dL=dM.getSavedRange()!=null?dM.getSavedRange():dM.getRange();return dL;}
,"default":function(){return this.__ve.getRange();}
}),__wW:qx.core.Environment.select(D,{"mshtml":function(dN,dO){var dR;if(dN==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__xa();}
else {this.__kp.body.focus();var dQ=this.__ve.getSelection();var dP=this.__wV();if(dP&&dQ&&dQ.type!=cg){try{dP.pasteHTML(dN);dP.collapse(false);dP.select();dR=true;}
catch(e){}
;}
else {dR=false;}
;this.__ve.resetSavedRange();return dR;}
;}
,"default":function(dS,dT){this.__kp.body.focus();return this.__kp.execCommand(dT.identifier,false,dS);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(D,{"gecko":function(){var ec=this.__xk();var eg=this.__wX(ec);var dX=this.__xi(ec);var ed=bE+Date.parse(new Date());var ee=ch+Date.parse(new Date());var dV=bs;var ea=bv+ed+y;dV+=ea;dV+=K+ee+dq+eg+G;dV+=dX+be;this.__ve.getCommandManager().addUndoStep(a,cF,this.getCommandObject(a));this.execute(a,dV);this.__wY();qx.bom.element.Attribute.reset(this.__kp.getElementById(ed),df);var eb=this.__kp.getElementById(ee);if(eb.previousSibling.innerHTML==ea){var dU=this.__xj();var dY=this.__kp.createElement(bn);var dW=this.__kp.createAttribute(T);dW.nodeValue=A;dY.setAttributeNode(dW);var ef=this.__kp.createAttribute(p);ef.nodeValue=cK;dY.setAttributeNode(ef);eb.previousSibling.appendChild(dU);eb.previousSibling.appendChild(dY);}
;qx.bom.element.Attribute.reset(eb,df);return true;}
,"webkit":function(){var eh=this.getCurrentStyles();var ei=A;var ek={"background-color":true,"text-align":true};for(var ej in eh){if(ek[ej]){ei+=ej+ce+eh[ej]+cd;}
;}
;this.__ve.insertHtml(X+ei+co);}
,"default":qx.lang.Function.empty}),__wX:qx.core.Environment.select(D,{"gecko":function(el){var eq=V;var ep=el.child;if(ep[cW]){eq+=dm+ep[cW]+h;delete el.child[cW];}
;if(ep[da]){eq+=J+ep[da]+h;delete el.child[da];}
...
}),__wY:qx.core.Environment.select(D,{"gecko":function(){var ez=this.__ve.getSelection();if(!ez||!ez.focusNode){return;}
;var er=ez.focusNode;var ew=ez.focusNode;while(!qx.dom.Node.isNodeName(ew,g)){ew=ew.parentNode;}
;var ev=ew.previousSibling.id;var eA=ew.nextSibling?ew.nextSibling.id:null;if(qx.lang.String.startsWith(ev,ch)&&ev==eA){var ey=ew.nextSibling;var et=this.__ve.getRange();et.selectNode(ey);ez.addRange(et);var es=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__ve.getCommandManager().addUndoStep(a,es,this.getCommandObject(a));this.execute(a,es);var eu=this.__ve.getRange();if(er){while(er&&er.firstChild&&qx.dom.Node.isElement(er.firstChild)){er=er.firstChild;}
;}
;eu.selectNode(er);ez.addRange(eu);eu.collapse(true);}
;}
,"default":qx.lang.Function.empty}),__xa:qx.core.Environment.select(D,{"mshtml":function(){var eB=this.__ve.getRange();if(eB&&!qx.dom.Node.isNodeName(eB.parentElement(),cD)){eB.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);eB.collapse(false);eB.select();return true;}
;return false;}
,"default":function(){return false;}
}),__xb:function(eC,eD){var eE=(qx.core.Environment.get(D)==C)?this.__ve.getRange():this.__kp;return eE.execCommand(eD.identifier,false,eC);}
,__xc:function(eF,eG){if((qx.core.Environment.get(D)==C)){var eH=this.__ve.getFocusNode();this.__xd(eH);}
;this.__kp.body.focus();var eI=this.__kp.execCommand(eG.identifier,false,eF);if((qx.core.Environment.get(D)==cy)){var eH=this.__ve.getFocusNode();this.__xd(eH.parentNode);}
;return eI;}
,__xd:function(eJ){var eK=[];var parent=eJ.parentNode;while(qx.dom.Node.isNodeName(parent,cV)){eK.push(parent);parent=parent.parentNode;}
;if(eK.length>0){parent.appendChild(eJ);parent.removeChild(eK[eK.length-1]);}
;}
,__xe:qx.core.Environment.select(D,{"gecko":function(eL,eM){if(eL.src){this.__kp.execCommand(eM.identifier,false,eL.src);delete eL.src;var fa=this.__ve.getSelection();if(fa){var eY=fa.anchorNode;var eT=fa.anchorOffset;var eQ=eY.childNodes[eT-1];var eW;for(var eS in eL){eW=this.__kp.createAttribute(eS);eW.nodeValue=eL[eS];eQ.setAttributeNode(eW);}
...
;var eP=this.__kp.createDocumentFragment();var fb;if(eV&&eO!=null){var eR=this.__xf(eO);eP.appendChild(eR.root);fb=eR.inline;}
...
;var eN=this.__ve.getRange();eN.selectNodeContents(fb);}
;return true;}
else {return false;}
;}
,"mshtml":function(fc,fd){var fh=false;var fi=bQ;for(var fe in fc){fi+=fe+cf+fc[fe]+cz;}
;fi+=bO;var ff=this.__ve.getSelection();var fg=this.__wV();if(ff&&ff.type!=cg){try{fg.select();fg.pasteHTML(fi);fh=true;}
catch(e){}
;}
;this.__ve.resetSavedRange();return fh;}
,"default":function(fj,fk){if(fj.src){var fm=bQ;for(var fl in fj){fm+=fl+cf+fj[fl]+cz;}
;fm+=bO;return this.__kp.execCommand(dg,false,fm);}
else {return false;}
;}
}),__xf:function(fn){while(fn.firstChild&&fn.firstChild.nodeType==1){fn=fn.firstChild;}
;var fr=this.__xk(fn);var fv,fp,ft;var fo=A;var parent=null;var fu=null;var fs=fr.child;while(fs){fu=this.__kp.createElement(fs[z]?bV:f);fp=this.__kp.createAttribute(ck);fu.setAttributeNode(fp);for(var fq in fs){if(fq!=db&&fq!=z){fo+=fq+ce+fs[fq]+cd;}
...
,__xg:qx.core.Environment.select(D,{"gecko|opera":function(fw,fx){var fD=this.__ve.getSelection();var fA=this.__ve.getRange();if(fD.isCollapsed){var fz=v+(++this.__wO);var fE=this.__kp.createElement(cr);var fB=this.__kp.createAttribute(bu);var fy=this.__kp.createAttribute(df);var fC=this.__kp.createTextNode(fw);fy.nodeValue=fz;fE.setAttributeNode(fy);fB.nodeValue=fw;fE.setAttributeNode(fB);fE.appendChild(fC);fA.insertNode(fE);fA.selectNode(fE);fD.collapseToEnd();return true;}
else {return this.__kp.execCommand(fx.identifier,false,fw);}
;}
,"mshtml":function(fF,fG){try{var fI;var fH=this.__wV();var fJ=this.__ve;var fH=fJ.getSavedRange()!=null?fJ.getSavedRange():fJ.getRange();if(fH!=null&&fH.text!=A){fI=fH.execCommand(fG.identifier,false,fF);}
else {fI=this.__wW(bI+fF+cY+fF+cQ,fG);}
;this.__ve.resetSavedRange();return fI;}
catch(e){if(qx.core.Environment.get(B)){this.error(bG);}
;return false;}
;}
,"default":function(fK,fL){return this.__kp.execCommand(fL.identifier,false,fK);}
}),__xh:function(fM,fN){var fO=bb;if((qx.core.Environment.get(D)==dc)){fO+=this.__xi();}
;return this.__wW(fO,fN);}
,__xi:function(fP){var fT=A;var fS=cC;var fR=[];var fW=typeof fP!==dd?fP:this.__xk();var fU=fW.child;var fV=false;if(qx.lang.Object.isEmpty(fU)){return A;}
;while(fU){fV=fU[z]!=null;fT+=fV?bg:fS;for(var fQ in fU){fT+=(fQ!=db&&fQ!=z)?fQ+cv+fU[fQ]+h:A;}
;fT+=fV?I+fU[z]+cY:cY;fR.unshift(fV?bP:bq);fU=fU.child;}
;if(fR.length==1&&fR[0]==bP){fT+=cj;}
;for(var i=0,j=fR.length;i<j;i++){fT+=fR[i];}
;return fT;}
,__xj:function(){var fY=this.__kp.createDocumentFragment();var ge=this.__xk();var parent=fY;var gc=ge.child;var ga;var gd=false;while(gc){gd=gc[z]!=null;ga=this.__kp.createElement(gd?bV:f);parent.appendChild(ga);for(var fX in gc){if(fX!=db&&fX!=z){qx.bom.element.Style.set(ga,fX,gc[fX]);}
;}
;if(gd){var gb=this.__kp.createAttribute(cw);gb.nodeValue=gc[z];ga.setAttributeNode(gb);}
;parent=ga;gc=gc.child;}
;return fY;}
,__xk:function(gf){var gh={};var gi=null;var gj=this.getCurrentStyles(gf);gi=gh.child={};for(var gg in gj){if(gg!=b){gi[gg]=gj[gg];}
;}
...
;return gh;}
,getCurrentStyles:function(gl){if(gl==null){var gn=this.__ve.getSelection();if(!gn||gn.focusNode==null){return {};}
;gl=(gn.focusNode.nodeType==3)?gn.focusNode.parentNode:gn.focusNode;}
;var go=qx.dom.Hierarchy.getAncestors(gl);var gq=qx.lang.Array.insertBefore(go,gl,go[0]);var gm=this.__xl(gq);var gp=this.__xm(gm,gq);return gp;}
,__xl:function(gr){var gu={};var gs,gt;for(var i=0,j=gr.length;i<j;i++){gt=gr[i];for(var k=0,l=gt.style.length;k<l;k++){gs=gt.style[k];if(gs.length>0&&typeof gu[gs]===dd){gu[gs]=gt.style.getPropertyValue(gs);}
;}
;if(gt.tagName.toUpperCase()==bH&&gt.size&&gu[z]===undefined){gu[z]=gt.size;}
;}
;if(gu[z]&&gu[bU]){delete gu[bU];}
;return gu;}
,__xm:function(gv,gw){var gB=gw[0];var gz=this.__ve.getContentWindow().getComputedStyle(gB,null);var gx;var gA={};for(var gy in gv){if(gy!=z){gx=gz.getPropertyValue(gy);}
else {gx=gv[gy];}
;if(gy==bR&&gx==de){gA[gy]=this.__xo(gw);}
else if(gy==b){gA[gy]=this.__xn(gw);}
else {gA[gy]=gx;}
;}
;return gA;}
,__xn:function(gC){var gF,gH,gD;var gG=[];var gE=this.__ve.getContentWindow();for(var i=0,j=gC.length;i<j;i++){gD=gE.getComputedStyle(gC[i],null);gF=gD.getPropertyValue(b);gH=gD.getPropertyValue(S);if(gF!=x){gG.push({'text-decoration':gF,'color':gH});}
;}
;return gG;}
,__xo:function(gI){var gK,gJ,gL;for(var i=0;i<gI.length;i++){gK=gI[i];gJ=this.__ve.getContentWindow().getComputedStyle(gK,null);gL=gJ.getPropertyValue(bR);if(gL!=de){return gL;}
;}
;}
,__xp:function(gM,gN){var ha=this.__ve.getSelection();var gU=((qx.core.Environment.get(D)==C))?this.__ve.getRange():gU=ha.getRangeAt(0);var gV=[];var gY;var gT=[dn,bw];var gO,i,j,gW;gW=((qx.core.Environment.get(D)==C))?gU.parentElement():gU.commonAncestorContainer;if(gW.tagName==ct){for(var i=0;i<gT.length;i++){gO=gW.getElementsByTagName(gT[i]);for(var j=0;j<gO.length;j++){if(gO[j]){gV.push(gO[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(gT,gW.tagName)){gV.push(gW);}
;if(gV.length>0){for(var i=0;i<gV.length;i++){var gQ=gV[i];gY=((qx.core.Environment.get(D)==C))?((gQ==gW)||(gW.tagName==ct)):ha.containsNode(gQ,false);for(j=0;j<gQ.childNodes.length;j++){var gS=gQ.childNodes[j];if(gY||(ha.focusNode.nodeValue&&qx.dom.Hierarchy.contains(gS,ha.focusNode)&&(ha.focusOffset==ha.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(gS,ha.anchorNode)&&(ha.anchorOffset==0))||(ha.containsNode(gS,false))){gS.style.fontSize=(this.__wN[gM]||gM)+cb;}
;}
;}
;}
else {var gR=((qx.core.Environment.get(D)==C))?gW:ha.focusNode;var gX=qx.dom.Hierarchy.getAncestors(gR);for(i=0;i<gX.length;i++){if(gX[i].tagName==M){if((((qx.core.Environment.get(D)==dc))&&((ha.anchorOffset==0)&&(ha.focusNode.nodeValue&&(ha.focusOffset==ha.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(gX[i].firstChild,ha.anchorNode)&&qx.dom.Hierarchy.contains(gX[i].lastChild,ha.focusNode)))||(((qx.core.Environment.get(D)==C))&&(gU.htmlText==gX[i].innerHTML))){gX[i].style.fontSize=(this.__wN[gM]||gM)+cb;}
;break;}
;}
;}
;if((qx.core.Environment.get(D)==C)){this.__kp.body.focus();this.__ve.getRange().select();return this.__kp.execCommand(n,false,gM);}
...
,__xq:qx.core.Environment.select(D,{"mshtml":function(hb,hc){this.__kp.body.focus();return this.__kp.execCommand(o,false,hb);}
,"gecko|opera":function(hd,he){this.__kp.body.focus();return this.__kp.execCommand(E,false,hd);}
,"webkit":function(hf,hg){var hh=this.__ve.getSelection();var hi=this.__ve.getRange();if(!hh||!hh.isCollapsed){this.__kp.body.focus();this.__kp.execCommand(o,false,hf);if(hh){hh.collapseToEnd();}
;return true;}
...
;}
;hi.setStart(hh.anchorNode,hh.anchorNode.nodeValue.charAt(hl)==cs?hl+1:hl);hi.setEnd(hh.anchorNode,hk);hh.addRange(hi);this.__kp.body.focus();this.__kp.execCommand(o,false,hf);hh.collapseToEnd();return true;}
;}
}),__xr:function(hm,hn){hm=hm!=null&&typeof hm==bS?hm:de;qx.bom.element.Style.set(this.__kp.body,cL,hm);return true;}
,__xs:function(ho,hp){var hq,hs,hr;var ht=qx.bom.htmlarea.manager.Command;if(ho==null){hq=null;}
else {hq=ho[0];hs=ho[1];hr=ho[2];}
;if(hq==null||typeof hq!=bS){qx.bom.element.Style.set(this.__kp.body,bY,A);qx.bom.element.Style.set(this.__kp.body,bW,A);qx.bom.element.Style.set(this.__kp.body,bN,A);return true;}
else {if(hq.search(/^url.*\(/)==-1){hq=cH+hq+u;}
;}
;if(hs!=null&&!qx.lang.String.contains(ht.__wQ,hs)){if(qx.core.Environment.get(B)){this.error(cu+hs+br+ht.__wQ+m);}
;return false;}
else {hs=bK;}
;if(hr!=null){if(qx.lang.Type.isString(hr)&&!qx.lang.String.contains(ht.__wP,bT+hr+bT)){if(qx.core.Environment.get(B)){this.error(cu+hr+bL+ht.__wP+m);}
;return false;}
else {if(qx.lang.Type.isArray(hr)&&hr.length==2){hr=hr[0]+cs+hr[1];}
else {if(qx.core.Environment.get(B)){this.error(cl);}
;return false;}
;}
;}
else {hr=bh;}
;qx.bom.element.Style.set(this.__kp.body,bY,hq);qx.bom.element.Style.set(this.__kp.body,bW,hs);qx.bom.element.Style.set(this.__kp.body,bN,hr);return true;}
,__xt:qx.core.Environment.select(D,{"mshtml":function(hu,hv){var hw=this.__kp.body.createTextRange();hw.select();return true;}
,"default":function(hx,hy){return this.__wU(hy.identifier,false,hx);}
}),__xu:function(){return this.__ve.getSelectedText();}
,__xv:function(){return this.__ve.getSelectedHtml();}
,__xw:function(hz,hA){var hE=this.__ve.getFocusNode();if(hE.textContent==A){var hC=qx.dom.Hierarchy.getAncestors(hE);hC.unshift(hE);var Node=qx.dom.Node;var hB=qx.bom.element.Style;var hD=hC.shift();while(hC.length>0){if(Node.getName(hD)==g||Node.getName(hD)==ca){break;}
;if(hB.get(hD,hz,hB.LOCAL_MODE)==hA){hB.reset(hD,hz);return true;}
;hD=hC.shift();}
;}
;return false;}
,__xx:qx.core.Environment.select(D,{"gecko":function(hF,hG){if(this.__xw(bo,cN)){return true;}
else {return this.__wU(hG.identifier,false,hF);}
;}
,"default":function(hH,hI){return this.__wU(hI.identifier,false,hH);}
}),__xy:qx.core.Environment.select(D,{"gecko":function(hJ,hK){if(this.__xw(dj,s)){return true;}
else {return this.__wU(hK.identifier,false,hJ);}
;}
,"default":function(hL,hM){return this.__wU(hM.identifier,false,hL);}
}),__xz:qx.core.Environment.select(D,{"gecko":function(hN,hO){if(this.__xw(cA,bM)){return true;}
else {return this.__wU(hO.identifier,false,hN);}
;}
,"default":function(hP,hQ){return this.__wU(hQ.identifier,false,hP);}
}),__xA:qx.core.Environment.select(D,{"gecko":function(hR,hS){if(this.__xw(cA,W)){return true;}
else {return this.__wU(hS.identifier,false,hR);}
;}
,"default":function(hT,hU){return this.__wU(hU.identifier,false,hT);}
})},destruct:function(){this.__kp=this.__ve=this._commands=null;this.__wM=this.__wN=null;}
});}
)();
(function(){var n="undo",m="pageup",l="ADD TO UNDO STACK",k="control",h="shift",g="end",f="right",d="qx_link",c="b",b="insertunorderedlist",bo="Undo",bn="pagedown",bm="__vd",bl="k",bk="home",bj="Redo",bi="a",bh="insertorderedlist",bg="y",bf="justifyright",u="redo",v="insertParagraph",s="qx.bom.htmlarea.manager.UndoRedo",t="left",q="i",r="u",o="enter",p="execCommand failed! Details: ",A="ADD TO REDO STACK",B="insertimage",K="z",H="undoRedoState",S="down",N="up",bb="body",X="backgroundColor",D="actionType ",be="mousedown",bd=" is not managed! Please provide a handler method!",bc="table",C="backgroundImage",F="backgroundRepeat",G="p",J="backgroundPosition",L="td",O="img",U="inserthyperlink",ba="mouseup",w="keypress",x="qx.bom.htmlarea.HtmlArea.debug",E="backgroundimage",R="qx.debug",Q="backgroundcolor",P="webkit",W=" ",V="Content",M="Internal",T="inserthtml",a="gecko",Y="Custom",y="Command",z="mshtml",I="engine.name";qx.Class.define(s,{extend:qx.core.Object,construct:function(bp,bq){qx.core.Object.call(this);this.__vd=bp;this.__ve=bq;this.__vf=[];this.__vg=[];this._commands=null;this.__kp=null;this.__vh={};this.__vi={command:true,content:true,custom:true};this.__vG();this.__vj=qx.lang.Function.bind(this._handleKeyPress,this);this.__vk=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(I)==z)){this.__vl=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__vm:false,__vn:false,__vo:false,__vi:null,__vh:null,__vd:null,__kp:null,__vf:null,__vg:null,__ve:null,__vj:null,__vk:null,__vl:null,__vp:null,setContentDocument:function(br){this.__kp=br;this.__vd.setContentDocument(br);qx.event.Registration.addListener(br.body,w,this.__vj,this);qx.event.Registration.addListener(br.body,ba,this.__vk,this);if((qx.core.Environment.get(I)==z)){qx.event.Registration.addListener(br.body,be,this.__vl,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__vd.insertParagraphOnLinebreak();}
,execute:function(bs,bt){var bu;bs=bs.toLowerCase();if(this._commands[bs]){if(this._commands[bs].passthrough){bu=this.__vd.execute(bs,bt);}
else {bu=this[bs].call(this);}
;}
else {if((qx.core.Environment.get(I)==z)||(qx.core.Environment.get(I)==P)){this.__vH(bs,bt,this.__vd.getCommandObject(bs));bu=this.__vd.execute(bs,bt);if(!bu){this.__vf.pop();}
;}
else {bu=this.__vd.execute(bs,bt);if(bu){this.__vH(bs,bt,this.__vd.getCommandObject(bs));}
;}
;if(bs==n&&this.__vf.length==0){this.__vn=false;this.__vP();}
else if(bs==u&&this.__vg.length==0){this.__vm=false;this.__vP();}
;}
;this.__vo=false;return bu;}
,addUndoStep:function(bv,bw,bx){this.__vH(bv,bw,bx);}
,registerHandler:function(by,bz,bA,bB){this.__vh[by]={undo:bz,redo:bA,context:bB};}
,isUndoPossible:function(){return this.__vn;}
,undo:function(){var bE;if(this.__vo){this.__vJ();}
;if(this.__vf.length>0){var bD=this.__vf.pop();if(this.__vi[bD.actionType.toLowerCase()]){switch(bD.actionType){case y:bE=this.__vr(bD);break;case V:bE=this.__vv(bD);break;case M:bE=this.__vu(bD);break;case Y:bE=this.__vq(bD);break;};}
else if(this.__vh[bD.actionType]){var bC=this.__vh[bD.actionType];bE=bC.undo.call(bC.context?bC.context:this,bD);this.__vL(bD);}
else {this.error(D+bD.actionType+bd);}
;this.__vm=true;this.__vP();return bE;}
;}
,__vq:qx.core.Environment.select(I,{"mshtml|webkit":function(bF){var bG=this.__kp.body.innerHTML;var bI=bF.content;this.__kp.body.innerHTML=bI;var bH=bF;bH.content=bG;this.__vL(bH);return true;}
,"default":function(bJ){var bN=bJ;var bM=qx.bom.element.Style;switch(bJ.command){case Q:bN.parameter=[bM.get(this.__kp.body,X)];break;case E:bN.parameter=[bM.get(this.__kp.body,C),bM.get(this.__kp.body,F),bM.get(this.__kp.body,J)];break;};this.__vL(bN);if(bJ.command==U){if((qx.core.Environment.get(I)==a)){var bL=d+this.__vd.__hyperLinkId;var bK=this.__kp.getElementById(bL);if(bK){bK.parentNode.removeChild(bK);return true;}
else {return false;}
;}
;}
else {return this.__vd.execute(bJ.command,bJ.value);}
;}
}),__vr:qx.core.Environment.select(I,{"mshtml|webkit":function(bO){}
,"default":function(bP){this.__vL(bP);if((qx.core.Environment.get(I)==a)){if(bP.command==T&&bP.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__vs(T,v)){this.__vt();}
;}
;return this.__vw();}
}),__vs:function(bQ,bR){if(this.__vf.length>0){var bS=this.__vf[this.__vf.length-1];return (bS.command==bQ&&bS.value==bR);}
;return false;}
,__vt:function(){this.__vw();if(this.__vf.length>0){var bT=this.__vf.pop();this.__vL(bT);}
;}
,__vu:function(bU){this.__vL(bU);return this.__vw();}
,__vv:qx.core.Environment.select(I,{"gecko":function(bV){this.__vL(bV);try{return this.__vw();}
catch(bW){if(qx.core.Environment.get(R)){this.error(p+bW);}
;}
;}
,"mshtml|webkit":function(bX){}
,"default":function(bY){this.__vL(bY);return this.__vw();}
}),__vw:function(){try{return this.__kp.execCommand(bo,false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__vm;}
,redo:function(){if(this.__vm){var cb;if(this.__vg.length>0){var cc=this.__vg.pop();if(this.__vi[cc.actionType.toLowerCase()]){switch(cc.actionType){case y:cb=this.__vy(cc);break;case V:cb=this.__vE(cc);break;case M:cb=this.__vD(cc);break;case Y:cb=this.__vx(cc);break;};}
else if(this.__vh[cc.actionType]){var ca=this.__vh[cc.actionType];cb=ca.redo.call(ca.context?ca.context:this,cc);this.__vK(cc);}
else {this.error(D+cc.actionType+bd);}
;this.__vn=true;this.__vP();}
;return cb;}
;}
,__vx:qx.core.Environment.select(I,{"mshtml|webkit":function(cd){var ce=this.__kp.body.innerHTML;var cg=cd.content;this.__kp.body.innerHTML=cg;var cf=cd;cf.content=ce;this.__vK(cf);return true;}
,"default":function(ch){this.__vK(ch);return this.__vF();}
}),__vy:qx.core.Environment.select(I,{"mshtml|webkit":function(ci){}
,"default":function(cj){this.__vK(cj);var ck=this.__vF();if((qx.core.Environment.get(I)==a)){if(this.__vz(T,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cl=this.__vA();this.__vB();if(cl!=null){this.__vC(cl);}
;}
;}
;return ck;}
}),__vz:function(cm,cn){if(this.__vg.length>0){var co=this.__vg[this.__vg.length-1];return (co.command==cm&&co.value==cn);}
;return false;}
,__vA:function(){if(this.__ve==null){return null;}
;var cp=this.__ve.getSelection();var cq=cp?cp.focusNode:null;if(cq==null){return null;}
...
;}
,__vB:function(){var cs=this.__vg.pop();this.__vK(cs);this.__vF();}
,__vC:qx.core.Environment.select(I,{"gecko":function(ct){if(ct==this.__ve.getContentBody().lastChild){return;}
;var cw=ct.firstChild;while(cw.firstChild){cw=cw.firstChild;}
;var cu=this.__ve.getSelection();var cv=this.__ve.getRange();if(cu&&cv){cv.selectNode(cw);cu.addRange(cv);cv.collapse(true);}
;}
,"default":qx.lang.Function.empty}),__vD:function(cx){this.__vK(cx);return this.__vF();}
,__vE:qx.core.Environment.select(I,{"mshtml|webkit":function(cy){}
,"default":function(cz){this.__vK(cz);return this.__vF();}
}),__vF:function(){try{return this.__kp.execCommand(bj,false,null);}
catch(e){return false;}
;}
,__vG:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__vd.getCommandObject(Q).customUndo=true;this.__vd.getCommandObject(E).customUndo=true;if((qx.core.Environment.get(I)==a)){}
;}
,__vH:qx.core.Environment.select(I,{"mshtml|webkit":function(cA,cB,cC){var cD=this.getUndoRedoObject();cD.commandObject=cC;cD.command=cA;cD.value=cB;cD.actionType=Y;cD.content=this.__kp.body.innerHTML;this.__vI(cD);}
,"default":function(cE,cF,cG){if(this.__ve==null){return;}
;var cI=this.getUndoRedoObject();cI.commandObject=cG;cI.command=cE;cI.value=cF;cI.actionType=Y;var cH=this.__ve.getSelection();if(cG.customUndo){var cJ=[];switch(cE){case Q:cJ.push(qx.bom.element.Style.get(this.__kp.body,X));break;case E:cJ.push(qx.bom.element.Style.get(this.__kp.body,C),qx.bom.element.Style.get(this.__kp.body,F),qx.bom.element.Style.get(this.__kp.body,J));break;case U:if(cH&&!cH.isCollapsed){cI.actionType=y;}
...
;}
;this.__vI(cI);}
}),__vI:function(cK){if(this.__vo){this.__vJ();}
;this.__vK(cK);this.__vm=false;this.__vg=[];this.__vP();}
,__vJ:function(){var cL=this.__vf[this.__vf.length-1];if(cL==null||cL.actionType!=V){var cM=this.getUndoRedoObject();cM.actionType=V;if((qx.core.Environment.get(I)==z)||(qx.core.Environment.get(I)==P)){cM.content=this.__vp;cM.actionType=Y;this.__vp=null;}
;this.__vK(cM);this.__vo=false;}
;}
...
,__vK:function(cN){if((qx.core.Environment.get(R))&&qx.core.Environment.get(x)){this.debug(l);this.debug(cN.actionType+W+cN.command+W+cN.value);}
;this.__vf.push(cN);}
,__vL:function(cO){if((qx.core.Environment.get(R))&&qx.core.Environment.get(x)){this.debug(A);this.debug(cO.actionType+W+cO.command+W+cO.value);}
;this.__vg.push(cO);}
,_handleKeyPress:function(e){var cP=e.getKeyIdentifier().toLowerCase();var cQ=e.isCtrlPressed();switch(cP){case k:case h:case t:case f:case N:case S:case m:case bn:case bk:case g:case o:break;case bi:case c:case q:case r:case bl:case bg:case K:if(!cQ){this.__vM();}
;break;default:this.__vm=false;this.__vg=[];this.__vM();};}
,__vM:function(){if(!this.__vo){this.__vo=true;this.__vn=true;if((qx.core.Environment.get(I)==z)||(qx.core.Environment.get(I)==P)){this.__vp=this.__kp.body.innerHTML;}
;this.__vP();}
;}
,__vN:null,_handleMouseDown:qx.core.Environment.select(I,{"mshtml":function(e){var cR=e.getOriginalTarget();if(qx.dom.Node.isElement(cR)&&(qx.dom.Node.isNodeName(cR,O)||qx.dom.Node.isNodeName(cR,bc))){this.__vN={node:cR,content:cR.outerHTML};}
else {this.__vN=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(I,{"gecko":function(e){if(this.__ve==null){return;}
;var cT=this.__ve.getSelection();if(!cT){this.__vN=null;return;}
;var cS=cT.anchorNode;var cU=cS.childNodes[cT.anchorOffset];if(qx.dom.Node.isNodeName(cU,O)){if(this.__vN==null){this.__vN=cU.cloneNode(true);}
else {if(this.__vN.style.width!=cU.style.width||this.__vN.style.height!=cU.style.height){this.__vO();this.__vN=cU.cloneNode(true);}
;}
;}
...
;if(this.__vN==null){this.__vN=cV.cloneNode(true);}
else {qx.event.Timer.once(function(){if(cV.style.width!=this.__vN.style.width||cV.style.height!=this.__vN.style.height||cV.innerHTML!=this.__vN.innerHTML){this.__vO();this.__vN=cV.cloneNode(true);}
;}
,this,0);}
;}
else {this.__vN=null;}
;}
,"default":function(e){var cW=qx.bom.Event.getTarget(e);if(this.__vN!=null){if(cW.nodeType==1){if(cW==this.__vN.node){if(cW.outerHTML!=this.__vN.content){this.__vN.content=cW.outerHTML;this.__vO();}
;}
else {for(var i=0,j=cW.childNodes.length;i<j;i++){if(cW.childNodes[i]==this.__vN.node){if(cW.childNodes[i].outerHTML!=this.__vN.content){this.__vN.content=cW.childNodes[i].outerHTML;this.__vO();}
;}
;}
;}
;}
...
;}
;}
}),__vO:qx.core.Environment.select(I,{"mshtml|webkit":function(){this.__vH(M,null,null);}
,"default":function(){var cX=this.getUndoRedoObject();cX.actionType=M;this.__vK(cX);}
}),__vP:function(){qx.event.Timer.once(function(e){if(this.__ve!=null){var cY={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__ve.fireDataEvent(H,cY);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__kp.body,w,this.__vj);qx.event.Registration.removeListener(this.__kp,ba,this.__vk);if((qx.core.Environment.get(I)==z)){qx.event.Registration.removeListener(this.__kp,be,this.__vl);}
;}
catch(e){}
;this._disposeObjects(bm);this.__ve=this.__vf=this.__vg=this._commands=this.__kp=null;this.__vi=this.__vh=null;}
});}
)();
...
(function(){var k="Enter",j="one",i="mouseout",h="Space",g="key",f="mousewheel",d="keyinput",c="changeSelection",b="y",a="qx.ui.form.SelectBox",A="mouseover",z="selectbox",y="click",x="quick",w=" ",v="hovered",u="changeLabel",t="changeIcon",s="arrow",r="",p="spacer",q="pressed",n="abandoned",o="popup",l="atom",m="list";qx.Class.define(a,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],include:[qx.ui.core.MSingleSelectionHandling,qx.ui.form.MModelSelection],construct:function(){qx.ui.form.AbstractSelectBox.call(this);this._createChildControl(l);this._createChildControl(p);this._createChildControl(s);this.addListener(A,this._onMouseOver,this);this.addListener(i,this._onMouseOut,this);this.addListener(y,this._onClick,this);this.addListener(f,this._onMouseWheel,this);this.addListener(d,this._onKeyInput,this);this.addListener(c,this.__mQ,this);}
,properties:{appearance:{refine:true,init:z}},members:{__ya:null,_createChildControlImpl:function(B,C){var D;switch(B){case p:D=new qx.ui.core.Spacer();this._add(D,{flex:1});break;case l:D=new qx.ui.basic.Atom(w);D.setCenter(false);D.setAnonymous(true);this._add(D,{flex:1});break;case s:D=new qx.ui.basic.Image();D.setAnonymous(true);this._add(D);break;};return D||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,B);}
...
,__mQ:function(e){var F=e.getData()[0];var E=this.getChildControl(m);if(E.getSelection()[0]!=F){if(F){E.setSelection([F]);}
else {E.resetSelection();}
;}
;this.__zG();this.__zH();}
,__zG:function(){var H=this.getChildControl(m).getSelection()[0];var I=this.getChildControl(l);var G=H?H.getIcon():r;G==null?I.resetIcon():I.setIcon(G);}
,__zH:function(){var L=this.getChildControl(m).getSelection()[0];var M=this.getChildControl(l);var K=L?L.getLabel():r;var J=this.getFormat();if(J!=null){K=J.call(this,L);}
;if(K&&K.translate){K=K.translate();}
;K==null?M.resetLabel():M.setLabel(K);}
,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;if(this.hasState(n)){this.removeState(n);this.addState(q);}
;this.addState(v);}
,_onMouseOut:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.removeState(v);if(this.hasState(q)){this.removeState(q);this.addState(n);}
;}
,_onClick:function(e){this.toggle();}
,_onMouseWheel:function(e){if(this.getChildControl(o).isVisible()){return;}
;var O=e.getWheelDelta(b)>0?1:-1;var Q=this.getSelectables();var P=this.getSelection()[0];if(!P){P=Q[0];}
;var N=Q.indexOf(P)+O;var R=Q.length-1;if(N<0){N=0;}
else if(N>=R){N=R;}
;this.setSelection([Q[N]]);e.stopPropagation();e.preventDefault();}
,_onKeyPress:function(e){var S=e.getKeyIdentifier();if(S==k||S==h){if(this.__ya){this.setSelection([this.__ya]);this.__ya=null;}
;this.toggle();}
else {qx.ui.form.AbstractSelectBox.prototype._onKeyPress.call(this,e);}
;}
,_onKeyInput:function(e){var T=e.clone();T.setTarget(this._list);T.setBubbles(false);this.getChildControl(m).dispatchEvent(T);}
,_onListMouseDown:function(e){if(this.__ya){this.setSelection([this.__ya]);this.__ya=null;}
;}
,_onListChangeSelection:function(e){var U=e.getData();var X=e.getOldData();if(X&&X.length>0){X[0].removeListener(t,this.__zG,this);X[0].removeListener(u,this.__zH,this);}
;if(U.length>0){var W=this.getChildControl(o);var V=this.getChildControl(m);var Y=V.getSelectionContext();if(W.isVisible()&&(Y==x||Y==g)){this.__ya=U[0];}
else {this.setSelection([U[0]]);this.__ya=null;}
;U[0].addListener(t,this.__zG,this);U[0].addListener(u,this.__zH,this);}
else {this.resetSelection();}
;}
,_onPopupChangeVisibility:function(e){qx.ui.form.AbstractSelectBox.prototype._onPopupChangeVisibility.call(this,e);var bb=this.getChildControl(o);if(!bb.isVisible()){var bd=this.getChildControl(m);if(bd.hasChildren()){bd.setSelection(this.getSelection());}
;}
else {var ba=bb.getLayoutLocation(this);var bf=qx.bom.Viewport.getHeight();var be=ba.top;var bg=bf-ba.bottom;var bc=be>bg?be:bg;var bh=this.getMaxListHeight();var bd=this.getChildControl(m);if(bh==null||bh>bc){bd.setMaxHeight(bc);}
