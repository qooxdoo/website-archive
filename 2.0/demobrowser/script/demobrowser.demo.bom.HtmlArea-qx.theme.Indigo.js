...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.HtmlArea","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea-qx.theme.Indigo.a541ed64d48d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,this.__xB);qx.dom.Element.insertBegin(cI,cH);return cH;}
,__xJ:function(){var cP=qx.dom.Element.create(bE);qx.bom.element.Style.setStyles(cP,{"marginRight":bx,"float":by});var cR;var cQ=qx.dom.Element.create(bj,{title:m});if(qx.core.Environment.get(bA)==bD){qx.bom.element.Attribute.set(cQ,bC,bF);}
...
;}
,this.__xB);qx.dom.Element.insertBegin(cQ,cP);return cP;}
,__xL:function(){var cW=[{bold:{text:cn,image:s,action:this.__xB.setBold},italic:{text:bu,image:U,action:this.__xB.setItalic},underline:{text:B,image:bt,action:this.__xB.setUnderline},strikethrough:{text:C,image:ct,action:this.__xB.setStrikeThrough},removeFormat:{text:M,image:h,action:this.__xB.removeFormat}},{alignLeft:{text:cc,image:t,action:this.__xB.setJustifyLeft},alignCenter:{text:X,image:cd,action:this.__xB.setJustifyCenter},alignRight:{text:bv,image:p,action:this.__xB.setJustifyRight},alignJustify:{text:cl,image:bb,action:this.__xB.setJustifyFull}},{fontFamily:{custom:this.__xI},fontSize:{custom:this.__xJ},fontColor:{text:b,image:c,action:this.__xC},textBackgroundColor:{text:bN,image:bR,action:this.__xD}},{indent:{text:bT,image:bn,action:this.__xB.insertIndent},outdent:{text:D,image:n,action:this.__xB.insertOutdent}},{insertImage:{text:o,image:K,action:this.__xE},insertTable:{text:ca,image:f,action:this.__xF},insertLink:{text:bQ,image:H,action:this.__xG},insertHTML:{text:O,image:bK,action:this.__xH},insertHR:{text:bJ,image:bM,action:this.__xB.insertHorizontalRuler}},{ol:{text:I,image:bo,action:this.__xB.insertOrderedList},ul:{text:z,image:bL,action:this.__xB.insertUnorderedList}},{undo:{text:T,image:g,action:this.__xB.undo},redo:{text:co,image:Y,action:this.__xB.redo}}];var cY,dd,cV,db;for(var i=0,j=cW.length;i<j;i++){dd={};dd[cr]=i==j-1?bG:bx;dd[cg]=by;cY=qx.dom.Element.create(bE);qx.bom.element.Style.setStyles(cY,dd);for(var da in cW[i]){var dc=cW[i][da];if(dc.custom){cV=dc.custom.call(this);}
...
;qx.event.Registration.addListener(cV,cu,dc.action,this.__xB);}
...
;return this;}
;}
;var O=function(ba,bb){return function(bc,bd,be,bf,bg,bh){if(this.length>0){var bi=this[0].nodeType===1?ba[bb](this[0],bc,bd,be,bf,bg,bh):null;if(bi&&bi.nodeType){return this.__ur([bi]);}
else {return bi;}
;}
;return null;}
;}
...
,__up:/^.[^:#\[\.,]*$/,not:function(bL){if(this.__up.test(bL)){var bM=qx.bom.Selector.matches(m+bL+g,this);return this.__ur(bM);}
;var bM=qx.bom.Selector.matches(bL,this);return this.filter(function(bN){return bM.indexOf(bN)===-1;}
);}
,add:function(bO,bP){var bQ=qx.bom.Selector.query(bO,bP);var bR=qx.lang.Array.unique(this.concat(bQ));return this.__ur(bR);}
...
;bY=bY.parentNode;}
;}
);return this.__ur(qx.lang.Array.unique(bW));}
...
;return this.__ur(cb);}
,find:function(cc){var ce=qx.bom.Selector;if(this.length===1){return this.__ur(ce.query(cc,this[0]));}
else {var cd=[];for(var i=0,l=this.length;i<l;i++){cd.push.apply(cd,ce.query(cc,this[i]));}
;return this.__ur(qx.lang.Array.unique(cd));}
;}
...
;return this.__ur(ch);}
,nextAll:function(ci){return this.__uq(v,ci);}
...
;return this.__ur(cl);}
,prevAll:function(cm){return this.__uq(f,cm);}
...
;return this.__ur(co);}
,parents:function(cp){return this.__uq(a,cp);}
,siblings:function(cq){return this.__uq(u,cq);}
,__uq:function(cr,cs){var cu=[];var ct=qx.dom.Hierarchy;for(var i=0,l=this.length;i<l;i++){cu.push.apply(cu,ct[cr](this[i]));}
;var cv=qx.lang.Array.unique(cu);if(cs){cv=qx.bom.Selector.matches(cs,cv);}
;return this.__ur(cv);}
,__ur:function(cw){var cx=new qx.bom.Collection;cx.__uo=this;cw=Array.prototype.slice.call(cw,0);cx.push.apply(cx,cw);return cx;}
,andSelf:function(){return this.add(this.__uo);}
,end:function(){return this.__uo||new qx.bom.Collection();}
,__us:function(cy,cz){var cE=this[0];var cD=cE.ownerDocument||cE;var cC=cD.createDocumentFragment();var cG=qx.bom.Html.clean(cy,cD,cC);var cI=cC.firstChild;if(cI){var cA=this.length-1;for(var i=0,l=cA;i<l;i++){cz.call(this,this[i],cC.cloneNode(true));}
...
;}
;return this;}
,__ut:function(cJ,cK){var cM=qx.bom.Selector;var cL=qx.lang.Array;var cO=[];for(var i=0,l=cJ.length;i<l;i++){if(qx.core.Environment.get(N)){if(typeof cJ[i]!==C){throw new Error(M+cJ[i]);}
;}
;cO.push.apply(cO,cM.query(cJ[i]));}
;cO=cL.cast(cL.unique(cO),qx.bom.Collection);for(var i=0,cN=this.length;i<cN;i++){cO[cK](this[i]);}
;return this;}
,append:function(cP){return this.__us(arguments,this.__uu);}
,prepend:function(cQ){return this.__us(arguments,this.__uv);}
,__uu:function(cR,cS){cR.appendChild(cS);}
,__uv:function(cT,cU){cT.insertBefore(cU,cT.firstChild);}
,appendTo:function(cV){return this.__ut(arguments,h);}
,prependTo:function(cW){return this.__ut(arguments,b);}
,before:function(cX){return this.__us(arguments,this.__uw);}
,after:function(cY){return this.__us(arguments,this.__ux);}
,__uw:function(da,db){da.parentNode.insertBefore(db,da);}
,__ux:function(dc,dd){dc.parentNode.insertBefore(dd,dc.nextSibling);}
,insertBefore:function(de){return this.__ut(arguments,o);}
,insertAfter:function(df){return this.__ut(arguments,s);}
...
;dg.map(this.__uy).append(this);}
;return this;}
,__uy:function(di){while(di.firstChild){di=di.firstChild;}
;return di;}
...
,replaceAll:function(dl){return this.__ut(arguments,p);}
...
;}
;var ba,bc=[];for(var i=0,l=W.length;i<l;i++){ba=W[i];if(typeof ba===w){ba=this.__uh(ba,X);}
...
(function(){var j="url: ",i="Invalid state",h="head",g="script",f="load",e="Unknown response headers",d="abort",c="Received native readyState: loaded",b="readystatechange",a="Response header cannot be determined for ",D="opera",C="unknown",B="Open native request with ",A="Response headers cannot be determined for",z="Detected error",y="Send native request",x="on",w="timeout",v="Unknown environment key at this phase",u="Received native load",q="error",r="qx.debug",o="requests made with script transport.",p="loadend",m="",n="mshtml",k="browser.documentmode",l="engine.name",s="qx.debug.io",t="qx.bom.request.Script";qx.Bootstrap.define(t,{construct:function(){this.__Ad();this.__zX=qx.Bootstrap.bind(this._onNativeLoad,this);this.__zY=qx.Bootstrap.bind(this._onNativeError,this);this.__sy=qx.Bootstrap.bind(this._onTimeout,this);this.__Aa=document.head||document.getElementsByTagName(h)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__Af()?0:15000;}
,events:{"readystatechange":t,"error":t,"loadend":t,"timeout":t,"abort":t,"load":t},members:{readyState:null,status:null,statusText:null,timeout:null,__Ab:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(G,H){if(this.__sR){return;}
;this.__Ad();this.__sB=null;this.__sM=H;if(this.__Ai(s)){qx.Bootstrap.debug(qx.bom.request.Script,B+j+H);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__sR){return;}
;var K={};if(this.readyState!==1){throw new Error(i);}
;K[I]=J;this.__sM=qx.util.Uri.appendParamsToUrl(this.__sM,K);return this;}
,send:function(){if(this.__sR){return;}
;var N=this.__Ag(),L=this.__Aa,M=this;if(this.timeout>0){this.__dw=window.setTimeout(this.__sy,this.timeout);}
;if(this.__Ai(s)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;L.insertBefore(N,L.firstChild);window.setTimeout(function(){M._readyStateChange(2);M._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__sR){return;}
;this.__sB=true;this.__Ah();this._emit(d);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__sR){return;}
;if(this.__Ai(r)){qx.Bootstrap.debug(a+o);}
;return C;}
,getAllResponseHeaders:function(){if(this.__sR){return;}
;if(this.__Ai(r)){qx.Bootstrap.debug(A+o);}
;return e;}
,setDetermineSuccess:function(P){this.__Ab=P;}
,dispose:function(){var Q=this.__Ac;if(!this.__sR){if(Q){Q.onload=Q.onreadystatechange=null;this.__Ah();}
;if(this.__dw){window.clearTimeout(this.__dw);}
;this.__sR=true;}
;}
,_getUrl:function(){return this.__sM;}
,_getScriptElement:function(){return this.__Ac;}
,_onTimeout:function(){this.__Ae();if(!this.__Af()){this._emit(q);}
;this._emit(w);if(!this.__Af()){this._emit(p);}
;}
,_onNativeLoad:function(){var T=this.__Ac,R=this.__Ab,S=this;if(this.__sB){return;}
;if(this.__Ai(l)===n&&this.__Ai(k)<9){if(!(/loaded|complete/).test(T.readyState)){return;}
else {if(this.__Ai(s)){qx.Bootstrap.debug(qx.bom.request.Script,c);}
;}
;}
;if(this.__Ai(s)){qx.Bootstrap.debug(qx.bom.request.Script,u);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__Ai(s)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;}
;if(this.__dw){window.clearTimeout(this.__dw);}
;window.setTimeout(function(){S._success();S._readyStateChange(4);S._emit(f);S._emit(p);}
);}
,_onNativeError:function(){this.__Ae();this._emit(q);this._emit(p);}
,__Ac:null,__Aa:null,__sM:m,__zX:null,__zY:null,__sy:null,__dw:null,__sB:null,__sR:null,__Ad:function(){this.readyState=0;this.status=0;this.statusText=m;}
,_readyStateChange:function(U){this.readyState=U;this._emit(b);}
,_success:function(){this.__Ah();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=m+this.status;}
,__Ae:function(){this.__Ah();this.readyState=4;this.status=0;this.statusText=null;}
,__Af:function(){var W=this.__Ai(l)===n&&this.__Ai(k)<9;var V=this.__Ai(l)===D;return !(W||V);}
,__Ag:function(){var X=this.__Ac=document.createElement(g);X.src=this.__sM;X.onerror=this.__zY;X.onload=this.__zX;if(this.__Ai(l)===n&&this.__Ai(k)<9){X.onreadystatechange=this.__zX;}
;return X;}
,__Ah:function(){var Y=this.__Ac;if(Y&&Y.parentNode){this.__Aa.removeChild(Y);}
;}
,__Ai:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
