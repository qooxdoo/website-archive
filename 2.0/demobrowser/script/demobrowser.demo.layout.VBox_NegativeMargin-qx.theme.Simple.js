...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_NegativeMargin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Simple.1e27d2ac12cc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="demobrowser.demo.layout.VBox_NegativeMargin",h="yellow",g="gray",f="blue",e="center",d="green",c="left",b="right",a="main";qx.Class.define(i,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});scroll.add(j);j.add(this.getBox1());j.add(this.getBox2());j.add(this.getBox3());j.add(this.getBox4());j.add(this.getBox5());j.add(this.getBox6());j.add(this.getBox7());}
,getBox1:function(){var k=new qx.ui.layout.VBox();var m=new qx.ui.container.Composite(k).set({decorator:a,backgroundColor:h,width:140,allowGrowY:false});var o=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxWidth:100,alignX:c});var n=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d,maxWidth:100,alignX:e});var l=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxWidth:100,alignX:b});m.add(o);m.add(n);m.add(l);n.setMarginTop(-10);l.setMarginTop(-10);return m;}
,getBox2:function(){var p=new qx.ui.layout.VBox();var r=new qx.ui.container.Composite(p).set({decorator:a,backgroundColor:h,width:140,allowGrowY:false});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxWidth:100,alignX:c});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d,maxWidth:100,alignX:e});var q=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxWidth:100,alignX:b});r.add(t);r.add(s);r.add(q);s.setMarginTop(-10);s.setMarginBottom(20);q.setMarginTop(-10);return r;}
,getBox3:function(){var u=new qx.ui.layout.VBox();var w=new qx.ui.container.Composite(u).set({decorator:a,backgroundColor:h,width:140,height:300,allowGrowY:false});var y=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxWidth:100,alignX:c});var x=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d,maxWidth:100,alignX:e});var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxWidth:100,alignX:b});w.add(y,{flex:1});w.add(x,{flex:1});w.add(v,{flex:1});x.setMarginTop(-10);v.setMarginTop(-10);return w;}
,getBox4:function(){var z=new qx.ui.layout.VBox();var B=new qx.ui.container.Composite(z).set({decorator:a,backgroundColor:h,width:140,height:300,allowGrowY:false});var D=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxWidth:100,alignX:c});var C=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d,maxWidth:100,alignX:e});var A=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxWidth:100,alignX:b});B.add(D,{flex:1});B.add(C,{flex:2});B.add(A,{flex:3});C.setMarginTop(-10);A.setMarginTop(-10);return B;}
,getBox5:function(){var E=new qx.ui.layout.VBox();var G=new qx.ui.container.Composite(E).set({decorator:a,backgroundColor:h,width:140,height:300,allowGrowY:false});var I=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxWidth:100,alignX:c});var H=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d,maxWidth:100,alignX:e});var F=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxWidth:100,alignX:b});G.add(I,{flex:1});G.add(H,{flex:2});G.add(F,{flex:3});H.setMarginTop(-10);F.setMarginTop(-10);I.setHeight(0);H.setHeight(0);F.setHeight(0);return G;}
,getBox6:function(){var J=new qx.ui.layout.VBox();var L=new qx.ui.container.Composite(J).set({decorator:a,backgroundColor:h,width:140,height:100,allowGrowY:false});var N=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxWidth:100,alignX:c});var M=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d,maxWidth:100,alignX:e});var K=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxWidth:100,alignX:b});L.add(N,{flex:1});L.add(M,{flex:1});L.add(K,{flex:1});M.setMarginTop(-10);K.setMarginTop(-10);return L;}
,getBox7:function(){var O=new qx.ui.layout.VBox();var Q=new qx.ui.container.Composite(O).set({decorator:a,backgroundColor:h,width:140,height:100,allowGrowY:false});var S=new qx.ui.core.Widget().set({decorator:a,backgroundColor:f,maxWidth:100,alignX:c});var R=new qx.ui.core.Widget().set({decorator:a,backgroundColor:d,maxWidth:100,alignX:e});var P=new qx.ui.core.Widget().set({decorator:a,backgroundColor:g,maxWidth:100,alignX:b});Q.add(S,{flex:1});Q.add(R,{flex:2});Q.add(P,{flex:3});R.setMarginTop(-10);P.setMarginTop(-10);return Q;}
}});}
)();
