...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_Reversed","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Reversed-qx.theme.Modern.9ed51bdaa27f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="demobrowser.demo.layout.VBox_Reversed",k="yellow",j="gray",i="blue",h="green",g="click to reverse",f="top",d="bottom",c="middle",b="mousedown",a="main";qx.Class.define(l,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var m=new qx.ui.layout.VBox();var o=new qx.ui.container.Composite(m).set({decorator:a,backgroundColor:k,width:120});m.setSpacing(5);m.setReversed(true);var q=new qx.ui.core.Widget().set({decorator:a,backgroundColor:i,maxHeight:60,alignY:f});var p=new qx.ui.basic.Label(g).set({decorator:a,rich:true,backgroundColor:h,padding:5,height:60,maxHeight:60,alignY:c,allowGrowX:true,allowGrowY:true});var n=new qx.ui.core.Widget().set({decorator:a,backgroundColor:j,maxHeight:60,alignY:d});o.add(q);o.add(p);o.add(n);o.addListener(b,function(e){m.setReversed(!m.getReversed());}
