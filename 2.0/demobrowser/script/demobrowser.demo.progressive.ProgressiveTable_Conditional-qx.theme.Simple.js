...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Conditional","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional-qx.theme.Simple.6c4ea60475fe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="regex cannot be null!",u="font-weight",t="Condition not recognized or value1/value2 is null!",s="Condition not recognized or value is null!",r="text-align",q='g',p="qx.ui.progressive.renderer.table.cell.Conditional",o=":",n=";",m="color",e="font-style",l="==",h=">",c="between",b="regex",g="<",f="!between",j=">=",a="!=",k="<=",d="";qx.Class.define(p,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(w,x,y,z){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__JY=[l,a,h,g,j,k];this.__Ka=[c,f];this.__Kb=[];this.__xO=w||d;this.__xP=x||d;this.__xQ=y||d;this.__xR=z||d;}
,members:{__JY:null,__Ka:null,__Kb:null,__xO:null,__xP:null,__xQ:null,__xR:null,__xS:function(A,B){if(A.align){B[r]=A.align;}
;if(A.color){B[m]=A.color;}
;if(A.style){B[e]=A.style;}
;if(A.weight){B[u]=A.weight;}
;}
,addNumericCondition:function(C,D,E,F,G,H,I){if(!qx.lang.Array.contains(this.__JY,C)||D==null){throw new Error(s);}
;this.__Kb.push({condition:C,align:E,color:F,style:G,weight:H,value1:D,target:I});}
,addBetweenCondition:function(J,K,L,M,N,O,P,Q){if(!qx.lang.Array.contains(this.__Ka,J)||K==null||L==null){throw new Error(t);}
;this.__Kb.push({condition:J,align:M,color:N,style:O,weight:P,value1:K,value2:L,target:Q});}
,addRegex:function(R,S,T,U,V,W){if(!R){throw new Error(v);}
;this.__Kb.push({condition:b,align:S,color:T,style:U,weight:V,regex:R,target:W});}
,_getCellStyle:function(X){if(this.__Kb.length==0){return X.style||d;}
;var i;var bc;var Y;var bb={"text-align":this.__xO,"color":this.__xP,"font-style":this.__xQ,"font-weight":this.__xR};for(i=0;i<this.__Kb.length;i++){var bf=this.__Kb[i];bc=false;if(qx.lang.Array.contains(this.__JY,bf.condition)){if(bf.target==null){Y=X.cellData;}
...
;break;};}
else if(qx.lang.Array.contains(this.__Ka,bf.condition)){if(bf.target==null){Y=X.cellData;}
else {Y=X.element.data[bf.target];}
...
;;if(bc){this.__xS(bf,bb);}
;var bd=[];for(var be in bb){if(bb[be]){bd.push(be,o,bb[be],n);}
;}
;}
;return bd.join(d);}
},destruct:function(){this.__JY=this.__Ka=this.__Kb=null;}
});}
)();
