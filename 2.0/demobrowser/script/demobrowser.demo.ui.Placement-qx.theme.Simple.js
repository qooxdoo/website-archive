...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Placement","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Placement-qx.theme.Simple.f062d035525e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s="demobrowser.demo.ui.Placement",r="Open DOM-Popup",q="DOM Popup",p="Open Popup",o="Content",n="right-bottom",m="DOM align control",l="domanchor",k="left-top",j="mousedown",c="changeSelection",h="top-left",g="bottom-right",b="right-top",a="bottom-left",f="left-bottom",d="top-right";qx.Class.define(s,{extend:qx.application.Standalone,members:{__PI:null,main:function(){qx.application.Standalone.prototype.main.call(this);var t=this.getRoot();this.__PI=[a,g,h,d,b,n,k,f];t.add(this.createTestField(a),{left:20,top:20});t.add(this.createTestField(g),{right:20,top:20});t.add(this.createTestField(h),{right:20,bottom:20});t.add(this.createTestField(d),{left:20,bottom:20});t.add(this.createTestField(b),{left:20,top:250});t.add(this.createTestField(f),{right:20,top:250});t.add(this.createDomClick(),{left:200,top:100});}
,createTestField:function(u){var y=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var w=new qx.ui.popup.Popup(new qx.ui.layout.Grow);w.add(new qx.ui.basic.Atom(o));w.setPadding(20);var v=new qx.ui.form.SelectBox;var z=null;for(var i=0;i<this.__PI.length;i++){var x=new qx.ui.form.ListItem(this.__PI[i]);v.add(x);if(this.__PI[i]==u){z=x;}
;}
;y.add(v);v.addListener(c,function(e){w.setPosition(e.getData()[0].getLabel());}
);v.setSelection([z]);var A=new qx.ui.form.Button(p);y.add(A);A.addListener(j,function(e){w.placeToWidget(A);w.show();}
);return y;}
,createDomClick:function(){var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var F=new qx.ui.basic.Label(m);D.add(F);var C=new qx.ui.popup.Popup(new qx.ui.layout.Grow);C.add(new qx.ui.basic.Atom(q));C.setPadding(20);var B=new qx.ui.form.SelectBox;for(var i=0;i<this.__PI.length;i++){B.add(new qx.ui.form.ListItem(this.__PI[i]));}
;D.add(B);B.addListener(c,function(e){C.setPosition(e.getData()[0].getLabel());}
);var E=new qx.ui.form.Button(r);D.add(E);E.addListener(j,function(e){C.placeToElement(document.getElementById(l));C.show();}
);return D;}
