...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Shadow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.Shadow-qx.theme.Simple.c63eaa743f3d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="#D9D9D9",i="#1866B5",h="#24B",g="#FF0000",f="#CCCCCC",e="rgba(0, 0, 0, 0.4)",d="#FFFFE1",c="#B7B7B7",b="#BBBBBB",a="#9DCBFE",N="#A7A6AA",M="#EBEBEB",L="#666666",K="#CBC8CD",J="#F9F9F9",I="#F7F7F7",H="#808080",G="#686868",F="#888888",E="#E0ECFF",q="#2E3A46",r="css.rgba",o="#F5F5F5",p="#E3E3E3",m="#DDDDDD",n="#BBB",k="qx.theme.simple.Color",l="#F1F1F1",s="#939393",t="#BCBCBC",w="#134983",v="#E8F0E3",y="#FAFBFE",x="#AAAAAA",A="#5685D6",z="black",u="#6694E3",D="#EEE",C="gray",B="white";qx.Theme.define(k,{colors:{"background":B,"dark-blue":A,"light-background":E,"background-selected":u,"background-selected-dark":A,"background-disabled":I,"background-disabled-checked":b,"background-pane":y,"tabview-unselected":i,"tabview-button-border":w,"tabview-label-active-disabled":j,"link":h,"scrollbar-bright":l,"scrollbar-dark":M,"button":v,"button-border":n,"button-border-hovered":s,"invalid":g,"button-box-bright":J,"button-box-dark":p,"button-box-bright-pressed":m,"button-box-dark-pressed":o,"border-lead":F,"window-border":q,"window-border-inner":a,"white-box-border":t,"shadow":qx.core.Environment.get(r)?e:L,"border-main":u,"border-light":c,"border-light-shadow":G,"border-separator":H,"text":z,"text-disabled":N,"text-selected":B,"text-placeholder":K,"tooltip":d,"tooltip-text":z,"table-header":[242,242,242],"table-focus-indicator":[179,217,255],"table-header-cell":[235,234,219],"table-row-background-focused-selected":[90,138,211],"table-row-background-focused":[221,238,255],"table-row-background-selected":[51,94,168],"table-row-background-even":B,"table-row-background-odd":B,"table-row-selected":[255,255,255],"table-row":[0,0,0],"table-row-line":D,"table-column-line":D,"progressive-table-header":x,"progressive-table-row-background-even":[250,248,243],"progressive-table-row-background-odd":[255,255,255],"progressive-progressbar-background":C,"progressive-progressbar-indicator-done":f,"progressive-progressbar-indicator-undone":B,"progressive-progressbar-percent-background":C,"progressive-progressbar-percent-text":B}});}
)();
