...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Portal","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal-qx.theme.Modern.f597b7a66756.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="demobrowser.demo.bom.Portal",i="500px",h="200px",g="GroupBox Left",f="groupBoxRight",e="250px",d="120px",c="GroupBox Right",b="140px",a="groupBoxLeft",w="box2",v="box6",u="box0",t="box4",s="box1",r="box3",q="box7",p="box5",o="100px",n="300px",l="350px",m="700px",k="10px";qx.Class.define(j,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);boxData={groupBoxes:{"groupBoxLeft":{id:a,name:g,boxes:[u,s,w,r]},"groupBoxRight":{id:f,name:c,boxes:[t,p,v,q]}},boxes:{box0:{id:u,name:u,width:n,height:d,minWidth:k,maxWidth:l,minHeight:k,maxHeight:m,draggable:true,resizable:true,resizeHandles:1},box1:{id:s,name:s,width:n,height:o,minWidth:k,maxWidth:l,minHeight:k,maxHeight:m,draggable:true,resizable:false,resizeHandles:1},box2:{id:w,name:w,width:n,height:o,minWidth:k,maxWidth:l,minHeight:k,maxHeight:m,draggable:false,resizable:false,resizeHandles:0},box3:{id:r,name:r,width:n,height:o,minWidth:k,maxWidth:l,minHeight:k,maxHeight:m,draggable:true,resizable:true,resizeHandles:3},box4:{id:t,name:t,width:n,height:o,minWidth:k,maxWidth:l,minHeight:k,maxHeight:m,draggable:true,resizable:true,resizeHandles:1},box5:{id:p,name:p,width:e,height:h,minWidth:k,maxWidth:i,minHeight:k,maxHeight:m,draggable:true,resizable:true,resizeHandles:2},box6:{id:v,name:v,width:n,height:o,minWidth:k,maxWidth:l,minHeight:k,maxHeight:m,draggable:false,resizable:false,resizeHandles:0},box7:{id:q,name:q,width:n,height:b,minWidth:k,maxWidth:l,minHeight:k,maxHeight:m,draggable:true,resizable:true,resizeHandles:2}}};demobrowser.demo.bom.portal.box.Manager.getInstance().load();demobrowser.demo.bom.portal.dragdrop.Manager.getInstance();}
}});}
)();
(function(){var m="groupBoxes",h="demobrowser.demo.bom.portal.box.Manager",g="boxData",f="qx.event.type.Event",e="boxes",d="demobrowser.demo.bom.portal.box.Box",c="_applyActiveBox",b="loaded",a="singleton";qx.Class.define(h,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__Pe=[];this.__Pf=[];this.__Pg={};}
,statics:{dataKeyRoot:g,dataKeyGroupBoxes:m,dataKeyBoxes:e},events:{"loaded":f},properties:{activeBox:{init:null,check:d,apply:c}},members:{__Pe:null,__Pf:null,__Pg:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);}
;n.setActive(true);}
,load:function(){this.__bf(window[demobrowser.demo.bom.portal.box.Manager.dataKeyRoot]);qx.event.Registration.fireEvent(this,b);}
,__bf:function(p){var t,w,u,v,x,p;var q=p[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var s=p[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in q){t=q[w];u=t.boxes;w=t.id;v={id:w,element:document.getElementById(w)};this.__Pf.push(v);this.__Pg[w]=[];for(var k=0,l=u.length;k<l;k++){p=s[u[k]];var r=document.getElementById(p.id);var x=new demobrowser.demo.bom.portal.box.Box(p,r,null,w);this.__Pe.push(x);this.__Pg[w].push(x);}
;}
;}
,getBoxes:function(){return this.__Pe;}
,getGroupBoxes:function(){return this.__Pf;}
,updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());qx.lang.Array.remove(this.__Pg[z],A);qx.lang.Array.insertAt(this.__Pg[y],A,B);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__Pf.length,D;i<j;i++){D=this.__Pg[this.__Pf[i].id];for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__Pf[i];}
;}
;}
;return null;}
...
(function(){var s="click",r="1px solid #444444",q="height",p="position",o="zIndex",n="_applyActive",m="width",l="box_content",k=" It does contain no UI widget code at all.",j="relative",c="demobrowser.demo.bom.portal.box.Box",i="1px solid orange",g="This is a demo application showing the low-level capabilities.",b="div",a="String",f="<br/><br/>",d="border",h="Boolean";qx.Class.define(c,{extend:qx.core.Object,construct:function(t,u,v,w){qx.core.Object.call(this);this.__Ph=t;this.__bV=t.id;if(u!=null){qx.bom.element.Style.set(u,m,t.width);qx.bom.element.Style.set(u,q,t.height);this.__Pk(u,v);}
;this.setElement(u);this.setGroupBoxId(w);this.__Pi=null;this.__Pj=null;if(t.resizable){this.setResizable(true);var x={minWidth:parseInt(t.minWidth),minHeight:parseInt(t.minHeight),maxWidth:parseInt(t.maxWidth),maxHeight:parseInt(t.maxHeight),handles:t.resizeHandles};this.__Pi=new demobrowser.demo.bom.portal.box.Resizable(this,x);}
;if(t.draggable){this.setDraggable(true);this.__Pj=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__Pl();}
,properties:{element:{init:null},groupBoxId:{init:null,check:a},active:{check:h,init:false,apply:n},resizable:{check:h,init:false},draggable:{check:h,init:false}},members:{__bV:null,__Ph:null,__Pj:null,__Pi:null,_applyActive:function(y,z){if(y){qx.bom.element.Style.set(this.getElement(),d,i);}
else {qx.bom.element.Style.set(this.getElement(),d,r);}
;}
,getId:function(){return this.getElement()?this.getElement().id:null;}
,getData:function(){return this.__Ph;}
,getDraggableComponent:function(){return this.__Pj;}
,getResizableComponent:function(){return this.__Pi;}
,__Pk:function(A,B){if(B){for(var C in B){qx.bom.element.Style.set(C,B[C]);}
;}
;qx.bom.element.Style.set(A,p,j);qx.bom.element.Style.set(A,o,0);qx.bom.Element.addListener(A,s,this.__Pm,this,true);}
,__Pl:function(){var E=g+k;E=E+f+E+f+E;var D=qx.dom.Element.create(b,{"class":l});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__Pm:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__Ph=this.__Pi=this.__Pj=null;}
});}
)();
...
(function(){var u="south",t="mouseup",s="mousedown",r='px',q="width",p="_",o="height",n="px",m="east",l="div",d="demobrowser.demo.bom.portal.box.Resizable",k="southeast",h="Handle",c="mouseover",b="mouseout",g="visible",f="mousemove",i="orientation",a="hidden",j="visibility";qx.Class.define(d,{extend:qx.core.Object,construct:function(v,w){qx.core.Object.call(this);this.__Pn=v;this.__dJ=this.__Pn.getElement();this.__Po={};this.__Pp=false;this.__Pq={orientation:null,lastCoord:{left:null,top:null}};this.__Pr={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__Pr){if(w[name]){this.__Pr[name]=w[name];}
;}
;this.__Pk();}
,members:{__Pq:null,__Pn:null,__dJ:null,__Po:null,__Pr:null,__Pp:false,getBox:function(){return this.__Pn;}
,__Pk:function(){switch(this.__Pr.handles){case 1:this.__Po.east=null;break;case 2:this.__Po.south=null;break;case 3:this.__Po.south=null;this.__Po.southeast=null;this.__Po.east=null;break;};for(var y in this.__Po){var x=this.__Po[y]=qx.dom.Element.create(l);qx.bom.element.Attribute.set(x,i,y);qx.dom.Element.insertEnd(x,this.__dJ);if(this.__dJ.id){x.id=this.__dJ.id+p+y;}
;this.__Ps(y);this.__Pt(y);}
;}
,__Ps:function(z){qx.bom.element.Class.add(this.__Po[z],z+h);qx.bom.element.Style.set(this.__Po[z],j,this.__Pr.autoHide?a:g);}
,__Pt:function(A){var C=qx.event.Registration;var B=this.__Po[A];C.addListener(B,s,this.__Pw,this);C.addListener(document,t,this.__Px,this);if(this.__Pr.autoHide){C.addListener(this.__Pn.getElement(),c,this.__Pu,this);C.addListener(this.__Pn.getElement(),b,this.__Pv,this);}
;}
,__Pu:function(e){for(var D in this.__Po){qx.bom.element.Style.set(this.__Po[D],j,g);}
;}
,__Pv:function(e){if(!this.__Pp){for(var E in this.__Po){qx.bom.element.Style.set(this.__Po[E],j,a);}
;}
;}
,__Pw:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,f,this.__Py,this,true);this.__Pp=true;var F=e.getTarget();this.__Pq.orientation=qx.bom.element.Attribute.get(F,i);this.__Pq.lastCoord.left=e.getDocumentLeft();this.__Pq.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__dJ);}
;}
,__Px:function(e){e.stopPropagation();if(this.__Pp){qx.event.Registration.removeListener(document,f,this.__Py,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__dJ);if(this.__Pr.autoHide){for(var G in this.__Po){qx.bom.element.Style.set(this.__Po[G],j,a);}
;}
;this.__Pp=false;qx.bom.Selection.clear(document.body);}
;}
,__Py:function(e){e.stopPropagation();if(this.__Pp){var H={left:null,top:null};switch(this.__Pq.orientation){case u:H.top=e.getDocumentTop();break;case k:H.top=e.getDocumentTop();H.left=e.getDocumentLeft();break;case m:H.left=e.getDocumentLeft();break;};this.__Pz(H,this.__Pq.lastCoord);this.__Pq.lastCoord.left=e.getDocumentLeft();this.__Pq.lastCoord.top=e.getDocumentTop();}
;}
,__Pz:function(I,J){var Q=qx.bom.element.Dimension;var N=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Pn.getId());var P=Q.getContentSize(N.element);if(I.left){var M=I.left-J.left;if(M!==0){var L=Q.getContentWidth(this.__dJ)+M;var O=Q.getWidth(this.__dJ)+M;if((this.__Pr.minWidth==null||L>this.__Pr.minWidth)&&(this.__Pr.maxWidth==null||L<=this.__Pr.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__dJ,q,L+r);this.__Pn.getData().width=L;}
;}
;}
;}
;if(I.top){var M=I.top-J.top;if(M!==0){var K=Q.getContentHeight(this.__dJ)+M;if((this.__Pr.minHeight==null||K>this.__Pr.minHeight)&&(this.__Pr.maxHeight==null||K<=this.__Pr.maxHeight)){qx.bom.element.Style.set(this.__dJ,o,K+n);}
;}
;}
;}
},destruct:function(){if(this.__Pr.autoHide){qx.event.Registration.removeListener(this.__Pn.getElement(),c,this.__Pu,this);qx.event.Registration.removeListener(this.__Pn.getElement(),b,this.__Pv,this);}
;this.__Pn=this.__Pr=this.__dJ=this.__Po=null;this.__Pq=null;}
});}
)();
...
(function(){var c="auto",b="demobrowser.demo.bom.portal.box.Util",a="zIndex";qx.Class.define(b,{statics:{__PA:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,a);e=e==c?0:e;qx.bom.element.Style.set(d,a,e+this.__PA);}
,sendToBack:function(f){var g=qx.bom.element.Style.get(f,a);qx.bom.element.Style.set(f,a,g-this.__PA);}
}});}
)();
...
(function(){var k="mouseup",j="mousedown",i="mouseover",h="drag",g="dragend",f="move",d="demobrowser.demo.bom.portal.box.Draggable",c="cursor",b="mousemove",a="dragstart";qx.Class.define(d,{extend:qx.core.Object,construct:function(l){qx.core.Object.call(this);this.__Pn=l;this.__dJ=l.getElement();this.__PB=null;this.__PC=null;this.__Pk();}
,members:{__Pn:null,__dJ:null,__PB:null,__PC:null,getBox:function(){return this.__Pn;}
,getElement:function(){return this.__dJ;}
,__Pk:function(){this.__PD();this.__Pt();}
,__PD:function(){this.__PB=qx.dom.Element.create("div");qx.bom.element.Class.add(this.__PB,"dragHandle");qx.dom.Element.insertBegin(this.__PB,this.__dJ);}
,__Pt:function(){qx.bom.Element.addListener(this.__PB,j,this.__nB,this);qx.bom.Element.addListener(this.__PB,i,function(e){qx.bom.element.Style.set(this,c,f);}
,this.__PB);qx.bom.Element.addListener(this.__PB,a,this.__sr,this);qx.bom.Element.addListener(this.__PB,g,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__PB,h,this.__PG,this);}
,__nB:function(e){if(e.isLeftPressed()){this.__PC={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__dJ),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__dJ)};qx.bom.Element.addListener(document.body,k,this.__PF,this,true);this.__PE();qx.event.Registration.fireEvent(this.__PB,a,qx.event.type.Event);}
;}
,__PE:qx.core.Environment.select("engine.name",{"mshtml":function(){var n=this;var m=qx.lang.Function.bind(this.__PF,n);document.getElementsByTagName("html")[0].onmouseleave=m;}
,"default":qx.lang.Function.empty}),__PF:function(e){try{e.stopPropagation();}
catch(o){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,"mousemove",this.__PG,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,"mouseup",this.__PF,this,true);}
,__sr:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__Pn);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__Pn);qx.event.Registration.addListener(document.body,b,this.__PG,this,true);}
,__PG:function(e){e.stopPropagation();var p=e.getDocumentLeft()-this.__PC.left;var top=e.getDocumentTop()-this.__PC.top;qx.event.Timer.once(function(){this.checkGroupBox(p,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,p);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__Pn=this.__PB=this.__dJ=this.__PC=null;}
});}
)();
(function(){var m="Boolean",l="left",k="demobrowser.demo.bom.portal.dragdrop.Manager",h="end",g="border",f="top",d="demobrowser.demo.bom.portal.box.Box",c="ease-out",b="singleton",a="px";qx.Class.define(k,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__PH={top:null,height:null};this.__PI={top:0,left:0};}
,properties:{activeBox:{check:d,init:null,nullable:true},sessionActive:{check:m,init:false}},members:{__PH:null,__PJ:null,__PK:false,__PI:null,__PL:null,__PM:null,startSession:function(n){this.setSessionActive(true);this.setActiveBox(n);this.__PJ=n.getGroupBoxId();this.__PN();if(this.__PL==null){this.__PL={};var o=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=o.length;i<j;i++){this.__PL[o[i].element.id]={left:qx.bom.element.Location.getLeft(o[i].element),right:qx.bom.element.Location.getLeft(o[i].element)+qx.bom.element.Dimension.getWidth(o[i].element)};}
;}
;}
,__PN:function(){if(!this.__PM){this.__PM=qx.dom.Element.create("div");}
;var r=this.getActiveBox().getElement();var p=qx.bom.element.Dimension.getContentSize(r);this.__PO(r,this.__PM);qx.bom.element.Class.add(this.__PM,qx.bom.element.Class.get(r));var q="opacity:0.5;margin:0;position:absolute;"+"top:"+qx.bom.element.Location.getTop(r)+"px;"+"left:"+qx.bom.element.Location.getLeft(r)+"px;"+"width:"+p.width+"px;"+"height:"+p.height+"px";qx.bom.element.Style.setCss(this.__PM,q);qx.bom.element.Style.set(r,"border","1px dashed red");qx.dom.Node.getBodyElement(r).appendChild(this.__PM);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__PM);}
,__PO:function(s,t){while(s.firstChild){t.appendChild(s.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var y=this.getActiveBox();var v=y.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(y.getGroupBoxId(),this.__PJ,y);y.setGroupBoxId(this.__PJ);var x={left:qx.bom.element.Location.getLeft(this.__PM)+a,top:qx.bom.element.Location.getTop(this.__PM)+a};var w={left:qx.bom.element.Location.getLeft(v)+a,top:qx.bom.element.Location.getTop(v)+a};var z={timing:c,duration:300,keep:100,keyFrames:{'0':x,'100':w}};var u=qx.bom.element.Animation.animate(this.__PM,z);u.addListener(h,function(){this.__PO(this.__PM,v);qx.bom.element.Style.reset(v,g);this.__PM.parentNode.removeChild(this.__PM);if(y.isActive()){y._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(y);}
;}
,this);}
,onDragMove:function(top,A){if(this.__PI.left!=A){qx.bom.element.Style.set(this.__PM,l,A+a);}
;if(this.__PI.top!=top){qx.bom.element.Style.set(this.__PM,f,top+a);}
;var B=this.getActiveBox().getElement();if(this.__PH.top==null){this.__PH.top=qx.bom.element.Location.getTop(B);}
;if(this.__PH.height==null){this.__PH.height=qx.bom.element.Dimension.getHeight(B);}
;if(this.__PK==false&&top>=this.__PH.top&&top<=(this.__PH.top+this.__PH.height)){return;}
;var C;if(this.__PK){C=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__PJ));while(C!=null){if(this.__PP(true,top,B,C)){this.__PK=false;return;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {C=B;}
;if(top-this.__PI.top>0){C=qx.dom.Hierarchy.getNextElementSibling(C);while(C!=null){if(C){if(this.__PP(true,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getNextElementSibling(C);}
;}
else {var C=qx.dom.Hierarchy.getPreviousElementSibling(C);while(C!=null){if(C){if(this.__PP(false,top,B,C)){return;}
;}
;C=qx.dom.Hierarchy.getPreviousElementSibling(C);}
;}
;this.__PI.left=A;this.__PI.top=top;}
,__PP:function(D,top,E,F){var G=qx.bom.element.Location.getTop(F);var I=parseInt(qx.bom.element.Style.get(F,"paddingTop"));var J=parseInt(qx.bom.element.Style.get(F,"paddingBottom"));var H=qx.bom.element.Dimension.getContentHeight(F)+J+I;var K;if(D){if(top>=(G+(H/3))){K=qx.dom.Hierarchy.getNextElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertAfter(E,F);this.__PH.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
else {if(top<=(G+H*2/3)){K=qx.dom.Hierarchy.getPreviousElementSibling(F);if(K!=E||K==null){qx.dom.Element.insertBefore(E,F);this.__PH.top=qx.bom.element.Location.getTop(E);}
;return true;}
;}
;return false;}
,checkGroupBox:function(L,M){if(this.__PL[this.__PJ].left<=L&&this.__PL[this.__PJ].right>=L){return;}
;for(var N in this.__PL){if(N!=this.__PJ){if(this.__PL[N].left<=L+M&&this.__PL[N].right>=L){this.__PJ=N;this.__PK=true;return;}
;}
;}
;}
},destruct:function(){this.__PH=this.__PI=this.__PJ=null;this.__PQ=this.__PM=this.__PL=null;}
});}
)();
...
(function(){var b="qx.bom.element.Animation",a="css.animation";qx.Bootstrap.define(b,{statics:{animate:function(c,d,e){if(qx.core.Environment.get(a)){return qx.bom.element.AnimationCss.animate(c,d,e);}
else {return qx.bom.element.AnimationJs.animate(c,d,e);}
;}
,animateReverse:function(f,g,h){if(qx.core.Environment.get(a)){return qx.bom.element.AnimationCss.animateReverse(f,g,h);}
else {return qx.bom.element.AnimationJs.animateReverse(f,g,h);}
;}
}});}
)();
...
(function(){var k="No 'keyFrames' given > 0",j="end",i="Anni",h="keyFrames",g="The key 'reverse' is deprecated: Please use the method ",f="Keyframe position needs to be between 0 and 100",d="duration",c=":",b="} ",a="Unknown key '",E="' in the animation description.",D="end-event",C="css.animation",B="ms ",A="% {",z="'animateReverse' instead.",y="linear",x=";",w="qx.bom.element.AnimationCss",v="keyframes",r="repeat",s="timing",p="keep",q="origin",n="reverse",o="alternate",l="qx.debug",m="name",t="",u=" ";qx.Bootstrap.define(w,{statics:{__Bb:null,__Bc:i,__bV:0,__Bd:{},__Be:{"scale":true,"rotate":true,"skew":true,"translate":true},__Bf:qx.core.Environment.get(C),animateReverse:function(F,G,H){return this._animate(F,G,H,true);}
,animate:function(I,J,K){return this._animate(I,J,K,false);}
,_animate:function(L,M,N,O){this.__Bi(M);if(M.hasOwnProperty(n)){O=M.reverse;if(qx.core.Environment.get(l)){qx.log.Logger.warn(g+z);qx.log.Logger.trace();}
;}
;if(qx.core.Environment.get(l)){this.__Bj(M);}
;if(!this.__Bb){this.__Bb=qx.bom.Stylesheet.createElement();}
;var S=M.keyFrames;if(N==undefined){N=M.duration;}
;if(this.__Bf!=null){var name=this.__Bk(S,O);var Q=name+u+N+B+M.repeat+u+M.timing+u+(M.alternate?o:t);var P=this.__Bf[D];qx.bom.Event.addNativeListener(L,P,this.__Bg);L.style[qx.lang.String.camelCase(this.__Bf[m])]=Q;}
;var R=new qx.bom.element.AnimationHandle();R.desc=M;R.el=L;L.$$animation=R;if(M.origin!=null){qx.bom.element.Transform.setOrigin(L,M.origin);}
;if(this.__Bf==null){window.setTimeout(function(){qx.bom.element.AnimationCss.__Bg({target:L});}
,0);}
;return R;}
,__Bg:function(e){var T=e.target;var U=T.$$animation;if(!U){return;}
;var W=U.desc;if(qx.bom.element.AnimationCss.__Bf!=null){var V=qx.lang.String.camelCase(qx.bom.element.AnimationCss.__Bf[m]);T.style[V]=t;qx.bom.Event.removeNativeListener(T,qx.bom.element.AnimationCss.__Bf[m],qx.bom.element.AnimationCss.__Bg);}
;if(W.origin!=null){qx.bom.element.Transform.setOrigin(T,t);}
;if(W.keep!=null){qx.bom.element.AnimationCss.__Bh(T,W.keyFrames[W.keep]);}
;T.$$animation=null;U.el=null;U.ended=true;U.emit(j,T);}
,__Bh:function(X,Y){var bb;for(var ba in Y){if(ba in qx.bom.element.AnimationCss.__Be){if(!bb){bb={};}
;bb[ba]=Y[ba];}
else {X.style[qx.lang.String.camelCase(ba)]=Y[ba];}
;}
;if(bb){qx.bom.element.Transform.transform(X,bb);}
;}
,__Bi:function(bc){if(!bc.hasOwnProperty(o)){bc.alternate=false;}
;if(!bc.hasOwnProperty(p)){bc.keep=null;}
;if(!bc.hasOwnProperty(r)){bc.repeat=1;}
;if(!bc.hasOwnProperty(s)){bc.timing=y;}
;if(!bc.hasOwnProperty(q)){bc.origin=null;}
;}
,__Bj:qx.core.Environment.select(l,{"true":function(bd){var be=[q,d,p,h,r,s,o,n];for(var name in bd){if(!(be.indexOf(name)!=-1)){qx.Bootstrap.warn(a+name+E);}
;}
;if(bd.keyFrames==null){qx.Bootstrap.warn(k);}
else {for(var bf in bd.keyFrames){if(bf<0||bf>100){qx.Bootstrap.warn(f);}
;}
;}
;}
,"default":null}),__Bk:function(frames,bg){var bj=t;for(var bm in frames){bj+=(bg?-(bm-100):bm)+A;var bi=frames[bm];var bl;for(var bh in bi){if(bh in this.__Be){if(!bl){bl={};}
;bl[bh]=bi[bh];}
else {bj+=bh+c+bi[bh]+x;}
;}
;if(bl){bj+=qx.bom.element.Transform.getCss(bl);}
;bj+=b;}
;if(this.__Bd[bj]){return this.__Bd[bj];}
;var name=this.__Bc+this.__bV++;var bk=this.__Bf[v]+u+name;qx.bom.Stylesheet.addRule(this.__Bb,bk,bj);this.__Bd[bj]=name;return name;}
}});}
)();
...
(function(){var g="Element",f="qx.bom.element.AnimationHandle",e="play-state",d="paused",c="running",b="",a="css.animation";qx.Bootstrap.define(f,{extend:qx.event.Emitter,construct:function(){var h=qx.core.Environment.get(a);this.__BQ=h&&h[e];this.__BR=true;}
,events:{"end":g},members:{__BQ:null,__BR:false,__BS:false,isPlaying:function(){return this.__BR;}
,isEnded:function(){return this.__BS;}
,pause:function(){if(this.el){this.el.style[this.__BQ]=d;this.el.$$animation.__BR=false;if(this.animationId&&qx.bom.element.AnimationJs){qx.bom.element.AnimationJs.pause(this);}
;}
;}
,play:function(){if(this.el){this.el.style[this.__BQ]=c;this.el.$$animation.__BR=true;if(this.i!=undefined&&qx.bom.element.AnimationJs){qx.bom.element.AnimationJs.play(this);}
;}
;}
,stop:function(){if(this.el&&qx.core.Environment.get(a)){this.el.style[this.__BQ]=b;this.el.style[qx.core.Environment.get(a).name]=b;this.el.$$animation.__BR=false;this.el.$$animation.__BS=true;}
...
(function(){var t="css.transform",s=" ",r="qx.bom.element.Transform",q="hidden",p="Z",o=";",n=":",m="backface-visibility",l="name",k="perspective",d="visible",j="(",g=") ",c="X",b="Y",f="origin",e="style",h="perspective-origin",a="";qx.Bootstrap.define(r,{statics:{__Bs:[c,b,p],__Bt:qx.core.Environment.get(t),transform:function(u,v){var x=this.__Bu(v);if(this.__Bt!=null){var w=this.__Bt[l];u.style[w]=x;}
;}
,translate:function(y,z){this.transform(y,{translate:z});}
,scale:function(A,B){this.transform(A,{scale:B});}
,rotate:function(C,D){this.transform(C,{rotate:D});}
,skew:function(E,F){this.transform(E,{skew:F});}
,getCss:function(G){var I=this.__Bu(G);if(this.__Bt!=null){var H=this.__Bt[l];return qx.lang.String.hyphenate(H)+n+I+o;}
;return a;}
,setOrigin:function(J,K){if(this.__Bt!=null){J.style[this.__Bt[f]]=K;}
;}
,getOrigin:function(L){if(this.__Bt!=null){return L.style[this.__Bt[f]];}
;return a;}
,setStyle:function(M,N){if(this.__Bt!=null){M.style[this.__Bt[e]]=N;}
;}
,getStyle:function(O){if(this.__Bt!=null){return O.style[this.__Bt[e]];}
;return a;}
,setPerspective:function(P,Q){if(this.__Bt!=null){P.style[this.__Bt[k]]=Q;}
;}
,getPerspective:function(R){if(this.__Bt!=null){return R.style[this.__Bt[k]];}
;return a;}
,setPerspectiveOrigin:function(S,T){if(this.__Bt!=null){S.style[this.__Bt[h]]=T;}
;}
,getPerspectiveOrigin:function(U){if(this.__Bt!=null){var W=U.style[this.__Bt[h]];if(W!=a){return W;}
else {var X=U.style[this.__Bt[h]+c];var V=U.style[this.__Bt[h]+b];if(X!=a){return X+s+V;}
;}
;}
;return a;}
,setBackfaceVisibility:function(Y,ba){if(this.__Bt!=null){Y.style[this.__Bt[m]]=ba?d:q;}
;}
,getBackfaceVisibility:function(bb){if(this.__Bt!=null){return bb.style[this.__Bt[m]]==d;}
;return true;}
,__Bu:function(bc){var bf=a;for(var be in bc){var bd=bc[be];if(qx.Bootstrap.isArray(bd)){for(var i=0;i<bd.length;i++){if(bd[i]==undefined){continue;}
;bf+=be+this.__Bs[i]+j;bf+=bd[i];bf+=g;}
;}
else {bf+=be+j+bc[be]+g;}
;}
;return bf;}
}});}
)();
(function(){var h="The key 'reverse' is deprecated: Please use the method ",g="reverse",f="qx.debug",e="qx.bom.element.AnimationJs",d="'animateReverse' instead.",c="end";qx.Bootstrap.define(e,{statics:{__Bz:30,__BA:["%","in","cm","mm","em","ex","pt","pc","px"],animate:function(k,l,m){return this._animate(k,l,m,false);}
,animateReverse:function(n,o,p){return this._animate(n,o,p,true);}
,_animate:function(q,r,s,t){if(q.$$animation){return;}
;if(r.hasOwnProperty(g)){t=r.reverse;if(qx.core.Environment.get(f)){qx.log.Logger.warn(h+d);qx.log.Logger.trace();}
;}
;if(s==undefined){s=r.duration;}
;var z=r.keyFrames;var v=this.__BH(z);var w=this.__BG(s,v);var A=parseInt(s/w,10);this.__BB(z,q);var B=this.__BC(A,w,v,z,s,r.timing);if(t){B.reverse();}
;var u=new qx.bom.element.AnimationHandle();u.desc=r;u.el=q;u.delta=B;u.stepTime=w;u.steps=A;q.$$animation=u;u.i=0;u.initValues={};u.repeatSteps=this.__BE(A,r.repeat);return this.play(u);}
,__BB:function(C,D){var E={};for(var H in C){for(var name in C[H]){if(E[name]==undefined){var F=C[H][name];if(typeof F=="string"){E[name]=F.substring((parseInt(F,10)+"").length,F.length);}
else {E[name]="";}
;}
;}
;}
;for(var H in C){var G=C[H];for(var name in E){if(G[name]==undefined){if(window.getComputedStyle){G[name]=getComputedStyle(D,null)[name];}
else {G[name]=D.style[name];}
;if(G[name]==""&&this.__BA.indexOf(E[name])!=-1){G[name]="0"+E[name];}
;}
;}
;}
;}
,__BC:function(I,J,K,L,M,N){var V=new Array(I);var X=1;V[0]=L[0];var P=L[0];var R=L[K[X]];for(var i=1;i<V.length;i++){if(i*J/M*100>K[X]){P=R;X++;R=L[K[X]];}
;V[i]={};for(var name in R){var W=R[name]+"";if(W.charAt(0)=="#"){var Q=qx.util.ColorUtil.cssStringToRgb(P[name]);var U=qx.util.ColorUtil.cssStringToRgb(W);var O=[];for(var j=0;j<Q.length;j++){var S=Q[j]-U[j];O[j]=parseInt(Q[j]-S*this.__BD(N,i/I),10);}
;V[i][name]=qx.util.ColorUtil.rgbToHexString(O);}
else if(!isNaN(parseInt(W,10))){var T=W.substring((parseInt(W,10)+"").length,W.length);var S=parseFloat(W)-parseFloat(P[name]);V[i][name]=(parseFloat(P[name])+S*this.__BD(N,i/I))+T;}
else {V[i][name]=P[name]+"";}
;}
;}
;V[V.length-1]=L[100];return V;}
,play:function(Y){var ba=window.setInterval(function(){Y.repeatSteps--;var bb=Y.delta[Y.i%Y.steps];if(Y.i==0){for(var name in bb){if(Y.initValues[name]==undefined){if(qx.bom.element.Style){Y.initValues[name]=qx.bom.element.Style.get(Y.el,qx.lang.String.camelCase(name));}
else {Y.initValues[name]=Y.el.style[qx.lang.String.camelCase(name)];}
;}
;}
;}
;qx.bom.element.AnimationJs.__BF(Y.el,bb);Y.i++;if(Y.i%Y.steps==0){if(Y.desc.alternate){Y.delta.reverse();}
;}
;if(Y.repeatSteps<0){qx.bom.element.AnimationJs.stop(Y);}
;}
,Y.stepTime);Y.animationId=ba;return Y;}
,pause:function(bc){window.clearInterval(bc.animationId);bc.animationId=null;}
,stop:function(bd){var bg=bd.desc;var be=bd.el;var bf=bd.initValues;window.clearInterval(bd.animationId);if(bg.keep!=undefined){this.__BF(be,bg.keyFrames[bg.keep]);}
else {this.__BF(be,bf);}
;be.$$animation=null;bd.el=null;bd.ended=true;bd.animationId=null;bd.emit(c,be);}
,__BD:function(bh,x){if(bh=="ease-in"){var a=[3.1223e-7,0.0757,1.2646,-0.167,-0.4387,0.2654];}
else if(bh=="ease-out"){var a=[-7.0198e-8,1.652,-0.551,-0.0458,0.1255,-0.1807];}
else if(bh=="linear"){return x;}
else if(bh=="ease-in-out"){var a=[2.482e-7,-0.2289,3.3466,-1.0857,-1.7354,0.7034];}
else {var a=[-0.0021,0.2472,9.8054,-21.6869,17.7611,-5.1226];}
;;;var y=0;for(var i=0;i<a.length;i++){y+=a[i]*Math.pow(x,i);}
;return y;}
,__BE:function(bi,bj){if(bj==undefined){return bi;}
;if(bj=="infinite"){return Number.MAX_VALUE;}
;return bi*bj;}
,__BF:function(bk,bl){for(var bm in bl){if(bl[bm]===undefined){continue;}
;var name=qx.lang.String.camelCase(bm);if(qx.bom.element.Style){qx.bom.element.Style.set(bk,name,bl[bm]);}
else {bk.style[name]=bl[bm];}
;}
;}
,__BG:function(bn,bo){var bq=100;for(var i=0;i<bo.length-1;i++){bq=Math.min(bq,bo[i+1]-bo[i]);}
;var bp=bn*bq/100;while(bp>this.__Bz){bp=bp/2;}
;return Math.round(bp);}
,__BH:function(br){var bs=qx.Bootstrap.getKeys(br);for(var i=0;i<bs.length;i++){bs[i]=parseInt(bs[i],10);}
