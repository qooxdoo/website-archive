...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.75fe4f30ccb9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var bL="_leftComposite",bK="^.*",bJ="filled",bI="changeValue",bH="?qxenv:demobrowser.withTests:true",bG="__Ox",bF="demobrowser.DemoBrowser",bE="_infosplit",bD="_history",bC="_status",br="__OA",bq="instead.",bp="_searchTextField",bo="f1",bn="__Or",bm='changeSelection',bl="Couldn't load file: ",bk="logappender",bj=".html",bi="__Oz",bS="f2",bT="visible",bQ="ig",bR="success",bO="__OC",bP="noPlayground",bM="__kD",bN='excluded',bU="_urlWindow",bV='_cmdDisposeSample',bv="__Om",bu="toolbar",bx="tree1",bw="demo/welcome.html",bz='_cmdSampleInOwnWindow',by=".*",bB=" ",bA='demo/',bt="default",bs="__OB",a="index.html",b="when using the file protocol. Please try the http protocol ",c="Filter...",d="qx.theme.Indigo",f="/playground/",g='label',h="changeState",n="icon/16/actions/edit-find.png",o="_",p="__kF",ca="__Ow",bY="__OE",bX="right",bW="main",ce='_cmdObjectSummary',cd="Info",cc="_prevButton",cb="file:",cg='_cmdNextSample',cf="The security settings of your browser may prohibit AJAX ",R="_tree",S="2.0",P="left",Q=".",V='_cmdPrevSample',W='_cmdRunSample',T="excluded",U="http://demo.qooxdoo.org/",N="bottom-left",O="Failed to load demo data from the file system.\n\n",B="right-top",A="runbutton",D="_runbutton",C="_demoView",x="_navPart",w="?qx.theme=",z="textfield",y="mainsplit",v="app-header",q="Demo Browser",bc="_nextButton",bd="app-splitpane",be="__Oy",bf="__Oq",X="fail",Y="_iframe",ba="node",bb="horizontal",bg='execute',bh='value',L="~",K="widget",J="interval",I="modelLink",H="tags",G="value",F="",E="/",M="enabled";qx.Class.define(bF,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__kD={};var ck=new qx.ui.layout.VBox;this.setLayout(ck);this.add(this._createHeader());this.widgets={};this.tests={};this.__Ol=d;this.__OF();this.__Om=this.__OM();this.add(this.__Om);var co=new qx.ui.splitpane.Pane(bb);co.setAppearance(bd);this.mainsplit=co;var cl=new qx.ui.splitpane.Pane(bb);cl.setDecorator(null);this._infosplit=cl;this.add(co,{flex:1});var cq=this._leftComposite=new qx.ui.container.Composite();cq.setLayout(new qx.ui.layout.VBox(3));co.add(cq,0);{}
;var cj=new qx.ui.container.Composite();cj.setLayout(new qx.ui.layout.HBox(3));cj.setAppearance(z);cq.add(cj);var cr=new qx.ui.basic.Image(n);cj.add(cr);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(K);this._searchTextField.setPlaceholder(c);var cp=new qx.event.Timer(500);cp.addListener(J,function(cs){this.filter(this._searchTextField.getValue());cp.stop();}
,this);this._searchTextField.addListener(bI,function(ct){cp.restart();}
,this);cj.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(F);this._status.setAppearance(K);this._status.setWidth(80);this._status.setTextAlign(bX);cj.add(this._status);co.add(cl,1);this._tree=this.__OQ();cq.add(this._tree,{flex:1});this.__OR();this._demoView=this.__ON();cl.add(this._demoView,2);var ch=this.__On=this.__OO();var ci=this.__Oo=this.__OP();var cm=this.__Op=new qxc.ui.logpane.LogView();cm.setDecorator(null);var cn=this.__cG=new qx.ui.container.Stack();cn.setDecorator(bW);cn.add(ch);cn.add(ci);cn.add(cm);cl.add(cn,1);cn.resetSelection();cn.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(h,function(e){var cu=e.getData().replace(L,E);if(this._currentSample!=cu){this.setCurrentSample(cu);}
;}
,this);this.__Oq=[this.__Ow,this.__Ox,this.__OA];this.__Oq.push(this.__Ou);this.__Oq.push(this.__Oy);this.__Oq.push(this.__OC);this.__Or=new qx.event.Timer(250);this.__Or.addListener(J,this.__OT,this);this.__Or.start();this.__Os=new demobrowser.InfoWindow(this.tr(cd));this.__Os.setAutoCenter(true);}
,members:{_iframe:null,__Ol:null,__Or:null,__Ot:null,_tree:null,_status:null,_searchTextField:null,__Ou:null,__Ov:null,__Oq:null,_versionFilter:null,_navPart:null,__Ow:null,__Ox:null,__Oy:null,__Oz:null,__OA:null,__OB:null,__OC:null,__Om:null,_leftComposite:null,_infosplit:null,_demoView:null,__kF:null,__kD:null,__OD:null,_urlWindow:null,__Os:null,__cG:null,__On:null,__Oo:null,__Op:null,__OE:null,defaultUrl:bw,playgroundUrl:U+S+f,__OF:function(){this._cmdObjectSummary=new qx.ui.core.Command("Ctrl+O");this._cmdObjectSummary.addListener("execute",this.__OH,this);this._cmdRunSample=new qx.ui.core.Command("F5");this._cmdRunSample.addListener("execute",this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command("Ctrl+Left");this._cmdPrevSample.addListener("execute",this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command("Ctrl+Right");this._cmdNextSample.addListener("execute",this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command("Ctrl+N");this._cmdSampleInOwnWindow.addListener("execute",this.__OI,this);this._cmdDisposeSample=new qx.ui.core.Command("Ctrl+D");this._cmdDisposeSample.addListener("execute",this.__OL,this);}
,__OG:function(e){var cy=e.getTarget()===this.__OE?this.__OD:this.__OE;var cx=e.getData()[0];if(cy&&cx){cy.setModelSelection([cx.getModel()]);}
;var cv=cx!=null?cx.getUserData("value"):"";switch(cv){case "html":this.__cG.setSelection([this.__On]);this.__cG.show();break;case "js":this.__cG.setSelection([this.__Oo]);this.__cG.show();break;case "log":this.__cG.setSelection([this.__Op]);this.__cG.show();break;default:this.__cG.resetSelection();this.__cG.exclude();};}
,__OH:function(){var cA=this._iframe.getWindow();var cz;if(cA&&cA.qx){cz=cA.qx.dev.ObjectSummary.getInfo();}
else {cz="Unable to access namespace. Maybe no demo loaded.";}
;var cB=new qx.ui.form.TextArea(cz);cB.setDecorator(null);cB.setAutoSize(true);cB.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__Os.setContent(cB);this.__Os.setWidth(400);this.__Os.show();}
,__OI:function(){var cC=this._iframe.getSource();window.open(cC,"_blank");}
,__OJ:function(cD){var cE=!!cD;var cF=this._tree.getSelection()[0].getUserData("tags");if(cF){cE=cE&&!qx.lang.Array.contains(cF,"noPlayground");}
;this.__Ou.setEnabled(cE);this.__Ov=cD;}
,__OK:function(){if(this.__Ov){var cI=this.__Ov;var cH='{"code": '+'"'+encodeURIComponent(cI)+'"}';var cG=this.playgroundUrl+"#"+encodeURIComponent(cH);window.open(cG,"_blank");}
else {var cJ=new qx.ui.basic.Label(this.tr("Could not open the Playground."));this.__Os.setContent(cJ);this.__Os.setWidth(200);this.__Os.show();}
;}
,__GO:function(){window.open("http://demo.qooxdoo.org/"+"2.0"+"/apiviewer/");}
,__GP:function(){var cK=("2.0".split("-")[0]);window.open("http://manual.qooxdoo.org/"+cK);}
,_onHideShowTests:function(event){var cM=window.location.search;var cN=window.location.hash;var cL=a;if(cM==F){cL+=bH;}
;cL+=cN;location.replace(cL);}
,__OL:function(e){var cP=this._iframe.getWindow();var cO;if(cP&&cP.qx){cP.qx.core.ObjectRegistry.shutdown();cO=this.tr("Demo has been disposed.");}
else {cO=this.tr("Unable to access application.");}
;var cQ=new qx.ui.basic.Label(cO);cQ.setRich(true);cQ.setWrap(true);this.__Os.setContent(cQ);this.__Os.setWidth(350);this.__Os.show();}
,__OM:function(){var dp=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr("Run"),"icon/22/actions/media-playback-start.png");this._runbutton.addListener("execute",this.runSample,this);this._runbutton.setToolTipText("Run the selected demo");dp.add(this._runbutton);var ds=new qx.ui.toolbar.Part();dp.add(ds);var da=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");da.addListener("execute",this.playPrev,this);da.setToolTipText("Run previous demo");ds.add(da);this._prevButton=da;var dm=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");dm.addListener("execute",this.playNext,this);dm.setToolTipText("Run next demo");ds.add(dm);this._nextButton=dm;var dd={converter:function(dx){return dx=="visible";}
};qx.data.SingleValueBinding.bind(this._runbutton,"visibility",da,"enabled",dd);qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dm,"enabled",dd);var dv=this._navPart=new qx.ui.toolbar.Part();dp.add(dv);var dw=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");dw.addListener("execute",this.__OI,this);dw.setToolTipText("Open demo in new window");this.__Ow=dw;dv.add(dw);var dj=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");dj.addListener("execute",this.__OK,this);dj.setToolTipText("Open demo in the playground");dj.setEnabled(false);if(qx.core.Environment.get("browser.name")=="ie"){dj.exclude();}
;this.__Ou=dj;dv.add(dj);var cU=new qx.ui.toolbar.Part();dp.add(cU);var dh=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");cU.add(dh);dh.setToolTipText(this.tr("Open the qooxdoo API Viewer"));dh.addListener("execute",this.__GO,this);var cS=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");cU.add(cS);cS.setToolTipText(this.tr("Open the qooxdoo Manual"));cS.addListener("execute",this.__GP,this);var dq=new qx.ui.toolbar.Part;dp.add(dq);var dl=new qx.ui.menu.Menu;this.__Oz=dl;var db=new qx.ui.menu.RadioButton("Modern Theme");var dt=new qx.ui.menu.RadioButton("Classic Theme");var du=new qx.ui.menu.RadioButton("Simple Theme");var dr=new qx.ui.menu.RadioButton("Indigo Theme");db.setUserData("value","qx.theme.Modern");dt.setUserData("value","qx.theme.Classic");du.setUserData("value","qx.theme.Simple");dr.setUserData("value","qx.theme.Indigo");dr.setValue(true);var de=new qx.ui.form.RadioGroup(db,dt,du,dr);de.addListener("changeSelection",this.__OX,this);dl.add(dr);dl.add(db);dl.add(dt);dl.add(du);var dc=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dl);this.__Oy=dc;dc.setToolTipText("Choose theme");dq.add(dc);var df=new qx.ui.menu.Menu;var dg=new qx.ui.menu.Button(this.tr("Object Summary"));this.__OC=dg;dg.setCommand(this._cmdObjectSummary);df.add(dg);var cX=new qx.ui.menu.Button(this.tr("Dispose Demo"));this.__OA=cX;cX.setCommand(this._cmdDisposeSample);df.add(cX);df.addSeparator();var cV=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));cV.setValue(!!qx.core.Environment.get("demobrowser.withTests"));cV.addListener("changeValue",this._onHideShowTests,this);df.add(cV);var cY=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",df);this.__OB=cY;cY.setToolTipText("Debugging options");dq.add(cY);var di=new qx.ui.toolbar.Part;this.__Ox=di;dp.addSpacer();dp.add(di);var dn=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");dn.setToolTipText("Display HTML source");dn.setModel('html');var cW=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");cW.setToolTipText("Display JavaScript source");cW.setModel('js');dn.setUserData("value","html");cW.setUserData("value","js");di.add(dn);di.add(cW);var dk=new qx.ui.toolbar.RadioButton("Log File","icon/22/apps/utilities-log-viewer.png");dk.setToolTipText("Display log file");dk.setUserData("value","log");dk.setModel('log');di.add(dk);var cR=this.__OE=new qx.ui.form.RadioGroup;cR.setAllowEmptySelection(true);cR.add(dk);cR.addListener('changeSelection',this.__OG,this);cR.add(dn,cW);dp.setOverflowHandling(true);var cT=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");cT.setAppearance("toolbar-button");dp.add(cT);dp.setOverflowIndicator(cT);dp.setRemovePriority(di,6);dp.setRemovePriority(dq,5);dp.setRemovePriority(cU,4);dp.setRemovePriority(dv,3);dp.setRemovePriority(ds,2);dp.setRemovePriority(this._navPart,1);this.__kF=new qx.ui.menu.Menu();cT.setMenu(this.__kF);dp.addListener("hideItem",this._onHideItem,this);dp.addListener("showItem",this._onShowItem,this);return dp;}
,_onHideItem:function(e){var dy=e.getData();var dz=this._getMenuItems(dy);for(var i=0,l=dz.length;i<l;i++){dz[i].setVisibility(bT);if(dy===this.__Oy&&!(dz[i] instanceof qx.ui.menu.Separator)){dz[i].getMenu().setPosition(B);}
;}
;}
,_onShowItem:function(e){var dA=e.getData();var dC=this._getMenuItems(dA);for(var i=0,l=dC.length;i<l;i++){dC[i].setVisibility(T);}
;if(dA===this.__Oy){var dB=dA.getMenuButtons();for(var i=0,l=dB.length;i<l;i++){dB[i].getMenu().setPosition(N);}
;}
;}
,_getMenuItems:function(dD){var dF=[];if(dD instanceof qx.ui.toolbar.Part){var dK=dD.getChildren();var dJ=null;var dE=false;var dG=this.__kF.getChildren();if(dD!=this.__Ox){dJ=this.__kD[dD.toHashCode()];if(!dJ){dJ=new qx.ui.menu.Separator();this.__kF.addBefore(dJ,dG[0]);this.__kD[dD.toHashCode()]=dJ;}
;dF.push(dJ);}
else {dE=true;}
;for(var i=0,l=dK.length;i<l;i++){if(dK[i].getVisibility()==bN){continue;}
;var dH=this.__kD[dK[i].toHashCode()];if(!dH){if(dK[i] instanceof qx.ui.toolbar.RadioButton){dH=new qx.ui.menu.RadioButton(dK[i].getLabel());dH.setToolTipText(dK[i].getToolTipText());dH.setEnabled(dK[i].getEnabled());dH.setUserData(bh,dK[i].getUserData(bh));dH.setModel(dK[i].getModel());dK[i].bind(M,dH,M);dK[i].bind(G,dH,G);dH.bind(G,dK[i],G);if(!this.__OD){this.__OD=new qx.ui.form.RadioGroup();this.__OD.setAllowEmptySelection(true);this.__OD.addListener(bm,this.__OG,this);}
;this.__OD.add(dH);}
else if(dK[i] instanceof qx.ui.toolbar.MenuButton){dH=new qx.ui.menu.Button(dK[i].getLabel().translate(),dK[i].getIcon(),dK[i].getCommand(),dK[i].getMenu());dH.setToolTipText(dK[i].getToolTipText());dH.setEnabled(dK[i].getEnabled());dK[i].bind(M,dH,M);}
else if(dK[i] instanceof qx.ui.toolbar.Button){dH=new qx.ui.menu.Button(dK[i].getLabel().translate(),dK[i].getIcon());dH.getChildControl(g,false).setRich(true);dH.setTextColor(dK[i].getTextColor());dH.setToolTipText(dK[i].getToolTipText());dH.setEnabled(dK[i].getEnabled());dK[i].bind(M,dH,M);var dI=qx.event.Registration.getManager(dK[i]).getListeners(dK[i],bg);if(dI&&dI.length>0){for(var j=0,k=dI.length;j<k;j++){dH.addListener(bg,qx.lang.Function.bind(dI[j].handler,dI[j].context));}
;}
;}
else if(dK[i] instanceof qx.ui.toolbar.CheckBox){dH=new qx.ui.menu.CheckBox(dK[i].getLabel());dH.setToolTipText(dK[i].getToolTipText());dH.setEnabled(dK[i].getEnabled());dK[i].bind(M,dH,M);}
else {dH=new qx.ui.menu.Separator();}
;;;if(dE){this.__kF.add(dH);}
else {this.__kF.addBefore(dH,dJ);}
;this.__kD[dK[i].toHashCode()]=dH;}
;dF.push(dH);}
;}
;return dF;}
,__ON:function(){var dL=new qx.ui.embed.Iframe().set({nativeContextMenu:true});dL.addListener("load",this.__OS,this);this._iframe=dL;return dL;}
,__OO:function(){var dM=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");dM.setOverflow("auto","auto");dM.setFont("monospace");dM.setBackgroundColor("white");this.widgets["outputviews.sourcepage.html.page"]=dM;dM.getContentElement().setAttribute("id","qx_srcview");return dM;}
,__OP:function(){var dN=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");dN.setOverflow("auto","auto");dN.setFont("monospace");dN.setBackgroundColor("white");this.widgets["outputviews.sourcepage.js.page"]=dN;dN.getContentElement().setAttribute("id","qx_srcview");return dN;}
,__OQ:function(){var dP=new qx.ui.tree.Tree();var dO=new qx.ui.tree.TreeFolder("Demos");dP.setAppearance("demo-tree");dP.setRoot(dO);this.tree=this.widgets["treeview.flat"]=dP;dP.addListener("changeSelection",this.treeGetSelection,this);dP.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return dP;}
,__OR:function(){var dQ=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");dQ.setLayout(new qx.ui.layout.VBox(10));dQ.setAllowMaximize(false);dQ.setAllowMinimize(false);var dT=new qx.ui.basic.Label("");dT.setSelectable(true);dT.setNativeContextMenu(true);dQ.add(dT);this._urlWindow=dQ;var dU=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(dU<0){dU=0;}
;var top=Math.ceil((qx.bom.Viewport.getHeight()/2)-25);if(top<0){top=0;}
;dQ.moveTo(dU,top);this.getApplicationRoot().add(dQ);var dR=new qx.ui.menu.Menu();var dS=new qx.ui.menu.Button(this.tr("Get Demo Link"),"icon/22/mimetypes/text-html.png");dS.addListener("execute",function(e){var dW=this.tree.getSelection()[0];var dY=dW.getUserData("modelLink");var dV=this.tests.handler.getFullName(dY);dV=dV.replace(".","~");var dX=location.protocol+"//"+location.host+location.pathname+"#"+dV;this._urlWindow.getChildren()[0].setValue(dX);this._urlWindow.open();}
,this);dR.add(dS);this._tree.setContextMenu(dR);}
,treeGetSelection:function(e){var ea=this.tree.getSelection()[0];this._runbutton.setEnabled(!ea.hasChildren());var eb=ea.getUserData(I);this.tests.selected=this.tests.handler.getFullName(eb);}
,leftReloadTree:function(e){this._sampleToTreeNodeMap={};var ec=this._sampleToTreeNodeMap;var ei=null;var ek=null;var eh=this._history.getState();var ef=eh.match(/([^~]+)~/);if(ef){ei=ef[1];}
else {var ed=eh.match(/([^~][\w]*)/);if(ed){ei=ed[1];}
;}
;function ej(el,em){var eq=em.getChildren();var t;for(var i=0;i<eq.length;i++){var en=eq[i];if(en.hasChildren()){t=new qx.ui.tree.TreeFolder(ee.polish(en.label));t.setUserData(bJ,false);t.setUserData(ba,en);ej(t,t.getUserData(ba));if(en.label==ei){ek=t;t.setOpen(true);}
;}
else {if(!en.type){continue;}
;t=new qx.ui.tree.TreeFile(ee.polish(en.label));var ep=en.pwd().slice(1).join(E)+E+en.label;if(en.tags){var j,m,eo;t.setUserData(H,en.tags);{}
;}
;ec[ep]=t;}
;el.add(t);t.setUserData(I,en);en.widgetLinkFull=t;}
;}
;var eg=this.tests.handler.ttree;var ee=this;this.tree.setUserData(I,eg);this.tree.getRoot().setOpen(true);ej(this.tree.getRoot(),eg);{}
;if(ek!=null){this.tree.setSelection([ek]);}
else {this.tree.setSelection([this.tree.getRoot()]);}
;}
,runSample:function(e){if(this.tests.selected&&this.tests.selected!=F){var er=this.tests.selected.replace(Q,E);this.setCurrentSample(er);}
else {this.playNext();}
;}
,setCurrentSample:function(es){if(!es){return;}
;if(!this._sampleToTreeNodeMap){return;}
;var et;var ew=this._sampleToTreeNodeMap[es];if(ew){ew.getTree().setSelection([ew]);et=bA+es;et+=w+this.__Ol;var eu=ew.getUserData(H);if(eu){this.__Ou.setEnabled(!qx.lang.Array.contains(eu,bP));}
;}
else {et=this.defaultUrl;}
;if(this._iframe.getSource()==et){this._iframe.reload();}
else {this.__Ot=false;this._iframe.setSource(et);}
;if(et==this.defaultUrl){this.disableMenuButtons();}
else {this.enableMenuButtons();}
;this._currentSample=es;this._currentSampleUrl=et;}
,__OS:function(){var eB=this._iframe.getWindow();var eH=this._iframe.getSource();if(eH!=null&&eH!=this.defaultUrl){var eA;try{eA=eB.location.href;}
catch(eJ){eA=window.location.href;var eI=eA.lastIndexOf("/");if(eI!=-1){eA=eA.substring(0,eI+1);}
;eA+=eH;}
;var eF=eA.indexOf("/demo/")+6;var eC=eA.indexOf("?");eC=eC==-1?eA.length:eC;var eD=eA.substring(eF,eC).split("/");var eG=String.fromCharCode(187);if(eD.length==2){var ey=eD[0];ey=ey.charAt(0).toUpperCase()+ey.substring(1);var eE=eD[1].replace(".html","").replace("_"," ");eE=eE.charAt(0).toUpperCase()+eE.substring(1);var ez="qooxdoo "+eG+" Demo Browser "+eG+" "+ey+" "+eG+" "+eE;}
else {var ez="qooxdoo "+eG+" Demo Browser "+eG+" Start";}
;document.title=ez;}
;}
,__OT:function(e){var eK=this._iframe.getWindow();try{if(eK&&eK.qx&&eK.qx.log&&eK.qx.log.appender){if(!this.__Ot){this.__Ot=true;this.debug("Demo loaded: "+this._currentSample);this.__Op.clear();try{this.__Op.fetch(eK.qx.log.Logger);}
catch(e){return;}
...
;}
catch(eL){this.__Ot=false;}
;}
,filter:function(eM){var eU=new RegExp(bK+eM+by,bQ);var eS=this._tree.getRoot().getItems(true,true);var eT=0;var eN=0;for(var i=0;i<eS.length;i++){var eV=eS[i];var parent=eV.getParent();var eR=eV.getUserData(H);var eO=false;if(eR!=null){for(var j=0;j<eR.length;j++){eO=!!eR[j].match(eU);if(eO){break;}
;}
;}
;if(eV.getChildren().length==0){eN++;}
;if((eO||(eV.getLabel().search(eU)!=-1)||(parent.getLabel().search(eU)!=-1))){if(eV.getChildren().length==0){eT++;}
;eV.show();eV.getParent().setOpen(true);eV.getParent().show();}
else {eV.exclude();}
;}
;if(eM==F){var eQ=this._tree.getRoot().getItems(false,true);var eP=this._tree.getSelection();for(var i=0;i<eQ.length;i++){if(eQ[i]==eP[0]||eQ[i]==eP[0].getParent()){continue;}
;eQ[i].setOpen(false);}
;}
;this._status.setValue(eT+E+eN);}
,__OU:function(eW){if(typeof (eW)!="string"){return;}
;var eX=new qx.io.request.Xhr(eW);eX.setTimeout(180000);eX.addListener("success",function(eY){var content=eY.getTarget().getResponse();if(content){var fc=content.indexOf("<script",content.indexOf("<script")+7);var fi=content.indexOf("src",fc);var fb=content.indexOf("\"",fi+5);var fd=content.substring(fi+5,fb);var fg=fd.substring(4,fd.length-3)+".src.js";var u="script/demobrowser.demo";var ff=eW.split('/');var fe=ff[1];var fh=ff[2];fh=fh.substr(0,fh.indexOf('.html'));u+="."+fe+"."+fh+".src.js";fg=u;var fa=new qx.io.request.Xhr(fg);fa.setTimeout(18000);fa.addListener("success",function(){var fj=fa.getResponse();this.__OJ(fj);if(fj){this.widgets["outputviews.sourcepage.js.page"].setHtml(this.__OV(fj,"javascript"));}
;}
,this);fa.addListener("fail",function(){this.error("Couldn't load file: "+eW);}
,this);fa.send();this.widgets["outputviews.sourcepage.html.page"].setHtml(this.__OV(content));}
;}
,this);eX.addListener("fail",function(fk){this.error("Couldn't load file: "+eW);}
,this);eX.send();}
,dataLoader:function(fl){var fm=new qx.io.request.Xhr(fl);fm.setTimeout(180000);fm.addListener(bR,function(fn){var content=fn.getTarget().getResponse();if(!content){if(window.location.protocol==cb){alert(O+cf+b+bq);}
;return;}
;var fo=eval(content);qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(fo);this.leftReloadTree();var fp=this._history.getState();if(fp){this.setCurrentSample(fp.replace(L,E));}
else {this.setCurrentSample(this.defaultUrl);}
;}
,this,0);}
,this);fm.addListener(X,function(fq){this.error(bl+fl);}
,this);fm.send();}
,playPrev:function(e){var fu=this.tree.getSelection()[0];if(fu){var fr=this.tree.getPreviousNodeOf(fu,false);if(!fr||fr==this.tree.getRoot()){return;}
;while(fr.isVisible&&!fr.isVisible()){fr=this.tree.getPreviousNodeOf(fr,false);}
;if(fr.getParent()==this.tree.getRoot()){var ft=this.tree.getPreviousNodeOf(fr,false);while(ft.isVisible&&!ft.isVisible()){ft=this.tree.getPreviousNodeOf(ft,false);}
;if(ft.getParent()==this.tree.getRoot()){ft.setOpen(true);var fs=this.tree.getPreviousNodeOf(fr,false);while(fs.isVisible&&!fs.isVisible()){fs=this.tree.getPreviousNodeOf(fs,false);}
;if(ft!==fs){fr=fs;}
;}
else {fr=ft;}
;}
;if(!fr||fr===fu){return;}
else {this.tree.setSelection([fr]);this.runSample();}
;}
;}
,playNext:function(e){this._nextButton.setEnabled(true);this._prevButton.setEnabled(true);var fx=this.tree.getSelection()[0];if(fx){var fv=this.tree.getNextNodeOf(fx);if(!fv){return;}
;if(fv.getParent()==this.tree.getRoot()){fv.setOpen(true);fv=this.tree.getNextNodeOf(fv);}
;if(!fv){return;}
;while(!fv.isVisible()){var fw=this.tree.getNextNodeOf(fv);if(!fw){return;}
;if(fw.getParent()==this.tree.getRoot()){fv.setOpen(true);var fw=this.tree.getNextNodeOf(fw);}
;fv=fw;}
;if(fv){this.tree.setSelection([fv]);this.runSample();}
;}
;}
,__OV:function(fy,fz){var fA=new qx.util.StringBuilder("<pre class='script'>");var fC=[];var fD=new qx.util.StringBuilder();var fE=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var fB=/^\s*<\/script>\s*$/i;fy=fy.replace(/\r\n/g,"\n").replace(/\r/g,"\n");var fC=fy.split('\n');if(fz=="javascript"){return "<pre ><div class='script'>"+qx.dev.Tokenizer.javaScriptToHtml(fy)+"</div></pre>";}
;for(var i=0;i<fC.length;i++){if(fE.exec(fC[i])){fA.add(this.__OW(qx.bom.String.escape(fD.get()+fC[i])));fD.clear();}
else if(fB.exec(fC[i])){var fF=qx.dev.Tokenizer.javaScriptToHtml(fD.get());fA.add('<div class="script">',fF,'</div>');fD.clear();fD.add(fC[i],'\n');}
else {fD.add(fC[i],'\n');}
;}
;fA.add(this.__OW(qx.bom.String.escape(fD.get())),"</pre>");return fA.get();}
,disableMenuButtons:function(){var fG=this.__Oq;for(var i=0;i<fG.length;i++){fG[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var fH=this.__Oq;for(var i=0;i<fH.length;i++){fH[i].setEnabled(true);}
;}
,__OW:function(fI){var fK=fI;function fJ(fL){var s=new qx.util.StringBuilder(arguments[1],'<span class="html-tag-name">',arguments[2],'</span>');var fM;var fN=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){fM=arguments[i];if(fM=="/"){fN=true;break;}
else {var m=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;var r;while((r=m.exec(fM))!=null){s.add(' <span class="keyword">',r[1],'</span>=<span class="string">',r[2].replace(/\s*$/,""),'</span>');}
;}
;}
;s.add((fN?"/":""));}
;s.add('&gt;');return s.get();}
;fK=fK.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,fJ);return fK;}
,polish:function(fO){return fO.replace(bj,F).replace(o,bB);}
,__OX:function(e){this.__Ol=e.getData()[0].getUserData("value");this.runSample();}
,_createHeader:function(){var fR=new qx.ui.layout.HBox();var fP=new qx.ui.container.Composite(fR);fP.setAppearance(v);var fS=new qx.ui.basic.Label(q);var fQ=new qxc.ui.versionlabel.VersionLabel();fQ.setFont(bt);fP.add(fS);fP.add(new qx.ui.core.Spacer,{flex:1});fP.add(fQ);return fP;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(y,bx,P,A,bu,bo,bS,bD,bk,ce,W,V,cg,bz,bV,br,bs,x,D,ca,be,bi,bG,bY,bv,bE,bp,bC,R,Y,C,bf,bO,bn,bL,bU,bc,cc,bM,p);}
});}
)();
...
(function(){var m="separator-vertical",k="__Hp",j="_applyShowLogLevel",h="Boolean",g="qxc.ui.logpane.LogView",f='',d="Debug",c="Log",b="auto",a="icon/16/actions/edit-clear.png",K="Clear",J="DIV",I="middle",H="icon/16/status/dialog-information.png",G="Warning",F="Log Level",E="Error",D="appear",C="main",B="changeLogLevel",t="Info",u="bold",r="icon/16/status/dialog-error.png",s="monospace",p="icon/16/status/dialog-warning.png",q="scroll",n="warn",o="execute",v="error",w="info",y="model",x="icon/16/categories/system.png",A="white",z="debug";qx.Class.define(g,{extend:qx.ui.container.Composite,construct:function(){this.__Ho=[[z,d,x],[w,t,H],[n,G,p],[v,E,r]];var O=new qx.ui.layout.VBox();O.setSeparator(m);qx.ui.container.Composite.call(this,O);this.setDecorator(C);var M=new qx.ui.basic.Label(this.tr(c)).set({font:u,padding:10,alignY:I,allowGrowX:true,allowGrowY:true});this.__EJ=new qx.ui.toolbar.ToolBar();this.__EJ.add(M);this.__EJ.addSpacer();this.__EJ.setBackgroundColor(A);var L=new qx.ui.toolbar.Button(this.tr(K),a);L.addListener(o,function(e){this.clear();}
,this);this.__EJ.add(L);this.add(this.__EJ);var N=new qx.ui.embed.Html(f);N.set({backgroundColor:A,overflowY:q,overflowX:b,font:s,padding:3});this.add(N,{flex:1});this.__Hp=new qx.log.appender.Element();qx.log.Logger.unregister(this.__Hp);this.__Hq=document.createElement(J);this.__Hp.setElement(this.__Hq);N.addListenerOnce(D,function(){N.getContentElement().getDomElement().appendChild(this.__Hq);}
,this);}
,properties:{showLogLevel:{check:h,apply:j,init:false},logLevel:{check:[z,w,n,v],init:z,event:B}},members:{__Hq:null,__Hp:null,__Ho:null,__Hr:null,__EJ:null,clear:function(){this.__Hp.clear();}
,fetch:function(P){if(!P){P=qx.log.Logger;}
;P.register(this.__Hp);P.clear();}
,getAppenderElement:function(){return this.__Hq;}
,_applyShowLogLevel:function(Q,R){if(!this.__Hr){this.__Hr=this.__Hs();this.__EJ.add(this.__Hr);}
;if(Q){this.__Hr.show();}
else {this.__Hr.exclude();}
;}
,__Hs:function(){var S=new qx.ui.menu.Menu();var V=new qx.ui.toolbar.MenuButton(F,x);V.setMenu(S);for(var i=0,l=this.__Ho.length;i<l;i++){var U=this.__Ho[i];var T=new qx.ui.menu.Button(U[1],U[2]);T.setUserData(y,U[0]);T.addListener(o,function(W){var X=W.getTarget();this.setLogLevel(X.getUserData(y));V.setIcon(X.getIcon());}
,this);S.add(T);}
;return V;}
},destruct:function(){this._disposeObjects(k);this.__Hq=null;}
});}
)();
...
,properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__BT:null,_getContentContainer:function(){if(!this.__BT){this.__BT=new qx.ui.container.Composite(new qx.ui.layout.VBox());this.__BT.setMinHeight(20);}
;return this.__BT;}
...
(function(){var g="qxc.ui.versionlabel.VersionLabel",f="qooxdoo",e=" ",d="2.0",c="versionLabel.name",b="",a="versionLabel.version";qx.Class.define(g,{extend:qx.ui.basic.Label,construct:function(h,i){if(h==undefined){h=qx.core.Environment.get(c);}
