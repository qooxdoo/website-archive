...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager-qx.theme.Modern.986b3b0ce844.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="One-shot 1-second timer: ",e="__Hg",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";qx.Class.define(d,{extend:qx.application.Standalone,members:{__Hg:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();i.start(function(j,k){this.__QS(c+k);}
...
,__QS:function(p){p=Date.parse(new Date)+" "+p+"\n";this.__Hg.setValue(this.__Hg.getValue()+p);}
...
,this);var t=new qx.ui.form.TextArea();t.set({width:400,height:300});this.__Hg=t;q.add(t);q.add(s);this.getRoot().add(q,{left:20,top:10});}
