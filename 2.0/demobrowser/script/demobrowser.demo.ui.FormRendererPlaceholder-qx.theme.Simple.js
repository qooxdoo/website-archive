...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererPlaceholder","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererPlaceholder-qx.theme.Simple.dc895a5026dc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="Name",j="Registration",i="demobrowser.demo.ui.FormRendererPlaceholder",h="Send",g="send...",f="Bio",e="Country",d="Personal Information",c="Password",b="Reset",a="execute";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var m=new qx.ui.form.Form();m.addGroupHeader(j);var l=new qx.ui.form.TextField();l.setRequired(true);m.add(l,k);var q=new qx.ui.form.PasswordField();q.setRequired(true);m.add(q,c);m.addGroupHeader(d);m.add(new qx.ui.form.TextField(),e);m.add(new qx.ui.form.TextArea(),f);var o=new qx.ui.form.Button(h);o.addListener(a,function(){if(m.validate()){alert(g);}
;}
,this);m.addButton(o);var n=new qx.ui.form.Button(b);n.addListener(a,function(){m.reset();}
,this);m.addButton(n);var p=new qx.ui.form.renderer.SinglePlaceholder(m);this.getRoot().add(p,{left:10,top:10});}
}});}
)();
...
(function(){var b="Only widgets with placeholders supported.",a="qx.ui.form.renderer.SinglePlaceholder";qx.Class.define(a,{extend:qx.ui.form.renderer.Single,implement:qx.ui.form.renderer.IFormRenderer,members:{addItems:function(c,d,e){if(e!=null){this._add(this._createHeader(e),{row:this._row,column:0,colSpan:2});this._row++;}
;for(var i=0;i<c.length;i++){if(c[i].setPlaceholder===undefined){throw new Error(b);}
;c[i].setPlaceholder(d[i]);this._add(c[i],{row:this._row,column:0});this._row++;}
;}
}});}
)();
