...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Animation_Compare","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_Compare-qx.theme.Modern.69b483d34179.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Reverse",l="demobrowser.demo.animation.Animation_Compare",k="1%",j="10%",g="JavaScript Animation",f="infinite",d="#124589",c="2em",b="60px",a="20%",Q="CSS3 Animation",P="ease",O="30px",N="200px",M="linear",L="0.3",K="Stop",J="400px",I="Play",H="2",t="1",u="ease-in-out",r="none",s="red",p="#00FF00",q="ease-in",n="-50px",o="ease-out",v="Pause",w="h1",z="1em",y="50px",B="40px",A="button",D="10px",C="100px",x="div",G="click",F="-10px",E="0px";qx.Class.define(l,{extend:qx.application.Native,members:{createButton:function(name,R){var S=[];var U=[qx.bom.element.AnimationCss,qx.bom.element.AnimationJs];for(var i=0;i<U.length;i++){var T=document.createElement(x);T.innerHTML=name;T.className=A;S[i]=T;}
;var V=(function(W,name){return function(e){if(name.indexOf(m)!=-1){qx.bom.element.AnimationCss.animateReverse(S[0],W);qx.bom.element.AnimationJs.animateReverse(S[1],W);}
else {qx.bom.element.AnimationCss.animate(S[0],W);qx.bom.element.AnimationJs.animate(S[1],W);}
;}
;}
)(R,name);qx.bom.Event.addNativeListener(S[0],G,V);qx.bom.Event.addNativeListener(S[1],G,V);return S;}
,main:function(){qx.application.Native.prototype.main.call(this);var bk={duration:1000,keyFrames:{'0':{"width":C},'70':{"width":N},'100':{"width":C}}};var be={duration:1000,keyFrames:{'0':{"height":B},'70':{"height":b},'100':{"height":B}}};var bl={duration:500,keyFrames:{'0':{"opacity":1},'50':{"opacity":0},'100':{"opacity":1}}};var bt={duration:500,keep:100,keyFrames:{'0':{"opacity":1},'100':{"opacity":0,display:r}}};var bd={duration:500,keyFrames:{'0':{"left":E,"top":E},'80':{"left":y,"top":C},'100':{"left":E,"top":E}}};var bf={duration:500,keyFrames:{'0':{"left":E},'30':{"left":F},'60':{"left":D},'80':{"left":F},'100':{"left":E}}};var ba={duration:500,keyFrames:{'0':{"left":E,"top":E},'30':{"left":F,"top":F},'60':{"left":D,"top":F},'80':{"left":F,"top":D},'100':{"left":E,"top":E}}};var by={duration:1000,keep:[70],keyFrames:{'0':{"width":O},'70':{"width":C},'100':{"width":y}}};var bn={duration:1000,keyFrames:{'0':{"line-height":t},'88':{"line-height":H},'100':{"line-height":L}}};var X={duration:2000,keyFrames:{'0':{"font-size":z},'88':{"font-size":c},'100':{"font-size":z}}};var bb={duration:1000,keyFrames:{'0':{"width":j},'40':{"width":a},'100':{"width":k}}};var bw={duration:1000,keyFrames:{'0':{"color":s},'50':{"color":d},'100':{"color":p}}};var bz={duration:500,repeat:2,keyFrames:{'0':{"top":E},'50':{"top":F},'100':{"top":E}}};var bh={duration:500,alternate:true,repeat:2,keyFrames:{'0':{"top":E},'100':{"top":n}}};var Y={duration:1000,timing:q,keep:100,keyFrames:{'0':{"left":E},'100':{"left":J}}};var bo=qx.lang.Object.clone(Y);bo.timing=o;var br=qx.lang.Object.clone(Y);br.timing=M;var bg=qx.lang.Object.clone(Y);bg.timing=P;var bi=qx.lang.Object.clone(Y);bi.timing=u;var bs={duration:1000,keyFrames:{'0':{},'50':{"opacity":0},'100':{}}};var bp={"Width":bk,"Height":be,"Fade":bl,"FadeOut":bt,"Move":bd,"Shake":bf,"Dance":ba,"Dance Reverse":ba,"Keep":by,"Font-Size":X,"Line Height":bn,"Percent Width":bb,"Color":bw,"Twice":bz,"Alternate":bh,"Ease In":Y,"Ease Out":bo,"Linear":br,"Ease":bg,"Ease In Out":bi,"Missing Values":bs};var h=document.createElement(w);h.innerHTML=Q;document.body.appendChild(h);var bc=document.createElement(x);document.body.appendChild(bc);h=document.createElement(w);h.innerHTML=g;document.body.appendChild(h);var bC=document.createElement(x);document.body.appendChild(bC);for(var bm in bp){var bj=this.createButton(bm,bp[bm]);bc.appendChild(bj[0]);bC.appendChild(bj[1]);}
;var bv={duration:500,alternate:true,repeat:f,keyFrames:{'0':{left:E},'100':{left:D}}};var bj=[];var bB=[qx.bom.element.AnimationCss,qx.bom.element.AnimationJs];for(var i=0;i<bB.length;i++){var bx=document.createElement(x);bx.innerHTML=K;bx.className=A;bj[i]=bx;}
;var bu=(function(bD){return function(e){for(var i=0;i<bq.length;i++){bq[i].stop();}
;}
;}
)(bv);qx.bom.Event.addNativeListener(bj[0],G,bu);qx.bom.Event.addNativeListener(bj[1],G,bu);var bq=[];bq.push(qx.bom.element.AnimationCss.animate(bj[0],bv));bq.push(qx.bom.element.AnimationJs.animate(bj[1],bv));bc.appendChild(bj[0]);bC.appendChild(bj[1]);var bj=[];var bB=[qx.bom.element.AnimationCss,qx.bom.element.AnimationJs];for(var i=0;i<bB.length;i++){var bx=document.createElement(x);bx.innerHTML=v;bx.className=A;bj[i]=bx;}
;var bu=(function(bE){return function(e){for(var i=0;i<bq.length;i++){if(bA[i].el){if(bA[i].isPlaying()){bA[i].pause();bA[i].el.innerHTML=I;}
else {bA[i].play();bA[i].el.innerHTML=v;}
;}
;}
;}
;}
)(bv);qx.bom.Event.addNativeListener(bj[0],G,bu);qx.bom.Event.addNativeListener(bj[1],G,bu);var bA=[];bA.push(qx.bom.element.AnimationCss.animate(bj[0],bv));bA.push(qx.bom.element.AnimationJs.animate(bj[1],bv));bc.appendChild(bj[0]);bC.appendChild(bj[1]);}
}});}
)();
