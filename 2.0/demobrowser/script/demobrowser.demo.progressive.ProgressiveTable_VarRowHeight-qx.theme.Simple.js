...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Simple.4afbea035bbf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="Unrecognized key: ",e="qx.ui.progressive.renderer.table.Widths",d="minWidth",c="width",b="maxWidth",a="Column number out of range";qx.Class.define(e,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__Mp=[];for(var i=0;i<g;i++){this.__Mp[i]=new qx.ui.core.ColumnData();}
;}
,members:{__Mp:null,getData:function(){return this.__Mp;}
...
;}
,setWidth:function(l,m){if(l>this.__Mp.length-1||l<0){throw new Error(a);}
;this.__Mp[l].setColumnWidth(m);}
,setMinWidth:function(n,o){if(n>this.__Mp.length-1||n<0){throw new Error(a);}
;this.__Mp[n].setMinWidth(o);}
,setMaxWidth:function(p,q){if(p>this.__Mp.length-1||p<0){throw new Error(a);}
;this.__Mp[p].setMaxWidth(q);}
}});}
)();
...
,members:{__Jd:null,join:function(c){this.__Jd=c;}
...
(function(){var f="resize",d="progressive-table-header",c="_layout",b="qx.ui.progressive.headfoot.TableHeading",a="progressive-table-header-cell";qx.Class.define(b,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(g,h){qx.ui.progressive.headfoot.Abstract.call(this);this.__Ja=g;var k=g.getData();this.__Fn=[];for(var i=0;i<k.length;i++){var l=new qx.ui.basic.Atom(h[i]);l.setAppearance(a);this.add(l);this.__Fn[i]=l;}
...
,properties:{appearance:{refine:true,init:d}},members:{__Ja:null,__Kg:null,__Fn:null,__nN:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__Kg){return this.__Ja.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var n=this.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();this.__Kg=true;this.__nN.renderLayout(n,100);this.__Kg=false;var o=this.__Ja.getData();for(var i=0;i<o.length;i++){this.__Fn[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__Ja=this.__Fn=null;this._disposeObjects(c);}
});}
)();
(function(){var n="progressive-progressbar-indicator-undone",m="__LR",l="progress",k="%",j="progressive-progressbar-indicator-done",i="progressive-progressbar-percent-text",h="renderStart",g="__LS",f="progressive-progressbar-background",d="0%",a="qx.ui.progressive.headfoot.Progress",c="progressive-progressbar-percent-background",b="renderEnd";qx.Class.define(a,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,p){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__Je={};var q=qx.theme.manager.Color.getInstance();this.__Je.background=q.resolve(f);this.__Je.indicatorDone=q.resolve(j);this.__Je.indicatorUndone=q.resolve(n);this.__Je.percentBackground=q.resolve(c);this.__Je.percentText=q.resolve(i);this.set({backgroundColor:this.__Je.background});this.__LR=new qx.ui.core.Widget();this.__LR.set({width:0,backgroundColor:this.__Je.indicatorDone});this.add(this.__LR);var r=new qx.ui.core.Widget();r.set({backgroundColor:this.__Je.indicatorUndone});this.add(r,{flex:1});this.__LS=new qx.ui.basic.Atom(d);this.__LS.set({width:100,backgroundColor:this.__Je.percentBackground,textColor:this.__Je.percentText});this.add(this.__LS);this.exclude();}
,members:{__LT:null,__Je:null,__LR:null,__LS:null,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(h,function(e){this.__LT=e.getData().initial;this.show();}
,this);s.addListener(l,function(e){var v=1.0-(e.getData().remaining/this.__LT);var w=this.getBounds();if(w){var t=Math.floor((w.width-this.__LS.getBounds().width)*v);var u=Math.floor(v*100)+k;if(!isNaN(t)){this.__LR.setMinWidth(t);this.__LS.setLabel(u);}
;}
;}
,this);s.addListener(b,function(e){this.exclude();}
,this);}
},destruct:function(){this.__Je=null;this._disposeObjects(m,g);}
});}
)();
(function(){var e="applyStructure() is abstract",d="abstract",c="qx.ui.progressive.structure.Abstract",b="overflowY",a="auto";qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__EF=new qx.ui.core.Widget();this.__zw=this.__EF;}
else {this.__EF=null;this.__zw=f;}
;this.__zw.getContentElement().setStyle(b,a);}
,members:{__EF:null,__zw:null,applyStructure:function(g){throw new Error(e);}
,getPane:function(){return this.__zw;}
},destruct:function(){if(this.__EF){this.__EF.dispose();}
;this.__EF=this.__zw=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,c,d){qx.ui.progressive.structure.Abstract.call(this,d);if(!b){this.__JV=new qx.ui.progressive.headfoot.Null();this.__oU=this.__JV;}
else {this.__JV=null;this.__oU=b;}
;if(!c){this.__JW=new qx.ui.progressive.headfoot.Null();this.__JX=this.__JW;}
else {this.__JW=null;this.__JX=c;}
;}
,members:{__oU:null,__JX:null,__JV:null,__JW:null,applyStructure:function(e){this.__oU.join(e);this.__JX.join(e);e.add(this.__oU);e.add(this.getPane(),{flex:1});e.add(this.__JX);}
,getHeader:function(){return this.__oU;}
,getFooter:function(){return this.__JX;}
},destruct:function(){if(this.__JV){this.__JV.dispose();this.__JV=null;}
;if(this.__JW){this.__JW.dispose();this.__JW=null;}
;this.__oU=this.__JX=null;}
});}
)();
...
;this.__Lg=r;r.applyStructure(this);this.__Lh=false;this.__Li=false;this.__Lj=0;}
,events:{"renderStart":a,"renderEnd":a,"progress":a,"progressDetail":a},properties:{dataModel:{check:n,apply:q},batchSize:{check:b,init:20},flushWidgetQueueAfterBatch:{check:p,init:false},interElementTimeout:{check:b,init:0}},members:{__Fo:null,__Li:null,__Lk:null,__Lj:null,__Lh:null,__Lg:null,getStructure:function(){return this.__Lg;}
,addRenderer:function(name,s){this.__Fo[name]=s;s.join(this,name);}
,removeRenderer:function(name){if(!this.__Fo[name]){throw new Error(j+name);}
;delete this.__Fo[name];}
,render:function(){if(this.__Li){return;}
;this.__Li=true;var t=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__Lg.getPane(),batchSize:this.getBatchSize(),rendererData:this.__Lm(),userData:{}});this.__Lk=new Date();if(this.__Lh){this.__Lj=t.getModel().getElementCount();this.fireDataEvent(d,{state:t,initial:this.__Lj});this.__Ll(t);}
else {qx.event.Timer.once(function(){this.__Lj=t.getModel().getElementCount();this.fireDataEvent(d,{state:t,initial:this.__Lj});this.__Ll(t);this.__Lh=true;}
,this,10);}
;}
,_applyDataModel:function(u,v){if(v){v.removeListener(f,this.__Ln,this);v.dispose();}
;u.addListener(f,this.__Ln,this);}
,__Ll:function(w){var x;var z;var y;for(var i=w.getBatchSize();i>0;i--){x=w.getModel().getNextElement();if(!x){this.debug(o+(new Date()-this.__Lk)+m);this.__Li=false;this.fireDataEvent(c,w);w.dispose();return;}
;z=x.element;y=this.__Fo[z.renderer];y.render(w,z);this.fireDataEvent(g,{initial:this.__Lj,remaining:x.remaining,element:z});}
;this.fireDataEvent(l,{initial:this.__Lj,remaining:x.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__Ll(w);}
,this,this.getInterElementTimeout());}
,__Lm:function(){var A={};for(var name in this.__Fo){A[name]={};}
;return A;}
,__Ln:function(e){this.__Lj=e.getData();this.render();}
},destruct:function(){for(var name in this.__Fo){this.__Fo[name].dispose();}
;this.__Lk=this.__Fo=this.__Lg=null;}
});}
)();
...
(function(){var b="qx.ui.progressive.model.Default",a="dataAvailable";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__Cb=[];}
,members:{__Cb:null,addElements:function(c){this.__Cb=this.__Cb.concat(c);this.fireDataEvent(a,this.__Cb.length);}
,addElement:function(d){this.__Cb.push(d);this.fireDataEvent(a,this.__Cb.length);}
,getElementCount:function(){return this.__Cb.length;}
,getNextElement:function(){if(this.__Cb.length>0){return ({element:this.__Cb.shift(),remaining:this.__Cb.length});}
;return null;}
},destruct:function(){this.__Cb=null;}
});}
)();
...
(function(){var l="content",k="px",j="  font-size: 11px;",h="px ",g=';',f='',d="padding: ",c="end",b="div",a="  position: absolute;",bh="qx.tableResizeDebug",bg="  width : 100%;",bf="__columnData",be="Renderer is already joined to a Progressive.",bd="css.boxmodel",bc="  top: 0px;",bb="qx.debug",ba="__Jc",Y="  overflow:hidden;",X=" {",s="  border-right:1px solid #f2f2f2;",t="Invalid location: ",q="  cursor:default;",r="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",o="-row {",p="resize",m="start",n="relative",w=": width=",x=':ellipsis;',F=':',D="  white-space:nowrap;",N="  padding : 0px 6px 0px 6px;",I="qx.ui.progressive.renderer.table.Row",T="progressive-table-row-background-odd",R="  height: 100%;",z="__nN",W="progressive-table-row-background-even",V="col ",U="  border-bottom:1px solid #eeeeee;",y="left: ",B="No existing renderer for column ",C="css.userselect.none",E=")",G="css.userselect",J="css.textoverflow",O="}",S="",u="width: ",v=" out of range (max: ",A="0px ",M="qx-progressive-",L="Column ",K="-row",Q="-col-",P="px;",H=".qx-progressive-";qx.Class.define(I,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bi){qx.ui.progressive.renderer.Abstract.call(this);this.__Ja=bi;this.__Jb={};this.__Jc=new qx.ui.progressive.renderer.table.cell.Default();this.__Jd=null;this.__Je={};var bj=qx.theme.manager.Color.getInstance();this.__Je.bgcol=[];this.__Je.bgcol[0]=bj.resolve(W);this.__Je.bgcol[1]=bj.resolve(T);this.__nN=new qx.ui.layout.HBox();this.__nN.connectToWidget(this);}
,statics:{__nc:null,__Jf:6,__Jg:a+bc+R+Y+(qx.core.Environment.get(J)?qx.lang.String.hyphenate(qx.core.Environment.get(J))+x:S)+D+s+U+N+q+j+r+(qx.core.Environment.get(G)?qx.lang.String.hyphenate(qx.core.Environment.get(G))+F+qx.core.Environment.get(C)+g:f)},properties:{defaultRowHeight:{init:16}},members:{__Jd:null,__AR:null,__Jh:null,__Ja:null,__Jb:null,__Jc:null,__Je:null,__nN:null,join:function(bk,name){if(this.__Jd){throw new Error(be);}
;this.__Jd=bk;this.__AR=name;var bm=qx.ui.progressive.renderer.table.Row;if(!bm.__nc){bm.__nc={};}
;var bl=bk.toHashCode();if(!bm.__nc[bl]){bm.__nc[bl]={rowstylesheet:null,cellstylesheet:[]};var bn=H+bl+o+bg+O;bm.__nc[bl].rowstylesheet=qx.bom.Stylesheet.createElement(bn);var bo=this.__Ja.getData();for(var i=0;i<bo.length;i++){var bn=H+bl+Q+i+X+bm.__Jg+O;bm.__nc[bl].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bn);}
;this.__Jh=bl;var bp=bk.getStructure().getPane();bp.addListener(p,this._resizeColumns,this);}
;}
,addRenderer:function(bq,br){var bs=this.__Ja.getData();if(bq<0||bq>=bs.length){throw new Error(L+bq+v+(bs.length-1)+E);}
;this.__Jb[bq]=br;}
,removeRenderer:function(bt){var bu=this.__Ja.getData();if(bt<0||bt>=bu.length){throw new Error(L+bt+v+(bu.length-1)+E);}
;if(!this.__Jb[bt]){throw new Error(B+bt);}
;delete this.__Jb[bt];}
,render:function(bv,bw){var bG=bw.data;var bB=[];var bD;var bC;var bz=0;if(bv.getRendererData()[this.__AR].end===undefined){bv.getRendererData()[this.__AR]={end:0,start:1,rows:0,totalHeight:0};}
;var bF=document.createElement(b);for(var i=0;i<bG.length;i++){var bA=M+this.__Jh+Q+i;bC=this.__Jb[i]||this.__Jc;bD={state:bv,rowDiv:bF,stylesheet:bA,element:bw,dataIndex:i,cellData:bG[i],height:bz};bB.push(bC.render(bD));if(bD.height>bz){bz=bD.height;}
;}
;bz=(bz>0?bz:this.getDefaultRowHeight());var bE=bv.getRendererData()[this.__AR];bE.totalHeight+=bz;bF.style.position=n;bF.style.height=bz+k;bF.className=M+this.__Jh+K;bF.innerHTML=bB.join(S);switch(bw.location){case c:var bx=bE.end||0;bF.style.backgroundColor=this.__Je.bgcol[bx];bE.end=(bx==0?1:0);bv.getPane().getContentElement().getDomElement().appendChild(bF);break;case m:var by=bv.getPane().getContentElement().getDomElement();var bH=by.childNodes;if(bH.length>0){var bx=bE.start;bF.style.backgroundColor=this.__Je.bgcol[bx];bE.start=(bx==0?1:0);by.insertBefore(bF,bH[0]);break;}
else {by.appendChild(bF);}
;break;default:throw new Error(t+bw.location);};++bE.rows;}
,getLayoutChildren:function(){return this.__Ja.getData();}
,_resizeColumns:function(e){var bP=this.__Jd.getStructure().getPane();var bM=bP.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();var bN=H+this.__Jh+K;var bJ=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bJ.__nc[this.__Jh].rowstylesheet,bN);var bL=u+bM+P;qx.bom.Stylesheet.addRule(bJ.__nc[this.__Jh].rowstylesheet,bN,bL);this.__nN.renderLayout(bM,100);var bO=this.__Ja.getData();for(var i=0,bS=0;i<bO.length;i++,bS+=bM){var bN=H+this.__Jh+Q+i;var bJ=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bJ.__nc[this.__Jh].cellstylesheet[i],bN);bM=bO[i].getComputedWidth();if(qx.core.Environment.get(bb)){if(qx.core.Environment.get(bh)){this.debug(V+i+w+bM);}
;}
;var bK;if(qx.core.Environment.get(bd)==l){bK=qx.ui.progressive.renderer.table.Row.__Jf*2;}
else {bK=-1;}
;var bR=(bM-bK)+P;var bQ=A+qx.ui.progressive.renderer.table.Row.__Jf+h+A+qx.ui.progressive.renderer.table.Row.__Jf+P;var bI=bS+P;var bL=bJ.__Jg+u+bR+y+bI+d+bQ;qx.bom.Stylesheet.addRule(bJ.__nc[this.__Jh].cellstylesheet[i],bN,bL);}
;}
},destruct:function(){var name;for(name in this.__Jb){this.__Jb[name]=null;}
;var bU=qx.ui.progressive.renderer.table.Row;var bT=this.__Jd.toHashCode();if(bU.__nc&&bU.__nc[bT]){if(bU.__nc[bT].rowstylesheet){var bW=H+this.__Jh+K;var bU=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bU.__nc[this.__Jh].rowstylesheet,bW);}
;if(bU.__nc[bT].cellstylesheet){for(var i=bU.__nc[bT].cellstylesheet.length-1;i>=0;i--){var bW=H+this.__Jh+Q+i;var bV=bU.__nc[this.__Jh].cellstylesheet[i];var bU=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV,bW);}
;}
;}
;if(this.__Jd&&this.__Jd.getRendererData){var bX=this.__Jd.getRendererData();if(bX&&bX[this.__AR]&&bX[this.__AR].end!==undefined){bX[this.__AR]=null;}
;}
;this.__Je=this.__Jb=this.__Jd=this.__Ja=null;this._disposeObjects(z,ba,bf);}
});}
)();
...
(function(){var u=" height='",t="vertical-align:middle;",s="text-align:center;",r="abstract",q="",p='<img ',o=" style='padding-top:2px;'",n='" style="filter:',m=" title='",l=" width='",e="qx.ui.progressive.renderer.table.cell.Icon",k="'",h="_identifyImage() is abstract",c=">",b="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",g="qx/static/blank.gif",f="string",i="',sizingMethod='scale')",a="px'",j='" ',d='src="';qx.Class.define(e,{type:r,extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);var v=qx.util.AliasManager.getInstance();var w=qx.util.ResourceManager.getInstance();var x=v.resolve(g);this.__Iy=w.toUri(x);}
,members:{__Iy:null,getBlankImage:function(){return this.__Iy;}
,_identifyImage:function(y){throw new Error(h);}
,_getCellStyle:function(z){var A=qx.ui.progressive.renderer.table.cell.Abstract.prototype._getCellStyle.call(this,z)+s+t;return A;}
,_getContentHtml:function(B){var C=[];var D=this.__Iz(B);C.push(p);if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(D.url)){C.push(d,this.__Iy,n,b,D.url,i,j);}
else {C.push(d,D.url,j);}
;if(D.imageWidth){C.push(l,D.imageWidth,a);}
;if(D.imageHeight){C.push(u,D.imageHeight,a);}
;C.push(o);if(D.tooltip){C.push(m,D.tooltip,k);}
;if(D.extras){C.push(D.extras);}
;C.push(c);return C.join(q);}
,__Iz:function(E){var F=this._identifyImage(E);if(F==null||typeof F==f){F={url:F,tooltip:null};}
;if(F.url==null){F.url=this.__Iy;}
;return F;}
}});}
)();
