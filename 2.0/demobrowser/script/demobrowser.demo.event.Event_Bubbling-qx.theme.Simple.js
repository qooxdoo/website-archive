...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Bubbling","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bubbling-qx.theme.Simple.140cff82bba5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="logger",l="Event phase",k="capture",j="Current target",h="div",g="Event",f="demobrowser.demo.event.Event_Bubbling",d="bubble",c="Target",b="click",a="at target";qx.Class.define(f,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([g,c,j,l],document.getElementById(m),50);for(var i=1;i<10;i++){var n=document.getElementById(h+i);qx.event.Registration.addListener(n,b,this._cascadeCapture,this,true);qx.event.Registration.addListener(n,b,this._cascadeBubble,this,false);}
;}
,_cascadeCapture:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?a:k]);}
,_cascadeBubble:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?a:d]);}
}});}
)();
