...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent-qx.theme.Classic.98c13b11902b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;qx.bom.Element.addListener(G,m,this.__Qg,this);}
...
,this);}
,__Qg:function(e){var K=e.getTarget().id.split(z)[1];var I=e.getTarget().checked;var J=document.getElementById(o);if(I){qx.bom.Element.addListener(J,K,this.logMouseEvent,this);}
