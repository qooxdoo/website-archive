...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage-qx.theme.Simple.b6fa62afb523.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="<em>no content</em>",q="Memory Storage",p="html.storage.userdata",o="list",n="save",m="value",l="Web Storage",k="demobrowser.demo.bom.Storage",j="<br>",i="userData Storage",c="clear",h="html.storage.local",f=":",b="using",a="remove",e="key",d="",g="click";qx.Class.define(k,{extend:qx.application.Native,members:{__Aj:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__Aj=qx.bom.Storage.getLocal();var t=document.getElementById(n);var s=document.getElementById(c);var u=document.getElementById(a);var self=this;qx.bom.Event.addNativeListener(t,g,function(){var w=qx.bom.Input.getValue(document.getElementById(e));var v=qx.bom.Input.getValue(document.getElementById(m));self.__Aj.setItem(w,v);self.updateList();}
);qx.bom.Event.addNativeListener(s,g,function(){self.__Aj.clear();self.updateList();}
);qx.bom.Event.addNativeListener(u,g,function(){self.__Aj.removeItem(self.__Aj.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var x=document.getElementById(o);x.innerHTML=d;this.__Aj.forEach(function(y,z){x.innerHTML+=y+f+z+j;}
