...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Image","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Image-qx.theme.Simple.18a5caf82d00.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="icon/32/actions/format-justify-left.png",j="Toggle enabled",i="icon/32/actions/go-home.png",h="changeValue",g="demobrowser/demo/icons/multimedia-player.png",f="icon/32/actions/format-justify-right.png",d="icon/32/actions/format-justify-fill.png",c="demobrowser.demo.widget.Image",b="icon/32/actions/format-justify-center.png",a="http://resources.qooxdoo.org/images/logo.gif";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.layout.HBox();r.setSpacing(20);var m=new qx.ui.container.Composite(r);this.getRoot().add(m,{left:20,top:20});m.add(new qx.ui.basic.Image(g));var q=new qx.ui.basic.Image(k);m.add(q);var l=new qx.ui.basic.Image(f);m.add(l);var o=new qx.ui.basic.Image(d);m.add(o);var p=new qx.ui.basic.Image(b);m.add(p);var n=new qx.ui.basic.Image(i);n.setScale(true);n.setWidth(64);n.setHeight(64);m.add(n);var external=new qx.ui.basic.Image(a);m.add(external);var t=new qx.ui.basic.Image(a);t.setWidth(136);t.setHeight(40);t.setScale(true);m.add(t);var s=new qx.ui.form.ToggleButton(j);s.setValue(true);s.addListener(h,function(e){m.setEnabled(e.getData());}
);this.getRoot().add(s,{left:20,top:180});}
}});}
)();
