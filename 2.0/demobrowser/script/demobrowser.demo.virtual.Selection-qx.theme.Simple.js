...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Selection","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Selection-qx.theme.Simple.1fbf1f18617d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="default",j="Additive Selection",i="Cell Line Selection",h="addaptive",g="Options",f="Row Selection",d="changeSelection",c="Column Selection",b="Enable drag selection",a="demobrowser.demo.virtual.Selection",H="Selection Mode",G="Single Selection",F="Cell Rectangle Selection",E="Enable quick selection",D="One Selection",C="Quick selection is only available for the modes multi or additive",B="Drag selection is only available for the modes multi or additive",A="Multi Selection",z="changeValue",y="table-row-background-selected",r="additive",s="one",p="single",q="selected",n="#EEE",o="horizontal",l="table-scroller-header",m="value",t="white",u=" / ",w="bold",v="multi",x="manager";qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var M=qx.theme.manager.Font.getInstance().resolve(k).getStyles();this._fontCss=qx.bom.element.Style.compile(M);var V=new qx.ui.layout.Grid(5,0);V.setRowFlex(2,1);V.setColumnFlex(0,1);V.setColumnFlex(1,1);V.setColumnFlex(2,1);V.setColumnFlex(3,1);var J=[];var T=new qx.ui.container.Composite(V);this.getRoot().add(T,{edge:5});T.add(new qx.ui.basic.Label(f).set({font:w,decorator:l,padding:3,allowGrowX:true}),{row:1,column:0});var L=this.createRowSelectionScroller();J.push(L.getUserData(x));T.add(L,{row:2,column:0});T.add(new qx.ui.basic.Label(c).set({font:w,decorator:l,padding:3,allowGrowX:true}),{row:1,column:1});var L=this.createColumnSelectionScroller();J.push(L.getUserData(x));T.add(L,{row:2,column:1});T.add(new qx.ui.basic.Label(F).set({font:w,decorator:l,padding:3,allowGrowX:true}),{row:1,column:2});var L=this.createCellRectangleSelectionScroller();J.push(L.getUserData(x));T.add(L,{row:2,column:2});T.add(new qx.ui.basic.Label(i).set({font:w,decorator:l,padding:3,allowGrowX:true}),{row:1,column:3});var L=this.createCellLineSelectionScroller();J.push(L.getUserData(x));T.add(L,{row:2,column:3});var R=new qx.ui.layout.Grid(20,4);var O=new qx.ui.container.Composite(R).set({padding:15,backgroundColor:t});T.add(O,{row:0,column:0,colSpan:4});O.add(new qx.ui.basic.Label(H).set({font:w,padding:3}),{row:0,column:0});var N=new qx.ui.form.RadioButton(G);N.setUserData(m,p);O.add(N,{row:1,column:0});var Q=new qx.ui.form.RadioButton(A);Q.setUserData(m,v);Q.setValue(true);O.add(Q,{row:2,column:0});var K=new qx.ui.form.RadioButton(j);K.setUserData(m,r);O.add(K,{row:3,column:0});var I=new qx.ui.form.RadioButton(D);I.setUserData(m,s);O.add(I,{row:4,column:0});var P=new qx.ui.form.RadioGroup(N,Q,K,I);P.addListener(d,function(e){var W=e.getData()[0].getUserData(m);J.forEach(function(X){X.setMode(W);}
);if(W==p||W==s){U.setEnabled(false);S.setEnabled(true);}
else if(W==v||W==h){U.setEnabled(true);S.setEnabled(false);}
;}
);O.add(new qx.ui.basic.Label(g).set({font:w,padding:3}),{row:0,column:1});var U=new qx.ui.form.CheckBox(b);O.add(U,{row:1,column:1});U.addListener(z,function(e){if(e.getData()){var Y=J[0].getMode();if(Y==p||Y==s){this.debug(B);}
;}
;J.forEach(function(ba){ba.setDrag(e.getData());}
);}
);var S=new qx.ui.form.CheckBox(E).set({enabled:false});O.add(S,{row:2,column:1});S.addListener(z,function(e){if(e.getData()){var bb=J[0].getMode();if(bb==v||bb==r){this.debug(C);}
;}
;J.forEach(function(bc){bc.setQuick(e.getData());}
);}
);}
,createRowSelectionScroller:function(){var bh=new qx.ui.virtual.core.Scroller(1000,100,20,100);var bf=new qx.ui.virtual.layer.Row(t,n);bh.getPane().addLayer(bf);bh.getPane().addLayer(new qx.ui.virtual.layer.GridLines(o));var bg=new qx.ui.virtual.cell.Cell();var be=new qx.ui.virtual.layer.HtmlCell({getCellProperties:function(bi,bj){var bk={};if(bd.isItemSelected(bi)){bk.selected=true;}
;return bg.getCellProperties(bi+u+bj,bk);}
});bh.getPane().addLayer(be);var bd=new qx.ui.virtual.selection.Row(bh.getPane(),{styleSelectable:function(bl,bm,bn){if(bm!==q){return;}
;if(bn){bf.setBackground(bl,q);}
else {bf.setBackground(bl,null);}
;be.updateLayerData();}
});bd.attachMouseEvents(bh.getPane());bd.attachKeyEvents(bh);bd.set({mode:v});bd.addItem(0);bh.setUserData(x,bd);return bh;}
,createColumnSelectionScroller:function(){var br=new qx.ui.virtual.core.Scroller(1000,100,20,100);br.getPane().addLayer(new qx.ui.virtual.layer.Row(t,n));var bq=new qx.ui.virtual.layer.Column();br.getPane().addLayer(bq);br.getPane().addLayer(new qx.ui.virtual.layer.GridLines(o));var bs=new qx.ui.virtual.cell.Cell();var bp=new qx.ui.virtual.layer.HtmlCell({getCellProperties:function(bt,bu){var bv={};if(bo.isItemSelected(bu)){bv.selected=true;}
;return bs.getCellProperties(bt+u+bu,bv);}
});br.getPane().addLayer(bp);var bo=new qx.ui.virtual.selection.Column(br.getPane(),{styleSelectable:function(bw,bx,by){if(bx!==q){return;}
;if(by){bq.setBackground(bw,q);}
else {bq.setBackground(bw,null);}
;bp.updateLayerData();}
});bo.attachMouseEvents(br.getPane());bo.attachKeyEvents(br);bo.set({mode:v});bo.addItem(0);br.setUserData(x,bo);return br;}
,createCellRectangleSelectionScroller:function(){var bC=new qx.ui.virtual.core.Scroller(1000,100,20,100);bC.getPane().addLayer(new qx.ui.virtual.layer.Row(t,n));var bB=new qx.ui.virtual.cell.Cell();var bD=new qx.ui.virtual.cell.Cell().set({backgroundColor:y});var bA=new qx.ui.virtual.layer.HtmlCell({getCellProperties:function(bE,bF){var bG={};if(bz.isItemSelected({row:bE,column:bF})){bG.selected=true;}
;if(bG.selected){return bD.getCellProperties(bE+u+bF,bG);}
else {bB.resetBackgroundColor();return bB.getCellProperties(bE+u+bF,bG);}
;}
});bC.getPane().addLayer(bA);bC.getPane().addLayer(new qx.ui.virtual.layer.GridLines(o));var bz=new qx.ui.virtual.selection.CellRectangle(bC.getPane(),{styleSelectable:function(bH,bI,bJ){bA.updateLayerData();}
});bz.attachMouseEvents(bC.getPane());bz.attachKeyEvents(bC);bz.set({mode:v});bz.addItem({row:0,column:0});bC.setUserData(x,bz);return bC;}
,createCellLineSelectionScroller:function(){var bN=new qx.ui.virtual.core.Scroller(1000,100,20,100);bN.getPane().addLayer(new qx.ui.virtual.layer.Row(t,n));var bM=new qx.ui.virtual.cell.Cell();var bO=new qx.ui.virtual.cell.Cell().set({backgroundColor:y});var bL=new qx.ui.virtual.layer.HtmlCell({getCellProperties:function(bP,bQ){var bR={};if(bK.isItemSelected({row:bP,column:bQ})){bR.selected=true;}
;if(bR.selected){return bO.getCellProperties(bP+u+bQ,bR);}
else {bM.resetBackgroundColor();return bM.getCellProperties(bP+u+bQ,bR);}
;}
});bN.getPane().addLayer(bL);bN.getPane().addLayer(new qx.ui.virtual.layer.GridLines(o));var bK=new qx.ui.virtual.selection.CellLines(bN.getPane(),{styleSelectable:function(bS,bT,bU){bL.updateLayerData();}
});bK.attachMouseEvents(bN.getPane());bK.attachKeyEvents(bN);bK.set({mode:v});bK.addItem({row:0,column:0});bN.setUserData(x,bK);return bN;}
}});}
)();
...
(function(){var k="scrollY",j="The method 'getItemRight' is not implemented!",i="update",h="scrollX",g="The method 'getItemLeft' is not implemented!",f="The method 'getItemBottom' is not implemented!",d="The method 'getItemTop' is not implemented!",c="pane",b="os.scrollBarOverlayed",a="qx.ui.virtual.core.Scroller";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(l,m,n,o){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__zw=new qx.ui.virtual.core.Pane(l,m,n,o);this.__zw.addListener(i,this._computeScrollbars,this);this.__zw.addListener(h,this._onScrollPaneX,this);this.__zw.addListener(k,this._onScrollPaneY,this);if(qx.core.Environment.get(b)){this._add(this.__zw,{edge:0});}
else {this._add(this.__zw,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__zw:null,getPane:function(){return this.__zw;}
,_createChildControlImpl:function(p,q){if(p==c){return this.__zw;}
...
,_onScrollBarX:function(e){this.__zw.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__zw.setScrollY(e.getData());}
},destruct:function(){this.__zw.dispose();this.__zw=null;}
});}
)();
(function(){var w="qx.ui.virtual.core.Pane",v="resize",u="click",t="__yK",s="scrollX",r="dblclick",q="contextmenu",p="qx.debug",o="cellClick",n="cellContextmenu",f="__yJ",m="__yR",j="qx.event.type.Event",c="cellDblclick",b="scrollY",h="__yQ",g="update",k="change",a="qx.event.type.Data",l="qx.ui.virtual.core.CellEvent",d="appear";qx.Class.define(w,{extend:qx.ui.core.Widget,construct:function(x,y,z,A){qx.ui.core.Widget.call(this);this.__yJ=new qx.ui.virtual.core.Axis(z,x);this.__yK=new qx.ui.virtual.core.Axis(A,y);this.__yL=0;this.__yM=0;this.__yN=0;this.__yO=0;this.__yP={};this.__gR={};this.__yQ=new qx.ui.container.Composite();this.__yQ.setUserBounds(0,0,0,0);this._add(this.__yQ);this.__yR=[];this.__yJ.addListener(k,this.fullUpdate,this);this.__yK.addListener(k,this.fullUpdate,this);this.addListener(v,this._onResize,this);this.addListenerOnce(d,this._onAppear,this);this.addListener(u,this._onClick,this);this.addListener(r,this._onDblclick,this);this.addListener(q,this._onContextmenu,this);}
,events:{cellClick:l,cellContextmenu:l,cellDblclick:l,update:j,scrollX:a,scrollY:a},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__yJ:null,__yK:null,__yL:null,__yM:null,__yN:null,__yO:null,__yP:null,__gR:null,__yQ:null,__yR:null,__yS:null,__oq:null,__yI:null,getRowConfig:function(){return this.__yJ;}
,getColumnConfig:function(){return this.__yK;}
,getChildren:function(){return [this.__yQ];}
,addLayer:function(B){if(qx.core.Environment.get(p)){this.assertInterface(B,qx.ui.virtual.core.ILayer);}
;this.__yR.push(B);B.setUserBounds(0,0,0,0);this.__yQ.add(B);}
,getLayers:function(){return this.__yR;}
,getVisibleLayers:function(){var C=[];for(var i=0;i<this.__yR.length;i++){var D=this.__yR[i];if(D.isVisible()){C.push(D);}
;}
;return C;}
,getScrollMaxX:function(){var E=this.getInnerSize();if(E){return Math.max(0,this.__yK.getTotalSize()-E.width);}
;return 0;}
,getScrollMaxY:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__yJ.getTotalSize()-F.height);}
;return 0;}
,setScrollY:function(G){var H=this.getScrollMaxY();if(G<0){G=0;}
else if(G>H){G=H;}
;if(this.__yL!==G){var I=this.__yL;this.__yL=G;this._deferredUpdateScrollPosition();this.fireDataEvent(b,G,I);}
;}
,getScrollY:function(){return this.__yL;}
,setScrollX:function(J){var K=this.getScrollMaxX();if(J<0){J=0;}
else if(J>K){J=K;}
;if(J!==this.__yM){var L=this.__yM;this.__yM=J;this._deferredUpdateScrollPosition();this.fireDataEvent(s,J,L);}
;}
,getScrollX:function(){return this.__yM;}
,getScrollSize:function(){return {width:this.__yK.getTotalSize(),height:this.__yJ.getTotalSize()};}
...
,this,0);}
,this);return;}
;var Q=this.__yJ.getItemPosition(M);var O=Q+this.__yJ.getItemSize(M);var N=this.getScrollY();if(Q<N){this.setScrollY(Q);}
...
,this,0);}
,this);return;}
;var T=this.__yK.getItemPosition(R);var S=T+this.__yK.getItemSize(R);var V=this.getScrollX();if(T<V){this.setScrollX(T);}
...
;bc=this.__yJ.getItemAtPosition(this.getScrollY()+bb-be.top);bd=this.__yK.getItemAtPosition(this.getScrollX()+ba-be.left);if(!bc||!bd){return null;}
...
;var bm=this.__yM+bl.width;var bn=this.__yO-bm;if(this.__yM-this.__yP.left<Math.min(this.__yM,bf)||this.__yP.right-bm<Math.min(bn,bh)){var bo=Math.min(this.__yM,bg);var bk=Math.min(bn,bi);this._setLayerWindow(bj,this.__yM-bo,this.__yL,bl.width+bo+bk,bl.height,false);}
;}
,prefetchY:function(bp,bq,br,bs){var bt=this.getVisibleLayers();if(bt.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bu=this.__yL+bw.height;var bv=this.__yN-bu;if(this.__yL-this.__yP.top<Math.min(this.__yL,bp)||this.__yP.bottom-bu<Math.min(bv,br)){var by=Math.min(this.__yL,bq);var bx=Math.min(bv,bs);this._setLayerWindow(bt,this.__yM,this.__yL-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContainerElement().getDomElement()){this.__yS=true;this._updateScrollPosition();this.__yS=null;this.fireEvent(g);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onClick:function(e){this.__yT(e,o);}
,_onContextmenu:function(e){this.__yT(e,n);}
,_onDblclick:function(e){this.__yT(e,c);}
,__yT:function(e,bz){var bA=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bA){return;}
...
;this.__gR={};}
,_setLayerWindow:function(bC,bD,top,bE,bF,bG){var bL=this.__yJ.getItemAtPosition(top);if(bL){var bN=bL.index;var bR=this.__yJ.getItemSizes(bN,bF+bL.offset);var bM=qx.lang.Array.sum(bR);var bT=top-bL.offset;var bQ=top-bL.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bT=0;var bQ=0;}
;var bP=this.__yK.getItemAtPosition(bD);if(bP){var bJ=bP.index;var bI=this.__yK.getItemSizes(bJ,bE+bP.offset);var bO=qx.lang.Array.sum(bI);var bS=bD-bP.offset;var bK=bD-bP.offset+bO;}
else {var bJ=0;var bI=[];var bO=0;var bS=0;var bK=0;}
;this.__yP={top:bT,bottom:bQ,left:bS,right:bK};this.__yQ.setUserBounds(this.__yP.left-this.__yM,this.__yP.top-this.__yL,bO,bM);this.__oq=bI;this.__yI=bR;for(var i=0;i<this.__yR.length;i++){var bH=this.__yR[i];bH.setUserBounds(0,0,bO,bM);if(bG){bH.fullUpdate(bN,bJ,bR,bI);}
else {bH.updateLayerWindow(bN,bJ,bR,bI);}
;}
;}
,__yU:function(){if(this.__yS){return;}
;var bU=this.getScrollSize();if(this.__yN!==bU.height||this.__yO!==bU.width){this.__yN=bU.height;this.__yO=bU.width;this.fireEvent(g);}
;}
...
,_fullUpdate:function(){var bV=this.getVisibleLayers();if(bV.length==0){this.__yU();return;}
;var bW=this.getBounds();if(!bW){return;}
;this._setLayerWindow(bV,this.__yM,this.__yL,bW.width,bW.height,true);this.__yU();}
,_deferredUpdateScrollPosition:function(){this.__gR._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__yU();return;}
;var ca=this.getBounds();if(!ca){return;}
;var bY={top:this.__yL,bottom:this.__yL+ca.height,left:this.__yM,right:this.__yM+ca.width};if(this.__yP.top<=bY.top&&this.__yP.bottom>=bY.bottom&&this.__yP.left<=bY.left&&this.__yP.right>=bY.right){this.__yQ.setUserBounds(this.__yP.left-bY.left,this.__yP.top-bY.top,this.__yP.right-this.__yP.left,this.__yP.bottom-this.__yP.top);}
else {this._setLayerWindow(bX,this.__yM,this.__yL,ca.width,ca.height,false);}
;this.__yU();}
},destruct:function(){this._disposeArray(m);this._disposeObjects(f,t,h);this.__yP=this.__gR=this.__oq=this.__yI=null;}
});}
)();
...
,events:{"change":f},members:{__zs:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__zs=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__zs=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__zs=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__zs=null;this.fireNonBubblingEvent(c);}
,__zt:function(){if(this.__zs){return this.__zs;}
;var r=this.defaultItemSize;var y=this.itemCount;var t=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<y){t.push(p);}
;}
;if(t.length==0){var u=[{startIndex:0,endIndex:y-1,firstItemSize:r,rangeStart:0,rangeEnd:y*r-1}];this.__zs=u;return u;}
...
;var z=u[u.length-1];var w=(y-z.startIndex-1)*r;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=y-1;this.__zs=u;return u;}
,__zu:function(A){var B=this.__zs||this.__zt();var C=0;var E=B.length-1;while(true){var F=C+((E-C)>>1);var D=B[F];if(D.rangeEnd<A){C=F+1;}
else if(D.rangeStart>A){E=F-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(G){if(G<0||G>=this.getTotalSize()){return null;}
;var I=this.__zu(G);var K=I.rangeStart;var H=I.startIndex;var L=I.firstItemSize;if(K+L>G){return {index:H,offset:G-K};}
else {var J=this.defaultItemSize;return {index:H+1+Math.floor((G-K-L)/J),offset:(G-K-L)%J};}
;}
,__zv:function(M){var N=this.__zs||this.__zt();var O=0;var Q=N.length-1;while(true){var R=O+((Q-O)>>1);var P=N[R];if(P.endIndex<M){O=R+1;}
else if(P.startIndex>M){Q=R-1;}
else {return P;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__zv(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__zs||this.__zt();return U[U.length-1].rangeEnd+1;}
...
;}
;return Y;}
},destruct:function(){this.customSizes=this.__zs=null;}
});}
)();
...
,properties:{anonymous:{refine:true,init:true}},members:{__gR:null,__cx:null,__yG:null,__yH:null,__yI:null,__oq:null,getFirstRow:function(){return this.__yG;}
,getFirstColumn:function(){return this.__yH;}
,getRowSizes:function(){return this.__yI||[];}
...
else if(this.__gR.updateLayerData&&this.__yI){this._updateLayerData();}
;;if(this.__gR.fullUpdate||this.__gR.updateLayerWindow){var e=this.__cx;this.__yG=e[0];this.__yH=e[1];this.__yI=e[2];this.__oq=e[3];}
;this.__gR={};}
,_updateLayerData:function(){this._fullUpdate(this.__yG,this.__yH,this.__yI,this.__oq);}
...
},destruct:function(){this.__gR=this.__cx=this.__yI=this.__oq=null;}
});}
)();
...
;this.__zi={};this.__zj={};}
,properties:{colorEven:{nullable:true,check:a,apply:c,themeable:true},colorOdd:{nullable:true,check:a,apply:d,themeable:true}},members:{__zk:null,__zl:null,__zi:null,__zj:null,setColor:function(g,h){if(h){this.__zi[g]=qx.theme.manager.Color.getInstance().resolve(h);}
else {delete (this.__zi[g]);}
;}
,clearCustomColors:function(){this.__zi={};this.updateLayerData();}
,getColor:function(i){var j=this.__zi[i];if(j){return j;}
else {return i%2==0?this.__zk:this.__zl;}
;}
,_applyColorEven:function(k,l){if(k){this.__zk=qx.theme.manager.Color.getInstance().resolve(k);}
else {this.__zk=null;}
;this.updateLayerData();}
,_applyColorOdd:function(m,n){if(m){this.__zl=qx.theme.manager.Color.getInstance().resolve(m);}
else {this.__zl=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__zj[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__zj[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__zj[q];}
},destruct:function(){this.__zi=this.__zj=null;}
});}
)();
...
;}
,setColor:function(J,K){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,K);if(this.__zA(J)){this.updateLayerData();}
;}
,setBackground:function(L,M){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,L,M);if(this.__zA(L)){this.updateLayerData();}
;}
,__zA:function(N){var P=this.getFirstRow();var O=P+this.getRowSizes().length-1;return N>=P&&N<=O;}
}});}
)();
(function(){var u="top:",t="",s="height: ",r="gray",q="width: 100%;",p="width: ",o="height: 100%;",n="qx.ui.virtual.layer.GridLines",m="left:",l="html",e="Color",k="PositiveInteger",h="top: 0px;",c="</div>",b="background-color:",g="horizontal",f="position: absolute;",i="qx.debug",a="<div style='",j="'>",d="px;";qx.Class.define(n,{extend:qx.ui.virtual.layer.Abstract,construct:function(v,w,z){qx.ui.virtual.layer.Abstract.call(this);this.setZIndex(1);if(w){this.setDefaultLineColor(w);}
;if(z!==undefined){this.setDefaultLineSize(z);}
;this.__It=[];this.__Iu=[];this._isHorizontal=(v||g)==g;}
,properties:{defaultLineColor:{init:r,check:e,themeable:true},defaultLineSize:{init:1,check:k,themeable:true}},members:{__It:null,__Iu:null,isHorizontal:function(){return this._isHorizontal;}
,setLineColor:function(A,B){if(qx.core.Environment.get(i)){qx.core.Assert.assertPositiveNumber(A);qx.core.Assert.assertString(B);}
;this.__It[A]=B;if(this.__Iv(A)){this.updateLayerData();}
;}
...
;this.__Iu[C]=D;if(this.__Iv(C)){this.updateLayerData();}
;}
,__Iv:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__Iu[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__It[K]||this.getDefaultLineColor();}
,__Iw:function(L,M,N){var top=0;var O,P;for(var y=0;y<N.length-1;y++){O=this.getLineColor(M+y);P=this.getLineSize(M+y);top+=N[y];L.push(a,f,s+P+d,q,u,top-((P>1)?Math.floor(P/2):1),d,b,O,j,c);}
;}
,__Ix:function(Q,R,S){var V=0;var T,U;for(var x=0;x<S.length-1;x++){T=this.getLineColor(R+x);U=this.getLineSize(R+x);V+=S[x];Q.push(a,f,p+U+d,o,h,m,V-((U>1)?Math.floor(U/2):1),d,b,T,j,c);}
;}
,_fullUpdate:function(W,X,Y,ba){var bb=[];if(this._isHorizontal){this.__Iw(bb,W,Y);}
else {this.__Ix(bb,X,ba);}
;this.getContentElement().setAttribute(l,bb.join(t));}
,_updateLayerWindow:function(bc,bd,be,bf){var bg=bc!==this.getFirstRow()||be.length!==this.getRowSizes().length;var bh=bd!==this.getFirstColumn()||bf.length!==this.getColumnSizes().length;if((this._isHorizontal&&bg)||(!this._isHorizontal&&bh)){this._fullUpdate(bc,bd,be,bf);}
;}
},destruct:function(){this.__It=this.__Iu=null;}
});}
)();
(function(){var a="qx.ui.virtual.cell.ICell";qx.Interface.define(a,{members:{getCellProperties:function(b,c){}
}});}
)();
(function(){var d="qx.ui.virtual.cell.Abstract",c="abstract",b="qx-cell",a="";qx.Class.define(d,{type:c,extend:qx.core.Object,implement:qx.ui.virtual.cell.ICell,construct:function(){qx.core.Object.call(this);qx.ui.virtual.cell.CellStylesheet.getInstance();}
,members:{getCssClasses:function(e,f){return b;}
,getAttributes:function(g,h){return a;}
,getStyles:function(i,j){return a;}
...
(function(){var m="}",l="qx.ui.virtual.cell.CellStylesheet",k="none",j="default",i="ellipsis",h="hidden",g="} ",f=".",e="css.boxsizing",d="content-box",a="singleton",c="absolute",b=".qx-cell {";qx.Class.define(l,{extend:qx.core.Object,type:a,construct:function(){qx.core.Object.call(this);var n=b+qx.bom.element.Style.compile({position:c,overflow:h,cursor:j,textOverflow:i,userSelect:k})+g;if(qx.core.Environment.get(e)){n+=b+qx.bom.element.BoxSizing.compile(d)+m;}
;this.__jy=qx.bom.Stylesheet.createElement(n);this.__IP={};this.__lF={};}
,members:{__jy:null,__IP:null,__lF:null,getStylesheet:function(){return this.__jy;}
,getCssClass:function(o){return this.__IP[o]||null;}
,computeClassForStyles:function(p,q){var r=this.__lF[q];if(!r){var r=this.__IQ();qx.bom.Stylesheet.addRule(this.__jy,f+r,q);this.__lF[q]=r;}
;this.__IP[p]=r;return r;}
,__IQ:function(){return "qx-cell-"+this.toHashCode()+"-"+(this.__IR++);}
,__IR:0},destruct:function(){this.__jy=this.__IP=this.__lF=null;}
});}
)();
(function(){var k="-",j="backgroundColor",h="_applyTextAlign",g="px",f="_applyFont",e="_applyBackgroundColor",d="cell",c="center",b="font",a=":",J="shorthand",I="String",H="_applyAppearance",G="background-color:",F="textAlign",E="qx-cell ",D="left",C="textColor",B="text-align:",A="Font",r="right",s="_applyTextColor",p="justify",q="color:",n=" ",o="qx.ui.virtual.cell.Cell",l="paddingLeft",m="Color",t="",u="paddingBottom",w="paddingTop",v="paddingRight",y=";",x="Integer",z="_applyPadding";qx.Class.define(o,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__jy=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__Jj={};this.__Jk={};this.__Jl={};this.__Jm={};this.__hy={};this.__Jn={};this.initAppearance();this.__Jr();}
,properties:{appearance:{check:I,init:d,apply:H},backgroundColor:{nullable:true,check:m,apply:e,themeable:true},textColor:{nullable:true,check:m,apply:s,themeable:true},textAlign:{check:[D,c,r,p],nullable:true,themeable:true,apply:h},font:{nullable:true,apply:f,check:A,themeable:true},paddingTop:{check:x,init:0,apply:z,themeable:true},paddingRight:{check:x,nullable:true,apply:z,themeable:true},paddingBottom:{check:x,nullable:true,apply:z,themeable:true},paddingLeft:{check:x,nullable:true,apply:z,themeable:true},padding:{group:[w,v,u,l],mode:J,themeable:true}},members:{__Jo:null,__Jp:null,__hy:null,__Jn:null,__Jk:null,__Jj:null,__Jl:null,__Jm:null,__Jq:false,__jy:null,__Jr:function(){var M=qx.util.PropertyUtil;var O=qx.lang.Object.fromArray(this._getCssProperties());this.__Jo=[];var L=this.constructor;while(L){var N=M.getProperties(L);for(var K in N){if(!O[K]){this.__Jo.push(K);}
;}
;L=L.superclass;}
;}
,_getCssProperties:function(){return [j,C,b,F,w,v,u,l];}
,_applyAppearance:function(P,Q){if(Q){this.__Jk={};}
;}
,_getValue:function(R){if(this.__Jq){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(S,T){var U;if(this.__Jq){U=this.__Jk;}
else {U=this.__Jj;}
;if(T===null){delete U[S];}
else {U[S]=T;}
;}
,_applyBackgroundColor:function(V,W,name){var V=this._getValue(name);if(!V){this._storeStyle(name,null);}
else {this._storeStyle(name,G+qx.theme.manager.Color.getInstance().resolve(V));}
;}
,_applyTextColor:function(X,Y,name){var X=this._getValue(name);if(!X){this._storeStyle(name,null);}
else {this._storeStyle(name,q+qx.theme.manager.Color.getInstance().resolve(X));}
;}
,_applyTextAlign:function(ba,bb,name){var ba=this._getValue(name);if(!ba){this._storeStyle(name,null);}
else {this._storeStyle(name,B+ba);}
;}
,_applyFont:function(bc,bd,name){var bc=this._getValue(name);if(!bc){this._storeStyle(name,null);}
else {var be=qx.theme.manager.Font.getInstance().resolve(bc);this._storeStyle(name,qx.bom.element.Style.compile(be.getStyles()));}
;}
,_applyPadding:function(bf,bg,name){var bf=this._getValue(name);if(this.__Jq){var bi=this.__Jm;}
else {bi=this.__Jl;}
;if(bf===null){delete bi[name];}
else {bi[name]=bf;}
;if(bf===null){this._storeStyle(name,null);}
else {var bh=qx.lang.String.hyphenate(name);this._storeStyle(name,bh+a+bf+g);}
;}
,getCellProperties:function(bj,bk){this.__Js(bk);return {classes:this.getCssClasses(bj,bk),style:this.getStyles(bj,bk),attributes:this.getAttributes(bj,bk),content:this.getContent(bj,bk),insets:this.getInsets(bj,bk)};}
,getAttributes:function(bl,bm){return t;}
,getContent:function(bn,bo){return bn;}
,getCssClasses:function(bp,bq){var br=this.__jy.getCssClass(this.__Jp)||t;return E+br;}
,__Js:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+k+qx.lang.Object.getKeys(bs).sort().join(n);if(this.__Jp==bt){return;}
;this.__Jp=bt;var bv=this.__hy[this.__Jp];if(!bv){this.__Jt();this.__Ju(bs);this.__Jv(bs);this.__Jw();this.__hy[this.__Jp]=1;}
;this.__Jx();}
,__Jt:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++){bw.deleteThemeValue(this,bx[i]);}
;}
,__Ju:function(by){this.__Jk={};this.__Jq=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var bz=qx.theme.manager.Appearance.getInstance().styleFrom(bB,by);for(var bC in bz){if(bz[bC]!==undefined){bA.setThemed(this,bC,bz[bC]);}
;}
;this.__Jq=false;}
,__Jv:function(){var bD=qx.lang.Object.getValues(this.__Jk).join(y);this.__jy.computeClassForStyles(this.__Jp,bD);}
,__Jw:function(){var bI=this.__Jo;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__Jn[this.__Jp]=bG;}
,__Jx:function(){var bK=qx.util.PropertyUtil;var bJ=this.__Jn[this.__Jp]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bM,bN){return qx.lang.Object.getValues(this.__Jj).join(y);}
,getInsets:function(bO,bP){var bT=this.__Jl;var bS=this.__Jm;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bQ=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bR=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bQ,top+bR];}
},destruct:function(){this.__jy=this.__Jj=this.__Jk=this.__Jl=this.__Jm=this.__hy=this.__Jn=this.__Jo=null;}
});}
)();
(function(){var q="width:",p="top:",o="css.boxmodel",n=">",m="qx.debug",l="content",k="</div>",j="qx.ui.virtual.layer.HtmlCell",i="style='",h="height:",c="<div ",g="class='",f="left:",b="html",a="' ",e="px;",d="";qx.Class.define(j,{extend:qx.ui.virtual.layer.Abstract,construct:function(r){qx.ui.virtual.layer.Abstract.call(this);this.setZIndex(2);if(qx.core.Environment.get(m)){this.assertInterface(r,qx.ui.virtual.core.IHtmlCellProvider);}
;this._cellProvider=r;}
,members:{_getCellSizeStyle:function(s,t,u,v){var w=d;if(qx.core.Environment.get(o)==l){s-=u;t-=v;}
;w+=q+s+e;w+=h+t+e;return w;}
,_fullUpdate:function(z,A,B,C){var I=[];var J=0;var top=0;var K=z;var E=A;for(var y=0;y<B.length;y++){var J=0;var E=A;var F=B[y];for(var x=0;x<C.length;x++){var H=C[x];var D=this._cellProvider.getCellProperties(K,E);var G=D.insets||[0,0];I.push(c,i,f,J,e,p,top,e,this._getCellSizeStyle(H,F,G[0],G[1]),D.style||d,a,g,D.classes||d,a,D.attributes||d,n,D.content||d,k);E++;J+=H;}
;top+=F;K++;}
;this.getContentElement().setAttribute(b,I.join(d));}
},destruct:function(){this._cellProvider=null;}
});}
)();
(function(){var a="qx.ui.virtual.core.IHtmlCellProvider";qx.Interface.define(a,{members:{getCellProperties:function(b,c){}
}});}
)();
...
(function(){var q="qx.ui.virtual.layer.Column",p="block",o="",n="height:",m="column-layer",k="background-color:",j="width:",h="none",g="<div style='",f="</div>",c="position: absolute;",e="top: 0;",d="'>",b="left:",a="px;";qx.Class.define(q,{extend:qx.ui.virtual.layer.AbstractBackground,properties:{appearance:{refine:true,init:m}},members:{_fullUpdate:function(r,s,t,u){var C=[];var A=qx.lang.Array.sum(t);var D=[];var F=0;var z=s;var y=0;for(var x=0;x<u.length;x++){var E=this.getBackground(z);if(E){D.push({childIndex:y,decorator:E,width:u[x],height:A});C.push(g,c,e,b,F,a,d,E.getMarkup(),f);y++;}
else {var B=this.getColor(z);if(B){C.push(g,c,e,b,F,a,j,u[x],a,n,A,a,k,B,d,f);y++;}
;}
;F+=u[x];z+=1;}
;var v=this.getContentElement().getDomElement();v.style.display=h;v.innerHTML=C.join(o);for(var i=0,l=D.length;i<l;i++){var w=D[i];w.decorator.resize(v.childNodes[w.childIndex].firstChild,w.width,w.height);}
;v.style.display=p;this._height=A;}
...
;}
,setColor:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,K,L);var N=this.getFirstColumn();var M=N+this.getColumnSizes().length-1;if(K>=N&&K<=M){this.updateLayerData();}
;}
}});}
)();
(function(){var c="right",b="qx.ui.virtual.selection.Column",a="left";qx.Class.define(b,{extend:qx.ui.virtual.selection.Row,members:{_getItemCount:function(){return this._pane.getColumnConfig().getItemCount();}
,_getSelectableFromMouseEvent:function(event){var d=this._pane.getCellAtPosition(event.getDocumentLeft(),event.getDocumentTop());if(!d){return null;}
;return this._isSelectable(d.column)?d.column:null;}
,_getRelatedSelectable:function(e,f){if(f==a){var h=e-1;var g=0;var j=-1;}
else if(f==c){var h=e+1;var g=this._getItemCount()-1;var j=1;}
else {return null;}
;for(var i=h;i!==g+j;i+=j){if(this._isSelectable(i)){return i;}
;}
;return null;}
,_scrollItemIntoView:function(k){this._pane.scrollColumnIntoView(k);}
,_getSelectableLocationX:function(l){var m=this._pane.getColumnConfig();var o=m.getItemPosition(l);var n=o+m.getItemSize(l)-1;return {left:o,right:n};}
,_getSelectableLocationY:function(p){return {top:0,bottom:this._pane.getRowConfig().getTotalSize()-1};}
}});}
)();
(function(){var f="under",e="above",d="left",c="right",b="x",a="qx.ui.virtual.selection.CellRectangle";qx.Class.define(a,{extend:qx.ui.virtual.selection.Abstract,members:{_getItemCount:function(){return this._pane.getRowConfig().getItemCount()*this._pane.getColumnConfig().getItemCount();}
,_getSelectableFromMouseEvent:function(event){var g=this._pane.getCellAtPosition(event.getDocumentLeft(),event.getDocumentTop());if(!g){return null;}
;return this._isSelectable(g)?g:null;}
,getSelectables:function(h){var j=[];var m=this._pane.getRowConfig().getItemCount();var i=this._pane.getColumnConfig().getItemCount();for(var n=0;n<m;n++){for(var k=0;k<i;k++){var l={row:n,column:k};if(this._isSelectable(l)){j.push(l);}
;}
;}
;return j;}
,_getSelectableRange:function(o,p){var s=[];var t=Math.min(o.row,p.row);var u=Math.max(o.row,p.row);var r=Math.min(o.column,p.column);var w=Math.max(o.column,p.column);for(var x=t;x<=u;x++){for(var v=r;v<=w;v++){var q={row:x,column:v};if(this._isSelectable(q)){s.push(q);}
;}
;}
;return s;}
,_getFirstSelectable:function(){var z=this._pane.getRowConfig().getItemCount();var y=this._pane.getColumnConfig().getItemCount();for(var C=0;C<z;C++){for(var B=0;B<y;B++){var A={row:C,column:B};if(this._isSelectable(A)){return A;}
;}
;}
;return null;}
,_getLastSelectable:function(){var E=this._pane.getRowConfig().getItemCount();var D=this._pane.getColumnConfig().getItemCount();for(var G=D-1;G>=0;G--){for(var H=E-1;H>=0;H--){var F={row:H,column:G};if(this._isSelectable(F)){return F;}
;}
;}
;return null;}
,_getRelatedSelectable:function(I,J){var K={row:I.row,column:I.column};switch(J){case e:for(var O=I.row-1;O>=0;O--){K.row=O;if(this._isSelectable(K)){return K;}
;}
;break;case f:var L=this._pane.getRowConfig().getItemCount();for(var O=I.row+1;O<L;O++){K.row=O;if(this._isSelectable(K)){return K;}
;}
;break;case d:for(var N=I.column-1;N>=0;N--){K.column=N;if(this._isSelectable(K)){return K;}
;}
;break;case c:var M=this._pane.getColumnConfig().getItemCount();for(var N=I.column+1;N<M;N++){K.column=N;if(this._isSelectable(K)){return K;}
;}
;break;};return null;}
...
,_getSelectableLocationX:function(T){var U=this._pane.getColumnConfig();var W=U.getItemPosition(T.column);var V=W+U.getItemSize(T.column)-1;return {left:W,right:V};}
,_getSelectableLocationY:function(X){var bb=this._pane.getRowConfig();var ba=bb.getItemPosition(X.row);var Y=ba+bb.getItemSize(X.row)-1;return {top:ba,bottom:Y};}
}});}
)();
(function(){var a="qx.ui.virtual.selection.CellLines";qx.Class.define(a,{extend:qx.ui.virtual.selection.CellRectangle,members:{_getSelectableRange:function(b,c){var g=[];var d=this._pane.getColumnConfig().getItemCount();if(b.row<c.row||b.row==c.row&&b.column<c.column){var f=b.row*d+b.column;var e=c.row*d+c.column;}
else {var f=c.row*d+c.column;var e=b.row*d+b.column;}
;for(var i=f;i<=e;i++){var h={row:Math.floor(i/d),column:i%d};if(this._isSelectable(h)){g.push(h);}
;}
;return g;}
}});}
)();
