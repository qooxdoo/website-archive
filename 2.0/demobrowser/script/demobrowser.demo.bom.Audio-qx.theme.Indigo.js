...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Audio-qx.theme.Indigo.d3938a80ae70.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{appearance:{refine:true,init:g}},events:{complete:d,change:b},members:{__vR:0,__KV:100,getValue:function(){return this.__vR;}
,setValue:function(l){var m=this.getMaximum();if(!qx.lang.Type.isNumber(l)||!isFinite(l)){return;}
;if(l<0){l=0;}
;if(l>m){l=m;}
;this.__vR=l;this._changeProgress(l/m);return l;}
,getMaximum:function(){return this.__KV;}
,setMaximum:function(n){var o=n;var p=this.getValue();if(!qx.lang.Type.isNumber(o)||!isFinite(o)||o<=0){return;}
;if(o<p){o=p;}
;this.__KV=o;this._changeProgress(p/o);return o;}
