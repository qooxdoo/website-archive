...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Flickr","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Flickr-qx.theme.Classic.cc44c230fecb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
}});qx.Class.define(A,{extend:qx.data.store.Jsonp,construct:function(P){this.setCallbackName(u);qx.data.store.Jsonp.call(this,this.__PS(P));}
,members:{searchForTag:function(Q){if(Q!=m){this.setUrl(this.__PS(Q));}
;}
,__PS:function(R){if(!R){return;}
