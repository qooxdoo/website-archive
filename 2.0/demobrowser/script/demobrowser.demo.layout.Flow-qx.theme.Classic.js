...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow-qx.theme.Classic.ba69a8c90f91.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var x=new qx.ui.layout.LineSizeIterator(A,this.getSpacingX());var y=0;while(x.hasMoreLines()){var z=x.computeNextLine(v);this.__KY(z,y,v);y+=z.height+this.getSpacingY();}
;}
,__KY:function(B,C,D){var F=qx.ui.layout.Util;var I=0;if(this.getAlignX()!="left"){I=D-B.width;if(this.getAlignX()=="center"){I=Math.round(I/2);}
;}
...
;}
,_computeSizeHint:function(){return this.__La(Infinity);}
,hasHeightForWidth:function(){return true;}
,getHeightForWidth:function(K){return this.__La(K).height;}
,__La:function(L){var M=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());var Q=0;var N=0;var O=0;while(M.hasMoreLines()){var P=M.computeNextLine(L);O+=1;N=Math.max(N,P.width);Q+=P.height;}
;return {width:N,height:Q+this.getSpacingY()*(O-1)};}
}});}
)();
(function(){var b="No more lines to compute",a="qx.ui.layout.LineSizeIterator";qx.Class.define(a,{extend:Object,construct:function(c,d){this.__dW=c;this.__Jz=d;this.__JA=c.length>0;this.__JB=0;}
,members:{__dW:null,__Jz:null,__JA:null,__JB:null,computeNextLine:function(e){var e=e||Infinity;if(!this.__JA){throw new Error(b);}
;var p=this.__dW;var n=0;var g=0;var o=[];var k=[];for(var i=this.__JB;i<p.length;i++){var m=p[i];var q=m.getSizeHint();var j=this.__JC(i);var h=q.width+j;var f=i==this.__JB;if(!f&&g+h>e){this.__JB=i;break;}
;var l=q.height+m.getMarginTop()+m.getMarginBottom();o.push(m);k.push(j);g+=h;n=Math.max(n,l);if(m.getLayoutProperties().lineBreak){this.__JB=i+1;break;}
;}
;if(i>=p.length){this.__JA=false;}
;return {height:n,width:g,children:o,gapsBefore:k};}
,__JC:function(r){var s=r==this.__JB;if(s){return this.__dW[r].getMarginLeft();}
else {return Math.max(this.__dW[r-1].getMarginRight(),this.__dW[r].getMarginLeft(),this.__Jz);}
;}
,hasMoreLines:function(){return this.__JA;}
}});}
)();
