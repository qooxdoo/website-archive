...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Simple.0285823d0a95.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(u);var D={"width":f,"height":w,"position":l,"left":o,"top":o,"background":i+G+n};this.__DV=new qx.html.Element(m,D);this.__DV.addListener(k,this.__Dj,this);this.__DV.addListener(B,this.__Di,this);F.add(this.__DV);}
,__Dj:function(e){if(e.isMultiTouch()){this.__QD=e.getRotation()+this.__QC;this.__QE=e.getScale()*this.__QB;this.__DV.setStyle(C,r+this.__QD+g+this.__QE+n);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__DV.getStyle(A))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__DV.getStyle(j))/2);this.__DV.setStyles({"left":I+q,"top":top+q});}
;}
,__Di:function(e){if(e.isMultiTouch()){this.__QC=this.__QD;this.__QB=this.__QE;}
;}
}});}
)();
