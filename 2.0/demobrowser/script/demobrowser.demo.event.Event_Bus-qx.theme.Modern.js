...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Bus","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bus-qx.theme.Modern.feac217c489d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(n,o,p){this.__Qc=f+n.join(j)+l;this.__Qd=p||50;this.__Qe=o;this._clearLog();}
,_clearLog:function(){this.__Qe.innerHTML=this.__Qc+a;this.__Qf=[];}
,_log:function(q){this.__Qf.unshift(q);this.__Qf=this.__Qf.slice(0,this.__Qd);var r=[this.__Qc];for(var i=0;i<this.__Qf.length;i++){r.push(e,this.__Qf[i].join(g),b);}
;r.push(a);this.__Qe.innerHTML=r.join(h);this.__Qe.scrollTop=0;}
,__Qc:null,__Qd:null,__Qe:null,__Qf:null},destruct:function(){this.__Qe=this.__Qf=null;}
});}
)();
...
},construct:function(){this.__DO={};}
,members:{__DO:null,getSubscriptions:function(){return this.__DO;}
...
;}
;return false;}
,dispatch:function(G){var J=this.getSubscriptions();var H=G.getName();var I=false;for(var K in J){var L=K.indexOf(d);if(L>-1){if(L===0||K.substr(0,L)===H.substr(0,L)){this.__DP(J[K],G);I=true;}
;}
else {if(K===H){this.__DP(J[H],G);I=true;}
;}
;}
;return I;}
,dispatchByName:function(name,M){var N=new qx.event.message.Message(name,M);return this.dispatch(N);}
,__DP:function(O,P){for(var i=0;i<O.length;i++){var Q=O[i].subscriber;var R=O[i].context;if(R&&R.isDisposed){if(R.isDisposed()){O.splice(i,1);i--;}
else {Q.call(R,P);}
;}
else {Q.call(R,P);}
;}
