...
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return k;
},getBox2:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,minHeight:60,allowGrowX:false});
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:c}));
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:a}));
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:b}));
return j;
