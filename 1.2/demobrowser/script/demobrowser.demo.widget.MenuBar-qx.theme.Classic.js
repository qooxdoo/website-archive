...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.MenuBar","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.MenuBar-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"137d4d83adf7"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var bD="execute",bC="changeValue",bB="icon/16/actions/system-search.png",bA="Online Forum",bz="New",by="icon/16/actions/edit-cut.png",bx="Search in files",bw="icon/16/actions/format-justify-fill.png",bv="Left aligned",bu="Undo",bj="_openCommand",bi="Uppercase",bh="View",bg="C Dialect",bf="changeSelection",be="Save as...",bd="Show line numbers",bc="Search previous...",bb="Quickstart",ba="Cut",bK="Ctrl+N",bL="C",bI="Show console",bJ="Search",bG="Help",bH="_redoCommand",bE="Redo",bF="Show status bar",bM="icon/16/actions/format-justify-left.png",bN="ANSI to OEM",bn="Centered",bm="Paragraph",bp="Edit",bo="Ctrl+O",br="icon/16/actions/document-print.png",bq="icon/16/actions/document-open.png",bt="C Sharp",bs="icon/16/actions/edit-undo.png",bl="Close",bk="icon/16/actions/document-save-as.png",c="Python",d="icon/16/apps/utilities-help.png",f="Show tree",g="Spaces to tabs",h="Right aligned",i="OEM to ANSI",j="JavaScript",k="demobrowser.demo.widget.MenuBar",l="_copyCommand",m="XML",bR="Save",bQ="_undoCommand",bP="Capitals",bO="icon/16/actions/application-exit.png",bV="C Plus Plus",bU="_saveCommand",bT="Lowercase",bS="Search next...",bX="_newCommand",bW="Replace in files",J="Perl",K="Ctrl+P",H="Topics",I="Panes",N="Justified",O="Ctrl+X",L="Show macros",M="Show ruler",F="Copy",G="Paste",u="_pasteCommand",t="icon/16/actions/format-justify-right.png",w="Ctrl+Z",v="Ctrl+R",q="icon/16/actions/edit-redo.png",p="Show tags",s="Info...",r="Format",o="File",n="Show tabs",T="Print",U="icon/16/actions/document-save.png",V="icon/16/actions/edit-copy.png",W="Search...",P="icon/16/actions/format-justify-center.png",Q="Open",R="_cutCommand",S="Objective C",X="Exit",Y="Ctrl+S",E="Syntax",D="Ctrl+C",C="icon/16/actions/document-new.png",B="Tabs to spaces",A="ASCII table",z="Replace",y="HTML",x="icon/16/actions/edit-paste.png";
...
var a=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
a.setPadding(20);
a.setAllowStretchX(false);
b.add(a);
this.getRoot().add(b,{edge:0});
this.createCommands();
a.add(this.getMenuBar(),{left:20,top:20});
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(bK);
this._newCommand.addListener(bD,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bo);
this._openCommand.addListener(bD,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(Y);
this._saveCommand.addListener(bD,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(w);
this._undoCommand.addListener(bD,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(v);
this._redoCommand.addListener(bD,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(O);
this._cutCommand.addListener(bD,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(D);
this._copyCommand.addListener(bD,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(K);
this._pasteCommand.addListener(bD,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuBar:function(){var dk=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
dk.add(menubar);
var dj=new qx.ui.menubar.Button(o,null,this.getFileMenu());
var di=new qx.ui.menubar.Button(bp,null,this.getEditMenu());
var dl=new qx.ui.menubar.Button(bJ,null,this.getSearchMenu());
var dp=new qx.ui.menubar.Button(bh,null,this.getViewMenu());
var dn=new qx.ui.menubar.Button(r,null,this.getFormatMenu());
var dm=new qx.ui.menubar.Button(bG,null,this.getHelpMenu());
menubar.add(dj);
menubar.add(di);
menubar.add(dl);
menubar.add(dp);
...
menubar.add(dm);
return dk;
},getFileMenu:function(){var cH=new qx.ui.menu.Menu;
var cF=new qx.ui.menu.Button(bz,C,this._newCommand);
var cJ=new qx.ui.menu.Button(Q,bq,this._openCommand);
var cI=new qx.ui.menu.Button(bl);
var cM=new qx.ui.menu.Button(bR,U,this._saveCommand);
var cL=new qx.ui.menu.Button(be,bk);
var cK=new qx.ui.menu.Button(T,br);
var cG=new qx.ui.menu.Button(X,bO);
cF.addListener(bD,this.debugButton);
cJ.addListener(bD,this.debugButton);
cI.addListener(bD,this.debugButton);
cM.addListener(bD,this.debugButton);
cL.addListener(bD,this.debugButton);
cK.addListener(bD,this.debugButton);
cG.addListener(bD,this.debugButton);
cH.add(cF);
cH.add(cJ);
cH.add(cI);
cH.add(cM);
...
var du=new qx.ui.menu.Button(bu,bs,this._undoCommand);
var dt=new qx.ui.menu.Button(bE,q,this._redoCommand);
var dq=new qx.ui.menu.Button(ba,by,this._cutCommand);
var dv=new qx.ui.menu.Button(F,V,this._copyCommand);
var ds=new qx.ui.menu.Button(G,x,this._pasteCommand);
du.addListener(bD,this.debugButton);
dt.addListener(bD,this.debugButton);
dq.addListener(bD,this.debugButton);
dv.addListener(bD,this.debugButton);
ds.addListener(bD,this.debugButton);
dr.add(du);
dr.add(dt);
dr.addSeparator();
dr.add(dq);
...
dr.add(ds);
return dr;
},getSearchMenu:function(){var cY=new qx.ui.menu.Menu;
var cW=new qx.ui.menu.Button(W,bB);
var dc=new qx.ui.menu.Button(bS);
var cX=new qx.ui.menu.Button(bc);
var db=new qx.ui.menu.Button(z);
var cV=new qx.ui.menu.Button(bx,bB);
var da=new qx.ui.menu.Button(bW);
cX.setEnabled(false);
cW.addListener(bD,this.debugButton);
dc.addListener(bD,this.debugButton);
cX.addListener(bD,this.debugButton);
db.addListener(bD,this.debugButton);
cV.addListener(bD,this.debugButton);
da.addListener(bD,this.debugButton);
cY.add(cW);
cY.add(dc);
cY.add(cX);
cY.add(db);
...
cY.add(da);
return cY;
},getViewMenu:function(){var ci=new qx.ui.menu.Menu;
var ck=new qx.ui.menu.Button(I,null,null,this.getPanesMenu());
var cn=new qx.ui.menu.Button(E,null,null,this.getSyntaxMenu());
var cm=new qx.ui.menu.CheckBox(M);
var cl=new qx.ui.menu.CheckBox(bd);
var cj=new qx.ui.menu.Button(A);
cm.addListener(bC,this.debugCheckBox);
cl.addListener(bC,this.debugCheckBox);
cj.addListener(bD,this.debugButton);
ci.add(ck);
ci.add(cn);
ci.addSeparator();
...
ci.add(cj);
return ci;
},getPanesMenu:function(){var cp=new qx.ui.menu.Menu;
var cr=new qx.ui.menu.CheckBox(n);
var ct=new qx.ui.menu.CheckBox(bF);
var cu=new qx.ui.menu.CheckBox(f);
var cq=new qx.ui.menu.CheckBox(L);
var cs=new qx.ui.menu.CheckBox(p);
var co=new qx.ui.menu.CheckBox(bI);
cr.setValue(true);
ct.setValue(true);
cq.setValue(true);
cr.addListener(bC,this.debugCheckBox);
ct.addListener(bC,this.debugCheckBox);
cu.addListener(bC,this.debugCheckBox);
cq.addListener(bC,this.debugCheckBox);
cs.addListener(bC,this.debugCheckBox);
co.addListener(bC,this.debugCheckBox);
cp.add(ct);
cp.add(cr);
cp.addSeparator();
cp.add(cu);
...
cp.add(co);
return cp;
},getSyntaxMenu:function(){var cR=new qx.ui.menu.Menu;
var cN=new qx.ui.menu.RadioButton(y);
var cP=new qx.ui.menu.RadioButton(m);
var cO=new qx.ui.menu.RadioButton(j);
var cQ=new qx.ui.menu.Button(bg,null,null,this.getSyntaxCMenu());
var cU=new qx.ui.menu.RadioButton(J);
var cS=new qx.ui.menu.RadioButton(c);
cR.add(cN);
cR.add(cP);
cR.add(cO);
cR.add(cQ);
cR.add(cU);
cR.add(cS);
var cT=new qx.ui.form.RadioGroup;
cT.add(cN,cP,cO,cU,cS);
cT.add.apply(cT,cQ.getMenu().getChildren());
cT.addListener(bf,this.debugRadio);
return cR;
},getSyntaxCMenu:function(){var cw=new qx.ui.menu.Menu;
var cv=new qx.ui.menu.RadioButton(bL);
var cz=new qx.ui.menu.RadioButton(bt);
var cy=new qx.ui.menu.RadioButton(S);
var cx=new qx.ui.menu.RadioButton(bV);
cw.add(cv);
cw.add(cz);
cw.add(cy);
cw.add(cx);
return cw;
},getFormatMenu:function(){var cc=new qx.ui.menu.Menu;
var cb=new qx.ui.menu.Button(bm,null,null,this.getParagraphMenu());
var ce=new qx.ui.menu.Button(B);
var cf=new qx.ui.menu.Button(g);
var ca=new qx.ui.menu.Button(bi);
var cd=new qx.ui.menu.Button(bT);
var bY=new qx.ui.menu.Button(bP);
var ch=new qx.ui.menu.Button(i);
var cg=new qx.ui.menu.Button(bN);
ce.addListener(bD,this.debugButton);
cf.addListener(bD,this.debugButton);
ca.addListener(bD,this.debugButton);
cd.addListener(bD,this.debugButton);
bY.addListener(bD,this.debugButton);
ch.addListener(bD,this.debugButton);
cg.addListener(bD,this.debugButton);
cc.add(cb);
cc.add(ce);
cc.add(cf);
...
cc.add(cg);
return cc;
},getParagraphMenu:function(){var cA=new qx.ui.menu.Menu;
var cD=new qx.ui.menu.Button(bv,bM);
var cE=new qx.ui.menu.Button(h,t);
var cB=new qx.ui.menu.Button(bn,P);
var cC=new qx.ui.menu.Button(N,bw);
cD.addListener(bD,this.debugButton);
cE.addListener(bD,this.debugButton);
cB.addListener(bD,this.debugButton);
cC.addListener(bD,this.debugButton);
cA.add(cD);
cA.add(cE);
cA.add(cB);
cA.add(cC);
return cA;
},getHelpMenu:function(){var dd=new qx.ui.menu.Menu;
var df=new qx.ui.menu.Button(H,d);
var dh=new qx.ui.menu.Button(bb);
var dg=new qx.ui.menu.Button(bA);
var de=new qx.ui.menu.Button(s);
df.addListener(bD,this.debugButton);
dh.addListener(bD,this.debugButton);
dg.addListener(bD,this.debugButton);
de.addListener(bD,this.debugButton);
dd.add(df);
dd.add(dh);
dd.addSeparator();
dd.add(dg);
...
dd.add(de);
return dd;
}},destruct:function(){this._disposeObjects(bX,bj,bU,bQ,bH,R,l,u);
}});
})();
