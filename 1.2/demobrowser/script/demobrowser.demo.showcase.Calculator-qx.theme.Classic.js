...
(function(){var P="execute",O="-",N="+",M="/",L="*",K="=",J=".",I="__MQ",H="black",G="Del",bm="sans-serif",bl="C",bk="5",bj="7",bi="demobrowser.demo.showcase.Calculator",bh="CE",bg="solid",bf="icon/22/apps/utilities-calculator.png",be="3",bd="0",W="n",X="8",U="__MR",V="6",S="4",T="Calculator",Q="2",R="Verdana",Y="1",ba="demobrowser.demo.showcase.CalculatorLogic",bc="+/-",bb="9";
qx.Class.define(bi,{extend:qx.application.Standalone,members:{__MQ:null,__MR:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__MR=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var c=new qx.ui.window.Window(T,bf);
c.setLayout(new qx.ui.layout.VBox(16));
var f=new qx.ui.decoration.Single(1,bg,H);
...
n.setLayout(x);
this.__MQ=new qx.ui.basic.Label(this.__MR.getCurrentValue().toString()).set({decorator:f,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__MQ.setEnabled(false);
var y=new qx.bom.Font().set({size:14,family:[R,bm],bold:true});
var s=new qx.ui.form.Button(bd).set({font:y,minWidth:40});
var r=new qx.ui.form.Button(Y).set({font:y,minWidth:40});
var q=new qx.ui.form.Button(Q).set({font:y,minWidth:40});
var p=new qx.ui.form.Button(be).set({font:y,minWidth:40});
var w=new qx.ui.form.Button(S).set({font:y,minWidth:40});
var v=new qx.ui.form.Button(bk).set({font:y,minWidth:40});
var u=new qx.ui.form.Button(V).set({font:y,minWidth:40});
var t=new qx.ui.form.Button(bj).set({font:y,minWidth:40});
var A=new qx.ui.form.Button(X).set({font:y,minWidth:40});
var z=new qx.ui.form.Button(bb).set({font:y,minWidth:40});
var b=new qx.ui.form.Button(bl).set({font:y,minWidth:40});
var d=new qx.ui.form.Button(bh).set({font:y,minWidth:40});
var j=new qx.ui.form.Button(G).set({font:y,minWidth:40});
var i=new qx.ui.form.Button(bc).set({font:y,minWidth:40});
var l=new qx.ui.form.Button(J).set({font:y,minWidth:40});
var h=new qx.ui.form.Button(N).set({font:y,minWidth:40});
var o=new qx.ui.form.Button(O).set({font:y,minWidth:40});
var m=new qx.ui.form.Button(L).set({font:y,minWidth:40});
var k=new qx.ui.form.Button(M).set({font:y,minWidth:40});
var g=new qx.ui.form.Button(K).set({font:y,minWidth:40});
x.setColumnFlex(0,1);
x.setColumnFlex(1,1);
x.setColumnFlex(2,1);
x.setColumnFlex(3,1);
...
x.setRowFlex(5,1);
x.setRowFlex(6,1);
n.add(this.__MQ,{row:0,column:0,rowSpan:0,colSpan:4});
...
c.add(n,{flex:1});
b.addListener(P,function(e){this.__MR.cleanDisplay();
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
d.addListener(P,function(e){this.__MR.clearEntry();

if(this.__MR.getResult()!=null){this.__MQ.setValue(this.__MR.getCurrentValue().toString());
}},this);
j.addListener(P,function(e){this.__MR.deleteNumber();
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
i.addListener(P,function(e){this.__MR.setSign();

if(this.__MR.getResult()!=null){this.__MQ.setValue(this.__MR.getResult().toString());
}},this);
s.addListener(P,function(e){this.__MR.setCurrentValue(0);
this.__MQ.setValue(this.__MR.getCurrentValue().toFixed(this.__MR.getZeroCounter()).toString());
},this);
r.addListener(P,function(e){this.__MR.setCurrentValue(1);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
q.addListener(P,function(e){this.__MR.setCurrentValue(2);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
p.addListener(P,function(e){this.__MR.setCurrentValue(3);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
w.addListener(P,function(e){this.__MR.setCurrentValue(4);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
v.addListener(P,function(e){this.__MR.setCurrentValue(5);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
u.addListener(P,function(e){this.__MR.setCurrentValue(6);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
t.addListener(P,function(e){this.__MR.setCurrentValue(7);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
A.addListener(P,function(e){this.__MR.setCurrentValue(8);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
z.addListener(P,function(e){this.__MR.setCurrentValue(9);
this.__MQ.setValue(this.__MR.getCurrentValue().toString());
},this);
h.addListener(P,function(e){this.__MR.calculate(N);

if(this.__MR.getResult()!=null){this.__MQ.setValue(this.__MR.getResult().toString());
}this.__MR.resetCurrentValue();
},this);
o.addListener(P,function(e){this.__MR.calculate(O);

if(this.__MR.getResult()!=null){this.__MQ.setValue(this.__MR.getResult().toString());
}this.__MR.resetCurrentValue();
},this);
m.addListener(P,function(e){this.__MR.calculate(L);

if(this.__MR.getResult()!=null){this.__MQ.setValue(this.__MR.getResult().toString());
}this.__MR.resetCurrentValue();
},this);
k.addListener(P,function(e){this.__MR.calculate(M);

if(this.__MR.getResult()!=null){this.__MQ.setValue(this.__MR.getResult().toString());
}this.__MR.resetCurrentValue();
},this);
g.addListener(P,function(e){this.__MR.calculate(K);

if(this.__MR.getResult()!=null){this.__MQ.setValue(this.__MR.getResult().toString());
}this.__MR.resetCurrentValue();
},this);
l.addListener(P,function(e){this.__MR.setComma();
},this);
}},destruct:function(){this._disposeObjects(U,I);
}});
qx.Class.define(ba,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__MS:0,__MT:0,__MU:"n",__MV:0,__MW:0,__MX:0,__MY:false,__Na:1,__Nb:0,__Nc:false,__Nd:0,setCurrentValue:function(F){if(this.__MY){this.__Na*=10;
this.__MS=this.__MS+(F/this.__Na);

if(F==0){this.__Nb++;
}}else{this.__MY=false;

if(this.__MS<0){this.__MS=this.__MS*10-F;
}else{this.__MS=this.__MS*10+F;
}}},getZeroCounter:function(){return this.__Nb;
},setComma:function(){this.__MY=true;
},getCurrentValue:function(){return this.__MS;
},resetCurrentValue:function(){this.__MS=null;
},cleanDisplay:function(){this.__Nd=0;
this.__MW=0;
this.__MU="n";
this.__Nb=0;
this.__Na=1;
...
this.__MT=0;
this.__Nc=false;
},setResult:function(bn){this.__MT=bn;
},getResult:function(){return Math.round(this.__MT*10000000)/10000000;
},setCurrentOperation:function(a){this.__MU=a;
},getCurrentOperation:function(){return this.__MU;
},clearEntry:function(){this.__Nc=false;
this.__Nb=0;
this.__Na=1;
this.__MY=false;
this.__MX++;
...
if(this.__MX<2){this.__MW=this.__MT;
}
if(this.__MV>=2){this.__MT=0;
this.__MV=0;
}},setSign:function(){this.__Nd++;

if(this.__Nd%2==0){this.__Nc=false;
}else{this.__Nc=true;
}
if(this.__MS==null){this.__MS=this.__MT;
}this.__MS=this.__MS*(-1);

if(this.__MT==0){this.__MT=this.__MS;
}
if(this.__MT!=0){this.__MW=this.__MT;
this.__MT=this.__MS;
}},deleteNumber:function(){var B=false;
var E=false;

if(this.__MS<0){this.__MS=this.__MS*(-1);
E=true;
}
if(this.__MS!=null){if(this.__MS.toString().lastIndexOf(J)!=-1){this.__MS=this.__MS*this.__Na;
B=true;
}}var C=this.__MS%10;
var D=C/10;
this.__MS=this.__MS/10;
this.__MS=this.__MS-D;

if(B){this.__Na/=10;
this.__MS=this.__MS/(this.__Na);
B=false;
}
if(E){this.__MS=this.__MS*(-1);
E=false;
}},calculate:function(bo){if(bo==N||bo==L||bo==M||bo==O||bo==K){this.__MY=false;
this.__Na=1;
this.__Nb=0;

if(this.__MU!=W){if(this.__MU==N){if(this.__MT==null){this.__MT=this.__MW;
}
if(this.__Nc){this.__MT=this.__MW+this.__MS;
}else{this.__MT=this.__MT+this.__MS;
}this.__MS=this.__MT;
this.__MW=this.__MT;
}
if(this.__MU==O){if(this.__MT==0){this.__MT=this.__MS;
this.__MS=0;
}
if(this.__MT==null){this.__MT=this.__MW;
}
if(this.__Nc){this.__MT=this.__MW-this.__MS;
}else{this.__MT=this.__MT-this.__MS;
}this.__MS=this.__MT;
...
if(this.__MU==M){if(this.__MT==0){this.__MT=this.__MS;
this.__MS=1;
}
if(this.__MT==null){this.__MT=this.__MW;
}
if(this.__MS!=null){if(this.__MS!=0){if(this.__Nc){this.__MT=this.__MW/this.__MS;
}else{this.__MT=this.__MT/this.__MS;
}}else{alert("You can't divide by 0!");
}}this.__MS=this.__MT;
this.__MW=this.__MT;
}
if(this.__MU==L){if(this.__MT==0){this.__MT=1;
}
if(this.__MS==null){this.__MS=1;
}
if(this.__MT==null){this.__MT=this.__MW;
}
if(this.__Nc){this.__MT=this.__MW*this.__MS;
...
this.__MW=this.__MT;
}}else{this.__MT=this.__MS;
}
if(bo!=K){this.__MU=bo;
}else{this.__MV++;
this.__MT=this.__MW;
this.__MU="n";
}this.__Nc=false;
