...
(function(){var I="changeValue",H="execute",G="icon/16/apps/office-calendar.png",F="right",E="demobrowser.demo.widget.Window",D="Yes",C="Second Window",B="Page 1",A="bottom",z="Use move frame",by="Show Statusbar",bx="icon/16/actions/dialog-cancel.png",bw="icon/32/status/dialog-error.png",bv="Show Close",bu="icon/32/apps/office-address-book.png",bt="Third Window",bs="icon/22/apps/utilities-calculator.png",br="Show Maximize",bq="Allow Close",bp="Use resize frame",P="No",Q="resizable",N="Allow Maximize",O="value",L="The second window",M="Page 3",J="move",K="Resizable ",T="First Window",U="resize",bd="Moveable",bb="Demo loaded",bh="Allow Minimize",bf="Resizable",bl="Open Modal Dialog 2",bj="Open Modal Dialog 1",W="First Modal Dialog",bo="top",bn="Movable",bm="Show Minimize",V="Basics",Y="Modal",ba="Do you want to fly to Berlin?",bc="Welcome to your first own Window.<br/>Have fun!",be="Application is ready",bg="icon/16/apps/internet-feed-reader.png",bi="Second Modal Dialog",bk="icon/16/actions/dialog-ok.png",R="Page 2",S="left",X="icon/16/apps/internet-telephony.png";
...
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var bJ=new qx.ui.window.Window(T,G);
bJ.setLayout(new qx.ui.layout.VBox(10));
bJ.setShowStatusbar(true);
bJ.setStatus(bb);
bJ.open();
this.getRoot().add(bJ,{left:20,top:20});
bJ.addListener(J,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
bJ.addListener(U,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var bI=new qx.ui.basic.Atom(bc,bu);
bI.setRich(true);
bJ.add(bI);
...
bH.add(bM);
var bK=new qx.ui.tabview.Page(R);
bH.add(bK);
var bL=new qx.ui.tabview.Page(M);
bH.add(bL);
},createWindow2:function(){var m=new qx.ui.window.Window(C,bg);
m.setLayout(new qx.ui.layout.VBox(10));
m.setStatus(be);
m.open();
this.getRoot().add(m,{left:350,top:120});
var v=new qx.ui.basic.Atom(L,bs);
m.add(v);
var f=new qx.ui.container.Composite;
f.setLayout(new qx.ui.layout.HBox(10));
m.add(f,{flex:1});
var o=new qx.ui.groupbox.GroupBox(V);
o.setLayout(new qx.ui.layout.VBox(4));
f.add(o,{flex:1});
var j=new qx.ui.form.CheckBox(bv);
j.setValue(true);
j.addListener(I,function(e){m.setShowClose(e.getData());
});
o.add(j);
var u=new qx.ui.form.CheckBox(br);
u.setValue(true);
u.addListener(I,function(e){m.setShowMaximize(e.getData());
});
o.add(u);
var n=new qx.ui.form.CheckBox(bm);
n.setValue(true);
n.addListener(I,function(e){m.setShowMinimize(e.getData());
});
o.add(n);
var q=new qx.ui.form.CheckBox(bq);
q.setValue(true);
q.addListener(I,function(e){m.setAllowClose(e.getData());
});
o.add(q);
var w=new qx.ui.form.CheckBox(N);
w.setValue(true);
w.addListener(I,function(e){m.setAllowMaximize(e.getData());
});
o.add(w);
var l=new qx.ui.form.CheckBox(bh);
l.setValue(true);
l.addListener(I,function(e){m.setAllowMinimize(e.getData());
});
o.add(l);
var g=new qx.ui.form.CheckBox(by);
g.setValue(false);
g.addListener(I,function(e){m.setShowStatusbar(e.getData());
});
o.add(g);
var y=new qx.ui.groupbox.GroupBox(bf);
y.setLayout(new qx.ui.layout.VBox(4));
f.add(y,{flex:1});
var s=new qx.ui.form.CheckBox(bp);
s.setValue(true);
s.addListener(I,function(e){m.setUseResizeFrame(e.getData());
});
y.add(s);
var t=[bo,F,A,S];

for(var i=0;i<t.length;i++){var r=t[i];
var k=new qx.ui.form.CheckBox(K+r).set({value:true});
k.bind(O,m,Q+qx.lang.String.firstUp(r));
y.add(k);
}var h=new qx.ui.groupbox.GroupBox(bd);
h.setLayout(new qx.ui.layout.VBox(4));
f.add(h,{flex:1});
var p=new qx.ui.form.CheckBox(bn);
p.setValue(true);
p.addListener(I,function(e){m.setMovable(e.getData());
});
h.add(p);
var x=new qx.ui.form.CheckBox(z);
x.addListener(I,function(e){m.setUseMoveFrame(e.getData());
});
h.add(x);
},createWindow3:function(){var bE=new qx.ui.window.Window(bt,X);
...
var bG=new qx.ui.form.Button(bj,G);
bG.addListener(H,bF.open,bF);
bE.add(bG);
},getModalWindow1:function(){var b=new qx.ui.window.Window(W);
b.setLayout(new qx.ui.layout.VBox(10));
b.setModal(true);
b.moveTo(150,150);
this.getRoot().add(b);
var a=this.getModalWindow2();
var d=new qx.ui.form.Button(bl,G);
d.addListener(H,a.open,a);
b.add(d);
var c=new qx.ui.form.CheckBox(Y);
c.setValue(true);
b.add(c);
c.addListener(I,function(e){b.setModal(e.getData());
});
return b;
},getModalWindow2:function(){var bA=new qx.ui.window.Window(bi);
bA.setLayout(new qx.ui.layout.VBox(10));
bA.setModal(true);
bA.setShowClose(false);
bA.moveTo(300,300);
this.getRoot().add(bA);
var bz=new qx.ui.basic.Atom(ba,bw);
bA.add(bz);
var bC=new qx.ui.container.Composite;
bC.setLayout(new qx.ui.layout.HBox(10,F));
bA.add(bC);
var bD=new qx.ui.form.Button(D,bk);
bD.addListener(H,function(e){bA.close();
});
bC.add(bD);
var bB=new qx.ui.form.Button(P,bx);
bB.addListener(H,function(e){alert("Sorry, please click 'Yes'!");
});
bC.add(bB);
return bA;
}}});
