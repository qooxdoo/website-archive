...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Image","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Image-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cbbc20bd283b"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="http://resources.qooxdoo.org/images/logo.gif",j="icon/32/actions/format-justify-left.png",i="Toggle enabled",h="icon/32/actions/go-home.png",g="changeValue",f="demobrowser/demo/icons/multimedia-player.png",d="icon/32/actions/format-justify-right.png",c="icon/32/actions/format-justify-fill.png",b="demobrowser.demo.widget.Image",a="icon/32/actions/format-justify-center.png";
...
r.setSpacing(20);
var m=new qx.ui.container.Composite(r);
this.getRoot().add(m,{left:20,top:20});
m.add(new qx.ui.basic.Image(f));
var q=new qx.ui.basic.Image(j);
m.add(q);
var l=new qx.ui.basic.Image(d);
m.add(l);
var o=new qx.ui.basic.Image(c);
m.add(o);
var p=new qx.ui.basic.Image(a);
m.add(p);
var n=new qx.ui.basic.Image(h);
n.setScale(true);
n.setWidth(64);
n.setHeight(64);
m.add(n);
var external=new qx.ui.basic.Image(k);
m.add(external);
var t=new qx.ui.basic.Image(k);
t.setWidth(136);
t.setHeight(40);
t.setScale(true);
m.add(t);
var s=new qx.ui.form.ToggleButton(i);
s.setValue(true);
s.addListener(g,function(e){m.setEnabled(e.getData());
});
