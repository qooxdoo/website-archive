...
var l=new qx.ui.table.pane.Header(this.getScrollerMock());
this.getRoot().add(l,{left:10,top:10});
l.onPaneModelChanged();
l.setColumnWidth(0,150);
l.addListener(d,function(e){var i=e.getTarget();

if(i instanceof qx.ui.table.headerrenderer.HeaderCell){var j=l._indexOf(i);
l.setMouseOverColumn(j);
}});
var n=new qx.ui.form.ToggleButton(h);
this.getRoot().add(n,{left:20,top:100});
n.addListener(c,function(e){var k=e.getData();

if(k){n.setLabel(b);
l.showColumnMoveFeedback(1,50);
}else{n.setLabel(h);
l.hideColumnMoveFeedback();
}});
var m=new qx.ui.form.Button(f);
this.getRoot().add(m,{left:20,top:140});
m.addListener(a,function(){l.onPaneModelChanged();
});
}}});
})();
