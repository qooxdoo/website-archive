...
(function(){var l="value",k="horizontal",j="first",h="both",g="Trash",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",H="Windows (C:)",G="Toggle Splitpane Orientation",F="Inbox",E="Desktop",D="_container1",C="execute",B="__Me",A="Presets",z="Network",y="changeSelection",s="Sent",t="/",q="Files",r="_container2",o="vertical",p="Workspace",m="Junk #",n="Data",u="Show both panes",v="Show second pane",x="demobrowser.demo.widget.SplitPane",w="Edit";
qx.Class.define(x,{extend:qx.application.Standalone,members:{__Me:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var J=new qx.ui.container.Scroll();
var I=new qx.ui.container.Composite(new qx.ui.layout.Basic());
I.setAllowStretchX(false);
J.add(I);
var P=new qx.ui.splitpane.Pane(k).set({width:450,height:300});
this.__Me=P;
var S=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:d});
var V=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:d});
var M=this.__Mf();
var L=new qx.ui.form.Button(G).set({allowGrowX:false,allowGrowY:false});
L.addListener(C,this._toggle,this);
...
P.add(S,0);
P.add(V,1);
I.add(P,{left:20,top:40});
this.getRoot().add(J,{edge:0});
var K=new qx.ui.layout.VBox(5);
var Q=new qx.ui.container.Composite(K);
var T=new qx.ui.form.RadioButton(c);
var U=new qx.ui.form.RadioButton(v);
var R=new qx.ui.form.RadioButton(u);
T.setUserData(l,j);
U.setUserData(l,f);
R.setUserData(l,h);
R.setValue(true);
...
Q.add(U);
Q.add(R);
var O=new qx.ui.form.RadioGroup(T,U,R);
O.addListener(y,this._changeVisiblity,this);
I.add(Q,{left:490,top:42});
L.focus();
},_toggle:function(){var bn=this.__Me.getOrientation();
this.__Me.setOrientation(bn==k?o:k);
},_changeVisiblity:function(e){var bm=e.getData()[0].getUserData(l);

if(bm==h){this._container1.show();
this._container2.show();
}else if(bm==j){this._container1.show();
this._container2.exclude();
}else if(bm==f){this._container1.exclude();
this._container2.show();
}},__Mf:function(){var bg=new qx.ui.tree.Tree();
bg.setDecorator(null);
var bl=new qx.ui.tree.TreeFolder(t);
bl.setOpen(true);
bg.setRoot(bl);
var bj=new qx.ui.tree.TreeFolder(E);
bj.setOpen(true);
bl.add(bj);
var bb=new qx.ui.tree.TreeFolder(q);
var Y=new qx.ui.tree.TreeFolder(p);
var ba=new qx.ui.tree.TreeFolder(z);
var X=new qx.ui.tree.TreeFolder(g);
bj.add(bb,Y,ba,X);
var bh=new qx.ui.tree.TreeFile(H);
var W=new qx.ui.tree.TreeFile(b);
Y.add(bh,W);
var bk=new qx.ui.tree.TreeFolder(F);
var bc=new qx.ui.tree.TreeFolder(A);
var bf=new qx.ui.tree.TreeFolder(s);
var be=new qx.ui.tree.TreeFolder(g);

for(var i=0;i<100;i++){be.add(new qx.ui.tree.TreeFile(m+i));
}var bi=new qx.ui.tree.TreeFolder(n);
var bd=new qx.ui.tree.TreeFolder(w);
bk.add(bc,bf,be,bi,bd);
bl.add(bk);
return bg;
}},destruct:function(){this._disposeObjects(B,D,r);
}});
})();
