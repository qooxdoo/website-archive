...
var K=new qx.ui.groupbox.GroupBox(o);
K.setWidth(200);
this.getRoot().add(K,{left:10,top:10});
var H=new qx.ui.layout.Grid();
H.setSpacing(5);
H.setColumnAlign(0,f,a);
K.setLayout(H);
var x=new qx.ui.basic.Label(b);
K.add(x,{row:0,column:0});
var A=new qx.ui.form.TextField();
K.add(A,{row:0,column:1});
var N=new qx.ui.basic.Label(d);
K.add(N,{row:1,column:0});
var I=new qx.ui.form.SelectBox();
var J=new qx.ui.form.ListItem(i);
I.add(J);
var F=new qx.ui.form.ListItem(n);
I.add(F);
var D=new qx.ui.form.ListItem(p);
I.add(D);
K.add(I,{row:1,column:1});
var P=new qx.ui.basic.Label(k);
K.add(P,{row:2,column:0});
var M=new qx.ui.form.CheckBox();
K.add(M,{row:2,column:1});
var E=new qx.ui.form.Button(m);
K.add(E,{row:3,column:0});
var z={name:null,gender:null,ok:0,hidden:e};
var L=qx.data.marshal.Json.createModel(z);
var C=new qx.data.controller.Object(L);
C.addTarget(A,r,g,true);
C.addTarget(I,j,l,true);
var y={converter:function(u){return u===1;
}};
var B={converter:function(t){return t?1:0;
}};
C.addTarget(M,r,h,true,y,B);
A.setRequired(true);
M.setRequired(true);
var O=new qx.ui.form.validation.Manager();
O.add(A,qx.util.Validate.required);
O.add(M);
O.setValidator(function(v){var w=I.getSelection()[0]!==J;
I.setValid(w);
return w;
});
var G=function(s){if(s instanceof qx.ui.form.ListItem){return s.getLabel();
}};
E.addListener(c,function(){if(O.validate()){alert("You are sending: "+qx.util.Serializer.toUriParameter(L,G));
}},this);
}}});
})();
