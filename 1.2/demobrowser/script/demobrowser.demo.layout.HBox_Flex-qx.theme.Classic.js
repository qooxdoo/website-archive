...
var q=new qx.ui.container.Composite(p).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
p.setSpacing(5);
q.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:1});
q.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
q.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:3});
return q;
},getBox2:function(){var n=new qx.ui.layout.HBox();
var o=new qx.ui.container.Composite(n).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
n.setSpacing(5);
o.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:30}),{flex:1});
o.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
o.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:150}),{flex:3});
return o;
},getBox3:function(){var h=new qx.ui.layout.HBox();
var k=new qx.ui.container.Composite(h).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
h.setSpacing(5);

for(var i=0;i<25;i++){var j=new qx.ui.core.Widget();
j.set({decorator:d,backgroundColor:c,width:5});
k.add(j,{flex:1});
}return k;
