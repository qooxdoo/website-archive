...
document.getElementById(c).onclick=function(){var q=qx.dev.Tokenizer.tokenizeJavaScript(k.value);
n.innerHTML=qx.bom.String.escape(qx.util.Json.stringify(q,true));
};
var m=function(){var o=qx.dev.Tokenizer.tokenizeJavaScript(k.value);
var p=[];

for(var i=0;i<o.length;i++){p[i]=o[i].value;
}n.innerHTML=h+qx.bom.String.escape(p.join(f))+j;
};
