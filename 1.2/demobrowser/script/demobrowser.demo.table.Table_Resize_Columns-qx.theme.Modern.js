...
var B=E.getBehavior();
B.set(0,{width:k,minWidth:40,maxWidth:80});
B.setWidth(1,i);
B.setMinWidth(1,100);
B.setMaxWidth(1,320);
var E=G.getTableColumnModel();
...
y.add(x);
w=new qx.ui.toolbar.Button(q,j);
w.addListener(r,function(H){var I=this.createRandomRows(10);
this._tableModel.addRows(I);
this.info("10 rows added");
},this);
x.add(w);
w=new qx.ui.toolbar.Button(p,d);
w.addListener(r,function(s){var t=this._tableModel.getRowCount();
...
y.add(x);
var v=this._table;
z=new qx.ui.toolbar.CheckBox(e);
z.set({value:v.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(o+b)});
z.addListener(h,function(u){v.setKeepFirstVisibleRowComplete(this.getValue());
},z);
x.add(z);
return y;
