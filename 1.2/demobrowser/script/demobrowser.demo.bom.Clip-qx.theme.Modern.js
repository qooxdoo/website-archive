...
},set2:function(){var m=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  120,null");
qx.bom.element.Clip.set(m,{left:20,top:20,width:120});
...
},set4:function(){var o=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,null  120,40");
qx.bom.element.Clip.set(o,{left:20,width:120,height:40});
