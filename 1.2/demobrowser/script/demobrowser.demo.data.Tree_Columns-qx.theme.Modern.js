...
}}},bindItem:function(M,N,O){M.bindDefaultProperties(N,O);
M.bindProperty(j,k,null,N.getUserData(j),O);
M.bindProperty(b,k,null,N.getUserData(e),O);
M.bindPropertyReverse(b,k,null,N.getUserData(e),O);
M.bindProperty(f,k,null,N.getUserData(f),O);
M.bindProperty(g,k,null,N.getUserData(g),O);
M.bindProperty(h,E,{converter:function(L){return L?n:c;
}},N.getUserData(h),O);
