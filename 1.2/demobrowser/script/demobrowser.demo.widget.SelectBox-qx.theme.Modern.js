...
(function(){var o="icon/16/devices/",n="phone.png",m="audio-card.png",l="battery.png",k="printer.png",j="Simple",h="display.png",g="audio-input-microphone.png",f="Empty Item",d="computer.png",J="Random Value ",I="input-keyboard.png",H="drive-optical.png",G="",F="media-optical.png",E="changeSelection",D="pda.png",C="network-wired.png",B=".",A="camera-photo.png",v="network-wireless.png",w="media-flash.png",t="Option ",u="input-mouse.png",r="demobrowser.demo.widget.SelectBox",s="With icons",p="drive-harddisk.png",q="camera-web.png",x="multimedia-player.png",y="Item ",z="Long text";
...
var N=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
N.setPadding(20);
N.add(this.createBox1());
N.add(this.createBox2());
N.add(this.createBox3());
N.add(this.createBox4());
O.add(N,{left:20,top:20});
this.getRoot().add(O,{edge:0});
},createBox1:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
b.add(new qx.ui.basic.Label(j));
var a=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var c=new qx.ui.form.ListItem(y+(i+1));
a.add(c);
if(i==5){a.setSelection([c]);
}}a.addListener(E,function(e){this.debug("changeSelection: "+e.getData()[0]);
});
b.add(a);
return b;
},createBox2:function(){var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
L.add(new qx.ui.basic.Label(z));
var K=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var M=new qx.ui.form.ListItem(J+Math.round(Math.random()*100000000));
K.add(M);
}L.add(K);
return L;
},createBox3:function(){var S=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
S.add(new qx.ui.basic.Label(s));
var U=[m,g,l,A,q,d,h,p,H,I,u,w,F,x,C,v,D,n,k];
var V=o;
var R=new qx.ui.form.SelectBox();

for(var i=0;i<U.length;i++){var T=new qx.ui.form.ListItem(U[i].substr(0,U[i].indexOf(B)),V+U[i]);
R.add(T);
}S.add(R);
return S;
},createBox4:function(){var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
Q.add(new qx.ui.basic.Label(f));
var P=new qx.ui.form.SelectBox();
P.add(new qx.ui.form.ListItem(G));

for(var i=0;i<10;i++){P.add(new qx.ui.form.ListItem(t+(i+1)));
}Q.add(P);
return Q;
}}});
})();
