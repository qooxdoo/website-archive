...
qx.util.Permutation.permute(r,function(l){var m=t.createHeaderCell(l);
s.add(m);
t.updateHeaderCell(l,m);
});
...
qx.util.Permutation.permute(n,function(j){var k=p.createHeaderCell(j);
o.add(k);
p.updateHeaderCell(j,k);
});
},_getNewHeaderContainer:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
q.addListener(d,function(e){e.getTarget().addState(h);
});
q.addListener(a,function(e){e.getTarget().removeState(h);
});
this._container.add(q);
return q;
