...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Grid_Animated","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Grid_Animated-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"75792c455d28"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="green",k="sinodial",j="click",i="yellow",h="width",g="height",f="demobrowser.demo.layout.Grid_Animated",d="orange",c="main";
...
s.setSpacing(20);
var r=new qx.ui.container.Composite(s);
r.setPadding(20);
this.getRoot().add(r,{left:0,top:0});
r.add(this.getAnimGrid(),{row:0,column:0});
},getNewWidget:function(){var m=new qx.ui.core.Widget().set({width:50,height:50,backgroundColor:l});
m.addListener(j,function(e){if(this._active==m){return;
}var p=[];
var n=0.3;

if(this._active){this._active.set({backgroundColor:l,width:50,height:50});
}m.set({backgroundColor:d});
var q=m.getBounds();
p.push(new demobrowser.demo.layout.Grid_Animated_Property(m,h).set({from:q.width,to:200,duration:n,transition:k}));
p.push(new demobrowser.demo.layout.Grid_Animated_Property(m,g).set({from:q.height,to:200,duration:n,transition:k}));
var o=new qx.fx.effect.core.Parallel(p[0],p[1]);
o.start();
this._active=m;
},this);
return m;
},getAnimGrid:function(){var a=new qx.ui.container.Composite().set({decorator:c,backgroundColor:i,width:500,height:500});
var b=new qx.ui.layout.Grid();
b.setSpacing(3);
a.setLayout(b);
this._active=null;

for(var x=0;x<7;x++){b.setColumnFlex(x,1);
b.setRowFlex(x,1);

for(var y=0;y<7;y++){a.add(this.getNewWidget(),{row:y,column:x});
}}return a;
}}});
})();
...
(function(){var a="demobrowser.demo.layout.Grid_Animated_Property";
qx.Class.define(a,{extend:qx.fx.Base,construct:function(b,c){this._propName=c;
qx.fx.Base.call(this,b);
},members:{update:function(d){var e={};
e[this._propName]=Math.round(d);
this._getElement().set(e);
}}});
})();
...
(function(){var b="qx.fx.effect.core.Parallel",a="__xn";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(g){qx.fx.Base.call(this);
this.__xn=arguments;
},members:{__xn:null,finish:function(){qx.fx.Base.prototype.finish.call(this);
var f=this.__xn;
...
f[i].afterFinish();
}},update:function(d){qx.fx.Base.prototype.update.call(this);
var e=this.__xn;
