...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.KeyEvent","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.KeyEvent-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"38263f197949"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this._log([q,q!==n?p.getKeyIdentifier():m,q==n?p.getCharCode():m,p.isShiftPressed(),p.isAltPressed(),p.isCtrlPressed()]);
p.preventDefault();
}}});
})();
