...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VSplit","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VSplit-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"283991bf84b2"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var p="vertical",o="main",n="Flex:1",m="Flex:1; Min:250",l="Auto",k="Flex:2",j="Flex:0",i="Flex:2; Max:100",h="Flex:1; Max:100",g="Flex:1; Max:200",d="Flex:2; Min:250",f="Flex:0; Min:350",e="demobrowser.demo.layout.VSplit";
...
var F=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(F);
F.add(this.getSplitPaneTwoFlexSimple(),{left:0});
F.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
F.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
F.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
F.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
F.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
F.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
F.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
F.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var b=new qx.ui.splitpane.Pane(p);
b.setHeight(400);
b.setDecorator(o);
...
b.add(c,2);
return b;
},getSplitPaneTwoFlexWithOneMin:function(){var D=new qx.ui.splitpane.Pane(p);
D.setHeight(400);
D.setDecorator(o);
var C=new qx.ui.form.TextArea(m);
C.setDecorator(null);
C.setWrap(true);
C.setMinHeight(250);
D.add(C,1);
...
D.add(E,2);
return D;
},getSplitPaneTwoFlexWithOneMax:function(){var u=new qx.ui.splitpane.Pane(p);
u.setHeight(400);
u.setDecorator(o);
var t=new qx.ui.form.TextArea(n);
t.setDecorator(null);
t.setWrap(true);
u.add(t,1);
var v=new qx.ui.form.TextArea(i);
v.setDecorator(null);
v.setWrap(true);
v.setMaxHeight(100);
u.add(v,2);
return u;
},getSplitPaneTwoFlexWithTwoMin:function(){var H=new qx.ui.splitpane.Pane(p);
H.setHeight(400);
H.setDecorator(o);
var G=new qx.ui.form.TextArea(m);
G.setDecorator(null);
G.setWrap(true);
G.setMinHeight(250);
H.add(G,1);
...
H.add(I,2);
return H;
},getSplitPaneTwoFlexWithTwoMax:function(){var N=new qx.ui.splitpane.Pane(p);
N.setHeight(400);
N.setDecorator(o);
var M=new qx.ui.form.TextArea(h);
M.setDecorator(null);
M.setWrap(true);
M.setMaxHeight(100);
N.add(M,1);
...
N.add(O,2);
return N;
},getSplitPaneOneFlexSimple:function(){var K=new qx.ui.splitpane.Pane(p);
K.setHeight(400);
K.setDecorator(o);
var J=new qx.ui.form.TextArea(j);
J.setDecorator(null);
J.setWrap(true);
K.add(J,0);
...
K.add(L);
return K;
},getSplitPaneOneFlexSimpleWithMax:function(){var A=new qx.ui.splitpane.Pane(p);
A.setHeight(400);
A.setDecorator(o);
...
z.setWrap(true);
A.add(z,0);
var B=new qx.ui.form.TextArea(g);
B.setDecorator(null);
B.setWrap(true);
B.setMaxHeight(200);
A.add(B);
return A;
},getSplitPaneOneFlexSimpleWithMin:function(){var x=new qx.ui.splitpane.Pane(p);
x.setHeight(400);
x.setDecorator(o);
...
x.add(y);
return x;
},getSplitPaneAuto:function(){var r=new qx.ui.splitpane.Pane(p);
r.setDecorator(o);
var q=new qx.ui.form.TextArea(l);
q.setDecorator(null);
q.setWrap(true);
r.add(q,0);
var s=new qx.ui.form.TextArea(l);
s.setDecorator(null);
s.setWrap(true);
r.add(s);
return r;
