...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.Shadow","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.Shadow-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"44e20f812800"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var d="shadow-window",c="main",b="demobrowser.demo.ui.Shadow",a="yellow";
...
var e=new qx.ui.core.Widget().set({decorator:d});
this.getRoot().add(e,{top:10,left:10});
var e=new qx.ui.core.Widget().set({shadow:d,decorator:c,backgroundColor:a});
this.getRoot().add(e,{top:10,left:150});
}}});
})();
