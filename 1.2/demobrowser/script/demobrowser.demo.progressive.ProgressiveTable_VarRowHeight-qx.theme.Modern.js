...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.progressive.ProgressiveTable_VarRowHeight","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"9443f993fd23"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var v="row",u="small icon",t="This, too, is tall.",s="No attributes specified.",q="1*",p="demobrowser/demo/icons/",o="",n="TALL ICON",m="I am tall.",l="red",d="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",k="format-justify-left.png",g="I am small.",c="end",b="multimedia-player.png",f="This, too, is small.",e="Id",h="Image",a="Note variable row heights in this table.";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__ME:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var O=p;
this.imageData=[{url:O+k,height:4,tooltip:u},{url:O+b,height:4,tooltip:n},o];
this.__ME=0;
...
for(var i=0;i<this.imageData.length;i++){if(!this.imageData[i]){continue;
}K=M.resolve(this.imageData[i].url);
N=L.toUri(K);
this.imageData[i].url=N;
++this.__ME;
qx.io.ImageLoader.load(N,function(w,x){this.info("Searching for ["+w+"]");
for(var j=0;j<this.imageData.length;j++){if(this.imageData[j].url==w){this.imageData[j].height=x.height;
--this.__ME;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__ME+", end="+this.imageData.length);
if(this.__ME==0){this.doLoad();
}return;
}}throw new Error("Image data for "+w+" not found");
},this);
}if(this.__ME==0){this.doLoad();
}},doLoad:function(){var z=this;
var G=function(P,Q){var R={renderer:v,location:c,data:[Q,z.imageData[P]]};
return R;
};
var F=new qx.ui.progressive.renderer.table.Widths(2);
F.setWidth(0,200);
F.setWidth(1,q);
var B=[e,h];
var C=new qx.ui.progressive.headfoot.TableHeading(F,B);
var A=new qx.ui.progressive.headfoot.Progress(F,B);
var J=new qx.ui.progressive.structure.Default(C,A);
var y=new qx.ui.progressive.Progressive(J);
var H=new qx.ui.basic.Atom(a);
H.setHeight(16);
H.setTextColor(l);
y.add(H);
var E=new qx.ui.progressive.model.Default();
var D=[];
D.push(G(0,g));
D.push(G(1,m));
D.push(G(0,f));
...
E.addElements(D);
y.setDataModel(E);
var I=new qx.ui.progressive.renderer.table.Row(F);
y.addRenderer(v,I);
var r=new qx.ui.progressive.renderer.table.cell.Image();
I.addRenderer(1,r);
y.set({width:400,maxWidth:400});
this.getRoot().add(y,{left:50,top:50,bottom:50});
y.render();
}}});
})();
...
qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);
this.__HH=[];

for(var i=0;i<j;i++){this.__HH[i]=new qx.ui.core.ColumnData();
}},members:{__HH:null,getData:function(){return this.__HH;
},set:function(m,n){for(var o in n){switch(o){case a:this.setWidth(m,n[o]);
break;
case b:this.setMinWidth(m,n[o]);
break;
case d:this.setMaxWidth(m,n[o]);
break;
default:throw new Error("Unrecognized key: "+o);
}}},setWidth:function(k,l){if(k>this.__HH.length-1||k<0){throw new Error("Column number out of range");
}this.__HH[k].setColumnWidth(l);
},setMinWidth:function(g,h){if(g>this.__HH.length-1||g<0){throw new Error("Column number out of range");
}this.__HH[g].setMinWidth(h);
},setMaxWidth:function(e,f){if(e>this.__HH.length-1||e<0){throw new Error("Column number out of range");
}this.__HH[e].setMaxWidth(f);
}}});
})();
...
},members:{__DC:null,join:function(c){this.__DC=c;
...
this.__DF=new qx.ui.layout.HBox();
this.__DF.connectToWidget(this);
},properties:{appearance:{refine:true,init:j}},members:{__DD:null,__DG:null,__DE:null,__DF:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);
},getLayoutChildren:function(){if(this.__DG){return this.__DD.getData();
...
this.__DG=true;
this.__DF.renderLayout(n,100);
this.__DG=false;
var o=this.__DD.getData();
for(var i=0;i<o.length;i++){this.__DE[i].setWidth(o[i].getComputedWidth());
...
(function(){var m="progressive-progressbar-indicator-undone",l="progress",k="%",j="progressive-progressbar-indicator-done",i="__HF",h="progressive-progressbar-percent-text",g="renderStart",f="__HE",d="progressive-progressbar-background",c="qx.ui.progressive.headfoot.Progress",a="progressive-progressbar-percent-background",b="renderEnd";
qx.Class.define(c,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(s,t){qx.ui.progressive.headfoot.Abstract.call(this);
this.setHeight(16);
this.setPadding(0);
this.__HD={};
var u=qx.theme.manager.Color.getInstance();
this.__HD.background=u.resolve(d);
this.__HD.indicatorDone=u.resolve(j);
this.__HD.indicatorUndone=u.resolve(m);
this.__HD.percentBackground=u.resolve(a);
this.__HD.percentText=u.resolve(h);
this.set({backgroundColor:this.__HD.background});
this.__HE=new qx.ui.core.Widget();
this.__HE.set({width:0,backgroundColor:this.__HD.indicatorDone});
this.add(this.__HE);
var v=new qx.ui.core.Widget();
v.set({backgroundColor:this.__HD.indicatorUndone});
this.add(v,{flex:1});
this.__HF=new qx.ui.basic.Atom("0%");
this.__HF.set({width:100,backgroundColor:this.__HD.percentBackground,textColor:this.__HD.percentText});
this.add(this.__HF);
this.exclude();
},members:{__HG:null,__HD:null,__HE:null,__HF:null,join:function(r){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,r);
r.addListener(g,function(e){this.__HG=e.getData().initial;
this.show();
},this);
r.addListener(l,function(e){var p=1.0-(e.getData().remaining/this.__HG);
var q=this.getBounds();

if(q){var n=Math.floor((q.width-this.__HF.getBounds().width)*p);
var o=Math.floor(p*100)+k;

if(!isNaN(n)){this.__HE.setMinWidth(n);
this.__HF.setLabel(o);
}}},this);
r.addListener(b,function(e){this.exclude();
},this);
}},destruct:function(){this.__HD=null;
this._disposeObjects(f,i);
}});
})();
...
if(!f){this.__Fe=new qx.ui.core.Widget();
this.__Ff=this.__Fe;
}else{this.__Fe=null;
this.__Ff=f;
}this.__Ff.getContentElement().setStyle(b,a);
},members:{__Fe:null,__Ff:null,applyStructure:function(e){throw new Error("applyStructure() is abstract");
},getPane:function(){return this.__Ff;
}},destruct:function(){if(this.__Fe){this.__Fe.dispose();
}this.__Fe=this.__Ff=null;
}});
})();
(function(){var a="qx.ui.progressive.structure.Default";
qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(c,d,e){qx.ui.progressive.structure.Abstract.call(this,e);
if(!c){this.__Fx=new qx.ui.progressive.headfoot.Null();
this.__Fy=this.__Fx;
}else{this.__Fx=null;
this.__Fy=c;
}if(!d){this.__Fz=new qx.ui.progressive.headfoot.Null();
this.__FA=this.__Fz;
}else{this.__Fz=null;
this.__FA=d;
}},members:{__Fy:null,__FA:null,__Fx:null,__Fz:null,applyStructure:function(b){this.__Fy.join(b);
this.__FA.join(b);
b.add(this.__Fy);
b.add(this.getPane(),{flex:1});
b.add(this.__FA);
},getHeader:function(){return this.__Fy;
},getFooter:function(){return this.__FA;
}},destruct:function(){if(this.__Fx){this.__Fx.dispose();
this.__Fx=null;
}
if(this.__Fz){this.__Fz.dispose();
this.__Fz=null;
}this.__Fy=this.__FA=null;
}});
})();
...
this.__FE=false;
this.__FF=0;
},events:{"renderStart":k,"renderEnd":k,"progress":k,"progressDetail":k},properties:{dataModel:{check:c,apply:f},batchSize:{check:g,init:20},flushWidgetQueueAfterBatch:{check:d,init:false},interElementTimeout:{check:g,init:0}},members:{__FB:null,__FE:null,__FG:null,__FF:null,__FD:null,__FC:null,getStructure:function(){return this.__FC;
},addRenderer:function(name,t){this.__FB[name]=t;
t.join(this,name);
},removeRenderer:function(name){if(!this.__FB[name]){throw new Error("No existing renderer named "+name);
}delete this.__FB[name];
},render:function(){if(this.__FE){return;
}this.__FE=true;
var m=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__FC.getPane(),batchSize:this.getBatchSize(),rendererData:this.__FI(),userData:{}});
this.__FG=new Date();
if(this.__FD){this.__FF=m.getModel().getElementCount();
this.fireDataEvent(h,{state:m,initial:this.__FF});
this.__FH(m);
}else{qx.event.Timer.once(function(){this.__FF=m.getModel().getElementCount();
this.fireDataEvent(h,{state:m,initial:this.__FF});
this.__FH(m);
this.__FD=true;
},this,10);
}},_applyDataModel:function(r,s){if(s){s.removeListener(j,this.__FJ,this);
s.dispose();
}r.addListener(j,this.__FJ,this);
},__FH:function(n){var o;
var q;
var p;

for(var i=n.getBatchSize();i>0;i--){o=n.getModel().getNextElement();

if(!o){this.debug("Render time: "+(new Date()-this.__FG)+"ms");
this.__FE=false;
this.fireDataEvent("renderEnd",n);
n.dispose();
return ;
}q=o.element;
p=this.__FB[q.renderer];
p.render(n,q);
this.fireDataEvent("progressDetail",{initial:this.__FF,remaining:o.remaining,element:q});
}this.fireDataEvent("progress",{initial:this.__FF,remaining:o.remaining});
if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();
}qx.event.Timer.once(function(){this.__FH(n);
},this,this.getInterElementTimeout());
},__FI:function(){var u={};

for(var name in this.__FB){u[name]={};
}return u;
},__FJ:function(e){this.__FF=e.getData();
this.render();
}},destruct:function(){for(var name in this.__FB){this.__FB[name].dispose();
}this.__FG=this.__FB=this.__FC=null;
}});
})();
...
this.__Gj=[];
},members:{__Gj:null,addElements:function(c){this.__Gj=this.__Gj.concat(c);
this.fireDataEvent(b,this.__Gj.length);
},addElement:function(d){this.__Gj.push(d);
this.fireDataEvent(b,this.__Gj.length);
},getElementCount:function(){return this.__Gj.length;
},getNextElement:function(){if(this.__Gj.length>0){return ({element:this.__Gj.shift(),remaining:this.__Gj.length});
}return null;
...
(function(){var l=".qx-progressive-",k="-col-",j="px;",h="-row",g="}",f="width: ",d="0px ",c="qx-progressive-",b="px",a="  font-size: 11px;",T="padding: ",S="px ",R='',Q="end",P="qx.client",O="div",N="  position: absolute;",M="  width : 100%;",L="__columnData",K="  border-bottom:1px solid #eeeeee;",s="",t="  top: 0px;",q="  overflow:hidden;",r=" {",o="  cursor:default;",p="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",m="-row {",n="resize",u="start",v="relative",C="  -o-text-overflow: ellipsis;",A="mshtml",E="  border-right:1px solid #f2f2f2;",D="  white-space:nowrap;",G=';-moz-user-select:none;',F="  padding : 0px 6px 0px 6px;",x="qx.ui.progressive.renderer.table.Row",J="__Et",I="progressive-table-row-background-odd",H="  text-overflow:ellipsis;",w="__Ew",y="  height: 100%;",z="progressive-table-row-background-even",B="left: ";
qx.Class.define(x,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bJ){qx.ui.progressive.renderer.Abstract.call(this);
this.__Er=bJ;
this.__Es={};
this.__Et=new qx.ui.progressive.renderer.table.cell.Default();
this.__Eu=null;
this.__Ev={};
var bK=qx.theme.manager.Color.getInstance();
this.__Ev.bgcol=[];
this.__Ev.bgcol[0]=bK.resolve(z);
this.__Ev.bgcol[1]=bK.resolve(I);
this.__Ew=new qx.ui.layout.HBox();
this.__Ew.connectToWidget(this);
},statics:{__Ex:null,__Ey:6,__Ez:N+t+y+q+H+C+D+E+K+F+o+a+p+(qx.core.Variant.isSet(P,A)?R:G)},properties:{defaultRowHeight:{init:16}},members:{__Eu:null,__EA:null,__EB:null,__Er:null,__Es:null,__Et:null,__Ev:null,__Ew:null,join:function(U,name){if(this.__Eu){throw new Error("Renderer is already joined to a Progressive.");
}this.__Eu=U;
this.__EA=name;
var W=qx.ui.progressive.renderer.table.Row;

if(!W.__Ex){W.__Ex={};
}var V=U.toHashCode();

if(!W.__Ex[V]){W.__Ex[V]={rowstylesheet:null,cellstylesheet:[]};
var X=l+V+m+M+g;
W.__Ex[V].rowstylesheet=qx.bom.Stylesheet.createElement(X);
var Y=this.__Er.getData();

for(var i=0;i<Y.length;i++){var X=l+V+k+i+r+W.__Ez+g;
W.__Ex[V].cellstylesheet[i]=qx.bom.Stylesheet.createElement(X);
}this.__EB=V;
var ba=U.getStructure().getPane();
ba.addListener(n,this._resizeColumns,this);
}},addRenderer:function(bg,bh){var bi=this.__Er.getData();

if(bg<0||bg>=bi.length){throw new Error("Column "+bg+" out of range (max: "+(bi.length-1)+")");
}this.__Es[bg]=bh;
},removeRenderer:function(bH){var bI=this.__Er.getData();

if(bH<0||bH>=bI.length){throw new Error("Column "+bH+" out of range (max: "+(bI.length-1)+")");
}
if(!this.__Es[bH]){throw new Error("No existing renderer for column "+bH);
}delete this.__Es[bH];
},render:function(bu,bv){var bF=bv.data;
var bA=[];
var bC;
var bB;
var by=0;
if(bu.getRendererData()[this.__EA].end===undefined){bu.getRendererData()[this.__EA]={end:0,start:1,rows:0,totalHeight:0};
}var bE=document.createElement(O);
for(var i=0;i<bF.length;i++){var bz=c+this.__EB+k+i;
bB=this.__Es[i]||this.__Et;
bC={state:bu,rowDiv:bE,stylesheet:bz,element:bv,dataIndex:i,cellData:bF[i],height:by};
bA.push(bB.render(bC));
if(bC.height>by){by=bC.height;
}}by=(by>0?by:this.getDefaultRowHeight());
var bD=bu.getRendererData()[this.__EA];
bD.totalHeight+=by;
bE.style.position=v;
bE.style.height=by+b;
bE.className=c+this.__EB+h;
bE.innerHTML=bA.join(s);
switch(bv.location){case Q:var bw=bD.end||0;
bE.style.backgroundColor=this.__Ev.bgcol[bw];
bD.end=(bw==0?1:0);
bu.getPane().getContentElement().getDomElement().appendChild(bE);
break;
case u:var bx=bu.getPane().getContentElement().getDomElement();
var bG=bx.childNodes;
if(bG.length>0){var bw=bD.start;
bE.style.backgroundColor=this.__Ev.bgcol[bw];
bD.start=(bw==0?1:0);
bx.insertBefore(bE,bG[0]);
break;
}else{bx.appendChild(bE);
}break;
default:throw new Error("Invalid location: "+bv.location);
}++bD.rows;
},getLayoutChildren:function(){return this.__Er.getData();
},_resizeColumns:function(e){var bq=this.__Eu.getStructure().getPane();
var bn=bq.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bo=l+this.__EB+h;
var bk=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bk.__Ex[this.__EB].rowstylesheet,bo);
var bm=f+bn+j;
qx.bom.Stylesheet.addRule(bk.__Ex[this.__EB].rowstylesheet,bo,bm);
this.__Ew.renderLayout(bn,100);
var bp=this.__Er.getData();
for(var i=0,bt=0;i<bp.length;i++,bt+=bn){var bo=l+this.__EB+k+i;
var bk=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bk.__Ex[this.__EB].cellstylesheet[i],bo);
bn=bp[i].getComputedWidth();
{};
var bl;

if(qx.bom.client.Feature.CONTENT_BOX){bl=qx.ui.progressive.renderer.table.Row.__Ey*2;
}else{bl=-1;
}var bs=(bn-bl)+j;
var br=d+qx.ui.progressive.renderer.table.Row.__Ey+S+d+qx.ui.progressive.renderer.table.Row.__Ey+j;
var bj=bt+j;
var bm=bk.__Ez+f+bs+B+bj+T+br;
qx.bom.Stylesheet.addRule(bk.__Ex[this.__EB].cellstylesheet[i],bo,bm);
}}},destruct:function(){var name;

for(name in this.__Es){this.__Es[name]=null;
}var bc=qx.ui.progressive.renderer.table.Row;
var bb=this.__Eu.toHashCode();

if(bc.__Ex&&bc.__Ex[bb]){if(bc.__Ex[bb].rowstylesheet){var be=l+this.__EB+h;
var bc=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bc.__Ex[this.__EB].rowstylesheet,be);
}if(bc.__Ex[bb].cellstylesheet){for(var i=bc.__Ex[bb].cellstylesheet.length-1;i>=0;i--){var be=l+this.__EB+k+i;
var bd=bc.__Ex[this.__EB].cellstylesheet[i];
var bc=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bd,be);
}}}
if(this.__Eu&&this.__Eu.getRendererData){var bf=this.__Eu.getRendererData();

if(bf&&bf[this.__EA]&&bf[this.__EA].end!==undefined){bf[this.__EA]=null;
}}this.__Ev=this.__Es=this.__Eu=this.__Er=null;
this._disposeObjects(w,J,L);
}});
})();
(function(){var m="",l="'",k="abstract",j=">",i="</div>",h="<div ",g="' ",f="style='",e="qx.ui.progressive.renderer.table.cell.Abstract",d="class='";
qx.Class.define(e,{type:k,extend:qx.core.Object,members:{_getCellStyle:function(n){return m;
},_getCellExtras:function(o){return m;
},_getContentHtml:function(p){return p.cellData||m;
},render:function(a){var c=[];
var b=this._getCellStyle(a);
c.push(h,d,a.stylesheet,g);

if(b){c.push(f,b,l);
}c.push(this._getCellExtras(a),j,this._getContentHtml(a),i);
return c.join(m);
}}});
})();
...
(function(){var l='" ',k='src="',j="px'",i="qx.ui.progressive.renderer.table.cell.Icon",h="qx.client",g="string",f="vertical-align:middle;",e="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",d='<img ',c=">",x=" style='padding-top:2px;'",w="text-align:center;",v="",u=" title='",t="'",s="mshtml",r=" width='",q="abstract",p='" style="filter:',o=" height='",m="qx/static/blank.gif",n="',sizingMethod='scale')";
qx.Class.define(i,{type:q,extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);
var E=qx.util.AliasManager.getInstance();
var F=qx.util.ResourceManager.getInstance();
var G=E.resolve(m);
this.__Dl=F.toUri(G);
},members:{__Dl:null,getBlankImage:function(){return this.__Dl;
},_identifyImage:function(A){throw new Error("_identifyImage() is abstract");
},_getCellStyle:function(y){var z=qx.ui.progressive.renderer.table.cell.Abstract.prototype._getCellStyle.call(this,y)+w+f;
return z;
},_getContentHtml:function(B){var C=[];
var D=this.__Dm(B);
C.push(d);
if(qx.core.Variant.isSet(h,s)&&/\.png$/i.test(D.url)){C.push(k,this.__Dl,p,e,D.url,n,l);
}else{C.push(k,D.url,l);
}if(D.imageWidth){C.push(r,D.imageWidth,j);
}if(D.imageHeight){C.push(o,D.imageHeight,j);
}C.push(x);
if(D.tooltip){C.push(u,D.tooltip,t);
}if(D.extras){C.push(D.extras);
}C.push(c);
return C.join(v);
},__Dm:function(a){var b=this._identifyImage(a);
if(b==null||typeof b==g){b={url:b,tooltip:null};
}if(b.url==null){b.url=this.__Dl;
}return b;
}}});
})();
...
if(d===undefined){this.__Dn=d;
}else{this.__Dn=16;
}
if(e===undefined){this.__Do=e;
}else{this.__Do=16;
}},members:{__Dn:null,__Do:null,_identifyImage:function(f){var j={imageWidth:this.__Dn,imageHeight:this.__Do};
var k;
