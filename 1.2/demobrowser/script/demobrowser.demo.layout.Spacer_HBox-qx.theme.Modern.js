...
(function(){var j="main",i="green",h="yellow",g="top",f="bottom",e="middle",d="demobrowser.demo.layout.Spacer_HBox";
...
var m=this.getRoot();
m.add(this.getSpacerWithoutFlex(),{left:10,top:10});
m.add(this.getSpacerWithFlex(),{left:10,top:70});
m.add(this.getAddRemoveSpacer(),{left:10,top:200});
},getSpacerWithoutFlex:function(){var k=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,allowGrowX:false});
var l=new qx.ui.layout.HBox();
l.setSpacing(5);
k.setLayout(l);
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
k.add(new qx.ui.core.Spacer(30,40));
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return k;
},getSpacerWithFlex:function(){var n=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,height:100,width:400});
var o=new qx.ui.layout.HBox();
o.setSpacing(5);
n.setLayout(o);
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:g}));
n.add(new qx.ui.core.Spacer(30,40),{flex:1});
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:e}));
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:f}));
return n;
},getAddRemoveSpacer:function(){var a=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h});
var c=new qx.ui.layout.HBox();
c.setSpacing(5);
a.setLayout(c);
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:g}));
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:e}));
var b=new qx.ui.core.Spacer(30,40);
a.add(b,{flex:1});
a.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:f}));
a.remove(b);
return a;
}}});
})();
