...
var G=true;
D.addListener(r,function(){B.setWidth(G?300:200);
G=!G;
});
this.getRoot().add(D,{left:330,top:20});
var C=new qx.ui.form.Button(o);
var F=true;
C.addListener(r,function(){B.getChildren()[0].setWidth(F?100:300);
F=!F;
});
this.getRoot().add(C,{left:430,top:20});
var E=this.generateScrollbarConfig(q,100);
var A=this.generateScrollbarConfig(p,120);
E.addListener(s,function(e){B.setScrollbarX(e.getData()[0].getUserData(t));
});
A.addListener(s,function(e){B.setScrollbarY(e.getData()[0].getUserData(t));
});
