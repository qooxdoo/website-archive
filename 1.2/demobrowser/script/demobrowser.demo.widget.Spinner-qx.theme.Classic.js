...
},addNonEditableSpinner:function(C,D){var E=new qx.ui.form.Spinner(0,50,100);
E.setEditable(false);
C.add(new qx.ui.basic.Label(n),{column:0,row:D});
C.add(new qx.ui.basic.Label(s),{column:1,row:D});
C.add(E,{column:2,row:D});
C.add(new qx.ui.basic.Label(q),{column:3,row:D});
...
},addSteppedSpinner:function(w,x){var y=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
w.add(new qx.ui.basic.Label(l),{column:0,row:x});
w.add(new qx.ui.basic.Label(j),{column:1,row:x});
w.add(y,{column:2,row:x});
w.add(new qx.ui.basic.Label(g),{column:3,row:x});
},addDisabledSpinner:function(z,A){var B=new qx.ui.form.Spinner;
B.setEnabled(false);
z.add(new qx.ui.basic.Label(o),{column:0,row:A});
z.add(new qx.ui.basic.Label(s),{column:1,row:A});
z.add(B,{column:2,row:A});
z.add(new qx.ui.basic.Label(q),{column:3,row:A++});
