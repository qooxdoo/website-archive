...
(function(){var dd="execute",dc="changeValue",db="icon/16/actions/edit-cut.png",da="changeSelection",cY="icon/16/actions/edit-paste.png",cX="Copy",cW="Paste",cV="icon/16/actions/edit-copy.png",cU="Cut",cT="icon/16/actions/system-search.png",cx="New",cw="Undo",cv="icon/16/actions/document-save.png",cu="Redo",ct="icon/22/apps/preferences-users.png",cs="icon/16/actions/document-print.png",cr="icon/16/actions/document-open.png",cq="icon/16/actions/edit-undo.png",cp="Save",co="icon/16/actions/edit-redo.png",dk="Print",dl="Open",di="icon/16/actions/document-new.png",dj="Online Forum",dg="icon/16/actions/format-justify-fill.png",dh="Search in files",de="C",df="__LN",dm="Left aligned",dn="Perl",cM="View",cL="C Dialect",cO="Info...",cN="Save as...",cQ="Show line numbers",cP="__LP",cS="Quickstart",cR="icon/16/actions/contact-new.png",cK="Actions",cJ="__LO",bf="Show console",bg="Search",bh="Help",bi="Show status bar",bj="icon/16/actions/format-justify-left.png",bk="ANSI to OEM",bl="Centered",bm="Website 3",bn="Edit",bo="icon/16/actions/format-justify-center.png",ds="__LQ",dr="icon/16/actions/go-previous.png",dq="C Sharp",dp="Close",dw="Website 2",dv="icon/16/actions/document-save-as.png",du="Python",dt="icon/16/apps/utilities-help.png",dy="Show tree",dx="Options",bN="Spaces to tabs",bO="Right aligned",bL="Action 1",bM="OEM to ANSI",bR="Line 431",bS="__LR",bP="JavaScript",bQ="icon",bJ="Action 2",bK="Folder ",bw="XML",bv="Line 313",by="Paragraph",bx="demobrowser.demo.widget.Menu",bs="icon/16/actions/application-exit.png",br="__LM",bu="C Plus Plus",bt="Line 26",bq="Item ",bp="ASCII table",bX="Option 1",bY="Search next...",ca="Line 12",cb="Action 3",bT="Replace in files",bU="Uppercase",bV="Topics",bW="Panes",cc="Justified",cd="Show macros",bG="Search previous...",bF="Back",bE="__LK",bD="main",bC="icon/16/actions/format-justify-right.png",bB="icon/16/actions/go-next.png",bA="command ",bz="Option 3",bI="Next",bH="__LL",ce="Show tags",cf="Capitals",cg="Format",ch="File",ci="Show tabs",cj="Split Button",ck="Tabs to spaces",cl="Search...",cm="Line 1039",cn="Option 2",cB="Objective C",cA="Exit",cz="move to",cy="Syntax",cF="Show ruler",cE="Website 1",cD="Menu Button",cC="Line 30",cH="Lowercase",cG="Replace",cI="HTML";
qx.Class.define(bx,{extend:qx.application.Standalone,members:{__LK:null,__LL:null,__LM:null,__LN:null,__LO:null,__LP:null,__LQ:null,__LR:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var ew=new qx.ui.container.Scroll();
var ev=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
ev.setPadding(20);
ev.setAllowStretchX(false);
ew.add(ev);
this.getRoot().add(ew,{edge:0});
this.createCommands();
ev.add(this.getMenuButton(),{left:20,top:20});
ev.add(this.getSplitButton(),{left:150,top:20});
ev.add(this.getMenuBar(),{left:20,top:100});
ev.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var eo=new qx.ui.menu.Menu();
var ep=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){ep.add(new qx.ui.menu.Button(bK+(i+1)));
}eo.add(new qx.ui.menu.Button(cz,null,null,ep));
eo.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){eo.add(new qx.ui.menu.Button(bA+(i+1)));
}return eo;
...
},createCommands:function(){this.__LK=new qx.ui.core.Command("Ctrl+N");
this.__LK.addListener(dd,this.debugCommand);
this.__LL=new qx.ui.core.Command("Ctrl+O");
this.__LL.addListener(dd,this.debugCommand);
this.__LM=new qx.ui.core.Command("Ctrl+S");
this.__LM.addListener(dd,this.debugCommand);
this.__LN=new qx.ui.core.Command("Ctrl+Z");
this.__LN.addListener(dd,this.debugCommand);
this.__LO=new qx.ui.core.Command("Ctrl+R");
this.__LO.addListener(dd,this.debugCommand);
this.__LP=new qx.ui.core.Command("Ctrl+X");
this.__LP.addListener(dd,this.debugCommand);
this.__LQ=new qx.ui.core.Command("Ctrl+C");
this.__LQ.addListener(dd,this.debugCommand);
this.__LR=new qx.ui.core.Command("Ctrl+P");
this.__LR.addListener(dd,this.debugCommand);
this.__LR.setEnabled(false);
},getMenuButton:function(){var ex=new qx.ui.menu.Menu;
ex.add(new qx.ui.menu.RadioButton(bX));
ex.add(new qx.ui.menu.RadioButton(cn));
ex.add(new qx.ui.menu.RadioButton(bz));
var eF=new qx.ui.menu.Menu;
eF.add(new qx.ui.menu.RadioButton(bL));
eF.add(new qx.ui.menu.RadioButton(bJ));
eF.add(new qx.ui.menu.RadioButton(cb));
var eE=new qx.ui.form.RadioGroup;
eE.add.apply(eE,ex.getChildren());
eE.addListener(da,this.debugRadio);
var eC=new qx.ui.form.RadioGroup;
eC.add.apply(eC,eF.getChildren());
eC.addListener(da,this.debugRadio);
var eA=new qx.ui.menu.Menu();
var eD=new qx.ui.menu.Button(cw,cq,this.__LN);
var eK=new qx.ui.menu.Button(cu,co,this.__LO);
var ez=new qx.ui.menu.Button(cU,db,this.__LP);
var eH=new qx.ui.menu.Button(cX,cV,this.__LQ);
var eB=new qx.ui.menu.Button(cW,cY,this.__LR);
var ey=new qx.ui.menu.Button(dx,cT,null,ex);
var eI=new qx.ui.menu.Button(cK,cR,null,eF);
var eG=new qx.ui.menu.Button(dk,cs);
eD.addListener(dd,this.debugButton);
eK.addListener(dd,this.debugButton);
ez.addListener(dd,this.debugButton);
eH.addListener(dd,this.debugButton);
eB.addListener(dd,this.debugButton);
ey.addListener(dd,this.debugButton);
...
eA.addSeparator();
eA.add(eG);
var eJ=new qx.ui.form.MenuButton(cD,ct,eA);
return eJ;
},getSplitButton:function(){var eq=new qx.ui.menu.Menu;
var eu=new qx.ui.menu.Button(cE);
var es=new qx.ui.menu.Button(dw);
var et=new qx.ui.menu.Button(bm);
eq.setMinWidth(120);
eu.addListener(dd,this.debugButton);
es.addListener(dd,this.debugButton);
et.addListener(dd,this.debugButton);
eq.add(eu);
eq.add(es);
eq.add(et);
var er=new qx.ui.form.SplitButton(cj,ct,eq);
er.addListener(dd,this.debugButton);
return er;
},getMenuBar:function(){var dQ=new qx.ui.container.Composite(new qx.ui.layout.Grow);
dQ.setDecorator(bD);
...
var dT=new qx.ui.toolbar.Part;
toolbar.add(ea);
toolbar.add(dP);
toolbar.addSpacer();
toolbar.add(dT);
var dY=new qx.ui.toolbar.SplitButton(bF,dr,this.getBackMenu());
var dV=new qx.ui.toolbar.SplitButton(bI,bB,this.getForwardMenu());
var dO=new qx.ui.toolbar.Button(cx,di,this.__LK);
var dS=new qx.ui.toolbar.Button(dl,cr,this.__LL);
var dX=new qx.ui.toolbar.Button(cp,cv,this.__LM);
dY.addListener(dd,this.debugButton);
dV.addListener(dd,this.debugButton);
dO.addListener(dd,this.debugButton);
dS.addListener(dd,this.debugButton);
dX.addListener(dd,this.debugButton);
ea.add(dY);
ea.add(dV);
ea.addSeparator();
ea.add(dO);
...
ea.add(dX);
ea.setShow(bQ);
var dR=new qx.ui.toolbar.MenuButton(ch);
var dN=new qx.ui.toolbar.MenuButton(bn);
var dM=new qx.ui.toolbar.MenuButton(bg);
var eb=new qx.ui.toolbar.MenuButton(cM);
var dW=new qx.ui.toolbar.MenuButton(cg);
dR.setMenu(this.getFileMenu());
dN.setMenu(this.getEditMenu());
dM.setMenu(this.getSearchMenu());
eb.setMenu(this.getViewMenu());
dW.setMenu(this.getFormatMenu());
dP.add(dR);
dP.add(dN);
dP.add(dM);
dP.add(eb);
dP.add(dW);
var dU=new qx.ui.toolbar.MenuButton(bh);
dU.setMenu(this.getHelpMenu());
dT.add(dU);
return dQ;
},getBackMenu:function(){var H=new qx.ui.menu.Menu;
var I=new qx.ui.menu.Button(bv);
var K=new qx.ui.menu.Button(cm);
var G=new qx.ui.menu.Button(ca);
var J=new qx.ui.menu.Button(bt);
...
H.add(J);
return H;
},getForwardMenu:function(){var W=new qx.ui.menu.Menu;
var X=new qx.ui.menu.Button(bR);
var Y=new qx.ui.menu.Button(cC);
...
var a=new qx.ui.menu.Button(cx,di,this.__LK);
var f=new qx.ui.menu.Button(dl,cr,this.__LL);
var d=new qx.ui.menu.Button(dp);
var j=new qx.ui.menu.Button(cp,cv,this.__LM);
var h=new qx.ui.menu.Button(cN,dv);
var g=new qx.ui.menu.Button(dk,cs);
var b=new qx.ui.menu.Button(cA,bs);
a.addListener(dd,this.debugButton);
f.addListener(dd,this.debugButton);
d.addListener(dd,this.debugButton);
j.addListener(dd,this.debugButton);
h.addListener(dd,this.debugButton);
g.addListener(dd,this.debugButton);
...
c.add(b);
return c;
},getEditMenu:function(){var A=new qx.ui.menu.Menu;
var D=new qx.ui.menu.Button(cw,cq,this.__LN);
var C=new qx.ui.menu.Button(cu,co,this.__LO);
var z=new qx.ui.menu.Button(cU,db,this.__LP);
var E=new qx.ui.menu.Button(cX,cV,this.__LQ);
var B=new qx.ui.menu.Button(cW,cY,this.__LR);
D.addListener(dd,this.debugButton);
C.addListener(dd,this.debugButton);
...
var Q=new qx.ui.menu.Button(cl,cT);
var V=new qx.ui.menu.Button(bY);
var R=new qx.ui.menu.Button(bG);
var U=new qx.ui.menu.Button(cG);
var P=new qx.ui.menu.Button(dh,cT);
var T=new qx.ui.menu.Button(bT);
R.setEnabled(false);
...
S.add(T);
return S;
},getViewMenu:function(){var k=new qx.ui.menu.Menu;
var m=new qx.ui.menu.Button(bW,null,null,this.getPanesMenu());
var p=new qx.ui.menu.Button(cy,null,null,this.getSyntaxMenu());
var o=new qx.ui.menu.CheckBox(cF);
var n=new qx.ui.menu.CheckBox(cQ);
var l=new qx.ui.menu.Button(bp);
o.addListener(dc,this.debugCheckBox);
n.addListener(dc,this.debugCheckBox);
...
k.add(l);
return k;
},getPanesMenu:function(){var ei=new qx.ui.menu.Menu;
var ek=new qx.ui.menu.CheckBox(ci);
var em=new qx.ui.menu.CheckBox(bi);
var en=new qx.ui.menu.CheckBox(dy);
var ej=new qx.ui.menu.CheckBox(cd);
var el=new qx.ui.menu.CheckBox(ce);
var eh=new qx.ui.menu.CheckBox(bf);
ek.setValue(true);
em.setValue(true);
ej.setValue(true);
ek.addListener(dc,this.debugCheckBox);
em.addListener(dc,this.debugCheckBox);
en.addListener(dc,this.debugCheckBox);
ej.addListener(dc,this.debugCheckBox);
el.addListener(dc,this.debugCheckBox);
eh.addListener(dc,this.debugCheckBox);
ei.add(em);
ei.add(ek);
ei.addSeparator();
ei.add(en);
...
ei.add(eh);
return ei;
},getSyntaxMenu:function(){var dI=new qx.ui.menu.Menu;
var dE=new qx.ui.menu.RadioButton(cI);
var dG=new qx.ui.menu.RadioButton(bw);
var dF=new qx.ui.menu.RadioButton(bP);
var dH=new qx.ui.menu.Button(cL,null,null,this.getSyntaxCMenu());
var dL=new qx.ui.menu.RadioButton(dn);
var dJ=new qx.ui.menu.RadioButton(du);
dI.add(dE);
dI.add(dG);
dI.add(dF);
dI.add(dH);
dI.add(dL);
dI.add(dJ);
var dK=new qx.ui.form.RadioGroup;
dK.add(dE,dG,dF,dL,dJ);
dK.add.apply(dK,dH.getMenu().getChildren());
dK.addListener(da,this.debugRadio);
return dI;
},getSyntaxCMenu:function(){var dA=new qx.ui.menu.Menu;
var dz=new qx.ui.menu.RadioButton(de);
var dD=new qx.ui.menu.RadioButton(dq);
var dC=new qx.ui.menu.RadioButton(cB);
var dB=new qx.ui.menu.RadioButton(bu);
dA.add(dz);
dA.add(dD);
dA.add(dC);
dA.add(dB);
return dA;
},getFormatMenu:function(){var t=new qx.ui.menu.Menu;
var s=new qx.ui.menu.Button(by,null,null,this.getParagraphMenu());
var v=new qx.ui.menu.Button(ck);
var w=new qx.ui.menu.Button(bN);
var r=new qx.ui.menu.Button(bU);
var u=new qx.ui.menu.Button(cH);
var q=new qx.ui.menu.Button(cf);
var y=new qx.ui.menu.Button(bM);
var x=new qx.ui.menu.Button(bk);
v.addListener(dd,this.debugButton);
...
t.add(x);
return t;
},getParagraphMenu:function(){var ec=new qx.ui.menu.Menu;
var ef=new qx.ui.menu.Button(dm,bj);
var eg=new qx.ui.menu.Button(bO,bC);
var ed=new qx.ui.menu.Button(bl,bo);
var ee=new qx.ui.menu.Button(cc,dg);
ef.addListener(dd,this.debugButton);
eg.addListener(dd,this.debugButton);
ed.addListener(dd,this.debugButton);
...
ec.add(ee);
return ec;
},getHelpMenu:function(){var ba=new qx.ui.menu.Menu;
var bc=new qx.ui.menu.Button(bV,dt);
var be=new qx.ui.menu.Button(cS);
var bd=new qx.ui.menu.Button(dj);
var bb=new qx.ui.menu.Button(cO);
...
ba.add(bb);
return ba;
},getList:function(){var F=new qx.ui.form.List;
F.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){F.add(new qx.ui.form.ListItem(bq+i));
}return F;
},getContextMenu:function(){var L=new qx.ui.menu.Menu;
var N=new qx.ui.menu.Button(cU,db,this.__LP);
var O=new qx.ui.menu.Button(cX,cV,this.__LQ);
var M=new qx.ui.menu.Button(cW,cY,this.__LR);
...
L.add(M);
return L;
}},destruct:function(){this._disposeObjects(bE,bH,br,df,cJ,cP,ds,bS);
}});
})();
