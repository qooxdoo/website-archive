...
(function(){var j="Stopping recurrent 2-second timer",i="Recurrent 2-second timer with limit 3:",h="\n",g="One-shot 1-second timer: ",f=" ",e="__Ln",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Ln:null,startTimers:function(){var v=qx.util.TimerManager.getInstance();
v.start(function(t,u){this.__Lo(c+u);
},5000,this,null,0);
v.start(function(l,m){this.__Lo(g+m);
},0,this,null,1000);
v.start(function(n,o){this.__Lo(i+o);

if(++n.count==3){this.__Lo(j);
v.stop(o);
}},2000,this,{count:0},2000);
},__Lo:function(k){k=Date.parse(new Date)+f+k+h;
this.__Ln.setValue(this.__Ln.getValue()+k);
},main:function(){qx.application.Standalone.prototype.main.call(this);
var q=new qx.ui.layout.VBox(5);
var p=new qx.ui.container.Composite(q);
var r=new qx.ui.form.Button(b);
r.set({allowGrowX:false,allowGrowY:false});
r.addListener(a,function(){r.setEnabled(false);
this.startTimers();
},this);
var s=new qx.ui.form.TextArea();
s.set({width:400,height:300});
this.__Ln=s;
p.add(s);
p.add(r);
