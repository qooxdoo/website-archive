...
(function(){var x="value",w="main",v="Verdana",u="sans-serif",t="selectable",s="rich",r="Big Long Label Cutted",q="My First Long Label Cutted",p="rich label",o="top",h="native context menu",n="text label",k="configure rich label",g="demobrowser.demo.widget.Label",f="nativeContextMenu",j="right",i="configure text label",l="A long label text with auto-wrapping. This also may contain <b style='color:red'>rich HTML</b> markup.",e="Big Long Label",m="execute";
...
this.getRoot().add(y);
var z=new qx.ui.basic.Label(n).set({decorator:w,width:200});
y.add(z);
this.getRoot().add(this.createConfigureButton(z,i),{left:240,top:20});
var A=new qx.ui.basic.Label(p).set({decorator:w,rich:true});
y.add(A);
this.getRoot().add(this.createConfigureButton(A,k),{left:240,top:60});
var B=new qx.ui.basic.Label(q).set({decorator:w,width:80});
y.add(B);
var C=new qx.ui.basic.Label().set({value:l,decorator:w,rich:true,width:120});
y.add(C);
var D=new qx.ui.basic.Label(e).set({decorator:w,font:new qx.bom.Font(28,[v,u])});
y.add(D);
var E=new qx.ui.basic.Label(r).set({decorator:w,font:new qx.bom.Font(28,[v,u]),width:150});
y.add(E);
},createConfigureButton:function(a,b){var d=new qx.ui.form.Button(b);
var c;
d.addListener(m,function(){if(!c){c=this.createEditDialog(a,b);
}c.open();
},this);
return d;
...
J.setColumnFlex(1,1);
J.setColumnAlign(0,j,o);
H.setLayout(J);
var I=new qx.data.controller.Object(F);
H.add(new qx.ui.basic.Label(x).set({paddingTop:5}),{row:0,column:0});
var K=new qx.ui.form.TextArea().set({liveUpdate:true});
I.addTarget(K,x,x,true);
H.add(K,{row:0,column:1});
H.add(new qx.ui.basic.Label(t),{row:1,column:0});
var L=new qx.ui.form.CheckBox();
I.addTarget(L,x,t,true);
H.add(L,{row:1,column:1});
H.add(new qx.ui.basic.Label(h),{row:2,column:0});
var L=new qx.ui.form.CheckBox();
I.addTarget(L,x,f,true);
H.add(L,{row:2,column:1});
H.add(new qx.ui.basic.Label(s),{row:3,column:0});
