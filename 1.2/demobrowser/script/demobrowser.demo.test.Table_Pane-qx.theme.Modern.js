...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_Pane","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Table_Pane-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"24b5712024d8"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
