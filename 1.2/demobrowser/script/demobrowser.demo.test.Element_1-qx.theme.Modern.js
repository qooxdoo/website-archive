...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Element_1","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Element_1-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"98deee0dfe35"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
