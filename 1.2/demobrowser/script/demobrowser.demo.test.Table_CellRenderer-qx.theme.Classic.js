...
(function(){var T="",S="Hello",R="icon/16/actions/go-down.png",Q="World",P="bold",O="Juhu",N="</div>",M="waiting",L="icon/16/actions/go-next.png",K="http://resources.qooxdoo.org/images/logo.gif",by="$ ",bx="string",bw="border: 1px dotted green",bv="inactive",bu="decoration",bt="multi<br>line",bs="between",br="<",bq="<div style='position:absolute;height:20px;width:",bp="px;top:",bb="qx/decoration/Modern",bc="icon/16/actions/go-previous.png",Y="icon",ba="number",W="px'>",X="<i>italic</i>",U="0$",V="qx/icon/Tango",bd="<b>bold</b>",be="icon/16/actions/go-up.png",bh="boolean",bg="demobrowser.demo.test.Table_CellRenderer",bj="tooltip",bi="red",bl="icon/16/emotes/face-sad.png",bk="icon/16/emotes/face-smile.png",bf="left",bo=">=",bn="active",bm="object";
qx.Class.define(bg,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(bu,bb);
qx.util.AliasManager.getInstance().add(Y,V);
},__Ld:function(cc,top,cd,ce,cf){var cg=[bq,cd,bp,top,W];
ce.createDataCellHtml(cf,cg);
cg.push(N);
cc.innerHTML+=cg.join(T);
},testDefaultRenderer:function(A){var B=100;
var D={value:[null,O,32,new Date()],styleLeft:[0],styleWidth:[B],styleHeight:[20],style:[T]};
var C=this._getNewTableDiv(B);
var top=0;
qx.util.Permutation.permute(D,function(h){this.__Ld(C,top,B,A,h);
top+=20;
},this);
},testBooleanRenderer:function(){var bH=70;
var bG=30;
var bI=new qx.ui.table.cellrenderer.Boolean();
var bE={value:[null,true,false],styleLeft:[0],styleWidth:[bH],styleHeight:[bG],style:[T]};
var bF=this._getNewTableDiv(bH);
var top=0;
qx.util.Permutation.permute(bE,function(cl){this.__Ld(bF,top,bH,bI,cl);
top+=bG;
},this);
bI.setIconFalse(bl);
bI.setIconTrue(bk);
qx.util.Permutation.permute(bE,function(J){this.__Ld(bF,top,bH,bI,J);
top+=bG;
},this);
},testDateRenderer:function(){var d=180;
var e=new qx.ui.table.cellrenderer.Date();
var g={value:new Date(),styleLeft:[0],styleWidth:[d],styleHeight:[20],style:[T]};
var c=qx.util.format.DateFormat;
var f=[c.getDateTimeInstance(),c.getDateInstance()];
var a=this._getNewTableDiv(d);
var top=0;

for(var i=0;i<f.length;i++){var b=f[i];
e.setDateFormat(b);
this.__Ld(a,top,d,e,g);
top+=20;
}},testNumberRenderer:function(){var bN=new qx.ui.table.cellrenderer.Number();
var bM=100;
var bP={value:Math.PI,styleLeft:[0],styleWidth:[bM],styleHeight:[20],style:[T]};
var bL=qx.util.format.NumberFormat;
var bO=[bL.getIntegerInstance(),new bL().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:by})];
var bJ=this._getNewTableDiv(bM);
var top=0;

for(var i=0;i<bO.length;i++){var bK=bO[i];
bN.setNumberFormat(bK);
this.__Ld(bJ,top,bM,bN,bP);
top+=20;
}},testImageRenderer:function(){var cj=new qx.ui.table.cellrenderer.Image();
var ch=50;
var ck={value:[null,R,be,bc,L,K],styleLeft:[0],styleWidth:[ch],styleHeight:[20],style:[T],tooltip:[T,bj]};
var ci=this._getNewTableDiv(ch);
var top=0;
qx.util.Permutation.permute(ck,function(z){this.__Ld(ci,top,ch,cj,z);
top+=20;
},this);
},testStringRenderer:function(){var bD=new qx.ui.table.cellrenderer.String();
var bC=100;
var bB=20;
var bz={value:[null,S,Q],styleLeft:[0],styleWidth:[bC],styleHeight:[bB],style:[T]};
var bA=this._getNewTableDiv(bC);
var top=0;
qx.util.Permutation.permute(bz,function(w){this.__Ld(bA,top,bC,bD,w);
top+=20;
},this);
},testPasswordRenderer:function(){var v=new qx.ui.table.cellrenderer.Password();
var u=100;
var t=20;
var r={value:[null,S,Q],styleLeft:[0],styleWidth:[u],styleHeight:[t],style:[T]};
var s=this._getNewTableDiv(u);
var top=0;
qx.util.Permutation.permute(r,function(x){this.__Ld(s,top,u,v,x);
top+=20;
},this);
},testHtmlRenderer:function(){var q=new qx.ui.table.cellrenderer.Html();
var p=100;
var o=50;
var m={value:[null,bd,X,bt],styleLeft:[0],styleWidth:[p],styleHeight:[o],style:[T]};
var n=this._getNewTableDiv(p);
var top=0;
qx.util.Permutation.permute(m,function(cn){this.__Ld(n,top,p,q,cn);
top+=20;
},this);
},testConditionalRenderer:function(){var I=new qx.ui.table.cellrenderer.Conditional();
I.addNumericCondition(br,0,null,bi,null,null);
I.addNumericCondition(bo,100,bf,null,null,null);
I.addBetweenCondition(bs,0,2,null,null,null,P,null);
I.addRegex(U,null,null,P,bw);
var H=100;
var G=20;
var E={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[H],table:[this.tableMock],styleHeight:[G],style:[T]};
var F=this._getNewTableDiv(H);
var top=0;
qx.util.Permutation.permute(E,function(y){this.__Ld(F,top,H,I,y);
top+=20;
},this);
},testDynamicRenderer:function(){var bV=new qx.ui.table.cellrenderer.Dynamic();
bV.setCellRendererFactoryFunction(function(j){var l=j.value;
var k=qx.ui.table.cellrenderer;

switch(typeof l){case bx:if(l.match(/^icon\//)){return new k.Image();
}else{return new k.String();
}case bh:return new k.Boolean();
case ba:return new k.Number();
case bm:if(l instanceof Date){return new k.Date();
}return new k.Default();
}});
var bU=100;
var bT=20;
var bR={value:[null,O,new Date(),30,R,false],styleLeft:[0],styleWidth:[bU],styleHeight:[bT],table:[this.tableMock],style:[T]};
var bS=this._getNewTableDiv(bU);
var top=0;
qx.util.Permutation.permute(bR,function(bQ){this.__Ld(bS,top,bU,bV,bQ);
top+=20;
},this);
},testReplaceRenderer:function(){var cb=new qx.ui.table.cellrenderer.Replace();
cb.setReplaceMap({1:bn,2:bv,3:M});
cb.addReversedReplaceMap();
var ca=100;
var bY=20;
var bW={value:[1,2,3],styleLeft:[0],styleWidth:[ca],table:[this.tableMock],styleHeight:[bY],style:[T]};
var bX=this._getNewTableDiv(ca);
var top=0;
qx.util.Permutation.permute(bW,function(cm){this.__Ld(bX,top,ca,cb,cm);
top+=20;
},this);
