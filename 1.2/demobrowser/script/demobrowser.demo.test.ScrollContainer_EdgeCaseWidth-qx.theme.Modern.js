...
var H=true;
E.addListener(r,function(){C.setHeight(H?300:200);
H=!H;
});
this.getRoot().add(E,{left:330,top:20});
var D=new qx.ui.form.Button(o);
var G=true;
D.addListener(r,function(){C.getChildren()[0].setHeight(G?100:300);
G=!G;
});
...
return z;
},generateBox:function(){var A=new qx.ui.basic.Label(b).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:n,textColor:d,padding:10,decorator:new qx.ui.decoration.Single(4,f,m)});
return A;
},__Le:null}});
})();
