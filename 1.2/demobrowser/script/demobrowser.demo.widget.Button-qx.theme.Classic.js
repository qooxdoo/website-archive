...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Button","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Button-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"3cb73ff99abd"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var p="0",o="white",n="main",m="execute",l="Button A",k="#AAA",j="icon/22/actions/list-add.png",i="Button B",h="demobrowser.demo.widget.Button",g="icon/22/apps/internet-web-browser.png",c="Hover",f="icon/22/apps/media-video-player.png",d="icon/22/apps/internet-mail.png",b="changeValue",a="Toggle Button";
...
},addNormalButtons:function(z){var A=new qx.ui.form.Button(l,f);
z.add(A);
var B=new qx.ui.form.Button(i,d);
B.setEnabled(false);
z.add(B);
},addToggleButton:function(x){var y=new qx.ui.form.ToggleButton(a,g);
y.focus();
x.add(y);
y.addListener(b,function(e){this.debug("Checked: "+e.getData());
},this);
},addRepeatButton:function(C){var D=new qx.ui.form.RepeatButton(null,j);
C.add(D);
var E=new qx.ui.basic.Label(p);
E.setDecorator(n);
E.setPadding(2,4);
E.setBackgroundColor(o);
C.add(E);
D.addListener(m,function(){var q=parseInt(E.getValue())+1;
E.setValue(q.toString());
});
},addHoverButton:function(r){var s=new qx.ui.form.HoverButton(c).set({padding:10,backgroundColor:k});
r.add(s);
var t=new qx.ui.basic.Label(p);
t.setDecorator(n);
t.setPadding(2,4);
t.setBackgroundColor(o);
r.add(t);
s.addListener(m,function(){var w=parseInt(t.getValue())+1;
t.setValue(w.toString());
});
}}});
})();
