...
return q;
},getColumnAlignGrid:function(){var u=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var v=new qx.ui.layout.Grid();
v.setSpacing(3);
v.setColumnAlign(0,h,j);
v.setColumnAlign(1,f,e);
v.setColumnAlign(2,g,k);
u.setLayout(v);
...
},getCellAlignGrid:function(){var n=new qx.ui.container.Composite().set({decorator:m,backgroundColor:l,allowGrowX:false,allowGrowY:false});
var p=new qx.ui.layout.Grid();
p.setSpacing(3);
n.setLayout(p);

for(var x=0;x<5;x++){p.setColumnAlign(x,f,e);

for(var y=0;y<5;y++){n.add(this.getNewWidget(),{row:y,column:x});
}}var o=p.getCellWidget(0,0);
o.set({alignX:h,alignY:j});
o.set({backgroundColor:d,width:20,height:20});
var o=p.getCellWidget(4,4);
o.set({alignX:g,alignY:k});
o.set({backgroundColor:d,width:20,height:20});
return n;
