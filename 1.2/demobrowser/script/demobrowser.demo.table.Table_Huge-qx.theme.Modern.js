...
(function(){var k="x",j="_tableModel",h="Cell ",g="Table",f="demobrowser.demo.table.Table_Huge",e="Column ";
qx.Class.define(f,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return g;
},COL_COUNT:50,ROW_COUNT:10000,createRandomRows:function(a){var c=[];

for(var d=0;d<a;d++){var b=[];

for(var i=0;i<this.COL_COUNT;i++){b.push(h+i+k+d);
}c.push(b);
}return c;
...
for(var i=0;i<this.COL_COUNT;i++){o.push(e+i);
}l.setColumns(o);
l.setData(m);
