...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.OwnCodeInModel","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.OwnCodeInModel-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a14b1aa57d67"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="execute",r="icon/16/mimetypes/",q="name",p="model",o="model.items",n="demobrowser.demo.data.OwnCodeInModel",m=".png",l="json/list.json",k="type",j="Using the delegation to bring two sort function to the root model ",f="Sort By Name",i="items",h="class of this demo. The buttons just calling those sort functions.",e="<b>Adding own code to the model</b><br/>",d="demobrowser.demo.data.ItemsMixin",g="Sort By Type";
...
var z=new qx.data.controller.List(null,w);
z.setLabelPath(q);
z.setIconOptions({converter:function(t){return r+t+m;
}});
z.setIconPath(k);
var A={getModelMixins:function(u){if(u==i){return demobrowser.demo.data.ItemsMixin;
}}};
var v=l;
var C=new qx.data.store.Json(v,A);
C.bind(o,z,p);
var B=new qx.ui.form.Button(g);
B.setWidth(120);
this.getRoot().add(B,{left:130,top:80});
B.addListener(s,function(){C.getModel().sortByType();
},this);
var y=new qx.ui.form.Button(f);
y.setWidth(120);
this.getRoot().add(y,{left:130,top:110});
y.addListener(s,function(){C.getModel().sortByName();
},this);
var x=new qx.ui.basic.Label();
x.setRich(true);
x.setWidth(410);
x.setValue(e+j+h);
this.getRoot().add(x,{left:10,top:10});
}}});
qx.Mixin.define(d,{members:{sortByType:function(){var c=this.getItems();
