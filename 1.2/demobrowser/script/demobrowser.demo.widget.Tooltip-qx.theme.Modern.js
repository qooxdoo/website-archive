...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Tooltip","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Tooltip-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"69e61e4d7b93"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="icon/16/actions/help-about.png",k="Tooltip text",j="icon/32/actions/help-about.png",i="Button #2 (Shared ToolTip)",h="Short timeout ToolTip",g="demobrowser.demo.widget.Tooltip",f="Hello World #3",d="Button with ToolTipText and ToolTipIcon",c="ToolTip with icon and label",b="Shared tool tip of button #",z="ToolTip with icon and rich text",y="Such a great tooltip with a (show) timeout of 50ms.",x="Icon only ToolTip",w="Button #1 (Shared ToolTip)",v="container",u="This also may contain <b style='color:red'>rich HTML</b> markup ",t="appear",s="2",r="Shared ToolTip",q="1",o="Button with ToolTipText",p="A long label text with auto-wrapping. ",m="Button with ToolTipIcon",n="and with a (show) timeout of 50ms.";
...
var A=new qx.ui.layout.Grid(10,10);
this.container=new qx.ui.container.Composite(A).set({padding:20});
B.add(this.container);
...
},__LC:4,__LD:0,add:function(H){this.container.add(H,{row:Math.floor(this.__LD/this.__LC),column:this.__LD%this.__LC});
this.__LD+=1;
},createSharedToolTip:function(){var L=new qx.ui.tooltip.ToolTip(r);
L.addListener(t,function(e){var O=b;

if(this.getOpener()==K){O+=q;
}else{O+=s;
}L.setLabel(O);
});
var K=new qx.ui.form.Button(w);
K.setToolTip(L);
this.add(K);
var J=new qx.ui.form.Button(i);
J.setToolTip(L);
this.add(J);
},createIconToolTip:function(){var I=new qx.ui.form.Button(x).set({toolTip:new qx.ui.tooltip.ToolTip(null,l)});
this.add(I);
},createToolTip:function(){var a=new qx.ui.form.Button(c).set({toolTip:new qx.ui.tooltip.ToolTip(f,l)});
this.add(a);
},createShortTimeoutToolTip:function(){var N=new qx.ui.tooltip.ToolTip(y,j);
N.setShowTimeout(50);
var M=new qx.ui.form.Button(h);
this.add(M);
M.setToolTip(N);
},createRichToolTip:function(){var F=new qx.ui.tooltip.ToolTip(p+u+n,j);
F.setWidth(200);
F.setRich(true);
F.setShowTimeout(50);
var E=new qx.ui.form.Button(z);
this.add(E);
E.setToolTip(F);
},createToolTipText:function(){var G=new qx.ui.form.Button(o).set({toolTipText:k});
this.add(G);
},createToolTipIcon:function(){var C=new qx.ui.form.Button(m).set({toolTipIcon:l});
this.add(C);
},createToolTipTextIcon:function(){var D=new qx.ui.form.Button(d).set({toolTipText:k,toolTipIcon:l});
this.add(D);
