...
F.execute();
},testCheckBoxEditor:function(){var v={value:[true,false]};
qx.util.Permutation.permute(v,function(y){this._addEditor(new qx.ui.table.celleditor.CheckBox(),y);
},this);
},testComboBoxEditor:function(){var t={value:[l,k,f,2],table:[this.getTableMock()]};
var u=new qx.ui.table.celleditor.ComboBox();
u.setListData([h,k,i]);
qx.util.Permutation.permute(t,function(s){this._addEditor(u,s);
},this);
},testSelectBoxEditor:function(){var n={value:[l,k],table:[this.getTableMock()]};
var o=new qx.ui.table.celleditor.SelectBox();
o.setListData([h,k,i]);
qx.util.Permutation.permute(n,function(r){this._addEditor(o,r);
},this);
},testPasswordEditor:function(){var w={value:[null,10,j]};
qx.util.Permutation.permute(w,function(J){this._addEditor(new qx.ui.table.celleditor.PasswordField(),J);
},this);
},testTextfieldEditor:function(){var z={value:[null,10,j]};
qx.util.Permutation.permute(z,function(A){this._addEditor(new qx.ui.table.celleditor.TextField(),A);
},this);
},testTextfieldEditorDynamic:function(){var p={value:[true,j]};
var q=new qx.ui.table.celleditor.Dynamic();
q.setCellEditorFactoryFunction(function(x){if(typeof x.value==b){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(p,function(m){this._addEditor(q,m);
},this);
