...
},addSplitPaneTwoFlexSimple:function(){var A=new qx.ui.splitpane.Pane(m);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(l);
...
z.setWrap(true);
A.add(z,1);
var B=new qx.ui.form.TextArea(h);
B.setDecorator(null);
B.setWrap(true);
A.add(B,2);
...
s.setWrap(true);
r.add(s,2);
},addSplitPaneTwoFlexWithOneMax:function(){var M=new qx.ui.splitpane.Pane(m);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(l);
...
L.setWrap(true);
M.add(L,1);
var N=new qx.ui.form.TextArea(f);
N.setDecorator(null);
N.setWrap(true);
N.setMaxWidth(100);
M.add(N,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var o=new qx.ui.splitpane.Pane(m);
o.setWidth(400);
o.setHeight(60);
o.setDecorator(l);
this.getRoot().add(o,{left:20,top:260});
var n=new qx.ui.form.TextArea(j);
n.setDecorator(null);
n.setWrap(true);
n.setMinWidth(250);
o.add(n,1);
var p=new qx.ui.form.TextArea(a);
p.setDecorator(null);
p.setWrap(true);
p.setMinWidth(250);
o.add(p,2);
...
H.setMaxWidth(100);
G.add(H,2);
},addSplitPaneOneFlexSimple:function(){var x=new qx.ui.splitpane.Pane(m);
x.setWidth(400);
x.setHeight(60);
x.setDecorator(l);
this.getRoot().add(x,{left:500,top:20});
var w=new qx.ui.form.TextArea(g);
w.setDecorator(null);
w.setWrap(true);
x.add(w,0);
var y=new qx.ui.form.TextArea(k);
y.setDecorator(null);
y.setWrap(true);
x.add(y);
},addSplitPaneOneFlexSimpleWithMax:function(){var D=new qx.ui.splitpane.Pane(m);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(l);
this.getRoot().add(D,{left:500,top:100});
var C=new qx.ui.form.TextArea(g);
C.setDecorator(null);
C.setWrap(true);
D.add(C,0);
var E=new qx.ui.form.TextArea(d);
E.setDecorator(null);
E.setWrap(true);
E.setMaxWidth(200);
D.add(E);
...
K.setWrap(true);
J.add(K);
},addSplitPaneAuto:function(){var u=new qx.ui.splitpane.Pane(m);
u.setDecorator(l);
this.getRoot().add(u,{left:500,top:340});
var t=new qx.ui.form.TextArea(i);
t.setDecorator(null);
t.setWrap(true);
u.add(t,0);
