...
V.setIconOptions(ba);
V.setIconPath(d);
var T={converter:function(M){if(M){return c;
}else{return v;
}}};
...
P.addListener(k,function(){for(var i=0;i<Y.length;i++){var K=Y.getItem(i);
K.setEmote(j);
}},this);
