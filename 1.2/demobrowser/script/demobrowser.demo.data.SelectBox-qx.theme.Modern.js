...
(function(){var t="selection[0]",s="value",r="C",q="A",p="F",o="G",n="Type in the textfield or set the selection with the button.",m="J",l="D",k="E",d="H",j="I",g="B",c="<b>Synchronized Selection</b><br/>",b="execute",f="<b>Change Selection</b><br/>",e="demobrowser.demo.data.SelectBox",h="Bound to the same data and share the selection. The label is also bound to the selection.",a="The selection is: ",i="Set Selection to 'C'";
...
w.addListener(b,function(){A.getSelection().setItem(0,r);
},this);
