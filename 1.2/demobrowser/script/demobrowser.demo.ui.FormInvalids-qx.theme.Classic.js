...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.FormInvalids","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.FormInvalids-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ab1b63697d1e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.getRoot().add(B[9],{left:240,top:70});
B.push(new qx.ui.groupbox.RadioGroupBox(r));
this.getRoot().add(B[10],{left:240,top:170});
B.push(new qx.ui.groupbox.CheckGroupBox(r));
this.getRoot().add(B[11],{left:240,top:270});
B.push(new qx.ui.form.List());
this.getRoot().add(B[12],{left:390,top:70});

for(var i=0;i<10;i++){B[12].add(new qx.ui.form.ListItem(a+(i+1)));
}B.push(new qx.ui.form.DateField());
this.getRoot().add(B[13],{left:390,top:280});
B.push(new qx.ui.control.DateChooser());
this.getRoot().add(B[14],{left:530,top:70});
var y=new qx.ui.form.RadioGroup();
var t=new qx.ui.form.RadioButton(l);
y.add(t);
this.getRoot().add(t,{left:530,top:250});
var u=new qx.ui.form.RadioButton(o);
y.add(u);
...
var C=new qx.ui.tree.TreeFolder(p);
C.setOpen(true);
x.setRoot(C);
...
qx.Class.define(d,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IRadioItem,qx.ui.form.IExecutable,qx.ui.form.IBooleanForm,qx.ui.form.IModel],include:[qx.ui.form.MModelProperty],properties:{appearance:{refine:true,init:c}},events:{"changeValue":a,"execute":b},members:{_createChildControlImpl:function(k){var l;

switch(k){case i:l=new qx.ui.form.RadioButton;
l.setValue(true);
...
this._add(l);
}return l||qx.ui.groupbox.GroupBox.prototype._createChildControlImpl.call(this,k);
},_onExecute:function(e){this.fireEvent(g);
},_onRadioChangeValue:function(e){var o=e.getData()?true:false;
this.getChildrenContainer().setEnabled(o);
this.fireDataEvent(h,o,e.getOldData());
...
},setGroup:function(m){if(m!=null){m.add(this);
}return;
...
qx.Class.define(b,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IExecutable,qx.ui.form.IBooleanForm,qx.ui.form.IModel],include:[qx.ui.form.MModelProperty],properties:{appearance:{refine:true,init:d}},events:{"changeValue":a,"execute":c},members:{_createChildControlImpl:function(j){var k;

switch(j){case i:k=new qx.ui.form.CheckBox();
k.setValue(true);
