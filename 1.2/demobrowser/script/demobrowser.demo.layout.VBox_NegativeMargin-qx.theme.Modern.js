...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox_NegativeMargin","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a02c6e1ab073"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
l.setMarginTop(-10);
return m;
},getBox2:function(){var u=new qx.ui.layout.VBox();
var w=new qx.ui.container.Composite(u).set({decorator:i,backgroundColor:h,width:140,allowGrowY:false});
...
A.setMarginTop(-10);
return B;
},getBox5:function(){var J=new qx.ui.layout.VBox();
...
K.setHeight(0);
return L;
},getBox6:function(){var p=new qx.ui.layout.VBox();
var r=new qx.ui.container.Composite(p).set({decorator:i,backgroundColor:h,width:140,height:100,allowGrowY:false});
