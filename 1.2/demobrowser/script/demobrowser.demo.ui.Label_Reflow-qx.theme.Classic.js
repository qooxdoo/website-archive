...
(function(){var u="main",t="qooxdoo is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed.",s="click",r="#CCC",q="<b>qooxdoo is cool.</b>",p="qooxdoo (pronounced [’ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",o="#FFF",n="It includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",m="demobrowser.demo.ui.Label_Reflow",l="Toggle first paragraph",j="Resize Pane",k="#EEE";
...
a.setRowFlex(0,1);
a.setSpacing(10);
var b=new qx.ui.container.Composite(a).set({backgroundColor:k,decorator:u,padding:10,allowGrowX:false,allowGrowY:false,allowStretchX:false,allowStretchY:false});
c.add(b);
this.getRoot().add(c,{edge:0});
var h=this.getPane();
b.add(h,{row:0,column:0,colSpan:3});
var f=new qx.ui.basic.Label(l).set({backgroundColor:r,decorator:u,padding:[4,8]});
b.add(f,{row:1,column:1});
var d=false;
f.addListener(s,function(){var z=h.getChildren()[0];
z.setValue(d?t:q);
d=!d;
});
var g=new qx.ui.basic.Label(j).set({backgroundColor:r,decorator:u,padding:[4,8]});
b.add(g,{row:1,column:2});
var i=false;
g.addListener(s,function(e){if(i){h.setWidth(600);
}else{h.setWidth(300);
}i=!i;
});
},getPane:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:o,width:600,decorator:u,padding:10});
var v=new qx.ui.basic.Label().set({rich:true,value:t});
y.add(v);
var w=new qx.ui.basic.Label().set({rich:true,value:n});
y.add(w);
var x=new qx.ui.basic.Label().set({rich:true,value:p});
y.add(x);
return y;
}}});
})();
