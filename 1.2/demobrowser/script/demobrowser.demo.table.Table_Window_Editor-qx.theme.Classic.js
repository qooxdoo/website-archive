...
(function(){var u="execute",t="A boolean",s="A number",r="Table with window cell editor",q="A date",p="Enter",o="1*",n="50%",m="demobrowser.demo.table.Table_Window_Editor",l="appear",i="demobrowser.demo.table.ModalCellEditorFactory",k="Cell Editor",j="ID",h="Save";
qx.Class.define(m,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return r;
},createTable:function(){var f=this.createRandomRows(50);
var c=new qx.ui.table.model.Simple();
c.setColumns([j,s,q,t]);
c.setData(f);
c.setColumnEditable(1,true);
var b={tableColumnModel:function(A){return new qx.ui.table.columnmodel.Resize(A);
}};
var g=new qx.ui.table.Table(c,b);
g.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var d=g.getTableColumnModel();
var a=d.getBehavior();
a.set(0,{width:o,minWidth:40,maxWidth:80});
a.setWidth(1,n);
a.setMinWidth(1,100);
a.setMaxWidth(1,320);
a.set(3,{width:100});
...
d.setCellEditorFactory(1,new demobrowser.demo.table.ModalCellEditorFactory());
return g;
}}});
qx.Class.define(i,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,members:{createCellEditor:function(v){var y=new qx.ui.window.Window(k);
y.setLayout(new qx.ui.layout.HBox(4));
y.set({padding:3,modal:true,showClose:false,showMaximize:false,showMinimize:false});
y.moveTo(300,250);
y.addListener(l,function(e){y.__MB.focus();
y.__MB.setTextSelection(0,y.__MB.getValue().length);
});
y.__MB=new qx.ui.form.TextField(v.value+"").set({allowGrowY:true});
y.add(y.__MB);
var w=new qx.ui.form.Button(h);
w.addListener(u,function(e){y.close();
});
y.add(w);
var x=new qx.ui.core.Command(p);
x.addListener(u,function(e){w.execute();
x.dispose();
x=null;
});
return y;
},getCellEditorValue:function(z){return parseFloat(z.__MB.getValue());
}}});
})();
