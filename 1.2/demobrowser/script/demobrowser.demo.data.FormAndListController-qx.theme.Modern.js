...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.FormAndListController","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.FormAndListController-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"84da38e74487"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="female",k="Martin",j="male",i="Lastname",h="Gender",g="Wittemann",f="Alien",e="execute",d="Firstname",c="demobrowser.demo.data.FormAndListController",a="dont know!",b="Show model data in the log";
...
var s={firstname:k,lastname:g,gender:[j,l,a,f]};
var r=qx.data.marshal.Json.createModel(s);
var m=new qx.ui.form.Form();
var n=new qx.ui.form.TextField();
m.add(n,d);
var p=new qx.ui.form.TextField();
m.add(p,i);
var q=new qx.ui.form.SelectBox();
new qx.data.controller.List(r.getGender(),q);
m.add(q,h);
this.getRoot().add(new qx.ui.form.renderer.Single(m),{left:30,top:20});
new qx.data.controller.Form(r,m);
var o=new qx.ui.form.Button(b);
this.getRoot().add(o,{left:240,top:20});
o.addListener(e,function(){this.debug(qx.dev.Debug.debugProperties(r));
},this);
}}});
})();
