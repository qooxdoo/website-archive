...
var X=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
X.setPadding(20);
X.setAllowStretchX(false);
Y.add(X);
this.getRoot().add(Y,{edge:0});
X.add(this.getTabView1());
X.add(this.getTabView2());
X.add(this.getTabView3());
},getTabView1:function(){var E=new qx.ui.tabview.TabView();
E.setWidth(500);
var I=new qx.ui.tabview.Page(c,k);
I.setLayout(new qx.ui.layout.VBox());
I.add(new qx.ui.basic.Label(q));
E.add(I);
var G=new qx.ui.tabview.Page(f,z);
G.setLayout(new qx.ui.layout.VBox());
G.add(new qx.ui.basic.Label(t));
E.add(G);
var H=new qx.ui.tabview.Page(w,j);
H.setLayout(new qx.ui.layout.VBox());
H.add(new qx.ui.basic.Label(A));
E.add(H);
var F=new qx.ui.tabview.Page(u,D);
F.setLayout(new qx.ui.layout.VBox());
F.add(new qx.ui.basic.Label(s));
E.add(F);
return E;
},getTabView2:function(){var a=new qx.ui.tabview.TabView();
a.setWidth(500);

for(var i=1;i<=20;i++){var b=new qx.ui.tabview.Page(n+i,k);
b.setLayout(new qx.ui.layout.VBox());
b.setShowCloseButton(true);
b.add(new qx.ui.basic.Label(n+i+p));
a.add(b);
}return a;
...
P.add(Q);
P.add(L);
O.addListener(m,function(e){var ba=N.getChildren().length+1;
var bb=new qx.ui.tabview.Page(n+ba,l);
N.add(bb);
});
Q.addListener(m,function(e){var J=N.getChildren();

if(J.length>0){N.remove(J[0]);
}});
L.addListener(m,function(e){var K=N.getChildren();

if(K.length>0){N.remove(K[K.length-1]);
}});
return N;
}}});
})();
