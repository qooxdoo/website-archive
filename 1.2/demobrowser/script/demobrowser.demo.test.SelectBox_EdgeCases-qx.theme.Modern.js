...
(function(){var o="Times New Roman",n="Long list",m="Long button, short text",l="",k="Fonts",j="container",h="Font ",g="Tahoma",f="Courier New",e="Item ",c="Arial",d="demobrowser.demo.test.SelectBox_EdgeCases";
...
this.addBox2();
this.addBox3();
},addBox1:function(){this.container.add(new qx.ui.basic.Label(n),{left:25,top:20});
var a=new qx.ui.form.SelectBox();
a.setMaxListHeight(null);

for(var i=0;i<300;i++){var b=new qx.ui.form.ListItem(l+i);
a.add(b);
}this.container.add(a,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(k),{left:25,bottom:45});
var w=new qx.ui.form.SelectBox();
var r=new qx.bom.Font(12,[g]);
var s=new qx.bom.Font(15,[c]);
var q=new qx.bom.Font(18,[f]);
var u=new qx.bom.Font(21,[o]);
var t=[r,s,q,u];

for(var i=0;i<t.length;i++){var v=new qx.ui.form.ListItem(h+(i+1));
v.setFont(t[i]);
w.add(v);
}this.container.add(w,{left:20,bottom:20});
},addBox3:function(){this.container.add(new qx.ui.basic.Label(m),{left:205,top:20});
var x=new qx.ui.form.SelectBox();
x.setWidth(300);
x.setMaxListHeight(100);

for(var i=0;i<20;i++){var y=new qx.ui.form.ListItem(e+i);
