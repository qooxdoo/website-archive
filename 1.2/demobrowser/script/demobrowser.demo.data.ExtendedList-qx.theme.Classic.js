...
var H=new qx.data.controller.List(null,D);
...
B.addListener(k,function(){for(var i=0;i<K.length;i++){K.getItem(i).toggleOnline();
}},this);
var I=new qx.ui.form.Button(w);
I.setWidth(120);
this.getRoot().add(I,{left:180,top:115});
I.addListener(k,function(){qx.log.appender.Console.show();
