...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"c3c5ebae1e62"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var z=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(z);
z.add(this.getBox1());
z.add(this.getBox2());
z.add(this.getBox3());
...
z.add(this.getBox6());
z.add(this.getBox7());
},getBox1:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
s.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
s.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
s.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return s;
},getBox2:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,minHeight:60,allowGrowX:false});
t.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:c}));
t.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:a}));
t.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:b}));
return t;
},getBox3:function(){var C=new qx.ui.layout.HBox();
var D=new qx.ui.container.Composite(C).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
C.setSpacing(5);
C.setAlignX(e);
...
var B=new qx.ui.container.Composite(A).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
A.setSpacing(5);
A.setAlignX(f);
B.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
B.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
B.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return B;
},getBox5:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:i,backgroundColor:g,allowGrowX:false});
var m=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var l=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var j=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
k.add(m);
k.add(l);
k.add(j);
m.setMarginRight(10);
...
v.setMarginRight(10);
return w;
},getBox7:function(){var n=new qx.ui.layout.HBox();
var p=new qx.ui.container.Composite(n).set({decorator:i,backgroundColor:g,width:500,allowGrowX:false});
n.setSpacing(5);
n.setAlignX(f);
var r=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var q=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var o=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
p.add(r);
p.add(q);
p.add(o);
r.setMarginRight(10);
