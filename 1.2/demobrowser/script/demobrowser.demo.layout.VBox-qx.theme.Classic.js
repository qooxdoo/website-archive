...
m.add(this.getBox6());
m.add(this.getBox7());
},getBox1:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
...
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return k;
},getBox5:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
...
B.add(A);
return B;
},getBox6:function(){var v=new qx.ui.layout.VBox();
...
x.add(w);
return x;
},getBox7:function(){var q=new qx.ui.layout.VBox();
