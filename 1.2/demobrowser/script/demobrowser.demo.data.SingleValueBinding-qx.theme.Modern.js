...
var be=new qx.ui.form.TextField(f);
be.setLiveUpdate(true);
this.getRoot().add(be,{top:30,left:10});
var X=new qx.ui.basic.Label(f);
this.getRoot().add(X,{top:32,left:120});
be.bind(h,X,k);
this.getRoot().add(new qx.ui.basic.Label(D),{top:60,left:10});
var bd=new qx.ui.form.Slider();
bd.setWidth(100);
this.getRoot().add(bd,{top:80,left:10});
var S=new qx.ui.basic.Label(i);
this.getRoot().add(S,{top:80,left:120});
bd.bind(k,S,k);
this.getRoot().add(new qx.ui.basic.Label(x),{top:110,left:10});
var U=new qx.ui.form.Slider();
U.setWidth(100);
this.getRoot().add(U,{top:130,left:10});
var bj=new qx.ui.basic.Label(i);
this.getRoot().add(bj,{top:130,left:120});
var Y={converter:function(P){if(P<50){return A;
}else{return M;
}}};
U.bind(k,bj,k,Y);
this.getRoot().add(new qx.ui.basic.Label(B),{top:180,left:10});
var bc=new demobrowser.demo.data.model.Node();
var bf=new demobrowser.demo.data.model.Node();
var bi=new demobrowser.demo.data.model.Node();
bi.setNames(new qx.data.Array(o,v));
bc.setChild(bf);
var bl=new qx.ui.form.Button(c);
this.getRoot().add(bl,{top:200,left:10});
bl.addListener(g,function(){bc.getChild().getNames().reverse();
},this);
var bh=new qx.ui.form.Button(m);
this.getRoot().add(bh,{top:200,left:80});
bh.addListener(g,function(){if(bc.getChild()==bf){bc.setChild(bi);
}else{bc.setChild(bf);
}},this);
this.getRoot().add(new qx.ui.basic.Label(N),{left:10,top:235});
this.getRoot().add(new qx.ui.basic.Label(I),{left:60,top:235});
var bk=new qx.ui.basic.Label();
this.getRoot().add(bk,{top:250,left:10});
var bb=new qx.ui.basic.Label();
this.getRoot().add(bb,{top:250,left:60});
bc.bind(O,bk,k);
bc.bind(a,bb,k);
this.getRoot().add(new qx.ui.basic.Label(s),{top:310,left:10});
var Q=new qx.ui.form.TextField(p);
Q.setLiveUpdate(true);
this.getRoot().add(Q,{top:330,left:10});
var ba=new qx.ui.basic.Label(i);
this.getRoot().add(ba,{top:332,left:120});
var Y={onUpdate:function(){ba.setValue(i);
Q.setValid(true);
},onSetFail:function(e){ba.setValue(r);
Q.setValid(false);
}};
Q.bind(h,bc,l,Y);
...
T.setWidth(350);
T.setValue(j+J+F);
this.getRoot().add(T,{left:250,top:10});
var W=new qx.ui.basic.Label();
W.setRich(true);
W.setWidth(350);
W.setValue(j+b+K);
this.getRoot().add(W,{left:250,top:60});
var R=new qx.ui.basic.Label();
R.setRich(true);
R.setWidth(350);
R.setValue(j+E+z+n);
this.getRoot().add(R,{left:250,top:110});
var bg=new qx.ui.basic.Label();
bg.setRich(true);
bg.setWidth(350);
bg.setValue(j+u+L+w+t+q);
this.getRoot().add(bg,{left:250,top:180});
var V=new qx.ui.basic.Label();
V.setRich(true);
V.setWidth(350);
V.setValue(j+H+G+C);
this.getRoot().add(V,{left:250,top:310});
}}});
})();
...
(function(){var q="qx.data.Array",p="demobrowser.demo.data.model.Node",o="String",n="changeNames",m="changeName",l="\n",k="- ",j="",h="changeChild",g="changeColor",c="Marge",f="AFFE",e="Homer",b="__MH",a="changeName2",d="changeChildren";
qx.Class.define(p,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:q,event:d},child:{check:p,event:h,nullable:true},names:{check:q,event:n,init:new qx.data.Array(e,c)},name:{check:o,init:f,event:m},name2:{check:o,event:a},number:{init:10,validate:b},color:{event:g,nullable:true}},members:{__MH:function(r){if(!isNaN(parseFloat(r))){if(/^\d+$/.test(r)){return;
...
for(var i=0;i<s;i++){t+=k;
}t+=this.getName();

for(var i=0;i<this.getChildren().length;i++){t+=l+this.getChildren().getItem(i).toString(s+1);
}return t;
}}});
})();
