...
(function(){var g="Window: ",f="interval",e="__Lk",d="Label: ",c="demobrowser.demo.test.Destructor";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__Li:null,__Lj:0,__Lk:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__Li=[];
this.currentTest=this.testWindows;
this.__Lk=new qx.event.Timer(1000);
this.__Lk.addListener(f,this.runTest,this);
this.__Lk.start();
},runTest:function(){this.__Lj++;
var b=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Lj+" (Registry: "+b+")");
this.currentTest();
