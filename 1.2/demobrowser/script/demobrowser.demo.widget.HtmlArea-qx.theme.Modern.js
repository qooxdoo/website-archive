...
(function(){var p="",o="changeSelection",n="demobrowser.demo.widget.HtmlArea",m="Set Text Color",l="Insert Table",k="qx/icon/Oxygen/16/actions/format-indent-more.png",h="As an application developer you can <b>use the same API.</b></p>",g="Comic Sans MS",f="Insert Ordered List",d="<p>This UI-level widget can be used at RIA (Rich ",bz="qx/icon/Oxygen/16/actions/format-justify-left.png",by="Tahoma",bx="qx/icon/Oxygen/16/actions/format-text-italic.png",bw="Indent More",bv="qx/icon/Oxygen/16/actions/edit-undo.png",bu="Courier",bt="Courier New",bs="qx/icon/Oxygen/16/actions/format-justify-right.png",br="solid",bq="Georgia",w="Align Left",x="Insert HTML Code",u="qx/icon/Oxygen/16/actions/format-justify-center.png",v="Impact",s="demobrowser/demo/icons/htmlarea/format-text-color.png",t="Change Font Size",q="<h1>HtmlArea UI-level widget</h1>",r="Align Justify",E="Undo Last Change",F="qx/icon/Oxygen/16/actions/insert-link.png",S="Redo Last Undo Step",O="demobrowser/demo/icons/htmlarea/format-fill-color.png",bb="The UI widget does use the low-level component internally ",V="<p>You can play around with this widget by hitting the ",bm="demobrowser/demo/icons/htmlarea/insert-text.png",bg="qx/icon/Oxygen/16/actions/format-indent-less.png",J="Times New Roman",bp="Remove Format",bo="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bn="Align Right",I="qx/icon/Oxygen/16/actions/edit-clear.png",L="demobrowser/demo/icons/htmlarea/format-list-unordered.png",N="Align Center",Q="Set Text Background Color",T="Format Bold",W="qx/icon/Oxygen/16/actions/edit-redo.png",bd="Change Font Family",bi="Lucida Console",y="Internet Applications) and inline applications.<br/>",z="Arial Black",K="border-main",ba="Insert Link",Y="Inserted Unordered List",X="qx/icon/Oxygen/16/actions/format-text-bold.png",bf="execute",be="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",U="main",bc="Arial",a="12px ",bh="Format Italic",A="qx/icon/Oxygen/16/actions/format-justify-fill.png",B="qx/icon/Oxygen/16/actions/format-text-underline.png",P="Verdana",b="Indent Less",c="Insert Image",H="demobrowser/demo/icons/htmlarea/insert-table.png",C='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',D="Format Strikethrough",G="Format Underline",R="qx/icon/Oxygen/16/actions/insert-image.png",bk="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bj="Insert Horizontal Ruler",M="so code-duplication is avoided.<br/>",bl="buttons at the toolbar.</p>";
qx.Class.define(n,{extend:qx.application.Standalone,members:{__LS:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bO=q+d+y+bb+M+h+V+bl;
var bJ=new qx.ui.basic.Label(bO);
bJ.set({rich:true,marginBottom:10});
var bN=C;
var bM=this.getRoot();
var bL=new qx.ui.decoration.Single(1,br,K);
bL.setWidthTop(0);
this.__LS=new qx.ui.embed.HtmlArea(bN,null,"blank.html");
this.__LS.set({width:600,height:400,decorator:bL});
var toolbar=this.__Md();
var bI=new qx.ui.layout.VBox(0);
var bK=new qx.ui.container.Composite(bI);
bK.add(bJ);
bK.add(toolbar);
bK.add(this.__LS);
bM.add(bK,{left:20,top:20});
},__LT:function(e){var bW=window.prompt("Color (Hex): ","#");
this.setTextColor(bW);
},__LU:function(e){var bT=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(bT);
},__LV:function(e){var ce={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(ce);
},__LW:function(e){var bP="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(bP);
},__LX:function(e){var bB=new qx.ui.window.Window("Insert Hyperlink");
bB.setLayout(new qx.ui.layout.VBox(20));
bB.set({width:400,showMaximize:false,showMinimize:false});
var bF=new qx.ui.form.TextField("http://");
bB.add(bF);
var bD=new qx.ui.layout.HBox(10);
bD.setAlignX("right");
var bE=new qx.ui.container.Composite(bD);
var bA=new qx.ui.form.Button("OK");
bA.setWidth(60);
bA.addListener("execute",function(e){this.insertHyperLink(bF.getValue());
bB.close();
},this);
bE.add(bA);
var bC=new qx.ui.form.Button("Cancel");
bC.setWidth(60);
bC.addListener("execute",function(e){bB.close();
},this);
bE.add(bC);
bB.add(bE);
bB.center();
bB.open();
this.saveRange();
},__LY:function(e){var bG=window.prompt("HTML Code:","");
this.insertHtml(bG);
},__Ma:function(){var bR=new qx.ui.form.SelectBox;
bR.set({toolTipText:bd,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
bR.add(new qx.ui.form.ListItem(p));
var bS=[by,P,J,bc,z,bt,bu,bq,v,g,bi];
var bQ;

for(var i=0,j=bS.length;i<j;i++){bQ=new qx.ui.form.ListItem(bS[i]);
bQ.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(a+bS[i])});
bR.add(bQ);
}bR.addListener(o,function(e){var cd=e.getData()[0].getLabel();

if(cd!=p){this.setFontFamily(cd);
bR.setSelection([bR.getChildren()[0]]);
}},this.__LS);
return bR;
},__Mb:function(){var bV=new qx.ui.form.SelectBox;
bV.set({toolTipText:t,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
bV.add(new qx.ui.form.ListItem(p));
var bU;

for(var i=1;i<=7;i++){bU=new qx.ui.form.ListItem(i+p);
bU.set({focusable:false,keepFocus:true});
bV.add(bU);
}bV.addListener(o,function(e){var bH=e.getData()[0].getLabel();

if(bH!=p){this.setFontSize(bH);
bV.setSelection([bV.getChildren()[0]]);
}},this.__LS);
return bV;
},__Mc:function(){return [{bold:{text:T,image:X,action:this.__LS.setBold},italic:{text:bh,image:bx,action:this.__LS.setItalic},underline:{text:G,image:B,action:this.__LS.setUnderline},strikethrough:{text:D,image:be,action:this.__LS.setStrikeThrough},removeFormat:{text:bp,image:I,action:this.__LS.removeFormat}},{alignLeft:{text:w,image:bz,action:this.__LS.setJustifyLeft},alignCenter:{text:N,image:u,action:this.__LS.setJustifyCenter},alignRight:{text:bn,image:bs,action:this.__LS.setJustifyRight},alignJustify:{text:r,image:A,action:this.__LS.setJustifyFull}},{fontFamily:{custom:this.__Ma},fontSize:{custom:this.__Mb},fontColor:{text:m,image:s,action:this.__LT},textBackgroundColor:{text:Q,image:O,action:this.__LU}},{indent:{text:bw,image:k,action:this.__LS.insertIndent},outdent:{text:b,image:bg,action:this.__LS.insertOutdent}},{insertImage:{text:c,image:R,action:this.__LV},insertTable:{text:l,image:H,action:this.__LW},insertLink:{text:ba,image:F,action:this.__LX},insertHTML:{text:x,image:bm,action:this.__LY},insertHR:{text:bj,image:bo,action:this.__LS.insertHorizontalRuler}},{ol:{text:f,image:bk,action:this.__LS.insertOrderedList},ul:{text:Y,image:L,action:this.__LS.insertUnorderedList}},{undo:{text:E,image:bv,action:this.__LS.undo},redo:{text:S,image:W,action:this.__LS.redo}}];
},__Md:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator(U);
var bX;
var bY=this.__Mc();

for(var i=0,j=bY.length;i<j;i++){var ca=new qx.ui.toolbar.Part;
toolbar.add(ca);

for(var cb in bY[i]){var cc=bY[i][cb];

if(cc.custom){bX=cc.custom.call(this);
}else{bX=new qx.ui.toolbar.Button(null,cc.image);
bX.set({focusable:false,keepFocus:true,center:true,toolTipText:cc.text?cc.text:p});
bX.addListener(bf,cc.action,this.__LS);
}ca.add(bX);
}}return toolbar;
}}});
})();
