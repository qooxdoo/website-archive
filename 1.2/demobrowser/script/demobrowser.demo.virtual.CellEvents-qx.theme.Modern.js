...
var p=q.getPane();
p.addListener(j,this._onCellClick,this);
p.addListener(d,this._onContextMenu,this);
p.addListener(b,this._onDblclickPane,this);
...
this.__Mj(a);
},_onContextMenu:function(e){var s=i+e.getRow()+n+e.getColumn()+o;
this.__Mj(s);
},_onDblclickPane:function(e){var t=h+e.getRow()+n+e.getColumn()+o;
this.__Mj(t);
},__Mj:function(r){this.logger.setHtml(this.logger.getHtml()+r);
