...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.animation.Tree_Highlight","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.animation.Tree_Highlight-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"15f08076eea5"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var m="execute",l="appear",k="changeSelection",j="Trash",h="mode",g="Windows (C:)",f="Documents (D:)",e="Add before",d="Add after",c="Add at begin",M="Inbox",L="Desktop",K="Show open button:",J="New tree item name: ",I="auto",H="Hello",G="Presets",F="Data 123213234325345234523453453245",E="demobrowser.demo.animation.Tree_Highlight",D="Network",t="Control",u="Sent",r="Files",s="Remove tree item",p="Add file",q="Workspace",n="Junk #",o="Tree",v="never",w="Add folder",y="Root",x="always",A="Move to parent",z="Reset tree",C="Edit",B="Remove all children";
...
var bd=new qx.ui.groupbox.GroupBox(o).set({contentPadding:[4,4,4,4]});
bd.setLayout(new qx.ui.layout.Canvas());
this._container.add(bd);
this._treeGroup=bd;
var be=this.getTree();
bd.add(be,{edge:0});
this._tree=be;
this._container.add(this.getCommandFrame());
},getTree:function(){var bx=new qx.ui.tree.Tree().set({width:200,height:400});
var bC=new qx.ui.tree.TreeFolder(y);
bC.setOpen(true);
bx.setRoot(bC);
var bA=new qx.ui.tree.TreeFolder(L);
bA.setOpen(true);
bC.add(bA);
var bs=new qx.ui.tree.TreeFolder(r);
var bq=new qx.ui.tree.TreeFolder(q);
var br=new qx.ui.tree.TreeFolder(D);
var bp=new qx.ui.tree.TreeFolder(j);
bA.add(bs,bq,br,bp);
var by=new qx.ui.tree.TreeFile(g);
var bo=new qx.ui.tree.TreeFile(f);
bq.add(by,bo);
var bB=new qx.ui.tree.TreeFolder(M);
var bt=new qx.ui.tree.TreeFolder(G);
var bw=new qx.ui.tree.TreeFolder(u);
var bv=new qx.ui.tree.TreeFolder(j);

for(var i=0;i<100;i++){bv.add(new qx.ui.tree.TreeFile(n+i));
}var bz=new qx.ui.tree.TreeFolder(F);
var bu=new qx.ui.tree.TreeFolder(C);
bB.add(bt,bw,bv,bz,bu);
bC.add(bB);
return bx;
},getCommandFrame:function(){var R=new qx.ui.groupbox.GroupBox(t);
R.setLayout(new qx.ui.layout.Grid(3,5));
var T=0;
R.add(new qx.ui.basic.Label(J).set({paddingTop:4}),{row:T,column:0});
this.inputItemName=new qx.ui.form.TextField(H);
R.add(this.inputItemName,{row:T++,column:1});
this.btnAddFolder=new qx.ui.form.Button(w);
this.btnAddFolder.addListener(m,this._addFolder,this);
R.add(this.btnAddFolder,{row:T++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(p);
this.btnAddFile.addListener(m,this._addFile,this);
R.add(this.btnAddFile,{row:T++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(d);
this.btnAddAfter.addListener(m,this._addAfter,this);
R.add(this.btnAddAfter,{row:T++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(e);
this.btnAddBefore.addListener(m,this._addBefore,this);
R.add(this.btnAddBefore,{row:T++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(c);
this.btnAddBegin.addListener(m,this._addBegin,this);
R.add(this.btnAddBegin,{row:T++,column:0,colSpan:2});
R.add(new qx.ui.core.Spacer(5,5),{row:T++,column:0});
this.btnRemove=new qx.ui.form.Button(s);
this.btnRemove.addListener(m,this._removeTreeItem,this);
R.add(this.btnRemove,{row:T++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(B);
this.btnRemoveAll.addListener(m,this._removeAll,this);
R.add(this.btnRemoveAll,{row:T++,column:0,colSpan:2});
R.add(new qx.ui.core.Spacer(5,5),{row:T++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(A);
this.btnMoveToParent.addListener(m,this._moveToParent,this);
R.add(this.btnMoveToParent,{row:T++,column:0,colSpan:2});
R.add(new qx.ui.core.Spacer(5,5),{row:T++,column:0});
R.add(new qx.ui.basic.Label(K),{row:T,column:0});
var P=[x,v,I];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<P.length;i++){var S=P[i];
var Q=new qx.ui.form.RadioButton(S).set({value:S==this._tree.getRootOpenClose()});
Q.setUserData(h,S);
this.showOpenButtons[S]=Q;
this.mgrShowRootOpen.add(Q);
R.add(Q,{row:T++,column:1});
}this.mgrShowRootOpen.addListener(k,this._onChangeShowOpen,this);
R.add(new qx.ui.core.Spacer(5,5),{row:T++,column:0});
this.btnReset=new qx.ui.form.Button(z);
this.btnReset.addListener(m,this._resetTree,this);
R.add(this.btnReset,{row:T++,column:0,colSpan:2});
this._tree.addListener(k,this._updateControls,this);
this._updateControls();
return R;
},_addFolder:function(){var bm=this._tree.getSelection()[0];
var bn=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
bn.addListenerOnce(l,function(){var bc=new qx.fx.effect.core.Highlight(bn.getContainerElement().getDomElement());
bc.start();
},this);
bm.setOpen(true);
bm.add(bn);
},_addFile:function(){var Y=this._tree.getSelection()[0];
var ba=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
ba.addListenerOnce(l,function(){var b=new qx.fx.effect.core.Highlight(ba.getContainerElement().getDomElement());
b.start();
},this);
Y.setOpen(true);
Y.add(ba);
},_addBefore:function(){var bh=this._tree.getSelection()[0];
var bi=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bi.addListenerOnce(l,function(){var bl=new qx.fx.effect.core.Highlight(bi.getContainerElement().getDomElement());
bl.start();
},this);
bh.getParent().addBefore(bi,bh);
},_addAfter:function(){var bj=this._tree.getSelection()[0];
var bk=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bk.addListenerOnce(l,function(){var bb=new qx.fx.effect.core.Highlight(bk.getContainerElement().getDomElement());
bb.start();
},this);
bj.getParent().addAfter(bk,bj);
},_addBegin:function(){var N=this._tree.getSelection()[0];
var O=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
O.addListenerOnce(l,function(){var bD=new qx.fx.effect.core.Highlight(O.getContainerElement().getDomElement());
bD.start();
},this);
N.getParent().addAtBegin(O);
},_removeTreeItem:function(){var a=this._tree.getSelection()[0];
var parent=a.getParent();
parent.remove(a);
},_removeAll:function(){var bg=this._tree.getSelection()[0];
bg.removeAll();
},_moveToParent:function(){var bf=this._tree.getSelection()[0];
var parent=bf.getParent();
parent.remove(bf);
parent.getParent().add(bf);
this._updateControls();
},_onChangeShowOpen:function(){var bE=this._tree.getSelection()[0];

if(bE!=null){var bF=this.mgrShowRootOpen.getSelection()[0].getUserData(h);
bE.setOpenSymbolMode(bF);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(l,function(){this._tree.addListener(k,this._updateControls,this);
},this);
},_updateControls:function(){var U=this._tree.getSelection()[0];

if(!U){this.btnAddFolder.setEnabled(false);
...
var V=X==-1;
var W=U instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(W);
this.btnAddFile.setEnabled(W);
this.btnAddBefore.setEnabled(!V);
this.btnAddAfter.setEnabled(!V);
this.btnAddBegin.setEnabled(!V);
this.btnRemove.setEnabled(!V);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(W);
this.showOpenButtons[U.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(X>0);
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{startColor:{init:c,check:f},endColor:{init:a,check:f},restoreBackground:{init:true,check:h},keepBackgroundImage:{init:false,check:h}},members:{__xv:null,__xw:null,__xx:null,__xy:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var o=this._getElement();
this.__xv={backgroundImage:qx.bom.element.Style.get(o,g),backgroundColor:qx.bom.element.Style.get(o,i)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(o,g,e);
}this.__xw=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__xx=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__xy=[this.__xx[0]-this.__xw[0],this.__xx[1]-this.__xw[1],this.__xx[2]-this.__xw[2]];
},update:function(j){qx.fx.Base.prototype.update.call(this);
var k=[this.__xw[0]+Math.round(this.__xy[0]*j),this.__xw[1]+Math.round(this.__xy[1]*j),this.__xw[2]+Math.round(this.__xy[2]*j)];
...
for(var m in this.__xv){qx.bom.element.Style.set(n,m,this.__xv[m]);
}}},destruct:function(){this.__xw=this.__xx=this.__xy=null;
}});
})();
