...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.RadioButton","qx.theme":"qx.theme.Classic"};
...
m.setSpacing(10);
var k=new qx.ui.container.Composite(m);
k.setPadding(20);
this.getRoot().add(k,{left:0,top:0});
k.add(p);
var o=new qx.ui.form.RadioButton(g);
var n=new qx.ui.form.RadioButton(d);
var r=new qx.ui.form.RadioButton(h);
var l=new qx.ui.form.RadioButton(b);
k.add(o);
k.add(n);
k.add(r);
k.add(l);
var q=new qx.ui.form.RadioGroup(o,n,r,l);
q.addListener(c,this._onChangeSelection,this);
},_onChangeSelection:function(e){var j=e.getData()[0];
var i=j.getLabel();
alert("Your favorite color is: "+i);
}}});
})();
