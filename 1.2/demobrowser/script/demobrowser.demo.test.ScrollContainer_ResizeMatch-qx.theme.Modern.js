...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.ScrollContainer_ResizeMatch","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"394f1edb0373"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var f="brown",e="Toggle size",d="white",c="demobrowser.demo.test.ScrollContainer_ResizeMatch",b="execute",a="Content size: 300x300";
...
h.set({width:200,height:200});
this.getRoot().add(h,{left:10,top:10});
h.add(this.generateBox());
var g=new qx.ui.form.Button(e);
var i=true;
g.addListener(b,function(){h.setWidth(i?300:200);
h.setHeight(i?300:200);
i=!i;
});
this.getRoot().add(g,{left:10,top:400});
},generateBox:function(){var j=new qx.ui.basic.Label(a).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:f,textColor:d,padding:10});
return j;
}}});
})();
