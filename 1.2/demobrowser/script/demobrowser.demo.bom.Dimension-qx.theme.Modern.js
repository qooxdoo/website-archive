...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Dimension","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Dimension-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1597089a5634"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.debug(k);
}function h(n){var o=qx.bom.element.Dimension;
return o.getWidth(n)+f+o.getHeight(n);
}function j(l){var m=qx.bom.element.Dimension;
return m.getContentWidth(l)+f+m.getContentHeight(l);
}}}});
})();
