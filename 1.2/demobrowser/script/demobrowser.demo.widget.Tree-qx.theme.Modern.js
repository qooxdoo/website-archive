...
(function(){var A="changeValue",z="execute",y="Trash",x="changeSelection",w="mode",v="multi",u="single",t="Windows (C:)",s="Documents (D:)",r="Inbox",be="Desktop",bd="root",bc="Open mode:",bb="Presets",ba="Hide Root Node",Y="Network",X="Control",W=" items",V="Sent",U="Files",H="Show Open Items",I="",F="Workspace",G="Enable drag selection",D="Selection: ",E="Junk #",B="demobrowser.demo.widget.Tree",C="Data",J="click",K="Show root open button",N="none",M="Enable multi selection",P="double click",O="Selection:",R="Show Selected Items",Q="Root node:",L="Toggle Height",T="Edit",S="Show Items";
...
var bj=new qx.ui.layout.HBox();
bj.set({spacing:20});
var bi=new qx.ui.container.Composite(bj);
this.getRoot().add(bi);
var bg=this.getTree();
bi.add(bg);
var bh=this.getCommandFrame(bg);
bi.add(bh);
},getTree:function(){var l=new qx.ui.tree.Tree().set({width:200,height:400});
var q=new qx.ui.tree.TreeFolder(bd);
q.setOpen(true);
l.setRoot(q);
var o=new qx.ui.tree.TreeFolder(be);
o.setOpen(true);
q.add(o);
var f=new qx.ui.tree.TreeFolder(U);
var c=new qx.ui.tree.TreeFolder(F);
var d=new qx.ui.tree.TreeFolder(Y);
var b=new qx.ui.tree.TreeFolder(y);
o.add(f,c,d,b);
var m=new qx.ui.tree.TreeFile(t);
var a=new qx.ui.tree.TreeFile(s);
c.add(m,a);
var p=new qx.ui.tree.TreeFolder(r);
var g=new qx.ui.tree.TreeFolder(bb);
var k=new qx.ui.tree.TreeFolder(V);
var j=new qx.ui.tree.TreeFolder(y);

for(var i=0;i<30;i++){j.add(new qx.ui.tree.TreeFile(E+i));
}var n=new qx.ui.tree.TreeFolder(C);
var h=new qx.ui.tree.TreeFolder(T);
p.add(g,k,j,n,h);
q.add(p);
return l;
},getCommandFrame:function(bm){var bw=new qx.ui.groupbox.GroupBox(X);
var bu=4;
bw.setLayout(new qx.ui.layout.Grid(5,3));
var bD=0;
bw.add(new qx.ui.basic.Label(D).set({paddingTop:4}),{row:bD,column:0});
var bA=new qx.ui.form.TextField().set({readOnly:true});
bw.add(bA,{row:bD++,column:1});
bm.addListener(x,function(e){var bl=e.getData();

if(bl.length>0){if(this.getSelectionMode()===v){bA.setValue(bl.length+W);
}else{bA.setValue(bl[0].getLabel());
}}else{bA.setValue(I);
}});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
bw.add(new qx.ui.basic.Label(bc),{row:bD,column:0});
var bq={"click":J,"dblclick":P,"none":N};
...
}bo.addListener(x,function(e){bm.setOpenMode(e.getData()[0].getUserData(w));
});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
bw.add(new qx.ui.basic.Label(O),{row:bD,column:0});
var bs=new qx.ui.form.CheckBox(M);
bw.add(bs,{row:bD++,column:1});
bs.addListener(A,function(e){var bf=e.getData();
bm.setSelectionMode(bf?v:u);
});
var bt=new qx.ui.form.CheckBox(G);
bw.add(bt,{row:bD++,column:1});
bt.addListener(A,function(e){var bk=e.getData();
bm.setDragSelection(bk);

if(!bs.getValue()){bs.setValue(true);
}});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
bw.add(new qx.ui.basic.Label(Q),{row:bD,column:0});
var bB=new qx.ui.form.CheckBox(ba);
bw.add(bB,{row:bD++,column:1});
bB.addListener(A,function(e){bm.setHideRoot(e.getData());
});
var br=new qx.ui.form.CheckBox(K);
bw.add(br,{row:bD++,column:1});
br.addListener(A,function(e){bm.setRootOpenClose(e.getData());
});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
var bz=new qx.ui.form.Button(S);
bw.add(bz,{row:bD++,column:1});
bz.addListener(z,function(e){alert((""+bm.getItems()).replace(",","\n","g"));
});
var bn=new qx.ui.form.Button(H);
bw.add(bn,{row:bD++,column:1});
bn.addListener(z,function(e){alert((""+bm.getItems(true,false)).replace(",","\n","g"));
});
var bx=new qx.ui.form.Button(R);
bw.add(bx,{row:bD++,column:1});
bx.addListener(z,function(e){if(this.getSelectionMode()===u){alert(this.getSelection());
}else{alert(this.getSelection().toString().replace(",","\n","g"));
}},bm);
var bv=new qx.ui.form.Button(L);
bw.add(bv,{row:bD++,column:1});
var bC=true;
bv.addListener(z,function(e){bm.setHeight(bC?600:400);
bC=!bC;
});
return bw;
}}});
