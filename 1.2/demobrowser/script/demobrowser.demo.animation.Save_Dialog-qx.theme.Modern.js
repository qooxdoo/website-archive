...
(function(){var r="execute",q="middle",p="Cancel",o="demobrowser.demo.animation.Save_Dialog",n="appear",m="Your changes will be lost if you don't save them.",l="close",k="__KU",j="center",h="__KW",c="Save...",g='<b "font-size:12pt;">Do you want to save the changes you made in the doc "Untitled"?</b>',f="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",b="right",a="__KT",e="__KV",d="Don't save";
qx.Class.define(o,{extend:qx.application.Standalone,members:{__KT:null,__KU:null,__KV:null,__KW:null,__KX:function(){if(qx.bom.client.Engine.MSHTML){this.__KT=new qx.fx.effect.core.Fade(this.__KU.getContainerElement().getDomElement()).set({from:0,to:1});
this.__KV=new qx.fx.effect.core.Fade(this.__KU.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__KT=new qx.fx.effect.combination.Grow(this.__KU.getContainerElement().getDomElement());
this.__KV=new qx.fx.effect.combination.Shrink(this.__KU.getContainerElement().getDomElement());
}},showDialog:function(){this.__KU.setZIndex(1);
this.__KT.start();
},hideDialog:function(){this.__KV.start();
},main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__KW=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__KW.setLayout(new qx.ui.layout.VBox());
t.add(this.__KW,{left:40,top:40});
...
y.setRowHeight(2,10);
y.setRowAlign(3,j,q);
this.__KU=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__KU.setLayout(y);
t.add(this.__KU,{left:65,top:125});
this.__KU.addListenerOnce(n,this.__KX,this);
var A=new qx.ui.basic.Label(g);
var u=new qx.ui.basic.Label(m);
A.setRich(true);
this.__KU.add(A,{row:0,column:0,colSpan:3});
this.__KU.add(u,{row:1,column:0,colSpan:3});
var w=[d,p,c];

for(var i=0;i<w.length;i++){var s=new qx.ui.form.Button(w[i]);
s.setAllowStretchX(false);
this.__KU.add(s,{row:3,column:i});
s.addListener(r,this.hideDialog,this);
}}},destruct:function(){this._disposeObjects(h,k,a,e);
}});
})();
