...
(function(){var p="top",o="right",n="resize",m="Name",l="Password",k="Login",j="__KY",h="appear",g="__Lb",f="__La",b="demobrowser.demo.animation.Login",d="50%",c="execute",a="30%";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__KY:null,__La:null,__Lb:null,checkInput:function(){this.__KY.start();
},__Lc:function(){this.__KY=new qx.fx.effect.combination.Shake(this.__La.getContainerElement().getDomElement());
...
this.__La=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__La.setLayout(r);
this.__La.addListener(n,function(e){var v=this.__La.getBounds();
this.__La.set({marginTop:Math.round(-v.height/2),marginLeft:Math.round(-v.width/2)});
},this);
this.getRoot().add(this.__La,{left:d,top:a});
var q=[m,l];

for(var i=0;i<q.length;i++){this.__La.add(new qx.ui.basic.Label(q[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var s=new qx.ui.form.TextField();
var t=new qx.ui.form.PasswordField();
this.__La.add(s.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__La.add(t.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var u=this.__Lb=new qx.ui.form.Button(k);
u.setAllowStretchX(false);
this.__La.add(u,{row:3,column:1});
u.addListener(c,this.checkInput,this);
this.__La.addListener(h,this.__Lc,this);
