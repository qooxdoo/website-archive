...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.GroupBox","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.GroupBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"46be12f8fe78"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
