...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.ScrollContainer_ResizeMatch","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"5cd01f50f3f4"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
