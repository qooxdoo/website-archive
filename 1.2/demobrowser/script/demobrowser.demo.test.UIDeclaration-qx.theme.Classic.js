...
var N={clazz:qx.ui.form.Form,children:[{type:l,label:y},{type:n,label:h,validator:null,name:g,widget:{clazz:qx.ui.form.TextField,required:true,width:200}},{type:n,label:k,widget:{clazz:qx.ui.form.TextField}},{type:n,label:p,widget:{clazz:qx.ui.form.TextField}},{type:n,label:f,widget:{clazz:qx.ui.form.TextField}},{type:n,label:v,widget:{clazz:qx.ui.form.DateField}},{type:m,widget:{clazz:qx.ui.form.Button,label:r}},{type:m,widget:{clazz:qx.ui.form.Button,label:t}}]};
var O={clazz:qx.ui.window.Window,layout:{clazz:qx.ui.layout.VBox,spacing:10},layoutProperties:{left:20,top:20},showStatusbar:true,status:d,caption:z,icon:c,id:u,listeners:[{event:A,handler:function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
}},{event:w,handler:function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
}}],children:[{clazz:qx.ui.basic.Atom,label:q,icon:s,rich:true},{clazz:qx.ui.tabview.TabView,layoutProperties:{flex:1},children:[{clazz:qx.ui.tabview.Page,label:j,layoutProperties:{flex:1},layout:{clazz:qx.ui.layout.Canvas},children:[N]},{clazz:qx.ui.tabview.Page,label:x,layoutProperties:{flex:1}},{clazz:qx.ui.tabview.Page,label:B,layoutProperties:{flex:1}}]}]};
this.addFromDefinition(O);
this.win.open();
},addFromDefinition:function(a){var b=this.getRoot();
this.__Lf(b,a);
},__Lf:function(G,H){var I=new H.clazz();
...
if(L!=null){for(var i=0;i<L.length;i++){if(I instanceof qx.ui.form.Form){this.__Lg(I,L[i]);
}else{this.__Lf(I,L[i]);
...
}}},__Lg:function(C,D){if(D.type===l){C.addGroupHeader(D.label);
return;
}var E=new D.widget.clazz();
var F=qx.lang.Object.clone(D.widget);
delete F.clazz;
E.set(F);

if(D.type===n){C.add(E,D.label,D.validator,D.name);
}else if(D.type===m){C.addButton(E);
}}}});
})();
