...
A.add(this.getBox5());
A.add(this.getBox6());
},getBox1:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
t.add(s,{flex:1});
return t;
},getBox2:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
h.add(j,{width:d});
h.add(i,{width:d});
h.add(g,{width:d,flex:1});
return h;
},getBox3:function(){var x=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
x.add(w,{flex:1});
return x;
},getBox4:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
l.add(n,{width:d,flex:1});
l.add(m,{width:d,flex:1});
l.add(k,{width:d,flex:1});
return l;
},getBox5:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:200,allowGrowX:false});
...
return C;
},getBox6:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
p.add(r,{width:d,flex:1});
p.add(q,{width:d,flex:1});
p.add(o,{width:d,flex:1});
return p;
}}});
})();
