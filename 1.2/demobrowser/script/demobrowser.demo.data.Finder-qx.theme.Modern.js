...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.Finder","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.Finder-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c1af288289ca"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var g="name",f="model",e="selection[0].files",d="Finder",c="json/finder.json",b="model.files",a="demobrowser.demo.data.Finder";
