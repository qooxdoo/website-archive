...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Grid_Complex","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Grid_Complex-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"fe02503ce62c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var i="main",h="green",g="yellow",f="bottom",e="center",d="middle",c="demobrowser.demo.layout.Grid_Complex",b="orange",a="right";
...
j.add(this.getGrid1());
j.add(this.getGrid2());
},getGrid1:function(){var o=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,allowGrowX:false});
o.setLayout(new qx.ui.layout.Grid(5,20));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:0});
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:1});
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,width:150,maxWidth:150}),{row:1,column:0,rowSpan:1,colSpan:2});
return o;
},getGrid2:function(){var k=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,width:500,allowShrinkX:false,allowShrinkY:false,allowGrowX:false});
var n=new qx.ui.layout.Grid();
n.setColumnFlex(1,2);
n.setRowFlex(1,3);
n.setColumnMinWidth(0,70);
n.setColumnMinWidth(1,100);
n.setColumnMaxWidth(2,150);
n.setRowMinHeight(0,70);
n.setSpacing(5);
k.setLayout(n);
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:0});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:1,rowSpan:1,colSpan:2});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:1,column:0});
var m=new qx.ui.container.Composite().set({decorator:i,backgroundColor:b,width:400,padding:5});
k.add(m,{row:1,column:1,rowSpan:2,colSpan:2});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:2,column:0});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:3,column:0,rowSpan:1,colSpan:2});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:3,column:2});
var l=new qx.ui.layout.Grid();
m.setLayout(l);
l.setColumnAlign(1,e,d);
l.setColumnAlign(0,a,f);
l.setColumnMinWidth(1,40);
l.setSpacing(5);
l.setColumnFlex(1,1);
m.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,width:150}),{row:0,column:0});
m.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,height:70,allowGrowX:false}),{row:0,column:1});
m.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:60,allowGrowX:false}),{row:1,column:0});
m.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,minWidth:170}),{row:2,column:0});
return k;
}}});
})();
