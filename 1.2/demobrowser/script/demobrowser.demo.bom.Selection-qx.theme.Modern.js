...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Selection","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Selection-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"58b26a0eb675"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="button",j="click",i="div",h="margin-right: 8px",g="results",f="margin: 4px",d="width:100%;margin-bottom:20px",c="getEnd",b="textarea",a="getStart",P="plaintext",O="text",N="margin: 4px 0px",M="demobrowser.demo.bom.Selection",L="getEndSelectionDocument",K="getSelectionInput",J="this is a test",I="setSelectionInput",H="width:300px;height:250px",G="getStartSelectionDocument",r="setSelectionDocument",s="border:1px solid darkgrey;",p="test\ntest2\ntest3\ntest4\ntest5",q="<strong>Results</strong>",n="background-color: lightgrey",o="test test2 test3 test4 test5 test6",l="container",m="textfield",t="areaContainer",u="position:relative;padding:20px",y="width:20%;margin-right:10px",x="margin-bottom:20px",A="width:500px;height:200px;",z="textContainer",C="test text",B="setSelectionTextarea",w="inputContainer",F="<br/>",E="getSelectionDocument",D="getSelectionTextarea",v="textBlock";
qx.Class.define(M,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var T=qx.bom.Element.create(i,{id:l,style:u});
var bj=qx.bom.Element.create(i,{id:z,style:d});
qx.dom.Element.insertEnd(bj,T);
var bc=qx.bom.Element.create(i,{id:v,style:x});
bc.innerHTML=o;
qx.dom.Element.insertEnd(bc,bj);
var bg=qx.bom.Input.create(k,{value:E,style:f});
qx.bom.Element.addListener(bg,j,this._getSelection,document);
qx.dom.Element.insertEnd(bg,bj);
var bd=qx.bom.Input.create(k,{value:r,style:f});
qx.bom.Element.addListener(bd,j,function(e){qx.bom.Selection.set(document.getElementById(P).firstChild,0,4);
this.debug(qx.bom.Selection.getLength(document));
},this);
qx.dom.Element.insertEnd(bd,bj);
var W=qx.bom.Input.create(k,{value:G,style:f});
qx.bom.Element.addListener(W,j,this._getStart,document);
qx.dom.Element.insertEnd(W,bj);
var Q=qx.bom.Input.create(k,{value:L,style:f});
qx.bom.Element.addListener(Q,j,this._getEnd,document);
qx.dom.Element.insertEnd(Q,bj);
var V=qx.bom.Element.create(i,{id:w,style:d});
qx.dom.Element.insertEnd(V,T);
this._input=qx.bom.Input.create(O,{id:m,value:C,style:y});
qx.dom.Element.insertEnd(this._input,V);
var ba=qx.bom.Input.create(k,{value:K,style:h});
qx.bom.Element.addListener(ba,j,this._getSelection,this._input);
qx.dom.Element.insertEnd(ba,V);
var bh=qx.bom.Input.create(k,{value:I,style:h});
qx.bom.Element.addListener(bh,j,this._setSelection,this._input);
qx.dom.Element.insertEnd(bh,V);
var be=qx.bom.Input.create(k,{value:a,style:h});
qx.bom.Element.addListener(be,j,this._getStart,this._input);
qx.dom.Element.insertEnd(be,V);
var bk=qx.bom.Input.create(k,{value:c,style:h});
qx.bom.Element.addListener(bk,j,this._getEnd,this._input);
qx.dom.Element.insertEnd(bk,V);
var S=qx.bom.Element.create(i,{id:t,style:d});
qx.dom.Element.insertEnd(S,T);
this._textArea=qx.bom.Input.create(b,{id:b,rows:7,cols:20,value:p,style:H});
qx.dom.Element.insertEnd(this._textArea,S);
var bf=qx.bom.Input.create(k,{value:D,style:h});
qx.bom.Element.addListener(bf,j,this._getSelection,this._textArea);
qx.dom.Element.insertEnd(bf,S);
var X=qx.bom.Input.create(k,{value:B,style:h});
qx.bom.Element.addListener(X,j,this._setSelection,this._textArea);
qx.dom.Element.insertEnd(X,S);
var R=qx.bom.Input.create(k,{value:a,style:h});
qx.bom.Element.addListener(R,j,this._getStart,this._textArea);
qx.dom.Element.insertEnd(R,S);
var bi=qx.bom.Input.create(k,{value:c,style:h});
qx.bom.Element.addListener(bi,j,this._getEnd,this._textArea);
qx.dom.Element.insertEnd(bi,S);
var bb=qx.bom.Element.create(i,{style:N});
bb.innerHTML=q;
var U=qx.bom.Element.create(i,{id:g,style:A+s+n});
qx.dom.Element.insertEnd(bb,T);
qx.dom.Element.insertEnd(U,T);
var Y=qx.bom.Element.create(i,{id:P});
Y.innerHTML=J;
qx.dom.Element.insertEnd(Y,document.body);
qx.dom.Element.insertEnd(T,document.body);
},_getSelection:function(e){document.getElementById(g).innerHTML=qx.bom.Selection.get(this)+F+qx.bom.Selection.getLength(this);
},_getStart:function(e){document.getElementById(g).innerHTML=qx.bom.Selection.getStart(this);
},_getEnd:function(e){document.getElementById(g).innerHTML=qx.bom.Selection.getEnd(this);
