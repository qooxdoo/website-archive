...
this.__MJ=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__MJ:null,__MI:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__MJ!=null){i.stop(this.__MJ);
this.__MJ=null;
}this.__MJ=i.start(function(){this.__MI.update();
this.__MJ=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__MI=null;
}});
})();
