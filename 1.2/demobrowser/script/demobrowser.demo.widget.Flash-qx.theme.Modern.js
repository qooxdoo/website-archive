...
(function(){var k="execute",j="__LF",i="__LG",h="Flash Player Version",g="__LH",f="right",d="Message from Flash:",c="Simple demo with FlashVars",b="bgcolor",a="demobrowser.demo.widget.Flash",y="demobrowser/demo/flash/FlashVersion.swf",x="Flash:",w="<b>qooxdoo:</b>",v="__LI",u="demobrowser.demo.widget.Flash.sendMessage",t="demobrowser.demo.widget.Flash.flashReady",s="demobrowser/demo/flash/fo_tester.swf",r="this is passed in via FlashVars",q="Two way communication (ActionScript <-> JavaScript)",p="Message to Flash:",n="Show Flash Player version",o="noscale",l="__LE",m="#FF6600";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__LE:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var D=new qx.ui.tabview.TabView();
D.setContentPadding([8,8,8,8]);
var G=this.getRoot();
G.add(D,{edge:0});
var E=new qx.ui.tabview.Page(c);
E.setLayout(new qx.ui.layout.Canvas());
E.add(this.createFlashDemo1(),{edge:0});
D.add(E);
var F=new qx.ui.tabview.Page(q);
F.setLayout(new qx.ui.layout.Canvas());
F.add(this.createFlashDemo2(),{edge:0});
D.add(F);
this.__LE=this.createWindow();
G.add(this.__LE,{top:20,left:20});
},createWindow:function(){var M=new qx.ui.window.Window(h).set({width:300,height:200,contentPadding:[0,0,0,0]});
M.setLayout(new qx.ui.layout.Canvas());
M.add(new qx.ui.embed.Flash(y),{edge:0});
return M;
},createFlashDemo1:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var z={flashVarText:r};
var A=new qx.ui.embed.Flash(s).set({scale:o,variables:z});
A.getContentElement().setParam(b,m);
B.add(A,{flex:1});
var C=new qx.ui.form.Button(n);
C.addListener(k,function(){this.__LE.open();
},this);
B.add(C);
return B;
},__LF:null,__LG:null,__LH:null,__LI:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
...
this.__LG=new qx.ui.form.TextArea("No message.");
this.__LG.setEnabled(false);
J.add(this.__LG,{flex:1});
J.add(new qx.ui.basic.Label(p));
this.__LH=new qx.ui.form.TextArea("qooxdoo is the best!");
J.add(this.__LH,{flex:1});
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));
this.__LI=new qx.ui.form.Button("Send to Flash");
this.__LI.setEnabled(false);
this.__LI.addListener(k,function(e){this.__LF.getFlashElement().sendMessage(this.__LH.getValue());
},this);
L.add(this.__LI);
J.add(L);
...
this.__LF=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__LF.setVariables({init:t});
I.add(this.__LF,{flex:1});
return K;
},sendMessage:function(N){this.__LG.setValue(N);
},initFlash:function(){if(this.__LF.getFlashElement().setup){this.__LF.getFlashElement().setup(u);
this.__LI.setEnabled(true);
...
}}},statics:{__LJ:null,setCallBackInstance:function(H){demobrowser.demo.widget.Flash.__LJ=H;
},sendMessage:function(O){demobrowser.demo.widget.Flash.__LJ.sendMessage(O);
},flashReady:function(){demobrowser.demo.widget.Flash.__LJ.initFlash();
}},destruct:function(){this._disposeObjects(i,g,v,j,l);
}});
})();
...
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(bi,bj){this.getContentElement().setVariables(bi);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(bn,bo){this.getContentElement().setAttribute(z,bn?k:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bv,bw){this.__DO(e,bv);
},_applyScale:function(bk,bl){this.__DO(a,bk);
},_applyWmode:function(br,bs){this.__DO(O,br);
},_applyPlay:function(Y,ba){this.__DO(s,Y);
},_applyLoop:function(bt,bu){this.__DO(J,bt);
},_applyMenu:function(bg,bh){this.__DO(L,bg);
},_applyAllowScriptAccess:function(bp,bq){this.__DO(I,bp);
},_applyLiveConnect:function(W,X){this.__DO(o,W);
},__DO:function(U,V){this.getContentElement().setParam(U,V);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
if(g===null||g===undefined){delete this.__CN[f];
}else{this.__CN[f]=g;
