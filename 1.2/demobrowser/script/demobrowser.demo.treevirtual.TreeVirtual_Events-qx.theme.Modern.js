...
var G=e.getData();
x.nodeSetHideOpenClose(G,true);
});
x.addListener(h,function(e){var D=j;
var E=e.getData();

for(i=0;i<E.length;i++){D+=s+E[i].label;
}alert('changeSelection: '+D);
});
}}});
})();
