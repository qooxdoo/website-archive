...
for(var i=0;i<8;i++){D.push(i);
}var F=new qx.data.Array(D);
var x=new qx.ui.form.List();
this.getRoot().add(x,{left:10,top:80});
var A=new qx.data.controller.List(F,x);
var w={};
w.filter=function(s){return parseInt(s)%2==1;
};
var y={};
y.filter=function(I){return parseInt(I)%2==0;
};
var C=new qx.ui.basic.Label(b);
this.getRoot().add(C,{left:10,top:290});
var G={converter:function(r){if(r==y){return l;
}else if(r==w){return f;
}return p;
}};
A.bind(a,C,e,G);
...
z.addListener(q,function(){F.push(F.length);
},this);
var E=new qx.ui.form.Button(m);
E.setWidth(120);
this.getRoot().add(E,{left:130,top:115});
E.addListener(q,function(){F.pop();
},this);
var B=new qx.ui.form.Button(o);
B.setWidth(120);
this.getRoot().add(B,{left:130,top:150});
B.addListener(q,function(){qx.log.appender.Console.show();
this.info(F.toString());
},this);
var u=new qx.ui.form.Button(k);
u.setWidth(120);
this.getRoot().add(u,{left:130,top:185});
u.addListener(q,function(){A.getDelegate()==w?A.setDelegate(y):A.setDelegate(w);
},this);
var t=new qx.ui.form.Button(j);
t.setWidth(120);
this.getRoot().add(t,{left:130,top:220});
t.addListener(q,function(){A.setDelegate(null);
},this);
var H=new qx.ui.form.Button(g);
H.setWidth(120);
this.getRoot().add(H,{left:130,top:255});
H.addListener(q,function(){F.reverse();
},this);
