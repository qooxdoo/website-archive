...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.Event_Iframe","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.Event_Iframe-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"95f6bb060cc7"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var q=qx.bom.Iframe.create({name:m,src:b});
q.id=m;
document.body.appendChild(q);
qx.event.Registration.addListener(q,d,this.bindIFrameEvents,this);
...
},_cascadeCapture:function(e){var p=e.getCurrentTarget();
this.debug("capture: "+p.id+" "+e.getEventPhase());
