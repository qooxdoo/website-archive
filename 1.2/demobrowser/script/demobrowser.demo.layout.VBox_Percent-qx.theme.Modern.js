...
C.add(B,{flex:1});
return C;
},getBox2:function(){var q=new qx.ui.layout.VBox();
var s=new qx.ui.container.Composite(q).set({decorator:k,backgroundColor:h,height:300,allowGrowY:false});
q.setSpacing(5);
...
s.add(u,{height:i});
s.add(t,{height:i});
s.add(r,{height:i,flex:1});
return s;
},getBox3:function(){var F=new qx.ui.layout.VBox();
var H=new qx.ui.container.Composite(F).set({decorator:k,backgroundColor:h,allowGrowY:false});
F.setSpacing(5);
var J=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var I=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var G=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
H.add(J,{height:g});
H.add(I,{flex:1});
H.add(G,{flex:1});
return H;
...
var d=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
var b=new qx.ui.core.Widget().set({decorator:k,backgroundColor:j});
c.add(e,{height:i,flex:1});
c.add(d,{height:i,flex:1});
c.add(b,{height:i,flex:1});
return c;
},getBox5:function(){var v=new qx.ui.layout.VBox();
var x=new qx.ui.container.Composite(v).set({decorator:k,backgroundColor:h,height:100,allowGrowY:false});
v.setSpacing(5);
...
x.add(z,{height:i,flex:1});
x.add(y,{height:i,flex:1});
x.add(w,{height:i,flex:1});
return x;
},getBox6:function(){var l=new qx.ui.layout.VBox();
var n=new qx.ui.container.Composite(l).set({decorator:k,backgroundColor:h,height:300,allowGrowY:false});
l.setSpacing(5);
...
n.add(p,{height:i,flex:1});
n.add(o,{height:i,flex:1});
n.add(m,{height:i,flex:1});
return n;
}}});
})();
