...
return l;
},getGrid2:function(){var o=new qx.ui.layout.Grid();
o.setColumnAlign(1,f,d);
o.setColumnAlign(0,b,c);
o.setSpacing(5);
var n=new qx.ui.container.Composite(o).set({decorator:k,backgroundColor:i,allowGrowX:false});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,width:150}),{row:0,column:0});
var m=new qx.ui.basic.Label(h).set({decorator:k,backgroundColor:j,allowGrowX:false,width:50,height:50});
n.add(m,{row:0,column:1});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:60,allowGrowX:false}),{row:1,column:0});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,height:80}),{row:1,column:1});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:0});
n.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:1});
var p=10;
m.addListener(g,function(e){m.setWidth(50+p);
p=-p;
});
return n;
