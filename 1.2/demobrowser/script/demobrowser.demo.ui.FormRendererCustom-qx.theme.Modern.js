...
qx.Class.define(l,{extend:qx.ui.form.renderer.Single,members:{__Nu:0,__Nv:0,addItems:function(q,r,s){var v=0;
if(s!=null){this._add(this._createHeader(s),{row:v,column:this.__Nu,colSpan:2});
v++;
}for(var i=0;i<q.length;i++){var u=this._createLabel(r[i],q[i]);
this._add(u,{row:v,column:this.__Nu});
var t=q[i];
u.setBuddy(t);

if(t instanceof qx.ui.form.RadioGroup){t=this._createWidgetForRadioGroup(t);
}this._add(t,{row:v,column:this.__Nu+1});
v++;
}this.__Nu+=2;
this.__Nv<v?this.__Nv=v:null;
...
this._add(this._buttonRow,{row:this.__Nv,column:0,colSpan:this.__Nu});
