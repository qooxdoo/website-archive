...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_Margin","qx.theme":"qx.theme.Classic"};
...
E.add(this.getBox4());
E.add(this.getBox5());
},getBox1:function(){var k=new qx.ui.layout.HBox();
var m=new qx.ui.container.Composite(k).set({decorator:e,backgroundColor:c,allowGrowX:false});
k.setSpacing(5);
...
var l=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
m.add(o);
m.add(n);
m.add(l);
o.setAllowGrowY(false);
n.setAllowGrowY(false);
l.setAllowGrowY(false);
o.setMarginTop(20);
l.setMarginBottom(30);
return m;
},getBox2:function(){var f=new qx.ui.layout.HBox();
var h=new qx.ui.container.Composite(f).set({decorator:e,backgroundColor:c,allowGrowX:false});
f.setSpacing(5);
...
h.add(g);
j.setMarginTop(20);
g.setMarginBottom(30);
return h;
},getBox3:function(){var u=new qx.ui.layout.HBox();
var w=new qx.ui.container.Composite(u).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
u.setSpacing(5);
u.setAlignY(b);
...
var v=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
w.add(y);
w.add(x);
w.add(v);
y.setAllowGrowY(false);
x.setAllowGrowY(false);
v.setAllowGrowY(false);
y.setMarginTop(20);
v.setMarginBottom(30);
return w;
},getBox4:function(){var z=new qx.ui.layout.HBox();
var B=new qx.ui.container.Composite(z).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
z.setSpacing(5);
z.setAlignY(b);
...
var A=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
B.add(D);
B.add(C);
B.add(A);
D.setMarginTop(20);
A.setMarginTop(5);
A.setMinHeight(50);
A.setMarginBottom(20);
return B;
},getBox5:function(){var p=new qx.ui.layout.HBox();
var r=new qx.ui.container.Composite(p).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
p.setSpacing(5);
p.setAlignY(b);
...
var q=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
r.add(t);
r.add(s);
r.add(q);
t.setMarginTop(20);
