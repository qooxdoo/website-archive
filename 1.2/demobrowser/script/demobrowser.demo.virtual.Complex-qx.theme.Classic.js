...
this.__Mu=[];
},members:{_pool:null,__Mu:null,getCellData:function(A,B){if(!this.__Mu[A]){this.__Mu[A]=[];
}
if(!this.__Mu[A][B]){this.__Mu[A][B]={label:this.__Mv(),icon:this.__Mw()};
}return this.__Mu[A][B];
},getCellWidget:function(s,t){var u;

if(t%2==0){u=this._pool.atom.pop();

if(!u){u=new qx.ui.basic.Atom();
u.addListener(c,function(){var C=this.__Mw();
u.setIcon(C);
this.__Mu[s][t].icon=C;
},this);
...
u.setUserData(o,t);
return u;
},poolCellWidget:function(z){if(z.classname==a){this._pool.atom.push(z);
}else{this._pool.checkbox.push(z);
}},__Mv:function(){var name=m;

for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);
}return name;
},__Mw:function(){var v=n;
var x=k;
var y=[l,g,h,b,d];
var w=Math.floor(Math.random()*4);
return (v+16+e+x+y[w]);
}},destruct:function(){this._pool=this.__Mu=null;
}});
})();
