...
var settings = {"qx.application":"portal.Application","qx.theme":"qx.theme.Modern","qx.version":"1.2"};
...
var libinfo = {"__out__":{"sourceUri":"script"},"portal":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.2"}};
...
},__rp:function(n){var r,u,s,t,v,n;
...
qx.lang.Array.remove(this.__ro[z],A);
qx.lang.Array.insertAt(this.__ro[y],A,B);
},getGroupBoxDataOfBox:function(w){for(var i=0,j=this.__rn.length,x;i<j;i++){x=this.__ro[this.__rn[i].id];

for(var k=0,l=x.length;k<l;k++){if(x[k].getId()===w){return this.__rn[i];
}}}return null;
...
this.__rs=new portal.box.Resizable(this,E);
}if(A.draggable){this.setDraggable(true);
this.__rt=new portal.box.Draggable(this);
}this.__rv();
},properties:{element:{init:null},groupBoxId:{init:null,check:h},active:{check:s,init:false,apply:j},resizable:{check:s,init:false},draggable:{check:s,init:false}},members:{__rr:null,__rq:null,__rt:null,__rs:null,_applyActive:function(t,u){if(t){qx.bom.element.Style.set(this.getElement(),q,a);
...
},__ru:function(x,y){if(y){for(var z in y){qx.bom.element.Style.set(z,y[z]);
}}qx.bom.element.Style.set(x,l,b);
qx.bom.element.Style.set(x,k,0);
qx.bom.Element.addListener(x,o,this.__rw,this,true);
},__rv:function(){var w=f+g;
w=w+r+w+r+w;
var v=qx.bom.Element.create(d,{"class":i});
v.innerHTML=w;
qx.dom.Element.insertEnd(v,this.getElement());
...
for(var name in this.__rC){if(z[name]){this.__rC[name]=z[name];
}}this.__rD();
...
this.__rz.east=null;
break;
}for(var Q in this.__rz){var P=this.__rz[Q]=qx.bom.Element.create(g);
qx.bom.element.Attribute.set(P,p,Q);
qx.dom.Element.insertEnd(P,this.__ry);

if(this.__ry.id){P.id=this.__ry.id+i+Q;
}this.__rE(Q);
this.__rF(Q);
}},__rE:function(A){qx.bom.element.Class.add(this.__rz[A],A+k);
qx.bom.element.Style.set(this.__rz[A],v,this.__rC.autoHide?u:r);
},__rF:function(L){var N=qx.event.Registration;
var M=this.__rz[L];
N.addListener(M,j,this.__rI,this);
N.addListener(document.body,n,this.__rJ,this);

if(this.__rC.autoHide){N.addListener(this.__rx.getElement(),t,this.__rG,this);
N.addListener(this.__rx.getElement(),s,this.__rH,this);
}},__rG:function(e){for(var O in this.__rz){qx.bom.element.Style.set(this.__rz[O],v,r);
}},__rH:function(e){if(!this.__rA){for(var K in this.__rz){qx.bom.element.Style.set(this.__rz[K],v,u);
}}},__rI:function(e){e.stopPropagation();
if(e.isLeftPressed()){qx.event.Registration.addListener(document.body,q,this.__rK,this,true);
this.__rA=true;
var x=e.getTarget();
this.__rB.orientation=qx.bom.element.Attribute.get(x,p);
...
if(this.__rA){qx.event.Registration.removeListener(document.body,q,this.__rK,this,true);
portal.box.Util.sendToBack(this.__ry);

if(this.__rC.autoHide){for(var a in this.__rz){qx.bom.element.Style.set(this.__rz[a],v,u);
}}this.__rA=false;
...
switch(this.__rB.orientation){case o:w.top=e.getDocumentTop();
break;
case b:w.top=e.getDocumentTop();
w.left=e.getDocumentLeft();
break;
case h:w.left=e.getDocumentLeft();
break;
}this.__rL(w,this.__rB.lastCoord);
this.__rB.lastCoord.left=e.getDocumentLeft();
this.__rB.lastCoord.top=e.getDocumentTop();
}},__rL:function(B,C){var J=qx.bom.element.Dimension;
var G=portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__rx.getId());
var I=J.getContentSize(G.element);

if(B.left){var F=B.left-C.left;

if(F!==0){var E=J.getContentWidth(this.__ry)+F;
var H=J.getWidth(this.__ry)+F;

if((this.__rC.minWidth==null||E>this.__rC.minWidth)&&(this.__rC.maxWidth==null||E<=this.__rC.maxWidth)){if(I.width>=H){qx.bom.element.Style.set(this.__ry,l,E+f);
}}}}
if(B.top){var F=B.top-C.top;

if(F!==0){var D=J.getContentHeight(this.__ry)+F;

if((this.__rC.minHeight==null||D>this.__rC.minHeight)&&(this.__rC.maxHeight==null||D<=this.__rC.maxHeight)){qx.bom.element.Style.set(this.__ry,d,D+c);
}}}}},destruct:function(){if(this.__rC.autoHide){qx.event.Registration.removeListener(this.__rx.getElement(),t,this.__rG,this);
qx.event.Registration.removeListener(this.__rx.getElement(),s,this.__rH,this);
...
qx.Class.define(b,{statics:{__rO:1000,bringToFront:function(f){var g=qx.bom.element.Style.get(f,c);
g=g==a?0:g;
...
this.__rV();
},__rU:function(){this.__rR=qx.bom.Element.create(g);
qx.bom.element.Class.add(this.__rR,b);
qx.dom.Element.insertBegin(this.__rR,this.__rQ);
},__rV:function(){qx.bom.Element.addListener(this.__rR,l,this.__rW,this);
qx.bom.Element.addListener(this.__rR,j,function(e){qx.bom.element.Style.set(this,c,f);
},this.__rR);
qx.bom.Element.addListener(this.__rR,m,this.__sa,this);
qx.bom.Element.addListener(this.__rR,h,portal.dragdrop.Manager.getInstance().stopSession,portal.dragdrop.Manager.getInstance());
qx.bom.Element.addListener(this.__rR,i,this.__sb,this);
...
qx.bom.Element.addListener(document.body,n,this.__rY,this,true);
this.__rX();
qx.event.Registration.fireEvent(this.__rR,m,qx.event.type.Event);
}},__rX:qx.core.Variant.select(a,{"mshtml":function(){var s=this;
var r=qx.lang.Function.bind(this.__rY,s);
document.getElementsByTagName(d)[0].onmouseleave=r;
},"default":qx.lang.Function.empty}),__rY:function(e){try{e.stopPropagation();
}catch(q){}
if(portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,o,this.__sb,this,true);
portal.dragdrop.Manager.getInstance().stopSession();
}qx.bom.Element.removeListener(document.body,n,this.__rY,this,true);
...
qx.event.Registration.addListener(document.body,o,this.__sb,this,true);
},__sb:function(e){e.stopPropagation();
var t=e.getDocumentLeft()-this.__rS.left;
var top=e.getDocumentTop()-this.__rS.top;
qx.event.Timer.once(function(){this.checkGroupBox(t);
this.onDragMove(top,t);
},portal.dragdrop.Manager.getInstance(),0);
}},destruct:function(){this.__rP=this.__rR=this.__rQ=this.__rS=null;
}});
})();
(function(){var A="px",z="px;",y="border",x="portal.box.Box",w="1px dashed red",v="top",u="Boolean",t="left",s="paddingTop",r="width:",k="height:",q="finish",n="opacity:0.5;margin:0;position:absolute;",g="left:",f="div",m="absolute",l="spring",o="paddingBottom",d="portal.dragdrop.Manager",p="singleton",h="top:";
qx.Class.define(d,{type:p,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__sc={top:null,height:null};
this.__sd={top:0,left:0};
},properties:{activeBox:{check:x,init:null,nullable:true},sessionActive:{check:u,init:false}},members:{__sc:null,__se:null,__sf:false,__sd:null,__sg:null,__sh:null,startSession:function(G){this.setSessionActive(true);
this.setActiveBox(G);
this.__se=G.getGroupBoxId();
this.__si();
if(this.__sg==null){this.__sg={};
var H=portal.box.Manager.getInstance().getGroupBoxes();

for(var i=0,j=H.length;i<j;i++){this.__sg[H[i].element.id]={left:qx.bom.element.Location.getLeft(H[i].element),right:qx.bom.element.Location.getLeft(H[i].element)+qx.bom.element.Dimension.getWidth(H[i].element)};
}}},__si:function(){if(!this.__sh){this.__sh=qx.bom.Element.create(f);
}var D=this.getActiveBox().getElement();
var B=qx.bom.element.Dimension.getContentSize(D);
this.__sj(D,this.__sh);
qx.bom.element.Class.add(this.__sh,qx.bom.element.Class.get(D));
var C=n+h+qx.bom.element.Location.getTop(D)+z+g+qx.bom.element.Location.getLeft(D)+z+r+B.width+z+k+B.height+A;
qx.bom.element.Style.setCss(this.__sh,C);
qx.bom.element.Style.set(D,y,w);
qx.dom.Node.getBodyElement(D).appendChild(this.__sh);
portal.box.Util.bringToFront(this.__sh);
},__sj:function(E,F){while(E.firstChild){F.appendChild(E.firstChild);
...
a.set({x:qx.bom.element.Location.getLeft(c),y:qx.bom.element.Location.getTop(c),mode:m,duration:0.5,transition:l});
a.start();
a.addListener(q,function(){this.__sj(this.__sh,c);
qx.bom.element.Style.reset(c,y);
...
},onDragMove:function(top,S){if(this.__sd.left!=S){qx.bom.element.Style.set(this.__sh,t,S+A);
}
if(this.__sd.top!=top){qx.bom.element.Style.set(this.__sh,v,top+A);
...
this.__sd.top=top;
},__sk:function(I,top,J,K){var L=qx.bom.element.Location.getTop(K);
var N=parseInt(qx.bom.element.Style.get(K,s));
var O=parseInt(qx.bom.element.Style.get(K,o));
var M=qx.bom.element.Dimension.getContentHeight(K)+O+N;
var P;

if(I){if(top>=(L+(M/3))){P=qx.dom.Hierarchy.getNextElementSibling(K);

if(P!=J||P==null){qx.dom.Element.insertAfter(J,K);
this.__sc.top=qx.bom.element.Location.getTop(J);
}return true;
}}else{if(top<=(L+M*2/3)){P=qx.dom.Hierarchy.getPreviousElementSibling(K);

if(P!=J||P==null){qx.dom.Element.insertBefore(J,K);
this.__sc.top=qx.bom.element.Location.getTop(J);
}return true;
}}return false;
},checkGroupBox:function(Q){if(this.__sg[this.__se].left<=Q&&this.__sg[this.__se].right>=Q){return;
}
for(var R in this.__sg){if(R!=this.__se){if(this.__sg[R].left<=Q&&this.__sg[R].right>=Q){this.__se=R;
this.__sf=true;
return;
...
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:g,check:[g,e]},x:{init:0,check:f},y:{init:0,check:f}},members:{__sv:null,__sw:null,__sx:null,__sy:null,__sz:null,setup:function(){var m=this._getElement();
qx.fx.Base.prototype.setup.call(this);

if(m.parentNode){this.__sx=qx.bom.element.Location.getLeft(m)-qx.bom.element.Location.getLeft(m.parentNode);
this.__sy=qx.bom.element.Location.getTop(m)-qx.bom.element.Location.getTop(m.parentNode);
}else{this.__sx=qx.bom.element.Location.getLeft(m);
this.__sy=qx.bom.element.Location.getTop(m);
}this.__sz=qx.bom.element.Style.get(m,i);
...
var k=Math.round(this.__sv*j+this.__sx);
var top=Math.round(this.__sw*j+this.__sy);
