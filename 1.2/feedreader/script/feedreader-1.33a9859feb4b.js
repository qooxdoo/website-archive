qx.$$packageData['33a9859feb4b']={"locales":{},"resources":{"feedreader/images/combined/icons16.png":[16,96,"png","feedreader"],"qx/icon/Tango/16/actions/dialog-cancel.png":[16,16,"png","qx","feedreader/images/combined/icons16.png",0,-64],"qx/icon/Tango/16/actions/dialog-ok.png":[16,16,"png","qx","feedreader/images/combined/icons16.png",0,0],"qx/icon/Tango/16/apps/preferences-locale.png":[16,16,"png","qx","feedreader/images/combined/icons16.png",0,-48],"qx/icon/Tango/16/apps/preferences-theme.png":[16,16,"png","qx","feedreader/images/combined/icons16.png",0,-32]},"translations":{}};

qx.Part.$$notifyLoad("33a9859feb4b", function() {
...
qx.Class.define(a,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__bp:null,setDesktop:function(t){this.__bp=t;
this.updateStack();
},getDesktop:function(){return this.__bp;
},changeActiveWindow:function(o,p){if(o){this.updateStack();
this.bringToFront(o);
o.setActive(true);
}
if(p){p.resetActive();
...
}if(h.isAlwaysOnTop()){n+=2;
h.setZIndex(n);
}else if(h.isModal()){m+=2;
h.setZIndex(m);
...
if(!j){this.__bp.setActiveWindow(f);
}},bringToFront:function(c){var d=this.__bp.getWindows();
var e=qx.lang.Array.remove(d,c);

if(e){d.push(c);
this.updateStack();
}},sendToBack:function(q){var r=this.__bp.getWindows();
