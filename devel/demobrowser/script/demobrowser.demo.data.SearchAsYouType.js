...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.26e488db9fcb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="number",b="qx.util.TimerManager",c="interval",d="singleton";qx.Class.define(b,{extend:qx.core.Object,type:d,statics:{__xY:[],__ya:{},__sG:0},members:{__yb:false,start:function(h,g,j,e,k){if(typeof k!=a){k=g||0;}
;var f=(new Date()).getTime()+k;this.self(arguments).__ya[ ++this.self(arguments).__sG]={callback:h,userData:e||null,expireAt:f,recurTime:g,context:j||this};this.__yc(f,this.self(arguments).__sG);return this.self(arguments).__sG;}
