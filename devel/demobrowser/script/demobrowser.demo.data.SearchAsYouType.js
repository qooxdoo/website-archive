...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.f29536a5359d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="number",b="qx.util.TimerManager",c="interval",d="singleton";qx.Class.define(b,{extend:qx.core.Object,type:d,statics:{__xP:[],__xQ:{},__sy:0},members:{__xR:false,start:function(h,g,j,e,k){if(typeof k!=a){k=g||0;}
;var f=(new Date()).getTime()+k;this.self(arguments).__xQ[ ++this.self(arguments).__sy]={callback:h,userData:e||null,expireAt:f,recurTime:g,context:j||this};this.__xS(f,this.self(arguments).__sy);return this.self(arguments).__sy;}
