...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.OwnCodeInModel.a2abfb4f49ee.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="application/json",c="json",d="aborted",e="loaded",f="qx.event.type.Data",g="error",h="fail",i="receiving",j="queued",k="changeState",l="success",m="String",n="changePhase",o="sending",p="_marshaler",q="completed",r="failed",s="qx.data.store.Json",t="configured",u="changeUrl",v="timeout",w="__uH",x="_applyUrl";qx.Class.define(s,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":f,"error":f},properties:{model:{nullable:true,event:a},state:{check:[t,j,o,i,q,d,v,r],init:t,event:k},url:{check:m,apply:x,event:u,nullable:true}},members:{_marshaler:null,_delegate:null,__uH:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__uH;}
,_setRequest:function(C){this.__uH=C;}
,_createRequest:function(D){if(this.__uH){this.__uH.dispose();this.__uH=null;}
...
,_onChangePhase:function(I){var G=I.getData(),J={},H;J={"opened":t,"sent":o,"loading":i,"success":q,"abort":d,"timeout":v,"statusError":r};H=J[G];if(H){this.setState(H);}
;}
...
;this.fireDataEvent(e,this.getModel());if(this.__uH){this.__uH.dispose();this.__uH=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__uH!=null){this._disposeObjects(w);}
...
;this.__sb={};var S=this._transport=this._createTransport();this._setPhase(H);this.__sc=qx.lang.Function.bind(this._onReadyStateChange,this);this.__sd=qx.lang.Function.bind(this._onLoad,this);this.__se=qx.lang.Function.bind(this._onLoadEnd,this);this.__sf=qx.lang.Function.bind(this._onAbort,this);this.__sg=qx.lang.Function.bind(this._onTimeout,this);this.__sh=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__sc;S.onload=this.__sd;S.onloadend=this.__se;S.onabort=this.__sf;S.ontimeout=this.__sg;S.onerror=this.__sh;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__sc:null,__sd:null,__se:null,__sf:null,__sg:null,__sh:null,__si:null,__sj:null,__sk:null,__sb:null,__sl:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__sj=true;this.__sk=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__sm());qx.lang.Object.mergeWith(bd,this.__sl);qx.lang.Object.mergeWith(bd,this.__sb);return bd;}
,__sm:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__sb[bh]=bi;}
,getRequestHeader:function(bj){return this.__sb[bj];}
,removeRequestHeader:function(bk){if(this.__sb[bk]){delete this.__sb[bk];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__sk;}
...
,getResponse:function(){return this.__si;}
,_setResponse:function(bo){var bn=bo;if(this.__si!==bo){this.__si=bo;this.fireEvent(I,qx.event.type.Data,[this.__si,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__sj){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__sn();}
;}
,__sn:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__sk;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__sk=br;this.fireDataEvent(c,br,bs);}
...
(function(){var a="text",b="Retry open native request with method: ",c="activex",d="No XHR support available.",f="If-None-Match",g="xhr",h="If-Modified-Since",i="engine.version",j="onunload",k="GET",l="-1",m="qx.debug.io",n="Undefined",o="Open native request with method: ",p="error",q="loadend",r="Blob",s="HTMLDocument",t="progress",u="load",v="Received native readyState: ",w="abort",x=", url: ",y="String",z="browser.documentmode",A="document",B="",C="readystatechange",D="Microsoft.XMLHTTP",E="Already disposed",F="browser.version",G="opera",H="qx.bom.request.Xhr",I="on",J="timeout",K="gecko",L="If-Match",M="mshtml",N="engine.name",O="Microsoft.XMLDOM",P="file:",Q="Send native request",R="FormData",S="If-Range",T="Content-Type",U="io.xhr",V="Not enough arguments",W="ArrayBuffer",X="undefined",Y=", async: ",bb="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(H,{extend:Object,implement:[qx.core.IDisposable],construct:function(){var bc=qx.Bootstrap.bind(this.__sF,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__sp=qx.event.GlobalError.observeMethod(bc);}
else {this.__sp=bc;}
;this.__sq=qx.Bootstrap.bind(this.__sD,this);this.__sr=qx.Bootstrap.bind(this.__sE,this);this.__sg=qx.Bootstrap.bind(this.__sJ,this);this.__sC();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__ss=qx.Bootstrap.bind(this.__sM,this);window.attachEvent(j,this.__ss);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":H,"error":H,"loadend":H,"timeout":H,"abort":H,"load":H,"progress":H},members:{readyState:0,responseText:B,response:null,responseXML:null,status:0,statusText:B,responseType:B,timeout:0,progress:null,open:function(bh,bd,be,bg,bf){this.__sO();if(typeof bd===X){throw new Error(V);}
else if(typeof bh===X){bh=k;}
;this.__sj=false;this.__st=false;this.__su=false;this.__sv=bd;if(typeof be==X){be=true;}
;this.__sw=be;this.status=0;this.statusText=this.responseText=B;this.responseXML=null;this.response=null;if(!this.__sN()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__sC();}
;this.__sy.onreadystatechange=this.__sp;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,o+bh+x+bd+Y+be);}
;this.__sy.open(bh,bd,be,bg,bf);}
catch(bi){if(!qx.util.Request.isCrossDomain(bd)){throw bi;}
;if(!this.__sw){this.__sx=bi;}
;if(this.__sw){if(window.XDomainRequest){this.readyState=4;this.__sy=new XDomainRequest();this.__sy.onerror=qx.Bootstrap.bind(function(){this._emit(C);this._emit(p);this._emit(q);}
,this);if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+bh+x+bd+Y+be);}
;this.__sy.open(bh,bd,be,bg,bf);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__sA){return;}
;this.readyState=4;this._emit(C);this._emit(p);this._emit(q);}
,this));}
;}
;if(qx.core.Environment.get(N)===M&&qx.core.Environment.get(z)<9&&this.__sy.readyState>0){this.__sy.setRequestHeader(h,l);}
;if(qx.core.Environment.get(N)===K&&parseInt(qx.core.Environment.get(i),10)<2&&!this.__sw){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(C);}
;}
,setRequestHeader:function(bj,bk){this.__sO();if(bj==L||bj==h||bj==f||bj==S){this.__su=true;}
;this.__sy.setRequestHeader(bj,bk);return this;}
,send:function(bm){this.__sO();if(!this.__sw&&this.__sx){throw this.__sx;}
;if(qx.core.Environment.get(N)===G&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__sz=window.setTimeout(this.__sg,this.timeout);}
;bm=typeof bm==X?null:bm;var bl=qx.Bootstrap.getClass(bm);bm=(bm!==null&&this.__sB.indexOf(bl)===-1)?bm.toString():bm;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,Q);}
;if(this.__sw){this.__sy.responseType=this.responseType;}
;this.__sy.send(bm);}
catch(bo){if(!this.__sw){throw bo;}
;if(this._getProtocol()===P){this.readyState=2;this.__sG();var bn=this;window.setTimeout(function(){if(bn.__sA){return;}
;bn.readyState=3;bn.__sG();bn.readyState=4;bn.__sG();}
);}
;}
;if(qx.core.Environment.get(N)===K&&!this.__sw){this.__sF();}
;this.__st=true;return this;}
,abort:function(){this.__sO();this.__sj=true;this.__sy.abort();if(this.__sy&&this.readyState!==qx.bom.request.Xhr.DONE){this.readyState=this.__sy.readyState;}
;return this;}
...
,getResponseHeader:function(br){this.__sO();if(qx.core.Environment.get(z)===9&&this.__sy.aborted){return B;}
;return this.__sy.getResponseHeader(br);}
,getAllResponseHeaders:function(){this.__sO();if(qx.core.Environment.get(z)===9&&this.__sy.aborted){return B;}
;return this.__sy.getAllResponseHeaders();}
,overrideMimeType:function(bs){this.__sO();if(this.__sy.overrideMimeType){this.__sy.overrideMimeType(bs);}
else {throw new Error(bb);}
;return this;}
,getRequest:function(){return this.__sy;}
,dispose:function(){if(this.__sA){return false;}
;window.clearTimeout(this.__sz);if(window.detachEvent){window.detachEvent(j,this.__ss);}
;try{this.__sy.onreadystatechange;}
catch(bu){return false;}
;var bt=function(){}
;this.__sy.onreadystatechange=bt;this.__sy.onload=bt;this.__sy.onerror=bt;this.__sy.onprogress=bt;this.abort();this.__sy=null;this.__sA=true;return true;}
,isDisposed:function(){return !!this.__sA;}
...
,_getProtocol:function(){var bw=this.__sv;var bx=/^(\w+:)\/\//;if(bw!==null&&bw.match){var by=bw.match(bx);if(by&&by[1]){return by[1];}
;}
;return window.location.protocol;}
,__sy:null,__sw:null,__sp:null,__sq:null,__sr:null,__ss:null,__sg:null,__st:null,__sv:null,__sj:null,__dj:null,__sA:null,__sz:null,__sx:null,__su:null,__sB:null,__sC:function(){this.__sy=this._createNativeXhr();this.__sy.onreadystatechange=this.__sp;if(qx.Bootstrap.getClass(this.__sy.onabort)!==n){this.__sy.onabort=this.__sq;}
;if(qx.Bootstrap.getClass(this.__sy.onprogress)!==n){this.__sy.onprogress=this.__sr;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__sA=this.__st=this.__sj=false;this.__sB=[W,r,s,y,R];}
,__sD:function(){if(!this.__sj){this.abort();}
;}
,__sE:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(t);}
,__sF:function(){var bz=this.__sy,bA=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,v+bz.readyState);}
;if(this.readyState==bz.readyState){return;}
;this.readyState=bz.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sj&&!this.__st){return;}
;if(!this.__sw&&(bz.readyState==2||bz.readyState==3)){return;}
...
;if(bA){this.__sK();this.__sL();}
;}
;this.__sG();if(this.readyState==qx.bom.request.Xhr.DONE){if(bz){bz.onreadystatechange=function(){}
;}
;}
;}
,__sG:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__sz);}
;this._emit(C);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sH();}
;}
,__sH:function(){if(this.__dj){this._emit(J);if(qx.core.Environment.get(N)===G){this._emit(p);}
;this.__dj=false;}
else {if(this.__sj){this._emit(w);}
else {if(this.__sI()){this._emit(p);}
else {this._emit(u);}
;}
;}
;this._emit(q);}
,__sI:function(){var bC;if(this._getProtocol()===P){bC=!this.responseText;}
else {bC=!this.statusText&&this.status!==204;}
;return bC;}
,__sJ:function(){var bD=this.__sy;this.readyState=qx.bom.request.Xhr.DONE;this.__dj=true;bD.aborted=true;bD.abort();this.responseText=B;this.responseXML=null;this.__sG();}
,__sK:function(){var bE=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===P&&this.status===0&&bE){if(!this.__sI()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(N)===G){if(bE&&this.__su&&!this.__sj&&this.status===0){this.status=304;}
;}
;}
,__sL:function(){if(qx.core.Environment.get(N)==M&&(this.getResponseHeader(T)||B).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bF=new window.ActiveXObject(O);bF.async=false;bF.validateOnParse=false;bF.loadXML(this.responseText);this.responseXML=bF;}
;}
,__sM:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sN:function(){var name=qx.core.Environment.get(N);var bG=qx.core.Environment.get(F);return !(name==M&&bG<9||name==K&&bG<3.5);}
,__sO:function(){if(this.__sA){throw new Error(E);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__sP:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__sP=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__sP=i;}
,_getParser:function(k){var j=this.__sP,m=c,l=c;if(j){return j;}
