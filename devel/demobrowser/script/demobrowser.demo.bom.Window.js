...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.3d5ad291400a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return C;}
,__ub:function(K,O){var M;var J;var N=[];if(O&&this.__ua()){for(var L in K){if(qx.bom.Window.__tX[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__tX[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__tY[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__uc:function(){if(this.isClosed(this.__tW)){this.getBlocker().unblock();this.__dE.stop();}
;}
...
,members:{__tk:null,__rb:null,__tl:null,__tm:false,__tn:10000,__to:0,__tp:f,block:function(r){if(!this.__tm){qx.event.Registration.addListener(window,a,this.__ng,this);this.__tl=r;var q=this.__ts();this.__tt(q);this.__tm=true;}
;}
,unblock:function(){if(this.__tm){this.__tu();qx.event.Registration.removeListener(window,a,this.__ng,this);this.__tm=false;}
;}
...
,__eP:function(){this.__tq();if((qx.core.Environment.get(j)==b)){this.__tr();}
;}
,__tq:function(){this.__rb=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__rb,{display:d,opacity:this.__to,backgroundColor:this.__tp});this.setBlockerZIndex(this.__tn);}
...
;return v;}
,__tt:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__rb,w);qx.dom.Element.insertEnd(this.__rb,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__tk,w);qx.dom.Element.insertEnd(this.__tk,document.body);}
;}
,__tu:function(){qx.dom.Element.remove(this.__rb);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__tk);}
;}
,__ng:function(e){if(this.__tw()){this.__tv({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__tv(y);}
,this,0);}
;}
,__tv:function(z){qx.bom.element.Style.setStyles(this.__rb,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__tk,z);}
;}
