...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.ad630ec8d39b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__Ah:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__Ah=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__Ah[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__Ah[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__Ah[0],h,A,true,false);}
,this);}
},destruct:function(){this.__Ah=null;}
});}
)();
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__mV:null,__ux:null,__ey:null,__uy:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__uz:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__uA:function(){return window.showModalDialog!=null;}
,open:function(z,name,I,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var H=this.__uB(I,E&&A);if(E){if(this.__uA()&&A){C=window.showModalDialog(z,[window.self],H);}
else {this.getBlocker().block();if(this.__ey==null){this.__ey=new qx.event.Timer(500);this.__ey.addListener(f,this.__uC,this);}
;this.__ux=window.open(z,name,H);this.__ey.restart();C=this.__ux;}
;}
else {C=window.open(z,name,H);}
;if(C&&D&&(D instanceof Function)){var F=self||C;var B=qx.lang.Function.bind(D,F);var G=function(){B();qx.bom.Event.removeNativeListener(C,t,G);}
;qx.bom.Event.addNativeListener(C,t,G);}
;return C;}
,__uB:function(L,P){var N;var K;var O=[];if(P&&this.__uA()){for(var M in L){if(qx.bom.Window.__uy[M]){var J=n;if(M!=u&&M!=h){J=b;}
;K=qx.bom.Window.__uy[M]+i+L[M]+J;O.push(K);}
else {qx.log.Logger.warn(o+M+s);}
;}
;N=O.join(w);}
else {for(var M in L){if(qx.bom.Window.__uz[M]){if(qx.lang.Type.isBoolean(L[M])){K=M+v+(L[M]?j:a);}
else {K=M+v+L[M];}
;O.push(K);}
else {qx.log.Logger.warn(o+M+e);}
;}
;N=O.join(y);}
;return N;}
,__uC:function(){if(this.isClosed(this.__ux)){this.getBlocker().unblock();this.__ey.stop();}
;}
,getBlocker:function(){if(this.__mV==null){this.__mV=new qx.bom.Blocker;}
;return this.__mV;}
,close:function(Q){if(Q){return Q.close();}
;}
,isClosed:function(R){var closed=true;if(R){try{closed=R.closed;}
catch(S){}
;}
;return closed;}
,moveTo:function(T,top,U){if(!qx.bom.Window.isClosed(T)){try{T.moveTo(U,top);}
catch(V){qx.log.Logger.error(m,V);}
;}
;}
,resizeTo:function(W,X,Y){if(!qx.bom.Window.isClosed(W)){try{W.resizeTo(X,Y);}
catch(ba){qx.log.Logger.error(d,ba);}
;}
;}
}});}
)();
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__fj();}
,members:{__tK:null,__rD:null,__tL:null,__tM:false,__tN:10000,__tO:0,__tP:f,block:function(r){if(!this.__tM){qx.event.Registration.addListener(window,a,this.__nI,this);this.__tL=r;var q=this.__tS();this.__tT(q);this.__tM=true;}
;}
,unblock:function(){if(this.__tM){this.__tU();qx.event.Registration.removeListener(window,a,this.__nI,this);this.__tM=false;}
;}
,isBlocked:function(){return this.__tM;}
,getBlockerElement:function(){return this.__rD;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__rD,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__rD,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__rD,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__rD);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__rD,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__rD,h);}
,__fj:function(){this.__tQ();if((qx.core.Environment.get(j)==b)){this.__tR();}
;}
,__tQ:function(){this.__rD=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__rD,{display:d,opacity:this.__tO,backgroundColor:this.__tP});this.setBlockerZIndex(this.__tN);}
,__tR:function(){this.__tK=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__tK,l,false);qx.bom.element.Attribute.set(this.__tK,i,n);qx.bom.element.Style.setStyles(this.__tK,{display:d,opacity:this.__tO});}
,__tS:function(){var v={position:p};if(this.__tW()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__tL)+g;v.height=qx.bom.element.Dimension.getHeight(this.__tL)+g;v.left=qx.bom.element.Location.getLeft(this.__tL)+g;v.top=qx.bom.element.Location.getTop(this.__tL)+g;}
;return v;}
,__tT:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__rD,w);qx.dom.Element.insertEnd(this.__rD,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__tK,w);qx.dom.Element.insertEnd(this.__tK,document.body);}
;}
,__tU:function(){qx.dom.Element.remove(this.__rD);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__tK);}
;}
,__nI:function(e){if(this.__tW()){this.__tV({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__tV(y);}
,this,0);}
;}
,__tV:function(z){qx.bom.element.Style.setStyles(this.__rD,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__tK,z);}
;}
,__tW:function(){return (this.__tL==null||qx.dom.Node.isWindow(this.__tL)||qx.dom.Node.isDocument(this.__tL));}
}});}
)();
