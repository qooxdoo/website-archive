...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.d6759498c09a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__Au:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__Au=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__Au[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__Au[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__Au[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__nk:null,__uM:null,__eI:null,__uN:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__uO:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__uP:function(){return window.showModalDialog!=null;}
,open:function(z,name,I,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var H=this.__uQ(I,E&&A);if(E){if(this.__uP()&&A){C=window.showModalDialog(z,[window.self],H);}
else {this.getBlocker().block();if(this.__eI==null){this.__eI=new qx.event.Timer(500);this.__eI.addListener(f,this.__uR,this);}
;this.__uM=window.open(z,name,H);this.__eI.restart();C=this.__uM;}
;}
...
;return C;}
,__uQ:function(L,P){var N;var K;var O=[];if(P&&this.__uP()){for(var M in L){if(qx.bom.Window.__uN[M]){var J=n;if(M!=u&&M!=h){J=b;}
;K=qx.bom.Window.__uN[M]+i+L[M]+J;O.push(K);}
else {qx.log.Logger.warn(o+M+s);}
;}
;N=O.join(w);}
else {for(var M in L){if(qx.bom.Window.__uO[M]){if(qx.lang.Type.isBoolean(L[M])){K=M+v+(L[M]?j:a);}
else {K=M+v+L[M];}
;O.push(K);}
...
;N=O.join(y);}
;return N;}
,__uR:function(){if(this.isClosed(this.__uM)){this.getBlocker().unblock();this.__eI.stop();}
;}
,getBlocker:function(){if(this.__nk==null){this.__nk=new qx.bom.Blocker;}
;return this.__nk;}
...
,members:{__ua:null,__rR:null,__ub:null,__uc:false,__ud:10000,__ue:0,__uf:f,block:function(r){if(!this.__uc){qx.event.Registration.addListener(window,a,this.__nW,this);this.__ub=r;var q=this.__ui();this.__uj(q);this.__uc=true;}
;}
,unblock:function(){if(this.__uc){this.__uk();qx.event.Registration.removeListener(window,a,this.__nW,this);this.__uc=false;}
;}
,isBlocked:function(){return this.__uc;}
,getBlockerElement:function(){return this.__rR;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__rR,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__rR,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__rR,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__rR);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__rR,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__rR,h);}
,__ft:function(){this.__ug();if((qx.core.Environment.get(j)==b)){this.__uh();}
;}
,__ug:function(){this.__rR=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__rR,{display:d,opacity:this.__ue,backgroundColor:this.__uf});this.setBlockerZIndex(this.__ud);}
,__uh:function(){this.__ua=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__ua,l,false);qx.bom.element.Attribute.set(this.__ua,i,n);qx.bom.element.Style.setStyles(this.__ua,{display:d,opacity:this.__ue});}
,__ui:function(){var v={position:p};if(this.__um()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__ub)+g;v.height=qx.bom.element.Dimension.getHeight(this.__ub)+g;v.left=qx.bom.element.Location.getLeft(this.__ub)+g;v.top=qx.bom.element.Location.getTop(this.__ub)+g;}
;return v;}
,__uj:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__rR,w);qx.dom.Element.insertEnd(this.__rR,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__ua,w);qx.dom.Element.insertEnd(this.__ua,document.body);}
;}
,__uk:function(){qx.dom.Element.remove(this.__rR);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__ua);}
;}
,__nW:function(e){if(this.__um()){this.__ul({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__ul(y);}
,this,0);}
;}
,__ul:function(z){qx.bom.element.Style.setStyles(this.__rR,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__ua,z);}
;}
,__um:function(){return (this.__ub==null||qx.dom.Node.isWindow(this.__ub)||qx.dom.Node.isDocument(this.__ub));}
}});}
)();
