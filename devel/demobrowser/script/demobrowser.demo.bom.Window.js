...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.6198dbc003c8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__zX:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__zX=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__zX[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__zX[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__zX[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__mK:null,__un:null,__ew:null,__uo:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__up:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__uq:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__ur(H,E&&A);if(E){if(this.__uq()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__ew==null){this.__ew=new qx.event.Timer(500);this.__ew.addListener(f,this.__us,this);}
;this.__un=window.open(z,name,G);this.__ew.restart();C=this.__un;}
;}
...
;return C;}
,__ur:function(K,O){var M;var J;var N=[];if(O&&this.__uq()){for(var L in K){if(qx.bom.Window.__uo[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__uo[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__up[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__us:function(){if(this.isClosed(this.__un)){this.getBlocker().unblock();this.__ew.stop();}
;}
,getBlocker:function(){if(this.__mK==null){this.__mK=new qx.bom.Blocker;}
;return this.__mK;}
...
,members:{__tA:null,__rs:null,__tB:null,__tC:false,__tD:10000,__tE:0,__tF:f,block:function(r){if(!this.__tC){qx.event.Registration.addListener(window,a,this.__nx,this);this.__tB=r;var q=this.__tI();this.__tJ(q);this.__tC=true;}
;}
,unblock:function(){if(this.__tC){this.__tK();qx.event.Registration.removeListener(window,a,this.__nx,this);this.__tC=false;}
;}
,isBlocked:function(){return this.__tC;}
...
,__fh:function(){this.__tG();if((qx.core.Environment.get(j)==b)){this.__tH();}
;}
,__tG:function(){this.__rs=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__rs,{display:d,opacity:this.__tE,backgroundColor:this.__tF});this.setBlockerZIndex(this.__tD);}
,__tH:function(){this.__tA=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__tA,l,false);qx.bom.element.Attribute.set(this.__tA,i,n);qx.bom.element.Style.setStyles(this.__tA,{display:d,opacity:this.__tE});}
,__tI:function(){var v={position:p};if(this.__tM()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__tB)+g;v.height=qx.bom.element.Dimension.getHeight(this.__tB)+g;v.left=qx.bom.element.Location.getLeft(this.__tB)+g;v.top=qx.bom.element.Location.getTop(this.__tB)+g;}
;return v;}
,__tJ:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__rs,w);qx.dom.Element.insertEnd(this.__rs,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__tA,w);qx.dom.Element.insertEnd(this.__tA,document.body);}
;}
,__tK:function(){qx.dom.Element.remove(this.__rs);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__tA);}
;}
,__nx:function(e){if(this.__tM()){this.__tL({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__tL(y);}
,this,0);}
;}
,__tL:function(z){qx.bom.element.Style.setStyles(this.__rs,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__tA,z);}
;}
,__tM:function(){return (this.__tB==null||qx.dom.Node.isWindow(this.__tB)||qx.dom.Node.isDocument(this.__tB));}
}});}
)();
