...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.da590e26c1c4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__mq:null,__tR:null,__dC:null,__tS:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__tT:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__tU:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__tV(H,E&&A);if(E){if(this.__tU()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__dC==null){this.__dC=new qx.event.Timer(500);this.__dC.addListener(f,this.__tW,this);}
;this.__tR=window.open(z,name,G);this.__dC.restart();C=this.__tR;}
;}
...
;return C;}
,__tV:function(K,O){var M;var J;var N=[];if(O&&this.__tU()){for(var L in K){if(qx.bom.Window.__tS[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__tS[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__tT[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__tW:function(){if(this.isClosed(this.__tR)){this.getBlocker().unblock();this.__dC.stop();}
;}
...
,members:{__tf:null,__qV:null,__tg:null,__th:false,__ti:10000,__tj:0,__tk:f,block:function(r){if(!this.__th){qx.event.Registration.addListener(window,a,this.__nd,this);this.__tg=r;var q=this.__tn();this.__to(q);this.__th=true;}
;}
,unblock:function(){if(this.__th){this.__tp();qx.event.Registration.removeListener(window,a,this.__nd,this);this.__th=false;}
;}
,isBlocked:function(){return this.__th;}
,getBlockerElement:function(){return this.__qV;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__qV,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__qV,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__qV,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__qV);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__qV,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__qV,h);}
,__eN:function(){this.__tl();if((qx.core.Environment.get(j)==b)){this.__tm();}
;}
,__tl:function(){this.__qV=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__qV,{display:d,opacity:this.__tj,backgroundColor:this.__tk});this.setBlockerZIndex(this.__ti);}
,__tm:function(){this.__tf=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__tf,l,false);qx.bom.element.Attribute.set(this.__tf,i,n);qx.bom.element.Style.setStyles(this.__tf,{display:d,opacity:this.__tj});}
,__tn:function(){var v={position:p};if(this.__tr()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__tg)+g;v.height=qx.bom.element.Dimension.getHeight(this.__tg)+g;v.left=qx.bom.element.Location.getLeft(this.__tg)+g;v.top=qx.bom.element.Location.getTop(this.__tg)+g;}
;return v;}
,__to:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__qV,w);qx.dom.Element.insertEnd(this.__qV,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__tf,w);qx.dom.Element.insertEnd(this.__tf,document.body);}
;}
,__tp:function(){qx.dom.Element.remove(this.__qV);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__tf);}
;}
,__nd:function(e){if(this.__tr()){this.__tq({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__tq(y);}
,this,0);}
;}
,__tq:function(z){qx.bom.element.Style.setStyles(this.__qV,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__tf,z);}
;}
,__tr:function(){return (this.__tg==null||qx.dom.Node.isWindow(this.__tg)||qx.dom.Node.isDocument(this.__tg));}
}});}
)();
