...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.60c3fdf62439.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,getBlocker:function(){if(this.__mS==null){this.__mS=new qx.bom.Blocker;}
;return this.__mS;}
...
,members:{__tI:null,__rA:null,__tJ:null,__tK:false,__tL:10000,__tM:0,__tN:f,block:function(r){if(!this.__tK){qx.event.Registration.addListener(window,a,this.__nF,this);this.__tJ=r;var q=this.__tQ();this.__tR(q);this.__tK=true;}
;}
,unblock:function(){if(this.__tK){this.__tS();qx.event.Registration.removeListener(window,a,this.__nF,this);this.__tK=false;}
;}
,isBlocked:function(){return this.__tK;}
,getBlockerElement:function(){return this.__rA;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__rA,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__rA,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__rA,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__rA);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__rA,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__rA,h);}
,__fh:function(){this.__tO();if((qx.core.Environment.get(j)==b)){this.__tP();}
;}
,__tO:function(){this.__rA=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__rA,{display:d,opacity:this.__tM,backgroundColor:this.__tN});this.setBlockerZIndex(this.__tL);}
...
;return v;}
,__tR:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__rA,w);qx.dom.Element.insertEnd(this.__rA,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__tI,w);qx.dom.Element.insertEnd(this.__tI,document.body);}
;}
,__tS:function(){qx.dom.Element.remove(this.__rA);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__tI);}
;}
,__nF:function(e){if(this.__tU()){this.__tT({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__tT(y);}
,this,0);}
;}
,__tT:function(z){qx.bom.element.Style.setStyles(this.__rA,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__tI,z);}
;}
