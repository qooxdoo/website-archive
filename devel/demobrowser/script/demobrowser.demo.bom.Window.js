...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.3532de6a0bec.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__mp:null,__tQ:null,__dC:null,__tR:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__tS:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__tT:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__tU(H,E&&A);if(E){if(this.__tT()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__dC==null){this.__dC=new qx.event.Timer(500);this.__dC.addListener(f,this.__tV,this);}
;this.__tQ=window.open(z,name,G);this.__dC.restart();C=this.__tQ;}
;}
...
;return C;}
,__tU:function(K,O){var M;var J;var N=[];if(O&&this.__tT()){for(var L in K){if(qx.bom.Window.__tR[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__tR[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__tS[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__tV:function(){if(this.isClosed(this.__tQ)){this.getBlocker().unblock();this.__dC.stop();}
;}
,getBlocker:function(){if(this.__mp==null){this.__mp=new qx.bom.Blocker;}
;return this.__mp;}
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__eN();}
,members:{__te:null,__qU:null,__tf:null,__tg:false,__th:10000,__ti:0,__tj:f,block:function(r){if(!this.__tg){this.__tf=r;var q=this.__tm();this.__tn(q);this.__tg=true;}
;}
,unblock:function(){if(this.__tg){this.__to();this.__tg=false;}
;}
,isBlocked:function(){return this.__tg;}
,getBlockerElement:function(){return this.__qU;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__qU,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__qU,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__qU,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__qU);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__qU,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__qU,h);}
,__eN:function(){this.__tk();if((qx.core.Environment.get(j)==b)){this.__tl();}
;qx.event.Registration.addListener(window,a,this.__nc,this);}
,__tk:function(){this.__qU=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__qU,{display:d,opacity:this.__ti,backgroundColor:this.__tj});this.setBlockerZIndex(this.__th);}
,__tl:function(){this.__te=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__te,l,false);qx.bom.element.Attribute.set(this.__te,i,n);qx.bom.element.Style.setStyles(this.__te,{display:d,opacity:this.__ti});}
,__tm:function(){var v={position:p};if(this.__tq()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__tf)+g;v.height=qx.bom.element.Dimension.getHeight(this.__tf)+g;v.left=qx.bom.element.Location.getLeft(this.__tf)+g;v.top=qx.bom.element.Location.getTop(this.__tf)+g;}
;return v;}
,__tn:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__qU,w);qx.dom.Element.insertEnd(this.__qU,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__te,w);qx.dom.Element.insertEnd(this.__te,document.body);}
;}
,__to:function(){qx.dom.Element.remove(this.__qU);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__te);}
;}
,__nc:function(e){if(this.__tq()){this.__tp({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__tp(y);}
,this,0);}
;}
,__tp:function(z){qx.bom.element.Style.setStyles(this.__qU,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__te,z);}
;}
,__tq:function(){return (this.__tf==null||qx.dom.Node.isWindow(this.__tf)||qx.dom.Node.isDocument(this.__tf));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__nc,this);this.__te=this.__qU=this.__tf=null;}
});}
)();
