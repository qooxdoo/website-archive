...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.dd20431bd95e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
else {this.getBlocker().block();if(this.__dE==null){this.__dE=new qx.event.Timer(500);this.__dE.addListener(f,this.__ue,this);}
;this.__tY=window.open(z,name,G);this.__dE.restart();C=this.__tY;}
;}
...
;M=N.join(y);}
;return M;}
,__ue:function(){if(this.isClosed(this.__tY)){this.getBlocker().unblock();this.__dE.stop();}
;}
