...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.e4f6cd57e685.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
else {this.getBlocker().block();if(this.__eg==null){this.__eg=new qx.event.Timer(500);this.__eg.addListener(f,this.__uO,this);}
;this.__uJ=window.open(z,name,H);this.__eg.restart();C=this.__uJ;}
;}
...
;N=O.join(y);}
;return N;}
,__uO:function(){if(this.isClosed(this.__uJ)){this.getBlocker().unblock();this.__eg.stop();}
;}
