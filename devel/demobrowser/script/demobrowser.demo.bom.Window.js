...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.ded35be894ba.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="Open Native Modal Window",c="demobrowser.demo.bom.Window",d="Modal Window closed?",f="http://sourceforge.net",g="window1",h="window3",i="http://slashdot.org",j="Window closed?",k="http://qooxdoo.org",l="demobrowser/demo/html/ModalWindow.html",m="#eee",n="Open Faked Native Modal Window",o="window2",p="tap",q="button";qx.Class.define(c,{extend:qx.application.Native,members:{__Ar:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__Ar=[k,f,i,r.toUri(l)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,p,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__Ar[0],g,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,b);document.body.appendChild(s);qx.event.Registration.addListener(s,p,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__Ar[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,p,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(m);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__Ar[0],h,A,true,false);}
,this);}
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__nh:null,__uJ:null,__eF:null,__uK:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__uL:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__uM:function(){return window.showModalDialog!=null;}
,open:function(z,name,I,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var H=this.__uN(I,E&&A);if(E){if(this.__uM()&&A){C=window.showModalDialog(z,[window.self],H);}
else {this.getBlocker().block();if(this.__eF==null){this.__eF=new qx.event.Timer(500);this.__eF.addListener(f,this.__uO,this);}
;this.__uJ=window.open(z,name,H);this.__eF.restart();C=this.__uJ;}
;}
...
;return C;}
,__uN:function(L,P){var N;var K;var O=[];if(P&&this.__uM()){for(var M in L){if(qx.bom.Window.__uK[M]){var J=n;if(M!=u&&M!=h){J=b;}
;K=qx.bom.Window.__uK[M]+i+L[M]+J;O.push(K);}
else {qx.log.Logger.warn(o+M+s);}
;}
;N=O.join(w);}
else {for(var M in L){if(qx.bom.Window.__uL[M]){if(qx.lang.Type.isBoolean(L[M])){K=M+v+(L[M]?j:a);}
else {K=M+v+L[M];}
;O.push(K);}
...
;N=O.join(y);}
;return N;}
,__uO:function(){if(this.isClosed(this.__uJ)){this.getBlocker().unblock();this.__eF.stop();}
;}
...
,members:{__tW:null,__rO:null,__tX:null,__tY:false,__ua:10000,__ub:0,__uc:f,block:function(r){if(!this.__tY){qx.event.Registration.addListener(window,a,this.__nT,this);this.__tX=r;var q=this.__uf();this.__ug(q);this.__tY=true;}
;}
,unblock:function(){if(this.__tY){this.__uh();qx.event.Registration.removeListener(window,a,this.__nT,this);this.__tY=false;}
;}
,isBlocked:function(){return this.__tY;}
,getBlockerElement:function(){return this.__rO;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__rO,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__rO,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__rO,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__rO);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__rO,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__rO,h);}
,__fq:function(){this.__ud();if((qx.core.Environment.get(j)==b)){this.__ue();}
;}
,__ud:function(){this.__rO=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__rO,{display:d,opacity:this.__ub,backgroundColor:this.__uc});this.setBlockerZIndex(this.__ua);}
,__ue:function(){this.__tW=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__tW,l,false);qx.bom.element.Attribute.set(this.__tW,i,n);qx.bom.element.Style.setStyles(this.__tW,{display:d,opacity:this.__ub});}
,__uf:function(){var v={position:p};if(this.__uj()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__tX)+g;v.height=qx.bom.element.Dimension.getHeight(this.__tX)+g;v.left=qx.bom.element.Location.getLeft(this.__tX)+g;v.top=qx.bom.element.Location.getTop(this.__tX)+g;}
;return v;}
,__ug:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__rO,w);qx.dom.Element.insertEnd(this.__rO,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__tW,w);qx.dom.Element.insertEnd(this.__tW,document.body);}
;}
,__uh:function(){qx.dom.Element.remove(this.__rO);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__tW);}
;}
,__nT:function(e){if(this.__uj()){this.__ui({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__ui(y);}
,this,0);}
;}
,__ui:function(z){qx.bom.element.Style.setStyles(this.__rO,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__tW,z);}
;}
,__uj:function(){return (this.__tX==null||qx.dom.Node.isWindow(this.__tX)||qx.dom.Node.isDocument(this.__tX));}
}});}
)();
