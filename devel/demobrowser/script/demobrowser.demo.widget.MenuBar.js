...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.MenuBar.f89772e06797.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__pI(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__pF.length>0){do {var Q=this.__pF[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__pF.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__pH(Q);G+=I;if(E&&this.__pF.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__pF.length>0);}
;}
,__pH:function(R){R.setVisibility(o);this.__pF.shift();this.fireDataEvent(m,R);}
,__pI:function(S){if(!S){return;}
;this.__pF.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__pG.length-1;i>=0;i-- ){var T=this.__pG[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__pG[W]!=undefined){throw new Error(v);}
;this.__pG[W]=X;}
...
;for(var i=0;i<this.__pF.length;i++ ){this.__pF[i].setVisibility(o);}
;this.__pF=[];}
;}
...
;bf.setVisibility(y);}
;}
,__pJ:false,_setAllowMenuOpenHover:function(bg){this.__pJ=bg;}
,_isAllowMenuOpenHover:function(){return this.__pJ;}
...
(function(){var a="blur",b="Enter",c="Escape",d="Space",f="keydown",g="Left",h="__pP",j="Down",k="Up",l="singleton",m="qx.debug",n="interval",o="roll",p="event.touch",q="__pO",r="Object is no menu: ",s="pointerdown",t="qx.ui.menu.Manager",u="keyup",v="keypress",w="contextmenu",x="__lH",y="Right";qx.Class.define(t,{type:l,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__lH=[];var z=document.body;var A=qx.event.Registration;A.addListener(window.document.documentElement,s,this._onPointerDown,this,true);A.addListener(z,o,this._onRoll,this,true);A.addListener(z,f,this._onKeyUpDown,this,true);A.addListener(z,u,this._onKeyUpDown,this,true);A.addListener(z,v,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__pO=new qx.event.Timer();this.__pO.addListener(n,this._onOpenInterval,this);this.__pP=new qx.event.Timer();this.__pP.addListener(n,this._onCloseInterval,this);}
,members:{__pQ:null,__pR:null,__pO:null,__pP:null,__lH:null,_getChild:function(B,D,C,G){var F=B.getChildren();var length=F.length;var E;for(var i=D;i<length&&i>=0;i+=C){E=F[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
...
,scheduleOpen:function(R){this.cancelClose(R);if(R.isVisible()){if(this.__pQ){this.cancelOpen(this.__pQ);}
;}
else if(this.__pQ!=R){this.__pQ=R;this.__pO.restartWith(R.getOpenInterval());}
;}
,scheduleClose:function(S){this.cancelOpen(S);if(!S.isVisible()){if(this.__pR){this.cancelClose(this.__pR);}
;}
else if(this.__pR!=S){this.__pR=S;this.__pP.restartWith(S.getCloseInterval());}
;}
,cancelOpen:function(T){if(this.__pQ==T){this.__pO.stop();this.__pQ=null;}
;}
,cancelClose:function(U){if(this.__pR==U){this.__pP.stop();this.__pR=null;}
;}
,_onOpenInterval:function(e){this.__pO.stop();this.__pQ.open();this.__pQ=null;}
,_onCloseInterval:function(e){this.__pP.stop();this.__pR.exclude();this.__pR=null;}
,preventContextMenuOnce:function(){qx.event.Registration.addListener(document.body,w,this.__pS,this,true);}
,__pS:function(e){var V=e.getTarget();V=qx.ui.core.Widget.getWidgetByElement(V,true);if(this._isInMenu(V)){e.stopPropagation();e.preventDefault();}
;qx.event.Registration.removeListener(document.body,w,this.__pS,this,true);}
...
;}
,__pT:{"Enter":1,"Space":1},__pU:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var X=this.getActiveMenu();if(!X){return;}
;var Y=e.getKeyIdentifier();if(this.__pU[Y]||(this.__pT[Y]&&X.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var bc=this.getActiveMenu();if(!bc){return;}
;var ba=e.getKeyIdentifier();var be=this.__pU[ba];var bb=this.__pT[ba];if(be){switch(ba){case k:this._onKeyPressUp(bc);break;case j:this._onKeyPressDown(bc);break;case g:this._onKeyPressLeft(bc);break;case y:this._onKeyPressRight(bc);break;case c:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
...
;this.__pY();}
,__pY:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__qa:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(n,this.__qa,this);return;}
...
;this.__pX=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__pX){this.__pX.call(this);delete this.__pX;}
;}
...
;this.__qa();}
;}
,_onPointerOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__pW=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__pW){bt.cancelOpen(this.__pW);this.__pW=null;}
;}
;}
...
;if(this.__pW){bw.cancelOpen(this.__pW);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__qb:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__qb=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__qb||null;}
...
;var x=this.__qc(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__qc:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
,__qi:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
