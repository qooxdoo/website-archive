...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.426121d3dff7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._getIframeElement().addListener(h,this.__tg,this);}
...
,__tg:function(e){var r=e.getData();if(r){this.setSource(r);}
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbarY:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__Gn:null,__Go:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__Go){this._stopIframeObserver();}
;var F=qx.event.Idle.getInstance();this.__Go=F.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__Gn=null;if(!this.__Go){return;}
;var G=qx.event.Idle.getInstance();G.removeListenerById(this.__Go);}
,_onIframeObserverInterval:function(){var H=this._getIframeSize();if(!H){this._disableScollbars();return;}
;if(this.__Gn&&H.width==this.__Gn.width&&H.height==this.__Gn.height){return;}
;this.__Gn=H;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var K=this.__Gn;var N=this.getChildControl(j).getBounds();var L=this.getChildControl(j).getInnerSize();if(!K||!L||!L){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__Gn=null;}
});}
)();
...
(function(){var a="no",b="Boolean",c="px",d="event.help",f="gecko",g="__ti",h="auto",i="_applyScrollbar",j="Unable to set 'nativeHelp' property, possibly due to security restrictions",k="qx.debug",l="DOMNodeInserted",m="load",n="_applyNativeHelp",o="yes",p="scrolling",q="/",r="help",s="pointerup",t="appear",u="pointerdown",v="engine.name",w="block",x="qx.ui.embed.Iframe",y="losecapture",z="contextmenu",A="none",B="iframe",C="display";qx.Class.define(x,{extend:qx.ui.embed.AbstractIframe,construct:function(D){if(D!=null){this.__th=D;}
;qx.ui.embed.AbstractIframe.call(this,D);qx.event.Registration.addListener(document.body,u,this.block,this,true);qx.event.Registration.addListener(document.body,s,this.release,this,true);qx.event.Registration.addListener(document.body,y,this.release,this,true);this.__ti=this._createBlockerElement();if((qx.core.Environment.get(v)==f)){this.addListenerOnce(t,function(e){var E=this.getContentElement().getDomElement();qx.bom.Event.addNativeListener(E,l,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:B},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:b,init:false,apply:n},scrollbar:{check:[h,a,o],nullable:true,themeable:true,apply:i}},members:{__th:null,__ti:null,renderLayout:function(J,top,H,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,J,top,H,F);var I=c;var G=this.getInsets();this.__ti.setStyles({"left":(J+G.left)+I,"top":(top+G.top)+I,"width":(H-G.left-G.right)+I,"height":(F-G.top-G.bottom)+I});}
,_createContentElement:function(){var K=new qx.html.Iframe(this.__th);K.addListener(m,this._onIframeLoad,this);return K;}
...
,block:function(){this.__ti.setStyle(C,w);}
,release:function(){this.__ti.setStyle(C,A);}
...
,setLayoutParent:function(parent){qx.ui.embed.AbstractIframe.prototype.setLayoutParent.call(this,parent);if(parent){this.getLayoutParent().getContentElement().add(this.__ti);}
;}
},destruct:function(){if(this.getLayoutParent()&&this.__ti.getParent()){this.getLayoutParent().getContentElement().remove(this.__ti);}
...
(function(){var a="source",b="element",c="name",d="qx.event.type.Event",f="iframe",g="qx.html.Iframe",h="navigate",i="qx.event.type.Data";qx.Class.define(g,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,f,k,l);this.setSource(j);this.addListener(h,this.__tg,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(b);}
...
;}
,__tg:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
