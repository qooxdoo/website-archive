...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.c66c933bdc2e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbarY:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__Bf:null,__Bg:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__Bg){this._stopIframeObserver();}
;var F=qx.event.Idle.getInstance();this.__Bg=F.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__Bf=null;if(!this.__Bg){return;}
;var G=qx.event.Idle.getInstance();G.removeListenerById(this.__Bg);}
,_onIframeObserverInterval:function(){var H=this._getIframeSize();if(!H){this._disableScollbars();return;}
;if(this.__Bf&&H.width==this.__Bf.width&&H.height==this.__Bf.height){return;}
;this.__Bf=H;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var K=this.__Bf;var N=this.getChildControl(j).getBounds();var L=this.getChildControl(j).getInnerSize();if(!K||!L||!L){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__Bf=null;}
});}
)();
