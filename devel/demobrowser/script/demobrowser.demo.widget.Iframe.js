...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.042018e1cd35.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._getIframeElement().addListener(h,this.__qM,this);}
...
,__qM:function(e){var r=e.getData();if(r){this.setSource(r);}
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbarY:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__CM:null,__CN:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__CN){this._stopIframeObserver();}
;var F=qx.event.Idle.getInstance();this.__CN=F.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__CM=null;if(!this.__CN){return;}
;var G=qx.event.Idle.getInstance();G.removeListenerById(this.__CN);}
,_onIframeObserverInterval:function(){var H=this._getIframeSize();if(!H){this._disableScollbars();return;}
;if(this.__CM&&H.width==this.__CM.width&&H.height==this.__CM.height){return;}
;this.__CM=H;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var K=this.__CM;var N=this.getChildControl(j).getBounds();var L=this.getChildControl(j).getInnerSize();if(!K||!L||!L){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__CM=null;}
});}
)();
...
(function(){var a="no",b="Boolean",c="px",d="event.help",f="gecko",g="auto",h="_applyScrollbar",i="Unable to set 'nativeHelp' property, possibly due to security restrictions",j="qx.debug",k="DOMNodeInserted",l="load",m="_applyNativeHelp",n="yes",o="scrolling",p="/",q="help",r="pointerup",s="appear",t="pointerdown",u="engine.name",v="block",w="qx.ui.embed.Iframe",x="losecapture",y="contextmenu",z="none",A="iframe",B="__qO",C="display";qx.Class.define(w,{extend:qx.ui.embed.AbstractIframe,construct:function(D){if(D!=null){this.__qN=D;}
;qx.ui.embed.AbstractIframe.call(this,D);qx.event.Registration.addListener(document.body,t,this.block,this,true);qx.event.Registration.addListener(document.body,r,this.release,this,true);qx.event.Registration.addListener(document.body,x,this.release,this,true);this.__qO=this._createBlockerElement();if((qx.core.Environment.get(u)==f)){this.addListenerOnce(s,function(e){var E=this.getContentElement().getDomElement();qx.bom.Event.addNativeListener(E,k,this._onDOMNodeInserted);}
);this._onDOMNodeInserted=qx.lang.Function.listener(this._syncSourceAfterDOMMove,this);}
;}
,properties:{appearance:{refine:true,init:A},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:b,init:false,apply:m},scrollbar:{check:[g,a,n],nullable:true,themeable:true,apply:h}},members:{__qN:null,__qO:null,renderLayout:function(J,top,H,F){qx.ui.embed.AbstractIframe.prototype.renderLayout.call(this,J,top,H,F);var I=c;var G=this.getInsets();this.__qO.setStyles({"left":(J+G.left)+I,"top":(top+G.top)+I,"width":(H-G.left-G.right)+I,"height":(F-G.top-G.bottom)+I});}
,_createContentElement:function(){var K=new qx.html.Iframe(this.__qN);K.addListener(l,this._onIframeLoad,this);return K;}
...
,block:function(){this.__qO.setStyle(C,v);}
,release:function(){this.__qO.setStyle(C,z);}
...
,setLayoutParent:function(parent){qx.ui.embed.AbstractIframe.prototype.setLayoutParent.call(this,parent);if(parent){this.getLayoutParent().getContentElement().add(this.__qO);}
;}
},destruct:function(){if(this.getLayoutParent()&&this.__qO.getParent()){this.getLayoutParent().getContentElement().remove(this.__qO);}
...
(function(){var a="source",b="element",c="name",d="qx.event.type.Event",f="iframe",g="qx.html.Iframe",h="navigate",i="qx.event.type.Data";qx.Class.define(g,{extend:qx.html.Element,construct:function(j,k,l){qx.html.Element.call(this,f,k,l);this.setSource(j);this.addListener(h,this.__qM,this);qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(b);}
...
;}
,__qM:function(e){var v=e.getData();if(v){this.setSource(v);}
;}
}});}
)();
