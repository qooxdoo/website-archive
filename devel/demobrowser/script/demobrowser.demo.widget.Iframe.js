...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.47671df3a54e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbarY:{check:[u,q,o],init:u,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__Bh:null,__Bi:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__Bi){this._stopIframeObserver();}
;var F=qx.event.Idle.getInstance();this.__Bi=F.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__Bh=null;if(!this.__Bi){return;}
;var G=qx.event.Idle.getInstance();G.removeListenerById(this.__Bi);}
,_onIframeObserverInterval:function(){var H=this._getIframeSize();if(!H){this._disableScollbars();return;}
;if(this.__Bh&&H.width==this.__Bh.width&&H.height==this.__Bh.height){return;}
;this.__Bh=H;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var K=this.__Bh;var N=this.getChildControl(j).getBounds();var L=this.getChildControl(j).getInnerSize();if(!K||!L||!L){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__Bh=null;}
});}
)();
