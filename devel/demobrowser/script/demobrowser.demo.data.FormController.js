...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController.b0485374c9e2.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="qx.core.Object",c="qx.data.controller.Object",d="get",e="[",f="reset",g="_applyModel",h="last";qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bh={};this.__hu=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__hu:null,__bh:null,_applyModel:function(o,l){for(var i=0;i<this.__hu.length;i++ ){var t=this.__hu[i][0];var q=this.__hu[i][1];var n=this.__hu[i][2];var r=this.__hu[i][3];var p=this.__hu[i][4];var m=this.__hu[i][5];if(l!=undefined&&!l.isDisposed()){this.__vn(t,q,n,l);}
...
;var H=F.toHashCode();if(this.__bh[H]==undefined){this.__bh[H]=[];}
;this.__bh[H].push([C,I,D,B,E,A]);}
...
;var P=this.__bh[R.toHashCode()];if(P==undefined||P.length==0){return;}
