...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController.a7fc48bd7fb0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="The given item has not been added.",b="qx.ui.form.Resetter",c=" not supported for reseting.",d="Item ";qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__qR=[];}
,members:{__qR:null,add:function(e){if(this._supportsValue(e)){var f=e.getValue();}
else if(this.__vv(e)){var f=e.getSelection();}
else if(this.__vw(e)){var f=e.getSelection().concat();}
else {throw new Error(d+e+c);}
;this.__qR.push({item:e,init:f});}
,remove:function(g){for(var i=0;i<this.__qR.length;i++ ){var h=this.__qR[i];if(h.item===g){this.__qR.splice(i,1);return true;}
;}
;return false;}
,reset:function(){for(var i=0;i<this.__qR.length;i++ ){var j=this.__qR[i];this.__vD(j.item,j.init);}
;}
,resetItem:function(k){var l;for(var i=0;i<this.__qR.length;i++ ){var m=this.__qR[i];if(m.item===k){l=m.init;break;}
;}
...
;}
,redefine:function(){for(var i=0;i<this.__qR.length;i++ ){var p=this.__qR[i].item;this.__qR[i].init=this.__vE(p);}
;}
,redefineItem:function(q){var r;for(var i=0;i<this.__qR.length;i++ ){if(this.__qR[i].item===q){r=this.__qR[i];break;}
;}
...
,ASSUME_YEAR_2000_THRESHOLD:30,ISO_MASKS:{isoDate:eT,isoTime:V,isoDateTime:T,isoUtcDateTime:dQ},AM_MARKER:ek,PM_MARKER:N},members:{__vR:null,__lJ:null,__vS:null,__vT:null,__vV:null,__vW:null,__vX:null,__vU:null,__vY:function(gt,gs){var gu=dL+(gt<0?((-1)*gt):gt);while(gu.length<gs){gu=eY+gu;}
;return gt<0?a+gu:gu;}
...
,_applyLocale:function(gW,gV){this.__lJ=gW===null?this.setLocale(this.__vS):gW;}
...
;var iu=this.__vW=[];var ip=qx.locale.Date.getAmMarker(this.__lJ).toString()||it.AM_MARKER;var iD=qx.locale.Date.getPmMarker(this.__lJ).toString()||it.PM_MARKER;var ig=this.__lJ;var il=function(iG,iH){iH=parseInt(iH,10);if(iH>=0){if(iH<it.ASSUME_YEAR_2000_THRESHOLD){iH+=2000;}
...
(function(){var a="changeModel",b="modelSelection[0]",c="qx.core.Object",d=":\n",e="qx.debug",f="_applyTarget",g="qx.data.controller.Form",h="changeTarget",j="value",k=" of ",l="Could not bind property ",m=".",n="No target is set.",o="qx.ui.form.Form",p="_applyModel";qx.Class.define(g,{extend:qx.core.Object,construct:function(q,s,r){qx.core.Object.call(this);this._selfUpdate=!!r;this.__vG={};if(q!=null){this.setModel(q);}
...
},members:{__uH:null,__uI:function(z){return Object.keys(z).sort().join(a);}
,toClass:function(A,B){this.__uJ(A,B,null,0);}
,__uJ:function(N,I,C,K){if(!qx.lang.Type.isObject(N)||!!N.$$isString||N instanceof qx.core.Object){if(N instanceof Array||qx.Bootstrap.getClass(N)==h){for(var i=0;i<N.length;i++ ){this.__uJ(N[i],I,C+o+i+m,K+1);}
;}
;return;}
;var E=this.__uI(N);if(this.__uN(E,C,K)){return;}
;for(var M in N){this.__uJ(N[M],I,M,K+1);}
;if(qx.Class.isDefined(s+E)){return;}
;if(this.__uH&&this.__uH.getModelClass&&this.__uH.getModelClass(E,N,C,K)!=null){return;}
;var O={};var F={__uK:this.__uK};for(var M in N){if(this.__uH&&this.__uH.getPropertyMapping){M=this.__uH.getPropertyMapping(M,E);}
...
;if(this.__uH&&this.__uH.getValidationRule){var H=this.__uH.getValidationRule(E,M);if(H){O[M].validate=k+M;F[k+M]=H;}
;}
;}
;if(this.__uH&&this.__uH.getModelSuperClass){var L=this.__uH.getModelSuperClass(E,C,K)||qx.core.Object;}
else {var L=qx.core.Object;}
;var G=[];if(this.__uH&&this.__uH.getModelMixins){var J=this.__uH.getModelMixins(E,C,K);if(!qx.lang.Type.isArray(J)){if(J!=null){G=[J];}
;}
else {G=J;}
;}
;if(I){G.push(qx.data.marshal.MEventBubbling);}
;var D={extend:L,include:G,properties:O,members:F,destruct:this.__uL};qx.Class.define(s+E,D);}
,__uL:function(){var P=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var Q in P){this.__uK(this.get(P[Q].name));}
;}
,__uK:function(R){if(!(R instanceof qx.core.Object)){return;}
;if(R.isDisposed()){return;}
;R.dispose();}
,__uM:function(S,W,X,V){var Y;if(this.__uH&&this.__uH.getModelClass){Y=this.__uH.getModelClass(S,W,X,V);}
;if(Y!=null){return (new Y());}
else {var U=s+S;var T=qx.Class.getByName(U);if(!T){throw new Error(b+U+l);}
;return (new T());}
;}
,__uN:function(ba,bd,bb){var bc=this.__uH;return bc&&bc.ignore&&bc.ignore(ba,bd,bb);}
,toModel:function(be){return this.__uO(be,null,0);}
,__uO:function(bq,bg,bm){var bk=qx.lang.Type.isObject(bq);var bf=bq instanceof Array||qx.Bootstrap.getClass(bq)==h;if((!bk&&!bf)||!!bq.$$isString||bq instanceof qx.core.Object){return bq;}
else if(this.__uN(this.__uI(bq),bg,bm)){return bq;}
else if(bf){var bo=qx.data.Array;if(this.__uH&&this.__uH.getArrayClass){var bl=this.__uH.getArrayClass(bg,bm);bo=bl||bo;}
;var br=new bo();br.setAutoDisposeItems(true);for(var i=0;i<bq.length;i++ ){br.push(this.__uO(bq[i],bg+o+i+m,bm+1));}
;return br;}
else if(bk){var bh=this.__uI(bq);var bp=this.__uM(bh,bq,bg,bm);for(var bn in bq){var bi=bn;if(this.__uH&&this.__uH.getPropertyMapping){bi=this.__uH.getPropertyMapping(bn,bh);}
;var bs=bi.replace(/-|\.|\s+/g,d);if((qx.core.Environment.get(t))&&qx.core.Environment.get(e)){if(bs!=bi){this.warn(c+bn+n+bi+v);}
;}
;bi=bs;var bj=p+qx.lang.String.firstUp(bi);if(bp[bj]){bp[bj](this.__uO(bq[bn],bn,bm+1));}
;}
;return bp;}
;throw new Error(j);}
...
(function(){var a="changeModel",b="qx.core.Object",c="qx.data.controller.Object",d="get",e="[",f="reset",g="_applyModel",h="last";qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bS={};this.__hu=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__hu:null,__bS:null,_applyModel:function(o,l){for(var i=0;i<this.__hu.length;i++ ){var t=this.__hu[i][0];var q=this.__hu[i][1];var n=this.__hu[i][2];var r=this.__hu[i][3];var p=this.__hu[i][4];var m=this.__hu[i][5];if(l!=undefined&&!l.isDisposed()){this.__vn(t,q,n,l);}
...
;}
;}
,addTarget:function(z,w,u,x,y,v){this.__hu.push([z,w,u,x,y,v]);this.__vm(z,w,u,x,y,v);}
...
,removeTarget:function(K,J,L){this.__vn(K,J,L,this.getModel());for(var i=0;i<this.__hu.length;i++ ){if(this.__hu[i][0]==K&&this.__hu[i][1]==J&&this.__hu[i][2]==L){this.__hu.splice(i,1);}
;}
;}
...
;var A=z[h+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(A)){var D=qx.data&&qx.data.IListData&&qx.Class.hasInterface(A&&A.constructor,qx.data.IListData);for(var i=0;i<A.length;i++ ){var F=D?A.getItem(i):A[i];E+=this.__sn(name,F,C);}
;}
else if(qx.lang.Type.isDate(A)&&y!=null){E+=this.__sn(name,y.format(A),C);}
else {E+=this.__sn(name,A,C);}
;}
;return E.substring(0,E.length-1);}
,__sn:function(name,I,G){if(I&&I.$$type==o){I=I.classname;}
