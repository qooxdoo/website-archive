...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas.2c2610f0177a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="__CJ",c="_applyCanvasWidth",d="redraw",f="Boolean",g="_applyCanvasHeight",h="qx.ui.embed.Canvas",i="Integer",j="qx.event.type.Data";qx.Class.define(h,{extend:qx.ui.core.Widget,construct:function(l,k){qx.ui.core.Widget.call(this);this.__CJ=new qx.util.DeferredCall(this.__CK,this);this.addListener(a,this._onResize,this);if(l!==undefined){this.setCanvasWidth(l);}
;if(k!==undefined){this.setCanvasHeight(k);}
;}
,events:{"redraw":j},properties:{syncDimension:{check:f,init:false},canvasWidth:{check:i,init:300,apply:c},canvasHeight:{check:i,init:150,apply:g}},members:{__CJ:null,_createContentElement:function(){return new qx.html.Canvas();}
,__CK:function(){var n=this.getContentElement();var p=n.getHeight();var m=n.getWidth();var o=n.getContext2d();this._draw(m,p,o);this.fireNonBubblingEvent(d,qx.event.type.Data,[{width:m,height:p,context:o}]);}
,_applyCanvasWidth:function(r,q){this.getContentElement().setWidth(r);this.__CJ.schedule();}
,_applyCanvasHeight:function(t,s){this.getContentElement().setHeight(t);this.__CJ.schedule();}
,update:function(){this.__CJ.schedule();}
...
(function(){var a="canvas",b="2d",c="qx.html.Canvas";qx.Class.define(c,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__ef=document.createElement(a);}
,members:{__ef:null,_createDomElement:function(){return this.__ef;}
,getCanvas:function(){return this.__ef;}
,setWidth:function(f){this.__ef.width=f;}
,getWidth:function(){return this.__ef.width;}
,setHeight:function(g){this.__ef.height=g;}
,getHeight:function(){return this.__ef.height;}
,getContext2d:function(){return this.__ef.getContext(b);}
}});}
)();
