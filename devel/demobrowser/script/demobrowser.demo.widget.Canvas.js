...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas.d67b0fcd98b8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="canvas",b="2d",c="qx.html.Canvas";qx.Class.define(c,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__eg=document.createElement(a);}
,members:{__eg:null,_createDomElement:function(){return this.__eg;}
,getCanvas:function(){return this.__eg;}
,setWidth:function(f){this.__eg.width=f;}
,getWidth:function(){return this.__eg.width;}
,setHeight:function(g){this.__eg.height=g;}
,getHeight:function(){return this.__eg.height;}
,getContext2d:function(){return this.__eg.getContext(b);}
}});}
)();
