...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.c55cff090db8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__BA=this.__BF(L);U.add(this.__BA);var Q=this.__BF(A);U.add(Q);this.__Br=this.__BG(L);this.__BA.add(this.__Br);this.__BA.addListener(M,qx.lang.Function.bind(this.__BE,this),this);this.__Bq=this.__BG(A);Q.add(this.__Bq);Q.addListener(M,qx.lang.Function.bind(this.__BE,this),this);this.__Bs=this.__BH();U.add(this.__Bs);this.__By=this.__BI();this.__BA.add(this.__By);this.__Bz=this.__BI();Q.add(this.__Bz);this.__Bx=[0,0];this.__BB();}
,__BB:function(){this.__Bs.setStyles({"left":k,"top":k});this.__Bt=new qx.event.Timer(40);this.__Bt.addListener(n,function(){var x=(parseInt(this.__Bs.getStyle(L))+this.__Bu*this.__Bv);var y=(parseInt(this.__Bs.getStyle(z))+this.__Bu*this.__Bw);this.__Bs.setStyle(L,x+c);this.__Bs.setStyle(z,y+c);this.__BD();}
,this);this.__Bt.start();}
,__BC:function(V){this.__Bt.stop();this.__Bt.dispose();this.__Bu=5;this.__Bx[V]=this.__Bx[V]+1;this.__By.setAttribute(w,this.__Bx[0]);this.__Bz.setAttribute(w,this.__Bx[1]);this.__BB();}
,__BD:function(){var X=this.getBoundsFor(this.__Bs);if(X.top<=0){this.__Bw=1;}
;if(X.bottom>=window.innerHeight-5){this.__Bw=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__BC(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__Br);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__Bv=1;this.__Bu=Math.min(this.__Bu+1,20);}
;var W=this.getBoundsFor(this.__Bq);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__Bv=-1;this.__Bu=Math.min(this.__Bu+1,20);}
;}
,__BE:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__BA.getDomElement(),e.getTarget())){ba=this.__Br;}
else {ba=this.__Bq;}
...
,__BF:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__BG:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__BH:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__BI:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
