...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.8da158306138.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__AR=this.__AW(L);U.add(this.__AR);var Q=this.__AW(A);U.add(Q);this.__AI=this.__AX(L);this.__AR.add(this.__AI);this.__AR.addListener(M,qx.lang.Function.bind(this.__AV,this),this);this.__AH=this.__AX(A);Q.add(this.__AH);Q.addListener(M,qx.lang.Function.bind(this.__AV,this),this);this.__AJ=this.__AY();U.add(this.__AJ);this.__AP=this.__Ba();this.__AR.add(this.__AP);this.__AQ=this.__Ba();Q.add(this.__AQ);this.__AO=[0,0];this.__AS();}
,__AS:function(){this.__AJ.setStyles({"left":k,"top":k});this.__AK=new qx.event.Timer(40);this.__AK.addListener(n,function(){var x=(parseInt(this.__AJ.getStyle(L))+this.__AL*this.__AM);var y=(parseInt(this.__AJ.getStyle(z))+this.__AL*this.__AN);this.__AJ.setStyle(L,x+c);this.__AJ.setStyle(z,y+c);this.__AU();}
,this);this.__AK.start();}
,__AT:function(V){this.__AK.stop();this.__AK.dispose();this.__AL=5;this.__AO[V]=this.__AO[V]+1;this.__AP.setAttribute(w,this.__AO[0]);this.__AQ.setAttribute(w,this.__AO[1]);this.__AS();}
,__AU:function(){var X=this.getBoundsFor(this.__AJ);if(X.top<=0){this.__AN=1;}
;if(X.bottom>=window.innerHeight-5){this.__AN=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__AT(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__AI);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__AM=1;this.__AL=Math.min(this.__AL+1,20);}
;var W=this.getBoundsFor(this.__AH);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__AM=-1;this.__AL=Math.min(this.__AL+1,20);}
;}
,__AV:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__AR.getDomElement(),e.getTarget())){ba=this.__AI;}
else {ba=this.__AH;}
...
,__AW:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__AX:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__AY:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__Ba:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
