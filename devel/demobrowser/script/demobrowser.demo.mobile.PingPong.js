...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.7cd9e818d540.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__BC=this.__BH(L);U.add(this.__BC);var Q=this.__BH(A);U.add(Q);this.__Bt=this.__BI(L);this.__BC.add(this.__Bt);this.__BC.addListener(M,qx.lang.Function.bind(this.__BG,this),this);this.__Bs=this.__BI(A);Q.add(this.__Bs);Q.addListener(M,qx.lang.Function.bind(this.__BG,this),this);this.__Bu=this.__BJ();U.add(this.__Bu);this.__BA=this.__BK();this.__BC.add(this.__BA);this.__BB=this.__BK();Q.add(this.__BB);this.__Bz=[0,0];this.__BD();}
,__BD:function(){this.__Bu.setStyles({"left":k,"top":k});this.__Bv=new qx.event.Timer(40);this.__Bv.addListener(n,function(){var x=(parseInt(this.__Bu.getStyle(L))+this.__Bw*this.__Bx);var y=(parseInt(this.__Bu.getStyle(z))+this.__Bw*this.__By);this.__Bu.setStyle(L,x+c);this.__Bu.setStyle(z,y+c);this.__BF();}
,this);this.__Bv.start();}
,__BE:function(V){this.__Bv.stop();this.__Bv.dispose();this.__Bw=5;this.__Bz[V]=this.__Bz[V]+1;this.__BA.setAttribute(w,this.__Bz[0]);this.__BB.setAttribute(w,this.__Bz[1]);this.__BD();}
,__BF:function(){var X=this.getBoundsFor(this.__Bu);if(X.top<=0){this.__By=1;}
;if(X.bottom>=window.innerHeight-5){this.__By=-1;}
;if(X.left<=0||X.right>=window.innerWidth){this.__BE(X.left<=0?1:0);}
;var Y=this.getBoundsFor(this.__Bt);if(X.left<=Y.right&&X.bottom>=Y.top&&X.top<=Y.bottom){this.__Bx=1;this.__Bw=Math.min(this.__Bw+1,20);}
;var W=this.getBoundsFor(this.__Bs);if(X.right>=W.left&&X.bottom>=W.top&&X.top<=W.bottom){this.__Bx=-1;this.__Bw=Math.min(this.__Bw+1,20);}
;}
,__BG:function(e){var ba;if(qx.dom.Hierarchy.contains(this.__BC.getDomElement(),e.getTarget())){ba=this.__Bt;}
else {ba=this.__Bs;}
...
,__BH:function(bd){var bc={"width":C,"height":h,"position":N,"backgroundColor":a};if(bd==L){bc[J]=u;}
else {bc[L]=C;bc[d]=u;}
;return new qx.html.Element(g,bc);}
,__BI:function(bf){var be={"width":l,"height":t,"top":t,"position":N,"backgroundColor":K};be[bf]=F;return new qx.html.Element(g,be);}
,__BJ:function(){var bg={"width":F,"height":F,"position":N,"backgroundColor":K,"userSelect":I};return new qx.html.Element(g,bg);}
,__BK:function(){var bh={"width":h,"height":h,"textAlign":r,"fontSize":H,"color":b,"fontFamily":B};var bi=new qx.html.Element(g,bh);bi.setAttribute(w,j);return bi;}
}});}
)();
