...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.bed6c5bd5a8d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__nO=document||window.document;this.__ux();var self=this;qx.bom.Event.addNativeListener(this.__nO,this.__lf,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__nO:null,__uv:null,__uw:null,__lf:null,__ux:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__nO[m]!=undefined){this.__uv=m;this.__lf=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__nO[m]!=undefined){this.__uw=m;break;}
;}
;if(this.__uv==null){this.__uv=k;this.__lf=c;}
;if(this.__uw==null){this.__uw=b;}
;}
,isHidden:function(){return !!this.__nO[this.__uv];}
,getVisibilityState:function(){return this.__nO[this.__uw]||d;}
}});}
)();
