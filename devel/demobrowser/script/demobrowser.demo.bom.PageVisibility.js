...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.939a51dcdbca.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__np=document||window.document;this.__tX();var self=this;qx.bom.Event.addNativeListener(this.__np,this.__iQ,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__np:null,__tV:null,__tW:null,__iQ:null,__tX:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__np[m]!=undefined){this.__tV=m;this.__iQ=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__np[m]!=undefined){this.__tW=m;break;}
;}
;if(this.__tV==null){this.__tV=k;this.__iQ=c;}
;if(this.__tW==null){this.__tW=b;}
;}
,isHidden:function(){return !!this.__np[this.__tV];}
,getVisibilityState:function(){return this.__np[this.__tW]||d;}
}});}
)();
