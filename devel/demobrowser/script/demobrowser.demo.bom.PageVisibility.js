...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.f236ee977f6d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mP=document||window.document;this.__tB();var self=this;qx.bom.Event.addNativeListener(this.__mP,this.__hD,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mP:null,__tz:null,__tA:null,__hD:null,__tB:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mP[m]!=undefined){this.__tz=m;this.__hD=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mP[m]!=undefined){this.__tA=m;break;}
;}
;if(this.__tz==null){this.__tz=k;this.__hD=c;}
;if(this.__tA==null){this.__tA=b;}
;}
,isHidden:function(){return !!this.__mP[this.__tz];}
,getVisibilityState:function(){return this.__mP[this.__tA]||d;}
}});}
)();
