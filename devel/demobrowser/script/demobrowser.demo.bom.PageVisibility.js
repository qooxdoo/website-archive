...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.8bc323a70268.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__nA=document||window.document;this.__ui();var self=this;qx.bom.Event.addNativeListener(this.__nA,this.__kS,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__nA:null,__ug:null,__uh:null,__kS:null,__ui:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__nA[m]!=undefined){this.__ug=m;this.__kS=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__nA[m]!=undefined){this.__uh=m;break;}
;}
;if(this.__ug==null){this.__ug=k;this.__kS=c;}
;if(this.__uh==null){this.__uh=b;}
;}
,isHidden:function(){return !!this.__nA[this.__ug];}
,getVisibilityState:function(){return this.__nA[this.__uh]||d;}
}});}
)();
