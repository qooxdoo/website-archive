...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.eecee0027b0d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mO=document||window.document;this.__tA();var self=this;qx.bom.Event.addNativeListener(this.__mO,this.__hD,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mO:null,__ty:null,__tz:null,__hD:null,__tA:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mO[m]!=undefined){this.__ty=m;this.__hD=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mO[m]!=undefined){this.__tz=m;break;}
;}
;if(this.__ty==null){this.__ty=k;this.__hD=c;}
;if(this.__tz==null){this.__tz=b;}
;}
,isHidden:function(){return !!this.__mO[this.__ty];}
,getVisibilityState:function(){return this.__mO[this.__tz]||d;}
}});}
)();
