...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.9850e36316ad.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__ny=document||window.document;this.__yn();var self=this;qx.bom.Event.addNativeListener(this.__ny,this.__kQ,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__ny:null,__yl:null,__ym:null,__kQ:null,__yn:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__ny[m]!=undefined){this.__yl=m;this.__kQ=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__ny[m]!=undefined){this.__ym=m;break;}
;}
;if(this.__yl==null){this.__yl=k;this.__kQ=c;}
;if(this.__ym==null){this.__ym=b;}
;}
,isHidden:function(){return !!this.__ny[this.__yl];}
,getVisibilityState:function(){return this.__ny[this.__ym]||d;}
}});}
)();
