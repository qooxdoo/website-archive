...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.ae1bf2acccb1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mT=document||window.document;this.__tB();var self=this;qx.bom.Event.addNativeListener(this.__mT,this.__hH,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mT:null,__tz:null,__tA:null,__hH:null,__tB:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mT[m]!=undefined){this.__tz=m;this.__hH=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mT[m]!=undefined){this.__tA=m;break;}
;}
;if(this.__tz==null){this.__tz=k;this.__hH=c;}
;if(this.__tA==null){this.__tA=b;}
;}
,isHidden:function(){return !!this.__mT[this.__tz];}
,getVisibilityState:function(){return this.__mT[this.__tA]||d;}
}});}
)();
