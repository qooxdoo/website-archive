...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.337a1523d4b9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mU=document||window.document;this.__tC();var self=this;qx.bom.Event.addNativeListener(this.__mU,this.__hJ,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mU:null,__tA:null,__tB:null,__hJ:null,__tC:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mU[m]!=undefined){this.__tA=m;this.__hJ=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mU[m]!=undefined){this.__tB=m;break;}
;}
;if(this.__tA==null){this.__tA=k;this.__hJ=c;}
;if(this.__tB==null){this.__tB=b;}
;}
,isHidden:function(){return !!this.__mU[this.__tA];}
,getVisibilityState:function(){return this.__mU[this.__tB]||d;}
}});}
)();
