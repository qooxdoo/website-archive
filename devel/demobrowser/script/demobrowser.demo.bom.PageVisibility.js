...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.d8f55df7717d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__nN=document||window.document;this.__uw();var self=this;qx.bom.Event.addNativeListener(this.__nN,this.__is,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__nN:null,__uu:null,__uv:null,__is:null,__uw:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__nN[m]!=undefined){this.__uu=m;this.__is=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__nN[m]!=undefined){this.__uv=m;break;}
;}
;if(this.__uu==null){this.__uu=k;this.__is=c;}
;if(this.__uv==null){this.__uv=b;}
;}
,isHidden:function(){return !!this.__nN[this.__uu];}
,getVisibilityState:function(){return this.__nN[this.__uv]||d;}
}});}
)();
