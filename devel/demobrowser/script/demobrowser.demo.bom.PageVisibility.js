...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.3c2a86c6dbbd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__mX=document||window.document;this.__tH();var self=this;qx.bom.Event.addNativeListener(this.__mX,this.__hL,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__mX:null,__tF:null,__tG:null,__hL:null,__tH:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__mX[m]!=undefined){this.__tF=m;this.__hL=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__mX[m]!=undefined){this.__tG=m;break;}
;}
;if(this.__tF==null){this.__tF=k;this.__hL=c;}
;if(this.__tG==null){this.__tG=b;}
;}
,isHidden:function(){return !!this.__mX[this.__tF];}
,getVisibilityState:function(){return this.__mX[this.__tG]||d;}
}});}
)();
