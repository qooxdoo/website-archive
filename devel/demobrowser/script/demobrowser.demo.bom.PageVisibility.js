...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.2f049fcbaa0d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__nL=document||window.document;this.__uu();var self=this;qx.bom.Event.addNativeListener(this.__nL,this.__iq,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__nL:null,__us:null,__ut:null,__iq:null,__uu:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__nL[m]!=undefined){this.__us=m;this.__iq=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__nL[m]!=undefined){this.__ut=m;break;}
;}
;if(this.__us==null){this.__us=k;this.__iq=c;}
;if(this.__ut==null){this.__ut=b;}
;}
,isHidden:function(){return !!this.__nL[this.__us];}
,getVisibilityState:function(){return this.__nL[this.__ut]||d;}
}});}
)();
