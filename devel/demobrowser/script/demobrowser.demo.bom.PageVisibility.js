...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.2fd4753a2c8f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__nL=document||window.document;this.__uR();var self=this;qx.bom.Event.addNativeListener(this.__nL,this.__iq,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__nL:null,__uP:null,__uQ:null,__iq:null,__uR:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__nL[m]!=undefined){this.__uP=m;this.__iq=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__nL[m]!=undefined){this.__uQ=m;break;}
;}
;if(this.__uP==null){this.__uP=k;this.__iq=c;}
;if(this.__uQ==null){this.__uQ=b;}
;}
,isHidden:function(){return !!this.__nL[this.__uP];}
,getVisibilityState:function(){return this.__nL[this.__uQ]||d;}
}});}
)();
