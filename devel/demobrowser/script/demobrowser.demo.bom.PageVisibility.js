...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.e349511f8794.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__nx=document||window.document;this.__ug();var self=this;qx.bom.Event.addNativeListener(this.__nx,this.__iR,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__nx:null,__ue:null,__uf:null,__iR:null,__ug:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__nx[m]!=undefined){this.__ue=m;this.__iR=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__nx[m]!=undefined){this.__uf=m;break;}
;}
;if(this.__ue==null){this.__ue=k;this.__iR=c;}
;if(this.__uf==null){this.__uf=b;}
;}
,isHidden:function(){return !!this.__nx[this.__ue];}
,getVisibilityState:function(){return this.__nx[this.__uf]||d;}
}});}
)();
