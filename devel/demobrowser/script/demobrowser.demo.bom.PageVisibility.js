...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.95ac820c015f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__nN=document||window.document;this.__yC();var self=this;qx.bom.Event.addNativeListener(this.__nN,this.__is,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__nN:null,__yA:null,__yB:null,__is:null,__yC:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__nN[m]!=undefined){this.__yA=m;this.__is=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__nN[m]!=undefined){this.__yB=m;break;}
;}
;if(this.__yA==null){this.__yA=k;this.__is=c;}
;if(this.__yB==null){this.__yB=b;}
;}
,isHidden:function(){return !!this.__nN[this.__yA];}
,getVisibilityState:function(){return this.__nN[this.__yB]||d;}
}});}
)();
