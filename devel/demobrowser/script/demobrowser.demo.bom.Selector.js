...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Selector.82fbf4ccb08d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,getWindow:function(N){return qx.dom.Node.getWindow(qx.module.Traversing.__tN(N));}
...
,getDocument:function(Q){return qx.dom.Node.getDocument(qx.module.Traversing.__tN(Q));}
,getNodeName:function(R){return qx.dom.Node.getName(qx.module.Traversing.__tN(R));}
,getNodeText:function(S){return qx.dom.Node.getText(qx.module.Traversing.__tN(S));}
,isBlockNode:function(T){return qx.dom.Node.isBlockNode(qx.module.Traversing.__tN(T));}
,equalNodes:function(bd,bf){bd=qx.module.Traversing.__tO(bd);bf=qx.module.Traversing.__tO(bf);if(!bd||!bf){return false;}
...
;}
;if(bc){var U=qx.module.Traversing.__tP(bd);var be=qx.module.Traversing.__tP(bf);for(var W in U){if(U[W]!==be[W]){return false;}
;}
;}
...
;return true;}
;}
},members:{__tM:null,add:function(bg){if(bg instanceof qxWeb){bg=bg[0];}
...
;}
;return bq;}
,getAncestors:function(bt){return this.__tM(null,bt);}
,getAncestorsUntil:function(bv,bu){return this.__tM(bv,bu);}
...
;return bO;}
,getNextAll:function(bR){var bQ=qx.module.Traversing.__tQ(this,f,bR);return qxWeb.$init(bQ,qxWeb);}
...
;return bX;}
,getPrevAll:function(cb){var ca=qx.module.Traversing.__tQ(this,k,cb);return qxWeb.$init(ca,qxWeb);}
...
,getSiblings:function(ci){var ch=qx.module.Traversing.__tQ(this,n,ci);return qxWeb.$init(ch,qxWeb);}
...
},defer:function(cp){qxWeb.$attachAll(this);qxWeb.$attach({"__tM":cp.__tM});}
});}
)();
...
;}
;var Y,bb=[];for(var i=0,l=X.length;i<l;i++ ){Y=X[i];if(typeof Y===k){Y=this.__tT(Y,bc);}
...
,appendTo:function(parent){parent=qx.module.Manipulating.__tX(parent);for(var i=0,l=parent.length;i<l;i++ ){this._forEachElement(function(C,j){if(i==0){qx.dom.Element.insertEnd(this[j],parent[i]);}
else {qx.dom.Element.insertEnd(this.eq(j).clone(true)[0],parent[i]);}
;}
);}
;return this;}
,insertBefore:function(D){D=qx.module.Manipulating.__tX(D);for(var i=0,l=D.length;i<l;i++ ){this._forEachElement(function(E,F){if(i==0){qx.dom.Element.insertBefore(E,D[i]);}
else {qx.dom.Element.insertBefore(this.eq(F).clone(true)[0],D[i]);}
;}
);}
;return this;}
,insertAfter:function(G){G=qx.module.Manipulating.__tX(G);for(var i=0,l=G.length;i<l;i++ ){for(var j=this.length-1;j>=0;j-- ){if(!this[j]||this[j].nodeType!==1){continue;}
;if(i==0){qx.dom.Element.insertAfter(this[j],G[i]);}
else {qx.dom.Element.insertAfter(this.eq(j).clone(true)[0],G[i]);}
;}
;}
;return this;}
,wrap:function(H){H=qx.module.Manipulating.__tV(H);if(H.length==0){return this;}
;this._forEachElement(function(I){var J=H.eq(0).clone(true);qx.dom.Element.insertAfter(J[0],I);var K=qx.module.Manipulating.__tW(J[0]);qx.dom.Element.insertEnd(I,K);}
);return this;}
...
;return Y.scrollTop;}
,setScrollLeft:function(bb,bc){var Node=qx.dom.Node;if(bc&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__tU.bind(this,a,bb,bc)();}
...
;}
;return this;}
,setScrollTop:function(be,bf){var Node=qx.dom.Node;if(bf&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__tU.bind(this,d,be,bf)();}
