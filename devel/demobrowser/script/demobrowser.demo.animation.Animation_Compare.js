...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_Compare.b4ab3443867d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="360deg",b="Reverse",c="demobrowser.demo.animation.Animation_Compare",d="1%",f="infinite",g="10%",j="JavaScript Animation",k="0deg",l="#124589",m="end",n="2em",o="div",p="60px",q="auto",r="0",s="20%",t="CSS3 Animation",u="ease",v="30px",w="0px",x="-10px",y="200px",z="Pause",A="h1",B="10px",C="Waiting 2s",D="1em",E="0.3",F="start",G="button",H="100px",I="Stop",J="400px",K="5px",L="50px",M="Play",N="iteration",O="2",P="ease-in",Q="1",R="Ended",S="ease-in-out",T="none",U="red",V="#00FF00",W="Running",X="20px",Y="linear",bf="-50px",bg="tap",bh="ease-out",be="40px";qx.Class.define(c,{extend:qx.application.Native,members:{createButton:function(name,bl){var bj=[];for(var i=0;i<this.aniClasses.length;i++ ){var bi=document.createElement(o);bi.innerHTML=name;bi.className=G;bj[i]=bi;}
...
;}
;}
)(bl,name);qxWeb(bj[0]).on(bg,bk);qxWeb(bj[1]).on(bg,bk);return bj;}
,main:function(){qx.application.Native.prototype.main.call(this);this.aniClasses=[qx.bom.element.AnimationCss,qx.bom.element.AnimationJs];var bE={duration:1000,keyFrames:{'0':{"width":H},'70':{"width":y},'100':{"width":H}}};var bu={duration:1000,keyFrames:{'0':{"height":be},'70':{"height":p},'100':{"height":be}}};var bF={duration:500,keyFrames:{'0':{"opacity":1},'50':{"opacity":0},'100':{"opacity":1}}};var bP={duration:500,keep:100,keyFrames:{'0':{"opacity":1},'100':{"opacity":0,display:T}}};var bt={duration:500,keyFrames:{'0':{"left":w,"top":w},'80':{"left":L,"top":H},'100':{"left":w,"top":w}}};var bv={duration:500,keyFrames:{'0':{"left":w},'30':{"left":x},'60':{"left":B},'80':{"left":x},'100':{"left":w}}};var bq={duration:500,keyFrames:{'0':{"left":w,"top":w},'30':{"left":x,"top":x},'60':{"left":B,"top":x},'80':{"left":x,"top":B},'100':{"left":w,"top":w}}};var bY={duration:1000,keep:70,keyFrames:{'0':{"top":w},'70':{"top":K},'100':{"top":v}}};var bI={duration:1000,keyFrames:{'0':{"line-height":Q},'88':{"line-height":O},'100':{"line-height":E}}};var bn={duration:2000,keyFrames:{'0':{"font-size":D},'88':{"font-size":n},'100':{"font-size":D}}};var br={duration:1000,keyFrames:{'0':{"width":g},'40':{"width":s},'100':{"width":d}}};var bU={duration:1000,keyFrames:{'0':{"color":U},'50':{"color":l},'100':{"color":V}}};var ca={duration:500,repeat:2,keyFrames:{'0':{"top":w},'50':{"top":x},'100':{"top":w}}};var bB={duration:500,alternate:true,repeat:2,keyFrames:{'0':{"top":w},'100':{"top":bf}}};var bo={duration:1000,timing:P,keep:100,keyFrames:{'0':{"left":w},'100':{"left":J}}};var bK=qx.lang.Object.clone(bo);bK.timing=bh;var bN=qx.lang.Object.clone(bo);bN.timing=Y;var bA=qx.lang.Object.clone(bo);bA.timing=u;var bC=qx.lang.Object.clone(bo);bC.timing=S;var bO={duration:1000,keyFrames:{'0':{},'50':{"opacity":0},'100':{}}};var bp={duration:500,alternate:true,repeat:2,keep:100,keyFrames:{'0':{"top":w},'100':{"top":L}}};var bz={duration:1000,keep:100,keyFrames:{'0':{"top":w},'100':{"top":L}}};var bH={duration:500,alternate:true,repeat:3,keep:100,keyFrames:{'0':{"top":w},'100':{"top":X}}};var bW={duration:1000,keyFrames:{'0':{"rotate":k},'100':{"rotate":a}}};var by={duration:1000,keyFrames:{'0':{"scale":1},'50':{"scale":0},'100':{"scale":1}}};var bJ={duration:1000,keyFrames:{'0':{"translate":[w,w]},'50':{"translate":[B,B]},'100':{"translate":[w,w]}}};var bT={duration:1000,keyFrames:{'0':{"skew":k},'100':{"skew":a}}};var bL={"Width":bE,"Height":bu,"Fade":bF,"FadeOut":bP,"Move":bt,"Shake":bv,"Dance":bq,"Dance Reverse":bq,"Keep":bY,"Keep (Alt.)":bp,"Keep (Reverse)":bz,"Keep (Reverse/Alt)":bH,"Font-Size":bn,"Line Height":bI,"Percent Width":br,"Color":bU,"Twice":ca,"Alternate":bB,"Ease In":bo,"Ease Out":bK,"Linear":bN,"Ease":bA,"Ease In Out":bC,"Missing Values":bO,"Rotate":bW,"Scale":by,"Translate":bJ,"Skew":bT};var h=document.createElement(A);h.innerHTML=t;document.body.appendChild(h);var bs=document.createElement(o);document.body.appendChild(bs);h=document.createElement(A);h.innerHTML=j;document.body.appendChild(h);var cd=document.createElement(o);document.body.appendChild(cd);for(var bR in bL){var bD=this.createButton(bR,bL[bR]);bs.appendChild(bD[0]);cd.appendChild(bD[1]);}
;var bS={duration:500,alternate:true,repeat:f,keyFrames:{'0':{left:w},'100':{left:B}}};var bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=I;bX.className=G;bD[i]=bX;}
;var bG=(function(ce){return function(e){for(var i=0;i<bM.length;i++ ){bM[i].stop();}
;}
;}
)(bS);qxWeb(bD[0]).on(bg,bG);qxWeb(bD[1]).on(bg,bG);var bM=[];bM.push(qx.bom.element.AnimationCss.animate(bD[0],bS));bM.push(qx.bom.element.AnimationJs.animate(bD[1],bS));bs.appendChild(bD[0]);cd.appendChild(bD[1]);bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=z;bX.className=G;bD[i]=bX;}
;var bG=(function(cf){return function(e){for(var i=0;i<bM.length;i++ ){if(cc[i].el){if(cc[i].isPlaying()){cc[i].pause();cc[i].el.innerHTML=M;}
else {cc[i].play();cc[i].el.innerHTML=z;}
;}
;}
;}
;}
)(bS);qxWeb(bD[0]).on(bg,bG);qxWeb(bD[1]).on(bg,bG);var cc=[];cc.push(qx.bom.element.AnimationCss.animate(bD[0],bS));cc.push(qx.bom.element.AnimationJs.animate(bD[1],bS));bs.appendChild(bD[0]);cd.appendChild(bD[1]);bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=r;bX.className=G;bD[i]=bX;bX.style.cursor=q;}
;var bw=function(e){e.innerHTML=parseInt(e.innerHTML)+1;}
;qx.bom.element.AnimationCss.animate(bD[0],bS).on(N,bw);qx.bom.element.AnimationJs.animate(bD[1],bS).on(N,bw);bs.appendChild(bD[0]);cd.appendChild(bD[1]);var bx={duration:500,repeat:10,delay:2000,alternate:true,keyFrames:{'0':{left:w},'100':{left:B}}};bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=C;bX.className=G;bD[i]=bX;bX.style.cursor=q;}
;var bQ=function(e){e.innerHTML=W;}
;var bV=function(e){e.innerHTML=R;}
;var cb=[];cb.push(qx.bom.element.AnimationCss.animate(bD[0],bx));cb.push(qx.bom.element.AnimationJs.animate(bD[1],bx));for(var i=0;i<cb.length;i++ ){cb[i].on(F,bQ);cb[i].on(m,bV);}
