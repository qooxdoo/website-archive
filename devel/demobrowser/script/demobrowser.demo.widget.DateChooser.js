...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.DateChooser.adbd66e987b1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="- Use the cursors keys to move the selection.",b="- Double-tap or enter/space-key will fire an execute event.",c="bold",d="- Page-keys / shift + page-keys switch months/years.",f="Description",g="select a date",h="Show January 1981",i="Set current date",j="Execute: ",k="Change: ",l="center",m="en",n="changeValue",o="demobrowser.demo.widget.DateChooser",p="Remove the selection",q="- Escape will remove the selection.",r="execute";qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);qx.locale.Manager.getInstance().setLocale(m);var s=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));var w=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));var E=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));var x=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var y=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));E.add(y);E.add(C);w.add(E);w.add(x);D.add(w);s.add(D);this.getRoot().add(s,{left:20,top:20});var u=new qx.ui.control.DateChooser();D.addBefore(u,w);var B=new qx.ui.basic.Label(g);s.add(B);u.addListener(n,function(e){B.setValue(k+e.getData());}
,this);u.addListener(r,function(e){var F=u.getValue();B.setValue(j+F);}
,this);var v=new qx.ui.form.Button(i);v.setAlignX(l);y.add(v);v.addListener(r,function(e){u.setValue(new Date());}
);var z=new qx.ui.form.Button(h);y.add(z);z.addListener(r,function(e){u.showMonth(0,1981);}
);var t=new qx.ui.form.Button(p);y.add(t);t.addListener(r,function(e){u.setValue(null);}
);var A=new qx.ui.basic.Label(f);A.setFont(c);C.add(A);C.add(new qx.ui.basic.Label(a));C.add(new qx.ui.basic.Label(d));C.add(new qx.ui.basic.Label(b));C.add(new qx.ui.basic.Label(q));}
}});}
)();
