...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.GroupedList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList.16fb21214881.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__a:[],addPendingDefer:function(bB,bA){if(qx.$$loader.delayDefer){this.__a.push(bB);bB.$$pendingDefer=bA;}
else {bA.call(bB);}
;}
...
;if(bS!=bX)bV=bS;}
;return bV;}
;var t=this;if(!bH){var bG=this.__a;this.__a=[];bG.forEach(bC);return;}
;bF(bH);}
...
;}
;return cc;}
,__b:[D,m,q,s,M,U,g],keys:({"ES5":Object.keys,"BROKEN_IE":function(cf){if(cf===null||(typeof cf!==V&&typeof cf!==c)){throw new TypeError(f);}
...
;}
)()!==s?C:j],__c:{"[object String]":A,"[object Array]":K,"[object Object]":z,"[object RegExp]":x,"[object Number]":N,"[object Boolean]":d,"[object Date]":E,"[object Function]":H,"[object Error]":e,"[object Blob]":u,"[object ArrayBuffer]":T,"[object FormData]":O},bind:function(cq,self,cr){var cp=Array.prototype.slice.call(arguments,2,arguments.length);return function(){var cs=Array.prototype.slice.call(arguments,0,arguments.length);return cq.apply(self,cp.concat(cs));}
;}
...
},members:{__cG:null,__cH:null,__cJ:null,__cO:null,__cI:null,__cK:null,__cE:null,__cF:null,__cM:null,getWindow:function(){return this.__cE;}
...
;}
,_applyValue:function(br,bq){this.getContentElement().setValue(br);this.__lP=true;qx.ui.core.queue.Layout.add(this);}
...
};T.setDelegate(V);T.setSelection(this.__BG.getSelection());return U;}
,createThirdExample:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var be=new qx.ui.basic.Label(u).set({font:v});bc.add(be);var bb=this.__Gj=new qx.ui.list.List().set({height:280,width:150,labelPath:e,labelOptions:{converter:function(bg,bf){return bf?bg+D+bf.getLastname():B;}
...
};bb.setDelegate(bd);bb.setSelection(this.__BG.getSelection());return bc;}
},destruct:function(){this.__BG.dispose();this.__Gi.dispose();this.__Gj.dispose();this.__BG=this.__Gi=this.__Gj=null;}
});}
)();
...
;if(v){this.setSeparator(v);}
;}
,properties:{alignY:{check:[k,o,f],init:k,apply:b},alignX:{check:[m,c,r],init:m,apply:b},spacing:{check:p,init:0,apply:b},separator:{check:a,nullable:true,apply:b},reversed:{check:s,init:false,apply:d}},members:{__pt:null,__lL:null,__lM:null,__hd:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__lN:function(){var B=this._getLayoutChildren();var length=B.length;var x=false;var w=this.__pt&&this.__pt.length!=length&&this.__lL&&this.__pt;var z;var y=w?this.__pt:new Array(length);var A=w?this.__lL:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;var i,ba,G,O;var P=[];var W=H;for(i=0;i<length;i+=1){O=this.__pt[i];G=O!=null?Math.floor((N-H)*O):K[i].getSizeHint().height;P.push(G);W+=G;}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__lN();}
;var be=qx.ui.layout.Util;var bs=this.__hd;var bh=0,bi=0,bq=0;var bj=0,bk=0;var bo,bf,br;for(var i=0,l=bs.length;i<l;i+=1){bo=bs[i];bf=bo.getSizeHint();bi+=bf.height;var bn=this.__lL[i];var bg=this.__pt[i];if(bn){bh+=bf.minHeight;}
...
},destruct:function(){this.__pt=this.__lL=this.__hd=null;}
});}
)();
(function(){var a="changeModel",b="application/json",c="json",d="aborted",e="loaded",f="qx.event.type.Data",g="error",h="fail",i="receiving",j="queued",k="changeState",l="success",m="String",n="changePhase",o="sending",p="_marshaler",q="completed",r="failed",s="qx.data.store.Json",t="__xl",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(s,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":f,"error":f},properties:{model:{nullable:true,event:a},state:{check:[u,j,o,i,q,d,w,r],init:u,event:k},url:{check:m,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__xl:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__xl;}
,_setRequest:function(C){this.__xl=C;}
,_createRequest:function(D){if(this.__xl){this.__xl.dispose();this.__xl=null;}
...
;this.fireDataEvent(e,this.getModel());if(this.__xl){this.__xl.dispose();this.__xl=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__xl!=null){this._disposeObjects(t);}
...
},members:{__ni:null,__nj:function(z){return Object.keys(z).sort().join(a);}
,toClass:function(A,B){this.__nk(A,B,null,0);}
,__nk:function(N,I,C,K){if(!qx.lang.Type.isObject(N)||!!N.$$isString||N instanceof qx.core.Object){if(N instanceof Array||qx.Bootstrap.getClass(N)==h){for(var i=0;i<N.length;i++ ){this.__nk(N[i],I,C+o+i+m,K+1);}
;}
;return;}
;var E=this.__nj(N);if(this.__no(E,C,K)){return;}
;for(var M in N){this.__nk(N[M],I,M,K+1);}
;if(qx.Class.isDefined(s+E)){return;}
;if(this.__ni&&this.__ni.getModelClass&&this.__ni.getModelClass(E,N,C,K)!=null){return;}
;var O={};var F={__nl:this.__nl};for(var M in N){if(this.__ni&&this.__ni.getPropertyMapping){M=this.__ni.getPropertyMapping(M,E);}
...
;if(this.__ni&&this.__ni.getValidationRule){var H=this.__ni.getValidationRule(E,M);if(H){O[M].validate=k+M;F[k+M]=H;}
;}
;}
;if(this.__ni&&this.__ni.getModelSuperClass){var L=this.__ni.getModelSuperClass(E,C,K)||qx.core.Object;}
else {var L=qx.core.Object;}
;var G=[];if(this.__ni&&this.__ni.getModelMixins){var J=this.__ni.getModelMixins(E,C,K);if(!qx.lang.Type.isArray(J)){if(J!=null){G=[J];}
;}
else {G=J;}
;}
;if(I){G.push(qx.data.marshal.MEventBubbling);}
;var D={extend:L,include:G,properties:O,members:F,destruct:this.__nm};qx.Class.define(s+E,D);}
,__nm:function(){var P=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var Q in P){this.__nl(this.get(P[Q].name));}
;}
,__nl:function(R){if(!(R instanceof qx.core.Object)){return;}
;if(R.isDisposed()){return;}
;R.dispose();}
,__nn:function(S,W,X,V){var Y;if(this.__ni&&this.__ni.getModelClass){Y=this.__ni.getModelClass(S,W,X,V);}
;if(Y!=null){return (new Y());}
else {var U=s+S;var T=qx.Class.getByName(U);if(!T){throw new Error(b+U+l);}
;return (new T());}
;}
,__no:function(ba,bd,bb){var bc=this.__ni;return bc&&bc.ignore&&bc.ignore(ba,bd,bb);}
,toModel:function(be){return this.__np(be,null,0);}
,__np:function(bq,bg,bm){var bk=qx.lang.Type.isObject(bq);var bf=bq instanceof Array||qx.Bootstrap.getClass(bq)==h;if((!bk&&!bf)||!!bq.$$isString||bq instanceof qx.core.Object){return bq;}
else if(this.__no(this.__nj(bq),bg,bm)){return bq;}
else if(bf){var bo=qx.data.Array;if(this.__ni&&this.__ni.getArrayClass){var bl=this.__ni.getArrayClass(bg,bm);bo=bl||bo;}
;var br=new bo();br.setAutoDisposeItems(true);for(var i=0;i<bq.length;i++ ){br.push(this.__np(bq[i],bg+o+i+m,bm+1));}
;return br;}
else if(bk){var bh=this.__nj(bq);var bp=this.__nn(bh,bq,bg,bm);for(var bn in bq){var bi=bn;if(this.__ni&&this.__ni.getPropertyMapping){bi=this.__ni.getPropertyMapping(bn,bh);}
;var bs=bi.replace(/-|\.|\s+/g,d);if((qx.core.Environment.get(t))&&qx.core.Environment.get(e)){if(bs!=bi){this.warn(c+bn+n+bi+v);}
;}
;bi=bs;var bj=p+qx.lang.String.firstUp(bi);if(bp[bj]){bp[bj](this.__np(bq[bn],bn,bm+1));}
;}
;return bp;}
;throw new Error(j);}
...
;if((n instanceof qx.core.Object)&&qx.Class.hasMixin(n.constructor,qx.data.marshal.MEventBubbling)){var o=qx.lang.Function.bind(this.__nq,this,name);var q=n.addListener(g,o,this);var p=n.getUserData(d+this.$$hash);if(p==null){p=[];n.setUserData(d+this.$$hash,p);}
;p.push(q);}
;}
,__nq:function(name,e){var y=e.getData();var u=y.value;var s=y.old;if(qx.Class.hasInterface(e.getTarget().constructor,qx.data.IListData)){if(y.name.indexOf){var x=y.name.indexOf(h)!=-1?y.name.indexOf(h):y.name.length;var v=y.name.indexOf(f)!=-1?y.name.indexOf(f):y.name.length;if(v==0){var t=name+y.name;}
...
else if(arguments.length>1){this.__nr=[];for(var i=0;i<arguments.length;i++ ){this.__nr.push(arguments[i]);}
;}
else if(typeof u==q){this.__nr=new Array(u);}
else if(u instanceof Array){this.__nr=qx.lang.Array.clone(u);}
else {this.__nr=[];this.dispose();throw new Error(l);}
;for(var i=0;i<this.__nr.length;i++ ){this._applyEventPropagation(this.__nr[i],null,i);}
;this.__ns();if(qx.core.Environment.get(k)){this[0]=h;}
;}
,properties:{autoDisposeItems:{check:e,init:false}},events:{"change":t,"changeLength":t},members:{__nr:null,concat:function(v){if(v){var w=this.__nr.concat(v);}
else {var w=this.__nr.concat();}
;return new qx.data.Array(w);}
,join:function(x){return this.__nr.join(x);}
,pop:function(){var y=this.__nr.pop();this.__ns();this._registerEventChaining(null,y,this.length-1);this.fireDataEvent(r,{value:[],name:this.length+f,old:[y],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:g,removed:[y],added:[]},null);return y;}
,push:function(z){for(var i=0;i<arguments.length;i++ ){this.__nr.push(arguments[i]);this.__ns();this._registerEventChaining(arguments[i],null,this.length-1);this.fireDataEvent(r,{value:[arguments[i]],name:(this.length-1)+f,old:[],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,reverse:function(){if(this.length==0){return;}
;var A=this.__nr.concat();this.__nr.reverse();this.__nt(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__nr,name:n+(this.__nr.length-1),old:A,item:this});}
,shift:function(){if(this.length==0){return;}
;var B=this.__nr.shift();this.__ns();this._registerEventChaining(null,B,this.length-1);this.__nt(0,this.length);this.fireDataEvent(r,{value:[],name:p,old:[B],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:g,removed:[B],added:[]},null);return B;}
,slice:function(D,C){return new qx.data.Array(this.__nr.slice(D,C));}
,splice:function(I,K,M){var Q=this.__nr.length;var L=this.__nr.splice.apply(this.__nr,arguments);if(this.__nr.length!=Q){this.__ns();}
...
;this.__nt(I+(arguments.length-2)-K,this.length);if(O||G){var J=[];for(var i=2;i<arguments.length;i++ ){J[i-2]=arguments[i];}
...
;var R=this.__nr.concat();this.__nr.sort.apply(this.__nr,arguments);if(qx.lang.Array.equals(this.__nr,R)===true){return;}
;this.__nt(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__nr,name:n+(this.length-1),old:R,item:this});}
,unshift:function(T){for(var i=arguments.length-1;i>=0;i-- ){this.__nr.unshift(arguments[i]);this.__ns();this.__nt(0,this.length);this.fireDataEvent(r,{value:[this.__nr[0]],name:p,old:[this.__nr[1]],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,toArray:function(){return this.__nr;}
,getItem:function(U){return this.__nr[U];}
,setItem:function(V,X){var W=this.__nr[V];if(W===X){return;}
;this.__nr[V]=X;this._registerEventChaining(X,W,V);if(this.length!=this.__nr.length){this.__ns();}
...
,indexOf:function(Y){return this.__nr.indexOf(Y);}
,lastIndexOf:function(ba){return this.__nr.lastIndexOf(ba);}
,toString:function(){if(this.__nr!=null){return this.__nr.toString();}
;return f;}
,contains:function(bb){return this.__nr.indexOf(bb)!==-1;}
...
,removeAll:function(){for(var i=0;i<this.__nr.length;i++ ){this._registerEventChaining(null,this.__nr[i],i);}
;if(this.getLength()==0){return [];}
;var bo=this.getLength();var bn=this.__nr.concat();this.__nr.length=0;this.__ns();this.fireDataEvent(r,{value:[],name:n+(bo-1),old:bn,item:this});this.fireDataEvent(o,{start:0,end:bo-1,type:g,removed:bn,added:[]},null);return bn;}
...
;var bq=this.__nr.length;Array.prototype.push.apply(this.__nr,bp);for(var i=0;i<bp.length;i++ ){this._registerEventChaining(bp[i],null,bq+i);}
;var bq=this.length;this.__ns();var name=bq==(this.length-1)?bq:bq+a+(this.length-1);this.fireDataEvent(r,{value:bp,name:name+f,old:[],item:this});this.fireDataEvent(o,{start:bq,end:this.length-1,type:b,added:bp,removed:[]},null);}
...
,forEach:function(bx,by){for(var i=0;i<this.__nr.length;i++ ){bx.call(by,this.__nr[i],i,this);}
;}
,filter:function(bz,self){return new qx.data.Array(this.__nr.filter(bz,self));}
,map:function(bA,self){return new qx.data.Array(this.__nr.map(bA,self));}
,some:function(bB,self){return this.__nr.some(bB,self);}
,every:function(bC,self){return this.__nr.every(bC,self);}
,reduce:function(bE,bD){return this.__nr.reduce(bE,bD);}
,reduceRight:function(bG,bF){return this.__nr.reduceRight(bG,bF);}
,__ns:function(){var bH=this.length;this.length=this.__nr.length;this.fireDataEvent(s,this.length,bH);}
,__nt:function(bJ,bI){for(var i=bJ;i<bI;i++ ){this._registerEventChaining(this.__nr[i],this.__nr[i],i);}
;}
},destruct:function(){for(var i=0;i<this.__nr.length;i++ ){var bK=this.__nr[i];this._applyEventPropagation(null,bK,i);if(this.isAutoDisposeItems()&&bK&&bK instanceof qx.core.Object){bK.dispose();}
;}
;this.__nr=null;}
});}
)();
...
;this.__oy={};var S=this._transport=this._createTransport();this._setPhase(H);this.__oz=qx.lang.Function.bind(this._onReadyStateChange,this);this.__oA=qx.lang.Function.bind(this._onLoad,this);this.__oB=qx.lang.Function.bind(this._onLoadEnd,this);this.__oC=qx.lang.Function.bind(this._onAbort,this);this.__nw=qx.lang.Function.bind(this._onTimeout,this);this.__oD=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__oz;S.onload=this.__oA;S.onloadend=this.__oB;S.onabort=this.__oC;S.ontimeout=this.__nw;S.onerror=this.__oD;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__oz:null,__oA:null,__oB:null,__oC:null,__nw:null,__oD:null,__oE:null,__nz:null,__oF:null,__oy:null,__oG:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__nz=true;this.__oF=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__oH());qx.lang.Object.mergeWith(bd,this.__oG);qx.lang.Object.mergeWith(bd,this.__oy);return bd;}
,__oH:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__oy[bh]=bi;}
,getRequestHeader:function(bj){return this.__oy[bj];}
,removeRequestHeader:function(bk){if(this.__oy[bk]){delete this.__oy[bk];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__oF;}
...
,getResponse:function(){return this.__oE;}
,_setResponse:function(bo){var bn=bo;if(this.__oE!==bo){this.__oE=bo;this.fireEvent(I,qx.event.type.Data,[this.__oE,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__nz){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__oI();}
;}
,__oI:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__oF;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__oF=br;this.fireDataEvent(c,br,bs);}
...
;if(m.substr(0,m.length-1)==n.protocol&&location.host===n.authority&&location.port===n.port){return false;}
;return true;}
...
;var A=z[h+qx.lang.String.firstUp(name)]();if(qx.lang.Type.isArray(A)){var D=qx.data&&qx.data.IListData&&qx.Class.hasInterface(A&&A.constructor,qx.data.IListData);for(var i=0;i<A.length;i++ ){var F=D?A.getItem(i):A[i];E+=this.__oJ(name,F,C);}
;}
else if(qx.lang.Type.isDate(A)&&y!=null){E+=this.__oJ(name,y.format(A),C);}
else {E+=this.__oJ(name,A,C);}
;}
;return E.substring(0,E.length-1);}
,__oJ:function(name,I,G){if(I&&I.$$type==o){I=I.classname;}
...
(function(){var a="Retry open native request with method: ",b="activex",c="No XHR support available.",d="If-None-Match",f="xhr",g="If-Modified-Since",h="engine.version",i="onunload",j="GET",k="-1",l="qx.debug.io",m="Undefined",n="Open native request with method: ",o="error",p="loadend",q="Blob",r="HTMLDocument",s="progress",t="load",u="Received native readyState: ",v="abort",w=", url: ",x="String",y="browser.documentmode",z="",A="readystatechange",B="Microsoft.XMLHTTP",C="Already disposed",D="browser.version",E="opera",F="qx.bom.request.Xhr",G="on",H="timeout",I="gecko",J="If-Match",K="mshtml",L="engine.name",M="Microsoft.XMLDOM",N="file:",O="Send native request",P="FormData",Q="If-Range",R="Content-Type",S="io.xhr",T="Not enough arguments",U="ArrayBuffer",V="undefined",W=", async: ",X="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(F,{extend:Object,construct:function(){var Y=qx.Bootstrap.bind(this.__on,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__nY=qx.event.GlobalError.observeMethod(Y);}
else {this.__nY=Y;}
;this.__oa=qx.Bootstrap.bind(this.__ol,this);this.__ob=qx.Bootstrap.bind(this.__om,this);this.__nw=qx.Bootstrap.bind(this.__or,this);this.__ok();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__oc=qx.Bootstrap.bind(this.__ou,this);window.attachEvent(i,this.__oc);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":F,"error":F,"loadend":F,"timeout":F,"abort":F,"load":F,"progress":F},members:{readyState:0,responseText:z,responseXML:null,status:0,statusText:z,timeout:0,progress:null,open:function(be,ba,bb,bd,bc){this.__ow();if(typeof ba===V){throw new Error(T);}
else if(typeof be===V){be=j;}
;this.__nz=false;this.__od=false;this.__oe=false;this.__nA=ba;if(typeof bb==V){bb=true;}
;this.__of=bb;if(!this.__ov()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__ok();}
;this.__oh.onreadystatechange=this.__nY;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,n+be+w+ba+W+bb);}
;this.__oh.open(be,ba,bb,bd,bc);}
catch(bf){if(!qx.util.Request.isCrossDomain(ba)){throw bf;}
;if(!this.__of){this.__og=bf;}
;if(this.__of){if(window.XDomainRequest){this.readyState=4;this.__oh=new XDomainRequest();this.__oh.onerror=qx.Bootstrap.bind(function(){this._emit(A);this._emit(o);this._emit(p);}
,this);if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+be+w+ba+W+bb);}
;this.__oh.open(be,ba,bb,bd,bc);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__nB){return;}
;this.readyState=4;this._emit(A);this._emit(o);this._emit(p);}
,this));}
;}
;if(qx.core.Environment.get(L)===K&&qx.core.Environment.get(y)<9&&this.__oh.readyState>0){this.__oh.setRequestHeader(g,k);}
;if(qx.core.Environment.get(L)===I&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__of){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(A);}
;}
,setRequestHeader:function(bg,bh){this.__ow();if(bg==J||bg==g||bg==d||bg==Q){this.__oe=true;}
;this.__oh.setRequestHeader(bg,bh);return this;}
,send:function(bj){this.__ow();if(!this.__of&&this.__og){throw this.__og;}
;if(qx.core.Environment.get(L)===E&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__oi=window.setTimeout(this.__nw,this.timeout);}
;bj=typeof bj==V?null:bj;var bi=qx.Bootstrap.getClass(bj);bj=(bj!==null&&this.__oj.indexOf(bi)===-1)?bj.toString():bj;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,O);}
;this.__oh.send(bj);}
catch(bl){if(!this.__of){throw bl;}
;if(this._getProtocol()===N){this.readyState=2;this.__oo();var bk=this;window.setTimeout(function(){if(bk.__nB){return;}
;bk.readyState=3;bk.__oo();bk.readyState=4;bk.__oo();}
);}
;}
;if(qx.core.Environment.get(L)===I&&!this.__of){this.__on();}
;this.__od=true;return this;}
,abort:function(){this.__ow();this.__nz=true;this.__oh.abort();if(this.__oh&&this.readyState!==qx.bom.request.Xhr.DONE){this.readyState=this.__oh.readyState;}
;return this;}
,_emit:function(event){if(this[G+event]){this[G+event]();}
...
,ontimeout:function(){}
,onprogress:function(){}
,on:function(name,bm,bn){this._emitter.on(name,bm,bn);return this;}
,getResponseHeader:function(bo){this.__ow();if(qx.core.Environment.get(y)===9&&this.__oh.aborted){return z;}
;return this.__oh.getResponseHeader(bo);}
,getAllResponseHeaders:function(){this.__ow();if(qx.core.Environment.get(y)===9&&this.__oh.aborted){return z;}
;return this.__oh.getAllResponseHeaders();}
,overrideMimeType:function(bp){this.__ow();if(this.__oh.overrideMimeType){this.__oh.overrideMimeType(bp);}
else {throw new Error(X);}
;return this;}
,getRequest:function(){return this.__oh;}
,dispose:function(){if(this.__nB){return false;}
;window.clearTimeout(this.__oi);if(window.detachEvent){window.detachEvent(i,this.__oc);}
;try{this.__oh.onreadystatechange;}
catch(br){return false;}
;var bq=function(){}
;this.__oh.onreadystatechange=bq;this.__oh.onload=bq;this.__oh.onerror=bq;this.__oh.onprogress=bq;this.abort();this.__oh=null;this.__nB=true;return true;}
,isDisposed:function(){return !!this.__nB;}
,_createNativeXhr:function(){var bs=qx.core.Environment.get(S);if(bs===f){return new XMLHttpRequest();}
;if(bs==b){return new window.ActiveXObject(B);}
;qx.Bootstrap.error(this,c);}
,_getProtocol:function(){var bt=this.__nA;var bu=/^(\w+:)\/\//;if(bt!==null&&bt.match){var bv=bt.match(bu);if(bv&&bv[1]){return bv[1];}
;}
;return window.location.protocol;}
,__oh:null,__of:null,__nY:null,__oa:null,__ob:null,__oc:null,__nw:null,__od:null,__nA:null,__nz:null,__df:null,__nB:null,__oi:null,__og:null,__oe:null,__oj:null,__ok:function(){this.__oh=this._createNativeXhr();this.__oh.onreadystatechange=this.__nY;if(qx.Bootstrap.getClass(this.__oh.onabort)!==m){this.__oh.onabort=this.__oa;}
;if(qx.Bootstrap.getClass(this.__oh.onprogress)!==m){this.__oh.onprogress=this.__ob;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__nB=this.__od=this.__nz=false;this.__oj=[U,q,r,x,P];}
,__ol:function(){if(!this.__nz){this.abort();}
;}
,__om:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(s);}
,__on:function(){var bw=this.__oh,bx=true;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,u+bw.readyState);}
;if(this.readyState==bw.readyState){return;}
;this.readyState=bw.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__nz&&!this.__od){return;}
;if(!this.__of&&(bw.readyState==2||bw.readyState==3)){return;}
;this.status=0;this.statusText=this.responseText=z;this.responseXML=null;if(this.readyState>=qx.bom.request.Xhr.HEADERS_RECEIVED){try{this.status=bw.status;this.statusText=bw.statusText;this.responseText=bw.responseText;this.responseXML=bw.responseXML;}
catch(by){bx=false;}
;if(bx){this.__os();this.__ot();}
;}
;this.__oo();if(this.readyState==qx.bom.request.Xhr.DONE){if(bw){bw.onreadystatechange=function(){}
;}
;}
;}
,__oo:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__oi);}
;this._emit(A);if(this.readyState===qx.bom.request.Xhr.DONE){this.__op();}
;}
,__op:function(){if(this.__df){this._emit(H);if(qx.core.Environment.get(L)===E){this._emit(o);}
;this.__df=false;}
else {if(this.__nz){this._emit(v);}
else {if(this.__oq()){this._emit(o);}
else {this._emit(t);}
;}
;}
;this._emit(p);}
,__oq:function(){var bz;if(this._getProtocol()===N){bz=!this.responseText;}
else {bz=!this.statusText&&this.status!==204;}
;return bz;}
,__or:function(){var bA=this.__oh;this.readyState=qx.bom.request.Xhr.DONE;this.__df=true;bA.aborted=true;bA.abort();this.responseText=z;this.responseXML=null;this.__oo();}
,__os:function(){var bB=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===N&&this.status===0&&bB){if(!this.__oq()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(L)===E){if(bB&&this.__oe&&!this.__nz&&this.status===0){this.status=304;}
;}
;}
,__ot:function(){if(qx.core.Environment.get(L)==K&&(this.getResponseHeader(R)||z).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bC=new window.ActiveXObject(M);bC.async=false;bC.validateOnParse=false;bC.loadXML(this.responseText);this.responseXML=bC;}
;}
,__ou:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__ov:function(){var name=qx.core.Environment.get(L);var bD=qx.core.Environment.get(D);return !(name==K&&bD<9||name==I&&bD<3.5);}
,__ow:function(){if(this.__nB){throw new Error(C);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__oK:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__oK=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__oK=i;}
,_getParser:function(k){var j=this.__oK,m=c,l=c;if(j){return j;}
...
(function(){var a="mouse",b="scrollbar-y",c="qx.ui.core.scroll.MRoll",d="pointerdown",f="scrollbar-x",g="roll";qx.Mixin.define(c,{members:{__qE:null,_addRollHandling:function(){this.addListener(g,this._onRoll,this);this.addListener(d,this._onPointerDownForRoll,this);}
...
,_onPointerDownForRoll:function(e){this.__qE=e.getPointerId();}
,_onRoll:function(e){if(e.getPointerType()==a){return;}
;if(this.__qE&&e.getMomentum()){qx.event.Registration.getManager(e.getOriginalTarget()).getHandler(qx.event.handler.Gesture).gestureCancel(this.__qE);e.stopMomentum();this.__qE=null;return;}
;this.__qE=null;var k=this._isChildControlVisible(f);var l=this._isChildControlVisible(b);var q=l?this.getChildControl(b,true):null;var p=k?this.getChildControl(f,true):null;var m=e.getDelta().y;var h=e.getDelta().x;var j=!l;var o=!k;if(q){if(m!==0){q.scrollBy(parseInt(m,10));}
...
;r.addListener(k,this.__qI,this);r.addListener(i,this.__qJ,this);this.__qF=[n,o];this.__qG=[m,g];}
,properties:{dragScrollThresholdX:{check:p,init:30},dragScrollThresholdY:{check:p,init:30},dragScrollSlowDownFactor:{check:b,init:0.1}},members:{__qH:null,__qF:null,__qG:null,_findScrollableParent:function(s){var t=s;if(t===null){return null;}
...
;}
,_getAxis:function(A){if(this.__qF.indexOf(A)!==-1){return a;}
else if(this.__qG.indexOf(A)!==-1){return q;}
else {throw new Error(l+A+f);}
;}
,_getThresholdByEdgeType:function(B){if(this.__qF.indexOf(B)!==-1){return this.getDragScrollThresholdX();}
else if(this.__qG.indexOf(B)!==-1){return this.getDragScrollThresholdY();}
;}
...
;var P=S.getBounds(),O=T===a?P.width:P.height,R=this._calculateScrollAmount(O,Q);if(this._isScrollbarExceedingMaxPos(S,T,R)){this.__qH.stop();}
;S.scrollBy(R);}
,__qI:function(e){if(this.__qH){this.__qH.stop();}
...
;bd=this._getAxis(X);if(this._isScrollbarVisible(U,bd)){bb=this._calculateThresholdExceedance(bc[X],this._getThresholdByEdgeType(X));if(this.__qH){this.__qH.dispose();}
;this.__qH=new qx.event.Timer(50);this.__qH.addListener(h,function(be,bg,bf){this._scrollBy(be,bg,bf);}
.bind(this,U,bd,bb));this.__qH.start();e.stopPropagation();return;}
else {U=this._findScrollableParent(U);}
;}
;}
,__qJ:function(e){if(this.__qH){this.__qH.stop();}
;}
},destruct:function(){if(this.__qH){this.__qH.dispose();}
;}
});}
)();
...
,_getContentHint:function(){var L=qx.bom.element.Scroll.getScrollbarWidth();return {width:this.__py?100:L,maxWidth:this.__py?null:L,minWidth:this.__py?null:L,height:this.__py?L:100,maxHeight:this.__py?L:null,minHeight:this.__py?L:null};}
...
,_applyPosition:function(P){var content=this.getContentElement();if(this.__py){content.scrollToX(P);}
else {content.scrollToY(P);}
;}
,_applyOrientation:function(S,Q){var R=this.__py=S===x;this.set({allowGrowX:R,allowShrinkX:R,allowGrowY:!R,allowShrinkY:!R});if(R){this.replaceState(o,x);}
...
,_updateScrollBar:function(){var U=this.__py;var V=this.getBounds();if(!V){return;}
...
,scrollTo:function(Y,X){this.stopScrollAnimation();if(X){var ba=this.getPosition();this.__qL=new qx.bom.AnimationFrame();this.__qL.on(d,function(bc){var bb=parseInt(bc/X*(Y-ba)+ba);this.updatePosition(bb);}
,this);this.__qL.on(f,function(){this.setPosition(Math.max(0,Math.min(this.getMaximum(),Y)));this.__qL=null;this.fireEvent(q);}
,this);this.__qL.startSequence(X);}
...
,stopScrollAnimation:function(){if(this.__qL){this.__qL.cancelSequence();this.__qL=null;}
;}
,_onScroll:function(e){var bj=this.getContentElement();var bk=this.__py?bj.getScrollX():bj.getScrollY();this.setPosition(bk);}
...
,this);}
,events:{"scrollAnimationEnd":l},properties:{appearance:{refine:true,init:A},orientation:{check:[x,r],init:x,apply:s},maximum:{check:w,apply:B,init:100},position:{check:i,init:0,apply:z,event:F},singleStep:{check:f,init:20},pageStep:{check:f,init:10,apply:u},knobFactor:{check:c,apply:j,nullable:true}},members:{__qM:2,__qN:0,_computeSizeHint:function(){var H=qx.ui.core.Widget.prototype._computeSizeHint.call(this);if(this.getOrientation()===x){this.__qN=H.minWidth;H.minWidth=0;}
else {this.__qN=H.minHeight;H.minHeight=0;}
;return H;}
,renderLayout:function(M,top,J,I){var L=qx.ui.core.Widget.prototype.renderLayout.call(this,M,top,J,I);var K=this.getOrientation()===x;if(this.__qN>=(K?J:I)){this.getChildControl(n).setVisibility(o);this.getChildControl(D).setVisibility(o);}
...
,_onResizeSlider:function(e){var bg=this.getChildControl(a).getChildControl(m);var bj=bg.getSizeHint();var bh=false;var bi=this.getChildControl(a).getInnerSize();if(this.getOrientation()==r){if(bi.height<bj.minHeight+this.__qM){bh=true;}
;}
else {if(bi.width<bj.minWidth+this.__qM){bh=true;}
;}
;if(bh){bg.exclude();}
else {bg.show();}
;}
...
(function(){var a="",b="qx.ui.form.MForm",c="Boolean",d="_applyValid",f="changeLocale",g="changeRequired",h="changeValid",i="qx.dynlocale",j="changeInvalidMessage",k="String",l="invalid";qx.Mixin.define(b,{construct:function(){if(qx.core.Environment.get(i)){qx.locale.Manager.getInstance().addListener(f,this.__qj,this);}
;}
...
,__qj:qx.core.Environment.select(i,{"true":function(e){var o=this.getInvalidMessage();if(o&&o.translate){this.setInvalidMessage(o.translate());}
;var p=this.getRequiredInvalidMessage();if(p&&p.translate){this.setRequiredInvalidMessage(p.translate());}
;}
,"false":null})},destruct:function(){if(qx.core.Environment.get(i)){qx.locale.Manager.getInstance().removeListener(f,this.__qj,this);}
;}
});}
)();
...
,_onPointerDown:function(e){if(this.__qR){return;}
;var bw=this.__py;var bu=this.getChildControl(P);var bv=bw?G:L;var bA=bw?e.getDocumentLeft():e.getDocumentTop();var bC=this.getDecorator();bC=qx.theme.manager.Decoration.getInstance().resolve(bC);if(bw){var bz=bC?bC.getInsets().left:0;var by=(this.getPaddingLeft()||0)+bz;}
else {var bz=bC?bC.getInsets().top:0;var by=(this.getPaddingTop()||0)+bz;}
;var bB=this.__qO=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bv];bB+=by;var bx=this.__qP=qx.bom.element.Location.get(bu.getContentElement().getDomElement())[bv];if(e.getTarget()===bu){this.__qR=true;if(!this.__qW){this.__qW=new qx.event.Timer(100);this.__qW.addListener(r,this._fireValue,this);}
;this.__qW.start();this.__qS=bA+bB-bx;bu.addState(c);}
else {this.__qT=true;this.__qU=bA<=bx?-1:1;this.__rb(e);this._onInterval();if(!this.__du){this.__du=new qx.event.Timer(100);this.__du.addListener(r,this._onInterval,this);}
;this.__du.start();}
;this.addListener(w,this._onPointerMove);this.capture();e.stopPropagation();}
,_onPointerUp:function(e){if(this.__qR){this.releaseCapture();delete this.__qR;this.__qW.stop();this._fireValue();delete this.__qS;this.getChildControl(P).removeState(c);if(e.getType()===B){var bE;var bF;var bD;if(this.__py){bE=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__qO);bD=qx.bom.element.Location.get(this.getContentElement().getDomElement())[L];bF=e.getDocumentTop()-(bD+this.getChildControl(P).getBounds().top);}
else {bE=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__qO);bD=qx.bom.element.Location.get(this.getContentElement().getDomElement())[G];bF=e.getDocumentLeft()-(bD+this.getChildControl(P).getBounds().left);}
;if(bF<0||bF>this.__qQ||bE<0||bE>this.__qQ){this.getChildControl(P).removeState(b);}
;}
;}
else if(this.__qT){this.__du.stop();this.releaseCapture();delete this.__qT;delete this.__qU;delete this.__qV;}
;this.removeListener(w,this._onPointerMove);if(e.getType()===B){e.stopPropagation();}
;}
,_onPointerMove:function(e){if(this.__qR){var bH=this.__py?e.getDocumentLeft():e.getDocumentTop();var bG=bH-this.__qS;this.slideTo(this._positionToValue(bG));}
else if(this.__qT){this.__rb(e);}
;e.stopPropagation();}
,_onInterval:function(e){var bI=this.getValue()+(this.__qU*this.getPageStep());if(bI<this.getMinimum()){bI=this.getMinimum();}
else if(bI>this.getMaximum()){bI=this.getMaximum();}
;var bJ=this.__qU==-1;if((bJ&&bI<=this.__qV)||(!bJ&&bI>=this.__qV)){bI=this.__qV;}
;this.slideTo(bI);}
,_onUpdate:function(e){var bL=this.getInnerSize();var bM=this.getChildControl(P).getBounds();var bK=this.__py?E:x;this._updateKnobSize();this.__ra=bL[bK]-bM[bK];this.__qQ=bM[bK];this._updateKnobPosition();}
,__py:false,__ra:0,__rb:function(e){var bN=this.__py;var bU=bN?e.getDocumentLeft():e.getDocumentTop();var bX=this.__qO;var bO=this.__qP;var bY=this.__qQ;var bV=bU-bX;if(bU>=bO){bV-=bY;}
;var bR=this._positionToValue(bV);var bP=this.getMinimum();var bQ=this.getMaximum();if(bR<bP){bR=bP;}
else if(bR>bQ){bR=bQ;}
else {var bW=this.getValue();var bT=this.getPageStep();var bS=this.__qU<0?I:Q;bR=bW+(Math[bS]((bR-bW)/bT)*bT);}
;if(this.__qV==null||(this.__qU==-1&&bR<=this.__qV)||(this.__qU==1&&bR>=this.__qV)){this.__qV=bR;}
;}
,_positionToValue:function(cb){var ca=this.__ra;if(ca==null||ca==0){return 0;}
;var cd=cb/ca;if(cd<0){cd=0;}
else if(cd>1){cd=1;}
;var cc=this.getMaximum()-this.getMinimum();return this.getMinimum()+Math.round(cc*cd);}
,_valueToPosition:function(ch){var ce=this.__ra;if(ce==null){return 0;}
...
,_setKnobPosition:function(ck){var ci=this.getChildControl(P);var cj=this.getDecorator();cj=qx.theme.manager.Decoration.getInstance().resolve(cj);var content=ci.getContentElement();if(this.__py){if(cj&&cj.getPadding()){ck+=cj.getPadding().left;}
...
;if(this.__py){this.getChildControl(P).setWidth(Math.round(cm*cl.width));}
...
,slideTo:function(cu,ct){this.stopSlideAnimation();if(ct){this.__rd(cu,ct);}
else {this.updatePosition(cu);}
;}
,updatePosition:function(cv){this.setValue(this.__rc(cv));}
,stopSlideAnimation:function(){if(this.__qL){this.__qL.cancelSequence();this.__qL=null;}
;}
,__rc:function(cw){if(cw<this.getMinimum()){cw=this.getMinimum();}
...
;return cw;}
,__rd:function(cy,cx){cy=this.__rc(cy);var cz=this.getValue();this.__qL=new qx.bom.AnimationFrame();this.__qL.on(i,function(cA){this.setValue(parseInt(cA/cx*(cy-cz)+cz));}
,this);this.__qL.on(j,function(){this.setValue(cy);this.__qL=null;this.fireEvent(O);}
,this);this.__qL.startSequence(cx);}
,_applyOrientation:function(cD,cC){var cB=this.getChildControl(P);this.__py=cD===N;if(this.__py){this.removeState(C);cB.removeState(C);this.addState(N);cB.addState(N);cB.setLayoutProperties({top:0,right:null,bottom:0});}
...
else {if(this.__py){this.getChildControl(P).resetWidth();}
else {this.getChildControl(P).resetHeight();}
;}
;}
,_applyValue:function(cH,cG){if(cH!=null){this._updateKnobPosition();if(this.__qR){this.__qY=[cH,cG];}
else {this.fireEvent(h,qx.event.type.Data,[cH,cG]);}
;}
else {this.resetValue();}
;}
,_fireValue:function(){if(!this.__qY){return;}
;var cI=this.__qY;this.__qY=null;this.fireEvent(h,qx.event.type.Data,cI);}
...
(function(){var a="toolTipText",b="icon",c="label",d="qx.ui.core.MExecutable",f="enabled",g="value",h="qx.event.type.Event",j="execute",k="_applyCommand",l="qx.ui.command.Command",m="menu",n="changeCommand";qx.Mixin.define(d,{events:{"execute":h},properties:{command:{check:l,apply:k,event:n,nullable:true}},members:{__pK:null,__pL:false,__pM:null,_bindableProperties:[f,c,b,a,g,m],execute:function(){var o=this.getCommand();if(o){if(this.__pL){this.__pL=false;}
else {this.__pL=true;o.execute(this);}
;}
;this.fireEvent(j);}
,__pN:function(e){if(this.__pL){this.__pL=false;return;}
;if(this.isEnabled()){this.__pL=true;this.execute();}
;}
,_applyCommand:function(r,p){if(p!=null){p.removeListenerById(this.__pM);}
;if(r!=null){this.__pM=r.addListener(j,this.__pN,this);}
;var q=this.__pK;if(q==null){this.__pK=q={};}
...
;}
;}
},destruct:function(){this._applyCommand(null,this.getCommand());this.__pK=null;}
});}
)();
...
,events:{"execute":j,"press":j,"release":j},properties:{interval:{check:m,init:100},firstInterval:{check:m,init:500},minTimer:{check:m,init:20},timerDecrease:{check:m,init:2}},members:{__qd:null,__du:null,press:function(){if(this.isEnabled()){if(!this.hasState(g)){this.__qe();}
;this.removeState(l);this.addState(g);}
;}
,release:function(q){if(!this.isEnabled()){return;}
;if(this.hasState(g)){if(!this.__qd){this.execute();}
;}
;this.removeState(g);this.removeState(l);this.__qf();}
...
;}
,_onPointerDown:function(e){if(!e.isLeftPressed()){return;}
;this.capture();this.__qe();e.stopPropagation();}
,_onPointerUp:function(e){this.releaseCapture();if(!this.hasState(l)){this.addState(b);if(this.hasState(g)&&!this.__qd){this.execute();}
;}
;this.__qf();e.stopPropagation();}
,_onTap:function(e){}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case f:case k:if(this.hasState(g)){if(!this.__qd){this.execute();}
;this.removeState(g);this.removeState(l);e.stopPropagation();this.__qf();}
;};}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case f:case k:this.removeState(l);this.addState(g);e.stopPropagation();this.__qe();};}
,_onInterval:function(e){this.__qd=true;this.fireEvent(n);}
,__qe:function(){this.fireEvent(a);this.__qd=false;this.__du.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.removeState(l);this.addState(g);}
,__qf:function(){this.fireEvent(d);this.__du.stop();this.removeState(l);this.removeState(g);}
...
,events:{"interval":d},properties:{interval:{check:a,init:100},firstInterval:{check:a,init:500},minimum:{check:a,init:20},decrease:{check:a,init:2}},members:{__du:null,__qg:null,start:function(){this.__du.setInterval(this.getFirstInterval());this.__du.start();}
,stop:function(){this.__du.stop();this.__qg=null;}
,_onInterval:function(){this.__du.stop();if(this.__qg==null){this.__qg=this.getInterval();}
;this.__qg=Math.max(this.getMinimum(),this.__qg-this.getDecrease());this.__du.setInterval(this.__qg);this.__du.start();this.fireEvent(c);}
...
(function(){var a="' must be defined!",b="height",c="vAlign",d="hAlign",e="' is not supported by the Grid layout!",f="bottom",g="Invalid parameter 'column'",h="Integer",m="The property '",n="'",o="_applyLayoutChange",p="qx.debug",q="Value must be positive",r="center",s="qx.ui.layout.Grid",t="middle",u="maxHeight",v="Cannot add widget '",w="width",z=") for '",A="'!. ",B="top",C="minHeight",D="right",E="' in this cell (",F=", ",G="The layout properties 'row' and 'column' of the child widget '",H="minWidth",I="flex",J="left",K="maxWidth",L="Invalid parameter 'row'",M="There is already a widget '";qx.Class.define(s,{extend:qx.ui.layout.Abstract,construct:function(O,N){qx.ui.layout.Abstract.call(this);this.__re=[];this.__rf=[];if(O){this.setSpacingX(O);}
;if(N){this.setSpacingY(N);}
;}
,properties:{spacingX:{check:h,init:0,apply:o},spacingY:{check:h,init:0,apply:o}},members:{__rg:null,__re:null,__rf:null,__rh:null,__ri:null,__rj:null,__rk:null,__rl:null,__rm:null,verifyLayoutProperty:qx.core.Environment.select(p,{"true":function(P,name,Q){var R={"row":1,"column":1,"rowSpan":1,"colSpan":1};this.assert(R[name]==1,m+name+e);this.assertInteger(Q);this.assert(Q>=0,q);}
,"false":null}),__rn:function(){var Y=[];var T=[];var W=[];var V=-1;var S=-1;var X=this._getLayoutChildren();for(var i=0,l=X.length;i<l;i++ ){var ba=X[i];var bb=ba.getLayoutProperties();var bc=bb.row;var U=bb.column;bb.colSpan=bb.colSpan||1;bb.rowSpan=bb.rowSpan||1;if(bc==null||U==null){throw new Error(G+ba+a);}
...
;}
;this.__rg=Y;this.__rh=T;this.__ri=W;this.__rj=V;this.__rk=S;this.__rl=null;this.__rm=null;delete this._invalidChildrenCache;}
,_setRowData:function(bg,be,bf){var bd=this.__re[bg];if(!bd){this.__re[bg]={};this.__re[bg][be]=bf;}
else {bd[be]=bf;}
;}
,_setColumnData:function(bh,bj,bk){var bi=this.__rf[bh];if(!bi){this.__rf[bh]={};this.__rf[bh][bj]=bk;}
else {bi[bj]=bk;}
;}
...
,getColumnAlign:function(bp){var bq=this.__rf[bp]||{};return {vAlign:bq.vAlign||B,hAlign:bq.hAlign||J};}
...
,getRowAlign:function(bv){var bu=this.__re[bv]||{};return {vAlign:bu.vAlign||B,hAlign:bu.hAlign||J};}
,getCellWidget:function(bx,bw){if(this._invalidChildrenCache){this.__rn();}
;var bx=this.__rg[bx]||{};return bx[bw]||null;}
,getRowCount:function(){if(this._invalidChildrenCache){this.__rn();}
;return this.__rj+1;}
,getColumnCount:function(){if(this._invalidChildrenCache){this.__rn();}
;return this.__rk+1;}
,getCellAlign:function(bF,bz){var bE=B;var bC=J;var bD=this.__re[bF];var bA=this.__rf[bz];var by=this.__rg[bF][bz];if(by){var bB={vAlign:by.getAlignY(),hAlign:by.getAlignX()};}
else {bB={};}
...
,getColumnFlex:function(bI){var bJ=this.__rf[bI]||{};return bJ.flex!==undefined?bJ.flex:0;}
,setRowFlex:function(bL,bK){this._setRowData(bL,I,bK);this._applyLayoutChange();return this;}
,getRowFlex:function(bO){var bM=this.__re[bO]||{};var bN=bM.flex!==undefined?bM.flex:0;return bN;}
,setColumnMaxWidth:function(bP,bQ){this._setColumnData(bP,K,bQ);this._applyLayoutChange();return this;}
,getColumnMaxWidth:function(bR){var bS=this.__rf[bR]||{};return bS.maxWidth!==undefined?bS.maxWidth:Infinity;}
,setColumnWidth:function(bT,bU){this._setColumnData(bT,w,bU);this._applyLayoutChange();return this;}
,getColumnWidth:function(bV){var bW=this.__rf[bV]||{};return bW.width!==undefined?bW.width:null;}
,setColumnMinWidth:function(bX,bY){this._setColumnData(bX,H,bY);this._applyLayoutChange();return this;}
,getColumnMinWidth:function(ca){var cb=this.__rf[ca]||{};return cb.minWidth||0;}
,setRowMaxHeight:function(cd,cc){this._setRowData(cd,u,cc);this._applyLayoutChange();return this;}
,getRowMaxHeight:function(cf){var ce=this.__re[cf]||{};return ce.maxHeight||Infinity;}
,setRowHeight:function(cg,ch){this._setRowData(cg,b,ch);this._applyLayoutChange();return this;}
,getRowHeight:function(cj){var ci=this.__re[cj]||{};return ci.height!==undefined?ci.height:null;}
,setRowMinHeight:function(cl,ck){this._setRowData(cl,C,ck);this._applyLayoutChange();return this;}
,getRowMinHeight:function(cn){var cm=this.__re[cn]||{};return cm.minHeight||0;}
,__ro:function(cp){var co=cp.getSizeHint();var cr=cp.getMarginLeft()+cp.getMarginRight();var cq=cp.getMarginTop()+cp.getMarginBottom();var cs={height:co.height+cq,width:co.width+cr,minHeight:co.minHeight+cq,minWidth:co.minWidth+cr,maxHeight:co.maxHeight+cq,maxWidth:co.maxWidth+cr};return cs;}
,_fixHeightsRowSpan:function(cN){var cz=this.getSpacingY();for(var i=0,l=this.__ri.length;i<l;i++ ){var cF=this.__ri[i];var cC=this.__ro(cF);var cv=cF.getLayoutProperties();var cB=cv.row;var cK=cz*(cv.rowSpan-1);var ct=cK;var cw={};for(var j=0;j<cv.rowSpan;j++ ){var cA=cv.row+j;var cJ=cN[cA];var cL=this.getRowFlex(cA);if(cL>0){cw[cA]={min:cJ.minHeight,value:cJ.height,max:cJ.maxHeight,flex:cL};}
...
;}
;}
,_fixWidthsColSpan:function(cR){var cS=this.getSpacingX();for(var i=0,l=this.__rh.length;i<l;i++ ){var cO=this.__rh[i];var cQ=this.__ro(cO);var cU=cO.getLayoutProperties();var cP=cU.column;var db=cS*(cU.colSpan-1);var cT=db;var cV={};var cX;for(var j=0;j<cU.colSpan;j++ ){var cW=cU.column+j;var da=cR[cW];var cY=this.getColumnFlex(cW);if(cY>0){cV[cW]={min:da.minWidth,value:da.width,max:da.maxWidth,flex:cY};}
...
;}
;}
,_getRowHeights:function(){if(this.__rl!=null){return this.__rl;}
;var dm=[];var df=this.__rj;var de=this.__rk;for(var dn=0;dn<=df;dn++ ){var dg=0;var di=0;var dh=0;for(var dl=0;dl<=de;dl++ ){var dd=this.__rg[dn][dl];if(!dd){continue;}
;var dj=dd.getLayoutProperties().rowSpan||0;if(dj>1){continue;}
;var dk=this.__ro(dd);if(this.getRowFlex(dn)>0){dg=Math.max(dg,dk.minHeight);}
...
;if(this.__ri.length>0){this._fixHeightsRowSpan(dm);}
;this.__rl=dm;return dm;}
,_getColWidths:function(){if(this.__rm!=null){return this.__rm;}
;var dt=[];var dq=this.__rk;var ds=this.__rj;for(var dy=0;dy<=dq;dy++ ){var dw=0;var dv=0;var dr=Infinity;for(var dz=0;dz<=ds;dz++ ){var dp=this.__rg[dz][dy];if(!dp){continue;}
;var du=dp.getLayoutProperties().colSpan||0;if(du>1){continue;}
;var dx=this.__ro(dp);dv=Math.max(dv,dx.minWidth);dw=Math.max(dw,dx.width);}
...
;if(this.__rh.length>0){this._fixWidthsColSpan(dt);}
;this.__rm=dt;return dt;}
...
,renderLayout:function(ej,dO,ei){if(this._invalidChildrenCache){this.__rn();}
;var ed=qx.ui.layout.Util;var dQ=this.getSpacingX();var dW=this.getSpacingY();var eh=this._getColWidths();var ek=this._getColumnFlexOffsets(ej);var dR=[];var em=this.__rk;var dP=this.__rj;var el;for(var en=0;en<=em;en++ ){el=ek[en]?ek[en].offset:0;dR[en]=eh[en].width+el;}
...
;var er=0;for(var en=0;en<=em;en++ ){var top=0;for(var dX=0;dX<=dP;dX++ ){var ef=this.__rg[dX][en];if(!ef){top+=et[dX]+dW;continue;}
...
;er+=dR[en]+dQ;}
;}
,invalidateLayoutCache:function(){qx.ui.layout.Abstract.prototype.invalidateLayoutCache.call(this);this.__rm=null;this.__rl=null;}
...
},destruct:function(){this.__rg=this.__re=this.__rf=this.__rh=this.__ri=this.__rm=this.__rl=null;}
});}
)();
...
,events:{update:n,scrollAnimationEnd:n},properties:{scrollX:{check:j,apply:g,transform:d,event:f,init:0},scrollY:{check:m,apply:h,transform:k,event:b,init:0}},members:{__qh:null,add:function(t){var u=this._getChildren()[0];if(u){this._remove(u);u.removeListener(a,this._onUpdate,this);}
...
;this.stopScrollAnimation();if(N){var P=this.getScrollX();this.__qh=new qx.bom.AnimationFrame();this.__qh.on(p,function(){this.setScrollX(Q);this.__qh=null;this.fireEvent(c);}
,this);this.__qh.on(i,function(S){var R=parseInt(S/N*(Q-P)+P);this.setScrollX(R);}
,this);this.__qh.startSequence(N);}
else {this.setScrollX(Q);}
;}
,scrollToY:function(W,T){var U=this.getScrollMaxY();if(W<0){W=0;}
else if(W>U){W=U;}
;this.stopScrollAnimation();if(T){var V=this.getScrollY();this.__qh=new qx.bom.AnimationFrame();this.__qh.on(p,function(){this.setScrollY(W);this.__qh=null;this.fireEvent(c);}
,this);this.__qh.on(i,function(Y){var X=parseInt(Y/T*(W-V)+V);this.setScrollY(X);}
,this);this.__qh.startSequence(T);}
...
,stopScrollAnimation:function(){if(this.__qh){this.__qh.cancelSequence();this.__qh=null;}
;}
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__rp=new qx.ui.virtual.core.Pane(o,l,n,m);this.__rp.addListener(c,this._computeScrollbars,this);this.__rp.addListener(d,this._onScrollPaneX,this);this.__rp.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__rp,{edge:0});}
else {this._add(this.__rp,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__rp:null,getPane:function(){return this.__rp;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__rp;}
...
,_onScrollBarX:function(e){this.__rp.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__rp.setScrollY(e.getData());}
},destruct:function(){this.__rp.dispose();this.__rp=null;}
});}
)();
(function(){var a="scrollY",b="__rr",c="cellTap",d="qx.event.type.Data",f="change",g="qx.debug",h="__rx",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="scrollX",p="appear",q="pointerdown",r="__rq",s="qx.ui.virtual.core.Pane",t="qx.ui.virtual.core.CellEvent",u="update",v="contextmenu",w="tap",x="__ry";qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__rq=new qx.ui.virtual.core.Axis(A,B);this.__rr=new qx.ui.virtual.core.Axis(z,y);this.__rs=0;this.__rt=0;this.__ru=0;this.__rv=0;this.__rw={};this.__jw={};this.__rx=new qx.ui.container.Composite();this.__rx.setUserBounds(0,0,0,0);this._add(this.__rx);this.__ry=[];this.__rq.addListener(f,this.fullUpdate,this);this.__rr.addListener(f,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(p,this._onAppear,this);this.addListener(q,this._onPointerDown,this);this.addListener(w,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(v,this._onContextmenu,this);}
,events:{cellTap:t,cellContextmenu:t,cellDbltap:t,update:j,scrollX:d,scrollY:d},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__rq:null,__rr:null,__rs:null,__rt:null,__ru:null,__rv:null,__rw:null,__jw:null,__rx:null,__ry:null,__rz:null,__qb:null,__rA:null,__rB:null,getRowConfig:function(){return this.__rq;}
,getColumnConfig:function(){return this.__rr;}
,getChildren:function(){return [this.__rx];}
,addLayer:function(C){if(qx.core.Environment.get(g)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__ry.push(C);C.setUserBounds(0,0,0,0);this.__rx.add(C);}
,getLayers:function(){return this.__ry;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__ry.length;i++ ){var E=this.__ry[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__rr.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__rq.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__rs!==J){var I=this.__rs;this.__rs=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__rs;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__rt){var L=this.__rt;this.__rt=M;this._deferredUpdateScrollPosition();this.fireDataEvent(o,M,L);}
;}
,getScrollX:function(){return this.__rt;}
,getScrollSize:function(){return {width:this.__rr.getTotalSize(),height:this.__rq.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__rq.getItemPosition(P);var O=R+this.__rq.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__rr.getItemPosition(S);var T=U+this.__rr.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__rq.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__rr.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__rt+bl.width;var bo=this.__rv-bn;if(this.__rt-this.__rw.left<Math.min(this.__rt,bj)||this.__rw.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__rt,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__rt-bp,this.__rs,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__rs+bw.height;var bt=this.__ru-bs;if(this.__rs-this.__rw.top<Math.min(this.__rs,bz)||this.__rw.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__rs,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__rt,this.__rs-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__rz=true;this._updateScrollPosition();this.__rz=null;this.fireEvent(u);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__rB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__rC(e,c);}
,_onContextmenu:function(e){this.__rC(e,k);}
,_onDbltap:function(e){this.__rC(e,n);}
,__rC:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__rB;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
;this.fireNonBubblingEvent(bC,qx.ui.virtual.core.CellEvent,[this,e,bB.row,bB.column]);}
,syncWidget:function(bD){if(this.__jw._fullUpdate){this._fullUpdate();}
else if(this.__jw._updateScrollPosition){this._updateScrollPosition();}
;this.__jw={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__rq.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__rq.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__rr.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__rr.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__rw={top:bU,bottom:bQ,left:bS,right:bI};this.__rx.setUserBounds((this.getPaddingLeft()||0)+(this.__rw.left-this.__rt),(this.getPaddingTop()||0)+(this.__rw.top-this.__rs),bO,bM);this.__qb=bH;this.__rA=bR;for(var i=0;i<this.__ry.length;i++ ){var bG=this.__ry[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__rD:function(){if(this.__rz){return;}
;var bW=this.getScrollSize();if(this.__ru!==bW.height||this.__rv!==bW.width){this.__ru=bW.height;this.__rv=bW.width;this.fireEvent(u);}
;}
,fullUpdate:function(){this.__jw._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__jw._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__rD();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__rt,this.__rs,bY.width,bY.height,true);this.__rD();}
,_deferredUpdateScrollPosition:function(){this.__jw._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__rD();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__rs,bottom:this.__rs+cc.height,left:this.__rt,right:this.__rt+cc.width};if(this.__rw.top<=cb.top&&this.__rw.bottom>=cb.bottom&&this.__rw.left<=cb.left&&this.__rw.right>=cb.right){this.__rx.setUserBounds((this.getPaddingLeft()||0)+(this.__rw.left-cb.left),(this.getPaddingTop()||0)+(this.__rw.top-cb.top),this.__rw.right-this.__rw.left,this.__rw.bottom-this.__rw.top);}
else {this._setLayerWindow(ca,this.__rt,this.__rs,cc.width,cc.height,false);}
;this.__rD();}
},destruct:function(){this._disposeArray(x);this._disposeObjects(r,b,h);this.__rw=this.__jw=this.__qb=this.__rA=null;}
});}
)();
...
,events:{"change":e},members:{__rE:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__rE=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__rE=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__rE=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__rE=null;this.fireNonBubblingEvent(c);}
,__rF:function(){if(this.__rE){return this.__rE;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__rE=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__rE=u;return u;}
,__rG:function(F){var B=this.__rE||this.__rF();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__rG(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__rH:function(M){var O=this.__rE||this.__rF();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__rH(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__rE||this.__rF();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__rE=null;}
});}
)();
...
(function(){var a="one",b="Boolean",c="qx.ui.virtual.selection.MModel",d="qx.data.Array",f="multi",g="selected",h="_applySelection",j="change",k="_applyDragSelection",l="single",m="_applyQuickSelection",n="changeSelection",o="_applySelectionMode",p="additive",q="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this._initSelectionManager();this.__rI=new qx.data.Array();this.initSelection(this.__rI);}
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__rJ:false,__rK:false,__rI:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
,_onChangeSelection:function(e){if(this.__rK==true){return;}
;this.__rJ=true;var G=this.getSelection();var I=[];for(var i=0;i<G.getLength();i++ ){var H=G.getItem(i);var J=this._getSelectables();var F=-1;if(J!=null){F=J.indexOf(H);}
...
;this.__rL();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__rJ=false;}
,_onManagerChangeSelection:function(e){if(this.__rJ==true){return;}
;this.__rK=true;this.__rL();this.__rK=false;}
,__rL:function(){if(this.__rN()){return;}
;var M=this._manager.getSelection();var N=[];for(var i=0;i<M.length;i++ ){var O=this._getDataFromRow(M[i]);if(O!=null){N.push(O);}
;}
;this.__rM(N);}
,__rM:function(R){var Q=this.getSelection();if(R.length>0){var P=[0,Q.getLength()];P=P.concat(R);var S=Q.splice.apply(Q,P);S.dispose();}
else {Q.removeAll();}
;}
,__rN:function(){var U=this.getSelection();var W=this._manager.getSelection();if(U.getLength()!==W.length){return false;}
...
;this._fireChange();}
,_setLeadItem:function(cb){var ca=this.__sf;if(ca!==null){this._styleSelectable(ca,u,false);}
;if(cb!==null){this._styleSelectable(cb,u,true);}
;this.__sf=cb;}
,getLeadItem:function(){return this.__sf;}
,_setAnchorItem:function(cd){var cc=this.__sg;if(cc!=null){this._styleSelectable(cc,I,false);}
;if(cd!=null){this._styleSelectable(cd,I,true);}
;this.__sg=cd;}
,_getAnchorItem:function(){return this.__sg!==null?this.__sg:null;}
...
;this._fireChange();}
,handlePointerOver:function(event){if(this.__si!=null&&this.__si!=this._getScroll().top){this.__si=null;return;}
...
;var cD=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cA=event.isShiftPressed();if(this.isItemSelected(cB)&&!cA&&!cD&&!this.getDrag()){this.__sh=cB;this._userInteraction=false;return;}
else {this.__sh=null;}
;this._scrollItemIntoView(cB);var cC=this.getMode();if(this.getDrag()&&cC!==bu&&cC!==h&&!cA&&!cD&&event.getPointerType()==F){this._setAnchorItem(cB);this._setLeadItem(cB);this.__rU=this._getLocation();this.__rR=this._getScroll();this.__rV=event.getDocumentLeft()+this.__rR.left;this.__rW=event.getDocumentTop()+this.__rR.top;this.__rX=true;this._capture();}
;this._fireChange(bD);this._userInteraction=false;}
,handleTap:function(event){this._userInteraction=true;var cH=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cE=event.isShiftPressed();if(!cH&&!cE&&this.__sh!=null){this._userInteraction=false;var cF=this._getSelectableFromPointerEvent(event);if(cF===null||!this.isItemSelected(cF)){return;}
;}
...
,handlePointerMove:function(event){if(!this.__rX){return;}
;this.__rY=event.getDocumentLeft();this.__sa=event.getDocumentTop();this._userInteraction=true;var cI=this.__rY+this.__rR.left;if(cI>this.__rV){this.__sb=1;}
else if(cI<this.__rV){this.__sb=-1;}
else {this.__sb=0;}
;var cJ=this.__sa+this.__rR.top;if(cJ>this.__rW){this.__sc=1;}
else if(cJ<this.__rW){this.__sc=-1;}
else {this.__sc=0;}
;var location=this.__rU;if(this.__rY<location.left){this.__rO=this.__rY-location.left;}
else if(this.__rY>location.right){this.__rO=this.__rY-location.right;}
else {this.__rO=0;}
;if(this.__sa<location.top){this.__rP=this.__sa-location.top;}
else if(this.__sa>location.bottom){this.__rP=this.__sa-location.bottom;}
else {this.__rP=0;}
;if(!this.__rQ){this.__rQ=new qx.event.Timer(100);this.__rQ.addListener(G,this._onInterval,this);}
;this.__rQ.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
,handleAddItem:function(e){var cK=e.getData();if(this.getMode()===h&&this.isSelectionEmpty()){this.addItem(cK);}
;}
,handleRemoveItem:function(e){this.removeItem(e.getData());}
,_cleanup:function(){if(!this.getDrag()&&this.__rX){return;}
;if(this.__sd){this._fireChange(bD);}
;delete this.__rX;delete this.__rS;delete this.__rT;this._releaseCapture();if(this.__rQ){this.__rQ.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__rO,this.__rP);this.__rR=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cT=this._getDimension();var cM=Math.max(0,Math.min(this.__rY-this.__rU.left,cT.width))+this.__rR.left;var cL=Math.max(0,Math.min(this.__sa-this.__rU.top,cT.height))+this.__rR.top;if(this.__rS===cM&&this.__rT===cL){return;}
;this.__rS=cM;this.__rT=cL;var cQ=this._getAnchorItem();var cO=cQ;var cR=this.__sb;var cU,cN;while(cR!==0){cU=cR>0?this._getRelatedSelectable(cO,t):this._getRelatedSelectable(cO,W);if(cU!==null){cN=this._getSelectableLocationX(cU);if((cR>0&&cN.left<=cM)||(cR<0&&cN.right>=cM)){cO=cU;continue;}
;}
;break;}
;var cS=this.__sc;var cV,cP;while(cS!==0){cV=cS>0?this._getRelatedSelectable(cO,z):this._getRelatedSelectable(cO,bB);if(cV!==null){cP=this._getSelectableLocationY(cV);if((cS>0&&cP.top<=cL)||(cS<0&&cP.bottom>=cL)){cO=cV;continue;}
;}
;break;}
...
;this._fireChange(bw);}
,__pU:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;var dd,dc;var df=event.getKeyIdentifier();var de=this.getMode();var cY=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var da=event.isShiftPressed();var db=false;if(df===A&&cY){if(de!==bu&&de!==h){this._selectAllItems();db=true;}
;}
...
;db=true;}
;}
else if(this.__pU[df]){db=true;if(de===bu||de==h){dd=this._getSelectedItem();}
...
;}
;break;};this.__si=this._getScroll().top;this._scrollItemIntoView(dc);}
;}
...
;this.__gK={};}
,_selectItemRange:function(dk,dp,dm){var dq=this._getSelectableRange(dk,dp);if(!dm){var dn=this.__gK;var dr=this.__sj(dq);for(var dl in dn){if(!dr[dl]){this._removeFromSelection(dn[dl]);}
;}
;}
...
;}
,__sj:function(dw){var dx={};var dv;for(var i=0,l=dw.length;i<l;i++ ){dv=dw[i];dx[this._selectableToHashCode(dv)]=dv;}
;return dx;}
...
;}
;}
,_addToSelection:function(dC){var dD=this._selectableToHashCode(dC);if(this.__gK[dD]==null&&this._isSelectable(dC)){this.__gK[dD]=dC;this._styleSelectable(dC,S,true);this.__sd=true;}
;}
...
;this.__sd=true;}
,_removeFromSelection:function(dG){var dH=this._selectableToHashCode(dG);if(this.__gK[dH]!=null){delete this.__gK[dH];this._styleSelectable(dG,S,false);this.__sd=true;}
;}
...
;if(!dL){return false;}
;this._scrollItemIntoView(dI);this._setLeadItem(dP);this._setAnchorItem(dP);this.__sd=true;this._fireChange();}
,_fireChange:function(dQ){if(this.__sd){this.__se=dQ||null;this.fireDataEvent(bA,this.getSelection());delete this.__sd;}
;}
...
;return dS;}
;return null;}
},destruct:function(){this._disposeObjects(R);this.__gK=this.__sh=this.__sg=null;this.__sf=null;}
});}
)();
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__sn=[];this.__BP=[];this.__BQ={};this.__BR=false;this.__BS=false;this.__BT=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__sn;}
,_lookup:function(Q){return this.__sn[Q];}
,_lookupGroup:function(R){return this.__BP.indexOf(R);}
,_reverseLookup:function(S){if(S<0){return -1;}
;return this.__sn.indexOf(S);}
...
,_applyGroupRowHeight:function(ba,Y){this.__BU();}
...
,_applyDelegate:function(bo,bn){this._provider.setDelegate(bo);this.__Ao();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this._provider.removeBindings();this.__Ao();this._applyDefaultSelection();}
,__sv:function(){this.getPane().getRowConfig().setItemCount(this.__sn.length);this.getPane().fullUpdate();}
,__BU:function(){var bp=this.getPane().getRowConfig();var bq=this.getGroupItemHeight();bp.resetItemSizes();if(bq){for(var i=0,l=this.__sn.length;i<l; ++i){if(this.__sn[i]==-1){bp.setItemSize(i,bq);}
;}
;}
;}
,__Ao:function(){this.__sn=[];this.__BP=[];this.__BQ={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var br=this.getModel();if(br!=null){this._runDelegateFilter(br);this._runDelegateSorter(br);this._runDelegateGroup(br);}
;this._updateSelection();this.__BU();this.__sv();}
,_runDelegateFilter:function(bt){var bs=qx.util.Delegate.getMethod(this.getDelegate(),D);for(var i=0,l=bt.length;i<l; ++i){if(bs==null||bs(bt.getItem(i))){this.__sn.push(i);}
;}
;}
,_runDelegateSorter:function(bu){if(this.__sn.length==0){return;}
;var bv=qx.util.Delegate.getMethod(this.getDelegate(),t);if(bv!=null){this.__sn.sort(function(a,b){return bv(bu.getItem(a),bu.getItem(b));}
);}
;}
,_runDelegateGroup:function(bz){var bA=qx.util.Delegate.getMethod(this.getDelegate(),v);if(bA!=null){for(var i=0,l=this.__sn.length;i<l; ++i){var bw=this.__sn[i];var by=this.getModel().getItem(bw);var bx=bA(by);this.__BV(bx,bw);}
;this.__sn=this.__BW();}
;}
,__BV:function(bC,bB){if(bC==null){this.__BT=true;bC=A;}
;var name=this.__BX(bC);if(this.__BQ[name]==null){this.__BQ[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bC);}
;}
;this.__BQ[name].push(bB);}
,__BW:function(){this.__BY();var bG=[];var bI=0;var bE=this.getGroups();for(var i=0;i<bE.getLength();i++ ){var bD=bE.getItem(i);bG.push(-1);this.__BP.push(bI);bI++ ;var bH=this.__BX(bD);var bF=this.__BQ[bH];if(bF!=null){for(var k=0;k<bF.length;k++ ){bG.push(bF[k]);bI++ ;}
;}
;}
;return bG;}
,__BX:function(bK){var name=null;if(!qx.lang.Type.isString(bK)){var bJ=this.getGroups().indexOf(bK);this.__BS=true;name=v;if(bJ==-1){name+=this.getGroups().getLength();}
else {name+=bJ;}
;}
else {this.__BR=true;var name=bK;}
;return name;}
,__BY:function(){if(this.__BS&&this.__BT||this.__BS&&this.__BR){throw new Error(r+z);}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__sn=this.__BP=this.__BQ=null;if(this.__BO){this.__BO.dispose();}
;}
});}
)();
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__jw={};}
,properties:{anonymous:{refine:true,init:true}},members:{__jw:null,__bR:null,__sD:null,__sE:null,__rA:null,__qb:null,getFirstRow:function(){return this.__sD;}
,getFirstColumn:function(){return this.__sE;}
,getRowSizes:function(){return this.__rA||[];}
,getColumnSizes:function(){return this.__qb||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jw.fullUpdate||this.__jw.updateLayerWindow&&this.__jw.updateLayerData){this._fullUpdate.apply(this,this.__bR);}
else if(this.__jw.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bR);}
else if(this.__jw.updateLayerData&&this.__rA){this._updateLayerData();}
;if(this.__jw.fullUpdate||this.__jw.updateLayerWindow){var d=this.__bR;this.__sD=d[0];this.__sE=d[1];this.__rA=d[2];this.__qb=d[3];}
;this.__jw={};}
,_updateLayerData:function(){this._fullUpdate(this.__sD,this.__sE,this.__rA,this.__qb);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__jw.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bR=arguments;this.__jw.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bR=arguments;this.__jw.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jw=this.__bR=this.__rA=this.__qb=null;}
});}
)();
...
;this.__Ca={};this.__Cb={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__Cc:null,__Cd:null,__Ca:null,__Cb:null,setColor:function(h,g){if(g){this.__Ca[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__Ca[h]);}
;}
,clearCustomColors:function(){this.__Ca={};this.updateLayerData();}
,getColor:function(i){var j=this.__Ca[i];if(j){return j;}
else {return i%2==0?this.__Cc:this.__Cd;}
;}
,_applyColorEven:function(l,k){if(l){this.__Cc=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__Cc=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__Cd=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__Cd=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__Cb[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__Cb[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__Cb[q];}
},destruct:function(){this.__Ca=this.__Cb=null;}
});}
)();
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__Ce(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__Ce(K)){this.updateLayerData();}
;}
,__Ce:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
(function(){var a="cell.type",b="model[",c="groups[",d="model",f="",g="changeDelegate",h="label",i="qx.ui.list.core.MWidgetController",j="icon",k="]",l="value",m="BindingIds",n=".",o="group",p="String";qx.Mixin.define(i,{construct:function(){this.__sy=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},groupLabelPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},groupLabelOptions:{nullable:true},delegate:{event:g,init:null,nullable:true}},members:{__sy:null,bindDefaultProperties:function(q,r){if(q.getUserData(a)!=o){this.bindProperty(f,d,null,q,r);this.bindProperty(this.getLabelPath(),h,this.getLabelOptions(),q,r);if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),j,this.getIconOptions(),q,r);}
;}
else {this.bindProperty(this.getGroupLabelPath(),l,this.getGroupLabelOptions(),q,r);}
;}
,bindProperty:function(u,x,v,t,s){var y=t.getUserData(a);var w=this.__sz(s,u,y);if(v){v.ignoreConverter=d;}
;var z=this._list.bind(w,t,x,v);this.__sA(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__sz(A,D,G);var H=F.bind(B,this._list,C,E);this.__sA(F,H);}
,removeBindings:function(){while(this.__sy.length>0){var I=this.__sy.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_removeBindingsFrom:function(T){var U=this.__sB(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__sy,T)){qx.lang.Array.remove(this.__sy,T);}
;}
,__sz:function(X,ba,Y){var W=b+X+k;if(Y==o){W=c+X+k;}
;if(ba!=null&&ba!=f){W+=n+ba;}
;return W;}
,__sA:function(bc,bd){var bb=this.__sB(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
;if(!qx.lang.Array.contains(this.__sy,bc)){this.__sy.push(bc);}
;}
,__sB:function(be){var bf=be.getUserData(m);if(bf==null){bf=[];be.setUserData(m,bf);}
;return bf;}
},destruct:function(){this.__sy=null;}
});}
)();
...
,styleSelectabled:function(v){var u=this.__Cf(v);this._styleSelectabled(u);}
,styleUnselectabled:function(x){var w=this.__Cf(x);this._styleUnselectabled(w);}
...
;}
,_styleSelectabled:function(A){this.__Cg(A,{selected:1});}
,_styleUnselectabled:function(B){this.__Cg(B,{});}
...
,__Cf:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__Cg:function(I,H){if(I==null){return;}
...
;this._cellProvider=h;this.__sF=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__sF:null,getRenderedCellWidget:function(q,n){if(this._getChildren().length===0){return null;}
...
;}
,_getSpacer:function(){var r=this.__sF.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(B,v,A,z){var C=this._cellProvider;var H=this._getChildren().concat();for(var i=0;i<H.length;i++ ){var F=H[i];if(F.getUserData(g)){this.__sF.push(F);}
...
;}
;}
;var L=this._cellProvider;var P=this._getChildren().concat();for(var i=0;i<P.length;i++ ){if(!bb[i]){var W=P[i];if(W.getUserData(g)){this.__sF.push(W);}
...
;this._cellProvider=this.__sF=null;}
});}
)();
...
(function(){var a="created",b="qx.ui.virtual.cell.AbstractWidget",c="cell.states",d="abstract method call",e="qx.event.type.Data";qx.Class.define(b,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){qx.core.Object.call(this);this.__cW=[];}
,events:{"created":e},members:{__cW:null,_createWidget:function(){throw new Error(d);}
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__sG();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cW.push(p);}
,_cleanupPool:function(){var q=this.__cW.pop();while(q){q.destroy();q=this.__cW.pop();}
;}
,__sG:function(){var r=this.__cW.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
},destruct:function(){this._cleanupPool();this.__cW=null;}
});}
)();
