...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.dab52f77ff10.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__CC:null,__CD:null,__ef:null,__CE:null,__CF:null,setPrefetchX:function(o,r,p,q){this.__CC=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__CD=[v,u,t,s];}
,_onInterval:function(){var w=this.__CC;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__CD;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__CE){y.getChildControl(j).removeListenerById(this.__CE);}
;if(this.__CF){y.getChildControl(l).removeListenerById(this.__CF);}
;}
...
;this.__CE=z.getChildControl(j).addListener(g,this.__ef.restart,this.__ef);this.__CF=z.getChildControl(l).addListener(g,this.__ef.restart,this.__ef);}
else {this.__ef.stop();}
;}
,_applyInterval:function(B,A){this.__ef.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__CC=this.__CD=null;this._disposeObjects(b);}
});}
)();
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="pointerover",h="network-server.png",i="row",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__nV=[];}
,members:{_pool:null,__nV:null,getCellData:function(t,s){if(!this.__nV[t]){this.__nV[t]=[];}
;if(!this.__nV[t][s]){this.__nV[t][s]={label:this.__Bu(),icon:this.__Bv()};}
;return this.__nV[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(g,function(){var x=this.__Bv();v.setIcon(x);this.__nV[w][u].icon=x;}
,this);}
...
;}
,__Bu:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__Bv:function(){var z=a;var B=e;var A=[d,k,h,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
},destruct:function(){this._pool=this.__nV=null;}
});}
)();
