...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.89d9010d711b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:g},interval:{check:k,init:200,apply:a}},members:{__Ck:null,__Cl:null,__du:null,__Cm:null,__Cn:null,setPrefetchX:function(o,r,p,q){this.__Ck=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__Cl=[v,u,t,s];}
,_onInterval:function(){var w=this.__Ck;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Cl;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__Cm){y.getChildControl(j).removeListenerById(this.__Cm);}
;if(this.__Cn){y.getChildControl(l).removeListenerById(this.__Cn);}
;}
...
;this.__Cm=z.getChildControl(j).addListener(f,this.__du.restart,this.__du);this.__Cn=z.getChildControl(l).addListener(f,this.__du.restart,this.__du);}
else {this.__du.stop();}
;}
,_applyInterval:function(B,A){this.__du.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__Ck=this.__Cl=null;this._disposeObjects(h);}
});}
)();
