...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.f0d6d9928fbd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__CA:null,__CB:null,__dE:null,__CC:null,__CD:null,setPrefetchX:function(o,r,p,q){this.__CA=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__CB=[v,u,t,s];}
,_onInterval:function(){var w=this.__CA;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__CB;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__CC){y.getChildControl(j).removeListenerById(this.__CC);}
;if(this.__CD){y.getChildControl(l).removeListenerById(this.__CD);}
;}
...
;this.__CC=z.getChildControl(j).addListener(g,this.__dE.restart,this.__dE);this.__CD=z.getChildControl(l).addListener(g,this.__dE.restart,this.__dE);}
else {this.__dE.stop();}
;}
,_applyInterval:function(B,A){this.__dE.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__CA=this.__CB=null;this._disposeObjects(b);}
});}
)();
