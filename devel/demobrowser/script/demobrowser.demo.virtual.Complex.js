...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.e676c031091b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:g},interval:{check:k,init:200,apply:a}},members:{__Cp:null,__Cq:null,__du:null,__Cr:null,__Cs:null,setPrefetchX:function(o,r,p,q){this.__Cp=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__Cq=[v,u,t,s];}
,_onInterval:function(){var w=this.__Cp;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Cq;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__Cr){y.getChildControl(j).removeListenerById(this.__Cr);}
;if(this.__Cs){y.getChildControl(l).removeListenerById(this.__Cs);}
;}
...
;this.__Cr=z.getChildControl(j).addListener(f,this.__du.restart,this.__du);this.__Cs=z.getChildControl(l).addListener(f,this.__du.restart,this.__du);}
else {this.__du.stop();}
;}
,_applyInterval:function(B,A){this.__du.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__Cp=this.__Cq=null;this._disposeObjects(h);}
});}
)();
