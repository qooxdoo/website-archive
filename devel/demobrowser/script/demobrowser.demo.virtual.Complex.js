...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.e5ea5bcd5231.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:h,nullable:true,init:null,apply:g},interval:{check:j,init:200,apply:a}},members:{__Cs:null,__Ct:null,__dv:null,__Cu:null,__Cv:null,setPrefetchX:function(o,r,p,q){this.__Cs=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__Ct=[v,u,t,s];}
,_onInterval:function(){var w=this.__Cs;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Ct;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__Cu){y.getChildControl(i).removeListenerById(this.__Cu);}
;if(this.__Cv){y.getChildControl(k).removeListenerById(this.__Cv);}
;}
...
;this.__Cu=z.getChildControl(i).addListener(f,this.__dv.restart,this.__dv);this.__Cv=z.getChildControl(k).addListener(f,this.__dv.restart,this.__dv);}
else {this.__dv.stop();}
;}
,_applyInterval:function(B,A){this.__dv.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__Cs=this.__Ct=null;this._disposeObjects(l);}
});}
)();
