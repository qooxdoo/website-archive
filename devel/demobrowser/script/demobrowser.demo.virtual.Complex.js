...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.efd8cac62319.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applyInterval",b="appear",c="qx.debug",d="interval",e="qx.ui.virtual.behavior.Prefetch",f="scroll",g="_applyScroller",h="qx.ui.virtual.core.Scroller",i="scrollbar-x",j="Integer",k="scrollbar-y",l="__dv";qx.Class.define(e,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(c)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__dv=new qx.event.Timer(this.getInterval());this.__dv.addListener(d,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:h,nullable:true,init:null,apply:g},interval:{check:j,init:200,apply:a}},members:{__Cr:null,__Cs:null,__dv:null,__Ct:null,__Cu:null,setPrefetchX:function(o,r,p,q){this.__Cr=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__Cs=[v,u,t,s];}
,_onInterval:function(){var w=this.__Cr;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Cs;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__Ct){y.getChildControl(i).removeListenerById(this.__Ct);}
;if(this.__Cu){y.getChildControl(k).removeListenerById(this.__Cu);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__dv.stop();z.addListenerOnce(b,this.__dv.start,this.__dv);}
else {this.__dv.restart();}
;this.__Ct=z.getChildControl(i).addListener(f,this.__dv.restart,this.__dv);this.__Cu=z.getChildControl(k).addListener(f,this.__dv.restart,this.__dv);}
else {this.__dv.stop();}
;}
,_applyInterval:function(B,A){this.__dv.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__Cr=this.__Cs=null;this._disposeObjects(l);}
});}
)();
