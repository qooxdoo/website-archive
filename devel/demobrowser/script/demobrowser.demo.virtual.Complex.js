...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.89019d33e5f9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="__dD",b="_applyInterval",c="appear",d="qx.debug",e="interval",f="qx.ui.virtual.behavior.Prefetch",g="scroll",h="_applyScroller",i="qx.ui.virtual.core.Scroller",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(f,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(d)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__dD=new qx.event.Timer(this.getInterval());this.__dD.addListener(e,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:b}},members:{__BJ:null,__BK:null,__dD:null,__BL:null,__BM:null,setPrefetchX:function(o,r,p,q){this.__BJ=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__BK=[v,u,t,s];}
,_onInterval:function(){var w=this.__BJ;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__BK;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__BL){y.getChildControl(j).removeListenerById(this.__BL);}
;if(this.__BM){y.getChildControl(l).removeListenerById(this.__BM);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__dD.stop();z.addListenerOnce(c,this.__dD.start,this.__dD);}
else {this.__dD.restart();}
;this.__BL=z.getChildControl(j).addListener(g,this.__dD.restart,this.__dD);this.__BM=z.getChildControl(l).addListener(g,this.__dD.restart,this.__dD);}
else {this.__dD.stop();}
;}
,_applyInterval:function(B,A){this.__dD.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__BJ=this.__BK=null;this._disposeObjects(a);}
});}
)();
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="pointerover",h="network-server.png",i="row",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__bk=[];}
,members:{_pool:null,__bk:null,getCellData:function(t,s){if(!this.__bk[t]){this.__bk[t]=[];}
;if(!this.__bk[t][s]){this.__bk[t][s]={label:this.__bl(),icon:this.__bm()};}
;return this.__bk[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(g,function(){var x=this.__bm();v.setIcon(x);this.__bk[w][u].icon=x;}
,this);}
...
;}
,__bl:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__bm:function(){var z=a;var B=e;var A=[d,k,h,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
},destruct:function(){this._pool=this.__bk=null;}
});}
)();
