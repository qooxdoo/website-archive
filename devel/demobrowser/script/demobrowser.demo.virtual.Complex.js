...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.53b1a1ebd1d8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applyInterval",b="__dC",c="appear",d="qx.debug",e="interval",f="qx.ui.virtual.behavior.Prefetch",g="scroll",h="_applyScroller",i="qx.ui.virtual.core.Scroller",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(f,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(d)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__dC=new qx.event.Timer(this.getInterval());this.__dC.addListener(e,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__Ct:null,__Cu:null,__dC:null,__Cv:null,__Cw:null,setPrefetchX:function(o,r,p,q){this.__Ct=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__Cu=[v,u,t,s];}
,_onInterval:function(){var w=this.__Ct;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Cu;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__Cv){y.getChildControl(j).removeListenerById(this.__Cv);}
;if(this.__Cw){y.getChildControl(l).removeListenerById(this.__Cw);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__dC.stop();z.addListenerOnce(c,this.__dC.start,this.__dC);}
else {this.__dC.restart();}
;this.__Cv=z.getChildControl(j).addListener(g,this.__dC.restart,this.__dC);this.__Cw=z.getChildControl(l).addListener(g,this.__dC.restart,this.__dC);}
else {this.__dC.stop();}
;}
,_applyInterval:function(B,A){this.__dC.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__Ct=this.__Cu=null;this._disposeObjects(b);}
});}
)();
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="pointerover",h="network-server.png",i="row",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__bm=[];}
,members:{_pool:null,__bm:null,getCellData:function(t,s){if(!this.__bm[t]){this.__bm[t]=[];}
;if(!this.__bm[t][s]){this.__bm[t][s]={label:this.__bn(),icon:this.__bo()};}
;return this.__bm[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(g,function(){var x=this.__bo();v.setIcon(x);this.__bm[w][u].icon=x;}
,this);}
...
;}
,__bn:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__bo:function(){var z=a;var B=e;var A=[d,k,h,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
},destruct:function(){this._pool=this.__bm=null;}
});}
)();
