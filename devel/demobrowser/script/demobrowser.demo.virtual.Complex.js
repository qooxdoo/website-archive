...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.949512e047dd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:b}},members:{__Cv:null,__Cw:null,__dD:null,__Cx:null,__Cy:null,setPrefetchX:function(o,r,p,q){this.__Cv=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__Cw=[v,u,t,s];}
,_onInterval:function(){var w=this.__Cv;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Cw;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__Cx){y.getChildControl(j).removeListenerById(this.__Cx);}
;if(this.__Cy){y.getChildControl(l).removeListenerById(this.__Cy);}
;}
...
;this.__Cx=z.getChildControl(j).addListener(g,this.__dD.restart,this.__dD);this.__Cy=z.getChildControl(l).addListener(g,this.__dD.restart,this.__dD);}
else {this.__dD.stop();}
;}
,_applyInterval:function(B,A){this.__dD.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__Cv=this.__Cw=null;this._disposeObjects(a);}
});}
)();
