...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.3c0030eab8f6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__CC:null,__CD:null,__dE:null,__CE:null,__CF:null,setPrefetchX:function(o,r,p,q){this.__CC=[o,r,p,q];}
...
;this.__CE=z.getChildControl(j).addListener(g,this.__dE.restart,this.__dE);this.__CF=z.getChildControl(l).addListener(g,this.__dE.restart,this.__dE);}
else {this.__dE.stop();}
;}
