...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex.99c3880de14a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__Am:null,__An:null,__dE:null,__Ao:null,__Ap:null,setPrefetchX:function(o,r,p,q){this.__Am=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__An=[v,u,t,s];}
,_onInterval:function(){var w=this.__Am;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__An;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__Ao){y.getChildControl(j).removeListenerById(this.__Ao);}
;if(this.__Ap){y.getChildControl(l).removeListenerById(this.__Ap);}
;}
...
;this.__Ao=z.getChildControl(j).addListener(g,this.__dE.restart,this.__dE);this.__Ap=z.getChildControl(l).addListener(g,this.__dE.restart,this.__dE);}
else {this.__dE.stop();}
;}
,_applyInterval:function(B,A){this.__dE.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__Am=this.__An=null;this._disposeObjects(b);}
});}
)();
...
(function(){var a="icon/",b=" / ",c="",d="folder.png",e="places/",f="demobrowser.demo.virtual.DemoLayer",g="pointerover",h="network-server.png",i="row",k="user-trash.png",l="foobar!",m="changeValue",n="column",o="network-workgroup.png",p="qx.ui.basic.Atom",q="/",r="user-desktop.png";qx.Class.define(f,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__Y=[];}
,members:{_pool:null,__Y:null,getCellData:function(t,s){if(!this.__Y[t]){this.__Y[t]=[];}
;if(!this.__Y[t][s]){this.__Y[t][s]={label:this.__ba(),icon:this.__bb()};}
;return this.__Y[t][s];}
,getCellWidget:function(w,u){var v;if(u%2==0){v=this._pool.atom.pop();if(!v){v=new qx.ui.basic.Atom();v.addListener(g,function(){var x=this.__bb();v.setIcon(x);this.__Y[w][u].icon=x;}
,this);}
...
;}
,__ba:function(){var name=c;for(var j=0;j<10;j++ ){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__bb:function(){var z=a;var B=e;var A=[d,k,h,o,r];var C=Math.floor(Math.random()*4);return (z+16+q+B+A[C]);}
},destruct:function(){this._pool=this.__Y=null;}
});}
)();
