...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ModelDebugging.c7fec727d39a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{responseJson:null,__ch:null,__vb:null,__vc:null,__vd:null,__ve:null,__vf:null,__sz:null,__vg:e,open:function(t,p){if(this.__sz){return;}
...
;r[q]=s;this.__vf=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hD(c,[t,p]);}
...
,dispose:function(){this.__vh();this.__hD(d);}
,_onNativeLoad:function(){this.status=this.__vd?200:500;this.__hD(i);}
