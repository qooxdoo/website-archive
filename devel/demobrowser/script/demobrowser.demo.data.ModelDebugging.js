...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ModelDebugging.541720b29a1b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,open:function(H,G){if(this.__sA){return;}
;this.__uU();this.__sj=null;this.__sv=G;if(this.__va(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__sA){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__sv=qx.util.Uri.appendParamsToUrl(this.__sv,K);return this;}
,send:function(){if(this.__sA){return null;}
;var M=this.__uX(),L=this.__uR,N=this;if(this.timeout>0){this.__dh=window.setTimeout(this.__sg,this.timeout);}
...
,abort:function(){if(this.__sA){return null;}
;this.__sj=true;this.__uY();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__sA){return null;}
;if(this.__va(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__sA){return null;}
;if(this.__va(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__uS=P;}
,dispose:function(){var Q=this.__uT;if(!this.__sA){if(Q){Q.onload=Q.onreadystatechange=null;this.__uY();}
;if(this.__dh){window.clearTimeout(this.__dh);}
;this.__sA=true;}
;}
,isDisposed:function(){return !!this.__sA;}
,_getUrl:function(){return this.__sv;}
...
;}
,_onNativeLoad:function(){var S=this.__uT,R=this.__uS,T=this;if(this.__sj){return;}
...
,__uT:null,__uR:null,__sv:n,__uP:null,__uQ:null,__sg:null,__dh:null,__sj:null,__sA:null,__uU:function(){this.readyState=0;this.status=0;this.statusText=n;}
...
,__uX:function(){var X=this.__uT=document.createElement(i);X.src=this.__sv;X.onerror=this.__uQ;X.onload=this.__uP;if(this.__va(x)===w&&this.__va(l)<9){X.onreadystatechange=this.__uP;}
;return X;}
...
,members:{responseJson:null,__ch:null,__vb:null,__vc:null,__vd:null,__ve:null,__vf:null,__sA:null,__vg:e,open:function(t,p){if(this.__sA){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__vd=false;q=this.__vb||b;s=this.__vc||this.__vg+n+this.__ch+m;if(!this.__vc){this.constructor[this.__ch]=this;}
...
;r[q]=s;this.__vf=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hF(c,[t,p]);}
,callback:function(v){if(this.__sA){return;}
;this.__vd=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__ch]=undefined;this.__vh();}
...
,dispose:function(){this.__vh();this.__hF(d);}
,_onNativeLoad:function(){this.status=this.__vd?200:500;this.__hF(i);}
,__vh:function(){if(this.__ve&&window[this.__vc]){window[this.__vc]=undefined;this.__ve=false;}
;}
,__hF:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__vi:function(){this.__ch=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
...
;return br;}
;return A;}
,startDisposeProfiling:qx.core.Environment.select(c,{"true":function(){this.disposeProfilingActive=true;this.__vL=qx.core.ObjectRegistry.getNextHash();}
,"default":(function(){}
)}),stopDisposeProfiling:qx.core.Environment.select(c,{"true":function(bA){if(!this.__vL){qx.log.Logger.error(s+this.classname+F);return [];}
...
;}
;var bB=qx.core.ObjectRegistry.getNextHash();var bD=qx.core.ObjectRegistry.getPostId();var bE=qx.core.ObjectRegistry.getStackTraces();for(var bC=this.__vL;bC<bB;bC++ ){var by=qx.core.ObjectRegistry.fromHashCode(bC+bD);if(by&&by.isDisposed&&!by.isDisposed()){if(bA&&typeof bA==h&&!bA(by)){continue;}
