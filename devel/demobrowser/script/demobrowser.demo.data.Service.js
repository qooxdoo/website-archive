...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.f6c214a87988.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="application/json",c="json",d="aborted",e="loaded",f="qx.event.type.Data",g="error",h="fail",i="receiving",j="queued",k="changeState",l="success",m="String",n="changePhase",o="sending",p="_marshaler",q="completed",r="__uD",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":f,"error":f},properties:{model:{nullable:true,event:a},state:{check:[u,j,o,i,q,d,w,s],init:u,event:k},url:{check:m,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__uD:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__uD;}
,_setRequest:function(C){this.__uD=C;}
,_createRequest:function(D){if(this.__uD){this.__uD.dispose();this.__uD=null;}
...
,_onChangePhase:function(I){var G=I.getData(),J={},H;J={"opened":u,"sent":o,"loading":i,"success":q,"abort":d,"timeout":w,"statusError":s};H=J[G];if(H){this.setState(H);}
;}
...
;this.fireDataEvent(e,this.getModel());if(this.__uD){this.__uD.dispose();this.__uD=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__uD!=null){this._disposeObjects(r);}
...
;this.__rV={};var S=this._transport=this._createTransport();this._setPhase(H);this.__rW=qx.lang.Function.bind(this._onReadyStateChange,this);this.__rX=qx.lang.Function.bind(this._onLoad,this);this.__rY=qx.lang.Function.bind(this._onLoadEnd,this);this.__sa=qx.lang.Function.bind(this._onAbort,this);this.__sb=qx.lang.Function.bind(this._onTimeout,this);this.__sc=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__rW;S.onload=this.__rX;S.onloadend=this.__rY;S.onabort=this.__sa;S.ontimeout=this.__sb;S.onerror=this.__sc;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__rW:null,__rX:null,__rY:null,__sa:null,__sb:null,__sc:null,__sd:null,__se:null,__sf:null,__rV:null,__sg:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__se=true;this.__sf=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__sh());qx.lang.Object.mergeWith(bd,this.__sg);qx.lang.Object.mergeWith(bd,this.__rV);return bd;}
,__sh:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__rV[bh]=bi;}
,getRequestHeader:function(bj){return this.__rV[bj];}
,removeRequestHeader:function(bk){if(this.__rV[bk]){delete this.__rV[bk];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__sf;}
...
,getResponse:function(){return this.__sd;}
,_setResponse:function(bo){var bn=bo;if(this.__sd!==bo){this.__sd=bo;this.fireEvent(I,qx.event.type.Data,[this.__sd,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__se){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__si();}
;}
,__si:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__sf;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__sf=br;this.fireDataEvent(c,br,bs);}
...
(function(){var a="text",b="Retry open native request with method: ",c="activex",d="No XHR support available.",f="If-None-Match",g="xhr",h="If-Modified-Since",i="engine.version",j="onunload",k="GET",l="-1",m="qx.debug.io",n="Undefined",o="Open native request with method: ",p="error",q="loadend",r="Blob",s="HTMLDocument",t="progress",u="load",v="Received native readyState: ",w="abort",x=", url: ",y="String",z="browser.documentmode",A="document",B="",C="readystatechange",D="Microsoft.XMLHTTP",E="Already disposed",F="browser.version",G="opera",H="qx.bom.request.Xhr",I="on",J="timeout",K="gecko",L="If-Match",M="mshtml",N="engine.name",O="Microsoft.XMLDOM",P="file:",Q="Send native request",R="FormData",S="If-Range",T="Content-Type",U="io.xhr",V="Not enough arguments",W="ArrayBuffer",X="undefined",Y=", async: ",bb="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(H,{extend:Object,construct:function(){var bc=qx.Bootstrap.bind(this.__sA,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__sk=qx.event.GlobalError.observeMethod(bc);}
else {this.__sk=bc;}
;this.__sl=qx.Bootstrap.bind(this.__sy,this);this.__sm=qx.Bootstrap.bind(this.__sz,this);this.__sb=qx.Bootstrap.bind(this.__sE,this);this.__sx();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sn=qx.Bootstrap.bind(this.__sH,this);window.attachEvent(j,this.__sn);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":H,"error":H,"loadend":H,"timeout":H,"abort":H,"load":H,"progress":H},members:{readyState:0,responseText:B,response:null,responseXML:null,status:0,statusText:B,responseType:B,timeout:0,progress:null,open:function(bh,bd,be,bg,bf){this.__sJ();if(typeof bd===X){throw new Error(V);}
else if(typeof bh===X){bh=k;}
;this.__se=false;this.__so=false;this.__sp=false;this.__sq=bd;if(typeof be==X){be=true;}
;this.__sr=be;this.status=0;this.statusText=this.responseText=B;this.responseXML=null;this.response=null;if(!this.__sI()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__sx();}
;this.__st.onreadystatechange=this.__sk;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,o+bh+x+bd+Y+be);}
;this.__st.open(bh,bd,be,bg,bf);}
catch(bi){if(!qx.util.Request.isCrossDomain(bd)){throw bi;}
;if(!this.__sr){this.__ss=bi;}
;if(this.__sr){if(window.XDomainRequest){this.readyState=4;this.__st=new XDomainRequest();this.__st.onerror=qx.Bootstrap.bind(function(){this._emit(C);this._emit(p);this._emit(q);}
,this);if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+bh+x+bd+Y+be);}
;this.__st.open(bh,bd,be,bg,bf);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__sv){return;}
;this.readyState=4;this._emit(C);this._emit(p);this._emit(q);}
,this));}
;}
;if(qx.core.Environment.get(N)===M&&qx.core.Environment.get(z)<9&&this.__st.readyState>0){this.__st.setRequestHeader(h,l);}
;if(qx.core.Environment.get(N)===K&&parseInt(qx.core.Environment.get(i),10)<2&&!this.__sr){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(C);}
;}
,setRequestHeader:function(bj,bk){this.__sJ();if(bj==L||bj==h||bj==f||bj==S){this.__sp=true;}
;this.__st.setRequestHeader(bj,bk);return this;}
,send:function(bm){this.__sJ();if(!this.__sr&&this.__ss){throw this.__ss;}
;if(qx.core.Environment.get(N)===G&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__su=window.setTimeout(this.__sb,this.timeout);}
;bm=typeof bm==X?null:bm;var bl=qx.Bootstrap.getClass(bm);bm=(bm!==null&&this.__sw.indexOf(bl)===-1)?bm.toString():bm;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,Q);}
;if(this.__sr){this.__st.responseType=this.responseType;}
;this.__st.send(bm);}
catch(bo){if(!this.__sr){throw bo;}
;if(this._getProtocol()===P){this.readyState=2;this.__sB();var bn=this;window.setTimeout(function(){if(bn.__sv){return;}
;bn.readyState=3;bn.__sB();bn.readyState=4;bn.__sB();}
);}
;}
;if(qx.core.Environment.get(N)===K&&!this.__sr){this.__sA();}
;this.__so=true;return this;}
,abort:function(){this.__sJ();this.__se=true;this.__st.abort();if(this.__st&&this.readyState!==qx.bom.request.Xhr.DONE){this.readyState=this.__st.readyState;}
;return this;}
...
,getResponseHeader:function(br){this.__sJ();if(qx.core.Environment.get(z)===9&&this.__st.aborted){return B;}
;return this.__st.getResponseHeader(br);}
,getAllResponseHeaders:function(){this.__sJ();if(qx.core.Environment.get(z)===9&&this.__st.aborted){return B;}
;return this.__st.getAllResponseHeaders();}
,overrideMimeType:function(bs){this.__sJ();if(this.__st.overrideMimeType){this.__st.overrideMimeType(bs);}
else {throw new Error(bb);}
;return this;}
,getRequest:function(){return this.__st;}
,dispose:function(){if(this.__sv){return false;}
;window.clearTimeout(this.__su);if(window.detachEvent){window.detachEvent(j,this.__sn);}
;try{this.__st.onreadystatechange;}
catch(bu){return false;}
;var bt=function(){}
;this.__st.onreadystatechange=bt;this.__st.onload=bt;this.__st.onerror=bt;this.__st.onprogress=bt;this.abort();this.__st=null;this.__sv=true;return true;}
,isDisposed:function(){return !!this.__sv;}
...
,_getProtocol:function(){var bw=this.__sq;var bx=/^(\w+:)\/\//;if(bw!==null&&bw.match){var by=bw.match(bx);if(by&&by[1]){return by[1];}
;}
;return window.location.protocol;}
,__st:null,__sr:null,__sk:null,__sl:null,__sm:null,__sn:null,__sb:null,__so:null,__sq:null,__se:null,__dg:null,__sv:null,__su:null,__ss:null,__sp:null,__sw:null,__sx:function(){this.__st=this._createNativeXhr();this.__st.onreadystatechange=this.__sk;if(qx.Bootstrap.getClass(this.__st.onabort)!==n){this.__st.onabort=this.__sl;}
;if(qx.Bootstrap.getClass(this.__st.onprogress)!==n){this.__st.onprogress=this.__sm;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__sv=this.__so=this.__se=false;this.__sw=[W,r,s,y,R];}
,__sy:function(){if(!this.__se){this.abort();}
;}
,__sz:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(t);}
,__sA:function(){var bz=this.__st,bA=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,v+bz.readyState);}
;if(this.readyState==bz.readyState){return;}
;this.readyState=bz.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__se&&!this.__so){return;}
;if(!this.__sr&&(bz.readyState==2||bz.readyState==3)){return;}
...
;if(bA){this.__sF();this.__sG();}
;}
;this.__sB();if(this.readyState==qx.bom.request.Xhr.DONE){if(bz){bz.onreadystatechange=function(){}
;}
;}
;}
,__sB:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__su);}
;this._emit(C);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sC();}
;}
,__sC:function(){if(this.__dg){this._emit(J);if(qx.core.Environment.get(N)===G){this._emit(p);}
;this.__dg=false;}
else {if(this.__se){this._emit(w);}
else {if(this.__sD()){this._emit(p);}
else {this._emit(u);}
;}
;}
;this._emit(q);}
,__sD:function(){var bC;if(this._getProtocol()===P){bC=!this.responseText;}
else {bC=!this.statusText&&this.status!==204;}
;return bC;}
,__sE:function(){var bD=this.__st;this.readyState=qx.bom.request.Xhr.DONE;this.__dg=true;bD.aborted=true;bD.abort();this.responseText=B;this.responseXML=null;this.__sB();}
,__sF:function(){var bE=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===P&&this.status===0&&bE){if(!this.__sD()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(N)===G){if(bE&&this.__sp&&!this.__se&&this.status===0){this.status=304;}
;}
;}
,__sG:function(){if(qx.core.Environment.get(N)==M&&(this.getResponseHeader(T)||B).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bF=new window.ActiveXObject(O);bF.async=false;bF.validateOnParse=false;bF.loadXML(this.responseText);this.responseXML=bF;}
;}
,__sH:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sI:function(){var name=qx.core.Environment.get(N);var bG=qx.core.Environment.get(F);return !(name==M&&bG<9||name==K&&bG<3.5);}
,__sJ:function(){if(this.__sv){throw new Error(E);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__sK:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__sK=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__sK=i;}
,_getParser:function(k){var j=this.__sK,m=c,l=c;if(j){return j;}
...
(function(){var a="url: ",b="qx.debug.io",c="qx.bom.request.Script",d="Invalid state",e="head",f="error",g="loadend",h="qx.debug",i="script",j="load",k="Unknown response headers",l="browser.documentmode",m="abort",n="",o="Received native readyState: loaded",p="readystatechange",q="Response header cannot be determined for ",r="requests made with script transport.",s="opera",t="unknown",u="Open native request with ",v="Response headers cannot be determined for",w="mshtml",x="engine.name",y="Detected error",z="Send native request",A="on",B="timeout",C="Unknown environment key at this phase",D="Received native load";qx.Bootstrap.define(c,{construct:function(){this.__uR();this.__uM=qx.Bootstrap.bind(this._onNativeLoad,this);this.__uN=qx.Bootstrap.bind(this._onNativeError,this);this.__sb=qx.Bootstrap.bind(this._onTimeout,this);this.__uO=document.head||document.getElementsByTagName(e)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__uT()?0:15000;}
,events:{"readystatechange":c,"error":c,"loadend":c,"timeout":c,"abort":c,"load":c},members:{readyState:null,status:null,statusText:null,timeout:null,__uP:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(H,G){if(this.__sv){return;}
;this.__uR();this.__se=null;this.__sq=G;if(this.__uW(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__sv){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__sq=qx.util.Uri.appendParamsToUrl(this.__sq,K);return this;}
,send:function(){if(this.__sv){return null;}
;var M=this.__uU(),L=this.__uO,N=this;if(this.timeout>0){this.__de=window.setTimeout(this.__sb,this.timeout);}
;if(this.__uW(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;L.insertBefore(M,L.firstChild);window.setTimeout(function(){N._readyStateChange(2);N._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__sv){return null;}
;this.__se=true;this.__uV();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__sv){return null;}
;if(this.__uW(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__sv){return null;}
;if(this.__uW(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__uP=P;}
,dispose:function(){var Q=this.__uQ;if(!this.__sv){if(Q){Q.onload=Q.onreadystatechange=null;this.__uV();}
;if(this.__de){window.clearTimeout(this.__de);}
;this.__sv=true;}
;}
,isDisposed:function(){return !!this.__sv;}
,_getUrl:function(){return this.__sq;}
,_getScriptElement:function(){return this.__uQ;}
,_onTimeout:function(){this.__uS();if(!this.__uT()){this._emit(f);}
;this._emit(B);if(!this.__uT()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__uQ,R=this.__uP,T=this;if(this.__se){return;}
;if(this.__uW(x)===w&&this.__uW(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__uW(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__uW(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__uW(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__de){window.clearTimeout(this.__de);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__uS();this._emit(f);this._emit(g);}
,__uQ:null,__uO:null,__sq:n,__uM:null,__uN:null,__sb:null,__de:null,__se:null,__sv:null,__uR:function(){this.readyState=0;this.status=0;this.statusText=n;}
...
,__uT:function(){var W=this.__uW(x)===w&&this.__uW(l)<9;var V=this.__uW(x)===s;return !(W||V);}
,__uU:function(){var X=this.__uQ=document.createElement(i);X.src=this.__sq;X.onerror=this.__uN;X.onload=this.__uM;if(this.__uW(x)===w&&this.__uW(l)<9){X.onreadystatechange=this.__uM;}
;return X;}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__vf();}
,members:{responseJson:null,__cs:null,__uX:null,__uY:null,__va:null,__vb:null,__vc:null,__sv:null,__vd:e,open:function(t,p){if(this.__sv){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__va=false;q=this.__uX||b;s=this.__uY||this.__vd+n+this.__cs+m;if(!this.__uY){this.constructor[this.__cs]=this;}
else {if(!window[this.__uY]){this.__vb=true;window[this.__uY]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__uY+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__vc=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hw(c,[t,p]);}
,callback:function(v){if(this.__sv){return;}
;this.__va=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cs]=undefined;this.__ve();}
,setCallbackParam:function(w){this.__uX=w;return this;}
,setCallbackName:function(name){this.__uY=name;return this;}
,setPrefix:function(x){this.__vd=x;}
,getGeneratedUrl:function(){return this.__vc;}
,dispose:function(){this.__ve();this.__hw(d);}
,_onNativeLoad:function(){this.status=this.__va?200:500;this.__hw(i);}
,__ve:function(){if(this.__vb&&window[this.__uY]){window[this.__uY]=undefined;this.__vb=false;}
;}
,__hw:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__vf:function(){this.__cs=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
