...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.8b811dbaf7f4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="application/json",c="__uA",d="json",e="aborted",f="loaded",g="qx.event.type.Data",h="error",i="fail",j="receiving",k="queued",l="changeState",m="success",n="String",o="changePhase",p="sending",q="_marshaler",r="completed",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":g,"error":g},properties:{model:{nullable:true,event:a},state:{check:[u,k,p,j,r,e,w,s],init:u,event:l},url:{check:n,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__uA:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__uA;}
,_setRequest:function(C){this.__uA=C;}
,_createRequest:function(D){if(this.__uA){this.__uA.dispose();this.__uA=null;}
...
;this.fireDataEvent(f,this.getModel());if(this.__uA){this.__uA.dispose();this.__uA=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__uA!=null){this._disposeObjects(c);}
...
(function(){var a="Retry open native request with method: ",b="activex",c="No XHR support available.",d="If-None-Match",f="xhr",g="If-Modified-Since",h="engine.version",i="onunload",j="GET",k="-1",l="qx.debug.io",m="Undefined",n="Open native request with method: ",o="error",p="loadend",q="Blob",r="HTMLDocument",s="progress",t="load",u="Received native readyState: ",v="abort",w=", url: ",x="String",y="browser.documentmode",z="",A="readystatechange",B="Microsoft.XMLHTTP",C="Already disposed",D="browser.version",E="opera",F="qx.bom.request.Xhr",G="on",H="timeout",I="gecko",J="If-Match",K="mshtml",L="engine.name",M="Microsoft.XMLDOM",N="file:",O="Send native request",P="FormData",Q="If-Range",R="Content-Type",S="io.xhr",T="Not enough arguments",U="ArrayBuffer",V="undefined",W=", async: ",X="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(F,{extend:Object,construct:function(){var Y=qx.Bootstrap.bind(this.__sy,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__si=qx.event.GlobalError.observeMethod(Y);}
else {this.__si=Y;}
;this.__sj=qx.Bootstrap.bind(this.__sw,this);this.__sk=qx.Bootstrap.bind(this.__sx,this);this.__rY=qx.Bootstrap.bind(this.__sC,this);this.__sv();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sl=qx.Bootstrap.bind(this.__sF,this);window.attachEvent(i,this.__sl);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":F,"error":F,"loadend":F,"timeout":F,"abort":F,"load":F,"progress":F},members:{readyState:0,responseText:z,responseXML:null,status:0,statusText:z,timeout:0,progress:null,open:function(be,ba,bb,bd,bc){this.__sH();if(typeof ba===V){throw new Error(T);}
else if(typeof be===V){be=j;}
;this.__sc=false;this.__sm=false;this.__sn=false;this.__so=ba;if(typeof bb==V){bb=true;}
;this.__sp=bb;if(!this.__sG()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__sv();}
;this.__sr.onreadystatechange=this.__si;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,n+be+w+ba+W+bb);}
;this.__sr.open(be,ba,bb,bd,bc);}
catch(bf){if(!qx.util.Request.isCrossDomain(ba)){throw bf;}
;if(!this.__sp){this.__sq=bf;}
;if(this.__sp){if(window.XDomainRequest){this.readyState=4;this.__sr=new XDomainRequest();this.__sr.onerror=qx.Bootstrap.bind(function(){this._emit(A);this._emit(o);this._emit(p);}
,this);if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+be+w+ba+W+bb);}
;this.__sr.open(be,ba,bb,bd,bc);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__st){return;}
;this.readyState=4;this._emit(A);this._emit(o);this._emit(p);}
,this));}
;}
;if(qx.core.Environment.get(L)===K&&qx.core.Environment.get(y)<9&&this.__sr.readyState>0){this.__sr.setRequestHeader(g,k);}
;if(qx.core.Environment.get(L)===I&&parseInt(qx.core.Environment.get(h),10)<2&&!this.__sp){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(A);}
;}
,setRequestHeader:function(bg,bh){this.__sH();if(bg==J||bg==g||bg==d||bg==Q){this.__sn=true;}
;this.__sr.setRequestHeader(bg,bh);return this;}
,send:function(bj){this.__sH();if(!this.__sp&&this.__sq){throw this.__sq;}
...
;bj=typeof bj==V?null:bj;var bi=qx.Bootstrap.getClass(bj);bj=(bj!==null&&this.__su.indexOf(bi)===-1)?bj.toString():bj;try{if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,O);}
;this.__sr.send(bj);}
catch(bl){if(!this.__sp){throw bl;}
;if(this._getProtocol()===N){this.readyState=2;this.__sz();var bk=this;window.setTimeout(function(){if(bk.__st){return;}
;bk.readyState=3;bk.__sz();bk.readyState=4;bk.__sz();}
);}
;}
;if(qx.core.Environment.get(L)===I&&!this.__sp){this.__sy();}
...
,getResponseHeader:function(bo){this.__sH();if(qx.core.Environment.get(y)===9&&this.__sr.aborted){return z;}
;return this.__sr.getResponseHeader(bo);}
,getAllResponseHeaders:function(){this.__sH();if(qx.core.Environment.get(y)===9&&this.__sr.aborted){return z;}
;return this.__sr.getAllResponseHeaders();}
,overrideMimeType:function(bp){this.__sH();if(this.__sr.overrideMimeType){this.__sr.overrideMimeType(bp);}
else {throw new Error(X);}
;return this;}
,getRequest:function(){return this.__sr;}
,dispose:function(){if(this.__st){return false;}
;window.clearTimeout(this.__ss);if(window.detachEvent){window.detachEvent(i,this.__sl);}
;try{this.__sr.onreadystatechange;}
catch(br){return false;}
;var bq=function(){}
;this.__sr.onreadystatechange=bq;this.__sr.onload=bq;this.__sr.onerror=bq;this.__sr.onprogress=bq;this.abort();this.__sr=null;this.__st=true;return true;}
...
,_getProtocol:function(){var bt=this.__so;var bu=/^(\w+:)\/\//;if(bt!==null&&bt.match){var bv=bt.match(bu);if(bv&&bv[1]){return bv[1];}
;}
;return window.location.protocol;}
,__sr:null,__sp:null,__si:null,__sj:null,__sk:null,__sl:null,__rY:null,__sm:null,__so:null,__sc:null,__df:null,__st:null,__ss:null,__sq:null,__sn:null,__su:null,__sv:function(){this.__sr=this._createNativeXhr();this.__sr.onreadystatechange=this.__si;if(qx.Bootstrap.getClass(this.__sr.onabort)!==m){this.__sr.onabort=this.__sj;}
;if(qx.Bootstrap.getClass(this.__sr.onprogress)!==m){this.__sr.onprogress=this.__sk;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__st=this.__sm=this.__sc=false;this.__su=[U,q,r,x,P];}
,__sw:function(){if(!this.__sc){this.abort();}
;}
,__sx:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(s);}
,__sy:function(){var bw=this.__sr,bx=true;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Xhr,u+bw.readyState);}
;if(this.readyState==bw.readyState){return;}
;this.readyState=bw.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sc&&!this.__sm){return;}
;if(!this.__sp&&(bw.readyState==2||bw.readyState==3)){return;}
...
;if(bx){this.__sD();this.__sE();}
;}
;this.__sz();if(this.readyState==qx.bom.request.Xhr.DONE){if(bw){bw.onreadystatechange=function(){}
;}
;}
;}
,__sz:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__ss);}
;this._emit(A);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sA();}
;}
,__sA:function(){if(this.__df){this._emit(H);if(qx.core.Environment.get(L)===E){this._emit(o);}
;this.__df=false;}
else {if(this.__sc){this._emit(v);}
else {if(this.__sB()){this._emit(o);}
else {this._emit(t);}
;}
;}
;this._emit(p);}
,__sB:function(){var bz;if(this._getProtocol()===N){bz=!this.responseText;}
else {bz=!this.statusText&&this.status!==204;}
;return bz;}
,__sC:function(){var bA=this.__sr;this.readyState=qx.bom.request.Xhr.DONE;this.__df=true;bA.aborted=true;bA.abort();this.responseText=z;this.responseXML=null;this.__sz();}
,__sD:function(){var bB=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===N&&this.status===0&&bB){if(!this.__sB()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(L)===E){if(bB&&this.__sn&&!this.__sc&&this.status===0){this.status=304;}
;}
;}
,__sE:function(){if(qx.core.Environment.get(L)==K&&(this.getResponseHeader(R)||z).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bC=new window.ActiveXObject(M);bC.async=false;bC.validateOnParse=false;bC.loadXML(this.responseText);this.responseXML=bC;}
;}
,__sF:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sG:function(){var name=qx.core.Environment.get(L);var bD=qx.core.Environment.get(D);return !(name==K&&bD<9||name==I&&bD<3.5);}
,__sH:function(){if(this.__st){throw new Error(C);}
;}
...
;var M=this.__uR(),L=this.__uL,N=this;if(this.timeout>0){this.__dd=window.setTimeout(this.__rY,this.timeout);}
;if(this.__uT(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
...
;this.__sc=true;this.__uS();this._emit(m);return this;}
...
;if(this.__uT(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__st){return null;}
;if(this.__uT(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__uM=P;}
,dispose:function(){var Q=this.__uN;if(!this.__st){if(Q){Q.onload=Q.onreadystatechange=null;this.__uS();}
;if(this.__dd){window.clearTimeout(this.__dd);}
;this.__st=true;}
;}
,isDisposed:function(){return !!this.__st;}
,_getUrl:function(){return this.__so;}
,_getScriptElement:function(){return this.__uN;}
,_onTimeout:function(){this.__uP();if(!this.__uQ()){this._emit(f);}
;this._emit(B);if(!this.__uQ()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__uN,R=this.__uM,T=this;if(this.__sc){return;}
;if(this.__uT(x)===w&&this.__uT(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__uT(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__uT(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__uT(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__dd){window.clearTimeout(this.__dd);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__uP();this._emit(f);this._emit(g);}
,__uN:null,__uL:null,__so:n,__uJ:null,__uK:null,__rY:null,__dd:null,__sc:null,__st:null,__uO:function(){this.readyState=0;this.status=0;this.statusText=n;}
,_readyStateChange:function(U){this.readyState=U;this._emit(p);}
,_success:function(){this.__uS();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=n+this.status;}
,__uP:function(){this.__uS();this.readyState=4;this.status=0;this.statusText=null;}
,__uQ:function(){var W=this.__uT(x)===w&&this.__uT(l)<9;var V=this.__uT(x)===s;return !(W||V);}
,__uR:function(){var X=this.__uN=document.createElement(i);X.src=this.__so;X.onerror=this.__uK;X.onload=this.__uJ;if(this.__uT(x)===w&&this.__uT(l)<9){X.onreadystatechange=this.__uJ;}
;return X;}
,__uS:function(){var Y=this.__uN;if(Y&&Y.parentNode){this.__uL.removeChild(Y);}
;}
,__uT:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__vc();}
,members:{responseJson:null,__cr:null,__uU:null,__uV:null,__uW:null,__uX:null,__uY:null,__st:null,__va:e,open:function(t,p){if(this.__st){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__uW=false;q=this.__uU||b;s=this.__uV||this.__va+n+this.__cr+m;if(!this.__uV){this.constructor[this.__cr]=this;}
else {if(!window[this.__uV]){this.__uX=true;window[this.__uV]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__uV+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__uY=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hu(c,[t,p]);}
,callback:function(v){if(this.__st){return;}
;this.__uW=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cr]=undefined;this.__vb();}
,setCallbackParam:function(w){this.__uU=w;return this;}
,setCallbackName:function(name){this.__uV=name;return this;}
,setPrefix:function(x){this.__va=x;}
,getGeneratedUrl:function(){return this.__uY;}
,dispose:function(){this.__vb();this.__hu(d);}
,_onNativeLoad:function(){this.status=this.__uW?200:500;this.__hu(i);}
,__vb:function(){if(this.__uX&&window[this.__uV]){window[this.__uV]=undefined;this.__uX=false;}
;}
,__hu:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__vc:function(){this.__cr=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
