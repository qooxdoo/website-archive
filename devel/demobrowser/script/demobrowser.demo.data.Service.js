...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.b8298752b2f4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="application/json",c="__uC",d="json",e="aborted",f="loaded",g="qx.event.type.Data",h="error",i="fail",j="receiving",k="queued",l="changeState",m="success",n="String",o="changePhase",p="sending",q="_marshaler",r="completed",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":g,"error":g},properties:{model:{nullable:true,event:a},state:{check:[u,k,p,j,r,e,w,s],init:u,event:l},url:{check:n,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__uC:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__uC;}
,_setRequest:function(C){this.__uC=C;}
,_createRequest:function(D){if(this.__uC){this.__uC.dispose();this.__uC=null;}
;var E=new qx.io.request.Xhr(D);this._setRequest(E);E.setAccept(b);E.setParser(d);E.addListener(m,this._onSuccess,this);var F=this._delegate;if(F&&qx.lang.Type.isFunction(F.configureRequest)){this._delegate.configureRequest(E);}
...
;this.fireDataEvent(f,this.getModel());if(this.__uC){this.__uC.dispose();this.__uC=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__uC!=null){this._disposeObjects(c);}
...
;this.__rU={};var S=this._transport=this._createTransport();this._setPhase(H);this.__rV=qx.lang.Function.bind(this._onReadyStateChange,this);this.__rW=qx.lang.Function.bind(this._onLoad,this);this.__rX=qx.lang.Function.bind(this._onLoadEnd,this);this.__rY=qx.lang.Function.bind(this._onAbort,this);this.__sa=qx.lang.Function.bind(this._onTimeout,this);this.__sb=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__rV;S.onload=this.__rW;S.onloadend=this.__rX;S.onabort=this.__rY;S.ontimeout=this.__sa;S.onerror=this.__sb;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__rV:null,__rW:null,__rX:null,__rY:null,__sa:null,__sb:null,__sc:null,__sd:null,__se:null,__rU:null,__sf:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__sd=true;this.__se=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__sg());qx.lang.Object.mergeWith(bd,this.__sf);qx.lang.Object.mergeWith(bd,this.__rU);return bd;}
,__sg:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__rU[bh]=bi;}
,getRequestHeader:function(bj){return this.__rU[bj];}
,removeRequestHeader:function(bk){if(this.__rU[bk]){delete this.__rU[bk];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__se;}
...
,getResponse:function(){return this.__sc;}
,_setResponse:function(bo){var bn=bo;if(this.__sc!==bo){this.__sc=bo;this.fireEvent(I,qx.event.type.Data,[this.__sc,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__sd){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__sh();}
;}
,__sh:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__se;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__se=br;this.fireDataEvent(c,br,bs);}
...
(function(){var a="text",b="Retry open native request with method: ",c="activex",d="No XHR support available.",f="If-None-Match",g="xhr",h="If-Modified-Since",i="engine.version",j="onunload",k="GET",l="-1",m="qx.debug.io",n="Undefined",o="Open native request with method: ",p="error",q="loadend",r="Blob",s="HTMLDocument",t="progress",u="load",v="Received native readyState: ",w="abort",x=", url: ",y="String",z="browser.documentmode",A="document",B="",C="readystatechange",D="Microsoft.XMLHTTP",E="Already disposed",F="browser.version",G="opera",H="qx.bom.request.Xhr",I="on",J="timeout",K="gecko",L="If-Match",M="mshtml",N="engine.name",O="Microsoft.XMLDOM",P="file:",Q="Send native request",R="FormData",S="If-Range",T="Content-Type",U="io.xhr",V="Not enough arguments",W="ArrayBuffer",X="undefined",Y=", async: ",bb="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(H,{extend:Object,construct:function(){var bc=qx.Bootstrap.bind(this.__sz,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__sj=qx.event.GlobalError.observeMethod(bc);}
else {this.__sj=bc;}
;this.__sk=qx.Bootstrap.bind(this.__sx,this);this.__sl=qx.Bootstrap.bind(this.__sy,this);this.__sa=qx.Bootstrap.bind(this.__sD,this);this.__sw();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sm=qx.Bootstrap.bind(this.__sG,this);window.attachEvent(j,this.__sm);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":H,"error":H,"loadend":H,"timeout":H,"abort":H,"load":H,"progress":H},members:{readyState:0,responseText:B,response:null,responseXML:null,status:0,statusText:B,responseType:B,timeout:0,progress:null,open:function(bh,bd,be,bg,bf){this.__sI();if(typeof bd===X){throw new Error(V);}
else if(typeof bh===X){bh=k;}
;this.__sd=false;this.__sn=false;this.__so=false;this.__sp=bd;if(typeof be==X){be=true;}
;this.__sq=be;this.status=0;this.statusText=this.responseText=B;this.responseXML=null;this.response=null;if(!this.__sH()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__sw();}
;this.__ss.onreadystatechange=this.__sj;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,o+bh+x+bd+Y+be);}
;this.__ss.open(bh,bd,be,bg,bf);}
catch(bi){if(!qx.util.Request.isCrossDomain(bd)){throw bi;}
;if(!this.__sq){this.__sr=bi;}
;if(this.__sq){if(window.XDomainRequest){this.readyState=4;this.__ss=new XDomainRequest();this.__ss.onerror=qx.Bootstrap.bind(function(){this._emit(C);this._emit(p);this._emit(q);}
,this);if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+bh+x+bd+Y+be);}
;this.__ss.open(bh,bd,be,bg,bf);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__su){return;}
;this.readyState=4;this._emit(C);this._emit(p);this._emit(q);}
,this));}
;}
;if(qx.core.Environment.get(N)===M&&qx.core.Environment.get(z)<9&&this.__ss.readyState>0){this.__ss.setRequestHeader(h,l);}
;if(qx.core.Environment.get(N)===K&&parseInt(qx.core.Environment.get(i),10)<2&&!this.__sq){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(C);}
;}
,setRequestHeader:function(bj,bk){this.__sI();if(bj==L||bj==h||bj==f||bj==S){this.__so=true;}
;this.__ss.setRequestHeader(bj,bk);return this;}
,send:function(bm){this.__sI();if(!this.__sq&&this.__sr){throw this.__sr;}
;if(qx.core.Environment.get(N)===G&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__st=window.setTimeout(this.__sa,this.timeout);}
;bm=typeof bm==X?null:bm;var bl=qx.Bootstrap.getClass(bm);bm=(bm!==null&&this.__sv.indexOf(bl)===-1)?bm.toString():bm;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,Q);}
;if(this.__sq){this.__ss.responseType=this.responseType;}
;this.__ss.send(bm);}
catch(bo){if(!this.__sq){throw bo;}
;if(this._getProtocol()===P){this.readyState=2;this.__sA();var bn=this;window.setTimeout(function(){if(bn.__su){return;}
;bn.readyState=3;bn.__sA();bn.readyState=4;bn.__sA();}
);}
;}
;if(qx.core.Environment.get(N)===K&&!this.__sq){this.__sz();}
;this.__sn=true;return this;}
,abort:function(){this.__sI();this.__sd=true;this.__ss.abort();if(this.__ss&&this.readyState!==qx.bom.request.Xhr.DONE){this.readyState=this.__ss.readyState;}
;return this;}
,_emit:function(event){if(this[I+event]){this[I+event]();}
...
,ontimeout:function(){}
,onprogress:function(){}
,on:function(name,bp,bq){this._emitter.on(name,bp,bq);return this;}
,getResponseHeader:function(br){this.__sI();if(qx.core.Environment.get(z)===9&&this.__ss.aborted){return B;}
;return this.__ss.getResponseHeader(br);}
,getAllResponseHeaders:function(){this.__sI();if(qx.core.Environment.get(z)===9&&this.__ss.aborted){return B;}
;return this.__ss.getAllResponseHeaders();}
,overrideMimeType:function(bs){this.__sI();if(this.__ss.overrideMimeType){this.__ss.overrideMimeType(bs);}
else {throw new Error(bb);}
;return this;}
,getRequest:function(){return this.__ss;}
,dispose:function(){if(this.__su){return false;}
;window.clearTimeout(this.__st);if(window.detachEvent){window.detachEvent(j,this.__sm);}
;try{this.__ss.onreadystatechange;}
catch(bu){return false;}
;var bt=function(){}
;this.__ss.onreadystatechange=bt;this.__ss.onload=bt;this.__ss.onerror=bt;this.__ss.onprogress=bt;this.abort();this.__ss=null;this.__su=true;return true;}
,isDisposed:function(){return !!this.__su;}
,_createNativeXhr:function(){var bv=qx.core.Environment.get(U);if(bv===g){return new XMLHttpRequest();}
;if(bv==c){return new window.ActiveXObject(D);}
;qx.Bootstrap.error(this,d);}
,_getProtocol:function(){var bw=this.__sp;var bx=/^(\w+:)\/\//;if(bw!==null&&bw.match){var by=bw.match(bx);if(by&&by[1]){return by[1];}
;}
;return window.location.protocol;}
,__ss:null,__sq:null,__sj:null,__sk:null,__sl:null,__sm:null,__sa:null,__sn:null,__sp:null,__sd:null,__dg:null,__su:null,__st:null,__sr:null,__so:null,__sv:null,__sw:function(){this.__ss=this._createNativeXhr();this.__ss.onreadystatechange=this.__sj;if(qx.Bootstrap.getClass(this.__ss.onabort)!==n){this.__ss.onabort=this.__sk;}
;if(qx.Bootstrap.getClass(this.__ss.onprogress)!==n){this.__ss.onprogress=this.__sl;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__su=this.__sn=this.__sd=false;this.__sv=[W,r,s,y,R];}
,__sx:function(){if(!this.__sd){this.abort();}
;}
,__sy:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(t);}
,__sz:function(){var bz=this.__ss,bA=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,v+bz.readyState);}
;if(this.readyState==bz.readyState){return;}
;this.readyState=bz.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sd&&!this.__sn){return;}
;if(!this.__sq&&(bz.readyState==2||bz.readyState==3)){return;}
;this.status=0;this.statusText=this.responseText=B;this.responseXML=null;this.response=null;if(this.readyState>=qx.bom.request.Xhr.HEADERS_RECEIVED){try{this.status=bz.status;this.statusText=bz.statusText;this.response=bz.response;if((this.responseType===B)||(this.responseType===a)){this.responseText=bz.responseText;}
;if((this.responseType===B)||(this.responseType===A)){this.responseXML=bz.responseXML;}
;}
catch(bB){bA=false;}
;if(bA){this.__sE();this.__sF();}
;}
;this.__sA();if(this.readyState==qx.bom.request.Xhr.DONE){if(bz){bz.onreadystatechange=function(){}
;}
;}
;}
,__sA:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__st);}
;this._emit(C);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sB();}
;}
,__sB:function(){if(this.__dg){this._emit(J);if(qx.core.Environment.get(N)===G){this._emit(p);}
;this.__dg=false;}
else {if(this.__sd){this._emit(w);}
else {if(this.__sC()){this._emit(p);}
else {this._emit(u);}
;}
;}
;this._emit(q);}
,__sC:function(){var bC;if(this._getProtocol()===P){bC=!this.responseText;}
else {bC=!this.statusText&&this.status!==204;}
;return bC;}
,__sD:function(){var bD=this.__ss;this.readyState=qx.bom.request.Xhr.DONE;this.__dg=true;bD.aborted=true;bD.abort();this.responseText=B;this.responseXML=null;this.__sA();}
,__sE:function(){var bE=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===P&&this.status===0&&bE){if(!this.__sC()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(N)===G){if(bE&&this.__so&&!this.__sd&&this.status===0){this.status=304;}
;}
;}
,__sF:function(){if(qx.core.Environment.get(N)==M&&(this.getResponseHeader(T)||B).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bF=new window.ActiveXObject(O);bF.async=false;bF.validateOnParse=false;bF.loadXML(this.responseText);this.responseXML=bF;}
;}
,__sG:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sH:function(){var name=qx.core.Environment.get(N);var bG=qx.core.Environment.get(F);return !(name==M&&bG<9||name==K&&bG<3.5);}
,__sI:function(){if(this.__su){throw new Error(E);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__sJ:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__sJ=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__sJ=i;}
,_getParser:function(k){var j=this.__sJ,m=c,l=c;if(j){return j;}
...
(function(){var a="url: ",b="qx.debug.io",c="qx.bom.request.Script",d="Invalid state",e="head",f="error",g="loadend",h="qx.debug",i="script",j="load",k="Unknown response headers",l="browser.documentmode",m="abort",n="",o="Received native readyState: loaded",p="readystatechange",q="Response header cannot be determined for ",r="requests made with script transport.",s="opera",t="unknown",u="Open native request with ",v="Response headers cannot be determined for",w="mshtml",x="engine.name",y="Detected error",z="Send native request",A="on",B="timeout",C="Unknown environment key at this phase",D="Received native load";qx.Bootstrap.define(c,{construct:function(){this.__uQ();this.__uL=qx.Bootstrap.bind(this._onNativeLoad,this);this.__uM=qx.Bootstrap.bind(this._onNativeError,this);this.__sa=qx.Bootstrap.bind(this._onTimeout,this);this.__uN=document.head||document.getElementsByTagName(e)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__uS()?0:15000;}
,events:{"readystatechange":c,"error":c,"loadend":c,"timeout":c,"abort":c,"load":c},members:{readyState:null,status:null,statusText:null,timeout:null,__uO:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(H,G){if(this.__su){return;}
;this.__uQ();this.__sd=null;this.__sp=G;if(this.__uV(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__su){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__sp=qx.util.Uri.appendParamsToUrl(this.__sp,K);return this;}
,send:function(){if(this.__su){return null;}
;var M=this.__uT(),L=this.__uN,N=this;if(this.timeout>0){this.__de=window.setTimeout(this.__sa,this.timeout);}
;if(this.__uV(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;L.insertBefore(M,L.firstChild);window.setTimeout(function(){N._readyStateChange(2);N._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__su){return null;}
;this.__sd=true;this.__uU();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__su){return null;}
;if(this.__uV(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__su){return null;}
;if(this.__uV(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__uO=P;}
,dispose:function(){var Q=this.__uP;if(!this.__su){if(Q){Q.onload=Q.onreadystatechange=null;this.__uU();}
;if(this.__de){window.clearTimeout(this.__de);}
;this.__su=true;}
;}
,isDisposed:function(){return !!this.__su;}
,_getUrl:function(){return this.__sp;}
,_getScriptElement:function(){return this.__uP;}
,_onTimeout:function(){this.__uR();if(!this.__uS()){this._emit(f);}
;this._emit(B);if(!this.__uS()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__uP,R=this.__uO,T=this;if(this.__sd){return;}
;if(this.__uV(x)===w&&this.__uV(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__uV(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__uV(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__uV(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__de){window.clearTimeout(this.__de);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__uR();this._emit(f);this._emit(g);}
,__uP:null,__uN:null,__sp:n,__uL:null,__uM:null,__sa:null,__de:null,__sd:null,__su:null,__uQ:function(){this.readyState=0;this.status=0;this.statusText=n;}
,_readyStateChange:function(U){this.readyState=U;this._emit(p);}
,_success:function(){this.__uU();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=n+this.status;}
,__uR:function(){this.__uU();this.readyState=4;this.status=0;this.statusText=null;}
,__uS:function(){var W=this.__uV(x)===w&&this.__uV(l)<9;var V=this.__uV(x)===s;return !(W||V);}
,__uT:function(){var X=this.__uP=document.createElement(i);X.src=this.__sp;X.onerror=this.__uM;X.onload=this.__uL;if(this.__uV(x)===w&&this.__uV(l)<9){X.onreadystatechange=this.__uL;}
;return X;}
,__uU:function(){var Y=this.__uP;if(Y&&Y.parentNode){this.__uN.removeChild(Y);}
;}
,__uV:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__ve();}
,members:{responseJson:null,__cs:null,__uW:null,__uX:null,__uY:null,__va:null,__vb:null,__su:null,__vc:e,open:function(t,p){if(this.__su){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__uY=false;q=this.__uW||b;s=this.__uX||this.__vc+n+this.__cs+m;if(!this.__uX){this.constructor[this.__cs]=this;}
else {if(!window[this.__uX]){this.__va=true;window[this.__uX]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__uX+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__vb=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hv(c,[t,p]);}
,callback:function(v){if(this.__su){return;}
;this.__uY=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cs]=undefined;this.__vd();}
,setCallbackParam:function(w){this.__uW=w;return this;}
,setCallbackName:function(name){this.__uX=name;return this;}
,setPrefix:function(x){this.__vc=x;}
,getGeneratedUrl:function(){return this.__vb;}
,dispose:function(){this.__vd();this.__hv(d);}
,_onNativeLoad:function(){this.status=this.__uY?200:500;this.__hv(i);}
,__vd:function(){if(this.__va&&window[this.__uX]){window[this.__uX]=undefined;this.__va=false;}
;}
,__hv:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__ve:function(){this.__cs=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
