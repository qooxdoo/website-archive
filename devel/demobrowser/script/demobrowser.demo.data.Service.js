...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.b4b566006e93.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="application/json",c="json",d="aborted",e="loaded",f="qx.event.type.Data",g="error",h="fail",i="receiving",j="queued",k="changeState",l="success",m="String",n="changePhase",o="sending",p="_marshaler",q="__uB",r="completed",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":f,"error":f},properties:{model:{nullable:true,event:a},state:{check:[u,j,o,i,r,d,w,s],init:u,event:k},url:{check:m,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__uB:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__uB;}
,_setRequest:function(C){this.__uB=C;}
,_createRequest:function(D){if(this.__uB){this.__uB.dispose();this.__uB=null;}
...
,_onChangePhase:function(I){var G=I.getData(),J={},H;J={"opened":u,"sent":o,"loading":i,"success":r,"abort":d,"timeout":w,"statusError":s};H=J[G];if(H){this.setState(H);}
;}
...
;this.fireDataEvent(e,this.getModel());if(this.__uB){this.__uB.dispose();this.__uB=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__uB!=null){this._disposeObjects(q);}
...
;this.__rT={};var S=this._transport=this._createTransport();this._setPhase(H);this.__rU=qx.lang.Function.bind(this._onReadyStateChange,this);this.__rV=qx.lang.Function.bind(this._onLoad,this);this.__rW=qx.lang.Function.bind(this._onLoadEnd,this);this.__rX=qx.lang.Function.bind(this._onAbort,this);this.__rY=qx.lang.Function.bind(this._onTimeout,this);this.__sa=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__rU;S.onload=this.__rV;S.onloadend=this.__rW;S.onabort=this.__rX;S.ontimeout=this.__rY;S.onerror=this.__sa;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__rU:null,__rV:null,__rW:null,__rX:null,__rY:null,__sa:null,__sb:null,__sc:null,__sd:null,__rT:null,__se:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__sc=true;this.__sd=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__sf());qx.lang.Object.mergeWith(bd,this.__se);qx.lang.Object.mergeWith(bd,this.__rT);return bd;}
,__sf:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__rT[bh]=bi;}
,getRequestHeader:function(bj){return this.__rT[bj];}
,removeRequestHeader:function(bk){if(this.__rT[bk]){delete this.__rT[bk];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__sd;}
...
,getResponse:function(){return this.__sb;}
,_setResponse:function(bo){var bn=bo;if(this.__sb!==bo){this.__sb=bo;this.fireEvent(I,qx.event.type.Data,[this.__sb,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__sc){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__sg();}
;}
,__sg:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__sd;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__sd=br;this.fireDataEvent(c,br,bs);}
...
(function(){var a="text",b="Retry open native request with method: ",c="activex",d="No XHR support available.",f="If-None-Match",g="xhr",h="If-Modified-Since",i="engine.version",j="onunload",k="GET",l="-1",m="qx.debug.io",n="Undefined",o="Open native request with method: ",p="error",q="loadend",r="Blob",s="HTMLDocument",t="progress",u="load",v="Received native readyState: ",w="abort",x=", url: ",y="String",z="browser.documentmode",A="document",B="",C="readystatechange",D="Microsoft.XMLHTTP",E="Already disposed",F="browser.version",G="opera",H="qx.bom.request.Xhr",I="on",J="timeout",K="gecko",L="If-Match",M="mshtml",N="engine.name",O="Microsoft.XMLDOM",P="file:",Q="Send native request",R="FormData",S="If-Range",T="Content-Type",U="io.xhr",V="Not enough arguments",W="ArrayBuffer",X="undefined",Y=", async: ",bb="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(H,{extend:Object,construct:function(){var bc=qx.Bootstrap.bind(this.__sy,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__si=qx.event.GlobalError.observeMethod(bc);}
else {this.__si=bc;}
;this.__sj=qx.Bootstrap.bind(this.__sw,this);this.__sk=qx.Bootstrap.bind(this.__sx,this);this.__rY=qx.Bootstrap.bind(this.__sC,this);this.__sv();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sl=qx.Bootstrap.bind(this.__sF,this);window.attachEvent(j,this.__sl);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":H,"error":H,"loadend":H,"timeout":H,"abort":H,"load":H,"progress":H},members:{readyState:0,responseText:B,response:null,responseXML:null,status:0,statusText:B,responseType:B,timeout:0,progress:null,open:function(bh,bd,be,bg,bf){this.__sH();if(typeof bd===X){throw new Error(V);}
else if(typeof bh===X){bh=k;}
;this.__sc=false;this.__sm=false;this.__sn=false;this.__so=bd;if(typeof be==X){be=true;}
;this.__sp=be;this.status=0;this.statusText=this.responseText=B;this.responseXML=null;this.response=null;if(!this.__sG()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__sv();}
;this.__sr.onreadystatechange=this.__si;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,o+bh+x+bd+Y+be);}
;this.__sr.open(bh,bd,be,bg,bf);}
catch(bi){if(!qx.util.Request.isCrossDomain(bd)){throw bi;}
;if(!this.__sp){this.__sq=bi;}
;if(this.__sp){if(window.XDomainRequest){this.readyState=4;this.__sr=new XDomainRequest();this.__sr.onerror=qx.Bootstrap.bind(function(){this._emit(C);this._emit(p);this._emit(q);}
,this);if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+bh+x+bd+Y+be);}
;this.__sr.open(bh,bd,be,bg,bf);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__st){return;}
;this.readyState=4;this._emit(C);this._emit(p);this._emit(q);}
,this));}
;}
;if(qx.core.Environment.get(N)===M&&qx.core.Environment.get(z)<9&&this.__sr.readyState>0){this.__sr.setRequestHeader(h,l);}
;if(qx.core.Environment.get(N)===K&&parseInt(qx.core.Environment.get(i),10)<2&&!this.__sp){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(C);}
;}
,setRequestHeader:function(bj,bk){this.__sH();if(bj==L||bj==h||bj==f||bj==S){this.__sn=true;}
;this.__sr.setRequestHeader(bj,bk);return this;}
,send:function(bm){this.__sH();if(!this.__sp&&this.__sq){throw this.__sq;}
;if(qx.core.Environment.get(N)===G&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__ss=window.setTimeout(this.__rY,this.timeout);}
;bm=typeof bm==X?null:bm;var bl=qx.Bootstrap.getClass(bm);bm=(bm!==null&&this.__su.indexOf(bl)===-1)?bm.toString():bm;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,Q);}
;if(this.__sp){this.__sr.responseType=this.responseType;}
;this.__sr.send(bm);}
catch(bo){if(!this.__sp){throw bo;}
;if(this._getProtocol()===P){this.readyState=2;this.__sz();var bn=this;window.setTimeout(function(){if(bn.__st){return;}
;bn.readyState=3;bn.__sz();bn.readyState=4;bn.__sz();}
);}
;}
;if(qx.core.Environment.get(N)===K&&!this.__sp){this.__sy();}
;this.__sm=true;return this;}
,abort:function(){this.__sH();this.__sc=true;this.__sr.abort();if(this.__sr&&this.readyState!==qx.bom.request.Xhr.DONE){this.readyState=this.__sr.readyState;}
;return this;}
...
,getResponseHeader:function(br){this.__sH();if(qx.core.Environment.get(z)===9&&this.__sr.aborted){return B;}
;return this.__sr.getResponseHeader(br);}
,getAllResponseHeaders:function(){this.__sH();if(qx.core.Environment.get(z)===9&&this.__sr.aborted){return B;}
;return this.__sr.getAllResponseHeaders();}
,overrideMimeType:function(bs){this.__sH();if(this.__sr.overrideMimeType){this.__sr.overrideMimeType(bs);}
else {throw new Error(bb);}
;return this;}
,getRequest:function(){return this.__sr;}
,dispose:function(){if(this.__st){return false;}
;window.clearTimeout(this.__ss);if(window.detachEvent){window.detachEvent(j,this.__sl);}
;try{this.__sr.onreadystatechange;}
catch(bu){return false;}
;var bt=function(){}
;this.__sr.onreadystatechange=bt;this.__sr.onload=bt;this.__sr.onerror=bt;this.__sr.onprogress=bt;this.abort();this.__sr=null;this.__st=true;return true;}
,isDisposed:function(){return !!this.__st;}
...
,_getProtocol:function(){var bw=this.__so;var bx=/^(\w+:)\/\//;if(bw!==null&&bw.match){var by=bw.match(bx);if(by&&by[1]){return by[1];}
;}
;return window.location.protocol;}
,__sr:null,__sp:null,__si:null,__sj:null,__sk:null,__sl:null,__rY:null,__sm:null,__so:null,__sc:null,__df:null,__st:null,__ss:null,__sq:null,__sn:null,__su:null,__sv:function(){this.__sr=this._createNativeXhr();this.__sr.onreadystatechange=this.__si;if(qx.Bootstrap.getClass(this.__sr.onabort)!==n){this.__sr.onabort=this.__sj;}
;if(qx.Bootstrap.getClass(this.__sr.onprogress)!==n){this.__sr.onprogress=this.__sk;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__st=this.__sm=this.__sc=false;this.__su=[W,r,s,y,R];}
,__sw:function(){if(!this.__sc){this.abort();}
;}
,__sx:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(t);}
,__sy:function(){var bz=this.__sr,bA=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,v+bz.readyState);}
;if(this.readyState==bz.readyState){return;}
;this.readyState=bz.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sc&&!this.__sm){return;}
;if(!this.__sp&&(bz.readyState==2||bz.readyState==3)){return;}
...
;if(bA){this.__sD();this.__sE();}
;}
;this.__sz();if(this.readyState==qx.bom.request.Xhr.DONE){if(bz){bz.onreadystatechange=function(){}
;}
;}
;}
,__sz:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__ss);}
;this._emit(C);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sA();}
;}
,__sA:function(){if(this.__df){this._emit(J);if(qx.core.Environment.get(N)===G){this._emit(p);}
;this.__df=false;}
else {if(this.__sc){this._emit(w);}
else {if(this.__sB()){this._emit(p);}
else {this._emit(u);}
;}
;}
;this._emit(q);}
,__sB:function(){var bC;if(this._getProtocol()===P){bC=!this.responseText;}
else {bC=!this.statusText&&this.status!==204;}
;return bC;}
,__sC:function(){var bD=this.__sr;this.readyState=qx.bom.request.Xhr.DONE;this.__df=true;bD.aborted=true;bD.abort();this.responseText=B;this.responseXML=null;this.__sz();}
,__sD:function(){var bE=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===P&&this.status===0&&bE){if(!this.__sB()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(N)===G){if(bE&&this.__sn&&!this.__sc&&this.status===0){this.status=304;}
;}
;}
,__sE:function(){if(qx.core.Environment.get(N)==M&&(this.getResponseHeader(T)||B).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bF=new window.ActiveXObject(O);bF.async=false;bF.validateOnParse=false;bF.loadXML(this.responseText);this.responseXML=bF;}
;}
,__sF:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sG:function(){var name=qx.core.Environment.get(N);var bG=qx.core.Environment.get(F);return !(name==M&&bG<9||name==K&&bG<3.5);}
,__sH:function(){if(this.__st){throw new Error(E);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__sI:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__sI=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__sI=i;}
,_getParser:function(k){var j=this.__sI,m=c,l=c;if(j){return j;}
...
(function(){var a="url: ",b="qx.debug.io",c="qx.bom.request.Script",d="Invalid state",e="head",f="error",g="loadend",h="qx.debug",i="script",j="load",k="Unknown response headers",l="browser.documentmode",m="abort",n="",o="Received native readyState: loaded",p="readystatechange",q="Response header cannot be determined for ",r="requests made with script transport.",s="opera",t="unknown",u="Open native request with ",v="Response headers cannot be determined for",w="mshtml",x="engine.name",y="Detected error",z="Send native request",A="on",B="timeout",C="Unknown environment key at this phase",D="Received native load";qx.Bootstrap.define(c,{construct:function(){this.__uP();this.__uK=qx.Bootstrap.bind(this._onNativeLoad,this);this.__uL=qx.Bootstrap.bind(this._onNativeError,this);this.__rY=qx.Bootstrap.bind(this._onTimeout,this);this.__uM=document.head||document.getElementsByTagName(e)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__uR()?0:15000;}
,events:{"readystatechange":c,"error":c,"loadend":c,"timeout":c,"abort":c,"load":c},members:{readyState:null,status:null,statusText:null,timeout:null,__uN:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(H,G){if(this.__st){return;}
;this.__uP();this.__sc=null;this.__so=G;if(this.__uU(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__st){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__so=qx.util.Uri.appendParamsToUrl(this.__so,K);return this;}
,send:function(){if(this.__st){return null;}
;var M=this.__uS(),L=this.__uM,N=this;if(this.timeout>0){this.__dd=window.setTimeout(this.__rY,this.timeout);}
;if(this.__uU(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;L.insertBefore(M,L.firstChild);window.setTimeout(function(){N._readyStateChange(2);N._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__st){return null;}
;this.__sc=true;this.__uT();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__st){return null;}
;if(this.__uU(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__st){return null;}
;if(this.__uU(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__uN=P;}
,dispose:function(){var Q=this.__uO;if(!this.__st){if(Q){Q.onload=Q.onreadystatechange=null;this.__uT();}
;if(this.__dd){window.clearTimeout(this.__dd);}
;this.__st=true;}
;}
,isDisposed:function(){return !!this.__st;}
,_getUrl:function(){return this.__so;}
,_getScriptElement:function(){return this.__uO;}
,_onTimeout:function(){this.__uQ();if(!this.__uR()){this._emit(f);}
;this._emit(B);if(!this.__uR()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__uO,R=this.__uN,T=this;if(this.__sc){return;}
;if(this.__uU(x)===w&&this.__uU(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__uU(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__uU(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__uU(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__dd){window.clearTimeout(this.__dd);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__uQ();this._emit(f);this._emit(g);}
,__uO:null,__uM:null,__so:n,__uK:null,__uL:null,__rY:null,__dd:null,__sc:null,__st:null,__uP:function(){this.readyState=0;this.status=0;this.statusText=n;}
,_readyStateChange:function(U){this.readyState=U;this._emit(p);}
,_success:function(){this.__uT();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=n+this.status;}
,__uQ:function(){this.__uT();this.readyState=4;this.status=0;this.statusText=null;}
,__uR:function(){var W=this.__uU(x)===w&&this.__uU(l)<9;var V=this.__uU(x)===s;return !(W||V);}
,__uS:function(){var X=this.__uO=document.createElement(i);X.src=this.__so;X.onerror=this.__uL;X.onload=this.__uK;if(this.__uU(x)===w&&this.__uU(l)<9){X.onreadystatechange=this.__uK;}
;return X;}
,__uT:function(){var Y=this.__uO;if(Y&&Y.parentNode){this.__uM.removeChild(Y);}
;}
,__uU:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__vd();}
,members:{responseJson:null,__cr:null,__uV:null,__uW:null,__uX:null,__uY:null,__va:null,__st:null,__vb:e,open:function(t,p){if(this.__st){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__uX=false;q=this.__uV||b;s=this.__uW||this.__vb+n+this.__cr+m;if(!this.__uW){this.constructor[this.__cr]=this;}
else {if(!window[this.__uW]){this.__uY=true;window[this.__uW]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__uW+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__va=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hu(c,[t,p]);}
,callback:function(v){if(this.__st){return;}
;this.__uX=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cr]=undefined;this.__vc();}
,setCallbackParam:function(w){this.__uV=w;return this;}
,setCallbackName:function(name){this.__uW=name;return this;}
,setPrefix:function(x){this.__vb=x;}
,getGeneratedUrl:function(){return this.__va;}
,dispose:function(){this.__vc();this.__hu(d);}
,_onNativeLoad:function(){this.status=this.__uX?200:500;this.__hu(i);}
,__vc:function(){if(this.__uY&&window[this.__uW]){window[this.__uW]=undefined;this.__uY=false;}
;}
,__hu:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__vd:function(){this.__cr=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
