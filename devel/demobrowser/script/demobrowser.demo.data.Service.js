...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.d976375b42e8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="application/json",c="__uG",d="json",e="aborted",f="loaded",g="qx.event.type.Data",h="error",i="fail",j="receiving",k="queued",l="changeState",m="success",n="String",o="changePhase",p="sending",q="_marshaler",r="completed",s="failed",t="qx.data.store.Json",u="configured",v="changeUrl",w="timeout",x="_applyUrl";qx.Class.define(t,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":g,"error":g},properties:{model:{nullable:true,event:a},state:{check:[u,k,p,j,r,e,w,s],init:u,event:l},url:{check:n,apply:x,event:v,nullable:true}},members:{_marshaler:null,_delegate:null,__uG:null,_applyUrl:function(B,A){if(B!=null){B=qx.util.AliasManager.getInstance().resolve(B);B=qx.util.ResourceManager.getInstance().toUri(B);this._createRequest(B);}
;}
,_getRequest:function(){return this.__uG;}
,_setRequest:function(C){this.__uG=C;}
,_createRequest:function(D){if(this.__uG){this.__uG.dispose();this.__uG=null;}
...
;this.fireDataEvent(f,this.getModel());if(this.__uG){this.__uG.dispose();this.__uG=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__uG!=null){this._disposeObjects(c);}
...
;this.__rY={};var S=this._transport=this._createTransport();this._setPhase(H);this.__sa=qx.lang.Function.bind(this._onReadyStateChange,this);this.__sb=qx.lang.Function.bind(this._onLoad,this);this.__sc=qx.lang.Function.bind(this._onLoadEnd,this);this.__sd=qx.lang.Function.bind(this._onAbort,this);this.__se=qx.lang.Function.bind(this._onTimeout,this);this.__sf=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__sa;S.onload=this.__sb;S.onloadend=this.__sc;S.onabort=this.__sd;S.ontimeout=this.__se;S.onerror=this.__sf;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__sa:null,__sb:null,__sc:null,__sd:null,__se:null,__sf:null,__sg:null,__sh:null,__si:null,__rY:null,__sj:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__sh=true;this.__si=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__sk());qx.lang.Object.mergeWith(bd,this.__sj);qx.lang.Object.mergeWith(bd,this.__rY);return bd;}
,__sk:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__rY[bh]=bi;}
,getRequestHeader:function(bj){return this.__rY[bj];}
,removeRequestHeader:function(bk){if(this.__rY[bk]){delete this.__rY[bk];}
;}
...
,getResponse:function(){return this.__sg;}
,_setResponse:function(bo){var bn=bo;if(this.__sg!==bo){this.__sg=bo;this.fireEvent(I,qx.event.type.Data,[this.__sg,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__sh){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__sl();}
;}
,__sl:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__si;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__si=br;this.fireDataEvent(c,br,bs);}
...
(function(){var a="text",b="Retry open native request with method: ",c="activex",d="No XHR support available.",f="If-None-Match",g="xhr",h="If-Modified-Since",i="engine.version",j="onunload",k="GET",l="-1",m="qx.debug.io",n="Undefined",o="Open native request with method: ",p="error",q="loadend",r="Blob",s="HTMLDocument",t="progress",u="load",v="Received native readyState: ",w="abort",x=", url: ",y="String",z="browser.documentmode",A="document",B="",C="readystatechange",D="Microsoft.XMLHTTP",E="Already disposed",F="browser.version",G="opera",H="qx.bom.request.Xhr",I="on",J="timeout",K="gecko",L="If-Match",M="mshtml",N="engine.name",O="Microsoft.XMLDOM",P="file:",Q="Send native request",R="FormData",S="If-Range",T="Content-Type",U="io.xhr",V="Not enough arguments",W="ArrayBuffer",X="undefined",Y=", async: ",bb="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(H,{extend:Object,construct:function(){var bc=qx.Bootstrap.bind(this.__sD,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__sn=qx.event.GlobalError.observeMethod(bc);}
else {this.__sn=bc;}
;this.__so=qx.Bootstrap.bind(this.__sB,this);this.__sp=qx.Bootstrap.bind(this.__sC,this);this.__se=qx.Bootstrap.bind(this.__sH,this);this.__sA();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sq=qx.Bootstrap.bind(this.__sK,this);window.attachEvent(j,this.__sq);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":H,"error":H,"loadend":H,"timeout":H,"abort":H,"load":H,"progress":H},members:{readyState:0,responseText:B,response:null,responseXML:null,status:0,statusText:B,responseType:B,timeout:0,progress:null,open:function(bh,bd,be,bg,bf){this.__sM();if(typeof bd===X){throw new Error(V);}
else if(typeof bh===X){bh=k;}
;this.__sh=false;this.__sr=false;this.__ss=false;this.__st=bd;if(typeof be==X){be=true;}
;this.__su=be;this.status=0;this.statusText=this.responseText=B;this.responseXML=null;this.response=null;if(!this.__sL()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__sA();}
;this.__sw.onreadystatechange=this.__sn;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,o+bh+x+bd+Y+be);}
;this.__sw.open(bh,bd,be,bg,bf);}
catch(bi){if(!qx.util.Request.isCrossDomain(bd)){throw bi;}
;if(!this.__su){this.__sv=bi;}
;if(this.__su){if(window.XDomainRequest){this.readyState=4;this.__sw=new XDomainRequest();this.__sw.onerror=qx.Bootstrap.bind(function(){this._emit(C);this._emit(p);this._emit(q);}
,this);if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+bh+x+bd+Y+be);}
;this.__sw.open(bh,bd,be,bg,bf);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__sy){return;}
;this.readyState=4;this._emit(C);this._emit(p);this._emit(q);}
,this));}
;}
;if(qx.core.Environment.get(N)===M&&qx.core.Environment.get(z)<9&&this.__sw.readyState>0){this.__sw.setRequestHeader(h,l);}
;if(qx.core.Environment.get(N)===K&&parseInt(qx.core.Environment.get(i),10)<2&&!this.__su){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(C);}
;}
,setRequestHeader:function(bj,bk){this.__sM();if(bj==L||bj==h||bj==f||bj==S){this.__ss=true;}
;this.__sw.setRequestHeader(bj,bk);return this;}
,send:function(bm){this.__sM();if(!this.__su&&this.__sv){throw this.__sv;}
;if(qx.core.Environment.get(N)===G&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__sx=window.setTimeout(this.__se,this.timeout);}
;bm=typeof bm==X?null:bm;var bl=qx.Bootstrap.getClass(bm);bm=(bm!==null&&this.__sz.indexOf(bl)===-1)?bm.toString():bm;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,Q);}
;if(this.__su){this.__sw.responseType=this.responseType;}
;this.__sw.send(bm);}
catch(bo){if(!this.__su){throw bo;}
;if(this._getProtocol()===P){this.readyState=2;this.__sE();var bn=this;window.setTimeout(function(){if(bn.__sy){return;}
;bn.readyState=3;bn.__sE();bn.readyState=4;bn.__sE();}
);}
;}
;if(qx.core.Environment.get(N)===K&&!this.__su){this.__sD();}
;this.__sr=true;return this;}
,abort:function(){this.__sM();this.__sh=true;this.__sw.abort();if(this.__sw&&this.readyState!==qx.bom.request.Xhr.DONE){this.readyState=this.__sw.readyState;}
;return this;}
...
,getResponseHeader:function(br){this.__sM();if(qx.core.Environment.get(z)===9&&this.__sw.aborted){return B;}
;return this.__sw.getResponseHeader(br);}
,getAllResponseHeaders:function(){this.__sM();if(qx.core.Environment.get(z)===9&&this.__sw.aborted){return B;}
;return this.__sw.getAllResponseHeaders();}
,overrideMimeType:function(bs){this.__sM();if(this.__sw.overrideMimeType){this.__sw.overrideMimeType(bs);}
else {throw new Error(bb);}
;return this;}
,getRequest:function(){return this.__sw;}
,dispose:function(){if(this.__sy){return false;}
;window.clearTimeout(this.__sx);if(window.detachEvent){window.detachEvent(j,this.__sq);}
;try{this.__sw.onreadystatechange;}
catch(bu){return false;}
;var bt=function(){}
;this.__sw.onreadystatechange=bt;this.__sw.onload=bt;this.__sw.onerror=bt;this.__sw.onprogress=bt;this.abort();this.__sw=null;this.__sy=true;return true;}
,isDisposed:function(){return !!this.__sy;}
...
,_getProtocol:function(){var bw=this.__st;var bx=/^(\w+:)\/\//;if(bw!==null&&bw.match){var by=bw.match(bx);if(by&&by[1]){return by[1];}
;}
;return window.location.protocol;}
,__sw:null,__su:null,__sn:null,__so:null,__sp:null,__sq:null,__se:null,__sr:null,__st:null,__sh:null,__dj:null,__sy:null,__sx:null,__sv:null,__ss:null,__sz:null,__sA:function(){this.__sw=this._createNativeXhr();this.__sw.onreadystatechange=this.__sn;if(qx.Bootstrap.getClass(this.__sw.onabort)!==n){this.__sw.onabort=this.__so;}
;if(qx.Bootstrap.getClass(this.__sw.onprogress)!==n){this.__sw.onprogress=this.__sp;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__sy=this.__sr=this.__sh=false;this.__sz=[W,r,s,y,R];}
,__sB:function(){if(!this.__sh){this.abort();}
;}
,__sC:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(t);}
,__sD:function(){var bz=this.__sw,bA=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,v+bz.readyState);}
;if(this.readyState==bz.readyState){return;}
;this.readyState=bz.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sh&&!this.__sr){return;}
;if(!this.__su&&(bz.readyState==2||bz.readyState==3)){return;}
...
;if(bA){this.__sI();this.__sJ();}
;}
;this.__sE();if(this.readyState==qx.bom.request.Xhr.DONE){if(bz){bz.onreadystatechange=function(){}
;}
;}
;}
,__sE:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__sx);}
;this._emit(C);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sF();}
;}
,__sF:function(){if(this.__dj){this._emit(J);if(qx.core.Environment.get(N)===G){this._emit(p);}
;this.__dj=false;}
else {if(this.__sh){this._emit(w);}
else {if(this.__sG()){this._emit(p);}
else {this._emit(u);}
;}
;}
;this._emit(q);}
,__sG:function(){var bC;if(this._getProtocol()===P){bC=!this.responseText;}
else {bC=!this.statusText&&this.status!==204;}
;return bC;}
,__sH:function(){var bD=this.__sw;this.readyState=qx.bom.request.Xhr.DONE;this.__dj=true;bD.aborted=true;bD.abort();this.responseText=B;this.responseXML=null;this.__sE();}
,__sI:function(){var bE=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===P&&this.status===0&&bE){if(!this.__sG()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(N)===G){if(bE&&this.__ss&&!this.__sh&&this.status===0){this.status=304;}
;}
;}
,__sJ:function(){if(qx.core.Environment.get(N)==M&&(this.getResponseHeader(T)||B).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bF=new window.ActiveXObject(O);bF.async=false;bF.validateOnParse=false;bF.loadXML(this.responseText);this.responseXML=bF;}
;}
,__sK:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sL:function(){var name=qx.core.Environment.get(N);var bG=qx.core.Environment.get(F);return !(name==M&&bG<9||name==K&&bG<3.5);}
,__sM:function(){if(this.__sy){throw new Error(E);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__sN:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__sN=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__sN=i;}
,_getParser:function(k){var j=this.__sN,m=c,l=c;if(j){return j;}
...
(function(){var a="url: ",b="qx.debug.io",c="qx.bom.request.Script",d="Invalid state",e="head",f="error",g="loadend",h="qx.debug",i="script",j="load",k="Unknown response headers",l="browser.documentmode",m="abort",n="",o="Received native readyState: loaded",p="readystatechange",q="Response header cannot be determined for ",r="requests made with script transport.",s="opera",t="unknown",u="Open native request with ",v="Response headers cannot be determined for",w="mshtml",x="engine.name",y="Detected error",z="Send native request",A="on",B="timeout",C="Unknown environment key at this phase",D="Received native load";qx.Bootstrap.define(c,{construct:function(){this.__uU();this.__uP=qx.Bootstrap.bind(this._onNativeLoad,this);this.__uQ=qx.Bootstrap.bind(this._onNativeError,this);this.__se=qx.Bootstrap.bind(this._onTimeout,this);this.__uR=document.head||document.getElementsByTagName(e)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__uW()?0:15000;}
,events:{"readystatechange":c,"error":c,"loadend":c,"timeout":c,"abort":c,"load":c},members:{readyState:null,status:null,statusText:null,timeout:null,__uS:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(H,G){if(this.__sy){return;}
;this.__uU();this.__sh=null;this.__st=G;if(this.__va(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__sy){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__st=qx.util.Uri.appendParamsToUrl(this.__st,K);return this;}
,send:function(){if(this.__sy){return null;}
;var M=this.__uX(),L=this.__uR,N=this;if(this.timeout>0){this.__dh=window.setTimeout(this.__se,this.timeout);}
;if(this.__va(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;L.insertBefore(M,L.firstChild);window.setTimeout(function(){N._readyStateChange(2);N._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__sy){return null;}
;this.__sh=true;this.__uY();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__sy){return null;}
;if(this.__va(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__sy){return null;}
;if(this.__va(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__uS=P;}
,dispose:function(){var Q=this.__uT;if(!this.__sy){if(Q){Q.onload=Q.onreadystatechange=null;this.__uY();}
;if(this.__dh){window.clearTimeout(this.__dh);}
;this.__sy=true;}
;}
,isDisposed:function(){return !!this.__sy;}
,_getUrl:function(){return this.__st;}
,_getScriptElement:function(){return this.__uT;}
,_onTimeout:function(){this.__uV();if(!this.__uW()){this._emit(f);}
;this._emit(B);if(!this.__uW()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__uT,R=this.__uS,T=this;if(this.__sh){return;}
;if(this.__va(x)===w&&this.__va(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__va(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__va(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__va(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__dh){window.clearTimeout(this.__dh);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__uV();this._emit(f);this._emit(g);}
,__uT:null,__uR:null,__st:n,__uP:null,__uQ:null,__se:null,__dh:null,__sh:null,__sy:null,__uU:function(){this.readyState=0;this.status=0;this.statusText=n;}
,_readyStateChange:function(U){this.readyState=U;this._emit(p);}
,_success:function(){this.__uY();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=n+this.status;}
,__uV:function(){this.__uY();this.readyState=4;this.status=0;this.statusText=null;}
,__uW:function(){var W=this.__va(x)===w&&this.__va(l)<9;var V=this.__va(x)===s;return !(W||V);}
,__uX:function(){var X=this.__uT=document.createElement(i);X.src=this.__st;X.onerror=this.__uQ;X.onload=this.__uP;if(this.__va(x)===w&&this.__va(l)<9){X.onreadystatechange=this.__uP;}
;return X;}
,__uY:function(){var Y=this.__uT;if(Y&&Y.parentNode){this.__uR.removeChild(Y);}
;}
,__va:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__vi();}
,members:{responseJson:null,__cv:null,__vb:null,__vc:null,__vd:null,__ve:null,__vf:null,__sy:null,__vg:e,open:function(t,p){if(this.__sy){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__vd=false;q=this.__vb||b;s=this.__vc||this.__vg+n+this.__cv+m;if(!this.__vc){this.constructor[this.__cv]=this;}
else {if(!window[this.__vc]){this.__ve=true;window[this.__vc]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__vc+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__vf=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hz(c,[t,p]);}
,callback:function(v){if(this.__sy){return;}
;this.__vd=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cv]=undefined;this.__vh();}
,setCallbackParam:function(w){this.__vb=w;return this;}
,setCallbackName:function(name){this.__vc=name;return this;}
,setPrefix:function(x){this.__vg=x;}
,getGeneratedUrl:function(){return this.__vf;}
,dispose:function(){this.__vh();this.__hz(d);}
,_onNativeLoad:function(){this.status=this.__vd?200:500;this.__hz(i);}
,__vh:function(){if(this.__ve&&window[this.__vc]){window[this.__vc]=undefined;this.__ve=false;}
;}
,__hz:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__vi:function(){this.__cv=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
