...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.f7b9775fb556.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__xt();}
,members:{responseJson:null,__cr:null,__xm:null,__xn:null,__xo:null,__xp:null,__xq:null,__nB:null,__xr:e,open:function(t,p){if(this.__nB){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__xo=false;q=this.__xm||b;s=this.__xn||this.__xr+n+this.__cr+m;if(!this.__xn){this.constructor[this.__cr]=this;}
else {if(!window[this.__xn]){this.__xp=true;window[this.__xn]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__xn+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__xq=p=qx.util.Uri.appendParamsToUrl(p,r);this.__hu(c,[t,p]);}
,callback:function(v){if(this.__nB){return;}
;this.__xo=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__cr]=undefined;this.__xs();}
,setCallbackParam:function(w){this.__xm=w;return this;}
,setCallbackName:function(name){this.__xn=name;return this;}
,setPrefix:function(x){this.__xr=x;}
,getGeneratedUrl:function(){return this.__xq;}
,dispose:function(){this.__xs();this.__hu(d);}
,_onNativeLoad:function(){this.status=this.__xo?200:500;this.__hu(i);}
,__xs:function(){if(this.__xp&&window[this.__xn]){window[this.__xn]=undefined;this.__xp=false;}
;}
,__hu:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__xt:function(){this.__cr=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
