...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.b2445aac1583.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__sa={};var S=this._transport=this._createTransport();this._setPhase(H);this.__sb=qx.lang.Function.bind(this._onReadyStateChange,this);this.__sc=qx.lang.Function.bind(this._onLoad,this);this.__sd=qx.lang.Function.bind(this._onLoadEnd,this);this.__se=qx.lang.Function.bind(this._onAbort,this);this.__sf=qx.lang.Function.bind(this._onTimeout,this);this.__sg=qx.lang.Function.bind(this._onError,this);S.onreadystatechange=this.__sb;S.onload=this.__sc;S.onloadend=this.__sd;S.onabort=this.__se;S.ontimeout=this.__sf;S.onerror=this.__sg;}
...
,nullable:true},authentication:{check:k,nullable:true}},members:{__sb:null,__sc:null,__sd:null,__se:null,__sf:null,__sg:null,__sh:null,__si:null,__sj:null,__sa:null,__sk:null,_transport:null,_createTransport:function(){throw new Error(F);}
...
;this.__si=true;this.__sj=t;this._transport.abort();}
...
;}
,_getAllRequestHeaders:function(){var bd={};qx.lang.Object.mergeWith(bd,this._getConfiguredRequestHeaders());qx.lang.Object.mergeWith(bd,this.__sl());qx.lang.Object.mergeWith(bd,this.__sk);qx.lang.Object.mergeWith(bd,this.__sa);return bd;}
,__sl:function(){var bf=this.getAuthentication(),be={};if(bf){bf.getAuthHeaders().forEach(function(bg){be[bg.key]=bg.value;}
);return be;}
;}
,setRequestHeader:function(bh,bi){this.__sa[bh]=bi;}
,getRequestHeader:function(bj){return this.__sa[bj];}
,removeRequestHeader:function(bk){if(this.__sa[bk]){delete this.__sa[bk];}
;}
,getTransport:function(){return this._transport;}
,getReadyState:function(){return this._transport.readyState;}
,getPhase:function(){return this.__sj;}
...
,_setResponse:function(bo){var bn=bo;if(this.__sh!==bo){this.__sh=bo;this.fireEvent(I,qx.event.type.Data,[this.__sh,bn]);}
;}
,_onReadyStateChange:function(){var bp=this.getReadyState();if(qx.core.Environment.get(f)){this.debug(C+bp);}
;this.fireEvent(E);if(this.__si){return;}
;if(bp===3){this._setPhase(q);}
;if(this.isDone()){this.__sm();}
;}
,__sm:function(){if(qx.core.Environment.get(f)){this.debug(B+this.getStatus());}
...
,_setPhase:function(br){var bs=this.__sj;if(qx.core.Environment.get(n)){qx.core.Assert.assertString(br);qx.core.Assert.assertMatch(br,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__sj=br;this.fireDataEvent(c,br,bs);}
...
(function(){var a="text",b="Retry open native request with method: ",c="activex",d="No XHR support available.",f="If-None-Match",g="xhr",h="If-Modified-Since",i="engine.version",j="onunload",k="GET",l="-1",m="qx.debug.io",n="Undefined",o="Open native request with method: ",p="error",q="loadend",r="Blob",s="HTMLDocument",t="progress",u="load",v="Received native readyState: ",w="abort",x=", url: ",y="String",z="browser.documentmode",A="document",B="",C="readystatechange",D="Microsoft.XMLHTTP",E="Already disposed",F="browser.version",G="opera",H="qx.bom.request.Xhr",I="on",J="timeout",K="gecko",L="If-Match",M="mshtml",N="engine.name",O="Microsoft.XMLDOM",P="file:",Q="Send native request",R="FormData",S="If-Range",T="Content-Type",U="io.xhr",V="Not enough arguments",W="ArrayBuffer",X="undefined",Y=", async: ",bb="Native XHR object doesn't support overrideMimeType.";qx.Bootstrap.define(H,{extend:Object,construct:function(){var bc=qx.Bootstrap.bind(this.__sE,this);if(qx.event&&qx.event.GlobalError&&qx.event.GlobalError.observeMethod){this.__so=qx.event.GlobalError.observeMethod(bc);}
else {this.__so=bc;}
;this.__sp=qx.Bootstrap.bind(this.__sC,this);this.__sq=qx.Bootstrap.bind(this.__sD,this);this.__sf=qx.Bootstrap.bind(this.__sI,this);this.__sB();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sr=qx.Bootstrap.bind(this.__sL,this);window.attachEvent(j,this.__sr);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":H,"error":H,"loadend":H,"timeout":H,"abort":H,"load":H,"progress":H},members:{readyState:0,responseText:B,response:null,responseXML:null,status:0,statusText:B,responseType:B,timeout:0,progress:null,open:function(bh,bd,be,bg,bf){this.__sN();if(typeof bd===X){throw new Error(V);}
else if(typeof bh===X){bh=k;}
;this.__si=false;this.__ss=false;this.__st=false;this.__su=bd;if(typeof be==X){be=true;}
;this.__sv=be;this.status=0;this.statusText=this.responseText=B;this.responseXML=null;this.response=null;if(!this.__sM()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__sB();}
;this.__sx.onreadystatechange=this.__so;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,o+bh+x+bd+Y+be);}
;this.__sx.open(bh,bd,be,bg,bf);}
catch(bi){if(!qx.util.Request.isCrossDomain(bd)){throw bi;}
;if(!this.__sv){this.__sw=bi;}
;if(this.__sv){if(window.XDomainRequest){this.readyState=4;this.__sx=new XDomainRequest();this.__sx.onerror=qx.Bootstrap.bind(function(){this._emit(C);this._emit(p);this._emit(q);}
,this);if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+bh+x+bd+Y+be);}
;this.__sx.open(bh,bd,be,bg,bf);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__sz){return;}
;this.readyState=4;this._emit(C);this._emit(p);this._emit(q);}
,this));}
;}
;if(qx.core.Environment.get(N)===M&&qx.core.Environment.get(z)<9&&this.__sx.readyState>0){this.__sx.setRequestHeader(h,l);}
;if(qx.core.Environment.get(N)===K&&parseInt(qx.core.Environment.get(i),10)<2&&!this.__sv){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(C);}
;}
,setRequestHeader:function(bj,bk){this.__sN();if(bj==L||bj==h||bj==f||bj==S){this.__st=true;}
;this.__sx.setRequestHeader(bj,bk);return this;}
,send:function(bm){this.__sN();if(!this.__sv&&this.__sw){throw this.__sw;}
;if(qx.core.Environment.get(N)===G&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__sy=window.setTimeout(this.__sf,this.timeout);}
;bm=typeof bm==X?null:bm;var bl=qx.Bootstrap.getClass(bm);bm=(bm!==null&&this.__sA.indexOf(bl)===-1)?bm.toString():bm;try{if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,Q);}
;if(this.__sv){this.__sx.responseType=this.responseType;}
;this.__sx.send(bm);}
catch(bo){if(!this.__sv){throw bo;}
;if(this._getProtocol()===P){this.readyState=2;this.__sF();var bn=this;window.setTimeout(function(){if(bn.__sz){return;}
;bn.readyState=3;bn.__sF();bn.readyState=4;bn.__sF();}
);}
;}
;if(qx.core.Environment.get(N)===K&&!this.__sv){this.__sE();}
;this.__ss=true;return this;}
,abort:function(){this.__sN();this.__si=true;this.__sx.abort();if(this.__sx&&this.readyState!==qx.bom.request.Xhr.DONE){this.readyState=this.__sx.readyState;}
;return this;}
...
,getResponseHeader:function(br){this.__sN();if(qx.core.Environment.get(z)===9&&this.__sx.aborted){return B;}
;return this.__sx.getResponseHeader(br);}
,getAllResponseHeaders:function(){this.__sN();if(qx.core.Environment.get(z)===9&&this.__sx.aborted){return B;}
;return this.__sx.getAllResponseHeaders();}
,overrideMimeType:function(bs){this.__sN();if(this.__sx.overrideMimeType){this.__sx.overrideMimeType(bs);}
else {throw new Error(bb);}
;return this;}
,getRequest:function(){return this.__sx;}
,dispose:function(){if(this.__sz){return false;}
;window.clearTimeout(this.__sy);if(window.detachEvent){window.detachEvent(j,this.__sr);}
;try{this.__sx.onreadystatechange;}
catch(bu){return false;}
;var bt=function(){}
;this.__sx.onreadystatechange=bt;this.__sx.onload=bt;this.__sx.onerror=bt;this.__sx.onprogress=bt;this.abort();this.__sx=null;this.__sz=true;return true;}
,isDisposed:function(){return !!this.__sz;}
...
,_getProtocol:function(){var bw=this.__su;var bx=/^(\w+:)\/\//;if(bw!==null&&bw.match){var by=bw.match(bx);if(by&&by[1]){return by[1];}
;}
;return window.location.protocol;}
,__sx:null,__sv:null,__so:null,__sp:null,__sq:null,__sr:null,__sf:null,__ss:null,__su:null,__si:null,__dj:null,__sz:null,__sy:null,__sw:null,__st:null,__sA:null,__sB:function(){this.__sx=this._createNativeXhr();this.__sx.onreadystatechange=this.__so;if(qx.Bootstrap.getClass(this.__sx.onabort)!==n){this.__sx.onabort=this.__sp;}
;if(qx.Bootstrap.getClass(this.__sx.onprogress)!==n){this.__sx.onprogress=this.__sq;this.progress={lengthComputable:false,loaded:0,total:0};}
;this.__sz=this.__ss=this.__si=false;this.__sA=[W,r,s,y,R];}
,__sC:function(){if(!this.__si){this.abort();}
;}
,__sD:function(e){this.progress.lengthComputable=e.lengthComputable;this.progress.loaded=e.loaded;this.progress.total=e.total;this._emit(t);}
,__sE:function(){var bz=this.__sx,bA=true;if(qx.core.Environment.get(m)){qx.Bootstrap.debug(qx.bom.request.Xhr,v+bz.readyState);}
;if(this.readyState==bz.readyState){return;}
;this.readyState=bz.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__si&&!this.__ss){return;}
;if(!this.__sv&&(bz.readyState==2||bz.readyState==3)){return;}
...
;if(bA){this.__sJ();this.__sK();}
;}
;this.__sF();if(this.readyState==qx.bom.request.Xhr.DONE){if(bz){bz.onreadystatechange=function(){}
;}
;}
;}
,__sF:function(){if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__sy);}
;this._emit(C);if(this.readyState===qx.bom.request.Xhr.DONE){this.__sG();}
;}
,__sG:function(){if(this.__dj){this._emit(J);if(qx.core.Environment.get(N)===G){this._emit(p);}
;this.__dj=false;}
else {if(this.__si){this._emit(w);}
else {if(this.__sH()){this._emit(p);}
else {this._emit(u);}
;}
;}
;this._emit(q);}
,__sH:function(){var bC;if(this._getProtocol()===P){bC=!this.responseText;}
else {bC=!this.statusText&&this.status!==204;}
;return bC;}
,__sI:function(){var bD=this.__sx;this.readyState=qx.bom.request.Xhr.DONE;this.__dj=true;bD.aborted=true;bD.abort();this.responseText=B;this.responseXML=null;this.__sF();}
,__sJ:function(){var bE=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===P&&this.status===0&&bE){if(!this.__sH()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(N)===G){if(bE&&this.__st&&!this.__si&&this.status===0){this.status=304;}
;}
;}
,__sK:function(){if(qx.core.Environment.get(N)==M&&(this.getResponseHeader(T)||B).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bF=new window.ActiveXObject(O);bF.async=false;bF.validateOnParse=false;bF.loadXML(this.responseText);this.responseXML=bF;}
;}
,__sL:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__sM:function(){var name=qx.core.Environment.get(N);var bG=qx.core.Environment.get(F);return !(name==M&&bG<9||name==K&&bG<3.5);}
,__sN:function(){if(this.__sz){throw new Error(E);}
;}
...
;}
,statics:{PARSER:{json:qx.lang.Json.parse,xml:qx.xml.Document.fromString}},members:{__sO:null,parse:function(h,g){var f=this._getParser(g);if(typeof f===a){if(h!==c){return f.call(this,h);}
;}
;return h;}
,setParser:function(i){if(typeof qx.util.ResponseParser.PARSER[i]===a){return this.__sO=qx.util.ResponseParser.PARSER[i];}
;if(qx.core.Environment.get(d)){qx.core.Assert.assertFunction(i);}
;return this.__sO=i;}
,_getParser:function(k){var j=this.__sO,m=c,l=c;if(j){return j;}
...
,open:function(H,G){if(this.__sz){return;}
;this.__uU();this.__si=null;this.__su=G;if(this.__va(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__sz){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__su=qx.util.Uri.appendParamsToUrl(this.__su,K);return this;}
,send:function(){if(this.__sz){return null;}
;var M=this.__uX(),L=this.__uR,N=this;if(this.timeout>0){this.__dh=window.setTimeout(this.__sf,this.timeout);}
...
,abort:function(){if(this.__sz){return null;}
;this.__si=true;this.__uY();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__sz){return null;}
;if(this.__va(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__sz){return null;}
;if(this.__va(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__uS=P;}
,dispose:function(){var Q=this.__uT;if(!this.__sz){if(Q){Q.onload=Q.onreadystatechange=null;this.__uY();}
...
;}
,_onNativeLoad:function(){var S=this.__uT,R=this.__uS,T=this;if(this.__si){return;}
...
,__uT:null,__uR:null,__su:n,__uP:null,__uQ:null,__sf:null,__dh:null,__si:null,__sz:null,__uU:function(){this.readyState=0;this.status=0;this.statusText=n;}
...
,__uX:function(){var X=this.__uT=document.createElement(i);X.src=this.__su;X.onerror=this.__uQ;X.onload=this.__uP;if(this.__va(x)===w&&this.__va(l)<9){X.onreadystatechange=this.__uP;}
;return X;}
...
,members:{responseJson:null,__cv:null,__vb:null,__vc:null,__vd:null,__ve:null,__vf:null,__sz:null,__vg:e,open:function(t,p){if(this.__sz){return;}
...
,callback:function(v){if(this.__sz){return;}
