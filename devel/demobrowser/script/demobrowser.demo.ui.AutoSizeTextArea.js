...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea.370c1be3ca7c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,append:function(k){var l=this.__Bi(k);Array.prototype.push.apply(this,l);return this;}
,prepend:function(m){var n=this.__Bi(m);Array.prototype.splice.apply(this,[0,0].concat(n));return this;}
,__Bi:function(o){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(o,c);}
