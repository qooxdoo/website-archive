...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea.3168a8813b49.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,append:function(k){var l=this.__Bg(k);Array.prototype.push.apply(this,l);return this;}
,prepend:function(m){var n=this.__Bg(m);Array.prototype.splice.apply(this,[0,0].concat(n));return this;}
,__Bg:function(o){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(o,c);}
