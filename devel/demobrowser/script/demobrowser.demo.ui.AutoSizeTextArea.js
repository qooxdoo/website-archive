...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea.57e107640f83.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,append:function(k){var l=this.__Bb(k);Array.prototype.push.apply(this,l);return this;}
,prepend:function(m){var n=this.__Bb(m);Array.prototype.splice.apply(this,[0,0].concat(n));return this;}
,__Bb:function(o){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(o,c);}
