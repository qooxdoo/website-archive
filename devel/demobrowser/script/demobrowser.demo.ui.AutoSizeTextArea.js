...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea.fa484a288cb4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,append:function(k){var l=this.__Bj(k);Array.prototype.push.apply(this,l);return this;}
,prepend:function(m){var n=this.__Bj(m);Array.prototype.splice.apply(this,[0,0].concat(n));return this;}
,__Bj:function(o){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(o,c);}
