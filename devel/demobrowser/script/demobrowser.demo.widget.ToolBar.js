...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ToolBar.a695ec81bef6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__oh(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__oe.length>0){do {var Q=this.__oe[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__oe.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__og(Q);G+=I;if(E&&this.__oe.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__oe.length>0);}
;}
,__og:function(R){R.setVisibility(o);this.__oe.shift();this.fireDataEvent(m,R);}
,__oh:function(S){if(!S){return;}
;this.__oe.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__of.length-1;i>=0;i-- ){var T=this.__of[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__of[W]!=undefined){throw new Error(v);}
;this.__of[W]=X;}
...
;for(var i=0;i<this.__oe.length;i++ ){this.__oe[i].setVisibility(o);}
;this.__oe=[];}
;}
...
;bf.setVisibility(y);}
;}
,__oi:false,_setAllowMenuOpenHover:function(bg){this.__oi=bg;}
...
(function(){var a="__on",b="blur",c="Enter",d="Escape",f="Space",g="keydown",h="Left",j="Down",k="Up",l="singleton",m="qx.debug",n="interval",o="roll",p="event.touch",q="__oo",r="Object is no menu: ",s="pointerdown",t="qx.ui.menu.Manager",u="keyup",v="keypress",w="contextmenu",x="__lS",y="Right";qx.Class.define(t,{type:l,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__lS=[];var z=document.body;var A=qx.event.Registration;A.addListener(window.document.documentElement,s,this._onPointerDown,this,true);A.addListener(z,o,this._onRoll,this,true);A.addListener(z,g,this._onKeyUpDown,this,true);A.addListener(z,u,this._onKeyUpDown,this,true);A.addListener(z,v,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,b,this.hideAll,this);}
;this.__on=new qx.event.Timer();this.__on.addListener(n,this._onOpenInterval,this);this.__oo=new qx.event.Timer();this.__oo.addListener(n,this._onCloseInterval,this);}
,members:{__op:null,__oq:null,__on:null,__oo:null,__lS:null,_getChild:function(B,D,C,G){var F=B.getChildren();var length=F.length;var E;for(var i=D;i<length&&i>=0;i+=C){E=F[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
...
,scheduleOpen:function(R){this.cancelClose(R);if(R.isVisible()){if(this.__op){this.cancelOpen(this.__op);}
;}
else if(this.__op!=R){this.__op=R;this.__on.restartWith(R.getOpenInterval());}
;}
,scheduleClose:function(S){this.cancelOpen(S);if(!S.isVisible()){if(this.__oq){this.cancelClose(this.__oq);}
;}
else if(this.__oq!=S){this.__oq=S;this.__oo.restartWith(S.getCloseInterval());}
;}
,cancelOpen:function(T){if(this.__op==T){this.__on.stop();this.__op=null;}
;}
,cancelClose:function(U){if(this.__oq==U){this.__oo.stop();this.__oq=null;}
;}
...
,preventContextMenuOnce:function(){qx.event.Registration.addListener(document.body,w,this.__or,this,true);}
,__or:function(e){var V=e.getTarget();V=qx.ui.core.Widget.getWidgetByElement(V,true);if(this._isInMenu(V)){e.stopPropagation();e.preventDefault();}
;qx.event.Registration.removeListener(document.body,w,this.__or,this,true);}
...
;}
,__os:{"Enter":1,"Space":1},__ot:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var X=this.getActiveMenu();if(!X){return;}
;var Y=e.getKeyIdentifier();if(this.__ot[Y]||(this.__os[Y]&&X.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var bc=this.getActiveMenu();if(!bc){return;}
;var ba=e.getKeyIdentifier();var be=this.__ot[ba];var bb=this.__os[ba];if(be){switch(ba){case k:this._onKeyPressUp(bc);break;case j:this._onKeyPressDown(bc);break;case h:this._onKeyPressLeft(bc);break;case y:this._onKeyPressRight(bc);break;case d:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
...
;this.__ox();}
,__ox:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__oy:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(n,this.__oy,this);return;}
...
;this.__ow=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__ow){this.__ow.call(this);delete this.__ow;}
;}
...
;this.__oy();}
;}
,_onPointerOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__ov=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__ov){bt.cancelOpen(this.__ov);this.__ov=null;}
;}
;}
...
;if(this.__ov){bw.cancelOpen(this.__ov);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__oz:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__oz=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__oz||null;}
...
;var x=this.__oA(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
...
;}
;}
,__oA:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
...
(function(){var a="hovered",b="hover-button",c="__dC",d="pointerover",f="interval",g="qx.ui.form.HoverButton",h="Integer",i="pointerout";qx.Class.define(g,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(d,this._onPointerOver,this);this.addListener(i,this._onPointerOut,this);this.__dC=new qx.event.AcceleratingTimer();this.__dC.addListener(f,this._onInterval,this);}
,properties:{appearance:{refine:true,init:b},interval:{check:h,init:80},firstInterval:{check:h,init:200},minTimer:{check:h,init:20},timerDecrease:{check:h,init:2}},members:{__dC:null,_onPointerOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__dC.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(a);}
,_onPointerOut:function(e){this.__dC.stop();this.removeState(a);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
,__oG:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
