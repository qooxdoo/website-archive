...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.3652354a83a8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__uA:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__uB:null,__uC:null,getLocal:function(){if(this.__uB){return this.__uB;}
;return this.__uB=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__uC){return this.__uC;}
;return this.__uC=new qx.bom.storage.Web(b);}
},construct:function(g){this.__qT=g;}
,members:{__qT:null,getStorage:function(){return window[this.__qT+c];}
,getLength:function(){return this.getStorage(this.__qT).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__qT).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__qT).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__qT).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__qT);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__qT).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__uB:null,__uC:null,__bG:0,getLocal:function(){if(this.__uB){return this.__uB;}
;return this.__uB=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__uC){return this.__uC;}
;return this.__uC=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__uD=document.createElement(f);this.__uD.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__uD);this.__uD.addBehavior(j);this.__uE=m;this.__uD.load(this.__uE);this.__fI={};this.__uF={};var l=this.__uD.getAttribute(d+qx.bom.storage.UserData.__bG);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fI[l.key]=l.value;this.__uF[l.key]=d+qx.bom.storage.UserData.__bG;qx.bom.storage.UserData.__bG++ ;l=this.__uD.getAttribute(d+qx.bom.storage.UserData.__bG);}
;}
,members:{__uD:null,__uE:h,__fI:null,__uF:null,getStorage:function(){return this.__fI;}
,getLength:function(){return Object.keys(this.__fI).length;}
,setItem:function(n,p){if(this.__uF[n]){var o=this.__uF[n];}
else {var o=d+qx.bom.storage.UserData.__bG;qx.bom.storage.UserData.__bG++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__uD.setAttribute(o,q);this.__uD.save(this.__uE);this.__fI[n]=p;this.__uF[n]=o;}
,getItem:function(r){return this.__fI[r]||null;}
,removeItem:function(v){var u=this.__uF[v];if(u==undefined){return;}
;this.__uD.removeAttribute(u);qx.bom.storage.UserData.__bG-- ;delete this.__fI[v];delete this.__uF[v];var t=d+qx.bom.storage.UserData.__bG;if(this.__uD.getAttribute(t)){var w=this.__uD.getAttribute(d+qx.bom.storage.UserData.__bG);this.__uD.removeAttribute(t);this.__uD.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__uF[s]=u;}
;this.__uD.save(this.__uE);}
,clear:function(){for(var x in this.__uF){this.__uD.removeAttribute(this.__uF[x]);}
;this.__uD.save(this.__uE);this.__fI={};this.__uF={};}
...
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__uB:null,__uC:null,getLocal:function(){if(this.__uB){return this.__uB;}
;return this.__uB=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__uC){return this.__uC;}
;return this.__uC=new qx.bom.storage.Memory();}
