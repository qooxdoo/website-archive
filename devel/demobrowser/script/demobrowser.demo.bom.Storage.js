...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.1bbb2d97f1c4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<em>no content</em>",b="Memory Storage",c="html.storage.local",d="html.storage.userdata",e="",f="list",g="save",h="value",i="Web Storage",j="demobrowser.demo.bom.Storage",k="<br>",l="tap",m="clear",n=":",o="using",p="remove",r="key",s="userData Storage";qx.Class.define(j,{extend:qx.application.Native,members:{__dP:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__dP=qx.bom.Storage.getLocal();var v=document.getElementById(g);var t=document.getElementById(m);var u=document.getElementById(p);var self=this;q(v).on(l,function(){var w=qx.bom.Input.getValue(document.getElementById(r));var x=qx.bom.Input.getValue(document.getElementById(h));self.__dP.setItem(w,x);self.updateList();}
);q(t).on(l,function(){self.__dP.clear();self.updateList();}
);q(u).on(l,function(){self.__dP.removeItem(self.__dP.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var y=document.getElementById(f);y.innerHTML=e;this.__dP.forEach(function(z,A){y.innerHTML+=z+n+A+k;}
...
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__uc:null,__ud:null,__bE:0,getLocal:function(){if(this.__uc){return this.__uc;}
;return this.__uc=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__ud){return this.__ud;}
;return this.__ud=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__ue=document.createElement(f);this.__ue.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__ue);this.__ue.addBehavior(j);this.__uf=m;this.__ue.load(this.__uf);this.__fw={};this.__ug={};var l=this.__ue.getAttribute(d+qx.bom.storage.UserData.__bE);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fw[l.key]=l.value;this.__ug[l.key]=d+qx.bom.storage.UserData.__bE;qx.bom.storage.UserData.__bE++ ;l=this.__ue.getAttribute(d+qx.bom.storage.UserData.__bE);}
;}
,members:{__ue:null,__uf:h,__fw:null,__ug:null,getStorage:function(){return this.__fw;}
,getLength:function(){return Object.keys(this.__fw).length;}
,setItem:function(n,p){if(this.__ug[n]){var o=this.__ug[n];}
else {var o=d+qx.bom.storage.UserData.__bE;qx.bom.storage.UserData.__bE++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__ue.setAttribute(o,q);this.__ue.save(this.__uf);this.__fw[n]=p;this.__ug[n]=o;}
,getItem:function(r){return this.__fw[r]||null;}
,removeItem:function(v){var u=this.__ug[v];if(u==undefined){return;}
;this.__ue.removeAttribute(u);qx.bom.storage.UserData.__bE-- ;delete this.__fw[v];delete this.__ug[v];var t=d+qx.bom.storage.UserData.__bE;if(this.__ue.getAttribute(t)){var w=this.__ue.getAttribute(d+qx.bom.storage.UserData.__bE);this.__ue.removeAttribute(t);this.__ue.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__ug[s]=u;}
;this.__ue.save(this.__uf);}
,clear:function(){for(var x in this.__ug){this.__ue.removeAttribute(this.__ug[x]);}
;this.__ue.save(this.__uf);this.__fw={};this.__ug={};}
