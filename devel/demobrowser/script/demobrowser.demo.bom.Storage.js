...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.94486d9a7d1c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<em>no content</em>",b="Memory Storage",c="html.storage.local",d="html.storage.userdata",e="",f="list",g="save",h="value",i="Web Storage",j="demobrowser.demo.bom.Storage",k="<br>",l="tap",m="clear",n=":",o="using",p="remove",r="key",s="userData Storage";qx.Class.define(j,{extend:qx.application.Native,members:{__ei:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__ei=qx.bom.Storage.getLocal();var v=document.getElementById(g);var t=document.getElementById(m);var u=document.getElementById(p);var self=this;q(v).on(l,function(){var w=qx.bom.Input.getValue(document.getElementById(r));var x=qx.bom.Input.getValue(document.getElementById(h));self.__ei.setItem(w,x);self.updateList();}
);q(t).on(l,function(){self.__ei.clear();self.updateList();}
);q(u).on(l,function(){self.__ei.removeItem(self.__ei.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var y=document.getElementById(f);y.innerHTML=e;this.__ei.forEach(function(z,A){y.innerHTML+=z+n+A+k;}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__ux:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__uy:null,__uz:null,getLocal:function(){if(this.__uy){return this.__uy;}
;return this.__uy=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__uz){return this.__uz;}
;return this.__uz=new qx.bom.storage.Web(b);}
},construct:function(g){this.__qQ=g;}
,members:{__qQ:null,getStorage:function(){return window[this.__qQ+c];}
,getLength:function(){return this.getStorage(this.__qQ).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__qQ).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__qQ).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__qQ).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__qQ);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__qQ).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__uy:null,__uz:null,__bG:0,getLocal:function(){if(this.__uy){return this.__uy;}
;return this.__uy=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__uz){return this.__uz;}
;return this.__uz=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__uA=document.createElement(f);this.__uA.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__uA);this.__uA.addBehavior(j);this.__uB=m;this.__uA.load(this.__uB);this.__fF={};this.__uC={};var l=this.__uA.getAttribute(d+qx.bom.storage.UserData.__bG);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fF[l.key]=l.value;this.__uC[l.key]=d+qx.bom.storage.UserData.__bG;qx.bom.storage.UserData.__bG++ ;l=this.__uA.getAttribute(d+qx.bom.storage.UserData.__bG);}
;}
,members:{__uA:null,__uB:h,__fF:null,__uC:null,getStorage:function(){return this.__fF;}
,getLength:function(){return Object.keys(this.__fF).length;}
,setItem:function(n,p){if(this.__uC[n]){var o=this.__uC[n];}
else {var o=d+qx.bom.storage.UserData.__bG;qx.bom.storage.UserData.__bG++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__uA.setAttribute(o,q);this.__uA.save(this.__uB);this.__fF[n]=p;this.__uC[n]=o;}
,getItem:function(r){return this.__fF[r]||null;}
,removeItem:function(v){var u=this.__uC[v];if(u==undefined){return;}
;this.__uA.removeAttribute(u);qx.bom.storage.UserData.__bG-- ;delete this.__fF[v];delete this.__uC[v];var t=d+qx.bom.storage.UserData.__bG;if(this.__uA.getAttribute(t)){var w=this.__uA.getAttribute(d+qx.bom.storage.UserData.__bG);this.__uA.removeAttribute(t);this.__uA.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__uC[s]=u;}
;this.__uA.save(this.__uB);}
,clear:function(){for(var x in this.__uC){this.__uA.removeAttribute(this.__uC[x]);}
;this.__uA.save(this.__uB);this.__fF={};this.__uC={};}
,getKey:function(y){return Object.keys(this.__fF)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__uy:null,__uz:null,getLocal:function(){if(this.__uy){return this.__uy;}
;return this.__uy=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__uz){return this.__uz;}
;return this.__uz=new qx.bom.storage.Memory();}
},construct:function(){this.__fF={};}
,members:{__fF:null,getStorage:function(){return this.__fF;}
,getLength:function(){return Object.keys(this.__fF).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__fF[b]=c;}
,getItem:function(e){var d=this.__fF[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__fF[f];}
,clear:function(){this.__fF={};}
,getKey:function(h){var g=Object.keys(this.__fF);return g[h];}
