...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.9cf37ef2ebe5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__uy:null,__uz:null,__cg:0,getLocal:function(){if(this.__uy){return this.__uy;}
;return this.__uy=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__uz){return this.__uz;}
;return this.__uz=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__uA=document.createElement(f);this.__uA.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__uA);this.__uA.addBehavior(j);this.__uB=m;this.__uA.load(this.__uB);this.__gB={};this.__uC={};var l=this.__uA.getAttribute(d+qx.bom.storage.UserData.__cg);while(l!=undefined){l=qx.lang.Json.parse(l);this.__gB[l.key]=l.value;this.__uC[l.key]=d+qx.bom.storage.UserData.__cg;qx.bom.storage.UserData.__cg++ ;l=this.__uA.getAttribute(d+qx.bom.storage.UserData.__cg);}
;}
,members:{__uA:null,__uB:h,__gB:null,__uC:null,getStorage:function(){return this.__gB;}
...
;var q=qx.lang.Json.stringify({key:n,value:p});this.__uA.setAttribute(o,q);this.__uA.save(this.__uB);this.__gB[n]=p;this.__uC[n]=o;}
,getItem:function(r){return this.__gB[r]||null;}
,removeItem:function(v){var u=this.__uC[v];if(u==undefined){return;}
;this.__uA.removeAttribute(u);qx.bom.storage.UserData.__cg-- ;delete this.__gB[v];delete this.__uC[v];var t=d+qx.bom.storage.UserData.__cg;if(this.__uA.getAttribute(t)){var w=this.__uA.getAttribute(d+qx.bom.storage.UserData.__cg);this.__uA.removeAttribute(t);this.__uA.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__uC[s]=u;}
;this.__uA.save(this.__uB);}
,clear:function(){for(var x in this.__uC){this.__uA.removeAttribute(this.__uC[x]);}
;this.__uA.save(this.__uB);this.__gB={};this.__uC={};}
