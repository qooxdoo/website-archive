...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.bd7334fe09d5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<em>no content</em>",b="Memory Storage",c="html.storage.local",d="html.storage.userdata",e="",f="list",g="save",h="value",i="Web Storage",j="demobrowser.demo.bom.Storage",k="<br>",l="tap",m="clear",n=":",o="using",p="remove",r="key",s="userData Storage";qx.Class.define(j,{extend:qx.application.Native,members:{__dR:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__dR=qx.bom.Storage.getLocal();var v=document.getElementById(g);var t=document.getElementById(m);var u=document.getElementById(p);var self=this;q(v).on(l,function(){var w=qx.bom.Input.getValue(document.getElementById(r));var x=qx.bom.Input.getValue(document.getElementById(h));self.__dR.setItem(w,x);self.updateList();}
);q(t).on(l,function(){self.__dR.clear();self.updateList();}
);q(u).on(l,function(){self.__dR.removeItem(self.__dR.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var y=document.getElementById(f);y.innerHTML=e;this.__dR.forEach(function(z,A){y.innerHTML+=z+n+A+k;}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__ul:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__um:null,__un:null,getLocal:function(){if(this.__um){return this.__um;}
;return this.__um=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__un){return this.__un;}
;return this.__un=new qx.bom.storage.Web(b);}
...
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__um:null,__un:null,__bG:0,getLocal:function(){if(this.__um){return this.__um;}
;return this.__um=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__un){return this.__un;}
;return this.__un=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__uo=document.createElement(f);this.__uo.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__uo);this.__uo.addBehavior(j);this.__up=m;this.__uo.load(this.__up);this.__fy={};this.__uq={};var l=this.__uo.getAttribute(d+qx.bom.storage.UserData.__bG);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fy[l.key]=l.value;this.__uq[l.key]=d+qx.bom.storage.UserData.__bG;qx.bom.storage.UserData.__bG++ ;l=this.__uo.getAttribute(d+qx.bom.storage.UserData.__bG);}
;}
,members:{__uo:null,__up:h,__fy:null,__uq:null,getStorage:function(){return this.__fy;}
,getLength:function(){return Object.keys(this.__fy).length;}
,setItem:function(n,p){if(this.__uq[n]){var o=this.__uq[n];}
else {var o=d+qx.bom.storage.UserData.__bG;qx.bom.storage.UserData.__bG++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__uo.setAttribute(o,q);this.__uo.save(this.__up);this.__fy[n]=p;this.__uq[n]=o;}
,getItem:function(r){return this.__fy[r]||null;}
,removeItem:function(v){var u=this.__uq[v];if(u==undefined){return;}
;this.__uo.removeAttribute(u);qx.bom.storage.UserData.__bG-- ;delete this.__fy[v];delete this.__uq[v];var t=d+qx.bom.storage.UserData.__bG;if(this.__uo.getAttribute(t)){var w=this.__uo.getAttribute(d+qx.bom.storage.UserData.__bG);this.__uo.removeAttribute(t);this.__uo.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__uq[s]=u;}
;this.__uo.save(this.__up);}
,clear:function(){for(var x in this.__uq){this.__uo.removeAttribute(this.__uq[x]);}
;this.__uo.save(this.__up);this.__fy={};this.__uq={};}
...
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__um:null,__un:null,getLocal:function(){if(this.__um){return this.__um;}
;return this.__um=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__un){return this.__un;}
;return this.__un=new qx.bom.storage.Memory();}
