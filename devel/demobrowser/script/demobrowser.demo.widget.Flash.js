...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.6ec390828a08.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__CH){this.__CH=new Date().getTime();}
;var bp=new Date().getTime()-this.__CH;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__CH=null;}
;}
else {this.fireEvent(p);this.__CH=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__CI(c,bB);}
,_applyScale:function(bD,bC){this.__CI(h,bD);}
,_applyWmode:function(bF,bE){this.__CI(m,bF);}
,_applyPlay:function(bH,bG){this.__CI(I,bH);}
,_applyLoop:function(bJ,bI){this.__CI(s,bJ);}
,_applyMenu:function(bL,bK){this.__CI(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__CI(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__CI(z,bP);}
,__CI:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__CJ={};this.__CK={};this.__CL={};}
,members:{__CJ:null,__CL:null,__CK:null,__CM:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__CM=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CK,this.__CJ);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CM){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__CM){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__CK;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__CM){throw new Error(d);}
;this.__CK=t;}
,getAttributes:function(){return this.__CL;}
...
else if(this.__CM){throw new Error(j);}
;if(v===null||v===undefined){delete this.__CL[u];}
else {this.__CL[u]=v;}
;}
,getParams:function(){return this.__CJ;}
...
;}
;}
;if(this.__CM){throw new Error(l);}
;if(x===null||x===undefined){delete this.__CJ[w];}
else {this.__CJ[w]=x;}
;}
,getFlashElement:function(){return this.__CM;}
},destruct:function(){if(this.__CM){qx.bom.Flash.destroy(this.__CM);}
