...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.1d784e79fbfc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CR){this.__CR=new Date().getTime();}
;var bn=new Date().getTime()-this.__CR;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CR=null;}
;}
...
,_applyQuality:function(bz,by){this.__CS(c,bz);}
,_applyScale:function(bB,bA){this.__CS(h,bB);}
,_applyWmode:function(bD,bC){this.__CS(m,bD);}
,_applyPlay:function(bF,bE){this.__CS(I,bF);}
,_applyLoop:function(bH,bG){this.__CS(s,bH);}
,_applyMenu:function(bJ,bI){this.__CS(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CS(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CS(z,bN);}
,__CS:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CT={};this.__CU={};this.__CV={};}
,members:{__CT:null,__CV:null,__CU:null,__CW:null,_createDomElement:function(){return qx.dom.Element.create(h);}
...
;if(this.__CW){throw new Error(j);}
...
else if(this.__CW){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CV[t];}
else {this.__CV[t]=u;}
;}
...
;if(w===null||w===undefined){delete this.__CT[v];}
else {this.__CT[v]=w;}
;}
