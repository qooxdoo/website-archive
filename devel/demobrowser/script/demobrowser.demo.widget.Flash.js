...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.d7273a1c287a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="Flash Player Version",c="__BK",d="right",f="qooxdoo is the best!",g="Message from Flash:",h="__BI",i="execute",j="Simple demo with FlashVars",k="bgcolor",l="demobrowser.demo.widget.Flash",m="demobrowser/demo/flash/TestFlash.swf",n="1) no pop-up or advertising blocker is activated.\n",o="Send to Flash",p="demobrowser/demo/flash/FlashVersion.swf",q="No message.",r="Flash:",s="<b>qooxdoo:</b>",t="__cL",u="__BH",v="demobrowser.demo.widget.Flash.sendMessage",w="demobrowser.demo.widget.Flash.flashReady",x="Couldn't connect to Flash Player! Please make sure that:\n",y="demobrowser/demo/flash/fo_tester.swf",z="this is passed in via FlashVars",A="Two way communication (ActionScript <-> JavaScript)",B="Message to Flash:",C="Show Flash Player version",D="__BJ",E="noscale",F="#FF6600";qx.Class.define(l,{extend:qx.application.Standalone,members:{__cL:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(j);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(A);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cL=this.createWindow();G.add(this.__cL,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:z};var M=new qx.ui.embed.Flash(y).set({scale:E,variables:L});M.getContentElement().setParam(k,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(C);O.addListener(i,function(){this.__cL.open();}
,this);N.add(O);return N;}
,__BH:null,__BI:null,__BJ:null,__BK:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(s).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__BI=new qx.ui.form.TextArea(q);this.__BI.setEnabled(false);Q.add(this.__BI,{flex:1});Q.add(new qx.ui.basic.Label(B));this.__BJ=new qx.ui.form.TextArea(f);Q.add(this.__BJ,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,d));this.__BK=new qx.ui.form.Button(o);this.__BK.setEnabled(false);this.__BK.addListener(i,function(e){this.__BH.getFlashElement().sendMessage(this.__BJ.getValue());}
,this);S.add(this.__BK);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(r).set({rich:true}));this.__BH=new qx.ui.embed.Flash(m);this.__BH.setVariables({init:w});P.add(this.__BH,{flex:1});return R;}
,sendMessage:function(T){this.__BI.setValue(T);}
,initFlash:function(){if(this.__BH.getFlashElement().setup){this.__BH.getFlashElement().setup(v);this.__BK.setEnabled(true);}
else {alert(x+n+a);}
;}
},statics:{__BL:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__BL=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__BL.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__BL.initFlash();}
},destruct:function(){this._disposeObjects(h,D,c,u,t);}
});}
)();
...
(function(){var a="sameDomain",b="Boolean",c="quality",d="_applyVariables",e="low",f="_applyLoop",g="opaque",h="scale",i="_applyAllowScriptAccess",j="showall",k="Map",l="_applyLiveConnect",m="wmode",n="Integer",o="_applyMenu",p="loaded",q="window",r="_applyPlay",s="loop",t="allowScriptAccess",u="qx.debug",v="menu",w="noborder",x="loading",y="qx.event.type.Event",z="swLiveConnect",A="Timeout after: ",B="qx.ui.embed.Flash",C="String",D="_applyId",E="high",F="",G="transparent",H="exactfit",I="play",J="autohigh",K="_applySource",L="appear",M="medium",N="Invalid parameter 'source'.",O="timeout",P="_applyMayScript",Q="best",R="_applyQuality",S="never",T="_applyScale",U="flash",V="always",W="Invalid parameter 'id'.",X="noscale",Y="undefined",bd="_applyWmode",be="autolow",bf="mayscript";qx.Class.define(B,{extend:qx.ui.core.Widget,construct:function(bg,bh){qx.ui.core.Widget.call(this);if(qx.core.Environment.get(u)){qx.core.Assert.assertString(bg,N);if(bh){qx.core.Assert.assertString(bh,W);}
;}
;this.setSource(bg);if(bh){this.setId(bh);}
else {this.setId(U+this.toHashCode());}
...
,this);}
,events:{"loading":y,"loaded":y,"timeout":y},properties:{source:{check:C,apply:K},id:{check:C,apply:D},quality:{check:[e,be,J,M,E,Q],init:Q,nullable:true,apply:R},scale:{check:[j,w,H,X],nullable:true,apply:T},wmode:{check:[q,g,G],init:g,nullable:true,apply:bd},play:{check:b,nullable:true,apply:r},loop:{check:b,nullable:true,apply:f},mayScript:{check:b,nullable:false,apply:P},menu:{check:b,nullable:true,apply:o},allowScriptAccess:{check:[a,V,S],init:a,nullable:true,apply:i},liveConnect:{check:b,init:true,nullable:true,apply:l},variables:{init:{},check:k,apply:d},loadTimeout:{check:n,init:10000}},members:{__CS:null,getFlashElement:function(){var bi=this.getContentElement();if(bi){return bi.getFlashElement();}
else {return null;}
;}
,isLoaded:function(){return this.getPercentLoaded()===100;}
,getPercentLoaded:function(){var bj=this.getFlashElement();if(typeof (bj)!=Y&&bj!=null){try{return bj.PercentLoaded();}
catch(bk){return 0;}
;}
else {return 0;}
;}
,_createContentElement:function(){var bl=new qx.html.Flash();bl.connectWidget(this);return bl;}
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CS){this.__CS=new Date().getTime();}
;var bn=new Date().getTime()-this.__CS;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CS=null;}
;}
else {this.fireEvent(p);this.__CS=null;}
;}
;}
,_applySource:function(br,bq){var bp=qx.util.ResourceManager.getInstance().toUri(br);this.getContentElement().setSource(bp);qx.ui.core.queue.Layout.add(this);}
,_applyId:function(bt,bs){this.getContentElement().setId(bt);qx.ui.core.queue.Layout.add(this);}
,_applyVariables:function(bv,bu){this.getContentElement().setVariables(bv);qx.ui.core.queue.Layout.add(this);}
,_applyMayScript:function(bx,bw){this.getContentElement().setAttribute(bf,bx?F:false);qx.ui.core.queue.Layout.add(this);}
,_applyQuality:function(bz,by){this.__CT(c,bz);}
,_applyScale:function(bB,bA){this.__CT(h,bB);}
,_applyWmode:function(bD,bC){this.__CT(m,bD);}
,_applyPlay:function(bF,bE){this.__CT(I,bF);}
,_applyLoop:function(bH,bG){this.__CT(s,bH);}
,_applyMenu:function(bJ,bI){this.__CT(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CT(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CT(z,bN);}
,__CT:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
...
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CU={};this.__CV={};this.__CW={};}
,members:{__CU:null,__CW:null,__CV:null,__CX:null,_createDomElement:function(){return qx.dom.Element.create(h);}
,createFlash:function(){this.__CX=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CV,this.__CU);}
,setSource:function(q){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(q,b);}
;if(this.__CX){throw new Error(j);}
;this.setAttribute(g,q);}
,setId:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CX){throw new Error(c);}
;this.setAttribute(m,r);}
,getVariables:function(){return this.__CV;}
,setVariables:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(s,b);}
;if(this.__CX){throw new Error(d);}
;this.__CV=s;}
,getAttributes:function(){return this.__CW;}
,setAttribute:function(t,u){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(t,f);if(arguments.length>1&&u!==null){if(!qx.lang.Type.isBoolean(u)&&!qx.lang.Type.isString(u)){throw new Error(l);}
;}
;}
;if(t.indexOf(a)===0){qx.html.Element.prototype.setAttribute.call(this,t,u);}
else if(this.__CX){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CW[t];}
else {this.__CW[t]=u;}
;}
,getParams:function(){return this.__CU;}
,setParam:function(v,w){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(v,f);if(arguments.length>1&&w!==null){if(!qx.lang.Type.isBoolean(w)&&!qx.lang.Type.isString(w)){throw new Error(l);}
;}
;}
;if(this.__CX){throw new Error(k);}
;if(w===null||w===undefined){delete this.__CU[v];}
else {this.__CU[v]=w;}
;}
,getFlashElement:function(){return this.__CX;}
},destruct:function(){if(this.__CX){qx.bom.Flash.destroy(this.__CX);}
;this.__CU=this.__CV=this.__CW=null;}
});}
)();
