...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.afdb5acf267a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CJ){this.__CJ=new Date().getTime();}
;var bn=new Date().getTime()-this.__CJ;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CJ=null;}
;}
else {this.fireEvent(p);this.__CJ=null;}
;}
;}
...
,_applyQuality:function(bz,by){this.__CK(c,bz);}
,_applyScale:function(bB,bA){this.__CK(h,bB);}
,_applyWmode:function(bD,bC){this.__CK(m,bD);}
,_applyPlay:function(bF,bE){this.__CK(I,bF);}
,_applyLoop:function(bH,bG){this.__CK(s,bH);}
,_applyMenu:function(bJ,bI){this.__CK(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CK(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CK(z,bN);}
,__CK:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CL={};this.__CM={};this.__CN={};}
,members:{__CL:null,__CN:null,__CM:null,__CO:null,_createDomElement:function(){return qx.dom.Element.create(h);}
,createFlash:function(){this.__CO=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CM,this.__CL);}
,setSource:function(q){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(q,b);}
;if(this.__CO){throw new Error(j);}
;this.setAttribute(g,q);}
,setId:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CO){throw new Error(c);}
;this.setAttribute(m,r);}
,getVariables:function(){return this.__CM;}
,setVariables:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(s,b);}
;if(this.__CO){throw new Error(d);}
;this.__CM=s;}
,getAttributes:function(){return this.__CN;}
...
else if(this.__CO){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CN[t];}
else {this.__CN[t]=u;}
;}
,getParams:function(){return this.__CL;}
...
;}
;}
;if(this.__CO){throw new Error(k);}
;if(w===null||w===undefined){delete this.__CL[v];}
else {this.__CL[v]=w;}
;}
,getFlashElement:function(){return this.__CO;}
},destruct:function(){if(this.__CO){qx.bom.Flash.destroy(this.__CO);}
