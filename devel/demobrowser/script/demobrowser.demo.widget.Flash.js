...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.490cf2f3e363.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CN){this.__CN=new Date().getTime();}
;var bn=new Date().getTime()-this.__CN;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CN=null;}
;}
else {this.fireEvent(p);this.__CN=null;}
;}
;}
...
,_applyQuality:function(bz,by){this.__CO(c,bz);}
,_applyScale:function(bB,bA){this.__CO(h,bB);}
,_applyWmode:function(bD,bC){this.__CO(m,bD);}
,_applyPlay:function(bF,bE){this.__CO(I,bF);}
,_applyLoop:function(bH,bG){this.__CO(s,bH);}
,_applyMenu:function(bJ,bI){this.__CO(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CO(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CO(z,bN);}
,__CO:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CP={};this.__CQ={};this.__CR={};}
,members:{__CP:null,__CR:null,__CQ:null,__CS:null,_createDomElement:function(){return qx.dom.Element.create(h);}
,createFlash:function(){this.__CS=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CQ,this.__CP);}
,setSource:function(q){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(q,b);}
;if(this.__CS){throw new Error(j);}
;this.setAttribute(g,q);}
,setId:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CS){throw new Error(c);}
;this.setAttribute(m,r);}
,getVariables:function(){return this.__CQ;}
,setVariables:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(s,b);}
;if(this.__CS){throw new Error(d);}
;this.__CQ=s;}
,getAttributes:function(){return this.__CR;}
...
else if(this.__CS){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CR[t];}
else {this.__CR[t]=u;}
;}
,getParams:function(){return this.__CP;}
...
;}
;}
;if(this.__CS){throw new Error(k);}
;if(w===null||w===undefined){delete this.__CP[v];}
else {this.__CP[v]=w;}
;}
,getFlashElement:function(){return this.__CS;}
},destruct:function(){if(this.__CS){qx.bom.Flash.destroy(this.__CS);}
