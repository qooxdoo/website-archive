...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.1bccc04ca27c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CQ){this.__CQ=new Date().getTime();}
;var bn=new Date().getTime()-this.__CQ;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CQ=null;}
;}
else {this.fireEvent(p);this.__CQ=null;}
;}
;}
...
,_applyQuality:function(bz,by){this.__CR(c,bz);}
,_applyScale:function(bB,bA){this.__CR(h,bB);}
,_applyWmode:function(bD,bC){this.__CR(m,bD);}
,_applyPlay:function(bF,bE){this.__CR(I,bF);}
,_applyLoop:function(bH,bG){this.__CR(s,bH);}
,_applyMenu:function(bJ,bI){this.__CR(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CR(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CR(z,bN);}
,__CR:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CS={};this.__CT={};this.__CU={};}
,members:{__CS:null,__CU:null,__CT:null,__CV:null,_createDomElement:function(){return qx.dom.Element.create(h);}
,createFlash:function(){this.__CV=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CT,this.__CS);}
,setSource:function(q){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(q,b);}
;if(this.__CV){throw new Error(j);}
;this.setAttribute(g,q);}
,setId:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CV){throw new Error(c);}
;this.setAttribute(m,r);}
,getVariables:function(){return this.__CT;}
,setVariables:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(s,b);}
;if(this.__CV){throw new Error(d);}
;this.__CT=s;}
,getAttributes:function(){return this.__CU;}
...
else if(this.__CV){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CU[t];}
else {this.__CU[t]=u;}
;}
,getParams:function(){return this.__CS;}
...
;}
;}
;if(this.__CV){throw new Error(k);}
;if(w===null||w===undefined){delete this.__CS[v];}
else {this.__CS[v]=w;}
;}
,getFlashElement:function(){return this.__CV;}
},destruct:function(){if(this.__CV){qx.bom.Flash.destroy(this.__CV);}
;this.__CS=this.__CT=this.__CU=null;}
});}
)();
