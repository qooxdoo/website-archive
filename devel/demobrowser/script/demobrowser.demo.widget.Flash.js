...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.b04f337761e1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CL){this.__CL=new Date().getTime();}
;var bn=new Date().getTime()-this.__CL;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CL=null;}
;}
else {this.fireEvent(p);this.__CL=null;}
;}
;}
...
,_applyQuality:function(bz,by){this.__CM(c,bz);}
,_applyScale:function(bB,bA){this.__CM(h,bB);}
,_applyWmode:function(bD,bC){this.__CM(m,bD);}
,_applyPlay:function(bF,bE){this.__CM(I,bF);}
,_applyLoop:function(bH,bG){this.__CM(s,bH);}
,_applyMenu:function(bJ,bI){this.__CM(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CM(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CM(z,bN);}
,__CM:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CN={};this.__CO={};this.__CP={};}
,members:{__CN:null,__CP:null,__CO:null,__CQ:null,_createDomElement:function(){return qx.dom.Element.create(h);}
...
;if(this.__CQ){throw new Error(d);}
;this.__CO=s;}
...
else if(this.__CQ){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CP[t];}
else {this.__CP[t]=u;}
;}
...
;}
;}
;if(this.__CQ){throw new Error(k);}
;if(w===null||w===undefined){delete this.__CN[v];}
else {this.__CN[v]=w;}
;}
