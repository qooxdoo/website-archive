...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.97f8c362851d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CM){this.__CM=new Date().getTime();}
;var bn=new Date().getTime()-this.__CM;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CM=null;}
;}
else {this.fireEvent(p);this.__CM=null;}
;}
;}
...
,_applyQuality:function(bz,by){this.__CN(c,bz);}
,_applyScale:function(bB,bA){this.__CN(h,bB);}
,_applyWmode:function(bD,bC){this.__CN(m,bD);}
,_applyPlay:function(bF,bE){this.__CN(I,bF);}
,_applyLoop:function(bH,bG){this.__CN(s,bH);}
,_applyMenu:function(bJ,bI){this.__CN(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CN(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CN(z,bN);}
,__CN:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CO={};this.__CP={};this.__CQ={};}
,members:{__CO:null,__CQ:null,__CP:null,__CR:null,_createDomElement:function(){return qx.dom.Element.create(h);}
,createFlash:function(){this.__CR=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CP,this.__CO);}
,setSource:function(q){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(q,b);}
;if(this.__CR){throw new Error(j);}
;this.setAttribute(g,q);}
,setId:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CR){throw new Error(c);}
;this.setAttribute(m,r);}
,getVariables:function(){return this.__CP;}
,setVariables:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(s,b);}
;if(this.__CR){throw new Error(d);}
;this.__CP=s;}
,getAttributes:function(){return this.__CQ;}
...
else if(this.__CR){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CQ[t];}
else {this.__CQ[t]=u;}
;}
,getParams:function(){return this.__CO;}
...
;}
;}
;if(this.__CR){throw new Error(k);}
;if(w===null||w===undefined){delete this.__CO[v];}
else {this.__CO[v]=w;}
;}
,getFlashElement:function(){return this.__CR;}
},destruct:function(){if(this.__CR){qx.bom.Flash.destroy(this.__CR);}
;this.__CO=this.__CP=this.__CQ=null;}
});}
)();
