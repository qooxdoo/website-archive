...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.f82fa763e559.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__CI){this.__CI=new Date().getTime();}
;var bp=new Date().getTime()-this.__CI;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__CI=null;}
;}
else {this.fireEvent(p);this.__CI=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__CJ(c,bB);}
,_applyScale:function(bD,bC){this.__CJ(h,bD);}
,_applyWmode:function(bF,bE){this.__CJ(m,bF);}
,_applyPlay:function(bH,bG){this.__CJ(I,bH);}
,_applyLoop:function(bJ,bI){this.__CJ(s,bJ);}
,_applyMenu:function(bL,bK){this.__CJ(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__CJ(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__CJ(z,bP);}
,__CJ:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__CK={};this.__CL={};this.__CM={};}
,members:{__CK:null,__CM:null,__CL:null,__CN:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__CN=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CL,this.__CK);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CN){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__CN){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__CL;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__CN){throw new Error(d);}
;this.__CL=t;}
,getAttributes:function(){return this.__CM;}
...
else if(this.__CN){throw new Error(j);}
;if(v===null||v===undefined){delete this.__CM[u];}
else {this.__CM[u]=v;}
;}
,getParams:function(){return this.__CK;}
...
;}
;}
;if(this.__CN){throw new Error(l);}
;if(x===null||x===undefined){delete this.__CK[w];}
else {this.__CK[w]=x;}
;}
,getFlashElement:function(){return this.__CN;}
},destruct:function(){if(this.__CN){qx.bom.Flash.destroy(this.__CN);}
