...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.f52b7d4745c9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__CF){this.__CF=new Date().getTime();}
;var bp=new Date().getTime()-this.__CF;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__CF=null;}
;}
else {this.fireEvent(p);this.__CF=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__CG(c,bB);}
,_applyScale:function(bD,bC){this.__CG(h,bD);}
,_applyWmode:function(bF,bE){this.__CG(m,bF);}
,_applyPlay:function(bH,bG){this.__CG(I,bH);}
,_applyLoop:function(bJ,bI){this.__CG(s,bJ);}
,_applyMenu:function(bL,bK){this.__CG(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__CG(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__CG(z,bP);}
,__CG:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__CH={};this.__CI={};this.__CJ={};}
,members:{__CH:null,__CJ:null,__CI:null,__CK:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__CK=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CI,this.__CH);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CK){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__CK){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__CI;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__CK){throw new Error(d);}
;this.__CI=t;}
,getAttributes:function(){return this.__CJ;}
...
else if(this.__CK){throw new Error(j);}
;if(v===null||v===undefined){delete this.__CJ[u];}
else {this.__CJ[u]=v;}
;}
,getParams:function(){return this.__CH;}
...
;}
;}
;if(this.__CK){throw new Error(l);}
;if(x===null||x===undefined){delete this.__CH[w];}
else {this.__CH[w]=x;}
;}
,getFlashElement:function(){return this.__CK;}
},destruct:function(){if(this.__CK){qx.bom.Flash.destroy(this.__CK);}
;this.__CH=this.__CI=this.__CJ=null;}
});}
)();
