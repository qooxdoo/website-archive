...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.abd2bdc41a0b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_checkLoading:function(){var bm=this.getSource();if(bm!=F&&bm!=null&&bm!=Y){if(!this.isLoaded()){if(!this.__CP){this.__CP=new Date().getTime();}
;var bn=new Date().getTime()-this.__CP;if(this.getLoadTimeout()>bn){var bo=qx.util.TimerManager.getInstance();bo.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bn);}
;this.fireEvent(O);this.__CP=null;}
;}
else {this.fireEvent(p);this.__CP=null;}
;}
;}
...
,_applyQuality:function(bz,by){this.__CQ(c,bz);}
,_applyScale:function(bB,bA){this.__CQ(h,bB);}
,_applyWmode:function(bD,bC){this.__CQ(m,bD);}
,_applyPlay:function(bF,bE){this.__CQ(I,bF);}
,_applyLoop:function(bH,bG){this.__CQ(s,bH);}
,_applyMenu:function(bJ,bI){this.__CQ(v,bJ);}
,_applyAllowScriptAccess:function(bL,bK){this.__CQ(t,bL);}
,_applyLiveConnect:function(bN,bM){this.__CQ(z,bN);}
,__CQ:function(bO,bP){this.getContentElement().setParam(bO,bP);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="Invalid attribute 'key'.",g="movie",h="div",i="The attributes cannot be modified after initial creation",j="The source cannot be modified after initial creation",k="The params cannot be modified after initial creation",l="Invalid attribute 'value' expected String, Boolean or null.",m="id",n="qx.html.Flash";qx.Class.define(n,{extend:qx.html.Element,construct:function(o,p){qx.html.Element.call(this,h,o,p);this.__CR={};this.__CS={};this.__CT={};}
,members:{__CR:null,__CT:null,__CS:null,__CU:null,_createDomElement:function(){return qx.dom.Element.create(h);}
,createFlash:function(){this.__CU=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CS,this.__CR);}
,setSource:function(q){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(q,b);}
;if(this.__CU){throw new Error(j);}
;this.setAttribute(g,q);}
,setId:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__CU){throw new Error(c);}
;this.setAttribute(m,r);}
,getVariables:function(){return this.__CS;}
,setVariables:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(s,b);}
;if(this.__CU){throw new Error(d);}
;this.__CS=s;}
,getAttributes:function(){return this.__CT;}
...
else if(this.__CU){throw new Error(i);}
;if(u===null||u===undefined){delete this.__CT[t];}
else {this.__CT[t]=u;}
;}
,getParams:function(){return this.__CR;}
...
;}
;}
;if(this.__CU){throw new Error(k);}
;if(w===null||w===undefined){delete this.__CR[v];}
else {this.__CR[v]=w;}
;}
,getFlashElement:function(){return this.__CU;}
},destruct:function(){if(this.__CU){qx.bom.Flash.destroy(this.__CU);}
