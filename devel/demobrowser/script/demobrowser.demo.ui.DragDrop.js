...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop.f8f8beee97e5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" array contains ",b="__dl",c="qx.ui.core.MSingleSelectionHandling",d=" items!",f="changeSelection",g="changeSelected",h="Could only select one item, but the selection",i="qx.event.type.Data";qx.Mixin.define(c,{events:{"changeSelection":i},members:{__dl:null,getSelection:function(){var j=this.__qb().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__qb().setSelected(k[0]);break;default:throw new Error(h+a+k.length+d);};}
,resetSelection:function(){this.__qb().resetSelected();}
,isSelected:function(l){return this.__qb().isSelected(l);}
,isSelectionEmpty:function(){return this.__qb().isSelectionEmpty();}
,getSelectables:function(m){return this.__qb().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(f,o,n);}
,__qb:function(){if(this.__dl==null){var p=this;this.__dl=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
...
(function(){var a=", because it is not a child element!",b="__qe",c="Boolean",d="__qc",e="qx.ui.core.SingleSelectionManager",f="qx.debug",g="__qd",h="Invalid selectionProvider!",j="Could not check if ",k=" is selected,",l="Could not select ",m="changeSelected",n=" because it is not a child element!",o="qx.event.type.Data";qx.Class.define(e,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(f)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,h);}
;this.__qc=p;}
,events:{"changeSelected":o},properties:{allowEmptySelection:{check:c,init:true,apply:b}},members:{__qd:null,__qc:null,getSelected:function(){return this.__qd;}
,setSelected:function(q){if(!this.__qg(q)){throw new Error(l+q+a);}
;this.__qf(q);}
,resetSelected:function(){this.__qf(null);}
,isSelected:function(r){if(!this.__qg(r)){throw new Error(j+r+k+n);}
;return this.__qd===r;}
,isSelectionEmpty:function(){return this.__qd==null;}
,getSelectables:function(t){var s=this.__qc.getItems();var u=[];for(var i=0;i<s.length;i++ ){if(this.__qc.isItemSelectable(s[i])){u.push(s[i]);}
;}
;if(!t){for(var i=u.length-1;i>=0;i-- ){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__qe:function(w,v){if(!w){this.__qf(this.__qd);}
;}
,__qf:function(x){var A=this.__qd;var y=x;if(y!=null&&A===y){return;}
;if(!this.isAllowEmptySelection()&&y==null){var z=this.getSelectables(true)[0];if(z){y=z;}
;}
;this.__qd=y;this.fireDataEvent(m,y,A);}
,__qg:function(B){var C=this.__qc.getItems();for(var i=0;i<C.length;i++ ){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__qc.toHashCode){this._disposeObjects(d);}
else {this.__qc=null;}
...
;}
,remove:function(w){var x=this.__qS;if(qx.lang.Array.contains(x,w)){qx.lang.Array.remove(x,w);if(w.getGroup()===this){w.resetGroup();}
;w.removeListener(p,this._onItemChangeChecked,this);if(w.getValue()){this.resetSelection();}
;}
;}
,getChildren:function(){return this.__qS;}
...
;}
,_applyInvalidMessage:function(A,z){for(var i=0;i<this.__qS.length;i++ ){this.__qS[i].setInvalidMessage(A);}
;}
,_applyValid:function(C,B){for(var i=0;i<this.__qS.length;i++ ){this.__qS[i].setValid(C);}
;}
,_applyEnabled:function(F,E){var D=this.__qS;if(F==null){for(var i=0,l=D.length;i<l;i++ ){D[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var J=this.getSelection()[0];var K=this.__qS;var I=K.indexOf(J);if(I==-1){return;}
...
,selectPrevious:function(){var M=this.getSelection()[0];var N=this.__qS;var L=N.indexOf(M);if(L==-1){return;}
...
,_isItemSelectable:function(O){return this.__qS.indexOf(O)!=-1;}
,__qh:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
...
;var cK=this.getContentElement();if(cF&&this.__pT){if(this.__pT){var cH=this.getInsets();this._getPlaceholderElement().setStyles({paddingTop:cH.top+cM,paddingRight:cH.right+cM,paddingBottom:cH.bottom+cM,paddingLeft:cH.left+cM});}
;}
;if(cJ||cL.margin){if(this.__pT){var cH=this.getInsets();this._getPlaceholderElement().setStyles({"width":(innerWidth-cH.left-cH.right)+cM,"height":(innerHeight-cH.top-cH.bottom)+cM});}
;cK.setStyles({"width":innerWidth+cM,"height":innerHeight+cM});this._renderContentElement(innerHeight,cK);}
;if(cL.position){if(this.__pT){this._getPlaceholderElement().setStyles({"left":cN+cM,"top":top+cM});}
;}
;}
...
;return cP;}
,_applyEnabled:function(cS,cR){qx.ui.core.Widget.prototype._applyEnabled.call(this,cS,cR);this.getContentElement().setEnabled(cS);if(this.__pT){if(cS){this._showPlaceholder();}
else {this._removePlaceholder();}
;}
else {var cQ=this.getContentElement();cQ.setAttribute(bW,cS?this.getPlaceholder():cm);}
;}
,__pV:{width:16,height:16},_getContentHint:function(){return {width:this.__pV.width*10,height:this.__pV.height||16};}
,_applyFont:function(cV,cU){if(cU&&this.__ma&&this.__md){this.__ma.removeListenerById(this.__md);this.__md=null;}
;var cT;if(cV){this.__ma=qx.theme.manager.Font.getInstance().resolve(cV);if(this.__ma instanceof qx.bom.webfonts.WebFont){this.__md=this.__ma.addListener(C,this._onWebFontStatusChange,this);}
;cT=this.__ma.getStyles();}
...
;if(this.__pT){delete cT[F];this._getPlaceholderElement().setStyles(cT);}
;if(cV){this.__pV=qx.bom.Label.getTextSize(D,cT);}
else {delete this.__pV;}
;qx.ui.core.queue.Layout.add(this);}
...
,_getTextSize:function(){return this.__pV;}
,_onHtmlInput:function(e){var dd=e.getData();var dc=true;this.__pU=false;if(this.__jv&&this.__jv===dd){dc=false;}
...
;}
;if(dc){this.fireDataEvent(r,dd,this.__jv);this.__jv=dd;if(this.getLiveUpdate()){this.__pW(dd);}
;}
;}
,_onWebFontStatusChange:function(dh){if(dh.getData().valid===true){var dg=this.__ma.getStyles();this.__pV=qx.bom.Label.getTextSize(D,dg);qx.ui.core.queue.Layout.add(this);}
;}
,__pW:function(dj){var di=this.__ju;this.__ju=dj;if(di!=dj){this.fireNonBubblingEvent(c,qx.event.type.Data,[dj,di]);}
;}
,setValue:function(dn){if(this.isDisposed()){return null;}
;if(dn===null){if(this.__pU){return dn;}
;dn=cm;this.__pU=true;}
else {this.__pU=false;if(this.__pT){this._removePlaceholder();}
;}
;if(qx.lang.Type.isString(dn)){var dm=this.getContentElement();if(dm.getValue()!=dn){var dk=dm.getValue();dm.setValue(dn);var dl=this.__pU?null:dn;this.__ju=dk;this.__pW(dl);this.__jv=this.__ju;}
;if(this.__pT){this._showPlaceholder();}
;return dn;}
;throw new Error(J+dn);}
,getValue:function(){return (this.isDisposed()||this.__pU)?null:this.getContentElement().getValue();}
,resetValue:function(){this.setValue(null);}
,_onChangeContent:function(e){this.__pU=e.getData()===null;this.__pW(e.getData());}
...
,setLayoutParent:function(parent){qx.ui.core.Widget.prototype.setLayoutParent.call(this,parent);if(this.__pT){if(parent){this.getLayoutParent().getContentElement().add(this._getPlaceholderElement());}
...
.bind(this),0);}
,_removePlaceholder:function(){if(this.hasState(j)){if(this.__pT){this._getPlaceholderElement().setStyle(cv,Y);}
;this.removeState(j);}
;}
,_syncPlaceholder:function(){if(this.hasState(j)&&this.__pT){this._getPlaceholderElement().setStyle(cv,M);}
;}
...
;if(!this.__pT&&qx.ui.form.AbstractField.__dN){qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__dN);qx.ui.form.AbstractField.__dN=null;qx.ui.form.AbstractField.__pS();}
;}
,_applyPlaceholder:function(dw,dv){if(this.__pT){this._getPlaceholderElement().setValue(dw);if(dw!=null){this.addListener(V,this._removePlaceholder,this);this.addListener(ct,this._showPlaceholder,this);this._showPlaceholder();}
...
;this._placeholder=this.__ma=null;if(qx.core.Environment.get(s)){qx.locale.Manager.getInstance().removeListener(cg,this._onChangeLocale,this);}
;if(this.__ma&&this.__md){this.__ma.removeListenerById(this.__md);}
...
;qx.html.Element.call(this,t,q,r);this.__pX=s;}
,members:{__pX:null,__pY:null,__qa:null,_createDomElement:function(){return qx.bom.Input.create(this.__pX);}
...
;}
,setEnabled:function(w){this.__qa=w;this.setAttribute(l,w===false);if(qx.core.Environment.get(a)==g){if(!w){this.setStyles({"userModify":m,"userSelect":d});}
else {this.setStyles({"userModify":null,"userSelect":this.__pY?null:d});}
;}
;}
,setSelectable:qx.core.Environment.select(a,{"webkit":function(x){this.__pY=x;qx.html.Element.prototype.setSelectable.call(this,this.__qa&&x);}
...
,setWrap:function(C,D){if(this.__pX===n){this._setProperty(c,C,D);}
else {throw new Error(e);}
;return this;}
,getWrap:function(){if(this.__pX===n){return this._getProperty(c);}
else {throw new Error(e);}
;}
}});}
)();
...
,properties:{wrap:{check:b,init:true,apply:f},appearance:{refine:true,init:j},singleStep:{check:i,init:20},minimalLineHeight:{check:i,apply:h,init:4},autoSize:{check:b,apply:w,init:false}},members:{__qF:null,__qG:null,__qH:null,setValue:function(M){M=qx.ui.form.AbstractField.prototype.setValue.call(this,M);this.__qI();return M;}
...
;}
,__qI:function(){if(this.isAutoSize()){var R=this.__qJ();if(R&&this.getBounds()){this.__qH=this.__qH||this._getAreaHeight();var T=this._getScrolledAreaHeight();if(this.getMaxHeight()){var P=this.getInsets();var Q=-P.top+this.getMaxHeight()-P.bottom;if(T>Q){this.getContentElement().setStyle(I,k);}
else {this.getContentElement().setStyle(I,H);}
;}
;var S=Math.max(T,this.__qH);this._setAreaHeight(S);}
else {this.getContentElement().addListenerOnce(x,function(){this.__qI();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(U){if(this._getAreaHeight()!==U){this.__qG=U;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__qM();}
;}
,_getScrolledAreaHeight:function(){var W=this.__qJ();var V=W.getDomElement();if(V){if(!V.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;this.__qL(W);if(qx.core.Environment.get(C)==B&&qx.core.Environment.get(s)==8){if(!V.scrollTop){qx.html.Element.flush();}
;}
;return V.scrollTop;}
;}
,__qJ:function(){this.__qF=this.__qF||this.__qK();return this.__qF;}
,__qK:function(){var ba,Y,bb,X;ba=this.getContentElement();if(!ba.getDomElement()){return null;}
;bb=qx.bom.Element.clone(ba.getDomElement());X=new qx.html.Input(j);X.useElement(bb);Y=X;Y.setStyles({position:K,top:0,left:o,height:0,overflow:H},true);Y.removeAttribute(G);Y.removeAttribute(z);Y.setAttribute(y,g);Y.setValue(ba.getValue()||t);Y.insertBefore(ba);this.__qL(Y);return Y;}
,__qL:function(bc){bc=bc.getDomElement();if(bc){bc.scrollTop=10000;}
;}
...
,_applyAutoSize:function(bh,bg){if(qx.core.Environment.get(m)){this.__qN();}
;if(bh){this.__qI();this.addListener(a,this.__qI,this);if(!this.getBounds()){this.addListenerOnce(x,function(){this.getContentElement().setStyle(I,H);}
);}
else {this.getContentElement().setStyle(I,H);}
;}
else {this.removeListener(a,this.__qI);this.getContentElement().setStyle(I,k);}
;}
,_applyDimension:function(bi){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(m)){this.__qN();}
;if(bi===this.getMaxHeight()){this.__qI();}
;}
,__qM:function(){var content=this.getContentElement();var bk=content.getDomElement();var bj=content.getStyle(u);content.setStyle(u,parseInt(bj,10)+1000+c,true);if(bk){qx.bom.element.Dimension.getWidth(bk);}
;content.setStyle(u,bj,true);}
,__qN:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(n+J+v);}
;}
,_getContentHint:function(){var bl=qx.ui.form.AbstractField.prototype._getContentHint.call(this);bl.height=bl.height*this.getMinimalLineHeight();bl.width=this._getTextSize().width*20;if(this.isAutoSize()){bl.height=this.__qG||bl.height;}
;return bl;}
},destruct:function(){this.setAutoSize(false);if(this.__qF){this.__qF.dispose();}
;}
});}
)();
