...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.f00a3812bb81.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{anonymous:{refine:true,init:true}},members:{__jB:null,__bV:null,__xy:null,__xz:null,__wX:null,__ot:null,getFirstRow:function(){return this.__xy;}
...
;if(this.__jB.fullUpdate||this.__jB.updateLayerWindow&&this.__jB.updateLayerData){this._fullUpdate.apply(this,this.__bV);}
else if(this.__jB.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bV);}
else if(this.__jB.updateLayerData&&this.__wX){this._updateLayerData();}
;if(this.__jB.fullUpdate||this.__jB.updateLayerWindow){var d=this.__bV;this.__xy=d[0];this.__xz=d[1];this.__wX=d[2];this.__ot=d[3];}
;this.__jB={};}
...
,fullUpdate:function(p,q,o,n){this.__bV=arguments;this.__jB.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bV=arguments;this.__jB.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jB=this.__bV=this.__wX=this.__ot=null;}
});}
)();
