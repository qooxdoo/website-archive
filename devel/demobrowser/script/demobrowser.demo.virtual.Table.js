...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.2356764af1a8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__dO=qx.bom.Stylesheet.createElement(p);this.__BT={};this.__lH={};}
,members:{__dO:null,__BT:null,__lH:null,getStylesheet:function(){return this.__dO;}
,getCssClass:function(q){return this.__BT[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lH[r];if(!s){var s=this.__BU();qx.bom.Stylesheet.addRule(this.__dO,k+s,r);this.__lH[r]=s;}
;this.__BT[t]=s;return s;}
,__BU:function(){return e+this.toHashCode()+a+(this.__BV++ );}
,__BV:0},destruct:function(){this.__dO=this.__BT=this.__lH=null;}
});}
)();
