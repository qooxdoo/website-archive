...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.abeda0e57751.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__wM=new qx.ui.virtual.core.Pane(o,l,n,m);this.__wM.addListener(c,this._computeScrollbars,this);this.__wM.addListener(d,this._onScrollPaneX,this);this.__wM.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__wM,{edge:0});}
else {this._add(this.__wM,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__wM:null,getPane:function(){return this.__wM;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__wM;}
...
,_onScrollBarX:function(e){this.__wM.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__wM.setScrollY(e.getData());}
},destruct:function(){this.__wM.dispose();this.__wM=null;}
});}
)();
(function(){var a="scrollY",b="__wN",c="cellTap",d="qx.event.type.Data",f="change",g="qx.debug",h="qx.event.type.Event",j="cellContextmenu",k="dbltap",l="resize",m="cellDbltap",n="scrollX",o="__wO",p="appear",q="pointerdown",r="__wU",s="qx.ui.virtual.core.Pane",t="__wV",u="qx.ui.virtual.core.CellEvent",v="update",w="contextmenu",x="tap";qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__wN=new qx.ui.virtual.core.Axis(A,B);this.__wO=new qx.ui.virtual.core.Axis(z,y);this.__wP=0;this.__wQ=0;this.__wR=0;this.__wS=0;this.__wT={};this.__jB={};this.__wU=new qx.ui.container.Composite();this.__wU.setUserBounds(0,0,0,0);this._add(this.__wU);this.__wV=[];this.__wN.addListener(f,this.fullUpdate,this);this.__wO.addListener(f,this.fullUpdate,this);this.addListener(l,this._onResize,this);this.addListenerOnce(p,this._onAppear,this);this.addListener(q,this._onPointerDown,this);this.addListener(x,this._onTap,this);this.addListener(k,this._onDbltap,this);this.addListener(w,this._onContextmenu,this);}
,events:{cellTap:u,cellContextmenu:u,cellDbltap:u,update:h,scrollX:d,scrollY:d},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__wN:null,__wO:null,__wP:null,__wQ:null,__wR:null,__wS:null,__wT:null,__jB:null,__wU:null,__wV:null,__wW:null,__ou:null,__wX:null,__wY:null,getRowConfig:function(){return this.__wN;}
,getColumnConfig:function(){return this.__wO;}
,getChildren:function(){return [this.__wU];}
,addLayer:function(C){if(qx.core.Environment.get(g)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__wV.push(C);C.setUserBounds(0,0,0,0);this.__wU.add(C);}
,getLayers:function(){return this.__wV;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__wV.length;i++ ){var E=this.__wV[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__wO.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__wN.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__wP!==J){var I=this.__wP;this.__wP=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__wP;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__wQ){var L=this.__wQ;this.__wQ=M;this._deferredUpdateScrollPosition();this.fireDataEvent(n,M,L);}
;}
,getScrollX:function(){return this.__wQ;}
,getScrollSize:function(){return {width:this.__wO.getTotalSize(),height:this.__wN.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__wN.getItemPosition(P);var O=R+this.__wN.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__wO.getItemPosition(S);var T=U+this.__wO.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__wN.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__wO.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__wQ+bl.width;var bo=this.__wS-bn;if(this.__wQ-this.__wT.left<Math.min(this.__wQ,bj)||this.__wT.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__wQ,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__wQ-bp,this.__wP,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__wP+bw.height;var bt=this.__wR-bs;if(this.__wP-this.__wT.top<Math.min(this.__wP,bz)||this.__wT.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__wP,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__wQ,this.__wP-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__wW=true;this._updateScrollPosition();this.__wW=null;this.fireEvent(v);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__wY=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__xa(e,c);}
,_onContextmenu:function(e){this.__xa(e,j);}
,_onDbltap:function(e){this.__xa(e,m);}
,_checkScrollBounds:function(){var bA=this.getScrollMaxX();var bB=this.getScrollMaxY();if(this.__wQ<0){this.__wQ=0;}
else if(this.__wQ>bA){this.__wQ=bA;}
;if(this.__wP<0){this.__wP=0;}
else if(this.__wP>bB){this.__wP=bB;}
;}
,__xa:function(e,bE){var bD=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bD){return;}
;var bC=this.__wY;if(bC==null||bC.row!==bD.row||bC.column!==bD.column){return;}
;this.fireNonBubblingEvent(bE,qx.ui.virtual.core.CellEvent,[this,e,bD.row,bD.column]);}
,syncWidget:function(bF){if(this.__jB._fullUpdate){this._checkScrollBounds();this._fullUpdate();}
else if(this.__jB._updateScrollPosition){this._checkScrollBounds();this._updateScrollPosition();}
;this.__jB={};}
,_setLayerWindow:function(bG,bV,top,bR,bN,bX){var bM=this.__wN.getItemAtPosition(top);if(bM){var bP=bM.index;var bT=this.__wN.getItemSizes(bP,bN+bM.offset);var bO=qx.lang.Array.sum(bT);var bW=top-bM.offset;var bS=top-bM.offset+bO;}
else {var bP=0;var bT=[];var bO=0;var bW=0;var bS=0;}
;var bH=this.__wO.getItemAtPosition(bV);if(bH){var bL=bH.index;var bJ=this.__wO.getItemSizes(bL,bR+bH.offset);var bQ=qx.lang.Array.sum(bJ);var bU=bV-bH.offset;var bK=bV-bH.offset+bQ;}
else {var bL=0;var bJ=[];var bQ=0;var bU=0;var bK=0;}
;this.__wT={top:bW,bottom:bS,left:bU,right:bK};this.__wU.setUserBounds((this.getPaddingLeft()||0)+(this.__wT.left-this.__wQ),(this.getPaddingTop()||0)+(this.__wT.top-this.__wP),bQ,bO);this.__ou=bJ;this.__wX=bT;for(var i=0;i<this.__wV.length;i++ ){var bI=this.__wV[i];bI.setUserBounds(0,0,bQ,bO);if(bX){bI.fullUpdate(bP,bL,bT,bJ);}
else {bI.updateLayerWindow(bP,bL,bT,bJ);}
;}
;}
,__xb:function(){if(this.__wW){return;}
;var bY=this.getScrollSize();if(this.__wR!==bY.height||this.__wS!==bY.width){this.__wR=bY.height;this.__wS=bY.width;this.fireEvent(v);}
;}
,fullUpdate:function(){this.__jB._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__jB._fullUpdate;}
,_fullUpdate:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__xb();return;}
;var cb=this.getBounds();if(!cb){return;}
;this._setLayerWindow(ca,this.__wQ,this.__wP,cb.width,cb.height,true);this.__xb();}
,_deferredUpdateScrollPosition:function(){this.__jB._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var cc=this.getVisibleLayers();if(cc.length==0){this.__xb();return;}
;var ce=this.getBounds();if(!ce){return;}
;var cd={top:this.__wP,bottom:this.__wP+ce.height,left:this.__wQ,right:this.__wQ+ce.width};if(this.__wT.top<=cd.top&&this.__wT.bottom>=cd.bottom&&this.__wT.left<=cd.left&&this.__wT.right>=cd.right){this.__wU.setUserBounds((this.getPaddingLeft()||0)+(this.__wT.left-cd.left),(this.getPaddingTop()||0)+(this.__wT.top-cd.top),this.__wT.right-this.__wT.left,this.__wT.bottom-this.__wT.top);}
else {this._setLayerWindow(cc,this.__wQ,this.__wP,ce.width,ce.height,false);}
;this.__xb();}
},destruct:function(){this._disposeArray(t);this._disposeObjects(b,o,r);this.__wT=this.__jB=this.__ou=this.__wX=null;}
});}
)();
...
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__xc=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__xc=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__xc=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__xc=null;this.fireNonBubblingEvent(c);}
...
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__xc=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__xc=u;return u;}
,__xe:function(F){var B=this.__xc||this.__xd();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__xe(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__xf:function(M){var O=this.__xc||this.__xd();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__xf(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__xc||this.__xd();return U[U.length-1].rangeEnd+1;}
...
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__jB={};}
,properties:{anonymous:{refine:true,init:true}},members:{__jB:null,__F:null,__xy:null,__xz:null,__wX:null,__ou:null,getFirstRow:function(){return this.__xy;}
,getFirstColumn:function(){return this.__xz;}
,getRowSizes:function(){return this.__wX||[];}
,getColumnSizes:function(){return this.__ou||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jB.fullUpdate||this.__jB.updateLayerWindow&&this.__jB.updateLayerData){this._fullUpdate.apply(this,this.__F);}
else if(this.__jB.updateLayerWindow){this._updateLayerWindow.apply(this,this.__F);}
else if(this.__jB.updateLayerData&&this.__wX){this._updateLayerData();}
;if(this.__jB.fullUpdate||this.__jB.updateLayerWindow){var d=this.__F;this.__xy=d[0];this.__xz=d[1];this.__wX=d[2];this.__ou=d[3];}
;this.__jB={};}
,_updateLayerData:function(){this._fullUpdate(this.__xy,this.__xz,this.__wX,this.__ou);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__jB.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__F=arguments;this.__jB.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__F=arguments;this.__jB.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jB=this.__F=this.__wX=this.__ou=null;}
});}
)();
...
;this.__xA={};this.__xB={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__xC:null,__xD:null,__xA:null,__xB:null,setColor:function(h,g){if(g){this.__xA[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__xA[h]);}
;}
,clearCustomColors:function(){this.__xA={};this.updateLayerData();}
,getColor:function(i){var j=this.__xA[i];if(j){return j;}
else {return i%2==0?this.__xC:this.__xD;}
;}
,_applyColorEven:function(l,k){if(l){this.__xC=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__xC=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__xD=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__xD=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__xB[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__xB[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__xB[q];}
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__xE(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__xE(K)){this.updateLayerData();}
;}
,__xE:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
;this.__Co=[];this.__Cp=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__Co:null,__Cp:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__Co[B]=A;if(this.__Cq(B)){this.updateLayerData();}
;}
...
;this.__Cp[C]=D;if(this.__Cq(C)){this.updateLayerData();}
;}
,__Cq:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__Cp[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__Co[K]||this.getDefaultLineColor();}
,__Cr:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__Cs:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__Cr(Y,ba,X);}
else {this.__Cs(Y,bb,W);}
...
;this.__dJ=qx.bom.Stylesheet.createElement(p);this.__BN={};this.__md={};}
,members:{__dJ:null,__BN:null,__md:null,getStylesheet:function(){return this.__dJ;}
,getCssClass:function(q){return this.__BN[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__md[r];if(!s){var s=this.__BO();qx.bom.Stylesheet.addRule(this.__dJ,k+s,r);this.__md[r]=s;}
;this.__BN[t]=s;return s;}
,__BO:function(){return e+this.toHashCode()+a+(this.__BP++ );}
,__BP:0},destruct:function(){this.__dJ=this.__BN=this.__md=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dJ=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__BQ={};this.__BR={};this.__BS={};this.__BT={};this.__jU={};this.__BU={};this.initAppearance();this.__BY();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__BV:null,__BW:null,__jU:null,__BU:null,__BR:null,__BQ:null,__BS:null,__BT:null,__BX:false,__dJ:null,__BY:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__BV=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__BV.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__BR={};}
;}
,_getValue:function(R){if(this.__BX){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__BX){U=this.__BR;}
else {U=this.__BQ;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__BX){var bi=this.__BT;}
else {bi=this.__BS;}
...
;}
,getCellProperties:function(bk,bj){this.__Ca(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dJ.getCssClass(this.__BW)||t;return v+bq;}
,__Ca:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__BW==bt){return;}
;this.__BW=bt;var bv=this.__jU[this.__BW];if(!bv){this.__Cb();this.__Cc(bs);this.__Cd(bs);this.__Ce();this.__jU[this.__BW]=1;}
;this.__Cf();}
,__Cb:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__Cc:function(bz){this.__BR={};this.__BX=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__BX=false;}
,__Cd:function(){var bD=qx.lang.Object.getValues(this.__BR).join(I);this.__dJ.computeClassForStyles(this.__BW,bD);}
,__Ce:function(){var bI=this.__BV;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__BU[this.__BW]=bG;}
,__Cf:function(){var bK=qx.util.PropertyUtil;var bJ=this.__BU[this.__BW]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__BQ).join(I);}
,getInsets:function(bQ,bR){var bT=this.__BS;var bS=this.__BT;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dJ=this.__BQ=this.__BR=this.__BS=this.__BT=this.__jU=this.__BU=this.__BV=null;}
});}
)();
