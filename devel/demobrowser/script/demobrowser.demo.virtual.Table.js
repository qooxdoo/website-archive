...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.b5f03c0e55b3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__dP=qx.bom.Stylesheet.createElement(p);this.__BV={};this.__lL={};}
,members:{__dP:null,__BV:null,__lL:null,getStylesheet:function(){return this.__dP;}
,getCssClass:function(q){return this.__BV[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lL[r];if(!s){var s=this.__BW();qx.bom.Stylesheet.addRule(this.__dP,k+s,r);this.__lL[r]=s;}
;this.__BV[t]=s;return s;}
,__BW:function(){return e+this.toHashCode()+a+(this.__BX++ );}
,__BX:0},destruct:function(){this.__dP=this.__BV=this.__lL=null;}
});}
)();
