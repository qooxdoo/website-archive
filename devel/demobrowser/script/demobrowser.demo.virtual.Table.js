...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.662efd1671a4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="__up",d="demobrowser.demo.virtual.Table",e="white",f="#EEE",g="vertical";qx.Class.define(d,{extend:qx.application.Standalone,members:{__up:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(e,f));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(g));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__up=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__up.getCellProperties(k+a+j);}
...
;this.__vF={};this.__vG={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__vH:null,__vI:null,__vF:null,__vG:null,setColor:function(h,g){if(g){this.__vF[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__vF[h]);}
;}
,clearCustomColors:function(){this.__vF={};this.updateLayerData();}
,getColor:function(i){var j=this.__vF[i];if(j){return j;}
else {return i%2==0?this.__vH:this.__vI;}
;}
,_applyColorEven:function(l,k){if(l){this.__vH=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__vH=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__vI=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__vI=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__vG[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__vG[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__vG[q];}
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__vJ(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__vJ(K)){this.updateLayerData();}
;}
,__vJ:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
;this.__Ax=[];this.__Ay=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__Ax:null,__Ay:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__Ax[B]=A;if(this.__Az(B)){this.updateLayerData();}
;}
...
;this.__Ay[C]=D;if(this.__Az(C)){this.updateLayerData();}
;}
,__Az:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__Ay[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__Ax[K]||this.getDefaultLineColor();}
,__AA:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__AB:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__AA(Y,ba,X);}
else {this.__AB(Y,bb,W);}
...
;}
},destruct:function(){this.__Ax=this.__Ay=null;}
});}
)();
...
;this.__dF=qx.bom.Stylesheet.createElement(p);this.__zW={};this.__lW={};}
,members:{__dF:null,__zW:null,__lW:null,getStylesheet:function(){return this.__dF;}
,getCssClass:function(q){return this.__zW[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lW[r];if(!s){var s=this.__zX();qx.bom.Stylesheet.addRule(this.__dF,k+s,r);this.__lW[r]=s;}
;this.__zW[t]=s;return s;}
,__zX:function(){return e+this.toHashCode()+a+(this.__zY++ );}
,__zY:0},destruct:function(){this.__dF=this.__zW=this.__lW=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dF=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__Aa={};this.__Ab={};this.__Ac={};this.__Ad={};this.__jO={};this.__Ae={};this.initAppearance();this.__Ai();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__Af:null,__Ag:null,__jO:null,__Ae:null,__Ab:null,__Aa:null,__Ac:null,__Ad:null,__Ah:false,__dF:null,__Ai:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__Af=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__Af.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__Ab={};}
;}
,_getValue:function(R){if(this.__Ah){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__Ah){U=this.__Ab;}
else {U=this.__Aa;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__Ah){var bi=this.__Ad;}
else {bi=this.__Ac;}
...
;}
,getCellProperties:function(bk,bj){this.__Aj(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dF.getCssClass(this.__Ag)||t;return v+bq;}
,__Aj:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__Ag==bt){return;}
;this.__Ag=bt;var bv=this.__jO[this.__Ag];if(!bv){this.__Ak();this.__Al(bs);this.__Am(bs);this.__An();this.__jO[this.__Ag]=1;}
;this.__Ao();}
,__Ak:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__Al:function(bz){this.__Ab={};this.__Ah=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__Ah=false;}
,__Am:function(){var bD=qx.lang.Object.getValues(this.__Ab).join(I);this.__dF.computeClassForStyles(this.__Ag,bD);}
,__An:function(){var bI=this.__Af;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__Ae[this.__Ag]=bG;}
,__Ao:function(){var bK=qx.util.PropertyUtil;var bJ=this.__Ae[this.__Ag]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__Aa).join(I);}
,getInsets:function(bQ,bR){var bT=this.__Ac;var bS=this.__Ad;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dF=this.__Aa=this.__Ab=this.__Ac=this.__Ad=this.__jO=this.__Ae=this.__Af=null;}
});}
)();
