...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.0a0c1bdb9811.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__wJ=new qx.ui.virtual.core.Pane(o,l,n,m);this.__wJ.addListener(c,this._computeScrollbars,this);this.__wJ.addListener(d,this._onScrollPaneX,this);this.__wJ.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__wJ,{edge:0});}
else {this._add(this.__wJ,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__wJ:null,getPane:function(){return this.__wJ;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__wJ;}
...
,_onScrollBarX:function(e){this.__wJ.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__wJ.setScrollY(e.getData());}
},destruct:function(){this.__wJ.dispose();this.__wJ=null;}
});}
)();
(function(){var a="scrollY",b="__wL",c="cellTap",d="__wR",f="qx.event.type.Data",g="change",h="qx.debug",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="scrollX",p="appear",q="__wS",r="pointerdown",s="qx.ui.virtual.core.Pane",t="qx.ui.virtual.core.CellEvent",u="update",v="contextmenu",w="tap",x="__wK";qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__wK=new qx.ui.virtual.core.Axis(A,B);this.__wL=new qx.ui.virtual.core.Axis(z,y);this.__wM=0;this.__wN=0;this.__wO=0;this.__wP=0;this.__wQ={};this.__jy={};this.__wR=new qx.ui.container.Composite();this.__wR.setUserBounds(0,0,0,0);this._add(this.__wR);this.__wS=[];this.__wK.addListener(g,this.fullUpdate,this);this.__wL.addListener(g,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(p,this._onAppear,this);this.addListener(r,this._onPointerDown,this);this.addListener(w,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(v,this._onContextmenu,this);}
,events:{cellTap:t,cellContextmenu:t,cellDbltap:t,update:j,scrollX:f,scrollY:f},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__wK:null,__wL:null,__wM:null,__wN:null,__wO:null,__wP:null,__wQ:null,__jy:null,__wR:null,__wS:null,__wT:null,__oq:null,__wU:null,__wV:null,getRowConfig:function(){return this.__wK;}
,getColumnConfig:function(){return this.__wL;}
,getChildren:function(){return [this.__wR];}
,addLayer:function(C){if(qx.core.Environment.get(h)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__wS.push(C);C.setUserBounds(0,0,0,0);this.__wR.add(C);}
,getLayers:function(){return this.__wS;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__wS.length;i++ ){var E=this.__wS[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__wL.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__wK.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__wM!==J){var I=this.__wM;this.__wM=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__wM;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__wN){var L=this.__wN;this.__wN=M;this._deferredUpdateScrollPosition();this.fireDataEvent(o,M,L);}
;}
,getScrollX:function(){return this.__wN;}
,getScrollSize:function(){return {width:this.__wL.getTotalSize(),height:this.__wK.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__wK.getItemPosition(P);var O=R+this.__wK.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__wL.getItemPosition(S);var T=U+this.__wL.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__wK.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__wL.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__wN+bl.width;var bo=this.__wP-bn;if(this.__wN-this.__wQ.left<Math.min(this.__wN,bj)||this.__wQ.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__wN,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__wN-bp,this.__wM,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__wM+bw.height;var bt=this.__wO-bs;if(this.__wM-this.__wQ.top<Math.min(this.__wM,bz)||this.__wQ.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__wM,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__wN,this.__wM-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__wT=true;this._updateScrollPosition();this.__wT=null;this.fireEvent(u);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__wV=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__wW(e,c);}
,_onContextmenu:function(e){this.__wW(e,k);}
,_onDbltap:function(e){this.__wW(e,n);}
,_checkScrollBounds:function(){var bA=this.getScrollMaxX();var bB=this.getScrollMaxY();if(this.__wN<0){this.__wN=0;}
else if(this.__wN>bA){this.__wN=bA;}
;if(this.__wM<0){this.__wM=0;}
else if(this.__wM>bB){this.__wM=bB;}
;}
,__wW:function(e,bE){var bD=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bD){return;}
;var bC=this.__wV;if(bC==null||bC.row!==bD.row||bC.column!==bD.column){return;}
;this.fireNonBubblingEvent(bE,qx.ui.virtual.core.CellEvent,[this,e,bD.row,bD.column]);}
,syncWidget:function(bF){if(this.__jy._fullUpdate){this._checkScrollBounds();this._fullUpdate();}
else if(this.__jy._updateScrollPosition){this._checkScrollBounds();this._updateScrollPosition();}
;this.__jy={};}
,_setLayerWindow:function(bG,bV,top,bR,bN,bX){var bM=this.__wK.getItemAtPosition(top);if(bM){var bP=bM.index;var bT=this.__wK.getItemSizes(bP,bN+bM.offset);var bO=qx.lang.Array.sum(bT);var bW=top-bM.offset;var bS=top-bM.offset+bO;}
else {var bP=0;var bT=[];var bO=0;var bW=0;var bS=0;}
;var bH=this.__wL.getItemAtPosition(bV);if(bH){var bL=bH.index;var bJ=this.__wL.getItemSizes(bL,bR+bH.offset);var bQ=qx.lang.Array.sum(bJ);var bU=bV-bH.offset;var bK=bV-bH.offset+bQ;}
else {var bL=0;var bJ=[];var bQ=0;var bU=0;var bK=0;}
;this.__wQ={top:bW,bottom:bS,left:bU,right:bK};this.__wR.setUserBounds((this.getPaddingLeft()||0)+(this.__wQ.left-this.__wN),(this.getPaddingTop()||0)+(this.__wQ.top-this.__wM),bQ,bO);this.__oq=bJ;this.__wU=bT;for(var i=0;i<this.__wS.length;i++ ){var bI=this.__wS[i];bI.setUserBounds(0,0,bQ,bO);if(bX){bI.fullUpdate(bP,bL,bT,bJ);}
else {bI.updateLayerWindow(bP,bL,bT,bJ);}
;}
;}
,__wX:function(){if(this.__wT){return;}
;var bY=this.getScrollSize();if(this.__wO!==bY.height||this.__wP!==bY.width){this.__wO=bY.height;this.__wP=bY.width;this.fireEvent(u);}
;}
,fullUpdate:function(){this.__jy._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__jy._fullUpdate;}
,_fullUpdate:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__wX();return;}
;var cb=this.getBounds();if(!cb){return;}
;this._setLayerWindow(ca,this.__wN,this.__wM,cb.width,cb.height,true);this.__wX();}
,_deferredUpdateScrollPosition:function(){this.__jy._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var cc=this.getVisibleLayers();if(cc.length==0){this.__wX();return;}
;var ce=this.getBounds();if(!ce){return;}
;var cd={top:this.__wM,bottom:this.__wM+ce.height,left:this.__wN,right:this.__wN+ce.width};if(this.__wQ.top<=cd.top&&this.__wQ.bottom>=cd.bottom&&this.__wQ.left<=cd.left&&this.__wQ.right>=cd.right){this.__wR.setUserBounds((this.getPaddingLeft()||0)+(this.__wQ.left-cd.left),(this.getPaddingTop()||0)+(this.__wQ.top-cd.top),this.__wQ.right-this.__wQ.left,this.__wQ.bottom-this.__wQ.top);}
else {this._setLayerWindow(cc,this.__wN,this.__wM,ce.width,ce.height,false);}
;this.__wX();}
},destruct:function(){this._disposeArray(q);this._disposeObjects(x,b,d);this.__wQ=this.__jy=this.__oq=this.__wU=null;}
});}
)();
...
,events:{"change":e},members:{__wY:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__wY=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__wY=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__wY=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__wY=null;this.fireNonBubblingEvent(c);}
,__xa:function(){if(this.__wY){return this.__wY;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__wY=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__wY=u;return u;}
,__xb:function(F){var B=this.__wY||this.__xa();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__xb(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__xc:function(M){var O=this.__wY||this.__xa();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__xc(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__wY||this.__xa();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__wY=null;}
});}
)();
...
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__jy={};}
,properties:{anonymous:{refine:true,init:true}},members:{__jy:null,__bS:null,__xv:null,__xw:null,__wU:null,__oq:null,getFirstRow:function(){return this.__xv;}
,getFirstColumn:function(){return this.__xw;}
,getRowSizes:function(){return this.__wU||[];}
,getColumnSizes:function(){return this.__oq||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jy.fullUpdate||this.__jy.updateLayerWindow&&this.__jy.updateLayerData){this._fullUpdate.apply(this,this.__bS);}
else if(this.__jy.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bS);}
else if(this.__jy.updateLayerData&&this.__wU){this._updateLayerData();}
;if(this.__jy.fullUpdate||this.__jy.updateLayerWindow){var d=this.__bS;this.__xv=d[0];this.__xw=d[1];this.__wU=d[2];this.__oq=d[3];}
;this.__jy={};}
,_updateLayerData:function(){this._fullUpdate(this.__xv,this.__xw,this.__wU,this.__oq);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__jy.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bS=arguments;this.__jy.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bS=arguments;this.__jy.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jy=this.__bS=this.__wU=this.__oq=null;}
});}
)();
...
;this.__xx={};this.__xy={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__xz:null,__xA:null,__xx:null,__xy:null,setColor:function(h,g){if(g){this.__xx[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__xx[h]);}
;}
,clearCustomColors:function(){this.__xx={};this.updateLayerData();}
,getColor:function(i){var j=this.__xx[i];if(j){return j;}
else {return i%2==0?this.__xz:this.__xA;}
;}
,_applyColorEven:function(l,k){if(l){this.__xz=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__xz=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__xA=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__xA=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__xy[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__xy[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__xy[q];}
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__xB(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__xB(K)){this.updateLayerData();}
;}
,__xB:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
;this.__Cn=[];this.__Co=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__Cn:null,__Co:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__Cn[B]=A;if(this.__Cp(B)){this.updateLayerData();}
;}
...
;this.__Co[C]=D;if(this.__Cp(C)){this.updateLayerData();}
;}
,__Cp:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__Co[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__Cn[K]||this.getDefaultLineColor();}
,__Cq:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__Cr:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__Cq(Y,ba,X);}
else {this.__Cr(Y,bb,W);}
...
;this.__dG=qx.bom.Stylesheet.createElement(p);this.__BM={};this.__lY={};}
,members:{__dG:null,__BM:null,__lY:null,getStylesheet:function(){return this.__dG;}
,getCssClass:function(q){return this.__BM[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lY[r];if(!s){var s=this.__BN();qx.bom.Stylesheet.addRule(this.__dG,k+s,r);this.__lY[r]=s;}
;this.__BM[t]=s;return s;}
,__BN:function(){return e+this.toHashCode()+a+(this.__BO++ );}
,__BO:0},destruct:function(){this.__dG=this.__BM=this.__lY=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dG=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__BP={};this.__BQ={};this.__BR={};this.__BS={};this.__jQ={};this.__BT={};this.initAppearance();this.__BX();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__BU:null,__BV:null,__jQ:null,__BT:null,__BQ:null,__BP:null,__BR:null,__BS:null,__BW:false,__dG:null,__BX:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__BU=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__BU.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__BQ={};}
;}
,_getValue:function(R){if(this.__BW){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__BW){U=this.__BQ;}
else {U=this.__BP;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__BW){var bi=this.__BS;}
else {bi=this.__BR;}
...
;}
,getCellProperties:function(bk,bj){this.__BY(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dG.getCssClass(this.__BV)||t;return v+bq;}
,__BY:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__BV==bt){return;}
;this.__BV=bt;var bv=this.__jQ[this.__BV];if(!bv){this.__Ca();this.__Cb(bs);this.__Cc(bs);this.__Cd();this.__jQ[this.__BV]=1;}
;this.__Ce();}
,__Ca:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__Cb:function(bz){this.__BQ={};this.__BW=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__BW=false;}
,__Cc:function(){var bD=qx.lang.Object.getValues(this.__BQ).join(I);this.__dG.computeClassForStyles(this.__BV,bD);}
,__Cd:function(){var bI=this.__BU;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__BT[this.__BV]=bG;}
,__Ce:function(){var bK=qx.util.PropertyUtil;var bJ=this.__BT[this.__BV]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__BP).join(I);}
,getInsets:function(bQ,bR){var bT=this.__BR;var bS=this.__BS;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dG=this.__BP=this.__BQ=this.__BR=this.__BS=this.__jQ=this.__BT=this.__BU=null;}
});}
)();
