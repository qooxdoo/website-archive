...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.c47084342dcb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,syncWidget:function(bF){if(this.__jH._fullUpdate){this._checkScrollBounds();this._fullUpdate();}
else if(this.__jH._updateScrollPosition){this._checkScrollBounds();this._updateScrollPosition();}
;this.__jH={};}
...
;}
,fullUpdate:function(){this.__jH._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__jH._fullUpdate;}
...
,_deferredUpdateScrollPosition:function(){this.__jH._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
...
;this.__xb();}
},destruct:function(){this._disposeArray(t);this._disposeObjects(b,o,r);this.__wT=this.__jH=this.__oz=this.__wX=null;}
});}
)();
...
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__jH={};}
,properties:{anonymous:{refine:true,init:true}},members:{__jH:null,__bT:null,__xy:null,__xz:null,__wX:null,__oz:null,getFirstRow:function(){return this.__xy;}
,getFirstColumn:function(){return this.__xz;}
,getRowSizes:function(){return this.__wX||[];}
,getColumnSizes:function(){return this.__oz||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jH.fullUpdate||this.__jH.updateLayerWindow&&this.__jH.updateLayerData){this._fullUpdate.apply(this,this.__bT);}
else if(this.__jH.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bT);}
else if(this.__jH.updateLayerData&&this.__wX){this._updateLayerData();}
;if(this.__jH.fullUpdate||this.__jH.updateLayerWindow){var d=this.__bT;this.__xy=d[0];this.__xz=d[1];this.__wX=d[2];this.__oz=d[3];}
;this.__jH={};}
,_updateLayerData:function(){this._fullUpdate(this.__xy,this.__xz,this.__wX,this.__oz);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__jH.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bT=arguments;this.__jH.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bT=arguments;this.__jH.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jH=this.__bT=this.__wX=this.__oz=null;}
});}
)();
...
;this.__dN=qx.bom.Stylesheet.createElement(p);this.__BN={};this.__mi={};}
,members:{__dN:null,__BN:null,__mi:null,getStylesheet:function(){return this.__dN;}
,getCssClass:function(q){return this.__BN[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__mi[r];if(!s){var s=this.__BO();qx.bom.Stylesheet.addRule(this.__dN,k+s,r);this.__mi[r]=s;}
;this.__BN[t]=s;return s;}
,__BO:function(){return e+this.toHashCode()+a+(this.__BP++ );}
,__BP:0},destruct:function(){this.__dN=this.__BN=this.__mi=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dN=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__BQ={};this.__BR={};this.__BS={};this.__BT={};this.__kb={};this.__BU={};this.initAppearance();this.__BY();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__BV:null,__BW:null,__kb:null,__BU:null,__BR:null,__BQ:null,__BS:null,__BT:null,__BX:false,__dN:null,__BY:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__BV=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__BV.push(N);}
;}
;O=O.superclass;}
;}
...
;this.__BW=bt;var bv=this.__kb[this.__BW];if(!bv){this.__Cb();this.__Cc(bs);this.__Cd(bs);this.__Ce();this.__kb[this.__BW]=1;}
;this.__Cf();}
...
},destruct:function(){this.__dN=this.__BQ=this.__BR=this.__BS=this.__BT=this.__kb=this.__BU=this.__BV=null;}
});}
)();
