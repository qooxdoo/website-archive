...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.f8a070faefd6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__xb();}
},destruct:function(){this._disposeArray(t);this._disposeObjects(b,o,r);this.__wT=this.__jB=this.__ot=this.__wX=null;}
});}
)();
...
,properties:{anonymous:{refine:true,init:true}},members:{__jB:null,__F:null,__xy:null,__xz:null,__wX:null,__ot:null,getFirstRow:function(){return this.__xy;}
...
;if(this.__jB.fullUpdate||this.__jB.updateLayerWindow){var d=this.__F;this.__xy=d[0];this.__xz=d[1];this.__wX=d[2];this.__ot=d[3];}
;this.__jB={};}
,_updateLayerData:function(){this._fullUpdate(this.__xy,this.__xz,this.__wX,this.__ot);}
...
},destruct:function(){this.__jB=this.__F=this.__wX=this.__ot=null;}
});}
)();
...
;this.__BY=bt;var bv=this.__jT[this.__BY];if(!bv){this.__Cd();this.__Ce(bs);this.__Cf(bs);this.__Cg();this.__jT[this.__BY]=1;}
;this.__Ch();}
...
},destruct:function(){this.__dJ=this.__BS=this.__BT=this.__BU=this.__BV=this.__jT=this.__BW=this.__BX=null;}
});}
)();
