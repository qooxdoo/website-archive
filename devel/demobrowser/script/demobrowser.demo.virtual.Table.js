...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Table","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.472942c29039.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="demobrowser.demo.virtual.Table",d="white",e="__bk",f="#EEE",g="vertical";qx.Class.define(c,{extend:qx.application.Standalone,members:{__bk:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(d,f));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(g));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__bk=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__bk.getCellProperties(k+a+j);}
},destruct:function(){this._disposeObjects(e);}
});}
)();
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__wI=new qx.ui.virtual.core.Pane(o,l,n,m);this.__wI.addListener(c,this._computeScrollbars,this);this.__wI.addListener(d,this._onScrollPaneX,this);this.__wI.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__wI,{edge:0});}
else {this._add(this.__wI,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__wI:null,getPane:function(){return this.__wI;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__wI;}
...
,_onScrollBarX:function(e){this.__wI.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__wI.setScrollY(e.getData());}
},destruct:function(){this.__wI.dispose();this.__wI=null;}
});}
)();
(function(){var a="scrollY",b="__wJ",c="cellTap",d="__wR",f="qx.event.type.Data",g="change",h="qx.debug",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="scrollX",p="appear",q="pointerdown",r="qx.ui.virtual.core.Pane",s="qx.ui.virtual.core.CellEvent",t="update",u="contextmenu",v="tap",w="__wQ",x="__wK";qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__wJ=new qx.ui.virtual.core.Axis(A,B);this.__wK=new qx.ui.virtual.core.Axis(z,y);this.__wL=0;this.__wM=0;this.__wN=0;this.__wO=0;this.__wP={};this.__jx={};this.__wQ=new qx.ui.container.Composite();this.__wQ.setUserBounds(0,0,0,0);this._add(this.__wQ);this.__wR=[];this.__wJ.addListener(g,this.fullUpdate,this);this.__wK.addListener(g,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(p,this._onAppear,this);this.addListener(q,this._onPointerDown,this);this.addListener(v,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(u,this._onContextmenu,this);}
,events:{cellTap:s,cellContextmenu:s,cellDbltap:s,update:j,scrollX:f,scrollY:f},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__wJ:null,__wK:null,__wL:null,__wM:null,__wN:null,__wO:null,__wP:null,__jx:null,__wQ:null,__wR:null,__wS:null,__op:null,__wT:null,__wU:null,getRowConfig:function(){return this.__wJ;}
,getColumnConfig:function(){return this.__wK;}
,getChildren:function(){return [this.__wQ];}
,addLayer:function(C){if(qx.core.Environment.get(h)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__wR.push(C);C.setUserBounds(0,0,0,0);this.__wQ.add(C);}
,getLayers:function(){return this.__wR;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__wR.length;i++ ){var E=this.__wR[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__wK.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__wJ.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__wL!==J){var I=this.__wL;this.__wL=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__wL;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__wM){var L=this.__wM;this.__wM=M;this._deferredUpdateScrollPosition();this.fireDataEvent(o,M,L);}
;}
,getScrollX:function(){return this.__wM;}
,getScrollSize:function(){return {width:this.__wK.getTotalSize(),height:this.__wJ.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__wJ.getItemPosition(P);var O=R+this.__wJ.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__wK.getItemPosition(S);var T=U+this.__wK.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__wJ.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__wK.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__wM+bl.width;var bo=this.__wO-bn;if(this.__wM-this.__wP.left<Math.min(this.__wM,bj)||this.__wP.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__wM,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__wM-bp,this.__wL,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__wL+bw.height;var bt=this.__wN-bs;if(this.__wL-this.__wP.top<Math.min(this.__wL,bz)||this.__wP.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__wL,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__wM,this.__wL-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__wS=true;this._updateScrollPosition();this.__wS=null;this.fireEvent(t);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__wU=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__wV(e,c);}
,_onContextmenu:function(e){this.__wV(e,k);}
,_onDbltap:function(e){this.__wV(e,n);}
,_checkScrollBounds:function(){var bA=this.getScrollMaxX();var bB=this.getScrollMaxY();if(this.__wM<0){this.__wM=0;}
else if(this.__wM>bA){this.__wM=bA;}
;if(this.__wL<0){this.__wL=0;}
else if(this.__wL>bB){this.__wL=bB;}
;}
,__wV:function(e,bE){var bD=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bD){return;}
;var bC=this.__wU;if(bC==null||bC.row!==bD.row||bC.column!==bD.column){return;}
;this.fireNonBubblingEvent(bE,qx.ui.virtual.core.CellEvent,[this,e,bD.row,bD.column]);}
,syncWidget:function(bF){if(this.__jx._fullUpdate){this._checkScrollBounds();this._fullUpdate();}
else if(this.__jx._updateScrollPosition){this._checkScrollBounds();this._updateScrollPosition();}
;this.__jx={};}
,_setLayerWindow:function(bG,bV,top,bR,bN,bX){var bM=this.__wJ.getItemAtPosition(top);if(bM){var bP=bM.index;var bT=this.__wJ.getItemSizes(bP,bN+bM.offset);var bO=qx.lang.Array.sum(bT);var bW=top-bM.offset;var bS=top-bM.offset+bO;}
else {var bP=0;var bT=[];var bO=0;var bW=0;var bS=0;}
;var bH=this.__wK.getItemAtPosition(bV);if(bH){var bL=bH.index;var bJ=this.__wK.getItemSizes(bL,bR+bH.offset);var bQ=qx.lang.Array.sum(bJ);var bU=bV-bH.offset;var bK=bV-bH.offset+bQ;}
else {var bL=0;var bJ=[];var bQ=0;var bU=0;var bK=0;}
;this.__wP={top:bW,bottom:bS,left:bU,right:bK};this.__wQ.setUserBounds((this.getPaddingLeft()||0)+(this.__wP.left-this.__wM),(this.getPaddingTop()||0)+(this.__wP.top-this.__wL),bQ,bO);this.__op=bJ;this.__wT=bT;for(var i=0;i<this.__wR.length;i++ ){var bI=this.__wR[i];bI.setUserBounds(0,0,bQ,bO);if(bX){bI.fullUpdate(bP,bL,bT,bJ);}
else {bI.updateLayerWindow(bP,bL,bT,bJ);}
;}
;}
,__wW:function(){if(this.__wS){return;}
;var bY=this.getScrollSize();if(this.__wN!==bY.height||this.__wO!==bY.width){this.__wN=bY.height;this.__wO=bY.width;this.fireEvent(t);}
;}
,fullUpdate:function(){this.__jx._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__jx._fullUpdate;}
,_fullUpdate:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__wW();return;}
;var cb=this.getBounds();if(!cb){return;}
;this._setLayerWindow(ca,this.__wM,this.__wL,cb.width,cb.height,true);this.__wW();}
,_deferredUpdateScrollPosition:function(){this.__jx._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var cc=this.getVisibleLayers();if(cc.length==0){this.__wW();return;}
;var ce=this.getBounds();if(!ce){return;}
;var cd={top:this.__wL,bottom:this.__wL+ce.height,left:this.__wM,right:this.__wM+ce.width};if(this.__wP.top<=cd.top&&this.__wP.bottom>=cd.bottom&&this.__wP.left<=cd.left&&this.__wP.right>=cd.right){this.__wQ.setUserBounds((this.getPaddingLeft()||0)+(this.__wP.left-cd.left),(this.getPaddingTop()||0)+(this.__wP.top-cd.top),this.__wP.right-this.__wP.left,this.__wP.bottom-this.__wP.top);}
else {this._setLayerWindow(cc,this.__wM,this.__wL,ce.width,ce.height,false);}
;this.__wW();}
},destruct:function(){this._disposeArray(d);this._disposeObjects(b,x,w);this.__wP=this.__jx=this.__op=this.__wT=null;}
});}
)();
...
,events:{"change":e},members:{__wX:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__wX=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__wX=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__wX=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__wX=null;this.fireNonBubblingEvent(c);}
,__wY:function(){if(this.__wX){return this.__wX;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__wX=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__wX=u;return u;}
,__xa:function(F){var B=this.__wX||this.__wY();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__xa(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__xb:function(M){var O=this.__wX||this.__wY();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__xb(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__wX||this.__wY();return U[U.length-1].rangeEnd+1;}
,getItemSizes:function(bb,V){var ba=this.customSizes;var Y=this.defaultItemSize;var X=0;var W=[];var i=0;while(X<V){var bc=ba[bb]!=null?ba[bb]:Y;bb++ ;X+=bc;W[i++ ]=bc;if(bb>=this.itemCount){break;}
;}
;return W;}
},destruct:function(){this.customSizes=this.__wX=null;}
});}
)();
...
(function(){var a="qx.ui.virtual.core.CellEvent",b="Integer";qx.Class.define(a,{extend:qx.event.type.Pointer,properties:{row:{check:b,nullable:true},column:{check:b,nullable:true}},members:{init:function(e,c,f,d){c.clone(this);this.setBubbles(false);this.setRow(f);this.setColumn(d);}
}});}
)();
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__jx={};}
,properties:{anonymous:{refine:true,init:true}},members:{__jx:null,__bS:null,__xu:null,__xv:null,__wT:null,__op:null,getFirstRow:function(){return this.__xu;}
,getFirstColumn:function(){return this.__xv;}
,getRowSizes:function(){return this.__wT||[];}
,getColumnSizes:function(){return this.__op||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__jx.fullUpdate||this.__jx.updateLayerWindow&&this.__jx.updateLayerData){this._fullUpdate.apply(this,this.__bS);}
else if(this.__jx.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bS);}
else if(this.__jx.updateLayerData&&this.__wT){this._updateLayerData();}
;if(this.__jx.fullUpdate||this.__jx.updateLayerWindow){var d=this.__bS;this.__xu=d[0];this.__xv=d[1];this.__wT=d[2];this.__op=d[3];}
;this.__jx={};}
,_updateLayerData:function(){this._fullUpdate(this.__xu,this.__xv,this.__wT,this.__op);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__jx.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bS=arguments;this.__jx.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bS=arguments;this.__jx.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__jx=this.__bS=this.__wT=this.__op=null;}
});}
)();
...
;this.__xw={};this.__xx={};}
,properties:{colorEven:{nullable:true,check:c,apply:b,themeable:true},colorOdd:{nullable:true,check:c,apply:a,themeable:true}},members:{__xy:null,__xz:null,__xw:null,__xx:null,setColor:function(h,g){if(g){this.__xw[h]=qx.theme.manager.Color.getInstance().resolve(g);}
else {delete (this.__xw[h]);}
;}
,clearCustomColors:function(){this.__xw={};this.updateLayerData();}
,getColor:function(i){var j=this.__xw[i];if(j){return j;}
else {return i%2==0?this.__xy:this.__xz;}
;}
,_applyColorEven:function(l,k){if(l){this.__xy=qx.theme.manager.Color.getInstance().resolve(l);}
else {this.__xy=null;}
;this.updateLayerData();}
,_applyColorOdd:function(n,m){if(n){this.__xz=qx.theme.manager.Color.getInstance().resolve(n);}
else {this.__xz=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__xx[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__xx[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__xx[q];}
},destruct:function(){this.__xw=this.__xx=null;}
});}
)();
...
;}
,setColor:function(J,I){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,I);if(this.__xA(J)){this.updateLayerData();}
;}
,setBackground:function(K,L){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,K,L);if(this.__xA(K)){this.updateLayerData();}
;}
,__xA:function(M){var O=this.getFirstRow();var N=O+this.getRowSizes().length-1;return M>=O&&M<=N;}
}});}
)();
...
;this.__Cm=[];this.__Cn=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__Cm:null,__Cn:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__Cm[B]=A;if(this.__Co(B)){this.updateLayerData();}
;}
...
;this.__Cn[C]=D;if(this.__Co(C)){this.updateLayerData();}
;}
,__Co:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__Cn[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__Cm[K]||this.getDefaultLineColor();}
,__Cp:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__Cq:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__Cp(Y,ba,X);}
else {this.__Cq(Y,bb,W);}
...
(function(){var a="width:",b="top:",c="",d="css.boxmodel",e=">",f="qx.debug",g="content",h="</div>",i="qx.ui.virtual.layer.HtmlCell",j="' ",k="style='",l="height:",m="<div ",n="px;",o="class='",p="left:",q="html";qx.Class.define(i,{extend:qx.ui.virtual.layer.Abstract,construct:function(r){qx.ui.virtual.layer.Abstract.call(this);this.setZIndex(12);if(qx.core.Environment.get(f)){this.assertInterface(r,qx.ui.virtual.core.IHtmlCellProvider);}
;this._cellProvider=r;}
,members:{_getCellSizeStyle:function(s,w,u,v){var t=c;if(qx.core.Environment.get(d)==g){s-=u;w-=v;}
;t+=a+s+n;t+=l+w+n;return t;}
,_fullUpdate:function(D,A,I,C){var H=[];var J=0;var top=0;var K=D;var B=A;for(var y=0;y<I.length;y++ ){var J=0;var B=A;var E=I[y];for(var x=0;x<C.length;x++ ){var G=C[x];var z=this._cellProvider.getCellProperties(K,B);var F=z.insets||[0,0];H.push(m,k,p,J,n,b,top,n,this._getCellSizeStyle(G,E,F[0],F[1]),z.style||c,j,o,z.classes||c,j,z.attributes||c,e,z.content||c,h);B++ ;J+=G;}
;top+=E;K++ ;}
;this.getContentElement().setAttribute(q,H.join(c));}
},destruct:function(){this._cellProvider=null;}
});}
)();
(function(){var a="qx.ui.virtual.core.IHtmlCellProvider";qx.Interface.define(a,{members:{getCellProperties:function(c,b){}
}});}
)();
(function(){var a="qx.ui.virtual.cell.ICell";qx.Interface.define(a,{members:{getCellProperties:function(c,b){}
}});}
)();
(function(){var a="qx.ui.virtual.cell.Abstract",b="abstract",c="qx-cell",d="";qx.Class.define(a,{type:b,extend:qx.core.Object,implement:qx.ui.virtual.cell.ICell,construct:function(){qx.core.Object.call(this);qx.ui.virtual.cell.CellStylesheet.getInstance();}
,members:{getCssClasses:function(f,e){return c;}
,getAttributes:function(h,g){return d;}
,getStyles:function(j,i){return d;}
,getInsets:function(l,k){return [0,0];}
,getContent:function(n,m){return n;}
,getCellProperties:function(p,o){return {classes:this.getCssClasses(p,o),style:this.getStyles(p,o),attributes:this.getAttributes(p,o),content:this.getContent(p,o),insets:this.getInsets(p,o)};}
}});}
)();
(function(){var a="-",b="}",c="qx.ui.virtual.cell.CellStylesheet",d="none",e="qx-cell-",f=".qx-cell {",g="default",h="ellipsis",i="hidden",j="} ",k=".",l="css.boxsizing",m="content-box",n="singleton",o="absolute";qx.Class.define(c,{extend:qx.core.Object,type:n,construct:function(){qx.core.Object.call(this);var p=f+qx.bom.element.Style.compile({position:o,overflow:i,cursor:g,textOverflow:h,userSelect:d})+j;if(qx.core.Environment.get(l)){p+=f+qx.bom.element.BoxSizing.compile(m)+b;}
;this.__dG=qx.bom.Stylesheet.createElement(p);this.__BL={};this.__lX={};}
,members:{__dG:null,__BL:null,__lX:null,getStylesheet:function(){return this.__dG;}
,getCssClass:function(q){return this.__BL[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__lX[r];if(!s){var s=this.__BM();qx.bom.Stylesheet.addRule(this.__dG,k+s,r);this.__lX[r]=s;}
;this.__BL[t]=s;return s;}
,__BM:function(){return e+this.toHashCode()+a+(this.__BN++ );}
,__BN:0},destruct:function(){this.__dG=this.__BL=this.__lX=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dG=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__BO={};this.__BP={};this.__BQ={};this.__BR={};this.__jP={};this.__BS={};this.initAppearance();this.__BW();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__BT:null,__BU:null,__jP:null,__BS:null,__BP:null,__BO:null,__BQ:null,__BR:null,__BV:false,__dG:null,__BW:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__BT=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__BT.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__BP={};}
;}
,_getValue:function(R){if(this.__BV){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__BV){U=this.__BP;}
else {U=this.__BO;}
;if(S===null){delete U[T];}
else {U[T]=S;}
;}
,_applyBackgroundColor:function(W,V,name){var W=this._getValue(name);if(!W){this._storeStyle(name,null);}
else {this._storeStyle(name,s+qx.theme.manager.Color.getInstance().resolve(W));}
;}
,_applyTextColor:function(Y,X,name){var Y=this._getValue(name);if(!Y){this._storeStyle(name,null);}
else {this._storeStyle(name,F+qx.theme.manager.Color.getInstance().resolve(Y));}
;}
,_applyTextAlign:function(bb,ba,name){var bb=this._getValue(name);if(!bb){this._storeStyle(name,null);}
else {this._storeStyle(name,y+bb);}
;}
,_applyFont:function(be,bd,name){var be=this._getValue(name);if(!be){this._storeStyle(name,null);}
else {var bc=qx.theme.manager.Font.getInstance().resolve(be);this._storeStyle(name,qx.bom.element.Style.compile(bc.getStyles()));}
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__BV){var bi=this.__BR;}
else {bi=this.__BQ;}
;if(bh===null){delete bi[name];}
else {bi[name]=bh;}
;if(bh===null){this._storeStyle(name,null);}
else {var bf=qx.bom.Style.getCssName(name);this._storeStyle(name,bf+n+bh+d);}
;}
,getCellProperties:function(bk,bj){this.__BX(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dG.getCssClass(this.__BU)||t;return v+bq;}
,__BX:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__BU==bt){return;}
;this.__BU=bt;var bv=this.__jP[this.__BU];if(!bv){this.__BY();this.__Ca(bs);this.__Cb(bs);this.__Cc();this.__jP[this.__BU]=1;}
;this.__Cd();}
,__BY:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__Ca:function(bz){this.__BP={};this.__BV=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__BV=false;}
,__Cb:function(){var bD=qx.lang.Object.getValues(this.__BP).join(I);this.__dG.computeClassForStyles(this.__BU,bD);}
,__Cc:function(){var bI=this.__BT;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__BS[this.__BU]=bG;}
,__Cd:function(){var bK=qx.util.PropertyUtil;var bJ=this.__BS[this.__BU]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__BO).join(I);}
,getInsets:function(bQ,bR){var bT=this.__BQ;var bS=this.__BR;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dG=this.__BO=this.__BP=this.__BQ=this.__BR=this.__jP=this.__BS=this.__BT=null;}
});}
)();
