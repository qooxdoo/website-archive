...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.9df99586a4bb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__xV.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__xU:null,__xV:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__xU);l.dispose();this.__xU=null;}
;if(m){this.__xU=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__tK:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__tL:null,__tM:null,getLocal:function(){if(this.__tL){return this.__tL;}
;return this.__tL=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__tM){return this.__tM;}
;return this.__tM=new qx.bom.storage.Web(b);}
},construct:function(g){this.__qd=g;}
,members:{__qd:null,getStorage:function(){return window[this.__qd+c];}
,getLength:function(){return this.getStorage(this.__qd).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__qd).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__qd).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__qd).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__qd);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__qd).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__tL:null,__tM:null,__cj:0,getLocal:function(){if(this.__tL){return this.__tL;}
;return this.__tL=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__tM){return this.__tM;}
;return this.__tM=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__tN=document.createElement(f);this.__tN.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__tN);this.__tN.addBehavior(j);this.__tO=m;this.__tN.load(this.__tO);this.__gb={};this.__tP={};var l=this.__tN.getAttribute(d+qx.bom.storage.UserData.__cj);while(l!=undefined){l=qx.lang.Json.parse(l);this.__gb[l.key]=l.value;this.__tP[l.key]=d+qx.bom.storage.UserData.__cj;qx.bom.storage.UserData.__cj++ ;l=this.__tN.getAttribute(d+qx.bom.storage.UserData.__cj);}
;}
,members:{__tN:null,__tO:h,__gb:null,__tP:null,getStorage:function(){return this.__gb;}
,getLength:function(){return Object.keys(this.__gb).length;}
,setItem:function(n,p){if(this.__tP[n]){var o=this.__tP[n];}
else {var o=d+qx.bom.storage.UserData.__cj;qx.bom.storage.UserData.__cj++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__tN.setAttribute(o,q);this.__tN.save(this.__tO);this.__gb[n]=p;this.__tP[n]=o;}
,getItem:function(r){return this.__gb[r]||null;}
,removeItem:function(v){var u=this.__tP[v];if(u==undefined){return;}
;this.__tN.removeAttribute(u);qx.bom.storage.UserData.__cj-- ;delete this.__gb[v];delete this.__tP[v];var t=d+qx.bom.storage.UserData.__cj;if(this.__tN.getAttribute(t)){var w=this.__tN.getAttribute(d+qx.bom.storage.UserData.__cj);this.__tN.removeAttribute(t);this.__tN.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__tP[s]=u;}
;this.__tN.save(this.__tO);}
,clear:function(){for(var x in this.__tP){this.__tN.removeAttribute(this.__tP[x]);}
;this.__tN.save(this.__tO);this.__gb={};this.__tP={};}
...
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__tL:null,__tM:null,getLocal:function(){if(this.__tL){return this.__tL;}
;return this.__tL=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__tM){return this.__tM;}
