...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.aa0d290afae0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__tF:null,__tG:null,__ch:0,getLocal:function(){if(this.__tF){return this.__tF;}
;return this.__tF=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__tG){return this.__tG;}
;return this.__tG=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__tH=document.createElement(f);this.__tH.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__tH);this.__tH.addBehavior(j);this.__tI=m;this.__tH.load(this.__tI);this.__fY={};this.__tJ={};var l=this.__tH.getAttribute(d+qx.bom.storage.UserData.__ch);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fY[l.key]=l.value;this.__tJ[l.key]=d+qx.bom.storage.UserData.__ch;qx.bom.storage.UserData.__ch++ ;l=this.__tH.getAttribute(d+qx.bom.storage.UserData.__ch);}
;}
,members:{__tH:null,__tI:h,__fY:null,__tJ:null,getStorage:function(){return this.__fY;}
...
;var q=qx.lang.Json.stringify({key:n,value:p});this.__tH.setAttribute(o,q);this.__tH.save(this.__tI);this.__fY[n]=p;this.__tJ[n]=o;}
,getItem:function(r){return this.__fY[r]||null;}
,removeItem:function(v){var u=this.__tJ[v];if(u==undefined){return;}
;this.__tH.removeAttribute(u);qx.bom.storage.UserData.__ch-- ;delete this.__fY[v];delete this.__tJ[v];var t=d+qx.bom.storage.UserData.__ch;if(this.__tH.getAttribute(t)){var w=this.__tH.getAttribute(d+qx.bom.storage.UserData.__ch);this.__tH.removeAttribute(t);this.__tH.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__tJ[s]=u;}
;this.__tH.save(this.__tI);}
,clear:function(){for(var x in this.__tJ){this.__tH.removeAttribute(this.__tJ[x]);}
;this.__tH.save(this.__tI);this.__fY={};this.__tJ={};}
