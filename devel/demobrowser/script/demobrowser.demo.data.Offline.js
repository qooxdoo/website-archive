...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.0b989cfa7322.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__tF:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__tG:null,__tH:null,getLocal:function(){if(this.__tG){return this.__tG;}
;return this.__tG=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__tH){return this.__tH;}
;return this.__tH=new qx.bom.storage.Web(b);}
},construct:function(g){this.__pX=g;}
,members:{__pX:null,getStorage:function(){return window[this.__pX+c];}
,getLength:function(){return this.getStorage(this.__pX).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__pX).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__pX).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__pX).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__pX);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__pX).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__tG:null,__tH:null,__ch:0,getLocal:function(){if(this.__tG){return this.__tG;}
;return this.__tG=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__tH){return this.__tH;}
;return this.__tH=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__tI=document.createElement(f);this.__tI.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__tI);this.__tI.addBehavior(j);this.__tJ=m;this.__tI.load(this.__tJ);this.__fY={};this.__tK={};var l=this.__tI.getAttribute(d+qx.bom.storage.UserData.__ch);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fY[l.key]=l.value;this.__tK[l.key]=d+qx.bom.storage.UserData.__ch;qx.bom.storage.UserData.__ch++ ;l=this.__tI.getAttribute(d+qx.bom.storage.UserData.__ch);}
;}
,members:{__tI:null,__tJ:h,__fY:null,__tK:null,getStorage:function(){return this.__fY;}
,getLength:function(){return Object.keys(this.__fY).length;}
,setItem:function(n,p){if(this.__tK[n]){var o=this.__tK[n];}
else {var o=d+qx.bom.storage.UserData.__ch;qx.bom.storage.UserData.__ch++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__tI.setAttribute(o,q);this.__tI.save(this.__tJ);this.__fY[n]=p;this.__tK[n]=o;}
,getItem:function(r){return this.__fY[r]||null;}
,removeItem:function(v){var u=this.__tK[v];if(u==undefined){return;}
;this.__tI.removeAttribute(u);qx.bom.storage.UserData.__ch-- ;delete this.__fY[v];delete this.__tK[v];var t=d+qx.bom.storage.UserData.__ch;if(this.__tI.getAttribute(t)){var w=this.__tI.getAttribute(d+qx.bom.storage.UserData.__ch);this.__tI.removeAttribute(t);this.__tI.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__tK[s]=u;}
;this.__tI.save(this.__tJ);}
,clear:function(){for(var x in this.__tK){this.__tI.removeAttribute(this.__tK[x]);}
;this.__tI.save(this.__tJ);this.__fY={};this.__tK={};}
,getKey:function(y){return Object.keys(this.__fY)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__tG:null,__tH:null,getLocal:function(){if(this.__tG){return this.__tG;}
;return this.__tG=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__tH){return this.__tH;}
;return this.__tH=new qx.bom.storage.Memory();}
},construct:function(){this.__fY={};}
,members:{__fY:null,getStorage:function(){return this.__fY;}
,getLength:function(){return Object.keys(this.__fY).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__fY[b]=c;}
,getItem:function(e){var d=this.__fY[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__fY[f];}
,clear:function(){this.__fY={};}
,getKey:function(h){var g=Object.keys(this.__fY);return g[h];}
