...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.59b946d5c558.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__xK.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__xJ:null,__xK:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__xJ);l.dispose();this.__xJ=null;}
;if(m){this.__xJ=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__tz:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__tA:null,__tB:null,getLocal:function(){if(this.__tA){return this.__tA;}
;return this.__tA=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__tB){return this.__tB;}
;return this.__tB=new qx.bom.storage.Web(b);}
},construct:function(g){this.__pN=g;}
,members:{__pN:null,getStorage:function(){return window[this.__pN+c];}
,getLength:function(){return this.getStorage(this.__pN).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__pN).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__pN).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__pN).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__pN);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__pN).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__tA:null,__tB:null,__cs:0,getLocal:function(){if(this.__tA){return this.__tA;}
;return this.__tA=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__tB){return this.__tB;}
;return this.__tB=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__tC=document.createElement(f);this.__tC.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__tC);this.__tC.addBehavior(j);this.__tD=m;this.__tC.load(this.__tD);this.__fR={};this.__tE={};var l=this.__tC.getAttribute(d+qx.bom.storage.UserData.__cs);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fR[l.key]=l.value;this.__tE[l.key]=d+qx.bom.storage.UserData.__cs;qx.bom.storage.UserData.__cs++ ;l=this.__tC.getAttribute(d+qx.bom.storage.UserData.__cs);}
;}
,members:{__tC:null,__tD:h,__fR:null,__tE:null,getStorage:function(){return this.__fR;}
,getLength:function(){return Object.keys(this.__fR).length;}
,setItem:function(n,p){if(this.__tE[n]){var o=this.__tE[n];}
else {var o=d+qx.bom.storage.UserData.__cs;qx.bom.storage.UserData.__cs++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__tC.setAttribute(o,q);this.__tC.save(this.__tD);this.__fR[n]=p;this.__tE[n]=o;}
,getItem:function(r){return this.__fR[r]||null;}
,removeItem:function(v){var u=this.__tE[v];if(u==undefined){return;}
;this.__tC.removeAttribute(u);qx.bom.storage.UserData.__cs-- ;delete this.__fR[v];delete this.__tE[v];var t=d+qx.bom.storage.UserData.__cs;if(this.__tC.getAttribute(t)){var w=this.__tC.getAttribute(d+qx.bom.storage.UserData.__cs);this.__tC.removeAttribute(t);this.__tC.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__tE[s]=u;}
;this.__tC.save(this.__tD);}
,clear:function(){for(var x in this.__tE){this.__tC.removeAttribute(this.__tE[x]);}
;this.__tC.save(this.__tD);this.__fR={};this.__tE={};}
...
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__tA:null,__tB:null,getLocal:function(){if(this.__tA){return this.__tA;}
