...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.6773ff1b444a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this._storeModel=qx.util.Function.debounce(this.__xL.bind(this),qx.data.store.Offline.STORE_MODEL_DELAY);this._marshaler=new qx.data.marshal.Json(i);this._key=j;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},statics:{STORE_MODEL_DELAY:400},members:{_storage:null,__xK:null,__xL:function(){var k=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,k);}
,_applyModel:function(m,l){if(l){l.removeListenerById(this.__xK);l.dispose();this.__xK=null;}
;if(m){this.__xK=m.addListener(f,this._storeModel,this);this._storeModel();}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__tA:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__tB:null,__tC:null,getLocal:function(){if(this.__tB){return this.__tB;}
;return this.__tB=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__tC){return this.__tC;}
;return this.__tC=new qx.bom.storage.Web(b);}
},construct:function(g){this.__pO=g;}
,members:{__pO:null,getStorage:function(){return window[this.__pO+c];}
,getLength:function(){return this.getStorage(this.__pO).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__pO).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__pO).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__pO).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__pO);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__pO).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__tB:null,__tC:null,__cs:0,getLocal:function(){if(this.__tB){return this.__tB;}
;return this.__tB=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__tC){return this.__tC;}
;return this.__tC=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__tD=document.createElement(f);this.__tD.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__tD);this.__tD.addBehavior(j);this.__tE=m;this.__tD.load(this.__tE);this.__fR={};this.__tF={};var l=this.__tD.getAttribute(d+qx.bom.storage.UserData.__cs);while(l!=undefined){l=qx.lang.Json.parse(l);this.__fR[l.key]=l.value;this.__tF[l.key]=d+qx.bom.storage.UserData.__cs;qx.bom.storage.UserData.__cs++ ;l=this.__tD.getAttribute(d+qx.bom.storage.UserData.__cs);}
;}
,members:{__tD:null,__tE:h,__fR:null,__tF:null,getStorage:function(){return this.__fR;}
,getLength:function(){return Object.keys(this.__fR).length;}
,setItem:function(n,p){if(this.__tF[n]){var o=this.__tF[n];}
else {var o=d+qx.bom.storage.UserData.__cs;qx.bom.storage.UserData.__cs++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__tD.setAttribute(o,q);this.__tD.save(this.__tE);this.__fR[n]=p;this.__tF[n]=o;}
,getItem:function(r){return this.__fR[r]||null;}
,removeItem:function(v){var u=this.__tF[v];if(u==undefined){return;}
;this.__tD.removeAttribute(u);qx.bom.storage.UserData.__cs-- ;delete this.__fR[v];delete this.__tF[v];var t=d+qx.bom.storage.UserData.__cs;if(this.__tD.getAttribute(t)){var w=this.__tD.getAttribute(d+qx.bom.storage.UserData.__cs);this.__tD.removeAttribute(t);this.__tD.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__tF[s]=u;}
;this.__tD.save(this.__tE);}
,clear:function(){for(var x in this.__tF){this.__tD.removeAttribute(this.__tF[x]);}
;this.__tD.save(this.__tE);this.__fR={};this.__tF={};}
,getKey:function(y){return Object.keys(this.__fR)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__tB:null,__tC:null,getLocal:function(){if(this.__tB){return this.__tB;}
;return this.__tB=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__tC){return this.__tC;}
;return this.__tC=new qx.bom.storage.Memory();}
},construct:function(){this.__fR={};}
,members:{__fR:null,getStorage:function(){return this.__fR;}
,getLength:function(){return Object.keys(this.__fR).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__fR[b]=c;}
,getItem:function(e){var d=this.__fR[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__fR[f];}
,clear:function(){this.__fR={};}
,getKey:function(h){var g=Object.keys(this.__fR);return g[h];}
