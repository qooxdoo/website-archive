...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Dynamic_Resize.c41542a26e98.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="The root widget does not support 'left', or 'top' paddings!",i="div",j="left",k="paddingTop",l="qxIsRootPage",m="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(n){this.__mX=n;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__ng,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__dE:null,__mX:null,_createContentElement:function(){var p=this.__mX.createElement(i);this.__mX.body.appendChild(p);var o=new qx.html.Root(p);o.setStyles({position:m,textAlign:j});o.connectWidget(this);if((qx.core.Environment.get(c)==f)){o.setAttribute(l,1);}
;return o;}
...
,__ng:function(e){this.getContentElement().setStyles({width:0,height:0});}
...
;this.__yo=v;v.style.overflow=o;v.style.textAlign=q;this.__yp=w||false;this.__yq=u||false;this.__yr();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__yp:false,__yq:false,__yo:null,__yr:function(){if(this.__yp||this.__yq){var x=qx.bom.element.Dimension.getSize(this.__yo);if(this.__yp&&x.width<1){throw new Error(r+this.__yo+s+this+k);}
;if(this.__yq){if(x.height<1){throw new Error(r+this.__yo+s+this+g);}
;if(x.height>=1&&qx.bom.element.Style.get(this.__yo,j,3)==f){qx.bom.element.Style.set(this.__yo,j,x.height+h);}
;}
;qx.event.Registration.addListener(this.__yo,a,this._onResize,this);}
;}
,_createContentElement:function(){var y=this.__yo;if(this.__yp||this.__yq){var A=document.createElement(p);y.appendChild(A);}
else {A=y;}
;var z=new qx.html.Root(A);A.style.position=d;z.connectWidget(this);qx.event.Timer.once(function(e){this.fireEvent(n);}
,this,0);return z;}
,_onResize:function(e){var B=e.getData();if((B.oldWidth!==B.width)&&this.__yp||(B.oldHeight!==B.height)&&this.__yq){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var G=this.__yp;var D=this.__yq;if(!G||!D){var C=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {C={};}
;var H=qx.bom.element.Dimension;if(G){var F=H.getContentWidth(this.__yo);C.width=F;C.minWidth=F;C.maxWidth=F;}
;if(D){var E=H.getContentHeight(this.__yo);C.height=E;C.minHeight=E;C.maxHeight=E;}
;return C;}
},defer:function(I,J){qx.ui.core.MLayoutHandling.remap(J);}
,destruct:function(){qx.event.Registration.removeListener(this.__yo,a,this._onResize,this);this.__yo=null;}
});}
)();
(function(){var a="resize",b="__dE",c="interval",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:[qx.event.IEventHandler,qx.core.IDisposable],construct:function(g){qx.core.Object.call(this);this.__dn=g;this.__yc={};this.__dE=new qx.event.Timer(200);this.__dE.addListener(c,this._onInterval,this);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__yc:null,__dn:null,__dE:null,canHandleEvent:function(i,h){return i.tagName.toLowerCase()!==d;}
,registerEvent:function(m,n,j){var l=qx.core.ObjectRegistry.toHashCode(m);var k=this.__yc;if(!k[l]){k[l]={element:m,width:qx.bom.element.Dimension.getWidth(m),height:qx.bom.element.Dimension.getHeight(m)};this.__dE.start();}
;}
,unregisterEvent:function(r,s,o){var q=qx.core.ObjectRegistry.toHashCode(r);var p=this.__yc;if(p[q]){delete p[q];if(qx.lang.Object.isEmpty(p)){this.__dE.stop();}
;}
;}
,_onInterval:function(e){var u=this.__yc;for(var x in u){var y=u[x];var t=y.element;var w=qx.bom.element.Dimension.getWidth(t);var v=qx.bom.element.Dimension.getHeight(t);if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,a,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);y.width=w;y.height=v;}
;}
;}
},destruct:function(){this.__dn=this.__yc=null;this._disposeObjects(b);}
