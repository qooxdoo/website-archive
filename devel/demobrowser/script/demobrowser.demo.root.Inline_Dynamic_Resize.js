...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Dynamic_Resize.a0f2f22e86f0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="The root widget does not support 'left', or 'top' paddings!",i="div",j="left",k="paddingTop",l="qxIsRootPage",m="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(n){this.__mU=n;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__nd,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__dC:null,__mU:null,_createContentElement:function(){var p=this.__mU.createElement(i);this.__mU.body.appendChild(p);var o=new qx.html.Root(p);o.setStyles({position:m,textAlign:j});o.connectWidget(this);if((qx.core.Environment.get(c)==f)){o.setAttribute(l,1);}
;return o;}
,_computeSizeHint:function(){var q=qx.bom.Document.getWidth(this._window);var r=qx.bom.Document.getHeight(this._window);return {minWidth:q,width:q,maxWidth:q,minHeight:r,height:r,maxHeight:r};}
,__nd:function(e){this.getContentElement().setStyles({width:0,height:0});}
,supportsMaximize:function(){return false;}
,_applyPadding:function(t,s,name){if(t&&(name==k||name==g)){throw new Error(h);}
;qx.ui.root.Abstract.prototype._applyPadding.call(this,t,s,name);}
...
(function(){var a="resize",b="mshtml",c="engine.name",d="relative",f="",g=" needs a height when its height size should be used!",h="px",i="qx.debug",j="height",k=" needs a width when its width size should be used!",l="-webkit-backface-visibility",m="qx.ui.root.Inline",n="appear",o="hidden",p="div",q="left",r="The root element ",s=" of ",t="Please use a DOM element to create an inline root.";qx.Class.define(m,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(v,w,u){if(qx.core.Environment.get(i)){this.assertElement(v,t);}
;this.__yh=v;v.style.overflow=o;v.style.textAlign=q;this.__yi=w||false;this.__yj=u||false;this.__yk();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
;var window=qx.dom.Node.getWindow(v);qx.event.Registration.addListener(window,a,this._onWindowResize,this);this.getContentElement().setStyle(l,o);}
,members:{__yi:false,__yj:false,__yh:null,__yk:function(){if(this.__yi||this.__yj){var x=qx.bom.element.Dimension.getSize(this.__yh);if(this.__yi&&x.width<1){throw new Error(r+this.__yh+s+this+k);}
;if(this.__yj){if(x.height<1){throw new Error(r+this.__yh+s+this+g);}
;if(x.height>=1&&qx.bom.element.Style.get(this.__yh,j,3)==f){qx.bom.element.Style.set(this.__yh,j,x.height+h);}
;}
;qx.event.Registration.addListener(this.__yh,a,this._onResize,this);}
;}
,_createContentElement:function(){var y=this.__yh;if(this.__yi||this.__yj){var A=document.createElement(p);y.appendChild(A);}
else {A=y;}
;var z=new qx.html.Root(A);A.style.position=d;z.connectWidget(this);qx.event.Timer.once(function(e){this.fireEvent(n);}
,this,0);return z;}
,_onResize:function(e){var B=e.getData();if((B.oldWidth!==B.width)&&this.__yi||(B.oldHeight!==B.height)&&this.__yj){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var G=this.__yi;var D=this.__yj;if(!G||!D){var C=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {C={};}
;var H=qx.bom.element.Dimension;if(G){var F=H.getContentWidth(this.__yh);C.width=F;C.minWidth=F;C.maxWidth=F;}
;if(D){var E=H.getContentHeight(this.__yh);C.height=E;C.minHeight=E;C.maxHeight=E;}
;return C;}
},defer:function(I,J){qx.ui.core.MLayoutHandling.remap(J);}
,destruct:function(){qx.event.Registration.removeListener(this.__yh,a,this._onResize,this);this.__yh=null;}
});}
)();
(function(){var a="resize",b="interval",c="__dC",d="body",f="qx.event.handler.ElementResize";qx.Class.define(f,{extend:qx.core.Object,implement:[qx.event.IEventHandler,qx.core.IDisposable],construct:function(g){qx.core.Object.call(this);this.__dl=g;this.__xU={};this.__dC=new qx.event.Timer(200);this.__dC.addListener(b,this._onInterval,this);}
