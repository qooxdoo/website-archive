...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButtonGroup.6acc0b7342f0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,add:function(w,v){this.__vH.add(w);this._add(w,v);}
,remove:function(x){this.__vH.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__vH.getItems();for(var i=y.length-1;i>=0;i-- ){this.__vH.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__vH.getSelection();}
,setSelection:function(z){this.__vH.setSelection(z);}
,resetSelection:function(){this.__vH.resetSelection();}
,isSelected:function(A){return this.__vH.isSelected(A);}
,isSelectionEmpty:function(){return this.__vH.isSelectionEmpty();}
,getSelectables:function(B){return this.__vH.getSelectables(B);}
