...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButtonGroup.9b60c879c7e6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Boolean",b="_applyValid",c="",d="changeRequired",f="changeValid",g="__vB",h="changeInvalidMessage",j="changeSelection",k="_applyInvalidMessage",l="String",m="qx.ui.form.RadioButtonGroup",n="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__vB=new qx.ui.form.RadioGroup();this.__vB.addListener(j,function(e){this.fireDataEvent(j,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:a,init:true,apply:b,event:f},required:{check:a,init:false,event:d},invalidMessage:{check:l,init:c,event:h,apply:k},requiredInvalidMessage:{check:l,nullable:true,event:h}},events:{"changeSelection":n},members:{__vB:null,_applyInvalidMessage:function(r,p){var q=this._getChildren();for(var i=0;i<q.length;i++ ){q[i].setInvalidMessage(r);}
;}
...
,add:function(w,v){this.__vB.add(w);this._add(w,v);}
,remove:function(x){this.__vB.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__vB.getItems();for(var i=y.length-1;i>=0;i-- ){this.__vB.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__vB.getSelection();}
,setSelection:function(z){this.__vB.setSelection(z);}
,resetSelection:function(){this.__vB.resetSelection();}
,isSelected:function(A){return this.__vB.isSelected(A);}
,isSelectionEmpty:function(){return this.__vB.isSelectionEmpty();}
,getSelectables:function(B){return this.__vB.getSelectables(B);}
