...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FiniteStateMachine.fec40561f6be.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_getInternalData:function(){return ({"states":this.__jY,"startState":this.__Bm,"eventQueue":this.__Bo,"blockedEvents":this.__Bp,"savedStates":this.__Bn,"friendlyToObject":this.__Bq,"friendlyToHash":this.__Br,"hashToFriendly":this.__Bs,"groupToFriendly":this.__Bt,"friendlyToGroups":this.__Bu});}
...
;this.__jY[bV].getAutoActionsBeforeOnentry()(this);if(bU){this.debug(this.getName()+w+bV+T);}
;this.__jY[bV].getOnentry()(this,null);if(bU){this.debug(this.getName()+w+bV+I);}
;this.__jY[bV].getAutoActionsAfterOnentry()(this);}
...
;ck=this.getState();cn=this.__jY[ck];cq=cn.transitions;e=cn.getEvents()[event.getType()];if(!e){if(cu){this.debug(this.getName()+bs+event.getType()+n+r);}
;return true;}
...
;break;}
;};for(var t in cq){var cm=cq[t];switch(cm.getPredicate()(this,event)){case true:break;case false:continue;case null:return true;default:throw new Error(A+ck+z+t+v+bp);};cl=cm.getNextState();if(typeof (cl)==l){if(!cl in this.__jY){throw new Error(o+cl);}
...
;cn=this.__jY[this.getNextState()];this.setPreviousState(ck);this.setState(this.getNextState());this.setNextState(null);cj=ck;ck=cl;cl=undefined;if(cr){this.debug(this.getName()+w+ck+K);}
...
;return true;}
},destruct:function(){this._disposeArray(c);this._disposeArray(j);this.__Bn=this.__jY=null;}
});}
)();
