...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree_Columns","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Columns.8646cb62dad3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Windows (C:)",b="Documents (D:)",c="Inbox",d="Desktop",e="Trash",f="Personal",g="-rw-r--r--",h="Presets",j="size",k="Network",l="light",m="Sent",n="children",o="Big",p="Files",q="icon/16/status/dialog-information.png",r="",s="mode",t=" 2010",u="Workspace",v="date",w="demobrowser.demo.virtual.Tree_Columns",x="Spam",y="Data",z="May ",A="Root",B="label",C="Lists",D="kb",E="Item ",F="checked",G="Edit",H="leadIcon";qx.Class.define(w,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.container.Scroll();var I=new qx.ui.container.Composite(new qx.ui.layout.Basic());I.setAllowGrowX(false);I.setAllowStretchX(false);J.add(I);this.getRoot().add(J,{edge:0});var K=new qx.ui.tree.VirtualTree(null,B,n).set({width:600,height:500});I.add(K,{left:20,top:48});var M={label:A,children:[{label:d,children:[{label:p},{label:u,children:[{label:a},{label:b}]},{label:k},{label:e}]},{label:c,children:[{label:h},{label:m},{label:e},{label:y},{label:G},{label:C},{label:f},{label:o,children:[]},{label:x}]}]};for(var i=0;i<50;i++ ){M.children[1].children[7].children[i]={label:E+i};}
;this.extendData(M);var L=qx.data.marshal.Json.createModel(M,true);this.configureTriState(L);K.setModel(L);K.setDelegate(this);}
,extendData:function(N){N.date=z+Math.round(Math.random()*30+1)+t;N.size=Math.round(Math.random()*100)+D;N.light=Math.floor(Math.random()*4)==0;N.mode=g;N.checked=Math.random()>=0.5;if(N.children){for(var i=0;i<N.children.length;i++ ){this.extendData(N.children[i]);}
;}
;}
,configureTriState:function(O){O.getModel=function(){return this;}
;if(O.getChildren!=null){var P=O.getChildren();for(var i=0;i<P.getLength();i++ ){var Q=P.getItem(i);this.configureTriState(Q);O.bind(F,Q,F,{converter:function(R,S){if(R===null){return S.getChecked();}
;return R;}
});Q.bind(F,O,F,{converter:function(V,parent){var W=parent.getChildren().toArray();var T=W.every(function(X){return X.getChecked();}
);var U=W.some(function(Y){return Y.getChecked()||Y.getChecked()==null;}
);if(U){return T?true:null;}
else {return false;}
;}
});}
;}
;}
,bindItem:function(bb,ba,bc){bb.bindDefaultProperties(ba,bc);bb.bindProperty(j,j,null,ba,bc);bb.bindProperty(F,F,null,ba,bc);bb.bindPropertyReverse(F,F,null,ba,bc);bb.bindProperty(v,v,null,ba,bc);bb.bindProperty(s,s,null,ba,bc);bb.bindProperty(l,H,{converter:function(bd){return bd?q:r;}
},ba,bc);}
,createItem:function(){return new demobrowser.demo.virtual.tree.TreeItem();}
}});}
)();
...
,openNodeWithoutScrolling:function(g){this.assertArgumentsCount(arguments,1,1);this.assertInterface(g,qx.core.Object);}
,closeNode:function(h){this.assertArgumentsCount(arguments,1,1);this.assertInterface(h,qx.core.Object);}
,closeNodeWithoutScrolling:function(i){this.assertArgumentsCount(arguments,1,1);this.assertInterface(i,qx.core.Object);}
...
(function(){var a="changeModel",b="resize",c="_applyLabelOptions",d="_applyLabelPath",f="or 'labelPath' is 'null'!",g="one",h="marshal.MEventBubbling'. Therefore the tree can not update ",j="_applyOpenMode",k="the view automatically on model changes.",l="qx.core.Object",m="Space",n="Left",o="filter",p="Integer",q="_applyModel",r="_applyShowTopLevelOpenCloseIcons",s="Boolean",t="open",u="changeOpenMode",v="cellTap",w="qx.debug",x="changeDelegate",y="virtual-tree",z="_applyChildProperty",A="qx.event.type.Data",B="_applyIconPath",C="dbltap",D="_applyDelegate",E="cellDbltap",F="_applyHideRoot",G="close",H="The model item doesn't support the Mixin 'qx.data.",I="_applyRowHeight",J="changeBubble",K="sorter",L="Right",M="Enter",N="qx.ui.tree.VirtualTree",O="keypress",P="none",Q="Could not build tree, because 'childProperty' and/",R="updated",S="_applyShowLeafs",T="String",U="_applyIconOptions",V="tap",W=".";qx.Class.define(N,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.tree.core.IVirtualTree,qx.data.controller.ISelection],include:[qx.ui.virtual.selection.MModel,qx.ui.core.MContentPadding],construct:function(X,ba,Y){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);this._init();if(ba!=null){this.setLabelPath(ba);}
;if(Y!=null){this.setChildProperty(Y);}
;if(X!=null){this.initModel(X);}
;this.initItemHeight();this.initOpenMode();this.addListener(O,this._onKeyPress,this);}
,events:{open:A,close:A},properties:{appearance:{refine:true,init:y},focusable:{refine:true,init:true},width:{refine:true,init:100},height:{refine:true,init:200},itemHeight:{check:p,init:25,apply:I,themeable:true},openMode:{check:[V,C,P],init:C,apply:j,event:u,themeable:true},hideRoot:{check:s,init:false,apply:F},showTopLevelOpenCloseIcons:{check:s,init:false,apply:r},showLeafs:{check:s,init:true,apply:S},childProperty:{check:T,apply:z,nullable:true},labelPath:{check:T,apply:d,nullable:true},iconPath:{check:T,apply:B,nullable:true},labelOptions:{apply:c,nullable:true},iconOptions:{apply:U,nullable:true},model:{check:l,apply:q,event:a,nullable:true,deferredInit:true},delegate:{event:x,apply:D,init:null,nullable:true}},members:{_provider:null,_layer:null,__sn:null,__so:null,__sp:null,__ho:null,_itemWidth:0,__sq:null,syncWidget:function(bc){var be=this._layer.getFirstRow();var bd=this._layer.getRowSizes().length;for(var bg=be;bg<be+bd;bg++ ){var bb=this._layer.getRenderedCellWidget(bg,0);if(bb!=null){this._itemWidth=Math.max(this._itemWidth,bb.getSizeHint().width);}
;}
;var bf=this.getPane().getInnerSize().width;this.getPane().getColumnConfig().setItemSize(0,Math.max(this._itemWidth,bf));}
,openNode:function(bh){this.__st(bh);this.buildLookupTable();}
,openNodeWithoutScrolling:function(bi){var bj=this.getAutoScrollIntoView();this.setAutoScrollIntoView(false);this.openNode(bi);this.setAutoScrollIntoView(bj);}
,refresh:function(){this.buildLookupTable();}
,openNodeAndParents:function(bk){this.__su(this.getModel(),bk);this.buildLookupTable();}
,closeNode:function(bl){if(qx.lang.Array.contains(this.__so,bl)){qx.lang.Array.remove(this.__so,bl);this.fireDataEvent(G,bl);this.buildLookupTable();}
;}
,closeNodeWithoutScrolling:function(bm){var bn=this.getAutoScrollIntoView();this.setAutoScrollIntoView(false);this.closeNode(bm);this.setAutoScrollIntoView(bn);}
,isNodeOpen:function(bo){return qx.lang.Array.contains(this.__so,bo);}
,_init:function(){this.__sn=new qx.data.Array();this.__so=[];this.__sp=[];this._initLayer();}
,_initLayer:function(){this._provider=new qx.ui.tree.provider.WidgetProvider(this);this._layer=this._provider.createLayer();this._layer.addListener(R,this._onUpdated,this);this.getPane().addLayer(this._layer);this.getPane().addListenerOnce(b,function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,this);}
,getLookupTable:function(){return this.__sn;}
,_reverseLookup:function(bp){return bp;}
,_getDataFromRow:function(bq){return this.__sn.getItem(bq);}
,_getSelectables:function(){return this.__sn;}
,getOpenNodes:function(){return this.__so;}
,isNode:function(br){return qx.ui.tree.core.Util.isNode(br,this.getChildProperty());}
,getLevel:function(bs){return this.__sp[bs];}
,hasChildren:function(bt){return qx.ui.tree.core.Util.hasChildren(bt,this.getChildProperty(),!this.isShowLeafs());}
,_getContentPaddingTarget:function(){return this.getPane();}
,_applyRowHeight:function(bv,bu){this.getPane().getRowConfig().setDefaultItemSize(bv);}
,_applyOpenMode:function(bx,bw){var by=this.getPane();if(bx===C){by.addListener(E,this._onOpen,this);}
else if(bx===V){by.addListener(v,this._onOpen,this);}
;if(bw===C){by.removeListener(E,this._onOpen,this);}
else if(bw===V){by.removeListener(v,this._onOpen,this);}
;}
,_applyHideRoot:function(bA,bz){this.buildLookupTable();}
,_applyShowTopLevelOpenCloseIcons:function(bC,bB){this.buildLookupTable();}
,_applyShowLeafs:function(bE,bD){this.buildLookupTable();}
,_applyChildProperty:function(bG,bF){this._provider.setChildProperty(bG);}
,_applyLabelPath:function(bI,bH){this._provider.setLabelPath(bI);}
,_applyIconPath:function(bK,bJ){this._provider.setIconPath(bK);}
,_applyLabelOptions:function(bM,bL){this._provider.setLabelOptions(bM);}
,_applyIconOptions:function(bO,bN){this._provider.setIconOptions(bO);}
,_applyModel:function(bQ,bP){this.__so=[];if(bQ!=null){if(qx.core.Environment.get(w)){if(!qx.Class.hasMixin(bQ.constructor,qx.data.marshal.MEventBubbling)){this.warn(H+h+k);}
;}
;bQ.addListener(J,this._onChangeBubble,this);this.__st(bQ);}
;if(bP!=null){bP.removeListener(J,this._onChangeBubble,this);}
;this.__sr();}
,_applyDelegate:function(bS,bR){this._provider.setDelegate(bS);this.buildLookupTable();}
,_onChangeBubble:function(event){var bX=event.getData();var bU=bX.name;var bT=bU.lastIndexOf(W);if(bT!=-1){bU=bU.substr(bT+1,bU.length);}
;if(qx.lang.String.startsWith(bU,this.getChildProperty())){var bV=bX.item;if(qx.Class.isSubClassOf(bV.constructor,qx.data.Array)){if(bT===-1){bV=this.getModel();}
else {var bW=bX.name.substr(0,bT);bV=qx.data.SingleValueBinding.resolvePropertyChain(this.getModel(),bW);}
;}
;if(this.__sn.indexOf(bV)!=-1){this.__sr();}
;}
;}
,_onUpdated:function(event){if(this.__ho==null){this.__ho=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__ho.schedule();}
,_onOpen:function(event){var ca=event.getRow();var bY=this.__sn.getItem(ca);if(this.isNode(bY)){if(this.isNodeOpen(bY)){this.closeNode(bY);}
else {this.openNode(bY);}
;}
;}
,_onKeyPress:function(e){var cb=this.getSelection();if(cb.getLength()>0){var cd=cb.getItem(0);var cc=this.isNode(cd);switch(e.getKeyIdentifier()){case n:if(cc&&this.isNodeOpen(cd)){this.closeNode(cd);}
else {var parent=this.getParent(cd);if(parent!=null){cb.splice(0,1,parent);}
;}
;break;case L:if(cc&&!this.isNodeOpen(cd)){this.openNode(cd);}
else {if(cc){var ce=cd.get(this.getChildProperty());if(ce!=null&&ce.getLength()>0){cb.splice(0,1,ce.getItem(0));}
;}
;}
;break;case M:case m:if(!cc){return;}
;if(this.isNodeOpen(cd)){this.closeNode(cd);}
else {this.openNode(cd);}
;break;};}
;}
,_beforeApplySelection:function(cg){if(cg.length===0&&this.getSelectionMode()===g){var cf=this.__sx();var ch=this.getLookupTable().indexOf(cf);if(ch>=0){cg.push(ch);}
;}
;}
,_afterApplySelection:function(){var ci=this.getSelection();if(ci.getLength()>0&&this.getSelectionMode()===g){this.__sw(ci.getItem(0));}
else {this.__sq=[];}
;}
,__sr:function(){this.buildLookupTable();this._applyDefaultSelection();}
,buildLookupTable:function(){if(this.getModel()!=null&&(this.getChildProperty()==null||this.getLabelPath()==null)){throw new Error(Q+f);}
;this._itemWidth=0;var cm=[];this.__sp=[];var ck=-1;var cl=this.getModel();if(cl!=null){if(!this.isHideRoot()){ck++ ;cm.push(cl);this.__sp.push(ck);}
;if(this.isNodeOpen(cl)){var cj=this.__ss(cl,ck);cm=cm.concat(cj);}
;}
;if(!qx.lang.Array.equals(this.__sn.toArray(),cm)){this._provider.removeBindings();this.__sn.removeAll();this.__sn.append(cm);this.__sv();this._updateSelection();}
;}
,__ss:function(cn,cs){var cr=[];cs++ ;if(!this.isNode(cn)){return cr;}
;var cv=cn.get(this.getChildProperty());if(cv==null){return cr;}
;cv=cv.copy();var ct=this.getDelegate();var cq=qx.util.Delegate.getMethod(ct,o);var cp=qx.util.Delegate.getMethod(ct,K);if(cp!=null){cv.sort(cp);}
;for(var i=0;i<cv.getLength();i++ ){var cu=cv.getItem(i);if(cq&&!cq(cu)){continue;}
;if(this.isNode(cu)){this.__sp.push(cs);cr.push(cu);if(this.isNodeOpen(cu)){var co=this.__ss(cu,cs);cr=cr.concat(co);}
;}
else {if(this.isShowLeafs()){this.__sp.push(cs);cr.push(cu);}
;}
;}
;cv.dispose();return cr;}
,__st:function(cw){if(!qx.lang.Array.contains(this.__so,cw)){this.__so.push(cw);this.fireDataEvent(t,cw);}
;}
,__su:function(cx,cy){if(cx===cy){this.__st(cy);return true;}
;if(!this.isNode(cx)){return false;}
;var cB=cx.get(this.getChildProperty());if(cB==null){return false;}
;for(var i=0;i<cB.getLength();i++ ){var cA=cB.getItem(i);var cz=this.__su(cA,cy);if(cz===true){this.__st(cA);return true;}
;}
;return false;}
,__sv:function(){this.getPane().getRowConfig().setItemCount(this.__sn.getLength());this.getPane().fullUpdate();}
,getParent:function(cD){var cE=this.__sn.indexOf(cD);if(cE<0){return null;}
;var cF=this.__sp[cE];while(cE>0){cE-- ;var cC=this.__sp[cE];if(cC<cF){return this.__sn.getItem(cE);}
;}
;return null;}
,__sw:function(cG){this.__sq=[];var parent=this.getParent(cG);while(parent!=null){this.__sq.unshift(parent);parent=this.getParent(parent);}
;}
,__sx:function(){if(this.__sq==null){return this.getModel();}
;var cH=this.getLookupTable();var parent=this.__sq.pop();while(parent!=null){if(cH.contains(parent)){return parent;}
;parent=this.__sq.pop();}
;return this.getModel();}
},destruct:function(){var cJ=this.getPane();if(cJ!=null){if(cJ.hasListener(E)){cJ.removeListener(E,this._onOpen,this);}
;if(cJ.hasListener(v)){cJ.removeListener(v,this._onOpen,this);}
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__ho!=null){this.__ho.cancel();this.__ho.dispose();}
;var cI=this.getModel();if(cI!=null){cI.removeListener(J,this._onChangeBubble,this);}
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__sn.dispose();this._layer=this._provider=this.__sn=this.__so=this.__ho=null;}
});}
)();
...
(function(){var a="BindingIds",b="model",c="",d="changeDelegate",f="virtual-tree-file",g="label",h="appearance",i="icon",j="bindItem",k=".length",l="]",m="virtual-tree-folder",n="[",o=".",p="String",q="qx.ui.tree.core.MWidgetController";qx.Mixin.define(q,{construct:function(){this.__sy=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:p,nullable:true},delegate:{event:d,init:null,nullable:true}},members:{__sy:null,bindDefaultProperties:function(u,s){this.bindProperty(c,b,null,u,s);this.bindProperty(this.getLabelPath(),g,this.getLabelOptions(),u,s);var r=this.__sz(s);var t=this._tree.getLookupTable();t=qx.data.SingleValueBinding.resolvePropertyChain(t,r);if(qx.util.OOUtil.hasProperty(t.constructor,this.getChildProperty())){this.bindProperty(this.getChildProperty()+k,h,{converter:function(){return m;}
},u,s);}
else {u.setAppearance(f);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),i,this.getIconOptions(),u,s);}
;}
,bindProperty:function(y,B,z,x,v){var A=this.__sz(v,y);var w=this._tree.getLookupTable();var C=w.bind(A,x,B,z);this.__sA(x,C);}
,bindPropertyReverse:function(J,F,H,I,D){var G=this.__sz(D,J);var E=this._tree.getLookupTable();var K=I.bind(F,E,G,H);this.__sA(I,K);}
,removeBindings:function(){while(this.__sy.length>0){var L=this.__sy.pop();this._removeBindingsFrom(L);}
;}
,_bindItem:function(N,O){var M=qx.util.Delegate.getMethod(this.getDelegate(),j);if(M!=null){M(this,N,O);}
else {this.bindDefaultProperties(N,O);}
;}
,_removeBindingsFrom:function(P){var Q=this.__sB(P);while(Q.length>0){var R=Q.pop();try{this._tree.getLookupTable().removeBinding(R);}
catch(e){P.removeBinding(R);}
;}
;if(qx.lang.Array.contains(this.__sy,P)){qx.lang.Array.remove(this.__sy,P);}
;}
,__sz:function(T,U){var S=n+T+l;if(U!=null&&U!=c){S+=o+U;}
;return S;}
,__sA:function(W,X){var V=this.__sB(W);if(!qx.lang.Array.contains(V,X)){V.push(X);}
;if(!qx.lang.Array.contains(this.__sy,W)){this.__sy.push(W);}
;}
,__sB:function(Y){var ba=Y.getUserData(a);if(ba==null){ba=[];Y.setUserData(a,ba);}
;return ba;}
...
,members:{_tree:null,_renderer:null,getCellWidget:function(t,r){var s=this._tree.getLookupTable().getItem(t);var p=false;if(this._tree.isNode(s)){p=this._tree.hasChildren(s);}
;var o=this._renderer.getCellWidget();o.setOpen(p&&this._tree.isNodeOpen(s));o.addListener(a,this.__sC,this);o.setUserData(b,this.getChildProperty());o.setUserData(g,this._tree.isShowLeafs());if(this._tree.getSelection().contains(s)){this._styleSelectabled(o);}
else {this._styleUnselectabled(o);}
;var q=this._tree.getLevel(t);if(!this._tree.isShowTopLevelOpenCloseIcons()){q-=1;}
;o.setUserData(d,q);if(!this._tree.isShowTopLevelOpenCloseIcons()&&q==-1){o.setOpenSymbolMode(m);}
else {o.setOpenSymbolMode(f);}
;this._bindItem(o,t);qx.ui.core.queue.Widget.add(o);return o;}
,poolCellWidget:function(u){u.removeListener(a,this.__sC,this);this._removeBindingsFrom(u);this._renderer.pool(u);this._onPool(u);}
,createLayer:function(){return new qx.ui.virtual.layer.WidgetCell(this);}
,createRenderer:function(){var v=qx.util.Delegate.getMethod(this.getDelegate(),e);if(v==null){v=function(){return new qx.ui.tree.VirtualTreeItem();}
;}
;var w=new qx.ui.virtual.cell.WidgetCell();w.setDelegate({createWidget:v});return w;}
,styleSelectabled:function(y){var x=this._tree._layer.getRenderedCellWidget(y,0);this._styleSelectabled(x);}
,styleUnselectabled:function(A){var z=this._tree._layer.getRenderedCellWidget(A,0);this._styleUnselectabled(z);}
,isSelectable:function(C){var B=this._tree._layer.getRenderedCellWidget(C,0);if(B!=null){return B.isEnabled();}
else {return true;}
;}
,_styleSelectabled:function(D){if(D==null){return;}
;this._renderer.updateStates(D,{selected:1});}
,_styleUnselectabled:function(E){if(E==null){return;}
;this._renderer.updateStates(E,{});}
,_onPool:function(F){var G=qx.util.Delegate.getMethod(this.getDelegate(),j);if(G!=null){G(F);}
;}
,_onItemCreated:function(event){var H=qx.util.Delegate.getMethod(this.getDelegate(),h);if(H!=null){var I=event.getData();H(I);}
;}
,_onChangeDelegate:function(event){if(this._renderer!=null){this._renderer.dispose();this.removeBindings();}
;this._renderer=this.createRenderer();this._renderer.addListener(i,this._onItemCreated,this);}
,__sC:function(event){var K=event.getTarget();var L=K.getUserData(k);var J=this._tree.getLookupTable().getItem(L);if(event.getData()){this._tree.openNodeWithoutScrolling(J);}
else {this._tree.closeNodeWithoutScrolling(J);}
;}
...
,addSpacer:function(){if(!this.__sJ){this.__sJ=new qx.ui.core.Spacer();}
else {this._remove(this.__sJ);}
;this._add(this.__sJ);}
,addOpenButton:function(){this._add(this.getChildControl(l));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var L=this.getChildControl(t);if(this.__sI){this._remove(L);}
;this._add(L);this.__sI=true;}
,addLabel:function(M){var N=this.getChildControl(D);if(this.__sH){this._remove(N);}
;if(M){this.setLabel(M);}
else {N.setValue(this.getLabel());}
;this._add(N);this.__sH=true;}
,_applyIcon:function(P,O){if(!this.__sL()){this.__sM(P);}
else if(!this.isOpen()){this.__sM(P);}
;}
,_applyIconOpened:function(R,Q){if(this.isOpen()){if(this.__sK()&&this.__sL()){this.__sM(R);}
else if(!this.__sK()&&this.__sL()){this.__sM(R);}
;}
;}
...
;var X;if(W){X=this.__sL()?this.getIconOpened():null;}
else {X=this.getIcon();}
;if(X){this.__sM(X);}
;W?this.addState(u):this.removeState(u);}
,__sK:function(){return qx.util.PropertyUtil.getUserValue(this,t);}
,__sL:function(){return qx.util.PropertyUtil.getUserValue(this,v);}
,__sM:function(Y){var ba=this.getChildControl(t,true);if(ba){ba.setSource(Y);}
;}
...
;}
;if(this.__sJ){this.__sJ.setWidth((this.getLevel()+1)*this.getIndent()-bf);}
;}
...
(function(){var a="open",b="cell.childProperty",c="cell.level",d="qx.ui.tree.VirtualTreeItem",f="change",g="virtual-tree-folder",h="cell.showLeafs",i="changeLength";qx.Class.define(d,{extend:qx.ui.tree.core.AbstractItem,properties:{appearance:{refine:true,init:g}},members:{_forwardStates:{selected:true},_addWidgets:function(){this.addSpacer();this.addOpenButton();this.addIcon();this.addLabel();}
,_shouldShowOpenSymbol:function(){var open=this.getChildControl(a,true);if(open==null){return false;}
;return this.isOpenable();}
,getLevel:function(){return this.getUserData(c);}
,hasChildren:function(){var j=this.getModel();var l=this.getUserData(b);var k=this.getUserData(h);return qx.ui.tree.core.Util.hasChildren(j,l,!k);}
,_applyModel:function(p,m){var q=this.getUserData(b);var o=this.getUserData(h);if(p!=null&&qx.ui.tree.core.Util.isNode(p,q)){var n=f+qx.lang.String.firstUp(q);if(qx.Class.hasProperty(p.constructor,q)){p.addListener(n,this._onChangeChildProperty,this);}
;if(qx.ui.tree.core.Util.hasChildren(p,q,!o)){p.get(q).addListener(i,this._onChangeLength,this);this._updateIndent();}
;}
;if(m!=null&&qx.ui.tree.core.Util.isNode(m,q)){var n=f+qx.lang.String.firstUp(q);m.removeListener(n,this._onChangeChildProperty,this);var r=m.get(q);if(r){r.removeListener(i,this._onChangeLength,this);}
;}
;}
,_onChangeLength:function(){this._updateIndent();}
,_onChangeChildProperty:function(e){var t=e.getData();var s=e.getOldData();if(t){this._updateIndent();t.addListener(i,this._onChangeLength,this);}
;if(s){s.removeListener(i,this._onChangeLength,this);}
;}
}});}
)();
(function(){var a="qx.ui.tree.core.Util";qx.Class.define(a,{statics:{isNode:function(b,c){if(b==null||c==null){return false;}
;return qx.Class.hasProperty(b.constructor,c);}
,hasChildren:function(d,f,h){if(d==null||f==null||!this.isNode(d,f)){return false;}
;var g=d.get(f);if(g==null){return false;}
;if(!h){return g.length>0;}
else {for(var i=0;i<g.getLength();i++ ){var e=g.getItem(i);if(this.isNode(e,f)){return true;}
;}
;}
;return false;}
}});}
...
(function(){var a="source",b="changeLeadIcon",c="changeSize",d="changeMode",e="changeDate",f="checked",g="changeChecked",h="icon/16/places/user-desktop.png",i="value",j="size",k="leadIcon",l="date",m="mode",n="demobrowser.demo.virtual.tree.TreeItem",o="String",p="Boolean";qx.Class.define(n,{extend:qx.ui.tree.VirtualTreeItem,properties:{leadIcon:{check:o,event:b,nullable:true},checked:{check:p,event:g,nullable:true},size:{check:o,event:c,nullable:true},date:{check:o,event:e,nullable:true},mode:{check:o,event:d,nullable:true}},members:{__Go:null,__Gp:null,__Gq:null,__Gr:null,__jd:null,_addWidgets:function(){var q=this.__Go=new qx.ui.basic.Image();this.bind(k,q,a);q.setWidth(16);this.addWidget(q);this.addSpacer();this.addOpenButton();this.addIcon();this.setIcon(h);var r=this.__Gp=new qx.ui.form.CheckBox();this.bind(f,r,i);r.bind(i,this,f);r.setFocusable(false);r.setTriState(true);r.setMarginRight(4);this.addWidget(r);this.addLabel();this.addWidget(new qx.ui.core.Spacer(),{flex:1});var s=this.__Gq=new qx.ui.basic.Label();this.bind(j,s,i);s.setWidth(50);this.addWidget(s);s=this.__Gr=new qx.ui.basic.Label();this.bind(l,s,i);s.setWidth(150);this.addWidget(s);s=this.__jd=new qx.ui.basic.Label();this.bind(m,s,i);s.setWidth(80);this.addWidget(s);}
}});}
)();
...
(function(){var a=" array contains ",b="__dh",c="qx.ui.core.MSingleSelectionHandling",d=" items!",f="changeSelection",g="changeSelected",h="Could only select one item, but the selection",i="qx.event.type.Data";qx.Mixin.define(c,{events:{"changeSelection":i},members:{__dh:null,getSelection:function(){var j=this.__qs().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__qs().setSelected(k[0]);break;default:throw new Error(h+a+k.length+d);};}
,resetSelection:function(){this.__qs().resetSelected();}
,isSelected:function(l){return this.__qs().isSelected(l);}
,isSelectionEmpty:function(){return this.__qs().isSelectionEmpty();}
,getSelectables:function(m){return this.__qs().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(f,o,n);}
,__qs:function(){if(this.__dh==null){var p=this;this.__dh=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
,isItemSelectable:function(q){if(p._isItemSelectable){return p._isItemSelectable(q);}
else {return q.isVisible();}
;}
});this.__dh.addListener(g,this._onChangeSelected,this);}
;this.__dh.setAllowEmptySelection(this._isAllowEmptySelection());return this.__dh;}
},destruct:function(){this._disposeObjects(b);}
});}
)();
(function(){var a=", because it is not a child element!",b="Boolean",c="qx.ui.core.SingleSelectionManager",d="qx.debug",e="Invalid selectionProvider!",f="Could not check if ",g=" is selected,",h="__qu",j="Could not select ",k="__qv",l="changeSelected",m=" because it is not a child element!",n="__qt",o="qx.event.type.Data";qx.Class.define(c,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(d)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,e);}
;this.__qt=p;}
,events:{"changeSelected":o},properties:{allowEmptySelection:{check:b,init:true,apply:k}},members:{__qu:null,__qt:null,getSelected:function(){return this.__qu;}
,setSelected:function(q){if(!this.__qx(q)){throw new Error(j+q+a);}
;this.__qw(q);}
,resetSelected:function(){this.__qw(null);}
,isSelected:function(r){if(!this.__qx(r)){throw new Error(f+r+g+m);}
;return this.__qu===r;}
,isSelectionEmpty:function(){return this.__qu==null;}
,getSelectables:function(t){var s=this.__qt.getItems();var u=[];for(var i=0;i<s.length;i++ ){if(this.__qt.isItemSelectable(s[i])){u.push(s[i]);}
;}
;if(!t){for(var i=u.length-1;i>=0;i-- ){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__qv:function(w,v){if(!w){this.__qw(this.__qu);}
;}
,__qw:function(x){var A=this.__qu;var y=x;if(y!=null&&A===y){return;}
;if(!this.isAllowEmptySelection()&&y==null){var z=this.getSelectables(true)[0];if(z){y=z;}
;}
;this.__qu=y;this.fireDataEvent(l,y,A);}
,__qx:function(B){var C=this.__qt.getItems();for(var i=0;i<C.length;i++ ){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__qt.toHashCode){this._disposeObjects(n);}
else {this.__qt=null;}
...
(function(){var a="Could not set the model selection. Maybe your models are not unique? ",b="qx.ui.form.MModelSelection",c="Please use an array as parameter.",d="change",f="qx.debug",g="changeSelection",h="__qy",k="qx.event.type.Data";qx.Mixin.define(b,{construct:function(){this.__qy=new qx.data.Array();this.__qy.addListener(d,this.__qB,this);this.addListener(g,this.__qA,this);}
,events:{changeModelSelection:k},members:{__qy:null,__qz:false,__qA:function(){if(this.__qz){return;}
...
;}
;}
,__qB:function(){this.__qz=true;var r=this.getSelectables(true);var s=[];var q=this.__qy.toArray();for(var i=0;i<q.length;i++ ){var u=q[i];for(var j=0;j<r.length;j++ ){var v=r[j];var p=v.getModel?v.getModel():null;if(u===p){s.push(v);break;}
;}
;}
;this.setSelection(s);this.__qz=false;var t=this.getSelection();if(!qx.lang.Array.equals(t,s)){this.__qA();}
;}
,getModelSelection:function(){return this.__qy;}
,setModelSelection:function(w){if(!w){this.__qy.removeAll();return;}
;if(qx.core.Environment.get(f)){this.assertArray(w,c);}
;w.unshift(this.__qy.getLength());w.unshift(0);var x=this.__qy.splice.apply(this.__qy,w);x.dispose();}
...
;}
,_applyInvalidMessage:function(A,z){for(var i=0;i<this.__qC.length;i++ ){this.__qC[i].setInvalidMessage(A);}
;}
,_applyValid:function(C,B){for(var i=0;i<this.__qC.length;i++ ){this.__qC[i].setValid(C);}
;}
,_applyEnabled:function(F,E){var D=this.__qC;if(F==null){for(var i=0,l=D.length;i<l;i++ ){D[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var J=this.getSelection()[0];var K=this.__qC;var I=K.indexOf(J);if(I==-1){return;}
...
,selectPrevious:function(){var M=this.getSelection()[0];var N=this.__qC;var L=N.indexOf(M);if(L==-1){return;}
...
,__qD:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
