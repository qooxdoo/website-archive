...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List.2e9384d82183.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{selection:{check:d,event:n,apply:h,nullable:false,deferredInit:true},selectionMode:{check:[l,f,p,a],init:l,apply:o},dragSelection:{check:b,init:false,apply:k},quickSelection:{check:b,init:false,apply:m}},events:{"changeSelection":q},members:{_manager:null,__xe:false,__xf:false,__xd:null,_initSelectionManager:function(){var self=this;var r={isItemSelectable:function(s){return self._provider.isSelectable(s);}
...
,_onChangeSelection:function(e){if(this.__xf==true){return;}
;this.__xe=true;var G=this.getSelection();var I=[];for(var i=0;i<G.getLength();i++ ){var H=G.getItem(i);var J=this._getSelectables();var F=-1;if(J!=null){F=J.indexOf(H);}
...
;this.__xe=false;}
,_onManagerChangeSelection:function(e){if(this.__xe==true){return;}
;this.__xf=true;this.__xg();this.__xf=false;}
,__xg:function(){if(this.__xi()){return;}
;var M=this._manager.getSelection();var N=[];for(var i=0;i<M.length;i++ ){var O=this._getDataFromRow(M[i]);if(O!=null){N.push(O);}
;}
;this.__xh(N);}
,__xh:function(R){var Q=this.getSelection();if(R.length>0){var P=[0,Q.getLength()];P=P.concat(R);var S=Q.splice.apply(Q,P);S.dispose();}
else {Q.removeAll();}
;}
,__xi:function(){var U=this.getSelection();var W=this._manager.getSelection();if(U.getLength()!==W.length){return false;}
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__ub=[];this.__xk=[];this.__xl={};this.__xm=false;this.__xn=false;this.__xo=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__ub;}
,_lookup:function(Q){return this.__ub[Q];}
,_lookupGroup:function(R){return this.__xk.indexOf(R);}
,_reverseLookup:function(S){if(S<0){return -1;}
;return this.__ub.indexOf(S);}
...
,_applyGroupRowHeight:function(ba,Y){this.__xq();}
...
,_applyDelegate:function(bo,bn){this._provider.setDelegate(bo);this.__uq();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this._provider.removeBindings();this.__uq();this._applyDefaultSelection();}
,__xp:function(){this.getPane().getRowConfig().setItemCount(this.__ub.length);this.getPane().fullUpdate();}
,__xq:function(){var bp=this.getPane().getRowConfig();var bq=this.getGroupItemHeight();bp.resetItemSizes();if(bq){for(var i=0,l=this.__ub.length;i<l; ++i){if(this.__ub[i]==-1){bp.setItemSize(i,bq);}
;}
;}
;}
,__uq:function(){this.__ub=[];this.__xk=[];this.__xl={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var br=this.getModel();if(br!=null){this._runDelegateFilter(br);this._runDelegateSorter(br);this._runDelegateGroup(br);}
;this._updateSelection();this.__xq();this.__xp();}
,_runDelegateFilter:function(bt){var bs=qx.util.Delegate.getMethod(this.getDelegate(),D);for(var i=0,l=bt.length;i<l; ++i){if(bs==null||bs(bt.getItem(i))){this.__ub.push(i);}
;}
;}
,_runDelegateSorter:function(bu){if(this.__ub.length==0){return;}
;var bv=qx.util.Delegate.getMethod(this.getDelegate(),t);if(bv!=null){this.__ub.sort(function(a,b){return bv(bu.getItem(a),bu.getItem(b));}
);}
;}
,_runDelegateGroup:function(bz){var bA=qx.util.Delegate.getMethod(this.getDelegate(),v);if(bA!=null){for(var i=0,l=this.__ub.length;i<l; ++i){var bw=this.__ub[i];var by=this.getModel().getItem(bw);var bx=bA(by);this.__xr(bx,bw);}
;this.__ub=this.__xs();}
;}
,__xr:function(bC,bB){if(bC==null){this.__xo=true;bC=A;}
;var name=this.__xt(bC);if(this.__xl[name]==null){this.__xl[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bC);}
;}
;this.__xl[name].push(bB);}
,__xs:function(){this.__xu();var bG=[];var bI=0;var bE=this.getGroups();for(var i=0;i<bE.getLength();i++ ){var bD=bE.getItem(i);bG.push(-1);this.__xk.push(bI);bI++ ;var bH=this.__xt(bD);var bF=this.__xl[bH];if(bF!=null){for(var k=0;k<bF.length;k++ ){bG.push(bF[k]);bI++ ;}
;}
;}
;return bG;}
,__xt:function(bK){var name=null;if(!qx.lang.Type.isString(bK)){var bJ=this.getGroups().indexOf(bK);this.__xn=true;name=v;if(bJ==-1){name+=this.getGroups().getLength();}
else {name+=bJ;}
;}
else {this.__xm=true;var name=bK;}
;return name;}
,__xu:function(){if(this.__xn&&this.__xo||this.__xn&&this.__xm){throw new Error(r+z);}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__ub=this.__xk=this.__xl=null;if(this.__xj){this.__xj.dispose();}
;}
});}
)();
...
;var z=this._list.bind(w,t,x,v);this.__uB(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__xD(A,D,G);var H=F.bind(B,this._list,C,E);this.__uB(F,H);}
...
;}
,_removeBindingsFrom:function(T){var U=this.__xE(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
...
;return W;}
,__uB:function(bc,bd){var bb=this.__xE(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
;if(!qx.lang.Array.contains(this.__xC,bc)){this.__xC.push(bc);}
;}
,__xE:function(be){var bf=be.getUserData(m);if(bf==null){bf=[];be.setUserData(m,bf);}
;return bf;}
...
,styleSelectabled:function(v){var u=this.__xF(v);this._styleSelectabled(u);}
,styleUnselectabled:function(x){var w=this.__xF(x);this._styleUnselectabled(w);}
...
;}
,_styleSelectabled:function(A){this.__xG(A,{selected:1});}
,_styleUnselectabled:function(B){this.__xG(B,{});}
...
,__xF:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__xG:function(I,H){if(I==null){return;}
...
;this._cellProvider=h;this.__xH=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:c},members:{__xH:null,getRenderedCellWidget:function(q,n){if(this._getChildren().length===0){return null;}
...
;}
,_getSpacer:function(){var r=this.__xH.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(g,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(B,v,A,z){var C=this._cellProvider;var H=this._getChildren().concat();for(var i=0;i<H.length;i++ ){var F=H[i];if(F.getUserData(g)){this.__xH.push(F);}
...
;}
;}
;var L=this._cellProvider;var P=this._getChildren().concat();for(var i=0;i<P.length;i++ ){if(!bb[i]){var W=P[i];if(W.getUserData(g)){this.__xH.push(W);}
...
;this._cellProvider=this.__xH=null;}
});}
)();
...
;}
;j.setUserData(c,h);}
,getCellWidget:function(o,m){var n=this.__xI();this.updateStates(n,m);this.updateData(n,o);return n;}
,pool:function(p){this.__cX.push(p);}
,_cleanupPool:function(){var q=this.__cX.pop();while(q){q.destroy();q=this.__cX.pop();}
;}
,__xI:function(){var r=this.__cX.shift();if(r==null){r=this._createWidget();this.fireDataEvent(a,r);}
;return r;}
