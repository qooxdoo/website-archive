...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.List.bd9cd2e5519c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__ue=[];this.__xn=[];this.__xo={};this.__xp=false;this.__xq=false;this.__xr=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__ue;}
,_lookup:function(Q){return this.__ue[Q];}
,_lookupGroup:function(R){return this.__xn.indexOf(R);}
,_reverseLookup:function(S){if(S<0){return -1;}
;return this.__ue.indexOf(S);}
...
,_applyDelegate:function(bo,bn){this._provider.setDelegate(bo);this.__ut();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this._provider.removeBindings();this.__ut();this._applyDefaultSelection();}
,__xs:function(){this.getPane().getRowConfig().setItemCount(this.__ue.length);this.getPane().fullUpdate();}
,__xt:function(){var bp=this.getPane().getRowConfig();var bq=this.getGroupItemHeight();bp.resetItemSizes();if(bq){for(var i=0,l=this.__ue.length;i<l; ++i){if(this.__ue[i]==-1){bp.setItemSize(i,bq);}
;}
;}
;}
,__ut:function(){this.__ue=[];this.__xn=[];this.__xo={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
...
,_runDelegateFilter:function(bt){var bs=qx.util.Delegate.getMethod(this.getDelegate(),D);for(var i=0,l=bt.length;i<l; ++i){if(bs==null||bs(bt.getItem(i))){this.__ue.push(i);}
;}
;}
,_runDelegateSorter:function(bu){if(this.__ue.length==0){return;}
;var bv=qx.util.Delegate.getMethod(this.getDelegate(),t);if(bv!=null){this.__ue.sort(function(a,b){return bv(bu.getItem(a),bu.getItem(b));}
);}
;}
,_runDelegateGroup:function(bz){var bA=qx.util.Delegate.getMethod(this.getDelegate(),v);if(bA!=null){for(var i=0,l=this.__ue.length;i<l; ++i){var bw=this.__ue[i];var by=this.getModel().getItem(bw);var bx=bA(by);this.__xu(bx,bw);}
;this.__ue=this.__xv();}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__ue=this.__xn=this.__xo=null;if(this.__xm){this.__xm.dispose();}
;}
});}
)();
