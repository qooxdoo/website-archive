...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Dynamic.ceb98824fc0d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_init:function(){this.__uf=new qx.data.Array();this.__Cz=[];this.__CA=[];this._initLayer();}
...
,this);}
,getLookupTable:function(){return this.__uf;}
,_reverseLookup:function(bp){return bp;}
,_getDataFromRow:function(bq){return this.__uf.getItem(bq);}
,_getSelectables:function(){return this.__uf;}
...
;}
;if(this.__uf.indexOf(bV)!=-1){this.__CC();}
;}
;}
,_onUpdated:function(event){if(this.__ht==null){this.__ht=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__ht.schedule();}
,_onOpen:function(event){var ca=event.getRow();var bY=this.__uf.getItem(ca);if(this.isNode(bY)){if(this.isNodeOpen(bY)){this.closeNode(bY);}
...
;}
;if(!qx.lang.Array.equals(this.__uf.toArray(),cm)){this._provider.removeBindings();this.__uf.removeAll();this.__uf.append(cm);this.__xs();this._updateSelection();}
;}
...
;}
;return false;}
,__xs:function(){this.getPane().getRowConfig().setItemCount(this.__uf.getLength());this.getPane().fullUpdate();}
,getParent:function(cD){var cE=this.__uf.indexOf(cD);if(cE<0){return null;}
;var cF=this.__CA[cE];while(cE>0){cE-- ;var cC=this.__CA[cE];if(cC<cF){return this.__uf.getItem(cE);}
;}
;return null;}
...
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__ht!=null){this.__ht.cancel();this.__ht.dispose();}
;var cI=this.getModel();if(cI!=null){cI.removeListener(J,this._onChangeBubble,this);}
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__uf.dispose();this._layer=this._provider=this.__uf=this.__Cz=this.__ht=null;}
});}
)();
...
(function(){var a="BindingIds",b="model",c="",d="changeDelegate",f="virtual-tree-file",g="label",h="appearance",i="icon",j="bindItem",k=".length",l="]",m="virtual-tree-folder",n="[",o=".",p="String",q="qx.ui.tree.core.MWidgetController";qx.Mixin.define(q,{construct:function(){this.__xF=[];}
,properties:{labelPath:{check:p,nullable:true},iconPath:{check:p,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},childProperty:{check:p,nullable:true},delegate:{event:d,init:null,nullable:true}},members:{__xF:null,bindDefaultProperties:function(u,s){this.bindProperty(c,b,null,u,s);this.bindProperty(this.getLabelPath(),g,this.getLabelOptions(),u,s);var r=this.__xG(s);var t=this._tree.getLookupTable();t=qx.data.SingleValueBinding.resolvePropertyChain(t,r);if(qx.util.OOUtil.hasProperty(t.constructor,this.getChildProperty())){this.bindProperty(this.getChildProperty()+k,h,{converter:function(){return m;}
},u,s);}
else {u.setAppearance(f);}
;if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),i,this.getIconOptions(),u,s);}
;}
,bindProperty:function(y,B,z,x,v){var A=this.__xG(v,y);var w=this._tree.getLookupTable();var C=w.bind(A,x,B,z);this.__uE(x,C);}
,bindPropertyReverse:function(J,F,H,I,D){var G=this.__xG(D,J);var E=this._tree.getLookupTable();var K=I.bind(F,E,G,H);this.__uE(I,K);}
,removeBindings:function(){while(this.__xF.length>0){var L=this.__xF.pop();this._removeBindingsFrom(L);}
;}
...
;}
,_removeBindingsFrom:function(P){var Q=this.__xH(P);while(Q.length>0){var R=Q.pop();try{this._tree.getLookupTable().removeBinding(R);}
catch(e){P.removeBinding(R);}
;}
;if(qx.lang.Array.contains(this.__xF,P)){qx.lang.Array.remove(this.__xF,P);}
;}
,__xG:function(T,U){var S=n+T+l;if(U!=null&&U!=c){S+=o+U;}
;return S;}
,__uE:function(W,X){var V=this.__xH(W);if(!qx.lang.Array.contains(V,X)){V.push(X);}
;if(!qx.lang.Array.contains(this.__xF,W)){this.__xF.push(W);}
;}
,__xH:function(Y){var ba=Y.getUserData(a);if(ba==null){ba=[];Y.setUserData(a,ba);}
;return ba;}
