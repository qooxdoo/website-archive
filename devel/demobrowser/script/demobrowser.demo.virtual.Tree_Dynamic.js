...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Dynamic.612135372c3b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_init:function(){this.__ue=new qx.data.Array();this.__Cz=[];this.__CA=[];this._initLayer();}
...
,this);}
,getLookupTable:function(){return this.__ue;}
,_reverseLookup:function(bp){return bp;}
,_getDataFromRow:function(bq){return this.__ue.getItem(bq);}
,_getSelectables:function(){return this.__ue;}
...
;}
;if(this.__ue.indexOf(bV)!=-1){this.__CC();}
;}
;}
,_onUpdated:function(event){if(this.__ht==null){this.__ht=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__ht.schedule();}
,_onOpen:function(event){var ca=event.getRow();var bY=this.__ue.getItem(ca);if(this.isNode(bY)){if(this.isNodeOpen(bY)){this.closeNode(bY);}
...
;}
;if(!qx.lang.Array.equals(this.__ue.toArray(),cm)){this._provider.removeBindings();this.__ue.removeAll();this.__ue.append(cm);this.__xs();this._updateSelection();}
;}
...
;}
;return false;}
,__xs:function(){this.getPane().getRowConfig().setItemCount(this.__ue.getLength());this.getPane().fullUpdate();}
,getParent:function(cD){var cE=this.__ue.indexOf(cD);if(cE<0){return null;}
;var cF=this.__CA[cE];while(cE>0){cE-- ;var cC=this.__CA[cE];if(cC<cF){return this.__ue.getItem(cE);}
;}
;return null;}
...
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__ue.dispose();this._layer=this._provider=this.__ue=this.__Cz=this.__ht=null;}
});}
)();
