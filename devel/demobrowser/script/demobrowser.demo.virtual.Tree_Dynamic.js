...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Tree_Dynamic.27c0c8300f20.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_init:function(){this.__uf=new qx.data.Array();this.__Cx=[];this.__Cy=[];this._initLayer();}
...
;}
;if(this.__uf.indexOf(bV)!=-1){this.__CA();}
;}
;}
,_onUpdated:function(event){if(this.__hx==null){this.__hx=new qx.util.DeferredCall(function(){qx.ui.core.queue.Widget.add(this);}
,this);}
;this.__hx.schedule();}
...
;var cF=this.__Cy[cE];while(cE>0){cE-- ;var cC=this.__Cy[cE];if(cC<cF){return this.__uf.getItem(cE);}
;}
;return null;}
...
;}
;if(!qx.core.ObjectRegistry.inShutDown&&this.__hx!=null){this.__hx.cancel();this.__hx.dispose();}
;var cI=this.getModel();if(cI!=null){cI.removeListener(J,this._onChangeBubble,this);}
;this._layer.removeListener(R,this._onUpdated,this);this._layer.destroy();this._provider.dispose();this.__uf.dispose();this._layer=this._provider=this.__uf=this.__Cx=this.__hx=null;}
});}
)();
