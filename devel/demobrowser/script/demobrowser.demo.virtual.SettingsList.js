...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SettingsList.aa338383d41d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__ug=[];this.__xn=[];this.__xo={};this.__xp=false;this.__xq=false;this.__xr=false;this.getPane().addListener(d,this._onResize,this);this._initBackground();this._initLayer();}
...
;}
,_getLookupTable:function(){return this.__ug;}
,_lookup:function(Q){return this.__ug[Q];}
,_lookupGroup:function(R){return this.__xn.indexOf(R);}
,_reverseLookup:function(S){if(S<0){return -1;}
;return this.__ug.indexOf(S);}
...
,_applyDelegate:function(bo,bn){this._provider.setDelegate(bo);this.__uv();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this._provider.removeBindings();this.__uv();this._applyDefaultSelection();}
,__xs:function(){this.getPane().getRowConfig().setItemCount(this.__ug.length);this.getPane().fullUpdate();}
,__xt:function(){var bp=this.getPane().getRowConfig();var bq=this.getGroupItemHeight();bp.resetItemSizes();if(bq){for(var i=0,l=this.__ug.length;i<l; ++i){if(this.__ug[i]==-1){bp.setItemSize(i,bq);}
;}
;}
;}
,__uv:function(){this.__ug=[];this.__xn=[];this.__xo={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
...
,_runDelegateFilter:function(bt){var bs=qx.util.Delegate.getMethod(this.getDelegate(),D);for(var i=0,l=bt.length;i<l; ++i){if(bs==null||bs(bt.getItem(i))){this.__ug.push(i);}
;}
;}
,_runDelegateSorter:function(bu){if(this.__ug.length==0){return;}
;var bv=qx.util.Delegate.getMethod(this.getDelegate(),t);if(bv!=null){this.__ug.sort(function(a,b){return bv(bu.getItem(a),bu.getItem(b));}
);}
;}
,_runDelegateGroup:function(bz){var bA=qx.util.Delegate.getMethod(this.getDelegate(),v);if(bA!=null){for(var i=0,l=this.__ug.length;i<l; ++i){var bw=this.__ug[i];var by=this.getModel().getItem(bw);var bx=bA(by);this.__xu(bx,bw);}
;this.__ug=this.__xv();}
;}
...
;this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__ug=this.__xn=this.__xo=null;if(this.__xm){this.__xm.dispose();}
;}
});}
)();
...
;var z=this._list.bind(w,t,x,v);this.__uF(t,z);}
,bindPropertyReverse:function(D,B,E,F,A){var G=F.getUserData(a);var C=this.__xG(A,D,G);var H=F.bind(B,this._list,C,E);this.__uF(F,H);}
...
;return W;}
,__uF:function(bc,bd){var bb=this.__xH(bc);if(!qx.lang.Array.contains(bb,bd)){bb.push(bd);}
