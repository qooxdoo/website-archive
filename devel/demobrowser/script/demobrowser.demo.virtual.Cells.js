...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells.15777ea957e9.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:e},iconTrue:{check:d,themeable:true,apply:c},iconFalse:{check:d,themeable:true,apply:a}},members:{__Cp:null,__Cq:null,__AA:null,_applyIconTrue:function(f){this.__Cp=this.__AA.resolve(f);}
,_applyIconFalse:function(g){this.__Cq=this.__AA.resolve(g);}
