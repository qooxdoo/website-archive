...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.TreeController.29cbb910e91c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="ecmascript.string.startsWith",b="function",c="ecmascript.array.indexof",d="qx.bom.client.EcmaScript",f="ecmascript.array.foreach",g="ecmascript.array.findIndex",h="ecmascript.array.reduceright",i="stack",j="ecmascript.array.map",k="ecmascript.object.keys",l="ecmascript.string.trim",m="ecmascript.array.reduce",n="ecmascript.array.every",o="ecmascript.array.filter",p="[object Error]",q="ecmascript.string.endsWith",r="ecmascript.array.some",s="stacktrace",t="ecmascript.error.toString",u="ecmascript.function.bind",v="ecmascript.array.lastindexof",w="ecmascript.array.find",x="e",y="ecmascript.error.stacktrace",z="ecmascript.date.now";qx.Bootstrap.define(d,{statics:{getStackTrace:function(){var A;var e=new Error(x);A=e.stack?i:e.stacktrace?s:null;if(!A){try{throw e;}
catch(B){e=B;}
;}
;return e.stacktrace?s:e.stack?i:null;}
...
},defer:function(C){qx.core.Environment.add(c,C.getArrayIndexOf);qx.core.Environment.add(v,C.getArrayLastIndexOf);qx.core.Environment.add(f,C.getArrayForEach);qx.core.Environment.add(o,C.getArrayFilter);qx.core.Environment.add(j,C.getArrayMap);qx.core.Environment.add(r,C.getArraySome);qx.core.Environment.add(w,C.getArrayFind);qx.core.Environment.add(g,C.getArrayFindIndex);qx.core.Environment.add(n,C.getArrayEvery);qx.core.Environment.add(m,C.getArrayReduce);qx.core.Environment.add(h,C.getArrayReduceRight);qx.core.Environment.add(z,C.getDateNow);qx.core.Environment.add(t,C.getErrorToString);qx.core.Environment.add(y,C.getStackTrace);qx.core.Environment.add(u,C.getFunctionBind);qx.core.Environment.add(k,C.getObjectKeys);qx.core.Environment.add(a,C.getStringStartsWith);qx.core.Environment.add(q,C.getStringEndsWith);qx.core.Environment.add(l,C.getStringTrim);}
});}
)();
...
;}
;}
else if(qx.bom.client.Engine.__s()){if(/Opera[\s\/]([0-9]+)\.([0-9])([0-9]*)/.test(A)){if(A.indexOf(g)!=-1){var D=A.match(/Version\/(\d+)\.(\d+)/);B=D[1]+w+D[2].charAt(0)+w+D[2].substring(1,D[2].length);}
else {B=RegExp.$1+w+RegExp.$2;if(RegExp.$3!=o){B+=w+RegExp.$3;}
;}
;}
;}
else if(qx.bom.client.Engine.__t()){if(/AppleWebKit\/([^ ]+)/.test(A)){B=RegExp.$1;var C=RegExp(c).exec(B);if(C){B=B.slice(0,C.index);}
;}
;}
else if(qx.bom.client.Engine.__u()){if(/rv\:([^\);]+)(\)|;)/.test(A)){B=RegExp.$1;}
;}
else {var y=window.qxFail;if(y&&typeof y===b){B=y().FULLVERSION;}
else {B=f;qx.Bootstrap.warn(n+A+r);}
;}
;return B;}
,getName:function(){var name;if(qx.bom.client.Engine.__v()){name=s;}
else if(qx.bom.client.Engine.__s()){name=p;}
else if(qx.bom.client.Engine.__t()){name=u;}
else if(qx.bom.client.Engine.__u()){name=e;}
else {var E=window.qxFail;if(E&&typeof E===b){name=E().NAME;}
else {name=e;qx.Bootstrap.warn(n+window.navigator.userAgent+r);}
;}
;return name;}
,__s:function(){return window.opera&&Object.prototype.toString.call(window.opera)==a;}
,__t:function(){return window.navigator.userAgent.indexOf(l)!=-1;}
,__u:function(){return (window.navigator.mozApps||window.navigator.buildID)&&window.navigator.product===k&&window.navigator.userAgent.indexOf(m)==-1;}
,__v:function(){if(window.navigator.cpuClass&&(/MSIE\s+([^\);]+)(\)|;)/.test(window.navigator.userAgent)||/Trident\/\d+?\.\d+?/.test(window.navigator.userAgent))){return true;}
;if(qx.bom.client.Engine.__w()){return true;}
;return false;}
,__w:function(){return window.navigator.userAgent.indexOf(q)>-1;}
...
(function(){var a="qx.globalErrorHandling",b="qx.event.GlobalError";qx.Bootstrap.define(b,{statics:{__x:null,__y:null,__z:null,__A:function(){if(qx.core&&qx.core.Environment){return qx.core.Environment.get(a);}
else {return !!qx.Bootstrap.getEnvironmentSetting(a);}
;}
,setErrorHandler:function(c,d){this.__x=c||null;this.__z=d||window;if(this.__A()){if(c&&window.onerror){var e=qx.Bootstrap.bind(this.__B,this);if(this.__y==null){this.__y=window.onerror;}
;var self=this;window.onerror=function(f,g,h){self.__y(f,g,h);e(f,g,h);}
;}
;if(c&&!window.onerror){window.onerror=qx.Bootstrap.bind(this.__B,this);}
;if(this.__x==null){if(this.__y!=null){window.onerror=this.__y;this.__y=null;}
else {window.onerror=null;}
;}
;}
;}
,__B:function(i,j,k){if(this.__x){this.handleError(new qx.core.WindowError(i,j,k));}
;}
,observeMethod:function(l){if(this.__A()){var self=this;return function(){if(!self.__x){return l.apply(this,arguments);}
...
;}
,handleError:function(n){if(this.__x){this.__x.call(this.__z,n);}
;}
...
;this.__C=c;this.__D=e||a;this.__E=f===undefined?-1:f;}
,members:{__C:null,__D:null,__E:null,toString:function(){return this.__C;}
,getUri:function(){return this.__D;}
,getLineNumber:function(){return this.__E;}
}});}
)();
...
;this.__C=a+(e&&e.message?e.message:e);var d=Error.call(this,this.__C);if(d.stack){this.stack=d.stack;}
;if(d.stacktrace){this.stacktrace=d.stacktrace;}
;this.__F=c;this.__G=e;}
,members:{__G:null,__F:null,__C:null,toString:function(){return this.__C;}
,getArguments:function(){return this.__F;}
,getSourceException:function(){return this.__G;}
},destruct:function(){this.__G=null;this.__F=null;this.__C=null;}
});}
)();
(function(){var c="-",d="qx.debug.dispose",e="",f="qx.core.ObjectRegistry",g="qx.debug",h="$$hash",j="-0",k="Invalid object: ",m="Could not dispose object ",n=" objects",o=": ",p="Disposed ";qx.Bootstrap.define(f,{statics:{inShutDown:false,__H:{},__I:0,__J:[],__K:e,__L:{},register:function(q){var t=this.__H;if(!t){return;}
;var s=q.$$hash;if(s==null){var r=this.__J;if(r.length>0&&!qx.core.Environment.get(d)){s=r.pop();}
else {s=(this.__I++ )+this.__K;}
;q.$$hash=s;if(qx.core.Environment.get(d)){if(qx.dev&&qx.dev.Debug&&qx.dev.Debug.disposeProfilingActive){this.__L[s]=qx.dev.StackTrace.getStackTrace();}
;}
;}
...
;var w=this.__H;if(w&&w[v]){delete w[v];this.__J.push(v);}
;try{delete u.$$hash;}
...
;var z=this.__J;if(z.length>0){y=z.pop();}
else {y=(this.__I++ )+this.__K;}
;return A.$$hash=y;}
,clearHashCode:function(C){if(qx.core.Environment.get(g)){if(C==null){throw new Error(k+C);}
;}
;var B=C.$$hash;if(B!=null){this.__J.push(B);try{delete C.$$hash;}
catch(D){if(C.removeAttribute){C.removeAttribute(h);}
;}
;}
;}
,fromHashCode:function(E){return this.__H[E]||null;}
,shutdown:function(){this.inShutDown=true;var G=this.__H;var I=[];for(var F in G){I.push(F);}
...
;}
;break;}
;qx.Bootstrap.debug(this,p+l+n);delete this.__H;}
,getRegistry:function(){return this.__H;}
,getNextHash:function(){return this.__I;}
,getPostId:function(){return this.__K;}
,getStackTraces:function(){return this.__L;}
},defer:function(K){if(window&&window.top){var frames=window.top.frames;for(var i=0;i<frames.length;i++ ){if(frames[i]===window){K.__K=c+(i+1);return;}
;}
;}
;K.__K=j;}
});}
...
;return O;}
,__M:{"Windows NT 10.0":H,"Windows NT 6.3":M,"Windows NT 6.2":J,"Windows NT 6.1":n,"Windows NT 6.0":I,"Windows NT 5.2":h,"Windows NT 5.1":Y,"Windows NT 5.0":L,"Windows 2000":L,"Windows NT 4.0":by,"Win 9x 4.90":A,"Windows CE":m,"Windows 98":F,"Win98":F,"Windows 95":u,"Win95":u,"Mac OS X 10_10":bo,"Mac OS X 10.10":bo,"Mac OS X 10_9":r,"Mac OS X 10.9":r,"Mac OS X 10_8":w,"Mac OS X 10.8":w,"Mac OS X 10_7":g,"Mac OS X 10.7":g,"Mac OS X 10_6":R,"Mac OS X 10.6":R,"Mac OS X 10_5":p,"Mac OS X 10.5":p,"Mac OS X 10_4":U,"Mac OS X 10.4":U,"Mac OS X 10_3":d,"Mac OS X 10.3":d,"Mac OS X 10_2":B,"Mac OS X 10.2":B,"Mac OS X 10_1":b,"Mac OS X 10.1":b,"Mac OS X 10_0":T,"Mac OS X 10.0":T},getVersion:function(){var bC=qx.bom.client.OperatingSystem.__N(navigator.userAgent);if(bC==null){bC=qx.bom.client.OperatingSystem.__O(navigator.userAgent);}
;if(bC!=null){return bC;}
else {return O;}
;}
,__N:function(bD){var bG=[];for(var bF in qx.bom.client.OperatingSystem.__M){bG.push(bF);}
;var bH=new RegExp(N+bG.join(s).replace(/\./g,x)+i,bt);var bE=bH.exec(bD);if(bE&&bE[1]){return qx.bom.client.OperatingSystem.__M[bE[1]];}
;return null;}
,__O:function(bN){var bI=bN.indexOf(e)!=-1;var bO=bN.indexOf(D)!=-1;var bJ=bN.match(/(iPad|iPhone|iPod)/i)?true:false;if(bI){var bQ=new RegExp(/Windows Phone (\d+(?:\.\d+)+)/i);var bL=bQ.exec(bN);if(bL&&bL[1]){return bL[1];}
;}
...
;}
;return name;}
,getVersion:function(){var P=navigator.userAgent;var Q=new RegExp(x+qx.bom.client.Browser.__P+l);var N=P.match(Q);if(!N){return v;}
...
;}
,__P:{"webkit":g,"gecko":n,"mshtml":o,"opera":D}[qx.bom.client.Engine.getName()]},defer:function(R){qx.core.Environment.add(i,R.getName);qx.core.Environment.add(y,R.getVersion);qx.core.Environment.add(G,R.getDocumentMode);qx.core.Environment.add(h,R.getQuirksMode);}
});}
)();
...
;}
;if(!(cK={}.hasOwnProperty)){cK=function(dt){var du={},dv;if((du.__Q=null,du.__Q={"toString":1},du).toString!=cv){cK=function(dw){var dx=this.__Q,dy=dw in (this.__Q=null,this);this.__Q=dx;return dy;}
;}
...
;if(qx.core.Environment.get(J)){this.__V(name,M);}
...
,$$registry:{},__U:qx.core.Environment.select(J,{"true":{"include":K,"statics":K,"members":K,"properties":K,"events":K,"destruct":d,"construct":d},"default":null}),__V:qx.core.Environment.select(J,{"true":function(name,bf){var be=this.__U;for(var bd in bf){if(!be[bd]){throw new Error(h+bd+D+name+k);}
...
(function(){var a="qx.core.Aspect",b="before",c="*",d="static";qx.Bootstrap.define(a,{statics:{__H:[],wrap:function(h,l,j){var m=[];var e=[];var k=this.__H;var g;for(var i=0;i<k.length;i++ ){g=k[i];if((g.type==null||j==g.type||g.type==c)&&(g.name==null||h.match(g.name))){g.pos==-1?m.push(g.fcn):e.push(g.fcn);}
;}
...
,addAdvice:function(q,o,p,name){this.__H.push({fcn:q,pos:o===b?-1:1,type:p,name:name});}
}});}
)();
...
;if(qx.core.Environment.get(u)){this.__V(name,X);}
...
;}
;return Y;}
,__W:function(be,bf,bb,bi,bg){var bc=bb.$$members;if(bc){for(var bh in bc){if(qx.Bootstrap.isFunction(bc[bh])){var bk=this.__X(bf,bh);var bd=bk||qx.Bootstrap.isFunction(be[bh]);if(!bd){if(bg){throw new Error(k+bh+o+bf.classname+M+bb.name+m);}
else {return false;}
;}
;var bj=bi===true&&!bk&&!qx.util.OOUtil.hasInterface(bf,bb);if(bj){be[bh]=this.__bb(bb,be[bh],bh,bc[bh]);}
;}
...
;if(!bg){return true;}
;}
,__X:function(bo,bl){var bq=bl.match(/^(is|toggle|get|set|reset)(.*)$/);if(!bq){return false;}
...
;return true;}
,__Y:function(bu,br,bs){if(br.$$properties){for(var bt in br.$$properties){if(!qx.util.OOUtil.getPropertyDefinition(bu,bt)){if(bs){throw new Error(g+bt+J+bu.classname+z);}
else {return false;}
;}
;}
;}
;if(!bs){return true;}
;}
,__ba:function(by,bv,bw){if(bv.$$events){for(var bx in bv.$$events){if(!qx.util.OOUtil.supportsEvent(by,bx)){if(bw){throw new Error(w+bx+J+by.classname+z);}
else {return false;}
;}
;}
;}
;if(!bw){return true;}
;}
,assertObject:function(bB,bz){var bC=bB.constructor;this.__W(bB,bC,bz,false,true);this.__Y(bC,bz,true);this.__ba(bC,bz,true);var bA=bz.$$extends;if(bA){for(var i=0,l=bA.length;i<l;i++ ){this.assertObject(bB,bA[i]);}
;}
;}
,assert:function(bF,bD,bG){this.__W(bF.prototype,bF,bD,bG,true);this.__Y(bF,bD,true);this.__ba(bF,bD,true);var bE=bD.$$extends;if(bE){for(var i=0,l=bE.length;i<l;i++ ){this.assert(bF,bE[i],bG);}
;}
;}
,objectImplements:function(bJ,bH){var bK=bJ.constructor;if(!this.__W(bJ,bK,bH)||!this.__Y(bK,bH)||!this.__ba(bK,bH)){return false;}
;var bI=bH.$$extends;if(bI){for(var i=0,l=bI.length;i<l;i++ ){if(!this.objectImplements(bJ,bI[i])){return false;}
;}
;}
;return true;}
,classImplements:function(bN,bL){if(!this.__W(bN.prototype,bN,bL)||!this.__Y(bN,bL)||!this.__ba(bN,bL)){return false;}
...
,$$registry:{},__bb:qx.core.Environment.select(u,{"true":function(bR,bP,bS,bO){function bQ(){bO.apply(this,arguments);return bP.apply(this,arguments);}
;bP.wrapper=bQ;return bQ;}
,"default":function(bV,bU,bW,bT){}
}),__U:qx.core.Environment.select(u,{"true":{"extend":V,"statics":V,"members":V,"properties":V,"events":V},"default":null}),__V:qx.core.Environment.select(u,{"true":function(name,cb){if(qx.core.Environment.get(u)){var ca=this.__U;for(var bY in cb){if(ca[bY]===undefined){throw new Error(f+bY+B+name+h);}
...
;}
,__bj:function(clazz,config,name){var upname=qx.Bootstrap.firstUp(name);var members=clazz.prototype;if(qx.core.Environment.get(dn)){if(qx.core.Environment.get(dc)>1){qx.Bootstrap.debug(dk+name);}
;}
;if(config.dereference===undefined&&typeof config.check===bq){config.dereference=this.__bk(config.check);}
...
;}
,__bk:function(er){return !!this.__be[er];}
,__bl:{'0':ea,'1':bN,'2':H,'3':cs,'4':dq,'5':Y},error:function(es,ez,ey,et,eu){var ev=es.constructor.classname;var ew=s+ey+bi+ev+E+this.$$method[et][ey]+dQ+eu+bh;throw new Error(ew+(this.__bl[ez]||df+ez));}
,__bm:function(eD,eE,name,eC,eA,eB){var eF=this.__bn(eD,eE,name,eC,eA,eB);if(eB===undefined){return eF.call(eD);}
else if(qx.core.Environment.get(dn)){return eF.apply(eD,eB);}
else {return eF.call(eD,eB[0]);}
;}
,__bn:function(instance,members,name,variant,code,args){var store=this.$$method[variant][name];if(qx.core.Environment.get(dn)){if(qx.core.Environment.get(dc)>1){qx.Bootstrap.debug(bv+this.$$method[variant][name]+R+code.join(dA));}
...
,executeOptimizedGetter:function(eK,eJ,name,eI){var eH=this.__bo(eK,eJ,name,eI);var eL=eJ.prototype;return this.__bm(eK,eL,name,eI,eH);}
,installOptimizedGetter:function(eP,eO,name,eN){var eM=this.__bo(eP,eO,name,eN);var eQ=eO.prototype;this.__bn(eP,eQ,name,eN,eM);}
,__bo:function(eU,eT,name,eS){var eV=eT.$$properties[name];var eR=[];var eW=this.$$store;eR.push(U,eW.runtime[name],bY);eR.push(V,eW.runtime[name],h);if(eV.inheritable){eR.push(W,eW.inherit[name],bY);eR.push(V,eW.inherit[name],h);eR.push(L);}
...
;return eR;}
,executeOptimizedSetter:function(fc,fb,name,fa,eY){var eX=this.__bp(fc,fb,name,fa,eY);var fd=fb.prototype;return this.__bm(fc,fd,name,fa,eX,eY);}
,installOptimizedSetter:function(fi,fh,name,fg,ff){var fe=this.__bp(fi,fh,name,fg,ff);var fj=fh.prototype;return this.__bn(fi,fj,name,fg,fe,ff);}
,__bp:function(fr,fq,name,fp,fo){var ft=fq.$$properties[name];var fs=fq.prototype;var fl=[];var fk=fp===f||fp===bS||fp===cn||(fp===dh&&ft.init===undefined);var fm=ft.apply||ft.event||ft.inheritable;var fu=this.__bq(fp,name);this.__br(fl,fq,ft,name);this.__bs(fl,ft,name,fp,fk);if(fk){this.__bt(fl,fq,ft,name);}
;if(fm){this.__bu(fl,fk,fu,fp);}
;if(ft.inheritable){fl.push(bD);}
;if(qx.core.Environment.get(dn)){if(fk){this.__bv(fl,ft,fq,name,fp);}
;}
;if(!fm){this.__bw(fl,name,fp,fk);}
else {this.__bx(fl,ft,name,fp,fk);}
;if(ft.inheritable){this.__by(fl,ft,name,fp);}
else if(fm){this.__bz(fl,ft,name,fp);}
;if(fm){this.__bA(fl,ft,name,fp);if(ft.inheritable&&fs._getChildren){this.__bB(fl,name);}
;}
;if(fk){fl.push(co);}
;return fl;}
,__bq:function(fv,name){if(fv===cn||fv===bg){var fw=this.$$store.runtime[name];}
else if(fv===bS||fv===j){fw=this.$$store.theme[name];}
else if(fv===dh){fw=this.$$store.init[name];}
else {fw=this.$$store.user[name];}
;return fw;}
,__br:function(fx,fA,fy,name){fx.push(bV);if(typeof fy.isEqual===g){fx.push(bo,fA.classname,cy,name,cj);}
...
;}
,__bs:function(fD,fB,name,fE,fC){if(qx.core.Environment.get(dn)){fD.push(dK);if(fE===dh){fD.push(bT,name,by,fE,bO);}
;if(fE===dI){}
...
;}
;}
,__bt:function(fF,fH,fG,name){if(fG.transform){fF.push(bw,fG.transform,bI);}
...
;}
;}
,__bu:function(fJ,fI,fL,fK){var fM=(fK===bp||fK===j||fK===bg);if(fI){fJ.push(dE,fL,S);}
else if(fM){fJ.push(U,fL,bk);}
;}
,__bv:qx.core.Environment.select(dn,{"true":function(fO,fN,fQ,name,fP){if(!fN.nullable){fO.push(bX,name,by,fP,bO);}
;if(fN.check!==undefined){fO.push(c+name+de+fQ.classname+ct);if(fN.nullable){fO.push(cA);}
;if(fN.inheritable){fO.push(dr);}
;fO.push(J);if(this.__bd[fN.check]!==undefined){fO.push(dj,this.__bd[fN.check],dR);}
...
;}
,"false":undefined}),__bw:function(fS,name,fT,fR){if(fT===cn){fS.push(bM,this.$$store.runtime[name],cE);}
...
;}
,__bx:function(fW,fU,name,fX,fV){if(fU.inheritable){fW.push(bc,this.$$store.inherit[name],h);}
else {fW.push(cS);}
...
;fW.push(cV);}
;}
,__by:function(ga,fY,name,gb){ga.push(cd);if(gb===dI){ga.push(bP);}
...
;if(qx.core.Environment.get(dF)){try{this.__V(name,dS);}
catch(dT){if(dP){dT.message=B+dT.message;}
;throw dT;}
;}
;var dQ=this.__bF(name,dS.type,dS.extend,dS.statics,dS.construct,dS.destruct,dS.include);if(dS.extend){if(dS.properties){this.__bH(dQ,dS.properties,true);}
;if(dS.members){this.__bJ(dQ,dS.members,true,true,false);}
;if(dS.events){this.__bG(dQ,dS.events,true);}
;if(dS.include){for(var i=0,l=dS.include.length;i<l;i++ ){this.__bN(dQ,dS.include[i],false);}
;}
;}
else if(dS.hasOwnProperty(dp)&&qx.core.Environment.get(dF)){throw new Error(cu);}
;if(dS.environment){for(var dR in dS.environment){qx.core.Environment.add(dR,dS.environment[dR]);}
;}
;if(dS.implement){for(var i=0,l=dS.implement.length;i<l;i++ ){this.__bL(dQ,dS.implement[i]);}
;}
;if(qx.core.Environment.get(dF)){this.__bE(dQ);}
;if(dS.defer){dS.defer.self=dQ;qx.Bootstrap.addPendingDefer(dQ,function(){dS.defer(dQ,dQ.prototype,{add:function(name,dU){var dV={};dV[name]=dU;qx.Class.__bH(dQ,dV,true);}
});}
);}
;return dQ;}
...
,getSubclasses:function(ey){if(!ey){return null;}
;var ez={};var eA=qx.Class.$$registry;for(var name in eA){if(eA[name].superclass&&eA[name].superclass==ey){ez[name]=eA[name];}
;}
;return ez;}
,genericToString:function(){return dv+this.classname+dB;}
,$$registry:qx.Bootstrap.$$registry,__U:qx.core.Environment.select(dF,{"true":{"type":Q,"extend":cM,"implement":dc,"include":dc,"construct":cM,"statics":dc,"properties":dc,"members":dc,"environment":dc,"events":dc,"defer":cM,"destruct":cM},"default":null}),__bD:qx.core.Environment.select(dF,{"true":{"type":Q,"statics":dc,"environment":dc,"defer":cM},"default":null}),__V:qx.core.Environment.select(dF,{"true":function(name,eE){if(eE.type&&!(eE.type===cD||eE.type===du||eE.type===k)){throw new Error(dn+eE.type+T+name+cA);}
;if(eE.type&&eE.type!==cD&&!eE.extend){throw new Error(s+name+da);}
;var eD=eE.type===cD?this.__bD:this.__U;for(var eC in eE){if(!eD[eC]){throw new Error(cH+eC+y+name+cB);}
;if(eE[eC]==null){throw new Error(dy+eC+y+name+H);}
;if(typeof eE[eC]!==eD[eC]){throw new Error(w+eC+y+name+cL+eD[eC]+cA);}
;}
;var eB=[dz,cI,U,f,dw,dh,v];for(var i=0,l=eB.length;i<l;i++ ){var eC=eB[i];if(eE[eC]!==undefined&&(eE[eC].$$hash!==undefined||!qx.Bootstrap.isObject(eE[eC]))){throw new Error(dy+eC+y+name+cQ);}
;}
;if(eE.include){if(qx.Bootstrap.getClass(eE.include)===dg){for(var i=0,a=eE.include,l=a.length;i<l;i++ ){if(a[i]==null||a[i].$$type!==dx){throw new Error(cR+name+J+i+b+a[i]);}
;}
;}
else {throw new Error(q+name+de);}
;}
;if(eE.implement){if(qx.Bootstrap.getClass(eE.implement)===dg){for(var i=0,a=eE.implement,l=a.length;i<l;i++ ){if(a[i]==null||a[i].$$type!==z){throw new Error(dM+name+dN+i+b+a[i]);}
;}
;}
else {throw new Error(dG+name+cX);}
;}
;if(eE.include){try{qx.Mixin.checkCompatibility(eE.include);}
catch(eF){throw new Error(P+name+dK+eF.message);}
;}
;if(eE.environment){for(var eC in eE.environment){if(eC.substr(0,eC.indexOf(cT))!=name.substr(0,name.indexOf(cT))){throw new Error(n+eC+cS+name+V+dI);}
;}
;}
;if(eE.settings){for(var eC in eE.settings){if(eC.substr(0,eC.indexOf(cT))!=name.substr(0,name.indexOf(cT))){throw new Error(dJ+eC+cS+name+o);}
;}
;}
;if(eE.variants){for(var eC in eE.variants){if(eC.substr(0,eC.indexOf(cT))!=name.substr(0,name.indexOf(cT))){throw new Error(cV+eC+cS+name+cU);}
;}
;}
;}
,"default":function(name,eG){}
}),__bE:qx.core.Environment.select(dF,{"true":function(eJ){var eI=eJ.superclass;while(eI){if(eI.$$classtype!==du){break;}
;var eH=eI.$$implements;if(eH){for(var i=0;i<eH.length;i++ ){qx.Interface.assert(eJ,eH[i],true);}
;}
;eI=eI.superclass;}
;}
,"default":function(eK){}
}),__bF:function(name,eV,eU,eL,eS,eP,eO){var eR=function(){return (typeof this==cE);}
;var eQ;if(!eU&&qx.core.Environment.get(dj)==false){eQ=eL||{};qx.Bootstrap.setDisplayNames(eQ,name);}
else {eQ={};if(eU){if(!eS){eS=this.__bO();}
;if(this.__bP(eU,eO)){eQ=this.__bQ(eS,name,eV);}
else {eQ=eS;}
;if(eV===k){eQ.getInstance=this.getInstance;}
;qx.Bootstrap.setDisplayName(eS,name,d);}
;if(eL){qx.Bootstrap.setDisplayNames(eL,name);var eT;for(var i=0,a=Object.keys(eL),l=a.length;i<l;i++ ){eT=a[i];var eM=eL[eT];if(qx.core.Environment.get(dj)){if(eM instanceof Function){eM=qx.core.Aspect.wrap(name+cT+eT,eM,cD);}
;eQ[eT]=eM;}
else {eQ[eT]=eM;}
;}
;}
;}
;var eN=name?qx.Bootstrap.createNamespace(name,eQ):dC;eQ.classname=name;if(!eR()){try{eQ.name=name;}
catch(eW){}
;}
;eQ.basename=eN;eQ.$$type=cP;if(eV){eQ.$$classtype=eV;}
;if(!eQ.hasOwnProperty(t)){eQ.toString=this.genericToString;}
;if(eU){qx.Bootstrap.extendClass(eQ,eS,eU,name,eN);if(eP){if(qx.core.Environment.get(dj)){eP=qx.core.Aspect.wrap(name,eP,F);}
;eQ.$$destructor=eP;qx.Bootstrap.setDisplayName(eP,name,G);}
;}
;this.$$registry[name]=eQ;return eQ;}
,__bG:function(eX,eY,fb){if(qx.core.Environment.get(dF)){if(typeof eY!==dc||qx.Bootstrap.getClass(eY)===dg){throw new Error(eX.classname+cC);}
;for(var fa in eY){if(typeof eY[fa]!==Q){throw new Error(eX.classname+dA+fa+p);}
;}
;if(eX.$$events&&fb!==true){for(var fa in eY){if(eX.$$events[fa]!==undefined&&eX.$$events[fa]!==eY[fa]){throw new Error(eX.classname+dA+fa+E+eX.$$events[fa]+dE+eY[fa]);}
;}
;}
;}
;if(eX.$$events){for(var fa in eY){eX.$$events[fa]=eY[fa];}
;}
else {eX.$$events=eY;}
;}
,__bH:function(fd,fg,fe){if(!qx.core.Environment.get(O)){throw new Error(h);}
;var ff;if(fe===undefined){fe=false;}
;var fc=fd.prototype;for(var name in fg){ff=fg[name];if(qx.core.Environment.get(dF)){this.__bI(fd,name,ff,fe);}
;ff.name=name;if(!ff.refine){if(fd.$$properties===undefined){fd.$$properties={};}
;fd.$$properties[name]=ff;}
;if(ff.init!==undefined){fd.prototype[dd+name]=ff.init;}
;if(ff.event!==undefined){if(!qx.core.Environment.get(S)){throw new Error(Y);}
;var event={};event[ff.event]=m;this.__bG(fd,event,fe);}
;if(ff.inheritable){this.__bC.$$inheritable[name]=true;if(!fc.$$refreshInheritables){this.__bC.attachRefreshInheritables(fd);}
;}
;if(!ff.refine){this.__bC.attachMethods(fd,name,ff);}
;}
;}
,__bI:qx.core.Environment.select(dF,{"true":function(fh,name,fn,fj){if(!qx.core.Environment.get(O)){throw new Error(h);}
;var fm=this.hasProperty(fh,name);if(fm){var fi=this.getPropertyDefinition(fh,name);if(fn.refine&&fi.init===undefined){throw new Error(K+name+dD+fh.classname+C);}
;}
;if(!fm&&fn.refine){throw new Error(cF+name+cz+fh.classname+cJ);}
;if(fm&&!fj){throw new Error(dl+fh.classname+X+name+cN);}
;if(fm&&fj){if(!fn.refine){throw new Error(dq+name+db+fh.classname+ds+this.getByProperty(fh,name).classname+cv);}
;for(var fk in fn){if(fk!==dL&&fk!==dO){throw new Error(dl+fh.classname+r+name+u+fk+cx);}
;}
;}
;var fl=fn.group?this.__bC.$$allowedGroupKeys:this.__bC.$$allowedKeys;for(var fk in fn){if(fl[fk]===undefined){throw new Error(cH+fk+L+name+y+fh.classname+cB);}
;if(fn[fk]===undefined){throw new Error(dy+fk+L+name+y+fh.classname+g+fn[fk]);}
;if(fl[fk]!==null&&typeof fn[fk]!==fl[fk]){throw new Error(w+fk+L+name+y+fh.classname+cL+fl[fk]+cA);}
;}
;if(fn.transform!=null){if(!(typeof fn.transform===Q)){throw new Error(x+name+y+fh.classname+cW);}
;}
;if(fn.check!=null){if(!qx.Bootstrap.isString(fn.check)&&!qx.Bootstrap.isArray(fn.check)&&!qx.Bootstrap.isFunction(fn.check)){throw new Error(j+name+y+fh.classname+cY);}
;}
;}
,"default":null}),__bJ:function(fv,fo,fq,fs,fu){var fp=fv.prototype;var ft,fr;qx.Bootstrap.setDisplayNames(fo,fv.classname+cG);for(var i=0,a=Object.keys(fo),l=a.length;i<l;i++ ){ft=a[i];fr=fo[ft];if(qx.core.Environment.get(dF)){if(fp[ft]!==undefined&&ft.charAt(0)===cK&&ft.charAt(1)===cK){throw new Error(dm+ft+I+fv.classname+cB);}
;if(fq!==true&&fp.hasOwnProperty(ft)){throw new Error(R+ft+I+fv.classname+cB);}
;}
;if(fp[ft]!=undefined&&fp[ft].$$install){fp[ft].$$install();}
;if(fs!==false&&fr instanceof Function&&fr.$$type==null){if(fu==true){fr=this.__bK(fr,fp[ft]);}
else {if(fp[ft]){fr.base=fp[ft];}
;fr.self=fv;}
;if(qx.core.Environment.get(dj)){fr=qx.core.Aspect.wrap(fv.classname+cT+ft,fr,dt);}
;}
;fp[ft]=fr;}
;}
,__bK:function(fw,fx){if(fx){return function(){var fz=fw.base;fw.base=fx;var fy=fw.apply(this,arguments);fw.base=fz;return fy;}
;}
else {return fw;}
;}
,__bL:function(fC,fA){if(qx.core.Environment.get(dF)){if(!fC||!fA){throw new Error(dk);}
;if(this.hasOwnInterface(fC,fA)){throw new Error(M+fA.name+di+fC.classname+df);}
;if(fC.$$classtype!==du){qx.Interface.assert(fC,fA,true);}
;}
;var fB=qx.Interface.flatten([fA]);if(fC.$$implements){fC.$$implements.push(fA);fC.$$flatImplements.push.apply(fC.$$flatImplements,fB);}
else {fC.$$implements=[fA];fC.$$flatImplements=fB;}
;}
,__bM:function(fE){var name=fE.classname;var fD=this.__bQ(fE,name,fE.$$classtype);for(var i=0,a=Object.keys(fE),l=a.length;i<l;i++ ){fF=a[i];fD[fF]=fE[fF];}
;fD.prototype=fE.prototype;var fH=fE.prototype;for(var i=0,a=Object.keys(fH),l=a.length;i<l;i++ ){fF=a[i];var fI=fH[fF];if(fI&&fI.self==fE){fI.self=fD;}
;}
;for(var fF in this.$$registry){var fG=this.$$registry[fF];if(!fG){continue;}
;if(fG.base==fE){fG.base=fD;}
;if(fG.superclass==fE){fG.superclass=fD;}
;if(fG.$$original){if(fG.$$original.base==fE){fG.$$original.base=fD;}
;if(fG.$$original.superclass==fE){fG.$$original.superclass=fD;}
;}
;}
;qx.Bootstrap.createNamespace(name,fD);this.$$registry[name]=fD;return fD;}
,__bN:function(fO,fM,fL){if(qx.core.Environment.get(dF)){if(!fO||!fM){throw new Error(dk);}
;}
;if(this.hasMixin(fO,fM)){return;}
;var fJ=fO.$$original;if(fM.$$constructor&&!fJ){fO=this.__bM(fO);}
;var fK=qx.Mixin.flatten([fM]);var fN;for(var i=0,l=fK.length;i<l;i++ ){fN=fK[i];if(fN.$$events){this.__bG(fO,fN.$$events,fL);}
;if(fN.$$properties){this.__bH(fO,fN.$$properties,fL);}
;if(fN.$$members){this.__bJ(fO,fN.$$members,fL,fL,fL);}
;}
;if(fO.$$includes){fO.$$includes.push(fM);fO.$$flatIncludes.push.apply(fO.$$flatIncludes,fK);}
else {fO.$$includes=[fM];fO.$$flatIncludes=fK;}
;}
,__bO:function(){function fP(){fP.base.apply(this,arguments);}
;return fP;}
,__bP:function(fR,fQ){if(qx.core.Environment.get(dF)){return true;}
;if(fR&&fR.$$includes){var fS=fR.$$flatIncludes;for(var i=0,l=fS.length;i<l;i++ ){if(fS[i].$$constructor){return true;}
;}
;}
;if(fQ){var fT=qx.Mixin.flatten(fQ);for(var i=0,l=fT.length;i<l;i++ ){if(fT[i].$$constructor){return true;}
;}
;}
;return false;}
,__bQ:function(fV,name,fU){var fX=function(){var gb=fX;if(qx.core.Environment.get(dF)){if(!(this instanceof gb)){throw new Error(A+name+D);}
;if(fU===du){if(this.classname===name){throw new Error(dH+name+e);}
;}
else if(fU===k){if(!gb.$$allowconstruct){throw new Error(cO+name+W);}
;}
;}
;var fY=gb.$$original.apply(this,arguments);if(gb.$$includes){var ga=gb.$$flatIncludes;for(var i=0,l=ga.length;i<l;i++ ){if(ga[i].$$constructor){ga[i].$$constructor.apply(this,arguments);}
;}
;}
;if(qx.core.Environment.get(dF)){if(this.classname===name){this.$$initialized=true;}
;}
;return fY;}
;if(qx.core.Environment.get(dj)){var fW=qx.core.Aspect.wrap(name,fX,d);fX.$$original=fV;fX.constructor=fW;fX=fW;}
;fX.$$original=fV;fV.wrapper=fX;return fX;}
},defer:function(){if(qx.core.Environment.get(dj)){for(var gc in qx.Bootstrap.$$registry){var gd=qx.Bootstrap.$$registry[gc];for(var ge in gd){if(gd[ge] instanceof Function){gd[ge]=qx.core.Aspect.wrap(gc+cT+ge,gd[ge],cD);}
;}
;}
;}
;}
...
(function(){var a="qx.debug.databinding",b=". Error message: ",c="Boolean",d="Data after conversion: ",f="set",g="deepBinding",h=")",k=") to the object '",l="item",m="Can not remove the bindings for null object!",n="Please use only one array at a time: ",p="Binding executed from ",q="Integer",r="reset",s=" of object ",t="qx.event.type.Data",u="qx.data.SingleValueBinding",v="No number or 'last' value hast been given",w="Binding property ",x="Failed so set value ",y=").",z="change",A="qx.debug",B="targetObject",C="targetPropertyChain",D="get",E="^",F="Binding could not be found!",G="sourceObject",H="String",I=" to ",J="Binding from '",K="",L="sourcePropertyChain",M="PositiveNumber",N="Data before conversion: ",O="]",P="[",Q=".",R="PositiveInteger",S="' (",T=" on ",U="Binding does not exist!",V=" does not work.",W=" in an array binding: ",X=" is not an data (qx.event.type.Data) event on ",Y=".[",bj=" (",bk=" by ",bl="Date",bg="Number",bh=" not possible: No event available. ",bi="last";qx.Class.define(u,{statics:{__bS:{},__bT:{},bind:function(by,bs,bD,bA,bG){if(qx.core.Environment.get(A)){qx.core.Assert.assertObject(by,G);qx.core.Assert.assertString(bs,L);qx.core.Assert.assertObject(bD,B);qx.core.Assert.assertString(bA,C);}
;var bC=this.__bV(by,bs,bD,bA,bG);var bo=bs.split(Q);var bn=this.__ce(bo);var bq=[];var bE=[];var bp=[];var br=[];var bw=by;try{for(var i=0;i<bo.length;i++ ){if(bn[i]!==K){br.push(z);}
else {var bv=this.__bW(bw,bo[i]);if(!bv){if(i==0){throw new qx.core.AssertionError(w+bo[i]+s+bw+bh);}
;this.__cd(undefined,bD,bA,bG,by);break;}
;br.push(bv);}
;bq[i]=bw;if(i==bo.length-1){if(bn[i]!==K){var bx=bn[i]===bi?bw.length-1:bn[i];var bm=bw.getItem(bx);this.__cd(bm,bD,bA,bG,by);bp[i]=this.__cf(bw,br[i],bD,bA,bG,bn[i]);}
else {if(bo[i]!=null&&bw[D+qx.lang.String.firstUp(bo[i])]!=null){var bm=bw[D+qx.lang.String.firstUp(bo[i])]();this.__cd(bm,bD,bA,bG,by);}
;bp[i]=this.__cf(bw,br[i],bD,bA,bG);}
;}
...
;}
;if(!bw){this.__cd(bw,bD,bA,bG,by);break;}
;}
;}
...
;}
;throw bH;}
;var bu={type:g,listenerIds:bp,sources:bq,targetListenerIds:bC.listenerIds,targets:bC.targets};this.__cg(bu,by,bs,bD,bA);return bu;}
...
;break;}
;if(j==bO.propertyNames.length-1){if(qx.Class.implementsInterface(bM,qx.data.IListData)){var bQ=bO.arrayIndexValues[j]===bi?bM.length-1:bO.arrayIndexValues[j];var bJ=bM.getItem(bQ);this.__cd(bJ,bO.targetObject,bO.targetPropertyChain,bO.options,bO.sources[bO.index]);bO.listenerIds[j]=this.__cf(bM,z,bO.targetObject,bO.targetPropertyChain,bO.options,bO.arrayIndexValues[j]);}
else {if(bO.propertyNames[j]!=null&&bM[D+qx.lang.String.firstUp(bO.propertyNames[j])]!=null){var bJ=bM[D+qx.lang.String.firstUp(bO.propertyNames[j])]();this.__cd(bJ,bO.targetObject,bO.targetPropertyChain,bO.options,bO.sources[bO.index]);}
;var bK=this.__bW(bM,bO.propertyNames[j]);if(!bK){this.__bX(bO.targetObject,bO.targetPropertyChain);break;}
;bO.listenerIds[j]=this.__cf(bM,bK,bO.targetObject,bO.targetPropertyChain,bO.options);}
;}
...
;}
;}
,__bV:function(bT,cc,cg,bX,ca){var bW=bX.split(Q);var bU=this.__ce(bW);var cf=[];var ce=[];var bY=[];var cd=[];var bV=cg;for(var i=0;i<bW.length-1;i++ ){if(bU[i]!==K){cd.push(z);}
...
,updateTarget:function(cl,co,cq,cm,cp){var cn=this.resolvePropertyChain(cl,co);cn=qx.data.SingleValueBinding.__ch(cn,cq,cm,cp,cl);this.__bY(cq,cm,cn);}
,resolvePropertyChain:function(o,cr){var cs=this.__cb(cr);return this.__cc(o,cs,cs.length);}
,__bW:function(cu,cv){var ct=this.__ci(cu,cv);if(ct==null){if(qx.Class.supportsEvent(cu.constructor,cv)){ct=cv;}
else if(qx.Class.supportsEvent(cu.constructor,z+qx.lang.String.firstUp(cv))){ct=z+qx.lang.String.firstUp(cv);}
else {return null;}
;}
;return ct;}
,__bX:function(cA,cy){var cz=this.__cb(cy);var cx=this.__cc(cA,cz);if(cx!=null){var cB=cz[cz.length-1];var cw=this.__ca(cB);if(cw){this.__bY(cA,cy,null);return;}
;if(cx[r+qx.lang.String.firstUp(cB)]!=undefined){cx[r+qx.lang.String.firstUp(cB)]();}
else {cx[f+qx.lang.String.firstUp(cB)](null);}
;}
;}
,__bY:function(cH,cE,cF){var cG=this.__cb(cE);var cD=this.__cc(cH,cG);if(cD){var cI=cG[cG.length-1];var cC=this.__ca(cI);if(cC){if(cC===bi){cC=cD.length-1;}
;cD.setItem(cC,cF);}
else {cD[f+qx.lang.String.firstUp(cI)](cF);}
;}
;}
,__ca:function(cL){var cJ=/^\[(\d+|last)\]$/;var cK=cL.match(cJ);if(cK){return cK[1];}
;return null;}
,__cb:function(cM){return cM.replace(/\[/g,Y).split(Q).filter(function(cN){return cN!==K;}
);}
,__cc:function(cT,cO,cP){cP=cP||cO.length-1;var cR=cT;for(var i=0;cR!==null&&i<cP;i++ ){try{var cS=cO[i];var cQ=this.__ca(cS);if(cQ){if(cQ===bi){cQ=cR.length-1;}
;cR=cR.getItem(cQ);}
...
;}
;return cR;}
,__cd:function(da,cV,cX,cY,cW){da=this.__ch(da,cV,cX,cY,cW);if(da===undefined){this.__bX(cV,cX);}
...
;}
;}
,__ce:function(db){var dc=[];for(var i=0;i<db.length;i++ ){var name=db[i];if(name.endsWith(O)){var dd=name.substring(name.indexOf(P)+1,name.indexOf(O));if(name.indexOf(O)!=name.length-1){throw new Error(n+name+V);}
...
;}
;return dc;}
,__cf:function(de,dh,dm,dk,di,dg){if(qx.core.Environment.get(A)){var df=qx.Class.getEventType(de.constructor,dh);qx.core.Assert.assertEquals(t,df,dh+X+de+Q);}
...
;dr=qx.data.SingleValueBinding.__ch(dr,dm,dk,di,de);if(qx.core.Environment.get(a)){qx.log.Logger.debug(d+dr);}
...
,__cg:function(dy,dt,dw,dz,dx){var du;du=dt.toHashCode();if(this.__bS[du]===undefined){this.__bS[du]=[];}
;var dv=[dy,dt,dw,dz,dx];this.__bS[du].push(dv);du=dz.toHashCode();if(this.__bT[du]===undefined){this.__bT[du]=[];}
;this.__bT[du].push(dv);}
,__ch:function(dD,dJ,dC,dF,dA){if(dF&&dF.converter){var dG;if(dJ.getModel){dG=dJ.getModel();}
;return dF.converter(dD,dG,dA,dJ);}
else {var dE=this.__cb(dC);var dB=this.__cc(dJ,dE);var dK=dC.substring(dC.lastIndexOf(Q)+1,dC.length);if(dB==null){return dD;}
;var dH=qx.Class.getPropertyDefinition(dB.constructor,dK);var dI=dH==null?K:dH.check;return this.__cj(dD,dI);}
;}
,__ci:function(dL,dN){var dM=qx.Class.getPropertyDefinition(dL.constructor,dN);if(dM==null){return null;}
;return dM.event;}
,__cj:function(dQ,dP){var dO=qx.lang.Type.getClass(dQ);if((dO==bg||dO==H)&&(dP==q||dP==R)){dQ=parseInt(dQ,10);}
...
,showAllBindingsInLog:function(){for(var ep in this.__bS){var eo=qx.core.ObjectRegistry.fromHashCode(ep);for(var i=0;i<this.__bS[ep].length;i++ ){this.showBindingInLog(eo,this.__bS[ep][i][0]);}
;}
;}
}});}
)();
...
,members:{__ck:0,__cl:0,__cm:false,__cn:0,__co:null,__cp:null,setMaxEntries:function(c){this.__cp=c;this.clear();}
,getMaxEntries:function(){return this.__cp;}
,addEntry:function(d){this.__co[this.__ck]=d;this.__ck=this.__cq(this.__ck,1);var e=this.getMaxEntries();if(this.__cl<e){this.__cl++ ;}
;if(this.__cm&&(this.__cn<e)){this.__cn++ ;}
;}
,getNumEntriesStored:function(){return this.__cl;}
,mark:function(){this.__cm=true;this.__cn=0;}
,clearMark:function(){this.__cm=false;}
,getAllEntries:function(){return this.getEntries(this.getMaxEntries(),false);}
,getEntries:function(f,j){if(f>this.__cl){f=this.__cl;}
;if(j&&this.__cm&&(f>this.__cn)){f=this.__cn;}
;if(f>0){var h=this.__cq(this.__ck,-1);var g=this.__cq(h,-f+1);var i;if(g<=h){i=this.__co.slice(g,h+1);}
else {i=this.__co.slice(g,this.__cl).concat(this.__co.slice(0,h+1));}
;}
else {i=[];}
;return i;}
,clear:function(){this.__co=new Array(this.getMaxEntries());this.__cl=0;this.__cn=0;this.__ck=0;}
,__cq:function(n,l){var k=this.getMaxEntries();var m=(n+l)%k;if(m<0){m+=k;}
;return m;}
}});}
)();
...
(function(){var a="qx.log.Logger",b="[",c="The mixin '",d="...(+",e="array",f="The method '",g=")",h="warn",j="node",k="The event '",m="instance",n="info",o="string",p="Please consult the API documentation of this method for alternatives.",q="null",r="error",s="qx.debug",t="Please consult the API documentation of this class for alternatives.",u="#",v="class",w="' is deprecated: ",x=": ",y="Please consult the API documentation for alternatives.",z="document",A="{...(",B="",C="number",D="' from class '",E="The class '",F="stringify",G="' overrides a deprecated method: ",H="date",I="unknown",J="function",K="[default]",L="text[",M="]",N="[...(",O="boolean",P="\n",Q=")}",R="|",S="debug",T=")]",U="map",V="The constant '",W="undefined",X="trace",Y="object";qx.Bootstrap.define(a,{statics:{__cr:S,setLevel:function(ba){this.__cr=ba;}
,getLevel:function(){return this.__cr;}
,setTreshold:function(bb){this.__cw.setMaxMessages(bb);}
,getTreshold:function(){return this.__cw.getMaxMessages();}
,__cs:[],__ct:{},__cu:[],__cv:0,register:function(bd){if(bd.$$id){return;}
;var bg=this.__cv++ ;this.__cs[bg]=bd;this.__ct[bd.classname]=bd;bd.$$id=bg;var be=this.__cw.getAllLogEvents();for(var i=0,l=be.length;i<l;i++ ){var bf=be[i];var bc=this.__cB(bf.loggerName,bf.level);if(bc[bd.classname]){bd.process(bf);}
;}
;}
,unregister:function(bh){var bi=bh.$$id;if(bi==null){return;}
;delete this.__ct[bh.classname];delete this.__cs[bi];delete bh.$$id;}
,addFilter:function(bk,bj,bl){if(typeof bk==o){bk=new RegExp(bk);}
;this.__cu.push({loggerMatch:bk,level:bl||this.__cr,appenderName:bj});}
,resetFilters:function(){this.__cu=[];}
,debug:function(bn,bm){qx.log.Logger.__cA(S,arguments);}
,info:function(bp,bo){qx.log.Logger.__cA(n,arguments);}
,warn:function(br,bq){qx.log.Logger.__cA(h,arguments);}
,error:function(bt,bs){qx.log.Logger.__cA(r,arguments);}
,trace:function(bx,bu){if(qx.log.Logger.isLoggerEnabled(X,bx)){var bw=qx.dev.StackTrace.getStackTrace();var bv=qx.lang.Array.fromArguments(arguments);bv.push(bw.join(P));qx.log.Logger.__cA(X,bv);}
;}
...
;}
;}
,clear:function(){this.__cw.clearHistory();}
,__cw:new qx.log.appender.RingBuffer(50),__cx:{trace:0,debug:1,info:2,warn:3,error:4},__cy:{},__cz:function(bT){if(bT){if(bT.classname){return bT.classname;}
;if(typeof bT==o){return bT;}
;}
;return K;}
,isLoggerEnabled:function(bX,bV){var bU=this.__cz(bV);var bW=this.__cB(bU,bX);return !!Object.keys(bW).length;}
,__cA:function(cb,bY){var cd=bY.length<2?null:bY[0];var ce=this.__cz(cd);var ca=this.__cB(ce,cb);if(!Object.keys(ca).length){return;}
;var cg=cd?1:0;var cc=[];for(var i=cg,l=bY.length;i<l;i++ ){cc.push(this.__cD(bY[i],true));}
...
;}
;this.__cw.process(ci);for(var cf in ca){ca[cf].process(ci);}
;}
,__cB:function(cj,cl){var co=this.__cx;if(!this.__cu.length){if(co[cl]<co[this.__cr]){return [];}
;return this.__ct;}
;var cm=cj+R+cl;var ck=this.__cy[cm];if(ck!==undefined){return ck;}
;var ck={};for(var i=0;i<this.__cu.length;i++ ){var cn=this.__cu[i];if(co[cl]<co[cn.level]){continue;}
;if(cn.appenderName&&ck[cn.appenderName]){continue;}
;if(!cn.loggerMatch||cn.loggerMatch.test(cj)){if(cn.appenderName){ck[cn.appenderName]=this.__ct[cn.appenderName];}
else {return this.__cy[cm]=this.__ct;}
;}
;}
;return this.__cy[cm]=ck;}
,__cC:function(cq){if(cq===undefined){return W;}
...
;return I;}
,__cD:function(cw,cv){var cz=this.__cC(cw);var ct=I;var cs=[];switch(cz){case q:case W:ct=cz;break;case o:case C:case O:case H:ct=cw;break;case j:if(cw.nodeType===9){ct=z;}
...
;cx=cy[i];cr=this.__cD(cw[cx],false);cr.key=cx;ct.push(cr);}
;}
else {var cu=0;for(var cx in cw){cu++ ;}
;ct=A+cu+Q;}
;break;};return {type:cz,text:ct,trace:cs};}
},defer:function(cA){var cB=qx.Bootstrap.$$logs;for(var i=0;i<cB.length;i++ ){cA.__cA(cB[i][0],cB[i][1]);}
...
(function(){var a="info",b="error",c="warn",d="debug",e="qx.core.MLogging",f="trace";qx.Mixin.define(e,{members:{__cE:qx.log.Logger,debug:function(g){this.__cF(d,arguments);}
,info:function(h){this.__cF(a,arguments);}
,warn:function(i){this.__cF(c,arguments);}
,error:function(j){this.__cF(b,arguments);}
,trace:function(k){this.__cF(f,arguments);}
,__cF:function(l,n){var m=qx.lang.Array.fromArguments(n);m.unshift(this);this.__cE[l].apply(this.__cE,m);}
}});}
)();
...
(function(){var a="-",b="qx.bom.Style",c="",d='-',e="Webkit",f="ms",g=":",h=";",j="Moz",k="O",m="string",n="Khtml";qx.Bootstrap.define(b,{statics:{VENDOR_PREFIXES:[e,j,k,f,n],__cG:{},__cH:null,getPropertyName:function(q){var o=document.documentElement.style;if(o[q]!==undefined){return q;}
...
;}
;return null;}
,getCssName:function(r){var s=this.__cG[r];if(!s){s=r.replace(/[A-Z]/g,function(t){return (d+t.charAt(0).toLowerCase());}
);if((/^ms/.test(s))){s=a+s;}
;this.__cG[r]=s;}
;return s;}
,getAppliedStyle:function(A,x,z,v){var C=qx.bom.Style.getCssName(x);var w=qx.dom.Node.getWindow(A);var u=(v!==false)?[null].concat(this.VENDOR_PREFIXES):[null];for(var i=0,l=u.length;i<l;i++ ){var y=false;var B=u[i]?a+u[i].toLowerCase()+a+z:z;if(qx.bom.Style.__cH){y=qx.bom.Style.__cH.call(w,C,B);}
else {A.style.cssText+=C+g+B+h;y=(typeof A.style[x]==m&&A.style[x]!==c);}
;if(y){return B;}
;}
;return null;}
},defer:function(D){if(window.CSS&&window.CSS.supports){qx.bom.Style.__cH=window.CSS.supports.bind(window.CSS);}
else if(window.supportsCSS){qx.bom.Style.__cH=window.supportsCSS.bind(window);}
;}
});}
)();
...
(function(){var a="Failed to remove event listener for id '",b="': ",c="Invalid context for callback.",d="Invalid capture flag.",e="Failed to add event listener for type '",f="UNKNOWN_",g="'",h="|bubble",j="Invalid event type.",k="There is no event handler for the event '",m=" from the target '",n="qx.debug",o="capture",p="|capture",q="Invalid callback function",r="qx.event.Manager",s="__cN",t="' on target '",u="'!",v="Could not dispatch event '",w="",x="_",y="DOM_",z="Invalid event target.",A="No dispatcher can handle event of type ",B="QX_",C=" to the target '",D="Failed to remove event listener for type '",E=" on ",F="Invalid id type.",G="c",H="|",I="qx.globalErrorHandling",J="unload",K="__cM",L="DOCUMENT_",M="Invalid object: ",N="Invalid Target.",O="WIN_",P="Invalid event object.";qx.Class.define(r,{extend:Object,construct:function(Q,S){this.__cI=Q;this.__cJ=qx.core.ObjectRegistry.toHashCode(Q);this.__cK=S;if(Q.qx!==qx){var self=this;var R=function(){qx.bom.Event.removeNativeListener(Q,J,arguments.callee);self.dispose();}
...
(function(){var a="qx.core.MEvent";qx.Mixin.define(a,{members:{__cX:qx.event.Registration,addListener:function(d,b,self,c){if(!this.$$disposed){return this.__cX.addListener(this,d,b,self,c);}
;return null;}
...
;return this.__cX.removeListener(this,m,k,self,l);}
;return false;}
,removeListenerById:function(o){if(!this.$$disposed){return this.__cX.removeListenerById(this,o);}
;return false;}
,hasListener:function(q,p){return this.__cX.hasListener(this,q,p);}
,dispatchEvent:function(r){if(!this.$$disposed){return this.__cX.dispatchEvent(this,r);}
;return true;}
,fireEvent:function(t,u,s){if(!this.$$disposed){return this.__cX.fireEvent(this,t,u,s);}
;return true;}
,fireNonBubblingEvent:function(w,x,v){if(!this.$$disposed){return this.__cX.fireNonBubblingEvent(this,w,x,v);}
;return true;}
,fireDataEvent:function(A,B,y,z){if(!this.$$disposed){if(y===undefined){y=null;}
;return this.__cX.fireNonBubblingEvent(this,A,qx.event.type.Data,[B,y,!!z]);}
;return true;}
}});}
)();
...
,statics:{$$type:q},members:{__bC:qx.core.Environment.get(e)?qx.core.Property:null,toHashCode:function(){return this.$$hash;}
...
;var v=this.constructor;var u=new v;var x=qx.Class.getProperties(v);var w=this.__bC.$$store.user;var y=this.__bC.$$method.set;var name;for(var i=0,l=x.length;i<l;i++ ){name=x[i];if(this.hasOwnProperty(w[name])){u[y[name]](this[w[name]]);}
;}
;return u;}
,__cY:null,setUserData:function(z,A){if(!this.__cY){this.__cY={};}
;this.__cY[z]=A;}
,getUserData:function(C){if(!this.__cY){return null;}
;var B=this.__cY[C];return B===undefined?null:B;}
...
;}
;qx.core.ObjectRegistry.unregister(this);this.__cY=null;if(qx.core.Environment.get(e)){var N=this.constructor;var R;var S=this.__bC.$$store;var P=S.user;var Q=S.theme;var L=S.inherit;var O=S.useinit;var M=S.init;while(N){R=N.$$properties;if(R){for(var name in R){if(R[name].dereference){this[P[name]]=this[Q[name]]=this[L[name]]=this[O[name]]=this[M[name]]=undefined;}
;}
;}
;N=N.superclass;}
;}
...
;}
,destroyContainer:function(K){if(qx.core.Environment.get(c)){if(qx.ui.mobile&&K instanceof qx.ui.mobile.core.Widget){qx.core.Assert.assertTrue(this.__da(K),g);}
else {qx.core.Assert.assertQxWidget(K,m);qx.core.Assert.assertTrue(this.__da(K),p+n+d);}
;}
;var J=[];this._collectContainerChildren(K,J);var L=J.length;for(var i=L-1;i>=0;i-- ){J[i].destroy();}
;K.destroy();}
,_collectContainerChildren:function(O,N){var P=O.getChildren();for(var i=0;i<P.length;i++ ){var M=P[i];N.push(M);if(this.__da(M)){this._collectContainerChildren(M,N);}
;}
;}
,__da:function(R){var Q=[];if(qx.ui.mobile&&R instanceof qx.ui.mobile.core.Widget){Q=[qx.ui.mobile.container.Composite];}
...
(function(){var a="qx.util.ObjectPool",b="Class needs to be defined!",c="Object is already pooled: ",d="Integer";qx.Class.define(a,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__db={};if(e!=null){this.setSize(e);}
;}
,properties:{size:{check:d,init:Infinity}},members:{__db:null,getObject:function(h){if(this.$$disposed){return new h;}
;if(!h){throw new Error(b);}
;var f=null;var g=this.__db[h.classname];if(g){f=g.pop();}
;if(f){f.$$pooled=false;}
else {f=new h;}
;return f;}
,poolObject:function(k){if(!this.__db){return;}
;var j=k.classname;var m=this.__db[j];if(k.$$pooled){throw new Error(c+k);}
;if(!m){this.__db[j]=m=[];}
;if(m.length>this.getSize()){if(k.destroy){k.destroy();}
else {k.dispose();}
;return;}
;k.$$pooled=true;m.push(k);}
},destruct:function(){var p=this.__db;var n,o,i,l;for(n in p){o=p[n];for(i=0,l=o.length;i<l;i++ ){o[i].dispose();}
;}
;delete this.__db;}
});}
)();
...
(function(){var a="qx.event.type.Data";qx.Class.define(a,{extend:qx.event.type.Event,members:{__dc:null,__dd:null,init:function(c,d,b){qx.event.type.Event.prototype.init.call(this,false,b);this.__dc=c;this.__dd=d;return this;}
,clone:function(e){var f=qx.event.type.Event.prototype.clone.call(this,e);f.__dc=this.__dc;f.__dd=this.__dd;return f;}
,getData:function(){return this.__dc;}
,getOldData:function(){return this.__dd;}
},destruct:function(){this.__dc=this.__dd=null;}
});}
)();
(function(){var a="qx.util.DeferredCallManager",b="singleton";qx.Class.define(a,{extend:qx.core.Object,type:b,construct:function(){this.__de={};this.__df=qx.lang.Function.bind(this.__dj,this);this.__dg=false;}
,members:{__dh:null,__di:null,__de:null,__dg:null,__df:null,schedule:function(d){if(this.__dh==null){this.__dh=window.setTimeout(this.__df,0);}
;var c=d.toHashCode();if(this.__di&&this.__di[c]){return;}
;this.__de[c]=d;this.__dg=true;}
,refreshTimeout:function(){if(this.__dh!==null){this.__dh=window.setTimeout(this.__df,0);}
;}
,cancel:function(f){var e=f.toHashCode();if(this.__di&&this.__di[e]){this.__di[e]=null;return;}
;delete this.__de[e];if(qx.lang.Object.isEmpty(this.__de)&&this.__dh!=null){window.clearTimeout(this.__dh);this.__dh=null;}
;}
,__dj:qx.event.GlobalError.observeMethod(function(){this.__dh=null;while(this.__dg){this.__di=qx.lang.Object.clone(this.__de);this.__de={};this.__dg=false;for(var h in this.__di){var g=this.__di[h];if(g){this.__di[h]=null;g.call();}
;}
;}
;this.__di=null;}
)},destruct:function(){if(this.__dh!=null){window.clearTimeout(this.__dh);}
;this.__df=this.__de=null;}
});}
)();
...
(function(){var a="qx.util.DeferredCall",b="The context object '",c="qx.debug",d="'is already disposed.",e="' of the defered call '";qx.Class.define(a,{extend:qx.core.Object,construct:function(f,g){qx.core.Object.call(this);this.__x=f;this.__z=g||null;this.__dl=qx.util.DeferredCallManager.getInstance();}
,members:{__x:null,__z:null,__dl:null,cancel:function(){this.__dl.cancel(this);}
,schedule:function(){this.__dl.schedule(this);}
,call:function(){if(qx.core.Environment.get(c)){var h=this.__z;if(h&&h.isDisposed&&h.isDisposed()){this.warn(b+h+e+this+d);}
;}
;this.__z?this.__x.apply(this.__z):this.__x();}
},destruct:function(){this.cancel();this.__z=this.__x=this.__dl=null;}
});}
)();
...
(function(){var a="qx.core.BaseInit",b="engine.name",c="Main runtime: ",d="",f="qx.application",g="os.name",h="engine.version",i="Missing application class: ",j="Load runtime: ",k="ms",l="Could not detect engine!",m="Finalize runtime: ",n="Could not detect operating system!",o="Could not detect the version of the engine!";qx.Class.define(a,{statics:{__dm:null,getApplication:function(){return this.__dm||null;}
,ready:function(){if(this.__dm){return;}
...
;qx.log.Logger.debug(this,j+(new Date-qx.Bootstrap.LOADSTART)+k);var q=qx.core.Environment.get(f);var r=qx.Class.getByName(q);if(r){this.__dm=new r;var p=new Date;this.__dm.main();qx.log.Logger.debug(this,c+(new Date-p)+k);var p=new Date;this.__dm.finalize();qx.log.Logger.debug(this,m+(new Date-p)+k);}
else {qx.log.Logger.warn(i+q);}
;}
,__dn:function(e){var s=this.__dm;if(s){s.close();}
;}
,__do:function(){var t=this.__dm;if(t){t.terminate();}
...
;}
,_onNative:function(){var q=qx.core.Environment.select(a,{"true":qx.event.GlobalError.observeMethod(this.__dp),"false":this.__dp});q.apply(this,arguments);}
,__dp:function(e){if(this.isDisposed()){return;}
...
(function(){var a="ready",b="mshtml",c="engine.name",d="qx.event.handler.Application",f="complete",g="webkit",h="gecko",i="qx.globalErrorHandling",j="load",k="unload",l="opera",m="left",n="DOMContentLoaded",o="shutdown",p="browser.documentmode";qx.Class.define(d,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(q){qx.core.Object.call(this);this._window=q.getWindow();this.__dq=false;this.__dr=false;this.__ds=false;this.__dt=false;this._initObserver();qx.event.handler.Application.$$instance=this;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{ready:1,shutdown:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true,onScriptLoaded:function(){var r=qx.event.handler.Application.$$instance;if(r){r.__du();}
;}
},members:{canHandleEvent:function(t,s){}
,registerEvent:function(w,v,u){}
,unregisterEvent:function(z,y,x){}
,__ds:null,__dq:null,__dr:null,__dt:null,__du:function(){if(!this.__ds&&this.__dq&&qx.$$loader.scriptLoaded){if((qx.core.Environment.get(c)==b)){if(qx.event.Registration.hasListener(this._window,a)){this.__ds=true;qx.event.Registration.fireEvent(this._window,a);}
;}
else {this.__ds=true;qx.event.Registration.fireEvent(this._window,a);}
;}
;}
,isApplicationReady:function(){return this.__ds;}
,_initObserver:function(){if(qx.$$domReady||document.readyState==f||document.readyState==a){this.__dq=true;this.__du();}
...
,_onNativeLoad:function(){var C=qx.core.Environment.select(i,{"true":qx.event.GlobalError.observeMethod(this.__dv),"false":this.__dv});C.apply(this,arguments);}
,__dv:function(){this.__dq=true;this.__du();}
,_onNativeUnload:function(){var D=qx.core.Environment.select(i,{"true":qx.event.GlobalError.observeMethod(this.__dw),"false":this.__dw});D.apply(this,arguments);}
,__dw:function(){if(!this.__dt){this.__dt=true;try{qx.event.Registration.fireEvent(this._window,o);}
catch(e){throw e;}
...
(function(){var a="ready",b="shutdown",c="beforeunload",d="qx.core.Init";qx.Class.define(d,{statics:{getApplication:qx.core.BaseInit.getApplication,ready:qx.core.BaseInit.ready,__dn:function(e){var f=this.getApplication();if(f){e.setReturnValue(f.close());}
;}
,__do:function(){var g=this.getApplication();if(g){g.terminate();}
;}
},defer:function(h){qx.event.Registration.addListener(window,a,h.ready,h);qx.event.Registration.addListener(window,b,h.__do,h);qx.event.Registration.addListener(window,c,h.__dn,h);}
});}
)();
(function(){var a="Abstract method call",b="abstract",c="*",d="",e="-webkit-tap-highlight-color: transparent;",f="-ms-touch-select: none;",g="qx.application.AbstractGui",h="-webkit-touch-callout: none;",i="-webkit-tap-highlight-color: rgba(0,0,0,0);";qx.Class.define(g,{type:b,extend:qx.core.Object,implement:[qx.application.IApplication],include:qx.locale.MTranslation,members:{__dx:null,_createRootWidget:function(){throw new Error(a);}
,getRoot:function(){return this.__dx;}
,main:function(){qx.theme.manager.Meta.getInstance().initialize();qx.ui.tooltip.Manager.getInstance();var j=[h,f,i,e].join(d);qx.ui.style.Stylesheet.getInstance().addRule(c,j);this.__dx=this._createRootWidget();window.scrollTo(0,0);}
...
,__dy:null,_fireEvent:function(e){if(e.getTarget()===qx.theme.manager.Color.getInstance()){qx.theme.manager.Decoration.getInstance().refresh();}
;this.fireEvent(i);}
...
(function(){var a="Could not parse color: ",b="_applyTheme",c="qx.theme.manager.Color",d="Theme",e="changeTheme",f="string",g="singleton";qx.Class.define(c,{type:g,extend:qx.util.ValueManager,properties:{theme:{check:d,nullable:true,apply:b,event:e}},members:{_applyTheme:function(j){var h={};if(j){var i=j.colors;for(var name in i){h[name]=this.__dz(i,name);}
;}
;this._setDynamic(h);}
,__dz:function(l,name){var k=l[name];if(typeof k===f){if(!qx.util.ColorUtil.isCssString(k)){if(l[k]!=undefined){return this.__dz(l,k);}
;throw new Error(a+k);}
;return k;}
...
else if(this.isRgbaString(y)){return this.__dB(y);}
else if(this.isRgbString(y)){return this.__dA();}
else if(this.isHex3String(y)){return this.__dC();}
else if(this.isHex6String(y)){return this.__dD();}
;throw new Error(a+y);}
,cssStringToRgb:function(z){if(this.isNamedColor(z)){return this.NAMED[z];}
else if(this.isSystemColor(z)){throw new Error(e+z);}
else if(this.isRgbString(z)){return this.__dA();}
else if(this.isRgbaString(z)){return this.__dB();}
else if(this.isHex3String(z)){return this.__dC();}
else if(this.isHex6String(z)){return this.__dD();}
;throw new Error(a+z);}
...
,__dA:function(){var L=parseInt(RegExp.$1,10);var K=parseInt(RegExp.$2,10);var J=parseInt(RegExp.$3,10);return [L,K,J];}
,__dB:function(){var P=parseInt(RegExp.$1,10);var O=parseInt(RegExp.$2,10);var M=parseInt(RegExp.$3,10);var N=parseFloat(RegExp.$4,10);if(P===0&&O===0&M===0&&N===0){return [-1,-1,-1];}
;return [P,O,M];}
,__dC:function(){var S=parseInt(RegExp.$1,16)*17;var R=parseInt(RegExp.$2,16)*17;var Q=parseInt(RegExp.$3,16)*17;return [S,R,Q];}
,__dD:function(){var V=(parseInt(RegExp.$1,16)*16)+parseInt(RegExp.$2,16);var U=(parseInt(RegExp.$3,16)*16)+parseInt(RegExp.$4,16);var T=(parseInt(RegExp.$5,16)*16)+parseInt(RegExp.$6,16);return [V,U,T];}
,hex3StringToRgb:function(W){if(this.isHex3String(W)){return this.__dC(W);}
;throw new Error(m+W);}
,hex3StringToHex6String:function(X){if(this.isHex3String(X)){return this.rgbToHexString(this.hex3StringToRgb(X));}
;return X;}
,hex6StringToRgb:function(Y){if(this.isHex6String(Y)){return this.__dD(Y);}
;throw new Error(q+Y);}
,hexStringToRgb:function(ba){if(this.isHex3String(ba)){return this.__dC(ba);}
;if(this.isHex6String(ba)){return this.__dD(ba);}
...
(function(){var a="mshtml",b="engine.name",c="_applyTheme",d="",e="'.",f="qx-",g="Unable to resolve decorator '",h="singleton",j=";",k="__dG",l="qx.theme.manager.Decoration",m=".",n="Theme",o="object",p="changeTheme",q="string",r="browser.documentmode",s=":";qx.Class.define(l,{type:h,extend:qx.core.Object,statics:{CSS_CLASSNAME_PREFIX:f},construct:function(){qx.core.Object.call(this);this.__dE=[];this.__dF=(qx.core.Environment.get(b)==a&&qx.core.Environment.get(r)<9);}
,properties:{theme:{check:n,nullable:true,apply:c,event:p}},members:{__dG:null,__dE:null,__dF:false,getCssClassName:function(u){var t=qx.theme.manager.Decoration.CSS_CLASSNAME_PREFIX;if(qx.lang.Type.isString(u)){return t+u;}
...
;if(!z){throw new Error(g+x+e);}
;var A=d;var v=z.getStyles(true);Object.keys(v).sort().forEach(function(E){if(qx.Bootstrap.isObject(v[E])){var B=d;var G=v[E];var D=false;for(var C in G){D=true;B+=C+s+G[C]+j;}
;var F=this.__dF?y:y+(D?s:d);this.__dE.push(F+E);w.addRule(F+E,B);return;}
;A+=E+s+v[E]+j;}
,this);if(A){w.addRule(y,A);this.__dE.push(y);}
;return x;}
,removeAllCssClasses:function(){for(var i=0;i<this.__dE.length;i++ ){var H=this.__dE[i];qx.ui.style.Stylesheet.getInstance().removeRule(H);}
;this.__dE=[];}
,resolve:function(L){if(!L){return null;}
;if(typeof L===o){return L;}
;var M=this.getTheme();if(!M){return null;}
;var J=this.__dG;if(!J){J=this.__dG={};}
...
,isCached:function(T){return !this.__dG?false:qx.lang.Object.contains(this.__dG,T);}
...
;}
;this.removeAllCssClasses();this._disposeMap(k);this.__dG={};}
...
(function(){var a="qx.ui.style.Stylesheet",b="singleton";qx.Class.define(a,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__dH=qx.bom.Stylesheet.createElement();this.__dE=[];}
,members:{__dE:null,__dH:null,addRule:function(d,c){if(this.hasRule(d)){return;}
;qx.bom.Stylesheet.addRule(this.__dH,d,c);this.__dE.push(d);}
,hasRule:function(e){return this.__dE.indexOf(e)!=-1;}
,removeRule:function(f){delete this.__dE[this.__dE.indexOf(f)];qx.bom.Stylesheet.removeRule(this.__dH,f);}
}});}
)();
(function(){var a="qx.bom.client.Stylesheet",b="html.stylesheet.deleterule",c="html.stylesheet.insertrule",d="function",e="html.stylesheet.createstylesheet",f="html.stylesheet.addimport",g="html.stylesheet.removeimport",h="object";qx.Bootstrap.define(a,{statics:{__dI:function(){if(!qx.bom.client.Stylesheet.__dJ){qx.bom.client.Stylesheet.__dJ=qx.bom.Stylesheet.createElement();}
;return qx.bom.client.Stylesheet.__dJ;}
,getCreateStyleSheet:function(){return typeof document.createStyleSheet===h;}
,getInsertRule:function(){return typeof qx.bom.client.Stylesheet.__dI().insertRule===d;}
,getDeleteRule:function(){return typeof qx.bom.client.Stylesheet.__dI().deleteRule===d;}
,getAddImport:function(){return (typeof qx.bom.client.Stylesheet.__dI().addImport===h);}
,getRemoveImport:function(){return (typeof qx.bom.client.Stylesheet.__dI().removeImport===h);}
...
,__dK:{},getHelperElement:function(I){if(!I){I=window;}
;var J=I.location.href;if(!qx.dom.Element.__dK[J]){var K=qx.dom.Element.__dK[J]=I.document.createElement(g);if(qx.core.Environment.get(a)==e){K.style.display=c;I.document.body.appendChild(K);}
;}
;return qx.dom.Element.__dK[J];}
...
;var J=this.__dL;name=J.names[name]||name;if(J.bools[name]&&!qx.lang.Type.isBoolean(K)){K=qx.lang.Type.isString(K);}
...
(function(){var a="abstract",b="Abstract method called.",c="qx.ui.decoration.Abstract";qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.decoration.IDecorator],type:a,members:{__dN:null,_getDefaultInsets:function(){throw new Error(b);}
,_isInitialized:function(){throw new Error(b);}
,_resetInsets:function(){this.__dN=null;}
,getInsets:function(){if(!this.__dN){this.__dN=this._getDefaultInsets();}
;return this.__dN;}
...
(function(){var a="0",b="qx/static",c="http://",d="https://",e="file://",f="qx.util.AliasManager",g="singleton",h=".",i="/",j="static";qx.Class.define(f,{type:g,extend:qx.util.ValueManager,construct:function(){qx.util.ValueManager.call(this);this.__dO={};this.add(j,b);}
,members:{__dO:null,_preprocess:function(n){var m=this._getDynamic();if(m[n]===false){return n;}
else if(m[n]===undefined){if(n.charAt(0)===i||n.charAt(0)===h||n.indexOf(c)===0||n.indexOf(d)===a||n.indexOf(e)===0){m[n]=false;return n;}
;if(this.__dO[n]){return this.__dO[n];}
;var l=n.substring(0,n.indexOf(i));var k=this.__dO[l];if(k!==undefined){m[n]=k+n.substring(l.length);}
;}
;return n;}
,add:function(o,q){this.__dO[o]=q;var p=this._getDynamic();for(var r in p){if(r.substring(0,r.indexOf(i))===o){p[r]=q+r.substring(o.length);}
;}
;}
,remove:function(s){delete this.__dO[s];}
,resolve:function(t){var u=this._getDynamic();if(t!=null){t=this._preprocess(t);}
;return u[t]||t;}
,getAliases:function(){var v={};for(var w in this.__dO){v[w]=this.__dO[w];}
;return v;}
...
(function(){var a="singleton",b="qx.util.LibraryManager";qx.Class.define(b,{extend:qx.core.Object,type:a,statics:{__dP:qx.$$libraries||{}},members:{has:function(c){return !!this.self(arguments).__dP[c];}
,get:function(d,e){return this.self(arguments).__dP[d][e]?this.self(arguments).__dP[d][e]:null;}
,set:function(f,g,h){this.self(arguments).__dP[f][g]=h;}
}});}
)();
...
,statics:{__H:qx.$$resources||{},__dQ:{}},members:{getIds:function(s){var u=this.self(arguments).__H;if(!u){return null;}
;var t=[];for(var r in u){if(u.hasOwnProperty(r)){if(s&&r.indexOf(s)==-1){continue;}
;t.push(r);}
;}
;return t;}
,has:function(v){return !!this.self(arguments).__H[v];}
,getData:function(w){return this.self(arguments).__H[w]||null;}
,getImageWidth:function(y){var x=this.self(arguments).__H[y];return x?x[0]:null;}
,getImageHeight:function(A){var z=this.self(arguments).__H[A];return z?z[1]:null;}
,getImageFormat:function(C){var B=this.self(arguments).__H[C];return B?B[2]:null;}
,getCombinedFormat:function(H){var E=e;var G=this.self(arguments).__H[H];var D=G&&G.length>4&&typeof (G[4])==i&&this.constructor.__H[G[4]];if(D){var I=G[4];var F=this.constructor.__H[I];E=F[2];}
;return E;}
,toUri:function(M){if(M==null){return M;}
;var J=this.self(arguments).__H[M];if(!J){return M;}
;if(typeof J===i){var L=J;}
else {var L=J[3];if(!L){return M;}
;}
;var K=e;if((qx.core.Environment.get(b)==a)&&qx.core.Environment.get(d)){K=this.self(arguments).__dQ[L];}
;return K+qx.util.LibraryManager.getInstance().get(L,n)+m+M;}
,toDataUri:function(P){var O=this.constructor.__H[P];var R=this.constructor.__H[O[4]];var Q;if(R){var N=R[4][P];Q=k+N[j]+l+N[f]+q+N[h];}
else {Q=this.toUri(P);}
;return Q;}
...
else {T.__dQ[U]=e;continue;}
;if(S.match(/^\/\//)!=null){T.__dQ[U]=window.location.protocol;}
else if(S.match(/^\//)!=null){T.__dQ[U]=window.location.protocol+c+window.location.host;}
else if(S.match(/^\.\//)!=null){var W=document.URL;T.__dQ[U]=W.substring(0,W.lastIndexOf(m)+1);}
else if(S.match(/^http/)!=null){T.__dQ[U]=e;}
else {var V=window.location.href.indexOf(g);var X;if(V==-1){X=window.location.href;}
else {X=window.location.href.substring(0,V);}
;T.__dQ[U]=X.substring(0,X.lastIndexOf(m)+1);}
;}
;}
;}
;}
...
;var bc=this.getInnerOpacity();if(bc<1){this.__dS(bd,bc);}
...
;}
,__dS:function(bh,be){if(!qx.core.Environment.get(F)){if(qx.core.Environment.get(m)){qx.log.Logger.warn(A);}
;return;}
...
,getLinearGradient:function(){qx.bom.client.Css.__dU=false;var cj=Q;var cg=document.createElement(o);var ch=qx.bom.Style.getAppliedStyle(cg,J,cj);if(!ch){cj=bN;var ch=qx.bom.Style.getAppliedStyle(cg,J,cj,false);if(ch){qx.bom.client.Css.__dU=true;}
;}
;if(!ch){return null;}
;var ci=/(.*?)\(/.exec(ch);return ci?ci[1]:null;}
,getFilterGradient:function(){return qx.bom.client.Css.__dV(bD,bA);}
...
,getLegacyWebkitGradient:function(){if(qx.bom.client.Css.__dU===null){qx.bom.client.Css.getLinearGradient();}
;return qx.bom.client.Css.__dU;}
...
,getFilterTextShadow:function(){return qx.bom.client.Css.__dV(L,W);}
,__dV:function(cv,ct){var cu=false;var cw=bR+cv+bG+ct+bJ;var cs=document.createElement(o);document.body.appendChild(cs);cs.style.filter=cw;if(cs.filters&&cs.filters.length>0&&cs.filters.item(cv).enabled==true){cu=true;}
...
;var V=qx.util.AliasManager.getInstance().resolve(this.getBorderImage());var W=this.__dW(V);return {top:this.getSliceTop()||W[0],right:this.getSliceRight()||W[1],bottom:this.getSliceBottom()||W[2],left:this.getSliceLeft()||W[3]};}
,_applyBorderImage:function(){if(qx.core.Environment.get(o)){if(this._isInitialized()){throw new Error(H);}
;}
;}
,__dW:function(be){var bd=this.getBorderImageMode();var bf=0;var bb=0;var bc=0;var bg=0;var bh=/(.*)(\.[a-z]+)$/.exec(be);var X=bh[1];var ba=bh[2];var Y=qx.util.ResourceManager.getInstance();if(bd==K||bd==w){bf=Y.getImageHeight(X+i+ba);bc=Y.getImageHeight(X+q+ba);}
...
;var bh=this.__ec;if(qx.core.Environment.get(u)){bh=this.__dX;}
else if(qx.core.Environment.get(g)&&!qx.core.Environment.get(K)&&qx.core.Environment.get(d)){bh=this.__dY;}
else if(qx.core.Environment.get(g)&&!qx.core.Environment.get(K)){bh=this.__eb;}
;var bj=[w,M,Y,j,V,H];(function(bo,bq,bt,br,bk,bn){for(var i=0;i<bo.length;i++ ){var bw=this.__ed(bo[i]);var bp=this.__ed(bq[i]);var bx=bt[i];var bm=br[i];var bl=bk[i];var bu=bn[i];if(!bh(bw,bp,bx,bm,bl,bu,bg,bi)){break;}
;}
...
,__dX:function(bH,bE,bI,bA,bz,bC,by,bD){bI=bI===c?D:bI;if(bA==P){var bG=bz+bI+a+bI;var bF=bC+bI+a+bI;}
else {var bG=m+bI+W+bz+bI;var bF=m+bI+W+bC+bI;}
;var bB=e+bH+b+bE+f;bD.push(o+bG+bf+bF+bf+bB+f);return true;}
,__dY:function bJ(bW,bQ,bY,bM,bL,bN,bK,bO){if(!bJ.__ea){bJ.__ea=document.createElement(I);}
...
;}
;bJ.__ea.width=bR;bJ.__ea.height=bP;var bT=bJ.__ea.getContext(U);if(bX){var bV=bT.createLinearGradient(0,0,0,bP);}
...
;bO.push(t+bJ.__ea.toDataURL()+A+ca);return true;}
,__eb:function(ci,ch,ck,cd,cc,ce,cb,cf){var cj=cd==P?1:0;if(!qx.util.ColorUtil.isHex6String(ci)){ci=qx.util.ColorUtil.stringToRgb(ci);ci=qx.util.ColorUtil.rgbToHexString(ci);}
...
;return false;}
,__ec:function(cu,cr,cv,co,cm,cp,cl,cq){var cw=co==P?0:270;var cs=cu+W+cm+cv;var cn=cr+W+cp+cv;var ct=qx.core.Environment.get(K);if(ct===bd){cw=co==P?cw+90:cw-90;}
;cq.push(ct+J+cw+s+cs+bf+cn+f);return true;}
,__ed:function(cx){return qx.core.Environment.get(y)?qx.theme.manager.Color.getInstance().resolve(cx):cx;}
...
(function(){var a=', ',b="qx.ui.decoration.Decorator",c="_style",d="_getDefaultInsetsFor",e="left",f="top",g="bottom",h="right";qx.Class.define(b,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],include:[qx.ui.decoration.MBackgroundColor,qx.ui.decoration.MBorderRadius,qx.ui.decoration.MBoxShadow,qx.ui.decoration.MDoubleBorder,qx.ui.decoration.MLinearBackgroundGradient,qx.ui.decoration.MBorderImage],members:{__ee:false,getPadding:function(){var l=this.getInset();var j=this._getDefaultInsetsForBorderImage();var o=l.top-(j.top?j.top:this.getWidthTop());var n=l.right-(j.right?j.right:this.getWidthRight());var k=l.bottom-(j.bottom?j.bottom:this.getWidthBottom());var m=l.left-(j.left?j.left:this.getWidthLeft());return {top:l.top?o:this.getInnerWidthTop(),right:l.right?n:this.getInnerWidthRight(),bottom:l.bottom?k:this.getInnerWidthBottom(),left:l.left?m:this.getInnerWidthLeft()};}
...
,_isInitialized:function(){return this.__ee;}
...
));for(var i=0;i<z.length;i++ ){this.__ef(z[i],y);}
;return z;}
,__ef:function(F,E){var G=F.length;while(F.length<E){F.push(F[F.length%G]);}
;}
}});}
)();
...
;var j=this.getTheme();if(j!==null&&j.fonts[l]){var m=this.__eh(j.fonts[l]);return k[l]=(new m).set(j.fonts[l]);}
;return l;}
,isDynamic:function(q){var p=this._dynamic;if(q&&(q instanceof qx.bom.Font||p[q]!==undefined)){return true;}
;var o=this.getTheme();if(o!==null&&q&&o.fonts[q]){var n=this.__eh(o.fonts[q]);p[q]=(new n).set(o.fonts[q]);return true;}
;return false;}
,__eg:function(s,r){if(s[r].include){var t=s[s[r].include];s[r].include=null;delete s[r].include;s[r]=qx.lang.Object.mergeWith(s[r],t,false);this.__eg(s,r);}
;}
,_applyTheme:function(y){var u=this._dynamic;for(var x in u){if(u[x].themed){u[x].dispose();delete u[x];}
;}
;if(y){var v=y.fonts;for(var x in v){if(v[x].include&&v[v[x].include]){this.__eg(v,x);}
;var w=this.__eh(v[x]);u[x]=(new w).set(v[x]);u[x].themed=true;}
;}
;this._setDynamic(u);}
,__eh:function(z){if(z.sources){return qx.bom.webfonts.WebFont;}
;return qx.bom.Font;}
},destruct:function(){this._disposeMap(c);}
});}
)();
(function(){var a="Boolean",b="px",c="_applyItalic",d="_applyBold",e="underline",f="_applyTextShadow",g="Integer",h="_applyFamily",j="_applyLineHeight",k='"',m="Array",n="line-through",o="overline",p="Color",q="String",r="",s="italic",t="normal",u="qx.bom.Font",v="bold",w="Number",x="_applyDecoration",y=" ",z="_applySize",A=",",B="_applyColor";qx.Class.define(u,{extend:qx.core.Object,construct:function(D,C){qx.core.Object.call(this);this.__ei={fontFamily:r,fontSize:null,fontWeight:null,fontStyle:null,textDecoration:null,lineHeight:null,color:null,textShadow:null};if(D!==undefined){this.setSize(D);}
...
,__ej:{fontFamily:r,fontSize:r,fontWeight:r,fontStyle:r,textDecoration:r,lineHeight:1.2,color:r,textShadow:r},getDefaultStyles:function(){return this.__ej;}
},properties:{size:{check:g,nullable:true,apply:z},lineHeight:{check:w,nullable:true,apply:j},comparisonString:{check:q,init:null,nullable:true},family:{check:m,nullable:true,apply:h},bold:{check:a,nullable:true,apply:d},italic:{check:a,nullable:true,apply:c},decoration:{check:[e,n,o],nullable:true,apply:x},color:{check:p,nullable:true,apply:B},textShadow:{nullable:true,check:q,apply:f}},members:{__ei:null,_applySize:function(M,L){this.__ei.fontSize=M===null?null:M+b;}
,_applyLineHeight:function(O,N){this.__ei.lineHeight=O===null?null:O;}
,_applyFamily:function(P,Q){var R=r;for(var i=0,l=P.length;i<l;i++ ){if(P[i].indexOf(y)>0){R+=k+P[i]+k;}
else {R+=P[i];}
;if(i!==l-1){R+=A;}
;}
;this.__ei.fontFamily=R;}
,_applyBold:function(T,S){this.__ei.fontWeight=T==null?null:T?v:t;}
,_applyItalic:function(V,U){this.__ei.fontStyle=V==null?null:V?s:t;}
,_applyDecoration:function(X,W){this.__ei.textDecoration=X==null?null:X;}
,_applyColor:function(ba,Y){this.__ei.color=null;if(ba){this.__ei.color=qx.theme.manager.Color.getInstance().resolve(ba);}
;}
,_applyTextShadow:function(bc,bb){this.__ei.textShadow=bc==null?null:bc;}
,getStyles:function(){return this.__ei;}
}});}
)();
(function(){var a="qx.bom.webfonts.WebFont",b="",c="qx.debug",d="changeStatus",e="_applySources",f="qx.event.type.Data",g=" was not applied, perhaps the source file could not be loaded.",h="WebFont ";qx.Class.define(a,{extend:qx.bom.Font,events:{"changeStatus":f},properties:{sources:{nullable:true,apply:e}},members:{__ek:null,_applySources:function(m,o){var j=[];for(var i=0,l=m.length;i<l;i++ ){var k=this._quoteFontFamily(m[i].family);j.push(k);var n=m[i];n.comparisonString=this.getComparisonString();qx.bom.webfonts.Manager.getInstance().require(k,n,this._onWebFontChangeStatus,this);}
...
(function(){var a="m",b="os.name",c=")",d="os.version",e="qx.bom.webfonts.Manager",f=".*font-style: *",g="svg",h="chrome",k="browser.name",n="singleton",o=",\n",p="src: ",q="mobileSafari",r="\nfont-style: ",s="');",t="qx.debug",u="interval",v="'eot)",w="#",y="firefox",z="!",A="eot",B="ios",C="changeStatus",D="Couldn't create @font-face rule for WebFont ",E="}\n",F="font-family: ",G="browser.documentmode",H="mobile safari",I="safari",J="@font-face.*?",K=";",L="",M="ttf",N="_",O="') format('svg')",P=";\n",Q="('embedded-opentype')",R="browser.version",S="opera",T="engine.version",U="') format('woff')",V="normal",W="mshtml",X="engine.name",Y="url('",bq="src: url('",br="('embedded-opentype)",bs="\nfont-weight: ",bm=".*font-weight: *",bn="?#iefix') format('embedded-opentype')",bo="woff",bp="ie",bu="\.(",bv="'eot')",bw="Error while adding @font-face rule:",bx="@font-face {",bt="') format('truetype')";qx.Class.define(e,{extend:qx.core.Object,type:n,construct:function(){qx.core.Object.call(this);this.__el=[];this.__em={};this.__en=[];this.__eo=this.getPreferredFormats();}
,statics:{FONT_FORMATS:[A,bo,M,g],VALIDATION_TIMEOUT:5000},members:{__el:null,__ep:null,__em:null,__eo:null,__en:null,__eq:null,require:function(bC,bI,bE,bH){var bB=bI.source;var bA=bI.comparisonString;var bD=bI.fontWeight;var bz=bI.fontStyle;var bF=[];for(var i=0,l=bB.length;i<l;i++ ){var bG=bB[i].split(w);var by=qx.util.ResourceManager.getInstance().toUri(bG[0]);if(bG.length>1){by=by+w+bG[1];}
;bF.push(by);}
;if(qx.core.Environment.get(X)==W&&(parseInt(qx.core.Environment.get(T))<9||qx.core.Environment.get(G)<9)){if(!this.__eq){this.__eq=new qx.event.Timer(100);this.__eq.addListener(u,this.__et,this);}
;if(!this.__eq.isEnabled()){this.__eq.start();}
;this.__en.push([bC,bF,bD,bz,bA,bE,bH]);}
else {this.__es(bC,bF,bD,bz,bA,bE,bH);}
;}
,remove:function(bL,bM,bN){var bK=this.__er(bL,bM,bN);var bJ=null;for(var i=0,l=this.__el.length;i<l;i++ ){if(this.__el[i]==bK){bJ=i;this.__ez(bL,bM,bN);break;}
;}
;if(bJ!==null){qx.lang.Array.removeAt(this.__el,bJ);}
;if(bL in this.__em){this.__em[bL].dispose();delete this.__em[bL];}
;}
,getPreferredFormats:function(){var bO=[];var bS=qx.core.Environment.get(k);var bP=qx.core.Environment.get(R);var bR=qx.core.Environment.get(b);var bQ=qx.core.Environment.get(d);if((bS==bp&&qx.core.Environment.get(G)>=9)||(bS==y&&bP>=3.6)||(bS==h&&bP>=6)){bO.push(bo);}
;if((bS==S&&bP>=10)||(bS==I&&bP>=3.1)||(bS==y&&bP>=3.5)||(bS==h&&bP>=4)||(bS==H&&bR==B&&bQ>=4.2)){bO.push(M);}
;if(bS==bp&&bP>=4){bO.push(A);}
;if(bS==q&&bR==B&&bQ>=4.1){bO.push(g);}
;return bO;}
,removeStyleSheet:function(){this.__el=[];if(this.__ep){qx.bom.Stylesheet.removeSheet(this.__ep);}
;this.__ep=null;}
,__er:function(bU,bT,bW){var bV=bU+N+(bT?bT:V)+N+(bW?bW:V);return bV;}
,__es:function(cc,cg,cb,bY,ca,ce,ch){var cf=this.__er(cc,cb,bY);if(!qx.lang.Array.contains(this.__el,cf)){var ci=this.__ev(cg);var cd=this.__ew(cc,cb,bY,ci);if(!cd){throw new Error(D+cc+z);}
;if(!this.__ep){this.__ep=qx.bom.Stylesheet.createElement();}
;try{this.__ey(cd);}
catch(cj){if(qx.core.Environment.get(t)){this.warn(bw,cj.message);return;}
;}
;this.__el.push(cf);}
;if(!this.__em[cc]){this.__em[cc]=new qx.bom.webfonts.Validator(cc,ca);this.__em[cc].setTimeout(qx.bom.webfonts.Manager.VALIDATION_TIMEOUT);this.__em[cc].addListenerOnce(C,this.__eu,this);}
;if(ce){var bX=ch||window;this.__em[cc].addListenerOnce(C,ce,bX);}
;this.__em[cc].validate();}
,__et:function(){if(this.__en.length==0){this.__eq.stop();return;}
;var ck=this.__en.shift();this.__es.apply(this,ck);}
,__eu:function(cl){var cm=cl.getData();if(cm.valid===false){qx.event.Timer.once(function(){this.remove(cm.family);}
,this,250);}
;}
,__ev:function(cn){var cp=qx.bom.webfonts.Manager.FONT_FORMATS;var co={};for(var i=0,l=cn.length;i<l;i++ ){var cq=null;for(var x=0;x<cp.length;x++ ){var cr=new RegExp(bu+cp[x]+c);var cs=cr.exec(cn[i]);if(cs){cq=cs[1];}
;}
;if(cq){co[cq]=cn[i];}
;}
;return co;}
,__ew:function(cw,ct,cz,cA){var cy=[];var cu=this.__eo.length>0?this.__eo:qx.bom.webfonts.Manager.FONT_FORMATS;for(var i=0,l=cu.length;i<l;i++ ){var cv=cu[i];if(cA[cv]){cy.push(this.__ex(cv,cA[cv]));}
;}
;var cx=p+cy.join(o)+K;cx=F+cw+P+cx;cx=cx+r+(cz?cz:V)+K;cx=cx+bs+(ct?ct:V)+K;return cx;}
,__ex:function(cC,cB){switch(cC){case A:return Y+cB+s+bq+cB+bn;case bo:return Y+cB+U;case M:return Y+cB+bt;case g:return Y+cB+O;default:return null;};}
,__ey:function(cE){var cD=bx+cE+E;if(qx.core.Environment.get(k)==bp&&qx.core.Environment.get(G)<9){var cF=this.__eA(this.__ep.cssText);cF+=cD;this.__ep.cssText=cF;}
else {this.__ep.insertRule(cD,this.__ep.cssRules.length);}
;}
,__ez:function(cJ,cK,cG){var cL=new RegExp(J+cJ+f+(cG?cG:V)+bm+(cK?cK:V),a);for(var i=0,l=document.styleSheets.length;i<l;i++ ){var cH=document.styleSheets[i];if(cH.cssText){var cI=cH.cssText.replace(/\n/g,L).replace(/\r/g,L);cI=this.__eA(cI);if(cL.exec(cI)){cI=cI.replace(cL,L);}
;cH.cssText=cI;}
else if(cH.cssRules){for(var j=0,m=cH.cssRules.length;j<m;j++ ){var cI=cH.cssRules[j].cssText.replace(/\n/g,L).replace(/\r/g,L);if(cL.exec(cI)){this.__ep.deleteRule(j);return;}
;}
;}
;}
;}
,__eA:function(cM){return cM.replace(v,bv).replace(br,Q);}
},destruct:function(){if(this.__eq){this.__eq.stop();this.__eq.dispose();}
;delete this.__el;this.removeStyleSheet();for(var cN in this.__em){this.__em[cN].dispose();}
...
;var self=this;this.__eB=function(){self._oninterval.call(self);}
;}
...
;var p=new qx.event.Timer(o);p.__eC=m;p.addListener(c,function(e){p.stop();m.call(n,e);p.dispose();n=null;}
,n);p.start();return p;}
},properties:{enabled:{init:true,check:f,apply:k},interval:{check:i,init:1000,apply:b}},members:{__eD:null,__eB:null,_applyInterval:function(r,q){if(this.getEnabled()){this.restart();}
;}
,_applyEnabled:function(t,s){if(s){window.clearInterval(this.__eD);this.__eD=null;}
else if(t){this.__eD=window.setInterval(this.__eB,this.getInterval());}
;}
...
;}
)},destruct:function(){if(this.__eD){window.clearInterval(this.__eD);}
;this.__eD=this.__eB=null;}
});}
)();
(function(){var a="sans-serif",b="changeStatus",c="Integer",d="auto",e="qx.event.type.Data",f="0",g="qx.bom.webfonts.Validator",h="interval",i="Georgia",j="WEei",k="visible",l="Times New Roman",m="__eH",n="Arial",o="normal",p="Helvetica",q="350px",r="_applyFontFamily",s="-1000px",t="hidden",u="serif",v="span",w="absolute",x=",";qx.Class.define(g,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);if(z){this.setComparisonString(z);}
;if(y){this.setFontFamily(y);this.__eE=this._getRequestedHelpers();}
;}
,statics:{COMPARISON_FONTS:{sans:[n,p,a],serif:[l,i,u]},HELPER_CSS:{position:w,margin:f,padding:f,top:s,left:s,fontSize:q,width:d,height:d,lineHeight:o,fontVariant:o,visibility:t},COMPARISON_STRING:j,__eF:null,__eG:null,removeDefaultHelperElements:function(){var A=qx.bom.webfonts.Validator.__eG;if(A){for(var B in A){document.body.removeChild(A[B]);}
;}
;delete qx.bom.webfonts.Validator.__eG;}
},properties:{fontFamily:{nullable:true,init:null,apply:r},comparisonString:{nullable:true,init:null},timeout:{check:c,init:5000}},events:{"changeStatus":e},members:{__eE:null,__eH:null,__eI:null,validate:function(){this.__eI=new Date().getTime();if(this.__eH){this.__eH.restart();}
else {this.__eH=new qx.event.Timer(100);this.__eH.addListener(h,this.__eK,this);qx.event.Timer.once(function(){this.__eH.start();}
,this,0);}
;}
,_reset:function(){if(this.__eE){for(var D in this.__eE){var C=this.__eE[D];document.body.removeChild(C);}
;this.__eE=null;}
;}
,_isFontValid:function(){if(!qx.bom.webfonts.Validator.__eF){this.__eJ();}
;if(!this.__eE){this.__eE=this._getRequestedHelpers();}
;this.__eE.sans.style.visibility=k;this.__eE.sans.style.visibility=t;this.__eE.serif.style.visibility=k;this.__eE.serif.style.visibility=t;var F=qx.bom.element.Dimension.getWidth(this.__eE.sans);var E=qx.bom.element.Dimension.getWidth(this.__eE.serif);var G=qx.bom.webfonts.Validator;if(F!==G.__eF.sans||E!==G.__eF.serif){return true;}
;return false;}
...
;}
,__eJ:function(){var P=qx.bom.webfonts.Validator;if(!P.__eG){P.__eG={sans:this._getHelperElement(P.COMPARISON_FONTS.sans),serif:this._getHelperElement(P.COMPARISON_FONTS.serif)};}
;P.__eF={sans:qx.bom.element.Dimension.getWidth(P.__eG.sans),serif:qx.bom.element.Dimension.getWidth(P.__eG.serif)};}
,__eK:function(){if(this._isFontValid()){this.__eH.stop();this._reset();this.fireDataEvent(b,{family:this.getFontFamily(),valid:true});}
else {var Q=new Date().getTime();if(Q-this.__eI>=this.getTimeout()){this.__eH.stop();this._reset();this.fireDataEvent(b,{family:this.getFontFamily(),valid:false});}
;}
;}
},destruct:function(){this._reset();this.__eH.stop();this.__eH.removeListener(h,this.__eK,this);this._disposeObjects(m);}
});}
)();
...
,__eL:{visible:true,hidden:true},getContentWidth:function(t){var q=qx.bom.element.Style;var r=qx.bom.element.Style.get(t,j);var s=parseInt(q.get(t,f)||d,10);var w=parseInt(q.get(t,e)||d,10);if(this.__eL[r]){var v=t.clientWidth;if((qx.core.Environment.get(b)==g)||qx.dom.Node.isBlockNode(t)){v=v-s-w;}
...
;}
;}
,getContentHeight:function(B){var x=qx.bom.element.Style;var A=qx.bom.element.Style.get(B,k);var z=parseInt(x.get(B,i)||d,10);var y=parseInt(x.get(B,h)||d,10);if(this.__eL[A]){return B.clientHeight-z-y;}
...
(function(){var a="cursor:",b="engine.name",c="",d="mshtml",e="nw-resize",f="engine.version",g="nesw-resize",h="browser.documentmode",i=";",j="nwse-resize",k="qx.bom.element.Cursor",l="ne-resize",m="browser.quirksmode",n="cursor";qx.Bootstrap.define(k,{statics:{__eM:{},compile:function(o){return a+(this.__eM[o]||o)+i;}
,get:function(q,p){return qx.bom.element.Style.get(q,n,p,false);}
,set:function(s,r){s.style.cursor=this.__eM[r]||r;}
,reset:function(t){t.style.cursor=c;}
},defer:function(u){if(qx.core.Environment.get(b)==d&&((parseFloat(qx.core.Environment.get(f))<9||qx.core.Environment.get(h)<9)&&!qx.core.Environment.get(m))){u.__eM[g]=l;u.__eM[j]=e;}
;}
});}
)();
(function(){var a="This client does not support the boxSizing value",b="border-box",c="qx.bom.element.BoxSizing",d="css.boxsizing",e="",f="This client does not support dynamic modification of the boxSizing property.",g="qx.debug",h="boxSizing",i="content-box",j=":",k=";";qx.Bootstrap.define(c,{statics:{__eN:{tags:{button:true,select:true},types:{search:true,button:true,submit:true,reset:true,checkbox:true,radio:true}},__eO:function(m){var l=this.__eN;return l.tags[m.tagName.toLowerCase()]||l.types[m.type];}
...
;if(qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(p))){if(!this.__eO(p)){return i;}
;}
;return b;}
...
(function(){var a="css.float",b='cssFloat',c="px",d="Cascaded styles are not supported in this browser!",e="css.appearance",f="pixelRight",g="css.userselect",h="css.boxsizing",i="css.textoverflow",j="qx.debug",k="pixelHeight",l=":",m="pixelTop",n="css.borderimage",o="Invalid argument 'name'",p="pixelLeft",q="css.usermodify",r="qx.bom.element.Style",s="Invalid argument 'smart'",t="",u="pixelBottom",v="Invalid argument 'styles'",w="pixelWidth",x='float',y=";",z="\"\"",A="Invalid argument 'element'",B="style";qx.Bootstrap.define(r,{statics:{__eP:null,__eQ:null,__eR:function(){var D={"appearance":qx.core.Environment.get(e),"userSelect":qx.core.Environment.get(g),"textOverflow":qx.core.Environment.get(i),"borderImage":qx.core.Environment.get(n),"float":qx.core.Environment.get(a),"userModify":qx.core.Environment.get(q),"boxSizing":qx.core.Environment.get(h)};this.__eQ={};for(var C in qx.lang.Object.clone(D)){if(!D[C]){delete D[C];}
else {if(C===x){this.__eQ[b]=C;}
else {this.__eQ[C]=qx.bom.Style.getCssName(D[C]);}
;}
;}
;this.__eP=D;}
,__eS:function(name){var E=qx.bom.Style.getPropertyName(name);if(E){this.__eP[name]=E;}
;return E;}
,__eT:{width:w,height:k,left:p,right:f,top:m,bottom:u},__eU:{clip:qx.bom.element.Clip,cursor:qx.bom.element.Cursor,opacity:qx.bom.element.Opacity,boxSizing:qx.bom.element.BoxSizing},compile:function(F){var I=[];var J=this.__eU;var H=this.__eQ;var name,G;for(name in F){G=F[name];if(G==null){continue;}
;name=this.__eQ[name]||name;if(J[name]){I.push(J[name].compile(G));}
...
,isPropertySupported:function(N){return (this.__eU[N]||this.__eP[N]||N in document.documentElement.style);}
...
;}
;name=this.__eP[name]||this.__eS(name)||name;if(O!==false&&this.__eU[name]){this.__eU[name].set(Q,P);}
...
;}
;var U=this.__eP;var Y=this.__eU;var S=X.style;for(var W in R){var T=R[W];var name=U[W]||this.__eS(W)||W;if(T===undefined){if(V!==false&&Y[name]){Y[name].reset(X);}
else {S[name]=t;}
;}
...
;}
;}
,reset:function(bb,name,ba){name=this.__eP[name]||this.__eS(name)||name;if(ba!==false&&this.__eU[name]){this.__eU[name].reset(bb);}
else {bb.style[name]=t;}
;}
,get:function(bf,name,bh,bj){name=this.__eP[name]||this.__eS(name)||name;if(bj!==false&&this.__eU[name]){return this.__eU[name].get(bf,bh);}
...
;var bk=this.__eT[name];if(bk&&(bk in bf.style)){var bi=bf.style[name];bf.style[name]=bl||0;var be=bf.style[bk]+c;bf.style[name]=bi;return be;}
;return bl;}
;return bf.style[name]||t;};}
},defer:function(bm){bm.__eR();}
});}
)();
...
,__eV:function(m){var o=this.getWidth(m)>this.getHeight(m)?90:0;var n=m.orientation;if(n==null||Math.abs(n%180)==o){return {"-270":90,"-180":180,"-90":-90,"0":0,"90":90,"180":180,"270":-90};}
else {return {"-270":180,"-180":-90,"-90":0,"0":90,"90":180,"180":-90,"270":0};}
;}
,__eW:null,getOrientation:function(p){var p=p||window.top;var q=p.orientation;if(q==null){q=this.getWidth(p)>this.getHeight(p)?90:0;}
else {if(this.__eW==null){this.__eW=this.__eV(p);}
;q=this.__eW[q];}
;return q;}
...
(function(){var a="'.",b="Missing appearance: ",c="_applyTheme",d="qx.debug",e="string",f="Cannot find a matching appearance for '",g="Hint: This may be an issue with nested child controls and a missing alias definition in the appearance theme.",h="qx.theme.manager.Appearance",j=":",k="Theme",l="undefined",m="changeTheme",n="/",o="singleton";qx.Class.define(h,{type:o,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__eX={};this.__eY={};}
,properties:{theme:{check:k,nullable:true,event:m,apply:c}},members:{__fa:{},__eX:null,__eY:null,_applyTheme:function(){this.__eY={};this.__eX={};}
,__fb:function(D,z,q,u){var w=z.appearances;var r=w[D];if(!r){var C=n;var s=[];var v=D.split(C);var B=qx.lang.Array.clone(v);var y;while(!r&&v.length>0){s.unshift(v.pop());var t=v.join(C);r=w[t];if(r){y=r.alias||r;if(typeof y===e){var A=y+C+s.join(C);return this.__fb(A,z,q,B);}
;}
;}
;for(var i=0;i<s.length-1;i++ ){s.shift();var x=s.join(C);var p=this.__fb(x,z,null,B);if(p){return p;}
;}
;if(q!=null){return this.__fb(q,z,null,B);}
;if(qx.core.Environment.get(d)){if(typeof u!==l){this.debug(f+u.join(n)+a);if(u.length>1){this.info(g);}
;}
;}
;return null;}
else if(typeof r===e){return this.__fb(r,z,q,B);}
else if(r.include&&!r.style){return this.__fb(r.include,z,q,B);}
;return D;}
,styleFrom:function(W,O,P,F){if(!P){P=this.getTheme();}
;var M=this.__eY;var E=M[W];if(!E){E=M[W]=this.__fb(W,P,F);}
...
;if(J>0){U+=j+J;}
;}
;var K=this.__eX;if(K[U]!==undefined){return K[U];}
;if(!O){O=this.__fa;}
...
;return K[U]=R||null;}
},destruct:function(){this.__eX=this.__eY=null;}
});}
)();
...
;W.include=this.__fc(W.include);W.patch=this.__fc(W.patch);if(qx.core.Environment.get(q)){this.__V(name,W);}
;var V={$$type:Q,name:name,title:W.title,toString:this.genericToString};if(W.extend){V.supertheme=W.extend;}
;V.basename=qx.Bootstrap.createNamespace(name,V);this.__ff(V,W);this.__fd(V,W);this.$$registry[name]=V;for(var i=0,a=W.include,l=a.length;i<l;i++ ){this.include(V,a[i]);}
;for(var i=0,a=W.patch,l=a.length;i<l;i++ ){this.patch(V,a[i]);}
;}
,__fc:function(X){if(!X){return [];}
;if(qx.Bootstrap.isArray(X)){return X;}
else {return [X];}
;}
,__fd:function(Y,ba){var bb=ba.aliases||{};if(ba.extend&&ba.extend.aliases){qx.Bootstrap.objectMergeWith(bb,ba.extend.aliases,false);}
;Y.aliases=bb;}
...
,__fe:function(bd){for(var i=0,bc=this.__fg,l=bc.length;i<l;i++ ){if(bd[bc[i]]){return bc[i];}
;}
;}
,__ff:function(bi,bj){var bf=this.__fe(bj);if(bj.extend&&!bf){bf=bj.extend.type;}
...
,$$registry:{},__fg:[N,u,n,d,j,s,e,R],__U:qx.core.Environment.select(q,{"true":{"title":m,"aliases":U,"type":m,"extend":U,"colors":U,"borders":U,"decorations":U,"fonts":U,"icons":U,"widgets":U,"appearances":U,"meta":U,"include":U,"patch":U},"default":null}),__fh:qx.core.Environment.select(q,{"true":{"color":U,"border":U,"decoration":U,"font":U,"icon":U,"appearance":U,"widget":U},"default":null}),__V:qx.core.Environment.select(q,{"true":function(name,bq){var bp=this.__U;for(var bo in bq){if(bp[bo]===undefined){throw new Error(f+bo+M+name+h);}
...
;}
;if(bq.meta){var bm;for(var bo in bq.meta){bm=bq.meta[bo];if(this.__fh[bo]===undefined){throw new Error(C+bo+S);}
;if(typeof bm!==this.__fh[bo]){throw new Error(I+bo+L);}
...
;}
,"default":function(){}
}),patch:function(bu,bs){this.__fi(bs);var bw=this.__fe(bs);if(bw!==this.__fe(bu)){throw new Error(w+bu.name+v+bs.name+b);}
;var bt=bs[bw];var br=bu.$$clazz.prototype;for(var bv in bt){br[bv]=bt[bv];}
;}
,include:function(bA,by){this.__fi(by);var bC=by.type;if(bC!==bA.type){throw new Error(w+bA.name+v+by.name+b);}
;var bz=by[bC];var bx=bA.$$clazz.prototype;for(var bB in bz){if(bx[bB]!==undefined){continue;}
;bx[bB]=bz[bB];}
;}
,__fi:function(bD){if(typeof bD===H||bD==null){var bF=new Error(g);if(qx.core.Environment.get(q)){var bE=qx.dev.StackTrace.getStackTraceFromError(bF);qx.Bootstrap.error(this,bE);}
;throw bF;}
;}
}});}
)();
(function(){var a="__fk",b="qx.ui.tooltip.ToolTip",c="Boolean",d="",f="mouse",g="pointerover",h="interval",i="__fm",j="_applyCurrent",k="widget",l="__fj",m="qx.ui.tooltip.Manager",n="pointermove",o="focusout",p="tooltip-error",q="singleton",r="pointerout";qx.Class.define(m,{type:q,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);qx.event.Registration.addListener(document.body,g,this.__fr,this,true);this.__fj=new qx.event.Timer();this.__fj.addListener(h,this.__fo,this);this.__fk=new qx.event.Timer();this.__fk.addListener(h,this.__fp,this);this.__fl={left:0,top:0};}
,properties:{current:{check:b,nullable:true,apply:j},showInvalidToolTips:{check:c,init:true},showToolTips:{check:c,init:true}},members:{__fl:null,__fk:null,__fj:null,__fm:null,__fn:null,getSharedTooltip:function(){if(!this.__fm){this.__fm=new qx.ui.tooltip.ToolTip().set({rich:true});}
;return this.__fm;}
,getSharedErrorTooltip:function(){if(!this.__fn){this.__fn=new qx.ui.tooltip.ToolTip().set({appearance:p,rich:true});this.__fn.setLabel(d);this.__fn.syncAppearance();}
;return this.__fn;}
,_applyCurrent:function(u,t){if(t&&qx.ui.core.Widget.contains(t,u)){return;}
;if(t){if(!t.isDisposed()){t.exclude();}
;this.__fj.stop();this.__fk.stop();}
;var v=qx.event.Registration;var s=document.body;if(u){this.__fj.startWith(u.getShowTimeout());v.addListener(s,r,this.__fs,this,true);v.addListener(s,o,this.__ft,this,true);v.addListener(s,n,this.__fq,this,true);}
else {v.removeListener(s,r,this.__fs,this,true);v.removeListener(s,o,this.__ft,this,true);v.removeListener(s,n,this.__fq,this,true);}
;}
,__fo:function(e){var w=this.getCurrent();if(w&&!w.isDisposed()){this.__fk.startWith(w.getHideTimeout());if(w.getPlaceMethod()==k){w.placeToWidget(w.getOpener());}
else {w.placeToPoint(this.__fl);}
;w.show();}
;this.__fj.stop();}
,__fp:function(e){var x=this.getCurrent();if(x&&!x.isDisposed()){x.exclude();}
;this.__fk.stop();this.resetCurrent();}
,__fq:function(e){var y=this.__fl;y.left=Math.round(e.getDocumentLeft());y.top=Math.round(e.getDocumentTop());}
,__fr:function(e){var z=qx.ui.core.Widget.getWidgetByElement(e.getTarget());this.__fq(e);this.showToolTip(z);}
...
,__fs:function(e){var F=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!F){return;}
...
;}
,__ft:function(e){var I=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!I){return;}
;var J=this.getCurrent();if(J&&J==I.getToolTip()){this.setCurrent(null);}
;}
},destruct:function(){qx.event.Registration.removeListener(document.body,g,this.__fr,this,true);this._disposeObjects(l,a,i);this.__fl=null;}
});}
)();
...
;}
;}
,"false":null}),__fu:null,__fv:null,__fw:null,__fx:null,__fy:null,__fz:null,__fA:null,getBounds:function(){return this.__fz||this.__fv||null;}
...
;if(P!=null&&P!==this.__fu){this.__fu=P;qx.ui.core.queue.Layout.add(this);return null;}
;var O=this.__fv;if(!O){O=this.__fv={};}
;var T={};if(U!==O.left||top!==O.top){T.position=true;O.left=U;O.top=top;}
;if(R!==O.width||Q!==O.height){T.size=true;O.width=R;O.height=Q;}
;if(this.__fw){T.local=true;delete this.__fw;}
;if(this.__fy){T.margin=true;delete this.__fy;}
;return T;}
,isExcluded:function(){return false;}
,hasValidLayout:function(){return !this.__fw;}
,scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);}
,invalidateLayoutCache:function(){this.__fw=true;this.__fx=null;}
,getSizeHint:function(V){var W=this.__fx;if(W){return W;}
;if(V===false){return null;}
;W=this.__fx=this._computeSizeHint();if(this._hasHeightForWidth()&&this.__fu&&this.getHeight()==null){W.height=this.__fu;}
...
,_applyMargin:function(){this.__fy=true;var parent=this.$$parent;if(parent){parent.updateLayoutProperties();}
;}
,_applyAlign:function(){var parent=this.$$parent;if(parent){parent.updateLayoutProperties();}
;}
,_applyDimension:function(){qx.ui.core.queue.Layout.add(this);}
,_applyStretching:function(){qx.ui.core.queue.Layout.add(this);}
,hasUserBounds:function(){return !!this.__fz;}
,setUserBounds:function(bi,top,bh,bj){this.__fz={left:bi,top:top,width:bh,height:bj};qx.ui.core.queue.Layout.add(this);}
,resetUserBounds:function(){delete this.__fz;qx.ui.core.queue.Layout.add(this);}
,__fB:{},setLayoutProperties:function(bm){if(bm==null){return;}
;var bk=this.__fA;if(!bk){bk=this.__fA={};}
...
;return null;}
,clone:function(){var bq=qx.core.Object.prototype.clone.call(this);var br=this.__fA;if(br){bq.__fA=qx.lang.Object.clone(br);}
;return bq;}
...
;this.$$parent=this.$$subparent=this.__fA=this.__fv=this.__fz=this.__fx=null;}
});}
)();
...
(function(){var a="qx.ui.core.queue.Layout",b="layout";qx.Class.define(a,{statics:{__en:{},__fC:{},remove:function(c){delete this.__en[c.$$hash];}
,add:function(d){this.__en[d.$$hash]=d;qx.ui.core.queue.Manager.scheduleFlush(b);}
,isScheduled:function(e){return !!this.__en[e.$$hash];}
,flush:function(){var f=this.__fE();for(var i=f.length-1;i>=0;i-- ){var g=f[i];if(g.hasValidLayout()){continue;}
...
;}
;}
,getNestingLevel:function(l){var k=this.__fC;var n=0;var parent=l;while(true){if(k[parent.$$hash]!=null){n+=k[parent.$$hash];break;}
;if(!parent.$$parent){break;}
;parent=parent.$$parent;n+=1;}
;var m=n;while(l&&l!==parent){k[l.$$hash]=m-- ;l=l.$$parent;}
;return n;}
,__fD:function(){var t=qx.ui.core.queue.Visibility;this.__fC={};var s=[];var r=this.__en;var o,q;for(var p in r){o=r[p];if(t.isVisible(o)){q=this.getNestingLevel(o);if(!s[q]){s[q]={};}
;s[q][p]=o;delete r[p];}
;}
;return s;}
,__fE:function(){var x=[];var z=this.__fD();for(var w=z.length-1;w>=0;w-- ){if(!z[w]){continue;}
...
;var y=qx.lang.Array.cast(w,v);for(var i=0;i<qxWeb.__eJ.length;i++ ){qxWeb.__eJ[i].call(y);}
;return y;}
...
;}
,$attachInit:function(G){this.__eJ.push(G);}
...
;}
;return null;}
,_getWidth:function(t){var u=this[0];if(u){if(qx.dom.Node.isElement(u)){var r;if(t){var s={display:c,position:m,visibility:h};r=qx.module.Css.__fH(u,s,j,this);}
...
;}
;return null;}
,_getContentHeight:function(w){var y=this[0];if(qx.dom.Node.isElement(y)){var x;if(w){var v={position:m,visibility:h,display:c};x=qx.module.Css.__fH(y,v,g,this);}
else {x=qx.bom.element.Dimension.getContentHeight(y);}
;return x;}
;return null;}
,_getContentWidth:function(B){var z=this[0];if(qx.dom.Node.isElement(z)){var C;if(B){var A={position:m,visibility:h,display:c};C=qx.module.Css.__fH(z,A,f,this);}
else {C=qx.bom.element.Dimension.getContentWidth(z);}
;return C;}
;return null;}
,__fF:{},__fG:function(G,D){var F=qx.module.Css.__fF;if(!F[G]){var H=D||document;var E=qxWeb(H.createElement(G)).appendTo(D.body);F[G]=E.getStyle(a);E.remove();}
;return F[G]||b;}
,__fH:function(L,I,J,O){var M={};for(var N in I){M[N]=L.style[N];L.style[N]=I[N];}
...
else {var ba=qxWeb.getDocument(X[0]);V=qx.module.Css.__fG(X[0].tagName,ba);}
...
(function(){var a="borderBottomWidth",b="scroll",c="qx.bom.element.Location",d="gecko",e="paddingLeft",f="borderRightWidth",g="auto",h="static",i="borderTopWidth",j="borderLeftWidth",k="marginBottom",l="marginTop",m="overflowY",n="marginLeft",o="border-box",p="padding",q="paddingBottom",r="paddingTop",s="marginRight",t="browser.quirksmode",u="engine.name",v="position",w="margin",x="paddingRight",y="BODY",z="overflowX",A="border";qx.Bootstrap.define(c,{statics:{__fI:function(C,B){return qx.bom.element.Style.get(C,B,qx.bom.element.Style.COMPUTED_MODE,false);}
,__fJ:function(E,D){return parseInt(qx.bom.element.Style.get(E,D,qx.bom.element.Style.COMPUTED_MODE,false),10)||0;}
,__fK:function(G){var H=0,top=0;var F=qx.dom.Node.getWindow(G);H-=qx.bom.Viewport.getScrollLeft(F);top-=qx.bom.Viewport.getScrollTop(F);return {left:H,top:top};}
,__fL:qx.core.Environment.select(u,{"mshtml":function(K){var J=qx.dom.Node.getDocument(K);var I=J.body;var L=0;var top=0;L-=I.clientLeft+J.documentElement.clientLeft;top-=I.clientTop+J.documentElement.clientTop;if(!qx.core.Environment.get(t)){L+=this.__fJ(I,j);top+=this.__fJ(I,i);}
...
,"gecko":function(R){var Q=qx.dom.Node.getDocument(R).body;var S=Q.offsetLeft;var top=Q.offsetTop;if(qx.bom.element.BoxSizing.get(Q)!==o){S+=this.__fJ(Q,j);top+=this.__fJ(Q,i);}
;return {left:S,top:top};}
,"default":function(U){var T=qx.dom.Node.getDocument(U).body;var V=T.offsetLeft;var top=T.offsetTop;return {left:V,top:top};}
}),__fM:function(W){var X=W.getBoundingClientRect();return {left:Math.round(X.left),top:Math.round(X.top)};}
,get:function(bf,bg){if(bf.tagName==y){var location=this.__fN(bf);var bj=location.left;var top=location.top;}
else {var Y=this.__fL(bf);var bd=this.__fM(bf);var scroll=this.__fK(bf);var bj=bd.left+Y.left-scroll.left;var top=bd.top+Y.top-scroll.top;}
...
;var bb=bj+ba;var bc=top+be;if(bg){if(bg==p||bg==b){var bi=qx.bom.element.Style.get(bf,z);if(bi==b||bi==g){bb+=bf.scrollWidth-ba+this.__fJ(bf,j)+this.__fJ(bf,f);}
;var bh=qx.bom.element.Style.get(bf,m);if(bh==b||bh==g){bc+=bf.scrollHeight-be+this.__fJ(bf,i)+this.__fJ(bf,a);}
;}
;switch(bg){case p:bj+=this.__fJ(bf,e);top+=this.__fJ(bf,r);bb-=this.__fJ(bf,x);bc-=this.__fJ(bf,q);case b:bj-=bf.scrollLeft;top-=bf.scrollTop;bb-=bf.scrollLeft;bc-=bf.scrollTop;case A:bj+=this.__fJ(bf,j);top+=this.__fJ(bf,i);bb-=this.__fJ(bf,f);bc-=this.__fJ(bf,a);break;case w:bj-=this.__fJ(bf,n);top-=this.__fJ(bf,l);bb+=this.__fJ(bf,s);bc+=this.__fJ(bf,k);break;};}
;return {left:bj,top:top,right:bb,bottom:bc};}
,__fN:function(bl){var top=bl.offsetTop;var bm=bl.offsetLeft;top+=this.__fJ(bl,l);bm+=this.__fJ(bl,n);if(qx.core.Environment.get(u)===d){top+=this.__fJ(bl,j);bm+=this.__fJ(bl,i);}
...
;}
;return A.className;}
,"default":function(C,E){var D={};var F;var B=C.className;if(B){F=B.split(this.__fO);for(var i=0,l=F.length;i<l;i++ ){D[F[i]]=true;}
...
;return P.className;}
,"default":function(S,Q){var R=new RegExp(v+Q.join(g)+v,s);return S.className=S.className.replace(R,f).replace(this.__fP,f).replace(this.__fO,p);}
...
(function(){var a="ipod",b="pc",c="ps3",d=")",e="device.type",f="psp",g="wii",h="xbox",i="\.",j="iemobile",k="ipad",l="ds",m="(",n="mobile",o="tablet",p="ontouchstart",q="g",r="iphone",s="|",t="qx.bom.client.Device",u="desktop",v="device.name",w="device.touch",x="undefined",y="device.pixelRatio";qx.Bootstrap.define(t,{statics:{__M:{"Windows Phone":j,"iPod":a,"iPad":k,"iPhone":r,"PSP":f,"PLAYSTATION 3":c,"Nintendo Wii":g,"Nintendo DS":l,"XBOX":h,"Xbox":h},getName:function(){var B=[];for(var A in qx.bom.client.Device.__M){B.push(A);}
;var C=new RegExp(m+B.join(s).replace(/\./g,i)+d,q);var z=C.exec(navigator.userAgent);if(z&&z[1]){return qx.bom.client.Device.__M[z[1]];}
;return b;}
...
else {var z=function(){if(qx.module.Event.__ds){return;}
...
;var C=qx.module.Event.__fQ;for(var i=0,l=E.length;i<l;i++ ){var D=E[i];if(qx.lang.Type.isFunction(B)){if(!C[D]){C[D]=[];}
;C[D].push(B);}
;}
;}
,$unregisterEventNormalization:function(I,F){if(!qx.lang.Type.isArray(I)){I=[I];}
;var G=qx.module.Event.__fQ;for(var i=0,l=I.length;i<l;i++ ){var H=I[i];if(G[H]){qx.lang.Array.remove(G[H],F);}
;}
;}
,$getEventNormalizationRegistry:function(){return qx.module.Event.__fQ;}
,$registerEventHook:function(O,L,K){if(!qx.lang.Type.isArray(O)){O=[O];}
;var M=qx.module.Event.__fR.on;for(var i=0,l=O.length;i<l;i++ ){var N=O[i];if(qx.lang.Type.isFunction(L)){if(!M[N]){M[N]=[];}
;M[N].push(L);}
;}
;if(!K){return;}
;var J=qx.module.Event.__fR.off;for(var i=0,l=O.length;i<l;i++ ){var N=O[i];if(qx.lang.Type.isFunction(K)){if(!J[N]){J[N]=[];}
;J[N].push(K);}
;}
;}
,$unregisterEventHook:function(U,R,Q){if(!qx.lang.Type.isArray(U)){U=[U];}
;var S=qx.module.Event.__fR.on;for(var i=0,l=U.length;i<l;i++ ){var T=U[i];if(S[T]){qx.lang.Array.remove(S[T],R);}
;}
;if(!Q){return;}
;var P=qx.module.Event.__fR.off;for(var i=0,l=U.length;i<l;i++ ){var T=U[i];if(P[T]){qx.lang.Array.remove(P[T],Q);}
;}
;}
,$getEventHookRegistry:function(){return qx.module.Event.__fR;}
},members:{on:function(bd,bb,bc,W){for(var i=0;i<this.length;i++ ){var V=this[i];var Y=bc||qxWeb(V);var X=qx.module.Event.__fR.on;var be=X[t]||[];if(X[bd]){be=be.concat(X[bd]);}
;for(var j=0,m=be.length;j<m;j++ ){be[j](V,bd,bb,bc);}
;var ba=function(bf,event){var bh=qx.module.Event.__fQ;var bg=bh[t]||[];if(bh[bd]){bg=bg.concat(bh[bd]);}
...
;V.$$lastlistenerId=V.$$emitter.on(bd,ba,Y);V.$$emitter.getEntryById(V.$$lastlistenerId).useCapture=!!W;if(!V.__fS){V.__fS={};}
;if(!V.__fS[bd]){V.__fS[bd]={};}
;V.__fS[bd][V.$$lastlistenerId]=ba;if(!bc){if(!V.__fT){V.__fT={};}
;V.__fT[V.$$lastlistenerId]=Y;}
;}
;return this;}
,off:function(bt,bo,bq,bj){var br=(bo===null&&bq===null);for(var j=0;j<this.length;j++ ){var bi=this[j];if(!bi.__fS){continue;}
;var bv=[];if(bt!==null){bv.push(bt);}
else {for(var bm in bi.__fS){bv.push(bm);}
;}
;for(var i=0,l=bv.length;i<l;i++ ){for(var bu in bi.__fS[bv[i]]){var bs=bi.__fS[bv[i]][bu];if(br||bs==bo||bs.original==bo){var bl=typeof bi.__fT!==q&&bi.__fT[bu];var bw;if(!bq&&bl){bw=bi.__fT[bu];}
;var bp=bi.$$emitter.off(bv[i],bs,bw||bq);if(br||bs.original==bo){qx.bom.Event.removeNativeListener(bi,bv[i],bs,bj);}
;if(bp!==null){delete bi.__fS[bv[i]][bu];}
;if(bl){delete bi.__fT[bu];}
;}
;}
;var bk=qx.module.Event.__fR.off;var bn=bk[t]||[];if(bk[bt]){bn=bn.concat(bk[bt]);}
...
(function(){var a="qx.event.Emitter",b="*";qx.Bootstrap.define(a,{extend:Object,statics:{__fU:[]},members:{__fS:null,__fV:null,on:function(name,c,d){var e=qx.event.Emitter.__fU.length;this.__fW(name).push({listener:c,ctx:d,id:e,name:name});qx.event.Emitter.__fU.push({name:name,listener:c,ctx:d});return e;}
,once:function(name,f,g){var h=qx.event.Emitter.__fU.length;this.__fW(name).push({listener:f,ctx:g,once:true,id:h});qx.event.Emitter.__fU.push({name:name,listener:f,ctx:g});return h;}
,off:function(name,m,k){var l=this.__fW(name);for(var i=l.length-1;i>=0;i-- ){var n=l[i];if(n.listener==m&&n.ctx==k){l.splice(i,1);qx.event.Emitter.__fU[n.id]=null;return n.id;}
;}
;return null;}
,offById:function(p){var o=qx.event.Emitter.__fU[p];if(o){this.off(o.name,o.listener,o.ctx);}
;return null;}
...
,emit:function(name,A){var x=this.__fW(name).concat();var y=[];for(var i=0;i<x.length;i++ ){var z=x[i];z.listener.call(z.ctx,A);if(z.once){y.push(z);}
;}
;y.forEach(function(B){var C=this.__fW(name);var D=C.indexOf(B);C.splice(D,1);}
.bind(this));x=this.__fW(b);for(var i=x.length-1;i>=0;i-- ){var z=x[i];z.listener.call(z.ctx,A);}
;}
,getListeners:function(){return this.__fS;}
,getEntryById:function(F){for(var name in this.__fS){var E=this.__fS[name];for(var i=0,j=E.length;i<j;i++ ){if(E[i].id===F){return E[i];}
;}
;}
;}
,__fW:function(name){if(this.__fS==null){this.__fS={};}
;if(this.__fS[name]==null){this.__fS[name]=[];}
;return this.__fS[name];}
}});}
)();
(function(){var a="touchmove",b="os.name",c="mousedown",d="event.dispatchevent",e="MSPointerDown",f="gesturemove",g="pointerover",h="touch",k="mouseout",m="ms",n="Processed",o="pointercancel",p="pointerleave",q="touchstart",r="pointerenter",s="mouse",t="event.mspointer",u="mousemove",v="MSPointerCancel",w="gesturefinish",z="browser.documentmode",A="pointerup",B="touchend",C="osx",D="mouseover",E="$$qx",F="pointerdown",G="MSPointerUp",H="pointermove",I="MSPointerOver",J="gecko",K="mshtml",L="engine.name",M="mouseup",N="touchcancel",O="contextmenu",P="gesturecancel",Q="MSPointerMove",R="MSPointerOut",S="gesturebegin",T="qx.event.handler.PointerCore",U=".",V="device.touch",W="pointerout";qx.Bootstrap.define(T,{extend:Object,statics:{MOUSE_TO_POINTER_MAPPING:{mousedown:F,mouseup:A,mousemove:H,mouseout:W,mouseover:g},TOUCH_TO_POINTER_MAPPING:{touchstart:F,touchend:A,touchmove:H,touchcancel:o},MSPOINTER_TO_POINTER_MAPPING:{MSPointerDown:F,MSPointerMove:H,MSPointerUp:A,MSPointerCancel:o,MSPointerLeave:p,MSPointerEnter:r,MSPointerOver:g,MSPointerOut:W},POINTER_TO_GESTURE_MAPPING:{pointerdown:S,pointerup:w,pointercancel:P,pointermove:f},LEFT_BUTTON:(qx.core.Environment.get(L)==K&&qx.core.Environment.get(z)<=8)?1:0,SIM_MOUSE_DISTANCE:25,SIM_MOUSE_DELAY:2500,__fX:null},construct:function(ba,bb){this.__fY=ba;this.__ga=bb;this.__gb=[];this.__gc=[];this.__gd=[];this._processedFlag=E+this.classname.substr(this.classname.lastIndexOf(U)+1)+n;var Y=qx.core.Environment.get(L);var X=parseInt(qx.core.Environment.get(z),10);if(Y==K&&X==10){this.__gb=[e,Q,G,v,I,R,F,H,A,o,g,W];this._initPointerObserver();}
else {if(qx.core.Environment.get(t)){this.__ge=true;}
;this.__gb=[F,H,A,o,g,W];this._initPointerObserver();}
;if(!qx.core.Environment.get(t)){if(qx.core.Environment.get(V)){this.__gb=[q,B,a,N];this._initObserver(this._onTouchEvent);}
;this.__gb=[c,M,u,D,k,O];this._initObserver(this._onMouseEvent);}
;}
,members:{__fY:null,__ga:null,__gb:null,__ge:false,__gf:null,__gg:0,__gc:null,__gh:null,__gd:null,_processedFlag:null,_initPointerObserver:function(){this._initObserver(this._onPointerEvent);}
,_initObserver:function(bc,bd){this.__gf=qx.lang.Function.listener(bc,this);this.__gb.forEach(function(be){if(bd&&qx.dom.Node.isDocument(this.__fY)){if(!this.__fY.$$emitter){this.__fY.$$emitter=new qx.event.Emitter();}
;this.__fY.$$emitter.on(be,this.__gf);}
else {qx.bom.Event.addNativeListener(this.__fY,be,this.__gf);}
;}
.bind(this));}
...
;if(!this.__ge){bh.stopPropagation();}
...
;bl[this._processedFlag]=true;var bm=qx.event.handler.PointerCore.TOUCH_TO_POINTER_MAPPING[bl.type];var bo=bl.changedTouches;this._determineActiveTouches(bl.type,bo);if(bl.touches.length<this.__gd.length){for(var i=this.__gd.length-1;i>=0;i-- ){var bq=new qx.event.type.dom.Pointer(o,bl,{identifier:this.__gd[i].identifier,target:bl.target,pointerType:h,pointerId:this.__gd[i].identifier+2});this._fireEvent(bq,o,bl.target);}
;this.__gh=null;this.__gd=[];return;}
;if(bl.type==q&&this.__gh===null){this.__gh=bo[0].identifier;}
...
;if(bp.identifier==this.__gh){bk.isPrimary=true;bk.button=0;bk.buttons=1;qx.event.handler.PointerCore.__fX={"x":bp.clientX,"y":bp.clientY,"time":new Date().getTime()};}
;var br=new qx.event.type.dom.Pointer(bm,bl,bk);this._fireEvent(br,bm,bk.target);if(bl.type==B||bl.type==N){var bs=new qx.event.type.dom.Pointer(W,bl,bk);this._fireEvent(bs,W,bl.target);if(this.__gh==bp.identifier){this.__gh=null;}
;}
;}
;}
...
;if(bt.type==c){this.__gc[bt.which]=1;}
else if(bt.type==M){if(qx.core.Environment.get(b)==C&&qx.core.Environment.get(L)==J){if(this.__gc[bt.which]!=1&&bt.ctrlKey){this.__gc[1]=0;}
;}
;this.__gc[bt.which]=0;}
;var bv=qx.event.handler.PointerCore.MOUSE_TO_POINTER_MAPPING[bt.type];var bu=qx.bom.Event.getTarget(bt);var bw=qx.lang.Array.sum(this.__gc);var bz={pointerType:s,pointerId:1};if(this.__gg!=bw&&bw!==0&&this.__gg!==0){var bx=new qx.event.type.dom.Pointer(H,bt,bz);this._fireEvent(bx,H,bu);}
;this.__gg=bw;if(bt.type==c&&bw>1){return;}
;if(bt.type==M&&bw>0){return;}
;if(bt.type==O){this.__gc[bt.which]=0;return;}
;var by=new qx.event.type.dom.Pointer(bv,bt,bz);this._fireEvent(by,bv,bu);}
,_determineActiveTouches:function(bD,bC){if(bD==q){for(var i=0;i<bC.length;i++ ){this.__gd.push(bC[i]);}
;}
else if(bD==B||bD==N){var bA=[];for(var i=0;i<this.__gd.length;i++ ){var bB=true;for(var j=0;j<bC.length;j++ ){if(this.__gd[i].identifier==bC[j].identifier){bB=false;break;}
;}
;if(bB){bA.push(this.__gd[i]);}
;}
;this.__gd=bA;}
;}
,_isSimulatedMouseEvent:function(x,y){var bF=qx.event.handler.PointerCore.__fX;if(bF){var bG=new Date().getTime()-bF.time;var bE=qx.event.handler.PointerCore.SIM_MOUSE_DISTANCE;var bI=Math.abs(x-qx.event.handler.PointerCore.__fX.x);var bH=Math.abs(y-qx.event.handler.PointerCore.__fX.y);if(bG<qx.event.handler.PointerCore.SIM_MOUSE_DELAY){if(bI<bE||bH<bE){return true;}
;}
;}
;return false;}
,_stopObserver:function(){for(var i=0;i<this.__gb.length;i++ ){qx.bom.Event.removeNativeListener(this.__fY,this.__gb[i],this.__gf);}
;}
...
;}
;if(qx.core.Environment.get(d)){if(!this.__ge){bL.dispatchEvent(bK);}
...
;}
;}
,dispose:function(){this._stopObserver();this.__fY=this.__ga=null;}
}});}
)();
...
(function(){var a="css.animation",b="translate",c="rotate",d="skew",e="scale",f="qx.bom.element.Animation";qx.Bootstrap.define(f,{statics:{animate:function(h,k,g){var j=qx.bom.element.Animation.__gi(h,k.keyFrames);if(qx.core.Environment.get(a)&&j){return qx.bom.element.AnimationCss.animate(h,k,g);}
else {return qx.bom.element.AnimationJs.animate(h,k,g);}
;}
,animateReverse:function(m,o,l){var n=qx.bom.element.Animation.__gi(m,o.keyFrames);if(qx.core.Environment.get(a)&&n){return qx.bom.element.AnimationCss.animateReverse(m,o,l);}
else {return qx.bom.element.AnimationJs.animateReverse(m,o,l);}
;}
,__gi:function(p,t){var r=[];for(var v in t){var s=t[v];for(var u in s){if(r.indexOf(u)==-1){r.push(u);}
;}
;}
...
;if(this.__gl!=null){var name=this.__gs(ba,Y);var X=name+K+bd+H+be.timing+K+(be.delay?be.delay+H:y)+be.repeat+K+(be.alternate?n:y);qx.bom.Event.addNativeListener(W,this.__gl[k],this.__gm);qx.bom.Event.addNativeListener(W,this.__gl[x],this.__gn);qx.bom.Event.addNativeListener(W,this.__gl[F],this.__go);if(qx.core.Environment.get(o)){if(qx.bom.element.Style.get(W,P)==J){qx.log.Logger.warn(D,W);}
;}
;W.style[qx.lang.String.camelCase(this.__gl[w])]=X;if(bb&&bb==100&&this.__gl[a]){W.style[this.__gl[a]]=B;}
;}
...
;if(this.__gl==null){window.setTimeout(function(){qx.bom.element.AnimationCss.__go({target:W});}
,0);}
;return bc;}
,__gm:function(e){if(e.target.$$animation){e.target.$$animation.emit(h,e.target);}
;}
,__gn:function(e){if(e.target!=null&&e.target.$$animation!=null){e.target.$$animation.emit(E,e.target);}
;}
,__go:function(e){var bf=e.target;var bg=bf.$$animation;if(!bg){return;}
;var bi=bg.desc;if(qx.bom.element.AnimationCss.__gl!=null){var bh=qx.lang.String.camelCase(qx.bom.element.AnimationCss.__gl[w]);bf.style[bh]=y;qx.bom.Event.removeNativeListener(bf,qx.bom.element.AnimationCss.__gl[w],qx.bom.element.AnimationCss.__go);}
;if(bi.origin!=null){qx.bom.element.Transform.setOrigin(bf,y);}
;qx.bom.element.AnimationCss.__gp(bf,bi.keyFrames[bg.keep]);bf.$$animation=null;bg.el=null;bg.ended=true;bg.emit(i,bf);}
,__gp:function(bj,bk){var bm;for(var bl in bk){if(bl in qx.bom.element.AnimationCss.__gk){if(!bm){bm={};}
;bm[bl]=bk[bl];}
else {bj.style[qx.lang.String.camelCase(bl)]=bk[bl];}
;}
;if(bm){qx.bom.element.Transform.transform(bj,bm);}
;}
,__gq:function(bn){if(!bn.hasOwnProperty(n)){bn.alternate=false;}
...
;}
,__gr:qx.core.Environment.select(o,{"true":function(bp){var bo=[z,r,q,l,u,d,g,n];for(var name in bp){if(!(bo.indexOf(name)!=-1)){qx.Bootstrap.warn(A+name+C);}
;}
...
;}
;}
,"default":null}),__gs:function(frames,bs){var bv=y;for(var bz in frames){bv+=(bs?-(bz-100):bz)+I;var bu=frames[bz];var bx;for(var br in bu){if(br in this.__gk){if(!bx){bx={};}
;bx[br]=bu[br];}
...
;bv+=v;}
;if(this.__dE[bv]){return this.__dE[bv];}
;var name=this.__gj+this.__cv++ ;var bw=this.__gl[O]+K+name;qx.bom.Stylesheet.addRule(this.__dH,bw,bv);this.__dE[bv]=name;return name;}
,__gt:function(){this.__cv=0;if(this.__dH){this.__dH.ownerNode.remove();this.__dH=null;this.__dE={};}
;}
},defer:function(bA){if(qx.core.Environment.get(c)===t&&parseInt(qx.core.Environment.get(f))>=8){document.addEventListener(p,function(){if(!document.hidden){bA.__gt();}
;}
,false);}
;}
});}
)();
(function(){var a="css.animation",b="Element",c="",d="qx.bom.element.AnimationHandle",e="play-state",f="end",g="paused",h="running";qx.Bootstrap.define(d,{extend:qx.event.Emitter,construct:function(){var i=qx.core.Environment.get(a);this.__gu=i&&i[e];this.__gv=true;this.addListenerOnce(f,this.__gx,this);}
,events:{"start":b,"end":b,"iteration":b},members:{__gu:null,__gv:false,__gw:false,isPlaying:function(){return this.__gv;}
,isEnded:function(){return this.__gw;}
,isPaused:function(){return this.el.style[this.__gu]==g;}
,pause:function(){if(this.el){this.el.style[this.__gu]=g;this.el.$$animation.__gv=false;if(this.animationId&&qx.bom.element.AnimationJs){qx.bom.element.AnimationJs.pause(this);}
;}
;}
,play:function(){if(this.el){this.el.style[this.__gu]=h;this.el.$$animation.__gv=true;if(this.i!=undefined&&qx.bom.element.AnimationJs){qx.bom.element.AnimationJs.play(this);}
;}
;}
,stop:function(){if(this.el&&qx.core.Environment.get(a)&&!this.jsAnimation){this.el.style[this.__gu]=c;this.el.style[qx.core.Environment.get(a).name]=c;this.el.$$animation.__gv=false;this.el.$$animation.__gw=true;}
else if(this.jsAnimation){this.stopped=true;qx.bom.element.AnimationJs.stop(this);}
;}
,__gx:function(){this.__gv=false;this.__gw=true;}
}});}
)();
(function(){var c="cm",d="mm",e="0",f="pt",g="pc",h="",k="%",l="em",m="qx.bom.element.AnimationJs",n="infinite",o="#",p="in",q="px",r="start",s="end",t="ex",u=";",v="undefined",w="iteration",y="string",z=":";qx.Bootstrap.define(m,{statics:{__gy:30,__gz:[k,p,c,d,l,t,f,g,q],__gk:{"scale":true,"rotate":true,"skew":true,"translate":true},animate:function(B,C,A){return this._animate(B,C,A,false);}
...
;var L=Q.keyFrames;var J=this.__gI(L);var K=this.__gH(P,J);var N=parseInt(P/K,10);this.__gA(L,G);var O=this.__gC(N,K,J,L,P,Q.timing);var H=new qx.bom.element.AnimationHandle();H.jsAnimation=true;if(I){O.reverse();H.reverse=true;}
;H.desc=Q;H.el=G;H.delta=O;H.stepTime=K;H.steps=N;G.$$animation=H;H.i=0;H.initValues={};H.repeatSteps=this.__gF(N,Q.repeat);var M=Q.delay||0;var self=this;H.delayId=window.setTimeout(function(){H.delayId=null;self.play(H);}
,M);return H;}
,__gA:function(V,R){var Y={};for(var U in V){for(var name in V[U]){var S=qx.bom.Style.getPropertyName(name);if(S&&S!=name){var X=qx.bom.Style.getCssName(S);V[U][X]=V[U][name];delete V[U][name];name=X;}
;if(Y[name]==undefined){var W=V[U][name];if(typeof W==y){Y[name]=this.__gD(W);}
else {Y[name]=h;}
;}
;}
;}
...
;if(T[name]===h&&this.__gz.indexOf(Y[name])!=-1){T[name]=e+Y[name];}
;}
;}
;}
;}
,__gB:function(bb){bb=qx.lang.Object.clone(bb);var bc;for(var name in bb){if(name in this.__gk){if(!bc){bc={};}
...
;}
;return bb;}
,__gC:function(bw,bh,bo,bi,be,bq){var bp=new Array(bw);var bm=1;bp[0]=this.__gB(bi[0]);var bt=bi[0];var bj=bi[bo[bm]];var bf=Math.floor(bo[bm]/(bh/be*100));var bs=1;for(var i=1;i<bp.length;i++ ){if(i*bh/be*100>bo[bm]){bt=bj;bm++ ;bj=bi[bo[bm]];bf=Math.floor(bo[bm]/(bh/be*100))-bf;bs=1;}
;bp[i]={};var bd;for(var name in bj){var br=bj[name]+h;if(name in this.__gk){if(!bd){bd={};}
;if(qx.Bootstrap.isArray(bt[name])){if(!qx.Bootstrap.isArray(bj[name])){bj[name]=[bj[name]];}
;bd[name]=[];for(var j=0;j<bj[name].length;j++ ){var bu=bj[name][j]+h;var x=bs/bf;bd[name][j]=this.__gE(bu,bt[name],bq,x);}
;}
else {var x=bs/bf;bd[name]=this.__gE(br,bt[name],bq,x);}
;}
...
else if(!isNaN(parseFloat(br))){var x=bs/bf;bp[i][name]=this.__gE(br,bt[name],bq,x);}
...
;}
;bs++ ;}
;bp[bp.length-1]=this.__gB(bi[100]);return bp;}
,__gD:function(by){return by.substring((parseFloat(by)+h).length,by.length);}
,__gE:function(bC,bB,bz,x){var bA=parseFloat(bC)-parseFloat(bB);return (parseFloat(bB)+bA*qx.bom.AnimationFrame.calculateTiming(bz,x))+this.__gD(bC);}
...
;}
;}
;qx.bom.element.AnimationJs.__gG(bD.el,bF);bD.i++ ;if(bD.i%bD.steps==0){bD.emit(w,bD.el);if(bD.desc.alternate){bD.delta.reverse();}
;}
...
;this.__gG(bH,bJ.keyFrames[bL]);}
else {this.__gG(bH,bI);}
;bH.$$animation=null;bK.el=null;bK.ended=true;bK.animationId=null;bK.emit(s,bH);return bK;}
,__gF:function(bN,bM){if(bM==undefined){return bN;}
;if(bM==n){return Number.MAX_VALUE;}
;return bN*bM;}
,__gG:function(bP,bO){for(var bQ in bO){if(bO[bQ]===undefined){continue;}
...
;}
;}
,__gH:function(bT,bR){var bU=100;for(var i=0;i<bR.length-1;i++ ){bU=Math.min(bU,bR[i+1]-bR[i]);}
;var bS=bT*bU/100;while(bS>this.__gy){bS=bS/2;}
;return Math.round(bS);}
,__gI:function(bW){var bV=Object.keys(bW);for(var i=0;i<bV.length;i++ ){bV[i]=parseInt(bV[i],10);}
...
,cancelSequence:function(){this.__gK=true;}
...
;}
;bL.__hl();}
;var bI=this._visibility;for(var bK in bI){bL=bI[bK];var bO=bL.__gV;if(!bO){delete bI[bK];continue;}
;if(qx.core.Environment.get(A)){if(this.DEBUG){qx.log.Logger.debug(this,bt+bL.__gX);}
;}
;if(!bL.$$disposed){bO.style.display=bL.__gX?L:bq;if((qx.core.Environment.get(X)==W)){if(!(document.documentMode>=8)){bO.style.visibility=bL.__gX?C:bn;}
;}
;}
;delete bI[bK];}
;var scroll=this._scroll;for(var bK in scroll){bL=scroll[bK];var bC=bL.__gV;if(bC&&bC.offsetWidth){var bF=true;if(bL.__hb!=null){bL.__gV.scrollLeft=bL.__hb;delete bL.__hb;}
;if(bL.__hc!=null){bL.__gV.scrollTop=bL.__hc;delete bL.__hc;}
;var bP=bL.__gY;if(bP!=null){var bJ=bP.element.getDomElement();if(bJ&&bJ.offsetWidth){qx.bom.element.Scroll.intoViewX(bJ,bC,bP.align);delete bL.__gY;}
else {bF=false;}
;}
;var bQ=bL.__ha;if(bQ!=null){var bJ=bQ.element.getDomElement();if(bJ&&bJ.offsetWidth){qx.bom.element.Scroll.intoViewY(bJ,bC,bQ.align);delete bL.__ha;}
else {bF=false;}
;}
;if(bF){delete scroll[bK];}
;}
;}
;var bE={"releaseCapture":1,"blur":1,"deactivate":1};for(var i=0;i<this._actions.length;i++ ){var bR=this._actions[i];var bO=bR.element.__gV;if(!bO||!bE[bR.type]&&!bR.element.__hm()){continue;}
;var bH=bR.args;bH.unshift(bO);qx.bom.Element[bR.type].apply(qx.bom.Element,bH);}
;this._actions=[];for(var bK in this.__gP){var bA=this.__gP[bK];var bC=bA.element.__gV;if(bC){qx.bom.Selection.set(bC,bA.start,bA.end);delete this.__gP[bK];}
;}
;qx.event.handler.Appear.refresh();}
,__gS:function(){if(!this.__gQ){var bT=qx.event.Registration.getManager(window);this.__gQ=bT.getHandler(qx.event.handler.Focus);}
;return this.__gQ;}
,__gT:function(){if(!this.__gR){var bU=qx.event.Registration.getManager(window);this.__gR=bU.getDispatcher(qx.event.dispatch.MouseCapture);}
;return this.__gR.getCaptureElement();}
,__gU:function(bV){var bW=qx.core.ObjectRegistry.fromHashCode(bV.$$element);return bW&&!bW.__hm();}
},members:{__gM:null,__gV:null,__dx:false,__gW:true,__gX:true,__gY:null,__ha:null,__hb:null,__hc:null,__hd:null,__he:null,__hf:null,__gN:null,__gO:null,__hg:null,__hh:null,__hi:null,__hj:null,__hk:null,_scheduleChildrenUpdate:function(){if(this.__hj){return;}
;this.__hj=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
,_createDomElement:function(){return qx.dom.Element.create(this.__gM);}
,__hl:function(){if(qx.core.Environment.get(A)){if(this.DEBUG){this.debug(r+this.getAttribute(bu));}
;}
;var length;var bX=this.__hi;if(bX){length=bX.length;var bY;for(var i=0;i<length;i++ ){bY=bX[i];if(bY.__gX&&bY.__gW&&!bY.__gV){bY.__hl();}
;}
;}
;if(!this.__gV){this.__gV=this._createDomElement();this.__gV.$$element=this.$$hash;this._copyData(false);if(bX&&length>0){this._insertChildren();}
;}
else {this._syncData();if(this.__hj){this._syncChildren();}
;}
;delete this.__hj;}
,_insertChildren:function(){var ca=this.__hi;var length=ca.length;var cc;if(length>2){var cb=document.createDocumentFragment();for(var i=0;i<length;i++ ){cc=ca[i];if(cc.__gV&&cc.__gW){cb.appendChild(cc.__gV);}
;}
;this.__gV.appendChild(cb);}
else {var cb=this.__gV;for(var i=0;i<length;i++ ){cc=ca[i];if(cc.__gV&&cc.__gW){cb.appendChild(cc.__gV);}
;}
;}
;}
,_syncChildren:function(){var cm=qx.core.ObjectRegistry;var cd=this.__hi;var ck=cd.length;var ce;var ci;var cg=this.__gV;var cl=cg.childNodes;var cf=0;var cj;if(qx.core.Environment.get(A)){var ch=0;}
;for(var i=cl.length-1;i>=0;i-- ){cj=cl[i];ci=cm.fromHashCode(cj.$$element);if(!ci||!ci.__gW||ci.__hk!==this){cg.removeChild(cj);if(qx.core.Environment.get(A)){ch++ ;}
;}
;}
;for(var i=0;i<ck;i++ ){ce=cd[i];if(ce.__gW){ci=ce.__gV;cj=cl[cf];if(!ci){continue;}
...
;}
;}
,_copyData:function(co){var cq=this.__gV;var cs=this.__gO;if(cs){var cp=qx.bom.element.Attribute;for(var cr in cs){cp.set(cq,cr,cs[cr]);}
;}
;var cs=this.__gN;if(cs){var cn=qx.bom.element.Style;if(co){cn.setStyles(cq,cs);}
else {cn.setCss(cq,cn.compile(cs));}
;}
;var cs=this.__hg;if(cs){for(var cr in cs){this._applyProperty(cr,cs[cr]);}
;}
;var cs=this.__hh;if(cs){qx.event.Registration.getManager(cq).importListeners(cq,cs);delete this.__hh;}
;}
,_syncData:function(){var cx=this.__gV;var cw=qx.bom.element.Attribute;var cu=qx.bom.element.Style;var cv=this.__he;if(cv){var cA=this.__gO;if(cA){var cy;for(var cz in cv){cy=cA[cz];if(cy!==undefined){cw.set(cx,cz,cy);}
else {cw.reset(cx,cz);}
;}
;}
;this.__he=null;}
;var cv=this.__hd;if(cv){var cA=this.__gN;if(cA){var ct={};for(var cz in cv){ct[cz]=cA[cz];}
;cu.setStyles(cx,ct);}
;this.__hd=null;}
;var cv=this.__hf;if(cv){var cA=this.__hg;if(cA){var cy;for(var cz in cv){this._applyProperty(cz,cA[cz]);}
;}
;this.__hf=null;}
;}
,__hm:function(){var cB=this;while(cB){if(cB.__dx){return true;}
;if(!cB.__gW||!cB.__gX){return false;}
;cB=cB.__hk;}
;return false;}
,__hn:function(cC){if(cC.__hk===this){throw new Error(a+cC);}
;if(cC.__dx){throw new Error(D);}
;if(cC.__hk){cC.__hk.remove(cC);}
;cC.__hk=this;if(!this.__hi){this.__hi=[];}
;if(this.__gV){this._scheduleChildrenUpdate();}
;}
,__ho:function(cD){if(cD.__hk!==this){throw new Error(br+cD);}
;if(this.__gV){this._scheduleChildrenUpdate();}
;delete cD.__hk;}
,__hp:function(cE){if(cE.__hk!==this){throw new Error(br+cE);}
;if(this.__gV){this._scheduleChildrenUpdate();}
;}
,getChildren:function(){return this.__hi||null;}
,getChild:function(cF){var cG=this.__hi;return cG&&cG[cF]||null;}
,hasChildren:function(){var cH=this.__hi;return cH&&cH[0]!==undefined;}
,indexOf:function(cJ){var cI=this.__hi;return cI?cI.indexOf(cJ):-1;}
,hasChild:function(cL){var cK=this.__hi;return cK&&cK.indexOf(cL)!==-1;}
,add:function(cM){if(arguments[1]){for(var i=0,l=arguments.length;i<l;i++ ){this.__hn(arguments[i]);}
;this.__hi.push.apply(this.__hi,arguments);}
else {this.__hn(cM);this.__hi.push(cM);}
;return this;}
,addAt:function(cO,cN){this.__hn(cO);qx.lang.Array.insertAt(this.__hi,cO,cN);return this;}
,remove:function(cP){var cQ=this.__hi;if(!cQ){return this;}
;if(arguments[1]){var cR;for(var i=0,l=arguments.length;i<l;i++ ){cR=arguments[i];this.__ho(cR);qx.lang.Array.remove(cQ,cR);}
;}
else {this.__ho(cP);qx.lang.Array.remove(cQ,cP);}
;return this;}
,removeAt:function(cS){var cT=this.__hi;if(!cT){throw new Error(E);}
;var cU=cT[cS];if(!cU){throw new Error(Q);}
;this.__ho(cU);qx.lang.Array.removeAt(this.__hi,cS);return this;}
,removeAll:function(){var cV=this.__hi;if(cV){for(var i=0,l=cV.length;i<l;i++ ){this.__ho(cV[i]);}
;cV.length=0;}
;return this;}
,getParent:function(){return this.__hk||null;}
,insertInto:function(parent,cW){parent.__hn(this);if(cW==null){parent.__hi.push(this);}
else {qx.lang.Array.insertAt(this.__hi,this,cW);}
;return this;}
,insertBefore:function(cX){var parent=cX.__hk;parent.__hn(this);qx.lang.Array.insertBefore(parent.__hi,this,cX);return this;}
,insertAfter:function(cY){var parent=cY.__hk;parent.__hn(this);qx.lang.Array.insertAfter(parent.__hi,this,cY);return this;}
,moveTo:function(da){var parent=this.__hk;parent.__hp(this);var dc=parent.__hi.indexOf(this);if(dc===da){throw new Error(I);}
else if(dc<da){da-- ;}
;qx.lang.Array.removeAt(parent.__hi,dc);qx.lang.Array.insertAt(parent.__hi,this,da);return this;}
,moveBefore:function(dd){var parent=this.__hk;return this.moveTo(parent.__hi.indexOf(dd));}
,moveAfter:function(de){var parent=this.__hk;return this.moveTo(parent.__hi.indexOf(de)+1);}
,free:function(){var parent=this.__hk;if(!parent){throw new Error(U);}
;if(!parent.__hi){return this;}
;parent.__ho(this);qx.lang.Array.remove(parent.__hi,this);return this;}
,getDomElement:function(){return this.__gV||null;}
,getNodeName:function(){return this.__gM;}
,setNodeName:function(name){this.__gM=name;}
,setRoot:function(df){this.__dx=df;}
,useMarkup:function(dg){if(this.__gV){throw new Error(bv);}
;if(qx.core.Environment.get(X)==W){var dh=document.createElement(q);}
else {var dh=qx.dom.Element.getHelperElement();}
;dh.innerHTML=dg;this.useElement(dh.firstChild);return this.__gV;}
,useElement:function(di){if(this.__gV){throw new Error(bv);}
;this.__gV=di;this.__gV.$$element=this.$$hash;this._copyData(true);}
,isFocusable:function(){var dk=this.getAttribute(P);if(dk>=1){return true;}
;var dj=qx.event.handler.Focus.FOCUSABLE_ELEMENTS;if(dk>=0&&dj[this.__gM]){return true;}
;return false;}
...
;}
,isNativelyFocusable:function(){return !!qx.event.handler.Focus.FOCUSABLE_ELEMENTS[this.__gM];}
,include:function(){if(this.__gW){return this;}
;delete this.__gW;if(this.__hk){this.__hk._scheduleChildrenUpdate();}
;return this;}
,exclude:function(){if(!this.__gW){return this;}
;this.__gW=false;if(this.__hk){this.__hk._scheduleChildrenUpdate();}
;return this;}
,isIncluded:function(){return this.__gW===true;}
,fadeIn:function(dn){var dp=qxWeb(this.__gV);if(dp.isPlaying()){dp.stop();}
;if(!this.__gV){this.__hl();dp.push(this.__gV);}
;if(this.__gV){dp.fadeIn(dn).once(v,function(){this.show();qx.html.Element.flush();}
,this);return dp.getAnimationHandles()[0];}
;}
,fadeOut:function(dq){var dr=qxWeb(this.__gV);if(dr.isPlaying()){dr.stop();}
;if(this.__gV){dr.fadeOut(dq).once(v,function(){this.hide();qx.html.Element.flush();}
,this);return dr.getAnimationHandles()[0];}
;}
,show:function(){if(this.__gX){return this;}
;if(this.__gV){qx.html.Element._visibility[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;if(this.__hk){this.__hk._scheduleChildrenUpdate();}
;delete this.__gX;return this;}
,hide:function(){if(!this.__gX){return this;}
;if(this.__gV){qx.html.Element._visibility[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;this.__gX=false;return this;}
,isVisible:function(){return this.__gX===true;}
,scrollChildIntoViewX:function(dv,dt,dw){var ds=this.__gV;var du=dv.getDomElement();if(dw!==false&&ds&&ds.offsetWidth&&du&&du.offsetWidth){qx.bom.element.Scroll.intoViewX(du,ds,dt);}
else {this.__gY={element:dv,align:dt};qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__hb;}
,scrollChildIntoViewY:function(dA,dy,dB){var dx=this.__gV;var dz=dA.getDomElement();if(dB!==false&&dx&&dx.offsetWidth&&dz&&dz.offsetWidth){qx.bom.element.Scroll.intoViewY(dz,dx,dy);}
else {this.__ha={element:dA,align:dy};qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__hc;}
,scrollToX:function(x,dC){var dD=this.__gV;if(dC!==true&&dD&&dD.offsetWidth){dD.scrollLeft=x;delete this.__hb;}
else {this.__hb=x;qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__gY;}
,getScrollX:function(){var dE=this.__gV;if(dE){return dE.scrollLeft;}
;return this.__hb||0;}
,scrollToY:function(y,dG){var dF=this.__gV;if(dG!==true&&dF&&dF.offsetWidth){dF.scrollTop=y;delete this.__hc;}
else {this.__hc=y;qx.html.Element._scroll[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;delete this.__ha;}
,getScrollY:function(){var dH=this.__gV;if(dH){return dH.scrollTop;}
;return this.__hc||0;}
,disableScrolling:function(){this.enableScrolling();this.scrollToX(0);this.scrollToY(0);this.addListener(h,this.__hr,this);}
,enableScrolling:function(){this.removeListener(h,this.__hr,this);}
,__hq:null,__hr:function(e){if(!this.__hq){this.__hq=true;this.__gV.scrollTop=0;this.__gV.scrollLeft=0;delete this.__hq;}
;}
,getTextSelection:function(){var dI=this.__gV;if(dI){return qx.bom.Selection.get(dI);}
;return null;}
,getTextSelectionLength:function(){var dJ=this.__gV;if(dJ){return qx.bom.Selection.getLength(dJ);}
;return null;}
,getTextSelectionStart:function(){var dK=this.__gV;if(dK){return qx.bom.Selection.getStart(dK);}
;return null;}
,getTextSelectionEnd:function(){var dL=this.__gV;if(dL){return qx.bom.Selection.getEnd(dL);}
;return null;}
,setTextSelection:function(dM,dN){var dO=this.__gV;if(dO){qx.bom.Selection.set(dO,dM,dN);return;}
;qx.html.Element.__gP[this.toHashCode()]={element:this,start:dM,end:dN};qx.html.Element._scheduleFlush(K);}
,clearTextSelection:function(){var dP=this.__gV;if(dP){qx.bom.Selection.clear(dP);}
;delete qx.html.Element.__gP[this.toHashCode()];}
,__hs:function(dQ,dR){var dS=qx.html.Element._actions;dS.push({type:dQ,element:this,args:dR||[]});qx.html.Element._scheduleFlush(K);}
,focus:function(){this.__hs(k);}
,blur:function(){this.__hs(p);}
,activate:function(){this.__hs(T);}
,deactivate:function(){this.__hs(s);}
,capture:function(dT){this.__hs(B,[dT!==false]);}
,releaseCapture:function(){this.__hs(H);}
,setStyle:function(dU,dV,dW){if(!this.__gN){this.__gN={};}
;if(this.__gN[dU]==dV){return this;}
;if(dV==null){delete this.__gN[dU];}
else {this.__gN[dU]=dV;}
;if(this.__gV){if(dW){qx.bom.element.Style.set(this.__gV,dU,dV);return this;}
;if(!this.__hd){this.__hd={};}
;this.__hd[dU]=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;return this;}
,setStyles:function(dY,eb){var ea=qx.bom.element.Style;if(!this.__gN){this.__gN={};}
;if(this.__gV){if(!this.__hd){this.__hd={};}
;for(var dX in dY){var ec=dY[dX];if(this.__gN[dX]==ec){continue;}
;if(ec==null){delete this.__gN[dX];}
else {this.__gN[dX]=ec;}
;if(eb){ea.set(this.__gV,dX,ec);continue;}
;this.__hd[dX]=true;}
;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
else {for(var dX in dY){var ec=dY[dX];if(this.__gN[dX]==ec){continue;}
;if(ec==null){delete this.__gN[dX];}
else {this.__gN[dX]=ec;}
;}
;}
...
,getStyle:function(ef){return this.__gN?this.__gN[ef]:null;}
,getAllStyles:function(){return this.__gN||null;}
,setAttribute:function(eg,eh,ei){if(!this.__gO){this.__gO={};}
;if(this.__gO[eg]==eh){return this;}
;if(eh==null){delete this.__gO[eg];}
else {this.__gO[eg]=eh;}
;if(this.__gV){if(ei){qx.bom.element.Attribute.set(this.__gV,eg,eh);return this;}
;if(!this.__he){this.__he={};}
;this.__he[eg]=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;return this;}
...
,getAttribute:function(ep){return this.__gO?this.__gO[ep]:null;}
...
,_setProperty:function(et,eu,ev){if(!this.__hg){this.__hg={};}
;if(this.__hg[et]==eu){return this;}
;if(eu==null){delete this.__hg[et];}
else {this.__hg[et]=eu;}
;if(this.__gV){if(ev){this._applyProperty(et,eu);return this;}
;if(!this.__hf){this.__hf={};}
;this.__hf[et]=true;qx.html.Element._modified[this.$$hash]=this;qx.html.Element._scheduleFlush(K);}
;return this;}
,_removeProperty:function(ex,ew){return this._setProperty(ex,null,ew);}
,_getProperty:function(ez){var ey=this.__hg;if(!ey){return null;}
...
;}
;if(this.__gV){return qx.event.Registration.addListener(this.__gV,eF,eC,self,eB);}
;if(!this.__hh){this.__hh={};}
;if(eB==null){eB=false;}
;var eE=qx.event.Manager.getNextUniqueId();var eG=eF+(eB?g:c)+eE;this.__hh[eG]={type:eF,listener:eC,self:self,capture:eB,unique:eE};return eG;}
...
;}
;if(this.__gV){if(eI.$$wrapped_callback&&eI.$$wrapped_callback[eO+this.$$hash]){var eJ=eI.$$wrapped_callback[eO+this.$$hash];delete eI.$$wrapped_callback[eO+this.$$hash];eI=eJ;}
;qx.event.Registration.removeListener(this.__gV,eO,eI,self,eH);}
else {var eK=this.__hh;var eN;if(eH==null){eH=false;}
...
;if(this.__gV){qx.event.Registration.removeListenerById(this.__gV,eP);}
else {delete this.__hh[eP];}
;return this;}
,hasListener:function(eR,eQ){if(this.$$disposed){return false;}
;if(this.__gV){return qx.event.Registration.hasListener(this.__gV,eR,eQ);}
;var eS=this.__hh;var eU;if(eQ==null){eQ=false;}
;for(var eT in eS){eU=eS[eT];if(eU.capture===eQ&&eU.type===eR){return true;}
;}
;return false;}
,getListeners:function(){if(this.$$disposed){return null;}
;if(this.__gV){return qx.event.Registration.getManager(this.__gV).serializeListeners(this.__gV);}
;var eV=[];for(var eX in this.__hh){var eW=this.__hh[eX];eV.push({type:eW.type,handler:eW.listener,self:eW.self,capture:eW.capture});}
;return eV;}
},defer:function(eY){eY.__ht=new qx.util.DeferredCall(eY.flush,eY);}
,destruct:function(){if(this.$$hash){delete qx.html.Element._modified[this.$$hash];delete qx.html.Element._scroll[this.$$hash];}
;var fa=this.__gV;if(fa){qx.event.Registration.getManager(fa).removeAllListeners(fa);fa.$$element=L;}
;if(!qx.core.ObjectRegistry.inShutDown){var parent=this.__hk;if(parent&&!parent.$$disposed){parent.remove(this);}
;}
;this._disposeArray(bs);this.__gO=this.__gN=this.__hh=this.__hg=this.__he=this.__hd=this.__hf=this.__gV=this.__hk=this.__gY=this.__ha=null;}
});}
)();
(function(){var a="qx.event.handler.Appear",b="engine.name",c="mshtml",d="disappear",e="appear",f="browser.documentmode";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(g){qx.core.Object.call(this);this.__dl=g;this.__hu={};qx.event.handler.Appear.__hv[this.$$hash]=this;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{appear:true,disappear:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true,__hv:{},refresh:function(){var h=this.__hv;for(var i in h){h[i].refresh();}
;}
},members:{__dl:null,__hu:null,canHandleEvent:function(k,j){}
,registerEvent:function(o,p,m){var n=qx.core.ObjectRegistry.toHashCode(o)+p;var l=this.__hu;if(l&&!l[n]){l[n]=o;o.$$displayed=o.offsetWidth>0;}
;}
,unregisterEvent:function(t,u,r){var s=qx.core.ObjectRegistry.toHashCode(t)+u;var q=this.__hu;if(!q){return;}
;if(q[s]){delete q[s];}
;}
,refresh:function(){var A=this.__hu;var x;var y=qx.core.Environment.get(b)==c&&qx.core.Environment.get(f)<9;for(var v in A){x=A[v];var w=x.offsetWidth>0;if(!w&&y){w=x.offsetWidth>0;}
;if((!!x.$$displayed)!==w){x.$$displayed=w;var z=qx.event.Registration.createEvent(w?e:d);this.__dl.dispatchEvent(x,z);}
;}
;}
},destruct:function(){this.__dl=this.__hu=null;delete qx.event.handler.Appear.__hv[this.$$hash];}
...
,__hw:{'0':i,'2':j,'1':d},__hx:{'0':e,'1':i,'2':j,'4':d},__hy:{'1':i,'2':j,'4':d},stop:function(){this.stopPropagation();}
...
;default:if(!(qx.core.Environment.get(b)==a&&qx.core.Environment.get(h)<=8)){if(this._native.button===-1){return this.__hx[this._native.buttons]||e;}
;return this.__hw[this._native.button]||e;}
...
,dispose:function(){this.__hz(d);this.__dl=this.__cI=this.__dx=null;}
,__hz:function(D,C){qx.event.handler.PointerCore.prototype[D].apply(this,C||[]);}
...
(function(){var a="swipe",b="pinch",c="event.dispatchevent",d="gesturemove",e="touch",f="longtap",g="event.mousewheel",h="roll",i="dblclick",j="wheel",k="rotate",l="trackstart",m="gesturefinish",n="y",o="browser.documentmode",p="dbltap",q="qx.event.handler.GestureCore",r="right",s="mshtml",t="engine.name",u="gesturecancel",v="gesturebegin",w="track",z="trackend",A="left",B="tap",C="down",D="x",E="up";qx.Bootstrap.define(q,{extend:Object,statics:{TYPES:[B,a,f,p,w,l,z,k,b,h],GESTURE_EVENTS:[v,m,d,u],TAP_MAX_DISTANCE:{"touch":40,"mouse":5,"pen":20},DOUBLETAP_MAX_DISTANCE:{"touch":10,"mouse":4,"pen":10},SWIPE_DIRECTION:{x:[A,r],y:[E,C]},LONGTAP_TIME:500,DOUBLETAP_TIME:500,ROLL_FACTOR:18},construct:function(F,G){this.__fY=F;this.__ga=G;this.__hA={};this.__hB={};this.__hC={};this._initObserver();}
,members:{__fY:null,__ga:null,__hA:null,__hD:null,__hE:null,__hF:null,__hG:null,__hB:null,__hH:null,__hC:null,__hI:null,_initObserver:function(){qx.event.handler.GestureCore.GESTURE_EVENTS.forEach(function(I){qxWeb(this.__fY).on(I,this.checkAndFireGesture,this);}
.bind(this));if(qx.core.Environment.get(t)==s&&qx.core.Environment.get(o)<9){qxWeb(this.__fY).on(i,this._onDblClick,this);}
;var H=qx.core.Environment.get(g);qxWeb(H.target).on(H.type,this._fireRoll,this);}
,_stopObserver:function(){qx.event.handler.GestureCore.GESTURE_EVENTS.forEach(function(K){qxWeb(this.__fY).off(K,this.checkAndFireGesture,this);}
.bind(this));if(qx.core.Environment.get(t)==s&&qx.core.Environment.get(o)<9){qxWeb(this.__fY).off(i,this._onDblClick,this);}
...
;}
,gestureBegin:function(O,P){if(this.__hA[O.pointerId]){this.__hQ(this.__hA[O.pointerId]);delete this.__hA[O.pointerId];}
;if(this._hasIntermediaryHandler(P)){return;}
;this.__hA[O.pointerId]={"startTime":new Date().getTime(),"lastEventTime":new Date().getTime(),"startX":O.clientX,"startY":O.clientY,"clientX":O.clientX,"clientY":O.clientY,"velocityX":0,"velocityY":0,"target":P,"isTap":true,"isPrimary":O.isPrimary,"longTapTimer":window.setTimeout(this.__hP.bind(this,O,P),qx.event.handler.GestureCore.LONGTAP_TIME)};if(O.isPrimary){this.__hF=false;this.__hE=P;this.__hM(l,O,P);}
else {this.__hF=true;if(Object.keys(this.__hA).length===2){this.__hG=this._calcAngle();this.__hI=this._calcDistance();}
;}
;}
,gestureMove:function(R,S){var T=this.__hA[R.pointerId];if(T){var Q=T.clientX;var U=T.clientY;T.clientX=R.clientX;T.clientY=R.clientY;T.lastEventTime=new Date().getTime();if(Q){T.velocityX=T.clientX-Q;}
;if(U){T.velocityY=T.clientY-U;}
;if(Object.keys(this.__hA).length===2){this.__hN(R,T.target);this.__hO(R,T.target);}
;if(!this.__hF){this.__hM(w,R,T.target);this._fireRoll(R,e,T.target);}
;if(T.isTap){T.isTap=this._isBelowTapMaxDistance(R);if(!T.isTap){this.__hQ(T);}
;}
;}
;}
,_hasIntermediaryHandler:function(V){while(V&&V!==this.__fY){if(V.$$gestureHandler){return true;}
;V=V.parentNode;}
;return false;}
,gestureFinish:function(X,Y){if(!this.__hA[X.pointerId]){return;}
;var bf=this.__hA[X.pointerId];this.__hQ(bf);if(this._hasIntermediaryHandler(Y)){return;}
;this.__hJ(bf.velocityX,bf.velocityY,X,bf.target);this.__hM(z,X,bf.target);if(bf.isTap){if(Y!==bf.target){delete this.__hA[X.pointerId];return;}
;this._fireEvent(X,B,X.target||Y);var ba=false;if(Object.keys(this.__hB).length>0){var be=Date.now()-qx.event.handler.GestureCore.DOUBLETAP_TIME;for(var bg in this.__hB){if(bg<be){delete this.__hB[bg];}
else {var W=this.__hB[bg];var bc=this.__hK(W.x,W.y,X.clientX,X.clientY,X.getPointerType());var bd=W.target===(X.target||Y);var bh=W.button===X.button;if(bc&&bh&&bd){ba=true;delete this.__hB[bg];this._fireEvent(X,p,X.target||Y);}
;}
;}
;}
;if(!ba){this.__hB[Date.now()]={x:X.clientX,y:X.clientY,target:X.target||Y,button:X.button};}
;}
else if(!this._isBelowTapMaxDistance(X)){var bb=this.__hL(X,Y);if(bb){X.swipe=bb;this._fireEvent(X,a,bf.target||Y);}
;}
;delete this.__hA[X.pointerId];}
,stopMomentum:function(bi){this.__hC[bi]=true;}
,gestureCancel:function(bj){if(this.__hA[bj]){this.__hQ(this.__hA[bj]);delete this.__hA[bj];}
;}
,updateGestureTarget:function(bk,bl){this.__hA[bk].target=bl;}
,__hJ:function(bq,br,bn,bo,bt){var bs=bn.timeoutId;if((Math.abs(br)<1&&Math.abs(bq)<1)||this.__hC[bs]){delete this.__hC[bs];return;}
;if(!bt){bt=1;var bp=2.8;br=br/bp;bq=bq/bp;}
;bt+=0.0006;br=br/bt;bq=bq/bt;var bm=qx.bom.AnimationFrame.request(qx.lang.Function.bind(function(bu,bv,bw,bx,by){this.__hJ(bu,bv,bw,bx,by);}
...
,_calcAngle:function(){var bA=null;var bB=null;for(var bz in this.__hA){var bC=this.__hA[bz];if(bA===null){bA=bC;}
else {bB=bC;}
;}
;var x=bA.clientX-bB.clientX;var y=bA.clientY-bB.clientY;return (360+Math.atan2(y,x)*(180/Math.PI))%360;}
,_calcDistance:function(){var bD=null;var bE=null;for(var bG in this.__hA){var bH=this.__hA[bG];if(bD===null){bD=bH;}
else {bE=bH;}
;}
...
,__hK:function(bL,bP,bQ,bR,bS){var bO=qx.event.handler.GestureCore;var bM=Math.abs(bL-bQ)<bO.DOUBLETAP_MAX_DISTANCE[bS];var bN=Math.abs(bP-bR)<bO.DOUBLETAP_MAX_DISTANCE[bS];return bM&&bN;}
,_getDeltaCoordinates:function(bV){var bW=this.__hA[bV.pointerId];if(!bW){return null;}
;var bT=bV.clientX-bW.startX;var bU=bV.clientY-bW.startY;var bX=D;if(Math.abs(bT/bU)<1){bX=n;}
;return {"x":bT,"y":bU,"axis":bX};}
,_fireEvent:function(ca,cc,cb){if(!this.__fY){return;}
...
else if(this.__ga){bY=new qx.event.type.dom.Custom(cc,ca,{target:this.__fY,currentTarget:this.__fY,srcElement:this.__fY,swipe:ca.swipe,scale:ca.scale,angle:ca.angle,delta:ca.delta,pointerType:ca.pointerType,momentum:ca.momentum});this.__ga.emit(cc,ca);}
;}
,_onDblClick:function(cd){var ce=qx.bom.Event.getTarget(cd);this._fireEvent(cd,B,ce);this._fireEvent(cd,p,ce);}
,__hL:function(ch,ci){var co=this.__hA[ch.pointerId];if(!co){return null;}
...
,__hM:function(cq,cr,cs){cr.delta=this._getDeltaCoordinates(cr);this._fireEvent(cr,cq,cr.target||cs);}
...
else {var cw=this.__hA[cu.pointerId];cu.delta={x:-cw.velocityX,y:-cw.velocityY,axis:Math.abs(cw.velocityX/cw.velocityY)<1?n:D};}
;this._fireEvent(cu,h,cu.target||cv);}
,__hN:function(cx,cz){if(!cx.isPrimary){var cy=this._calcAngle();cx.angle=Math.round((cy-this.__hG)%360);this._fireEvent(cx,k,this.__hE);}
;}
,__hO:function(cC,cD){if(!cC.isPrimary){var cA=this._calcDistance();var cB=cA/this.__hI;cC.scale=(Math.round(cB*100)/100);this._fireEvent(cC,b,this.__hE);}
;}
,__hP:function(cE,cF){var cG=this.__hA[cE.pointerId];if(cG){this._fireEvent(cE,f,cE.target||cF);cG.longTapTimer=null;cG.isTap=false;}
;}
,__hQ:function(cH){if(cH.longTapTimer){window.clearTimeout(cH.longTapTimer);cH.longTapTimer=null;}
;}
...
,dispose:function(){for(var cK in this.__hA){this.__hQ(cK);}
;this._stopObserver();this.__fY=this.__ga=null;}
}});}
)();
...
;return this.__hR(f);}
;if(d===a){var x=0;if(e.wheelDelta!==undefined){if(e.wheelDeltaX!==undefined){x=e.wheelDeltaX?this.__hR(-e.wheelDeltaX):0;}
;}
else {if(e.axis&&e.axis==e.HORIZONTAL_AXIS&&(e.detail!==undefined)&&(e.detail>0)){x=this.__hR(e.detail);}
else if(e.deltaX!==undefined){x=this.__hR(e.deltaX);}
;}
;return x;}
;if(d===b){var y=0;if(e.wheelDelta!==undefined){if(e.wheelDeltaY!==undefined){y=e.wheelDeltaY?this.__hR(-e.wheelDeltaY):0;}
else {y=this.__hR(-e.wheelDelta);}
;}
else {if(!(e.axis&&e.axis==e.HORIZONTAL_AXIS)&&(e.detail!==undefined)&&(e.detail>0)){y=this.__hR(e.detail);}
else if(e.deltaY!==undefined){y=this.__hR(e.deltaY);}
;}
;return y;}
;return 0;}
,__hR:function(j){var g=Math.abs(j);if(g===0){return 0;}
;if(qx.util.Wheel.MINSCROLL==null||qx.util.Wheel.MINSCROLL>g){qx.util.Wheel.MINSCROLL=g;this.__hS();}
;if(qx.util.Wheel.MAXSCROLL==null||qx.util.Wheel.MAXSCROLL<g){qx.util.Wheel.MAXSCROLL=g;this.__hS();}
...
,__hS:function(){var k=qx.util.Wheel.MAXSCROLL||0;var n=qx.util.Wheel.MINSCROLL||k;if(k<=n){return;}
;var l=k-n;var m=(k/l)*Math.log(l);if(m==0){m=1;}
;qx.util.Wheel.FACTOR=6/m;}
}});}
)();
(function(){var a="dblclick",b="mshtml",c="engine.name",d="dispose",e="useraction",f="gesturemove",g="gesturecancel",h="checkAndFireGesture",i="gesturebegin",j="qx.event.handler.Gesture",k="gesturefinish",l="browser.documentmode";qx.Class.define(j,{extend:qx.event.handler.GestureCore,implement:qx.event.IEventHandler,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{tap:1,swipe:1,longtap:1,dbltap:1,rotate:1,pinch:1,track:1,trackstart:1,trackend:1,roll:1},GESTURE_EVENTS:[i,k,f,g],TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT,IGNORE_CAN_HANDLE:true,EVENT_CLASSES:{"tap":qx.event.type.Tap,"longtap":qx.event.type.Tap,"dbltap":qx.event.type.Tap,"swipe":qx.event.type.Swipe,"rotate":qx.event.type.Rotate,"pinch":qx.event.type.Pinch,"track":qx.event.type.Track,"trackstart":qx.event.type.Track,"trackend":qx.event.type.Track,"roll":qx.event.type.Roll}},construct:function(m){this.__dl=m;this.__cI=m.getWindow();this.__dx=this.__cI.document;qx.event.handler.GestureCore.apply(this,[this.__dx]);}
,members:{__dl:null,__cI:null,__dx:null,__fS:null,__hT:null,__hU:null,canHandleEvent:function(o,n){}
,registerEvent:function(r,q,p){}
,unregisterEvent:function(u,t,s){}
,_initObserver:function(){this.__fS=qx.lang.Function.listener(this.checkAndFireGesture,this);qx.event.handler.Gesture.GESTURE_EVENTS.forEach(function(w){qx.event.Registration.addListener(this.__dx,w,this.__fS,this);}
.bind(this));if(qx.core.Environment.get(c)==b&&qx.core.Environment.get(l)<9){this.__hT=qx.lang.Function.listener(this._onDblClick,this);qx.bom.Event.addNativeListener(this.__dx,a,this.__hT);}
;var v=qx.bom.client.Event.getMouseWheel(this.__cI);this.__hU=qx.lang.Function.listener(this._fireRoll,this);qx.bom.Event.addNativeListener(v.target,v.type,this.__hU,this);}
,checkAndFireGesture:function(y,x,z){this.__hz(h,[y.getNativeEvent(),y.getType(),y.getTarget()]);}
,_stopObserver:function(){qx.event.handler.Gesture.GESTURE_EVENTS.forEach(function(B){qx.event.Registration.removeListener(this.__dx,B,this.__fS);}
.bind(this));if(qx.core.Environment.get(c)==b&&qx.core.Environment.get(l)<9){qx.bom.Event.removeNativeListener(this.__dx,a,this.__hT);}
;var A=qx.bom.client.Event.getMouseWheel(this.__cI);qx.bom.Event.removeNativeListener(A.target,A.type,this.__hU);}
...
,dispose:function(){this._stopObserver();this.__hz(d);this.__dl=this.__cI=this.__dx=this.__hT=null;}
,__hz:function(I,H){qx.event.handler.GestureCore.prototype[I].apply(this,H||[]);}
...
(function(){var a="qx.event.handler.UserAction";qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(b){qx.core.Object.call(this);this.__dl=b;this.__cI=b.getWindow();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{useraction:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__dl:null,__cI:null,canHandleEvent:function(d,c){}
,registerEvent:function(g,f,e){}
,unregisterEvent:function(j,i,h){}
},destruct:function(){this.__dl=this.__cI=null;}
,defer:function(k){qx.event.Registration.addHandler(k);}
});}
)();
(function(){var a="dblclick",b="os.name",c="mouseup",d="mousedown",e="useraction",f="webkit",g="contextmenu",h="mousewheel",i="engine.name",j="mouseover",k="mouseout",l="gecko",m="ios",n="click",o="mousemove",p="qx.event.handler.Mouse",q="on";qx.Class.define(p,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(r){qx.core.Object.call(this);this.__dl=r;this.__cI=r.getWindow();this.__dx=this.__cI.document;this._initButtonObserver();this._initMoveObserver();this._initWheelObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT+qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__hV:null,__hW:null,__hX:null,__hY:null,__ia:null,__dl:null,__cI:null,__dx:null,__ib:null,canHandleEvent:function(t,s){}
...
:(function(){return null;}
),__ic:function(A,B,C){if(!C){C=qx.bom.Event.getTarget(A);}
...
,preventNextClick:function(){this.__ib=true;}
,_initButtonObserver:function(){this.__hV=qx.lang.Function.listener(this._onButtonEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__dx,d,this.__hV);Event.addNativeListener(this.__dx,c,this.__hV);Event.addNativeListener(this.__dx,n,this.__hV);Event.addNativeListener(this.__dx,a,this.__hV);Event.addNativeListener(this.__dx,g,this.__hV);}
,_initMoveObserver:function(){this.__hW=qx.lang.Function.listener(this._onMoveEvent,this);var Event=qx.bom.Event;Event.addNativeListener(this.__dx,o,this.__hW);Event.addNativeListener(this.__dx,j,this.__hW);Event.addNativeListener(this.__dx,k,this.__hW);}
,_initWheelObserver:function(){this.__hX=qx.lang.Function.listener(this._onWheelEvent,this);var D=qx.bom.client.Event.getMouseWheel(this.__cI);qx.bom.Event.addNativeListener(D.target,D.type,this.__hX);}
,_stopButtonObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__dx,d,this.__hV);Event.removeNativeListener(this.__dx,c,this.__hV);Event.removeNativeListener(this.__dx,n,this.__hV);Event.removeNativeListener(this.__dx,a,this.__hV);Event.removeNativeListener(this.__dx,g,this.__hV);}
,_stopMoveObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__dx,o,this.__hW);Event.removeNativeListener(this.__dx,j,this.__hW);Event.removeNativeListener(this.__dx,k,this.__hW);}
,_stopWheelObserver:function(){var E=qx.bom.client.Event.getMouseWheel(this.__cI);qx.bom.Event.removeNativeListener(E.target,E.type,this.__hX);}
,_onMoveEvent:qx.event.GlobalError.observeMethod(function(F){this.__ic(F);}
),_onButtonEvent:qx.event.GlobalError.observeMethod(function(I){var H=I.type;var J=qx.bom.Event.getTarget(I);if(H==n&&this.__ib){delete this.__ib;return;}
;if(qx.core.Environment.get(i)==l||qx.core.Environment.get(i)==f){if(J&&J.nodeType==3){J=J.parentNode;}
;}
;var G=qx.event.handler.DragDrop&&this.__dl.getHandler(qx.event.handler.DragDrop).isSessionActive();if(G&&H==n){return;}
;if(this.__ie){this.__ie(I,H,J);}
;this.__ic(I,H,J);if(this.__id){this.__id(I,H,J);}
;if(this.__if&&!G){this.__if(I,H,J);}
;this.__hY=H;}
),_onWheelEvent:qx.event.GlobalError.observeMethod(function(K){this.__ic(K,h);}
),__id:qx.core.Environment.select(i,{"opera":function(L,M,N){if(M==c&&L.button==2){this.__ic(L,g,N);}
;}
,"default":null}),__ie:qx.core.Environment.select(i,{"mshtml":function(O,P,Q){if(O.target!==undefined){return;}
;if(P==c&&this.__hY==n){this.__ic(O,d,Q);}
else if(P==a){this.__ic(O,n,Q);}
;}
,"default":null}),__if:qx.core.Environment.select(i,{"mshtml":null,"default":function(S,R,T){switch(R){case d:this.__ia=T;break;case c:if(T!==this.__ia){var U=qx.dom.Hierarchy.getCommonParent(T,this.__ia);if(U){this.__ic(S,n,U);}
;}
;};}
})},destruct:function(){this._stopButtonObserver();this._stopMoveObserver();this._stopWheelObserver();this.__dl=this.__cI=this.__dx=this.__ia=null;}
...
(function(){var a="mshtml",b="engine.name",c="keypress",d="useraction",e="win",f="text",g="keyinput",h="os.name",i="webkit",j="input",k="gecko",l="off",m="keydown",n="autoComplete",o="keyup",p="qx.event.handler.Keyboard";qx.Class.define(p,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(q){qx.core.Object.call(this);this.__dl=q;this.__cI=q.getWindow();if((qx.core.Environment.get(b)==k)){this.__dx=this.__cI;}
else {this.__dx=this.__cI.document.documentElement;}
;this.__ig={};this._initKeyObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{keyup:1,keydown:1,keypress:1,keyinput:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true},members:{__ih:null,__dl:null,__cI:null,__dx:null,__ig:null,__ii:null,__ij:null,__ik:null,canHandleEvent:function(s,r){}
,registerEvent:function(v,u,t){}
,unregisterEvent:function(y,x,w){}
,_fireInputEvent:function(A,z){var B=this.__il();if(B&&B.offsetWidth!=0){var event=qx.event.Registration.createEvent(g,qx.event.type.KeyInput,[A,B,z]);this.__dl.dispatchEvent(B,event);}
;if(this.__cI){qx.event.Registration.fireEvent(this.__cI,d,qx.event.type.Data,[g]);}
;}
,_fireSequenceEvent:function(D,F,C){var E=this.__il();var G=D.keyCode;var event=qx.event.Registration.createEvent(F,qx.event.type.KeySequence,[D,E,C]);this.__dl.dispatchEvent(E,event);if(qx.core.Environment.get(b)==a||qx.core.Environment.get(b)==i){if(F==m&&event.getDefaultPrevented()){if(!qx.event.util.Keyboard.isNonPrintableKeyCode(G)&&!this._emulateKeyPress[G]){this._fireSequenceEvent(D,c,C);}
;}
;}
;if(this.__cI){qx.event.Registration.fireEvent(this.__cI,d,qx.event.type.Data,[F]);}
;}
,__il:function(){var H=this.__dl.getHandler(qx.event.handler.Focus);var I=H.getActive();if(!I||I.offsetWidth==0){I=H.getFocus();}
;if(!I||I.offsetWidth==0){I=this.__dl.getWindow().document.body;}
;return I;}
,_initKeyObserver:function(){this.__ih=qx.lang.Function.listener(this.__im,this);this.__ik=qx.lang.Function.listener(this.__io,this);var Event=qx.bom.Event;Event.addNativeListener(this.__dx,o,this.__ih);Event.addNativeListener(this.__dx,m,this.__ih);Event.addNativeListener(this.__dx,c,this.__ik);}
,_stopKeyObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__dx,o,this.__ih);Event.removeNativeListener(this.__dx,m,this.__ih);Event.removeNativeListener(this.__dx,c,this.__ik);for(var K in (this.__ij||{})){var J=this.__ij[K];Event.removeNativeListener(J.target,c,J.callback);}
;delete (this.__ij);}
...
},destruct:function(){this._stopKeyObserver();this.__ii=this.__dl=this.__cI=this.__dx=this.__ig=null;}
...
;}
,tryActivate:function(Y){var X=this.__iQ(Y);if(X){this.setActive(X);}
;}
,__ic:function(ba,bc,bf,be){var bd=qx.event.Registration;var bb=bd.createEvent(bf,qx.event.type.Focus,[ba,bc,be]);bd.dispatchEvent(ba,bb);}
,_windowFocused:true,__iD:function(){if(this._windowFocused){this._windowFocused=false;this.__ic(this._window,null,c,false);}
;}
,__iE:function(){if(!this._windowFocused){this._windowFocused=true;this.__ic(this._window,null,f,false);}
;}
,_initObserver:qx.core.Environment.select(y,{"gecko":function(){this.__iq=qx.lang.Function.listener(this.__iK,this);this.__ir=qx.lang.Function.listener(this.__iL,this);this.__is=qx.lang.Function.listener(this.__iJ,this);this.__it=qx.lang.Function.listener(this.__iI,this);this.__iu=qx.lang.Function.listener(this.__iF,this);qx.bom.Event.addNativeListener(this._document,d,this.__iq,true);qx.bom.Event.addNativeListener(this._document,z,this.__ir,true);qx.bom.Event.addNativeListener(this._window,f,this.__is,true);qx.bom.Event.addNativeListener(this._window,c,this.__it,true);qx.bom.Event.addNativeListener(this._window,D,this.__iu,true);}
,"mshtml":function(){this.__iq=qx.lang.Function.listener(this.__iK,this);this.__ir=qx.lang.Function.listener(this.__iL,this);this.__iw=qx.lang.Function.listener(this.__iG,this);this.__ix=qx.lang.Function.listener(this.__iH,this);this.__iv=qx.lang.Function.listener(this.__iN,this);qx.bom.Event.addNativeListener(this._document,d,this.__iq);qx.bom.Event.addNativeListener(this._document,z,this.__ir);qx.bom.Event.addNativeListener(this._document,w,this.__iw);qx.bom.Event.addNativeListener(this._document,B,this.__ix);qx.bom.Event.addNativeListener(this._document,a,this.__iv);}
,"webkit":function(){this.__iq=qx.lang.Function.listener(this.__iK,this);this.__ir=qx.lang.Function.listener(this.__iL,this);this.__ix=qx.lang.Function.listener(this.__iH,this);this.__is=qx.lang.Function.listener(this.__iJ,this);this.__it=qx.lang.Function.listener(this.__iI,this);this.__iv=qx.lang.Function.listener(this.__iN,this);qx.bom.Event.addNativeListener(this._document,d,this.__iq,true);qx.bom.Event.addNativeListener(this._document,z,this.__ir,true);qx.bom.Event.addNativeListener(this._document,a,this.__iv,false);qx.bom.Event.addNativeListener(this._window,A,this.__ix,true);qx.bom.Event.addNativeListener(this._window,f,this.__is,true);qx.bom.Event.addNativeListener(this._window,c,this.__it,true);}
,"opera":function(){this.__iq=qx.lang.Function.listener(this.__iK,this);this.__ir=qx.lang.Function.listener(this.__iL,this);this.__iw=qx.lang.Function.listener(this.__iG,this);this.__ix=qx.lang.Function.listener(this.__iH,this);qx.bom.Event.addNativeListener(this._document,d,this.__iq,true);qx.bom.Event.addNativeListener(this._document,z,this.__ir,true);qx.bom.Event.addNativeListener(this._window,j,this.__iw,true);qx.bom.Event.addNativeListener(this._window,A,this.__ix,true);}
}),_stopObserver:qx.core.Environment.select(y,{"gecko":function(){qx.bom.Event.removeNativeListener(this._document,d,this.__iq,true);qx.bom.Event.removeNativeListener(this._document,z,this.__ir,true);qx.bom.Event.removeNativeListener(this._window,f,this.__is,true);qx.bom.Event.removeNativeListener(this._window,c,this.__it,true);qx.bom.Event.removeNativeListener(this._window,D,this.__iu,true);}
,"mshtml":function(){qx.bom.Event.removeNativeListener(this._document,d,this.__iq);qx.bom.Event.removeNativeListener(this._document,z,this.__ir);qx.bom.Event.removeNativeListener(this._document,w,this.__iw);qx.bom.Event.removeNativeListener(this._document,B,this.__ix);qx.bom.Event.removeNativeListener(this._document,a,this.__iv);}
,"webkit":function(){qx.bom.Event.removeNativeListener(this._document,d,this.__iq,true);qx.bom.Event.removeNativeListener(this._document,z,this.__ir,true);qx.bom.Event.removeNativeListener(this._document,a,this.__iv,false);qx.bom.Event.removeNativeListener(this._window,A,this.__ix,true);qx.bom.Event.removeNativeListener(this._window,f,this.__is,true);qx.bom.Event.removeNativeListener(this._window,c,this.__it,true);}
,"opera":function(){qx.bom.Event.removeNativeListener(this._document,d,this.__iq,true);qx.bom.Event.removeNativeListener(this._document,z,this.__ir,true);qx.bom.Event.removeNativeListener(this._window,j,this.__iw,true);qx.bom.Event.removeNativeListener(this._window,A,this.__ix,true);}
}),__iF:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"gecko":function(bg){var bh=qx.bom.Event.getTarget(bg);if(!this.__iR(bh)){qx.bom.Event.preventDefault(bg);}
;}
,"default":null})),__iG:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"mshtml":function(bj){this.__iE();var bk=qx.bom.Event.getTarget(bj);var bi=this.__iP(bk);if(bi){this.setFocus(bi);}
;this.tryActivate(bk);}
,"opera":function(bl){var bm=qx.bom.Event.getTarget(bl);if(bm==this._document||bm==this._window){this.__iE();if(this.__iy){this.setFocus(this.__iy);delete this.__iy;}
;if(this.__iz){this.setActive(this.__iz);delete this.__iz;}
;}
else {this.setFocus(bm);this.tryActivate(bm);if(!this.__iR(bm)){bm.selectionStart=0;bm.selectionEnd=0;}
;}
;}
,"default":null})),__iH:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"mshtml":function(bn){var bo=qx.bom.Event.getRelatedTarget(bn);if(bo==null){this.__iD();this.resetFocus();this.resetActive();}
;}
...
;}
,"opera":function(br){var bs=qx.bom.Event.getTarget(br);if(bs==this._document){this.__iD();this.__iy=this.getFocus();this.__iz=this.getActive();this.resetFocus();this.resetActive();}
else {if(bs===this.getFocus()){this.resetFocus();}
;if(bs===this.getActive()){this.resetActive();}
;}
;}
,"default":null})),__iI:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"gecko":function(bt){var bu=qx.bom.Event.getTarget(bt);if(bu===this._window||bu===this._document){this.__iD();this.resetActive();this.resetFocus();}
;}
,"webkit":function(bv){var bw=qx.bom.Event.getTarget(bv);if(bw===this._window||bw===this._document){this.__iD();this.__iy=this.getFocus();this.__iz=this.getActive();this.resetActive();this.resetFocus();}
;}
,"default":null})),__iJ:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"gecko":function(bx){var by=qx.bom.Event.getTarget(bx);if(by===this._window||by===this._document){this.__iE();by=this._body;}
;this.setFocus(by);this.tryActivate(by);}
,"webkit":function(bz){var bA=qx.bom.Event.getTarget(bz);if(bA===this._window||bA===this._document){this.__iE();if(this.__iy){this.setFocus(this.__iy);delete this.__iy;}
;if(this.__iz){this.setActive(this.__iz);delete this.__iz;}
;}
else {this.__iC=bz.relatedTarget;this.setFocus(bA);this.__iC=null;this.tryActivate(bA);}
;}
,"default":null})),__iK:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"mshtml":function(bC){var bD=qx.bom.Event.getTarget(bC);var bB=this.__iP(bD);if(bB){if(!this.__iR(bD)){bD.unselectable=u;try{if(document.selection){document.selection.empty();}
;}
catch(bE){}
;try{bB.focus();}
catch(bF){}
;}
;}
else {qx.bom.Event.preventDefault(bC);if(!this.__iR(bD)){bD.unselectable=u;}
;}
;}
,"webkit":function(bH){var bI=qx.bom.Event.getTarget(bH);var bG=this.__iP(bI);if(bG){this.setFocus(bG);}
else {qx.bom.Event.preventDefault(bH);}
;}
,"gecko":function(bK){var bL=qx.bom.Event.getTarget(bK);var bJ=this.__iP(bL);if(bJ){this.setFocus(bJ);}
else {qx.bom.Event.preventDefault(bK);}
;}
,"opera":function(bO){var bP=qx.bom.Event.getTarget(bO);var bM=this.__iP(bP);if(!this.__iR(bP)){qx.bom.Event.preventDefault(bO);if(bM){var bN=this.getFocus();if(bN&&bN.selectionEnd){bN.selectionStart=0;bN.selectionEnd=0;bN.blur();}
;if(bM){this.setFocus(bM);}
;}
;}
else if(bM){this.setFocus(bM);}
;}
,"default":null})),__iL:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"mshtml":function(bQ){var bR=qx.bom.Event.getTarget(bQ);if(bR.unselectable){bR.unselectable=t;}
;this.tryActivate(this.__iM(bR));}
...
;}
,"webkit":function(bU){var bV=qx.bom.Event.getTarget(bU);this.tryActivate(this.__iM(bV));}
,"opera":function(bW){var bX=qx.bom.Event.getTarget(bW);this.tryActivate(this.__iM(bX));}
,"default":null})),__iM:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"mshtml":function(bY){var ca=this.getFocus();if(ca&&bY!=ca&&(ca.nodeName.toLowerCase()===o||ca.nodeName.toLowerCase()===l)){bY=ca;}
;return bY;}
...
})),__iN:qx.event.GlobalError.observeMethod(qx.core.Environment.select(y,{"mshtml":function(ce){var cf=qx.bom.Event.getTarget(ce);if(!this.__iR(cf)){qx.bom.Event.preventDefault(ce);}
;}
,"webkit":function(cg){var ch=qx.bom.Event.getTarget(cg);if(!this.__iR(ch)){qx.bom.Event.preventDefault(cg);}
;}
,"default":null})),__iO:function(ci){var cj=qx.bom.element.Attribute.get(ci,s);if(cj>=1){return true;}
;var ck=qx.event.handler.Focus.FOCUSABLE_ELEMENTS;if(cj>=0&&ck[ci.tagName]){return true;}
;return false;}
,__iP:function(cl){while(cl&&cl.nodeType===1){if(cl.getAttribute(C)==u){return null;}
;if(this.__iO(cl)){return cl;}
;cl=cl.parentNode;}
;return this._body;}
,__iQ:function(cm){var cn=cm;while(cm&&cm.nodeType===1){if(cm.getAttribute(E)==u){return null;}
;cm=cm.parentNode;}
;return cn;}
,__iR:function(co){while(co&&co.nodeType===1){var cp=co.getAttribute(r);if(cp!=null){return cp===u;}
;co=co.parentNode;}
;return true;}
,_applyActive:function(cr,cq){if(cq){this.__ic(cq,cr,k,true);}
;if(cr){this.__ic(cr,cq,v,true);}
;if(this.__ip){window.scrollTo(0,0);}
;}
,_applyFocus:function(ct,cs){if(cs){this.__ic(cs,ct,B,true);}
;if(ct){this.__ic(ct,cs,w,true);}
;if(cs){this.__ic(cs,ct,c,false);}
;if(ct){this.__ic(ct,cs||this.__iC,f,false);}
;}
},destruct:function(){this._stopObserver();this._manager=this._window=this._document=this._root=this._body=this.__iS=this.__iC=null;}
...
,"default":function(t){if(this.__iT(t)){return t.value.substring(t.selectionStart,t.selectionEnd);}
...
,"default":function(x){if(qx.core.Environment.get(a)==k){var B,C,A;if(this.__iT(x)){var z=x.selectionStart;var y=x.selectionEnd;B=x.value.substring(z,y);C=y-z;}
else {B=qx.bom.Selection.get(x);C=B.length;}
;A=qx.util.StringSplit.split(B,/\r\n/);return C-(A.length-1);}
;if(this.__iT(x)){return x.selectionEnd-x.selectionStart;}
else {return this.get(x).length;}
;}
}),getStart:qx.core.Environment.select(m,{"selection":function(D){if(this.__iT(D)){var I=qx.bom.Range.get();if(!D.contains(I.parentElement())){return -1;}
...
;return  ++L;}
;}
,"default":function(N){if(qx.core.Environment.get(a)===i||qx.core.Environment.get(a)===g){if(this.__iT(N)){return N.selectionStart;}
...
;}
;}
;if(this.__iT(N)){return N.selectionStart;}
else {return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(N)).anchorOffset;}
;}
}),getEnd:qx.core.Environment.select(m,{"selection":function(Q){if(this.__iT(Q)){var V=qx.bom.Range.get();if(!Q.contains(V.parentElement())){return -1;}
...
;return U-( ++Y);}
;}
,"default":function(bb){if(qx.core.Environment.get(a)===i||qx.core.Environment.get(a)===g){if(this.__iT(bb)){return bb.selectionEnd;}
...
;}
;}
;if(this.__iT(bb)){return bb.selectionEnd;}
else {return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(bb)).focusOffset;}
;}
}),__iT:function(be){return qx.dom.Node.isElement(be)&&(be.nodeName.toLowerCase()==h||be.nodeName.toLowerCase()==n);}
...
(function(){var a="touchmove",b="os.name",c="MSPointerDown",d="android",e="engine.version",f="pointercancel",g="qx.event.handler.TouchCore",h="event.mspointer",j="MSPointerCancel",k="y",l="pointer-events",m="pointerup",n="touchend",o="pointerdown",p="MSPointerUp",q="right",r="engine.name",s="undefined",t="touchcancel",u="MSPointerMove",v="webkit",w="none",z="left",A="pointermove",B="down",C="x",D="up",E="touchstart";qx.Bootstrap.define(g,{extend:Object,statics:{TAP_MAX_DISTANCE:qx.core.Environment.get(b)!=d?10:40,SWIPE_DIRECTION:{x:[z,q],y:[D,B]},SWIPE_MIN_DISTANCE:qx.core.Environment.get(b)!=d?11:41,SWIPE_MIN_VELOCITY:0,LONGTAP_TIME:500},construct:function(F,G){this.__iU=F;this.__ga=G;this._initTouchObserver();this.__iV=[];this.__iW={};}
,members:{__iU:null,__ga:null,__iX:null,__iY:null,__iW:null,__ja:null,__jb:null,__jc:null,__iV:null,__jd:null,_initTouchObserver:function(){this.__iX=qx.lang.Function.listener(this._onTouchEvent,this);this.__jd=[E,a,n,t];if(qx.core.Environment.get(h)){var H=parseInt(qx.core.Environment.get(e),10);if(H==10){this.__jd=[c,u,p,j];}
else {this.__jd=[o,A,m,f];}
;}
;for(var i=0;i<this.__jd.length;i++ ){qx.bom.Event.addNativeListener(this.__iU,this.__jd[i],this.__iX);}
;}
,_stopTouchObserver:function(){for(var i=0;i<this.__jd.length;i++ ){qx.bom.Event.removeNativeListener(this.__iU,this.__jd[i],this.__iX);}
;}
...
;return O;}
,_calcSingleTouchDelta:function(S){if(this.__iW.hasOwnProperty(S.identifier)){var R=this.__iW[S.identifier];var P=Math.floor(S.clientX-R[0]);var Q=Math.floor(S.clientY-R[1]);var T=C;if(Math.abs(P/Q)<1){T=k;}
...
;V.delta=[];if(ba==E){this.__iY=this._getTarget(V);if(V.touches&&V.touches.length>1){this.__jb=this._getScalingDistance(V.touches[0],V.touches[1]);this.__jc=this._getRotationAngle(V.touches[0],V.touches[1]);}
;for(var i=0;i<V.changedTouches.length;i++ ){var Y=V.changedTouches[i];this.__iW[Y.identifier]=[Y.clientX,Y.clientY];}
;}
;if(ba==a){if(typeof V.scale==s&&V.targetTouches.length>1){var W=this._getScalingDistance(V.targetTouches[0],V.targetTouches[1]);V.scale=W/this.__jb;}
;if((typeof V.rotation==s||qx.core.Environment.get(h))&&V.targetTouches.length>1){var X=this._getRotationAngle(V.targetTouches[0],V.targetTouches[1]);V._rotation=X-this.__jc;}
;V.delta=this._calcTouchesDelta(V.targetTouches);}
;this._fireEvent(V,ba,this.__iY);if(qx.core.Environment.get(h)){if(ba==n||ba==t){delete this.__iV[V.pointerId];}
;}
;if((ba==n||ba==t)&&V.changedTouches[0]){delete this.__iW[V.changedTouches[0].identifier];}
;}
,_detectTouchesByPointer:function(bd,bf){var bc=[];if(bf==E){this.__iV[bd.pointerId]=bd;}
else if(bf==a){this.__iV[bd.pointerId]=bd;}
;for(var be in this.__iV){var bb=this.__iV[be];bc.push(bb);}
;return bc;}
...
;}
else if(qx.core.Environment.get(h)){var bh=this.__je(bi);if(bh){bj=bh;}
;}
;return bj;}
,__je:function(bm){var bk=null;var bl=null;if(bm&&bm.touches&&bm.touches.length!==0){bk=bm.touches[0].clientX;bl=bm.touches[0].clientY;}
...
;var br=br||bq.type;if(bs&&bs.nodeType&&this.__ga){this.__ga.emit(br,bq);}
;}
,dispose:function(){this._stopTouchObserver();this.__iY=this.__iU=this.__jd=this.__iV=this.__ga=this.__jb=this.__jc=null;}
}});}
)();
(function(){var a="resize",b="os.name",c="qx.event.handler.Orientation",d="landscape",e="android",f="portrait",g="orientationchange";qx.Class.define(c,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(h){qx.core.Object.call(this);this.__dl=h;this.__cI=h.getWindow();this._initObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{orientationchange:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__dl:null,__cI:null,__jf:null,_currentOrientation:null,__jg:null,canHandleEvent:function(j,i){}
,registerEvent:function(m,l,k){}
,unregisterEvent:function(p,o,n){}
,_initObserver:function(){this.__jg=qx.lang.Function.listener(this._onNative,this);this.__jf=qx.bom.Event.supportsEvent(this.__cI,g)?g:a;var Event=qx.bom.Event;Event.addNativeListener(this.__cI,this.__jf,this.__jg);}
,_stopObserver:function(){var Event=qx.bom.Event;Event.removeNativeListener(this.__cI,this.__jf,this.__jg);}
...
;}
},destruct:function(){this._stopObserver();this.__dl=this.__cI=null;}
,defer:function(w){qx.event.Registration.addHandler(w);}
});}
)();
(function(){var a="landscape",b="qx.event.type.Orientation",c="portrait";qx.Class.define(b,{extend:qx.event.type.Event,members:{__jh:null,__ji:null,init:function(d,e){qx.event.type.Event.prototype.init.call(this,false,false);this.__jh=d;this.__ji=e;return this;}
,clone:function(f){var g=qx.event.type.Event.prototype.clone.call(this,f);g.__jh=this.__jh;g.__ji=this.__ji;return g;}
,getOrientation:function(){return this.__jh;}
,isLandscape:function(){return this.__ji==a;}
,isPortrait:function(){return this.__ji==c;}
}});}
)();
(function(){var a="touchmove",b="dispose",c="useraction",d="touchend",e="event.touch",f="touchstart",g="qx.event.handler.Touch";qx.Class.define(g,{extend:qx.event.handler.TouchCore,implement:qx.event.IEventHandler,construct:function(h){this.__dl=h;this.__cI=h.getWindow();this.__dx=this.__cI.document;qx.event.handler.TouchCore.apply(this,[this.__dx]);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{touchstart:1,touchmove:1,touchend:1,touchcancel:1,tap:1,longtap:1,swipe:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT,IGNORE_CAN_HANDLE:true,MOUSE_TO_TOUCH_MAPPING:{"mousedown":f,"mousemove":a,"mouseup":d}},members:{__dl:null,__cI:null,__dx:null,__jj:false,canHandleEvent:function(j,i){}
,registerEvent:function(m,l,k){}
,unregisterEvent:function(p,o,n){}
...
),dispose:function(){this.__hz(b);this.__dl=this.__cI=this.__dx=null;}
,__hz:function(w,v){qx.event.handler.TouchCore.prototype[w].apply(this,v||[]);}
...
,isMultiTouch:function(){return this.__jl().length>1;}
,getScale:function(){return this._native.scale;}
,getRotation:function(){if(typeof this._native._rotation===d){return this._native.rotation;}
else {return this._native._rotation;}
;}
,getDelta:function(){return this._native.delta;}
,getDocumentLeft:function(g){return this.__jk(g).pageX;}
,getDocumentTop:function(h){return this.__jk(h).pageY;}
,getScreenLeft:function(j){return this.__jk(j).screenX;}
,getScreenTop:function(k){return this.__jk(k).screenY;}
,getViewportLeft:function(l){return this.__jk(l).clientX;}
,getViewportTop:function(m){return this.__jk(m).clientY;}
,getIdentifier:function(n){return this.__jk(n).identifier;}
,__jk:function(o){o=o==null?0:o;return this.__jl()[o];}
,__jl:function(){var p=(this._isTouchEnd()?this.getChangedTargetTouches():this.getTargetTouches());return p;}
...
;}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{input:1,change:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__jm:false,__jn:null,__jo:null,__jp:null,canHandleEvent:function(C,B){var A=C.tagName.toLowerCase();if(B===m&&(A===m||A===f)){return true;}
;if(B===k&&(A===m||A===f||A===p)){return true;}
;return false;}
,registerEvent:function(H,G,E){if(qx.core.Environment.get(v)==u&&(qx.core.Environment.get(b)<9||(qx.core.Environment.get(b)>=9&&qx.core.Environment.get(q)<9))){if(!H.__jq){var F=H.tagName.toLowerCase();var D=H.type;if(D===a||D===g||F===f||D===x||D===d){qx.bom.Event.addNativeListener(H,h,this._onPropertyWrapper);}
...
;}
;}
,__jr:qx.core.Environment.select(v,{"mshtml":function(I){if(qx.core.Environment.get(b)>=9&&qx.core.Environment.get(q)>=9){qx.bom.Event.addNativeListener(I,m,this._onInputWrapper);if(I.type===a||I.type===g||I.type===f){this._inputFixWrapper=qx.lang.Function.listener(this._inputFix,this,I);qx.bom.Event.addNativeListener(I,t,this._inputFixWrapper);}
;}
;}
...
}),unregisterEvent:function(Q,P){if(qx.core.Environment.get(v)==u&&qx.core.Environment.get(b)<9&&qx.core.Environment.get(q)<9){if(Q.__jq){var O=Q.tagName.toLowerCase();var N=Q.type;if(N===a||N===g||O===f||N===x||N===d){qx.bom.Event.removeNativeListener(Q,h,this._onPropertyWrapper);}
...
;}
;}
,__js:qx.core.Environment.select(v,{"mshtml":function(S){if(qx.core.Environment.get(b)>=9&&qx.core.Environment.get(q)>=9){qx.bom.Event.removeNativeListener(S,m,this._onInputWrapper);if(S.type===a||S.type===g||S.type===f){qx.bom.Event.removeNativeListener(S,t,this._inputFixWrapper);}
;}
;}
...
}),_onKeyPress:qx.core.Environment.select(v,{"mshtml":function(e,X){if(e.keyCode===13){if(X.value!==this.__jo){this.__jo=X.value;qx.event.Registration.fireEvent(X,k,qx.event.type.Data,[X.value]);}
;}
;}
,"opera":function(e,Y){if(e.keyCode===13){if(Y.value!==this.__jo){this.__jo=Y.value;qx.event.Registration.fireEvent(Y,k,qx.event.type.Data,[Y.value]);}
;}
;}
,"default":null}),_inputFix:qx.core.Environment.select(v,{"mshtml":function(e,ba){if(e.keyCode===46||e.keyCode===8){if(ba.value!==this.__jp){this.__jp=ba.value;qx.event.Registration.fireEvent(ba,m,qx.event.type.Data,[ba.value]);}
;}
;}
,"default":null}),_onKeyDown:qx.core.Environment.select(v,{"opera":function(e){if(e.keyCode===13){this.__jm=true;}
;}
,"default":null}),_onKeyUp:qx.core.Environment.select(v,{"opera":function(e){if(e.keyCode===13){this.__jm=false;}
;}
,"default":null}),_onInput:qx.event.GlobalError.observeMethod(function(e){var bc=qx.bom.Event.getTarget(e);var bb=bc.tagName.toLowerCase();if(!this.__jm||bb!==m){if((qx.core.Environment.get(v)==s)&&qx.core.Environment.get(r)<10.6){this.__jn=window.setTimeout(function(){qx.event.Registration.fireEvent(bc,m,qx.event.type.Data,[bc.value]);}
,0);}
...
(function(){var a="offline",b="qx.event.handler.Offline",c="online";qx.Class.define(b,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(d){qx.core.Object.call(this);this.__dl=d;this.__cI=d.getWindow();this._initObserver();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{online:true,offline:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__dl:null,__cI:null,__jg:null,canHandleEvent:function(f,e){}
,registerEvent:function(i,h,g){}
,unregisterEvent:function(l,k,j){}
,_initObserver:function(){this.__jg=qx.lang.Function.listener(this._onNative,this);qx.bom.Event.addNativeListener(this.__cI,a,this.__jg);qx.bom.Event.addNativeListener(this.__cI,c,this.__jg);}
,_stopObserver:function(){qx.bom.Event.removeNativeListener(this.__cI,a,this.__jg);qx.bom.Event.removeNativeListener(this.__cI,c,this.__jg);}
...
},destruct:function(){this.__dl=null;this._stopObserver();delete qx.event.handler.Appear.__instances[this.$$hash];}
...
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST},members:{__cK:null,__jt:null,__ju:true,__cI:null,_getParent:function(n){return n.parentNode;}
,canDispatchEvent:function(p,event,o){return !!(this.__jt&&this.__jv[o]);}
,dispatchEvent:function(r,event,q){if(q==g){event.stopPropagation();this.releaseCapture();return;}
;if(this.__ju||!qx.dom.Hierarchy.contains(this.__jt,r)){r=this.__jt;}
;qx.event.dispatch.AbstractBubbling.prototype.dispatchEvent.call(this,r,event,q);}
,__jv:{"mouseup":1,"mousedown":1,"click":1,"dblclick":1,"mousemove":1,"mouseout":1,"mouseover":1,"pointerdown":1,"pointerup":1,"pointermove":1,"pointerover":1,"pointerout":1,"tap":1,"dbltap":1},activateCapture:function(t,s){var s=s!==false;if(this.__jt===t&&this.__ju==s){return;}
;if(this.__jt){this.releaseCapture();}
...
;this.__ju=s;this.__jt=t;this.__cK.fireEvent(t,i,qx.event.type.Event,[true,false]);}
,getCaptureElement:function(){return this.__jt;}
,releaseCapture:function(){var u=this.__jt;if(!u){return;}
;this.__jt=null;this.__cK.fireEvent(u,d,qx.event.type.Event,[true,false]);this.nativeReleaseCapture(u);}
...
,"default":(function(){}
)})},destruct:function(){this.__jt=this.__cI=this.__cK=null;}
...
;}
;return false;}
,__jw:{quicktime:{plugin:[k],control:f},wmv:{plugin:[v],control:L},divx:{plugin:[E],control:Q},silverlight:{plugin:[c],control:F},pdf:{plugin:[t,g],control:M}},getQuicktimeVersion:function(){var V=qx.bom.client.Plugin.__jw[D];return qx.bom.client.Plugin.__jx(V.control,V.plugin);}
,getWindowsMediaVersion:function(){var W=qx.bom.client.Plugin.__jw[n];return qx.bom.client.Plugin.__jx(W.control,W.plugin,true);}
,getDivXVersion:function(){var X=qx.bom.client.Plugin.__jw[u];return qx.bom.client.Plugin.__jx(X.control,X.plugin);}
,getSilverlightVersion:function(){var Y=qx.bom.client.Plugin.__jw[H];return qx.bom.client.Plugin.__jx(Y.control,Y.plugin);}
,getPdfVersion:function(){var ba=qx.bom.client.Plugin.__jw[m];return qx.bom.client.Plugin.__jx(ba.control,ba.plugin);}
,getQuicktime:function(){var bb=qx.bom.client.Plugin.__jw[D];return qx.bom.client.Plugin.__jy(bb.control,bb.plugin);}
,getWindowsMedia:function(){var bc=qx.bom.client.Plugin.__jw[n];return qx.bom.client.Plugin.__jy(bc.control,bc.plugin,true);}
,getDivX:function(){var bd=qx.bom.client.Plugin.__jw[u];return qx.bom.client.Plugin.__jy(bd.control,bd.plugin);}
,getSilverlight:function(){var be=qx.bom.client.Plugin.__jw[H];return qx.bom.client.Plugin.__jy(be.control,be.plugin);}
,getPdf:function(){var bf=qx.bom.client.Plugin.__jw[m];return qx.bom.client.Plugin.__jy(bf.control,bf.plugin);}
,__jx:function(bo,bk,bj){var bg=qx.bom.client.Plugin.__jy(bo,bk,bj);if(!bg){return w;}
...
;return w;}
;}
,__jy:function(bt,br,bq){if(qx.bom.client.Engine.getName()==x&&(qx.bom.client.Browser.getDocumentMode()<11||bq)){if(!this.getActiveX()){return false;}
...
;var t=document.createElement(q);var s=t.style;s.height=s.width=m;s.overflow=w;document.body.appendChild(t);var c=z(t);this.__jz=c;document.body.removeChild(t);return this.__jz;}
...
(function(){var a=" due to exceptions in user code. The application has to be reloaded!",b="Error in the 'Appearance' queue:",c="Error in the 'Widget' queue:",d="\n",f="Error in the 'Layout' queue:",g="Error in the 'Visibility' queue:",h="qx.debug",i="useraction",j="qx.debug.ui.queue",k="Error while layout flush: ",l="Error in the 'Dispose' queue:",m="Stack trace: \n",n="event.touch",o="qx.ui.core.queue.Manager",p=" times in a row",q="Fatal Error: Flush terminated ";qx.Class.define(o,{statics:{__jA:false,__gK:false,__jB:{},__jC:0,MAX_RETRIES:10,scheduleFlush:function(r){var self=qx.ui.core.queue.Manager;self.__jB[r]=true;if(!self.__jA){self.__gK=false;qx.bom.AnimationFrame.request(function(){if(self.__gK){self.__gK=false;return;}
;self.flush();}
,self);self.__jA=true;}
;}
,flush:function(){var self=qx.ui.core.queue.Manager;if(self.__jD){return;}
;self.__jD=true;self.__gK=true;var s=self.__jB;self.__jE(function(){while(s.visibility||s.widget||s.appearance||s.layout||s.element){if(s.widget){delete s.widget;if(qx.core.Environment.get(j)){try{qx.ui.core.queue.Widget.flush();}
...
;}
;}
,function(){self.__jA=false;}
);self.__jE(function(){if(s.dispose){delete s.dispose;if(qx.core.Environment.get(j)){try{qx.ui.core.queue.Dispose.flush();}
catch(e){qx.log.Logger.error(l+e);}
;}
else {qx.ui.core.queue.Dispose.flush();}
;}
;}
,function(){self.__jD=false;}
);self.__jC=0;}
,__jE:qx.core.Environment.select(h,{"true":function(t,u){t();u();}
...
;self.__jA=false;self.__jD=false;self.__jC+=1;if(self.__jC<=self.MAX_RETRIES){self.scheduleFlush();}
else {throw new Error(q+(self.__jC-1)+p+a);}
;throw e;}
finally{w();}
;}
}),__jF:function(e){qx.ui.core.queue.Manager.flush();}
},defer:function(x){qx.html.Element._scheduleFlush=x.scheduleFlush;qx.event.Registration.addListener(window,i,qx.core.Environment.get(n)?x.__jF:x.flush);}
});}
)();
(function(){var a="qx.ui.core.queue.Widget",b="widget",c="$$default";qx.Class.define(a,{statics:{__en:[],__jB:{},remove:function(e,g){var d=this.__en;if(!qx.lang.Array.contains(d,e)){return;}
;var f=e.$$hash;if(g==null){qx.lang.Array.remove(d,e);delete this.__jB[f];return;}
;if(this.__jB[f]){delete this.__jB[f][g];if(qx.lang.Object.getLength(this.__jB[f])==0){qx.lang.Array.remove(d,e);}
;}
;}
,add:function(j,l){var h=this.__en;if(!qx.lang.Array.contains(h,j)){h.unshift(j);}
;if(l==null){l=c;}
;var k=j.$$hash;if(!this.__jB[k]){this.__jB[k]={};}
;this.__jB[k][l]=true;qx.ui.core.queue.Manager.scheduleFlush(b);}
,flush:function(){var m=this.__en;var n,o;for(var i=m.length-1;i>=0;i-- ){n=m[i];o=this.__jB[n.$$hash];m.splice(i,1);n.syncWidget(o);}
;if(m.length!=0){return;}
;this.__en=[];this.__jB={};}
}});}
)();
(function(){var a="qx.ui.core.queue.Visibility",b="visibility";qx.Class.define(a,{statics:{__en:[],__jG:{},__dc:{},remove:function(c){if(this.__jG[c.$$hash]){delete this.__jG[c.$$hash];qx.lang.Array.remove(this.__en,c);}
;delete this.__dc[c.$$hash];}
,isVisible:function(d){return this.__dc[d.$$hash]||false;}
,__jH:function(f){var h=this.__dc;var g=f.$$hash;var e;if(f.isExcluded()){e=false;}
else {var parent=f.$$parent;if(parent){e=this.__jH(parent);}
else {e=f.isRootWidget();}
;}
;return h[g]=e;}
,add:function(j){if(this.__jG[j.$$hash]){return;}
;this.__en.unshift(j);this.__jG[j.$$hash]=j;qx.ui.core.queue.Manager.scheduleFlush(b);}
,flush:function(){var n=this.__en;var o=this.__dc;for(var i=n.length-1;i>=0;i-- ){var m=n[i].$$hash;if(o[m]!=null){n[i].addChildrenToQueue(n);}
;}
;var k={};for(var i=n.length-1;i>=0;i-- ){var m=n[i].$$hash;k[m]=o[m];o[m]=null;}
;for(var i=n.length-1;i>=0;i-- ){var l=n[i];var m=l.$$hash;n.splice(i,1);if(o[m]==null){this.__jH(l);}
;if(o[m]&&o[m]!=k[m]){l.checkAppearanceNeeds();}
;}
;this.__en=[];this.__jG={};}
}});}
)();
(function(){var a="appearance",b="qx.ui.core.queue.Appearance";qx.Class.define(b,{statics:{__en:[],__jG:{},remove:function(c){if(this.__jG[c.$$hash]){qx.lang.Array.remove(this.__en,c);delete this.__jG[c.$$hash];}
;}
,add:function(d){if(this.__jG[d.$$hash]){return;}
;this.__en.unshift(d);this.__jG[d.$$hash]=d;qx.ui.core.queue.Manager.scheduleFlush(a);}
,has:function(e){return !!this.__jG[e.$$hash];}
,flush:function(){var h=qx.ui.core.queue.Visibility;var f=this.__en;var g;for(var i=f.length-1;i>=0;i-- ){g=f[i];f.splice(i,1);delete this.__jG[g.$$hash];if(h.isVisible(g)){g.syncAppearance();}
else {g.$$stateChanges=true;}
;}
;}
}});}
)();
(function(){var a="dispose",b="qx.ui.core.queue.Dispose";qx.Class.define(b,{statics:{__en:[],add:function(d){var c=this.__en;if(qx.lang.Array.contains(c,d)){return;}
;c.unshift(d);qx.ui.core.queue.Manager.scheduleFlush(a);}
,isEmpty:function(){return this.__en.length==0;}
,flush:function(){var e=this.__en;for(var i=e.length-1;i>=0;i-- ){var f=e[i];e.splice(i,1);f.dispose();}
;if(e.length!=0){return;}
;this.__en=[];}
}});}
)();
(function(){var a="backgroundColor",b="drag",c="_applyNativeContextMenu",d="touch",f="div",g="_applyBackgroundColor",h="qx.event.type.Data",j="object",k="_applyFocusable",m=" requires a layout, but no one was defined!",n="qx.event.type.KeyInput",o="focused",p="disabled",q="move",r="createChildControl",s="qxanonymous",t="Unsupported control: ",u="dragstart",v="Invalid left decorator inset detected: ",w="Font",x="qx.dynlocale",y="dragchange",z="Invalid layout data: ",A="Could not add widget to itself: ",B="_applyEnabled",C="_applySelectable",D="Number",E="_applyKeepActive",F="qx.event.type.Pinch",G="dragend",H="__jM",I="_applyVisibility",J="The 'before' widget is not a child of this widget!",K="Child control '",L="qxDraggable",M="qx.event.type.Roll",N="syncAppearance",O='" while styling ',P="paddingLeft",Q="' of widget ",R="qx.event.type.Mouse",S="Wrong 'left' argument. ",T="_applyPadding",U="#",V="'Child' must be an instance of qx.ui.core.LayoutItem!",W="Remove Error: ",X="visible",Y="qx.event.type.Event",di="qx.event.type.MouseWheel",dj="_applyCursor",dk="changeVisibility",de="_applyDraggable",df="resize",dg="Decorator",dh="At least one child in control ",dq="zIndex",dr="changeTextColor",ds="$$widget",dt="changeContextMenu",dl="on",dm="paddingTop",dn="opacity",dp="This widget has no children!",dx="changeSelectable",dY="Invalid top decorator inset detected: ",ff="_applyAnonymous",dy="none",du="outline",dv="hidden",fb="The 'after' widget is not a child of this widget!",dw="_applyAppearance",dz=" returned an invalid size hint!",dA="hovered",dB="_applyOpacity",dG="Boolean",dH="px",dI="qx.ui.core.Widget",dC="longtap",dD="default",dE="minHeight is larger than maxHeight!",dF="TabIndex property must be between 1 and 32000",dM="_applyFont",dN="cursor",dO="qxDroppable",dP="' already created!",dJ="__jP",dK="changeZIndex",fc=": ",dL="Color",dT="changeEnabled",dU="Abstract method call: _getContentHeightForWidth()!",fe="changeFont",dV="qx.event.type.Focus",dQ="_applyDecorator",dR="_applyZIndex",fd="_applyTextColor",dS=' has no themeable property "',dW="Widget is not focusable!",dX="qx.ui.menu.Menu",ek="engine.name",ej="__jI",ei="qx.event.type.Drag",ep="Invalid right decorator inset detected: ",eo="Invalid widget to add: ",en="qx.event.type.KeySequence",em="excluded",ed="DOM element is not yet created!",ec="_applyToolTipText",eb="The layout of the widget",ea="Exception while creating child control '",eh="qx.event.type.Rotate",eg="_applyDroppable",ef=" is not a child of this widget!",ee="true",ew="widget",ev="Wrong 'top' argument. ",eu="qxClass",et="changeDecorator",eA="qx.event.type.Tap",ez="Integer",ey="__jN",ex="changeBackgroundColor",es="_applyTabIndex",er="Invalid bottom decorator inset detected: ",eq="changeAppearance",eL="qx.debug",eK="qx.event.type.Track",eJ="shorthand",eP="/",eO="String",eN="border-box",eM="",eE="_applyContextMenu",eD="changeToolTipText",eC="padding",eB="tabIndex",eI="paddingBottom",eH="beforeContextmenuOpen",eG="changeNativeContextMenu",eF="undefined",eV="qx.ui.tooltip.ToolTip",eU="contextmenu",eT="_applyKeepFocus",eS="paddingRight",fa="minWidth is larger than maxWidth!",eY="changeLocale",eX="qx.event.type.Pointer",eW="qxKeepFocus",eR="opera",eQ="qx.event.type.Touch",dd="qxKeepActive",dc="absolute";qx.Class.define(dI,{extend:qx.ui.core.LayoutItem,include:[qx.locale.MTranslation],construct:function(){qx.ui.core.LayoutItem.call(this);this.__jI=this.__jO();this.initFocusable();this.initSelectable();this.initNativeContextMenu();}
,events:{appear:Y,disappear:Y,createChildControl:h,resize:h,move:h,syncAppearance:h,mousemove:R,mouseover:R,mouseout:R,mousedown:R,mouseup:R,click:R,dblclick:R,contextmenu:R,beforeContextmenuOpen:h,mousewheel:di,touchstart:eQ,touchend:eQ,touchmove:eQ,touchcancel:eQ,tap:eA,longtap:eA,dbltap:eA,swipe:eQ,rotate:eh,pinch:F,track:eK,roll:M,pointermove:eX,pointerover:eX,pointerout:eX,pointerdown:eX,pointerup:eX,pointercancel:eX,keyup:en,keydown:en,keypress:en,keyinput:n,focus:dV,blur:dV,focusin:dV,focusout:dV,activate:dV,deactivate:dV,capture:Y,losecapture:Y,drop:ei,dragleave:ei,dragover:ei,drag:ei,dragstart:ei,dragend:ei,dragchange:ei,droprequest:ei},properties:{paddingTop:{check:ez,init:0,apply:T,themeable:true},paddingRight:{check:ez,init:0,apply:T,themeable:true},paddingBottom:{check:ez,init:0,apply:T,themeable:true},paddingLeft:{check:ez,init:0,apply:T,themeable:true},padding:{group:[dm,eS,eI,P],mode:eJ,themeable:true},zIndex:{nullable:true,init:10,apply:dR,event:dK,check:ez,themeable:true},decorator:{nullable:true,init:null,apply:dQ,event:et,check:dg,themeable:true},backgroundColor:{nullable:true,check:dL,apply:g,event:ex,themeable:true},textColor:{nullable:true,check:dL,apply:fd,event:dr,themeable:true,inheritable:true},font:{nullable:true,apply:dM,check:w,event:fe,themeable:true,inheritable:true,dereference:true},opacity:{check:D,apply:dB,themeable:true,nullable:true,init:null},cursor:{check:eO,apply:dj,themeable:true,inheritable:true,nullable:true,init:null},toolTip:{check:eV,nullable:true},toolTipText:{check:eO,nullable:true,event:eD,apply:ec},toolTipIcon:{check:eO,nullable:true,event:eD},blockToolTip:{check:dG,init:false},showToolTipWhenDisabled:{check:dG,init:false},visibility:{check:[X,dv,em],init:X,apply:I,event:dk},enabled:{init:true,check:dG,inheritable:true,apply:B,event:dT},anonymous:{init:false,check:dG,apply:ff},tabIndex:{check:ez,nullable:true,apply:es},focusable:{check:dG,init:false,apply:k},keepFocus:{check:dG,init:false,apply:eT},keepActive:{check:dG,init:false,apply:E},draggable:{check:dG,init:false,apply:de},droppable:{check:dG,init:false,apply:eg},selectable:{check:dG,init:false,event:dx,apply:C},contextMenu:{check:dX,apply:eE,nullable:true,event:dt},nativeContextMenu:{check:dG,init:false,themeable:true,event:eG,apply:c},appearance:{check:eO,init:ew,apply:dw,event:eq}},statics:{DEBUG:false,getWidgetByElement:function(fj,fh){while(fj){var fg=fj.$$widget;if(fg!=null){var fi=qx.core.ObjectRegistry.fromHashCode(fg);if(!fh||!fi.getAnonymous()){return fi;}
;}
...
;}
;return false;}
,__jJ:new qx.util.ObjectPool()},members:{__jI:null,__jK:null,__jL:null,__jM:null,_getLayout:function(){return this.__jM;}
...
;this.__jM=fl;qx.ui.core.queue.Layout.add(this);}
,setLayoutParent:function(parent){if(this.$$parent===parent){return;}
...
;var content=this.getContentElement();var fw=ft.size||this._updateInsets;var fu=dH;var fm={};if(ft.position){fm.left=fs+fu;fm.top=top+fu;}
;if(fw||ft.margin){fm.width=fp+fu;fm.height=fn+fu;}
;if(Object.keys(fm).length>0){content.setStyles(fm);}
;if(fw||ft.local||ft.margin){if(this.__jM&&this.hasLayoutChildren()){var fr=this.getInsets();var innerWidth=fp-fr.left-fr.right;var innerHeight=fn-fr.top-fr.bottom;var fv=this.getDecorator();var fq={left:0,right:0,top:0,bottom:0};if(fv){fv=qx.theme.manager.Decoration.getInstance().resolve(fv);fq=fv.getPadding();}
;var fo={top:this.getPaddingTop()+fq.top,right:this.getPaddingRight()+fq.right,bottom:this.getPaddingBottom()+fq.bottom,left:this.getPaddingLeft()+fq.left};this.__jM.renderLayout(innerWidth,innerHeight,fo);}
...
,__jN:null,clearSeparators:function(){var fy=this.__jN;if(!fy){return;}
;var fz=qx.ui.core.Widget.__jJ;var content=this.getContentElement();var fx;for(var i=0,l=fy.length;i<l;i++ ){fx=fy[i];fz.poolObject(fx);content.remove(fx.getContentElement());}
;fy.length=0;}
,renderSeparator:function(fB,fC){var fA=qx.ui.core.Widget.__jJ.getObject(qx.ui.core.Widget);fA.set({decorator:fB});var fE=fA.getContentElement();this.getContentElement().add(fE);var fD=fE.getDomElement();if(fD){fD.style.top=fC.top+dH;fD.style.left=fC.left+dH;fD.style.width=fC.width+dH;fD.style.height=fC.height+dH;}
else {fE.setStyles({left:fC.left+dH,top:fC.top+dH,width:fC.width+dH,height:fC.height+dH});}
...
;if(fH!==null&&fI!==null){this.assert(fH<=fI,dE);}
;}
...
;}
,_getContentHint:function(){var fQ=this.__jM;if(fQ){if(this.hasLayoutChildren()){var fR=fQ.getSizeHint();if(qx.core.Environment.get(eL)){var fP=eb+this.toString()+dz;this.assertInteger(fR.width,S+fP);this.assertInteger(fR.height,ev+fP);}
;return fR;}
...
,_getContentHeightForWidth:function(gb){throw new Error(dU);}
,getInsets:function(){var top=this.getPaddingTop();var gc=this.getPaddingRight();var gd=this.getPaddingBottom();var gg=this.getPaddingLeft();if(this.getDecorator()){var gf=qx.theme.manager.Decoration.getInstance().resolve(this.getDecorator());var ge=gf.getInsets();if(qx.core.Environment.get(eL)){this.assertNumber(ge.top,dY+ge.top);this.assertNumber(ge.right,ep+ge.right);this.assertNumber(ge.bottom,er+ge.bottom);this.assertNumber(ge.left,v+ge.left);}
...
,_applyAnonymous:function(gl){if(gl){this.getContentElement().setAttribute(s,ee);}
...
;return false;}
,__jO:function(){var go=this._createContentElement();go.setAttribute(ds,this.toHashCode());go.setStyles({"touch-action":dy,"-ms-touch-action":dy});if(qx.core.Environment.get(eL)){go.setAttribute(eu,this.classname);}
...
,_createContentElement:function(){return new qx.html.Element(f,{overflowX:dv,overflowY:dv});}
,getContentElement:function(){return this.__jI;}
,__jP:null,getLayoutChildren:function(){var gq=this.__jP;if(!gq){return this.__jQ;}
...
;return gr||gq;}
,scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);}
,invalidateLayoutChildren:function(){var gs=this.__jM;if(gs){gs.invalidateChildrenCache();}
;qx.ui.core.queue.Layout.add(this);}
,hasLayoutChildren:function(){var gu=this.__jP;if(!gu){return false;}
...
,_indexOf:function(gw){var gv=this.__jP;if(!gv){return -1;}
;return gv.indexOf(gw);}
,_hasChildren:function(){var gx=this.__jP;return gx!=null&&(!!gx[0]);}
,addChildrenToQueue:function(gy){var gz=this.__jP;if(!gz){return;}
...
;if(gC.getLayoutParent()==this){qx.lang.Array.remove(this.__jP,gC);}
;if(this.__jP){this.__jP.push(gC);}
else {this.__jP=[gC];}
;this.__jR(gC,gB);}
,_addAt:function(gG,gD,gF){if(!this.__jP){this.__jP=[];}
;if(gG.getLayoutParent()==this){qx.lang.Array.remove(this.__jP,gG);}
;var gE=this.__jP[gD];if(gE===gG){gG.setLayoutProperties(gF);}
;if(gE){qx.lang.Array.insertBefore(this.__jP,gG,gE);}
else {this.__jP.push(gG);}
;this.__jR(gG,gF);}
...
;if(gH.getLayoutParent()==this){qx.lang.Array.remove(this.__jP,gH);}
;qx.lang.Array.insertBefore(this.__jP,gH,gJ);this.__jR(gH,gI);}
,_addAfter:function(gM,gK,gL){if(qx.core.Environment.get(eL)){this.assertInArray(gK,this._getChildren(),fb);}
;if(gM==gK){return;}
;if(!this.__jP){this.__jP=[];}
;if(gM.getLayoutParent()==this){qx.lang.Array.remove(this.__jP,gM);}
;qx.lang.Array.insertAfter(this.__jP,gM,gK);this.__jR(gM,gL);}
,_remove:function(gN){if(!this.__jP){throw new Error(dp);}
;qx.lang.Array.remove(this.__jP,gN);this.__jS(gN);}
,_removeAt:function(gO){if(!this.__jP){throw new Error(dp);}
;var gP=this.__jP[gO];qx.lang.Array.removeAt(this.__jP,gO);this.__jS(gP);return gP;}
,_removeAll:function(){if(!this.__jP){return [];}
;var gQ=this.__jP.concat();this.__jP.length=0;for(var i=gQ.length-1;i>=0;i-- ){this.__jS(gQ[i]);}
;qx.ui.core.queue.Layout.add(this);return gQ;}
,_afterAddChild:null,_afterRemoveChild:null,__jR:function(gS,gR){if(qx.core.Environment.get(eL)){this.assertInstance(gS,qx.ui.core.LayoutItem,eo+gS);this.assertNotIdentical(gS,this,A+gS);if(gR!=null){this.assertType(gR,j,z+gR);}
;}
...
;}
,__jS:function(gT){if(qx.core.Environment.get(eL)){this.assertNotUndefined(gT);}
;if(gT.getLayoutParent()!==this){throw new Error(W+gT+ef);}
;gT.setLayoutParent(null);if(this.__jM){this.__jM.invalidateChildrenCache();}
...
,_applyPadding:function(ha,gY,name){this._updateInsets=true;qx.ui.core.queue.Layout.add(this);this.__jT(name,ha);}
,__jT:function(hb,he){var content=this.getContentElement();var hc=this.getDecorator();hc=qx.theme.manager.Decoration.getInstance().resolve(hc);if(hc){var hd=qx.Bootstrap.firstLow(hb.replace(eC,eM));he+=hc.getPadding()[hd]||0;}
;content.setStyle(hb,he+dH);}
...
;}
,_applyToolTipText:function(hj,hi){if(qx.core.Environment.get(x)){if(this.__jL){return;}
;var hh=qx.locale.Manager.getInstance();this.__jL=hh.addListener(eY,function(){var hk=this.getToolTipText();if(hk&&hk.translate){this.setToolTipText(hk.translate());}
;}
,this);}
;}
...
,_applyCursor:function(hu,ht){if(hu==null&&!this.isSelectable()){hu=dD;}
;this.getContentElement().setStyle(dN,hu,qx.core.Environment.get(ek)==eR);}
...
;}
,__jU:null,$$stateChanges:null,_forwardStates:null,hasState:function(hD){var hC=this.__jU;return !!hC&&!!hC[hD];}
,addState:function(hH){var hG=this.__jU;if(!hG){hG=this.__jU={};}
;if(hG[hH]){return;}
;this.__jU[hH]=true;if(hH===dA){this.syncAppearance();}
else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hF=this.__jX;if(forward&&forward[hH]&&hF){var hE;for(var hI in hF){hE=hF[hI];if(hE instanceof qx.ui.core.Widget){hF[hI].addState(hH);}
;}
;}
;}
,removeState:function(hM){var hL=this.__jU;if(!hL||!hL[hM]){return;}
;delete this.__jU[hM];if(hM===dA){this.syncAppearance();}
else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hK=this.__jX;if(forward&&forward[hM]&&hK){for(var hN in hK){var hJ=hK[hN];if(hJ instanceof qx.ui.core.Widget){hJ.removeState(hM);}
;}
;}
;}
,replaceState:function(hP,hS){var hR=this.__jU;if(!hR){hR=this.__jU={};}
;if(!hR[hS]){hR[hS]=true;}
;if(hR[hP]){delete hR[hP];}
;if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;}
else {qx.ui.core.queue.Appearance.add(this);}
;var forward=this._forwardStates;var hQ=this.__jX;if(forward&&forward[hS]&&hQ){for(var hT in hQ){var hO=hQ[hT];if(hO instanceof qx.ui.core.Widget){hO.replaceState(hP,hS);}
;}
;}
;}
,__jV:null,__jW:null,syncAppearance:function(){var hY=this.__jU;var hX=this.__jV;var ia=qx.theme.manager.Appearance.getInstance();var hV=qx.core.Property.$$method.setThemed;var ig=qx.core.Property.$$method.resetThemed;if(this.__jW){delete this.__jW;if(hX){var hU=ia.styleFrom(hX,hY,null,this.getAppearance());hX=null;}
;}
;if(!hX){var hW=this;var ib=[];do {ib.push(hW.$$subcontrol||hW.getAppearance());}
while(hW=hW.$$subparent);hX=ib.reverse().join(eP).replace(/#[0-9]+/g,eM);this.__jV=hX;}
;var ie=ia.styleFrom(hX,hY,null,this.getAppearance());if(ie){if(hU){for(var ic in hU){if(ie[ic]===undefined){this[ig[ic]]();}
;}
;}
;if(qx.core.Environment.get(eL)){for(var ic in ie){if(!this[hV[ic]]){throw new Error(this.classname+dS+ic+O+hX);}
;}
;}
...
;}
;this.fireDataEvent(N,this.__jU);}
...
;}
,updateAppearance:function(){this.__jW=true;qx.ui.core.queue.Appearance.add(this);var il=this.__jX;if(il){var ij;for(var ik in il){ij=il[ik];if(ij instanceof qx.ui.core.Widget){ij.updateAppearance();}
;}
;}
;}
...
;ir.setAttribute(eB,it);ir.setStyle(du,dy);}
...
else if(iy<1||iy>32000){throw new Error(dF);}
...
,_applyEnabled:function(iC,iB){if(iC===false){this.addState(p);this.removeState(dA);if(this.isFocusable()){this.removeState(o);this._applyFocusable(false,true);}
...
;if(!iG){this.removeListener(eU,this._onContextMenuOpen);this.removeListener(dC,this._onContextMenuOpen);iF.removeListener(dk,this._onBeforeContextMenuOpen,this);}
;}
;if(iG){iG.setOpener(this);iG.addState(eU);if(!iF){this.addListener(eU,this._onContextMenuOpen);this.addListener(dC,this._onContextMenuOpen);iG.addListener(dk,this._onBeforeContextMenuOpen,this);}
;}
;}
,_onContextMenuOpen:function(e){if(e.getType()==dC){if(e.getPointerType()!==d){return;}
;}
...
;this.getContentElement().setAttribute(dO,iK?dl:null);}
,_onDragStart:function(e){this._getDragDropCursor().placeToPointer(e);this.getApplicationRoot().setGlobalCursor(dD);}
...
,hasChildControl:function(ja){if(!this.__jX){return false;}
;return !!this.__jX[ja];}
,__jX:null,_getCreatedChildControls:function(){return this.__jX;}
,getChildControl:function(jd,jc){if(!this.__jX){if(jc){return null;}
;this.__jX={};}
;var jb=this.__jX[jd];if(jb){return jb;}
...
;delete jk.$$subcontrol;delete jk.$$subparent;var jl=this.__jU;var forward=this._forwardStates;if(jl&&forward&&jk instanceof qx.ui.core.Widget){for(var jm in jl){if(forward[jm]){jk.removeState(jm);}
;}
;}
;delete this.__jX[jn];return jk;}
,_createChildControl:function(js){if(!this.__jX){this.__jX={};}
else if(this.__jX[js]){throw new Error(K+js+dP);}
...
;}
catch(jt){jt.message=ea+js+Q+this.toString()+fc+jt.message;throw jt;}
;if(!jo){throw new Error(t+js);}
;jo.$$subcontrol=js;jo.$$subparent=this;var jq=this.__jU;var forward=this._forwardStates;if(jq&&forward&&jo instanceof qx.ui.core.Widget){for(var jr in jq){if(forward[jr]){jo.addState(jr);}
;}
;}
;this.fireDataEvent(r,jo);return this.__jX[js]=jo;}
,_createChildControlImpl:function(jv,ju){return null;}
,_disposeChildControls:function(){var jz=this.__jX;if(!jz){return;}
...
,setDomLeft:function(jE){var jD=this.getContentElement().getDomElement();if(jD){jD.style.left=jE+dH;}
else {throw new Error(ed);}
;}
,setDomTop:function(jG){var jF=this.getContentElement().getDomElement();if(jF){jF.style.top=jG+dH;}
else {throw new Error(ed);}
;}
,setDomPosition:function(jI,top){var jH=this.getContentElement().getDomElement();if(jH){jH.style.left=jI+dH;jH.style.top=top+dH;}
else {throw new Error(ed);}
;}
...
;}
;return jJ;}
},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Environment.get(x)){if(this.__jL){qx.locale.Manager.getInstance().removeListenerById(this.__jL);}
;}
...
;if(!qx.core.ObjectRegistry.inShutDown){this.clearSeparators();this.__jN=null;}
else {this._disposeArray(ey);}
;this._disposeArray(dJ);this.__jU=this.__jX=null;this._disposeObjects(H,ej);}
});}
)();
(function(){var a="blur",b="activate",c="focus",d="qx.ui.core.EventHandler";qx.Class.define(d,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(){qx.core.Object.call(this);this.__dl=qx.event.Registration.getManager(window);}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1,keyup:1,keydown:1,keypress:1,keyinput:1,capture:1,losecapture:1,focusin:1,focusout:1,focus:1,blur:1,activate:1,deactivate:1,appear:1,disappear:1,dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1,touchstart:1,touchend:1,touchmove:1,touchcancel:1,tap:1,longtap:1,swipe:1,dbltap:1,track:1,trackend:1,trackstart:1,pinch:1,rotate:1,roll:1,pointermove:1,pointerover:1,pointerout:1,pointerdown:1,pointerup:1,pointercancel:1},IGNORE_CAN_HANDLE:false},members:{__dl:null,__jY:{focusin:1,focusout:1,focus:1,blur:1},__ka:{mouseover:1,mouseout:1,appear:1,disappear:1},canHandleEvent:function(f,e){return f instanceof qx.ui.core.Widget;}
...
;if(this.__jY[j.getType()]){n=n&&n.getFocusTarget();if(!n){return;}
;}
...
;if(v){if(this.__jY[j.getType()]){v=v.getFocusTarget();}
;if(v===n){return;}
;}
;}
;var r=j.getCurrentTarget();var t=qx.ui.core.Widget.getWidgetByElement(r);if(!t||t.isAnonymous()){return;}
;if(this.__jY[j.getType()]){t=t.getFocusTarget();}
;var u=j.getType();if(!t||!(t.isEnabled()||this.__ka[u])){return;}
;var g=j.getEventPhase()==qx.event.type.Event.CAPTURING_PHASE;var q=this.__dl.getListeners(t,u,g);if(j.getEventPhase()==qx.event.type.Event.AT_TARGET){if(!q){q=[];}
;var h=this.__dl.getListeners(t,u,!g);if(h){q=q.concat(h);}
;}
...
(function(){var a="blur",b="qxDraggable",c="touch",d="qx.ui.core.Widget",f="longtap",g="Escape",h="drag",i="keydown",j="Unsupported data type: ",k="roll",l="drop",m="qxDroppable",n="qx.event.handler.DragDrop",o="mouse",p="This method must not be used outside the drop event listener!",q="Control",r="Shift",s="!",t="alias",u="droprequest",v="copy",w="pointerup",x="dragstart",y="move",z="pointerdown",A="dragchange",B="on",C="Alt",D="keyup",E="keypress",F="dragleave",G="dragend",H="dragover",I="left",J="Please use a droprequest listener to the drag source to fill the manager with data!",K="pointermove";qx.Class.define(n,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(L){qx.core.Object.call(this);this.__dl=L;this.__dx=L.getWindow().document.documentElement;this.__dl.addListener(this.__dx,f,this._onLongtap,this);this.__dl.addListener(this.__dx,z,this._onPointerdown,this,true);qx.event.Registration.addListener(window,a,this._onWindowBlur,this);this.__kn();}
,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1},IGNORE_CAN_HANDLE:true,ALLOWED_BUTTONS:[I],MIN_DRAG_DISTANCE:5},properties:{cursor:{check:d,nullable:true,init:null}},members:{__dl:null,__dx:null,__kb:null,__kc:null,__kd:null,__ke:null,__kf:null,__d:null,__kg:null,__kh:null,__ki:false,__kj:false,__kk:false,__kl:null,__km:null,canHandleEvent:function(N,M){}
,registerEvent:function(Q,P,O){}
,unregisterEvent:function(T,S,R){}
,addType:function(U){this.__kd[U]=true;}
,addAction:function(V){this.__ke[V]=true;}
,supportsType:function(W){return !!this.__kd[W];}
,supportsAction:function(X){return !!this.__ke[X];}
,setDropAllowed:function(Y){this.__kj=Y;this.__ko();}
,getData:function(ba){if(!this.__kj||!this.__kb){throw new Error(p);}
;if(!this.__kd[ba]){throw new Error(j+ba+s);}
;if(!this.__d[ba]){this.__kg=ba;this.__ic(u,this.__kc,this.__kb,false);}
;if(!this.__d[ba]){throw new Error(J);}
;return this.__d[ba]||null;}
,getCurrentAction:function(){this.__ko();return this.__kh;}
,getDragTarget:function(){return this.__kl;}
,addData:function(bb,bc){this.__d[bb]=bc;}
,getCurrentType:function(){return this.__kg;}
,isSessionActive:function(){return this.__ki;}
,__kn:function(){this.__kd={};this.__ke={};this.__kf={};this.__d={};}
,__ko:function(){if(this.__kc==null){return;}
;var bg=this.__ke;var bd=this.__kf;var be=null;if(this.__kj){if(bd.Shift&&bd.Control&&bg.alias){be=t;}
...
;}
;var bf=this.__kh;if(be!=bf){if(this.__kb){this.__kh=be;this.__kk=this.__ic(A,this.__kb,this.__kc,true);if(!this.__kk){be=null;}
;}
;if(be!=bf){this.__kh=be;this.__ic(A,this.__kc,this.__kb,false);}
;}
;}
,__ic:function(bm,bi,bj,bk,bn){var bl=qx.event.Registration;var bh=bl.createEvent(bm,qx.event.type.Drag,[bk,bn]);if(bi!==bj){bh.setRelatedTarget(bj);}
;return bl.dispatchEvent(bi,bh);}
,__kp:function(bo){while(bo&&bo.nodeType==1){if(bo.getAttribute(b)==B){return bo;}
;bo=bo.parentNode;}
;return null;}
,__kq:function(bp){while(bp&&bp.nodeType==1){if(bp.getAttribute(m)==B){return bp;}
;bp=bp.parentNode;}
;return null;}
,clearSession:function(){this.__dl.removeListener(this.__dx,K,this._onPointermove,this);this.__dl.removeListener(this.__dx,w,this._onPointerup,this,true);this.__dl.removeListener(this.__dx,i,this._onKeyDown,this,true);this.__dl.removeListener(this.__dx,D,this._onKeyUp,this,true);this.__dl.removeListener(this.__dx,E,this._onKeyPress,this,true);this.__dl.removeListener(this.__dx,k,this._onRoll,this,true);if(this.__kc){this.__ic(G,this.__kc,this.__kb,false);}
;this.__kj=false;this.__kb=null;if(this.__kl){this.__kl.removeState(h);this.__kl=null;}
;this.__kc=null;this.__ki=false;this.__km=null;this.__kn();}
,_onLongtap:function(e){if(e.getPointerType()!=c){return;}
;this.__dl.addListener(this.__dx,k,this._onRoll,this,true);this._start(e);}
,_start:function(e){var br=qx.event.handler.DragDrop.ALLOWED_BUTTONS.indexOf(e.getButton())!==-1;if(!e.isPrimary()||!br){return false;}
;var bs=this.__km?this.__km.target:e.getTarget();var bq=this.__kp(bs);if(bq){this.__kc=bq;var bt=qx.ui.core.Widget.getWidgetByElement(this.__km.original);while(bt&&bt.isAnonymous()){bt=bt.getLayoutParent();}
;if(bt){this.__kl=bt;bt.addState(h);}
;if(!this.__ic(x,this.__kc,this.__kb,true,e)){return false;}
;this.__dl.addListener(this.__dx,i,this._onKeyDown,this,true);this.__dl.addListener(this.__dx,D,this._onKeyUp,this,true);this.__dl.addListener(this.__dx,E,this._onKeyPress,this,true);this.__ki=true;return true;}
;}
,_onPointerdown:function(e){if(e.isPrimary()){this.__km={target:e.getTarget(),original:e.getOriginalTarget(),left:e.getDocumentLeft(),top:e.getDocumentTop()};this.__dl.addListener(this.__dx,K,this._onPointermove,this);this.__dl.addListener(this.__dx,w,this._onPointerup,this,true);}
;}
,_onPointermove:function(e){if(!e.isPrimary()){return;}
;if(!this.__ki&&e.getPointerType()==o){var bA=this._getDelta(e);var bu=qx.event.handler.DragDrop.MIN_DRAG_DISTANCE;if(bA&&(Math.abs(bA.x)>bu||Math.abs(bA.y)>bu)){if(!this._start(e)){this.clearSession();return;}
;}
;}
;if(!this.__ki){return;}
;if(!this.__ic(h,this.__kc,this.__kb,true,e)){this.clearSession();}
;var bv=e.getTarget();var by=this.getCursor();if(!by){by=qx.ui.core.DragDropCursor.getInstance();}
;var bx=by.getContentElement().getDomElement();if(bv!==bx){var bw=this.__kq(bv);if(bw&&bw!=this.__kb){if(this.__kb){this.__ic(F,this.__kb,this.__kc,false,e);}
;this.__kj=true;this.__kb=bw;this.__kj=this.__ic(H,bw,this.__kc,true,e);}
else if(!bw&&this.__kb){this.__ic(F,this.__kb,this.__kc,false,e);this.__kb=null;this.__kj=false;qx.event.Timer.once(this.__ko,this,0);}
;}
;var bz=this.__kf;bz.Control=e.isCtrlPressed();bz.Shift=e.isShiftPressed();bz.Alt=e.isAltPressed();this.__ko();}
,_getDelta:function(e){if(!this.__km){return null;}
;var bB=e.getDocumentLeft()-this.__km.left;var bC=e.getDocumentTop()-this.__km.top;return {"x":bB,"y":bC};}
,_onPointerup:function(e){if(!e.isPrimary()){return;}
;if(this.__kj&&this.__kk){this.__ic(l,this.__kb,this.__kc,false,e);}
;if(e.getTarget()==this.__kc){e.stopPropagation();}
;this.clearSession();}
,_onRoll:function(e){e.stop();}
,_onWindowBlur:function(e){this.clearSession();}
,_onKeyDown:function(e){var bD=e.getKeyIdentifier();switch(bD){case C:case q:case r:if(!this.__kf[bD]){this.__kf[bD]=true;this.__ko();}
;};}
,_onKeyUp:function(e){var bE=e.getKeyIdentifier();switch(bE){case C:case q:case r:if(this.__kf[bE]){this.__kf[bE]=false;this.__ko();}
;};}
,_onKeyPress:function(e){var bF=e.getKeyIdentifier();switch(bF){case g:this.clearSession();};}
},destruct:function(){qx.event.Registration.removeListener(window,a,this._onWindowBlur,this);this.__kc=this.__kb=this.__dl=this.__dx=this.__kd=this.__ke=this.__kf=this.__d=null;}
...
(function(){var a="best-fit",b="placementRight",c="Boolean",d="bottom-right",e="' ",f="widget",g="placementLeft",h="qx.ui.core.MPlacement",i="left-top",j="Integer",k="left-middle",l="right-middle",m="top-center",n="[qx.ui.core.MPlacement.setMoveDirection()], the value was '",o="offsetRight",p="interval",q="keep-align",r="bottom-left",s="pointer",t="direct",u="shorthand",v="Invalid value for the parameter 'direction' ",w="offsetLeft",x="top-left",y="appear",z="offsetBottom",A="top",B="top-right",C="offsetTop",D="but 'top' or 'left' are allowed.",E="right-bottom",F="disappear",G="right-top",H="bottom-center",I="left-bottom",J="left";qx.Mixin.define(h,{statics:{__gX:null,__kr:J,setVisibleElement:function(K){this.__gX=K;}
,getVisibleElement:function(){return this.__gX;}
,setMoveDirection:function(L){if(L===A||L===J){this.__kr=L;}
else {throw new Error(v+n+L+e+D);}
;}
,getMoveDirection:function(){return this.__kr;}
},properties:{position:{check:[x,m,B,r,H,d,i,k,I,G,l,E],init:r,themeable:true},placeMethod:{check:[f,s],init:s,themeable:true},domMove:{check:c,init:false},placementModeX:{check:[t,q,a],init:q,themeable:true},placementModeY:{check:[t,q,a],init:q,themeable:true},offsetLeft:{check:j,init:0,themeable:true},offsetTop:{check:j,init:0,themeable:true},offsetRight:{check:j,init:0,themeable:true},offsetBottom:{check:j,init:0,themeable:true},offset:{group:[C,o,z,w],mode:u,themeable:true}},members:{__ks:null,__kt:null,__ku:null,getLayoutLocation:function(N){var P,O,R,top;O=N.getBounds();if(!O){return null;}
...
;}
,placeToWidget:function(bc,ba){if(ba){this.__kv();this.__ks=qx.lang.Function.bind(this.placeToWidget,this,bc,false);qx.event.Idle.getInstance().addListener(p,this.__ks);this.__ku=function(){this.__kv();}
;this.addListener(F,this.__ku,this);}
;var bb=bc.getContentLocation()||this.getLayoutLocation(bc);if(bb!=null){this._place(bb);return true;}
else {return false;}
;}
,__kv:function(){if(this.__ks){qx.event.Idle.getInstance().removeListener(p,this.__ks);this.__ks=null;}
;if(this.__ku){this.removeListener(F,this.__ku,this);this.__ku=null;}
;}
...
,events:{"interval":d},properties:{timeoutInterval:{check:a,init:100,apply:c}},members:{__dy:null,_applyTimeoutInterval:function(g){if(this.__dy){this.__dy.setInterval(g);}
;}
,_onInterval:function(){this.fireEvent(b);}
,__kx:function(){if(!this.__dy&&this.hasListener(b)){var h=new qx.event.Timer(this.getTimeoutInterval());h.addListener(b,this._onInterval,this);h.start();this.__dy=h;}
;}
,__ky:function(){if(this.__dy&&!this.hasListener(b)){this.__dy.stop();this.__dy.dispose();this.__dy=null;}
;}
,addListener:function(k,i,self,j){var l=qx.core.Object.prototype.addListener.call(this,k,i,self,j);this.__kx();return l;}
,addListenerOnce:function(o,m,self,n){var p=qx.core.Object.prototype.addListenerOnce.call(this,o,m,self,n);this.__kx();return p;}
,removeListener:function(s,q,self,r){var t=qx.core.Object.prototype.removeListener.call(this,s,q,self,r);this.__ky();return t;}
,removeListenerById:function(u){var v=qx.core.Object.prototype.removeListenerById.call(this,u);this.__ky();return v;}
},destruct:function(){if(this.__dy){this.__dy.stop();}
;this.__dy=null;}
});}
)();
(function(){var a="-",b="best-fit",c="size",d='__kz',e="edge-start",f="target.bottom",g="offsets",h="size.width",i="bottom",j="offsets.bottom",k="qx.util.placement.Placement",l="Please use '",m="qx.debug",n="keep-align",o="center",p="target.right",q="direct",r="offsets.right",s="middle",t="target",u="align-start",v="Invalid 'mode' argument!'",w="left",x="align-end",y="Class",z="offsets.left",A="top",B="area",C="right",D="edge-end",E="target.top",F="area.height",G="target.left",H="align-center",I="area.width",J="' instead!",K="size.height",L="offsets.top";qx.Class.define(k,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__kz=qx.util.placement.DirectAxis;}
,properties:{axisX:{check:y},axisY:{check:y},edge:{check:[A,C,i,w],init:A},align:{check:[A,C,i,w,o,s],init:C}},statics:{__kA:null,compute:function(W,P,M,N,V,Q,R){this.__kA=this.__kA||new qx.util.placement.Placement();var T=V.split(a);var S=T[0];var O=T[1];if(qx.core.Environment.get(m)){if(O===o||O===s){var U=s;if(S===A||S===i){U=o;}
;qx.core.Assert.assertEquals(U,O,l+S+a+U+J);}
;}
;this.__kA.set({axisX:this.__kE(Q),axisY:this.__kE(R),edge:S,align:O});return this.__kA.compute(W,P,M,N);}
,__kB:null,__kC:null,__kD:null,__kE:function(X){switch(X){case q:this.__kB=this.__kB||qx.util.placement.DirectAxis;return this.__kB;case n:this.__kC=this.__kC||qx.util.placement.KeepAlignAxis;return this.__kC;case b:this.__kD=this.__kD||qx.util.placement.BestFitAxis;return this.__kD;default:throw new Error(v);};}
},members:{__kz:null,compute:function(be,bb,Y,ba){if(qx.core.Environment.get(m)){this.assertObject(be,c);this.assertNumber(be.width,h);this.assertNumber(be.height,K);this.assertObject(bb,B);this.assertNumber(bb.width,I);this.assertNumber(bb.height,F);this.assertObject(Y,t);this.assertNumber(Y.top,E);this.assertNumber(Y.right,p);this.assertNumber(Y.bottom,f);this.assertNumber(Y.left,G);this.assertObject(ba,g);this.assertNumber(ba.top,L);this.assertNumber(ba.right,r);this.assertNumber(ba.bottom,j);this.assertNumber(ba.left,z);}
;var bc=this.getAxisX()||this.__kz;var bf=bc.computeStart(be.width,{start:Y.left,end:Y.right},{start:ba.left,end:ba.right},bb.width,this.__kF());var bd=this.getAxisY()||this.__kz;var top=bd.computeStart(be.height,{start:Y.top,end:Y.bottom},{start:ba.top,end:ba.bottom},bb.height,this.__kG());return {left:bf,top:top};}
,__kF:function(){var bh=this.getEdge();var bg=this.getAlign();if(bh==w){return e;}
else if(bh==C){return D;}
else if(bg==w){return u;}
else if(bg==o){return H;}
else if(bg==C){return x;}
;}
,__kG:function(){var bj=this.getEdge();var bi=this.getAlign();if(bj==A){return e;}
...
(function(){var a="Image could not be loaded: ",b="Boolean",c="px",d="http",e=".png",f="background-image",g="engine.version",h="scale",j="changeSource",l="x",m="div",n="aborted",o="background-size",p="nonScaled",q="3",r="qx.ui.basic.Image",s="__kH",t="top",u="0 0",v="background",w=", no-repeat",x="qx.debug",y="loaded",z="backgroundImage",A="backgroundRepeat",B="-disabled.$1",C="class",D="qx.event.type.Event",E="image",F="loadingFailed",G="css.alphaimageloaderneeded",H="1.5",I="String",J="browser.documentmode",K="backgroundPosition",L="border-box",M="changeScale",N="left",O="_applySource",P="$$widget",Q="@",R="data:image/",S="px, ",T='.',U="scaled",V=", ",W="2",X="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",Y="mshtml",br="engine.name",bs=", 0 0",bt="_applyScale",bn="try to load an unmanaged relative image: ",bo="position",bp="replacement",bq="img",bw="no-repeat",bx="background-position",by="hidden",bz="alphaScaled",bu=",",bv="absolute";qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(bA){this.__kH={};qx.ui.core.Widget.call(this);if(bA){this.setSource(bA);}
;}
,properties:{source:{check:I,init:null,nullable:true,event:j,apply:O,themeable:true},scale:{check:b,init:false,event:M,themeable:true,apply:bt},appearance:{refine:true,init:E},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},events:{loadingFailed:D,loaded:D,aborted:D},statics:{PLACEHOLDER_IMAGE:X},members:{__kI:null,__kJ:null,__ji:null,__kH:null,__kK:null,__kL:null,__kM:0,_onChangeTheme:function(){qx.ui.core.Widget.prototype._onChangeTheme.call(this);this._styleSource();}
,getContentElement:function(){return this.__kQ();}
,_createContentElement:function(){return this.__kQ();}
,_getContentHint:function(){return {width:this.__kI||0,height:this.__kJ||0};}
,_applyDecorator:function(bD,bC){qx.ui.core.Widget.prototype._applyDecorator.call(this,bD,bC);var bE=this.getSource();bE=qx.util.AliasManager.getInstance().resolve(bE);var bB=this.getContentElement();if(this.__kL){bB=bB.getChild(0);}
;this.__la(bB,bE);}
,_applyPadding:function(bG,bF,name){qx.ui.core.Widget.prototype._applyPadding.call(this,bG,bF,name);var bH=this.getContentElement();if(this.__kL){bH.getChild(0).setStyles({top:this.getPaddingTop()||0,left:this.getPaddingLeft()||0});}
else {bH.setPadding(this.getPaddingLeft()||0,this.getPaddingTop()||0);}
;}
,renderLayout:function(bK,top,bI,bL){qx.ui.core.Widget.prototype.renderLayout.call(this,bK,top,bI,bL);var bJ=this.getContentElement();if(this.__kL){bJ.getChild(0).setStyles({width:bI-(this.getPaddingLeft()||0)-(this.getPaddingRight()||0),height:bL-(this.getPaddingTop()||0)-(this.getPaddingBottom()||0),top:this.getPaddingTop()||0,left:this.getPaddingLeft()||0});}
;}
...
,__kN:function(bR){this.__ji=bR;}
,__kO:function(){if(this.__ji==null){var bT=this.getSource();var bS=false;if(bT!=null){bS=bT.endsWith(e);}
;if(this.getScale()&&bS&&qx.core.Environment.get(G)){this.__ji=bz;}
else if(this.getScale()){this.__ji=U;}
else {this.__ji=p;}
;}
;return this.__ji;}
,__kP:function(bW){var bV;var bU;if(bW==bz){bV=true;bU=m;}
else if(bW==p){bV=false;bU=m;}
else {bV=true;bU=bq;}
;var bY=new qx.html.Image(bU);bY.setAttribute(P,this.toHashCode());bY.setScale(bV);bY.setStyles({"overflowX":by,"overflowY":by,"boxSizing":L});if(qx.core.Environment.get(G)){var bX=this.__kL=new qx.html.Element(m);bX.setAttribute(P,this.toHashCode());bX.setStyle(bo,bv);bX.add(bY);return bX;}
;return bY;}
,__kQ:function(){if(this.$$disposed){return null;}
;var ca=this.__kO();if(this.__kH[ca]==null){this.__kH[ca]=this.__kP(ca);}
;var cb=this.__kH[ca];if(!this.__kK){this.__kK=cb;}
;return cb;}
,_styleSource:function(){var cg=qx.util.AliasManager.getInstance();var cf=qx.util.ResourceManager.getInstance();var ci=cg.resolve(this.getSource());var ch=this.getContentElement();if(this.__kL){ch=ch.getChild(0);}
;if(!ci){ch.resetSource();return;}
;this.__kT(ci);if((qx.core.Environment.get(br)==Y)&&(parseInt(qx.core.Environment.get(g),10)<9||qx.core.Environment.get(J)<9)){var cd=this.getScale()?h:bw;ch.tagNameHint=qx.bom.element.Decoration.getTagName(cd,ci);}
;var ce=this.__kS();if(qx.util.ResourceManager.getInstance().has(ci)){var cj=this._findHighResolutionSource(ci);if(cj){var cl=cf.getImageHeight(ci);var ck=cf.getImageWidth(ci);this.setWidth(cl);this.setHeight(ck);var cc=cl+S+ck+c;this.__kK.setStyle(o,cc);this.setSource(cj);ci=cj;}
;this.__kV(ce,ci);this.__kR();}
else if(qx.io.ImageLoader.isLoaded(ci)){this.__kW(ce,ci);this.__kR();}
else {this.__kX(ce,ci);}
;}
,__kR:function(){this.__kM++ ;qx.bom.AnimationFrame.request(function(cm){if(cm===this.__kM){this.fireEvent(y);}
else {this.fireEvent(n);}
;}
.bind(this,this.__kM));}
,__kS:function(){var cn=this.__kK;if(this.__kL){cn=cn.getChild(0);}
;return cn;}
,__kT:qx.core.Environment.select(br,{"mshtml":function(cp){var cq=qx.core.Environment.get(G);var co=cp.endsWith(e);if(cq&&co){if(this.getScale()&&this.__kO()!=bz){this.__kN(bz);}
else if(!this.getScale()&&this.__kO()!=p){this.__kN(p);}
;}
else {if(this.getScale()&&this.__kO()!=U){this.__kN(U);}
else if(!this.getScale()&&this.__kO()!=p){this.__kN(p);}
;}
;this.__kU(this.__kQ());}
,"default":function(cr){if(this.getScale()&&this.__kO()!=U){this.__kN(U);}
else if(!this.getScale()&&this.__kO()!=p){this.__kN(p);}
;this.__kU(this.__kQ());}
}),__kU:function(cv){var cu=this.__kK;if(cu!=cv){if(cu!=null){var cI=c;var cs={};var cy=cu.getAllStyles();if(cy){for(var cB in cy){cs[cB]=cy[cB];}
;}
;var cA=this.getBounds();if(cA!=null){cs.width=cA.width+cI;cs.height=cA.height+cI;}
;var cC=this.getInsets();cs.left=parseInt(cu.getStyle(N)||cC.left)+cI;cs.top=parseInt(cu.getStyle(t)||cC.top)+cI;cs.zIndex=10;var cD=this.__kL?cv.getChild(0):cv;cD.setStyles(cs,true);cD.setSelectable(this.getSelectable());if(!cu.isVisible()){cv.hide();}
else if(!cv.isVisible()){cv.show();}
;if(!cu.isIncluded()){cv.exclude();}
else if(!cv.isIncluded()){cv.include();}
;var cF=cu.getParent();if(cF){var ct=cF.getChildren().indexOf(cu);cF.removeAt(ct);cF.addAt(cv,ct);}
;var cx=cD.getNodeName();cD.setSource(null);var cw=this.__kS();cD.tagNameHint=cx;cD.setAttribute(C,cw.getAttribute(C));qx.html.Element.flush();var cH=cw.getDomElement();var cG=cv.getDomElement();var cE=cu.getListeners()||[];cE.forEach(function(cJ){cv.addListener(cJ.type,cJ.handler,cJ.self,cJ.capture);}
);if(cH&&cG){var cz=cH.$$hash;cH.$$hash=cG.$$hash;cG.$$hash=cz;}
;this.__kK=cv;}
;}
;}
,__kV:function(cL,cN){var cM=qx.util.ResourceManager.getInstance();if(!this.getEnabled()){var cK=cN.replace(/\.([a-z]+)$/,B);if(cM.has(cK)){cN=cK;this.addState(bp);}
else {this.removeState(bp);}
;}
;if(cL.getSource()===cN){return;}
;this.__la(cL,cN);this.__lc(cM.getImageWidth(cN),cM.getImageHeight(cN));}
,__kW:function(cO,cS){var cQ=qx.io.ImageLoader;this.__la(cO,cS);var cR=cQ.getWidth(cS);var cP=cQ.getHeight(cS);this.__lc(cR,cP);}
,__kX:function(cU,cW){var cV=qx.io.ImageLoader;if(qx.core.Environment.get(x)){var cT=cW.toLowerCase();if(!cT.startsWith(d)&&!cT.startsWith(R)){var self=this.self(arguments);if(!self.__kY){self.__kY={};}
;if(!self.__kY[cW]){this.debug(bn+cW);self.__kY[cW]=true;}
;}
;}
;if(!cV.isFailed(cW)){cV.load(cW,this.__lb,this);}
else {if(cU!=null){cU.resetSource();}
;}
;}
,__la:function(cX,dc){if(cX.getNodeName()==m){var dg=qx.theme.manager.Decoration.getInstance().resolve(this.getDecorator());if(dg){var dd=(dg.getStartColor()&&dg.getEndColor());var db=dg.getBackgroundImage();if(dd||db){var cY=this.getScale()?h:bw;var da=qx.bom.element.Decoration.getAttributes(dc,cY);var df=dg.getStyles(true);var de={"backgroundImage":da.style.backgroundImage,"backgroundPosition":(da.style.backgroundPosition||u),"backgroundRepeat":(da.style.backgroundRepeat||bw)};if(db){de[K]+=bu+df[bx]||u;de[A]+=V+dg.getBackgroundRepeat();}
;if(dd){de[K]+=bs;de[A]+=w;}
;de[z]+=bu+(df[f]||df[v]);cX.setStyles(de);return;}
;}
else {cX.setSource(null);}
;}
;cX.setSource(dc);}
,_findHighResolutionSource:function(dh){var dk=[q,W,H];var dj=parseFloat(qx.bom.client.Device.getDevicePixelRatio().toFixed(2));if(dj<=1){return false;}
;var i=dk.length;while(i>0&&dj>dk[ --i]){}
;var di;var k;for(k=i;k>=0;k-- ){di=this._getHighResolutionSource(dh,dk[k]);if(di){return di;}
;}
;for(k=i+1;k<dk.length;k++ ){di=this._getHighResolutionSource(dh,dk[k]);if(di){return di;}
;}
;return null;}
,_getHighResolutionSource:function(dl,dm){var dp=dl.lastIndexOf(T);if(dp>-1){var dn=Q+dm+l;var dq=dl.slice(0,dp)+dn+dl.slice(dp);if(qx.util.ResourceManager.getInstance().has(dq)){return dq;}
;}
;return null;}
,__lb:function(dr,ds){if(this.$$disposed===true){return;}
;if(dr!==qx.util.AliasManager.getInstance().resolve(this.getSource())){this.fireEvent(n);return;}
;if(ds.failed){this.warn(a+dr);this.fireEvent(F);}
else if(ds.aborted){this.fireEvent(n);return;}
else {this.fireEvent(y);}
;this.__kW(this.__kS(),dr);}
,__lc:function(dt,du){if(dt!==this.__kI||du!==this.__kJ){this.__kI=dt;this.__kJ=du;qx.ui.core.queue.Layout.add(this);}
;}
},destruct:function(){for(var dv in this.__kH){if(this.__kH.hasOwnProperty(dv)){this.__kH[dv].setAttribute(P,null,true);}
;}
;delete this.__kK;if(this.__kL){delete this.__kL;}
;this._disposeMap(s);}
});}
)();
(function(){var a="mshtml",b='img',c="",d="qx.globalErrorHandling",e="load",f="qx.io.ImageLoader";qx.Bootstrap.define(f,{statics:{__dc:{},__ld:{width:null,height:null},__le:/\.(png|gif|jpg|jpeg|bmp)\b/i,__lf:/^data:image\/(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(g){var h=this.__dc[g];return !!(h&&h.loaded);}
,isFailed:function(j){var k=this.__dc[j];return !!(k&&k.failed);}
,isLoading:function(m){var n=this.__dc[m];return !!(n&&n.loading);}
,getFormat:function(r){var q=this.__dc[r];if(!q||!q.format){var o=this.__lf.exec(r);if(o!=null){var p=(q&&qx.lang.Type.isNumber(q.width)?q.width:this.__ld.width);var s=(q&&qx.lang.Type.isNumber(q.height)?q.height:this.__ld.height);q={loaded:true,format:o[1],width:p,height:s};}
;}
;return q?q.format:null;}
,getSize:function(t){var u=this.__dc[t];return u?{width:u.width,height:u.height}:this.__ld;}
,getWidth:function(v){var w=this.__dc[v];return w?w.width:null;}
,getHeight:function(x){var y=this.__dc[x];return y?y.height:null;}
,load:function(B,A,C){var D=this.__dc[B];if(!D){D=this.__dc[B]={};}
;if(A&&!C){C=window;}
...
;var z=document.createElement(b);var E=qx.lang.Function.listener(this.__lg,this,z,B);z.onload=E;z.onerror=E;z.src=B;D.element=z;}
;}
,abort:function(F){var I=this.__dc[F];if(I&&!I.loaded){I.aborted=true;var H=I.callbacks;var G=I.element;G.onload=G.onerror=null;G.src=c;delete I.callbacks;delete I.element;delete I.loading;for(var i=0,l=H.length;i<l;i+=2){H[i].call(H[i+1],F,I);}
;}
;this.__dc[F]=null;}
,__lg:function(){var J=qx.core.Environment.select(d,{"true":qx.event.GlobalError.observeMethod(this.__lh),"false":this.__lh});J.apply(this,arguments);}
,__lh:function(event,L,K){var P=this.__dc[K];if(qx.bom.client.Engine.getName()==a&&parseFloat(qx.bom.client.Engine.getVersion())===11){document.body.appendChild(L);}
;var M=function(Q){return (Q&&Q.height!==0);}
;if(event.type===e&&M(L)){P.loaded=true;P.width=L.width;P.height=L.height;var N=this.__le.exec(K);if(N!=null){P.format=N[1];}
;}
else {P.failed=true;}
...
;}
,dispose:function(){this.__dc={};}
}});}
)();
(function(){var a="source",b="engine.name",c="",d="mshtml",e="px",f="px ",g="no-repeat",h="backgroundImage",i="scale",j="webkit",k="div",l="qx.html.Image",m="qx/static/blank.gif",n="backgroundPosition";qx.Class.define(l,{extend:qx.html.Element,members:{__li:null,__lj:null,tagNameHint:null,setPadding:function(o,p){this.__lj=o;this.__li=p;if(this.getNodeName()==k){this.setStyle(n,o+f+p+e);}
;}
...
;var u=this._getProperty(a);var r=this._getProperty(i);var v=r?i:g;if(u!=null){u=u||null;q.paddingTop=this.__li;q.paddingLeft=this.__lj;qx.bom.element.Decoration.update(s,u,v,q);}
;}
;}
...
;}
,getTagName:function(bf,be){if(be&&qx.core.Environment.get(q)&&this.__ll[bf]&&be.endsWith(d)){return k;}
;return this.__lm[bf];}
...
;}
;var bl;if(qx.core.Environment.get(q)&&this.__ll[bi]&&bj===z){var bm=this.__lo(bk);this.__ln(bh,bm.width,bm.height);bl=this.processAlphaFix(bh,bi,bk);}
else {delete bh.clip;if(bi===i){bl=this.__lp(bh,bi,bk);}
else if(bi===p||bi===P){bl=this.__lq(bh,bi,bk);}
else {bl=this.__lt(bh,bi,bk);}
;}
;return bl;}
,__ln:function(bo,bn,bp){if(bo.width==null&&bn!=null){bo.width=bn+c;}
;if(bo.height==null&&bp!=null){bo.height=bp+c;}
;}
,__lo:function(bq){var br=qx.util.ResourceManager.getInstance().getImageWidth(bq)||qx.io.ImageLoader.getWidth(bq);var bs=qx.util.ResourceManager.getInstance().getImageHeight(bq)||qx.io.ImageLoader.getHeight(bq);return {width:br,height:bs};}
...
,__lp:function(bz,bA,by){var bB=qx.util.ResourceManager.getInstance().toUri(by);var bC=this.__lo(by);this.__ln(bz,bC.width,bC.height);return {src:bB,style:bz};}
,__lq:function(bD,bE,bG){var bF=qx.util.ResourceManager.getInstance();var bJ=bF.getCombinedFormat(bG);var bL=this.__lo(bG);var bH;if(bJ){var bK=bF.getData(bG);var bI=bK[4];if(bJ==H){bH=bF.toDataUri(bG);}
else {bH=bF.toUri(bI);}
;if(bE===p){bD=this.__lr(bD,bK,bL.height);}
else {bD=this.__ls(bD,bK,bL.width);}
;return {src:bH,style:bD};}
else {if(qx.core.Environment.get(o)){this.__lv(bG);}
...
;}
,__lr:function(bM,bN,bP){var bO=qx.util.ResourceManager.getInstance().getImageHeight(bN[4]);bM.clip={top:-bN[6],height:bP};bM.height=bO+c;if(bM.top!=null){bM.top=(parseInt(bM.top,10)+bN[6])+c;}
else if(bM.bottom!=null){bM.bottom=(parseInt(bM.bottom,10)+bP-bO-bN[6])+c;}
;return bM;}
,__ls:function(bR,bS,bQ){var bT=qx.util.ResourceManager.getInstance().getImageWidth(bS[4]);bR.clip={left:-bS[5],width:bQ};bR.width=bT+c;if(bR.left!=null){bR.left=(parseInt(bR.left,10)+bS[5])+c;}
else if(bR.right!=null){bR.right=(parseInt(bR.right,10)+bQ-bT-bS[5])+c;}
;return bR;}
,__lt:function(bU,bV,bY){var bX=qx.util.ResourceManager.getInstance();var bW=bX.getCombinedFormat(bY);var ch=this.__lo(bY);if(bW&&bV!==b){var cg=bX.getData(bY);var ce=cg[4];if(bW==H){var cb=bX.toDataUri(bY);var ca=0;var cc=0;}
...
;return {style:bU};}
else {var top=bU.paddingTop||0;var ci=bU.paddingLeft||0;bU.backgroundPosition=ci+g+top+c;if(qx.core.Environment.get(o)){if(bV!==b){this.__lv(bY);}
;}
;this.__ln(bU,ch.width,ch.height);this.__lu(bU,bY,bV);return {style:bU};}
;}
,__lu:function(cj,cm,ck){var top=null;var cp=null;if(cj.backgroundPosition){var cl=cj.backgroundPosition.split(K);cp=parseInt(cl[0],10);if(isNaN(cp)){cp=cl[0];}
...
;}
,__lv:function(cq){if(this.DEBUG&&qx.util.ResourceManager.getInstance().has(cq)&&cq.indexOf(a)==-1){if(!this.__lk[cq]){qx.log.Logger.debug(l+cq);this.__lk[cq]=true;}
;}
;}
}});}
)();
(function(){var a="')",b="gecko",c="background-image:url(",d="0",e=");",f="",g="px",h="number",i=")",j="background-repeat:",k="engine.version",l="data:",m=" ",n="qx.bom.element.Background",o=";",p="url(",q="background-position:",r="base64",s="url('",t="engine.name",u="'";qx.Class.define(n,{statics:{__lw:[c,null,e,q,null,o,j,null,o],__lx:{backgroundImage:null,backgroundPosition:null,backgroundRepeat:null},__ly:function(z,top){var v=qx.core.Environment.get(t);var x=qx.core.Environment.get(k);if(v==b&&x<1.9&&z==top&&typeof z==h){top+=0.01;}
;if(z){var y=(typeof z==h)?z+g:z;}
else {y=d;}
;if(top){var w=(typeof top==h)?top+g:top;}
else {w=d;}
;return y+m+w;}
,__lz:function(A){var String=qx.lang.String;var B=A.substr(0,50);return B.startsWith(l)&&String.contains(B,r);}
,compile:function(F,D,H,top){var G=this.__ly(H,top);var E=qx.util.ResourceManager.getInstance().toUri(F);if(this.__lz(E)){E=u+E+u;}
;var C=this.__lw;C[1]=E;C[4]=G;C[7]=D;return C.join(f);}
,getStyles:function(L,J,N,top){if(!L){return this.__lx;}
;var M=this.__ly(N,top);var K=qx.util.ResourceManager.getInstance().toUri(L);var O;if(this.__lz(K)){O=s+K+a;}
else {O=p+K+i;}
...
,"false":null}),_clearSeparators:function(){var m=this.__lA;if(m instanceof qx.ui.core.LayoutItem){m.clearSeparators();}
;}
,_renderSeparator:function(n,o){this.__lA.renderSeparator(n,o);}
,connectToWidget:function(p){if(p&&this.__lA){throw new Error(e);}
;this.__lA=p;this.invalidateChildrenCache();}
,_getWidget:function(){return this.__lA;}
,_applyLayoutChange:function(){if(this.__lA){this.__lA.scheduleLayoutUpdate();}
;}
,_getLayoutChildren:function(){return this.__lA.getLayoutChildren();}
},destruct:function(){this.__lA=this.__fx=null;}
});}
)();
(function(){var a="qx.bom.client.Locale",b="-",c="locale",d="",e="android",f="locale.variant",g="C",h="locale.default";qx.Bootstrap.define(a,{statics:{getLocale:function(){var i=qx.bom.client.Locale.__lB();var j=i.indexOf(b);if(j!=-1){i=i.substr(0,j);}
;return i;}
,getVariant:function(){var k=qx.bom.client.Locale.__lB();var m=d;var l=k.indexOf(b);if(l!=-1){m=k.substr(l+1);}
;return m;}
,__lB:function(){var n=(navigator.userLanguage||navigator.language||d);if(qx.bom.client.OperatingSystem.getName()==e){var o=/(\w{2})-(\w{2})/i.exec(navigator.userAgent);if(o){n=o[0];}
;}
...
(function(){var a="qx.locale.LocalizedString";qx.Class.define(a,{extend:qx.type.BaseString,construct:function(b,d,c){qx.type.BaseString.call(this,b);this.__lD=d;this.__lE=c;}
,members:{__lD:null,__lE:null,translate:function(){return qx.locale.Manager.getInstance().translate(this.__lD,this.__lE);}
,getMessageId:function(){return this.__lD;}
}});}
)();
(function(){var a="locale",b="_applyLocale",c="",d="changeLocale",e="_",f="Locale: ",g="locale.default",h="locale.variant",j="qx.dynlocale",k=" not available.",l="qx.locale.Manager",m="String",n="singleton",o="qx.debug";qx.Class.define(l,{type:n,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__lF=qx.$$translations||{};this.__lG=qx.$$locales||{};this.initLocale();this.__lH=this.getLocale();}
...
;return I;}
)()}},members:{__lI:qx.core.Environment.get(g),__lJ:null,__lK:null,__lF:null,__lG:null,__lH:null,getLanguage:function(){return this.__lK;}
,getTerritory:function(){return this.getLocale().split(e)[1]||c;}
,getAvailableLocales:function(L){var M=[];for(var K in this.__lG){if(K!=this.__lI){if(this.__lG[K]===null&&!L){continue;}
;M.push(K);}
;}
;return M;}
,__lL:function(N){var P;if(N==null){return null;}
;var O=N.indexOf(e);if(O==-1){P=N;}
else {P=N.substring(0,O);}
;return P;}
,_applyLocale:function(R,Q){if(qx.core.Environment.get(o)){if(!(R in this.__lG||R==this.__lH)){qx.log.Logger.warn(f+R+k);}
;}
;this.__lJ=R;this.__lK=this.__lL(R);}
,addTranslation:function(S,V){var T=this.__lF;if(T[S]){for(var U in V){T[S][U]=V[U];}
;}
else {T[S]=V;}
;}
,addLocale:function(ba,X){var W=this.__lG;if(W[ba]){for(var Y in X){W[ba][Y]=X[Y];}
;}
else {W[ba]=X;}
;}
,translate:function(be,bd,bb){var bc=this.__lF;return this.__lM(bc,be,bd,bb);}
,localize:function(bi,bh,bf){var bg=this.__lG;return this.__lM(bg,bi,bh,bf);}
,__lM:function(bn,bo,bl,bm){if(qx.core.Environment.get(o)){this.assertObject(bn);this.assertString(bo);this.assertArray(bl);}
;var bj;if(!bn){return bo;}
;if(bm){var bk=this.__lL(bm);}
else {bm=this.__lJ;bk=this.__lK;}
;if(!bj&&bn[bm]){bj=bn[bm][bo];}
;if(!bj&&bn[bk]){bj=bn[bk][bo];}
;if(!bj&&bn[this.__lI]){bj=bn[this.__lI][bo];}
;if(!bj){bj=bo;}
...
;return bj;}
},destruct:function(){this.__lF=this.__lG=null;}
});}
)();
...
(function(){var a="blur",b="qx.debug",c="qx.ui.popup.Manager",d="Object is no popup: ",f="pointerdown",g="__lN",h="singleton";qx.Class.define(c,{type:h,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__lN=[];qx.event.Registration.addListener(document.documentElement,f,this.__lP,this,true);qx.bom.Element.addListener(window,a,this.hideAll,this);}
,members:{__lN:null,add:function(j){if(qx.core.Environment.get(b)){if(!(j instanceof qx.ui.popup.Popup)){throw new Error(d+j);}
;}
;this.__lN.push(j);this.__lO();}
,remove:function(k){if(qx.core.Environment.get(b)){if(!(k instanceof qx.ui.popup.Popup)){throw new Error(d+k);}
;}
;qx.lang.Array.remove(this.__lN,k);this.__lO();}
,hideAll:function(){var l=this.__lN.length,m={};while(l-- ){m=this.__lN[l];if(m.getAutoHide()){m.exclude();}
;}
;}
,__lO:function(){var n=1e7;for(var i=0;i<this.__lN.length;i++ ){this.__lN[i].setZIndex(n++ );}
;}
,__lP:function(e){var p=qx.ui.core.Widget.getWidgetByElement(e.getTarget());var q=this.__lN;for(var i=0;i<q.length;i++ ){var o=q[i];if(!o.getAutoHide()||p==o||qx.ui.core.Widget.contains(o,p)){continue;}
;o.exclude();}
;}
},destruct:function(){qx.event.Registration.removeListener(document.documentElement,f,this.__lP,this,true);this._disposeArray(g);}
});}
)();
...
;}
,properties:{alignX:{check:[o,j,p],init:o,apply:c},alignY:{check:[n,b,g],init:n,apply:c},spacing:{check:q,init:0,apply:c},separator:{check:a,nullable:true,apply:c},reversed:{check:k,init:false,apply:e}},members:{__lQ:null,__lR:null,__lS:null,__hi:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__lT:function(){var B=this._getLayoutChildren();var length=B.length;var y=false;var w=this.__lQ&&this.__lQ.length!=length&&this.__lR&&this.__lQ;var z;var x=w?this.__lQ:new Array(length);var A=w?this.__lR:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__lQ=x;this.__lR=A;}
;this.__lS=y;this.__hi=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(U,O,T){if(this._invalidChildrenCache){this.__lT();}
;var K=this.__hi;var length=K.length;var W=qx.ui.layout.Util;var S=this.getSpacing();var Y=this.getSeparator();if(Y){var H=W.computeHorizontalSeparatorGaps(K,S,Y);}
else {var H=W.computeHorizontalGaps(K,S,true);}
;var i,V,Q,P;var X=[];var L=H;for(i=0;i<length;i+=1){P=this.__lQ[i];Q=P!=null?Math.floor((U-H)*P):K[i].getSizeHint().width;X.push(Q);L+=Q;}
;if(this.__lS&&L!=U){var N={};var R,F;for(i=0;i<length;i+=1){R=this.__lR[i];if(R>0){M=K[i].getSizeHint();N[i]={min:M.minWidth,value:X[i],max:M.maxWidth,flex:R};}
;}
...
;var bs=qx.ui.layout.Util;var bf=this.__hi;var bk=0,bl=0,be=0;var bi=0,bj=0;var bp,bg,br;for(var i=0,l=bf.length;i<l;i+=1){bp=bf[i];bg=bp.getSizeHint();bl+=bg.width;var bo=this.__lR[i];var bh=this.__lQ[i];if(bo){bk+=bg.minWidth;}
...
},destruct:function(){this.__lQ=this.__lR=this.__hi=null;}
});}
)();
...
;}
,properties:{rich:{check:d,init:false,event:J,apply:L},wrap:{check:d,init:true,apply:j},value:{check:y,apply:t,event:k,nullable:true},buddy:{check:f,apply:w,nullable:true,init:null,dereference:true},textAlign:{check:[P,u,G,I],nullable:true,themeable:true,apply:c,event:i},appearance:{refine:true,init:N},selectable:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},allowShrinkY:{refine:true,init:false}},members:{__lU:null,__lV:null,__lW:null,__lX:null,_getContentHint:function(){if(this.__lV){this.__lY=this.__ma();delete this.__lV;}
...
;}
,__lY:{width:0,height:0},_applyFont:function(bc,bb){if(bb&&this.__lU&&this.__lX){this.__lU.removeListenerById(this.__lX);this.__lX=null;}
;var ba;if(bc){this.__lU=qx.theme.manager.Font.getInstance().resolve(bc);if(this.__lU instanceof qx.bom.webfonts.WebFont){this.__lX=this.__lU.addListener(h,this._onWebFontStatusChange,this);}
;ba=this.__lU.getStyles();}
else {this.__lU=null;ba=qx.bom.Font.getDefaultStyles();}
;if(this.getTextColor()!=null){delete ba[m];}
;this.getContentElement().setStyles(ba);this.__lV=true;qx.ui.core.queue.Layout.add(this);}
,__ma:function(bf){var be=qx.bom.Label;var bh=this.getFont();var bd=bh?this.__lU.getStyles():qx.bom.Font.getDefaultStyles();var content=this.getValue()||R;var bg=this.getRich();if(this.__lX){this.__mb();}
;return bg?be.getHtmlSize(content,bd,bf):be.getTextSize(content,bd);}
,__mb:function(){if(!this.getContentElement()){return;}
...
;}
;}
,_applyBuddy:function(bk,bj){if(bj!=null){this.removeRelatedBindings(bj);this.removeListenerById(this.__lW);this.__lW=null;}
;if(bk!=null){bk.bind(x,this,x);this.__lW=this.addListener(Q,function(){if(bk.isFocusable()){bk.focus.apply(bk);}
;if(z in bk&&typeof bk.toggleValue===C){bk.toggleValue();}
;}
,this);}
;}
,_applyRich:function(bl){this.getContentElement().setRich(bl);this.__lV=true;qx.ui.core.queue.Layout.add(this);}
...
;}
,"false":null}),_onWebFontStatusChange:function(bp){if(bp.getData().valid===true){if(qx.core.Environment.get(l)==a&&parseFloat(qx.core.Environment.get(D))>=8){window.setTimeout(function(){this.__lV=true;qx.ui.core.queue.Layout.add(this);}
.bind(this),0);}
;this.__lV=true;qx.ui.core.queue.Layout.add(this);}
;}
...
;this.__lV=true;qx.ui.core.queue.Layout.add(this);}
,"false":function(bt,bs){this.getContentElement().setValue(bt);this.__lV=true;qx.ui.core.queue.Layout.add(this);}
})},destruct:function(){if(qx.core.Environment.get(E)){qx.locale.Manager.getInstance().removeListener(O,this._onChangeLocale,this);}
;if(this.__lU&&this.__lX){this.__lU.removeListenerById(this.__lX);}
;this.__lU=null;}
});}
)();
(function(){var a="value",b="qx.html.Label",c="The label mode cannot be modified after initial creation",d='hidden';qx.Class.define(b,{extend:qx.html.Element,members:{__mc:null,_applyProperty:function(name,e){qx.html.Element.prototype._applyProperty.call(this,name,e);if(name==a){var f=this.getDomElement();qx.bom.Label.setValue(f,e);}
;}
,_createDomElement:function(){var h=this.__mc;var g=qx.bom.Label.create(this._content,h);g.style.overflow=d;return g;}
...
;j=!!j;if(this.__mc==j){return this;}
;this.__mc=j;return this;}
,setValue:function(l){this._setProperty(a,l);return this;}
,getValue:function(){return this._getProperty(a);}
}});}
)();
(function(){var a="text",b="function",c="px",d="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul",e="crop",f="nowrap",g="end",h="div",i="100%",j="auto",k="0",l="css.textoverflow",m="qx.debug",n="html.xul",o="value",p="visible",q="qx.bom.Label",r="",s="ellipsis",t="normal",u="inherit",v="block",w="label",x="-1000px",y="hidden",z="absolute";qx.Bootstrap.define(q,{statics:{__md:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__me:function(){var A=this.__mg(false);document.body.insertBefore(A,document.body.firstChild);return this._textElement=A;}
,__mf:function(){var B=this.__mg(true);document.body.insertBefore(B,document.body.firstChild);return this._htmlElement=B;}
,__mg:function(E){var C=qx.dom.Element.create(h);var D=C.style;D.width=D.height=j;D.left=D.top=x;D.visibility=y;D.position=z;D.overflow=p;D.display=v;if(E){D.whiteSpace=t;}
else {D.whiteSpace=f;if(!qx.core.Environment.get(l)&&qx.core.Environment.get(n)){var F=document.createElementNS(d,w);var D=F.style;D.padding=k;D.margin=k;D.width=j;for(var G in this.__md){D[G]=u;}
;C.appendChild(F);}
;}
;return C;}
,__mh:function(I){var H={};H.overflow=y;if(I){H.whiteSpace=t;}
...
;if(!qx.core.Environment.get(l)&&qx.core.Environment.get(n)){var N=L.document.createElementNS(d,w);var K=N.style;K.cursor=u;K.color=u;K.overflow=y;K.maxWidth=i;K.padding=k;K.margin=k;K.width=j;for(var O in this.__md){N.style[O]=u;}
;N.setAttribute(e,g);J.appendChild(N);}
else {qx.bom.element.Style.setStyles(J,this.__mh(M));}
;if(content){this.setValue(J,content);}
;return J;}
,__mi:null,setSanitizer:function(P){if(qx.core.Environment.get(m)){if(P){qx.core.Assert.assertFunction(P);}
;}
;qx.bom.Label.__mi=P;}
,setValue:function(R,Q){Q=Q||r;if(R.useHtml){if(qx.bom.Label.__mi&&typeof (qx.bom.Label.__mi)===b){Q=qx.bom.Label.__mi(Q);}
;R.innerHTML=Q;}
...
;}
,getHtmlSize:function(content,T,U){var V=this._htmlElement||this.__mf();V.style.width=U!=undefined?U+c:j;V.innerHTML=content;return this.__mj(V,T);}
,getTextSize:function(X,W){var Y=this._textElement||this.__me();if(!qx.core.Environment.get(l)&&qx.core.Environment.get(n)){Y.firstChild.setAttribute(o,X);}
else {qx.bom.element.Attribute.set(Y,a,X);}
;return this.__mj(Y,W);}
,__mj:function(be,ba){var bb=this.__md;if(!ba){ba={};}
...
(function(){var a="_applyActiveWindow",b="changeModal",c="windowAdded",d="__dl",f="changeVisibility",g="__mk",h="windowRemoved",i="qx.ui.window.Window",j="changeActive",k="qx.ui.window.MDesktop",l="changeActiveWindow",m="qx.event.type.Data";qx.Mixin.define(k,{properties:{activeWindow:{check:i,apply:a,event:l,init:null,nullable:true}},events:{windowAdded:m,windowRemoved:m},members:{__mk:null,__dl:null,getWindowManager:function(){if(!this.__dl){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());}
;return this.__dl;}
,supportsMaximize:function(){return true;}
,setWindowManager:function(n){if(this.__dl){this.__dl.setDesktop(null);}
;n.setDesktop(this);this.__dl=n;}
...
;}
,_addWindow:function(r){if(!qx.lang.Array.contains(this.getWindows(),r)){this.getWindows().push(r);this.fireDataEvent(c,r);r.addListener(j,this._onChangeActive,this);r.addListener(b,this._onChangeModal,this);r.addListener(f,this._onChangeVisibility,this);}
...
;return this.__mk;}
},destruct:function(){this._disposeArray(g);this._disposeObjects(d);}
});}
)();
(function(){var a="_applyBlockerColor",b="Number",c="qx.ui.core.MBlocker",d="__ml",e="_applyBlockerOpacity",f="Color";qx.Mixin.define(c,{properties:{blockerColor:{check:f,init:null,nullable:true,apply:a,themeable:true},blockerOpacity:{check:b,init:1,apply:e,themeable:true}},members:{__ml:null,_createBlocker:function(){return new qx.ui.core.Blocker(this);}
...
,isBlocked:function(){return this.__ml&&this.__ml.isBlocked();}
,unblock:function(){if(this.__ml){this.__ml.unblock();}
;}
,forceUnblock:function(){if(this.__ml){this.__ml.forceUnblock();}
;}
,blockContent:function(k){this.getBlocker().blockContent(k);}
,getBlocker:function(){if(!this.__ml){this.__ml=this._createBlocker();}
;return this.__ml;}
},destruct:function(){this._disposeObjects(d);}
});}
)();
(function(){var a="qx.dyntheme",b="backgroundColor",c="_applyOpacity",d="Boolean",f="px",g="keydown",h="__ml",j="deactivate",k="changeTheme",l="opacity",m="Tab",n="qx.event.type.Event",o="move",p="Color",q="resize",r="zIndex",s="appear",t="__dy",u="qx.ui.root.Abstract",v="keyup",w="keypress",x="Number",y="unblocked",z="qx.ui.core.Blocker",A="disappear",B="blocked",C="_applyColor";qx.Class.define(z,{extend:qx.core.Object,events:{blocked:n,unblocked:n},construct:function(D){qx.core.Object.call(this);this._widget=D;D.addListener(q,this.__mq,this);D.addListener(o,this.__mq,this);D.addListener(A,this.__ms,this);if(qx.Class.isDefined(u)&&D instanceof qx.ui.root.Abstract){this._isRoot=true;this.setKeepBlockerActive(true);}
;if(qx.core.Environment.get(a)){qx.theme.manager.Meta.getInstance().addListener(k,this._onChangeTheme,this);}
;this.__mm=[];this.__mn=[];}
,properties:{color:{check:p,init:null,nullable:true,apply:C,themeable:true},opacity:{check:x,init:1,apply:c,themeable:true},keepBlockerActive:{check:d,init:false}},members:{__ml:null,__mo:0,__mm:null,__mn:null,__dy:null,_widget:null,_isRoot:false,__mp:null,__mq:function(e){var E=e.getData();if(this.isBlocked()){this._updateBlockerBounds(E);}
;}
,__mr:function(){this._updateBlockerBounds(this._widget.getBounds());if(this._widget.isRootWidget()){this._widget.getContentElement().add(this.getBlockerElement());}
else {this._widget.getLayoutParent().getContentElement().add(this.getBlockerElement());}
;}
,__ms:function(){if(this.isBlocked()){this.getBlockerElement().getParent().remove(this.getBlockerElement());this._widget.addListenerOnce(s,this.__mr,this);}
;}
...
,_applyColor:function(I,H){var G=qx.theme.manager.Color.getInstance().resolve(I);this.__mt(b,G);}
,_applyOpacity:function(K,J){this.__mt(l,K);}
,_onChangeTheme:qx.core.Environment.select(a,{"true":function(){this._applyColor(this.getColor());}
,"false":null}),__mt:function(M,N){var L=[];this.__ml&&L.push(this.__ml);for(var i=0;i<L.length;i++ ){L[i].setStyle(M,N);}
;}
,_backupActiveWidget:function(){var O=qx.event.Registration.getManager(window).getHandler(qx.event.handler.Focus);this.__mm.push(qx.ui.core.Widget.getWidgetByElement(O.getActive()));this.__mn.push(qx.ui.core.Widget.getWidgetByElement(O.getFocus()));if(this._widget.isFocusable()){this._widget.focus();}
;}
,_restoreActiveWidget:function(){var Q;var P=this.__mn.length;if(P>0){Q=this.__mn.pop();if(Q&&!Q.isDisposed()&&Q.isFocusable()){Q.focus();}
;}
;var R=this.__mm.length;if(R>0){Q=this.__mm.pop();if(Q&&!Q.isDisposed()){Q.activate();}
;}
;}
,__mu:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());}
,getBlockerElement:function(S){if(!this.__ml){this.__ml=this.__mu();this.__ml.setStyle(r,15);if(!S){if(this._isRoot){S=this._widget;}
else {S=this._widget.getLayoutParent();}
;}
;S.getContentElement().add(this.__ml);this.__ml.exclude();}
;return this.__ml;}
,block:function(){this._block();}
,_block:function(T,V){if(!this._isRoot&&!this._widget.getLayoutParent()){this.__mp=this._widget.addListenerOnce(s,this._block.bind(this,T));return;}
...
;this.__mo++ ;if(this.__mo<2){this._backupActiveWidget();var W=this._widget.getBounds();if(W){this._updateBlockerBounds(W);}
;U.include();if(!V){U.activate();}
;U.addListener(j,this.__mx,this);U.addListener(w,this.__mw,this);U.addListener(g,this.__mw,this);U.addListener(v,this.__mw,this);this.fireEvent(B,qx.event.type.Event);}
;}
,isBlocked:function(){return this.__mo>0;}
,unblock:function(){if(this.__mp){this._widget.removeListenerById(this.__mp);}
;if(!this.isBlocked()){return;}
;this.__mo-- ;if(this.__mo<1){this.__mv();this.__mo=0;}
;}
,forceUnblock:function(){if(!this.isBlocked()){return;}
;this.__mo=0;this.__mv();}
,__mv:function(){this._restoreActiveWidget();var X=this.getBlockerElement();X.removeListener(j,this.__mx,this);X.removeListener(w,this.__mw,this);X.removeListener(g,this.__mw,this);X.removeListener(v,this.__mw,this);X.exclude();this.fireEvent(y,qx.event.type.Event);}
,blockContent:function(Y){this._block(Y,true);}
,__mw:function(e){if(e.getKeyIdentifier()==m){e.stop();}
;}
,__mx:function(){if(this.getKeepBlockerActive()){this.getBlockerElement().activate();}
;}
...
;this._widget.removeListener(q,this.__mq,this);this._widget.removeListener(o,this.__mq,this);this._widget.removeListener(s,this.__mr,this);this._widget.removeListener(A,this.__ms,this);if(this.__mp){this._widget.removeListenerById(this.__mp);}
;this._disposeObjects(h,t);this.__mm=this.__mn=this._widget=null;}
});}
)();
...
;e.preventDefault();}
,__mA:function(e){if(e.getKeyIdentifier()!==d){return;}
...
(function(){var a="keypress",b="focusout",c="activate",d="Tab",f="singleton",g="__mB",h="deactivate",j="focusin",k="qx.ui.core.FocusHandler";qx.Class.define(k,{extend:qx.core.Object,type:f,construct:function(){qx.core.Object.call(this);this.__mB={};}
,members:{__mB:null,__mC:null,__mD:null,__mE:null,connectTo:function(m){m.addListener(a,this.__io,this);m.addListener(j,this._onFocusIn,this,true);m.addListener(b,this._onFocusOut,this,true);m.addListener(c,this._onActivate,this,true);m.addListener(h,this._onDeactivate,this,true);}
,addRoot:function(n){this.__mB[n.$$hash]=n;}
,removeRoot:function(o){delete this.__mB[o.$$hash];}
,getActiveWidget:function(){return this.__mC;}
,isActive:function(p){return this.__mC==p;}
,getFocusedWidget:function(){return this.__mD;}
,isFocused:function(q){return this.__mD==q;}
,isFocusRoot:function(r){return !!this.__mB[r.$$hash];}
,_onActivate:function(e){var t=e.getTarget();this.__mC=t;var s=this.__mF(t);if(s!=this.__mE){this.__mE=s;}
;}
,_onDeactivate:function(e){var u=e.getTarget();if(this.__mC==u){this.__mC=null;}
;}
,_onFocusIn:function(e){var v=e.getTarget();if(v!=this.__mD){this.__mD=v;v.visualizeFocus();}
;}
,_onFocusOut:function(e){var w=e.getTarget();if(w==this.__mD){this.__mD=null;w.visualizeBlur();}
;}
,__io:function(e){if(e.getKeyIdentifier()!=d){return;}
;if(!this.__mE){return;}
;e.stopPropagation();e.preventDefault();var x=this.__mD;if(!e.isShiftPressed()){var y=x?this.__mJ(x):this.__mH();}
else {var y=x?this.__mK(x):this.__mI();}
;if(y){y.tabFocus();}
;}
,__mF:function(z){var A=this.__mB;while(z){if(A[z.$$hash]){return z;}
;z=z.getLayoutParent();}
;return null;}
,__mG:function(I,H){if(I===H){return 0;}
...
;return 0;}
,__mH:function(){return this.__mN(this.__mE,null);}
,__mI:function(){return this.__mO(this.__mE,null);}
,__mJ:function(M){var N=this.__mE;if(N==M){return this.__mH();}
;while(M&&M.getAnonymous()){M=M.getLayoutParent();}
;if(M==null){return [];}
;var O=[];this.__mL(N,M,O);O.sort(this.__mG);var P=O.length;return P>0?O[0]:this.__mH();}
,__mK:function(Q){var R=this.__mE;if(R==Q){return this.__mI();}
;while(Q&&Q.getAnonymous()){Q=Q.getLayoutParent();}
;if(Q==null){return [];}
;var S=[];this.__mM(R,Q,S);S.sort(this.__mG);var T=S.length;return T>0?S[T-1]:this.__mI();}
,__mL:function(parent,U,V){var X=parent.getLayoutChildren();var W;for(var i=0,l=X.length;i<l;i++ ){W=X[i];if(!(W instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(W)&&W.isEnabled()&&W.isVisible()){if(W.isTabable()&&this.__mG(U,W)<0){V.push(W);}
;this.__mL(W,U,V);}
;}
;}
,__mM:function(parent,Y,ba){var bc=parent.getLayoutChildren();var bb;for(var i=0,l=bc.length;i<l;i++ ){bb=bc[i];if(!(bb instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(bb)&&bb.isEnabled()&&bb.isVisible()){if(bb.isTabable()&&this.__mG(Y,bb)>0){ba.push(bb);}
;this.__mM(bb,Y,ba);}
;}
;}
,__mN:function(parent,bd){var bf=parent.getLayoutChildren();var be;for(var i=0,l=bf.length;i<l;i++ ){be=bf[i];if(!(be instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(be)&&be.isEnabled()&&be.isVisible()){if(be.isTabable()){if(bd==null||this.__mG(be,bd)<0){bd=be;}
;}
;bd=this.__mN(be,bd);}
;}
;return bd;}
,__mO:function(parent,bg){var bi=parent.getLayoutChildren();var bh;for(var i=0,l=bi.length;i<l;i++ ){bh=bi[i];if(!(bh instanceof qx.ui.core.Widget)){continue;}
;if(!this.isFocusRoot(bh)&&bh.isEnabled()&&bh.isVisible()){if(bh.isTabable()){if(bg==null||this.__mG(bh,bg)>0){bg=bh;}
;}
;bg=this.__mO(bh,bg);}
;}
;return bg;}
},destruct:function(){this._disposeMap(g);this.__mD=this.__mC=this.__mE=null;}
});}
)();
(function(){var a="touchmove",b="os.name",c="-webkit-overflow-scrolling",d="touch",f="paddingLeft",g="div",h="100%",i="The root widget does not support 'left', or 'top' paddings!",j="0px",k="The application could not be started due to a missing body tag in the HTML file!",l="ios",m="overflowY",n="resize",o="",p="$$widget",q="paddingTop",r="engine.name",s="none",t="webkit",u="-webkit-backface-visibility",v="touch-action",w="qx.ui.root.Application",x="hidden",y="tap",z="overflowX",A="absolute";qx.Class.define(w,{extend:qx.ui.root.Abstract,construct:function(B){this.__cI=qx.dom.Node.getWindow(B);this.__mP=B;qx.ui.root.Abstract.call(this);qx.event.Registration.addListener(this.__cI,n,this._onResize,this);this._setLayout(new qx.ui.layout.Canvas());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);this.getContentElement().disableScrolling();this.getContentElement().setStyle(u,x);this.addListener(a,this.__mQ,this);if(qx.core.Environment.get(b)==l){this.getContentElement().addListener(y,function(e){var C=qx.ui.core.Widget.getWidgetByElement(e.getTarget());while(C&&!C.isFocusable()){C=C.getLayoutParent();}
;if(C&&C.isFocusable()){C.getContentElement().focus();}
;}
,this,true);}
;}
,members:{__cI:null,__mP:null,_createContentElement:function(){var D=this.__mP;if((qx.core.Environment.get(r)==t)){if(!D.body){alert(k);}
;}
...
;}
,_computeSizeHint:function(){var I=qx.bom.Viewport.getWidth(this.__cI);var J=qx.bom.Viewport.getHeight(this.__cI);return {minWidth:I,width:I,maxWidth:I,minHeight:J,height:J,maxHeight:J};}
...
,__mQ:function(e){var M=e.getOriginalTarget();while(M&&M.style){var Q=qx.bom.element.Style.get(M,v)!==s&&qx.bom.element.Style.get(M,v)!==o;var P=qx.bom.element.Style.get(M,c)===d;var O=qx.bom.element.Style.get(M,z)!=x;var N=qx.bom.element.Style.get(M,m)!=x;if(Q||P||N||O){return;}
;M=M.parentNode;}
;e.preventDefault();}
,destroy:function(){if(this.$$disposed){return;}
;qx.dom.Element.remove(this.getContentElement().getDomElement());qx.ui.root.Abstract.prototype.destroy.call(this);}
},destruct:function(){this.__cI=this.__mP=null;}
});}
)();
...
(function(){var a="Boolean",b="one",c="pointerover",d="qx.event.type.Data",f=", because it is not a child element!",g="_applyDragSelection",h="Could not add + ",j=" from selection, because it is not a child element!",k="changeSelection",l="Could not test if ",m="Could not remove ",n="addItem",o="multi",p="_applyQuickSelection",q="single",r="qx.ui.core.MMultiSelectionHandling",s="pointermove",t=" is selected, because it is not a child element!",u="_applySelectionMode",v="additive",w="keypress",x="losecapture",y="__dl",z="Could not select ",A="removeItem",B="tap",C="pointerdown",D=" to selection, because it is not a child element!";qx.Mixin.define(r,{construct:function(){var F=this.SELECTION_MANAGER;var E=this.__dl=new F(this);this.addListener(C,E.handlePointerDown,E);this.addListener(B,E.handleTap,E);this.addListener(c,E.handlePointerOver,E);this.addListener(s,E.handlePointerMove,E);this.addListener(x,E.handleLoseCapture,E);this.addListener(w,E.handleKeyPress,E);this.addListener(n,E.handleAddItem,E);this.addListener(A,E.handleRemoveItem,E);E.addListener(k,this._onSelectionChange,this);}
,events:{"changeSelection":d},properties:{selectionMode:{check:[q,o,v,b],init:q,apply:u},dragSelection:{check:a,init:false,apply:g},quickSelection:{check:a,init:false,apply:p}},members:{__dl:null,selectAll:function(){this.__dl.selectAll();}
,isSelected:function(G){if(!qx.ui.core.Widget.contains(this,G)){throw new Error(l+G+t);}
;return this.__dl.isItemSelected(G);}
...
;this.__dl.removeItem(I);}
,selectRange:function(J,K){this.__dl.selectItemRange(J,K);}
,resetSelection:function(){this.__dl.clearSelection();}
...
else {var M=this.getSelection();if(!qx.lang.Array.equals(M,L)){this.__dl.replaceSelection(L);}
;}
;}
,getSelection:function(){return this.__dl.getSelection();}
,getSortedSelection:function(){return this.__dl.getSortedSelection();}
,isSelectionEmpty:function(){return this.__dl.isSelectionEmpty();}
,getSelectionContext:function(){return this.__dl.getSelectionContext();}
,_getManager:function(){return this.__dl;}
,getSelectables:function(N){return this.__dl.getSelectables(N);}
,invertSelection:function(){this.__dl.invertSelection();}
,_getLeadItem:function(){var O=this.__dl.getMode();if(O===q||O===b){return this.__dl.getSelectedItem();}
else {return this.__dl.getLeadItem();}
;}
,_applySelectionMode:function(Q,P){this.__dl.setMode(Q);}
,_applyDragSelection:function(S,R){this.__dl.setDrag(S);}
,_applyQuickSelection:function(U,T){this.__dl.setQuick(U);}
,_onSelectionChange:function(e){this.fireDataEvent(k,e.getData());}
},destruct:function(){this._disposeObjects(y);}
});}
)();
(function(){var a="",b="qx.ui.form.MForm",c="Boolean",d="_applyValid",f="changeLocale",g="changeRequired",h="changeValid",i="qx.dynlocale",j="changeInvalidMessage",k="String",l="invalid";qx.Mixin.define(b,{construct:function(){if(qx.core.Environment.get(i)){qx.locale.Manager.getInstance().addListener(f,this.__pM,this);}
;}
...
;throw new Error(n);}
,getSelection:function(){return qx.lang.Object.getValues(this.__gP);}
,getSortedSelection:function(){var bU=this.getSelectables();var bT=qx.lang.Object.getValues(this.__gP);bT.sort(function(a,b){return bU.indexOf(a)-bU.indexOf(b);}
);return bT;}
,isItemSelected:function(bV){var bW=this._selectableToHashCode(bV);return this.__gP[bW]!==undefined;}
,isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__gP);}
...
;this._fireChange();}
,_setLeadItem:function(cb){var ca=this.__rm;if(ca!==null){this._styleSelectable(ca,u,false);}
;if(cb!==null){this._styleSelectable(cb,u,true);}
;this.__rm=cb;}
,getLeadItem:function(){return this.__rm;}
,_setAnchorItem:function(cd){var cc=this.__rn;if(cc!=null){this._styleSelectable(cc,I,false);}
;if(cd!=null){this._styleSelectable(cd,I,true);}
;this.__rn=cd;}
,_getAnchorItem:function(){return this.__rn!==null?this.__rn:null;}
...
,_getSelectableLocationY:function(cl){throw new Error(bp);}
...
,getSelectables:function(cp){throw new Error(bv);}
...
;this._fireChange();}
,handlePointerOver:function(event){if(this.__rp!=null&&this.__rp!=this._getScroll().top){this.__rp=null;return;}
...
;var cD=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cA=event.isShiftPressed();if(this.isItemSelected(cB)&&!cA&&!cD&&!this.getDrag()){this.__ro=cB;this._userInteraction=false;return;}
else {this.__ro=null;}
;this._scrollItemIntoView(cB);var cC=this.getMode();if(this.getDrag()&&cC!==bt&&cC!==h&&!cA&&!cD&&event.getPointerType()==F){this._setAnchorItem(cB);this._setLeadItem(cB);this.__rc=this._getLocation();this.__qY=this._getScroll();this.__rd=event.getDocumentLeft()+this.__qY.left;this.__re=event.getDocumentTop()+this.__qY.top;this.__rf=true;this._capture();}
;this._fireChange(bD);this._userInteraction=false;}
,handleTap:function(event){this._userInteraction=true;var cH=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cE=event.isShiftPressed();if(!cH&&!cE&&this.__ro!=null){this._userInteraction=false;var cF=this._getSelectableFromPointerEvent(event);if(cF===null||!this.isItemSelected(cF)){return;}
;}
;var cF=this._getSelectableFromPointerEvent(event);if(cF===null){this._userInteraction=false;return;}
;switch(this.getMode()){case bt:case h:this._setSelectedItem(cF);break;case bq:this._setLeadItem(cF);this._setAnchorItem(cF);this._toggleInSelection(cF);break;case U:this._setLeadItem(cF);if(cE){var cG=this._getAnchorItem();if(cG===null){cG=this._getFirstSelectable();this._setAnchorItem(cG);}
...
,handlePointerMove:function(event){if(!this.__rf){return;}
;this.__rg=event.getDocumentLeft();this.__rh=event.getDocumentTop();this._userInteraction=true;var cI=this.__rg+this.__qY.left;if(cI>this.__rd){this.__ri=1;}
else if(cI<this.__rd){this.__ri=-1;}
else {this.__ri=0;}
;var cJ=this.__rh+this.__qY.top;if(cJ>this.__re){this.__rj=1;}
else if(cJ<this.__re){this.__rj=-1;}
else {this.__rj=0;}
;var location=this.__rc;if(this.__rg<location.left){this.__qV=this.__rg-location.left;}
else if(this.__rg>location.right){this.__qV=this.__rg-location.right;}
else {this.__qV=0;}
;if(this.__rh<location.top){this.__qW=this.__rh-location.top;}
else if(this.__rh>location.bottom){this.__qW=this.__rh-location.bottom;}
else {this.__qW=0;}
;if(!this.__qX){this.__qX=new qx.event.Timer(100);this.__qX.addListener(G,this._onInterval,this);}
;this.__qX.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
,handleAddItem:function(e){var cK=e.getData();if(this.getMode()===h&&this.isSelectionEmpty()){this.addItem(cK);}
;}
,handleRemoveItem:function(e){this.removeItem(e.getData());}
,_cleanup:function(){if(!this.getDrag()&&this.__rf){return;}
;if(this.__rk){this._fireChange(bD);}
;delete this.__rf;delete this.__ra;delete this.__rb;this._releaseCapture();if(this.__qX){this.__qX.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__qV,this.__qW);this.__qY=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cT=this._getDimension();var cM=Math.max(0,Math.min(this.__rg-this.__rc.left,cT.width))+this.__qY.left;var cL=Math.max(0,Math.min(this.__rh-this.__rc.top,cT.height))+this.__qY.top;if(this.__ra===cM&&this.__rb===cL){return;}
;this.__ra=cM;this.__rb=cL;var cQ=this._getAnchorItem();var cO=cQ;var cR=this.__ri;var cU,cN;while(cR!==0){cU=cR>0?this._getRelatedSelectable(cO,t):this._getRelatedSelectable(cO,V);if(cU!==null){cN=this._getSelectableLocationX(cU);if((cR>0&&cN.left<=cM)||(cR<0&&cN.right>=cM)){cO=cU;continue;}
;}
;break;}
;var cS=this.__rj;var cV,cP;while(cS!==0){cV=cS>0?this._getRelatedSelectable(cO,z):this._getRelatedSelectable(cO,bB);if(cV!==null){cP=this._getSelectableLocationY(cV);if((cS>0&&cP.top<=cL)||(cS<0&&cP.bottom>=cL)){cO=cV;continue;}
;}
;break;}
;var cW=this.getMode();if(cW===U){this._selectItemRange(cQ,cO);}
else if(cW===bq){if(this.isItemSelected(cQ)){this._selectItemRange(cQ,cO,true);}
else {this._deselectItemRange(cQ,cO);}
;this._setAnchorItem(cO);}
;this._fireChange(bw);}
,__oo:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;var dd,dc;var df=event.getKeyIdentifier();var de=this.getMode();var cY=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var da=event.isShiftPressed();var db=false;if(df===A&&cY){if(de!==bt&&de!==h){this._selectAllItems();db=true;}
;}
else if(df===p){if(de!==bt&&de!==h){this._clearSelection();db=true;}
;}
else if(df===r){var cX=this.getLeadItem();if(cX!=null&&!da){if(cY||de===bq){this._toggleInSelection(cX);}
else {this._setSelectedItem(cX);}
;db=true;}
;}
else if(this.__oo[df]){db=true;if(de===bt||de==h){dd=this._getSelectedItem();}
...
;if(dc!==null){switch(de){case bt:case h:this._setSelectedItem(dc);break;case bq:this._setLeadItem(dc);break;case U:if(da){var dg=this._getAnchorItem();if(dg===null){this._setAnchorItem(dg=this._getFirstSelectable());}
...
;}
;break;};this.__rp=this._getScroll().top;this._scrollItemIntoView(dc);}
;}
...
;}
,_clearSelection:function(){var di=this.__gP;for(var dj in di){this._removeFromSelection(di[dj]);}
;this.__gP={};}
,_selectItemRange:function(dk,dp,dm){var dq=this._getSelectableRange(dk,dp);if(!dm){var dn=this.__gP;var dr=this.__rq(dq);for(var dl in dn){if(!dr[dl]){this._removeFromSelection(dn[dl]);}
;}
;}
...
;}
,__rq:function(dw){var dx={};var dv;for(var i=0,l=dw.length;i<l;i++ ){dv=dw[i];dx[this._selectableToHashCode(dv)]=dv;}
;return dx;}
,_getSelectedItem:function(){for(var dy in this.__gP){return this.__gP[dy];}
;return null;}
,_setSelectedItem:function(dA){if(this._isSelectable(dA)){var dz=this.__gP;var dB=this._selectableToHashCode(dA);if(!dz[dB]||(dz.length>=2)){this._clearSelection();this._addToSelection(dA);}
;}
;}
,_addToSelection:function(dC){var dD=this._selectableToHashCode(dC);if(this.__gP[dD]==null&&this._isSelectable(dC)){this.__gP[dD]=dC;this._styleSelectable(dC,R,true);this.__rk=true;}
;}
,_toggleInSelection:function(dE){var dF=this._selectableToHashCode(dE);if(this.__gP[dF]==null){this.__gP[dF]=dE;this._styleSelectable(dE,R,true);}
else {delete this.__gP[dF];this._styleSelectable(dE,R,false);}
;this.__rk=true;}
,_removeFromSelection:function(dG){var dH=this._selectableToHashCode(dG);if(this.__gP[dH]!=null){delete this.__gP[dH];this._styleSelectable(dG,R,false);this.__rk=true;}
;}
...
;}
;var dP=dK[0];var dI=dO;var dM=this.__gP;for(var dN in dM){if(dJ[dN]){delete dJ[dN];}
...
;if(!dL){return false;}
;this._scrollItemIntoView(dI);this._setLeadItem(dP);this._setAnchorItem(dP);this.__rk=true;this._fireChange();}
,_fireChange:function(dQ){if(this.__rk){this.__rl=dQ||null;this.fireDataEvent(bs,this.getSelection());delete this.__rk;}
;}
...
;return dS;}
;return null;}
},destruct:function(){this._disposeObjects(bA);this.__gP=this.__ro=this.__rn=null;this.__rm=null;}
});}
)();
(function(){var a="vertical",b="under",c="above",d="qx.ui.core.selection.Widget",e="left",f="right";qx.Class.define(d,{extend:qx.ui.core.selection.Abstract,construct:function(g){qx.ui.core.selection.Abstract.call(this);this.__lA=g;}
,members:{__lA:null,_isSelectable:function(h){return this._isItemSelectable(h)&&h.getLayoutParent()===this.__lA;}
,_selectableToHashCode:function(j){return j.$$hash;}
,_styleSelectable:function(k,m,n){n?k.addState(m):k.removeState(m);}
,_capture:function(){this.__lA.capture();}
,_releaseCapture:function(){this.__lA.releaseCapture();}
,_isItemSelectable:function(o){if(this._userInteraction){return o.isVisible()&&o.isEnabled();}
else {return o.isVisible();}
;}
,_getWidget:function(){return this.__lA;}
,_getLocation:function(){var p=this.__lA.getContentElement().getDomElement();return p?qx.bom.element.Location.get(p):null;}
,_getDimension:function(){return this.__lA.getInnerSize();}
...
,_scrollItemIntoView:function(w){this.__lA.scrollChildIntoView(w);}
,getSelectables:function(x){var y=false;if(!x){y=this._userInteraction;this._userInteraction=true;}
;var B=this.__lA.getChildren();var z=[];var A;for(var i=0,l=B.length;i<l;i++ ){A=B[i];if(this._isItemSelectable(A)){z.push(A);}
;}
;this._userInteraction=y;return z;}
,_getSelectableRange:function(C,D){if(C===D){return [C];}
;var H=this.__lA.getChildren();var E=[];var G=false;var F;for(var i=0,l=H.length;i<l;i++ ){F=H[i];if(F===C||F===D){if(G){E.push(F);break;}
else {G=true;}
;}
;if(G&&this._isItemSelectable(F)){E.push(F);}
;}
;return E;}
,_getFirstSelectable:function(){var I=this.__lA.getChildren();for(var i=0,l=I.length;i<l;i++ ){if(this._isItemSelectable(I[i])){return I[i];}
;}
;return null;}
,_getLastSelectable:function(){var J=this.__lA.getChildren();for(var i=J.length-1;i>0;i-- ){if(this._isItemSelectable(J[i])){return J[i];}
;}
;return null;}
,_getRelatedSelectable:function(N,O){var L=this.__lA.getOrientation()===a;var P=this.__lA.getChildren();var K=P.indexOf(N);var M;if((L&&O===c)||(!L&&O===e)){for(var i=K-1;i>=0;i-- ){M=P[i];if(this._isItemSelectable(M)){return M;}
;}
;}
...
;}
},destruct:function(){this.__lA=null;}
});}
)();
...
(function(){var a="_applyIconOpened",b="changeOpen",c="Boolean",d="changeIcon",f="changeIconOpened",g="changeLabel",h="Integer",i="auto",j="Abstract method call.",k="_applyIndent",l="open",m="changeOpenSymbolMode",n="_applyOpenSymbolMode",o="__rt",p="middle",q="String",r="resize",s="",t="icon",u="opened",v="iconOpened",w="abstract",x="never",y="_applyIcon",z="always",A="_applyOpen",B="changeIndent",C="qx.ui.tree.core.AbstractItem",D="label",E="_applyLabel";qx.Class.define(C,{extend:qx.ui.core.Widget,type:w,include:[qx.ui.form.MModelProperty],implement:[qx.ui.form.IModel],construct:function(F){qx.ui.core.Widget.call(this);if(F!=null){this.setLabel(F);}
;this._setLayout(new qx.ui.layout.HBox());this._addWidgets();this.initOpen();}
,properties:{open:{check:c,init:false,event:b,apply:A},openSymbolMode:{check:[z,x,i],init:i,event:m,apply:n},indent:{check:h,init:19,apply:k,event:B,themeable:true},icon:{check:q,apply:y,event:d,nullable:true,themeable:true},iconOpened:{check:q,apply:a,event:f,nullable:true,themeable:true},label:{check:q,apply:E,event:g,init:s}},members:{__rr:null,__rs:null,__rt:null,_addWidgets:function(){throw new Error(j);}
,_createChildControlImpl:function(I,H){var G;switch(I){case D:G=new qx.ui.basic.Label().set({alignY:p,anonymous:true,value:this.getLabel()});break;case t:G=new qx.ui.basic.Image().set({alignY:p,anonymous:true,source:this.getIcon()});break;case l:G=new qx.ui.tree.core.FolderOpenButton().set({alignY:p});G.addListener(b,this._onChangeOpen,this);G.addListener(r,this._updateIndent,this);break;};return G||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,I);}
,addWidget:function(J,K){this._add(J,K);}
,addSpacer:function(){if(!this.__rt){this.__rt=new qx.ui.core.Spacer();}
else {this._remove(this.__rt);}
;this._add(this.__rt);}
,addOpenButton:function(){this._add(this.getChildControl(l));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var L=this.getChildControl(t);if(this.__rs){this._remove(L);}
;this._add(L);this.__rs=true;}
,addLabel:function(M){var N=this.getChildControl(D);if(this.__rr){this._remove(N);}
;if(M){this.setLabel(M);}
else {N.setValue(this.getLabel());}
;this._add(N);this.__rr=true;}
,_applyIcon:function(P,O){if(!this.__rv()){this.__rw(P);}
else if(!this.isOpen()){this.__rw(P);}
;}
,_applyIconOpened:function(R,Q){if(this.isOpen()){if(this.__ru()&&this.__rv()){this.__rw(R);}
else if(!this.__ru()&&this.__rv()){this.__rw(R);}
;}
;}
,_applyLabel:function(T,S){var U=this.getChildControl(D,true);if(U){U.setValue(T);}
;}
,_applyOpen:function(W,V){var open=this.getChildControl(l,true);if(open){open.setOpen(W);}
;var X;if(W){X=this.__rv()?this.getIconOpened():null;}
else {X=this.getIcon();}
;if(X){this.__rw(X);}
;W?this.addState(u):this.removeState(u);}
,__ru:function(){return qx.util.PropertyUtil.getUserValue(this,t);}
,__rv:function(){return qx.util.PropertyUtil.getUserValue(this,v);}
,__rw:function(Y){var ba=this.getChildControl(t,true);if(ba){ba.setSource(Y);}
;}
,isOpenable:function(){var bb=this.getOpenSymbolMode();return (bb===z||bb===i&&this.hasChildren());}
,_shouldShowOpenSymbol:function(){throw new Error(j);}
,_applyOpenSymbolMode:function(bd,bc){this._updateIndent();}
,_updateIndent:function(){var bf=0;var open=this.getChildControl(l,true);if(open){if(this._shouldShowOpenSymbol()){open.show();var be=open.getBounds();if(be){bf=be.width;}
else {return;}
;}
else {open.exclude();}
;}
;if(this.__rt){this.__rt.setWidth((this.getLevel()+1)*this.getIndent()-bf);}
;}
,_applyIndent:function(bh,bg){this._updateIndent();}
,getLevel:function(){throw new Error(j);}
,syncWidget:function(bi){this._updateIndent();}
,hasChildren:function(){throw new Error(j);}
},destruct:function(){this._disposeObjects(o);}
});}
)();
(function(){var a="toolTipText",b="icon",c="label",d="qx.ui.core.MExecutable",f="enabled",g="value",h="qx.event.type.Event",j="execute",k="_applyCommand",l="qx.ui.command.Command",m="menu",n="changeCommand";qx.Mixin.define(d,{events:{"execute":h},properties:{command:{check:l,apply:k,event:n,nullable:true}},members:{__oe:null,__of:false,__og:null,_bindableProperties:[f,c,b,a,g,m],execute:function(){var o=this.getCommand();if(o){if(this.__of){this.__of=false;}
else {this.__of=true;o.execute(this);}
;}
;this.fireEvent(j);}
,__oh:function(e){if(this.__of){this.__of=false;return;}
;if(this.isEnabled()){this.__of=true;this.execute();}
;}
,_applyCommand:function(r,p){if(p!=null){p.removeListenerById(this.__og);}
;if(r!=null){this.__og=r.addListener(j,this.__oh,this);}
;var q=this.__oe;if(q==null){this.__oe=q={};}
...
;}
;}
},destruct:function(){this._applyCommand(null,this.getCommand());this.__oe=null;}
});}
)();
...
(function(){var a="open",b="__hi",c="abstract",d="qx.debug",e="'. It is not a child of this tree item.",f="addItem",g="__rx",h="visible",j="excluded",k="removeItem",m="Invalid child index: ",n="Cannot remove treeitem '",o="qx.ui.tree.core.AbstractTreeItem";qx.Class.define(o,{extend:qx.ui.tree.core.AbstractItem,type:c,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__hi=[];}
,properties:{parent:{check:o,nullable:true}},members:{__hi:null,__rx:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
;return null;}
,_applyOpen:function(t,s){if(this.hasChildren()){this.getChildrenContainer().setVisibility(t?h:j);}
...
;}
;}
,getChildrenContainer:function(){if(!this.__rx){this.__rx=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?h:j});}
;return this.__rx;}
,hasChildrenContainer:function(){return this.__rx;}
...
;}
,__ry:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);}
;}
...
;this.__hi.push(Q);if(!N){this.__ry();}
;if(P){Q.recursiveAddToWidgetQueue();P.fireNonBubblingEvent(f,qx.event.type.Data,[Q]);}
;}
;if(P){qx.ui.core.queue.Widget.add(this);}
;}
,addAt:function(X,T){if(qx.core.Environment.get(d)){this.assert(T<=this.__hi.length&&T>=0,m+T);}
;if(T==this.__hi.length){this.add(X);return;}
;var W=X.getParent();if(W){W.remove(X);}
;var U=this.getChildrenContainer();X.setParent(this);var V=this.hasChildren();var S=this.__hi[T];U.addBefore(X,S);if(X.hasChildren()){U.addAfter(X.getChildrenContainer(),X);}
;qx.lang.Array.insertAt(this.__hi,X,T);if(!V){this.__ry();}
;if(this.getTree()){X.recursiveAddToWidgetQueue();qx.ui.core.queue.Widget.add(this);}
;}
,addBefore:function(Y,bb){if(qx.core.Environment.get(d)){this.assert(this.__hi.indexOf(bb)>=0);}
;var ba=Y.getParent();if(ba){ba.remove(Y);}
;this.addAt(Y,this.__hi.indexOf(bb));}
,addAfter:function(bd,bc){if(qx.core.Environment.get(d)){this.assert(this.__hi.indexOf(bc)>=0);}
;var be=bd.getParent();if(be){be.remove(bd);}
;this.addAt(bd,this.__hi.indexOf(bc)+1);}
,addAtBegin:function(bf){this.addAt(bf,0);}
,remove:function(bk){for(var i=0,l=arguments.length;i<l;i++ ){var bj=arguments[i];if(this.__hi.indexOf(bj)==-1){this.warn(n+bj+e);return;}
...
;}
;qx.lang.Array.remove(this.__hi,bj);bj.setParent(null);bg.remove(bj);}
;var bh=this.getTree();if(bh){bh.fireNonBubblingEvent(k,qx.event.type.Data,[bj]);}
;qx.ui.core.queue.Widget.add(this);}
,removeAt:function(bl){var bm=this.__hi[bl];if(bm){this.remove(bm);}
;}
,removeAll:function(){var bn=this.__hi.concat();for(var i=this.__hi.length-1;i>=0;i-- ){this.remove(this.__hi[i]);}
;return bn;}
...
,events:{update:n,scrollAnimationEnd:n},properties:{scrollX:{check:j,apply:g,transform:d,event:f,init:0},scrollY:{check:m,apply:h,transform:k,event:b,init:0}},members:{__oA:null,add:function(t){var u=this._getChildren()[0];if(u){this._remove(u);u.removeListener(a,this._onUpdate,this);}
...
;this.stopScrollAnimation();if(N){var P=this.getScrollX();this.__oA=new qx.bom.AnimationFrame();this.__oA.on(p,function(){this.setScrollX(Q);this.__oA=null;this.fireEvent(c);}
,this);this.__oA.on(i,function(S){var R=parseInt(S/N*(Q-P)+P);this.setScrollX(R);}
,this);this.__oA.startSequence(N);}
else {this.setScrollX(Q);}
;}
,scrollToY:function(W,T){var U=this.getScrollMaxY();if(W<0){W=0;}
else if(W>U){W=U;}
;this.stopScrollAnimation();if(T){var V=this.getScrollY();this.__oA=new qx.bom.AnimationFrame();this.__oA.on(p,function(){this.setScrollY(W);this.__oA=null;this.fireEvent(c);}
,this);this.__oA.on(i,function(Y){var X=parseInt(Y/T*(W-V)+V);this.setScrollY(X);}
,this);this.__oA.startSequence(T);}
...
,stopScrollAnimation:function(){if(this.__oA){this.__oA.cancelSequence();this.__oA=null;}
;}
...
;if(v){this.setSeparator(v);}
;}
,properties:{alignY:{check:[k,o,f],init:k,apply:b},alignX:{check:[m,c,r],init:m,apply:b},spacing:{check:p,init:0,apply:b},separator:{check:a,nullable:true,apply:b},reversed:{check:s,init:false,apply:d}},members:{__nX:null,__lR:null,__lS:null,__hi:null,_applyReversed:function(){this._invalidChildrenCache=true;this._applyLayoutChange();}
,__lT:function(){var B=this._getLayoutChildren();var length=B.length;var x=false;var w=this.__nX&&this.__nX.length!=length&&this.__lR&&this.__nX;var z;var y=w?this.__nX:new Array(length);var A=w?this.__lR:new Array(length);if(this.getReversed()){B=B.concat().reverse();}
...
;}
;if(!w){this.__nX=y;this.__lR=A;}
;this.__lS=x;this.__hi=B;delete this._invalidChildrenCache;}
...
;}
,"false":null}),renderLayout:function(V,N,Y){if(this._invalidChildrenCache){this.__lT();}
;var K=this.__hi;var length=K.length;var U=qx.ui.layout.Util;var T=this.getSpacing();var bb=this.getSeparator();if(bb){var H=U.computeVerticalSeparatorGaps(K,T,bb);}
else {var H=U.computeVerticalGaps(K,T,true);}
;var i,ba,G,O;var P=[];var W=H;for(i=0;i<length;i+=1){O=this.__nX[i];G=O!=null?Math.floor((N-H)*O):K[i].getSizeHint().height;P.push(G);W+=G;}
;if(this.__lS&&W!=N){var M={};var S,F;for(i=0;i<length;i+=1){S=this.__lR[i];if(S>0){L=K[i].getSizeHint();M[i]={min:L.minHeight,value:P[i],max:L.maxHeight,flex:S};}
;}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__lT();}
;var be=qx.ui.layout.Util;var bs=this.__hi;var bh=0,bi=0,bq=0;var bj=0,bk=0;var bo,bf,br;for(var i=0,l=bs.length;i<l;i+=1){bo=bs[i];bf=bo.getSizeHint();bi+=bf.height;var bn=this.__lR[i];var bg=this.__nX[i];if(bn){bh+=bf.minHeight;}
...
},destruct:function(){this.__nX=this.__lR=this.__hi=null;}
});}
)();
(function(){var a="Could not set the model selection. Maybe your models are not unique? ",b="__qJ",c="qx.ui.form.MModelSelection",d="Please use an array as parameter.",f="change",g="qx.debug",h="changeSelection",k="qx.event.type.Data";qx.Mixin.define(c,{construct:function(){this.__qJ=new qx.data.Array();this.__qJ.addListener(f,this.__qM,this);this.addListener(h,this.__qL,this);}
,events:{changeModelSelection:k},members:{__qJ:null,__qK:false,__qL:function(){if(this.__qK){return;}
...
;}
;}
,__qM:function(){this.__qK=true;var r=this.getSelectables(true);var s=[];var q=this.__qJ.toArray();for(var i=0;i<q.length;i++ ){var u=q[i];for(var j=0;j<r.length;j++ ){var v=r[j];var p=v.getModel?v.getModel():null;if(u===p){s.push(v);break;}
;}
;}
;this.setSelection(s);this.__qK=false;var t=this.getSelection();if(!qx.lang.Array.equals(t,s)){this.__qL();}
;}
,getModelSelection:function(){return this.__qJ;}
,setModelSelection:function(w){if(!w){this.__qJ.removeAll();return;}
;if(qx.core.Environment.get(g)){this.assertArray(w,d);}
;w.unshift(this.__qJ.getLength());w.unshift(0);var x=this.__qJ.splice.apply(this.__qJ,w);x.dispose();}
...
;if((n instanceof qx.core.Object)&&qx.Class.hasMixin(n.constructor,qx.data.marshal.MEventBubbling)){var o=qx.lang.Function.bind(this.__qN,this,name);var q=n.addListener(g,o,this);var p=n.getUserData(d+this.$$hash);if(p==null){p=[];n.setUserData(d+this.$$hash,p);}
;p.push(q);}
;}
,__qN:function(name,e){var y=e.getData();var u=y.value;var s=y.old;if(qx.Class.hasInterface(e.getTarget().constructor,qx.data.IListData)){if(y.name.indexOf){var x=y.name.indexOf(h)!=-1?y.name.indexOf(h):y.name.length;var v=y.name.indexOf(f)!=-1?y.name.indexOf(f):y.name.length;if(v==0){var t=name+y.name;}
...
else if(arguments.length>1){this.__qO=[];for(var i=0;i<arguments.length;i++ ){this.__qO.push(arguments[i]);}
;}
else if(typeof u==q){this.__qO=new Array(u);}
else if(u instanceof Array){this.__qO=qx.lang.Array.clone(u);}
else {this.__qO=[];this.dispose();throw new Error(l);}
;for(var i=0;i<this.__qO.length;i++ ){this._applyEventPropagation(this.__qO[i],null,i);}
;this.__qP();if(qx.core.Environment.get(k)){this[0]=h;}
;}
,properties:{autoDisposeItems:{check:e,init:false}},events:{"change":t,"changeLength":t},members:{__qO:null,concat:function(v){if(v){var w=this.__qO.concat(v);}
else {var w=this.__qO.concat();}
;return new qx.data.Array(w);}
,join:function(x){return this.__qO.join(x);}
,pop:function(){var y=this.__qO.pop();this.__qP();this._registerEventChaining(null,y,this.length-1);this.fireDataEvent(r,{value:[],name:this.length+f,old:[y],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:g,removed:[y],added:[]},null);return y;}
,push:function(z){for(var i=0;i<arguments.length;i++ ){this.__qO.push(arguments[i]);this.__qP();this._registerEventChaining(arguments[i],null,this.length-1);this.fireDataEvent(r,{value:[arguments[i]],name:(this.length-1)+f,old:[],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,reverse:function(){if(this.length==0){return;}
;var A=this.__qO.concat();this.__qO.reverse();this.__qQ(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__qO,name:n+(this.__qO.length-1),old:A,item:this});}
,shift:function(){if(this.length==0){return;}
;var B=this.__qO.shift();this.__qP();this._registerEventChaining(null,B,this.length-1);this.__qQ(0,this.length);this.fireDataEvent(r,{value:[],name:p,old:[B],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:g,removed:[B],added:[]},null);return B;}
,slice:function(D,C){return new qx.data.Array(this.__qO.slice(D,C));}
,splice:function(I,K,M){var Q=this.__qO.length;var L=this.__qO.splice.apply(this.__qO,arguments);if(this.__qO.length!=Q){this.__qP();}
...
;this.__qQ(I+(arguments.length-2)-K,this.length);if(O||G){var J=[];for(var i=2;i<arguments.length;i++ ){J[i-2]=arguments[i];}
...
;var R=this.__qO.concat();this.__qO.sort.apply(this.__qO,arguments);if(qx.lang.Array.equals(this.__qO,R)===true){return;}
;this.__qQ(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__qO,name:n+(this.length-1),old:R,item:this});}
,unshift:function(T){for(var i=arguments.length-1;i>=0;i-- ){this.__qO.unshift(arguments[i]);this.__qP();this.__qQ(0,this.length);this.fireDataEvent(r,{value:[this.__qO[0]],name:p,old:[this.__qO[1]],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,toArray:function(){return this.__qO;}
,getItem:function(U){return this.__qO[U];}
,setItem:function(V,X){var W=this.__qO[V];if(W===X){return;}
;this.__qO[V]=X;this._registerEventChaining(X,W,V);if(this.length!=this.__qO.length){this.__qP();}
...
,indexOf:function(Y){return this.__qO.indexOf(Y);}
,lastIndexOf:function(ba){return this.__qO.lastIndexOf(ba);}
,toString:function(){if(this.__qO!=null){return this.__qO.toString();}
;return f;}
,contains:function(bb){return this.__qO.indexOf(bb)!==-1;}
...
,removeAll:function(){for(var i=0;i<this.__qO.length;i++ ){this._registerEventChaining(null,this.__qO[i],i);}
;if(this.getLength()==0){return [];}
;var bo=this.getLength();var bn=this.__qO.concat();this.__qO.length=0;this.__qP();this.fireDataEvent(r,{value:[],name:n+(bo-1),old:bn,item:this});this.fireDataEvent(o,{start:0,end:bo-1,type:g,removed:bn,added:[]},null);return bn;}
...
;var bq=this.__qO.length;Array.prototype.push.apply(this.__qO,bp);for(var i=0;i<bp.length;i++ ){this._registerEventChaining(bp[i],null,bq+i);}
;var bq=this.length;this.__qP();var name=bq==(this.length-1)?bq:bq+a+(this.length-1);this.fireDataEvent(r,{value:bp,name:name+f,old:[],item:this});this.fireDataEvent(o,{start:bq,end:this.length-1,type:b,added:bp,removed:[]},null);}
...
,forEach:function(bx,by){for(var i=0;i<this.__qO.length;i++ ){bx.call(by,this.__qO[i],i,this);}
;}
,filter:function(bz,self){return new qx.data.Array(this.__qO.filter(bz,self));}
,map:function(bA,self){return new qx.data.Array(this.__qO.map(bA,self));}
,some:function(bB,self){return this.__qO.some(bB,self);}
,every:function(bC,self){return this.__qO.every(bC,self);}
,reduce:function(bE,bD){return this.__qO.reduce(bE,bD);}
,reduceRight:function(bG,bF){return this.__qO.reduceRight(bG,bF);}
,__qP:function(){var bH=this.length;this.length=this.__qO.length;this.fireDataEvent(s,this.length,bH);}
,__qQ:function(bJ,bI){for(var i=bJ;i<bI;i++ ){this._registerEventChaining(this.__qO[i],this.__qO[i],i);}
;}
},destruct:function(){for(var i=0;i<this.__qO.length;i++ ){var bK=this.__qO[i];this._applyEventPropagation(null,bK,i);if(this.isAutoDisposeItems()&&bK&&bK instanceof qx.core.Object){bK.dispose();}
;}
;this.__qO=null;}
});}
)();
...
(function(){var a="mouse",b="scrollbar-y",c="qx.ui.core.scroll.MRoll",d="pointerdown",f="scrollbar-x",g="roll";qx.Mixin.define(c,{members:{__rz:null,_addRollHandling:function(){this.addListener(g,this._onRoll,this);this.addListener(d,this._onPointerDownForRoll,this);}
...
,_onPointerDownForRoll:function(e){this.__rz=e.getPointerId();}
,_onRoll:function(e){if(e.getPointerType()==a){return;}
;if(this.__rz&&e.getMomentum()){qx.event.Registration.getManager(e.getOriginalTarget()).getHandler(qx.event.handler.Gesture).gestureCancel(this.__rz);e.stopMomentum();this.__rz=null;return;}
;this.__rz=null;var k=this._isChildControlVisible(f);var l=this._isChildControlVisible(b);var q=l?this.getChildControl(b,true):null;var p=k?this.getChildControl(f,true):null;var m=e.getDelta().y;var h=e.getDelta().x;var j=!l;var o=!k;if(q){if(m!==0){q.scrollBy(parseInt(m,10));}
...
;r.addListener(k,this.__rD,this);r.addListener(i,this.__rE,this);this.__rA=[n,o];this.__rB=[m,g];}
,properties:{dragScrollThresholdX:{check:p,init:30},dragScrollThresholdY:{check:p,init:30},dragScrollSlowDownFactor:{check:b,init:0.1}},members:{__rC:null,__rA:null,__rB:null,_findScrollableParent:function(s){var t=s;if(t===null){return null;}
...
;}
,_getAxis:function(A){if(this.__rA.indexOf(A)!==-1){return a;}
else if(this.__rB.indexOf(A)!==-1){return q;}
else {throw new Error(l+A+f);}
;}
,_getThresholdByEdgeType:function(B){if(this.__rA.indexOf(B)!==-1){return this.getDragScrollThresholdX();}
else if(this.__rB.indexOf(B)!==-1){return this.getDragScrollThresholdY();}
;}
...
;var P=S.getBounds(),O=T===a?P.width:P.height,R=this._calculateScrollAmount(O,Q);if(this._isScrollbarExceedingMaxPos(S,T,R)){this.__rC.stop();}
;S.scrollBy(R);}
,__rD:function(e){if(this.__rC){this.__rC.stop();}
...
;bd=this._getAxis(X);if(this._isScrollbarVisible(U,bd)){bb=this._calculateThresholdExceedance(bc[X],this._getThresholdByEdgeType(X));if(this.__rC){this.__rC.dispose();}
;this.__rC=new qx.event.Timer(50);this.__rC.addListener(h,function(be,bg,bf){this._scrollBy(be,bg,bf);}
.bind(this,U,bd,bb));this.__rC.start();e.stopPropagation();return;}
else {U=this._findScrollableParent(U);}
;}
;}
,__rE:function(e){if(this.__rC){this.__rC.stop();}
;}
},destruct:function(){if(this.__rC){this.__rC.dispose();}
;}
});}
)();
...
(function(){var a="__rF",b="qx.ui.core.scroll.NativeScrollBar",c="px",d="PositiveNumber",f="frame",g="end",h="box-sizing",i="Integer",j="track",k="browser.name",l="hidden",m="content-box",n="pointerup",o="vertical",p="_applyOrientation",q="scrollAnimationEnd",r="appear",s="pointerdown",t="PositiveInteger",u='qx.event.type.Event',v="mshtml",w="engine.name",x="horizontal",y="Number",z="edge",A="_applyPosition",B="scrollbar",C="_applyMaximum",D="pointermove",E="native",F="scroll";qx.Class.define(b,{extend:qx.ui.core.Widget,implement:qx.ui.core.scroll.IScrollBar,construct:function(G){qx.ui.core.Widget.call(this);this.addState(E);this.getContentElement().addListener(F,this._onScroll,this);this.addListener(s,this._stopPropagation,this);this.addListener(n,this._stopPropagation,this);this.addListener(D,this._stopPropagation,this);this.addListener(r,this._onAppear,this);this.getContentElement().add(this._getScrollPaneElement());this.getContentElement().setStyle(h,m);if(G!=null){this.setOrientation(G);}
else {this.initOrientation();}
;this.addListener(j,function(e){e.stopPropagation();}
,this);}
,events:{scrollAnimationEnd:u},properties:{appearance:{refine:true,init:B},orientation:{check:[x,o],init:x,apply:p},maximum:{check:t,apply:C,init:100},position:{check:y,init:0,apply:A,event:F},singleStep:{check:i,init:20},knobFactor:{check:d,nullable:true}},members:{__pF:null,__rF:null,__kM:null,__rG:null,_getScrollPaneElement:function(){if(!this.__rF){this.__rF=new qx.html.Element();}
;return this.__rF;}
...
,_getContentHint:function(){var L=qx.bom.element.Scroll.getScrollbarWidth();return {width:this.__pF?100:L,maxWidth:this.__pF?null:L,minWidth:this.__pF?null:L,height:this.__pF?L:100,maxHeight:this.__pF?L:null,minHeight:this.__pF?L:null};}
...
,_applyPosition:function(P){var content=this.getContentElement();if(this.__pF){content.scrollToX(P);}
else {content.scrollToY(P);}
;}
,_applyOrientation:function(S,Q){var R=this.__pF=S===x;this.set({allowGrowX:R,allowShrinkX:R,allowGrowY:!R,allowShrinkY:!R});if(R){this.replaceState(o,x);}
...
,_updateScrollBar:function(){var U=this.__pF;var V=this.getBounds();if(!V){return;}
;if(this.isEnabled()){var W=U?V.width:V.height;var T=this.getMaximum()+W;}
else {T=0;}
;if(qx.core.Environment.get(w)==v||qx.core.Environment.get(k)==z){var V=this.getBounds();this.getContentElement().setStyles({left:(U?V.left:(V.left-1))+c,top:(U?(V.top-1):V.top)+c,width:(U?V.width:V.width+1)+c,height:(U?V.height+1:V.height)+c});}
;this._getScrollPaneElement().setStyles({left:0,top:0,width:(U?T:1)+c,height:(U?1:T)+c});this.updatePosition(this.getPosition());}
,scrollTo:function(Y,X){this.stopScrollAnimation();if(X){var ba=this.getPosition();this.__rG=new qx.bom.AnimationFrame();this.__rG.on(f,function(bc){var bb=parseInt(bc/X*(Y-ba)+ba);this.updatePosition(bb);}
,this);this.__rG.on(g,function(){this.setPosition(Math.max(0,Math.min(this.getMaximum(),Y)));this.__rG=null;this.fireEvent(q);}
,this);this.__rG.startSequence(X);}
...
,stopScrollAnimation:function(){if(this.__rG){this.__rG.cancelSequence();this.__rG=null;}
;}
,_onScroll:function(e){var bj=this.getContentElement();var bk=this.__pF?bj.getScrollX():bj.getScrollY();this.setPosition(bk);}
...
;var bw=this.__pF;var bu=this.getChildControl(P);var bv=bw?G:L;var bA=bw?e.getDocumentLeft():e.getDocumentTop();var bC=this.getDecorator();bC=qx.theme.manager.Decoration.getInstance().resolve(bC);if(bw){var bz=bC?bC.getInsets().left:0;var by=(this.getPaddingLeft()||0)+bz;}
...
else {this.__rO=true;this.__rP=bA<=bx?-1:1;this.__rV(e);this._onInterval();if(!this.__dy){this.__dy=new qx.event.Timer(100);this.__dy.addListener(r,this._onInterval,this);}
;this.__dy.start();}
;this.addListener(w,this._onPointerMove);this.capture();e.stopPropagation();}
,_onPointerUp:function(e){if(this.__rM){this.releaseCapture();delete this.__rM;this.__rR.stop();this._fireValue();delete this.__rN;this.getChildControl(P).removeState(c);if(e.getType()===B){var bE;var bF;var bD;if(this.__pF){bE=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__rJ);bD=qx.bom.element.Location.get(this.getContentElement().getDomElement())[L];bF=e.getDocumentTop()-(bD+this.getChildControl(P).getBounds().top);}
...
;}
;}
else if(this.__rO){this.__dy.stop();this.releaseCapture();delete this.__rO;delete this.__rP;delete this.__rQ;}
;this.removeListener(w,this._onPointerMove);if(e.getType()===B){e.stopPropagation();}
;}
,_onPointerMove:function(e){if(this.__rM){var bH=this.__pF?e.getDocumentLeft():e.getDocumentTop();var bG=bH-this.__rN;this.slideTo(this._positionToValue(bG));}
else if(this.__rO){this.__rV(e);}
;e.stopPropagation();}
...
;this.slideTo(bI);}
,_onUpdate:function(e){var bL=this.getInnerSize();var bM=this.getChildControl(P).getBounds();var bK=this.__pF?E:x;this._updateKnobSize();this.__rU=bL[bK]-bM[bK];this.__rL=bM[bK];this._updateKnobPosition();}
,__pF:false,__rU:0,__rV:function(e){var bN=this.__pF;var bU=bN?e.getDocumentLeft():e.getDocumentTop();var bX=this.__rJ;var bO=this.__rK;var bY=this.__rL;var bV=bU-bX;if(bU>=bO){bV-=bY;}
...
;}
,_positionToValue:function(cb){var ca=this.__rU;if(ca==null||ca==0){return 0;}
;var cd=cb/ca;if(cd<0){cd=0;}
else if(cd>1){cd=1;}
;var cc=this.getMaximum()-this.getMinimum();return this.getMinimum()+Math.round(cc*cd);}
,_valueToPosition:function(ch){var ce=this.__rU;if(ce==null){return 0;}
...
,_setKnobPosition:function(ck){var ci=this.getChildControl(P);var cj=this.getDecorator();cj=qx.theme.manager.Decoration.getInstance().resolve(cj);var content=ci.getContentElement();if(this.__pF){if(cj&&cj.getPadding()){ck+=cj.getPadding().left;}
...
;if(this.__pF){this.getChildControl(P).setWidth(Math.round(cm*cl.width));}
...
,slideTo:function(cu,ct){this.stopSlideAnimation();if(ct){this.__rX(cu,ct);}
else {this.updatePosition(cu);}
;}
,updatePosition:function(cv){this.setValue(this.__rW(cv));}
,stopSlideAnimation:function(){if(this.__rG){this.__rG.cancelSequence();this.__rG=null;}
;}
,__rW:function(cw){if(cw<this.getMinimum()){cw=this.getMinimum();}
...
;return cw;}
,__rX:function(cy,cx){cy=this.__rW(cy);var cz=this.getValue();this.__rG=new qx.bom.AnimationFrame();this.__rG.on(i,function(cA){this.setValue(parseInt(cA/cx*(cy-cz)+cz));}
,this);this.__rG.on(j,function(){this.setValue(cy);this.__rG=null;this.fireEvent(O);}
,this);this.__rG.startSequence(cx);}
,_applyOrientation:function(cD,cC){var cB=this.getChildControl(P);this.__pF=cD===N;if(this.__pF){this.removeState(C);cB.removeState(C);this.addState(N);cB.addState(N);cB.setLayoutProperties({top:0,right:null,bottom:0});}
...
else {if(this.__pF){this.getChildControl(P).resetWidth();}
...
(function(){var a="press",b="hovered",c="qx.ui.form.RepeatButton",d="release",f="Enter",g="pressed",h="interval",i="qx.event.type.Event",j="Space",k="__dy",l="abandoned",m="Integer",n="execute";qx.Class.define(c,{extend:qx.ui.form.Button,construct:function(o,p){qx.ui.form.Button.call(this,o,p);this.__dy=new qx.event.AcceleratingTimer();this.__dy.addListener(h,this._onInterval,this);}
,events:{"execute":i,"press":i,"release":i},properties:{interval:{check:m,init:100},firstInterval:{check:m,init:500},minTimer:{check:m,init:20},timerDecrease:{check:m,init:2}},members:{__ow:null,__dy:null,press:function(){if(this.isEnabled()){if(!this.hasState(g)){this.__ox();}
;this.removeState(l);this.addState(g);}
;}
,release:function(q){if(!this.isEnabled()){return;}
;if(this.hasState(g)){if(!this.__ow){this.execute();}
;}
;this.removeState(g);this.removeState(l);this.__oy();}
...
;}
,_onPointerOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;if(this.hasState(l)){this.removeState(l);this.addState(g);this.__dy.start();}
;this.addState(b);}
,_onPointerOut:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.removeState(b);if(this.hasState(g)){this.removeState(g);this.addState(l);this.__dy.stop();}
;}
,_onPointerDown:function(e){if(!e.isLeftPressed()){return;}
;this.capture();this.__ox();e.stopPropagation();}
,_onPointerUp:function(e){this.releaseCapture();if(!this.hasState(l)){this.addState(b);if(this.hasState(g)&&!this.__ow){this.execute();}
;}
;this.__oy();e.stopPropagation();}
,_onTap:function(e){}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case f:case j:if(this.hasState(g)){if(!this.__ow){this.execute();}
;this.removeState(g);this.removeState(l);e.stopPropagation();this.__oy();}
;};}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case f:case j:this.removeState(l);this.addState(g);e.stopPropagation();this.__ox();};}
,_onInterval:function(e){this.__ow=true;this.fireEvent(n);}
,__ox:function(){this.fireEvent(a);this.__ow=false;this.__dy.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.removeState(l);this.addState(g);}
,__oy:function(){this.fireEvent(d);this.__dy.stop();this.removeState(l);this.removeState(g);}
},destruct:function(){this._disposeObjects(k);}
});}
)();
(function(){var a="Integer",b="interval",c="qx.event.type.Event",d="qx.event.AcceleratingTimer",e="__dy";qx.Class.define(d,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__dy=new qx.event.Timer(this.getInterval());this.__dy.addListener(b,this._onInterval,this);}
,events:{"interval":c},properties:{interval:{check:a,init:100},firstInterval:{check:a,init:500},minimum:{check:a,init:20},decrease:{check:a,init:2}},members:{__dy:null,__oz:null,start:function(){this.__dy.setInterval(this.getFirstInterval());this.__dy.start();}
,stop:function(){this.__dy.stop();this.__oz=null;}
,_onInterval:function(){this.__dy.stop();if(this.__oz==null){this.__oz=this.getInterval();}
;this.__oz=Math.max(this.getMinimum(),this.__oz-this.getDecrease());this.__dy.setInterval(this.__oz);this.__dy.start();this.fireEvent(b);}
...
(function(){var a="' must be defined!",b="height",c="vAlign",d="hAlign",e="' is not supported by the Grid layout!",f="bottom",g="Invalid parameter 'column'",h="Integer",m="The property '",n="'",o="_applyLayoutChange",p="qx.debug",q="Value must be positive",r="center",s="qx.ui.layout.Grid",t="middle",u="maxHeight",v="Cannot add widget '",w="width",z=") for '",A="'!. ",B="top",C="minHeight",D="right",E="' in this cell (",F=", ",G="The layout properties 'row' and 'column' of the child widget '",H="minWidth",I="flex",J="left",K="maxWidth",L="Invalid parameter 'row'",M="There is already a widget '";qx.Class.define(s,{extend:qx.ui.layout.Abstract,construct:function(O,N){qx.ui.layout.Abstract.call(this);this.__po=[];this.__pp=[];if(O){this.setSpacingX(O);}
;if(N){this.setSpacingY(N);}
;}
,properties:{spacingX:{check:h,init:0,apply:o},spacingY:{check:h,init:0,apply:o}},members:{__pq:null,__po:null,__pp:null,__pr:null,__ps:null,__pt:null,__pu:null,__pv:null,__pw:null,verifyLayoutProperty:qx.core.Environment.select(p,{"true":function(P,name,Q){var R={"row":1,"column":1,"rowSpan":1,"colSpan":1};this.assert(R[name]==1,m+name+e);this.assertInteger(Q);this.assert(Q>=0,q);}
,"false":null}),__px:function(){var Y=[];var T=[];var W=[];var V=-1;var S=-1;var X=this._getLayoutChildren();for(var i=0,l=X.length;i<l;i++ ){var ba=X[i];var bb=ba.getLayoutProperties();var bc=bb.row;var U=bb.column;bb.colSpan=bb.colSpan||1;bb.rowSpan=bb.rowSpan||1;if(bc==null||U==null){throw new Error(G+ba+a);}
...
;}
;this.__pq=Y;this.__pr=T;this.__ps=W;this.__pt=V;this.__pu=S;this.__pv=null;this.__pw=null;delete this._invalidChildrenCache;}
,_setRowData:function(bg,be,bf){var bd=this.__po[bg];if(!bd){this.__po[bg]={};this.__po[bg][be]=bf;}
else {bd[be]=bf;}
;}
,_setColumnData:function(bh,bj,bk){var bi=this.__pp[bh];if(!bi){this.__pp[bh]={};this.__pp[bh][bj]=bk;}
else {bi[bj]=bk;}
;}
...
,getColumnAlign:function(bp){var bq=this.__pp[bp]||{};return {vAlign:bq.vAlign||B,hAlign:bq.hAlign||J};}
...
,getRowAlign:function(bv){var bu=this.__po[bv]||{};return {vAlign:bu.vAlign||B,hAlign:bu.hAlign||J};}
,getCellWidget:function(bx,bw){if(this._invalidChildrenCache){this.__px();}
;var bx=this.__pq[bx]||{};return bx[bw]||null;}
,getRowCount:function(){if(this._invalidChildrenCache){this.__px();}
;return this.__pt+1;}
,getColumnCount:function(){if(this._invalidChildrenCache){this.__px();}
;return this.__pu+1;}
,getCellAlign:function(bF,bz){var bE=B;var bC=J;var bD=this.__po[bF];var bA=this.__pp[bz];var by=this.__pq[bF][bz];if(by){var bB={vAlign:by.getAlignY(),hAlign:by.getAlignX()};}
else {bB={};}
...
,getColumnFlex:function(bI){var bJ=this.__pp[bI]||{};return bJ.flex!==undefined?bJ.flex:0;}
,setRowFlex:function(bL,bK){this._setRowData(bL,I,bK);this._applyLayoutChange();return this;}
,getRowFlex:function(bO){var bM=this.__po[bO]||{};var bN=bM.flex!==undefined?bM.flex:0;return bN;}
,setColumnMaxWidth:function(bP,bQ){this._setColumnData(bP,K,bQ);this._applyLayoutChange();return this;}
,getColumnMaxWidth:function(bR){var bS=this.__pp[bR]||{};return bS.maxWidth!==undefined?bS.maxWidth:Infinity;}
,setColumnWidth:function(bT,bU){this._setColumnData(bT,w,bU);this._applyLayoutChange();return this;}
,getColumnWidth:function(bV){var bW=this.__pp[bV]||{};return bW.width!==undefined?bW.width:null;}
,setColumnMinWidth:function(bX,bY){this._setColumnData(bX,H,bY);this._applyLayoutChange();return this;}
,getColumnMinWidth:function(ca){var cb=this.__pp[ca]||{};return cb.minWidth||0;}
,setRowMaxHeight:function(cd,cc){this._setRowData(cd,u,cc);this._applyLayoutChange();return this;}
,getRowMaxHeight:function(cf){var ce=this.__po[cf]||{};return ce.maxHeight||Infinity;}
,setRowHeight:function(cg,ch){this._setRowData(cg,b,ch);this._applyLayoutChange();return this;}
,getRowHeight:function(cj){var ci=this.__po[cj]||{};return ci.height!==undefined?ci.height:null;}
,setRowMinHeight:function(cl,ck){this._setRowData(cl,C,ck);this._applyLayoutChange();return this;}
,getRowMinHeight:function(cn){var cm=this.__po[cn]||{};return cm.minHeight||0;}
,__py:function(cp){var co=cp.getSizeHint();var cr=cp.getMarginLeft()+cp.getMarginRight();var cq=cp.getMarginTop()+cp.getMarginBottom();var cs={height:co.height+cq,width:co.width+cr,minHeight:co.minHeight+cq,minWidth:co.minWidth+cr,maxHeight:co.maxHeight+cq,maxWidth:co.maxWidth+cr};return cs;}
,_fixHeightsRowSpan:function(cN){var cz=this.getSpacingY();for(var i=0,l=this.__ps.length;i<l;i++ ){var cF=this.__ps[i];var cC=this.__py(cF);var cv=cF.getLayoutProperties();var cB=cv.row;var cK=cz*(cv.rowSpan-1);var ct=cK;var cw={};for(var j=0;j<cv.rowSpan;j++ ){var cA=cv.row+j;var cJ=cN[cA];var cL=this.getRowFlex(cA);if(cL>0){cw[cA]={min:cJ.minHeight,value:cJ.height,max:cJ.maxHeight,flex:cL};}
...
;}
;}
,_fixWidthsColSpan:function(cR){var cS=this.getSpacingX();for(var i=0,l=this.__pr.length;i<l;i++ ){var cO=this.__pr[i];var cQ=this.__py(cO);var cU=cO.getLayoutProperties();var cP=cU.column;var db=cS*(cU.colSpan-1);var cT=db;var cV={};var cX;for(var j=0;j<cU.colSpan;j++ ){var cW=cU.column+j;var da=cR[cW];var cY=this.getColumnFlex(cW);if(cY>0){cV[cW]={min:da.minWidth,value:da.width,max:da.maxWidth,flex:cY};}
...
;}
;}
,_getRowHeights:function(){if(this.__pv!=null){return this.__pv;}
;var dm=[];var df=this.__pt;var de=this.__pu;for(var dn=0;dn<=df;dn++ ){var dg=0;var di=0;var dh=0;for(var dl=0;dl<=de;dl++ ){var dd=this.__pq[dn][dl];if(!dd){continue;}
;var dj=dd.getLayoutProperties().rowSpan||0;if(dj>1){continue;}
;var dk=this.__py(dd);if(this.getRowFlex(dn)>0){dg=Math.max(dg,dk.minHeight);}
...
;if(this.__ps.length>0){this._fixHeightsRowSpan(dm);}
;this.__pv=dm;return dm;}
,_getColWidths:function(){if(this.__pw!=null){return this.__pw;}
;var dt=[];var dq=this.__pu;var ds=this.__pt;for(var dy=0;dy<=dq;dy++ ){var dw=0;var dv=0;var dr=Infinity;for(var dz=0;dz<=ds;dz++ ){var dp=this.__pq[dz][dy];if(!dp){continue;}
;var du=dp.getLayoutProperties().colSpan||0;if(du>1){continue;}
;var dx=this.__py(dp);dv=Math.max(dv,dx.minWidth);dw=Math.max(dw,dx.width);}
...
;if(this.__pr.length>0){this._fixWidthsColSpan(dt);}
;this.__pw=dt;return dt;}
...
,renderLayout:function(ej,dO,ei){if(this._invalidChildrenCache){this.__px();}
;var ed=qx.ui.layout.Util;var dQ=this.getSpacingX();var dW=this.getSpacingY();var eh=this._getColWidths();var ek=this._getColumnFlexOffsets(ej);var dR=[];var em=this.__pu;var dP=this.__pt;var el;for(var en=0;en<=em;en++ ){el=ek[en]?ek[en].offset:0;dR[en]=eh[en].width+el;}
...
;var er=0;for(var en=0;en<=em;en++ ){var top=0;for(var dX=0;dX<=dP;dX++ ){var ef=this.__pq[dX][en];if(!ef){top+=et[dX]+dW;continue;}
...
;er+=dR[en]+dQ;}
;}
,invalidateLayoutCache:function(){qx.ui.layout.Abstract.prototype.invalidateLayoutCache.call(this);this.__pw=null;this.__pv=null;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__px();}
...
},destruct:function(){this.__pq=this.__po=this.__pp=this.__pr=this.__ps=this.__pw=this.__pv=null;}
});}
)();
...
(function(){var a="resetPaddingRight",b="setPaddingTop",c="_applyContentPadding",d="setPaddingBottom",e="resetThemed",f="contentPaddingRight",g="Integer",h="contentPaddingLeft",i="setThemedPaddingLeft",j="resetPaddingTop",k="shorthand",l="setThemedPaddingRight",m="setThemed",n="setPaddingRight",o="contentPaddingBottom",p="resetPaddingBottom",q="qx.ui.core.MContentPadding",r="resetPaddingLeft",s="setThemedPaddingTop",t="setPaddingLeft",u="setThemedPaddingBottom",v="contentPaddingTop";qx.Mixin.define(q,{properties:{contentPaddingTop:{check:g,init:0,apply:c,themeable:true},contentPaddingRight:{check:g,init:0,apply:c,themeable:true},contentPaddingBottom:{check:g,init:0,apply:c,themeable:true},contentPaddingLeft:{check:g,init:0,apply:c,themeable:true},contentPadding:{group:[v,f,o,h],mode:k,themeable:true}},members:{__oR:{contentPaddingTop:b,contentPaddingRight:n,contentPaddingBottom:d,contentPaddingLeft:t},__oS:{contentPaddingTop:s,contentPaddingRight:l,contentPaddingBottom:u,contentPaddingLeft:i},__oT:{contentPaddingTop:j,contentPaddingRight:a,contentPaddingBottom:p,contentPaddingLeft:r},_applyContentPadding:function(z,w,name,y){var A=this._getContentPaddingTarget();if(z==null){var x=this.__oT[name];A[x]();}
else {if(y==m||y==e){var B=this.__oS[name];A[B](z);}
else {var B=this.__oR[name];A[B](z);}
;}
;}
}});}
)();
(function(){var a="Enter",b="_applyOpenMode",c="excluded",d="Space",f="Left",g="Boolean",h="changeOpenMode",j="_applyRootOpenClose",k="visible",l="changeSelection",m="qx.ui.tree.Tree",n="qx.event.type.Data",o="qx.ui.tree.core.AbstractTreeItem",p="tree",q="dbltap",r="_applyHideRoot",s="changeRoot",t="__rY",u="_applyRoot",v="keypress",w="none",x="pane",y="tap",z="Right";qx.Class.define(m,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__rY=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(x).add(this.__rY);this.initOpenMode();this.initRootOpenClose();this.addListener(l,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:n,removeItem:n},properties:{openMode:{check:[y,q,w],init:q,apply:b,event:h,themeable:true},root:{check:o,init:null,nullable:true,event:s,apply:u},hideRoot:{check:g,init:false,apply:r},rootOpenClose:{check:g,init:false,apply:j},appearance:{refine:true,init:p},focusable:{refine:true,init:true}},members:{__rY:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__rY;}
...
,_getContentPaddingTarget:function(){return this.__rY;}
...
;return null;}
,_applyOpenMode:function(be,bd){if(bd==y){this.removeListener(y,this._onOpen,this);}
else if(bd==q){this.removeListener(q,this._onOpen,this);}
;if(be==y){this.addListener(y,this._onOpen,this);}
...
;break;case z:if(bi.isOpenable()&&!bi.isOpen()){bi.setOpen(true);}
...
;if(this.getSelection()==null){this.__tW=new qx.data.Array();this.setSelection(this.__tW);}
;}
,properties:{selection:{check:b,event:f,apply:d,init:null}},events:{"changeSelection":h},members:{_modifingSelection:0,__tX:null,__tY:null,__tW:null,_applySelection:function(k,j){if(this.__tY!=undefined&&j!=undefined){j.removeListenerById(this.__tY);this.__tY=null;}
;if(k){this.__tY=k.addListener(a,this.__ua,this);}
;this._updateSelection();}
,__ua:function(){this._updateSelection();}
,_changeTargetSelection:function(){if(this.getTarget()==null){return;}
;if(!this.__ub()&&!this.__uc()){return;}
;if(this._inSelectionModification()){return;}
;var m=this.getTarget().getSelection();var l=this.getSelection();if(l==null){l=new qx.data.Array();this.__tW=l;this.setSelection(l);}
...
,_addChangeTargetListener:function(p,o){if(this.__tX!=undefined&&o!=undefined){o.removeListenerById(this.__tX);}
;if(p!=null){if(this.__ub()||this.__uc()){this.__tX=p.addListener(f,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()||!this.getSelection()){return;}
;this._startSelectionModification();if(this.__ub()){var s=[];for(var i=0;i<this.getSelection().length;i++ ){var t=this.getSelection().getItem(i);var u=this.__ue(t);if(u!=null){s.push(u);}
;}
...
;}
;}
else if(this.__uc()){var r=this.getSelection().getItem(this.getSelection().length-1);if(r!==undefined){this.__ud(r);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__ub:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.IMultiSelection);}
,__uc:function(){var w=this.getTarget().constructor;return qx.Class.implementsInterface(w,qx.ui.core.ISingleSelection);}
,__ud:function(x){var y=this.__ue(x);if(y==null){return;}
;if(this.__ub()){this.getTarget().addToSelection(y);}
else if(this.__uc()){this.getTarget().setSelection([y]);}
;}
,__ue:function(z){var A=this.getTarget().getSelectables(true);for(var i=0;i<A.length;i++ ){if(A[i].getModel()==z){return A[i];}
;}
;return null;}
...
},destruct:function(){if(this.__tW){this.__tW.dispose();}
;}
});}
)();
...
(function(){var a="changeModel",b="_applyDelegate",c="qx.core.Object",d="_applyLabelPath",f="icon",g="change",h="label",k="' twice.",l="_applyTarget",m="changeTarget",n="_applyIconPath",o="Can not reverse bind the same target property '",p="_applyLabelOptions",q="_applyChildPath",r="_applyIconOptions",s="qx.data.controller.Tree",t="String",u="Can not bind the same target property '",v="_applyModel",w="get";qx.Class.define(s,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(y,z,A,x){qx.core.Object.call(this);this.__bS={};this.__ug=[];this.__uv={};if(A!=null){this.setChildPath(A);}
;if(x!=null){this.setLabelPath(x);}
;if(y!=null){this.setModel(y);}
;if(z!=null){this.setTarget(z);}
;}
,properties:{model:{check:c,apply:v,event:a,nullable:true,dereference:true},target:{apply:l,event:m,init:null,nullable:true,dereference:true},childPath:{check:t,apply:q,nullable:true},labelPath:{check:t,apply:d,nullable:true},iconPath:{check:t,apply:n,nullable:true},labelOptions:{apply:p,nullable:true},iconOptions:{apply:r,nullable:true},delegate:{apply:b,init:null,nullable:true}},members:{__uv:null,__bS:null,__ug:null,__uw:null,_applyDelegate:function(C,B){this._setConfigureItem(C,B);this._setCreateItem(C,B);this._setBindItem(C,B);}
,_applyIconOptions:function(E,D){this.__us();}
,_applyLabelOptions:function(G,F){this.__us();}
,_applyTarget:function(I,H){if(H!=undefined){this.__uB(H);}
;if(this.getModel()!=null){this.__uz();}
;this._addChangeTargetListener(I,H);}
,_applyModel:function(K,J){this.__uz();}
,_applyChildPath:function(M,L){this.__uw=L;this.__uz();this.__uw=null;}
,_applyIconPath:function(O,N){this.__us();}
,_applyLabelPath:function(Q,P){this.__uz();}
,__ux:function(R){var T=R.getTarget();var S=this.__uv[T.toHashCode()].treeNode;var U=this.__uv[T.toHashCode()].modelNode;this.__uA(S,U);this._updateSelection();}
,__uy:function(e){var X=e.getData();var bc=e.getOldData();var V=this.__uv[bc.toHashCode()];bc.removeListenerById(V.changeListenerId);delete this.__uv[bc.toHashCode()];V.modelNode.removeListenerById(V.changeChildernListenerId);var bd=V.modelNode;var bb=qx.Class.getPropertyDefinition(V.modelNode.constructor,this.getChildPath());var Y=bb.event;var ba=bd.addListener(Y,this.__uy,this);var W=V.treeNode;this.__uv[X.toHashCode()]={modelNode:bd,treeNode:W,changeListenerId:V.changeListenerId,changeChildernListenerId:ba};this.__uA(W,bd);this._updateSelection();}
...
;return be;}
,__uz:function(){if(this.getTarget()==null||this.getChildPath()==null){return;}
...
;this.__uB();if(this.getModel()!=null){var bg=this._createItem();bg.setModel(this.getModel());this.__uE(this.getModel(),bg);this.__uA(bg,this.getModel());this.getTarget().setRoot(bg);}
;}
,__uA:function(bn,br){if(br[w+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;}
;var bj=br[w+qx.lang.String.firstUp(this.getChildPath())]();if(this.__uv[bj.toHashCode()]==undefined){var bl=bj.addListener(g,this.__ux,this);var bp=qx.Class.getPropertyDefinition(br.constructor,this.getChildPath());var bm=bp.event;var bq=br.addListener(bm,this.__uy,this);this.__uv[bj.toHashCode()]={modelNode:br,treeNode:bn,changeListenerId:bl,changeChildernListenerId:bq};}
...
;}
else {var bo=this._createItem();bo.setModel(bj.getItem(i));bn.addAt(bo,i);this.__uE(bj.getItem(i),bo);this.__uA(bo,bj.getItem(i));}
;}
;}
;for(var i=bn.getChildren().length-1;i>=bj.length;i-- ){var bk=bn.getChildren()[i];this.__uD(bk,bn);}
;}
,__uB:function(bt){if(bt==null){bt=this.getTarget();}
;if(bt==null){return;}
;var bv=bt.getRoot();if(bv!=null){bt.setRoot(null);this.__uC(bv);var bu=bv.getModel();if(bu){this.__uF(bu);}
;bv.destroy();this.__uv={};}
;}
,__uC:function(bw){var bx=bw.getChildren()||[];for(var i=bx.length-1;i>=0;i-- ){if(bx[i].getChildren().length>0){this.__uC(bx[i]);}
;this.__uD(bx[i],bw);}
;}
,__uD:function(bz,bC){var bD=bz.getModel();var by=this.__uw||this.getChildPath();var bA=w+qx.lang.String.firstUp(by);if(bD[bA]!=undefined){var bE=bD[bA]();var bB=this.__uv[bE.toHashCode()];bE.removeListenerById(bB.changeListenerId);bD.removeListenerById(bB.changeChildernListenerId);this.__uC(bz);delete this.__uv[bE.toHashCode()];}
;this.__uF(bD);bC.remove(bz);bz.destroy();}
,bindProperty:function(bG,bJ,bI,bF,bL){var bK=bL.bind(bG,bF,bJ,bI);if(this.__bS[bJ]==null){this.__bS[bJ]={};}
;var bH=this.__bS[bJ];if(bH[bL.toHashCode()]){if(bH[bL.toHashCode()].id){throw new Error(u+bJ+k);}
;bH[bL.toHashCode()].id=bK;}
else {bH[bL.toHashCode()]={id:bK,reverseId:null,treeNode:bF};}
;if(!qx.lang.Array.contains(this.__ug,bJ)){this.__ug.push(bJ);}
;}
,bindPropertyReverse:function(bQ,bM,bO,bP,bS){var bR=bP.bind(bM,bS,bQ,bO);if(this.__bS[bM]==null){this.__bS[bM]={};}
;var bN=this.__bS[bM];if(bN[bS.toHashCode()]){if(bN[bS.toHashCode()].reverseId){throw new Error(o+bQ+k);}
;bN[bS.toHashCode()].reverseId=bR;}
else {bN[bS.toHashCode()]={id:null,reverseId:bR,treeNode:bP};}
;if(!qx.lang.Array.contains(this.__ug,bM)){this.__ug.push(bM);}
;}
...
;}
,__us:function(){var bW;for(var ca in this.__bS){bW=ca;break;}
;for(var bX in this.__bS[bW]){var bV=this.__bS[bW][bX].treeNode;var bY=qx.core.ObjectRegistry.fromHashCode(bX);this.__uF(bY);this.__uE(bY,bV);}
;}
,__uE:function(cd,cb){var cc=this.getDelegate();if(cc!=null&&cc.bindItem!=null){cc.bindItem(this,cb,cd);}
else {this.bindDefaultProperties(cb,cd);}
;}
,__uF:function(cg){for(var i=0;i<this.__ug.length;i++ ){var ce=this.__ug[i];var cf=this.__bS[ce][cg.toHashCode()];if(cf!=null){if(cf.id){cg.removeBinding(cf.id);cf.id=null;}
;if(cf.reverseId){cf.treeNode.removeBinding(cf.reverseId);cf.reverseId=null;}
;delete this.__bS[ce][cg.toHashCode()];}
;}
;}
...
;this._startSelectionModification();this.__uB();this.__uz();this._endSelectionModification();this._updateSelection();}
,_setBindItem:function(cn,cm){if(cn!=null&&cn.bindItem!=null){if(cm!=null&&cm.bindItem!=null&&cn.bindItem==cm.bindItem){return;}
;this.__uz();}
;}
},destruct:function(){this.setTarget(null);this.setModel(null);this.__bS=this.__uv=this.__ug=null;}
});}
)();
...
(function(){var a="indexOf",b="addAfter",c="add",d="addBefore",e="_",f="addAt",g="hasChildren",h="removeAt",i="removeAll",j="getChildren",k="remove",l="qx.ui.core.MRemoteChildrenHandling";qx.Mixin.define(l,{members:{__op:function(q,m,o,n){var p=this.getChildrenContainer();if(p===this){q=e+q;}
;return (p[q])(m,o,n);}
,getChildren:function(){return this.__op(j);}
,hasChildren:function(){return this.__op(g);}
,add:function(s,r){return this.__op(c,s,r);}
,remove:function(t){return this.__op(k,t);}
,removeAll:function(){return this.__op(i);}
,indexOf:function(u){return this.__op(a,u);}
,addAt:function(x,v,w){this.__op(f,x,v,w);}
,addBefore:function(y,A,z){this.__op(d,y,A,z);}
,addAfter:function(D,B,C){this.__op(b,D,B,C);}
,removeAt:function(E){return this.__op(h,E);}
}});}
)();
(function(){var a="qx.ui.form.List",b="text",c="Boolean",d="one",f="addChildWidget",g="_applySpacing",h="Enter",j="Integer",k="action",m="keyinput",n="qx.event.type.Data",o="addItem",p="vertical",q="removeChildWidget",r="",s="_applyOrientation",t="single",u="keypress",v="list",w="__rY",x="horizontal",y="label",z="pane",A="removeItem";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__rY=this._createListItemContainer();this.__rY.addListener(f,this._onAddChild,this);this.__rY.addListener(q,this._onRemoveChild,this);this.getChildControl(z).add(this.__rY);if(B){this.setOrientation(x);}
else {this.initOrientation();}
;this.addListener(u,this._onKeyPress);this.addListener(m,this._onKeyInput);this.__tO=r;}
,events:{addItem:n,removeItem:n},properties:{appearance:{refine:true,init:v},focusable:{refine:true,init:true},orientation:{check:[x,p],init:p,apply:s},spacing:{check:j,init:0,apply:g,themeable:true},enableInlineFind:{check:c,init:true}},members:{__tO:null,__tP:null,__rY:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__rY;}
...
,_applyOrientation:function(F,C){var D=F===x;var E=D?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__rY;content.setLayout(E);content.setAllowGrowX(!D);content.setAllowGrowY(D);this._applySpacing(this.getSpacing());}
,_applySpacing:function(H,G){this.__rY.getLayout().setSpacing(H);}
...
;if(((new Date).valueOf()-this.__tP)>1000){this.__tO=r;}
;this.__tO+=e.getChar();var K=this.findItemByLabelFuzzy(this.__tO);if(K){this.setSelection([K]);}
;this.__tP=(new Date).valueOf();}
...
(function(){var a="changeModel",b="_applyLabelOptions",c="_applyLabelPath",d="changeTarget",e="_applyModel",f="change",g="icon",h="ReverseBindingId",k="qx.data.controller.List",m="_applyIconPath",n="BindingId",o="_applyDelegate",p="",q="changeDelegate",r="_applyTarget",s="]",t="qx.data.IListData",u="model[",v="model",w="label",x="String",y="_applyIconOptions",z=".";qx.Class.define(k,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__uf=[];this.__ug=[];this.__uh=[];this.__ui={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:t,apply:e,event:a,nullable:true,dereference:true},target:{apply:r,event:d,nullable:true,init:null,dereference:true},labelPath:{check:x,apply:c,nullable:true},iconPath:{check:x,apply:m,nullable:true},labelOptions:{apply:b,nullable:true},iconOptions:{apply:y,nullable:true},delegate:{apply:o,event:q,init:null,nullable:true}},members:{__uj:null,__uf:null,__ui:null,__ug:null,__uh:null,__uk:null,__ul:null,update:function(){this.__uo();this.__us();this._updateSelection();}
,_applyDelegate:function(E,D){this._setConfigureItem(E,D);this._setFilter(E,D);this._setCreateItem(E,D);this._setBindItem(E,D);}
,_applyIconOptions:function(G,F){this.__us();}
,_applyLabelOptions:function(I,H){this.__us();}
,_applyIconPath:function(K,J){this.__us();}
,_applyLabelPath:function(M,L){this.__us();}
,_applyModel:function(P,N){if(N!=undefined){if(this.__uj!=undefined){N.removeListenerById(this.__uj);}
;}
;if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length).dispose();}
;if(P!=null){this.__uj=P.addListener(f,this.__un,this);this.__uu();this.__uo();if(N==null){this._changeTargetSelection();}
else {this.__uk=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var O=this.getTarget();if(O!=null){var length=O.getChildren().length;for(var i=0;i<length;i++ ){this.__ur();}
;}
;}
;}
...
;if(S!=null){if(this.getModel()!=null){for(var i=0;i<this.__uf.length;i++ ){this.__uq(this.__jG(i));}
;}
;}
;}
,__um:false,__un:function(){if(this.__um){return;}
;this.__um=true;this.__ul=true;qx.ui.core.queue.Widget.add(this);this.update();this.__um=false;}
,syncWidget:function(){if(this.__uk){this._changeTargetSelection();}
;if(this.__ul){this._updateSelection();}
;this.__ul=this.__uk=null;}
,__uo:function(){if(this.getTarget()==null){return;}
;this.__uu();var U=this.__uf.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++ ){this.__uq(this.__jG(j));}
;}
else if(U<T){for(var j=T;j>U;j-- ){this.__ur();}
;}
;this.__uu();this.__uk=true;qx.ui.core.queue.Widget.add(this);}
,__up:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__uj);this.__uj=V.addListener(f,this.__un,this);}
;}
...
;return W;}
,__uq:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__ur:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bo,br,bp,bn,bm){if(bp!=null){var bp=qx.lang.Object.clone(bp);this.__ui[br]=bp.onUpdate;delete bp.onUpdate;}
else {bp={};this.__ui[br]=null;}
;bp.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bm);bp.ignoreConverter=v;var bq=u+bm+s;if(bo!=null&&bo!=p){bq+=z+bo;}
;var bs=this.bind(bq,bn,br,bp);bn.setUserData(br+n,bs);if(!qx.lang.Array.contains(this.__ug,br)){this.__ug.push(br);}
;}
,bindPropertyReverse:function(by,bv,bw,bx,bt){var bu=u+bt+s;if(by!=null&&by!=p){bu+=z+by;}
;var bz=bx.bind(bv,this,bu,bw);bx.setUserData(by+h,bz);if(!qx.lang.Array.contains(this.__uh,by)){this.__uh.push(by);}
;}
,_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;}
;for(var i=0;i<this.__ug.length;i++ ){if(this.__ui[this.__ug[i]]!=null){this.__ui[this.__ug[i]]();}
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__ug.length;i++ ){var bE=bD.getUserData(this.__ug[i]+n);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__uh.length;i++ ){var bE=bD.getUserData(this.__uh[i]+h);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__us:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++ ){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__jG(i));}
;this.__up();}
...
,_setFilter:function(bR,bP){if((bR==null||bR.filter==null)&&(bP!=null&&bP.filter!=null)){this.__ut();}
...
;var bQ=this.__uf;this.__uu();if(bQ.length>this.__uf.length){for(var j=bQ.length;j>this.__uf.length;j-- ){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bQ.length<this.__uf.length){for(var j=bQ.length;j<this.__uf.length;j++ ){var bT=this._createItem();this.getTarget().add(bT);}
;}
;var bS=this.getTarget().getChildren();for(var i=0;i<bS.length;i++ ){this._bindListItem(bS[i],this.__jG(i));}
;this.__up();this._endSelectionModification();this._updateSelection();}
,__ut:function(){this.__uu();this.__uo();this.__us();this.__ul=true;qx.ui.core.queue.Widget.add(this);}
,__uu:function(){var bW=this.getModel();if(bW==null){return;}
;var bX=this.getDelegate();if(bX!=null){var bV=bX.filter;}
;this.__uf=[];for(var i=0;i<bW.getLength();i++ ){if(bV==null||bV(bW.getItem(i))){this.__uf.push(i);}
;}
;}
,__jG:function(bY){return this.__uf[bY];}
},destruct:function(){this.__uf=this.__ui=this.__ug=null;this.__uh=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
...
;return Y+ba;}
,escapeHTML:function(bd){return String(bd).replace(/[<>&"']/g,this.__mR);}
,__mR:function(bf){var be={"<":m,">":e,"&":s,"'":t,'"':D};return be[bf]||L;}
...
,clear:function(){this.__cA.innerHTML=x;}
,process:function(bd){this.__cA.appendChild(qx.log.appender.Util.toHtml(bd));this.__mV();}
,__mV:function(){this.__cA.scrollTop=this.__cA.scrollHeight;}
,__gX:true,toggle:function(){if(!this.__mS){this.init();}
else if(this.__mS.style.display==p){this.show();}
else {this.__mS.style.display=p;}
;}
,show:function(){if(!this.__mS){this.init();}
else {this.__mS.style.display=P;this.__cA.scrollTop=this.__cA.scrollHeight;}
;}
,__mW:[],execute:function(){var bf=this.__mT.value;if(bf==x){return;}
;if(bf==F){this.clear();return;}
;var be=document.createElement(j);be.innerHTML=qx.log.appender.Util.escapeHTML(V+bf);be.className=k;this.__mW.push(bf);this.__mU=this.__mW.length;this.__cA.appendChild(be);this.__mV();try{var bg=window.eval(bf);}
catch(bh){qx.log.Logger.error(bh);}
;if(bg!==undefined){qx.log.Logger.debug(bg);}
;}
,__mX:function(e){this.__cA.style.height=(this.__mS.clientHeight-this.__mS.firstChild.offsetHeight-this.__mS.lastChild.offsetHeight)+c;}
...
;if(!this.__mS){return;}
;if(!qx.dom.Hierarchy.contains(this.__mS,e.getTarget())){return;}
;if(bj==b&&this.__mT.value!=x){this.execute();this.__mT.value=x;}
;if(bj==m||bj==W){this.__mU+=bj==m?-1:1;this.__mU=Math.min(Math.max(0,this.__mU),this.__mW.length);var bi=this.__mW[this.__mU];this.__mT.value=bi||x;this.__mT.select();}
;}
