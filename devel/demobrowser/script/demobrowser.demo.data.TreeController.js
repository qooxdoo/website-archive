...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.TreeController.9e5cf5060536.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
;}
,__ug:false,__uh:function(){if(this.__ug)return;this.__ug=true;this.__uf=true;qx.ui.core.queue.Widget.add(this);this.update();this.__ug=false;}
