...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.HeightForWidth.92277239c81a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Abstract method call",b="abstract",c="*",d="",e="-webkit-tap-highlight-color: transparent;",f="-ms-touch-select: none;",g="qx.application.AbstractGui",h="-webkit-touch-callout: none;",i="-webkit-tap-highlight-color: rgba(0,0,0,0);";qx.Class.define(g,{type:b,extend:qx.core.Object,implement:[qx.application.IApplication],include:qx.locale.MTranslation,members:{__dW:null,_createRootWidget:function(){throw new Error(a);}
,getRoot:function(){return this.__dW;}
,main:function(){qx.theme.manager.Meta.getInstance().initialize();qx.ui.tooltip.Manager.getInstance();var j=[h,f,i,e].join(d);qx.ui.style.Stylesheet.getInstance().addRule(c,j);this.__dW=this._createRootWidget();window.scrollTo(0,0);}
...
(function(){var a="qx.ui.tooltip.ToolTip",b="Boolean",c="",d="mouse",f="pointerover",g="interval",h="__dX",i="_applyCurrent",j="widget",k="qx.ui.tooltip.Manager",l="pointermove",m="__eb",n="focusout",o="__dY",p="tooltip-error",q="singleton",r="pointerout";qx.Class.define(k,{type:q,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);qx.event.Registration.addListener(document.body,f,this.__eg,this,true);this.__dX=new qx.event.Timer();this.__dX.addListener(g,this.__ed,this);this.__dY=new qx.event.Timer();this.__dY.addListener(g,this.__ee,this);this.__ea={left:0,top:0};}
,properties:{current:{check:a,nullable:true,apply:i},showInvalidToolTips:{check:b,init:true},showToolTips:{check:b,init:true}},members:{__ea:null,__dY:null,__dX:null,__eb:null,__ec:null,getSharedTooltip:function(){if(!this.__eb){this.__eb=new qx.ui.tooltip.ToolTip().set({rich:true});}
;return this.__eb;}
,getSharedErrorTooltip:function(){if(!this.__ec){this.__ec=new qx.ui.tooltip.ToolTip().set({appearance:p,rich:true});this.__ec.setLabel(c);this.__ec.syncAppearance();}
;return this.__ec;}
,_applyCurrent:function(u,t){if(t&&qx.ui.core.Widget.contains(t,u)){return;}
;if(t){if(!t.isDisposed()){t.exclude();}
;this.__dX.stop();this.__dY.stop();}
;var v=qx.event.Registration;var s=document.body;if(u){this.__dX.startWith(u.getShowTimeout());v.addListener(s,r,this.__eh,this,true);v.addListener(s,n,this.__ei,this,true);v.addListener(s,l,this.__ef,this,true);}
else {v.removeListener(s,r,this.__eh,this,true);v.removeListener(s,n,this.__ei,this,true);v.removeListener(s,l,this.__ef,this,true);}
;}
,__ed:function(e){var w=this.getCurrent();if(w&&!w.isDisposed()){this.__dY.startWith(w.getHideTimeout());if(w.getPlaceMethod()==j){w.placeToWidget(w.getOpener());}
else {w.placeToPoint(this.__ea);}
;w.show();}
;this.__dX.stop();}
,__ee:function(e){var x=this.getCurrent();if(x&&!x.getAutoHide()){return;}
;if(x&&!x.isDisposed()){x.exclude();}
;this.__dY.stop();this.resetCurrent();}
,__ef:function(e){var y=this.__ea;y.left=Math.round(e.getDocumentLeft());y.top=Math.round(e.getDocumentTop());}
,__eg:function(e){var z=qx.ui.core.Widget.getWidgetByElement(e.getTarget());this.__ef(e);this.showToolTip(z);}
...
,__eh:function(e){var F=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!F){return;}
...
;if(H&&!H.getAutoHide()){return;}
;if(H&&!G){this.setCurrent(null);}
else {this.resetCurrent();}
;}
,__ei:function(e){var I=qx.ui.core.Widget.getWidgetByElement(e.getTarget());if(!I){return;}
;var J=this.getCurrent();if(J&&!J.getAutoHide()){return;}
;if(J&&J==I.getToolTip()){this.setCurrent(null);}
;}
},destruct:function(){qx.event.Registration.removeListener(document.body,f,this.__eg,this,true);this._disposeObjects(h,o,m);this.__ea=null;}
});}
)();
...
;this.__mL=y;this.__gS=B;delete this._invalidChildrenCache;}
...
;var K=this.__gS;var length=K.length;var W=qx.ui.layout.Util;var S=this.getSpacing();var Y=this.getSeparator();if(Y){var H=W.computeHorizontalSeparatorGaps(K,S,Y);}
...
;var bs=qx.ui.layout.Util;var bf=this.__gS;var bk=0,bl=0,be=0;var bi=0,bj=0;var bp,bg,br;for(var i=0,l=bf.length;i<l;i+=1){bp=bf[i];bg=bp.getSizeHint();bl+=bg.width;var bo=this.__mK[i];var bh=this.__mJ[i];if(bo){bk+=bg.minWidth;}
...
},destruct:function(){this.__mJ=this.__mK=this.__gS=null;}
});}
)();
...
(function(){var a="qx.ui.form.IField",b="qx.event.type.Data";qx.Interface.define(a,{events:{"changeValue":b},members:{setValue:function(c){return arguments.length==1;}
,resetValue:function(){}
,getValue:function(){}
}});}
)();
(function(){var a="qx.event.type.Data",b="qx.ui.form.IStringForm";qx.Interface.define(b,{extend:qx.ui.form.IField,events:{"changeValue":a},members:{setValue:function(c){return arguments.length==1;}
,resetValue:function(){}
,getValue:function(){}
}});}
)();
...
(function(){var a="_applyActiveWindow",b="changeModal",c="windowAdded",d="changeVisibility",f="__dt",g="windowRemoved",h="qx.ui.window.Window",i="__mU",j="changeActive",k="qx.ui.window.MDesktop",l="changeActiveWindow",m="qx.event.type.Data";qx.Mixin.define(k,{properties:{activeWindow:{check:h,apply:a,event:l,init:null,nullable:true}},events:{windowAdded:m,windowRemoved:m},members:{__mU:null,__dt:null,getWindowManager:function(){if(!this.__dt){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());}
;return this.__dt;}
,supportsMaximize:function(){return true;}
,setWindowManager:function(n){if(this.__dt){this.__dt.setDesktop(null);}
;n.setDesktop(this);this.__dt=n;}
...
;}
,_addWindow:function(r){if(!this.getWindows().includes(r)){this.getWindows().push(r);this.fireDataEvent(c,r);r.addListener(j,this._onChangeActive,this);r.addListener(b,this._onChangeModal,this);r.addListener(d,this._onChangeVisibility,this);}
...
;}
,_removeWindow:function(t){if(this.getWindows().includes(t)){qx.lang.Array.remove(this.getWindows(),t);this.fireDataEvent(g,t);t.removeListener(j,this._onChangeActive,this);t.removeListener(b,this._onChangeModal,this);t.removeListener(d,this._onChangeVisibility,this);this.getWindowManager().updateStack();}
;}
,getWindows:function(){if(!this.__mU){this.__mU=[];}
;return this.__mU;}
},destruct:function(){this._disposeArray(i);this._disposeObjects(f);}
});}
)();
...
(function(){var a="qx.dyntheme",b="backgroundColor",c="_applyOpacity",d="Boolean",f="px",g="keydown",h="deactivate",j="changeTheme",k="opacity",l="__mV",m="Tab",n="qx.event.type.Event",o="move",p="Color",q="resize",r="zIndex",s="appear",t="__ey",u="qx.ui.root.Abstract",v="keyup",w="keypress",x="Number",y="unblocked",z="qx.ui.core.Blocker",A="disappear",B="blocked",C="_applyColor";qx.Class.define(z,{extend:qx.core.Object,events:{blocked:n,unblocked:n},construct:function(D){qx.core.Object.call(this);this._widget=D;D.addListener(q,this.__nb,this);D.addListener(o,this.__nb,this);D.addListener(A,this.__nd,this);if(qx.Class.isDefined(u)&&D instanceof qx.ui.root.Abstract){this._isRoot=true;this.setKeepBlockerActive(true);}
;if(qx.core.Environment.get(a)){qx.theme.manager.Meta.getInstance().addListener(j,this._onChangeTheme,this);}
;this.__mW=[];this.__mX=[];}
,properties:{color:{check:p,init:null,nullable:true,apply:C,themeable:true},opacity:{check:x,init:1,apply:c,themeable:true},keepBlockerActive:{check:d,init:false}},members:{__mV:null,__mY:0,__mW:null,__mX:null,__ey:null,_widget:null,_isRoot:false,__na:null,__nb:function(e){var E=e.getData();if(this.isBlocked()){this._updateBlockerBounds(E);}
;}
,__nc:function(){this._updateBlockerBounds(this._widget.getBounds());if(this._widget.isRootWidget()){this._widget.getContentElement().add(this.getBlockerElement());}
else {this._widget.getLayoutParent().getContentElement().add(this.getBlockerElement());}
;}
,__nd:function(){if(this.isBlocked()){this.getBlockerElement().getParent().remove(this.getBlockerElement());this._widget.addListenerOnce(s,this.__nc,this);}
;}
...
,_applyColor:function(I,H){var G=qx.theme.manager.Color.getInstance().resolve(I);this.__ne(b,G);}
,_applyOpacity:function(K,J){this.__ne(k,K);}
,_onChangeTheme:qx.core.Environment.select(a,{"true":function(){this._applyColor(this.getColor());}
,"false":null}),__ne:function(M,N){var L=[];this.__mV&&L.push(this.__mV);for(var i=0;i<L.length;i++ ){L[i].setStyle(M,N);}
;}
...
;}
;}
,__nf:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());}
,getBlockerElement:function(S){if(!this.__mV){this.__mV=this.__nf();this.__mV.setStyle(r,15);if(!S){if(this._isRoot){S=this._widget;}
else {S=this._widget.getLayoutParent();}
;}
;S.getContentElement().add(this.__mV);this.__mV.exclude();}
;return this.__mV;}
,block:function(){this._block();}
,_block:function(T,V){if(!this._isRoot&&!this._widget.getLayoutParent()){this.__na=this._widget.addListenerOnce(s,this._block.bind(this,T));return;}
...
;U.addListener(h,this.__ni,this);U.addListener(w,this.__nh,this);U.addListener(g,this.__nh,this);U.addListener(v,this.__nh,this);this.fireEvent(B,qx.event.type.Event);}
;}
,isBlocked:function(){return this.__mY>0;}
,unblock:function(){if(this.__na){this._widget.removeListenerById(this.__na);}
;if(!this.isBlocked()){return;}
;this.__mY-- ;if(this.__mY<1){this.__ng();this.__mY=0;}
;}
,forceUnblock:function(){if(!this.isBlocked()){return;}
;this.__mY=0;this.__ng();}
,__ng:function(){this._restoreActiveWidget();var X=this.getBlockerElement();X.removeListener(h,this.__ni,this);X.removeListener(w,this.__nh,this);X.removeListener(g,this.__nh,this);X.removeListener(v,this.__nh,this);X.exclude();this.fireEvent(y,qx.event.type.Event);}
,blockContent:function(Y){this._block(Y,true);}
,__nh:function(e){if(e.getKeyIdentifier()==m){e.stop();}
;}
,__ni:function(){if(this.getKeepBlockerActive()&&!qx.ui.core.FocusHandler.getInstance().isFocusRoot(this._widget)){this.getBlockerElement().activate();}
;}
...
;this._widget.removeListener(q,this.__nb,this);this._widget.removeListener(o,this.__nb,this);this._widget.removeListener(s,this.__nc,this);this._widget.removeListener(A,this.__nd,this);if(this.__na){this._widget.removeListenerById(this.__na);}
;this._disposeObjects(l,t);this.__mW=this.__mX=this._widget=null;}
});}
)();
...
,members:{__nj:null,__nk:null,__nl:null,__nm:null,connectTo:function(m){m.addListener(a,this.__kI,this);m.addListener(j,this._onFocusIn,this,true);m.addListener(b,this._onFocusOut,this,true);m.addListener(c,this._onActivate,this,true);m.addListener(h,this._onDeactivate,this,true);}
...
;}
,__kI:function(e){if(e.getKeyIdentifier()!=f){return;}
;if(!this.__nm){return;}
...
;e.preventDefault();}
,__nz:function(e){if(e.getKeyIdentifier()!==d){return;}
...
;}
,_computeSizeHint:function(){var H=qx.bom.Viewport.getWidth(this.__ct);var I=qx.bom.Viewport.getHeight(this.__ct);return {minWidth:H,width:H,maxWidth:H,minHeight:I,height:I,maxHeight:I};}
...
},destruct:function(){this.__ct=this.__nA=null;}
});}
)();
...
;this.__mL=x;this.__gS=B;delete this._invalidChildrenCache;}
...
;var K=this.__gS;var length=K.length;var U=qx.ui.layout.Util;var T=this.getSpacing();var bb=this.getSeparator();if(bb){var H=U.computeVerticalSeparatorGaps(K,T,bb);}
...
;}
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__mM();}
;var be=qx.ui.layout.Util;var bs=this.__gS;var bh=0,bi=0,bq=0;var bj=0,bk=0;var bo,bf,br;for(var i=0,l=bs.length;i<l;i+=1){bo=bs[i];bf=bo.getSizeHint();bi+=bf.height;var bn=this.__mK[i];var bg=this.__oI[i];if(bn){bh+=bf.minHeight;}
...
},destruct:function(){this.__oI=this.__mK=this.__gS=null;}
});}
)();
