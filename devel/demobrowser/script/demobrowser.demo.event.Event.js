...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event.ac0e44324674.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__o=f+p.join(c)+a;this.__p=o||50;this.__q=n;this._clearLog();}
,_clearLog:function(){this.__q.innerHTML=this.__o+k;this.__r=[];}
,_log:function(q){this.__r.unshift(q);this.__r=this.__r.slice(0,this.__p);var r=[this.__o];for(var i=0;i<this.__r.length;i++ ){r.push(g,this.__r[i].join(e),l);}
;r.push(k);this.__q.innerHTML=r.join(d);this.__q.scrollTop=0;}
,__o:null,__p:null,__q:null,__r:null},destruct:function(){this.__q=this.__r=null;}
});}
)();
