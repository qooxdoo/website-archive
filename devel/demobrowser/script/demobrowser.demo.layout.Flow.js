...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow.e676c35d421b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="No more lines to compute",b="qx.ui.layout.LineSizeIterator";qx.Class.define(b,{extend:Object,construct:function(d,c){this.__gz=d;this.__ym=c;this.__yn=d.length>0;this.__yo=0;}
,members:{__gz:null,__ym:null,__yn:null,__yo:null,computeNextLine:function(k){var k=k||Infinity;if(!this.__yn){throw new Error(a);}
;var p=this.__gz;var n=0;var f=0;var o=[];var j=[];for(var i=this.__yo;i<p.length;i++ ){var m=p[i];var q=m.getSizeHint();var g=this.__yp(i);var h=q.width+g;var e=i==this.__yo;if(!e&&f+h>k){this.__yo=i;break;}
...
,__yp:function(r){var s=r==this.__yo;if(s){return this.__gz[r].getMarginLeft();}
else {return Math.max(this.__gz[r-1].getMarginRight(),this.__gz[r].getMarginLeft(),this.__ym);}
;}
