...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow.fce6b9c2ccfd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="No more lines to compute",b="qx.ui.layout.LineSizeIterator";qx.Class.define(b,{extend:Object,construct:function(d,c){this.__ho=d;this.__yg=c;this.__yh=d.length>0;this.__yi=0;}
,members:{__ho:null,__yg:null,__yh:null,__yi:null,computeNextLine:function(k){var k=k||Infinity;if(!this.__yh){throw new Error(a);}
;var p=this.__ho;var n=0;var f=0;var o=[];var j=[];for(var i=this.__yi;i<p.length;i++ ){var m=p[i];var q=m.getSizeHint();var g=this.__yj(i);var h=q.width+g;var e=i==this.__yi;if(!e&&f+h>k){this.__yi=i;break;}
...
,__yj:function(r){var s=r==this.__yi;if(s){return this.__ho[r].getMarginLeft();}
else {return Math.max(this.__ho[r-1].getMarginRight(),this.__ho[r].getMarginLeft(),this.__yg);}
;}
