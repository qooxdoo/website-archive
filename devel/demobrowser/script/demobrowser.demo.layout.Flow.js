...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Flow.dfd0015892be.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="No more lines to compute",b="qx.ui.layout.LineSizeIterator";qx.Class.define(b,{extend:Object,construct:function(d,c){this.__hm=d;this.__yd=c;this.__ye=d.length>0;this.__yf=0;}
,members:{__hm:null,__yd:null,__ye:null,__yf:null,computeNextLine:function(k){var k=k||Infinity;if(!this.__ye){throw new Error(a);}
;var p=this.__hm;var n=0;var f=0;var o=[];var j=[];for(var i=this.__yf;i<p.length;i++ ){var m=p[i];var q=m.getSizeHint();var g=this.__yg(i);var h=q.width+g;var e=i==this.__yf;if(!e&&f+h>k){this.__yf=i;break;}
...
,__yg:function(r){var s=r==this.__yf;if(s){return this.__hm[r].getMarginLeft();}
else {return Math.max(this.__hm[r-1].getMarginRight(),this.__hm[r].getMarginLeft(),this.__yd);}
;}
