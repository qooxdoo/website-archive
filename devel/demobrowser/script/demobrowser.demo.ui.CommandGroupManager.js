...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.b453eaa129d7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__vG:null,__Br:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
...
;}
;if(this.getActive()===m){this.__Br=null;}
...
;return false;}
;for(var i=0;i<this.__vG.length;i++ ){var n=this.__vG[i];if(n==o){n.setActive(true);this.__Br=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__Br;}
,block:function(){if(this.__Br){this.__Br.setActive(false);}
;}
,unblock:function(){if(this.__Br){this.__Br.setActive(true);}
;}
,_getGroup:function(q){var p=this.__vG.indexOf(q);if(p===-1){return null;}
;return this.__vG[p];}
},destruct:function(){this.__vG=this.__Br=null;}
});}
)();
