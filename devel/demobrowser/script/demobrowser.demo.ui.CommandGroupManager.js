...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.40c4401f379c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,members:{__vB:null,__Bn:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
...
;}
;if(this.getActive()===m){this.__Bn=null;}
...
;return false;}
;for(var i=0;i<this.__vB.length;i++ ){var n=this.__vB[i];if(n==o){n.setActive(true);this.__Bn=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__Bn;}
,block:function(){if(this.__Bn){this.__Bn.setActive(false);}
;}
,unblock:function(){if(this.__Bn){this.__Bn.setActive(true);}
;}
,_getGroup:function(q){var p=this.__vB.indexOf(q);if(p===-1){return null;}
;return this.__vB[p];}
},destruct:function(){this.__vB=this.__Bn=null;}
});}
)();
