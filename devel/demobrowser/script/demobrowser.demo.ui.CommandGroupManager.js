...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.6f3013819340.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.ui.command.GroupManager",b="Group must be an instance of qx.ui.command.Group",c="qx.debug",d="Group was not added before. Please use ",e="'add()' method to add the group.",f="Given group is not an instance of qx.ui.command.Group",g="Group was not added before! You have to use 'addCommand()' method before activating!",h="Group is already added!";qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__un=[];}
,members:{__un:null,__zk:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
;if(qx.lang.Array.contains(this.__un,j)){if(qx.core.Environment.get(c)){this.debug(h);}
;return false;}
;this.__un.push(j);j.setActive(false);return true;}
...
;var l=this.__un.indexOf(m);if(l===-1){if(qx.core.Environment.get(c)){this.debug(d+e);}
;}
;if(this.getActive()===m){this.__zk=null;}
;this.__un.splice(l,1);return m;}
...
;return false;}
;for(var i=0;i<this.__un.length;i++ ){var n=this.__un[i];if(n==o){n.setActive(true);this.__zk=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__zk;}
,block:function(){if(this.__zk){this.__zk.setActive(false);}
;}
,unblock:function(){if(this.__zk){this.__zk.setActive(true);}
;}
,_getGroup:function(q){var p=this.__un.indexOf(q);if(p===-1){return null;}
;return this.__un[p];}
},destruct:function(){this.__un=this.__zk=null;}
});}
)();
