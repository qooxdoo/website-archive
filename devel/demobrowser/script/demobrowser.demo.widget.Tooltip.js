...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.57ef13f68625.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Rr:4,__Rs:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Rs/this.__Rr),column:this.__Rs%this.__Rr});this.__Rs+=1;}
