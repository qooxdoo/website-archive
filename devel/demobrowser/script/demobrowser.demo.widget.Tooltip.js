...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.fe47be480b44.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__bQ:4,__bR:0,add:function(B){this.container.add(B,{row:Math.floor(this.__bR/this.__bQ),column:this.__bR%this.__bQ});this.__bR+=1;}
