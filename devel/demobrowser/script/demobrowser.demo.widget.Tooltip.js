...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.1cefd17ed7c8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__vf:4,__vg:0,add:function(B){this.container.add(B,{row:Math.floor(this.__vg/this.__vf),column:this.__vg%this.__vf});this.__vg+=1;}
