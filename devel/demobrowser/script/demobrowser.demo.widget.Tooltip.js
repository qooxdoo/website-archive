...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.6c3a7544ae5a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__bF:4,__bG:0,add:function(B){this.container.add(B,{row:Math.floor(this.__bG/this.__bF),column:this.__bG%this.__bF});this.__bG+=1;}
