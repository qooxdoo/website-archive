...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.af70ff6c13e8.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__uS:4,__uT:0,add:function(B){this.container.add(B,{row:Math.floor(this.__uT/this.__uS),column:this.__uT%this.__uS});this.__uT+=1;}
