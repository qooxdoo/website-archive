...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.28ca61874ceb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__BV:4,__BW:0,add:function(B){this.container.add(B,{row:Math.floor(this.__BW/this.__BV),column:this.__BW%this.__BV});this.__BW+=1;}
