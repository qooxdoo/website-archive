...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.6c7853652851.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__bS:4,__bT:0,add:function(B){this.container.add(B,{row:Math.floor(this.__bT/this.__bS),column:this.__bT%this.__bS});this.__bT+=1;}
