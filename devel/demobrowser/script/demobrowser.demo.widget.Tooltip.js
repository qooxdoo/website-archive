...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.db45228aab22.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__GP:4,__GQ:0,add:function(B){this.container.add(B,{row:Math.floor(this.__GQ/this.__GP),column:this.__GQ%this.__GP});this.__GQ+=1;}
