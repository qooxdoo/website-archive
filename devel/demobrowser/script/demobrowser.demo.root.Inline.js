...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline.ec3040e93549.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__yE=v;v.style.overflow=o;v.style.textAlign=q;this.__yF=w||false;this.__yG=u||false;this.__yH();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__yF:false,__yG:false,__yE:null,__yH:function(){if(this.__yF||this.__yG){var x=qx.bom.element.Dimension.getSize(this.__yE);if(this.__yF&&x.width<1){throw new Error(r+this.__yE+s+this+k);}
;if(this.__yG){if(x.height<1){throw new Error(r+this.__yE+s+this+g);}
;if(x.height>=1&&qx.bom.element.Style.get(this.__yE,j,3)==f){qx.bom.element.Style.set(this.__yE,j,x.height+h);}
;}
;qx.event.Registration.addListener(this.__yE,a,this._onResize,this);}
;}
,_createContentElement:function(){var y=this.__yE;if(this.__yF||this.__yG){var A=document.createElement(p);y.appendChild(A);}
else {A=y;}
;var z=new qx.html.Root(A);A.style.position=d;z.connectWidget(this);qx.event.Timer.once(function(e){this.fireEvent(n);}
,this,0);return z;}
,_onResize:function(e){var B=e.getData();if((B.oldWidth!==B.width)&&this.__yF||(B.oldHeight!==B.height)&&this.__yG){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var G=this.__yF;var D=this.__yG;if(!G||!D){var C=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {C={};}
;var H=qx.bom.element.Dimension;if(G){var F=H.getContentWidth(this.__yE);C.width=F;C.minWidth=F;C.maxWidth=F;}
;if(D){var E=H.getContentHeight(this.__yE);C.height=E;C.minHeight=E;C.maxHeight=E;}
;return C;}
