...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline.c645ac8e8074.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__tY=v;v.style.overflow=o;v.style.textAlign=q;this.__ua=w||false;this.__ub=u||false;this.__uc();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==b)){this.setKeepFocus(true);}
...
,members:{__ua:false,__ub:false,__tY:null,__uc:function(){if(this.__ua||this.__ub){var x=qx.bom.element.Dimension.getSize(this.__tY);if(this.__ua&&x.width<1){throw new Error(r+this.__tY+s+this+k);}
;if(this.__ub){if(x.height<1){throw new Error(r+this.__tY+s+this+g);}
;if(x.height>=1&&qx.bom.element.Style.get(this.__tY,j,3)==f){qx.bom.element.Style.set(this.__tY,j,x.height+h);}
;}
;qx.event.Registration.addListener(this.__tY,a,this._onResize,this);}
;}
,_createContentElement:function(){var y=this.__tY;if(this.__ua||this.__ub){var A=document.createElement(p);y.appendChild(A);}
else {A=y;}
;var z=new qx.html.Root(A);A.style.position=d;z.connectWidget(this);qx.event.Timer.once(function(e){this.fireEvent(n);}
,this,0);return z;}
,_onResize:function(e){var B=e.getData();if((B.oldWidth!==B.width)&&this.__ua||(B.oldHeight!==B.height)&&this.__ub){qx.ui.core.queue.Layout.add(this);}
;}
...
;}
,_computeSizeHint:function(){var G=this.__ua;var D=this.__ub;if(!G||!D){var C=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {C={};}
;var H=qx.bom.element.Dimension;if(G){var F=H.getContentWidth(this.__tY);C.width=F;C.minWidth=F;C.maxWidth=F;}
;if(D){var E=H.getContentHeight(this.__tY);C.height=E;C.minHeight=E;C.maxHeight=E;}
;return C;}
},defer:function(I,J){qx.ui.core.MLayoutHandling.remap(J);}
,destruct:function(){qx.event.Registration.removeListener(this.__tY,a,this._onResize,this);this.__tY=null;}
});}
)();
