...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.ec3ecfe839b5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__yI].values;var bo=this.__yE[this.__yI];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__yJ){bn.shift();}
...
;this.__yG.setRed(bx);this.__yG.setGreen(bw);this.__yG.setBlue(bv);this.__yF.open();}
,_onColorSelectorOk:function(){var by=this.__yG;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__yF.close();}
,_onColorSelectorCancel:function(){this.__yF.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__yF){this.__yF.destroy();this.__yG.destroy();this.__yH.destroy();}
;this._tables=this.__yE=null;}
});}
)();
...
;this.__yQ=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__yQ=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pJ?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pJ=true;this.__yQ=true;this.setRed(255);this.setGreen(255);this.__yQ=false;this.setBlue(255);}
,__pL:function(){if(!this.__yQ){this.__pJ=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__yK===null){this.__yK=bU;}
;if(this.__yK!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__yK!==n){this._setHexFromRgb();}
;switch(this.__yK){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pL();if(this.__yK===bU){this.__yK=null;}
;}
,_applyGreen:function(de,dd){if(this.__yK===null){this.__yK=cq;}
;if(this.__yK!==cK){this.getChildControl(O).setValue(de);}
;if(this.__yK!==n){this._setHexFromRgb();}
;switch(this.__yK){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pL();if(this.__yK===cq){this.__yK=null;}
;}
,_applyBlue:function(dg,df){if(this.__yK===null){this.__yK=d;}
;if(this.__yK!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__yK!==n){this._setHexFromRgb();}
;switch(this.__yK){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pL();if(this.__yK===d){this.__yK=null;}
;}
,_applyHue:function(di,dh){if(this.__yK===null){this.__yK=cr;}
;if(this.__yK!==F){this.getChildControl(cu).setValue(di);}
;if(this.__yK!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__yK){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__yK===cr){this.__yK=null;}
;}
,_applySaturation:function(dk,dj){if(this.__yK===null){this.__yK=s;}
;if(this.__yK!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__yK!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__yK){case F:case R:case s:this._setRgbFromHue();};if(this.__yK===s){this.__yK=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__yK===null){this.__yK=c;}
;if(this.__yK!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__yK!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__yK){case F:case P:case c:this._setRgbFromHue();};if(this.__yK===c){this.__yK=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__yM=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__yN=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__yM=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__yM===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__yN=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__yM=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__yN,0,256);this.__yK=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__yK=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__yM){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__yM=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__yM===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__yO=location.top+(du.height/2)-dv.top;this.__yP=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__yM=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__yO,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__yP,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__yK=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__yK=null;}
,_setRedFromSpinner:function(){if(this.__yK!==null){return;}
;this.__yK=cK;this.setRed(this.getChildControl(m).getValue());this.__yK=null;}
,_setGreenFromSpinner:function(){if(this.__yK!==null){return;}
;this.__yK=cK;this.setGreen(this.getChildControl(O).getValue());this.__yK=null;}
,_setBlueFromSpinner:function(){if(this.__yK!==null){return;}
;this.__yK=cK;this.setBlue(this.getChildControl(cG).getValue());this.__yK=null;}
,_setHueFromSpinner:function(){if(this.__yK!==null){return;}
;this.__yK=F;this.setHue(this.getChildControl(cu).getValue());this.__yK=null;}
,_setSaturationFromSpinner:function(){if(this.__yK!==null){return;}
;this.__yK=F;this.setSaturation(this.getChildControl(cx).getValue());this.__yK=null;}
,_setBrightnessFromSpinner:function(){if(this.__yK!==null){return;}
;this.__yK=F;this.setBrightness(this.getChildControl(bT).getValue());this.__yK=null;}
...
;this.__yK=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__yK=null;}
...
,_setHueFromRgb:function(){switch(this.__yK){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__yK){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
