...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.2d57692e8431.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__Au].values;var bo=this.__Aq[this.__Au];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__Av){bn.shift();}
...
;this.__As.setRed(bx);this.__As.setGreen(bw);this.__As.setBlue(bv);this.__Ar.open();}
,_onColorSelectorOk:function(){var by=this.__As;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__Ar.close();}
,_onColorSelectorCancel:function(){this.__Ar.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__Ar){this.__Ar.destroy();this.__As.destroy();this.__At.destroy();}
;this._tables=this.__Aq=null;}
});}
)();
...
;this.__AC=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__AC=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pW?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pW=true;this.__AC=true;this.setRed(255);this.setGreen(255);this.__AC=false;this.setBlue(255);}
,__pY:function(){if(!this.__AC){this.__pW=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__Aw===null){this.__Aw=bU;}
;if(this.__Aw!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__Aw!==n){this._setHexFromRgb();}
;switch(this.__Aw){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pY();if(this.__Aw===bU){this.__Aw=null;}
;}
,_applyGreen:function(de,dd){if(this.__Aw===null){this.__Aw=cq;}
;if(this.__Aw!==cK){this.getChildControl(O).setValue(de);}
;if(this.__Aw!==n){this._setHexFromRgb();}
;switch(this.__Aw){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pY();if(this.__Aw===cq){this.__Aw=null;}
;}
,_applyBlue:function(dg,df){if(this.__Aw===null){this.__Aw=d;}
;if(this.__Aw!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__Aw!==n){this._setHexFromRgb();}
;switch(this.__Aw){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pY();if(this.__Aw===d){this.__Aw=null;}
;}
,_applyHue:function(di,dh){if(this.__Aw===null){this.__Aw=cr;}
;if(this.__Aw!==F){this.getChildControl(cu).setValue(di);}
;if(this.__Aw!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__Aw){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__Aw===cr){this.__Aw=null;}
;}
,_applySaturation:function(dk,dj){if(this.__Aw===null){this.__Aw=s;}
;if(this.__Aw!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__Aw!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__Aw){case F:case R:case s:this._setRgbFromHue();};if(this.__Aw===s){this.__Aw=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__Aw===null){this.__Aw=c;}
;if(this.__Aw!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__Aw!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__Aw){case F:case P:case c:this._setRgbFromHue();};if(this.__Aw===c){this.__Aw=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__Ay=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__Az=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__Ay=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__Ay===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__Az=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__Ay=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__Az,0,256);this.__Aw=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__Aw=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__Ay){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__Ay=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__Ay===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__AA=location.top+(du.height/2)-dv.top;this.__AB=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__Ay=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__AA,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__AB,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__Aw=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__Aw=null;}
,_setRedFromSpinner:function(){if(this.__Aw!==null){return;}
;this.__Aw=cK;this.setRed(this.getChildControl(m).getValue());this.__Aw=null;}
,_setGreenFromSpinner:function(){if(this.__Aw!==null){return;}
;this.__Aw=cK;this.setGreen(this.getChildControl(O).getValue());this.__Aw=null;}
,_setBlueFromSpinner:function(){if(this.__Aw!==null){return;}
;this.__Aw=cK;this.setBlue(this.getChildControl(cG).getValue());this.__Aw=null;}
,_setHueFromSpinner:function(){if(this.__Aw!==null){return;}
;this.__Aw=F;this.setHue(this.getChildControl(cu).getValue());this.__Aw=null;}
,_setSaturationFromSpinner:function(){if(this.__Aw!==null){return;}
;this.__Aw=F;this.setSaturation(this.getChildControl(cx).getValue());this.__Aw=null;}
,_setBrightnessFromSpinner:function(){if(this.__Aw!==null){return;}
;this.__Aw=F;this.setBrightness(this.getChildControl(bT).getValue());this.__Aw=null;}
,_onHexFieldChange:function(e){if(this.__Aw!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__Aw=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__Aw=null;}
...
,_setHueFromRgb:function(){switch(this.__Aw){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__Aw){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
