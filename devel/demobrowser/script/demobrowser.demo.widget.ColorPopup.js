...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.a2a5a5516575.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="__oC",b="qx.ui.window.Manager";qx.Class.define(b,{extend:qx.core.Object,implement:qx.ui.window.IWindowManager,members:{__oC:null,setDesktop:function(c){this.__oC=c;this.updateStack();}
,getDesktop:function(){return this.__oC;}
,changeActiveWindow:function(d,e){if(d){this.bringToFront(d);d.setActive(true);}
;if(e){e.resetActive();}
;}
,_minZIndex:1e5,updateStack:function(){qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(){this.__oC.forceUnblock();var h=this.__oC.getWindows();var g=this._minZIndex;var m=g+h.length*2;var j=g+h.length*4;var k=null;for(var i=0,l=h.length;i<l;i++ ){var f=h[i];if(!f.isVisible()){continue;}
;k=k||f;if(f.isModal()){f.setZIndex(j);this.__oC.blockContent(j-1);j+=2;k=f;}
else if(f.isAlwaysOnTop()){f.setZIndex(m);m+=2;}
else {f.setZIndex(g);g+=2;}
;if(!k.isModal()&&f.isActive()||f.getZIndex()>k.getZIndex()){k=f;}
;}
;this.__oC.setActiveWindow(k);}
,bringToFront:function(o){var n=this.__oC.getWindows();var p=qx.lang.Array.remove(n,o);if(p){n.push(o);this.updateStack();}
;}
,sendToBack:function(r){var q=this.__oC.getWindows();var s=qx.lang.Array.remove(q,r);if(s){q.unshift(r);this.updateStack();}
;}
},destruct:function(){this._disposeObjects(a);}
});}
)();
(function(){var a="pointerup",b="Boolean",c="losecapture",d="move",f="qx.ui.core.MMovable",g="__oE",h="The move handle could not be redefined!",i="__oD",j="pointerdown",k="maximized",l="pointermove",m="roll",n="move-frame";qx.Mixin.define(f,{properties:{movable:{check:b,init:true},useMoveFrame:{check:b,init:false}},members:{__oD:null,__oE:null,__oF:null,__oG:null,__oH:null,__oI:null,__oJ:null,__oK:false,__oL:null,__oM:0,_activateMoveHandle:function(o){if(this.__oD){throw new Error(h);}
;this.__oD=o;o.addListener(j,this._onMovePointerDown,this);o.addListener(a,this._onMovePointerUp,this);o.addListener(l,this._onMovePointerMove,this);o.addListener(c,this.__oQ,this);}
,__oN:function(){var p=this.__oE;if(!p){p=this.__oE=new qx.ui.core.Widget();p.setAppearance(n);p.exclude();qx.core.Init.getApplication().getRoot().add(p);}
;return p;}
,__oO:function(){var location=this.getContentLocation();var r=this.getBounds();var q=this.__oN();q.setUserBounds(location.left,location.top,r.width,r.height);q.show();q.setZIndex(this.getZIndex()+1);}
,__oP:function(e){var t=this.__oF;var s=Math.max(t.left,Math.min(t.right,e.getDocumentLeft()));var v=Math.max(t.top,Math.min(t.bottom,e.getDocumentTop()));var u=this.__oG+s;var w=this.__oH+v;return {viewportLeft:parseInt(u,10),viewportTop:parseInt(w,10),parentLeft:parseInt(u-this.__oI,10),parentTop:parseInt(w-this.__oJ,10)};}
,_onMoveRoll:function(e){e.stop();}
,_onMovePointerDown:function(e){if(!this.getMovable()||this.hasState(k)){return;}
;this.addListener(m,this._onMoveRoll,this);var parent=this.getLayoutParent();var x=parent.getContentLocation();var z=parent.getBounds();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(!parent.isBlocked()){this.__oL=parent.getBlockerColor();this.__oM=parent.getBlockerOpacity();parent.setBlockerColor(null);parent.setBlockerOpacity(1);parent.blockContent(this.getZIndex()-1);this.__oK=true;}
;}
;this.__oF={left:x.left,top:x.top,right:x.left+z.width,bottom:x.top+z.height};var y=this.getContentLocation();this.__oI=x.left;this.__oJ=x.top;this.__oG=y.left-e.getDocumentLeft();this.__oH=y.top-e.getDocumentTop();this.addState(d);this.__oD.capture();if(this.getUseMoveFrame()){this.__oO();}
;e.stop();}
,_onMovePointerMove:function(e){if(!this.hasState(d)){return;}
;var B=this.__oP(e);if(this.getUseMoveFrame()){this.__oN().setDomPosition(B.viewportLeft,B.viewportTop);}
...
;this.removeState(d);var parent=this.getLayoutParent();if(qx.Class.implementsInterface(parent,qx.ui.window.IDesktop)){if(this.__oK){parent.unblock();parent.setBlockerColor(this.__oL);parent.setBlockerOpacity(this.__oM);this.__oL=null;this.__oM=0;this.__oK=false;}
;}
;this.__oD.releaseCapture();var D=this.__oP(e);var C=this.getLayoutParent().getInsets();this.setLayoutProperties({left:D.parentLeft-(C.left||0),top:D.parentTop-(C.top||0)});if(this.getUseMoveFrame()){this.__oN().exclude();}
;e.stopPropagation();}
,__oQ:function(e){if(!this.hasState(d)){return;}
;this.removeState(d);if(this.getUseMoveFrame()){this.__oN().exclude();}
;}
},destruct:function(){this._disposeObjects(g,i);this.__oF=null;}
});}
)();
(function(){var a="Boolean",b="w-resize",c="touch",d="sw-resize",f="n-resize",g="resizableRight",h="ne-resize",i="se-resize",j="Integer",k="e-resize",l="resizableLeft",m="move",n="shorthand",o="maximized",p="resize",q="nw-resize",r="pointerup",s="pointerdown",t="qx.ui.core.MResizable",u="losecapture",v="resize-frame",w="resizableBottom",x="s-resize",y="pointermove",z="resizableTop",A="pointerout";qx.Mixin.define(t,{construct:function(){var content=this.getContentElement();content.addListener(s,this.__ph,this,true);content.addListener(r,this.__pi,this);content.addListener(y,this.__pk,this);content.addListener(A,this.__pl,this);content.addListener(u,this.__pj,this);var B=content.getDomElement();if(B==null){B=window;}
;this.__oU=qx.event.Registration.getManager(B).getHandler(qx.event.handler.DragDrop);}
,properties:{resizableTop:{check:a,init:true},resizableRight:{check:a,init:true},resizableBottom:{check:a,init:true},resizableLeft:{check:a,init:true},resizable:{group:[z,g,w,l],mode:n},resizeSensitivity:{check:j,init:5},useResizeFrame:{check:a,init:true}},members:{__oU:null,__oV:null,__oW:null,__oX:null,__oY:null,__pa:null,__pb:null,RESIZE_TOP:1,RESIZE_BOTTOM:2,RESIZE_LEFT:4,RESIZE_RIGHT:8,_getResizeFrame:function(){var C=this.__oV;if(!C){C=this.__oV=new qx.ui.core.Widget();C.setAppearance(v);C.exclude();qx.core.Init.getApplication().getRoot().add(C);}
;return C;}
,__pc:function(){var location=this.getContentLocation();var D=this._getResizeFrame();D.setUserBounds(location.left,location.top,location.right-location.left,location.bottom-location.top);D.show();D.setZIndex(this.getZIndex()+1);}
,__pd:function(e){var F=this.__oW;var E=this.getSizeHint();var I=this.__pb;var H=this.__pa;var J=H.width;var G=H.height;var L=H.left;var top=H.top;var K;if((F&this.RESIZE_TOP)||(F&this.RESIZE_BOTTOM)){K=Math.max(I.top,Math.min(I.bottom,e.getDocumentTop()))-this.__oY;if(F&this.RESIZE_TOP){G-=K;}
else {G+=K;}
;if(G<E.minHeight){G=E.minHeight;}
else if(G>E.maxHeight){G=E.maxHeight;}
;if(F&this.RESIZE_TOP){top+=H.height-G;}
;}
;if((F&this.RESIZE_LEFT)||(F&this.RESIZE_RIGHT)){K=Math.max(I.left,Math.min(I.right,e.getDocumentLeft()))-this.__oX;if(F&this.RESIZE_LEFT){J-=K;}
else {J+=K;}
...
,__pe:{'1':f,'2':x,'4':b,'8':k,'5':q,'6':d,'9':h,'10':i},__pf:function(e){var location=this.getContentLocation();var O=this.getResizeSensitivity();var N=e.getDocumentLeft();var P=e.getDocumentTop();var M=this.__pg(location,N,P,O);if(M>0){M=M|this.__pg(location,N,P,O*2);}
;this.__oW=M;}
,__pg:function(location,T,R,S){var Q=0;if(this.getResizableTop()&&Math.abs(location.top-R)<S&&T>location.left-S&&T<location.right+S){Q+=this.RESIZE_TOP;}
...
;return Q;}
,__ph:function(e){if(!this.__oW||!this.getEnabled()||e.getPointerType()==c){return;}
;this.addState(p);this.__oX=e.getDocumentLeft();this.__oY=e.getDocumentTop();var location=this.getContentLocation();var V=this.getBounds();this.__pa={top:location.top,left:location.left,width:location.right-location.left,height:location.bottom-location.top,bounds:qx.lang.Object.clone(V)};var parent=this.getLayoutParent();var W=parent.getContentLocation();var U=parent.getBounds();this.__pb={left:W.left,top:W.top,right:W.left+U.width,bottom:W.top+U.height};if(this.getUseResizeFrame()){this.__pc();}
;this.capture();e.stop();}
,__pi:function(e){if(!this.hasState(p)||!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.getUseResizeFrame()){this._getResizeFrame().exclude();}
;var X=this.__pd(e);this.setWidth(X.width);this.setHeight(X.height);if(this.getResizableLeft()||this.getResizableTop()){this.setLayoutProperties({left:X.parentLeft,top:X.parentTop});}
;this.__oW=0;this.removeState(p);this.resetCursor();this.getApplicationRoot().resetGlobalCursor();this.releaseCapture();e.stopPropagation();}
,__pj:function(e){if(!this.__oW){return;}
...
;}
,__pk:function(e){if(!this.getEnabled()||e.getPointerType()==c){return;}
;if(this.hasState(p)){var ba=this.__pd(e);if(this.getUseResizeFrame()){var Y=this._getResizeFrame();Y.setUserBounds(ba.viewportLeft,ba.viewportTop,ba.width,ba.height);}
...
;}
;e.stopPropagation();}
else if(!this.hasState(o)&&!this.__oU.isSessionActive()){this.__pf(e);var bd=this.__oW;var bc=this.getApplicationRoot();if(bd){var bb=this.__pe[bd];this.setCursor(bb);bc.setGlobalCursor(bb);}
else if(this.getCursor()){this.resetCursor();bc.resetGlobalCursor();}
;}
;}
,__pl:function(e){if(e.getPointerType()==c){return;}
;if(this.getCursor()&&!this.hasState(p)){this.resetCursor();this.getApplicationRoot().resetGlobalCursor();}
;}
},destruct:function(){if(this.__oV!=null&&!qx.core.ObjectRegistry.inShutDown){this.__oV.destroy();this.__oV=null;}
;this.__oU=null;}
});}
)();
...
;var br=this.getLayoutProperties();this.__pn=br.left===undefined?0:br.left;this.__pm=br.top===undefined?0:br.top;this.setLayoutProperties({left:null,top:null,edge:0});this.addState(F);this._updateCaptionBar();this.fireEvent(Q);}
;}
;}
,minimize:function(){if(!this.isVisible()){return;}
;if(this.fireNonBubblingEvent(b,qx.event.type.Event,[false,true])){var bs=this.getLayoutProperties();this.__pn=bs.left===undefined?0:bs.left;this.__pm=bs.top===undefined?0:bs.top;this.removeState(F);this.hide();this.fireEvent(v);}
;}
...
;var bt=this.__pn;var top=this.__pm;this.setLayoutProperties({edge:null,left:bt,top:top});this.removeState(F);this._updateCaptionBar();this.fireEvent(S);}
;}
...
,setValue:function(da){var cY;if(da==null){this.__pP=true;cY=[255,255,255];}
else {cY=qx.util.ColorUtil.stringToRgb(da);this.__pP=false;}
;this.__yW=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__yW=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pP?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pP=true;this.__yW=true;this.setRed(255);this.setGreen(255);this.__yW=false;this.setBlue(255);}
,__pR:function(){if(!this.__yW){this.__pP=false;this.fireDataEvent(f,this.getValue());}
;}
...
;switch(this.__yQ){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pR();if(this.__yQ===bU){this.__yQ=null;}
;}
,_applyGreen:function(de,dd){if(this.__yQ===null){this.__yQ=cq;}
;if(this.__yQ!==cK){this.getChildControl(O).setValue(de);}
;if(this.__yQ!==n){this._setHexFromRgb();}
;switch(this.__yQ){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pR();if(this.__yQ===cq){this.__yQ=null;}
;}
,_applyBlue:function(dg,df){if(this.__yQ===null){this.__yQ=d;}
;if(this.__yQ!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__yQ!==n){this._setHexFromRgb();}
;switch(this.__yQ){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pR();if(this.__yQ===d){this.__yQ=null;}
;}
