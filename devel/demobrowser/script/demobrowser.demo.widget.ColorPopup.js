...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.033dac22db2d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__yD].values;var bo=this.__yz[this.__yD];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__yE){bn.shift();}
...
;this.__yB.setRed(bx);this.__yB.setGreen(bw);this.__yB.setBlue(bv);this.__yA.open();}
,_onColorSelectorOk:function(){var by=this.__yB;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__yA.close();}
,_onColorSelectorCancel:function(){this.__yA.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__yA){this.__yA.destroy();this.__yB.destroy();this.__yC.destroy();}
;this._tables=this.__yz=null;}
});}
)();
...
;this.__yL=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__yL=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pJ?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pJ=true;this.__yL=true;this.setRed(255);this.setGreen(255);this.__yL=false;this.setBlue(255);}
,__pL:function(){if(!this.__yL){this.__pJ=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__yF===null){this.__yF=bU;}
;if(this.__yF!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__yF!==n){this._setHexFromRgb();}
;switch(this.__yF){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pL();if(this.__yF===bU){this.__yF=null;}
;}
,_applyGreen:function(de,dd){if(this.__yF===null){this.__yF=cq;}
;if(this.__yF!==cK){this.getChildControl(O).setValue(de);}
;if(this.__yF!==n){this._setHexFromRgb();}
;switch(this.__yF){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pL();if(this.__yF===cq){this.__yF=null;}
;}
,_applyBlue:function(dg,df){if(this.__yF===null){this.__yF=d;}
;if(this.__yF!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__yF!==n){this._setHexFromRgb();}
;switch(this.__yF){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pL();if(this.__yF===d){this.__yF=null;}
;}
,_applyHue:function(di,dh){if(this.__yF===null){this.__yF=cr;}
;if(this.__yF!==F){this.getChildControl(cu).setValue(di);}
;if(this.__yF!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__yF){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__yF===cr){this.__yF=null;}
;}
,_applySaturation:function(dk,dj){if(this.__yF===null){this.__yF=s;}
;if(this.__yF!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__yF!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__yF){case F:case R:case s:this._setRgbFromHue();};if(this.__yF===s){this.__yF=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__yF===null){this.__yF=c;}
;if(this.__yF!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__yF!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__yF){case F:case P:case c:this._setRgbFromHue();};if(this.__yF===c){this.__yF=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__yH=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__yI=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__yH=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__yH===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__yI=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__yH=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__yI,0,256);this.__yF=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__yF=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__yH){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__yH=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__yH===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__yJ=location.top+(du.height/2)-dv.top;this.__yK=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__yH=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__yJ,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__yK,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__yF=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__yF=null;}
,_setRedFromSpinner:function(){if(this.__yF!==null){return;}
;this.__yF=cK;this.setRed(this.getChildControl(m).getValue());this.__yF=null;}
,_setGreenFromSpinner:function(){if(this.__yF!==null){return;}
;this.__yF=cK;this.setGreen(this.getChildControl(O).getValue());this.__yF=null;}
,_setBlueFromSpinner:function(){if(this.__yF!==null){return;}
;this.__yF=cK;this.setBlue(this.getChildControl(cG).getValue());this.__yF=null;}
,_setHueFromSpinner:function(){if(this.__yF!==null){return;}
;this.__yF=F;this.setHue(this.getChildControl(cu).getValue());this.__yF=null;}
,_setSaturationFromSpinner:function(){if(this.__yF!==null){return;}
;this.__yF=F;this.setSaturation(this.getChildControl(cx).getValue());this.__yF=null;}
,_setBrightnessFromSpinner:function(){if(this.__yF!==null){return;}
;this.__yF=F;this.setBrightness(this.getChildControl(bT).getValue());this.__yF=null;}
,_onHexFieldChange:function(e){if(this.__yF!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__yF=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__yF=null;}
...
,_setHueFromRgb:function(){switch(this.__yF){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__yF){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
