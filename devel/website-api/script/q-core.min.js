...
;}
,statics:{$$type:g},members:{__Property:qx.core.Environment.get(d)?qx.core.Property:null,toHashCode:function(){return this.$$hash;}
...
;var n=this.constructor;var m=new n;var p=qx.Class.getProperties(n);var o=this.__Property.$$store.user;var q=this.__Property.$$method.set;var name;for(var i=0,l=p.length;i<l;i++ ){name=p[i];if(this.hasOwnProperty(o[name])){m[q[name]](this[o[name]]);}
;}
;return m;}
,__userData:null,setUserData:function(r,s){if(!this.__userData){this.__userData={};}
;this.__userData[r]=s;}
,getUserData:function(u){if(!this.__userData){return null;}
;var t=this.__userData[u];return t===undefined?null:t;}
...
;}
;qx.core.ObjectRegistry.unregister(this);this.__userData=null;if(qx.core.Environment.get(d)){var F=this.constructor;var J;var K=this.__Property.$$store;var H=K.user;var I=K.theme;var D=K.inherit;var G=K.useinit;var E=K.init;while(F){J=F.$$properties;if(J){for(var name in J){if(J[name].dereference){this[H[name]]=this[I[name]]=this[D[name]]=this[G[name]]=this[E[name]]=undefined;}
;}
;}
;F=F.superclass;}
;}
