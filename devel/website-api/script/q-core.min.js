...
(function(){var a="ecmascript.array.reduce",b="function",c="ecmascript.array.lastindexof",d="ecmascript.array.map",e="ecmascript.array.filter",f="Length is 0 and no second argument given",g="qx.lang.normalize.Array",h="ecmascript.array.indexof",j="First argument is not callable",k="ecmascript.array.findIndex",m="ecmascript.array.foreach",n="ecmascript.array.find",o="ecmascript.array.reduceright",p="ecmascript.array.some",q="ecmascript.array.every";qx.Bootstrap.define(g,{statics:{indexOf:function(r,s){if(s==null){s=0;}
else if(s<0){s=Math.max(0,this.length+s);}
;for(var i=s;i<this.length;i++ ){if(this[i]===r){return i;}
;}
;return -1;}
,lastIndexOf:function(t,u){if(u==null){u=this.length-1;}
else if(u<0){u=Math.max(0,this.length+u);}
;for(var i=u;i>=0;i-- ){if(this[i]===t){return i;}
;}
;return -1;}
,forEach:function(v,w){var l=this.length;for(var i=0;i<l;i++ ){var x=this[i];if(x!==undefined){v.call(w||window,x,i,this);}
;}
;}
,filter:function(B,y){var z=[];var l=this.length;for(var i=0;i<l;i++ ){var A=this[i];if(A!==undefined){if(B.call(y||window,A,i,this)){z.push(this[i]);}
;}
;}
;return z;}
,map:function(F,C){var D=[];var l=this.length;for(var i=0;i<l;i++ ){var E=this[i];if(E!==undefined){D[i]=F.call(C||window,E,i,this);}
;}
;return D;}
,some:function(G,H){var l=this.length;for(var i=0;i<l;i++ ){var I=this[i];if(I!==undefined){if(G.call(H||window,I,i,this)){return true;}
;}
;}
;return false;}
,every:function(J,K){var l=this.length;for(var i=0;i<l;i++ ){var L=this[i];if(L!==undefined){if(!J.call(K||window,L,i,this)){return false;}
;}
;}
;return true;}
,find:function(M,N){{}
;var l=this.length;for(var i=0;i<l;i++ ){var O=this[i];if(M.call(N||window,O,i,this)){return O;}
;}
;return undefined;}
,findIndex:function(P,Q){{}
;var l=this.length;for(var i=0;i<l;i++ ){var R=this[i];if(P.call(Q||window,R,i,this)){return i;}
;}
;return -1;}
,reduce:function(S,T){if(typeof S!==b){throw new TypeError(j);}
;if(T===undefined&&this.length===0){throw new TypeError(f);}
;var U=T===undefined?this[0]:T;for(var i=T===undefined?1:0;i<this.length;i++ ){if(i in this){U=S.call(undefined,U,this[i],i,this);}
;}
;return U;}
,reduceRight:function(V,W){if(typeof V!==b){throw new TypeError(j);}
;if(W===undefined&&this.length===0){throw new TypeError(f);}
;var X=W===undefined?this[this.length-1]:W;for(var i=W===undefined?this.length-2:this.length-1;i>=0;i-- ){if(i in this){X=V.call(undefined,X,this[i],i,this);}
;}
;return X;}
},defer:function(Y){if(!qx.core.Environment.get(h)){Array.prototype.indexOf=Y.indexOf;}
;if(!qx.core.Environment.get(c)){Array.prototype.lastIndexOf=Y.lastIndexOf;}
;if(!qx.core.Environment.get(m)){Array.prototype.forEach=Y.forEach;}
;if(!qx.core.Environment.get(e)){Array.prototype.filter=Y.filter;}
;if(!qx.core.Environment.get(d)){Array.prototype.map=Y.map;}
;if(!qx.core.Environment.get(p)){Array.prototype.some=Y.some;}
;if(!qx.core.Environment.get(n)){Array.prototype.find=Y.find;}
;if(!qx.core.Environment.get(k)){Array.prototype.findIndex=Y.findIndex;}
;if(!qx.core.Environment.get(q)){Array.prototype.every=Y.every;}
;if(!qx.core.Environment.get(a)){Array.prototype.reduce=Y.reduce;}
;if(!qx.core.Environment.get(o)){Array.prototype.reduceRight=Y.reduceRight;}
;}
});}
)();
