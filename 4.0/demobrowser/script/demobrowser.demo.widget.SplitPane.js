...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane.e5bc030bf9cf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="first",b="Show first pane",c="Documents (D:)",d="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",f="Windows (C:)",g="Toggle Splitpane Orientation",h="Inbox",j="Desktop",k="Trash",l="both",m="_container1",n="execute",o="):",p="Presets",q="Network",r="value",s="changeSelection",t="Sent",u="Offset (",v="/",w="offset",x="Files",y="_container2",z="vertical",A="Workspace",B="Junk #",C="second",D="main",E="Data",F="horizontal",G="Show both panes",H="__wE",I="Show second pane",J="demobrowser.demo.widget.SplitPane",K="Edit";qx.Class.define(J,{extend:qx.application.Standalone,members:{__wE:null,main:function(){qx.application.Standalone.prototype.main.call(this);var M=new qx.ui.container.Scroll();var L=new qx.ui.container.Composite(new qx.ui.layout.Basic());L.setAllowStretchX(false);M.add(L);var T=new qx.ui.splitpane.Pane(F).set({width:450,height:300});this.__wE=T;var X=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:D});var W=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:D});var P=this.__Qn();var O=new qx.ui.form.Button(g).set({allowGrowX:false,allowGrowY:false});O.addListener(n,this._toggle,this);var R=new qx.ui.basic.Label(d);R.setRich(true);X.add(P);W.add(O);W.add(R);this._container1=X;this._container2=W;T.add(X,0);T.add(W,1);L.add(T,{left:20,top:40});this.getRoot().add(M,{edge:0});var N=new qx.ui.layout.VBox(5);var U=new qx.ui.container.Composite(N);var Y=new qx.ui.form.RadioButton(b);var ba=new qx.ui.form.RadioButton(I);var bb=new qx.ui.form.RadioButton(G);Y.setUserData(r,a);ba.setUserData(r,C);bb.setUserData(r,l);bb.setValue(true);U.add(Y);U.add(ba);U.add(bb);var Q=new qx.ui.form.RadioGroup(Y,ba,bb);Q.addListener(s,this._changeVisiblity,this);L.add(U,{left:490,top:42});O.focus();var S=new qx.ui.basic.Label();this.getRoot().add(S,{left:490,top:120});var V=new qx.ui.form.Slider().set({minimum:0,maximum:30,value:6,width:100});this.getRoot().add(V,{left:490,top:140});V.bind(r,T,w);V.bind(r,S,r,{converter:function(bc){return u+bc+o;}
});}
,_toggle:function(){var bd=this.__wE.getOrientation();this.__wE.setOrientation(bd==F?z:F);}
,_changeVisiblity:function(e){var be=e.getData()[0].getUserData(r);if(be==l){this._container1.show();this._container2.show();}
else if(be==a){this._container1.show();this._container2.exclude();}
else if(be==C){this._container1.exclude();this._container2.show();}
;}
,__Qn:function(){var bo=new qx.ui.tree.Tree();bo.setDecorator(null);var bt=new qx.ui.tree.TreeFolder(v);bt.setOpen(true);bo.setRoot(bt);var br=new qx.ui.tree.TreeFolder(j);br.setOpen(true);bt.add(br);var bj=new qx.ui.tree.TreeFolder(x);var bh=new qx.ui.tree.TreeFolder(A);var bi=new qx.ui.tree.TreeFolder(q);var bg=new qx.ui.tree.TreeFolder(k);br.add(bj,bh,bi,bg);var bp=new qx.ui.tree.TreeFile(f);var bf=new qx.ui.tree.TreeFile(c);bh.add(bp,bf);var bs=new qx.ui.tree.TreeFolder(h);var bk=new qx.ui.tree.TreeFolder(p);var bn=new qx.ui.tree.TreeFolder(t);var bm=new qx.ui.tree.TreeFolder(k);for(var i=0;i<100;i++ ){bm.add(new qx.ui.tree.TreeFile(B+i));}
;var bq=new qx.ui.tree.TreeFolder(E);var bl=new qx.ui.tree.TreeFolder(K);bs.add(bk,bn,bm,bq,bl);bt.add(bs);return bo;}
},destruct:function(){this._disposeObjects(H,m,y);}
});}
)();
...
(function(){var a="slider",b="splitter",c="px",d="Integer",f="height",g="move",h="maxHeight",i="resize",j="pointerup",k="vertical",l="width",m="_applyOrientation",n="_applyOffset",o="splitpane",p="qx.ui.splitpane.Pane",q="pointerdown",r="top",s="minHeight",t="knob",u="horizontal",v="minWidth",w="appear",z="losecapture",A="left",B="pointermove",C="maxWidth",D="pointerout";qx.Class.define(p,{extend:qx.ui.core.Widget,construct:function(E){qx.ui.core.Widget.call(this);this.__fV=[];if(E){this.setOrientation(E);}
else {this.initOrientation();}
;this.__lg.addListener(q,this._onPointerDown,this);this.__lg.addListener(j,this._onPointerUp,this);this.__lg.addListener(B,this._onPointerMove,this);this.__lg.addListener(D,this._onPointerOut,this);this.__lg.addListener(z,this._onPointerUp,this);}
,properties:{appearance:{refine:true,init:o},offset:{check:d,init:6,apply:n},orientation:{init:u,check:[u,k],apply:m}},members:{__sJ:null,__sK:false,__sL:null,__sM:null,__nw:null,__sN:null,__sO:null,__fV:null,__lg:null,_createChildControlImpl:function(H,G){var F;switch(H){case a:F=new qx.ui.splitpane.Slider(this);F.exclude();this._add(F,{type:H});break;case b:F=new qx.ui.splitpane.Splitter(this);this._add(F,{type:H});F.addListener(g,this.__sP,this);break;};return F||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
,__sP:function(e){this.__sR(e.getData());}
,__sQ:function(K){this.__lg=new qx.ui.splitpane.Blocker(K);this.getContentElement().add(this.__lg);var I=this.getChildControl(b);var J=I.getWidth();if(!J){I.addListenerOnce(w,function(){this.__sR();}
,this);}
;I.addListener(i,function(e){var L=e.getData();if(L.height==0||L.width==0){this.__lg.hide();}
else {this.__lg.show();}
;}
,this);}
,getBlocker:function(){return this.__lg;}
,_applyOrientation:function(Q,N){var R=this.getChildControl(a);var M=this.getChildControl(b);this.__nw=Q===u;if(!this.__lg){this.__sQ(Q);}
;this.__lg.setOrientation(Q);var P=this._getLayout();if(P){P.dispose();}
;var O=Q===k?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;this._setLayout(O);M.removeState(N);M.addState(Q);M.getChildControl(t).removeState(N);M.getChildControl(t).addState(Q);R.removeState(N);R.addState(Q);qx.ui.core.queue.Manager.flush();this.__sR();}
,_applyOffset:function(T,S){this.__sR();}
,__sR:function(V){var U=this.getChildControl(b);var ba=this.getOffset();var bb=U.getBounds();var Y=U.getContentElement().getDomElement();if(!Y){return;}
;if(this.__nw){var X=null;if(V){X=V.width;}
else if(bb){X=bb.width;}
;var bc=V&&V.left;if(X){if(isNaN(bc)){bc=qx.bom.element.Location.getPosition(Y).left;}
;this.__lg.setWidth(ba,X);this.__lg.setLeft(ba,bc);}
;}
...
;this.__lg.setHeight(ba,W);this.__lg.setTop(ba,top);}
;}
;}
,add:function(be,bd){if(bd==null){this._add(be);}
else {this._add(be,{flex:bd});}
;this.__fV.push(be);}
,remove:function(bf){this._remove(bf);qx.lang.Array.remove(this.__fV,bf);}
,getChildren:function(){return this.__fV;}
,_onPointerDown:function(e){if(!e.isLeftPressed()){return;}
;var bg=this.getChildControl(b);var bj=bg.getContentLocation();var bh=this.getContentLocation();this.__sJ=this.__nw?e.getDocumentLeft()-bj.left+bh.left:e.getDocumentTop()-bj.top+bh.top;var bi=this.getChildControl(a);var bk=bg.getBounds();bi.setUserBounds(bk.left,bk.top,bk.width,bk.height);bi.setZIndex(bg.getZIndex()+1);bi.show();this.__sK=true;this.__lg.capture();e.stop();}
,_onPointerMove:function(e){this._setLastPointerPosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__sK){this.__sS();var bl=this.getChildControl(a);var bm=this.__sN;if(this.__nw){bl.setDomLeft(bm);this.__lg.setStyle(A,(bm-this.getOffset())+c);}
else {bl.setDomTop(bm);this.__lg.setStyle(r,(bm-this.getOffset())+c);}
;e.stop();}
;}
,_onPointerOut:function(e){this._setLastPointerPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onPointerUp:function(e){if(!this.__sK){return;}
;this._finalizeSizes();var bn=this.getChildControl(a);bn.exclude();this.__sK=false;this.releaseCapture();e.stop();}
,_finalizeSizes:function(){var br=this.__sN;var bo=this.__sO;if(br==null){return;}
...
else {if(this.__nw){bs.setWidth(br);bq.setWidth(bo);}
else {bs.setHeight(br);bq.setHeight(bo);}
;}
;}
,__sS:function(){if(this.__nw){var bx=v,bE=l,by=C,bC=this.__sL;}
else {var bx=s,bE=f,by=h,bC=this.__sM;}
;var bD=this._getChildren();var bv=bD[2].getSizeHint();var bA=bD[3].getSizeHint();var bB=bD[2].getBounds()[bE]+bD[3].getBounds()[bE];var bz=bC-this.__sJ;var bw=bB-bz;if(bz<bv[bx]){bw-=bv[bx]-bz;bz=bv[bx];}
else if(bw<bA[bx]){bz-=bA[bx]-bw;bw=bA[bx];}
;if(bz>bv[by]){bw+=bz-bv[by];bz=bv[by];}
else if(bw>bA[by]){bz+=bw-bA[by];bw=bA[by];}
;this.__sN=bz;this.__sO=bw;}
,_isActiveDragSession:function(){return this.__sK;}
,_setLastPointerPosition:function(x,y){this.__sL=x;this.__sM=y;}
...
;this.__fy.removeItem(I);}
,selectRange:function(J,K){this.__fy.selectItemRange(J,K);}
,resetSelection:function(){this.__fy.clearSelection();}
...
else {var M=this.getSelection();if(!qx.lang.Array.equals(M,L)){this.__fy.replaceSelection(L);}
;}
;}
,getSelection:function(){return this.__fy.getSelection();}
,getSortedSelection:function(){return this.__fy.getSortedSelection();}
,isSelectionEmpty:function(){return this.__fy.isSelectionEmpty();}
,getSelectionContext:function(){return this.__fy.getSelectionContext();}
,_getManager:function(){return this.__fy;}
,getSelectables:function(N){return this.__fy.getSelectables(N);}
,invertSelection:function(){this.__fy.invertSelection();}
,_getLeadItem:function(){var O=this.__fy.getMode();if(O===r||O===b){return this.__fy.getSelectedItem();}
else {return this.__fy.getLeadItem();}
;}
,_applySelectionMode:function(Q,P){this.__fy.setMode(Q);}
,_applyDragSelection:function(S,R){this.__fy.setDrag(S);}
,_applyQuickSelection:function(U,T){this.__fy.setQuick(U);}
,_onSelectionChange:function(e){this.fireDataEvent(l,e.getData());}
},destruct:function(){this._disposeObjects(g);}
});}
)();
(function(){var c="os.name",d="Abstract method call: _getLastSelectable()",f="Could not select more than one items in mode: ",g="Boolean",h="one",j="Abstract method call: _getLocation()",k="Left",m="Abstract method call: _scrollBy()",n="The method getSelectedItem() is only supported in 'single' and 'one' selection mode!",o="Abstract method call: _scrollItemIntoView()",p="Escape",q="Abstract method call: _isSelectable()",r="Space",s="Abstract method call: _getPage()",t="right",u="lead",v="Down",w="Abstract method call: _getFirstSelectable()",x="Up",y="qx.event.type.Data",z="under",A="A",B="_applyMode",C="PageDown",D="Can not select multiple items in selection mode: ",E="osx",F="mouse",G="interval",H="Abstract method call: _styleSelectable()",I="anchor",J="Abstract method call: _capture()",K="Abstract method call: _getDimension()",L="The method invertSelection() is only supported in 'multi' and 'additive' selection mode!",M="!",N="Abstract method call: _getScroll()",O="Abstract method call: _getRelatedSelectable()",P="End",Q="quick",R="selected",S="key",T="Abstract method call: _getSelectableLocationX()",U="multi",V="left",W="Abstract method call: _selectableToHashCode()",X="Home",Y="Can not select all items in selection mode: ",bt="single",bu="Right",bv="Abstract method call: getSelectables()",bp="Abstract method call: _getSelectableLocationY()",bq="additive",br="abstract",bs="changeSelection",bA="above",bB="__mH",bC="Abstract method call: _getSelectableRange()",bD="tap",bw="drag",bx="PageUp",by="qx.ui.core.selection.Abstract",bz="Abstract method call: _releaseCapture()";qx.Class.define(by,{type:br,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__fC={};}
,events:{"changeSelection":y},properties:{mode:{check:[bt,U,bq,h],init:bt,apply:B},drag:{check:g,init:false},quick:{check:g,init:false}},members:{__mF:0,__mG:0,__mH:null,__mI:null,__mJ:null,__mK:null,__mL:null,__mM:null,__mN:null,__mO:null,__mP:null,__mQ:null,__mR:null,__mS:null,__mT:null,__mU:null,__mV:null,__fC:null,__mW:null,__mX:null,_userInteraction:false,__mY:null,getSelectionContext:function(){return this.__mU;}
...
,getSortedSelection:function(){var bU=this.getSelectables();var bT=qx.lang.Object.getValues(this.__fC);bT.sort(function(a,b){return bU.indexOf(a)-bU.indexOf(b);}
);return bT;}
,isItemSelected:function(bV){var bW=this._selectableToHashCode(bV);return this.__fC[bW]!==undefined;}
...
;this._fireChange();}
,_setLeadItem:function(cb){var ca=this.__mV;if(ca!==null){this._styleSelectable(ca,u,false);}
;if(cb!==null){this._styleSelectable(cb,u,true);}
;this.__mV=cb;}
,getLeadItem:function(){return this.__mV;}
,_setAnchorItem:function(cd){var cc=this.__mW;if(cc!=null){this._styleSelectable(cc,I,false);}
;if(cd!=null){this._styleSelectable(cd,I,true);}
;this.__mW=cd;}
,_getAnchorItem:function(){return this.__mW!==null?this.__mW:null;}
...
;this._fireChange();}
,handlePointerOver:function(event){if(this.__mY!=null&&this.__mY!=this._getScroll().top){this.__mY=null;return;}
...
;var cD=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cA=event.isShiftPressed();if(this.isItemSelected(cB)&&!cA&&!cD&&!this.getDrag()){this.__mX=cB;this._userInteraction=false;return;}
else {this.__mX=null;}
;this._scrollItemIntoView(cB);var cC=this.getMode();if(this.getDrag()&&cC!==bt&&cC!==h&&!cA&&!cD&&event.getPointerType()==F){this._setAnchorItem(cB);this._setLeadItem(cB);this.__mL=this._getLocation();this.__mI=this._getScroll();this.__mM=event.getDocumentLeft()+this.__mI.left;this.__mN=event.getDocumentTop()+this.__mI.top;this.__mO=true;this._capture();}
;this._fireChange(bD);this._userInteraction=false;}
,handleTap:function(event){this._userInteraction=true;var cE=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var cF=event.isShiftPressed();if(!cE&&!cF&&this.__mX!=null){var cH=this._getSelectableFromPointerEvent(event);if(cH===null||!this.isItemSelected(cH)){this._userInteraction=false;return;}
;var cI=this.getMode();if(cI===bq){this._removeFromSelection(cH);}
else {this._setSelectedItem(cH);if(this.getMode()===U){this._setLeadItem(cH);this._setAnchorItem(cH);}
;}
;this._userInteraction=false;}
;var cH=this._getSelectableFromPointerEvent(event);if(cH===null){this._userInteraction=false;return;}
;switch(this.getMode()){case bt:case h:this._setSelectedItem(cH);break;case bq:this._setLeadItem(cH);this._setAnchorItem(cH);this._toggleInSelection(cH);break;case U:this._setLeadItem(cH);if(cF){var cG=this._getAnchorItem();if(cG===null){cG=this._getFirstSelectable();this._setAnchorItem(cG);}
;this._selectItemRange(cG,cH,cE);}
else if(cE){this._setAnchorItem(cH);this._toggleInSelection(cH);}
else {this._setAnchorItem(cH);this._setSelectedItem(cH);}
;break;};this._cleanup();}
,handleLoseCapture:function(event){this._cleanup();}
,handlePointerMove:function(event){if(!this.__mO){return;}
;this.__mP=event.getDocumentLeft();this.__mQ=event.getDocumentTop();this._userInteraction=true;var cJ=this.__mP+this.__mI.left;if(cJ>this.__mM){this.__mR=1;}
else if(cJ<this.__mM){this.__mR=-1;}
else {this.__mR=0;}
;var cK=this.__mQ+this.__mI.top;if(cK>this.__mN){this.__mS=1;}
else if(cK<this.__mN){this.__mS=-1;}
else {this.__mS=0;}
;var location=this.__mL;if(this.__mP<location.left){this.__mF=this.__mP-location.left;}
else if(this.__mP>location.right){this.__mF=this.__mP-location.right;}
else {this.__mF=0;}
;if(this.__mQ<location.top){this.__mG=this.__mQ-location.top;}
else if(this.__mQ>location.bottom){this.__mG=this.__mQ-location.bottom;}
else {this.__mG=0;}
;if(!this.__mH){this.__mH=new qx.event.Timer(100);this.__mH.addListener(G,this._onInterval,this);}
;this.__mH.start();this._autoSelect();event.stopPropagation();this._userInteraction=false;}
,handleAddItem:function(e){var cL=e.getData();if(this.getMode()===h&&this.isSelectionEmpty()){this.addItem(cL);}
;}
,handleRemoveItem:function(e){this.removeItem(e.getData());}
,_cleanup:function(){if(!this.getDrag()&&this.__mO){return;}
;if(this.__mT){this._fireChange(bD);}
;delete this.__mO;delete this.__mJ;delete this.__mK;this._releaseCapture();if(this.__mH){this.__mH.stop();}
;}
,_onInterval:function(e){this._scrollBy(this.__mF,this.__mG);this.__mI=this._getScroll();this._autoSelect();}
,_autoSelect:function(){var cU=this._getDimension();var cN=Math.max(0,Math.min(this.__mP-this.__mL.left,cU.width))+this.__mI.left;var cM=Math.max(0,Math.min(this.__mQ-this.__mL.top,cU.height))+this.__mI.top;if(this.__mJ===cN&&this.__mK===cM){return;}
;this.__mJ=cN;this.__mK=cM;var cR=this._getAnchorItem();var cP=cR;var cS=this.__mR;var cV,cO;while(cS!==0){cV=cS>0?this._getRelatedSelectable(cP,t):this._getRelatedSelectable(cP,V);if(cV!==null){cO=this._getSelectableLocationX(cV);if((cS>0&&cO.left<=cN)||(cS<0&&cO.right>=cN)){cP=cV;continue;}
;}
;break;}
;var cT=this.__mS;var cW,cQ;while(cT!==0){cW=cT>0?this._getRelatedSelectable(cP,z):this._getRelatedSelectable(cP,bA);if(cW!==null){cQ=this._getSelectableLocationY(cW);if((cT>0&&cQ.top<=cM)||(cT<0&&cQ.bottom>=cM)){cP=cW;continue;}
;}
;break;}
;var cX=this.getMode();if(cX===U){this._selectItemRange(cR,cP);}
else if(cX===bq){if(this.isItemSelected(cR)){this._selectItemRange(cR,cP,true);}
else {this._deselectItemRange(cR,cP);}
;this._setAnchorItem(cP);}
;this._fireChange(bw);}
,__na:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;var de,dd;var dg=event.getKeyIdentifier();var df=this.getMode();var da=event.isCtrlPressed()||(qx.core.Environment.get(c)==E&&event.isMetaPressed());var db=event.isShiftPressed();var dc=false;if(dg===A&&da){if(df!==bt&&df!==h){this._selectAllItems();dc=true;}
;}
else if(dg===p){if(df!==bt&&df!==h){this._clearSelection();dc=true;}
;}
else if(dg===r){var cY=this.getLeadItem();if(cY!=null&&!db){if(da||df===bq){this._toggleInSelection(cY);}
else {this._setSelectedItem(cY);}
;dc=true;}
;}
else if(this.__na[dg]){dc=true;if(df===bt||df==h){de=this._getSelectedItem();}
else {de=this.getLeadItem();}
;if(de!==null){switch(dg){case X:dd=this._getFirstSelectable();break;case P:dd=this._getLastSelectable();break;case x:dd=this._getRelatedSelectable(de,bA);break;case v:dd=this._getRelatedSelectable(de,z);break;case k:dd=this._getRelatedSelectable(de,V);break;case bu:dd=this._getRelatedSelectable(de,t);break;case bx:dd=this._getPage(de,true);break;case C:dd=this._getPage(de,false);break;};}
else {switch(dg){case X:case v:case bu:case C:dd=this._getFirstSelectable();break;case P:case x:case k:case bx:dd=this._getLastSelectable();break;};}
;if(dd!==null){switch(df){case bt:case h:this._setSelectedItem(dd);break;case bq:this._setLeadItem(dd);break;case U:if(db){var dh=this._getAnchorItem();if(dh===null){this._setAnchorItem(dh=this._getFirstSelectable());}
;this._setLeadItem(dd);this._selectItemRange(dh,dd,da);}
else {this._setAnchorItem(dd);this._setLeadItem(dd);if(!da){this._setSelectedItem(dd);}
;}
;break;};this.__mY=this._getScroll().top;this._scrollItemIntoView(dd);}
;}
;if(dc){event.stop();this._fireChange(S);}
;this._userInteraction=false;}
,_selectAllItems:function(){var di=this.getSelectables();for(var i=0,l=di.length;i<l;i++ ){this._addToSelection(di[i]);}
;}
,_clearSelection:function(){var dj=this.__fC;for(var dk in dj){this._removeFromSelection(dj[dk]);}
;this.__fC={};}
,_selectItemRange:function(dl,dq,dn){var dr=this._getSelectableRange(dl,dq);if(!dn){var dp=this.__fC;var ds=this.__nb(dr);for(var dm in dp){if(!ds[dm]){this._removeFromSelection(dp[dm]);}
;}
;}
;for(var i=0,l=dr.length;i<l;i++ ){this._addToSelection(dr[i]);}
;}
,_deselectItemRange:function(dv,dt){var du=this._getSelectableRange(dv,dt);for(var i=0,l=du.length;i<l;i++ ){this._removeFromSelection(du[i]);}
;}
,__nb:function(dx){var dy={};var dw;for(var i=0,l=dx.length;i<l;i++ ){dw=dx[i];dy[this._selectableToHashCode(dw)]=dw;}
;return dy;}
,_getSelectedItem:function(){for(var dz in this.__fC){return this.__fC[dz];}
;return null;}
,_setSelectedItem:function(dB){if(this._isSelectable(dB)){var dA=this.__fC;var dC=this._selectableToHashCode(dB);if(!dA[dC]||(dA.length>=2)){this._clearSelection();this._addToSelection(dB);}
;}
;}
,_addToSelection:function(dD){var dE=this._selectableToHashCode(dD);if(this.__fC[dE]==null&&this._isSelectable(dD)){this.__fC[dE]=dD;this._styleSelectable(dD,R,true);this.__mT=true;}
;}
,_toggleInSelection:function(dF){var dG=this._selectableToHashCode(dF);if(this.__fC[dG]==null){this.__fC[dG]=dF;this._styleSelectable(dF,R,true);}
else {delete this.__fC[dG];this._styleSelectable(dF,R,false);}
;this.__mT=true;}
,_removeFromSelection:function(dH){var dI=this._selectableToHashCode(dH);if(this.__fC[dI]!=null){delete this.__fC[dI];this._styleSelectable(dH,R,false);this.__mT=true;}
;}
,_replaceMultiSelection:function(dL){if(dL.length===0){this.clearSelection();return;}
;var dM=false;var dP,dO;var dK={};for(var i=0,l=dL.length;i<l;i++ ){dP=dL[i];if(this._isSelectable(dP)){dO=this._selectableToHashCode(dP);dK[dO]=dP;}
;}
;var dQ=dL[0];var dJ=dP;var dN=this.__fC;for(var dO in dN){if(dK[dO]){delete dK[dO];}
else {dP=dN[dO];delete dN[dO];this._styleSelectable(dP,R,false);dM=true;}
;}
;for(var dO in dK){dP=dN[dO]=dK[dO];this._styleSelectable(dP,R,true);dM=true;}
;if(!dM){return false;}
;this._scrollItemIntoView(dJ);this._setLeadItem(dQ);this._setAnchorItem(dQ);this.__mT=true;this._fireChange();}
,_fireChange:function(dR){if(this.__mT){this.__mU=dR||null;this.fireDataEvent(bs,this.getSelection());delete this.__mT;}
;}
,_applyDefaultSelection:function(dS){if(dS===true||this.getMode()===h&&this.isSelectionEmpty()){var dT=this._getFirstSelectable();if(dT!=null){this.selectItem(dT);}
;return dT;}
;return null;}
},destruct:function(){this._disposeObjects(bB);this.__fC=this.__mX=this.__mW=null;this.__mV=null;}
});}
)();
...
,addLabel:function(M){var N=this.getChildControl(C);if(this.__nc){this._remove(N);}
...
,__ng:function(){return qx.util.PropertyUtil.getUserValue(this,u);}
...
(function(){var a="open",b="abstract",c="__fV",d="qx.debug",e="'. It is not a child of this tree item.",f="addItem",g="visible",h="excluded",j="__nm",k="removeItem",m="Invalid child index: ",n="Cannot remove treeitem '",o="qx.ui.tree.core.AbstractTreeItem";qx.Class.define(o,{extend:qx.ui.tree.core.AbstractItem,type:b,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__fV=[];}
,properties:{parent:{check:o,nullable:true}},members:{__fV:null,__nm:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
;}
,getChildren:function(){return this.__fV;}
,hasChildren:function(){return this.__fV?this.__fV.length>0:false;}
...
;this.__fV.push(Q);if(!N){this.__nn();}
;if(P){Q.recursiveAddToWidgetQueue();P.fireNonBubblingEvent(f,qx.event.type.Data,[Q]);}
;}
;if(P){qx.ui.core.queue.Widget.add(this);}
;}
,addAt:function(X,T){if(qx.core.Environment.get(d)){this.assert(T<=this.__fV.length&&T>=0,m+T);}
;if(T==this.__fV.length){this.add(X);return;}
;var W=X.getParent();if(W){W.remove(X);}
;var U=this.getChildrenContainer();X.setParent(this);var V=this.hasChildren();var S=this.__fV[T];U.addBefore(X,S);if(X.hasChildren()){U.addAfter(X.getChildrenContainer(),X);}
;qx.lang.Array.insertAt(this.__fV,X,T);if(!V){this.__nn();}
;if(this.getTree()){X.recursiveAddToWidgetQueue();qx.ui.core.queue.Widget.add(this);}
;}
,addBefore:function(Y,bb){if(qx.core.Environment.get(d)){this.assert(this.__fV.indexOf(bb)>=0);}
;var ba=Y.getParent();if(ba){ba.remove(Y);}
;this.addAt(Y,this.__fV.indexOf(bb));}
,addAfter:function(bd,bc){if(qx.core.Environment.get(d)){this.assert(this.__fV.indexOf(bc)>=0);}
;var be=bd.getParent();if(be){be.remove(bd);}
;this.addAt(bd,this.__fV.indexOf(bc)+1);}
,addAtBegin:function(bf){this.addAt(bf,0);}
,remove:function(bk){for(var i=0,l=arguments.length;i<l;i++ ){var bj=arguments[i];if(this.__fV.indexOf(bj)==-1){this.warn(n+bj+e);return;}
...
;}
;qx.lang.Array.remove(this.__fV,bj);bj.setParent(null);bg.remove(bj);}
;var bh=this.getTree();if(bh){bh.fireNonBubblingEvent(k,qx.event.type.Data,[bj]);}
;qx.ui.core.queue.Widget.add(this);}
,removeAt:function(bl){var bm=this.__fV[bl];if(bm){this.remove(bm);}
;}
,removeAll:function(){var bn=this.__fV.concat();for(var i=this.__fV.length-1;i>=0;i-- ){this.remove(this.__fV[i]);}
;return bn;}
},destruct:function(){this._disposeArray(c);this._disposeObjects(j);}
});}
)();
...
(function(){var a="Enter",b="_applyOpenMode",c="excluded",d="Space",f="Left",g="Boolean",h="changeOpenMode",j="_applyRootOpenClose",k="visible",l="changeSelection",m="qx.ui.tree.Tree",n="qx.event.type.Data",o="qx.ui.tree.core.AbstractTreeItem",p="tree",q="dbltap",r="_applyHideRoot",s="changeRoot",t="__nC",u="_applyRoot",v="keypress",w="none",x="pane",y="tap",z="Right";qx.Class.define(m,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__nC=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(x).add(this.__nC);this.initOpenMode();this.initRootOpenClose();this.addListener(l,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:n,removeItem:n},properties:{openMode:{check:[y,q,w],init:q,apply:b,event:h,themeable:true},root:{check:o,init:null,nullable:true,event:s,apply:u},hideRoot:{check:g,init:false,apply:r},rootOpenClose:{check:g,init:false,apply:j},appearance:{refine:true,init:p},focusable:{refine:true,init:true}},members:{__nC:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__nC;}
...
,_getContentPaddingTarget:function(){return this.__nC;}
