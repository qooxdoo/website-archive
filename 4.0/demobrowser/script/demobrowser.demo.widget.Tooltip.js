...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Tooltip.b2593338c622.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__Qo:4,__Qp:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Qp/this.__Qo),column:this.__Qp%this.__Qo});this.__Qp+=1;}
