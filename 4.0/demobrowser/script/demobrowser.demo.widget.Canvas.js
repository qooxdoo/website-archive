...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Canvas","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas.bce0af9ee841.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Window containing a Canvas - synced coordinates",b="redraw",c="html.canvas",d="Canvas is not supported by this browser!",f="center",g="Window containing a Canvas - static coordinates",h="Resize the windows to see the effect.",i="Canvas is not support by this browser!",j="rgba(0, 0, 200, 0.5)",k="middle",l="demobrowser.demo.widget.Canvas",m="rgb(200,0,0)";qx.Class.define(l,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.basic.Label(h);this.getRoot().add(r,{left:10,top:10});var q=new qx.ui.window.Window(g).set({width:200,height:200});q.setLayout(new qx.ui.layout.Canvas());if(!qx.core.Environment.get(c)){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox());p.add(new qx.ui.basic.Label(d).set({rich:true,alignX:f,alignY:k}));}
else {var p=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:false});p.addListener(b,this.draw,this);}
;q.add(p,{edge:0});this.getRoot().add(q,{left:30,top:40});q.open();var n=new qx.ui.window.Window(a).set({width:200,height:200});n.setLayout(new qx.ui.layout.Canvas());if(!qx.core.Environment.get(c)){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox());o.add(new qx.ui.basic.Label(i).set({rich:true,alignX:f,alignY:k}));}
else {var o=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:true});o.addListener(b,this.draw,this);}
;n.add(o,{edge:0});this.getRoot().add(n,{left:30,top:250});n.open();}
,draw:function(e){var s=e.getData();var t=s.context;t.fillStyle=m;t.fillRect(20,20,105,100);t.fillStyle=j;t.fillRect(70,70,105,100);}
}});}
)();
...
(function(){var a="resize",b="_applyCanvasWidth",c="redraw",d="Boolean",f="_applyCanvasHeight",g="qx.ui.embed.Canvas",h="Integer",i="__EU",j="qx.event.type.Data";qx.Class.define(g,{extend:qx.ui.core.Widget,construct:function(l,k){qx.ui.core.Widget.call(this);this.__EU=new qx.util.DeferredCall(this.__EV,this);this.addListener(a,this._onResize,this);if(l!==undefined){this.setCanvasWidth(l);}
;if(k!==undefined){this.setCanvasHeight(k);}
;}
,events:{"redraw":j},properties:{syncDimension:{check:d,init:false},canvasWidth:{check:h,init:300,apply:b},canvasHeight:{check:h,init:150,apply:f}},members:{__EU:null,_createContentElement:function(){return new qx.html.Canvas();}
,__EV:function(){var n=this.getContentElement();var p=n.getHeight();var m=n.getWidth();var o=n.getContext2d();this._draw(m,p,o);this.fireNonBubblingEvent(c,qx.event.type.Data,[{width:m,height:p,context:o}]);}
,_applyCanvasWidth:function(r,q){this.getContentElement().setWidth(r);this.__EU.schedule();}
,_applyCanvasHeight:function(t,s){this.getContentElement().setHeight(t);this.__EU.schedule();}
,update:function(){this.__EU.schedule();}
,_onResize:function(e){var u=e.getData();if(this.getSyncDimension()){this.setCanvasHeight(u.height);this.setCanvasWidth(u.width);}
;}
,getContext2d:function(){return this.getContentElement().getContext2d();}
,_draw:function(v,x,w){}
},destruct:function(){this._disposeObjects(i);}
});}
)();
(function(){var a="canvas",b="2d",c="qx.html.Canvas";qx.Class.define(c,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__iV=document.createElement(a);}
,members:{__iV:null,_createDomElement:function(){return this.__iV;}
,getCanvas:function(){return this.__iV;}
,setWidth:function(f){this.__iV.width=f;}
,getWidth:function(){return this.__iV.width;}
,setHeight:function(g){this.__iV.height=g;}
,getHeight:function(){return this.__iV.height;}
,getContext2d:function(){return this.__iV.getContext(b);}
