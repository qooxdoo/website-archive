...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.MouseEvent_LowLevel.ed6159d90d17.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__OW=f+p.join(c)+a;this.__OX=o||50;this.__OY=n;this._clearLog();}
,_clearLog:function(){this.__OY.innerHTML=this.__OW+k;this.__Pa=[];}
,_log:function(q){this.__Pa.unshift(q);this.__Pa=this.__Pa.slice(0,this.__OX);var r=[this.__OW];for(var i=0;i<this.__Pa.length;i++ ){r.push(g,this.__Pa[i].join(e),l);}
;r.push(k);this.__OY.innerHTML=r.join(d);this.__OY.scrollTop=0;}
,__OW:null,__OX:null,__OY:null,__Pa:null},destruct:function(){this.__OY=this.__Pa=null;}
});}
)();
...
(function(){var a="demobrowser.demo.event.MouseEvent_LowLevel",b="mouseout",c="mousedown",d="clientX",f="dblclick",g="relatedTarget",h="mouse",j="button",k="mousemove",l="screenX",m="logger",n="",o="_",p="mouseover",q="check_",r="click",s="Event",t="Target",u="clientY",v="mouseup",w="contextmenu",x="change",y="screenY";qx.Class.define(a,{extend:demobrowser.demo.event.EventDemo,members:{__Pc:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this.__Pc=qx.lang.Function.bind(this.logMouseEvent,this);this._initLogger([t,s,j,d,u,l,y,g],document.getElementById(m),50);var z=document.getElementById(h);var B=[c,v,r,f,w,k,p,b];for(var i=0;i<B.length;i++ ){var A=document.getElementById(q+B[i]);if(A.checked){qx.bom.Event.addNativeListener(z,B[i],this.__Pc);}
;qx.bom.Event.addNativeListener(A,x,qx.lang.Function.bind(this.__Pb,this));}
;}
,__Pb:function(e){var E=qx.bom.Event.getTarget(e);var F=E.id.split(o)[1];var C=E.checked;var D=document.getElementById(h);if(C){qx.bom.Event.addNativeListener(D,F,this.__Pc);}
else {qx.bom.Event.removeNativeListener(D,F,this.__Pc);}
;}
