...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.ea2bab41684b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="no",b="px",c="qx.bom.Window",d="Cross-Domain Scripting problem: Could not resize window!",e="' is not supported for native windows.",f="interval",g="dialogWidth",h="resizable",i=":",j="yes",k="dialogTop",l="qxNativeWindow",m="Cross-Domain Scripting problem: Could not move window!",n="",o="Option '",p="javascript:/",q="dialogLeft",r="dialogHeight",s="' is not supported for modal windows.",t='load',u="scrollbars",v="=",w=";",x="scroll",y=",";qx.Class.define(c,{statics:{__lg:null,__Jh:null,__ju:null,__Ji:{"top":k,left:q,width:g,height:r,scrollbars:x,resizable:h},__Jj:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__Jk:function(){return window.showModalDialog!=null;}
,open:function(z,name,H,E,A,D,self){var C=null;if(z==null){z=p;}
;if(name==null){name=l+new Date().getTime();}
;if(A==null){A=true;}
;var G=this.__Jl(H,E&&A);if(E){if(this.__Jk()&&A){C=window.showModalDialog(z,[window.self],G);}
else {this.getBlocker().block();if(this.__ju==null){this.__ju=new qx.event.Timer(500);this.__ju.addListener(f,this.__Jm,this);}
;this.__Jh=window.open(z,name,G);this.__ju.restart();C=this.__Jh;}
;}
...
;return C;}
,__Jl:function(K,O){var M;var J;var N=[];if(O&&this.__Jk()){for(var L in K){if(qx.bom.Window.__Ji[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__Ji[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Jj[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__Jm:function(){if(this.isClosed(this.__Jh)){this.getBlocker().unblock();this.__ju.stop();}
;}
