...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.7398d8b0f9e6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="__Qb",c="__cv",d="Flash Player Version",f="right",g="qooxdoo is the best!",h="Message from Flash:",i="execute",j="Simple demo with FlashVars",k="__Qd",l="bgcolor",m="demobrowser.demo.widget.Flash",n="demobrowser/demo/flash/TestFlash.swf",o="1) no pop-up or advertising blocker is activated.\n",p="Send to Flash",q="demobrowser/demo/flash/FlashVersion.swf",r="No message.",s="Flash:",t="<b>qooxdoo:</b>",u="demobrowser.demo.widget.Flash.sendMessage",v="demobrowser.demo.widget.Flash.flashReady",w="Couldn't connect to Flash Player! Please make sure that:\n",x="demobrowser/demo/flash/fo_tester.swf",y="this is passed in via FlashVars",z="Two way communication (ActionScript <-> JavaScript)",A="__Qc",B="Message to Flash:",C="__FU",D="Show Flash Player version",E="noscale",F="#FF6600";qx.Class.define(m,{extend:qx.application.Standalone,members:{__cv:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(j);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(z);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cv=this.createWindow();G.add(this.__cv,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:y};var M=new qx.ui.embed.Flash(x).set({scale:E,variables:L});M.getContentElement().setParam(l,F);N.add(M,{flex:1});var O=new qx.ui.form.Button(D);O.addListener(i,function(){this.__cv.open();}
,this);N.add(O);return N;}
,__FU:null,__Qb:null,__Qc:null,__Qd:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(t).set({rich:true}));Q.add(new qx.ui.basic.Label(h));this.__Qb=new qx.ui.form.TextArea(r);this.__Qb.setEnabled(false);Q.add(this.__Qb,{flex:1});Q.add(new qx.ui.basic.Label(B));this.__Qc=new qx.ui.form.TextArea(g);Q.add(this.__Qc,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));this.__Qd=new qx.ui.form.Button(p);this.__Qd.setEnabled(false);this.__Qd.addListener(i,function(e){this.__FU.getFlashElement().sendMessage(this.__Qc.getValue());}
,this);S.add(this.__Qd);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(s).set({rich:true}));this.__FU=new qx.ui.embed.Flash(n);this.__FU.setVariables({init:v});P.add(this.__FU,{flex:1});return R;}
,sendMessage:function(T){this.__Qb.setValue(T);}
,initFlash:function(){if(this.__FU.getFlashElement().setup){this.__FU.getFlashElement().setup(u);this.__Qd.setEnabled(true);}
else {alert(w+o+a);}
;}
},statics:{__Qe:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Qe=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Qe.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Qe.initFlash();}
},destruct:function(){this._disposeObjects(b,A,k,C,c);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__FK){this.__FK=new Date().getTime();}
;var bp=new Date().getTime()-this.__FK;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__FK=null;}
;}
else {this.fireEvent(p);this.__FK=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__FL(c,bB);}
,_applyScale:function(bD,bC){this.__FL(h,bD);}
,_applyWmode:function(bF,bE){this.__FL(m,bF);}
,_applyPlay:function(bH,bG){this.__FL(I,bH);}
,_applyLoop:function(bJ,bI){this.__FL(s,bJ);}
,_applyMenu:function(bL,bK){this.__FL(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__FL(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__FL(z,bP);}
,__FL:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__FR={};this.__FS={};this.__FT={};}
,members:{__FR:null,__FT:null,__FS:null,__FU:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__FU=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__FS,this.__FR);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__FU){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__FU){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__FS;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__FU){throw new Error(d);}
;this.__FS=t;}
,getAttributes:function(){return this.__FT;}
...
else if(this.__FU){throw new Error(j);}
;if(v===null||v===undefined){delete this.__FT[u];}
else {this.__FT[u]=v;}
;}
,getParams:function(){return this.__FR;}
...
;}
;}
;if(this.__FU){throw new Error(l);}
;if(x===null||x===undefined){delete this.__FR[w];}
else {this.__FR[w]=x;}
;}
,getFlashElement:function(){return this.__FU;}
},destruct:function(){if(this.__FU){qx.bom.Flash.destroy(this.__FU);}
;this.__FR=this.__FS=this.__FT=null;}
});}
)();
