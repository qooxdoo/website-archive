...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.c7b11763f159.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__oU=document||window.document;this.__HP();var self=this;qx.bom.Event.addNativeListener(this.__oU,this.__du,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__oU:null,__HN:null,__HO:null,__du:null,__HP:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__oU[m]!=undefined){this.__HN=m;this.__du=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__oU[m]!=undefined){this.__HO=m;break;}
;}
;if(this.__HN==null){this.__HN=k;this.__du=c;}
;if(this.__HO==null){this.__HO=b;}
;}
,isHidden:function(){return !!this.__oU[this.__HN];}
,getVisibilityState:function(){return this.__oU[this.__HO]||d;}
}});}
)();
