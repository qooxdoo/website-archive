...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.7c2488c77b91.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:d,apply:g}},members:{_storage:null,__Ek:null,_applyModel:function(l,k){if(k){k.removeListenerById(this.__Ek);k.dispose();this.__Ek=null;}
;if(l){this.__Ek=l.addListener(f,this.__El,this);this.__El();}
else {this._storage.removeItem(this._key);}
;}
,__El:function(){var m=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,m);}
