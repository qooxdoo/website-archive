...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker.fbfa4933a805.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__cN();}
,members:{__Jn:null,__CD:null,__Jo:null,__Jp:false,__Jq:10000,__Jr:0,__Js:f,block:function(r){if(!this.__Jp){this.__Jo=r;var q=this.__Jv();this.__Jw(q);this.__Jp=true;}
;}
,unblock:function(){if(this.__Jp){this.__Jx();this.__Jp=false;}
;}
,isBlocked:function(){return this.__Jp;}
,getBlockerElement:function(){return this.__CD;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__CD,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__CD,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__CD,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__CD);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__CD,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__CD,h);}
,__cN:function(){this.__Jt();if((qx.core.Environment.get(j)==b)){this.__Ju();}
;qx.event.Registration.addListener(window,a,this.__yK,this);}
,__Jt:function(){this.__CD=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__CD,{display:d,opacity:this.__Jr,backgroundColor:this.__Js});this.setBlockerZIndex(this.__Jq);}
,__Ju:function(){this.__Jn=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Jn,l,false);qx.bom.element.Attribute.set(this.__Jn,i,n);qx.bom.element.Style.setStyles(this.__Jn,{display:d,opacity:this.__Jr});}
,__Jv:function(){var v={position:p};if(this.__Jz()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Jo)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Jo)+g;v.left=qx.bom.element.Location.getLeft(this.__Jo)+g;v.top=qx.bom.element.Location.getTop(this.__Jo)+g;}
;return v;}
,__Jw:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__CD,w);qx.dom.Element.insertEnd(this.__CD,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Jn,w);qx.dom.Element.insertEnd(this.__Jn,document.body);}
;}
,__Jx:function(){qx.dom.Element.remove(this.__CD);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Jn);}
;}
,__yK:function(e){if(this.__Jz()){this.__Jy({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Jy(y);}
,this,0);}
;}
,__Jy:function(z){qx.bom.element.Style.setStyles(this.__CD,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Jn,z);}
;}
,__Jz:function(){return (this.__Jo==null||qx.dom.Node.isWindow(this.__Jo)||qx.dom.Node.isDocument(this.__Jo));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__yK,this);this.__Jn=this.__CD=this.__Jo=null;}
});}
)();
