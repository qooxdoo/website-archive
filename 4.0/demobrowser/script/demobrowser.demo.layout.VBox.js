...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox.dd40bfa47661.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.layout.VBox",b="yellow",c="middle",d="bottom",e="center",f="green",g="left",h="right",i="main";qx.Class.define(a,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});scroll.add(j);j.add(this.getBox1());j.add(this.getBox2());j.add(this.getBox3());j.add(this.getBox4());j.add(this.getBox5());j.add(this.getBox6());j.add(this.getBox7());}
,getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:b,allowGrowY:false});k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));return k;}
,getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:b,minWidth:60,allowGrowY:false});l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,maxWidth:40,alignX:g}));l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,maxWidth:40,alignX:e}));l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,maxWidth:40,alignX:h}));return l;}
,getBox3:function(){var m=new qx.ui.layout.VBox();var n=new qx.ui.container.Composite(m).set({decorator:i,backgroundColor:b,height:300,allowGrowY:false});m.setSpacing(5);m.setAlignY(d);n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));return n;}
,getBox4:function(){var o=new qx.ui.layout.VBox();var p=new qx.ui.container.Composite(o).set({decorator:i,backgroundColor:b,height:300,allowGrowY:false});o.setSpacing(5);o.setAlignY(c);p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:f}));return p;}
,getBox5:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:b,allowGrowY:false});var t=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10});var s=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10,marginTop:20});var r=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10});q.add(t);q.add(s);q.add(r);return q;}
,getBox6:function(){var u=new qx.ui.layout.VBox();var w=new qx.ui.container.Composite(u).set({decorator:i,backgroundColor:b,height:300,allowGrowY:false});u.setSpacing(5);u.setAlignY(d);var y=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10});var x=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10,marginTop:20});var v=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10});w.add(y);w.add(x);w.add(v);return w;}
,getBox7:function(){var z=new qx.ui.layout.VBox();var B=new qx.ui.container.Composite(z).set({decorator:i,backgroundColor:b,height:300,allowGrowY:false});z.setSpacing(5);z.setAlignY(c);var D=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10});var C=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10,marginTop:20});var A=new qx.ui.core.Widget().set({decorator:i,backgroundColor:f,marginBottom:10});B.add(D);B.add(C);B.add(A);return B;}
}});}
)();
