...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage.4a661b5fabf6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="swipe",b="pinch",c="event.dispatchevent",d="longtap",e="rotate",f="track",g="trackstart",h="trackend",i="tap",j="qx.module.event.GestureHandler",k="roll",l="dbltap";qx.Bootstrap.define(j,{statics:{TYPES:[i,d,a,l,f,g,h,k,e,b],register:function(n,m){if(!n.__dq){n.__dq=0;}
;if(!n.$$gestureHandler){if(!qx.core.Environment.get(c)){if(!n.$$emitter){n.$$emitter=new qx.event.Emitter();}
;}
;n.$$gestureHandler=new qx.event.handler.GestureCore(n,n.$$emitter);}
;n.__dq++ ;}
,unregister:function(o){if(o.$$gestureHandler){o.__dq-- ;if(o.__dq===0){o.$$gestureHandler.dispose();o.$$gestureHandler=null;}
;}
;}
},defer:function(p){qxWeb.$registerEventHook(p.TYPES,p.register,p.unregister);}
});}
)();
...
(function(){var a="<em>no content</em>",b="Memory Storage",c="html.storage.local",d="html.storage.userdata",e="",f="list",g="save",h="value",i="Web Storage",j="demobrowser.demo.bom.Storage",k="<br>",l="tap",m="clear",n=":",o="using",p="remove",r="key",s="userData Storage";qx.Class.define(j,{extend:qx.application.Native,members:{__cU:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__cU=qx.bom.Storage.getLocal();var v=document.getElementById(g);var t=document.getElementById(m);var u=document.getElementById(p);var self=this;q(v).on(l,function(){var w=qx.bom.Input.getValue(document.getElementById(r));var x=qx.bom.Input.getValue(document.getElementById(h));self.__cU.setItem(w,x);self.updateList();}
);q(t).on(l,function(){self.__cU.clear();self.updateList();}
);q(u).on(l,function(){self.__cU.removeItem(self.__cU.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var y=document.getElementById(f);y.innerHTML=e;this.__cU.forEach(function(z,A){y.innerHTML+=z+n+A+k;}
,y);if(y.innerHTML==e){y.innerHTML=a;}
;}
,setUsing:function(){var B=document.getElementById(o);if(qx.core.Environment.get(c)){B.innerHTML=i;}
else if(qx.core.Environment.get(d)){B.innerHTML=s;}
else {B.innerHTML=b;}
;}
}});}
)();
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__Em:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__En:null,__Eo:null,getLocal:function(){if(this.__En){return this.__En;}
;return this.__En=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__Eo){return this.__Eo;}
;return this.__Eo=new qx.bom.storage.Web(b);}
...
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__En:null,__Eo:null,__ch:0,getLocal:function(){if(this.__En){return this.__En;}
;return this.__En=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__Eo){return this.__Eo;}
;return this.__Eo=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__Ep=document.createElement(f);this.__Ep.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__Ep);this.__Ep.addBehavior(j);this.__Eq=m;this.__Ep.load(this.__Eq);this.__cU={};this.__Er={};var l=this.__Ep.getAttribute(d+qx.bom.storage.UserData.__ch);while(l!=undefined){l=qx.lang.Json.parse(l);this.__cU[l.key]=l.value;this.__Er[l.key]=d+qx.bom.storage.UserData.__ch;qx.bom.storage.UserData.__ch++ ;l=this.__Ep.getAttribute(d+qx.bom.storage.UserData.__ch);}
;}
,members:{__Ep:null,__Eq:h,__cU:null,__Er:null,getStorage:function(){return this.__cU;}
,getLength:function(){return Object.keys(this.__cU).length;}
,setItem:function(n,p){if(this.__Er[n]){var o=this.__Er[n];}
else {var o=d+qx.bom.storage.UserData.__ch;qx.bom.storage.UserData.__ch++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__Ep.setAttribute(o,q);this.__Ep.save(this.__Eq);this.__cU[n]=p;this.__Er[n]=o;}
,getItem:function(r){return this.__cU[r]||null;}
,removeItem:function(v){var u=this.__Er[v];if(u==undefined){return;}
;this.__Ep.removeAttribute(u);qx.bom.storage.UserData.__ch-- ;delete this.__cU[v];delete this.__Er[v];var t=d+qx.bom.storage.UserData.__ch;if(this.__Ep.getAttribute(t)){var w=this.__Ep.getAttribute(d+qx.bom.storage.UserData.__ch);this.__Ep.removeAttribute(t);this.__Ep.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__Er[s]=u;}
;this.__Ep.save(this.__Eq);}
,clear:function(){for(var x in this.__Er){this.__Ep.removeAttribute(this.__Er[x]);}
;this.__Ep.save(this.__Eq);this.__cU={};this.__Er={};}
,getKey:function(y){return Object.keys(this.__cU)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__En:null,__Eo:null,getLocal:function(){if(this.__En){return this.__En;}
;return this.__En=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__Eo){return this.__Eo;}
;return this.__Eo=new qx.bom.storage.Memory();}
},construct:function(){this.__cU={};}
,members:{__cU:null,getStorage:function(){return this.__cU;}
,getLength:function(){return Object.keys(this.__cU).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__cU[b]=c;}
,getItem:function(e){var d=this.__cU[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__cU[f];}
,clear:function(){this.__cU={};}
,getKey:function(h){var g=Object.keys(this.__cU);return g[h];}
