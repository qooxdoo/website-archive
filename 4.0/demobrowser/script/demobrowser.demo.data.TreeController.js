...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.TreeController.bd93a08783dd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="_applyDelegate",c="qx.core.Object",d="_applyLabelPath",f="icon",g="change",h="label",k="' twice.",l="_applyTarget",m="changeTarget",n="_applyIconPath",o="Can not reverse bind the same target property '",p="_applyLabelOptions",q="_applyChildPath",r="_applyIconOptions",s="qx.data.controller.Tree",t="String",u="Can not bind the same target property '",v="_applyModel",w="get";qx.Class.define(s,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(y,z,A,x){qx.core.Object.call(this);this.__bb={};this.__yw=[];this.__IX={};if(A!=null){this.setChildPath(A);}
;if(x!=null){this.setLabelPath(x);}
;if(y!=null){this.setModel(y);}
;if(z!=null){this.setTarget(z);}
;}
,properties:{model:{check:c,apply:v,event:a,nullable:true,dereference:true},target:{apply:l,event:m,init:null,nullable:true,dereference:true},childPath:{check:t,apply:q,nullable:true},labelPath:{check:t,apply:d,nullable:true},iconPath:{check:t,apply:n,nullable:true},labelOptions:{apply:p,nullable:true},iconOptions:{apply:r,nullable:true},delegate:{apply:b,init:null,nullable:true}},members:{__IX:null,__bb:null,__yw:null,__IY:null,_applyDelegate:function(C,B){this._setConfigureItem(C,B);this._setCreateItem(C,B);this._setBindItem(C,B);}
,_applyIconOptions:function(E,D){this.__yH();}
,_applyLabelOptions:function(G,F){this.__yH();}
,_applyTarget:function(I,H){if(H!=undefined){this.__CQ(H);}
;if(this.getModel()!=null){this.__Jc();}
;this._addChangeTargetListener(I,H);}
,_applyModel:function(K,J){this.__Jc();}
,_applyChildPath:function(M,L){this.__IY=L;this.__Jc();this.__IY=null;}
,_applyIconPath:function(O,N){this.__yH();}
,_applyLabelPath:function(Q,P){this.__Jc();}
,__Ja:function(R){var T=R.getTarget();var S=this.__IX[T.toHashCode()].treeNode;var U=this.__IX[T.toHashCode()].modelNode;this.__Jd(S,U);this._updateSelection();}
,__Jb:function(e){var X=e.getData();var bc=e.getOldData();var V=this.__IX[bc.toHashCode()];bc.removeListenerById(V.changeListenerId);delete this.__IX[bc.toHashCode()];V.modelNode.removeListenerById(V.changeChildernListenerId);var bd=V.modelNode;var bb=qx.Class.getPropertyDefinition(V.modelNode.constructor,this.getChildPath());var Y=bb.event;var ba=bd.addListener(Y,this.__Jb,this);var W=V.treeNode;this.__IX[X.toHashCode()]={modelNode:bd,treeNode:W,changeListenerId:V.changeListenerId,changeChildernListenerId:ba};this.__Jd(W,bd);this._updateSelection();}
...
;return be;}
,__Jc:function(){if(this.getTarget()==null||this.getChildPath()==null){return;}
...
;this.__CQ();if(this.getModel()!=null){var bg=this._createItem();bg.setModel(this.getModel());this.__xy(this.getModel(),bg);this.__Jd(bg,this.getModel());this.getTarget().setRoot(bg);}
;}
,__Jd:function(bn,br){if(br[w+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;}
;var bj=br[w+qx.lang.String.firstUp(this.getChildPath())]();if(this.__IX[bj.toHashCode()]==undefined){var bl=bj.addListener(g,this.__Ja,this);var bp=qx.Class.getPropertyDefinition(br.constructor,this.getChildPath());var bm=bp.event;var bq=br.addListener(bm,this.__Jb,this);this.__IX[bj.toHashCode()]={modelNode:br,treeNode:bn,changeListenerId:bl,changeChildernListenerId:bq};}
...
;}
else {var bo=this._createItem();bo.setModel(bj.getItem(i));bn.addAt(bo,i);this.__xy(bj.getItem(i),bo);this.__Jd(bo,bj.getItem(i));}
;}
;}
;for(var i=bn.getChildren().length-1;i>=bj.length;i-- ){var bk=bn.getChildren()[i];this.__Jf(bk,bn);}
;}
,__CQ:function(bt){if(bt==null){bt=this.getTarget();}
;if(bt==null){return;}
;var bv=bt.getRoot();if(bv!=null){bt.setRoot(null);this.__Je(bv);var bu=bv.getModel();if(bu){this.__mE(bu);}
;bv.destroy();this.__IX={};}
;}
,__Je:function(bw){var bx=bw.getChildren()||[];for(var i=bx.length-1;i>=0;i-- ){if(bx[i].getChildren().length>0){this.__Je(bx[i]);}
;this.__Jf(bx[i],bw);}
;}
,__Jf:function(bz,bC){var bD=bz.getModel();var by=this.__IY||this.getChildPath();var bA=w+qx.lang.String.firstUp(by);if(bD[bA]!=undefined){var bE=bD[bA]();var bB=this.__IX[bE.toHashCode()];bE.removeListenerById(bB.changeListenerId);bD.removeListenerById(bB.changeChildernListenerId);this.__Je(bz);delete this.__IX[bE.toHashCode()];}
...
;this._startSelectionModification();this.__CQ();this.__Jc();this._endSelectionModification();this._updateSelection();}
,_setBindItem:function(cn,cm){if(cn!=null&&cn.bindItem!=null){if(cm!=null&&cm.bindItem!=null&&cn.bindItem==cm.bindItem){return;}
;this.__Jc();}
;}
},destruct:function(){this.setTarget(null);this.setModel(null);this.__bb=this.__IX=this.__yw=null;}
});}
)();
