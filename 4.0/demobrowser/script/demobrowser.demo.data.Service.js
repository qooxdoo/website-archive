...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.90fb091e756a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.ui.form.List",b="text",c="Boolean",d="one",f="addChildWidget",g="_applySpacing",h="Enter",j="Integer",k="action",m="keyinput",n="qx.event.type.Data",o="addItem",p="vertical",q="removeChildWidget",r="",s="_applyOrientation",t="single",u="keypress",v="__nC",w="list",x="horizontal",y="label",z="pane",A="removeItem";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__nC=this._createListItemContainer();this.__nC.addListener(f,this._onAddChild,this);this.__nC.addListener(q,this._onRemoveChild,this);this.getChildControl(z).add(this.__nC);if(B){this.setOrientation(x);}
else {this.initOrientation();}
;this.addListener(u,this._onKeyPress);this.addListener(m,this._onKeyInput);this.__yn=r;}
,events:{addItem:n,removeItem:n},properties:{appearance:{refine:true,init:w},focusable:{refine:true,init:true},orientation:{check:[x,p],init:p,apply:s},spacing:{check:j,init:0,apply:g,themeable:true},enableInlineFind:{check:c,init:true}},members:{__yn:null,__yo:null,__nC:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__nC;}
...
,_applyOrientation:function(F,C){var D=F===x;var E=D?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__nC;content.setLayout(E);content.setAllowGrowX(!D);content.setAllowGrowY(D);this._applySpacing(this.getSpacing());}
,_applySpacing:function(H,G){this.__nC.getLayout().setSpacing(H);}
...
;if(((new Date).valueOf()-this.__yo)>1000){this.__yn=r;}
...
,__uw:null,__uu:null,__uo:null,__up:null,__uq:null,__ue:null,__ur:null,__ut:null,__uh:null,__fx:null,__uy:null,__ux:null,__uv:null,__us:null,__uz:function(){this.__uw=this._createNativeXhr();this.__uw.onreadystatechange=this.__uo;if(this.__uw.onabort){this.__uw.onabort=this.__up;}
...
;}
,__uD:function(){if(this.__fx){this._emit(N);if(qx.core.Environment.get(F)===z){this._emit(n);}
;this.__fx=false;}
...
;return bs;}
,__uF:function(){var bt=this.__uw;this.readyState=qx.bom.request.Xhr.DONE;this.__fx=true;bt.abort();this.responseText=u;this.responseXML=null;this.__uC();}
...
(function(){var a="url: ",b="qx.debug.io",c="qx.bom.request.Script",d="Invalid state",e="head",f="error",g="loadend",h="qx.debug",i="script",j="load",k="Unknown response headers",l="browser.documentmode",m="abort",n="",o="Received native readyState: loaded",p="readystatechange",q="Response header cannot be determined for ",r="requests made with script transport.",s="opera",t="unknown",u="Open native request with ",v="Response headers cannot be determined for",w="mshtml",x="engine.name",y="Detected error",z="Send native request",A="on",B="timeout",C="Unknown environment key at this phase",D="Received native load";qx.Bootstrap.define(c,{construct:function(){this.__yh();this.__yc=qx.Bootstrap.bind(this._onNativeLoad,this);this.__yd=qx.Bootstrap.bind(this._onNativeError,this);this.__ue=qx.Bootstrap.bind(this._onTimeout,this);this.__ye=document.head||document.getElementsByTagName(e)[0]||document.documentElement;this._emitter=new qx.event.Emitter();this.timeout=this.__yj()?0:15000;}
,events:{"readystatechange":c,"error":c,"loadend":c,"timeout":c,"abort":c,"load":c},members:{readyState:null,status:null,statusText:null,timeout:null,__yf:null,on:function(name,E,F){this._emitter.on(name,E,F);return this;}
,open:function(H,G){if(this.__uy){return;}
;this.__yh();this.__uh=null;this.__ut=G;if(this.__ym(b)){qx.Bootstrap.debug(qx.bom.request.Script,u+a+G);}
;this._readyStateChange(1);}
,setRequestHeader:function(I,J){if(this.__uy){return null;}
;var K={};if(this.readyState!==1){throw new Error(d);}
;K[I]=J;this.__ut=qx.util.Uri.appendParamsToUrl(this.__ut,K);return this;}
,send:function(){if(this.__uy){return null;}
;var M=this.__yk(),L=this.__ye,N=this;if(this.timeout>0){this.__fv=window.setTimeout(this.__ue,this.timeout);}
;if(this.__ym(b)){qx.Bootstrap.debug(qx.bom.request.Script,z);}
;L.insertBefore(M,L.firstChild);window.setTimeout(function(){N._readyStateChange(2);N._readyStateChange(3);}
);return this;}
,abort:function(){if(this.__uy){return null;}
;this.__uh=true;this.__yl();this._emit(m);return this;}
...
,onabort:function(){}
,ontimeout:function(){}
,getResponseHeader:function(O){if(this.__uy){return null;}
;if(this.__ym(h)){qx.Bootstrap.debug(q+r);}
;return t;}
,getAllResponseHeaders:function(){if(this.__uy){return null;}
;if(this.__ym(h)){qx.Bootstrap.debug(v+r);}
;return k;}
,setDetermineSuccess:function(P){this.__yf=P;}
,dispose:function(){var Q=this.__yg;if(!this.__uy){if(Q){Q.onload=Q.onreadystatechange=null;this.__yl();}
;if(this.__fv){window.clearTimeout(this.__fv);}
;this.__uy=true;}
;}
,isDisposed:function(){return !!this.__uy;}
,_getUrl:function(){return this.__ut;}
,_getScriptElement:function(){return this.__yg;}
,_onTimeout:function(){this.__yi();if(!this.__yj()){this._emit(f);}
;this._emit(B);if(!this.__yj()){this._emit(g);}
;}
,_onNativeLoad:function(){var S=this.__yg,R=this.__yf,T=this;if(this.__uh){return;}
;if(this.__ym(x)===w&&this.__ym(l)<9){if(!(/loaded|complete/).test(S.readyState)){return;}
else {if(this.__ym(b)){qx.Bootstrap.debug(qx.bom.request.Script,o);}
;}
;}
;if(this.__ym(b)){qx.Bootstrap.debug(qx.bom.request.Script,D);}
;if(R){if(!this.status){this.status=R()?200:500;}
;}
;if(this.status===500){if(this.__ym(b)){qx.Bootstrap.debug(qx.bom.request.Script,y);}
;}
;if(this.__fv){window.clearTimeout(this.__fv);}
;window.setTimeout(function(){T._success();T._readyStateChange(4);T._emit(j);T._emit(g);}
);}
,_onNativeError:function(){this.__yi();this._emit(f);this._emit(g);}
,__yg:null,__ye:null,__ut:n,__yc:null,__yd:null,__ue:null,__fv:null,__uh:null,__uy:null,__yh:function(){this.readyState=0;this.status=0;this.statusText=n;}
,_readyStateChange:function(U){this.readyState=U;this._emit(p);}
,_success:function(){this.__yl();this.readyState=4;if(!this.status){this.status=200;}
;this.statusText=n+this.status;}
,__yi:function(){this.__yl();this.readyState=4;this.status=0;this.statusText=null;}
,__yj:function(){var W=this.__ym(x)===w&&this.__ym(l)<9;var V=this.__ym(x)===s;return !(W||V);}
,__yk:function(){var X=this.__yg=document.createElement(i);X.src=this.__ut;X.onerror=this.__yd;X.onload=this.__yc;if(this.__ym(x)===w&&this.__ym(l)<9){X.onreadystatechange=this.__yc;}
;return X;}
,__yl:function(){var Y=this.__yg;if(Y&&Y.parentNode){this.__ye.removeChild(Y);}
;}
,__ym:function(ba){if(qx&&qx.core&&qx.core.Environment){return qx.core.Environment.get(ba);}
...
(function(){var a="qx.bom.request.Jsonp",b="callback",c="open",d="dispose",e="",f="qx",g="qx.debug",h="Expecting JavaScript response to call: ",i="_onNativeLoad",j=" already exists",k="Callback ",l="qx.debug.io",m=".callback",n="qx.bom.request.Jsonp.";qx.Bootstrap.define(a,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__uS();}
,members:{responseJson:null,__ch:null,__uL:null,__uM:null,__uN:null,__uO:null,__uP:null,__uy:null,__uQ:e,open:function(t,p){if(this.__uy){return;}
;var r={},q,s,o=this;this.responseJson=null;this.__uN=false;q=this.__uL||b;s=this.__uM||this.__uQ+n+this.__ch+m;if(!this.__uM){this.constructor[this.__ch]=this;}
else {if(!window[this.__uM]){this.__uO=true;window[this.__uM]=function(u){o.callback(u);}
;}
else {if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,k+this.__uM+j);}
;}
;}
;if(qx.core.Environment.get(l)){qx.Bootstrap.debug(qx.bom.request.Jsonp,h+s);}
;r[q]=s;this.__uP=p=qx.util.Uri.appendParamsToUrl(p,r);this.__gn(c,[t,p]);}
,callback:function(v){if(this.__uy){return;}
;this.__uN=true;if(qx.core.Environment.get(g)){v=qx.lang.Json.stringify(v);v=qx.lang.Json.parse(v);}
;this.responseJson=v;this.constructor[this.__ch]=undefined;this.__uR();}
,setCallbackParam:function(w){this.__uL=w;return this;}
,setCallbackName:function(name){this.__uM=name;return this;}
,setPrefix:function(x){this.__uQ=x;}
,getGeneratedUrl:function(){return this.__uP;}
,dispose:function(){this.__uR();this.__gn(d);}
,_onNativeLoad:function(){this.status=this.__uN?200:500;this.__gn(i);}
,__uR:function(){if(this.__uO&&window[this.__uM]){window[this.__uM]=undefined;this.__uO=false;}
;}
,__gn:function(z,y){qx.bom.request.Script.prototype[z].apply(this,y||[]);}
,__uS:function(){this.__ch=f+(new Date().valueOf())+(e+Math.random()).substring(2,5);}
}});}
)();
...
(function(){var a="changeModel",b="qx.core.Object",c="qx.data.controller.Object",d="get",e="[",f="reset",g="_applyModel",h="last";qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bb={};this.__gi=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__gi:null,__bb:null,_applyModel:function(o,l){for(var i=0;i<this.__gi.length;i++ ){var t=this.__gi[i][0];var q=this.__gi[i][1];var n=this.__gi[i][2];var r=this.__gi[i][3];var p=this.__gi[i][4];var m=this.__gi[i][5];if(l!=undefined&&!l.isDisposed()){this.__ws(t,q,n,l);}
...
;}
;}
,addTarget:function(z,w,u,x,y,v){this.__gi.push([z,w,u,x,y,v]);this.__wr(z,w,u,x,y,v);}
...
,removeTarget:function(K,J,L){this.__ws(K,J,L,this.getModel());for(var i=0;i<this.__gi.length;i++ ){if(this.__gi[i][0]==K&&this.__gi[i][1]==J&&this.__gi[i][2]==L){this.__gi.splice(i,1);}
;}
;}
