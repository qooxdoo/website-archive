...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.AutoSizeTextArea.c48541b611cc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,append:function(k){var l=this.__Es(k);Array.prototype.push.apply(this,l);return this;}
,prepend:function(m){var n=this.__Es(m);Array.prototype.splice.apply(this,[0,0].concat(n));return this;}
,__Es:function(o){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(o,c);}
