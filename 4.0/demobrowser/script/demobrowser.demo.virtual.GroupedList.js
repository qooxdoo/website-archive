...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList.bf4e32665902.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
};T.setDelegate(V);T.setSelection(this.__JV.getSelection());return U;}
...
};bb.setDelegate(bd);bb.setSelection(this.__JV.getSelection());return bc;}
},destruct:function(){this.__JV.dispose();this.__PR.dispose();this.__PS.dispose();this.__JV=this.__PR=this.__PS=null;}
});}
)();
