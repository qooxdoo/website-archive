...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Page","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Page.53b576ca31e5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="resize",b="qx.ui.root.Page",c="engine.name",d="mshtml",f="gecko",g="paddingLeft",h="$$widget",i="The root widget does not support 'left', or 'top' paddings!",j="div",k="left",l="paddingTop",m="qxIsRootPage",n="absolute";qx.Class.define(b,{extend:qx.ui.root.Abstract,construct:function(o){this.__oU=o;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(a,this.__yK,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==d)){this.setKeepFocus(true);}
;}
,members:{__ju:null,__oU:null,_createContentElement:function(){var q=this.__oU.createElement(j);this.__oU.body.appendChild(q);var p=new qx.html.Root(q);p.setStyles({position:n,textAlign:k});p.setAttribute(h,this.toHashCode());if((qx.core.Environment.get(c)==f)){p.setAttribute(m,1);}
;return p;}
...
,__yK:function(e){this.getContentElement().setStyles({width:0,height:0});}
...
},destruct:function(){this.__oU=null;}
});}
)();
...
(function(){var a="demobrowser.demo.root.Page",b="yellow",c="red",d="green",e="main",f="blue";qx.Class.define(a,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);var g=new qx.ui.container.Composite(new qx.ui.layout.HBox());var k=new qx.ui.core.Widget().set({backgroundColor:c,decorator:e,padding:10});var j=new qx.ui.core.Widget().set({backgroundColor:f,decorator:e});var i=new qx.ui.core.Widget().set({backgroundColor:d,decorator:e});var h=new qx.ui.core.Widget().set({backgroundColor:b,decorator:e});g.add(k);g.add(j);g.add(i);g.add(h);this.getRoot().add(g,{left:30,top:120});}
}});}
)();
