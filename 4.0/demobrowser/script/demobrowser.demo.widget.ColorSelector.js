...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorSelector.f6c6f7880caa.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,setValue:function(da){var cY;if(da==null){this.__pr=true;cY=[255,255,255];}
else {cY=qx.util.ColorUtil.stringToRgb(da);this.__pr=false;}
;this.__Cy=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__Cy=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pr?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pr=true;this.__Cy=true;this.setRed(255);this.setGreen(255);this.__Cy=false;this.setBlue(255);}
,__pt:function(){if(!this.__Cy){this.__pr=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__Cs===null){this.__Cs=bU;}
;if(this.__Cs!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__Cs!==n){this._setHexFromRgb();}
;switch(this.__Cs){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pt();if(this.__Cs===bU){this.__Cs=null;}
;}
,_applyGreen:function(de,dd){if(this.__Cs===null){this.__Cs=cq;}
;if(this.__Cs!==cK){this.getChildControl(O).setValue(de);}
;if(this.__Cs!==n){this._setHexFromRgb();}
;switch(this.__Cs){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pt();if(this.__Cs===cq){this.__Cs=null;}
;}
,_applyBlue:function(dg,df){if(this.__Cs===null){this.__Cs=d;}
;if(this.__Cs!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__Cs!==n){this._setHexFromRgb();}
;switch(this.__Cs){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pt();if(this.__Cs===d){this.__Cs=null;}
;}
,_applyHue:function(di,dh){if(this.__Cs===null){this.__Cs=cr;}
;if(this.__Cs!==F){this.getChildControl(cu).setValue(di);}
;if(this.__Cs!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__Cs){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__Cs===cr){this.__Cs=null;}
;}
,_applySaturation:function(dk,dj){if(this.__Cs===null){this.__Cs=s;}
;if(this.__Cs!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__Cs!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__Cs){case F:case R:case s:this._setRgbFromHue();};if(this.__Cs===s){this.__Cs=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__Cs===null){this.__Cs=c;}
;if(this.__Cs!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__Cs!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__Cs){case F:case P:case c:this._setRgbFromHue();};if(this.__Cs===c){this.__Cs=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__Cu=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__Cv=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__Cu=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__Cu===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__Cv=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__Cu=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__Cv,0,256);this.__Cs=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__Cs=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__Cu){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__Cu=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__Cu===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__Cw=location.top+(du.height/2)-dv.top;this.__Cx=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__Cu=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__Cw,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__Cx,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__Cs=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__Cs=null;}
,_setRedFromSpinner:function(){if(this.__Cs!==null){return;}
;this.__Cs=cK;this.setRed(this.getChildControl(m).getValue());this.__Cs=null;}
,_setGreenFromSpinner:function(){if(this.__Cs!==null){return;}
;this.__Cs=cK;this.setGreen(this.getChildControl(O).getValue());this.__Cs=null;}
,_setBlueFromSpinner:function(){if(this.__Cs!==null){return;}
;this.__Cs=cK;this.setBlue(this.getChildControl(cG).getValue());this.__Cs=null;}
,_setHueFromSpinner:function(){if(this.__Cs!==null){return;}
;this.__Cs=F;this.setHue(this.getChildControl(cu).getValue());this.__Cs=null;}
,_setSaturationFromSpinner:function(){if(this.__Cs!==null){return;}
;this.__Cs=F;this.setSaturation(this.getChildControl(cx).getValue());this.__Cs=null;}
,_setBrightnessFromSpinner:function(){if(this.__Cs!==null){return;}
;this.__Cs=F;this.setBrightness(this.getChildControl(bT).getValue());this.__Cs=null;}
,_onHexFieldChange:function(e){if(this.__Cs!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__Cs=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__Cs=null;}
...
,_setHueFromRgb:function(){switch(this.__Cs){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__Cs){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
