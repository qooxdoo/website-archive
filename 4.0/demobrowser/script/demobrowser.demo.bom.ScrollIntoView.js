...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.ScrollIntoView","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.ScrollIntoView.3a00e30c8d24.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="z6",b="z8",c=", scroll=",d="z5",e="z4",f="Height: ",g="z1",h="Width: ",j="z7",k="z3",m="z2",n=", client=",o=": offset=",p="demobrowser.demo.bom.ScrollIntoView";qx.Class.define(p,{extend:qx.application.Native,statics:{test:function(){var r=[g,m,k,e,d,a,j,b];for(var i=0,l=r.length;i<l;i++ ){var q=document.getElementById(r[i]);qx.log.Logger.info(h+r[i]+o+q.offsetWidth+c+q.scrollWidth+n+q.clientWidth);qx.log.Logger.info(f+r[i]+o+q.offsetHeight+c+q.scrollHeight+n+q.clientHeight);}
;}
}});}
)();
