...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Pane_Column.614c16b3b30d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="bold",b="demobrowser.demo.virtual.Pane_Column",c="table-scroller-header",d="Even/Odd Colors",e="Custom Colors",f="white",g="Even/Odd & Custom Colors",h="#EEE";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var j=new qx.ui.layout.Grid(5,0);j.setRowFlex(1,1);j.setColumnFlex(0,1);j.setColumnFlex(1,1);j.setColumnFlex(2,1);var k=new qx.ui.container.Composite(j);this.getRoot().add(k,{edge:0});k.add(new qx.ui.basic.Label(d).set({font:a,decorator:c,padding:3,allowGrowX:true}),{row:0,column:0});var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);m.getPane().addLayer(new qx.ui.virtual.layer.Column(f,h));k.add(m,{row:1,column:0});k.add(new qx.ui.basic.Label(e).set({font:a,decorator:c,padding:3,allowGrowX:true}),{row:0,column:1});var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);var l=new qx.ui.virtual.layer.Column();for(var i=0;i<10000;i++ ){l.setColor(i,qx.util.ColorUtil.randomColor());}
;m.getPane().addLayer(l);k.add(m,{row:1,column:1});k.add(new qx.ui.basic.Label(g).set({font:a,decorator:c,padding:3,allowGrowX:true}),{row:0,column:2});var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);var l=new qx.ui.virtual.layer.Column(f,h);for(var i=0;i<10000;i++ ){if(Math.random()>0.7){l.setColor(i,qx.util.ColorUtil.randomColor());}
;}
;m.getPane().addLayer(l);k.add(m,{row:1,column:2});}
}});}
)();
