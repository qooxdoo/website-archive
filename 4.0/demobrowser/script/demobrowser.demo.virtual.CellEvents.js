...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.001fc3816885.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_onCellTap:function(e){var q=f+e.getRow()+i+e.getColumn()+h;this.__PM(q);}
,_onContextMenu:function(e){var r=d+e.getRow()+i+e.getColumn()+h;this.__PM(r);}
,_onDbltapPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__PM(s);}
,__PM:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__wE=new qx.ui.virtual.core.Pane(o,l,n,m);this.__wE.addListener(c,this._computeScrollbars,this);this.__wE.addListener(d,this._onScrollPaneX,this);this.__wE.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__wE,{edge:0});}
else {this._add(this.__wE,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__wE:null,getPane:function(){return this.__wE;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__wE;}
...
,_onScrollBarX:function(e){this.__wE.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__wE.setScrollY(e.getData());}
},destruct:function(){this.__wE.dispose();this.__wE=null;}
});}
)();
(function(){var a="scrollY",b="__wN",c="cellTap",d="qx.event.type.Data",f="change",g="qx.debug",h="__wF",j="qx.event.type.Event",k="cellContextmenu",l="dbltap",m="resize",n="cellDbltap",o="scrollX",p="tap",q="appear",r="pointerdown",s="qx.ui.virtual.core.Pane",t="qx.ui.virtual.core.CellEvent",u="update",v="contextmenu",w="__wG",x="__wM";qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__wF=new qx.ui.virtual.core.Axis(A,B);this.__wG=new qx.ui.virtual.core.Axis(z,y);this.__wH=0;this.__wI=0;this.__wJ=0;this.__wK=0;this.__wL={};this.__iG={};this.__wM=new qx.ui.container.Composite();this.__wM.setUserBounds(0,0,0,0);this._add(this.__wM);this.__wN=[];this.__wF.addListener(f,this.fullUpdate,this);this.__wG.addListener(f,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(q,this._onAppear,this);this.addListener(r,this._onPointerDown,this);this.addListener(p,this._onTap,this);this.addListener(l,this._onDbltap,this);this.addListener(v,this._onContextmenu,this);}
,events:{cellTap:t,cellContextmenu:t,cellDbltap:t,update:j,scrollX:d,scrollY:d},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__wF:null,__wG:null,__wH:null,__wI:null,__wJ:null,__wK:null,__wL:null,__iG:null,__wM:null,__wN:null,__wO:null,__qe:null,__wP:null,__wQ:null,getRowConfig:function(){return this.__wF;}
,getColumnConfig:function(){return this.__wG;}
,getChildren:function(){return [this.__wM];}
,addLayer:function(C){if(qx.core.Environment.get(g)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__wN.push(C);C.setUserBounds(0,0,0,0);this.__wM.add(C);}
,getLayers:function(){return this.__wN;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__wN.length;i++ ){var E=this.__wN[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__wG.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__wF.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__wH!==J){var I=this.__wH;this.__wH=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__wH;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__wI){var L=this.__wI;this.__wI=M;this._deferredUpdateScrollPosition();this.fireDataEvent(o,M,L);}
;}
,getScrollX:function(){return this.__wI;}
,getScrollSize:function(){return {width:this.__wG.getTotalSize(),height:this.__wF.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__wF.getItemPosition(P);var O=R+this.__wF.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__wG.getItemPosition(S);var T=U+this.__wG.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__wF.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__wG.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__wI+bl.width;var bo=this.__wK-bn;if(this.__wI-this.__wL.left<Math.min(this.__wI,bj)||this.__wL.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__wI,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__wI-bp,this.__wH,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__wH+bw.height;var bt=this.__wJ-bs;if(this.__wH-this.__wL.top<Math.min(this.__wH,bz)||this.__wL.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__wH,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__wI,this.__wH-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__wO=true;this._updateScrollPosition();this.__wO=null;this.fireEvent(u);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onPointerDown:function(e){this.__wQ=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());}
,_onTap:function(e){this.__wR(e,c);}
,_onContextmenu:function(e){this.__wR(e,k);}
,_onDbltap:function(e){this.__wR(e,n);}
,__wR:function(e,bC){var bB=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bB){return;}
;var bA=this.__wQ;if(bA==null||bA.row!==bB.row||bA.column!==bB.column){return;}
;this.fireNonBubblingEvent(bC,qx.ui.virtual.core.CellEvent,[this,e,bB.row,bB.column]);}
,syncWidget:function(bD){if(this.__iG._fullUpdate){this._fullUpdate();}
else if(this.__iG._updateScrollPosition){this._updateScrollPosition();}
;this.__iG={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__wF.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__wF.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__wG.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__wG.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__wL={top:bU,bottom:bQ,left:bS,right:bI};this.__wM.setUserBounds((this.getPaddingLeft()||0)+(this.__wL.left-this.__wI),(this.getPaddingTop()||0)+(this.__wL.top-this.__wH),bO,bM);this.__qe=bH;this.__wP=bR;for(var i=0;i<this.__wN.length;i++ ){var bG=this.__wN[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__wS:function(){if(this.__wO){return;}
;var bW=this.getScrollSize();if(this.__wJ!==bW.height||this.__wK!==bW.width){this.__wJ=bW.height;this.__wK=bW.width;this.fireEvent(u);}
;}
,fullUpdate:function(){this.__iG._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__iG._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__wS();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__wI,this.__wH,bY.width,bY.height,true);this.__wS();}
,_deferredUpdateScrollPosition:function(){this.__iG._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var ca=this.getVisibleLayers();if(ca.length==0){this.__wS();return;}
;var cc=this.getBounds();if(!cc){return;}
;var cb={top:this.__wH,bottom:this.__wH+cc.height,left:this.__wI,right:this.__wI+cc.width};if(this.__wL.top<=cb.top&&this.__wL.bottom>=cb.bottom&&this.__wL.left<=cb.left&&this.__wL.right>=cb.right){this.__wM.setUserBounds((this.getPaddingLeft()||0)+(this.__wL.left-cb.left),(this.getPaddingTop()||0)+(this.__wL.top-cb.top),this.__wL.right-this.__wL.left,this.__wL.bottom-this.__wL.top);}
else {this._setLayerWindow(ca,this.__wI,this.__wH,cc.width,cc.height,false);}
;this.__wS();}
},destruct:function(){this._disposeArray(b);this._disposeObjects(h,w,x);this.__wL=this.__iG=this.__qe=this.__wP=null;}
});}
)();
...
,events:{"change":e},members:{__wT:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__wT=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__wT=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__wT=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__wT=null;this.fireNonBubblingEvent(c);}
,__wU:function(){if(this.__wT){return this.__wT;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__wT=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__wT=u;return u;}
,__wV:function(F){var B=this.__wT||this.__wU();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__wV(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__wW:function(M){var O=this.__wT||this.__wU();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__wW(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__wT||this.__wU();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__wT=null;}
});}
)();
...
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__iG={};}
,properties:{anonymous:{refine:true,init:true}},members:{__iG:null,__bF:null,__xp:null,__xq:null,__wP:null,__qe:null,getFirstRow:function(){return this.__xp;}
,getFirstColumn:function(){return this.__xq;}
,getRowSizes:function(){return this.__wP||[];}
,getColumnSizes:function(){return this.__qe||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__iG.fullUpdate||this.__iG.updateLayerWindow&&this.__iG.updateLayerData){this._fullUpdate.apply(this,this.__bF);}
else if(this.__iG.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bF);}
else if(this.__iG.updateLayerData&&this.__wP){this._updateLayerData();}
;if(this.__iG.fullUpdate||this.__iG.updateLayerWindow){var d=this.__bF;this.__xp=d[0];this.__xq=d[1];this.__wP=d[2];this.__qe=d[3];}
;this.__iG={};}
,_updateLayerData:function(){this._fullUpdate(this.__xp,this.__xq,this.__wP,this.__qe);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__iG.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bF=arguments;this.__iG.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bF=arguments;this.__iG.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__iG=this.__bF=this.__wP=this.__qe=null;}
});}
)();
