...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager-qx.theme.Simple.5d45ab43fbc1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="One-shot 1-second timer: ",e="demobrowser.demo.test.TimerManager",d="Recurrent 5-second timer: ",c="__Hv",b="Start timers",a="execute";qx.Class.define(e,{extend:qx.application.Standalone,members:{__Hv:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();i.start(function(j,k){this.__QS(d+k);}
,5000,this,null,0);i.start(function(l,m){this.__QS(f+m);}
,0,this,null,1000);i.start(function(n,o){this.__QS(g+o);if(++n.count==3){this.__QS(h);i.stop(o);}
;}
,2000,this,{count:0},2000);}
,__QS:function(p){p=Date.parse(new Date)+" "+p+"\n";this.__Hv.setValue(this.__Hv.getValue()+p);}
...
,this);var t=new qx.ui.form.TextArea();t.set({width:400,height:300});this.__Hv=t;q.add(t);q.add(s);this.getRoot().add(q,{left:20,top:10});}
},destruct:function(){this._disposeObjects(c);}
});}
)();
