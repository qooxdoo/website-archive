...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.72700c754326.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var bO="-",bN="_leftComposite",bM="^.*",bL="filled",bK="changeValue",bJ="?qxenv:demobrowser.withTests:true",bI="__Ox",bH="demobrowser.DemoBrowser",bG="_infosplit",bF="_history",bu="_status",bt="__OA",bs="instead.",br="_searchTextField",bq="f1",bp="__Or",bo='changeSelection',bn="Couldn't load file: ",bm="logappender",bl=".html",bV="__Oz",bW="f2",bT="visible",bU="ig",bR="success",bS="__OC",bP="noPlayground",bQ="__kD",bX='excluded',bY="_urlWindow",by='_cmdDisposeSample',bx="__Om",bA="toolbar",bz="tree1",bC="demo/welcome.html",bB='_cmdSampleInOwnWindow',bE=".*",bD=" ",bw='demo/',bv="default",a="__OB",b="index.html",c="when using the file protocol. Please try the http protocol ",d="Filter...",f="qx.theme.Indigo",g="/playground/",h='label',n="changeState",o="/apiviewer/",p="icon/16/actions/edit-find.png",cd="_",cc="__kF",cb="__Ow",ca="__OE",ch="http://manual.qooxdoo.org/",cg="right",cf="main",ce='_cmdObjectSummary',cj="Info",ci="_prevButton",S="file:",T='_cmdNextSample',Q="The security settings of your browser may prohibit AJAX ",R="_tree",W="left",X=".",U='_cmdPrevSample',V='_cmdRunSample',O="excluded",P="bottom-left",B="Failed to load demo data from the file system.\n\n",A="right-top",D="runbutton",C="_runbutton",x="_demoView",w="_navPart",z="?qx.theme=",y="textfield",v="mainsplit",q="app-header",bd="Demo Browser",be="_nextButton",bf="app-splitpane",bg="__Oy",Y="__Oq",ba="fail",bb="_iframe",bc="node",bh="horizontal",bi='execute',L='value',K="~",J="widget",I="http://demo.qooxdoo.org/",H="interval",G="modelLink",F="tags",E="2.0.1",N="value",M="",bj="/",bk="enabled";qx.Class.define(bH,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__kD={};var cn=new qx.ui.layout.VBox;this.setLayout(cn);this.add(this._createHeader());this.widgets={};this.tests={};this.__Ol=f;this.__OF();this.__Om=this.__OM();this.add(this.__Om);var cr=new qx.ui.splitpane.Pane(bh);cr.setAppearance(bf);this.mainsplit=cr;var co=new qx.ui.splitpane.Pane(bh);co.setDecorator(null);this._infosplit=co;this.add(cr,{flex:1});var ct=this._leftComposite=new qx.ui.container.Composite();ct.setLayout(new qx.ui.layout.VBox(3));cr.add(ct,0);{}
;var cm=new qx.ui.container.Composite();cm.setLayout(new qx.ui.layout.HBox(3));cm.setAppearance(y);ct.add(cm);var cu=new qx.ui.basic.Image(p);cm.add(cu);this._searchTextField=new qx.ui.form.TextField();this._searchTextField.setLiveUpdate(true);this._searchTextField.setAppearance(J);this._searchTextField.setPlaceholder(d);var cs=new qx.event.Timer(500);cs.addListener(H,function(cv){this.filter(this._searchTextField.getValue());cs.stop();}
,this);this._searchTextField.addListener(bK,function(cx){cs.restart();}
,this);cm.add(this._searchTextField,{flex:1});this._status=new qx.ui.basic.Label(M);this._status.setAppearance(J);this._status.setWidth(80);this._status.setTextAlign(cg);cm.add(this._status);cr.add(co,1);this._tree=this.__OQ();ct.add(this._tree,{flex:1});this.__OR();this._demoView=this.__ON();co.add(this._demoView,2);var ck=this.__On=this.__OO();var cl=this.__Oo=this.__OP();var cp=this.__Op=new qxc.ui.logpane.LogView();cp.setDecorator(null);var cq=this.__cG=new qx.ui.container.Stack();cq.setDecorator(cf);cq.add(ck);cq.add(cl);cq.add(cp);co.add(cq,1);cq.resetSelection();cq.exclude();this._history=qx.bom.History.getInstance();this._history.addListener(n,function(e){var cy=e.getData().replace(K,bj);if(this._currentSample!=cy){this.setCurrentSample(cy);}
;}
,this);this.__Oq=[this.__Ow,this.__Ox,this.__OA];this.__Oq.push(this.__Ou);this.__Oq.push(this.__Oy);this.__Oq.push(this.__OC);this.__Or=new qx.event.Timer(250);this.__Or.addListener(H,this.__OT,this);this.__Or.start();this.__Os=new demobrowser.InfoWindow(this.tr(cj));this.__Os.setAutoCenter(true);}
,members:{_iframe:null,__Ol:null,__Or:null,__Ot:null,_tree:null,_status:null,_searchTextField:null,__Ou:null,__Ov:null,__Oq:null,_versionFilter:null,_navPart:null,__Ow:null,__Ox:null,__Oy:null,__Oz:null,__OA:null,__OB:null,__OC:null,__Om:null,_leftComposite:null,_infosplit:null,_demoView:null,__kF:null,__kD:null,__OD:null,_urlWindow:null,__Os:null,__cG:null,__On:null,__Oo:null,__Op:null,__OE:null,defaultUrl:bC,playgroundUrl:I+E+g,__OF:function(){this._cmdObjectSummary=new qx.ui.core.Command("Ctrl+O");this._cmdObjectSummary.addListener("execute",this.__OH,this);this._cmdRunSample=new qx.ui.core.Command("F5");this._cmdRunSample.addListener("execute",this.runSample,this);this._cmdPrevSample=new qx.ui.core.Command("Ctrl+Left");this._cmdPrevSample.addListener("execute",this.playPrev,this);this._cmdNextSample=new qx.ui.core.Command("Ctrl+Right");this._cmdNextSample.addListener("execute",this.playNext,this);this._cmdSampleInOwnWindow=new qx.ui.core.Command("Ctrl+N");this._cmdSampleInOwnWindow.addListener("execute",this.__OI,this);this._cmdDisposeSample=new qx.ui.core.Command("Ctrl+D");this._cmdDisposeSample.addListener("execute",this.__OL,this);}
,__OG:function(e){var cB=e.getTarget()===this.__OE?this.__OD:this.__OE;var cA=e.getData()[0];if(cB&&cA){cB.setModelSelection([cA.getModel()]);}
;var cz=cA!=null?cA.getUserData("value"):"";switch(cz){case "html":this.__cG.setSelection([this.__On]);this.__cG.show();break;case "js":this.__cG.setSelection([this.__Oo]);this.__cG.show();break;case "log":this.__cG.setSelection([this.__Op]);this.__cG.show();break;default:this.__cG.resetSelection();this.__cG.exclude();};}
,__OH:function(){var cD=this._iframe.getWindow();var cC;if(cD&&cD.qx){cC=cD.qx.dev.ObjectSummary.getInfo();}
else {cC="Unable to access namespace. Maybe no demo loaded.";}
;var cE=new qx.ui.form.TextArea(cC);cE.setDecorator(null);cE.setAutoSize(true);cE.setMaxHeight(qx.bom.Viewport.getHeight()-100);this.__Os.setContent(cE);this.__Os.setWidth(400);this.__Os.show();}
,__OI:function(){var cF=this._iframe.getSource();window.open(cF,"_blank");}
,__OJ:function(cG){var cH=!!cG;var cI=this._tree.getSelection()[0].getUserData("tags");if(cI){cH=cH&&!qx.lang.Array.contains(cI,"noPlayground");}
;this.__Ou.setEnabled(cH);this.__Ov=cG;}
,__OK:function(){if(this.__Ov){var cL=this.__Ov;var cK='{"code": '+'"'+encodeURIComponent(cL)+'"}';var cJ=this.playgroundUrl+"#"+encodeURIComponent(cK);window.open(cJ,"_blank");}
else {var cM=new qx.ui.basic.Label(this.tr("Could not open the Playground."));this.__Os.setContent(cM);this.__Os.setWidth(200);this.__Os.show();}
;}
,__He:function(){window.open(I+E+o);}
,__Hf:function(){var cN=(E.split(bO)[0]);window.open(ch+cN);}
,_onHideShowTests:function(event){var cP=window.location.search;var cQ=window.location.hash;var cO=b;if(cP==M){cO+=bJ;}
;cO+=cQ;location.replace(cO);}
,__OL:function(e){var cS=this._iframe.getWindow();var cR;if(cS&&cS.qx){cS.qx.core.ObjectRegistry.shutdown();cR=this.tr("Demo has been disposed.");}
else {cR=this.tr("Unable to access application.");}
;var cT=new qx.ui.basic.Label(cR);cT.setRich(true);cT.setWrap(true);this.__Os.setContent(cT);this.__Os.setWidth(350);this.__Os.show();}
,__OM:function(){var ds=new qx.ui.toolbar.ToolBar();this._runbutton=new qx.ui.toolbar.Button(this.tr("Run"),"icon/22/actions/media-playback-start.png");this._runbutton.addListener("execute",this.runSample,this);this._runbutton.setToolTipText("Run the selected demo");ds.add(this._runbutton);var dv=new qx.ui.toolbar.Part();ds.add(dv);var dd=new qx.ui.toolbar.Button(this.tr("Previous"),"icon/22/actions/go-previous.png");dd.addListener("execute",this.playPrev,this);dd.setToolTipText("Run previous demo");dv.add(dd);this._prevButton=dd;var dq=new qx.ui.toolbar.Button(this.tr("Next"),"icon/22/actions/go-next.png");dq.addListener("execute",this.playNext,this);dq.setToolTipText("Run next demo");dv.add(dq);this._nextButton=dq;var dg={converter:function(dA){return dA=="visible";}
};qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dd,"enabled",dg);qx.data.SingleValueBinding.bind(this._runbutton,"visibility",dq,"enabled",dg);var dy=this._navPart=new qx.ui.toolbar.Part();ds.add(dy);var dz=new qx.ui.toolbar.Button(this.tr("Own Window"),"icon/22/actions/edit-redo.png");dz.addListener("execute",this.__OI,this);dz.setToolTipText("Open demo in new window");this.__Ow=dz;dy.add(dz);var dm=new qx.ui.toolbar.Button(this.tr("To Playground"),"icon/22/actions/application-exit.png");dm.addListener("execute",this.__OK,this);dm.setToolTipText("Open demo in the playground");dm.setEnabled(false);if(qx.core.Environment.get("browser.name")=="ie"){dm.exclude();}
;this.__Ou=dm;dy.add(dm);var cX=new qx.ui.toolbar.Part();ds.add(cX);var dk=new qx.ui.toolbar.Button(this.tr("API Viewer"),"icon/22/actions/help-contents.png");cX.add(dk);dk.setToolTipText(this.tr("Open the qooxdoo API Viewer"));dk.addListener("execute",this.__He,this);var cV=new qx.ui.toolbar.Button(this.tr("Manual"),"icon/22/actions/help-about.png");cX.add(cV);cV.setToolTipText(this.tr("Open the qooxdoo Manual"));cV.addListener("execute",this.__Hf,this);var dt=new qx.ui.toolbar.Part;ds.add(dt);var dp=new qx.ui.menu.Menu;this.__Oz=dp;var de=new qx.ui.menu.RadioButton("Modern Theme");var dw=new qx.ui.menu.RadioButton("Classic Theme");var dx=new qx.ui.menu.RadioButton("Simple Theme");var du=new qx.ui.menu.RadioButton("Indigo Theme");de.setUserData("value","qx.theme.Modern");dw.setUserData("value","qx.theme.Classic");dx.setUserData("value","qx.theme.Simple");du.setUserData("value","qx.theme.Indigo");du.setValue(true);var dh=new qx.ui.form.RadioGroup(de,dw,dx,du);dh.addListener("changeSelection",this.__OX,this);dp.add(du);dp.add(de);dp.add(dw);dp.add(dx);var df=new qx.ui.toolbar.MenuButton(this.tr("Theme"),"icon/22/apps/utilities-color-chooser.png",dp);this.__Oy=df;df.setToolTipText("Choose theme");dt.add(df);var di=new qx.ui.menu.Menu;var dj=new qx.ui.menu.Button(this.tr("Object Summary"));this.__OC=dj;dj.setCommand(this._cmdObjectSummary);di.add(dj);var db=new qx.ui.menu.Button(this.tr("Dispose Demo"));this.__OA=db;db.setCommand(this._cmdDisposeSample);di.add(db);di.addSeparator();var cY=new qx.ui.menu.CheckBox(this.tr("Hide/Show Tests Demos"));cY.setValue(!!qx.core.Environment.get("demobrowser.withTests"));cY.addListener("changeValue",this._onHideShowTests,this);di.add(cY);var dc=new qx.ui.toolbar.MenuButton(this.tr("Debug"),"icon/22/apps/office-spreadsheet.png",di);this.__OB=dc;dc.setToolTipText("Debugging options");dt.add(dc);var dl=new qx.ui.toolbar.Part;this.__Ox=dl;ds.addSpacer();ds.add(dl);var dr=new qx.ui.toolbar.RadioButton("HTML Code","icon/22/apps/internet-web-browser.png");dr.setToolTipText("Display HTML source");dr.setModel('html');var da=new qx.ui.toolbar.RadioButton("JS Code","icon/22/mimetypes/executable.png");da.setToolTipText("Display JavaScript source");da.setModel('js');dr.setUserData("value","html");da.setUserData("value","js");dl.add(dr);dl.add(da);var dn=new qx.ui.toolbar.RadioButton("Log File","icon/22/apps/utilities-log-viewer.png");dn.setToolTipText("Display log file");dn.setUserData("value","log");dn.setModel('log');dl.add(dn);var cU=this.__OE=new qx.ui.form.RadioGroup;cU.setAllowEmptySelection(true);cU.add(dn);cU.addListener('changeSelection',this.__OG,this);cU.add(dr,da);ds.setOverflowHandling(true);var cW=new qx.ui.toolbar.MenuButton(null,"icon/22/actions/media-seek-forward.png");cW.setAppearance("toolbar-button");ds.add(cW);ds.setOverflowIndicator(cW);ds.setRemovePriority(dl,6);ds.setRemovePriority(dt,5);ds.setRemovePriority(cX,4);ds.setRemovePriority(dy,3);ds.setRemovePriority(dv,2);ds.setRemovePriority(this._navPart,1);this.__kF=new qx.ui.menu.Menu();cW.setMenu(this.__kF);ds.addListener("hideItem",this._onHideItem,this);ds.addListener("showItem",this._onShowItem,this);return ds;}
,_onHideItem:function(e){var dB=e.getData();var dC=this._getMenuItems(dB);for(var i=0,l=dC.length;i<l;i++){dC[i].setVisibility(bT);if(dB===this.__Oy&&!(dC[i] instanceof qx.ui.menu.Separator)){dC[i].getMenu().setPosition(A);}
;}
;}
,_onShowItem:function(e){var dD=e.getData();var dF=this._getMenuItems(dD);for(var i=0,l=dF.length;i<l;i++){dF[i].setVisibility(O);}
;if(dD===this.__Oy){var dE=dD.getMenuButtons();for(var i=0,l=dE.length;i<l;i++){dE[i].getMenu().setPosition(P);}
;}
;}
,_getMenuItems:function(dG){var dI=[];if(dG instanceof qx.ui.toolbar.Part){var dN=dG.getChildren();var dM=null;var dH=false;var dJ=this.__kF.getChildren();if(dG!=this.__Ox){dM=this.__kD[dG.toHashCode()];if(!dM){dM=new qx.ui.menu.Separator();this.__kF.addBefore(dM,dJ[0]);this.__kD[dG.toHashCode()]=dM;}
;dI.push(dM);}
else {dH=true;}
;for(var i=0,l=dN.length;i<l;i++){if(dN[i].getVisibility()==bX){continue;}
;var dK=this.__kD[dN[i].toHashCode()];if(!dK){if(dN[i] instanceof qx.ui.toolbar.RadioButton){dK=new qx.ui.menu.RadioButton(dN[i].getLabel());dK.setToolTipText(dN[i].getToolTipText());dK.setEnabled(dN[i].getEnabled());dK.setUserData(L,dN[i].getUserData(L));dK.setModel(dN[i].getModel());dN[i].bind(bk,dK,bk);dN[i].bind(N,dK,N);dK.bind(N,dN[i],N);if(!this.__OD){this.__OD=new qx.ui.form.RadioGroup();this.__OD.setAllowEmptySelection(true);this.__OD.addListener(bo,this.__OG,this);}
;this.__OD.add(dK);}
...
;}
;return dI;}
,__ON:function(){var dO=new qx.ui.embed.Iframe().set({nativeContextMenu:true});dO.addListener("load",this.__OS,this);this._iframe=dO;return dO;}
,__OO:function(){var dP=new qx.ui.embed.Html("<div class='script'>The sample source will be displayed here.</div>");dP.setOverflow("auto","auto");dP.setFont("monospace");dP.setBackgroundColor("white");this.widgets["outputviews.sourcepage.html.page"]=dP;dP.getContentElement().setAttribute("id","qx_srcview");return dP;}
,__OP:function(){var dQ=new qx.ui.embed.Html("<div class='script'>The sample JS source will be displayed here.</div>");dQ.setOverflow("auto","auto");dQ.setFont("monospace");dQ.setBackgroundColor("white");this.widgets["outputviews.sourcepage.js.page"]=dQ;dQ.getContentElement().setAttribute("id","qx_srcview");return dQ;}
,__OQ:function(){var dS=new qx.ui.tree.Tree();var dR=new qx.ui.tree.TreeFolder("Demos");dS.setAppearance("demo-tree");dS.setRoot(dR);this.tree=this.widgets["treeview.flat"]=dS;dS.addListener("changeSelection",this.treeGetSelection,this);dS.addListener("dblclick",function(e){qx.event.Timer.once(this.runSample,this,50);}
,this);return dS;}
,__OR:function(){var dT=new qx.ui.window.Window(this.tr("Demo Link"),"icon/22/mimetypes/text-html.png");dT.setLayout(new qx.ui.layout.VBox(10));dT.setAllowMaximize(false);dT.setAllowMinimize(false);var dW=new qx.ui.basic.Label("");dW.setSelectable(true);dW.setNativeContextMenu(true);dT.add(dW);this._urlWindow=dT;var dX=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);if(dX<0){dX=0;}
...
;}
,runSample:function(e){if(this.tests.selected&&this.tests.selected!=M){var eu=this.tests.selected.replace(X,bj);this.setCurrentSample(eu);}
else {this.playNext();}
;}
,setCurrentSample:function(ew){if(!ew){return;}
;if(!this._sampleToTreeNodeMap){return;}
;var ey;var eA=this._sampleToTreeNodeMap[ew];if(eA){eA.getTree().setSelection([eA]);ey=bw+ew;ey+=z+this.__Ol;var ez=eA.getUserData(F);if(ez){this.__Ou.setEnabled(!qx.lang.Array.contains(ez,bP));}
;}
else {ey=this.defaultUrl;}
;if(this._iframe.getSource()==ey){this._iframe.reload();}
else {this.__Ot=false;this._iframe.setSource(ey);}
;if(ey==this.defaultUrl){this.disableMenuButtons();}
else {this.enableMenuButtons();}
;this._currentSample=ew;this._currentSampleUrl=ey;}
,__OS:function(){var eE=this._iframe.getWindow();var eK=this._iframe.getSource();if(eK!=null&&eK!=this.defaultUrl){var eD;try{eD=eE.location.href;}
...
;document.title=eC;}
;}
,__OT:function(e){var eN=this._iframe.getWindow();try{if(eN&&eN.qx&&eN.qx.log&&eN.qx.log.appender){if(!this.__Ot){this.__Ot=true;this.debug("Demo loaded: "+this._currentSample);this.__Op.clear();try{this.__Op.fetch(eN.qx.log.Logger);}
catch(e){return;}
;this._history.addToHistory(this._currentSample.replace("/","~"),document.title);if(this._currentSampleUrl!=this.defaultUrl){this.__OU(this._currentSampleUrl);}
;}
;}
else {this.__Ot=false;}
;}
catch(eO){this.__Ot=false;}
;}
,filter:function(eP){var eX=new RegExp(bM+eP+bE,bU);var eV=this._tree.getRoot().getItems(true,true);var eW=0;var eQ=0;for(var i=0;i<eV.length;i++){var eY=eV[i];var parent=eY.getParent();var eU=eY.getUserData(F);var eR=false;if(eU!=null){for(var j=0;j<eU.length;j++){eR=!!eU[j].match(eX);if(eR){break;}
;}
;}
...
;}
,this,0);}
,this);fp.addListener(ba,function(ft){this.error(bn+fo);}
,this);fp.send();}
...
;}
;}
,__OV:function(fB,fC){var fD=new qx.util.StringBuilder("<pre class='script'>");var fF=[];var fG=new qx.util.StringBuilder();var fH=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;var fE=/^\s*<\/script>\s*$/i;fB=fB.replace(/\r\n/g,"\n").replace(/\r/g,"\n");var fF=fB.split('\n');if(fC=="javascript"){return "<pre ><div class='script'>"+qx.dev.Tokenizer.javaScriptToHtml(fB)+"</div></pre>";}
;for(var i=0;i<fF.length;i++){if(fH.exec(fF[i])){fD.add(this.__OW(qx.bom.String.escape(fG.get()+fF[i])));fG.clear();}
else if(fE.exec(fF[i])){var fI=qx.dev.Tokenizer.javaScriptToHtml(fG.get());fD.add('<div class="script">',fI,'</div>');fG.clear();fG.add(fF[i],'\n');}
else {fG.add(fF[i],'\n');}
;}
;fD.add(this.__OW(qx.bom.String.escape(fG.get())),"</pre>");return fD.get();}
,disableMenuButtons:function(){var fJ=this.__Oq;for(var i=0;i<fJ.length;i++){fJ[i].setEnabled(false);}
;}
,enableMenuButtons:function(){var fK=this.__Oq;for(var i=0;i<fK.length;i++){fK[i].setEnabled(true);}
;}
,__OW:function(fL){var fN=fL;function fM(fO){var s=new qx.util.StringBuilder(arguments[1],'<span class="html-tag-name">',arguments[2],'</span>');var fP;var fQ=false;if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){fP=arguments[i];if(fP=="/"){fQ=true;break;}
...
,polish:function(fR){return fR.replace(bl,M).replace(cd,bD);}
,__OX:function(e){this.__Ol=e.getData()[0].getUserData("value");this.runSample();}
,_createHeader:function(){var fU=new qx.ui.layout.HBox();var fS=new qx.ui.container.Composite(fU);fS.setAppearance(q);var fV=new qx.ui.basic.Label(bd);var fT=new qxc.ui.versionlabel.VersionLabel();fT.setFont(bv);fS.add(fV);fS.add(new qx.ui.core.Spacer,{flex:1});fS.add(fT);return fS;}
},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;this._disposeObjects(v,bz,W,D,bA,bq,bW,bF,bm,ce,V,U,T,bB,by,bt,a,w,C,cb,bg,bV,bI,ca,bx,bG,br,bu,R,bb,x,Y,bS,bp,bN,bY,be,ci,bQ,cc);}
});}
)();
...
(function(){var m="separator-vertical",k="_applyShowLogLevel",j="Boolean",h="qxc.ui.logpane.LogView",g='',f="Debug",d="Log",c="auto",b="execute",a="icon/16/actions/edit-clear.png",I="Clear",H="DIV",G="middle",F="icon/16/status/dialog-information.png",E="Warning",D="Error",C="__HE",B="appear",A="main",z="changeLogLevel",t="Info",u="bold",r="icon/16/categories/system.png",s="icon/16/status/dialog-error.png",p="monospace",q="icon/16/status/dialog-warning.png",n="scroll",o="warn",v="error",w="info",y="white",x="debug";qx.Class.define(h,{extend:qx.ui.container.Composite,construct:function(){this.__HD=[[x,f,r],[w,t,F],[o,E,q],[v,D,s]];var M=new qx.ui.layout.VBox();M.setSeparator(m);qx.ui.container.Composite.call(this,M);this.setDecorator(A);var K=new qx.ui.basic.Label(this.tr(d)).set({font:u,padding:10,alignY:G,allowGrowX:true,allowGrowY:true});this.__Fa=new qx.ui.toolbar.ToolBar();this.__Fa.add(K);this.__Fa.addSpacer();this.__Fa.setBackgroundColor(y);var J=new qx.ui.toolbar.Button(this.tr(I),a);J.addListener(b,function(e){this.clear();}
,this);this.__Fa.add(J);this.add(this.__Fa);var L=new qx.ui.embed.Html(g);L.set({backgroundColor:y,overflowY:n,overflowX:c,font:p,padding:3});this.add(L,{flex:1});this.__HE=new qx.log.appender.Element();qx.log.Logger.unregister(this.__HE);this.__HF=document.createElement(H);this.__HE.setElement(this.__HF);L.addListenerOnce(B,function(){L.getContentElement().getDomElement().appendChild(this.__HF);}
,this);}
,properties:{showLogLevel:{check:j,apply:k,init:false},logLevel:{check:[x,w,o,v],init:x,event:z}},members:{__HF:null,__HE:null,__HD:null,__HG:null,__Fa:null,clear:function(){this.__HE.clear();}
,fetch:function(N){if(!N){N=qx.log.Logger;}
;N.register(this.__HE);N.clear();}
,getAppenderElement:function(){return this.__HF;}
,_applyShowLogLevel:function(O,P){if(!this.__HG){this.__HG=this.__HH();this.__Fa.add(this.__HG);}
;if(O){this.__HG.show();}
else {this.__HG.exclude();}
;}
,__HH:function(){var Q=new qx.ui.menu.Menu();var T=new qx.ui.toolbar.MenuButton("Log Level","icon/16/categories/system.png");T.setMenu(Q);for(var i=0,l=this.__HD.length;i<l;i++){var S=this.__HD[i];var R=new qx.ui.menu.Button(S[1],S[2]);R.setUserData("model",S[0]);R.addListener("execute",function(U){var V=U.getTarget();this.setLogLevel(V.getUserData("model"));T.setIcon(V.getIcon());}
,this);Q.add(R);}
;return T;}
},destruct:function(){this._disposeObjects(C);this.__HF=null;}
});}
)();
...
(function(){var j="qx.blankpage",i="undefined",h="#",g="hidden",f="can't initialize iframe",e="qx.bom.HashHistory",d="absolute",c="interval",b="-1000px",a="";qx.Class.define(e,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this._baseUrl=null;this.__rO();}
,members:{__rL:null,__rM:null,__rN:false,addToHistory:function(k,l){if(!qx.lang.Type.isString(k)){k=k+a;}
;if(qx.lang.Type.isString(l)){this.setTitle(l);this._titles[k]=l;}
;if(this.getState()!==k){this.setState(k);}
;}
,__rO:function(){this.__rM=this.__rP();document.body.appendChild(this.__rM);this.__rQ(function(){this._baseUrl=this.__rM.contentWindow.document.location.href;this.__rR();}
,this);}
,__rP:function(){var m=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(j))+h});m.style.visibility=g;m.style.position=d;m.style.left=b;m.style.top=b;return m;}
,__rQ:function(n,o,p){if(typeof p===i){p=0;}
;if(!this.__rM.contentWindow||!this.__rM.contentWindow.document){if(p>20){throw new Error(f);}
;qx.event.Timer.once(function(){this.__rQ(n,o,++p);}
,this,10);return;}
;this.__rN=true;n.call(o||window);}
,__rR:function(){qx.event.Idle.getInstance().addListener(c,this.__rT,this);}
,__rS:function(){qx.event.Idle.getInstance().removeListener(c,this.__rT,this);}
,__rT:function(){var q=this._readState();if(qx.lang.Type.isString(q)&&q!=this.getState()){this._onHistoryLoad(q);}
;}
,_readState:function(){var r=!this._getHash()?a:this._getHash().substr(1);return this._decode(r);}
,_getHash:function(){if(!this.__rN){return;}
;return this.__rM.contentWindow.document.location.hash;}
,_writeState:function(s){this._setHash(this._encode(s));}
,_setHash:function(t){if(!this.__rM||!this._baseUrl){return;}
;var u=!this.__rM.contentWindow.document.location.hash?a:this.__rM.contentWindow.document.location.hash.substr(1);if(t!=u){this.__rM.contentWindow.document.location.hash=t;}
;}
},destruct:function(){this.__rS();this.__rM=null;}
});}
)();
...
(function(){var q="request",p="qx.bom.IframeHistory",o="engine.name",n="can't initialize iframe",m="mshtml",l="state",k='<html><body><div id="state">',j="browser.version",i="hidden",h="qx.blankpage",c="undefined",g='</div></body></html>',f="absolute",b="",a="interval",d="-1000px";qx.Class.define(p,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__rY();}
,members:{__rM:null,__rN:false,__rU:null,__rV:null,__rW:null,_setInitialState:function(){qx.bom.History.prototype._setInitialState.call(this);this.__rW=this._getHash();}
,_setHash:function(r){qx.bom.History.prototype._setHash.call(this,r);this.__rW=this._encode(r);}
...
;}
,_setState:function(v){this.__rV=true;this.setState(v);this.__rV=false;}
,_applyState:function(w,x){if(this.__rV){return;}
;this._writeState(w);}
,_readState:function(){if(!this.__rN){return this._decode(this._getHash());}
;var y=this.__rM.contentWindow.document;var z=y.getElementById(l);return z?this._decode(z.innerText):b;}
,_writeState:function(A){if(!this.__rN){this.__rX();this.__rU=qx.event.Timer.once(function(){this._writeState(A);}
,this,50);return;}
;this.__rX();var A=this._encode(A);if(qx.core.Environment.get(o)==m&&qx.core.Environment.get(j)!=8){this._setHash(A);}
;var B=this.__rM.contentWindow.document;B.open();B.write(k+A+g);B.close();}
,__rX:function(){if(this.__rU){this.__rU.stop();this.__rU.dispose();}
;}
,__rY:function(){this.__rO(function(){qx.event.Idle.getInstance().addListener(a,this.__rT,this);}
);}
,__rT:function(e){var D=null;var C=this._getHash();if(!this.__sb(C)){D=this.__sa(C);}
else {D=this._readState();}
;if(qx.lang.Type.isString(D)&&D!=this.getState()){this._onHistoryLoad(D);}
;}
,__sa:function(E){E=this._decode(E);this._writeState(E);return E;}
,__sb:function(F){return qx.lang.Type.isString(F)&&F==this.__rW;}
,__rO:function(G){this.__rM=this.__rP();document.body.appendChild(this.__rM);this.__rQ(function(){this._writeState(this.getState());if(G){G.call(this);}
;}
,this);}
,__rP:function(){var H=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(qx.core.Environment.get(h))});H.style.visibility=i;H.style.position=f;H.style.left=d;H.style.top=d;return H;}
,__rQ:function(I,J,K){if(typeof K===c){K=0;}
;if(!this.__rM.contentWindow||!this.__rM.contentWindow.document){if(K>20){throw new Error(n);}
;qx.event.Timer.once(function(){this.__rQ(I,J,++K);}
,this,10);return;}
;this.__rN=true;I.call(J||window);}
},destruct:function(){this.__rM=null;if(this.__rU){this.__rU.dispose();this.__rU=null;}
;qx.event.Idle.getInstance().removeListener(a,this.__rT,this);}
});}
)();
(function(){var d="qx.bom.NativeHistory",c="engine.name",b="hashchange",a="interval";qx.Class.define(d,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);this.__rR();}
,members:{__rL:null,__rR:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__rL=qx.lang.Function.bind(this.__rT,this);qx.bom.Event.addNativeListener(window,b,this.__rL);}
else {qx.event.Idle.getInstance().addListener(a,this.__rT,this);}
;}
,__rS:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,b,this.__rL);}
else {qx.event.Idle.getInstance().removeListener(a,this.__rT,this);}
;}
,__rT:function(){var e=this._readState();if(qx.lang.Type.isString(e)&&e!=this.getState()){this._onHistoryLoad(e);}
;}
...
(function(){var g="resize",f="demobrowser.InfoWindow",e="Boolean",d="_applyContent",c="center",b="OK",a="execute";qx.Class.define(f,{extend:qx.ui.window.Window,construct:function(h,i){qx.ui.window.Window.call(this,h,i);this.setLayout(new qx.ui.layout.VBox(10));this.setMinWidth(200);this.setMaxWidth(qx.bom.Viewport.getWidth()-10);this.setMaxHeight(qx.bom.Viewport.getHeight()-10);this.setShowMinimize(false);this.setShowMaximize(false);this.add(this._getContentContainer(),{flex:1});this.add(this._makeOkButton(),{flex:0});this.addListener(g,this.__OY,this);}
,properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__Cj:null,_getContentContainer:function(){if(!this.__Cj){this.__Cj=new qx.ui.container.Composite(new qx.ui.layout.VBox());this.__Cj.setMinHeight(20);}
;return this.__Cj;}
...
,__OY:function(){if(this.getAutoCenter()){this.center();}
;}
}});}
)();
...
(function(){var p="No target to insert tests",o="^",n="demobrowser.TreeDataHandler",m="ttree",l="\\.[^\\.]+$",h="demobrowser.withTests",g="depth",f="All",e=".",d="",c="test";qx.Class.define(n,{extend:qx.core.Object,construct:function(q){qx.core.Object.call(this);this.tmap=q;this.ttree=this.__Pa(q);}
,members:{__Pa:function(r){var t=r;function s(x,y){var B=y.classname;var z=B.split(e);function A(parent,D){if(!D.length){return parent;}
...
(function(){var g="qxc.ui.versionlabel.VersionLabel",f="qooxdoo",e="2.0.1",d=" ",c="versionLabel.name",b="",a="versionLabel.version";qx.Class.define(g,{extend:qx.ui.basic.Label,construct:function(h,i){if(h==undefined){h=qx.core.Environment.get(c);}
...
(function(){var j="),to(",i="from(",h="background-image",g="background",f="<div style=\"position: absolute; width: 100%; height: 100%; filter:progid:DXImageTransform.Microsoft.Gradient",e="StartColorStr='#FF",d="browser.name",c="', ",b="-webkit-gradient(linear,",a="startColorPosition",P="qx.debug",O="deg, ",N="css.gradient.legacywebkit",M="EndColorStr='#FF",L="startColor",K="ie",J="(GradientType=",I="qx.ui.decoration.MLinearBackgroundGradient",H="(",G="endColorPosition",q="';)\"></div>",r="endColor",o=", ",p="overflow",m="hidden",n="This decorator is already in-use. Modification is not possible anymore!",k=" 0",l="px",s="0",t="shorthand",y="Color",x="vertical",A="",z="css.gradient.filter",C="Number",B="%",v=")",F="css.gradient.linear",E=",",D="horizontal",u=" ",w="_applyLinearBackgroundGradient";qx.Mixin.define(I,{properties:{startColor:{check:y,nullable:true,apply:w},endColor:{check:y,nullable:true,apply:w},orientation:{check:[D,x],init:x,apply:w},startColorPosition:{check:C,init:0,apply:w},endColorPosition:{check:C,init:100,apply:w},colorPositionUnit:{check:[l,B],init:B,apply:w},gradientStart:{group:[L,a],mode:t},gradientEnd:{group:[r,G],mode:t}},members:{_styleLinearBackgroundGradient:function(Q){var W=this.__sc();var bb=W.start;var U=W.end;var bc=this.getColorPositionUnit();if(qx.core.Environment.get(N)){bc=bc===l?A:bc;if(this.getOrientation()==D){var ba=this.getStartColorPosition()+bc+k+bc;var X=this.getEndColorPosition()+bc+k+bc;}
else {var ba=s+bc+u+this.getStartColorPosition()+bc;var X=s+bc+u+this.getEndColorPosition()+bc;}
;var S=i+bb+j+U+v;var T=b+ba+E+X+E+S+v;Q[g]=T;}
else if(qx.core.Environment.get(z)&&!qx.core.Environment.get(F)){Q[p]=m;}
else {var bd=this.getOrientation()==D?0:270;if(qx.core.Environment.get(d)==K){bd=bd-90;}
;var V=bb+u+this.getStartColorPosition()+bc;var R=U+u+this.getEndColorPosition()+bc;var Y=qx.core.Environment.get(F);Q[h]=Y+H+bd+O+V+E+R+v;}
;}
,__sc:function(){var be=qx.theme.manager.Color.getInstance();var bg=be.resolve(this.getStartColor());var bf=be.resolve(this.getEndColor());return {start:bg,end:bf};}
,_getContent:function(){if(qx.core.Environment.get(z)&&!qx.core.Environment.get(F)){var bi=this.__sc();var bk=this.getOrientation()==D?1:0;var bj=qx.util.ColorUtil.hex3StringToHex6String(bi.start);var bh=qx.util.ColorUtil.hex3StringToHex6String(bi.end);bj=bj.substring(1,bj.length);bh=bh.substring(1,bh.length);return f+J+bk+o+e+bj+c+M+bh+q;}
;return A;}
...
,_applyLinearBackgroundGradient:function(){if(qx.core.Environment.get(P)){if(this._isInitialized()){throw new Error(n);}
;}
;}
}});}
)();
