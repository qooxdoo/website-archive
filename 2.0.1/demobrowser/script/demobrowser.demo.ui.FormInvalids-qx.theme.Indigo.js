...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormInvalids-qx.theme.Indigo.f66b4dd1d1d3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var s=" invalidate all shown widgets. Try the invalid focus and tooltip.",r="root",q="RadioGroup 2",p=")",o="disable tooltips",n="RadioGroup 1",m="Invalid (",l="File 3",k="demobrowser.demo.ui.FormInvalids",j="disabled",c="<b>Validation</b><br/>Press the button to",h="File 1",g="Item ",b="File 2",a="invalid",f="changeValue",d="I am a box";qx.Class.define(k,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var B=[];B.push(new qx.ui.form.Spinner());this.getRoot().add(B[0],{left:20,top:80});B.push(new qx.ui.form.Slider());B[1].setWidth(200);this.getRoot().add(B[1],{left:20,top:120});B.push(new qx.ui.form.TextField());this.getRoot().add(B[2],{left:20,top:150});B.push(new qx.ui.form.TextArea());this.getRoot().add(B[3],{left:20,top:190});B.push(new qx.ui.form.PasswordField());this.getRoot().add(B[4],{left:20,top:290});B.push(new qx.ui.form.ComboBox());this.getRoot().add(B[5],{left:20,top:330});B.push(new qx.ui.form.SelectBox());this.getRoot().add(B[6],{left:20,top:370});B.push(new qx.ui.form.CheckBox());this.getRoot().add(B[7],{left:20,top:390});B.push(new qx.ui.form.CheckBox().set({triState:true,value:null}));this.getRoot().add(B[8],{left:20,top:410});B.push(new qx.ui.form.RadioButton());this.getRoot().add(B[9],{left:20,top:430});B.push(new qx.ui.groupbox.GroupBox(d));this.getRoot().add(B[10],{left:240,top:70});B.push(new qx.ui.groupbox.RadioGroupBox(d));this.getRoot().add(B[11],{left:240,top:170});B.push(new qx.ui.groupbox.CheckGroupBox(d));this.getRoot().add(B[12],{left:240,top:270});B.push(new qx.ui.form.List());this.getRoot().add(B[13],{left:390,top:70});for(var i=0;i<10;i++){B[13].add(new qx.ui.form.ListItem(g+(i+1)));}
;B.push(new qx.ui.form.DateField());this.getRoot().add(B[14],{left:390,top:280});B.push(new qx.ui.control.DateChooser());this.getRoot().add(B[15],{left:530,top:70});var y=new qx.ui.form.RadioGroup();var t=new qx.ui.form.RadioButton(n);y.add(t);this.getRoot().add(t,{left:390,top:320});var u=new qx.ui.form.RadioButton(q);y.add(u);this.getRoot().add(u,{left:390,top:340});B.push(y);var x=new qx.ui.tree.Tree();B.push(x);this.getRoot().add(x,{left:530,top:300});var C=new qx.ui.tree.TreeFolder(r);C.setOpen(true);x.setRoot(C);C.add(new qx.ui.tree.TreeFile(h));C.add(new qx.ui.tree.TreeFile(b));C.add(new qx.ui.tree.TreeFile(l));var w=new qx.ui.form.ToggleButton(a);this.getRoot().add(w,{left:280,top:20});w.addListener(f,function(e){for(var i=0;i<B.length;i++){B[i].setInvalidMessage(m+i+p);B[i].setValid(!e.getData());}
;}
,this);var z=new qx.ui.form.ToggleButton(j);this.getRoot().add(z,{left:350,top:20});z.addListener(f,function(e){for(var i=0;i<B.length;i++){B[i].setEnabled(!e.getData());}
;}
,this);var v=new qx.ui.form.ToggleButton(o);this.getRoot().add(v,{left:430,top:20});v.addListener(f,function(e){qx.ui.tooltip.Manager.getInstance().setShowInvalidToolTips(!e.getData());}
,this);var A=new qx.ui.basic.Label();A.setRich(true);A.setWidth(250);A.setValue(c+s);this.getRoot().add(A,{left:20,top:10});}
}});}
)();
...
(function(){var i="resize",h="qx.ui.groupbox.RadioGroupBox",g="radio-groupbox",f="qx.event.type.Event",d="qx.event.type.Data",c="changeValue",b="execute",a="legend";qx.Class.define(h,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IRadioItem,qx.ui.form.IExecutable,qx.ui.form.IBooleanForm,qx.ui.form.IModel],include:[qx.ui.form.MModelProperty],properties:{appearance:{refine:true,init:g}},events:{"changeValue":d,"execute":f},members:{_createChildControlImpl:function(j,k){var l;switch(j){case a:l=new qx.ui.form.RadioButton();l.setAllowGrowX(true);l.setValue(true);l.addListener(c,this._onRadioChangeValue,this);l.addListener(i,this._repositionFrame,this);l.addListener(b,this._onExecute,this);this._add(l,{left:0,right:0});};return l||qx.ui.groupbox.GroupBox.prototype._createChildControlImpl.call(this,j);}
,_applyEnabled:function(m,n){qx.ui.groupbox.GroupBox.prototype._applyEnabled.call(this,m,n);this.getChildrenContainer().setEnabled(m&&this.getValue());}
,_onExecute:function(e){this.fireEvent(b);}
...
,execute:function(){this.getChildControl(a).execute();}
,setCommand:function(p){this.getChildControl(a).setCommand(p);}
,getCommand:function(){return this.getChildControl(a).getCommand();}
,getGroup:function(){return this.getChildControl(a).getGroup();}
,setGroup:function(q){if(q!=null){q.add(this);}
;return;}
,getValue:function(){return this.getChildControl(a).getValue();}
,setValue:function(r){this.getChildControl(a).setValue(r);}
,resetValue:function(){this.getChildControl(a).resetValue();}
,getLabel:function(){return this.getChildControl(a).getLabel();}
}});}
)();
(function(){var i="resize",h="check-groupbox",g="qx.event.type.Event",f="qx.ui.groupbox.CheckGroupBox",d="qx.event.type.Data",c="changeValue",b="execute",a="legend";qx.Class.define(f,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IExecutable,qx.ui.form.IBooleanForm,qx.ui.form.IModel],include:[qx.ui.form.MModelProperty],properties:{appearance:{refine:true,init:h}},events:{"changeValue":d,"execute":g},members:{_createChildControlImpl:function(j,k){var l;switch(j){case a:l=new qx.ui.form.CheckBox();l.setValue(true);l.setAllowGrowX(true);l.addListener(c,this._onRadioChangeValue,this);l.addListener(i,this._repositionFrame,this);l.addListener(b,this._onExecute,this);this._add(l,{left:0,right:0});};return l||qx.ui.groupbox.GroupBox.prototype._createChildControlImpl.call(this,j);}
,_onExecute:function(e){this.fireEvent(b);}
...
,execute:function(){this.getChildControl(a).execute();}
,setCommand:function(n){this.getChildControl(a).setCommand(n);}
,getCommand:function(){return this.getChildControl(a).getCommand();}
,getValue:function(){return this.getChildControl(a).getValue();}
,setValue:function(o){this.getChildControl(a).setValue(o);}
,resetValue:function(){this.getChildControl(a).resetValue();}
}});}
)();
...
(function(){var k="_applyIconOpened",j="Boolean",i="changeIcon",h="changeIconOpened",g="changeLabel",f="Integer",d="_applyIndent",c="changeOpenSymbolMode",b="_applyOpenSymbolMode",a="resize",E="__lr",D="",C="iconOpened",B="abstract",A="never",z="_applyIcon",y="_applyOpen",x="changeIndent",w="qx.ui.tree.core.AbstractItem",v="_applyLabel",r="changeOpen",s="opened",p="always",q="auto",n="middle",o="String",l="label",m="Abstract method call.",t="open",u="icon";qx.Class.define(w,{extend:qx.ui.core.Widget,type:B,include:[qx.ui.form.MModelProperty],implement:[qx.ui.form.IModel],construct:function(F){qx.ui.core.Widget.call(this);if(F!=null){this.setLabel(F);}
;this._setLayout(new qx.ui.layout.HBox());this._addWidgets();this.initOpen();}
,properties:{open:{check:j,init:false,event:r,apply:y},openSymbolMode:{check:[p,A,q],init:q,event:c,apply:b},indent:{check:f,init:19,apply:d,event:x,themeable:true},icon:{check:o,apply:z,event:i,nullable:true,themeable:true},iconOpened:{check:o,apply:k,event:h,nullable:true,themeable:true},label:{check:o,apply:v,event:g,init:D}},members:{__lp:null,__lq:null,__lr:null,_addWidgets:function(){throw new Error(m);}
,_createChildControlImpl:function(G,H){var I;switch(G){case l:I=new qx.ui.basic.Label().set({alignY:n,anonymous:true,value:this.getLabel()});break;case u:I=new qx.ui.basic.Image().set({alignY:n,anonymous:true,source:this.getIcon()});break;case t:I=new qx.ui.tree.core.FolderOpenButton().set({alignY:n});I.addListener(r,this._onChangeOpen,this);I.addListener(a,this._updateIndent,this);break;};return I||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,G);}
,addWidget:function(J,K){this._add(J,K);}
,addSpacer:function(){if(!this.__lr){this.__lr=new qx.ui.core.Spacer();}
else {this._remove(this.__lr);}
;this._add(this.__lr);}
,addOpenButton:function(){this._add(this.getChildControl(t));}
,_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());}
;}
,addIcon:function(){var L=this.getChildControl(u);if(this.__lq){this._remove(L);}
;this._add(L);this.__lq=true;}
,addLabel:function(M){var N=this.getChildControl(l);if(this.__lp){this._remove(N);}
;if(M){this.setLabel(M);}
else {N.setValue(this.getLabel());}
;this._add(N);this.__lp=true;}
,_applyIcon:function(O,P){if(!this.__lt()){this.__lu(O);}
else if(!this.isOpen()){this.__lu(O);}
;}
,_applyIconOpened:function(Q,R){if(this.isOpen()){if(this.__ls()&&this.__lt()){this.__lu(Q);}
else if(!this.__ls()&&this.__lt()){this.__lu(Q);}
;}
;}
...
;var X;if(V){X=this.__lt()?this.getIconOpened():null;}
else {X=this.getIcon();}
;if(X){this.__lu(X);}
;V?this.addState(s):this.removeState(s);}
,__ls:function(){return qx.util.PropertyUtil.getUserValue(this,u);}
,__lt:function(){return qx.util.PropertyUtil.getUserValue(this,C);}
,__lu:function(Y){var ba=this.getChildControl(u,true);if(ba){ba.setSource(Y);}
;}
...
;}
;if(this.__lr){this.__lr.setWidth((this.getLevel()+1)*this.getIndent()-bf);}
;}
...
(function(){var o="__lP",n="open",m="abstract",k="'. It is not a child of this tree item.",j="addItem",h="__dW",g="removeItem",f="Invalid child index: ",e="Cannot remove treeitem '",d="visible",a="excluded",c="qx.ui.tree.core.AbstractTreeItem",b="qx.debug";qx.Class.define(c,{extend:qx.ui.tree.core.AbstractItem,type:m,construct:function(p){qx.ui.tree.core.AbstractItem.call(this,p);this.__dW=[];}
,properties:{parent:{check:c,nullable:true}},members:{__dW:null,__lP:null,getTree:function(){var r=this;while(r.getParent()){r=r.getParent();}
...
,_shouldShowOpenSymbol:function(){var open=this.getChildControl(n,true);if(!open){return false;}
...
;}
;}
,getChildrenContainer:function(){if(!this.__lP){this.__lP=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?d:a});}
;return this.__lP;}
,hasChildrenContainer:function(){return this.__lP;}
,getParentChildrenContainer:function(){if(this.getParent()){return this.getParent().getChildrenContainer();}
else if(this.getLayoutParent()){return this.getLayoutParent();}
else {return null;}
;}
,getChildren:function(){return this.__dW;}
,hasChildren:function(){return this.__dW?this.__dW.length>0:false;}
...
;this.__dW.push(R);if(!O){this.__lQ();}
;if(Q){R.recursiveAddToWidgetQueue();Q.fireNonBubblingEvent(j,qx.event.type.Data,[R]);}
;}
;if(Q){qx.ui.core.queue.Widget.add(this);}
;}
,addAt:function(S,T){if(qx.core.Environment.get(b)){this.assert(T<=this.__dW.length&&T>=0,f+T);}
;if(T==this.__dW.length){this.add(S);return;}
;var X=S.getParent();if(X){X.remove(S);}
;var V=this.getChildrenContainer();S.setParent(this);var W=this.hasChildren();var U=this.__dW[T];V.addBefore(S,U);if(S.hasChildren()){V.addAfter(S.getChildrenContainer(),S);}
;qx.lang.Array.insertAt(this.__dW,S,T);if(!W){this.__lQ();}
;if(this.getTree()){S.recursiveAddToWidgetQueue();qx.ui.core.queue.Widget.add(this);}
;}
,addBefore:function(Y,ba){if(qx.core.Environment.get(b)){this.assert(this.__dW.indexOf(ba)>=0);}
;var bb=Y.getParent();if(bb){bb.remove(Y);}
;this.addAt(Y,this.__dW.indexOf(ba));}
,addAfter:function(bc,bd){if(qx.core.Environment.get(b)){this.assert(this.__dW.indexOf(bd)>=0);}
;var be=bc.getParent();if(be){be.remove(bc);}
;this.addAt(bc,this.__dW.indexOf(bd)+1);}
,addAtBegin:function(bf){this.addAt(bf,0);}
,remove:function(bg){for(var i=0,l=arguments.length;i<l;i++){var bk=arguments[i];if(this.__dW.indexOf(bk)==-1){this.warn(e+bk+k);return;}
...
;}
;qx.lang.Array.remove(this.__dW,bk);bk.setParent(null);bh.remove(bk);}
;var bi=this.getTree();if(bi){bi.fireNonBubblingEvent(g,qx.event.type.Data,[bk]);}
;qx.ui.core.queue.Widget.add(this);}
,removeAt:function(bl){var bm=this.__dW[bl];if(bm){this.remove(bm);}
;}
,removeAll:function(){var bn=this.__dW.concat();for(var i=this.__dW.length-1;i>=0;i--){this.remove(this.__dW[i]);}
;return bn;}
},destruct:function(){this._disposeArray(h);this._disposeObjects(o);}
});}
)();
(function(){var l="__mq",k="_applyOpenMode",j="Space",h="Left",g="Enter",f="changeOpenMode",d="_applyRootOpenClose",c="changeSelection",b="qx.ui.tree.Tree",a="qx.ui.tree.core.AbstractTreeItem",z="tree",y="_applyHideRoot",x="changeRoot",w="_applyRoot",v="keypress",u="none",t="pane",s="Right",r="Boolean",q="excluded",o="visible",p="qx.event.type.Data",m="click",n="dblclick";qx.Class.define(b,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection,qx.ui.form.IForm],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection,qx.ui.form.MForm],construct:function(){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__mq=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});this.getChildControl(t).add(this.__mq);this.initOpenMode();this.initRootOpenClose();this.addListener(c,this._onChangeSelection,this);this.addListener(v,this._onKeyPress,this);}
,events:{addItem:p,removeItem:p},properties:{openMode:{check:[m,n,u],init:n,apply:k,event:f,themeable:true},root:{check:a,init:null,nullable:true,event:x,apply:w},hideRoot:{check:r,init:false,apply:y},rootOpenClose:{check:r,init:false,apply:d},appearance:{refine:true,init:z},focusable:{refine:true,init:true}},members:{__mq:null,SELECTION_MANAGER:qx.ui.tree.selection.SelectionManager,getChildrenContainer:function(){return this.__mq;}
...
,_getContentPaddingTarget:function(){return this.__mq;}
