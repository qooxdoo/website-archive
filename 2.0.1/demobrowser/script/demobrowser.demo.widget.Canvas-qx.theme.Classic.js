...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Canvas-qx.theme.Classic.1f44508416b0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="resize",h="_applyCanvasWidth",g="Boolean",f="__JS",d="_applyCanvasHeight",c="qx.ui.embed.Canvas",b="qx.event.type.Data",a="Integer";qx.Class.define(c,{extend:qx.ui.core.Widget,construct:function(j,k){qx.ui.core.Widget.call(this);this.__JS=new qx.util.DeferredCall(this.__JT,this);this.addListener(i,this._onResize,this);if(j!==undefined){this.setCanvasWidth(j);}
;if(k!==undefined){this.setCanvasHeight(k);}
;}
,events:{"redraw":b},properties:{syncDimension:{check:g,init:false},canvasWidth:{check:a,init:300,apply:h},canvasHeight:{check:a,init:150,apply:d}},members:{__JS:null,_createContentElement:function(){return new qx.html.Canvas();}
,__JT:function(){var m=this.getContentElement();var o=m.getHeight();var l=m.getWidth();var n=m.getContext2d();this._draw(l,o,n);this.fireNonBubblingEvent("redraw",qx.event.type.Data,[{width:l,height:o,context:n}]);}
,_applyCanvasWidth:function(p,q){this.getContentElement().setWidth(p);this.__JS.schedule();}
,_applyCanvasHeight:function(r,s){this.getContentElement().setHeight(r);this.__JS.schedule();}
,update:function(){this.__JS.schedule();}
...
(function(){var c="2d",b="qx.html.Canvas",a="canvas";qx.Class.define(b,{extend:qx.html.Element,construct:function(d,e){qx.html.Element.call(this,a,d,e);this.__JU=document.createElement(a);}
,members:{__JU:null,_createDomElement:function(){return this.__JU;}
,getCanvas:function(){return this.__JU;}
,setWidth:function(f){this.__JU.width=f;}
,getWidth:function(){return this.__JU.width;}
,setHeight:function(g){this.__JU.height=g;}
,getHeight:function(){return this.__JU.height;}
,getContext2d:function(){return this.__JU.getContext(c);}
