...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.DragDrop-qx.theme.Simple.15a28802bd98.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
);var K=new qx.ui.basic.Label(g);G.add(K,{left:500,top:20});var E=this.__Dg=new qx.ui.form.List;E.setDraggable(true);E.setDroppable(true);E.setSelectionMode(s);G.add(E,{left:500,top:40});for(var i=0;i<20;i++){E.add(new qx.ui.form.ListItem(v+i,x));}
;var F=new qx.ui.core.Widget;F.setDecorator(new qx.ui.decoration.Single().set({top:[1,j,c]}));F.setHeight(0);F.setOpacity(0.5);F.setZIndex(100);F.setLayoutProperties({left:-1000,top:-1000});F.setDroppable(true);this.getRoot().add(F);E.addListener(w,function(e){e.addAction(r);}
);E.addListener(y,function(e){F.setDomPosition(-1000,-1000);}
);E.addListener(m,function(e){var X=e.getOriginalTarget();if(X instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Ri=X;}
...
;var ba=this.__Dg.getSortedSelection();for(var i=0,l=ba.length;i<l;i++){this.__Dg.addBefore(ba[i],Y);this.__Dg.addToSelection(ba[i]);}
;}
