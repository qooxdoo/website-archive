...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_HeaderRenderer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_HeaderRenderer-qx.theme.Indigo.f9bdc00666cd.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="icon/16/apps/internet-feed-reader.png",h="mouseover",g="demobrowser.demo.test.Table_HeaderRenderer",f="_container",d="mouseout",c="Name",b="hovered",a="tool tip";qx.Class.define(g,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.setUp();this.testDefaultRenderer();this.testIconRenderer();}
,setUp:function(){this._container=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));this.getRoot().add(this._container,{left:20,top:20});}
,testDefaultRenderer:function(){var l=new qx.ui.table.headerrenderer.Default();l.setToolTip(a);var j={name:[c],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};var k=this._getNewHeaderContainer();qx.util.Permutation.permute(j,function(m){var n=l.createHeaderCell(m);k.add(n);l.updateHeaderCell(m,n);}
);}
,testIconRenderer:function(){var q=new qx.ui.table.headerrenderer.Icon(i);q.setToolTip(a);var o={name:[c],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};var p=this._getNewHeaderContainer();qx.util.Permutation.permute(o,function(r){var s=q.createHeaderCell(r);p.add(s);q.updateHeaderCell(r,s);}
);}
,_getNewHeaderContainer:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));t.addListener(h,function(e){e.getTarget().addState(b);}
);t.addListener(d,function(e){e.getTarget().removeState(b);}
);this._container.add(t);return t;}
},destruct:function(){this._disposeObjects(f);}
});}
)();
