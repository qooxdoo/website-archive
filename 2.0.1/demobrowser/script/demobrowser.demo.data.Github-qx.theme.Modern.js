...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Github-qx.theme.Modern.9a3c8311339c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return H;}
},members:{__Mk:null,__JV:null,__Mn:null,__Ml:null,__Mm:null,__Mo:null,configureRequest:function(K){this.__Mo=K;}
...
,map:function(N,O,P,Q){this.__JV[N]=[O,P,Q];this.__Mk[N]=[];if(N==z){this[N]=undefined;}
...
,invoke:function(R,S,T){var V=this.__Mp(R),S=S==null?{}:S,Y=this._getRequestConfig(R,S);this.__JV[R].params=S;this.__Mq(S,Y.check);this.__Jm(V,Y,T);if(this.__Mo){this.__Mo.call(this,V,R,S,T);}
...
;}
,__Jm:function(bg,bh,bi){bg.set({method:bh.method,url:bh.url});if(bi){bg.setRequestData(bi);}
;}
...
;}
;}
,refresh:function(bu){this.invoke(bu,this.__JV[bu].params);}
,poll:function(bv,bw,bx){if(this.__Ml[bv]){this.__Ml[bv].dispose();}
;if(typeof bx==u){bx=this.__JV[bv].params;}
...
,_getRequestConfig:function(bK,bL){var bN=this.__JV[bK];var bL=qx.lang.Object.clone(bL);if(!qx.lang.Type.isArray(bN)){throw new Error(E+bK);}
...
;}
;this.__Mk=this.__JV=this.__Ml=null;}
});}
)();
...
(function(){var j="changeModel",i="model.user.avatar_url",h="application/json",g="github.view.Gist",f="model.description",e="west",d="/gists/{id}",c="Description",b="https://api.github.com",a="demobrowser.demo.data.Github",H="source",G="/gists",F="change",E="Content",D="center",C="#fff",B="Authorization",A="html",z="model.user.login",y="model.files",q="north",r="Gists",o="Accept",p="token ",m="github.rest.Resource",n="description",k="undefined",l="</pre>",s="<pre>",t="GET",v="value",u="get",x="model",w="bold";qx.Class.define(a,{extend:qx.application.Standalone,members:{__PU:null,__PV:null,__PW:null,__PX:null,__Dg:null,__PY:null,main:function(){if(typeof GITHUB==k){return;}
;qx.application.Standalone.prototype.main.call(this);this._setUpResources();this._setUpStores();this._createGui();this._setUpBinding();this.__PU.get();this.__Dg.addListener(j,function(I){var J=I.getData();this.__Dg.getSelection().push(J.getItem(0));}
,this);this.__Dg.getSelection().addListener(F,function(K){var L=this.__Dg.getSelection().getItem(0).getId();this.__PV.get({id:L});}
,this);}
...
,_createGui:function(){var M=new qx.ui.container.Composite(new qx.ui.layout.Dock());M.setPadding(10);var N=new qx.ui.basic.Label(r);N.setFont(w);N.setPaddingBottom(10);M.add(N,{edge:q});this.__Dg=new qx.ui.list.List();this.__Dg.setWidth(200);this.__PY=new github.view.Gist();M.add(this.__Dg,{edge:e});M.add(this.__PY,{edge:D});this.getRoot().add(M,{edge:0});}
,_setUpBinding:function(){var P=this.__Dg,O=this.__PW,Q=this.__PX;P.setLabelPath(n);P.setLabelOptions({converter:function(S,T,U,V){if(S===null||!S.length){return T.getId();}
;return S;}
...
;this._delegate=j;this._marshaler=new qx.data.marshal.Json(j);if(j&&qx.lang.Type.isFunction(j.configureRequest)){this.__Jm();}
;this.__Jl=qx.lang.Function.bind(this.__Jn,this);this.__xB();}
,properties:{resource:{check:d},actionName:{check:b},model:{nullable:true,event:g}},members:{_marshaler:null,_delegate:null,__Jl:null,__Jm:function(){var k=this.getResource(),l=this._delegate;k.configureRequest(l.configureRequest);}
,__xB:function(){var n=this.getResource(),m=this.getActionName();if(n&&m){n.addListener(this.getActionName()+c,this.__Jl);}
;}
,__Jn:function(e){var p=e.getData(),o=this._marshaler,q,r=this.getModel(),s=this._delegate;if(p){if(s&&s.manipulateData){p=s.manipulateData(p);}
