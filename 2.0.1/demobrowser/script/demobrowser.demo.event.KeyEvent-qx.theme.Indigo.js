...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.KeyEvent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.KeyEvent-qx.theme.Indigo.0c75ab12413c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="logger",m="keypress",l="Char code",k="Ctrl",j="Key identifier",h="demobrowser.demo.event.KeyEvent",g="Shift",f="keydown",e="Event",d="Alt",a="keyup",c="",b="keyinput";qx.Class.define(h,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([e,j,l,g,k,d],document.getElementById(n),50);var o=[f,m,a,b];for(var i=0;i<o.length;i++){qx.bom.Element.addListener(document.documentElement,o[i],this.logKeyEvent,this);}
;}
,logKeyEvent:function(p){var q=p.getType();this._log([q,q!==b?p.getKeyIdentifier():c,q==b?p.getCharCode():c,p.isShiftPressed(),p.isCtrlPressed(),p.isAltPressed()]);p.preventDefault();}
}});}
)();
