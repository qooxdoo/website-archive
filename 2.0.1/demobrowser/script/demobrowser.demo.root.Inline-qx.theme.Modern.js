...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline-qx.theme.Modern.58f7e538cc5e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="black",h="red",g="demobrowser.demo.root.Inline",f="isle",e="green",d="white",c="yellow",b="blue",a="main";qx.Class.define(g,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);var l=new qx.ui.root.Inline(document.getElementById(f)).set({decorator:a,padding:10,textColor:i,backgroundColor:d});var m=new qx.ui.core.Widget().set({backgroundColor:h,decorator:a,padding:10});var n=new qx.ui.core.Widget().set({backgroundColor:b,decorator:a});var k=new qx.ui.core.Widget().set({backgroundColor:e,decorator:a});var j=new qx.ui.core.Widget().set({backgroundColor:c,decorator:a});l.add(m);l.add(n);l.add(k);l.add(j);l.setLayout(new qx.ui.layout.HBox());}
}});}
)();
