...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup-qx.theme.Indigo.cef65a86e6ab.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bp=this._tables[this.__MP].values;var bq=this.__MM[this.__MP];if(!bp){return;}
;var br=this.getValue();if(!br){return;}
;var bo=bp.indexOf(br);if(bo!=-1){qx.lang.Array.removeAt(bp,bo);}
else if(bp.length==this.__MQ){bp.shift();}
...
;this.__MO.setRed(bz);this.__MO.setGreen(by);this.__MO.setBlue(bx);this.__MN.open();}
,_onColorSelectorOk:function(){var bA=this.__MO;this.setValue(qx.util.ColorUtil.rgbToRgbString([bA.getRed(),bA.getGreen(),bA.getBlue()]));this.__MN.close();}
,_onColorSelectorCancel:function(){this.__MN.close();}
...
;}
,_tables:{core:{label:w,values:[b,c,g,o,Q,s,y,I,T,a,l,k]},recent:{label:H,values:[]}}},destruct:function(){this._disposeObjects(f,u);this._tables=this.__MM=null;}
});}
)();
...
;this.__ID=true;this.setRed(ch[0]);this.setGreen(ch[1]);this.__ID=false;this.setBlue(ch[2]);}
,getValue:function(){return this.__mB?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__mB=true;this.__ID=true;this.setRed(255);this.setGreen(255);this.__ID=false;this.setBlue(255);}
,__mE:function(){if(!this.__ID){this.__mB=false;this.fireDataEvent(T,this.getValue());}
;}
,_applyRed:function(ci,cj){if(this.__Ix===null){this.__Ix=B;}
;if(this.__Ix!==z){this.getChildControl(v).setValue(ci);}
;if(this.__Ix!==U){this._setHexFromRgb();}
;switch(this.__Ix){case z:case U:case B:this._setHueFromRgb();};this._setPreviewFromRgb();this.__mE();if(this.__Ix===B){this.__Ix=null;}
;}
,_applyGreen:function(ck,cl){if(this.__Ix===null){this.__Ix=C;}
;if(this.__Ix!==z){this.getChildControl(p).setValue(ck);}
;if(this.__Ix!==U){this._setHexFromRgb();}
;switch(this.__Ix){case z:case U:case C:this._setHueFromRgb();};this._setPreviewFromRgb();this.__mE();if(this.__Ix===C){this.__Ix=null;}
;}
,_applyBlue:function(cm,cn){if(this.__Ix===null){this.__Ix=J;}
;if(this.__Ix!==z){this.getChildControl(Q).setValue(cm);}
;if(this.__Ix!==U){this._setHexFromRgb();}
;switch(this.__Ix){case z:case U:case J:this._setHueFromRgb();};this._setPreviewFromRgb();this.__mE();if(this.__Ix===J){this.__Ix=null;}
;}
,_applyHue:function(co,cp){if(this.__Ix===null){this.__Ix=u;}
;if(this.__Ix!==A){this.getChildControl(R).setValue(co);}
;if(this.__Ix!==N){if(this.getChildControl(y).getBounds()){this.getChildControl(y).setDomLeft(Math.round(co/1.40625)+this.getChildControl(P).getPaddingLeft());}
else {this.getChildControl(y).setLayoutProperties({left:Math.round(co/1.40625)});}
;}
;switch(this.__Ix){case A:case N:case u:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__Ix===u){this.__Ix=null;}
;}
,_applySaturation:function(cq,cr){if(this.__Ix===null){this.__Ix=K;}
;if(this.__Ix!==A){this.getChildControl(S).setValue(cq);}
;if(this.__Ix!==N){this._setBrightnessGradiant();if(this.getChildControl(y).getBounds()){this.getChildControl(y).setDomTop(256-Math.round(cq*2.56)+this.getChildControl(P).getPaddingTop());}
else {this.getChildControl(y).setLayoutProperties({top:256-Math.round(cq*2.56)});}
;}
;switch(this.__Ix){case A:case N:case K:this._setRgbFromHue();};if(this.__Ix===K){this.__Ix=null;}
;}
,_applyBrightness:function(cs,ct){if(this.__Ix===null){this.__Ix=E;}
;if(this.__Ix!==A){this.getChildControl(o).setValue(cs);}
;if(this.__Ix!==s){var cu=256-Math.round(cs*2.56);if(this.getChildControl(x).getBounds()){this.getChildControl(x).setDomTop(cu+this.getChildControl(w).getPaddingTop());}
else {this.getChildControl(x).setLayoutProperties({top:cu});}
;}
;switch(this.__Ix){case A:case s:case E:this._setRgbFromHue();};if(this.__Ix===E){this.__Ix=null;}
;}
,_onBrightnessHandleMouseDown:function(e){this.getChildControl(x).capture();this.__Iz=x;var cx=this.getChildControl(O).getContainerLocation();var cw=this.getChildControl(x).getContainerLocation();var cv=this.getChildControl(O).getBounds();this.__IA=cx.top+(e.getDocumentTop()-cw.top)-cv.top;e.stopPropagation();}
,_onBrightnessHandleMouseUp:function(e){this.getChildControl(x).releaseCapture();this.__Iz=null;}
,_onBrightnessHandleMouseMove:function(e){if(this.__Iz===x){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(O).getContainerLocation();var cy=this.getChildControl(x).getBounds();this.__IA=location.top+(cy.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(x).capture();this.__Iz=x;}
...
,_setBrightnessOnFieldEvent:function(e){var cz=qx.lang.Number.limit(e.getDocumentTop()-this.__IA,0,256);this.__Ix=s;if(this.getChildControl(x).getBounds()){this.getChildControl(x).setDomTop(cz);}
else {this.getChildControl(x).setLayoutProperties({top:cz});}
;this.setBrightness(100-Math.round(cz/2.56));this.__Ix=null;}
,_onHueSaturationHandleMouseUp:function(e){if(this.__Iz){e.stopPropagation();this.getChildControl(y).releaseCapture();this.__Iz=null;}
;}
,_onHueSaturationHandleMouseMove:function(e){if(this.__Iz===y){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(r).getContainerLocation();var cA=this.getChildControl(y).getBounds();var cB=this.getChildControl(r).getBounds();this.__IB=location.top+(cA.height/2)-cB.top;this.__IC=location.left+(cA.width/2)-cB.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(y).capture();this.__Iz=y;}
...
,_setHueSaturationOnFieldEvent:function(e){var cD=qx.lang.Number.limit(e.getDocumentTop()-this.__IB,0,256);var cC=qx.lang.Number.limit(e.getDocumentLeft()-this.__IC,0,256);this.getChildControl(y).setDomPosition(cC,cD);this.__Ix=N;this.setSaturation(100-Math.round(cD/2.56));this.setHue(Math.round(cC*1.40625));this.__Ix=null;}
,_setRedFromSpinner:function(){if(this.__Ix!==null){return;}
;this.__Ix=z;this.setRed(this.getChildControl(v).getValue());this.__Ix=null;}
,_setGreenFromSpinner:function(){if(this.__Ix!==null){return;}
;this.__Ix=z;this.setGreen(this.getChildControl(p).getValue());this.__Ix=null;}
,_setBlueFromSpinner:function(){if(this.__Ix!==null){return;}
;this.__Ix=z;this.setBlue(this.getChildControl(Q).getValue());this.__Ix=null;}
,_setHueFromSpinner:function(){if(this.__Ix!==null){return;}
;this.__Ix=A;this.setHue(this.getChildControl(R).getValue());this.__Ix=null;}
,_setSaturationFromSpinner:function(){if(this.__Ix!==null){return;}
;this.__Ix=A;this.setSaturation(this.getChildControl(S).getValue());this.__Ix=null;}
,_setBrightnessFromSpinner:function(){if(this.__Ix!==null){return;}
;this.__Ix=A;this.setBrightness(this.getChildControl(o).getValue());this.__Ix=null;}
,_onHexFieldChange:function(e){if(this.__Ix!==null){return;}
;try{var cF=this.getChildControl(L);var cE=qx.util.ColorUtil.hexStringToRgb(bM+cF.getValue());}
catch(cG){return;}
;this.__Ix=U;this.setRed(cE[0]);this.setGreen(cE[1]);this.setBlue(cE[2]);this.__Ix=null;}
...
,_setHueFromRgb:function(){switch(this.__Ix){case A:case N:case s:break;default:var cK=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(cK[0]);this.setSaturation(cK[1]);this.setBrightness(cK[2]);};}
,_setRgbFromHue:function(){switch(this.__Ix){case z:case U:break;default:var cL=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(cL[0]);this.setGreen(cL[1]);this.setBlue(cL[2]);};}
