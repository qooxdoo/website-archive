...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SelectBox-qx.theme.Modern.795529b2f07f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="icon/16/devices/",m="printer",l="firstname",k=".png",j="media-optical",h="computer",g="Simple",f="Filtered",d="json/persons.json",c="camera-photo",W="Empty Item",V="network-wired",U="selection[0]",T="change",S="icon",R="Random Value ",Q="Grouped with Persons",P="drive-harddisk",O="model.persons",N="Sorted",u="audio-card",v="network-wireless",s="Change selection: ",t="drive-optical",q="camera-web",r="media-flash",o="input-mouse",p="Option ",w="pda",x="battery",E="model",C="label",H="audio-input-microphone",G="no model...",J="With icons",I="demobrowser.demo.virtual.SelectBox",z="phone",M="input-keyboard",L=" ",K="multimedia-player",y="Long text",A="display",B="toolTipText",D="",F="Item ";qx.Class.define(I,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var ba=new qx.ui.container.Scroll();var X=new qx.ui.container.Composite(new qx.ui.layout.Canvas());ba.add(X,{edge:0});var bb=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));bb.setPadding(20);var Y=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));Y.setPadding(20);bb.add(this.createBox1());bb.add(this.createBox2());bb.add(this.createBox3());bb.add(this.createBox4());Y.add(this.createBox5());Y.add(this.createBox6());Y.add(this.createBox7());X.add(bb,{left:20,top:20});X.add(Y,{left:20,top:200});this.getRoot().add(ba,{edge:0});}
,createBox1:function(){var bd=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bd.add(new qx.ui.basic.Label(g));var bc=new qx.data.Array();for(var i=0;i<300;i++){bc.push(F+(i+1));}
;var be=new qx.ui.form.VirtualSelectBox(bc);bd.add(be);be.getSelection().push(bc.getItem(5));be.getSelection().addListener(T,function(e){this.debug(s,be.getSelection().getItem(0));}
);return bd;}
,createBox2:function(){var bg=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bg.add(new qx.ui.basic.Label(y));var bf=new qx.data.Array();for(var i=0;i<300;i++){bf.push(R+Math.round(Math.random()*100000000));}
;var bh=new qx.ui.form.VirtualSelectBox(bf);bg.add(bh);bh.bind(U,bh,B,null);var bi={bindItem:function(bj,bk,bl){bj.bindDefaultProperties(bk,bl);bj.bindProperty(D,B,null,bk,bl);}
};bh.setDelegate(bi);return bg;}
,createBox3:function(){var bn=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bn.add(new qx.ui.basic.Label(J));var bo=[u,H,x,c,q,h,A,P,t,M,o,r,j,K,V,v,w,z,m];var bs=n;var bp=k;var bq=[];for(var i=0;i<bo.length;i++){bq.push({label:bo[i],icon:bs+bo[i]+bp});}
;var br=qx.data.marshal.Json.createModel(bq);var bm=new qx.ui.form.VirtualSelectBox(br).set({labelPath:C,iconPath:S});bn.add(bm);return bn;}
,createBox4:function(){var bu=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bu.add(new qx.ui.basic.Label(W));var bt=new qx.data.Array();bt.push(D);for(var i=0;i<300;i++){bt.push(p+(i+1));}
;var bv=new qx.ui.form.VirtualSelectBox(bt);bu.add(bv);return bu;}
,createBox5:function(){var bx=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bx.add(new qx.ui.basic.Label(N));var bw=new qx.data.Array();for(var i=0;i<300;i++){bw.push(F+i);}
;var by=new qx.ui.form.VirtualSelectBox(bw);bx.add(by);var bz={sorter:function(a,b){return a<b?1:a>b?-1:0;}
};by.setDelegate(bz);return bx;}
,createBox6:function(){var bB=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bB.add(new qx.ui.basic.Label(f));var bA=new qx.data.Array();for(var i=0;i<300;i++){bA.push(F+i);}
;var bC=new qx.ui.form.VirtualSelectBox(bA);bB.add(bC);var bD={filter:function(bE){return ((parseInt(bE.slice(5,bE.length),10))%2==1);}
};bC.setDelegate(bD);return bB;}
,createBox7:function(){var bH=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));bH.add(new qx.ui.basic.Label(Q));var bG=new qx.ui.form.VirtualSelectBox();bG.setLabelPath(l);bG.setLabelOptions({converter:function(bK,bL){return bL?bK+L+bL.getLastname():G;}
});bH.add(bG);var bF=d;var bJ=new qx.data.store.Json(bF);bJ.bind(O,bG,E);var bI={sorter:function(a,b){a=a.getFirstname();b=b.getFirstname();return a>b?1:a<b?-1:0;}
...
(function(){var r='"',q="The model contained an illegal name: '",p="qx.debug.databinding",o="change",n="qx.data.marshal.Json",m="Unsupported type!",l="'.",k="'. Replaced it with '",j="set",h="' is not a valid JavaScript identifier.",c="_applyEventPropagation",g="The key '",f="",b="Array",a="_validate",e="qx.debug",d="qx.data.model.";qx.Class.define(n,{extend:qx.core.Object,implement:[qx.data.marshal.IMarshaler],construct:function(s){qx.core.Object.call(this);this.__tV=s;}
...
},members:{__tV:null,__tW:function(v){return qx.Bootstrap.getKeys(v).sort().join(r);}
...
;}
;return;}
;var z=this.__tW(w);for(var A in w){this.toClass(w[A],x);}
;if(qx.Class.isDefined(d+z)){return;}
;if(this.__tV&&this.__tV.getModelClass&&this.__tV.getModelClass(z)!=null){return;}
;var G={};var F={__tX:this.__tX};for(var A in w){if(this.__tV&&this.__tV.getPropertyMapping){A=this.__tV.getPropertyMapping(A,z);}
...
;if(this.__tV&&this.__tV.getValidationRule){var C=this.__tV.getValidationRule(z,A);if(C){G[A].validate=a+A;F[a+A]=C;}
;}
;}
;if(this.__tV&&this.__tV.getModelSuperClass){var E=this.__tV.getModelSuperClass(z)||qx.core.Object;}
else {var E=qx.core.Object;}
;var B=[];if(this.__tV&&this.__tV.getModelMixins){var D=this.__tV.getModelMixins(z);if(!qx.lang.Type.isArray(D)){if(D!=null){B=[D];}
;}
else {B=D;}
;}
;if(x){B.push(qx.data.marshal.MEventBubbling);}
;var y={extend:E,include:B,properties:G,members:F,destruct:this.__tY};qx.Class.define(d+z,y);}
,__tY:function(){var H=qx.util.PropertyUtil.getAllProperties(this.constructor);for(var I in H){this.__tX(this.get(H[I].name));}
;}
,__tX:function(J){if(!(J instanceof qx.core.Object)){return;}
;if(J.isDisposed()){return;}
;J.dispose();}
,__ua:function(K){var L;if(this.__tV&&this.__tV.getModelClass){L=this.__tV.getModelClass(K);}
...
;return U;}
else if(S){var P=this.__tW(N);var V=this.__ua(P);for(var T in N){var Q=T;if(this.__tV&&this.__tV.getPropertyMapping){Q=this.__tV.getPropertyMapping(T,P);}
...
(function(){var j="changeModel",i="application/json",h="json",g="loaded",f="error",e="fail",d="queued",c="changeState",b="success",a="String",x="__qK",w="changePhase",v="_marshaler",u="qx.data.store.Json",t="changeUrl",s="_applyUrl",r="aborted",q="qx.event.type.Data",p="receiving",o="sending",m="completed",n="failed",k="timeout",l="configured";qx.Class.define(u,{extend:qx.core.Object,construct:function(y,z){qx.core.Object.call(this);this._marshaler=new qx.data.marshal.Json(z);this._delegate=z;if(y!=null){this.setUrl(y);}
;}
,events:{"loaded":q,"error":q},properties:{model:{nullable:true,event:j},state:{check:[l,d,o,p,m,r,k,n],init:l,event:c},url:{check:a,apply:s,event:t,nullable:true}},members:{_marshaler:null,_delegate:null,__qK:null,_applyUrl:function(A,B){if(A!=null){A=qx.util.AliasManager.getInstance().resolve(A);A=qx.util.ResourceManager.getInstance().toUri(A);this._createRequest(A);}
;}
,_getRequest:function(){return this.__qK;}
,_setRequest:function(C){this.__qK=C;}
,_createRequest:function(D){if(this.__qK){this.__qK.dispose();this.__qK=null;}
;var E=new qx.io.request.Xhr(D);this._setRequest(E);E.setAccept(i);E.setParser(h);E.addListener(b,this._onSuccess,this);var F=this._delegate;if(F&&qx.lang.Type.isFunction(F.configureRequest)){this._delegate.configureRequest(E);}
;E.addListener(w,this._onChangePhase,this);E.addListener(e,this._onFail,this);E.send();}
,_onChangePhase:function(G){var H=G.getData(),J={},I;J={"opened":l,"sent":o,"loading":p,"success":m,"abort":r,"timeout":k,"statusError":n};I=J[H];if(I){this.setState(I);}
;}
,_onFail:function(K){var L=K.getTarget();this.fireDataEvent(f,L);}
,_onSuccess:function(M){if(this.isDisposed()){return;}
;var O=M.getTarget(),P=O.getResponse();var N=this._delegate;if(N&&qx.lang.Type.isFunction(N.manipulateData)){P=this._delegate.manipulateData(P);}
;this._marshaler.toClass(P,true);var Q=this.getModel();this.setModel(this._marshaler.toModel(P));if(Q&&Q.dispose){Q.dispose();}
;this.fireDataEvent(g,this.getModel());if(this.__qK){this.__qK.dispose();this.__qK=null;}
;}
,reload:function(){var R=this.getUrl();if(R!=null){this._createRequest(R);}
;}
},destruct:function(){if(this.__qK!=null){this._disposeObjects(x);}
;this._disposeSingletonObjects(v);this._delegate=null;}
});}
)();
...
;this.__qt={};var O=this._transport=this._createTransport();this._setPhase(p);this.__um=qx.lang.Function.bind(this._onReadyStateChange,this);this.__un=qx.lang.Function.bind(this._onLoad,this);this.__uo=qx.lang.Function.bind(this._onLoadEnd,this);this.__up=qx.lang.Function.bind(this._onAbort,this);this.__sU=qx.lang.Function.bind(this._onTimeout,this);this.__uq=qx.lang.Function.bind(this._onError,this);O.onreadystatechange=this.__um;O.onload=this.__un;O.onloadend=this.__uo;O.onabort=this.__up;O.ontimeout=this.__sU;O.onerror=this.__uq;}
...
,nullable:true},authentication:{check:c,nullable:true}},members:{__um:null,__un:null,__uo:null,__up:null,__sU:null,__uq:null,__ur:null,__sW:null,__us:null,__qt:null,__ut:null,_transport:null,_createTransport:function(){throw new Error(A);}
...
;this.__sW=true;this.__us=x;this._transport.abort();}
,_setRequestHeaders:function(){var X=this._transport,V=this._getAllRequestHeaders();for(var W in V){X.setRequestHeader(W,V[W]);}
;}
,_getAllRequestHeaders:function(){var Y=qx.lang.Object.merge({},this._getConfiguredRequestHeaders(),this.__uu(),this.__ut,this.__qt);return Y;}
,__uu:function(){var bb=this.getAuthentication(),ba={};if(bb){bb.getAuthHeaders().forEach(function(bc){ba[bc.key]=bc.value;}
);return ba;}
;}
...
,getPhase:function(){return this.__us;}
...
,getResponse:function(){return this.__ur;}
,_setResponse:function(bi){var bj=bi;if(this.__ur!==bi){this.__ur=bi;this.fireEvent(m,qx.event.type.Data,[this.__ur,bj]);}
;}
,_onReadyStateChange:function(){var bk=this.getReadyState();if(qx.core.Environment.get(C)){this.debug(D+bk);}
;this.fireEvent(r);if(this.__sW){return;}
;if(bk===3){this._setPhase(M);}
;if(this.isDone()){this.__uv();}
;}
,__uv:function(){var bl;if(qx.core.Environment.get(C)){this.debug(E+this.getStatus());}
...
,_setPhase:function(bn){var bo=this.__us;if(qx.core.Environment.get(v)){qx.core.Assert.assertString(bn);qx.core.Assert.assertMatch(bn,/^(unsent)|(opened)|(sent)|(loading)|(load)|(success)|(abort)|(timeout)|(statusError)$/);}
;this.__us=bn;this.fireDataEvent(h,bn,bo);}
...
,init:true}},members:{__uw:null,_createTransport:function(){return new qx.bom.request.Xhr();}
...
;}
;return C;}
,setParser:function(D){var E=qx.io.request.Xhr;if(typeof E.PARSER[D]===h){return this.__uw=E.PARSER[D];}
;if(qx.core.Environment.get(o)){qx.core.Assert.assertFunction(D);}
;return this.__uw=D;}
,_getParser:function(){var F=this.__uw,G;if(F){return F;}
...
(function(){var k="Retry open native request with method: ",j="activex",i="No XHR support available.",h="If-None-Match",g="xhr",f="engine.version",d="GET",c="-1",b="Open native request with method: ",a="Received native readyState: ",P="abort",O="Microsoft.XMLHTTP",N="Already disposed",M="browser.version",L="on",K="If-Match",J="Microsoft.XMLDOM",I="Send native request",H="If-Range",G="Content-Type",r="io.xhr",s="Not enough arguments",p="timeout",q="If-Modified-Since",n="onunload",o="load",l=", url: ",m="browser.documentmode",t=", async: ",u="loadend",y="opera",x="gecko",A="file:",z="error",C="mshtml",B="undefined",w="qx.debug.io",F="",E="readystatechange",D="qx.bom.request.Xhr",v="engine.name";qx.Bootstrap.define(D,{construct:function(){this.__sS=qx.Bootstrap.bind(this.__ti,this);this.__sT=qx.Bootstrap.bind(this.__th,this);this.__sU=qx.Bootstrap.bind(this.__tm,this);this.__tg();this._emitter=new qx.event.Emitter();if(window.attachEvent){this.__sV=qx.Bootstrap.bind(this.__tp,this);window.attachEvent(n,this.__sV);}
;}
,statics:{UNSENT:0,OPENED:1,HEADERS_RECEIVED:2,LOADING:3,DONE:4},events:{"readystatechange":D,"error":D,"loadend":D,"timeout":D,"abort":D,"load":D},members:{readyState:0,responseText:F,responseXML:null,status:0,statusText:F,timeout:0,open:function(Q,R,S,T,U){this.__tr();if(typeof R===B){throw new Error(s);}
else if(typeof Q===B){Q=d;}
;this.__sW=false;this.__sX=false;this.__sY=false;this.__ta=R;if(typeof S==B){S=true;}
;this.__tb=S;if(!this.__tq()&&this.readyState>qx.bom.request.Xhr.UNSENT){this.dispose();this.__tg();}
;this.__td.onreadystatechange=this.__sS;try{if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,b+Q+l+R+t+S);}
;this.__td.open(Q,R,S,T,U);}
catch(V){if(!qx.util.Request.isCrossDomain(R)){throw V;}
;if(!this.__tb){this.__tc=V;}
;if(this.__tb){if(window.XDomainRequest){this.readyState=4;this.__td=new XDomainRequest();this.__td.onerror=qx.Bootstrap.bind(function(){this._emit(E);this._emit(z);this._emit(u);}
,this);if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,k+Q+l+R+t+S);}
;this.__td.open(Q,R,S,T,U);return;}
;window.setTimeout(qx.Bootstrap.bind(function(){if(this.__tf){return;}
;this.readyState=4;this._emit(E);this._emit(z);this._emit(u);}
,this));}
;}
;if(qx.core.Environment.get(v)===C&&qx.core.Environment.get(m)<9&&this.__td.readyState>0){this.__td.setRequestHeader(q,c);}
;if(qx.core.Environment.get(v)===x&&parseInt(qx.core.Environment.get(f),10)<2&&!this.__tb){this.readyState=qx.bom.request.Xhr.OPENED;this._emit(E);}
;}
,setRequestHeader:function(W,X){this.__tr();if(W==K||W==q||W==h||W==H){this.__sY=true;}
;this.__td.setRequestHeader(W,X);return this;}
,send:function(Y){this.__tr();if(!this.__tb&&this.__tc){throw this.__tc;}
;if(qx.core.Environment.get(v)===y&&this.timeout===0){this.timeout=10000;}
;if(this.timeout>0){this.__te=window.setTimeout(this.__sU,this.timeout);}
;Y=typeof Y==B?null:Y;try{if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,I);}
;this.__td.send(Y);}
catch(bb){if(!this.__tb){throw bb;}
;if(this._getProtocol()===A){this.readyState=2;this.__tj();var ba=this;window.setTimeout(function(){if(ba.__tf){return;}
;ba.readyState=3;ba.__tj();ba.readyState=4;ba.__tj();}
);}
;}
;if(qx.core.Environment.get(v)===x&&!this.__tb){this.__ti();}
;this.__sX=true;return this;}
,abort:function(){this.__tr();this.__sW=true;this.__td.abort();if(this.__td){this.readyState=this.__td.readyState;}
;return this;}
...
,getResponseHeader:function(be){this.__tr();return this.__td.getResponseHeader(be);}
,getAllResponseHeaders:function(){this.__tr();return this.__td.getAllResponseHeaders();}
,getRequest:function(){return this.__td;}
,dispose:function(){if(this.__tf){return false;}
;window.clearTimeout(this.__te);if(window.detachEvent){window.detachEvent(n,this.__sV);}
;try{this.__td.onreadystatechange;}
catch(bg){return;}
;var bf=function(){}
;this.__td.onreadystatechange=bf;this.__td.onload=bf;this.__td.onerror=bf;this.abort();this.__td=null;this.__tf=true;return true;}
...
,_getProtocol:function(){var bi=this.__ta;var bj=/^(\w+:)\/\//;if(bi!==null&&bi.match){var bk=bi.match(bj);if(bk&&bk[1]){return bk[1];}
;}
;return window.location.protocol;}
,__td:null,__tb:null,__sS:null,__sT:null,__sV:null,__sU:null,__sX:null,__ta:null,__sW:null,__dy:null,__tf:null,__te:null,__tc:null,__sY:null,__tg:function(){this.__td=this._createNativeXhr();this.__td.onreadystatechange=this.__sS;if(this.__td.onabort){this.__td.onabort=this.__sT;}
;this.__tf=this.__sX=this.__sW=false;}
,__th:function(){if(!this.__sW){this.abort();}
;}
,__ti:function(){var bl=this.__td,bm=true;if(qx.core.Environment.get(w)){qx.Bootstrap.debug(qx.bom.request.Xhr,a+bl.readyState);}
;if(this.readyState==bl.readyState){return;}
;this.readyState=bl.readyState;if(this.readyState===qx.bom.request.Xhr.DONE&&this.__sW&&!this.__sX){return;}
;if(!this.__tb&&(bl.readyState==2||bl.readyState==3)){return;}
...
;if(bm){this.__tn();this.__to();}
;}
;this.__tj();if(this.readyState==qx.bom.request.Xhr.DONE){if(bl){bl.onreadystatechange=function(){}
;}
;}
;}
,__tj:function(){var bo=this;if(this.readyState===qx.bom.request.Xhr.DONE){window.clearTimeout(this.__te);}
;if(qx.core.Environment.get(v)==C&&qx.core.Environment.get(m)<8){if(this.__tb&&!this.__sX&&this.readyState>=qx.bom.request.Xhr.LOADING){if(this.readyState==qx.bom.request.Xhr.LOADING){return;}
;if(this.readyState==qx.bom.request.Xhr.DONE){window.setTimeout(function(){if(bo.__tf){return;}
;bo.readyState=3;bo._emit(E);bo.readyState=4;bo._emit(E);bo.__tk();}
);return;}
;}
;}
;this._emit(E);if(this.readyState===qx.bom.request.Xhr.DONE){this.__tk();}
;}
,__tk:function(){if(this.__dy){this._emit(p);if(qx.core.Environment.get(v)===y){this._emit(z);}
;this.__dy=false;}
else {if(this.__sW){this._emit(P);}
else {if(this.__tl()){this._emit(z);}
else {this._emit(o);this._emitter.emit(o);}
;}
;}
;this._emit(u);}
,__tl:function(){var bp;if(this._getProtocol()===A){bp=!this.responseText;}
else {bp=!this.statusText;}
;return bp;}
,__tm:function(){var bq=this.__td;this.readyState=qx.bom.request.Xhr.DONE;this.__dy=true;bq.abort();this.responseText=F;this.responseXML=null;this.__tj();}
,__tn:function(){var br=this.readyState===qx.bom.request.Xhr.DONE;if(this._getProtocol()===A&&this.status===0&&br){if(!this.__tl()){this.status=200;}
;}
;if(this.status===1223){this.status=204;}
;if(qx.core.Environment.get(v)===y){if(br&&this.__sY&&!this.__sW&&this.status===0){this.status=304;}
;}
;}
,__to:function(){if(qx.core.Environment.get(v)==C&&(this.getResponseHeader(G)||F).match(/[^\/]+\/[^\+]+\+xml/)&&this.responseXML&&!this.responseXML.documentElement){var bs=new window.ActiveXObject(J);bs.async=false;bs.validateOnParse=false;bs.loadXML(this.responseText);this.responseXML=bs;}
;}
,__tp:function(){try{if(this){this.dispose();}
;}
catch(e){}
;}
,__tq:function(){var name=qx.core.Environment.get(v);var bt=qx.core.Environment.get(M);return !(name==C&&bt<9||name==x&&bt<3.5);}
,__tr:function(){if(this.__tf){throw new Error(N);}
;}
...
;var e={position:b,top:0,left:0};var f=this._generateBackgroundMarkup(e);return this.__BG=f;}
