...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Atom","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Atom-qx.theme.Modern.7b4c004399e3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="Icon Top",i="Icon Bottom",h="bottom",g="icon/32/actions/go-previous.png",f="Atom Without Label",e="icon/32/actions/go-next.png",d="icon/32/actions/go-up.png",c="Icon Left",b="demobrowser.demo.widget.Atom",a="icon",A="icon/32/actions/go-down.png",z="left",y="right",x="Atom Without Icon",w="Higher Atom",v="#EAE6FA",u="label",t="Icon Right",s="Wider Atom",r="icon/32/apps/utilities-notes.png",p="#FAF8E6",q="Atom With Long Label",n="top",o="#E6FAED",l="icon/32/apps/internet-feed-reader.png",m="#E6EDFA",k="main";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(B,{left:20,top:20});B.add(new qx.ui.basic.Atom(c,g).set({backgroundColor:o,decorator:k,iconPosition:z,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(j,d).set({backgroundColor:o,decorator:k,iconPosition:n,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(t,e).set({backgroundColor:o,decorator:k,iconPosition:y,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(i,A).set({backgroundColor:o,decorator:k,iconPosition:h,padding:5,allowGrowY:false}));B.add(new qx.ui.core.Spacer().set({width:40}));B.add(new qx.ui.basic.Atom(f,l).set({backgroundColor:p,decorator:k,show:a,padding:5,allowGrowY:false}));B.add(new qx.ui.basic.Atom(x,l).set({backgroundColor:p,decorator:k,show:u,padding:5,allowGrowY:false}));var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(D,{left:20,top:150});D.add(new qx.ui.basic.Atom(q).set({backgroundColor:m,decorator:k,padding:5,width:100,allowGrowY:false}));D.add(new qx.ui.basic.Atom(q,l).set({backgroundColor:m,decorator:k,padding:5,width:150,allowGrowY:false}));D.add(new qx.ui.basic.Atom(q,l).set({backgroundColor:v,decorator:k,iconPosition:n,padding:5,width:100,allowGrowY:false}));var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));this.getRoot().add(C,{left:20,top:250});C.add(new qx.ui.basic.Atom(s).set({backgroundColor:m,decorator:k,center:true,padding:5,width:100,allowGrowY:false}));C.add(new qx.ui.basic.Atom(s,r).set({backgroundColor:m,decorator:k,center:true,padding:5,width:140,allowGrowY:false}));C.add(new qx.ui.basic.Atom(w,r).set({backgroundColor:m,decorator:k,iconPosition:n,center:true,padding:5,height:100,allowGrowY:false}));}
}});}
)();
