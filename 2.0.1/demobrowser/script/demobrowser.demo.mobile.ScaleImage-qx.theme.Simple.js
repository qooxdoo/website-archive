...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Simple.0da944332e3a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(u);var D={"width":f,"height":w,"position":l,"left":o,"top":o,"background":i+G+n};this.__El=new qx.html.Element(m,D);this.__El.addListener(k,this.__Dy,this);this.__El.addListener(B,this.__Dx,this);F.add(this.__El);}
,__Dy:function(e){if(e.isMultiTouch()){this.__QD=e.getRotation()+this.__QC;this.__QE=e.getScale()*this.__QB;this.__El.setStyle(C,r+this.__QD+g+this.__QE+n);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__El.getStyle(A))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__El.getStyle(j))/2);this.__El.setStyles({"left":I+q,"top":top+q});}
;}
,__Dx:function(e){if(e.isMultiTouch()){this.__QC=this.__QD;this.__QB=this.__QE;}
;}
}});}
)();
