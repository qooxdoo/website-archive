...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.FormController","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormController-qx.theme.Classic.ed27c857d7bf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Cancel",l="Last Name",k="Company",j="Save",i="First Name",h="Email",g="You are saving: ",f="Date",e="firstName",d="lastName",a="demobrowser.demo.data.FormController",c="Simple Form",b="execute";qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.groupbox.GroupBox(c);r.setLayout(new qx.ui.layout.Canvas());this.getRoot().add(r,{left:10,top:10});var o=new qx.ui.form.Form();var n=new qx.ui.form.TextField();n.setRequired(true);n.setWidth(200);o.add(n,i,null,e);o.add(new qx.ui.form.TextField(),l,null,d);o.add(new qx.ui.form.TextField(),k);o.add(new qx.ui.form.TextField(),h);o.add(new qx.ui.form.DateField(),f);var s=new qx.ui.form.Button(j);s.setWidth(70);o.addButton(s);var p=new qx.ui.form.Button(m);p.setWidth(70);o.addButton(p);r.add(new qx.ui.form.renderer.Single(o));var q=new qx.data.controller.Form(null,o);var t=q.createModel();s.addListener(b,function(){if(o.validate()){alert(g+qx.util.Serializer.toJson(t));}
;}
,this);p.addListener(b,o.reset,o);}
}});}
)();
...
(function(){var o="changeModel",n="qx.core.Object",m="qx.debug",l="_applyTarget",k="qx.data.controller.Form",j="changeTarget",h=" of ",g="Could not bind property ",f=".",e="No target is set.",b="qx.ui.form.Form",d="_applyModel",c="modelSelection[0]",a="value";qx.Class.define(k,{extend:qx.core.Object,construct:function(p,q,r){qx.core.Object.call(this);this._selfUpdate=!!r;this.__Ln={};if(p!=null){this.setModel(p);}
;if(q!=null){this.setTarget(q);}
;}
,properties:{model:{check:n,apply:d,event:o,nullable:true,dereference:true},target:{check:b,apply:l,event:j,nullable:true,init:null,dereference:true}},members:{__Lo:null,__Ln:null,addBindingOptions:function(name,s,t){this.__Ln[name]=[s,t];if(this.getModel()==null||this.getTarget()==null){return;}
;var u=this.getTarget().getItems()[name];var v=this.__Lr(u)?c:a;this.__Lo.removeTarget(u,v,name);this.__Lo.addTarget(u,v,name,!this._selfUpdate,s,t);}
,createModel:function(w){var y=this.getTarget();if(y==null){throw new Error(e);}
;var z=y.getItems();var A={};for(var name in z){var B=name.split(f);var E=A;for(var i=0;i<B.length;i++){if(i+1==B.length){var D=z[name].constructor;var x=null;if(qx.Class.hasInterface(D,qx.ui.core.ISingleSelection)){x=z[name].getModelSelection().getItem(0)||null;}
else {x=z[name].getValue();}
;if(this.__Ln[name]&&this.__Ln[name][1]){x=this.__Ln[name][1].converter(x);}
;E[B[i]]=x;}
else {if(!E[B[i]]){E[B[i]]={};}
;E=E[B[i]];}
;}
;}
;var C=qx.data.marshal.Json.createModel(A,w);this.setModel(C);return C;}
,updateModel:function(){if(!this._selfUpdate||!this.getModel()||!this.getTarget()){return;}
;var F=this.getTarget().getItems();for(var name in F){var I=F[name];var H=this.__Lr(I)?c:a;var G=this.__Ln[name];G=G&&this.__Ln[name][1];qx.data.SingleValueBinding.updateTarget(I,H,this.getModel(),name,G);}
;}
,_applyTarget:function(J,K){if(K!=null){this.__Lq(K);}
;if(this.getModel()==null){return;}
;if(J!=null){this.__Lp();}
;}
,_applyModel:function(L,M){if(this.__Lo!=null){var N=this.getTarget().getItems();for(var name in N){var P=N[name];var O=this.__Lr(P)?c:a;this.__Lo.removeTarget(P,O,name);}
;}
;if(this.__Lo!=null){this.__Lo.setModel(L);}
;if(this.getTarget()==null){return;}
;if(L!=null){this.__Lp();}
;}
,__Lp:function(){if(this.__Lo==null){this.__Lo=new qx.data.controller.Object(this.getModel());}
;var Q=this.getTarget().getItems();for(var name in Q){var T=Q[name];var R=this.__Lr(T)?c:a;var S=this.__Ln[name];try{if(S==null){this.__Lo.addTarget(T,R,name,!this._selfUpdate);}
else {this.__Lo.addTarget(T,R,name,!this._selfUpdate,S[0],S[1]);}
;}
catch(U){if(qx.core.Environment.get(m)){this.warn(g+name+h+this.getModel());}
;}
;}
;this.getTarget().redefineResetter();}
,__Lq:function(V){if(this.__Lo==null){return;}
;var W=V.getItems();for(var name in W){var Y=W[name];var X=this.__Lr(Y)?c:a;this.__Lo.removeTarget(Y,X,name);}
;}
,__Lr:function(ba){return qx.Class.hasInterface(ba.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(ba.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__Lo){this.__Lo.dispose();}
;}
});}
)();
