...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Dock_PercentSize-qx.theme.Indigo.33d6d70b9d8f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var p="x",o="y",n="demobrowser.demo.layout.Dock_PercentSize",m="east",l="yellow",k="center",j="red",i="north",h="south",g="west",c="green",f="fuchsia",e="orange",b="blue",a="50%",d="main";qx.Class.define(n,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(r);var q=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:d,backgroundColor:l,width:450,height:250,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:j});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:c});var t=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f});q.add(x,{edge:i});q.add(w,{edge:g,width:a});q.add(v,{edge:h,height:a});q.add(u,{edge:m});q.add(t,{edge:k});r.add(q);var s=new qx.ui.layout.Dock();s.setSort(o);var q=(new qx.ui.container.Composite(s)).set({decorator:d,backgroundColor:l,width:450,height:250,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:j});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:c});var t=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f});q.add(x,{edge:i});q.add(w,{edge:g,width:a});q.add(v,{edge:h,height:a});q.add(u,{edge:m});q.add(t,{edge:k});r.add(q);var s=new qx.ui.layout.Dock();s.setSort(p);var q=(new qx.ui.container.Composite(s)).set({decorator:d,backgroundColor:l,width:450,height:250,allowGrowX:false});var x=new qx.ui.core.Widget().set({decorator:d,backgroundColor:j});var w=new qx.ui.core.Widget().set({decorator:d,backgroundColor:b});var v=new qx.ui.core.Widget().set({decorator:d,backgroundColor:e});var u=new qx.ui.core.Widget().set({decorator:d,backgroundColor:c});var t=new qx.ui.core.Widget().set({decorator:d,backgroundColor:f});q.add(x,{edge:i});q.add(w,{edge:g,width:a});q.add(v,{edge:h,height:a});q.add(u,{edge:m});q.add(t,{edge:k});r.add(q);}
}});}
)();
