...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.RadioButton","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.RadioButton-qx.theme.Classic.28e9b88cc9ad.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var i="Yellow",h="Red",g="demobrowser.demo.widget.RadioButton",f="Green",d="Your favorite color is: ",c="changeSelection",b="Blue",a="What is your favorite color?";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var o=new qx.ui.basic.Label(a);var l=new qx.ui.layout.VBox();l.setSpacing(10);var j=new qx.ui.container.Composite(l);j.setPadding(20);this.getRoot().add(j,{left:0,top:0});j.add(o);var n=new qx.ui.form.RadioButton(h);var m=new qx.ui.form.RadioButton(f);var q=new qx.ui.form.RadioButton(i);var k=new qx.ui.form.RadioButton(b);j.add(n);j.add(m);j.add(q);j.add(k);var p=new qx.ui.form.RadioGroup(n,m,q,k);p.addListener(c,this._onChangeSelection,this);}
,_onChangeSelection:function(e){var s=e.getData()[0];var r=s.getLabel();alert(d+r);}
}});}
)();
