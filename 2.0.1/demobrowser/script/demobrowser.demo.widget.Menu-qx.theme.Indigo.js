...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu-qx.theme.Indigo.97e51e43021d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var cn="Online Forum",cm="icon/16/actions/format-justify-fill.png",cl="Search in files",ck="C",cj="Left aligned",ci="Perl",ch="View",cg="C Dialect",cf="Info...",ce="Save as...",bu="Show line numbers",bt="Quickstart",bs="icon/16/actions/contact-new.png",br="Ctrl+N",bq="Actions",bp="Show console",bo="Search",bn="Help",bm="__RG",bl="Show status bar",cu="icon/16/actions/format-justify-left.png",cv="ANSI to OEM",cs="Centered",ct="Website 3",cq="Edit",cr="icon/16/actions/format-justify-center.png",co="Ctrl+O",cp="icon/16/actions/go-previous.png",cw="C Sharp",cx="Close",bS="Split Button",bR="Website 2",bU="icon/16/actions/document-save-as.png",bT="Python",bW="icon/16/apps/utilities-help.png",bV="Show tree",bY="Options",bX="Spaces to tabs",bQ="Right aligned",bP="Action 1",a="OEM to ANSI",b="Line 431",c="__RF",d="JavaScript",f="__RJ",g="icon",h="Action 2",j="Folder ",k="XML",l="Line 313",cB="Paragraph",cA="demobrowser.demo.widget.Menu",cz="icon/16/actions/application-exit.png",cy="C Plus Plus",cF="__wG",cE="Line 26",cD="Item ",cC="ASCII table",cH="Option 1",cG="Search next...",K="Line 12",L="Action 3",I="Replace in files",J="Uppercase",O="Ctrl+P",P="Topics",M="Panes",N="Justified",G="Ctrl+X",H="__RH",t="Search previous...",s="Change selection: ",v="__RI",u="Back",p="main",o=" = ",r="Execute command: ",q="Show ruler",n="__RE",m="__wz",U="icon/16/actions/format-justify-right.png",V="icon/16/actions/go-next.png",W="Ctrl+Z",X="command ",Q="Option 3",R="Next",S="Ctrl+R",T="Show macros",Y="Show tags",ba="Capitals",D="Execute button: ",C="Format",B="File",A="Change checked: ",z="Show tabs",y="Tabs to spaces",x="Search...",w="Line 1039",F="Option 2",E="Objective C",bb="Exit",bc="move to",bd="Ctrl+S",be="Syntax",bf="Ctrl+C",bg="Website 1",bh="Menu Button",bi="Line 30",bj="Lowercase",bk="Replace",by="HTML",bx="New",bw="Undo",bv="icon/16/actions/document-save.png",bC="Redo",bB="icon/22/apps/preferences-users.png",bA="icon/16/actions/document-print.png",bz="icon/16/actions/document-open.png",bE="icon/16/actions/edit-undo.png",bD="Save",bL="icon/16/actions/edit-redo.png",bM="Print",bJ="Open",bK="icon/16/actions/document-new.png",bH="icon/16/actions/edit-cut.png",bI="changeSelection",bF="icon/16/actions/edit-paste.png",bG="Copy",bN="Paste",bO="icon/16/actions/edit-copy.png",cb="Cut",ca="icon/16/actions/system-search.png",cd="changeValue",cc="execute";qx.Class.define(cA,{extend:qx.application.Standalone,members:{__RE:null,__RF:null,__RG:null,__wz:null,__wG:null,__RH:null,__RI:null,__RJ:null,main:function(){qx.application.Standalone.prototype.main.call(this);var cJ=new qx.ui.container.Scroll();var cI=new qx.ui.container.Composite(new qx.ui.layout.Canvas);cI.setPadding(20);cI.setAllowStretchX(false);cJ.add(cI);this.getRoot().add(cJ,{edge:0});this.createCommands();cI.add(this.getMenuButton(),{left:20,top:20});cI.add(this.getSplitButton(),{left:150,top:20});cI.add(this.getMenuBar(),{left:20,top:100});cI.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
,getRootContextMenu:function(){var cK=new qx.ui.menu.Menu();var cL=new qx.ui.menu.Menu();for(var i=0;i<30;i++){cL.add(new qx.ui.menu.Button(j+(i+1)));}
;cK.add(new qx.ui.menu.Button(bc,null,null,cL));cK.add(new qx.ui.menu.Separator());for(var i=0;i<7;i++){cK.add(new qx.ui.menu.Button(X+(i+1)));}
;return cK;}
,debugRadio:function(e){this.debug(s+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(r+this.getShortcut());}
,debugButton:function(e){this.debug(D+this.getLabel());}
,debugCheckBox:function(e){this.debug(A+this.getLabel()+o+e.getData());}
,createCommands:function(){this.__RE=new qx.ui.core.Command(br);this.__RE.addListener(cc,this.debugCommand);this.__RF=new qx.ui.core.Command(co);this.__RF.addListener(cc,this.debugCommand);this.__RG=new qx.ui.core.Command(bd);this.__RG.addListener(cc,this.debugCommand);this.__wz=new qx.ui.core.Command(W);this.__wz.addListener(cc,this.debugCommand);this.__wG=new qx.ui.core.Command(S);this.__wG.addListener(cc,this.debugCommand);this.__RH=new qx.ui.core.Command(G);this.__RH.addListener(cc,this.debugCommand);this.__RI=new qx.ui.core.Command(bf);this.__RI.addListener(cc,this.debugCommand);this.__RJ=new qx.ui.core.Command(O);this.__RJ.addListener(cc,this.debugCommand);this.__RJ.setEnabled(false);}
,getMenuButton:function(){var cM=new qx.ui.menu.Menu;cM.add(new qx.ui.menu.RadioButton(cH));cM.add(new qx.ui.menu.RadioButton(F));cM.add(new qx.ui.menu.RadioButton(Q));var cU=new qx.ui.menu.Menu;cU.add(new qx.ui.menu.RadioButton(bP));cU.add(new qx.ui.menu.RadioButton(h));cU.add(new qx.ui.menu.RadioButton(L));var cT=new qx.ui.form.RadioGroup;cT.add.apply(cT,cM.getChildren());cT.addListener(bI,this.debugRadio);var cR=new qx.ui.form.RadioGroup;cR.add.apply(cR,cU.getChildren());cR.addListener(bI,this.debugRadio);var cP=new qx.ui.menu.Menu();var cS=new qx.ui.menu.Button(bw,bE,this.__wz);var da=new qx.ui.menu.Button(bC,bL,this.__wG);var cO=new qx.ui.menu.Button(cb,bH,this.__RH);var cW=new qx.ui.menu.Button(bG,bO,this.__RI);var cQ=new qx.ui.menu.Button(bN,bF,this.__RJ);var cN=new qx.ui.menu.Button(bY,ca,null,cM);var cX=new qx.ui.menu.Button(bq,bs,null,cU);var cV=new qx.ui.menu.Button(bM,bA);cS.addListener(cc,this.debugButton);da.addListener(cc,this.debugButton);cO.addListener(cc,this.debugButton);cW.addListener(cc,this.debugButton);cQ.addListener(cc,this.debugButton);cN.addListener(cc,this.debugButton);cX.addListener(cc,this.debugButton);cV.addListener(cc,this.debugButton);cP.add(cS);cP.add(da);cP.addSeparator();cP.add(cO);cP.add(cW);cP.add(cQ);cP.addSeparator();cP.add(cN);cP.add(cX);cP.addSeparator();cP.add(cV);var cY=new qx.ui.form.MenuButton(bh,bB,cP);return cY;}
,getSplitButton:function(){var db=new qx.ui.menu.Menu;var df=new qx.ui.menu.Button(bg);var dd=new qx.ui.menu.Button(bR);var de=new qx.ui.menu.Button(ct);db.setMinWidth(120);df.addListener(cc,this.debugButton);dd.addListener(cc,this.debugButton);de.addListener(cc,this.debugButton);db.add(df);db.add(dd);db.add(de);var dc=new qx.ui.form.SplitButton(bS,bB,db);dc.addListener(cc,this.debugButton);return dc;}
,getMenuBar:function(){var dk=new qx.ui.container.Composite(new qx.ui.layout.Grow);dk.setDecorator(p);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);dk.add(toolbar);var du=new qx.ui.toolbar.Part;var dj=new qx.ui.toolbar.Part;var dn=new qx.ui.toolbar.Part;toolbar.add(du);toolbar.add(dj);toolbar.addSpacer();toolbar.add(dn);var dt=new qx.ui.toolbar.SplitButton(u,cp,this.getBackMenu());var dq=new qx.ui.toolbar.SplitButton(R,V,this.getForwardMenu());var di=new qx.ui.toolbar.Button(bx,bK,this.__RE);var dm=new qx.ui.toolbar.Button(bJ,bz,this.__RF);var ds=new qx.ui.toolbar.Button(bD,bv,this.__RG);dt.addListener(cc,this.debugButton);dq.addListener(cc,this.debugButton);di.addListener(cc,this.debugButton);dm.addListener(cc,this.debugButton);ds.addListener(cc,this.debugButton);du.add(dt);du.add(dq);du.addSeparator();du.add(di);du.add(dm);du.add(ds);du.setShow(g);var dl=new qx.ui.toolbar.MenuButton(B);var dh=new qx.ui.toolbar.MenuButton(cq);var dg=new qx.ui.toolbar.MenuButton(bo);var dv=new qx.ui.toolbar.MenuButton(ch);var dr=new qx.ui.toolbar.MenuButton(C);dl.setMenu(this.getFileMenu());dh.setMenu(this.getEditMenu());dg.setMenu(this.getSearchMenu());dv.setMenu(this.getViewMenu());dr.setMenu(this.getFormatMenu());dj.add(dl);dj.add(dh);dj.add(dg);dj.add(dv);dj.add(dr);var dp=new qx.ui.toolbar.MenuButton(bn);dp.setMenu(this.getHelpMenu());dn.add(dp);return dk;}
,getBackMenu:function(){var dx=new qx.ui.menu.Menu;var dy=new qx.ui.menu.Button(l);var dA=new qx.ui.menu.Button(w);var dw=new qx.ui.menu.Button(K);var dz=new qx.ui.menu.Button(cE);dy.addListener(cc,this.debugButton);dA.addListener(cc,this.debugButton);dw.addListener(cc,this.debugButton);dz.addListener(cc,this.debugButton);dx.add(dy);dx.add(dA);dx.add(dw);dx.add(dz);return dx;}
,getForwardMenu:function(){var dB=new qx.ui.menu.Menu;var dC=new qx.ui.menu.Button(b);var dD=new qx.ui.menu.Button(bi);dC.addListener(cc,this.debugButton);dD.addListener(cc,this.debugButton);dB.add(dC);dB.add(dD);return dB;}
,getFileMenu:function(){var dG=new qx.ui.menu.Menu;var dE=new qx.ui.menu.Button(bx,bK,this.__RE);var dI=new qx.ui.menu.Button(bJ,bz,this.__RF);var dH=new qx.ui.menu.Button(cx);var dL=new qx.ui.menu.Button(bD,bv,this.__RG);var dK=new qx.ui.menu.Button(ce,bU);var dJ=new qx.ui.menu.Button(bM,bA);var dF=new qx.ui.menu.Button(bb,cz);dE.addListener(cc,this.debugButton);dI.addListener(cc,this.debugButton);dH.addListener(cc,this.debugButton);dL.addListener(cc,this.debugButton);dK.addListener(cc,this.debugButton);dJ.addListener(cc,this.debugButton);dF.addListener(cc,this.debugButton);dG.add(dE);dG.add(dI);dG.add(dH);dG.add(dL);dG.add(dK);dG.add(dJ);dG.add(dF);return dG;}
,getEditMenu:function(){var dN=new qx.ui.menu.Menu;var dQ=new qx.ui.menu.Button(bw,bE,this.__wz);var dP=new qx.ui.menu.Button(bC,bL,this.__wG);var dM=new qx.ui.menu.Button(cb,bH,this.__RH);var dR=new qx.ui.menu.Button(bG,bO,this.__RI);var dO=new qx.ui.menu.Button(bN,bF,this.__RJ);dQ.addListener(cc,this.debugButton);dP.addListener(cc,this.debugButton);dM.addListener(cc,this.debugButton);dR.addListener(cc,this.debugButton);dO.addListener(cc,this.debugButton);dN.add(dQ);dN.add(dP);dN.addSeparator();dN.add(dM);dN.add(dR);dN.add(dO);return dN;}
,getSearchMenu:function(){var dV=new qx.ui.menu.Menu;var dT=new qx.ui.menu.Button(x,ca);var dY=new qx.ui.menu.Button(cG);var dU=new qx.ui.menu.Button(t);var dX=new qx.ui.menu.Button(bk);var dS=new qx.ui.menu.Button(cl,ca);var dW=new qx.ui.menu.Button(I);dU.setEnabled(false);dT.addListener(cc,this.debugButton);dY.addListener(cc,this.debugButton);dU.addListener(cc,this.debugButton);dX.addListener(cc,this.debugButton);dS.addListener(cc,this.debugButton);dW.addListener(cc,this.debugButton);dV.add(dT);dV.add(dY);dV.add(dU);dV.add(dX);dV.addSeparator();dV.add(dS);dV.add(dW);return dV;}
,getViewMenu:function(){var ea=new qx.ui.menu.Menu;var ec=new qx.ui.menu.Button(M,null,null,this.getPanesMenu());var ef=new qx.ui.menu.Button(be,null,null,this.getSyntaxMenu());var ee=new qx.ui.menu.CheckBox(q);var ed=new qx.ui.menu.CheckBox(bu);var eb=new qx.ui.menu.Button(cC);ee.addListener(cd,this.debugCheckBox);ed.addListener(cd,this.debugCheckBox);eb.addListener(cc,this.debugButton);ea.add(ec);ea.add(ef);ea.addSeparator();ea.add(ee);ea.add(ed);ea.addSeparator();ea.add(eb);return ea;}
,getPanesMenu:function(){var eh=new qx.ui.menu.Menu;var ej=new qx.ui.menu.CheckBox(z);var el=new qx.ui.menu.CheckBox(bl);var em=new qx.ui.menu.CheckBox(bV);var ei=new qx.ui.menu.CheckBox(T);var ek=new qx.ui.menu.CheckBox(Y);var eg=new qx.ui.menu.CheckBox(bp);ej.setValue(true);el.setValue(true);ei.setValue(true);ej.addListener(cd,this.debugCheckBox);el.addListener(cd,this.debugCheckBox);em.addListener(cd,this.debugCheckBox);ei.addListener(cd,this.debugCheckBox);ek.addListener(cd,this.debugCheckBox);eg.addListener(cd,this.debugCheckBox);eh.add(el);eh.add(ej);eh.addSeparator();eh.add(em);eh.add(ei);eh.add(ek);eh.add(eg);return eh;}
,getSyntaxMenu:function(){var er=new qx.ui.menu.Menu;var en=new qx.ui.menu.RadioButton(by);var ep=new qx.ui.menu.RadioButton(k);var eo=new qx.ui.menu.RadioButton(d);var eq=new qx.ui.menu.Button(cg,null,null,this.getSyntaxCMenu());var eu=new qx.ui.menu.RadioButton(ci);var es=new qx.ui.menu.RadioButton(bT);er.add(en);er.add(ep);er.add(eo);er.add(eq);er.add(eu);er.add(es);var et=new qx.ui.form.RadioGroup;et.add(en,ep,eo,eu,es);et.add.apply(et,eq.getMenu().getChildren());et.addListener(bI,this.debugRadio);return er;}
,getSyntaxCMenu:function(){var ew=new qx.ui.menu.Menu;var ev=new qx.ui.menu.RadioButton(ck);var ez=new qx.ui.menu.RadioButton(cw);var ey=new qx.ui.menu.RadioButton(E);var ex=new qx.ui.menu.RadioButton(cy);ew.add(ev);ew.add(ez);ew.add(ey);ew.add(ex);return ew;}
,getFormatMenu:function(){var eD=new qx.ui.menu.Menu;var eC=new qx.ui.menu.Button(cB,null,null,this.getParagraphMenu());var eF=new qx.ui.menu.Button(y);var eG=new qx.ui.menu.Button(bX);var eB=new qx.ui.menu.Button(J);var eE=new qx.ui.menu.Button(bj);var eA=new qx.ui.menu.Button(ba);var eI=new qx.ui.menu.Button(a);var eH=new qx.ui.menu.Button(cv);eF.addListener(cc,this.debugButton);eG.addListener(cc,this.debugButton);eB.addListener(cc,this.debugButton);eE.addListener(cc,this.debugButton);eA.addListener(cc,this.debugButton);eI.addListener(cc,this.debugButton);eH.addListener(cc,this.debugButton);eD.add(eC);eD.add(eF);eD.add(eG);eD.addSeparator();eD.add(eB);eD.add(eE);eD.add(eA);eD.addSeparator();eD.add(eI);eD.add(eH);return eD;}
,getParagraphMenu:function(){var eJ=new qx.ui.menu.Menu;var eM=new qx.ui.menu.Button(cj,cu);var eN=new qx.ui.menu.Button(bQ,U);var eK=new qx.ui.menu.Button(cs,cr);var eL=new qx.ui.menu.Button(N,cm);eM.addListener(cc,this.debugButton);eN.addListener(cc,this.debugButton);eK.addListener(cc,this.debugButton);eL.addListener(cc,this.debugButton);eJ.add(eM);eJ.add(eN);eJ.add(eK);eJ.add(eL);return eJ;}
,getHelpMenu:function(){var eO=new qx.ui.menu.Menu;var eQ=new qx.ui.menu.Button(P,bW);var eS=new qx.ui.menu.Button(bt);var eR=new qx.ui.menu.Button(cn);var eP=new qx.ui.menu.Button(cf);eQ.addListener(cc,this.debugButton);eS.addListener(cc,this.debugButton);eR.addListener(cc,this.debugButton);eP.addListener(cc,this.debugButton);eO.add(eQ);eO.add(eS);eO.addSeparator();eO.add(eR);eO.addSeparator();eO.add(eP);return eO;}
...
;return eT;}
,getContextMenu:function(){var eU=new qx.ui.menu.Menu;var eW=new qx.ui.menu.Button(cb,bH,this.__RH);var eX=new qx.ui.menu.Button(bG,bO,this.__RI);var eV=new qx.ui.menu.Button(bN,bF,this.__RJ);eW.addListener(cc,this.debugButton);eX.addListener(cc,this.debugButton);eV.addListener(cc,this.debugButton);eU.add(eW);eU.add(eX);eU.add(eV);return eU;}
},destruct:function(){this._disposeObjects(n,c,bm,m,cF,H,v,f);}
});}
)();
...
(function(){var m="-",l="PageUp",k="Escape",j="qx.event.type.Data",h="_applyShortcut",g="PrintScreen",f="NumLock",d="5",c="8",b="execute",S="Meta",R="0",Q="2",P="Shift",O="You can only specify one non modifier key!",N="3",M="/",L="Delete",K="String",J="changeEnabled",t="*",u="qx.bom.Shortcut",r="6",s="4",p="1",q="Alt",n="Not a valid key name for a shortcut: ",o="PageDown",v="Whitespaces are not allowed within shortcuts",w="_applyEnabled",B="7",A="a",D="z",C="9",F="Boolean",E="+",y="short",I="keydown",H="",G="Control",x="keypress",z="Unidentified";qx.Class.define(u,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__zn={};this.__zo=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":j},properties:{enabled:{init:true,check:F,event:J,apply:w},shortcut:{check:K,apply:h,nullable:true},autoRepeat:{check:F,init:false}},members:{__zn:H,__zo:H,execute:function(U){this.fireDataEvent(b,U);}
,__zp:function(event){if(this.getEnabled()&&this.__zq(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__eJ:function(event){if(this.getEnabled()&&this.__zq(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(V,W){if(V){qx.event.Registration.addListener(document.documentElement,I,this.__zp,this);qx.event.Registration.addListener(document.documentElement,x,this.__eJ,this);}
else {qx.event.Registration.removeListener(document.documentElement,I,this.__zp,this);qx.event.Registration.removeListener(document.documentElement,x,this.__eJ,this);}
;}
,_applyShortcut:function(X,Y){if(X){if(X.search(/[\s]+/)!=-1){var bc=v;this.error(bc);throw new Error(bc);}
;this.__zn={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__zo=null;var ba;var a=[];while(X.length>0&&ba!=-1){ba=X.search(/[-+]+/);a.push((X.length==1||ba==-1)?X:X.substring(0,ba));X=X.substring(ba+1);}
;var bb=a.length;for(var i=0;i<bb;i++){var bd=this.__zs(a[i]);switch(bd){case G:case P:case S:case q:this.__zn[bd]=true;break;case z:var bc=n+a[i];this.error(bc);throw bc;default:if(this.__zo){var bc=O;this.error(bc);throw bc;}
;this.__zo=bd;};}
;}
;return true;}
,__zq:function(e){var be=this.__zo;if(!be){return;}
...
;return false;}
,__zr:{esc:k,ctrl:G,print:g,del:L,pageup:l,pagedown:o,numlock:f,numpad_0:R,numpad_1:p,numpad_2:Q,numpad_3:N,numpad_4:s,numpad_5:d,numpad_6:r,numpad_7:B,numpad_8:c,numpad_9:C,numpad_divide:M,numpad_multiply:t,numpad_minus:m,numpad_plus:E},__zs:function(bf){var bg=qx.event.util.Keyboard;var bh=z;if(bg.isValidKeyIdentifier(bf)){return bf;}
;if(bf.length==1&&bf>=A&&bf<=D){return bf.toUpperCase();}
;bf=bf.toLowerCase();var bh=this.__zr[bf]||qx.lang.String.firstUp(bf);if(bg.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bk=this.__zo;var bj=[];for(var bi in this.__zn){if(this.__zn[bi]){bj.push(qx.locale.Key.getKeyName(y,bi));}
;}
;if(bk){bj.push(qx.locale.Key.getKeyName(y,bk));}
;return bj.join(E);}
},destruct:function(){this.setEnabled(false);this.__zn=this.__zo=null;}
});}
)();
