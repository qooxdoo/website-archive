...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Overflow","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Overflow-qx.theme.Indigo.246abcb8a76d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="9h: ",i="#3",h="9j: ",g="#1",f="9p: ",e="9k: ",d="3: ",c="1: ",b="9o: ",a="9a: ",S="9m: ",R="9n: ",Q="9c: ",P="#2",O="9i: ",N="#4",M="#0",L="9d: ",K="9e: ",J="9f: ",q="9g: ",r="2: ",o="9l: ",p="demobrowser.demo.bom.Overflow",m="9b: ",n="test9l",k="test3",l="test1",s="test9b",t="test9j",A="test9o",y="test9n",D="test9h",C="test9f",F="test9d",E="test2",v="test9m",I="test9p",H="test9c",G="test9k",u="test9i",w="test9a",x="test9e",z="test9g",B=", ";qx.Class.define(p,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var T=qx.bom.element.Overflow;this.info(M);this.debug(c+T.getX(document.getElementById(l))+B+T.getY(document.getElementById(l)));this.debug(r+T.getX(document.getElementById(E))+B+T.getY(document.getElementById(E)));this.debug(d+T.getX(document.getElementById(k))+B+T.getY(document.getElementById(k)));this.info(g);this.debug(a+T.getX(document.getElementById(w))+B+T.getY(document.getElementById(w)));this.debug(m+T.getX(document.getElementById(s))+B+T.getY(document.getElementById(s)));this.debug(Q+T.getX(document.getElementById(H))+B+T.getY(document.getElementById(H)));this.debug(L+T.getX(document.getElementById(F))+B+T.getY(document.getElementById(F)));this.info(P);this.debug(K+T.getX(document.getElementById(x))+B+T.getY(document.getElementById(x)));this.debug(J+T.getX(document.getElementById(C))+B+T.getY(document.getElementById(C)));this.debug(q+T.getX(document.getElementById(z))+B+T.getY(document.getElementById(z)));this.debug(j+T.getX(document.getElementById(D))+B+T.getY(document.getElementById(D)));this.info(i);this.debug(O+T.getX(document.getElementById(u))+B+T.getY(document.getElementById(u)));this.debug(h+T.getX(document.getElementById(t))+B+T.getY(document.getElementById(t)));this.debug(e+T.getX(document.getElementById(G))+B+T.getY(document.getElementById(G)));this.debug(o+T.getX(document.getElementById(n))+B+T.getY(document.getElementById(n)));this.info(N);this.debug(S+T.getX(document.getElementById(v))+B+T.getY(document.getElementById(v)));this.debug(R+T.getX(document.getElementById(y))+B+T.getY(document.getElementById(y)));this.debug(b+T.getX(document.getElementById(A))+B+T.getY(document.getElementById(A)));this.debug(f+T.getX(document.getElementById(I))+B+T.getY(document.getElementById(I)));}
}});}
)();
