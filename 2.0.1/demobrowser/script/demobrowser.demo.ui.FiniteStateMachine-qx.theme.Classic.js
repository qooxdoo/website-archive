...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FiniteStateMachine-qx.theme.Classic.66e798909621.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_getInternalData:function(){return ({"states":this.__hy,"startState":this.__LK,"eventQueue":this.__LM,"blockedEvents":this.__LN,"savedStates":this.__LL,"friendlyToObject":this.__LO,"friendlyToHash":this.__LP,"hashToFriendly":this.__LQ,"groupToFriendly":this.__LR,"friendlyToGroups":this.__LS});}
...
;return true;}
},destruct:function(){this._disposeArray(c);this._disposeArray(l);this.__LL=this.__hy=null;}
});}
)();
