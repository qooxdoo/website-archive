...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.ManualLayout","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.ManualLayout-qx.theme.Simple.e460b6e553e7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="black",f="red",e="green",d="demobrowser.demo.layout.ManualLayout",c="yellow",b="solid",a="blue";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=g;var n=new qx.ui.decoration.Single(3,b,h);var m=new qx.ui.core.Widget().set({backgroundColor:f,decorator:n,paddingLeft:10,paddingRight:10});m.setUserBounds(10,10,100,30);var l=new qx.ui.core.Widget().set({backgroundColor:a,decorator:n});l.setUserBounds(200,20,150,100);var k=new qx.ui.core.Widget().set({backgroundColor:e,decorator:n,padding:3});k.setUserBounds(380,50,150,100);var j=new qx.ui.core.Widget().set({backgroundColor:c,decorator:n,padding:10});j.setUserBounds(50,200,150,100);var i=new qx.ui.container.Composite();i.add(m);i.add(l);i.add(k);i.add(j);this.getRoot().add(i,{edge:0});}
}});}
)();
