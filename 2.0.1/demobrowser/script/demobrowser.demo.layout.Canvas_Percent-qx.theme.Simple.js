...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Canvas_Percent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Canvas_Percent-qx.theme.Simple.0a94bacde26f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="black",m="teal",l="red",k="demobrowser.demo.layout.Canvas_Percent",j="green",i="yellow",h="orange",g="solid",f="blue",e="12%",b="6%",d="3%",c="9%",a="20%";qx.Class.define(k,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var v=new qx.ui.decoration.Single(3,g,n);var u=new qx.ui.core.Widget().set({backgroundColor:l,decorator:v});var t=new qx.ui.core.Widget().set({backgroundColor:f,decorator:v});var s=new qx.ui.core.Widget().set({backgroundColor:j,decorator:v});var r=new qx.ui.core.Widget().set({backgroundColor:i,decorator:v});var q=new qx.ui.core.Widget().set({backgroundColor:h,decorator:v});var p=new qx.ui.core.Widget().set({backgroundColor:m,decorator:v});var o=new qx.ui.container.Composite(new qx.ui.layout.Canvas());o.add(u,{left:d,top:d,right:d,bottom:d,width:a,height:a});o.add(t,{left:b,top:b,right:b,width:a,height:a});o.add(s,{left:c,top:c,bottom:c,width:a,height:a});o.add(r,{left:e,top:e,width:a,height:a});o.add(q,{top:c,right:c,width:a,height:a});o.add(p,{right:c,bottom:c,width:a,height:a});this.getRoot().add(o,{edge:0});}
}});}
)();
