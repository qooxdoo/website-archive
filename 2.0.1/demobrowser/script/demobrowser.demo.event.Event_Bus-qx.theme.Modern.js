...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bus-qx.theme.Modern.fed538bcb500.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},construct:function(){this.__Ee={};}
,members:{__Ee:null,getSubscriptions:function(){return this.__Ee;}
...
;}
;return false;}
,dispatch:function(G){var J=this.getSubscriptions();var H=G.getName();var I=false;for(var K in J){var L=K.indexOf(d);if(L>-1){if(L===0||K.substr(0,L)===H.substr(0,L)){this.__Ef(J[K],G);I=true;}
;}
else {if(K===H){this.__Ef(J[H],G);I=true;}
;}
;}
;return I;}
,dispatchByName:function(name,M){var N=new qx.event.message.Message(name,M);return this.dispatch(N);}
,__Ef:function(O,P){for(var i=0;i<O.length;i++){var Q=O[i].subscriber;var R=O[i].context;if(R&&R.isDisposed){if(R.isDisposed()){O.splice(i,1);i--;}
else {Q.call(R,P);}
;}
else {Q.call(R,P);}
;}
