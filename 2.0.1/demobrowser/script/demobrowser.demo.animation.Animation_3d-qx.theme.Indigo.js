...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Animation_3d","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_3d-qx.theme.Indigo.1617f61c6a68.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="360deg",s="infinite",r="css.transform.3d",q="demobrowser.demo.animation.Animation_3d",p="",o="flat",n="container",m="45deg",l="parent",k="0deg",d="mouseover",j="50px",g="mouseout",c="center top",b="css.animation",f="-100px",e='label',h="20deg",a="CSS animations not supported, sorry!",i="preserve-3d";qx.Class.define(q,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(b)==null||!qx.core.Environment.get(r)){document.body.innerHTML=p;var w=document.createElement(e);w.innerHTML=a;document.body.appendChild(w);return;}
;var v={duration:10000,repeat:s,keyFrames:{'0':{rotate:[null,k]},'100':{rotate:[null,t]}}};var parent=document.getElementById(l);qx.bom.element.Animation.animate(parent,v);qx.bom.element.Transform.setStyle(parent,i);qx.bom.element.Transform.transform(parent.children[0],{translate:[null,null,f],rotate:[null,m]});qx.bom.element.Transform.transform(parent.children[1],{translate:[null,null,j],rotate:[h]});qx.bom.element.Transform.setOrigin(parent.children[1],c);var u=document.getElementById(n);qx.bom.element.Transform.setPerspective(u,500);qx.bom.Event.addNativeListener(u,d,function(){qx.bom.element.Transform.setStyle(parent,o);}
);qx.bom.Event.addNativeListener(u,g,function(){qx.bom.element.Transform.setStyle(parent,i);}
);}
}});}
)();
