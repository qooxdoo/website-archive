...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Indigo.2b1e2a8a531d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__yP:function(e){var co=window.prompt(bl,x);this.insertHtml(co);}
,__yQ:function(){var cq=new qx.ui.form.SelectBox;cq.set({toolTipText:m,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});cq.add(new qx.ui.form.ListItem(x));var cr=[X,O,r,U,f,J,M,bz,g,ba,R];var cp;for(var i=0,j=cr.length;i<j;i++){cp=new qx.ui.form.ListItem(cr[i]);cp.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(bU+cr[i])});cq.add(cp);}
;cq.addListener(C,function(e){var cs=e.getData()[0].getLabel();if(cs!=x){this.setFontFamily(cs);cq.setSelection([cq.getChildren()[0]]);}
;}
,this.__yJ);return cq;}
,__yR:function(){var cu=new qx.ui.form.SelectBox;cu.set({toolTipText:bx,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});cu.add(new qx.ui.form.ListItem(x));var ct;for(var i=1;i<=7;i++){ct=new qx.ui.form.ListItem(i+x);ct.set({focusable:false,keepFocus:true});cu.add(ct);}
;cu.addListener(C,function(e){var cv=e.getData()[0].getLabel();if(cv!=x){this.setFontSize(cv);cu.setSelection([cu.getChildren()[0]]);}
;}
,this.__yJ);return cu;}
,__yS:function(){return [{bold:{text:l,image:D,action:this.__yJ.setBold},italic:{text:bh,image:T,action:this.__yJ.setItalic},underline:{text:V,image:bg,action:this.__yJ.setUnderline},strikethrough:{text:Q,image:bO,action:this.__yJ.setStrikeThrough},removeFormat:{text:bT,image:d,action:this.__yJ.removeFormat}},{alignLeft:{text:w,image:L,action:this.__yJ.setJustifyLeft},alignCenter:{text:o,image:bH,action:this.__yJ.setJustifyCenter},alignRight:{text:bs,image:K,action:this.__yJ.setJustifyRight},alignJustify:{text:bE,image:N,action:this.__yJ.setJustifyFull}},{fontFamily:{custom:this.__yQ},fontSize:{custom:this.__yR},fontColor:{text:br,image:a,action:this.__yK},textBackgroundColor:{text:bk,image:bF,action:this.__yL}},{indent:{text:bv,image:bB,action:this.__yJ.insertIndent},outdent:{text:P,image:p,action:this.__yJ.insertOutdent}},{insertImage:{text:u,image:bR,action:this.__yM},insertTable:{text:bq,image:b,action:this.__yN},insertLink:{text:bm,image:F,action:this.__yO},insertHTML:{text:I,image:bC,action:this.__yP},insertHR:{text:bD,image:bK,action:this.__yJ.insertHorizontalRuler}},{ol:{text:G,image:bb,action:this.__yJ.insertOrderedList},ul:{text:bt,image:bL,action:this.__yJ.insertUnorderedList}},{undo:{text:h,image:c,action:this.__yJ.undo},redo:{text:k,image:n,action:this.__yJ.redo}}];}
,__yT:function(){var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setDecorator(bN);var cw;var cx=this.__yS();for(var i=0,j=cx.length;i<j;i++){var cy=new qx.ui.toolbar.Part;toolbar.add(cy);for(var cz in cx[i]){var cA=cx[i][cz];if(cA.custom){cw=cA.custom.call(this);}
else {cw=new qx.ui.toolbar.Button(null,cA.image);cw.set({focusable:false,keepFocus:true,center:true,toolTipText:cA.text?cA.text:x});cw.addListener(y,cA.action,this.__yJ);}
;cy.add(cw);}
;}
;return toolbar;}
}});}
...
(function(){var k="xhtml",j="_applyUseUndoRedo",i="focusOut",h="_applyMessengerMode",g="url(",f=")",d="InsertParagraphOnLinebreak",c="gecko",b="repeat",a="undoRedoState",bh="div",bg="__wa",bf="messengerContent",be="Integer",bd="NativeContextMenu",bc="focused",bb="Function",ba="Please use the method 'qx.dom.Node.isBlockNode' instead.",Y="_applyInsertParagraphOnLinebreak",X="PostProcess",r="_applyInsertLinebreakOnCtrlEnter",s="ContentType",p="px",q="set",n="DefaultFontSize",o="cursorContext",l="htmlarea",m="ready",v="loadingError",w="MessengerMode",E="_applyDefaultFontSize",C="UseUndoRedo",M="_applyDefaultFontFamily",H="_applyContentType",T="qx.ui.embed.HtmlArea",R="mshtml",y="Verdana",W="block",V="DefaultFontFamily",U="contextmenu",x="__vY",A="readyAfterInvalid",B="InsertLinebreakOnCtrlEnter",D="qx/static/blank.gif",F="_applyPostProcess",I="absolute",O="mousedown",S="DOMNodeRemoved",t="String",u="none",z="engine.name",L="appear",K="mouseup",J="losecapture",Q="display",P="Boolean",G="qx.event.type.Event",N="qx.event.type.Data";qx.Class.define(T,{extend:qx.ui.core.Widget,construct:function(bi,bj,bk){this.__vW={};qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.Grow);this.__wc();this.__vX={content:bi,styleInfo:bj,source:bk};qx.event.Registration.addListener(document.body,O,this.block,this,true);qx.event.Registration.addListener(document.body,K,this.release,this,true);qx.event.Registration.addListener(document.body,J,this.release,this,true);}
,events:{"loadingError":N,"messengerContent":N,"cursorContext":N,"ready":G,"readyAfterInvalid":G,"focused":G,"focusOut":G,"contextmenu":N,"undoRedoState":N},statics:{isBlockNode:function(bl){var bm=qx.ui.embed.HtmlArea.isBlockNode;var bn=ba;qx.log.Logger.deprecatedMethodWarning(bm,bn);return qx.dom.Node.isBlockNode(bl);}
,isParagraphParent:function(bo){return qx.bom.htmlarea.HtmlArea.isParagraphParent(bo);}
},properties:{contentType:{check:t,init:k,apply:H},messengerMode:{check:P,init:false,apply:h},insertParagraphOnLinebreak:{check:P,init:true,apply:Y},insertLinebreakOnCtrlEnter:{check:P,init:true,apply:r},postProcess:{check:bb,nullable:true,init:null,apply:F},useUndoRedo:{check:P,init:true,apply:j},appearance:{refine:true,init:l},defaultFontFamily:{check:t,init:y,apply:M},defaultFontSize:{check:be,init:4,apply:E},focusable:{refine:true,init:true}},members:{__vY:null,__vW:null,__wa:null,__vX:null,__wb:null,_initBlockerElement:function(){if(!this.__wa){this.__wa=this._createBlockerElement();}
;}
,_applyContentType:function(bp,bq){if(this.__vY!=null){this.__vY.setContentType(bp);}
else {this.__vW[s]=bp;}
;}
,_applyMessengerMode:function(br,bs){if(this.__vY!=null){this.__vY.setMessengerMode(br);}
else {this.__vW[w]=br;}
;}
,_applyInsertParagraphOnLinebreak:function(bt,bu){if(this.__vY!=null){this.__vY.setInsertParagraphOnLinebreak(bt);}
else {this.__vW[d]=bt;}
;}
,_applyInsertLinebreakOnCtrlEnter:function(bv,bw){if(this.__vY!=null){this.__vY.setInsertLinebreakOnCtrlEnter(bv);}
else {this.__vW[B]=bv;}
;}
,_applyPostProcess:function(bx,by){if(this.__vY!=null){this.__vY.setPostProcess(bx);}
else {this.__vW[X]=bx;}
;}
,_applyUseUndoRedo:function(bz,bA){if(this.__vY!=null){this.__vY.setUseUndoRedo(bz);}
else {this.__vW[C]=bz;}
;}
,_applyDefaultFontFamily:function(bB,bC){if(this.__vY!=null){this.__vY.setDefaultFontFamily(bB);}
else {this.__vW[V]=bB;}
;}
,_applyDefaultFontSize:function(bD,bE){if(this.__vY!=null){this.__vY.setDefaultFontSize(bD);}
else {this.__vW[n]=bD;}
;}
,_applyNativeContextMenu:function(bF,bG){if(this.__vY!=null){this.__vY.setNativeContextMenu(bF);}
else {this.__vW[bd]=bF;}
;}
,_createBlockerElement:function(){var bH=new qx.html.Element(bh);bH.setStyles({zIndex:20,position:I,display:u});if((qx.core.Environment.get(z)==R)){bH.setStyles({backgroundImage:g+qx.util.ResourceManager.getInstance().toUri(D)+f,backgroundRepeat:b});}
;return bH;}
,__wc:function(){this.addListenerOnce(L,this.__wd);}
,__wd:function(){var bI=this.getContentElement().getDomElement();this.__vY=new qx.bom.htmlarea.HtmlArea(bI,this.__vX.content,this.__vX.styleInfo,this.__vX.source);this.__we();this.__wf();if((qx.core.Environment.get(z)==c)){this.__wi();}
;this.addListener(L,this.forceEditable);}
,__we:function(){for(var bJ in this.__vW){this.__vY[q+bJ](this.__vW[bJ]);}
;}
,__wf:function(){this.__vY.addListener(m,this.__wg,this);this.__vY.addListener(A,this.__wg,this);this.__vY.addListener(bc,this.__wg,this);this.__vY.addListener(i,this.__wg,this);this.__vY.addListener(v,this.__wh,this);this.__vY.addListener(o,this.__wh,this);this.__vY.addListener(U,this.__wh,this);this.__vY.addListener(a,this.__wh,this);this.__vY.addListener(bf,this.__wh,this);}
,__wg:function(e){var bK=e.clone();this.fireEvent(bK.getType());}
,__wh:function(e){var bL=e.clone();this.fireDataEvent(bL.getType(),e.getData());}
,__wi:function(){this.__wb=qx.lang.Function.bind(this.__wj,this);var bM=this.getContainerElement().getDomElement();qx.bom.Event.addNativeListener(bM,S,this.__wb);}
,__wj:qx.event.GlobalError.observeMethod(function(e){if(this.__vY&&!this.__vY.isDisposed()){this.__vY.invalidateEditor();}
;}
),renderLayout:function(bN,top,bO,bP){qx.ui.core.Widget.prototype.renderLayout.call(this,bN,top,bO,bP);var bR=p;var bQ=this.getInsets();if(!this.__wa){this._initBlockerElement();}
;this.__wa.setStyles({left:bQ.left+bR,top:bQ.top+bR,width:(bO-bQ.left-bQ.right)+bR,height:(bP-bQ.top-bQ.bottom)+bR});}
,getIframeObject:function(){return this.__vY!=null?this.__vY.getIframeObject():null;}
,getCommandManager:function(){return this.__vY!=null?this.__vY.getCommandManager():null;}
,setValue:function(bS){if(this.__vY!=null){this.__vY.setValue(bS);}
else {this.__vX.content=bS;}
;}
,getValue:function(){if(this.__vY!=null){return this.__vY.getValue();}
else {return this.__vX.content;}
;}
,getComputedValue:function(bT){return this.__vY!=null?this.__vY.getHtml(bT):null;}
,getCompleteHtml:function(){return this.__vY!=null?this.__vY.getCompleteHtml():null;}
,getContentDocument:function(){return this.__vY!=null?this.__vY.getContentDocument():null;}
,getContentBody:function(){return this.__vY!=null?this.__vY.getContentBody():null;}
,getContentWindow:function(){return this.__vY!=null?this.__vY.getContentWindow():null;}
,getWords:function(bU){return this.__vY!=null?this.__vY.getWords(bU):null;}
,getWordsWithElement:function(){return this.__vY!=null?this.__vY.getWordsWithElement():null;}
,getTextNodes:function(){return this.__vY!=null?this.__vY.getTextNodes():null;}
,isReady:function(){return this.__vY!=null?this.__vY.isReady():false;}
,forceEditable:function(){if(this.__vY!=null){this.__vY.forceEditable();}
;}
,isLoaded:function(){return this.__vY!=null?this.__vY.isLoaded():false;}
,setEditable:function(bV){if(this.__vY!=null){this.__vY.setEditable(bV);}
;}
,getEditable:function(){return this.__vY!=null?this.__vY.getEditable():false;}
,isEditable:function(){return this.__vY!=null?this.__vY.isEditable():false;}
,insertHtml:function(bW){return this.__vY!=null?this.__vY.insertHtml(bW):false;}
,removeFormat:function(){return this.__vY!=null?this.__vY.removeFormat():false;}
,setBold:function(){return this.__vY!=null?this.__vY.setBold():false;}
,setItalic:function(){return this.__vY!=null?this.__vY.setItalic():false;}
,setUnderline:function(){return this.__vY!=null?this.__vY.setUnderline():false;}
,setStrikeThrough:function(){return this.__vY!=null?this.__vY.setStrikeThrough():false;}
,setFontSize:function(bX){return this.__vY!=null?this.__vY.setFontSize(bX):false;}
,setFontFamily:function(bY){return this.__vY!=null?this.__vY.setFontFamily(bY):false;}
,setTextColor:function(ca){return this.__vY!=null?this.__vY.setTextColor(ca):false;}
,setTextBackgroundColor:function(cb){return this.__vY!=null?this.__vY.setTextBackgroundColor(cb):false;}
,setJustifyLeft:function(){return this.__vY!=null?this.__vY.setJustifyLeft():false;}
,setJustifyCenter:function(){return this.__vY!=null?this.__vY.setJustifyCenter():false;}
,setJustifyRight:function(){return this.__vY!=null?this.__vY.setJustifyRight():false;}
,setJustifyFull:function(){return this.__vY!=null?this.__vY.setJustifyFull():false;}
,insertIndent:function(){return this.__vY!=null?this.__vY.insertIndent():false;}
,insertOutdent:function(){return this.__vY!=null?this.__vY.insertOutdent():false;}
,insertOrderedList:function(){return this.__vY!=null?this.__vY.insertOrderedList():false;}
,insertUnorderedList:function(){return this.__vY!=null?this.__vY.insertUnorderedList():false;}
,insertHorizontalRuler:function(){return this.__vY!=null?this.__vY.insertHorizontalRuler():false;}
,insertImage:function(cc){return this.__vY!=null?this.__vY.insertImage(cc):false;}
,insertHyperLink:function(cd){return this.__vY!=null?this.__vY.insertHyperLink(cd):false;}
,removeBackgroundColor:function(){return this.__vY!=null?this.__vY.removeBackgroundColor():false;}
,setBackgroundColor:function(ce){return this.__vY!=null?this.__vY.setBackgroundColor(ce):false;}
,removeBackgroundImage:function(){return this.__vY!=null?this.__vY.removeBackgroundImage():false;}
,setBackgroundImage:function(cf,cg,ch){return this.__vY!=null?this.__vY.setBackgroundImage(cf,cg,ch):false;}
,selectAll:function(){return this.__vY!=null?this.__vY.selectAll():false;}
,undo:function(){return this.__vY!=null?this.__vY.undo():false;}
,redo:function(){return this.__vY!=null?this.__vY.redo():false;}
,resetHtml:function(){if(this.__vY!=null){this.__vY.resetHtml();}
;}
,getHtml:function(ci){return this.__vY!=null?this.__vY.getHtml(ci):null;}
,containsOnlyPlaceholder:function(){return this.__vY!=null?this.__vY.containsOnlyPlaceHolder():false;}
,getContextInformation:function(){return this.__vY!=null?this.__vY.getContextInformation():null;}
,getSelection:function(){return this.__vY!=null?this.__vY.getSelection():null;}
,getSelectedText:function(){return this.__vY!=null?this.__vY.getSelectedText():null;}
,getSelectedHtml:function(){return this.__vY!=null?this.__vY.getSelectedHtml():null;}
,clearSelection:function(){if(this.__vY!=null){this.__vY.clearSelection();}
;}
,getRange:function(){return this.__vY.getRange();}
,saveRange:function(){this.__vY.saveRange();}
,getSavedRange:function(){return this.__vY.getSavedRange();}
,resetSavedRange:function(){this.__vY.resetSavedRange();}
,getFocusNode:function(){return this.__vY!=null?this.__vY.getFocusNode():null;}
,block:function(){if(!this.__wa){this._initBlockerElement();}
;if(!this.getContainerElement().hasChild(this.__wa)){this.getContainerElement().add(this.__wa);}
;this.__wa.setStyle(Q,W);}
,release:function(){if(this.__wa){this.__wa.setStyle(Q,u);}
;}
,focus:function(){qx.ui.core.Widget.prototype.focus.call(this);this.__wk();}
,tabFocus:function(){qx.ui.core.Widget.prototype.tabFocus.call(this);this.__wk();}
,__wk:function(){if(this.__vY!=null){qx.event.Timer.once(function(){this.__vY.focusContent();}
,this,0);}
;}
},destruct:function(){this.__vW=this.__vX=null;qx.event.Registration.removeListener(document.body,O,this.block,this,true);qx.event.Registration.removeListener(document.body,K,this.release,this,true);qx.event.Registration.removeListener(document.body,J,this.release,this,true);var cj=this.getContainerElement().getDomElement();if(cj){qx.bom.Event.removeNativeListener(cj,S,this.__wb);}
;this._disposeObjects(bg,x);}
});}
)();
