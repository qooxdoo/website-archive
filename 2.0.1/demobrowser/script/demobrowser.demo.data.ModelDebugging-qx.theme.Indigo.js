...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ModelDebugging-qx.theme.Indigo.b0814ab0da5e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="qx.bom.request.Jsonp",l="callback",k="open",j="dispose",i="",h="_onNativeLoad",g="qx.debug",f="Expecting JavaScript response to call: ",e="].callback",d=" already exists",a="Callback ",c="qx.bom.request.Jsonp[",b="qx.debug.io";qx.Bootstrap.define(m,{extend:qx.bom.request.Script,construct:function(){qx.bom.request.Script.apply(this);this.__tI();}
,members:{responseJson:null,__bV:null,__tD:null,__tE:null,__tF:null,__tG:null,__tf:null,open:function(n,o){if(this.__tf){return;}
;var p={},r,q,s=this;this.responseJson=null;this.__tF=false;r=this.__tD||l;q=this.__tE||c+this.__bV+e;if(!this.__tE){this.constructor[this.__bV]=this;}
else {if(!window[this.__tE]){this.__tG=true;window[this.__tE]=function(t){s.callback(t);}
;}
else {if(qx.core.Environment.get(b)){qx.Bootstrap.debug(qx.bom.request.Jsonp,a+this.__tE+d);}
;}
;}
...
,callback:function(u){if(this.__tf){return;}
;this.__tF=true;if(qx.core.Environment.get(g)){u=qx.lang.Json.stringify(u);u=qx.lang.Json.parse(u);}
;this.responseJson=u;this.constructor[this.__bV]=undefined;this.__tH();}
,setCallbackParam:function(v){this.__tD=v;return this;}
,setCallbackName:function(name){this.__tE=name;return this;}
,dispose:function(){this.__tH();this.__fK(j);}
,_onNativeLoad:function(){this.status=this.__tF?200:500;this.__fK(h);}
,__tH:function(){if(this.__tG&&window[this.__tE]){window[this.__tE]=undefined;this.__tG=false;}
;}
,__fK:function(w,x){qx.bom.request.Script.prototype[w].apply(this,x||[]);}
,__tI:function(){this.__bV=(new Date().valueOf())+(i+Math.random()).substring(2,5);}
}});}
)();
...
;return br;}
;;return C;}
,startDisposeProfiling:qx.core.Environment.select(y,{"true":function(){this.disposeProfilingActive=true;this.__PT=qx.core.ObjectRegistry.getNextHash();}
,"default":qx.lang.Function.empty}),stopDisposeProfiling:qx.core.Environment.select(y,{"true":function(bt){if(!this.__PT){qx.log.Logger.error(K+this.classname+E);return [];}
;this.disposeProfilingActive=false;var bv=[];while(!qx.ui.core.queue.Dispose.isEmpty()){qx.ui.core.queue.Dispose.flush();}
;var bw=qx.core.ObjectRegistry.getNextHash();var by=qx.core.ObjectRegistry.getPostId();var bz=qx.core.ObjectRegistry.getStackTraces();for(var bu=this.__PT;bu<bw;bu++){var bx=qx.core.ObjectRegistry.fromHashCode(bu+by);if(bx&&bx.isDisposed&&!bx.isDisposed()){if(bt&&typeof bt==g&&!bt(bx)){continue;}
