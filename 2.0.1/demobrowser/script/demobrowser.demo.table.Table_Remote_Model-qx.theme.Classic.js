...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.table.Table_Remote_Model-qx.theme.Classic.4f2a5083bd17.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,reloadData:function(){this.clearCache();if(this.__KU!=-1){var j=this._cancelCurrentRequest();if(j){this.__KU=-1;this.__KX=false;}
else {this.__KX=true;}
;}
;this.__KV=-1;this.__KW=-1;this.__Lb=true;this._loadRowCount();}
,clearCache:function(){this.__KY={};this.__La=0;}
,getCacheContent:function(){return {sortColumnIndex:this.__mW,sortAscending:this.__nb,rowCount:this.__KS,lruCounter:this.__KT,rowBlockCache:this.__KY,rowBlockCount:this.__La};}
,restoreCacheContent:function(k){if(this.__KU!=-1){var m=this._cancelCurrentRequest();if(m){this.__KU=-1;this.__KX=false;}
else {this.__KX=true;}
;}
;this.__mW=k.sortColumnIndex;this.__nb=k.sortAscending;this.__KS=k.rowCount;this.__KT=k.lruCounter;this.__KY=k.rowBlockCache;this.__La=k.rowBlockCount;var l={firstRow:0,lastRow:this.__KS-1,firstColumn:0,lastColumn:this.getColumnCount()-1};this.fireDataEvent(a,l);}
...
;}
;}
,prefetchRows:function(y,z){if(this.__KU==-1){var A=this.getBlockSize();var F=Math.ceil(this.__KS/A);var E=parseInt(y/A,10)-1;if(E<0){E=0;}
;var D=parseInt(z/A,10)+1;if(D>=F){D=F-1;}
;var C=-1;var B=-1;for(var G=E;G<=D;G++){if(this.__KY[G]==null||this.__KY[G].isDirty){if(C==-1){C=G;}
;B=G;}
;}
...
,_onRowDataLoaded:function(J){if(J!=null&&!this.__KX){var M=this.getBlockSize();var K=Math.ceil(J.length/M);if(K==1){this._setRowBlockData(this.__KU,J);}
...
},destruct:function(){this.__na=this.__mY=this.__KY=null;}
});}
)();
