...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline-qx.theme.Classic.a172ad7278ef.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{model:{nullable:true,event:c,apply:a}},members:{_storage:null,__Cw:null,_applyModel:function(j,k){if(k){k.removeListenerById(this.__Cw);k.dispose();this.__Cw=null;}
;if(j){this.__Cw=j.addListener(b,this.__Cx,this);this.__Cx();}
else {this._storage.removeItem(this._key);}
;}
,__Cx:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
