...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Popup","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Popup-qx.theme.Modern.8a6fcd3a715f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="#FFFAD3",i="#DFFAD3",h="Open Popup #2",g="top-right",f="Open Popup #1",d="demobrowser.demo.widget.Popup",c="click",b="icon/32/apps/media-photo-album.png",a="Hello World #1";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.layout.HBox();k.setSpacing(20);var l=new qx.ui.container.Composite(k).set({padding:20});this.getRoot().add(l);l.add(this._getPopupButton1());l.add(this._getPopupButton2());}
,_getPopupButton1:function(){var m=new qx.ui.form.Button(f);var n=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:j,padding:[2,4],offset:3,offsetBottom:20});n.add(new qx.ui.basic.Atom(a,b));m.addListener(c,function(e){n.placeToMouse(e);n.show();}
,this);return m;}
,_getPopupButton2:function(){var o=new qx.ui.form.Button(h);var p=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:i,padding:[2,4],offset:3,position:g});p.add(new qx.ui.basic.Atom(a,b));o.addListener(c,function(e){p.placeToMouse(e);p.show();}
,this);return o;}
}});}
)();
