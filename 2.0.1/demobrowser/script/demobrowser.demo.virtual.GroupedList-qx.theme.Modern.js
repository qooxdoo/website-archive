...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.GroupedList","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Modern.b9cc9fdfd879.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
};T.setDelegate(V);T.setSelection(this.__Dg.getSelection());return U;}
,createThirdExample:function(){var bc=new qx.ui.container.Composite(new qx.ui.layout.Canvas());var be=new qx.ui.basic.Label(z).set({font:n});bc.add(be);var bb=this.__Rs=new qx.ui.list.List().set({height:280,width:150,labelPath:p,labelOptions:{converter:function(bf,bg){return bg?bf+o+bg.getLastname():v;}
...
};bb.setDelegate(bd);bb.setSelection(this.__Dg.getSelection());return bc;}
},destruct:function(){this.__Dg.dispose();this.__Rr.dispose();this.__Rs.dispose();this.__Dg=this.__Rr=this.__Rs=null;}
});}
)();
