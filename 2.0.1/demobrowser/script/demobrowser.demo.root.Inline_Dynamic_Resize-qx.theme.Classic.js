...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline_Dynamic_Resize","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline_Dynamic_Resize-qx.theme.Classic.4d7dfd9e36ad.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="widget",s="drive-optical.png",r="computer.png",q="audio-card.png",p="battery.png",o="isle1",n="input-keyboard.png",m="icon/48/devices/",l="demobrowser.demo.root.Inline_Dynamic_Resize",k="isle2",d="drive-harddisk.png",j="camera-web.png",g="network-wired.png",c="icon/48/devices/computer.png",b="camera-photo.png",f="network-wireless.png",e="audio-input-microphone.png",h="group",a="display.png";qx.Class.define(l,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);var x=new qx.ui.root.Inline(document.getElementById(o),false,true);x.setLayout(new qx.ui.layout.Canvas());x.add(new qx.ui.form.Button(null,c),{edge:0});var v=new qx.ui.root.Inline(document.getElementById(k),true,false).set({padding:[10,0],decorator:null,appearance:t});v.setLayout(new qx.ui.layout.Canvas());var w=new qx.ui.container.SlideBar();w.setLayout(new qx.ui.layout.HBox(3));v.add(w,{edge:0});var u=[q,e,p,b,j,r,a,d,s,n,g,f];for(var i=0;i<u.length;i++){w.add((new qx.ui.basic.Image(m+u[i])).set({decorator:h,padding:4}));}
;}
}});}
)();
