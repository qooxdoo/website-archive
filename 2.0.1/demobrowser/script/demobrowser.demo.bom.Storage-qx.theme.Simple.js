...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Storage","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Storage-qx.theme.Simple.8822c8c0d253.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="<em>no content</em>",q="Memory Storage",p="html.storage.userdata",o="list",n="save",m="value",l="Web Storage",k="demobrowser.demo.bom.Storage",j="<br>",i="userData Storage",c="clear",h="html.storage.local",f=":",b="using",a="remove",e="key",d="",g="click";qx.Class.define(k,{extend:qx.application.Native,members:{__sn:null,main:function(){qx.application.Native.prototype.main.call(this);this.setUsing();this.__sn=qx.bom.Storage.getLocal();var t=document.getElementById(n);var s=document.getElementById(c);var u=document.getElementById(a);var self=this;qx.bom.Event.addNativeListener(t,g,function(){var w=qx.bom.Input.getValue(document.getElementById(e));var v=qx.bom.Input.getValue(document.getElementById(m));self.__sn.setItem(w,v);self.updateList();}
);qx.bom.Event.addNativeListener(s,g,function(){self.__sn.clear();self.updateList();}
);qx.bom.Event.addNativeListener(u,g,function(){self.__sn.removeItem(self.__sn.getKey(0));self.updateList();}
);this.updateList();}
,updateList:function(){var x=document.getElementById(o);x.innerHTML=d;this.__sn.forEach(function(y,z){x.innerHTML+=y+f+z+j;}
...
(function(){var f="local",d="session",c="Storage",b="qx.bom.storage.Web",a="Storage full.";qx.Bootstrap.define(b,{statics:{__Cy:null,__Cz:null,getLocal:function(){if(this.__Cy){return this.__Cy;}
;return this.__Cy=new qx.bom.storage.Web(f);}
,getSession:function(){if(this.__Cz){return this.__Cz;}
;return this.__Cz=new qx.bom.storage.Web(d);}
...
(function(){var j="session",h="head",g="none",f="qx.bom.storage.UserData",e="div",d="local",c="#default#userdata",b="display",a="qx";qx.Bootstrap.define(f,{statics:{__Cy:null,__Cz:null,__bV:0,getLocal:function(){if(this.__Cy){return this.__Cy;}
;return this.__Cy=new qx.bom.storage.UserData(d);}
,getSession:function(){if(this.__Cz){return this.__Cz;}
;return this.__Cz=new qx.bom.storage.UserData(j);}
},construct:function(k){this.__CA=document.createElement(e);this.__CA.style[b]=g;document.getElementsByTagName(h)[0].appendChild(this.__CA);this.__CA.addBehavior(c);this.__CB=k;this.__CA.load(this.__CB);this.__sn={};this.__CC={};var l=this.__CA.getAttribute(a+qx.bom.storage.UserData.__bV);while(l!=undefined){l=qx.lang.Json.parse(l);this.__sn[l.key]=l.value;this.__CC[l.key]=a+qx.bom.storage.UserData.__bV;qx.bom.storage.UserData.__bV++;l=this.__CA.getAttribute(a+qx.bom.storage.UserData.__bV);}
;}
,members:{__CA:null,__CB:"qxtest",__sn:null,__CC:null,getStorage:function(){return this.__sn;}
,getLength:function(){return qx.Bootstrap.getKeys(this.__sn).length;}
,setItem:function(m,n){if(this.__CC[m]){var o=this.__CC[m];}
else {var o=a+qx.bom.storage.UserData.__bV;qx.bom.storage.UserData.__bV++;}
;var p=qx.lang.Json.stringify({key:m,value:n});this.__CA.setAttribute(o,p);this.__CA.save(this.__CB);this.__sn[m]=n;this.__CC[m]=o;}
,getItem:function(q){return this.__sn[q]||null;}
,removeItem:function(r){var u=this.__CC[r];if(u==undefined){return;}
;this.__CA.removeAttribute(u);qx.bom.storage.UserData.__bV--;delete this.__sn[r];delete this.__CC[r];var t=a+qx.bom.storage.UserData.__bV;if(this.__CA.getAttribute(t)){var v=this.__CA.getAttribute(a+qx.bom.storage.UserData.__bV);this.__CA.removeAttribute(t);this.__CA.setAttribute(u,v);var s=qx.lang.Json.parse(v).key;this.__CC[s]=u;}
;this.__CA.save(this.__CB);}
,clear:function(){for(var w in this.__CC){this.__CA.removeAttribute(this.__CC[w]);}
;this.__CA.save(this.__CB);this.__sn={};this.__CC={};}
,getKey:function(x){return qx.Bootstrap.getKeys(this.__sn)[x];}
,forEach:function(y,z){var length=this.getLength();for(var i=0;i<length;i++){var A=this.getKey(i);y.call(z,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__Cy:null,__Cz:null,getLocal:function(){if(this.__Cy){return this.__Cy;}
;return this.__Cy=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__Cz){return this.__Cz;}
;return this.__Cz=new qx.bom.storage.Memory();}
},construct:function(){this.__sn={};}
,members:{__sn:null,getStorage:function(){return this.__sn;}
,getLength:function(){return qx.Bootstrap.getKeys(this.__sn).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__sn[b]=c;}
,getItem:function(d){var e=this.__sn[d];if(qx.lang.Type.isString(e)){e=qx.lang.Json.parse(e);}
;return e;}
,removeItem:function(f){delete this.__sn[f];}
,clear:function(){this.__sn={};}
,getKey:function(g){var h=qx.Bootstrap.getKeys(this.__sn);return h[g];}
,forEach:function(j,k){var length=this.getLength();for(var i=0;i<length;i++){var l=this.getKey(i);j.call(k,l,this.getItem(l));}
;}
}});}
)();
(function(){var c="html.storage.local",b="html.storage.userdata",a="qx.bom.Storage";qx.Bootstrap.define(a,{statics:{__BD:null,getLocal:function(){return this.__BD.getLocal();}
,getSession:function(){return this.__BD.getSession();}
},defer:function(d){if(qx.core.Environment.get(c)){d.__BD=qx.bom.storage.Web;}
else if(qx.core.Environment.get(b)){d.__BD=qx.bom.storage.UserData;}
else {d.__BD=qx.bom.storage.Memory;}
;}
});}
)();
