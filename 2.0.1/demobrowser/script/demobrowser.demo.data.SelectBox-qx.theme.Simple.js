...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SelectBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SelectBox-qx.theme.Simple.a5966c9577d5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var t="F",s="G",r="Type in the textfield or set the selection with the button.",q="J",p="D",o="E",n="H",m="I",l="B",k="<b>Synchronized Selection</b><br/>",d="execute",j="<b>Change Selection</b><br/>",g="demobrowser.demo.data.SelectBox",c="Bound to the same data and share the selection. The label is also bound to the selection.",b="The selection is: ",f="Set Selection to 'C'",e="C",h="A",a="selection[0]",i="value";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var C=new qx.data.Array([h,l,e,p,o,t,s,n,m,q]);var D=new qx.ui.form.SelectBox();this.getRoot().add(D,{left:10,top:110});var A=new qx.data.controller.List(C,D);var B=new qx.ui.form.SelectBox();this.getRoot().add(B,{left:150,top:110});var z=new qx.data.controller.List(C,B);A.setSelection(z.getSelection());var y=new qx.ui.basic.Label();this.getRoot().add(new qx.ui.basic.Label(b),{left:10,top:140});this.getRoot().add(y,{left:110,top:140});A.bind(a,y,i);var v=new qx.ui.form.TextField(h);v.setLiveUpdate(true);v.setWidth(150);this.getRoot().add(v,{left:290,top:110});v.bind(i,A,a);A.bind(a,v,i);var w=new qx.ui.form.Button(f);w.setWidth(150);this.getRoot().add(w,{left:290,top:140});w.addListener(d,function(){A.getSelection().setItem(0,e);}
,this);var u=new qx.ui.basic.Label();u.setRich(true);u.setWidth(240);u.setValue(k+c);this.getRoot().add(u,{left:10,top:10});var x=new qx.ui.basic.Label();x.setRich(true);x.setWidth(130);x.setValue(j+r);this.getRoot().add(x,{left:300,top:10});}
}});}
)();
