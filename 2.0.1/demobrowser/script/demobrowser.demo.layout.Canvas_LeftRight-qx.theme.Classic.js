...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Canvas_LeftRight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Canvas_LeftRight-qx.theme.Classic.1565b9f888cf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var g="black",f="red",e="demobrowser.demo.layout.Canvas_LeftRight",d="green",c="yellow",b="solid",a="blue";qx.Class.define(e,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var m=new qx.ui.decoration.Single(3,b,g);var l=new qx.ui.core.Widget().set({backgroundColor:f,decorator:m,width:400});var k=new qx.ui.core.Widget().set({backgroundColor:a,decorator:m,minWidth:400});var j=new qx.ui.core.Widget().set({backgroundColor:d,decorator:m,width:400});var i=new qx.ui.core.Widget().set({backgroundColor:c,decorator:m,minWidth:400});var h=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({decorator:m});this.getRoot().setPadding(20);h.add(l,{left:10,top:10});h.add(k,{left:10,top:80});h.add(j,{top:150,right:10});h.add(i,{top:220,right:10});this.getRoot().add(h,{edge:0});}
}});}
)();
