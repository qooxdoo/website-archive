...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.showcase.Form-qx.theme.Indigo.db72e04f506d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__jb:function(bp,bq){var bt=qx.io.ImageLoader;if(qx.core.Environment.get(E)){var br=bq.toLowerCase();var bs=qx.lang.String.startsWith;if(!bs(br,f)&&!bs(br,y)){var self=this.self(arguments);if(!self.__GA){self.__GA={};}
;if(!self.__GA[bq]){this.debug(q+bq);self.__GA[bq]=true;}
;}
;}
...
(function(){var k="Spinner",j="Boolean",h="RadioButtonGroup",g="SelectBox",f="qxc.application.formdemo.FormItems",e="Selection",d="Website 3",c="TextArea",b="execute",a="Website 2",V="Text",U="ToggleButton",T="RadioButton 1",S="RadioButton 3",R="MenuButton :",Q="placeholder test...",P="Options",O="RadioButton",N="middle",M="SplitButton",r="Buttons",s="RepeatButton :",p="",q="required",n="Slider",o="ToggleButton :",l="TextField",m="Option",t="0",u="right",B="VirtualSelectBox",z="SplitButton :",F="Button :",D="ComboBox",I="List",H="RadioButton 2",w="Tri-State CheckBox",L="Number",K="CheckBox",J="DateField",v="MenuButton",x="Website 1",y="PasswordField",A="VirtualComboBox",C="Button",E="Item ",G="value";qx.Class.define(f,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);this.__vr=[];this._createView();}
,members:{__vr:null,_createView:function(){var bq=new qx.ui.layout.Grid(20,5);bq.setColumnFlex(0,1);bq.setColumnFlex(1,1);this.setLayout(bq);this.setPadding(10);var bf=1;var bo=new qx.ui.form.Form();var W=new qx.ui.groupbox.GroupBox(V);W.setLayout(new qx.ui.layout.Canvas());this.add(W,{row:0,column:0});var bA=new qx.ui.form.TextField();bA.setPlaceholder(q);bA.setTabIndex(bf++);bA.setRequired(true);this.__vr.push(bA);bo.add(bA,l);var be=new qx.ui.form.PasswordField();be.setTabIndex(bf++);bA.setRequired(true);this.__vr.push(be);bo.add(be,y);var X=new qx.ui.form.TextArea();X.setPlaceholder(Q);X.setTabIndex(bf++);this.__vr.push(X);bo.add(X,c);var Y=new qx.ui.form.ComboBox();Y.setTabIndex(bf++);this.__vs(Y);this.__vr.push(Y);bo.add(Y,D);var bg=new qx.ui.form.VirtualComboBox();bg.setTabIndex(bf++);this.__vt(bg);this.__vr.push(bg);bo.add(bg,A);var bt=new qx.ui.form.DateField();bt.setTabIndex(bf++);this.__vr.push(bt);bo.add(bt,J);var bc=new qx.ui.form.renderer.Single(bo);W.add(bc);bo=new qx.ui.form.Form();var bi=new qx.ui.groupbox.GroupBox(e);bi.setLayout(new qx.ui.layout.Canvas());this.add(bi,{row:1,column:0,rowSpan:2});var bu=new qx.ui.form.SelectBox();bu.setTabIndex(bf++);bo.add(bu,g);this.__vs(bu);this.__vr.push(bu);var bh=new qx.ui.form.VirtualSelectBox();bh.setTabIndex(bf++);bo.add(bh,B);this.__vt(bh);this.__vr.push(bh);var bz=new qx.ui.form.List();bz.setTabIndex(bf++);bz.setHeight(60);bz.setWidth(155);bo.add(bz,I);this.__vs(bz);this.__vr.push(bz);var br=new qx.ui.form.RadioButtonGroup();br.add(new qx.ui.form.RadioButton(T).set({tabIndex:bf++}));br.add(new qx.ui.form.RadioButton(H).set({tabIndex:bf++}));br.add(new qx.ui.form.RadioButton(S).set({tabIndex:bf++}));bo.add(br,h);this.__vr.push(br);bc=new qx.ui.form.renderer.Single(bo);bi.add(bc);var bx=new qx.ui.groupbox.GroupBox(r);var bs=new qx.ui.layout.Grid(8,8);bx.setLayout(bs);bs.setColumnAlign(0,u,N);this.add(bx,{row:0,column:1});var by=new qx.ui.form.Button(C).set({tabIndex:bf++});var bj=new qx.ui.basic.Label(F);bj.setBuddy(by);bx.add(bj,{row:0,column:0});bx.add(by,{row:0,column:1});this.__vr.push(by);var bb=new qx.ui.form.ToggleButton(U).set({tabIndex:bf++});bj=new qx.ui.basic.Label(o);bj.setBuddy(bb);bx.add(bj,{row:1,column:0});bx.add(bb,{row:1,column:1});this.__vr.push(bb);var bm=new qx.ui.form.RepeatButton(t).set({tabIndex:bf++});bj=new qx.ui.basic.Label(s);bj.setBuddy(bm);bx.add(bj,{row:2,column:0});bx.add(bm,{row:2,column:1});this.__vr.push(bm);var bn=new qx.ui.form.MenuButton(v,null,this.__vu()).set({tabIndex:bf++});bj=new qx.ui.basic.Label(R);bj.setBuddy(bn);bx.add(bj,{row:3,column:0});bx.add(bn,{row:3,column:1});this.__vr.push(bn);var bd=new qx.ui.form.SplitButton(M,null,this.__vv()).set({tabIndex:bf++});bj=new qx.ui.basic.Label(z);bj.setBuddy(bd);bx.add(bj,{row:4,column:0});bx.add(bd,{row:4,column:1});this.__vr.push(bd);bm.addListener(b,function(){var bC=parseInt(bm.getLabel(),10)+1;bm.setLabel(bC.toString());}
);bo=new qx.ui.form.Form();var ba=new qx.ui.groupbox.GroupBox(j);ba.setLayout(new qx.ui.layout.Canvas());this.add(ba,{row:1,column:1});var bv=new qx.ui.form.CheckBox().set({tabIndex:bf++});bo.add(bv,K);this.__vr.push(bv);var bB=new qx.ui.form.CheckBox().set({tabIndex:bf++,triState:true,value:null});bo.add(bB,w);this.__vr.push(bB);var bl=new qx.ui.form.RadioButton().set({tabIndex:bf++});bo.add(bl,O);this.__vr.push(bl);bc=new qx.ui.form.renderer.Single(bo);ba.add(bc);bo=new qx.ui.form.Form();var bw=new qx.ui.groupbox.GroupBox(L);bw.setLayout(new qx.ui.layout.Canvas());this.add(bw,{row:2,column:1});var bk=new qx.ui.form.Spinner(0,50,100).set({tabIndex:bf++});bo.add(bk,k);this.__vr.push(bk);var bp=new qx.ui.form.Slider().set({tabIndex:bf++});bp.setWidth(130);bo.add(bp,n);this.__vr.push(bp);bp.bind(G,bk,G);bk.bind(G,bp,G);bc=new qx.ui.form.renderer.Single(bo);bw.add(bc);}
,__vs:function(bD){for(var i=0;i<10;i++){var bE=new qx.ui.form.ListItem(E+i);bD.add(bE);}
;}
,__vt:function(bF){var bG=new qx.data.Array();for(var i=0;i<300;i++){bG.push(E+(i));}
;bF.setModel(bG);}
,__vu:function(){var bH=new qx.ui.menu.Menu;for(var i=0;i<3;i++){bH.add(new qx.ui.menu.RadioButton(m+i));}
;var bK=new qx.ui.form.RadioGroup;bK.add.apply(bK,bH.getChildren());var bJ=new qx.ui.menu.Menu();for(i=0;i<3;i++){var bL=new qx.ui.menu.Button(C+i);bJ.add(bL);}
;var bI=new qx.ui.menu.Button(P,p,null,bH);bJ.addSeparator();bJ.add(bI);return bJ;}
,__vv:function(){var bM=new qx.ui.menu.Menu;var bP=new qx.ui.menu.Button(x);var bN=new qx.ui.menu.Button(a);var bO=new qx.ui.menu.Button(d);bM.add(bP);bM.add(bN);bM.add(bO);return bM;}
,getWidgets:function(){return this.__vr;}
}});}
)();
...
(function(){var b="qx.ui.form.Form",a="";qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__vQ=[];this._buttons=[];this._buttonOptions=[];this._validationManager=new qx.ui.form.validation.Manager();this._resetter=this._createResetter();}
,members:{__vQ:null,_validationManager:null,_groupCounter:0,_buttons:null,_buttonOptions:null,_resetter:null,add:function(c,d,e,name,f,g){if(this.__vR()){this.__vQ.push({title:null,items:[],labels:[],names:[],options:[],headerOptions:{}});}
;this.__vQ[this._groupCounter].items.push(c);this.__vQ[this._groupCounter].labels.push(d);this.__vQ[this._groupCounter].options.push(g);if(name==null){name=d.replace(/\s+|&|-|\+|\*|\/|\||!|\.|,|:|\?|;|~|%|\{|\}|\(|\)|\[|\]|<|>|=|\^|@|\\/g,a);}
;this.__vQ[this._groupCounter].names.push(name);this._validationManager.add(c,e,f);this._resetter.add(c);}
,addGroupHeader:function(h,k){if(!this.__vR()){this._groupCounter++;}
;this.__vQ.push({title:h,items:[],labels:[],names:[],options:[],headerOptions:k});}
,addButton:function(l,m){this._buttons.push(l);this._buttonOptions.push(m||null);}
,__vR:function(){return this.__vQ.length===0;}
...
,getGroups:function(){return this.__vQ;}
,getButtons:function(){return this._buttons;}
,getButtonOptions:function(){return this._buttonOptions;}
,getItems:function(){var n={};for(var i=0;i<this.__vQ.length;i++){var o=this.__vQ[i];for(var j=0;j<o.names.length;j++){var name=o.names[j];n[name]=o.items[j];}
;}
;return n;}
,_createResetter:function(){return new qx.ui.form.Resetter();}
},destruct:function(){this.__vQ=this._buttons=this._buttonOptions=null;this._validationManager.dispose();this._resetter.dispose();}
});}
)();
(function(){var n="Widgets supporting selection can only be validated ",m="Added widget not supported.",l="in the form validator",k="changeValid",j="qx.event.type.Event",h="value instanceof Function || qx.Class.isSubClassOf(value.constructor, qx.ui.form.validation.AsyncValidator)",g="qx.ui.form.validation.Manager",f="This field is required",d="qx.event.type.Data",c="complete",a="String",b="";qx.Class.define(g,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__vd=[];this.__ve={};this.setRequiredFieldMessage(qx.locale.Manager.tr(f));}
,events:{"changeValid":d,"complete":j},properties:{validator:{check:h,init:null,nullable:true},invalidMessage:{check:a,init:b},requiredFieldMessage:{check:a,init:b},context:{nullable:true}},members:{__vd:null,__vf:null,__ve:null,__vg:null,add:function(o,p,q){if(!this.__vl(o)){throw new Error(m);}
;if(this.__vb(o)&&!o.getValue){if(p!=null){throw new Error(n+l);}
;}
;var r={item:o,validator:p,valid:null,context:q};this.__vd.push(r);}
,remove:function(s){var t=this.__vd;for(var i=0,u=t.length;i<u;i++){if(s===t[i].item){t.splice(i,1);return s;}
;}
;return null;}
,getItems:function(){var v=[];for(var i=0;i<this.__vd.length;i++){v.push(this.__vd[i].item);}
;return v;}
,validate:function(){var A=true;this.__vg=true;var x=[];for(var i=0;i<this.__vd.length;i++){var y=this.__vd[i].item;var B=this.__vd[i].validator;x.push(y);if(B==null){var w=this.__vh(y);A=A&&w;this.__vg=w&&this.__vg;continue;}
;var w=this.__vi(this.__vd[i],y.getValue());A=w&&A;if(w!=null){this.__vg=w&&this.__vg;}
;}
;var z=this.__vj(x);if(qx.lang.Type.isBoolean(z)){this.__vg=z&&this.__vg;}
;A=z&&A;this.__vm(A);if(qx.lang.Object.isEmpty(this.__ve)){this.fireEvent(c);}
;return A;}
,__vh:function(C){if(C.getRequired()){if(this.__vb(C)){var D=!!C.getSelection()[0];}
...
;return true;}
,__vi:function(G,H){var M=G.item;var L=G.context;var K=G.validator;if(this.__vk(K)){this.__ve[M.toHashCode()]=null;K.validate(M,M.getValue(),this,L);return null;}
...
,__vj:function(N){var P=this.getValidator();var Q=this.getContext()||this;if(P==null){return true;}
;this.setInvalidMessage(b);if(this.__vk(P)){this.__ve[this.toHashCode()]=null;P.validateForm(N,this,Q);return null;}
...
;}
;return R;}
,__vk:function(S){var T=false;if(!qx.lang.Type.isFunction(S)){T=qx.Class.isSubClassOf(S.constructor,qx.ui.form.validation.AsyncValidator);}
;return T;}
,__vl:function(U){var V=U.constructor;return qx.Class.hasInterface(V,qx.ui.form.IForm);}
,__vb:function(W){var X=W.constructor;return qx.Class.hasInterface(X,qx.ui.core.ISingleSelection);}
,__vm:function(Y){var ba=this.__vf;this.__vf=Y;if(ba!=Y){this.fireDataEvent(k,Y,ba);}
;}
,getValid:function(){return this.__vf;}
,isValid:function(){return this.getValid();}
,getInvalidMessages:function(){var bb=[];for(var i=0;i<this.__vd.length;i++){var bc=this.__vd[i].item;if(!bc.getValid()){bb.push(bc.getInvalidMessage());}
;}
;if(this.getInvalidMessage()!=b){bb.push(this.getInvalidMessage());}
;return bb;}
,getInvalidFormItems:function(){var bd=[];for(var i=0;i<this.__vd.length;i++){var be=this.__vd[i].item;if(!be.getValid()){bd.push(be);}
;}
;return bd;}
,reset:function(){for(var i=0;i<this.__vd.length;i++){var bf=this.__vd[i];bf.item.setValid(true);}
;this.__vf=null;}
,setItemValid:function(bg,bh){this.__ve[bg.toHashCode()]=bh;bg.setValid(bh);this.__vn();}
,setFormValid:function(bi){this.__ve[this.toHashCode()]=bi;this.__vn();}
,__vn:function(){var bk=this.__vg;for(var bl in this.__ve){var bj=this.__ve[bl];bk=bj&&bk;if(bj==null){return;}
;}
;this.__vm(bk);this.__ve={};this.fireEvent(c);}
},destruct:function(){this.__vd=null;}
});}
)();
(function(){var a="qx.ui.form.validation.AsyncValidator";qx.Class.define(a,{extend:qx.core.Object,construct:function(b){qx.core.Object.call(this);this.__vo=b;}
,members:{__vo:null,__vp:null,__dz:null,__vq:null,validate:function(c,d,e,f){this.__vq=false;this.__vp=c;this.__dz=e;this.__vo.call(f||this,this,d);}
,validateForm:function(g,h,i){this.__vq=true;this.__dz=h;this.__vo.call(i,g,this);}
,setValid:function(j,k){if(this.__vq){if(k!==undefined){this.__dz.setInvalidMessage(k);}
;this.__dz.setFormValid(j);}
else {if(k!==undefined){this.__vp.setInvalidMessage(k);}
;this.__dz.setItemValid(this.__vp,j);}
;}
},destruct:function(){this.__dz=this.__vp=null;}
});}
)();
...
(function(){var d="qx.ui.form.Resetter",c=" not supported for reseting.",b="Item ",a="The given item has not been added.";qx.Class.define(d,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__mP=[];}
,members:{__mP:null,add:function(e){if(this._supportsValue(e)){var f=e.getValue();}
else if(this.__vb(e)){var f=e.getSelection();}
else if(this.__vc(e)){var f=e.getSelection().concat();}
else {throw new Error(b+e+c);}
;;this.__mP.push({item:e,init:f});}
,reset:function(){for(var i=0;i<this.__mP.length;i++){var g=this.__mP[i];this.__uY(g.item,g.init);}
;}
,resetItem:function(h){var j;for(var i=0;i<this.__mP.length;i++){var k=this.__mP[i];if(k.item===h){j=k.init;break;}
;}
;if(j===undefined){throw new Error(a);}
;this.__uY(h,j);}
,__uY:function(l,m){if(this._supportsValue(l)){l.setValue(m);}
else if(this.__vb(l)||this.__vc(l)){l.setSelection(m);}
;}
,redefine:function(){for(var i=0;i<this.__mP.length;i++){var n=this.__mP[i].item;this.__mP[i].init=this.__va(n);}
;}
,redefineItem:function(o){var p;for(var i=0;i<this.__mP.length;i++){if(this.__mP[i].item===o){p=this.__mP[i];break;}
;}
;if(p===undefined){throw new Error(a);}
;p.init=this.__va(p.item);}
,__va:function(q){if(this._supportsValue(q)){return q.getValue();}
else if(this.__vb(q)||this.__vc(q)){return q.getSelection();}
;}
,__vb:function(r){var s=r.constructor;return qx.Class.hasInterface(s,qx.ui.core.ISingleSelection);}
,__vc:function(t){var u=t.constructor;return qx.Class.hasInterface(u,qx.data.controller.ISelection);}
...
;var bo=this.getContentElement();if(bl&&this.__mA){this.__mF().setStyles({"left":bm.left+bq,"top":bm.top+bq});}
;if(bn){if(this.__mA){this.__mF().setStyles({"width":innerWidth+bq,"height":innerHeight+bq});}
...
;return bs;}
,_applyEnabled:function(bt,bu){qx.ui.core.Widget.prototype._applyEnabled.call(this,bt,bu);this.getContentElement().setEnabled(bt);if(this.__mA){if(bt){this._showPlaceholder();}
...
;this.getContentElement().setStyles(by);if(this.__mA){delete by[J];this.__mF().setStyles(by);}
;if(bw){this.__mD=qx.bom.Label.getTextSize(S,by);}
...
,_onHtmlInput:function(e){var bE=e.getData();var bD=true;this.__mB=false;if(this.__fO&&this.__fO===bE){bD=false;}
...
;if(bD){this.fireDataEvent(D,bE,this.__fO);this.__fO=bE;if(this.getLiveUpdate()){this.__mE(bE);}
;}
;}
,_onWebFontStatusChange:function(bG){if(bG.getData().valid===true){var bH=this.__lw.getStyles();this.__mD=qx.bom.Label.getTextSize(S,bH);qx.ui.core.queue.Layout.add(this);}
;}
,__mE:function(bI){var bJ=this.__fN;this.__fN=bI;if(bJ!=bI){this.fireNonBubblingEvent(b,qx.event.type.Data,[bI,bJ]);}
;}
,setValue:function(bK){if(bK===null){if(this.__mB){return bK;}
;bK=N;this.__mB=true;}
else {this.__mB=false;if(this.__mA){this._removePlaceholder();}
;}
...
;if(bM.getValue()!=bK){var bN=bM.getValue();bM.setValue(bK);var bL=this.__mB?null:bK;this.__fN=bN;this.__mE(bL);}
;if(this.__mA){this._showPlaceholder();}
;return bK;}
;throw new Error(y+bK);}
,getValue:function(){var bO=this.getContentElement().getValue();return this.__mB?null:bO;}
,resetValue:function(){this.setValue(null);}
,_onChangeContent:function(e){this.__mB=e.getData()===null;this.__mE(e.getData());}
...
;}
;}
,_removePlaceholder:function(){if(this.hasState(O)){this.__mF().setStyle(H,u);this.removeState(O);}
;}
,_syncPlaceholder:function(){if(this.hasState(O)){this.__mF().setStyle(H,ba);}
;}
,__mF:function(){if(this.__mC==null){this.__mC=new qx.html.Label();var bT=qx.theme.manager.Color.getInstance();this.__mC.setStyles({"visibility":u,"zIndex":6,"position":z,"color":bT.resolve(h)});this.getContainerElement().add(this.__mC);}
;return this.__mC;}
...
;}
,"false":null}),_applyPlaceholder:function(bU,bV){if(this.__mA){this.__mF().setValue(bU);if(bU!=null){this.addListener(F,this._removePlaceholder,this);this.addListener(Q,this._showPlaceholder,this);this._showPlaceholder();}
...
;}
},destruct:function(){this.__mC=this.__lw=null;if(qx.core.Environment.get(K)){qx.locale.Manager.getInstance().removeListener(t,this._onChangeLocale,this);}
;if(this.__lw&&this.__lA){this.__lw.removeListenerById(this.__lA);}
;}
});}
)();
...
;qx.html.Element.call(this,s,q,r);this.__mG=p;}
...
;}
,setEnabled:qx.core.Environment.select(f,{"webkit":function(v){this.__mI=v;if(!v){this.setStyles({"userModify":i,"userSelect":c});}
else {this.setStyles({"userModify":null,"userSelect":this.__mH?null:c});}
;}
,"default":function(w){this.setAttribute(j,w===false);}
}),setSelectable:qx.core.Environment.select(f,{"webkit":function(x){this.__mH=x;qx.html.Element.prototype.setSelectable.call(this,this.__mI&&x);}
...
,setWrap:function(C,D){if(this.__mG===a){this._setProperty(d,C,D);}
else {throw new Error(e);}
;return this;}
,getWrap:function(){if(this.__mG===a){return this._getProperty(d);}
else {throw new Error(e);}
;}
}});}
)();
...
(function(){var k="px",j="_applyWrap",i="-1",h="_applyMinimalLineHeight",g="mousewheel",f="autoSize is ignored when the height property is set. ",d="visible",c="y",b="browser.documentmode",a="property instead.",E="_applyAutoSize",D="tabIndex",C='name',B="qx.ui.form.TextArea",A='id',z="If you want to set an initial height, use the minHeight ",y="absolute",x="Boolean",w="Integer",v="input",r="appear",s="mshtml",p="webkit",q="qx.debug",n="textarea",o="width",l="auto",m="engine.name",t="hidden",u="overflowY";qx.Class.define(B,{extend:qx.ui.form.AbstractField,construct:function(F){qx.ui.form.AbstractField.call(this,F);this.initWrap();this.addListener(g,this._onMousewheel,this);}
,properties:{wrap:{check:x,init:true,apply:j},appearance:{refine:true,init:n},singleStep:{check:w,init:20},minimalLineHeight:{check:w,apply:h,init:4},autoSize:{check:x,apply:E,init:false}},members:{__vH:null,__vI:null,__vJ:null,setValue:function(G){G=qx.ui.form.AbstractField.prototype.setValue.call(this,G);this.__vK();return G;}
,_onMousewheel:function(e){var H=this.getContentElement();var scrollY=H.getScrollY();H.scrollToY(scrollY+e.getWheelDelta(c)*this.getSingleStep());var I=H.getScrollY();if(I!=scrollY){e.stop();}
;}
,__vK:function(){if(this.isAutoSize()){var L=this.__vL();if(L){this.__vJ=this.__vJ||this._getAreaHeight();var N=this._getScrolledAreaHeight();if(this.getMaxHeight()){var J=this.getInsets();var K=-J.top+this.getMaxHeight()-J.bottom;if(N>K){this.getContentElement().setStyle(u,l);}
else {this.getContentElement().setStyle(u,t);}
;}
;var M=Math.max(N,this.__vJ);this._setAreaHeight(M);}
else {this.getContentElement().addListenerOnce(r,function(){this.__vK();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(O){if(this._getAreaHeight()!==O){this.__vI=O;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__vO();}
;}
,_getScrolledAreaHeight:function(){var Q=this.__vL();var P=Q.getDomElement();if(P){if(!P.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;if(qx.core.Environment.get(m)==s&&qx.core.Environment.get(b)>=8){P.style.overflow=d;}
;Q.setValue(this.getValue());this.__vN(Q);if(qx.core.Environment.get(m)==s){if(!P.scrollTop){qx.html.Element.flush();}
;return P.scrollTop+this._getTextSize().height;}
;return P.scrollTop;}
;}
,__vL:function(){this.__vH=this.__vH||this.__vM();return this.__vH;}
,__vM:function(){var U,S,R,T;U=this.getContentElement();if(!U.getDomElement()){return;}
;R=qx.bom.Collection.create(U.getDomElement()).clone()[0];T=new qx.html.Input(n);T.useElement(R);S=T;S.setStyles({position:y,top:0,left:-9999,height:0,overflow:t},true);S.removeAttribute(A);S.removeAttribute(C);S.setAttribute(D,i);S.setValue(U.getValue());S.insertBefore(U);this.__vN(S);return S;}
,__vN:function(V){V=V.getDomElement();if(V){V.scrollTop=10000;}
;}
,_createInputElement:function(){return new qx.html.Input(n,{overflowX:l,overflowY:l});}
,_applyWrap:function(W,X){this.getContentElement().setWrap(W);this.__vK();}
,_applyMinimalLineHeight:function(){qx.ui.core.queue.Layout.add(this);}
,_applyAutoSize:function(Y,ba){if(qx.core.Environment.get(q)){this.__vP();}
;if(Y){this.__vK();this.addListener(v,this.__vK,this);this.addListenerOnce(r,function(){this.getContentElement().setStyle(u,t);}
);}
else {this.removeListener(v,this.__vK);this.getContentElement().setStyle(u,l);}
;}
,_applyDimension:function(bb){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(q)){this.__vP();}
;if(bb===this.getMaxHeight()){this.__vK();}
;}
,__vO:function(){var content=this.getContentElement();var bd=content.getDomElement();var bc=content.getStyle(o);content.setStyle(o,parseInt(bc,10)+1000+k,true);if(bd){qx.bom.element.Dimension.getWidth(bd);}
;content.setStyle(o,bc,true);}
,__vP:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(f+z+a);}
;}
,_getContentHint:function(){var be=qx.ui.form.AbstractField.prototype._getContentHint.call(this);be.height=be.height*this.getMinimalLineHeight();be.width=this._getTextSize().width*20;if(this.isAutoSize()){be.height=this.__vI||be.height;}
;return be;}
}});}
)();
...
;}
,properties:{appearance:{refine:true,init:z},orientation:{check:[n,o],init:n,apply:b},maximum:{check:B,apply:f,init:100},position:{check:i,init:0,apply:A,event:y},singleStep:{check:x,init:20},pageStep:{check:x,init:10,apply:a},knobFactor:{check:k,apply:h,nullable:true}},members:{__AL:2,__AM:0,_computeSizeHint:function(){var D=qx.ui.core.Widget.prototype._computeSizeHint.call(this);if(this.getOrientation()===n){this.__AM=D.minWidth;D.minWidth=0;}
else {this.__AM=D.minHeight;D.minHeight=0;}
;return D;}
,renderLayout:function(E,top,F,G){var I=qx.ui.core.Widget.prototype.renderLayout.call(this,E,top,F,G);var H=this.getOrientation()===n;if(this.__AM>=(H?F:G)){this.getChildControl(p).setVisibility(s);this.getChildControl(m).setVisibility(s);}
...
,_onResizeSlider:function(e){var X=this.getChildControl(l).getChildControl(g);var bb=X.getSizeHint();var Y=false;var ba=this.getChildControl(l).getInnerSize();if(this.getOrientation()==o){if(ba.height<bb.minHeight+this.__AL){Y=true;}
;}
else {if(ba.width<bb.minWidth+this.__AL){Y=true;}
;}
;if(Y){X.exclude();}
else {X.show();}
;}
...
,_onMouseDown:function(e){if(this.__AQ){return;}
;var bk=this.__lY;var bi=this.getChildControl(t);var bj=bk?z:B;var bm=bk?e.getDocumentLeft():e.getDocumentTop();var bn=this.__AN=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bj];var bl=this.__AO=qx.bom.element.Location.get(bi.getContainerElement().getDomElement())[bj];if(e.getTarget()===bi){this.__AQ=true;if(!this.__AV){this.__AV=new qx.event.Timer(100);this.__AV.addListener(M,this._fireValue,this);}
;this.__AV.start();this.__AR=bm+bn-bl;bi.addState(I);}
else {this.__AS=true;this.__AT=bm<=bl?-1:1;this.__Ba(e);this._onInterval();if(!this.__iG){this.__iG=new qx.event.Timer(100);this.__iG.addListener(M,this._onInterval,this);}
;this.__iG.start();}
;this.addListener(L,this._onMouseMove);this.capture();e.stopPropagation();}
,_onMouseUp:function(e){if(this.__AQ){this.releaseCapture();delete this.__AQ;this.__AV.stop();this._fireValue();delete this.__AR;this.getChildControl(t).removeState(I);if(e.getType()===D){var bp;var bq;var bo;if(this.__lY){bp=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__AN);bo=qx.bom.element.Location.get(this.getContentElement().getDomElement())[B];bq=e.getDocumentTop()-(bo+this.getChildControl(t).getBounds().top);}
else {bp=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__AN);bo=qx.bom.element.Location.get(this.getContentElement().getDomElement())[z];bq=e.getDocumentLeft()-(bo+this.getChildControl(t).getBounds().left);}
;if(bq<0||bq>this.__AP||bp<0||bp>this.__AP){this.getChildControl(t).removeState(y);}
;}
;}
else if(this.__AS){this.__iG.stop();this.releaseCapture();delete this.__AS;delete this.__AT;delete this.__AU;}
;this.removeListener(L,this._onMouseMove);if(e.getType()===D){e.stopPropagation();}
;}
,_onMouseMove:function(e){if(this.__AQ){var bs=this.__lY?e.getDocumentLeft():e.getDocumentTop();var br=bs-this.__AR;this.slideTo(this._positionToValue(br));}
else if(this.__AS){this.__Ba(e);}
;e.stopPropagation();}
,_onInterval:function(e){var bt=this.getValue()+(this.__AT*this.getPageStep());if(bt<this.getMinimum()){bt=this.getMinimum();}
else if(bt>this.getMaximum()){bt=this.getMaximum();}
;var bu=this.__AT==-1;if((bu&&bt<=this.__AU)||(!bu&&bt>=this.__AU)){bt=this.__AU;}
;this.slideTo(bt);}
,_onUpdate:function(e){var bw=this.getInnerSize();var bx=this.getChildControl(t).getBounds();var bv=this.__lY?O:R;this._updateKnobSize();this.__AY=bw[bv]-bx[bv];this.__AP=bx[bv];this._updateKnobPosition();}
,__lY:false,__AY:0,__Ba:function(e){var by=this.__lY;var bF=by?e.getDocumentLeft():e.getDocumentTop();var bH=this.__AN;var bz=this.__AO;var bJ=this.__AP;var bG=bF-bH;if(bF>=bz){bG-=bJ;}
;var bD=this._positionToValue(bG);var bA=this.getMinimum();var bB=this.getMaximum();if(bD<bA){bD=bA;}
else if(bD>bB){bD=bB;}
else {var bE=this.getValue();var bC=this.getPageStep();var bI=this.__AT<0?q:u;bD=bE+(Math[bI]((bD-bE)/bC)*bC);}
;if(this.__AU==null||(this.__AT==-1&&bD<=this.__AU)||(this.__AT==1&&bD>=this.__AU)){this.__AU=bD;}
;}
,_positionToValue:function(bK){var bL=this.__AY;if(bL==null||bL==0){return 0;}
;var bN=bK/bL;if(bN<0){bN=0;}
else if(bN>1){bN=1;}
;var bM=this.getMaximum()-this.getMinimum();return this.getMinimum()+Math.round(bM*bN);}
,_valueToPosition:function(bO){var bP=this.__AY;if(bP==null){return 0;}
...
;}
;}
,_applyValue:function(ce,cf){if(ce!=null){this._updateKnobPosition();if(this.__AQ){this.__AX=[ce,cf];}
else {this.fireEvent(N,qx.event.type.Data,[ce,cf]);}
;}
else {this.resetValue();}
;}
,_fireValue:function(){if(!this.__AX){return;}
;var cg=this.__AX;this.__AX=null;this.fireEvent(N,qx.event.type.Data,cg);}
...
;if(((new Date).valueOf()-this.__Bc)>1000){this.__Bb=n;}
;this.__Bb+=e.getChar();var K=this.findItemByLabelFuzzy(this.__Bb);if(K){this.setSelection([K]);}
;this.__Bc=(new Date).valueOf();}
...
,this);}
,properties:{appearance:{refine:true,init:w},placeholder:{check:c,nullable:true,apply:u}},events:{"changeValue":g},members:{__zi:null,__zj:null,_applyPlaceholder:function(y,z){this.getChildControl(m).setPlaceholder(y);}
...
,_setPreselectedItem:function(){if(this.__zi){var J=this.__zi.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__zi);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__zi=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(n);var L=M.getSelectionContext();if(L==d||L==i){this.__zi=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__zi=null;}
;}
;}
...
},destruct:function(){if(this.__Ae){this.__Ae.dispose();}
;}
});}
)();
(function(){var n="changeModel",m="mouseup",l="one",k="Enter",j="changeDelegate",h="qx.data.Array",g="changeVisibility",f="qx.ui.form.core.VirtualDropDownList",e="_applySelection",d="changeSelection",a="change",c="Invalid parameter 'target'!",b="list";qx.Class.define(f,{extend:qx.ui.popup.Popup,construct:function(o){qx.core.Assert.assertNotNull(o,c);qx.core.Assert.assertNotUndefined(o,c);qx.core.Assert.assertInterface(o,qx.ui.form.core.AbstractVirtualBox,c);qx.ui.popup.Popup.call(this,new qx.ui.layout.VBox());this._target=o;this._createChildControl(b);this.addListener(g,this.__Aj,this);this.__Ag=new qx.data.Array();this.initSelection(this.__Ag);}
,properties:{autoHide:{refine:true,init:false},keepActive:{refine:true,init:true},selection:{check:h,event:d,apply:e,nullable:false,deferredInit:true}},members:{_target:null,_preselected:null,__Ah:false,__Ai:false,__Ag:null,open:function(){this.placeToWidget(this._target,true);this.show();}
,close:function(){this.hide();}
,setPreselected:function(p){this._preselected=p;this.__Ai=true;var r=this.getChildControl(b).getSelection();var q=new qx.data.Array([p]);this.__Al(q,r);q.dispose();this.__Ai=false;}
...
,_handleKeyboard:function(event){if(this.isVisible()&&event.getKeyIdentifier()===k){this.__Ak();return;}
;var v=event.clone();v.setTarget(this.getChildControl(b));v.setBubbles(false);this.getChildControl(b).dispatchEvent(v);}
,_handleMouse:function(event){this.__Ak();}
,__mQ:function(event){if(this.__Ah){return;}
;var w=this.getSelection();var x=this.getChildControl(b).getSelection();this.__Ai=true;this.__Al(w,x);this.__Ai=false;this.__Ah=true;this.__Al(x,w);this.__Ah=false;}
,_onListChangeSelection:function(event){if(this.__Ai){return;}
;var y=this.getChildControl(b).getSelection();if(this.isVisible()){this.setPreselected(y.getItem(0));}
else {this.__Ah=true;this.__Al(y,this.getSelection());this.__Ah=false;}
;}
,__Aj:function(event){if(this.isVisible()){if(this._preselected==null){var z=this.getSelection();var A=this.getChildControl(b).getSelection();this.__Al(z,A);}
;this.__Am();}
...
,_applySelection:function(B,C){B.addListener(a,this.__mQ,this);if(C!=null){C.removeListener(a,this.__mQ,this);}
;this.__Al(B,this.getChildControl(b).getSelection(B));}
,__Ak:function(){if(this._preselected!=null){var D=this.getSelection();D.splice(0,1,this._preselected);this._preselected=null;this.close();}
;}
,__Al:function(E,F){if(E.equals(F)){return;}
...
;}
,__Am:function(){this.__An();this.__Ao();}
,__An:function(){var J=this._target.getBounds().width;this.setWidth(J);}
,__Ao:function(){var K=this.__Ap();var N=this._target.getMaxListHeight();var L=this.getChildControl(b);var M=L.getPane().getRowConfig().getTotalSize();if(N==null||M<N){N=M;}
;if(N>K){L.setMaxHeight(K);}
else if(N<K){L.setMaxHeight(N);}
;}
,__Ap:function(){var O=this.getLayoutLocation(this._target);var Q=qx.bom.Viewport.getHeight();var R=O.top;var P=Q-O.bottom;return R>P?R:P;}
},destruct:function(){if(this.__Ag){this.__Ag.dispose();}
;}
});}
)();
(function(){var k="scrollY",j="The method 'getItemRight' is not implemented!",i="update",h="scrollX",g="The method 'getItemLeft' is not implemented!",f="The method 'getItemBottom' is not implemented!",d="The method 'getItemTop' is not implemented!",c="pane",b="os.scrollBarOverlayed",a="qx.ui.virtual.core.Scroller";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(l,m,n,o){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__AE=new qx.ui.virtual.core.Pane(l,m,n,o);this.__AE.addListener(i,this._computeScrollbars,this);this.__AE.addListener(h,this._onScrollPaneX,this);this.__AE.addListener(k,this._onScrollPaneY,this);if(qx.core.Environment.get(b)){this._add(this.__AE,{edge:0});}
else {this._add(this.__AE,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__AE:null,getPane:function(){return this.__AE;}
,_createChildControlImpl:function(p,q){if(p==c){return this.__AE;}
...
,_onScrollBarX:function(e){this.__AE.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__AE.setScrollY(e.getData());}
},destruct:function(){this.__AE.dispose();this.__AE=null;}
});}
)();
(function(){var w="qx.ui.virtual.core.Pane",v="resize",u="click",t="__zR",s="scrollX",r="dblclick",q="contextmenu",p="qx.debug",o="cellClick",n="__zY",f="cellContextmenu",m="__zS",j="qx.event.type.Event",c="cellDblclick",b="scrollY",h="__Aa",g="update",k="change",a="qx.event.type.Data",l="qx.ui.virtual.core.CellEvent",d="appear";qx.Class.define(w,{extend:qx.ui.core.Widget,construct:function(x,y,z,A){qx.ui.core.Widget.call(this);this.__zR=new qx.ui.virtual.core.Axis(z,x);this.__zS=new qx.ui.virtual.core.Axis(A,y);this.__zT=0;this.__zU=0;this.__zV=0;this.__zW=0;this.__zX={};this.__gR={};this.__zY=new qx.ui.container.Composite();this.__zY.setUserBounds(0,0,0,0);this._add(this.__zY);this.__Aa=[];this.__zR.addListener(k,this.fullUpdate,this);this.__zS.addListener(k,this.fullUpdate,this);this.addListener(v,this._onResize,this);this.addListenerOnce(d,this._onAppear,this);this.addListener(u,this._onClick,this);this.addListener(r,this._onDblclick,this);this.addListener(q,this._onContextmenu,this);}
,events:{cellClick:l,cellContextmenu:l,cellDblclick:l,update:j,scrollX:a,scrollY:a},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__zR:null,__zS:null,__zT:null,__zU:null,__zV:null,__zW:null,__zX:null,__gR:null,__zY:null,__Aa:null,__Ab:null,__oq:null,__zQ:null,getRowConfig:function(){return this.__zR;}
,getColumnConfig:function(){return this.__zS;}
,getChildren:function(){return [this.__zY];}
,addLayer:function(B){if(qx.core.Environment.get(p)){this.assertInterface(B,qx.ui.virtual.core.ILayer);}
;this.__Aa.push(B);B.setUserBounds(0,0,0,0);this.__zY.add(B);}
,getLayers:function(){return this.__Aa;}
,getVisibleLayers:function(){var C=[];for(var i=0;i<this.__Aa.length;i++){var D=this.__Aa[i];if(D.isVisible()){C.push(D);}
;}
;return C;}
,getScrollMaxX:function(){var E=this.getInnerSize();if(E){return Math.max(0,this.__zS.getTotalSize()-E.width);}
;return 0;}
,getScrollMaxY:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__zR.getTotalSize()-F.height);}
;return 0;}
,setScrollY:function(G){var H=this.getScrollMaxY();if(G<0){G=0;}
else if(G>H){G=H;}
;if(this.__zT!==G){var I=this.__zT;this.__zT=G;this._deferredUpdateScrollPosition();this.fireDataEvent(b,G,I);}
;}
,getScrollY:function(){return this.__zT;}
,setScrollX:function(J){var K=this.getScrollMaxX();if(J<0){J=0;}
else if(J>K){J=K;}
;if(J!==this.__zU){var L=this.__zU;this.__zU=J;this._deferredUpdateScrollPosition();this.fireDataEvent(s,J,L);}
;}
,getScrollX:function(){return this.__zU;}
,getScrollSize:function(){return {width:this.__zS.getTotalSize(),height:this.__zR.getTotalSize()};}
,scrollRowIntoView:function(M){var P=this.getBounds();if(!P){this.addListenerOnce(d,function(){qx.event.Timer.once(function(){this.scrollRowIntoView(M);}
,this,0);}
,this);return;}
;var Q=this.__zR.getItemPosition(M);var O=Q+this.__zR.getItemSize(M);var N=this.getScrollY();if(Q<N){this.setScrollY(Q);}
else if(O>N+P.height){this.setScrollY(O-P.height);}
;}
,scrollColumnIntoView:function(R){var U=this.getBounds();if(!U){this.addListenerOnce(d,function(){qx.event.Timer.once(function(){this.scrollColumnIntoView(R);}
,this,0);}
,this);return;}
;var T=this.__zS.getItemPosition(R);var S=T+this.__zS.getItemSize(R);var V=this.getScrollX();if(T<V){this.setScrollX(T);}
else if(S>V+U.width){this.setScrollX(S-U.width);}
;}
,scrollCellIntoView:function(W,X){var Y=this.getBounds();if(!Y){this.addListenerOnce(d,function(){qx.event.Timer.once(function(){this.scrollCellIntoView(W,X);}
,this,0);}
,this);return;}
;this.scrollColumnIntoView(W);this.scrollRowIntoView(X);}
,getCellAtPosition:function(ba,bb){var bc,bd;var be=this.getContentLocation();if(!be||bb<be.top||bb>=be.bottom||ba<be.left||ba>=be.right){return null;}
;bc=this.__zR.getItemAtPosition(this.getScrollY()+bb-be.top);bd=this.__zS.getItemAtPosition(this.getScrollX()+ba-be.left);if(!bc||!bd){return null;}
;return {row:bc.index,column:bd.index};}
,prefetchX:function(bf,bg,bh,bi){var bj=this.getVisibleLayers();if(bj.length==0){return;}
;var bl=this.getBounds();if(!bl){return;}
;var bm=this.__zU+bl.width;var bn=this.__zW-bm;if(this.__zU-this.__zX.left<Math.min(this.__zU,bf)||this.__zX.right-bm<Math.min(bn,bh)){var bo=Math.min(this.__zU,bg);var bk=Math.min(bn,bi);this._setLayerWindow(bj,this.__zU-bo,this.__zT,bl.width+bo+bk,bl.height,false);}
;}
,prefetchY:function(bp,bq,br,bs){var bt=this.getVisibleLayers();if(bt.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bu=this.__zT+bw.height;var bv=this.__zV-bu;if(this.__zT-this.__zX.top<Math.min(this.__zT,bp)||this.__zX.bottom-bu<Math.min(bv,br)){var by=Math.min(this.__zT,bq);var bx=Math.min(bv,bs);this._setLayerWindow(bt,this.__zU,this.__zT-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContainerElement().getDomElement()){this.__Ab=true;this._updateScrollPosition();this.__Ab=null;this.fireEvent(g);}
;}
,_onAppear:function(){this.fullUpdate();}
,_onClick:function(e){this.__Ac(e,o);}
,_onContextmenu:function(e){this.__Ac(e,f);}
,_onDblclick:function(e){this.__Ac(e,c);}
,__Ac:function(e,bz){var bA=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());if(!bA){return;}
;this.fireNonBubblingEvent(bz,qx.ui.virtual.core.CellEvent,[this,e,bA.row,bA.column]);}
,syncWidget:function(bB){if(this.__gR._fullUpdate){this._fullUpdate();}
else if(this.__gR._updateScrollPosition){this._updateScrollPosition();}
;this.__gR={};}
,_setLayerWindow:function(bC,bD,top,bE,bF,bG){var bL=this.__zR.getItemAtPosition(top);if(bL){var bN=bL.index;var bR=this.__zR.getItemSizes(bN,bF+bL.offset);var bM=qx.lang.Array.sum(bR);var bT=top-bL.offset;var bQ=top-bL.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bT=0;var bQ=0;}
;var bP=this.__zS.getItemAtPosition(bD);if(bP){var bJ=bP.index;var bI=this.__zS.getItemSizes(bJ,bE+bP.offset);var bO=qx.lang.Array.sum(bI);var bS=bD-bP.offset;var bK=bD-bP.offset+bO;}
else {var bJ=0;var bI=[];var bO=0;var bS=0;var bK=0;}
;this.__zX={top:bT,bottom:bQ,left:bS,right:bK};this.__zY.setUserBounds(this.__zX.left-this.__zU,this.__zX.top-this.__zT,bO,bM);this.__oq=bI;this.__zQ=bR;for(var i=0;i<this.__Aa.length;i++){var bH=this.__Aa[i];bH.setUserBounds(0,0,bO,bM);if(bG){bH.fullUpdate(bN,bJ,bR,bI);}
else {bH.updateLayerWindow(bN,bJ,bR,bI);}
;}
;}
,__Ad:function(){if(this.__Ab){return;}
;var bU=this.getScrollSize();if(this.__zV!==bU.height||this.__zW!==bU.width){this.__zV=bU.height;this.__zW=bU.width;this.fireEvent(g);}
;}
,fullUpdate:function(){this.__gR._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__gR._fullUpdate;}
,_fullUpdate:function(){var bV=this.getVisibleLayers();if(bV.length==0){this.__Ad();return;}
;var bW=this.getBounds();if(!bW){return;}
;this._setLayerWindow(bV,this.__zU,this.__zT,bW.width,bW.height,true);this.__Ad();}
,_deferredUpdateScrollPosition:function(){this.__gR._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
,_updateScrollPosition:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__Ad();return;}
;var ca=this.getBounds();if(!ca){return;}
;var bY={top:this.__zT,bottom:this.__zT+ca.height,left:this.__zU,right:this.__zU+ca.width};if(this.__zX.top<=bY.top&&this.__zX.bottom>=bY.bottom&&this.__zX.left<=bY.left&&this.__zX.right>=bY.right){this.__zY.setUserBounds(this.__zX.left-bY.left,this.__zX.top-bY.top,this.__zX.right-this.__zX.left,this.__zX.bottom-this.__zX.top);}
else {this._setLayerWindow(bX,this.__zU,this.__zT,ca.width,ca.height,false);}
;this.__Ad();}
},destruct:function(){this._disposeArray(h);this._disposeObjects(t,m,n);this.__zX=this.__gR=this.__oq=this.__zQ=null;}
});}
)();
...
,events:{"change":f},members:{__AA:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__AA=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__AA=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__AA=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__AA=null;this.fireNonBubblingEvent(c);}
,__AB:function(){if(this.__AA){return this.__AA;}
;var r=this.defaultItemSize;var y=this.itemCount;var t=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<y){t.push(p);}
;}
;if(t.length==0){var u=[{startIndex:0,endIndex:y-1,firstItemSize:r,rangeStart:0,rangeEnd:y*r-1}];this.__AA=u;return u;}
...
;var z=u[u.length-1];var w=(y-z.startIndex-1)*r;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=y-1;this.__AA=u;return u;}
,__AC:function(A){var B=this.__AA||this.__AB();var C=0;var E=B.length-1;while(true){var F=C+((E-C)>>1);var D=B[F];if(D.rangeEnd<A){C=F+1;}
else if(D.rangeStart>A){E=F-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(G){if(G<0||G>=this.getTotalSize()){return null;}
;var I=this.__AC(G);var K=I.rangeStart;var H=I.startIndex;var L=I.firstItemSize;if(K+L>G){return {index:H,offset:G-K};}
else {var J=this.defaultItemSize;return {index:H+1+Math.floor((G-K-L)/J),offset:(G-K-L)%J};}
;}
,__AD:function(M){var N=this.__AA||this.__AB();var O=0;var Q=N.length-1;while(true){var R=O+((Q-O)>>1);var P=N[R];if(P.endIndex<M){O=R+1;}
else if(P.startIndex>M){Q=R-1;}
else {return P;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__AD(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__AA||this.__AB();return U[U.length-1].rangeEnd+1;}
...
;}
;return Y;}
},destruct:function(){this.customSizes=this.__AA=null;}
});}
)();
...
,_onChangeSelection:function(e){if(this.__AF==true){return;}
;this.__Ax=true;var E=this.getSelection();var G=[];for(var i=0;i<E.getLength();i++){var F=E.getItem(i);var H=this._getSelectables();var D=-1;if(H!=null){D=H.indexOf(F);}
...
;this.__Al();if(this._afterApplySelection!=null&&qx.lang.Type.isFunction(this._afterApplySelection)){this._afterApplySelection();}
;this.__Ax=false;}
,_onManagerChangeSelection:function(e){if(this.__Ax==true){return;}
;this.__AF=true;this.__Al();this.__AF=false;}
...
;}
;this.__AG(K);}
,__AG:function(M){var N=this.getSelection();if(M.length>0){var P=[0,N.getLength()];P=P.concat(M);var O=N.splice.apply(N,P);O.dispose();}
else {N.removeAll();}
;}
,__AH:function(){var R=this.getSelection();var T=this._manager.getSelection();if(R.getLength()!==T.length){return false;}
...
;}
},destruct:function(){this._manager.dispose();this._manager=null;if(this.__Ag){this.__Ag.dispose();}
;}
});}
)();
...
(function(){var p="changeModel",o="resize",n="_applyLabelOptions",m="_applyLabelPath",j="_applyGroupLabelOptions",h="filter",g="Integer",f="_applyModel",d="changeGroups",c="Boolean",G="GroupingTypeError: You can't mix 'Objects' and 'Strings' as",F="sorter",E="_applyIconPath",D="_applyDelegate",C="changeDelegate",B=" group identifier!",A="???",z="_applyRowHeight",y="virtual-list",x="_applyGroupLabelPath",v="_applyIconOptions",w="qx.ui.list.List",t="qx.data.Array",u="change",r="row-layer",s="group",q="String";qx.Class.define(w,{extend:qx.ui.virtual.core.Scroller,include:[qx.ui.virtual.selection.MModel],implement:qx.data.controller.ISelection,construct:function(H){qx.ui.virtual.core.Scroller.call(this,0,1,20,100);this._init();this.__zx=new qx.data.Array();this.initGroups(this.__zx);if(H!=null){this.initModel(H);}
;this.initItemHeight();}
,properties:{appearance:{refine:true,init:y},focusable:{refine:true,init:true},width:{refine:true,init:100},height:{refine:true,init:200},model:{check:t,apply:f,event:p,nullable:true,deferredInit:true},itemHeight:{check:g,init:25,apply:z,themeable:true},labelPath:{check:q,apply:m,nullable:true},iconPath:{check:q,apply:E,nullable:true},groupLabelPath:{check:q,apply:x,nullable:true},labelOptions:{apply:n,nullable:true},iconOptions:{apply:v,nullable:true},groupLabelOptions:{apply:j,nullable:true},delegate:{apply:D,event:C,init:null,nullable:true},autoGrouping:{check:c,init:true},groups:{check:t,event:d,nullable:false,deferredInit:true}},members:{_background:null,_provider:null,_layer:null,__zy:null,__zz:null,__zA:null,__zB:false,__zC:false,__zD:false,__zx:null,refresh:function(){this.__zF();}
,_createChildControlImpl:function(I,J){var K;switch(I){case r:K=new qx.ui.virtual.layer.Row(null,null);break;};return K||qx.ui.virtual.core.Scroller.prototype._createChildControlImpl.call(this,I);}
,_init:function(){this._provider=new qx.ui.list.provider.WidgetProvider(this);this.__zy=[];this.__zz=[];this.__zA={};this.__zB=false;this.__zC=false;this.__zD=false;this.getPane().addListener(o,this._onResize,this);this._initBackground();this._initLayer();}
,_initBackground:function(){this._background=this.getChildControl(r);this.getPane().addLayer(this._background);}
...
;}
,_getLookupTable:function(){return this.__zy;}
,_lookup:function(O){return this.__zy[O];}
,_lookupGroup:function(P){return this.__zz.indexOf(P);}
,_reverseLookup:function(Q){if(Q<0){return -1;}
;return this.__zy.indexOf(Q);}
,_isGroup:function(R){return this._lookup(R)==-1;}
,_getSelectables:function(){return this.getModel();}
,_applyModel:function(S,T){if(S!=null){S.addListener(u,this._onModelChange,this);}
;if(T!=null){T.removeListener(u,this._onModelChange,this);}
...
,_applyDelegate:function(bj,bk){this._provider.setDelegate(bj);this.__zF();}
,_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);}
,_onModelChange:function(e){this.__zF();this._applyDefaultSelection();}
,__zE:function(){this.getPane().getRowConfig().setItemCount(this.__zy.length);this.getPane().fullUpdate();}
,__zF:function(){this.__zy=[];this.__zz=[];this.__zA={};if(this.isAutoGrouping()){this.getGroups().removeAll();}
;var bl=this.getModel();if(bl!=null){this._runDelegateFilter(bl);this._runDelegateSorter(bl);this._runDelegateGroup(bl);}
;this._updateSelection();this.__zE();}
,_runDelegateFilter:function(bm){var bn=qx.util.Delegate.getMethod(this.getDelegate(),h);for(var i=0,l=bm.length;i<l;++i){if(bn==null||bn(bm.getItem(i))){this.__zy.push(i);}
;}
;}
,_runDelegateSorter:function(bo){if(this.__zy.length==0){return;}
;var bp=qx.util.Delegate.getMethod(this.getDelegate(),F);if(bp!=null){this.__zy.sort(function(a,b){return bp(bo.getItem(a),bo.getItem(b));}
);}
;}
,_runDelegateGroup:function(bq){var bu=qx.util.Delegate.getMethod(this.getDelegate(),s);if(bu!=null){for(var i=0,l=this.__zy.length;i<l;++i){var br=this.__zy[i];var bt=this.getModel().getItem(br);var bs=bu(bt);this.__zG(bs,br);}
;this.__zy=this.__zH();}
;}
,__zG:function(bv,bw){if(bv==null){this.__zD=true;bv=A;}
;var name=this.__zI(bv);if(this.__zA[name]==null){this.__zA[name]=[];if(this.isAutoGrouping()){this.getGroups().push(bv);}
;}
;this.__zA[name].push(bw);}
,__zH:function(){this.__zJ();var bA=[];var bC=0;var by=this.getGroups();for(var i=0;i<by.getLength();i++){var bx=by.getItem(i);bA.push(-1);this.__zz.push(bC);bC++;var bB=this.__zI(bx);var bz=this.__zA[bB];if(bz!=null){for(var k=0;k<bz.length;k++){bA.push(bz[k]);bC++;}
;}
;}
;return bA;}
,__zI:function(bD){var name=null;if(!qx.lang.Type.isString(bD)){var bE=this.getGroups().indexOf(bD);this.__zC=true;name=s;if(bE==-1){name+=this.getGroups().getLength();}
else {name+=bE;}
;}
else {this.__zB=true;var name=bD;}
;return name;}
,__zJ:function(){if(this.__zC&&this.__zD||this.__zC&&this.__zB){throw new Error(G+B);}
;}
},destruct:function(){this._background.dispose();this._provider.dispose();this._layer.dispose();this._background=this._provider=this._layer=this.__zy=this.__zz=this.__zA=null;if(this.__zx){this.__zx.dispose();}
;}
});}
)();
(function(){var c="qx.ui.virtual.layer.Abstract",b="abstract",a="Abstract method '_fullUpdate' called!";qx.Class.define(c,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__gR={};}
,properties:{anonymous:{refine:true,init:true}},members:{__gR:null,__cx:null,__zO:null,__zP:null,__zQ:null,__oq:null,getFirstRow:function(){return this.__zO;}
...
;if(this.__gR.fullUpdate||this.__gR.updateLayerWindow&&this.__gR.updateLayerData){this._fullUpdate.apply(this,this.__cx);}
else if(this.__gR.updateLayerWindow){this._updateLayerWindow.apply(this,this.__cx);}
else if(this.__gR.updateLayerData&&this.__zQ){this._updateLayerData();}
;;if(this.__gR.fullUpdate||this.__gR.updateLayerWindow){var e=this.__cx;this.__zO=e[0];this.__zP=e[1];this.__zQ=e[2];this.__oq=e[3];}
;this.__gR={};}
,_updateLayerData:function(){this._fullUpdate(this.__zO,this.__zP,this.__zQ,this.__oq);}
,_fullUpdate:function(f,g,h,i){throw new Error(a);}
,_updateLayerWindow:function(j,k,l,m){this._fullUpdate(j,k,l,m);}
,updateLayerData:function(){this.__gR.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(n,o,p,q){this.__cx=arguments;this.__gR.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(r,s,t,u){this.__cx=arguments;this.__gR.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__gR=this.__cx=this.__zQ=this.__oq=null;}
});}
)();
...
;this.__Aq={};this.__Ar={};}
,properties:{colorEven:{nullable:true,check:a,apply:c,themeable:true},colorOdd:{nullable:true,check:a,apply:d,themeable:true}},members:{__As:null,__At:null,__Aq:null,__Ar:null,setColor:function(g,h){if(h){this.__Aq[g]=qx.theme.manager.Color.getInstance().resolve(h);}
else {delete (this.__Aq[g]);}
;}
,clearCustomColors:function(){this.__Aq={};this.updateLayerData();}
,getColor:function(i){var j=this.__Aq[i];if(j){return j;}
else {return i%2==0?this.__As:this.__At;}
;}
,_applyColorEven:function(k,l){if(k){this.__As=qx.theme.manager.Color.getInstance().resolve(k);}
else {this.__As=null;}
;this.updateLayerData();}
,_applyColorOdd:function(m,n){if(m){this.__At=qx.theme.manager.Color.getInstance().resolve(m);}
else {this.__At=null;}
;this.updateLayerData();}
,setBackground:function(o,p){if(p){this.__Ar[o]=qx.theme.manager.Decoration.getInstance().resolve(p);}
else {delete (this.__Ar[o]);}
;this.updateLayerData();}
,getBackground:function(q){return this.__Ar[q];}
},destruct:function(){this.__Aq=this.__Ar=null;}
});}
)();
...
;}
,setColor:function(J,K){qx.ui.virtual.layer.AbstractBackground.prototype.setColor.call(this,J,K);if(this.__AI(J)){this.updateLayerData();}
;}
,setBackground:function(L,M){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,L,M);if(this.__AI(L)){this.updateLayerData();}
;}
,__AI:function(N){var P=this.getFirstRow();var O=P+this.getRowSizes().length-1;return N>=P&&N<=O;}
}});}
)();
...
(function(){var p="model[",o="groups[",n="model",m="changeDelegate",l="label",k="qx.ui.list.core.MWidgetController",j="icon",i="value",h=".",g="",c="]",f="BindingIds",d="group",b="cell.type",a="String";qx.Mixin.define(k,{construct:function(){this.__zK=[];}
,properties:{labelPath:{check:a,nullable:true},iconPath:{check:a,nullable:true},groupLabelPath:{check:a,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},groupLabelOptions:{nullable:true},delegate:{event:m,init:null,nullable:true}},members:{__zK:null,bindDefaultProperties:function(q,r){if(q.getUserData(b)!=d){this.bindProperty(g,n,null,q,r);this.bindProperty(this.getLabelPath(),l,this.getLabelOptions(),q,r);if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),j,this.getIconOptions(),q,r);}
;}
else {this.bindProperty(this.getGroupLabelPath(),i,this.getGroupLabelOptions(),q,r);}
;}
,bindProperty:function(s,t,u,v,w){var y=v.getUserData(b);var x=this.__zL(w,s,y);var z=this._list.bind(x,v,t,u);this.__zM(v,z);}
,bindPropertyReverse:function(A,B,C,D,E){var G=D.getUserData(b);var F=this.__zL(E,A,G);var H=D.bind(B,this._list,F,C);this.__zM(D,H);}
,removeBindings:function(){while(this.__zK.length>0){var I=this.__zK.pop();this._removeBindingsFrom(I);}
;}
...
;}
,_removeBindingsFrom:function(T){var U=this.__zN(T);while(U.length>0){var V=U.pop();try{this._list.removeBinding(V);}
catch(e){T.removeBinding(V);}
;}
;if(qx.lang.Array.contains(this.__zK,T)){qx.lang.Array.remove(this.__zK,T);}
;}
,__zL:function(W,X,Y){var ba=p+W+c;if(Y==d){ba=o+W+c;}
;if(X!=null&&X!=g){ba+=h+X;}
;return ba;}
,__zM:function(bb,bc){var bd=this.__zN(bb);if(!qx.lang.Array.contains(bd,bc)){bd.push(bc);}
;if(!qx.lang.Array.contains(this.__zK,bb)){this.__zK.push(bb);}
;}
,__zN:function(be){var bf=be.getUserData(f);if(bf==null){bf=[];be.setUserData(f,bf);}
;return bf;}
},destruct:function(){this.__zK=null;}
});}
)();
...
,styleSelectabled:function(u){var v=this.__zv(u);this._styleSelectabled(v);}
,styleUnselectabled:function(w){var x=this.__zv(w);this._styleUnselectabled(x);}
...
;}
,_styleSelectabled:function(A){this.__zw(A,{selected:1});}
,_styleUnselectabled:function(B){this.__zw(B,{});}
...
,__zv:function(G){return this._list._layer.getRenderedCellWidget(G,0);}
,__zw:function(H,I){if(H==null){return;}
...
;this._cellProvider=h;this.__Af=[];}
,properties:{anonymous:{refine:true,init:false}},events:{updated:g},members:{__Af:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;var q=this.getRowSizes().length;var p=this.getFirstRow();var o=this.getFirstColumn();if(j<p||j>=p+q||k<o||k>=o+l){return null;}
;var n=(k-o)+(j-p)*l;var m=this._getChildren()[n];if(m.getUserData(a)){return null;}
else {return m;}
;}
,_getSpacer:function(){var r=this.__Af.pop();if(!r){r=new qx.ui.core.Spacer();r.setUserData(a,1);}
;return r;}
...
;}
;}
,_fullUpdate:function(v,w,z,A){var C=this._cellProvider;var G=this._getChildren();for(var i=0;i<G.length;i++){var E=G[i];if(E.getUserData(a)){this.__Af.push(E);}
...
;}
;}
;var U=this._cellProvider;var Y=this._getChildren();for(var i=0;i<Y.length;i++){if(!S[i]){var W=Y[i];if(W.getUserData(a)){this.__Af.push(W);}
...
;this._cellProvider=this.__Af=null;}
});}
)();
...
;}
;h.setUserData(b,i);}
,getCellWidget:function(m,n){var o=this.__Au();this.updateStates(o,n);this.updateData(o,m);return o;}
,pool:function(p){this.__cQ.push(p);}
,_cleanupPool:function(){var q=this.__cQ.pop();while(q){q.destroy();q=this.__cQ.pop();}
;}
,__Au:function(){var r=this.__cQ.pop();if(r==null){r=this._createWidget();this.fireDataEvent(e,r);}
;return r;}
...
(function(){var x="Function",w="",v="virtual-combobox",u="click",t="_applyPlaceholder",s="single",r="converter",q="changeValue",p="qx.ui.form.VirtualComboBox",o="String",f="Enter",n="inner",j="focusout",c="list",b="change",h="select",g="focusin",k="dropdown",a="button",m="value",d="textfield";qx.Class.define(p,{extend:qx.ui.form.core.AbstractVirtualBox,implement:[qx.ui.form.IStringForm],construct:function(y){qx.ui.form.core.AbstractVirtualBox.call(this,y);var z=this._createChildControl(d);this._createChildControl(a);var A=this.getChildControl(k);A.getChildControl(c).setSelectionMode(s);this.__dD=A.getSelection();this.__dD.addListener(b,this.__Ay,this);this.bind(m,z,m);z.bind(m,this,m);this.addListener(g,function(e){z.fireNonBubblingEvent(g,qx.event.type.Focus);}
,this);this.addListener(j,function(e){z.fireNonBubblingEvent(j,qx.event.type.Focus);}
,this);}
,properties:{appearance:{refine:true,init:v},width:{refine:true,init:120},value:{nullable:true,event:q},placeholder:{check:o,nullable:true,apply:t},defaultFormat:{check:x,init:null,nullable:true}},members:{__Av:null,__Aw:null,__dD:null,__Ax:null,getTextSelection:function(){return this.getChildControl(d).getTextSelection();}
,getTextSelectionLength:function(){return this.getChildControl(d).getTextSelectionLength();}
,setTextSelection:function(B,C){this.getChildControl(d).setTextSelection(B,C);}
,clearTextSelection:function(){this.getChildControl(d).clearTextSelection();}
,selectAllText:function(){this.getChildControl(d).selectAllText();}
,resetAllTextSelection:function(){this.clearTextSelection();this.selectAllText();}
,tabFocus:function(){var D=this.getChildControl(d);D.getFocusElement().focus();D.selectAllText();}
,focus:function(){qx.ui.form.core.AbstractVirtualBox.prototype.focus.call(this);this.getChildControl(d).getFocusElement().focus();}
,_createChildControlImpl:function(E,F){var G;switch(E){case d:G=new qx.ui.form.TextField();G.setFocusable(false);G.addState(n);this._add(G,{flex:1});break;case a:G=new qx.ui.form.Button();G.setFocusable(false);G.setKeepActive(true);G.addState(n);this._add(G);break;};return G||qx.ui.form.core.AbstractVirtualBox.prototype._createChildControlImpl.call(this,E,F);}
,_beforeOpen:function(){this.__Az();}
,_handleKeyboard:function(event){var H=this._getAction(event);switch(H){case h:this.setValue(this.getChildControl(d).getValue());break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
,_getAction:function(event){var I=event.getKeyIdentifier();var K=this.getChildControl(k).isVisible();var J=this._isModifierPressed(event);if(!K&&!J&&I===f){return h;}
else {return qx.ui.form.core.AbstractVirtualBox.prototype._getAction.call(this,event);}
;}
,_handleMouse:function(event){qx.ui.form.core.AbstractVirtualBox.prototype._handleMouse.call(this,event);var L=event.getType();if(L!==u){return;}
;var M=event.getTarget();if(M==this.getChildControl(a)){this.toggle();}
else {this.close();}
;}
,__Ay:function(event){if(this.__Ax==true){return;}
;var N=this.__dD.getItem(0);N=this.__br(N);this.setValue(N);}
,_applyPlaceholder:function(O,P){this.getChildControl(d).setPlaceholder(O);}
,__Az:function(){var S=this.getValue();var R=this.getChildControl(k);var Q=R.getSelection();if(this.__br(Q.getItem(0))!==S){this.__Ax=true;Q.removeAll();this.__Ax=false;if(S==null||S==w){return;}
;var W=this.getModel();var V=R.getChildControl(c)._getLookupTable();for(var i=0,l=V.length;i<l;i++){var T=W.getItem(V[i]);var U=this.__br(T);if(U&&U.indexOf(S)==0){R.setPreselected(T);break;}
;}
;}
;}
,__br:function(X){var ba=this.getLabelOptions();var Y=this.getDefaultFormat();var bc=this.getLabelPath();var bb=null;if(bc!=null){bb=qx.data.SingleValueBinding.getValueFromObject(X,bc);}
else if(qx.lang.Type.isString(X)){bb=X;}
;var bd=qx.util.Delegate.getMethod(ba,r);if(bd!=null){bb=bd(bb);}
;if(bb!=null&&Y!=null){bb=Y(qx.lang.String.stripTags(bb));}
;return bb;}
},destruct:function(){var be=this.getChildControl(d);this.removeAllBindings();be.removeAllBindings();this.__dD.removeListener(b,this.__Ay,this);this.__dD=null;}
});}
)();
...
,events:{"changeValue":f},properties:{dateFormat:{check:k,apply:H},placeholder:{check:a,nullable:true,apply:A},appearance:{refine:true,init:B},focusable:{refine:true,init:true},width:{refine:true,init:120}},statics:{__zk:null,__zl:null,getDefaultDateFormatter:function(){var K=qx.locale.Date.getDateFormat(E).toString();if(K==this.__zk){return this.__zl;}
;if(this.__zl){this.__zl.dispose();}
;this.__zl=new qx.util.format.DateFormat(K,qx.locale.Manager.getInstance().getLocale());this.__zk=K;return this.__zl;}
},members:{__zm:null,_forwardStates:{focused:true,invalid:true},_setDefaultDateFormat:function(){this.setDateFormat(qx.ui.form.DateField.getDefaultDateFormatter());}
,_addLocaleChangeLeistener:function(){if(qx.core.Environment.get(l)){this.__zm=qx.locale.Manager.getInstance().addListener(d,function(){this._setDefaultDateFormat();}
,this);}
;}
...
},destruct:function(){if(qx.core.Environment.get(l)){if(this.__zm){qx.locale.Manager.getInstance().removeListenerById(this.__zm);}
;}
;}
});}
)();
(function(){var k="HH:mm",j="HHmmsszz",h="cldr_date_format_",g="HHmm",f="HHmmss",e="This case should never happen.",d="cldr_time_format_",c="HH:mm:ss zz",b="cldr_pm",a="cldr_am",K="qx.locale.Date",J="cldr_date_time_format_",I="HH:mm:ss",H="sat",G="cldr_day_",F="cldr_month_",E="wed",D="fri",C="tue",B="mon",r="sun",s="thu",p="short",q="full",n="long",o="medium",l='_',m="stand-alone",t="narrow",u="abbreviated",w="wide",v='stand-alone',y="qx.debug",x='format',A="format",z="_";qx.Class.define(K,{statics:{__nx:qx.locale.Manager.getInstance(),getAmMarker:function(L){return this.__nx.localize(a,[],L);}
,getPmMarker:function(M){return this.__nx.localize(b,[],M);}
...
;var R=[r,B,C,E,s,D,H];var S=[];for(var i=0;i<R.length;i++){var Q=G+O+z+length+z+R[i];S.push(P?this.__ny(O,O===x?v:x,Q,N):this.__nx.localize(Q,[],N));}
;return S;}
...
;var Y=[r,B,C,E,s,D,H];var X=G+V+z+length+z+Y[T];return W?this.__ny(V,V===x?v:x,X,U):this.__nx.localize(X,[],U);}
...
;var be=[];for(var i=0;i<12;i++){var bd=F+bb+z+length+z+(i+1);be.push(bc?this.__ny(bb,bb===x?v:x,bd,ba):this.__nx.localize(bd,[],ba));}
;return be;}
...
;var bj=F+bh+z+length+z+(bf+1);return bi?this.__ny(bh,bh===x?v:x,bj,bg):this.__nx.localize(bj,[],bg);}
,getDateFormat:function(bk,bl){if(qx.core.Environment.get(y)){qx.core.Assert.assertInArray(bk,[p,o,n,q]);}
;var bm=h+bk;return this.__nx.localize(bm,[],bl);}
,getDateTimeFormat:function(bn,bo,bp){var br=J+bn;var bq=this.__nx.localize(br,[],bp);if(bq==br){bq=bo;}
;return bq;}
,getTimeFormat:function(bs,bt){if(qx.core.Environment.get(y)){qx.core.Assert.assertInArray(bs,[p,o,n,q]);}
;var bv=d+bs;var bu=this.__nx.localize(bv,[],bt);if(bu!=bv){return bu;}
...
else {bK=this.__nx.getTerritory()||this.__nx.getLanguage();}
;return bK.toUpperCase();}
,__ny:function(bL,bM,bN,bO){var bQ=this.__nx.localize(bN,[],bO);if(bQ==bN){var bP=bN.replace(l+bL+l,l+bM+l);return this.__nx.localize(bP,[],bO);}
else {return bQ;}
;}
}});}
)();
...
(function(){var cU='W',cT="qqqq",cS="h",cR="KK",cQ=" is not supported",cP="Z",cO="Date string '",cN="GGGGG",cM=". Wildcard ",cL="LL",bQ="^",bP='4th quarter',bO="SSS",bN="qqq",bM='3rd quarter',bL="K",bK='q',bJ="Provided date is invalid",bI="Error parsing date '",bH='G',dc="a",dd='2nd quarter',da="dd",db="qx.util.format.DateFormat",cX='weekDay',cY="ee",cV="q",cW="QQQQ",de="ww",df="H",cu='Y+',ct='wide',cw="(\\d\\d\\d?)",cv="(GMT[\\+\\-]\\d\\d:\\d\\d)",cy="_applyLocale",cx="Q",cA="c",cz="weekOfMonth",cs="GGG",cr='-',o="w",p="mm",q='h',r="S",s='s',t="QQQ",u="G",v="GG",w="kk",x="ss",du="([\\+\\-]\\d\\d\\d\\d)",dt='H',ds='S',dr='1st quarter',dy='Q1',dx="QQ",dw="HH",dv='k',dA="m",dz="DDD",bh='D',bi="': the value for day or month is too large",bf='K',bg="L",bl="hh",bm="e",bj="W",bk="GGGG",bd='Q2',be="MM",P="y+",O='narrow',R="yyyy-MM-dd HH:mm:ss",Q="' does not match the date format: ",L="short",K='d',N="unkown",M="\\d?",J="k",I="qx.debug",br='m',bs="z",bt="String",bu='Q3',bn='month',bo="DD",bp='isoUtcDateTime',bq="SS",bv="s",bw="M",ba='w',Y="$",X="?",W='Q4',V="qq",U='L',T='abbreviated',S="Y+",bc=":",bb='y',bx="quoted_literal",by="weekOfYear",bz='a',bA="day",bB="(-*",bC="GMT",bD="HH:mm:ss",bE='y+',bF="HHmmss",bG="long",bV="Malformed date format: ",bU='Y',bT='z',bS='BC',ca='c',bY="d",bX="D",bW='e',cd='B',cc='',cn='Before Christ',co='Z',cl=" ",cm="min",cj='M',ck="sec",ch="\\d",ci="+?",cp='E',cq="locale",cE="eeeee",cD="EEEE",cG='Anno Domini',cF="+",cI="eee",cH="ccc",cK="EEEEE",cJ="EE",cC="MMMM",cB='Q',dm="eeee",dn="LLLLL",dp="LLLL",dq="ms",di="(\\d\\d?\\d?)",dj="cccc",dk="dayOfYear",dl='AD',dg="ccccc",dh="E",n="MMM",m="EEE",h="MMMMM",g="LLL",f="quarter",e='A',d="default",c="0",b="literal",a="wildcard",A="'",B="(\\d?)",y="hour",z="abbreviated",E="wide",F="(\\d\\d*?)",C="narrow",D="-",G="stand-alone",H="",ce="format",cb="(\\d\\d?)",cg="(",cf="|",bR=")";qx.Class.define(db,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(dB,dC){qx.core.Object.call(this);if(!dC){this.__hN=qx.locale.Manager.getInstance().getLocale();this.__nd=qx.locale.Manager.getInstance().bind(cq,this,cq);}
else {this.__hN=dC;this.setLocale(dC);}
;this.__ne=this.__hN;if(dB!=null){this.__nf=dB.toString();if(this.__nf in qx.util.format.DateFormat.ISO_MASKS){if(this.__nf===bp){this.__ng=true;}
;this.__nf=qx.util.format.DateFormat.ISO_MASKS[this.__nf];}
;}
else {this.__nf=qx.locale.Date.getDateFormat(bG,this.__hN)+cl+qx.locale.Date.getDateTimeFormat(bF,bD,this.__hN);}
;}
,properties:{locale:{apply:cy,nullable:true,check:bt}},statics:{getDateTimeInstance:function(){var dE=qx.util.format.DateFormat;var dD=qx.locale.Date.getDateFormat(bG)+cl+qx.locale.Date.getDateTimeFormat(bF,bD);if(dE._dateInstance==null||dE._dateInstance.__nf!=dD){dE._dateTimeInstance=new dE();}
;return dE._dateTimeInstance;}
,getDateInstance:function(){var dG=qx.util.format.DateFormat;var dF=qx.locale.Date.getDateFormat(L)+H;if(dG._dateInstance==null||dG._dateInstance.__nf!=dF){dG._dateInstance=new dG(dF);}
;return dG._dateInstance;}
,ASSUME_YEAR_2000_THRESHOLD:30,LOGGING_DATE_TIME__format:R,ISO_MASKS:{isoDate:"yyyy-MM-dd",isoTime:"HH:mm:ss",isoDateTime:"yyyy-MM-dd'T'HH:mm:ss",isoUtcDateTime:"yyyy-MM-dd'T'HH:mm:ss'Z'"},AM_MARKER:"am",PM_MARKER:"pm"},members:{__nd:null,__hN:null,__ne:null,__nf:null,__nh:null,__ni:null,__nj:null,__ng:null,__nk:function(dH,dI){var dJ=H+(dH<0?((-1)*dH):dH);while(dJ.length<dI){dJ=c+dJ;}
;return dH<0?D+dJ:dJ;}
,__nl:function(dK){var dL=new Date(dK.getTime());var dM=dL.getDate();while(dL.getMonth()!=0){dL.setDate(-1);dM+=dL.getDate()+1;}
;return dM;}
,__nm:function(dN){return new Date(dN.getTime()+(3-((dN.getDay()+6)%7))*86400000);}
,__nn:function(dO){var dQ=this.__nm(dO);var dR=dQ.getFullYear();var dP=this.__nm(new Date(dR,0,4));return Math.floor(1.5+(dQ.getTime()-dP.getTime())/86400000/7);}
,__no:function(dS){var dU=this.__nm(dS);var dT=this.__nm(new Date(dS.getFullYear(),dS.getMonth(),4));return Math.floor(1.5+(dU.getTime()-dT.getTime())/86400000/7);}
,__np:function(dV){var dW=this.__nm(dV);return dW.getFullYear();}
,__nq:function(dX){var dY=new Date(dX,2,1);dY.setDate(-1);return dY.getDate()+1===29;}
,__nr:function(ea,eb){var ef=0;var eg=0;if(!eb){eb=1971;}
...
,__ns:function(eh,ei,ej){var ek;switch(ei){case 11:ek=eh-1;if(eh!=this.__np(new Date(ek,ei,ej))){ek=eh;}
;break;case 0:ek=eh+1;if(eh!=this.__np(new Date(ek,ei,ej))){ek=eh;}
;break;default:ek=eh;};return ek;}
,_applyLocale:function(el,em){this.__hN=el===null?this.setLocale(this.__ne):el;}
,format:function(en){if(en==null){return null;}
;if(isNaN(en.getTime())){if(qx.core.Environment.get(I)){qx.log.Logger.error(bJ);}
;return null;}
;if(this.__ng){en=new Date(en.getUTCFullYear(),en.getUTCMonth(),en.getUTCDate(),en.getUTCHours(),en.getUTCMinutes(),en.getUTCSeconds(),en.getUTCMilliseconds());}
;var eq=this.__hN;var ev=en.getFullYear();var er=en.getMonth();var eu=en.getDate();var ey=en.getDay();var eB=en.getHours();var eH=en.getMinutes();var ez=en.getSeconds();var eF=en.getMilliseconds();var ex=en.getTimezoneOffset();var eC=ex>0?1:-1;var eo=Math.floor(Math.abs(ex)/60);var eE=Math.abs(ex)%60;this.__nt();var eG=H;for(var i=0;i<this.__nj.length;i++){var ew=this.__nj[i];if(ew.type==b){eG+=ew.text;}
else {var ep=ew.character;var eA=ew.size;var eI=X;switch(ep){case bb:if(eA==2){eI=this.__nk(ev%100,2);}
else {var es=Math.abs(ev);eI=es+H;if(eA>eI.length){for(var j=eI.length;j<eA;j++){eI=c+eI;}
;}
;if(ev<0){eI=D+eI;}
;}
;break;case bU:eI=this.__np(en)+H;var es=eI.replace(cr,cc);if(eA>eI.length){for(var j=es.length;j<eA;j++){es=c+es;}
;}
;eI=eI.indexOf(D)!=-1?D+es:es;break;case bH:if(eA>=1&&eA<=3){eI=ev>0?dl:bS;}
else if(eA==4){eI=ev>0?cG:cn;}
else if(eA==5){eI=ev>0?e:cd;}
;;break;case cB:if(eA==1||eA==2){eI=this.__nk(parseInt(er/4)+1,eA);}
;if(eA==3){eI=cB+(parseInt(er/4)+1);}
;break;case bK:if(eA==1||eA==2){eI=this.__nk(parseInt(er/4)+1,eA);}
;if(eA==3){eI=cB+(parseInt(er/4)+1);}
;break;case bh:eI=this.__nk(this.__nl(en),eA);break;case K:eI=this.__nk(eu,eA);break;case ba:eI=this.__nk(this.__nn(en),eA);break;case cU:eI=this.__no(en);break;case cp:if(eA>=1&&eA<=3){eI=qx.locale.Date.getDayName(z,ey,eq,ce,true);}
else if(eA==4){eI=qx.locale.Date.getDayName(E,ey,eq,ce,true);}
else if(eA==5){eI=qx.locale.Date.getDayName(C,ey,eq,ce,true);}
;;break;case bW:var et=qx.locale.Date.getWeekStart(eq);var eD=1+((ey-et>=0)?(ey-et):7+(ey-et));if(eA>=1&&eA<=2){eI=this.__nk(eD,eA);}
...
;;;break;case cj:if(eA==1||eA==2){eI=this.__nk(er+1,eA);}
...
;;;break;case U:if(eA==1||eA==2){eI=this.__nk(er+1,eA);}
...
;;;break;case bz:eI=(eB<12)?qx.locale.Date.getAmMarker(eq):qx.locale.Date.getPmMarker(eq);break;case dt:eI=this.__nk(eB,eA);break;case dv:eI=this.__nk((eB==0)?24:eB,eA);break;case bf:eI=this.__nk(eB%12,eA);break;case q:eI=this.__nk(((eB%12)==0)?12:(eB%12),eA);break;case br:eI=this.__nk(eH,eA);break;case s:eI=this.__nk(ez,eA);break;case ds:eI=this.__nk(eF,3);if(eA<eI.length){eI=eI.substr(0,eA);}
else {while(eA>eI.length){eI+=c;}
;}
;break;case bT:if(eA>=1&&eA<=4){eI=bC+((eC>0)?D:cF)+this.__nk(Math.abs(eo),2)+bc+this.__nk(eE,2);}
;break;case co:if(eA>=1&&eA<=3){eI=((eC>0)?D:cF)+this.__nk(Math.abs(eo),2)+this.__nk(eE,2);}
else {eI=bC+((eC>0)?D:cF)+this.__nk(Math.abs(eo),2)+bc+this.__nk(eE,2);}
;break;};eG+=eI;}
;}
;return eG;}
,parse:function(eJ){this.__nu();var eS=this.__nh.regex.exec(eJ);if(eS==null){throw new Error(cO+eJ+Q+this.__nf);}
;var eK={era:1,year:1970,quarter:1,month:0,day:1,dayOfYear:1,hour:0,ispm:false,weekDay:4,weekYear:1970,weekOfMonth:1,weekOfYear:1,min:0,sec:0,ms:0};var eM=1;var eL=false;var eN=false;for(var i=0;i<this.__nh.usedRules.length;i++){var eO=this.__nh.usedRules[i];var eP=eS[eM];if(eO.field!=null){eK[eO.field]=parseInt(eP,10);}
else {eO.manipulator(eK,eP,eO.pattern);}
;if(eO.pattern==S){var eQ=false;for(var k=0;k<this.__nh.usedRules.length;k++){if(this.__nh.usedRules[k].pattern==bE){eQ=true;break;}
;}
;if(!eQ){eL=true;}
;}
;if(eO.pattern.indexOf(bX)!=-1){var eU=false;for(var k=0;k<this.__nh.usedRules.length;k++){if(this.__nh.usedRules[k].pattern.indexOf(bY)!=-1){eU=true;break;}
;}
;if(!eU){eN=true;}
;}
;eM+=(eO.groups==null)?1:eO.groups;}
;if(eL){eK.year=this.__ns(eK.weekYear,eK.month,eK.day);}
;if(eN){var eT=this.__nr(eK.dayOfYear,eK.year);eK.month=eT.month;eK.day=eT.day;}
;if(eK.era<0&&(eK.year*eK.era<0)){eK.year=eK.year*eK.era;}
;var eR=new Date(eK.year,eK.month,eK.day,(eK.ispm)?(eK.hour+12):eK.hour,eK.min,eK.sec,eK.ms);if(this.__ng){eR=new Date(eR.getUTCFullYear(),eR.getUTCMonth(),eR.getUTCDate(),eR.getUTCHours(),eR.getUTCMinutes(),eR.getUTCSeconds(),eR.getUTCMilliseconds());}
;if(eK.month!=eR.getMonth()||eK.year!=eR.getFullYear()){throw new Error(bI+eJ+bi);}
;return eR;}
,__nt:function(){if(this.__nj!=null){return;}
;this.__nj=[];var fa;var eX=0;var fc=H;var eV=this.__nf;var eY=d;var i=0;while(i<eV.length){var fb=eV.charAt(i);switch(eY){case bx:if(fb==A){if(i+1>=eV.length){i++;break;}
;var eW=eV.charAt(i+1);if(eW==A){fc+=fb;i++;}
else {i++;eY=N;}
;}
else {fc+=fb;i++;}
;break;case a:if(fb==fa){eX++;i++;}
else {this.__nj.push({type:a,character:fa,size:eX});fa=null;eX=0;eY=d;}
;break;default:if((fb>=bz&&fb<=bT)||(fb>=e&&fb<=co)){fa=fb;eY=a;}
else if(fb==A){if(i+1>=eV.length){fc+=fb;i++;break;}
;var eW=eV.charAt(i+1);if(eW==A){fc+=fb;i++;}
;i++;eY=bx;}
else {eY=d;}
;if(eY!=d){if(fc.length>0){this.__nj.push({type:b,text:fc});fc=H;}
;}
else {fc+=fb;i++;}
;break;};}
;if(fa!=null){this.__nj.push({type:a,character:fa,size:eX});}
else if(fc.length>0){this.__nj.push({type:b,text:fc});}
;}
,__nu:function(){if(this.__nh!=null){return;}
;var fg=this.__nf;this.__nw();this.__nt();var fm=[];var fi=bQ;for(var fe=0;fe<this.__nj.length;fe++){var fn=this.__nj[fe];if(fn.type==b){fi+=qx.lang.String.escapeRegexpChars(fn.text);}
else {var ff=fn.character;var fj=fn.size;var fh;for(var fo=0;fo<this.__ni.length;fo++){var fk=this.__ni[fo];if(this.__nv(fk,ff,fj)){fh=fk;break;}
;}
...
;this.__nh={regex:fd,"usedRules":fm,pattern:fi};}
,__nv:function(fq,fr,fs){if(fr===bb&&fq.pattern===bE){fq.regex=fq.regexFunc(fs);return true;}
else if(fr===bU&&fq.pattern===cu){fq.regex=fq.regexFunc(fs);return true;}
else {return fr==fq.pattern.charAt(0)&&fs==fq.pattern.length;}
;}
,__nw:function(){var fG=qx.util.format.DateFormat;var fI=qx.lang.String;if(this.__ni!=null){return;}
;var fH=this.__ni=[];var fC=qx.locale.Date.getAmMarker(this.__hN).toString()||fG.AM_MARKER;var fP=qx.locale.Date.getPmMarker(this.__hN).toString()||fG.PM_MARKER;var fu=this.__hN;var fz=function(fT,fU){fU=parseInt(fU,10);if(fU>0){if(fU<fG.ASSUME_YEAR_2000_THRESHOLD){fU+=2000;}
...
},destruct:function(){if(this.__nd!=null){qx.locale.Manager.getInstance().removeBinding(this.__nd);}
;this.__nj=this.__nh=this.__ni=null;}
});}
)();
...
else {var bv=(bs==null)?-1:bs.getDate();for(var i=0;i<6*7;i++){var bu=this.__zg[i];if(bu.hasState(v)){if(bu.hasState(J)){bu.removeState(J);}
;}
...
(function(){var i=" array contains ",h="qx.ui.core.MSingleSelectionHandling",g="__dz",f=" items!",d="changeSelection",c="changeSelected",b="Could only select one item, but the selection",a="qx.event.type.Data";qx.Mixin.define(h,{events:{"changeSelection":a},members:{__dz:null,getSelection:function(){var j=this.__mJ().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__mJ().setSelected(k[0]);break;default:throw new Error(b+i+k.length+f);};}
,resetSelection:function(){this.__mJ().resetSelected();}
,isSelected:function(l){return this.__mJ().isSelected(l);}
,isSelectionEmpty:function(){return this.__mJ().isSelectionEmpty();}
,getSelectables:function(m){return this.__mJ().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(d,o,n);}
,__mJ:function(){if(this.__dz==null){var p=this;this.__dz=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
,isItemSelectable:function(q){if(p._isItemSelectable){return p._isItemSelectable(q);}
else {return q.isVisible();}
;}
});this.__dz.addListener(c,this._onChangeSelected,this);}
;this.__dz.setAllowEmptySelection(this._isAllowEmptySelection());return this.__dz;}
},destruct:function(){this._disposeObjects(g);}
});}
)();
(function(){var o=", because it is not a child element!",n="Boolean",m="qx.ui.core.SingleSelectionManager",l="qx.debug",k="__mK",j="Invalid selectionProvider!",h="Could not check if ",g=" is selected,",f="Could not select ",e="__mL",b="changeSelected",d=" because it is not a child element!",c="__mM",a="qx.event.type.Data";qx.Class.define(m,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(l)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,j);}
;this.__mK=p;}
,events:{"changeSelected":a},properties:{allowEmptySelection:{check:n,init:true,apply:c}},members:{__mL:null,__mK:null,getSelected:function(){return this.__mL;}
,setSelected:function(q){if(!this.__mO(q)){throw new Error(f+q+o);}
;this.__mN(q);}
,resetSelected:function(){this.__mN(null);}
,isSelected:function(r){if(!this.__mO(r)){throw new Error(h+r+g+d);}
;return this.__mL===r;}
,isSelectionEmpty:function(){return this.__mL==null;}
,getSelectables:function(s){var t=this.__mK.getItems();var u=[];for(var i=0;i<t.length;i++){if(this.__mK.isItemSelectable(t[i])){u.push(t[i]);}
;}
;if(!s){for(var i=u.length-1;i>=0;i--){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__mM:function(v,w){if(!v){this.__mN(this.__mL);}
;}
,__mN:function(x){var A=this.__mL;var z=x;if(z!=null&&A===z){return;}
;if(!this.isAllowEmptySelection()&&z==null){var y=this.getSelectables(true)[0];if(y){z=y;}
;}
;this.__mL=z;this.fireDataEvent(b,z,A);}
,__mO:function(B){var C=this.__mK.getItems();for(var i=0;i<C.length;i++){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__mK.toHashCode){this._disposeObjects(k);}
else {this.__mK=null;}
...
,__mQ:function(e){var E=e.getData()[0];var D=this.getChildControl(l);if(D.getSelection()[0]!=E){if(E){D.setSelection([E]);}
else {D.resetSelection();}
;}
;this.__AJ();this.__AK();}
,__AJ:function(){var G=this.getChildControl("list").getSelection()[0];var H=this.getChildControl("atom");var F=G?G.getIcon():"";F==null?H.resetIcon():H.setIcon(F);}
,__AK:function(){var K=this.getChildControl("list").getSelection()[0];var L=this.getChildControl("atom");var J=K?K.getLabel():"";var I=this.getFormat();if(I!=null){J=I.call(this,K);}
;if(J&&J.translate){J=J.translate();}
...
,_onKeyPress:function(e){var R=e.getKeyIdentifier();if(R==k||R==h){if(this.__zi){this.setSelection([this.__zi]);this.__zi=null;}
;this.toggle();}
...
,_onListMouseDown:function(e){if(this.__zi){this.setSelection([this.__zi]);this.__zi=null;}
;}
,_onListChangeSelection:function(e){var T=e.getData();var W=e.getOldData();if(W&&W.length>0){W[0].removeListener(s,this.__AJ,this);W[0].removeListener(t,this.__AK,this);}
;if(T.length>0){var V=this.getChildControl(n);var U=this.getChildControl(l);var X=U.getSelectionContext();if(V.isVisible()&&(X==w||X==g)){this.__zi=T[0];}
else {this.setSelection([T[0]]);this.__zi=null;}
;T[0].addListener(s,this.__AJ,this);T[0].addListener(t,this.__AK,this);}
...
(function(){var k="Enter",j="qx.data.Array",h="mouseout",g="open",f="list",e="qx.ui.form.VirtualSelectBox",d="changeSelection",c="_applySelection",b="icon",a="mouseover",C="converter",B="click",A="model",z="label",y=" ",x="virtual-selectbox",w="hovered",v="Space",u="interval",t="arrow",r="search",s="spacer",p="pressed",q="abandoned",n="selection",o="atom",l="dropdown",m="";qx.Class.define(e,{extend:qx.ui.form.core.AbstractVirtualBox,implement:qx.data.controller.ISelection,construct:function(D){qx.ui.form.core.AbstractVirtualBox.call(this,D);this._createChildControl(o);this._createChildControl(s);this._createChildControl(t);this.addListener(a,this._onMouseOver,this);this.addListener(h,this._onMouseOut,this);this.__bg=[];this.initSelection(this.getChildControl(l).getSelection());this.__uU=new qx.event.Timer(500);this.__uU.addListener(u,this.__uW,this);}
,properties:{appearance:{refine:true,init:x},width:{refine:true,init:120},selection:{check:j,event:d,apply:c,nullable:false,deferredInit:true}},members:{__uV:m,__uU:null,__bg:null,syncWidget:function(E){this._removeBindings();this._addBindings();}
,_createChildControlImpl:function(F,G){var H;switch(F){case s:H=new qx.ui.core.Spacer();this._add(H,{flex:1});break;case o:H=new qx.ui.form.ListItem(m);H.setCenter(false);H.setAnonymous(true);this._add(H,{flex:1});break;case t:H=new qx.ui.basic.Image();H.setAnonymous(true);this._add(H);break;};return H||qx.ui.form.core.AbstractVirtualBox.prototype._createChildControlImpl.call(this,F,G);}
,_getAction:function(event){var I=event.getKeyIdentifier();var K=this.getChildControl(l).isVisible();var J=this._isModifierPressed(event);if(!K&&!J&&(I===k||I===v)){return g;}
else if(K&&event.isPrintable()){return r;}
else {return qx.ui.form.core.AbstractVirtualBox.prototype._getAction.call(this,event);}
;}
,_addBindings:function(){var P=this.getChildControl(o);var L=this._getBindPath(n,m);var N=this.bind(L,P,A,null);this.__bg.push(N);var O=this._getBindPath(n,this.getLabelPath());N=this.bind(O,P,z,this.getLabelOptions());this.__bg.push(N);if(this.getIconPath()!=null){var M=this._getBindPath(n,this.getIconPath());N=this.bind(M,P,b,this.getIconOptions());this.__bg.push(N);}
;}
,_removeBindings:function(){while(this.__bg.length>0){var Q=this.__bg.pop();this.removeBinding(Q);}
;}
,_handleMouse:function(event){qx.ui.form.core.AbstractVirtualBox.prototype._handleMouse.call(this,event);var R=event.getType();if(R===B){this.toggle();}
;}
,_handleKeyboard:function(event){var S=this._getAction(event);switch(S){case r:this.__uV+=this.__uX(event.getKeyIdentifier());this.__uU.restart();break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
,_onMouseOver:function(event){if(!this.isEnabled()||event.getTarget()!==this){return;}
;if(this.hasState(q)){this.removeState(q);this.addState(p);}
;this.addState(w);}
,_onMouseOut:function(event){if(!this.isEnabled()||event.getTarget()!==this){return;}
;this.removeState(w);if(this.hasState(p)){this.removeState(p);this.addState(q);}
;}
,_applySelection:function(T,U){this.getChildControl(l).setSelection(T);qx.ui.core.queue.Widget.add(this);}
,__uW:function(){this.__uU.stop();var Y=this.__uV;if(Y==null||Y==m){return;}
;var bf=this.getModel();var ba=this.getChildControl(l).getChildControl(f);var W=ba.getSelection();var length=ba._getLookupTable().length;var bb=bf.indexOf(W.getItem(0));var bd=ba._reverseLookup(bb);for(var i=1;i<=length;i++){var bg=(i+bd)%length;var be=bf.getItem(ba._lookup(bg));var bc=be;if(this.getLabelPath()!=null){bc=qx.data.SingleValueBinding.getValueFromObject(be,this.getLabelPath());var V=this.getLabelOptions();if(V!=null){var X=qx.util.Delegate.getMethod(V,C);if(X!=null){bc=X(bc,be);}
;}
;}
;if(qx.lang.String.startsWith(bc.toLowerCase(),Y.toLowerCase())){W.push(be);break;}
;}
;this.__uV=m;}
,__uX:function(bh){if(bh===v){return y;}
else {return bh;}
;}
},destruct:function(){this._removeBindings();this.__uU.removeListener(u,this.__uW,this);this.__uU.dispose();this.__uU==null;}
});}
)();
(function(){var n="_applyValid",m="",l="changeRequired",k="changeValid",j="_applyInvalidMessage",h="__qO",g="qx.ui.form.RadioButtonGroup",f="qx.event.type.Data",d="Boolean",c="changeInvalidMessage",a="changeSelection",b="String";qx.Class.define(g,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__qO=new qx.ui.form.RadioGroup();this.__qO.addListener(a,function(e){this.fireDataEvent(a,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:d,init:true,apply:n,event:k},required:{check:d,init:false,event:l},invalidMessage:{check:b,init:m,event:c,apply:j},requiredInvalidMessage:{check:b,nullable:true,event:c}},events:{"changeSelection":f},members:{__qO:null,_applyInvalidMessage:function(p,q){var r=this._getChildren();for(var i=0;i<r.length;i++){r[i].setInvalidMessage(p);}
;}
,_applyValid:function(s,t){var u=this._getChildren();for(var i=0;i<u.length;i++){u[i].setValid(s);}
;}
,getRadioGroup:function(){return this.__qO;}
,getChildren:function(){return this._getChildren();}
,add:function(v,w){this.__qO.add(v);this._add(v,w);}
,remove:function(x){this.__qO.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__qO.getItems();for(var i=0;i<y.length;i++){this.__qO.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__qO.getSelection();}
,setSelection:function(z){return this.__qO.setSelection(z);}
,resetSelection:function(){return this.__qO.resetSelection();}
,isSelected:function(A){return this.__qO.isSelected(A);}
,isSelectionEmpty:function(){return this.__qO.isSelectionEmpty();}
,getSelectables:function(B){return this.__qO.getSelectables(B);}
},destruct:function(){this._disposeObjects(h);}
});}
)();
(function(){var r="_applyAllowEmptySelection",q="_applyInvalidMessage",p="qx.ui.form.RadioGroup",o="_applyValid",n="",m="changeRequired",k="changeValid",j="changeEnabled",h="__mP",g="changeSelection",c="_applyEnabled",f="changeInvalidMessage",d="changeValue",b="String",a="Boolean";qx.Class.define(p,{extend:qx.core.Object,implement:[qx.ui.core.ISingleSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MSingleSelectionHandling,qx.ui.form.MModelSelection],construct:function(s){qx.core.Object.call(this);this.__mP=[];this.addListener(g,this.__mQ,this);if(s!=null){this.add.apply(this,arguments);}
;}
,properties:{enabled:{check:a,apply:c,event:j,init:true},wrap:{check:a,init:true},allowEmptySelection:{check:a,init:false,apply:r},valid:{check:a,init:true,apply:o,event:k},required:{check:a,init:false,event:m},invalidMessage:{check:b,init:n,event:f,apply:q},requiredInvalidMessage:{check:b,nullable:true,event:f}},members:{__mP:null,getItems:function(){return this.__mP;}
,add:function(t){var u=this.__mP;var v;for(var i=0,l=arguments.length;i<l;i++){v=arguments[i];if(qx.lang.Array.contains(u,v)){continue;}
...
;}
,remove:function(w){var x=this.__mP;if(qx.lang.Array.contains(x,w)){qx.lang.Array.remove(x,w);if(w.getGroup()===this){w.resetGroup();}
;w.removeListener(d,this._onItemChangeChecked,this);if(w.getValue()){this.resetSelection();}
;}
;}
,getChildren:function(){return this.__mP;}
...
;}
,_applyInvalidMessage:function(z,A){for(var i=0;i<this.__mP.length;i++){this.__mP[i].setInvalidMessage(z);}
;}
,_applyValid:function(B,C){for(var i=0;i<this.__mP.length;i++){this.__mP[i].setValid(B);}
;}
,_applyEnabled:function(D,E){var F=this.__mP;if(D==null){for(var i=0,l=F.length;i<l;i++){F[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var I=this.getSelection()[0];var K=this.__mP;var J=K.indexOf(I);if(J==-1){return;}
...
,selectPrevious:function(){var L=this.getSelection()[0];var N=this.__mP;var M=N.indexOf(L);if(M==-1){return;}
...
,_isItemSelectable:function(O){return this.__mP.indexOf(O)!=-1;}
,__mQ:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
...
(function(){var w="__nz",v="blur",u="Enter",t="__og",s="__oh",r="Up",q="Escape",p="event.touch",o="qx.ui.menu.Manager",n="Left",f="Down",m="Right",j="singleton",c="Space",b="Object is no menu: ",h="qx.debug",g="interval",k="keydown",a="mousedown",l="keyup",d="keypress";qx.Class.define(o,{type:j,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__nz=[];var x=document.body;var y=qx.event.Registration;y.addListener(window.document.documentElement,a,this._onMouseDown,this,true);y.addListener(x,k,this._onKeyUpDown,this,true);y.addListener(x,l,this._onKeyUpDown,this,true);y.addListener(x,d,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,v,this.hideAll,this);}
;this.__og=new qx.event.Timer;this.__og.addListener(g,this._onOpenInterval,this);this.__oh=new qx.event.Timer;this.__oh.addListener(g,this._onCloseInterval,this);}
,members:{__oi:null,__oj:null,__og:null,__oh:null,__nz:null,_getChild:function(z,A,B,C){var D=z.getChildren();var length=D.length;var E;for(var i=A;i<length&&i>=0;i+=B){E=D[i];if(E.isEnabled()&&!E.isAnonymous()&&E.isVisible()){return E;}
;}
...
;}
;var I=this.__nz;I.push(H);H.setZIndex(1e6+I.length);}
,remove:function(J){if(qx.core.Environment.get(h)){if(!(J instanceof qx.ui.menu.Menu)){throw new Error(b+J);}
;}
;var K=this.__nz;if(K){qx.lang.Array.remove(K,J);}
;}
,hideAll:function(){var L=this.__nz;if(L){for(var i=L.length-1;i>=0;i--){L[i].exclude();}
;}
;}
,getActiveMenu:function(){var M=this.__nz;return M.length>0?M[M.length-1]:null;}
,scheduleOpen:function(N){this.cancelClose(N);if(N.isVisible()){if(this.__oi){this.cancelOpen(this.__oi);}
;}
else if(this.__oi!=N){this.__oi=N;this.__og.restartWith(N.getOpenInterval());}
;}
,scheduleClose:function(O){this.cancelOpen(O);if(!O.isVisible()){if(this.__oj){this.cancelClose(this.__oj);}
;}
else if(this.__oj!=O){this.__oj=O;this.__oh.restartWith(O.getCloseInterval());}
;}
,cancelOpen:function(P){if(this.__oi==P){this.__og.stop();this.__oi=null;}
;}
,cancelClose:function(Q){if(this.__oj==Q){this.__oh.stop();this.__oj=null;}
;}
,_onOpenInterval:function(e){this.__og.stop();this.__oi.open();this.__oi=null;}
,_onCloseInterval:function(e){this.__oh.stop();this.__oj.exclude();this.__oj=null;}
...
;if(this.__nz.length>0&&!this._isInMenu(R)){this.hideAll();}
;}
,__ok:{"Enter":1,"Space":1},__ln:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var S=this.getActiveMenu();if(!S){return;}
;var T=e.getKeyIdentifier();if(this.__ln[T]||(this.__ok[T]&&S.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var U=this.getActiveMenu();if(!U){return;}
;var V=e.getKeyIdentifier();var X=this.__ln[V];var W=this.__ok[V];if(X){switch(V){case r:this._onKeyPressUp(U);break;case f:this._onKeyPressDown(U);break;case n:this._onKeyPressLeft(U);break;case m:this._onKeyPressRight(U);break;case q:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
...
;this.__oo();}
,__oo:function(){if(this.isVisible()){if(this.getBlockBackground()){var T=this.getZIndex();this._blocker.blockContent(T-1);}
;}
...
,__op:function(){var bl=this._getMenuBounds();if(!bl){this.addListenerOnce(o,this.__op,this);return;}
...
;this.__on=bn;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bo){this.getChildControl(m);if(this.__on){this.__on.call(this);delete this.__on;}
;}
...
;;this.__op();}
;}
,_onMouseOver:function(e){var br=qx.ui.menu.Manager.getInstance();br.cancelClose(this);var bs=e.getTarget();if(bs.isEnabled()&&bs instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bs);var bq=bs.getMenu&&bs.getMenu();if(bq){bq.setOpener(bs);br.scheduleOpen(bq);this.__om=bq;}
else {var bt=this.getOpenedButton();if(bt){br.scheduleClose(bt.getMenu());}
;if(this.__om){br.cancelOpen(this.__om);this.__om=null;}
;}
;}
...
;if(this.__om){bu.cancelOpen(this.__om);}
;}
;}
...
(function(){var c="qx.ui.menu.Layout",b="Integer",a="_applyLayoutChange";qx.Class.define(c,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:a},spanColumn:{check:b,init:1,nullable:true,apply:a},iconColumnWidth:{check:b,init:0,themeable:true,apply:a},arrowColumnWidth:{check:b,init:0,themeable:true,apply:a}},members:{__oq:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,j;var e=this.getSpanColumn();var h=this.__oq=[0,0,0,0];var m=this.getColumnSpacing();var k=0;var f=0;for(var i=0,l=q.length;i<l;i++){o=q[i];if(o.isAnonymous()){continue;}
...
;var u=this.__or(w[0]);var x=u.getColumnSizes();var r=u.getSpacingX();var q=qx.lang.Array.sum(x)+r*(x.length-1);if(q<k){x[1]+=k-q;}
...
;}
;}
,__or:function(z){while(!(z instanceof qx.ui.menu.Menu)){z=z.getLayoutParent();}
;return z;}
...
;var N=L.getMarginLeft()+L.getMarginRight();N=Math.max(N,this.getSpacing());var I=L.getSizeHint().width+N;this.__oz(L);D-=I;if(E&&E.getVisibility()!=o){E.setVisibility(o);D+=K;var G=E.getMarginLeft()+E.getMarginRight();D+=Math.max(G,this.getSpacing());}
;}
while(D>C);}
else if(this.__ow.length>0){do {var O=this.__ow[0];if(O){var N=O.getMarginLeft()+O.getMarginRight();N=Math.max(N,this.getSpacing());if(O.getDecoratorElement()==null){O.syncAppearance();O.invalidateLayoutCache();}
;var H=O.getSizeHint().width;var M=false;if(this.__ow.length==1&&K>0){var F=N-this.getSpacing();var J=D-K+H+F;M=C>J;}
;if(C>D+H+N||M){this.__oy(O);D+=H;if(E&&this.__ow.length==0){E.setVisibility(p);}
;}
else {return;}
;}
;}
while(C>=D&&this.__ow.length>0);}
;}
,__oy:function(P){P.setVisibility(o);this.__ow.shift();this.fireDataEvent(d,P);}
,__oz:function(Q){if(!Q){return;}
;this.__ow.unshift(Q);Q.setVisibility(p);this.fireDataEvent(s,Q);}
,_getNextToHide:function(){for(var i=this.__ox.length-1;i>=0;i--){var R=this.__ox[i];if(R&&R.getVisibility&&R.getVisibility()==o){return R;}
;}
...
;}
;}
,setRemovePriority:function(U,V,W){if(!W&&this.__ox[V]!=undefined){throw new Error(v);}
;this.__ox[V]=U;}
...
;if(X){this.addListener(n,this._onResize,this);}
else {this.removeListener(n,this._onResize,this);var ba=this.getOverflowIndicator();if(ba){ba.setVisibility(p);}
;for(var i=0;i<this.__ow.length;i++){this.__ow[i].setVisibility(o);}
;this.__ow=[];}
;}
,_applyOverflowIndicator:function(bc,bd){if(bd){this._remove(bd);}
;if(bc){if(this._indexOf(bc)==-1){throw new Error(c);}
;bc.setVisibility(p);}
;}
,__oA:false,_setAllowMenuOpenHover:function(be){this.__oA=be;}
...
,_add:function(bi,bj){qx.ui.core.Widget.prototype._add.call(this,bi,bj);var bk=this.getSizeHint().width+bi.getSizeHint().width+2*this.getSpacing();this._recalculateOverflow(null,bk);}
,_addAt:function(bl,bm,bn){qx.ui.core.Widget.prototype._addAt.call(this,bl,bm,bn);var bo=this.getSizeHint().width+bl.getSizeHint().width+2*this.getSpacing();this._recalculateOverflow(null,bo);}
,_addBefore:function(bp,bq,br){qx.ui.core.Widget.prototype._addBefore.call(this,bp,bq,br);var bs=this.getSizeHint().width+bp.getSizeHint().width+2*this.getSpacing();this._recalculateOverflow(null,bs);}
,_addAfter:function(bt,bu,bv){qx.ui.core.Widget.prototype._addAfter.call(this,bt,bu,bv);var bw=this.getSizeHint().width+bt.getSizeHint().width+2*this.getSpacing();this._recalculateOverflow(null,bw);}
,_remove:function(bx){qx.ui.core.Widget.prototype._remove.call(this,bx);var by=this.getSizeHint().width-bx.getSizeHint().width-2*this.getSpacing();this._recalculateOverflow(null,by);}
,_removeAt:function(bz){var bB=this._getChildren()[bz];qx.ui.core.Widget.prototype._removeAt.call(this,bz);var bA=this.getSizeHint().width-bB.getSizeHint().width-2*this.getSpacing();this._recalculateOverflow(null,bA);}
,_removeAll:function(){qx.ui.core.Widget.prototype._removeAll.call(this);this._recalculateOverflow(null,0);}
,addSpacer:function(){var bC=new qx.ui.core.Spacer;this._add(bC,{flex:1});return bC;}
,addSeparator:function(){this.add(new qx.ui.toolbar.Separator);}
,getMenuButtons:function(){var bE=this.getChildren();var bD=[];var bF;for(var i=0,l=bE.length;i<l;i++){bF=bE[i];if(bF instanceof qx.ui.menubar.Button){bD.push(bF);}
else if(bF instanceof qx.ui.toolbar.Part){bD.push.apply(bD,bF.getMenuButtons());}
;}
;return bD;}
},destruct:function(){if(this.hasListener(n)){this.removeListener(n,this._onResize,this);}
;}
});}
)();
...
,__oB:function(){var x=this.getChildrenContainer().getChildren();x=x.filter(function(y){return y.getVisibility()==k;}
...
,_onMouseOver:function(e){e.stopPropagation();this.addState(l);delete this.__vS;}
...
;var T=this.getMenu();if(T&&T.isVisible()){this.__vS=true;return;}
;this.removeState(l);}
...
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__vS){this.removeState(l);}
;}
}});}
)();
...
,_applyValue:function(bf,bg){var bh=this.getChildControl(z);this._updateButtons();this.__vT=bf;if(bf!==null){if(this.getNumberFormat()){bh.setValue(this.getNumberFormat().format(bf));}
...
,_applyNumberFormat:function(bn,bo){var bp=this.getChildControl(z);bp.setFilter(this._getFilterRegExp());this.getNumberFormat().addListener(E,this._onChangeNumberFormat,this);this._applyValue(this.__vT,undefined);}
...
;}
;}
,_onKeyDown:function(e){switch(e.getKeyIdentifier()){case r:this.__vU=true;case n:this.getChildControl(y).press();break;case l:this.__vV=true;case q:this.getChildControl(v).press();break;default:return;};e.stopPropagation();e.preventDefault();}
,_onKeyUp:function(e){switch(e.getKeyIdentifier()){case r:this.getChildControl(y).release();this.__vU=false;break;case n:this.getChildControl(y).release();break;case l:this.getChildControl(v).release();this.__vV=false;break;case q:this.getChildControl(v).release();break;};}
...
;this.setValue(bv);}
else {this._applyValue(this.__vT,undefined);}
;}
...
,_countUp:function(){if(this.__vU){var bC=this.getValue()+this.getPageStep();}
...
;}
;this.gotoValue(bC);}
,_countDown:function(){if(this.__vV){var bE=this.getValue()-this.getPageStep();}
