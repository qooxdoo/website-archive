...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Page","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Page-qx.theme.Simple.5d220353dc30.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="demobrowser.demo.root.Page",e="yellow",d="red",c="green",b="blue",a="main";qx.Class.define(f,{extend:qx.application.Inline,members:{main:function(){qx.application.Inline.prototype.main.call(this);var g=new qx.ui.container.Composite(new qx.ui.layout.HBox());var k=new qx.ui.core.Widget().set({backgroundColor:d,decorator:a,padding:10});var j=new qx.ui.core.Widget().set({backgroundColor:b,decorator:a});var i=new qx.ui.core.Widget().set({backgroundColor:c,decorator:a});var h=new qx.ui.core.Widget().set({backgroundColor:e,decorator:a});g.add(k);g.add(j);g.add(i);g.add(h);this.getRoot().add(g,{left:30,top:120});}
}});}
)();
