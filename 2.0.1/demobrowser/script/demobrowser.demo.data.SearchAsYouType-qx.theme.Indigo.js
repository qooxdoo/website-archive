...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Indigo.ad8785346186.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="_applySearchString",c="demobrowser.demo.data.filter.SearchAsYouTypeFilter",b="String",a="";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__ub=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__te=null;}
,properties:{searchString:{check:b,apply:d,init:a}},members:{__te:null,__ub:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();if(this.__te!=null){i.stop(this.__te);this.__te=null;}
;this.__te=i.start(function(){this.__ub.update();this.__te=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__ub=null;}
});}
)();
