...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.MultiPageForm","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.MultiPageForm-qx.theme.Simple.430f26c4f5bb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="changeBubble",q="name",p="password",o="enabled",n="Birthdate:",m="valid",l="email",k="next",j="back",i="Email:",c="birthdate",h="demobrowser.demo.ui.MultiPageForm",g="Name:",b="Password:",a="submit",f="execute",d="value";qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.container.Stack();this.getRoot().add(J,{left:10,top:10});var v=new qx.ui.layout.Grid();v.setSpacing(5);var K=new qx.ui.container.Composite(v);J.add(K);var s=new qx.ui.basic.Label(g);K.add(s,{row:0,column:0});var name=new qx.ui.form.TextField();name.setRequired(true);K.add(name,{row:0,column:1});var w=new qx.ui.basic.Label(b);K.add(w,{row:1,column:0});var H=new qx.ui.form.PasswordField();H.setRequired(true);K.add(H,{row:1,column:1});var A=new qx.ui.form.Button(k);K.add(A,{row:2,column:1});A.addListener(f,J.next,J);var x=new qx.ui.layout.Grid();x.setSpacing(5);var I=new qx.ui.container.Composite(x);J.add(I);var E=new qx.ui.basic.Label(i);I.add(E,{row:0,column:0});var B=new qx.ui.form.TextField();I.add(B,{row:0,column:1});var t=new qx.ui.basic.Label(n);I.add(t,{row:1,column:0});var z=new qx.ui.form.DateField();z.setRequired(true);I.add(z,{row:1,column:1});var u=new qx.ui.form.Button(j);I.add(u,{row:2,column:0});u.addListener(f,J.previous,J);var y=new qx.ui.form.Button(a);y;I.add(y,{row:2,column:1});var F={name:null,password:null,email:null,birthdate:null};var G=qx.data.marshal.Json.createModel(F,true);var C=new qx.data.controller.Object(G);C.addTarget(name,d,q,true);C.addTarget(H,d,p,true);C.addTarget(B,d,l,true);C.addTarget(z,d,c,true);y.addListener(f,function(){alert(qx.util.Serializer.toUriParameter(G));}
,this);var D=new qx.ui.form.validation.Manager();D.add(name);D.add(H);D.add(B,qx.util.Validate.email());D.add(z);G.addListener(r,function(e){D.validate();}
,this);D.validate();D.bind(m,y,o);}
}});}
)();
...
(function(){var h="changeModel",g="qx.core.Object",f="qx.data.controller.Object",e="get",d="reset",c="_applyModel",b="last",a="[";qx.Class.define(f,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bg={};this.__ej=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:g,event:h,apply:c,nullable:true,dereference:true}},members:{__ej:null,__bg:null,_applyModel:function(k,l){for(var i=0;i<this.__ej.length;i++){var t=this.__ej[i][0];var q=this.__ej[i][1];var o=this.__ej[i][2];var r=this.__ej[i][3];var s=this.__ej[i][4];var n=this.__ej[i][5];if(l!=undefined&&!l.isDisposed()){this.__zu(t,q,o,l);}
;if(k!=undefined){this.__zt(t,q,o,r,s,n);}
else {if(t.isDisposed()||qx.core.ObjectRegistry.inShutDown){continue;}
;if(q.indexOf(a)==-1){t[d+qx.lang.String.firstUp(q)]();}
else {var open=q.indexOf(a);var m=parseInt(q.substring(open+1,q.length-1),10);q=q.substring(0,open);var p=t[e+qx.lang.String.firstUp(q)]();if(m==b){m=p.length;}
;if(p){p.setItem(m,null);}
;}
;}
;}
;}
,addTarget:function(u,v,w,x,y,z){this.__ej.push([u,v,w,x,y,z]);this.__zt(u,v,w,x,y,z);}
,__zt:function(A,B,C,D,E,F){if(this.getModel()==null){return;}
;var G=this.getModel().bind(C,A,B,E);var H=null;if(D){H=A.bind(B,this.getModel(),C,F);}
;var I=A.toHashCode();if(this.__bg[I]==undefined){this.__bg[I]=[];}
;this.__bg[I].push([G,H,B,C,E,F]);}
,removeTarget:function(J,K,L){this.__zu(J,K,L,this.getModel());for(var i=0;i<this.__ej.length;i++){if(this.__ej[i][0]==J&&this.__ej[i][1]==K&&this.__ej[i][2]==L){this.__ej.splice(i,1);}
;}
;}
,__zu:function(M,N,O,P){if(!(M instanceof qx.core.Object)){return;}
;var Q=this.__bg[M.toHashCode()];if(Q==undefined||Q.length==0){return;}
;for(var i=0;i<Q.length;i++){if(Q[i][2]==N&&Q[i][3]==O){var R=Q[i][0];P.removeBinding(R);if(Q[i][1]!=null){M.removeBinding(Q[i][1]);}
;Q.splice(i,1);return;}
;}
;}
...
catch(e){O=O||qx.locale.Manager.tr(m,M,e);throw new qx.core.ValidationError(b,O);}
;}
,range:function(P,Q,R){return function(S){R=R||qx.locale.Manager.tr(c,S,P,Q);if(S<P||S>Q){throw new qx.core.ValidationError(b,R);}
;}
;}
,inArray:function(T,U){return function(V){U=U||qx.locale.Manager.tr(f,V,T);if(T.indexOf(V)===-1){throw new qx.core.ValidationError(b,U);}
;}
;}
,regExp:function(W,X){return function(Y){X=X||qx.locale.Manager.tr(d,Y,W);if(!W.test(Y)){throw new qx.core.ValidationError(b,X);}
;}
;}
}});}
)();
