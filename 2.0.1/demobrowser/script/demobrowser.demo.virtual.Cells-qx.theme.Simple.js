...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Cells","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Simple.d57664140fcf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="testImageCell",i="qx.theme",h="testNumberCell",g="width:",f="testHtmlCell",e="testDateCell",d="css.boxmodel",c="height:",b="testStringCell",a="testBooleanCellCustomImage",y="demobrowser.demo.virtual.Cells",x="content",w="testBooleanCell",v="foobar!",u="qx.theme.Modern",t="icon/32/apps/utilities-notes.png",s="medium",r="icon/16/emotes/face-sad.png",q="icon/16/apps/internet-feed-reader.png",p="icon/16/emotes/face-smile.png",n="This is a feed reader!",o="<b>HTML</b>",l="px;",m="Juhu",k="";qx.Class.define(y,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var z=new qx.ui.layout.HBox(5);this.topContainer=new qx.ui.container.Composite(z);this.runTest(b);this.runTest(h);this.runTest(e);this.runTest(f);if(qx.core.Environment.get(i)==u){this.runTest(j);this.runTest(w);this.runTest(a);}
;this.getRoot().add(this.topContainer,{edge:5});}
,runTest:function(A){this.setUp();this[A]();}
...
,testStringCell:function(){var C={value:[m,o,k,null],states:[{},{selected:1}]};var B=new qx.ui.virtual.cell.String;qx.util.Permutation.permute(C,function(D){var E=this.__LA(B,D.value,D.states);this.container.add(E);}
,this);}
,testNumberCell:function(){var F={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};var G=new qx.ui.virtual.cell.Number();qx.util.Permutation.permute(F,function(H){if(H.format){G.setNumberFormat(H.format);}
else {G.resetNumberFormat();}
;var I=this.__LA(G,H.value,H.states);this.container.add(I);}
,this);}
,testDateCell:function(){var J={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(s))],states:[{},{selected:1}]};var K=new qx.ui.virtual.cell.Date();qx.util.Permutation.permute(J,function(L){if(L.format){K.setDateFormat(L.format);}
else {K.resetDateFormat();}
;var M=this.__LA(K,L.value,L.states);this.container.add(M);}
,this);}
,testHtmlCell:function(){var N={value:[m,o,k,null],states:[{},{selected:1}]};var O=new qx.ui.virtual.cell.Html;qx.util.Permutation.permute(N,function(P){var Q=this.__LA(O,P.value,P.states);this.container.add(Q);}
,this);}
,testImageCell:function(){var R={value:[{url:q,tooltip:n},{url:t,tooltip:v},null],states:[{},{selected:1}]};var S=new qx.ui.virtual.cell.Image;qx.util.Permutation.permute(R,function(T){var U=this.__LA(S,T.value,T.states);this.container.add(U);}
,this);}
,testBooleanCell:function(){var V={value:[true,false,null],states:[{},{selected:1}]};var W=new qx.ui.virtual.cell.Boolean;qx.util.Permutation.permute(V,function(X){var Y=this.__LA(W,X.value,X.states);this.container.add(Y);}
,this);}
,testBooleanCellCustomImage:function(){var ba={value:[true,false,null],states:[{},{selected:1}]};var bb=new qx.ui.virtual.cell.Boolean;bb.setIconFalse(r);bb.setIconTrue(p);qx.util.Permutation.permute(ba,function(bc){var bd=this.__LA(bb,bc.value,bc.states);this.container.add(bd);}
,this);}
,__LA:function(be,bf,bg){var bk=100;var bi=30;var bm=new qx.ui.embed.Html().set({width:bk,height:bi,decorator:bg.selected?null:"main"});var bh=be.getCellProperties(bf,bg);var bj=bh.insets;var bl=["<div ","style='",this._getCellSizeStyle(bk,bi,bj[0],bj[1]),bh.style,"' ","class='",bh.classes,"' ",bh.attributes,">",bh.content,"</div>"].join("");bm.setHtml(bl);return bm;}
,_getCellSizeStyle:function(bn,bo,bp,bq){var br=k;if(qx.core.Environment.get(d)==x){bn-=bp;bo-=bq;}
;br+=g+bn+l;br+=c+bo+l;return br;}
}});}
)();
...
;this.__jy=qx.bom.Stylesheet.createElement(p);this.__Jf={};this.__lF={};}
,members:{__jy:null,__Jf:null,__lF:null,getStylesheet:function(){return this.__jy;}
,getCssClass:function(q){return this.__Jf[q]||null;}
,computeClassForStyles:function(r,s){var t=this.__lF[s];if(!t){var t=this.__Jg();qx.bom.Stylesheet.addRule(this.__jy,f+t,s);this.__lF[s]=t;}
;this.__Jf[r]=t;return t;}
,__Jg:function(){return k+this.toHashCode()+o+(this.__Jh++);}
,__Jh:0},destruct:function(){this.__jy=this.__Jf=this.__lF=null;}
});}
)();
(function(){var k="backgroundColor",j="_applyTextAlign",h="px",g="_applyFont",f="_applyBackgroundColor",e="cell",d="center",c="font",b=":",a="shorthand",H="String",G="_applyAppearance",F="background-color:",E="textAlign",D="qx-cell ",C="left",B="textColor",A="text-align:",z="Font",y="right",r="_applyTextColor",s="justify",p="color:",q=";",n="qx.ui.virtual.cell.Cell",o="paddingLeft",l="Color",m="",t="paddingBottom",u="paddingTop",w="paddingRight",v="Integer",x="_applyPadding";qx.Class.define(n,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__jy=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__Jy={};this.__Jz={};this.__JA={};this.__JB={};this.__hy={};this.__JC={};this.initAppearance();this.__JG();}
,properties:{appearance:{check:H,init:e,apply:G},backgroundColor:{nullable:true,check:l,apply:f,themeable:true},textColor:{nullable:true,check:l,apply:r,themeable:true},textAlign:{check:[C,d,y,s],nullable:true,themeable:true,apply:j},font:{nullable:true,apply:g,check:z,themeable:true},paddingTop:{check:v,init:0,apply:x,themeable:true},paddingRight:{check:v,nullable:true,apply:x,themeable:true},paddingBottom:{check:v,nullable:true,apply:x,themeable:true},paddingLeft:{check:v,nullable:true,apply:x,themeable:true},padding:{group:[u,w,t,o],mode:a,themeable:true}},members:{__JD:null,__JE:null,__hy:null,__JC:null,__Jz:null,__Jy:null,__JA:null,__JB:null,__JF:false,__jy:null,__JG:function(){var K=qx.util.PropertyUtil;var M=qx.lang.Object.fromArray(this._getCssProperties());this.__JD=[];var J=this.constructor;while(J){var L=K.getProperties(J);for(var I in L){if(!M[I]){this.__JD.push(I);}
;}
;J=J.superclass;}
;}
,_getCssProperties:function(){return [k,B,c,E,u,w,t,o];}
,_applyAppearance:function(N,O){if(O){this.__Jz={};}
;}
,_getValue:function(P){if(this.__JF){return qx.util.PropertyUtil.getThemeValue(this,P);}
else {return qx.util.PropertyUtil.getUserValue(this,P);}
;}
,_storeStyle:function(Q,R){var S;if(this.__JF){S=this.__Jz;}
else {S=this.__Jy;}
...
;}
,_applyPadding:function(bd,be,name){var bd=this._getValue(name);if(this.__JF){var bg=this.__JB;}
else {bg=this.__JA;}
...
;}
,getCellProperties:function(bh,bi){this.__JH(bi);return {classes:this.getCssClasses(bh,bi),style:this.getStyles(bh,bi),attributes:this.getAttributes(bh,bi),content:this.getContent(bh,bi),insets:this.getInsets(bh,bi)};}
,getAttributes:function(bj,bk){return m;}
,getContent:function(bl,bm){return bl;}
,getCssClasses:function(bn,bo){var bp=this.__jy.getCssClass(this.__JE)||m;return D+bp;}
,__JH:function(bq){if(!bq){bq={};}
;var bs=this.getAppearance();var br=bs+"-"+qx.lang.Object.getKeys(bq).sort().join(" ");if(this.__JE==br){return;}
;this.__JE=br;var bt=this.__hy[this.__JE];if(!bt){this.__JI();this.__JJ(bq);this.__JK(bq);this.__JL();this.__hy[this.__JE]=1;}
;this.__JM();}
,__JI:function(){var bu=qx.util.PropertyUtil;var bv=this._getCssProperties();for(var i=0;i<bv.length;i++){bu.deleteThemeValue(this,bv[i]);}
;}
,__JJ:function(bw){this.__Jz={};this.__JF=true;var bz=this.getAppearance();var by=qx.util.PropertyUtil;var bx=qx.theme.manager.Appearance.getInstance().styleFrom(bz,bw);for(var bA in bx){if(bx[bA]!==undefined){by.setThemed(this,bA,bx[bA]);}
;}
;this.__JF=false;}
,__JK:function(){var bB=qx.lang.Object.getValues(this.__Jz).join(";");this.__jy.computeClassForStyles(this.__JE,bB);}
,__JL:function(){var bG=this.__JD;var bC=qx.util.PropertyUtil;var bE={};for(var i=0;i<bG.length;i++){var bF=bG[i];var bD=bC.getThemeValue(this,bF);if(bD!==undefined){bE[bF]=bD;}
;}
;this.__JC[this.__JE]=bE;}
,__JM:function(){var bI=qx.util.PropertyUtil;var bH=this.__JC[this.__JE]||{};for(var bJ in bH){bI.setThemed(this,bJ,bH[bJ]);}
;}
,getStyles:function(bK,bL){return qx.lang.Object.getValues(this.__Jy).join(q);}
,getInsets:function(bM,bN){var bR=this.__JA;var bQ=this.__JB;var top=(bR.paddingTop!==undefined?bR.paddingTop:bQ.paddingTop)||0;var bO=(bR.paddingRight!==undefined?bR.paddingRight:bQ.paddingRight)||0;var bP=(bR.paddingBottom!==undefined?bR.paddingBottom:bQ.paddingBottom)||0;var bS=(bR.paddingLeft!==undefined?bR.paddingLeft:bQ.paddingLeft)||0;return [bS+bO,top+bP];}
},destruct:function(){this.__jy=this.__Jy=this.__Jz=this.__JA=this.__JB=this.__hy=this.__JC=this.__JD=null;}
});}
)();
...
(function(){var c="qx.ui.virtual.cell.String",b="cell-string",a="";qx.Class.define(c,{extend:qx.ui.virtual.cell.Cell,construct:function(){qx.ui.virtual.cell.Cell.call(this);}
...
(function(){var d="qx.ui.virtual.cell.Number",c="qx.util.format.NumberFormat",b="",a="cell-number";qx.Class.define(d,{extend:qx.ui.virtual.cell.Cell,construct:function(e){qx.ui.virtual.cell.Cell.call(this);if(e){this.setNumberFormat(e);}
;}
...
(function(){var d="qx.util.format.DateFormat",c="cell-date",b="",a="qx.ui.virtual.cell.Date";qx.Class.define(a,{extend:qx.ui.virtual.cell.Cell,construct:function(e){qx.ui.virtual.cell.Cell.call(this);if(e){this.setDateFormat(e);}
...
(function(){var b="cell-html",a="qx.ui.virtual.cell.Html";qx.Class.define(a,{extend:qx.ui.virtual.cell.Cell,properties:{appearance:{refine:true,init:b}},members:{getContent:function(c,d){return c;}
}});}
)();
(function(){var j="qx.ui.virtual.cell.AbstractImage",i="engine.version",h="_identifyImage is abstract",g="static",f='"',e='<div style="',d='/>',c='<img src="',b='title="',a='></div>',v="img",u="top",t="gecko",s="engine.name",r='" style="',q="abstract",p="inline-block",o="-moz-inline-box",n="px",m='" ',k="no-repeat",l="";qx.Class.define(j,{extend:qx.ui.virtual.cell.Cell,type:q,construct:function(){qx.ui.virtual.cell.Cell.call(this);this._aliasManager=qx.util.AliasManager.getInstance();}
,members:{__qm:16,__qn:16,_aliasManager:null,__qp:function(w){var z=qx.util.ResourceManager.getInstance();var y=qx.io.ImageLoader;var x,A;if(z.has(w)){x=z.getImageWidth(w),A=z.getImageHeight(w);}
else if(y.isLoaded(w)){x=y.getWidth(w);A=y.getHeight(w);}
else {x=this.__qm;A=this.__qn;}
;return {width:x,height:A};}
,__JN:function(B){if(typeof (B)=="string"){B={url:B};}
;var C=this._aliasManager.resolve(B.url||null);var D;if(B.width&&B.height){D={width:B.width,height:B.height};}
else {D=this.__qp(C);}
;return {width:D.width,height:D.height,url:C,tooltip:B.tooltip};}
,_identifyImage:function(E){throw new Error(h);}
,getContent:function(F,G){if(F===null){return l;}
;var content=l;var I=this.__JN(this._identifyImage(F));var M=qx.core.Environment.get(s)==t&&qx.core.Environment.get(i)<1.9;var J=I.tooltip?b+I.tooltip+f:l;var H={width:I.width+n,height:I.height+n,display:M?o:p,verticalAlign:u,position:g};var K=qx.bom.element.Decoration.getTagName(k,I.url);var L=qx.bom.element.Decoration.getAttributes(I.url,k,H);var N=qx.bom.element.Style.compile(L.style);if(K===v){content=c+L.src+r+N+m;content+=J+d;}
else {content=e+N+m;content+=J+a;}
;return content;}
}});}
)();
(function(){var b="cell-image",a="qx.ui.virtual.cell.Image";qx.Class.define(a,{extend:qx.ui.virtual.cell.AbstractImage,properties:{appearance:{refine:true,init:b}},members:{_identifyImage:function(c){return c;}
}});}
)();
(function(){var e="_applyIconFalse",d="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",b="cell-boolean",a="String";qx.Class.define(d,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__zc=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:b},iconTrue:{check:a,themeable:true,apply:c},iconFalse:{check:a,themeable:true,apply:e}},members:{__Kq:null,__Kr:null,__zc:null,_applyIconTrue:function(f){this.__Kq=this.__zc.resolve(f);}
,_applyIconFalse:function(g){this.__Kr=this.__zc.resolve(g);}
,_identifyImage:function(h){return h==true?this.__Kq:this.__Kr;}
}});}
)();
