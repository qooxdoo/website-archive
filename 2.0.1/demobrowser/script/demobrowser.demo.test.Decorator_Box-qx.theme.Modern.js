...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Decorator_Box","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Decorator_Box-qx.theme.Modern.c5460f0f3e7e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="sliceBottom",m="horizontal",l="qx.debug.dispose",k="qx.ui.decoration.AbstractBox",j="sliceLeft",i="_applyBaseImage",h="sliceRight",g="_applyFill",f="shorthand",e="String",b="sliceTop",d="set",c="Number",a="_applySlices";qx.Class.define(k,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],construct:function(o,p,q){qx.ui.decoration.Abstract.call(this);this._setOrientation(q);if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__BD=new qx.ui.decoration.css3.BorderImage();if(o){this.__BE(o,q);}
;if(p!=null){this.__BD.setInsets(p);}
;}
else {this.__BD=new qx.ui.decoration.BoxDiv(o,p,q);}
;if(qx.core.Environment.get(l)){this.__BD.$$ignoreDisposeWarning=true;}
;}
,properties:{baseImage:{check:e,nullable:true,apply:i},sliceLeft:{check:c,nullable:true,apply:a},sliceRight:{check:c,nullable:true,apply:a},sliceBottom:{check:c,nullable:true,apply:a},sliceTop:{check:c,nullable:true,apply:a},slices:{group:[b,h,n,j],mode:f},fill:{apply:g}},members:{__BD:null,_isHorizontal:null,_setOrientation:function(r){this._isHorizontal=r==m;}
,getMarkup:function(){return this.__BD.getMarkup();}
,resize:function(s,t,u){this.__BD.resize(s,t,u);}
,tint:function(v,w){}
,getInsets:function(){return this.__BD.getInsets();}
,_applyInsets:function(x,y,name){var z=d+qx.lang.String.firstUp(name);this.__BD[z](x);}
,_applySlices:function(A,B,name){var C=d+qx.lang.String.firstUp(name);if(this.__BD[C]){this.__BD[C](A);}
;}
,_applyFill:function(D,E,name){if(this.__BD.setFill){this.__BD.setFill(D);}
;}
,_applyBaseImage:function(F,G){if(this.__BD instanceof qx.ui.decoration.BoxDiv){this.__BD.setBaseImage(F);}
else {this.__BE(F);}
;}
,__BE:function(H){this.__BD.setBorderImage(H);var N=qx.util.AliasManager.getInstance().resolve(H);var O=/(.*)(\.[a-z]+)$/.exec(N);var L=O[1];var M=O[2];var K=qx.util.ResourceManager.getInstance();if(qx.core.Environment.get("qx.debug")){if(!K.has(N)){this.warn("The border image '"+N+"' is not available!");}
;}
;if(this._isHorizontal){var Q=K.getImageWidth(L+"-l"+M);var I=K.getImageWidth(L+"-r"+M);if(I&&Q){this.__BD.setSlice([0,I,0,Q]);}
;}
else {var J=K.getImageHeight(L+"-b"+M);var P=K.getImageHeight(L+"-t"+M);if(P&&J){this.__BD.setSlice([P,0,J,0]);}
;}
;}
},destruct:function(){this.__BG=this.__BP=this.__BQ=null;this.__BD.dispose();}
});}
)();
...
;}
,properties:{baseImage:{check:x,nullable:true,apply:c}},members:{__BG:null,__BP:null,__BQ:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};}
,_isInitialized:function(){return !!this.__BG;}
,_setOrientation:function(B){this._isHorizontal=B==r;}
,getMarkup:function(){if(this.__BG){return this.__BG;}
;var C=qx.bom.element.Decoration;var D=this.__BP;var E=this.__BQ;var F=[];F.push(e);if(this._isHorizontal){F.push(C.create(D.l,k,{top:0,left:0}));F.push(C.create(D.c,p,{top:0,left:E.left+l}));F.push(C.create(D.r,k,{top:0,right:0}));}
...
;F.push(i);return this.__BG=F.join(w);}
,resize:function(G,H,I){G.style.width=H+l;G.style.height=I+l;var J=this.__BQ;if(this._isHorizontal){var innerWidth=H-J.left-J.right;innerWidth=innerWidth<0?0:innerWidth;G.childNodes[1].style.width=innerWidth+l;}
...
;}
,tint:function(K,L){}
,_applyBaseImage:function(M,N){if(qx.core.Environment.get(d)){if(this.__BG){throw new Error(q);}
;}
;var O=qx.util.ResourceManager.getInstance();if(M){var Q=qx.util.AliasManager.getInstance();var S=Q.resolve(M);var T=/(.*)(\.[a-z]+)$/.exec(S);var R=T[1];var P=T[2];var U=this.__BP={t:R+h+P,b:R+b+P,c:R+u+P,l:R+j+P,r:R+f+P};this.__BQ={top:O.getImageHeight(U.t),bottom:O.getImageHeight(U.b),left:O.getImageWidth(U.l),right:O.getImageWidth(U.r)};}
;}
},destruct:function(){this.__BG=this.__BP=this.__BQ=null;}
});}
)();
