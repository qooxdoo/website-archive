...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Flash","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash-qx.theme.Modern.ee18ea808fce.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var k="2) this html page is not loaded from the file system, but a webserver.",j="Flash Player Version",i="right",h="qooxdoo is the best!",g="Message from Flash:",f="__RC",d="Simple demo with FlashVars",c="__ce",b="bgcolor",a="demobrowser.demo.widget.Flash",F="demobrowser/demo/flash/TestFlash.swf",E="__Kz",D="1) no pop-up or advertising blocker is activated.\n",C="Send to Flash",B="demobrowser/demo/flash/FlashVersion.swf",A="No message.",z="Flash:",y="<b>qooxdoo:</b>",x="demobrowser.demo.widget.Flash.sendMessage",w="demobrowser.demo.widget.Flash.flashReady",r="Couldn't connect to Flash Player! Please make sure that:\n",s="__RB",p="demobrowser/demo/flash/fo_tester.swf",q="this is passed in via FlashVars",n="Two way communication (ActionScript <-> JavaScript)",o="__RA",l="Message to Flash:",m="Show Flash Player version",t="noscale",u="#FF6600",v="execute";qx.Class.define(a,{extend:qx.application.Standalone,members:{__ce:null,main:function(){qx.application.Standalone.prototype.main.call(this);var G=new qx.ui.tabview.TabView();G.setContentPadding([8,8,8,8]);var J=this.getRoot();J.add(G,{edge:0});var H=new qx.ui.tabview.Page(d);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});G.add(H);var I=new qx.ui.tabview.Page(n);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});G.add(I);this.__ce=this.createWindow();J.add(this.__ce,{top:20,left:20});}
,createWindow:function(){var K=new qx.ui.window.Window(j).set({width:300,height:200,contentPadding:[0,0,0,0]});K.setLayout(new qx.ui.layout.Canvas());K.add(new qx.ui.embed.Flash(B),{edge:0});return K;}
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:q};var M=new qx.ui.embed.Flash(p).set({scale:t,variables:L});M.getContentElement().setParam(b,u);N.add(M,{flex:1});var O=new qx.ui.form.Button(m);O.addListener(v,function(){this.__ce.open();}
,this);N.add(O);return N;}
,__Kz:null,__RA:null,__RB:null,__RC:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(y).set({rich:true}));Q.add(new qx.ui.basic.Label(g));this.__RA=new qx.ui.form.TextArea(A);this.__RA.setEnabled(false);Q.add(this.__RA,{flex:1});Q.add(new qx.ui.basic.Label(l));this.__RB=new qx.ui.form.TextArea(h);Q.add(this.__RB,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,i));this.__RC=new qx.ui.form.Button(C);this.__RC.setEnabled(false);this.__RC.addListener(v,function(e){this.__Kz.getFlashElement().sendMessage(this.__RB.getValue());}
,this);S.add(this.__RC);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(z).set({rich:true}));this.__Kz=new qx.ui.embed.Flash(F);this.__Kz.setVariables({init:w});P.add(this.__Kz,{flex:1});return R;}
,sendMessage:function(T){this.__RA.setValue(T);}
,initFlash:function(){if(this.__Kz.getFlashElement().setup){this.__Kz.getFlashElement().setup(x);this.__RC.setEnabled(true);}
else {alert(r+D+k);}
;}
},statics:{__RD:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__RD=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__RD.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__RD.initFlash();}
},destruct:function(){this._disposeObjects(o,s,f,E,c);}
});}
)();
...
(function(){var j="quality",i="_applyVariables",h="low",g="_applyLoop",f="scale",e="_applyAllowScriptAccess",d="showall",c="Map",b="_applyLiveConnect",a="wmode",bc="Integer",bb="_applyMenu",ba="loaded",Y="window",X="_applyPlay",W="loop",V="allowScriptAccess",U="menu",T="noborder",S="loading",q="swLiveConnect",r="Timeout after: ",o="qx.ui.embed.Flash",p="_applyId",m="high",n="transparent",k="exactfit",l="play",u="autohigh",v="_applySource",D="appear",B="medium",K="Invalid parameter 'source'.",F="timeout",O="_applyMayScript",M="_applyQuality",x="never",R="_applyScale",Q="flash",P="always",w="Invalid parameter 'id'.",z="noscale",A="_applyWmode",C="autolow",E="mayscript",G="sameDomain",L="opaque",N="qx.debug",s="String",t="",y="best",J="undefined",I="qx.event.type.Event",H="Boolean";qx.Class.define(o,{extend:qx.ui.core.Widget,construct:function(bd,be){qx.ui.core.Widget.call(this);if(qx.core.Environment.get(N)){qx.core.Assert.assertString(bd,K);if(be){qx.core.Assert.assertString(be,w);}
;}
;this.setSource(bd);if(be){this.setId(be);}
else {this.setId(Q+this.toHashCode());}
;this.initQuality();this.initWmode();this.initAllowScriptAccess();this.initLiveConnect();this.addListenerOnce(D,function(){this._checkLoading();this.getContentElement().createFlash();}
,this);}
,events:{"loading":I,"loaded":I,"timeout":I},properties:{source:{check:s,apply:v},id:{check:s,apply:p},quality:{check:[h,C,u,B,m,y],init:y,nullable:true,apply:M},scale:{check:[d,T,k,z],nullable:true,apply:R},wmode:{check:[Y,L,n],init:L,nullable:true,apply:A},play:{check:H,nullable:true,apply:X},loop:{check:H,nullable:true,apply:g},mayScript:{check:H,nullable:false,apply:O},menu:{check:H,nullable:true,apply:bb},allowScriptAccess:{check:[G,P,x],init:G,nullable:true,apply:e},liveConnect:{check:H,init:true,nullable:true,apply:b},variables:{init:{},check:c,apply:i},loadTimeout:{check:bc,init:10000}},members:{__Ku:null,getFlashElement:function(){var bf=this.getContentElement();if(bf){return bf.getFlashElement();}
else {return null;}
;}
,isLoaded:function(){return this.getPercentLoaded()===100;}
,getPercentLoaded:function(){var bg=this.getFlashElement();if(typeof (bg)!=J&&bg!=null){try{return bg.PercentLoaded();}
catch(bh){return 0;}
;}
else {return 0;}
;}
,_createContentElement:function(){return new qx.html.Flash();}
,_checkLoading:function(){var bi=this.getSource();if(bi!=t&&bi!=null&&bi!=J){if(!this.isLoaded()){if(!this.__Ku){this.__Ku=new Date().getTime();}
;var bj=new Date().getTime()-this.__Ku;if(this.getLoadTimeout()>bj){var bk=qx.util.TimerManager.getInstance();bk.start(this._checkLoading,0,this,null,10);this.fireEvent(S);}
else {if(qx.core.Environment.get(N)){this.debug(r+bj);}
;this.fireEvent(F);this.__Ku=null;}
;}
else {this.fireEvent(ba);this.__Ku=null;}
;}
;}
,_applySource:function(bl,bm){var bn=qx.util.ResourceManager.getInstance().toUri(bl);this.getContentElement().setSource(bn);qx.ui.core.queue.Layout.add(this);}
,_applyId:function(bo,bp){this.getContentElement().setId(bo);qx.ui.core.queue.Layout.add(this);}
,_applyVariables:function(bq,br){this.getContentElement().setVariables(bq);qx.ui.core.queue.Layout.add(this);}
,_applyMayScript:function(bs,bt){this.getContentElement().setAttribute(E,bs?t:false);qx.ui.core.queue.Layout.add(this);}
,_applyQuality:function(bu,bv){this.__Kv(j,bu);}
,_applyScale:function(bw,bx){this.__Kv(f,bw);}
,_applyWmode:function(by,bz){this.__Kv(a,by);}
,_applyPlay:function(bA,bB){this.__Kv(l,bA);}
,_applyLoop:function(bC,bD){this.__Kv(W,bC);}
,_applyMenu:function(bE,bF){this.__Kv(U,bE);}
,_applyAllowScriptAccess:function(bG,bH){this.__Kv(V,bG);}
,_applyLiveConnect:function(bI,bJ){this.__Kv(q,bI);}
,__Kv:function(bK,bL){this.getContentElement().setParam(bK,bL);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var m="The id cannot be modified after initial creation",l="The variables cannot be modified after initial creation",k="movie",j="The attributes cannot be modified after initial creation",i="The source cannot be modified after initial creation",h="The params cannot be modified after initial creation",g="id",f="qx.html.Flash",e="Invalid attribute 'key'.",d="div",a="Invalid attribute 'value' expected String, Boolean or null.",c="Invalid attribute 'value'.",b="qx.debug";qx.Class.define(f,{extend:qx.html.Element,construct:function(n,o){qx.html.Element.call(this,d,n,o);this.__Kw={};this.__Kx={};this.__Ky={};}
,members:{__Kw:null,__Ky:null,__Kx:null,__Kz:null,_createDomElement:function(){return qx.dom.Element.create(d);}
,createFlash:function(){this.__Kz=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Kx,this.__Kw);}
,setSource:function(p){if(qx.core.Environment.get(b)){qx.core.Assert.assertString(p,c);}
;if(this.__Kz){throw new Error(i);}
;this.setAttribute(k,p);}
,setId:function(q){if(qx.core.Environment.get(b)){qx.core.Assert.assertString(q,c);}
;if(this.__Kz){throw new Error(m);}
;this.setAttribute(g,q);}
,getVariables:function(){return this.__Kx;}
,setVariables:function(r){if(qx.core.Environment.get(b)){qx.core.Assert.assertMap(r,c);}
;if(this.__Kz){throw new Error(l);}
;this.__Kx=r;}
,getAttributes:function(){return this.__Ky;}
,setAttribute:function(s,t){if(qx.core.Environment.get(b)){qx.core.Assert.assertString(s,e);if(arguments.length>1&&t!==null){if(!qx.lang.Type.isBoolean(t)&&!qx.lang.Type.isString(t)){throw new Error(a);}
;}
;}
;if(this.__Kz){throw new Error(j);}
;if(t===null||t===undefined){delete this.__Ky[s];}
else {this.__Ky[s]=t;}
;}
,getParams:function(){return this.__Kw;}
,setParam:function(u,v){if(qx.core.Environment.get(b)){qx.core.Assert.assertString(u,e);if(arguments.length>1&&v!==null){if(!qx.lang.Type.isBoolean(v)&&!qx.lang.Type.isString(v)){throw new Error(a);}
;}
;}
;if(this.__Kz){throw new Error(h);}
;if(v===null||v===undefined){delete this.__Kw[u];}
else {this.__Kw[u]=v;}
;}
,getFlashElement:function(){return this.__Kz;}
},destruct:function(){if(this.__Kz){qx.bom.Flash.destroy(this.__Kz);}
;this.__Kw=this.__Kx=this.__Ky=null;}
});}
)();
(function(){var r="Invalid parameter 'element'.",q="&",p="Invalid attribute 'id'.",o="mshtml",n="qx.debug",m="beforeunload",l="The parent DOM element isn't in DOM! The External Interface doesn't work in IE!",k="load",j="Invalid attribute 'movie'.",h="data",c="Invalid parameter 'attributes'.",g="qx.bom.Flash",f="undefined",b="movie",a="=",e="100%",d="engine.name";qx.Class.define(g,{statics:{_flashObjects:{},create:function(s,t,u,v,w){if(!w){w=window;}
;if(qx.core.Environment.get(n)){qx.core.Assert.assertElement(s,r);qx.core.Assert.assertMap(t,c);qx.core.Assert.assertString(t.movie,j);qx.core.Assert.assertString(t.id,p);if(!qx.dom.Element.isInDom(s,w)){qx.log.Logger.warn(this,l);}
;}
;if(!t.width){t.width=e;}
;if(!t.height){t.height=e;}
;v=v?qx.lang.Object.clone(v):{};if(!v[b]){v[b]=t.movie;}
;t[h]=t.movie;delete t.movie;if(u){for(var name in u){if(typeof v.flashvars!=f){v.flashvars+=q+name+a+u[name];}
else {v.flashvars=name+a+u[name];}
;}
;}
;var x=this.__KF(s,t,v,w);this._flashObjects[t.id]=x;return x;}
,destroy:qx.core.Environment.select(d,{"mshtml":function(y,z){y=this.__KA(y);if(y.readyState==4){this.__KB(y);}
else {if(!z){z=window;}
;qx.bom.Event.addNativeListener(z,k,function(){qx.bom.Flash.__KB(y);}
);}
;}
,"default":function(A,B){A=this.__KA(A);if(A.parentNode){A.parentNode.removeChild(A);}
;delete this._flashObjects[A.id];}
}),__KA:function(C){if(!C){throw new Error("DOM element is null or undefined!");}
;if(C.tagName.toLowerCase()!=="object"){C=C.firstChild;}
;if(!C||C.tagName.toLowerCase()!=="object"){throw new Error("DOM element has or is not a flash object!");}
;return C;}
,__KB:qx.core.Environment.select("engine.name",{"mshtml":qx.event.GlobalError.observeMethod(function(D){for(var i in D){if(typeof D[i]=="function"){D[i]=null;}
;}
;if(D.parentNode){D.parentNode.removeChild(D);}
;delete this._flashObjects[D.id];}
),"default":null}),__KC:qx.event.GlobalError.observeMethod(function(){for(var E in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[E]);}
;window.__KD=function(){}
;window.__KE=function(){}
;qx.bom.Event.removeNativeListener(window,"beforeunload",qx.bom.Flash.__KC);}
),__KF:qx.core.Environment.select("engine.name",{"mshtml":function(F,G,H,I){H.movie=G.data;delete G.data;delete G.classid;var J="";for(name in H){J+='<param name="'+name+'" value="'+H[name]+'" />';}
;if(G.id){F.innerHTML='<object id="'+G.id+'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">'+J+'</object>';delete G.id;}
else {F.innerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">'+J+'</object>';}
;for(var name in G){F.firstChild.setAttribute(name,G[name]);}
;return F.firstChild;}
,"default":function(K,L,M,N){delete L.classid;delete M.movie;var P=qx.dom.Element.create("object",L,N);P.setAttribute("type","application/x-shockwave-flash");var O;for(var name in M){O=qx.dom.Element.create("param",{},N);O.setAttribute("name",name);O.setAttribute("value",M[name]);P.appendChild(O);}
;K.appendChild(P);return P;}
})},defer:function(Q){if((qx.core.Environment.get(d)==o)){qx.bom.Event.addNativeListener(window,m,Q.__KC);}
;}
});}
)();
(function(){var c="qx.util.TimerManager",b="interval",a="singleton";qx.Class.define(c,{extend:qx.core.Object,type:a,statics:{__KG:[],__KH:{},__te:0},members:{__KI:false,start:function(d,e,f,g,h){if(!h){h=e||0;}
;var j=(new Date()).getTime()+h;this.self(arguments).__KH[++this.self(arguments).__te]={callback:d,userData:g||null,expireAt:j,recurTime:e,context:f||this};this.__KJ(j,this.self(arguments).__te);return this.self(arguments).__te;}
,stop:function(k){var l=this.self(arguments).__KG;var length=l.length;for(var i=0;i<length;i++){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__KH[k];if(l.length==0&&this.__KI){qx.event.Idle.getInstance().removeListener(b,this.__KK,this);this.__KI=false;}
;}
,__KJ:function(m,n){var p=this.self(arguments).__KG;var o=this.self(arguments).__KH;var length=p.length;for(var i=0;i<length;i++){if(o[p[i]].expireAt>m){p.splice(i,0,n);break;}
;}
;if(p.length==length){p.push(n);}
;if(!this.__KI){qx.event.Idle.getInstance().addListener("interval",this.__KK,this);this.__KI=true;}
;}
,__KK:function(){var t=(new Date()).getTime();var r=this.self(arguments).__KG;var s=this.self(arguments).__KH;while(r.length>0&&s[r[0]].expireAt<=t){var v=r.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__KJ(q.expireAt,v);}
else {delete s[v];}
;}
;if(r.length==0&&this.__KI){qx.event.Idle.getInstance().removeListener("interval",this.__KK,this);this.__KI=false;}
;}
}});}
)();
