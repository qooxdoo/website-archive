...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor_Flash-qx.theme.Indigo.c9890300a9bf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="demobrowser.demo.test.Destructor_Flash",k="created: ",j="300px",h="interval",g="height",f="TestFlash.swf",e="400px",d="width",c="cleaned: ",b="div",a="FlashMovie";qx.Class.define(m,{extend:qx.application.Native,members:{__cR:null,__EW:0,main:function(){qx.application.Native.prototype.main.call(this);this.__cR=[];var n=new qx.event.Timer(5000);n.addListener(h,this.runTest,this);n.start();this.runTest();}
,runTest:function(){for(var i=0;i<5;i++){var o=qx.dom.Element.create(b);qx.bom.element.Style.set(o,d,e);qx.bom.element.Style.set(o,g,j);document.body.appendChild(o);var p=a+this.__EW;this.__EW++;qx.bom.Flash.create(o,{movie:f,id:p});this.debug(k+p);this.__cR.push(o);}
