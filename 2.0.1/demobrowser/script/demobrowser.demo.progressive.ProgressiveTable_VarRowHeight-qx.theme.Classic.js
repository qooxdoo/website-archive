...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_VarRowHeight","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_VarRowHeight-qx.theme.Classic.c8a031585263.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",k="format-justify-left.png",h="end",g="Found [",f="Id",e="No attributes specified.",d="TALL ICON",c="1*",b=", end=",a="This, too, is small.",C="This, too, is tall.",B="",A="Searching for [",z="]",y=" not found",x="small icon",w="demobrowser/demo/icons/",v="I am small.",u="red",t="Image data for ",q="I am tall.",s="].  loadCount=",o="multimedia-player.png",p="Image",m="Note variable row heights in this table.",n="row";qx.Class.define(l,{extend:qx.application.Standalone,members:{__QH:null,main:function(){qx.application.Standalone.prototype.main.call(this);var H=w;this.imageData=[{url:H+k,height:4,tooltip:x},{url:H+o,height:4,tooltip:d},B];this.__QH=0;var F=qx.util.AliasManager.getInstance();var E=qx.util.ResourceManager.getInstance();var D;var G;for(var i=0;i<this.imageData.length;i++){if(!this.imageData[i]){continue;}
;D=F.resolve(this.imageData[i].url);G=E.toUri(D);this.imageData[i].url=G;++this.__QH;qx.io.ImageLoader.load(G,function(I,J){this.info(A+I+z);for(var j=0;j<this.imageData.length;j++){if(this.imageData[j].url==I){this.imageData[j].height=J.height;--this.__QH;this.debug(g+this.imageData[j].url+s+this.__QH+b+this.imageData.length);if(this.__QH==0){this.doLoad();}
;return;}
;}
;throw new Error(t+I+y);}
,this);}
;if(this.__QH==0){this.doLoad();}
;}
,doLoad:function(){var L=this;var S=function(W,X){var Y={renderer:n,location:h,data:[X,L.imageData[W]]};return Y;}
;var R=new qx.ui.progressive.renderer.table.Widths(2);R.setWidth(0,200);R.setWidth(1,c);var N=[f,p];var O=new qx.ui.progressive.headfoot.TableHeading(R,N);var M=new qx.ui.progressive.headfoot.Progress(R,N);var V=new qx.ui.progressive.structure.Default(O,M);var K=new qx.ui.progressive.Progressive(V);var T=new qx.ui.basic.Atom(m);T.setHeight(16);T.setTextColor(u);K.add(T);var Q=new qx.ui.progressive.model.Default();var P=[];P.push(S(0,v));P.push(S(1,q));P.push(S(0,a));P.push(S(1,C));P.push(S(2,e));Q.addElements(P);K.setDataModel(Q);var U=new qx.ui.progressive.renderer.table.Row(R);K.addRenderer(n,U);var r=new qx.ui.progressive.renderer.table.cell.Image();U.addRenderer(1,r);K.set({width:400,maxWidth:400});this.getRoot().add(K,{left:50,top:50,bottom:50});K.render();}
}});}
)();
(function(){var f="Unrecognized key: ",e="qx.ui.progressive.renderer.table.Widths",d="minWidth",c="width",b="maxWidth",a="Column number out of range";qx.Class.define(e,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__My=[];for(var i=0;i<g;i++){this.__My[i]=new qx.ui.core.ColumnData();}
;}
,members:{__My:null,getData:function(){return this.__My;}
,set:function(h,j){for(var k in j){switch(k){case c:this.setWidth(h,j[k]);break;case d:this.setMinWidth(h,j[k]);break;case b:this.setMaxWidth(h,j[k]);break;default:throw new Error(f+k);};}
;}
,setWidth:function(l,m){if(l>this.__My.length-1||l<0){throw new Error(a);}
;this.__My[l].setColumnWidth(m);}
,setMinWidth:function(n,o){if(n>this.__My.length-1||n<0){throw new Error(a);}
;this.__My[n].setMinWidth(o);}
,setMaxWidth:function(p,q){if(p>this.__My.length-1||p<0){throw new Error(a);}
;this.__My[p].setMaxWidth(q);}
}});}
)();
...
,members:{__Js:null,join:function(c){this.__Js=c;}
...
(function(){var f="resize",d="progressive-table-header",c="_layout",b="qx.ui.progressive.headfoot.TableHeading",a="progressive-table-header-cell";qx.Class.define(b,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(g,h){qx.ui.progressive.headfoot.Abstract.call(this);this.__Jp=g;var k=g.getData();this.__FC=[];for(var i=0;i<k.length;i++){var l=new qx.ui.basic.Atom(h[i]);l.setAppearance(a);this.add(l);this.__FC[i]=l;}
;var j=new qx.ui.core.Widget();j.set({height:16,appearance:a,minWidth:0,width:0});this.add(j,{flex:1});this.addListener(f,this._resizeColumns,this);this.__nN=new qx.ui.layout.HBox();this.__nN.connectToWidget(this);}
,properties:{appearance:{refine:true,init:d}},members:{__Jp:null,__Ks:null,__FC:null,__nN:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__Ks){return this.__Jp.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var n=this.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();this.__Ks=true;this.__nN.renderLayout(n,100);this.__Ks=false;var o=this.__Jp.getData();for(var i=0;i<o.length;i++){this.__FC[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__Jp=this.__FC=null;this._disposeObjects(c);}
});}
)();
(function(){var n="progressive-progressbar-indicator-undone",m="__Me",l="progress",k="%",j="progressive-progressbar-indicator-done",i="progressive-progressbar-percent-text",h="renderStart",g="progressive-progressbar-background",f="0%",d="qx.ui.progressive.headfoot.Progress",a="__Mf",c="progressive-progressbar-percent-background",b="renderEnd";qx.Class.define(d,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,p){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__Jt={};var q=qx.theme.manager.Color.getInstance();this.__Jt.background=q.resolve(g);this.__Jt.indicatorDone=q.resolve(j);this.__Jt.indicatorUndone=q.resolve(n);this.__Jt.percentBackground=q.resolve(c);this.__Jt.percentText=q.resolve(i);this.set({backgroundColor:this.__Jt.background});this.__Me=new qx.ui.core.Widget();this.__Me.set({width:0,backgroundColor:this.__Jt.indicatorDone});this.add(this.__Me);var r=new qx.ui.core.Widget();r.set({backgroundColor:this.__Jt.indicatorUndone});this.add(r,{flex:1});this.__Mf=new qx.ui.basic.Atom(f);this.__Mf.set({width:100,backgroundColor:this.__Jt.percentBackground,textColor:this.__Jt.percentText});this.add(this.__Mf);this.exclude();}
,members:{__Mg:null,__Jt:null,__Me:null,__Mf:null,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(h,function(e){this.__Mg=e.getData().initial;this.show();}
,this);s.addListener(l,function(e){var v=1.0-(e.getData().remaining/this.__Mg);var w=this.getBounds();if(w){var t=Math.floor((w.width-this.__Mf.getBounds().width)*v);var u=Math.floor(v*100)+k;if(!isNaN(t)){this.__Me.setMinWidth(t);this.__Mf.setLabel(u);}
;}
;}
,this);s.addListener(b,function(e){this.exclude();}
,this);}
},destruct:function(){this.__Jt=null;this._disposeObjects(m,a);}
});}
)();
(function(){var e="applyStructure() is abstract",d="abstract",c="qx.ui.progressive.structure.Abstract",b="overflowY",a="auto";qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__EU=new qx.ui.core.Widget();this.__AE=this.__EU;}
else {this.__EU=null;this.__AE=f;}
;this.__AE.getContentElement().setStyle(b,a);}
,members:{__EU:null,__AE:null,applyStructure:function(g){throw new Error(e);}
,getPane:function(){return this.__AE;}
},destruct:function(){if(this.__EU){this.__EU.dispose();}
;this.__EU=this.__AE=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,c,d){qx.ui.progressive.structure.Abstract.call(this,d);if(!b){this.__Ki=new qx.ui.progressive.headfoot.Null();this.__oU=this.__Ki;}
else {this.__Ki=null;this.__oU=b;}
;if(!c){this.__Kj=new qx.ui.progressive.headfoot.Null();this.__Kk=this.__Kj;}
else {this.__Kj=null;this.__Kk=c;}
;}
,members:{__oU:null,__Kk:null,__Ki:null,__Kj:null,applyStructure:function(e){this.__oU.join(e);this.__Kk.join(e);e.add(this.__oU);e.add(this.getPane(),{flex:1});e.add(this.__Kk);}
,getHeader:function(){return this.__oU;}
,getFooter:function(){return this.__Kk;}
},destruct:function(){if(this.__Ki){this.__Ki.dispose();this.__Ki=null;}
;if(this.__Kj){this.__Kj.dispose();this.__Kj=null;}
;this.__oU=this.__Kk=null;}
});}
)();
...
(function(){var q="_applyDataModel",p="Boolean",o="Render time: ",n="qx.ui.progressive.model.Abstract",m="ms",l="progress",k="white",j="No existing renderer named ",h="qx.ui.progressive.Progressive",g="progressDetail",c="renderEnd",f="dataAvailable",d="renderStart",b="Integer",a="qx.event.type.Data";qx.Class.define(h,{extend:qx.ui.container.Composite,construct:function(r){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__FD={};this.set({backgroundColor:k});if(!r){r=new qx.ui.progressive.structure.Default();}
;this.__Ls=r;r.applyStructure(this);this.__Lt=false;this.__Lu=false;this.__Lv=0;}
,events:{"renderStart":a,"renderEnd":a,"progress":a,"progressDetail":a},properties:{dataModel:{check:n,apply:q},batchSize:{check:b,init:20},flushWidgetQueueAfterBatch:{check:p,init:false},interElementTimeout:{check:b,init:0}},members:{__FD:null,__Lu:null,__Lw:null,__Lv:null,__Lt:null,__Ls:null,getStructure:function(){return this.__Ls;}
,addRenderer:function(name,s){this.__FD[name]=s;s.join(this,name);}
,removeRenderer:function(name){if(!this.__FD[name]){throw new Error(j+name);}
;delete this.__FD[name];}
,render:function(){if(this.__Lu){return;}
;this.__Lu=true;var t=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__Ls.getPane(),batchSize:this.getBatchSize(),rendererData:this.__Ly(),userData:{}});this.__Lw=new Date();if(this.__Lt){this.__Lv=t.getModel().getElementCount();this.fireDataEvent(d,{state:t,initial:this.__Lv});this.__Lx(t);}
else {qx.event.Timer.once(function(){this.__Lv=t.getModel().getElementCount();this.fireDataEvent(d,{state:t,initial:this.__Lv});this.__Lx(t);this.__Lt=true;}
,this,10);}
;}
,_applyDataModel:function(u,v){if(v){v.removeListener(f,this.__Lz,this);v.dispose();}
;u.addListener(f,this.__Lz,this);}
,__Lx:function(w){var x;var z;var y;for(var i=w.getBatchSize();i>0;i--){x=w.getModel().getNextElement();if(!x){this.debug(o+(new Date()-this.__Lw)+m);this.__Lu=false;this.fireDataEvent(c,w);w.dispose();return;}
;z=x.element;y=this.__FD[z.renderer];y.render(w,z);this.fireDataEvent(g,{initial:this.__Lv,remaining:x.remaining,element:z});}
;this.fireDataEvent(l,{initial:this.__Lv,remaining:x.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__Lx(w);}
,this,this.getInterElementTimeout());}
,__Ly:function(){var A={};for(var name in this.__FD){A[name]={};}
;return A;}
,__Lz:function(e){this.__Lv=e.getData();this.render();}
},destruct:function(){for(var name in this.__FD){this.__FD[name].dispose();}
;this.__Lw=this.__FD=this.__Ls=null;}
});}
)();
...
(function(){var e="getElementCount() is abstract",d="abstract",c="qx.ui.progressive.model.Abstract",b="getNextElement() is abstract",a="qx.event.type.Data";qx.Class.define(c,{type:d,extend:qx.core.Object,events:{"dataAvailable":a},members:{getElementCount:function(){throw new Error(e);}
,getNextElement:function(){throw new Error(b);}
}});}
)();
(function(){var b="qx.ui.progressive.model.Default",a="dataAvailable";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__Cq=[];}
,members:{__Cq:null,addElements:function(c){this.__Cq=this.__Cq.concat(c);this.fireDataEvent(a,this.__Cq.length);}
,addElement:function(d){this.__Cq.push(d);this.fireDataEvent(a,this.__Cq.length);}
,getElementCount:function(){return this.__Cq.length;}
,getNextElement:function(){if(this.__Cq.length>0){return ({element:this.__Cq.shift(),remaining:this.__Cq.length});}
;return null;}
},destruct:function(){this.__Cq=null;}
});}
)();
(function(){var c="qx.ui.progressive.renderer.Abstract",b="render() is abstract",a="abstract";qx.Class.define(c,{type:a,extend:qx.core.Object,members:{render:function(d,e){throw new Error(b);}
,join:function(f,name){}
}});}
)();
(function(){var l="content",k="px",j="  font-size: 11px;",h="px ",g=';',f='',d="padding: ",c="end",b="div",a="  position: absolute;",bh="qx.tableResizeDebug",bg="  width : 100%;",bf="__columnData",be="Renderer is already joined to a Progressive.",bd="css.boxmodel",bc="  top: 0px;",bb="qx.debug",ba="  overflow:hidden;",Y=" {",X="  border-right:1px solid #f2f2f2;",s="Invalid location: ",t="  cursor:default;",q="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",r="-row {",o="resize",p="start",m="relative",n=": width=",w=':ellipsis;',x=':',F="  white-space:nowrap;",D="  padding : 0px 6px 0px 6px;",N="qx.ui.progressive.renderer.table.Row",I="progressive-table-row-background-odd",T="  height: 100%;",R="__nN",z="progressive-table-row-background-even",W="col ",V="__Jr",U="  border-bottom:1px solid #eeeeee;",y="left: ",B="No existing renderer for column ",C="css.userselect.none",E=")",G="css.userselect",J="css.textoverflow",O="}",S="",u="width: ",v=" out of range (max: ",A="0px ",M="qx-progressive-",L="Column ",K="-row",Q="-col-",P="px;",H=".qx-progressive-";qx.Class.define(N,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bi){qx.ui.progressive.renderer.Abstract.call(this);this.__Jp=bi;this.__Jq={};this.__Jr=new qx.ui.progressive.renderer.table.cell.Default();this.__Js=null;this.__Jt={};var bj=qx.theme.manager.Color.getInstance();this.__Jt.bgcol=[];this.__Jt.bgcol[0]=bj.resolve(z);this.__Jt.bgcol[1]=bj.resolve(I);this.__nN=new qx.ui.layout.HBox();this.__nN.connectToWidget(this);}
,statics:{__nc:null,__Ju:6,__Jv:a+bc+T+ba+(qx.core.Environment.get(J)?qx.lang.String.hyphenate(qx.core.Environment.get(J))+w:S)+F+X+U+D+t+j+q+(qx.core.Environment.get(G)?qx.lang.String.hyphenate(qx.core.Environment.get(G))+x+qx.core.Environment.get(C)+g:f)},properties:{defaultRowHeight:{init:16}},members:{__Js:null,__BF:null,__Jw:null,__Jp:null,__Jq:null,__Jr:null,__Jt:null,__nN:null,join:function(bk,name){if(this.__Js){throw new Error(be);}
;this.__Js=bk;this.__BF=name;var bm=qx.ui.progressive.renderer.table.Row;if(!bm.__nc){bm.__nc={};}
;var bl=bk.toHashCode();if(!bm.__nc[bl]){bm.__nc[bl]={rowstylesheet:null,cellstylesheet:[]};var bn=H+bl+r+bg+O;bm.__nc[bl].rowstylesheet=qx.bom.Stylesheet.createElement(bn);var bo=this.__Jp.getData();for(var i=0;i<bo.length;i++){var bn=H+bl+Q+i+Y+bm.__Jv+O;bm.__nc[bl].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bn);}
;this.__Jw=bl;var bp=bk.getStructure().getPane();bp.addListener(o,this._resizeColumns,this);}
;}
,addRenderer:function(bq,br){var bs=this.__Jp.getData();if(bq<0||bq>=bs.length){throw new Error(L+bq+v+(bs.length-1)+E);}
;this.__Jq[bq]=br;}
,removeRenderer:function(bt){var bu=this.__Jp.getData();if(bt<0||bt>=bu.length){throw new Error(L+bt+v+(bu.length-1)+E);}
;if(!this.__Jq[bt]){throw new Error(B+bt);}
;delete this.__Jq[bt];}
,render:function(bv,bw){var bG=bw.data;var bB=[];var bD;var bC;var bz=0;if(bv.getRendererData()[this.__BF].end===undefined){bv.getRendererData()[this.__BF]={end:0,start:1,rows:0,totalHeight:0};}
;var bF=document.createElement(b);for(var i=0;i<bG.length;i++){var bA=M+this.__Jw+Q+i;bC=this.__Jq[i]||this.__Jr;bD={state:bv,rowDiv:bF,stylesheet:bA,element:bw,dataIndex:i,cellData:bG[i],height:bz};bB.push(bC.render(bD));if(bD.height>bz){bz=bD.height;}
;}
;bz=(bz>0?bz:this.getDefaultRowHeight());var bE=bv.getRendererData()[this.__BF];bE.totalHeight+=bz;bF.style.position=m;bF.style.height=bz+k;bF.className=M+this.__Jw+K;bF.innerHTML=bB.join(S);switch(bw.location){case c:var bx=bE.end||0;bF.style.backgroundColor=this.__Jt.bgcol[bx];bE.end=(bx==0?1:0);bv.getPane().getContentElement().getDomElement().appendChild(bF);break;case p:var by=bv.getPane().getContentElement().getDomElement();var bH=by.childNodes;if(bH.length>0){var bx=bE.start;bF.style.backgroundColor=this.__Jt.bgcol[bx];bE.start=(bx==0?1:0);by.insertBefore(bF,bH[0]);break;}
else {by.appendChild(bF);}
;break;default:throw new Error(s+bw.location);};++bE.rows;}
,getLayoutChildren:function(){return this.__Jp.getData();}
,_resizeColumns:function(e){var bP=this.__Js.getStructure().getPane();var bM=bP.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();var bN=H+this.__Jw+K;var bJ=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bJ.__nc[this.__Jw].rowstylesheet,bN);var bL=u+bM+P;qx.bom.Stylesheet.addRule(bJ.__nc[this.__Jw].rowstylesheet,bN,bL);this.__nN.renderLayout(bM,100);var bO=this.__Jp.getData();for(var i=0,bS=0;i<bO.length;i++,bS+=bM){var bN=H+this.__Jw+Q+i;var bJ=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bJ.__nc[this.__Jw].cellstylesheet[i],bN);bM=bO[i].getComputedWidth();if(qx.core.Environment.get(bb)){if(qx.core.Environment.get(bh)){this.debug(W+i+n+bM);}
;}
;var bK;if(qx.core.Environment.get(bd)==l){bK=qx.ui.progressive.renderer.table.Row.__Ju*2;}
else {bK=-1;}
;var bR=(bM-bK)+P;var bQ=A+qx.ui.progressive.renderer.table.Row.__Ju+h+A+qx.ui.progressive.renderer.table.Row.__Ju+P;var bI=bS+P;var bL=bJ.__Jv+u+bR+y+bI+d+bQ;qx.bom.Stylesheet.addRule(bJ.__nc[this.__Jw].cellstylesheet[i],bN,bL);}
;}
},destruct:function(){var name;for(name in this.__Jq){this.__Jq[name]=null;}
;var bU=qx.ui.progressive.renderer.table.Row;var bT=this.__Js.toHashCode();if(bU.__nc&&bU.__nc[bT]){if(bU.__nc[bT].rowstylesheet){var bW=H+this.__Jw+K;var bU=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bU.__nc[this.__Jw].rowstylesheet,bW);}
;if(bU.__nc[bT].cellstylesheet){for(var i=bU.__nc[bT].cellstylesheet.length-1;i>=0;i--){var bW=H+this.__Jw+Q+i;var bV=bU.__nc[this.__Jw].cellstylesheet[i];var bU=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV,bW);}
;}
;}
;if(this.__Js&&this.__Js.getRendererData){var bX=this.__Js.getRendererData();if(bX&&bX[this.__BF]&&bX[this.__BF].end!==undefined){bX[this.__BF]=null;}
;}
;this.__Jt=this.__Jq=this.__Js=this.__Jp=null;this._disposeObjects(R,V,bf);}
});}
)();
...
(function(){var t=" height='",s="vertical-align:middle;",r="text-align:center;",q="abstract",p="",o='<img ',n=" style='padding-top:2px;'",m='" style="filter:',l=" title='",k=" width='",d="qx.ui.progressive.renderer.table.cell.Icon",j="'",g="_identifyImage() is abstract",c=">",b="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",f="qx/static/blank.gif",e="',sizingMethod='scale')",h="px'",a='" ',i='src="';qx.Class.define(d,{type:q,extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(){qx.ui.progressive.renderer.table.cell.Abstract.call(this);var u=qx.util.AliasManager.getInstance();var v=qx.util.ResourceManager.getInstance();var w=u.resolve(f);this.__IN=v.toUri(w);}
,members:{__IN:null,getBlankImage:function(){return this.__IN;}
,_identifyImage:function(x){throw new Error(g);}
...
,_getContentHtml:function(A){var B=[];var C=this.__IO(A);B.push(o);if(qx.bom.element.Decoration.isAlphaImageLoaderEnabled()&&/\.png$/i.test(C.url)){B.push(i,this.__IN,m,b,C.url,e,a);}
else {B.push(i,C.url,a);}
;if(C.imageWidth){B.push(k,C.imageWidth,h);}
;if(C.imageHeight){B.push(t,C.imageHeight,h);}
;B.push(n);if(C.tooltip){B.push(l,C.tooltip,j);}
;if(C.extras){B.push(C.extras);}
;B.push(c);return B.join(p);}
,__IO:function(D){var E=this._identifyImage(D);if(E==null||typeof E=="string"){E={url:E,tooltip:null};}
;if(E.url==null){E.url=this.__IN;}
;return E;}
}});}
)();
(function(){var c="qx.ui.progressive.renderer.table.cell.Image",b="string",a="";qx.Class.define(c,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(d,e){qx.ui.progressive.renderer.table.cell.Icon.call(this);if(d===undefined){this.__qq=d;}
else {this.__qq=16;}
;if(e===undefined){this.__qr=e;}
else {this.__qr=16;}
;}
,members:{__qq:null,__qr:null,_identifyImage:function(f){var j={imageWidth:this.__qq,imageHeight:this.__qr};var k;if(typeof (f.cellData)==b){j.url=f.cellData;}
else {j.url=f.cellData.url;j.tooltip=f.cellData.tooltip;k=f.cellData.height;}
;if(j.url==a){j.url=this._imageBlank;}
else {var i=qx.util.AliasManager.getInstance();var h=qx.util.ResourceManager.getInstance();var g=i.resolve(j.url);j.url=h.toUri(g);}
;if(k){f.height=k;}
;return j;}
}});}
)();
