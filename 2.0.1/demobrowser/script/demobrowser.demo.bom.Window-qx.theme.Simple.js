...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Window","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window-qx.theme.Simple.e3df296faaba.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var q="Open Native Window",p="Open Native Modal Window",o="demobrowser.demo.bom.Window",n="Modal Window closed?",m="http://sourceforge.net",l="window1",k="window3",j="http://slashdot.org",i="Window closed?",h="http://qooxdoo.org",c="demobrowser/demo/html/ModalWindow.html",g="Open Faked Native Modal Window",f="window2",b="#eee",a="click",d="button";qx.Class.define(o,{extend:qx.application.Native,members:{__BI:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__BI=[h,m,j,r.toUri(c)];var u=qx.bom.Input.create(d);qx.bom.Input.setValue(u,q);document.body.appendChild(u);qx.event.Registration.addListener(u,a,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__BI[0],l,x);}
...
,this);var s=qx.bom.Input.create(d);qx.bom.Input.setValue(s,p);document.body.appendChild(s);qx.event.Registration.addListener(s,a,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__BI[3],f,y,true);}
...
,this);var v=qx.bom.Input.create(d);qx.bom.Input.setValue(v,g);document.body.appendChild(v);qx.event.Registration.addListener(v,a,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(b);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__BI[0],k,A,true,false);}
,this);}
...
(function(){var t="Cross-Domain Scripting problem: Could not move window!",s="no",r="' is not supported for modal windows.",q="yes",p="",o="' is not supported for native windows.",n="qx.bom.Window",m="interval",l="Cross-Domain Scripting problem: Could not resize window!",k="resizable",d="scrollbars",j="px",g="javascript:/",c=":",b=";",f="qxNativeWindow",e=",",h='load',a="=",i="Option '";qx.Class.define(n,{statics:{__jI:null,__MV:null,__iG:null,__MW:{"top":"dialogTop",left:"dialogLeft",width:"dialogWidth",height:"dialogHeight",scrollbars:"scroll",resizable:"resizable"},__MX:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__MY:function(){return window.showModalDialog!=null;}
,open:function(u,name,v,w,x,y,self){var C=null;if(u==null){u=g;}
;if(name==null){name=f+new Date().getTime();}
;if(x==null){x=true;}
;var z=this.__Na(v,w&&x);if(w){if(this.__MY()&&x){C=window.showModalDialog(u,[window.self],z);}
else {this.getBlocker().block();if(this.__iG==null){this.__iG=new qx.event.Timer(500);this.__iG.addListener(m,this.__Nb,this);}
;this.__MV=window.open(u,name,z);this.__iG.restart();C=this.__MV;}
;}
...
;return C;}
,__Na:function(D,E){var F;var I;var G=[];if(E&&this.__MY()){for(var H in D){if(qx.bom.Window.__MW[H]){var J=p;if(H!=d&&H!=k){J=j;}
;I=qx.bom.Window.__MW[H]+c+D[H]+J;G.push(I);}
else {qx.log.Logger.warn(i+H+r);}
;}
;F=G.join(b);}
else {for(var H in D){if(qx.bom.Window.__MX[H]){if(qx.lang.Type.isBoolean(D[H])){I=H+a+(D[H]?q:s);}
else {I=H+a+D[H];}
;G.push(I);}
else {qx.log.Logger.warn(i+H+o);}
;}
;F=G.join(e);}
;return F;}
,__Nb:function(){if(this.isClosed(this.__MV)){this.getBlocker().unblock();this.__iG.stop();}
;}
,getBlocker:function(){if(this.__jI==null){this.__jI=new qx.bom.Blocker;}
;return this.__jI;}
...
,members:{__Nc:null,__wa:null,__Nd:null,__Ne:false,__Nf:10000,__Ng:0,__Nh:p,block:function(q){if(!this.__Ne){this.__Nd=q;var r=this.__Nk();this.__Nl(r);this.__Ne=true;}
;}
,unblock:function(){if(this.__Ne){this.__Nm();this.__Ne=false;}
;}
,isBlocked:function(){return this.__Ne;}
,getBlockerElement:function(){return this.__wa;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__wa,h,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wa,h);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wa,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wa);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wa,c,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wa,c);}
...
,__Ni:function(){this.__wa=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wa,{display:g,opacity:this.__Ng,backgroundColor:this.__Nh});this.setBlockerZIndex(this.__Nf);}
...
;return v;}
,__Nl:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wa,w);qx.dom.Element.insertEnd(this.__wa,x);if((qx.core.Environment.get(d)==f)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Nc,w);qx.dom.Element.insertEnd(this.__Nc,document.body);}
;}
,__Nm:function(){qx.dom.Element.remove(this.__wa);if((qx.core.Environment.get(d)==f)){qx.dom.Element.remove(this.__Nc);}
;}
...
,this,0);}
;}
,__Nn:function(z){qx.bom.element.Style.setStyles(this.__wa,z);if((qx.core.Environment.get(d)==f)){qx.bom.element.Style.setStyles(this.__Nc,z);}
;}
,__No:function(){return (this.__Nd==null||qx.dom.Node.isWindow(this.__Nd)||qx.dom.Node.isDocument(this.__Nd));}
},destruct:function(){qx.event.Registration.removeListener(window,i,this.__jP,this);this.__Nc=this.__wa=this.__Nd=null;}
});}
)();
