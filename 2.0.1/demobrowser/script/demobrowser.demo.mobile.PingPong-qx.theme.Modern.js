...
var envinfo = {"engine.name":"webkit","locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.mobile.emulatetouch":true,"qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Modern.8b9b3f53aa2b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var H=this.__Qx(u);M.add(H);var I=this.__Qx(v);M.add(I);this.__Ql=this.__Qy(u);H.add(this.__Ql);H.addListener(E,qx.lang.Function.bind(this.__Dy,this,this.__Ql),this);this.__Qk=this.__Qy(v);I.add(this.__Qk);I.addListener(E,qx.lang.Function.bind(this.__Dy,this,this.__Qk),this);this.__Qm=this.__Qz();M.add(this.__Qm);this.__Qs=this.__QA();H.add(this.__Qs);this.__Qt=this.__QA();I.add(this.__Qt);this.__Qr=[0,0];this.__Qu();}
...
;}
,__Dy:function(R,e){R.setStyles({"top":(e.getDocumentTop()-50)+q});}
