...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Resizer","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Resizer-qx.theme.Simple.519218d8382f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var c='Option number ',b="demobrowser.demo.widget.Resizer",a="Resize me\nI'm resizable";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this.getRoot().add(this._getResizer(),{left:20,top:20});this.getRoot().add(this._getResizerList(),{left:400,top:20});}
,_getResizerList:function(){var d=new qx.ui.form.List().set({width:100,height:200,minWidth:50,minHeight:100,maxHeight:400,maxWidth:500});for(var i=0;i<100;i++){d.add(new qx.ui.form.ListItem(c+i));}
;var e=new qx.ui.container.Resizer();e.setLayout(new qx.ui.layout.Grow());e.add(d);return e;}
,_getResizer:function(){var f=new qx.ui.form.TextArea;f.setValue(a);var g=new qx.ui.container.Resizer().set({minWidth:100,minHeight:50,width:200,height:100,resizableTop:false,resizableLeft:false});g.setLayout(new qx.ui.layout.Canvas());g.add(f,{top:0,right:0,bottom:0,left:0});return g;}
}});}
)();
...
(function(){var b="resizer",a="qx.ui.container.Resizer";qx.Class.define(a,{extend:qx.ui.container.Composite,include:qx.ui.core.MResizable,properties:{appearance:{refine:true,init:b}}});}
)();
