...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Environment-qx.theme.Modern.c460c97fc120.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.bom.client.OperatingSystem.getName();return (G==c||G==e)&&qx.bom.client.Flash.__Jo(w,H);}
,getStrictSecurityModel:function(){var I=qx.bom.client.Flash.getVersion();if(I==m){return false;}
;var J=I.split(l);if(J[0]<10){return qx.bom.client.Flash.__Jo(u,I);}
else {return qx.bom.client.Flash.__Jo(d,I);}
;}
,_cachedSupportsVersion:{},__Jo:function(K,L){var O=K.split(l);var N=L||qx.bom.client.Flash.getVersion();N=N.split(l);for(var i=0;i<O.length;i++){var M=parseInt(N[i],10)-parseInt(O[i],10);if(M>0){return true;}
