...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ComboBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox-qx.theme.Simple.f51fa06052e3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var y=" = ",x="... &gt; (as literal HTML entity)",w="... &gt; (as Richtext)",v="ChangeValue: ",u="icon",t="<u>Underlined Text</u>",s="label",r="'s Icon",q="demobrowser.demo.virtual.ComboBox",p="With icons",h="Default",o="changeValue",l="2^ ",f="<i>Italic Text</i>",d="<b>Bold Text</b>",k="HTML entities: &laquo; &lt; &amp; &gt; &raquo;",j="Item ",m="Sorted and filtered model",c="With HTML (rich) text",n="icon/16/places/folder.png",g="bold";qx.Class.define(q,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this._createDefaultExample();this._createIconExample();this._createWideExample();this._createHtmlExample();}
,_createDefaultExample:function(){var C=new qx.ui.basic.Label(h);C.setFont(g);this.getRoot().add(C,{left:20,top:20});var z=new qx.ui.form.VirtualComboBox();var B=[];for(var i=1;i<401;i++){B.push(l+i+y+Math.pow(2,i));}
;var A=qx.data.marshal.Json.createModel(B);z.setModel(A);z.addListener(o,function(e){this.debug(v+e.getData());}
);this.getRoot().add(z,{left:20,top:40});}
,_createIconExample:function(){var G=new qx.ui.basic.Label(p);G.setFont(g);this.getRoot().add(G,{left:160,top:20});var D=new qx.ui.form.VirtualComboBox();var F=[];for(var i=1;i<31;i++){F.push({label:i+r,icon:n});}
;var E=qx.data.marshal.Json.createModel(F);D.setModel(E);D.setLabelPath(s);D.setIconPath(u);this.getRoot().add(D,{left:160,top:40});}
,_createHtmlExample:function(){var L=new qx.ui.basic.Label(c);L.setFont(g);this.getRoot().add(L,{left:300,top:20});var H=new qx.ui.form.VirtualComboBox().set({width:200});var J=[x,w,d,t,f,k];var I=qx.data.marshal.Json.createModel(J);H.setModel(I);var K={configureItem:function(M){M.setRich(true);}
...
,_createWideExample:function(){var P=new qx.ui.basic.Label(m);P.setFont(g);this.getRoot().add(P,{left:20,top:280});var O=new qx.ui.form.VirtualComboBox();var S=[];for(var i=1;i<100;i++){S.push(j+i);}
