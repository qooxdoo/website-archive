...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.GroupBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.GroupBox-qx.theme.Indigo.751889f5b442.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var n="demobrowser.demo.widget.GroupBox",m="Expert Settings",l="Show debugging console",k="Enable code completion",j="Default Settings",i="frame",h="Show debugging content",g="icon/16/apps/utilities-text-editor.png",f="Custom Settings",e="Code Assist",b="Advanced Settings",d="",c="legend",a="Option #1";qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.layout.VBox();r.setSpacing(20);var q=new qx.ui.container.Composite(r);q.setPadding(20);this.getRoot().add(q,{left:0,top:0});var x=new qx.ui.groupbox.GroupBox(e,g);q.add(x);x.setLayout(new qx.ui.layout.VBox());x.add(new qx.ui.form.CheckBox(h));x.add(new qx.ui.form.CheckBox(k));x.add(new qx.ui.form.CheckBox(l));var z=new qx.ui.groupbox.CheckGroupBox(m);q.add(z);z.setLayout(new qx.ui.layout.HBox(12));var s=new qx.ui.basic.Label(a);z.add(s);var p=new qx.ui.form.TextField(d);z.add(p);var u=new qx.ui.container.Composite(new qx.ui.layout.VBox());q.add(u);var w=new qx.ui.form.RadioButton(j);w.setMarginLeft(9);u.add(w);var v=new qx.ui.form.RadioButton(f);v.setMarginLeft(9);u.add(v);var y=new qx.ui.groupbox.RadioGroupBox(b);y.getChildControl(c).setMarginTop(0);y.getChildControl(c).setPaddingTop(0);y.getChildControl(i).setMarginTop(14);y.setLayout(new qx.ui.layout.HBox(12));u.add(y);new qx.ui.form.RadioGroup(w,v,y);var t=new qx.ui.basic.Label(a);y.add(t);var o=new qx.ui.form.TextField(d);y.add(o);}
}});}
)();
