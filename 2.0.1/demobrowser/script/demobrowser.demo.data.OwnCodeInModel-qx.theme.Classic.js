...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.OwnCodeInModel","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.OwnCodeInModel-qx.theme.Classic.e22d2a9fccbe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="icon/16/mimetypes/",q="name",p="demobrowser/demo/data/list.json",o="model",n="model.items",m="demobrowser.demo.data.OwnCodeInModel",l=".png",k="type",j="Using the delegation to bring two sort function to the root model ",i="Sort By Name",e="items",h="class of this demo. The buttons just calling those sort functions.",g="<b>Adding own code to the model</b><br/>",d="demobrowser.demo.data.ItemsMixin",c="Sort By Type",f="execute";qx.Class.define(m,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var t=new qx.ui.form.List();this.getRoot().add(t,{left:10,top:80});var w=new qx.data.controller.List(null,t);w.setLabelPath(q);w.setIconOptions({converter:function(A){return r+A+l;}
});w.setIconPath(k);var x={getModelMixins:function(B){if(B==e){return demobrowser.demo.data.ItemsMixin;}
;}
};var s=qx.util.ResourceManager.getInstance().toUri(p);var z=new qx.data.store.Json(s,x);z.bind(n,w,o);var y=new qx.ui.form.Button(c);y.setWidth(120);this.getRoot().add(y,{left:130,top:80});y.addListener(f,function(){z.getModel().sortByType();}
,this);var v=new qx.ui.form.Button(i);v.setWidth(120);this.getRoot().add(v,{left:130,top:110});v.addListener(f,function(){z.getModel().sortByName();}
,this);var u=new qx.ui.basic.Label();u.setRich(true);u.setWidth(410);u.setValue(g+j+h);this.getRoot().add(u,{left:10,top:10});}
}});qx.Mixin.define(d,{members:{sortByType:function(){var C=this.getItems();C.sort(function(a,b){if(a.getType()>b.getType()){return 1;}
else if(a.getType()<b.getType()){return -1;}
else {return 0;}
;}
);}
,sortByName:function(){var D=this.getItems();D.sort(function(a,b){return a.getName()>b.getName()?1:-1;}
);}
}});}
)();
