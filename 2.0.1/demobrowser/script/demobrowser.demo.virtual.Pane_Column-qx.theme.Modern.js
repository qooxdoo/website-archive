...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Pane_Column-qx.theme.Modern.92ec008bd26d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var h="demobrowser.demo.virtual.Pane_Column",g="Even/Odd Colors",f="Custom Colors",e="Even/Odd & Custom Colors",d="white",c="#EEE",b="bold",a="table-scroller-header";qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var k=new qx.ui.layout.Grid(5,0);k.setRowFlex(1,1);k.setColumnFlex(0,1);k.setColumnFlex(1,1);k.setColumnFlex(2,1);var j=new qx.ui.container.Composite(k);this.getRoot().add(j,{edge:0});j.add(new qx.ui.basic.Label(g).set({font:b,decorator:a,padding:3,allowGrowX:true}),{row:0,column:0});var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);m.getPane().addLayer(new qx.ui.virtual.layer.Column(d,c));j.add(m,{row:1,column:0});j.add(new qx.ui.basic.Label(f).set({font:b,decorator:a,padding:3,allowGrowX:true}),{row:0,column:1});var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);var l=new qx.ui.virtual.layer.Column();for(var i=0;i<10000;i++){l.setColor(i,qx.util.ColorUtil.randomColor());}
;m.getPane().addLayer(l);j.add(m,{row:1,column:1});j.add(new qx.ui.basic.Label(e).set({font:b,decorator:a,padding:3,allowGrowX:true}),{row:0,column:2});var m=new qx.ui.virtual.core.Scroller(100,10000,60,60);var l=new qx.ui.virtual.layer.Column(d,c);for(var i=0;i<10000;i++){if(Math.random()>0.7){l.setColor(i,qx.util.ColorUtil.randomColor());}
;}
;m.getPane().addLayer(l);j.add(m,{row:1,column:2});}
}});}
)();
