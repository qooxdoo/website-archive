...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Separator-qx.theme.Simple.1df6cda724d6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,__CL:{north:1,south:2,west:3,east:4,center:5},__CM:{'1':"top",'2':"bottom",'3':"left",'4':"right"},__kQ:function(){var F=this._getLayoutChildren();var N,H;var length=F.length;var J=[];var M=[];var K=[];var G=this.getSort()===v;var L=this.getSort()===l;for(var i=0;i<length;i++){N=F[i];K=N.getLayoutProperties().edge;if(K===w){if(H){throw new Error(j);}
;H=N;}
...
;this.__dW=O;var I=[];for(var i=0;i<length;i++){K=O[i].getLayoutProperties().edge;I[i]=this.__CL[K]||5;}
;this.__BQ=I;delete this._invalidChildrenCache;}
,renderLayout:function(P,Q){if(this._invalidChildrenCache){this.__kQ();}
;var bk=qx.ui.layout.Util;var W=this.__dW;var bl=this.__BQ;var length=W.length;var ba,S,Y,bf,bg,bq,bd,T,bn;var bu=[];var bc=[];var bt=this._getSeparatorWidths();var by=this.getSpacingX();var bx=this.getSpacingY();var X=-by;var bm=-bx;if(bt.x){X-=bt.x+by;}
;if(bt.y){bm-=bt.y+bx;}
...
;var bP=this.__dW;var ca=this.__BQ;var length=bP.length;var bT,cb;var bV,bU;var bW=0,ci=0;var bM=0,cd=0;var bX=0,ch=0;var bN=0,cc=0;var ce=this._getSeparatorWidths();var cg=this.getSpacingX(),cf=this.getSpacingY();var bR=-cg,bQ=-cf;if(ce.x){bR-=ce.x+cg;}
;if(ce.y){bQ-=ce.y+cf;}
...
},destruct:function(){this.__BQ=this.__dW=null;}
});}
)();
