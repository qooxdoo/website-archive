...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_Percent","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VBox_Percent-qx.theme.Modern.1c86f35b1402.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="demobrowser.demo.layout.VBox_Percent",e="50%",d="yellow",c="33%",b="green",a="main";qx.Class.define(f,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var g=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});scroll.add(g);g.add(this.getBox1());g.add(this.getBox2());g.add(this.getBox3());g.add(this.getBox4());g.add(this.getBox5());g.add(this.getBox6());}
,getBox1:function(){var h=new qx.ui.layout.VBox();var j=new qx.ui.container.Composite(h).set({decorator:a,backgroundColor:d,height:300,allowGrowY:false});h.setSpacing(5);var l=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var k=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var i=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});j.add(l,{height:e});j.add(k,{flex:1});j.add(i,{flex:1});return j;}
,getBox2:function(){var m=new qx.ui.layout.VBox();var o=new qx.ui.container.Composite(m).set({decorator:a,backgroundColor:d,height:300,allowGrowY:false});m.setSpacing(5);var q=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var p=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var n=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});o.add(q,{height:c});o.add(p,{height:c});o.add(n,{height:c,flex:1});return o;}
,getBox3:function(){var r=new qx.ui.layout.VBox();var t=new qx.ui.container.Composite(r).set({decorator:a,backgroundColor:d,allowGrowY:false});r.setSpacing(5);var v=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var s=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});t.add(v,{height:e});t.add(u,{flex:1});t.add(s,{flex:1});return t;}
,getBox4:function(){var w=new qx.ui.layout.VBox();var y=new qx.ui.container.Composite(w).set({decorator:a,backgroundColor:d,allowGrowY:false});w.setSpacing(5);var A=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var z=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var x=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});y.add(A,{height:c,flex:1});y.add(z,{height:c,flex:1});y.add(x,{height:c,flex:1});return y;}
,getBox5:function(){var B=new qx.ui.layout.VBox();var D=new qx.ui.container.Composite(B).set({decorator:a,backgroundColor:d,height:100,allowGrowY:false});B.setSpacing(5);var F=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var E=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var C=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});D.add(F,{height:c,flex:1});D.add(E,{height:c,flex:1});D.add(C,{height:c,flex:1});return D;}
,getBox6:function(){var G=new qx.ui.layout.VBox();var I=new qx.ui.container.Composite(G).set({decorator:a,backgroundColor:d,height:300,allowGrowY:false});G.setSpacing(5);var K=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var J=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var H=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});I.add(K,{height:c,flex:1});I.add(J,{height:c,flex:1});I.add(H,{height:c,flex:1});return I;}
}});}
)();
