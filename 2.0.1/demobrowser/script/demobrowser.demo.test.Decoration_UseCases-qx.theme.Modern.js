...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Decoration_UseCases-qx.theme.Modern.4b76c1c72f86.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var j="backgroundColor",i="demobrowser/demo/test/logo.gif",h="qx/decoration/Modern/cursors/alias.gif",g="scale",f="<div style='position:absolute;left:600px;top:1100px;font-size:36px;font-weight:bold;color:red'>Scaled Clipped Alpha PNG</div>",e="demobrowser/demo/test/demobrowser_thumb.png",d="41px",c="500px",b="136px",a="scale-y",S="qx/decoration/Modern/app-header.png",R="scale-x",Q="qx/icon/Tango/22/places/folder-open.png",P="<div style='position:absolute;left:600px;top:20px;font-size:36px;font-weight:bold;color:red'>Single PNG</div>",O="demobrowser/demo/test/alphaPNG.png",N="400px",M="qx/decoration/Modern/form/checkbox-focused.png",L="<div style='position:absolute;left:600px;top:230px;font-size:36px;font-weight:bold;color:red'>Clipped PNG</div>",K="120px",J="250px",q="15px",r="<div style='position:absolute;left:600px;top:1700px;font-size:36px;font-weight:bold;color:red'>Clipped GIF</div>",o="<div style='position:absolute;left:600px;top:1400px;font-size:36px;font-weight:bold;color:red'>Single GIF</div>",p="body",m="<div style='position:absolute;left:600px;top:650px;font-size:36px;font-weight:bold;color:red'>Repeated Single Alpha PNG</div>",n="orange",k="<div style='position:absolute;left:600px;top:880px;font-size:36px;font-weight:bold;color:red'>Repeated Clipped Alpha PNG</div>",l="demobrowser.demo.test.Decoration_UseCases",s="450px",t="230px",A="1700px",y="19px",D="420px",C="880px",F="650px",E="50px",v="1100px",I="350px",H="150px",G="1400px",u="repeat-x",w="20px",x="repeat-y",z="no-repeat",B="200px";qx.Class.define(l,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var bh=qx.bom.Collection.query(p);var U=S;var bk=e;var bg=O;var bi=Q;var bj=M;var X=i;var bl=h;var bt=qx.bom.element.Decoration;var bs=bt.create(U,z,{top:w});bh.append(bs);var bp=bt.create(U,u,{width:I,height:w,top:w,left:K});bh.append(bp);var bq=bt.create(U,x,{width:w,height:B,top:w,left:c});bh.append(bq);bh.append(P);var br=bt.create(bk,z,{top:t});bh.append(br);var bb=bt.create(bk,x,{height:N,top:t,left:B});bh.append(bb);bh.append(L);var bd=bt.create(bg,z,{top:F});bh.append(bd);var Y=bt.create(bg,u,{width:I,top:F,left:E});bh.append(Y);var T=bt.create(bg,x,{height:B,top:F,left:D});bh.append(T);bh.append(m);var br=bt.create(bi,z,{top:C});bh.append(br);var ba=bt.create(bi,u,{width:I,top:C,left:E});bh.append(ba);var bb=bt.create(bj,x,{height:B,top:C,left:D});bh.append(bb);bh.append(k);var bc=bt.create(bj,g,{width:H,height:H,top:v});bh.append(bc);var be=bt.create(bj,R,{width:B,top:v,left:B});bh.append(be);var bf=bt.create(bj,a,{height:B,top:v,left:s});bh.append(bf);bh.append(f);var bn=bt.create(X,z,{width:b,height:d,top:G});bh.append(bn);var W=bt.create(X,u,{width:J,top:G,left:H});bh.append(W);var V=bt.create(X,x,{height:B,top:G,left:s});bh.append(V);bh.append(o);var bm=bt.create(bl,z,{width:y,height:q,top:A});bh.append(bm);var bo=bt.create(bl,x,{width:y,height:B,top:A,left:E});bh.append(bo);bh.append(r);bh.setStyle(j,n);}
}});}
)();
