...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.table.Table_Events", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.table.Table_Events-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var v="",u="columnVisibilityMenuCreateEnd",t="Boolean",s="icon/16/actions/edit-cut.png",r="A number",q="changeValue",p="Column",o="sorted",n="tableWidthChanged",m="verticalScrollBarChanged",T="icon/16/actions/edit-copy.png",S="icon/22/actions/media-record.png",R="cellContextmenu",Q="_events",P="Cut",O="_tableModel",N="Table",M="asc",L="icon/16/actions/edit-paste.png",K="columnVisibilityMenuCreateStart",C="cellDblclick",D="_eventsWin",A="Copy",B="Name",y="desc",z="Paste",w="Event log",x="cellClick",E="metaDataChanged",F="demobrowser.demo.table.Table_Events",H="Row",G="A date",J="Capture events",I="ID";
qx.Class.define(F,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return N;
},main:function(){arguments.callee.base.call(this);
var W=this._eventsWin=new qx.ui.window.Window(w).set({height:400,width:290,showClose:false,showMinimize:false,contentPadding:0});
W.setLayout(new qx.ui.layout.Canvas());
W.open();
this.getRoot().add(W,{left:670,top:10});
this._events=new qx.ui.table.model.Simple();
this._events.setColumns([B,H,p]);
this._events.setData([]);
var V=new qx.ui.table.Table(this._events);
V.getTableColumnModel().setColumnWidth(0,150);
V.getTableColumnModel().setColumnWidth(1,60);
V.getTableColumnModel().setColumnWidth(2,60);
W.add(V,{edge:0});
},createTable:function(){var j=this.createRandomRows(50);
var f=this._tableModel=new qx.ui.table.model.Simple();
f.setColumns([I,r,G,t]);
f.setData(j);
f.setColumnEditable(1,true);
f.setColumnEditable(2,true);
var k=new qx.ui.table.Table(f);
k.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var g=k.getTableColumnModel();
g.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
var l=function(e){this._events.addRows([[e.getType(),v,v,v]],0);
};
var i=function(e){this._events.addRows([[e.getType(),e.getRow(),e.getColumn()]],0);
};
var h=function(e){var U=e.getData();
this._events.addRows([[e.getType(),U.ascending?M:y,U.columnIndex]],0);
};
k.addListener(K,l,this);
k.addListener(u,l,this);
k.addListener(n,l,this);
k.addListener(m,l,this);
k.addListener(x,i,this);
k.addListener(C,i,this);
k.addListener(R,i,this);
f.addListener(o,h,this);
f.addListener(E,l,this);
k.setContextMenu(this.getContextMenu());
return k;
},createControls:function(){var ba=new qx.ui.toolbar.ToolBar();
var X,Y,bb;
Y=new qx.ui.toolbar.Part();
ba.add(Y);
X=new qx.ui.toolbar.CheckBox(J,S).set({value:true});
Y.add(X);
X.addListener(q,function(e){if(X.isValue()){this._events.setData([]);
this._eventsWin.open();
}else{this._eventsWin.close();
}},this);
return ba;
},getContextMenu:function(){var a=new qx.ui.menu.Menu();
var c=new qx.ui.menu.Button(P,s);
var d=new qx.ui.menu.Button(A,T);
var b=new qx.ui.menu.Button(z,L);
a.add(c);
a.add(d);
a.add(b);
return a;
}},destruct:function(){this._disposeObjects(O,D,Q);
}});
})();
