...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.legacy.EmbedFuture_Layout-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var h="auto",g="black",f="gray",d="demobrowser.demo.legacy.EmbedFuture_Layout",c="Resize HBox",b="100%",a="execute";
qx.Class.define(d,{extend:qx.legacy.application.Gui,members:{main:function(){arguments.callee.base.call(this);
qx.theme.manager.Meta.getInstance().initialize();
var i=new qx.legacy.ui.form.Button(c);
var j=new qx.legacy.ui.embed.Future().set({width:h,height:b,content:this.getGrid()});
var l=new qx.legacy.ui.layout.HorizontalBoxLayout();
l.set({top:10,left:10,height:h,width:h,backgroundColor:f,border:g,spacing:10,padding:5});
l.add(i,j);
l.addToDocument();
var k=true;
i.addListener(a,function(e){l.setHeight(k?300:h);
k=!k;
},this);
...
(function(){var k="qx.legacy.ui.embed.Future",j="_applyContent",i="qx.ui.core.Widget",h="_root",g="hidden",f="div";
qx.Class.define(k,{extend:qx.legacy.ui.basic.Terminator,construct:function(){arguments.callee.base.call(this);
this.set({overflow:g,minWidth:0,minHeight:0});
},properties:{content:{check:i,apply:j,init:null,nullable:true}},members:{_applyContent:function(n,o){if(this._root){if(o){this._root.remove(o);
}
if(n){this._root.add(n);
...
}},_changeInnerWidth:function(d,e){arguments.callee.base.call(this,d,e);
this._setPaneWidth(this.getBoxWidth());
},_changeInnerHeight:function(l,m){arguments.callee.base.call(this,l,m);
this._setPaneHeight(this.getBoxHeight());
},_setPaneWidth:function(a){if(this._root){this._root.setWidth(a);
}},_setPaneHeight:function(p){if(this._root){this._root.setHeight(p);
}},_afterAppear:function(){var b=this.getElement();
var c=document.createElement(f);
b.appendChild(c);
this._root=new qx.ui.root.Inline(c).set({minWidth:0,minHeight:0});
