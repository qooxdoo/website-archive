...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.SelectBox_EdgeCases", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.SelectBox_EdgeCases-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var t="Times New Roman",s="Long list",r="Long button, short text",q="",p="Fonts",o="container",n="Font ",m="Tahoma",l="Courier New",k="Item ",h="Arial",j="demobrowser.demo.test.SelectBox_EdgeCases";
...
u.add(this.container);
this.getRoot().add(u,{edge:0});
this.addBox1();
this.addBox2();
this.addBox3();
},addBox1:function(){this.container.add(new qx.ui.basic.Label(s),{left:25,top:20});
var x=new qx.ui.form.SelectBox();
x.setMaxListHeight(null);

for(var i=0;i<300;i++){var y=new qx.ui.form.ListItem(q+i);
x.add(y);
}this.container.add(x,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(p),{left:25,bottom:45});
var g=new qx.ui.form.SelectBox();
var b=new qx.bom.Font(12,[m]);
var c=new qx.bom.Font(15,[h]);
var a=new qx.bom.Font(18,[l]);
var e=new qx.bom.Font(21,[t]);
var d=[b,c,a,e];

for(var i=0;i<d.length;i++){var f=new qx.ui.form.ListItem(n+(i+1));
f.setFont(d[i]);
g.add(f);
}this.container.add(g,{left:20,bottom:20});
},addBox3:function(){this.container.add(new qx.ui.basic.Label(r),{left:205,top:20});
var v=new qx.ui.form.SelectBox();
v.setWidth(300);
v.setMaxListHeight(100);

for(var i=0;i<20;i++){var w=new qx.ui.form.ListItem(k+i);
