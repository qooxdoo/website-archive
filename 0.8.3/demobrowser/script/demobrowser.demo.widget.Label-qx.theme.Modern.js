...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Label-qx.theme.Modern-0.js"]],
  boot : "boot",
...
return L;
},createEditDialog:function(B,C){var D=new qx.ui.window.Window(C).set({allowMinimize:false,showMinimize:false,allowMaximize:false,showMaximize:false});
D.moveTo(350,20);
var F=new qx.ui.layout.Grid(10,10);
F.setColumnFlex(1,1);
F.setColumnAlign(0,f,k);
D.setLayout(F);
var E=new qx.data.controller.Object(B);
D.add(new qx.ui.basic.Label(t).set({paddingTop:5}),{row:0,column:0});
var G=new qx.ui.form.TextArea().set({liveUpdate:true});
E.addTarget(G,t,t,true);
D.add(G,{row:0,column:1});
D.add(new qx.ui.basic.Label(p),{row:1,column:0});
var H=new qx.ui.form.CheckBox();
E.addTarget(H,t,p,true);
D.add(H,{row:1,column:1});
D.add(new qx.ui.basic.Label(d),{row:2,column:0});
var H=new qx.ui.form.CheckBox();
E.addTarget(H,t,b,true);
D.add(H,{row:2,column:1});
D.add(new qx.ui.basic.Label(o),{row:3,column:0});
var H=new qx.ui.form.CheckBox().set({enabled:false});
E.addTarget(H,t,o);
D.add(H,{row:3,column:1});
return D;
}}});
})();
