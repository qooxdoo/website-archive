...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HBox_NegativeMargin", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.HBox_NegativeMargin-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var u="main",t="yellow",s="gray",r="green",q="top",p="bottom",o="middle",n="blue",m="demobrowser.demo.layout.HBox_NegativeMargin";
qx.Class.define(m,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var H=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(H);
H.add(this.getBox1());
H.add(this.getBox2());
H.add(this.getBox3());
...
H.add(this.getBox6());
H.add(this.getBox7());
},getBox1:function(){var w=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,allowGrowX:false});
var y=new qx.ui.core.Widget().set({decorator:u,backgroundColor:n,maxHeight:50,alignY:q});
var x=new qx.ui.core.Widget().set({decorator:u,backgroundColor:r,maxHeight:50,alignY:o});
var v=new qx.ui.core.Widget().set({decorator:u,backgroundColor:s,maxHeight:50,alignY:p});
w.add(y);
w.add(x);
w.add(v);
x.setMarginLeft(-10);
v.setMarginLeft(-10);
return w;
},getBox2:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,allowGrowX:false});
var l=new qx.ui.core.Widget().set({decorator:u,backgroundColor:n,maxHeight:50,alignY:q});
var k=new qx.ui.core.Widget().set({decorator:u,backgroundColor:r,maxHeight:50,alignY:o});
var i=new qx.ui.core.Widget().set({decorator:u,backgroundColor:s,maxHeight:50,alignY:p});
j.add(l);
j.add(k);
j.add(i);
k.setMarginLeft(-10);
...
i.setMarginLeft(-10);
return j;
},getBox3:function(){var A=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:500,allowGrowX:false});
var C=new qx.ui.core.Widget().set({decorator:u,backgroundColor:n,maxHeight:50,alignY:q});
var B=new qx.ui.core.Widget().set({decorator:u,backgroundColor:r,maxHeight:50,alignY:o});
var z=new qx.ui.core.Widget().set({decorator:u,backgroundColor:s,maxHeight:50,alignY:p});
A.add(C,{flex:1});
A.add(B,{flex:1});
A.add(z,{flex:1});
B.setMarginLeft(-10);
z.setMarginLeft(-10);
return A;
},getBox4:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:500,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:u,backgroundColor:n,maxHeight:50,alignY:q});
var g=new qx.ui.core.Widget().set({decorator:u,backgroundColor:r,maxHeight:50,alignY:o});
var e=new qx.ui.core.Widget().set({decorator:u,backgroundColor:s,maxHeight:50,alignY:p});
f.add(h,{flex:1});
f.add(g,{flex:2});
f.add(e,{flex:3});
g.setMarginLeft(-10);
e.setMarginLeft(-10);
return f;
},getBox5:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:500,allowGrowX:false});
var d=new qx.ui.core.Widget().set({decorator:u,backgroundColor:n,maxHeight:50,alignY:q});
var c=new qx.ui.core.Widget().set({decorator:u,backgroundColor:r,maxHeight:50,alignY:o});
var a=new qx.ui.core.Widget().set({decorator:u,backgroundColor:s,maxHeight:50,alignY:p});
b.add(d,{flex:1});
b.add(c,{flex:2});
b.add(a,{flex:3});
c.setMarginLeft(-10);
...
a.setWidth(0);
return b;
},getBox6:function(){var J=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:200,allowGrowX:false});
var L=new qx.ui.core.Widget().set({decorator:u,backgroundColor:n,maxHeight:50,alignY:q});
var K=new qx.ui.core.Widget().set({decorator:u,backgroundColor:r,maxHeight:50,alignY:o});
var I=new qx.ui.core.Widget().set({decorator:u,backgroundColor:s,maxHeight:50,alignY:p});
J.add(L,{flex:1});
...
I.setMarginLeft(-10);
return J;
},getBox7:function(){var E=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:200,allowGrowX:false});
var G=new qx.ui.core.Widget().set({decorator:u,backgroundColor:n,maxHeight:50,alignY:q});
var F=new qx.ui.core.Widget().set({decorator:u,backgroundColor:r,maxHeight:50,alignY:o});
var D=new qx.ui.core.Widget().set({decorator:u,backgroundColor:s,maxHeight:50,alignY:p});
E.add(G,{flex:1});
E.add(F,{flex:2});
E.add(D,{flex:3});
F.setMarginLeft(-10);
...
(function(){var x="_applyLayoutChange",w="Decorator",v="Integer",u="top",t="left",s="auto",r="qx.ui.layout.Dock",q="_applySort",p="__AS",o="__AR",l="Boolean",n="x",m="y";
qx.Class.define(r,{extend:qx.ui.layout.Abstract,construct:function(y,z,A,B){arguments.callee.base.call(this);

if(y){this.setSpacingX(y);
}
...
}},properties:{sort:{check:[s,m,n],init:s,apply:q},separatorX:{check:w,nullable:true,apply:x},separatorY:{check:w,nullable:true,apply:x},connectSeparators:{check:l,init:false,apply:x},spacingX:{check:v,init:0,apply:x},spacingY:{check:v,init:0,apply:x}},members:{__AR:null,__AS:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__AT:{north:1,south:2,west:3,east:4,center:5},__AU:{1:"top",2:"bottom",3:"left",4:"right"},__AV:function(){var a=this._getLayoutChildren();
var j,c;
var length=a.length;
var e=[];
var h=[];
...
var g=this.getSort()==="x";

for(var i=0;i<length;i++){j=a[i];
f=j.getLayoutProperties().edge;

if(f==="center"){if(c){throw new Error("It is not allowed to have more than one child aligned to 'center'!");
}c=j;
}else if(g||b){if(f==="north"||f==="south"){b?e.push(j):h.push(j);
}else if(f==="west"||f==="east"){b?h.push(j):e.push(j);
}}else{e.push(j);
}}var k=e.concat(h);
...
},renderLayout:function(bj,bk){if(this._invalidChildrenCache){this.__AV();
}var bD=qx.ui.layout.Util;
var bq=this.__AR;
var bE=this.__AS;
var length=bq.length;
var bt,bm,bs,by,bz,bJ,bw,bn,bG;
var bN=[];
var bv=[];
var bM=this._getSeparatorWidths();
var bR=this.getSpacingX();
var bQ=this.getSpacingY();
var br=-bR;
var bF=-bQ;
...
for(var i=0;i<length;i++){bm=bq[i];
by=bm.getLayoutProperties();
bs=bm.getSizeHint();
bw=bs.width;
bn=bs.height;

if(by.width!=null){bw=Math.floor(bj*parseFloat(by.width)/100);

if(bw<bs.minWidth){bw=bs.minWidth;
}else if(bw>bs.maxWidth){bw=bs.maxWidth;
}}
if(by.height!=null){bn=Math.floor(bk*parseFloat(by.height)/100);

if(bn<bs.minHeight){bn=bs.minHeight;
}else if(bn>bs.maxHeight){bn=bs.maxHeight;
}}bN[i]=bw;
bv[i]=bn;
switch(bE[i]){case 1:case 2:bF+=bn+bm.getMarginTop()+bm.getMarginBottom()+bQ;

if(bM.y){bF+=bM.y+bQ;
}break;
case 3:case 4:br+=bw+bm.getMarginLeft()+bm.getMarginRight()+bR;

if(bM.x){br+=bM.x+bR;
}break;
default:br+=bw+bm.getMarginLeft()+bm.getMarginRight()+bR;
bF+=bn+bm.getMarginTop()+bm.getMarginBottom()+bQ;
...
switch(bE[i]){case 3:case 4:case 5:bz=bm.getLayoutProperties().flex;
if(bz==null&&bE[i]==5){bz=1;
}
if(bz>0){bs=bm.getSizeHint();
bt[i]={min:bs.minWidth,value:bN[i],max:bs.maxWidth,flex:bz};
}}}var bo=bD.computeFlexOffsets(bt,bj,br);

for(var i in bo){bG=bo[i].offset;
bN[i]+=bG;
br+=bG;
}}if(bF!=bk){bt=[];
bJ=bF<bk;
...
switch(bE[i]){case 1:case 2:case 5:bz=bm.getLayoutProperties().flex;
if(bz==null&&bE[i]==5){bz=1;
}
if(bz>0){bs=bm.getSizeHint();
bt[i]={min:bs.minHeight,value:bv[i],max:bs.maxHeight,flex:bz};
}}}var bo=bD.computeFlexOffsets(bt,bk,bF);

for(var i in bo){bG=bo[i].offset;
bv[i]+=bG;
bF+=bG;
}}this._clearSeparators();
var bK=this.getSeparatorX(),bL=this.getSeparatorY();
var bO=this.getConnectSeparators();
var bB=0,bI=0;
var bV,top,bw,bn,bA,bS;
var bC,bP,bU,bl;
var bT,bu,bx,bp;
var bH=this.__AU;
...
bs=bm.getSizeHint();
bT=bm.getMarginTop();
bu=bm.getMarginBottom();
bx=bm.getMarginLeft();
bp=bm.getMarginRight();
switch(bS){case 1:case 2:bw=bj-bx-bp;
if(bw<bs.minWidth){bw=bs.minWidth;
}else if(bw>bs.maxWidth){bw=bs.maxWidth;
}bn=bv[i];
top=bB+bD.computeVerticalAlignOffset(bH[bS],bn,bk,bT,bu);
bV=bI+bD.computeHorizontalAlignOffset(bm.getAlignX()||t,bw,bj,bx,bp);
if(bM.y){if(bS==1){bP=bB+bn+bT+bQ+bu;
}else{bP=bB+bk-bn-bT-bQ-bu-bM.y;
}bC=bV;
bU=bj;
...
}this._renderSeparator(bL,{left:bC,top:bP,width:bU,height:bM.y});
}bA=bn+bT+bu+bQ;
...
case 3:case 4:bn=bk-bT-bu;
if(bn<bs.minHeight){bn=bs.minHeight;
}else if(bn>bs.maxHeight){bn=bs.maxHeight;
}bw=bN[i];
bV=bI+bD.computeHorizontalAlignOffset(bH[bS],bw,bj,bx,bp);
top=bB+bD.computeVerticalAlignOffset(bm.getAlignY()||u,bn,bk,bT,bu);
if(bM.x){if(bS==3){bC=bI+bw+bx+bR+bp;
}else{bC=bI+bj-bw-bx-bR-bp-bM.x;
}bP=top;
bl=bk;
...
}this._renderSeparator(bK,{left:bC,top:bP,width:bM.x,height:bl});
}bA=bw+bx+bp+bR;
...
top=bB+bD.computeVerticalAlignOffset(bm.getAlignY()||u,bn,bk,bT,bu);
}bm.renderLayout(bV,top,bw,bn);
}},_getSeparatorWidths:function(){var bb=this.getSeparatorX(),ba=this.getSeparatorY();

if(bb||ba){var bg=qx.theme.manager.Decoration.getInstance();
}
if(bb){var bh=bg.resolve(bb);
var bd=bh.getInsets();
var be=bd.left+bd.right;
}
if(ba){var bi=bg.resolve(ba);
var bc=bi.getInsets();
var bf=bc.top+bc.bottom;
}return {x:be||0,y:bf||0};
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__AV();
}var F=this.__AR;
var P=this.__AS;
var length=F.length;
var J,Q;
...
var N=0,W=0;
var D=0,R=0;
var T=this._getSeparatorWidths();
var V=this.getSpacingX(),U=this.getSpacingY();
var H=-V,G=-U;

if(T.x){H-=T.x+V;
}
if(T.y){G-=T.y+U;
}for(var i=0;i<length;i++){Q=F[i];
J=Q.getSizeHint();
L=Q.getMarginLeft()+Q.getMarginRight();
K=Q.getMarginTop()+Q.getMarginBottom();
switch(P[i]){case 1:case 2:N=Math.max(N,J.width+M+L);
W=Math.max(W,J.minWidth+X+L);
D+=J.height+K;
R+=J.minHeight+K;
G+=U;
...
case 3:case 4:C=Math.max(C,J.height+D+K);
S=Math.max(S,J.minHeight+R+K);
M+=J.width+L;
X+=J.minWidth+L;
H+=V;
...
if(T.y){G+=T.y+U;
}}}var I=Math.max(X,W)+H;
var Y=Math.max(M,N)+H;
var O=Math.max(S,R)+G;
var E=Math.max(C,D)+G;
return {minWidth:I,width:Y,minHeight:O,height:E};
}},destruct:function(){this._disposeFields(p,o);
}});
})();
...
(function(){var r="bold",q="wlpe_qx.ui.layout.Grid",p="black",o="demobrowser.demo.util.PropertyEditor",n="Widget Properties",m="lpe_qx.ui.layout.HBox",l="wlpe_qx.ui.layout.Dock",k="wlpe_",j="lpe_qx.ui.layout.Dock",i="lpe_",J="_editorGroups",I="solid",H="string",G="_widgetIndicator",F="wlpe_qx.ui.layout.HBox",E="wlpe_qx.ui.layout.Canvas",D="wlpe_qx.ui.layout.VBox",C=" layout properties",B="_applyWidget",A="qx.ui.core.Widget",y=" properties",z="wlpe_qx.ui.layout.Basic",w="_layoutControls",x="Selected Widget",u="lpe_qx.ui.layout.Grid",v="pane",s="white",t="_pane";
qx.Class.define(o,{extend:qx.ui.core.AbstractScrollArea,construct:function(){arguments.callee.base.call(this);
this.setWidth(null);
this._editorGroups={};
...
g.add(new qx.ui.basic.Label(n).set({font:r,padding:[1,0,5,0]}));
...
},properties:{widget:{check:A,apply:B}},members:{handleWidgetClick:function(e){var K=e.getTarget();
this.setWidget(K);
},_createWidgetIndicator:function(){var X=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:5}));
X.add(this._createLabel(x));
this._widgetIndicator=new qx.ui.basic.Label().set({height:30,allowGrowX:true,allowGrowY:true,padding:5});
X._add(this._widgetIndicator);
return X;
},_createLabel:function(N){return new qx.ui.basic.Label(N).set({font:r,allowGrowX:true,padding:[5,0,5,0]});
},_createContainer:function(Y,ba){var bb=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:5}));
bb.add(this._createLabel(Y));
bb.add(ba);
return bb;
},updateWidgetLayoutPropertyEditor:function(a){var c=a.getLayoutParent()?a.getLayoutParent()._getLayout():null;
var b=this.getWidgetLayoutPropertyEditor(c);

if(b){b.getChildren()[1].setSelected(a);
}
if(b===this._wlpe){return;
}
if(this._wlpe){this._pane.remove(this._wlpe);
}
if(!b){this._wlpe=b;
return;
}this._pane.addAfter(b,this._layoutControls);
this._wlpe=b;
},updateLayoutPropertyEditor:function(R){var T=R.getLayout?R.getLayout():null;
var S=this.getLayoutPropertyEditor(T);

if(S){S.getChildren()[1].setSelected(T);
}
if(S===this._lpe){return;
}
...
this._lpe=S;
},getWidgetLayoutPropertyEditor:function(U){if(!U){return null;
}var name=k+U.constructor.classname;
var W;

if(this._editorGroups[name]){return this._editorGroups[name];
}var V;

switch(name){case F:case D:W=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BOX_PROPERTIES);
break;
case E:W=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.CANVAS_PROPERTIES);
break;
case z:W=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BASIC_PROPERTIES);
break;
case l:W=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.DOCK_PROPERTIES);
break;
case q:W=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.GRID_PROPERTIES);
break;
}
if(!W){return null;
}this._editorGroups[name]=this._createContainer(U.constructor.classname+C,W);
return this._editorGroups[name];
},getLayoutPropertyEditor:function(O){if(!O){return null;
}var name=i+O.constructor.classname;
var Q;

if(this._editorGroups[name]){return this._editorGroups[name];
}var P;

switch(name){case m:Q=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.HBOX_PROPERTIES);
break;
case j:Q=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.DOCK_PROPERTIES);
break;
case u:Q=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.GRID_PROPERTIES);
break;
}
if(!Q){return null;
}this._editorGroups[name]=this._createContainer(O.constructor.classname+y,Q);
return this._editorGroups[name];
},_applyWidget:function(L,M){this._layoutControls.setSelected(L);
this._widgetIndicator.setBackgroundColor(L.getBackgroundColor());
this._widgetIndicator.setDecorator(L.getDecorator());
this._widgetIndicator.setValue(L.toString());
this.updateLayoutPropertyEditor(L);
this.updateWidgetLayoutPropertyEditor(L);
}},destruct:function(){this._disposeFields(t,J,G,w);
}});
})();
...
(function(){var A="value",z="changeValue",y="enum",x="set",w="int",v="string",u="bool",t="function",s="null",r="demobrowser.demo.util.PropertyGroup",n="_properties",q="_applySelected",p="get",m="top",k="changeSelection",o="right";
qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(B){arguments.callee.base.call(this);
this._properties=B;
var D=new qx.ui.layout.Grid(10,5);
D.setColumnAlign(0,o,m);
D.setColumnMinWidth(0,110);
this._setLayout(D);
this.set({allowShrinkX:false,allowShrinkY:false});
var K=0;

for(var G in this._properties){var J=this._properties[G].type;
var F=this._properties[G].nullable;
this._add(new qx.ui.basic.Label(G).set({paddingTop:4}),{row:K,column:0});

if(F){var E=new qx.ui.form.CheckBox(s);
E.addListener(z,this._createOnNullPropertyChange(G),this);
this._add(E,{row:K,column:2});
this._properties[G].nullWidget=E;
}
if(J==w){var I=new qx.ui.form.Spinner().set({minimum:this._properties[G].min||0,maximum:this._properties[G].max!==undefined?this._properties[G].max:1000});
I.addListener(z,this._createOnIntPropertyChange(G),this);
this._add(I,{row:K++,column:1});
}else if(J==u){var I=new qx.ui.form.CheckBox();
I.addListener(z,this._createOnBoolPropertyChange(G),this);
this._add(I,{row:K++,column:1});
}else if(J==y){var H=this._properties[G].values;
var I=new qx.ui.form.RadioGroup();

for(var i=0;i<H.length;i++){var C=new qx.ui.form.RadioButton(H[i]);
C.setUserData(A,H[i]);
I.add(C);
this._add(C,{row:K++,column:1});
}I.addListener(k,this._createOnEnumPropertyChange(G,I),this);
}else if(J==v){var I=new qx.ui.form.TextField();
I.setLiveUpdate(true);
I.addListener(z,this._createOnIntPropertyChange(G),this);
this._add(I,{row:K++,column:1});
}this._properties[G].formItem=I;
}},statics:{WIDGET_PROPERTIES:{"width":{type:"int",nullable:true},"height":{type:"int",nullable:true},"minWidth":{type:"int",nullable:true},"minHeight":{type:"int",nullable:true},"maxWidth":{type:"int",nullable:true},"maxHeight":{type:"int",nullable:true},"allowGrowX":{type:"bool",nullable:false},"allowGrowY":{type:"bool",nullable:false},"allowShrinkX":{type:"bool",nullable:false},"allowShrinkY":{type:"bool",nullable:false},"marginTop":{type:"int",min:-1000,nullable:false},"marginRight":{type:"int",min:-1000,nullable:false},"marginBottom":{type:"int",min:-1000,nullable:false},"marginLeft":{type:"int",min:-1000,nullable:false},"paddingTop":{type:"int",nullable:false},"paddingRight":{type:"int",nullable:false},"paddingBottom":{type:"int",nullable:false},"paddingLeft":{type:"int",nullable:false},"alignX":{type:"enum",values:["left","center","right"],nullable:true},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:true}},HBOX_PROPERTIES:{"alignX":{type:"enum",values:["left","center","right"],nullable:false},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:false},"spacing":{type:"int",nullable:false},"reversed":{type:"bool",nullable:false}},DOCK_PROPERTIES:{"sort":{type:"enum",values:["auto","y","x"],nullable:false},"spacingX":{type:"int",nullable:false},"spacingY":{type:"int",nullable:false}},GRID_PROPERTIES:{"horizontalSpacing":{type:"int",nullable:false},"verticalSpacing":{type:"int",nullable:false}}},properties:{selected:{apply:q,nullable:true}},members:{_applySelected:function(bb,bc){this._updateControls(bb);
},_setProperty:function(f,name,g){if(!f){return;
}var j=x+qx.lang.String.firstUp(name);
var h=this._properties[name].convert;

if(h){g=h(g);
}f[j](g);
},_getProperty:function(bd,name){var be=p+qx.lang.String.firstUp(name);
return bd[be]();
},_hasProperty:function(V,name){var W=x+qx.lang.String.firstUp(name);
return (typeof (V[W])==t);
},_createOnIntPropertyChange:function(b){return function(e){var M=this.getSelected();
this._setProperty(M,b,e.getTarget().getValue());
};
},_createOnBoolPropertyChange:function(a){return function(e){var d=this.getSelected();
this._setProperty(d,a,e.getTarget().getValue());
};
},_createOnEnumPropertyChange:function(bf,bg){return function(e){var c=this.getSelected();
this._setProperty(c,bf,bg.getSelection()[0].getUserData(A));
};
},_createOnNullPropertyChange:function(L){return function(e){var Y=this.getSelected();
var X=e.getTarget();

if(X.getValue()){this._setProperty(Y,L,null);
this._properties[L].formItem.setEnabled(false);
}else{var ba=null;

if(this._properties[L].type==y){ba=this._properties[L].formItem.getSelection()[0].getUserData(A);
}else{ba=this._properties[L].formItem.getValue();
}this._setProperty(Y,L,ba);
this._properties[L].formItem.setEnabled(true);
}};
},_updateControls:function(N){for(var T in this._properties){var U=this._properties[T].type;
var Q=this._properties[T].formItem;
var O=this._properties[T].nullable;

if(!this._hasProperty(N,T)){Q.setEnabled(false);

if(O){this._properties[T].nullWidget.setEnabled(false);
}return;
}Q.setEnabled(true);
var S=this._getProperty(N,T);

if(S!==null){if(U==w){Q.setValue(parseInt(S));
}else if(U==v){Q.setValue(S.toString());
}else if(U==u){Q.setValue(!!S);
}else if(U==y){var P=Q.getItems();

for(var i=0,l=P.length;i<l;i++){var R=P[i];

if(R.getUserData(A)==S){Q.setSelection([R]);
break;
}}}}
if(O){this._properties[T].nullWidget.setValue(S==null);
this._properties[T].nullWidget.setEnabled(true);
Q.setEnabled(S!==null);
...
(function(){var m="textfield",l="",k="downbutton",j="upbutton",i="Please use the maximum property instead.",h="Number",g="Please use the minimum property instead.",f="inner",d="PageUp",c="Boolean",L="changeValue",K="Down",J="Up",I="execute",H="PageDown",G="changeLocale",F="qx.dynlocale",E="on",D="_applyEditable",C="_applyWrap",t="keydown",u="\-]",r="mousewheel",s="_applyValue",p="number",q="_applyMinimum",n="qx.util.format.NumberFormat",o="[0-9",v="keyup",w="spinner",y="this._checkValue(value)",x="_applyMaximum",A="changeNumberFormat",z="_applyNumberFormat",B="qx.ui.form.Spinner";
qx.Class.define(B,{extend:qx.ui.core.Widget,implement:[qx.ui.form.IFormElement,qx.ui.form.INumberForm,qx.ui.form.IRange,qx.ui.form.IForm],include:[qx.ui.core.MContentPadding,qx.ui.form.MFormElement,qx.ui.form.MForm],construct:function(bp,bq,br){arguments.callee.base.call(this);
...
if(bp!=null){this.setMinimum(bp);
}
if(br!=null){this.setMaximum(br);
}
if(bq!==undefined){this.setValue(bq);
}else{this.initValue();
}},properties:{appearance:{refine:true,init:w},focusable:{refine:true,init:true},singleStep:{check:h,init:1},pageStep:{check:h,init:10},minimum:{check:h,apply:q,init:0},value:{check:y,nullable:true,apply:s,init:0,event:L},maximum:{check:h,apply:x,init:100},wrap:{check:c,init:false,apply:C},editable:{check:c,init:true,apply:D},numberFormat:{check:n,apply:z,nullable:true},allowShrinkY:{refine:true,init:false}},members:{__uk:null,__ul:false,__um:false,_createChildControlImpl:function(bg){var bh;

switch(bg){case m:bh=new qx.ui.form.TextField();
...
break;
case j:bh=new qx.ui.form.RepeatButton();
bh.addState(f);
bh.setFocusable(false);
bh.addListener(I,this._countUp,this);
this._add(bh,{column:1,row:0});
break;
case k:bh=new qx.ui.form.RepeatButton();
bh.addState(f);
bh.setFocusable(false);
bh.addListener(I,this._countDown,this);
this._add(bh,{column:1,row:1});
break;
}return bh||arguments.callee.base.call(this,bg);
},_getFilterRegExp:function(){var bo=qx.locale.Number.getDecimalSeparator(qx.locale.Manager.getInstance().getLocale());
var bn=qx.locale.Number.getGroupSeparator(qx.locale.Manager.getInstance().getLocale());
var bm=l;
var bk=l;

if(this.getNumberFormat()!==null){bm=this.getNumberFormat().getPrefix()||l;
bk=this.getNumberFormat().getPostfix()||l;
}var bl=new RegExp(o+qx.lang.String.escapeRegexpChars(bo)+qx.lang.String.escapeRegexpChars(bn)+qx.lang.String.escapeRegexpChars(bm)+qx.lang.String.escapeRegexpChars(bk)+u);
return bl;
},_forwardStates:{focused:true,invalid:true},tabFocus:function(){var bF=this.getChildControl(m);
bF.getFocusElement().focus();
bF.selectAllText();
...
}},_applyMaximum:function(bx,by){if(this.getMinimum()>bx){this.setMin(bx);
}
if(this.getValue()>bx){this.setValue(bx);
}else{this._updateButtons();
}},_applyEnabled:function(be,bf){arguments.callee.base.call(this,be,bf);
this._updateButtons();
},_checkValue:function(T){return typeof T===p&&T>=this.getMinimum()&&T<=this.getMaximum();
},_applyValue:function(bt,bu){var bv=this.getChildControl(m);
this._updateButtons();
this.__uk=bt;
if(bt!==null){if(this.getNumberFormat()){bv.setValue(this.getNumberFormat().format(bt));
}else{bv.setValue(bt+l);
}}else{bv.setValue(l);
}},_applyEditable:function(bz,bA){var bB=this.getChildControl(m);

if(bB){bB.setReadOnly(!bz);
}},_applyWrap:function(a,b){this._updateButtons();
},_applyNumberFormat:function(Q,R){var S=this.getChildControl(m);
S.setFilter(this._getFilterRegExp());
this.getNumberFormat().addListener(A,this._onChangeNumberFormat,this);
this._applyValue(this.__uk,undefined);
},_getContentPaddingTarget:function(){return this.getChildControl(m);
},_updateButtons:function(){var bD=this.getChildControl(j);
var bC=this.getChildControl(k);
var bE=this.getValue();

if(!this.getEnabled()){bD.setEnabled(false);
bC.setEnabled(false);
}else{if(this.getWrap()){bD.setEnabled(true);
bC.setEnabled(true);
}else{if(bE!==null&&bE<this.getMaximum()){bD.setEnabled(true);
}else{bD.setEnabled(false);
}if(bE!==null&&bE>this.getMinimum()){bC.setEnabled(true);
}else{bC.setEnabled(false);
}}}},_onKeyDown:function(e){switch(e.getKeyIdentifier()){case d:this.__ul=true;
case J:this.getChildControl(j).press();
break;
case H:this.__um=true;
...
this.__ul=false;
break;
case J:this.getChildControl(j).release();
break;
case H:this.getChildControl(k).release();
this.__um=false;
break;
...
},_onTextChange:function(e){var bi=this.getChildControl(m);
var bj;
if(this.getNumberFormat()){try{bj=this.getNumberFormat().parse(bi.getValue());
}catch(bd){}}if(bj===undefined){bj=parseFloat(bi.getValue(),10);
}if(!isNaN(bj)){if(bj>this.getMaximum()){bi.setValue(this.getMaximum()+l);
return;
}else if(bj<this.getMinimum()){bi.setValue(this.getMinimum()+l);
return;
}this.setValue(bj);
}else{this._applyValue(this.__uk,undefined);
}},_onChangeLocale:function(V){if(this.getNumberFormat()!==null){this.setNumberFormat(this.getNumberFormat());
var W=this.getChildControl(m);
...
},_countUp:function(){if(this.__ul){var P=this.getValue()+this.getPageStep();
}else{var P=this.getValue()+this.getSingleStep();
}if(this.getWrap()){if(P>this.getMaximum()){var O=this.getMaximum()-P;
P=this.getMinimum()+O;
}}this.gotoValue(P);
},_countDown:function(){if(this.__um){var bc=this.getValue()-this.getPageStep();
...
},setMin:function(bw){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
this.setMinimum(bw);
},getMin:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
return this.getMinimum();
},resetMin:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
this.resetMinimum();
},initMin:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
this.initMinimum();
},setMax:function(ba){qx.log.Logger.deprecatedMethodWarning(arguments.callee,i);
this.setMaximum(ba);
},getMax:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,i);
return this.getMaximum();
},resetMax:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,i);
this.resetMaximum();
},initMaxi:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,i);
this.initMaximum();
...
(function(){var i="demobrowser.demo.util.LayoutPropertyGroup";
qx.Class.define(i,{extend:demobrowser.demo.util.PropertyGroup,statics:{BOX_PROPERTIES:{"flex":{type:"int",min:-1000,nullable:true}},BASIC_PROPERTIES:{"top":{type:"int",min:-1000,nullable:true},"left":{type:"int",min:-1000,nullable:true}},CANVAS_PROPERTIES:{"top":{type:"string",nullable:true,convert:function(o){if(parseInt(o).toString()==o){o=parseInt(o);
}return o||null;
}},"right":{type:"string",nullable:true,convert:function(k){if(parseInt(k).toString()==k){k=parseInt(k);
}return k||null;
}},"bottom":{type:"string",nullable:true,convert:function(j){if(parseInt(j).toString()==j){j=parseInt(j);
}return j||null;
}},"left":{type:"string",nullable:true,convert:function(g){if(parseInt(g).toString()==g){g=parseInt(g);
}return g||null;
}},"width":{type:"int",nullable:true,convert:function(a){return a==null?null:a+"%";
}},"height":{type:"int",nullable:true,convert:function(l){return l==null?null:l+"%";
}}},DOCK_PROPERTIES:{"width":{type:"int",nullable:true,convert:function(n){return n==null?null:n+"%";
}},"height":{type:"int",nullable:true,convert:function(m){return m==null?null:m+"%";
}},"edge":{type:"enum",values:["north","east","south","west","center"],nullable:false}},GRID_PROPERTIES:{"row":{type:"int",nullable:false},"column":{type:"int",nullable:false},"rowSpan":{type:"int",nullable:true},"colSpan":{type:"int",nullable:true}}},members:{_setProperty:function(c,name,d){var e=this._properties[name].convert;

if(e){d=e(d);
}var f={};
f[name]=d;
c.setLayoutProperties(f);
},_getProperty:function(b,name){return b.getLayoutProperties()[name]||null;
},_hasProperty:function(h,name){return true;
}}});
})();
...
}},members:{add:function(a){this.getChildControl(d).add(a);
},remove:function(e){this.getChildControl(d).remove(e);
