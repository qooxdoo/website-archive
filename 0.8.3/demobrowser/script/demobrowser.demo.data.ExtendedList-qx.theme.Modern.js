...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.ExtendedList", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.data.ExtendedList-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var n="execute",m="Jack",l="kiss",k="demobrowser.demo.data.ExtendedList",j="Jim",h="sad",g="<b>Displaying Checkboxes in a list</b><br/>",f="plain",e="surprise",d="embarrassed",C="value",B="online",A="name",z="Write data to log",y="Jackob",x="Dan",w="Tim",v="Karl",u="Online <> Offline",t="This list display a set of persons in a list as checkbox. Every ",r="label",s="Dustin",p="angel",q="Max",o="person does have a name as label and an online status as checkbox.";
qx.Class.define(k,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var N=[q,y,w,m,x,s,v,j];
var G=[d,l,f,h,e,p];
var L=[];

for(var i=0;i<20;i++){var I=new demobrowser.demo.data.model.Person();
I.setName(N[i%N.length]);
I.setEmote(G[i%G.length]);
I.setOnline(i%3==0);
L.push(I);
}var M=new qx.data.Array(L);
var F=new qx.ui.form.List();
F.setWidth(150);
this.getRoot().add(F,{left:10,top:80});
var J=new qx.data.controller.List(null,F);
var E={configureItem:function(O){O.setPadding(3);
},createItem:function(){return new qx.ui.form.CheckBox();
},bindItem:function(a,b,c){a.bindProperty(A,r,null,b,c);
a.bindProperty(B,C,null,b,c);
}};
J.setDelegate(E);
J.setModel(M);
var D=new qx.ui.form.Button(u);
D.setWidth(120);
this.getRoot().add(D,{left:180,top:80});
D.addListener(n,function(){for(var i=0;i<M.length;i++){M.getItem(i).toggleOnline();
}},this);
var K=new qx.ui.form.Button(z);
K.setWidth(120);
this.getRoot().add(K,{left:180,top:115});
K.addListener(n,function(){qx.log.appender.Console.show();
...
H.setWidth(410);
H.setValue(g+t+o);
this.getRoot().add(H,{left:20,top:10});
}}});
})();
...
(function(){var g="String",f="demobrowser.demo.data.model.Person",e="Boolean",d="changeName",c="Person: ",b="changeOnline",a="changeEmote";
qx.Class.define(f,{extend:qx.core.Object,properties:{name:{check:g,event:d,nullable:true},emote:{check:g,event:a},online:{check:e,event:b,init:true}},members:{toString:function(){return c+this.getName();
}}});
})();
