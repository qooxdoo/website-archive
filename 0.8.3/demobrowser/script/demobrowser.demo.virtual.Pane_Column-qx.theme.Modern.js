...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.Pane_Column", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.virtual.Pane_Column-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var m="bold",l="table-scroller-header",k="white",j="#EEE",h="demobrowser.demo.virtual.Pane_Column",g="Even/Odd Colors",f="Custom Colors",e="Even/Odd & Custom Colors";
...
a.add(new qx.ui.basic.Label(g).set({font:m,decorator:l,padding:3,allowGrowX:true}),{row:0,column:0});
var d=new qx.ui.virtual.core.Scroller(100,10000,60,60);
d.getPane().addLayer(new qx.ui.virtual.layer.Column(k,j));
a.add(d,{row:1,column:0});
a.add(new qx.ui.basic.Label(f).set({font:m,decorator:l,padding:3,allowGrowX:true}),{row:0,column:1});
var d=new qx.ui.virtual.core.Scroller(100,10000,60,60);
var c=new qx.ui.virtual.layer.Column();

for(var i=0;i<10000;i++){c.setColor(i,qx.util.ColorUtil.randomColor());
}d.getPane().addLayer(c);
a.add(d,{row:1,column:1});
a.add(new qx.ui.basic.Label(e).set({font:m,decorator:l,padding:3,allowGrowX:true}),{row:0,column:2});
var d=new qx.ui.virtual.core.Scroller(100,10000,60,60);
var d=new qx.ui.virtual.core.Scroller(100,10000,60,60);
var c=new qx.ui.virtual.layer.Column(k,j);

for(var i=0;i<10000;i++){if(Math.random()>0.7){c.setColor(i,qx.util.ColorUtil.randomColor());
}}d.getPane().addLayer(c);
a.add(d,{row:1,column:2});
}}});
})();
