...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Table_HeaderRenderer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Table_HeaderRenderer-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var l="Name",k="hovered",j="tool tip",i="icon/16/apps/internet-feed-reader.png",h="mouseover",g="demobrowser.demo.test.Table_HeaderRenderer",f="_container",d="mouseout";
...
},testDefaultRenderer:function(){var v=new qx.ui.table.headerrenderer.Default();
var t={name:[l],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var u=this._getNewHeaderContainer();
qx.util.Permutation.permute(t,function(b){var c=v.createHeaderCell(b);
u.add(c);
v.updateHeaderCell(b,c);
});
},testDefaultRenderer:function(){var y=new qx.ui.table.headerrenderer.Default();
y.setToolTip(j);
var w={name:[l],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var x=this._getNewHeaderContainer();
qx.util.Permutation.permute(w,function(r){var s=y.createHeaderCell(r);
x.add(s);
y.updateHeaderCell(r,s);
});
},testIconRenderer:function(){var o=new qx.ui.table.headerrenderer.Icon(i);
o.setToolTip(j);
var m={name:[l],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var n=this._getNewHeaderContainer();
qx.util.Permutation.permute(m,function(p){var q=o.createHeaderCell(p);
n.add(q);
o.updateHeaderCell(p,q);
});
},_getNewHeaderContainer:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
a.addListener(h,function(e){e.getTarget().addState(k);
});
a.addListener(d,function(e){e.getTarget().removeState(k);
});
