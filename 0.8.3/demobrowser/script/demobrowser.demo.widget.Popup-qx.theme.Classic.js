...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Popup-qx.theme.Classic-0.js"]],
  boot : "boot",
...
return m;
},_getPopupButton2:function(){var k=new qx.ui.form.Button(d);
var l=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:f,padding:[2,4],offset:3,position:c});
