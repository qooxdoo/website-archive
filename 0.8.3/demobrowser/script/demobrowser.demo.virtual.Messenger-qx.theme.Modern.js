...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.Messenger", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.virtual.Messenger-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var t="execute",s="middle",r="",q="away",p="offline",o="value",n="online",m="icon",l="busy",k="selection[0].status",be="right",bd="selection[0]",bc="separator-vertical",bb="Escape",ba="Cancel",Y="qooxdoo",X="Group: ",W="Friends",V="Name:",U="Enter",A="source",B="Group:",y="demobrowser/demo/icons/imicons/user_delete.png",z="center",w="enabled",x="icon/16/actions/list-add.png",u="group",v="Name: ",C="name",D="keypress",K="modelSelection",I="top",O="Contacts",M="Status: ",Q="selection",P="Add",F="Contact Details",T="Add user",S="model",R="appear",E="New Group",G="avatar",H="left",J="Avatar: ",L="demobrowser.demo.virtual.Messenger",N="demobrowser/demo/icons/imicons/user_add.png";
qx.Class.define(L,{extend:qx.application.Standalone,members:{__tM:null,messenger:null,__tN:null,main:function(){arguments.callee.base.call(this);
var bj=this.getRoot();
var bm=new qx.ui.window.Window(O).set({contentPadding:0,showClose:false,showMinimize:false});
...
toolbar.add(bh);
var bf=new qx.ui.toolbar.Button(r,N).set({show:m});
bf.addListener(t,this.showAddContactWindow,this);
bh.add(bf);
var bg=new qx.ui.toolbar.Button(r,y).set({show:m});
this.messenger.bind(bd,bg,w,{converter:function(bo){return !!bo;
}});
bg.addListener(t,function(){this.messenger.getModel().remove(this.messenger.getSelection().getItem(0));
},this);
bh.add(bg);
return bh;
},createDetailsView:function(){var f=new qx.data.controller.Object();
this.messenger.bind(bd,f,S);
var b=new qx.ui.groupbox.GroupBox(F);
var g=new qx.ui.layout.Grid(5,5);
g.setColumnAlign(0,be,s);
b.setLayout(g);
b.add(new qx.ui.basic.Label(v),{row:0,column:0});
var i=new qx.ui.form.TextField();
f.addTarget(i,o,C,true);
b.add(i,{row:0,column:1});
b.add(new qx.ui.basic.Label(X),{row:1,column:0});
var c=new qx.ui.form.TextField();
f.addTarget(c,o,u,true);
b.add(c,{row:1,column:1});
b.add(new qx.ui.basic.Label(M),{row:2,column:0});
var h=new qx.ui.form.SelectBox();
h.add(new qx.ui.form.ListItem(n).set({model:n}));
h.add(new qx.ui.form.ListItem(q).set({model:q}));
h.add(new qx.ui.form.ListItem(l).set({model:l}));
h.add(new qx.ui.form.ListItem(p).set({model:p}));
this.messenger.bind(k,h,K,{converter:function(a){return [a];
}});
h.bind(Q,this.messenger,k,{converter:function(bi){return bi[0].getModel();
}});
b.add(h,{row:2,column:1});
b.add(new qx.ui.basic.Label(J).set({alignY:I}),{row:3,column:0});
var d=new qx.ui.basic.Image().set({alignX:z});
f.addTarget(d,A,G);
b.add(d,{row:3,column:1});
return b;
},showAddContactWindow:function(){if(this.__tM==null){var bp=new qx.ui.layout.Grid(5,10);
var br=new qx.ui.window.Window(T,x);
br.set({width:165,height:100,showMinimize:false,showClose:false,showMaximize:false});
br.setLayout(bp);
var bu=new qx.ui.basic.Label(V);
var bv=new qx.ui.form.TextField();
var bs=new qx.ui.form.ComboBox(E);
bs.add(new qx.ui.form.ListItem(Y));
bs.add(new qx.ui.form.ListItem(W));
var bq=new qx.ui.basic.Label(B);
var bx=new qx.ui.form.Button(P);
var bw=new qx.ui.form.Button(ba);
this.__tN=bv;
bx.setAllowGrowX(false);
bw.setAllowGrowX(false);
br.addListener(R,bv.focus,bv);
bw.addListener(t,br.close,br);
var bt=function(){var bn=new demobrowser.demo.virtual.messenger.BuddyModel();
bn.setName(bv.getValue());
bn.setGroup(bs.getValue());
this.messenger.getModel().push(bn);
this.messenger.getSelection().setItem(0,bn);
br.close();
};
bx.addListener(t,bt,this);
br.addListener(D,function(e){var j=e.getKeyIdentifier();

if(j==U){bt.call(this);
}else if(j==bb){br.close();
}},this);
...
bp.setColumnAlign(0,H,s);
bp.setColumnAlign(1,be,s);
this.getRoot().add(br,{left:20,top:20});
this.__tM=br;
}this.__tN.setValue(r);
this.__tM.center();
this.__tM.open();
...
var p=new qx.ui.virtual.behavior.Prefetch(this,0,0,0,0,600,800,600,800).set({interval:500});
...
qx.Class.define(v,{extend:qx.ui.virtual.form.ListController,construct:function(A,B){arguments.callee.base.call(this,A,B);
this.__tO=new demobrowser.demo.virtual.messenger.BuddyCell();
this.__tP=new demobrowser.demo.virtual.messenger.GroupCell();
this.__tP.addListener(x,this._onChangeOpenGroup,this);
this.__tQ=[];
this.__tR={};
this.__tS=[];
this.__tT=new qx.util.DeferredCall(this._updateGrouping,this);
},members:{__tS:null,__tR:null,__tT:null,__tQ:null,__tO:null,__tP:null,_getRowData:function(h){return this.__tS[h];
},_getModelRow:function(H){return this.__tS.indexOf(H);
},_getRowCount:function(){return this.__tS.length;
},_isGroupHeader:function(z){return this.__tS[z] instanceof demobrowser.demo.virtual.messenger.GroupModel;
},_getGroupModel:function(name,I){var J=this.__tR[name];

if(!J){var J=new demobrowser.demo.virtual.messenger.GroupModel();
J.setName(name);
this.__tR[name]=J;
}J.setRow(I);
return J;
},_onChangeOpenGroup:function(e){var g=this.__tS[e.getData().getUserData(t)];
g.toggleOpen();
this.__tT.schedule();
},getCellRenderer:function(j){if(this._isGroupHeader(j)){return this.__tP;
}else{return this.__tO;
}},isRowSelectable:function(C){return !this._isGroupHeader(C);
},_visualizeGrouping:function(c){var d=this.getTarget();

if(d){for(var i=0;i<this.__tQ.length;i++){var f=this.__tQ[i].getOldRow();
...
r.sort(function(a,b){var k=a.getGroup();
var l=b.getGroup();

if(k==l){return a.getName()<b.getName()?-1:1;
}return k>l?-1:1;
});
var p=r[0];
...
s=0;
var m=this._getGroupModel(o.getGroup(),this.__tS.length);
this.__tS.push(m);
n.push(m);
}
if(m.isOpen()){this.__tS.push(o);
...
this._syncModelSelectionToView();
this._syncRowCount();
},_applyModel:function(F,G){arguments.callee.base.call(this,F,G);
this.__tT.schedule();
...
(function(){var k="decoration/arrows/down-invert.png",j="changeOpen",i="bold",h=" (",g=")",f="click",d="white",c="demobrowser.demo.virtual.messenger.GroupCell",b="decoration/arrows/right-invert.png",a="qx.event.type.Data";
qx.Class.define(c,{extend:qx.ui.virtual.cell.AbstractWidget,events:{changeOpen:a},members:{_createWidget:function(){var n=new qx.ui.basic.Atom().set({icon:k,textColor:d,font:i,padding:[0,3]});
n.addListener(f,function(e){this.fireDataEvent(j,e.getCurrentTarget());
},this);
return n;
},updateData:function(l,m){l.setLabel(m.getName()+h+m.getItemCount()+g);

if(m.isOpen()){l.setIcon(k);
}else{l.setIcon(b);
}}}});
})();
...
}},properties:{name:{init:c,event:g,check:a},row:{event:d,check:j,apply:b},open:{check:h,init:true,event:i},itemCount:{check:j,init:0,event:e}},members:{__tU:null,_applyRow:function(k,l){this.__tU=l;
},getOldRow:function(){return this.__tU;
}}});
})();
