...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.Cells", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.virtual.Cells-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var T="",S="' ",R="<b>HTML</b>",Q="px;",P="Juhu",O="testImageCell",N="</div>",M="<div ",L="testNumberCell",K="selected",bn="class='",bm="width:",bl="testHtmlCell",bk="testDateCell",bj=">",bi="height:",bh="testStringCell",bg="testBooleanCellCustomImage",bf="demobrowser.demo.virtual.Cells",be="testBooleanCell",bb="foobar!",bc="style='",Y="medium",ba="main",W="icon/16/emotes/face-sad.png",X="icon/16/apps/internet-feed-reader.png",U="icon/16/emotes/face-smile.png",V="This is a feed reader!",bd="icon/32/apps/utilities-notes.png";
qx.Class.define(bf,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var J=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(J);
this.runTest(bh);
this.runTest(L);
this.runTest(bk);
this.runTest(bl);
...
},testStringCell:function(){var I={value:[P,R,T,null],states:[{},{selected:1}]};
var H=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(I,function(c){var d=this.__ua(H,c.value,c.states);
this.container.add(d);
},this);
},testNumberCell:function(){var i={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var j=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(i,function(bs){if(bs.format){j.setNumberFormat(bs.format);
}else{j.resetNumberFormat();
}var bt=this.__ua(j,bs.value,bs.states);
this.container.add(bt);
},this);
},testDateCell:function(){var k={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(Y))],states:[{},{selected:1}]};
var l=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(k,function(g){if(g.format){l.setDateFormat(g.format);
}else{l.resetDateFormat();
}var h=this.__ua(l,g.value,g.states);
this.container.add(h);
},this);
},testHtmlCell:function(){var a={value:[P,R,T,null],states:[{},{selected:1}]};
var b=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(a,function(t){var u=this.__ua(b,t.value,t.states);
this.container.add(u);
},this);
},testImageCell:function(){var E={value:[{url:X,tooltip:V},{url:bd,tooltip:bb},null],states:[{},{selected:1}]};
var F=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(E,function(e){var f=this.__ua(F,e.value,e.states);
...
qx.util.Permutation.permute(bo,function(bq){var br=this.__ua(bp,bq.value,bq.states);
this.container.add(br);
},this);
},testBooleanCellCustomImage:function(){var bu={value:[true,false,null],states:[{},{selected:1}]};
var bv=new qx.ui.virtual.cell.Boolean;
bv.setIconFalse(W);
bv.setIconTrue(U);
qx.util.Permutation.permute(bu,function(r){var s=this.__ua(bv,r.value,r.states);
this.container.add(s);
},this);
},__ua:function(v,w,x){var B=100;
var z=30;
var D=new qx.ui.embed.Html().set({width:B,height:z,decorator:x.selected?K:ba});
var y=v.getCellProperties(w,x);
var A=y.insets;
var C=[M,bc,this._getCellSizeStyle(B,z,A[0],A[1]),y.style,S,bn,y.classes,S,y.attributes,bj,y.content,N].join(T);
D.setHtml(C);
return D;
},_getCellSizeStyle:function(m,n,o,p){var q=T;
...
(function(){var E="",D="px",C='" ',B="no-repeat",A='"',z='" style="',y='title="',x='<div style="',w='></div>',v="qx.ui.virtual.cell.AbstractImage",p='/>',u="img",s="inline-block",o="static",n="top",r='<img src="',q="abstract",t="string",m="-moz-inline-box";
qx.Class.define(v,{extend:qx.ui.virtual.cell.Cell,type:q,construct:function(){arguments.callee.base.call(this);
this._aliasManager=qx.util.AliasManager.getInstance();
},members:{__ub:16,__uc:16,_aliasManager:null,__ud:function(G){var J=qx.util.ResourceManager.getInstance();
...
},__ue:function(a){if(typeof (a)==t){a={url:a};
...
},getContent:function(d,e){if(d===null){return E;
}var content=E;
var g=this.__ue(this._identifyImage(d));
var k=qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9;
var h=g.tooltip?y+g.tooltip+A:E;
var f={width:g.width+D,height:g.height+D,display:k?m:s,verticalAlign:n,position:o};
var i=qx.bom.element.Decoration.getTagName(B,g.url);
var j=qx.bom.element.Decoration.getAttributes(g.url,B,f);
var l=qx.bom.element.Style.compile(j.style);

if(i===u){content=r+j.src+z+l+C;
content+=h+p;
}else{content=x+l+C;
content+=h+w;
}return content;
...
this.__uf=qx.util.AliasManager.getInstance();
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__ug:null,__uh:null,__uf:null,_applyIconTrue:function(g){this.__ug=this.__uf.resolve(g);
},_applyIconFalse:function(h){this.__uh=this.__uf.resolve(h);
},_identifyImage:function(f){return f==true?this.__ug:this.__uh;
}}});
})();
