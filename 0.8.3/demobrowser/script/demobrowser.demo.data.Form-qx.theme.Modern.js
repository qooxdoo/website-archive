...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.Form", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.data.Form-qx.theme.Modern-0.js"]],
  boot : "boot",
...
var y={name:null,gender:null,ok:0,hidden:f};
var K=qx.data.marshal.Json.createModel(y);
var B=new qx.data.controller.Object(K);
B.addTarget(z,s,h,true);
B.addTarget(H,k,m,true);
var x={converter:function(t){return t===1;
}};
var A={converter:function(P){return P?1:0;
}};
B.addTarget(L,s,i,true,x,A);
z.setRequired(true);
L.setRequired(true);
var N=new qx.ui.form.validation.Manager();
N.add(z,qx.util.Validate.required);
N.add(L);
N.setValidator(function(u){var v=H.getSelection()[0]!==I;
H.setValid(v);
return v;
});
var F=function(a){if(a instanceof qx.ui.form.ListItem){return a.getLabel();
}};
D.addListener(d,function(){if(N.validate()){alert("You are sending: "+qx.util.Serializer.toUriParameter(K,F));
}},this);
}}});
})();
