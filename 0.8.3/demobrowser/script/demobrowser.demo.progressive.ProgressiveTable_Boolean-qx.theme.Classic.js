...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.progressive.ProgressiveTable_Boolean", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.progressive.ProgressiveTable_Boolean-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var k="row",j="Boolean",i="end",h="demobrowser.demo.progressive.ProgressiveTable_Boolean",g="Id";
qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var u=0;
var q=function(a){var d=[];
var c=new Date().getTime();
var e=400*24*60*60*1000;

for(var f=0;f<a;f++){var b=new Date(c+Math.random()*e-e/2);
d.push({renderer:k,location:i,data:[u++,(Math.floor(Math.random()*2)==0?false:true)]});
}return d;
};
var t=new qx.ui.progressive.renderer.table.Widths(2);
t.setWidth(0,100);
t.setWidth(1,100);
var o=[g,j];
var p=new qx.ui.progressive.headfoot.TableHeading(t,o);
var n=new qx.ui.progressive.headfoot.Progress(t,o);
var w=new qx.ui.progressive.structure.Default(p,n);
var m=new qx.ui.progressive.Progressive(w);
var s=new qx.ui.progressive.model.Default();
var r=q(20);
s.addElements(r);
m.setDataModel(s);
var v=new qx.ui.progressive.renderer.table.Row(t);
m.addRenderer(k,v);
var l=new qx.ui.progressive.renderer.table.cell.Boolean();
l.setAllowToggle(true);
v.addRenderer(1,l);
m.set({width:200+qx.bom.element.Overflow.getScrollbarWidth(),maxWidth:200+qx.bom.element.Overflow.getScrollbarWidth()});
this.getRoot().add(m,{left:50,top:50,bottom:50});
m.render();
}}});
})();
...
(function(){var j="'; ",i="  this.src='",h="  var filters = this.filters.item(loader); ",g="qx.client",f="}",e="{",d="  var loader = 'DXImageTransform.Microsoft.AlphaImageLoader'; ",c="mshtml",b="  filters.sizingMethod = 'scale'; ",a="  filters.src='",G="\"",F="__yU",E="  this.attributes.setNamedItem(namedItem); ",D="} catch (e) { ",C="var node = this.attributes.getNamedItem('celldata'); ",B="qx.ui.progressive.renderer.table.cell.Boolean",A="decoration/table/boolean-true.png",z="var value = node.nodeValue; ",y="decoration/table/boolean-false.png",x="celldata='1' ",q="  node.nodeValue='0'; ",r="  this.attributes.setNamedItem(node); ",o="if (value == '0') ",p="celldata='0' ",m="  node.nodeValue='1'; ",n="__yV",k="onclick=\"",l="  namedItem.value = node.nodeValue; ",s="var src; ",t="try { ",v="  var namedItem = document.createAttribute('celldata'); ",u="} ",w="else ";
qx.Class.define(B,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(){arguments.callee.base.call(this);
...
this.__yU=M.toUri(K);
this.__yV=M.toUri(J);
},properties:{allowToggle:{init:false}},members:{__yU:null,__yV:null,__yW:null,__yX:null,__yY:null,__za:null,__zb:null,__zc:null,_identifyImage:function(H){var I={imageWidth:11,imageHeight:11};

switch(H.cellData){case true:I.url=this.__yU;
I.extras=x;
break;
case false:I.url=this.__yV;
I.extras=p;
break;
default:I.url=null;
break;
}
if(this.getAllowToggle()){I.extras+=k+C+z+s+o+e;

if(qx.core.Variant.isSet(g,c)&&/\.png$/i.test(this.__yU)){I.extras+=i+this.getBlankImage()+j+d+h+a+this.__yU+j+b;
}else{I.extras+=i+this.__yU+j;
}I.extras+=m+u+w+e;

if(qx.core.Variant.isSet(g,c)&&/\.png$/i.test(this.__yV)){I.extras+=i+this.getBlankImage()+j+d+h+a+this.__yV+j+b;
}else{I.extras+=i+this.__yV+j;
}I.extras+=q+f;
I.extras+=t+r+D+v+l+E+f+G;
}return I;
},_getCellStyle:function(N){var O=arguments.callee.base.call(this,N);
return O;
}},destruct:function(){this._disposeFields(F,n);
}});
})();
