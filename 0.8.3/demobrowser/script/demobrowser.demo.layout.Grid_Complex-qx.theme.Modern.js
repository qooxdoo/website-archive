...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Grid_Complex", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Grid_Complex-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var j="main",i="green",h="yellow",g="bottom",f="center",e="middle",d="demobrowser.demo.layout.Grid_Complex",c="orange",b="right";
...
a.add(this.getGrid1());
a.add(this.getGrid2());
},getGrid1:function(){var k=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,allowGrowX:false});
k.setLayout(new qx.ui.layout.Grid(5,20));
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:0});
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:1});
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,width:150,maxWidth:150}),{row:1,column:0,rowSpan:1,colSpan:2});
return k;
},getGrid2:function(){var l=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,width:500,allowShrinkX:false,allowShrinkY:false,allowGrowX:false});
var o=new qx.ui.layout.Grid();
o.setColumnFlex(1,2);
o.setRowFlex(1,3);
o.setColumnMinWidth(0,70);
o.setColumnMinWidth(1,100);
o.setColumnMaxWidth(2,150);
o.setRowMinHeight(0,70);
o.setSpacing(5);
l.setLayout(o);
l.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:0});
l.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:1,rowSpan:1,colSpan:2});
l.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:1,column:0});
var n=new qx.ui.container.Composite().set({decorator:j,backgroundColor:c,width:400,padding:5});
l.add(n,{row:1,column:1,rowSpan:2,colSpan:2});
l.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:2,column:0});
l.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:3,column:0,rowSpan:1,colSpan:2});
l.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:3,column:2});
var m=new qx.ui.layout.Grid();
n.setLayout(m);
m.setColumnAlign(1,f,e);
m.setColumnAlign(0,b,g);
m.setColumnMinWidth(1,40);
m.setSpacing(5);
m.setColumnFlex(1,1);
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,width:150}),{row:0,column:0});
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,allowGrowX:false,height:70,allowGrowX:false}),{row:0,column:1});
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:60,allowGrowX:false}),{row:1,column:0});
n.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,minWidth:170}),{row:2,column:0});
return l;
}}});
})();
