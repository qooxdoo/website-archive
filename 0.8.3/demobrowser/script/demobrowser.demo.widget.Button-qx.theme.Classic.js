...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Button-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var o="Button A",n="0",m="icon/22/actions/list-add.png",l="Button B",k="demobrowser.demo.widget.Button",j="icon/22/apps/internet-web-browser.png",i="icon/22/apps/media-video-player.png",h="icon/22/apps/internet-mail.png",g="changeValue",f="white",b="main",d="execute",c="Toggle Button";
...
var u=new qx.ui.form.Button(o,i);
q.add(u);
var v=new qx.ui.form.Button(l,h);
v.setEnabled(false);
q.add(v);
var w=new qx.ui.form.ToggleButton(c,j);
w.focus();
q.add(w);
w.addListener(g,function(e){this.debug("Checked: "+e.getData());
},this);
var t=m;
...
q.add(s);
r.addListener(d,function(){var a=parseInt(s.getValue())+1;
s.setValue(a.toString());
});
}}});
})();
