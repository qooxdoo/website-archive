...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.ResizeEvent-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var h="resize",g="demobrowser.demo.test.ResizeEvent",f="red",d="click",c="blue";
qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var b=new qx.ui.core.Widget().set({backgroundColor:f,width:80});
var a=new qx.ui.core.Widget().set({backgroundColor:c});
this.getRoot().add(b,{left:10,top:10});
this.getRoot().add(a,{left:10,top:110});
b.addListener(h,function(e){this.debug("Resize red");
a.setWidth(e.getData().width);
});
b.addListener(d,function(){b.setWidth(b.getWidth()+10);
});
}}});
})();
