...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_NegativeMargin", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Classic-0.js"]],
  boot : "boot",
...
var L=new qx.ui.container.Composite(J).set({decorator:x,backgroundColor:w,width:140,allowGrowY:false});
...
K.setMarginTop(-10);
return L;
},getBox2:function(){var y=new qx.ui.layout.VBox();
var A=new qx.ui.container.Composite(y).set({decorator:x,backgroundColor:w,width:140,allowGrowY:false});
var C=new qx.ui.core.Widget().set({decorator:x,backgroundColor:u,maxWidth:100,alignX:r});
var B=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s,maxWidth:100,alignX:t});
var z=new qx.ui.core.Widget().set({decorator:x,backgroundColor:v,maxWidth:100,alignX:q});
A.add(C);
A.add(B);
A.add(z);
B.setMarginTop(-10);
...
l.setMarginTop(-10);
return m;
},getBox4:function(){var E=new qx.ui.layout.VBox();
var G=new qx.ui.container.Composite(E).set({decorator:x,backgroundColor:w,width:140,height:300,allowGrowY:false});
...
var c=new qx.ui.container.Composite(a).set({decorator:x,backgroundColor:w,width:140,height:300,allowGrowY:false});
...
var Q=new qx.ui.container.Composite(O).set({decorator:x,backgroundColor:w,width:140,height:100,allowGrowY:false});
...
var h=new qx.ui.container.Composite(f).set({decorator:x,backgroundColor:w,width:140,height:100,allowGrowY:false});
