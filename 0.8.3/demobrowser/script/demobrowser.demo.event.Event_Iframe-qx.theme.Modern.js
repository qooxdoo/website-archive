...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.Event_Iframe", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.event.Event_Iframe-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var q="click",p="iframe",o="scroll",n="inner",m="_juhu",l="div",k="juhu",j="contextmenu",h="input",g="load",c="keydown",f="demobrowser.demo.event.Event_Iframe",d="data/Event_2_frame.html",b="_inner";
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var v=qx.bom.Iframe.create({name:p,src:d});
v.id=p;
document.body.appendChild(v);
qx.event.Registration.addListener(v,g,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var t=window.document.getElementById(p);
var s=qx.bom.Iframe.getDocument(t);
this._juhu=s.getElementById(k);
this._inner=s.getElementById(n);
qx.event.Registration.addListener(this._juhu,j,this._preventDefault,this);
qx.event.Registration.addListener(this._inner,q,this._stopPropagation,this);
qx.event.Registration.addListener(this._juhu,q,this._onclick1,this);
qx.event.Registration.addListener(this._juhu,q,this._onclick2,this);
qx.event.Registration.addListener(s.getElementById(h),c,this._onkeydown,this);

for(var i=1;i<10;i++){var r=s.getElementById(l+i);
qx.event.Registration.addListener(r,q,this._cascadeCapture,this,true);
qx.event.Registration.addListener(r,q,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(s.getElementById(o),o,this._scroll,this);
},_onkeydown:function(e){this.debug("keydown: "+e.getKeyIdentifier());
},_scroll:function(e){this.debug("scroll");
},_cascadeCapture:function(e){var a=e.getCurrentTarget();
this.debug("capture: "+a.id+" "+e.getEventPhase());
},_cascadeBubble:function(e){var u=e.getCurrentTarget();
this.debug("bubble: "+u.id+" "+e.getEventPhase());
...
qx.event.Registration.removeListener(this._juhu,q,this._onclick1);
},_onclick2:function(e){this.debug(e.getType()+" 2: "+e);
}},destruct:function(){this._disposeFields(m,b);
}});
})();
