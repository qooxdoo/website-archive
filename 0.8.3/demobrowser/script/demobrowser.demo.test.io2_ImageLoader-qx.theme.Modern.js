...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.io2_ImageLoader", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.io2_ImageLoader-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var e="100px",d="img",c="demobrowser.demo.test.io2_ImageLoader",b="http://resources.qooxdoo.org/images/logo.gif",a="absolute";
qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
qx.io2.ImageLoader.load(b,function(f,g){qx.log.Logger.debug("Image loaded ("+g.width+"x"+g.height+")");
