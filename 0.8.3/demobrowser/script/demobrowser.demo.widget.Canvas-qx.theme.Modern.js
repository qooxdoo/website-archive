...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Canvas", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Canvas-qx.theme.Modern-0.js"]],
  boot : "boot",
...
var v=new qx.ui.basic.Label(d);
this.getRoot().add(v,{left:10,top:10});
var u=new qx.ui.window.Window(f).set({width:200,height:200});
u.setLayout(new qx.ui.layout.Canvas());

if(qx.core.Variant.isSet(i,m)){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox());
t.add(new qx.ui.basic.Label(k).set({rich:true,alignX:j,alignY:h}));
}else{var t=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:false});
t.addListener(l,this.draw,this);
}u.add(t,{edge:0});
this.getRoot().add(u,{left:30,top:40});
u.open();
var r=new qx.ui.window.Window(g).set({width:200,height:200});
r.setLayout(new qx.ui.layout.Canvas());

if(qx.core.Variant.isSet(i,m)){var s=new qx.ui.container.Composite(new qx.ui.layout.HBox());
s.add(new qx.ui.basic.Label(k).set({rich:true,alignX:j,alignY:h}));
}else{var s=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:true});
s.addListener(l,this.draw,this);
}r.add(s,{edge:0});
this.getRoot().add(r,{left:30,top:250});
r.open();
...
(function(){var u="Integer",t="resize",s="_applyCanvasWidth",r="redraw",q="Boolean",p="__wL",o="_applyCanvasHeight",n="qx.ui.embed.Canvas",m="qx.event.type.Data";
qx.Class.define(n,{extend:qx.ui.core.Widget,construct:function(w,x){arguments.callee.base.call(this);
this.__wL=new qx.util.DeferredCall(this.__wM,this);
this.addListener(t,this._onResize,this);

if(w!==undefined){this.setCanvasWidth(w);
}
if(x!==undefined){this.setCanvasHeight(x);
}},events:{"redraw":m},properties:{syncDimension:{check:q,init:false},canvasWidth:{check:u,init:300,apply:s},canvasHeight:{check:u,init:150,apply:o}},members:{__wL:null,_createContentElement:function(){return new qx.html.Canvas();
},__wM:function(){var j=this.getContentElement();
var l=j.getHeight();
var i=j.getWidth();
var k=j.getContext2d();
this._draw(i,l,k);
this.fireNonBubblingEvent(r,qx.event.type.Data,[{width:i,height:l,context:k}]);
},_applyCanvasWidth:function(c,d){this.getContentElement().setWidth(c);
this.__wL.schedule();
},_applyCanvasHeight:function(a,b){this.getContentElement().setHeight(a);
this.__wL.schedule();
},update:function(){this.__wL.schedule();
},_onResize:function(e){var v=e.getData();

if(this.getSyncDimension()){this.setCanvasHeight(v.height);
this.setCanvasWidth(v.width);
}},getContext2d:function(){return this.getContentElement().getContext2d();
},_draw:function(f,g,h){}},destruct:function(){this._disposeObjects(p);
}});
})();
(function(){var e="canvas",d="__wN",c="2d",b="qx.html.Canvas";
qx.Class.define(b,{extend:qx.html.Element,construct:function(){arguments.callee.base.call(this,e);
this.__wN=document.createElement(e);
},members:{__wN:null,_createDomElement:function(){return this.__wN;
},getCanvas:function(){return this.__wN;
},setWidth:function(a){this.__wN.width=a;
},getWidth:function(){return this.__wN.width;
},setHeight:function(f){this.__wN.height=f;
},getHeight:function(){return this.__wN.height;
},getContext2d:function(){return this.__wN.getContext(c);
