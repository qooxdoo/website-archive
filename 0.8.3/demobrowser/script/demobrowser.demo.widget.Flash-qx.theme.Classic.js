...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Flash", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Flash-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var k="execute",j="Flash Player Version",i="__wP",h="right",g="qooxdoo is the best!",f="Message from Flash:",d="__wR",c="Simple demo with FlashVars",b="demobrowser.demo.widget.Flash",a="demobrowser/demo/flash/TestFlash.swf",B="Send to Flash",A="demobrowser/demo/flash/FlashVersion.swf",z="No message.",y="Flash:",x="<b>qooxdoo:</b>",w="__wO",v="__wS",u="demobrowser.demo.widget.Flash.sendMessage",t="demobrowser.demo.widget.Flash.flashReady",s="demobrowser/demo/flash/fo_tester.swf",q="this is passed in via FlashVars",r="Two way communication (ActionScript <-> JavaScript)",o="Message to Flash:",p="Show Flash Player version",m="__wQ",n="noscale",l="#FF6600";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__wO:null,main:function(){arguments.callee.base.call(this);
var E=new qx.ui.tabview.TabView();
E.setContentPadding([8,8,8,8]);
var H=this.getRoot();
H.add(E,{edge:0});
var F=new qx.ui.tabview.Page(c);
F.setLayout(new qx.ui.layout.Canvas());
F.add(this.createFlashDemo1(),{edge:0});
E.add(F);
var G=new qx.ui.tabview.Page(r);
G.setLayout(new qx.ui.layout.Canvas());
G.add(this.createFlashDemo2(),{edge:0});
E.add(G);
this.__wO=this.createWindow();
H.add(this.__wO,{top:20,left:20});
...
return D;
},createFlashDemo1:function(){var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var O={flashVarText:q};
var P=new qx.ui.embed.Flash(s).set({scale:n,variables:O,backgroundColor:l});
Q.add(P,{flex:1});
var R=new qx.ui.form.Button(p);
R.addListener(k,function(){this.__wO.open();
},this);
Q.add(R);
return Q;
},__wP:null,__wQ:null,__wR:null,__wS:null,createFlashDemo2:function(){arguments.callee.self.setCallBackInstance(this);
var K=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var J=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
K.add(J,{flex:1});
J.add(new qx.ui.basic.Label(x).set({rich:true}));
J.add(new qx.ui.basic.Label(f));
this.__wQ=new qx.ui.form.TextArea(z);
this.__wQ.setEnabled(false);
J.add(this.__wQ,{flex:1});
J.add(new qx.ui.basic.Label(o));
this.__wR=new qx.ui.form.TextArea(g);
J.add(this.__wR,{flex:1});
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));
this.__wS=new qx.ui.form.Button(B);
this.__wS.setEnabled(false);
this.__wS.addListener(k,function(e){this.__wP.getFlashElement().sendMessage(this.__wR.getValue());
},this);
L.add(this.__wS);
J.add(L);
var I=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
K.add(I,{flex:1});
I.add(new qx.ui.basic.Label(y).set({rich:true}));
this.__wP=new qx.ui.embed.Flash(a);
this.__wP.setVariables({init:t});
I.add(this.__wP,{flex:1});
return K;
},sendMessage:function(M){this.__wQ.setValue(M);
},initFlash:function(){if(this.__wP.getFlashElement().setup){this.__wP.getFlashElement().setup(u);
this.__wS.setEnabled(true);
...
}}},statics:{__wT:null,setCallBackInstance:function(C){demobrowser.demo.widget.Flash.__wT=C;
},sendMessage:function(N){demobrowser.demo.widget.Flash.__wT.sendMessage(N);
},flashReady:function(){demobrowser.demo.widget.Flash.__wT.initFlash();
}},destruct:function(){this._disposeObjects(m,d,v,i,w);
}});
})();
...
(function(){var z="Boolean",y="sameDomain",x="opaque",w="String",v="best",u="quality",t="_applyVariables",s="low",r="_applyLoop",q="scale",bk="_applyAllowScriptAccess",bj="showall",bi="Map",bh="wmode",bg="excactfit",bf="bgcolor",be="_applyMenu",bd="menu",bc="_applyPlay",bb="loop",G="allowScriptAccess",H="_applyWmode",E="#",F="noborder",C="swLiveConnect",D="qx.ui.embed.Flash",A="_applyId",B="high",I="",J="transparent",Q="play",O="_applyLiveConnect",U="_applySource",S="appear",W="medium",V="flash",L="_applyMayScript",ba="_applyQuality",Y="never",X="_applyScale",K="autohigh",M="always",N="window",P="noscale",R="autolow",T="mayscript";
qx.Class.define(D,{extend:qx.ui.core.Widget,construct:function(o,p){arguments.callee.base.call(this);
{};
this.setSource(o);
...
this.addListenerOnce(S,function(){this.getContentElement().createFlash();
},this);
},properties:{source:{check:w,apply:U},id:{check:w,apply:A},quality:{check:[s,R,K,W,B,v],init:v,nullable:true,apply:ba},scale:{check:[bj,F,bg,P],nullable:true,apply:X},wmode:{check:[N,x,J],init:x,nullable:true,apply:H},play:{check:z,nullable:true,apply:bc},loop:{check:z,nullable:true,apply:r},mayScript:{check:z,nullable:false,apply:L},menu:{check:z,nullable:true,apply:be},allowScriptAccess:{check:[y,M,Y],init:y,nullable:true,apply:bk},liveConnect:{check:z,init:true,nullable:true,apply:O},variables:{init:{},check:bi,apply:t}},members:{getFlashElement:function(){var g=this.getContentElement();

if(g){return g.getFlashElement();
}else{return null;
}},_createContentElement:function(){return new qx.html.Flash();
},_applySource:function(j,k){var l=qx.util.ResourceManager.getInstance().toUri(j);
this.getContentElement().setSource(l);
qx.ui.core.queue.Layout.add(this);
},_applyId:function(br,bs){this.getContentElement().setId(br);
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(bp,bq){this.getContentElement().setVariables(bp);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(bB,bC){this.getContentElement().setAttribute(T,bB?I:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bz,bA){this.__wU(u,bz);
},_applyScale:function(bl,bm){this.__wU(q,bl);
},_applyWmode:function(bv,bw){this.__wU(bh,bv);
},_applyPlay:function(a,b){this.__wU(Q,a);
},_applyLoop:function(bn,bo){this.__wU(bb,bn);
},_applyMenu:function(bx,by){this.__wU(bd,bx);
},_applyAllowScriptAccess:function(bt,bu){this.__wU(G,bt);
},_applyLiveConnect:function(e,f){this.__wU(C,e);
},_applyBackgroundColor:function(c,d){c=this.__wV(c);
this.__wU(bf,c);
},__wU:function(m,n){this.getContentElement().setParam(m,n);
qx.ui.core.queue.Layout.add(this);
},__wV:function(h){if(!h){return h;
}var i=qx.util.ColorUtil.stringToRgb(h);
return E+qx.util.ColorUtil.rgbToHexString(i);
}}});
})();
(function(){var h="__wW",g="__wY",f="__wX",e="movie",d="div",c="id",b="qx.html.Flash";
qx.Class.define(b,{extend:qx.html.Element,construct:function(){arguments.callee.base.call(this);
this.__wW={};
this.__wX={};
this.__wY={};
},members:{__wW:null,__wY:null,__wX:null,__xa:null,_createDomElement:function(){return qx.bom.Element.create(d);
},createFlash:function(){this.__xa=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__wX,this.__wW);
},setSource:function(i){{};

if(this.__xa){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(e,i);
},setId:function(n){{};

if(this.__xa){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(c,n);
},getVariables:function(){return this.__wX;
},setVariables:function(a){{};

if(this.__xa){throw new Error("The variables cannot be modified after initial creation");
}this.__wX=a;
},getAttributes:function(){return this.__wY;
},setAttribute:function(l,m){{};

if(this.__xa){throw new Error("The attributes cannot be modified after initial creation");
}
if(m===null||m===undefined){delete this.__wY[l];
}else{this.__wY[l]=m;
}},getParams:function(){return this.__wW;
},setParam:function(j,k){{};

if(this.__xa){throw new Error("The params cannot be modified after initial creation");
}
if(k===null||k===undefined){delete this.__wW[j];
}else{this.__wW[j]=k;
}},getFlashElement:function(){return this.__xa;
}},destruct:function(){if(this.__xa){qx.bom.Flash.destroy(this.__xa);
}this._disposeFields(h,f,g);
}});
})();
