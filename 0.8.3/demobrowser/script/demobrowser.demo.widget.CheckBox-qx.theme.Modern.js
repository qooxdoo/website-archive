...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.CheckBox-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var p="",o=", ",n="demobrowser.demo.widget.CheckBox",m="Bathing togs",l="_checkBoxes",k="OK",j="Towel",h="Sun Oil",g="Beer",f="What do you need for the beach?",d="execute";
qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var u=new qx.ui.basic.Label(f);
...
r.add(u);
var q=new qx.ui.form.CheckBox(h);
var x=new qx.ui.form.CheckBox(j);
var v=new qx.ui.form.CheckBox(g);
var w=new qx.ui.form.CheckBox(m);
...
t.addListener(d,this._onExecute,this);
t.setAllowGrowX(false);
r.add(t);
},_onExecute:function(e){var b=this._checkBoxes;
var a=0;
var c=p;

for(var i=0;i<b.length;i++){if(b[i].getValue()){a++;
c+=(b[i].getLabel()+o);
}}
if(a>0){c=c.substring(0,c.length-2);
alert("You need these things for the beach: "+c);
