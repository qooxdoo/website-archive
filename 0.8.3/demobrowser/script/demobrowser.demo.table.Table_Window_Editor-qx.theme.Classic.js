...
qx.$$translations = {"C": {}, "en": {}, "fr_FR": {}, "de": {"key_short_Meta": "Meta", "one of one row": "Eine von einer Zeile", "key_short_Scroll": "Rollen", "key_full_Left": "Pfeil links", "key_short_Control": "Strg", "key_short_Home": "Pos1", "Reset column widths": "Spaltenbreite zurücksetzen", "key_short_Space": "Leer", "one row": "Eine Zeile", "key_short_Shift": "Umschalt", "key_full_Control": "Steuerung", "key_full_Insert": "Einfügen", "key_full_Scroll": "Rollen", "key_short_Apps": "Kontext", "key_short_Backspace": "Rück", "key_short_Alt": "Alt", "key_full_Shift": "Umschalttaste", "key_full_Pause": "Pause", "key_full_Space": "Leertaste", "key_short_PageDown": "Bild runter", "%1 of %2 rows": "%1 von %2 Zeilen", "key_full_NumLock": "NumLock", "key_full_Tab": "Tabulator", "key_full_End": "Ende", "key_full_PageDown": "Bild runter ", "key_short_Escape": "Esc", "key_full_Apps": "Kontextmenü", "key_full_Delete": "Entfernen", "key_full_Backspace": "Rücktaste", "key_full_Alt": "Alt", "key_short_Tab": "Tab", "key_short_Win": "Win", "key_short_PageUp": "Bild hoch", "key_full_Right": "Pfeil rechts", "key_short_Down": "Runter", "key_short_PrintScreen": "Druck", "key_full_Win": "Windowstaste", "key_short_Right": "Rechts ", "key_short_NumLock": "Num", "key_full_Escape": "Escape", "key_full_PageUp": "Bild hoch", "key_short_CapsLock": "Feststell", "key_short_Enter": "Enter", "key_short_Pause": "Pause", "key_short_Left": "Links", "key_full_Enter": "Enter", "%1 rows": "%1 Zeilen", "key_full_CapsLock": "Feststelltaste", "key_short_Up": "Hoch", "key_full_PrintScreen": "Drucken", "key_full_Meta": "Meta", "key_short_End": "Ende", "key_full_Home": "Position 1", "key_full_Up": "Pfeil hoch", "key_short_Delete": "Entf", "key_short_Insert": "Einfg", "key_full_Down": "Pfeil runter"}, "fr": {"key_short_Meta": "Meta", "one of one row": "ligne une de une", "key_short_Scroll": "Arrêt Défil", "key_full_Left": "Gauche", "key_short_Control": "Ctrl", "key_short_Home": "Orig.", "Reset column widths": "Réinitialiser la largeur des colonnes", "key_short_Space": "Espace", "one row": "une ligne", "key_short_Shift": "Maj", "key_full_Control": "Contrôle", "key_full_Insert": "Insertion", "key_full_Scroll": "Arrêt défilement", "key_short_Apps": "App.", "key_short_Backspace": "Effacement Arrière", "key_short_Alt": "Alt", "key_full_Shift": "Majuscules", "key_full_Pause": "Pause", "key_full_Space": "Espace", "key_short_PageDown": "Pg Suiv.", "%1 of %2 rows": "ligne %1 de %2", "key_full_NumLock": "Verouillage Numérique", "key_full_Tab": "Tabulation", "key_full_End": "Fin", "key_full_PageDown": "Page Suivante", "key_short_Escape": "Echap.", "key_full_Apps": "Application", "key_full_Delete": "Suppression", "key_full_Backspace": "Effacement arrière", "key_full_Alt": "Alternative", "key_short_Tab": "Tab", "key_short_Win": "Win", "key_short_PageUp": "Pg Préc.", "key_full_Right": "Droite", "key_short_Down": "Bas", "key_short_PrintScreen": "Imp. Écran", "key_full_Win": "Windows", "key_short_Right": "Droite", "key_short_NumLock": "Verr. Num.", "key_full_Escape": "Échappement", "key_full_PageUp": "Page Précédente", "key_short_CapsLock": "Verr. Maj.", "key_short_Enter": "Entrée", "key_short_Pause": "Pause", "key_short_Left": "Gauche", "key_full_Enter": "Entrée", "%1 rows": "%1 lignes", "key_full_CapsLock": "Verrouillage des Majuscule", "key_short_Up": "Haut", "key_full_PrintScreen": "Impression de l'écran", "key_full_Meta": "Meta", "key_short_End": "Fin", "key_full_Home": "Origine", "key_full_Up": "Haut", "key_short_Delete": "Supp.", "key_short_Insert": "Ins.", "key_full_Down": "Bas"}, "en_US": {}, "de_DE": {}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.table.Table_Window_Editor-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var p="execute",o="Enter",n="A boolean",m="A number",l="Table with window cell editor",k="A date",j="",i="ModalCellEditorFactory",h="1*",g="50%",c="demobrowser.demo.table.Table_Window_Editor",f="appear",d="Cell Editor",b="ID",a="Save";
qx.Class.define(c,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return l;
...
var w={tableColumnModel:function(q){return new qx.ui.table.columnmodel.Resize(q);
}};
...
var v=y.getBehavior();
v.set(0,{width:h,minWidth:40,maxWidth:80});
v.setWidth(1,g);
v.setMinWidth(1,100);
v.setMaxWidth(1,320);
v.set(3,{width:100});
...
y.setCellEditorFactory(1,new ModalCellEditorFactory());
return A;
}}});
qx.Class.define(i,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,members:{createCellEditor:function(r){var u=new qx.ui.window.Window(d);
u.setLayout(new qx.ui.layout.HBox(4));
u.set({padding:3,modal:true,showClose:false,showMaximize:false,showMinimize:false});
u.moveTo(300,250);
u.addListener(f,function(e){u.__qd.focus();
u.__qd.setSelection(0,u.__qd.getValue().length);
});
u.__qd=new qx.ui.form.TextField(r.value+j).set({allowGrowY:true});
u.add(u.__qd);
var s=new qx.ui.form.Button(a);
s.addListener(p,function(e){u.close();
});
u.add(s);
var t=new qx.event.Command(o);
t.addListener(p,function(e){s.execute();
t.dispose();
t=null;
});
return u;
},getCellEditorValue:function(B){return parseFloat(B.__qd.getValue());
}}});
})();
