...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.MouseEvent", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.event.MouseEvent-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var s="</table>",r="</th></tr>",q="demobrowser.demo.event.EventDemo",p="</th><th>",o="",n="</td><td>",m="<table><tr><th>",l="<tr><td>",k="btnClear",j="__qx",f="click",h="</td></tr>",g="__qy";
qx.Class.define(q,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var t=document.getElementById(k);

if(t){qx.bom.Element.addListener(t,f,this._clearLog,this);
}},_initLogger:function(a,b,c){this.__qv=m+a.join(p)+r;
this.__qw=c||50;
this.__qx=b;
this._clearLog();
},_clearLog:function(){this.__qx.innerHTML=this.__qv+s;
this.__qy=[];
},_log:function(d){this.__qy.unshift(d);
this.__qy=this.__qy.slice(0,this.__qw);
var e=[this.__qv];

for(var i=0;i<this.__qy.length;i++){e.push(l,this.__qy[i].join(n),h);
}e.push(s);
this.__qx.innerHTML=e.join(o);
this.__qx.scrollTop=0;
},__qv:null,__qw:null,__qx:null,__qy:null},destruct:function(){this._disposeFields(j,g);
}});
})();
(function(){var t="mouse",s="change",r="mousedown",q="mouseout",p="demobrowser.demo.event.MouseEvent",o="clientX",n="dblclick",m="relatedTarget",l="button",k="capture",K="mousemove",J="pageY",I="screenX",H="logger",G="",F="_",E="mouseover",D="check_",C="click",B="Event",z="Target",A="clientY",x="mouseup",y="losecapture",v="contextmenu",w="screenY",u="pageX";
qx.Class.define(p,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
this._initLogger([z,B,l,u,J,o,A,I,w,m],document.getElementById(H),50);
var f=document.getElementById(t);
var h=[r,x,C,n,v,K,E,q];

for(var i=0;i<h.length;i++){var j=document.getElementById(D+h[i]);

if(j.checked){qx.bom.Element.addListener(f,h[i],this.logMouseEvent,this);
}qx.bom.Element.addListener(j,s,this.__qz,this);
}var g=document.getElementById(k);
g.checked=false;
qx.bom.Element.addListener(g,s,function(e){var d=e.getTarget().checked;

if(d){qx.bom.Element.capture(f);
}else{qx.bom.Element.releaseCapture(f);
}},this);
qx.bom.Element.addListener(f,y,function(e){g.checked=false;
},this);
},__qz:function(e){var c=e.getTarget().id.split(F)[1];
var a=e.getTarget().checked;
var b=document.getElementById(t);

if(a){qx.bom.Element.addListener(b,c,this.logMouseEvent,this);
}else{qx.bom.Element.removeListener(b,c,this.logMouseEvent,this);
}},logMouseEvent:function(L){L.preventDefault();
this._log([L.getTarget().id,L.getType(),L.getButton(),L.getDocumentLeft(),L.getDocumentTop(),L.getScreenLeft(),L.getScreenTop(),L.getViewportLeft(),L.getViewportTop(),L.getRelatedTarget()?L.getRelatedTarget().id:G]);
}}});
})();
