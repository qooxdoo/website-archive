...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.ElementResize", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.event.ElementResize-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var g="resize",f="demobrowser.demo.event.ElementResize",d="width: ",c="px",b="px<br>height: ";
...
qx.bom.Element.addListener(k,g,this._onResize,this);
this.update(k,k.offsetWidth,k.offsetHeight);
},_onResize:function(e){var a=e.getData();
this.update(e.getTarget(),a.width,a.height);
},update:function(h,i,j){h.innerHTML=d+i+b+j+c;
}}});
})();
...
(function(){var t="resize",s="qx.event.handler.ElementResize",r="interval",q="__pn",p="__pl",o="body",n="__pm";
qx.Class.define(s,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(h){arguments.callee.base.call(this);
this.__pl=h;
this.__pm={};
this.__pn=new qx.event.Timer(200);
this.__pn.addListener(r,this._onInterval,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__pm:null,__pl:null,__pn:null,canHandleEvent:function(A,B){return A.tagName.toLowerCase()!==o;
...
this.__pn.start();
}},unregisterEvent:function(i,j,k){var m=qx.core.ObjectRegistry.toHashCode(i);
var l=this.__pm;

if(l[m]){delete l[m];

if(qx.lang.Object.isEmpty(l)){this.__pn.stop();
}}},_onInterval:function(e){var b=this.__pm;
