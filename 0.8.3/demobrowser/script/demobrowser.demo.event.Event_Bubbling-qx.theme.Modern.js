...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.Event_Bubbling", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.event.Event_Bubbling-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var n="click",m="at target",l="logger",k="Event phase",j="capture",h="Current target",g="div",f="Event",d="demobrowser.demo.event.Event_Bubbling",c="bubble",b="Target";
qx.Class.define(d,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
this._initLogger([f,b,h,k],document.getElementById(l),50);

for(var i=1;i<10;i++){var a=document.getElementById(g+i);
qx.event.Registration.addListener(a,n,this._cascadeCapture,this,true);
qx.event.Registration.addListener(a,n,this._cascadeBubble,this,false);
}},_cascadeCapture:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?m:j]);
},_cascadeBubble:function(e){this._log([e.getType(),e.getTarget().id,e.getCurrentTarget().id,e.getEventPhase()==2?m:c]);
}}});
})();
