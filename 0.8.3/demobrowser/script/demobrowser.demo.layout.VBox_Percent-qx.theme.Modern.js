...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_Percent", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.VBox_Percent-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var u="main",t="green",s="33%",r="yellow",q="50%",p="demobrowser.demo.layout.VBox_Percent";
qx.Class.define(p,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var v=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(v);
v.add(this.getBox1());
v.add(this.getBox2());
v.add(this.getBox3());
...
var I=new qx.ui.container.Composite(G).set({decorator:u,backgroundColor:r,height:300,allowGrowY:false});
G.setSpacing(5);
var K=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var J=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var H=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
I.add(K,{height:q});
I.add(J,{flex:1});
I.add(H,{flex:1});
return I;
},getBox2:function(){var w=new qx.ui.layout.VBox();
var y=new qx.ui.container.Composite(w).set({decorator:u,backgroundColor:r,height:300,allowGrowY:false});
w.setSpacing(5);
var A=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var z=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var x=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
y.add(A,{height:s});
y.add(z,{height:s});
y.add(x,{height:s,flex:1});
return y;
},getBox3:function(){var B=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(B).set({decorator:u,backgroundColor:r,allowGrowY:false});
B.setSpacing(5);
var F=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var E=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var C=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
D.add(F,{height:q});
D.add(E,{flex:1});
D.add(C,{flex:1});
return D;
},getBox4:function(){var k=new qx.ui.layout.VBox();
var m=new qx.ui.container.Composite(k).set({decorator:u,backgroundColor:r,allowGrowY:false});
k.setSpacing(5);
var o=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var n=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var l=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
m.add(o,{height:s,flex:1});
m.add(n,{height:s,flex:1});
m.add(l,{height:s,flex:1});
return m;
},getBox5:function(){var f=new qx.ui.layout.VBox();
var h=new qx.ui.container.Composite(f).set({decorator:u,backgroundColor:r,height:100,allowGrowY:false});
f.setSpacing(5);
var j=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var i=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var g=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
h.add(j,{height:s,flex:1});
h.add(i,{height:s,flex:1});
h.add(g,{height:s,flex:1});
return h;
},getBox6:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:u,backgroundColor:r,height:300,allowGrowY:false});
a.setSpacing(5);
var e=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var d=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
var b=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t});
c.add(e,{height:s,flex:1});
c.add(d,{height:s,flex:1});
c.add(b,{height:s,flex:1});
return c;
}}});
})();
