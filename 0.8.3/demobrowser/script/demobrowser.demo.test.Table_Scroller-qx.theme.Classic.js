...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Table_Scroller", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Table_Scroller-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var e="main",d="demobrowser.demo.test.Table_Scroller",c="#FFE",b="demobrowser.demo.table.Scroller.DummyTable",a="table";
qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var h=new demobrowser.demo.table.Scroller.DummyTable();
this.getRoot().add(h,{left:10,top:10});
}}});
qx.Class.define(b,{extend:qx.ui.container.Composite,include:[demobrowser.demo.table.MUtil],construct:function(){arguments.callee.base.call(this,new qx.ui.layout.Canvas());
