...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HBox_Margin", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.HBox_Margin-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var t="main",s="green",r="yellow",q="middle",p="demobrowser.demo.layout.HBox_Margin";
...
var m=new qx.ui.container.Composite(k).set({decorator:t,backgroundColor:r,allowGrowX:false});
k.setSpacing(5);
var o=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var n=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var l=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
m.add(o);
m.add(n);
m.add(l);
...
var c=new qx.ui.container.Composite(a).set({decorator:t,backgroundColor:r,allowGrowX:false});
a.setSpacing(5);
var e=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var d=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var b=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
c.add(e);
c.add(d);
c.add(b);
e.setMarginTop(20);
...
var h=new qx.ui.container.Composite(f).set({decorator:t,backgroundColor:r,height:100,allowGrowX:false});
f.setSpacing(5);
f.setAlignY(q);
var j=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var i=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var g=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
h.add(j);
h.add(i);
h.add(g);
...
return h;
},getBox4:function(){var u=new qx.ui.layout.HBox();
var w=new qx.ui.container.Composite(u).set({decorator:t,backgroundColor:r,height:100,allowGrowX:false});
u.setSpacing(5);
u.setAlignY(q);
var y=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var x=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var v=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
w.add(y);
w.add(x);
w.add(v);
y.setMarginTop(20);
v.setMarginTop(5);
v.setMinHeight(50);
v.setMarginBottom(20);
return w;
},getBox5:function(){var z=new qx.ui.layout.HBox();
var B=new qx.ui.container.Composite(z).set({decorator:t,backgroundColor:r,height:100,allowGrowX:false});
z.setSpacing(5);
z.setAlignY(q);
var D=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var C=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
var A=new qx.ui.core.Widget().set({decorator:t,backgroundColor:s});
B.add(D);
B.add(C);
B.add(A);
D.setMarginTop(20);
