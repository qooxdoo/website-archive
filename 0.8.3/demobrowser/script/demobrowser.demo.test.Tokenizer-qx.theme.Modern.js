...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Tokenizer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Tokenizer-qx.theme.Modern-0.js"]],
  boot : "boot",
...
document.getElementById(c).onclick=function(){var m=qx.dev.Tokenizer.tokenizeJavaScript(n.value);
q.innerHTML=qx.bom.String.escape(qx.util.Json.stringify(m,true));
};
var p=function(){var k=qx.dev.Tokenizer.tokenizeJavaScript(n.value);
var l=[];

for(var i=0;i<k.length;i++){l[i]=k[i].value;
}q.innerHTML=h+qx.bom.String.escape(l.join(f))+j;
};
document.getElementById(g).onclick=p;
var o=function(){q.innerHTML=h+qx.dev.Tokenizer.javaScriptToHtml(n.value)+j;
};
document.getElementById(b).onclick=o;
o();
}}});
})();
