...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Classic-0.js"]],
  boot : "boot",
...
var i=true;
h.addListener(b,function(){scrollContainer.setWidth(i?300:200);
scrollContainer.setHeight(i?300:200);
i=!i;
});
