...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.ScrollContainer_EdgeCaseWidth", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.ScrollContainer_EdgeCaseWidth-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var z="value",y="changeSelection",x="execute",w="ScrollbarX:",v="ScrollbarY:",u="Toggle content",t="blue",s="black",r="auto",q="Off",k="white",p="demobrowser.demo.test.ScrollContainer_EdgeCaseWidth",n="off",j="On",i="Content size: 300x300",m="Toggle pane",l="solid",o="Auto",h="on";
...
var G=true;
D.addListener(x,function(){B.setHeight(G?300:200);
G=!G;
});
this.getRoot().add(D,{left:330,top:20});
var C=new qx.ui.form.Button(u);
var F=true;
C.addListener(x,function(){B.getChildren()[0].setHeight(F?100:300);
F=!F;
});
this.getRoot().add(C,{left:430,top:20});
var E=this.generateScrollbarConfig(w,100);
var A=this.generateScrollbarConfig(v,120);
E.addListener(y,function(e){B.setScrollbarX(e.getData()[0].getUserData(z));
});
A.addListener(y,function(e){B.setScrollbarY(e.getData()[0].getUserData(z));
});
...
a.setMarginRight(20);
var b=new qx.ui.form.RadioButton(o);
var d=new qx.ui.form.RadioButton(j);
var c=new qx.ui.form.RadioButton(q);
b.setUserData(z,r);
d.setUserData(z,h);
c.setUserData(z,n);
b.setValue(true);
...
return g;
},generateBox:function(){var H=new qx.ui.basic.Label(i).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:t,textColor:k,padding:10,decorator:new qx.ui.decoration.Single(4,l,s)});
return H;
},__oC:null}});
})();
