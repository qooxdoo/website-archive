...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.Event", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.event.Event-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var k="click",j="keydown",i="execute",h="input",g="scroll",f="resize",d="Shift-Meta-F1",c="keyinput: ",b=" 1: ",a="Ctrl-A",E="inner",D="keyinput",C="scroll:",B="demobrowser.demo.event.Event",A="keydown: ",z=": ",y="logger",x="juhu",w=" (inner): ",v="mouseover",r="mouse out",s="mouseout",p="_juhu",q="Events",n=" 2: ",o="prevent default ",l="mouse over",m="contextmenu",t="Resize:",u="_inner";
qx.Class.define(B,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
this._initLogger([q],document.getElementById(y),50);
qx.event.Registration.addListener(window,f,this._onResize,this);
var F=new qx.event.Command(d);
F.addListener(i,function(){this.debug(F.toString());
},this);
var G=new qx.event.Command(a);
G.addListener(i,function(){this.debug(G.toString());
},this);
...
},_onclick2:function(e){this._log([e.getType()+n+e]);
}},destruct:function(){this._disposeFields(p,u);
}});
})();
