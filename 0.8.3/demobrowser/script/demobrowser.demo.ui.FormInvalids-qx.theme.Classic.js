...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.FormInvalids", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.ui.FormInvalids-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var o="changeValue",n="I am a box",m="disable tooltips",l="RadioGroup 2",k=" invalidate all shown widgets. Try the invalid focus and tooltip.",j="RadioGroup 1",h="Invalid (",g="demobrowser.demo.ui.FormInvalids",f=")...",d="disabled",a="<b>Validation</b><br/>Press the button to",c="Item ",b="invalid";
...
var p=new qx.ui.form.RadioButton(j);
t.add(p);
this.getRoot().add(p,{left:530,top:250});
var q=new qx.ui.form.RadioButton(l);
t.add(q);
this.getRoot().add(q,{left:530,top:270});
w.push(t);
var s=new qx.ui.form.ToggleButton(b);
this.getRoot().add(s,{left:260,top:20});
s.addListener(o,function(e){for(var i=0;i<w.length;i++){w[i].setInvalidMessage(h+i+f);
...
var r=new qx.ui.form.ToggleButton(m);
