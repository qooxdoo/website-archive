...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.animation.Transition_Color-qx.theme.Modern-0.js"]],
  boot : "boot",
...
var z=this.getRoot();
var J=new qx.ui.embed.Html();
J.setHtml(d);
J.setCssClass(g);
z.add(J);
var G={linear:p,easeInQuad:t,easeOutQuad:h,sinodial:j,reverse:a,wobble:o,spring:c,flicker:i,pulse:u};
var x=new qx.ui.form.SelectBox();
var I=new qx.ui.form.Button(b);
var B=new qx.ui.basic.Label(v);
var C=new qx.ui.basic.Label(r);
var H=new qx.ui.basic.Label(l);
var C=new qx.ui.basic.Label(G.linear);
var D=new qx.ui.form.Spinner;

for(var A in G){x.add(new qx.ui.form.ListItem(A));
}x.addListener(q,function(e){C.setValue(G[C.setValue(e.getData()[0].getLabel())]);
});
D.set({maximum:10.0,minimum:0.1,value:1.0});
var y;
J.addListenerOnce(f,function(){y=new qx.fx.effect.core.Highlight(J.getContentElement().getDomElement());
