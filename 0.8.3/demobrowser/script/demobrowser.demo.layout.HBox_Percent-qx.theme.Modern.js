...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.HBox_Percent-qx.theme.Modern-0.js"]],
  boot : "boot",
...
s.add(this.getBox5());
s.add(this.getBox6());
},getBox1:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
...
b.add(a,{flex:1});
return b;
},getBox4:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,allowGrowX:false});
var A=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
...
return y;
},getBox5:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:200,allowGrowX:false});
...
p.add(r,{width:h,flex:1});
p.add(q,{width:h,flex:1});
p.add(o,{width:h,flex:1});
return p;
},getBox6:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
