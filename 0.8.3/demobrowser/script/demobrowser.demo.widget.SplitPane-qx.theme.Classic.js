...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.SplitPane", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.SplitPane-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var B="value",A="horizontal",z="first",y="both",x="Trash",w="second",v="main",u="Show first pane",t="Documents (D:)",s="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",X="Windows (C:)",W="Toggle Splitpane Orientation",V="Inbox",U="Desktop",T="_container1",S="execute",R="Presets",Q="Network",P="changeSelection",O="Sent",I="/",J="Files",G="_container2",H="vertical",E="Workspace",F="Junk #",C="Data",D="Show both panes",K="Show second pane",L="demobrowser.demo.widget.SplitPane",N="Edit",M="__wz";
qx.Class.define(L,{extend:qx.application.Standalone,members:{__wz:null,main:function(){arguments.callee.base.call(this);
var ba=new qx.ui.container.Scroll();
var Y=new qx.ui.container.Composite(new qx.ui.layout.Basic());
Y.setAllowStretchX(false);
ba.add(Y);
var bg=new qx.ui.splitpane.Pane(A).set({width:450,height:300});
this.__wz=bg;
var bj=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:v});
var bm=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:v});
var bd=this.__wA();
var bc=new qx.ui.form.Button(W).set({allowGrowX:false,allowGrowY:false});
bc.addListener(S,this._toggle,this);
var be=new qx.ui.basic.Label(s);
be.setRich(true);
bj.add(bd);
bm.add(bc);
bm.add(be);
...
var bk=new qx.ui.form.RadioButton(u);
var bl=new qx.ui.form.RadioButton(K);
var bi=new qx.ui.form.RadioButton(D);
bk.setUserData(B,z);
bl.setUserData(B,w);
bi.setUserData(B,y);
bi.setValue(true);
...
bf.addListener(P,this._changeVisiblity,this);
Y.add(bh,{left:490,top:42});
bc.focus();
},_toggle:function(){var bn=this.__wz.getOrientation();
this.__wz.setOrientation(bn==A?H:A);
},_changeVisiblity:function(e){var a=e.getData()[0].getUserData(B);

if(a==y){this._container1.show();
this._container2.show();
}else if(a==z){this._container1.show();
this._container2.exclude();
}else if(a==w){this._container1.exclude();
this._container2.show();
}},__wA:function(){var m=new qx.ui.tree.Tree();
m.setDecorator(null);
var r=new qx.ui.tree.TreeFolder(I);
r.setOpen(true);
m.setRoot(r);
var p=new qx.ui.tree.TreeFolder(U);
p.setOpen(true);
r.add(p);
var g=new qx.ui.tree.TreeFolder(J);
var d=new qx.ui.tree.TreeFolder(E);
var f=new qx.ui.tree.TreeFolder(Q);
var c=new qx.ui.tree.TreeFolder(x);
p.add(g,d,f,c);
var n=new qx.ui.tree.TreeFile(X);
var b=new qx.ui.tree.TreeFile(t);
d.add(n,b);
var q=new qx.ui.tree.TreeFolder(V);
var h=new qx.ui.tree.TreeFolder(R);
var l=new qx.ui.tree.TreeFolder(O);
var k=new qx.ui.tree.TreeFolder(x);

for(var i=0;i<100;i++){k.add(new qx.ui.tree.TreeFile(F+i));
}var o=new qx.ui.tree.TreeFolder(C);
var j=new qx.ui.tree.TreeFolder(N);
q.add(h,l,k,o,j);
r.add(q);
return m;
}},destruct:function(){this._disposeObjects(M,T,G);
}});
})();
