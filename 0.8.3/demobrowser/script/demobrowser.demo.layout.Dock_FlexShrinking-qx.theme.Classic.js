...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Dock_FlexShrinking", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Dock_FlexShrinking-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var o="main",n="east",m="yellow",l="center",k="north",j="south",i="west",h="green",g="blue",f="fuchsia",c="orange",e="red",d="demobrowser.demo.layout.Dock_FlexShrinking",b="x",a="y";
qx.Class.define(d,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(q);
var p=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:o,backgroundColor:m,width:150,height:100,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});
var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:g});
var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:c});
var t=new qx.ui.core.Widget().set({decorator:o,backgroundColor:h});
var s=new qx.ui.core.Widget().set({decorator:o,backgroundColor:f});
p.add(w,{edge:k,flex:1});
p.add(v,{edge:i,flex:1});
p.add(u,{edge:j,flex:1});
p.add(t,{edge:n,flex:1});
p.add(s,{edge:l});
q.add(p);
var r=new qx.ui.layout.Dock();
r.setSort(a);
var p=(new qx.ui.container.Composite(r)).set({decorator:o,backgroundColor:m,width:150,height:100,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});
var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:g});
var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:c});
var t=new qx.ui.core.Widget().set({decorator:o,backgroundColor:h});
