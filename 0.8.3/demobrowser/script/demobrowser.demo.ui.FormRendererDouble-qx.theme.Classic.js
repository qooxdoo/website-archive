...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.FormRendererDouble", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.ui.FormRendererDouble-qx.theme.Classic-0.js"]],
  boot : "boot",
...
q.addButton(r);
var u=q.createView(qx.ui.form.renderer.Double);
...
(function(){var k="top",j="left",h=" <span style='color:red'>*</span> ",g="bold",f="",e="qx.ui.form.renderer.Double",d="right",c=" :";
qx.Class.define(e,{extend:qx.ui.core.Widget,implement:qx.ui.form.renderer.IFormRenderer,construct:function(){arguments.callee.base.call(this);
var t=new qx.ui.layout.Grid();
t.setSpacing(6);
t.setColumnAlign(0,j,k);
t.setColumnAlign(1,j,k);
t.setColumnAlign(2,j,k);
t.setColumnAlign(3,j,k);
this._setLayout(t);
...
}var s=new qx.ui.basic.Label(name+r+c);
s.setRich(true);
return s;
},_createHeader:function(u){var v=new qx.ui.basic.Label(u);
v.setFont(g);
