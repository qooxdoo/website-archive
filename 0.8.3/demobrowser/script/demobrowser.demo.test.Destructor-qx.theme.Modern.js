...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Destructor", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Destructor-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var h="Window: ",g="__fi",f="interval",e="Label: ",d="demobrowser.demo.test.Destructor";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__fg:[],main:function(){arguments.callee.base.call(this);
this.currentTest=this.testWindows;
this.__fh=0;
this.__fi=new qx.event.Timer(1000);
this.__fi.addListener(f,this.runTest,this);
this.__fi.start();
timer=this.__fi;
},runTest:function(){this.__fh++;
var c=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__fh+" (Registry: "+c+")");
this.currentTest();
qx.ui.core.queue.Manager.flush();
var b=this.__fg;

for(var i=0,l=b.length;i<l;i++){b[i].destroy();
}b.length=0;
qx.ui.core.queue.Manager.flush();
var c=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Done! (Registry: "+c+")");
},testLabels:function(){for(var i=0;i<250;i++){var j=new qx.ui.basic.Label(e+i);
this.getRoot().add(j,{left:50,top:50+i*20});
this.__fg.push(j);
}},testWindows:function(){for(var i=0;i<5;i++){var a=new qx.ui.window.Window(h+i);
a.open();
this.__fg.push(a);
