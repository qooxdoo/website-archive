...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Spinner", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Spinner-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var x="0",w="middle",v="100",u="left",t="Disabled",s="Not Editable",r="demobrowser.demo.widget.Spinner",q="Stepped",p="Wrap",o="-3000",i="30",n="300",l="3000",h="changeValue",g="-30",k="Simple",j="Number format",m="right";
qx.Class.define(r,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(y,z){var A=new qx.ui.form.Spinner();
y.add(new qx.ui.basic.Label(k),{column:0,row:z});
y.add(new qx.ui.basic.Label(x),{column:1,row:z});
y.add(A,{column:2,row:z});
y.add(new qx.ui.basic.Label(v),{column:3,row:z});
A.addListener(h,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(B,C){var D=new qx.ui.form.Spinner(0,50,100);
D.setEditable(false);
B.add(new qx.ui.basic.Label(s),{column:0,row:C});
B.add(new qx.ui.basic.Label(x),{column:1,row:C});
B.add(D,{column:2,row:C});
B.add(new qx.ui.basic.Label(v),{column:3,row:C});
},addWrappingSpinner:function(I,J){var K=new qx.ui.form.Spinner(-30,30,30);
K.setWrap(true);
I.add(new qx.ui.basic.Label(p),{column:0,row:J});
I.add(new qx.ui.basic.Label(g),{column:1,row:J});
...
L.add(new qx.ui.basic.Label(o),{column:1,row:M});
L.add(N,{column:2,row:M});
L.add(new qx.ui.basic.Label(l),{column:3,row:M});
},addDisabledSpinner:function(c,d){var f=new qx.ui.form.Spinner;
f.setEnabled(false);
c.add(new qx.ui.basic.Label(t),{column:0,row:d});
c.add(new qx.ui.basic.Label(x),{column:1,row:d});
c.add(f,{column:2,row:d});
c.add(new qx.ui.basic.Label(v),{column:3,row:d++});
...
G.setNumberFormat(H);
E.add(new qx.ui.basic.Label(j),{column:0,row:F});
E.add(new qx.ui.basic.Label(x),{column:1,row:F});
E.add(G,{column:2,row:F});
E.add(new qx.ui.basic.Label(n),{column:3,row:F++});
},main:function(){arguments.callee.base.call(this);
var b=new qx.ui.layout.Grid(10,8);
b.setColumnAlign(0,u,w);
b.setColumnAlign(1,m,w);
b.setColumnAlign(2,u,w);
b.setColumnAlign(3,u,w);
var a=new qx.ui.container.Composite(b);
a.setPadding(10);
this.getRoot().add(a,{left:0,top:0});
this.addSimpleSpinner(a,0);
this.addNonEditableSpinner(a,1);
this.addWrappingSpinner(a,2);
this.addSteppedSpinner(a,3);
this.addDisabledSpinner(a,4);
this.addFormattedSpinner(a,5);
}}});
})();
