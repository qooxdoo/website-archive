...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Grid_Animated-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var n="green",m="sinodial",l="click",k="yellow",j="width",i="height",h="demobrowser.demo.layout.Grid_Animated",g="orange",f="main";
...
},getNewWidget:function(){var q=new qx.ui.core.Widget().set({width:50,height:50,backgroundColor:n});
q.addListener(l,function(e){if(this._active==q){return;
}var c=[];
var a=0.3;

if(this._active){this._active.set({backgroundColor:n,width:50,height:50});
}q.set({backgroundColor:g});
var d=q.getBounds();
c.push(new demobrowser.demo.layout.Grid_Animated_Property(q,j).set({from:d.width,to:200,duration:a,transition:m}));
c.push(new demobrowser.demo.layout.Grid_Animated_Property(q,i).set({from:d.height,to:200,duration:a,transition:m}));
var b=new qx.fx.effect.core.Parallel(c[0],c[1]);
b.start();
this._active=q;
},this);
return q;
},getAnimGrid:function(){var o=new qx.ui.container.Composite().set({decorator:f,backgroundColor:k,width:500,height:500});
...
qx.Class.define(c,{extend:qx.fx.Base,construct:function(d,e){this._propName=e;
arguments.callee.base.call(this,d);
},members:{update:function(a){var b={};
b[this._propName]=Math.round(a);
this._getElement().set(b);
}}});
})();
