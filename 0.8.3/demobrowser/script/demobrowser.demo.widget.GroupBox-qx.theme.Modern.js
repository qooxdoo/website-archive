...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.GroupBox", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.GroupBox-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var p="legend",o="Please use the value property instead.",n="changeValue",m="execute",l="qx.event.type.Data",k="resize",j="check-groupbox",i="changeName",h="changeChecked",g="Please use boolean values instead.",d="qx.event.type.Event",f="qx.ui.groupbox.CheckGroupBox";
qx.Class.define(f,{extend:qx.ui.groupbox.GroupBox,include:[qx.ui.form.MFormElement],implement:[qx.ui.form.IExecutable,qx.ui.form.IBooleanForm],properties:{appearance:{refine:true,init:j}},events:{"changeChecked":l,"changeValue":l,"execute":d},members:{_createChildControlImpl:function(q){var r;

switch(q){case p:r=new qx.ui.form.CheckBox();
r.setValue(true);
r.addListener(n,this._onRadioChangeValue,this);
r.addListener(i,this._onRadioChangeName,this);
r.addListener(k,this._repositionFrame,this);
r.addListener(m,this._onExecute,this);
this._add(r);
}return r||arguments.callee.base.call(this,q);
...
},setCommand:function(a){this.getChildControl(p).setCommand(a);
},getCommand:function(){return this.getChildControl(p).getCommand();
},getValue:function(){return this.getChildControl(p).getValue();
},setValue:function(s){if(qx.lang.Type.isString(s)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
return;
}this.getChildControl(p).setValue(s);
},resetValue:function(){this.getChildControl(p).resetValue();
},getChecked:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,o);
return this.getValue();
},setChecked:function(b){qx.log.Logger.deprecatedMethodWarning(arguments.callee,o);
this.setValue(b);
}}});
})();
...
(function(){var r="legend",q="changeName",p="Please use the value property instead.",o="changeValue",n="execute",m="qx.event.type.Data",l="resize",k="changeChecked",j="qx.ui.groupbox.RadioGroupBox",i="Please use boolean values instead.",g="radio-groupbox",h="qx.event.type.Event";
qx.Class.define(j,{extend:qx.ui.groupbox.GroupBox,include:[qx.ui.form.MFormElement],implement:[qx.ui.form.IRadioItem,qx.ui.form.IExecutable,qx.ui.form.IBooleanForm],properties:{appearance:{refine:true,init:g}},events:{"changeChecked":m,"changeValue":m,"execute":h},members:{_createChildControlImpl:function(d){var f;

switch(d){case r:f=new qx.ui.form.RadioButton;
f.setValue(true);
f.addListener(o,this._onRadioChangeValue,this);
f.addListener(q,this._onRadioChangeName,this);
f.addListener(l,this._repositionFrame,this);
f.addListener(n,this._onExecute,this);
this._add(f);
}return f||arguments.callee.base.call(this,d);
},_onExecute:function(e){this.fireEvent(n);
},_onRadioChangeValue:function(e){var c=e.getData()?true:false;
this.getChildrenContainer().setEnabled(c);
this.fireDataEvent(k,c);
this.fireDataEvent(o,c,e.getOldData());
},_onRadioChangeName:function(e){this.fireDataEvent(q,e.getData());
},execute:function(){this.getChildControl(r).execute();
},setCommand:function(b){this.getChildControl(r).setCommand(b);
},getCommand:function(){return this.getChildControl(r).getCommand();
},getGroup:function(){return this.getChildControl(r).getGroup();
},setGroup:function(t){if(t!=null){t.add(this);
}return;
},getValue:function(){return this.getChildControl(r).getValue();
},setValue:function(a){if(qx.lang.Type.isString(a)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,i);
return;
}this.getChildControl(r).setValue(a);
},resetValue:function(){this.getChildControl(r).resetValue();
},getChecked:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,p);
return this.getValue();
},setChecked:function(s){qx.log.Logger.deprecatedMethodWarning(arguments.callee,p);
this.setValue(s);
},getLabel:function(){return this.getChildControl(r).getLabel();
}}});
})();
