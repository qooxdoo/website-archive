...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.progressive.ProgressiveTable_Mouseover", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var F="row",E="onmouseout='DateCellRenderer.onmouseout(this);' ",D="DateCellRenderer",C="rgb(255, 0, 0)",B="celldata",A="",z="Number",y="red",x="1*",w="celldata='",q="' ",v="<br>",t="demobrowser.demo.progressive.ProgressiveTable_Mouseover",p="onmouseover='DateCellRenderer.onmouseover(this);' ",o="end",s="Date",r="Move your mouse over the Date field",u="color",n="Id";
qx.Class.define(t,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var k=0;
var g=function(L){var O=[];
var N=new Date().getTime();
var P=400*24*60*60*1000;

for(var Q=0;Q<L;Q++){var M=new Date(N+Math.random()*P-P/2);
O.push({renderer:F,location:o,data:[k++,Math.random()*10000,M]});
}return O;
};
var j=new qx.ui.progressive.renderer.table.Widths(3);
j.setWidth(0,100);
j.setWidth(1,x);
j.setWidth(2,300);
var d=[n,z,s];
var f=new qx.ui.progressive.headfoot.TableHeading(j,d);
var c=new qx.ui.progressive.headfoot.Progress(j,d);
var m=new qx.ui.progressive.structure.Default(f,c);
var b=new qx.ui.progressive.Progressive(m);
var l=new qx.ui.basic.Atom(r);
l.setTextColor(y);
l.setHeight(16);
l.setRich(true);
b.add(l);
var i=new qx.ui.progressive.model.Default();
var h=g(500);
i.addElements(h);
b.setDataModel(i);
var e=new qx.ui.progressive.renderer.table.Row(j);
b.addRenderer(F,e);
e.addRenderer(2,new DateCellRenderer());
this.getRoot().add(b,{edge:50});
b.render();
}}});
qx.Class.define(D,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(G){G.__zg=qx.bom.element.Style.get(G,u);
G.style.color=C;
G.parentNode.style.height=32;
G.__zh=G.innerHTML;
var I=Date.parse(G.attributes.getNamedItem(B).nodeValue);
var H=new Date(I);
G.innerHTML=H.toUTCString()+v+H.toString();
},onmouseout:function(a){a.style.color=a.__zg;
a.parentNode.style.height=16;
a.innerHTML=a.__zh;
}},members:{_getCellExtras:function(J){var K=[];
K.push(arguments.callee.base.call(this));
K.push(w+J.cellData.toUTCString()+q);
K.push(p,E);
return K.join(A);
}}});
})();
