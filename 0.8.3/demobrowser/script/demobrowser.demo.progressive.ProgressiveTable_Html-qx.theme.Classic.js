...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.progressive.ProgressiveTable_Html-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var s="</div>",q="<div style='background-color: cyan; text-align: center;'>",p="row",o="2*",n="1*",m="    I'm red!",l="  </span>",k="end",j="Literal",i="  Hi there.",f="  <span style='color: red;'>",h="demobrowser.demo.progressive.ProgressiveTable_Html",g="  Hello world!",e="    &nbsp;&nbsp;&nbsp;",d="Html";
qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var C=0;
var B=function(a,b){var c={renderer:p,location:k,data:[a,a]};
return c;
};
