...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Login", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.animation.Login-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var u="top",t="right",s="resize",r="Name",q="Password",p="Login",o="__vF",n="__vG",m="appear",l="__vE",h="demobrowser.demo.animation.Login",k="50%",j="execute",g="30%";
qx.Class.define(h,{extend:qx.application.Standalone,members:{__vE:null,__vF:null,__vG:null,checkInput:function(){this.__vE.start();
},__vH:function(){this.__vE=new qx.fx.effect.combination.Shake(this.__vF.getContainerElement().getDomElement());
},main:function(){arguments.callee.base.call(this);
var b=new qx.ui.layout.Grid(9,5);
b.setColumnAlign(0,t,u);
b.setColumnAlign(2,t,u);
this.__vF=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__vF.setLayout(b);
this.__vF.addListener(s,function(e){var v=this.__vF.getBounds();
this.__vF.set({marginTop:Math.round(-v.height/2),marginLeft:Math.round(-v.width/2)});
},this);
this.getRoot().add(this.__vF,{left:k,top:g});
var a=[r,q];

for(var i=0;i<a.length;i++){this.__vF.add(new qx.ui.basic.Label(a[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var c=new qx.ui.form.TextField();
var d=new qx.ui.form.PasswordField();
this.__vF.add(c.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__vF.add(d.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var f=this.__vG=new qx.ui.form.Button(p);
f.setAllowStretchX(false);
this.__vF.add(f,{row:3,column:1});
f.addListener(j,this.checkInput,this);
this.__vF.addListener(m,this.__vH,this);
}},destruct:function(){this._disposeObjects(o,n,l);
}});
})();
