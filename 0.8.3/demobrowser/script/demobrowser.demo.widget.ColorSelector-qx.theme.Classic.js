...
qx.$$translations = {"C": {}, "en": {}, "fr_FR": {}, "de": {"HSB": "HSB", "RGB": "RGB", "Details": "Details", "Preview (Old/New)": "Vorschau (alt/neu)", "Presets": "Voreinstellungen", "Hex": "Hex"}, "fr": {"HSB": "TSV", "RGB": "RVB", "Details": "Détails", "Preview (Old/New)": "Aperçu (Ancien/Nouveau)", "Presets": "Pré-réglages", "Hex": "Hex"}, "en_US": {}, "de_DE": {}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.ColorSelector-qx.theme.Classic-0.js"]],
  boot : "boot",
