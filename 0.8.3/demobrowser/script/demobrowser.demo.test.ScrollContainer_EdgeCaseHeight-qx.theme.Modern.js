...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.ScrollContainer_EdgeCaseHeight-qx.theme.Modern-0.js"]],
  boot : "boot",
...
return H;
},generateBox:function(){var B=new qx.ui.basic.Label(b).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:n,textColor:j,padding:10,decorator:new qx.ui.decoration.Single(4,f,m)});
return B;
}}});
})();
