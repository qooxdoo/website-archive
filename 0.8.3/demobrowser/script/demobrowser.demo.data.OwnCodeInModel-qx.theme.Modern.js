...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.OwnCodeInModel", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.data.OwnCodeInModel-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var A="execute",z="icon/16/mimetypes/",y="name",x="model",w="model.items",v="demobrowser.demo.data.OwnCodeInModel",u=".png",t="json/list.json",s="type",r="Using the delegation to bring two sort function to the root model ",n="Sort By Name",q="items",p="class of this demo. The buttons just calling those sort functions.",m="<b>Adding own code to the model</b><br/>",l="demobrowser.demo.data.ItemsMixin",o="Sort By Type";
...
var g=new qx.data.controller.List(null,d);
g.setLabelPath(y);
g.setIconOptions({converter:function(D){return z+D+u;
}});
g.setIconPath(s);
var h={getModelMixins:function(C){if(C==q){return demobrowser.demo.data.ItemsMixin;
}}};
var c=t;
var j=new qx.data.store.Json(c,h);
j.bind(w,g,x);
var i=new qx.ui.form.Button(o);
i.setWidth(120);
this.getRoot().add(i,{left:130,top:80});
i.addListener(A,function(){j.getModel().sortByType();
},this);
var f=new qx.ui.form.Button(n);
f.setWidth(120);
this.getRoot().add(f,{left:130,top:110});
f.addListener(A,function(){j.getModel().sortByName();
},this);
var e=new qx.ui.basic.Label();
e.setRich(true);
e.setWidth(410);
e.setValue(m+r+p);
this.getRoot().add(e,{left:10,top:10});
}}});
qx.Mixin.define(l,{members:{sortByType:function(){var B=this.getItems();
B.sort(function(a,b){if(a.getType()>b.getType()){return 1;
}else if(a.getType()<b.getType()){return -1;
}else{return 0;
}});
},sortByName:function(){var k=this.getItems();
k.sort(function(a,b){return a.getName()>b.getName()?1:-1;
});
}}});
})();
