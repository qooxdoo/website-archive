...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.SearchAsYouType", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.data.SearchAsYouType-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var e="__AJ",d="_applySearchString",c="demobrowser.demo.data.filter.SearchAsYouTypeFilter",b="String",a="";
qx.Class.define(c,{extend:qx.core.Object,construct:function(f){arguments.callee.base.call(this);
this.__AJ=f;
this.filter=qx.lang.Function.bind(function(j){return j.search(this.getSearchString())!=-1;
},this);
this.__AK=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__AK:null,__AJ:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__AK!=null){i.stop(this.__AK);
this.__AK=null;
}this.__AK=i.start(function(){this.__AJ.update();
this.__AK=null;
},0,this,null,200);
},filter:null},destruct:function(){this._disposeFields(e);
}});
})();
