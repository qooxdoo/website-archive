...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Slider", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Slider-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var s="left",r="bottom",q="center",p="vertical",o="Max: ",n="changeValue",m="horizontal",l="top",k="middle",j="demobrowser.demo.widget.Slider",g="Min: ",h="right";
...
},_createVerticalLayout:function(){var u=[];
...
w.slider.setOrientation(p);
t.add(w.slider,{row:0,column:x,rowSpan:3,colSpan:1});
t.add(w.minimum,{row:0,column:x+1});
t.add(w.value,{row:1,column:x+1});
t.add(w.maximum,{row:2,column:x+1});
v.setColumnMinWidth(x+1,80);
v.setColumnWidth(x+2,20);
x+=3;
}return t;
},_createHorizontalLayout:function(){var b=[];
b.push(this._createSliderGroup(new qx.ui.form.Slider().set({maximum:1000,value:100})));
b.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-100,maximum:100,singleStep:5,pageStep:20,value:0})));
b.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-600,maximum:-200,singleStep:10,pageStep:50,value:-300})));
b.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:25,maximum:75,singleStep:5,pageStep:10,value:25})));
...
c.setColumnFlex(1,1);
c.setColumnFlex(2,1);
c.setColumnAlign(0,s,r);
c.setColumnAlign(1,q,r);
c.setColumnAlign(2,h,r);
var f=0;

for(var i=0;i<b.length;i++){var d=b[i];
d.slider.setOrientation(m);
d.value.setWidth(100);
d.value.setTextAlign(q);
a.add(d.minimum,{row:f,column:0});
a.add(d.value,{row:f,column:1});
a.add(d.maximum,{row:f,column:2});
a.add(d.slider,{row:f+1,column:0,colSpan:3,rowSpan:1});
c.setRowHeight(f+2,20);
f+=3;
}return a;
},_createSliderGroup:function(y){var z={slider:y,minimum:new qx.ui.basic.Label(g+y.getMinimum().toString()),maximum:new qx.ui.basic.Label(o+y.getMaximum().toString()),value:new qx.ui.basic.Label(y.getValue().toString())};
y.addListener(n,function(e){z.value.setValue(y.getValue().toString());
});
return z;
}}});
})();
