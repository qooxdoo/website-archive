...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.showcase.Calculator-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var N="execute",M="-",L="+",K="n",J="/",I="*",H="=",G="sans-serif",F="Verdana",E=".",bm="black",bl="Del",bk="C",bj="__xU",bi="5",bh="7",bg="demobrowser.demo.showcase.Calculator",bf="CE",be="solid",bd="icon/22/apps/utilities-calculator.png",U="3",V="0",S="8",T="__xT",Q="6",R="4",O="Calculator",P="right",W="2",X="1",ba="demobrowser.demo.showcase.CalculatorLogic",Y="white",bc="+/-",bb="9";
qx.Class.define(bg,{extend:qx.application.Standalone,members:{__xT:null,__xU:null,main:function(){arguments.callee.base.call(this);
{};
this.__xU=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var g=new qx.ui.window.Window(O,bd);
g.setLayout(new qx.ui.layout.VBox(16));
var i=new qx.ui.decoration.Single(1,be,bm);
var q=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var A=new qx.ui.layout.Grid(5,5);
q.setLayout(A);
this.__xT=new qx.ui.basic.Label(this.__xU.getCurrentValue().toString()).set({decorator:i,backgroundColor:Y,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[F,G],bold:true}),textAlign:P});
this.__xT.setEnabled(false);
var B=new qx.bom.Font().set({size:14,family:[F,G],bold:true});
var v=new qx.ui.form.Button(V).set({font:B,minWidth:40});
var u=new qx.ui.form.Button(X).set({font:B,minWidth:40});
var t=new qx.ui.form.Button(W).set({font:B,minWidth:40});
var s=new qx.ui.form.Button(U).set({font:B,minWidth:40});
var z=new qx.ui.form.Button(R).set({font:B,minWidth:40});
var y=new qx.ui.form.Button(bi).set({font:B,minWidth:40});
var x=new qx.ui.form.Button(Q).set({font:B,minWidth:40});
var w=new qx.ui.form.Button(bh).set({font:B,minWidth:40});
var D=new qx.ui.form.Button(S).set({font:B,minWidth:40});
var C=new qx.ui.form.Button(bb).set({font:B,minWidth:40});
var f=new qx.ui.form.Button(bk).set({font:B,minWidth:40});
var h=new qx.ui.form.Button(bf).set({font:B,minWidth:40});
var m=new qx.ui.form.Button(bl).set({font:B,minWidth:40});
var l=new qx.ui.form.Button(bc).set({font:B,minWidth:40});
var o=new qx.ui.form.Button(E).set({font:B,minWidth:40});
var k=new qx.ui.form.Button(L).set({font:B,minWidth:40});
var r=new qx.ui.form.Button(M).set({font:B,minWidth:40});
var p=new qx.ui.form.Button(I).set({font:B,minWidth:40});
var n=new qx.ui.form.Button(J).set({font:B,minWidth:40});
var j=new qx.ui.form.Button(H).set({font:B,minWidth:40});
A.setColumnFlex(0,1);
A.setColumnFlex(1,1);
A.setColumnFlex(2,1);
A.setColumnFlex(3,1);
...
A.setRowFlex(5,1);
A.setRowFlex(6,1);
q.add(this.__xT,{row:0,column:0,rowSpan:0,colSpan:4});
q.add(f,{row:1,column:2,rowSpan:1,colSpan:2});
q.add(h,{row:1,column:1});
q.add(m,{row:1,column:0});
q.add(w,{row:2,column:0});
q.add(D,{row:2,column:1});
q.add(C,{row:2,column:2});
q.add(n,{row:2,column:3});
q.add(z,{row:3,column:0});
q.add(y,{row:3,column:1});
q.add(x,{row:3,column:2});
q.add(p,{row:3,column:3});
q.add(u,{row:4,column:0});
q.add(t,{row:4,column:1});
q.add(s,{row:4,column:2});
q.add(r,{row:4,column:3});
q.add(v,{row:5,column:0});
q.add(l,{row:5,column:1});
q.add(o,{row:5,column:2});
q.add(k,{row:5,column:3});
q.add(j,{row:6,column:0,rowSpan:1,colSpan:4});
g.setWidth(260);
g.setMinWidth(260);
g.setHeight(260);
g.open();
...
g.add(q,{flex:1});
f.addListener(N,function(e){this.__xU.cleanDisplay();
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
h.addListener(N,function(e){this.__xU.clearEntry();

if(this.__xU.getResult()!=null){this.__xT.setValue(this.__xU.getCurrentValue().toString());
}},this);
m.addListener(N,function(e){this.__xU.deleteNumber();
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
l.addListener(N,function(e){this.__xU.setSign();

if(this.__xU.getResult()!=null){this.__xT.setValue(this.__xU.getResult().toString());
}},this);
v.addListener(N,function(e){this.__xU.setCurrentValue(0);
this.__xT.setValue(this.__xU.getCurrentValue().toFixed(this.__xU.getZeroCounter()).toString());
},this);
u.addListener(N,function(e){this.__xU.setCurrentValue(1);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
t.addListener(N,function(e){this.__xU.setCurrentValue(2);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
s.addListener(N,function(e){this.__xU.setCurrentValue(3);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
z.addListener(N,function(e){this.__xU.setCurrentValue(4);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
y.addListener(N,function(e){this.__xU.setCurrentValue(5);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
x.addListener(N,function(e){this.__xU.setCurrentValue(6);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
w.addListener(N,function(e){this.__xU.setCurrentValue(7);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
D.addListener(N,function(e){this.__xU.setCurrentValue(8);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
C.addListener(N,function(e){this.__xU.setCurrentValue(9);
this.__xT.setValue(this.__xU.getCurrentValue().toString());
},this);
k.addListener(N,function(e){this.__xU.calculate(L);

if(this.__xU.getResult()!=null){this.__xT.setValue(this.__xU.getResult().toString());
}this.__xU.resetCurrentValue();
},this);
r.addListener(N,function(e){this.__xU.calculate(M);

if(this.__xU.getResult()!=null){this.__xT.setValue(this.__xU.getResult().toString());
}this.__xU.resetCurrentValue();
},this);
p.addListener(N,function(e){this.__xU.calculate(I);

if(this.__xU.getResult()!=null){this.__xT.setValue(this.__xU.getResult().toString());
}this.__xU.resetCurrentValue();
},this);
n.addListener(N,function(e){this.__xU.calculate(J);

if(this.__xU.getResult()!=null){this.__xT.setValue(this.__xU.getResult().toString());
}this.__xU.resetCurrentValue();
},this);
j.addListener(N,function(e){this.__xU.calculate(H);

if(this.__xU.getResult()!=null){this.__xT.setValue(this.__xU.getResult().toString());
}this.__xU.resetCurrentValue();
},this);
o.addListener(N,function(e){this.__xU.setComma();
},this);
}},destruct:function(){this._disposeObjects(bj,T);
}});
qx.Class.define(ba,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
},members:{__xV:0,__xW:0,__xX:K,__xY:0,__ya:0,__yb:0,__yc:false,__yd:1,__ye:0,__yf:false,__yg:0,setCurrentValue:function(bo){if(this.__yc){this.__yd*=10;
this.__xV=this.__xV+(bo/this.__yd);

if(bo==0){this.__ye++;
}}else{this.__yc=false;

if(this.__xV<0){this.__xV=this.__xV*10-bo;
}else{this.__xV=this.__xV*10+bo;
}}},getZeroCounter:function(){return this.__ye;
},setComma:function(){this.__yc=true;
},getCurrentValue:function(){return this.__xV;
},resetCurrentValue:function(){this.__xV=null;
},cleanDisplay:function(){this.__yg=0;
this.__ya=0;
this.__xX=K;
this.__ye=0;
this.__yd=1;
...
this.__xW=0;
this.__yf=false;
},setResult:function(bp){this.__xW=bp;
},getResult:function(){return Math.round(this.__xW*10000000)/10000000;
},setCurrentOperation:function(bn){this.__xX=bn;
},getCurrentOperation:function(){return this.__xX;
},clearEntry:function(){this.__yf=false;
this.__ye=0;
this.__yd=1;
this.__yc=false;
this.__yb++;
...
if(this.__yb<2){this.__ya=this.__xW;
}
if(this.__xY>=2){this.__xW=0;
this.__xY=0;
}},setSign:function(){this.__yg++;

if(this.__yg%2==0){this.__yf=false;
}else{this.__yf=true;
}
if(this.__xV==null){this.__xV=this.__xW;
}this.__xV=this.__xV*(-1);

if(this.__xW==0){this.__xW=this.__xV;
}
if(this.__xW!=0){this.__ya=this.__xW;
this.__xW=this.__xV;
}},deleteNumber:function(){var a=false;
var d=false;

if(this.__xV<0){this.__xV=this.__xV*(-1);
d=true;
}
if(this.__xV!=null){if(this.__xV.toString().lastIndexOf(E)!=-1){this.__xV=this.__xV*this.__yd;
a=true;
}}var b=this.__xV%10;
var c=b/10;
this.__xV=this.__xV/10;
this.__xV=this.__xV-c;

if(a){this.__yd/=10;
this.__xV=this.__xV/(this.__yd);
a=false;
}
if(d){this.__xV=this.__xV*(-1);
d=false;
}},calculate:function(bq){if(bq==L||bq==I||bq==J||bq==M||bq==H){this.__yc=false;
this.__yd=1;
this.__ye=0;

if(this.__xX!=K){if(this.__xX==L){if(this.__xW==null){this.__xW=this.__ya;
}
if(this.__yf){this.__xW=this.__ya+this.__xV;
}else{this.__xW=this.__xW+this.__xV;
}this.__xV=this.__xW;
this.__ya=this.__xW;
}
if(this.__xX==M){if(this.__xW==0){this.__xW=this.__xV;
this.__xV=0;
}
if(this.__xW==null){this.__xW=this.__ya;
}
if(this.__yf){this.__xW=this.__ya-this.__xV;
}else{this.__xW=this.__xW-this.__xV;
}this.__xV=this.__xW;
...
if(this.__xX==J){if(this.__xW==0){this.__xW=this.__xV;
this.__xV=1;
}
if(this.__xW==null){this.__xW=this.__ya;
}
if(this.__xV!=null){if(this.__xV!=0){if(this.__yf){this.__xW=this.__ya/this.__xV;
}else{this.__xW=this.__xW/this.__xV;
}}else{alert("You can't divide by 0!");
}}this.__xV=this.__xW;
this.__ya=this.__xW;
}
if(this.__xX==I){if(this.__xW==0){this.__xW=1;
}
if(this.__xV==null){this.__xV=1;
}
if(this.__xW==null){this.__xW=this.__ya;
}
if(this.__yf){this.__xW=this.__ya*this.__xV;
...
this.__ya=this.__xW;
}}else{this.__xW=this.__xV;
}
if(bq!=H){this.__xX=bq;
}else{this.__xY++;
this.__xW=this.__ya;
this.__xX=K;
}this.__yf=false;
