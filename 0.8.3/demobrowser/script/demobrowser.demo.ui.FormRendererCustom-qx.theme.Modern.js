...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.FormRendererCustom", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.ui.FormRendererCustom-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var p="execute",o="Name",n="demobrowser.demo.ui.FormRendererCustom",m="Registration",l="Bio",k="Send",j="Contact",h="Country",g="Personal Information",f="demobrowser.form.CustomRenderer",c="Password",e="Email",d="Phone",b="right",a="Reset";
qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
qx.Class.define(f,{extend:qx.ui.form.renderer.Single,members:{__Be:0,__Bf:0,addItems:function(s,t,u){var x=0;
if(u!=null){this._add(this._createHeader(u),{row:x,column:this.__Be,colSpan:2});
x++;
}for(var i=0;i<s.length;i++){var w=this._createLabel(t[i],s[i]);
this._add(w,{row:x,column:this.__Be});
var v=s[i];
w.setBuddy(v);

if(v instanceof qx.ui.form.RadioGroup){v=this._createWidgetForRadioGroup(v);
}this._add(v,{row:x,column:this.__Be+1});
x++;
}this.__Be+=2;
this.__Bf<x?this.__Bf=x:null;
...
this._add(this._buttonRow,{row:this.__Bf,column:0,colSpan:this.__Be});
...
z.addGroupHeader(g);
z.add(new qx.ui.form.TextField(),h);
z.add(new qx.ui.form.TextArea(),l);
var B=new qx.ui.form.Button(k);
...
z.addButton(A);
var C=z.createView(demobrowser.form.CustomRenderer);
