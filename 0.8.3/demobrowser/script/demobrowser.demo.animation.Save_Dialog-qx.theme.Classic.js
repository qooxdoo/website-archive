...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.animation.Save_Dialog-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var s="execute",r="__vA",q="middle",p="demobrowser.demo.animation.Save_Dialog",o="appear",n='<b "font-size:12pt;">Do you want to save the changes you made in the document "Untitled"?</b>',m="close",l="__vB",k="center",j="__vC",c="Save...",h="Cancel",g="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",b="right",a="Your changes will be lost if you don't save them.",f="__vz",d="Don't save";
var e;
qx.Class.define(p,{extend:qx.application.Standalone,members:{__vz:null,__vA:null,__vB:null,__vC:null,__vD:function(){if(qx.bom.client.Engine.MSHTML){this.__vz=new qx.fx.effect.core.Fade(this.__vA.getContainerElement().getDomElement()).set({from:0,to:1});
this.__vB=new qx.fx.effect.core.Fade(this.__vA.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__vz=new qx.fx.effect.combination.Grow(this.__vA.getContainerElement().getDomElement());
this.__vB=new qx.fx.effect.combination.Shrink(this.__vA.getContainerElement().getDomElement());
}},showDialog:function(){this.__vA.setZIndex(1);
this.__vz.start();
},hideDialog:function(){this.__vB.start();
},main:function(){arguments.callee.base.call(this);
var document=this.getRoot();
this.__vC=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__vC.setLayout(new qx.ui.layout.VBox());
document.add(this.__vC,{left:40,top:40});
var y=new qx.ui.form.Button(m);
y.set({allowStretchX:false,alignX:b,marginBottom:15});
y.addListener(s,this.showDialog,this);
this.__vC.add(y);
var u=g;
var w=new qx.ui.form.TextArea(u);
w.set({width:400,height:250});
this.__vC.add(w);
var z=new qx.ui.layout.Grid(3,4);
z.setColumnWidth(0,120);
z.setColumnWidth(1,110);
z.setColumnWidth(2,110);
z.setRowHeight(2,10);
z.setRowAlign(3,k,q);
this.__vA=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__vA.setLayout(z);
document.add(this.__vA,{left:65,top:125});
this.__vA.addListenerOnce(o,this.__vD,this);
var A=new qx.ui.basic.Label(n);
var v=new qx.ui.basic.Label(a);
A.setRich(true);
this.__vA.add(A,{row:0,column:0,colSpan:3});
this.__vA.add(v,{row:1,column:0,colSpan:3});
var x=[d,h,c];

for(var i=0;i<x.length;i++){var t=new qx.ui.form.Button(x[i]);
t.setAllowStretchX(false);
this.__vA.add(t,{row:3,column:i});
t.addListener(s,this.hideDialog,this);
}}},destruct:function(){this._disposeObjects(j,r,f,l);
}});
})();
