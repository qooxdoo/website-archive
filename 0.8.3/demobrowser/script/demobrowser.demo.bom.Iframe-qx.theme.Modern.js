...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Iframe", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.Iframe-qx.theme.Modern-0.js"]],
  boot : "boot",
...
},registerEvent:function(a,b,c){},unregisterEvent:function(i,j,k){}},defer:function(l){qx.event.Registration.addHandler(l);
}});
})();
(function(){var n="0",m="qx.client",l="qx.bom.Iframe",k="webkit",j="qx.event.handler.Iframe.onevent(this)",i="true",h="iframe",g="body";
qx.Class.define(l,{statics:{create:function(e,f){var e=e?qx.lang.Object.clone(e):{};
e.onload=j;
e.frameBorder=n;
e.frameSpacing=n;
e.marginWidth=n;
...
e.vspace=n;
e.border=n;
e.allowTransparency=i;
return qx.bom.Element.create(h,e,f);
},getWindow:qx.core.Variant.select(m,{"mshtml|gecko":function(D){try{return D.contentWindow;
}catch(y){return null;
}},"default":function(q){try{var r=this.getDocument(q);
