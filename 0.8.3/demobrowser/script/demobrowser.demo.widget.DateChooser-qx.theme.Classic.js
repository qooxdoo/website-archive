...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.DateChooser", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.DateChooser-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var s="execute",r="- Use the cursors keys to move the selection.",q="- Double-click or enter/space-key will fire an execute event.",p="bold",o="- Page-keys / shift + page-keys switch months/years.",n="changeDate",m="select a date",l="Show January 1981",k="Set current date",j="Execute: ",d="Change: ",i="center",h="en",c="demobrowser.demo.widget.DateChooser",b="Remove the selection",g="Description",f="- Escape will remove the selection.";
...
B.add(C);
w.addListener(n,function(e){C.setValue(d+e.getData());
},this);
w.addListener(s,function(e){var a=w.getValue();
C.setValue(j+a);
},this);
var x=new qx.ui.form.Button(k);
x.setAlignX(i);
u.add(x);
x.addListener(s,function(e){w.setValue(new Date());
});
var A=new qx.ui.form.Button(l);
u.add(A);
A.addListener(s,function(e){w.showMonth(0,1981);
});
var v=new qx.ui.form.Button(b);
u.add(v);
v.addListener(s,function(e){w.setValue(null);
});
var t=new qx.ui.basic.Label(g);
t.setFont(p);
D.add(t);
D.add(new qx.ui.basic.Label(r));
D.add(new qx.ui.basic.Label(o));
D.add(new qx.ui.basic.Label(q));
D.add(new qx.ui.basic.Label(f));
}}});
})();
