...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Table_RowRenderer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Table_RowRenderer-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var G="px",F='" ',E='>',D="",C=";position:relative;height:",B="tableMock",A="table",z=' (init)</div>',y='class="',x=" (update)",r="relative",w="div",u='style="',q="px;",p="px; width:",t=": ",s="demobrowser.demo.test.Table_RowRenderer",v=", ",o='<div ';
qx.Class.define(s,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
qx.theme.manager.Meta.getInstance().initialize();
this.setUp();
this.testDefaultRenderer();
},setUp:function(){this.tableMock=this.getTableMock();
},testDefaultRenderer:function(d){var d=new qx.ui.table.rowrenderer.Default();
var h=300;
var g=20;
var f={focusedRow:[true,false],selected:[true,false],row:[1,2],table:[this.tableMock]};
var e=this._getNewTableDiv(h);
var top=0;
var self=this;
qx.util.Permutation.permute(f,function(i){var content=[];

for(var m in i){if(m!==A){content.push(m+t+i[m]);
}}content=content.join(v);
var n=self._createRowElement(e,h,g);
var j=d.getRowClass(i);

if(j){n.className=j;
}n.innerHTML=content+x;
d.updateDataRowElement(i,n);
var l=[];
l.push(o);

if(j){l.push(y,j,F);
}var k=d.createRowStyle(i);
k+=C+g+p+h+q;

if(k){l.push(u,k,F);
}l.push(E,content,z);
e.innerHTML+=l.join(D);
self._rowTop+=g;
});
},_rowTop:0,_createRowElement:function(parent,a,b){var c=qx.bom.Element.create(w);
qx.bom.element.Style.setStyles(c,{position:r,width:a+G,height:b+G});
this._rowTop+=20;
