...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Grid_Simple", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Grid_Simple-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var p="main",o="green",n="yellow",m="click me",l="click",k="center",j="top",i="middle",h="right",g="demobrowser.demo.layout.Grid_Simple";
...
s.add(this.getGrid2());
s.add(this.getGrid3());
},getGrid1:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:p,backgroundColor:n,allowGrowX:false,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:0,column:0});
a.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:0,column:1});
a.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:1,column:0});
a.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:1,column:1});
return a;
},getGrid2:function(){var d=new qx.ui.layout.Grid();
d.setColumnAlign(1,k,j);
d.setColumnAlign(0,h,i);
d.setSpacing(5);
var c=new qx.ui.container.Composite(d).set({decorator:p,backgroundColor:n,allowGrowX:false});
c.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o,width:150}),{row:0,column:0});
var b=new qx.ui.basic.Label(m).set({decorator:p,backgroundColor:o,allowGrowX:false,width:50,height:50});
c.add(b,{row:0,column:1});
c.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o,maxHeight:60,allowGrowX:false}),{row:1,column:0});
c.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o,height:80}),{row:1,column:1});
c.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:2,column:0});
c.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:2,column:1});
var f=10;
b.addListener(l,function(e){b.setWidth(50+f);
f=-f;
});
return c;
},getGrid3:function(){var r=new qx.ui.container.Composite().set({decorator:p,backgroundColor:n,width:400,height:300,allowShrinkX:false,allowShrinkY:false});
var q=new qx.ui.layout.Grid();
q.setColumnFlex(1,2);
q.setRowFlex(1,3);
q.setSpacing(5);
r.setLayout(q);
r.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:0,column:0});
r.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:0,column:1});
r.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:1,column:0});
r.add(new qx.ui.core.Widget().set({decorator:p,backgroundColor:o}),{row:1,column:1});
return r;
}}});
})();
