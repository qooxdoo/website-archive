...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.animation.Showcase-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var k="setup",j="finish",h="execute",g="Shrink",f="19,66,117",e="#134275",d="#7CFC00",c="Drop out",b="Fold in",a="backgroundColor",O="Attention effects",N="Vanish effects",M="Grow",L="out",K="block",J="in",I="Base effects",H="_demoElement",G="Puff",F="default",s="Shake",t="testImg",q="Drop in",r="Fold out",o="ColorFlow",p="Toggle Background",m="Toggle Size",n="Toggle Opacity",u="testDiv",v="Pulsate",y="Switch Off",x="spring",A="bold",z="Toggle Position",C="_vBoxes",B="demobrowser.demo.animation.Showcase",w="south",E="_demoImage",D="display";
qx.Class.define(B,{extend:qx.application.Standalone,members:{_toggleEnable:function(){var status=(this._vBoxes[0].getEnabled()===false);
...
this._demoImage=document.getElementById(t);
var bo=this.getRoot();
this._vBoxes=[];
var bd=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
bd.setWidth(150);
var bp={gbxBase:new qx.ui.groupbox.GroupBox(I),gbxAttention:new qx.ui.groupbox.GroupBox(O),gbxVanish:new qx.ui.groupbox.GroupBox(N)};
var bp={gbxBase:new qx.ui.groupbox.GroupBox(I),gbxAttention:new qx.ui.groupbox.GroupBox(O),gbxVanish:new qx.ui.groupbox.GroupBox(N)};

for(var bl in bp){bp[bl].setLayout(new qx.ui.layout.Grow);
}var Y=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
Y.set({minWidth:120});
this._vBoxes.push(Y);
var bj=new qx.ui.form.Button(n);
var bg=new qx.ui.form.Button(m);
var bt=new qx.ui.form.Button(z);
var Q=new qx.ui.form.Button(p);
Y.add(bj);
Y.add(bg);
Y.add(bt);
Y.add(Q);
...
var ba=new qx.ui.form.Button(s);
var bn=new qx.ui.form.Button(o);
var S=new qx.ui.form.Button(v);
bf.add(ba);
bf.add(bn);
bf.add(S);
bp.gbxAttention.add(bf);
var bh=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
bh.set({minWidth:120});
this._vBoxes.push(bh);
var U=new qx.ui.form.Button(G);
var X=new qx.ui.form.Button(c);
var W=new qx.ui.form.Button(y);
var bw=new qx.ui.form.Button(g);
...
for(var bl in bp){bd.add(bp[bl]);
}bo.add(bd);
var bs=new qx.fx.effect.core.Fade(this._demoElement);
bs.addListener(k,function(){this._toggleEnable();
},this);
bs.addListener(j,function(){this._toggleEnable();
},this);
bj.addListener(h,function(){var status=qx.bom.element.Style.get(this._demoElement,D);
bs.set({from:(status==K)?1:0,to:(status==K)?0:1});
bs.start();
},this);
var bi=new qx.fx.effect.core.Scale(this._demoImage);
bi.addListener(k,function(){this._toggleEnable();
},this);
bi.addListener(j,function(){this._toggleEnable();
},this);
bg.addListener(h,function(){var status=qx.bom.element.Dimension.getWidth(this._demoImage);
bi.set({scaleTo:((status>240)?80:120),duration:0.5});
bi.start();
},this);
var bm=new qx.fx.effect.core.Move(this._demoElement);
bm.addListener(k,function(){this._toggleEnable();
},this);
bm.addListener(j,function(){this._toggleEnable();
},this);
bt.addListener(h,function(){var status=qx.bom.element.Location.getLeft(this._demoElement);
bm.set({duration:1,x:(status<300)?300:-300,y:(status<300)?100:-100,transition:x});
bm.start();
},this);
var P=new qx.fx.effect.core.Highlight(this._demoElement);
P.addListener(k,function(){this._toggleEnable();
},this);
P.addListener(j,function(){this._toggleEnable();
},this);
Q.addListener(h,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,a)).toString();
P.set({startColor:(status==f)?e:d,endColor:(status==f)?d:e,restoreBackground:false});
P.start();
},this);
var V=new qx.fx.effect.combination.Shake(this._demoElement);
V.addListener(k,function(){this._toggleEnable();
},this);
V.addListener(j,function(){this._toggleEnable();
},this);
ba.addListener(h,function(){V.start();
});
var bb=new qx.fx.effect.combination.ColorFlow(this._demoElement);
bb.addListener(k,function(){this._toggleEnable();
},this);
bb.addListener(j,function(){this._toggleEnable();
},this);
bn.addListener(h,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,a)).toString();
bb.set({restoreBackground:false,startColor:(status==f)?e:d,endColor:(status==f)?d:e});
bb.start();
},this);
var bu=new qx.fx.effect.combination.Pulsate(this._demoElement);
bu.addListener(k,function(){this._toggleEnable();
},this);
bu.addListener(j,function(){this._toggleEnable();
},this);
S.addListener(h,function(){bu.start();
});
var bv=new qx.fx.effect.combination.Puff(this._demoImage);
bv.setModifyDisplay(false);
bv.addListener(k,function(){this._toggleEnable();
},this);
bv.addListener(j,function(){this._toggleEnable();
},this);
U.addListener(h,function(){bv.start();
});
var be=new qx.fx.effect.combination.Shrink(this._demoImage);
var bk=new qx.fx.effect.combination.Grow(this._demoImage);
var bc=be;
be.addListener(k,function(){this._toggleEnable();
},this);
be.addListener(j,function(){this._toggleEnable();

if(bw.getLabel()==g){bw.setLabel(M);
bc=bk;
}else{bw.setLabel(g);
bc=be;
}},this);
...
bw.addListener(h,function(){bc.start();
});
var bq=new qx.fx.effect.combination.Drop(this._demoElement);
bq.set({direction:w,yAmount:90});
bq.addListener(k,function(){this._toggleEnable();
},this);
bq.addListener(j,function(){this._toggleEnable();

if(X.getLabel()==c){X.setLabel(q);
bq.setMode(J);
}else{X.setLabel(c);
bq.setMode(L);
}},this);
X.addListener(h,function(){bq.start();
});
var T=new qx.fx.effect.combination.Fold(this._demoElement);
T.addListener(k,function(){this._toggleEnable();
},this);
T.addListener(j,function(){this._toggleEnable();
qx.lang.Function.delay(function(){if(R.getLabel()==b){R.setLabel(r);
T.setMode(L);
}else{R.setLabel(b);
T.setMode(J);
}},100,this);
},this);
R.addListener(h,function(){T.start();
});
var br=new qx.fx.effect.combination.Switch(this._demoElement);
br.setModifyDisplay(false);
br.addListener(k,function(){this._toggleEnable();
},this);
br.addListener(j,function(){this._toggleEnable();
},this);
W.addListener(h,function(){br.start();
});

for(var bl in bp){bp[bl].setFont(A);
bd.add(bp[bl]);
}
for(var i=0;i<this._vBoxes.length;i++){this._vBoxes[i].setFont(F);
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{modifyDisplay:{init:true,check:b},from:{init:1.0,refine:true},to:{init:0.0,refine:true}},members:{update:function(a){arguments.callee.base.call(this);
qx.bom.element.Opacity.set(this._getElement(),a);
},beforeSetup:function(){arguments.callee.base.call(this);
var g=this._getElement();

if((this.getModifyDisplay())&&(this.getTo()>0)){qx.bom.element.Style.set(g,f,c);
...
(function(){var r='px',q="Boolean",p="Number",o="fontSize",n="Array",m="qx.fx.effect.core.Scale",l="__uH",k="__uG",j="12px",i='pt',c='em',h="position",g="__uO",b='%',a="100%",f="string",e="absolute";
qx.Class.define(m,{extend:qx.fx.Base,construct:function(M){arguments.callee.base.call(this,M);
this.__uG=qx.fx.effect.core.Scale.originalStyle;
this.__uH=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:q},scaleY:{init:true,check:q},scaleContent:{init:true,check:q},scaleFromCenter:{init:true,check:q},scaleFrom:{init:100.0,check:p},scaleTo:{init:100,check:p},restoreAfterFinish:{init:false,check:q},alternateDimensions:{init:[],check:n}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':c,'px':r,'%':b,'pt':i}},members:{__uI:null,__uJ:null,__uK:null,__uL:null,__uM:null,__uN:null,__uO:null,__uG:null,__uH:null,setup:function(){arguments.callee.base.call(this);
var D=this._getElement();
this.__uI=qx.bom.element.Style.get(D,h);

for(var B in this.__uG){this.__uG[B]=D.style[B];
}this.__uJ=qx.bom.element.Location.getTop(D);
this.__uK=qx.bom.element.Location.getLeft(D);

try{var C=qx.bom.element.Style.get(D,o);
}catch(s){if(typeof (C)!=f){C=(qx.bom.client.Engine.MSHTML)?j:a;
}}
for(var z in this.__uH){if(C.indexOf(z)>0){this.__uL=parseFloat(C);
this.__uM=z;
break;
}}this.__uN=(this.getScaleTo()-this.getScaleFrom())/100;
var A=this.getAlternateDimensions();

if(A.length==0){this.__uO=[D.offsetWidth,D.offsetHeight];
}else{this.__uO=A;
}},update:function(t){var v=this._getElement();
arguments.callee.base.call(this);
var u=(this.getScaleFrom()/100.0)+(this.__uN*t);

if(this.getScaleContent()&&this.__uL){qx.bom.element.Style.set(v,o,this.__uL*u+this.__uM);
}this._setDimensions(this.__uO[0]*u,this.__uO[1]*u);
},finish:function(){arguments.callee.base.call(this);
var y=this._getElement();

if(this.getRestoreAfterFinish()){for(var w in this.__uG){var x=this.__uG[w];
qx.bom.element.Style.set(y,w,x);
}}},_setDimensions:function(E,F){var d={};
var J=this._getElement();
var H=this.getScaleX();
var I=this.getScaleY();

if(H){d.width=Math.round(E)+r;
}
if(I){d.height=Math.round(F)+r;
}
if(this.getScaleFromCenter()){var K=(E-this.__uO[0])/2;
var L=(F-this.__uO[1])/2;

if(this.__uI==e){if(I){d.top=this.__uJ-L+r;
}
if(H){d.left=this.__uK-K+r;
}}else{if(I){d.top=-L+r;
}
if(H){d.left=-K+r;
}}}
for(var G in d){qx.bom.element.Style.set(J,G,d[G]);
}}},destruct:function(){this._disposeFields(g,k,l);
}});
})();
(function(){var i="position",h="px",g="relative",f="Number",e="absolute",d="top",c="left",b='absolute',a="qx.fx.effect.core.Move";
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:g,check:[g,e]},x:{init:0,check:f},y:{init:0,check:f}},members:{__uw:null,__ux:null,__uy:null,__uz:null,__uA:null,setup:function(){var j=this._getElement();
arguments.callee.base.call(this);

if(j.parentNode){this.__uy=qx.bom.element.Location.getLeft(j)-qx.bom.element.Location.getLeft(j.parentNode);
this.__uz=qx.bom.element.Location.getTop(j)-qx.bom.element.Location.getTop(j.parentNode);
}else{this.__uy=qx.bom.element.Location.getLeft(j);
this.__uz=qx.bom.element.Location.getTop(j);
}this.__uA=qx.bom.element.Style.get(j,i);
qx.bom.element.Style.set(j,i,e);

if(this.getMode()==b){this.__uw=this.getX()-this.__uy;
this.__ux=this.getY()-this.__uz;
}else{this.__uw=this.getX();
this.__ux=this.getY();
}},update:function(k){var m=this._getElement();
arguments.callee.base.call(this);
var l=Math.round(this.__uw*k+this.__uy);
var top=Math.round(this.__ux*k+this.__uz);
qx.bom.element.Style.set(m,c,l+h);
qx.bom.element.Style.set(m,d,top+h);
},afterFinishInternal:function(){qx.bom.element.Style.set(this._getElement(),i,this.__uA);
}}});
})();
...
(function(){var e="horizontal",d="vertical",c="__uT",b="qx.fx.effect.combination.Shake",a="Number";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(k){arguments.callee.base.call(this,k);
this.__uT=[new qx.fx.effect.core.Move(k),new qx.fx.effect.core.Move(k),new qx.fx.effect.core.Move(k),new qx.fx.effect.core.Move(k),new qx.fx.effect.core.Move(k),new qx.fx.effect.core.Move(k)];
},properties:{direction:{init:e,check:[e,d]},duration:{init:0.5,refine:true},distance:{init:20,check:a}},members:{__uT:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var f=parseFloat(this.getDistance());
var g=parseFloat(this.getDuration())/10.0;

if(this.getDirection()==e){this.__uT[0].set({x:f,y:0,duration:g});
this.__uT[1].set({x:-f*2,y:0,duration:g*2});
this.__uT[2].set({x:f*2,y:0,duration:g*2});
this.__uT[3].set({x:-f*2,y:0,duration:g*2});
this.__uT[4].set({x:f*2,y:0,duration:g*2});
this.__uT[5].set({x:-f,y:0,duration:g*2});
}else if(this.getDirection()==d){this.__uT[0].set({y:f,x:0,duration:g});
this.__uT[1].set({y:-f*2,x:0,duration:g*2});
this.__uT[2].set({y:f*2,x:0,duration:g*2});
this.__uT[3].set({y:-f*2,x:0,duration:g*2});
this.__uT[4].set({y:f*2,x:0,duration:g*2});
this.__uT[5].set({y:-f,x:0,duration:g*2});
}var j=this.__uT;

for(var i=0,h=this.__uT.length;i<h;i++){this.__uT[i].id=i;

if(i<5){this.__uT[i].afterFinishInternal=function(){j[this.id+1].start();
};
}}this.__uT[0].start();
}},destruct:function(){this._disposeArray(c);
}});
})();
(function(){var t="linear",s="Number",r="reverse",q="Boolean",p="none",o="wobble",n="flicker",m="pulse",l="sinodial",k="easeOutQuad",d="spring",j="easeInQuad",g="full",c="Color",b="backgroundColor",f="#ffffff",e="__uU",h="backgroundImage",a="qx.fx.effect.combination.ColorFlow",i="#ffffaa";
qx.Class.define(a,{extend:qx.fx.Base,construct:function(u){arguments.callee.base.call(this,u);
this.__uU=[new qx.fx.effect.core.Highlight(u),new qx.fx.effect.core.Highlight(u)];
},properties:{startColor:{init:f,check:c},endColor:{init:i,check:c},forwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},backwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},forwardDuration:{init:1.0,check:s},backwardDuration:{init:1.0,check:s},delayBetween:{init:0.3,check:s},restoreBackground:{init:true,check:q},keepBackgroundImage:{init:false,check:q}},members:{__uV:null,__uU:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var v=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__uV={backgroundImage:qx.bom.element.Style.get(v,h),backgroundColor:qx.bom.element.Style.get(v,b)};
this.__uU[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__uU[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__uU[0].afterFinishInternal=function(){self.__uU[1].start();
};
this.__uU[0].start();
}},destruct:function(){this._disposeArray(e);
}});
})();
(function(){var h="opacity",g="__uW",f="qx.fx.effect.combination.Pulsate",e="sinodial";
qx.Class.define(f,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
var b=this.getDuration()/6;
var c=0;
this.__uW=[new qx.fx.effect.core.Fade(a),new qx.fx.effect.core.Fade(a),new qx.fx.effect.core.Fade(a),new qx.fx.effect.core.Fade(a),new qx.fx.effect.core.Fade(a),new qx.fx.effect.core.Fade(a)];

for(var i=0,l=this.__uW.length;i<l;i++){this.__uW[i].set({duration:b,to:((c%2)!=0)?1:0,from:((c%2)!=0)?0:1,transition:e,modifyDisplay:false});
c++;
}},properties:{duration:{init:2,refine:true}},members:{__uX:null,__uW:null,beforeSetup:function(){this.__uX=qx.bom.element.Style.get(this._getElement(),h);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var d=0;
var self=this;

for(var i=0,l=this.__uW.length;i<l;i++){this.__uW[i].id=d;

if(d<5){this.__uW[i].afterFinishInternal=function(){self.__uW[this.id+1].start();
};
}d++;
}this.__uW[0].start();
},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),h,this.__uX);
}},destruct:function(){this._disposeArray(g);
}});
})();
(function(){var i="__uY",h="opacity",g="Boolean",f="none",e="qx.fx.effect.combination.Puff",d="_effects",c="__vb",b="__va",a="display";
qx.Class.define(e,{extend:qx.fx.Base,construct:function(n){arguments.callee.base.call(this,n);
this.__uY=new qx.fx.effect.core.Scale(n);
this.__va=new qx.fx.effect.core.Fade(n);
this.__vb=new qx.fx.effect.core.Parallel(this.__uY,this.__va);
},properties:{modifyDisplay:{init:true,check:g}},members:{__va:null,__uY:null,__vb:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var k=this._getElement();
var j={opacity:qx.bom.element.Style.get(k,h)};
this.__va.afterFinishInternal=function(){var m=this._getElement();

for(var l in j){qx.bom.element.Style.set(m,l,j[l]);
}};
this.__uY.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__va.set({sync:true,to:0.0,modifyDisplay:false});
this.__vb.start();
}},destruct:function(){this._disposeArray(d);
this._disposeObjects(c,i,b);
}});
})();
(function(){var c="qx.fx.effect.core.Parallel",b="__vc";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(d){arguments.callee.base.call(this);
this.__vc=arguments;
},members:{__vc:null,finish:function(){arguments.callee.base.call(this);
var g=this.__vc;
...
(function(){var n="sinodial",m="none",l="overflow",k="flicker",j="center",i="pulse",h="spring",g="full",f="wobble",e="easeOutQuad",K="easeInQuad",J="reverse",I="linear",H="scroll",G="__ve",F="Boolean",E="px",D='bottom-left',C='top-left',B='bottom-right',u="bottom-right",v="opacity",s="__vd",t="__vf",q="bottom-left",r="visible",o="qx.fx.effect.combination.Shrink",p="top-left",w="top-right",x='top-right',z='center',y="hidden",A="display";
qx.Class.define(o,{extend:qx.fx.Base,construct:function(d){arguments.callee.base.call(this,d);
this.__vd=new qx.fx.effect.core.Move(d);
this.__ve=new qx.fx.effect.core.Scale(d);
this.__vf=new qx.fx.effect.core.Parallel(this.__vd,this.__ve);
},properties:{direction:{init:j,check:[p,w,q,u,j]},moveTransition:{init:n,check:[I,K,e,n,J,k,f,i,h,m,g]},scaleTransition:{init:n,check:[I,K,e,n,J,k,f,i,h,m,g]},modifyDisplay:{init:true,check:F}},members:{__vg:null,__vd:null,__ve:null,__vf:null,setup:function(){arguments.callee.base.call(this);
...
qx.bom.element.Style.set(N,l,r);
var M;

for(var L in this.__vg){M=this.__vg[L];

if(L!=l){M+=E;
}qx.bom.element.Style.set(N,L,M);
}
if(this.getModifyDisplay()){qx.bom.element.Style.set(N,A,m);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var c=this._getElement();
var a,b;
this.__vg={top:qx.bom.element.Location.getTop(c,H),left:qx.bom.element.Location.getLeft(c,H),width:qx.bom.element.Dimension.getContentWidth(c),height:qx.bom.element.Dimension.getContentHeight(c),opacity:qx.bom.element.Style.get(c,v)};

switch(this.getDirection()){case C:a=b=0;
break;
case x:a=this.__vg.width;
b=0;
break;
case D:a=0;
b=this.__vg.height;
break;
case B:a=this.__vg.width;
b=this.__vg.height;
break;
case z:a=this.__vg.width/2;
b=this.__vg.height/2;
break;
}this.__vd.set({x:a,y:b,sync:true,transition:this.getMoveTransition()});
this.__ve.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__vf.start();
}},destruct:function(){this._disposeObjects(s,G,t);
}});
})();
(function(){var p="sinodial",o="px",n="flicker",m="0px",l="center",k="pulse",j="spring",i="full",h="wobble",g="easeOutQuad",P="easeInQuad",O="reverse",N="none",M="overflow",L="linear",K="height",J='bottom-left',I='top-left',H='bottom-right',G="bottom-right",w="__vj",x="qx.fx.effect.combination.Grow",u="__vh",v="bottom-left",s="visible",t="width",q="top-left",r="top",y="top-right",z='top-right',B="__vi",A="block",D='center',C="hidden",F="left",E="display";
qx.Class.define(x,{extend:qx.fx.Base,construct:function(T){arguments.callee.base.call(this,T);
this.__vh=new qx.fx.effect.core.Move(T);
this.__vi=new qx.fx.effect.core.Scale(T);
this.__vj=new qx.fx.effect.core.Parallel(this.__vh,this.__vi);
},properties:{direction:{init:l,check:[q,y,v,G,l]},scaleTransition:{init:p,check:[L,P,g,p,O,n,h,k,j,N,i]},moveTransition:{init:p,check:[L,P,g,p,O,n,h,k,j,N,i]}},members:{__vi:null,__vh:null,__vj:null,setup:function(){arguments.callee.base.call(this);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var d=this._getElement();
...
this.__vi.afterFinishInternal=function(){var R;
...
break;
}this.__vh.set({x:e,y:f,sync:true,transition:this.getMoveTransition()});
this.__vi.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[c.width,c.height]});
qx.bom.element.Style.set(d,r,(c.top+a)+o);
qx.bom.element.Style.set(d,F,(c.left+b)+o);
qx.bom.element.Style.set(d,K,m);
qx.bom.element.Style.set(d,t,m);
this.__vj.start();
}},destruct:function(){this._disposeObjects(u,B,w);
}});
})();
(function(){var u="out",t="px",s="south",r="Number",q="north-west",p="west",o="in",n="north",m="south-east",l="south-west",e="east",k="north-east",h="display",c="__vk",b="top",g="Boolean",f="block",i="left",a="__vm",j="__vl",d="qx.fx.effect.combination.Drop";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(w){arguments.callee.base.call(this,w);
this.__vk=new qx.fx.effect.core.Move(w);
this.__vl=new qx.fx.effect.core.Fade(w);
this.__vm=new qx.fx.effect.core.Parallel(this.__vk,this.__vl);
},properties:{direction:{init:s,check:[s,p,e,n,l,m,k,q]},xAmount:{init:100,check:r},yAmount:{init:100,check:r},mode:{init:u,check:[o,u]},modifyDisplay:{init:true,check:g}},members:{__vl:null,__vk:null,__vm:null,start:function(){arguments.callee.base.call(this);
...
this.__vl.afterFinishInternal=function(){for(var v in A){qx.bom.element.Style.set(B,v,A[v]+t);
}};
this.__vl.set({duration:0.5,sync:true,from:(this.getMode()==u)?1:0,to:(this.getMode()==u)?0:1,modifyDisplay:true});
this.__vm.start();
}},destruct:function(){this._disposeObjects(c,j,a);
}});
})();
(function(){var r="display",q="in",p="overflow",o="block",n="none",m="visible",l="0px",k="hidden",j="visiblity",i="Boolean",d="height",h="width",g="px",c="qx.fx.effect.combination.Fold",b="__vo",f="__vn",e="out";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(t){arguments.callee.base.call(this,t);
},properties:{modifyDisplay:{init:true,check:i},mode:{init:q,check:[q,e]}},members:{__vn:null,__vo:null,__vp:null,afterFinish:function(){var s=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==q)){qx.bom.element.Style.set(s,r,o);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var a=this._getElement();
var self=this;
this.__vn=new qx.fx.effect.core.Scale(a);
this.__vo=new qx.fx.effect.core.Scale(a);
this.__vn.afterFinishInternal=function(){self.__vo.start();
};
this.__vo.afterFinishInternal=function(){self._cleanUp();
};
this.__vp=this._getStyle();
qx.bom.element.Style.set(a,p,k);

if(this.getMode()==q){this.__vn.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__vo.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__vn.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__vp.width,this.__vp.height]});
this.__vo.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__vp.width,this.__vp.height]});
qx.bom.element.Style.set(a,r,o);
qx.bom.element.Style.set(a,d,l);
qx.bom.element.Style.set(a,h,l);
}this.__vn.start();
},_cleanUp:function(){var y;
var z=this._getElement();

if((this.getMode()==q)&&(this.getModifyDisplay())){qx.bom.element.Style.set(z,r,n);
}
for(var x in this.__vp){y=this.__vp[x];

if(x!=p){y+=g;
}qx.bom.element.Style.set(z,x,y);
}qx.bom.element.Style.set(z,p,m);
},_getStyle:function(){var w=this._getElement();
var u=(qx.bom.element.Style.get(w,r)==n);

if(u){qx.bom.element.Style.set(w,j,k);
qx.bom.element.Style.set(w,r,o);
}var v={overflow:qx.bom.element.Style.get(w,p),top:qx.bom.element.Location.getTop(w),left:qx.bom.element.Location.getLeft(w),width:qx.bom.element.Dimension.getContentWidth(w),height:qx.bom.element.Dimension.getContentHeight(w)};

if(u){qx.bom.element.Style.set(w,r,n);
qx.bom.element.Style.set(w,j,m);
}return v;
}},destruct:function(){this._disposeObjects(f,b);
}});
})();
(function(){var l="off",k="overflow",j="__vr",i="Boolean",h="qx.fx.effect.combination.Switch",g="none",f="__vq",e="flicker",d="hidden",c="display";
qx.Class.define(h,{extend:qx.fx.Base,construct:function(o){arguments.callee.base.call(this,o);
this.setTransition(e);
var p=this.__vq=new qx.fx.effect.core.Scale(o);
this.__vq.beforeSetup=function(){qx.bom.element.Style.set(o,k,d);
};
this.__vr=new qx.fx.effect.core.Fade(o);
this.__vr.afterFinishInternal=function(){p.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:i},mode:{init:l,check:[l]}},members:{__vq:null,__vr:null,setup:function(){arguments.callee.base.call(this);
var b=this._getElement();
var a=qx.bom.element.Style.get(b,k);
this.__vq.afterFinishInternal=function(){qx.bom.element.Style.set(b,k,a);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==l)){qx.bom.element.Style.set(this._getElement(),c,g);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}
if(this.getMode()==l){this.__vq.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__vr.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__vr.start();
},_applyDuration:function(m,n){this.__vq.setDuration(m/2);
this.__vr.setDuration(m/2);
}},destruct:function(){this._disposeObjects(j,f);
}});
})();
