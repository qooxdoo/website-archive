...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Window", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Window-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var W="changeValue",V="execute",U="icon/16/apps/office-calendar.png",T="right",S="demobrowser.demo.widget.Window",R="Yes",Q="Second Window",P="Page 1",O="bottom",N="Use move frame",bM="Show Statusbar",bL="icon/16/actions/dialog-cancel.png",bK="icon/32/status/dialog-error.png",bJ="Show Close",bI="Third Window",bH="icon/22/apps/utilities-calculator.png",bG="Show Maximize",bF="Allow Close",bE="Use resize frame",bD="No",be="resizable",bf="Allow Maximize",bc="value",bd="The second window",ba="Page 3",bb="move",X="Resizable ",Y="First Window",bi="resize",bj="Moveable",br="Demo loaded",bp="Allow Minimize",bv="Resizable",bt="Open Modal Dialog 2",bz="Open Modal Dialog 1",bx="First Modal Dialog",bl="top",bC="Movable",bB="icon/32/apps/office-address-book.png",bA="Basics",bk="Modal",bn="Do you want to fly to Berlin?",bo="Welcome to your first own Window.<br/>Have fun!",bq="Application is ready",bs="icon/16/apps/internet-feed-reader.png",bu="Second Modal Dialog",bw="icon/16/actions/dialog-ok.png",by="Page 2",bg="left",bh="icon/16/apps/internet-telephony.png",bm="Show Minimize";
qx.Class.define(S,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
this.createWindow1();
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var E=new qx.ui.window.Window(Y,U);
E.setLayout(new qx.ui.layout.VBox(10));
E.setShowStatusbar(true);
E.setStatus(br);
E.open();
this.getRoot().add(E,{left:20,top:20});
E.addListener(bb,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
E.addListener(bi,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var D=new qx.ui.basic.Atom(bo,bB);
D.setRich(true);
E.add(D);
var C=new qx.ui.tabview.TabView;
E.add(C,{flex:1});
var H=new qx.ui.tabview.Page(P);
C.add(H);
var F=new qx.ui.tabview.Page(by);
C.add(F);
var G=new qx.ui.tabview.Page(ba);
C.add(G);
},createWindow2:function(){var p=new qx.ui.window.Window(Q,bs);
p.setLayout(new qx.ui.layout.VBox(10));
p.setStatus(bq);
p.open();
this.getRoot().add(p,{left:350,top:120});
var z=new qx.ui.basic.Atom(bd,bH);
p.add(z);
var j=new qx.ui.container.Composite;
j.setLayout(new qx.ui.layout.HBox(10));
p.add(j,{flex:1});
var s=new qx.ui.groupbox.GroupBox(bA);
s.setLayout(new qx.ui.layout.VBox(4));
j.add(s,{flex:1});
var m=new qx.ui.form.CheckBox(bJ);
m.setValue(true);
m.addListener(W,function(e){p.setShowClose(e.getData());
});
s.add(m);
var y=new qx.ui.form.CheckBox(bG);
y.setValue(true);
y.addListener(W,function(e){p.setShowMaximize(e.getData());
});
s.add(y);
var r=new qx.ui.form.CheckBox(bm);
r.setValue(true);
r.addListener(W,function(e){p.setShowMinimize(e.getData());
});
s.add(r);
var u=new qx.ui.form.CheckBox(bF);
u.setValue(true);
u.addListener(W,function(e){p.setAllowClose(e.getData());
});
s.add(u);
var A=new qx.ui.form.CheckBox(bf);
A.setValue(true);
A.addListener(W,function(e){p.setAllowMaximize(e.getData());
});
s.add(A);
var o=new qx.ui.form.CheckBox(bp);
o.setValue(true);
o.addListener(W,function(e){p.setAllowMinimize(e.getData());
});
s.add(o);
var k=new qx.ui.form.CheckBox(bM);
k.setValue(false);
k.addListener(W,function(e){p.setShowStatusbar(e.getData());
});
s.add(k);
var B=new qx.ui.groupbox.GroupBox(bv);
B.setLayout(new qx.ui.layout.VBox(4));
j.add(B,{flex:1});
var w=new qx.ui.form.CheckBox(bE);
w.setValue(true);
w.addListener(W,function(e){p.setUseResizeFrame(e.getData());
});
B.add(w);
var x=[bl,T,O,bg];

for(var i=0;i<x.length;i++){var v=x[i];
var n=new qx.ui.form.CheckBox(X+v).set({value:true});
n.bind(bc,p,be+qx.lang.String.firstUp(v));
B.add(n);
}var l=new qx.ui.groupbox.GroupBox(bj);
l.setLayout(new qx.ui.layout.VBox(4));
j.add(l,{flex:1});
var t=new qx.ui.form.CheckBox(bC);
t.setValue(true);
t.addListener(W,function(e){p.setMovable(e.getData());
});
l.add(t);
var q=new qx.ui.form.CheckBox(N);
q.addListener(W,function(e){p.setUseMoveFrame(e.getData());
});
l.add(q);
},createWindow3:function(){var a=new qx.ui.window.Window(bI,bh);
a.setLayout(new qx.ui.layout.VBox);
a.setMaxWidth(450);
a.setMaxHeight(400);
a.setAllowMaximize(false);
a.open();
this.getRoot().add(a,{left:100,top:250});
var b=this.getModalWindow1();
var c=new qx.ui.form.Button(bz,U);
c.addListener(V,b.open,b);
a.add(c);
},getModalWindow1:function(){var f=new qx.ui.window.Window(bx);
f.setLayout(new qx.ui.layout.VBox(10));
f.setModal(true);
f.moveTo(150,150);
this.getRoot().add(f);
var d=this.getModalWindow2();
var h=new qx.ui.form.Button(bt,U);
h.addListener(V,d.open,d);
f.add(h);
var g=new qx.ui.form.CheckBox(bk);
g.setValue(true);
f.add(g);
g.addListener(W,function(e){f.setModal(e.getData());
});
return f;
},getModalWindow2:function(){var J=new qx.ui.window.Window(bu);
J.setLayout(new qx.ui.layout.VBox(10));
J.setModal(true);
J.setShowClose(false);
J.moveTo(300,300);
this.getRoot().add(J);
var I=new qx.ui.basic.Atom(bn,bK);
J.add(I);
var L=new qx.ui.container.Composite;
L.setLayout(new qx.ui.layout.HBox(10,T));
J.add(L);
var M=new qx.ui.form.Button(R,bw);
M.addListener(V,function(e){J.close();
});
L.add(M);
var K=new qx.ui.form.Button(bD,bL);
K.addListener(V,function(e){alert("Sorry, please click 'Yes'!");
});
L.add(K);
return J;
}}});
...
(function(){var y="pane",x="lastTab",w="bar",v="page",u="firstTab",t="changeSelected",s="right",r="bottom",q="button",p="qx.event.type.Data",S="changeSelection",R="close",Q="top",P="left",O="__nu",N="barRight",M="beforeChangeSelection",L="Use 'setSelection' instead!",K="Use 'changeSelection' instead!",J="__nt",F="tabview",G="vertical",D="_applyBarPosition",E="barLeft",B="horizontal",C="qx.ui.tabview.TabView",z="barTop",A="barBottom",H="Use 'getSelection' instead!",I="Use 'resetSelection' instead!";
qx.Class.define(C,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:[qx.ui.core.MContentPadding],construct:function(a){arguments.callee.base.call(this);
this.__nt={top:z,right:N,bottom:A,left:E};
this._createChildControl(w);
this._createChildControl(y);
var b=this.__nu=new qx.ui.form.RadioGroup;
b.setWrap(false);
b.addListener(S,this._onChangeSelection,this);
if(a!=null){this.setBarPosition(a);
}else{this.initBarPosition();
}},events:{"changeSelected":p,"changeSelection":p},properties:{appearance:{refine:true,init:F},barPosition:{check:[P,s,Q,r],init:Q,apply:D}},members:{__nu:null,_createChildControlImpl:function(n){var o;

switch(n){case w:o=new qx.ui.container.SlideBar();
o.setZIndex(10);
this._add(o);
break;
case y:o=new qx.ui.container.Stack;
o.setZIndex(5);
this._add(o,{flex:1});
break;
...
var bt=bs.getButton();
var bu=this.getChildControl(w);
var bw=this.getChildControl(y);
bs.exclude();
bu.add(bt);
bw.add(bs);
this.__nu.add(bt);
bs.addState(this.__nt[this.getBarPosition()]);
bs.addState(x);
var bv=this.getChildren();

if(bv[0]==bs){bs.addState(u);
}else{bv[bv.length-2].removeState(x);
}bs.addListener(R,this._onPageClose,this);
},remove:function(T){var Y=this.getChildControl(y);
var W=this.getChildControl(w);
var V=T.getButton();
var X=Y.getChildren();
if(this.getSelection()[0]==T){var U=X.indexOf(T);

if(U==0){if(X[1]){this.setSelection([X[1]]);
}else{this.resetSelection();
}}else{this.setSelection([X[U-1]]);
}}W.remove(V);
Y.remove(T);
this.__nu.remove(V);
T.removeState(this.__nt[this.getBarPosition()]);
if(T.hasState(u)){T.removeState(u);

if(X[0]){X[0].addState(u);
}}
if(T.hasState(x)){T.removeState(x);

if(X.length>0){X[X.length-1].addState(x);
}}T.removeListener(R,this._onPageClose,this);
},getChildren:function(){return this.getChildControl(y).getChildren();
},indexOf:function(m){return this.getChildControl(y).indexOf(m);
},__nt:null,_applyBarPosition:function(bi,bj){var bk=this.getChildControl(w);
var bp=bi==P||bi==s;
var bn=bi==s||bi==r;
var bo=bp?qx.ui.layout.HBox:qx.ui.layout.VBox;
var br=this._getLayout();

if(br&&br instanceof bo){}else{this._setLayout(br=new bo);
}br.setReversed(bn);
bk.setOrientation(bp?G:B);
var bq=this.getChildren();
if(bj){var bl=this.__nt[bj];
bk.removeState(bl);
for(var i=0,l=bq.length;i<l;i++){bq[i].removeState(bl);
}}
if(bi){var bm=this.__nt[bi];
bk.addState(bm);
for(var i=0,l=bq.length;i<l;i++){bq[i].addState(bm);
}}},setSelected:function(c){qx.log.Logger.deprecatedMethodWarning(arguments.callee,L);
this.setSelection([c]);
},getSelected:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,H);
var bz=this.getSelection()[0];

if(bz){return bz;
}else{return null;
}},resetSelected:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,I);
this.resetSelection();
},getSelection:function(){var bg=this.__nu.getSelection();
var bh=[];

for(var i=0;i<bg.length;i++){bh.push(bg[i].getUserData(v));
}return bh;
},setSelection:function(be){var bf=[];

for(var i=0;i<be.length;i++){bf.push(be[i].getChildControl(q));
}this.__nu.setSelection(bf);
},resetSelection:function(){this.__nu.resetSelection();
},isSelected:function(h){var j=h.getChildControl(q);
return this.__nu.isSelected(j);
},isSelectionEmpty:function(){return this.__nu.isSelectionEmpty();
},getSelectables:function(){var bx=this.__nu.getSelectables();
var by=[];

for(var i=0;i<bx.length;i++){by.push(bx[i].getUserData(v));
}return by;
},_onChangeSelection:function(e){var bd=this.getChildControl(y);
var ba=e.getData()[0];

if(ba){bd.setSelection([ba.getUserData(v)]);
ba.focus();
this.scrollChildIntoView(ba,null,null,false);
}else{bd.resetSelection();
}var bc=bd.getSelection();
var bb=e.getOldData();
this.fireDataEvent(S,bc,bb);
this.fireDataEvent(t,bc[0],bb[0]);
},_onBeforeChangeSelection:function(e){if(!this.fireNonBubblingEvent(M,qx.event.type.Event,[false,true])){e.preventDefault();
}},addListener:function(d,f,self,g){if(d===t){qx.log.Logger.deprecatedEventWarning(arguments.callee,t,K);
}return arguments.callee.base.call(this,d,f,self,g);
},_onRadioChangeSelection:function(e){var k=e.getData()[0];

if(k){this.setSelection([k.getUserData(v)]);
}else{this.resetSelection();
...
(function(){var w="horizontal",v="scrollpane",u="vertical",t="button-backward",s="button-forward",r="content",q="execute",p="qx.ui.container.SlideBar",o="removeChildWidget",n="_applyOrientation",l="slidebar",m="update";
qx.Class.define(p,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MRemoteLayoutHandling],construct:function(j){arguments.callee.base.call(this);
var k=this.getChildControl(v);
this._add(k,{flex:1});

if(j!=null){this.setOrientation(j);
}else{this.initOrientation();
}},properties:{appearance:{refine:true,init:l},orientation:{check:[w,u],init:w,apply:n}},members:{getChildrenContainer:function(){return this.getChildControl(r);
},_createChildControlImpl:function(B){var C;

switch(B){case s:C=new qx.ui.form.RepeatButton;
C.addListener(q,this._onExecuteForward,this);
C.setFocusable(false);
this._addAt(C,2);
break;
case t:C=new qx.ui.form.RepeatButton;
C.addListener(q,this._onExecuteBackward,this);
C.setFocusable(false);
this._addAt(C,0);
break;
case r:C=new qx.ui.container.Composite();
if(qx.bom.client.Engine.GECKO){C.addListener(o,this._onRemoveChild,this);
}this.getChildControl(v).add(C);
break;
case v:C=new qx.ui.core.ScrollPane();
C.addListener(m,this._onResize,this);
break;
}return C||arguments.callee.base.call(this,B);
},_forwardStates:{barLeft:true,barTop:true,barRight:true,barBottom:true},scrollBy:function(x){var y=this.getChildControl(v);

if(this.getOrientation()===w){y.scrollByX(x);
}else{y.scrollByY(x);
}},scrollTo:function(z){var A=this.getChildControl(v);

if(this.getOrientation()===w){A.scrollToX(z);
}else{A.scrollToY(z);
...
if(b==u){d.removeState(u);
c.removeState(u);
d.addState(w);
c.addState(w);
}else if(b==w){d.removeState(w);
c.removeState(w);
d.addState(u);
c.addState(u);
}
if(a==w){this._setLayout(new qx.ui.layout.HBox());
...
var i=content.getBounds();
var h=(this.getOrientation()===w)?i.width>g.width:i.height>g.height;
h?this._showArrows():this._hideArrows();
...
(function(){var t="change",s="Use 'getSelection' instead!",r="Use 'resetSelection' instead!",q="Boolean",p="qx.ui.container.Stack",o="_applyDynamic",n="Use 'setSelection' instead!",m="changeSelection",k="Use 'changeSelection' instead!",j="qx.event.type.Data";
qx.Class.define(p,{extend:qx.ui.core.Widget,implement:qx.ui.core.ISingleSelection,include:qx.ui.core.MSingleSelectionHandling,construct:function(){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.Grow);
this.addListener(m,this.__nF,this);
},events:{"change":j},properties:{dynamic:{check:q,init:false,apply:o}},members:{_applyDynamic:function(u){var w=this._getChildren();
...
}}}},setSelected:function(G){qx.log.Logger.deprecatedMethodWarning(arguments.callee,n);
this.setSelection([G]);
},getSelected:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,s);
var h=this.getSelection()[0];

if(h){return h;
}else{return null;
}},resetSelected:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,r);
this.resetSelection();
},_getItems:function(){return this.getChildren();
},_isAllowEmptySelection:function(){return true;
},_isItemSelectable:function(D){return D.isEnabled();
},__nF:function(e){var E=e.getOldData()[0];
var F=e.getData()[0];

if(E){if(this.isDynamic()){E.exclude();
}else{E.hide();
}}
if(F){F.show();
}if(this.hasListener(t)){this.fireDataEvent(t,F,E);
}},addListener:function(J,K,self,L){if(J===t){qx.log.Logger.deprecatedEventWarning(arguments.callee,t,k);
...
},previous:function(){var B=this.getSelection()[0];
var z=this._indexOf(B)-1;
...
qx.Class.define(g,{extend:qx.ui.container.Composite,construct:function(q,r){arguments.callee.base.call(this);
this._createChildControl(n);
if(q!=null){this.setLabel(q);
}
if(r!=null){this.setIcon(r);
}},events:{"close":d},properties:{appearance:{refine:true,init:f},label:{check:k,init:m,apply:c},icon:{check:k,init:m,apply:i},showCloseButton:{check:j,init:false,apply:e}},members:{_forwardStates:{barTop:1,barRight:1,barBottom:1,barLeft:1,firstTab:1,lastTab:1},_applyIcon:function(s,t){this.getChildControl(n).setIcon(s);
},_applyLabel:function(o,p){this.getChildControl(n).setLabel(o);
...
switch(a){case n:b=new qx.ui.tabview.TabButton;
b.setAllowGrowX(true);
b.setAllowGrowY(true);
b.setUserData(h,this);
b.addListener(l,this._onButtonClose,this);
this._add(b);
break;
}return b||arguments.callee.base.call(this,a);
...
(function(){var q="close-button",p="middle",o="left",n="icon",m="label",l="right",k="click",j="Boolean",i="bottom",h="qx.ui.tabview.TabButton",e="center",g="_applyShowCloseButton",f="top",d="close",c="qx.event.type.Data";
qx.Class.define(h,{extend:qx.ui.form.RadioButton,implement:qx.ui.form.IRadioItem,construct:function(){arguments.callee.base.call(this);
var r=new qx.ui.layout.Grid(2,0);
r.setRowAlign(0,o,p);
r.setColumnAlign(0,l,p);
this._getLayout().dispose();
this._setLayout(r);
this.initShowCloseButton();
},events:{"close":c},properties:{showCloseButton:{check:j,init:false,apply:g}},members:{_applyIconPosition:function(s,t){var u={icon:this.getChildControl(n),label:this.getChildControl(m),closeButton:this.getShowCloseButton()?this.getChildControl(q):null};
for(var v in u){if(u[v]){this._remove(u[v]);
}}
switch(s){case f:this._add(u.label,{row:3,column:2});
this._add(u.icon,{row:1,column:2});

if(u.closeButton){this._add(u.closeButton,{row:0,column:4});
}break;
case i:this._add(u.label,{row:1,column:2});
this._add(u.icon,{row:3,column:2});

if(u.closeButton){this._add(u.closeButton,{row:0,column:4});
}break;
case o:this._add(u.label,{row:0,column:2});
this._add(u.icon,{row:0,column:0});

if(u.closeButton){this._add(u.closeButton,{row:0,column:4});
}break;
case l:this._add(u.label,{row:0,column:0});
...
switch(a){case m:var b=new qx.ui.basic.Label(this.getLabel());
b.setAnonymous(true);
this._add(b,{row:0,column:2});
this._getLayout().setColumnFlex(2,1);
break;
case n:b=new qx.ui.basic.Image(this.getIcon());
b.setAnonymous(true);
this._add(b,{row:0,column:0});
break;
case q:b=new qx.ui.form.Button();
b.addListener(k,this._onCloseButtonClick,this);
this._add(b,{row:0,column:4});

if(!this.getShowCloseButton()){b.exclude();
}break;
}return b||arguments.callee.base.call(this,a);
},_onCloseButtonClick:function(){this.fireDataEvent(d,this);
},_applyShowCloseButton:function(w,x){if(w){this._showChildControl(q);
}else{this._excludeChildControl(q);
}},_applyCenter:function(y){var z=this._getLayout();

if(y){z.setColumnAlign(2,e,p);
}else{z.setColumnAlign(2,o,p);
}}}});
})();
...
},setIcon:function(q){this.getChildControl(l).setIcon(q);
