...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.ListBinding", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.virtual.ListBinding-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var k="Affe ",j="demobrowser.demo.virtual.ListBinding";
qx.Class.define(j,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var b=new qx.ui.virtual.form.List();
this.getRoot().add(b,{left:10,top:10});
var g=[];

for(var i=0;i<10000;i++){g.push(k+i);
}g=new qx.data.Array(g);
var d=new qx.ui.virtual.form.ListController(g,b);
d.setDelegate({filter:function(n){var o;
parseInt(n[n.length-1])%2?o=false:o=true;
return o;
...
var c=new qx.ui.virtual.form.ListController(d.getSelection(),h);
var a=new qx.ui.virtual.form.List().set({useWidgetCells:true,cellRenderer:new demobrowser.demo.virtual.messenger.BuddyCell(),rowHeight:28});
var e=demobrowser.demo.virtual.messenger.BuddyModel.createBuddies(200);
var f=new qx.ui.virtual.form.ListController(e,a);
this.getRoot().add(a,{left:10,top:320});
}}});
})();
...
},properties:{appearance:{refine:true,init:a},width:{refine:true,init:100},height:{refine:true,init:200},scrollbarX:{check:[s,q,m],init:s,themeable:true,apply:n},scrollbarY:{check:[s,q,m],init:s,themeable:true,apply:n},scrollbar:{group:[g,h]}},members:{_createChildControlImpl:function(Q){var R;

switch(Q){case t:R=new qx.ui.core.ScrollPane();
R.addListener(i,this._computeScrollbars,this);
R.addListener(c,this._onScrollPaneX,this);
R.addListener(f,this._onScrollPaneY,this);
this._add(R,{row:0,column:0});
break;
case u:R=new qx.ui.core.ScrollBar(j);
R.setMinWidth(0);
R.exclude();
...
break;
case v:R=new qx.ui.core.ScrollBar(d);
R.setMinHeight(0);
R.exclude();
...
},getItemTop:function(O){return this.getChildControl(t).getItemTop(O);
},getItemBottom:function(V){return this.getChildControl(t).getItemBottom(V);
},getItemLeft:function(S){return this.getChildControl(t).getItemLeft(S);
},getItemRight:function(x){return this.getChildControl(t).getItemRight(x);
...
},_onMouseWheel:function(e){var ba=this._isChildControlVisible(u);
var bb=this._isChildControlVisible(v);
var Y=(bb)?this.getChildControl(v,true):(ba?this.getChildControl(u,true):null);

if(Y){Y.scrollBySteps(e.getWheelDelta());
}e.stop();
},_onChangeScrollbarXVisibility:function(e){var L=this._isChildControlVisible(u);
var M=this._isChildControlVisible(v);

if(!L){this.scrollToX(0);
}L&&M?this._showChildControl(r):this._excludeChildControl(r);
},_onChangeScrollbarYVisibility:function(e){var T=this._isChildControlVisible(u);
var U=this._isChildControlVisible(v);

if(!U){this.scrollToY(0);
}T&&U?this._showChildControl(r):this._excludeChildControl(r);
...
if(I===s&&J===s){var E=D.width>A.width;
var K=D.height>A.height;
if((E||K)&&!(E&&K)){if(E){K=D.height>F.height;
}else if(K){E=D.width>F.width;
}}}else{var E=I===q;
var K=J===q;
if(D.width>(E?F.width:A.width)&&I===s){E=true;
}
if(D.height>(E?F.height:A.height)&&J===s){K=true;
}}if(E){var C=this.getChildControl(u);
C.show();
var H=Math.max(0,D.width-F.width-1);
C.setMaximum(H);
C.setKnobFactor(H>0?F.width/D.width:0);
}else{this._excludeChildControl(u);
}
if(K){var B=this.getChildControl(v);
B.show();
var H=Math.max(0,D.height-F.height-1);
B.setMaximum(H);
B.setKnobFactor(H>0?F.height/D.height:0);
}else{this._excludeChildControl(v);
}}}});
})();
(function(){var h="scrollY",g="update",f="scrollX",d="__rO",c="pane",b="qx.ui.virtual.core.Scroller";
qx.Class.define(b,{extend:qx.ui.core.AbstractScrollArea,construct:function(m,n,o,p){arguments.callee.base.call(this);
this.__rO=new qx.ui.virtual.core.Pane(m,n,o,p);
this.__rO.addListener(g,this._computeScrollbars,this);
this.__rO.addListener(f,this._onScrollPaneX,this);
this.__rO.addListener(h,this._onScrollPaneY,this);
this._add(this.__rO,{row:0,column:0});
},properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__rO:null,getPane:function(){return this.__rO;
},_createChildControlImpl:function(j){if(j==c){return this.__rO;
}else{return arguments.callee.base.call(this,j);
}},getItemTop:function(a){throw new Error("The method 'getItemTop' is not implemented!");
},getItemBottom:function(k){throw new Error("The method 'getItemBottom' is not implemented!");
},getItemLeft:function(i){throw new Error("The method 'getItemLeft' is not implemented!");
},getItemRight:function(l){throw new Error("The method 'getItemRight' is not implemented!");
},_onScrollBarX:function(e){this.__rO.setScrollX(e.getData());
},_onScrollBarY:function(e){this.__rO.setScrollY(e.getData());
}},destruct:function(){this._disposeObjects(d);
}});
})();
(function(){var p="row-layer",o="selected",n="grid-lines",m="Boolean",l="Integer",k="cell.row",j="cell.renderer",h="_applyDelegate",g="qx.ui.virtual.form.List",f="_changeShowGridLines",C="Object",B="_applyCellRenderer",A="changeRowHeight",z="_applyRowCount",y="changeCellRenderer",x="resize",w="changeShowGridLines",v="changeDelegate",u="_applyUseWidgetCells",t="changeRowCount",r="_applyRowHeight",s="horizontal",q="virtual-list";
qx.Class.define(g,{extend:qx.ui.virtual.core.Scroller,construct:function(bj){arguments.callee.base.call(this,0,1,20,100);
this._useHtmlCells=bj;
qx.ui.core.queue.Widget.add(this);
this.getPane().addListener(x,this._onResize,this);
this._initSelectionManager();
this.initRowHeight();
this.initDelegate();
},properties:{appearance:{refine:true,init:q},rowCount:{check:l,event:t,init:0,apply:z},rowHeight:{check:l,event:A,init:20,apply:r,themeable:true},showGridLines:{check:m,event:w,init:false,apply:f,themeable:true},useWidgetCells:{check:m,init:false,apply:u,themeable:true},cellRenderer:{event:y,apply:B,themeable:true},delegate:{check:C,event:v,init:null,nullable:true,apply:h}},members:{__rP:null,__rQ:null,__rR:null,__rS:null,_initWidgetLayer:function(){var self=this;
var K={getCellWidget:function(bo,bp){var bt=self._getCellData(bo);

if(!bt){return null;
}var bq={};

if(self.__rQ.isItemSelected(bo)){bq.selected=true;
}var br=self._getCellRenderer(bo);
var bs=br.getCellWidget(bt,bq);
bs.setUserData(k,bo);
bs.setUserData(j,br);
return bs;
},poolCellWidget:function(W){var X=W.getUserData(j);
X.pool(W);
}};
this._showChildControl(p);
this.__rR=new qx.ui.virtual.layer.WidgetCell(K);
this.getPane().addLayer(this.__rR);

if(!this.__rP){this.setCellRenderer(qx.ui.virtual.form.ListItemCell.getInstance());
}},_initHtmlLayer:function(){var self=this;
var D={getCellProperties:function(bl,bm){var bn={};

if(self.__rQ.isItemSelected(bl)){bn.selected=true;
}return self._getCellRenderer(bl).getCellProperties(self._getCellData(bl),bn);
}};
this._showChildControl(p);
this.__rR=new qx.ui.virtual.layer.HtmlCell(D);
this.getPane().addLayer(this.__rR);

if(!this.__rP){this.setCellRenderer(new qx.ui.virtual.cell.Cell());
}},_initSelectionManager:function(){var self=this;
var E={isItemSelectable:function(Y){return self._delegate.isRowSelectable?self._delegate.isRowSelectable(Y):true;
},styleSelectable:function(F,G,H){if(self.__rS){self._styleWidgetSelectable(F,G,H);
}else{self._styleHtmlSelectable(F,G,H);
}}};
this.__rQ=new qx.ui.virtual.selection.Row(this.getPane(),E);
this.__rQ.attachMouseEvents(this.getPane());
this.__rQ.attachKeyEvents(this);
},getSelectionManager:function(){return this.__rQ;
},_createChildControlImpl:function(bd){var be;

switch(bd){case p:be=new qx.ui.virtual.layer.Row(null,null);
this.getPane().addLayer(be);
break;
case n:be=new qx.ui.virtual.layer.GridLines(s);
this.getPane().addLayer(be);
break;
}return be||arguments.callee.base.call(this,bd);
},update:function(){if(this.__rR){this.__rR.updateLayerData();
}},_applyRowCount:function(U,V){this.getPane().getRowConfig().setItemCount(U);
},_applyRowHeight:function(bf,bg){this.getPane().getRowConfig().setDefaultItemSize(bf);
},_changeShowGridLines:function(bh,bi){if(bh){this._showChildControl(n);
}else{this._excludeChildControl(n);
}},_applyDelegate:function(S,T){this._delegate=S||{};
},_applyUseWidgetCells:function(ba,bb){if(this.__rS!==null){throw new Error("The property 'useWidgetCells' cannot be set after the list has "+"been rendered.");
}},_applyCellRenderer:function(I,J){this.__rP=I;

if(this.__rR){this.__rR.fullUpdate();
}},_getCellData:function(bk){return this._delegate.getCellData?this._delegate.getCellData(bk):null;
},_getCellRenderer:function(bc){return this._delegate.getCellRenderer?this._delegate.getCellRenderer(bc):this.__rP;
},_styleHtmlSelectable:function(a,b,c){if(b!==o){return;
}var d=this.getChildControl(p);

if(c){d.setDecorator(a,o);
}else{d.setDecorator(a,null);
}this.__rR.updateLayerData();
},_styleWidgetSelectable:function(L,M,N){if(M!==o){return;
}var O=this.__rR.getChildren();

for(var i=0;i<O.length;i++){var P=O[i];
var R=P.getUserData(k);

if(L!==R){continue;
}
if(this.getPane().isUpdatePending()){continue;
}var Q=this._getCellRenderer(L);

if(N){Q.updateStates(P,{selected:1});
}else{Q.updateStates(P,{});
}}},syncWidget:function(){if(this.__rS!==null){return;
}this.__rS=this.getUseWidgetCells();

if(this.__rS){this._initWidgetLayer();
...
(function(){var B="resize",A="scrollY",z="Please use getChildren instead.",w="update",v="scrollX",u="_applyScrollX",t="_applyScrollY",s="qx.lang.Type.isNumber(value)&&value>=0&&value<=this.getScrollMaxY()",r="qx.lang.Type.isNumber(value)&&value>=0&&value<=this.getScrollMaxX()",q="appear",n="qx.ui.core.ScrollPane",p="qx.event.type.Event",o="scroll";
qx.Class.define(n,{extend:qx.ui.core.Widget,construct:function(){arguments.callee.base.call(this);
this.set({minWidth:0,minHeight:0});
this._setLayout(new qx.ui.layout.Grow());
this.addListener(B,this._onUpdate);
var m=this.getContentElement();
m.addListener(o,this._onScroll,this);
m.addListener(q,this._onAppear,this);
},events:{update:p},properties:{scrollX:{check:r,apply:u,event:v,init:0},scrollY:{check:s,apply:t,event:A,init:0}},members:{add:function(K){var L=this._getChildren()[0];

if(L){this._remove(L);
L.removeListener(B,this._onUpdate,this);
}
if(K){this._add(K);
K.addListener(B,this._onUpdate,this);
}},remove:function(l){if(l){this._remove(l);
l.removeListener(B,this._onUpdate,this);
}},getChild:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,z);
...
return top;
},getItemBottom:function(E){return this.getItemTop(E)+E.getBounds().height;
...
},getScrollMaxY:function(){var G=this.getInnerSize();
var F=this.getScrollSize();

if(G&&F){return Math.max(0,F.height-G.height);
}return 0;
...
(function(){var o="appear",n="qx.ui.virtual.core.CellEvent",m="qx.event.type.Data",l="change",k="update",j="scrollY",h="full update",g="__sg",f="dblclick",d="__sf",I="__sb",H="update layer window",G="qx.event.type.Event",F="__rU",E="cellContextmenu",D="resize",C="__sa",B="scrollX",A="Please use getChildren instead.",z="cellDblclick",v="__sd",w="qx.ui.virtual.core.Pane",t="click",u="prefetch x",r="contextmenu",s="cellClick",p="__sc",q="prefetch y",x="scroll",y="__rT";
qx.Class.define(w,{extend:qx.ui.core.Widget,construct:function(bk,bl,bm,bn){arguments.callee.base.call(this);
this.__rT=new qx.ui.virtual.core.Axis(bm,bk);
this.__rU=new qx.ui.virtual.core.Axis(bn,bl);
this.__rV=0;
this.__rW=0;
this.__rX=0;
this.__rY=0;
this.__sa={};
this.__sb={};
this.__sc=new qx.ui.container.Composite();
this.__sc.setUserBounds(0,0,0,0);
this._add(this.__sc);
this.__sd=[];
this.__rT.addListener(l,this.fullUpdate,this);
this.__rU.addListener(l,this.fullUpdate,this);
this.addListener(D,this._onResize,this);
this.addListenerOnce(o,this._onAppear,this);
this.addListener(t,this._onClick,this);
this.addListener(f,this._onDblclick,this);
this.addListener(r,this._onContextmenu,this);
},events:{cellClick:n,cellContextmenu:n,cellDblclick:n,update:G,scrollX:m,scrollY:m},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__rT:null,__rU:null,__rV:null,__rW:null,__rX:null,__rY:null,__sa:null,__sb:null,__sc:null,__sd:null,__se:null,__sf:null,__sg:null,DEBUG:false,getRowConfig:function(){return this.__rT;
},getColumnConfig:function(){return this.__rU;
},getChild:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,A);
return this.__sc;
},getChildren:function(){return [this.__sc];
},addLayer:function(M){{};
this.__sd.push(M);
M.setUserBounds(0,0,0,0);
this.__sc.add(M);
},getLayers:function(){return this.__sd;
},getVisibleLayers:function(){var ci=[];

for(var i=0;i<this.__sd.length;i++){var cj=this.__sd[i];

if(cj.isVisible()){ci.push(cj);
}}return ci;
},getScrollMaxX:function(){var N=this.getBounds();

if(N){return Math.max(0,this.__rU.getTotalSize()-N.width);
}return 0;
},getScrollMaxY:function(){var c=this.getBounds();

if(c){return Math.max(0,this.__rT.getTotalSize()-c.height);
}return 0;
},setScrollY:function(J){var K=this.getScrollMaxY();

if(J<0){J=0;
}else if(J>K){J=K;
}
if(this.__rV!==J){var L=this.__rV;
this.__rV=J;
this._deferredUpdateScrollPosition();
this.fireDataEvent(j,J,L);
}},getScrollY:function(){return this.__rV;
},setScrollX:function(ca){var cb=this.getScrollMaxX();

if(ca<0){ca=0;
}else if(ca>cb){ca=cb;
}
if(ca!==this.__rW){var cc=this.__rW;
this.__rW=ca;
this._deferredUpdateScrollPosition();
this.fireDataEvent(B,ca,cc);
}},getScrollX:function(){return this.__rW;
},getScrollSize:function(){return {width:this.__rU.getTotalSize(),height:this.__rT.getTotalSize()};
},scrollRowIntoView:function(bU){var bX=this.getBounds();

if(!bX){this.addListenerOnce(o,function(){this.scrollRowIntoView(bU);
},this);
return;
}var bY=this.__rT.getItemPosition(bU);
var bW=bY+this.__rT.getItemSize(bU);
var bV=this.getScrollY();

if(bY<bV){this.setScrollY(bY);
}else if(bW>bV+bX.height){this.setScrollY(bW-bX.height);
}},scrollColumnIntoView:function(bC){var bF=this.getBounds();

if(!bF){this.addListenerOnce(o,function(){this.scrollColumnIntoView(bC);
},this);
return;
}var bE=this.__rU.getItemPosition(bC);
var bD=bE+this.__rU.getItemSize(bC);
var bG=this.getScrollX();

if(bE<bG){this.setScrollX(bE);
}else if(bD>bG+bF.width){this.setScrollX(bD-bF.width);
}},scrollCellIntoView:function(bH,bI){var bJ=this.getBounds();

if(!bJ){this.addListenerOnce(o,function(){this.scrollCellIntoView(bH,bI);
},this);
return;
}this.scrollColumnIntoView(bH);
this.scrollRowIntoView(bI);
},getCellAtPosition:function(cd,ce){var cf,cg;
var ch=this.getContentLocation();

if(!ch||ce<ch.top||ce>=ch.bottom||cd<ch.left||cd>=ch.right){return null;
}cf=this.__rT.getItemAtPosition(this.getScrollY()+ce-ch.top);
cg=this.__rU.getItemAtPosition(this.getScrollX()+cd-ch.left);

if(!cf||!cg){return null;
}return {row:cf.index,column:cg.index};
},prefetchX:function(bK,bL,bM,bN){var bO=this.getVisibleLayers();

if(bO.length==0){return;
}var bQ=this.getBounds();

if(!bQ){return;
}var bR=this.__rW+bQ.width;
var bS=this.__rY-bR;

if(this.__rW-this.__sa.left<Math.min(this.__rW,bK)||this.__sa.right-bR<Math.min(bS,bM)){this.DEBUG&&console.log(u);
var bT=Math.min(this.__rW,bL);
var bP=Math.min(bS,bN);
this._setLayerWindow(bO,this.__rW-bT,this.__rV,bQ.width+bT+bP,bQ.height,false);
...
if(!by){return;
}var bw=this.__rV+by.height;
var bx=this.__rX-bw;

if(this.__rV-this.__sa.top<Math.min(this.__rV,br)||this.__sa.bottom-bw<Math.min(bx,bt)){this.DEBUG&&console.log(q);
var bA=Math.min(this.__rV,bs);
var bz=Math.min(bx,bu);
this._setLayerWindow(bv,this.__rW,this.__rV-bA,by.width,by.height+bA+bz,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__se=true;
this._updateScrollPosition();
this.__se=null;
this.fireEvent(k);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__sh(e,s);
},_onContextmenu:function(e){this.__sh(e,E);
},_onDblclick:function(e){this.__sh(e,z);
},__sh:function(e,a){var b=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());

if(!b){return;
}this.fireNonBubblingEvent(a,qx.ui.virtual.core.CellEvent,[this,e,b.row,b.column]);
},syncWidget:function(){if(this.__sb._fullUpdate){this._fullUpdate();
}else if(this.__sb._updateScrollPosition){this._updateScrollPosition();
}this.__sb={};
},_setLayerWindow:function(Q,R,top,S,T,U){var ba=this.__rT.getItemAtPosition(top);

if(ba){var bc=ba.index;
var bh=this.__rT.getItemSizes(bc,T+ba.offset);
var bb=qx.lang.Array.sum(bh);
var bj=top-ba.offset;
var bg=top-ba.offset+bb;
}else{var bc=0;
var bh=[];
var bb=0;
var bj=0;
var bg=0;
}var be=this.__rU.getItemAtPosition(R);

if(be){var X=be.index;
var W=this.__rU.getItemSizes(X,S+be.offset);
var bd=qx.lang.Array.sum(W);
var bi=R-be.offset;
var Y=R-be.offset+bd;
}else{var X=0;
var W=[];
var bd=0;
var bi=0;
var Y=0;
}this.__sa={top:bj,bottom:bg,left:bi,right:Y};
this.__sc.setUserBounds(this.__sa.left-this.__rW,this.__sa.top-this.__rV,bd,bb);
this.__sf=W;
this.__sg=bh;
this.DEBUG&&qx.ui.core.queue.Manager.flush();

for(var i=0;i<this.__sd.length;i++){var bf=new Date();
var V=this.__sd[i];
V.setUserBounds(0,0,bd,bb);

if(U){V.fullUpdate(bc,X,bh,W);
}else{V.updateLayerWindow(bc,X,bh,W);
}if(this.DEBUG){this.debug("layer update ("+V.classname+"): "+(new Date()-bf)+"ms");
var bf=new Date();
qx.ui.core.queue.Manager.flush();
this.debug("layer flush ("+V.classname+"): "+(new Date()-bf)+"ms");
}}},__si:function(){if(this.__se){return;
}var bB=this.getScrollSize();

if(this.__rX!==bB.height||this.__rY!==bB.width){this.__rX=bB.height;
this.__rY=bB.width;
this.fireEvent(k);
}},fullUpdate:function(){this.__sb._fullUpdate=1;
qx.ui.core.queue.Widget.add(this);
},isUpdatePending:function(){return !!this.__sb._fullUpdate;
},_fullUpdate:function(){var O=this.getVisibleLayers();

if(O.length==0){this.__si();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var P=this.getBounds();
this.DEBUG&&console.log(h);
this._setLayerWindow(O,this.__rW,this.__rV,P.width,P.height,true);
this.__si();
},_deferredUpdateScrollPosition:function(){this.__sb._updateScrollPosition=1;
qx.ui.core.queue.Widget.add(this);
},_updateScrollPosition:function(){var bo=this.getVisibleLayers();

if(bo.length==0){this.__si();
return;
}var bq=this.getBounds();

if(!bq){return ;
}var bp={top:this.__rV,bottom:this.__rV+bq.height,left:this.__rW,right:this.__rW+bq.width};

if(this.__sa.top<=bp.top&&this.__sa.bottom>=bp.bottom&&this.__sa.left<=bp.left&&this.__sa.right>=bp.right){this.DEBUG&&console.log(x);
this.__sc.setUserBounds(this.__sa.left-bp.left,this.__sa.top-bp.top,this.__sa.right-this.__sa.left,this.__sa.bottom-this.__sa.top);
}else{this.DEBUG&&console.log(H);
this._setLayerWindow(bo,this.__rW,this.__rV,bq.width,bq.height,false);
}this.__si();
}},destruct:function(){this._disposeArray(v);
this._disposeObjects(y,F,p);
this._disposeFields(C,I,d,g);
}});
})();
(function(){var L="change",K="__sj",J="customSizes",I="qx.event.type.Event",H="qx.ui.virtual.core.Axis";
qx.Class.define(H,{extend:qx.core.Object,construct:function(bb,bc){arguments.callee.base.call(this);
this.itemCount=bc;
this.defaultItemSize=bb;
this.customSizes={};
},events:{"change":I},members:{__sj:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
},setItemCount:function(X){if(this.itemCount!==X){this.itemCount=X;
this.__sj=null;
this.fireNonBubblingEvent(L);
}},setItemSize:function(Y,ba){{};

if(this.customSizes[Y]==ba){return;
}
if(ba===null){delete this.customSizes[Y];
}else{this.customSizes[Y]=ba;
}this.__sj=null;
this.fireNonBubblingEvent(L);
},getItemSize:function(W){return this.customSizes[W]||this.defaultItemSize;
},resetItemSizes:function(){this.customSizes={};
this.__sj=null;
this.fireNonBubblingEvent(L);
},__sk:function(){if(this.__sj){return this.__sj;
}var l=this.defaultItemSize;
var s=this.itemCount;
var n=[];

for(var p in this.customSizes){var j=parseInt(p);

if(j<s){n.push(j);
}}
if(n.length==0){var o=[{startIndex:0,endIndex:s-1,firstItemSize:l,rangeStart:0,rangeEnd:s*l-1}];
this.__sj=o;
return o;
...
for(var i=0;i<n.length;i++){var j=n[i];

if(j>=s){break;
}var r=this.customSizes[j];
var m=j*l+k;
k+=r-l;
o[i]={startIndex:j,firstItemSize:r,rangeStart:m};

if(i>0){o[i-1].rangeEnd=m-1;
o[i-1].endIndex=j-1;
}}if(o[0].rangeStart>0){o.unshift({startIndex:0,endIndex:o[0].startIndex-1,firstItemSize:l,rangeStart:0,rangeEnd:o[0].rangeStart-1});
}var t=o[o.length-1];
var q=(s-t.startIndex-1)*l;
t.rangeEnd=t.rangeStart+t.firstItemSize+q-1;
t.endIndex=s-1;
this.__sj=o;
return o;
},__sl:function(c){var d=this.__sj||this.__sk();
var e=0;
var g=d.length-1;
while(true){var h=e+((g-e)>>1);
var f=d[h];

if(f.rangeEnd<c){e=h+1;
}else if(f.rangeStart>c){g=h-1;
}else{return f;
...
}},__sm:function(B){var C=this.__sj||this.__sk();
var D=0;
var F=C.length-1;
while(true){var G=D+((F-D)>>1);
var E=C[G];

if(E.endIndex<B){D=G+1;
}else if(E.startIndex>B){F=G-1;
}else{return E;
}}},getItemPosition:function(U){if(U<0||U>=this.itemCount){return null;
}var V=this.__sm(U);

if(V.startIndex==U){return V.rangeStart;
}else{return V.rangeStart+V.firstItemSize+(U-V.startIndex-1)*this.defaultItemSize;
}},getTotalSize:function(){var T=this.__sj||this.__sk();
return T[T.length-1].rangeEnd+1;
},getItemSizes:function(u,v){var w=this.customSizes;
var z=this.defaultItemSize;
var y=0;
var x=[];
var i=0;

while(y<v){var A=w[u++]||z;
y+=A;
x[i++]=A;

if(u>=this.itemCount){break;
}}return x;
}},destruct:function(){this._disposeFields(J,K);
}});
})();
(function(){var f="Integer",e="qx.ui.virtual.core.CellEvent";
...
(function(){var f="__so",e="abstract",d="qx.ui.virtual.layer.Abstract",c="__sn",b="__sr",a="__ss";
qx.Class.define(d,{extend:qx.ui.core.Widget,type:e,implement:[qx.ui.virtual.core.ILayer],construct:function(){arguments.callee.base.call(this);
this.__sn={};
},properties:{anonymous:{refine:true,init:true}},members:{__sn:null,__so:null,__sp:null,__sq:null,__sr:null,__ss:null,getFirstRow:function(){return this.__sp;
},getFirstColumn:function(){return this.__sq;
},getRowSizes:function(){return this.__sr||[];
},getColumnSizes:function(){return this.__ss||[];
},syncWidget:function(){if(!this.getContentElement().getDomElement()){return;
}
if(this.__sn.fullUpdate||this.__sn.updateLayerWindow&&this.__sn.updateLayerData){this._fullUpdate.apply(this,this.__so);
}else if(this.__sn.updateLayerWindow){this._updateLayerWindow.apply(this,this.__so);
}else if(this.__sn.updateLayerData){this._updateLayerData();
}
if(this.__sn.fullUpdate||this.__sn.updateLayerWindow){var s=this.__so;
this.__sp=s[0];
this.__sq=s[1];
this.__sr=s[2];
this.__ss=s[3];
}this.__sn={};
},_updateLayerData:function(){this._fullUpdate(this.__sp,this.__sq,this.__sr,this.__ss);
},_fullUpdate:function(o,p,q,r){throw new Error("Abstract method '_fullUpdate' called!");
},_updateLayerWindow:function(k,l,m,n){this._fullUpdate(k,l,m,n);
},updateLayerData:function(){this.__sn.updateLayerData=true;
qx.ui.core.queue.Widget.add(this);
},fullUpdate:function(t,u,v,w){this.__so=arguments;
this.__sn.fullUpdate=true;
qx.ui.core.queue.Widget.add(this);
},updateLayerWindow:function(g,h,i,j){this.__so=arguments;
this.__sn.updateLayerWindow=true;
qx.ui.core.queue.Widget.add(this);
}},destruct:function(){this._disposeFields(c,f,b,a);
}});
})();
(function(){var f="cell.empty",e="cell.column",d="cell.row",c="_cellProvider",b="__st",a="qx.ui.virtual.layer.WidgetCell";
qx.Class.define(a,{extend:qx.ui.virtual.layer.Abstract,include:[qx.ui.core.MChildrenHandling],construct:function(h){arguments.callee.base.call(this);
this.setZIndex(2);
{};
this._cellProvider=h;
this.__st=[];
},properties:{anonymous:{refine:true,init:false}},members:{getRenderedCellWidget:function(u,v){var w=this.getColumnSizes().length;
var D=this.getRowSizes().length;
var C=this.getFirstRow();
var B=this.getFirstColumn();

if(u<C||u>=C+D||v<B||v>=B+w){return null;
}var A=(v-B)+(u-C)*w;
var z=this._getChildren()[A];

if(z.getUserData(f)){return null;
}else{return z;
}},__st:null,_getSpacer:function(){var g=this.__st.pop();

if(!g){g=new qx.ui.core.Spacer();
g.setUserData(f,1);
}return g;
},_fullUpdate:function(j,k,l,m){var o=this._cellProvider;
var s=this._getChildren();

for(var i=0;i<s.length;i++){var q=s[i];

if(q.getUserData(f)){this.__st.push(q);
}else{o.poolCellWidget(q);
}}this._removeAll();
var top=0;
var t=0;

for(var y=0;y<l.length;y++){for(var x=0;x<m.length;x++){var r=j+y;
var p=k+x;
var n=o.getCellWidget(r,p)||this._getSpacer();
n.setUserBounds(t,top,m[x],l[y]);
n.setUserData(d,r);
n.setUserData(e,p);
this._add(n);
t+=m[x];
...
t=0;
}},_updateLayerWindow:function(F,G,H,I){var U=F+H.length-1;
var L=G+I.length-1;
...
if(T.getUserData(f)){this.__st.push(T);
...
(function(){var c="qx.ui.virtual.cell.IWidgetCell";
qx.Interface.define(c,{members:{getCellWidget:function(e,f){},pool:function(d){},updateStates:function(a,b){},updateData:function(g,h){}}});
})();
(function(){var i="cell.states",h="qx.ui.virtual.cell.AbstractWidget",g="__su";
qx.Class.define(h,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){arguments.callee.base.call(this);
this.__su=[];
},members:{__su:null,_createWidget:function(){throw new Error("abstract method call");
},updateData:function(j,k){throw new Error("abstract method call");
},updateStates:function(b,c){var f=b.getUserData(i);
if(f){var d=c||{};

for(var e in f){if(!d[e]){b.removeState(e);
}}}else{f={};
}if(c){for(var e in c){if(!f.state){b.addState(e);
}}}b.setUserData(i,c);
},getCellWidget:function(l,m){var n=this.__su.pop()||this._createWidget();
this.updateStates(n,m);
this.updateData(n,l);
return n;
},pool:function(a){this.__su.push(a);
...
(function(){var g="The value is deprecated. Please use model instead.",f="listitem",e="qx.ui.form.ListItem",d="qx.event.type.Event",c="changeValue",b="qx.event.type.Data";
qx.Class.define(e,{extend:qx.ui.basic.Atom,implement:[qx.ui.form.IModel],include:[qx.ui.form.MModelProperty],construct:function(h,i,j){arguments.callee.base.call(this,h,i);

if(j!=null){this.setValue(j);
}},events:{"action":d,"changeValue":b},properties:{appearance:{refine:true,init:f}},members:{getFormValue:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
var a=this.getValue();

if(a==null){a=this.getLabel();
}return a;
},__oF:null,setValue:function(k){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
var l=this.__oF;
this.__oF=k;
this.fireDataEvent(c,k,l);
},getValue:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
return this.__oF;
},resetValue:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,g);
this.setValue(null);
}}});
})();
(function(){var u="",t="px;",s="' ",r="qx.ui.virtual.layer.HtmlCell",q="width:",p="top:",o=">",n="_cellProvider",m="</div>",l="<div ",i="style='",k="height:",j="class='",h="left:",g="html";
qx.Class.define(r,{extend:qx.ui.virtual.layer.Abstract,construct:function(f){arguments.callee.base.call(this);
this.setZIndex(2);
{};
this._cellProvider=f;
},members:{_getCellSizeStyle:function(a,b,c,d){var e=u;
...
e+=k+b+t;
return e;
},_fullUpdate:function(v,w,z,A){var G=[];
var H=0;
var top=0;
var I=v;
var C=w;

for(var y=0;y<z.length;y++){var H=0;
var C=w;
var D=z[y];

for(var x=0;x<A.length;x++){var F=A[x];
var B=this._cellProvider.getCellProperties(I,C);
var E=B.insets||[0,0];
G.push(l,i,h,H,t,p,top,t,this._getCellSizeStyle(F,D,E[0],E[1]),B.style||u,s,j,B.classes||u,s,B.attributes||u,o,B.content||u,m);
C++;
H+=F;
}top+=D;
I++;
}this.getContentElement().setAttribute(g,G.join(u));
...
(function(){var h="",g="qx.ui.virtual.cell.Abstract",f="abstract",e="qx-cell";
qx.Class.define(g,{type:f,extend:qx.core.Object,implement:qx.ui.virtual.cell.ICell,construct:function(){arguments.callee.base.call(this);
qx.ui.virtual.cell.CellStylesheet.getInstance();
},members:{getCssClasses:function(i,j){return e;
},getAttributes:function(c,d){return h;
},getStyles:function(k,l){return h;
...
(function(){var bm="Integer",bl="_applyPadding",bk="paddingLeft",bj="Color",bi="",bh="paddingBottom",bg="paddingTop",bf="paddingRight",be=";",bd="-",bT="__sz",bS="backgroundColor",bR="_applyTextAlign",bQ="px",bP="__sB",bO="__sv",bN="_applyFont",bM="__sw",bL="_applyBackgroundColor",bK="cell",bt="center",bu="font",br=":",bs="shorthand",bp="__sx",bq="String",bn="_applyAppearance",bo="__sA",bv="background-color:",bw="textAlign",bC="qx-cell ",bB="left",bE="__sC",bD="textColor",bG="text-align:",bF="Font",by="right",bJ="_applyTextColor",bI="justify",bH="color:",bx=" ",bz="qx.ui.virtual.cell.Cell",bA="__sy";
qx.Class.define(bz,{extend:qx.ui.virtual.cell.Abstract,construct:function(){arguments.callee.base.call(this);
this.__sv=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__sw={};
this.__sx={};
this.__sy={};
this.__sz={};
...
this.initAppearance();
this.__sF();
},properties:{appearance:{check:bq,init:bK,apply:bn},backgroundColor:{nullable:true,check:bj,apply:bL,themeable:true},textColor:{nullable:true,check:bj,apply:bJ,themeable:true},textAlign:{check:[bB,bt,by,bI],nullable:true,themeable:true,apply:bR},font:{nullable:true,apply:bN,check:bF,themeable:true},paddingTop:{check:bm,init:0,apply:bl,themeable:true},paddingRight:{check:bm,nullable:true,apply:bl,themeable:true},paddingBottom:{check:bm,nullable:true,apply:bl,themeable:true},paddingLeft:{check:bm,nullable:true,apply:bl,themeable:true},padding:{group:[bg,bf,bh,bk],mode:bs,themeable:true}},members:{__sC:null,__sD:null,__sA:null,__sB:null,__sx:null,__sw:null,__sy:null,__sz:null,__sE:false,__sv:null,__sF:function(){var h=qx.util.PropertyUtil;
var k=qx.lang.Object.fromArray(this._getCssProperties());
this.__sC=[];
var g=this.constructor;

while(g){var j=h.getProperties(g);

for(var f in j){if(!k[f]){this.__sC.push(f);
}}g=g.superclass;
}},_getCssProperties:function(){return [bS,bD,bu,bw,bg,bf,bh,bk];
},_applyAppearance:function(T,U){if(U){this.__sx={};
}},_getValue:function(v){if(this.__sE){return qx.util.PropertyUtil.getThemeValue(this,v);
}else{return qx.util.PropertyUtil.getUserValue(this,v);
}},_storeStyle:function(w,x){var y;

if(this.__sE){y=this.__sx;
}else{y=this.__sw;
}
if(x===null){delete y[w];
}else{y[w]=x;
}},_applyBackgroundColor:function(z,A,name){var z=this._getValue(name);

if(!z){this._storeStyle(name,null);
}else{this._storeStyle(name,bv+qx.theme.manager.Color.getInstance().resolve(z));
}},_applyTextColor:function(d,e,name){var d=this._getValue(name);

if(!d){this._storeStyle(name,null);
}else{this._storeStyle(name,bH+qx.theme.manager.Color.getInstance().resolve(d));
}},_applyTextAlign:function(I,J,name){var I=this._getValue(name);

if(!I){this._storeStyle(name,null);
}else{this._storeStyle(name,bG+I);
}},_applyFont:function(V,W,name){var V=this._getValue(name);

if(!V){this._storeStyle(name,null);
}else{var X=qx.theme.manager.Font.getInstance().resolve(V);
this._storeStyle(name,qx.bom.element.Style.compile(X.getStyles()));
}},_applyPadding:function(bV,bW,name){var bV=this._getValue(name);

if(this.__sE){var bY=this.__sz;
}else{bY=this.__sy;
}
if(bV===null){delete bY[name];
}else{bY[name]=bV;
}
if(bV===null){this._storeStyle(name,null);
}else{var bX=qx.lang.String.hyphenate(name);
this._storeStyle(name,bX+br+bV+bQ);
}},getCellProperties:function(Y,ba){this.__sG(ba);
...
},getAttributes:function(R,S){return bi;
},getContent:function(bb,bc){return bb;
},getCssClasses:function(a,b){var c=this.__sv.getCssClass(this.__sD)||bi;
return bC+c;
},__sG:function(ca){if(!ca){ca={};
}var cc=this.getAppearance();
var cb=cc+bd+qx.lang.Object.getKeys(ca).sort().join(bx);

if(this.__sD==cb){return;
}this.__sD=cb;
var cd=this.__sA[this.__sD];

if(!cd){this.__sH();
this.__sI(ca);
this.__sJ(ca);
this.__sK();
var cd=qx.lang.Object.clone(this.__sx);
this.__sA[this.__sD]=1;
}this.__sL();
},__sH:function(){var K=qx.util.PropertyUtil;
var L=this._getCssProperties();

for(var i=0;i<L.length;i++){K.deleteThemeValue(this,L[i]);
}},__sI:function(M){this.__sx={};
this.__sE=true;
var P=this.getAppearance();
var O=qx.util.PropertyUtil;
var N=qx.theme.manager.Appearance.getInstance().styleFrom(P,M);

for(var Q in N){if(N[Q]!==undefined){O.setThemed(this,Q,N[Q]);
}}this.__sE=false;
},__sJ:function(){var bU=qx.lang.Object.getValues(this.__sx).join(be);
this.__sv.computeClassForStyles(this.__sD,bU);
},__sK:function(){var H=this.__sC;
...
}}this.__sB[this.__sD]=F;
},__sL:function(){var t=qx.util.PropertyUtil;
var s=this.__sB[this.__sD]||{};

for(var u in s){t.setThemed(this,u,s[u]);
}},getStyles:function(B,C){return qx.lang.Object.getValues(this.__sw).join(be);
},getInsets:function(l,m){var q=this.__sy;
var p=this.__sz;
...
return [r+n,top+o];
}},destruct:function(){this._disposeFields(bO,bM,bp,bA,bT,bo,bP,bE);
}});
})();
(function(){var s=".qx-cell {",r="-",q="mshtml",p="__sO",o="__sM",n="qx.ui.virtual.cell.CellStylesheet",m="none",l="qx-cell-",k="__sN",j="default",d="ellipsis",i="}",g="hidden",c="} ",b=".",f="qx.client",e="content-box",h="singleton",a="absolute";
qx.Class.define(n,{extend:qx.core.Object,type:h,construct:function(){arguments.callee.base.call(this);
var x=s+
qx.bom.element.Style.compile({position:a,overflow:g,cursor:j,textOverflow:d,userSelect:m})+c;

if(!qx.core.Variant.isSet(f,q)){x+=s+qx.bom.element.BoxSizing.compile(e)+i;
}this.__sM=qx.bom.Stylesheet.createElement(x);
this.__sN={};
this.__sO={};
},members:{__sM:null,__sN:null,__sO:null,getStylesheet:function(){return this.__sM;
},getCssClass:function(w){return this.__sN[w];
},computeClassForStyles:function(t,u){var v=this.__sO[u];

if(!v){var v=this.__sP();
qx.bom.Stylesheet.addRule(this.__sM,b+v,u);
this.__sO[u]=v;
}this.__sN[t]=v;
return v;
},__sP:function(){return l+this.toHashCode()+r+(this.__sQ++);
},__sQ:0},destruct:function(){this._disposeFields(o,k,p);
}});
})();
(function(){var n="$$theme_",m="$$user_",l="$$init_",k="qx.util.PropertyUtil";
qx.Class.define(k,{statics:{getProperties:function(x){return x.$$properties;
},getUserValue:function(t,u){return t[m+u];
},setUserValue:function(q,r,s){q[m+r]=s;
},deleteUserValue:function(v,w){delete (v[m+w]);
},getInitValue:function(g,h){return g[l+h];
},setInitValue:function(a,b,c){a[l+b]=c;
},deleteInitValue:function(i,j){delete (i[l+j]);
},getThemeValue:function(F,G){return F[n+G];
},setThemeValue:function(d,e,f){d[n+e]=f;
},deleteThemeValue:function(o,p){delete (o[n+p]);
},setThemed:function(y,z,A){var B=qx.core.Property.$$method.setThemed;
y[B[z]](A);
},resetThemed:function(C,D){var E=qx.core.Property.$$method.resetThemed;
C[E[D]]();
}}});
})();
(function(){var E="one",D="single",C="selected",B="additive",A="multi",z="PageUp",y="under",x="Left",w="lead",v="Down",bh="Up",bg="Boolean",bf="PageDown",be="anchor",bd="End",bc="Home",bb="Right",ba="right",Y="click",X="above",L="left",M="Escape",J="__mP",K="__nj",H="A",I="Space",F="__nh",G="_applyMode",N="__mS",O="interval",R="changeSelection",Q="qx.event.type.Data",T="quick",S="key",V="abstract",U="__ni",P="drag",W="qx.ui.core.selection.Abstract";
qx.Class.define(W,{type:V,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__mP={};
},events:{"changeSelection":Q},properties:{mode:{check:[D,A,B,E],init:D,apply:G},drag:{check:bg,init:false},quick:{check:bg,init:false}},members:{__mQ:0,__mR:0,__mS:null,__mT:null,__mU:null,__mV:null,__mW:null,__mX:null,__mY:null,__na:null,__nb:null,__nc:null,__nd:null,__ne:null,__nf:null,__ng:null,__nh:null,__mP:null,__ni:null,__nj:null,getSelectionContext:function(){return this.__ng;
},selectAll:function(){var cd=this.getMode();

if(cd==D||cd==E){throw new Error("Can not select all items in selection mode: "+cd);
}this._selectAllItems();
this._fireChange();
},selectItem:function(bA){this._setSelectedItem(bA);
var bB=this.getMode();

if(bB!==D&&bB!==E){this._setLeadItem(bA);
this._setAnchorItem(bA);
}this._scrollItemIntoView(bA);
this._fireChange();
},addItem:function(cE){var cF=this.getMode();

if(cF===D||cF===E){this._setSelectedItem(cE);
}else{if(!this._getAnchorItem()){this._setAnchorItem(cE);
}this._setLeadItem(cE);
this._addToSelection(cE);
}this._scrollItemIntoView(cE);
this._fireChange();
},removeItem:function(bi){this._removeFromSelection(bi);

if(this.getMode()===E&&this.isSelectionEmpty()){var bj=this._getFirstSelectable();

if(bj){this.addItem(bj);
}if(bj==bi){return;
}}
if(this._getLeadItem()==bi){this._setLeadItem(null);
}
if(this._getAnchorItem()==bi){this._setAnchorItem(null);
}this._fireChange();
},selectItemRange:function(cm,cn){var co=this.getMode();

if(co==D||co==E){throw new Error("Can not select multiple items in selection mode: "+co);
...
if(cH==E||cH===D){if(cG.length>1){throw new Error("Could not select more than one items in mode: "+cH+"!");
}
if(cG.length==1){this.selectItem(cG[0]);
}else{this.clearSelection();
}return;
}else{this._replaceMultiSelection(cG);
}},getSelectedItem:function(){var bU=this.getMode();

if(bU===D||bU===E){return this._getSelectedItem()||null;
}throw new Error("The method getSelectedItem() is only supported in 'single' and 'one' selection mode!");
},getSelection:function(){return qx.lang.Object.getValues(this.__mP);
},getSortedSelection:function(){var cu=this.getSelectables();
var ct=qx.lang.Object.getValues(this.__mP);
ct.sort(function(a,b){return cu.indexOf(a)-cu.indexOf(b);
});
return ct;
},isItemSelected:function(cg){var ch=this._selectableToHashCode(cg);
return this.__mP[ch]!==undefined;
},isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__mP);
},invertSelection:function(){var cs=this.getMode();

if(cs===D||cs===E){throw new Error("The method invertSelection() is only supported in 'multi' and 'additive' selection mode!");
}var cr=this.getSelectables();

for(var i=0;i<cr.length;i++){this._toggleInSelection(cr[i]);
}this._fireChange();
},_setLeadItem:function(bC){var bD=this.__nh;

if(bD!==null){this._styleSelectable(bD,w,false);
}
if(bC!==null){this._styleSelectable(bC,w,true);
}this.__nh=bC;
},_getLeadItem:function(){return this.__nh!==null?this.__nh:null;
},_setAnchorItem:function(bR){var bS=this.__ni;

if(bS){this._styleSelectable(bS,be,false);
}
if(bR){this._styleSelectable(bR,be,true);
}this.__ni=bR;
},_getAnchorItem:function(){return this.__ni!==null?this.__ni:null;
},_isSelectable:function(cI){throw new Error("Abstract method call: _isSelectable()");
},_getSelectableFromMouseEvent:function(event){var cv=event.getTarget();
return this._isSelectable(cv)?cv:null;
},_selectableToHashCode:function(bT){throw new Error("Abstract method call: _selectableToHashCode()");
...
},_getSelectableLocationX:function(bX){throw new Error("Abstract method call: _getSelectableLocationX()");
},_getSelectableLocationY:function(cl){throw new Error("Abstract method call: _getSelectableLocationY()");
...
},_getSelectableRange:function(ce,cf){throw new Error("Abstract method call: _getSelectableRange()");
},_getFirstSelectable:function(){throw new Error("Abstract method call: _getFirstSelectable()");
},_getLastSelectable:function(){throw new Error("Abstract method call: _getLastSelectable()");
},_getRelatedSelectable:function(bV,bW){throw new Error("Abstract method call: _getRelatedSelectable()");
},_getPage:function(bE,bF){throw new Error("Abstract method call: _getPage()");
},_applyMode:function(cY,da){this._setLeadItem(null);
this._setAnchorItem(null);
this._clearSelection();
if(cY===E){var db=this._getFirstSelectable();

if(db){this._setSelectedItem(db);
this._scrollItemIntoView(db);
}}this._fireChange();
...
this._fireChange(T);
},handleMouseDown:function(event){var bL=this._getSelectableFromMouseEvent(event);

if(bL===null){return;
}var bN=event.isCtrlPressed()||(qx.bom.client.Platform.MAC&&event.isMetaPressed());
var bK=event.isShiftPressed();
if(this.isItemSelected(bL)&&!bK&&!bN&&!this.getDrag()){this.__nj=bL;
return;
}else{this.__nj=null;
}this._scrollItemIntoView(bL);
switch(this.getMode()){case D:case E:this._setSelectedItem(bL);
break;
case B:this._setLeadItem(bL);
this._setAnchorItem(bL);
this._toggleInSelection(bL);
break;
case A:this._setLeadItem(bL);
if(bK){var bM=this._getAnchorItem();

if(bM===null){bM=this._getFirstSelectable();
this._setAnchorItem(bM);
}this._selectItemRange(bM,bL,bN);
}else if(bN){this._setAnchorItem(bL);
this._toggleInSelection(bL);
}else{this._setAnchorItem(bL);
this._setSelectedItem(bL);
}break;
}var bO=this.getMode();

if(this.getDrag()&&bO!==D&&bO!==E&&!bK&&!bN){this.__mW=this._getLocation();
this.__mT=this._getScroll();
this.__mX=event.getDocumentLeft()+this.__mT.left;
this.__mY=event.getDocumentTop()+this.__mT.top;
this.__na=true;
this._capture();
}this._fireChange(Y);
},handleMouseUp:function(event){var cX=event.isCtrlPressed()||(qx.bom.client.Platform.MAC&&event.isMetaPressed());
var cU=event.isShiftPressed();

if(!cX&&!cU&&this.__nj){var cV=this._getSelectableFromMouseEvent(event);

if(cV===null||!this.isItemSelected(cV)){return;
}var cW=this.getMode();

if(cW===B){this._removeFromSelection(cV);
}else{this._setSelectedItem(cV);

if(this.getMode()===A){this._setLeadItem(cV);
this._setAnchorItem(cV);
}}}this._cleanup();
},handleLoseCapture:function(event){this._cleanup();
},handleMouseMove:function(event){if(!this.__na){return;
}this.__nb=event.getDocumentLeft();
this.__nc=event.getDocumentTop();
var cx=this.__nb+this.__mT.left;

if(cx>this.__mX){this.__nd=1;
}else if(cx<this.__mX){this.__nd=-1;
}else{this.__nd=0;
}var cw=this.__nc+this.__mT.top;

if(cw>this.__mY){this.__ne=1;
}else if(cw<this.__mY){this.__ne=-1;
}else{this.__ne=0;
}var location=this.__mW;

if(this.__nb<location.left){this.__mQ=this.__nb-location.left;
}else if(this.__nb>location.right){this.__mQ=this.__nb-location.right;
}else{this.__mQ=0;
}
if(this.__nc<location.top){this.__mR=this.__nc-location.top;
}else if(this.__nc>location.bottom){this.__mR=this.__nc-location.bottom;
}else{this.__mR=0;
}if(!this.__mS){this.__mS=new qx.event.Timer(100);
this.__mS.addListener(O,this._onInterval,this);
}this.__mS.start();
this._autoSelect();
},handleAddItem:function(e){var cp=e.getData();

if(this.getMode()===E&&this.isSelectionEmpty()){this.addItem(cp);
}},handleRemoveItem:function(e){this.removeItem(e.getData());
},_cleanup:function(){if(!this.getDrag()&&this.__na){return;
}if(this.__nf){this._fireChange(Y);
}delete this.__na;
delete this.__mU;
delete this.__mV;
this._releaseCapture();
if(this.__mS){this.__mS.stop();
}},_onInterval:function(e){this._scrollBy(this.__mQ,this.__mR);
this.__mT=this._getScroll();
this._autoSelect();
},_autoSelect:function(){var r=this._getDimension();
var j=Math.max(0,Math.min(this.__nb-this.__mW.left,r.width))+this.__mT.left;
var h=Math.max(0,Math.min(this.__nc-this.__mW.top,r.height))+this.__mT.top;
if(this.__mU===j&&this.__mV===h){return;
}this.__mU=j;
this.__mV=h;
...
while(p!==0){s=p>0?this._getRelatedSelectable(m,ba):this._getRelatedSelectable(m,L);
...
while(q!==0){o=q>0?this._getRelatedSelectable(m,y):this._getRelatedSelectable(m,X);
...
if(u===A){this._selectItemRange(t,m);
}else if(u===B){if(this.isItemSelected(t)){this._selectItemRange(t,m,true);
}else{this._deselectItemRange(t,m);
}this._setAnchorItem(m);
}this._fireChange(P);
},__nk:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){var cQ,cP;
var cS=event.getKeyIdentifier();
var cR=this.getMode();
var cM=event.isCtrlPressed()||(qx.bom.client.Platform.MAC&&event.isMetaPressed());
var cN=event.isShiftPressed();
var cO=false;

if(cS===H&&cM){if(cR!==D&&cR!==E){this._selectAllItems();
cO=true;
}}else if(cS===M){if(cR!==D&&cR!==E){this._clearSelection();
cO=true;
}}else if(cS===I){var cL=this._getLeadItem();

if(cL&&!cN){if(cM||cR===B){this._toggleInSelection(cL);
}else{this._setSelectedItem(cL);
}cO=true;
}}else if(this.__nk[cS]){cO=true;

if(cR===D||cR==E){cQ=this._getSelectedItem();
}else{cQ=this._getLeadItem();
}
if(cQ!==null){switch(cS){case bc:cP=this._getFirstSelectable();
break;
case bd:cP=this._getLastSelectable();
break;
case bh:cP=this._getRelatedSelectable(cQ,X);
break;
case v:cP=this._getRelatedSelectable(cQ,y);
break;
case x:cP=this._getRelatedSelectable(cQ,L);
break;
case bb:cP=this._getRelatedSelectable(cQ,ba);
break;
case z:cP=this._getPage(cQ,true);
break;
case bf:cP=this._getPage(cQ,false);
break;
}}else{switch(cS){case bc:case v:case bb:case bf:cP=this._getFirstSelectable();
break;
case bd:case bh:case x:case z:cP=this._getLastSelectable();
break;
}}if(cP!==null){switch(cR){case D:case E:this._setSelectedItem(cP);
break;
case B:this._setLeadItem(cP);
break;
case A:if(cN){var cT=this._getAnchorItem();
...
}},_clearSelection:function(){var by=this.__mP;

for(var bz in by){this._removeFromSelection(by[bz]);
}this.__mP={};
},_selectItemRange:function(br,bs,bt){var bw=this._getSelectableRange(br,bs);
if(!bt){var bv=this.__mP;
var bx=this.__nl(bw);
...
}},__nl:function(ci){var ck={};
var cj;

for(var i=0,l=ci.length;i<l;i++){cj=ci[i];
ck[this._selectableToHashCode(cj)]=cj;
}return ck;
},_getSelectedItem:function(){for(var cb in this.__mP){return this.__mP[cb];
}return null;
},_setSelectedItem:function(cy){if(this._isSelectable(cy)){var cz=this.__mP;
var cA=this._selectableToHashCode(cy);

if(!cz[cA]||qx.lang.Object.hasMinLength(cz,2)){this._clearSelection();
this._addToSelection(cy);
}}},_addToSelection:function(bG){var bH=this._selectableToHashCode(bG);

if(!this.__mP[bH]&&this._isSelectable(bG)){this.__mP[bH]=bG;
this._styleSelectable(bG,C,true);
this.__nf=true;
}},_toggleInSelection:function(cJ){var cK=this._selectableToHashCode(cJ);

if(!this.__mP[cK]){this.__mP[cK]=cJ;
this._styleSelectable(cJ,C,true);
}else{delete this.__mP[cK];
this._styleSelectable(cJ,C,false);
}this.__nf=true;
},_removeFromSelection:function(bY){var ca=this._selectableToHashCode(bY);

if(this.__mP[ca]!=null){delete this.__mP[ca];
this._styleSelectable(bY,C,false);
this.__nf=true;
...
delete bo[bp];
this._styleSelectable(bq,C,false);
bn=true;
}}for(var bp in bl){bq=bo[bp]=bl[bp];
this._styleSelectable(bq,C,true);
bn=true;
}if(!bn){return false;
...
this.__nf=true;
this._fireChange();
},_fireChange:function(cq){if(this.__nf){this.__ng=cq||null;
this.fireDataEvent(R,this.getSelection());
delete this.__nf;
}}},destruct:function(){this._disposeObjects(N);
this._disposeFields(J,K,U,F);
}});
})();
(function(){var r="mouseup",q="mousedown",p="losecapture",o="mouseover",n="mousemove",m="removeItem",l="keypress",k="addItem",j="qx.ui.virtual.selection.Abstract",i="_pane",h="_delegate";
qx.Class.define(j,{extend:qx.ui.core.selection.Abstract,construct:function(t,u){arguments.callee.base.call(this);
{};
this._pane=t;
this._delegate=u||{};
},members:{_isSelectable:function(s){return this._delegate.isItemSelectable?this._delegate.isItemSelectable(s):true;
},_styleSelectable:function(c,d,e){if(this._delegate.styleSelectable){this._delegate.styleSelectable(c,d,e);
}},attachMouseEvents:function(){var w=this._pane.getContainerElement();
w.addListener(q,this.handleMouseDown,this);
w.addListener(r,this.handleMouseUp,this);
w.addListener(o,this.handleMouseOver,this);
w.addListener(n,this.handleMouseMove,this);
w.addListener(p,this.handleLoseCapture,this);
},detatchMouseEvents:function(){var g=this._pane.getContainerElement();
g.removeListener(q,this.handleMouseDown,this);
g.removeListener(r,this.handleMouseUp,this);
g.removeListener(o,this.handleMouseOver,this);
g.removeListener(n,this.handleMouseMove,this);
g.removeListener(p,this.handleLoseCapture,this);
},attachKeyEvents:function(f){f.addListener(l,this.handleKeyPress,this);
},detachKeyEvents:function(x){x.removeListener(l,this.handleKeyPress,this);
},attachListEvents:function(z){z.addListener(k,this.handleAddItem,this);
z.addListener(m,this.handleRemoveItem,this);
},detachListEvents:function(y){y.removeListener(k,this.handleAddItem,this);
y.removeListener(m,this.handleRemoveItem,this);
...
},_scrollBy:function(a,b){this._pane.setScrollX(this._pane.getScrollX()+a);
this._pane.setScrollY(this._pane.getScrollY()+b);
},_getLocation:function(){var v=this._pane.getContentElement().getDomElement();
...
(function(){var o="qx.ui.virtual.selection.Row",n="above",m="under";
qx.Class.define(o,{extend:qx.ui.virtual.selection.Abstract,members:{_getItemCount:function(){return this._pane.getRowConfig().getItemCount();
},_getSelectableFromMouseEvent:function(event){var b=this._pane.getCellAtPosition(event.getDocumentLeft(),event.getDocumentTop());

if(!b){return null;
}return this._isSelectable(b.row)?b.row:null;
},getSelectables:function(){var B=[];

for(var i=0,l=this._getItemCount();i<l;i++){if(this._isSelectable(i)){B.push(i);
}}return B;
},_getSelectableRange:function(r,s){var t=[];
var v=Math.min(r,s);
var u=Math.max(r,s);

for(var i=v;i<=u;i++){if(this._isSelectable(i)){t.push(i);
}}return t;
},_getFirstSelectable:function(){var c=this._getItemCount();

for(var i=0;i<c;i++){if(this._isSelectable(i)){return i;
}}return null;
},_getLastSelectable:function(){var A=this._getItemCount();

for(var i=A-1;i>=0;i--){if(this._isSelectable(i)){return i;
}}return null;
},_getRelatedSelectable:function(e,f){if(f==n){var h=e-1;
var g=0;
var j=-1;
}else if(f==m){var h=e+1;
...
}},_selectableToHashCode:function(k){return k;
},_scrollItemIntoView:function(a){this._pane.scrollRowIntoView(a);
},_getSelectableLocationX:function(d){return {left:0,right:this._pane.getColumnConfig().getTotalSize()-1};
...
(function(){var l="Color",k="_applyColorEven",j="qx.ui.virtual.layer.AbstractBackground",i="__sR",h="__sS",g="_applyColorOdd";
qx.Class.define(j,{extend:qx.ui.virtual.layer.Abstract,construct:function(e,f){arguments.callee.base.call(this);
...
this.__sS={};
},properties:{colorEven:{nullable:true,check:l,apply:k,themeable:true},colorOdd:{nullable:true,check:l,apply:g,themeable:true}},members:{__sT:null,__sU:null,__sR:null,__sS:null,setColor:function(r,s){if(s){this.__sR[r]=qx.theme.manager.Color.getInstance().resolve(s);
}else{delete (this.__sR[r]);
}},clearCustomColors:function(){this.__sR={};
this.updateLayerData();
},getColor:function(a){var b=this.__sR[a];

if(b){return b;
}else{return a%2==0?this.__sT:this.__sU;
}},_applyColorEven:function(n,o){if(n){this.__sT=qx.theme.manager.Color.getInstance().resolve(n);
}else{this.__sT=null;
}this.updateLayerData();
},_applyColorOdd:function(p,q){if(p){this.__sU=qx.theme.manager.Color.getInstance().resolve(p);
}else{this.__sU=null;
}this.updateLayerData();
},setDecorator:function(c,d){if(d){this.__sS[c]=qx.theme.manager.Decoration.getInstance().resolve(d);
}else{delete (this.__sS[c]);
}this.updateLayerData();
},getDecorator:function(m){return this.__sS[m];
}},destruct:function(){this._disposeFields(i,h);
}});
})();
(function(){var x="px;",w="left: 0;",v="</div>",u="top:",t="position: absolute;",s="<div style='",r="'>",q="background-color:",p="",o="qx.ui.virtual.layer.Row",k="block",n="width:",m="height:",j="row-layer",h="none";
qx.Class.define(o,{extend:qx.ui.virtual.layer.AbstractBackground,properties:{appearance:{refine:true,init:j}},members:{_fullUpdate:function(D,E,F,G){var M=[];
var L=qx.lang.Array.sum(G);
var N=[];
var top=0;
var P=D;
var J=0;

for(var y=0;y<F.length;y++){var O=this.getDecorator(P);

if(O){N.push({childIndex:J,decorator:O,width:L,height:F[y]});
M.push(s,t,w,u,top,x,r,O.getMarkup(),v);
J++;
}else{var K=this.getColor(P);

if(K){M.push(s,t,w,u,top,x,m,F[y],x,n,L,x,q,K,r,v);
J++;
}}top+=F[y];
P+=1;
}var H=this.getContentElement().getDomElement();
H.style.display=h;
H.innerHTML=M.join(p);
for(var i=0,l=N.length;i<l;i++){var I=N[i];
I.decorator.resize(H.childNodes[I.childIndex].firstChild,I.width,I.height);
}H.style.display=k;
this._width=L;
},_updateLayerWindow:function(a,b,c,d){if(a!==this.getFirstRow()||c.length!==this.getRowSizes().length||this._width<qx.lang.Array.sum(d)){this._fullUpdate(a,b,c,d);
}},setColor:function(z,A){arguments.callee.base.call(this,z,A);

if(this.__sV(z)){this.updateLayerData();
}},setDecorator:function(B,C){arguments.callee.base.call(this,B,C);

if(this.__sV(B)){this.updateLayerData();
}},__sV:function(e){var g=this.getFirstRow();
var f=g+this.getRowSizes().length-1;
return e>=g&&e<=f;
}}});
})();
(function(){var I="px;",H="</div>",G="background-color:",F="'>",E="horizontal",D="position: absolute;",C="<div style='",B="top:",A="height: ",z="__sX",U="width: 100%;",T="gray",S="__sW",R="height: 100%;",Q="PositiveInteger",P="Color",O="html",N="",M="width: ",L="left:",J="qx.ui.virtual.layer.GridLines",K="top: 0px;";
qx.Class.define(J,{extend:qx.ui.virtual.layer.Abstract,construct:function(f,g,h){arguments.callee.base.call(this);
this.setZIndex(1);
...
this.__sX=[];
this._isHorizontal=(f||E)==E;
},properties:{defaultLineColor:{init:T,check:P,themeable:true},defaultLineSize:{init:1,check:Q,themeable:true}},members:{__sW:null,__sX:null,isHorizontal:function(){return this._isHorizontal;
},setLineColor:function(o,p){{};
this.__sW[o]=p;

if(this.__sY(o)){this.updateLayerData();
}},setLineSize:function(v,w){{};
this.__sX[v]=w;

if(this.__sY(v)){this.updateLayerData();
}},__sY:function(a){if(this._isHorizontal){var e=this.getFirstColumn();
var c=e+this.getColumnSizes().length-1;
return a>=e&&a<=c;
}else{var d=this.getFirstRow();
var b=d+this.getRowSizes().length-1;
return a>=d&&a<=b;
}},getLineSize:function(V){return this.__sX[V]||this.getDefaultLineSize();
},getLineColor:function(bi){return this.__sW[bi]||this.getDefaultLineColor();
},__ta:function(q,r,s){var top=0;
var t,u;

for(var y=0;y<s.length-1;y++){t=this.getLineColor(r+y);
u=this.getLineSize(r+y);
top+=s[y];
q.push(C,D,A+u+I,U,B,top-((u>1)?Math.floor(u/2):1),I,G,t,F,H);
}},__tb:function(bc,bd,be){var bh=0;
var bf,bg;

for(var x=0;x<be.length-1;x++){bf=this.getLineColor(bd+x);
bg=this.getLineSize(bd+x);
bh+=be[x];
bc.push(C,D,M+bg+I,R,K,L,bh-((bg>1)?Math.floor(bg/2):1),I,G,bf,F,H);
}},_fullUpdate:function(W,X,Y,ba){var bb=[];

if(this._isHorizontal){this.__ta(bb,W,Y);
}else{this.__tb(bb,X,ba);
}this.getContentElement().setAttribute(O,bb.join(N));
},_updateLayerWindow:function(i,j,k,l){var m=i!==this.getFirstRow()||k.length!==this.getRowSizes().length;
var n=j!==this.getFirstColumn()||l.length!==this.getColumnSizes().length;

if((this._isHorizontal&&m)||(!this._isHorizontal&&n)){this._fullUpdate(i,j,k,l);
}}},destruct:function(){this._disposeFields(S,z);
}});
})();
...
},_registerEventChaining:function(k,l,name){if((k instanceof qx.core.Object)&&qx.Class.hasMixin(k.constructor,qx.data.marshal.MEventBubbling)){var m=qx.lang.Function.bind(this.__tc,this,name);
var n=k.addListener(c,m,this);
k.setUserData(d,n);
}if(l!=null&&l.getUserData&&l.getUserData(d)!=null){l.removeListenerById(l.getUserData(d));
}},__tc:function(name,e){var v=e.getData();
var r=v.value;
var p=v.old;
...
(function(){var be="change",bd="add",bc="order",bb="remove",ba="",Y="qx.data.Array",X="?",W="__td",V="changeBubble",U="qx.event.type.Event",R="number",T="changeLength",S="qx.event.type.Data";
qx.Class.define(Y,{extend:qx.core.Object,include:qx.data.marshal.MEventBubbling,implement:[qx.data.IListData],construct:function(b){arguments.callee.base.call(this);
if(b==undefined){this.__td=[];
}else if(arguments.length>1){this.__td=[];

for(var i=0;i<arguments.length;i++){this.__td.push(arguments[i]);
}}else if(typeof b==R){this.__td=new Array(b);
}else if(b instanceof Array){this.__td=qx.lang.Array.clone(b);
}else{this.__td=[];
throw new Error("Type of the parameter not supported!");
}for(var i=0;i<this.__td.length;i++){this._applyEventPropagation(this.__td[i],null,i);
}this.__te();
},events:{"change":S,"changeLength":U},members:{__td:null,concat:function(v){if(v){var w=this.__td.concat(v);
}else{var w=this.__td.concat();
}return new qx.data.Array(w);
},join:function(n){return this.__td.join(n);
},pop:function(){var O=this.__td.pop();
this.__te();
this._applyEventPropagation(null,O,this.length-1);
this.fireDataEvent(be,{start:this.length-1,end:this.length-1,type:bb,items:[O]},null);
return O;
},push:function(J){for(var i=0;i<arguments.length;i++){this.__td.push(arguments[i]);
this.__te();
this._applyEventPropagation(arguments[i],null,this.length-1);
this.fireDataEvent(be,{start:this.length-1,end:this.length-1,type:bd,items:[arguments[i]]},null);
}return this.length;
},reverse:function(){this.__td.reverse();
this.fireDataEvent(be,{start:0,end:this.length-1,type:bc,items:null},null);
},shift:function(){var x=this.__td.shift();
this.__te();
this._applyEventPropagation(null,x);
this.fireDataEvent(be,{start:0,end:this.length-1,type:bb,items:[x]},null);
return x;
},slice:function(l,m){return new qx.data.Array(this.__td.slice(l,m));
},splice:function(A,B,C){var I=this.__td.length;
var F=this.__td.splice.apply(this.__td,arguments);
if(this.__td.length!=I){this.__te();
}var G=B>0;
var D=arguments.length>2;
var E=null;

if(G||D){if(this.__td.length>I){var H=bd;
}else if(this.__td.length<I){var H=bb;
E=F;
}else{var H=bc;
...
}this.fireDataEvent(V,{value:this,name:X,old:F});
for(var i=0;i<F.length;i++){this._applyEventPropagation(null,F[i],i);
}return (new qx.data.Array(F));
},sort:function(r){this.__td.sort.apply(this.__td,arguments);
this.fireDataEvent(be,{start:0,end:this.length-1,type:bc,items:null},null);
},unshift:function(p){for(var i=arguments.length-1;i>=0;i--){this.__td.unshift(arguments[i]);
this.__te();
this._applyEventPropagation(arguments[i],null,0);
this.fireDataEvent(be,{start:0,end:this.length-1,type:bd,items:[arguments[i]]},null);
}return this.length;
},toArray:function(){return this.__td;
},getItem:function(g){return this.__td[g];
},setItem:function(s,t){var u=this.__td[s];
this.__td[s]=t;
this._applyEventPropagation(t,u,s);
if(this.length!=this.__td.length){this.__te();
}this.fireDataEvent(be,{start:s,end:s,type:bd,items:[t]},null);
},getLength:function(){return this.length;
},indexOf:function(d){return this.__td.indexOf(d);
},toString:function(){if(this.__td!=null){return this.__td.toString();
}return ba;
},contains:function(c){return this.__td.indexOf(c)!==-1;
},copy:function(){return this.concat();
},insertAt:function(e,f){this.splice(e,0,f);
},insertBefore:function(h,j){var k=this.indexOf(h);

if(k==-1){this.push(j);
}else{this.splice(k,0,j);
}},insertAfter:function(K,L){var M=this.indexOf(K);

if(M==-1||M==(this.length-1)){this.push(L);
}else{this.splice(M+1,0,L);
}},removeAt:function(o){return this.splice(o,1)[0];
},removeAll:function(){for(var i=0;i<this.__td.length;i++){this._applyEventPropagation(null,this.__td[i],i);
}this.__td.length=0;
this.__te();
},append:function(P){{};
for(var i=0;i<P.length;i++){this._applyEventPropagation(P[i],null,this.__td.length+i);
}Array.prototype.push.apply(this.__td,P);
this.__te();
...
},__te:function(){this.length=this.__td.length;
this.fireEvent(T,qx.event.type.Event);
}},destruct:function(){this._disposeFields(W);
}});
})();
(function(){var bd="sorter",bc="change",bb="changeSelection",ba="changeLength",Y="qx.data.IListData",X="filter",W="changeModel",V="_applyDelegate",U="changeDelegate",T="",N="qx.ui.virtual.form.ListController",S="_applyTarget",Q="qx.ui.virtual.form.List",M="_applySelection",L="changeTarget",P="changeBubble",O="_applyModel",R="object";
qx.Class.define(N,{extend:qx.core.Object,construct:function(w,x){arguments.callee.base.call(this);
this.setSelection(new qx.data.Array());

if(w!=null){this.setModel(w);
}
if(x!=null){this.setTarget(x);
}},properties:{target:{check:Q,event:L,nullable:true,init:null,apply:S},model:{check:Y,event:W,nullable:true,init:null,apply:O},selection:{check:Y,event:bb,apply:M},delegate:{apply:V,event:U,init:null,nullable:true}},members:{__tf:null,__tg:null,__th:null,__ti:null,__tj:null,__tk:null,__tl:null,_validDelegates:[bd,X],_getRowData:function(E){var F=this.getModel();
return F?F.getItem(this.__tn(E)):null;
},_getModelRow:function(bh){return this.getModel().indexOf(bh);
},getRowCount:function(){return this.__tl.length;
},update:function(){this.__tm();
},__tm:function(){var K=this.getModel();

if(K==null){return;
}this.__tl=[];
this._runDelegateFilter(K);
this._runDelegateSorter(K);

if(this.getTarget()!=null){this._syncRowCount();
}},_runDelegateSorter:function(f){if(!this._containsDelegateMethod(this.getDelegate(),bd)||qx.lang.Type.isObject(f)){return;
}
if(this.__tl.length==0){return;
}var g=this._getDelegate(bd);

if(g!=null){this.__tl.sort(function(a,b){return g(f.getItem(a),f.getItem(b));
});
}},_runDelegateFilter:function(u){if(typeof u!==R){return;
}var v=this._getDelegate(X);

for(var i=0,l=u.length;i<l;++i){if(v==null||v(u.getItem(i))){this.__tl.push(i);
}}},_containsDelegateMethod:function(m,n){var p=qx.lang.Type;

if(p.isObject(m)){if(p.isString(n)){return p.isFunction(m[n]);
}else{for(var o in this._validDelegates){if(p.isFunction(m[o])){return true;
}}}}return false;
},_getDelegate:function(c){var d=this.getDelegate();

if(this._containsDelegateMethod(d,c)){return d[c];
}return null;
},__tn:function(bg){return this.__tl[bg];
},_applyDelegate:function(y,z){if(this.getTarget()==null||this.getModel()==null){return;
}
if(this._containsDelegateMethod(y)){this.__tm();
}},_applyTarget:function(be,bf){if(be!=null){be.setDelegate(this);
this.__ti=be.getSelectionManager().addListener(bb,this._onChangeSelectionView,this);
}
if(bf!=null){bf.setDelegate(null);
bf.getSelectionManager().removeListenerById(this.__ti);
}
if(this.getModel()==null){return;
}this.__tm();
this._syncRowCount();
},_applyModel:function(q,r){if(q!=null){this.__tm();
this.__tf=q.addListener(ba,this._onChangeLengthModel,this);
this.__tg=q.addListener(bc,this._onChangeModel,this);
this.__th=q.addListener(P,this._onChangeBubbleModel,this);
}
if(r!=null){r.removeListenerById(this.__tf);
r.removeListenerById(this.__tg);
r.removeListenerById(this.__th);
}
if(this.getTarget()!=null){this._syncRowCount();
}},_applySelection:function(s,t){if(s!=null){this.__tj=s.addListener(bc,this._onChangeSelectionModel,this);
this.__tk=s.addListener(ba,this._onChangeSelectionModel,this);
this._syncModelSelectionToView();
}
if(t!=null){t.removeListenerById(this.__tj);
t.removeListenerById(this.__tk);
...
},_onChangeLengthModel:function(e){this.__tm();
this._syncRowCount();
},_onChangeModel:function(e){var j=this.getTarget();

if(j!=null){this.__tm();
j.update();
}},_onChangeBubbleModel:function(e){var h=this.getTarget();
...
if(!D){this.getSelection().removaeAll();
return;
}var C=D.getSelectionManager().getSelection();
var B=[];

for(var i=0;i<C.length;i++){var A=this._getRowData(C[i]);
B.push(A);
}B.unshift(this.getSelection().length);
B.unshift(0);
this._ignoreSelectionChange=true;
this.getSelection().splice.apply(this.getSelection(),B);
...
for(var i=G.length;i>=0;i--){var J=this._getModelRow(G.getItem(i));

if(J!==-1){H.push(J);
}else{G.removeAt(i);
}}I.getSelectionManager().replaceSelection(H);
this._ignoreSelectionChange=false;
},_syncRowCount:function(){var length=this.getRowCount();
this.getTarget().setRowCount(length);
},getCellData:function(k){return this._getRowData(k)||T;
}}});
})();
(function(){var e=".png",d="demobrowser/demo/icons/imicons/status_",c="text-selected",b="demobrowser.demo.virtual.messenger.BuddyCell",a="selected";
qx.Class.define(b,{extend:qx.ui.virtual.cell.AbstractWidget,members:{_createWidget:function(){return new demobrowser.demo.virtual.messenger.Buddy();
},updateData:function(f,g){f.label.setValue(g.getName());
f.icon.setSource(g.getAvatar());
f.statusIcon.setSource(d+g.getStatus()+e);
},updateStates:function(h,i){if(i.selected){h.setTextColor(c);
h.setDecorator(a);
}else{h.resetTextColor();
h.resetDecorator();
}}}});
})();
(function(){var b="middle",a="demobrowser.demo.virtual.messenger.Buddy";
qx.Class.define(a,{extend:qx.ui.core.Widget,construct:function(){arguments.callee.base.call(this);
this.set({padding:[0,3]});
this._setLayout(new qx.ui.layout.HBox(3).set({alignY:b}));
this.icon=new qx.ui.basic.Image().set({width:26,height:26,scale:true});
this.label=new qx.ui.basic.Label().set({allowGrowX:true});
...
(function(){var k="_applyEventPropagation",j="offline",h="String",g="Friends",f="away",e="online",d="busy",c="Christian Schmidt",b="User #",a="qooxdoo",O="smile",N="Jonathan Weiß",M=".png",L="kiss",K="changeStatus",J="icon/22/emotes/face-smile.png",I="plain",H="smile-big",G="surprise",F="raspberry",r="sad",s="embarrassed",p="Alexander Back",q="Fabian Jakobs",n="demobrowser/demo/icons/imicons/fabian_jakobs.png",o="Daniel Wagner",l="demobrowser/demo/icons/imicons/christian_schmidt.png",m="(unnamed)",t="Andreas Ecker",u="laugh",x="Thomas Herchenröder",w="changeGroup",z="demobrowser/demo/icons/imicons/martin_wittemann.png",y="changeName",B="angel",A="demobrowser.demo.virtual.messenger.BuddyModel",v="icon/22/emotes/face-",E="demobrowser/demo/icons/imicons/jonathan_weiss.png",D="changeAvatar",C="Martin Wittemann";
qx.Class.define(A,{extend:qx.core.Object,include:qx.data.marshal.MEventBubbling,properties:{name:{init:m,event:y,check:h,apply:k},avatar:{init:J,event:D,check:h,apply:k},status:{init:j,event:K,check:[f,d,e,j],apply:k},group:{init:g,event:w,check:h,apply:k}},statics:{createBuddies:function(Q){var S=[{name:p,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:q,img:n,statusIcon:this.getRandomStatus()},{name:t,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:C,img:z,statusIcon:this.getRandomStatus()},{name:x,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:o,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:N,img:E,statusIcon:this.getRandomStatus()},{name:c,img:l,statusIcon:this.getRandomStatus()}];

for(var i=0;i<S.length;i++){S[i].group=a;
}for(var i=S.length;i<Q;i++){S[i]={name:b+i,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus(),group:g};
}var R=[];

for(var i=0;i<S.length;i++){var T=new demobrowser.demo.virtual.messenger.BuddyModel().set({name:S[i].name,avatar:S[i].img,status:S[i].statusIcon,group:S[i].group});
R.push(T);
}return new qx.data.Array(R);
},getRandomBuddy:function(){var P=[B,s,L,u,I,F,r,H,O,G];
return v+P[Math.floor(Math.random()*P.length)]+M;
