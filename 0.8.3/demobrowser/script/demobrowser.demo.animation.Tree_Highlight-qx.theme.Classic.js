...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Tree_Highlight", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.animation.Tree_Highlight-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var F="execute",E="appear",D="changeSelection",C="Trash",B="mode",A="Windows (C:)",z="Documents (D:)",y="Add before",x="Add after",w="Add at begin",bv="_container",bu="btnMoveToParent",bt="Inbox",bs="Desktop",br="Show open button:",bq="New tree item name: ",bp="showOpenButtons",bo="auto",bn="btnAddAfter",bm="Hello",M="inputItemName",N="Presets",K="Data 123213234325345234523453453245",L="demobrowser.demo.animation.Tree_Highlight",I="Network",J="Control",G="btnAddFile",H="mgrShowRootOpen",Q="Sent",R="Files",ba="Remove tree item",X="Add file",be="Workspace",bc="btnRemoveAll",bi="btnAddBefore",bg="Junk #",T="btnAddFolder",bl="btnAddBegin",bk="Tree",bj="never",S="_treeGroup",V="Add folder",W="Root",Y="always",bb="Move to parent",bd="btnReset",bf="btnRemove",bh="_tree",O="Reset tree",P="Edit",U="Remove all children";
qx.Class.define(L,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
...
var o=new qx.ui.groupbox.GroupBox(bk).set({contentPadding:[4,4,4,4]});
...
},getTree:function(){var bG=new qx.ui.tree.Tree().set({width:200,height:400});
var bL=new qx.ui.tree.TreeFolder(W);
bL.setOpen(true);
bG.setRoot(bL);
var bJ=new qx.ui.tree.TreeFolder(bs);
bJ.setOpen(true);
bL.add(bJ);
var bB=new qx.ui.tree.TreeFolder(R);
var bz=new qx.ui.tree.TreeFolder(be);
var bA=new qx.ui.tree.TreeFolder(I);
var by=new qx.ui.tree.TreeFolder(C);
bJ.add(bB,bz,bA,by);
var bH=new qx.ui.tree.TreeFile(A);
var bx=new qx.ui.tree.TreeFile(z);
bz.add(bH,bx);
var bK=new qx.ui.tree.TreeFolder(bt);
var bC=new qx.ui.tree.TreeFolder(N);
var bF=new qx.ui.tree.TreeFolder(Q);
var bE=new qx.ui.tree.TreeFolder(C);

for(var i=0;i<100;i++){bE.add(new qx.ui.tree.TreeFile(bg+i));
}var bI=new qx.ui.tree.TreeFolder(K);
var bD=new qx.ui.tree.TreeFolder(P);
bK.add(bC,bF,bE,bI,bD);
bL.add(bK);
return bG;
},getCommandFrame:function(){var d=new qx.ui.groupbox.GroupBox(J);
d.setLayout(new qx.ui.layout.Grid(3,5));
var f=0;
d.add(new qx.ui.basic.Label(bq).set({paddingTop:4}),{row:f,column:0});
this.inputItemName=new qx.ui.form.TextField(bm);
d.add(this.inputItemName,{row:f++,column:1});
this.btnAddFolder=new qx.ui.form.Button(V);
this.btnAddFolder.addListener(F,this._addFolder,this);
d.add(this.btnAddFolder,{row:f++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(X);
this.btnAddFile.addListener(F,this._addFile,this);
d.add(this.btnAddFile,{row:f++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(x);
this.btnAddAfter.addListener(F,this._addAfter,this);
d.add(this.btnAddAfter,{row:f++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(y);
this.btnAddBefore.addListener(F,this._addBefore,this);
d.add(this.btnAddBefore,{row:f++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(w);
this.btnAddBegin.addListener(F,this._addBegin,this);
d.add(this.btnAddBegin,{row:f++,column:0,colSpan:2});
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
this.btnRemove=new qx.ui.form.Button(ba);
this.btnRemove.addListener(F,this._removeTreeItem,this);
d.add(this.btnRemove,{row:f++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(U);
this.btnRemoveAll.addListener(F,this._removeAll,this);
d.add(this.btnRemoveAll,{row:f++,column:0,colSpan:2});
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(bb);
this.btnMoveToParent.addListener(F,this._moveToParent,this);
d.add(this.btnMoveToParent,{row:f++,column:0,colSpan:2});
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
d.add(new qx.ui.basic.Label(br),{row:f,column:0});
var b=[Y,bj,bo];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<b.length;i++){var e=b[i];
var c=new qx.ui.form.RadioButton(e).set({value:e==this._tree.getRootOpenClose()});
c.setUserData(B,e);
this.showOpenButtons[e]=c;
this.mgrShowRootOpen.add(c);
d.add(c,{row:f++,column:1});
}this.mgrShowRootOpen.addListener(D,this._onChangeShowOpen,this);
d.add(new qx.ui.core.Spacer(5,5),{row:f++,column:0});
this.btnReset=new qx.ui.form.Button(O);
this.btnReset.addListener(F,this._resetTree,this);
d.add(this.btnReset,{row:f++,column:0,colSpan:2});
this._tree.addListener(D,this._updateControls,this);
this._updateControls();
return d;
},_addFolder:function(){var r=this._tree.getSelection()[0];
var s=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
s.addListenerOnce(E,function(){var v=new qx.fx.effect.core.Highlight(s.getContainerElement().getDomElement());
v.start();
},this);
r.setOpen(true);
r.add(s);
},_addFile:function(){var t=this._tree.getSelection()[0];
var u=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
u.addListenerOnce(E,function(){var bw=new qx.fx.effect.core.Highlight(u.getContainerElement().getDomElement());
bw.start();
},this);
t.setOpen(true);
t.add(u);
},_addBefore:function(){var bS=this._tree.getSelection()[0];
var bT=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bT.addListenerOnce(E,function(){var q=new qx.fx.effect.core.Highlight(bT.getContainerElement().getDomElement());
q.start();
},this);
bS.getParent().addBefore(bT,bS);
},_addAfter:function(){var bO=this._tree.getSelection()[0];
var bP=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bP.addListenerOnce(E,function(){var bN=new qx.fx.effect.core.Highlight(bP.getContainerElement().getDomElement());
bN.start();
},this);
bO.getParent().addAfter(bP,bO);
},_addBegin:function(){var bQ=this._tree.getSelection()[0];
var bR=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bR.addListenerOnce(E,function(){var n=new qx.fx.effect.core.Highlight(bR.getContainerElement().getDomElement());
n.start();
},this);
bQ.getParent().addAtBegin(bR);
},_removeTreeItem:function(){var bW=this._tree.getSelection()[0];
var parent=bW.getParent();
parent.remove(bW);
},_removeAll:function(){var bM=this._tree.getSelection()[0];
bM.removeAll();
},_moveToParent:function(){var a=this._tree.getSelection()[0];
var parent=a.getParent();
parent.remove(a);
parent.getParent().add(a);
this._updateControls();
},_onChangeShowOpen:function(){var bU=this._tree.getSelection()[0];

if(bU!=null){var bV=this.mgrShowRootOpen.getSelection()[0].getUserData(B);
bU.setOpenSymbolMode(bV);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(E,function(){this._tree.addListener(D,this._updateControls,this);
},this);
},_updateControls:function(){var l=this._tree.getSelection()[0];

if(!l){this.btnAddFolder.setEnabled(false);
...
var j=l.getLevel();
var m=j==-1;
var k=l instanceof qx.ui.tree.TreeFolder;
var g=this._tree.getNextSiblingOf(l)==null;
var h=this._tree.getPreviousSiblingOf(l)==null;
this.btnAddFolder.setEnabled(k);
this.btnAddFile.setEnabled(k);
this.btnAddBefore.setEnabled(!m);
this.btnAddAfter.setEnabled(!m);
this.btnAddBegin.setEnabled(!m);
this.btnRemove.setEnabled(!m);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(k);
this.showOpenButtons[l.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(j>0);
}},destruct:function(){this._disposeFields(bv,S,bh,M,T,G,bn,bi,bl,bf,bc,bu,bp,H,bd);
}});
})();
...
qx.Class.define(a,{extend:qx.ui.core.selection.ScrollArea,members:{_getSelectableLocationY:function(u){var v=u.getBounds();

if(v){var top=this._getWidget().getItemTop(u);
return {top:top,bottom:top+v.height};
}},_isSelectable:function(f){return f instanceof qx.ui.tree.AbstractTreeItem&&f.isEnabled()&&f.isVisible();
},_getSelectableFromMouseEvent:function(event){return this._getWidget().getTreeItem(event.getTarget());
},getSelectables:function(){var s=this._getWidget();
var t=[];

if(s.getRoot()!=null){var r=s.getRoot().getItems(true,false,s.getHideRoot());

for(var i=0;i<r.length;i++){if(this._isSelectable(r[i])){t.push(r[i]);
}}}return t;
...
switch(h){case d:k=j.getPreviousSiblingOf(g,false);
break;
case b:k=j.getNextSiblingOf(g,false);
break;
case c:if(g.isOpenable()&&g.isOpen()){g.setOpen(false);
}break;
case e:if(g.isOpenable()&&!g.isOpen()){g.setOpen(true);
}break;
}
if(!k){return null;
}
...
(function(){var C="dblclick",B="click",A="visible",z="Boolean",y="excluded",x="qx.event.type.Data",w="_applyHideRoot",v="none",u="_applyRootOpenClose",t="_applyOpenMode",n="__vs",s="changeRoot",q="changeOpenMode",m="pane",l="_applyRoot",p="qx.ui.tree.Tree",o="qx.ui.tree.AbstractTreeItem",r="tree";
qx.Class.define(p,{extend:qx.ui.core.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IModelSelection],include:[qx.ui.core.MMultiSelectionHandling,qx.ui.core.MContentPadding,qx.ui.form.MModelSelection],construct:function(){arguments.callee.base.call(this);
this.__vs=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});
this.getChildControl(m).add(this.__vs);
this.initOpenMode();
this.initRootOpenClose();
},events:{addItem:x,removeItem:x},properties:{openMode:{check:[B,C,v],init:C,apply:t,event:q,themeable:true},root:{check:o,init:null,nullable:true,event:s,apply:l},hideRoot:{check:z,init:false,apply:w},rootOpenClose:{check:z,init:false,apply:u},appearance:{refine:true,init:r},focusable:{refine:true,init:true}},members:{__vs:null,SELECTION_MANAGER:qx.ui.tree.SelectionManager,getChildrenContainer:function(){return this.__vs;
...
}i.setVisibility(this.getHideRoot()?y:A);
i.recursiveAddToWidgetQueue();
}},_applyHideRoot:function(b,c){var d=this.getRoot();

if(!d){return;
}d.setVisibility(b?y:A);
d.recursiveAddToWidgetQueue();
},_applyRootOpenClose:function(f,g){var h=this.getRoot();

if(!h){return;
}h.recursiveAddToWidgetQueue();
},_getContentPaddingTarget:function(){return this.__vs;
},getNextSiblingOf:function(M,N){if((N!==false||M.isOpen())&&M.hasChildren()){return M.getChildren()[0];
}
while(M){var parent=M.getParent();

if(!parent){return null;
}var P=parent.getChildren();
var O=P.indexOf(M);

if(O>-1&&O<P.length-1){return P[O+1];
}M=parent;
}return null;
...
}},getItems:function(E,F){if(this.getRoot()!=null){return this.getRoot().getItems(E,F,this.getHideRoot());
}else{return [];
...
},_applyOpenMode:function(Q,R){if(R==B){this.removeListener(B,this._onOpen,this);
}else if(R==C){this.removeListener(C,this._onOpen,this);
}
if(Q==B){this.addListener(B,this._onOpen,this);
}else if(Q==C){this.addListener(C,this._onOpen,this);
...
(function(){var u="open",t="auto",s="middle",r="icon",q="label",p="changeOpen",o="excluded",n="visible",m="String",k="opened",N="always",M="qx.ui.tree.AbstractTreeItem",L="addItem",K="Boolean",J="Integer",I="_applyIndent",H="changeOpenSymbolMode",G="_applyOpenSymbolMode",F="__vu",E="resize",B="",C="removeItem",z="__vt",A="abstract",x="never",y="_applyIcon",v="_applyOpen",w="__vx",D="_applyLabel";
qx.Class.define(M,{extend:qx.ui.core.Widget,type:A,include:[qx.ui.form.MModelProperty],implement:[qx.ui.form.IModel],construct:function(){arguments.callee.base.call(this);
this.__vt=[];
this._setLayout(new qx.ui.layout.HBox());
this._addWidgets();
this.initOpen();
},properties:{open:{check:K,init:false,event:p,apply:v},openSymbolMode:{check:[N,x,t],init:t,event:H,apply:G},indent:{check:J,init:19,apply:I,themeable:true},parent:{check:M,nullable:true},icon:{check:m,apply:y,nullable:true,themeable:true},label:{check:m,apply:D,init:B,dispose:true}},members:{__vt:null,__vu:null,__vv:null,__vw:null,__vx:null,_addWidgets:function(){throw new Error("Abstract method call.");
},_createChildControlImpl:function(Q){var R;

switch(Q){case q:R=new qx.ui.basic.Label().set({alignY:s,value:this.getLabel()});
break;
case r:R=new qx.ui.basic.Image().set({alignY:s,source:this.getIcon()});
break;
case u:R=new qx.ui.tree.FolderOpenButton().set({alignY:s});
R.addListener(p,this._onChangeOpen,this);
R.addListener(E,this._updateIndent,this);
break;
}return R||arguments.callee.base.call(this,Q);
},getTree:function(){var j=this;

while(j.getParent()){j=j.getParent();
}var h=j.getLayoutParent()?j.getLayoutParent().getLayoutParent():0;

if(h&&h instanceof qx.ui.core.ScrollPane){return h.getLayoutParent();
}return null;
},addWidget:function(bP,bQ){this._add(bP,bQ);
},addSpacer:function(){if(!this.__vx){this.__vx=new qx.ui.core.Spacer();
}else{this._remove(this.__vx);
}this._add(this.__vx);
},addOpenButton:function(){this._add(this.getChildControl(u));
},_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());
}},addIcon:function(){var bA=this.getChildControl(r);

if(this.__vw){this._remove(bA);
}this._add(bA);
this.__vw=true;
},addLabel:function(bp){var bq=this.getChildControl(q);

if(this.__vv){this._remove(bq);
}
if(bp){this.setLabel(bp);
}else{bq.setValue(this.getLabel());
}this._add(bq);
this.__vv=true;
...
}}},removeState:function(d){arguments.callee.base.call(this,d);
var g=this._getChildren();

for(var i=0,l=g.length;i<l;i++){var f=g[i];

if(f.addState){g[i].removeState(d);
}}},_applyIcon:function(a,b){var c=this.getChildControl(r,true);

if(c){c.setSource(a);
}},_applyLabel:function(bR,bS){var bT=this.getChildControl(q,true);

if(bT){bT.setValue(bR);
}},_applyOpen:function(bn,bo){if(this.hasChildren()){this.getChildrenContainer().setVisibility(bn?n:o);
}var open=this.getChildControl(u,true);

if(open){open.setOpen(bn);
}bn?this.addState(k):this.removeState(k);
},isOpenable:function(){var V=this.getOpenSymbolMode();
return (V===N||V===t&&this.hasChildren());
},_shouldShowOpenSymbol:function(){var open=this.getChildControl(u,true);

if(!open){return false;
}var br=this.getTree();

if(!br.getRootOpenClose()){if(br.getHideRoot()){if(br.getRoot()==this.getParent()){return false;
}}else{if(br.getRoot()==this){return false;
...
if(this.__vx){this.__vx.setWidth((this.getLevel()+1)*this.getIndent()-bm);
...
},getChildrenContainer:function(){if(!this.__vu){this.__vu=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?n:o});
}return this.__vu;
},getParentChildrenContainer:function(){if(this.getParent()){return this.getParent().getChildrenContainer();
}else if(this.getLayoutParent()){return this.getLayoutParent();
}else{return null;
}},getChildren:function(){return this.__vt;
},hasChildren:function(){return this.__vt?this.__vt.length>0:false;
},getItems:function(W,X,Y){if(Y!==false){var ba=[];
}else{var ba=[this];
}var bd=this.hasChildren()&&(X!==false||this.isOpen());

if(bd){var bc=this.getChildren();

if(W===false){ba=ba.concat(bc);
}else{for(var i=0,bb=bc.length;i<bb;i++){ba=ba.concat(bc[i].getItems(W,X,false));
}}}return ba;
},recursiveAddToWidgetQueue:function(){var bO=this.getItems(true,true,false);

for(var i=0,l=bO.length;i<l;i++){qx.ui.core.queue.Widget.add(bO[i]);
}},__vy:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);
...
bw.fireNonBubblingEvent(L,qx.event.type.Data,[bx]);
}}
if(bw){qx.ui.core.queue.Widget.add(this);
}},addAt:function(bf,bg){{};

if(bg==this.__vt.length){this.add(bf);
return;
}var bk=bf.getParent();
...
}qx.lang.Array.insertAt(this.__vt,bf,bg);
...
this.addAt(by,this.__vt.indexOf(bz));
},addAfter:function(bB,bC){{};
this.addAt(bB,this.__vt.indexOf(bC)+1);
},addAtBegin:function(be){this.addAt(be,0);
},remove:function(bK){for(var i=0,l=arguments.length;i<l;i++){var bN=arguments[i];

if(this.__vt.indexOf(bN)==-1){this.warn("Cannot remove treeitem '"+bN+"'. It is not a child of this tree item.");
return;
}var bM=this.getChildrenContainer();

if(bN.hasChildren()){bM.remove(bN.getChildrenContainer());
}qx.lang.Array.remove(this.__vt,bN);
bN.setParent(null);
bM.remove(bN);
}var bL=this.getTree();

if(bL){bL.fireNonBubblingEvent(C,qx.event.type.Data,[bN]);
}qx.ui.core.queue.Widget.add(this);
},removeAt:function(bD){var bE=this.__vt[bD];

if(bE){this.remove(bE);
}},removeAll:function(){for(var i=this.__vt.length-1;i>=0;i--){this.remove(this.__vt[i]);
}}},destruct:function(){this._disposeArray(z);
this._disposeObjects(w,F);
}});
})();
...
(function(){var r="backgroundColor",q="Boolean",p="backgroundImage",o="Color",n="__uS",m="none",l="qx.fx.effect.core.Highlight",k="#ffffff",j="#",i="#ffffaa",g="__uQ",h="__uR";
qx.Class.define(l,{extend:qx.fx.Base,properties:{startColor:{init:k,check:o},endColor:{init:i,check:o},restoreBackground:{init:true,check:q},keepBackgroundImage:{init:false,check:q}},members:{__uP:null,__uQ:null,__uR:null,__uS:null,setup:function(){arguments.callee.base.call(this);
var f=this._getElement();
this.__uP={backgroundImage:qx.bom.element.Style.get(f,p),backgroundColor:qx.bom.element.Style.get(f,r)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(f,p,m);
}this.__uQ=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__uR=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__uS=[this.__uR[0]-this.__uQ[0],this.__uR[1]-this.__uQ[1],this.__uR[2]-this.__uQ[2]];
},update:function(c){arguments.callee.base.call(this);
var d=[this.__uQ[0]+Math.round(this.__uS[0]*c),this.__uQ[1]+Math.round(this.__uS[1]*c),this.__uQ[2]+Math.round(this.__uS[2]*c)];
var e=j+qx.util.ColorUtil.rgbToHexString([d[0].toString(16),d[1].toString(16),d[2].toString(16)]);
qx.bom.element.Style.set(this._getElement(),r,e);
...
}},_restore:function(){var b=this._getElement();

for(var a in this.__uP){qx.bom.element.Style.set(b,a,this.__uP[a]);
}}},destruct:function(){this._disposeFields(g,h,n);
}});
})();
