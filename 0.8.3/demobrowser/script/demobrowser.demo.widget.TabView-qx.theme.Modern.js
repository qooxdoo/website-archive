...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.TabView", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.TabView-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var C="Page #",B="execute",A="icon/32/apps/utilities-terminal.png",z="icon/16/apps/utilities-terminal.png",y="icon/16/apps/utilities-calculator.png",x="demobrowser.demo.widget.TabView",w="bottom",v="Notes",u="Remove first page",t="Layout",S="icon/16/apps/utilities-help.png",R="Add new page",Q="changeSelection",P="Calculator...",O="icon/16/apps/utilities-notes.png",N="Bar Position",M="top",L="Calculator",K="right",J="Help",H="Help...",I="Notes...",F="Layout-Settings",G="Remove last page",D="left",E=" with close button.";
...
},getTabView1:function(){var T=new qx.ui.tabview.TabView();
T.setWidth(500);
var X=new qx.ui.tabview.Page(t,z);
X.setLayout(new qx.ui.layout.VBox());
X.add(new qx.ui.basic.Label(F));
T.add(X);
var V=new qx.ui.tabview.Page(v,O);
V.setLayout(new qx.ui.layout.VBox());
V.add(new qx.ui.basic.Label(I));
T.add(V);
var W=new qx.ui.tabview.Page(L,y);
W.setLayout(new qx.ui.layout.VBox());
W.add(new qx.ui.basic.Label(P));
T.add(W);
var U=new qx.ui.tabview.Page(J,S);
U.setLayout(new qx.ui.layout.VBox());
U.add(new qx.ui.basic.Label(H));
T.add(U);
return T;
},getTabView2:function(){var ba=new qx.ui.tabview.TabView();
ba.setWidth(500);

for(var i=1;i<=20;i++){var bb=new qx.ui.tabview.Page(C+i,z);
bb.setLayout(new qx.ui.layout.VBox());
bb.setShowCloseButton(true);
bb.add(new qx.ui.basic.Label(C+i+E));
ba.add(bb);
}return ba;
},getTabView3:function(){var j=new qx.ui.tabview.TabView();
j.setWidth(500);
j.setHeight(300);

for(var i=1;i<=3;i++){var s=new qx.ui.tabview.Page(C+i,A);
s.setLayout(new qx.ui.layout.VBox(4));
j.add(s);
s.add(new qx.ui.basic.Label(C+i));
}var l=j.getChildren()[0];
var q=new qx.ui.basic.Label(N);
var o=new qx.ui.form.RadioButton(M);
var h=new qx.ui.form.RadioButton(w);
var n=new qx.ui.form.RadioButton(D);
var p=new qx.ui.form.RadioButton(K);
l.add(new qx.ui.core.Spacer(10,10));
l.add(q);
l.add(o);
l.add(h);
l.add(n);
l.add(p);
var r=new qx.ui.form.RadioGroup(o,h,n,p);
r.addListener(Q,function(e){this.setBarPosition(e.getData()[0].getLabel());
},j);
n.setValue(true);
var k=new qx.ui.form.Button(R);
var m=new qx.ui.form.Button(u);
var g=new qx.ui.form.Button(G);
l.add(new qx.ui.core.Spacer(10,10));
l.add(k);
l.add(m);
l.add(g);
k.addListener(B,function(e){var a=j.getChildren().length+1;
var b=new qx.ui.tabview.Page(C+a,A);
j.add(b);
});
m.addListener(B,function(e){var c=j.getChildren();

if(c.length>0){j.remove(c[0]);
}});
g.addListener(B,function(e){var Y=j.getChildren();

if(Y.length>0){j.remove(Y[Y.length-1]);
}});
return j;
}}});
})();
