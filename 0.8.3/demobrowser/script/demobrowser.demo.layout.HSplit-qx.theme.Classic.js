...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HSplit", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.HSplit-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var v="horizontal",u="main",t="Flex:1",s="Flex:1; Min:250",r="Auto",q="Flex:2",p="Flex:0",o="Flex:2; Max:100",n="Flex:1; Max:100",m="Flex:1; Max:200",j="Flex:2; Min:250",l="Flex:0; Min:350",k="demobrowser.demo.layout.HSplit";
...
},addSplitPaneTwoFlexSimple:function(){var G=new qx.ui.splitpane.Pane(v);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(u);
this.getRoot().add(G,{left:20,top:20});
var F=new qx.ui.form.TextArea(t);
F.setDecorator(null);
F.setWrap(true);
G.add(F,1);
var H=new qx.ui.form.TextArea(q);
H.setDecorator(null);
H.setWrap(true);
G.add(H,2);
},addSplitPaneTwoFlexWithOneMin:function(){var D=new qx.ui.splitpane.Pane(v);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(u);
this.getRoot().add(D,{left:20,top:100});
var C=new qx.ui.form.TextArea(s);
C.setDecorator(null);
C.setWrap(true);
C.setMinWidth(250);
D.add(C,1);
var E=new qx.ui.form.TextArea(q);
E.setDecorator(null);
E.setWrap(true);
D.add(E,2);
},addSplitPaneTwoFlexWithOneMax:function(){var h=new qx.ui.splitpane.Pane(v);
h.setWidth(400);
h.setHeight(60);
h.setDecorator(u);
this.getRoot().add(h,{left:20,top:180});
var g=new qx.ui.form.TextArea(t);
g.setDecorator(null);
g.setWrap(true);
h.add(g,1);
...
i.setMaxWidth(100);
h.add(i,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var e=new qx.ui.splitpane.Pane(v);
e.setWidth(400);
e.setHeight(60);
e.setDecorator(u);
this.getRoot().add(e,{left:20,top:260});
var d=new qx.ui.form.TextArea(s);
d.setDecorator(null);
d.setWrap(true);
d.setMinWidth(250);
e.add(d,1);
var f=new qx.ui.form.TextArea(j);
f.setDecorator(null);
f.setWrap(true);
f.setMinWidth(250);
e.add(f,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var b=new qx.ui.splitpane.Pane(v);
b.setWidth(400);
b.setHeight(60);
b.setDecorator(u);
this.getRoot().add(b,{left:20,top:340});
var a=new qx.ui.form.TextArea(n);
a.setDecorator(null);
a.setWrap(true);
a.setMaxWidth(100);
b.add(a,1);
var c=new qx.ui.form.TextArea(o);
c.setDecorator(null);
c.setWrap(true);
c.setMaxWidth(100);
b.add(c,2);
},addSplitPaneOneFlexSimple:function(){var M=new qx.ui.splitpane.Pane(v);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(u);
this.getRoot().add(M,{left:500,top:20});
var L=new qx.ui.form.TextArea(p);
L.setDecorator(null);
L.setWrap(true);
M.add(L,0);
var N=new qx.ui.form.TextArea(t);
N.setDecorator(null);
N.setWrap(true);
M.add(N);
},addSplitPaneOneFlexSimpleWithMax:function(){var A=new qx.ui.splitpane.Pane(v);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(u);
this.getRoot().add(A,{left:500,top:100});
var z=new qx.ui.form.TextArea(p);
z.setDecorator(null);
z.setWrap(true);
A.add(z,0);
var B=new qx.ui.form.TextArea(m);
B.setDecorator(null);
B.setWrap(true);
B.setMaxWidth(200);
A.add(B);
},addSplitPaneOneFlexSimpleWithMin:function(){var J=new qx.ui.splitpane.Pane(v);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(u);
this.getRoot().add(J,{left:500,top:180});
var I=new qx.ui.form.TextArea(l);
I.setDecorator(null);
I.setWrap(true);
I.setMinWidth(350);
J.add(I,0);
var K=new qx.ui.form.TextArea(t);
K.setDecorator(null);
K.setWrap(true);
J.add(K);
},addSplitPaneAuto:function(){var x=new qx.ui.splitpane.Pane(v);
x.setDecorator(u);
this.getRoot().add(x,{left:500,top:340});
var w=new qx.ui.form.TextArea(r);
w.setDecorator(null);
w.setWrap(true);
x.add(w,0);
var y=new qx.ui.form.TextArea(r);
y.setDecorator(null);
y.setWrap(true);
x.add(y);
}}});
...
(function(){var R="splitter",Q="slider",P="mousedown",O="mouseout",N="mousemove",M="mouseup",L="losecapture",K="active",J="horizontal",I="vertical",bj="knob",bi="Integer",bh="height",bg="__wB",bf="row-resize",be="move",bd="maxHeight",bc="width",bb="_applyOrientation",ba="mouseover",X="splitpane",Y="qx.ui.splitpane.Pane",V="_applyOffset",W="minHeight",T="minWidth",U="col-resize",S="maxWidth";
qx.Class.define(Y,{extend:qx.ui.core.Widget,construct:function(bx){arguments.callee.base.call(this);
this.__wB=[];
if(bx){this.setOrientation(bx);
}else{this.initOrientation();
}this.addListener(P,this._onMouseDown);
this.addListener(M,this._onMouseUp);
this.addListener(N,this._onMouseMove);
this.addListener(O,this._onMouseOut);
this.addListener(L,this._onMouseUp);
},properties:{appearance:{refine:true,init:X},offset:{check:bi,init:6,apply:V},orientation:{init:J,check:[J,I],apply:bb}},members:{__wC:null,__wD:false,__wE:null,__wF:null,__wG:null,__wH:null,__wI:null,__wB:null,_createChildControlImpl:function(t){var u;

switch(t){case Q:u=new qx.ui.splitpane.Slider(this);
u.exclude();
this._add(u,{type:t});
break;
case R:u=new qx.ui.splitpane.Splitter(this);
this._add(u,{type:t});
u.addListener(be,this._onSplitterMove,this);
if(qx.bom.client.Engine.OPERA){u.addListener(ba,this._onSplitterMouseOver,u);
}break;
}return u||arguments.callee.base.call(this,t);
},_applyOrientation:function(f,g){var h=this.getChildControl(Q);
var k=this.getChildControl(R);
this.__wG=f===J;
var j=this._getLayout();

if(j){j.dispose();
}var i=f===I?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;
this._setLayout(i);
k.removeState(g);
k.addState(f);
k.getChildControl(bj).removeState(g);
k.getChildControl(bj).addState(f);
h.removeState(g);
h.addState(f);
},_applyOffset:function(F,G){var H=this.getChildControl(R);

if(G===0){H.removeListener(P,this._onMouseDown,this);
H.removeListener(N,this._onMouseMove,this);
H.removeListener(O,this._onMouseOut,this);
H.removeListener(M,this._onMouseUp,this);
H.removeListener(L,this._onMouseUp,this);
this.addListener(P,this._onMouseDown);
this.addListener(M,this._onMouseUp);
this.addListener(N,this._onMouseMove);
this.addListener(O,this._onMouseOut);
...
if(F===0){this.removeListener(P,this._onMouseDown);
this.removeListener(M,this._onMouseUp);
this.removeListener(N,this._onMouseMove);
this.removeListener(O,this._onMouseOut);
this.removeListener(L,this._onMouseUp);
H.addListener(P,this._onMouseDown,this);
H.addListener(N,this._onMouseMove,this);
H.addListener(O,this._onMouseOut,this);
H.addListener(M,this._onMouseUp,this);
H.addListener(L,this._onMouseUp,this);
}},add:function(a,b){if(b==null){this._add(a);
}else{this._add(a,{flex:b});
}this.__wB.push(a);
},remove:function(s){this._remove(s);
qx.lang.Array.remove(this.__wB,s);
},getChildren:function(){return this.__wB;
...
this.__wC=this.__wG?e.getDocumentLeft()-bt.left+bs.left:e.getDocumentTop()-bt.top+bs.top;
var bv=this.getChildControl(Q);
var bu=br.getBounds();
...
},_onMouseMove:function(e){this.__wE=e.getDocumentLeft();
this.__wF=e.getDocumentTop();
if(this.__wD){this.__wK();
var c=this.getChildControl(Q);
var d=this.__wH;

if(this.__wG){c.setDomLeft(d);
}else{c.setDomTop(d);
}}else{this.__wJ();
}},_onMouseOut:function(e){this.__wE=-1;
this.__wF=-1;
this.__wJ();
},_onMouseUp:function(e){if(!this.__wD){return;
}this._finalizeSizes();
var bw=this.getChildControl(Q);
bw.exclude();
this.__wD=false;
this.releaseCapture();
this.__wJ();
},_onSplitterMove:function(){this.__wJ();
},_onSplitterMouseOver:function(){this.addState(K);
},_finalizeSizes:function(){var o=this.__wH;
var l=this.__wI;
...
}else{if(this.__wG){p.setWidth(o);
m.setWidth(l);
}else{p.setHeight(o);
m.setHeight(l);
}}},_isNear:function(){var bk=this.getChildControl(R);
var bm=bk.getBounds();
var bo=bk.getContainerLocation();
var bl=this.getOffset();
if(!bo){return;
}var bp=this.__wE;
var bq=bm.width;
var bn=bo.left;

if(bq<bl){bn-=Math.floor((bl-bq)/2);
bq=bl;
}
if(bp<bn||bp>(bn+bq)){return false;
}var bp=this.__wF;
var bq=bm.height;
var bn=bo.top;
...
},__wJ:function(){var bz=this.getChildControl(R);
var bA=this.getApplicationRoot();
if(this.__wD||this._isNear()){var by=this.__wG?U:bf;
this.setCursor(by);
bA.setGlobalCursor(by);
bz.addState(K);
}else if(bz.hasState(K)){this.resetCursor();
bA.resetGlobalCursor();
bz.removeState(K);
}},__wK:function(){if(this.__wG){var x=T,E=bc,y=S,C=this.__wE;
}else{var x=W,E=bh,y=bd,C=this.__wF;
}var D=this._getChildren();
var v=D[2].getSizeHint();
var A=D[3].getSizeHint();
var B=D[2].getBounds()[E]+D[3].getBounds()[E];
var z=C-this.__wC;
var w=B-z;
if(z<v[x]){w-=v[x]-z;
z=v[x];
}else if(w<A[x]){z-=A[x]-w;
w=A[x];
}if(z>v[y]){w+=z-v[y];
z=v[y];
}else if(w>A[y]){z+=w-A[y];
w=A[y];
}this.__wH=z;
this.__wI=w;
},_isActiveDragSession:function(){return this.__wD;
}},destruct:function(){this._disposeFields(bg);
}});
})();
