...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_Flex", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.VBox_Flex-qx.theme.Classic-0.js"]],
  boot : "boot",
...
b.add(this.getBox5());
b.add(this.getBox6());
},getBox1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:f,backgroundColor:d,height:300,allowGrowY:false});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:3});
return h;
},getBox2:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:f,backgroundColor:d,height:300,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxHeight:30}),{flex:1});
a.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:2});
a.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxHeight:100}),{flex:3});
return a;
},getBox3:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:f,backgroundColor:d,height:300,allowGrowY:false});

for(var i=0;i<25;i++){j.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,height:5}),{flex:1});
}return j;
},getBox4:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:f,backgroundColor:d,height:300,minHeight:300,allowGrowY:false});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxHeight:60}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxHeight:60}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxHeight:60}),{flex:3});
return g;
},getBox5:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,minHeight:0,decorator:f,backgroundColor:d,allowGrowY:false});
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minHeight:60}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minHeight:60}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minHeight:60}),{flex:3});
return l;
},getBox6:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:f,backgroundColor:d,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minHeight:60}),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minHeight:60}),{flex:2});
k.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minHeight:60}),{flex:3});
return k;
}}});
})();
