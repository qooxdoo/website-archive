...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.ScrollBar-qx.theme.Classic-0.js"]],
  boot : "boot",
...
var i=new qx.ui.core.ScrollBar(a).set({height:200,maximum:500});
i.addListener(f,function(e){g.setPosition(e.getData());
});
h.add(i,{row:0,column:1});
var g=new qx.ui.core.ScrollBar(c).set({width:300,maximum:500});
