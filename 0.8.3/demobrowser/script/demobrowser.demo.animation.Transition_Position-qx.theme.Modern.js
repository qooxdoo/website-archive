...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Transition_Position", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.animation.Transition_Position-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var u="Name",t="Wobble will bounce the element forwards and backwards.",s="EaseInQuad will accelerate exponentially.",r="finish",q="Description",p="changeSelection",o="Linear is the default transition for many effects.",n="demobrowser.demo.animation.Transition_Position",m="execute",l="appear",f="Duration",k="Spring will overshoot the target and then move back.",i="Show it!",d="EaseOutQuad will slow down exponentially.",c="test",h="Sinodial transition will accelerate sinusoidal.",g="Reverse behaves like linear, but in the opposite direction.",j='<span style="color:white;">Welcome to <br><b style="color:#F3FFB3;">qooxdoo</b> animations!</span>',b="absolute";
...
H.setCssClass(c);
x.add(H);
var E={linear:o,easeInQuad:s,easeOutQuad:d,sinodial:h,reverse:g,wobble:t,spring:k};
var v=new qx.ui.form.SelectBox();
var G=new qx.ui.form.Button(i);
var z=new qx.ui.basic.Label(u);
var A=new qx.ui.basic.Label(q);
var F=new qx.ui.basic.Label(f);
var A=new qx.ui.basic.Label(E.linear);
var B=new qx.ui.form.Spinner;

for(var y in E){v.add(new qx.ui.form.ListItem(y));
}v.addListener(p,function(e){A.setValue(E[A.setValue(e.getData()[0].getLabel())]);
});
B.set({maximum:10.0,minimum:0.1,value:1.0});
var w;
var D=false;
H.addListenerOnce(l,function(){w=new qx.fx.effect.core.Move(H.getContentElement().getDomElement());
w.set({x:600,y:300,mode:b});
w.addListener(r,function(){w.set({x:D?90:600,y:D?90:300});
D=!D;
});
},this);
...
B.setNumberFormat(C);
G.addListener(m,function(){var a=v.getSelection()[0].getLabel();
w.set({transition:a,duration:B.getValue()});
w.start();
});
