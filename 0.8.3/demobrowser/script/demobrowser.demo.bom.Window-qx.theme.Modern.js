...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Window", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.Window-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var k="click",j="button",i="Open Native Window",h="demobrowser.demo.bom.Window",g="http://sourceforge.net",f="window1",d="http://slashdot.org",c="Window closed?",b="http://qooxdoo.org",a="__xx";
qx.Class.define(h,{extend:qx.application.Native,members:{__xx:null,main:function(){arguments.callee.base.call(this);
this.__xx=[b,g,d];
var m=qx.bom.Input.create(j);
qx.bom.Input.setValue(m,i);
document.body.appendChild(m);
qx.event.Registration.addListener(m,k,function(e){var n={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};
this.window1=qx.bom.Window.open(this.__xx[0],f,n);
},this);
var l=qx.bom.Input.create(j);
qx.bom.Input.setValue(l,c);
document.body.appendChild(l);
qx.event.Registration.addListener(l,k,function(e){alert(qx.bom.Window.isClosed(this.window1));
},this);
...
(function(){var m="=",l="no",k="qx.bom.Window",j="javascript:/",i="yes",h="qxNativeWindow",g=",";
qx.Class.define(k,{statics:{__xy:{top:1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},open:function(p,name,q){if(p==null){p=j;
}
...
for(var r in q){if(u[r]){if(t.isBoolean(q[r])){v=r+m+(q[r]?i:l);
}else{v=r+m+q[r];
}s.push(v);
}else{qx.log.Logger.warn("Option '"+r+"' is not supported for native windows.");
}}return window.open(p,name,s.join(g));
},close:function(f){if(f){return f.close();
}},isClosed:function(n){var closed=true;

if(n){try{closed=n.closed;
}catch(o){}}return closed;
},moveTo:function(a,top,b){if(!qx.bom.Window.isClosed(a)){try{a.moveTo(b,top);
}catch(w){qx.log.Logger.error("Cross-Domain Scripting problem: Could not move window!",w);
