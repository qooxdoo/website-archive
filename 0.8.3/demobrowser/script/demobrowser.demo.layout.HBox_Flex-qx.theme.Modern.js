...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HBox_Flex", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.HBox_Flex-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var e="main",d="green",c="yellow",b="demobrowser.demo.layout.HBox_Flex";
...
var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(a);
a.add(this.getBox1());
a.add(this.getBox2());
a.add(this.getBox3());
...
a.add(this.getBox5());
a.add(this.getBox6());
},getBox1:function(){var o=new qx.ui.layout.HBox();
var p=new qx.ui.container.Composite(o).set({width:500,decorator:e,backgroundColor:c,allowGrowX:false});
o.setSpacing(5);
p.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:1});
p.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
p.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:3});
return p;
},getBox2:function(){var h=new qx.ui.layout.HBox();
var j=new qx.ui.container.Composite(h).set({width:500,decorator:e,backgroundColor:c,allowGrowX:false});
h.setSpacing(5);
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxWidth:30}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxWidth:150}),{flex:3});
return j;
},getBox3:function(){var q=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(q).set({width:500,decorator:e,backgroundColor:c,allowGrowX:false});
q.setSpacing(5);

for(var i=0;i<25;i++){var r=new qx.ui.core.Widget();
r.set({decorator:e,backgroundColor:d,width:5});
s.add(r,{flex:1});
}return s;
},getBox4:function(){var m=new qx.ui.layout.HBox();
var n=new qx.ui.container.Composite(m).set({width:600,minWidth:600,decorator:e,backgroundColor:c,allowGrowX:false});
m.setSpacing(5);
n.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxWidth:120}),{flex:1});
n.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxWidth:120}),{flex:2});
n.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxWidth:120}),{flex:3});
return n;
},getBox5:function(){var f=new qx.ui.layout.HBox();
var g=new qx.ui.container.Composite(f).set({width:300,minWidth:0,decorator:e,backgroundColor:c,allowGrowX:false});
f.setSpacing(5);
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minWidth:120}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minWidth:120}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minWidth:120}),{flex:3});
return g;
},getBox6:function(){var k=new qx.ui.layout.HBox();
var l=new qx.ui.container.Composite(k).set({width:300,decorator:e,backgroundColor:c,allowGrowX:false});
k.setSpacing(5);
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minWidth:120}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minWidth:120}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minWidth:120}),{flex:3});
return l;
}}});
})();
