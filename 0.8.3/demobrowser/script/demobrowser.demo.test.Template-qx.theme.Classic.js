...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Template", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Template-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var b="demobrowser.demo.test.Template",a="Hello {name}";
qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var c=new qx.util.Template;
c.setContent(a);
this.debug(c.run({name:"Jonny"}));
}}});
})();
...
(function(){var l="values",k="_applyContent",j="),'",i="',(values.",h="qx.util.Template",g=" === undefined ? '' : values.",f="return ['",e="String",d="'].join('')";
qx.Class.define(h,{extend:qx.core.Object,construct:function(content){arguments.callee.base.call(this);

if(content!=null){this.setContent(content);
}},properties:{content:{check:e,nullable:true,apply:k}},members:{_applyContent:function(b,c){this.run=new Function(l,f+b.replace(this.__oN,this.__oM)+d);
},run:function(a){throw new Error("Please define any content first!");
},__oM:function(m,name){return i+name+g+name+j;
},__oN:/\{([\w-]+)}/g}});
})();
