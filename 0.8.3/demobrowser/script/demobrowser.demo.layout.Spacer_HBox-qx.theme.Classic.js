...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Spacer_HBox-qx.theme.Classic-0.js"]],
  boot : "boot",
...
return n;
},getAddRemoveSpacer:function(){var k=new qx.ui.container.Composite().set({decorator:g,backgroundColor:e});
...
var l=new qx.ui.core.Spacer(30,40);
k.add(l,{flex:1});
