...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Blocker", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.Blocker-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var n="300px",m="100px",l="absolute",k="click",j="button",i="Block Document for 5s",h="demobrowser.demo.bom.Blocker",g="red",f="Block Element for 5s",d="200px",a="div",c="orange",b="150px";
qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var p=qx.bom.Input.create(j,{value:i});
qx.bom.element.Style.setStyles(p,{position:l,left:m,top:m});
var r=new qx.bom.Blocker;
r.setBlockerOpacity(0.5);
qx.event.Registration.addListener(p,k,function(e){r.setBlockerColor(g);
r.block();
qx.event.Timer.once(function(e){r.unblock();
},window,5000);
});
qx.dom.Element.insertEnd(p,document.body);
var o=qx.bom.Input.create(j,{value:f});
qx.bom.element.Style.setStyles(o,{position:l,left:n,top:m});
var q=qx.bom.Element.create(a);
qx.bom.element.Style.setStyles(q,{position:l,left:n,top:b,width:n,height:d,backgroundColor:c,zIndex:500});
qx.dom.Element.insertBegin(q,document.body);
qx.event.Registration.addListener(o,k,function(e){r.block(q);
qx.event.Timer.once(function(e){r.unblock();
},window,5000);
});
qx.dom.Element.insertEnd(o,document.body);
}}});
})();
...
(function(){var A="mshtml",z="qx.client",y="px",x="0px",w="backgroundColor",v="block",u="zIndex",t="100%",s="absolute",r="resize",k="repeat",q="transparent",n="url(",j="src",i=")",m="allowTransparency",l="div",o="javascript:false;",h="qx/static/blank.gif",p="qx.bom.Blocker";
qx.Class.define(p,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__xK();
},members:{__xD:null,__xE:null,__xF:null,__xG:false,__xH:10000,__xI:0,__xJ:q,block:function(f){if(!this.__xG){this.__xF=f;
var g=this.__xN();
this.__xO(g);
this.__xG=true;
}},unblock:function(){if(this.__xG){this.__xP();
this.__xG=false;
}},isBlocked:function(){return this.__xG;
},getBlockerElement:function(){return this.__xE;
},setBlockerColor:function(B){qx.bom.element.Style.set(this.__xE,w,B);
},getBlockerColor:function(){return qx.bom.element.Style.get(this.__xE,w);
},setBlockerOpacity:function(d){qx.bom.element.Opacity.set(this.__xE,d);
},getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__xE);
},setBlockerZIndex:function(c){qx.bom.element.Style.set(this.__xE,u,c);
},getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__xE,u);
},__xK:function(){this.__xL();

if(qx.core.Variant.isSet(z,A)){this.__xM();
}qx.event.Registration.addListener(window,r,this.__xQ,this);
},__xL:function(){this.__xE=qx.bom.Element.create(l);
qx.bom.element.Style.setStyles(this.__xE,{display:v,opacity:this.__xI,backgroundColor:this.__xJ});
this.setBlockerZIndex(this.__xH);
if(qx.core.Variant.isSet(z,A)){qx.bom.element.Style.setStyles(this.__xE,{backgroundImage:n+qx.util.ResourceManager.getInstance().toUri(h)+i,backgroundRepeat:k});
}},__xM:function(){this.__xD=qx.bom.Iframe.create();
qx.bom.element.Attribute.set(this.__xD,m,false);
qx.bom.element.Attribute.set(this.__xD,j,o);
qx.bom.element.Style.setStyles(this.__xD,{display:v,opacity:this.__xI});
},__xN:function(){var C={position:s};

if(this.__xS()){C.left=x;
C.top=x;
C.right=null;
C.bottom=null;
C.width=qx.bom.Document.getWidth()+y;
C.height=qx.bom.Document.getHeight()+y;
}else{C.position=s;
C.width=t;
C.height=t;
}return C;
},__xO:function(a){var b;

if(this.__xS()){b=document.body;
}else{b=this.__xF;
}qx.bom.element.Style.setStyles(this.__xE,a);
qx.dom.Element.insertBegin(this.__xE,b);

if(qx.core.Variant.isSet(z,A)){a.zIndex=this.getBlockerZIndex()-1;
qx.bom.element.Style.setStyles(this.__xD,a);
qx.dom.Element.insertBegin(this.__xD,b);
}},__xP:function(){qx.dom.Element.remove(this.__xE);

if(qx.core.Variant.isSet(z,A)){qx.dom.Element.remove(this.__xD);
}},__xQ:function(e){if(this.__xS()){this.__xR({width:x,height:x});
qx.event.Timer.once(function(){var D={width:qx.bom.Document.getWidth()+y,height:qx.bom.Document.getHeight()+y};
this.__xR(D);
},this,0);
}},__xR:function(E){qx.bom.element.Style.setStyles(this.__xE,E);

if(qx.core.Variant.isSet(z,A)){qx.bom.element.Style.setStyles(this.__xD,E);
}},__xS:function(){return (this.__xF==null||qx.dom.Node.isWindow(this.__xF)||qx.dom.Node.isDocument(this.__xF));
}}});
})();
