...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.CellEvents", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.virtual.CellEvents-qx.theme.Classic-0.js"]],
  boot : "boot",
...
var q=r.getPane();
q.addListener(j,this._onCellClick,this);
q.addListener(d,this._onContextMenu,this);
q.addListener(b,this._onDblclickPane,this);
...
this.__tw(a);
},_onContextMenu:function(e){var p=i+e.getRow()+n+e.getColumn()+o;
this.__tw(p);
},_onDblclickPane:function(e){var s=h+e.getRow()+n+e.getColumn()+o;
this.__tw(s);
},__tw:function(t){this.logger.setHtml(this.logger.getHtml()+t);
