...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.AttributeStyle_1-qx.theme.Modern-0.js"]],
  boot : "boot",
...
var g=qx.bom.element.Visibility;
var h=qx.bom.element.Attribute;
var i=qx.bom.element.Style;
var j=qx.bom.element.Opacity;
this.info("test1");
this.debug("classname: "+h.get(document.getElementById("test1"),"class"));
this.debug("title: "+h.get(document.getElementById("test1"),"title"));
this.debug("top: "+i.get(document.getElementById("test1"),"top"));
this.info("test2");
this.debug("name: "+h.get(document.getElementById("test2"),"name"));
this.debug("value: "+h.get(document.getElementById("test2"),"value"));
this.debug("type: "+h.get(document.getElementById("test2"),"type"));
this.debug("max: "+h.get(document.getElementById("test2"),"maxlength"));
this.debug("left: "+i.get(document.getElementById("test2"),"left"));
this.info("test3");
this.debug("name: "+h.get(document.getElementById("test3"),"name"));
this.debug("value: "+h.get(document.getElementById("test3"),"value"));
this.debug("type: "+h.get(document.getElementById("test3"),"type"));
this.debug("checked: "+h.get(document.getElementById("test3"),"checked"));
this.debug("disabled: "+h.get(document.getElementById("test3"),"disabled"));
this.debug("tabindex: "+h.get(document.getElementById("test3"),"tabindex"));
this.info("test4");
this.debug("disabled: "+h.get(document.getElementById("test4"),"disabled"));
this.debug("readonly: "+h.get(document.getElementById("test4"),"readonly"));
this.info("test5");
this.debug("disabled: "+h.get(document.getElementById("test5"),"disabled"));
this.debug("readonly: "+h.get(document.getElementById("test5"),"readonly"));
this.info("test6");
this.debug("href: "+h.get(document.getElementById("test6"),"href"));
this.debug("style: "+h.get(document.getElementById("test6"),"style"));
this.debug("css: "+i.getCss(document.getElementById("test6")));
this.debug("color: "+i.get(document.getElementById("test6"),"color"));
this.debug("bg: "+i.get(document.getElementById("test6"),"backgroundColor"));
this.debug("family: "+i.get(document.getElementById("test6"),"fontFamily"));
this.debug("text: "+h.get(document.getElementById("test6"),"text"));
this.debug("html: "+h.get(document.getElementById("test6"),"html"));
this.debug("opacity: "+j.get(document.getElementById("test6")));
this.info("test7");
this.debug("valign: "+h.get(document.getElementById("test7"),"valign"));
this.debug("colspan: "+h.get(document.getElementById("test7").getElementsByTagName("td")[0],"colspan"));
this.info("test8");
i.set(document.getElementById(f),a,c);
i.set(document.getElementById(f),e,d);
j.set(document.getElementById(f),0.5);
this.debug("opacity: "+j.get(document.getElementById("test8")));
this.info("test9");
