...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.VBox-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var u="main",t="green",s="yellow",r="middle",q="bottom",p="demobrowser.demo.layout.VBox",o="center",n="left",m="right";
...
B.add(this.getBox6());
B.add(this.getBox7());
},getBox1:function(){var e=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:u,backgroundColor:s,allowGrowY:false});
e.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
e.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
e.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
return e;
},getBox2:function(){var v=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:u,backgroundColor:s,minWidth:60,allowGrowY:false});
v.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,maxWidth:40,alignX:n}));
v.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,maxWidth:40,alignX:o}));
v.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,maxWidth:40,alignX:m}));
return v;
},getBox3:function(){var k=new qx.ui.layout.VBox();
var l=new qx.ui.container.Composite(k).set({decorator:u,backgroundColor:s,height:300,allowGrowY:false});
k.setSpacing(5);
k.setAlignY(q);
l.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
l.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
l.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
return l;
},getBox4:function(){var C=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(C).set({decorator:u,backgroundColor:s,height:300,allowGrowY:false});
C.setSpacing(5);
C.setAlignY(r);
D.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
D.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
D.add(new qx.ui.core.Widget().set({decorator:u,backgroundColor:t}));
return D;
},getBox5:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:u,backgroundColor:s,allowGrowY:false});
var d=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10});
var c=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10,marginTop:20});
var a=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10});
b.add(d);
b.add(c);
b.add(a);
return b;
},getBox6:function(){var w=new qx.ui.layout.VBox();
var y=new qx.ui.container.Composite(w).set({decorator:u,backgroundColor:s,height:300,allowGrowY:false});
w.setSpacing(5);
w.setAlignY(q);
var A=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10});
var z=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10,marginTop:20});
var x=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10});
y.add(A);
y.add(z);
y.add(x);
return y;
},getBox7:function(){var f=new qx.ui.layout.VBox();
var h=new qx.ui.container.Composite(f).set({decorator:u,backgroundColor:s,height:300,allowGrowY:false});
f.setSpacing(5);
f.setAlignY(r);
var j=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10});
var i=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10,marginTop:20});
var g=new qx.ui.core.Widget().set({decorator:u,backgroundColor:t,marginBottom:10});
h.add(j);
h.add(i);
h.add(g);
return h;
