...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.UIDeclaration", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.UIDeclaration-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var w="Item",v="Button",u="Header",t="Last Name",s="Page 1",r="First Name",q="firstname",p="Email",o="Demo loaded",n="icon/16/apps/office-calendar.png",K="Page 3",J="move",I="First Window",H="Simple Form",G="Page 2",F="resize",E="Date",D="win",C="Cancel",B="icon/32/apps/office-address-book.png",z="Welcome to your first own Window.<br/>Have fun!",A="Save",x="demobrowser.demo.test.UIDeclaration",y="Company";
qx.Class.define(x,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var N={clazz:qx.ui.form.Form,children:[{type:u,label:H},{type:w,label:r,validator:null,name:q,widget:{clazz:qx.ui.form.TextField,required:true,width:200}},{type:w,label:t,widget:{clazz:qx.ui.form.TextField}},{type:w,label:y,widget:{clazz:qx.ui.form.TextField}},{type:w,label:p,widget:{clazz:qx.ui.form.TextField}},{type:w,label:E,widget:{clazz:qx.ui.form.DateField}},{type:v,widget:{clazz:qx.ui.form.Button,label:A}},{type:v,widget:{clazz:qx.ui.form.Button,label:C}}]};
var O={clazz:qx.ui.window.Window,layout:{clazz:qx.ui.layout.VBox,spacing:10},layoutProperties:{left:20,top:20},showStatusbar:true,status:o,caption:I,icon:n,id:D,listeners:[{event:J,handler:function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
}},{event:F,handler:function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
}}],children:[{clazz:qx.ui.basic.Atom,label:z,icon:B,rich:true},{clazz:qx.ui.tabview.TabView,layoutProperties:{flex:1},children:[{clazz:qx.ui.tabview.Page,label:s,layoutProperties:{flex:1},layout:{clazz:qx.ui.layout.Canvas},children:[N]},{clazz:qx.ui.tabview.Page,label:G,layoutProperties:{flex:1}},{clazz:qx.ui.tabview.Page,label:K,layoutProperties:{flex:1}}]}]};
this.addFromDefinition(O);
this.win.open();
},addFromDefinition:function(L){var M=this.getRoot();
this.__mi(M,L);
},__mi:function(a,b){var c=new b.clazz();
var h=qx.lang.Object.clone(b);
delete h.clazz;
delete h.layout;
delete h.children;
delete h.id;
...
var h=qx.lang.Object.clone(b.layout);
delete h.clazz;
d.set(h);
c.setLayout(d);
}var g=b.children;

if(g!=null){for(var i=0;i<g.length;i++){if(c instanceof qx.ui.form.Form){this.__mj(c,g[i]);
}else{this.__mi(c,g[i]);
}}}if(c instanceof qx.ui.form.Form){a.add(c.createView());
}else{a.add(c,b.layoutProperties);
}if(b.listeners){for(var i=0;i<b.listeners.length;i++){var f=b.listeners[i];
c.addListener(f.event,f.handler,f.context);
}}},__mj:function(j,k){if(k.type===u){j.addGroupHeader(k.label);
return;
...
if(k.type===w){j.add(l,k.label,k.validator,k.name);
}else if(k.type===v){j.addButton(l);
}}}});
})();
