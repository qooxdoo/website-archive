...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Decorator_Box", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Decorator_Box-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var z="px",y="no-repeat",x="-c",w="-l",v="horizontal",u="",t="qx.ui.decoration.AbstractBox",s='<div style="position:absolute;top:0;left:0;overflow:hidden;font-size:0;line-height:0;">',r="__oB",q="__oA",j='</div>',p="__oz",m="_applyBaseImage",h="-b",g="-t",l="__insets",k="repeat-x",n="repeat-y",f="abstract",o="String",i="-r";
qx.Class.define(t,{extend:qx.ui.decoration.Abstract,type:f,construct:function(d,e){arguments.callee.base.call(this);
if(d!=null){this.setBaseImage(d);
}
if(e!=null){this.setInsets(e);
}},properties:{baseImage:{check:o,nullable:true,apply:m}},members:{__oz:null,__oA:null,__oB:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__oz;
},_setOrientation:function(c){this._isHorizontal=c==v;
...
if(this._isHorizontal){M.push(J.create(K.l,y,{top:0,left:0}));
M.push(J.create(K.c,k,{top:0,left:L.left+z}));
M.push(J.create(K.r,y,{top:0,right:0}));
}else{M.push(J.create(K.t,y,{top:0,left:0}));
M.push(J.create(K.c,n,{top:L.top+z,left:L.left+z}));
M.push(J.create(K.b,y,{bottom:0,left:0}));
}M.push(j);
return this.__oz=M.join(u);
},resize:function(N,O,P){N.style.width=O+z;
N.style.height=P+z;
var Q=this.__oB;

if(this._isHorizontal){var innerWidth=O-Q.left-Q.right;
N.childNodes[1].style.width=innerWidth+z;
}else{var innerHeight=P-Q.top-Q.bottom;
N.childNodes[1].style.height=innerHeight+z;
}},tint:function(a,b){},_applyBaseImage:function(A,B){{};
...
var F=H[1];
var D=H[2];
var I=this.__oA={t:F+g+D,b:F+h+D,c:F+x+D,l:F+w+D,r:F+i+D};
this.__oB={top:C.getImageHeight(I.t),bottom:C.getImageHeight(I.b),left:C.getImageWidth(I.l),right:C.getImageWidth(I.r)};
}}},destruct:function(){this._disposeFields(p,l,q,r);
}});
})();
