...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.legacy.EmbedFuture_Dialog-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var a="qx.legacy.application.MGuiCompat";
qx.Mixin.define(a,{members:{compat:function(){if(this.__qB){return;
}this.__qB=true;
...
this.__qC=new qx.legacy.io.image.PreloaderSystem(qx.legacy.io.image.Manager.getInstance().getVisibleImages(),this._preloaderDone,this);
this.__qC.start();
...
this.info("render runtime: "+(new Date-b)+"ms");
...
this.__qD=new qx.legacy.io.image.PreloaderSystem(qx.legacy.io.image.Manager.getInstance().getHiddenImages(),this._postloaderDone,this);
this.__qD.start();
},_postloaderDone:function(){this.__qD.dispose();
this.__qD=null;
}}});
})();
(function(){var c="qx.legacy.application.Gui",b="__qE";
qx.Class.define(c,{extend:qx.core.Object,implement:[qx.application.IApplication],include:[qx.legacy.application.MGuiCompat],members:{main:function(){this.compat();
},finalize:function(){},terminate:function(){},close:function(a){},getRoot:function(){if(!this.__qE){this.__qE=new qx.ui.root.Page(document);
}return this.__qE;
}},destruct:function(){this._disposeObjects(b);
}});
})();
(function(){var h="Brave new world!",g="execute",f="demobrowser.demo.legacy.EmbedFuture_Dialog",d="icon/32/status/dialog-information.png",c="Open 0.8 widget dialog";
qx.Class.define(f,{extend:qx.legacy.application.Gui,members:{main:function(){arguments.callee.base.call(this);
qx.theme.manager.Meta.getInstance().initialize();
var a=new qx.legacy.ui.form.Button(c,d).set({top:10,left:10});
a.addToDocument();
var b=this.getDialog();
a.addListener(g,function(e){b.open();
},this);
},getDialog:function(){var i=new qx.ui.window.Window(h);
i.moveTo(100,100);
i.setLayout(new qx.ui.layout.Grow());
i.add(new qx.ui.basic.Label(h).set({font:qx.bom.Font.fromConfig({size:100,bold:true})}));
return i;
}}});
})();
...
(function(){var v="get",u="_invalidate",t="_recompute",s="undefined",r="_compute",q="_value",p="set",o="qx.legacy.core.Property",n="_change",m="_cached";
qx.Class.define(o,{statics:{addFastProperty:function(e,f){var g=e.name;
var i=qx.lang.String.firstUp(g);
var l=q+i;
var k=v+i;
var j=p+i;
var h=r+i;
f[l]=typeof e.defaultValue!==s?e.defaultValue:null;

if(!f.hasOwnProperty(k)){if(e.noCompute){f[k]=function(){return this[l];
};
}else{f[k]=function(){return this[l]==null?this[l]=this[h]():this[l];
};
}f[k].self=f.constructor;
}
if(!f.hasOwnProperty(j)){if(e.setOnlyOnce){f[j]=function(x){this[l]=x;
this[j]=null;
return x;
};
}else{f[j]=function(w){return this[l]=w;
};
}f[j].self=f.constructor;
}
if(!f.hasOwnProperty(h)){if(!e.noCompute){f[h]=function(){return null;
};
f[h].self=f.constructor;
}}},addCachedProperty:function(y,z){var E=y.name;
var B=qx.lang.String.firstUp(E);
var D=m+B;
var A=r+B;
var C=n+B;

if(typeof y.defaultValue!==s){z[D]=y.defaultValue;
}
if(!z.hasOwnProperty(v+B)){z[v+B]=function(){if(this[D]==null){this[D]=this[A]();
}return this[D];
};
}
if(!z.hasOwnProperty(u+B)){z[u+B]=function(){if(this[D]!=null){this[D]=null;

if(y.addToQueueRuntime){this.addToQueueRuntime(y.name);
}}};
}
if(!z.hasOwnProperty(t+B)){z[t+B]=function(){var b=this[D];
var a=this[A]();
...
if(!z.hasOwnProperty(C)){z[C]=function(c,d){};
}
if(!z.hasOwnProperty(A)){z[A]=function(){return null;
};
}z[v+B].self=z.constructor;
z[u+B].self=z.constructor;
z[t+B].self=z.constructor;
}}});
})();
...
(function(){var lo="qx.client",ln="height",lm="width",ll="",lk="auto",lj="left",li="top",lh="maxHeight",lg="minHeight",lf="Boolean",jx="right",jw="minWidth",jv="maxWidth",ju="Number",jt="qx.event.type.Event",js="bottom",jr="qx.legacy.event.type.MouseEvent",jq="scrollY",jp="overflow",jo="hidden",lv="scrollX",lw="scroll",lt="qx.legacy.event.type.DragEvent",lu="none",lr="px",ls="Integer",lp="display",lq="qx.legacy.event.type.FocusEvent",lx="number",ly="_applyClip",kG="String",kF="qx.legacy.event.type.KeyEvent",kI="n-resize",kH="div",kK="%",kJ="shorthand",kM="e-resize",kL="zIndex",kD="overflowX",kC=")",hh="gecko",hi="overflowY",hj="filter",hk=",",hl="=''",hm="string",hn="backgroundColor",ho="marginBottom",hp="focused",hq="ignore",lY="disabled",lX="normal",lW="qx.legacy.ui.form.Button",lV="MozUserSelect",md="clipTop",mc="WebkitUserSelect",mb="khtml",ma="Margin",mf="abandoned",me="KhtmlOpacity",iu="pressed",iv="clipLeft",is="MozOpacity",it="backgroundRepeat",iy="cursor",iz="marginLeft",iw="nw-resize",ix="clipWidth",iq="outline",ir="removeChild",hO="mshtml",hN="paddingTop",hQ="absolute",hP="backgroundImage",hK="marginTop",hJ="opacity",hM="marginRight",hL="clipHeight",hI="paddingLeft",hH="Padding",iF="KhtmlUserSelect",iG="over",iH="ne-resize",iI="userSelect",iB="parent",iC="tabIndex",iD="paddingBottom",iE="paddingRight",iJ="changeTabIndex",iK="_applyFocused",ic="changeTop",ib="_applyDisplay",ia="Left",hY="changeBorder",hX="_applyBackgroundColor",hW="Function",hV="_renderRuntime",hU="_applyCapture",im="Height",il="changeElement",iL="preferredBoxHeight",iM="verticalAlign",iN="hand",iO="_applyBackgroundRepeat",iP="qx.legacy.ui.core.Parent",iQ="this.setStyleProperty('padding",iR="*",iS="MinWidth",iT="_applyCommand",iU="this._style.",jG="_applyTop",jF="Type",jE="hasPercentX",jD="_element",jK="changeParent",jJ="middle",jI="_applyMarginBottom",jH="hasPercentY",jO="1px dotted",jN="_applyCursor",kq="_applySelectable",kr="id",ko="Width",kp="_oldParent",km="changeCapture",kn="qx.widgetDebugId",kk="hasAutoY",kl="initial",ky="_applyVisibility",kz="_applyBottom",kR="MozUserFocus",kQ="first",kT="__qH",kS="innerWidth",kV="innerHeight",kU="v",kX="_applyMinWidth",kW="_applyMarginRight",kO="Pixel",kN="MaxHeight",lH="borderTop",lI="_applyBackgroundImage",lJ="horizontalAlign",lK="-moz-scrollbars-none",lD="Bottom",lE="_computed",lF="_applyEnabled",lG="Auto",lB="changeOverflow",lC="_applyBorder",gV="beforeAppear",gU="100px",gT="_applyPaddingTop",gS="_applyPaddingBottom",gR="changeTextColor",gQ="outerHeight",gP="_applyMarginTop",gO="outerWidth",gN="_applyRight",gM="hideFocus",hw="preferredInnerWidth",hx="Element",hu="boxHeight",hv="borderLeft",hA="preferredBoxWidth",hB="changeHeight",hy="_applyHideFocus",hz="borderRight",hD="borderBottom",hE="_applyAppearance",jS="frameWidth",jM="Right",kb="changeRight",jW="hasFlexY",jB="_styleProperties",jy="_applyPaddingRight",hS="_applyOpacity",jC="Percent",ik="rect(",ij="url(",jf="beforeDisappear",jg="Parsed",jh="_applyMaxHeight",ji="_applyFont",jj="Alpha(Opacity=",jk="_applyMaxWidth",jl="changeFocused",jm="userFocus",jc="__qL",jd="qx.legacy.ui.popup.ToolTip",jA="changeDisplay",ka="_htmlProperties",jY="_borderElement",jX="_applyWidth",kf="unselectable",ke="parentPaddingBottom",kd="center",kc="changeMaxHeight",jV="changeZIndex",jU="changeMinHeight",hC="changeEnabled",ip="Null",io="preferredInnerHeight",jL="-moz-scrollbars-vertical",iA="_applyParent",jR="changeAnonymous",jQ="changeFont",jP="parentPaddingLeft",hR="_applyOverflow",kh="parentPaddingRight",hG="_applyZIndex",hT="')",iV="_applyTextColor",iW="MaxWidth",iX="addChild",iY="-moz-scrollbars-horizontal",ja="=((v==null)?0:v)+'px'",jb="disappear",kB="changeMinWidth",je="qx.event.Command",la=".",kY="_applyPaddingLeft",lc="', ((v==null)?0:v)+'px')",lb="Flex",le="beforeRemoveDom",ld="_applyMinHeight",jn="hasAutoX",kP="_applyLeft",kg="_isCreated",kE="create",hs="_inlineEvents",ht="removeDom",kw="qx.legacy.ui.basic.Inline",kx="this.removeStyleProperty('padding",ku="widget",kv="hasFlexX",ks="insertDom",kt="_applyMarginLeft",gL="_applyTabIndex",kA="qx.legacy.ui.menu.Menu",he="parentPaddingTop",hd="100%",hc="_jobQueue",hb="changeMaxWidth",ha="clip",gY="execute",gX="MinHeight",gW="_applyElement",hg="changeWidth",hf="_applyHeight",lP="visibility",lQ="changeVisibility",lR="beforeInsertDom",lS="padding",lL="boxWidth",lM="_htmlAttributes",lN="appear",lO="Value",lT="qx.legacy.ui.core.Widget",lU="changeBottom",kj="undefined",ki="abstract",hF="_style",hr="changeLeft",ig="_innerStyle",ie="margin",ii="frameHeight",ih="changeBackgroundColor",jT="changeAppearance",jz="Top",lz="_layoutChanges",lA="_resetRuntime";
qx.Class.define(lT,{extend:qx.core.Object,type:ki,construct:function(){arguments.callee.base.call(this);
this._layoutChanges={};
if(qx.core.Setting.get(kn)){this._generateHtmlId();
}},events:{"beforeAppear":jt,"appear":jt,"beforeDisappear":jt,"disappear":jt,"beforeInsertDom":jt,"insertDom":jt,"beforeRemoveDom":jt,"removeDom":jt,"create":jt,"execute":jt,"mouseover":jr,"mousemove":jr,"mouseout":jr,"mousedown":jr,"mouseup":jr,"mousewheel":jr,"click":jr,"dblclick":jr,"contextmenu":jr,"keydown":kF,"keypress":kF,"keyinput":kF,"keyup":kF,"focusout":lq,"focusin":lq,"blur":lq,"focus":lq,"dragdrop":lt,"dragout":lt,"dragover":lt,"dragmove":lt,"dragstart":lt,"dragend":lt},statics:{create:function(bM,bN){bM._appearance=bN;
return new bM;
...
},_globalWidgetQueue:[],addToGlobalWidgetQueue:function(o){if(!o._isInGlobalWidgetQueue&&o._isDisplayable){this.__qO.schedule();
qx.legacy.ui.core.Widget._globalWidgetQueue.push(o);
o._isInGlobalWidgetQueue=true;
}},removeFromGlobalWidgetQueue:function(bk){if(bk._isInGlobalWidgetQueue){qx.lang.Array.remove(qx.legacy.ui.core.Widget._globalWidgetQueue,bk);
delete bk._isInGlobalWidgetQueue;
}},flushGlobalWidgetQueue:function(){var er=qx.legacy.ui.core.Widget._globalWidgetQueue,et,eu;

while((et=er.length)>0){for(var i=0;i<et;i++){eu=er[i];
eu.flushWidgetQueue();
delete eu._isInGlobalWidgetQueue;
}er.splice(0,et);
}},_globalElementQueue:[],addToGlobalElementQueue:function(gD){if(!gD._isInGlobalElementQueue&&gD._isDisplayable){this.__qO.schedule();
qx.legacy.ui.core.Widget._globalElementQueue.push(gD);
gD._isInGlobalElementQueue=true;
}},removeFromGlobalElementQueue:function(bh){if(bh._isInGlobalElementQueue){qx.lang.Array.remove(qx.legacy.ui.core.Widget._globalElementQueue,bh);
delete bh._isInGlobalElementQueue;
}},flushGlobalElementQueue:function(){var cj=qx.legacy.ui.core.Widget._globalElementQueue,ck,cm;

while((ck=cj.length)>0){for(var i=0;i<ck;i++){cm=cj[i];
cm._createElementImpl();
delete cm._isInGlobalElementQueue;
}cj.splice(0,ck);
}},_globalStateQueue:[],addToGlobalStateQueue:function(mr){if(!mr._isInGlobalStateQueue&&mr._isDisplayable){this.__qO.schedule();
qx.legacy.ui.core.Widget._globalStateQueue.push(mr);
mr._isInGlobalStateQueue=true;
}},removeFromGlobalStateQueue:function(ei){if(ei._isInGlobalStateQueue){qx.lang.Array.remove(qx.legacy.ui.core.Widget._globalStateQueue,ei);
delete ei._isInGlobalStateQueue;
}},flushGlobalStateQueue:function(){var ep=qx.legacy.ui.core.Widget;
while(ep._globalStateQueue.length>0){var eo=qx.lang.Array.clone(ep._globalStateQueue);
ep._globalStateQueue=[];

for(var i=0,l=eo.length;i<l;i++){var eq=eo[i];

if(eq._isInGlobalStateQueue){eq._renderAppearance();
delete eq._isInGlobalStateQueue;
}}}},_globalJobQueue:[],addToGlobalJobQueue:function(bW){if(!bW._isInGlobalJobQueue&&bW._isDisplayable){this.__qO.schedule();
qx.legacy.ui.core.Widget._globalJobQueue.push(bW);
bW._isInGlobalJobQueue=true;
}},removeFromGlobalJobQueue:function(bg){if(bg._isInGlobalJobQueue){qx.lang.Array.remove(qx.legacy.ui.core.Widget._globalJobQueue,bg);
delete bg._isInGlobalJobQueue;
}},flushGlobalJobQueue:function(){var dv=qx.legacy.ui.core.Widget._globalJobQueue,dw,dx;

while((dw=dv.length)>0){for(var i=0;i<dw;i++){dx=dv[i];
dx._flushJobQueue(dx._jobQueue);
delete dx._isInGlobalJobQueue;
}dv.splice(0,dw);
}},_globalLayoutQueue:[],addToGlobalLayoutQueue:function(gg){if(!gg._isInGlobalLayoutQueue&&gg._isDisplayable){this.__qO.schedule();
qx.legacy.ui.core.Widget._globalLayoutQueue.push(gg);
gg._isInGlobalLayoutQueue=true;
}},removeFromGlobalLayoutQueue:function(dh){if(dh._isInGlobalLayoutQueue){qx.lang.Array.remove(qx.legacy.ui.core.Widget._globalLayoutQueue,dh);
delete dh._isInGlobalLayoutQueue;
}},flushGlobalLayoutQueue:function(){var dP=qx.legacy.ui.core.Widget._globalLayoutQueue,dQ,dR;

while((dQ=dP.length)>0){for(var i=0;i<dQ;i++){dR=dP[i];
dR._flushChildrenQueue();
delete dR._isInGlobalLayoutQueue;
}dP.splice(0,dQ);
}},_fastGlobalDisplayQueue:[],_lazyGlobalDisplayQueues:{},addToGlobalDisplayQueue:function(mw){if(!mw._isInGlobalDisplayQueue&&mw._isDisplayable){this.__qO.schedule();
var mx=mw.getParent();

if(mx.isSeeable()){var my=mx.toHashCode();

if(qx.legacy.ui.core.Widget._lazyGlobalDisplayQueues[my]){qx.legacy.ui.core.Widget._lazyGlobalDisplayQueues[my].push(mw);
}else{qx.legacy.ui.core.Widget._lazyGlobalDisplayQueues[my]=[mw];
}}else{qx.legacy.ui.core.Widget._fastGlobalDisplayQueue.push(mw);
}mw._isInGlobalDisplayQueue=true;
}},removeFromGlobalDisplayQueue:function(eW){},flushGlobalDisplayQueue:function(){var ml,mk,mn,mo;
var mj=qx.legacy.ui.core.Widget._fastGlobalDisplayQueue;
var mm=qx.legacy.ui.core.Widget._lazyGlobalDisplayQueues;
for(var i=0,l=mj.length;i<l;i++){mn=mj[i];
mn.getParent()._getTargetNode().appendChild(mn.getElement());
}if(qx.Class.isDefined(kw)){for(ml in mm){mk=mm[ml];

for(var i=0;i<mk.length;i++){mn=mk[i];

if(mn instanceof qx.legacy.ui.basic.Inline){mn._beforeInsertDom();

try{document.getElementById(mn.getInlineNodeId()).appendChild(mn.getElement());
}catch(bf){mn.debug("Could not append to inline id: "+mn.getInlineNodeId(),bf);
}mn._afterInsertDom();
mn._afterAppear();
qx.lang.Array.remove(mk,mn);
i--;
delete mn._isInGlobalDisplayQueue;
}}}}for(ml in mm){mk=mm[ml];
if(document.createDocumentFragment&&mk.length>=3){mo=document.createDocumentFragment();
for(var i=0,l=mk.length;i<l;i++){mn=mk[i];
mn._beforeInsertDom();
mo.appendChild(mn.getElement());
}mk[0].getParent()._getTargetNode().appendChild(mo);

for(var i=0,l=mk.length;i<l;i++){mn=mk[i];
mn._afterInsertDom();
}}else{for(var i=0,l=mk.length;i<l;i++){mn=mk[i];
mn._beforeInsertDom();
mn.getParent()._getTargetNode().appendChild(mn.getElement());
mn._afterInsertDom();
}}}for(ml in mm){mk=mm[ml];
...
if(mn.getVisibility()){mn._afterAppear();
}delete mn._isInGlobalDisplayQueue;
}delete mm[ml];
}for(var i=0,l=mj.length;i<l;i++){delete mj[i]._isInGlobalDisplayQueue;
}qx.lang.Array.removeAll(mj);
},getActiveSiblingHelperIgnore:function(dB,dC){for(var j=0;j<dB.length;j++){if(dC instanceof dB[j]){return true;
}}return false;
},getActiveSiblingHelper:function(dV,dW,dX,dY,ea){if(!dY){dY=[];
}var eb=dW.getChildren();
var ed=ea==null?eb.indexOf(dV)+dX:ea===kQ?0:eb.length-1;
var ec=eb[ed];

while(ec&&(!ec.getEnabled()||qx.legacy.ui.core.Widget.getActiveSiblingHelperIgnore(dY,ec))){ed+=dX;
ec=eb[ed];

if(!ec){return null;
}}return ec;
},__qF:function(bt){var bB=hV;
var bC=lA;
var bu=iU;
var bx=ja;
var bE=kU;
var bF=[lj,jx,li,js,lm,ln,jw,jv,lg,lh];
var by=[ia,jM,jz,lD,ko,im,iS,iW,gX,kN];
var bv=bB+ma;
var bD=bC+ma;
var bA=bu+ie;

for(var i=0;i<4;i++){bt[bv+by[i]]=new Function(bE,bA+by[i]+bx);
bt[bD+by[i]]=new Function(bA+by[i]+hl);
}var bw=bB+hH;
var bz=bC+hH;
var bG=bu+lS;

if(qx.core.Variant.isSet(lo,hh)){for(var i=0;i<4;i++){bt[bw+by[i]]=new Function(bE,bG+by[i]+bx);
bt[bz+by[i]]=new Function(bG+by[i]+hl);
}}else{for(var i=0;i<4;i++){bt[bw+by[i]]=new Function(bE,iQ+by[i]+lc);
bt[bz+by[i]]=new Function(kx+by[i]+hT);
}}for(var i=0;i<bF.length;i++){bt[bB+by[i]]=new Function(bE,bu+bF[i]+bx);
bt[bC+by[i]]=new Function(bu+bF[i]+hl);
}},TYPE_NULL:0,TYPE_PIXEL:1,TYPE_PERCENT:2,TYPE_AUTO:3,TYPE_FLEX:4,layoutPropertyTypes:{},__qG:function(dO){var a=[lm,ln,jw,jv,lg,lh,lj,jx,li,js];

for(var i=0,l=a.length,p,b,t;i<l;i++){p=a[i];
b=lE+qx.lang.String.firstUp(p);
t=b+jF;
dO.layoutPropertyTypes[p]={dataType:t,dataParsed:b+jg,dataValue:b+lO,typePixel:t+kO,typePercent:t+jC,typeAuto:t+lG,typeFlex:t+lb,typeNull:t+ip};
}},initScrollbarWidth:function(){var t=document.createElement(kH);
var s=t.style;
s.height=s.width=gU;
s.overflow=lw;
document.body.appendChild(t);
...
document.body.removeChild(t);
},_idCounter:0},properties:{enabled:{init:true,check:lf,inheritable:true,apply:lF,event:hC},parent:{check:iP,nullable:true,event:jK,apply:iA},element:{check:hx,nullable:true,apply:gW,event:il},visibility:{check:lf,init:true,apply:ky,event:lQ},display:{check:lf,init:true,apply:ib,event:jA},anonymous:{check:lf,init:false,event:jR},horizontalAlign:{check:[lj,kd,jx],themeable:true,nullable:true},verticalAlign:{check:[li,jJ,js],themeable:true,nullable:true},allowStretchX:{check:lf,init:true},allowStretchY:{check:lf,init:true},zIndex:{check:ju,apply:hG,event:jV,themeable:true,nullable:true,init:null},backgroundColor:{nullable:true,init:null,apply:hX,event:ih,themeable:true},textColor:{nullable:true,apply:iV,event:gR,themeable:true,inheritable:true},border:{nullable:true,init:null,apply:lC,event:hY,themeable:true},font:{nullable:true,apply:ji,event:jQ,themeable:true,inheritable:true},opacity:{check:ju,apply:hS,themeable:true,nullable:true,init:null},cursor:{check:kG,apply:jN,themeable:true,nullable:true,init:null},backgroundImage:{check:kG,nullable:true,apply:lI,themeable:true},backgroundRepeat:{check:kG,nullable:true,apply:iO,themeable:true},overflow:{check:[jo,lk,lw,lv,jq],nullable:true,apply:hR,event:lB,themeable:true,init:null},clipLeft:{check:ls,apply:ly,themeable:true,nullable:true},clipTop:{check:ls,apply:ly,themeable:true,nullable:true},clipWidth:{check:ls,apply:ly,themeable:true,nullable:true},clipHeight:{check:ls,apply:ly,themeable:true,nullable:true},tabIndex:{check:ls,nullable:true,init:null,apply:gL,event:iJ},hideFocus:{check:lf,init:false,apply:hy,themeable:true},enableElementFocus:{check:lf,init:true},focused:{check:lf,init:false,apply:iK,event:jl},selectable:{check:lf,init:null,nullable:true,apply:kq},toolTip:{check:jd,nullable:true},contextMenu:{check:kA,nullable:true},capture:{check:lf,init:false,apply:hU,event:km},dropDataTypes:{nullable:true,dispose:true},command:{check:je,nullable:true,apply:iT},appearance:{check:kG,init:ku,apply:hE,event:jT},supportsDropMethod:{check:hW,nullable:true,init:null},marginTop:{check:ju,apply:gP,nullable:true,themeable:true},marginRight:{check:ju,apply:kW,nullable:true,themeable:true},marginBottom:{check:ju,apply:jI,nullable:true,themeable:true},marginLeft:{check:ju,apply:kt,nullable:true,themeable:true},paddingTop:{check:ju,apply:gT,nullable:true,themeable:true},paddingRight:{check:ju,apply:jy,nullable:true,themeable:true},paddingBottom:{check:ju,apply:gS,nullable:true,themeable:true},paddingLeft:{check:ju,apply:kY,nullable:true,themeable:true},left:{apply:kP,event:hr,nullable:true,themeable:true,init:null},right:{apply:gN,event:kb,nullable:true,themeable:true,init:null},width:{apply:jX,event:hg,nullable:true,themeable:true,init:null},minWidth:{apply:kX,event:kB,nullable:true,themeable:true,init:null},maxWidth:{apply:jk,event:hb,nullable:true,themeable:true,init:null},top:{apply:jG,event:ic,nullable:true,themeable:true,init:null},bottom:{apply:kz,event:lU,nullable:true,themeable:true,init:null},height:{apply:hf,event:hB,nullable:true,themeable:true,init:null},minHeight:{apply:ld,event:jU,nullable:true,themeable:true,init:null},maxHeight:{apply:jh,event:kc,nullable:true,themeable:true,init:null},location:{group:[lj,li],themeable:true},dimension:{group:[lm,ln],themeable:true},space:{group:[lj,lm,li,ln],themeable:true},edge:{group:[li,jx,js,lj],themeable:true,mode:kJ},padding:{group:[hN,iE,iD,hI],mode:kJ,themeable:true},margin:{group:[hK,hM,ho,iz],mode:kJ,themeable:true},heights:{group:[lg,ln,lh],themeable:true},widths:{group:[jw,lm,jv],themeable:true},align:{group:[lJ,iM],themeable:true},clipLocation:{group:[iv,md]},clipDimension:{group:[ix,hL]},clip:{group:[iv,md,ix,hL]}},members:{_computedLeftValue:null,_computedLeftParsed:null,_computedLeftType:null,_computedLeftTypeNull:true,_computedLeftTypePixel:false,_computedLeftTypePercent:false,_computedLeftTypeAuto:false,_computedLeftTypeFlex:false,_computedRightValue:null,_computedRightParsed:null,_computedRightType:null,_computedRightTypeNull:true,_computedRightTypePixel:false,_computedRightTypePercent:false,_computedRightTypeAuto:false,_computedRightTypeFlex:false,_computedTopValue:null,_computedTopParsed:null,_computedTopType:null,_computedTopTypeNull:true,_computedTopTypePixel:false,_computedTopTypePercent:false,_computedTopTypeAuto:false,_computedTopTypeFlex:false,_computedBottomValue:null,_computedBottomParsed:null,_computedBottomType:null,_computedBottomTypeNull:true,_computedBottomTypePixel:false,_computedBottomTypePercent:false,_computedBottomTypeAuto:false,_computedBottomTypeFlex:false,_computedWidthValue:null,_computedWidthParsed:null,_computedWidthType:null,_computedWidthTypeNull:true,_computedWidthTypePixel:false,_computedWidthTypePercent:false,_computedWidthTypeAuto:false,_computedWidthTypeFlex:false,_computedMinWidthValue:null,_computedMinWidthParsed:null,_computedMinWidthType:null,_computedMinWidthTypeNull:true,_computedMinWidthTypePixel:false,_computedMinWidthTypePercent:false,_computedMinWidthTypeAuto:false,_computedMinWidthTypeFlex:false,_computedMaxWidthValue:null,_computedMaxWidthParsed:null,_computedMaxWidthType:null,_computedMaxWidthTypeNull:true,_computedMaxWidthTypePixel:false,_computedMaxWidthTypePercent:false,_computedMaxWidthTypeAuto:false,_computedMaxWidthTypeFlex:false,_computedHeightValue:null,_computedHeightParsed:null,_computedHeightType:null,_computedHeightTypeNull:true,_computedHeightTypePixel:false,_computedHeightTypePercent:false,_computedHeightTypeAuto:false,_computedHeightTypeFlex:false,_computedMinHeightValue:null,_computedMinHeightParsed:null,_computedMinHeightType:null,_computedMinHeightTypeNull:true,_computedMinHeightTypePixel:false,_computedMinHeightTypePercent:false,_computedMinHeightTypeAuto:false,_computedMinHeightTypeFlex:false,_computedMaxHeightValue:null,_computedMaxHeightParsed:null,_computedMaxHeightType:null,_computedMaxHeightTypeNull:true,_computedMaxHeightTypePixel:false,_computedMaxHeightTypePercent:false,_computedMaxHeightTypeAuto:false,_computedMaxHeightTypeFlex:false,_applyLeft:function(cQ,cR){this._unitDetectionPixelPercent(lj,cQ);
this.addToQueue(lj);
},_applyRight:function(fL,fM){this._unitDetectionPixelPercent(jx,fL);
this.addToQueue(jx);
},_applyTop:function(ca,cb){this._unitDetectionPixelPercent(li,ca);
this.addToQueue(li);
},_applyBottom:function(V,W){this._unitDetectionPixelPercent(js,V);
this.addToQueue(js);
},_applyWidth:function(eD,eE){this._unitDetectionPixelPercentAutoFlex(lm,eD);
this.addToQueue(lm);
},_applyMinWidth:function(cp,cq){this._unitDetectionPixelPercentAuto(jw,cp);
this.addToQueue(jw);
},_applyMaxWidth:function(bi,bj){this._unitDetectionPixelPercentAuto(jv,bi);
this.addToQueue(jv);
},_applyHeight:function(fj,fk){this._unitDetectionPixelPercentAutoFlex(ln,fj);
this.addToQueue(ln);
},_applyMinHeight:function(cn,co){this._unitDetectionPixelPercentAuto(lg,cn);
this.addToQueue(lg);
},_applyMaxHeight:function(eB,eC){this._unitDetectionPixelPercentAuto(lh,eB);
this.addToQueue(lh);
},isMaterialized:function(){var gA=this._element;
return (this._initialLayoutDone&&this._isDisplayable&&qx.legacy.html.Style.getStyleProperty(gA,lp)!=lu&&qx.legacy.html.Style.getStyleProperty(gA,lP)!=jo&&gA.offsetWidth>0&&gA.offsetHeight>0);
},pack:function(){this.setWidth(this.getPreferredBoxWidth());
this.setHeight(this.getPreferredBoxHeight());
},auto:function(){this.setWidth(lk);
this.setHeight(lk);
...
},_checkParent:function(bl,bm){if(this.contains(bl)){throw new Error("Could not insert myself into a child "+bl+"!");
}return bl;
},_applyParent:function(L,M){if(M){var N=M.getChildren().indexOf(this);
...
qx.lang.Array.removeAt(M.getChildren(),N);
M._invalidateVisibleChildren();
M._removeChildFromChildrenQueue(this);
M.getLayoutImpl().updateChildrenOnRemoveChild(this,N);
M.addToJobQueue(ir);
M._invalidatePreferredInnerDimensions();
this._oldParent=M;
}
if(L){this._hasParent=true;

if(typeof this._insertIndex==lx){qx.lang.Array.insertAt(L.getChildren(),this,this._insertIndex);
delete this._insertIndex;
}else{L.getChildren().push(this);
}}else{this._hasParent=false;
}qx.core.Property.refresh(this);
return this._handleDisplayable(iB);
},_applyDisplay:function(dz,dA){return this._handleDisplayable(lp);
},_handleDisplayable:function(e){var g=this._computeDisplayable();

if(this._isDisplayable==g&&!(g&&e==iB)){return true;
}this._isDisplayable=g;
var f=this.getParent();
if(f){f._invalidateVisibleChildren();
f._invalidatePreferredInnerDimensions();
}if(e&&this._oldParent&&this._oldParent._initialLayoutDone){var h=this.getElement();

if(h){if(this.getVisibility()){this._beforeDisappear();
}this._beforeRemoveDom();

try{this._oldParent._getTargetNode().removeChild(h);
}catch(u){}this._afterRemoveDom();

if(this.getVisibility()){this._afterDisappear();
}}delete this._oldParent;
}if(g){if(f._initialLayoutDone){f.getLayoutImpl().updateChildrenOnAddChild(this,f.getChildren().indexOf(this));
f.addToJobQueue(iX);
}this.addToLayoutChanges(kl);
this.addToCustomQueues(e);
...
if(this._jobQueue&&!qx.lang.Object.isEmpty(this._jobQueue)){qx.legacy.ui.core.Widget.addToGlobalJobQueue(this);
}
if(this._childrenQueue&&!qx.lang.Object.isEmpty(this._childrenQueue)){qx.legacy.ui.core.Widget.addToGlobalLayoutQueue(this);
...
this.removeFromCustomQueues(e);
if(f&&e){if(this.getVisibility()){this._beforeDisappear();
}if(f._initialLayoutDone&&this._initialLayoutDone){f.getLayoutImpl().updateChildrenOnRemoveChild(this,f.getChildren().indexOf(this));
f.addToJobQueue(ir);
this._beforeRemoveDom();
var k=this.getElement().parentNode;

if(k){k.removeChild(this.getElement());
if(k&&k!==f._getTargetNode()){this.warn("Unexpected parent node: "+k);
}}this._afterRemoveDom();
}f._removeChildFromChildrenQueue(this);

if(this.getVisibility()){this._afterDisappear();
}}}this._handleDisplayableCustom(g,f,e);
return true;
...
},_beforeAppear:function(){this.fireEvent(gV);
},_afterAppear:function(){this._isSeeable=true;
this.fireEvent(lN);
},_beforeDisappear:function(){this.removeState(iG);

if(qx.Class.isDefined(lW)){this.removeState(iu);
this.removeState(mf);
}this.fireEvent(jf);
...
},_beforeInsertDom:function(){this.fireEvent(lR);
},_afterInsertDom:function(){this.fireEvent(ks);
},_beforeRemoveDom:function(){this.fireEvent(le);
},_afterRemoveDom:function(){this.fireEvent(ht);
},_applyVisibility:function(cS,cT){if(cS){if(this._isDisplayable){this._beforeAppear();
}this.removeStyleProperty(lp);

if(this._isDisplayable){this._afterAppear();
}}else{if(this._isDisplayable){this._beforeDisappear();
}this.setStyleProperty(lp,lu);
...
},_isCreated:false,_getTargetNode:qx.core.Variant.select(lo,{"gecko":function(){return this._element;
...
},_createElementImpl:function(){this.setElement(this.getTopLevelWidget().getDocumentElement().createElement(kH));
},_applyElement:function(gh,gi){this._isCreated=gh!=null;

if(gi){gi.qx_Widget=null;
}
if(gh){gh.qx_Widget=this;
gh.style.position=hQ;
this._element=gh;
this._style=gh.style;
this._applyStyleProperties(gh);
this._applyHtmlProperties(gh);
this._applyHtmlAttributes(gh);
this._applyElementData(gh);
this.fireEvent(kE);
...
return true;
},_flushJobQueue:function(q){try{var cr=this._jobQueue;
var cA=this.getParent();

if(!cA||!cr||qx.lang.Object.isEmpty(cr)){return;
}var cz=this instanceof qx.legacy.ui.core.Parent?this.getLayoutImpl():null;

if(cz){cz.updateSelfOnJobQueueFlush(cr);
}}catch(fS){this.error("Flushing job queue (prechecks#1) failed",fS);
}try{var cv=false;
var cD=cr.marginLeft||cr.marginRight;
var cC=cr.marginTop||cr.marginBottom;
var cB=cr.frameWidth;
var cy=cr.frameHeight;
var cx=(cr.frameWidth||cr.preferredInnerWidth)&&this._recomputePreferredBoxWidth();
var cu=(cr.frameHeight||cr.preferredInnerHeight)&&this._recomputePreferredBoxHeight();

if(cx){var cE=this.getPreferredBoxWidth();

if(this._computedWidthTypeAuto){this._computedWidthValue=cE;
cr.width=true;
}
if(this._computedMinWidthTypeAuto){this._computedMinWidthValue=cE;
cr.minWidth=true;
}
if(this._computedMaxWidthTypeAuto){this._computedMaxWidthValue=cE;
cr.maxWidth=true;
}}
if(cu){var cE=this.getPreferredBoxHeight();

if(this._computedHeightTypeAuto){this._computedHeightValue=cE;
cr.height=true;
}
if(this._computedMinHeightTypeAuto){this._computedMinHeightValue=cE;
cr.minHeight=true;
}
if(this._computedMaxHeightTypeAuto){this._computedMaxHeightValue=cE;
cr.maxHeight=true;
}}
if((cr.width||cr.minWidth||cr.maxWidth||cr.left||cr.right)&&this._recomputeBoxWidth()){cD=cB=true;
}
if((cr.height||cr.minHeight||cr.maxHeight||cr.top||cr.bottom)&&this._recomputeBoxHeight()){cC=cy=true;
}}catch(gf){this.error("Flushing job queue (recompute#2) failed",gf);
}try{if((cD&&this._recomputeOuterWidth())||cx){cA._invalidatePreferredInnerWidth();
cA.getLayoutImpl().updateSelfOnChildOuterWidthChange(this);
cv=true;
}
if((cC&&this._recomputeOuterHeight())||cu){cA._invalidatePreferredInnerHeight();
cA.getLayoutImpl().updateSelfOnChildOuterHeightChange(this);
cv=true;
}
if(cv){cA._flushJobQueue();
}}catch(bJ){this.error("Flushing job queue (parentsignals#3) failed",bJ);
}try{cA._addChildToChildrenQueue(this);
for(var i in cr){this._layoutChanges[i]=true;
}}catch(bX){this.error("Flushing job queue (addjobs#4) failed",bX);
}try{if(this instanceof qx.legacy.ui.core.Parent&&(cr.paddingLeft||cr.paddingRight||cr.paddingTop||cr.paddingBottom)){var ct=this.getChildren(),cw=ct.length;

if(cr.paddingLeft){for(var i=0;i<cw;i++){ct[i].addToLayoutChanges(jP);
}}
if(cr.paddingRight){for(var i=0;i<cw;i++){ct[i].addToLayoutChanges(kh);
}}
if(cr.paddingTop){for(var i=0;i<cw;i++){ct[i].addToLayoutChanges(he);
}}
if(cr.paddingBottom){for(var i=0;i<cw;i++){ct[i].addToLayoutChanges(ke);
}}}
if(cB){this._recomputeInnerWidth();
}
if(cy){this._recomputeInnerHeight();
}
if(this._initialLayoutDone){if(cz){cz.updateChildrenOnJobQueueFlush(cr);
}}}catch(fc){this.error("Flushing job queue (childrensignals#5) failed",fc);
...
},_computeBoxWidth:function(){var gz=this.getParent().getLayoutImpl();
return Math.max(0,qx.lang.Number.limit(gz.computeChildBoxWidth(this),this.getMinWidthValue(),this.getMaxWidthValue()));
},_computeBoxHeight:function(){var fn=this.getParent().getLayoutImpl();
return Math.max(0,qx.lang.Number.limit(fn.computeChildBoxHeight(this),this.getMinHeightValue(),this.getMaxHeightValue()));
...
},getNeededWidth:function(){var A=this.getParent().getLayoutImpl();
return Math.max(0,A.computeChildNeededWidth(this));
},getNeededHeight:function(){var mv=this.getParent().getLayoutImpl();
return Math.max(0,mv.computeChildNeededHeight(this));
},_recomputeFlexX:function(){if(!this.getHasFlexX()){return false;
}
if(this._computedWidthTypeFlex){this._computedWidthValue=null;
this.addToLayoutChanges(lm);
}return true;
},_recomputeFlexY:function(){if(!this.getHasFlexY()){return false;
}
if(this._computedHeightTypeFlex){this._computedHeightValue=null;
this.addToLayoutChanges(ln);
}return true;
...
this.addToLayoutChanges(lg);
}
if(this._computedMaxHeightTypePercent){this._computedMaxHeightValue=null;
this.addToLayoutChanges(lh);
}
if(this._computedTopTypePercent){this._computedTopValue=null;
this.addToLayoutChanges(li);
}
if(this._computedBottomTypePercent){this._computedBottomValue=null;
this.addToLayoutChanges(js);
}return true;
},_recomputeRangeX:qx.core.Variant.select(lo,{"mshtml|opera|webkit":function(){if(this._computedLeftTypeNull||this._computedRightTypeNull){return false;
}this.addToLayoutChanges(lm);
return true;
},"default":function(){return !(this._computedLeftTypeNull||this._computedRightTypeNull);
}}),_recomputeRangeY:qx.core.Variant.select(lo,{"mshtml|opera|webkit":function(){if(this._computedTopTypeNull||this._computedBottomTypeNull){return false;
}this.addToLayoutChanges(ln);
return true;
},"default":function(){return !(this._computedTopTypeNull||this._computedBottomTypeNull);
}}),_recomputeStretchingX:qx.core.Variant.select(lo,{"mshtml|opera|webkit":function(){if(this.getAllowStretchX()&&this._computedWidthTypeNull){this._computedWidthValue=null;
this.addToLayoutChanges(lm);
return true;
}return false;
},"default":function(){if(this.getAllowStretchX()&&this._computedWidthTypeNull){return true;
}return false;
}}),_recomputeStretchingY:qx.core.Variant.select(lo,{"mshtml|opera|webkit":function(){if(this.getAllowStretchY()&&this._computedHeightTypeNull){this._computedHeightValue=null;
this.addToLayoutChanges(ln);
return true;
}return false;
...
},_computeFrameWidth:function(){var cN=this._cachedBorderLeft+this.getPaddingLeft()+this.getPaddingRight()+this._cachedBorderRight;

switch(this.getOverflow()){case lw:case jq:cN+=qx.legacy.ui.core.Widget.SCROLLBAR_SIZE;
break;
case lk:break;
}return cN;
},_computeFrameHeight:function(){var ev=this._cachedBorderTop+this.getPaddingTop()+this.getPaddingBottom()+this._cachedBorderBottom;

switch(this.getOverflow()){case lw:case lv:ev+=qx.legacy.ui.core.Widget.SCROLLBAR_SIZE;
break;
case lk:break;
}return ev;
...
}catch(dM){this.error("_computePreferredBoxWidth failed",dM);
}},_computePreferredBoxHeight:function(){try{return Math.max(0,this.getPreferredInnerHeight()+this.getFrameHeight());
}catch(bs){this.error("_computePreferredBoxHeight failed",bs);
...
},_evalUnitsPixelPercentAutoFlex:function(cf){switch(cf){case lk:return qx.legacy.ui.core.Widget.TYPE_AUTO;
case Infinity:case -Infinity:return qx.legacy.ui.core.Widget.TYPE_NULL;
}
switch(typeof cf){case lx:return isNaN(cf)?qx.legacy.ui.core.Widget.TYPE_NULL:qx.legacy.ui.core.Widget.TYPE_PIXEL;
case hm:return cf.indexOf(kK)!=-1?qx.legacy.ui.core.Widget.TYPE_PERCENT:cf.indexOf(iR)!=-1?qx.legacy.ui.core.Widget.TYPE_FLEX:qx.legacy.ui.core.Widget.TYPE_NULL;
}return qx.legacy.ui.core.Widget.TYPE_NULL;
},_evalUnitsPixelPercentAuto:function(bb){switch(bb){case lk:return qx.legacy.ui.core.Widget.TYPE_AUTO;
case Infinity:case -Infinity:return qx.legacy.ui.core.Widget.TYPE_NULL;
}
switch(typeof bb){case lx:return isNaN(bb)?qx.legacy.ui.core.Widget.TYPE_NULL:qx.legacy.ui.core.Widget.TYPE_PIXEL;
case hm:return bb.indexOf(kK)!=-1?qx.legacy.ui.core.Widget.TYPE_PERCENT:qx.legacy.ui.core.Widget.TYPE_NULL;
}return qx.legacy.ui.core.Widget.TYPE_NULL;
},_evalUnitsPixelPercent:function(bL){switch(bL){case Infinity:case -Infinity:return qx.legacy.ui.core.Widget.TYPE_NULL;
}
switch(typeof bL){case lx:return isNaN(bL)?qx.legacy.ui.core.Widget.TYPE_NULL:qx.legacy.ui.core.Widget.TYPE_PIXEL;
case hm:return bL.indexOf(kK)!=-1?qx.legacy.ui.core.Widget.TYPE_PERCENT:qx.legacy.ui.core.Widget.TYPE_NULL;
}return qx.legacy.ui.core.Widget.TYPE_NULL;
},_unitDetectionPixelPercentAutoFlex:function(name,di){var r=qx.legacy.ui.core.Widget.layoutPropertyTypes[name];
var s=r.dataType;
var p=r.dataParsed;
var v=r.dataValue;
var dl=r.typePixel;
var dk=r.typePercent;
var dj=r.typeAuto;
var dq=r.typeFlex;
var dp=r.typeNull;
var dm=this[dk];
...
switch(this[s]=this._evalUnitsPixelPercentAutoFlex(di)){case qx.legacy.ui.core.Widget.TYPE_PIXEL:this[dl]=true;
this[dk]=this[dj]=this[dq]=this[dp]=false;
this[p]=this[v]=Math.round(di);
break;
case qx.legacy.ui.core.Widget.TYPE_PERCENT:this[dk]=true;
this[dl]=this[dj]=this[dq]=this[dp]=false;
this[p]=parseFloat(di);
this[v]=null;
break;
case qx.legacy.ui.core.Widget.TYPE_AUTO:this[dj]=true;
this[dl]=this[dk]=this[dq]=this[dp]=false;
this[p]=this[v]=null;
break;
case qx.legacy.ui.core.Widget.TYPE_FLEX:this[dq]=true;
this[dl]=this[dk]=this[dj]=this[dp]=false;
this[p]=parseFloat(di);
this[v]=null;
break;
default:this[dp]=true;
this[dl]=this[dk]=this[dj]=this[dq]=false;
this[p]=this[v]=null;
break;
}
if(dm!=this[dk]){switch(name){case jw:case jv:case lm:case lj:case jx:this._invalidateHasPercentX();
break;
case lh:case lg:case ln:case li:case js:this._invalidateHasPercentY();
break;
}}if(dn!=this[dj]){switch(name){case jw:case jv:case lm:this._invalidateHasAutoX();
break;
case lg:case lh:case ln:this._invalidateHasAutoY();
break;
}}if(dr!=this[dq]){switch(name){case lm:this._invalidateHasFlexX();
break;
case ln:this._invalidateHasFlexY();
break;
}}},_unitDetectionPixelPercentAuto:function(name,gj){var r=qx.legacy.ui.core.Widget.layoutPropertyTypes[name];
var s=r.dataType;
var p=r.dataParsed;
var v=r.dataValue;
var gm=r.typePixel;
var gl=r.typePercent;
var gk=r.typeAuto;
var gp=r.typeNull;
var gn=this[gl];
var go=this[gk];

switch(this[s]=this._evalUnitsPixelPercentAuto(gj)){case qx.legacy.ui.core.Widget.TYPE_PIXEL:this[gm]=true;
this[gl]=this[gk]=this[gp]=false;
this[p]=this[v]=Math.round(gj);
break;
case qx.legacy.ui.core.Widget.TYPE_PERCENT:this[gl]=true;
this[gm]=this[gk]=this[gp]=false;
this[p]=parseFloat(gj);
this[v]=null;
break;
case qx.legacy.ui.core.Widget.TYPE_AUTO:this[gk]=true;
this[gm]=this[gl]=this[gp]=false;
this[p]=this[v]=null;
break;
default:this[gp]=true;
this[gm]=this[gl]=this[gk]=false;
this[p]=this[v]=null;
break;
}
if(gn!=this[gl]){switch(name){case jw:case jv:case lm:case lj:case jx:this._invalidateHasPercentX();
break;
case lg:case lh:case ln:case li:case js:this._invalidateHasPercentY();
break;
}}if(go!=this[gk]){switch(name){case jw:case jv:case lm:this._invalidateHasAutoX();
break;
case lg:case lh:case ln:this._invalidateHasAutoY();
break;
}}},_unitDetectionPixelPercent:function(name,cX){var r=qx.legacy.ui.core.Widget.layoutPropertyTypes[name];
var s=r.dataType;
var p=r.dataParsed;
var v=r.dataValue;
var db=r.typePixel;
var da=r.typePercent;
var cY=r.typeNull;
var dc=this[da];

switch(this[s]=this._evalUnitsPixelPercent(cX)){case qx.legacy.ui.core.Widget.TYPE_PIXEL:this[db]=true;
this[da]=this[cY]=false;
this[p]=this[v]=Math.round(cX);
break;
case qx.legacy.ui.core.Widget.TYPE_PERCENT:this[da]=true;
this[db]=this[cY]=false;
this[p]=parseFloat(cX);
this[v]=null;
break;
default:this[cY]=true;
this[db]=this[da]=false;
this[p]=this[v]=null;
break;
}
if(dc!=this[da]){switch(name){case jw:case jv:case lm:case lj:case jx:this._invalidateHasPercentX();
break;
case lg:case lh:case ln:case li:case js:this._invalidateHasPercentY();
break;
}}},getTopLevelWidget:function(){return this._hasParent?this.getParent().getTopLevelWidget():null;
},moveSelfBefore:function(el){this.getParent().addBefore(this,el);
},moveSelfAfter:function(dD){this.getParent().addAfter(this,dD);
...
}var cd=p.getChildren();
return cd[cd.indexOf(this)-1];
},getNextSibling:function(){var p=this.getParent();

if(p==null){return null;
}var eR=p.getChildren();
return eR[eR.indexOf(this)+1];
},getPreviousVisibleSibling:function(){if(!this._hasParent){return null;
}var dS=this.getParent().getVisibleChildren();
return dS[dS.indexOf(this)-1];
},getNextVisibleSibling:function(){if(!this._hasParent){return null;
}var fe=this.getParent().getVisibleChildren();
return fe[fe.indexOf(this)+1];
},getPreviousActiveSibling:function(eP){var eQ=qx.legacy.ui.core.Widget.getActiveSiblingHelper(this,this.getParent(),-1,eP,null);
return eQ?eQ:this.getParent().getLastActiveChild();
},getNextActiveSibling:function(eU){var eV=qx.legacy.ui.core.Widget.getActiveSiblingHelper(this,this.getParent(),1,eU,null);
return eV?eV:this.getParent().getFirstActiveChild();
...
},hasState:function(bV){return this.__qH&&this.__qH[bV]?true:false;
},addState:function(bK){if(!this.__qH){this.__qH={};
}
if(!this.__qH[bK]){this.__qH[bK]=true;

if(this._hasParent){qx.legacy.ui.core.Widget.addToGlobalStateQueue(this);
}}},removeState:function(cO){if(this.__qH&&this.__qH[cO]){delete this.__qH[cO];

if(this._hasParent){qx.legacy.ui.core.Widget.addToGlobalStateQueue(this);
}}},_styleFromMap:function(eK){var eO;
var eL=qx.core.Property.$$method.setThemed;
var eN=qx.core.Property.$$method.resetThemed;
var eM;
{};

for(var eO in eK){eM=eK[eO];
eM===kj?this[eN[eO]]():this[eL[eO]](eM);
}},_unstyleFromArray:function(fO){var i,l;
var fP=qx.core.Property.$$method.resetThemed;
{};

for(var i=0,l=fO.length;i<l;i++){this[fP[fO[i]]]();
}},_renderAppearance:function(){if(!this.__qH){this.__qH={};
}this._applyStateStyleFocus(this.__qH);
var ge=this.getAppearance();

if(ge){try{var r=qx.legacy.theme.manager.Appearance.getInstance().styleFrom(ge,this.__qH);

if(r){this._styleFromMap(r);
}}catch(I){this.error("Could not apply state appearance",I);
}}},_resetAppearanceThemeWrapper:function(fD,fE){var fF=this.getAppearance();

if(fF){var fK=qx.legacy.theme.manager.Appearance.getInstance();
var fG=fK.styleFromTheme(fE,fF,this.__qH);
var fJ=fK.styleFromTheme(fD,fF,this.__qH);
var fI=[];

for(var fH in fG){if(fJ[fH]===undefined){fI.push(fH);
}}this._unstyleFromArray(fI);
this._styleFromMap(fJ);
}},_applyStateStyleFocus:qx.core.Variant.select(lo,{"mshtml":function(X){},"default":function(cI){if(cI.focused){if(!qx.legacy.event.handler.FocusHandler.mouseFocus&&!this.getHideFocus()){this.setStyleProperty(iq,jO);
}}else{this.removeStyleProperty(iq);
...
},_applyAppearance:function(gq,gr){if(!this.__qH){this.__qH={};
}var gw=qx.legacy.theme.manager.Appearance.getInstance();

if(gq){var gs=gw.styleFrom(gq,this.__qH)||{};
}
if(gr){var gu=gw.styleFrom(gr,this.__qH)||{};
var gv=[];

for(var gt in gu){if(!gs||!(gt in gs)){gv.push(gt);
}}}
if(gv){this._unstyleFromArray(gv);
}
if(gs){this._styleFromMap(gs);
}},_recursiveAppearanceThemeUpdate:function(bO,bP){try{this._resetAppearanceThemeWrapper(bO,bP);
}catch(ce){this.error("Failed to update appearance theme",ce);
}},_applyElementData:function(bc){},setHtmlProperty:function(cV,cW){if(!this._htmlProperties){this._htmlProperties={};
}this._htmlProperties[cV]=cW;

if(this._isCreated&&this.getElement()[cV]!=cW){this.getElement()[cV]=cW;
}return true;
},removeHtmlProperty:qx.core.Variant.select(lo,{"mshtml":function(fd){if(!this._htmlProperties){return;
}delete this._htmlProperties[fd];

if(this._isCreated){this.getElement().removeAttribute(fd);
}return true;
},"default":function(cc){if(!this._htmlProperties){return;
}delete this._htmlProperties[cc];

if(this._isCreated){this.getElement().removeAttribute(cc);
delete this.getElement()[cc];
}return true;
}}),getHtmlProperty:function(cP){if(!this._htmlProperties){return ll;
}return this._htmlProperties[cP]||ll;
},_applyHtmlProperties:function(eH){var eJ=this._htmlProperties;

if(eJ){var eI;

for(eI in eJ){eH[eI]=eJ[eI];
}}},_generateHtmlId:function(){var Y=this.classname+la+qx.legacy.ui.core.Widget._idCounter++;
this.debug("setting autogenerated HTML id to "+Y);
this.setHtmlProperty(kr,Y);
},setHtmlAttribute:function(cG,cH){if(!this._htmlAttributes){this._htmlAttributes={};
}this._htmlAttributes[cG]=cH;

if(this._isCreated){this.getElement().setAttribute(cG,cH);
}return true;
},removeHtmlAttribute:function(gG){if(!this._htmlAttributes){return;
}delete this._htmlAttributes[gG];

if(this._isCreated){this.getElement().removeAttribute(gG);
}return true;
},getHtmlAttribute:function(cF){if(!this._htmlAttributes){return ll;
}return this._htmlAttributes[cF]||ll;
},_applyHtmlAttributes:function(dE){var dG=this._htmlAttributes;

if(dG){var dF;

for(dF in dG){dE.setAttribute(dF,dG[dF]);
}}},getStyleProperty:function(dH){if(!this._styleProperties){return ll;
}return this._styleProperties[dH]||ll;
},__qI:{cursor:true,zIndex:true,filter:true,display:true,visibility:true},setStyleProperty:function(bn,bo){if(!this._styleProperties){this._styleProperties={};
}this._styleProperties[bn]=bo;

if(this._isCreated){var bp=this.__qI[bn]?this.getElement():this._getTargetNode();

if(bp){bp.style[bn]=(bo==null)?ll:bo;
}}},removeStyleProperty:function(gB){if(!this._styleProperties){return;
}delete this._styleProperties[gB];

if(this._isCreated){var gC=this.__qI[gB]?this.getElement():this._getTargetNode();

if(gC){gC.style[gB]=ll;
}}},_applyStyleProperties:function(O){var S=this._styleProperties;

if(!S){return;
}var T;
var P=O;
var Q=this._getTargetNode();
var O;
var R;

for(T in S){O=this.__qI[T]?P:Q;
R=S[T];
O.style[T]=(R==null)?ll:R;
}},_applyEnabled:function(B,C){if(B===false){this.addState(lY);
this.removeState(iG);

if(qx.Class.isDefined(lW)){this.removeState(mf);
this.removeState(iu);
}}else{this.removeState(lY);
...
},getActiveChild:function(){var bS=this.getFocusRoot();

if(bS){return bS.getActiveChild();
}return null;
},_ontabfocus:qx.lang.Function.returnTrue,_applyFocused:function(ms,mt){if(!this.isCreated()){return;
}var mu=this.getFocusRoot();
if(mu){if(ms){mu.setFocusedChild(this);
this._visualizeFocus();
}else{if(mu.getFocusedChild()==this){mu.setFocusedChild(null);
}this._visualizeBlur();
}}},_applyHideFocus:qx.core.Variant.select(lo,{"mshtml":function(F,G){this.setHtmlProperty(gM,F);
...
},_applyCapture:function(gI,gJ){var gK=qx.legacy.event.handler.EventHandler.getInstance();

if(gJ){gK.setCaptureWidget(null);
}
if(gI){gK.setCaptureWidget(this);
}},_applyZIndex:function(gE,gF){if(gE==null){this.removeStyleProperty(kL);
}else{this.setStyleProperty(kL,gE);
}},_applyTabIndex:qx.core.Variant.select(lo,{"mshtml":function(m,n){this.setHtmlProperty(iC,m<0?-1:1);
},"gecko":function(mg,mh){this.setStyleProperty(kR,(mg<0?hq:lX));
},"default":function(ee,ef){this.setStyleProperty(jm,(ee<0?hq:lX));
this.setHtmlProperty(iC,ee<0?-1:1);
}}),_applySelectable:qx.core.Variant.select(lo,{"mshtml":function(bH,bI){},"gecko":function(fT,fU){if(fT){this.removeStyleProperty(lV);
}else{this.setStyleProperty(lV,lu);
}},"webkit":function(gc,gd){if(gc){this.removeStyleProperty(mc);
}else{this.setStyleProperty(mc,lu);
}},"khtml":function(mp,mq){if(mp){this.removeStyleProperty(iF);
}else{this.setStyleProperty(iF,lu);
}},"default":function(cg,ci){if(cg){return this.removeStyleProperty(iI);
}else{this.setStyleProperty(iI,lu);
}}}),_applyOpacity:qx.core.Variant.select(lo,{"mshtml":function(em,en){if(em==null||em>=1||em<0){this.removeStyleProperty(hj);
}else{this.setStyleProperty(hj,(jj+Math.round(em*100)+kC));
}},"default":function(eg,eh){if(eg==null||eg>1){if(qx.core.Variant.isSet(lo,hh)){this.removeStyleProperty(is);
}else if(qx.core.Variant.isSet(lo,mb)){this.removeStyleProperty(me);
}this.removeStyleProperty(hJ);
}else{eg=qx.lang.Number.limit(eg,0,1);
if(qx.core.Variant.isSet(lo,hh)){this.setStyleProperty(is,eg);
}else if(qx.core.Variant.isSet(lo,mb)){this.setStyleProperty(me,eg);
}this.setStyleProperty(hJ,eg);
}}}),__qJ:qx.core.Variant.select(lo,{"mshtml":{"cursor":iN,"ew-resize":kM,"ns-resize":kI,"nesw-resize":iH,"nwse-resize":iw},"opera":{"col-resize":kM,"row-resize":kI,"ew-resize":kM,"ns-resize":kI,"nesw-resize":iH,"nwse-resize":iw},"default":{}}),_applyCursor:function(fX,fY){if(fX){this.setStyleProperty(iy,this.__qJ[fX]||fX);
}else{this.removeStyleProperty(iy);
}},_applyCommand:function(ej,ek){},_applyBackgroundImage:function(cJ,cK){var cM=qx.legacy.io.image.Manager.getInstance();
var cL=qx.legacy.util.AliasManager.getInstance();

if(cK){cM.hide(cK);
}
if(cJ){cM.show(cJ);
}cL.connect(this._styleBackgroundImage,this,cJ);
},_styleBackgroundImage:function(gH){gH?this.setStyleProperty(hP,ij+qx.util.ResourceManager.getInstance().toUri(gH)+kC):this.removeStyleProperty(hP);
},_applyBackgroundRepeat:function(J,K){J?this.setStyleProperty(it,J):this.removeStyleProperty(it);
},_applyClip:function(fl,fm){return this._compileClipString();
},_compileClipString:function(){var fy=this.getClipLeft();
var fz=this.getClipTop();
var fB=this.getClipWidth();
var fC=this.getClipHeight();
var fA,fx;

if(fy==null){fA=(fB==null?lk:fB+lr);
fy=lk;
}else{fA=(fB==null?lk:fy+fB+lr);
fy=fy+lr;
}
if(fz==null){fx=(fC==null?lk:fC+lr);
fz=lk;
}else{fx=(fC==null?lk:fz+fC+lr);
fz=fz+lr;
}return this.setStyleProperty(ha,(ik+fz+hk+fA+hk+fx+hk+fy+kC));
},_applyOverflow:qx.core.Variant.select(lo,{"default":function(w,x){var z=w;
var y=jp;

switch(w){case lv:y=kD;
z=lw;
break;
case jq:y=hi;
z=lw;
...
for(var i=0;i<a.length;i++){if(a[i]!=y){this.removeStyleProperty(a[i]);
}}
switch(w){case lv:this.setStyleProperty(hi,jo);
break;
case jq:this.setStyleProperty(kD,jo);
break;
}this._renderOverflow(y,z,w,x);
this.addToQueue(jp);
},"gecko":function(dI,dJ){var dL=dI;
var dK=jp;

switch(dL){case jo:dL=lK;
break;
case lv:dL=iY;
break;
case jq:dL=jL;
break;
}this._renderOverflow(dK,dL,dI,dJ);
this.addToQueue(jp);
},"opera":function(dd,de){var dg=dd;
var df=jp;

switch(dg){case lv:case jq:dg=lw;
break;
}this._renderOverflow(df,dg,dd,de);
this.addToQueue(jp);
}}),_renderOverflow:function(fq,fr,fs,ft){this.setStyleProperty(fq,fr||ll);
this._invalidateFrameWidth();
this._invalidateFrameHeight();
},getOverflowX:function(){var eA=this.getOverflow();
return eA==jq?jo:eA;
},getOverflowY:function(){var d=this.getOverflow();
return d==lv?jo:d;
},_applyBackgroundColor:function(bT,bU){qx.legacy.theme.manager.Color.getInstance().connect(this._styleBackgroundColor,this,bT);
},_styleBackgroundColor:function(mi){mi?this.setStyleProperty(hn,mi):this.removeStyleProperty(hn);
},_applyTextColor:function(bq,br){},_applyFont:function(mD,mE){},_cachedBorderTop:0,_cachedBorderRight:0,_cachedBorderBottom:0,_cachedBorderLeft:0,_applyBorder:function(eS,eT){qx.legacy.theme.manager.Border.getInstance().connect(this._queueBorder,this,eS);
},__qK:{top:lH,right:hz,bottom:hD,left:hv},_queueBorder:function(mz,mA){if(!mA){var mC=this.__qK;

for(var mB in mC){this.addToQueue(mC[mB]);
}this.__qM(mz);
this.__qN(mz);
}else{if(mA===lj||mA===jx){this.__qM(mz);
}else{this.__qN(mz);
}this.addToQueue(this.__qK[mA]);
}this.__qL=mz;
},__qM:function(ds){var dt=this._cachedBorderLeft;
var du=this._cachedBorderRight;
this._cachedBorderLeft=ds?ds.getWidthLeft():0;
this._cachedBorderRight=ds?ds.getWidthRight():0;

if((dt+du)!=(this._cachedBorderLeft+this._cachedBorderRight)){this._invalidateFrameWidth();
}},__qN:function(ew){var ey=this._cachedBorderTop;
var ez=this._cachedBorderBottom;
this._cachedBorderTop=ew?ew.getWidthTop():0;
this._cachedBorderBottom=ew?ew.getWidthBottom():0;

if((ey+ez)!=(this._cachedBorderTop+this._cachedBorderBottom)){this._invalidateFrameHeight();
}},renderBorder:function(ff){var fi=this.__qL;

if(fi){if(ff.borderTop){fi.renderTop(this);
}
if(ff.borderRight){fi.renderRight(this);
}
if(ff.borderBottom){fi.renderBottom(this);
}
if(ff.borderLeft){fi.renderLeft(this);
}}else{var fg=qx.legacy.ui.core.Border;

if(ff.borderTop){fg.resetTop(this);
}
if(ff.borderRight){fg.resetRight(this);
}
if(ff.borderBottom){fg.resetBottom(this);
}
if(ff.borderLeft){fg.resetLeft(this);
}}},prepareEnhancedBorder:qx.core.Variant.select(lo,{"gecko":qx.lang.Function.returnTrue,"default":function(){var eY=this.getElement();
var fb=this._borderElement=document.createElement(kH);
var fa=eY.style;
var eX=this._innerStyle=fb.style;
if(qx.core.Variant.isSet(lo,hO)){}else{eX.width=eX.height=hd;
}eX.position=hQ;

for(var i in this._styleProperties){switch(i){case kL:case hj:case lp:break;
default:eX[i]=fa[i];
fa[i]=ll;
}}
for(var i in this._htmlProperties){switch(i){case kf:fb.unselectable=this._htmlProperties[i];
}}while(eY.firstChild){fb.appendChild(eY.firstChild);
}eY.appendChild(fb);
}}),_applyPaddingTop:function(dT,dU){this.addToQueue(hN);
this._invalidateFrameHeight();
},_applyPaddingRight:function(gx,gy){this.addToQueue(iE);
this._invalidateFrameWidth();
},_applyPaddingBottom:function(ga,gb){this.addToQueue(iD);
this._invalidateFrameHeight();
},_applyPaddingLeft:function(fQ,fR){this.addToQueue(hI);
this._invalidateFrameWidth();
},renderPadding:function(dN){},_applyMarginLeft:function(D,E){this.addToQueue(iz);
},_applyMarginRight:function(bQ,bR){this.addToQueue(hM);
},_applyMarginTop:function(fu,fv){this.addToQueue(hK);
},_applyMarginBottom:function(eF,eG){this.addToQueue(ho);
},execute:function(){var fN=this.getCommand();

if(fN){fN.execute(this);
}this.fireEvent(gY);
},_visualPropertyCheck:function(){if(!this.isCreated()){throw new Error(this.classname+": Element must be created previously!");
}},setScrollLeft:function(U){this._visualPropertyCheck();
this._getTargetNode().scrollLeft=U;
},setScrollTop:function(fp){this._visualPropertyCheck();
this._getTargetNode().scrollTop=fp;
...
},scrollIntoView:function(H){this.scrollIntoViewX(H);
this.scrollIntoViewY(H);
},scrollIntoViewX:function(ba){if(!this._isCreated||!this._isDisplayable){return false;
}return qx.legacy.html.ScrollIntoView.scrollX(this.getElement(),ba);
},scrollIntoViewY:function(bY){if(!this._isCreated||!this._isDisplayable){return false;
}return qx.legacy.html.ScrollIntoView.scrollY(this.getElement(),bY);
},supportsDrop:function(bd){var be=this.getSupportsDropMethod();

if(be!==null){return be.call(this,bd);
}return (this!=bd.sourceWidget);
}},settings:{"qx.widgetQueueDebugging":false,"qx.widgetDebugId":false},defer:function(fV,fW){qx.legacy.core.Property.addCachedProperty({name:kS,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:kV,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:lL,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:hu,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:gO,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:gQ,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:hA,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:iL,defaultValue:null},fW);
qx.legacy.core.Property.addCachedProperty({name:jS,defaultValue:null,addToQueueRuntime:true},fW);
qx.legacy.core.Property.addCachedProperty({name:ii,defaultValue:null,addToQueueRuntime:true},fW);
qx.legacy.core.Property.addCachedProperty({name:hw,defaultValue:null,addToQueueRuntime:true},fW);
qx.legacy.core.Property.addCachedProperty({name:io,defaultValue:null,addToQueueRuntime:true},fW);
qx.legacy.core.Property.addCachedProperty({name:jE,defaultValue:false},fW);
qx.legacy.core.Property.addCachedProperty({name:jH,defaultValue:false},fW);
qx.legacy.core.Property.addCachedProperty({name:kv,defaultValue:false},fW);
qx.legacy.core.Property.addCachedProperty({name:jW,defaultValue:false},fW);
qx.legacy.core.Property.addCachedProperty({name:jn,defaultValue:false},fW);
qx.legacy.core.Property.addCachedProperty({name:kk,defaultValue:false},fW);
fV.__qF(fW);
if(qx.core.Variant.isSet(lo,hO)){fW._renderRuntimeWidth=function(v){this._style.pixelWidth=(v==null)?0:v;

if(this._innerStyle){this._innerStyle.pixelWidth=(v==null)?0:v-2;
}};
fW._renderRuntimeHeight=function(v){this._style.pixelHeight=(v==null)?0:v;

if(this._innerStyle){this._innerStyle.pixelHeight=(v==null)?0:v-2;
}};
fW._resetRuntimeWidth=function(){this._style.width=ll;

if(this._innerStyle){this._innerStyle.width=ll;
}};
fW._resetRuntimeHeight=function(){this._style.height=ll;

if(this._innerStyle){this._innerStyle.height=ll;
}};
}fV.__qG(fV);
fV.__qO=new qx.util.DeferredCall(qx.legacy.ui.core.Widget.flushGlobalQueues,qx.legacy.ui.core.Widget);
},destruct:function(){var dy=this.getElement();

if(dy){dy.qx_Widget=null;
}this._disposeFields(kg,hs,jD,hF,jY,ig,kp,jB,ka,lM,kT,hc,lz,jc);
}});
})();
...
(function(){var c="qx.legacy.event.WidgetBubbling";
qx.Class.define(c,{extend:qx.event.dispatch.AbstractBubbling,statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL},members:{_getParent:function(d){return d.getParent();
},canDispatchEvent:function(a,event,b){return a instanceof qx.legacy.ui.core.Widget&&event.getBubbles();
}},defer:function(e){qx.event.Registration.addDispatcher(e);
}});
})();
(function(){var l="qx.client",k="overflow",j="1px",i="hidden",g="scroll",f="qx.legacy.html.Dimension",e="-moz-scrollbars-vertical",d="overflowX",c="-moz-scrollbars-horizontal",b="overflowY";
qx.Class.define(f,{statics:{getOuterWidth:function(F){return qx.legacy.html.Dimension.getBoxWidth(F)+qx.legacy.html.Style.getMarginLeft(F)+qx.legacy.html.Style.getMarginRight(F);
},getOuterHeight:function(z){return qx.legacy.html.Dimension.getBoxHeight(z)+qx.legacy.html.Style.getMarginTop(z)+qx.legacy.html.Style.getMarginBottom(z);
},getBoxWidthForZeroHeight:function(r){var h=r.offsetHeight;

if(h==0){var o=r.style.height;
r.style.height=j;
}var v=r.offsetWidth;

if(h==0){r.style.height=o;
}return v;
},getBoxHeightForZeroWidth:function(a){var w=a.offsetWidth;

if(w==0){var o=a.style.width;
a.style.width=j;
}var v=a.offsetHeight;

if(w==0){a.style.width=o;
}return v;
},getBoxWidth:function(C){return C.offsetWidth;
},getBoxHeight:function(P){return P.offsetHeight;
},getAreaWidth:qx.core.Variant.select(l,{"gecko":function(L){if(L.clientWidth!=0&&L.clientWidth!=(qx.legacy.html.Style.getBorderLeft(L)+qx.legacy.html.Style.getBorderRight(L))){return L.clientWidth;
}else{return qx.legacy.html.Dimension.getBoxWidth(L)-qx.legacy.html.Dimension.getInsetLeft(L)-qx.legacy.html.Dimension.getInsetRight(L);
}},"default":function(t){return t.clientWidth!=0?t.clientWidth:(qx.legacy.html.Dimension.getBoxWidth(t)-qx.legacy.html.Dimension.getInsetLeft(t)-qx.legacy.html.Dimension.getInsetRight(t));
}}),getAreaHeight:qx.core.Variant.select(l,{"gecko":function(J){if(J.clientHeight!=0&&J.clientHeight!=(qx.legacy.html.Style.getBorderTop(J)+qx.legacy.html.Style.getBorderBottom(J))){return J.clientHeight;
}else{return qx.legacy.html.Dimension.getBoxHeight(J)-qx.legacy.html.Dimension.getInsetTop(J)-qx.legacy.html.Dimension.getInsetBottom(J);
}},"default":function(y){return y.clientHeight!=0?y.clientHeight:(qx.legacy.html.Dimension.getBoxHeight(y)-qx.legacy.html.Dimension.getInsetTop(y)-qx.legacy.html.Dimension.getInsetBottom(y));
}}),getInnerWidth:function(B){return qx.legacy.html.Dimension.getAreaWidth(B)-qx.legacy.html.Style.getPaddingLeft(B)-qx.legacy.html.Style.getPaddingRight(B);
},getInnerHeight:function(G){return qx.legacy.html.Dimension.getAreaHeight(G)-qx.legacy.html.Style.getPaddingTop(G)-qx.legacy.html.Style.getPaddingBottom(G);
},getInsetLeft:qx.core.Variant.select(l,{"mshtml":function(D){return D.clientLeft;
},"default":function(E){return qx.legacy.html.Style.getBorderLeft(E);
}}),getInsetTop:qx.core.Variant.select(l,{"mshtml":function(H){return H.clientTop;
},"default":function(I){return qx.legacy.html.Style.getBorderTop(I);
}}),getInsetRight:qx.core.Variant.select(l,{"mshtml":function(m){if(qx.legacy.html.Style.getStyleProperty(m,b)==i||m.clientWidth==0){return qx.legacy.html.Style.getBorderRight(m);
}return Math.max(0,m.offsetWidth-m.clientLeft-m.clientWidth);
},"default":function(M){if(M.clientWidth==0){var N=qx.legacy.html.Style.getStyleProperty(M,k);
var O=N==g||N==e?16:0;
return Math.max(0,qx.legacy.html.Style.getBorderRight(M)+O);
}return Math.max(0,M.offsetWidth-M.clientWidth-qx.legacy.html.Style.getBorderLeft(M));
}}),getInsetBottom:qx.core.Variant.select(l,{"mshtml":function(R){if(qx.legacy.html.Style.getStyleProperty(R,d)==i||R.clientHeight==0){return qx.legacy.html.Style.getBorderBottom(R);
}return Math.max(0,R.offsetHeight-R.clientTop-R.clientHeight);
},"default":function(n){if(n.clientHeight==0){var p=qx.legacy.html.Style.getStyleProperty(n,k);
var q=p==g||p==c?16:0;
return Math.max(0,qx.legacy.html.Style.getBorderBottom(n)+q);
}return Math.max(0,n.offsetHeight-n.clientHeight-qx.legacy.html.Style.getBorderTop(n));
}}),getScrollBarSizeLeft:function(A){return 0;
},getScrollBarSizeTop:function(K){return 0;
},getScrollBarSizeRight:function(s){return qx.legacy.html.Dimension.getInsetRight(s)-qx.legacy.html.Style.getBorderRight(s);
},getScrollBarSizeBottom:function(Q){return qx.legacy.html.Dimension.getInsetBottom(Q)-qx.legacy.html.Style.getBorderBottom(Q);
},getScrollBarVisibleX:function(x){return qx.legacy.html.Dimension.getScrollBarSizeRight(x)>0;
},getScrollBarVisibleY:function(u){return qx.legacy.html.Dimension.getScrollBarSizeBottom(u)>0;
}}});
})();
(function(){var p="none",o="",n="noComputed",m="qx.client",l="hasComputed",k="borderBottomWidth",j="borderLeftStyle",i="paddingLeft",h="borderRightStyle",g="borderRightWidth",C="qx.legacy.html.Style",B="borderTopWidth",A="borderLeftWidth",z="marginBottom",y="marginTop",x="borderTopStyle",w="marginLeft",v="borderBottomStyle",u="paddingBottom",t="paddingTop",r="marginRight",s="paddingRight",q="undefined";
qx.Class.define(C,{statics:{getStylePropertySure:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?l:n,{"hasComputed":function(E,F){return !E?null:E.ownerDocument?E.ownerDocument.defaultView.getComputedStyle(E,o)[F]:E.style[F];
},"noComputed":qx.core.Variant.select(m,{"mshtml":function(H,I){try{if(!H){return null;
}
if(H.parentNode&&H.currentStyle){return H.currentStyle[I];
}else{var J=H.runtimeStyle[I];

if(J!=null&&typeof J!=q&&J!=o){return J;
}return H.style[I];
}}catch(c){throw new Error("Could not evaluate computed style: "+H+"["+I+"]: "+c);
}},"default":function(bb,bc){return !bb?null:bb.style[bc];
}})}),getStyleProperty:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?l:n,{"hasComputed":function(S,T){try{return S.ownerDocument.defaultView.getComputedStyle(S,o)[T];
}catch(L){throw new Error("Could not evaluate computed style: "+S+"["+T+"]: "+L);
}},"noComputed":qx.core.Variant.select(m,{"mshtml":function(Q,R){try{return Q.currentStyle[R];
}catch(ba){throw new Error("Could not evaluate computed style: "+Q+"["+R+"]: "+ba);
}},"default":function(N,O){try{return N.style[O];
}catch(Y){throw new Error("Could not evaluate computed style: "+N+"["+O+"]");
}}})}),getStyleSize:function(e,f){return parseInt(qx.legacy.html.Style.getStyleProperty(e,f))||0;
},getMarginLeft:function(b){return qx.legacy.html.Style.getStyleSize(b,w);
},getMarginTop:function(D){return qx.legacy.html.Style.getStyleSize(D,y);
},getMarginRight:function(U){return qx.legacy.html.Style.getStyleSize(U,r);
},getMarginBottom:function(G){return qx.legacy.html.Style.getStyleSize(G,z);
},getPaddingLeft:function(M){return qx.legacy.html.Style.getStyleSize(M,i);
},getPaddingTop:function(W){return qx.legacy.html.Style.getStyleSize(W,t);
},getPaddingRight:function(a){return qx.legacy.html.Style.getStyleSize(a,s);
},getPaddingBottom:function(K){return qx.legacy.html.Style.getStyleSize(K,u);
},getBorderLeft:function(X){return qx.legacy.html.Style.getStyleProperty(X,j)==p?0:qx.legacy.html.Style.getStyleSize(X,A);
},getBorderTop:function(V){return qx.legacy.html.Style.getStyleProperty(V,x)==p?0:qx.legacy.html.Style.getStyleSize(V,B);
},getBorderRight:function(d){return qx.legacy.html.Style.getStyleProperty(d,h)==p?0:qx.legacy.html.Style.getStyleSize(d,g);
},getBorderBottom:function(P){return qx.legacy.html.Style.getStyleProperty(P,v)==p?0:qx.legacy.html.Style.getStyleSize(P,k);
}}});
})();
(function(){var bk="_childrenQueue",bj="qx.legacy.ui.popup.ToolTipManager",bi="keypress",bh="qx.legacy.ui.core.Widget",bg="_cachedVisibleChildren",bf="changeFocusedChild",be="blur",bd="keydown",bc="first",bb="_layoutImpl",bP="focus",bO="removeAll",bN="return this._remappingChildTarget.",bM="qx.client",bL="_applyActiveChild",bK="_focusHandler",bJ="_children",bI="addAtBegin",bH="visibleChildren",bG="addBefore",br="qx.legacy.ui.popup.PopupManager",bs=".apply(this._remappingChildTarget, arguments)",bp="addAfter",bq="_remappingChildTarget",bn="remove",bo="_remappingChildTable",bl="qx.legacy.ui.core.Parent",bm="add",bt="qx.legacy.event.handler.FocusHandler",bu="opera",by="addAtEnd",bx="removeAt",bA="focusin",bz="abstract",bC="focusout",bB="none",bw="_applyFocusHandler",bF="addAt",bE="changeActiveChild",bD="_applyFocusedChild",bv="last";
qx.Class.define(bl,{extend:qx.legacy.ui.core.Widget,type:bz,construct:function(){arguments.callee.base.call(this);
this._children=[];
this._childrenQueue={};
this._layoutImpl=this._createLayoutImpl();
},properties:{focusHandler:{check:bt,apply:bw,nullable:true},activeChild:{check:bh,apply:bL,event:bE,nullable:true},focusedChild:{check:bh,apply:bD,event:bf,nullable:true}},members:{isFocusRoot:function(){return this.getFocusHandler()!=null;
...
},_applyFocusHandler:function(bQ,bR){if(bQ){this.addListener(bi,this._onfocuskeyevent);
if(this.getTabIndex()<1){this.setTabIndex(1);
}this.setHideFocus(true);
this.setActiveChild(this);
}else{this.removeListener(bd,this._onfocuskeyevent);
this.removeListener(bi,this._onfocuskeyevent);
this.setTabIndex(-1);
this.setHideFocus(false);
}},_applyActiveChild:function(j,k){},_applyFocusedChild:function(Q,R){var U=Q!=null;
var W=R!=null;

if(qx.Class.isDefined(br)&&U){var S=qx.legacy.ui.popup.PopupManager.getInstance();

if(S){S.update(Q);
}}
if(W){var T=qx.event.Registration.createEvent(bC,qx.legacy.event.type.FocusEvent);
T.setBubbles(true);

if(U){T.setRelatedTarget(Q);
}R.dispatchEvent(T);
}
if(U){var T=qx.event.Registration.createEvent(bA,qx.legacy.event.type.FocusEvent);
T.setBubbles(true);

if(W){T.setRelatedTarget(R);
}Q.dispatchEvent(T);
}
if(W){if(this.getActiveChild()==R&&!U){this.setActiveChild(null);
}R.setFocused(false);
var T=qx.event.Registration.createEvent(be,qx.legacy.event.type.FocusEvent);

if(U){T.setRelatedTarget(Q);
}R.dispatchEvent(T);

if(qx.Class.isDefined(bj)){var S=qx.legacy.ui.popup.ToolTipManager.getInstance();

if(S){S.handleBlur(T);
}}}
if(U){this.setActiveChild(Q);
Q.setFocused(true);
qx.legacy.event.handler.EventHandler.getInstance().setFocusRoot(this);
var T=qx.event.Registration.createEvent(bP,qx.legacy.event.type.FocusEvent);
...
},indexOf:function(ck){return this.getChildren().indexOf(ck);
},contains:function(P){switch(P){case null:return false;
case this:return true;
default:return this.contains(P.getParent());
}},_computeVisibleChildren:function(){var cB=[];
var cD=this.getChildren();

if(!cD){return 0;
}var cC=cD.length;

for(var i=0;i<cC;i++){var cA=cD[i];

if(cA._isDisplayable){cB.push(cA);
}}return cB;
...
},addAt:function(cw,cx){if(cx==null||cx<0){throw new Error("Not a valid index for addAt(): "+cx);
}
if(cw.getParent()==this){var cz=this.getChildren();
var cy=cz.indexOf(cw);

if(cy!=cx){if(cy!=-1){qx.lang.Array.removeAt(cz,cy);
}qx.lang.Array.insertAt(cz,cw,cx);

if(this._initialLayoutDone){this._invalidateVisibleChildren();
this.getLayoutImpl().updateChildrenOnMoveChild(cw,cx,cy);
}}}else{cw._insertIndex=cx;
cw.setParent(this);
}},addAtBegin:function(N){return this.addAt(N,0);
},addAtEnd:function(f){var g=this.getChildrenLength();
return this.addAt(f,f.getParent()==this?g-1:g);
},addBefore:function(H,I){var K=this.getChildren();
var L=K.indexOf(I);

if(L==-1){throw new Error("Child to add before: "+I+" is not inside this parent.");
}var J=K.indexOf(H);

if(J==-1||J>L){L++;
}return this.addAt(H,Math.max(0,L-1));
},addAfter:function(u,v){var x=this.getChildren();
var y=x.indexOf(v);

if(y==-1){throw new Error("Child to add after: "+v+" is not inside this parent.");
}var w=x.indexOf(u);

if(w!=-1&&w<y){y--;
}return this.addAt(u,Math.min(x.length,y+1));
},remove:function(m){var n;

for(var i=0,l=arguments.length;i<l;i++){n=arguments[i];

if(!(n instanceof qx.legacy.ui.core.Parent)&&!(n instanceof qx.legacy.ui.basic.Terminator)){throw new Error("Invalid Widget: "+n);
}else if(n.getParent()==this){n.setParent(null);
}}},removeAt:function(D){var E=this.getChildren()[D];

if(E){delete E._insertIndex;
E.setParent(null);
}},removeAll:function(){var ca=this.getChildren();
var cb=ca[0];

while(cb){this.remove(cb);
cb=ca[0];
}},getFirstChild:function(){return this.getChildren()[0]||null;
},getFirstVisibleChild:function(){return this.getVisibleChildren()[0]||null;
},getFirstActiveChild:function(h){return qx.legacy.ui.core.Widget.getActiveSiblingHelper(null,this,1,h,bc)||null;
},getLastChild:function(){var cj=this.getChildren();
return cj[cj.length-1]||null;
},getLastVisibleChild:function(){var O=this.getVisibleChildren();
return O[O.length-1]||null;
},getLastActiveChild:function(cq){return qx.legacy.ui.core.Widget.getActiveSiblingHelper(null,this,-1,cq,bv)||null;
},forEachChild:function(cl){var cn=this.getChildren(),cm,i=-1;

if(!cn){return;
}
while(cm=cn[++i]){cl.call(cm,i);
}},forEachVisibleChild:function(bV){var bX=this.getVisibleChildren(),bW,i=-1;

if(!bX){return;
}
while(bW=bX[++i]){bV.call(bW,i);
...
},_handleDisplayableCustom:function(ct,cu,cv){this.forEachChild(function(){this._handleDisplayable();
});
...
},_recursiveAppearanceThemeUpdate:function(bS,bT){arguments.callee.base.call(this,bS,bT);
this.forEachVisibleChild(function(){this._recursiveAppearanceThemeUpdate(bS,bT);
});
},_addChildToChildrenQueue:function(bU){if(!bU._isInParentChildrenQueue&&!bU._isDisplayable){this.warn("Ignoring invisible child: "+bU);
return;
}
if(!bU._isInParentChildrenQueue&&bU._isDisplayable){qx.legacy.ui.core.Widget.addToGlobalLayoutQueue(this);
this._childrenQueue[bU.toHashCode()]=bU;
}},_removeChildFromChildrenQueue:function(M){if(M._isInParentChildrenQueue){delete this._childrenQueue[M.toHashCode()];
...
},_layoutChild:function(q){if(!q._isDisplayable){return ;
}var r=q._layoutChanges;
try{if(q.renderBorder){if(r.borderTop||r.borderRight||r.borderBottom||r.borderLeft){q.renderBorder(r);
}}}catch(cr){this.error("Could not apply border to child "+q,cr);
}
try{if(q.renderPadding){if(r.paddingLeft||r.paddingRight||r.paddingTop||r.paddingBottom){q.renderPadding(r);
}}}catch(d){this.error("Could not apply padding to child "+q,d);
}try{this.getLayoutImpl().layoutChild(q,r);
}catch(cp){this.error("Could not layout child "+q+" through layout handler",cp);
}try{q._layoutPost(r);
}catch(o){this.error("Could not post layout child "+q,o);
}try{if(r.initial){q._initialLayoutDone=true;
qx.legacy.ui.core.Widget.addToGlobalDisplayQueue(q);
}}catch(bY){this.error("Could not handle display updates from layout flush for child "+q,bY);
}q._layoutChanges={};
delete q._isInParentLayoutQueue;
delete this._childrenQueue[q.toHashCode()];
...
},_changeInnerWidth:function(ce,cf){var cg=this.getLayoutImpl();

if(cg.invalidateChildrenFlexWidth){cg.invalidateChildrenFlexWidth();
}this.forEachVisibleChild(function(){if(cg.updateChildOnInnerWidthChange(this)&&this._recomputeBoxWidth()){this._recomputeOuterWidth();
this._recomputeInnerWidth();
}});
},_changeInnerHeight:function(X,Y){var ba=this.getLayoutImpl();

if(ba.invalidateChildrenFlexHeight){ba.invalidateChildrenFlexHeight();
}this.forEachVisibleChild(function(){if(ba.updateChildOnInnerHeightChange(this)&&this._recomputeBoxHeight()){this._recomputeOuterHeight();
this._recomputeInnerHeight();
}});
},getInnerWidthForChild:function(G){return this.getInnerWidth();
},getInnerHeightForChild:function(ci){return this.getInnerHeight();
},_remappingChildTable:[bm,bn,bF,bI,by,bx,bG,bp,bO],_remapStart:bN,_remapStop:bs,remapChildrenHandlingTo:function(F){var t=this._remappingChildTable;
this._remappingChildTarget=F;
...
}}},defer:function(a,b,c){qx.legacy.core.Property.addCachedProperty({name:bH,defaultValue:null},b);
if(qx.core.Variant.isSet(bM,bu)){b._layoutChildOrig=b._layoutChild;
b._layoutChild=function(z){if(!z._initialLayoutDone||!z._layoutChanges.border){return this._layoutChildOrig(z);
}var A=z.getElement().style;
var B=A.display;
A.display=bB;
var C=this._layoutChildOrig(z);
A.display=B;
return C;
};
}},destruct:function(){this._disposeArray(bJ);
this._disposeObjects(bb,bK);
this._disposeFields(bk,bk,bo,bq,bg);
}});
})();
...
(function(){var r="qx.event.type.Event",q="",p="qx.legacy.util.NativeWindow",n=":border-box;",m="auto",k="pointer",j="hand",h="*",g=":content-box;",f="cursor:",U="mousedown",T="_document",S="img{",R="client-document",Q="html,body { margin:0;border:0;padding:0; } ",P="qx.client",O="_window",N="singleton",M="changeGlobalCursor",L="_modalWidgets",y="qx.enableApplicationLayout",z="qx.legacy.ui.popup.PopupManager",w="}",x=" !important",u="qx.legacy.ui.window.Window",v="*{",s="String",t="windowresize",A="BackgroundImageCache",B="_globalCursorStyleSheet",E="_blocker",D="_modalNativeWindow",G="_applyGlobalCursor",F="qx.boxModelCorrection",I="mouseup",H="html,body{width:100%;height:100%;overflow:hidden;}",C="html { border:0 none; } ",K="} ",J="qx.legacy.ui.core.ClientDocument";
qx.Class.define(J,{type:N,extend:qx.legacy.ui.layout.CanvasLayout,construct:function(){arguments.callee.base.call(this);
if(qx.core.Setting.get(F)){var bf=qx.legacy.core.Client.getInstance().getEngineBoxSizingAttributes();
var bh=bf.join(n)+n;
var bg=bf.join(g)+g;
qx.bom.Stylesheet.createElement(Q+C+v+bh+K+S+bg+w);
}
if(qx.core.Setting.get(y)){qx.bom.Stylesheet.createElement(H);
}this._window=window;
this._document=window.document;
this.setElement(this._document.body);
this._document.body.style.position=q;
try{document.execCommand(A,false,true);
}catch(V){}this._cachedInnerWidth=this._document.body.offsetWidth;
this._cachedInnerHeight=this._document.body.offsetHeight;
this.addListener(t,this._onwindowresize);
this._modalWidgets=[];
...
this.initSelectable();
qx.legacy.event.handler.EventHandler.getInstance().setFocusRoot(this);
},events:{"focus":r,"windowblur":r,"windowfocus":r,"windowresize":r},properties:{appearance:{refine:true,init:R},enableElementFocus:{refine:true,init:false},enabled:{refine:true,init:true},selectable:{refine:true,init:false},hideFocus:{refine:true,init:true},globalCursor:{check:s,nullable:true,themeable:true,apply:G,event:M}},members:{_applyParent:qx.lang.Function.returnTrue,getTopLevelWidget:qx.lang.Function.returnThis,getWindowElement:function(){return this._window;
...
this._blocker.addListener(U,this.blockHelper,this);
this._blocker.addListener(I,this.blockHelper,this);
...
}}},block:function(bd){this._getBlocker().show();

if(qx.Class.isDefined(u)&&bd instanceof qx.legacy.ui.window.Window){this._modalWidgets.push(bd);
var be=bd.getZIndex();
this._getBlocker().setZIndex(be);
bd.setZIndex(be+1);
}else if(qx.Class.isDefined(p)&&bd instanceof qx.legacy.util.NativeWindow){this._modalNativeWindow=bd;
this._getBlocker().setZIndex(1e7);
}},release:function(W){if(W){if(qx.Class.isDefined(p)&&W instanceof qx.legacy.util.NativeWindow){this._modalNativeWindow=null;
}else{qx.lang.Array.remove(this._modalWidgets,W);
}}var l=this._modalWidgets.length;

if(l==0){this._getBlocker().hide();
}else{var X=this._modalWidgets[l-1];
var o=X.getZIndex();
this._getBlocker().setZIndex(o);
X.setZIndex(o+1);
}},createStyleElement:function(bo){return qx.bom.Stylesheet.createElement(bo);
},addCssRule:function(ba,bb,bc){return qx.bom.Stylesheet.addRule(ba,bb,bc);
},removeCssRule:function(a,b){return qx.bom.Stylesheet.removeRule(a,b);
},removeAllCssRules:function(Y){return qx.bom.Stylesheet.removeAllRules(Y);
},_applyGlobalCursor:qx.core.Variant.select(P,{"mshtml":function(bi,bj){if(bi==k){bi=j;
}
if(bj==k){bj=j;
}var bm,bn;
...
if(bi!=null&&bi!=q&&bi!=m){for(var i=0,l=bk.length;i<l;i++){bm=bk[i];
bn=bm.style.cursor;

if(bn!=null&&bn!=q&&bn!=m){bm._oldCursor=bn;
bm.style.cursor=bi;
bl.push(bm);
}}document.body.style.cursor=bi;
}else{document.body.style.cursor=q;
}},"default":function(c,d){if(!this._globalCursorStyleSheet){this._globalCursorStyleSheet=this.createStyleElement();
}this.removeCssRule(this._globalCursorStyleSheet,h);

if(c){this.addCssRule(this._globalCursorStyleSheet,h,f+c+x);
}}}),_onwindowresize:function(e){if(qx.Class.isDefined(z)){qx.legacy.ui.popup.PopupManager.getInstance().update();
}this._recomputeInnerWidth();
this._recomputeInnerHeight();
qx.legacy.ui.core.Widget.flushGlobalQueues();
...
}},settings:{"qx.enableApplicationLayout":true,"qx.boxModelCorrection":true},destruct:function(){this._disposeObjects(E);
this._disposeFields(O,T,L,D,B);
}});
})();
...
(function(){var D="mousedown",C="mouseup",B="qx.client",A="mouseover",z="click",y="qx.legacy.ui.menu.Manager",x="gecko",w="dblclick",v="mouseout",u="dragover",bD="qx.legacy.event.handler.DragAndDropHandler",bC="dragenter",bB="qx.legacy.ui.popup.ToolTipManager",bA="contextmenu",bz="blur",by="Boolean",bx="draggesture",bw="dragdrop",bv="keydown",bu="dragexit",K="mousewheel",L="qx.legacy.ui.popup.PopupManager",I="mousemove",J="resize",G="dragstart",H="focus",E="dragleave",F="DOMMouseScroll",Q="drag",R="qx.legacy.ui.embed.IframeManager",ba="__qS",X="Escape",bi="__qR",bd="textarea",bq="__qT",bn="singleton",T="qx.event.type.Data",bt="A",bs="error",br="__qQ",S="input",V="Tab",W="windowblur",Y="_lastMouseDown",bb="qx.legacy.event.handler.EventHandler",be="_lastMouseDownDispatchTarget",bk="qx.legacy.ui.core.Parent",bp="windowresize",M="__qP",N="_lastMouseEventDate",U="_lastMouseEventType",bh="__qU",bg="_applyCaptureWidget",bf="qx.legacy.ui.core.Widget",bm="_commands",bl="keyup",bc="windowfocus",bj="_applyFocusRoot",t="keypress",bo="_lastMouseDownDomTarget",O="dragend",P="iframe";
qx.Class.define(bb,{type:bn,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__qP=qx.lang.Function.bind(this._onmouseevent,this);
this.__qQ=qx.lang.Function.bind(this._ondragevent,this);
this.__qR=qx.lang.Function.bind(this._onselectevent,this);
this.__qS=qx.lang.Function.bind(this._onwindowblur,this);
this.__qT=qx.lang.Function.bind(this._onwindowfocus,this);
this.__qU=qx.lang.Function.bind(this._onwindowresize,this);
this._commands={};
},events:{"error":T},statics:{mouseEventTypes:[A,I,v,D,C,z,w,bA,qx.core.Variant.isSet(B,x)?F:K],keyEventTypes:[bv,t,bl],dragEventTypes:qx.core.Variant.select(B,{"gecko":[bw,u,bC,bu,bx],"mshtml":[O,u,G,Q,bC,E],"default":[G,bw,u,Q,E,bC,bu,bx]}),getDomTarget:qx.core.Variant.select(B,{"mshtml":function(cM){return cM.target||cM.srcElement;
},"webkit":function(n){var o=n.target||n.srcElement;
if(o&&(o.nodeType==qx.dom.Node.TEXT)){o=o.parentNode;
}return o;
},"default":function(bS){return bS.target;
}}),stopDomEvent:function(cd){if(cd.preventDefault){cd.preventDefault();
}cd.returnValue=false;
},getOriginalTargetObject:function(bH){if(bH==document.documentElement){bH=document.body;
}while(bH!=null&&bH.qx_Widget==null){try{bH=bH.parentNode;
}catch(bG){bH=null;
}}return bH?bH.qx_Widget:null;
},getOriginalTargetObjectFromEvent:function(cl,cm){var co=qx.legacy.event.handler.EventHandler.getDomTarget(cl);
if(cm){var cn=cm.document;

if(co==cm||co==cn||co==cn.documentElement||co==cn.body){return cn.body.qx_Widget;
}}return qx.legacy.event.handler.EventHandler.getOriginalTargetObject(co);
},getRelatedOriginalTargetObjectFromEvent:function(cN){return qx.legacy.event.handler.EventHandler.getOriginalTargetObject(cN.relatedTarget||(cN.type==A?cN.fromElement:cN.toElement));
},getTargetObject:function(c,d,f){if(!d){var d=qx.legacy.event.handler.EventHandler.getOriginalTargetObject(c);

if(!d){return null;
}}while(d){if(!f&&!d.getEnabled()){return null;
}if(!d.getAnonymous()){break;
}d=d.getParent();
}return d;
},getTargetObjectFromEvent:function(ck){return qx.legacy.event.handler.EventHandler.getTargetObject(qx.legacy.event.handler.EventHandler.getDomTarget(ck));
},getRelatedTargetObjectFromEvent:function(ct){var cu=ct.relatedTarget;

if(!cu){if(ct.type==A){cu=ct.fromElement;
}else{cu=ct.toElement;
}}return qx.legacy.event.handler.EventHandler.getTargetObject(cu);
}},properties:{allowClientContextMenu:{check:by,init:false},allowClientSelectAll:{check:by,init:false},captureWidget:{check:bf,nullable:true,apply:bg},focusRoot:{check:bk,nullable:true,apply:bj}},members:{_lastMouseEventType:null,_lastMouseDown:false,_lastMouseEventDate:0,_applyCaptureWidget:function(k,m){if(m){m.setCapture(false);
}
if(k){k.setCapture(true);
}},_applyFocusRoot:function(cp,cq){if(cq){cq.setFocusedChild(null);
}
if(cp&&cp.getFocusedChild()==null){cp.setFocusedChild(cp);
}},addCommand:function(b){this._commands[b.toHashCode()]=b;
},removeCommand:function(bF){delete this._commands[bF.toHashCode()];
},_checkKeyEventMatch:function(e){var cb;

for(var cc in this._commands){cb=this._commands[cc];

if(cb.getEnabled()&&cb.matchesKeyEvent(e)){if(!cb.execute(e.getTarget())){e.preventDefault();
}break;
}}},attachEvents:function(){this.attachEventTypes(qx.legacy.event.handler.EventHandler.mouseEventTypes,this.__qP);
this.attachEventTypes(qx.legacy.event.handler.EventHandler.dragEventTypes,this.__qQ);
qx.legacy.event.handler.KeyEventHandler.getInstance()._attachEvents();
qx.legacy.html.EventRegistration.addListener(window,bz,this.__qS);
qx.legacy.html.EventRegistration.addListener(window,H,this.__qT);
qx.legacy.html.EventRegistration.addListener(window,J,this.__qU);
document.body.onselect=document.onselectstart=document.onselectionchange=this.__qR;
},detachEvents:function(){this.detachEventTypes(qx.legacy.event.handler.EventHandler.mouseEventTypes,this.__qP);
this.detachEventTypes(qx.legacy.event.handler.EventHandler.dragEventTypes,this.__qQ);
qx.legacy.event.handler.KeyEventHandler.getInstance()._detachEvents();
qx.legacy.html.EventRegistration.removeListener(window,bz,this.__qS);
qx.legacy.html.EventRegistration.removeListener(window,H,this.__qT);
qx.legacy.html.EventRegistration.removeListener(window,J,this.__qU);
document.body.onselect=document.onselectstart=document.onselectionchange=null;
},attachEventTypes:function(g,h){try{var j=qx.core.Variant.isSet(B,x)?window:document.body;

for(var i=0,l=g.length;i<l;i++){qx.legacy.html.EventRegistration.addListener(j,g[i],h);
}}catch(bE){throw new Error("qx.legacy.event.handler.EventHandler: Failed to attach window event types: "+g+": "+bE);
}},detachEventTypes:function(ce,cf){try{var cg=qx.core.Variant.isSet(B,x)?window:document.body;

for(var i=0,l=ce.length;i<l;i++){qx.legacy.html.EventRegistration.removeListener(cg,ce[i],cf);
}}catch(bR){throw new Error("qx.legacy.event.handler.EventHandler: Failed to detach window event types: "+ce+": "+bR);
}},_onkeyevent_post:function(bI,bJ,bK,bL,bM){var bQ=qx.legacy.event.handler.EventHandler.getDomTarget(bI);
var bO=this.getFocusRoot();
var bP=this.getCaptureWidget()||(bO==null?null:bO.getActiveChild());
var bN=new qx.legacy.event.type.KeyEvent(bJ,bI,bQ,bP,null,bK,bL,bM);
if(bJ==bv){this._checkKeyEventMatch(bN);
}
if(bP!=null&&bP.getEnabled()){switch(bM){case X:case V:if(qx.Class.isDefined(y)){qx.legacy.ui.menu.Manager.getInstance().update(bP,bJ);
}break;
}if(!this.getAllowClientSelectAll()){if(bI.ctrlKey&&bM==bt){switch(bQ.tagName.toLowerCase()){case S:case bd:case P:break;
default:qx.legacy.event.handler.EventHandler.stopDomEvent(bI);
}}}
try{bP.dispatchEvent(bN);
if(qx.Class.isDefined(bD)){qx.legacy.event.handler.DragAndDropHandler.getInstance().handleKeyEvent(bN);
}}catch(cr){this.error("Failed to dispatch key event",cr);
this.fireDataEvent(bs,cr);
}}bN.dispose();
},_onmouseevent:qx.core.Variant.select(B,{"mshtml":function(ch){if(!ch){ch=window.event;
}var cj=qx.legacy.event.handler.EventHandler.getDomTarget(ch);
var ci=ch.type;

if(ci==I){if(this._mouseIsDown&&ch.button==0){this._onmouseevent_post(ch,C);
this._mouseIsDown=false;
}}else{if(ci==D){this._mouseIsDown=true;
}else if(ci==C){this._mouseIsDown=false;
}if(ci==C&&!this._lastMouseDown&&((new Date).valueOf()-this._lastMouseEventDate)<250){this._onmouseevent_post(ch,D);
}else if(ci==w&&this._lastMouseEventType==C&&((new Date).valueOf()-this._lastMouseEventDate)<250){this._onmouseevent_post(ch,z);
}
switch(ci){case D:case C:case z:case w:case bA:this._lastMouseEventType=ci;
this._lastMouseEventDate=(new Date).valueOf();
this._lastMouseDown=ci==D;
}}this._onmouseevent_post(ch,ci,cj);
},"default":function(cv){var cx=qx.legacy.event.handler.EventHandler.getDomTarget(cv);
var cw=cv.type;

switch(cw){case F:cw=K;
break;
case z:case w:if(cv.which!==1){return;
}}this._onmouseevent_post(cv,cw,cx);
}}),_onmouseevent_click_fix:qx.core.Variant.select(B,{"gecko":function(p,q,r){var s=false;

switch(q){case D:this._lastMouseDownDomTarget=p;
this._lastMouseDownDispatchTarget=r;
break;
case C:if(this._lastMouseDownDispatchTarget===r&&p!==this._lastMouseDownDomTarget){s=true;
}else{this._lastMouseDownDomTarget=null;
this._lastMouseDownDispatchTarget=null;
}}return s;
},"default":null}),_onmouseevent_post:function(cy,cz,cA){var cC,cH,cL,cD,cF,cK,cG,cI;
cH=this.getCaptureWidget();
cF=qx.legacy.event.handler.EventHandler.getOriginalTargetObject(cA);
if(!cH){cL=cD=qx.legacy.event.handler.EventHandler.getTargetObject(null,cF,true);
}else{cL=cH;
cD=qx.legacy.event.handler.EventHandler.getTargetObject(null,cF,true);
}if(!cD){return;
}cI=cD.getEnabled();
if(qx.core.Variant.isSet(B,x)){cG=this._onmouseevent_click_fix(cA,cz,cL);
}if(cz==bA&&!this.getAllowClientContextMenu()){qx.legacy.event.handler.EventHandler.stopDomEvent(cy);
}if(cI&&cz==D){qx.legacy.event.handler.FocusHandler.mouseFocus=true;
var cE=cD.getFocusRoot();

if(cE){this.setFocusRoot(cE);
var cB=cD;

while(!cB.isFocusable()&&cB!=cE){cB=cB.getParent();
}cE.setFocusedChild(cB);
cE.setActiveChild(cD);
}}switch(cz){case A:case v:cK=qx.legacy.event.handler.EventHandler.getRelatedTargetObjectFromEvent(cy);
if(cK==cD){return;
}}cC=new qx.legacy.event.type.MouseEvent(cz,cy,cA,cD,cF,cK);
qx.legacy.event.type.MouseEvent.storeEventState(cC);

if(cI){var cJ=false;
cJ=cL?cL.dispatchEvent(cC):true;
this._onmouseevent_special_post(cz,cD,cF,cL,cJ,cC,cy);
}else{if(cz==A){if(qx.Class.isDefined(bB)){qx.legacy.ui.popup.ToolTipManager.getInstance().handleMouseOver(cC);
}}}cC.dispose();
cC=null;
if(cG){this._onmouseevent_post(cy,z,this._lastMouseDownDomTarget);
this._lastMouseDownDomTarget=null;
this._lastMouseDownDispatchTarget=null;
}},_onmouseevent_special_post:function(bT,bU,bV,bW,bX,bY,ca){switch(bT){case D:if(qx.Class.isDefined(L)){qx.legacy.ui.popup.PopupManager.getInstance().update(bU);
}
if(qx.Class.isDefined(y)){qx.legacy.ui.menu.Manager.getInstance().update(bU,bT);
}
if(qx.Class.isDefined(R)){qx.legacy.ui.embed.IframeManager.getInstance().handleMouseDown(bY);
}break;
case C:if(qx.Class.isDefined(y)){qx.legacy.ui.menu.Manager.getInstance().update(bU,bT);
}
if(qx.Class.isDefined(R)){qx.legacy.ui.embed.IframeManager.getInstance().handleMouseUp(bY);
}break;
case A:if(qx.Class.isDefined(bB)){qx.legacy.ui.popup.ToolTipManager.getInstance().handleMouseOver(bY);
}break;
case v:if(qx.Class.isDefined(bB)){qx.legacy.ui.popup.ToolTipManager.getInstance().handleMouseOut(bY);
}break;
}this._ignoreWindowBlur=bT===D;
if(qx.Class.isDefined(bD)&&bU){qx.legacy.event.handler.DragAndDropHandler.getInstance().handleMouseEvent(bY);
}},_ondragevent:function(cs){if(!cs){cs=window.event;
}qx.legacy.event.handler.EventHandler.stopDomEvent(cs);
},_onselectevent:function(e){if(!e){e=window.event;
}var a=qx.legacy.event.handler.EventHandler.getOriginalTargetObjectFromEvent(e);
while(a){if(a.getSelectable()!=null){if(!a.getSelectable()){qx.legacy.event.handler.EventHandler.stopDomEvent(e);
}break;
}a=a.getParent();
}},_focused:false,_onwindowblur:function(e){if(!this._focused||this._ignoreWindowBlur){return;
}this._focused=false;
this.setCaptureWidget(null);
if(qx.Class.isDefined(L)){qx.legacy.ui.popup.PopupManager.getInstance().update();
}if(qx.Class.isDefined(y)){qx.legacy.ui.menu.Manager.getInstance().update();
}if(qx.Class.isDefined(bD)){qx.legacy.event.handler.DragAndDropHandler.getInstance().globalCancelDrag();
}qx.legacy.ui.core.ClientDocument.getInstance().fireEvent(W);
},_onwindowfocus:function(e){if(this._focused){return;
}this._focused=true;
qx.legacy.ui.core.ClientDocument.getInstance().fireEvent(bc);
},_onwindowresize:function(e){qx.legacy.ui.core.ClientDocument.getInstance().fireEvent(bp);
}},destruct:function(){this.detachEvents();
this._disposeMap(bm);
this._disposeFields(M,br,bi,ba,bq,bh);
this._disposeFields(U,Y,N,bo,be);
}});
})();
(function(){var Y="keydown",X="qx.client",W="keypress",V="NumLock",U="keyup",T="Enter",S="gecko",R="0",Q="9",P="F1",cc="-",cb="PageUp",ca="+",bY="PrintScreen",bX="A",bW="Left",bV="F5",bU="Down",bT="Up",bS="F11",bg="F6",bh="PageDown",be="Insert",bf="F8",bc="End",bd="/",ba="Delete",bb="Z",bn="*",bo="F4",by="Home",bv="F2",bG="F12",bB="F7",bO="F9",bL="F10",br="Right",bR="F3",bQ="Escape",bP="webkit",bq="3",bt="5",bu="singleton",bx="Meta",bz="7",bC="CapsLock",bI="keyinput",bN="Scroll",bi="Control",bj="Tab",bs="Shift",bF="Pause",bE="Unidentified",bD="_lastUpDownType",bK="Apps",bJ="6",bA="4",bH="Alt",M="2",bM="mshtml",bk="8",bl="Win",bw="1",N="qx.legacy.event.handler.KeyEventHandler",O=",",bp="Backspace",bm="Space";
qx.Class.define(N,{type:bu,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this._lastUpDownType={};
this.__qV=qx.lang.Function.bind(this._onKeyPress,this);
this.__qW=qx.lang.Function.bind(this._onkeyupdown,this);
},members:{_attachEvents:function(){var q=qx.core.Variant.isSet(X,S)?window:document.body;
qx.legacy.html.EventRegistration.addListener(q,W,this.__qV);
qx.legacy.html.EventRegistration.addListener(q,U,this.__qW);
qx.legacy.html.EventRegistration.addListener(q,Y,this.__qW);
},_detachEvents:function(){var L=qx.core.Variant.isSet(X,S)?window:document.body;
qx.legacy.html.EventRegistration.removeListener(L,W,this.__qV);
qx.legacy.html.EventRegistration.removeListener(L,U,this.__qW);
qx.legacy.html.EventRegistration.removeListener(L,Y,this.__qW);
},_onkeyupdown:qx.core.Variant.select(X,{"mshtml":function(H){H=window.event||H;
var K=H.keyCode;
var I=0;
var J=H.type;
if(!(this._lastUpDownType[K]==Y&&J==Y)){this._idealKeyHandler(K,I,J,H);
}if(J==Y){if(this._isNonPrintableKeyCode(K)||
K==
8||K==9){this._idealKeyHandler(K,I,W,H);
}}this._lastUpDownType[K]=J;
},"gecko":function(r){var v=this._keyCodeFix[r.keyCode]||r.keyCode;
var t=r.charCode;
var u=r.type;
if(qx.legacy.core.Client.getInstance().runsOnWindows()){var s=v?this._keyCodeToIdentifier(v):this._charCodeToIdentifier(t);

if(!(this._lastUpDownType[s]==W&&u==Y)){this._idealKeyHandler(v,t,u,r);
}this._lastUpDownType[s]=u;
}else{this._idealKeyHandler(v,t,u,r);
}},"webkit":function(B){var D=0;
var E=B.type;
if(qx.bom.client.Engine.VERSION<525.13){var F=0;
if(qx.legacy.core.Client.getInstance().getVersion()<420){if(!this._lastCharCodeForType){this._lastCharCodeForType={};
}var C=this._lastCharCodeForType[E]>63000;

if(C){this._lastCharCodeForType[E]=null;
return;
}this._lastCharCodeForType[E]=B.charCode;
}
if(E==U||E==Y){F=this._charCode2KeyCode[B.charCode]||B.keyCode;
}else{if(this._charCode2KeyCode[B.charCode]){F=this._charCode2KeyCode[B.charCode];
}else{D=B.charCode;
}}this._idealKeyHandler(F,D,E,B);
}else{var F=B.keyCode;
if(!(this._lastUpDownType[F]==Y&&E==Y)){this._idealKeyHandler(F,D,E,B);
}if(E==Y){if(this._isNonPrintableKeyCode(F)||F==8||F==9){this._idealKeyHandler(F,D,W,B);
}}this._lastUpDownType[F]=E;
}},"opera":function(ce){this._idealKeyHandler(ce.keyCode,0,ce.type,ce);
},"default":function(){throw new Error("Unsupported browser for key event handler!");
}}),_onKeyPress:qx.core.Variant.select(X,{"mshtml":function(w){var w=window.event||w;
...
var ch=cf.charCode;
var ci=cf.type;
if(qx.legacy.core.Client.getInstance().runsOnWindows()){var cg=cj?this._keyCodeToIdentifier(cj):this._charCodeToIdentifier(ch);

if(!(this._lastUpDownType[cg]==W&&ci==Y)){this._idealKeyHandler(cj,ch,ci,cf);
}this._lastUpDownType[cg]=ci;
}else{this._idealKeyHandler(cj,ch,ci,cf);
}},"webkit":function(k){if(qx.bom.client.Engine.VERSION<525.13){var o=0;
var m=0;
var n=k.type;
if(qx.legacy.core.Client.getInstance().getVersion()<420){if(!this._lastCharCodeForType){this._lastCharCodeForType={};
}var l=this._lastCharCodeForType[n]>63000;

if(l){this._lastCharCodeForType[n]=null;
return;
}this._lastCharCodeForType[n]=k.charCode;
}
if(n==U||n==Y){o=this._charCode2KeyCode[k.charCode]||k.keyCode;
}else{if(this._charCode2KeyCode[k.charCode]){o=this._charCode2KeyCode[k.charCode];
}else{m=k.charCode;
}}this._idealKeyHandler(o,m,n,k);
...
}}},"opera":function(G){if(this._keyCodeToIdentifierMap[G.keyCode]){this._idealKeyHandler(G.keyCode,0,G.type,G);
}else{this._idealKeyHandler(0,G.keyCode,G.type,G);
}},"default":function(){throw new Error("Unsupported browser for key event handler!");
}}),_specialCharCodeMap:{8:bp,9:bj,13:T,27:bQ,32:bm},_keyCodeToIdentifierMap:{16:bs,17:bi,18:bH,20:bC,224:bx,37:bW,38:bT,39:br,40:bU,33:cb,34:bh,35:bc,36:by,45:be,46:ba,112:P,113:bv,114:bR,115:bo,116:bV,117:bg,118:bB,119:bf,120:bO,121:bL,122:bS,123:bG,144:V,44:bY,145:bN,19:bF,91:bl,93:bK},_numpadToCharCode:{96:R.charCodeAt(0),97:bw.charCodeAt(0),98:M.charCodeAt(0),99:bq.charCodeAt(0),100:bA.charCodeAt(0),101:bt.charCodeAt(0),102:bJ.charCodeAt(0),103:bz.charCodeAt(0),104:bk.charCodeAt(0),105:Q.charCodeAt(0),106:bn.charCodeAt(0),107:ca.charCodeAt(0),109:cc.charCodeAt(0),110:O.charCodeAt(0),111:bd.charCodeAt(0)},_charCodeA:bX.charCodeAt(0),_charCodeZ:bb.charCodeAt(0),_charCode0:R.charCodeAt(0),_charCode9:Q.charCodeAt(0),_isNonPrintableKeyCode:function(e){return this._keyCodeToIdentifierMap[e]?true:false;
...
},isValidKeyIdentifier:function(y){if(this._identifierToKeyCodeMap[y]){return true;
}
if(y.length!=1){return false;
}
if(y>=R&&y<=Q){return true;
}
if(y>=bX&&y<=bb){return true;
}
switch(y){case ca:case cc:case bn:case bd:return true;
...
}},_charCodeToIdentifier:function(p){return this._specialCharCodeMap[p]||String.fromCharCode(p).toUpperCase();
},_identifierToKeyCode:function(x){return this._identifierToKeyCodeMap[x]||x.charCodeAt(0);
},_idealKeyHandler:function(f,g,h,i){if(!f&&!g){return;
}var j;
if(f){j=this._keyCodeToIdentifier(f);
qx.legacy.event.handler.EventHandler.getInstance()._onkeyevent_post(i,h,f,g,j);
}else{j=this._charCodeToIdentifier(g);
qx.legacy.event.handler.EventHandler.getInstance()._onkeyevent_post(i,W,f,g,j);
qx.legacy.event.handler.EventHandler.getInstance()._onkeyevent_post(i,bI,f,g,j);
}}},defer:function(a,b,c){if(!b._identifierToKeyCodeMap){b._identifierToKeyCodeMap={};

for(var d in b._keyCodeToIdentifierMap){b._identifierToKeyCodeMap[b._keyCodeToIdentifierMap[d]]=parseInt(d);
}
for(var d in b._specialCharCodeMap){b._identifierToKeyCodeMap[b._specialCharCodeMap[d]]=parseInt(d);
}}
if(qx.core.Variant.isSet(X,bM)){b._charCode2KeyCode={13:13,27:27};
}else if(qx.core.Variant.isSet(X,S)){b._keyCodeFix={12:b._identifierToKeyCode(V)};
}else if(qx.core.Variant.isSet(X,bP)){if(qx.bom.client.Engine.VERSION<525.13){b._charCode2KeyCode={63289:b._identifierToKeyCode(V),63276:b._identifierToKeyCode(cb),63277:b._identifierToKeyCode(bh),63275:b._identifierToKeyCode(bc),63273:b._identifierToKeyCode(by),63234:b._identifierToKeyCode(bW),63232:b._identifierToKeyCode(bT),63235:b._identifierToKeyCode(br),63233:b._identifierToKeyCode(bU),63272:b._identifierToKeyCode(ba),63302:b._identifierToKeyCode(be),63236:b._identifierToKeyCode(P),63237:b._identifierToKeyCode(bv),63238:b._identifierToKeyCode(bR),63239:b._identifierToKeyCode(bo),63240:b._identifierToKeyCode(bV),63241:b._identifierToKeyCode(bg),63242:b._identifierToKeyCode(bB),63243:b._identifierToKeyCode(bf),63244:b._identifierToKeyCode(bO),63245:b._identifierToKeyCode(bL),63246:b._identifierToKeyCode(bS),63247:b._identifierToKeyCode(bG),63248:b._identifierToKeyCode(bY),3:b._identifierToKeyCode(T),12:b._identifierToKeyCode(V),13:b._identifierToKeyCode(T)};
}else{b._charCode2KeyCode={13:13,27:27};
}}},destruct:function(){this._detachEvents();
this._disposeFields(bD);
}});
})();
(function(){var k="mshtml",j="gecko",i="khtml",h="opera",g="webkit",f="string",e="-khtml-box-sizing",d=".",c="netnewswire",b="-",bk="KDE",bj="+",bi="RealPlayer",bh="CSS1Compat",bg="[^\\.0-9]",bf="Linux",be="en",bd="Galeon",bc="-webkit-box-sizing",bb="MacPPC",r="Gecko",s="other",p="Win64",q="org.w3c.dom.svg",n="camino",o="win",l="Macintosh",m="X11",x="Shiira",y="Mozilla",G="explorer",E="box-sizing",O="1.0",J="shiira",W="konqueror",T="safari",A="NetNewsWire",ba="other webkit",Y="qx.legacy.core.Client",X="AppleWebKit",z="Camino",C="1.1",D="MSIE",F="mac",H="Firefox",K="other gecko",Q="http://www.w3.org/TR/SVG11/feature#BasicStructure",V="Windows",t="Safari",u="Win32",B="-moz-box-sizing",N="none",M="omniweb",L="unix",S="file:",R=" (nightly)",I="BSD",P="galeon",a="firefox",U="realplayer",v="MacIntel",w="OmniWeb";
qx.Class.define(Y,{statics:{__qX:function(){var bQ=window.location.protocol===S;
var bS=navigator.userAgent;
var bu=navigator.vendor;
var bH=navigator.product;
...
if(window.opera&&/Opera[\s\/]([0-9\.]*)/.test(bS)){bG=h;
bR=RegExp.$1;
bx=h;
bR=bR.substring(0,3)+d+bR.substring(3);
bI=bS.indexOf(D)!==-1?k:bS.indexOf(y)!==-1?j:null;
}else if(typeof bu===f&&bu===bk&&/KHTML\/([0-9-\.]*)/.test(bS)){bG=i;
bx=W;
bR=RegExp.$1;
}else if(bS.indexOf(X)!=-1&&/AppleWebKit\/([^ ]+)/.test(bS)){bG=g;
bR=RegExp.$1;
bz=bR.indexOf(bj)!=-1;
var by=RegExp(bg).exec(bR);

if(by){bR=bR.slice(0,by.index);
}
if(bS.indexOf(t)!=-1){bx=T;
}else if(bS.indexOf(w)!=-1){bx=M;
}else if(bS.indexOf(x)!=-1){bx=J;
}else if(bS.indexOf(A)!=-1){bx=c;
}else if(bS.indexOf(bi)!=-1){bx=U;
}else{bx=ba;
}
if(bz){bx+=R;
}}else if(window.controllers&&typeof bH===f&&bH===r&&/rv\:([^\);]+)(\)|;)/.test(bS)){bG=j;
bR=RegExp.$1;

if(bS.indexOf(H)!=-1){bx=a;
}else if(bS.indexOf(z)!=-1){bx=n;
}else if(bS.indexOf(bd)!=-1){bx=P;
}else{bx=K;
}}else if(/MSIE\s+([^\);]+)(\)|;)/.test(bS)){bG=k;
bR=RegExp.$1;
bx=G;
}
if(bR){bL=bR.split(d);
...
var bt=document.compatMode!==bh;
var bJ=be;
var bB=(bG==k?navigator.userLanguage:navigator.language).toLowerCase();
var bo=null;
var bs=bB.indexOf(b);

if(bs!=-1){bo=bB.substr(bs+1);
bB=bB.substr(0,bs);
}var bD=N;
var bF=false;
var bp=false;
...
if(bN.indexOf(V)!=-1||bN.indexOf(u)!=-1||bN.indexOf(p)!=-1){bF=true;
bD=o;
}else if(bN.indexOf(l)!=-1||bN.indexOf(bb)!=-1||bN.indexOf(v)!=-1){bp=true;
bD=F;
}else if(bN.indexOf(m)!=-1||bN.indexOf(bf)!=-1||bN.indexOf(I)!=-1){bq=true;
bD=L;
}else{bP=true;
bD=s;
}var bv=false;
...
if(document.implementation&&document.implementation.hasFeature){if(document.implementation.hasFeature(q,O)||document.implementation.hasFeature(Q,C)){bO=bE=true;
}}this._runsLocally=bQ;
this._engineName=bG;
this._engineNameMshtml=bG===k;
this._engineNameGecko=bG===j;
this._engineNameOpera=bG===h;
this._engineNameKhtml=bG===i;
this._engineNameWebkit=bG===g;
this._engineVersion=parseFloat(bR);
this._engineVersionMajor=parseInt(bC);
this._engineVersionMinor=parseInt(bw);
this._engineVersionRevision=parseInt(bA);
this._engineVersionBuild=parseInt(bK);
this._engineQuirksMode=bt;
this._engineBoxSizingAttributes=br;
this._engineEmulation=bI;
this._browserName=bx;
this._defaultLocale=bJ;
this._browserPlatform=bD;
this._browserPlatformWindows=bF;
this._browserPlatformMacintosh=bp;
this._browserPlatformUnix=bq;
this._browserPlatformOther=bP;
this._browserLocale=bB;
this._browserLocaleVariant=bo;
this._gfxVml=bv;
this._gfxSvg=bO;
this._gfxSvgBuiltin=bE;
this._gfxSvgPlugin=bM;
...
}},defer:function(bl,bm,bn){bl.__qX();
}});
})();
(function(){var i="on",h="qx.client",g="qx.legacy.html.EventRegistration";
qx.Class.define(g,{statics:{addListener:qx.core.Variant.select(h,{"mshtml":function(j,k,l){j.attachEvent(i+k,l);
},"default":function(a,b,c){a.addEventListener(b,c,false);
}}),removeListener:qx.core.Variant.select(h,{"mshtml":function(d,e,f){d.detachEvent(i+e,f);
},"default":function(m,n,o){m.removeEventListener(n,o,false);
}})}});
})();
(function(){var r="relatedTarget",q="bubbles",p="qx.legacy.event.type.DomEvent",o="_valueRelatedTarget",n="domTarget",m="_valueOriginalTarget",l="originalTarget",k="_valueDomEvent",j="modifiers",i="qx.client",g="domEvent",h="_valueDomTarget";
qx.Class.define(p,{extend:qx.event.type.Event,construct:function(b,c,d,e,f){arguments.callee.base.call(this);
this.init(true,true);
this.setType(b);
this.setDomEvent(c);
this.setDomTarget(d);
this.setTarget(e);
this.setOriginalTarget(f);
},statics:{SHIFT_MASK:1,CTRL_MASK:2,ALT_MASK:4,META_MASK:8},members:{_computeModifiers:function(){var v=0;
var u=this.getDomEvent();

if(u.shiftKey)v|=qx.legacy.event.type.DomEvent.SHIFT_MASK;

if(u.ctrlKey)v|=qx.legacy.event.type.DomEvent.CTRL_MASK;

if(u.altKey)v|=qx.legacy.event.type.DomEvent.ALT_MASK;

if(u.metaKey)v|=qx.legacy.event.type.DomEvent.META_MASK;
return v;
...
}},setDefaultPrevented:qx.core.Variant.select(i,{"mshtml":function(w){if(!w){return this.error("It is not possible to set preventDefault to false if it was true before!","setDefaultPrevented");
}this.getDomEvent().returnValue=false;
},"default":function(a){if(!a){return this.error("It is not possible to set preventDefault to false if it was true before!","setDefaultPrevented");
}this.getDomEvent().preventDefault();
this.getDomEvent().returnValue=false;
}}),preventDefault:function(){this.setDefaultPrevented(true);
}},defer:function(s,t){qx.legacy.core.Property.addCachedProperty({name:j,defaultValue:null},t);
qx.legacy.core.Property.addFastProperty({name:q,defaultValue:true,noCompute:true},t);
qx.legacy.core.Property.addFastProperty({name:g,defaultValue:null,noCompute:true,setOnlyOnce:true},t);
qx.legacy.core.Property.addFastProperty({name:n,defaultValue:null,noCompute:true,setOnlyOnce:true},t);
qx.legacy.core.Property.addFastProperty({name:l,defaultValue:null,setOnlyOnce:true},t);
qx.legacy.core.Property.addFastProperty({name:r,defaultValue:null,setOnlyOnce:true},t);
},destruct:function(){this._disposeFields(k,h,m,o);
}});
})();
...
},__qY:qx.core.Variant.select(r,{"mshtml":{1:q,2:p,4:n},"default":{0:q,2:p,1:n}}),getButton:function(){switch(this.getDomEvent().type){case o:case m:return q;
case k:return p;
default:return this.__qY[this.getDomEvent().button]||l;
...
(function(){var d="_objects",c="qx.legacy.util.ObjectManager";
...
},has:function(k){var l=qx.core.ObjectRegistry.toHashCode(k);
return this._objects[l]!==undefined;
},get:function(e){var f=qx.core.ObjectRegistry.toHashCode(e);
return this._objects[f];
},getByHash:function(m){return this._objects[m];
},getAll:function(){return this._objects;
},enableAll:function(){for(var a in this._objects){this._objects[a].setEnabled(true);
}},disableAll:function(){for(var b in this._objects){this._objects[b].setEnabled(false);
}}},destruct:function(){this._disposeMap(d);
}});
})();
(function(){var b="singleton",a="qx.legacy.ui.embed.IframeManager";
qx.Class.define(a,{type:b,extend:qx.legacy.util.ObjectManager,construct:function(){arguments.callee.base.call(this);
this._blocked={};
},members:{handleMouseDown:function(f){var g=this._blockData=qx.lang.Object.clone(this.getAll());
for(var h in g){g[h].block();
}},handleMouseUp:function(c){var d=this._blockData;
for(var e in d){d[e].release();
}}}});
})();
(function(){var c="qx.legacy.ui.basic.Terminator",b="load";
qx.Class.define(c,{extend:qx.legacy.ui.core.Widget,members:{renderPadding:function(d){if(d.paddingLeft){this._renderRuntimePaddingLeft(this.getPaddingLeft());
}
if(d.paddingRight){this._renderRuntimePaddingRight(this.getPaddingRight());
}
if(d.paddingTop){this._renderRuntimePaddingTop(this.getPaddingTop());
}
if(d.paddingBottom){this._renderRuntimePaddingBottom(this.getPaddingBottom());
...
}if(this._initialLayoutDone){this.addToJobQueue(b);
}},_layoutPost:function(a){if(a.initial||a.load||a.width||a.height){this._postApply();
...
(function(){var be="qx.client",bd="_widget",bc="qx.legacy.ui.layout.impl.LayoutImpl";
qx.Class.define(bc,{extend:qx.core.Object,construct:function(E){arguments.callee.base.call(this);
this._widget=E;
},members:{getWidget:function(){return this._widget;
},computeChildBoxWidth:function(c){return c.getWidthValue()||c._computeBoxWidthFallback();
},computeChildBoxHeight:function(bl){return bl.getHeightValue()||bl._computeBoxHeightFallback();
},computeChildNeededWidth:function(w){var z=w._computedMinWidthTypePercent?null:w.getMinWidthValue();
var x=w._computedMaxWidthTypePercent?null:w.getMaxWidthValue();
var y=(w._computedWidthTypePercent||w._computedWidthTypeFlex?null:w.getWidthValue())||w.getPreferredBoxWidth()||0;
return qx.lang.Number.limit(y,z,x)+w.getMarginLeft()+w.getMarginRight();
},computeChildNeededHeight:function(e){var h=e._computedMinHeightTypePercent?null:e.getMinHeightValue();
var f=e._computedMaxHeightTypePercent?null:e.getMaxHeightValue();
var g=(e._computedHeightTypePercent||e._computedHeightTypeFlex?null:e.getHeightValue())||e.getPreferredBoxHeight()||0;
return qx.lang.Number.limit(g,h,f)+e.getMarginTop()+e.getMarginBottom();
},computeChildrenNeededWidth_max:function(){for(var i=0,U=this.getWidget().getVisibleChildren(),V=U.length,T=0;i<V;i++){T=Math.max(T,U[i].getNeededWidth());
}return T;
},computeChildrenNeededHeight_max:function(){for(var i=0,ba=this.getWidget().getVisibleChildren(),bb=ba.length,Y=0;i<bb;i++){Y=Math.max(Y,ba[i].getNeededHeight());
}return Y;
},computeChildrenNeededWidth_sum:function(){for(var i=0,bj=this.getWidget().getVisibleChildren(),bk=bj.length,bi=0;i<bk;i++){bi+=bj[i].getNeededWidth();
}return bi;
...
},computeChildrenNeededWidth:null,computeChildrenNeededHeight:null,updateSelfOnChildOuterWidthChange:function(d){},updateSelfOnChildOuterHeightChange:function(o){},updateChildOnInnerWidthChange:function(S){},updateChildOnInnerHeightChange:function(bh){},updateSelfOnJobQueueFlush:function(F){},updateChildrenOnJobQueueFlush:function(A){},updateChildrenOnAddChild:function(K,L){},updateChildrenOnRemoveChild:function(bf,bg){},updateChildrenOnMoveChild:function(B,C,D){},flushChildrenQueue:function(p){var r=this.getWidget();

for(var q in p){r._layoutChild(p[q]);
}},layoutChild:function(m,n){},layoutChild_sizeLimitX:qx.core.Variant.select(be,{"mshtml":qx.lang.Function.returnTrue,"default":function(a,b){if(b.minWidth){a._computedMinWidthTypeNull?a._resetRuntimeMinWidth():a._renderRuntimeMinWidth(a.getMinWidthValue());
}else if(b.initial&&!a._computedMinWidthTypeNull){a._renderRuntimeMinWidth(a.getMinWidthValue());
}
if(b.maxWidth){a._computedMaxWidthTypeNull?a._resetRuntimeMaxWidth():a._renderRuntimeMaxWidth(a.getMaxWidthValue());
}else if(b.initial&&!a._computedMaxWidthTypeNull){a._renderRuntimeMaxWidth(a.getMaxWidthValue());
}}}),layoutChild_sizeLimitY:qx.core.Variant.select(be,{"mshtml":qx.lang.Function.returnTrue,"default":function(M,N){if(N.minHeight){M._computedMinHeightTypeNull?M._resetRuntimeMinHeight():M._renderRuntimeMinHeight(M.getMinHeightValue());
}else if(N.initial&&!M._computedMinHeightTypeNull){M._renderRuntimeMinHeight(M.getMinHeightValue());
}
if(N.maxHeight){M._computedMaxHeightTypeNull?M._resetRuntimeMaxHeight():M._renderRuntimeMaxHeight(M.getMaxHeightValue());
}else if(N.initial&&!M._computedMaxHeightTypeNull){M._renderRuntimeMaxHeight(M.getMaxHeightValue());
}}}),layoutChild_marginX:function(G,H){if(H.marginLeft||H.initial){var I=G.getMarginLeft();
I!=null?G._renderRuntimeMarginLeft(I):G._resetRuntimeMarginLeft();
}
if(H.marginRight||H.initial){var J=G.getMarginRight();
J!=null?G._renderRuntimeMarginRight(J):G._resetRuntimeMarginRight();
}},layoutChild_marginY:function(O,P){if(P.marginTop||P.initial){var R=O.getMarginTop();
R!=null?O._renderRuntimeMarginTop(R):O._resetRuntimeMarginTop();
}
if(P.marginBottom||P.initial){var Q=O.getMarginBottom();
Q!=null?O._renderRuntimeMarginBottom(Q):O._resetRuntimeMarginBottom();
}},layoutChild_sizeX_essentialWrapper:function(W,X){return W._isWidthEssential()?this.layoutChild_sizeX(W,X):W._resetRuntimeWidth();
},layoutChild_sizeY_essentialWrapper:function(u,v){return u._isHeightEssential()?this.layoutChild_sizeY(u,v):u._resetRuntimeHeight();
}},defer:function(s,t){t.computeChildrenNeededWidth=t.computeChildrenNeededWidth_max;
t.computeChildrenNeededHeight=t.computeChildrenNeededHeight_max;
},destruct:function(){this._disposeFields(bd);
}});
})();
(function(){var o="qx.client",n="qx.legacy.ui.layout.impl.CanvasLayoutImpl";
qx.Class.define(n,{extend:qx.legacy.ui.layout.impl.LayoutImpl,construct:function(w){arguments.callee.base.call(this,w);
...
},computeChildBoxHeight:function(s){var t=null;

if(s._computedTopTypeNull||s._computedBottomTypeNull){t=s.getHeightValue();
}else if(s._hasParent){t=this.getWidget().getInnerHeight()-s.getTopValue()-s.getBottomValue();
}return t||s._computeBoxHeightFallback();
},computeChildNeededWidth:function(J){var K=J._computedLeftTypePercent?null:J.getLeftValue();
var N=J._computedRightTypePercent?null:J.getRightValue();
var M=J._computedMinWidthTypePercent?null:J.getMinWidthValue();
var L=J._computedMaxWidthTypePercent?null:J.getMaxWidthValue();

if(K!=null&&N!=null){var O=J.getPreferredBoxWidth()||0;
}else{var O=(J._computedWidthTypePercent?null:J.getWidthValue())||J.getPreferredBoxWidth()||0;
}return qx.lang.Number.limit(O,M,L)+K+N+J.getMarginLeft()+J.getMarginRight();
},computeChildNeededHeight:function(d){var g=d._computedTopTypePercent?null:d.getTopValue();
var h=d._computedBottomTypePercent?null:d.getBottomValue();
var i=d._computedMinHeightTypePercent?null:d.getMinHeightValue();
var e=d._computedMaxHeightTypePercent?null:d.getMaxHeightValue();

if(g!=null&&h!=null){var f=d.getPreferredBoxHeight()||0;
}else{var f=(d._computedHeightTypePercent?null:d.getHeightValue())||d.getPreferredBoxHeight()||0;
}return qx.lang.Number.limit(f,i,e)+g+h+d.getMarginTop()+d.getMarginBottom();
},updateChildOnInnerWidthChange:function(G){var I=G._recomputePercentX();
var H=G._recomputeRangeX();
return I||H;
},updateChildOnInnerHeightChange:function(a){var c=a._recomputePercentY();
var b=a._recomputeRangeY();
return c||b;
},layoutChild:function(j,k){this.layoutChild_sizeX_essentialWrapper(j,k);
this.layoutChild_sizeY_essentialWrapper(j,k);
this.layoutChild_sizeLimitX(j,k);
this.layoutChild_sizeLimitY(j,k);
this.layoutChild_locationX(j,k);
this.layoutChild_locationY(j,k);
this.layoutChild_marginX(j,k);
this.layoutChild_marginY(j,k);
},layoutChild_sizeX:qx.core.Variant.select(o,{"mshtml|opera|webkit":function(x,y){if(y.initial||y.width||y.minWidth||y.maxWidth||y.left||y.right){if(x._computedMinWidthTypeNull&&x._computedWidthTypeNull&&x._computedMaxWidthTypeNull&&!(!x._computedLeftTypeNull&&!x._computedRightTypeNull)){x._resetRuntimeWidth();
}else{x._renderRuntimeWidth(x.getBoxWidth());
...
}}}),layoutChild_sizeY:qx.core.Variant.select(o,{"mshtml|opera|webkit":function(l,m){if(m.initial||m.height||m.minHeight||m.maxHeight||m.top||m.bottom){if(l._computedMinHeightTypeNull&&l._computedHeightTypeNull&&l._computedMaxHeightTypeNull&&!(!l._computedTopTypeNull&&!l._computedBottomTypeNull)){l._resetRuntimeHeight();
}else{l._renderRuntimeHeight(l.getBoxHeight());
}}},"default":function(E,F){if(F.initial||F.height){E._computedHeightTypeNull?E._resetRuntimeHeight():E._renderRuntimeHeight(E.getHeightValue());
}}}),layoutChild_locationX:function(p,q){var r=this.getWidget();

if(q.initial||q.left||q.parentPaddingLeft){p._computedLeftTypeNull?p._computedRightTypeNull&&r.getPaddingLeft()>0?p._renderRuntimeLeft(r.getPaddingLeft()):p._resetRuntimeLeft():p._renderRuntimeLeft(p.getLeftValue()+r.getPaddingLeft());
}
if(q.initial||q.right||q.parentPaddingRight){p._computedRightTypeNull?p._computedLeftTypeNull&&r.getPaddingRight()>0?p._renderRuntimeRight(r.getPaddingRight()):p._resetRuntimeRight():p._renderRuntimeRight(p.getRightValue()+r.getPaddingRight());
}},layoutChild_locationY:function(z,A){var B=this.getWidget();

if(A.initial||A.top||A.parentPaddingTop){z._computedTopTypeNull?z._computedBottomTypeNull&&B.getPaddingTop()>0?z._renderRuntimeTop(B.getPaddingTop()):z._resetRuntimeTop():z._renderRuntimeTop(z.getTopValue()+B.getPaddingTop());
}
if(A.initial||A.bottom||A.parentPaddingBottom){z._computedBottomTypeNull?z._computedTopTypeNull&&B.getPaddingBottom()>0?z._renderRuntimeBottom(B.getPaddingBottom()):z._resetRuntimeBottom():z._renderRuntimeBottom(z.getBottomValue()+B.getPaddingBottom());
}}}});
})();
...
(function(){var i="__ra",h="qx.legacy.theme.manager.Appearance",g="_applyAppearanceTheme",f="changeAppearanceTheme",e="Theme",d="__rb",c="singleton";
qx.Class.define(h,{type:c,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__ra={};
this.__rb={};
this.__rc=1;
},properties:{appearanceTheme:{check:e,nullable:true,apply:g,event:f}},members:{_applyAppearanceTheme:function(a,b){this._currentTheme=a;
this._oldTheme=b;
...
if(this._currentTheme){this.__ra[this._currentTheme.name]={};
}
...
if(this._oldTheme){delete this.__ra[this._oldTheme.name];
}delete this._currentTheme;
delete this._oldTheme;
},styleFrom:function(j,k){var l=this.getAppearanceTheme();

if(!l){return;
}return this.styleFromTheme(l,j,k);
},styleFromTheme:function(m,n,o){var x=m.appearances[n];

if(!x){{};
return null;
}if(!x.style){if(x.include){return this.styleFromTheme(m,x.include,o);
}else{return null;
}}var p=this.__rb;
var q=[n];

for(var t in o){if(!p[t]){p[t]=this.__rc++;
}q[p[t]]=true;
}var y=q.join();
var s=this.__ra[m.name];

if(s&&s[y]!==undefined){return s[y];
}var v;
if(x.include||x.base){var z=x.style(o);
var r;

if(x.include){r=this.styleFromTheme(m,x.include,o);
}v={};
if(x.base){var u=this.styleFromTheme(x.base,n,o);

if(x.include){for(var w in u){if(r[w]===undefined&&z[w]===undefined){v[w]=u[w];
}}}else{for(var w in u){if(z[w]===undefined){v[w]=u[w];
}}}}if(x.include){for(var w in r){if(z[w]===undefined){v[w]=r[w];
}}}for(var w in z){v[w]=z[w];
}}else{v=x.style(o);
}if(s){s[y]=v||null;
}return v||null;
}},destruct:function(){this._disposeFields(i,d);
}});
})();
(function(){var p="Boolean",o="fonts",n="appearances",m="qx.legacy.iconTheme",l="_applyAutoSync",k="icons",j="changeTheme",i="borders",h="qx.legacy.colorTheme",g="widgets",B="qx.legacy.widgetTheme",A="qx.legacy.appearanceTheme",z="qx.legacy.theme",y="qx.legacy.theme.manager.Meta",x="qx.legacy.borderTheme",w="_applyTheme",v="qx.legacy.fontTheme",u="qx.legacy.theme.ClassicRoyale",t="colors",s="Theme",q="singleton",r="meta";
qx.Class.define(y,{type:q,extend:qx.core.Object,properties:{theme:{check:s,nullable:true,apply:w,event:j},autoSync:{check:p,init:true,apply:l}},members:{_applyTheme:function(F,G){var J=null;
var R=null;
var Q=null;
var H=null;
var S=null;
...
if(F){J=F.meta.color||null;
R=F.meta.border||null;
Q=F.meta.font||null;
H=F.meta.widget||null;
S=F.meta.icon||null;
L=F.meta.appearance||null;
}
if(G){this.setAutoSync(false);
}var N=qx.legacy.theme.manager.Color.getInstance();
var I=qx.legacy.theme.manager.Border.getInstance();
var M=qx.legacy.theme.manager.Font.getInstance();
var K=qx.legacy.theme.manager.Icon.getInstance();
var O=qx.legacy.theme.manager.Widget.getInstance();
var P=qx.legacy.theme.manager.Appearance.getInstance();
N.setColorTheme(J);
I.setBorderTheme(R);
M.setFontTheme(Q);
O.setWidgetTheme(H);
K.setIconTheme(S);
P.setAppearanceTheme(L);

if(G){this.setAutoSync(true);
}},_applyAutoSync:function(e,f){if(e){qx.legacy.theme.manager.Appearance.getInstance().syncAppearanceTheme();
...
}},initialize:function(){var D=qx.core.Setting;
var C,E;
C=D.get(z);

if(C){E=qx.Theme.getByName(C);

if(!E){throw new Error("The meta theme to use is not available: "+C);
}this.setTheme(E);
}C=D.get(h);

if(C){E=qx.Theme.getByName(C);

if(!E){throw new Error("The color theme to use is not available: "+C);
}qx.legacy.theme.manager.Color.getInstance().setColorTheme(E);
}C=D.get(x);

if(C){E=qx.Theme.getByName(C);

if(!E){throw new Error("The border theme to use is not available: "+C);
}qx.legacy.theme.manager.Border.getInstance().setBorderTheme(E);
}C=D.get(v);

if(C){E=qx.Theme.getByName(C);

if(!E){throw new Error("The font theme to use is not available: "+C);
}qx.legacy.theme.manager.Font.getInstance().setFontTheme(E);
}C=D.get(B);

if(C){E=qx.Theme.getByName(C);

if(!E){throw new Error("The widget theme to use is not available: "+C);
}qx.legacy.theme.manager.Widget.getInstance().setWidgetTheme(E);
}C=D.get(m);

if(C){E=qx.Theme.getByName(C);

if(!E){throw new Error("The icon theme to use is not available: "+C);
}qx.legacy.theme.manager.Icon.getInstance().setIconTheme(E);
}C=D.get(A);

if(C){E=qx.Theme.getByName(C);

if(!E){throw new Error("The appearance theme to use is not available: "+C);
}qx.legacy.theme.manager.Appearance.getInstance().setAppearanceTheme(E);
}},__rd:function(a){var d=qx.Theme.getAll();
var b;
var c=[];

for(var name in d){b=d[name];

if(b[a]){c.push(b);
}}return c;
},getMetaThemes:function(){return this.__rd(r);
},getColorThemes:function(){return this.__rd(t);
},getBorderThemes:function(){return this.__rd(i);
},getFontThemes:function(){return this.__rd(o);
},getWidgetThemes:function(){return this.__rd(g);
},getIconThemes:function(){return this.__rd(k);
},getAppearanceThemes:function(){return this.__rd(n);
}},settings:{"qx.legacy.theme":u,"qx.legacy.colorTheme":null,"qx.legacy.borderTheme":null,"qx.legacy.fontTheme":null,"qx.legacy.widgetTheme":null,"qx.legacy.appearanceTheme":null,"qx.legacy.iconTheme":null}});
})();
(function(){var x="_dynamic",w="qx.legacy.util.ValueManager",v="abstract",u="_registry";
...
this._registry={};
this._dynamic={};
},statics:{__re:{},disconnect:function(y){var A=this.__re;

for(var z in A){A[z].disconnectObject(y);
}},register:function(B){this.__re[B.$$hash]=B;
},unregister:function(t){delete this.__re[t.$$hash];
}},members:{connect:function(n,o,p){{};
if(p!==null&&this._preprocess){p=this._preprocess(p);
}var q=o.toHashCode();
var s=qx.core.ObjectRegistry.toHashCode(n);
var r=this._registry;
if(this.isDynamic(p)){if(!r[q]){r[q]={};
}r[q][s]={callback:n,object:o,value:p};
p=this.resolveDynamic(p);
}else if(r[q]&&r[q][s]){delete r[q][s];
}n.call(o,p);
},disconnectObject:function(C){var D=this._registry;

if(D&&D[C.$$hash]){delete D[C.$$hash];
}},resolveDynamic:function(a){return this._dynamic[a];
},isDynamic:function(g){return !!this._dynamic[g];
},updateUsersOf:function(h){var l=this._registry;
var i,m;

for(var j in l){i=l[j];

for(var k in i){m=i[k];

if(m.value==h){m.callback.call(m.object,this.resolveDynamic(m.value));
}}}},updateAll:function(){var e=this._registry;
var b,f;

for(var c in e){b=e[c];

for(var d in b){f=b[d];
f.callback.call(f.object,this.resolveDynamic(f.value));
}}}},destruct:function(){this._disposeFields(u,x);
qx.legacy.util.ValueManager.unregister(this);
}});
})();
(function(){var f="_applyColorTheme",e="qx.legacy.theme.manager.Color",d="changeColorTheme",c="Theme",b="string",a="singleton";
qx.Class.define(e,{type:a,extend:qx.legacy.util.ValueManager,properties:{colorTheme:{check:c,nullable:true,apply:f,event:d}},members:{_applyColorTheme:function(g){var h=this._dynamic={};
...
(function(){var f="qx.legacy.theme.manager.Border",e="_applyBorderTheme",d="Theme",c="changeBorderTheme",b="singleton";
qx.Class.define(f,{type:b,extend:qx.legacy.util.ValueManager,properties:{borderTheme:{check:d,nullable:true,apply:e,event:c}},members:{resolveDynamic:function(a){return a instanceof qx.legacy.ui.core.Border?a:this._dynamic[a];
...
(function(){var G="",F="solid",E="0px",D="none",C="qx.client",B="double",A="px",z="inset",y="dotted",x="ridge",bz="outset",by="groove",bx="dashed",bw="bottom",bv="1px",bu="right",bt=" ",bs="shorthand",br="top",bq="Number",N="left",O="widthTop",L="styleRight",M="styleLeft",J="widthLeft",K="widthBottom",H="styleTop",I="styleBottom",R="colorBottom",S="widthRight",bb="colorLeft",Y="colorRight",bi="colorTop",bd="_applyColorInnerRight",bm="colorInnerRight",bk="_applyWidthRight",U="_applyStyleRight",bp="_applyColorBottom",bo="_applyWidthLeft",bn="_applyStyleLeft",T="_applyColorTop",W="colorInnerTop",X="colorInnerLeft",ba="_applyColorRight",bc="_applyStyleBottom",be="_applyStyleTop",bj="_applyColorInnerLeft",bl="_applyWidthTop",P="qx.legacy.ui.core.Border",Q="_applyColorInnerTop",V="_applyColorLeft",bh="colorInnerBottom",bg="_applyWidthBottom",bf="_applyColorInnerBottom";
qx.Class.define(P,{extend:qx.core.Object,construct:function(t,u,v){arguments.callee.base.call(this);

if(t!==undefined){this.setWidth(t);
}
if(u!==undefined){this.setStyle(u);
}
if(v!==undefined){this.setColor(v);
}},statics:{fromString:function(cC){var cG=new qx.legacy.ui.core.Border;
var cE=cC.split(/\s+/);
var cF,cD;

for(var i=0,l=cE.length;i<l;i++){cF=cE[i];

switch(cF){case by:case x:case z:case bz:case F:case y:case bx:case B:case D:cG.setStyle(cF);
break;
default:cD=parseInt(cF);

if(cD===cF||qx.lang.String.contains(cF,A)){cG.setWidth(cD);
}else{cG.setColor(cF);
}break;
}}return cG;
},fromConfig:function(cn){var co=new qx.legacy.ui.core.Border;
co.set(cn);
return co;
},resetTop:qx.core.Variant.select(C,{"gecko":function(bA){var bB=bA._style;

if(bB){bB.borderTopWidth=bB.borderTopStyle=bB.borderTopColor=bB.MozBorderTopColors=G;
}},"default":function(cy){var cz=cy._style;

if(cz){cz.borderTopWidth=cz.borderTopStyle=cz.borderTopColor=G;
}cz=cy._innerStyle;

if(cz){cz.borderTopWidth=cz.borderTopStyle=cz.borderTopColor=G;
}}}),resetRight:qx.core.Variant.select(C,{"gecko":function(bT){var bU=bT._style;

if(bU){bU.borderRightWidth=bU.borderRightStyle=bU.borderRightColor=bU.MozBorderRightColors=G;
}},"default":function(bP){var bQ=bP._style;

if(bQ){bQ.borderRightWidth=bQ.borderRightStyle=bQ.borderRightColor=G;
}bQ=bP._innerStyle;

if(bQ){bQ.borderRightWidth=bQ.borderRightStyle=bQ.borderRightColor=G;
}}}),resetBottom:qx.core.Variant.select(C,{"gecko":function(bE){var bF=bE._style;

if(bF){bF.borderBottomWidth=bF.borderBottomStyle=bF.borderBottomColor=bF.MozBorderBottomColors=G;
}},"default":function(cs){var ct=cs._style;

if(ct){ct.borderBottomWidth=ct.borderBottomStyle=ct.borderBottomColor=G;
}ct=cs._innerStyle;

if(ct){ct.borderBottomWidth=ct.borderBottomStyle=ct.borderBottomColor=G;
}}}),resetLeft:qx.core.Variant.select(C,{"gecko":function(bR){var bS=bR._style;

if(bS){bS.borderLeftWidth=bS.borderLeftStyle=bS.borderLeftColor=bS.MozBorderLeftColors=G;
}},"default":function(ca){var cb=ca._style;

if(cb){cb.borderLeftWidth=cb.borderLeftStyle=cb.borderLeftColor=G;
}cb=ca._innerStyle;

if(cb){cb.borderLeftWidth=cb.borderLeftStyle=cb.borderLeftColor=G;
}}})},properties:{widthTop:{check:bq,init:0,apply:bl},widthRight:{check:bq,init:0,apply:bk},widthBottom:{check:bq,init:0,apply:bg},widthLeft:{check:bq,init:0,apply:bo},styleTop:{nullable:true,check:[F,y,bx,B,bz,z,x,by],init:F,apply:be},styleRight:{nullable:true,check:[F,y,bx,B,bz,z,x,by],init:F,apply:U},styleBottom:{nullable:true,check:[F,y,bx,B,bz,z,x,by],init:F,apply:bc},styleLeft:{nullable:true,check:[F,y,bx,B,bz,z,x,by],init:F,apply:bn},colorTop:{nullable:true,apply:T},colorRight:{nullable:true,apply:ba},colorBottom:{nullable:true,apply:bp},colorLeft:{nullable:true,apply:V},colorInnerTop:{nullable:true,apply:Q},colorInnerRight:{nullable:true,apply:bd},colorInnerBottom:{nullable:true,apply:bf},colorInnerLeft:{nullable:true,apply:bj},left:{group:[J,M,bb]},right:{group:[S,L,Y]},top:{group:[O,H,bi]},bottom:{group:[K,I,R]},width:{group:[O,S,K,J],mode:bs},style:{group:[H,L,I,M],mode:bs},color:{group:[bi,Y,R,bb],mode:bs},innerColor:{group:[W,bm,bh,X],mode:bs}},members:{_applyWidthTop:function(cc,cd){this.__rf=cc==null?E:cc+A;
this.__rr();
this.__rz(br);
},_applyWidthRight:function(cq,cr){this.__rg=cq==null?E:cq+A;
this.__rt();
this.__rz(bu);
},_applyWidthBottom:function(cj,ck){this.__rh=cj==null?E:cj+A;
this.__rv();
this.__rz(bw);
},_applyWidthLeft:function(b,c){this.__ri=b==null?E:b+A;
this.__rx();
this.__rz(N);
},_applyColorTop:function(h,j){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorTop,this,h);
},_applyColorRight:function(bG,bH){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorRight,this,bG);
},_applyColorBottom:function(cA,cB){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorBottom,this,cA);
},_applyColorLeft:function(f,g){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorLeft,this,f);
},_applyColorInnerTop:function(cl,cm){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorInnerTop,this,cl);
},_applyColorInnerRight:function(d,e){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorInnerRight,this,d);
},_applyColorInnerBottom:function(k,m){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorInnerBottom,this,k);
},_applyColorInnerLeft:function(cw,cx){qx.legacy.theme.manager.Color.getInstance().connect(this._changeColorInnerLeft,this,cw);
},_applyStyleTop:function(){this.__rz(br);
},_applyStyleRight:function(){this.__rz(bu);
},_applyStyleBottom:function(){this.__rz(bw);
},_applyStyleLeft:function(){this.__rz(N);
},_changeColorTop:function(n){this.__rj=n;
this.__rr();
this.__rz(br);
},_changeColorInnerTop:function(bD){this.__rk=bD;
this.__rr();
this.__rz(br);
},_changeColorRight:function(w){this.__rl=w;
this.__rt();
this.__rz(bu);
},_changeColorInnerRight:function(ce){this.__rm=ce;
this.__rt();
this.__rz(bu);
},_changeColorBottom:function(cp){this.__rn=cp;
this.__rv();
this.__rz(bw);
},_changeColorInnerBottom:function(cf){this.__ro=cf;
this.__rv();
this.__rz(bw);
},_changeColorLeft:function(bV){this.__rp=bV;
this.__rx();
this.__rz(N);
},_changeColorInnerLeft:function(bC){this.__rq=bC;
this.__rx();
this.__rz(N);
},__rr:function(){this.__rs=this.getWidthTop()===2&&this.__rk!=null&&this.__rj!=this.__rk;
},__rt:function(){this.__ru=this.getWidthRight()===2&&this.__rm!=null&&this.__rl!=this.__rm;
},__rv:function(){this.__rw=this.getWidthBottom()===2&&this.__ro!=null&&this.__rn!=this.__ro;
},__rx:function(){this.__ry=this.getWidthLeft()===2&&this.__rq!=null&&this.__rp!=this.__rq;
},__rz:function(a){qx.legacy.theme.manager.Border.getInstance().updateUsersOf(this);
},renderTop:qx.core.Variant.select(C,{"gecko":function(bN){var bO=bN._style;
bO.borderTopWidth=this.__rf||E;
bO.borderTopColor=this.__rj||G;
if(this.__rs){bO.borderTopStyle=F;
bO.MozBorderTopColors=this.__rj+bt+this.__rk;
}else{bO.borderTopStyle=this.getStyleTop()||D;
bO.MozBorderTopColors=G;
}},"default":function(bW){var bX=bW._style;
var bY=bW._innerStyle;

if(this.__rs){if(!bY){bW.prepareEnhancedBorder();
bY=bW._innerStyle;
}bX.borderTopWidth=bY.borderTopWidth=bv;
bX.borderTopStyle=bY.borderTopStyle=F;
bX.borderTopColor=this.__rj;
bY.borderTopColor=this.__rk;
}else{bX.borderTopWidth=this.__rf||E;
bX.borderTopStyle=this.getStyleTop()||D;
bX.borderTopColor=this.__rj||G;
if(bY){bY.borderTopWidth=bY.borderTopStyle=bY.borderTopColor=G;
}}}}),renderRight:qx.core.Variant.select(C,{"gecko":function(cu){var cv=cu._style;
cv.borderRightWidth=this.__rg||E;
cv.borderRightColor=this.__rl||G;
if(this.__ru){cv.borderRightStyle=F;
cv.MozBorderRightColors=this.__rl+bt+this.__rm;
}else{cv.borderRightStyle=this.getStyleRight()||D;
cv.MozBorderRightColors=G;
}},"default":function(bK){var bL=bK._style;
var bM=bK._innerStyle;

if(this.__ru){if(!bM){bK.prepareEnhancedBorder();
bM=bK._innerStyle;
}bL.borderRightWidth=bM.borderRightWidth=bv;
bL.borderRightStyle=bM.borderRightStyle=F;
bL.borderRightColor=this.__rl;
bM.borderRightColor=this.__rm;
}else{bL.borderRightWidth=this.__rg||E;
bL.borderRightStyle=this.getStyleRight()||D;
bL.borderRightColor=this.__rl||G;
if(bM){bM.borderRightWidth=bM.borderRightStyle=bM.borderRightColor=G;
}}}}),renderBottom:qx.core.Variant.select(C,{"gecko":function(bI){var bJ=bI._style;
bJ.borderBottomWidth=this.__rh||E;
bJ.borderBottomColor=this.__rn||G;
if(this.__rw){bJ.borderBottomStyle=F;
bJ.MozBorderBottomColors=this.__rn+bt+this.__ro;
}else{bJ.borderBottomStyle=this.getStyleBottom()||D;
bJ.MozBorderBottomColors=G;
}},"default":function(cg){var ch=cg._style;
var ci=cg._innerStyle;

if(this.__rw){if(!ci){cg.prepareEnhancedBorder();
ci=cg._innerStyle;
}ch.borderBottomWidth=ci.borderBottomWidth=bv;
ch.borderBottomStyle=ci.borderBottomStyle=F;
ch.borderBottomColor=this.__rn;
ci.borderBottomColor=this.__ro;
}else{ch.borderBottomWidth=this.__rh||E;
ch.borderBottomStyle=this.getStyleBottom()||D;
ch.borderBottomColor=this.__rn||G;
if(ci){ci.borderBottomWidth=ci.borderBottomStyle=ci.borderBottomColor=G;
}}}}),renderLeft:qx.core.Variant.select(C,{"gecko":function(r){var s=r._style;
s.borderLeftWidth=this.__ri||E;
s.borderLeftColor=this.__rp||G;
if(this.__ry){s.borderLeftStyle=F;
s.MozBorderLeftColors=this.__rp+bt+this.__rq;
}else{s.borderLeftStyle=this.getStyleLeft()||D;
s.MozBorderLeftColors=G;
}},"default":function(o){var p=o._style;
var q=o._innerStyle;

if(this.__ry){if(!q){o.prepareEnhancedBorder();
q=o._innerStyle;
}p.borderLeftWidth=q.borderLeftWidth=bv;
p.borderLeftStyle=q.borderLeftStyle=F;
p.borderLeftColor=this.__rp;
q.borderLeftColor=this.__rq;
}else{p.borderLeftWidth=this.__ri||E;
p.borderLeftStyle=this.getStyleLeft()||D;
p.borderLeftColor=this.__rp||G;
if(q){q.borderLeftWidth=q.borderLeftStyle=q.borderLeftColor=G;
}}}})}});
})();
(function(){var g="_applyFontTheme",f="Theme",e="qx.legacy.theme.manager.Font",d="singleton",c="changeFontTheme";
qx.Class.define(e,{type:d,extend:qx.legacy.util.ValueManager,properties:{fontTheme:{check:f,nullable:true,apply:g,event:c}},members:{resolveDynamic:function(a){return a instanceof qx.legacy.ui.core.Font?a:this._dynamic[a];
},isDynamic:function(b){return b&&(b instanceof qx.legacy.ui.core.Font||this._dynamic[b]!==undefined);
},syncFontTheme:function(){this.updateAll();
},_applyFontTheme:function(h){var i=this._dynamic;

for(var l in i){if(i[l].themed){i[l].dispose();
delete i[l];
}}
if(h){var j=h.fonts;
var k=qx.legacy.ui.core.Font;
...
(function(){var t="",s=";",r="underline",q="fontStyle",p="Boolean",o="px",n='"',m="fontSize",k="fontFamily",j="textDecoration",P="italic",O="fontWeight",N="normal",M="bold",L="_applyItalic",K="_applyBold",J="Integer",I="_applyFamily",H="'",G="font-weight:",A="Array",B="overline",y="line-through",z="qx.legacy.ui.core.Font",w="font-size:",x="font-style:",u="text-decoration:",v="font-family:",C="_applyDecoration",D=" ",F="_applySize",E=",";
qx.Class.define(z,{extend:qx.core.Object,construct:function(bd,be){arguments.callee.base.call(this);

if(bd!==undefined){this.setSize(bd);
}
if(be!==undefined){this.setFamily(be);
}},statics:{fromString:function(d){var h=new qx.legacy.ui.core.Font;
var f=d.split(/\s+/);
var name=[];
var g;

for(var i=0;i<f.length;i++){switch(g=f[i]){case M:h.setBold(true);
break;
case P:h.setItalic(true);
break;
case r:h.setDecoration(r);
break;
default:var e=parseInt(g);

if(e==g||qx.lang.String.contains(g,o)){h.setSize(e);
}else{name.push(g);
}break;
}}
if(name.length>0){h.setFamily(name);
}return h;
},fromConfig:function(Q){var R=new qx.legacy.ui.core.Font;
R.set(Q);
return R;
},reset:function(X){X.removeStyleProperty(k);
X.removeStyleProperty(m);
X.removeStyleProperty(O);
X.removeStyleProperty(q);
X.removeStyleProperty(j);
},resetElement:function(Y){var ba=Y.style;
ba.fontFamily=t;
ba.fontSize=t;
ba.fontWeight=t;
ba.fontStyle=t;
ba.textDecoration=t;
},resetStyle:function(bf){bf.fontFamily=t;
bf.fontSize=t;
bf.fontWeight=t;
bf.fontStyle=t;
bf.textDecoration=t;
}},properties:{size:{check:J,nullable:true,apply:F},family:{check:A,nullable:true,apply:I},bold:{check:p,nullable:true,apply:K},italic:{check:p,nullable:true,apply:L},decoration:{check:[r,y,B],nullable:true,apply:C}},members:{__rA:null,__rB:null,__rC:null,__rD:null,__rE:null,_applySize:function(bg,bh){this.__rA=bg===null?null:bg+o;
},_applyFamily:function(U,V){var W=t;

for(var i=0,l=U.length;i<l;i++){if(U[i].indexOf(D)>0){W+=n+U[i]+n;
}else{W+=U[i];
}
if(i!=l-1){W+=E;
}}this.__rB=W;
},_applyBold:function(S,T){this.__rC=S===null?null:S?M:N;
},_applyItalic:function(bb,bc){this.__rD=bb===null?null:bb?P:N;
},_applyDecoration:function(a,b){this.__rE=a===null?null:a;
},render:function(bk){bk.setStyleProperty(k,this.__rB);
bk.setStyleProperty(m,this.__rA);
bk.setStyleProperty(O,this.__rC);
bk.setStyleProperty(q,this.__rD);
bk.setStyleProperty(j,this.__rE);
},renderStyle:function(c){c.fontFamily=this.__rB||t;
c.fontSize=this.__rA||t;
c.fontWeight=this.__rC||t;
c.fontStyle=this.__rD||t;
c.textDecoration=this.__rE||t;
},renderElement:function(bi){var bj=bi.style;
bj.fontFamily=this.__rB||t;
bj.fontSize=this.__rA||t;
bj.fontWeight=this.__rC||t;
bj.fontStyle=this.__rD||t;
bj.textDecoration=this.__rE||t;
},generateStyle:function(){return (this.__rB?v+this.__rB.replace(/\"/g,H)+s:t)+(this.__rA?w+this.__rA+s:t)+(this.__weight?G+this.__weight+s:t)+(this.__style?x+this.__style+s:t)+(this.__rE?u+this.__rE+s:t);
}}});
})();
(function(){var f="icon",e="qx.legacy.theme.manager.Icon",d="_applyIconTheme",c="changeIconTheme",b="Theme",a="singleton";
qx.Class.define(e,{type:a,extend:qx.core.Object,properties:{iconTheme:{check:b,nullable:true,apply:d,event:c}},members:{_applyIconTheme:function(j,k){if(qx.legacy.theme.manager.Meta.getInstance().getAutoSync()){this.syncIconTheme();
}},syncIconTheme:function(){var i=this.getIconTheme();
var h=qx.legacy.util.AliasManager.getInstance();

if(i){h.add(f,i.resource);
}else{h.remove(f);
}
if(i){for(var g in i.aliases){h.add(g,i.aliases[g]);
}}}}});
})();
...
this._aliases={};
this.add(b,i);
},members:{_preprocess:function(s){var v=this._dynamic;

if(v[s]===false){return s;
}else if(v[s]===undefined){if(s.charAt(0)===l||s.charAt(0)===c||s.indexOf(h)===0||s.indexOf(g)===j||s.indexOf(f)===0){v[s]=false;
return s;
}var u=s.substring(0,s.indexOf(l));
var t=this._aliases[u];

if(t!==undefined){v[s]=t+s.substring(u.length);
}}return s;
},add:function(m,n){this._aliases[m]=n;
var p=this._dynamic;
var o={};
for(var q in p){if(q.substring(0,q.indexOf(l))===m){p[q]=n+q.substring(m.length);
o[q]=true;
}}},remove:function(r){delete this._aliases[r];
...
qx.Class.define(c,{type:a,extend:qx.core.Object,properties:{widgetTheme:{check:b,nullable:true,apply:d,event:e}},members:{_applyWidgetTheme:function(g,h){if(qx.legacy.theme.manager.Meta.getInstance().getAutoSync()){this.syncWidgetTheme();
}},syncWidgetTheme:function(){var k=this.getWidgetTheme();
var j=qx.legacy.util.AliasManager.getInstance();

if(k){j.add(f,k.resource);
}else{j.remove(f);
}
if(k){for(var i in k.aliases){j.add(i,k.aliases[i]);
}}}}});
})();
(function(){var e="qx.legacy.event.handler.FocusHandler",d="_attachedWidget",c="Tab";
qx.Class.define(e,{extend:qx.core.Object,construct:function(a){arguments.callee.base.call(this);

if(a!=null){this._attachedWidget=a;
}},statics:{mouseFocus:false},members:{getAttachedWidget:function(){return this._attachedWidget;
},_onkeyevent:function(B,C){if(C.getKeyIdentifier()!=c){return;
}C.stopPropagation();
C.preventDefault();
qx.legacy.event.handler.FocusHandler.mouseFocus=false;
var E=this.getAttachedWidget().getFocusedChild();
if(!C.isShiftPressed()){var D=E?this.getWidgetAfter(B,E):this.getFirstWidget(B);
}else{var D=E?this.getWidgetBefore(B,E):this.getLastWidget(B);
}if(D){D.setFocused(true);
D._ontabfocus();
}},compareTabOrder:function(r,s){if(r==s){return 0;
}var v=r.getTabIndex();
var u=s.getTabIndex();
if(v!=u){return v-u;
}var x=qx.bom.element.Location.getTop(r.getElement());
var t=qx.bom.element.Location.getTop(s.getElement());

if(x!=t){return x-t;
}var y=qx.bom.element.Location.getLeft(r.getElement());
var w=qx.bom.element.Location.getLeft(s.getElement());
...
},getFirstWidget:function(b){return this._getFirst(b,null);
},getLastWidget:function(q){return this._getLast(q,null);
},getWidgetAfter:function(N,O){if(N==O){return this.getFirstWidget(N);
}
if(O.getAnonymous()){O=O.getParent();
}
if(O==null){return [];
}var P=[];
this._getAllAfter(N,O,P);
P.sort(this.compareTabOrder);
return P.length>0?P[0]:this.getFirstWidget(N);
},getWidgetBefore:function(Q,R){if(Q==R){return this.getLastWidget(Q);
}
if(R.getAnonymous()){R=R.getParent();
}
if(R==null){return [];
}var T=[];
this._getAllBefore(Q,R,T);
T.sort(this.compareTabOrder);
var S=T.length;
return S>0?T[S-1]:this.getLastWidget(Q);
},_getAllAfter:function(parent,f,g){var h=parent.getChildren();
var k;
var j=h.length;
...
if(k.isFocusable()&&k.getTabIndex()>0&&this.compareTabOrder(f,k)<0){g.push(h[i]);
}
if(!k.isFocusRoot()&&k instanceof qx.legacy.ui.core.Parent){this._getAllAfter(k,f,g);
}}},_getAllBefore:function(parent,l,m){var n=parent.getChildren();
var p;
var o=n.length;

for(var i=0;i<o;i++){p=n[i];

if(!(p instanceof qx.legacy.ui.core.Parent)&&!(p instanceof qx.legacy.ui.basic.Terminator)){continue;
}
if(p.isFocusable()&&p.getTabIndex()>0&&this.compareTabOrder(l,p)>0){m.push(p);
}
if(!p.isFocusRoot()&&p instanceof qx.legacy.ui.core.Parent){this._getAllBefore(p,l,m);
}}},_getFirst:function(parent,F){var G=parent.getChildren();
var I;
var H=G.length;

for(var i=0;i<H;i++){I=G[i];

if(!(I instanceof qx.legacy.ui.core.Parent)&&!(I instanceof qx.legacy.ui.basic.Terminator)){continue;
}
if(I.isFocusable()&&I.getTabIndex()>0){if(F==null||this.compareTabOrder(I,F)<0){F=I;
}}
if(!I.isFocusRoot()&&I instanceof qx.legacy.ui.core.Parent){F=this._getFirst(I,F);
}}return F;
},_getLast:function(parent,J){var K=parent.getChildren();
var M;
var L=K.length;

for(var i=0;i<L;i++){M=K[i];

if(!(M instanceof qx.legacy.ui.core.Parent)&&!(M instanceof qx.legacy.ui.basic.Terminator)){continue;
}
if(M.isFocusable()&&M.getTabIndex()>0){if(J==null||this.compareTabOrder(M,J)>0){J=M;
}}
if(!M.isFocusRoot()&&M instanceof qx.legacy.ui.core.Parent){J=this._getLast(M,J);
}}return J;
...
(function(){var g="__rF",f="__rG",e="singleton",d="qx.legacy.io.image.Manager";
qx.Class.define(d,{type:e,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__rF={};
this.__rG={};
},members:{add:function(h){var i=this.__rG;

if(i[h]===undefined){i[h]=1;
}else{i[h]++;
}},remove:function(p){var q=this.__rG;

if(q[p]!==undefined){q[p]--;
}
if(q[p]<=0){delete q[p];
}},show:function(j){var k=this.__rF;

if(k[j]===undefined){k[j]=1;
}else{k[j]++;
}},hide:function(r){var s=this.__rF;

if(s[r]!==undefined){s[r]--;
}
if(s[r]<=0){delete s[r];
}},getVisibleImages:function(){var a=this.__rF;
var b={};

for(var c in a){if(a[c]>0){b[c]=true;
}}return b;
},getHiddenImages:function(){var l=this.__rF;
var m=this.__rG;
var n={};
...
},"default":function(t){return t.offsetLeft;
}}),getTop:qx.core.Variant.select(d,{"gecko":function(n){var r=n.offsetTop;
var p=n.parentNode;
var o=qx.legacy.html.Style.getStyleProperty(n,f);
var q=qx.legacy.html.Style.getStyleProperty(p,f);
if(o!=e&&o!=g){r-=qx.legacy.html.Style.getBorderTop(p);
}if(q!=e&&q!=g){while(p){p=p.parentNode;

if(!p||typeof p.tagName!==c){break;
}var s=qx.legacy.html.Style.getStyleProperty(p,f);

if(s==e||s==g){r-=qx.legacy.html.Style.getBorderTop(p)+qx.legacy.html.Style.getPaddingTop(p);
break;
}}}return r;
},"default":function(a){return a.offsetTop;
}})}});
})();
(function(){var i="auto",h="scroll",g="overflow",f="body",e="-moz-scrollbars-horizontal",d="qx.legacy.html.ScrollIntoView",c="-moz-scrollbars-vertical",b="overflowY",a="overflowX";
qx.Class.define(d,{statics:{scrollX:function(j,k){var p,q,o,n;
var m=j.parentNode;
var l=j.offsetLeft;
var o=j.offsetWidth;

while(m){switch(qx.legacy.html.Style.getStyleProperty(m,g)){case h:case i:case e:n=true;
break;
default:switch(qx.legacy.html.Style.getStyleProperty(m,a)){case h:case i:n=true;
break;
default:n=false;
}}
if(n){p=m.clientWidth;
q=m.scrollLeft;

if(k){m.scrollLeft=l;
}else if(k==false){m.scrollLeft=l+o-p;
}else if(o>p||l<q){m.scrollLeft=l;
}else if((l+o)>(q+p)){m.scrollLeft=l+o-p;
}l=m.offsetLeft;
o=m.offsetWidth;
}else{l+=m.offsetLeft;
}
if(m.tagName.toLowerCase()==f){break;
}m=m.offsetParent;
}return true;
},scrollY:function(r,s){var u,y,x,w;
var v=r.parentNode;
var t=r.offsetTop;
var x=r.offsetHeight;

while(v){switch(qx.legacy.html.Style.getStyleProperty(v,g)){case h:case i:case c:w=true;
break;
default:switch(qx.legacy.html.Style.getStyleProperty(v,b)){case h:case i:w=true;
break;
default:w=false;
}}
if(w){u=v.clientHeight;
y=v.scrollTop;

if(s){v.scrollTop=t;
}else if(s==false){v.scrollTop=t+x-u;
}else if(x>u||t<y){v.scrollTop=t;
}else if((t+x)>(y+u)){v.scrollTop=t+x-u;
}t=v.offsetTop;
x=v.offsetHeight;
}else{t+=v.offsetTop;
}
if(v.tagName.toLowerCase()==f){break;
}v=v.offsetParent;
}return true;
}}});
})();
...
(function(){var b="qx.legacy.application.MMouseCapturePatch",a="qx.legacy";
qx.Mixin.define(b,{members:{canDispatchEvent:function(c,event,d){return (this.__captureElement&&this.__captureEvents[d]&&event.classname&&event.classname.indexOf(a)==-1);
}}});
})();
(function(){var a="qx.legacy.application.MEventPoolPatch";
qx.Mixin.define(a,{members:{__rH:{"qx.legacy.event.type.DragEvent":1,"qx.legacy.event.type.MouseEvent":1,"qx.legacy.event.type.KeyEvent":1},poolObject:function(b){if(this.__rH[b.classname]){return;
...
(function(){var j="completed",i="interval",h="qx.legacy.io.image.PreloaderSystem",g="qx.preloaderTimeout",f="_list",d="load",c="qx.event.type.Event",b="_timer",a="error";
qx.Class.define(h,{extend:qx.core.Object,construct:function(m,n,o){arguments.callee.base.call(this);
if(m instanceof Array){this._list=qx.lang.Object.fromArray(m);
}else{this._list=m;
}this._timer=new qx.event.Timer(qx.core.Setting.get(g));
this._timer.addListener(i,this.__rK,this);
if(n){this.addListener(j,n,o||null);
}},events:{"completed":c},members:{_stopped:false,start:function(){if(qx.lang.Object.isEmpty(this._list)){this.fireEvent(j);
return;
}
for(var k in this._list){var l=qx.legacy.io.image.PreloaderManager.getInstance().create(qx.legacy.util.AliasManager.getInstance().resolve(k));

if(l.isErroneous()||l.isLoaded()){delete this._list[k];
}else{l._origSource=k;
l.addListener(d,this.__rI,this);
l.addListener(a,this.__rJ,this);
}}this._check();
},__rI:function(e){if(this.isDisposed()){return;
}delete this._list[e.getTarget()._origSource];
this._check();
},__rJ:function(e){if(this.isDisposed()){return;
}delete this._list[e.getTarget()._origSource];
this._check();
},__rK:function(e){this.warn("Cannot preload: "+qx.lang.Object.getKeysAsString(this._list));
this._stopped=true;
this._timer.stop();
this.fireEvent(j);
...
}}},settings:{"qx.preloaderTimeout":3000},destruct:function(){if(this._timer){this._timer.removeListener(i,this.__rK,this);
...
qx.Class.define(d,{type:c,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this._objects={};
},members:{add:function(h){this._objects[h.getUri()]=h;
},remove:function(b){delete this._objects[b.getUri()];
},has:function(f){return this._objects[f]!=null;
},get:function(a){return this._objects[a];
},create:function(g){if(this._objects[g]){return this._objects[g];
}return new qx.legacy.io.image.Preloader(g);
}},destruct:function(){this._disposeFields(e);
}});
})();
...
this._element.onload=qx.lang.Function.bind(this.__rL,this);
this._element.onerror=qx.lang.Function.bind(this.__rM,this);
this._source=k;
this._element.src=qx.util.ResourceManager.getInstance().toUri(k);
...
}}),__rL:function(){if(this._isLoaded||this._isErroneous){return;
}this._isLoaded=true;
this._isErroneous=false;
this.fireEvent(c);
},__rM:function(){if(this._isLoaded||this._isErroneous){return;
...
(function(){var m="div",l="resize",k="qx.ui.root.Page",j="__pe",i="position",h="gecko",g="$$widget",f="qx.client",d="qxIsRootPage",c="absolute";
qx.Class.define(k,{extend:qx.ui.root.Abstract,construct:function(n){this.__pe=n;
arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.Basic());
this.setZIndex(10000);
qx.ui.core.queue.Layout.add(this);
this.addListener(l,this.__pg,this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
},members:{__pf:null,__pe:null,_createContainerElement:function(){var p=this.__pe.createElement(m);
this.__pe.body.appendChild(p);
var o=new qx.html.Root(p);
o.setStyle(i,c);
o.setAttribute(g,this.toHashCode());
if(qx.core.Variant.isSet(f,h)){o.setAttribute(d,1);
}return o;
...
},__pg:function(e){this.getContainerElement().setStyles({width:0,height:0});
...
qx.Theme.define(b,{title:c,aliases:{widget:a},widgets:{}});
})();
(function(){var dC="undefined",dB="solid",dA="background",dz="effect",dy="middle",dx="border-dark-shadow",dw="auto",dv="inset",du="outset",dt="default",dc="button",db="list",da="text-field",cY="gray",cX="inset-thin",cW="text-selected",cV="selected",cU="outset-thin",cT="window-captionbar-button",cS="dark-shadow",dJ="text-disabled",dK="button-abandoned",dH="50%",dI="center",dF="field",dG="date-chooser-title",dD="transparent",dE="table-header-border",dL="left",dM="list-view-content-cell-text",dl="static/image/blank.gif",dk="hidden",dn="date-chooser",dm="black",dq="row-resize",dp="spinner-button",ds="list-view-content-cell",dr="button-view-pane",dj="menu-button",di="tab-view-border",bJ="list-view-header-border",bK="widget/arrows/down.gif",bL="col-resize",bM="tooltip",bN="scrollY",bO="tree-element-icon",bP="right",bQ="menu",bR="widget/table/ascending.png",bS="widget/cursors/alias.gif",dQ="table-header-cell",dP="widget/arrows/next.gif",dO="tree-folder-icon",dN="list-view",dU="bold",dT="radio-view-button-checked",dS="widget/window/minimize.gif",dR="tab-view-button-checked",dW="table-pane",dV="text",cs="widget/splitpane/knob-vertical.png",ct="widget/window/close.gif",cq="widget/core/dotted-white.gif",cr="widget/cursors/move.gif",cw="widget/menu/checkbox.gif",cx="table-header-cell-hover",cu="window-active-caption",cv="widget/arrows/down-small.gif",co="large",cp="groove",cb="tree-folder",ca="widget/window/maximize.gif",cd="decoration/core/dotted-white.gif",cc="button-view-bar",bW="window-inactive-caption-text",bV="combo-box-button",bY="widget/cursors/nodrop.gif",bX="tooltip-text",bU="widget/window/restore.gif",bT="button-hover",cC="widget/cursors/copy.gif",cD="check-box-group-box-legend",cE="widget/splitpane/knob-horizontal.png",cF="widget/arrows/up.gif",cy="tab-view-pane",cz="divider-vertical",cA="tree-element-label",cB="widget/menu/radiobutton.gif",cG="list-view-header",cH="button-view",cl="divider-horizontal",ck="top",cj="radio-view-pane",ci="tab-view-button-hover",ch="window-active-caption-text",cg="list-view-border",cf="popup",ce="check-box",cn="tab-view-button",cm="window-inactive-caption",cI="qx.legacy.theme.classic.Appearance",cJ="widget/arrows/up-small.gif",cK="widget/table/descending.png",cL="empty",cM="tree-folder-label",cN="list-view-header-cell-hover",cO="table-focus-indicator",cP="Classic",cQ="tree-element",cR="resizer",dg="label",df="widget/table/selectColumnOrder.png",de="table-header",dd="bold-large",dh="radio-view-bar";
qx.Theme.define(cI,{title:cP,appearances:{"empty":{},"widget":{},"image":{},"atom":{},"popup":{},"cursor-dnd-move":{style:function(n){return {source:cr};
}},"cursor-dnd-copy":{style:function(l){return {source:cC};
}},"cursor-dnd-alias":{style:function(bt){return {source:bS};
}},"cursor-dnd-nodrop":{style:function(B){return {source:bY};
}},"label":{style:function(bs){return {textColor:bs.disabled?dJ:dC};
}},"client-document":{style:function(V){return {backgroundColor:dA,textColor:dV,font:dt};
}},"client-document-blocker":{style:function(ee){return {cursor:dt,backgroundImage:dl};
}},"tool-tip":{include:cf,style:function(U){return {backgroundColor:bM,textColor:bX,border:bM,padding:[1,3,2,3]};
}},"iframe":{style:function(o){return {border:dv};
}},"check-box":{style:function(eB){return {padding:[2,3]};
}},"radio-button":{include:ce},"button":{style:function(P){if(P.pressed||P.checked||P.abandoned){var R=dv;
}else{var R=du;
}
if(P.pressed||P.abandoned){var Q=[4,3,2,5];
}else{var Q=[3,4];
}return {backgroundColor:P.abandoned?dK:P.over?bT:dc,border:R,padding:Q};
}},"toolbar":{style:function(eA){return {border:cU,backgroundColor:dA};
}},"toolbar-part":{},"toolbar-part-handle":{style:function(bE){return {width:10};
}},"toolbar-part-handle-line":{style:function(ek){return {top:2,left:3,bottom:2,width:4,border:cU};
}},"toolbar-separator":{style:function(eN){return {width:8};
}},"toolbar-separator-line":{style:function(bC){return {top:2,left:3,width:dw,bottom:2,border:cl};
}},"toolbar-button":{style:function(h){if(h.pressed||h.checked||h.abandoned){var j=cX;
var i=[3,2,1,4];
}else if(h.over){var j=cU;
var i=[2,3];
}else{var j=dC;
var i=[3,4];
}return {cursor:dt,spacing:4,width:dw,border:j,padding:i,verticalChildrenAlign:dy,backgroundColor:h.abandoned?dK:dc,backgroundImage:h.checked&&!h.over?cq:null};
}},"button-view":{style:function(eO){return {border:cS};
}},"button-view-pane":{style:function(a){return {backgroundColor:dr,padding:10};
}},"button-view-page":{},"button-view-bar":{style:function(ev){var ew=dC;
var ex=dC;
var ey=qx.legacy.ui.core.Border;

if(ev.barTop){ew=[1,0];
ex=ey.fromConfig({bottom:[1,dB,dx]});
}else if(ev.barBottom){ew=[1,0];
ex=ey.fromConfig({top:[1,dB,dx]});
}else if(ev.barLeft){ew=[0,1];
ex=ey.fromConfig({right:[1,dB,dx]});
}else if(ev.barRight){ew=[0,1];
ex=ey.fromConfig({left:[1,dB,dx]});
}return {backgroundColor:cc,padding:ew||dC,border:ex||dC};
}},"button-view-button":{style:function(X){var bc,ba,bd,Y,bb;

if(X.checked||X.over){bb=new qx.legacy.ui.core.Border(1,dB,dx);

if(X.barTop){bb.setBottom(3,dB,dz);
Y=[3,6,1,6];
}else if(X.barBottom){bb.setTop(3,dB,dz);
Y=[1,6,3,6];
}else if(X.barLeft){bb.setRight(3,dB,dz);
Y=[3,4,3,6];
}else{bb.setLeft(3,dB,dz);
Y=[3,6,3,4];
}}else{bb=dC;
Y=[4,7];
}
if(X.barTop||X.barBottom){bc=[0,1];
ba=dw;
bd=null;
}else{bc=[1,0];
bd=dw;
ba=null;
}return {backgroundColor:X.checked?dr:dC,iconPosition:ck,margin:bc,width:ba,height:bd,border:bb,padding:Y||dC};
}},"tab-view":{style:function(W){return {spacing:-1};
}},"tab-view-bar":{},"tab-view-pane":{style:function(eb){return {backgroundColor:cy,border:new qx.legacy.ui.core.Border(1,dB,di),padding:10};
}},"tab-view-page":{},"tab-view-button":{style:function(bg){var bj,bh,bn,bp;
var bo,bi,bl,bk;
var bm,bq;
bo=0;
bi=0;
bq=new qx.legacy.ui.core.Border(1,dB,di);
...
if(bg.barTop){bq.setWidthBottom(0);
bq.setTop(3,dB,dz);
}else{bq.setWidthTop(0);
bq.setBottom(3,dB,dz);
}
if(bg.alignLeft){if(bg.firstChild){bn=6;
bp=7;
bk=0;
}}else{if(bg.lastChild){bn=8;
bp=5;
bl=0;
}}}else{bj=2;
bh=2;
...
if(bg.alignLeft){if(bg.firstChild){bn=6;
bp=5;
}}else{if(bg.lastChild){bn=6;
bp=5;
bl=0;
}}}return {padding:[bj,bp,bh,bn],margin:[bo,bl,bi,bk],border:bq,backgroundColor:bm};
}},"radio-view":{include:cH},"radio-view-pane":{style:function(br){return {backgroundColor:cj};
}},"radio-view-page":{},"radio-view-bar":{style:function(et){return {backgroundColor:dh,padding:[1,0],border:et.barTop?qx.legacy.ui.core.Border.fromConfig({bottom:[1,dB,dx]}):qx.legacy.ui.core.Border.fromConfig({top:[1,dB,dx]})};
}},"radio-view-button":{style:function(eJ){var eL,eK;

if(eJ.checked||eJ.over){eL=new qx.legacy.ui.core.Border(1,dB,dx);
eL.setLeft(3,dB,dz);
eK=[2,6,2,4];
}else{eL=dC;
eK=[3,7];
}return {backgroundColor:eJ.checked?dT:dC,iconPosition:dL,margin:[0,1],width:dw,opacity:eJ.checked?1.0:0.3,border:eL,padding:eK};
}},"window":{style:function(O){return {backgroundColor:dA,padding:1,border:O.maximized?dC:du};
}},"window-captionbar":{style:function(eQ){return {padding:[1,2,2],verticalChildrenAlign:dy,backgroundColor:eQ.active?cu:cm,textColor:eQ.active?ch:bW};
}},"window-resize-frame":{style:function(r){return {border:cS};
}},"window-captionbar-icon":{style:function(H){return {marginRight:2};
}},"window-captionbar-title":{style:function(bB){return {cursor:dt,font:dU,marginRight:2};
}},"window-captionbar-button":{include:dc,style:function(bI){return {padding:bI.pressed||bI.abandoned?[2,1,0,3]:[1,2]};
}},"window-captionbar-minimize-button":{include:cT,style:function(t){return {icon:dS};
}},"window-captionbar-restore-button":{include:cT,style:function(N){return {icon:bU};
}},"window-captionbar-maximize-button":{include:cT,style:function(C){return {icon:ca};
}},"window-captionbar-close-button":{include:cT,style:function(eg){return {marginLeft:2,icon:ct};
}},"window-statusbar":{style:function(eo){return {border:cX};
}},"window-statusbar-text":{style:function(es){return {padding:[1,4]};
}},"color-popup":{style:function(eT){return {padding:4,border:du,backgroundColor:dA};
}},"resizer":{style:function(eD){return {border:du};
}},"resizer-frame":{style:function(bz){return {border:cS};
}},"menu":{style:function(g){return {backgroundColor:bQ,border:du,padding:1};
}},"menu-layout":{},"menu-button":{style:function(J){return {spacing:2,padding:[2,4],verticalChildrenAlign:dy,backgroundColor:J.over?cV:dC,textColor:J.over?cW:dC};
}},"menu-button-arrow":{style:function(eM){return {source:dP};
}},"menu-check-box":{include:dj,style:function(eR){return {icon:eR.checked?cw:dl};
}},"menu-radio-button":{include:dj,style:function(ec){return {icon:ec.checked?cB:dl};
}},"menu-separator":{style:function(eP){return {marginTop:3,marginBottom:2,paddingLeft:3,paddingRight:3};
}},"menu-separator-line":{style:function(eI){return {right:0,left:0,height:dw,border:cz};
}},"list":{style:function(u){return {border:cX,backgroundColor:db};
}},"list-item":{style:function(dX){return {horizontalChildrenAlign:dL,verticalChildrenAlign:dy,spacing:4,padding:[3,5],backgroundColor:dX.selected?cV:dC,textColor:dX.selected?cW:dC};
}},"text-field":{style:function(eF){return {border:dv,padding:[1,3],textColor:eF.disabled?dJ:dC,backgroundColor:dF};
}},"text-area":{include:da},"combo-box":{style:function(A){return {border:dv,backgroundColor:dF};
}},"combo-box-list":{include:db,style:function(bD){return {border:dC,overflow:bN};
}},"combo-box-popup":{include:db,style:function(b){return {maxHeight:150,border:cS};
}},"combo-box-text-field":{include:da,style:function(s){return {border:dC,backgroundColor:dD};
}},"combo-box-button":{include:dc,style:function(w){return {padding:[0,3,0,2],icon:bK};
}},"combo-box-ex":{style:function(p){return {border:dv,backgroundColor:dF};
}},"combo-box-ex-list":{include:db,style:function(v){return {border:dC,edge:0};
}},"combo-box-ex-text-field":{include:da,style:function(eH){return {border:dC,minWidth:30,width:100,backgroundColor:dD};
}},"combo-box-ex-popup":{include:db,style:function(ep){return {border:cR};
}},"combo-box-ex-button":{include:bV},"treevirtual-focus-indicator":{include:cL},"tree-element":{style:function(K){return {height:16,verticalChildrenAlign:dy};
}},"tree-element-icon":{style:function(be){return {width:16,height:16};
}},"tree-element-label":{include:dg,style:function(G){return {marginLeft:3,height:15,padding:2,backgroundColor:G.selected?cV:dC,textColor:G.disabled?dJ:(G.selected?cW:dC)};
}},"tree-folder":{include:cQ},"tree-folder-icon":{include:bO},"tree-folder-label":{include:cA},"tree":{include:cb},"tree-icon":{include:dO},"tree-label":{include:cM},"list-view":{style:function(bH){return {border:new qx.legacy.ui.core.Border(1,dB,cg),backgroundColor:dN};
}},"list-view-pane":{style:function(ez){return {horizontalSpacing:1};
}},"list-view-header":{style:function(z){return {border:qx.legacy.ui.core.Border.fromConfig({bottom:[1,dB,bJ]}),backgroundColor:cG};
}},"list-view-header-cell":{style:function(by){return {padding:[2,6],spacing:4,backgroundColor:by.over?cN:dC,paddingBottom:by.over?0:2,border:by.over?new qx.legacy.ui.core.Border.fromConfig({bottom:[2,dB,dz]}):dC};
}},"list-view-header-cell-arrow-up":{style:function(eS){return {source:cF};
}},"list-view-header-cell-arrow-down":{style:function(F){return {source:bK};
}},"list-view-header-separator":{style:function(I){return {backgroundColor:bJ,width:1,marginTop:1,marginBottom:1};
}},"list-view-content-cell":{style:function(S){return {cursor:dt,backgroundColor:S.selected?cV:dC,textColor:S.selected?cW:dC,border:S.lead&&
!S.selected?
new qx.legacy.ui.core.Border.fromConfig({top:[1,dB,dz],bottom:[1,dB,dz]}):dC,marginTop:S.lead&&!S.selected?0:1,marginBottom:S.lead&&!S.selected?0:1};
}},"list-view-content-cell-image":{include:ds,style:function(eu){return {paddingLeft:6,paddingRight:6};
}},"list-view-content-cell-text":{include:ds,style:function(ea){return {overflow:dk,paddingLeft:6,paddingRight:6};
}},"list-view-content-cell-html":{include:dM},"list-view-content-cell-icon-html":{include:dM},"list-view-content-cell-link":{include:dM},"group-box":{style:function(c){return {backgroundColor:dA};
}},"group-box-legend":{style:function(bF){return {location:[10,1],backgroundColor:dA,paddingRight:3,paddingLeft:4,marginRight:10};
}},"group-box-frame":{style:function(f){return {edge:[8,0,0],padding:[12,9],border:cp};
}},"check-box-group-box-legend":{style:function(q){return {location:[10,1],backgroundColor:dA,paddingRight:3};
}},"radio-button-group-box-legend":{include:cD},"spinner":{style:function(eE){return {border:dv,backgroundColor:dF};
}},"spinner-text-field":{include:da,style:function(x){return {backgroundColor:dD};
}},"spinner-button":{style:function(y){return {width:16,backgroundColor:dA,paddingLeft:3,border:y.pressed||y.checked||y.abandoned?dv:du};
}},"spinner-button-up":{include:dp,style:function(eC){return {source:cJ};
}},"spinner-button-down":{include:dp,style:function(bG){return {paddingTop:1,source:cv};
}},"colorselector":{style:function(T){return {backgroundColor:dA,border:du};
}},"datechooser-toolbar-button":{style:function(eh){var ei={backgroundColor:eh.abandoned?dK:dc,backgroundImage:(eh.checked&&!eh.over)?cd:null,spacing:4,width:dw,verticalChildrenAlign:dy};

if(eh.pressed||eh.checked||eh.abandoned){ei.border=cX;
}else if(eh.over){ei.border=cU;
}else{ei.border=dC;
}
if(eh.pressed||eh.checked||eh.abandoned){ei.padding=[2,0,0,2];
}else if(eh.over){ei.padding=1;
}else{ei.padding=2;
}return ei;
}},"datechooser-monthyear":{style:function(e){return {font:co,textAlign:dI,verticalAlign:dy};
}},"datechooser-datepane":{style:function(ed){return {border:new qx.legacy.ui.core.Border(1,dB,cY),backgroundColor:dn};
}},"datechooser-weekday":{style:function(D){var E=qx.legacy.ui.core.Border.fromConfig({bottom:[1,dB,cY]});
return {border:E,font:dd,textAlign:dI,textColor:D.weekend?dG:dn,backgroundColor:D.weekend?dn:dG};
}},"datechooser-day":{style:function(dY){return {textAlign:dI,verticalAlign:dy,border:dY.today?dm:dC,textColor:dY.selected?cW:dY.otherMonth?dJ:dC,backgroundColor:dY.selected?cV:dC,padding:[2,4]};
}},"datechooser-week":{style:function(L){if(L.header){var M=qx.legacy.ui.core.Border.fromConfig({right:[1,dB,cY],bottom:[1,dB,cY]});
}else{var M=qx.legacy.ui.core.Border.fromConfig({right:[1,dB,cY]});
}return {textAlign:dI,textColor:dG,padding:[2,4],border:M};
}},"table-focus-statusbar":{style:function(m){return {border:qx.legacy.ui.core.Border.fromConfig({top:[1,dB,dx]}),paddingLeft:2,paddingRight:2};
}},"table-focus-indicator":{style:function(eG){return {border:new qx.legacy.ui.core.Border(2,dB,cO)};
}},"table-editor-textfield":{include:da,style:function(er){return {border:dC,padding:[0,2]};
}},"table-pane":{style:function(eq){return {backgroundColor:dW};
}},"table-header":{style:function(ef){return {border:qx.legacy.ui.core.Border.fromConfig({bottom:[1,dB,dE]}),backgroundColor:de};
}},"table-menubar-button":{style:function(el){if(el.pressed||el.checked||el.abandoned){var en=cX;
var em=[3,2,1,4];
}else if(el.over){var en=cU;
var em=[2,3];
}else{var en=dC;
var em=[3,4];
}return {cursor:dt,spacing:4,width:dw,border:en,padding:em,verticalChildrenAlign:dy,backgroundColor:el.abandoned?dK:dc,icon:df};
}},"table-header-cell":{style:function(bu){var bw,bx,bv;

if(bu.mouseover){bw=qx.legacy.ui.core.Border.fromConfig({right:[1,dB,dE],bottom:[2,dB,dz]});
bv=0;
bx=cx;
}else{bw=qx.legacy.ui.core.Border.fromConfig({right:[1,dB,dE]});
bv=2;
bx=dQ;
}return {paddingLeft:2,paddingRight:2,paddingBottom:bv,spacing:4,overflow:dk,iconPosition:bP,verticalChildrenAlign:dy,border:bw,backgroundColor:bx,icon:bu.sorted?(bu.sortedAscending?bR:cK):null,horizontalChildrenAlign:dL};
}},"splitpane":{style:function(k){return {overflow:dk,splitterSize:8,backgroundColor:dA};
}},"splitpane-splitter":{style:function(bA){return {cursor:bA.horizontal?bL:dq};
}},"splitpane-slider":{style:function(ej){return {opacity:0.5,backgroundColor:dA};
}},"splitpane-knob":{style:function(bf){if(bf.horizontal){return {opacity:bf.dragging?0.5:1.0,top:dH,left:dH,cursor:bL,source:cE,marginLeft:-2,marginTop:-7};
}else{return {opacity:bf.dragging?0.5:1.0,top:dH,left:dH,source:cs,marginTop:-2,marginLeft:-7,cursor:dq};
}}},"scrollbar-blocker":{style:function(d){return {backgroundColor:dm,opacity:0.2};
}}}});
})();
...
(function(){var C="Boolean",B="vertical",A="horizontal",z="left",y="top",x="stretchChildrenOrthogonalAxis",w="orientation",v="reverseChildrenOrder",u="useAdvancedFlexAllocation",t="spacing",V="changeOrientation",U="bottom",T="accumulatedChildrenOuterHeight",S="horizontalChildrenAlign",R="_applySpacing",Q="_applyStretchChildrenOrthogonalAxis",P="accumulatedChildrenOuterWidth",O="Integer",N="center",M="middle",J="qx.legacy.ui.layout.BoxLayout",K="_applyOrientation",H="_applyHorizontalChildrenAlign",I="right",F="_applyReverseChildrenOrder",G="_applyUseAdvancedFlexAllocation",D="changeSpacing",E="verticalChildrenAlign",L="_applyVerticalChildrenAlign";
qx.Class.define(J,{extend:qx.legacy.ui.core.Parent,construct:function(bg){arguments.callee.base.call(this);
if(bg!=null){this.setOrientation(bg);
}else{this.initOrientation();
}},statics:{STR_REVERSED:"-reversed"},properties:{orientation:{check:[A,B],init:A,apply:K,event:V},spacing:{check:O,init:0,themeable:true,apply:R,event:D},horizontalChildrenAlign:{check:[z,N,I],init:z,themeable:true,apply:H},verticalChildrenAlign:{check:[y,M,U],init:y,themeable:true,apply:L},reverseChildrenOrder:{check:C,init:false,apply:F},stretchChildrenOrthogonalAxis:{check:C,init:true,apply:Q},useAdvancedFlexAllocation:{check:C,init:false,apply:G}},defer:function(m,n){qx.legacy.core.Property.addCachedProperty({name:P,defaultValue:null},n);
qx.legacy.core.Property.addCachedProperty({name:T,defaultValue:null},n);
},members:{_createLayoutImpl:function(){return this.getOrientation()==B?new qx.legacy.ui.layout.impl.VerticalBoxLayoutImpl(this):new qx.legacy.ui.layout.impl.HorizontalBoxLayoutImpl(this);
},_layoutHorizontal:false,_layoutVertical:false,_layoutMode:z,isHorizontal:function(){return this._layoutHorizontal;
...
},_applyOrientation:function(o,p){this._layoutHorizontal=o==A;
this._layoutVertical=o==B;
if(this._layoutImpl){this._layoutImpl.dispose();
this._layoutImpl=null;
}
if(o){this._layoutImpl=this._createLayoutImpl();
}this._doLayoutOrder(o,p);
this.addToQueueRuntime(w);
},_applySpacing:function(a,b){this._doLayout();
this.addToQueueRuntime(t);
},_applyHorizontalChildrenAlign:function(bc,bd){this._doLayoutOrder();
this.addToQueueRuntime(S);
},_applyVerticalChildrenAlign:function(be,bf){this._doLayoutOrder();
this.addToQueueRuntime(E);
},_applyReverseChildrenOrder:function(W,X){this._doLayoutOrder();
this.addToQueueRuntime(v);
},_applyStretchChildrenOrthogonalAxis:function(g,h){this.addToQueueRuntime(x);
},_applyUseAdvancedFlexAllocation:function(q,r){this.addToQueueRuntime(u);
...
},_computeAccumulatedChildrenOuterWidth:function(){var ba=this.getVisibleChildren(),Y,i=-1,bb=this.getSpacing(),s=-bb;

while(Y=ba[++i]){s+=Y.getOuterWidth()+bb;
}return s;
},_computeAccumulatedChildrenOuterHeight:function(){var k=this.getVisibleChildren(),j,i=-1,l=this.getSpacing(),s=-l;

while(j=k[++i]){s+=j.getOuterHeight()+l;
}return s;
},_recomputeChildrenStretchingX:function(){var f=this.getVisibleChildren(),e,i=-1;

while(e=f[++i]){if(e._recomputeStretchingX()&&e._recomputeBoxWidth()){e._recomputeOuterWidth();
}}},_recomputeChildrenStretchingY:function(){var d=this.getVisibleChildren(),c,i=-1;

while(c=d[++i]){if(c._recomputeStretchingY()&&c._recomputeBoxHeight()){c._recomputeOuterHeight();
}}}}});
})();
(function(){var v="both",u="bottom",t="String",s="Integer",r="auto",q="icon",p="top",o="right",n="horizontal",m="inherit",O="label",N="left",M="_applyIconHeight",L="changeShow",K="default",J="_applyIconPosition",I="_applyIconWidth",H="center",G="_labelObject",F="middle",C="vertical",D="_iconObject",A="_applyIcon",B="none",y="_applyShow",z="qx.legacy.ui.basic.Atom",w="_applyLabel",x="_applyDisabledIcon",E="atom";
qx.Class.define(z,{extend:qx.legacy.ui.layout.BoxLayout,construct:function(R,S,T,U,V){arguments.callee.base.call(this);
this.getLayoutImpl().setEnableFlexSupport(false);
if(R!==undefined){this.setLabel(R);
}if(S!=null){this.setIcon(S);
}
if(S||V){if(T!=null){this.setIconWidth(T);
}
if(U!=null){this.setIconHeight(U);
}}this.initWidth();
this.initHeight();
},properties:{orientation:{refine:true,init:n},allowStretchX:{refine:true,init:false},allowStretchY:{refine:true,init:false},appearance:{refine:true,init:E},stretchChildrenOrthogonalAxis:{refine:true,init:false},width:{refine:true,init:r},height:{refine:true,init:r},horizontalChildrenAlign:{refine:true,init:H},verticalChildrenAlign:{refine:true,init:F},spacing:{refine:true,init:4},label:{apply:w,nullable:true,dispose:true,check:t},icon:{check:t,apply:A,nullable:true,themeable:true},disabledIcon:{check:t,apply:x,nullable:true,themeable:true},show:{init:v,check:[v,O,q,B],themeable:true,nullable:true,inheritable:true,apply:y,event:L},iconPosition:{init:N,check:[p,o,u,N],themeable:true,apply:J},iconWidth:{check:s,themeable:true,apply:I,nullable:true},iconHeight:{check:s,themeable:true,apply:M,nullable:true}},members:{_flashMode:false,_labelObject:null,_iconObject:null,_createLabel:function(){var l=this._labelObject=new qx.legacy.ui.basic.Label(this.getLabel());
l.setAnonymous(true);
l.setCursor(K);
...
if(W!==null){this._iconObject.setWidth(W);
}var X=this.getIconWidth();

if(X!==null){this._iconObject.setHeight(X);
}this._updateIcon();
this.addAt(i,0);
},_updateIcon:function(){var k=this.getIcon();
if(this._iconObject&&this.getIcon&&this.getDisabledIcon){var j=this.getDisabledIcon();

if(j){if(this.getEnabled()){k?this._iconObject.setSource(k):this._iconObject.resetSource();
}else{j?this._iconObject.setSource(j):this._iconObject.resetSource();
}this._iconObject.setEnabled(true);
}else{k?this._iconObject.setSource(k):this._iconObject.resetSource();
...
},_applyIconPosition:function(e,f){switch(e){case p:case u:this.setOrientation(C);
this.setReverseChildrenOrder(e==u);
break;
default:this.setOrientation(n);
this.setReverseChildrenOrder(e==o);
break;
}},_applyShow:function(Y,ba){this._handleIcon();
this._handleLabel();
},_applyLabel:function(g,h){if(this._labelObject){g?this._labelObject.setText(g):this._labelObject.resetText();
}this._handleLabel();
},_applyIcon:function(a,b){this._updateIcon();
this._handleIcon();
},_applyDisabledIcon:function(P,Q){this._updateIcon();
this._handleIcon();
},_applyIconWidth:function(c,d){if(this._iconObject){this._iconObject.setWidth(c);
}},_applyIconHeight:function(bb,bc){if(this._iconObject){this._iconObject.setHeight(bb);
}},_iconIsVisible:false,_labelIsVisible:false,_handleLabel:function(){switch(this.getShow()){case O:case v:case m:this._labelIsVisible=!!this.getLabel();
break;
...
}},_handleIcon:function(){switch(this.getShow()){case q:case v:case m:this._iconIsVisible=!!this.getIcon();
break;
...
(function(){var bh="locationY",bg="bottom",bf="top-reversed",be="middle-reversed",bd="middle",bc="qx.client",bb="locationX",ba="center",Y="qx.legacy.ui.layout.impl.VerticalBoxLayoutImpl",X="width",U="height",W="gecko",V="bottom-reversed",T="right",S="Boolean";
qx.Class.define(Y,{extend:qx.legacy.ui.layout.impl.LayoutImpl,properties:{enableFlexSupport:{check:S,init:true}},members:{computeChildBoxWidth:function(a){if(this.getWidget().getStretchChildrenOrthogonalAxis()&&a._computedWidthTypeNull&&a.getAllowStretchX()){return this.getWidget().getInnerWidth();
}return a.getWidthValue()||a._computeBoxWidthFallback();
},computeChildBoxHeight:function(O){return O.getHeightValue()||O._computeBoxHeightFallback();
...
var y=this.getWidget();
var l=y.getVisibleChildren();
var f=l.length;
var r;
var A=[];
var z=y.getInnerHeight();
var v=y.getSpacing()*(f-1);
var p;
for(p=0;p<f;p++){r=l[p];

if(r._computedHeightTypeFlex){A.push(r);

if(y._computedHeightTypeAuto){v+=r.getPreferredBoxHeight();
}}else{v+=r.getOuterHeight();
}}var h=z-v;
var n=A.length;
var g=0;

for(p=0;p<n;p++){g+=A[p]._computedHeightParsed;
}var m=h/g;

if(!y.getUseAdvancedFlexAllocation()){for(p=0;p<n;p++){r=A[p];
r._computedHeightFlexValue=Math.round(r._computedHeightParsed*m);
v+=r._computedHeightFlexValue;
}}else{var u=0;
var q,n,x,o,s,k;

for(p=0;p<n;p++){r=A[p];
k=r._computedHeightFlexValue=r._computedHeightParsed*m;
u+=k-qx.lang.Number.limit(k,r.getMinHeightValue(),r.getMaxHeightValue());
}u=Math.round(u);

if(u==0){for(p=0;p<n;p++){r=A[p];
r._computedHeightFlexValue=Math.round(r._computedHeightFlexValue);
v+=r._computedHeightFlexValue;
}}else{var t=u>0;

for(p=n-1;p>=0;p--){r=A[p];

if(t){x=(r.getMaxHeightValue()||Infinity)-r._computedHeightFlexValue;

if(x>0){r._allocationLoops=Math.floor(x/r._computedHeightParsed);
}else{qx.lang.Array.removeAt(A,p);
r._computedHeightFlexValue=Math.round(r._computedHeightFlexValue);
v+=Math.round(r._computedHeightFlexValue+x);
}}else{x=qx.legacy.util.Validation.isValidNumber(r.getMinHeightValue())?r._computedHeightFlexValue-r.getMinHeightValue():r._computedHeightFlexValue;

if(x>0){r._allocationLoops=Math.floor(x/r._computedHeightParsed);
}else{qx.lang.Array.removeAt(A,p);
r._computedHeightFlexValue=Math.round(r._computedHeightFlexValue);
v+=Math.round(r._computedHeightFlexValue-x);
}}}while(u!=0&&n>0){n=A.length;
q=Infinity;
s=0;
for(p=0;p<n;p++){q=Math.min(q,A[p]._allocationLoops);
s+=A[p]._computedHeightParsed;
}o=Math.min(s*q,u);
u-=o;
for(p=n-1;p>=0;p--){r=A[p];
r._computedHeightFlexValue+=o/s*r._computedHeightParsed;

if(r._allocationLoops==q){r._computedHeightFlexValue=Math.round(r._computedHeightFlexValue);
v+=r._computedHeightFlexValue;
delete r._allocationLoops;
qx.lang.Array.removeAt(A,p);
}else{if(u==0){r._computedHeightFlexValue=Math.round(r._computedHeightFlexValue);
v+=r._computedHeightFlexValue;
delete r._allocationLoops;
}else{r._allocationLoops-=q;
}}}}}}r._computedHeightFlexValue+=z-v;
...
},updateSelfOnChildOuterHeightChange:function(P){this.getWidget()._invalidateAccumulatedChildrenOuterHeight();
},updateChildOnInnerWidthChange:function(bv){var bx=bv._recomputePercentX();
var bw=bv._recomputeStretchingX();
if((bv.getHorizontalAlign()||this.getWidget().getHorizontalChildrenAlign())==ba){bv.addToLayoutChanges(bb);
}return bx||bw;
},updateChildOnInnerHeightChange:function(bi){if(this.getWidget().getVerticalChildrenAlign()==bd){bi.addToLayoutChanges(bh);
}var bj=bi._recomputePercentY();
var bk=bi._recomputeFlexY();
return bj||bk;
},updateSelfOnJobQueueFlush:function(L){if(L.addChild||L.removeChild){this.getWidget()._invalidateAccumulatedChildrenOuterHeight();
}},updateChildrenOnJobQueueFlush:function(by){var bA=false,bB=false;
var bz=this.getWidget();
if(by.orientation){bA=bB=true;
}if(by.spacing||by.orientation||by.reverseChildrenOrder||by.verticalChildrenAlign){bz._addChildrenToLayoutQueue(bh);
}
if(by.horizontalChildrenAlign){bz._addChildrenToLayoutQueue(bb);
}
if(by.stretchChildrenOrthogonalAxis){bA=true;
}if(bA){bz._recomputeChildrenStretchingX();
bz._addChildrenToLayoutQueue(X);
}
if(bB){bz._recomputeChildrenStretchingY();
bz._addChildrenToLayoutQueue(U);
}return true;
},updateChildrenOnRemoveChild:function(B,C){var w=this.getWidget(),E=w.getVisibleChildren(),F=E.length,D,i=-1;
if(this.getEnableFlexSupport()){for(var i=0;i<F;i++){D=E[i];

if(D.getHasFlexY()){C=Math.min(C,i);
break;
}}i=-1;
}switch(w.getLayoutMode()){case bg:case bf:while((D=E[++i])&&i<C){D.addToLayoutChanges(bh);
}break;
case bd:case be:while(D=E[++i]){D.addToLayoutChanges(bh);
}break;
default:i+=C;

while(D=E[++i]){D.addToLayoutChanges(bh);
}}},updateChildrenOnMoveChild:function(bE,bF,bG){var bJ=this.getWidget().getVisibleChildren();
var bH=Math.min(bF,bG);
var bI=Math.max(bF,bG)+1;

for(var i=bH;i<bI;i++){bJ[i].addToLayoutChanges(bh);
}},flushChildrenQueue:function(bq){var w=this.getWidget(),bt=w.getVisibleChildren(),bs=bt.length,br,i;
if(this.getEnableFlexSupport()){this.invalidateChildrenFlexHeight();

for(i=0;i<bs;i++){br=bt[i];

if(br.getHasFlexY()){br._computedHeightValue=null;

if(br._recomputeBoxHeight()){br._recomputeOuterHeight();
br._recomputeInnerHeight();
}bq[br.toHashCode()]=br;
br._layoutChanges.height=true;
}}}
switch(w.getLayoutMode()){case bg:case bf:for(var i=bs-1;i>=0&&!bq[bt[i].toHashCode()];i--){}for(var j=0;j<=i;j++){w._layoutChild(br=bt[j]);
}break;
case bd:case be:i=-1;

while(br=bt[++i]){w._layoutChild(br);
}break;
default:i=-1;
var bu=false;

while(br=bt[++i]){if(bu||bq[br.toHashCode()]){w._layoutChild(br);
bu=true;
...
},layoutChild_sizeX:qx.core.Variant.select(bc,{"mshtml|opera|webkit":function(d,e){if(e.initial||e.width||e.minWidth||e.maxWidth){if((d._isWidthEssential()&&(!d._computedWidthTypeNull||!d._computedMinWidthTypeNull||!d._computedMaxWidthTypeNull))||(d.getAllowStretchX()&&this.getWidget().getStretchChildrenOrthogonalAxis())){d._renderRuntimeWidth(d.getBoxWidth());
}else{d._resetRuntimeWidth();
}}},"default":function(bC,bD){if(bD.initial||bD.width){if(bC._isWidthEssential()&&!bC._computedWidthTypeNull){bC._renderRuntimeWidth(bC.getWidthValue());
}else{bC._resetRuntimeWidth();
}}}}),layoutChild_sizeY:qx.core.Variant.select(bc,{"mshtml|opera|webkit":function(Q,R){if(R.initial||R.height||R.minHeight||R.maxHeight){if(Q._isHeightEssential()&&(!Q._computedHeightTypeNull||!Q._computedMinHeightTypeNull||!Q._computedMaxHeightTypeNull)){Q._renderRuntimeHeight(Q.getBoxHeight());
}else{Q._resetRuntimeHeight();
}}},"default":function(M,N){if(N.initial||N.height){if(M._isHeightEssential()&&!M._computedHeightTypeNull){M._renderRuntimeHeight(M.getHeightValue());
}else{M._resetRuntimeHeight();
}}}}),layoutChild_locationY:function(bl,bm){var bp=this.getWidget();
if(bp.getFirstVisibleChild()==bl){switch(bp.getLayoutMode()){case bg:case bf:var bo=bp.getPaddingBottom()+bp.getAccumulatedChildrenOuterHeight()-bl.getOuterHeight();
break;
case bd:case be:var bo=bp.getPaddingTop()+Math.round((bp.getInnerHeight()-bp.getAccumulatedChildrenOuterHeight())/2);
break;
default:var bo=bp.getPaddingTop();
}}else{var bn=bl.getPreviousVisibleSibling();

switch(bp.getLayoutMode()){case bg:case bf:var bo=bn._cachedLocationVertical-bl.getOuterHeight()-bp.getSpacing();
break;
default:var bo=bn._cachedLocationVertical+bn.getOuterHeight()+bp.getSpacing();
}}bl._cachedLocationVertical=bo;
switch(this.getWidget().getLayoutMode()){case bg:case V:case be:bo+=!bl._computedBottomTypeNull?bl.getBottomValue():!bl._computedTopTypeNull?-(bl.getTopValue()):0;
bl._resetRuntimeTop();
bl._renderRuntimeBottom(bo);
break;
default:bo+=!bl._computedTopTypeNull?bl.getTopValue():!bl._computedBottomTypeNull?-(bl.getBottomValue()):0;
bl._resetRuntimeBottom();
bl._renderRuntimeTop(bo);
}},layoutChild_locationX:function(G,H){var J=this.getWidget();
if(qx.core.Variant.isSet(bc,W)){if(G.getAllowStretchX()&&J.getStretchChildrenOrthogonalAxis()&&G._computedWidthTypeNull){G._renderRuntimeLeft(J.getPaddingLeft()||0);
G._renderRuntimeRight(J.getPaddingRight()||0);
return;
}}var K=G.getHorizontalAlign()||J.getHorizontalChildrenAlign();
var I=K==ba?Math.round((J.getInnerWidth()-G.getOuterWidth())/2):0;
if(K==T){I+=J.getPaddingRight();
if(!G._computedRightTypeNull){I+=G.getRightValue();
}else if(!G._computedLeftTypeNull){I-=G.getLeftValue();
}G._resetRuntimeLeft();
G._renderRuntimeRight(I);
}else{I+=J.getPaddingLeft();
if(!G._computedLeftTypeNull){I+=G.getLeftValue();
}else if(!G._computedRightTypeNull){I-=G.getRightValue();
}G._resetRuntimeRight();
G._renderRuntimeLeft(I);
}}}});
})();
...
(function(){var u="locationX",t="right",s="center-reversed",r="center",q="left-reversed",p="qx.client",o="locationY",n="middle",m="width",l="bottom",g="height",k="qx.legacy.ui.layout.impl.HorizontalBoxLayoutImpl",h="gecko",f="right-reversed",e="Boolean";
qx.Class.define(k,{extend:qx.legacy.ui.layout.impl.LayoutImpl,properties:{enableFlexSupport:{check:e,init:true}},members:{computeChildBoxWidth:function(bJ){return bJ.getWidthValue()||bJ._computeBoxWidthFallback();
},computeChildBoxHeight:function(A){if(this.getWidget().getStretchChildrenOrthogonalAxis()&&A._computedHeightTypeNull&&A.getAllowStretchY()){return this.getWidget().getInnerHeight();
}return A.getHeightValue()||A._computeBoxHeightFallback();
...
var bB=this.getWidget();
var bo=bB.getVisibleChildren();
var bk=bo.length;
var bv;
var bC=[];
var bl=bB.getInnerWidth();
var bs=bB.getSpacing()*(bk-1);
var bt;
for(bt=0;bt<bk;bt++){bv=bo[bt];

if(bv._computedWidthTypeFlex){bC.push(bv);

if(bB._computedWidthTypeAuto){bs+=bv.getPreferredBoxWidth();
}}else{bs+=bv.getOuterWidth();
}}var bn=bl-bs;
var br=bC.length;
var bz=0;

for(bt=0;bt<br;bt++){bz+=bC[bt]._computedWidthParsed;
}var bq=bn/bz;

if(!bB.getUseAdvancedFlexAllocation()){for(bt=0;bt<br;bt++){bv=bC[bt];
bv._computedWidthFlexValue=Math.round(bv._computedWidthParsed*bq);
bs+=bv._computedWidthFlexValue;
}}else{var by=0;
var bu,br,bA,bp,bw,bm;

for(bt=0;bt<br;bt++){bv=bC[bt];
bm=bv._computedWidthFlexValue=bv._computedWidthParsed*bq;
by+=bm-qx.lang.Number.limit(bm,bv.getMinWidthValue(),bv.getMaxWidthValue());
}by=Math.round(by);

if(by==0){for(bt=0;bt<br;bt++){bv=bC[bt];
bv._computedWidthFlexValue=Math.round(bv._computedWidthFlexValue);
bs+=bv._computedWidthFlexValue;
}}else{var bx=by>0;

for(bt=br-1;bt>=0;bt--){bv=bC[bt];

if(bx){bA=(bv.getMaxWidthValue()||Infinity)-bv._computedWidthFlexValue;

if(bA>0){bv._allocationLoops=Math.floor(bA/bv._computedWidthParsed);
}else{qx.lang.Array.removeAt(bC,bt);
bv._computedWidthFlexValue=Math.round(bv._computedWidthFlexValue);
bs+=Math.round(bv._computedWidthFlexValue+bA);
}}else{bA=qx.legacy.util.Validation.isValidNumber(bv.getMinWidthValue())?bv._computedWidthFlexValue-bv.getMinWidthValue():bv._computedWidthFlexValue;

if(bA>0){bv._allocationLoops=Math.floor(bA/bv._computedWidthParsed);
}else{qx.lang.Array.removeAt(bC,bt);
bv._computedWidthFlexValue=Math.round(bv._computedWidthFlexValue);
bs+=Math.round(bv._computedWidthFlexValue-bA);
}}}while(by!=0&&br>0){br=bC.length;
bu=Infinity;
bw=0;
for(bt=0;bt<br;bt++){bu=Math.min(bu,bC[bt]._allocationLoops);
bw+=bC[bt]._computedWidthParsed;
}bp=Math.min(bw*bu,by);
by-=bp;
for(bt=br-1;bt>=0;bt--){bv=bC[bt];
bv._computedWidthFlexValue+=bp/bw*bv._computedWidthParsed;

if(bv._allocationLoops==bu){bv._computedWidthFlexValue=Math.round(bv._computedWidthFlexValue);
bs+=bv._computedWidthFlexValue;
delete bv._allocationLoops;
qx.lang.Array.removeAt(bC,bt);
}else{if(by==0){bv._computedWidthFlexValue=Math.round(bv._computedWidthFlexValue);
bs+=bv._computedWidthFlexValue;
delete bv._allocationLoops;
}else{bv._allocationLoops-=bu;
}}}}}}bv._computedWidthFlexValue+=bl-bs;
...
},updateSelfOnChildOuterWidthChange:function(X){this.getWidget()._invalidateAccumulatedChildrenOuterWidth();
},updateChildOnInnerWidthChange:function(bD){if(this.getWidget().getHorizontalChildrenAlign()==r){bD.addToLayoutChanges(u);
}var bE=bD._recomputePercentX();
var bF=bD._recomputeFlexX();
return bE||bF;
},updateChildOnInnerHeightChange:function(bG){var bI=bG._recomputePercentY();
var bH=bG._recomputeStretchingY();
if((bG.getVerticalAlign()||this.getWidget().getVerticalChildrenAlign())==n){bG.addToLayoutChanges(o);
}return bI||bH;
},updateSelfOnJobQueueFlush:function(B){if(B.addChild||B.removeChild){this.getWidget()._invalidateAccumulatedChildrenOuterWidth();
}},updateChildrenOnJobQueueFlush:function(v){var y=false,z=false;
var x=this.getWidget();
if(v.orientation){y=z=true;
}if(v.spacing||v.orientation||v.reverseChildrenOrder||v.horizontalChildrenAlign){x._addChildrenToLayoutQueue(u);
}
if(v.verticalChildrenAlign){x._addChildrenToLayoutQueue(o);
}
if(v.stretchChildrenOrthogonalAxis){z=true;
}if(y){x._recomputeChildrenStretchingX();
x._addChildrenToLayoutQueue(m);
}
if(z){x._recomputeChildrenStretchingY();
x._addChildrenToLayoutQueue(g);
}return true;
},updateChildrenOnRemoveChild:function(S,T){var w=this.getWidget(),V=w.getVisibleChildren(),W=V.length,U,i=-1;
if(this.getEnableFlexSupport()){for(i=0;i<W;i++){U=V[i];

if(U.getHasFlexX()){T=Math.min(T,i);
break;
}}i=-1;
}switch(w.getLayoutMode()){case t:case q:while((U=V[++i])&&i<T){U.addToLayoutChanges(u);
}break;
case r:case s:while(U=V[++i]){U.addToLayoutChanges(u);
}break;
default:i+=T;

while(U=V[++i]){U.addToLayoutChanges(u);
}}},updateChildrenOnMoveChild:function(be,bf,bg){var bj=this.getWidget().getVisibleChildren();
var bh=Math.min(bf,bg);
var bi=Math.max(bf,bg)+1;

for(var i=bh;i<bi;i++){bj[i].addToLayoutChanges(u);
}},flushChildrenQueue:function(N){var w=this.getWidget(),Q=w.getVisibleChildren(),P=Q.length,O,i;
if(this.getEnableFlexSupport()){this.invalidateChildrenFlexWidth();

for(i=0;i<P;i++){O=Q[i];

if(O.getHasFlexX()){O._computedWidthValue=null;

if(O._recomputeBoxWidth()){O._recomputeOuterWidth();
O._recomputeInnerWidth();
}N[O.toHashCode()]=O;
O._layoutChanges.width=true;
}}}
switch(w.getLayoutMode()){case t:case q:for(var i=P-1;i>=0&&!N[Q[i].toHashCode()];i--){}for(var j=0;j<=i;j++){w._layoutChild(O=Q[j]);
}break;
case r:case s:i=-1;

while(O=Q[++i]){w._layoutChild(O);
}break;
default:i=-1;
var R=false;

while(O=Q[++i]){if(R||N[O.toHashCode()]){w._layoutChild(O);
R=true;
}}}},layoutChild:function(L,M){this.layoutChild_sizeX(L,M);
this.layoutChild_sizeY(L,M);
this.layoutChild_sizeLimitX(L,M);
this.layoutChild_sizeLimitY(L,M);
this.layoutChild_locationX(L,M);
this.layoutChild_locationY(L,M);
this.layoutChild_marginX(L,M);
this.layoutChild_marginY(L,M);
},layoutChild_sizeX:qx.core.Variant.select(p,{"mshtml|opera|webkit":function(a,b){if(b.initial||b.width||b.minWidth||b.maxWidth){if(a._isWidthEssential()&&(!a._computedWidthTypeNull||!a._computedMinWidthTypeNull||!a._computedMaxWidthTypeNull)){a._renderRuntimeWidth(a.getBoxWidth());
}else{a._resetRuntimeWidth();
}}},"default":function(J,K){if(K.initial||K.width){if(J._isWidthEssential()&&!J._computedWidthTypeNull){J._renderRuntimeWidth(J.getWidthValue());
}else{J._resetRuntimeWidth();
}}}}),layoutChild_sizeY:qx.core.Variant.select(p,{"mshtml|opera|webkit":function(c,d){if(d.initial||d.height||d.minHeight||d.maxHeight){if((c._isHeightEssential()&&(!c._computedHeightTypeNull||!c._computedMinHeightTypeNull||!c._computedMaxHeightTypeNull))||(c.getAllowStretchY()&&this.getWidget().getStretchChildrenOrthogonalAxis())){c._renderRuntimeHeight(c.getBoxHeight());
}else{c._resetRuntimeHeight();
}}},"default":function(H,I){if(I.initial||I.height){if(H._isHeightEssential()&&!H._computedHeightTypeNull){H._renderRuntimeHeight(H.getHeightValue());
}else{H._resetRuntimeHeight();
}}}}),layoutChild_locationX:function(C,D){var G=this.getWidget();
if(G.getFirstVisibleChild()==C){switch(G.getLayoutMode()){case t:case q:var F=G.getPaddingRight()+G.getAccumulatedChildrenOuterWidth()-C.getOuterWidth();
break;
case r:case s:var F=G.getPaddingLeft()+Math.round((G.getInnerWidth()-G.getAccumulatedChildrenOuterWidth())/2);
break;
default:var F=G.getPaddingLeft();
}}else{var E=C.getPreviousVisibleSibling();

switch(G.getLayoutMode()){case t:case q:var F=E._cachedLocationHorizontal-C.getOuterWidth()-G.getSpacing();
break;
default:var F=E._cachedLocationHorizontal+E.getOuterWidth()+G.getSpacing();
}}C._cachedLocationHorizontal=F;
switch(G.getLayoutMode()){case t:case f:case s:F+=!C._computedRightTypeNull?C.getRightValue():!C._computedLeftTypeNull?-(C.getLeftValue()):0;
C._resetRuntimeLeft();
C._renderRuntimeRight(F);
break;
default:F+=!C._computedLeftTypeNull?C.getLeftValue():!C._computedRightTypeNull?-(C.getRightValue()):0;
C._resetRuntimeRight();
C._renderRuntimeLeft(F);
}},layoutChild_locationY:function(Y,ba){var bc=this.getWidget();
if(qx.core.Variant.isSet(p,h)){if(Y.getAllowStretchY()&&bc.getStretchChildrenOrthogonalAxis()&&Y._computedHeightTypeNull){Y._renderRuntimeTop(bc.getPaddingTop()||0);
Y._renderRuntimeBottom(bc.getPaddingBottom()||0);
return;
}}var bd=Y.getVerticalAlign()||bc.getVerticalChildrenAlign();
var bb=bd==n?Math.round((bc.getInnerHeight()-Y.getOuterHeight())/2):0;
if(bd==l){bb+=bc.getPaddingBottom();
if(!Y._computedBottomTypeNull){bb+=Y.getBottomValue();
}else if(!Y._computedTopTypeNull){bb-=Y.getTopValue();
}Y._resetRuntimeTop();
Y._renderRuntimeBottom(bb);
}else{bb+=bc.getPaddingTop();
if(!Y._computedTopTypeNull){bb+=Y.getTopValue();
}else if(!Y._computedBottomTypeNull){bb-=Y.getBottomValue();
}Y._resetRuntimeBottom();
Y._renderRuntimeTop(bb);
}}}});
})();
(function(){var u="",t="auto",s="text",r="qx.client",q="html",p="qx.dynlocale",o="_applyText",n="Boolean",m=")",l="color",bh="whiteSpace",bg="changeLocale",bf="String",be="textAlign",bd="mshtml|webkit",bc="ellipsis",bb="hidden",ba="opera",Y="on",X="</div><span style='float:left'>&hellip;</span>",B="_applyTextAlign",C="qx.legacy.ui.basic.Label",z=")+>)|(&([^;]|",A="_applyMnemonic",x="nowrap",y="default",v="_applyWrap",w="-1",D=")+;)|[^&",E="<span style=\"text-decoration:underline\">",L="<div style='float:left;width:",J="px;overflow:hidden;white-space:nowrap'>",P="center",N="&nbsp;",T="div",R=" (",G="i",W="changeText",V="right",U="justify",F="normal",H="</span>",I="&nbsp;&nbsp;",K="label",M="])*)(",O="^(((<([^>]|",Q="left",S="absolute";
qx.Class.define(C,{extend:qx.legacy.ui.basic.Terminator,construct:function(i,j,k){arguments.callee.base.call(this);

if(k!=null){this.setMode(k);
}
if(i!=null){this.setText(i);
}
if(j!=null){this.setMnemonic(j);
}
if(qx.core.Variant.isSet(p,Y)){qx.locale.Manager.getInstance().addListener(bg,this._onChangeLocale,this);
}this.initWidth();
this.initHeight();
this.initSelectable();
this.initCursor();
this.initWrap();
},statics:{_getMeasureNode:function(){var by=this._measureNode;

if(!by){by=document.createElement(T);
var bz=by.style;
bz.width=bz.height=t;
bz.visibility=bb;
bz.position=S;
bz.zIndex=w;
document.body.appendChild(by);
this._measureNode=by;
}return by;
}},properties:{appearance:{refine:true,init:K},width:{refine:true,init:t},height:{refine:true,init:t},allowStretchX:{refine:true,init:false},allowStretchY:{refine:true,init:false},selectable:{refine:true,init:false},cursor:{refine:true,init:y},text:{apply:o,init:u,dispose:true,event:W,check:bf},wrap:{check:n,init:false,nullable:true,apply:v},textAlign:{check:[Q,P,V,U],nullable:true,themeable:true,apply:B},textOverflow:{check:n,init:true,apply:o},mode:{check:[q,s,t],init:t,apply:o},mnemonic:{check:bf,nullable:true,apply:A}},members:{_content:u,_isHtml:false,setHtml:function(f){this.warn("Deprecated: please use setText() instead.");
this.trace();
this.setText(f);
},getHtml:function(){this.warn("Deprecated: please use getText() instead.");
this.trace();
return this.getText();
},_applyTextAlign:function(br,bs){br===null?this.removeStyleProperty(be):this.setStyleProperty(be,br);
},_applyFont:function(g,h){qx.legacy.theme.manager.Font.getInstance().connect(this._styleFont,this,g);
},_styleFont:function(bq){this._invalidatePreferredInnerDimensions();
bq?bq.render(this):qx.legacy.ui.core.Font.reset(this);
},_applyTextColor:function(b,c){qx.legacy.theme.manager.Color.getInstance().connect(this._styleTextColor,this,b);
},_styleTextColor:function(d){d?this.setStyleProperty(l,d):this.removeStyleProperty(l);
},_applyWrap:function(bA,bB){bA==null?this.removeStyleProperty(bh):this.setStyleProperty(bh,bA?F:x);
},_onChangeLocale:qx.core.Variant.select(p,{"on":function(e){var a=this.getText();

if(a.translate){this.setText(a.translate());
}},"off":null}),_applyText:function(bt){var bv=this.getMode();

if(bv===t){bv=qx.legacy.util.Validation.isValidString(bt)&&bt.match(/<.*>/)?q:s;
}
switch(bv){case s:var bu=qx.bom.String.escape(bt).replace(/(^ | $)/g,N).replace(/  /g,I);
this._isHtml=bu!==bt;
this._content=bu;
break;
case q:this._isHtml=true;
this._content=bt;
break;
}
if(this._isCreated){this._renderContent();
}},_applyMnemonic:function(bi,bj){this._mnemonicTest=bi?new RegExp(O+bi+z+bi+D+bi+M+bi+m,G):null;

if(this._isCreated){this._renderContent();
}},_computeObjectNeededDimensions:function(){var bp=arguments.callee.self._getMeasureNode();
var bo=bp.style;
var bn=this._styleProperties;
bo.fontFamily=bn.fontFamily||u;
bo.fontSize=bn.fontSize||u;
bo.fontWeight=bn.fontWeight||u;
bo.fontStyle=bn.fontStyle||u;
if(this._isHtml){bp.innerHTML=this._content;
}else{bp.innerHTML=u;
qx.bom.element.Attribute.set(bp,s,this._content);
}this._cachedPreferredInnerWidth=bp.scrollWidth;
this._cachedPreferredInnerHeight=bp.scrollHeight;
...
},__rN:function(bw,bx){return (L+(bx-14)+J+bw+X);
},_postApply:function(){var bl=this._content;
var bm=this._getTargetNode();

if(bl==null){bm.innerHTML=u;
return;
}
if(this.getMnemonic()){if(this._mnemonicTest.test(bl)){bl=RegExp.$1+E+RegExp.$7+H+RegExp.rightContext;
this._isHtml=true;
}else{bl+=R+this.getMnemonic()+m;
}}var bk=bm.style;

if(this.getTextOverflow()&&!this.getWrap()){if(this.getInnerWidth()<this.getPreferredInnerWidth()){bk.overflow=bb;

if(qx.core.Variant.isSet(r,bd)){bk.textOverflow=bc;
}else if(qx.core.Variant.isSet(r,ba)){bk.OTextOverflow=bc;
}else{bl=this.__rN(bl,this.getInnerWidth());
this._isHtml=true;
}}else{bk.overflow=u;

if(qx.core.Variant.isSet(r,bd)){bk.textOverflow=u;
}else if(qx.core.Variant.isSet(r,ba)){bk.OTextOverflow=u;
}}}
if(this._isHtml){bm.innerHTML=bl;
}else{bm.innerHTML=u;
qx.bom.element.Attribute.set(bm,s,bl);
}}},destruct:function(){if(qx.core.Variant.isSet(p,Y)){qx.locale.Manager.getInstance().removeListener(bg,this._onChangeLocale,this);
}}});
})();
...
(function(){var A="qx.client",z="",y="error",x="Boolean",w="auto",v="load",u="gecko|opera|webkit",t="qx.legacy.io.image.Preloader",r="changeSource",q="_applyPreloader",P="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",O="qx.event.type.Event",N="String",M="_applyLoaded",L="_applySource",K="img",J="top",I="qx.legacy.ui.basic.Image",H="image",G="Gray() Alpha(Opacity=30)",E="0 none",F="webkit",C="_image",D="qx/static/blank.gif",B="',sizingMethod='scale')";
qx.Class.define(I,{extend:qx.legacy.ui.basic.Terminator,construct:function(bj,bk,bl){arguments.callee.base.call(this);
this._blank=qx.util.ResourceManager.getInstance().toUri(D);
if(bj!=null){this.setSource(bj);
}if(bk!=null){this.setWidth(bk);
}else{this.initWidth();
}
if(bl!=null){this.setHeight(bl);
}else{this.initHeight();
}this.initSelectable();
},events:{"error":O},properties:{allowStretchX:{refine:true,init:false},allowStretchY:{refine:true,init:false},selectable:{refine:true,init:false},width:{refine:true,init:w},height:{refine:true,init:w},appearance:{refine:true,init:H},source:{check:N,apply:L,event:r,nullable:true,themeable:true},preloader:{check:t,apply:q,nullable:true},loaded:{check:x,init:false,apply:M},resizeToInner:{check:x,init:false}},members:{_onload:function(){this.setLoaded(true);
},_onerror:function(){this.warn("Could not load: "+this.getSource());
this.setLoaded(false);
this.fireEvent(y);
},_beforeAppear:function(){var a=this.getSource();

if(a){qx.legacy.io.image.Manager.getInstance().show(a);
this._registeredAsVisible=true;
}return arguments.callee.base.call(this);
},_beforeDisappear:function(){var bo=this.getSource();

if(bo&&this._registeredAsVisible){qx.legacy.io.image.Manager.getInstance().hide(bo);
delete this._registeredAsVisible;
}return arguments.callee.base.call(this);
},_applySource:function(S,T){var U=qx.legacy.io.image.Manager.getInstance();

if(T){U.remove(T);

if(this._registeredAsVisible){U.hide(T);
delete this._registeredAsVisible;
}}
if(S){U.add(S);
...
}},_connect:function(){var n=qx.legacy.util.AliasManager.getInstance();
n.connect(this._syncSource,this,this.getSource());
},_syncSource:function(bh){if(bh===null){this.setPreloader(null);
}else{var bi=qx.legacy.io.image.PreloaderManager.getInstance().create(bh);
this.setPreloader(bi);
}},_applyPreloader:function(l,m){if(m){m.removeListener(v,this._onload,this);
m.removeListener(y,this._onerror,this);
}
if(l){this.setLoaded(false);

if(l.isErroneous()){this._onerror();
}else if(l.isLoaded()){this.setLoaded(true);
}else{l.addListener(v,this._onload,this);
l.addListener(y,this._onerror,this);
}}else{this.setLoaded(false);
}},_applyLoaded:function(Y,ba){if(Y&&this.isCreated()){this._renderContent();
}else if(!Y){this._invalidatePreferredInnerWidth();
this._invalidatePreferredInnerHeight();
}},_applyElement:function(d,e){if(d){if(!this._image){try{if(qx.core.Variant.isSet(A,F)){this._image=document.createElement(K);
}else{this._image=new Image;
}this._image.style.border=E;
this._image.style.verticalAlign=J;
this._image.alt=z;
this._image.title=z;
}catch(bg){this.error("Failed while creating image #1",bg);
}
if(qx.core.Variant.isSet(A,u)){this._styleEnabled();
}}d.appendChild(this._image);
}arguments.callee.base.call(this,d,e);

if(d&&this.getSource()){this._connect();
}},_postApply:function(){this._postApplyDimensions();
this._updateContent();
},_applyEnabled:function(g,h){if(this._image){this._styleEnabled();
}return arguments.callee.base.call(this,g,h);
},_updateContent:qx.core.Variant.select(A,{"mshtml":function(){var i=this._image;
var X=this.getPreloader();
var W=X&&X.isLoaded()?qx.util.ResourceManager.getInstance().toUri(X.getSource()):this._blank;

if(X&&X.getIsPng()&&this.getEnabled()){i.src=this._blank;
i.style.filter=P+W+B;
}else{i.src=W;
i.style.filter=this.getEnabled()?z:G;
}},"default":function(){var bf=this.getPreloader();
var be=bf&&bf.isLoaded()?qx.util.ResourceManager.getInstance().toUri(bf.getSource()):this._blank;
this._image.src=be;
}}),_resetContent:qx.core.Variant.select(A,{"mshtml":function(){this._image.src=this._blank;
this._image.style.filter=z;
},"default":function(){this._image.src=this._blank;
}}),_styleEnabled:qx.core.Variant.select(A,{"mshtml":function(){this._updateContent();
},"default":function(){if(this._image){var o=this.getEnabled()===false?0.3:z;
var s=this._image.style;
s.opacity=s.KhtmlOpacity=s.MozOpacity=o;
}}}),_computePreferredInnerWidth:function(){var p=this.getPreloader();
return p?p.getWidth():0;
},_computePreferredInnerHeight:function(){var R=this.getPreloader();
return R?R.getHeight():0;
},_renderContent:function(){arguments.callee.base.call(this);
qx.legacy.ui.core.Widget.flushGlobalQueues();
},_postApplyDimensions:qx.core.Variant.select(A,{"mshtml":function(){try{var Q=this._image.style;

if(this.getResizeToInner()){Q.pixelWidth=this.getInnerWidth();
Q.pixelHeight=this.getInnerHeight();
}else{Q.pixelWidth=this.getPreferredInnerWidth();
Q.pixelHeight=this.getPreferredInnerHeight();
}}catch(V){this.error("postApplyDimensions failed",V);
}},"default":function(){try{var bb=this._image;

if(this.getResizeToInner()){bb.width=this.getInnerWidth();
bb.height=this.getInnerHeight();
}else{bb.width=this.getPreferredInnerWidth();
bb.height=this.getPreferredInnerHeight();
}}catch(f){this.error("postApplyDimensions failed",f);
}}}),_changeInnerWidth:qx.core.Variant.select(A,{"mshtml":function(bm,bn){if(this.getResizeToInner()){this._image.style.pixelWidth=bm;
}},"default":function(bc,bd){if(this.getResizeToInner()){this._image.width=bc;
}}}),_changeInnerHeight:qx.core.Variant.select(A,{"mshtml":function(b,c){if(this.getResizeToInner()){this._image.style.pixelHeight=b;
}},"default":function(j,k){if(this.getResizeToInner()){this._image.height=j;
}}})},destruct:function(){if(this._image){this._image.style.filter=z;
