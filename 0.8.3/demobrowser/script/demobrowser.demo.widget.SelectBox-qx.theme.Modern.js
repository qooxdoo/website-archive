...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.SelectBox-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var t="icon/16/devices/",s="phone.png",r="audio-card.png",q="battery.png",p="printer.png",o="Simple",n="display.png",m="audio-input-microphone.png",l="Empty Item",k="computer.png",O="Random Value ",N="input-keyboard.png",M="drive-optical.png",L="",K="media-optical.png",J="changeSelection",I="pda.png",H="network-wired.png",G=".",F="camera-photo.png",A="network-wireless.png",B="media-flash.png",y="Option ",z="input-mouse.png",w="demobrowser.demo.widget.SelectBox",x="With icons",u="drive-harddisk.png",v="camera-web.png",C="multimedia-player.png",D="Item ",E="Long text";
...
},createBox1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
h.add(new qx.ui.basic.Label(o));
var g=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var j=new qx.ui.form.ListItem(D+(i+1));
g.add(j);
if(i==5){g.setSelection([j]);
}}g.addListener(J,function(e){this.debug("changeSelection: "+e.getData()[0]);
});
h.add(g);
return h;
},createBox2:function(){var S=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
S.add(new qx.ui.basic.Label(E));
var R=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var T=new qx.ui.form.ListItem(O+Math.round(Math.random()*100000000));
R.add(T);
}S.add(R);
return S;
},createBox3:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
b.add(new qx.ui.basic.Label(x));
var d=[r,m,q,F,v,k,n,u,M,N,z,B,K,C,H,A,I,s,p];
var f=t;
var a=new qx.ui.form.SelectBox();

for(var i=0;i<d.length;i++){var c=new qx.ui.form.ListItem(d[i].substr(0,d[i].indexOf(G)),f+d[i]);
a.add(c);
}b.add(a);
return b;
},createBox4:function(){var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
Q.add(new qx.ui.basic.Label(l));
var P=new qx.ui.form.SelectBox();
P.add(new qx.ui.form.ListItem(L));

for(var i=0;i<10;i++){P.add(new qx.ui.form.ListItem(y+(i+1)));
}Q.add(P);
return Q;
}}});
})();
