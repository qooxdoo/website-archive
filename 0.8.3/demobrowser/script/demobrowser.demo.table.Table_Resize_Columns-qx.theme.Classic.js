...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.table.Table_Resize_Columns", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.table.Table_Resize_Columns-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var u="execute",t="Add 10 rows",s="Remove 10 rows",r="Whether the the first visible row should ",q="demobrowser.demo.table.Table_Resize_Columns",p="A number",o="_tableModel",n="1*",m="icon/22/actions/list-add.png",l="50%",f="A date",k="changeValue",i="Boolean test",e="be rendered completely when scrolling.",d="Table with automatic column sizes",h="Keep first row",g="icon/22/actions/list-remove.png",j="ID";
qx.Class.define(q,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return d;
},createTable:function(){var E=this.createRandomRows(50);
var C=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
C.setColumns([j,p,f,i]);
C.setData(E);
var B={tableColumnModel:function(a){return new qx.ui.table.columnmodel.Resize(a);
}};
var F=this._table=new qx.ui.table.Table(C,B);
F.set({width:600,height:400});
F.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var D=F.getTableColumnModel();
var A=D.getBehavior();
A.set(0,{width:n,minWidth:40,maxWidth:80});
A.setWidth(1,l);
A.setMinWidth(1,100);
A.setMaxWidth(1,320);
var D=F.getTableColumnModel();
...
return F;
},createControls:function(){var y=new qx.ui.toolbar.ToolBar();
var w,x,z;
x=new qx.ui.toolbar.Part();
y.add(x);
w=new qx.ui.toolbar.Button(t,m);
w.addListener(u,function(G){var H=this.createRandomRows(10);
this._tableModel.addRows(H);
this.info("10 rows added");
},this);
x.add(w);
w=new qx.ui.toolbar.Button(s,g);
w.addListener(u,function(b){var c=this._tableModel.getRowCount();
...
y.add(x);
var v=this._table;
z=new qx.ui.toolbar.CheckBox(h);
z.set({value:v.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(r+e)});
z.addListener(k,function(I){v.setKeepFirstVisibleRowComplete(this.getValue());
},z);
x.add(z);
return y;
