...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.StackContainer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.StackContainer-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var D="execute",C="yellow",B="teal",A="gray",z="red",y="Next",x="Previous",w="green",v="icon/22/actions/go-next.png",u="changeSelection",q="icon/22/actions/go-previous.png",t="orange",s="main",p="blue",o="resize",r="demobrowser.demo.widget.StackContainer";
...
var g=new qx.ui.form.Button(x,q);
var d=new qx.ui.form.Button(y,v);
a.add(g);
a.add(d);
this.getRoot().add(a,{left:20,top:150});
g.addListener(D,c.previous,c);
d.addListener(D,c.next,c);
var f=[z,A,p,t,B,C,w];
var b;
...
c.add(b);
}c.addListener(u,function(e){this.debug("Selected: "+e.getData()[0].getBackgroundColor());
});
},addDynamicStack:function(){var k=new qx.ui.container.Stack();
k.setDecorator(s);
k.setDynamic(true);
this.getRoot().add(k,{left:250,top:20});
var h=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));
var n=new qx.ui.form.Button(x,q);
var l=new qx.ui.form.Button(y,v);
h.add(n);
h.add(l);
this.getRoot().add(h,{left:250,top:150});
n.addListener(D,k.previous,k);
l.addListener(D,k.next,k);
var m=[z,A,p,t,B,C,w];
var j;

for(var i=0;i<m.length;i++){j=new qx.ui.core.Widget;
j.setBackgroundColor(m[i]);
j.setWidth((Math.round(i/2)+1)*50);
j.setHeight((Math.round(i/3)+1)*40);
k.add(j);
}k.addListener(u,function(e){var F=e.getData()[0];
this.debug("Selected: "+F.getBackgroundColor()+" ("+F.getWidth()+"x"+F.getHeight()+")");
});
k.addListener(o,function(e){var E=this.getBounds();
