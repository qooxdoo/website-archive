...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Table_CellRenderer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Table_CellRenderer-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var bu="",bt="Hello",bs="icon/16/actions/go-down.png",br="World",bq="bold",bp="Juhu",bo="</div>",bn="icon/16/actions/go-next.png",bm="tableMock",bl="$ ",bX="string",bW="border: 1px dotted green",bV="inactive",bU="decoration",bT="multi<br>line",bS="between",bR="<",bQ="<div style='position:absolute;height:20px;width:",bP="px;top:",bO="qx/decoration/Modern",bB="icon/16/actions/go-previous.png",bC="icon",bz="number",bA="px'>",bx="<i>italic</i>",by="0$",bv="qx/icon/Tango",bw="<b>bold</b>",bD="icon/16/actions/go-up.png",bE="boolean",bH="demobrowser.demo.test.Table_CellRenderer",bG="waiting",bJ="red",bI="icon/16/emotes/face-sad.png",bL="icon/16/emotes/face-smile.png",bK="left",bF=">=",bN="active",bM="object";
qx.Class.define(bH,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(bU,bO);
qx.util.AliasManager.getInstance().add(bC,bv);
},__oO:function(L,top,M,N,O){var P=[bQ,M,bP,top,bA];
N.createDataCellHtml(O,P);
P.push(bo);
L.innerHTML+=P.join(bu);
},testDefaultRenderer:function(Q){var R=100;
var T={value:[null,bp,32,new Date()],styleLeft:[0],styleWidth:[R],styleHeight:[20],style:[bu]};
var S=this._getNewTableDiv(R);
var top=0;
qx.util.Permutation.permute(T,function(U){this.__oO(S,top,R,Q,U);
top+=20;
},this);
},testBooleanRenderer:function(){var x=70;
var w=30;
var y=new qx.ui.table.cellrenderer.Boolean();
var u={value:[null,true,false],styleLeft:[0],styleWidth:[x],styleHeight:[w],style:[bu]};
var v=this._getNewTableDiv(x);
var top=0;
qx.util.Permutation.permute(u,function(bd){this.__oO(v,top,x,y,bd);
top+=w;
},this);
y.setIconFalse(bI);
y.setIconTrue(bL);
qx.util.Permutation.permute(u,function(z){this.__oO(v,top,x,y,z);
top+=w;
},this);
},testDateRenderer:function(){var cc=180;
var cd=new qx.ui.table.cellrenderer.Date();
var cf={value:new Date(),styleLeft:[0],styleWidth:[cc],styleHeight:[20],style:[bu]};
var cb=qx.util.format.DateFormat;
var ce=[cb.getDateTimeInstance(),cb.getDateInstance()];
var bY=this._getNewTableDiv(cc);
var top=0;

for(var i=0;i<ce.length;i++){var ca=ce[i];
cd.setDateFormat(ca);
this.__oO(bY,top,cc,cd,cf);
top+=20;
}},testNumberRenderer:function(){var E=new qx.ui.table.cellrenderer.Number();
var D=100;
var G={value:Math.PI,styleLeft:[0],styleWidth:[D],styleHeight:[20],style:[bu]};
var C=qx.util.format.NumberFormat;
var F=[C.getIntegerInstance(),new C().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:bl})];
var A=this._getNewTableDiv(D);
var top=0;

for(var i=0;i<F.length;i++){var B=F[i];
E.setNumberFormat(B);
this.__oO(A,top,D,E,G);
top+=20;
}},testImageRenderer:function(){var h=new qx.ui.table.cellrenderer.Image();
var f=50;
var j={value:[null,bs,bD,bB,bn],styleLeft:[0],styleWidth:[f],styleHeight:[20],style:[bu]};
var g=this._getNewTableDiv(f);
var top=0;
qx.util.Permutation.permute(j,function(ch){this.__oO(g,top,f,h,ch);
top+=20;
},this);
},testStringRenderer:function(){var bi=new qx.ui.table.cellrenderer.String();
var bh=100;
var bg=20;
var be={value:[null,bt,br],styleLeft:[0],styleWidth:[bh],styleHeight:[bg],style:[bu]};
var bf=this._getNewTableDiv(bh);
var top=0;
qx.util.Permutation.permute(be,function(H){this.__oO(bf,top,bh,bi,H);
top+=20;
},this);
},testPasswordRenderer:function(){var bb=new qx.ui.table.cellrenderer.Password();
var ba=100;
var Y=20;
var W={value:[null,bt,br],styleLeft:[0],styleWidth:[ba],styleHeight:[Y],style:[bu]};
var X=this._getNewTableDiv(ba);
var top=0;
qx.util.Permutation.permute(W,function(bj){this.__oO(X,top,ba,bb,bj);
top+=20;
},this);
},testHtmlRenderer:function(){var t=new qx.ui.table.cellrenderer.Html();
var s=100;
var r=50;
var p={value:[null,bw,bx,bT],styleLeft:[0],styleWidth:[s],styleHeight:[r],style:[bu]};
var q=this._getNewTableDiv(s);
var top=0;
qx.util.Permutation.permute(p,function(bc){this.__oO(q,top,s,t,bc);
top+=20;
},this);
},testConditionalRenderer:function(){var o=new qx.ui.table.cellrenderer.Conditional();
o.addNumericCondition(bR,0,null,bJ,null,null);
o.addNumericCondition(bF,100,bK,null,null,null);
o.addBetweenCondition(bS,0,2,null,null,null,bq,null);
o.addRegex(by,null,null,bq,bW);
var n=100;
var m=20;
var k={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[n],table:[this.tableMock],styleHeight:[m],style:[bu]};
var l=this._getNewTableDiv(n);
var top=0;
qx.util.Permutation.permute(k,function(V){this.__oO(l,top,n,o,V);
top+=20;
},this);
},testDynamicRenderer:function(){var cm=new qx.ui.table.cellrenderer.Dynamic();
cm.setCellRendererFactoryFunction(function(I){var K=I.value;
var J=qx.ui.table.cellrenderer;

switch(typeof K){case bX:if(K.match(/^icon\//)){return new J.Image();
}else{return new J.String();
}case bE:return new J.Boolean();
case bz:return new J.Number();
case bM:if(K instanceof Date){return new J.Date();
}return new J.Default();
}});
var cl=100;
var ck=20;
var ci={value:[null,bp,new Date(),30,bs,false],styleLeft:[0],styleWidth:[cl],styleHeight:[ck],table:[this.tableMock],style:[bu]};
var cj=this._getNewTableDiv(cl);
var top=0;
qx.util.Permutation.permute(ci,function(cg){this.__oO(cj,top,cl,cm,cg);
top+=20;
},this);
},testReplaceRenderer:function(){var e=new qx.ui.table.cellrenderer.Replace();
e.setReplaceMap({1:bN,2:bV,3:bG});
e.addReversedReplaceMap();
var d=100;
var c=20;
var a={value:[1,2,3],styleLeft:[0],styleWidth:[d],table:[this.tableMock],styleHeight:[c],style:[bu]};
var b=this._getNewTableDiv(d);
var top=0;
qx.util.Permutation.permute(a,function(bk){this.__oO(b,top,d,e,bk);
top+=20;
},this);
}},destruct:function(){this._disposeFields(bm);
}});
})();
...
(function(){var Q="",P="==",O=">",N="between",M="<",L="regex",K="!between",J=">=",I="!=",H="<=",A="font-weight",G=";",D="text-align",y="conditions",x='g',C=":",B="qx.ui.table.cellrenderer.Conditional",E="betweenAllowed",w="numericAllowed",F="color",z="font-style";
qx.Class.define(B,{extend:qx.ui.table.cellrenderer.Default,construct:function(s,t,u,v){arguments.callee.base.call(this);
this.numericAllowed=[P,I,O,M,J,H];
this.betweenAllowed=[N,K];
this.conditions=[];
this.__oV=s||Q;
this.__oW=t||Q;
this.__oX=u||Q;
this.__oY=v||Q;
},members:{__oV:null,__oW:null,__oX:null,__oY:null,__pa:function(a,b){if(a[1]!=null){b[D]=a[1];
}
if(a[2]!=null){b[F]=a[2];
}
if(a[3]!=null){b[z]=a[3];
...
}},addBetweenCondition:function(R,S,T,U,V,W,X,Y){if(qx.lang.Array.contains(this.betweenAllowed,R)){if(S!=null&&T!=null){var ba=[R,U,V,W,X,S,T,Y];
}}
if(ba!=null){this.conditions.push(ba);
}else{throw new Error("Condition not recognized or value1/value2 is null!");
}},addRegex:function(l,m,n,o,p,q){if(l!=null){var r=[L,m,n,o,p,l,q];
}
if(r!=null){this.conditions.push(r);
}else{throw new Error("regex cannot be null!");
}},_getCellStyle:function(bb){if(!this.conditions.length){return bb.style||Q;
}var bg=bb.table.getTableModel();
var i;
var bi;
var bc;
var be={"text-align":this.__oV,"color":this.__oW,"font-style":this.__oX,"font-weight":this.__oY};

for(i in this.conditions){bi=false;

if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){bc=bb.value;
}else{bc=bg.getValueById(this.conditions[i][6],bb.row);
}
switch(this.conditions[i][0]){case P:if(bc==this.conditions[i][5]){bi=true;
}break;
case I:if(bc!=this.conditions[i][5]){bi=true;
}break;
case O:if(bc>this.conditions[i][5]){bi=true;
}break;
case M:if(bc<this.conditions[i][5]){bi=true;
}break;
case J:if(bc>=this.conditions[i][5]){bi=true;
}break;
case H:if(bc<=this.conditions[i][5]){bi=true;
}break;
...
switch(this.conditions[i][0]){case N:if(bc>=this.conditions[i][5]&&bc<=this.conditions[i][6]){bi=true;
}break;
case K:if(bc<this.conditions[i][5]&&bc>this.conditions[i][6]){bi=true;
}break;
}}else if(this.conditions[i][0]==L){if(this.conditions[i][6]==null){bc=bb.value;
}else{bc=bg.getValueById(this.conditions[i][6],bb.row);
}var bd=new RegExp(this.conditions[i][5],x);
bi=bd.test(bc);
}if(bi==true){this.__pa(this.conditions[i],be);
}}var bh=[];

for(var bf in be){if(be[bf]){bh.push(bf,C,be[bf],G);
}}return bh.join(Q);
}},destruct:function(){this._disposeFields(w,E,y);
}});
})();
...
(function(){var e="__pd",d="qx.ui.table.cellrenderer.Image",c="";
qx.Class.define(d,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(a,b){arguments.callee.base.call(this);

if(a){this.__pb=a;
}
if(b){this.__pc=b;
}this.__pd=qx.util.AliasManager.getInstance();
},members:{__pd:null,__pc:16,__pb:16,_identifyImage:function(f){var g={imageWidth:this.__pb,imageHeight:this.__pc};

if(f.value==c){g.url=null;
}else{g.url=this.__pd.resolve(f.value);
}return g;
}},destruct:function(){this._disposeFields(e);
}});
})();
(function(){var d="qx.ui.table.cellrenderer.String",c="qooxdoo-table-cell",b="";
qx.Class.define(d,{extend:qx.ui.table.cellrenderer.Conditional,members:{_getContentHtml:function(e){return qx.bom.String.escape(e.value||b);
...
if(!f){this.error("No function provided! Aborting.");
}var e=f(c);
