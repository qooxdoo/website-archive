...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.showcase.Browser", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.showcase.Browser-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var p="execute",o="This feature is currently not supported.",n="http://",m="demobrowser.demo.showcase.Browser",l="separator-vertical",k="icon/16/actions/go-previous.png",j="keypress",i="Enter",h="icon/16/actions/go-next.png",g="Web Browser",c="icon/16/actions/media-playback-start.png",f="http://web.de",d="icon/16/categories/internet.png",b="middle";
...
},_createBrowser:function(){var s=new qx.ui.window.Window(g,d);
var q=new qx.ui.layout.VBox();
q.setSeparator(l);
s.setLayout(q);
s.setAllowClose(false);
s.setContentPadding(0);
s.open();
var toolbar=new qx.ui.toolbar.ToolBar();
s.add(toolbar);
var t=new qx.ui.toolbar.Button(null,k);
t.addListener(p,function(e){this.iframe.getWindow().history.back();
},this);
toolbar.add(t);
var u=new qx.ui.toolbar.Button(null,h);
u.addListener(p,function(e){this.iframe.getWindow().history.forward();
},this);
toolbar.add(u);
u.setEnabled(false);
t.setEnabled(false);
u.setToolTipText(o);
t.setToolTipText(o);
this.txtUrl=new qx.ui.form.TextField().set({marginLeft:1,value:f,padding:2,alignY:b});
this.txtUrl.addListener(j,function(e){if(e.getKeyIdentifier()==i){this.surfTo(this.txtUrl.getValue());
}},this);
toolbar.add(this.txtUrl,{flex:1});
var r=new qx.ui.toolbar.Button(null,c);
r.addListener(p,function(e){this.surfTo(this.txtUrl.getValue());
},this);
toolbar.add(r);
...
s.add(this.iframe,{flex:1});
return s;
},surfTo:function(a){if(a.indexOf(n)!==0){a=n+a;
this.txtUrl.setValue(a);
}this.iframe.setSource(a);
}}});
})();
...
qx.Class.define(i,{extend:qx.ui.core.Widget,construct:function(a){arguments.callee.base.call(this);
...
(function(){var q="display",p="mousedown",o="qx.client",n="contextmenu",m="load",l="help",k="mouseup",j="losecapture",i="none",h="repeat",J="Boolean",I="height",H="px",G="url(",F=")",E="div",D="_applyNativeHelp",C="width",B="zIndex",A="top",x="mshtml",y="__wg",v="block",w="qx.ui.embed.Iframe",t="position",u="iframe",r="left",s="absolute",z="qx/static/blank.gif";
qx.Class.define(w,{extend:qx.ui.embed.AbstractIframe,include:qx.ui.core.MNativeOverflow,construct:function(f){if(f!=null){this.__wf=f;
...
},properties:{appearance:{refine:true,init:u},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:J,init:false,apply:D}},members:{__wf:null,__wg:null,renderLayout:function(L,top,M,N){arguments.callee.base.call(this,L,top,M,N);
var P=H;
var O=this.getInsets();
this.__wg.setStyle(r,O.left+P);
this.__wg.setStyle(A,O.top+P);
this.__wg.setStyle(C,(M-O.left-O.right)+P);
this.__wg.setStyle(I,(N-O.top-O.bottom)+P);
},_createContentElement:function(){var g=new qx.html.Iframe(this.__wf);
g.addListener(m,this._onIframeLoad,this);
return g;
},_getIframeElement:function(){return this.getContentElement();
},_createBlockerElement:function(){var K=new qx.html.Element(E);
K.setStyle(B,20);
K.setStyle(t,s);
K.setStyle(q,i);
if(qx.core.Variant.isSet(o,x)){K.setStyles({backgroundImage:G+qx.util.ResourceManager.getInstance().toUri(z)+F,backgroundRepeat:h});
}return K;
},_onIframeLoad:function(e){this._applyNativeContextMenu(this.getNativeContextMenu(),null);
this._applyNativeHelp(this.getNativeHelp(),null);
this.fireNonBubblingEvent(m);
},block:function(){this.__wg.setStyle(q,v);
},release:function(){this.__wg.setStyle(q,i);
...
if(b===false){qx.event.Registration.removeListener(d,n,this._onNativeContextMenu,this,true);
}
if(a===false){qx.event.Registration.addListener(d,n,this._onNativeContextMenu,this,true);
}},_onNativeContextMenu:function(e){e.preventDefault();
},_applyNativeHelp:qx.core.Variant.select(o,{"mshtml":function(Q,R){var document=this.getDocument();

if(!document){return;
}
try{if(R===false){qx.bom.Event.removeNativeListener(document,l,qx.lang.Function.returnFalse);
}
if(Q===false){qx.bom.Event.addNativeListener(document,l,qx.lang.Function.returnFalse);
}}catch(e){}},"default":function(){}})},destruct:function(){this._disposeObjects(y);
...
qx.Class.define(e,{extend:qx.html.Element,construct:function(a){arguments.callee.base.call(this,c);
this._setProperty(g,a);
...
},reload:function(){var n=this.getDomElement();

if(n){var m=this.getSource();
this.setSource(null);
this.setSource(m);
}}}});
})();
