...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Destructor_Flash", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Destructor_Flash-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var n="demobrowser.demo.test.Destructor_Flash",m="300px",k="interval",j="__dc",h="height",g="TestFlash.swf",f="400px",e="width",d="div",c="FlashMovie";
qx.Class.define(n,{extend:qx.application.Native,members:{__dc:null,__dd:0,main:function(){arguments.callee.base.call(this);
this.__dc=[];
var r=new qx.event.Timer(5000);
r.addListener(k,this.runTest,this);
r.start();
this.runTest();
},runTest:function(){for(var i=0;i<5;i++){var o=qx.bom.Element.create(d);
qx.bom.element.Style.set(o,e,f);
qx.bom.element.Style.set(o,h,m);
document.body.appendChild(o);
var p=c+this.__dd;
this.__dd++;
qx.bom.Flash.create(o,{movie:g,id:p});
this.debug("created: "+p);
this.__dc.push(o);
}var q=qx.event.Timer.once(this.clear,this,2500);
q.start();
},clear:function(){var a=this.__dc;
