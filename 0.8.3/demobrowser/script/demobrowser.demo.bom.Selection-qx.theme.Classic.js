...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.Selection-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var k="div",j="button",i="click",h="margin-right: 8px",g="width:100%;margin-bottom:20px",f="results",d="textarea",c="plaintext",b="margin: 4px",a="text",N="test\ntest2\ntest3\ntest4\ntest5",M="margin: 4px 0px",L="demobrowser.demo.bom.Selection",K="width:20%;margin-right:10px",J="this is a test",I="setSelectionInput",H="width:300px;height:250px",G="setSelectionDocument",F="border:1px solid darkgrey;",E="<strong>Results</strong>",r="background-color: lightgrey",s="test test2 test3 test4 test5 test6",p="container",q="textfield",n="areaContainer",o="position:relative;padding:20px",l="getSelectionInput",m="margin-bottom:20px",t="width:500px;height:200px;",u="_textArea",x="textContainer",w="test text",z="setSelectionTextarea",y="inputContainer",B="<br/>",A="getSelectionDocument",v="_input",D="getSelectionTextarea",C="textBlock";
qx.Class.define(L,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var P=qx.bom.Element.create(k,{id:p,style:o});
var bc=qx.bom.Element.create(k,{id:x,style:g});
qx.dom.Element.insertEnd(bc,P);
var V=qx.bom.Element.create(k,{id:C,style:m});
V.innerHTML=s;
qx.dom.Element.insertEnd(V,bc);
var ba=qx.bom.Input.create(j,{value:A,style:b});
qx.bom.Element.addListener(ba,i,this._getSelection,document);
qx.dom.Element.insertEnd(ba,bc);
var W=qx.bom.Input.create(j,{value:G,style:b});
qx.bom.Element.addListener(W,i,function(e){qx.bom.Selection.set(document.getElementById(c).firstChild,0,4);
this.debug(qx.bom.Selection.getLength(document));
},this);
qx.dom.Element.insertEnd(W,bc);
var R=qx.bom.Element.create(k,{id:y,style:g});
qx.dom.Element.insertEnd(R,P);
this._input=qx.bom.Input.create(a,{id:q,value:w,style:K});
qx.dom.Element.insertEnd(this._input,R);
var U=qx.bom.Input.create(j,{value:l,style:h});
qx.bom.Element.addListener(U,i,this._getSelection,this._input);
qx.dom.Element.insertEnd(U,R);
var bb=qx.bom.Input.create(j,{value:I,style:h});
qx.bom.Element.addListener(bb,i,this._setSelection,this._input);
qx.dom.Element.insertEnd(bb,R);
var S=qx.bom.Element.create(k,{id:n,style:g});
qx.dom.Element.insertEnd(S,P);
this._textArea=qx.bom.Input.create(d,{id:d,rows:7,cols:20,value:N,style:H});
qx.dom.Element.insertEnd(this._textArea,S);
var Y=qx.bom.Input.create(j,{value:D,style:h});
qx.bom.Element.addListener(Y,i,this._getSelection,this._textArea);
qx.dom.Element.insertEnd(Y,S);
var T=qx.bom.Input.create(j,{value:z,style:h});
qx.bom.Element.addListener(T,i,this._setSelection,this._textArea);
qx.dom.Element.insertEnd(T,S);
var O=qx.bom.Element.create(k,{style:M});
O.innerHTML=E;
var Q=qx.bom.Element.create(k,{id:f,style:t+F+r});
qx.dom.Element.insertEnd(O,P);
qx.dom.Element.insertEnd(Q,P);
var X=qx.bom.Element.create(k,{id:c});
X.innerHTML=J;
qx.dom.Element.insertEnd(X,document.body);
qx.dom.Element.insertEnd(P,document.body);
},_getSelection:function(e){document.getElementById(f).innerHTML=qx.bom.Selection.get(this)+B+qx.bom.Selection.getLength(this);
