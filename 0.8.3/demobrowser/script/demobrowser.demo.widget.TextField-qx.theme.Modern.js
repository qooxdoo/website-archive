...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.TextField", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.TextField-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var p="execute",o="monospace",n="Web 2.0",m="Toggle enabled",l="Send selection",k="text\narea\nmonospace",j="Send content",i="20px sans-serif",h="changeValue",g="read only",c="Toggle live update",f="demobrowser.demo.widget.TextField",d="text\narea",b="text\narea\nnowrap",a="max15";
...
q.setSpacing(10);
var D=new qx.ui.container.Composite(q);
D.setPadding(20);
this.getRoot().add(D,{left:0,top:0});
var r=new qx.ui.form.TextField(a).set({maxLength:15});
r.focus();
r.addListener(h,function(e){this.debug("ChangeValue: "+e.getData());
},this);
D.add(r);
var t=new qx.ui.form.TextField(n).set({font:qx.bom.Font.fromString(i),padding:6});
D.add(t);
var s=new qx.ui.form.TextField(g).set({readOnly:true});
D.add(s);
var v=new qx.ui.form.TextArea(d);
D.add(v);
var C=new qx.ui.form.TextArea(b);
C.setWrap(false);
D.add(C);
var B=new qx.ui.form.TextArea(k);
B.setFont(o);
D.add(B);
var x=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
x.setPadding(20);
var w=new qx.ui.form.Button(c);
w.addListener(p,function(){r.toggleLiveUpdate();
});
x.add(w);
var z=new qx.ui.form.Button(m);
var A=false;
z.addListener(p,function(){D.setEnabled(A);
A=!A;
});
x.add(z);
var y=new qx.ui.form.Button(j);
y.addListener(p,function(){this.debug("Sending content: "+r.getValue());
});
x.add(y);
var u=new qx.ui.form.Button(l);
u.setFocusable(false);
u.setKeepFocus(true);
u.addListener(p,function(){this.debug("Sending selection: "+r.getSelection());
});
x.add(u);
this.getRoot().add(x,{left:200,top:0});
}}});
})();
