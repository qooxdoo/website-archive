...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.treevirtual.TreeVirtual_Events", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.treevirtual.TreeVirtual_Events-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var C="Trash",B="Windows (C:)",A="Data",z="Documents (D:)",y="\n  ",x="treeOpenWithContent",w="treeOpenWhileEmpty",v="demobrowser.demo.treevirtual.TreeVirtual_Events",u="Edit",t="Workspace",m="Network",s="Spam Message #",p="Selected labels:",k="Inbox",j="Desktop",o="changeSelection",n="Sent",q="treeClose",h="Files",r="Tree",l="Spam";
...
this.getRoot().add(a,{edge:30});
var g=a.getDataModel();
var c=g.addBranch(null,j,true);
var f;
g.addBranch(c,h,true);
f=g.addBranch(c,t,true);
g.addLeaf(f,B);
g.addLeaf(f,z);
g.addBranch(c,m,true);
g.addBranch(c,C,true);
var d=g.addBranch(null,k,true);
f=g.addBranch(d,l,false);

for(var i=1;i<3000;i++){g.addLeaf(f,s+i);
}g.addBranch(d,n,false);
g.addBranch(d,C,false);
g.addBranch(d,A,false);
g.addBranch(d,u,false);
g.setData();
var b=1;
a.addListener(x,function(e){alert('treeOpenWithContent ');
var D=e.getData();
g.addLeaf(D.nodeId,b.toString());
b++;
});
a.addListener(q,function(e){alert('treeClose ');
});
a.addListener(w,function(e){alert('treeOpenWhileEmpty');
var E=e.getData();
a.nodeSetHideOpenClose(E,true);
});
a.addListener(o,function(e){var F=p;
var G=e.getData();

for(i=0;i<G.length;i++){F+=y+G[i].label;
