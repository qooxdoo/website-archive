...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Tree-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var q="changeValue",p="execute",o="Trash",n="changeSelection",m="mode",l="multi",k="single",j="Windows (C:)",h="Documents (D:)",g="Inbox",T="Desktop",S="root",R="Open mode:",Q="Presets",P="Hide Root Node",O="Network",N="Control",M=" items",L="Sent",K="Files",x="Show Open Items",y="",v="Workspace",w="Enable drag selection",t="Selection: ",u="Junk #",r="demobrowser.demo.widget.Tree",s="Data",z="click",A="Show root open button",D="none",C="Enable multi selection",F="double click",E="Selection:",H="Show Selected Items",G="Root node:",B="Toggle Height",J="Edit",I="Show Items";
...
var b=this.getTree();
d.add(b);
var c=this.getCommandFrame(b);
d.add(c);
},getTree:function(){var bf=new qx.ui.tree.Tree().set({width:200,height:400});
var bk=new qx.ui.tree.TreeFolder(S);
bk.setOpen(true);
bf.setRoot(bk);
var bi=new qx.ui.tree.TreeFolder(T);
bi.setOpen(true);
bk.add(bi);
var ba=new qx.ui.tree.TreeFolder(K);
var X=new qx.ui.tree.TreeFolder(v);
var Y=new qx.ui.tree.TreeFolder(O);
var W=new qx.ui.tree.TreeFolder(o);
bi.add(ba,X,Y,W);
var bg=new qx.ui.tree.TreeFile(j);
var V=new qx.ui.tree.TreeFile(h);
X.add(bg,V);
var bj=new qx.ui.tree.TreeFolder(g);
var bb=new qx.ui.tree.TreeFolder(Q);
var be=new qx.ui.tree.TreeFolder(L);
var bd=new qx.ui.tree.TreeFolder(o);

for(var i=0;i<30;i++){bd.add(new qx.ui.tree.TreeFile(u+i));
}var bh=new qx.ui.tree.TreeFolder(s);
var bc=new qx.ui.tree.TreeFolder(J);
bj.add(bb,be,bd,bh,bc);
bk.add(bj);
return bf;
},getCommandFrame:function(bm){var bw=new qx.ui.groupbox.GroupBox(N);
var bu=4;
bw.setLayout(new qx.ui.layout.Grid(5,3));
var bD=0;
bw.add(new qx.ui.basic.Label(t).set({paddingTop:4}),{row:bD,column:0});
var bA=new qx.ui.form.TextField().set({readOnly:true});
bw.add(bA,{row:bD++,column:1});
bm.addListener(n,function(e){var a=e.getData();

if(a.length>0){if(this.getSelectionMode()===l){bA.setValue(a.length+M);
}else{bA.setValue(a[0].getLabel());
}}else{bA.setValue(y);
}});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
bw.add(new qx.ui.basic.Label(R),{row:bD,column:0});
var bq={"click":z,"dblclick":F,"none":D};
...
}bo.addListener(n,function(e){bm.setOpenMode(e.getData()[0].getUserData(m));
});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
bw.add(new qx.ui.basic.Label(E),{row:bD,column:0});
var bs=new qx.ui.form.CheckBox(C);
bw.add(bs,{row:bD++,column:1});
bs.addListener(q,function(e){var bl=e.getData();
bm.setSelectionMode(bl?l:k);
});
var bt=new qx.ui.form.CheckBox(w);
bw.add(bt,{row:bD++,column:1});
bt.addListener(q,function(e){var U=e.getData();
bm.setDragSelection(U);

if(!bs.getValue()){bs.setValue(true);
}});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
bw.add(new qx.ui.basic.Label(G),{row:bD,column:0});
var bB=new qx.ui.form.CheckBox(P);
bw.add(bB,{row:bD++,column:1});
bB.addListener(q,function(e){bm.setHideRoot(e.getData());
});
var br=new qx.ui.form.CheckBox(A);
bw.add(br,{row:bD++,column:1});
br.addListener(q,function(e){bm.setRootOpenClose(e.getData());
});
bw.add(new qx.ui.core.Spacer(bu,bu),{row:bD++,column:0});
var bz=new qx.ui.form.Button(I);
bw.add(bz,{row:bD++,column:1});
bz.addListener(p,function(e){alert((""+bm.getItems()).replace(",","\n","g"));
});
var bn=new qx.ui.form.Button(x);
bw.add(bn,{row:bD++,column:1});
bn.addListener(p,function(e){alert((""+bm.getItems(true,false)).replace(",","\n","g"));
});
var bx=new qx.ui.form.Button(H);
bw.add(bx,{row:bD++,column:1});
bx.addListener(p,function(e){if(this.getSelectionMode()===k){alert(this.getSelection());
}else{alert(this.getSelection().toString().replace(",","\n","g"));
}},bm);
var bv=new qx.ui.form.Button(B);
bw.add(bv,{row:bD++,column:1});
var bC=true;
bv.addListener(p,function(e){bm.setHeight(bC?600:400);
bC=!bC;
});
return bw;
}}});
