...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Cookie", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.Cookie-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var g="",f="execute",d="demobrowser.demo.bom.Cookie",c="Save",b="Restore",a="Delete";
qx.Class.define(d,{extend:qx.application.Standalone,statics:{COOKIE_KEY:"TextFieldContent"},members:{main:function(){arguments.callee.base.call(this);
var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
this.getRoot().add(k,{left:20,top:20});
var i=new qx.ui.form.TextField();
k.add(i);
var h=new qx.ui.form.Button(c);
k.add(h);
h.addListener(f,function(e){if(i.getValue()!=g){qx.bom.Cookie.set(demobrowser.demo.bom.Cookie.COOKIE_KEY,i.getValue());
i.setValue(g);
}},this);
var j=new qx.ui.form.Button(b);
k.add(j);
j.addListener(f,function(e){var m=qx.bom.Cookie.get(demobrowser.demo.bom.Cookie.COOKIE_KEY);
i.setValue(m!=null?m:g);
},this);
var l=new qx.ui.form.Button(a);
k.add(l);
l.addListener(f,function(e){qx.bom.Cookie.del(demobrowser.demo.bom.Cookie.COOKIE_KEY);
i.setValue(g);
},this);
}}});
})();
