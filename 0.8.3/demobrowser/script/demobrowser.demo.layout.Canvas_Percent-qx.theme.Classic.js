...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Canvas_Percent", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Canvas_Percent-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var v="20%",u="9%",t="3%",s="6%",r="12%",q="black",p="teal",o="red",n="demobrowser.demo.layout.Canvas_Percent",m="green",j="yellow",l="orange",k="solid",i="blue";
qx.Class.define(n,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var h=new qx.ui.decoration.Single(3,k,q);
...
var d=new qx.ui.core.Widget().set({backgroundColor:j,decorator:h});
var c=new qx.ui.core.Widget().set({backgroundColor:l,decorator:h});
var b=new qx.ui.core.Widget().set({backgroundColor:p,decorator:h});
var a=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
a.add(g,{left:t,top:t,right:t,bottom:t,width:v,height:v});
a.add(f,{left:s,top:s,right:s,width:v,height:v});
a.add(e,{left:u,top:u,bottom:u,width:v,height:v});
a.add(d,{left:r,top:r,width:v,height:v});
a.add(c,{top:u,right:u,width:v,height:v});
a.add(b,{right:u,bottom:u,width:v,height:v});
