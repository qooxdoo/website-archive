...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Tree_Columns", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Tree_Columns-qx.theme.Modern-0.js"]],
  boot : "boot",
...
W.add(bD,bC);
var by=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),c);
var bb=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),P);
var be=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),L);
var bd=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),j,m);
var bg=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),D);
var bf=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),A);
var bt=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),t);
var bs=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),G);
var br=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),e);
var bB=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),a);
var bA=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),n);
br.add(bB,bA);
bf.add(bt,bs,br);
var bi=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),x);
var bo=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),v);
var bp=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),q);
var bq=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),M);
var bk=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),C);
var bl=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),R);
var bm=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),z);
var bn=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),d);
var bu=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),O);
bi.add(bo,bp,bq,bk,bl,bm,bn,bu);
var bh=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),S);
var bv=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),s);
var bz=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),f);
var bw=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),p);
var bc=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),l);
bh.add(bv,bz,bw,bc);
var U=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),B);

for(var i=0;i<50;i++){U.add(new this.configureTreeItem(new qx.ui.tree.TreeFolder(),y+i));
}var T=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),K);
