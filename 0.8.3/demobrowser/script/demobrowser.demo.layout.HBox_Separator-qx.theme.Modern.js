...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.HBox_Separator-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var j="main",i="green",h="yellow",g="separator-horizontal",f="demobrowser.demo.layout.HBox_Separator",e="top",d="bottom",c="middle";
...
a.add(this.getBox2());
a.add(this.getBox3());
},getBox1:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,g)).set({decorator:j,backgroundColor:h,allowGrowX:false});
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return o;
},getBox2:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,g)).set({decorator:j,backgroundColor:h,minHeight:60,allowGrowX:false});
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:e}));
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:c}));
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:d}));
return b;
},getBox3:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,g)).set({decorator:j,backgroundColor:h,allowGrowX:false});
