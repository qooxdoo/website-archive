...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.virtual.Pane_GridLines-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var l="vertical",k="horizontal",j="demobrowser.demo.virtual.Pane_GridLines",i="red",h="blue";
qx.Class.define(j,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var d=new qx.ui.layout.Grid(5,5);
d.setRowFlex(0,1);
d.setColumnFlex(0,1);
d.setColumnFlex(1,1);
d.setColumnFlex(2,1);
var a=new qx.ui.container.Composite(d);
this.getRoot().add(a,{edge:5});
var b=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var c=new qx.ui.virtual.layer.GridLines(k);
c.setLineSize(1,3);
c.setLineColor(2,i);
var e=new qx.ui.virtual.layer.GridLines(l);
b.getPane().addLayer(c);
b.getPane().addLayer(e);
a.add(b,{row:0,column:0});
var b=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var f=new qx.ui.virtual.layer.GridLines(l);
f.setLineSize(1,5);
f.setLineColor(1,h);
b.getPane().addLayer(f);
a.add(b,{row:0,column:1});
var b=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var g=new qx.ui.virtual.layer.GridLines(k);
b.getPane().addLayer(g);
a.add(b,{row:0,column:2});
}}});
})();
