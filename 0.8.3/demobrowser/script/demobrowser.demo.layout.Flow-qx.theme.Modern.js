...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Flow", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Flow-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var C="_applyLayoutChange",B="top",A="left",z="Integer",y="middle",x="bottom",w="qx.ui.layout.Flow",v="center",u="right",t="Boolean";
...
}},properties:{alignX:{check:[A,v,u],init:A,apply:C},alignY:{check:[B,y,x],init:B,apply:C},spacingX:{check:z,init:0,apply:C},spacingY:{check:z,init:0,apply:C},reversed:{check:t,init:false,apply:C}},members:{verifyLayoutProperty:null,renderLayout:function(E,F){var J=this._getLayoutChildren();
...
}},__AW:function(d,e,f){var h=qx.ui.layout.Util;
var l=0;

if(this.getAlignX()!="left"){l=f-d.width;

if(this.getAlignX()=="center"){l=Math.round(l/2);
}}
for(var i=0;i<d.children.length;i++){var j=d.children[i];
var m=j.getSizeHint();
var k=j.getMarginTop();
var g=j.getMarginBottom();
var top=h.computeVerticalAlignOffset(j.getAlignY()||this.getAlignY(),k+m.height+g,d.height,k,g);
j.renderLayout(l+d.gapsBefore[i],e+top,m.width,m.height);
l+=d.gapsBefore[i]+m.width;
}},_computeSizeHint:function(){return this.__AX(Infinity);
},hasHeightForWidth:function(){return true;
},getHeightForWidth:function(D){return this.__AX(D).height;
},__AX:function(n){var o=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());
var s=0;
var p=0;
var q=0;

while(o.hasMoreLines()){var r=o.computeNextLine(n);
q+=1;
p=Math.max(p,r.width);
s+=r.height;
}return {width:p,height:s+this.getSpacingY()*(q-1)};
}}});
})();
(function(){var r="qx.ui.layout.LineSizeIterator";
qx.Class.define(r,{extend:Object,construct:function(a,b){this.__AY=a;
this.__Ba=b;
this.__Bb=a.length>0;
this.__Bc=0;
},members:{__AY:null,__Ba:null,__Bb:null,__Bc:null,computeNextLine:function(c){var c=c||Infinity;

if(!this.__Bb){throw new Error("No more lines to compute");
}var n=this.__AY;
var l=0;
var e=0;
var m=[];
...
for(var i=this.__Bc;i<n.length;i++){var k=n[i];
var o=k.getSizeHint();
var g=this.__Bd(i);
var f=o.width+g;
var d=i==this.__Bc;

if(!d&&e+f>c){this.__Bc=i;
break;
...
if(k.getLayoutProperties().lineBreak){this.__Bc=i+1;
break;
}}
if(i>=n.length){this.__Bb=false;
}return {height:l,width:e,children:m,gapsBefore:h};
},__Bd:function(p){var q=p==this.__Bc;

if(q){return this.__AY[p].getMarginLeft();
}else{return Math.max(this.__AY[p-1].getMarginRight(),this.__AY[p].getMarginLeft(),this.__Ba);
}},hasMoreLines:function(){return this.__Bb;
}}});
})();
