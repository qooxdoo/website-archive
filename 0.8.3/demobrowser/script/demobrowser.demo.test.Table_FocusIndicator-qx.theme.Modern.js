...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Table_FocusIndicator", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Table_FocusIndicator-qx.theme.Modern-0.js"]],
  boot : "boot",
...
qx.Mixin.define(bt,{members:{assert:function(l,m){qx.core.Assert.assert(l,m);
},fail:function(x){qx.core.Assert.fail(x);
},assertTrue:function(V,W){qx.core.Assert.assertTrue(V,W);
},assertFalse:function(M,N){qx.core.Assert.assertFalse(M,N);
},assertEquals:function(bF,bG,bH){qx.core.Assert.assertEquals(bF,bG,bH);
},assertNotEquals:function(bM,bN,bO){qx.core.Assert.assertNotEquals(bM,bN,bO);
},assertIdentical:function(n,o,p){qx.core.Assert.assertIdentical(n,o,p);
},assertNotIdentical:function(c,d,e){qx.core.Assert.assertNotIdentical(c,d,e);
},assertNotUndefined:function(E,F){qx.core.Assert.assertNotUndefined(E,F);
},assertUndefined:function(bK,bL){qx.core.Assert.assertUndefined(bK,bL);
},assertNotNull:function(bI,bJ){qx.core.Assert.assertNotNull(bI,bJ);
},assertNull:function(bD,bE){qx.core.Assert.assertNull(bD,bE);
},assertJsonEquals:function(bn,bo,bp){qx.core.Assert.assertJsonEquals(bn,bo,bp);
},assertMatch:function(bq,br,bs){qx.core.Assert.assertMatch(bq,br,bs);
},assertArgumentsCount:function(y,z,A,B){qx.core.Assert.assertArgumentsCount(y,z,A,B);
},assertEventFired:function(bx,event,by,bz,bA){qx.core.Assert.assertEventFired(bx,event,by,bz,bA);
},assertEventNotFired:function(O,event,P,Q){qx.core.Assert.assertEventNotFired(O,event,P,Q);
},assertException:function(bj,bk,bl,bm){qx.core.Assert.assertException(bj,bk,bl,bm);
},assertInArray:function(i,j,k){qx.core.Assert.assertInArray(i,j,k);
},assertArrayEquals:function(bu,bv,bw){qx.core.Assert.assertArrayEquals(bu,bv,bw);
},assertKeyInMap:function(bd,be,bf){qx.core.Assert.assertKeyInMap(bd,be,bf);
},assertFunction:function(I,J){qx.core.Assert.assertFunction(I,J);
},assertString:function(bB,bC){qx.core.Assert.assertString(bB,bC);
},assertBoolean:function(C,D){qx.core.Assert.assertBoolean(C,D);
},assertNumber:function(T,U){qx.core.Assert.assertNumber(T,U);
},assertPositiveNumber:function(R,S){qx.core.Assert.assertPositiveNumber(R,S);
},assertInteger:function(q,r){qx.core.Assert.assertInteger(q,r);
},assertPositiveInteger:function(G,H){qx.core.Assert.assertPositiveInteger(G,H);
},assertInRange:function(bR,bS,bT,bU){qx.core.Assert.assertInRange(bR,bS,bT,bU);
},assertObject:function(bV,bW){qx.core.Assert.assertObject(bV,bW);
},assertArray:function(v,w){qx.core.Assert.assertArray(v,w);
},assertMap:function(K,L){qx.core.Assert.assertMap(K,L);
},assertRegExp:function(bb,bc){qx.core.Assert.assertRegExp(bb,bc);
},assertType:function(X,Y,ba){qx.core.Assert.assertType(X,Y,ba);
},assertInstance:function(f,g,h){qx.core.Assert.assertInstance(f,g,h);
},assertInterface:function(s,t,u){qx.core.Assert.assertInterface(s,t,u);
},assertCssColor:function(bg,bh,bi){qx.core.Assert.assertCssColor(bg,bh,bi);
...
qx.Class.define(f,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil,qx.core.MAssert],members:{main:function(){arguments.callee.base.call(this);
