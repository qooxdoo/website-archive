...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.showcase.Localization", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$resources = {"qx/decoration/Modern/form/checkbox-checked-focused-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -474, 0], "qx/decoration/Modern/window/captionbar-inactive-br.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-inactive-combined.png", 0, 0], "qx/icon/Tango/16/actions/edit-undo.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/pda.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/view-refresh.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-r.png": [5, 136, "png", "qx", "qx/decoration/Modern/shadow-small-lr-combined.png", 0, 0], "qx/icon/Tango/16/devices/audio-card.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/office-presentation.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tabview-pane-tr.png": [30, 30, "png", "qx", "qx/decoration/Modern/tabview-pane-tb-combined.png", 0, -30], "qx/decoration/Modern/form/radiobutton-disabled.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -572, 0], "qx/icon/Tango/16/status/security-low.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-focused-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -132], "qx/icon/Tango/22/mimetypes/office-document.png": [22, 22, "png", "qx"], "qx/decoration/Modern/shadow/shadow-r.png": [15, 382, "png", "qx", "qx/decoration/Modern/shadow-lr-combined.png", -15, 0], "qx/decoration/Modern/shadow/shadow-tl.png": [15, 15, "png", "qx", "qx/decoration/Modern/shadow-tb-combined.png", 0, 0], "qx/decoration/Modern/tree/closed-selected.png": [8, 8, "png", "qx", "qx/decoration/Modern/tree-combined.png", 0, 0], "qx/icon/Tango/16/mimetypes/media-audio.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/mimetypes/office-contact.png": [16, 16, "png", "qx"], "qx/decoration/Modern/scrollbar/scrollbar-bg-horizontal.png": [76, 15, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -69, 0], "qx/icon/Tango/16/apps/utilities-network-manager.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -36, 0], "qx/icon/Tango/16/apps/utilities-system-monitor.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/edit-paste.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-inactive-r.png": [3, 15, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-lr-combined.png", 0, 0], "qx/decoration/Modern/window/close-active-hovered.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -72, 0], "qx/decoration/Modern/form/checkbox-focused-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -182, 0], "qx/icon/Tango/16/actions/format-text-italic.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-bottom-active-l.png": [5, 14, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-lr-combined.png", -5, 0], "qx/decoration/Modern/form/button-focused-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -16], "qx/decoration/Modern/tabview/tab-button-right-active-l.png": [5, 37, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-lr-combined.png", -5, 0], "qx/decoration/Modern/tree-combined.png": [32, 8, "png", "qx"], "qx/icon/Tango/16/actions/contact-new.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview-button-left-active-lr-combined.png": [10, 37, "png", "qx"], "qx/decoration/Modern/form/button-pressed-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -32, 0], "qx/decoration/Modern/tabview/tab-button-right-active-tr.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-tb-combined.png", 0, -20], "qx/decoration/Modern/window/statusbar-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/window-statusbar-tb-combined.png", 0, -12], "qx/decoration/Modern/form/button-checked-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -104], "qx/decoration/Modern/groupbox-tb-combined.png": [4, 24, "png", "qx"], "qx/decoration/Modern/pane/pane-t.png": [6, 6, "png", "qx", "qx/decoration/Modern/pane-tb-combined.png", 0, -24], "qx/icon/Tango/16/devices/display.png": [16, 16, "png", "qx"], "qx/decoration/Modern/toolbar/toolbar-gradient.png": [20, 130, "png", "qx", "qx/decoration/Modern/toolbar-combined.png", -20, 0], "qx/icon/Tango/16/devices/drive-harddisk.png": [16, 16, "png", "qx"], "qx/decoration/Modern/colorselector/brightness-field.png": [19, 256, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-b.png": [5, 5, "png", "qx", "qx/decoration/Modern/shadow-small-tb-combined.png", 0, -15], "qx/decoration/Modern/tabview-pane-tb-combined.png": [30, 180, "png", "qx"], "qx/icon/Tango/16/apps/office-project.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-active-tr.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-active-combined.png", 0, -30], "qx/decoration/Modern/scrollbar/scrollbar-button-bg-vertical.png": [10, 12, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -59, 0], "qx/icon/Tango/16/places/network-workgroup.png": [16, 16, "png", "qx"], "qx/decoration/Modern/button-tb-combined.png": [4, 216, "png", "qx"], "qx/icon/Tango/16/apps/preferences-users.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-tl.png": [5, 5, "png", "qx", "qx/decoration/Modern/shadow-small-tb-combined.png", 0, 0], "qx/decoration/Modern/menu/radiobutton.gif": [16, 5, "gif", "qx", "qx/decoration/Modern/menu-checkradio-combined.gif", 0, 0], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-b.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-b-combined.png", 0, -3], "qx/icon/Tango/16/actions/document-send.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-bottom-active-tl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-tb-combined.png", 0, -20], "qx/decoration/Modern/tabview-button-bottom-inactive-b-combined.png": [3, 9, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-inactive-br.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-b-combined.png", 0, -3], "qx/decoration/Modern/tabview/tab-button-right-active-b.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-tb-combined.png", 0, 0], "qx/decoration/Modern/form/button-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -60], "qx/decoration/Modern/form/button-hovered-c.png": [20, 52, "png", "qx"], "qx/decoration/Modern/form/tooltip-error-t.png": [6, 6, "png", "qx", "qx/decoration/Modern/tooltip-error-tb-combined.png", 0, -12], "qx/icon/Tango/16/devices/camera-web.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/insert-text.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-inactive-b.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-inactive-combined.png", 0, -18], "qx/decoration/Modern/form/input.png": [84, 12, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -70, 0], "qx/icon/Tango/16/places/network-server.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/media-flash.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/statusbar-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/window-statusbar-tb-combined.png", 0, 0], "qx/icon/Tango/16/actions/go-next.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/places/folder-remote.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tabview-pane-bl.png": [30, 30, "png", "qx", "qx/decoration/Modern/tabview-pane-tb-combined.png", 0, 0], "qx/decoration/Modern/window-captionbar-tb-inactive-combined.png": [6, 36, "png", "qx"], "qx/decoration/Modern/form/button-disabled-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -92], "qx/icon/Tango/16/status/image-loading.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/go-previous.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview-button-left-inactive-lr-combined.png": [6, 39, "png", "qx"], "qx/decoration/Modern/form/button-checked-focused-c.png": [20, 52, "png", "qx"], "qx/decoration/Modern/window/minimize-inactive.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -36, 0], "qx/icon/Tango/32/mimetypes/office-document.png": [32, 32, "png", "qx"], "qx/icon/Tango/16/emotes/face-sad.png": [16, 16, "png", "qx"], "qx/decoration/Modern/groupbox/groupbox-l.png": [4, 51, "png", "qx", "qx/decoration/Modern/groupbox-lr-combined.png", 0, 0], "qx/icon/Tango/16/actions/media-skip-backward.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-checked-focused-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -48, 0], "qx/decoration/Modern/window/minimize-active-hovered.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -9, 0], "qx/decoration/Modern/window-captionbar-lr-active-combined.png": [12, 9, "png", "qx"], "qx/icon/Tango/16/apps/office-address-book.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-l.png": [15, 382, "png", "qx", "qx/decoration/Modern/shadow-lr-combined.png", 0, 0], "qx/decoration/Modern/shadow/shadow-tr.png": [15, 15, "png", "qx", "qx/decoration/Modern/shadow-tb-combined.png", 0, -60], "qx/icon/Tango/16/apps/utilities-help.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/mimetypes/archive.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -48], "qx/decoration/Modern/menu-checkradio-combined.gif": [64, 7, "gif", "qx"], "qx/decoration/Modern/tabview-button-left-inactive-b-combined.png": [3, 9, "png", "qx"], "qx/decoration/Modern/scrollbar/scrollbar-bg-vertical.png": [15, 76, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -12, 0], "qx/decoration/Modern/cursors/move.gif": [13, 9, "gif", "qx", "qx/decoration/Modern/cursors-combined.gif", -20, 0], "qx/decoration/Modern/form/button-checked-focused-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -184], "qx/decoration/Modern/form/button-preselected-focused-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -180], "qx/decoration/Modern/form/checkbox-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -516, 0], "qx/icon/Tango/16/devices/audio-input-microphone.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/media-playback-stop.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/checkbox-pressed-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -558, 0], "qx/decoration/Modern/form/button-disabled-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -164], "qx/decoration/Modern/menu/checkbox-invert.gif": [16, 7, "gif", "qx", "qx/decoration/Modern/menu-checkradio-combined.gif", -16, 0], "qx/decoration/Modern/cursors/nodrop.gif": [20, 20, "gif", "qx", "qx/decoration/Modern/cursors-combined.gif", 0, 0], "qx/decoration/Modern/tabview/tabview-pane-l.png": [30, 2, "png", "qx", "qx/decoration/Modern/tabview-pane-lr-combined.png", 0, 0], "qx/decoration/Modern/tabview/tab-button-left-inactive-c.png": [14, 39, "png", "qx"], "qx/icon/Tango/16/actions/mail-mark-important.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-checked-focused-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -12, 0], "qx/icon/Tango/16/actions/edit-cut.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/emotes/face-smile.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-inactive-bl.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-inactive-combined.png", 0, -30], "qx/decoration/Modern/tabview-button-bottom-active-lr-combined.png": [10, 14, "png", "qx"], "qx/decoration/Modern/colorselector/huesaturation-field.jpg": [256, 256, "jpeg", "qx"], "qx/decoration/Modern/shadow-small-lr-combined.png": [10, 136, "png", "qx"], "qx/decoration/Modern/window/captionbar-active-t.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-active-combined.png", 0, -6], "qx/icon/Tango/16/devices/printer.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-right-active-tl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-tb-combined.png", 0, -5], "qx/decoration/Modern/form/button-pressed-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -84], "qx/decoration/Modern/tabview/tab-button-bottom-active-tr.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-tb-combined.png", 0, 0], "qx/decoration/Modern/tabview/tab-button-left-inactive-t.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-t-combined.png", 0, 0], "qx/decoration/Modern/inputcheckradio-combined.png": [628, 14, "png", "qx"], "qx/icon/Tango/16/apps/internet-messenger.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/categories/development.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/insert-image.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-disabled-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -120], "qx/decoration/Modern/tooltip-error-lr-combined.png": [12, 18, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-br.png": [5, 5, "png", "qx", "qx/decoration/Modern/shadow-small-tb-combined.png", 0, -10], "qx/decoration/Modern/tabview/tab-button-top-inactive-t.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-t-combined.png", 0, -6], "qx/decoration/Modern/tabview/tab-button-right-active-bl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-tb-combined.png", 0, -10], "qx/decoration/Modern/form/button-hovered-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -168], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-bl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-b-combined.png", 0, 0], "qx/decoration/Modern/form/radiobutton-focused-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -348, 0], "qx/decoration/Modern/tabview/tab-button-bottom-active-c.png": [20, 14, "png", "qx"], "qx/icon/Tango/16/actions/folder-new.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/categories/engineering.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/mail-mark-unread.png": [16, 16, "png", "qx"], "qx/decoration/Modern/menu/radiobutton-invert.gif": [16, 5, "gif", "qx", "qx/decoration/Modern/menu-checkradio-combined.gif", -32, 0], "qx/decoration/Modern/tabview/tab-button-left-inactive-bl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-b-combined.png", 0, 0], "qx/icon/Tango/16/actions/dialog-cancel.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/checkbox-pressed.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -530, 0], "qx/decoration/Modern/window/captionbar-active-bl.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-active-combined.png", 0, -24], "qx/decoration/Modern/tabview/tab-button-right-active-r.png": [5, 37, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-lr-combined.png", 0, 0], "qx/icon/Tango/16/actions/object-flip-horizontal.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/preferences-display.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview-button-top-active-lr-combined.png": [10, 12, "png", "qx"], "qx/icon/Tango/16/categories/multimedia.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/multimedia-player.png": [16, 16, "png", "qx"], "qx/decoration/Modern/table/header-cell.png": [20, 18, "png", "qx", "qx/decoration/Modern/table-combined.png", -54, 0], "qx/icon/Tango/16/status/security-medium.png": [16, 16, "png", "qx"], "qx/decoration/Modern/pane/pane-l.png": [6, 238, "png", "qx", "qx/decoration/Modern/pane-lr-combined.png", -6, 0], "qx/decoration/Modern/form/tooltip-error-br.png": [6, 6, "png", "qx", "qx/decoration/Modern/tooltip-error-tb-combined.png", 0, -30], "qx/decoration/Modern/arrows/right.png": [5, 8, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -5, 0], "qx/decoration/Modern/tabview/tab-button-right-active-t.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-tb-combined.png", 0, -25], "qx/icon/Tango/16/actions/document-new.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-active-b.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-tb-combined.png", 0, -20], "qx/icon/Tango/16/actions/format-text-strikethrough.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/maximize-active-hovered.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -45, 0], "qx/decoration/Modern/tabview/tab-button-right-inactive-tr.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-t-combined.png", 0, 0], "qx/decoration/Modern/form/input-focused.png": [40, 12, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -224, 0], "qx/icon/Tango/16/mimetypes/office-spreadsheet.png": [16, 16, "png", "qx"], "qx/decoration/Modern/arrows/up-small.png": [5, 3, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -69, 0], "qx/decoration/Modern/form/radiobutton-checked-disabled.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -264, 0], "qx/decoration/Modern/tabview/tabview-pane-b.png": [30, 30, "png", "qx", "qx/decoration/Modern/tabview-pane-tb-combined.png", 0, -60], "qx/decoration/Modern/tabview/tabview-pane-tl.png": [30, 30, "png", "qx", "qx/decoration/Modern/tabview-pane-tb-combined.png", 0, -90], "qx/decoration/Modern/form/radiobutton-checked-focused-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -56, 0], "qx/icon/Tango/16/actions/dialog-ok.png": [16, 16, "png", "qx"], "qx/decoration/Modern/colorselector/huesaturation-handle.gif": [11, 11, "gif", "qx", "qx/decoration/Modern/colorselector-combined.gif", -35, 0], "qx/decoration/Modern/tabview-button-left-inactive-t-combined.png": [3, 9, "png", "qx"], "qx/icon/Tango/16/apps/office-draw.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-hovered-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -40, 0], "qx/decoration/Modern/form/button-checked-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -8, 0], "qx/decoration/Modern/tabview-button-bottom-inactive-lr-combined.png": [6, 15, "png", "qx"], "qx/decoration/Modern/scrollbar/scrollbar-up.png": [6, 4, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -53, 0], "qx/decoration/Modern/pane-lr-combined.png": [12, 238, "png", "qx"], "qx/decoration/Modern/form/checkbox-checked-disabled.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -404, 0], "qx/decoration/Modern/form/button-disabled-c.png": [20, 52, "png", "qx"], "qx/icon/Tango/22/places/folder.png": [22, 22, "png", "qx"], "qx/icon/Tango/16/actions/edit-copy.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-right-inactive-tl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-t-combined.png", 0, -6], "qx/decoration/Modern/tabview/tab-button-right-inactive-b.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-b-combined.png", 0, 0], "qx/decoration/Modern/shadow/shadow-t.png": [15, 15, "png", "qx", "qx/decoration/Modern/shadow-tb-combined.png", 0, -30], "qx/decoration/Modern/window-captionbar-lr-inactive-combined.png": [12, 9, "png", "qx"], "qx/icon/Tango/22/places/folder-open.png": [22, 22, "png", "qx"], "qx/decoration/Modern/toolbar/toolbar-gradient-blue.png": [20, 130, "png", "qx", "qx/decoration/Modern/toolbar-combined.png", 0, 0], "qx/icon/Tango/16/emotes/face-angel.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-pressed-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -160], "qx/decoration/Modern/window/captionbar-inactive-tr.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-inactive-combined.png", 0, -6], "qx/decoration/Modern/groupbox/groupbox-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/groupbox-tb-combined.png", 0, 0], "qx/decoration/Modern/pane/pane-tr.png": [6, 6, "png", "qx", "qx/decoration/Modern/pane-tb-combined.png", 0, -12], "qx/icon/Tango/16/devices/computer.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window-captionbar-buttons-combined.png": [108, 9, "png", "qx"], "qx/icon/Tango/16/actions/list-add.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-hovered-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -32], "qx/icon/Tango/16/actions/check-spelling.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window-captionbar-tb-active-combined.png": [6, 36, "png", "qx"], "qx/decoration/Modern/groupbox/groupbox-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/groupbox-tb-combined.png", 0, -8], "qx/decoration/Modern/tabview/tab-button-top-inactive-tl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-t-combined.png", 0, 0], "qx/icon/Tango/16/apps/office-graphics.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/statusbar-l.png": [4, 7, "png", "qx", "qx/decoration/Modern/window-statusbar-lr-combined.png", -4, 0], "qx/decoration/Modern/shadow/shadow-b.png": [15, 15, "png", "qx", "qx/decoration/Modern/shadow-tb-combined.png", 0, -75], "qx/decoration/Modern/form/button-disabled-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -72], "qx/icon/Tango/16/mimetypes/office-calendar.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/format-justify-right.png": [16, 16, "png", "qx"], "qx/decoration/Modern/scrollbar/scrollbar-down.png": [6, 4, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -145, 0], "qx/icon/Tango/16/actions/go-home.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/go-last.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/media-video-player.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/status/mail-unread.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/document-open.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/preferences-sound.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-disabled-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -128], "qx/icon/Tango/16/emotes/face-kiss.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/statusbar-r.png": [4, 7, "png", "qx", "qx/decoration/Modern/window-statusbar-lr-combined.png", 0, 0], "qx/icon/Tango/16/apps/utilities-archiver.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-right-inactive-c.png": [14, 39, "png", "qx"], "qx/decoration/Modern/window/captionbar-inactive-l.png": [6, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-lr-inactive-combined.png", -6, 0], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-l.png": [3, 15, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-lr-combined.png", 0, 0], "qx/decoration/Modern/form/checkbox-checked-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -460, 0], "qx/decoration/Modern/form/button-preselected-c.png": [20, 52, "png", "qx"], "qx/icon/Tango/16/actions/go-top.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/media-playback-pause.png": [16, 16, "png", "qx"], "qx/decoration/Modern/colorselector/brightness-handle.gif": [35, 11, "gif", "qx", "qx/decoration/Modern/colorselector-combined.gif", 0, 0], "qx/icon/Tango/16/actions/go-first.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-active-tl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-tb-combined.png", 0, -10], "qx/icon/Tango/16/actions/object-rotate-right.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-active-r.png": [5, 12, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-lr-combined.png", 0, 0], "qx/icon/Tango/16/actions/format-justify-center.png": [16, 16, "png", "qx"], "qx/decoration/Modern/arrows/forward.png": [10, 8, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -43, 0], "qx/icon/Tango/16/actions/edit-clear.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/phone.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-focused-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, 0], "qx/decoration/Modern/form/checkbox.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -278, 0], "qx/decoration/Modern/arrows-combined.png": [87, 8, "png", "qx"], "qx/icon/Tango/16/apps/utilities-graphics-viewer.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-focused-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -16, 0], "qx/decoration/Modern/cursors/copy.gif": [19, 15, "gif", "qx", "qx/decoration/Modern/cursors-combined.gif", -52, 0], "qx/decoration/Modern/tabview/tab-button-top-active-tl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-tb-combined.png", 0, -10], "qx/decoration/Modern/tabview/tab-button-right-active-br.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-right-active-tb-combined.png", 0, -15], "qx/decoration/Modern/pane/pane-tl.png": [6, 6, "png", "qx", "qx/decoration/Modern/pane-tb-combined.png", 0, -18], "qx/decoration/Modern/tabview/tab-button-right-inactive-bl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-b-combined.png", 0, -6], "qx/icon/Tango/16/apps/utilities-calculator.png": [16, 16, "png", "qx"], "qx/decoration/Modern/scrollbar/scrollbar-left.png": [4, 6, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -170, 0], "qx/icon/Tango/16/actions/edit-find.png": [16, 16, "png", "qx"], "qx/decoration/Modern/pane-tb-combined.png": [6, 36, "png", "qx"], "qx/decoration/Modern/pane/pane-c.png": [20, 238, "png", "qx"], "qx/decoration/Modern/form/button-preselected-focused-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -8], "qx/decoration/Modern/selection.png": [110, 20, "png", "qx"], "qx/decoration/Modern/table/select-column-order.png": [10, 9, "png", "qx", "qx/decoration/Modern/table-combined.png", -36, 0], "qx/icon/Tango/16/actions/format-text-direction-ltr.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-tr.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-t-combined.png", 0, -3], "qx/decoration/Modern/arrows/up.png": [8, 5, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -35, 0], "qx/decoration/Modern/form/button-pressed-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -64], "qx/decoration/Modern/form/button-pressed-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -108], "qx/decoration/Modern/tabview/tab-button-left-active-t.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-tb-combined.png", 0, -25], "qx/icon/Tango/16/apps/office-spreadsheet.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/maximize-active.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -81, 0], "qx/decoration/Modern/tabview/tab-button-top-active-t.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-tb-combined.png", 0, 0], "qx/decoration/Modern/form/button-preselected-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -20, 0], "qx/icon/Tango/16/emotes/face-raspberry.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-checked-focused-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -148], "qx/icon/Tango/16/emotes/face-smile-big.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/preferences-wallpaper.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview-button-top-inactive-b-combined.png": [3, 9, "png", "qx"], "qx/icon/Tango/16/mimetypes/executable.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tabview-pane.png": [185, 250, "png", "qx"], "qx/decoration/Modern/window/captionbar-active-c.png": [20, 9, "png", "qx"], "qx/decoration/Modern/groupbox/groupbox-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/groupbox-tb-combined.png", 0, -12], "qx/decoration/Modern/tabview/tabview-pane-t.png": [30, 30, "png", "qx", "qx/decoration/Modern/tabview-pane-tb-combined.png", 0, -150], "qx/decoration/Modern/tabview/tab-button-top-inactive-c.png": [20, 15, "png", "qx"], "qx/icon/Tango/16/actions/window-new.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-bottom-active-br.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-tb-combined.png", 0, -15], "qx/decoration/Modern/form/tooltip-error-arrow.png": [11, 14, "png", "qx"], "qx/icon/Tango/16/mimetypes/media-image.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/tooltip-error-tr.png": [6, 6, "png", "qx", "qx/decoration/Modern/tooltip-error-tb-combined.png", 0, -18], "qx/decoration/Modern/form/button-checked-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -40], "qx/decoration/Modern/groupbox/groupbox-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/groupbox-tb-combined.png", 0, -20], "qx/decoration/Modern/form/button-preselected-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -52], "qx/icon/Tango/16/apps/preferences-locale.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/internet-feed-reader.png": [16, 16, "png", "qx"], "qx/decoration/Modern/scrollbar/scrollbar-button-bg-horizontal.png": [12, 10, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", 0, 0], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-tl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-t-combined.png", 0, -6], "qx/icon/Tango/16/apps/office-writer.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/format-justify-fill.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/places/user-desktop.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/checkbox-checked.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -320, 0], "qx/decoration/Modern/window/close-inactive.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -63, 0], "qx/decoration/Modern/arrows/down.png": [8, 5, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -74, 0], "qx/decoration/Modern/window/close-active.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -54, 0], "qx/decoration/Modern/form/button-disabled-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -4, 0], "qx/decoration/Modern/window/captionbar-inactive-t.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-inactive-combined.png", 0, -12], "qx/decoration/Modern/arrows/right-invert.png": [5, 8, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -15, 0], "qx/icon/Tango/16/actions/mail-receive.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/internet-blog.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/media-record.png": [16, 16, "png", "qx"], "qx/decoration/Modern/arrows/left-invert.png": [5, 8, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -30, 0], "qx/icon/Tango/16/actions/edit-select-all.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/input-keyboard.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-focused-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -64, 0], "qx/icon/Tango/16/actions/zoom-out.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/places/user-home.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/mail-reply-sender.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/internet-web-browser.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview-button-top-inactive-t-combined.png": [3, 9, "png", "qx"], "qx/decoration/Modern/tabview-button-right-active-tb-combined.png": [5, 30, "png", "qx"], "qx/decoration/Modern/form/button-focused-c.png": [20, 52, "png", "qx"], "qx/decoration/Modern/tooltip-error-tb-combined.png": [6, 36, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-inactive-tl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-t-combined.png", 0, -6], "qx/decoration/Modern/tabview/tab-button-top-active-l.png": [5, 12, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-lr-combined.png", -5, 0], "qx/decoration/Modern/toolbar/toolbar-part.gif": [7, 1, "gif", "qx"], "qx/icon/Tango/16/actions/mail-message-new.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/emotes/face-plain.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/office-web.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/document-save-as.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/system-shutdown.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/preferences-keyboard.png": [16, 16, "png", "qx"], "qx/decoration/Modern/groupbox/groupbox-c.png": [20, 51, "png", "qx"], "qx/icon/Tango/16/mimetypes/media-video.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/input-mouse.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/categories/science.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/mail-reply-all.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/statusbar-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/window-statusbar-tb-combined.png", 0, -4], "qx/decoration/Modern/tabview/tab-button-bottom-active-bl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-tb-combined.png", 0, -10], "qx/decoration/Modern/tabview/tab-button-left-active-l.png": [5, 37, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-lr-combined.png", -5, 0], "qx/icon/Tango/16/apps/internet-download-manager.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-active-l.png": [6, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-lr-active-combined.png", -6, 0], "qx/decoration/Modern/form/button-preselected-focused-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", 0, 0], "qx/decoration/Modern/shadow-lr-combined.png": [30, 382, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-inactive-b.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-b-combined.png", 0, -3], "qx/decoration/Modern/form/button-preselected-focused-c.png": [20, 52, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-active-br.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-tb-combined.png", 0, -5], "qx/decoration/Modern/form/radiobutton-focused.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -502, 0], "qx/decoration/Modern/form/checkbox-checked-focused.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -544, 0], "qx/decoration/Modern/form/checkbox-hovered-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -586, 0], "qx/decoration/Modern/shadow/shadow-bl.png": [15, 15, "png", "qx", "qx/decoration/Modern/shadow-tb-combined.png", 0, -45], "qx/decoration/Modern/tabview/tab-button-right-inactive-l.png": [3, 39, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-lr-combined.png", -3, 0], "qx/icon/Tango/16/places/user-trash-full.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tree/open-selected.png": [8, 8, "png", "qx", "qx/decoration/Modern/tree-combined.png", -24, 0], "qx/decoration/Modern/form/checkbox-checked-hovered-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", 0, 0], "qx/decoration/Modern/form/button-focused-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -88], "qx/decoration/Modern/tabview/tab-button-left-inactive-tr.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-t-combined.png", 0, -3], "qx/decoration/Modern/groupbox/groupbox-r.png": [4, 51, "png", "qx", "qx/decoration/Modern/groupbox-lr-combined.png", -4, 0], "qx/decoration/Modern/arrows/up-invert.png": [8, 5, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -53, 0], "qx/icon/Tango/16/actions/mail-mark-junk.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -44], "qx/icon/Tango/16/actions/address-book-new.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/format-justify-left.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -68, 0], "qx/decoration/Modern/tabview/tab-button-left-active-c.png": [12, 37, "png", "qx"], "qx/icon/Tango/16/mimetypes/text-plain.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tree/closed.png": [8, 8, "png", "qx", "qx/decoration/Modern/tree-combined.png", -8, 0], "qx/icon/Tango/16/status/dialog-warning.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/process-stop.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/status/image-missing.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tree/open.png": [8, 8, "png", "qx", "qx/decoration/Modern/tree-combined.png", -16, 0], "qx/decoration/Modern/table/ascending.png": [8, 5, "png", "qx", "qx/decoration/Modern/table-combined.png", -46, 0], "qx/icon/Tango/16/actions/dialog-close.png": [16, 16, "png", "qx"], "qx/decoration/Modern/menu/bar-background.png": [40, 20, "png", "qx", "qx/decoration/Modern/menu-background-combined.png", -20, 0], "qx/decoration/Modern/form/radiobutton-checked-hovered.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -390, 0], "qx/decoration/Modern/tabview-button-top-inactive-lr-combined.png": [6, 15, "png", "qx"], "qx/decoration/Modern/tabview-button-left-active-tb-combined.png": [5, 30, "png", "qx"], "qx/icon/Tango/16/actions/format-indent-less.png": [16, 16, "png", "qx"], "qx/decoration/Modern/menu/checkbox.gif": [16, 7, "gif", "qx", "qx/decoration/Modern/menu-checkradio-combined.gif", -48, 0], "qx/decoration/Modern/form/button-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -156], "qx/decoration/Modern/form/tooltip-error-bl.png": [6, 6, "png", "qx", "qx/decoration/Modern/tooltip-error-tb-combined.png", 0, 0], "qx/icon/Tango/16/emotes/face-surprise.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-hovered-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -36], "qx/decoration/Modern/tabview-button-right-inactive-t-combined.png": [3, 9, "png", "qx"], "qx/icon/Tango/16/apps/internet-transfer.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/preferences-clock.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-inactive-br.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-b-combined.png", 0, -6], "qx/decoration/Modern/splitpane/knob-horizontal.png": [1, 8, "png", "qx", "qx/decoration/Modern/splitpane-knobs-combined.png", 0, 0], "qx/decoration/Modern/tabview/tab-button-right-active-c.png": [12, 37, "png", "qx"], "qx/icon/Tango/16/apps/internet-mail.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/document-open-recent.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-tr.png": [5, 5, "png", "qx", "qx/decoration/Modern/shadow-small-tb-combined.png", 0, -25], "qx/decoration/Modern/form/radiobutton-checked-focused.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -28, 0], "qx/decoration/Modern/arrows/down-invert.png": [8, 5, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -61, 0], "qx/icon/Tango/16/apps/utilities-keyring.png": [16, 16, "png", "qx"], "qx/decoration/Modern/menu/background.png": [20, 49, "png", "qx", "qx/decoration/Modern/menu-background-combined.png", 0, 0], "qx/decoration/Modern/form/radiobutton-hovered-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -154, 0], "qx/decoration/Modern/form/checkbox-checked-pressed-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -210, 0], "qx/decoration/Modern/shadow-tb-combined.png": [15, 90, "png", "qx"], "qx/icon/Tango/16/actions/zoom-fit-best.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-checked-c.png": [20, 52, "png", "qx"], "qx/decoration/Modern/window/restore-active-hovered.png": [9, 8, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -99, 0], "qx/decoration/Modern/form/button-pressed-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -144], "qx/decoration/Modern/tabview-button-right-inactive-lr-combined.png": [6, 39, "png", "qx"], "qx/icon/Tango/16/actions/view-sort-ascending.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-focused-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -152], "qx/decoration/Modern/tabview/tabview-pane-r.png": [30, 2, "png", "qx", "qx/decoration/Modern/tabview-pane-lr-combined.png", -30, 0], "qx/icon/Tango/16/mimetypes/office-illustration.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/categories/internet.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/preferences-network.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/media-seek-backward.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-bl.png": [5, 5, "png", "qx", "qx/decoration/Modern/shadow-small-tb-combined.png", 0, -20], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-c.png": [20, 15, "png", "qx"], "qx/icon/Tango/16/apps/media-photo-album.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/view-fullscreen.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/utilities-color-chooser.png": [16, 16, "png", "qx"], "qx/decoration/Modern/menu-background-combined.png": [60, 49, "png", "qx"], "qx/icon/Tango/16/actions/media-skip-forward.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-active-br.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-active-combined.png", 0, -12], "qx/icon/Tango/16/actions/appointment-new.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/edit-redo.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/network-wireless.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-hovered-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -28], "qx/decoration/Modern/form/checkbox-checked-hovered.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -600, 0], "qx/icon/Tango/16/actions/view-sort-descending.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-focused-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -204], "qx/icon/Tango/16/places/user-trash.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/status/mail-read.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/dialog-apply.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -192], "qx/decoration/Modern/table/boolean-false.png": [14, 14, "png", "qx", "qx/decoration/Modern/table-combined.png", -22, 0], "qx/icon/Tango/16/actions/document-print-preview.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/statusbar-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/window-statusbar-tb-combined.png", 0, -16], "qx/decoration/Modern/window/captionbar-inactive-tl.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-inactive-combined.png", 0, -24], "qx/decoration/Modern/window/restore-active.png": [9, 8, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", 0, 0], "qx/decoration/Modern/pane/pane-r.png": [6, 238, "png", "qx", "qx/decoration/Modern/pane-lr-combined.png", 0, 0], "qx/decoration/Modern/tabview-button-bottom-active-tb-combined.png": [5, 30, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-active-tr.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-tb-combined.png", 0, -15], "qx/icon/Tango/16/actions/format-text-direction-rtl.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/utilities-character-map.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-active-bl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-top-active-tb-combined.png", 0, -25], "qx/decoration/Modern/form/button-preselected-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -112], "qx/decoration/Modern/form/button-pressed-c.png": [20, 52, "png", "qx"], "qx/decoration/Modern/cursors/alias.gif": [19, 15, "gif", "qx", "qx/decoration/Modern/cursors-combined.gif", -33, 0], "qx/decoration/Modern/form/radiobutton-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -418, 0], "qx/icon/Tango/16/places/folder.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -140], "qx/decoration/Modern/form/radiobutton-pressed-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -446, 0], "qx/decoration/Modern/tabview/tab-button-top-active-c.png": [20, 12, "png", "qx"], "qx/decoration/Modern/splitpane-knobs-combined.png": [8, 9, "png", "qx"], "qx/decoration/Modern/form/button-pressed-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -200], "qx/decoration/Modern/app-header.png": [110, 20, "png", "qx"], "qx/decoration/Modern/groupbox/groupbox-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/groupbox-tb-combined.png", 0, -4], "qx/decoration/Modern/window/restore-inactive.png": [9, 8, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -27, 0], "qx/decoration/Modern/form/button-checked-focused-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -100], "qx/icon/Tango/16/status/mail-replied.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-l.png": [5, 136, "png", "qx", "qx/decoration/Modern/shadow-small-lr-combined.png", -5, 0], "qx/icon/Tango/16/actions/window-close.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/status/security-high.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview-button-right-inactive-b-combined.png": [3, 9, "png", "qx"], "qx/icon/Tango/16/devices/scanner.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/system-search.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/categories/games.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-checked-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -52, 0], "qx/decoration/Modern/tabview/tab-button-left-active-br.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-tb-combined.png", 0, -20], "qx/icon/Tango/16/categories/utilities.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview-button-top-active-tb-combined.png": [5, 30, "png", "qx"], "qx/decoration/Modern/tabview/tabview-pane-c.png": [20, 2, "png", "qx"], "qx/static/blank.gif": [1, 1, "gif", "qx"], "qx/icon/Tango/16/devices/battery.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/status/dialog-information.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/radiobutton.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -334, 0], "qx/decoration/Modern/form/button-checked-focused-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -136], "qx/icon/Tango/16/emotes/face-laugh.png": [16, 16, "png", "qx"], "qx/decoration/Modern/arrows/rewind.png": [10, 8, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -20, 0], "qx/icon/Tango/16/apps/office-database.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-active-tl.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-active-combined.png", 0, 0], "qx/decoration/Modern/form/checkbox-hovered.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -376, 0], "qx/decoration/Modern/scrollbar/slider-knob-background.png": [12, 10, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -27, 0], "qx/decoration/Modern/tabview-button-right-active-lr-combined.png": [10, 37, "png", "qx"], "qx/icon/Tango/16/actions/insert-link.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-focused-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -124], "qx/icon/Tango/16/apps/preferences-accessibility.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-c.png": [20, 136, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-bottom-active-t.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-tb-combined.png", 0, -25], "qx/decoration/Modern/form/button-hovered-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -24], "qx/decoration/Modern/window-statusbar-tb-combined.png": [4, 24, "png", "qx"], "qx/icon/Tango/16/emblems/emblem-important.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-focused-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -172], "qx/icon/Tango/16/actions/media-seek-forward.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tabview-pane-br.png": [30, 30, "png", "qx", "qx/decoration/Modern/tabview-pane-tb-combined.png", 0, -120], "qx/icon/Tango/16/apps/utilities-terminal.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/list-remove.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -196], "qx/icon/Tango/16/mimetypes/office-presentation.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/checkbox-checked-pressed.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -614, 0], "qx/icon/Tango/16/devices/network-wired.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-small-t.png": [5, 5, "png", "qx", "qx/decoration/Modern/shadow-small-tb-combined.png", 0, -5], "qx/decoration/Modern/tabview/tab-button-right-inactive-r.png": [3, 39, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-lr-combined.png", 0, 0], "qx/decoration/Modern/form/button-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -20], "qx/decoration/Modern/table/boolean-true.png": [14, 14, "png", "qx", "qx/decoration/Modern/table-combined.png", -8, 0], "qx/icon/Tango/16/actions/object-rotate-left.png": [16, 16, "png", "qx"], "qx/decoration/Modern/shadow/shadow-c.png": [20, 382, "png", "qx"], "qx/decoration/Modern/table-combined.png": [74, 18, "png", "qx"], "qx/icon/Tango/16/devices/drive-optical.png": [16, 16, "png", "qx"], "qx/decoration/Modern/pane/pane-bl.png": [6, 6, "png", "qx", "qx/decoration/Modern/pane-tb-combined.png", 0, 0], "qx/decoration/Modern/form/radiobutton-checked.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -292, 0], "qx/icon/Tango/16/status/dialog-error.png": [16, 16, "png", "qx"], "qx/decoration/Modern/cursors-combined.gif": [71, 20, "gif", "qx"], "qx/icon/Tango/16/actions/object-flip-vertical.png": [16, 16, "png", "qx"], "qx/decoration/Modern/button-lr-combined.png": [72, 52, "png", "qx"], "qx/decoration/Modern/window/statusbar-c.png": [20, 7, "png", "qx"], "qx/icon/Tango/16/actions/edit-delete.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/categories/office.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/tooltip-error-tl.png": [6, 6, "png", "qx", "qx/decoration/Modern/tooltip-error-tb-combined.png", 0, -6], "qx/decoration/Modern/scrollbar-combined.png": [174, 76, "png", "qx"], "qx/icon/Tango/16/actions/format-text-underline.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/help-faq.png": [16, 16, "png", "qx"], "qx/decoration/Modern/toolbar-combined.png": [40, 130, "png", "qx"], "qx/icon/Tango/16/status/dialog-password.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/view-restore.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/statusbar-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/window-statusbar-tb-combined.png", 0, -20], "qx/decoration/Modern/window/captionbar-inactive-r.png": [6, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-lr-inactive-combined.png", 0, 0], "qx/decoration/Modern/form/checkbox-focused.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -488, 0], "qx/decoration/Modern/form/button-disabled-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -208], "qx/icon/Tango/16/mimetypes/office-document.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-pressed-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -24, 0], "qx/icon/Tango/16/actions/go-up.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-active-r.png": [5, 37, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-lr-combined.png", 0, 0], "qx/icon/Tango/16/categories/graphics.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-bottom-active-r.png": [5, 14, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-lr-combined.png", 0, 0], "qx/icon/Tango/16/emblems/emblem-favorite.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/devices/media-optical.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/categories/accessories.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window-statusbar-lr-combined.png": [8, 7, "png", "qx"], "qx/decoration/Modern/groupbox-lr-combined.png": [8, 51, "png", "qx"], "qx/decoration/Modern/form/button-checked-focused-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -4], "qx/decoration/Modern/form/radiobutton-hovered.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -14, 0], "qx/icon/Tango/16/actions/mail-send.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/mimetypes/text-html.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-inactive-r.png": [3, 39, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-lr-combined.png", -3, 0], "qx/decoration/Modern/form/radiobutton-checked-hovered-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -432, 0], "qx/decoration/Modern/tabview/tab-button-top-inactive-b.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-b-combined.png", 0, 0], "qx/icon/Tango/16/actions/application-exit.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/checkbox-disabled.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -196, 0], "qx/decoration/Modern/shadow/shadow-br.png": [15, 15, "png", "qx", "qx/decoration/Modern/shadow-tb-combined.png", 0, -15], "qx/decoration/Modern/pane/pane-b.png": [6, 6, "png", "qx", "qx/decoration/Modern/pane-tb-combined.png", 0, -6], "qx/icon/Tango/16/actions/document-save.png": [16, 16, "png", "qx"], "qx/decoration/Modern/toolbar/toolbar-handle-knob.gif": [1, 8, "gif", "qx"], "qx/decoration/Modern/form/button-checked-focused-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -68], "qx/decoration/Modern/form/button-checked-bl.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -76], "qx/decoration/Modern/form/radiobutton-checked-pressed.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -306, 0], "qx/decoration/Modern/groupbox/groupbox-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/groupbox-tb-combined.png", 0, -16], "qx/decoration/Modern/form/tooltip-error-l.png": [6, 18, "png", "qx", "qx/decoration/Modern/tooltip-error-lr-combined.png", 0, 0], "qx/decoration/Modern/arrows/down-small.png": [5, 3, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -82, 0], "qx/icon/Tango/16/actions/mail-mark-read.png": [16, 16, "png", "qx"], "qx/icon/Tango/32/places/folder.png": [32, 32, "png", "qx"], "qx/decoration/Modern/pane/pane-br.png": [6, 6, "png", "qx", "qx/decoration/Modern/pane-tb-combined.png", 0, -30], "qx/decoration/Modern/splitpane/knob-vertical.png": [8, 1, "png", "qx", "qx/decoration/Modern/splitpane-knobs-combined.png", 0, -8], "qx/decoration/Modern/scrollbar/scrollbar-right.png": [4, 6, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -39, 0], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-br.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-b-combined.png", 0, -6], "qx/decoration/Modern/form/tooltip-error-b.png": [6, 6, "png", "qx", "qx/decoration/Modern/tooltip-error-tb-combined.png", 0, -24], "qx/icon/Tango/16/apps/utilities-statistics.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/document-print.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-hovered-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -60, 0], "qx/icon/Tango/16/apps/utilities-log-viewer.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/utilities-dictionary.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/emotes/face-embarrassed.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-active-tr.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-tb-combined.png", 0, -15], "qx/decoration/Modern/shadow-small-tb-combined.png": [5, 30, "png", "qx"], "qx/icon/Tango/16/actions/zoom-original.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-active-b.png": [6, 6, "png", "qx", "qx/decoration/Modern/window-captionbar-tb-active-combined.png", 0, -18], "qx/decoration/Modern/form/button-checked-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -188], "qx/decoration/Modern/tabview/tab-button-top-inactive-l.png": [3, 15, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-lr-combined.png", -3, 0], "qx/decoration/Modern/colorselector-combined.gif": [46, 11, "gif", "qx"], "qx/icon/Tango/16/actions/format-indent-more.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-right-inactive-br.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-b-combined.png", 0, -3], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-r.png": [3, 15, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-lr-combined.png", -3, 0], "qx/decoration/Modern/tabview/tab-button-bottom-active-b.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-active-tb-combined.png", 0, -5], "qx/decoration/Modern/tabview/tab-button-left-inactive-l.png": [3, 39, "png", "qx", "qx/decoration/Modern/tabview-button-left-inactive-lr-combined.png", 0, 0], "qx/icon/Tango/16/actions/help-contents.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/go-bottom.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/utilities-notes.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/radiobutton-checked-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -42, 0], "qx/icon/Tango/16/apps/preferences-security.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/internet-telephony.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/radiobutton-pressed.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -168, 0], "qx/decoration/Modern/form/button-focused-r.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -44, 0], "qx/decoration/Modern/window/maximize-inactive.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -18, 0], "qx/decoration/Modern/tabview-pane-lr-combined.png": [60, 2, "png", "qx"], "qx/icon/Tango/16/apps/office-layout.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-hovered-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -80], "qx/icon/Tango/16/actions/system-log-out.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/preferences-font.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/mail-forward.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-focused-t.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -96], "qx/decoration/Modern/window/minimize-active.png": [9, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-buttons-combined.png", -90, 0], "qx/decoration/Modern/tabview/tab-button-left-active-b.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-tb-combined.png", 0, 0], "qx/decoration/Modern/window/captionbar-active-r.png": [6, 9, "png", "qx", "qx/decoration/Modern/window-captionbar-lr-active-combined.png", 0, 0], "qx/decoration/Modern/table/descending.png": [8, 5, "png", "qx", "qx/decoration/Modern/table-combined.png", 0, 0], "qx/decoration/Modern/form/button-checked-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -116], "qx/icon/Tango/16/actions/document-revert.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/media-eject.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-left-active-bl.png": [5, 5, "png", "qx", "qx/decoration/Modern/tabview-button-left-active-tb-combined.png", 0, -5], "qx/icon/Tango/16/actions/system-run.png": [16, 16, "png", "qx"], "qx/decoration/Modern/arrows/down-small-invert.png": [5, 3, "png", "qx", "qx/decoration/Modern/arrows-combined.png", -10, 0], "qx/icon/Tango/16/apps/office-calendar.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-tr.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -12], "qx/icon/Tango/32/places/folder-open.png": [32, 32, "png", "qx"], "qx/icon/Tango/16/devices/camera-photo.png": [16, 16, "png", "qx"], "qx/decoration/Modern/scrollbar/scrollbar-bg-pressed-vertical.png": [10, 19, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -43, 0], "qx/icon/Tango/16/categories/system.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/bookmark-new.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-checked-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -176], "qx/decoration/Modern/form/tooltip-error-r.png": [6, 18, "png", "qx", "qx/decoration/Modern/tooltip-error-lr-combined.png", -6, 0], "qx/icon/Tango/16/actions/zoom-in.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-preselected-focused-br.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -212], "qx/icon/Tango/16/actions/format-text-bold.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/radiobutton-checked-pressed-invalid.png": [14, 14, "png", "qx", "qx/decoration/Modern/inputcheckradio-combined.png", -362, 0], "qx/decoration/Modern/form/button-c.png": [20, 52, "png", "qx"], "qx/decoration/Modern/form/button-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -56, 0], "qx/decoration/Modern/window/statusbar-tl.png": [4, 4, "png", "qx", "qx/decoration/Modern/window-statusbar-tb-combined.png", 0, -8], "qx/icon/Tango/16/actions/help-about.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/document-properties.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/button-disabled-l.png": [4, 52, "png", "qx", "qx/decoration/Modern/button-lr-combined.png", -28, 0], "qx/icon/Tango/16/apps/preferences-theme.png": [16, 16, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-bottom-inactive-t.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-bottom-inactive-t-combined.png", 0, 0], "qx/decoration/Modern/tabview-button-bottom-inactive-t-combined.png": [3, 9, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-inactive-bl.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-b-combined.png", 0, -6], "qx/decoration/Modern/scrollbar/scrollbar-bg-pressed-horizontal.png": [19, 10, "png", "qx", "qx/decoration/Modern/scrollbar-combined.png", -151, 0], "qx/icon/Tango/16/apps/office-chart.png": [16, 16, "png", "qx"], "qx/decoration/Modern/window/captionbar-inactive-c.png": [20, 9, "png", "qx"], "qx/icon/Tango/16/actions/go-down.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/apps/media-audio-player.png": [16, 16, "png", "qx"], "qx/decoration/Modern/form/tooltip-error-c.png": [20, 18, "png", "qx"], "qx/decoration/Modern/tabview/tab-button-top-inactive-tr.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-top-inactive-t-combined.png", 0, -3], "qx/decoration/Modern/form/button-preselected-b.png": [4, 4, "png", "qx", "qx/decoration/Modern/button-tb-combined.png", 0, -56], "qx/decoration/Modern/tabview/tab-button-right-inactive-t.png": [3, 3, "png", "qx", "qx/decoration/Modern/tabview-button-right-inactive-t-combined.png", 0, -3], "qx/decoration/Modern/arrows/left.png": [5, 8, "png", "qx", "qx/decoration/Modern/arrows-combined.png", 0, 0], "qx/icon/Tango/16/apps/utilities-text-editor.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/places/folder-open.png": [16, 16, "png", "qx"], "qx/icon/Tango/16/actions/media-playback-start.png": [16, 16, "png", "qx"]};
qx.$$translations = {"C": {}, "en": {}, "fr_FR": {}, "de": {"key_short_Meta": "Meta", "key_short_Scroll": "Rollen", "Presets": "Voreinstellungen", "Hex": "Hex", "key_short_Space": "Leer", "key_short_Shift": "Umschalt", "key_short_Apps": "Kontext", "Open ColorSelector": "Öffne Farbauswahl", "key_short_Backspace": "Rück", "key_full_Escape": "Escape", "key_full_Space": "Leertaste", "key_full_Tab": "Tabulator", "key_full_Delete": "Entfernen", "key_short_Home": "Pos1", "Search": "Suchen", "key_short_Tab": "Tab", "key_full_Alt": "Alt", "key_short_Down": "Runter", "key_short_PrintScreen": "Druck", "key_short_Left": "Links", "Automatic": "Automatisch", "key_short_CapsLock": "Feststell", "key_short_Pause": "Pause", "OK": "OK", "key_full_Pause": "Pause", "key_short_Insert": "Einfg", "Preview (Old/New)": "Vorschau (alt/neu)", "key_short_End": "Ende", "key_full_Home": "Position 1", "Cancel": "Abbruch", "key_full_Up": "Pfeil hoch", "Next year": "Nächstes Jahr", "key_short_Delete": "Entf", "key_short_PageDown": "Bild runter", "key_full_Down": "Pfeil runter", "key_full_Left": "Pfeil links", "key_short_Control": "Strg", "Next month": "Nächster Monat", "key_short_Right": "Rechts ", "key_full_PageUp": "Bild hoch", "key_full_Control": "Steuerung", "RGB": "RGB", "Details": "Details", "key_full_Meta": "Meta", "key_full_Insert": "Einfügen", "key_short_Alt": "Alt", "key_full_Shift": "Umschalttaste", "Color Selector": "Farbauswahl", "key_full_NumLock": "NumLock", "key_full_End": "Ende", "key_short_Escape": "Esc", "key_full_Apps": "Kontextmenü", "key_full_Backspace": "Rücktaste", "HSB": "HSB", "key_short_PageUp": "Bild hoch", "key_short_Win": "Win", "key_full_Win": "Windowstaste", "key_short_NumLock": "Num", "key_full_Scroll": "Rollen", "key_short_Enter": "Enter", "Last month": "Vorheriger Monat", "key_full_Right": "Pfeil rechts", "key_full_PageDown": "Bild runter ", "key_full_Enter": "Enter", "key_full_CapsLock": "Feststelltaste", "key_short_Up": "Hoch", "key_full_PrintScreen": "Drucken", "Last year": "Vorheriges Jahr"}, "fr": {"key_short_Meta": "Meta", "key_short_Scroll": "Arrêt Défil", "Presets": "Pré-réglages", "Hex": "Hex", "key_short_Space": "Espace", "key_short_Shift": "Maj", "key_short_Apps": "App.", "Open ColorSelector": "Ouvrir le sélecteur de couleurs", "key_short_Backspace": "Effacement Arrière", "key_full_Escape": "Échappement", "key_full_Space": "Espace", "key_full_Tab": "Tabulation", "key_full_Delete": "Suppression", "key_short_Home": "Orig.", "Search": "Recherche", "key_short_Tab": "Tab", "key_full_Alt": "Alternative", "key_short_Down": "Bas", "key_short_PrintScreen": "Imp. Écran", "key_short_Left": "Gauche", "Automatic": "Automatique", "key_short_CapsLock": "Verr. Maj.", "key_short_Pause": "Pause", "OK": "OK", "key_full_Pause": "Pause", "key_short_Insert": "Ins.", "Preview (Old/New)": "Aperçu (Ancien/Nouveau)", "key_short_End": "Fin", "key_full_Home": "Origine", "Cancel": "Annuler", "key_full_Up": "Haut", "Next year": "Année prochaine", "key_short_Delete": "Supp.", "key_short_PageDown": "Pg Suiv.", "key_full_Down": "Bas", "key_full_Left": "Gauche", "key_short_Control": "Ctrl", "Next month": "Mois prochain", "key_short_Right": "Droite", "key_full_PageUp": "Page Précédente", "key_full_Control": "Contrôle", "RGB": "RVB", "Details": "Détails", "key_full_Meta": "Meta", "key_full_Insert": "Insertion", "key_short_Alt": "Alt", "key_full_Shift": "Majuscules", "Color Selector": "Sélecteur de couleurs", "key_full_NumLock": "Verouillage Numérique", "key_full_End": "Fin", "key_short_Escape": "Echap.", "key_full_Apps": "Application", "key_full_Backspace": "Effacement arrière", "HSB": "TSV", "key_short_PageUp": "Pg Préc.", "key_short_Win": "Win", "key_full_Win": "Windows", "key_short_NumLock": "Verr. Num.", "key_full_Scroll": "Arrêt défilement", "key_short_Enter": "Entrée", "Last month": "Mois dernier", "key_full_Right": "Droite", "key_full_PageDown": "Page Suivante", "key_full_Enter": "Entrée", "key_full_CapsLock": "Verrouillage des Majuscule", "key_short_Up": "Haut", "key_full_PrintScreen": "Impression de l'écran", "Last year": "Année dernière"}, "en_US": {}, "de_DE": {}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.showcase.Localization-qx.theme.Modern-0.js"]],
  boot : "boot",
...
bK.setRowFlex(3,1);
bK.setColumnAlign(0,T,M);
var bA=new qx.ui.window.Window(this.tr(H)).set({showClose:false,showMinimize:false});
bA.setLayout(bK);
bA.moveTo(50,50);
bA.open();
...
var bw=bT.getLocale();
var bS=new qx.ui.basic.Label(this.tr(A));
...
if((!bG&&bD[i]==bj)||bD[i]==bw){bG=bL;
}}bv.addListener(R,function(e){var bo=e.getData()[0].getLabel();
qx.locale.Manager.getInstance().setLocale(bo);
});

if(bG){bv.setSelection([bG]);
}bA.add(bv,{row:0,column:1});
bA.add(new qx.ui.basic.Label(this.tr(L)),{row:1,column:0});
var by=new qx.ui.form.ComboBox();
by.add(new qx.ui.form.ListItem(this.tr(k)));
by.add(new qx.ui.form.ListItem(this.tr(f)));
by.add(new qx.ui.form.ListItem(this.tr(h)));
...
var bq=new qx.event.Command(z);
var bB=new qx.event.Command(X);
var bp=new qx.event.Command(G);
var bR=new qx.event.Command(Q);
var bV=new qx.event.Command(b);
var bN=new qx.event.Command(bm);
var bM=new qx.event.Command(V);
var bx=new qx.event.Command(F);
var br=new qx.event.Command(t);
var bC=new qx.ui.menu.Menu;
bC.add(new qx.ui.menu.Button(this.tr(u),null,bq));
bC.add(new qx.ui.menu.Button(this.tr(D),null,bB));
bC.add(new qx.ui.menu.Separator());
bC.add(new qx.ui.menu.Button(this.tr(k),bn,bp));
bC.add(new qx.ui.menu.Button(this.tr(h),bd,bR));
bC.add(new qx.ui.menu.Button(this.tr(f),I,bV));
bC.add(new qx.ui.menu.Button(this.tr(ba),K,bN));
bC.add(new qx.ui.menu.Button(this.tr(W),null,bM));
bC.add(new qx.ui.menu.Separator());
bC.add(new qx.ui.menu.Button(this.tr(v),null,bx));
bC.add(new qx.ui.menu.Button(this.tr(U),null,br));
var bt=new qx.ui.form.MenuButton(this.tr(y),null,bC);
bA.add(bt,{row:4,column:0,colSpan:2});
var bQ=new qx.ui.control.ColorPopup();
bQ.exclude();
bQ.setValue(n);
var bO=new qx.ui.form.Button(this.tr(bk));
bO.addListener(bg,function(e){bQ.placeToMouse(e);
bQ.show();
});
bA.add(bO,{row:5,column:0});
var bE=new qx.ui.core.Widget().set({decorator:Y});
bA.add(bE,{row:5,column:1});
bQ.addListener(bi,function(e){bE.setBackgroundColor(e.getData());
});
var bJ=new qx.ui.window.Window(x).set({width:400,showClose:false,showMinimize:false});
bJ.setLayout(new qx.ui.layout.Canvas());
bJ.moveTo(150,300);
bJ.open();
var bF=new qx.ui.control.ColorSelector;
bJ.add(bF);
var bs=new qx.ui.window.Window(w,d).set({showClose:false,showMinimize:false});
bs.setLayout(new qx.ui.layout.Grow());
bs.moveTo(300,150);
bs.open();
var bH=new qx.ui.groupbox.GroupBox(this.tr(c));
...
bP[(i++*2)+1]=this.tr(bb);
bP[(i++*2)+1]=qx.locale.Date.getDateFormat(j);
bP[(i++*2)+1]=this.tr(bl);
bP[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(j))).format(new Date());
bP[(i++*2)+1]=this.tr(N);
bP[(i++*2)+1]=qx.locale.Date.getDateFormat(l);
bP[(i++*2)+1]=this.tr(C);
bP[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(l))).format(new Date());
bP[(i++*2)+1]=this.tr(B);
bP[(i++*2)+1]=qx.locale.Date.getDateFormat(g);
bP[(i++*2)+1]=this.tr(s);
bP[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(g))).format(new Date());
bP[(i++*2)+1]=this.tr(S);
...
bP[(i++*2)+1]=this.tr(bh);
bP[(i++*2)+1]=qx.locale.Date.getTimeFormat(l);
bP[(i++*2)+1]=this.tr(o);
bP[(i++*2)+1]=(new qx.util.format.DateFormat(qx.locale.Date.getTimeFormat(l))).format(new Date());
bP[(i++*2)+1]=this.tr(E);
bP[(i++*2)+1]=qx.locale.Date.getDayName(J,qx.locale.Date.getWeekStart());
bP[(i++*2)+1]=this.tr(bf,10000.12);
...
(function(){var O="textfield",N="button",M="input",L="list",K="changeValue",J="selected",I="qx.event.type.Data",H="inner",G="",F="focusin",bi="popup",bh="focusout",bg="blur",bf="Enter",be="Please use the changeValue event instead.",bd="Down",bc="Function",bb="Use public 'setTextSelection' instead!",ba="quick",Y="String",V="Use public 'clearTextSelection' instead!",W="qx.ui.form.ComboBox",T="single",U="Use public 'getTextSelectionLength' instead!",R="combobox",S="click",P="_applyPlaceholder",Q="Use public 'selectAllText' instead!",X="Use public 'getTextSelection' instead!";
qx.Class.define(W,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.form.IFormElement,qx.ui.form.IStringForm],construct:function(){arguments.callee.base.call(this);
var bl=this._createChildControl(O);
this._createChildControl(N);
this.addListener(S,this._onClick);
this.addListener(F,function(e){bl.fireNonBubblingEvent(F,qx.event.type.Focus);
},this);
this.addListener(bh,function(e){bl.fireNonBubblingEvent(bh,qx.event.type.Focus);
},this);
},properties:{appearance:{refine:true,init:R},format:{check:bc,init:function(bm){return this.__mN(bm);
},nullable:true},placeholder:{check:Y,nullable:true,apply:P}},events:{"input":I,"changeValue":I},members:{__mL:null,__mM:null,_applyPlaceholder:function(p,q){this.getChildControl(O).setPlaceholder(p);
},_createChildControlImpl:function(m){var n;

switch(m){case O:n=new qx.ui.form.TextField();
n.setFocusable(false);
n.addState(H);
n.addListener(K,this._onTextFieldChangeValue,this);
n.addListener(bg,this.close,this);
this._add(n,{flex:1});
break;
case N:n=new qx.ui.form.Button();
n.setFocusable(false);
n.setKeepActive(true);
n.addState(H);
this._add(n);
break;
case L:n=arguments.callee.base.call(this,m);
n.setSelectionMode(T);
break;
}return n||arguments.callee.base.call(this,m);
},_forwardStates:{focused:true},tabFocus:function(){var o=this.getChildControl(O);
o.getFocusElement().focus();
o.selectAllText();
},setValue:function(bj){var bk=this.getChildControl(O);

if(bk.getValue()==bj){return;
}bk.setValue(bj);
},getValue:function(){return this.getChildControl(O).getValue();
},resetValue:function(){this.getChildControl(O).setValue(null);
},addListener:function(r,s,self,t){if(r==M){qx.log.Logger.deprecatedEventWarning(arguments.callee,M,be);

if(!this.__mM){var u=this.getChildControl(O);
this.__mM=u.addListener(M,this._onTextFieldInput,this);
}}return arguments.callee.base.call(this,r,s,self,t);
},_onKeyPress:function(e){var i=this.getChildControl(bi);
var h=e.getKeyIdentifier();

if(h==bd&&e.isAltPressed()){this.getChildControl(N).addState(J);
this.toggle();
e.stopPropagation();
}else if(h==bf){if(i.isVisible()){this.close();
e.stop();
}}else if(i.isVisible()){arguments.callee.base.call(this,e);
}},_onClick:function(e){var E=e.getTarget();

if(E==this.getChildControl(N)){this.toggle();
}else{this.close();
}},_onListMouseDown:function(e){if(this.__mL){var c=this.__mL.getLabel();

if(this.getFormat()!=null){c=this.getFormat().call(this,this.__mL);
}this.setValue(c);
this.__mL=null;
}},_onListChangeSelection:function(e){var d=e.getData();

if(d.length>0){var f=this.getChildControl(L);

if(f.getSelectionContext()==ba){this.__mL=d[0];
}else{var g=d[0].getLabel();

if(this.getFormat()!=null){g=this.getFormat().call(this,d[0]);
}this.setValue(g);
this.__mL=null;
}}},_onPopupChangeVisibility:function(e){var w=this.getChildControl(bi);

if(w.isVisible()){var x=this.getChildControl(L);
var y=this.getValue();
var v=null;

if(y){v=x.findItem(y);
}
if(v){x.setSelection([v]);
}else{x.resetSelection();
}}else{this.tabFocus();
}this.getChildControl(N).removeState(J);
},_onTextFieldInput:function(e){this.fireDataEvent(M,e.getData());
},_onTextFieldChangeValue:function(e){var D=e.getData();
var C=this.getChildControl(L);

if(D!=null){var B=C.findItem(D);

if(B){C.setSelection([B]);
}else{C.resetSelection();
}}else{C.resetSelection();
}this.fireDataEvent(K,D,e.getOldData());
},__mN:function(j){var k=j?j.getLabel():G;
var l=j?j.getRich():false;

if(l){k=k.replace(/<[^>]+?>/g,G);
k=qx.bom.String.unescape(k);
}return k;
},getSelection:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,X);
return this.getTextSelection();
},getSelectionLength:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,U);
return this.getTextSelectionLength();
},setSelection:function(a,b){qx.log.Logger.deprecatedMethodWarning(arguments.callee,bb);
this.setTextSelection(a,b);
},clearSelection:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,V);
this.clearTextSelection();
},selectAll:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,Q);
this.selectAllText();
},getTextSelection:function(){return this.getChildControl(O).getTextSelection();
},getTextSelectionLength:function(){return this.getChildControl(O).getTextSelectionLength();
},setTextSelection:function(z,A){this.getChildControl(O).setTextSelection(z,A);
},clearTextSelection:function(){this.getChildControl(O).clearTextSelection();
},selectAllText:function(){this.getChildControl(O).selectAllText();
}}});
})();
...
(function(){var q="list",p="textfield",o="popup",n="Down",m="",l="Escape",k="qx.util.format.DateFormat",j="Please use the setValue instead.",i="changeValue",h="Left",D="Up",C="execute",B="used with Dates now.",A="Wrong data type detected. setValue is ",z="Please use the getValue instead.",y="changeVisibility",x="medium",w="mouseup",v="qx.ui.form.DateField",u="datefield",s="hidden",t="_applyDateFormat",r="Right";
...
var I=qx.locale.Date.getDateFormat(x).toString();
this.setDateFormat(new qx.util.format.DateFormat(I));
},properties:{appearance:{refine:true,init:u},dateFormat:{check:k,apply:t,dispose:true}},members:{setDate:function(J){qx.log.Logger.deprecatedMethodWarning(arguments.callee,j);
this.setValue(J);
},getDate:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,z);
return this.getValue();
},setValue:function(K){if(qx.lang.Type.isString(K)){qx.log.Logger.deprecatedMethodWarning(arguments.callee,A+B);
return;
}var L=this.getChildControl(p);
L.setValue(this.getDateFormat().format(K));
var M=this.getChildControl(q);
M.setValue(K);
},getValue:function(){var V=this.getChildControl(p).getValue();
try{return this.getDateFormat().parse(V);
}catch(U){return null;
}},resetValue:function(){var W=this.getChildControl(p);
W.setValue(m);
var X=this.getChildControl(q);
X.setValue(null);
},_applyDateFormat:function(E,F){try{var H=this.getChildControl(p);
var G=F.parse(H.getValue());
H.setValue(E.format(G));
}catch(a){}},_createChildControlImpl:function(f){var g;

switch(f){case q:g=new qx.ui.control.DateChooser();
g.setFocusable(false);
g.setKeepFocus(true);
g.addListener(C,this._onChangeDate,this);
break;
case o:g=new qx.ui.popup.Popup(new qx.ui.layout.VBox);
g.setAutoHide(false);
g.add(this.getChildControl(q));
g.addListener(w,this._onChangeDate,this);
g.addListener(y,this._onPopupChangeVisibility,this);
break;
}return g||arguments.callee.base.call(this,f);
},_onChangeDate:function(e){var Q=this.getChildControl(p);
var R=this.getChildControl(q).getValue();
Q.setValue(this.getDateFormat().format(R));
this.close();
},_onKeyPress:function(e){var b=e.getKeyIdentifier();

if(b==n&&e.isAltPressed()){this.toggle();
e.stopPropagation();
return;
}var c=this.getChildControl(o);

if(c.getVisibility()==s){return;
}if(b==l){this.close();
e.stopPropagation();
return;
}if(b===h||b===r||b===n||b===D){e.preventDefault();
}this.getChildControl(q).handleKeyPress(e);
},_onPopupChangeVisibility:function(e){var O=this.getChildControl(o);

if(O.isVisible()){var P=this.getChildControl(q);
var N=this.getValue();
P.setValue(N);
}},_onTextFieldChangeValue:function(e){var S=this.getValue();

if(S!=null){var T=this.getChildControl(q);
T.setValue(S);
}this.fireDataEvent(i,this.getValue());
},isEmpty:function(){var d=this.getChildControl(p).getValue();
return d==null||d==m;
}}});
})();
...
(function(){var J="selected",I="click",H="last-month-button",G="default",F="next-month-button",E="otherMonth",D="month-year-label",C="last-year-button",B="navigation-bar",A="next-year-button",bO="date-pane",bN="PageUp",bM="mousedown",bL="today",bK="Integer",bJ="PageDown",bI="changeLocale",bH="next-month-button-tooltip",bG="last-month-button-tooltip",bF="qx.dynlocale",Q="last-year-button-tooltip",R="next-year-button-tooltip",O="on",P="weekend",M="day",N="lastMonth",K="Next month",L="Escape",Y="Left",ba="__nq",bl="weekday",bi="changeValue",bt="Space",bo="Down",bB="qx.ui.control.DateChooser",by="Date",be="qx.event.type.Data",bE="dblclick",bD="day#",bC="Next year",bd="ww",bg="_applyValue",bh="Up",bk="__nr",bm="weekday#",bp="datechooser",bv="header",bA="week",S="lastYear",T="",bf="__ns",bs="nextYear",br="changeDate",bq="changeShownYear",bx="week#",bw="Please use getValue instead.",bn="Last month",bu="Right",v="Last year",bz="Please use setValue instead.",U="EE",V="mouseup",bj="keypress",w="Please use initValue instead.",z="Please use resetValue instead.",bc="Enter",W="nextMonth",X="week#0",bb="changeShownMonth";
qx.Class.define(bB,{extend:qx.ui.core.Widget,include:[qx.ui.core.MExecutable,qx.ui.form.MForm,qx.ui.form.MFormElement],implement:[qx.ui.form.IFormElement,qx.ui.form.IExecutable,qx.ui.form.IForm,qx.ui.form.IDateForm],construct:function(s){arguments.callee.base.call(this);
...
if(qx.core.Variant.isSet(bF,O)){qx.locale.Manager.getInstance().addListener(bI,this._updateDatePane,this);
}this.addListener(bM,this._onMouseUpDown,this);
this.addListener(V,this._onMouseUpDown,this);
},statics:{MONTH_YEAR_FORMAT:qx.locale.Date.getDateTimeFormat("yyyyMMMM","MMMM yyyy")},events:{changeDate:be},properties:{appearance:{refine:true,init:bp},width:{refine:true,init:200},height:{refine:true,init:150},shownMonth:{check:bK,init:null,nullable:true,event:bb},shownYear:{check:bK,init:null,nullable:true,event:bq},value:{check:by,init:null,nullable:true,event:bi,apply:bg}},members:{__nq:null,__nr:null,__ns:null,_forwardStates:{invalid:true},_createChildControlImpl:function(c){var d;

switch(c){case B:d=new qx.ui.container.Composite(new qx.ui.layout.HBox());
d.add(this.getChildControl(C));
d.add(this.getChildControl(H));
d.add(this.getChildControl(D),{flex:1});
d.add(this.getChildControl(F));
d.add(this.getChildControl(A));
this._add(d);
break;
case Q:d=new qx.ui.tooltip.ToolTip(this.tr(v));
break;
case C:d=new qx.ui.form.Button();
d.addState(S);
d.setFocusable(false);
d.setToolTip(this.getChildControl(Q));
d.addListener(I,this._onNavButtonClicked,this);
break;
case bG:d=new qx.ui.tooltip.ToolTip(this.tr(bn));
break;
case H:d=new qx.ui.toolbar.Button();
d.addState(N);
d.setFocusable(false);
d.setToolTip(this.getChildControl(bG));
d.addListener(I,this._onNavButtonClicked,this);
break;
case bH:d=new qx.ui.tooltip.ToolTip(this.tr(K));
break;
case F:d=new qx.ui.toolbar.Button();
d.addState(W);
d.setFocusable(false);
d.setToolTip(this.getChildControl(bH));
d.addListener(I,this._onNavButtonClicked,this);
break;
case R:d=new qx.ui.tooltip.ToolTip(this.tr(bC));
break;
case A:d=new qx.ui.toolbar.Button();
d.addState(bs);
d.setFocusable(false);
d.setToolTip(this.getChildControl(R));
d.addListener(I,this._onNavButtonClicked,this);
break;
case D:d=new qx.ui.basic.Label();
d.setAllowGrowX(true);
d.setAnonymous(true);
break;
case bA:d=new qx.ui.basic.Label();
d.setAllowGrowX(true);
d.setAllowGrowY(true);
d.setSelectable(false);
d.setAnonymous(true);
d.setCursor(G);
break;
case bl:d=new qx.ui.basic.Label();
d.setAllowGrowX(true);
d.setAllowGrowY(true);
d.setSelectable(false);
d.setAnonymous(true);
d.setCursor(G);
break;
case M:d=new qx.ui.basic.Label();
d.setAllowGrowX(true);
d.setAllowGrowY(true);
d.setCursor(G);
d.addListener(bM,this._onDayClicked,this);
d.addListener(bE,this._onDayDblClicked,this);
break;
case bO:var f=new qx.ui.layout.Grid();
d=new qx.ui.container.Composite(f);

for(var i=0;i<8;i++){f.setColumnFlex(i,1);
}
for(var i=0;i<7;i++){f.setRowFlex(i,1);
}var g=this.getChildControl(X);
g.addState(bv);
d.add(g,{column:0,row:0});
this.__nq=[];

for(var i=0;i<7;i++){g=this.getChildControl(bm+i);
d.add(g,{column:i+1,row:0});
this.__nq.push(g);
}this.__nr=[];
this.__ns=[];

for(var y=0;y<6;y++){var g=this.getChildControl(bx+(y+1));
d.add(g,{column:0,row:y+1});
this.__ns.push(g);
for(var x=0;x<7;x++){var g=this.getChildControl(bD+((y*7)+x));
d.add(g,{column:x+1,row:y+1});
this.__nr.push(g);
}}this._add(d);
break;
}return d||arguments.callee.base.call(this,c);
},_applyValue:function(h,j){this.fireDataEvent(br,h);

if((h!=null)&&(this.getShownMonth()!=h.getMonth()||this.getShownYear()!=h.getFullYear())){this.showMonth(h.getMonth(),h.getFullYear());
}else{var l=(h==null)?-1:h.getDate();

for(var i=0;i<6*7;i++){var k=this.__nr[i];

if(k.hasState(E)){if(k.hasState(J)){k.removeState(J);
}}else{var m=parseInt(k.getValue());

if(m==l){k.addState(J);
}else if(k.hasState(J)){k.removeState(J);
}}}}},_onMouseUpDown:function(e){var cx=e.getTarget();

if(cx==this.getChildControl(B)||cx==this.getChildControl(bO)){e.stopPropagation();
return;
}},_onNavButtonClicked:function(bR){var bT=this.getShownYear();
var bS=this.getShownMonth();

switch(bR.getCurrentTarget()){case this.getChildControl(C):bT--;
break;
case this.getChildControl(H):bS--;
...
case this.getChildControl(A):bT++;
break;
}this.showMonth(bS,bT);
},_onDayClicked:function(a){var b=a.getCurrentTarget().dateTime;
this.setValue(new Date(b));
},_onDayDblClicked:function(){this.execute();
},_onKeyPress:function(n){var r=null;
var p=null;
var q=null;

if(n.getModifiers()==0){switch(n.getKeyIdentifier()){case Y:r=-1;
break;
case bu:r=1;
break;
case bh:r=-7;
...
case bJ:p=1;
break;
case L:if(this.getValue()!=null){this.setValue(null);
return true;
}break;
case bc:case bt:if(this.getValue()!=null){this.execute();
}return;
}}else if(n.isShiftPressed()){switch(n.getKeyIdentifier()){case bN:q=-1;
break;
case bJ:q=1;
break;
}}
...
}},showMonth:function(bP,bQ){if((bP!=null&&bP!=this.getShownMonth())||(bQ!=null&&bQ!=this.getShownYear())){if(bP!=null){this.setShownMonth(bP);
}
if(bQ!=null){this.setShownYear(bQ);
}this._updateDatePane();
}},handleKeyPress:function(e){this._onKeyPress(e);
},_updateDatePane:function(){var ck=qx.ui.control.DateChooser;
var ch=new Date();
var ca=ch.getFullYear();
var cf=ch.getMonth();
var cd=ch.getDate();
var cl=this.getValue();
var co=(cl==null)?-1:cl.getFullYear();
var cv=(cl==null)?-1:cl.getMonth();
var ci=(cl==null)?-1:cl.getDate();
var ce=this.getShownMonth();
var cs=this.getShownYear();
var cb=qx.locale.Date.getWeekStart();
var cm=new Date(this.getShownYear(),this.getShownMonth(),1);
var cj=new qx.util.format.DateFormat(ck.MONTH_YEAR_FORMAT);
this.getChildControl(D).setValue(cj.format(cm));
var cu=cm.getDay();
var cg=1+((7-cu)%7);
var cn=new qx.util.format.DateFormat(U);

for(var i=0;i<7;i++){var cp=(i+cb)%7;
var cr=this.__nq[i];
cm.setDate(cg+cp);
cr.setValue(cn.format(cm));

if(qx.locale.Date.isWeekend(cp)){cr.addState(P);
}else{cr.removeState(P);
}}cm=new Date(cs,ce,1,12,0,0);
var bV=(7+cu-cb)%7;
cm.setDate(cm.getDate()-bV);
var cq=new qx.util.format.DateFormat(bd);

for(var bU=0;bU<6;bU++){this.__ns[bU].setValue(cq.format(cm));

for(var i=0;i<7;i++){var cr=this.__nr[bU*7+i];
var bY=cm.getFullYear();
var bX=cm.getMonth();
var cc=cm.getDate();
var bW=(co==bY&&cv==bX&&ci==cc);

if(bW){cr.addState(J);
}else{cr.removeState(J);
}
if(bX!=ce){cr.addState(E);
}else{cr.removeState(E);
}var ct=(bY==ca&&bX==cf&&cc==cd);

if(ct){cr.addState(bL);
}else{cr.removeState(bL);
}cr.setValue(T+cc);
cr.dateTime=cm.getTime();
cm.setDate(cm.getDate()+1);
}}cj.dispose();
cn.dispose();
cq.dispose();
},setDate:function(cw){qx.log.Logger.deprecatedMethodWarning(arguments.callee,bz);
this.setValue(cw);
},getDate:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,bw);
return this.getValue();
},resetDate:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,z);
this.resetValue();
},initDate:function(){qx.log.Logger.deprecatedMethodWarning(arguments.callee,w);
this.initValue();
}},destruct:function(){if(qx.core.Variant.isSet(bF,O)){qx.locale.Manager.getInstance().removeListener(bI,this._updateDatePane,this);
}this._disposeFields(ba,bk,bf);
}});
})();
...
(function(){var t="Unidentified",s="+",r="short",q="keydown",p="Control",o="",n="-",m="__qp",l="PageUp",k="Escape",bb="Boolean",ba="qx.event.type.Data",Y="_applyShortcut",X="PrintScreen",W="NumLock",V="5",U="8",T="__qo",S="execute",R="Meta",A="0",B="PageDown",y="Shift",z="You can only specify one non modifier key!",w="3",x="/",u="Delete",v="String",C="changeEnabled",D="*",J="Not a valid key name for a command: ",I="6",L="4",K="Alt",N="2",M="Whitespaces are not allowed within shortcuts",F="_applyEnabled",Q="1",P="7",O="qx.event.Command",E="a",G="z",H="9";
qx.Class.define(O,{extend:qx.core.Object,construct:function(f){arguments.callee.base.call(this);
this.__qo={};
this.__qp=null;
...
this.initEnabled();
},events:{"execute":ba},properties:{enabled:{init:true,check:bb,event:C,apply:F},shortcut:{check:v,apply:Y,nullable:true}},members:{__qo:o,__qp:o,execute:function(bc){this.fireDataEvent(S,bc);
},__qq:function(event){if(this.getEnabled()&&this.matchesKeyEvent(event)){this.execute(event.getTarget());
event.preventDefault();
event.stopPropagation();
}},_applyEnabled:function(g,h){if(g){qx.event.Registration.addListener(document.documentElement,q,this.__qq,this);
}else{qx.event.Registration.removeListener(document.documentElement,q,this.__qq,this);
}},_applyShortcut:function(bg,bh){if(bg){if(bg.search(/[\s]+/)!=-1){var bk=M;
this.error(bk);
throw bk;
}this.__qo={"Control":false,"Shift":false,"Meta":false,"Alt":false};
this.__qp=null;
var bi;
var a=[];
...
for(var i=0;i<bj;i++){var bl=this.__qs(a[i]);

switch(bl){case p:case y:case R:case K:this.__qo[bl]=true;
break;
case t:var bk=J+a[i];
this.error(bk);
throw bk;
default:if(this.__qp){var bk=z;
this.error(bk);
throw bk;
}this.__qp=bl;
}}}return true;
},matchesKeyEvent:function(e){var j=this.__qp;
...
if(j==e.getKeyIdentifier()){return true;
}return false;
},__qr:{esc:k,ctrl:p,print:X,del:u,pageup:l,pagedown:B,numlock:W,numpad_0:A,numpad_1:Q,numpad_2:N,numpad_3:w,numpad_4:L,numpad_5:V,numpad_6:I,numpad_7:P,numpad_8:U,numpad_9:H,numpad_divide:x,numpad_multiply:D,numpad_minus:n,numpad_plus:s},__qs:function(bd){var be=qx.event.handler.Keyboard;
var bf=t;

if(be.isValidKeyIdentifier(bd)){return bd;
}
if(bd.length==1&&bd>=E&&bd<=G){return bd.toUpperCase();
}bd=bd.toLowerCase();
var bf=this.__qr[bd]||qx.lang.String.firstUp(bd);

if(be.isValidKeyIdentifier(bf)){return bf;
}else{return t;
}},toString:function(){var d=this.__qp;
var c=[];

for(var b in this.__qo){if(this.__qo[b]){c.push(qx.locale.Key.getKeyName(r,b));
}}
if(d){c.push(qx.locale.Key.getKeyName(r,d));
}return c.join(s);
}},destruct:function(){this.setEnabled(false);
this._disposeFields(T,m);
}});
})();
...
qx.Class.define(bx,{statics:{getKeyName:function(bO,bP,bQ){{};
var bS=v+bO+A+bP;
var bR=qx.locale.Manager.getInstance().translate(bS,[],bQ);

if(bR==bS){return qx.locale.Key._keyNames[bS]||bP;
}else{return bR;
}}},defer:function(bT,bU,bV){var bX={};
...
(function(){var v="current-preview",u="execute",t="selected-preview",s="Number",r="preview-pane",q="selector-button",p="colorselector-cancelbutton",o="auto-button",n="colorselector-okbutton",m="mousedown",bj="teal",bi="maroon",bh="qx.ui.control.ColorPopup",bg="#666",bf="changeValue",be="#333",bd="__wk",bc="#000",bb="__wl",ba="yellow",C="changeGreen",D="colorpopup",A="_applyValue",B="blue",y="changeRed",z="field#",w="__wm",x="#CCC",F="Color Selector",G="changeVisibility",N="recent",L="changeBlue",R="mouseover",P="_tables",V="Cancel",T="#FFF",I="right",Y="Open ColorSelector",X="mouseout",W="#999",H="Automatic",J="Basic Colors",K="Preview (Old/New)",M="visible",O="Recent Colors",Q="OK",S="field",U="green",E="red";
...
this._createChildControl(r);
this._createChildControl(q);
this.addListener(G,this._onChangeVisibility,this);
},properties:{appearance:{refine:true,init:D},value:{nullable:true,apply:A,event:bf},red:{check:s,init:null,nullable:true,event:y},green:{check:s,init:null,nullable:true,event:C},blue:{check:s,init:null,nullable:true,event:L}},members:{__wj:1e5,__wk:null,__wl:null,__wm:null,__wn:N,__wo:12,_createChildControlImpl:function(br){var bs;

switch(br){case S:bs=new qx.ui.core.Widget;
bs.addListener(m,this._onFieldMouseDown,this);
bs.addListener(R,this._onFieldMouseOver,this);
bs.addListener(X,this._onFieldMouseOut,this);
break;
case o:bs=new qx.ui.form.Button(this.tr(H));
bs.setAllowStretchX(true);
bs.addListener(u,this._onAutomaticBtnExecute,this);
this.add(bs);
break;
case q:bs=new qx.ui.form.Button(this.tr(Y));
bs.addListener(u,this._onSelectorButtonExecute,this);
this.add(bs);
break;
case r:bs=new qx.ui.groupbox.GroupBox(this.tr(K));
bs.setLayout(new qx.ui.layout.HBox);
bs.add(this._createChildControl(t,true),{flex:1});
bs.add(this._createChildControl(v,true),{flex:1});
this.add(bs);
break;
case t:bs=new qx.ui.container.Composite(new qx.ui.layout.Basic);
break;
case v:bs=new qx.ui.container.Composite(new qx.ui.layout.Basic);
break;
case n:bs=new qx.ui.form.Button(this.tr(Q));
bs.addListener(u,this._onColorSelectorOk,this);
break;
case p:bs=new qx.ui.form.Button(this.tr(V));
bs.addListener(u,this._onColorSelectorCancel,this);
break;
}return bs||arguments.callee.base.call(this,br);
},_createBoxes:function(){this.__wk={};
var g=this._tables;
var l,f,h;
var j=0;

for(var k in g){l=g[k];
f=new qx.ui.groupbox.GroupBox(l.label);
f.setLayout(new qx.ui.layout.HBox);
this.__wk[k]=f;
this.add(f);

for(var i=0;i<this.__wo;i++){h=this.getChildControl(z+(j++));
h.setBackgroundColor(l.values[i]||null);
f.add(h);
}}},_createColorSelector:function(){if(this.__wm){return;
}var bC=new qx.ui.window.Window(this.tr(F));
this.__wl=bC;
bC.setLayout(new qx.ui.layout.VBox(16));
bC.setResizable(false);
bC.moveTo(20,20);
this.__wm=new qx.ui.control.ColorSelector;
bC.add(this.__wm);
var bD=new qx.ui.container.Composite(new qx.ui.layout.HBox(8,I));
bC.add(bD);
var bF=this._createChildControl(p);
var bE=this._createChildControl(n);
bD.add(bF);
bD.add(bE);
},_applyValue:function(bo,bp){if(bo===null){this.setRed(null);
this.setGreen(null);
this.setBlue(null);
}else{var bq=qx.util.ColorUtil.stringToRgb(bo);
this.setRed(bq[0]);
this.setGreen(bq[1]);
this.setBlue(bq[2]);
}this.getChildControl(t).setBackgroundColor(bo);
this._rotatePreviousColors();
},_rotatePreviousColors:function(){if(!this._tables){return;
}var bv=this._tables[this.__wn].values;
var bw=this.__wk[this.__wn];
...
}else if(bv.length==this.__wo){bv.shift();
}bv.push(bx);
var bt=bw.getChildren();

for(var i=0;i<bt.length;i++){bt[i].setBackgroundColor(bv[i]||null);
}},_onFieldMouseDown:function(e){var bG=this.getChildControl(v).getBackgroundColor();
this.setValue(bG);

if(bG){this.hide();
}},_onFieldMouseOver:function(e){this.getChildControl(v).setBackgroundColor(e.getTarget().getBackgroundColor());
},_onFieldMouseOut:function(e){var bn=this.getRed();
var bm=this.getGreen();
var bk=this.getBlue();
var bl=null;

if(bn!==null||bm!==null||bk!==null){var bl=qx.util.ColorUtil.rgbToRgbString([bn,bm,bk]);
}this.getChildControl(v).setBackgroundColor(bl);
...
if(d===null||c===null||b===null){d=255;
c=255;
b=255;
}this.__wm.setRed(d);
this.__wm.setGreen(c);
this.__wm.setBlue(b);
this.__wl.open();
},_onColorSelectorOk:function(e){var a=this.__wm;
this.setValue(qx.util.ColorUtil.rgbToRgbString([a.getRed(),a.getGreen(),a.getBlue()]));
this.__wl.close();
},_onColorSelectorCancel:function(e){this.__wl.close();
},_onChangeVisibility:function(e){if(this.getVisibility()==M){var bB=this.getRed();
var bA=this.getGreen();
var by=this.getBlue();
var bz=null;

if(bB!==null||bA!==null||by!==null){var bz=qx.util.ColorUtil.rgbToRgbString([bB,bA,by]);
}this.getChildControl(t).setBackgroundColor(bz);
this.getChildControl(v).setBackgroundColor(bz);
}},_tables:{core:{label:J,values:[bc,be,bg,W,x,T,E,U,B,ba,bj,bi]},recent:{label:O,values:[]}}},destruct:function(){this._disposeObjects(bb,w);
this._disposeFields(P,bd);
}});
})();
...
(function(){var cs="brightness-handle",cr="hue-saturation-handle",cq="hsbSpinner",cp="rgbSpinner",co="changeValue",cn="hexField",cm="hueSaturationField",cl="brightness-field",ck="mousedown",cj="rgb-spinner-red",bX="preview-content-old",bW="rgb-spinner-green",bV="brightnessField",bU="hue-saturation-field",bT="hsb-spinner-brightness",bS="preview-content-new",bR="hue-saturation-pane",bQ="rgb-spinner-blue",bP="hsb-spinner-hue",bO="hsb-spinner-saturation",cz="hex-field",cA="brightnessModifier",cx="blueModifier",cy="saturationModifier",cv="middle",cw="mouseup",ct="Number",cu="#",cB="redModifier",cC="greenModifier",cc="hueModifier",cb="Integer",ce="brightness-pane",cd="control-pane",cg="preset-grid",cf="preset-field-set",ci="qx.event.type.Event",ch="mousemove",ca="hex-field-composite",bY="rgb-spinner-composite",Y="hsb-spinner-composite",ba="control-bar",bb="visual-pane",bc="input-field-set",bd="preview-field-set",be="black",bf="_applyGreen",bg="#333",bh="aqua",bi="colorbucket",cG="qx.event.type.Data",cF="Hex",cE="#BBB",cD="decoration/colorselector/brightness-handle.gif",cK="Visual",cJ="_applySaturation",cI="Preview (Old/New)",cH="FFFFFF",cM="decoration/colorselector/brightness-field.png",cL="white",by="orange",bz="_applyRed",bw="_applyBlue",bx="maroon",bC="Presets",bD="_applyBrightness",bA="#999",bB="purple",bu="red",bv="mousewheel",bq="blue",bp="_applyHue",bs="decoration/colorselector/huesaturation-handle.gif",br="colorselector",bm="qx.ui.control.ColorSelector",bl="lime",bo="#EEE",bn="olive",bk="RGB",bj="decoration/colorselector/huesaturation-field.jpg",bI="navy",bJ="teal",bK="green",bL="yellow",bE="#666",bF="fuchsia",bG="Details",bH="",bM="colorbucket#",bN="appear",bt="HSB";
...
},events:{"dialogok":ci,"dialogcancel":ci,"changeValue":cG},properties:{appearance:{refine:true,init:br},red:{check:cb,init:255,apply:bz},green:{check:cb,init:255,apply:bf},blue:{check:cb,init:255,apply:bw},hue:{check:ct,init:0,apply:bp},saturation:{check:ct,init:0,apply:cJ},brightness:{check:ct,init:100,apply:bD}},members:{__wp:null,__wq:[bx,bu,by,bL,bn,bB,bF,bl,bK,bI,bq,bh,bJ,be,bg,bE,bA,cE,bo,cL],__wr:bH,__ws:0,__wt:0,__wu:0,__wv:true,__ww:false,_createChildControlImpl:function(u){var v;

switch(u){case ba:v=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
v.add(this.getChildControl(cd));
v.add(this.getChildControl(bb));
this._add(v);
break;
case bb:v=new qx.ui.groupbox.GroupBox(this.tr(cK));
v.setLayout(new qx.ui.layout.HBox(10));
v.add(this.getChildControl(bR));
v.add(this.getChildControl(ce));
break;
case cd:v=new qx.ui.container.Composite(new qx.ui.layout.VBox(12));
v.add(this.getChildControl(cf));
v.add(this.getChildControl(bc));
v.add(this.getChildControl(bd),{flex:1});
break;
case bR:v=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
v.setAllowGrowY(false);
v.addListener(cw,this._onHueSaturationPaneMouseWheel,this);
v.add(this.getChildControl(bU));
v.add(this.getChildControl(cr),{left:0,top:256});
break;
case bU:v=new qx.ui.basic.Image(bj);
v.addListener(ck,this._onHueSaturationFieldMouseDown,this);
break;
case cr:v=new qx.ui.basic.Image(bs);
v.addListener(ck,this._onHueSaturationFieldMouseDown,this);
v.addListener(cw,this._onHueSaturationHandleMouseUp,this);
v.addListener(ch,this._onHueSaturationHandleMouseMove,this);
break;
case ce:v=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
v.setAllowGrowY(false);
v.addListener(bv,this._onBrightnessPaneMouseWheel,this);
v.add(this.getChildControl(cl));
v.add(this.getChildControl(cs));
break;
case cl:v=new qx.ui.basic.Image(cM);
v.addListener(ck,this._onBrightnessFieldMouseDown,this);
break;
case cs:v=new qx.ui.basic.Image(cD);
v.addListener(ck,this._onBrightnessHandleMouseDown,this);
v.addListener(cw,this._onBrightnessHandleMouseUp,this);
v.addListener(ch,this._onBrightnessHandleMouseMove,this);
break;
case cf:v=new qx.ui.groupbox.GroupBox(this.tr(bC));
v.setLayout(new qx.ui.layout.Grow());
v.add(this.getChildControl(cg));
break;
case bi:v=new qx.ui.core.Widget();
v.addListener(ck,this._onColorFieldClick,this);
break;
case cg:A=new qx.ui.layout.Grid(3,3);
v=new qx.ui.container.Composite(A);
var B;
var z;

for(var i=0;i<2;i++){for(var j=0;j<10;j++){z=i*10+j;
B=this.getChildControl(bM+z);
B.setBackgroundColor(this.__wq[z]);
v.add(B,{column:j,row:i});
}}break;
case bc:v=new qx.ui.groupbox.GroupBox(this.tr(bG));
var A=new qx.ui.layout.VBox();
A.setSpacing(10);
v.setLayout(A);
v.add(this.getChildControl(ca));
v.add(this.getChildControl(bY));
v.add(this.getChildControl(Y));
break;
case bd:v=new qx.ui.groupbox.GroupBox(this.tr(cI));
var A=new qx.ui.layout.HBox(10);
v.setLayout(A);
v.add(this.getChildControl(bX),{flex:1});
v.add(this.getChildControl(bS),{flex:1});
break;
case ca:var y=new qx.ui.layout.HBox(4);
y.setAlignY(cv);
v=new qx.ui.container.Composite(y);
var D=new qx.ui.basic.Label(this.tr(cF));
v.add(D);
var C=new qx.ui.basic.Label(cu);
v.add(C);
v.add(this.getChildControl(cz));
break;
case cz:v=new qx.ui.form.TextField(cH);
v.setMaxLength(6);
v.setFilter(/[0-9A-Fa-f]/);
v.setWidth(55);
v.addListener(co,this._onHexFieldChange,this);
break;
case bY:var y=new qx.ui.layout.HBox(4);
y.setAlignY(cv);
v=new qx.ui.container.Composite(y);
var w=new qx.ui.basic.Label(this.tr(bk));
w.setWidth(25);
v.add(w);
v.add(this.getChildControl(cj));
v.add(this.getChildControl(bW));
v.add(this.getChildControl(bQ));
break;
case cj:v=new qx.ui.form.Spinner(0,255,255);
v.setWidth(50);
v.addListener(co,this._setRedFromSpinner,this);
break;
case bW:v=new qx.ui.form.Spinner(0,255,255);
v.setWidth(50);
v.addListener(co,this._setGreenFromSpinner,this);
break;
case bQ:v=new qx.ui.form.Spinner(0,255,255);
v.setWidth(50);
v.addListener(co,this._setBlueFromSpinner,this);
break;
case Y:var y=new qx.ui.layout.HBox(4);
y.setAlignY(cv);
v=new qx.ui.container.Composite(y);
var x=new qx.ui.basic.Label(this.tr(bt));
x.setWidth(25);
v.add(x);
v.add(this.getChildControl(bP));
v.add(this.getChildControl(bO));
v.add(this.getChildControl(bT));
break;
case bP:v=new qx.ui.form.Spinner(0,0,360);
v.setWidth(50);
v.addListener(co,this._setHueFromSpinner,this);
break;
case bO:v=new qx.ui.form.Spinner(0,0,100);
v.setWidth(50);
v.addListener(co,this._setSaturationFromSpinner,this);
break;
case bT:v=new qx.ui.form.Spinner(0,100,100);
v.setWidth(50);
v.addListener(co,this._setBrightnessFromSpinner,this);
break;
case bX:v=new qx.ui.core.Widget();
break;
case bS:v=new qx.ui.core.Widget();
break;
}return v||arguments.callee.base.call(this,u);
},setValue:function(L){var M;

if(L==null){this.__wv=true;
M=[255,255,255];
...
this.__ww=false;
this.setBlue(M[2]);
},getValue:function(){return this.__wv?null:cu+qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);
},resetValue:function(){this.__wv=true;
this.__ww=true;
this.setRed(255);
this.setGreen(255);
this.__ww=false;
this.setBlue(255);
},__wx:function(){if(!this.__ww){this.__wv=false;
this.fireDataEvent(co,this.getValue());
}},_applyRed:function(O,P){if(this.__wp===null){this.__wp=cB;
}
if(this.__wp!==cp){this.getChildControl(cj).setValue(O);
}
if(this.__wp!==cn){this._setHexFromRgb();
}
switch(this.__wp){case cp:case cn:case cB:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__wx();

if(this.__wp===cB){this.__wp=null;
}},_applyGreen:function(h,k){if(this.__wp===null){this.__wp=cC;
}
if(this.__wp!==cp){this.getChildControl(bW).setValue(h);
}
if(this.__wp!==cn){this._setHexFromRgb();
}
switch(this.__wp){case cp:case cn:case cC:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__wx();

if(this.__wp===cC){this.__wp=null;
}},_applyBlue:function(o,p){if(this.__wp===null){this.__wp=cx;
}
if(this.__wp!==cp){this.getChildControl(bQ).setValue(o);
}
if(this.__wp!==cn){this._setHexFromRgb();
}
switch(this.__wp){case cp:case cn:case cx:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__wx();

if(this.__wp===cx){this.__wp=null;
}},_applyHue:function(I,J){if(this.__wp===null){this.__wp=cc;
}
if(this.__wp!==cq){this.getChildControl(bP).setValue(I);
}
if(this.__wp!==cm){if(this.getChildControl(cr).getBounds()){this.getChildControl(cr).setDomLeft(Math.round(I/1.40625)+this.getChildControl(bR).getPaddingLeft());
}else{this.getChildControl(cr).setLayoutProperties({left:Math.round(I/1.40625)});
}}
switch(this.__wp){case cq:case cm:case cc:this._setRgbFromHue();
}this._setBrightnessGradiant();

if(this.__wp===cc){this.__wp=null;
}},_applySaturation:function(E,F){if(this.__wp===null){this.__wp=cy;
}
if(this.__wp!==cq){this.getChildControl(bO).setValue(E);
}
if(this.__wp!==cm){this._setBrightnessGradiant();

if(this.getChildControl(cr).getBounds()){this.getChildControl(cr).setDomTop(256-Math.round(E*2.56)+this.getChildControl(bR).getPaddingTop());
}else{this.getChildControl(cr).setLayoutProperties({top:256-Math.round(E*2.56)});
}}
switch(this.__wp){case cq:case cm:case cy:this._setRgbFromHue();
}
if(this.__wp===cy){this.__wp=null;
}},_applyBrightness:function(b,c){if(this.__wp===null){this.__wp=cA;
}
if(this.__wp!==cq){this.getChildControl(bT).setValue(b);
}
if(this.__wp!==bV){var d=256-Math.round(b*2.56);

if(this.getChildControl(cs).getBounds()){this.getChildControl(cs).setDomTop(d+this.getChildControl(ce).getPaddingTop());
}else{this.getChildControl(cs).setLayoutProperties({top:d});
}}
switch(this.__wp){case cq:case bV:case cA:this._setRgbFromHue();
}
if(this.__wp===cA){this.__wp=null;
}},_onBrightnessHandleMouseDown:function(e){this.getChildControl(cs).capture();
this.__wr=cs;
var S=this.getChildControl(cl).getContainerLocation();
var R=this.getChildControl(cs).getContainerLocation();
var Q=this.getChildControl(cl).getBounds();
this.__ws=S.top+(e.getDocumentTop()-R.top)-Q.top;
e.stopPropagation();
},_onBrightnessHandleMouseUp:function(e){this.getChildControl(cs).releaseCapture();
this.__wr=null;
},_onBrightnessHandleMouseMove:function(e){if(this.__wr===cs){this._setBrightnessOnFieldEvent(e);
}},_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(cl).getContainerLocation();
var U=this.getChildControl(cs).getBounds();
this.__ws=location.top+(U.height/2);
...
},_setBrightnessOnFieldEvent:function(e){var K=qx.lang.Number.limit(e.getDocumentTop()-this.__ws,0,256);
this.__wp=bV;

if(this.getChildControl(cs).getBounds()){this.getChildControl(cs).setDomTop(K);
}else{this.getChildControl(cs).setLayoutProperties({top:K});
}this.setBrightness(100-Math.round(K/2.56));
this.__wp=null;
},_onHueSaturationHandleMouseUp:function(e){this.getChildControl(cr).releaseCapture();
this.__wr=null;
},_onHueSaturationHandleMouseMove:function(e){if(this.__wr===cr){this._setHueSaturationOnFieldEvent(e);
}},_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(bU).getContainerLocation();
var G=this.getChildControl(cr).getBounds();
var H=this.getChildControl(bU).getBounds();
this.__wt=location.top+(G.height/2)-H.top;
this.__wu=location.left+(G.width/2)-H.left;
...
},_setHueSaturationOnFieldEvent:function(e){var g=qx.lang.Number.limit(e.getDocumentTop()-this.__wt,0,256);
var f=qx.lang.Number.limit(e.getDocumentLeft()-this.__wu,0,256);
this.getChildControl(cr).setDomPosition(f,g);
this.__wp=cm;
this.setSaturation(100-Math.round(g/2.56));
this.setHue(Math.round(f*1.40625));
this.__wp=null;
},_setRedFromSpinner:function(){if(this.__wp!==null){return;
}this.__wp=cp;
this.setRed(this.getChildControl(cj).getValue());
this.__wp=null;
},_setGreenFromSpinner:function(){if(this.__wp!==null){return;
}this.__wp=cp;
this.setGreen(this.getChildControl(bW).getValue());
this.__wp=null;
},_setBlueFromSpinner:function(){if(this.__wp!==null){return;
}this.__wp=cp;
this.setBlue(this.getChildControl(bQ).getValue());
this.__wp=null;
},_setHueFromSpinner:function(){if(this.__wp!==null){return;
}this.__wp=cq;
this.setHue(this.getChildControl(bP).getValue());
this.__wp=null;
},_setSaturationFromSpinner:function(){if(this.__wp!==null){return;
}this.__wp=cq;
this.setSaturation(this.getChildControl(bO).getValue());
this.__wp=null;
},_setBrightnessFromSpinner:function(){if(this.__wp!==null){return;
}this.__wp=cq;
this.setBrightness(this.getChildControl(bT).getValue());
this.__wp=null;
},_onHexFieldChange:function(e){if(this.__wp!==null){return;
}
try{var m=this.getChildControl(cz);
var l=qx.util.ColorUtil.hexStringToRgb(cu+m.getValue());
}catch(cP){return;
}this.__wp=cn;
this.setRed(l[0]);
this.setGreen(l[1]);
...
this.getChildControl(cz).setValue(a);
},_onColorFieldClick:function(e){var cN=e.getTarget().getBackgroundColor();

if(!cN){return this.error("Missing backgroundColor value for field: "+e.getTarget());
}var cO=qx.util.ColorUtil.stringToRgb(cN);
this.setRed(cO[0]);
this.setGreen(cO[1]);
this.setBlue(cO[2]);
},_setHueFromRgb:function(){switch(this.__wp){case cq:case cm:case bV:break;
...
}},_setRgbFromHue:function(){switch(this.__wp){case cp:case cn:break;
default:var N=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);
this.setRed(N.red);
this.setGreen(N.green);
this.setBlue(N.blue);
}},_setPreviewFromRgb:function(){var cQ=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(bS).setBackgroundColor(cQ);
},setPreviousColor:function(q,r,s){var t=qx.util.ColorUtil.rgbToRgbString([q,r,s]);
this.getChildControl(bX).setBackgroundColor(t);
this.setRed(q);
this.setGreen(r);
this.setBlue(s);
},_setBrightnessGradiant:function(){var V=qx.util.ColorUtil;
var W=V.hsbToRgb([this.getHue(),this.getSaturation(),255]);
var X=V.rgbToRgbString([W.red,W.green,W.blue]);
this.getChildControl(cl).setBackgroundColor(X);
},_onAppear:function(e){var T=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(bX).setBackgroundColor(T);
this.getChildControl(bS).setBackgroundColor(T);
}}});
})();
