...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_Separator", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.VBox_Separator-qx.theme.Classic-0.js"]],
  boot : "boot",
...
a.add(this.getBox2());
a.add(this.getBox3());
},getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return k;
},getBox2:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,minWidth:60,allowGrowY:false});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:e}));
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
return j;
},getBox3:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,allowGrowY:false});
