...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Request", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.Request-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var h="Loading...",g="",f="content",e="GET",d="demobrowser.demo.bom.Request",c="Request.html";
qx.Class.define(d,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var a=document.getElementById(f);
a.value=h;
var b=new qx.bom.Request;
b.open(e,c,true);
b.onreadystatechange=function(){qx.log.Logger.debug("Event: readystatechange: "+b.readyState);

if(b.readyState==4){a.value=b.responseText;
}};
b.onload=function(){qx.log.Logger.debug("Event: load");
};
b.onerror=function(){qx.log.Logger.debug("Event: error");
};
b.ontimeout=function(){qx.log.Logger.debug("Event: timeout");
};
b.onabort=function(){qx.log.Logger.debug("Event: abort");
};
b.send(g);
}}});
})();
