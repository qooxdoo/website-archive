...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Tooltip", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.Tooltip-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var s="icon/16/actions/help-about.png",r="Tooltip text",q="icon/32/actions/help-about.png",p="Button #2 (Shared ToolTip)",o="Short timeout ToolTip",n="demobrowser.demo.widget.Tooltip",m="Hello World #3",l="Button with ToolTipText and ToolTipIcon",k="ToolTip with icon and label",j="Shared tool tip of button #",G="ToolTip with icon and rich text",F="Such a great tooltip with a (show) timeout of 50ms.",E="Icon only ToolTip",D="Button #1 (Shared ToolTip)",C="container",B="This also may contain <b style='color:red'>rich HTML</b> markup ",A="appear",z="2",y="Shared ToolTip",x="1",v="Button with ToolTipText",w="A long label text with auto-wrapping. ",t="Button with ToolTipIcon",u="and with a (show) timeout of 50ms.";
...
var K=new qx.ui.layout.Grid(10,10);
this.container=new qx.ui.container.Composite(K).set({padding:20});
L.add(this.container);
...
},__wh:4,__wi:0,add:function(f){this.container.add(f,{row:Math.floor(this.__wi/this.__wh),column:this.__wi%this.__wh});
this.__wi+=1;
},createSharedToolTip:function(){var c=new qx.ui.tooltip.ToolTip(y);
c.addListener(A,function(e){var N=j;

if(this.getOpener()==b){N+=x;
}else{N+=z;
}c.setLabel(N);
});
...
a.setToolTip(c);
this.add(a);
},createIconToolTip:function(){var M=new qx.ui.form.Button(E).set({toolTip:new qx.ui.tooltip.ToolTip(null,s)});
this.add(M);
},createToolTip:function(){var J=new qx.ui.form.Button(k).set({toolTip:new qx.ui.tooltip.ToolTip(m,s)});
this.add(J);
},createShortTimeoutToolTip:function(){var I=new qx.ui.tooltip.ToolTip(F,q);
I.setShowTimeout(50);
var H=new qx.ui.form.Button(o);
this.add(H);
H.setToolTip(I);
},createRichToolTip:function(){var h=new qx.ui.tooltip.ToolTip(w+B+u,q);
h.setWidth(200);
h.setRich(true);
h.setShowTimeout(50);
...
this.add(g);
g.setToolTip(h);
},createToolTipText:function(){var O=new qx.ui.form.Button(v).set({toolTipText:r});
this.add(O);
},createToolTipIcon:function(){var i=new qx.ui.form.Button(t).set({toolTipIcon:s});
this.add(i);
},createToolTipTextIcon:function(){var d=new qx.ui.form.Button(l).set({toolTipText:r,toolTipIcon:s});
this.add(d);
