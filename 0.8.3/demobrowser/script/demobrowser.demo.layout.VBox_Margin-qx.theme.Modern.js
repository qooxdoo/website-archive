...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_Margin", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.VBox_Margin-qx.theme.Modern-0.js"]],
  boot : "boot",
...
var s=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(s);
s.add(this.getBox1());
s.add(this.getBox2());
s.add(this.getBox3());
s.add(this.getBox4());
s.add(this.getBox5());
},getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
k.add(l);
k.add(j);
m.setAllowGrowX(false);
l.setAllowGrowX(false);
j.setAllowGrowX(false);
m.setMarginLeft(20);
j.setMarginRight(30);
return k;
},getBox2:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,allowGrowY:false});
...
var f=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
g.add(i);
g.add(h);
g.add(f);
i.setMarginLeft(20);
f.setMarginRight(30);
return g;
},getBox3:function(){var y=new qx.ui.layout.VBox();
...
A.add(B);
A.add(z);
C.setAllowGrowX(false);
B.setAllowGrowX(false);
z.setAllowGrowX(false);
C.setMarginLeft(20);
z.setMarginRight(30);
return A;
...
u.setMarginRight(20);
return v;
},getBox5:function(){var n=new qx.ui.layout.VBox();
var p=new qx.ui.container.Composite(n).set({decorator:e,backgroundColor:c,width:150,allowGrowY:false});
n.setSpacing(5);
n.setAlignX(b);
