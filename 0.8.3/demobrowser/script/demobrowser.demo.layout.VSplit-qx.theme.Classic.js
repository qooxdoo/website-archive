...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.VSplit-qx.theme.Classic-0.js"]],
  boot : "boot",
...
var O=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(O);
O.add(this.getSplitPaneTwoFlexSimple(),{left:0});
O.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
O.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
O.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
O.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
O.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
O.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
O.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
O.add(this.getSplitPaneAuto(),{top:550,left:630});
...
G.add(H,2);
return G;
},getSplitPaneTwoFlexWithOneMin:function(){var h=new qx.ui.splitpane.Pane(v);
h.setHeight(400);
h.setDecorator(u);
var g=new qx.ui.form.TextArea(s);
g.setDecorator(null);
g.setWrap(true);
g.setMinHeight(250);
h.add(g,1);
var i=new qx.ui.form.TextArea(q);
i.setDecorator(null);
i.setWrap(true);
h.add(i,2);
return h;
},getSplitPaneTwoFlexWithOneMax:function(){var A=new qx.ui.splitpane.Pane(v);
A.setHeight(400);
A.setDecorator(u);
var z=new qx.ui.form.TextArea(t);
z.setDecorator(null);
z.setWrap(true);
A.add(z,1);
var B=new qx.ui.form.TextArea(o);
B.setDecorator(null);
B.setWrap(true);
B.setMaxHeight(100);
A.add(B,2);
return A;
},getSplitPaneTwoFlexWithTwoMin:function(){var M=new qx.ui.splitpane.Pane(v);
M.setHeight(400);
M.setDecorator(u);
...
M.add(N,2);
return M;
},getSplitPaneTwoFlexWithTwoMax:function(){var e=new qx.ui.splitpane.Pane(v);
e.setHeight(400);
e.setDecorator(u);
var d=new qx.ui.form.TextArea(n);
d.setDecorator(null);
d.setWrap(true);
d.setMaxHeight(100);
e.add(d,1);
...
e.add(f,2);
return e;
},getSplitPaneOneFlexSimple:function(){var x=new qx.ui.splitpane.Pane(v);
x.setHeight(400);
x.setDecorator(u);
var w=new qx.ui.form.TextArea(p);
w.setDecorator(null);
w.setWrap(true);
x.add(w,0);
var y=new qx.ui.form.TextArea(t);
y.setDecorator(null);
y.setWrap(true);
x.add(y);
return x;
},getSplitPaneOneFlexSimpleWithMax:function(){var b=new qx.ui.splitpane.Pane(v);
b.setHeight(400);
b.setDecorator(u);
...
D.add(E);
return D;
},getSplitPaneAuto:function(){var J=new qx.ui.splitpane.Pane(v);
J.setDecorator(u);
var I=new qx.ui.form.TextArea(r);
I.setDecorator(null);
I.setWrap(true);
J.add(I,0);
var K=new qx.ui.form.TextArea(r);
K.setDecorator(null);
K.setWrap(true);
J.add(K);
return J;
