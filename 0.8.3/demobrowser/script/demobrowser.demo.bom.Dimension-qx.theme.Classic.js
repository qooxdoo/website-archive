...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.bom.Dimension-qx.theme.Classic-0.js"]],
  boot : "boot",
...
var o=qx.bom.element.Overflow;

for(var i=1;i<1000;i++){var l=document.getElementById(e+i);

if(!l){break;
}var n=g+i+d+m(l)+c+p(l);
this.debug(n);
}function m(j){var k=qx.bom.element.Dimension;
return k.getWidth(j)+h+k.getHeight(j);
}function p(a){var b=qx.bom.element.Dimension;
