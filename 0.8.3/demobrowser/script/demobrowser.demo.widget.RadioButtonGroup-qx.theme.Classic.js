...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.RadioButtonGroup", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.widget.RadioButtonGroup-qx.theme.Classic-0.js"]],
  boot : "boot",
...
r.setLayout(new qx.ui.layout.VBox(2));
this.addButtons(r,[g,f,c]);
this.getRoot().add(r,{left:100,top:10});
var w=new qx.ui.basic.Label(a);
w.setRich(true);
this.getRoot().add(w,{left:10,top:70});
var t=new qx.ui.form.RadioButtonGroup();
t.setLayout(new qx.ui.layout.HBox(5));
this.addButtons(t,[o,h]);
this.getRoot().add(t,{left:100,top:70});
var s=new qx.ui.basic.Label(n);
s.setRich(true);
this.getRoot().add(s,{left:10,top:100});
var v=new qx.ui.form.RadioButtonGroup();
v.setLayout(new qx.ui.layout.Grid(10,10));
v.add(new qx.ui.form.RadioButton(e),{row:0,column:1});
v.add(new qx.ui.form.RadioButton(k),{row:1,column:0});
v.add(new qx.ui.form.RadioButton(b),{row:1,column:1});
v.add(new qx.ui.form.RadioButton(d),{row:1,column:2});
v.add(new qx.ui.form.RadioButton(l),{row:2,column:1});
this.getRoot().add(v,{left:100,top:100});
},addButtons:function(p,q){for(var i=0;i<q.length;i++){p.add(new qx.ui.form.RadioButton(q[i]));
}}}});
})();
...
(function(){var q="Boolean",p="changeSelection",o="_applyValid",n="",m="changeRequired",l="changeValid",k="changeInvalidMessage",j="_applyInvalidMessage",h="String",g="qx.ui.form.RadioButtonGroup",f="qx.event.type.Data";
qx.Class.define(g,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(a){arguments.callee.base.call(this);
if(a==null){this.setLayout(new qx.ui.layout.VBox(4));
}else{this.setLayout(a);
}this.__wy=new qx.ui.form.RadioGroup();
this.__wy.addListener(p,function(e){this.fireDataEvent(p,e.getData(),e.getOldData());
},this);
},properties:{valid:{check:q,init:true,apply:o,event:l},required:{check:q,init:false,event:m},invalidMessage:{check:h,init:n,event:k,apply:j}},events:{"changeSelection":f},members:{__wy:null,_applyInvalidMessage:function(w,x){var y=this._getChildren();

for(var i=0;i<y.length;i++){y[i].setInvalidMessage(w);
}},_applyValid:function(r,s){var t=this._getChildren();

for(var i=0;i<t.length;i++){t[i].setValid(r);
}},getRadioGroup:function(){return this.__wy;
},getChildren:function(){return this._getChildren();
},add:function(c,d){this.__wy.add(c);
this._add(c,d);
},remove:function(b){this.__wy.remove(b);
this._remove(b);
},removeAll:function(){var v=this.__wy.getItems();

for(var i=0;i<v.length;i++){this.__wy.removeAll(v[i]);
}this._removeAll();
},getSelection:function(){return this.__wy.getSelection();
},setSelection:function(z){return this.__wy.setSelection(z);
},resetSelection:function(){return this.__wy.resetSelection();
},isSelected:function(u){return this.__wy.isSelected(u);
},isSelectionEmpty:function(){return this.__wy.isSelectionEmpty();
},getSelectables:function(){return this.__wy.getSelectables();
}}});
})();
