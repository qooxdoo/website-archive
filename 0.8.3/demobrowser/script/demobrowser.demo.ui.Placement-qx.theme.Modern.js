...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.Placement", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.ui.Placement-qx.theme.Modern-0.js"]],
  boot : "boot",
...
(function(){var t="mousedown",s="changeSelection",r="top-left",q="bottom-right",p="right-top",o="bottom-left",n="left-bottom",m="top-right",l="demobrowser.demo.ui.Placement",k="Open DOM-Popup",c="DOM Popup",j="Open Popup",g="Content",b="right-bottom",a="DOM align control",f="domanchor",d="__Bg",h="left-top";
qx.Class.define(l,{extend:qx.application.Standalone,members:{__Bg:null,main:function(){arguments.callee.base.call(this);
var B=this.getRoot();
this.__Bg=[o,q,r,m,p,b,h,n];
B.add(this.createTestField(o),{left:20,top:20});
B.add(this.createTestField(q),{right:20,top:20});
B.add(this.createTestField(r),{right:20,bottom:20});
B.add(this.createTestField(m),{left:20,bottom:20});
B.add(this.createTestField(p),{left:20,top:250});
B.add(this.createTestField(n),{right:20,top:250});
B.add(this.createDomClick(),{left:200,top:100});
...
for(var i=0;i<this.__Bg.length;i++){var x=new qx.ui.form.ListItem(this.__Bg[i]);
v.add(x);

if(this.__Bg[i]==u){z=x;
}}y.add(v);
v.addListener(s,function(e){w.setPosition(e.getData()[0].getLabel());
});
v.setSelection([z]);
var A=new qx.ui.form.Button(j);
y.add(A);
A.addListener(t,function(e){w.placeToWidget(A);
w.show();
});
return y;
},createDomClick:function(){var E=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var G=new qx.ui.basic.Label(a);
E.add(G);
var D=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
D.add(new qx.ui.basic.Atom(c));
D.setPadding(20);
var C=new qx.ui.form.SelectBox;

for(var i=0;i<this.__Bg.length;i++){C.add(new qx.ui.form.ListItem(this.__Bg[i]));
}E.add(C);
C.addListener(s,function(e){D.setPosition(e.getData()[0].getLabel());
});
var F=new qx.ui.form.Button(k);
E.add(F);
F.addListener(t,function(e){D.placeToElement(document.getElementById(f));
D.show();
});
return E;
