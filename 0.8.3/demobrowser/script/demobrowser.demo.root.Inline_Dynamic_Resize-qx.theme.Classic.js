...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.root.Inline_Dynamic_Resize", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.root.Inline_Dynamic_Resize-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var u="resize",t="relative",s="__ph",r="div",q="qx.ui.root.Inline",p="$$widget",o="hidden",n="left";
qx.Class.define(q,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(v,w,x){this.__ph=v;
v.style.overflow=o;
v.style.textAlign=n;
this.__pi=w||false;
this.__pj=x||false;
var y=qx.bom.element.Dimension.getSize(v);

if(w&&y.width<1){throw new Error("The root element "+v+" of "+this+" needs a width when its width size should be used!");
}
if(x&&y.height<1){throw new Error("The root element "+v+" of "+this+" needs a height when its height size should be used!");
}this.__pk();
arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.Basic());
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
},members:{__pi:false,__pj:false,__ph:null,__pk:function(){if(this.__pi||this.__pj){qx.event.Registration.addListener(this.__ph,u,this._onResize,this);
}},_createContainerElement:function(){var b=this.__ph;

if(this.__pi||this.__pj){var d=document.createElement(r);
b.appendChild(d);
b.style.position=t;
}else{d=b;
...
if((a.oldWidth!==a.width)&&this.__pi||(a.oldHeight!==a.height)&&this.__pj){qx.ui.core.queue.Layout.add(this);
}},_computeSizeHint:function(){var l=this.__pi;
var i=this.__pj;

if(!l||!i){var h=arguments.callee.base.call(this);
}else{h={};
}var m=qx.bom.element.Dimension;

if(l){var k=m.getContentWidth(this.__ph);
h.width=k;
h.minWidth=k;
h.maxWidth=k;
}
if(i){var j=m.getContentHeight(this.__ph);
h.height=j;
h.minHeight=j;
h.maxHeight=j;
}return h;
}},defer:function(f,g){qx.ui.core.MLayoutHandling.remap(g);
},destruct:function(){qx.event.Registration.removeListener(this.__ph,u,this._onResize,this);
