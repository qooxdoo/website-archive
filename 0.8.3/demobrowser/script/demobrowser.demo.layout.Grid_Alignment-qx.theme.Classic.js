...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Grid_Alignment", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.layout.Grid_Alignment-qx.theme.Classic-0.js"]],
  boot : "boot",
...
var t=new qx.ui.container.Composite(new qx.ui.layout.Grid(20)).set({padding:20});
scroll.add(t);
t.add(this.getCellAlignGrid(),{row:0,column:0});
t.add(this.getRowColumnAlignGrid(),{row:0,column:1});
t.add(this.getColumnAlignGrid(),{row:0,column:2});
t.add(this.getRowAlignGrid(),{row:1,column:0});
...
return a;
},getColumnAlignGrid:function(){var r=new qx.ui.container.Composite().set({decorator:n,backgroundColor:m,allowGrowX:false,allowGrowY:false});
var s=new qx.ui.layout.Grid();
s.setSpacing(3);
s.setColumnAlign(0,j,k);
s.setColumnAlign(1,g,f);
s.setColumnAlign(2,h,l);
r.setLayout(s);

for(var x=0;x<3;x++){for(var y=0;y<6;y++){r.add(this.getNewWidget(),{row:y,column:x});
}}return r;
},getRowAlignGrid:function(){var z=new qx.ui.container.Composite().set({decorator:n,backgroundColor:m,allowGrowX:false,allowGrowY:false});
...
for(var x=0;x<6;x++){for(var y=0;y<3;y++){z.add(this.getNewWidget(),{row:y,column:x});
}}return z;
},getCellAlignGrid:function(){var u=new qx.ui.container.Composite().set({decorator:n,backgroundColor:m,allowGrowX:false,allowGrowY:false});
var w=new qx.ui.layout.Grid();
w.setSpacing(3);
u.setLayout(w);

for(var x=0;x<5;x++){w.setColumnAlign(x,g,f);

for(var y=0;y<5;y++){u.add(this.getNewWidget(),{row:y,column:x});
}}var v=w.getCellWidget(0,0);
v.set({alignX:j,alignY:k});
v.set({backgroundColor:e,width:20,height:20});
var v=w.getCellWidget(4,4);
v.set({alignX:h,alignY:l});
v.set({backgroundColor:e,width:20,height:20});
return u;
