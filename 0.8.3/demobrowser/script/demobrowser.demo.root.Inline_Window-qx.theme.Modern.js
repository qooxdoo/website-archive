...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.root.Inline_Window", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.root.Inline_Window-qx.theme.Modern-0.js"]],
  boot : "boot",
...
var c=1;
a.addListener(n,function(e){var q=new qx.ui.window.Window(j+c++).set({width:200,height:150});
q.moveTo(c*15,c*15);
q.open();
});
d.add(a);
...
d.add(b);
},cModWin:1,newModalWindow:function(){var o=new qx.ui.window.Window(h+this.cModWin++).set({modal:true});
o.moveTo(300+this.cModWin*15,this.cModWin*15);
o.setLayout(new qx.ui.layout.HBox());
var p=new qx.ui.form.Button(m);
p.addListener(n,this.newModalWindow,this);
o.add(p);
o.open();
}}});
})();
