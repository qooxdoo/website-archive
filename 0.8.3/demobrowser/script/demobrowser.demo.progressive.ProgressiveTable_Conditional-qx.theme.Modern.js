...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.progressive.ProgressiveTable_Conditional", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.progressive.ProgressiveTable_Conditional-qx.theme.Modern-0.js"]],
  boot : "boot",
...
var U=new qx.ui.progressive.structure.Default(N,L);
var K=new qx.ui.progressive.Progressive(U);
var Q=new qx.ui.progressive.model.Default();
var P=O(100);
Q.addElements(P);
K.setDataModel(Q);
var T=new qx.ui.progressive.renderer.table.Row(R);
K.addRenderer(h,T);
...
qx.Class.define(c,{extend:qx.core.Object,construct:function(m){arguments.callee.base.call(this);
this.__yh=[];

for(var i=0;i<m;i++){this.__yh[i]=new qx.ui.core.ColumnData();
}},members:{__yh:null,getData:function(){return this.__yh;
},set:function(j,k){for(var l in k){switch(l){case a:this.setWidth(j,k[l]);
break;
case b:this.setMinWidth(j,k[l]);
break;
case d:this.setMaxWidth(j,k[l]);
break;
default:throw new Error("Unrecognized key: "+l);
}}},setWidth:function(e,f){if(e>this.__yh.length-1||e<0){throw new Error("Column number out of range");
}this.__yh[e].setColumnWidth(f);
},setMinWidth:function(n,o){if(n>this.__yh.length-1||n<0){throw new Error("Column number out of range");
}this.__yh[n].setMinWidth(o);
},setMaxWidth:function(g,h){if(g>this.__yh.length-1||g<0){throw new Error("Column number out of range");
}this.__yh[g].setMaxWidth(h);
}}});
})();
...
(function(){var c="qx.ui.progressive.headfoot.Abstract",b="abstract",a="__yi";
...
},members:{__yi:null,join:function(d){this.__yi=d;
}},destruct:function(){this._disposeFields(a);
}});
})();
(function(){var o="progressive-table-header-cell",n="resize",m="__ym",l="qx.ui.progressive.headfoot.TableHeading",k="__yk",j="_layout",h="__yj",g="progressive-table-header";
qx.Class.define(l,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(a,b){arguments.callee.base.call(this);
this.__yj=a;
var d=a.getData();
this.__yk=[];
...
c.set({height:16,appearance:o,minWidth:0,width:0});
this.add(c,{flex:1});
this.addListener(n,this._resizeColumns,this);
this.__yl=new qx.ui.layout.HBox();
this.__yl.connectToWidget(this);
},properties:{appearance:{refine:true,init:g}},members:{__yj:null,__ym:null,__yk:null,__yl:null,join:function(p){arguments.callee.base.call(this,p);
},getLayoutChildren:function(){if(this.__ym){return this.__yj.getData();
}else{return arguments.callee.base.call(this);
}},_resizeColumns:function(e){var q=this.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
this.__ym=true;
this.__yl.renderLayout(q,100);
this.__ym=false;
var r=this.__yj.getData();
for(var i=0;i<r.length;i++){this.__yk[i].setWidth(r[i].getComputedWidth());
...
(function(){var q="progressive-progressbar-indicator-undone",p="__yo",o="progress",n="%",m="progressive-progressbar-indicator-done",l="__yn",k="progressive-progressbar-percent-text",j="renderStart",i="progressive-progressbar-background",h="0%",d="__progressive",g="qx.ui.progressive.headfoot.Progress",f="__yp",c="progressive-progressbar-percent-background",b="renderEnd";
qx.Class.define(g,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(v,w){arguments.callee.base.call(this);
this.setHeight(16);
this.setPadding(0);
this.__yn={};
var x=qx.theme.manager.Color.getInstance();
this.__yn.background=x.resolve(i);
this.__yn.indicatorDone=x.resolve(m);
this.__yn.indicatorUndone=x.resolve(q);
this.__yn.percentBackground=x.resolve(c);
this.__yn.percentText=x.resolve(k);
this.set({backgroundColor:this.__yn.background});
this.__yo=new qx.ui.core.Widget();
this.__yo.set({width:0,backgroundColor:this.__yn.indicatorDone});
this.add(this.__yo);
var y=new qx.ui.core.Widget();
y.set({backgroundColor:this.__yn.indicatorUndone});
this.add(y,{flex:1});
this.__yp=new qx.ui.basic.Atom(h);
this.__yp.set({width:100,backgroundColor:this.__yn.percentBackground,textColor:this.__yn.percentText});
this.add(this.__yp);
this.exclude();
},members:{__yq:null,__yn:null,__yo:null,__yp:null,join:function(a){arguments.callee.base.call(this,a);
a.addListener(j,function(e){this.__yq=e.getData().initial;
this.show();
},this);
a.addListener(o,function(e){var t=1.0-(e.getData().remaining/this.__yq);
var u=this.getBounds();

if(u){var r=Math.floor((u.width-this.__yp.getBounds().width)*t);
var s=Math.floor(t*100)+n;

if(!isNaN(r)){this.__yo.setMinWidth(r);
this.__yp.setLabel(s);
}}},this);
a.addListener(b,function(e){this.exclude();
},this);
}},destruct:function(){this._disposeFields(l,d);
this._disposeObjects(p,f);
}});
})();
(function(){var g="abstract",f="qx.ui.progressive.structure.Abstract",e="__ys",d="__yr",c="auto",b="overflowY";
qx.Class.define(f,{type:g,extend:qx.core.Object,construct:function(a){arguments.callee.base.call(this);
if(!a){this.__yr=new qx.ui.core.Widget();
this.__ys=this.__yr;
}else{this.__yr=null;
this.__ys=a;
}this.__ys.getContentElement().setStyle(b,c);
},members:{__yr:null,__ys:null,applyStructure:function(h){throw new Error("applyStructure() is abstract");
},getPane:function(){return this.__ys;
}},destruct:function(){if(this.__yr){this.__yr.dispose();
}this._disposeFields(d,e);
}});
})();
(function(){var c="__yu",b="qx.ui.progressive.structure.Default",a="__yw";
qx.Class.define(b,{extend:qx.ui.progressive.structure.Abstract,construct:function(e,f,g){arguments.callee.base.call(this,g);
if(!e){this.__yt=new qx.ui.progressive.headfoot.Null();
this.__yu=this.__yt;
}else{this.__yt=null;
this.__yu=e;
}if(!f){this.__yv=new qx.ui.progressive.headfoot.Null();
this.__yw=this.__yv;
}else{this.__yv=null;
this.__yw=f;
}},members:{__yu:null,__yw:null,__yt:null,__yv:null,applyStructure:function(d){this.__yu.join(d);
this.__yw.join(d);
d.add(this.__yu);
d.add(this.getPane(),{flex:1});
d.add(this.__yw);
},getHeader:function(){return this.__yu;
},getFooter:function(){return this.__yw;
}},destruct:function(){if(this.__yt){this.__yt.dispose();
this.__yt=null;
}
if(this.__yv){this.__yv.dispose();
this.__yv=null;
...
(function(){var q="qx.event.type.Data",p="dataAvailable",o="renderStart",n="_applyDataModel",m="__yy",l="__yC",k="__yx",j="progress",h="white",g="qx.ui.progressive.Progressive",d="progressDetail",f="renderEnd";
qx.Class.define(g,{extend:qx.ui.container.Composite,construct:function(w){arguments.callee.base.call(this,new qx.ui.layout.VBox());
this.__yx={};
this.set({backgroundColor:h});
...
this.__yA=false;
this.__yB=0;
},events:{"renderStart":q,"renderEnd":q,"progress":q,"progressDetail":q},properties:{dataModel:{apply:n},batchSize:{init:20},flushWidgetQueueAfterBatch:{init:false}},members:{__yx:null,__yA:null,__yC:null,__yB:null,__yz:null,__yy:null,getStructure:function(){return this.__yy;
},addRenderer:function(name,v){this.__yx[name]=v;
v.join(this,name);
},removeRenderer:function(name){if(!this.__yx[name]){throw new Error("No existing renderer named "+name);
}delete this.__yx[name];
},render:function(){if(this.__yA){return;
}this.__yA=true;
var c=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__yy.getPane(),batchSize:this.getBatchSize(),rendererData:this.__yE(),userData:{}});
this.__yC=new Date();
if(this.__yz){this.__yB=c.getModel().getElementCount();
this.fireDataEvent(o,{state:c,initial:this.__yB});
this.__yD(c);
}else{qx.event.Timer.once(function(){this.__yB=c.getModel().getElementCount();
this.fireDataEvent(o,{state:c,initial:this.__yB});
this.__yD(c);
this.__yz=true;
},this,10);
}},_applyDataModel:function(a,b){if(b){b.removeListener(p,this.__yF,this);
b.dispose();
}a.addListener(p,this.__yF,this);
},__yD:function(r){var s;
var u;
var t;

for(var i=r.getBatchSize();i>0;i--){s=r.getModel().getNextElement();

if(!s){this.debug("Render time: "+(new Date()-this.__yC)+"ms");
this.__yA=false;
this.fireDataEvent(f,r);
r.dispose();
return ;
}u=s.element;
t=this.__yx[u.renderer];
t.render(r,u);
this.fireDataEvent(d,{initial:this.__yB,remaining:s.remaining,element:u});
}this.fireDataEvent(j,{initial:this.__yB,remaining:s.remaining});
if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();
}qx.event.Timer.once(function(){this.__yD(r);
},this,0);
},__yE:function(){var x={};

for(var name in this.__yx){x[name]={};
}return x;
},__yF:function(e){this.__yB=e.getData();
this.render();
}},destruct:function(){for(var name in this.__yx){this.__yx[name].dispose();
}this._disposeFields(l,k,m);
}});
})();
...
(function(){var d="dataAvailable",c="qx.ui.progressive.model.Default",b="__yG";
qx.Class.define(c,{extend:qx.ui.progressive.model.Abstract,construct:function(){arguments.callee.base.call(this);
this.__yG=[];
},members:{__yG:null,addElements:function(a){this.__yG=this.__yG.concat(a);
this.fireDataEvent(d,this.__yG.length);
},addElement:function(e){this.__yG.push(e);
this.fireDataEvent(d,this.__yG.length);
},getElementCount:function(){return this.__yG.length;
},getNextElement:function(){if(this.__yG.length>0){return ({element:this.__yG.shift(),remaining:this.__yG.length});
}return null;
}},destruct:function(){this._disposeFields(b);
}});
})();
...
(function(){var E=".qx-progressive-",D="-col-",C="px;",B="-row",A="}",z="width: ",y="0px ",x="qx-progressive-",w="px",v="  font-size: 11px;",bs="__yJ",br="padding: ",bq="px ",bp='',bo="__yH",bn="end",bm="qx.client",bl="div",bk="  position: absolute;",bj="  width : 100%;",L="__yQ",M="__columnData",J="  border-bottom:1px solid #eeeeee;",K="",H="  top: 0px;",I="  overflow:hidden;",F=" {",G="__yK",O="  cursor:default;",P="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",W="-row {",U="resize",bb="__yM",Y="start",bf="relative",bd="  -o-text-overflow: ellipsis;",R="mshtml",bi="  border-right:1px solid #f2f2f2;",bh="  white-space:nowrap;",bg=';-moz-user-select:none;',Q="  padding : 0px 6px 0px 6px;",S="__yL",T="qx.ui.progressive.renderer.table.Row",V="__yI",X="progressive-table-row-background-odd",ba="  text-overflow:ellipsis;",bc="  height: 100%;",be="progressive-table-row-background-even",N="left: ";
qx.Class.define(T,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bt){arguments.callee.base.call(this);
this.__yH=bt;
this.__yI={};
this.__yJ=new qx.ui.progressive.renderer.table.cell.Default();
this.__yK=null;
this.__yL={};
var bu=qx.theme.manager.Color.getInstance();
this.__yL.bgcol=[];
this.__yL.bgcol[0]=bu.resolve(be);
this.__yL.bgcol[1]=bu.resolve(X);
this.__yM=new qx.ui.layout.HBox();
this.__yM.connectToWidget(this);
},statics:{__yN:null,__yO:6,__yP:bk+H+bc+I+ba+bd+bh+bi+J+Q+O+v+P+(qx.core.Variant.isSet(bm,R)?bp:bg)},properties:{defaultRowHeight:{init:16}},members:{__yK:null,__yQ:null,__yR:null,__yH:null,__yI:null,__yJ:null,__yL:null,__yM:null,join:function(bI,name){if(this.__yK){throw new Error("Renderer is already joined to a Progressive.");
}this.__yK=bI;
this.__yQ=name;
var bK=qx.ui.progressive.renderer.table.Row;

if(!bK.__yN){bK.__yN={};
}var bJ=bI.toHashCode();

if(!bK.__yN[bJ]){bK.__yN[bJ]={rowstylesheet:null,cellstylesheet:[]};
var bL=E+bJ+W+bj+A;
bK.__yN[bJ].rowstylesheet=qx.bom.Stylesheet.createElement(bL);
var bM=this.__yH.getData();

for(var i=0;i<bM.length;i++){var bL=E+bJ+D+i+F+bK.__yP+A;
bK.__yN[bJ].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bL);
}this.__yR=bJ;
var bN=bI.getStructure().getPane();
bN.addListener(U,this._resizeColumns,this);
}},addRenderer:function(n,o){var p=this.__yH.getData();

if(n<0||n>=p.length){throw new Error("Column "+n+" out of range (max: "+(p.length-1)+")");
}this.__yI[n]=o;
},removeRenderer:function(bO){var bP=this.__yH.getData();

if(bO<0||bO>=bP.length){throw new Error("Column "+bO+" out of range (max: "+(bP.length-1)+")");
}
if(!this.__yI[bO]){throw new Error("No existing renderer for column "+bO);
}delete this.__yI[bO];
...
var bC;
var bz=0;
if(bv.getRendererData()[this.__yQ].end===undefined){bv.getRendererData()[this.__yQ]={end:0,start:1,rows:0,totalHeight:0};
}var bF=document.createElement(bl);
for(var i=0;i<bG.length;i++){var bA=x+this.__yR+D+i;
bC=this.__yI[i]||this.__yJ;
...
var bE=bv.getRendererData()[this.__yQ];
bE.totalHeight+=bz;
bF.style.position=bf;
bF.style.height=bz+w;
bF.className=x+this.__yR+B;
bF.innerHTML=bB.join(K);
switch(bw.location){case bn:var bx=bE.end||0;
bF.style.backgroundColor=this.__yL.bgcol[bx];
bE.end=(bx==0?1:0);
bv.getPane().getContentElement().getDomElement().appendChild(bF);
break;
case Y:var by=bv.getPane().getContentElement().getDomElement();
...
},getLayoutChildren:function(){return this.__yH.getData();
},_resizeColumns:function(e){var j=this.__yK.getStructure().getPane();
var f=j.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var g=E+this.__yR+B;
var b=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(b.__yN[this.__yR].rowstylesheet,g);
var d=z+f+C;
qx.bom.Stylesheet.addRule(b.__yN[this.__yR].rowstylesheet,g,d);
this.__yM.renderLayout(f,100);
var h=this.__yH.getData();
for(var i=0,m=0;i<h.length;i++,m+=f){var g=E+this.__yR+D+i;
var b=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(b.__yN[this.__yR].cellstylesheet[i],g);
f=h[i].getComputedWidth();
{};
var c;

if(qx.bom.client.Feature.CONTENT_BOX){c=qx.ui.progressive.renderer.table.Row.__yO*2;
}else{c=-1;
}var l=(f-c)+C;
var k=y+qx.ui.progressive.renderer.table.Row.__yO+bq+y+qx.ui.progressive.renderer.table.Row.__yO+C;
var a=m+C;
var d=b.__yP+z+l+N+a+br+k;
qx.bom.Stylesheet.addRule(b.__yN[this.__yR].cellstylesheet[i],g,d);
}}},destruct:function(){var name;

for(name in this.__yI){this.__yI[name]=null;
}var r=qx.ui.progressive.renderer.table.Row;
var q=this.__yK.toHashCode();

if(r.__yN&&r.__yN[q]){if(r.__yN[q].rowstylesheet){var t=E+this.__yR+B;
var r=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(r.__yN[this.__yR].rowstylesheet,t);
}if(r.__yN[q].cellstylesheet){for(var i=r.__yN[q].cellstylesheet.length-1;i>=0;i--){var t=E+this.__yR+D+i;
var s=r.__yN[this.__yR].cellstylesheet[i];
var r=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(s,t);
}}}
if(this.__yK&&this.__yK.getRendererData){var u=this.__yK.getRendererData();

if(u&&u[this.__yQ]&&u[this.__yQ].end!==undefined){u[this.__yQ]=null;
}}this._disposeFields(L,S,V,G,bo);
this._disposeObjects(bb,bs,M);
}});
})();
...
(function(){var x="",w=">",v="between",u="<",t="regex",s="!between",r="!=",q="==",p=">=",o="<=",M="color",L="text-align",K="__zj",J="__zn",I=":",H="font-weight",G="__zl",F='g',E="qx.ui.progressive.renderer.table.cell.Conditional",D="__zm",B="__zk",C="__zo",z="__zi",A=";",y="font-style";
qx.Class.define(E,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(X,Y,ba,bb){arguments.callee.base.call(this);
this.__zi=[q,r,w,u,p,o];
this.__zj=[v,s];
this.__zk=[];
this.__zl=X||x;
this.__zm=Y||x;
this.__zn=ba||x;
this.__zo=bb||x;
},members:{__zi:null,__zj:null,__zk:null,__zl:null,__zm:null,__zn:null,__zo:null,__zp:function(N,O){if(N.align){O[L]=N.align;
}
if(N.color){O[M]=N.color;
}
if(N.style){O[y]=N.style;
}
if(N.weight){O[H]=N.weight;
}},addNumericCondition:function(a,b,c,d,e,f,g){if(!qx.lang.Array.contains(this.__zi,a)||b==null){throw new Error("Condition not recognized or value is null!");
}this.__zk.push({condition:a,align:c,color:d,style:e,weight:f,value1:b,target:g});
},addBetweenCondition:function(bc,bd,be,bf,bg,bh,bi,bj){if(!qx.lang.Array.contains(this.__zj,bc)||bd==null||be==null){throw new Error("Condition not recognized or value1/value2 is null!");
}this.__zk.push({condition:bc,align:bf,color:bg,style:bh,weight:bi,value1:bd,value2:be,target:bj});
},addRegex:function(h,j,k,l,m,n){if(!h){throw new Error("regex cannot be null!");
}this.__zk.push({condition:t,align:j,color:k,style:l,weight:m,regex:h,target:n});
},_getCellStyle:function(P){if(this.__zk.length==0){return P.style||x;
}var i;
var T;
var Q;
var S={"text-align":this.__zl,"color":this.__zm,"font-style":this.__zn,"font-weight":this.__zo};

for(i=0;i<this.__zk.length;i++){var W=this.__zk[i];
T=false;

if(qx.lang.Array.contains(this.__zi,W.condition)){if(W.target==null){Q=P.cellData;
}else{Q=P.element.data[W.target];
}
switch(W.condition){case q:if(Q==W.value1){T=true;
}break;
case r:if(Q!=W.value1){T=true;
}break;
case w:if(Q>W.value1){T=true;
}break;
case u:if(Q<W.value1){T=true;
}break;
case p:if(Q>=W.value1){T=true;
}break;
case o:if(Q<=W.value1){T=true;
}break;
}}else if(qx.lang.Array.contains(this.__zj,W.condition)){if(W.target==null){Q=P.cellData;
}else{Q=P.element.data[W.target];
}
switch(W.condition){case v:if(Q>=W.value1&&Q<=W.value2){T=true;
}break;
case s:if(Q<W.value1&&Q>W.value2){T=true;
}break;
}}else if(W.condition==t){if(W.target==null){Q=P.cellData;
}else{Q=P.element.data[W.target];
}var R=new RegExp(W.value1,F);
T=R.test(Q);
}if(T){this.__zp(W,S);
}var U=[];

for(var V in S){if(S[V]){U.push(V,I,S[V],A);
}}}return U.join(x);
}},destruct:function(){this._disposeFields(z,K,B,G,D,J,C);
}});
})();
