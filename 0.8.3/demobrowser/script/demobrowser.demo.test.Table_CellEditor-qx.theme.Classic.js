...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.test.Table_CellEditor-qx.theme.Classic-0.js"]],
  boot : "boot",
...
qx.Class.define(k,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
...
},_addEditor:function(z,A){A=qx.lang.Object.clone(A);
var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var F=z.createCellEditor(A);
var G=new qx.ui.container.Composite().set({width:200,height:20});
F.setUserBounds(0,0,200,20);
G.add(F);
B.add(G);
var D=new qx.ui.form.Button(i);
B.add(D);
D.addListener(m,function(){E.setValue(z.getCellEditorValue(F)+r);
});
var C=new qx.ui.form.Button(j);
B.add(C);
C.addListener(m,function(){F.destroy();
qx.ui.core.queue.Manager.flush();
F=z.createCellEditor(A);
F.setUserBounds(0,0,200,20);
G.add(F);
qx.ui.core.queue.Manager.flush();
});
var E=new qx.ui.basic.Label(r);
B.add(E);
this._container.add(B);
D.execute();
},testCheckBoxEditor:function(){var a={value:[true,false]};
qx.util.Permutation.permute(a,function(w){this._addEditor(new qx.ui.table.celleditor.CheckBox(),w);
},this);
},testComboBoxEditor:function(){var c={value:[r,q,l,2],table:[this.getTableMock()]};
var d=new qx.ui.table.celleditor.ComboBox();
d.setListData([n,q,o]);
qx.util.Permutation.permute(c,function(s){this._addEditor(d,s);
},this);
},testSelectBoxEditor:function(){var e={value:[r,q],table:[this.getTableMock()]};
var f=new qx.ui.table.celleditor.SelectBox();
f.setListData([n,q,o]);
qx.util.Permutation.permute(e,function(b){this._addEditor(f,b);
},this);
},testPasswordEditor:function(){var x={value:[null,10,p]};
qx.util.Permutation.permute(x,function(H){this._addEditor(new qx.ui.table.celleditor.PasswordField(),H);
},this);
},testTextfieldEditor:function(){var t={value:[null,10,p]};
qx.util.Permutation.permute(t,function(y){this._addEditor(new qx.ui.table.celleditor.TextField(),y);
},this);
},testTextfieldEditor:function(){var u={value:[true,p]};
var v=new qx.ui.table.celleditor.Dynamic();
v.setCellEditorFactoryFunction(function(I){if(typeof I.value==h){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(u,function(J){this._addEditor(v,J);
},this);
