...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["qx:demobrowser.demo.data.ListControllerWithFilter-qx.theme.Classic-0.js"]],
  boot : "boot",
...
(function(){var r="execute",q="Show all numbers.",p="Write data to log",o="Add an item",n="Remove an item",m="Show only even numbers.",l="Odd / Even filter",k="Remove filter",j="<b>Filtered List</b><br/>",h="Reverse order",d="demobrowser.demo.data.ListControllerWithFilter",g="Show only odd numbers.",f="value",c="init",b="delegate",e="List showing numbered items, bound to a data array.";
...
var w={};
w.filter=function(a){return parseInt(a)%2==1;
};
var y={};
...
var G={converter:function(s){if(s==y){return m;
}else if(s==w){return g;
}return q;
}};
A.bind(b,C,f,G);
...
z.addListener(r,function(){F.push(F.length);
},this);
var E=new qx.ui.form.Button(n);
E.setWidth(120);
this.getRoot().add(E,{left:130,top:115});
E.addListener(r,function(){F.pop();
},this);
...
u.addListener(r,function(){A.getDelegate()==w?A.setDelegate(y):A.setDelegate(w);
},this);
var t=new qx.ui.form.Button(k);
t.setWidth(120);
this.getRoot().add(t,{left:130,top:220});
t.addListener(r,function(){A.setDelegate(null);
},this);
var H=new qx.ui.form.Button(h);
H.setWidth(120);
this.getRoot().add(H,{left:130,top:255});
H.addListener(r,function(){F.reverse();
},this);
