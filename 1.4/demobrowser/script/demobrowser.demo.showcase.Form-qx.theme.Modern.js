...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.showcase.Form","qx.theme":"qx.theme.Modern"};
...
(function(){var k="value",j="placeholder",h="Button",g="CheckBox:",f="TextArea:",e="Boolean",d="RepeatButton:",c="execute",b="Website 2",a="Text",V="ToggleButton",U="password",T="RadioButton 3",S="Button:",R="ComboBox:",Q="ToggleButton:",P="Options",O="RadioButton",N="0",M="MenuButton:",r="demobrowser.demo.showcase.Form",s="Tri-State CheckBox:",p="PasswordField:",q="SplitButton",n="Buttons",o="",l="RadioButtons:",m="dd.mm.YYYY",t="List:",u="SplitButton:",B="Option",z="RadioButton 1",F="Spinner:",D="Selection",I="DateField:",H="RadioButton 2",w="Tri-State CheckBox",L="Number",K="CheckBox",J="SelectBox:",v="Website 3",x="MenuButton",y="Website 1",A="Slider:",C="TextField:",E="Item ",G="RadioButtonGroup:";
qx.Class.define(r,{extend:qx.application.Standalone,statics:{ITEM_SIZE:5},members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var bm=new qx.ui.layout.Grid(20,5);
bm.setColumnFlex(0,1);
bm.setColumnFlex(1,1);
var bx=new qx.ui.container.Composite(bm);
bx.setPadding(10);
var be=1;
var W=new qx.ui.groupbox.GroupBox(a);
W.setLayout(new qx.ui.layout.Grid(8,8));
W.setWidth(290);
bx.add(W,{row:0,column:0});
var bv=new qx.ui.form.TextField();
bv.setPlaceholder(j);
bv.setTabIndex(be++);
var bg=new qx.ui.basic.Label(C);
bg.setBuddy(bv);
W.add(bg,{row:0,column:0});
W.add(bv,{row:0,column:1});
var bd=new qx.ui.form.PasswordField();
bd.setTabIndex(be++);
bd.setPlaceholder(U);
bg=new qx.ui.basic.Label(p);
bg.setBuddy(bd);
W.add(bg,{row:1,column:0});
W.add(bd,{row:1,column:1});
var X=new qx.ui.form.TextArea();
X.setTabIndex(be++);
X.setPlaceholder(j);
bg=new qx.ui.basic.Label(f);
bg.setBuddy(X);
W.add(bg,{row:2,column:0});
W.add(X,{row:2,column:1});
var Y=new qx.ui.form.ComboBox();
Y.setTabIndex(be++);
Y.setPlaceholder(j);
bg=new qx.ui.basic.Label(R);
bg.setBuddy(Y);
W.add(bg,{row:3,column:0});
W.add(Y,{row:3,column:1});
this.__Uo(Y);
var bo=new qx.ui.form.DateField();
bo.setTabIndex(be++);
bo.setPlaceholder(m);
bg=new qx.ui.basic.Label(I);
bg.setBuddy(bo);
W.add(bg,{row:4,column:0});
W.add(bo,{row:4,column:1});
var bf=new qx.ui.groupbox.GroupBox(D);
bf.setLayout(new qx.ui.layout.Grid(8,8));
bf.setWidth(290);
bx.add(bf,{row:1,column:0,rowSpan:2});
var bp=new qx.ui.form.SelectBox();
bp.setTabIndex(be++);
bg=new qx.ui.basic.Label(J);
bg.setBuddy(bp);
bf.add(bg,{row:0,column:0});
bf.add(bp,{row:0,column:1});
this.__Uo(bp);
var bu=new qx.ui.form.List();
bu.setTabIndex(be++);
bu.setHeight(60);
bu.setWidth(155);
bg=new qx.ui.basic.Label(t);
bg.setBuddy(bu);
bf.add(bg,{row:1,column:0});
bf.add(bu,{row:1,column:1});
this.__Uo(bu);
var bn=new qx.ui.form.RadioButtonGroup();
bn.add(new qx.ui.form.RadioButton(z).set({tabIndex:be++}));
bn.add(new qx.ui.form.RadioButton(H).set({tabIndex:be++}));
bn.add(new qx.ui.form.RadioButton(T).set({tabIndex:be++}));
bg=new qx.ui.basic.Label(G);
bg.setBuddy(bn);
bf.add(bg,{row:2,column:0});
bf.add(bn,{row:2,column:1});
var bs=new qx.ui.groupbox.GroupBox(n);
bs.setLayout(new qx.ui.layout.Grid(8,8));
bs.setWidth(250);
bx.add(bs,{row:0,column:1});
var bt=new qx.ui.form.Button(h).set({tabIndex:be++});
bg=new qx.ui.basic.Label(S);
bg.setBuddy(bt);
bs.add(bg,{row:0,column:0});
bs.add(bt,{row:0,column:1});
var bb=new qx.ui.form.ToggleButton(V).set({tabIndex:be++});
bg=new qx.ui.basic.Label(Q);
bg.setBuddy(bb);
bs.add(bg,{row:1,column:0});
bs.add(bb,{row:1,column:1});
var bj=new qx.ui.form.RepeatButton(N).set({tabIndex:be++});
bg=new qx.ui.basic.Label(d);
bg.setBuddy(bj);
bs.add(bg,{row:2,column:0});
bs.add(bj,{row:2,column:1});
var bk=new qx.ui.form.MenuButton(x,null,this.__Up()).set({tabIndex:be++});
bg=new qx.ui.basic.Label(M);
bg.setBuddy(bk);
bs.add(bg,{row:3,column:0});
bs.add(bk,{row:3,column:1});
var bc=new qx.ui.form.SplitButton(q,null,this.__Uq()).set({tabIndex:be++});
bg=new qx.ui.basic.Label(u);
bg.setBuddy(bc);
bs.add(bg,{row:4,column:0});
bs.add(bc,{row:4,column:1});
bj.addListener(c,function(){var by=parseInt(bj.getLabel())+1;
bj.setLabel(by.toString());
});
var ba=new qx.ui.groupbox.GroupBox(e);
ba.setLayout(new qx.ui.layout.Grid(8,8));
ba.setWidth(250);
bx.add(ba,{row:1,column:1});
var bq=new qx.ui.form.CheckBox(K).set({tabIndex:be++});
bg=new qx.ui.basic.Label(g);
bg.setBuddy(bq);
ba.add(bg,{row:0,column:0});
ba.add(bq,{row:0,column:1});
var bw=new qx.ui.form.CheckBox(w).set({triState:true,value:null});
bg=new qx.ui.basic.Label(s);
bg.setBuddy(bw);
ba.add(bg,{row:1,column:0});
ba.add(bw,{row:1,column:1});
var bi=new qx.ui.form.RadioButton(O).set({tabIndex:be++});
ba.add(new qx.ui.basic.Label(l),{row:2,column:0});
ba.add(bi,{row:2,column:1});
var br=new qx.ui.groupbox.GroupBox(L);
br.setLayout(new qx.ui.layout.Grid(8,8));
br.setWidth(250);
bx.add(br,{row:2,column:1});
var bh=new qx.ui.form.Spinner(0,50,100).set({tabIndex:be++});
bg=new qx.ui.basic.Label(F);
bg.setBuddy(bh);
br.add(bg,{row:0,column:0});
br.add(bh,{row:0,column:1});
var bl=new qx.ui.form.Slider().set({tabIndex:be++});
bl.setWidth(130);
bg=new qx.ui.basic.Label(A);
bg.setBuddy(bl);
br.add(bg,{row:1,column:0});
br.add(bl,{row:1,column:1});
bl.bind(k,bh,k);
bh.bind(k,bl,k);
this.getRoot().add(bx);
},__Uo:function(bz){for(var i=0;i<10;i++){var bA=new qx.ui.form.ListItem(E+i);
bz.add(bA);
}},__Up:function(){var bB=new qx.ui.menu.Menu;
...
for(var i=0;i<3;i++){var bF=new qx.ui.menu.Button(h+i);
bD.add(bF);
}var bC=new qx.ui.menu.Button(P,o,null,bB);
bD.addSeparator();
bD.add(bC);
return bD;
},__Uq:function(){var bG=new qx.ui.menu.Menu;
var bJ=new qx.ui.menu.Button(y);
var bH=new qx.ui.menu.Button(b);
var bI=new qx.ui.menu.Button(v);
bG.add(bJ);
bG.add(bH);
bG.add(bI);
return bG;
