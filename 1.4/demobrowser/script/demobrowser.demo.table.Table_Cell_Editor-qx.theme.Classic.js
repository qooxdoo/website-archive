...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Cell_Editor","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Cell_Editor-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"6e443bfd29cf"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},properties:{cellEditorFactoryFunction:{check:b,nullable:true,init:null}},members:{__Qy:null,__Qx:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();

if(qx.core.Environment.get(c)){this.assertFunction(g,d);
}this.__Qy=g(f);
var h=this.__Qy.createCellEditor(f);
this.__Qx[h.toHashCode()]=f;
return h;
...
}var j=this.__Qx[i.toHashCode()];
this.__Qy=k(j);
var l=this.__Qy.getCellEditorValue(i);
return l;
...
this.__mT=false;
this.__mU=false;
},properties:{behavior:{check:j,init:null,nullable:true,apply:h,event:e}},members:{__mU:null,__mT:null,__mV:null,_applyBehavior:function(r,s){if(s!=null){s.dispose();
s=null;
