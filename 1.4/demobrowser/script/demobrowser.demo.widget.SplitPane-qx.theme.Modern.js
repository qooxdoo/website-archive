...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SplitPane","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.SplitPane-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d0cff74040fb"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
