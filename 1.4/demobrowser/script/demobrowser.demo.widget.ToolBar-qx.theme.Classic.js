...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ToolBar","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.ToolBar-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ff516fbfdd90"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="excluded",k="Left",j="New",h="value",g="changeSelection",f="Cut",d="Center",c="Copy",b="Paste",a="Right",X="icon/16/actions/format-justify-right.png",W="Label only",V="enabled",U="22px",T="icon/22/actions/format-justify-center.png",S="icon/16/actions/edit-cut.png",R="icon/22/actions/format-text-underline.png",Q="32px",P="icon/22/actions/edit-cut.png",O="icon/22/actions/format-justify-left.png",s="showItem",t="48px",q="Show:",r="icon/22/actions/edit-paste.png",o="demobrowser.demo.widget.ToolBar",p="icon/22/actions/document-new.png",m="visible",n="icon/16/actions/edit-copy.png",u="More...",v="icon/22/actions/help-contents.png",C="icon/16/actions/format-justify-center.png",A="icon/22/actions/edit-copy.png",G="icon",E="icon/22/actions/format-justify-right.png",K="icon/16/actions/edit-paste.png",I="on",x="Help",N="icon/16/actions/format-justify-left.png",M="label",L="Label and Icon",w="overflowHandling",y="both",z="Icon Size:",B="icon/16/actions/document-new.png",D="Toggle",F="Icon only",H="Overflow handling:",J="hideItem";
qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var bu=new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
bu.setPadding(20);
this.getRoot().add(bu,{edge:0});
toolbar=new qx.ui.toolbar.ToolBar();
toolbar.setSpacing(5);
bu.add(toolbar);
var bA=new qx.ui.toolbar.Part();
var bd=new qx.ui.toolbar.Button(j,p);
var bq=new qx.ui.toolbar.Button(c,A);
var be=new qx.ui.toolbar.Button(f,P);
var bx=new qx.ui.toolbar.Button(b,r);
bA.add(bd);
bA.add(new qx.ui.toolbar.Separator());
bA.add(bq);
bA.add(be);
bA.add(bx);
toolbar.add(bA);
var bB=new qx.ui.toolbar.Part();
var br=new qx.ui.toolbar.CheckBox(D,R);
bB.add(br);
toolbar.add(bB);
var bC=new qx.ui.toolbar.Part();
var bp=new qx.ui.toolbar.RadioButton(k,O);
var bo=new qx.ui.toolbar.RadioButton(d,T);
var bn=new qx.ui.toolbar.RadioButton(a,E);
bC.add(bp);
bC.add(bo);
bC.add(bn);
toolbar.add(bC);
var bD=new qx.ui.form.RadioGroup(bp,bo,bn);
bD.setAllowEmptySelection(true);
toolbar.addSpacer();
var bs=new qx.ui.toolbar.MenuButton(u);
toolbar.add(bs);
toolbar.setOverflowIndicator(bs);
var Y=new qx.ui.toolbar.Button(x,v);
toolbar.add(Y);
var bh=[bd,bq,be,bx,br,bp,bo,bn,Y];
toolbar.setRemovePriority(bA,4);
toolbar.setRemovePriority(bC,3);
toolbar.setRemovePriority(bB,2);
var ba=new qx.ui.menu.Menu();
bs.setMenu(ba);
var bd=new qx.ui.menu.Button(j,B);
var bi=new qx.ui.menu.Separator();
var bq=new qx.ui.menu.Button(c,n);
var be=new qx.ui.menu.Button(f,S);
var bx=new qx.ui.menu.Button(b,K);
ba.add(bd);
ba.add(bi);
ba.add(bq);
ba.add(be);
ba.add(bx);
var bj=new qx.ui.menu.Separator();
var bp=new qx.ui.menu.RadioButton(k);
var bo=new qx.ui.menu.RadioButton(d);
var bn=new qx.ui.menu.RadioButton(a);
bp.setIcon(N);
bo.setIcon(C);
bn.setIcon(X);
ba.add(bj);
...
ba.add(bo);
ba.add(bn);
var bb=ba.getChildren();

for(var i=0;i<bb.length;i++){bb[i].setVisibility(l);
}var bc=function(bF,bG){var bH=[];

if(bF==bA){bH.push(bd,bi,bq,be,bx);
}else if(bF==bC){bH.push(bj,bp,bo,bn);
}
for(var i=0;i<bH.length;i++){bH[i].setVisibility(bG);
}};
toolbar.addListener(s,function(e){bc(e.getData(),l);
},this);
toolbar.addListener(J,function(e){bc(e.getData(),m);
},this);
var bk=new qx.ui.layout.Grid();
bk.setSpacing(10);
var bw=new qx.ui.container.Composite(bk);
bu.add(bw);
var bm=new qx.ui.form.RadioButton(U);
bm.setValue(true);
var bE=new qx.ui.form.RadioButton(Q);
var bl=new qx.ui.form.RadioButton(t);
var bt=new qx.ui.form.RadioGroup();
bt.add(bm,bE,bl);
bw.add(new qx.ui.basic.Label(z),{row:0,column:0});
bw.add(bm,{row:0,column:1});
bw.add(bE,{row:0,column:2});
bw.add(bl,{row:0,column:3});
bt.addListener(g,function(e){var bK=e.getData()[0];
var bJ,bL,bI;

for(var i=0;i<bh.length;i++){bJ=bh[i];
bI=bJ.getIcon();
...
bg.setValue(true);
var bz=new qx.ui.form.RadioButton(F);
var bf=new qx.ui.form.RadioButton(W);
var bv=new qx.ui.form.RadioGroup();
bv.add(bg,bz,bf);
bw.add(new qx.ui.basic.Label(q),{row:1,column:0});
bw.add(bg,{row:1,column:1});
bw.add(bz,{row:1,column:2});
bw.add(bf,{row:1,column:3});
bv.addListener(g,function(e){if(e.getData()[0]==bg){toolbar.setShow(y);
}else if(e.getData()[0]==bz){toolbar.setShow(G);
}else if(e.getData()[0]==bf){toolbar.setShow(M);
}},this);
var by=new qx.ui.form.CheckBox(I);
bw.add(new qx.ui.basic.Label(H),{row:2,column:0});
bw.add(by,{row:2,column:1});
by.bind(h,toolbar,w);
by.bind(h,bv,V,{converter:function(bM){return !bM;
}});
}}});
})();
