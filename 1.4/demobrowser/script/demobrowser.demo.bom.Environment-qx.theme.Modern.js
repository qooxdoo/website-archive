...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Environment","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Environment-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"3ee35fc05bc8"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var o="<tr><td>",n="</td><td>",m="</td></tr>",l="demobrowser.demo.bom.Environment",k="<tr><td colspan='2'>&nbsp;</td></tr>",j="",h="<tr><td colspan='2'><h2>Asynchronous checks</h2></td></tr>",g="<h2>Synchronous checks</h2>",f="output",e="<tr><td colspan='2'><b>",b="</table>",d=".",c="<table border='0'>",a="</b></td></tr>";
...
t.add(g);
t.add(c);
var u=qx.core.Environment._checks;
var q=qx.lang.Object.getKeys(u);
q.sort();
var v=j;

for(var i=0;i<q.length;i++){var s=q[i];
var r=s.split(d)[0];

if(r!=v){v=r;
t.add(k);
t.add(e+r+a);
}t.add(o,s,n,qx.core.Environment.get(s),m);
}t.add(h);
u=qx.core.Environment._asyncChecks;
var p=qx.lang.Object.getLength(u);
q=qx.lang.Object.getKeys(u);

for(var i=0;i<q.length;i++){var s=q[i];
qx.core.Environment.getAsync(s,function(w){t.add(o,this,n,w,m);
p--;
