...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.HtmlArea","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.HtmlArea-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e83d1f2cf268"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var p="",o="changeSelection",n="demobrowser.demo.widget.HtmlArea",m="Set Text Color",l="Insert Table",k="qx/icon/Oxygen/16/actions/format-indent-more.png",h="As an application developer you can <b>use the same API.</b></p>",g="Comic Sans MS",f="Insert Ordered List",d="<p>This UI-level widget can be used at RIA (Rich ",bA="qx/icon/Oxygen/16/actions/format-justify-left.png",bz="Tahoma",by="qx/icon/Oxygen/16/actions/format-text-italic.png",bx="Indent More",bw="qx/icon/Oxygen/16/actions/edit-undo.png",bv="Courier",bu="Courier New",bt="qx/icon/Oxygen/16/actions/format-justify-right.png",bs="solid",br="Arial Black",w="Align Left",x="Insert HTML Code",u="qx/icon/Oxygen/16/actions/format-justify-center.png",v="Impact",s="demobrowser/demo/icons/htmlarea/format-text-color.png",t="Change Font Size",q="<h1>HtmlArea UI-level widget</h1>",r="Align Center",E="Align Justify",F="Undo Last Change",T="qx/icon/Oxygen/16/actions/insert-link.png",P="Redo Last Undo Step",bc="demobrowser/demo/icons/htmlarea/format-fill-color.png",W="The UI widget does use the low-level component internally ",bn="<p>You can play around with this widget by hitting the ",bh="demobrowser/demo/icons/htmlarea/insert-text.png",K="qx/icon/Oxygen/16/actions/format-indent-less.png",bq="Times New Roman",bp="Remove Format",bo="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",I="qx/icon/Oxygen/16/actions/edit-clear.png",M="demobrowser/demo/icons/htmlarea/format-list-unordered.png",O="HTML Code:",R="Set Text Background Color",U="Format Bold",X="Georgia",be="qx/icon/Oxygen/16/actions/edit-redo.png",bj="Change Font Family",y="Lucida Console",z="Internet Applications) and inline applications.<br/>",L="Align Right",bb="border-main",ba="Insert Link",Y="Inserted Unordered List",bg="qx/icon/Oxygen/16/actions/format-text-bold.png",bf="execute",V="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bd="main",a="Arial",bi="12px ",A="Format Italic",B="qx/icon/Oxygen/16/actions/format-justify-fill.png",Q="qx/icon/Oxygen/16/actions/format-text-underline.png",b="Verdana",c="Indent Less",H="Insert Image",C="demobrowser/demo/icons/htmlarea/insert-table.png",D='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',G="Format Strikethrough",S="Format Underline",bl="qx/icon/Oxygen/16/actions/insert-image.png",bk="demobrowser/demo/icons/htmlarea/format-list-ordered.png",N="Insert Horizontal Ruler",bm="so code-duplication is avoided.<br/>",J="buttons at the toolbar.</p>";
qx.Class.define(n,{extend:qx.application.Standalone,members:{__VT:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bH=q+d+z+W+bm+h+bn+J;
var bC=new qx.ui.basic.Label(bH);
bC.set({rich:true,marginBottom:10});
var bG=D;
var bF=this.getRoot();
var bE=new qx.ui.decoration.Single(1,bs,bb);
bE.setWidthTop(0);
this.__VT=new qx.ui.embed.HtmlArea(bG,null,"blank.html");
this.__VT.set({width:600,height:400,decorator:bE});
var toolbar=this.__We();
var bB=new qx.ui.layout.VBox(0);
var bD=new qx.ui.container.Composite(bB);
bD.add(bC);
bD.add(toolbar);
bD.add(this.__VT);
bF.add(bD,{left:20,top:20});
},__VU:function(e){var bI=window.prompt("Color (Hex): ","#");
this.setTextColor(bI);
},__VV:function(e){var bJ=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(bJ);
},__VW:function(e){var bK={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(bK);
},__VX:function(e){var bL="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(bL);
},__VY:function(e){var bN=new qx.ui.window.Window("Insert Hyperlink");
bN.setLayout(new qx.ui.layout.VBox(20));
bN.set({width:400,showMaximize:false,showMinimize:false});
var bR=new qx.ui.form.TextField("http://");
bN.add(bR);
var bP=new qx.ui.layout.HBox(10);
bP.setAlignX("right");
var bQ=new qx.ui.container.Composite(bP);
var bM=new qx.ui.form.Button("OK");
bM.setWidth(60);
bM.addListener("execute",function(e){this.insertHyperLink(bR.getValue());
bN.close();
},this);
bQ.add(bM);
var bO=new qx.ui.form.Button("Cancel");
bO.setWidth(60);
bO.addListener("execute",function(e){bN.close();
},this);
bQ.add(bO);
bN.add(bQ);
bN.center();
bN.open();
this.saveRange();
},__Wa:function(e){var bS=window.prompt(O,p);
this.insertHtml(bS);
},__Wb:function(){var bU=new qx.ui.form.SelectBox;
bU.set({toolTipText:bj,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
bU.add(new qx.ui.form.ListItem(p));
var bV=[bz,b,bq,a,br,bu,bv,X,v,g,y];
var bT;

for(var i=0,j=bV.length;i<j;i++){bT=new qx.ui.form.ListItem(bV[i]);
bT.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(bi+bV[i])});
bU.add(bT);
}bU.addListener(o,function(e){var bW=e.getData()[0].getLabel();

if(bW!=p){this.setFontFamily(bW);
bU.setSelection([bU.getChildren()[0]]);
}},this.__VT);
return bU;
},__Wc:function(){var bY=new qx.ui.form.SelectBox;
bY.set({toolTipText:t,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
bY.add(new qx.ui.form.ListItem(p));
var bX;

for(var i=1;i<=7;i++){bX=new qx.ui.form.ListItem(i+p);
bX.set({focusable:false,keepFocus:true});
bY.add(bX);
}bY.addListener(o,function(e){var ca=e.getData()[0].getLabel();

if(ca!=p){this.setFontSize(ca);
bY.setSelection([bY.getChildren()[0]]);
}},this.__VT);
return bY;
},__Wd:function(){return [{bold:{text:U,image:bg,action:this.__VT.setBold},italic:{text:A,image:by,action:this.__VT.setItalic},underline:{text:S,image:Q,action:this.__VT.setUnderline},strikethrough:{text:G,image:V,action:this.__VT.setStrikeThrough},removeFormat:{text:bp,image:I,action:this.__VT.removeFormat}},{alignLeft:{text:w,image:bA,action:this.__VT.setJustifyLeft},alignCenter:{text:r,image:u,action:this.__VT.setJustifyCenter},alignRight:{text:L,image:bt,action:this.__VT.setJustifyRight},alignJustify:{text:E,image:B,action:this.__VT.setJustifyFull}},{fontFamily:{custom:this.__Wb},fontSize:{custom:this.__Wc},fontColor:{text:m,image:s,action:this.__VU},textBackgroundColor:{text:R,image:bc,action:this.__VV}},{indent:{text:bx,image:k,action:this.__VT.insertIndent},outdent:{text:c,image:K,action:this.__VT.insertOutdent}},{insertImage:{text:H,image:bl,action:this.__VW},insertTable:{text:l,image:C,action:this.__VX},insertLink:{text:ba,image:T,action:this.__VY},insertHTML:{text:x,image:bh,action:this.__Wa},insertHR:{text:N,image:bo,action:this.__VT.insertHorizontalRuler}},{ol:{text:f,image:bk,action:this.__VT.insertOrderedList},ul:{text:Y,image:M,action:this.__VT.insertUnorderedList}},{undo:{text:F,image:bw,action:this.__VT.undo},redo:{text:P,image:be,action:this.__VT.redo}}];
},__We:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator(bd);
var cb;
var cc=this.__Wd();

for(var i=0,j=cc.length;i<j;i++){var cd=new qx.ui.toolbar.Part;
toolbar.add(cd);

for(var ce in cc[i]){var cf=cc[i][ce];

if(cf.custom){cb=cf.custom.call(this);
}else{cb=new qx.ui.toolbar.Button(null,cf.image);
cb.set({focusable:false,keepFocus:true,center:true,toolTipText:cf.text?cf.text:p});
cb.addListener(bf,cf.action,this.__VT);
}cd.add(cb);
}}return toolbar;
}}});
})();
