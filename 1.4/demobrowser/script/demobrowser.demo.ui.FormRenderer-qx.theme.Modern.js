...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRenderer","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.FormRenderer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"18ef8a3b29fd"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var o="execute",n="female",m="Name",l="Registration",k="male",j="Send",i="Bio",h="Gender",g="Country",f="Personal Information",c="Save?",e="Password",d="demobrowser.demo.ui.FormRenderer",b="Reset",a="Age";
...
u.setRequired(true);
q.add(u,e);
q.add(new qx.ui.form.CheckBox(),c);
q.addGroupHeader(f);
q.add(new qx.ui.form.Spinner(),a);
q.add(new qx.ui.form.TextField(),g);
var t=new qx.ui.form.SelectBox();
t.add(new qx.ui.form.ListItem(k));
t.add(new qx.ui.form.ListItem(n));
q.add(t,h);
...
q.addButton(r);
this.getRoot().add(new qx.ui.form.renderer.Single(q),{left:10,top:10});
}}});
})();
