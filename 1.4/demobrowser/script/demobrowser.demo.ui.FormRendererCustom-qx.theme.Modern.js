...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererCustom","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.FormRendererCustom-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"b9db65ab0c36"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(r,{extend:qx.ui.form.renderer.Single,members:{__Vh:0,__Vi:0,addItems:function(C,D,E,F){var I=0;
if(E!=null){this._add(this._createHeader(E),{row:I,column:this.__Vh,colSpan:2});
I++;
}for(var i=0;i<C.length;i++){var H=this._createLabel(D[i],C[i]);
this._add(H,{row:I,column:this.__Vh});
var G=C[i];
H.setBuddy(G);

if(G instanceof qx.ui.form.RadioGroup){G=this._createWidgetForRadioGroup(G);
}this._add(G,{row:I,column:this.__Vh+1});
if(F[i]&&F[i].placeholder){G.setPlaceholder(F[i].placeholder);
}I++;
}this.__Vh+=2;
this.__Vi<I?this.__Vi=I:null;
...
this._add(this._buttonRow,{row:this.__Vi,column:0,colSpan:this.__Vh});
