...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ModelDebugging","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ModelDebugging-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"6d31b514f47e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(f,{extend:qx.data.store.Json,statics:{saveResult:function(t){this.__Tj=t;
...
w+=l;
x.load(w,function(y){this.__Tk();
},this);
},__Tk:function(){var z=demobrowser.demo.data.store.Twitter.__Tj;
