...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Cells","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Cells-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"da725ac75be9"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="",i="' ",h="<b>HTML</b>",g="px;",f="Juhu",e="</div>",d="content",c="<div ",b="testNumberCell",a="class='",A="width:",z="testHtmlCell",y="testDateCell",x="css.boxmodel",w=">",v="height:",u="testStringCell",t="demobrowser.demo.virtual.Cells",s="foobar!",r="style='",p="medium",q="main",n="icon/16/emotes/face-sad.png",o="icon/16/apps/internet-feed-reader.png",l="icon/16/emotes/face-smile.png",m="This is a feed reader!",k="icon/32/apps/utilities-notes.png";
...
},testStringCell:function(){var E={value:[f,h,j,null],states:[{},{selected:1}]};
var D=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(E,function(F){var G=this.__Vm(D,F.value,F.states);
this.container.add(G);
},this);
},testNumberCell:function(){var H={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var I=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(H,function(J){if(J.format){I.setNumberFormat(J.format);
}else{I.resetNumberFormat();
}var K=this.__Vm(I,J.value,J.states);
this.container.add(K);
},this);
},testDateCell:function(){var L={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(p))],states:[{},{selected:1}]};
var M=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(L,function(N){if(N.format){M.setDateFormat(N.format);
}else{M.resetDateFormat();
}var O=this.__Vm(M,N.value,N.states);
this.container.add(O);
},this);
},testHtmlCell:function(){var P={value:[f,h,j,null],states:[{},{selected:1}]};
var Q=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(P,function(R){var S=this.__Vm(Q,R.value,R.states);
this.container.add(S);
},this);
},testImageCell:function(){var T={value:[{url:o,tooltip:m},{url:k,tooltip:s},null],states:[{},{selected:1}]};
var U=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(T,function(V){var W=this.__Vm(U,V.value,V.states);
this.container.add(W);
},this);
},testBooleanCell:function(){var X={value:[true,false,null],states:[{},{selected:1}]};
var Y=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(X,function(ba){var bb=this.__Vm(Y,ba.value,ba.states);
this.container.add(bb);
},this);
},testBooleanCellCustomImage:function(){var bc={value:[true,false,null],states:[{},{selected:1}]};
var bd=new qx.ui.virtual.cell.Boolean;
bd.setIconFalse(n);
bd.setIconTrue(l);
qx.util.Permutation.permute(bc,function(be){var bf=this.__Vm(bd,be.value,be.states);
this.container.add(bf);
},this);
},__Vm:function(bg,bh,bi){var bm=100;
var bk=30;
var bo=new qx.ui.embed.Html().set({width:bm,height:bk,decorator:bi.selected?null:q});
var bj=bg.getCellProperties(bh,bi);
var bl=bj.insets;
var bn=[c,r,this._getCellSizeStyle(bm,bk,bl[0],bl[1]),bj.style,i,a,bj.classes,i,bj.attributes,w,bj.content,e].join(j);
bo.setHtml(bn);
return bo;
},_getCellSizeStyle:function(bp,bq,br,bs){var bt=j;

if(qx.core.Environment.get(x)==d){bp-=br;
bq-=bs;
}bt+=A+bp+g;
bt+=v+bq+g;
return bt;
...
},members:{__JH:16,__JI:16,_aliasManager:null,__JJ:function(v){var y=qx.util.ResourceManager.getInstance();
...
},__JK:function(A){if(typeof (A)=="string"){A={url:A};
...
var H=this.__JK(this._identifyImage(E));
