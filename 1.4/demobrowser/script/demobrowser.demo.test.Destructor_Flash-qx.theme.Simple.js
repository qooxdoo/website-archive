...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor_Flash","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Destructor_Flash-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"243cfb54551f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(j,{extend:qx.application.Native,members:{__UE:null,__UF:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__UE=[];
...
o.start();
},clear:function(){var p=this.__UE;
