...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SearchAsYouType","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"0f004626f555"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var v=[p,g,f,n,k,j,e,b,m,l];
var y=[];

for(var i=0;i<60;i++){y.push(v[i%10]+c+i);
}var x=new qx.data.Array(y);
var w=new qx.ui.form.TextField();
w.setLiveUpdate(true);
this.getRoot().add(w,{top:70,left:10});
var t=new qx.ui.form.List();
this.getRoot().add(t,{left:10,top:100});
var u=new qx.data.controller.List(x,t);
var s=new demobrowser.demo.data.filter.SearchAsYouTypeFilter(u);
u.setDelegate(s);
w.bind(a,s,q);
...
this.__Tm=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__Tm:null,__Tl:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__Tm!=null){i.stop(this.__Tm);
this.__Tm=null;
}this.__Tm=i.start(function(){this.__Tl.update();
this.__Tm=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__Tl=null;
}});
})();
