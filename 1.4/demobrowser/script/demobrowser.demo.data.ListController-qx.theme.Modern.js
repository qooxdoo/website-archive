...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ListController","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ListController-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"5691037ca3ce"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var r="execute",q="multi",p="Bound to the selection of the list to the left.",o="Item ",n="Remove an item",m="Write data to log",l="Add an item",k="",j="selection[0]",h="<b>Multi selection List</b><br/>",c="value",g="<b>Selection Label</b><br/>",f="white",b="<b>Selection List</b><br/>",a="main",e="demobrowser.demo.data.ListController",d="Bound to the same data and share the selection.";
...
for(var i=0;i<10;i++){C.push(o+i);
}var F=new qx.data.Array(C);
var u=new qx.ui.form.List();
u.setSelectionMode(q);
var x=new qx.ui.form.List();
x.setSelectionMode(q);
var w=new qx.ui.form.List();
this.getRoot().add(u,{left:10,top:80});
this.getRoot().add(x,{left:130,top:80});
this.getRoot().add(w,{left:250,top:80});
var A=new qx.data.controller.List(F,u);
var z=new qx.data.controller.List(F,x);
var y=new qx.data.controller.List(A.getSelection(),w);
z.setSelection(A.getSelection());
var D=new qx.ui.basic.Label(k);
this.getRoot().add(D,{left:370,top:80});
y.bind(j,D,c);
D.setWidth(120);
D.setDecorator(a);
D.setBackgroundColor(f);
var G=new qx.ui.form.Button(l);
G.setWidth(120);
this.getRoot().add(G,{left:370,top:110});
G.addListener(r,function(){F.push(o+F.length);
},this);
var v=new qx.ui.form.Button(n);
v.setWidth(120);
this.getRoot().add(v,{left:370,top:145});
v.addListener(r,function(){F.pop();
},this);
var B=new qx.ui.form.Button(m);
B.setWidth(120);
this.getRoot().add(B,{left:370,top:180});
B.addListener(r,function(){qx.log.appender.Console.show();
this.info(F.toString());
},this);
...
s.setWidth(100);
s.setValue(b+p);
this.getRoot().add(s,{left:260,top:10});
var t=new qx.ui.basic.Label();
t.setRich(true);
t.setWidth(100);
t.setValue(g+p);
this.getRoot().add(t,{left:380,top:10});
}}});
})();
