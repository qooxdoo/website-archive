...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Decorator_Box","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Decorator_Box-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"e1903d68b179"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
