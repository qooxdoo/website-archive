...
(function(){var o="Maximal height",n="AAA ",m="",l="Wrap handling",k="Minimal height",j="qooxdoo is…",h="Non-default minimal line height",g="demobrowser.demo.ui.AutoSizeTextArea",f="changeValue",e="rich internet applications (RIAs).",b="Regular",d="qooxdoo is a comprehensive and innovative framework for creating ",c="Auto-Size",a="Wrap";
...
var q=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));
this.getRoot().add(q,{top:20,left:20});
var t=new qx.ui.basic.Label();
t.setValue(b);
var r=new qx.ui.form.TextArea();
r.set({allowStretchY:false,value:this.__Vc()});
q.add(t,{row:0,column:0});
q.add(r,{row:1,column:0});
var t=new qx.ui.basic.Label();
t.setValue(c);
var x=new qx.ui.form.TextArea();
x.set({allowStretchY:false,value:this.__Vc(),autoSize:true});
q.add(t,{row:0,column:1});
q.add(x,{row:1,column:1});
var t=new qx.ui.basic.Label();
t.setValue(h);
var y=new qx.ui.form.TextArea();
y.set({allowStretchY:false,value:j,autoSize:true,minimalLineHeight:1,maxHeight:300});
q.add(t,{row:0,column:2});
q.add(y,{row:1,column:2});
var t=new qx.ui.basic.Label();
t.setValue(k);
var u=new qx.ui.form.TextArea();
u.set({allowStretchY:false,value:this.__Vc(),autoSize:true,minHeight:200});
q.add(t,{row:2,column:0});
q.add(u,{row:3,column:0});
var t=new qx.ui.basic.Label();
t.setValue(o);
var s=new qx.ui.form.TextArea();
s.set({allowStretchY:false,value:this.__Vc(),autoSize:true,minHeight:200,maxHeight:300});
q.add(t,{row:2,column:1});
q.add(s,{row:3,column:1});
var t=new qx.ui.basic.Label();
t.setValue(l);
var v=new qx.ui.form.TextArea();
v.set({allowStretchY:false,value:this.__Vd(),autoSize:true});
var p=new qx.ui.form.CheckBox(a);
p.setValue(true);
p.setAllowStretchX(false);
p.addListener(f,function(){v.toggleWrap();
});
q.add(t,{row:2,column:2});
var w=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));
q.add(w,{row:3,column:2});
w.add(v,{row:0,column:0});
w.add(p,{row:1,column:0});
},__Vc:function(){return d+e;
},__Vd:function(){var z=new qx.type.Array(40);

for(var i=0;i<z.length;i++){z[i]=n;
}return z.join(m);
}}});
})();
...
return this;
},append:function(j){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(j,a);
}var k=j;
if(j instanceof qx.type.Array){k=[];

for(var i=0;i<j.length;i++){k[i]=j[i];
}}Array.prototype.push.apply(this,k);
return this;
},remove:function(l){var i=this.indexOf(l);

if(i!=-1){this.splice(i,1);
return l;
}},contains:function(m){return this.indexOf(m)!==-1;
}}});
})();
