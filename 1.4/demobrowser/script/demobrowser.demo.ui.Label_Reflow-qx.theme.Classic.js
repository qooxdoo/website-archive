...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Label_Reflow","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.Label_Reflow-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"6b5c7c485e9f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var m="main",l="qooxdoo is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed.",k="click",j="#CCC",i="<b>qooxdoo is cool.</b>",h="qooxdoo (pronounced [’ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",g="#FFF",f="It includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",d="demobrowser.demo.ui.Label_Reflow",c="Toggle first paragraph",a="Resize Pane",b="#EEE";
...
n.setRowFlex(0,1);
n.setSpacing(10);
var o=new qx.ui.container.Composite(n).set({backgroundColor:b,decorator:m,padding:10,allowGrowX:false,allowGrowY:false,allowStretchX:false,allowStretchY:false});
p.add(o);
this.getRoot().add(p,{edge:0});
var t=this.getPane();
o.add(t,{row:0,column:0,colSpan:3});
var r=new qx.ui.basic.Label(c).set({backgroundColor:j,decorator:m,padding:[4,8]});
o.add(r,{row:1,column:1});
var q=false;
r.addListener(k,function(){var v=t.getChildren()[0];
v.setValue(q?l:i);
q=!q;
});
var s=new qx.ui.basic.Label(a).set({backgroundColor:j,decorator:m,padding:[4,8]});
o.add(s,{row:1,column:2});
var u=false;
s.addListener(k,function(e){if(u){t.setWidth(600);
}else{t.setWidth(300);
}u=!u;
});
},getPane:function(){var z=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:g,width:600,decorator:m,padding:10});
var w=new qx.ui.basic.Label().set({rich:true,value:l});
z.add(w);
var x=new qx.ui.basic.Label().set({rich:true,value:f});
z.add(x);
var y=new qx.ui.basic.Label().set({rich:true,value:h});
z.add(y);
return z;
}}});
})();
