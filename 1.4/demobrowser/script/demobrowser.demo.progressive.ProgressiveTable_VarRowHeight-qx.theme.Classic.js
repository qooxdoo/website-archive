...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Ua:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var A=p;
...
--this.__Ua;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Ua+", end="+this.imageData.length);
if(this.__Ua==0){this.doLoad();
}return;
...
if(d===undefined){this.__MQ=d;
}else{this.__MQ=16;
}
if(e===undefined){this.__MR=e;
}else{this.__MR=16;
}},members:{__MQ:null,__MR:null,_identifyImage:function(f){var j={imageWidth:this.__MQ,imageHeight:this.__MR};
var k;
