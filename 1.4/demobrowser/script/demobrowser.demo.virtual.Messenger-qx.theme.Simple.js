...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Messenger","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Messenger-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"6f2805996dc7"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(C,{extend:qx.application.Standalone,members:{__Vx:null,messenger:null,__Vy:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var V=this.getRoot();
var Y=new qx.ui.window.Window(F).set({contentPadding:0,showClose:false,showMinimize:false});
...
var W=demobrowser.demo.virtual.messenger.BuddyModel.createBuddies(200);
this.messenger.setModel(W);
Y.add(this.createToolbar());
Y.add(this.messenger,{flex:1});
V.add(this.createDetailsView(),{left:20,top:20});
},createToolbar:function(){var toolbar=new qx.ui.toolbar.ToolBar();
var bc=new qx.ui.toolbar.Part();
toolbar.add(bc);
var ba=new qx.ui.toolbar.Button(i,E).set({show:c});
ba.addListener(k,this.showAddContactWindow,this);
bc.add(ba);
var bb=new qx.ui.toolbar.Button(i,p).set({show:c});
this.messenger.bind(T,bb,n,{converter:function(bd){return !!bd;
}});
bb.addListener(k,function(){this.messenger.getModel().remove(this.messenger.getSelection().getItem(0));
},this);
bc.add(bb);
return bc;
},createDetailsView:function(){var bh=new qx.data.controller.Object();
this.messenger.bind(T,bh,J);
var be=new qx.ui.groupbox.GroupBox(w);
var bi=new qx.ui.layout.Grid(5,5);
bi.setColumnAlign(0,U,j);
be.setLayout(bi);
be.add(new qx.ui.basic.Label(m),{row:0,column:0});
var bk=new qx.ui.form.TextField();
bh.addTarget(bk,f,t,true);
be.add(bk,{row:0,column:1});
be.add(new qx.ui.basic.Label(O),{row:1,column:0});
var bf=new qx.ui.form.TextField();
bh.addTarget(bf,f,l,true);
be.add(bf,{row:1,column:1});
be.add(new qx.ui.basic.Label(D),{row:2,column:0});
var bj=new qx.ui.form.SelectBox();
bj.add(new qx.ui.form.ListItem(d).set({model:d}));
bj.add(new qx.ui.form.ListItem(h).set({model:h}));
bj.add(new qx.ui.form.ListItem(b).set({model:b}));
bj.add(new qx.ui.form.ListItem(g).set({model:g}));
this.messenger.bind(a,bj,B,{converter:function(bl){return [bl];
}});
bj.bind(H,this.messenger,a,{converter:function(bm){return bm[0].getModel();
}});
be.add(bj,{row:2,column:1});
be.add(new qx.ui.basic.Label(A).set({alignY:z}),{row:3,column:0});
var bg=new qx.ui.basic.Image().set({alignX:q});
bh.addTarget(bg,r,x);
be.add(bg,{row:3,column:1});
return be;
},showAddContactWindow:function(){if(this.__Vx==null){var bn=new qx.ui.layout.Grid(5,10);
var bp=new qx.ui.window.Window(K,o);
bp.set({width:165,height:100,showMinimize:false,showClose:false,showMaximize:false});
bp.setLayout(bn);
var bs=new qx.ui.basic.Label(M);
var bt=new qx.ui.form.TextField();
var bq=new qx.ui.form.ComboBox(v);
bq.add(new qx.ui.form.ListItem(P));
bq.add(new qx.ui.form.ListItem(N));
var bo=new qx.ui.basic.Label(s);
var bv=new qx.ui.form.Button(G);
var bu=new qx.ui.form.Button(Q);
this.__Vy=bt;
bv.setAllowGrowX(false);
bu.setAllowGrowX(false);
bp.addListener(I,bt.focus,bt);
bu.addListener(k,bp.close,bp);
var br=function(){var bw=new demobrowser.demo.virtual.messenger.BuddyModel();
bw.setName(bt.getValue());
bw.setGroup(bq.getValue());
this.messenger.getModel().push(bw);
this.messenger.getSelection().setItem(0,bw);
bp.close();
};
bv.addListener(k,br,this);
bp.addListener(u,function(e){var bx=e.getKeyIdentifier();

if(bx==L){br.call(this);
}else if(bx==R){bp.close();
}},this);
bp.add(bs,{row:0,column:0});
bp.add(bt,{row:0,column:1,colSpan:2});
bp.add(bo,{row:1,column:0});
bp.add(bq,{row:1,column:1,colSpan:2});
bp.add(bv,{row:2,column:1});
bp.add(bu,{row:2,column:2});
bn.setColumnAlign(0,y,j);
bn.setColumnAlign(1,U,j);
this.getRoot().add(bp,{left:20,top:20});
this.__Vx=bp;
}this.__Vy.setValue(i);
this.__Vx.center();
this.__Vx.open();
...
this.__qW=bj.left===undefined?0:bj.left;
this.__qV=bj.top===undefined?0:bj.top;
...
if(this.fireNonBubblingEvent(s,qx.event.type.Event,[false,true])){var bk=this.getLayoutProperties();
this.__qW=bk.left===undefined?0:bk.left;
this.__qV=bk.top===undefined?0:bk.top;
this.removeState(c);
this.hide();
this.fireEvent(B);
...
}}},_applyActive:function(bn,bo){if(bo){this.removeState(L);
}else{this.addState(L);
}},_getContentPaddingTarget:function(){return this.getChildControl(S);
},_applyShowStatusbar:function(bp,bq){bp?this.addState(N):this.removeState(N);

if(bp){this._showChildControl(R);
}else{this._excludeChildControl(R);
}},_applyCaptionBarChange:function(br,bs){this._updateCaptionBar();
},_applyStatus:function(bt,bu){var bv=this.getChildControl(Q,true);

if(bv){bv.setValue(bt);
}},_onWindowEventStop:function(e){e.stopPropagation();
},_onWindowMouseDown:function(e){this.setActive(true);
},_onWindowFocusOut:function(e){if(this.getModal()){return;
}var bw=e.getRelatedTarget();

if(bw!=null&&!qx.ui.core.Widget.contains(this,bw)){this.setActive(false);
...
(function(){var l="row-layer",k="selected",j="grid-lines",h="Boolean",g="Integer",f="cell.row",d="cell.renderer",c="_applyDelegate",b="__MD",a="qx.ui.virtual.form.List",A="Object",z="_applyCellRenderer",y="changeRowHeight",x="_applyRowCount",w="changeCellRenderer",v="_applyShowGridLines",u="resize",t="changeShowGridLines",s="changeDelegate",r="_applyUseWidgetCells",p="changeRowCount",q="_applyRowHeight",n="horizontal",o="virtual-list",m="__MC";
...
this.initRowHeight();
this.initDelegate();
},properties:{appearance:{refine:true,init:o},rowCount:{check:g,event:p,init:0,apply:x},rowHeight:{check:g,event:y,init:20,apply:q,themeable:true},showGridLines:{check:h,event:t,init:false,apply:v,themeable:true},useWidgetCells:{check:h,init:false,apply:r,themeable:true},cellRenderer:{event:w,apply:z,themeable:true},delegate:{check:A,event:s,init:null,nullable:true,apply:c}},members:{__MB:null,__MC:null,__MD:null,__ME:null,_initWidgetLayer:function(){var self=this;
var B={getCellWidget:function(C,D){var H=self._getCellData(C);

if(!H){return null;
}var E={};

if(self.__MC.isItemSelected(C)){E.selected=true;
...
this.__MD=new qx.ui.virtual.layer.WidgetCell(B);
this.getPane().addLayer(this.__MD);

if(!this.__MB){this.setCellRenderer(qx.ui.virtual.form.ListItemCell.getInstance());
}},_initHtmlLayer:function(){var self=this;
var K={getCellProperties:function(L,M){var N={};

if(self.__MC.isItemSelected(L)){N.selected=true;
}return self._getCellRenderer(L).getCellProperties(self._getCellData(L),N);
}};
this._showChildControl(l);
this.__MD=new qx.ui.virtual.layer.HtmlCell(K);
this.getPane().addLayer(this.__MD);

if(!this.__MB){this.setCellRenderer(new qx.ui.virtual.cell.Cell());
...
},styleSelectable:function(Q,R,S){if(self.__ME){self._styleWidgetSelectable(Q,R,S);
}else{self._styleHtmlSelectable(Q,R,S);
}}};
this.__MC=new qx.ui.virtual.selection.Row(this.getPane(),O);
this.__MC.attachMouseEvents(this.getPane());
this.__MC.attachKeyEvents(this);
...
},update:function(){if(this.__MD){this.__MD.updateLayerData();
...
},_applyUseWidgetCells:function(bf,bg){if(this.__ME!==null){throw new Error("The property 'useWidgetCells' cannot be set after the list has "+"been rendered.");
}},_applyCellRenderer:function(bh,bi){this.__MB=bh;

if(this.__MD){this.__MD.fullUpdate();
}},_getCellData:function(bj){return this._delegate.getCellData?this._delegate.getCellData(bj):null;
},_getCellRenderer:function(bk){return this._delegate.getCellRenderer?this._delegate.getCellRenderer(bk):this.__MB;
...
}}},syncWidget:function(){if(this.__ME!==null){return;
}this.__ME=this.getUseWidgetCells();

if(this.__ME){this._initWidgetLayer();
}else{this._initHtmlLayer();
}},_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);
}},destruct:function(){this._delegate=this.__MB=null;
this._disposeObjects(m,b);
}});
})();
...
var l=new demobrowser.demo.virtual.messenger.Controller(null,this);
this.bind(k,l,k);
this.setSelection(l.getSelection());
this.rowLayer=this.getChildControl(f);
this.rowLayer.set({colorEven:d,colorOdd:g});
this.getPane().addLayer(this.rowLayer);
new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:600,maxAbove:800,minBelow:600,maxBelow:800}).set({interval:500});
},properties:{model:{event:j,check:h,nullable:true},selection:{event:c}},members:{styleGroup:function(m){var n=b;
this.getPane().getRowConfig().setItemSize(m,15);
this.rowLayer.setColor(m,n);
...
this.__IY=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__Ja={};
this.__Jb={};
this.__Jc={};
this.__Jd={};
...
for(var K in N){if(!O[K]){this.__Jg.push(K);
}}L=L.superclass;
}},_getCssProperties:function(){return [J,l,C,q,d,c,e,h];
},_applyAppearance:function(P,Q){if(Q){this.__Jb={};
}},_getValue:function(R){if(this.__Ji){return qx.util.PropertyUtil.getThemeValue(this,R);
}else{return qx.util.PropertyUtil.getUserValue(this,R);
}},_storeStyle:function(S,T){var U;

if(this.__Ji){U=this.__Jb;
}else{U=this.__Ja;
}
...
}},getCellProperties:function(bj,bk){this.__Jk(bk);
...
},getCssClasses:function(bp,bq){var br=this.__IY.getCssClass(this.__Jh)||f;
return n+br;
},__Jk:function(bs){if(!bs){bs={};
}var bu=this.getAppearance();
var bt=bu+a+qx.lang.Object.getKeys(bs).sort().join(x);

if(this.__Jh==bt){return;
}this.__Jh=bt;
var bv=this.__Je[this.__Jh];

if(!bv){this.__Jl();
this.__Jm(bs);
this.__Jn(bs);
this.__Jo();
this.__Je[this.__Jh]=1;
}this.__Jp();
},__Jl:function(){var bw=qx.util.PropertyUtil;
var bx=this._getCssProperties();

for(var i=0;i<bx.length;i++){bw.deleteThemeValue(this,bx[i]);
}},__Jm:function(by){this.__Jb={};
this.__Ji=true;
...
},__Jn:function(){var bD=qx.lang.Object.getValues(this.__Jb).join(b);
this.__IY.computeClassForStyles(this.__Jh,bD);
},__Jo:function(){var bI=this.__Jg;
...
}}this.__Jf[this.__Jh]=bG;
},__Jp:function(){var bK=qx.util.PropertyUtil;
var bJ=this.__Jf[this.__Jh]||{};

for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);
}},getStyles:function(bM,bN){return qx.lang.Object.getValues(this.__Ja).join(b);
},getInsets:function(bO,bP){var bT=this.__Jc;
var bS=this.__Jd;
...
return [bU+bQ,top+bR];
}},destruct:function(){this.__IY=this.__Ja=this.__Jb=this.__Jc=this.__Jd=this.__Je=this.__Jf=this.__Jg=null;
}});
})();
(function(){var n=".qx-cell {",m="mshtml",l="engine.name",k="qx.ui.virtual.cell.CellStylesheet",j="none",i="default",h="ellipsis",g="}",f="hidden",e="} ",b=".",d="content-box",c="singleton",a="absolute";
qx.Class.define(k,{extend:qx.core.Object,type:c,construct:function(){qx.core.Object.call(this);
var o=n+
qx.bom.element.Style.compile({position:a,overflow:f,cursor:i,textOverflow:h,userSelect:j})+e;

if(!(qx.core.Environment.get(l)==m)){o+=n+qx.bom.element.BoxSizing.compile(d)+g;
}this.__Ix=qx.bom.Stylesheet.createElement(o);
this.__Iy={};
this.__Iz={};
},members:{__Ix:null,__Iy:null,__Iz:null,getStylesheet:function(){return this.__Ix;
},getCssClass:function(p){return this.__Iy[p]||null;
},computeClassForStyles:function(q,r){var s=this.__Iz[r];

if(!s){var s=this.__IA();
qx.bom.Stylesheet.addRule(this.__Ix,b+s,r);
this.__Iz[r]=s;
}this.__Iy[q]=s;
return s;
},__IA:function(){return "qx-cell-"+this.toHashCode()+"-"+(this.__IB++);
},__IB:0},destruct:function(){this.__Ix=this.__Iy=this.__Iz=null;
}});
})();
...
(function(){var h="horizontal",g="qx.debug",f="",e="gray",d="qx.ui.virtual.layer.GridLines",c="Color",b="PositiveInteger",a="html";
qx.Class.define(d,{extend:qx.ui.virtual.layer.Abstract,construct:function(i,j,k){qx.ui.virtual.layer.Abstract.call(this);
this.setZIndex(1);

if(j){this.setDefaultLineColor(j);
}
if(k!==undefined){this.setDefaultLineSize(k);
}this.__MF=[];
this.__MG=[];
this._isHorizontal=(i||h)==h;
},properties:{defaultLineColor:{init:e,check:c,themeable:true},defaultLineSize:{init:1,check:b,themeable:true}},members:{__MF:null,__MG:null,isHorizontal:function(){return this._isHorizontal;
},setLineColor:function(l,m){if(qx.core.Environment.get(g)){qx.core.Assert.assertPositiveNumber(l);
qx.core.Assert.assertString(m);
}this.__MF[l]=m;

if(this.__MH(l)){this.updateLayerData();
}},setLineSize:function(n,o){if(qx.core.Environment.get(g)){qx.core.Assert.assertPositiveInteger(n);
qx.core.Assert.assertPositiveInteger(o);
}this.__MG[n]=o;

if(this.__MH(n)){this.updateLayerData();
}},__MH:function(p){if(this._isHorizontal){var t=this.getFirstColumn();
var r=t+this.getColumnSizes().length-1;
return p>=t&&p<=r;
}else{var s=this.getFirstRow();
var q=s+this.getRowSizes().length-1;
return p>=s&&p<=q;
}},getLineSize:function(u){return this.__MG[u]||this.getDefaultLineSize();
},getLineColor:function(v){return this.__MF[v]||this.getDefaultLineColor();
},__MI:function(w,z,A){var top=0;
var B,C;

for(var y=0;y<A.length-1;y++){B=this.getLineColor(z+y);
C=this.getLineSize(z+y);
top+=A[y];
w.push("<div style='","position: absolute;","height: "+C+"px;","width: 100%;","top:",top-((C>1)?Math.floor(C/2):1),"px;","background-color:",B,"'>","</div>");
}},__MJ:function(D,E,F){var I=0;
var G,H;

for(var x=0;x<F.length-1;x++){G=this.getLineColor(E+x);
H=this.getLineSize(E+x);
I+=F[x];
D.push("<div style='","position: absolute;","width: "+H+"px;","height: 100%;","top: 0px;","left:",I-((H>1)?Math.floor(H/2):1),"px;","background-color:",G,"'>","</div>");
}},_fullUpdate:function(J,K,L,M){var N=[];

if(this._isHorizontal){this.__MI(N,J,L);
}else{this.__MJ(N,K,M);
}this.getContentElement().setAttribute(a,N.join(f));
},_updateLayerWindow:function(O,P,Q,R){var S=O!==this.getFirstRow()||Q.length!==this.getRowSizes().length;
var T=P!==this.getFirstColumn()||R.length!==this.getColumnSizes().length;

if((this._isHorizontal&&S)||(!this._isHorizontal&&T)){this._fullUpdate(O,P,Q,R);
...
qx.Class.define(m,{extend:qx.core.Object,construct:function(u,v){qx.core.Object.call(this);
this.__NS=[];
...
}},properties:{target:{check:f,event:g,nullable:true,init:null,apply:j},model:{check:s,event:q,nullable:true,init:null,apply:d},selection:{check:s,event:k,apply:h},delegate:{apply:p,event:o,init:null,nullable:true}},members:{__NT:null,__NU:null,__NV:null,__NW:null,__NX:null,__NY:null,__NS:null,_validDelegates:[t,r],_getRowData:function(w){var x=this.getModel();
return x?x.getItem(this.__Ob(w)):null;
},_getModelRow:function(y){return this.getModel().indexOf(y);
},getRowCount:function(){return this.__NS.length;
},update:function(){this.__Oa();
this._syncViewSelectionToModel();
},__Oa:function(){var z=this.getModel();

if(z==null){return;
}this.__NS=[];
this._runDelegateFilter(z);
this._runDelegateSorter(z);
...
if(this.__NS.length==0){return;
}var B=this._getDelegate(t);

if(B!=null){this.__NS.sort(function(a,b){return B(A.getItem(a),A.getItem(b));
});
}},_runDelegateFilter:function(C){if(typeof C!==c){return;
}var D=this._getDelegate(r);

for(var i=0,l=C.length;i<l;++i){if(D==null||D(C.getItem(i))){this.__NS.push(i);
}}},_containsDelegateMethod:function(E,F){var H=qx.lang.Type;

if(H.isObject(E)){if(H.isString(F)){return H.isFunction(E[F]);
}else{for(var G in this._validDelegates){if(H.isFunction(E[G])){return true;
}}}}return false;
},_getDelegate:function(I){var J=this.getDelegate();

if(this._containsDelegateMethod(J,I)){return J[I];
}return null;
},__Ob:function(K){return this.__NS[K];
},_applyDelegate:function(L,M){if(this.getTarget()==null||this.getModel()==null){return;
}
if(this._containsDelegateMethod(L)){this.__Oa();
}},_applyTarget:function(N,O){if(N!=null){N.setDelegate(this);
this.__NW=N.getSelectionManager().addListener("changeSelection",this._onChangeSelectionView,this);
}
if(O!=null){O.setDelegate(null);
O.getSelectionManager().removeListenerById(this.__NW);
}
if(this.getModel()==null){return;
}this.__Oa();
this._syncRowCount();
},_applyModel:function(P,Q){if(Q!=null){Q.removeListenerById(this.__NT);
Q.removeListenerById(this.__NU);
Q.removeListenerById(this.__NV);
}
if(P!=null){this.__Oa();
this.__NT=P.addListener("changeLength",this._onChangeLengthModel,this);
this.__NU=P.addListener("change",this._onChangeModel,this);
this.__NV=P.addListener("changeBubble",this._onChangeBubbleModel,this);
}
if(this.getTarget()!=null){this._syncRowCount();
}},_applySelection:function(R,S){if(R!=null){this.__NX=R.addListener("change",this._onChangeSelectionModel,this);
this.__NY=R.addListener("changeLength",this._onChangeSelectionModel,this);
this._syncModelSelectionToView();
}
if(S!=null){S.removeListenerById(this.__NX);
S.removeListenerById(this.__NY);
...
},_onChangeLengthModel:function(e){this.__Oa();
this._syncRowCount();
},_onChangeModel:function(e){var T=this.getTarget();
...
if(!Y){this.getSelection().removeAll();
return;
...
var ba=this.getSelection();
var bb=[];

for(var i=ba.length;i>=0;i--){var bd=this._getModelRow(ba.getItem(i));

if(bd!==-1){bb.push(bd);
}else{ba.removeAt(i);
}}bc.getSelectionManager().replaceSelection(bb);
this._ignoreSelectionChange=false;
},_syncRowCount:function(){var length=this.getRowCount();
this.getTarget().setRowCount(length);
},getCellData:function(be){return this._getRowData(be)||n;
}},destruct:function(){this.__NS=null;
}});
})();
(function(){var j="name",h="changeOpen",g="group",f="demobrowser.demo.virtual.messenger.Controller",d=".",c="cell.row";
qx.Class.define(f,{extend:qx.ui.virtual.form.ListController,construct:function(k,l){qx.ui.virtual.form.ListController.call(this,k,l);
this.__Vz=new demobrowser.demo.virtual.messenger.BuddyCell();
this.__VA=new demobrowser.demo.virtual.messenger.GroupCell();
this.__VA.addListener(h,this._onChangeOpenGroup,this);
this.__VB=[];
this.__VC={};
this.__VD=[];
this.__VE=new qx.util.DeferredCall(this._updateGrouping,this);
},members:{__VD:null,__VC:null,__VE:null,__VB:null,__Vz:null,__VA:null,_getRowData:function(m){return this.__VD[m];
},_getModelRow:function(n){return this.__VD.indexOf(n);
},_getRowCount:function(){return this.__VD.length;
},_isGroupHeader:function(o){return this.__VD[o] instanceof demobrowser.demo.virtual.messenger.GroupModel;
},_getGroupModel:function(name,p){var q=this.__VC[name];

if(!q){var q=new demobrowser.demo.virtual.messenger.GroupModel();
q.setName(name);
this.__VC[name]=q;
}q.setRow(p);
return q;
},_onChangeOpenGroup:function(e){var r=this.__VD[e.getData().getUserData(c)];
r.toggleOpen();
this.__VE.schedule();
},getCellRenderer:function(s){if(this._isGroupHeader(s)){return this.__VA;
}else{return this.__Vz;
}},isRowSelectable:function(t){return !this._isGroupHeader(t);
},_visualizeGrouping:function(u){var v=this.getTarget();

if(v){for(var i=0;i<this.__VB.length;i++){var w=this.__VB[i].getOldRow();

if(w!==null){v.unstyleGroup(w);
}}
for(var i=0;i<u.length;i++){var w=u[i].getRow();
v.styleGroup(w);
}}this.__VB=u;
},_updateGrouping:function(){var B=this.getModel();
this.__VD=[];
var C=[];
var y=[];

if(B&&B.length>0){C=qx.lang.Array.clone(B.toArray());
C.sort(function(a,b){var E=a.getGroup();
var F=b.getGroup();

if(E==F){return a.getName()<b.getName()?-1:1;
}return E>F?-1:1;
});
var A=C[0];
var x=this._getGroupModel(A.getGroup(),0);
this.__VD.push(x);
y.push(x);
var D=0;

for(var i=0;i<C.length;i++){var z=C[i];

if(z.getGroup()!==x.getName()){x.setItemCount(D);
D=0;
var x=this._getGroupModel(z.getGroup(),this.__VD.length);
this.__VD.push(x);
y.push(x);
}
if(x.isOpen()){this.__VD.push(z);
}else{this.getSelection().remove(z);
}D+=1;
}}x.setItemCount(D);
this._visualizeGrouping(y);
this._syncModelSelectionToView();
this._syncRowCount();
},_applyModel:function(G,H){qx.ui.virtual.form.ListController.prototype._applyModel.call(this,G,H);
this.__VE.schedule();
},_onChangeModel:function(e){qx.ui.virtual.form.ListController.prototype._onChangeModel.call(this,e);
this.__VE.schedule();
},_onChangeBubbleModel:function(e){var I=e.getData();

if(I.name){var J=I.name.toString().split(d)[1];

if(J==j||J==g){this.__VE.schedule();
...
qx.Class.define(b,{extend:qx.ui.virtual.cell.AbstractWidget,events:{changeOpen:a},members:{_createWidget:function(){var q=new qx.ui.basic.Atom().set({icon:p,textColor:d,font:n,padding:[0,3]});
q.addListener(c,function(e){this.fireDataEvent(o,e.getCurrentTarget());
},this);
return q;
},updateData:function(r,s){r.setLabel(s.getName()+l+s.getItemCount()+j);
var t=qx.core.Environment.get(k)==g?h:i;

if(s.isOpen()){r.setIcon(f+t);
}else{r.setIcon(m+t);
}}}});
})();
...
}},properties:{name:{init:c,event:g,check:a},row:{event:d,check:j,apply:b},open:{check:h,init:true,event:i},itemCount:{check:j,init:0,event:e}},members:{__VF:null,_applyRow:function(k,l){this.__VF=l;
},getOldRow:function(){return this.__VF;
}}});
})();
(function(){var l="scroll",k="scrollbar-x",j="scrollbar-y",i="_applyInterval",h="appear",g="qx.debug",f="interval",e="qx.ui.virtual.behavior.Prefetch",d="_applyScroller",c="qx.ui.virtual.core.Scroller",a="__Qs",b="Integer";
qx.Class.define(e,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(g)){this.assertObject(n);
this.assertPositiveInteger(n.minLeft);
this.assertPositiveInteger(n.maxLeft);
this.assertPositiveInteger(n.minRight);
this.assertPositiveInteger(n.maxRight);
this.assertPositiveInteger(n.minAbove);
this.assertPositiveInteger(n.maxAbove);
this.assertPositiveInteger(n.minBelow);
this.assertPositiveInteger(n.maxBelow);
}qx.core.Object.call(this);
this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);
this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);
this.__Qs=new qx.event.Timer(this.getInterval());
this.__Qs.addListener(f,this._onInterval,this);

if(m){this.setScroller(m);
}},properties:{scroller:{check:c,nullable:true,init:null,apply:d},interval:{check:b,init:200,apply:i}},members:{__Qt:null,__Qu:null,__Qs:null,__Qv:null,__Qw:null,setPrefetchX:function(o,p,q,r){this.__Qt=[o,p,q,r];
},setPrefetchY:function(s,t,u,v){this.__Qu=[s,t,u,v];
},_onInterval:function(){var w=this.__Qt;

if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);
qx.ui.core.queue.Manager.flush();
}var x=this.__Qu;

if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);
qx.ui.core.queue.Manager.flush();
}},_applyScroller:function(y,z){if(z){if(this.__Qv){z.getChildControl(k).removeListenerById(this.__Qv);
}
if(this.__Qw){z.getChildControl(j).removeListenerById(this.__Qw);
}}
if(y){if(!y.getContainerElement().getDomElement()){this.__Qs.stop();
y.addListenerOnce(h,this.__Qs.start,this.__Qs);
}else{this.__Qs.restart();
}this.__Qv=y.getChildControl(k).addListener(l,this.__Qs.restart,this.__Qs);
this.__Qw=y.getChildControl(j).addListener(l,this.__Qs.restart,this.__Qs);
}else{this.__Qs.stop();
}},_applyInterval:function(A,B){this.__Qs.setInterval(A);
}},destruct:function(){this.setScroller(null);
this.__Qt=this.__Qu=null;
...
(function(){var v="keypress",u="qx.debug",t="interval",s="keydown",r="mousedown",q="keyup",p="__nT",o="blur",n="Enter",m="__nU",d="Up",l="Escape",h="event.touch",c="qx.ui.menu.Manager",b="Left",g="Down",f="Right",j="__nS",a="singleton",k="Space";
...
},members:{__nV:null,__nW:null,__nT:null,__nU:null,__nS:null,_getChild:function(y,z,A,B){var C=y.getChildren();
var length=C.length;
var D;
...
}},hideAll:function(){var K=this.__nS;

if(K){for(var i=K.length-1;i>=0;i--){K[i].exclude();
}}},getActiveMenu:function(){var L=this.__nS;
return L.length>0?L[L.length-1]:null;
},scheduleOpen:function(M){this.cancelClose(M);
if(M.isVisible()){if(this.__nV){this.cancelOpen(this.__nV);
}}else if(this.__nV!=M){this.__nV=M;
this.__nT.restartWith(M.getOpenInterval());
}},scheduleClose:function(N){this.cancelOpen(N);
if(!N.isVisible()){if(this.__nW){this.cancelClose(this.__nW);
}}else if(this.__nW!=N){this.__nW=N;
this.__nU.restartWith(N.getCloseInterval());
}},cancelOpen:function(O){if(this.__nV==O){this.__nT.stop();
this.__nV=null;
}},cancelClose:function(P){if(this.__nW==P){this.__nU.stop();
this.__nW=null;
...
}if(this.__nS.length>0&&!this._isInMenu(Q)){this.hideAll();
}},__nX:{"Enter":1,"Space":1},__nY:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var R=this.getActiveMenu();

if(!R){return;
}var S=e.getKeyIdentifier();

if(this.__nY[S]||(this.__nX[S]&&R.getSelectedButton())){e.stopPropagation();
...
}},__oT:function(z){while(!(z instanceof qx.ui.menu.Menu)){z=z.getLayoutParent();
}return z;
