...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"2257bb0c2b2c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(k,{extend:demobrowser.demo.event.EventDemo,members:{__Tu:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__Tu=qx.lang.Function.bind(this.logMouseEvent,this);
...
if(B.checked){qx.bom.Event.addNativeListener(z,A[i],this.__Tu);
}qx.bom.Event.addNativeListener(B,o,qx.lang.Function.bind(this.__Tv,this));
}},__Tv:function(e){var F=qx.bom.Event.getTarget(e);
var E=F.id.split(w)[1];
var C=F.checked;
var D=document.getElementById(l);

if(C){qx.bom.Event.addNativeListener(D,E,this.__Tu);
}else{qx.bom.Event.removeNativeListener(D,E,this.__Tu);
