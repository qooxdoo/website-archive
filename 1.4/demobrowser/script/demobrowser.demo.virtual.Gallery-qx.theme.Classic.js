...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Gallery","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Gallery-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"5943b21e13eb"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="",k="selected",j="cell",h="layer",g="icon",f="#f3f3f3",d="label",c="Gallery (HTML - divs)",b="manager",a="default",P="demobrowser.demo.virtual.Gallery",O="demobrowser.demo.virtual.WidgetGallery",N="text-align: center;",M="auto",L="color: white; background-color: #00398D;",K="user-desktop.png",J="<img src='",I="'></img>",H="group",G="resize",s="folder.png",t="vertical",q="multi",r="network-server.png",o="user-trash.png",p="off",m="top",n="icon/32/places/",u="horizontal",v="demobrowser.demo.virtual.AbstractGallery",y="abstract",x="position: absolute;",A="demobrowser.demo.virtual.HtmlGallery",z="Gallery (widgets)",C="<br>",B="Icon #",w="__Vq",F="network-workgroup.png",E="text-selected",D="demobrowser.demo.virtual.GalleryCell";
...
new demobrowser.demo.virtual.WidgetGallery(z);
var Q=new demobrowser.demo.virtual.HtmlGallery(c);
Q.moveTo(400,50);
}}});
qx.Class.define(v,{extend:qx.ui.window.Window,type:y,construct:function(R){qx.ui.window.Window.call(this,R);
...
S.set({scrollbarX:p,scrollbarY:M});
S.getPane().addListener(G,this._onPaneResize,this);
this.add(S);
this.manager=new qx.ui.virtual.selection.CellRectangle(S.getPane(),this).set({mode:q,drag:true});
...
for(var i=0;i<be;i++){var bl=n+bk[Math.floor(Math.random()*bk.length)];
var bf=bi.resolve(bl);
var bj=bg.toUri(bf);
bh[i]={label:B+(i+1),icon:bl,resolvedIcon:bj};
}return bh;
}},destruct:function(){this.items=null;
this._disposeObjects(b);
}});
qx.Class.define(D,{extend:qx.ui.virtual.cell.AbstractWidget,members:{_createWidget:function(){var bm=new qx.ui.basic.Atom().set({iconPosition:m});
...
this.__Vq=new demobrowser.demo.virtual.GalleryCell();
...
if(bx){this.__Vq.updateStates(bz,{selected:1});
}else{this.__Vq.updateStates(bz,{});
...
}var bF=this.__Vq.getCellWidget(bG,bE);
bF.setUserData(j,bD);
return bF;
},poolCellWidget:function(bH){this.__Vq.pool(bH);
}},destruct:function(){this._disposeObjects(w,h);
}});
qx.Class.define(A,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bI){demobrowser.demo.virtual.AbstractGallery.call(this,bI);
...
var bK=new qx.ui.virtual.layer.GridLines(u,f);
bL.getPane().addLayer(bK);
var bK=new qx.ui.virtual.layer.GridLines(t,f);
bL.getPane().addLayer(bK);
return bL;
...
var bR=bS?L:l;
return {style:[x,N,this._fontCss,bR].join(l),content:[J,bT.resolvedIcon,I,C,bT.label].join(l)};
