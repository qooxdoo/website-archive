...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ExtendedTree","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ExtendedTree-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"a3af58bd5485"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="qx.data.Array",r="demobrowser.demo.data.model.Node",q="String",p="changeNames",o="changeName",n="__Th",m="",l="Validation Error: ",k="changeChild",j="- ",c="changeColor",h="Marge",f="AFFE",b="is no number (parseFloat says so!).",a="Homer",e="\n",d="changeName2",g="changeChildren";
qx.Class.define(r,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:s,event:g},child:{check:r,event:k,nullable:true},names:{check:s,event:p,init:new qx.data.Array(a,h)},name:{check:q,init:f,event:o},name2:{check:q,event:d},number:{init:10,validate:n},color:{event:c,nullable:true}},members:{__Th:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
}}throw new qx.core.ValidationError(l+t+b);
