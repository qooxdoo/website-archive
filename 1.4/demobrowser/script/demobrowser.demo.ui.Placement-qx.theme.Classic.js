...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Placement","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.Placement-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"beab8d2ad6e2"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="mousedown",r="changeSelection",q="top-left",p="bottom-right",o="right-top",n="bottom-left",m="left-bottom",l="top-right",k="demobrowser.demo.ui.Placement",j="Open DOM-Popup",c="DOM Popup",h="Open Popup",g="Content",b="right-bottom",a="DOM align control",f="domanchor",d="left-top";
qx.Class.define(k,{extend:qx.application.Standalone,members:{__Vj:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__Vj=[n,p,q,l,o,b,d,m];
t.add(this.createTestField(n),{left:20,top:20});
t.add(this.createTestField(p),{right:20,top:20});
t.add(this.createTestField(q),{right:20,bottom:20});
t.add(this.createTestField(l),{left:20,bottom:20});
t.add(this.createTestField(o),{left:20,top:250});
t.add(this.createTestField(m),{right:20,top:250});
t.add(this.createDomClick(),{left:200,top:100});
},createTestField:function(u){var y=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var w=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
w.add(new qx.ui.basic.Atom(g));
w.setPadding(20);
var v=new qx.ui.form.SelectBox;
var z=null;

for(var i=0;i<this.__Vj.length;i++){var x=new qx.ui.form.ListItem(this.__Vj[i]);
v.add(x);

if(this.__Vj[i]==u){z=x;
}}y.add(v);
v.addListener(r,function(e){w.setPosition(e.getData()[0].getLabel());
});
v.setSelection([z]);
var A=new qx.ui.form.Button(h);
y.add(A);
A.addListener(s,function(e){w.placeToWidget(A);
w.show();
});
return y;
},createDomClick:function(){var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var F=new qx.ui.basic.Label(a);
D.add(F);
var C=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
C.add(new qx.ui.basic.Atom(c));
C.setPadding(20);
var B=new qx.ui.form.SelectBox;

for(var i=0;i<this.__Vj.length;i++){B.add(new qx.ui.form.ListItem(this.__Vj[i]));
}D.add(B);
B.addListener(r,function(e){C.setPosition(e.getData()[0].getLabel());
});
var E=new qx.ui.form.Button(j);
D.add(E);
E.addListener(s,function(e){C.placeToElement(document.getElementById(f));
C.show();
});
return D;
