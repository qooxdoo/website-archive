...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.GroupedList","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"a406c59542ca"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(e,{extend:qx.application.Standalone,members:{__Vr:null,__Vs:null,__Vt:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
N.bind(k,this.__Vr,i);
N.bind(k,this.__Vs,i);
N.bind(k,this.__Vt,i);
...
P.add(Q);
var O=this.__Vr=new qx.ui.list.List().set({height:280,width:150,labelPath:l,labelOptions:{converter:function(R,S){return S?R+g+S.getLastname():h;
}}});
P.add(O,{top:20});
return P;
...
U.add(W);
var T=this.__Vs=new qx.ui.list.List().set({height:280,width:150,labelPath:l,labelOptions:{converter:function(X,Y){return Y?Y.getLastname()+t+X:h;
}}});
U.add(T,{top:20});
...
T.setDelegate(V);
T.setSelection(this.__Vr.getSelection());
return U;
...
bc.add(be);
var bb=this.__Vt=new qx.ui.list.List().set({height:280,width:150,labelPath:l,labelOptions:{converter:function(bf,bg){return bg?bf+g+bg.getLastname():h;
}}});
bc.add(bb,{top:20});
...
bb.setDelegate(bd);
bb.setSelection(this.__Vr.getSelection());
return bc;
}},destruct:function(){this.__Vr.dispose();
this.__Vs.dispose();
this.__Vt.dispose();
this.__Vr=this.__Vs=this.__Vt=null;
}});
})();
