...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Margin","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox_Margin-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"75713a647aff"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var e="main",d="green",c="yellow",b="middle",a="demobrowser.demo.layout.HBox_Margin";
...
var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(f);
f.add(this.getBox1());
f.add(this.getBox2());
f.add(this.getBox3());
f.add(this.getBox4());
f.add(this.getBox5());
},getBox1:function(){var g=new qx.ui.layout.HBox();
var i=new qx.ui.container.Composite(g).set({decorator:e,backgroundColor:c,allowGrowX:false});
g.setSpacing(5);
...
var h=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
i.add(k);
i.add(j);
i.add(h);
k.setAllowGrowY(false);
j.setAllowGrowY(false);
h.setAllowGrowY(false);
k.setMarginTop(20);
h.setMarginBottom(30);
return i;
},getBox2:function(){var l=new qx.ui.layout.HBox();
var n=new qx.ui.container.Composite(l).set({decorator:e,backgroundColor:c,allowGrowX:false});
l.setSpacing(5);
var p=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var o=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var m=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
n.add(p);
n.add(o);
n.add(m);
p.setMarginTop(20);
m.setMarginBottom(30);
return n;
},getBox3:function(){var q=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(q).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
q.setSpacing(5);
q.setAlignY(b);
var u=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var t=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var r=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
s.add(u);
s.add(t);
s.add(r);
u.setAllowGrowY(false);
t.setAllowGrowY(false);
r.setAllowGrowY(false);
u.setMarginTop(20);
r.setMarginBottom(30);
return s;
},getBox4:function(){var v=new qx.ui.layout.HBox();
var x=new qx.ui.container.Composite(v).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
v.setSpacing(5);
v.setAlignY(b);
var z=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var y=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
...
w.setMarginTop(5);
w.setMinHeight(50);
w.setMarginBottom(20);
return x;
},getBox5:function(){var A=new qx.ui.layout.HBox();
var C=new qx.ui.container.Composite(A).set({decorator:e,backgroundColor:c,height:100,allowGrowX:false});
A.setSpacing(5);
A.setAlignY(b);
var E=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
var D=new qx.ui.core.Widget().set({decorator:e,backgroundColor:d});
