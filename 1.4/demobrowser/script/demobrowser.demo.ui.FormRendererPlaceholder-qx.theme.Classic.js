...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererPlaceholder","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.FormRendererPlaceholder-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"5b9a772c8fd0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="execute",i="Name",h="Registration",g="demobrowser.demo.ui.FormRendererPlaceholder",f="Send",e="Bio",d="Country",c="Personal Information",b="Password",a="Reset";
...
var l=new qx.ui.form.Form();
l.addGroupHeader(h);
var k=new qx.ui.form.TextField();
k.setRequired(true);
l.add(k,i);
var p=new qx.ui.form.PasswordField();
p.setRequired(true);
l.add(p,b);
l.addGroupHeader(c);
l.add(new qx.ui.form.TextField(),d);
l.add(new qx.ui.form.TextArea(),e);
var n=new qx.ui.form.Button(f);
n.addListener(j,function(){if(l.validate()){alert("send...");
}},this);
l.addButton(n);
var m=new qx.ui.form.Button(a);
m.addListener(j,function(){l.reset();
},this);
l.addButton(m);
var o=new qx.ui.form.renderer.SinglePlaceholder(l);
