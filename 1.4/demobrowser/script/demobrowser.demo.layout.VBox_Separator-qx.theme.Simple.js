...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_Separator","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_Separator-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"a5df39f5450f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var h="main",g="green",f="separator-vertical",e="yellow",d="center",c="demobrowser.demo.layout.VBox_Separator",b="left",a="right";
...
var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(i);
i.add(this.getBox1());
i.add(this.getBox2());
i.add(this.getBox3());
},getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,allowGrowY:false});
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
j.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return j;
},getBox2:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,minWidth:60,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:b}));
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:d}));
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxWidth:40,alignX:a}));
return k;
},getBox3:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,f)).set({decorator:h,backgroundColor:e,allowGrowY:false});
var o=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,marginBottom:10});
var n=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,marginBottom:10,marginTop:20});
var l=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,marginBottom:10});
m.add(o);
m.add(n);
m.add(l);
return m;
