...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"4efb709591a4"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(n,{extend:qx.application.Native,members:{__TQ:null,__TR:1,__TS:0,__TT:0,__TU:0,main:function(){qx.application.Native.prototype.main.call(this);
...
this.__TQ=new qx.html.Element("div",y);
this.__TQ.addListener(h,this.__TV,this);
this.__TQ.addListener(v,this.__TW,this);
A.add(this.__TQ);
},__TV:function(e){if(e.isMultiTouch()){this.__TT=e.getRotation()+this.__TS;
this.__TU=e.getScale()*this.__TR;
this.__TQ.setStyle("-webkit-transform","rotate("+this.__TT+"deg) scale("+this.__TU+")");
}else{var D=parseInt(e.getDocumentLeft())-(parseInt(this.__TQ.getStyle("width"))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__TQ.getStyle("height"))/2);
this.__TQ.setStyles({"left":D+"px","top":top+"px"});
}},__TW:function(e){if(e.isMultiTouch()){this.__TS=this.__TT;
this.__TR=this.__TU;
}}}});
})();
