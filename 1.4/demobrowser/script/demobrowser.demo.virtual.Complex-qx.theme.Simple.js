...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Complex","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Complex-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"bd4123a5a62a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var d="demobrowser.demo.virtual.Complex",c="horizontal",b="rgb(238, 243, 255)",a="white";
...
new qx.ui.virtual.behavior.Prefetch(e,{minLeft:500,maxLeft:600,minRight:1000,maxRight:1200,minAbove:0,maxAbove:0,minBelow:0,maxBelow:0});
}}});
})();
...
this.__Vn=[];
},members:{_pool:null,__Vn:null,getCellData:function(s,t){if(!this.__Vn[s]){this.__Vn[s]=[];
}
if(!this.__Vn[s][t]){this.__Vn[s][t]={label:this.__Vo(),icon:this.__Vp()};
}return this.__Vn[s][t];
},getCellWidget:function(u,v){var w;

if(v%2==0){w=this._pool.atom.pop();

if(!w){w=new qx.ui.basic.Atom();
w.addListener(c,function(){var x=this.__Vp();
w.setIcon(x);
this.__Vn[u][v].icon=x;
},this);
}w.set(this.getCellData(u,v));
}else{w=this._pool.checkbox.pop();

if(!w){w=new qx.ui.form.CheckBox();
w.addListener(f,function(){this.setLabel(this.getLabel()==p?w.getUserData(q)+r+w.getUserData(o):p);
},w);
}w.set({value:u%2==0,label:u+r+v});
}w.setUserData(q,u);
w.setUserData(o,v);
return w;
},poolCellWidget:function(y){if(y.classname==a){this._pool.atom.push(y);
}else{this._pool.checkbox.push(y);
}},__Vo:function(){var name=m;

for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);
}return name;
},__Vp:function(){var z=n;
var B=k;
var C=[l,g,h,b,d];
var A=Math.floor(Math.random()*4);
return (z+16+e+B+C[A]);
}},destruct:function(){this._pool=this.__Vn=null;
}});
})();
