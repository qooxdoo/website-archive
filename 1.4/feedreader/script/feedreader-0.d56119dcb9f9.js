...
return content?g:l;
},getTextOverflow:function(){return n in document.documentElement.style||e in document.documentElement.style;
},getPlaceholder:function(){var i=document.createElement(a);
return h in i;
},getBorderRadius:function(){return t in document.documentElement.style||d in document.documentElement.style||q in document.documentElement.style;
},getBoxShadow:function(){return s in document.documentElement.style||v in document.documentElement.style||m in document.documentElement.style;
},getTranslate3d:function(){return r in window&&b in new WebKitCSSMatrix();
...
for(F=z.length;F>3;F-=3){D=t+qx.locale.Number.getGroupSeparator(this.__mW)+z.substring(F-3,F)+D;
}D=z.substring(0,F)+D;
}var B=this.getPrefix()?this.getPrefix():t;
var y=this.getPostfix()?this.getPostfix():t;
var E=B+(A?r:t)+D;

if(C.length>0){E+=t+qx.locale.Number.getDecimalSeparator(this.__mW)+C;
}E+=y;
return E;
},parse:function(I){var N=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__mW)+t);
var L=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__mW)+t);
...
}},"scrollbar/button":{alias:el,include:el,style:function(gm){var go=dk;

if(gm.left){go+=l;
}else if(gm.right){go+=cR;
}else if(gm.up){go+=Q;
}else{go+=cS;
}
if(gm.left||gm.right){return {padding:[0,0,0,gm.left?3:4],icon:go,width:15,height:14};
}else{var gn=qx.core.Environment.get(ep);
return {padding:gn?3:[3,2],icon:go,width:14,height:15};
}}},"scrollbar/button-begin":eK,"scrollbar/button-end":eK,"slider":{style:function(gp){var gt;
var gr=!!gp.focused;
var gs=!!gp.invalid;
var gq=!!gp.disabled;

if(gr&&gs&&!gq){gt=et;
}else if(gr&&!gs&&!gq){gt=ey;
}else if(gq){gt=ev;
}else if(!gr&&gs&&!gq){gt=ex;
}else{gt=eu;
}
if(qx.core.Environment.get(ep)){gt+=em;
}return {decorator:gt};
}},"slider/knob":{include:el,style:function(gu){return {decorator:gu.disabled?dA:bw,shadow:undefined,height:14,width:14,padding:0};
}},"list":{alias:G,style:function(gv){var gz;
var gx=!!gv.focused;
var gy=!!gv.invalid;
var gw=!!gv.disabled;

if(gx&&gy&&!gw){gz=et;
}else if(gx&&!gy&&!gw){gz=ey;
}else if(gw){gz=ev;
}else if(!gx&&gy&&!gw){gz=ex;
}else{gz=eu;
}
if(qx.core.Environment.get(ep)){gz+=em;
}return {backgroundColor:cx,decorator:gz};
}},"list/pane":eo,"listitem":{alias:en,style:function(gA){var gB;

if(gA.dragover){gB=gA.selected?c:J;
}else{gB=gA.selected?cy:undefined;

if(gB&&qx.core.Environment.get(ep)){gB+=em;
}}return {padding:gA.dragover?[4,4,2,4]:4,textColor:gA.selected?cB:undefined,decorator:gB};
}},"slidebar":{},"slidebar/scrollpane":{},"slidebar/content":{},"slidebar/button-forward":{alias:el,include:el,style:function(gC){return {padding:5,center:true,icon:gC.vertical?ct:y};
}},"slidebar/button-backward":{alias:el,include:el,style:function(gD){return {padding:5,center:true,icon:gD.vertical?bl:bD};
}},"tabview":{style:function(gE){return {contentPadding:16};
}},"tabview/bar":{alias:bP,style:function(gF){var gG={marginBottom:gF.barTop?-1:0,marginTop:gF.barBottom?-4:0,marginLeft:gF.barRight?-3:0,marginRight:gF.barLeft?-1:0,paddingTop:0,paddingRight:0,paddingBottom:0,paddingLeft:0};
...
}},"tabview/bar/button-forward":{include:bb,alias:bb,style:function(gH){if(gH.barTop||gH.barBottom){return {marginTop:2,marginBottom:2};
}else{return {marginLeft:2,marginRight:2};
}}},"tabview/bar/button-backward":{include:bK,alias:bK,style:function(gI){if(gI.barTop||gI.barBottom){return {marginTop:2,marginBottom:2};
}else{return {marginLeft:2,marginRight:2};
}}},"tabview/bar/scrollpane":{},"tabview/pane":{style:function(gJ){var gK=qx.core.Environment.get(ep)&&qx.core.Environment.get(ek);
return {decorator:gK?p:da,minHeight:100,marginBottom:gJ.barBottom?-1:0,marginTop:gJ.barTop?-1:0,marginLeft:gJ.barLeft?-1:0,marginRight:gJ.barRight?-1:0};
}},"tabview-page":{alias:eo,include:eo,style:function(gL){var gM=qx.core.Environment.get(ep)&&qx.core.Environment.get(ek);
return {padding:gM?[4,3]:undefined};
}},"tabview-page/button":{alias:en,style:function(gN){var gU,gQ=0;
var gT=0,gO=0,gR=0,gS=0;
var gP=qx.core.Environment.get(ek)&&qx.core.Environment.get(ej)&&qx.core.Environment.get(ep);

if(gN.checked){if(gN.barTop){gU=dj;
gQ=gP?[5,11]:[6,14];
gR=gN.firstTab?0:-5;
gS=gN.lastTab?0:-5;
}else if(gN.barBottom){gU=F;
gQ=gP?[5,11]:[6,14];
gR=gN.firstTab?0:-5;
gS=gN.lastTab?0:-5;
gT=3;
}else if(gN.barRight){gU=dt;
gQ=gP?[5,10]:[6,13];
gT=gN.firstTab?0:-5;
gO=gN.lastTab?0:-5;
gR=2;
...
gT=gN.firstTab?0:-5;
gO=gN.lastTab?0:-5;
}}else{if(gN.barTop){gU=dO;
gQ=gP?[3,9]:[4,10];
gT=4;
gR=gN.firstTab?5:1;
gS=1;
}else if(gN.barBottom){gU=ds;
gQ=gP?[3,9]:[4,10];
gO=4;
gR=gN.firstTab?5:1;
gS=1;
gT=3;
}else if(gN.barRight){gU=eA;
gQ=gP?[3,9]:[4,10];
gS=5;
gT=gN.firstTab?5:1;
gO=1;
...
if(gU&&gP){gU+=em;
}return {zIndex:gN.checked?10:5,decorator:gU,padding:gQ,marginTop:gT,marginBottom:gO,marginLeft:gR,marginRight:gS,textColor:gN.checked?cE:cI};
}},"tabview-page/button/label":{alias:cw,style:function(gV){return {padding:[0,1,0,1],margin:gV.focused?0:1,decorator:gV.focused?bg:undefined};
}},"tabview-page/button/close-button":{alias:en,style:function(gW){return {icon:f};
}},"toolbar":{style:function(gX){var gY=qx.core.Environment.get(ep);
return {decorator:gY?cU:cg,spacing:2};
}},"toolbar/part":{style:function(ha){return {decorator:cd,spacing:2};
}},"toolbar/part/container":{style:function(hb){return {paddingLeft:2,paddingRight:2};
}},"toolbar/part/handle":{style:function(hc){return {source:N,marginLeft:3,marginRight:3};
}},"toolbar-button":{alias:en,style:function(hd){var hf;

if(hd.pressed||(hd.checked&&!hd.hovered)||(hd.checked&&hd.disabled)){hf=eI;
}else if(hd.hovered&&!hd.disabled){hf=be;
}var he=qx.core.Environment.get(ep)&&qx.core.Environment.get(ek);

if(he&&hf){hf+=em;
}return {marginTop:2,marginBottom:2,padding:(hd.pressed||hd.checked||hd.hovered)&&!hd.disabled||(hd.disabled&&hd.checked)?3:5,decorator:hf};
}},"toolbar-menubutton":{alias:eq,include:eq,style:function(hg){return {showArrow:true};
}},"toolbar-menubutton/arrow":{alias:cA,include:cA,style:function(hh){return {source:S};
}},"toolbar-splitbutton":{style:function(hi){return {marginTop:2,marginBottom:2};
}},"toolbar-splitbutton/button":{alias:eq,include:eq,style:function(hj){return {icon:ct,marginTop:undefined,marginBottom:undefined};
}},"toolbar-splitbutton/arrow":{alias:eq,include:eq,style:function(hk){if(hk.pressed||hk.checked||(hk.hovered&&!hk.disabled)){var hl=1;
}else{var hl=3;
}return {padding:hl,icon:ct,marginTop:undefined,marginBottom:undefined};
}},"toolbar-separator":{style:function(hm){return {decorator:E,margin:7};
}},"tree":ez,"tree-item":{style:function(hn){var ho=hn.selected?cy:undefined;

if(ho&&qx.core.Environment.get(ep)){ho+=em;
}return {padding:[2,6],textColor:hn.selected?cB:undefined,decorator:ho};
}},"tree-item/icon":{include:cA,style:function(hp){return {paddingRight:5};
}},"tree-item/label":cw,"tree-item/open":{include:cA,style:function(hq){var hr;

if(hq.selected&&hq.opened){hr=eJ;
}else if(hq.selected&&!hq.opened){hr=dd;
}else if(hq.opened){hr=W;
}else{hr=by;
}return {padding:[0,5,0,2],source:hr};
}},"tree-folder":{include:dI,alias:dI,style:function(hs){var hu,ht;

if(hs.small){hu=hs.opened?eN:eO;
ht=eN;
}else if(hs.large){hu=hs.opened?bO:di;
ht=bO;
}else{hu=hs.opened?bn:R;
ht=bn;
}return {icon:hu,iconOpened:ht};
}},"tree-file":{include:dI,alias:dI,style:function(hv){return {icon:hv.small?bI:hv.large?db:K};
}},"treevirtual":bm,"treevirtual-folder":{style:function(hw){return {icon:hw.opened?eN:eO};
}},"treevirtual-file":{include:bG,alias:bG,style:function(hx){return {icon:bI};
}},"treevirtual-line":{style:function(hy){return {icon:dG};
}},"treevirtual-contract":{style:function(hz){return {icon:W,paddingLeft:5,paddingTop:2};
}},"treevirtual-expand":{style:function(hA){return {icon:by,paddingLeft:5,paddingTop:2};
}},"treevirtual-only-contract":dK,"treevirtual-only-expand":u,"treevirtual-start-contract":dK,"treevirtual-start-expand":u,"treevirtual-end-contract":dK,"treevirtual-end-expand":u,"treevirtual-cross-contract":dK,"treevirtual-cross-expand":u,"treevirtual-end":{style:function(hB){return {icon:dG};
}},"treevirtual-cross":{style:function(hC){return {icon:dG};
}},"tooltip":{include:cs,style:function(hD){return {backgroundColor:dl,padding:[1,3,2,3],offset:[15,5,5,5]};
}},"tooltip/atom":en,"tooltip-error":{include:dH,style:function(hE){var hF=qx.core.Environment.get(ek)&&qx.core.Environment.get(ej);
return {textColor:cB,backgroundColor:undefined,placeMethod:eo,offset:[0,0,0,14],marginTop:-2,position:B,showTimeout:100,hideTimeout:10000,decorator:hF?b:dp,shadow:bQ,font:eg,padding:hF?3:undefined};
}},"tooltip-error/atom":en,"window":{style:function(hG){var hH=qx.core.Environment.get(ek)&&qx.core.Environment.get(ep)&&qx.core.Environment.get(ej);
var hI=cM;

if(hH){if(hG.showStatusbar){hI=dr;
}else{hI=dq;
}}return {decorator:hI,contentPadding:[10,10,10,10],margin:[0,5,5,0]};
}},"window/pane":{style:function(hJ){var hK=qx.core.Environment.get(ek)&&qx.core.Environment.get(ep)&&qx.core.Environment.get(ej);
return {decorator:hK?cK:O};
}},"window/captionbar":{style:function(hL){var hM=qx.core.Environment.get(ek)&&qx.core.Environment.get(ep)&&qx.core.Environment.get(ej);
var hN=hL.active?co:ea;

if(hM){hN+=em;
}return {decorator:hN,textColor:hL.active?ee:bt,minHeight:26,paddingRight:2};
}},"window/icon":{style:function(hO){return {margin:[5,0,3,6]};
}},"window/title":{style:function(hP){return {alignY:cz,font:eg,marginLeft:6,marginRight:12};
}},"window/minimize-button":{alias:en,style:function(hQ){return {icon:hQ.active?hQ.hovered?dY:eB:eC,margin:[4,8,2,0]};
}},"window/restore-button":{alias:en,style:function(hR){return {icon:hR.active?hR.hovered?cG:cD:k,margin:[5,8,2,0]};
}},"window/maximize-button":{alias:en,style:function(hS){return {icon:hS.active?hS.hovered?bh:bf:I,margin:[4,8,2,0]};
}},"window/close-button":{alias:en,style:function(hT){return {icon:hT.active?hT.hovered?g:dT:cb,margin:[4,8,2,0]};
}},"window/statusbar":{style:function(hU){var hV=qx.core.Environment.get(ek)&&qx.core.Environment.get(ep)&&qx.core.Environment.get(ej);
return {padding:[2,6],decorator:hV?cW:dm,minHeight:18};
}},"window/statusbar-text":{style:function(hW){return {font:dw};
}},"iframe":{style:function(hX){return {decorator:ei};
}},"resizer":{style:function(hY){var ia=qx.core.Environment.get(ej)&&qx.core.Environment.get(ek)&&qx.core.Environment.get(ep);
return {decorator:ia?cP:o};
}},"splitpane":{style:function(ib){return {decorator:i};
}},"splitpane/splitter":{style:function(ic){return {width:ic.horizontal?3:undefined,height:ic.vertical?3:undefined,backgroundColor:V};
}},"splitpane/splitter/knob":{style:function(id){return {source:id.horizontal?cr:ce};
}},"splitpane/slider":{style:function(ie){return {width:ie.horizontal?3:undefined,height:ie.vertical?3:undefined,backgroundColor:V};
}},"selectbox":el,"selectbox/atom":en,"selectbox/popup":cs,"selectbox/list":{alias:ez},"selectbox/arrow":{include:cA,style:function(ig){return {source:ct,paddingLeft:5};
}},"datechooser":{style:function(ih){var il;
var ij=!!ih.focused;
var ik=!!ih.invalid;
var ii=!!ih.disabled;

if(ij&&ik&&!ii){il=et;
}else if(ij&&!ik&&!ii){il=ey;
}else if(ii){il=ev;
}else if(!ij&&ik&&!ii){il=ex;
}else{il=eu;
}
if(qx.core.Environment.get(ep)){il+=em;
}return {padding:2,decorator:il,backgroundColor:cx};
}},"datechooser/navigation-bar":{},"datechooser/nav-button":{include:el,alias:el,style:function(im){var io={padding:[2,4],shadow:undefined};

if(im.lastYear){io.icon=dh;
io.marginRight=1;
}else if(im.lastMonth){io.icon=bD;
}else if(im.nextYear){io.icon=ck;
io.marginLeft=1;
}else if(im.nextMonth){io.icon=y;
}return io;
}},"datechooser/last-year-button-tooltip":dH,"datechooser/last-month-button-tooltip":dH,"datechooser/next-year-button-tooltip":dH,"datechooser/next-month-button-tooltip":dH,"datechooser/last-year-button":dM,"datechooser/last-month-button":dM,"datechooser/next-month-button":dM,"datechooser/next-year-button":dM,"datechooser/month-year-label":{style:function(ip){return {font:eg,textAlign:dE,textColor:ip.disabled?cv:undefined};
}},"datechooser/date-pane":{style:function(iq){return {textColor:iq.disabled?cv:undefined,marginTop:2};
}},"datechooser/weekday":{style:function(ir){return {textColor:ir.disabled?cv:ir.weekend?bu:undefined,textAlign:dE,paddingTop:2,backgroundColor:bN};
}},"datechooser/week":{style:function(is){return {textAlign:dE,padding:[2,4],backgroundColor:bN};
}},"datechooser/day":{style:function(it){var iu=it.disabled?undefined:it.selected?cy:undefined;

if(iu&&qx.core.Environment.get(ep)){iu+=em;
}return {textAlign:dE,decorator:iu,textColor:it.disabled?cv:it.selected?cB:it.otherMonth?bu:undefined,font:it.today?eg:undefined,padding:[2,4]};
}},"combobox":{style:function(iv){var iz;
var ix=!!iv.focused;
var iy=!!iv.invalid;
var iw=!!iv.disabled;

if(ix&&iy&&!iw){iz=et;
}else if(ix&&!iy&&!iw){iz=ey;
}else if(iw){iz=ev;
}else if(!ix&&iy&&!iw){iz=ex;
}else{iz=eu;
}
if(qx.core.Environment.get(ep)){iz+=em;
}return {decorator:iz};
}},"combobox/popup":cs,"combobox/list":{alias:ez},"combobox/button":{include:el,alias:el,style:function(iA,iB){var iC={icon:ct,padding:[iB.padding[0],iB.padding[1]-6],shadow:undefined,margin:undefined};

if(iA.selected){iC.decorator=bB;
}return iC;
}},"combobox/textfield":{include:w,style:function(iD){return {decorator:undefined};
}},"menu":{style:function(iE){var iF=qx.core.Environment.get(ep)&&qx.core.Environment.get(ej);
var iG={decorator:iF?br:bX,shadow:iF?undefined:bH,spacingX:6,spacingY:1,iconColumnWidth:16,arrowColumnWidth:4,placementModeY:iE.submenu||iE.contextmenu?cV:cT};

if(iE.submenu){iG.position=B;
iG.offset=[-2,-3];
}return iG;
}},"menu/slidebar":eH,"menu-slidebar":eo,"menu-slidebar-button":{style:function(iH){var iI=iH.hovered?cy:undefined;

if(iI&&qx.core.Environment.get(ep)){iI+=em;
}return {decorator:iI,padding:7,center:true};
}},"menu-slidebar/button-backward":{include:bv,style:function(iJ){return {icon:iJ.hovered?dv:bl};
}},"menu-slidebar/button-forward":{include:bv,style:function(iK){return {icon:iK.hovered?ec:ct};
}},"menu-separator":{style:function(iL){return {height:0,decorator:q,margin:[4,2]};
}},"menu-button":{alias:en,style:function(iM){var iN=iM.selected?cy:undefined;

if(iN&&qx.core.Environment.get(ep)){iN+=em;
}return {decorator:iN,textColor:iM.selected?cB:undefined,padding:[4,6]};
}},"menu-button/icon":{include:cA,style:function(iO){return {alignY:cz};
}},"menu-button/label":{include:cw,style:function(iP){return {alignY:cz,padding:1};
}},"menu-button/shortcut":{include:cw,style:function(iQ){return {alignY:cz,marginLeft:14,padding:1};
}},"menu-button/arrow":{include:cA,style:function(iR){return {source:iR.selected?m:y,alignY:cz};
}},"menu-checkbox":{alias:es,include:es,style:function(iS){return {icon:!iS.checked?undefined:iS.selected?M:ef};
}},"menu-radiobutton":{alias:es,include:es,style:function(iT){return {icon:!iT.checked?undefined:iT.selected?bs:cj};
}},"menubar":{style:function(iU){var iV=qx.core.Environment.get(ep);
return {decorator:iV?dz:dX};
}},"menubar-button":{alias:en,style:function(iW){var iX=(iW.pressed||iW.hovered)&&!iW.disabled?cy:undefined;

if(iX&&qx.core.Environment.get(ep)){iX+=em;
}return {decorator:iX,textColor:iW.pressed||iW.hovered?cB:undefined,padding:[3,8]};
}},"colorselector":eo,"colorselector/control-bar":eo,"colorselector/control-pane":eo,"colorselector/visual-pane":cu,"colorselector/preset-grid":eo,"colorselector/colorbucket":{style:function(iY){return {decorator:ei,width:16,height:16};
}},"colorselector/preset-field-set":cu,"colorselector/input-field-set":cu,"colorselector/preview-field-set":cu,"colorselector/hex-field-composite":eo,"colorselector/hex-field":w,"colorselector/rgb-spinner-composite":eo,"colorselector/rgb-spinner-red":er,"colorselector/rgb-spinner-green":er,"colorselector/rgb-spinner-blue":er,"colorselector/hsb-spinner-composite":eo,"colorselector/hsb-spinner-hue":er,"colorselector/hsb-spinner-saturation":er,"colorselector/hsb-spinner-brightness":er,"colorselector/preview-content-old":{style:function(ja){return {decorator:ei,width:50,height:10};
}},"colorselector/preview-content-new":{style:function(jb){return {decorator:ei,backgroundColor:cx,width:50,height:10};
}},"colorselector/hue-saturation-field":{style:function(jc){return {decorator:ei,margin:5};
}},"colorselector/brightness-field":{style:function(jd){return {decorator:ei,margin:[5,7]};
}},"colorselector/hue-saturation-pane":eo,"colorselector/hue-saturation-handle":eo,"colorselector/brightness-pane":eo,"colorselector/brightness-handle":eo,"colorpopup":{alias:cs,include:cs,style:function(je){return {padding:5,backgroundColor:z};
}},"colorpopup/field":{style:function(jf){return {decorator:ei,margin:2,width:14,height:14,backgroundColor:cx};
}},"colorpopup/selector-button":eh,"colorpopup/auto-button":eh,"colorpopup/preview-pane":cu,"colorpopup/current-preview":{style:function(jg){return {height:20,padding:4,marginLeft:4,decorator:ei,allowGrowX:true};
}},"colorpopup/selected-preview":{style:function(jh){return {height:20,padding:4,marginRight:4,decorator:ei,allowGrowX:true};
}},"colorpopup/colorselector-okbutton":{alias:eh,include:eh,style:function(ji){return {icon:df};
}},"colorpopup/colorselector-cancelbutton":{alias:eh,include:eh,style:function(jj){return {icon:dP};
}},"table":{alias:eo,style:function(jk){return {decorator:bm};
}},"table/statusbar":{style:function(jl){return {decorator:ci,padding:[0,2]};
}},"table/column-button":{alias:el,style:function(jm){var jn=qx.core.Environment.get(ep);
return {decorator:jn?Y:bz,padding:3,icon:bo};
}},"table-column-reset-button":{include:es,alias:es,style:function(){return {icon:t};
}},"table-scroller":eo,"table-scroller/scrollbar-x":dN,"table-scroller/scrollbar-y":dN,"table-scroller/header":{style:function(jo){var jp=qx.core.Environment.get(ep);
return {decorator:jp?Y:bz};
}},"table-scroller/pane":{style:function(jq){return {backgroundColor:dU};
}},"table-scroller/focus-indicator":{style:function(jr){return {decorator:bR};
}},"table-scroller/resize-line":{style:function(js){return {backgroundColor:cN,width:2};
}},"table-header-cell":{alias:en,style:function(jt){return {minWidth:13,minHeight:20,padding:jt.hovered?[3,4,2,4]:[3,4],decorator:jt.hovered?cX:L,sortIcon:jt.sorted?(jt.sortedAscending?dy:cl):undefined};
}},"table-header-cell/label":{style:function(ju){return {minWidth:0,alignY:cz,paddingRight:5};
}},"table-header-cell/sort-icon":{style:function(jv){return {alignY:cz,alignX:eR};
}},"table-header-cell/icon":{style:function(jw){return {minWidth:0,alignY:cz,paddingRight:5};
}},"table-editor-textfield":{include:w,style:function(jx){return {decorator:undefined,padding:[2,2],backgroundColor:cx};
}},"table-editor-selectbox":{include:C,alias:C,style:function(jy){return {padding:[0,2],backgroundColor:cx};
}},"table-editor-combobox":{include:dL,alias:dL,style:function(jz){return {decorator:undefined,backgroundColor:cx};
}},"progressive-table-header":{alias:eo,style:function(jA){return {decorator:bp};
}},"progressive-table-header-cell":{alias:en,style:function(jB){var jC=qx.core.Environment.get(ep);
return {minWidth:40,minHeight:25,paddingLeft:6,decorator:jC?eb:r};
}},"app-header":{style:function(jD){return {font:eg,textColor:cB,padding:[8,12],decorator:bY};
}},"app-header-label":cw,"virtual-list":ez,"virtual-list/row-layer":cJ,"row-layer":{style:function(jE){return {colorEven:dF,colorOdd:dC};
}},"group-item":{include:cw,alias:cw,style:function(jF){return {padding:4,decorator:qx.core.Environment.get(ep)?eE:eL,textColor:bd,font:eg};
}},"virtual-selectbox":C,"virtual-selectbox/dropdown":cs,"virtual-selectbox/dropdown/list":{alias:eP},"virtual-combobox":dL,"virtual-combobox/dropdown":cs,"virtual-combobox/dropdown/list":{alias:eP},"virtual-tree":ez,"virtual-tree-folder":cL,"virtual-tree-file":cn,"column-layer":eo,"cell":{style:function(jG){return {textColor:jG.selected?cB:eS,padding:[3,6],font:T};
}},"cell-string":ew,"cell-number":{include:ew,style:function(jH){return {textAlign:eR};
}},"cell-image":ew,"cell-boolean":{include:ew,style:function(jI){return {iconTrue:bV,iconFalse:dc};
}},"cell-atom":ew,"cell-date":ew,"cell-html":ew,"htmlarea":{"include":eo,style:function(jJ){return {backgroundColor:n};
}},"progressbar":{style:function(jK){return {decorator:dB,padding:[1],backgroundColor:de};
}},"progressbar/progress":{style:function(jL){var jM=jL.disabled?eL:cy;

if(qx.core.Environment.get(ep)){jM+=em;
}return {decorator:jM};
}}}});
})();
...
(function(){var m="separator-vertical",l="Posts",k="bold",j="__Cv",i="__Cu",h="_applyLoading",g="center",f="feedreader.view.List",e="single",d="middle",a="__Ct",c="feedreader/images/loading66.gif",b="Boolean";
...
p.setFont(k);
this._add(p);
this.__Ct=new qx.ui.container.Stack();
this._add(this.__Ct,{flex:1});
this.__Cu=new qx.ui.form.List();
this.__Cu.setDecorator(null);
this.__Cu.setSelectionMode(e);
this.__Cu.setPadding(0);
this.__Cu.setMargin(0);
this.__Ct.add(this.__Cu);
this.__Cv=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,g));
var n=new qx.ui.basic.Image(c);
n.setAlignY(d);
this.__Cv.add(n);
this.__Ct.add(this.__Cv);
},properties:{loading:{check:b,init:false,apply:h}},members:{__Ct:null,__Cu:null,__Cv:null,_applyLoading:function(q,r){if(q){this.__Ct.setSelection([this.__Cv]);
}else{this.__Ct.setSelection([this.__Cu]);
}},getList:function(){return this.__Cu;
}},destruct:function(){this._disposeObjects(i,a,j);
}});
})();
...
if(!feedreader.view.Article.__Cw){feedreader.view.Article.__Cw=true;
...
t.addListener(l,this.__Cy(r),this);
t.addListener(c,qx.lang.Function.bind(this.__Cx,this,r),this);
},__Cx:function(v,e){if(e.getData()==a||e.getData()==g||e.getData()==n){v.setState(m);
}},__Cy:function(w){return function(e){var x=e.getData();
if(x==n){w.setState(m);
return;
}w.setArticles(x);
w.setState(l);
...
(function(){var f="feedreader.view.Header",e="qx.version",d="qooxdoo ",c="default",b="Feed Reader",a="app-header";
qx.Class.define(f,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);
this.setLayout(new qx.ui.layout.HBox);
this.setAppearance(a);
var h=new qx.ui.basic.Label(b);
var g=new qx.ui.basic.Label(d+qx.core.Environment.get(e));
g.setFont(c);
this.add(h);
...
(function(){var l="execute",k="settings",j="loading",h="main",g="addfeed",f="selection[0]",d="north",c="new",b="changeModel",a="__CQ",V="__CK",U="article",T="__CS",S="__CI",R="__CO",Q="__CM",P="F1",O="selection[0].state",N="partLoaded",M="Control+A",s="loaded",t="icon/22/places/folder.png",q="__CJ",r="feedreader/images/loading22.gif",o="error",p="change",m="__CH",n="user",u="enabled",v="__CF",C="__CP",A="__CR",G="state",E="Control+D",I="__CL",H="icon/22/actions/process-stop.png",x="selection[0].articles",L="__CN",K="static",J="icon/22/apps/internet-feed-reader.png",w="model",y="feedreader.Application",z="Control+P",B="__CE",D="Control+R",F="feedreader.model.Feed";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__CE:null,__CF:null,__CG:null,__CH:null,__CI:null,__CJ:null,__CK:null,__CL:null,__CM:null,__CN:null,__CO:null,__CP:null,__CQ:null,__CR:null,__CS:null,__CT:false,__CU:false,main:function(){qx.application.Standalone.prototype.main.call(this);
qx.io.PartLoader.getInstance().addListener(N,function(e){this.debug("part loaded: "+e.getData().getName());
},this);
var X=qx.locale.Manager.getInstance().getLanguage();
var W=qx.Part.getInstance().getParts();
if(W[X]){qx.io.PartLoader.require([X],function(){qx.locale.Manager.getInstance().setLocale(X);
this.buildUpGui();
},this);
}else{this.warn("Cannot load locale part for current language "+X+", falling back to English.");
this.buildUpGui();
}},buildUpGui:function(){this._initializeCommands();
this._createLayout();
var Y=new feedreader.model.Model();
this.__CQ=Y.getFeedFolder();
this.__CS=Y.getStaticFeedFolder();
this.__CR=Y.getUserFeedFolder();
this._setUpBinding();
this.__CH.getRoot().setOpen(true);
this.__CH.getRoot().getChildren()[0].setOpen(true);
this.__CH.getRoot().getChildren()[1].setOpen(true);
this.__CH.setHideRoot(true);
this.__CE.getSelection().push(this.__CS.getFeeds().getItem(0));
this.reload();
},_setUpBinding:function(){var ba={converter:this._state2iconConverter};
this.__CE=new qx.data.controller.Tree(this.__CQ,this.__CH,"feeds","title");
this.__CE.setIconOptions(ba);
this.__CE.setIconPath(G);
this.__CF=new qx.data.controller.List(null,this.__CK.getList(),"title");
this.__CE.bind(x,this.__CF,w);
this.__CF.bind(f,this.__CO,U);
this.__CF.getSelection().addListener(p,this._listControllerChange,this);
this.__CF.addListener(b,this._treeControllerChange,this);
var bb={converter:this._state2loadingConverter};
this.__CE.bind(O,this.__CK,j,bb);
bb={converter:this._category2enabledConverter};
this.__CE.bind(f,this.__CJ.getRemoveButton(),u,bb);
},_category2enabledConverter:function(bc){return !!bc&&bc.getCategory()==n;
},_state2iconConverter:function(bd){if(bd==c||bd==j){return r;
}else if(bd==s){return J;
}else if(bd==o){return H;
}return t;
},_state2loadingConverter:function(be){if(be==c||be==j){return true;
}return false;
},_listControllerChange:function(bf){var bg=this.__CE.getSelection().getItem(0);
var bh=this.__CF.getSelection().getItem(0);
if(bh!=undefined){bg.setSelectedArticle(bh);
}},_treeControllerChange:function(bi){var bj=this.__CE.getSelection().getItem(0);
if(bj!=null&&bj.classname==F&&bj.getSelectedArticle()!=null&&bj.getArticles().contains(bj.getSelectedArticle())){qx.event.Timer.once(function(){this.__CF.getSelection().push(bj.getSelectedArticle());
},this,0);
}else{this.__CK.getList().scrollToY(0);
}},_createLayout:function(){var bk=new qx.ui.layout.Dock();
var bl=new qx.ui.container.Composite(bk);
this.getRoot().add(bl,{edge:0});
this.__CI=new feedreader.view.Header();
bl.add(this.__CI,{edge:d});
this.__CJ=new feedreader.view.ToolBar(this);
bl.add(this.__CJ,{edge:d});
this.__CL=new qx.ui.splitpane.Pane();
bl.add(this.__CL);
this.__CH=new qx.ui.tree.Tree();
this.__CH.setWidth(250);
this.__CH.setDecorator(h);
this.__CH.setPadding(0);
this.__CL.add(this.__CH,0);
this.__CM=new qx.ui.splitpane.Pane("vertical");
this.__CM.setDecorator(null);
this.__CL.add(this.__CM,1);
this.__CK=new feedreader.view.List(this.__CQ);
this.__CK.setHeight(200);
this.__CK.setDecorator(h);
this.__CM.add(this.__CK,0);
this.__CO=new feedreader.view.Article();
this.__CO.setDecorator(h);
this.__CM.add(this.__CO,1);
},_initializeCommands:function(){var bm={};
bm.reload=new qx.ui.core.Command(D);
bm.reload.addListener(l,this.reload,this);
bm.about=new qx.ui.core.Command(P);
bm.about.addListener(l,this.showAbout,this);
bm.preferences=new qx.ui.core.Command(z);
bm.preferences.addListener(l,this.showPreferences,this);
bm.addFeed=new qx.ui.core.Command(M);
bm.addFeed.addListener(l,this.showAddFeed,this);
bm.removeFeed=new qx.ui.core.Command(E);
bm.removeFeed.addListener(l,this.removeFeed,this);
this.__CG=bm;
},getCommand:function(bn){return this.__CG[bn];
},addFeed:function(bo,bp,bq){var br=new feedreader.model.Feed(bo,bp,bq);
this.__CR.getFeeds().push(br);
var bs=feedreader.io.FeedLoader.getInstance();
bs.load(br);
},removeFeed:function(){var bt=this.__CE.getSelection().getItem(0);
if(bt&&bt.getCategory&&bt.getCategory()!==K){var bu=this.__CR.getFeeds();
for(var i=0;i<bu.length;i++){if(bt===bu.getItem(i)){bu.splice(i,1);
return;
}}}},reload:function(){var bv=feedreader.io.FeedLoader.getInstance();
bv.loadAll(this.__CQ);
this.__CO.setArticle(null);
},showPreferences:function(){if(!this.__CU){this.__CJ.signalLoading(k,true);
}qx.io.PartLoader.require([k],function(){this.__CU=true;
if(!this.__CN){this.__CN=new feedreader.view.PreferenceWindow();
this.getRoot().add(this.__CN);
}this.__CN.center();
this.__CN.open();
this.__CJ.signalLoading(k,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){if(!this.__CT){this.__CJ.signalLoading(g,true);
}qx.io.PartLoader.require([g],function(){this.__CT=true;
if(!this.__CP){this.__CP=new feedreader.view.AddFeedWindow(this);
this.getRoot().add(this.__CP);
}this.__CP.center();
this.__CP.open();
this.__CJ.signalLoading(g,false);
},this);
}},destruct:function(){this.__CG=null;
this._disposeObjects(q,V,R,m,a,I,Q,S,T,A,B,v,L,C);
}});
})();
...
(function(){var k="enabled",j="originalIcon",i="__Dl",h=")",g="Remove feed",f="Preferences",d="excluded",c="addFeed",b="removeFeed",a="icon/22/actions/help-about.png",G="Reload the feeds. (%1)",F="Help",E="visible",D="feedreader.view.ToolBar",C="icon/22/actions/media-seek-forward.png",B="toolbar-button",A="Add feed",z="addfeed",y="icon/22/actions/view-refresh.png",x="(",r="reload",s="showItem",p="settings",q="about",n="icon/22/actions/dialog-cancel.png",o="Reload",l="preferences",m="icon/22/actions/dialog-ok.png",t="icon/22/apps/preferences-theme.png",u="hideItem",w="Open preferences window.",v="feedreader/images/loading22.gif";
qx.Class.define(D,{extend:qx.ui.toolbar.ToolBar,construct:function(H){qx.ui.toolbar.ToolBar.call(this);
this.__Dj={};
this.__Dk=new qx.ui.toolbar.Button(this.tr(A),m);
this.__Dk.setCommand(H.getCommand(c));
this.add(this.__Dk);
this.__Dl=new qx.ui.toolbar.Button(this.tr(g),n);
this.__Dl.setCommand(H.getCommand(b));
this.__Dl.setEnabled(false);
this.add(this.__Dl);
this.addSeparator();
var K=new qx.ui.toolbar.Button(this.tr(o),y);
var I=H.getCommand(r);
K.setCommand(I);
K.setToolTipText(this.tr(G,I.toString()));
this.add(K);
this.addSeparator();
this.__Dm=new qx.ui.toolbar.Button(this.tr(f),t);
this.__Dm.setCommand(H.getCommand(l));
this.__Dm.setToolTipText(this.tr(w));
this.add(this.__Dm);
this.addSpacer();
var L=new qx.ui.toolbar.Button(this.tr(F),a);
var J=H.getCommand(q);
L.setCommand(J);
L.setToolTipText(x+J.toString()+h);
this.add(L);
this.setOverflowHandling(true);
var M=new qx.ui.toolbar.MenuButton(null,C);
M.setAppearance(B);
this.add(M);
this.setOverflowIndicator(M);
this.__Dn=new qx.ui.menu.Menu();
M.setMenu(this.__Dn);
this.addListener(u,this._onHideItem,this);
this.addListener(s,this._onShowItem,this);
},members:{__Dl:null,__Dn:null,__Dj:null,__Dk:null,__Dm:null,getRemoveButton:function(){return this.__Dl;
...
P.setVisibility(d);
},_getMenuItem:function(R){var S=this.__Dj[R.toHashCode()];
...
this.__Dj[R.toHashCode()]=S;
}return S;
},signalLoading:function(T,U){if(T==z){var V=this.__Dk;
}else if(T==p){var V=this.__Dm;
}else{return ;
