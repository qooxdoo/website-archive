qx.$$packageData['52282f98616a']={"locales":{},"resources":{"qx/icon/Tango/64/actions/object-flip-horizontal.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/audio-card.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/audio-input-microphone.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/battery.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/camera-photo.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/camera-web.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/computer.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/display.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/drive-harddisk.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/drive-optical.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/input-keyboard.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/input-mouse.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/media-flash.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/media-optical.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/multimedia-player.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/network-wired.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/network-wireless.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/pda.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/phone.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/printer.png":[64,64,"png","qx"],"qx/icon/Tango/64/devices/scanner.png":[64,64,"png","qx"]},"translations":{}};

qx.Part.$$notifyLoad("52282f98616a", function() {
...
},members:{__xw:null,__xx:null,_createView:function(){var bt=new qx.ui.layout.Grid();
bt.setRowFlex(1,1);
...
bn.addListener(f,this.__xA,this);
bn.addListener(g,this.__xz,this);
bn.addListener(h,this.__xy,this);
bn.addListener(k,this.__xC,this);
bn.addListener(j,this.__xB,this);
...
bs.addListener(f,this.__xA,this);
bs.addListener(g,this.__xz,this);
bs.addListener(h,this.__xy,this);
bs.addListener(k,this.__xC,this);
bs.addListener(j,this.__xB,this);
...
return bu;
},__xy:function(e){var bw=e.getData(m);
...
}}},__xz:function(e){var bA=e.getTarget();
var bz=bA.getSelection().concat();
e.addData(m,bz);
},__xA:function(e){e.addType(m);
e.addAction(z);
var bB=e.getTarget().getSelection()[0];
this.__xw.set({label:bB.getLabel(),icon:bB.getIcon(),width:bB.getBounds().width});
},__xB:function(e){this.__xx&&this.__xx.removeState(n);
this.__xw.setDomPosition(-1000,-1000);
},__xC:function(e){var bC=e.getOriginalTarget();

if(bC instanceof qx.ui.form.ListItem){if(bC!=this.__xx){this.__xx&&this.__xx.removeState(n);
bC.addState(n);
this.__xx=bC;
}}else{this.__xx&&this.__xx.removeState(n);
}this.__xw.setDomPosition(e.getDocumentLeft()+15,e.getDocumentTop()+15);
}}});
})();
