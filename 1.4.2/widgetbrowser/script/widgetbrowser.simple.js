...
var settings = {"qx.application":"widgetbrowser.Application","qx.revision":"28147","qx.theme":"qx.theme.Simple","qx.version":"1.4.2"};
...
var envinfo = {"qx.application":"widgetbrowser.Application","qx.debug":false,"qx.nativeScrollBars":true,"qx.revision":"28147","qx.theme":"qx.theme.Simple","qx.version":"1.4.2"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.4.2"},"widgetbrowser":{"resourceUri":"resource","sourceUri":"script","version":"trunk"}};
...
qx.$$loader = {
  ...
  urisBefore : [],
  packageHashes : {"0":"52165584f87d","1":"91f919462a1e","2":"8ac548364bcb","3":"11653e679347","4":"2b66fddad03b","5":"aa01a16b0344","6":"dca0e124084c","7":"4239813be154","8":"db3ffed5d2dc","9":"e4eb798b788f","10":"218f63bfa49a","11":"6c3b61df6de2","12":"296d60613f2a","13":"2f7d7e103d0d","14":"a6d0275661fe","15":"7cb662758cf3","16":"eb79e5bcf237","17":"9c14a5f4da34","18":"dc51ff3c07f3","19":"9a26e911c03a","20":"cf85156bd40e","21":"7dd55316d3e3","22":"cf4f06b3d700","23":"244e41590fb6","24":"63344e450ab9","25":"bca52770f243","26":"7d2e42c6642a","27":"9613e5b71d3a","28":"8204cdd5e2d1","29":"894ba942dfc6","30":"cb8bd39d2223","31":"c080fbc7718c","32":"04eb4fb3de33"},
  boot : "boot",
...
},members:{__RB:null,__RC:null,__RD:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var c=this.getRoot();
var d=new qx.ui.layout.Dock();
var e=new qx.ui.container.Composite(d);
c.add(e,{edge:0});
this.__RB=new widgetbrowser.view.Header();
e.add(this.__RB,{edge:b});
var scroll=this.__RD=new qx.ui.container.Scroll();
e.add(scroll);
this.__RC=new widgetbrowser.view.TabView();
this.__RC.set({minWidth:800,minHeight:800,padding:15});
scroll.add(this.__RC);
},getScroll:function(){return this.__RD;
}}});
})();
...
(function(){var m="pane",k="lastTab",j="bar",h="page",g="firstTab",f="right",d="bottom",c="button",b="changeSelection",a="close",B="top",A="left",z="__sr",y="qx.event.type.Data",x="barRight",w="beforeChangeSelection",v="close-button",u="tabview",t="vertical",s="_applyBarPosition",q="barLeft",r="horizontal",o="qx.ui.tabview.TabView",p="barTop",n="barBottom";
...
this.__sq={top:p,right:x,bottom:n,left:q};
this._createChildControl(j);
this._createChildControl(m);
var D=this.__sr=new qx.ui.form.RadioGroup;
D.setWrap(false);
D.addListener(b,this._onChangeSelection,this);
if(C!=null){this.setBarPosition(C);
}else{this.initBarPosition();
}},events:{"changeSelection":y},properties:{appearance:{refine:true,init:u},barPosition:{check:[A,f,B,d],init:B,apply:s}},members:{__sr:null,_createChildControlImpl:function(E,F){var G;
...
L.add(H);
this.__sr.add(I);
H.addState(this.__sq[this.getBarPosition()]);
H.addState(k);
...
R.remove(M);
this.__sr.remove(O);
M.removeState(this.__sq[this.getBarPosition()]);
...
},__sq:null,_applyBarPosition:function(T,U){var V=this.getChildControl(j);
var bb=T==A||T==f;
var Y=T==f||T==d;
...
if(U){var W=this.__sq[U];
V.removeState(W);
for(var i=0,l=bc.length;i<l;i++){bc[i].removeState(W);
}}
if(T){var X=this.__sq[T];
V.addState(X);
for(var i=0,l=bc.length;i<l;i++){bc[i].addState(X);
}}},getSelection:function(){var be=this.__sr.getSelection();
var bf=[];
...
this.init();
this.addListener(v,this.__RE,this);
this.__RF();
...
this.add(K);
},__RE:function(e){qx.bom.Cookie.set("currentTab",e.getData()[0].getLabel());
},__RF:function(){var O=qx.bom.Cookie.get("currentTab")||qx.bom.Cookie.set("currentTab","basic");
