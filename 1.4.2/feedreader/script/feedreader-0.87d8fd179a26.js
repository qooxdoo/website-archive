...
(function(){var u="keypress",t="interval",s="keydown",r="mousedown",q="keyup",p="__nT",o="blur",n="Enter",m="__nV",l="__nU",d="Up",k="Escape",h="event.touch",c="qx.ui.menu.Manager",b="Left",g="Down",f="Right",j="singleton",a="Space";
...
},members:{__nW:null,__nX:null,__nU:null,__nV:null,__nT:null,_getChild:function(x,y,z,A){var B=x.getChildren();
var length=B.length;
var C;
...
if(L.isVisible()){if(this.__nW){this.cancelOpen(this.__nW);
}}else if(this.__nW!=L){this.__nW=L;
this.__nU.restartWith(L.getOpenInterval());
}},scheduleClose:function(M){this.cancelOpen(M);
if(!M.isVisible()){if(this.__nX){this.cancelClose(this.__nX);
}}else if(this.__nX!=M){this.__nX=M;
this.__nV.restartWith(M.getCloseInterval());
}},cancelOpen:function(N){if(this.__nW==N){this.__nU.stop();
this.__nW=null;
}},cancelClose:function(O){if(this.__nX==O){this.__nV.stop();
this.__nX=null;
...
}},__nY:{"Enter":1,"Space":1},__oa:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var Q=this.getActiveMenu();

if(!Q){return;
}var R=e.getKeyIdentifier();

if(this.__oa[R]||(this.__nY[R]&&Q.getSelectedButton())){e.stopPropagation();
...
(function(){var l="separator-vertical",k="Posts",j="bold",i="__Cy",h="_applyLoading",g="__CA",f="__Cz",e="feedreader.view.List",d="single",c="middle",a="feedreader/images/loading66.gif",b="Boolean";
qx.Class.define(e,{extend:qx.ui.core.Widget,construct:function(){qx.ui.core.Widget.call(this);
var n=new qx.ui.layout.VBox();
n.setSeparator(l);
this._setLayout(n);
var o=new qx.ui.basic.Label(this.tr(k));
o.setPadding(5);
o.setAllowGrowX(true);
o.setFont(j);
this._add(o);
this.__Cy=new qx.ui.container.Stack();
this._add(this.__Cy,{flex:1});
this.__Cz=new qx.ui.form.List();
this.__Cz.setDecorator(null);
this.__Cz.setSelectionMode(d);
this.__Cz.setPadding(0);
this.__Cz.setMargin(0);
this.__Cy.add(this.__Cz);
this.__CA=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,"center"));
var m=new qx.ui.basic.Image(a);
m.setAlignY(c);
this.__CA.add(m);
this.__Cy.add(this.__CA);
},properties:{loading:{check:b,init:false,apply:h}},members:{__Cy:null,__Cz:null,__CA:null,_applyLoading:function(p,q){if(p){this.__Cy.setSelection([this.__CA]);
}else{this.__Cy.setSelection([this.__Cz]);
}},getList:function(){return this.__Cz;
}},destruct:function(){this._disposeObjects(f,i,g);
}});
})();
...
if(!feedreader.view.Article.__CB){feedreader.view.Article.__CB=true;
...
}},properties:{sort:{check:[f,a,b],init:f,apply:d},separatorX:{check:k,nullable:true,apply:l},separatorY:{check:k,nullable:true,apply:l},connectSeparators:{check:c,init:false,apply:l},spacingX:{check:j,init:0,apply:l},spacingY:{check:j,init:0,apply:l}},members:{__CE:null,__CF:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__CG:{north:1,south:2,west:3,east:4,center:5},__CH:{1:"top",2:"bottom",3:"left",4:"right"},__CI:function(){var q=this._getLayoutChildren();
var y,s;
var length=q.length;
var u=[];
var x=[];
...
delete this._invalidChildrenCache;
},renderLayout:function(A,B){if(this._invalidChildrenCache){this.__CI();
...
(function(){var l="execute",k="settings",j="loading",h="main",g="addfeed",f="selection[0]",d="north",c="new",b="changeModel",a="__CQ",V="__CX",U="__CK",T="article",S="__CS",R="__CO",Q="__CM",P="F1",O="selection[0].state",N="partLoaded",M="Control+A",s="loaded",t="icon/22/places/folder.png",q="__CJ",r="feedreader/images/loading22.gif",o="error",p="change",m="user",n="enabled",u="__CW",v="__CU",C="__CP",A="__CV",G="__CR",E="state",I="Control+D",H="icon/22/actions/process-stop.png",x="selection[0].articles",L="__CN",K="static",J="icon/22/apps/internet-feed-reader.png",w="model",y="feedreader.Application",z="Control+P",B="Control+R",D="feedreader.model.Feed",F="__CT";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__CJ:null,__CK:null,__CL:null,__CM:null,__CN:null,__CO:null,__CP:null,__CQ:null,__CR:null,__CS:null,__CT:null,__CU:null,__CV:null,__CW:null,__CX:null,__CY:false,__Da:false,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__CV=Y.getFeedFolder();
this.__CX=Y.getStaticFeedFolder();
this.__CW=Y.getUserFeedFolder();
this._setUpBinding();
this.__CM.getRoot().setOpen(true);
this.__CM.getRoot().getChildren()[0].setOpen(true);
this.__CM.getRoot().getChildren()[1].setOpen(true);
this.__CM.setHideRoot(true);
this.__CJ.getSelection().push(this.__CX.getFeeds().getItem(0));
this.reload();
},_setUpBinding:function(){var ba={converter:this._state2iconConverter};
this.__CJ=new qx.data.controller.Tree(this.__CV,this.__CM,"feeds","title");
this.__CJ.setIconOptions(ba);
this.__CJ.setIconPath(E);
this.__CK=new qx.data.controller.List(null,this.__CP.getList(),"title");
this.__CJ.bind(x,this.__CK,w);
this.__CK.bind(f,this.__CT,T);
this.__CK.getSelection().addListener(p,this._listControllerChange,this);
this.__CK.addListener(b,this._treeControllerChange,this);
var bb={converter:this._state2loadingConverter};
this.__CJ.bind(O,this.__CP,j,bb);
bb={converter:this._category2enabledConverter};
this.__CJ.bind(f,this.__CO.getRemoveButton(),n,bb);
},_category2enabledConverter:function(bc){return !!bc&&bc.getCategory()==m;
...
},_listControllerChange:function(bf){var bg=this.__CJ.getSelection().getItem(0);
var bh=this.__CK.getSelection().getItem(0);
if(bh!=undefined){bg.setSelectedArticle(bh);
}},_treeControllerChange:function(bi){var bj=this.__CJ.getSelection().getItem(0);
if(bj!=null&&bj.classname==D&&bj.getSelectedArticle()!=null&&bj.getArticles().contains(bj.getSelectedArticle())){qx.event.Timer.once(function(){this.__CK.getSelection().push(bj.getSelectedArticle());
},this,0);
}else{this.__CP.getList().scrollToY(0);
}},_createLayout:function(){var bk=new qx.ui.layout.Dock();
var bl=new qx.ui.container.Composite(bk);
this.getRoot().add(bl,{edge:0});
this.__CN=new feedreader.view.Header();
bl.add(this.__CN,{edge:d});
this.__CO=new feedreader.view.ToolBar(this);
bl.add(this.__CO,{edge:d});
this.__CQ=new qx.ui.splitpane.Pane();
bl.add(this.__CQ);
this.__CM=new qx.ui.tree.Tree();
this.__CM.setWidth(250);
this.__CM.setDecorator(h);
this.__CM.setPadding(0);
this.__CQ.add(this.__CM,0);
this.__CR=new qx.ui.splitpane.Pane("vertical");
this.__CR.setDecorator(null);
this.__CQ.add(this.__CR,1);
this.__CP=new feedreader.view.List(this.__CV);
this.__CP.setHeight(200);
this.__CP.setDecorator(h);
this.__CR.add(this.__CP,0);
this.__CT=new feedreader.view.Article();
this.__CT.setDecorator(h);
this.__CR.add(this.__CT,1);
},_initializeCommands:function(){var bm={};
bm.reload=new qx.ui.core.Command(B);
...
bm.removeFeed=new qx.ui.core.Command(I);
bm.removeFeed.addListener(l,this.removeFeed,this);
this.__CL=bm;
},getCommand:function(bn){return this.__CL[bn];
},addFeed:function(bo,bp,bq){var br=new feedreader.model.Feed(bo,bp,bq);
this.__CW.getFeeds().push(br);
var bs=feedreader.io.FeedLoader.getInstance();
bs.load(br);
},removeFeed:function(){var bt=this.__CJ.getSelection().getItem(0);
if(bt&&bt.getCategory&&bt.getCategory()!==K){var bu=this.__CW.getFeeds();
for(var i=0;i<bu.length;i++){if(bt===bu.getItem(i)){bu.splice(i,1);
return;
}}}},reload:function(){var bv=feedreader.io.FeedLoader.getInstance();
bv.loadAll(this.__CV);
this.__CT.setArticle(null);
},showPreferences:function(){if(!this.__Da){this.__CO.signalLoading(k,true);
}qx.io.PartLoader.require([k],function(){this.__Da=true;
if(!this.__CS){this.__CS=new feedreader.view.PreferenceWindow();
this.getRoot().add(this.__CS);
}this.__CS.center();
this.__CS.open();
this.__CO.signalLoading(k,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){if(!this.__CY){this.__CO.signalLoading(g,true);
}qx.io.PartLoader.require([g],function(){this.__CY=true;
if(!this.__CU){this.__CU=new feedreader.view.AddFeedWindow(this);
this.getRoot().add(this.__CU);
}this.__CU.center();
this.__CU.open();
this.__CO.signalLoading(g,false);
},this);
}},destruct:function(){this.__CL=null;
this._disposeObjects(R,C,F,Q,A,a,G,L,V,u,q,U,S,v);
}});
})();
...
}},__oU:function(t){while(!(t instanceof qx.ui.menu.Menu)){t=t.getLayoutParent();
}return t;
...
this.add(K);
this.addSeparator();
this.__Ds=new qx.ui.toolbar.Button(this.tr(g),t);
this.__Ds.setCommand(H.getCommand(l));
this.__Ds.setToolTipText(this.tr(w));
this.add(this.__Ds);
this.addSpacer();
var L=new qx.ui.toolbar.Button(this.tr(G),b);
var J=H.getCommand(q);
L.setCommand(J);
L.setToolTipText(x+J.toString()+i);
this.add(L);
...
this.__Dt=new qx.ui.menu.Menu();
M.setMenu(this.__Dt);
this.addListener(u,this._onHideItem,this);
this.addListener(s,this._onShowItem,this);
},members:{__Dr:null,__Dt:null,__Dp:null,__Dq:null,__Ds:null,getRemoveButton:function(){return this.__Dr;
...
P.setVisibility(f);
},_getMenuItem:function(R){var S=this.__Dp[R.toHashCode()];
...
this.__Dp[R.toHashCode()]=S;
}return S;
},signalLoading:function(T,U){if(T==A){var V=this.__Dq;
}else if(T==p){var V=this.__Ds;
}else{return ;
