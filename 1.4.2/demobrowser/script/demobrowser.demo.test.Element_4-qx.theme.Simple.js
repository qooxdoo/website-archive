...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_4","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Element_4-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"c5e740966a64"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
