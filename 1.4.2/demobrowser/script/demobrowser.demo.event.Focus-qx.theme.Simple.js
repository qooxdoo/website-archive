...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Focus","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.Focus-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"f5e22108a3d7"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var o="engine.name",n="",m="1px dotted red",l="demobrowser.demo.event.Focus",k="mshtml",j="blur",i="focusout",h="webkit",g="focus",f="#E8ECF6",b="deactivate",d="activate",c="1px solid black",a="focusin";
qx.Class.define(l,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
qx.event.Registration.addListener(document.documentElement,d,this._onActivate,this,true);
qx.event.Registration.addListener(document.documentElement,b,this._onDeactivate,this,true);
qx.event.Registration.addListener(document.documentElement,a,this._onFocusIn,this);
qx.event.Registration.addListener(document.documentElement,i,this._onFocusOut,this);
qx.event.Registration.addListener(window,g,this._onWindowFocus,this);
qx.event.Registration.addListener(window,j,this._onWindowBlur,this);
},_onWindowFocus:function(e){this.debug("Window focussed");
},_onWindowBlur:function(e){this.debug("Window blurred");
},_onActivate:function(e){this.debug("Activate: "+e.getTarget());
e.getTarget().style.background=f;
},_onDeactivate:function(e){this.debug("Deactivate: "+e.getTarget());
e.getTarget().style.background=n;
},_onFocusIn:function(e){this.debug("FocusIn: "+e.getTarget());

if(qx.core.Environment.get(o)==h){e.getTarget().style.border=m;
}else{e.getTarget().style.outline=m;
}},_onFocusOut:function(e){this.debug("FocusOut: "+e.getTarget());

if(qx.core.Environment.get(o)==k){e.getTarget().style.border=c;
}else{e.getTarget().style.outline=n;
}}}});
})();
