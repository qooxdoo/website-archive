...
qx.Class.define(e,{extend:qx.application.Standalone,members:{__Vx:null,__Vy:null,__Vz:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
N.bind(k,this.__Vx,i);
N.bind(k,this.__Vy,i);
N.bind(k,this.__Vz,i);
...
P.add(Q);
var O=this.__Vx=new qx.ui.list.List().set({height:280,width:150,labelPath:l,labelOptions:{converter:function(R,S){return S?R+g+S.getLastname():h;
}}});
P.add(O,{top:20});
return P;
...
U.add(W);
var T=this.__Vy=new qx.ui.list.List().set({height:280,width:150,labelPath:l,labelOptions:{converter:function(X,Y){return Y?Y.getLastname()+t+X:h;
}}});
U.add(T,{top:20});
...
T.setDelegate(V);
T.setSelection(this.__Vx.getSelection());
return U;
...
bc.add(be);
var bb=this.__Vz=new qx.ui.list.List().set({height:280,width:150,labelPath:l,labelOptions:{converter:function(bf,bg){return bg?bf+g+bg.getLastname():h;
}}});
bc.add(bb,{top:20});
...
bb.setDelegate(bd);
bb.setSelection(this.__Vx.getSelection());
return bc;
}},destruct:function(){this.__Vx.dispose();
this.__Vy.dispose();
this.__Vz.dispose();
this.__Vx=this.__Vy=this.__Vz=null;
}});
})();
