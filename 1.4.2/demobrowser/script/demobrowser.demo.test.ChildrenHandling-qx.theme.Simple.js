...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ChildrenHandling","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.ChildrenHandling-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"5cc975255d74"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
