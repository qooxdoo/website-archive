...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Decorator_Box","qx.theme":"qx.theme.Modern"};
...
if(k){this.__vT(k,m);
}if(l!=null){this.__vS.setInsets(l);
}}else{this.__vS=new qx.ui.decoration.BoxDiv(k,l,m);
}},properties:{baseImage:{check:b,nullable:true,apply:e}},members:{__vS:null,_isHorizontal:null,_setOrientation:function(n){this._isHorizontal=n==i;
},getMarkup:function(){return this.__vS.getMarkup();
},resize:function(o,p,q){this.__vS.resize(o,p,q);
},tint:function(r,s){},getInsets:function(){return this.__vS.getInsets();
},_applyInsets:function(t,u,name){var v=g+qx.lang.String.firstUp(name);
this.__vS[v](t);
},_applyBaseImage:function(w,x){if(this.__vS instanceof qx.ui.decoration.BoxDiv){this.__vS.setBaseImage(w);
}else{this.__vT(w);
}},__vT:function(y){this.__vS.setBorderImage(y);
...
}}}},tint:function(J,K){},_applyBaseImage:function(L,M){if(qx.core.Environment.get(v)){if(this.__vc){throw new Error("This decorator is already in-use. Modification is not possible anymore!");
...
var Q=S[1];
var O=S[2];
var T=this.__vd={t:Q+c+O,b:Q+t+O,c:Q+o+O,l:Q+e+O,r:Q+a+O};
this.__ve={top:N.getImageHeight(T.t),bottom:N.getImageHeight(T.b),left:N.getImageWidth(T.l),right:N.getImageWidth(T.r)};
