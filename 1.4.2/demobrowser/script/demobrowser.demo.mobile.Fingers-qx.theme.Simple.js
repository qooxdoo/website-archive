...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.Fingers","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.Fingers-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"9763a0654377"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(v,{extend:qx.application.Native,members:{__TD:null,__TE:null,main:function(){qx.application.Native.prototype.main.call(this);
...
this.__TD[i]=parseInt(M.target.style.left)-M.pageX;
this.__TE[i]=parseInt(M.target.style.top)-M.pageY;
}},_onTouchMove:function(e){var P=e.getAllTouches();

for(var i=0;i<P.length;i++){var O=P[i];

if(P.target==document.body){continue;
}qx.bom.element.Style.setStyles(O.target,{"left":(O.pageX+this.__TD[i])+l,"top":(O.pageY+this.__TE[i])+l});
}e.stop();
}}});
})();
