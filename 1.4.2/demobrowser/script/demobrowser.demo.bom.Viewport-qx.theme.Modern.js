...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Viewport","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Viewport-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"8358df052405"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
