...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Grid_Complex","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Grid_Complex-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"b491668075a5"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
j.add(this.getGrid1());
j.add(this.getGrid2());
},getGrid1:function(){var k=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,allowGrowX:false});
k.setLayout(new qx.ui.layout.Grid(5,20));
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:0});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:1});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,width:150,maxWidth:150}),{row:1,column:0,rowSpan:1,colSpan:2});
return k;
},getGrid2:function(){var l=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,width:500,allowShrinkX:false,allowShrinkY:false,allowGrowX:false});
...
o.setSpacing(5);
l.setLayout(o);
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:0});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:1,rowSpan:1,colSpan:2});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:1,column:0});
var n=new qx.ui.container.Composite().set({decorator:i,backgroundColor:b,width:400,padding:5});
l.add(n,{row:1,column:1,rowSpan:2,colSpan:2});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:2,column:0});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:3,column:0,rowSpan:1,colSpan:2});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:3,column:2});
var m=new qx.ui.layout.Grid();
n.setLayout(m);
m.setColumnAlign(1,e,d);
m.setColumnAlign(0,a,f);
m.setColumnMinWidth(1,40);
m.setSpacing(5);
m.setColumnFlex(1,1);
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,width:150}),{row:0,column:0});
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,height:70,allowGrowX:false}),{row:0,column:1});
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:60,allowGrowX:false}),{row:1,column:0});
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,minWidth:170}),{row:2,column:0});
return l;
}}});
})();
