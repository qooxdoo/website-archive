...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Inline","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.root.Inline-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"6881c4785b9c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
}},members:{__vs:false,__vt:false,__vr:null,__vu:function(){if(this.__vs||this.__vt){var y=qx.bom.element.Dimension.getSize(this.__vr);

if(this.__vs&&y.width<1){throw new Error("The root element "+this.__vr+" of "+this+" needs a width when its width size should be used!");
}
if(this.__vt){if(y.height<1){throw new Error("The root element "+this.__vr+" of "+this+" needs a height when its height size should be used!");
}if(y.height>=1&&qx.bom.element.Style.get(this.__vr,q,3)==p){qx.bom.element.Style.set(this.__vr,q,y.height+o);
}}qx.event.Registration.addListener(this.__vr,s,this._onResize,this);
}},_createContainerElement:function(){var z=this.__vr;

if(this.__vs||this.__vt){var D=document.createElement(b);
z.appendChild(D);
...
if((H.oldWidth!==H.width)&&this.__vs||(H.oldHeight!==H.height)&&this.__vt){qx.ui.core.queue.Layout.add(this);
}},_computeSizeHint:function(){var M=this.__vs;
var J=this.__vt;
...
if(M){var L=N.getContentWidth(this.__vr);
I.width=L;
I.minWidth=L;
I.maxWidth=L;
}
if(J){var K=N.getContentHeight(this.__vr);
I.height=K;
I.minHeight=K;
I.maxHeight=K;
}return I;
}},defer:function(O,P){qx.ui.core.MLayoutHandling.remap(P);
},destruct:function(){qx.event.Registration.removeListener(this.__vr,s,this._onResize,this);
this.__vr=null;
}});
})();
