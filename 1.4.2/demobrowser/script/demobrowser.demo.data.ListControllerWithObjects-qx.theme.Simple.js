...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ListControllerWithObjects","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ListControllerWithObjects-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"54662fee9cd3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
