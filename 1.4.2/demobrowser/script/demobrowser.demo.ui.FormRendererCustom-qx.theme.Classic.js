...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererCustom","qx.theme":"qx.theme.Classic"};
...
qx.Class.define(r,{extend:qx.ui.form.renderer.Single,members:{__Vn:0,__Vo:0,addItems:function(C,D,E,F){var I=0;
if(E!=null){this._add(this._createHeader(E),{row:I,column:this.__Vn,colSpan:2});
I++;
}for(var i=0;i<C.length;i++){var H=this._createLabel(D[i],C[i]);
this._add(H,{row:I,column:this.__Vn});
var G=C[i];
H.setBuddy(G);

if(G instanceof qx.ui.form.RadioGroup){G=this._createWidgetForRadioGroup(G);
}this._add(G,{row:I,column:this.__Vn+1});
if(F[i]&&F[i].placeholder){G.setPlaceholder(F[i].placeholder);
}I++;
}this.__Vn+=2;
this.__Vo<I?this.__Vo=I:null;
...
this._add(this._buttonRow,{row:this.__Vo,column:0,colSpan:this.__Vn});
