...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.ElementResize","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.ElementResize-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"60bd4f75ea5c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
