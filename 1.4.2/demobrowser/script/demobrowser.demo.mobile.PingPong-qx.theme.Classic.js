...
(function(){var k="touchmove",j="div",i="100%",h="black",g="green",f="demobrowser.demo.mobile.PingPong",d="30px",c="qx.debug",b="0px",a="12px",w="event.touch",v='Lucida Grande',u="innerHTML",t="qx.mobile.emulatetouch",s="right",r="engine.name",q="20px",p="webkit",o="none",n="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",l="left",m="absolute";
qx.Class.define(f,{extend:qx.application.Native,members:{__TF:null,__TG:null,__TH:null,__TI:null,__TJ:5,__TK:1,__TL:1,__TM:null,__TN:null,__TO:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(c)){qx.log.appender.Native;
qx.log.appender.Console;
}var B={"width":i,"height":i,"backgroundColor":h,"margin":b,"userSelect":o};
var E=new qx.html.Element(j,B);
E.useElement(document.body);
E.setRoot(true);

if(qx.core.Environment.get(r)!=p||(!qx.core.Environment.get(w)&&qx.core.Environment.get(t)==false)){var D={"color":g,"font-family":v,"font-size":a,"position":m,"left":d,"top":q};
...
var A=this.__TT(s);
E.add(A);
this.__TG=this.__TU("left");
z.add(this.__TG);
z.addListener(k,qx.lang.Function.bind(this.__TS,this,this.__TG),this);
this.__TF=this.__TU("right");
A.add(this.__TF);
A.addListener(k,qx.lang.Function.bind(this.__TS,this,this.__TF),this);
this.__TH=this.__TV();
E.add(this.__TH);
this.__TN=this.__TW();
z.add(this.__TN);
...
this.__TM=[0,0];
this.__TP();
},__TP:function(){this.__TH.setStyles({"left":"200px","top":"200px"});
this.__TI=new qx.event.Timer(40);
this.__TI.addListener("interval",function(){var x=(parseInt(this.__TH.getStyle("left"))+this.__TJ*this.__TK);
var y=(parseInt(this.__TH.getStyle("top"))+this.__TJ*this.__TL);
this.__TH.setStyle("left",x+"px");
this.__TH.setStyle("top",y+"px");
this.__TR();
},this);
this.__TI.start();
},__TQ:function(F){this.__TI.stop();
this.__TI.dispose();
this.__TJ=5;
this.__TM[F]=this.__TM[F]+1;
this.__TN.setAttribute("innerHTML",this.__TM[0]);
this.__TO.setAttribute("innerHTML",this.__TM[1]);
this.__TP();
},__TR:function(){var H=this.getBoundsFor(this.__TH);
if(H.top<=0){this.__TL=1;
}if(H.bottom>=window.innerHeight-5){this.__TL=-1;
}if(H.left<=0||H.right>=window.innerWidth){this.__TQ(H.left<=0?1:0);
}var I=this.getBoundsFor(this.__TG);

if(H.left<=I.right&&H.bottom>=I.top&&H.top<=I.bottom){this.__TK=1;
this.__TJ=Math.min(this.__TJ+1,20);
}var G=this.getBoundsFor(this.__TF);

if(H.right>=G.left&&H.bottom>=G.top&&H.top<=G.bottom){this.__TK=-1;
this.__TJ=Math.min(this.__TJ+1,20);
}},__TS:function(J,e){J.setStyles({"top":(e.getDocumentTop()-50)+"px"});
},getBoundsFor:function(K){return qx.bom.element.Location.get(K.getDomElement());
},__TT:function(L){var M={"width":"50%","height":"100%","position":"absolute","backgroundColor":"black"};

if(L=="left"){M["border-right"]="1px solid white";
}else{M["left"]="50%";
M["border-left"]="1px solid white";
}return new qx.html.Element("div",M);
},__TU:function(N){var O={"width":"30px","height":"100px","top":"100px","position":"absolute","backgroundColor":"white"};
O[N]="20px";
return new qx.html.Element("div",O);
},__TV:function(){var P={"width":"20px","height":"20px","position":"absolute","backgroundColor":"white","userSelect":"none"};
return new qx.html.Element("div",P);
},__TW:function(){var Q={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};
