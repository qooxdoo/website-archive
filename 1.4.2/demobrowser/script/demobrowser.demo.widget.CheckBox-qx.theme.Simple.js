...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.CheckBox","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.CheckBox-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"794295b1a9a3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
