...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ComboBox","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.ComboBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"da75fc82cfe0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var x="bold",w=" = ",v="... &gt; (as literal HTML entity)",u="... &gt; (as Richtext)",t="HTML entities: &laquo; &lt; &amp; &gt; &raquo;",s="icon",r="<u>Underlined Text</u>",q="label",p="'s Icon",o="demobrowser.demo.virtual.ComboBox",g="With icons",n="Default",k="changeValue",f="2^ ",d="<i>Italic Text</i>",j="<b>Bold Text</b>",h="Item ",l="Sorted and filtered model",c="With HTML (rich) text",m="icon/16/places/folder.png";
...
},_createDefaultExample:function(){var B=new qx.ui.basic.Label(n);
B.setFont(x);
this.getRoot().add(B,{left:20,top:25});
var y=new qx.ui.form.VirtualComboBox();
var A=[];

for(var i=1;i<401;i++){A.push(f+i+w+Math.pow(2,i));
}var z=qx.data.marshal.Json.createModel(A);
y.setModel(z);
y.addListener(k,function(e){this.debug("ChangeValue: "+e.getData());
});
this.getRoot().add(y,{left:20,top:40});
},_createIconExample:function(){var F=new qx.ui.basic.Label(g);
F.setFont(x);
this.getRoot().add(F,{left:160,top:25});
var C=new qx.ui.form.VirtualComboBox();
var E=[];

for(var i=1;i<31;i++){E.push({label:i+p,icon:m});
}var D=qx.data.marshal.Json.createModel(E);
C.setModel(D);
C.setLabelPath(q);
C.setIconPath(s);
this.getRoot().add(C,{left:160,top:40});
},_createHtmlExample:function(){var K=new qx.ui.basic.Label(c);
K.setFont(x);
this.getRoot().add(K,{left:300,top:25});
var G=new qx.ui.form.VirtualComboBox().set({width:200});
var I=[v,u,j,r,d,t];
var H=qx.data.marshal.Json.createModel(I);
G.setModel(H);
var J={configureItem:function(L){L.setRich(true);
}};
G.setDelegate(J);
G.setDefaultFormat(function(M){if(M){M=qx.lang.String.stripTags(M);
M=qx.bom.String.unescape(M);
}return M;
});
this.getRoot().add(G,{left:300,top:40});
},_createWideExample:function(){var O=new qx.ui.basic.Label(l);
O.setFont(x);
this.getRoot().add(O,{left:20,top:285});
var N=new qx.ui.form.VirtualComboBox();
var R=[];

for(var i=1;i<100;i++){R.push(h+i);
}var Q=qx.data.marshal.Json.createModel(R);
N.setModel(Q);
var P={sorter:function(a,b){return a<b?1:a>b?-1:0;
},filter:function(S){var T=parseInt(/([0-9]+)/.exec(S)[1],10);
return T%2?true:false;
}};
N.setDelegate(P);
this.getRoot().add(N,{left:20,top:300});
}}});
})();
...
(function(){var q="textfield",p="button",o="inner",n="change",m="dropdown",k="select",j="Function",h="Enter",g="list",f="virtual-combobox",c="_applyValue",e="click",d="single",b="changeValue",a="qx.ui.form.VirtualComboBox";
...
this.__Ly=s.getSelection();
this.__Ly.addListener(n,this.__LA,this);
},properties:{appearance:{refine:true,init:f},width:{refine:true,init:120},value:{nullable:true,event:b,apply:c},defaultFormat:{check:j,init:null,nullable:true}},members:{__Ly:null,__Lz:null,getTextSelection:function(){return this.getChildControl(q).getTextSelection();
...
},_beforeOpen:function(){this.__LB();
...
}},__LA:function(event){if(this.__Lz==true){return;
}var F=this.__Ly.getItem(0);
F=this.__LC(F);
this.setValue(F);
this.getChildControl("textfield").setValue(F);
},_applyValue:function(G,H){var I=this.getChildControl(q);
I.setValue(G);
},__LB:function(){var L=this.getChildControl("textfield").getValue();
var K=this.getChildControl("dropdown");
var J=K.getSelection();

if(this.__LC(J.getItem(0))!==L){this.__Lz=true;
J.removeAll();
this.__Lz=false;
if(L==null||L==""){return;
}var P=this.getModel();
...
break;
}}}},__LC:function(Q){var S=this.getLabelOptions();
...
}},destruct:function(){this.__Ly.removeListener(n,this.__LA,this);
this.__Ly=null;
}});
})();
...
this.addListener(d,this.__Kp,this);
this.initSelection(new qx.data.Array());
},properties:{autoHide:{refine:true,init:false},keepActive:{refine:true,init:true},selection:{check:e,event:b,apply:c,nullable:false,deferredInit:true}},members:{_target:null,_preselected:null,__Km:false,__Kn:false,open:function(){this.placeToWidget(this._target,true);
this.show();
},close:function(){this.hide();
},setPreselected:function(p){this._preselected=p;
this.__Kn=true;
var q=this.getChildControl(n).getSelection();
this.__Kr(new qx.data.Array([p]),q);
this.__Kn=false;
...
},_handleKeyboard:function(event){if(this.isVisible()&&event.getKeyIdentifier()===g){this.__Kq();
return;
}var u=event.clone();
u.setTarget(this.getChildControl(n));
u.setBubbles(false);
this.getChildControl(n).dispatchEvent(u);
},_handleMouse:function(event){this.__Kq();
},__Ko:function(event){if(this.__Km){return;
...
this.__Kr(w,v);
this.__Km=false;
},_onListChangeSelection:function(event){if(this.__Kn){return;
}var x=this.getChildControl(n).getSelection();

if(this.isVisible()){this.setPreselected(x.getItem(0));
}else{this.__Km=true;
this.__Kr(x,this.getSelection());
this.__Km=false;
}},__Kp:function(event){if(this.isVisible()){if(this._preselected==null){var y=this.getSelection();
...
},_applySelection:function(A,B){A.addListener(m,this.__Ko,this);

if(B!=null){B.removeListener(m,this.__Ko,this);
}this.__Kr(A,this.getChildControl(n).getSelection(A));
},__Kq:function(){if(this._preselected!=null){var C=this.getSelection();
C.splice(0,1,this._preselected);
this._preselected=null;
this.close();
}},__Kr:function(D,E){if(D.equals(E)){return;
}
...
}},__Ks:function(){this.__Kt();
this.__Ku();
},__Kt:function(){var H=this._target.getBounds().width;
this.setWidth(H);
},__Ku:function(){var I=this.__Kv();
...
}},__Kv:function(){var M=this.getLayoutLocation(this._target);
...
(function(){var w="appear",v="qx.ui.virtual.core.CellEvent",u="update",t="change",s="qx.event.type.Data",r="qx.ui.virtual.core.Pane",q="resize",p="click",o="scrollX",n="dblclick",f="contextmenu",m="qx.debug",j="cellClick",c="__KV",b="cellContextmenu",h="__KN",g="__KW",k="qx.event.type.Event",a="__KO",l="cellDblclick",d="scrollY";
qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(x,y,z,A){qx.ui.core.Widget.call(this);
this.__KN=new qx.ui.virtual.core.Axis(z,x);
this.__KO=new qx.ui.virtual.core.Axis(A,y);
this.__KP=0;
this.__KQ=0;
this.__KR=0;
this.__KS=0;
...
this._add(this.__KV);
this.__KW=[];
this.__KN.addListener(t,this.fullUpdate,this);
this.__KO.addListener(t,this.fullUpdate,this);
...
for(var i=0;i<this.__KW.length;i++){var D=this.__KW[i];

if(D.isVisible()){C.push(D);
}}return C;
},getScrollMaxX:function(){var E=this.getBounds();

if(E){return Math.max(0,this.__KO.getTotalSize()-E.width);
}return 0;
},getScrollMaxY:function(){var F=this.getBounds();

if(F){return Math.max(0,this.__KN.getTotalSize()-F.height);
}return 0;
...
if(this.__KP!==G){var I=this.__KP;
this.__KP=G;
...
if(J!==this.__KQ){var L=this.__KQ;
this.__KQ=J;
this._deferredUpdateScrollPosition();
...
return;
}var Q=this.__KN.getItemPosition(M);
var O=Q+this.__KN.getItemSize(M);
...
return;
}var T=this.__KO.getItemPosition(R);
var S=T+this.__KO.getItemSize(R);
...
}bc=this.__KN.getItemAtPosition(this.getScrollY()+bb-be.top);
bd=this.__KO.getItemAtPosition(this.getScrollX()+ba-be.left);
...
if(!bl){return;
}var bm=this.__KQ+bl.width;
var bn=this.__KS-bm;

if(this.__KQ-this.__KT.left<Math.min(this.__KQ,bf)||this.__KT.right-bm<Math.min(bn,bh)){var bo=Math.min(this.__KQ,bg);
var bk=Math.min(bn,bi);
this._setLayerWindow(bj,this.__KQ-bo,this.__KP,bl.width+bo+bk,bl.height,false);
...
if(!bw){return;
}var bu=this.__KP+bw.height;
var bv=this.__KR-bu;

if(this.__KP-this.__KT.top<Math.min(this.__KP,bp)||this.__KT.bottom-bu<Math.min(bv,br)){var by=Math.min(this.__KP,bq);
var bx=Math.min(bv,bs);
this._setLayerWindow(bt,this.__KQ,this.__KP-by,bw.width,bw.height+by+bx,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__KX=true;
this._updateScrollPosition();
this.__KX=null;
this.fireEvent(u);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__Lb(e,j);
},_onContextmenu:function(e){this.__Lb(e,b);
},_onDblclick:function(e){this.__Lb(e,l);
},__Lb:function(e,bz){var bA=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());
...
},_setLayerWindow:function(bB,bC,top,bD,bE,bF){var bK=this.__KN.getItemAtPosition(top);

if(bK){var bM=bK.index;
var bQ=this.__KN.getItemSizes(bM,bE+bK.offset);
...
var bS=0;
var bP=0;
}var bO=this.__KO.getItemAtPosition(bC);

if(bO){var bI=bO.index;
var bH=this.__KO.getItemSizes(bI,bD+bO.offset);
...
var bR=0;
var bJ=0;
}this.__KT={top:bS,bottom:bP,left:bR,right:bJ};
this.__KV.setUserBounds(this.__KT.left-this.__KQ,this.__KT.top-this.__KP,bN,bL);
this.__KY=bH;
this.__La=bQ;

for(var i=0;i<this.__KW.length;i++){var bG=this.__KW[i];
...
if(this.__KR!==bT.height||this.__KS!==bT.width){this.__KR=bT.height;
this.__KS=bT.width;
this.fireEvent(u);
...
if(bU.length==0){this.__Lc();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var bV=this.getBounds();
this._setLayerWindow(bU,this.__KQ,this.__KP,bV.width,bV.height,true);
this.__Lc();
...
if(bW.length==0){this.__Lc();
return;
}var bY=this.getBounds();

if(!bY){return ;
}var bX={top:this.__KP,bottom:this.__KP+bY.height,left:this.__KQ,right:this.__KQ+bY.width};

if(this.__KT.top<=bX.top&&this.__KT.bottom>=bX.bottom&&this.__KT.left<=bX.left&&this.__KT.right>=bX.right){this.__KV.setUserBounds(this.__KT.left-bX.left,this.__KT.top-bX.top,this.__KT.right-this.__KT.left,this.__KT.bottom-this.__KT.top);
}else{this._setLayerWindow(bW,this.__KQ,this.__KP,bY.width,bY.height,false);
}this.__Lc();
...
this.customSizes={};
},events:{"change":e},members:{__Ld:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
this.__Ld=u;
return u;
},__Lf:function(A){var B=this.__Ld||this.__Le();
var C=0;
var E=B.length-1;
...
}},__Lg:function(M){var N=this.__Ld||this.__Le();
var O=0;
var Q=N.length-1;
...
}},getTotalSize:function(){var U=this.__Ld||this.__Le();
...
this.__Ke=[];
},properties:{anonymous:{refine:true,init:false}},events:{updated:b},members:{__Ke:null,getRenderedCellWidget:function(j,k){var l=this.getColumnSizes().length;
...
}},_getSpacer:function(){var r=this.__Ke.pop();
...
if(E.getUserData(g)){this.__Ke.push(E);
...
if(W.getUserData(g)){this.__Ke.push(W);
