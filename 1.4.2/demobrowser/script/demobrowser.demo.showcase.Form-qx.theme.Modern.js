...
var bk=new qx.ui.form.MenuButton(x,null,this.__Uw()).set({tabIndex:be++});
bg=new qx.ui.basic.Label(M);
bg.setBuddy(bk);
bs.add(bg,{row:3,column:0});
bs.add(bk,{row:3,column:1});
var bc=new qx.ui.form.SplitButton(q,null,this.__Ux()).set({tabIndex:be++});
...
bh.bind(k,bl,k);
this.getRoot().add(bx);
},__Uv:function(bz){for(var i=0;i<10;i++){var bA=new qx.ui.form.ListItem(E+i);
bz.add(bA);
}},__Uw:function(){var bB=new qx.ui.menu.Menu;
...
bD.add(bC);
return bD;
},__Ux:function(){var bG=new qx.ui.menu.Menu;
