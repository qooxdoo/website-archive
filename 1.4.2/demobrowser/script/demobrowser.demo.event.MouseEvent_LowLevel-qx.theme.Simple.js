...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"a59361ccdf47"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
