...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.Twitter","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.Twitter-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"a62ca0f1d176"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(B,{extend:qx.data.store.Json,statics:{saveResult:function(V){this.__Tu=V;
...
Y+=m;
ba.load(Y,function(bb){this.__Tv();
},this);
},__Tv:function(){var bc=demobrowser.demo.data.store.Twitter.__Tu;
