...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ResizeEvent","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.ResizeEvent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e820e21f9a22"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
