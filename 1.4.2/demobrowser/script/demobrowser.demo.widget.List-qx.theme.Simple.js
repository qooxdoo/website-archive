...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.List","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.List-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"24e0edc0864f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
