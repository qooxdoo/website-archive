...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_5","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Element_5-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"9a5fb923474c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
