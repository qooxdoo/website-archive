...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor","qx.theme":"qx.theme.Classic"};
...
(function(){var e="Window: ",d="interval",c="__UK",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__UI:null,__UJ:0,__UK:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__UI=[];
this.currentTest=this.testWindows;
this.__UK=new qx.event.Timer(1000);
this.__UK.addListener(d,this.runTest,this);
this.__UK.start();
},runTest:function(){this.__UJ++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__UJ+" (Registry: "+g+")");
this.currentTest();
qx.ui.core.queue.Manager.flush();
var f=this.__UI;

for(var i=0,l=f.length;i<l;i++){f[i].destroy();
}f.length=0;
qx.ui.core.queue.Manager.flush();
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Done! (Registry: "+g+")");
},testLabels:function(){for(var i=0;i<250;i++){var h=new qx.ui.basic.Label(b+i);
this.getRoot().add(h,{left:50,top:50+i*20});
this.__UI.push(h);
}},testWindows:function(){for(var i=0;i<5;i++){var j=new qx.ui.window.Window(e+i);
j.open();
this.__UI.push(j);
