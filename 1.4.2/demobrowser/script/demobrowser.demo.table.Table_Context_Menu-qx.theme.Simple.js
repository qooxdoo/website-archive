...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Context_Menu","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Context_Menu-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"2131b9668ec3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(c,{extend:qx.application.Standalone,include:demobrowser.demo.table.MUtil,members:{__Uy:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},showDialog:function(s){if(!this.__Uy){var v=this.__Uy=new qx.ui.window.Window().set({modal:true,showMinimize:false,showMaximize:false,width:180,contentPadding:[10,10,10,10]});
v.moveTo(315,100);
...
}this.__Uy.getChildren()[1].setValue(s);
this.__Uy.open();
this.__Uy.getChildren()[2].focus();
...
this.__MF=[];
this.__MG=[];
},members:{__MF:null,__MG:null,setContextMenuHandler:function(m,n,o){this.__MF[m]=n;
this.__MG[m]=o||this;
},getContextMenuHandler:function(p){return this.__MF[p];
