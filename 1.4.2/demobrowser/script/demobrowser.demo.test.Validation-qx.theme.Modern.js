...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Validation","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Validation-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e5565e2b2afc"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="<br>",i="new name: ",h="new gender: ",g="male",f="female",e="new age: ",d="demobrowser.demo.test.Validation",c="<b>Setting the age ",b="property to 27</b><br>",a="- name: Name is validated to a minimum length of two.<br/>",P="<br>old name: ",O=")",N="age:",M="fmale",L="<br><b>Setting the name to 'Hans'</b><br>",K="property to 'female'</b><br>",J="<br><b>Setting the gender ",I="must be longer than one characters. (",H="<b>Testing the gender ",G="<br>old gender: ",q="<br><b>Setting the age ",r="- age: Age is validated to be a number.<br/>",o="<b>Initial property values</b><br>",p="",m="<b>Setting the name to ''</b><br>",n="demobrowser.demo.test.Person",k="property to 'true'</b><br>",l="- gender: Gender is validated to be either male or female.",s="property to 'fmale'</b><br>",t="__Va",y="<font color='red'>GENDER NOT SET</font>",x="gender:",A="<br>old age: ",z="Hans",C="The demo creates an internal class containing three properties:<br/>",B="Validation Error: Name ",v="<font color='red'>AGE NOT SET</font>",F="My name",E="<font color='red'>NAME NOT SET</font>",D="white",u="name:",w="<b>Description</b><br/>";
...
var Q=new demobrowser.demo.test.Person();
var R=new qx.ui.embed.Html();
R.setBackgroundColor(D);
R.set({padding:10,width:250,height:360});
this.getRoot().add(R,{left:10,top:10});
R.setHtml(o);
R.setHtml(R.getHtml()+u+Q.getName()+j);
R.setHtml(R.getHtml()+N+Q.getAge()+j);
R.setHtml(R.getHtml()+x+Q.getGender()+j);
R.setHtml(R.getHtml()+L);
Q.setName(z);
R.setHtml(R.getHtml()+i+Q.getName()+j);
R.setHtml(R.getHtml()+m);
try{Q.setName(p);
R.setHtml(R.getHtml()+i+Q.getName()+j);
}catch(T){R.setHtml(R.getHtml()+E+P+Q.getName()+j);
}R.setHtml(R.getHtml()+q+b);
Q.setAge(27);
R.setHtml(R.getHtml()+e+Q.getAge()+j);
R.setHtml(R.getHtml()+c+k);
try{Q.setAge(true);
R.setHtml(R.getHtml()+e+Q.getAge()+j);
}catch(U){R.setHtml(R.getHtml()+v+A+Q.getAge()+j);
}R.setHtml(R.getHtml()+J+K);
Q.setGender(f);
R.setHtml(R.getHtml()+h+Q.getGender()+j);
R.setHtml(R.getHtml()+H+s);
try{Q.setAge(M);
R.setHtml(R.getHtml()+h+Q.getGender()+j);
}catch(V){R.setHtml(R.getHtml()+y+G+Q.getGender()+j);
}var S=new qx.ui.basic.Label();
S.setRich(true);
S.setWidth(250);
S.setValue(w+C+a+r+l);
this.getRoot().add(S,{left:280,top:10});
}}});
qx.Class.define(n,{extend:qx.core.Object,properties:{name:{init:F,validate:t},age:{init:18,validate:qx.util.Validate.number()},gender:{init:g,validate:qx.util.Validate.inArray([g,f])}},members:{__Va:function(W){if(W.length<2){throw new qx.core.ValidationError(B+I+W+O);
}}}});
})();
