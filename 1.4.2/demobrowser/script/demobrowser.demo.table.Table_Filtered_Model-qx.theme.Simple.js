...
},members:{__Ln:null,__Lm:null,_js_in_array:function(q,r){var s=r.toString();
...
if(!this.__Lm){this.__Ln=Y.slice(0);
this.__Lm=true;
}
if(W==null||W<1){W=1;
}
...
}},resetHiddenRows:function(){if(!this.__Ln){return ;
}this.Filters=[];
this.setData(qx.lang.Array.clone(this.__Ln));
},setData:function(bb,bc){this.__Ln=qx.lang.Array.clone(bb);
this.Filters=[];
qx.ui.table.model.Simple.prototype.setData.call(this,bb,bc);
}},destruct:function(){this.__Ln=this.numericAllowed=this.betweenAllowed=this.Filters=null;
}});
})();
