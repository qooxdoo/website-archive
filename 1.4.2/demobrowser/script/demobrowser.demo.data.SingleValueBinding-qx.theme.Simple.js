...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SingleValueBinding","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.SingleValueBinding-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"190119d5cdbe"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="qx.data.Array",r="demobrowser.demo.data.model.Node",q="String",p="changeNames",o="changeName",n="Validation Error: ",m="",l="__To",k="changeChild",j="- ",c="changeColor",h="Marge",f="AFFE",b="is no number (parseFloat says so!).",a="Homer",e="\n",d="changeName2",g="changeChildren";
qx.Class.define(r,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:s,event:g},child:{check:r,event:k,nullable:true},names:{check:s,event:p,init:new qx.data.Array(a,h)},name:{check:q,init:f,event:o},name2:{check:q,event:d},number:{init:10,validate:l},color:{event:c,nullable:true}},members:{__To:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
}}throw new qx.core.ValidationError(n+t+b);
},toString:function(u){if(u==undefined){u=0;
}var v=m;

for(var i=0;i<u;i++){v+=j;
}v+=this.getName();
