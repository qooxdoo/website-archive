...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="__VN",c="white",b="#EEE",a="vertical";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__VN:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__VN=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__VN.getCellProperties(j+g+k);
