...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Percent","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox_Percent-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"8ed0a64c9580"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var f="main",e="green",d="33%",c="yellow",b="50%",a="demobrowser.demo.layout.HBox_Percent";
...
var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(g);
g.add(this.getBox1());
g.add(this.getBox2());
g.add(this.getBox3());
...
g.add(this.getBox5());
g.add(this.getBox6());
},getBox1:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
i.add(h,{flex:1});
return i;
},getBox2:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
var o=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
...
m.add(o,{width:d});
m.add(n,{width:d});
m.add(l,{width:d,flex:1});
return m;
},getBox3:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
var s=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var r=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var p=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
q.add(s,{width:b});
q.add(r,{flex:1});
q.add(p,{flex:1});
return q;
},getBox4:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var v=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var t=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
u.add(w,{width:d,flex:1});
u.add(v,{width:d,flex:1});
u.add(t,{width:d,flex:1});
return u;
},getBox5:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:200,allowGrowX:false});
...
y.add(A,{width:d,flex:1});
y.add(z,{width:d,flex:1});
y.add(x,{width:d,flex:1});
return y;
},getBox6:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
var E=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var D=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
var B=new qx.ui.core.Widget().set({decorator:f,backgroundColor:e});
C.add(E,{width:d,flex:1});
C.add(D,{width:d,flex:1});
C.add(B,{width:d,flex:1});
return C;
}}});
})();
