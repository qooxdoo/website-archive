...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.DragDrop","qx.theme":"qx.theme.Classic"};
...
(function(){var m="drop",k="value",j="items",h="move",g="multi",f="dragover",d="icon/16/places/folder.png",c="dragstart",b="Item ",a="copy",A="drag",z="TextArea Target",y="solid",x="Reorderable",w="qx.ui.form.ListItem",v="droprequest",u="#33508D",t="Source",s="demobrowser.demo.ui.DragDrop",r="Simple Target",p="Enable drag",q="__Vk",n="\n",o="dragend";
qx.Class.define(s,{extend:qx.application.Standalone,members:{__Vk:null,__Vl:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var M=this.getRoot();
...
var C=this.__Vk=new qx.ui.form.List;
C.setDraggable(true);
C.setDroppable(true);
...
if(V instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Vl=V;
}
...
C.addListener(m,function(e){this.__Vm(e.getOriginalTarget());
},this);
D.addListener(m,function(e){this.__Vm(this.__Vl);
},this);
},__Vm:function(W){if(W.classname!=w){return;
}var X=this.__Vk.getSortedSelection();

for(var i=0,l=X.length;i<l;i++){this.__Vk.addBefore(X[i],W);
this.__Vk.addToSelection(X[i]);
