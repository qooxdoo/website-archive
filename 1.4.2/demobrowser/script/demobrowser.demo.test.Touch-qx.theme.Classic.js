...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Touch","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Touch-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"235811eef2b5"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var t="div",s="green",r="engine.name",q="Two",p="20px",o="30px",n="qx.debug",m="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",l="webkit",k="12px",c="innerHTML",j="qx.mobile.emulatetouch",g="event.touch",b='Lucida Grande',a="One",f="demobrowser.demo.test.Touch",d="blue",h="absolute";
qx.Class.define(f,{extend:qx.application.Native,members:{__UR:null,__US:null,main:function(){qx.application.Native.prototype.main.call(this);
if((qx.core.Environment.get(n))){qx.log.appender.Native;
qx.log.appender.Console;
}var v=new qx.html.Element(t);
v.useElement(document.body);
v.setRoot(true);

if(qx.core.Environment.get(r)!=l||(!qx.core.Environment.get(g)&&qx.core.Environment.get(j)==false)){var u={"color":s,"position":h,"font-family":b,"font-size":k,"left":o,"top":p};
var w=new qx.html.Element(t,u);
v.add(w);
w.setAttribute(c,m);
return;
}v.add(this.__UT(10,10,s,a));
v.add(this.__UT(110,10,d,q));
this.__UR=this.__UU(10,110);
v.add(this.__UR);
this.__US=this.__UU(110,110);
v.add(this.__US);
v.add(this.__UV(210,10));
},__UT:function(x,y,z,A){var B={"position":"absolute","left":x+"px","top":y+"px","width":"90px","height":"90px","backgroundColor":z,"fontFamily":"Arial","fontSize":"12px"};
var C=new qx.html.Element("div",B,{"id":A});
C.setAttribute("innerHTML","<b>Touch me:<br>"+A+"</b>");
C.addListener("touchstart",this.__UW,this);
C.addListener("touchmove",this.__UW,this);
C.addListener("touchend",this.__UW,this);
C.addListener("touchcancel",this.__UW,this);
return C;
},__UU:function(x,y){var D={"position":"absolute","left":x+"px","top":y+"px","width":"90px","fontFamily":"Arial","fontSize":"9px"};
return new qx.html.Element("div",D);
},__UV:function(x,y){var E={"position":"absolute","left":x+"px","top":y+"px","width":"55px","height":"55px","backgroundColor":"red","fontFamily":"Arial","fontSize":"12px"};
var F=new qx.html.Element("div",E);
F.setAttribute("innerHTML","<b>Cancel Touch</b>");
F.addListener("click",function(){window.setTimeout(function(){alert("Touch canceled");
},0);
},this);
return F;
},__UW:function(e){var G=[];
G.push("Type: "+e.getType());
G.push("==============");
G.push("Is Multi-Touch: "+e.isMultiTouch());
G.push("All Touches: "+e.getAllTouches().length);
G.push("Target Touches: "+e.getTargetTouches().length);
G.push("Changed Target Touches: "+e.getChangedTargetTouches().length);
G.push("==============");
G.push("Document: Left = "+e.getDocumentLeft()+" / Top = "+e.getDocumentTop());
G.push("Screen: Left = "+e.getScreenLeft()+" / Top = "+e.getScreenTop());
G.push("Viewport: Left = "+e.getViewportLeft()+" / Top = "+e.getViewportTop());
G.push("Identifier: "+e.getIdentifier());
var I=e.getTarget();
var H=false;
var K=e.getTargetTouches().length>0?e.getTargetTouches():e.getChangedTargetTouches();

for(var i=0;i<K.length;i++){H=K[0].target==I;

if(!H){break;
}}G.push("Are all touch targets div "+I.id+":"+H);
var J=this["__infoArea"+I.id];

if(J){J.setAttribute("innerHTML",G.join("<br>"));
}}}});
})();
