...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor_Flash","qx.theme":"qx.theme.Classic"};
...
qx.Class.define(j,{extend:qx.application.Native,members:{__UL:null,__UM:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__UL=[];
...
o.start();
},clear:function(){var p=this.__UL;
