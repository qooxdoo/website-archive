...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.ManualLayout","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.ManualLayout-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"46f2c1fce09f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var g="black",f="red",e="green",d="demobrowser.demo.layout.ManualLayout",c="yellow",b="solid",a="blue";
...
var m=new qx.ui.core.Widget().set({backgroundColor:f,decorator:n,paddingLeft:10,paddingRight:10});
m.setUserBounds(10,10,100,30);
var l=new qx.ui.core.Widget().set({backgroundColor:a,decorator:n});
l.setUserBounds(200,20,150,100);
var k=new qx.ui.core.Widget().set({backgroundColor:e,decorator:n,padding:3});
k.setUserBounds(380,50,150,100);
var j=new qx.ui.core.Widget().set({backgroundColor:c,decorator:n,padding:10});
j.setUserBounds(50,200,150,100);
