...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Tooltip","qx.theme":"qx.theme.Classic"};
...
},__Wv:4,__Ww:0,add:function(B){this.container.add(B,{row:Math.floor(this.__Ww/this.__Wv),column:this.__Ww%this.__Wv});
this.__Ww+=1;
