...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.treevirtual.TreeVirtual_Filter","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.treevirtual.TreeVirtual_Filter-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"10a19c7698f3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="2007-01-30 22:54:03",j="Trash",h="-rwxr-xr-x",g="demobrowser.demo.treevirtual.TreeVirtual_Filter",f="Permissions",e="Documents (D:)",d="Windows (C:)",c="Inbox",b="Desktop",a="input",x="1*",w="Network",v="Last Accessed",u="Sent",t="Filter",s="Files",r="Workspace",q="Tree",p="Spam",o="Data",m="100",n="Spam Message #",l="Edit";
...
this.getRoot().add(I,{edge:30});
var A=new qx.ui.treevirtual.TreeVirtual([q,f,v]);
A.set({width:400});
A.setAlwaysShowOpenCloseSymbol(true);
var z=A.getTableColumnModel().getBehavior();
z.set(0,{width:x,minWidth:180});
I.add(A);
var H=A.getDataModel();
var D=H.addBranch(null,b,true);
var y;
H.addBranch(D,s,true);
y=H.addBranch(D,r,true);
var F=H.addLeaf(y,d);
H.setColumnData(F,1,h);
H.setColumnData(F,2,k);
F=H.addLeaf(y,e);
H.setColumnData(F,1,h);
H.setColumnData(F,2,k);
H.addBranch(D,w,true);
F=H.addBranch(D,j,true);
var E=H.addBranch(null,c,true);
F=H.addBranch(E,p,true);

for(var i=1;i<3000;i++){H.addLeaf(F,n+i);
}H.addBranch(E,u,false);
H.addBranch(E,j,false);
H.addBranch(E,o,false);
H.addBranch(E,l,false);
var C=new qx.ui.groupbox.GroupBox(t);
C.setMaxHeight(50);
C.setLayout(new qx.ui.layout.VBox());
I.add(C);
var G=new qx.ui.form.TextField();
G.setValue(m);
G.addListener(a,function(){H.setData();
},this);
C.add(G);
var B=qx.lang.Function.bind(function(J){if(J.type==qx.ui.treevirtual.MTreePrimitive.Type.LEAF){var K=J.label;
return K.indexOf(G.getValue())!=-1;
}return true;
},this);
H.setFilter(B);
}}});
...
this.__mU=false;
this.__mV=false;
},properties:{behavior:{check:j,init:null,nullable:true,apply:h,event:e}},members:{__mV:null,__mU:null,__mW:null,_applyBehavior:function(r,s){if(s!=null){s.dispose();
s=null;
