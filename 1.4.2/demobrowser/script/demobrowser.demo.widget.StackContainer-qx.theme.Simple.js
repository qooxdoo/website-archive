...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.StackContainer","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.StackContainer-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"a1450af6d3fe"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
