...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_Scroller","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Table_Scroller-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"f518bb7d3a03"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var f=new demobrowser.demo.test.DummyTable();
this.getRoot().add(f,{left:10,top:10});
}}});
qx.Class.define(e,{extend:qx.ui.container.Composite,include:[demobrowser.demo.table.MUtil],construct:function(){qx.ui.container.Composite.call(this,new qx.ui.layout.Canvas());
this.setAppearance(a);
this.set({decorator:d,backgroundColor:b,width:600,height:400});
var h=new qx.ui.table.pane.Scroller(this.getTableMock());
this.add(h,{edge:0});
var g=new qx.ui.table.pane.Model(this.getColumnModelMock());
h.setTablePaneModel(g);
h._onPaneModelChanged();
h.getTablePane().setVisibleRowCount(20);
h.getTablePane()._updateAllRows();
}});
})();
