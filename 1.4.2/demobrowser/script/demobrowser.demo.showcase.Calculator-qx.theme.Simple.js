...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.showcase.Calculator","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.showcase.Calculator-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"ee8e752634ce"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="execute",j="-",i="+",h="n",g="/",f="*",d="=",c="sans-serif",b="Verdana",a=".",J="black",I="Del",H="C",G="5",F="7",E="demobrowser.demo.showcase.Calculator",D="CE",C="solid",B="icon/22/apps/utilities-calculator.png",A="3",r="0",s="qx.debug",p="__Uj",q="8",n="6",o="4",l="Calculator",m="right",t="2",u="1",w="demobrowser.demo.showcase.CalculatorLogic",v="__Ui",y="white",x="+/-",z="9";
qx.Class.define(E,{extend:qx.application.Standalone,members:{__Ui:null,__Uj:null,main:function(){qx.application.Standalone.prototype.main.call(this);
if(qx.core.Environment.get(s)){qx.log.appender.Native;
qx.log.appender.Console;
}this.__Uj=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var L=new qx.ui.window.Window(l,B);
L.setLayout(new qx.ui.layout.VBox(16));
var N=new qx.ui.decoration.Single(1,C,J);
var V=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var bg=new qx.ui.layout.Grid(5,5);
V.setLayout(bg);
this.__Ui=new qx.ui.basic.Label(this.__Uj.getCurrentValue().toString()).set({decorator:N,backgroundColor:y,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[b,c],bold:true}),textAlign:m});
this.__Ui.setEnabled(false);
var bh=new qx.bom.Font().set({size:14,family:[b,c],bold:true});
var bb=new qx.ui.form.Button(r).set({font:bh,minWidth:40});
var ba=new qx.ui.form.Button(u).set({font:bh,minWidth:40});
var Y=new qx.ui.form.Button(t).set({font:bh,minWidth:40});
var X=new qx.ui.form.Button(A).set({font:bh,minWidth:40});
var bf=new qx.ui.form.Button(o).set({font:bh,minWidth:40});
var be=new qx.ui.form.Button(G).set({font:bh,minWidth:40});
var bd=new qx.ui.form.Button(n).set({font:bh,minWidth:40});
var bc=new qx.ui.form.Button(F).set({font:bh,minWidth:40});
var bj=new qx.ui.form.Button(q).set({font:bh,minWidth:40});
var bi=new qx.ui.form.Button(z).set({font:bh,minWidth:40});
var K=new qx.ui.form.Button(H).set({font:bh,minWidth:40});
var M=new qx.ui.form.Button(D).set({font:bh,minWidth:40});
var R=new qx.ui.form.Button(I).set({font:bh,minWidth:40});
var Q=new qx.ui.form.Button(x).set({font:bh,minWidth:40});
var T=new qx.ui.form.Button(a).set({font:bh,minWidth:40});
var P=new qx.ui.form.Button(i).set({font:bh,minWidth:40});
var W=new qx.ui.form.Button(j).set({font:bh,minWidth:40});
var U=new qx.ui.form.Button(f).set({font:bh,minWidth:40});
var S=new qx.ui.form.Button(g).set({font:bh,minWidth:40});
var O=new qx.ui.form.Button(d).set({font:bh,minWidth:40});
bg.setColumnFlex(0,1);
bg.setColumnFlex(1,1);
bg.setColumnFlex(2,1);
bg.setColumnFlex(3,1);
bg.setRowFlex(1,1);
bg.setRowFlex(2,1);
bg.setRowFlex(3,1);
bg.setRowFlex(4,1);
bg.setRowFlex(5,1);
bg.setRowFlex(6,1);
V.add(this.__Ui,{row:0,column:0,rowSpan:0,colSpan:4});
V.add(K,{row:1,column:2,rowSpan:1,colSpan:2});
V.add(M,{row:1,column:1});
V.add(R,{row:1,column:0});
V.add(bc,{row:2,column:0});
V.add(bj,{row:2,column:1});
V.add(bi,{row:2,column:2});
V.add(S,{row:2,column:3});
V.add(bf,{row:3,column:0});
V.add(be,{row:3,column:1});
V.add(bd,{row:3,column:2});
V.add(U,{row:3,column:3});
V.add(ba,{row:4,column:0});
V.add(Y,{row:4,column:1});
V.add(X,{row:4,column:2});
V.add(W,{row:4,column:3});
V.add(bb,{row:5,column:0});
V.add(Q,{row:5,column:1});
V.add(T,{row:5,column:2});
V.add(P,{row:5,column:3});
V.add(O,{row:6,column:0,rowSpan:1,colSpan:4});
L.setWidth(260);
L.setMinWidth(260);
L.setHeight(260);
L.open();
this.getRoot().add(L,{left:20,top:20});
L.add(V,{flex:1});
K.addListener(k,function(e){this.__Uj.cleanDisplay();
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
M.addListener(k,function(e){this.__Uj.clearEntry();

if(this.__Uj.getResult()!=null){this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
}},this);
R.addListener(k,function(e){this.__Uj.deleteNumber();
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
Q.addListener(k,function(e){this.__Uj.setSign();

if(this.__Uj.getResult()!=null){this.__Ui.setValue(this.__Uj.getResult().toString());
}},this);
bb.addListener(k,function(e){this.__Uj.setCurrentValue(0);
this.__Ui.setValue(this.__Uj.getCurrentValue().toFixed(this.__Uj.getZeroCounter()).toString());
},this);
ba.addListener(k,function(e){this.__Uj.setCurrentValue(1);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
Y.addListener(k,function(e){this.__Uj.setCurrentValue(2);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
X.addListener(k,function(e){this.__Uj.setCurrentValue(3);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
bf.addListener(k,function(e){this.__Uj.setCurrentValue(4);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
be.addListener(k,function(e){this.__Uj.setCurrentValue(5);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
bd.addListener(k,function(e){this.__Uj.setCurrentValue(6);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__Uj.setCurrentValue(7);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
bj.addListener(k,function(e){this.__Uj.setCurrentValue(8);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
bi.addListener(k,function(e){this.__Uj.setCurrentValue(9);
this.__Ui.setValue(this.__Uj.getCurrentValue().toString());
},this);
P.addListener(k,function(e){this.__Uj.calculate(i);

if(this.__Uj.getResult()!=null){this.__Ui.setValue(this.__Uj.getResult().toString());
}this.__Uj.resetCurrentValue();
},this);
W.addListener(k,function(e){this.__Uj.calculate(j);

if(this.__Uj.getResult()!=null){this.__Ui.setValue(this.__Uj.getResult().toString());
}this.__Uj.resetCurrentValue();
},this);
U.addListener(k,function(e){this.__Uj.calculate(f);

if(this.__Uj.getResult()!=null){this.__Ui.setValue(this.__Uj.getResult().toString());
}this.__Uj.resetCurrentValue();
},this);
S.addListener(k,function(e){this.__Uj.calculate(g);

if(this.__Uj.getResult()!=null){this.__Ui.setValue(this.__Uj.getResult().toString());
}this.__Uj.resetCurrentValue();
},this);
O.addListener(k,function(e){this.__Uj.calculate(d);

if(this.__Uj.getResult()!=null){this.__Ui.setValue(this.__Uj.getResult().toString());
}this.__Uj.resetCurrentValue();
},this);
T.addListener(k,function(e){this.__Uj.setComma();
},this);
}},destruct:function(){this._disposeObjects(p,v);
}});
qx.Class.define(w,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__Uk:0,__Ul:0,__Um:h,__Un:0,__Uo:0,__Up:0,__Uq:false,__Ur:1,__Us:0,__Ut:false,__Uu:0,setCurrentValue:function(bk){if(this.__Uq){this.__Ur*=10;
this.__Uk=this.__Uk+(bk/this.__Ur);

if(bk==0){this.__Us++;
}}else{this.__Uq=false;

if(this.__Uk<0){this.__Uk=this.__Uk*10-bk;
}else{this.__Uk=this.__Uk*10+bk;
}}},getZeroCounter:function(){return this.__Us;
},setComma:function(){this.__Uq=true;
},getCurrentValue:function(){return this.__Uk;
},resetCurrentValue:function(){this.__Uk=null;
},cleanDisplay:function(){this.__Uu=0;
this.__Uo=0;
this.__Um=h;
this.__Us=0;
this.__Ur=1;
...
this.__Ul=0;
this.__Ut=false;
},setResult:function(bl){this.__Ul=bl;
},getResult:function(){return Math.round(this.__Ul*10000000)/10000000;
},setCurrentOperation:function(bm){this.__Um=bm;
},getCurrentOperation:function(){return this.__Um;
},clearEntry:function(){this.__Ut=false;
this.__Us=0;
this.__Ur=1;
this.__Uq=false;
this.__Up++;
...
if(this.__Up<2){this.__Uo=this.__Ul;
}
if(this.__Un>=2){this.__Ul=0;
this.__Un=0;
}},setSign:function(){this.__Uu++;

if(this.__Uu%2==0){this.__Ut=false;
}else{this.__Ut=true;
}
if(this.__Uk==null){this.__Uk=this.__Ul;
}this.__Uk=this.__Uk*(-1);

if(this.__Ul==0){this.__Ul=this.__Uk;
}
if(this.__Ul!=0){this.__Uo=this.__Ul;
this.__Ul=this.__Uk;
}},deleteNumber:function(){var bn=false;
var bq=false;

if(this.__Uk<0){this.__Uk=this.__Uk*(-1);
bq=true;
}
if(this.__Uk!=null){if(this.__Uk.toString().lastIndexOf(a)!=-1){this.__Uk=this.__Uk*this.__Ur;
bn=true;
}}var bo=this.__Uk%10;
var bp=bo/10;
this.__Uk=this.__Uk/10;
this.__Uk=this.__Uk-bp;

if(bn){this.__Ur/=10;
this.__Uk=this.__Uk/(this.__Ur);
bn=false;
}
if(bq){this.__Uk=this.__Uk*(-1);
bq=false;
}},calculate:function(br){if(br==i||br==f||br==g||br==j||br==d){this.__Uq=false;
this.__Ur=1;
this.__Us=0;

if(this.__Um!=h){if(this.__Um==i){if(this.__Ul==null){this.__Ul=this.__Uo;
}
if(this.__Ut){this.__Ul=this.__Uo+this.__Uk;
}else{this.__Ul=this.__Ul+this.__Uk;
}this.__Uk=this.__Ul;
this.__Uo=this.__Ul;
}
if(this.__Um==j){if(this.__Ul==0){this.__Ul=this.__Uk;
this.__Uk=0;
}
if(this.__Ul==null){this.__Ul=this.__Uo;
}
if(this.__Ut){this.__Ul=this.__Uo-this.__Uk;
}else{this.__Ul=this.__Ul-this.__Uk;
}this.__Uk=this.__Ul;
...
if(this.__Um==g){if(this.__Ul==0){this.__Ul=this.__Uk;
this.__Uk=1;
}
if(this.__Ul==null){this.__Ul=this.__Uo;
}
if(this.__Uk!=null){if(this.__Uk!=0){if(this.__Ut){this.__Ul=this.__Uo/this.__Uk;
}else{this.__Ul=this.__Ul/this.__Uk;
}}else{alert("You can't divide by 0!");
}}this.__Uk=this.__Ul;
this.__Uo=this.__Ul;
}
if(this.__Um==f){if(this.__Ul==0){this.__Ul=1;
}
if(this.__Uk==null){this.__Uk=1;
}
if(this.__Ul==null){this.__Ul=this.__Uo;
}
if(this.__Ut){this.__Ul=this.__Uo*this.__Uk;
...
this.__Uo=this.__Ul;
}}else{this.__Ul=this.__Uk;
}
if(br!=d){this.__Um=br;
}else{this.__Un++;
this.__Ul=this.__Uo;
this.__Um=h;
}this.__Ut=false;
