...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.io_HttpRequest","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.io_HttpRequest-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"fd44751811de"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="qx.event.type.Event",i="Boolean",h="String",g="basic",f="GET",e="text/plain",d="http",c="POST",b="application/xml",a="X-Requested-With",H="application/json",G="text/html",F="If-Modified-Since",E="Last-Modified",D='Basic ',C="Integer",B="qx.event.type.Data",A="HEAD",z="XMLHttpRequest",y='Authorization',q="Accept",r="OPTIONS",o="text/javascript",p="",m="PUT",n=':',k="application/x-www-form-urlencoded",l="DELETE",s="qx.io.HttpRequest",t="no-cache",v="__QI",u="Cache-Control",x="Content-Type",w="Thu, 01 Jan 1970 00:00:00 GMT";
qx.Class.define(s,{extend:qx.core.Object,construct:function(I){qx.core.Object.call(this);
this.__QG={};
if(I!=null){this.setUrl(I);
}},statics:{__QH:{}},events:{"change":B,"timeout":j,"load":j,"error":j,"abort":j},properties:{refresh:{check:i,init:false},data:{nullable:true},method:{check:[f,c,m,A,l,r],init:f},async:{check:i,init:true},mime:{check:[e,o,H,b,G],init:e},url:{check:h,init:p},username:{check:h,nullable:true},password:{check:h,nullable:true},auth:{check:[d,g],init:d},timeout:{check:C,nullable:true},cache:{check:i,init:false}},members:{__QI:null,__QG:null,setRequestHeader:function(J,K){this.__QG[J]=K;
},removeRequestHeader:function(L){delete this.__QG[L];
},getRequestHeader:function(M){var N=this.__QG[M];

if(N===undefined){N=null;
}return N;
},getResponseText:function(){var O=this.__QI;

if(O){return O.responseText;
}},getResponseXml:function(){var P=this.__QI;

if(P){return P.responseXML;
}},getResponseHeader:function(Q){var R=this.__QI;

if(R){return R.getResponseHeader(Q);
}},getAllResponseHeaders:function(){var S=this.__QI;

if(S){return S.getAllResponseHeaders();
}},isNotModified:function(){var T=this.__QI;

if(!T){return false;
}var U=T.getResponseHeader(E);
return T.status===304||qx.io.HttpRequest.__QH[this.getUrl()]===U;
},isSuccessful:function(){var V=this.__QI;
return !V||V.isSuccessful();
},getStatusCode:function(){var W=this.__QI;

if(W){return W.status;
}},getStatusText:function(){var X=this.__QI;

if(X){return X.statusText;
}},getReadyState:function(){var Y=this.__QI;

if(Y){return Y.readyState;
}},send:function(){if(this.__QI){if(this.getReadyState()!==4){throw new Error("Request is still pending at ready state: "+this.getReadyState());
}this.__QI.dispose();
}var bc=this.__QI=new qx.bom.Request;
bc.onreadystatechange=qx.lang.Function.bind(this.__QJ,this);
bc.ontimeout=qx.lang.Function.bind(this.__QK,this);
bc.onload=qx.lang.Function.bind(this.__QL,this);
bc.onerror=qx.lang.Function.bind(this.__QM,this);
bc.onabort=qx.lang.Function.bind(this.__QN,this);
...
if(!this.getCache()){bc.setRequestHeader(u,t);
}if(this.getRefresh()){bc.setRequestHeader(F,qx.io.HttpRequest.__QH[bb]||w);
}bc.setRequestHeader(a,z);
if(this.getMethod()===c){bc.setRequestHeader(x,k);
}bc.setRequestHeader(q,this.getMime());
var bd=this.__QG;

for(var name in bd){bc.setRequestHeader(name,bd[name]);
}bc.send(this.getData());
},abort:function(){if(this.__QI){this.__QI.abort();
}},__QJ:qx.event.GlobalError.observeMethod(function(){this.fireDataEvent("change",this.getReadyState());
if(this.getRefresh()&&this.getReadyState()===4&&this.isSuccessful()){var bf=this.getResponseHeader("Last-Modified");

if(bf){qx.io.HttpRequest.__QH[this.getUrl()]=bf;
}}}),__QK:qx.event.GlobalError.observeMethod(function(){if(this.hasListener("timeout")){this.fireEvent("timeout");
}}),__QL:qx.event.GlobalError.observeMethod(function(){if(this.hasListener("load")){this.fireEvent("load");
}}),__QM:qx.event.GlobalError.observeMethod(function(){if(this.hasListener("error")){this.fireEvent("error");
}}),__QN:qx.event.GlobalError.observeMethod(function(){if(this.hasListener("abort")){this.fireEvent("abort");
...
qx.Class.define(a,{statics:{__QO:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function(c){var h=this.__QO;
var m=b;
var f,e,d;
var j,k,l,g;
var i=0;
...
return m;
},decode:function(n){var s=this.__QO;
var w=b;
var q,p,o;
var t,u,v,r;
var i=0;
