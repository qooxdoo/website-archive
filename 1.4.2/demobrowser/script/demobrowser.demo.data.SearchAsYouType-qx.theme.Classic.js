...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.SearchAsYouType","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"3cad5ab3c98e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.__Tt=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__Tt:null,__Ts:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__Tt!=null){i.stop(this.__Tt);
this.__Tt=null;
}this.__Tt=i.start(function(){this.__Ts.update();
this.__Tt=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__Ts=null;
}});
})();
