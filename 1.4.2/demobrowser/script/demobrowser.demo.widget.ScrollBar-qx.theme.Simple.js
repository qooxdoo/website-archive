...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ScrollBar","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.ScrollBar-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"de2d61f1a06d"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
