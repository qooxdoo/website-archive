...
if(qx.core.Environment.get(bU)==bX){qx.bom.element.Attribute.set(cL[0],bW,bT);
...
return cH;
},__Tl:function(){var cP=qx.bom.Element.create(ca);
qx.bom.element.Style.setStyles(cP,{"marginRight":bS,"float":bv});
var cR;
var cQ=qx.bom.Element.create(ci,{title:w});

if(qx.core.Environment.get(bU)==bX){qx.bom.element.Attribute.set(cQ,bW,bT);
...
if(qx.core.Environment.get(bU)==bX){qx.bom.element.Attribute.set(cS[0],bW,bT);
...
return cP;
},__Tm:function(){var cW=[{bold:{text:p,image:F,action:this.__Tb.setBold},italic:{text:bO,image:bz,action:this.__Tb.setItalic},underline:{text:bB,image:bN,action:this.__Tb.setUnderline},strikethrough:{text:bC,image:r,action:this.__Tb.setStrikeThrough},removeFormat:{text:R,image:I,action:this.__Tb.removeFormat}},{alignLeft:{text:m,image:A,action:this.__Tb.setJustifyLeft},alignCenter:{text:bh,image:cp,action:this.__Tb.setJustifyCenter},alignRight:{text:bL,image:G,action:this.__Tb.setJustifyRight},alignJustify:{text:cn,image:bx,action:this.__Tb.setJustifyFull}},{fontFamily:{custom:this.__Tk},fontSize:{custom:this.__Tl},fontColor:{text:P,image:Q,action:this.__Te},textBackgroundColor:{text:cv,image:bM,action:this.__Tf}},{indent:{text:bK,image:b,action:this.__Tb.insertIndent},outdent:{text:bD,image:be,action:this.__Tb.insertOutdent}},{insertImage:{text:bd,image:T,action:this.__Tg},insertTable:{text:ce,image:O,action:this.__Th},insertLink:{text:cu,image:D,action:this.__Ti},insertHTML:{text:E,image:cm,action:this.__Tj},insertHR:{text:ct,image:cs,action:this.__Tb.insertHorizontalRuler}},{ol:{text:C,image:a,action:this.__Tb.insertOrderedList},ul:{text:bF,image:cr,action:this.__Tb.insertUnorderedList}},{undo:{text:bl,image:H,action:this.__Tb.undo},redo:{text:q,image:bi,action:this.__Tb.redo}}];
var cY,dd,cV,db;

for(var i=0,j=cW.length;i<j;i++){dd={};
dd[n]=i==j-1?cb:bS;
dd[g]=bv;
cY=qx.bom.Element.create(ca);
...
if(qx.core.Environment.get(bU)==bX){qx.bom.element.Attribute.set(cV,bW,bT);
}else{qx.bom.element.Style.set(cV,bY,bV);
}qx.event.Registration.addListener(cV,X,dc.action,this.__Tb);
}qx.dom.Element.insertEnd(cV,cY);
}qx.dom.Element.insertEnd(cY,this.__SY);
}qx.dom.Element.insertEnd(qx.bom.Element.create(o,{style:ch}),this.__SY);
}}});
})();
