...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.MouseEvent_LowLevel-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d23423857eb3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(l,{extend:demobrowser.demo.event.EventDemo,members:{__TB:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__TB=qx.lang.Function.bind(this.logMouseEvent,this);
...
if(A.checked){qx.bom.Event.addNativeListener(y,z[i],this.__TB);
}qx.bom.Event.addNativeListener(A,m,qx.lang.Function.bind(this.__TC,this));
}},__TC:function(e){var E=qx.bom.Event.getTarget(e);
var D=E.id.split("_")[1];
var B=E.checked;
var C=document.getElementById("mouse");

if(B){qx.bom.Event.addNativeListener(C,D,this.__TB);
}else{qx.bom.Event.removeNativeListener(C,D,this.__TB);
