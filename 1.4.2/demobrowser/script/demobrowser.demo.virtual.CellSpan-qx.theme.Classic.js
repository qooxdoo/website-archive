...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellSpan","qx.theme":"qx.theme.Classic"};
...
(function(){var j="yellow",i="bold",h="table-scroller-header",g="green",f="__Vr",e=" / ",d="Widget Cells",c="demobrowser.demo.virtual.CellSpan",b="HTML Cells",a="x";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__Vr:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
k.add(new qx.ui.basic.Label(b).set({font:i,decorator:h,padding:3,allowGrowX:true}),{row:0,column:0});
var m=this.getHtmlCellSpanScroller();
k.add(m,{row:1,column:0});
k.add(new qx.ui.basic.Label(d).set({font:i,decorator:h,padding:3,allowGrowX:true}),{row:0,column:1});
var m=this.getWidgetCellSpanScroller();
k.add(m,{row:1,column:1});
this.__Vr=new qx.ui.virtual.cell.Cell();
...
this.__Vr.setBackgroundColor(s);
return this.__Vr.getCellProperties(q+e+r);
...
},__OL:function(p,q,r,s,top,t,u){var w=this._cellProvider.getCellProperties(q,r);
var v=w.insets||[0,0];
...
var N=I[i];
this.__OL(L,J.firstRow,J.firstColumn,N.left,N.top,N.width,N.height);
}}else{F=[];
...
if(!F[E][K]){this.__OL(L,E,K,M,top,G,D);
}K++;
M+=G;
}top+=D;
E++;
...
}return this.__Lx(J,M);
},__Lx:function(N,O){var P=[];
...
this.__Qv=[];
this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__Qw());
...
},__Qv:null,setCellSpan:function(u,v,w,x){var y=u+d+v;
this._spanManager.removeCell(y);

if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);
}qx.ui.core.queue.Widget.add(this);
},__Qw:function(){var self=this;
...
return z;
},__Qx:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);
...
}}},__Qy:function(){var O=this.getChildren();
...
this._add(L);
}}},_fullUpdate:function(P,Q,R,S){this.__Qx(P,Q,R.length,S.length);
this.__Qy();
this._cellLayer.fullUpdate(P,Q,R,S);
},_updateLayerWindow:function(T,U,V,W){this.__Qx(T,U,V.length,W.length);
this.__Qy();
...
this._cellProvider=this.__Qv=this._cells=this._bounds=this._spanMap=null;
}});
})();
