...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Label","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Label-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"d4a51a881562"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
