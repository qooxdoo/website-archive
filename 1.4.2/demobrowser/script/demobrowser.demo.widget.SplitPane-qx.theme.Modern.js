...
(function(){var l="value",k="horizontal",j="first",h="Trash",g="both",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",K="Windows (C:)",J="Toggle Splitpane Orientation",I="Inbox",H="Desktop",G="_container1",F="__Wt",E="execute",D="):",C="Presets",B="Network",s="changeSelection",t="Sent",q="Offset (",r="/",o="offset",p="Files",m="_container2",n="vertical",u="Workspace",v="Junk #",x="Data",w="Show both panes",z="Show second pane",y="demobrowser.demo.widget.SplitPane",A="Edit";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__Wt:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},_toggle:function(){var bd=this.__Wt.getOrientation();
this.__Wt.setOrientation(bd==k?n:k);
...
this._container2.show();
}},__Wu:function(){var bo=new qx.ui.tree.Tree();
...
bt.add(bs);
return bo;
}},destruct:function(){this._disposeObjects(F,G,m);
}});
})();
