...
qx.Class.define(C,{extend:qx.application.Standalone,members:{__VD:null,messenger:null,__VE:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var V=this.getRoot();
...
return be;
},showAddContactWindow:function(){if(this.__VD==null){var bn=new qx.ui.layout.Grid(5,10);
...
this.__VF=new demobrowser.demo.virtual.messenger.BuddyCell();
this.__VG=new demobrowser.demo.virtual.messenger.GroupCell();
this.__VG.addListener(h,this._onChangeOpenGroup,this);
this.__VH=[];
this.__VI={};
this.__VJ=[];
this.__VK=new qx.util.DeferredCall(this._updateGrouping,this);
},members:{__VJ:null,__VI:null,__VK:null,__VH:null,__VF:null,__VG:null,_getRowData:function(m){return this.__VJ[m];
},_getModelRow:function(n){return this.__VJ.indexOf(n);
},_getRowCount:function(){return this.__VJ.length;
},_isGroupHeader:function(o){return this.__VJ[o] instanceof demobrowser.demo.virtual.messenger.GroupModel;
},_getGroupModel:function(name,p){var q=this.__VI[name];
...
return q;
},_onChangeOpenGroup:function(e){var r=this.__VJ[e.getData().getUserData(c)];
r.toggleOpen();
this.__VK.schedule();
},getCellRenderer:function(s){if(this._isGroupHeader(s)){return this.__VG;
}else{return this.__VF;
}},isRowSelectable:function(t){return !this._isGroupHeader(t);
},_visualizeGrouping:function(u){var v=this.getTarget();

if(v){for(var i=0;i<this.__VH.length;i++){var w=this.__VH[i].getOldRow();
...
D=0;
var x=this._getGroupModel(z.getGroup(),this.__VJ.length);
this.__VJ.push(x);
y.push(x);
}
if(x.isOpen()){this.__VJ.push(z);
...
}},properties:{name:{init:c,event:g,check:a},row:{event:d,check:j,apply:b},open:{check:h,init:true,event:i},itemCount:{check:j,init:0,event:e}},members:{__VL:null,_applyRow:function(k,l){this.__VL=l;
},getOldRow:function(){return this.__VL;
}}});
})();
