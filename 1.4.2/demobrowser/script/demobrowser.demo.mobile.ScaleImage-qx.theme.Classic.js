...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.ScaleImage","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"c7f55b17a62d"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="px",j=")",i="div",h="50px",g="absolute",f="touchmove",d="height",c="url(",b="green",a="deg) scale(",D="200px",C="30px",B="qx.debug",A="12px",z="event.touch",y="-webkit-transform",x="touchend",w="width",v='Lucida Grande',u="innerHTML",r="qx.mobile.emulatetouch",s="59px",p="engine.name",q="demobrowser/demo/mobile/qooxdoo-logo.png",n="20px",o="rotate(",l="webkit",m="demobrowser.demo.mobile.ScaleImage",t="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(m,{extend:qx.application.Native,members:{__TX:null,__TY:1,__Ua:0,__Ub:0,__Uc:0,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(B)){qx.log.appender.Native;
qx.log.appender.Console;
}var G=new qx.html.Element(i);
G.useElement(document.body);
G.setRoot(true);

if(qx.core.Environment.get(p)!=l||(!qx.core.Environment.get(z)&&qx.core.Environment.get(r)==false)){var F={"color":b,"position":g,"font-family":v,"font-size":A,"left":C,"top":n};
var I=new qx.html.Element(i,F);
G.add(I);
I.setAttribute(u,t);
return;
}var H=qx.util.ResourceManager.getInstance().toUri(q);
var E={"width":D,"height":s,"position":g,"left":h,"top":h,"background":c+H+j};
this.__TX=new qx.html.Element("div",E);
this.__TX.addListener(f,this.__Ud,this);
this.__TX.addListener(x,this.__Ue,this);
G.add(this.__TX);
},__Ud:function(e){if(e.isMultiTouch()){this.__Ub=e.getRotation()+this.__Ua;
this.__Uc=e.getScale()*this.__TY;
this.__TX.setStyle(y,o+this.__Ub+a+this.__Uc+j);
}else{var J=parseInt(e.getDocumentLeft())-(parseInt(this.__TX.getStyle(w))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__TX.getStyle(d))/2);
this.__TX.setStyles({"left":J+k,"top":top+k});
}},__Ue:function(e){if(e.isMultiTouch()){this.__Ua=this.__Ub;
this.__TY=this.__Uc;
}}}});
})();
