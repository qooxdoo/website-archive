...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.UIDeclaration","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.UIDeclaration-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"661640733f95"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.__UX(D,C);
},__UX:function(E,F){var G=new F.clazz();
...
if(J!=null){for(var i=0;i<J.length;i++){if(G instanceof qx.ui.form.Form){this.__UY(G,J[i]);
}else{this.__UX(G,J[i]);
...
}}},__UY:function(L,M){if(M.type==="Header"){L.addGroupHeader(M.label);
return;
