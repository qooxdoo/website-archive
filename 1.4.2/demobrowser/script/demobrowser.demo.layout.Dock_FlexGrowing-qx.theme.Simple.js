...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_FlexGrowing","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Dock_FlexGrowing-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"19bb995c12d6"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var o="main",n="east",m="yellow",l="center",k="north",j="south",i="west",h="green",g="blue",f="fuchsia",c="orange",e="red",d="demobrowser.demo.layout.Dock_FlexGrowing",b="x",a="y";
...
scroll.add(q);
var p=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:o,backgroundColor:m,width:450,height:250,allowGrowX:false});
...
r.setSort(a);
var p=(new qx.ui.container.Composite(r)).set({decorator:o,backgroundColor:m,width:450,height:250,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:o,backgroundColor:e});
var v=new qx.ui.core.Widget().set({decorator:o,backgroundColor:g});
var u=new qx.ui.core.Widget().set({decorator:o,backgroundColor:c});
var t=new qx.ui.core.Widget().set({decorator:o,backgroundColor:h});
