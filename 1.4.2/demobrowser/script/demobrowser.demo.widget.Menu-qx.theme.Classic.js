...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.theme":"qx.theme.Classic"};
...
(function(){var ci="execute",ch="changeValue",cg="icon/16/actions/edit-cut.png",cf="changeSelection",ce="icon/16/actions/edit-paste.png",cd="Copy",cc="Paste",cb="icon/16/actions/edit-copy.png",ca="Cut",bY="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",cp="Print",cq="Open",cn="icon/16/actions/document-new.png",co="Online Forum",cl="icon/16/actions/format-justify-fill.png",cm="Search in files",cj="C",ck="__Wp",cr="Left aligned",cs="__Wm",bR="Perl",bQ="View",bT="C Dialect",bS="Info...",bV="Save as...",bU="Show line numbers",bX="Quickstart",bW="icon/16/actions/contact-new.png",bP="Ctrl+N",bO="__Ws",a="Actions",b="Show console",c="Search",d="Help",f="Show status bar",g="icon/16/actions/format-justify-left.png",h="ANSI to OEM",j="Centered",k="Website 3",l="Edit",cw="icon/16/actions/format-justify-center.png",cv="Ctrl+O",cu="icon/16/actions/go-previous.png",ct="C Sharp",cA="Close",cz="__Wr",cy="Split Button",cx="Website 2",cC="icon/16/actions/document-save-as.png",cB="Python",K="icon/16/apps/utilities-help.png",L="Show tree",I="Options",J="Spaces to tabs",O="Right aligned",P="Action 1",M="OEM to ANSI",N="Line 431",G="JavaScript",H="icon",t="Action 2",s="Folder ",v="XML",u="Line 313",p="Paragraph",o="demobrowser.demo.widget.Menu",r="icon/16/actions/application-exit.png",q="C Plus Plus",n="Line 26",m="__Wq",U="Item ",V="ASCII table",W="__Wl",X="Option 1",Q="Search next...",R="Line 12",S="Action 3",T="Replace in files",Y="Uppercase",ba="Ctrl+P",D="Topics",C="Panes",B="Justified",A="Ctrl+X",z="Search previous...",y="__Wo",x="Back",w="main",F="Show ruler",E="icon/16/actions/format-justify-right.png",bb="icon/16/actions/go-next.png",bc="Ctrl+Z",bd="__Wn",be="command ",bf="Option 3",bg="Next",bh="Ctrl+R",bi="Show macros",bj="Show tags",bk="Capitals",by="Format",bx="File",bw="Show tabs",bv="Tabs to spaces",bC="Search...",bB="Line 1039",bA="Option 2",bz="Objective C",bE="Exit",bD="move to",bL="Ctrl+S",bM="Syntax",bJ="Ctrl+C",bK="Website 1",bH="Menu Button",bI="Line 30",bF="Lowercase",bG="Replace",bN="HTML";
qx.Class.define(o,{extend:qx.application.Standalone,members:{__Wl:null,__Wm:null,__Wn:null,__Wo:null,__Wp:null,__Wq:null,__Wr:null,__Ws:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cE=new qx.ui.container.Scroll();
var cD=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cD.setPadding(20);
cD.setAllowStretchX(false);
cE.add(cD);
this.getRoot().add(cE,{edge:0});
this.createCommands();
cD.add(this.getMenuButton(),{left:20,top:20});
cD.add(this.getSplitButton(),{left:150,top:20});
cD.add(this.getMenuBar(),{left:20,top:100});
cD.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var cF=new qx.ui.menu.Menu();
var cG=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){cG.add(new qx.ui.menu.Button(s+(i+1)));
}cF.add(new qx.ui.menu.Button(bD,null,null,cG));
cF.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cF.add(new qx.ui.menu.Button(be+(i+1)));
}return cF;
...
},createCommands:function(){this.__Wl=new qx.ui.core.Command(bP);
this.__Wl.addListener(ci,this.debugCommand);
this.__Wm=new qx.ui.core.Command(cv);
this.__Wm.addListener(ci,this.debugCommand);
this.__Wn=new qx.ui.core.Command(bL);
this.__Wn.addListener(ci,this.debugCommand);
this.__Wo=new qx.ui.core.Command(bc);
this.__Wo.addListener(ci,this.debugCommand);
this.__Wp=new qx.ui.core.Command(bh);
this.__Wp.addListener(ci,this.debugCommand);
this.__Wq=new qx.ui.core.Command(A);
this.__Wq.addListener(ci,this.debugCommand);
this.__Wr=new qx.ui.core.Command(bJ);
this.__Wr.addListener(ci,this.debugCommand);
this.__Ws=new qx.ui.core.Command(ba);
this.__Ws.addListener(ci,this.debugCommand);
this.__Ws.setEnabled(false);
},getMenuButton:function(){var cH=new qx.ui.menu.Menu;
cH.add(new qx.ui.menu.RadioButton(X));
cH.add(new qx.ui.menu.RadioButton(bA));
cH.add(new qx.ui.menu.RadioButton(bf));
var cP=new qx.ui.menu.Menu;
cP.add(new qx.ui.menu.RadioButton(P));
cP.add(new qx.ui.menu.RadioButton(t));
cP.add(new qx.ui.menu.RadioButton(S));
var cO=new qx.ui.form.RadioGroup;
cO.add.apply(cO,cH.getChildren());
cO.addListener(cf,this.debugRadio);
var cM=new qx.ui.form.RadioGroup;
cM.add.apply(cM,cP.getChildren());
cM.addListener(cf,this.debugRadio);
var cK=new qx.ui.menu.Menu();
var cN=new qx.ui.menu.Button(bt,bn,this.__Wo);
var cU=new qx.ui.menu.Button(br,bl,this.__Wp);
var cJ=new qx.ui.menu.Button(ca,cg,this.__Wq);
var cR=new qx.ui.menu.Button(cd,cb,this.__Wr);
var cL=new qx.ui.menu.Button(cc,ce,this.__Ws);
var cI=new qx.ui.menu.Button(I,bY,null,cH);
var cS=new qx.ui.menu.Button(a,bW,null,cP);
var cQ=new qx.ui.menu.Button(cp,bp);
cN.addListener(ci,this.debugButton);
cU.addListener(ci,this.debugButton);
cJ.addListener(ci,this.debugButton);
cR.addListener(ci,this.debugButton);
cL.addListener(ci,this.debugButton);
cI.addListener(ci,this.debugButton);
cS.addListener(ci,this.debugButton);
cQ.addListener(ci,this.debugButton);
cK.add(cN);
cK.add(cU);
cK.addSeparator();
cK.add(cJ);
...
cK.addSeparator();
cK.add(cQ);
var cT=new qx.ui.form.MenuButton(bH,bq,cK);
return cT;
},getSplitButton:function(){var cV=new qx.ui.menu.Menu;
var da=new qx.ui.menu.Button(bK);
var cX=new qx.ui.menu.Button(cx);
var cY=new qx.ui.menu.Button(k);
cV.setMinWidth(120);
da.addListener(ci,this.debugButton);
cX.addListener(ci,this.debugButton);
cY.addListener(ci,this.debugButton);
cV.add(da);
cV.add(cX);
cV.add(cY);
var cW=new qx.ui.form.SplitButton(cy,bq,cV);
cW.addListener(ci,this.debugButton);
return cW;
},getMenuBar:function(){var df=new qx.ui.container.Composite(new qx.ui.layout.Grow);
df.setDecorator(w);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
df.add(toolbar);
var dp=new qx.ui.toolbar.Part;
var de=new qx.ui.toolbar.Part;
var di=new qx.ui.toolbar.Part;
toolbar.add(dp);
toolbar.add(de);
toolbar.addSpacer();
toolbar.add(di);
var dn=new qx.ui.toolbar.SplitButton(x,cu,this.getBackMenu());
var dk=new qx.ui.toolbar.SplitButton(bg,bb,this.getForwardMenu());
var dd=new qx.ui.toolbar.Button(bu,cn,this.__Wl);
var dh=new qx.ui.toolbar.Button(cq,bo,this.__Wm);
var dm=new qx.ui.toolbar.Button(bm,bs,this.__Wn);
dn.addListener(ci,this.debugButton);
dk.addListener(ci,this.debugButton);
dd.addListener(ci,this.debugButton);
dh.addListener(ci,this.debugButton);
dm.addListener(ci,this.debugButton);
dp.add(dn);
dp.add(dk);
dp.addSeparator();
dp.add(dd);
...
dp.add(dm);
dp.setShow(H);
var dg=new qx.ui.toolbar.MenuButton(bx);
var dc=new qx.ui.toolbar.MenuButton(l);
var db=new qx.ui.toolbar.MenuButton(c);
var dq=new qx.ui.toolbar.MenuButton(bQ);
var dl=new qx.ui.toolbar.MenuButton(by);
dg.setMenu(this.getFileMenu());
dc.setMenu(this.getEditMenu());
db.setMenu(this.getSearchMenu());
dq.setMenu(this.getViewMenu());
dl.setMenu(this.getFormatMenu());
de.add(dg);
de.add(dc);
de.add(db);
de.add(dq);
de.add(dl);
var dj=new qx.ui.toolbar.MenuButton(d);
dj.setMenu(this.getHelpMenu());
di.add(dj);
return df;
},getBackMenu:function(){var ds=new qx.ui.menu.Menu;
var dt=new qx.ui.menu.Button(u);
var dv=new qx.ui.menu.Button(bB);
var dr=new qx.ui.menu.Button(R);
var du=new qx.ui.menu.Button(n);
dt.addListener(ci,this.debugButton);
dv.addListener(ci,this.debugButton);
dr.addListener(ci,this.debugButton);
du.addListener(ci,this.debugButton);
ds.add(dt);
ds.add(dv);
ds.add(dr);
ds.add(du);
return ds;
},getForwardMenu:function(){var dw=new qx.ui.menu.Menu;
var dx=new qx.ui.menu.Button(N);
var dy=new qx.ui.menu.Button(bI);
dx.addListener(ci,this.debugButton);
dy.addListener(ci,this.debugButton);
dw.add(dx);
dw.add(dy);
return dw;
},getFileMenu:function(){var dB=new qx.ui.menu.Menu;
var dz=new qx.ui.menu.Button(bu,cn,this.__Wl);
var dD=new qx.ui.menu.Button(cq,bo,this.__Wm);
var dC=new qx.ui.menu.Button(cA);
var dG=new qx.ui.menu.Button(bm,bs,this.__Wn);
var dF=new qx.ui.menu.Button(bV,cC);
var dE=new qx.ui.menu.Button(cp,bp);
var dA=new qx.ui.menu.Button(bE,r);
dz.addListener(ci,this.debugButton);
dD.addListener(ci,this.debugButton);
dC.addListener(ci,this.debugButton);
dG.addListener(ci,this.debugButton);
dF.addListener(ci,this.debugButton);
dE.addListener(ci,this.debugButton);
dA.addListener(ci,this.debugButton);
dB.add(dz);
dB.add(dD);
dB.add(dC);
...
dB.add(dA);
return dB;
},getEditMenu:function(){var dI=new qx.ui.menu.Menu;
var dL=new qx.ui.menu.Button(bt,bn,this.__Wo);
var dK=new qx.ui.menu.Button(br,bl,this.__Wp);
var dH=new qx.ui.menu.Button(ca,cg,this.__Wq);
var dM=new qx.ui.menu.Button(cd,cb,this.__Wr);
var dJ=new qx.ui.menu.Button(cc,ce,this.__Ws);
dL.addListener(ci,this.debugButton);
dK.addListener(ci,this.debugButton);
dH.addListener(ci,this.debugButton);
dM.addListener(ci,this.debugButton);
dJ.addListener(ci,this.debugButton);
dI.add(dL);
dI.add(dK);
dI.addSeparator();
dI.add(dH);
...
dI.add(dJ);
return dI;
},getSearchMenu:function(){var dQ=new qx.ui.menu.Menu;
var dO=new qx.ui.menu.Button(bC,bY);
var dT=new qx.ui.menu.Button(Q);
var dP=new qx.ui.menu.Button(z);
var dS=new qx.ui.menu.Button(bG);
var dN=new qx.ui.menu.Button(cm,bY);
var dR=new qx.ui.menu.Button(T);
dP.setEnabled(false);
dO.addListener(ci,this.debugButton);
dT.addListener(ci,this.debugButton);
dP.addListener(ci,this.debugButton);
dS.addListener(ci,this.debugButton);
dN.addListener(ci,this.debugButton);
dR.addListener(ci,this.debugButton);
dQ.add(dO);
dQ.add(dT);
...
dQ.add(dR);
return dQ;
},getViewMenu:function(){var dU=new qx.ui.menu.Menu;
var dW=new qx.ui.menu.Button(C,null,null,this.getPanesMenu());
var ea=new qx.ui.menu.Button(bM,null,null,this.getSyntaxMenu());
var dY=new qx.ui.menu.CheckBox(F);
var dX=new qx.ui.menu.CheckBox(bU);
var dV=new qx.ui.menu.Button(V);
dY.addListener(ch,this.debugCheckBox);
dX.addListener(ch,this.debugCheckBox);
dV.addListener(ci,this.debugButton);
dU.add(dW);
dU.add(ea);
dU.addSeparator();
...
dU.add(dV);
return dU;
},getPanesMenu:function(){var ec=new qx.ui.menu.Menu;
var ee=new qx.ui.menu.CheckBox(bw);
var eg=new qx.ui.menu.CheckBox(f);
var eh=new qx.ui.menu.CheckBox(L);
var ed=new qx.ui.menu.CheckBox(bi);
var ef=new qx.ui.menu.CheckBox(bj);
var eb=new qx.ui.menu.CheckBox(b);
ee.setValue(true);
eg.setValue(true);
ed.setValue(true);
ee.addListener(ch,this.debugCheckBox);
eg.addListener(ch,this.debugCheckBox);
eh.addListener(ch,this.debugCheckBox);
ed.addListener(ch,this.debugCheckBox);
ef.addListener(ch,this.debugCheckBox);
eb.addListener(ch,this.debugCheckBox);
ec.add(eg);
ec.add(ee);
ec.addSeparator();
ec.add(eh);
...
ec.add(eb);
return ec;
},getSyntaxMenu:function(){var em=new qx.ui.menu.Menu;
var ei=new qx.ui.menu.RadioButton(bN);
var ek=new qx.ui.menu.RadioButton(v);
var ej=new qx.ui.menu.RadioButton(G);
var el=new qx.ui.menu.Button(bT,null,null,this.getSyntaxCMenu());
var ep=new qx.ui.menu.RadioButton(bR);
var en=new qx.ui.menu.RadioButton(cB);
em.add(ei);
em.add(ek);
em.add(ej);
em.add(el);
em.add(ep);
em.add(en);
var eo=new qx.ui.form.RadioGroup;
eo.add(ei,ek,ej,ep,en);
eo.add.apply(eo,el.getMenu().getChildren());
eo.addListener(cf,this.debugRadio);
return em;
},getSyntaxCMenu:function(){var er=new qx.ui.menu.Menu;
var eq=new qx.ui.menu.RadioButton(cj);
var eu=new qx.ui.menu.RadioButton(ct);
var et=new qx.ui.menu.RadioButton(bz);
var es=new qx.ui.menu.RadioButton(q);
er.add(eq);
er.add(eu);
er.add(et);
er.add(es);
return er;
},getFormatMenu:function(){var ey=new qx.ui.menu.Menu;
var ex=new qx.ui.menu.Button(p,null,null,this.getParagraphMenu());
var eA=new qx.ui.menu.Button(bv);
var eB=new qx.ui.menu.Button(J);
var ew=new qx.ui.menu.Button(Y);
var ez=new qx.ui.menu.Button(bF);
var ev=new qx.ui.menu.Button(bk);
var eD=new qx.ui.menu.Button(M);
var eC=new qx.ui.menu.Button(h);
eA.addListener(ci,this.debugButton);
eB.addListener(ci,this.debugButton);
ew.addListener(ci,this.debugButton);
ez.addListener(ci,this.debugButton);
ev.addListener(ci,this.debugButton);
eD.addListener(ci,this.debugButton);
eC.addListener(ci,this.debugButton);
ey.add(ex);
ey.add(eA);
ey.add(eB);
ey.addSeparator();
...
ey.add(eC);
return ey;
},getParagraphMenu:function(){var eE=new qx.ui.menu.Menu;
var eH=new qx.ui.menu.Button(cr,g);
var eI=new qx.ui.menu.Button(O,E);
var eF=new qx.ui.menu.Button(j,cw);
var eG=new qx.ui.menu.Button(B,cl);
eH.addListener(ci,this.debugButton);
eI.addListener(ci,this.debugButton);
eF.addListener(ci,this.debugButton);
eG.addListener(ci,this.debugButton);
eE.add(eH);
eE.add(eI);
eE.add(eF);
eE.add(eG);
return eE;
},getHelpMenu:function(){var eJ=new qx.ui.menu.Menu;
var eL=new qx.ui.menu.Button(D,K);
var eN=new qx.ui.menu.Button(bX);
var eM=new qx.ui.menu.Button(co);
var eK=new qx.ui.menu.Button(bS);
eL.addListener(ci,this.debugButton);
eN.addListener(ci,this.debugButton);
eM.addListener(ci,this.debugButton);
eK.addListener(ci,this.debugButton);
eJ.add(eL);
eJ.add(eN);
eJ.addSeparator();
eJ.add(eM);
...
eJ.add(eK);
return eJ;
},getList:function(){var eO=new qx.ui.form.List;
eO.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){eO.add(new qx.ui.form.ListItem(U+i));
}return eO;
},getContextMenu:function(){var eP=new qx.ui.menu.Menu;
var eR=new qx.ui.menu.Button(ca,cg,this.__Wq);
var eS=new qx.ui.menu.Button(cd,cb,this.__Wr);
var eQ=new qx.ui.menu.Button(cc,ce,this.__Ws);
eR.addListener(ci,this.debugButton);
eS.addListener(ci,this.debugButton);
eQ.addListener(ci,this.debugButton);
eP.add(eR);
eP.add(eS);
eP.add(eQ);
return eP;
}},destruct:function(){this._disposeObjects(W,cs,bd,y,ck,m,cz,bO);
}});
})();
