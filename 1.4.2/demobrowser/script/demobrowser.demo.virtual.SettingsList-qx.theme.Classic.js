...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.SettingsList","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.SettingsList-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d3b54514f69b"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(b,{extend:qx.application.Standalone,members:{__VM:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var r=[];
var s=[h,c,a,g];

for(var i=0;i<s.length;i++){r[i]={name:s[i],checked:i<2,group:null};
}this.__VM=qx.data.marshal.Json.createModel(r,true);
var t=[];
...
this.__VM.toArray().forEach(function(u,v){v=v<2?0:1;
...
this.__VM.forEach(function(z){if(x.getLabel()==z.getGroup().getName()){z.setChecked(y);
}});
},this);
