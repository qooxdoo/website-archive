...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Tree_Highlight","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.animation.Tree_Highlight-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"e93baee89e3e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{startColor:{init:c,check:f},endColor:{init:a,check:f},restoreBackground:{init:true,check:h},keepBackgroundImage:{init:false,check:h}},members:{__Jg:null,__Jh:null,__Ji:null,__Jj:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var j=this._getElement();
this.__Jg={backgroundImage:qx.bom.element.Style.get(j,g),backgroundColor:qx.bom.element.Style.get(j,i)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,g,e);
}this.__Jh=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__Ji=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__Jj=[this.__Ji[0]-this.__Jh[0],this.__Ji[1]-this.__Jh[1],this.__Ji[2]-this.__Jh[2]];
},update:function(k){qx.fx.Base.prototype.update.call(this);
var l=[this.__Jh[0]+Math.round(this.__Jj[0]*k),this.__Jh[1]+Math.round(this.__Jj[1]*k),this.__Jh[2]+Math.round(this.__Jj[2]*k)];
...
for(var n in this.__Jg){qx.bom.element.Style.set(o,n,this.__Jg[n]);
}}},destruct:function(){this.__Jh=this.__Ji=this.__Jj=null;
}});
})();
