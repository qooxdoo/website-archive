...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Window_Editor","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Window_Editor-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"a9c6bf7ac5f5"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
z.moveTo(300,250);
z.addListener(f,function(e){z.__UH.focus();
z.__UH.setTextSelection(0,z.__UH.getValue().length);
});
z.__UH=new qx.ui.form.TextField(w.value+"").set({allowGrowY:true});
z.add(z.__UH);
...
return z;
},getCellEditorValue:function(A){return parseFloat(A.__UH.getValue());
}}});
})();
