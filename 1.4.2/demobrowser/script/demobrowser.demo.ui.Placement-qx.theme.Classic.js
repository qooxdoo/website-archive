...
qx.Class.define(k,{extend:qx.application.Standalone,members:{__Vp:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__Vp=[n,p,q,l,o,b,d,m];
...
for(var i=0;i<this.__Vp.length;i++){var x=new qx.ui.form.ListItem(this.__Vp[i]);
v.add(x);

if(this.__Vp[i]==u){z=x;
}}y.add(v);
...
for(var i=0;i<this.__Vp.length;i++){B.add(new qx.ui.form.ListItem(this.__Vp[i]));
}D.add(B);
