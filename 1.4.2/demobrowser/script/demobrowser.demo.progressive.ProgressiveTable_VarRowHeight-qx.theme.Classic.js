...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_VarRowHeight","qx.theme":"qx.theme.Classic"};
...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Uh:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var A=p;
...
--this.__Uh;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Uh+", end="+this.imageData.length);
if(this.__Uh==0){this.doLoad();
}return;
...
if(d===undefined){this.__MJ=d;
}else{this.__MJ=16;
}
if(e===undefined){this.__MK=e;
}else{this.__MK=16;
}},members:{__MJ:null,__MK:null,_identifyImage:function(f){var j={imageWidth:this.__MJ,imageHeight:this.__MK};
var k;
