...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Canvas","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Canvas-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"e40f777db5de"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
