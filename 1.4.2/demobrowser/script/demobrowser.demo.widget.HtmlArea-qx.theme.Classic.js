...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.HtmlArea","qx.theme":"qx.theme.Classic"};
...
(function(){var bB="",bA="execute",bz="<tr>",by="changeSelection",bx="#",bw="qooxdoo logo",bv="</tr>",bu="qx/icon/Oxygen/16/actions/format-indent-more.png",bt="Color (Hex): ",bs="Georgia",bh="http://",bg="Change Font Size",bf="BgColor (Hex): ",be="Indent More",bd="<p>You can play around with this widget by hitting the ",bc="Inserted Unordered List",bb="Align Right",ba="Format Italic",Y="qx/icon/Oxygen/16/actions/format-text-underline.png",X='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bI="OK",bJ="buttons at the toolbar.</p>",bG="demobrowser.demo.widget.HtmlArea",bH="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bE="Comic Sans MS",bF="<p>This UI-level widget can be used at RIA (Rich ",bC="Tahoma",bD="<td>First Row, First cell</td>",bK="solid",bL="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",bl="qx/icon/Oxygen/16/actions/format-justify-center.png",bk="Align Justify",bn="demobrowser/demo/icons/htmlarea/format-fill-color.png",bm="demobrowser/demo/icons/htmlarea/insert-text.png",bp="Insert Horizontal Ruler",bo="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",br="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bq="HTML Code:",bj="Set Text Background Color",bi="Internet Applications) and inline applications.<br/>",a="Insert Link",b="<td>Second Row, First cell</td>",c="</tbody>",d="Set Text Color",f="Insert Table",g="Cancel",h="As an application developer you can <b>use the same API.</b></p>",k="demobrowser/demo/icons/htmlarea/format-text-color.png",l="demobrowser/demo/icons/htmlarea/insert-table.png",m="qx/icon/Oxygen/16/actions/edit-undo.png",bP="qx/icon/Oxygen/16/actions/edit-clear.png",bO="Arial Black",bN="Impact",bM="Undo Last Change",bT="Redo Last Undo Step",bS="Format Bold",bR="Change Font Family",bQ="right",bV="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bU="main",H="Insert Hyperlink",I="Remove Format",F="blank.html",G="qx/icon/Oxygen/16/actions/insert-image.png",L="so code-duplication is avoided.<br/>",M="</table>",J="12px ",K="<td>First Row, Second cell</td>",D="Insert HTML Code",E="qx/icon/Oxygen/16/actions/insert-link.png",u="Insert Ordered List",t="qx/icon/Oxygen/16/actions/format-justify-left.png",w="Courier",v="Courier New",q="qx/icon/Oxygen/16/actions/format-justify-right.png",p="qx/icon/Oxygen/16/actions/format-text-bold.png",s="<td>Second Row, Second cell</td>",r="Insert Image",o="<h1>HtmlArea UI-level widget</h1>",n="Align Left",R="<table border='1'>",S="The UI widget does use the low-level component internally ",T="qx/icon/Oxygen/16/actions/format-indent-less.png",U="<tbody>",N="Times New Roman",O="Align Center",P="qx/icon/Oxygen/16/actions/edit-redo.png",Q="Lucida Console",V="border-main",W="qx/icon/Oxygen/16/actions/format-text-italic.png",C="Arial",B="qx/icon/Oxygen/16/actions/format-justify-fill.png",A="Verdana",z="Indent Less",y="Format Strikethrough",x="Format Underline";
qx.Class.define(bG,{extend:qx.application.Standalone,members:{__Wa:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cd=o+bF+bi+S+L+h+bd+bJ;
var bX=new qx.ui.basic.Label(cd);
bX.set({rich:true,marginBottom:10});
var cc=X;
var cb=this.getRoot();
var ca=new qx.ui.decoration.Single(1,bK,V);
ca.setWidthTop(0);
this.__Wa=new qx.ui.embed.HtmlArea(cc,null,F);
this.__Wa.set({width:600,height:400,decorator:ca});
var toolbar=this.__Wk();
var bW=new qx.ui.layout.VBox(0);
var bY=new qx.ui.container.Composite(bW);
bY.add(bX);
bY.add(toolbar);
bY.add(this.__Wa);
cb.add(bY,{left:20,top:20});
},__Wb:function(e){var ce=window.prompt(bt,bx);
this.setTextColor(ce);
},__Wc:function(e){var cf=window.prompt(bf,bx);
this.setTextBackgroundColor(cf);
},__Wd:function(e){var cg={src:qx.util.ResourceManager.getInstance().toUri(bL),border:0,title:bw,alt:bw};
this.insertImage(cg);
},__We:function(e){var ch=R+U+bz+bD+K+bv+bz+b+s+bv+c+M;
this.insertHtml(ch);
},__Wf:function(e){var cj=new qx.ui.window.Window(H);
cj.setLayout(new qx.ui.layout.VBox(20));
cj.set({width:400,showMaximize:false,showMinimize:false});
var cn=new qx.ui.form.TextField(bh);
cj.add(cn);
var cl=new qx.ui.layout.HBox(10);
cl.setAlignX(bQ);
var cm=new qx.ui.container.Composite(cl);
var ci=new qx.ui.form.Button(bI);
ci.setWidth(60);
ci.addListener(bA,function(e){this.insertHyperLink(cn.getValue());
cj.close();
},this);
cm.add(ci);
var ck=new qx.ui.form.Button(g);
ck.setWidth(60);
ck.addListener(bA,function(e){cj.close();
},this);
cm.add(ck);
cj.add(cm);
cj.center();
cj.open();
this.saveRange();
},__Wg:function(e){var co=window.prompt(bq,bB);
this.insertHtml(co);
},__Wh:function(){var cq=new qx.ui.form.SelectBox;
cq.set({toolTipText:bR,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
cq.add(new qx.ui.form.ListItem(bB));
var cr=[bC,A,N,C,bO,v,w,bs,bN,bE,Q];
var cp;

for(var i=0,j=cr.length;i<j;i++){cp=new qx.ui.form.ListItem(cr[i]);
cp.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(J+cr[i])});
cq.add(cp);
}cq.addListener(by,function(e){var cs=e.getData()[0].getLabel();

if(cs!=bB){this.setFontFamily(cs);
cq.setSelection([cq.getChildren()[0]]);
}},this.__Wa);
return cq;
},__Wi:function(){var cu=new qx.ui.form.SelectBox;
cu.set({toolTipText:bg,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
cu.add(new qx.ui.form.ListItem(bB));
var ct;

for(var i=1;i<=7;i++){ct=new qx.ui.form.ListItem(i+bB);
ct.set({focusable:false,keepFocus:true});
cu.add(ct);
}cu.addListener(by,function(e){var cv=e.getData()[0].getLabel();

if(cv!=bB){this.setFontSize(cv);
cu.setSelection([cu.getChildren()[0]]);
}},this.__Wa);
return cu;
},__Wj:function(){return [{bold:{text:bS,image:p,action:this.__Wa.setBold},italic:{text:ba,image:W,action:this.__Wa.setItalic},underline:{text:x,image:Y,action:this.__Wa.setUnderline},strikethrough:{text:y,image:bV,action:this.__Wa.setStrikeThrough},removeFormat:{text:I,image:bP,action:this.__Wa.removeFormat}},{alignLeft:{text:n,image:t,action:this.__Wa.setJustifyLeft},alignCenter:{text:O,image:bl,action:this.__Wa.setJustifyCenter},alignRight:{text:bb,image:q,action:this.__Wa.setJustifyRight},alignJustify:{text:bk,image:B,action:this.__Wa.setJustifyFull}},{fontFamily:{custom:this.__Wh},fontSize:{custom:this.__Wi},fontColor:{text:d,image:k,action:this.__Wb},textBackgroundColor:{text:bj,image:bn,action:this.__Wc}},{indent:{text:be,image:bu,action:this.__Wa.insertIndent},outdent:{text:z,image:T,action:this.__Wa.insertOutdent}},{insertImage:{text:r,image:G,action:this.__Wd},insertTable:{text:f,image:l,action:this.__We},insertLink:{text:a,image:E,action:this.__Wf},insertHTML:{text:D,image:bm,action:this.__Wg},insertHR:{text:bp,image:bo,action:this.__Wa.insertHorizontalRuler}},{ol:{text:u,image:bH,action:this.__Wa.insertOrderedList},ul:{text:bc,image:br,action:this.__Wa.insertUnorderedList}},{undo:{text:bM,image:m,action:this.__Wa.undo},redo:{text:bT,image:P,action:this.__Wa.redo}}];
},__Wk:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator(bU);
var cw;
var cx=this.__Wj();

for(var i=0,j=cx.length;i<j;i++){var cy=new qx.ui.toolbar.Part;
toolbar.add(cy);

for(var cz in cx[i]){var cA=cx[i][cz];

if(cA.custom){cw=cA.custom.call(this);
}else{cw=new qx.ui.toolbar.Button(null,cA.image);
cw.set({focusable:false,keepFocus:true,center:true,toolTipText:cA.text?cA.text:bB});
cw.addListener(bA,cA.action,this.__Wa);
}cy.add(cw);
}}return toolbar;
}}});
})();
...
}qx.event.Timer.once(function(){this.__AU();
},this,0);
}}else{this.__AT=0;
...
(function(){var o="engine.name",n="",m="qx.debug",h="BackColor",g="inserthtml",f="string",d="textDecoration",c="backgroundImage",b="backgroundRepeat",a='|',bf=" ",be="backgroundPosition",bd="id",bc="fontStyle",bb="backgroundColor",ba="_moz",Y=")",X="indent",W='" ',V="repeat repeat-x repeat-y no-repeat",v="qx.bom.htmlarea.manager.Command",w='</p>',t="insertParagraph",u="underline",r='"></span>',s="'><br class='webkit-block-placeholder' />",p="_moz_dirty",q="no-repeat",z="transparent",A="italic",I="type",G="url(",N=":",K="<p style='",R="line-through",P="__paragraph__",C='<p id="',U="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",T="__placeholder__",S='>',B="outdent",E='<span id="',F="top",H="HiliteColor",J="br",L="fontWeight",O='',Q="p",x="bold",y="webkit",D=";",M="body";
qx.Class.define(v,{extend:qx.core.Object,construct:function(bg){qx.core.Object.call(this);
this.__Bt=bg;
this.__Bu=null;
this._commands=null;
this.__BB();
...
this.__Bx=0;
},statics:{__By:U,__Bz:V},members:{__Bu:null,__Bt:null,__BA:false,__Bv:null,__Bw:null,__Bx:null,setContentDocument:function(bh){this.__Bu=bh;
},getCommandObject:function(bi){if(this._commands[bi]){return this._commands[bi];
}else{return null;
...
},execute:function(bj,bk){if(!this.__Bt.isReady()){this.error("editor not ready! '"+bj+"':'"+bk+"'");
return false;
}bj=bj.toLowerCase();
bk=bk!=null?bk:null;
if(this._commands[bj]){var bl;
var bm=this._commands[bj];
if(!((qx.core.Environment.get(o)==y)&&(bj==X||bj==B))){if(this.__BC()){this.__BD();
}}if(bm.useBuiltin){bl=this.__BE(bm.identifier,false,bk);
}else{if(bm.method!=null&&this[bm.method]){bl=this[bm.method].call(this,bk,bm);
}else{this.error("The method '"+bm.method+"' you calling to execute the command '"+bj+"' is not available!");
}}this.__Bt.resetSavedRange();
return bl;
}else{this.error("Command "+bj+" is currently not supported!");
}},__BC:function(){var Node=qx.dom.Node;
var bn=this.__Bt.getFocusNode();
var bq=false;
var bo=false;

if(bn){if(Node.isText(bn)){var bp=qx.dom.Hierarchy.getAncestors(bn);

for(var i=0,j=bp.length;i<j;i++){if(Node.isNodeName(bp[i],"p")||qx.bom.htmlarea.HtmlArea.isHeadlineNode(bp[i])){bq=true;
break;
}}}else if(Node.isNodeName(bn,"body")){bo=true;
}}return bo||!bq;
},__BD:function(){this.__BE("formatBlock",false,"p");
},__BE:function(br,bs,bt){try{var bw=this.__Bu;
var bu=false;
var bv=this.__Bt.getRange();
this.__Bu.body.focus();
if((qx.core.Environment.get("engine.name")=="mshtml")){if(br!="selectall"){bv.select();
if(((bv.text)&&(bv.text.length>0))||((bv.length==1)&&(bv.item(0))&&(bv.item(0).tagName=="IMG"))){bw=bv;
}else{bw=this.__Bu;
}}if(((qx.core.Environment.get("engine.name")=="mshtml"))&&(this.__Bv[br])){if(bv.text==""){bu=true;
}}}var bx=bw.execCommand(br,bs,bt);

if(bu&&bv.text!=""){bv.collapse();
}
if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("execCommand "+br+" with value "+bt+" succeded");
}this.__BA=false;
}catch(by){if((qx.core.Environment.get("qx.debug"))&&qx.core.Environment.get("qx.bom.htmlarea.HtmlArea.debug")){this.debug("execCommand "+br+" with value "+bt+" failed");
}return false;
}return bx;
},__BF:qx.core.Environment.select("engine.name",{"mshtml":function(){var bA=this.__Bt;
var bz=bA.getSavedRange()!=null?bA.getSavedRange():bA.getRange();
return bz;
},"default":function(){return this.__Bt.getRange();
}}),__BG:qx.core.Environment.select("engine.name",{"mshtml":function(bB,bC){var bF;
if(bB==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__BJ();
}else{this.__Bu.body.focus();
var bE=this.__Bt.getSelection();
var bD=this.__BF();
if(bD&&bE&&bE.type!="Control"){try{bD.pasteHTML(bB);
bD.collapse(false);
bD.select();
bF=true;
}catch(e){}}else{bF=false;
}this.__Bt.resetSavedRange();
return bF;
}},"default":function(bG,bH){this.__Bu.body.focus();
return this.__Bu.execCommand(bH.identifier,false,bG);
}}),insertParagraphOnLinebreak:qx.core.Environment.select(o,{"gecko":function(){var bP=this.__BT();
var bT=this.__BH(bP);
var bL=this.__BR(bP);
var bQ=T+Date.parse(new Date());
var bR=P+Date.parse(new Date());
var bJ=O;
var bN=E+bQ+r;
bJ+=bN;
bJ+=C+bR+W+bT+S;
bJ+=bL+w;
this.__Bt.getCommandManager().addUndoStep(g,t,this.getCommandObject(g));
this.execute(g,bJ);
this.__BI();
qx.bom.element.Attribute.reset(this.__Bu.getElementById(bQ),bd);
var bO=this.__Bu.getElementById(bR);

if(bO.previousSibling.innerHTML==bN){var bI=this.__BS();
var bM=this.__Bu.createElement(J);
var bK=this.__Bu.createAttribute(p);
bK.nodeValue=n;
bM.setAttributeNode(bK);
var bS=this.__Bu.createAttribute(I);
bS.nodeValue=ba;
bM.setAttributeNode(bS);
bO.previousSibling.appendChild(bI);
bO.previousSibling.appendChild(bM);
}qx.bom.element.Attribute.reset(bO,bd);
return true;
},"webkit":function(){var bU=this.getCurrentStyles();
var bV=n;
var bX={"background-color":true,"text-align":true};
for(var bW in bU){if(bX[bW]){bV+=bW+N+bU[bW]+D;
}}this.__Bt.insertHtml(K+bV+s);
},"default":qx.lang.Function.empty}),__BH:qx.core.Environment.select("engine.name",{"gecko":function(bY){var ce='style="';
var cd=bY.child;
if(cd["text-align"]){ce+='text-align:'+cd["text-align"]+';';
delete bY.child["text-align"];
}if(cd["font-family"]){ce+='font-family:'+cd["font-family"]+';';
delete bY.child["font-family"];
}var cc={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};
var ca={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};

for(var cb in cd){if(cc[cb]||ca[cb]){ce+=cb+':'+cd[cb]+';';
delete bY.child[cb];
}}ce+='"';
return ce;
},"default":function(){return "";
}}),__BI:qx.core.Environment.select("engine.name",{"gecko":function(){var cm=this.__Bt.getSelection();

if(!cm||!cm.focusNode){return;
}var cf=cm.focusNode;
var ck=cm.focusNode;

while(!qx.dom.Node.isNodeName(ck,"p")){ck=ck.parentNode;
}var cj=ck.previousSibling.id;
var cn=ck.nextSibling?ck.nextSibling.id:null;

if(qx.lang.String.startsWith(cj,"__paragraph__")&&cj==cn){var cl=ck.nextSibling;
var ch=this.__Bt.getRange();
ch.selectNode(cl);
cm.addRange(ch);
var cg=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;
this.__Bt.getCommandManager().addUndoStep("inserthtml",cg,this.getCommandObject("inserthtml"));
this.execute("inserthtml",cg);
var ci=this.__Bt.getRange();

if(cf){while(cf&&cf.firstChild&&qx.dom.Node.isElement(cf.firstChild)){cf=cf.firstChild;
}}ci.selectNode(cf);
cm.addRange(ci);
ci.collapse(true);
}},"default":qx.lang.Function.empty}),__BJ:qx.core.Environment.select("engine.name",{"mshtml":function(){var co=this.__Bt.getRange();
if(co&&!qx.dom.Node.isNodeName(co.parentElement(),"li")){co.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);
co.collapse(false);
co.select();
return true;
}return false;
},"default":function(){return false;
}}),__BK:function(cp,cq){var cr=(qx.core.Environment.get("engine.name")=="mshtml")?this.__Bt.getRange():this.__Bu;
return cr.execCommand(cq.identifier,false,cp);
},__BL:function(cs,ct){if((qx.core.Environment.get("engine.name")=="mshtml")){var cu=this.__Bt.getFocusNode();
this.__BM(cu);
}this.__Bu.body.focus();
var cv=this.__Bu.execCommand(ct.identifier,false,cs);

if((qx.core.Environment.get("engine.name")=="webkit")){var cu=this.__Bt.getFocusNode();
this.__BM(cu.parentNode);
}return cv;
},__BM:function(cw){var cx=[];
var parent=cw.parentNode;

while(qx.dom.Node.isNodeName(parent,"blockquote")){cx.push(parent);
parent=parent.parentNode;
}if(cx.length>0){parent.appendChild(cw);
parent.removeChild(cx[cx.length-1]);
}},__BN:qx.core.Environment.select("engine.name",{"gecko":function(cy,cz){if(cy.src){this.__Bu.execCommand(cz.identifier,false,cy.src);
delete cy.src;
var cM=this.__Bt.getSelection();
if(cM){var cL=cM.anchorNode;
var cG=cM.anchorOffset;
var cD=cL.childNodes[cG-1];
var cJ;

for(var cF in cy){cJ=this.__Bu.createAttribute(cF);
cJ.nodeValue=cy[cF];
cD.setAttributeNode(cJ);
}var cE={"font":true,"span":true};
var cB=null;
var cI=true;
if(qx.dom.Node.isElement(cD.previousSibling)&&cE[qx.dom.Node.getName(cD.previousSibling)]){cB=cD.previousSibling;
}else if(cE[qx.dom.Node.getName(cD.parentNode)]){cB=cD.parentNode;
cI=false;
}var cC=this.__Bu.createDocumentFragment();
var cN;

if(cI&&cB!=null){var cE=this.__BO(cB);
cC.appendChild(cE.root);
cN=cE.inline;
}else{cN=this.__Bu.createElement("span");
cC.appendChild(cN);
}var cK=this.__Bu.createTextNode("");
cN.appendChild(cK);
var cH=cD.parentNode;
if(cD==cH.lastChild){cH.appendChild(cC);
}else{cH.insertBefore(cC,cD.nextSibling);
}var cA=this.__Bt.getRange();
cA.selectNodeContents(cN);
}return true;
}else{return false;
}},"mshtml":function(cO,cP){var cT=false;
var cU="<img ";

for(var cQ in cO){cU+=cQ+"='"+cO[cQ]+"' ";
}cU+="/>";
var cR=this.__Bt.getSelection();
var cS=this.__BF();
if(cR&&cR.type!="Control"){try{cS.select();
cS.pasteHTML(cU);
cT=true;
}catch(e){}}this.__Bt.resetSavedRange();
return cT;
},"default":function(cV,cW){if(cV.src){var cY="<img ";

for(var cX in cV){cY+=cX+"='"+cV[cX]+"' ";
}cY+="/>";
return this.__Bu.execCommand("InsertHtml",false,cY);
}else{return false;
}}}),__BO:function(da){while(da.firstChild&&da.firstChild.nodeType==1){da=da.firstChild;
}var de=this.__BT(da);
var di,dc,dg;
var db="";
var parent=null;
...
while(df){dh=this.__Bu.createElement(df["legacy-font-size"]?"font":"span");
dc=this.__Bu.createAttribute("style");
dh.setAttributeNode(dc);
for(var dd in df){if(dd!="child"&&dd!="legacy-font-size"){db+=dd+":"+df[dd]+";";
}else if(dd=="legacy-font-size"){dg=this.__Bu.createAttribute("size");
dg.nodeValue=df[dd];
dh.setAttributeNode(dg);
}}dc.nodeValue=db;

if(parent!=null){parent.appendChild(dh);
}else{di=dh;
}parent=dh;
df=df.child;
db="";
}return {root:di,inline:dh};
},__BP:qx.core.Environment.select("engine.name",{"gecko|opera":function(dj,dk){var dr=this.__Bt.getSelection();
var dn=this.__Bt.getRange();
if(dr.isCollapsed){var dm="qx_link"+(++this.__Bx);
var ds=this.__Bu.createElement("a");
var dp=this.__Bu.createAttribute("href");
var dl=this.__Bu.createAttribute("id");
var dq=this.__Bu.createTextNode(dj);
dl.nodeValue=dm;
ds.setAttributeNode(dl);
dp.nodeValue=dj;
ds.setAttributeNode(dp);
ds.appendChild(dq);
dn.insertNode(ds);
dn.selectNode(ds);
dr.collapseToEnd();
return true;
}else{return this.__Bu.execCommand(dk.identifier,false,dj);
}},"mshtml":function(dt,du){try{var dw;
var dv=this.__BF();
var dx=this.__Bt;
var dv=dx.getSavedRange()!=null?dx.getSavedRange():dx.getRange();

if(dv!=null&&dv.text!=""){dw=dv.execCommand(du.identifier,false,dt);
}else{dw=this.__BG(' <a href="'+dt+'">'+dt+'</a> ',du);
}this.__Bt.resetSavedRange();
return dw;
}catch(e){if(qx.core.Environment.get("qx.debug")){this.error("inserthyperlink failed!");
}return false;
}},"default":function(dy,dz){return this.__Bu.execCommand(dz.identifier,false,dy);
}}),__BQ:function(dA,dB){var dC="<hr />";
if((qx.core.Environment.get("engine.name")=="gecko")){dC+=this.__BR();
}return this.__BG(dC,dB);
},__BR:function(dD){var dH="";
var dG='<span style="';
var dF=[];
var dK=typeof dD!=="undefined"?dD:this.__BT();
var dI=dK.child;
var dJ=false;
if(qx.lang.Object.isEmpty(dI)){return "";
}
while(dI){dJ=dI["legacy-font-size"]!=null;
dH+=dJ?'<font style="':dG;

for(var dE in dI){dH+=(dE!="child"&&dE!="legacy-font-size")?dE+':'+dI[dE]+';':"";
}dH+=dJ?'" size="'+dI["legacy-font-size"]+'">':'">';
dF.unshift(dJ?"</font>":"</span>");
dI=dI.child;
}if(dF.length==1&&dF[0]=="</font>"){dH+="<span></span>";
}for(var i=0,j=dF.length;i<j;i++){dH+=dF[i];
}return dH;
},__BS:function(){var dM=this.__Bu.createDocumentFragment();
var dR=this.__BT();
var parent=dM;
var dP=dR.child;
var dN;
...
dN=this.__Bu.createElement(dQ?"font":"span");
parent.appendChild(dN);
for(var dL in dP){if(dL!="child"&&dL!="legacy-font-size"){qx.bom.element.Style.set(dN,dL,dP[dL]);
}}
if(dQ){var dO=this.__Bu.createAttribute("size");
dO.nodeValue=dP["legacy-font-size"];
dN.setAttributeNode(dO);
}parent=dN;
dP=dP.child;
}return dM;
},__BT:function(dS){var dU={};
var dV=null;
var dW=this.getCurrentStyles(dS);
dV=dU.child={};

for(var dT in dW){if(dT!="text-decoration"){dV[dT]=dW[dT];
}}if(dW["text-decoration"]){var dX=dW["text-decoration"];
for(var i=0,j=dX.length;i<j;i++){if(dV==null){dV=dU.child={};
}else{dV=dV.child={};
}dV['color']=dX[i]['color'];
dV['text-decoration']=dX[i]['text-decoration'];
}}if(dW['color']&&dW['text-decoration']){dV=dV.child={};
dV['color']=dW['color'];
}return dU;
},getCurrentStyles:function(dY){if(dY==null){var eb=this.__Bt.getSelection();

if(!eb||eb.focusNode==null){return {};
}dY=(eb.focusNode.nodeType==3)?eb.focusNode.parentNode:eb.focusNode;
}var ec=qx.dom.Hierarchy.getAncestors(dY);
var ee=qx.lang.Array.insertBefore(ec,dY,ec[0]);
var ea=this.__BU(ee);
var ed=this.__BV(ea,ee);
return ed;
},__BU:function(ef){var ei={};
var eg,eh;

for(var i=0,j=ef.length;i<j;i++){eh=ef[i];

for(var k=0,l=eh.style.length;k<l;k++){eg=eh.style[k];

if(eg.length>0&&typeof ei[eg]==="undefined"){ei[eg]=eh.style.getPropertyValue(eg);
}}if(eh.tagName.toUpperCase()=="FONT"&&eh.size&&ei["legacy-font-size"]===undefined){ei["legacy-font-size"]=eh.size;
}}if(ei["legacy-font-size"]&&ei["font-size"]){delete ei["font-size"];
}return ei;
},__BV:function(ej,ek){var ep=ek[0];
var en=this.__Bt.getContentWindow().getComputedStyle(ep,null);
var el;
var eo={};

for(var em in ej){if(em!="legacy-font-size"){el=en.getPropertyValue(em);
}else{el=ej[em];
}if(em=="background-color"&&el=="transparent"){eo[em]=this.__BX(ek);
}else if(em=="text-decoration"){eo[em]=this.__BW(ek);
}else{eo[em]=el;
}}return eo;
},__BW:function(eq){var et,ev,er;
var eu=[];
var es=this.__Bt.getContentWindow();

for(var i=0,j=eq.length;i<j;i++){er=es.getComputedStyle(eq[i],null);
et=er.getPropertyValue("text-decoration");
ev=er.getPropertyValue("color");
if(et!="none"){eu.push({'text-decoration':et,'color':ev});
}}return eu;
},__BX:function(ew){var ez,ey,eA;

for(var i=0;i<ew.length;i++){ez=ew[i];
ey=this.__Bt.getContentWindow().getComputedStyle(ez,null);
eA=ey.getPropertyValue("background-color");
if(eA!="transparent"){return eA;
}}},__BY:function(eB,eC){var eO=this.__Bt.getSelection();
var eJ=((qx.core.Environment.get("engine.name")=="mshtml"))?this.__Bt.getRange():eJ=eO.getRangeAt(0);
var eK=[];
var eN;
var eI=["OL","UL"];
var eD,i,j,eL;
eL=((qx.core.Environment.get("engine.name")=="mshtml"))?eJ.parentElement():eJ.commonAncestorContainer;
if(eL.tagName=="BODY"){for(var i=0;i<eI.length;i++){eD=eL.getElementsByTagName(eI[i]);

for(var j=0;j<eD.length;j++){if(eD[j]){eK.push(eD[j]);
}}}}else if(qx.lang.Array.contains(eI,eL.tagName)){eK.push(eL);
}
if(eK.length>0){for(var i=0;i<eK.length;i++){var eF=eK[i];
eN=((qx.core.Environment.get("engine.name")=="mshtml"))?
((eF==eL)||(eL.tagName=="BODY")):
eO.containsNode(eF,false);
for(j=0;j<eF.childNodes.length;j++){var eH=eF.childNodes[j];
if(eN||
(eO.focusNode.nodeValue&&qx.dom.Hierarchy.contains(eH,eO.focusNode)&&(eO.focusOffset==eO.focusNode.nodeValue.length))||
(qx.dom.Hierarchy.contains(eH,eO.anchorNode)&&(eO.anchorOffset==0))||
(eO.containsNode(eH,false))){eH.style.fontSize=(this.__Bw[eB]||eB)+"px";
}}}}else{var eG=((qx.core.Environment.get("engine.name")=="mshtml"))?eL:eO.focusNode;
var eM=qx.dom.Hierarchy.getAncestors(eG);

for(i=0;i<eM.length;i++){if(eM[i].tagName=="LI"){if((((qx.core.Environment.get("engine.name")=="gecko"))&&
((eO.anchorOffset==0)&&
(eO.focusNode.nodeValue&&(eO.focusOffset==eO.focusNode.nodeValue.length))&&
qx.dom.Hierarchy.contains(eM[i].firstChild,eO.anchorNode)&&
qx.dom.Hierarchy.contains(eM[i].lastChild,eO.focusNode)))||
(((qx.core.Environment.get("engine.name")=="mshtml"))&&(eJ.htmlText==eM[i].innerHTML))){eM[i].style.fontSize=(this.__Bw[eB]||eB)+"px";
}break;
}}}if((qx.core.Environment.get("engine.name")=="mshtml")){this.__Bu.body.focus();
this.__Bt.getRange().select();
return this.__Bu.execCommand("FontSize",false,eB);
}else if((qx.core.Environment.get("engine.name")=="gecko")){var parent=eJ.commonAncestorContainer;
if(parent.nodeType===1){var eE=parent.getElementsByTagName("span");

for(i=0;i<eE.length;i++){if(eE[i].style.fontSize){eE[i].style.fontSize=null;
}}}}return this.__Bu.execCommand("FontSize",false,eB);
},__Ca:qx.core.Environment.select(o,{"mshtml":function(eP,eQ){this.__Bu.body.focus();
return this.__Bu.execCommand(h,false,eP);
},"gecko|opera":function(eR,eS){this.__Bu.body.focus();
return this.__Bu.execCommand(H,false,eR);
},"webkit":function(eT,eU){var eV=this.__Bt.getSelection();
var eW=this.__Bt.getRange();
if(!eV||!eV.isCollapsed){this.__Bu.body.focus();
this.__Bu.execCommand(h,false,eT);
if(eV){eV.collapseToEnd();
}return true;
}else{var eY=eV.anchorOffset;
var fa=eV.anchorOffset;
var eW=eV.getRangeAt(0);
var eX=eV.anchorNode;
while(fa>0){if(eX.nodeValue.charCodeAt(fa)==160||eX.nodeValue.charCodeAt(fa)==32){break;
}else{fa--;
}}while(eY<eX.nodeValue.length){if(eX.nodeValue.charCodeAt(eY)==160||eX.nodeValue.charCodeAt(eY)==32){break;
}else{eY++;
}}eW.setStart(eV.anchorNode,eV.anchorNode.nodeValue.charAt(fa)==bf?fa+1:fa);
eW.setEnd(eV.anchorNode,eY);
eV.addRange(eW);
this.__Bu.body.focus();
this.__Bu.execCommand(h,false,eT);
eV.collapseToEnd();
return true;
}}}),__Cb:function(fb,fc){fb=fb!=null&&typeof fb==f?fb:z;
qx.bom.element.Style.set(this.__Bu.body,bb,fb);
return true;
},__Cc:function(fd,fe){var ff,fh,fg;
var fi=qx.bom.htmlarea.manager.Command;

if(fd==null){ff=null;
}else{ff=fd[0];
fh=fd[1];
fg=fd[2];
}if(ff==null||typeof ff!=f){qx.bom.element.Style.set(this.__Bu.body,c,n);
qx.bom.element.Style.set(this.__Bu.body,b,n);
qx.bom.element.Style.set(this.__Bu.body,be,n);
return true;
}else{if(ff.search(/^url.*\(/)==-1){ff=G+ff+Y;
}}if(fh!=null&&!qx.lang.String.contains(fi.__Bz,fh)){if(qx.core.Environment.get(m)){this.error("The value '"+fh+"' is not allowed for parameter 'repeat'. Possible values are '"+fi.__Bz+"'");
}return false;
}else{fh=q;
}
if(fg!=null){if(qx.lang.Type.isString(fg)&&!qx.lang.String.contains(fi.__By,a+fg+a)){if(qx.core.Environment.get(m)){this.error("The value '"+fg+"' is not allowed for parameter 'position'. Possible values are '"+fi.__By+"'");
}return false;
}else{if(qx.lang.Type.isArray(fg)&&fg.length==2){fg=fg[0]+bf+fg[1];
...
}qx.bom.element.Style.set(this.__Bu.body,c,ff);
qx.bom.element.Style.set(this.__Bu.body,b,fh);
qx.bom.element.Style.set(this.__Bu.body,be,fg);
return true;
},__Cd:qx.core.Environment.select(o,{"mshtml":function(fj,fk){var fl=this.__Bu.body.createTextRange();
fl.select();
return true;
},"default":function(fm,fn){return this.__BE(fn.identifier,false,fm);
}}),__Ce:function(){return this.__Bt.getSelectedText();
},__Cf:function(){return this.__Bt.getSelectedHtml();
},__Cg:function(fo,fp){var ft=this.__Bt.getFocusNode();

if(ft.textContent==n){var fr=qx.dom.Hierarchy.getAncestors(ft);
fr.unshift(ft);
var Node=qx.dom.Node;
var fq=qx.bom.element.Style;
var fs=fr.shift();

while(fr.length>0){if(Node.getName(fs)==Q||Node.getName(fs)==M){break;
}if(fq.get(fs,fo,fq.LOCAL_MODE)==fp){fq.reset(fs,fo);
return true;
}fs=fr.shift();
}}return false;
},__Ch:qx.core.Environment.select(o,{"gecko":function(fu,fv){if(this.__Cg(L,x)){return true;
}else{return this.__BE(fv.identifier,false,fu);
}},"default":function(fw,fx){return this.__BE(fx.identifier,false,fw);
}}),__Ci:qx.core.Environment.select(o,{"gecko":function(fy,fz){if(this.__Cg(bc,A)){return true;
}else{return this.__BE(fz.identifier,false,fy);
}},"default":function(fA,fB){return this.__BE(fB.identifier,false,fA);
}}),__Cj:qx.core.Environment.select(o,{"gecko":function(fC,fD){if(this.__Cg(d,u)){return true;
}else{return this.__BE(fD.identifier,false,fC);
}},"default":function(fE,fF){return this.__BE(fF.identifier,false,fE);
}}),__Ck:qx.core.Environment.select(o,{"gecko":function(fG,fH){if(this.__Cg(d,R)){return true;
}else{return this.__BE(fH.identifier,false,fG);
}},"default":function(fI,fJ){return this.__BE(fJ.identifier,false,fI);
}})},destruct:function(){this.__Bu=this.__Bt=this._commands=null;
this.__Bv=this.__Bw=null;
}});
})();
(function(){var m="engine.name",l="Command",k="mshtml",h="gecko",g="Custom",f="Content",d="Internal",c="inserthtml",b="backgroundimage",a="qx.debug",bi="backgroundcolor",bh="webkit",bg="backgroundColor",bf="mousedown",be="table",bd="backgroundImage",bc="backgroundRepeat",bb="p",ba="backgroundPosition",Y="td",t="img",u="inserthyperlink",r="mouseup",s="keypress",p="qx.bom.htmlarea.HtmlArea.debug",q="undo",n="__zE",o="pageup",x="b",y="control",G="shift",E="end",O="right",J="qx_link",U="insertunorderedlist",S="Undo",A="pagedown",X="k",W="home",V="a",z="insertorderedlist",C="y",D="justifyright",F="redo",H="insertParagraph",K="qx.bom.htmlarea.manager.UndoRedo",P="left",T="i",v="u",w="enter",B="Redo",N="insertimage",M="z",L="undoRedoState",R="down",Q="up",I="body";
...
if((qx.core.Environment.get(m)==k)){qx.event.Registration.addListener(bl.body,bf,this.__zN,this,true);
...
}}else{if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){this.__Ak(bm,bn,this.__zE.getCommandObject(bm));
...
switch(bD.command){case bi:bH.parameter=[bG.get(this.__zI.body,bg)];
break;
...
}}},"mshtml|webkit":function(bR){},"default":function(bS){this.__Ao(bS);
return this.__zY();
...
this.__zE.getCommandObject(bi).customUndo=true;
...
switch(cy){case bi:cD.push(qx.bom.element.Style.get(this.__zI.body,bg));
break;
...
if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){cG.content=this.__zR;
cG.actionType=g;
this.__zR=null;
}this.__An(cG);
this.__zQ=false;
...
},__An:function(cH){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO UNDO STACK");
this.debug(cH.actionType+" "+cH.command+" "+cH.value);
}this.__zG.push(cH);
},__Ao:function(cI){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO REDO STACK");
...
this.__zP=true;
if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){this.__zR=this.__zI.body.innerHTML;
}this.__As();
...
if((qx.core.Environment.get(m)==k)){qx.event.Registration.removeListener(this.__zI,bf,this.__zN);
