...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.TimerManager-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"4366ad3609b3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="__UP",e="One-shot 1-second timer: ",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__UP:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();
i.start(function(j,k){this.__UQ(c+k);
},5000,this,null,0);
i.start(function(l,m){this.__UQ(e+m);
},0,this,null,1000);
i.start(function(n,o){this.__UQ(g+o);

if(++n.count==3){this.__UQ(h);
i.stop(o);
}},2000,this,{count:0},2000);
},__UQ:function(p){p=Date.parse(new Date)+" "+p+"\n";
this.__UP.setValue(this.__UP.getValue()+p);
},main:function(){qx.application.Standalone.prototype.main.call(this);
var r=new qx.ui.layout.VBox(5);
var q=new qx.ui.container.Composite(r);
var s=new qx.ui.form.Button(b);
s.set({allowGrowX:false,allowGrowY:false});
s.addListener(a,function(){s.setEnabled(false);
this.startTimers();
},this);
var t=new qx.ui.form.TextArea();
t.set({width:400,height:300});
this.__UP=t;
q.add(t);
q.add(s);
this.getRoot().add(q,{left:20,top:10});
