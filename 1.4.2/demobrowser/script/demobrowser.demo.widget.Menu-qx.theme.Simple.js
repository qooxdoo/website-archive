...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Menu-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"b5cc51ccac13"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
