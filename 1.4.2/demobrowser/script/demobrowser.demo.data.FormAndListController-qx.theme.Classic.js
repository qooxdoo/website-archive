...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.FormAndListController","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.FormAndListController-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ba2cdd01f12a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
