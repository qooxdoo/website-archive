...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Touch","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Touch-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"cac23f8df828"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
