...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Style","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Style-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"e6fb254e37f5"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
