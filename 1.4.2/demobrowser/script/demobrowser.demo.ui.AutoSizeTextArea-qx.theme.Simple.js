...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.AutoSizeTextArea","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.AutoSizeTextArea-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"ad25ee0fa8ba"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var n="Maximal height",m="wrap",l="Wrap handling",k="Minimal height",j="",h="value",g="Non-default minimal line height",f="demobrowser.demo.ui.AutoSizeTextArea",e="The quick brown fox…",d="The quick brown fox jumps over the lazy dog. ",a="Regular",c="Auto-Size",b="Wrap";
...
var p=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));
this.getRoot().add(p,{top:20,left:20});
var s=new qx.ui.basic.Label();
s.setValue(a);
var q=new qx.ui.form.TextArea();
q.set({allowStretchY:false,value:this.__Vj()});
p.add(s,{row:0,column:0});
p.add(q,{row:1,column:0});
s=new qx.ui.basic.Label();
s.setValue(c);
var w=new qx.ui.form.TextArea();
w.set({allowStretchY:false,value:this.__Vj(),autoSize:true});
p.add(s,{row:0,column:1});
p.add(w,{row:1,column:1});
s=new qx.ui.basic.Label();
s.setValue(g);
var x=new qx.ui.form.TextArea();
x.set({allowStretchY:false,value:e,autoSize:true,minimalLineHeight:1,maxHeight:300});
p.add(s,{row:0,column:2});
p.add(x,{row:1,column:2});
s=new qx.ui.basic.Label();
s.setValue(k);
var t=new qx.ui.form.TextArea();
t.set({allowStretchY:false,value:this.__Vj(),autoSize:true,minHeight:200});
p.add(s,{row:2,column:0});
p.add(t,{row:3,column:0});
s=new qx.ui.basic.Label();
s.setValue(n);
var r=new qx.ui.form.TextArea();
r.set({allowStretchY:false,value:this.__Vj(),autoSize:true,minHeight:200,maxHeight:300});
p.add(s,{row:2,column:1});
p.add(r,{row:3,column:1});
s=new qx.ui.basic.Label();
s.setValue(l);
var u=new qx.ui.form.TextArea();
u.set({allowStretchY:false,value:this.__Vj(),autoSize:true,minimalLineHeight:2});
var o=new qx.ui.form.CheckBox(b);
o.setValue(false);
o.setAllowStretchX(false);
o.bind(h,u,m);
p.add(s,{row:2,column:2});
var v=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,10));
p.add(v,{row:3,column:2});
v.add(u,{row:0,column:0});
v.add(o,{row:1,column:0});
},__Vj:function(){var y=new qx.type.Array(2);

for(var i=0;i<y.length;i++){y[i]=d;
}return y.join(j);
}}});
})();
...
(function(){var c="qx.type.Array",b="qx.debug",a="The parameter must be an array.";
qx.Class.define(c,{extend:qx.type.BaseArray,construct:function(d){qx.type.BaseArray.apply(this,arguments);
},members:{clone:qx.type.BaseArray.prototype.concat,insertAt:function(e,i){this.splice(i,0,e);
return this;
...
},insertAfter:function(h,j){var i=this.indexOf(j);
...
return this;
},append:function(k){if(qx.core.Environment.get(b)){qx.core.Assert.assertArray(k,a);
}var l=k;
if(k instanceof qx.type.Array){l=[];

for(var i=0;i<k.length;i++){l[i]=k[i];
}}Array.prototype.push.apply(this,l);
return this;
},remove:function(m){var i=this.indexOf(m);
