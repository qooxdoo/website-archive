...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.DateField","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.DateField-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e126c248c353"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var p="execute",o="dd.MM.yyyy",n="MM/dd/yyyy",m="MM-yyyy",l="With date formater",k="demobrowser.demo.widget.DateField",j="",i="Set current date",h="Default",g="Set data",c="en",f="changeValue",d="Get data",b="Reset",a="Get date";
...
this.getRoot().add(new qx.ui.basic.Label(h),{top:20,left:20});
var r=new qx.ui.form.DateField();
this.getRoot().add(r,{top:35,left:20});
r.setValue(new Date());
r.addListener(f,function(e){this.debug("Change Value: "+e.getData());
});
this.getRoot().add(new qx.ui.basic.Label(l),{top:20,left:150});
var t=new qx.ui.form.DateField();
this.getRoot().add(t,{top:35,left:150});
t.setValue(new Date());
var A=new qx.util.format.DateFormat(m);
var B=new qx.util.format.DateFormat(n);
var C=new qx.util.format.DateFormat(o);
t.setDateFormat(B);
var z=new qx.ui.form.Button(m);
z.setWidth(120);
this.getRoot().add(z,{top:60,left:150});
z.addListener(p,function(e){t.setDateFormat(A);
});
var u=new qx.ui.form.Button(n);
u.setWidth(120);
this.getRoot().add(u,{top:88,left:150});
u.addListener(p,function(e){t.setDateFormat(B);
});
var v=new qx.ui.form.Button(o);
v.setWidth(120);
this.getRoot().add(v,{top:116,left:150});
v.addListener(p,function(e){t.setDateFormat(C);
});
this.getRoot().add(new qx.ui.basic.Label(g),{top:20,left:280});
var s=new qx.ui.form.DateField();
this.getRoot().add(s,{top:35,left:280});
var D=new qx.ui.form.Button(i);
D.setWidth(120);
this.getRoot().add(D,{top:60,left:280});
D.addListener(p,function(e){s.setValue(new Date());
});
var w=new qx.ui.form.Button(b);
w.setWidth(120);
this.getRoot().add(w,{top:88,left:280});
w.addListener(p,function(e){s.resetValue();
});
this.getRoot().add(new qx.ui.basic.Label(d),{top:20,left:410});
var y=new qx.ui.form.DateField();
this.getRoot().add(y,{top:35,left:410});
var x=new qx.ui.basic.Label();
this.getRoot().add(x,{left:410,top:88});
var q=new qx.ui.form.Button(a);
q.setWidth(120);
this.getRoot().add(q,{left:410,top:60});
q.addListener(p,function(e){x.setValue(y.getValue()+j);
});
}}});
})();
