...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Opacity","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Opacity-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"75050ce491e6"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="overflowY",j="engine.name",i="hidden",h="auto",g="textarea",f="width",d="webkit",c="Boolean",b="Integer",a="qx.debug",z="input",y="",x="appear",w="mshtml",v="px",u="_applyWrap",t="-1",s="_applyMinimalLineHeight",r="_applyAutoSize",q="tabIndex",o='name',p="qx.ui.form.TextArea",m='id',n="mousewheel",l="absolute";
qx.Class.define(p,{extend:qx.ui.form.AbstractField,construct:function(A){qx.ui.form.AbstractField.call(this,A);
this.initWrap();
this.addListener(n,this._onMousewheel,this);
},properties:{wrap:{check:c,init:true,apply:u},appearance:{refine:true,init:g},singleStep:{check:b,init:20},minimalLineHeight:{check:b,apply:s,init:4},autoSize:{check:c,apply:r,init:false}},members:{__yD:null,__yE:null,__yF:null,setValue:function(B){B=qx.ui.form.AbstractField.prototype.setValue.call(this,B);
this.__yG();
return B;
},_onMousewheel:function(e){var C=this.getContentElement();
var scrollY=C.getScrollY();
C.scrollToY(scrollY+e.getWheelDelta()*this.getSingleStep());
var D=C.getScrollY();

if(D!=scrollY){e.stop();
}},__yG:function(){if(this.isAutoSize()){var G=this.__yH();

if(G){this.__yF=this.__yF||this._getAreaHeight();
...
}}var H=Math.max(I,this.__yF);
this._setAreaHeight(H);
}else{this.addListenerOnce(x,function(){if(qx.core.Environment.get(j)==d){var K=this.getContentElement();
var J=this.getValue();
K.setStyle(k,i,true);
this.setValue(y);
this.setValue(J);
...
},_setAreaHeight:function(L){if(this._getAreaHeight()!==L){this.__yE=L;
qx.ui.core.queue.Layout.add(this);
qx.ui.core.queue.Manager.flush();
this.__yK();
}},_getScrolledAreaHeight:function(){var N=this.__yH();
...
}if(qx.core.Environment.get(j)==w){M.style.overflow=y;
}N.setValue(this.getValue());
this.__yJ(N);

if(qx.core.Environment.get(j)==w){if(!M.scrollTop){qx.html.Element.flush();
}return M.scrollTop+this._getTextSize().height;
}return M.scrollTop;
}},__yH:function(){this.__yD=this.__yD||this.__yI();
return this.__yD;
},__yI:function(){var R,P,O,Q;
...
this.__yJ(P);
return P;
},__yJ:function(S){S=S.getDomElement();
...
},_applyAutoSize:function(V,W){if(qx.core.Environment.get(a)){this.__yL();
}
if(V){this.__yG();
this.addListener(z,this.__yG,this);
this.addListenerOnce(x,function(){this.getContentElement().setStyle(k,i);
});
}else{this.removeListener(z,this.__yG);
...
if(qx.core.Environment.get(a)){this.__yL();
}
if(X===this.getMaxHeight()){this.__yG();
}},__yK:function(){var content=this.getContentElement();
var ba=content.getDomElement();
var Y=content.getStyle(f);
content.setStyle(f,parseInt(Y,10)+1000+v,true);
...
if(this.isAutoSize()){bb.height=this.__yE||bb.height;
}return bb;
}}});
})();
...
qx.Class.define(b,{statics:{__ym:/\s+/g,__yn:/^\s+|\s+$/g,add:qx.lang.Object.select(qx.core.Environment.get(t)?r:s,{"native":function(u,name){u.classList.add(name);
return name;
...
return N.className=N.className.replace(P,q).replace(this.__yn,q).replace(this.__ym,p);
...
if(w&&w.nodeType){return this.__yv([w]);
}else{return w;
}}return null;
};
};
...
},__yr:/^[^<]*(<(.|\s)+>)[^>]*$|^#([\w-]+)$/,create:function(G,H){var J=qx.bom.Collection;
if(G.nodeType){return new J(G);
}else if(typeof G==="string"){var I=J.__yr.exec(G);
...
},__yt:/^.[^:#\[\.,]*$/,not:function(ba){if(this.__yt.test(ba)){var bb=qx.bom.Selector.matches(":not("+ba+")",this);
return this.__yv(bb);
...
return this.__yv(qx.lang.Array.unique(bl));
...
if(this.length===1){return this.__yv(bs.query(bq,this[0]));
}else{var br=[];

for(var i=0,l=this.length;i<l;i++){br.push.apply(br,bs.query(bq,this[i]));
}return this.__yv(qx.lang.Array.unique(br));
...
},nextAll:function(bw){return this.__yu("getNextSiblings",bw);
...
},prevAll:function(bA){return this.__yu("getPreviousSiblings",bA);
...
},parents:function(bD){return this.__yu("getAncestors",bD);
},siblings:function(bE){return this.__yu("getSiblings",bE);
},__yu:function(bF,bG){var bI=[];
...
},__yv:function(bK){var bL=new qx.bom.Collection;
bL.__ys=this;
...
},__yw:function(bM,bN){var bS=this[0];
...
},append:function(ce){return this.__yw(arguments,this.__yy);
},prepend:function(cf){return this.__yw(arguments,this.__yz);
},__yy:function(cg,ch){cg.appendChild(ch);
},__yz:function(ci,cj){ci.insertBefore(cj,ci.firstChild);
},appendTo:function(ck){return this.__yx(arguments,"append");
},prependTo:function(cl){return this.__yx(arguments,"prepend");
},before:function(cm){return this.__yw(arguments,this.__yA);
},after:function(cn){return this.__yw(arguments,this.__yB);
},__yA:function(co,cp){co.parentNode.insertBefore(cp,co);
},__yB:function(cq,cr){cq.parentNode.insertBefore(cr,cq.nextSibling);
},insertBefore:function(cs){return this.__yx(arguments,"before");
},insertAfter:function(ct){return this.__yx(arguments,"after");
...
}cu.map(this.__yC).append(this);
}return this;
},__yC:function(cw){while(cw.firstChild){cw=cw.firstChild;
}return cw;
...
},replaceAll:function(cz){return this.__yx(arguments,"replaceWith");
...
(function(){var u="checked",t="keypress",s="Boolean",r="Right",q="label",p="qx.debug",o="Left",n="_applyValue",m="changeValue",l="Up",d="value",k="qx.ui.form.RadioButton",h="radiobutton",c="toolTipText",b="enabled",g="qx.ui.form.RadioGroup",f="Down",i="_applyGroup",a="menu",j="execute";
qx.Class.define(k,{extend:qx.ui.form.Button,include:[qx.ui.form.MForm,qx.ui.form.MModelProperty],implement:[qx.ui.form.IRadioItem,qx.ui.form.IForm,qx.ui.form.IBooleanForm,qx.ui.form.IModel],construct:function(v){if(qx.core.Environment.get(p)){this.assertArgumentsCount(arguments,0,1);
}qx.ui.form.Button.call(this,v);
this.addListener(j,this._onExecute);
this.addListener(t,this._onKeyPress);
},properties:{group:{check:g,nullable:true,apply:i},value:{check:s,nullable:true,event:m,apply:n,init:false},appearance:{refine:true,init:h},allowGrowX:{refine:true,init:false}},members:{_forwardStates:{checked:true,focused:true,invalid:true,hovered:true},_bindableProperties:[b,q,c,d,a],_applyValue:function(w,x){w?this.addState(u):this.removeState(u);

if(w&&this.getFocusable()){this.focus();
}},_applyGroup:function(y,z){if(z){z.remove(this);
}
if(y){y.add(this);
}},_onExecute:function(e){var A=this.getGroup();

if(A&&A.getAllowEmptySelection()){this.toggleValue();
}else{this.setValue(true);
}},_onKeyPress:function(e){var B=this.getGroup();

if(!B){return;
}
switch(e.getKeyIdentifier()){case o:case l:B.selectPrevious();
break;
case r:case f:B.selectNext();
break;
}}}});
})();
...
(function(){var i="Integer",h="hovered",g="hover-button",f="interval",d="mouseover",c="mouseout",b="__pc",a="qx.ui.form.HoverButton";
...
this.__pc.addListener(f,this._onInterval,this);
},properties:{appearance:{refine:true,init:g},interval:{check:i,init:80},firstInterval:{check:i,init:200},minTimer:{check:i,init:20},timerDecrease:{check:i,init:2}},members:{__pc:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;
...
},addSpacer:function(){if(!this.__kN){this.__kN=new qx.ui.core.Spacer();
}else{this._remove(this.__kN);
}this._add(this.__kN);
},addOpenButton:function(){this._add(this.getChildControl(k));
},_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());
}},addIcon:function(){var K=this.getChildControl(j);

if(this.__kM){this._remove(K);
}this._add(K);
this.__kM=true;
},addLabel:function(L){var M=this.getChildControl(f);

if(this.__kL){this._remove(M);
}
if(L){this.setLabel(L);
}else{M.setValue(this.getLabel());
}this._add(M);
this.__kL=true;
},_applyIcon:function(N,O){if(!this.__kP()){this.__kQ(N);
}else if(!this.isOpen()){this.__kQ(N);
}},_applyIconOpened:function(P,Q){if(this.isOpen()){if(this.__kO()&&this.__kP()){this.__kQ(P);
}else if(!this.__kO()&&this.__kP()){this.__kQ(P);
...
if(U){W=this.__kP()?this.getIconOpened():null;
}else{W=this.getIcon();
}
if(W){this.__kQ(W);
}U?this.addState(c):this.removeState(c);
},__kO:function(){return qx.util.PropertyUtil.getUserValue(this,j);
},__kP:function(){return qx.util.PropertyUtil.getUserValue(this,s);
},__kQ:function(X){var Y=this.getChildControl(j,true);
...
if(this.__kN){this.__kN.setWidth((this.getLevel()+1)*this.getIndent()-be);
...
(function(){var m="qx.debug",k="visible",j="excluded",h="qx.ui.tree.core.AbstractTreeItem",g="__kR",f="open",e="abstract",d="__kS",c="addItem",b="removeItem",a="Invalid child index: ";
qx.Class.define(h,{extend:qx.ui.tree.core.AbstractItem,type:e,construct:function(n){qx.ui.tree.core.AbstractItem.call(this,n);
this.__kR=[];
},properties:{parent:{check:h,nullable:true}},members:{__kR:null,__kS:null,getTree:function(){var p=this;
...
}}},getChildrenContainer:function(){if(!this.__kS){this.__kS=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?k:j});
}return this.__kS;
},hasChildrenContainer:function(){return this.__kS;
},getParentChildrenContainer:function(){if(this.getParent()){return this.getParent().getChildrenContainer();
}else if(this.getLayoutParent()){return this.getLayoutParent();
}else{return null;
}},getChildren:function(){return this.__kR;
},hasChildren:function(){return this.__kR?this.__kR.length>0:false;
...
}},__kT:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);
...
O.fireNonBubblingEvent(c,qx.event.type.Data,[P]);
}}
if(O){qx.ui.core.queue.Widget.add(this);
}},addAt:function(Q,R){if(qx.core.Environment.get(m)){this.assert(R<=this.__kR.length&&R>=0,a+R);
}
if(R==this.__kR.length){this.add(Q);
return;
}var V=Q.getParent();
...
}qx.lang.Array.insertAt(this.__kR,Q,R);

if(!U){this.__kT();
}
if(this.getTree()){Q.recursiveAddToWidgetQueue();
qx.ui.core.queue.Widget.add(this);
}},addBefore:function(W,X){if(qx.core.Environment.get(m)){this.assert(this.__kR.indexOf(X)>=0);
}var Y=W.getParent();

if(Y){Y.remove(W);
}this.addAt(W,this.__kR.indexOf(X));
},addAfter:function(ba,bb){if(qx.core.Environment.get(m)){this.assert(this.__kR.indexOf(bb)>=0);
}var bc=ba.getParent();

if(bc){bc.remove(ba);
}this.addAt(ba,this.__kR.indexOf(bb)+1);
},addAtBegin:function(bd){this.addAt(bd,0);
},remove:function(be){for(var i=0,l=arguments.length;i<l;i++){var bi=arguments[i];

if(this.__kR.indexOf(bi)==-1){this.warn("Cannot remove treeitem '"+bi+"'. It is not a child of this tree item.");
return;
...
}}qx.lang.Array.remove(this.__kR,bi);
bi.setParent(null);
bf.remove(bi);
}var bg=this.getTree();

if(bg){bg.fireNonBubblingEvent(b,qx.event.type.Data,[bi]);
}qx.ui.core.queue.Widget.add(this);
},removeAt:function(bj){var bk=this.__kR[bj];

if(bk){this.remove(bk);
}},removeAll:function(){var bl=this.__kR.concat();

for(var i=this.__kR.length-1;i>=0;i--){this.remove(this.__kR[i]);
}return bl;
...
(function(){var v="keypress",u="qx.debug",t="interval",s="keydown",r="mousedown",q="keyup",p="__nT",o="blur",n="Enter",m="__nV",d="__nU",l="Up",h="Escape",c="event.touch",b="qx.ui.menu.Manager",g="Left",f="Down",j="Right",a="singleton",k="Space";
qx.Class.define(b,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__nT=[];
var w=document.body;
...
this.__nU.addListener(t,this._onOpenInterval,this);
this.__nV=new qx.event.Timer;
this.__nV.addListener(t,this._onCloseInterval,this);
},members:{__nW:null,__nX:null,__nU:null,__nV:null,__nT:null,_getChild:function(y,z,A,B){var C=y.getChildren();
var length=C.length;
var D;
...
if(M.isVisible()){if(this.__nW){this.cancelOpen(this.__nW);
}}else if(this.__nW!=M){this.__nW=M;
this.__nU.restartWith(M.getOpenInterval());
}},scheduleClose:function(N){this.cancelOpen(N);
if(!N.isVisible()){if(this.__nX){this.cancelClose(this.__nX);
}}else if(this.__nX!=N){this.__nX=N;
this.__nV.restartWith(N.getCloseInterval());
}},cancelOpen:function(O){if(this.__nW==O){this.__nU.stop();
this.__nW=null;
}},cancelClose:function(P){if(this.__nX==P){this.__nV.stop();
this.__nX=null;
}},_onOpenInterval:function(e){this.__nU.stop();
this.__nW.open();
this.__nW=null;
},_onCloseInterval:function(e){this.__nV.stop();
this.__nX.exclude();
this.__nX=null;
...
}},__nY:{"Enter":1,"Space":1},__oa:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var R=this.getActiveMenu();

if(!R){return;
}var S=e.getKeyIdentifier();

if(this.__oa[S]||(this.__nY[S]&&R.getSelectedButton())){e.stopPropagation();
...
},__oe:function(){if(this.isVisible()){if(this.getBlockBackground()){var R=this.getZIndex();
...
},__of:function(){var bj=this._getMenuBounds();

if(!bj){this.addListenerOnce(j,this.__of,this);
return;
...
if(this.__od){this.__od.call(this);
delete this.__od;
...
if(this.__oc){bo.cancelOpen(this.__oc);
this.__oc=null;
...
}if(this.__oc){br.cancelOpen(this.__oc);
...
(function(){var s="horizontal",r="scrollpane",q="button-backward",p="button-forward",o="vertical",n="content",m="execute",l="qx.ui.container.SlideBar",k="scrollY",j="engine.name",c="removeChildWidget",i="scrollX",g="_applyOrientation",b="mousewheel",a="gecko",f="Integer",d="slidebar",h="update";
...
},properties:{appearance:{refine:true,init:d},orientation:{check:[s,o],init:s,apply:g},scrollStep:{check:f,init:15,themeable:true}},members:{getChildrenContainer:function(){return this.getChildControl(n);
},_createChildControlImpl:function(v,w){var x;

switch(v){case p:x=new qx.ui.form.RepeatButton;
...
}},_applyEnabled:function(C,D,name){qx.ui.core.Widget.prototype._applyEnabled.call(this,C,D,name);
this._updateArrowsEnabled();
},_applyOrientation:function(E,F){var I=[this.getLayout(),this._getLayout()];
var H=this.getChildControl(p);
var G=this.getChildControl(q);
if(F==o){H.removeState(o);
G.removeState(o);
H.addState(s);
G.addState(s);
}else if(F==s){H.removeState(s);
G.removeState(s);
H.addState(o);
G.addState(o);
}
if(E==s){this._setLayout(new qx.ui.layout.HBox());
...
var L=content.getBounds();
var K=(this.getOrientation()===s)?L.width>J.width:L.height>J.height;

if(K){this._showArrows();
this._updateArrowsEnabled();
...
},_updateArrowsEnabled:function(){if(!this.getEnabled()){this.getChildControl(q).setEnabled(false);
this.getChildControl(p).setEnabled(false);
return;
}var N=this.getChildControl(r);

if(this.getOrientation()===s){var M=N.getScrollX();
var O=N.getScrollMaxX();
}else{var M=N.getScrollY();
var O=N.getScrollMaxY();
}this.getChildControl(q).setEnabled(M>0);
this.getChildControl(p).setEnabled(M<O);
...
}else if(this.__pd.length>0){do{var M=this.__pd[0];
...
var K=false;
if(this.__pd.length==1&&I>0){var D=L-this.getSpacing();
var H=B-I+F+D;
K=A>H;
}if(A>B+F+L||K){this.__pf(M);
B+=F;
if(C&&this.__pd.length==0){C.setVisibility(v);
}}else{return;
}}}while(A>=B&&this.__pd.length>0);
}},__pf:function(N){N.setVisibility(w);
this.__pd.shift();
this.fireDataEvent(p,N);
},__pg:function(O){if(!O){return;
}this.__pd.unshift(O);
O.setVisibility(v);
this.fireDataEvent(j,O);
},_getNextToHide:function(){for(var i=this.__pe.length-1;i>=0;i--){var P=this.__pe[i];
...
}}},setRemovePriority:function(S,T,U){if(!U&&this.__pe[T]!=undefined){throw new Error("Priority already in use!");
}this.__pe[T]=S;
...
}for(var i=0;i<this.__pd.length;i++){this.__pd[i].setVisibility(w);
}this.__pd=[];
...
}},__ph:false,_setAllowMenuOpenHover:function(bc){this.__ph=bc;
},_isAllowMenuOpenHover:function(){return this.__ph;
...
s.addListener(b,this.__pi,this);
this._add(s);
break;
...
},__pi:function(){var w=this.getChildrenContainer().getChildren();
...
for(var I=0;I<z;I++){this.__mQ[I]={width:E,headerRenderer:F,dataRenderer:C,editorFactory:B};
this.__mM[I]=I;
this.__mN[I]=I;
}this.__mP=null;
this.__mO=true;
...
this.assertNotUndefined(this.__mQ[J],h);
}var N=this.__mQ[J].width;

if(N!=K){this.__mQ[J].width=K;
...
this.assertNotUndefined(this.__mQ[O],h);
}return this.__mQ[O].width;
...
this.assertNotUndefined(this.__mQ[P],h);
}var R=this.__mQ[P].headerRenderer;

if(R!==this.__mR){R.dispose();
}this.__mQ[P].headerRenderer=Q;
this.fireDataEvent(p,{col:P});
},getHeaderCellRenderer:function(S){if(qx.core.Environment.get(k)){this.assertInteger(S,j);
this.assertNotUndefined(this.__mQ[S],h);
}return this.__mQ[S].headerRenderer;
...
this.assertNotUndefined(this.__mQ[T],h);
}this.__mQ[T].dataRenderer=U;
var V=this.__mQ[T].dataRenderer;

if(V!==this.__mS){return V;
}return null;
},getDataCellRenderer:function(W){if(qx.core.Environment.get(k)){this.assertInteger(W,j);
this.assertNotUndefined(this.__mQ[W],h);
}return this.__mQ[W].dataRenderer;
...
this.assertNotUndefined(this.__mQ[X],h);
}var ba=this.__mQ[X].headerRenderer;

if(ba!==this.__mT){ba.dispose();
}this.__mQ[X].editorFactory=Y;
},getCellEditorFactory:function(bb){if(qx.core.Environment.get(k)){this.assertInteger(bb,j);
this.assertNotUndefined(this.__mQ[bb],h);
}return this.__mQ[bb].editorFactory;
},_getColToXPosMap:function(){if(this.__mP==null){this.__mP={};

for(var be=0;be<this.__mM.length;be++){var bd=this.__mM[be];
this.__mP[bd]={overX:be};
}
for(var bc=0;bc<this.__mN.length;bc++){var bd=this.__mN[bc];
this.__mP[bd].visX=bc;
}}return this.__mP;
...
for(var x=bo+1;x<this.__mM.length;x++){var bq=this.__mM[x];
var bm=br[bq].visX;

if(bm!=null){bp=bm;
break;
}}if(bp==null){bp=this.__mN.length;
}this.__mN.splice(bp,0,bk);
}else{var bn=this.getVisibleX(bk);
this.__mN.splice(bn,1);
}this.__mP=null;
...
}this.__mM.splice(bt,1);
this.__mM.splice(bu,0,bx);
this.__mP=null;
...
if(by.length==this.__mM.length){this.__mO=true;
var bB=new Array(by.length);

for(var bz=0;bz<this.__mM.length;bz++){var bA=this.isColumnVisible(bz);
bB[bz]=bA;

if(bA){this.setColumnVisible(bz,false);
}}this.__mM=qx.lang.Array.clone(by);
this.__mP=null;
for(var bz=0;bz<this.__mM.length;bz++){if(bB[bz]){this.setColumnVisible(bz,true);
}}this.__mO=false;
this.fireDataEvent(f);
}else{throw new Error("setColumnsOrder: Invalid number of column positions given, expected "+this.__mM.length+", got "+by.length);
...
this.__qX=bj.left===undefined?0:bj.left;
this.__qW=bj.top===undefined?0:bj.top;
...
this.__qX=bk.left===undefined?0:bk.left;
this.__qW=bk.top===undefined?0:bk.top;
this.removeState(c);
this.hide();
this.fireEvent(B);
