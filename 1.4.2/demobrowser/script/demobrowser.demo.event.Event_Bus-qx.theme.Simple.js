...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Bus","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.Event_Bus-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"3af8cd76348c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
