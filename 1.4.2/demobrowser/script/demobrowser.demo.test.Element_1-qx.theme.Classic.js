...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Element_1","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Element_1-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ff657997d695"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
