...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Flash","qx.theme":"qx.theme.Classic"};
...
(function(){var k="execute",j="Flash Player Version",i="right",h="Message from Flash:",g="Simple demo with FlashVars",f="bgcolor",d="demobrowser.demo.widget.Flash",c="__VX",b="__VT",a="__VV",y="demobrowser/demo/flash/FlashVersion.swf",x="Flash:",w="__VU",v="<b>qooxdoo:</b>",u="demobrowser.demo.widget.Flash.sendMessage",t="demobrowser.demo.widget.Flash.flashReady",s="demobrowser/demo/flash/fo_tester.swf",r="this is passed in via FlashVars",q="Two way communication (ActionScript <-> JavaScript)",p="Message to Flash:",n="Show Flash Player version",o="noscale",l="#FF6600",m="__VW";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__VT:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var z=new qx.ui.tabview.TabView();
z.setContentPadding([8,8,8,8]);
var C=this.getRoot();
C.add(z,{edge:0});
var A=new qx.ui.tabview.Page(g);
A.setLayout(new qx.ui.layout.Canvas());
A.add(this.createFlashDemo1(),{edge:0});
z.add(A);
var B=new qx.ui.tabview.Page(q);
B.setLayout(new qx.ui.layout.Canvas());
B.add(this.createFlashDemo2(),{edge:0});
z.add(B);
this.__VT=this.createWindow();
C.add(this.__VT,{top:20,left:20});
},createWindow:function(){var D=new qx.ui.window.Window(j).set({width:300,height:200,contentPadding:[0,0,0,0]});
...
var E={flashVarText:r};
var F=new qx.ui.embed.Flash(s).set({scale:o,variables:E});
F.getContentElement().setParam(f,l);
G.add(F,{flex:1});
var H=new qx.ui.form.Button(n);
H.addListener(k,function(){this.__VT.open();
},this);
G.add(H);
return G;
},__VU:null,__VV:null,__VW:null,__VX:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var K=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var J=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
K.add(J,{flex:1});
J.add(new qx.ui.basic.Label(v).set({rich:true}));
J.add(new qx.ui.basic.Label(h));
this.__VV=new qx.ui.form.TextArea("No message.");
this.__VV.setEnabled(false);
J.add(this.__VV,{flex:1});
J.add(new qx.ui.basic.Label(p));
this.__VW=new qx.ui.form.TextArea("qooxdoo is the best!");
J.add(this.__VW,{flex:1});
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,i));
this.__VX=new qx.ui.form.Button("Send to Flash");
this.__VX.setEnabled(false);
this.__VX.addListener(k,function(e){this.__VU.getFlashElement().sendMessage(this.__VW.getValue());
},this);
L.add(this.__VX);
J.add(L);
...
this.__VU=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__VU.setVariables({init:t});
I.add(this.__VU,{flex:1});
return K;
},sendMessage:function(M){this.__VV.setValue(M);
},initFlash:function(){if(this.__VU.getFlashElement().setup){this.__VU.getFlashElement().setup(u);
this.__VX.setEnabled(true);
...
}}},statics:{__VY:null,setCallBackInstance:function(N){demobrowser.demo.widget.Flash.__VY=N;
},sendMessage:function(O){demobrowser.demo.widget.Flash.__VY.sendMessage(O);
},flashReady:function(){demobrowser.demo.widget.Flash.__VY.initFlash();
}},destruct:function(){this._disposeObjects(a,m,c,w,b);
}});
})();
...
if(bh!=d&&bh!=null&&bh!=b){if(!this.isLoaded()){if(!this.__Na){this.__Na=new Date().getTime();
}var bi=new Date().getTime()-this.__Na;
...
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bt,bu){this.__Nb(a,bt);
},_applyScale:function(bv,bw){this.__Nb(X,bv);
},_applyWmode:function(bx,by){this.__Nb(S,bx);
},_applyPlay:function(bz,bA){this.__Nb(L,bz);
},_applyLoop:function(bB,bC){this.__Nb(n,bB);
},_applyMenu:function(bD,bE){this.__Nb(l,bD);
},_applyAllowScriptAccess:function(bF,bG){this.__Nb(k,bF);
},_applyLiveConnect:function(bH,bI){this.__Nb(D,bH);
},__Nb:function(bJ,bK){this.getContentElement().setParam(bJ,bK);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
if(this.__Mb){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,j);
},setId:function(k){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(k,f);
}
if(this.__Mb){throw new Error("The id cannot be modified after initial creation");
...
if(this.__Mb){throw new Error("The variables cannot be modified after initial creation");
}this.__LY=l;
...
if(this.__Mb){throw new Error("The attributes cannot be modified after initial creation");
}
if(n===null||n===undefined){delete this.__Ma[m];
}else{this.__Ma[m]=n;
...
if(this.__Mb){throw new Error("The params cannot be modified after initial creation");
}
if(p===null||p===undefined){delete this.__LX[o];
}else{this.__LX[o]=p;
...
}}}var L=this.__Mh(G,H,J,K);
this._flashObjects[H.id]=L;
return L;
},destroy:qx.core.Environment.select(k,{"mshtml":function(M,N){M=this.__Mc(M);

if(M.readyState==4){this.__Md(M);
}else{if(!N){N=window;
}qx.bom.Event.addNativeListener(N,w,function(){qx.bom.Flash.__Md(M);
});
}},"default":function(O,P){O=this.__Mc(O);

if(O.parentNode){O.parentNode.removeChild(O);
}delete this._flashObjects[O.id];
}}),__Mc:function(Q){if(!Q){throw new Error("DOM element is null or undefined!");
}
...
},__Md:qx.core.Environment.select(k,{"mshtml":qx.event.GlobalError.observeMethod(function(R){for(var i in R){if(typeof R[i]==b){R[i]=null;
}}
if(R.parentNode){R.parentNode.removeChild(R);
}delete this._flashObjects[R.id];
}),"default":null}),__Me:qx.event.GlobalError.observeMethod(function(){for(var S in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[S]);
}window.__Mf=function(){};
window.__Mg=function(){};
qx.bom.Event.removeNativeListener(window,e,qx.bom.Flash.__Me);
}),__Mh:qx.core.Environment.select(k,{"mshtml":function(T,U,V,W){V.movie=U.data;
delete U.data;
delete U.classid;
var X=q;
...
return be;
}})},defer:function(bf){if((qx.core.Environment.get(k)==n)){qx.bom.Event.addNativeListener(window,e,bf.__Me);
}}});
})();
