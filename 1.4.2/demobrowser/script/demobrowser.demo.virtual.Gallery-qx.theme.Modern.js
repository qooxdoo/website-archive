...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Gallery","qx.theme":"qx.theme.Modern"};
...
(function(){var l="",k="selected",j="cell",h="layer",g="icon",f="#f3f3f3",d="label",c="Gallery (HTML - divs)",b="manager",a="default",P="demobrowser.demo.virtual.Gallery",O="demobrowser.demo.virtual.WidgetGallery",N="text-align: center;",M="auto",L="__Vw",K="color: white; background-color: #00398D;",J="user-desktop.png",I="<img src='",H="'></img>",G="group",s="resize",t="folder.png",q="vertical",r="multi",o="network-server.png",p="user-trash.png",m="off",n="top",u="icon/32/places/",v="horizontal",y="demobrowser.demo.virtual.AbstractGallery",x="abstract",A="position: absolute;",z="demobrowser.demo.virtual.HtmlGallery",C="Gallery (widgets)",B="<br>",w="Icon #",F="network-workgroup.png",E="text-selected",D="demobrowser.demo.virtual.GalleryCell";
...
this.__Vw=new demobrowser.demo.virtual.GalleryCell();
...
if(bx){this.__Vw.updateStates(bz,{selected:1});
}else{this.__Vw.updateStates(bz,{});
...
}var bF=this.__Vw.getCellWidget(bG,bE);
bF.setUserData(j,bD);
return bF;
},poolCellWidget:function(bH){this.__Vw.pool(bH);
}},destruct:function(){this._disposeObjects(L,h);
}});
