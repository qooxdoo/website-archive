...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VBox_NegativeMargin","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"dd20a73b1ec0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="_applyLayoutChange",j="Integer",h="auto",g="Decorator",f="top",e="edge",d="flex",c="left",b="Boolean",a="height",x="west",w="The property '",v="qx.debug",u="width",t="' is not supported by the Dock layout!",s="center",r="y",q="qx.ui.layout.Dock",p="_applySort",o="north",m="east",n="south",l="x";
qx.Class.define(q,{extend:qx.ui.layout.Abstract,construct:function(y,z,A,B){qx.ui.layout.Abstract.call(this);
...
}},properties:{sort:{check:[h,r,l],init:h,apply:p},separatorX:{check:g,nullable:true,apply:k},separatorY:{check:g,nullable:true,apply:k},connectSeparators:{check:b,init:false,apply:k},spacingX:{check:j,init:0,apply:k},spacingY:{check:j,init:0,apply:k}},members:{__CE:null,__CF:null,verifyLayoutProperty:qx.core.Environment.select(v,{"true":function(C,name,D){this.assertInArray(name,[d,e,a,u],w+name+t);

if(name===e){this.assertInArray(D,[o,n,x,m,s]);
}else if(name===d){this.assertNumber(D);
this.assert(D>=0);
...
},__CG:{north:1,south:2,west:3,east:4,center:5},__CH:{1:"top",2:"bottom",3:"left",4:"right"},__CI:function(){var E=this._getLayoutChildren();
var M,G;
var length=E.length;
var I=[];
var L=[];
var J=[];
var F=this.getSort()==="y";
var K=this.getSort()==="x";

for(var i=0;i<length;i++){M=E[i];
J=M.getLayoutProperties().edge;

if(J==="center"){if(G){throw new Error("It is not allowed to have more than one child aligned to 'center'!");
}G=M;
}else if(K||F){if(J==="north"||J==="south"){F?I.push(M):L.push(M);
}else if(J==="west"||J==="east"){F?L.push(M):I.push(M);
}}else{I.push(M);
}}var N=I.concat(L);
...
},renderLayout:function(O,P){if(this._invalidChildrenCache){this.__CI();
...
bB=bo+bj.computeHorizontalAlignOffset(R.getAlignX()||c,bc,O,bd,U);
...
top=bh+bj.computeVerticalAlignOffset(R.getAlignY()||f,S,P,bz,ba);
...
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__CI();
}var bO=this.__CE;
var bY=this.__CF;
...
}},destruct:function(){this.__CF=this.__CE=null;
}});
})();
