(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.bom.WebWorker", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.WebWorker.prototype.main.base.call(this);
        ...
        var calculate = new qx.ui.form.Button("Calculate").set({
          width: 100
        });
        var what = new qx.ui.form.TextField("30");
        var result = new qx.ui.form.List().set({
          width: 200
        });
...
//# sourceMappingURL=WebWorker.js.map?dt=1562276970486