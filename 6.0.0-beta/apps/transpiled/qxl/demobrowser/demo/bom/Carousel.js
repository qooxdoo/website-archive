(function () {
  ...
  ************************************************************************ */
   ...
   * @tag noPlayground
   */
  qx.Class.define("qxl.demobrowser.demo.bom.Carousel", {
    extend: qx.application.Native,
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.Carousel.prototype.main.base.call(this);
        ...
        for (var i = 0; i < items.length; i++) {
          entries[i] = qx.bom.Template.get("carousel-entry", {
            data: items[i]
          });
        ...
        window.setInterval(function () {
          for (var i = 0; i < entries.length; i++) {
            ...
            var to = parseInt(qx.bom.element.Style.get(item, "left")) - width; // left overflow
            ...
            if (i == round) {
              ...
              qx.bom.element.Style.set(item, "zIndex", 10); // from middle item
              ...
              frames[100].left = to + middleOffset + "px";
              qx.bom.element.Style.set(item, "zIndex", 1); // all default items
            } else {
              frames[100].left = to + "px";
            }

            qx.bom.element.Animation.animate(item, {
              duration: 500,
              keep: 100,
              keyFrames: frames
            });
...
//# sourceMappingURL=Carousel.js.map?dt=1562140820709