(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.bom.Location_StandardMode", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.Location_StandardMode.prototype.main.base.call(this);
        var links = document.getElementById("list").getElementsByTagName("a");

        for (var i = 0, l = links.length; i < l; i++) {
          qx.event.Registration.addListener(links[i], "tap", qxl.demobrowser.demo.bom.Location_StandardMode.jump);
        }
      }
    },
    statics: {
  ...
  qxl.demobrowser.demo.bom.Location_StandardMode.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Location_StandardMode.js.map?dt=1562184209355