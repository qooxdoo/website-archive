(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.bom.Environment", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.bom.Environment.prototype.main.base.call(this);
        var output = new qx.util.StringBuilder(); // SYNC CHECKS

        output.add("<h2>Synchronous checks</h2>");
        output.add("<table border='0'>"); // this should not be used directly. Its just to show all added checks
        ...
        for (var i = 0; i < keys.length; i++) {
          ...
          output.add("<tr><td>", key, "</td><td>", qx.lang.Json.stringify(value, null, 2), "</td></tr>");
        } // ASYNC CHECKS


        output.add("<tr><td colspan='2'><h2>Asynchronous checks</h2></td></tr>"); // this should not be used directly. Its just to show all added checks
...
//# sourceMappingURL=Environment.js.map?dt=1562153811098