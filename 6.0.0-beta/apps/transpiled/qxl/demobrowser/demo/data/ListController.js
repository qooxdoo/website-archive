(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.ListController", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.ListController.prototype.main.base.call(this); // create the data
        ...
        var list3 = new qx.ui.form.List(); // add the widgets to the document

        this.getRoot().add(list1, {
          left: 10,
          top: 110
        });
        this.getRoot().add(list2, {
          left: 130,
          top: 110
        });
        this.getRoot().add(list3, {
          left: 250,
          top: 110
        ...
        var controller3 = new qx.data.controller.List(controller1.getSelection(), list3); // synchronize the selection

        controller2.setSelection(controller1.getSelection()); // create a label for the selection

        var selectedLabel = new qx.ui.basic.Label("");
        this.getRoot().add(selectedLabel, {
          left: 370,
          top: 110
        }); // bind the label with single value binding to the current selection

        controller3.bind("selection[0]", selectedLabel, "value"); // style the textfield
        ...
        syncListDescription.setValue("<b>Multi selection List</b><br/>Bound to the same data and share the selection.");
        ...
        selectionListDescription.setValue("<b>Selection List</b><br/>Bound to the selection of the list to the left.");
        ...
        selectionLabelDescription.setValue("<b>Selection Label</b><br/>Bound to the selection of the list to the left.");
        this.getRoot().add(selectionLabelDescription, {
          left: 380,
          top: 10
        });
      }
  ...
  qxl.demobrowser.demo.data.ListController.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ListController.js.map?dt=1562235029099