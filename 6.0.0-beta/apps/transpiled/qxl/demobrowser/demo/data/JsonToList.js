(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.JsonToList", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.JsonToList.prototype.main.base.call(this); // create and add the list
        ...
        controller.setLabelPath("name"); // set a converter for the icons
        ...
        controller.setIconPath("type"); // create the data store
        ...
        store.bind("model.items", controller, "model"); // bind the status label
        ...
        description.setValue("<b>List bound to data in a json file</b><br/>Loading the json file <a href='" + url + "' target='_blank'>" + "list.json</a> and bind the items to the list widget. The icons " + " will be created by a converter which converts the type to an icon url.");
...
//# sourceMappingURL=JsonToList.js.map?dt=1562153811667