(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qxl.demobrowser.demo.data.model.Person": {},
      "qx.data.Array": {},
      "qx.ui.form.List": {},
  ...
  ************************************************************************ */
   ...
   * @tag delegate
   */
  qx.Class.define("qxl.demobrowser.demo.data.ExtendedList", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.ExtendedList.prototype.main.base.call(this); // names

        var names = ["Max", "Jakob", "Tim", "Jack", "Dan", "Dustin", "Karl", "Jim"];
        var emotes = ["embarrassed", "kiss", "plain", "sad", "surprise", "angel"]; // create the data

        var rawData = [];

        for (var i = 0; i < 20; i++) {
          var person = new qxl.demobrowser.demo.data.model.Person();
        ...
        list.setWidth(150); // add the widgets to the document
        ...
        var controller = new qx.data.controller.List(null, list); // create the delegate to change the bindings
        ...
        logDataButton.addListener("execute", function () {
          // open the console
          qx.log.appender.Console.show(); // log the data
        ...
        syncListDescription.setValue("<b>Displaying Checkboxes in a list</b><br/>This list display a set of persons in a list as checkbox. Every person does have a name as label and an online status as checkbox.");
        this.getRoot().add(syncListDescription, {
          left: 10,
          top: 10
        });
      }
  ...
  qxl.demobrowser.demo.data.ExtendedList.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ExtendedList.js.map?dt=1562235028883