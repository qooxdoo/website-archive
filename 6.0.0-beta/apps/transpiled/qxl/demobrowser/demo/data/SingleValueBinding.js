(function () {
  ...
  ************************************************************************ */
   ...
   * @tag databinding
   */
  qx.Class.define("qxl.demobrowser.demo.data.SingleValueBinding", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.SingleValueBinding.prototype.main.base.call(this);
        /* Event binding */
        // create the headline label

        this.getRoot().add(new qx.ui.basic.Label("Event binding"), {
          top: 10,
          left: 10
        }); // source textfield
        ...
        this.getRoot().add(textFieldSimple, {
          top: 30,
          left: 10
        }); // target label

        var labelSimple = new qx.ui.basic.Label("Change me...");
        this.getRoot().add(labelSimple, {
          top: 32,
          left: 120
        ...
        this.getRoot().add(new qx.ui.basic.Label("With default conversion"), {
          top: 80,
          left: 10
        ...
        this.getRoot().add(sliderConvert, {
          top: 100,
          left: 10
        }); // create the target label

        var labelConvert = new qx.ui.basic.Label("");
        this.getRoot().add(labelConvert, {
          top: 100,
          left: 120
        ...
        this.getRoot().add(new qx.ui.basic.Label("With own conversion"), {
          top: 150,
          left: 10
        }); // create the source slider
        ...
        this.getRoot().add(sliderSelfConvert, {
          top: 180,
          left: 10
        }); // create the target label

        var labelSelfConvert = new qx.ui.basic.Label("");
        this.getRoot().add(labelSelfConvert, {
          top: 180,
          left: 120
        ...
        this.getRoot().add(new qx.ui.basic.Label("Array binding"), {
          top: 240,
          left: 10
        }); // build the object structure

        var rootNode = new qxl.demobrowser.demo.data.model.Node();
        var node1 = new qxl.demobrowser.demo.data.model.Node();
        var node2 = new qxl.demobrowser.demo.data.model.Node();
        node2.setNames(new qx.data.Array("Bart", "Lisa"));
        rootNode.setChild(node1); // reverse the array button and handler
        ...
        }, this); // swap child between node1 and node2 button and handler

        var changeChildButton = new qx.ui.form.Button("Toggle child");
        this.getRoot().add(changeChildButton, {
          top: 260,
          left: 80
        });
        ...
        this.getRoot().add(new qx.ui.basic.Label("First:"), {
          left: 10,
          top: 295
        });
        this.getRoot().add(new qx.ui.basic.Label("Last:"), {
          left: 60,
          top: 295
        });
        var labelArrayFirst = new qx.ui.basic.Label();
        this.getRoot().add(labelArrayFirst, {
          top: 310,
          left: 10
        });
        var labelArrayLast = new qx.ui.basic.Label();
        this.getRoot().add(labelArrayLast, {
          top: 310,
          left: 60
        ...
        this.getRoot().add(new qx.ui.basic.Label("With validation"), {
          top: 390,
          left: 10
        }); // create the source slider
        ...
        this.getRoot().add(validationTextField, {
          top: 410,
          left: 10
        }); // create the validation label

        var labelValidation = new qx.ui.basic.Label("");
        this.getRoot().add(labelValidation, {
          top: 412,
          left: 120
        }); // create the options with the converter
        ...
        var options = {
          ...
          onSetFail: function onSetFail(e) {
        ...
        eventDescription.setValue("<b>Description</b><br/>Binding an data event, containing the change of the textfield to the label.");
        this.getRoot().add(eventDescription, {
          left: 250,
          top: 10
        ...
        defaultDescription.setValue("<b>Description</b><br/>Binding a number value (slider value) to a labels string (content). The default conversion will handle the type conversion.");
        this.getRoot().add(defaultDescription, {
          left: 250,
          top: 80
        ...
        ownDescription.setValue("<b>Description</b><br/>Binding a slider value to a labels text but conversion the number with a self written converter to a string only saying it its  above or below 50.");
        this.getRoot().add(ownDescription, {
          left: 250,
          top: 150
        ...
        deepDescription.setValue("<b>Description</b><br/>Binding of node elements containing a node as child and an array of names.<br/>The reverse button reverses the current selected child names array.<br/>Toggle child will change the child of the root node from a node containing ['Homer', 'Marge'] as names to a node containing ['Bart', 'Lisa'] as names.");
        this.getRoot().add(deepDescription, {
          left: 250,
          top: 240
        ...
        validationDescription.setValue("<b>Description</b><br/>Binding the textfield to a property with a validation. The validator in the object only accepts numbers. On a validation fail, a red  border will surround the textfield.");
...
//# sourceMappingURL=SingleValueBinding.js.map?dt=1562153811919