(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qxl.demobrowser.demo.data.model.Node": {},
      "qx.ui.tree.Tree": {},
  ...
  ************************************************************************ */
   ...
   * tag databinding
   */
  qx.Class.define("qxl.demobrowser.demo.data.TreeController", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.TreeController.prototype.main.base.call(this); // create the data
        ...
        for (var i = 0; i < 50; i++) {
          ...
          nodes[i].setName2("Thing " + i); // if its not the root node
        ...
        tree.setWidth(250);
        tree.setHeight(300); // bind the widget to the data with the controller

        var treeController = new qx.data.controller.Tree(nodes[0], tree, "children", "name"); // open the root node

        tree.getRoot().setOpen(true); // create a list for the selection
        ...
        addItemButton.addListener("execute", function () {
          var node = new qxl.demobrowser.demo.data.model.Node();
        ...
        this.getRoot().add(changeNameButton, {
          left: 390,
          top: 200
        });
        ...
        treeDescription.setValue("<b>Tree binding</b><br/>This tree is bound to a set of randomly generated nodes. Every node does have a name and a name2 property, containing 'Item i' and 'Thing i'.");
        this.getRoot().add(treeDescription, {
          left: 20,
          top: 10
        ...
        selectionListDescription.setValue("<b>Selected Items</b><br/>A list containing the selected items of the tree.");
        this.getRoot().add(selectionListDescription, {
          left: 270,
          top: 10
        });
      }
...
//# sourceMappingURL=TreeController.js.map?dt=1562512200519