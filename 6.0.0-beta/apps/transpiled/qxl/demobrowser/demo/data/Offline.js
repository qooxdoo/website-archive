(function () {
  ...
  ************************************************************************ */
   ...
   * @tag databinding
   */
  qx.Class.define("qxl.demobrowser.demo.data.Offline", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.Offline.prototype.main.base.call(this); // show a warning if html5 local storage is not supported
        ...
        var controller = new qx.data.controller.List(null, list); // create the offline store

        var store = new qx.data.store.Offline("qx-offline-demo"); // check if the model needs to be initialized
        ...
        removeButton.setAllowGrowY(false); // align the buttons top

        grid.setRowFlex(1, 1); // add handler
        ...
        description.setValue("<b>Offline data store</b><br/>The added data will be keept on reload. Just add or remove strings and reload to see the result.");
...
//# sourceMappingURL=Offline.js.map?dt=1562276970862