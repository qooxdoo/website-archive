  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.Tree_Dynamic", {
    ...
    members: {
      count: 0,
      main: function main() {
        qxl.demobrowser.demo.virtual.Tree_Dynamic.prototype.main.base.call(this);
        var root = {
          label: "Root",
          children: [],
          icon: "default",
        ...
        var delegate = {
          bindItem: function bindItem(controller, item, index) {
            ...
            controller.bindProperty("", "open", {
              converter: function converter(value, model, source, target) {
      ...
      createRandomData: function createRandomData(parent) {
...
//# sourceMappingURL=Tree_Dynamic.js.map?dt=1562147537598