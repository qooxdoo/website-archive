(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.virtual.list.ListItem", {
     ...
     */
    construct: function construct(label, icon, value) {
    ...
    */
    ...
    members: {
      ...
      */
      // property apply
      _applyManager: function _applyManager(value, old) {
        if (old) {
          old.remove(this);
        }
  ...
  qxl.demobrowser.demo.virtual.list.ListItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ListItem.js.map?dt=1562140827809