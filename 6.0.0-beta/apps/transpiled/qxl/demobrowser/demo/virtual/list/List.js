  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.virtual.list.List", {
    ...
    construct: function construct() {
      qx.ui.virtual.core.Scroller.constructor.call(this, 0, 1, this.getItemHeight(), 10);
      ...
      this.__selectionManager.attachListEvents(this); // Creates the prefetch behavior
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _onChangeItemHeight: function _onChangeItemHeight(e) {
        qx.ui.core.queue.Widget.add(this);
      },
      ...
      */
      ...
      getValue: function getValue() {
        ...
        for (var i = 0, l = selected.length; i < l; i++) {
          // Try value first
          value = selected[i].getValue(); // Fallback to label
      ...
      setValue: function setValue(value) {
        ...
        var splitted = value.split(","); // Building result list
      ...
      */
      ...
      ---------------------------------------------------------------------------
      */
      __itemToRow: function __itemToRow(item) {
      ...
      __rowToItem: function __rowToItem(row) {
        var item = this.__items[row];
        return item;
      },
      __itemsToRows: function __itemsToRows(items) {
        var rows = [];
      ...
      __rowsToItems: function __rowsToItems(rows) {
        var items = [];
      ...
      selectRange: function selectRange(begin, end) {
        this.__selectionManager.selectItemRange(this.__itemToRow(begin), this.__itemToRow(end));
      },
  ...
  qxl.demobrowser.demo.virtual.list.List.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=List.js.map?dt=1562140827784