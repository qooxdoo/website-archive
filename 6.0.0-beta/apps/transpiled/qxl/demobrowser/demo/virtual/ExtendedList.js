(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.ExtendedList", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.virtual.ExtendedList.prototype.main.base.call(this); // names

        var names = ["Max", "Jakob", "Tim", "Jack", "Dan", "Dustin", "Karl", "Jim"]; // create the data
...
//# sourceMappingURL=ExtendedList.js.map?dt=1562147537135