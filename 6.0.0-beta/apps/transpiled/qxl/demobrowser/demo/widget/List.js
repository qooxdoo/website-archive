(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.List", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.List.prototype.main.base.call(this); // scroll container
        ...
        for (var i = 1; i <= 25; i++) {
          ...
          configList.add(item);
          !(i % 9) && item.setEnabled(false); // Pre-Select "Item No 20"
        ...
        for (var i = 1; i <= 25; i++) {
          ...
          oneList.add(item); // Pre-Select "Item No 16"
        ...
        var l4l = ["audio-card.png", "audio-input-microphone.png", "battery.png", "camera-photo.png", "camera-web.png", "computer.png", "display.png", "drive-harddisk.png", "drive-optical.png", "input-keyboard.png", "input-mouse.png", "media-flash.png", "media-optical.png", "multimedia-player.png", "network-wired.png", "network-wireless.png", "pda.png", "phone.png", "printer.png"];
...
//# sourceMappingURL=List.js.map?dt=1562153816057