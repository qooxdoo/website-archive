(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.widget.CheckBox", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.CheckBox.prototype.main.base.call(this);
        var label = new qx.ui.basic.Label("What do you need for the beach?"); // create the main layout

        var mainLayout = new qx.ui.layout.VBox();
        mainLayout.setSpacing(10); // add the main layout to a container widget and to the document root
        ...
        container.add(label); // Create some radio buttons
        ...
        this._checkBoxes = [cbOil, cbTowel, cbBeer, cbBT]; // Add them to the container
...
//# sourceMappingURL=CheckBox.js.map?dt=1562140827976