(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.Resizer", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.Resizer.prototype.main.base.call(this);
        this.getRoot().add(this._getResizer(), {
          left: 20,
          top: 20
        });
        this.getRoot().add(this._getResizerList(), {
          left: 400,
          top: 20
        });
      },
      _getResizerList: function _getResizerList() {
      ...
      _getResizer: function _getResizer() {
...
//# sourceMappingURL=Resizer.js.map?dt=1562235033853