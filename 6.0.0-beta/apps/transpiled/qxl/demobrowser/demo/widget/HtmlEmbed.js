(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.widget.HtmlEmbed", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.HtmlEmbed.prototype.main.base.call(this);
        var box = new qx.ui.layout.VBox();
        box.setSpacing(10);
        var container = new qx.ui.container.Composite(box);
        container.setPadding(20);
        this.getRoot().add(container); // Example HTML embed
        ...
        container.add(embed1); // Example HTML embed with set font
        ...
        container.add(embed2); // Rich content
...
//# sourceMappingURL=HtmlEmbed.js.map?dt=1562184215641