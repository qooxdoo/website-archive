(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.widget.StackContainer", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.StackContainer.prototype.main.base.call(this);
        this.addSimpleStack();
        this.addDynamicStack();
      },
      addSimpleStack: function addSimpleStack() {
      ...
      addDynamicStack: function addDynamicStack() {
        var container = new qx.ui.container.Stack();
        container.setDecorator("main");
...
//# sourceMappingURL=StackContainer.js.map?dt=1562184216294