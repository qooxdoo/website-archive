(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.widget.Label", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.Label.prototype.main.base.call(this);
        ...
        this.getRoot().add(this.createConfigureButton(label1, "configure text label"), {
          left: 240,
          top: 20
        });
        ...
        this.getRoot().add(this.createConfigureButton(label2, "configure rich label"), {
          left: 240,
          top: 60
        });
      ...
      createConfigureButton: function createConfigureButton(widget, caption) {
      ...
      createEditDialog: function createEditDialog(widget, caption) {
        ...
        win.add(new qx.ui.basic.Label("selectable"), {
          row: 1,
          column: 0
        });
        var buttonSelectable = new qx.ui.form.CheckBox();
        controller.addTarget(buttonSelectable, "value", "selectable", true);
        win.add(buttonSelectable, {
          row: 1,
          column: 1
        });
        win.add(new qx.ui.basic.Label("native context menu"), {
          row: 2,
          column: 0
        });
        var buttonSelectable = new qx.ui.form.CheckBox();
        ...
        win.add(new qx.ui.basic.Label("rich"), {
          row: 3,
          column: 0
        });
...
//# sourceMappingURL=Label.js.map?dt=1562235033545