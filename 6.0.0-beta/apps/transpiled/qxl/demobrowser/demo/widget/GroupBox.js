(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.GroupBox", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.GroupBox.prototype.main.base.call(this); // create the main layout

        var mainLayout = new qx.ui.layout.VBox();
        mainLayout.setSpacing(20); // add the main layout to a container widget and to the document root
        ...
        box1.add(new qx.ui.form.CheckBox("Show debugging console")); // create the second group box
        ...
        box2.add(textField2); // create the third group box
...
//# sourceMappingURL=GroupBox.js.map?dt=1562276975042