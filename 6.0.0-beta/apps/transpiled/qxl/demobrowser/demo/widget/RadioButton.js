(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.widget.RadioButton", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.RadioButton.prototype.main.base.call(this);
        var label = new qx.ui.basic.Label("What is your favorite color?"); // create the main layout
        ...
        var rbBlue = new qx.ui.form.RadioButton("Blue"); // Add them to the container

        container.add(rbRed);
        container.add(rbGreen);
        container.add(rbYellow);
        container.add(rbBlue); // Add all radio buttons to the manager

        var manager = new qx.ui.form.RadioGroup(rbRed, rbGreen, rbYellow, rbBlue); // Add a listener to the "changeSelected" event
...
//# sourceMappingURL=RadioButton.js.map?dt=1562276975376