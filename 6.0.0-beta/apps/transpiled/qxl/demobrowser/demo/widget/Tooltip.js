(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.Tooltip", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.widget.Tooltip.prototype.main.base.call(this);
      ...
      createSharedToolTip: function createSharedToolTip() {
      ...
      createIconToolTip: function createIconToolTip() {
      ...
      createToolTip: function createToolTip() {
        var button = new qx.ui.form.Button("ToolTip with icon and label").set({
          toolTip: new qx.ui.tooltip.ToolTip("Hello World #3", "icon/16/actions/help-about.png")
        });
        this.add(button);
      },
      createShortTimeoutToolTip: function createShortTimeoutToolTip() {
        var tooltip = new qx.ui.tooltip.ToolTip("Such a great tooltip with a (show) timeout of 50ms.", "icon/32/actions/help-about.png");
        tooltip.setShowTimeout(50);
        var button = new qx.ui.form.Button("Short timeout ToolTip");
        this.add(button);
        button.setToolTip(tooltip);
      },
      createRichToolTip: function createRichToolTip() {
        var tooltip = new qx.ui.tooltip.ToolTip("A long label text with auto-wrapping. This also may contain <b style='color:red'>rich HTML</b> markup and with a (show) timeout of 50ms.", "icon/32/actions/help-about.png");
...
//# sourceMappingURL=Tooltip.js.map?dt=1562187680522