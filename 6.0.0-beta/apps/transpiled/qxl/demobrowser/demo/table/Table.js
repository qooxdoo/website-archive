(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.table.Table", {
    ...
    members: {
      ...
      createTable: function createTable() {
        ...
        var rowData = this.createRandomRows(50); // table model
        ...
        tableModel.setColumnSortable(3, false); // table
      ...
      createControls: function createControls() {
        ...
        checkBox.addListener("changeValue", function (evt) {
          if (evt.getData()) {
            var ascending = function ascending(row1, row2, columnIndex) {
            ...
            var descending = function descending(row1, row2, columnIndex) {
              var obj1 = row1[columnIndex];
              var obj2 = row2[columnIndex];
  ...
  qxl.demobrowser.demo.table.Table.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Table.js.map?dt=1562184212834