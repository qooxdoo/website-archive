(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.animation.Animation_Compare", {
    extend: qx.application.Native,
    members: {
      createButton: function createButton(name, desc) {
        var buttons = [];
      ...
      main: function main() {
        qxl.demobrowser.demo.animation.Animation_Compare.prototype.main.base.call(this);
        ...
        document.body.appendChild(cssContainer); // JS ANIMATIONS
        ...
        cssContainer.appendChild(buttons[0]);
        jsContainer.appendChild(buttons[1]); // PAUSE / PLAY
        ...
        cssContainer.appendChild(buttons[0]);
        jsContainer.appendChild(buttons[1]); // ITERATION EVENT
        ...
        var onIteration = function onIteration(e) {
        ...
        cssContainer.appendChild(buttons[0]);
        jsContainer.appendChild(buttons[1]); // DELAY
...
//# sourceMappingURL=Animation_Compare.js.map?dt=1562235028281