(function () {
  ...
  ************************************************************************ */
   ...
   * @tag noPlayground
   */
  qx.Class.define("qxl.demobrowser.demo.layout.VBox_Separator", {
    extend: qxl.demobrowser.demo.util.LayoutApplication,
    members: {
      main: function main() {
        qxl.demobrowser.demo.layout.VBox_Separator.prototype.main.base.call(this);
  ...
  qxl.demobrowser.demo.layout.VBox_Separator.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VBox_Separator.js.map?dt=1562184212232