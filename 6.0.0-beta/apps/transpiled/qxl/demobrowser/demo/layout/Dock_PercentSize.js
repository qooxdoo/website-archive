(function () {
  ...
  ************************************************************************ */
   ...
   * @tag noPlayground
   */
  qx.Class.define("qxl.demobrowser.demo.layout.Dock_PercentSize", {
    extend: qxl.demobrowser.demo.util.LayoutApplication,
    members: {
      main: function main() {
        qxl.demobrowser.demo.layout.Dock_PercentSize.prototype.main.base.call(this);
        ...
        scroll.add(container); // default layout, flex growing
        ...
        container.add(widget); // y-axis first, flex growing
        ...
        container.add(widget); // x-axis first, flex growing
...
//# sourceMappingURL=Dock_PercentSize.js.map?dt=1562187676431