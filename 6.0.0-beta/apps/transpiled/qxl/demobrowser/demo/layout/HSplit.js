(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.layout.HSplit", {
    ...
    members: {
       ...
       */
      main: function main() {
        qxl.demobrowser.demo.layout.HSplit.prototype.main.base.call(this); // Two Flex Tests
        ...
        this.addSplitPaneTwoFlexWithTwoMax(); // One Flex Test

        this.addSplitPaneOneFlexSimple();
        this.addSplitPaneOneFlexSimpleWithMax();
        this.addSplitPaneOneFlexSimpleWithMin(); // Auto Size

        this.addSplitPaneAuto();
      },
      addSplitPaneTwoFlexSimple: function addSplitPaneTwoFlexSimple() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
        this.getRoot().add(splitpane, {
          left: 20,
          top: 20
        }); // Left
        ...
        splitpane.add(leftWidget, 1); // Right
      ...
      addSplitPaneTwoFlexWithOneMin: function addSplitPaneTwoFlexWithOneMin() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
      ...
      addSplitPaneTwoFlexWithOneMax: function addSplitPaneTwoFlexWithOneMax() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
      ...
      addSplitPaneTwoFlexWithTwoMin: function addSplitPaneTwoFlexWithTwoMin() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
      ...
      addSplitPaneTwoFlexWithTwoMax: function addSplitPaneTwoFlexWithTwoMax() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
      ...
      addSplitPaneOneFlexSimple: function addSplitPaneOneFlexSimple() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
        ...
        leftWidget.setDecorator(null);
        leftWidget.setWrap(true);
        splitpane.add(leftWidget, 0); // Right
      ...
      addSplitPaneOneFlexSimpleWithMax: function addSplitPaneOneFlexSimpleWithMax() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
      ...
      addSplitPaneOneFlexSimpleWithMin: function addSplitPaneOneFlexSimpleWithMin() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setWidth(400);
        splitpane.setHeight(60);
        splitpane.setDecorator("main");
      ...
      addSplitPaneAuto: function addSplitPaneAuto() {
        var splitpane = new qx.ui.splitpane.Pane("horizontal");
        splitpane.setDecorator("main");
        this.getRoot().add(splitpane, {
          left: 500,
...
//# sourceMappingURL=HSplit.js.map?dt=1562184211825