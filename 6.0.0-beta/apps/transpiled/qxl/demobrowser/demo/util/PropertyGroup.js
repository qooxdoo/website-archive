(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.util.PropertyGroup", {
    extend: qx.ui.core.Widget,
    construct: function construct(propertyDescription) {
    ...
    members: {
      ...
      _setProperty: function _setProperty(widget, name, value) {
        if (!widget) {
          return;
        }
      ...
      _getProperty: function _getProperty(widget, name) {
        var getter = "get" + qx.lang.String.firstUp(name);
        return widget[getter]();
      },
      _hasProperty: function _hasProperty(widget, name) {
        var setter = "set" + qx.lang.String.firstUp(name);
        return typeof widget[setter] == "function";
      },
      _createOnIntPropertyChange: function _createOnIntPropertyChange(property) {
        return function (e) {
      ...
      _createOnBoolPropertyChange: function _createOnBoolPropertyChange(property) {
        return function (e) {
          var widget = this.getSelected();
      ...
      _createOnEnumPropertyChange: function _createOnEnumPropertyChange(property, mgr) {
        return function (e) {
          var widget = this.getSelected();
      ...
      _createOnNullPropertyChange: function _createOnNullPropertyChange(property) {
        return function (e) {
          var widget = this.getSelected();
      ...
      _updateControls: function _updateControls(widget) {
        for (var prop in this._properties) {
          var type = this._properties[prop].type;
...
//# sourceMappingURL=PropertyGroup.js.map?dt=1562153815025