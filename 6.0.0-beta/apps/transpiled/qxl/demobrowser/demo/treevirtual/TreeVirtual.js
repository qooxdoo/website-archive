(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.treevirtual.TreeVirtual", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.treevirtual.TreeVirtual.prototype.main.base.call(this); // We want to use some of the high-level node operation convenience
        ...
        var te2 = dataModel.addBranch(null, "Inbox", true, false, "icon/22/apps/internet-mail.png");
  ...
  qxl.demobrowser.demo.treevirtual.TreeVirtual.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=TreeVirtual.js.map?dt=1562276973112