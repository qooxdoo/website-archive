(function () {
  ...
  qx.Class.define("qxl.demobrowser.demo.treevirtual.TreeVirtual_Events", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.treevirtual.TreeVirtual_Events.prototype.main.base.call(this); // We want to use some of the high-level node operation convenience
        // methods rather than manually digging into the TreeVirtual helper
        // classes.  Include the mixin that provides them.

        qx.Class.include(qx.ui.treevirtual.TreeVirtual, qx.ui.treevirtual.MNode); // tree

        var tree = new qx.ui.treevirtual.TreeVirtual("Tree");
        tree.setColumnWidth(0, 400);
        tree.setAlwaysShowOpenCloseSymbol(true); // Add the tree
...
//# sourceMappingURL=TreeVirtual_Events.js.map?dt=1562187677960