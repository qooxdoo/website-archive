(function () {
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.treevirtual.TreeVirtual_Selections", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.treevirtual.TreeVirtual_Selections.prototype.main.base.call(this); // We want to use some of the high-level node operation convenience
        ...
        tree.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.MULTIPLE_INTERVAL); // Add the tree to the document
        ...
        hBox.add(commandFrame); // Create a combo box for the selection type

        var o = new qx.ui.basic.Atom("Selection Mode: ");
        commandFrame.add(o);
        o = new qx.ui.form.SelectBox(); // Add the various selection types
        ...
        o.add(item);
        o.setSelection([item]); // We want to be notified if the selection changes

        o.addListener("changeSelection", function (e) {
          switch (e.getData()[0].getLabel()) {
            case "No Selection":
              tree.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.NONE);
              break;
            ...
            case "Single Interval Selection":
              tree.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.SINGLE_INTERVAL);
              break;
...
//# sourceMappingURL=TreeVirtual_Selections.js.map?dt=1562235031597