(function () {
  ...
  qx.Class.define("qxl.demobrowser.demo.treevirtual.TreeVirtual_Filter", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.treevirtual.TreeVirtual_Filter.prototype.main.base.call(this); // We want to use some of the high-level node operation convenience
        ...
        commandFrame.add(textField); // Set the filter
  ...
  qxl.demobrowser.demo.treevirtual.TreeVirtual_Filter.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=TreeVirtual_Filter.js.map?dt=1562512202717