(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.event.MouseEvent", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.event.MouseEvent.prototype.main.base.call(this);
        ...
        for (var i = 0; i < events.length; i++) {
          ...
          if (elem.checked) {
            qx.bom.Element.addListener(mouseDiv, events[i], this.logMouseEvent, this);
          }
        ...
        qx.bom.Element.addListener(mouseDiv, "losecapture", function (e) {
          captureDiv.checked = false;
        }, this);
      },
      ...
      logMouseEvent: function logMouseEvent(mouseEvent) {
        ...
        this._log([mouseEvent.getTarget().id, mouseEvent.getType(), mouseEvent.getButton(), mouseEvent.getDocumentLeft(), mouseEvent.getDocumentTop(), mouseEvent.getScreenLeft(), mouseEvent.getScreenTop(), mouseEvent.getViewportLeft(), mouseEvent.getViewportTop(), mouseEvent.getRelatedTarget() ? mouseEvent.getRelatedTarget().id : ""]);
      }
    }
  });
...
//# sourceMappingURL=MouseEvent.js.map?dt=1562153812305