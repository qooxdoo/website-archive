(function () {
  ...
  ************************************************************************ */
   ...
   * @tag showcase
   */
  qx.Class.define("qxl.demobrowser.demo.showcase.Translation", {
    ...
    */
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.demobrowser.demo.showcase.Translation.prototype.main.base.call(this); // Enable logging in debug variant
        ...
        infoContainer.add(l1);
        infoContainer.add(l2);
        infoContainer.add(l3);
        ...
        container.add(appleNumberSelectBoxLabel, {
          row: 5,
          column: 0
        });
        ...
        container.add(translation2Info, {
          row: 5,
          column: 3,
          rowSpan: 2
        });
        ...
        container.add(translation3Info, {
          row: 7,
          column: 3
        });
        var translation4MId = new qx.ui.basic.Label("Orange");
        container.add(translation4MId, {
          row: 8,
          column: 1
        ...
        container.add(translation4Info, {
          row: 8,
          column: 3
        });
        ...
        addNewLocaleButton.addListener("execute", function (e) {
          ...
          if (locales.indexOf(newLocaleName) != -1) {
            ...
            localeManager.addTranslation(newLocaleName, {
              "demo": "demo"
            });
...
//# sourceMappingURL=Translation.js.map?dt=1562266613532