(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.showcase.Dialog", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.showcase.Dialog.prototype.main.base.call(this);
        ...
        for (var i = 0; i < inputs.length; i++) {
          page.add(new qx.ui.form.TextField(inputs[i]), {
            row: i,
            column: 1
          });
        } // text area
        ...
        male.setValue(true); // check boxes
...
//# sourceMappingURL=Dialog.js.map?dt=1562184212526