  ...
  qx.Class.define("qxl.demobrowser.demo.mobile.Fingers", {
    ...
    */
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.demobrowser.demo.mobile.Fingers.prototype.main.base.call(this); // Enable logging in debug variant
        ...
        root.add(label);
        label.setAttribute("innerHTML", "<b>Use your fingers to move the dots</b>"); // create some colored balls
        ...
        this.__startDivX = [];
        this.__startDivY = []; // attach the listeners
...
//# sourceMappingURL=Fingers.js.map?dt=1562187677218