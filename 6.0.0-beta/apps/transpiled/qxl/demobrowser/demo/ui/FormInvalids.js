(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.ui.FormInvalids", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.FormInvalids.prototype.main.base.call(this);
        var widgets = []; // spinner

        widgets.push(new qx.ui.form.Spinner());
        this.getRoot().add(widgets[0], {
          left: 20,
          top: 80
        }); // slider
        ...
        this.getRoot().add(widgets[14], {
          left: 390,
          top: 280
        }); // date chooser

        widgets.push(new qx.ui.control.DateChooser());
        this.getRoot().add(widgets[15], {
          left: 530,
          top: 70
        }); // radioGroup
        ...
        this.getRoot().add(toggleValidButton, {
          left: 300,
          top: 20
        });
        ...
        this.getRoot().add(disableButton, {
          left: 370,
          top: 20
        });
        ...
        this.getRoot().add(disableTooltipButton, {
          left: 450,
          top: 20
        });
        ...
        listDescription.setValue("<b>Validation</b><br/>Press the button to invalidate all shown widgets. Try the invalid focus and tooltip.");
        this.getRoot().add(listDescription, {
          left: 20,
          top: 10
        });
      }
...
//# sourceMappingURL=FormInvalids.js.map?dt=1562276973426