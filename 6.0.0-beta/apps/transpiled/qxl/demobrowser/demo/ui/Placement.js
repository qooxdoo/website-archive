  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.ui.Placement", {
    ...
    members: {
      __positions: null,
      main: function main() {
        qxl.demobrowser.demo.ui.Placement.prototype.main.base.call(this);
        var root = this.getRoot();
        this.__positions = ["bottom-left", "bottom-center", "bottom-right", "top-left", "top-center", "top-right", "right-top", "right-middle", "right-bottom", "left-top", "left-middle", "left-bottom"]; // Corners

        root.add(this.createTestField("bottom-left"), {
          left: 20,
          top: 20
        });
        root.add(this.createTestField("bottom-right"), {
          right: 20,
          top: 20
        });
        root.add(this.createTestField("top-right"), {
          right: 20,
          bottom: 20
        });
        root.add(this.createTestField("top-left"), {
          left: 20,
          bottom: 20
        }); // Top+Bottom Center

        root.add(this.createTestField("bottom-center"), {
          left: 400,
          top: 20
        });
        root.add(this.createTestField("top-center"), {
          left: 400,
          bottom: 20
        }); // Left+Right Side

        root.add(this.createTestField("right-top"), {
          left: 20,
          top: 200
        });
        root.add(this.createTestField("right-middle"), {
          left: 20,
          top: 275
        });
        root.add(this.createTestField("right-bottom"), {
          left: 20,
          top: 350
        });
        root.add(this.createTestField("left-top"), {
          right: 20,
          top: 200
        });
        root.add(this.createTestField("left-middle"), {
          right: 20,
          top: 275
        });
        root.add(this.createTestField("left-bottom"), {
          right: 20,
          top: 350
        }); // DOM align test

        root.add(this.createDomTest(), {
          left: 200,
          top: 100
        });
      },
      createTestField: function createTestField(init) {
      ...
      createDomTest: function createDomTest() {
        var composite = new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
...
//# sourceMappingURL=Placement.js.map?dt=1562235032218