(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.ui.NativeContextMenu", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.NativeContextMenu.prototype.main.base.call(this); // disable globally
        ...
        container.setLayout(layout); // menu allowed
        ...
        container.add(new qx.ui.form.TextField("text field"), {
          row: 3,
          column: 1
        });
      }
...
//# sourceMappingURL=NativeContextMenu.js.map?dt=1562153814687