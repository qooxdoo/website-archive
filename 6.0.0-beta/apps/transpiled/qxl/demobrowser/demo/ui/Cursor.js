(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.ui.Cursor", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.Cursor.prototype.main.base.call(this);
      ...
      getGrid1: function getGrid1() {
        ...
        var cursors = ["default", "crosshair", "pointer", "move", "n-resize", "ne-resize", "e-resize", "se-resize", "s-resize", "sw-resize", "w-resize", "nw-resize", "nesw-resize", "nwse-resize", "text", "wait", "help "];
        var i = 0;
...
//# sourceMappingURL=Cursor.js.map?dt=1562147536147