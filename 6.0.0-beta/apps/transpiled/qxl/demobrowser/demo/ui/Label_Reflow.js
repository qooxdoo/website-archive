(function () {
  ...
  ************************************************************************ */
   ...
   */
  qx.Class.define("qxl.demobrowser.demo.ui.Label_Reflow", {
    extend: qx.application.Standalone,
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.Label_Reflow.prototype.main.base.call(this); //this.getRoot().setPadding(20);
        ...
        btn_toggle.addListener("tap", function () {
          ...
          label.setValue(growText ? "qooxdoo is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed." : "<b>qooxdoo is cool.</b>");
          growText = !growText;
        });
...
//# sourceMappingURL=Label_Reflow.js.map?dt=1562187678572