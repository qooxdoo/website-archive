(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxl.demobrowser.demo.ui.AutoSizeTextArea", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.AutoSizeTextArea.prototype.main.base.call(this);
        ...
        subContainer.add(textAreaWrap, {
          row: 0,
          column: 0
        });
        subContainer.add(checkBox, {
          row: 1,
          column: 0
        });
      },
...
//# sourceMappingURL=AutoSizeTextArea.js.map?dt=1562276973232