  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.CommandGroupManager", {
    ...
    */
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.CommandGroupManager.prototype.main.base.call(this);
      ...
      _createWidgets: function _createWidgets() {
        ...
        page1.add(new ColorSwitch(this), {
          edge: 0
        });
        page2.add(new ColorSwitch(this), {
          edge: 0
        });
        page3.add(new ColorSwitch(this), {
          edge: 0
        });
        tabview.add(page1);
        tabview.add(page2);
      ...
      getGroupManager: function getGroupManager() {
  ...
  qx.Class.define("ColorSwitch", {
    ...
    construct: function construct(controller) {
      ...
      this.setPadding(25);
      this._controller = controller; // create command

      var cmd = new qx.ui.command.Command("5");
      cmd.addListener("execute", this.toggleColor, this); // create command group

      var group = new qx.ui.command.Group();
      this._group = group; // add command into group

      group.add("toggleColor", cmd); // Register command group at command group manager
    ...
    members: {
      ...
      toggleColor: function toggleColor(target, command) {
      ...
      _blockCommands: function _blockCommands(e) {
        this._controller.getGroupManager().block();
      },
      _unblockCommands: function _unblockCommands(e) {
...
//# sourceMappingURL=CommandGroupManager.js.map?dt=1562147536136