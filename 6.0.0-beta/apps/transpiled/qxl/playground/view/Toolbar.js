  ...
  */
  qx.Class.define("qxl.playground.view.Toolbar", {
    ...
    construct: function construct() {
      ...
      this.__menuItemStore = {}; // run button
      ...
      this.__samplesCheckButton = new qx.ui.form.ToggleButton(this.tr("Samples"), "icon/22/actions/edit-copy.png");
      ...
      this.__highlightButton = new qx.ui.form.ToggleButton(this.tr("Syntax Highlighting"), "icon/22/actions/check-spelling.png");
      ...
      this.__highlightButton.setValue(initValue); // spacer


      this.addSpacer(); // log Check button

      this.__logCheckButton = new qx.ui.toolbar.CheckBox(this.tr("Log"), "icon/22/apps/utilities-log-viewer.png");
    ...
    members: {
      ...
      enableHighlighting: function enableHighlighting(value) {
        this.__highlightButton.setEnabled(value); // if the button will be disable, remove the pressed state
    ...
    destruct: function destruct() {
      this._disposeObjects("__highlightButton", "__logCheckButton", "__overflowMenu");
    }
  });
  qxl.playground.view.Toolbar.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Toolbar.js.map?dt=1562140830284