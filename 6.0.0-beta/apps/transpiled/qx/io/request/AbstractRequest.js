    ...
    members: {
      ...
      */
      sendWithPromise: function sendWithPromise(context) {
        {
          var context = context !== undefined && context !== null ? context : this; // save this object's context
          ...
          var promise = new qx.Promise(function (resolve, reject) {
            ...
            var phaseListener = req.addListener("changePhase", function (e) {
              ...
              var failMessage = phase === "statusError" ? req.getStatus() + ": " + req.getStatusText() : null;
            ...
            listeners.push(phaseListener); // must be handled separately because it is not a phase
...
//# sourceMappingURL=AbstractRequest.js.map?dt=1562147515704