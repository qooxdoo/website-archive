qx.$$packageData['0'] = {
  ...
  "resources": {
    ...
    "qx/decoration/Classic/arrows-combined.meta": [
      null,
      null,
      "meta",
      "qx"
    ...
    "qx/decoration/Classic/cursors-combined.meta": [
      null,
      null,
      "meta",
      "qx"
    ...
    "qx/decoration/Classic/menu-combined.meta": [
      null,
      null,
      "meta",
      "qx"
    ],
    "qx/decoration/Classic/shadow-lr-combined.meta": [
      null,
      null,
      "meta",
      "qx"
    ...
    "qx/decoration/Classic/form/checkbox-undetermined-focused.png": [
      14,
      14,
      "png",
      "qx"
    ...
    "qx/decoration/Classic/form/radiobutton-checked-hovered.png": [
      14,
      14,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/form/radiobutton-checked-invalid.png": [
      14,
      14,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/shadow/shadow-small-tr.png": [
      5,
      5,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/shadow/shadow-small.png": [
      114,
      146,
      "png",
      "qx"
    ],
    "qx/decoration/Classic/shadow/shadow-t.png": [
      15,
      15,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/shadow/shadow-tl.png": [
      15,
      15,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/table/boolean-true.png": [
      11,
      11,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/table/descending-invert.png": [
      10,
      10,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/table/descending.png": [
      10,
      10,
      "png",
      "qx",
    ...
    "qx/decoration/Classic/table/select-column-order.png": [
      10,
      9,
      "png",
      "qx",
    ...
    "qx/decoration/Modern/arrows/down-invert.png": [
      ...
      "png",
      "qx",
      "qx/decoration/Modern/arrows-combined.png",
      -74,
      0
    ],
    ...
    "qx/decoration/Modern/cursors/alias.gif": [
      ...
      "gif",
      "qx",
      "qx/decoration/Modern/cursors-combined.gif",
      -52,
      0
    ],
    "qx/decoration/Modern/cursors/copy.gif": [
      19,
      15,
      "gif",
      "qx",
    ...
    "qx/decoration/Modern/cursors/move.gif": [
      13,
      9,
      "gif",
      "qx",
    ...
    "qx/decoration/Modern/cursors/nodrop.gif": [
      20,
      20,
      "gif",
      "qx",
    ...
    "qx/decoration/Modern/menu/checkbox-invert.gif": [
      ...
      "gif",
      "qx",
      "qx/decoration/Modern/menu-checkradio-combined.gif",
      -16,
      0
    ],
    ...
    "qx/decoration/Modern/scrollbar/scrollbar-down.png": [
      ...
      "png",
      "qx",
      "qx/decoration/Modern/scrollbar-combined.png",
      -28,
      0
    ],
    ...
    "qx/decoration/Modern/splitpane/knob-horizontal.png": [
      ...
      "png",
      "qx",
      "qx/decoration/Modern/splitpane-knobs-combined.png",
      0,
      -1
    ],
    ...
    "qx/decoration/Modern/table/ascending.png": [
      ...
      "png",
      "qx",
      "qx/decoration/Modern/table-combined.png",
      0,
      0
    ],
    ...
    "qx/decoration/Modern/tree/closed-selected.png": [
      ...
      "png",
      "qx",
      "qx/decoration/Modern/tree-combined.png",
      -24,
      0
    ],
    ...
    "qx/decoration/Modern/window/close-active-hovered.png": [
      ...
      "png",
      "qx",
      "qx/decoration/Modern/window-captionbar-buttons-combined.png",
      -27,
      0
    ],
    ...
    "qx/icon/Oxygen/16/mimetypes/text-plain.png": [
      16,
      16,
      "png",
      "qx"
    ...
    "qx/icon/Oxygen/16/places/folder.png": [
      16,
      16,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/22/mimetypes/office-document.png": [
      22,
      22,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/22/places/folder-open.png": [
      22,
      22,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/22/places/folder.png": [
      22,
      22,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/32/mimetypes/office-document.png": [
      32,
      32,
      "png",
      "qx"
    ...
    "qx/icon/Oxygen/48/devices/camera-photo.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/battery.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/camera-web.png": [
      48,
      48,
      "png",
      "qx"
    ...
    "qx/icon/Oxygen/48/devices/drive-harddisk.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/display.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/drive-optical.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/input-keyboard.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/media-flash.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/input-mouse.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/media-optical.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/multimedia-player.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/network-wired.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/network-wireless.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/pda.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/printer.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/scanner.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/devices/phone.png": [
      48,
      48,
      "png",
      "qx"
    ],
    "qx/icon/Oxygen/48/places/folder.png": [
      48,
      48,
      "png",
      "qx"
