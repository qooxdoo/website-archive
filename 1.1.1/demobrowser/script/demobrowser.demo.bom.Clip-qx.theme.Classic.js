...
qx.log.Logger.debug("Clip init: "+p.left+","+p.top+"  "+p.width+","+p.height);
},set0:function(){var m=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  120,40");
qx.bom.element.Clip.set(m,{left:20,top:20,width:120,height:40});
var n=qx.bom.element.Clip.get(m)||{};
qx.log.Logger.debug("Clip after: "+n.left+","+n.top+"  "+n.width+","+n.height);
},set1:function(){var i=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  null,40");
qx.bom.element.Clip.set(i,{left:20,top:20,height:40});
var j=qx.bom.element.Clip.get(i)||{};
qx.log.Logger.debug("Clip after: "+j.left+","+j.top+"  "+j.width+","+j.height);
},set2:function(){var e=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,20  120,null");
qx.bom.element.Clip.set(e,{left:20,top:20,width:120});
...
},set4:function(){var c=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,null  120,40");
qx.bom.element.Clip.set(c,{left:20,width:120,height:40});
