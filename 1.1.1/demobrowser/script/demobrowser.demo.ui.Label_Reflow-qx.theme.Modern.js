...
s.setRowFlex(0,1);
s.setSpacing(10);
var t=new qx.ui.container.Composite(s).set({backgroundColor:b,decorator:m,padding:10,allowGrowX:false,allowGrowY:false,allowStretchX:false,allowStretchY:false});
u.add(t);
this.getRoot().add(u,{edge:0});
var y=this.getPane();
t.add(y,{row:0,column:0,colSpan:3});
var w=new qx.ui.basic.Label(c).set({backgroundColor:j,decorator:m,padding:[4,8]});
t.add(w,{row:1,column:1});
var v=false;
w.addListener(k,function(){var n=y.getChildren()[0];
n.setValue(v?l:i);
v=!v;
});
var x=new qx.ui.basic.Label(a).set({backgroundColor:j,decorator:m,padding:[4,8]});
t.add(x,{row:1,column:2});
var z=false;
x.addListener(k,function(e){if(z){y.setWidth(600);
}else{y.setWidth(300);
}z=!z;
});
},getPane:function(){var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:g,width:600,decorator:m,padding:10});
var o=new qx.ui.basic.Label().set({rich:true,value:l});
r.add(o);
var p=new qx.ui.basic.Label().set({rich:true,value:f});
r.add(p);
var q=new qx.ui.basic.Label().set({rich:true,value:h});
r.add(q);
return r;
}}});
})();
