...
(function(){var n="main",m="green",l="yellow",k="middle",j="bottom",i="demobrowser.demo.layout.VBox",h="center",g="left",f="right";
...
var w=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(w);
w.add(this.getBox1());
w.add(this.getBox2());
w.add(this.getBox3());
...
w.add(this.getBox6());
w.add(this.getBox7());
},getBox1:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:n,backgroundColor:l,allowGrowY:false});
B.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
B.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
B.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
return B;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:n,backgroundColor:l,minWidth:60,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:40,alignX:g}));
o.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:40,alignX:h}));
o.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:40,alignX:f}));
return o;
},getBox3:function(){var C=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(C).set({decorator:n,backgroundColor:l,height:300,allowGrowY:false});
C.setSpacing(5);
C.setAlignY(j);
D.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
D.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
D.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
return D;
},getBox4:function(){var u=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(u).set({decorator:n,backgroundColor:l,height:300,allowGrowY:false});
u.setSpacing(5);
u.setAlignY(k);
v.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
v.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
v.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
return v;
},getBox5:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:n,backgroundColor:l,allowGrowY:false});
var A=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10});
var z=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10,marginTop:20});
var x=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10});
y.add(A);
y.add(z);
y.add(x);
return y;
},getBox6:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:n,backgroundColor:l,height:300,allowGrowY:false});
a.setSpacing(5);
a.setAlignY(j);
var e=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10});
var d=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10,marginTop:20});
var b=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10});
c.add(e);
c.add(d);
c.add(b);
return c;
},getBox7:function(){var p=new qx.ui.layout.VBox();
var r=new qx.ui.container.Composite(p).set({decorator:n,backgroundColor:l,height:300,allowGrowY:false});
p.setSpacing(5);
p.setAlignY(k);
var t=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10});
var s=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10,marginTop:20});
var q=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,marginBottom:10});
r.add(t);
r.add(s);
r.add(q);
return r;
