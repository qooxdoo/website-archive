...
var Y=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
Y.setPadding(20);
Y.setAllowStretchX(false);
ba.add(Y);
this.getRoot().add(ba,{edge:0});
Y.add(this.getTabView1());
Y.add(this.getTabView2());
Y.add(this.getTabView3());
...
C.add(D);
return C;
},getTabView2:function(){var W=new qx.ui.tabview.TabView();
W.setWidth(500);

for(var i=1;i<=20;i++){var X=new qx.ui.tabview.Page(l+i,h);
X.setLayout(new qx.ui.layout.VBox());
X.setShowCloseButton(true);
X.add(new qx.ui.basic.Label(l+i+n));
W.add(X);
}return W;
...
for(var i=1;i<=3;i++){var T=new qx.ui.tabview.Page(l+i,j);
T.setLayout(new qx.ui.layout.VBox(4));
K.add(T);
T.add(new qx.ui.basic.Label(l+i));
}var M=K.getChildren()[0];
var R=new qx.ui.basic.Label(w);
var P=new qx.ui.form.RadioButton(v);
var J=new qx.ui.form.RadioButton(d);
var O=new qx.ui.form.RadioButton(m);
var Q=new qx.ui.form.RadioButton(t);
...
S.addListener(z,function(e){this.setBarPosition(e.getData()[0].getLabel());
},K);
O.setValue(true);
...
M.add(N);
M.add(I);
L.addListener(k,function(e){var U=K.getChildren().length+1;
var V=new qx.ui.tabview.Page(l+U,j);
K.add(V);
});
N.addListener(k,function(e){var H=K.getChildren();

if(H.length>0){K.remove(H[0]);
}});
I.addListener(k,function(e){var bb=K.getChildren();

if(bb.length>0){K.remove(bb[bb.length-1]);
}});
return K;
}}});
})();
