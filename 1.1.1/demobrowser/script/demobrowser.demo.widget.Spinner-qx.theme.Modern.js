...
qx.Class.define(m,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(L,M){var N=new qx.ui.form.Spinner();
L.add(new qx.ui.basic.Label(f),{column:0,row:M});
L.add(new qx.ui.basic.Label(s),{column:1,row:M});
L.add(N,{column:2,row:M});
L.add(new qx.ui.basic.Label(q),{column:3,row:M});
N.addListener(b,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(x,y){var z=new qx.ui.form.Spinner(0,50,100);
z.setEditable(false);
x.add(new qx.ui.basic.Label(n),{column:0,row:y});
x.add(new qx.ui.basic.Label(s),{column:1,row:y});
x.add(z,{column:2,row:y});
x.add(new qx.ui.basic.Label(q),{column:3,row:y});
},addWrappingSpinner:function(D,E){var F=new qx.ui.form.Spinner(-30,30,30);
F.setWrap(true);
D.add(new qx.ui.basic.Label(k),{column:0,row:E});
D.add(new qx.ui.basic.Label(a),{column:1,row:E});
D.add(F,{column:2,row:E});
D.add(new qx.ui.basic.Label(c),{column:3,row:E});
},addSteppedSpinner:function(A,B){var C=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
A.add(new qx.ui.basic.Label(l),{column:0,row:B});
A.add(new qx.ui.basic.Label(j),{column:1,row:B});
...
H.setColumnAlign(0,p,r);
H.setColumnAlign(1,h,r);
H.setColumnAlign(2,p,r);
H.setColumnAlign(3,p,r);
