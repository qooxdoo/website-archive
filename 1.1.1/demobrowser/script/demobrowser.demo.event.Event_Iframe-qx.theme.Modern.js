...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.Event_Iframe","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.Event_Iframe-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"139c9815cb17"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var n="click",m="iframe",l="scroll",k="inner",j="div",h="juhu",g="contextmenu",f="input",d="load",c="keydown",a="demobrowser.demo.event.Event_Iframe",b="data/Event_2_frame.html";
qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var p=qx.bom.Iframe.create({name:m,src:b});
p.id=m;
document.body.appendChild(p);
qx.event.Registration.addListener(p,d,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var t=window.document.getElementById(m);
var s=qx.bom.Iframe.getDocument(t);
this._juhu=s.getElementById(h);
this._inner=s.getElementById(k);
qx.event.Registration.addListener(this._juhu,g,this._preventDefault,this);
qx.event.Registration.addListener(this._inner,n,this._stopPropagation,this);
qx.event.Registration.addListener(this._juhu,n,this._onclick1,this);
qx.event.Registration.addListener(this._juhu,n,this._onclick2,this);
qx.event.Registration.addListener(s.getElementById(f),c,this._onkeydown,this);

for(var i=1;i<10;i++){var r=s.getElementById(j+i);
qx.event.Registration.addListener(r,n,this._cascadeCapture,this,true);
qx.event.Registration.addListener(r,n,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(s.getElementById(l),l,this._scroll,this);
},_onkeydown:function(e){this.debug("keydown: "+e.getKeyIdentifier());
},_scroll:function(e){this.debug("scroll");
},_cascadeCapture:function(e){var q=e.getCurrentTarget();
this.debug("capture: "+q.id+" "+e.getEventPhase());
},_cascadeBubble:function(e){var o=e.getCurrentTarget();
this.debug("bubble: "+o.id+" "+e.getEventPhase());
},_preventDefault:function(e){this.debug(e.getType()+": "+e);
e.preventDefault();
},_stopPropagation:function(e){this.debug(e.getType()+" (inner): "+e);
e.stopPropagation();
},_onclick1:function(e){this.debug(e.getType()+" 1: "+e);
qx.event.Registration.removeListener(this._juhu,n,this._onclick1);
},_onclick2:function(e){this.debug(e.getType()+" 2: "+e);
