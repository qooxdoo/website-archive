...
(function(){var o="",n="Hello",m="icon/16/actions/go-down.png",l="World",k="bold",j="Juhu",h="</div>",g="waiting",f="icon/16/actions/go-next.png",e="http://resources.qooxdoo.org/images/logo.gif",S="$ ",R="string",Q="border: 1px dotted green",P="inactive",O="decoration",N="multi<br>line",M="between",L="<",K="<div style='position:absolute;height:20px;width:",J="px;top:",v="qx/decoration/Modern",w="icon/16/actions/go-previous.png",t="icon",u="number",r="px'>",s="<i>italic</i>",p="0$",q="qx/icon/Tango",x="<b>bold</b>",y="icon/16/actions/go-up.png",B="boolean",A="demobrowser.demo.test.Table_CellRenderer",D="tooltip",C="red",F="icon/16/emotes/face-sad.png",E="icon/16/emotes/face-smile.png",z="left",I=">=",H="active",G="object";
qx.Class.define(A,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(O,v);
qx.util.AliasManager.getInstance().add(t,q);
},__La:function(ci,top,cj,ck,cl){var cm=[K,cj,J,top,r];
ck.createDataCellHtml(cl,cm);
cm.push(h);
ci.innerHTML+=cm.join(o);
},testDefaultRenderer:function(bX){var bY=100;
var cb={value:[null,j,32,new Date()],styleLeft:[0],styleWidth:[bY],styleHeight:[20],style:[o]};
var ca=this._getNewTableDiv(bY);
var top=0;
qx.util.Permutation.permute(cb,function(bK){this.__La(ca,top,bY,bX,bK);
top+=20;
},this);
},testBooleanRenderer:function(){var bV=70;
var bU=30;
var bW=new qx.ui.table.cellrenderer.Boolean();
var bS={value:[null,true,false],styleLeft:[0],styleWidth:[bV],styleHeight:[bU],style:[o]};
var bT=this._getNewTableDiv(bV);
var top=0;
qx.util.Permutation.permute(bS,function(bm){this.__La(bT,top,bV,bW,bm);
top+=bU;
},this);
bW.setIconFalse(F);
bW.setIconTrue(E);
qx.util.Permutation.permute(bS,function(cc){this.__La(bT,top,bV,bW,cc);
top+=bU;
},this);
},testDateRenderer:function(){var bq=180;
var br=new qx.ui.table.cellrenderer.Date();
var bt={value:new Date(),styleLeft:[0],styleWidth:[bq],styleHeight:[20],style:[o]};
var bp=qx.util.format.DateFormat;
var bs=[bp.getDateTimeInstance(),bp.getDateInstance()];
var bn=this._getNewTableDiv(bq);
var top=0;

for(var i=0;i<bs.length;i++){var bo=bs[i];
br.setDateFormat(bo);
this.__La(bn,top,bq,br,bt);
top+=20;
}},testNumberRenderer:function(){var by=new qx.ui.table.cellrenderer.Number();
var bx=100;
var bA={value:Math.PI,styleLeft:[0],styleWidth:[bx],styleHeight:[20],style:[o]};
var bw=qx.util.format.NumberFormat;
var bz=[bw.getIntegerInstance(),new bw().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:S})];
var bu=this._getNewTableDiv(bx);
var top=0;

for(var i=0;i<bz.length;i++){var bv=bz[i];
by.setNumberFormat(bv);
this.__La(bu,top,bx,by,bA);
top+=20;
}},testImageRenderer:function(){var c=new qx.ui.table.cellrenderer.Image();
var a=50;
var d={value:[null,m,y,w,f,e],styleLeft:[0],styleWidth:[a],styleHeight:[20],style:[o],tooltip:[o,D]};
var b=this._getNewTableDiv(a);
var top=0;
qx.util.Permutation.permute(d,function(bQ){this.__La(b,top,a,c,bQ);
top+=20;
},this);
},testStringRenderer:function(){var ch=new qx.ui.table.cellrenderer.String();
var cg=100;
var cf=20;
var cd={value:[null,n,l],styleLeft:[0],styleWidth:[cg],styleHeight:[cf],style:[o]};
var ce=this._getNewTableDiv(cg);
var top=0;
qx.util.Permutation.permute(cd,function(bR){this.__La(ce,top,cg,ch,bR);
top+=20;
},this);
},testPasswordRenderer:function(){var bP=new qx.ui.table.cellrenderer.Password();
var bO=100;
var bN=20;
var bL={value:[null,n,l],styleLeft:[0],styleWidth:[bO],styleHeight:[bN],style:[o]};
var bM=this._getNewTableDiv(bO);
var top=0;
qx.util.Permutation.permute(bL,function(bJ){this.__La(bM,top,bO,bP,bJ);
top+=20;
},this);
},testHtmlRenderer:function(){var bl=new qx.ui.table.cellrenderer.Html();
var bk=100;
var bj=50;
var bh={value:[null,x,s,N],styleLeft:[0],styleWidth:[bk],styleHeight:[bj],style:[o]};
var bi=this._getNewTableDiv(bk);
var top=0;
qx.util.Permutation.permute(bh,function(T){this.__La(bi,top,bk,bl,T);
top+=20;
},this);
},testConditionalRenderer:function(){var bI=new qx.ui.table.cellrenderer.Conditional();
bI.addNumericCondition(L,0,null,C,null,null);
bI.addNumericCondition(I,100,z,null,null,null);
bI.addBetweenCondition(M,0,2,null,null,null,k,null);
bI.addRegex(p,null,null,k,Q);
var bH=100;
var bG=20;
var bE={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bH],table:[this.tableMock],styleHeight:[bG],style:[o]};
var bF=this._getNewTableDiv(bH);
var top=0;
qx.util.Permutation.permute(bE,function(cn){this.__La(bF,top,bH,bI,cn);
top+=20;
},this);
},testDynamicRenderer:function(){var Y=new qx.ui.table.cellrenderer.Dynamic();
Y.setCellRendererFactoryFunction(function(bB){var bD=bB.value;
var bC=qx.ui.table.cellrenderer;

switch(typeof bD){case R:if(bD.match(/^icon\//)){return new bC.Image();
}else{return new bC.String();
}case B:return new bC.Boolean();
case u:return new bC.Number();
case G:if(bD instanceof Date){return new bC.Date();
}return new bC.Default();
}});
var X=100;
var W=20;
var U={value:[null,j,new Date(),30,m,false],styleLeft:[0],styleWidth:[X],styleHeight:[W],table:[this.tableMock],style:[o]};
var V=this._getNewTableDiv(X);
var top=0;
qx.util.Permutation.permute(U,function(ba){this.__La(V,top,X,Y,ba);
top+=20;
},this);
},testReplaceRenderer:function(){var bf=new qx.ui.table.cellrenderer.Replace();
bf.setReplaceMap({1:H,2:P,3:g});
bf.addReversedReplaceMap();
var be=100;
var bd=20;
var bb={value:[1,2,3],styleLeft:[0],styleWidth:[be],table:[this.tableMock],styleHeight:[bd],style:[o]};
var bc=this._getNewTableDiv(be);
var top=0;
qx.util.Permutation.permute(bb,function(bg){this.__La(bc,top,be,bf,bg);
top+=20;
},this);
...
qx.Class.define(o,{extend:qx.ui.table.cellrenderer.Default,construct:function(bc,bd,be,bf){qx.ui.table.cellrenderer.Default.call(this);
...
this.__wK=be||B;
this.__wL=bf||B;
},members:{__wI:null,__wJ:null,__wK:null,__wL:null,__wM:function(R,S){if(R[1]!=null){S[p]=R[1];
}
if(R[2]!=null){S[n]=R[2];
}
if(R[3]!=null){S[q]=R[3];
...
if(R[4]!=null){S[m]=R[4];
}},addNumericCondition:function(J,K,L,M,N,O,P){var Q=null;

if(qx.lang.Array.contains(this.numericAllowed,J)){if(K!=null){Q=[J,L,M,N,O,K,P];
}}
if(Q!=null){this.conditions.push(Q);
...
}},addRegex:function(C,D,E,F,G,H){if(C!=null){var I=[w,D,E,F,G,C,H];
}
if(I!=null){this.conditions.push(I);
}else{throw new Error("regex cannot be null!");
}},_getCellStyle:function(T){if(!this.conditions.length){return T.style||B;
}var Y=T.table.getTableModel();
var i;
var bb;
var U;
var W={"text-align":this.__wI,"color":this.__wJ,"font-style":this.__wK,"font-weight":this.__wL};
...
switch(this.conditions[i][0]){case A:if(U==this.conditions[i][5]){bb=true;
}break;
case t:if(U!=this.conditions[i][5]){bb=true;
}break;
case z:if(U>this.conditions[i][5]){bb=true;
}break;
case x:if(U<this.conditions[i][5]){bb=true;
}break;
case u:if(U>=this.conditions[i][5]){bb=true;
}break;
case s:if(U<=this.conditions[i][5]){bb=true;
}break;
...
switch(this.conditions[i][0]){case y:if(U>=this.conditions[i][5]&&U<=this.conditions[i][6]){bb=true;
}break;
case v:if(U<this.conditions[i][5]&&U>this.conditions[i][6]){bb=true;
}break;
}}else if(this.conditions[i][0]==w){if(this.conditions[i][6]==null){U=T.value;
}else{U=Y.getValueById(this.conditions[i][6],T.row);
}var V=new RegExp(this.conditions[i][5],l);
bb=V.test(U);
}if(bb==true){this.__wM(this.conditions[i],W);
}}var ba=[];

for(var X in W){if(W[X]){ba.push(X,k,W[X],r);
}}return ba.join(B);
