...
qx.util.Permutation.permute(p,function(n){var o=r.createHeaderCell(n);
q.add(o);
r.updateHeaderCell(n,o);
});
},testIconRenderer:function(){var m=new qx.ui.table.headerrenderer.Icon(f);
m.setToolTip(g);
...
qx.util.Permutation.permute(k,function(s){var t=m.createHeaderCell(s);
l.add(t);
m.updateHeaderCell(s,t);
});
