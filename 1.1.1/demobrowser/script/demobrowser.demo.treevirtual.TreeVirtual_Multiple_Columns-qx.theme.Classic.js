...
var V=new qx.ui.treevirtual.TreeVirtual([n,h,J]);
V.set({width:400});
V.setAlwaysShowOpenCloseSymbol(true);
var U=V.getTableColumnModel().getBehavior();
U.set(0,{width:M,minWidth:180});
bc.add(V);
var bb=V.getDataModel();
var X=bb.addBranch(null,c,true);
V.nodeSetLabelStyle(X,v+P+O);
var T;
bb.addBranch(X,G,true);
T=bb.addBranch(X,s,true);
var ba=bb.addLeaf(T,f);
bb.setColumnData(ba,1,j);
bb.setColumnData(ba,2,l);
ba=bb.addLeaf(T,g);
bb.setColumnData(ba,1,j);
bb.setColumnData(ba,2,l);
bb.addBranch(X,L,true);
ba=bb.addBranch(X,k,true);
V.nodeSetCellStyle(ba,w);
var Y=bb.addBranch(null,d,true);
ba=bb.addBranch(Y,p,false);

for(var i=1;i<3000;i++){bb.addLeaf(ba,D+i);
}bb.addBranch(Y,H,false);
bb.addBranch(Y,k,false);
bb.addBranch(Y,x,false);
bb.addBranch(Y,F,false);
bb.setData();
var W=new qx.ui.groupbox.GroupBox(K);
...
V.addListener(I,function(e){var R=e.getData();
this.setValue(V.getHierarchy(R[0].nodeId).join(C));
S.setEnabled(true);
},o);
var S=new qx.ui.form.Button(q);
S.set({enabled:false});
W.add(S,{top:50,left:0});
S.addListener(b,function(e){var a=V.getSelectedNodes();

for(var i=0;i<a.length;i++){bb.prune(a[i].nodeId,true);
bb.setData();
}});
o=new qx.ui.form.CheckBox(y);
o.set({value:true});
W.add(o,{top:80,left:0});
o.addListener(m,function(e){V.setUseTreeLines(e.getData());
});
o=new qx.ui.form.CheckBox(E);
o.set({value:false});
W.add(o,{top:100,left:0});
o.addListener(m,function(e){V.setExcludeFirstLevelTreeLines(e.getData());
});
o=new qx.ui.form.CheckBox(A);
o.set({value:true});
W.add(o,{top:120,left:0});
o.addListener(m,function(e){V.setAlwaysShowOpenCloseSymbol(e.getData());
});
o=new qx.ui.form.CheckBox(B);
o.set({value:true});
W.add(o,{top:140,left:0});
V.addListener(r,function(e){if(this.getValue()){var Q=e.getData();
V.nodeSetHideOpenClose(Q,true);
}},o);
o=new qx.ui.form.CheckBox(t);
o.set({value:false});
W.add(o,{top:160,left:0});
o.addListener(m,function(e){V.setOpenCloseClickSelectsRow(e.getData());
});
o=new qx.ui.form.CheckBox(N);
o.set({value:false});
W.add(o,{top:180,left:0});
o.addListener(m,function(e){V.setEnabled(!e.getData());
});
}}});
})();
