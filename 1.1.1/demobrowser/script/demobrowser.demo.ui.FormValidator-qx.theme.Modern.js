...
var D=new qx.ui.form.validation.AsyncValidator(function(s,t){window.setTimeout(function(){if(t==null||t.length==0){s.setValid(false,i);
...
C.add(z,A);
C.add(F);
C.setValidator(function(p){var r=y.getValue()==z.getValue();

if(!r){var q=h;
y.setInvalidMessage(q);
z.setInvalidMessage(q);
y.setValid(false);
z.setValid(false);
}return r;
});
