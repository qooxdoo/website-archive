...
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return a;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,minWidth:60,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:e}));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
return o;
