...
(function(){var ba="execute",Y="appear",X="changeSelection",W="Trash",V="mode",U="Windows (C:)",T="Documents (D:)",S="Add before",R="Add after",Q="Add at begin",bA="Inbox",bz="Desktop",by="Show open button:",bx="New tree item name: ",bw="auto",bv="Hello",bu="Presets",bt="Data 123213234325345234523453453245",bs="demobrowser.demo.animation.Tree_Highlight",br="Network",bh="Control",bi="Sent",bf="Files",bg="Remove tree item",bd="Add file",be="Workspace",bb="Junk #",bc="Tree",bj="never",bk="Add folder",bm="Root",bl="always",bo="Move to parent",bn="Reset tree",bq="Edit",bp="Remove all children";
qx.Class.define(bs,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);
...
var k=new qx.ui.groupbox.GroupBox(bc).set({contentPadding:[4,4,4,4]});
k.setLayout(new qx.ui.layout.Canvas());
this._container.add(k);
this._treeGroup=k;
var l=this.getTree();
k.add(l,{edge:0});
this._tree=l;
this._container.add(this.getCommandFrame());
},getTree:function(){var G=new qx.ui.tree.Tree().set({width:200,height:400});
var L=new qx.ui.tree.TreeFolder(bm);
L.setOpen(true);
G.setRoot(L);
var J=new qx.ui.tree.TreeFolder(bz);
J.setOpen(true);
L.add(J);
var B=new qx.ui.tree.TreeFolder(bf);
var z=new qx.ui.tree.TreeFolder(be);
var A=new qx.ui.tree.TreeFolder(br);
var y=new qx.ui.tree.TreeFolder(W);
J.add(B,z,A,y);
var H=new qx.ui.tree.TreeFile(U);
var x=new qx.ui.tree.TreeFile(T);
z.add(H,x);
var K=new qx.ui.tree.TreeFolder(bA);
var C=new qx.ui.tree.TreeFolder(bu);
var F=new qx.ui.tree.TreeFolder(bi);
var E=new qx.ui.tree.TreeFolder(W);

for(var i=0;i<100;i++){E.add(new qx.ui.tree.TreeFile(bb+i));
}var I=new qx.ui.tree.TreeFolder(bt);
var D=new qx.ui.tree.TreeFolder(bq);
K.add(C,F,E,I,D);
L.add(K);
return G;
},getCommandFrame:function(){var o=new qx.ui.groupbox.GroupBox(bh);
o.setLayout(new qx.ui.layout.Grid(3,5));
var q=0;
o.add(new qx.ui.basic.Label(bx).set({paddingTop:4}),{row:q,column:0});
this.inputItemName=new qx.ui.form.TextField(bv);
o.add(this.inputItemName,{row:q++,column:1});
this.btnAddFolder=new qx.ui.form.Button(bk);
this.btnAddFolder.addListener(ba,this._addFolder,this);
o.add(this.btnAddFolder,{row:q++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(bd);
this.btnAddFile.addListener(ba,this._addFile,this);
o.add(this.btnAddFile,{row:q++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(R);
this.btnAddAfter.addListener(ba,this._addAfter,this);
o.add(this.btnAddAfter,{row:q++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(S);
this.btnAddBefore.addListener(ba,this._addBefore,this);
o.add(this.btnAddBefore,{row:q++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(Q);
this.btnAddBegin.addListener(ba,this._addBegin,this);
o.add(this.btnAddBegin,{row:q++,column:0,colSpan:2});
o.add(new qx.ui.core.Spacer(5,5),{row:q++,column:0});
this.btnRemove=new qx.ui.form.Button(bg);
this.btnRemove.addListener(ba,this._removeTreeItem,this);
o.add(this.btnRemove,{row:q++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(bp);
this.btnRemoveAll.addListener(ba,this._removeAll,this);
o.add(this.btnRemoveAll,{row:q++,column:0,colSpan:2});
o.add(new qx.ui.core.Spacer(5,5),{row:q++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(bo);
this.btnMoveToParent.addListener(ba,this._moveToParent,this);
o.add(this.btnMoveToParent,{row:q++,column:0,colSpan:2});
o.add(new qx.ui.core.Spacer(5,5),{row:q++,column:0});
o.add(new qx.ui.basic.Label(by),{row:q,column:0});
var m=[bl,bj,bw];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<m.length;i++){var p=m[i];
var n=new qx.ui.form.RadioButton(p).set({value:p==this._tree.getRootOpenClose()});
n.setUserData(V,p);
this.showOpenButtons[p]=n;
this.mgrShowRootOpen.add(n);
o.add(n,{row:q++,column:1});
}this.mgrShowRootOpen.addListener(X,this._onChangeShowOpen,this);
o.add(new qx.ui.core.Spacer(5,5),{row:q++,column:0});
this.btnReset=new qx.ui.form.Button(bn);
this.btnReset.addListener(ba,this._resetTree,this);
o.add(this.btnReset,{row:q++,column:0,colSpan:2});
this._tree.addListener(X,this._updateControls,this);
this._updateControls();
return o;
},_addFolder:function(){var bD=this._tree.getSelection()[0];
var bE=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
bE.addListenerOnce(Y,function(){var M=new qx.fx.effect.core.Highlight(bE.getContainerElement().getDomElement());
M.start();
},this);
bD.setOpen(true);
bD.add(bE);
},_addFile:function(){var v=this._tree.getSelection()[0];
var w=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
w.addListenerOnce(Y,function(){var c=new qx.fx.effect.core.Highlight(w.getContainerElement().getDomElement());
c.start();
},this);
v.setOpen(true);
v.add(w);
...
b.addListenerOnce(Y,function(){var N=new qx.fx.effect.core.Highlight(b.getContainerElement().getDomElement());
N.start();
},this);
a.getParent().addBefore(b,a);
},_addAfter:function(){var O=this._tree.getSelection()[0];
var P=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
P.addListenerOnce(Y,function(){var bF=new qx.fx.effect.core.Highlight(P.getContainerElement().getDomElement());
bF.start();
},this);
O.getParent().addAfter(P,O);
},_addBegin:function(){var bB=this._tree.getSelection()[0];
var bC=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bC.addListenerOnce(Y,function(){var e=new qx.fx.effect.core.Highlight(bC.getContainerElement().getDomElement());
e.start();
},this);
bB.getParent().addAtBegin(bC);
},_removeTreeItem:function(){var u=this._tree.getSelection()[0];
var parent=u.getParent();
parent.remove(u);
},_removeAll:function(){var d=this._tree.getSelection()[0];
d.removeAll();
...
this._updateControls();
},_onChangeShowOpen:function(){var s=this._tree.getSelection()[0];

if(s!=null){var t=this.mgrShowRootOpen.getSelection()[0].getUserData(V);
s.setOpenSymbolMode(t);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(Y,function(){this._tree.addListener(X,this._updateControls,this);
},this);
},_updateControls:function(){var f=this._tree.getSelection()[0];

if(!f){this.btnAddFolder.setEnabled(false);
...
var g=j==-1;
var h=f instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(h);
this.btnAddFile.setEnabled(h);
this.btnAddBefore.setEnabled(!g);
this.btnAddAfter.setEnabled(!g);
this.btnAddBegin.setEnabled(!g);
this.btnRemove.setEnabled(!g);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(h);
this.showOpenButtons[f.getOpenSymbolMode()].setValue(true);
