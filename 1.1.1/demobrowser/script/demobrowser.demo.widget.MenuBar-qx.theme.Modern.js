...
dr.add(menubar);
var dq=new qx.ui.menubar.Button(s,null,this.getFileMenu());
var dp=new qx.ui.menubar.Button(bt,null,this.getEditMenu());
var ds=new qx.ui.menubar.Button(bN,null,this.getSearchMenu());
var dv=new qx.ui.menubar.Button(bl,null,this.getViewMenu());
var du=new qx.ui.menubar.Button(v,null,this.getFormatMenu());
var dt=new qx.ui.menubar.Button(bK,null,this.getHelpMenu());
menubar.add(dq);
menubar.add(dp);
menubar.add(ds);
menubar.add(dv);
...
var cL=new qx.ui.menu.Button(bD,G,this._newCommand);
var cP=new qx.ui.menu.Button(U,bu,this._openCommand);
var cO=new qx.ui.menu.Button(bp);
var cS=new qx.ui.menu.Button(bV,Y,this._saveCommand);
var cR=new qx.ui.menu.Button(bi,bo);
var cQ=new qx.ui.menu.Button(X,bv);
var cM=new qx.ui.menu.Button(bc,bS);
...
var f=new qx.ui.menu.Button(by,bw,this._undoCommand);
var d=new qx.ui.menu.Button(bI,u,this._redoCommand);
var a=new qx.ui.menu.Button(be,bC,this._cutCommand);
var g=new qx.ui.menu.Button(J,ba,this._copyCommand);
var c=new qx.ui.menu.Button(K,B,this._pasteCommand);
f.addListener(bH,this.debugButton);
d.addListener(bH,this.debugButton);
a.addListener(bH,this.debugButton);
g.addListener(bH,this.debugButton);
c.addListener(bH,this.debugButton);
b.add(f);
b.add(d);
b.addSeparator();
b.add(a);
...
b.add(c);
return b;
},getSearchMenu:function(){var cg=new qx.ui.menu.Menu;
var ce=new qx.ui.menu.Button(bb,bF);
var cj=new qx.ui.menu.Button(bW);
var cf=new qx.ui.menu.Button(bg);
var ci=new qx.ui.menu.Button(D);
var cd=new qx.ui.menu.Button(bB,bF);
var ch=new qx.ui.menu.Button(cb);
cf.setEnabled(false);
ce.addListener(bH,this.debugButton);
cj.addListener(bH,this.debugButton);
...
cg.add(ch);
return cg;
},getViewMenu:function(){var cT=new qx.ui.menu.Menu;
var cV=new qx.ui.menu.Button(M,null,null,this.getPanesMenu());
var cY=new qx.ui.menu.Button(I,null,null,this.getSyntaxMenu());
var cX=new qx.ui.menu.CheckBox(Q);
var cW=new qx.ui.menu.CheckBox(bh);
var cU=new qx.ui.menu.Button(E);
cX.addListener(bG,this.debugCheckBox);
cW.addListener(bG,this.debugCheckBox);
...
cT.add(cU);
return cT;
},getPanesMenu:function(){var db=new qx.ui.menu.Menu;
var dd=new qx.ui.menu.CheckBox(r);
var df=new qx.ui.menu.CheckBox(bJ);
var dg=new qx.ui.menu.CheckBox(j);
var dc=new qx.ui.menu.CheckBox(P);
var de=new qx.ui.menu.CheckBox(t);
var da=new qx.ui.menu.CheckBox(bM);
dd.setValue(true);
df.setValue(true);
dc.setValue(true);
dd.addListener(bG,this.debugCheckBox);
df.addListener(bG,this.debugCheckBox);
dg.addListener(bG,this.debugCheckBox);
dc.addListener(bG,this.debugCheckBox);
de.addListener(bG,this.debugCheckBox);
da.addListener(bG,this.debugCheckBox);
db.add(df);
db.add(dd);
db.addSeparator();
db.add(dg);
...
db.add(da);
return db;
},getSyntaxMenu:function(){var ct=new qx.ui.menu.Menu;
var cp=new qx.ui.menu.RadioButton(C);
var cr=new qx.ui.menu.RadioButton(q);
var cq=new qx.ui.menu.RadioButton(n);
var cs=new qx.ui.menu.Button(bk,null,null,this.getSyntaxCMenu());
var cw=new qx.ui.menu.RadioButton(N);
var cu=new qx.ui.menu.RadioButton(h);
ct.add(cp);
ct.add(cr);
ct.add(cq);
ct.add(cs);
ct.add(cw);
ct.add(cu);
var cv=new qx.ui.form.RadioGroup;
cv.add(cp,cr,cq,cw,cu);
cv.add.apply(cv,cs.getMenu().getChildren());
cv.addListener(bj,this.debugRadio);
return ct;
},getSyntaxCMenu:function(){var cl=new qx.ui.menu.Menu;
var ck=new qx.ui.menu.RadioButton(bP);
var co=new qx.ui.menu.RadioButton(bx);
var cn=new qx.ui.menu.RadioButton(W);
var cm=new qx.ui.menu.RadioButton(ca);
cl.add(ck);
cl.add(co);
cl.add(cn);
cl.add(cm);
return cl;
},getFormatMenu:function(){var cF=new qx.ui.menu.Menu;
var cE=new qx.ui.menu.Button(bq,null,null,this.getParagraphMenu());
var cH=new qx.ui.menu.Button(F);
var cI=new qx.ui.menu.Button(k);
var cD=new qx.ui.menu.Button(bm);
var cG=new qx.ui.menu.Button(bX);
var cC=new qx.ui.menu.Button(bT);
var cK=new qx.ui.menu.Button(m);
var cJ=new qx.ui.menu.Button(bR);
cH.addListener(bH,this.debugButton);
cI.addListener(bH,this.debugButton);
cD.addListener(bH,this.debugButton);
cG.addListener(bH,this.debugButton);
cC.addListener(bH,this.debugButton);
...
cF.add(cJ);
return cF;
},getParagraphMenu:function(){var cx=new qx.ui.menu.Menu;
var cA=new qx.ui.menu.Button(bz,bQ);
var cB=new qx.ui.menu.Button(l,x);
var cy=new qx.ui.menu.Button(br,T);
var cz=new qx.ui.menu.Button(R,bA);
cA.addListener(bH,this.debugButton);
cB.addListener(bH,this.debugButton);
cy.addListener(bH,this.debugButton);
cz.addListener(bH,this.debugButton);
cx.add(cA);
cx.add(cB);
cx.add(cy);
cx.add(cz);
return cx;
},getHelpMenu:function(){var dj=new qx.ui.menu.Menu;
var dl=new qx.ui.menu.Button(L,i);
var dn=new qx.ui.menu.Button(bf);
var dm=new qx.ui.menu.Button(bE);
