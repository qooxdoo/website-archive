...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HSplit","qx.theme":"qx.theme.Modern"};
...
(function(){var p="horizontal",o="main",n="Flex:1",m="Flex:1; Min:250",l="Auto",k="Flex:2",j="Flex:0",i="Flex:2; Max:100",h="Flex:1; Max:100",g="Flex:1; Max:200",d="Flex:2; Min:250",f="Flex:0; Min:350",e="demobrowser.demo.layout.HSplit";
...
},addSplitPaneTwoFlexSimple:function(){var J=new qx.ui.splitpane.Pane(p);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(o);
this.getRoot().add(J,{left:20,top:20});
var I=new qx.ui.form.TextArea(n);
I.setDecorator(null);
I.setWrap(true);
J.add(I,1);
...
K.setWrap(true);
J.add(K,2);
},addSplitPaneTwoFlexWithOneMin:function(){var r=new qx.ui.splitpane.Pane(p);
r.setWidth(400);
r.setHeight(60);
r.setDecorator(o);
this.getRoot().add(r,{left:20,top:100});
var q=new qx.ui.form.TextArea(m);
q.setDecorator(null);
q.setWrap(true);
q.setMinWidth(250);
r.add(q,1);
var s=new qx.ui.form.TextArea(k);
s.setDecorator(null);
s.setWrap(true);
r.add(s,2);
},addSplitPaneTwoFlexWithOneMax:function(){var M=new qx.ui.splitpane.Pane(p);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(o);
this.getRoot().add(M,{left:20,top:180});
var L=new qx.ui.form.TextArea(n);
L.setDecorator(null);
L.setWrap(true);
M.add(L,1);
...
N.setMaxWidth(100);
M.add(N,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var u=new qx.ui.splitpane.Pane(p);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(o);
this.getRoot().add(u,{left:20,top:260});
var t=new qx.ui.form.TextArea(m);
t.setDecorator(null);
t.setWrap(true);
t.setMinWidth(250);
u.add(t,1);
var v=new qx.ui.form.TextArea(d);
v.setDecorator(null);
v.setWrap(true);
v.setMinWidth(250);
u.add(v,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var b=new qx.ui.splitpane.Pane(p);
b.setWidth(400);
b.setHeight(60);
b.setDecorator(o);
this.getRoot().add(b,{left:20,top:340});
var a=new qx.ui.form.TextArea(h);
a.setDecorator(null);
a.setWrap(true);
a.setMaxWidth(100);
b.add(a,1);
var c=new qx.ui.form.TextArea(i);
c.setDecorator(null);
c.setWrap(true);
c.setMaxWidth(100);
b.add(c,2);
},addSplitPaneOneFlexSimple:function(){var A=new qx.ui.splitpane.Pane(p);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(o);
this.getRoot().add(A,{left:500,top:20});
var z=new qx.ui.form.TextArea(j);
z.setDecorator(null);
z.setWrap(true);
A.add(z,0);
var B=new qx.ui.form.TextArea(n);
B.setDecorator(null);
B.setWrap(true);
A.add(B);
},addSplitPaneOneFlexSimpleWithMax:function(){var G=new qx.ui.splitpane.Pane(p);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(o);
...
F.setWrap(true);
G.add(F,0);
var H=new qx.ui.form.TextArea(g);
H.setDecorator(null);
H.setWrap(true);
H.setMaxWidth(200);
G.add(H);
},addSplitPaneOneFlexSimpleWithMin:function(){var x=new qx.ui.splitpane.Pane(p);
x.setWidth(400);
x.setHeight(60);
x.setDecorator(o);
this.getRoot().add(x,{left:500,top:180});
var w=new qx.ui.form.TextArea(f);
w.setDecorator(null);
w.setWrap(true);
w.setMinWidth(350);
x.add(w,0);
var y=new qx.ui.form.TextArea(n);
y.setDecorator(null);
y.setWrap(true);
x.add(y);
},addSplitPaneAuto:function(){var D=new qx.ui.splitpane.Pane(p);
D.setDecorator(o);
this.getRoot().add(D,{left:500,top:340});
