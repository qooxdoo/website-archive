...
(function(){var r="execute",q="-",p="+",o="/",n="*",m="=",l=".",k="black",j="Del",i="sans-serif",N="C",M="5",L="7",K="demobrowser.demo.showcase.Calculator",J="CE",I="__ML",H="solid",G="icon/22/apps/utilities-calculator.png",F="3",E="0",y="n",z="8",w="__MK",x="6",u="4",v="Calculator",s="2",t="Verdana",A="1",B="demobrowser.demo.showcase.CalculatorLogic",D="+/-",C="9";
qx.Class.define(K,{extend:qx.application.Standalone,members:{__MK:null,__ML:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__ML=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var P=new qx.ui.window.Window(v,G);
P.setLayout(new qx.ui.layout.VBox(16));
var R=new qx.ui.decoration.Single(1,H,k);
...
ba.setLayout(bk);
this.__MK=new qx.ui.basic.Label(this.__ML.getCurrentValue().toString()).set({decorator:R,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__MK.setEnabled(false);
var bl=new qx.bom.Font().set({size:14,family:[t,i],bold:true});
var bf=new qx.ui.form.Button(E).set({font:bl,minWidth:40});
var be=new qx.ui.form.Button(A).set({font:bl,minWidth:40});
var bd=new qx.ui.form.Button(s).set({font:bl,minWidth:40});
var bc=new qx.ui.form.Button(F).set({font:bl,minWidth:40});
var bj=new qx.ui.form.Button(u).set({font:bl,minWidth:40});
var bi=new qx.ui.form.Button(M).set({font:bl,minWidth:40});
var bh=new qx.ui.form.Button(x).set({font:bl,minWidth:40});
var bg=new qx.ui.form.Button(L).set({font:bl,minWidth:40});
var bn=new qx.ui.form.Button(z).set({font:bl,minWidth:40});
var bm=new qx.ui.form.Button(C).set({font:bl,minWidth:40});
var O=new qx.ui.form.Button(N).set({font:bl,minWidth:40});
var Q=new qx.ui.form.Button(J).set({font:bl,minWidth:40});
var V=new qx.ui.form.Button(j).set({font:bl,minWidth:40});
var U=new qx.ui.form.Button(D).set({font:bl,minWidth:40});
var X=new qx.ui.form.Button(l).set({font:bl,minWidth:40});
var T=new qx.ui.form.Button(p).set({font:bl,minWidth:40});
var bb=new qx.ui.form.Button(q).set({font:bl,minWidth:40});
var Y=new qx.ui.form.Button(n).set({font:bl,minWidth:40});
var W=new qx.ui.form.Button(o).set({font:bl,minWidth:40});
var S=new qx.ui.form.Button(m).set({font:bl,minWidth:40});
...
bk.setRowFlex(5,1);
bk.setRowFlex(6,1);
ba.add(this.__MK,{row:0,column:0,rowSpan:0,colSpan:4});
...
P.add(ba,{flex:1});
O.addListener(r,function(e){this.__ML.cleanDisplay();
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
Q.addListener(r,function(e){this.__ML.clearEntry();

if(this.__ML.getResult()!=null){this.__MK.setValue(this.__ML.getCurrentValue().toString());
}},this);
V.addListener(r,function(e){this.__ML.deleteNumber();
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
U.addListener(r,function(e){this.__ML.setSign();

if(this.__ML.getResult()!=null){this.__MK.setValue(this.__ML.getResult().toString());
}},this);
bf.addListener(r,function(e){this.__ML.setCurrentValue(0);
this.__MK.setValue(this.__ML.getCurrentValue().toFixed(this.__ML.getZeroCounter()).toString());
},this);
be.addListener(r,function(e){this.__ML.setCurrentValue(1);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bd.addListener(r,function(e){this.__ML.setCurrentValue(2);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bc.addListener(r,function(e){this.__ML.setCurrentValue(3);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bj.addListener(r,function(e){this.__ML.setCurrentValue(4);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bi.addListener(r,function(e){this.__ML.setCurrentValue(5);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bh.addListener(r,function(e){this.__ML.setCurrentValue(6);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bg.addListener(r,function(e){this.__ML.setCurrentValue(7);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bn.addListener(r,function(e){this.__ML.setCurrentValue(8);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
bm.addListener(r,function(e){this.__ML.setCurrentValue(9);
this.__MK.setValue(this.__ML.getCurrentValue().toString());
},this);
T.addListener(r,function(e){this.__ML.calculate(p);

if(this.__ML.getResult()!=null){this.__MK.setValue(this.__ML.getResult().toString());
}this.__ML.resetCurrentValue();
},this);
bb.addListener(r,function(e){this.__ML.calculate(q);

if(this.__ML.getResult()!=null){this.__MK.setValue(this.__ML.getResult().toString());
}this.__ML.resetCurrentValue();
},this);
Y.addListener(r,function(e){this.__ML.calculate(n);

if(this.__ML.getResult()!=null){this.__MK.setValue(this.__ML.getResult().toString());
}this.__ML.resetCurrentValue();
},this);
W.addListener(r,function(e){this.__ML.calculate(o);

if(this.__ML.getResult()!=null){this.__MK.setValue(this.__ML.getResult().toString());
}this.__ML.resetCurrentValue();
},this);
S.addListener(r,function(e){this.__ML.calculate(m);

if(this.__ML.getResult()!=null){this.__MK.setValue(this.__ML.getResult().toString());
}this.__ML.resetCurrentValue();
},this);
X.addListener(r,function(e){this.__ML.setComma();
},this);
}},destruct:function(){this._disposeObjects(I,w);
}});
qx.Class.define(B,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__MM:0,__MN:0,__MO:"n",__MP:0,__MQ:0,__MR:0,__MS:false,__MT:1,__MU:0,__MV:false,__MW:0,setCurrentValue:function(f){if(this.__MS){this.__MT*=10;
this.__MM=this.__MM+(f/this.__MT);

if(f==0){this.__MU++;
}}else{this.__MS=false;

if(this.__MM<0){this.__MM=this.__MM*10-f;
}else{this.__MM=this.__MM*10+f;
}}},getZeroCounter:function(){return this.__MU;
},setComma:function(){this.__MS=true;
},getCurrentValue:function(){return this.__MM;
},resetCurrentValue:function(){this.__MM=null;
},cleanDisplay:function(){this.__MW=0;
this.__MQ=0;
this.__MO="n";
this.__MU=0;
this.__MT=1;
...
this.__MN=0;
this.__MV=false;
},setResult:function(g){this.__MN=g;
},getResult:function(){return Math.round(this.__MN*10000000)/10000000;
},setCurrentOperation:function(h){this.__MO=h;
},getCurrentOperation:function(){return this.__MO;
},clearEntry:function(){this.__MV=false;
this.__MU=0;
this.__MT=1;
this.__MS=false;
this.__MR++;
...
if(this.__MR<2){this.__MQ=this.__MN;
}
if(this.__MP>=2){this.__MN=0;
this.__MP=0;
}},setSign:function(){this.__MW++;

if(this.__MW%2==0){this.__MV=false;
}else{this.__MV=true;
}
if(this.__MM==null){this.__MM=this.__MN;
}this.__MM=this.__MM*(-1);

if(this.__MN==0){this.__MN=this.__MM;
}
if(this.__MN!=0){this.__MQ=this.__MN;
this.__MN=this.__MM;
}},deleteNumber:function(){var a=false;
var d=false;

if(this.__MM<0){this.__MM=this.__MM*(-1);
d=true;
}
if(this.__MM!=null){if(this.__MM.toString().lastIndexOf(l)!=-1){this.__MM=this.__MM*this.__MT;
a=true;
}}var b=this.__MM%10;
var c=b/10;
this.__MM=this.__MM/10;
this.__MM=this.__MM-c;

if(a){this.__MT/=10;
this.__MM=this.__MM/(this.__MT);
a=false;
}
if(d){this.__MM=this.__MM*(-1);
d=false;
}},calculate:function(bo){if(bo==p||bo==n||bo==o||bo==q||bo==m){this.__MS=false;
this.__MT=1;
this.__MU=0;

if(this.__MO!=y){if(this.__MO==p){if(this.__MN==null){this.__MN=this.__MQ;
}
if(this.__MV){this.__MN=this.__MQ+this.__MM;
}else{this.__MN=this.__MN+this.__MM;
}this.__MM=this.__MN;
this.__MQ=this.__MN;
}
if(this.__MO==q){if(this.__MN==0){this.__MN=this.__MM;
this.__MM=0;
}
if(this.__MN==null){this.__MN=this.__MQ;
}
if(this.__MV){this.__MN=this.__MQ-this.__MM;
}else{this.__MN=this.__MN-this.__MM;
}this.__MM=this.__MN;
...
if(this.__MO==o){if(this.__MN==0){this.__MN=this.__MM;
this.__MM=1;
}
if(this.__MN==null){this.__MN=this.__MQ;
}
if(this.__MM!=null){if(this.__MM!=0){if(this.__MV){this.__MN=this.__MQ/this.__MM;
}else{this.__MN=this.__MN/this.__MM;
}}else{alert("You can't divide by 0!");
}}this.__MM=this.__MN;
this.__MQ=this.__MN;
}
if(this.__MO==n){if(this.__MN==0){this.__MN=1;
}
if(this.__MM==null){this.__MM=1;
}
if(this.__MN==null){this.__MN=this.__MQ;
}
if(this.__MV){this.__MN=this.__MQ*this.__MM;
...
this.__MQ=this.__MN;
}}else{this.__MN=this.__MM;
}
if(bo!=m){this.__MO=bo;
}else{this.__MP++;
this.__MN=this.__MQ;
this.__MO="n";
}this.__MV=false;
