...
},addNormalButtons:function(v){var w=new qx.ui.form.Button(o,i);
v.add(w);
var x=new qx.ui.form.Button(l,h);
x.setEnabled(false);
v.add(x);
...
y.add(A);
z.addListener(p,function(){var u=parseInt(A.getValue())+1;
A.setValue(u.toString());
});
},addHoverButton:function(a){var b=new qx.ui.form.HoverButton(g).set({padding:10,backgroundColor:n});
a.add(b);
...
a.add(c);
b.addListener(p,function(){var t=parseInt(c.getValue())+1;
c.setValue(t.toString());
});
}}});
})();
