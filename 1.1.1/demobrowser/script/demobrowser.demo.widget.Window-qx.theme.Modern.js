...
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var bJ=new qx.ui.window.Window(w,j);
bJ.setLayout(new qx.ui.layout.VBox(10));
bJ.setShowStatusbar(true);
bJ.setStatus(D);
bJ.open();
this.getRoot().add(bJ,{left:20,top:20});
...
var bI=new qx.ui.basic.Atom(E,W);
bI.setRich(true);
bJ.add(bI);
var bH=new qx.ui.tabview.TabView;
bJ.add(bH,{flex:1});
var bM=new qx.ui.tabview.Page(c);
bH.add(bM);
var bK=new qx.ui.tabview.Page(u);
bH.add(bK);
var bL=new qx.ui.tabview.Page(p);
bH.add(bL);
},createWindow2:function(){var bi=new qx.ui.window.Window(d,I);
bi.setLayout(new qx.ui.layout.VBox(10));
bi.setStatus(G);
bi.open();
this.getRoot().add(bi,{left:350,top:120});
var br=new qx.ui.basic.Atom(o,U);
bi.add(br);
...
bc.add(bk,{flex:1});
var bf=new qx.ui.form.CheckBox(X);
bf.setValue(true);
bf.addListener(l,function(e){bi.setShowClose(e.getData());
});
bk.add(bf);
var bq=new qx.ui.form.CheckBox(T);
bq.setValue(true);
bq.addListener(l,function(e){bi.setShowMaximize(e.getData());
});
bk.add(bq);
var bj=new qx.ui.form.CheckBox(O);
bj.setValue(true);
bj.addListener(l,function(e){bi.setShowMinimize(e.getData());
});
bk.add(bj);
var bm=new qx.ui.form.CheckBox(S);
bm.setValue(true);
bm.addListener(l,function(e){bi.setAllowClose(e.getData());
});
bk.add(bm);
var bs=new qx.ui.form.CheckBox(q);
bs.setValue(true);
bs.addListener(l,function(e){bi.setAllowMaximize(e.getData());
});
bk.add(bs);
var bh=new qx.ui.form.CheckBox(J);
bh.setValue(true);
bh.addListener(l,function(e){bi.setAllowMinimize(e.getData());
});
bk.add(bh);
var bd=new qx.ui.form.CheckBox(bb);
bd.setValue(false);
bd.addListener(l,function(e){bi.setShowStatusbar(e.getData());
});
bk.add(bd);
var bu=new qx.ui.groupbox.GroupBox(H);
bu.setLayout(new qx.ui.layout.VBox(4));
bc.add(bu,{flex:1});
var bo=new qx.ui.form.CheckBox(R);
bo.setValue(true);
bo.addListener(l,function(e){bi.setUseResizeFrame(e.getData());
});
bu.add(bo);
var bp=[Q,h,b,v];

for(var i=0;i<bp.length;i++){var bn=bp[i];
var bg=new qx.ui.form.CheckBox(n+bn).set({value:true});
bg.bind(r,bi,t+qx.lang.String.firstUp(bn));
bu.add(bg);
}var be=new qx.ui.groupbox.GroupBox(F);
be.setLayout(new qx.ui.layout.VBox(4));
bc.add(be,{flex:1});
var bl=new qx.ui.form.CheckBox(P);
bl.setValue(true);
bl.addListener(l,function(e){bi.setMovable(e.getData());
});
be.add(bl);
var bt=new qx.ui.form.CheckBox(a);
bt.addListener(l,function(e){bi.setUseMoveFrame(e.getData());
});
be.add(bt);
},createWindow3:function(){var bE=new qx.ui.window.Window(V,A);
bE.setLayout(new qx.ui.layout.VBox);
bE.setMaxWidth(450);
bE.setMaxHeight(400);
bE.setAllowMaximize(false);
bE.open();
this.getRoot().add(bE,{left:100,top:250});
var bF=this.getModalWindow1();
var bG=new qx.ui.form.Button(L,j);
bG.addListener(k,bF.open,bF);
bE.add(bG);
},getModalWindow1:function(){var bB=new qx.ui.window.Window(z);
bB.setLayout(new qx.ui.layout.VBox(10));
bB.setModal(true);
bB.moveTo(150,150);
this.getRoot().add(bB);
var bA=this.getModalWindow2();
var bD=new qx.ui.form.Button(N,j);
bD.addListener(k,bA.open,bA);
bB.add(bD);
var bC=new qx.ui.form.CheckBox(B);
bC.setValue(true);
bB.add(bC);
bC.addListener(l,function(e){bB.setModal(e.getData());
});
return bB;
},getModalWindow2:function(){var bw=new qx.ui.window.Window(K);
bw.setLayout(new qx.ui.layout.VBox(10));
bw.setModal(true);
bw.setShowClose(false);
bw.moveTo(300,300);
this.getRoot().add(bw);
var bv=new qx.ui.basic.Atom(C,Y);
bw.add(bv);
var by=new qx.ui.container.Composite;
by.setLayout(new qx.ui.layout.HBox(10,h));
bw.add(by);
var bz=new qx.ui.form.Button(f,M);
bz.addListener(k,function(e){bw.close();
});
by.add(bz);
var bx=new qx.ui.form.Button(s,ba);
bx.addListener(k,function(e){alert("Sorry, please click 'Yes'!");
});
by.add(bx);
return bw;
}}});
