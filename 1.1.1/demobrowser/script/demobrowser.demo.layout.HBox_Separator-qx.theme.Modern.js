...
n.add(this.getBox2());
n.add(this.getBox3());
},getBox1:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
o.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return o;
},getBox2:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,minHeight:60,allowGrowX:false});
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:c}));
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:a}));
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:b}));
return i;
