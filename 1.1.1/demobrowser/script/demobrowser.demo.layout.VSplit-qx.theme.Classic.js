...
var w=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(w);
w.add(this.getSplitPaneTwoFlexSimple(),{left:0});
w.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
w.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
w.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
w.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
w.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
w.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
w.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
w.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var r=new qx.ui.splitpane.Pane(m);
r.setHeight(400);
r.setDecorator(l);
var q=new qx.ui.form.TextArea(k);
q.setDecorator(null);
q.setWrap(true);
r.add(q,1);
...
r.add(s,2);
return r;
},getSplitPaneTwoFlexWithOneMin:function(){var E=new qx.ui.splitpane.Pane(m);
E.setHeight(400);
E.setDecorator(l);
...
E.add(F,2);
return E;
},getSplitPaneTwoFlexWithOneMax:function(){var B=new qx.ui.splitpane.Pane(m);
B.setHeight(400);
B.setDecorator(l);
var A=new qx.ui.form.TextArea(k);
A.setDecorator(null);
A.setWrap(true);
B.add(A,1);
...
B.add(C,2);
return B;
},getSplitPaneTwoFlexWithTwoMin:function(){var K=new qx.ui.splitpane.Pane(m);
K.setHeight(400);
K.setDecorator(l);
...
J.setMinHeight(250);
K.add(J,1);
var L=new qx.ui.form.TextArea(a);
L.setDecorator(null);
L.setWrap(true);
L.setMinHeight(250);
K.add(L,2);
return K;
},getSplitPaneTwoFlexWithTwoMax:function(){var H=new qx.ui.splitpane.Pane(m);
H.setHeight(400);
H.setDecorator(l);
var G=new qx.ui.form.TextArea(e);
G.setDecorator(null);
G.setWrap(true);
G.setMaxHeight(100);
H.add(G,1);
var I=new qx.ui.form.TextArea(f);
I.setDecorator(null);
I.setWrap(true);
I.setMaxHeight(100);
H.add(I,2);
return H;
},getSplitPaneOneFlexSimple:function(){var N=new qx.ui.splitpane.Pane(m);
N.setHeight(400);
N.setDecorator(l);
var M=new qx.ui.form.TextArea(g);
M.setDecorator(null);
M.setWrap(true);
N.add(M,0);
...
N.add(O);
return N;
},getSplitPaneOneFlexSimpleWithMax:function(){var o=new qx.ui.splitpane.Pane(m);
o.setHeight(400);
o.setDecorator(l);
...
n.setWrap(true);
o.add(n,0);
var p=new qx.ui.form.TextArea(d);
p.setDecorator(null);
p.setWrap(true);
p.setMaxHeight(200);
o.add(p);
return o;
},getSplitPaneOneFlexSimpleWithMin:function(){var y=new qx.ui.splitpane.Pane(m);
y.setHeight(400);
y.setDecorator(l);
var x=new qx.ui.form.TextArea(c);
x.setDecorator(null);
x.setWrap(true);
x.setMinHeight(350);
y.add(x,0);
...
y.add(z);
return y;
},getSplitPaneAuto:function(){var u=new qx.ui.splitpane.Pane(m);
u.setDecorator(l);
