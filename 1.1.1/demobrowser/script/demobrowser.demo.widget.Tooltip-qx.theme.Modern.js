...
(function(){var m="icon/16/actions/help-about.png",l="Tooltip text",k="icon/32/actions/help-about.png",j="Button #2 (Shared ToolTip)",i="Short timeout ToolTip",h="demobrowser.demo.widget.Tooltip",g="Hello World #3",f="Button with ToolTipText and ToolTipIcon",d="ToolTip with icon and label",c="Shared tool tip of button #",A="ToolTip with icon and rich text",z="Such a great tooltip with a (show) timeout of 50ms.",y="Icon only ToolTip",x="Button #1 (Shared ToolTip)",w="container",v="This also may contain <b style='color:red'>rich HTML</b> markup ",u="appear",t="2",s="Shared ToolTip",r="1",p="Button with ToolTipText",q="A long label text with auto-wrapping. ",n="Button with ToolTipIcon",o="and with a (show) timeout of 50ms.";
...
var L=new qx.ui.layout.Grid(10,10);
this.container=new qx.ui.container.Composite(L).set({padding:20});
M.add(this.container);
...
},__Lr:4,__Ls:0,add:function(O){this.container.add(O,{row:Math.floor(this.__Ls/this.__Lr),column:this.__Ls%this.__Lr});
this.__Ls+=1;
},createSharedToolTip:function(){var E=new qx.ui.tooltip.ToolTip(s);
E.addListener(u,function(e){var H=c;

if(this.getOpener()==D){H+=r;
}else{H+=t;
}E.setLabel(H);
});
...
C.setToolTip(E);
this.add(C);
},createIconToolTip:function(){var I=new qx.ui.form.Button(y).set({toolTip:new qx.ui.tooltip.ToolTip(null,m)});
this.add(I);
},createToolTip:function(){var K=new qx.ui.form.Button(d).set({toolTip:new qx.ui.tooltip.ToolTip(g,m)});
this.add(K);
},createShortTimeoutToolTip:function(){var b=new qx.ui.tooltip.ToolTip(z,k);
b.setShowTimeout(50);
var a=new qx.ui.form.Button(i);
this.add(a);
a.setToolTip(b);
},createRichToolTip:function(){var G=new qx.ui.tooltip.ToolTip(q+v+o,k);
G.setWidth(200);
G.setRich(true);
G.setShowTimeout(50);
...
this.add(F);
F.setToolTip(G);
},createToolTipText:function(){var J=new qx.ui.form.Button(p).set({toolTipText:l});
this.add(J);
},createToolTipIcon:function(){var B=new qx.ui.form.Button(n).set({toolTipIcon:m});
this.add(B);
},createToolTipTextIcon:function(){var N=new qx.ui.form.Button(f).set({toolTipText:l,toolTipIcon:m});
this.add(N);
