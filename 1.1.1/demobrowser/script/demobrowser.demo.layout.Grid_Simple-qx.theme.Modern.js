...
s.add(this.getGrid2());
s.add(this.getGrid3());
},getGrid1:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:k,backgroundColor:i,allowGrowX:false,allowGrowY:false});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:0});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:1});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:0});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:1});
return p;
...
return m;
},getGrid3:function(){var r=new qx.ui.container.Composite().set({decorator:k,backgroundColor:i,width:400,height:300,allowShrinkX:false,allowShrinkY:false});
var q=new qx.ui.layout.Grid();
q.setColumnFlex(1,2);
q.setRowFlex(1,3);
q.setSpacing(5);
r.setLayout(q);
r.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:0});
r.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:1});
r.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:0});
r.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:1});
return r;
}}});
})();
