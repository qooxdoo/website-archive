...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Destructor","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Destructor-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ca607dc9673a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var e="Window: ",d="interval",c="__Lh",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__Lf:null,__Lg:0,__Lh:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__Lf=[];
this.currentTest=this.testWindows;
this.__Lh=new qx.event.Timer(1000);
this.__Lh.addListener(d,this.runTest,this);
this.__Lh.start();
},runTest:function(){this.__Lg++;
var j=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Lg+" (Registry: "+j+")");
this.currentTest();
...
},testLabels:function(){for(var i=0;i<250;i++){var f=new qx.ui.basic.Label(b+i);
this.getRoot().add(f,{left:50,top:50+i*20});
this.__Lf.push(f);
}},testWindows:function(){for(var i=0;i<5;i++){var g=new qx.ui.window.Window(e+i);
g.open();
this.__Lf.push(g);
