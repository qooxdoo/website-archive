...
bd.add(br,{row:1,column:1});
this.createItems(br);
var bk=new qx.ui.form.RadioButtonGroup();
bk.add(new qx.ui.form.RadioButton(u));
bk.add(new qx.ui.form.RadioButton(C));
bk.add(new qx.ui.form.RadioButton(R));
be=new qx.ui.basic.Label(A);
be.setBuddy(bk);
bd.add(be,{row:2,column:0});
bd.add(bk,{row:2,column:1});
var bp=new qx.ui.groupbox.GroupBox(p);
bp.setLayout(new qx.ui.layout.Grid(8,8));
bp.setWidth(210);
this.getRoot().add(bp,{left:330,top:10});
var bq=new qx.ui.form.Button(j);
be=new qx.ui.basic.Label(Q);
be.setBuddy(bq);
bp.add(be,{row:0,column:0});
bp.add(bq,{row:0,column:1});
var ba=new qx.ui.form.ToggleButton(a);
be=new qx.ui.basic.Label(O);
be.setBuddy(ba);
bp.add(be,{row:1,column:0});
bp.add(ba,{row:1,column:1});
var bh=new qx.ui.form.RepeatButton(L);
be=new qx.ui.basic.Label(e);
be.setBuddy(bh);
bp.add(be,{row:2,column:0});
bp.add(bh,{row:2,column:1});
var bi=new qx.ui.form.MenuButton(H,null,this.createMenuForMenuButton());
be=new qx.ui.basic.Label(K);
be.setBuddy(bi);
bp.add(be,{row:3,column:0});
bp.add(bi,{row:3,column:1});
var bb=new qx.ui.form.SplitButton(s,null,this.createMenuForSplitButton());
be=new qx.ui.basic.Label(m);
be.setBuddy(bb);
bp.add(be,{row:4,column:0});
bp.add(bb,{row:4,column:1});
bh.addListener(d,function(){var bC=parseInt(bh.getLabel())+1;
bh.setLabel(bC.toString());
});
var Y=new qx.ui.groupbox.GroupBox(f);
Y.setLayout(new qx.ui.layout.Grid(8,8));
Y.setWidth(210);
this.getRoot().add(Y,{left:330,top:210});
var bn=new qx.ui.form.CheckBox(E);
be=new qx.ui.basic.Label(h);
be.setBuddy(bn);
Y.add(be,{row:0,column:0});
Y.add(bn,{row:0,column:1});
var bg=new qx.ui.form.RadioButton(M);
Y.add(new qx.ui.basic.Label(n),{row:1,column:0});
Y.add(bg,{row:1,column:1});
var bo=new qx.ui.groupbox.GroupBox(F);
bo.setLayout(new qx.ui.layout.Grid(8,8));
bo.setWidth(210);
this.getRoot().add(bo,{left:330,top:310});
var bf=new qx.ui.form.Spinner(0,50,100);
be=new qx.ui.basic.Label(B);
be.setBuddy(bf);
bo.add(be,{row:0,column:0});
bo.add(bf,{row:0,column:1});
var bj=new qx.ui.form.Slider();
bj.setWidth(130);
be=new qx.ui.basic.Label(v);
be.setBuddy(bj);
bo.add(be,{row:1,column:0});
bo.add(bj,{row:1,column:1});
},createItems:function(T){for(var i=0;i<this.self(arguments).ITEM_SIZE;i++){var U=new qx.ui.form.ListItem(y+i);
T.add(U);
}},createMenuForMenuButton:function(){var bx=new qx.ui.menu.Menu;

for(var i=0;i<3;i++){bx.add(new qx.ui.menu.RadioButton(t+i));
}var bA=new qx.ui.form.RadioGroup;
bA.add.apply(bA,bx.getChildren());
var bz=new qx.ui.menu.Menu();

for(var i=0;i<3;i++){var bB=new qx.ui.menu.Button(j+i);
bz.add(bB);
}var by=new qx.ui.menu.Button(N,q,null,bx);
bz.addSeparator();
bz.add(by);
return bz;
},createMenuForSplitButton:function(){var bt=new qx.ui.menu.Menu;
var bw=new qx.ui.menu.Button(G);
var bu=new qx.ui.menu.Button(c);
var bv=new qx.ui.menu.Button(I);
bt.add(bw);
bt.add(bu);
bt.add(bv);
return bt;
