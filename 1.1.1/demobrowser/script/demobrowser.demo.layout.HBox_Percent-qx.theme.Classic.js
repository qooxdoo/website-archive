...
k.add(this.getBox5());
k.add(this.getBox6());
},getBox1:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
...
q.add(p,{flex:1});
return q;
},getBox2:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
...
b.add(a,{flex:1});
return b;
},getBox4:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,allowGrowX:false});
...
C.add(E,{width:h,flex:1});
C.add(D,{width:h,flex:1});
C.add(B,{width:h,flex:1});
return C;
},getBox5:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:200,allowGrowX:false});
...
m.add(o,{width:h,flex:1});
m.add(n,{width:h,flex:1});
m.add(l,{width:h,flex:1});
return m;
},getBox6:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
var A=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
