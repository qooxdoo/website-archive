...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.SelectBox","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.SelectBox-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"b94bb7f99764"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var n="icon/16/devices/",m="phone.png",l="audio-card.png",k="battery.png",j="printer.png",h="Simple",g="display.png",f="audio-input-microphone.png",d="Empty Item",c="computer.png",I="Random Value ",H="input-keyboard.png",G="drive-optical.png",F="",E="media-optical.png",D="changeSelection",C="pda.png",B="network-wired.png",A=".",z="camera-photo.png",u="network-wireless.png",v="media-flash.png",s="Option ",t="input-mouse.png",q="demobrowser.demo.widget.SelectBox",r="With icons",o="drive-harddisk.png",p="camera-web.png",w="multimedia-player.png",x="Item ",y="Long text";
...
var a=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
a.setPadding(20);
a.add(this.createBox1());
a.add(this.createBox2());
a.add(this.createBox3());
a.add(this.createBox4());
b.add(a,{left:20,top:20});
this.getRoot().add(b,{edge:0});
},createBox1:function(){var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
K.add(new qx.ui.basic.Label(h));
var J=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var L=new qx.ui.form.ListItem(x+(i+1));
J.add(L);
if(i==5){J.setSelection([L]);
}}J.addListener(D,function(e){this.debug("changeSelection: "+e.getData()[0]);
});
K.add(J);
return K;
},createBox2:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
N.add(new qx.ui.basic.Label(y));
var M=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var O=new qx.ui.form.ListItem(I+Math.round(Math.random()*100000000));
M.add(O);
}N.add(M);
return N;
},createBox3:function(){var S=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
S.add(new qx.ui.basic.Label(r));
var U=[l,f,k,z,p,c,g,o,G,H,t,v,E,w,B,u,C,m,j];
var V=n;
var R=new qx.ui.form.SelectBox();

for(var i=0;i<U.length;i++){var T=new qx.ui.form.ListItem(U[i].substr(0,U[i].indexOf(A)),V+U[i]);
R.add(T);
}S.add(R);
return S;
},createBox4:function(){var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
Q.add(new qx.ui.basic.Label(d));
var P=new qx.ui.form.SelectBox();
P.add(new qx.ui.form.ListItem(F));

for(var i=0;i<10;i++){P.add(new qx.ui.form.ListItem(s+(i+1)));
}Q.add(P);
return Q;
}}});
})();
