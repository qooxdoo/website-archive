...
a.add(this.getBox5());
a.add(this.getBox6());
},getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
k.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:3});
return k;
},getBox2:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:30}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:100}),{flex:3});
return j;
},getBox3:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});

for(var i=0;i<25;i++){f.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,height:5}),{flex:1});
}return f;
},getBox4:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,minHeight:300,allowGrowY:false});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,maxHeight:60}),{flex:3});
return h;
...
return l;
},getBox6:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:e,backgroundColor:c,allowGrowY:false});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:3});
return g;
}}});
})();
