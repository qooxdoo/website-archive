...
var s=new qx.ui.container.Composite(r).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
r.setSpacing(5);
s.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:1});
s.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
s.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:3});
return s;
},getBox2:function(){var j=new qx.ui.layout.HBox();
var k=new qx.ui.container.Composite(j).set({width:500,decorator:d,backgroundColor:b,allowGrowX:false});
j.setSpacing(5);
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:30}),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:150}),{flex:3});
return k;
...
var h=new qx.ui.container.Composite(g).set({width:600,minWidth:600,decorator:d,backgroundColor:b,allowGrowX:false});
g.setSpacing(5);
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxWidth:120}),{flex:3});
return h;
...
return m;
},getBox6:function(){var e=new qx.ui.layout.HBox();
var f=new qx.ui.container.Composite(e).set({width:300,decorator:d,backgroundColor:b,allowGrowX:false});
e.setSpacing(5);
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:1});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:2});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minWidth:120}),{flex:3});
return f;
}}});
})();
