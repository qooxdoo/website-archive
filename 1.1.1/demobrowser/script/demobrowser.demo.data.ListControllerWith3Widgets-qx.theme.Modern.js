...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.ListControllerWith3Widgets","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ListControllerWith3Widgets-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d1e93e63687d"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var m="execute",l="Item ",k="Write data to log",j="Add an item",h="<b>SelectBox</b>",g="Remove an item",f="<b>List</b><br/>",e="multi",d="All 3 widgets share the same data model. The List and the SelectBox ",c="demobrowser.demo.data.ListControllerWith3Widgets",a="<b>ComboBox</b><br/>",b="also share the same selection.";
...
for(var i=0;i<30;i++){w.push(l+i);
}var y=new qx.data.Array(w);
var q=new qx.ui.form.List();
var n=new qx.ui.form.SelectBox();
var p=new qx.ui.form.ComboBox();
this.getRoot().add(q,{left:10,top:80});
q.setSelectionMode(e);
this.getRoot().add(n,{left:120,top:80});
this.getRoot().add(p,{left:250,top:80});
var u=new qx.data.controller.List(y,q);
var t=new qx.data.controller.List(y,n);
new qx.data.controller.List(y,p);
t.setSelection(u.getSelection());
var z=new qx.ui.form.Button(j);
z.setWidth(120);
this.getRoot().add(z,{left:380,top:80});
z.addListener(m,function(){y.push(l+y.length);
},this);
var r=new qx.ui.form.Button(g);
r.setWidth(120);
this.getRoot().add(r,{left:380,top:115});
r.addListener(m,function(){y.pop();
},this);
var v=new qx.ui.form.Button(k);
v.setWidth(120);
this.getRoot().add(v,{left:380,top:150});
v.addListener(m,function(){qx.log.appender.Console.show();
this.info(y.toString());
},this);
...
o.setWidth(100);
o.setValue(h);
this.getRoot().add(o,{left:130,top:10});
var A=new qx.ui.basic.Label();
A.setRich(true);
A.setWidth(100);
A.setValue(a);
this.getRoot().add(A,{left:260,top:10});
var s=new qx.ui.basic.Label();
s.setRich(true);
s.setWidth(360);
s.setValue(d+b);
this.getRoot().add(s,{left:20,top:30});
}}});
})();
