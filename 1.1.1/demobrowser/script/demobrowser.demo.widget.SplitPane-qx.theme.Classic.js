...
(function(){var t="value",s="horizontal",r="first",q="second",p="both",o="main",n="Show first pane",m="demobrowser.demo.widget.SplitPane",l="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",k="Show both panes",c="Toggle Splitpane Orientation",j="Show second pane",g="__LS",b="vertical",a="_container2",f="changeSelection",d="_container1",h="execute";
qx.Class.define(m,{extend:qx.application.Standalone,members:{__LS:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
var z=this.__LT();
var y=new qx.ui.form.Button(c).set({allowGrowX:false,allowGrowY:false});
...
var H=new qx.ui.form.RadioButton(j);
...
y.focus();
},_toggle:function(){var Y=this.__LS.getOrientation();
this.__LS.setOrientation(Y==s?b:s);
...
this._container2.show();
}},__LT:function(){var S=new qx.ui.tree.Tree();
S.setDecorator(null);
var X=new qx.ui.tree.TreeFolder("/");
X.setOpen(true);
S.setRoot(X);
var V=new qx.ui.tree.TreeFolder("Desktop");
V.setOpen(true);
X.add(V);
var N=new qx.ui.tree.TreeFolder("Files");
var L=new qx.ui.tree.TreeFolder("Workspace");
var M=new qx.ui.tree.TreeFolder("Network");
var K=new qx.ui.tree.TreeFolder("Trash");
V.add(N,L,M,K);
var T=new qx.ui.tree.TreeFile("Windows (C:)");
var J=new qx.ui.tree.TreeFile("Documents (D:)");
L.add(T,J);
var W=new qx.ui.tree.TreeFolder("Inbox");
var O=new qx.ui.tree.TreeFolder("Presets");
var R=new qx.ui.tree.TreeFolder("Sent");
var Q=new qx.ui.tree.TreeFolder("Trash");

for(var i=0;i<100;i++){Q.add(new qx.ui.tree.TreeFile("Junk #"+i));
}var U=new qx.ui.tree.TreeFolder("Data");
var P=new qx.ui.tree.TreeFolder("Edit");
W.add(O,R,Q,U,P);
X.add(W);
return S;
}},destruct:function(){this._disposeObjects(g,d,a);
}});
})();
