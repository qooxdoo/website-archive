...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"320bc5cca703"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var n="main",m="green",l="yellow",k="center",j="right",i="demobrowser.demo.layout.HBox",h="top",g="bottom",f="middle";
qx.Class.define(i,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);
...
r.add(this.getBox6());
r.add(this.getBox7());
},getBox1:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:l,allowGrowX:false});
q.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
q.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
q.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
return q;
},getBox2:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:l,minHeight:60,allowGrowX:false});
u.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxHeight:40,alignY:h}));
u.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxHeight:40,alignY:f}));
u.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxHeight:40,alignY:g}));
return u;
},getBox3:function(){var o=new qx.ui.layout.HBox();
var p=new qx.ui.container.Composite(o).set({decorator:n,backgroundColor:l,width:500,allowGrowX:false});
o.setSpacing(5);
o.setAlignX(j);
p.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
p.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
p.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
return p;
},getBox4:function(){var s=new qx.ui.layout.HBox();
var t=new qx.ui.container.Composite(s).set({decorator:n,backgroundColor:l,width:500,allowGrowX:false});
s.setSpacing(5);
s.setAlignX(k);
t.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
t.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
t.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}));
return t;
},getBox5:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:l,allowGrowX:false});
var D=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var C=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var A=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
B.add(D);
B.add(C);
B.add(A);
D.setMarginRight(10);
...
A.setMarginRight(10);
return B;
},getBox6:function(){var a=new qx.ui.layout.HBox();
var c=new qx.ui.container.Composite(a).set({decorator:n,backgroundColor:l,width:500,allowGrowX:false});
a.setSpacing(5);
a.setAlignX(j);
var e=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var d=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var b=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
c.add(e);
c.add(d);
c.add(b);
e.setMarginRight(10);
...
b.setMarginRight(10);
return c;
},getBox7:function(){var v=new qx.ui.layout.HBox();
var x=new qx.ui.container.Composite(v).set({decorator:n,backgroundColor:l,width:500,allowGrowX:false});
v.setSpacing(5);
v.setAlignX(k);
var z=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var y=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var w=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
x.add(z);
x.add(y);
x.add(w);
z.setMarginRight(10);
...
qx.Class.define(X,{extend:qx.ui.layout.Abstract,construct:function(bh,bi,bj,bk){qx.ui.layout.Abstract.call(this);
...
}},properties:{sort:{check:[Y,ba,bb],init:Y,apply:W},separatorX:{check:bd,nullable:true,apply:bg},separatorY:{check:bd,nullable:true,apply:bg},connectSeparators:{check:S,init:false,apply:bg},spacingX:{check:bc,init:0,apply:bg},spacingY:{check:bc,init:0,apply:bg}},members:{__qr:null,__qs:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__qt:{north:1,south:2,west:3,east:4,center:5},__qu:{1:be,2:R,3:bf,4:U},__qv:function(){var bI=this._getLayoutChildren();
var bQ,bK;
...
},renderLayout:function(a,b){if(this._invalidChildrenCache){this.__qv();
...
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__qv();
}var bo=this.__qr;
var by=this.__qs;
...
}},destruct:function(){this.__qs=this.__qr=null;
}});
})();
...
this.setWidth(null);
this._editorGroups={};
var G=new qx.ui.decoration.Single();
G.setLeft(1,B,l);
this.setDecorator(G);
this.setBackgroundColor(p);
var I=new qx.ui.container.Composite().set({padding:[20,14]});
this.getChildControl(o).add(I);
this._pane=I;
var H=new qx.ui.layout.VBox().set({spacing:5});
I.setLayout(H);
I.add(this._createWidgetIndicator());
I.add(new qx.ui.basic.Label(j).set({font:n,padding:[1,0,5,0]}));
var J=qx.lang.Object.clone(demobrowser.demo.util.PropertyGroup.WIDGET_PROPERTIES);
J.value={type:A,nullable:true};
this._layoutControls=new demobrowser.demo.util.PropertyGroup(J);
I.add(this._layoutControls);
},properties:{widget:{check:u,apply:v}},members:{handleWidgetClick:function(e){var U=e.getTarget();
this.setWidget(U);
},_createWidgetIndicator:function(){var M=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:5}));
M.add(this._createLabel(q));
this._widgetIndicator=new qx.ui.basic.Label().set({height:30,allowGrowX:true,allowGrowY:true,padding:5});
M._add(this._widgetIndicator);
return M;
},_createLabel:function(C){return new qx.ui.basic.Label(C).set({font:n,allowGrowX:true,padding:[5,0,5,0]});
},_createContainer:function(R,S){var T=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:5}));
T.add(this._createLabel(R));
T.add(S);
return T;
...
this._wlpe=b;
},updateLayoutPropertyEditor:function(D){var F=D.getLayout?D.getLayout():null;
var E=this.getLayoutPropertyEditor(F);

if(E){E.getChildren()[1].setSelected(F);
}
if(E===this._lpe){return;
}
...
}var name=g+P.constructor.classname;
var Q;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case z:case x:Q=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BOX_PROPERTIES);
break;
case y:Q=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.CANVAS_PROPERTIES);
break;
case s:Q=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BASIC_PROPERTIES);
break;
case h:Q=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.DOCK_PROPERTIES);
break;
case m:Q=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.GRID_PROPERTIES);
break;
}
if(!Q){return null;
}this._editorGroups[name]=this._createContainer(P.constructor.classname+w,Q);
return this._editorGroups[name];
},getLayoutPropertyEditor:function(N){if(!N){return null;
}var name=d+N.constructor.classname;
var O;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case i:O=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.HBOX_PROPERTIES);
break;
case f:O=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.DOCK_PROPERTIES);
break;
case r:O=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.GRID_PROPERTIES);
break;
}
if(!O){return null;
}this._editorGroups[name]=this._createContainer(N.constructor.classname+t,O);
return this._editorGroups[name];
},_applyWidget:function(K,L){this._layoutControls.setSelected(K);
this._widgetIndicator.setBackgroundColor(K.getBackgroundColor());
this._widgetIndicator.setDecorator(K.getDecorator());
this._widgetIndicator.setValue(K.toString());
this.updateLayoutPropertyEditor(K);
this.updateWidgetLayoutPropertyEditor(K);
...
(function(){var s="value",r="changeValue",q="enum",p="set",o="int",n="string",m="bool",k="function",j="null",h="demobrowser.demo.util.PropertyGroup",d="_applySelected",g="get",f="top",c="changeSelection",b="right";
qx.Class.define(h,{extend:qx.ui.core.Widget,construct:function(w){qx.ui.core.Widget.call(this);
this._properties=w;
var y=new qx.ui.layout.Grid(10,5);
y.setColumnAlign(0,b,f);
y.setColumnMinWidth(0,110);
this._setLayout(y);
this.set({allowShrinkX:false,allowShrinkY:false});
var F=0;

for(var B in this._properties){var E=this._properties[B].type;
var A=this._properties[B].nullable;
this._add(new qx.ui.basic.Label(B).set({paddingTop:4}),{row:F,column:0});

if(A){var z=new qx.ui.form.CheckBox(j);
z.addListener(r,this._createOnNullPropertyChange(B),this);
this._add(z,{row:F,column:2});
this._properties[B].nullWidget=z;
}
if(E==o){var D=new qx.ui.form.Spinner().set({minimum:this._properties[B].min||0,maximum:this._properties[B].max!==undefined?this._properties[B].max:1000});
D.addListener(r,this._createOnIntPropertyChange(B),this);
this._add(D,{row:F++,column:1});
}else if(E==m){var D=new qx.ui.form.CheckBox();
D.addListener(r,this._createOnBoolPropertyChange(B),this);
this._add(D,{row:F++,column:1});
}else if(E==q){var C=this._properties[B].values;
var D=new qx.ui.form.RadioGroup();

for(var i=0;i<C.length;i++){var x=new qx.ui.form.RadioButton(C[i]);
x.setUserData(s,C[i]);
D.add(x);
this._add(x,{row:F++,column:1});
}D.addListener(c,this._createOnEnumPropertyChange(B,D),this);
}else if(E==n){var D=new qx.ui.form.TextField();
D.setLiveUpdate(true);
D.addListener(r,this._createOnIntPropertyChange(B),this);
this._add(D,{row:F++,column:1});
}this._properties[B].formItem=D;
}},statics:{WIDGET_PROPERTIES:{"width":{type:"int",nullable:true},"height":{type:"int",nullable:true},"minWidth":{type:"int",nullable:true},"minHeight":{type:"int",nullable:true},"maxWidth":{type:"int",nullable:true},"maxHeight":{type:"int",nullable:true},"allowGrowX":{type:"bool",nullable:false},"allowGrowY":{type:"bool",nullable:false},"allowShrinkX":{type:"bool",nullable:false},"allowShrinkY":{type:"bool",nullable:false},"marginTop":{type:"int",min:-1000,nullable:false},"marginRight":{type:"int",min:-1000,nullable:false},"marginBottom":{type:"int",min:-1000,nullable:false},"marginLeft":{type:"int",min:-1000,nullable:false},"paddingTop":{type:"int",nullable:false},"paddingRight":{type:"int",nullable:false},"paddingBottom":{type:"int",nullable:false},"paddingLeft":{type:"int",nullable:false},"alignX":{type:"enum",values:["left","center","right"],nullable:true},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:true}},HBOX_PROPERTIES:{"alignX":{type:"enum",values:["left","center","right"],nullable:false},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:false},"spacing":{type:"int",nullable:false},"reversed":{type:"bool",nullable:false}},DOCK_PROPERTIES:{"sort":{type:"enum",values:["auto","y","x"],nullable:false},"spacingX":{type:"int",nullable:false},"spacingY":{type:"int",nullable:false}},GRID_PROPERTIES:{"horizontalSpacing":{type:"int",nullable:false},"verticalSpacing":{type:"int",nullable:false}}},properties:{selected:{apply:d,nullable:true}},members:{_applySelected:function(O,P){this._updateControls(O);
},_setProperty:function(W,name,X){if(!W){return;
}var ba=p+qx.lang.String.firstUp(name);
var Y=this._properties[name].convert;

if(Y){X=Y(X);
}W[ba](X);
},_getProperty:function(bc,name){var bd=g+qx.lang.String.firstUp(name);
return bc[bd]();
},_hasProperty:function(Q,name){var R=p+qx.lang.String.firstUp(name);
return (typeof (Q[R])==k);
},_createOnIntPropertyChange:function(V){return function(e){var bb=this.getSelected();
this._setProperty(bb,V,e.getTarget().getValue());
};
},_createOnBoolPropertyChange:function(a){return function(e){var be=this.getSelected();
this._setProperty(be,a,e.getTarget().getValue());
};
},_createOnEnumPropertyChange:function(t,u){return function(e){var bf=this.getSelected();
this._setProperty(bf,t,u.getSelection()[0].getUserData(s));
};
},_createOnNullPropertyChange:function(v){return function(e){var T=this.getSelected();
var S=e.getTarget();

if(S.getValue()){this._setProperty(T,v,null);
this._properties[v].formItem.setEnabled(false);
}else{var U=null;

if(this._properties[v].type==q){U=this._properties[v].formItem.getSelection()[0].getUserData(s);
}else{U=this._properties[v].formItem.getValue();
}this._setProperty(T,v,U);
this._properties[v].formItem.setEnabled(true);
}};
},_updateControls:function(G){for(var M in this._properties){var N=this._properties[M].type;
var J=this._properties[M].formItem;
var H=this._properties[M].nullable;

if(!this._hasProperty(G,M)){J.setEnabled(false);

if(H){this._properties[M].nullWidget.setEnabled(false);
}return;
}J.setEnabled(true);
var L=this._getProperty(G,M);

if(L!==null){if(N==o){J.setValue(parseInt(L));
}else if(N==n){J.setValue(L.toString());
}else if(N==m){J.setValue(!!L);
}else if(N==q){var I=J.getItems();

for(var i=0,l=I.length;i<l;i++){var K=I[i];

if(K.getUserData(s)==L){J.setSelection([K]);
break;
}}}}
if(H){this._properties[M].nullWidget.setValue(L==null);
this._properties[M].nullWidget.setEnabled(true);
J.setEnabled(L!==null);
...
qx.Class.define(a,{extend:demobrowser.demo.util.PropertyGroup,statics:{BOX_PROPERTIES:{"flex":{type:"int",min:-1000,nullable:true}},BASIC_PROPERTIES:{"top":{type:"int",min:-1000,nullable:true},"left":{type:"int",min:-1000,nullable:true}},CANVAS_PROPERTIES:{"top":{type:"string",nullable:true,convert:function(l){if(parseInt(l).toString()==l){l=parseInt(l);
}return l||null;
}},"right":{type:"string",nullable:true,convert:function(h){if(parseInt(h).toString()==h){h=parseInt(h);
}return h||null;
}},"bottom":{type:"string",nullable:true,convert:function(i){if(parseInt(i).toString()==i){i=parseInt(i);
}return i||null;
}},"left":{type:"string",nullable:true,convert:function(n){if(parseInt(n).toString()==n){n=parseInt(n);
}return n||null;
...
}}},DOCK_PROPERTIES:{"width":{type:"int",nullable:true,convert:function(f){return f==null?null:f+"%";
...
},_getProperty:function(k,name){return k.getLayoutProperties()[name]||null;
},_hasProperty:function(g,name){return true;
}}});
})();
