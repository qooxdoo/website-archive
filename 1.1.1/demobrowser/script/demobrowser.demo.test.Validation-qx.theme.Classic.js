...
(function(){var m="<br>",l="new name: ",k="new gender: ",j="male",i="female",h="new age: ",g="demobrowser.demo.test.Validation",f="<b>Setting the age ",e="property to 27</b><br>",d="- name: Name is validated to a minimum length of two.<br/>",S="<br>old name: ",R=")",Q="age:",P="fmale",O="<br><b>Setting the name to 'Hans'</b><br>",N="property to 'female'</b><br>",M="<br><b>Setting the gender ",L="must be longer than one characters. (",K="<b>Testing the gender ",J="__Le",t="<br>old gender: ",u="<br><b>Setting the age ",r="- age: Age is validated to be a number.<br/>",s="<b>Initial property values</b><br>",p="",q="<b>Setting the name to ''</b><br>",n="demobrowser.demo.test.Person",o="property to 'true'</b><br>",v="- gender: Gender is validated to be either male or female.",w="property to 'fmale'</b><br>",B="<font color='red'>GENDER NOT SET</font>",A="gender:",D="<br>old age: ",C="Hans",F="The demo creates an internal class containing three properties:<br/>",E="Validation Error: Name ",y="<font color='red'>AGE NOT SET</font>",I="My name",H="<font color='red'>NAME NOT SET</font>",G="white",x="name:",z="<b>Description</b><br/>";
...
b.setHtml(b.getHtml()+A+a.getGender()+m);
b.setHtml(b.getHtml()+O);
a.setName(C);
b.setHtml(b.getHtml()+l+a.getName()+m);
b.setHtml(b.getHtml()+q);
try{a.setName(p);
b.setHtml(b.getHtml()+l+a.getName()+m);
}catch(W){b.setHtml(b.getHtml()+H+S+a.getName()+m);
}b.setHtml(b.getHtml()+u+e);
a.setAge(27);
b.setHtml(b.getHtml()+h+a.getAge()+m);
b.setHtml(b.getHtml()+f+o);
try{a.setAge(true);
b.setHtml(b.getHtml()+h+a.getAge()+m);
}catch(T){b.setHtml(b.getHtml()+y+D+a.getAge()+m);
}b.setHtml(b.getHtml()+M+N);
a.setGender(i);
b.setHtml(b.getHtml()+k+a.getGender()+m);
b.setHtml(b.getHtml()+K+w);
try{a.setAge(P);
b.setHtml(b.getHtml()+k+a.getGender()+m);
}catch(U){b.setHtml(b.getHtml()+B+t+a.getGender()+m);
}var c=new qx.ui.basic.Label();
c.setRich(true);
c.setWidth(250);
c.setValue(z+F+d+r+v);
this.getRoot().add(c,{left:280,top:10});
}}});
qx.Class.define(n,{extend:qx.core.Object,properties:{name:{init:I,validate:J},age:{init:18,validate:qx.util.Validate.number()},gender:{init:j,validate:qx.util.Validate.inArray([j,i])}},members:{__Le:function(V){if(V.length<2){throw new qx.core.ValidationError(E+L+V+R);
}}}});
})();
