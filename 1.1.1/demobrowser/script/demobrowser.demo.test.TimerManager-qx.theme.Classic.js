...
(function(){var l="Stopping recurrent 2-second timer",k="Recurrent 2-second timer with limit 3:",j="\n",i="One-shot 1-second timer: ",h=" ",g="__Lk",f="demobrowser.demo.test.TimerManager",e="Recurrent 5-second timer: ",d="Start timers",c="execute";
qx.Class.define(f,{extend:qx.application.Standalone,members:{__Lk:null,startTimers:function(){var v=qx.util.TimerManager.getInstance();
v.start(function(a,b){this.__Ll(e+b);
},5000,this,null,0);
v.start(function(r,s){this.__Ll(i+s);
},0,this,null,1000);
v.start(function(t,u){this.__Ll(k+u);

if(++t.count==3){this.__Ll(l);
v.stop(u);
}},2000,this,{count:0},2000);
},__Ll:function(q){q=Date.parse(new Date)+h+q+j;
this.__Lk.setValue(this.__Lk.getValue()+q);
...
o.addListener(c,function(){o.setEnabled(false);
this.startTimers();
},this);
