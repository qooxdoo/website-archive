...
var N=function(e){var V=e.getData();
this._events.addRows([[e.getType(),V.ascending?B:n,V.columnIndex]],0);
};
...
U.add(T);
S=new qx.ui.toolbar.CheckBox(y,H).set({value:true});
T.add(S);
S.addListener(f,function(e){if(S.isValue()){this._events.setData([]);
