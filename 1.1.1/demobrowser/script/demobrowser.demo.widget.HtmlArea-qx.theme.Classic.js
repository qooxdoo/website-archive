...
qx.Class.define(o,{extend:qx.application.Standalone,members:{__LH:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var P=h+k+g+c+d+n+a+b;
var K=new qx.ui.basic.Label(P);
K.set({rich:true,marginBottom:10});
var O=m;
var N=this.getRoot();
var M=new qx.ui.decoration.Single(1,l,f);
M.setWidthTop(0);
this.__LH=new qx.ui.embed.HtmlArea(O,null,"blank.html");
this.__LH.set({width:600,height:400,decorator:M});
var toolbar=this.__LR();
var J=new qx.ui.layout.VBox(0);
var L=new qx.ui.container.Composite(J);
L.add(K);
L.add(toolbar);
L.add(this.__LH);
N.add(L,{left:20,top:20});
},__LI:function(e){var I=window.prompt("Color (Hex): ","#");
this.setTextColor(I);
},__LJ:function(e){var S=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(S);
},__LK:function(e){var Q={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(Q);
},__LL:function(e){var G="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(G);
},__LM:function(e){var q=new qx.ui.window.Window("Insert Hyperlink");
q.setLayout(new qx.ui.layout.VBox(20));
q.set({width:400,showMaximize:false,showMinimize:false});
var u=new qx.ui.form.TextField("http://");
q.add(u);
var s=new qx.ui.layout.HBox(10);
s.setAlignX("right");
var t=new qx.ui.container.Composite(s);
var p=new qx.ui.form.Button("OK");
p.setWidth(60);
p.addListener("execute",function(e){this.insertHyperLink(u.getValue());
q.close();
},this);
t.add(p);
var r=new qx.ui.form.Button("Cancel");
r.setWidth(60);
r.addListener("execute",function(e){q.close();
},this);
t.add(r);
q.add(t);
q.center();
q.open();
this.saveRange();
},__LN:function(e){var H=window.prompt("HTML Code:","");
this.insertHtml(H);
},__LO:function(){var B=new qx.ui.form.SelectBox;
B.set({toolTipText:"Change Font Family",focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
B.add(new qx.ui.form.ListItem(""));
var C=["Tahoma","Verdana","Times New Roman","Arial","Arial Black","Courier New","Courier","Georgia","Impact","Comic Sans MS","Lucida Console"];
var A;

for(var i=0,j=C.length;i<j;i++){A=new qx.ui.form.ListItem(C[i]);
A.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString("12px "+C[i])});
B.add(A);
}B.addListener("changeSelection",function(e){var R=e.getData()[0].getLabel();

if(R!=""){this.setFontFamily(R);
B.setSelection([B.getChildren()[0]]);
}},this.__LH);
return B;
},__LP:function(){var E=new qx.ui.form.SelectBox;
E.set({toolTipText:"Change Font Size",focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
E.add(new qx.ui.form.ListItem(""));
var D;

for(var i=1;i<=7;i++){D=new qx.ui.form.ListItem(i+"");
D.set({focusable:false,keepFocus:true});
E.add(D);
}E.addListener("changeSelection",function(e){var F=e.getData()[0].getLabel();

if(F!=""){this.setFontSize(F);
E.setSelection([E.getChildren()[0]]);
}},this.__LH);
return E;
},__LQ:function(){return [{bold:{text:"Format Bold",image:"qx/icon/Oxygen/16/actions/format-text-bold.png",action:this.__LH.setBold},italic:{text:"Format Italic",image:"qx/icon/Oxygen/16/actions/format-text-italic.png",action:this.__LH.setItalic},underline:{text:"Format Underline",image:"qx/icon/Oxygen/16/actions/format-text-underline.png",action:this.__LH.setUnderline},strikethrough:{text:"Format Strikethrough",image:"qx/icon/Oxygen/16/actions/format-text-strikethrough.png",action:this.__LH.setStrikeThrough},removeFormat:{text:"Remove Format",image:"qx/icon/Oxygen/16/actions/edit-clear.png",action:this.__LH.removeFormat}},{alignLeft:{text:"Align Left",image:"qx/icon/Oxygen/16/actions/format-justify-left.png",action:this.__LH.setJustifyLeft},alignCenter:{text:"Align Center",image:"qx/icon/Oxygen/16/actions/format-justify-center.png",action:this.__LH.setJustifyCenter},alignRight:{text:"Align Right",image:"qx/icon/Oxygen/16/actions/format-justify-right.png",action:this.__LH.setJustifyRight},alignJustify:{text:"Align Justify",image:"qx/icon/Oxygen/16/actions/format-justify-fill.png",action:this.__LH.setJustifyFull}},{fontFamily:{custom:this.__LO},fontSize:{custom:this.__LP},fontColor:{text:"Set Text Color",image:"demobrowser/demo/icons/htmlarea/format-text-color.png",action:this.__LI},textBackgroundColor:{text:"Set Text Background Color",image:"demobrowser/demo/icons/htmlarea/format-fill-color.png",action:this.__LJ}},{indent:{text:"Indent More",image:"qx/icon/Oxygen/16/actions/format-indent-more.png",action:this.__LH.insertIndent},outdent:{text:"Indent Less",image:"qx/icon/Oxygen/16/actions/format-indent-less.png",action:this.__LH.insertOutdent}},{insertImage:{text:"Insert Image",image:"qx/icon/Oxygen/16/actions/insert-image.png",action:this.__LK},insertTable:{text:"Insert Table",image:"demobrowser/demo/icons/htmlarea/insert-table.png",action:this.__LL},insertLink:{text:"Insert Link",image:"qx/icon/Oxygen/16/actions/insert-link.png",action:this.__LM},insertHTML:{text:"Insert HTML Code",image:"demobrowser/demo/icons/htmlarea/insert-text.png",action:this.__LN},insertHR:{text:"Insert Horizontal Ruler",image:"demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",action:this.__LH.insertHorizontalRuler}},{ol:{text:"Insert Ordered List",image:"demobrowser/demo/icons/htmlarea/format-list-ordered.png",action:this.__LH.insertOrderedList},ul:{text:"Inserted Unordered List",image:"demobrowser/demo/icons/htmlarea/format-list-unordered.png",action:this.__LH.insertUnorderedList}},{undo:{text:"Undo Last Change",image:"qx/icon/Oxygen/16/actions/edit-undo.png",action:this.__LH.undo},redo:{text:"Redo Last Undo Step",image:"qx/icon/Oxygen/16/actions/edit-redo.png",action:this.__LH.redo}}];
},__LR:function(){var toolbar=new qx.ui.toolbar.ToolBar;
...
for(var y in w[i]){var z=w[i][y];

if(z.custom){v=z.custom.call(this);
}else{v=new qx.ui.toolbar.Button(null,z.image);
v.set({focusable:false,keepFocus:true,center:true,toolTipText:z.text?z.text:""});
v.addListener("execute",z.action,this.__LH);
}x.add(v);
}}return toolbar;
}}});
})();
