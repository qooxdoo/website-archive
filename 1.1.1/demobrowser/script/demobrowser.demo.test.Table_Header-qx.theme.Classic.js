...
l.addListener(d,function(e){var j=e.getTarget();

if(j instanceof qx.ui.table.headerrenderer.HeaderCell){var k=l._indexOf(j);
l.setMouseOverColumn(k);
}});
var n=new qx.ui.form.ToggleButton(h);
this.getRoot().add(n,{left:20,top:100});
n.addListener(c,function(e){var i=e.getData();
