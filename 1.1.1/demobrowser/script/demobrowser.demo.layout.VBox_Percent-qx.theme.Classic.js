...
I.add(H,{flex:1});
return I;
},getBox2:function(){var r=new qx.ui.layout.VBox();
var t=new qx.ui.container.Composite(r).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
r.setSpacing(5);
...
t.add(v,{height:d});
t.add(u,{height:d});
t.add(s,{height:d,flex:1});
return t;
},getBox3:function(){var m=new qx.ui.layout.VBox();
var o=new qx.ui.container.Composite(m).set({decorator:f,backgroundColor:c,allowGrowY:false});
m.setSpacing(5);
...
o.add(n,{flex:1});
return o;
},getBox4:function(){var g=new qx.ui.layout.VBox();
...
var y=new qx.ui.container.Composite(w).set({decorator:f,backgroundColor:c,height:100,allowGrowY:false});
w.setSpacing(5);
