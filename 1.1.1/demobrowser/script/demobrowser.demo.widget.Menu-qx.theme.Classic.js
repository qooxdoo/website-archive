...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Menu","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Menu-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"90bde1788646"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var dD="execute",dC="changeValue",dB="icon/16/actions/edit-cut.png",dA="changeSelection",dz="icon/16/actions/edit-paste.png",dy="Copy",dx="Paste",dw="icon/16/actions/edit-copy.png",dv="Cut",du="icon/16/actions/system-search.png",cV="New",cU="Undo",cT="icon/16/actions/document-save.png",cS="Redo",cR="icon/22/apps/preferences-users.png",cQ="icon/16/actions/document-print.png",cP="icon/16/actions/document-open.png",cO="icon/16/actions/edit-undo.png",cN="Save",cM="icon/16/actions/edit-redo.png",dK="Print",dL="Open",dI="icon/16/actions/document-new.png",dJ="Online Forum",dG="__LF",dH="icon/16/actions/format-justify-fill.png",dE="Search in files",dF="C",dM="Left aligned",dN="Perl",dm="View",dl="C Dialect",dp="Info...",dn="Save as...",dr="Show line numbers",dq="__LG",dt="Quickstart",ds="icon/16/actions/contact-new.png",dk="Ctrl+N",dj="Actions",bD="Show console",bE="Search",bF="Help",bG="Show status bar",bH="icon/16/actions/format-justify-left.png",bI="ANSI to OEM",bJ="Centered",bK="Website 3",bL="Edit",bM="icon/16/actions/format-justify-center.png",dR="icon/16/actions/go-previous.png",dQ="C Sharp",dP="Close",dO="Website 2",dV="icon/16/actions/document-save-as.png",dU="Python",dT="icon/16/apps/utilities-help.png",dS="Show tree",dX="Options",dW="Spaces to tabs",cm="Right aligned",cn="Action 1",ck="OEM to ANSI",cl="Line 431",cq="JavaScript",cr="icon",co="Action 2",cp="Folder ",ci="XML",cj="Line 313",bU="Paragraph",bT="demobrowser.demo.widget.Menu",bW="icon/16/actions/application-exit.png",bV="C Plus Plus",bQ="Line 26",bP="Item ",bS="ASCII table",bR="Option 1",bO="Search next...",bN="Line 12",cw="Action 3",cx="Replace in files",cy="Uppercase",cz="Topics",cs="Panes",ct="Justified",cu="__LB",cv="Show macros",cA="Search previous...",cB="Back",cf="main",ce="__LC",cd="icon/16/actions/format-justify-right.png",cc="icon/16/actions/go-next.png",cb="command ",ca="Option 3",bY="Next",bX="Show tags",ch="Capitals",cg="Format",cC="File",cD="Show tabs",cE="Split Button",cF="__LD",cG="Tabs to spaces",cH="Search...",cI="Line 1039",cJ="Option 2",cK="Objective C",cL="Exit",da="__LA",cY="move to",cX="__Lz",cW="Syntax",de="Show ruler",dd="Website 1",dc="Menu Button",db="Line 30",dg="Lowercase",df="Replace",dh="__LE",di="HTML";
qx.Class.define(bT,{extend:qx.application.Standalone,members:{__Lz:null,__LA:null,__LB:null,__LC:null,__LD:null,__LE:null,__LF:null,__LG:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bC=new qx.ui.container.Scroll();
var bB=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
bB.setPadding(20);
bB.setAllowStretchX(false);
bC.add(bB);
this.getRoot().add(bC,{edge:0});
this.createCommands();
bB.add(this.getMenuButton(),{left:20,top:20});
bB.add(this.getSplitButton(),{left:150,top:20});
bB.add(this.getMenuBar(),{left:20,top:100});
bB.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var ec=new qx.ui.menu.Menu();
var ed=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){ed.add(new qx.ui.menu.Button(cp+(i+1)));
}ec.add(new qx.ui.menu.Button(cY,null,null,ed));
ec.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){ec.add(new qx.ui.menu.Button(cb+(i+1)));
}return ec;
...
},createCommands:function(){this.__Lz=new qx.ui.core.Command(dk);
this.__Lz.addListener(dD,this.debugCommand);
this.__LA=new qx.ui.core.Command("Ctrl+O");
this.__LA.addListener(dD,this.debugCommand);
this.__LB=new qx.ui.core.Command("Ctrl+S");
this.__LB.addListener(dD,this.debugCommand);
this.__LC=new qx.ui.core.Command("Ctrl+Z");
this.__LC.addListener(dD,this.debugCommand);
this.__LD=new qx.ui.core.Command("Ctrl+R");
this.__LD.addListener(dD,this.debugCommand);
this.__LE=new qx.ui.core.Command("Ctrl+X");
this.__LE.addListener(dD,this.debugCommand);
this.__LF=new qx.ui.core.Command("Ctrl+C");
this.__LF.addListener(dD,this.debugCommand);
this.__LG=new qx.ui.core.Command("Ctrl+P");
this.__LG.addListener(dD,this.debugCommand);
this.__LG.setEnabled(false);
},getMenuButton:function(){var v=new qx.ui.menu.Menu;
v.add(new qx.ui.menu.RadioButton(bR));
v.add(new qx.ui.menu.RadioButton(cJ));
v.add(new qx.ui.menu.RadioButton(ca));
var D=new qx.ui.menu.Menu;
D.add(new qx.ui.menu.RadioButton(cn));
D.add(new qx.ui.menu.RadioButton(co));
D.add(new qx.ui.menu.RadioButton(cw));
var C=new qx.ui.form.RadioGroup;
C.add.apply(C,v.getChildren());
C.addListener(dA,this.debugRadio);
var A=new qx.ui.form.RadioGroup;
A.add.apply(A,D.getChildren());
A.addListener(dA,this.debugRadio);
var y=new qx.ui.menu.Menu();
var B=new qx.ui.menu.Button(cU,cO,this.__LC);
var I=new qx.ui.menu.Button(cS,cM,this.__LD);
var x=new qx.ui.menu.Button(dv,dB,this.__LE);
var F=new qx.ui.menu.Button(dy,dw,this.__LF);
var z=new qx.ui.menu.Button(dx,dz,this.__LG);
var w=new qx.ui.menu.Button(dX,du,null,v);
var G=new qx.ui.menu.Button(dj,ds,null,D);
var E=new qx.ui.menu.Button(dK,cQ);
B.addListener(dD,this.debugButton);
I.addListener(dD,this.debugButton);
x.addListener(dD,this.debugButton);
F.addListener(dD,this.debugButton);
z.addListener(dD,this.debugButton);
w.addListener(dD,this.debugButton);
G.addListener(dD,this.debugButton);
E.addListener(dD,this.debugButton);
y.add(B);
y.add(I);
y.addSeparator();
y.add(x);
...
y.addSeparator();
y.add(E);
var H=new qx.ui.form.MenuButton(dc,cR,y);
return H;
},getSplitButton:function(){var es=new qx.ui.menu.Menu;
var ew=new qx.ui.menu.Button(dd);
var eu=new qx.ui.menu.Button(dO);
var ev=new qx.ui.menu.Button(bK);
es.setMinWidth(120);
ew.addListener(dD,this.debugButton);
eu.addListener(dD,this.debugButton);
ev.addListener(dD,this.debugButton);
es.add(ew);
es.add(eu);
es.add(ev);
var et=new qx.ui.form.SplitButton(cE,cR,es);
et.addListener(dD,this.debugButton);
return et;
},getMenuBar:function(){var eB=new qx.ui.container.Composite(new qx.ui.layout.Grow);
eB.setDecorator(cf);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
eB.add(toolbar);
var eK=new qx.ui.toolbar.Part;
var eA=new qx.ui.toolbar.Part;
var eE=new qx.ui.toolbar.Part;
toolbar.add(eK);
toolbar.add(eA);
toolbar.addSpacer();
toolbar.add(eE);
var eJ=new qx.ui.toolbar.SplitButton(cB,dR,this.getBackMenu());
var eG=new qx.ui.toolbar.SplitButton(bY,cc,this.getForwardMenu());
var ez=new qx.ui.toolbar.Button(cV,dI,this.__Lz);
var eD=new qx.ui.toolbar.Button(dL,cP,this.__LA);
var eI=new qx.ui.toolbar.Button(cN,cT,this.__LB);
eJ.addListener(dD,this.debugButton);
eG.addListener(dD,this.debugButton);
ez.addListener(dD,this.debugButton);
eD.addListener(dD,this.debugButton);
eI.addListener(dD,this.debugButton);
eK.add(eJ);
eK.add(eG);
eK.addSeparator();
eK.add(ez);
...
eK.add(eI);
eK.setShow(cr);
var eC=new qx.ui.toolbar.MenuButton(cC);
var ey=new qx.ui.toolbar.MenuButton(bL);
var ex=new qx.ui.toolbar.MenuButton(bE);
var eL=new qx.ui.toolbar.MenuButton(dm);
var eH=new qx.ui.toolbar.MenuButton(cg);
eC.setMenu(this.getFileMenu());
ey.setMenu(this.getEditMenu());
ex.setMenu(this.getSearchMenu());
eL.setMenu(this.getViewMenu());
eH.setMenu(this.getFormatMenu());
eA.add(eC);
eA.add(ey);
eA.add(ex);
eA.add(eL);
eA.add(eH);
var eF=new qx.ui.toolbar.MenuButton(bF);
eF.setMenu(this.getHelpMenu());
eE.add(eF);
return eB;
},getBackMenu:function(){var bf=new qx.ui.menu.Menu;
var bg=new qx.ui.menu.Button(cj);
var bi=new qx.ui.menu.Button(cI);
var be=new qx.ui.menu.Button(bN);
var bh=new qx.ui.menu.Button(bQ);
bg.addListener(dD,this.debugButton);
bi.addListener(dD,this.debugButton);
be.addListener(dD,this.debugButton);
bh.addListener(dD,this.debugButton);
bf.add(bg);
bf.add(bi);
bf.add(be);
bf.add(bh);
return bf;
},getForwardMenu:function(){var dY=new qx.ui.menu.Menu;
var ea=new qx.ui.menu.Button(cl);
var eb=new qx.ui.menu.Button(db);
ea.addListener(dD,this.debugButton);
eb.addListener(dD,this.debugButton);
dY.add(ea);
dY.add(eb);
return dY;
},getFileMenu:function(){var X=new qx.ui.menu.Menu;
var V=new qx.ui.menu.Button(cV,dI,this.__Lz);
var ba=new qx.ui.menu.Button(dL,cP,this.__LA);
var Y=new qx.ui.menu.Button(dP);
var bd=new qx.ui.menu.Button(cN,cT,this.__LB);
var bc=new qx.ui.menu.Button(dn,dV);
var bb=new qx.ui.menu.Button(dK,cQ);
var W=new qx.ui.menu.Button(cL,bW);
V.addListener(dD,this.debugButton);
ba.addListener(dD,this.debugButton);
Y.addListener(dD,this.debugButton);
bd.addListener(dD,this.debugButton);
bc.addListener(dD,this.debugButton);
bb.addListener(dD,this.debugButton);
W.addListener(dD,this.debugButton);
X.add(V);
X.add(ba);
X.add(Y);
...
X.add(W);
return X;
},getEditMenu:function(){var ef=new qx.ui.menu.Menu;
var ei=new qx.ui.menu.Button(cU,cO,this.__LC);
var eh=new qx.ui.menu.Button(cS,cM,this.__LD);
var ee=new qx.ui.menu.Button(dv,dB,this.__LE);
var ej=new qx.ui.menu.Button(dy,dw,this.__LF);
var eg=new qx.ui.menu.Button(dx,dz,this.__LG);
ei.addListener(dD,this.debugButton);
eh.addListener(dD,this.debugButton);
ee.addListener(dD,this.debugButton);
ej.addListener(dD,this.debugButton);
eg.addListener(dD,this.debugButton);
ef.add(ei);
ef.add(eh);
...
ef.add(eg);
return ef;
},getSearchMenu:function(){var M=new qx.ui.menu.Menu;
var K=new qx.ui.menu.Button(cH,du);
var P=new qx.ui.menu.Button(bO);
var L=new qx.ui.menu.Button(cA);
var O=new qx.ui.menu.Button(df);
var J=new qx.ui.menu.Button(dE,du);
var N=new qx.ui.menu.Button(cx);
L.setEnabled(false);
K.addListener(dD,this.debugButton);
P.addListener(dD,this.debugButton);
L.addListener(dD,this.debugButton);
O.addListener(dD,this.debugButton);
J.addListener(dD,this.debugButton);
N.addListener(dD,this.debugButton);
M.add(K);
M.add(P);
M.add(L);
M.add(O);
...
var c=new qx.ui.menu.Button(cs,null,null,this.getPanesMenu());
var g=new qx.ui.menu.Button(cW,null,null,this.getSyntaxMenu());
var f=new qx.ui.menu.CheckBox(de);
var d=new qx.ui.menu.CheckBox(dr);
var b=new qx.ui.menu.Button(bS);
f.addListener(dC,this.debugCheckBox);
d.addListener(dC,this.debugCheckBox);
b.addListener(dD,this.debugButton);
a.add(c);
a.add(g);
a.addSeparator();
...
a.add(b);
return a;
},getPanesMenu:function(){var bv=new qx.ui.menu.Menu;
var bx=new qx.ui.menu.CheckBox(cD);
var bz=new qx.ui.menu.CheckBox(bG);
var bA=new qx.ui.menu.CheckBox(dS);
var bw=new qx.ui.menu.CheckBox(cv);
var by=new qx.ui.menu.CheckBox(bX);
var bu=new qx.ui.menu.CheckBox(bD);
bx.setValue(true);
bz.setValue(true);
bw.setValue(true);
bx.addListener(dC,this.debugCheckBox);
bz.addListener(dC,this.debugCheckBox);
bA.addListener(dC,this.debugCheckBox);
bw.addListener(dC,this.debugCheckBox);
by.addListener(dC,this.debugCheckBox);
bu.addListener(dC,this.debugCheckBox);
bv.add(bz);
bv.add(bx);
bv.addSeparator();
bv.add(bA);
...
bv.add(bu);
return bv;
},getSyntaxMenu:function(){var eo=new qx.ui.menu.Menu;
var ek=new qx.ui.menu.RadioButton(di);
var em=new qx.ui.menu.RadioButton(ci);
var el=new qx.ui.menu.RadioButton(cq);
var en=new qx.ui.menu.Button(dl,null,null,this.getSyntaxCMenu());
var er=new qx.ui.menu.RadioButton(dN);
var ep=new qx.ui.menu.RadioButton(dU);
eo.add(ek);
eo.add(em);
eo.add(el);
eo.add(en);
eo.add(er);
eo.add(ep);
var eq=new qx.ui.form.RadioGroup;
eq.add(ek,em,el,er,ep);
eq.add.apply(eq,en.getMenu().getChildren());
eq.addListener(dA,this.debugRadio);
return eo;
},getSyntaxCMenu:function(){var bk=new qx.ui.menu.Menu;
var bj=new qx.ui.menu.RadioButton(dF);
var bn=new qx.ui.menu.RadioButton(dQ);
var bm=new qx.ui.menu.RadioButton(cK);
var bl=new qx.ui.menu.RadioButton(bV);
bk.add(bj);
bk.add(bn);
bk.add(bm);
bk.add(bl);
return bk;
},getFormatMenu:function(){var p=new qx.ui.menu.Menu;
var o=new qx.ui.menu.Button(bU,null,null,this.getParagraphMenu());
var r=new qx.ui.menu.Button(cG);
var s=new qx.ui.menu.Button(dW);
var n=new qx.ui.menu.Button(cy);
var q=new qx.ui.menu.Button(dg);
var m=new qx.ui.menu.Button(ch);
var u=new qx.ui.menu.Button(ck);
var t=new qx.ui.menu.Button(bI);
r.addListener(dD,this.debugButton);
s.addListener(dD,this.debugButton);
n.addListener(dD,this.debugButton);
q.addListener(dD,this.debugButton);
m.addListener(dD,this.debugButton);
u.addListener(dD,this.debugButton);
t.addListener(dD,this.debugButton);
p.add(o);
p.add(r);
p.add(s);
p.addSeparator();
...
p.add(t);
return p;
},getParagraphMenu:function(){var bp=new qx.ui.menu.Menu;
var bs=new qx.ui.menu.Button(dM,bH);
var bt=new qx.ui.menu.Button(cm,cd);
var bq=new qx.ui.menu.Button(bJ,bM);
var br=new qx.ui.menu.Button(ct,dH);
bs.addListener(dD,this.debugButton);
bt.addListener(dD,this.debugButton);
bq.addListener(dD,this.debugButton);
br.addListener(dD,this.debugButton);
bp.add(bs);
bp.add(bt);
bp.add(bq);
bp.add(br);
return bp;
},getHelpMenu:function(){var Q=new qx.ui.menu.Menu;
var S=new qx.ui.menu.Button(cz,dT);
var U=new qx.ui.menu.Button(dt);
var T=new qx.ui.menu.Button(dJ);
var R=new qx.ui.menu.Button(dp);
S.addListener(dD,this.debugButton);
U.addListener(dD,this.debugButton);
T.addListener(dD,this.debugButton);
R.addListener(dD,this.debugButton);
...
Q.add(R);
return Q;
},getList:function(){var bo=new qx.ui.form.List;
bo.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){bo.add(new qx.ui.form.ListItem(bP+i));
}return bo;
},getContextMenu:function(){var h=new qx.ui.menu.Menu;
var k=new qx.ui.menu.Button(dv,dB,this.__LE);
var l=new qx.ui.menu.Button(dy,dw,this.__LF);
var j=new qx.ui.menu.Button(dx,dz,this.__LG);
k.addListener(dD,this.debugButton);
l.addListener(dD,this.debugButton);
j.addListener(dD,this.debugButton);
h.add(k);
...
h.add(j);
return h;
}},destruct:function(){this._disposeObjects(cX,da,cu,ce,cF,dh,dG,dq);
}});
})();
