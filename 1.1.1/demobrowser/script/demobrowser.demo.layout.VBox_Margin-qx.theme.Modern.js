...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox_Margin","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_Margin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d308a7bc5b50"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="main",i="green",h="yellow",g="center",f="demobrowser.demo.layout.VBox_Margin";
...
o.add(this.getBox4());
o.add(this.getBox5());
},getBox1:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:j,backgroundColor:h,allowGrowY:false});
var s=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var r=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
var p=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
q.add(s);
q.add(r);
q.add(p);
...
p.setMarginRight(30);
return q;
},getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:j,backgroundColor:h,allowGrowY:false});
...
k.setMarginRight(30);
return l;
},getBox3:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:j,backgroundColor:h,width:150,allowGrowY:false});
a.setSpacing(5);
a.setAlignX(g);
...
c.add(d);
c.add(b);
e.setAllowGrowX(false);
d.setAllowGrowX(false);
b.setAllowGrowX(false);
e.setMarginLeft(20);
b.setMarginRight(30);
return c;
},getBox4:function(){var y=new qx.ui.layout.VBox();
var A=new qx.ui.container.Composite(y).set({decorator:j,backgroundColor:h,width:150,allowGrowY:false});
y.setSpacing(5);
y.setAlignX(g);
...
z.setMarginRight(20);
return A;
},getBox5:function(){var t=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(t).set({decorator:j,backgroundColor:h,width:150,allowGrowY:false});
t.setSpacing(5);
t.setAlignX(g);
...
var u=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i});
v.add(x);
v.add(w);
v.add(u);
x.setMarginLeft(20);
