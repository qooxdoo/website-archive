...
(function(){var o="top",n="right",m="resize",l="Name",k="Password",j="__KV",h="appear",g="__KW",f="__KX",d="demobrowser.demo.animation.Login",a="50%",c="execute",b="30%";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__KV:null,__KW:null,__KX:null,checkInput:function(){this.__KV.start();
},__KY:function(){this.__KV=new qx.fx.effect.combination.Shake(this.__KW.getContainerElement().getDomElement());
...
this.__KW.setLayout(r);
this.__KW.addListener(m,function(e){var p=this.__KW.getBounds();
this.__KW.set({marginTop:Math.round(-p.height/2),marginLeft:Math.round(-p.width/2)});
},this);
this.getRoot().add(this.__KW,{left:a,top:b});
var q=[l,k];

for(var i=0;i<q.length;i++){this.__KW.add(new qx.ui.basic.Label(q[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var s=new qx.ui.form.TextField();
var t=new qx.ui.form.PasswordField();
this.__KW.add(s.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__KW.add(t.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var u=this.__KX=new qx.ui.form.Button("Login");
u.setAllowStretchX(false);
this.__KW.add(u,{row:3,column:1});
u.addListener(c,this.checkInput,this);
this.__KW.addListener(h,this.__KY,this);
}},destruct:function(){this._disposeObjects(g,f,j);
}});
})();
