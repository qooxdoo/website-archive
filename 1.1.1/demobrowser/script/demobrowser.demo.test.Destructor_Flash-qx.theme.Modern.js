...
qx.Class.define(j,{extend:qx.application.Native,members:{__Li:null,__Lj:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__Li=[];
...
q.start();
},clear:function(){var m=this.__Li;
