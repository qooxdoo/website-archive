...
(function(){var l="",k="<b>HTML</b>",j="px;",i="Juhu",h="testImageCell",g="qx.theme",f="testNumberCell",e="width:",d="testHtmlCell",c="testDateCell",y="height:",x="testStringCell",w="testBooleanCellCustomImage",v="demobrowser.demo.virtual.Cells",u="testBooleanCell",t="foobar!",s="qx.theme.Modern",r="icon/32/apps/utilities-notes.png",q="medium",p="icon/16/emotes/face-sad.png",n="icon/16/apps/internet-feed-reader.png",o="icon/16/emotes/face-smile.png",m="This is a feed reader!";
...
var R=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(R);
this.runTest(x);
this.runTest(f);
this.runTest(c);
this.runTest(d);
if(qx.core.Setting.get(g)==s){this.runTest(h);
this.runTest(u);
this.runTest(w);
...
},testStringCell:function(){var T={value:[i,k,l,null],states:[{},{selected:1}]};
var S=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(T,function(W){var X=this.__LW(S,W.value,W.states);
this.container.add(X);
},this);
},testNumberCell:function(){var z={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var A=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(z,function(bb){if(bb.format){A.setNumberFormat(bb.format);
}else{A.resetNumberFormat();
}var bc=this.__LW(A,bb.value,bb.states);
this.container.add(bc);
},this);
},testDateCell:function(){var U={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(q))],states:[{},{selected:1}]};
var V=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(U,function(F){if(F.format){V.setDateFormat(F.format);
}else{V.resetDateFormat();
}var G=this.__LW(V,F.value,F.states);
this.container.add(G);
},this);
},testHtmlCell:function(){var bf={value:[i,k,l,null],states:[{},{selected:1}]};
var bg=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(bf,function(a){var b=this.__LW(bg,a.value,a.states);
this.container.add(b);
},this);
},testImageCell:function(){var bd={value:[{url:n,tooltip:m},{url:r,tooltip:t},null],states:[{},{selected:1}]};
var be=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(bd,function(Y){var ba=this.__LW(be,Y.value,Y.states);
this.container.add(ba);
},this);
},testBooleanCell:function(){var H={value:[true,false,null],states:[{},{selected:1}]};
var I=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(H,function(D){var E=this.__LW(I,D.value,D.states);
...
C.setIconFalse(p);
C.setIconTrue(o);
qx.util.Permutation.permute(B,function(O){var P=this.__LW(C,O.value,O.states);
this.container.add(P);
},this);
},__LW:function(bh,bi,bj){var bn=100;
var bl=30;
var bp=new qx.ui.embed.Html().set({width:bn,height:bl,decorator:bj.selected?null:"main"});
var bk=bh.getCellProperties(bi,bj);
var bm=bk.insets;
var bo=["<div ","style='",this._getCellSizeStyle(bn,bl,bm[0],bm[1]),bk.style,"' ","class='",bk.classes,"' ",bk.attributes,">",bk.content,"</div>"].join("");
bp.setHtml(bo);
return bp;
},_getCellSizeStyle:function(J,K,L,M){var N=l;
...
qx.Class.define(s,{extend:qx.ui.virtual.cell.Cell,type:n,construct:function(){qx.ui.virtual.cell.Cell.call(this);
this._aliasManager=qx.util.AliasManager.getInstance();
},members:{__wd:16,__we:16,_aliasManager:null,__wf:function(G){var J=qx.util.ResourceManager.getInstance();
...
},__wg:function(C){if(typeof (C)==q){C={url:C};
...
var d=this.__wg(this._identifyImage(a));
...
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__Dh:null,__Di:null,__Dg:null,_applyIconTrue:function(h){this.__Dh=this.__Dg.resolve(h);
},_applyIconFalse:function(f){this.__Di=this.__Dg.resolve(f);
},_identifyImage:function(g){return g==true?this.__Dh:this.__Di;
}}});
})();
