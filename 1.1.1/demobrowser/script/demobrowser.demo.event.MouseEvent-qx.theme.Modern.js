...
}qx.bom.Element.addListener(G,k,this.__Lq,this);
}var E=document.getElementById(a);
E.checked=false;
qx.bom.Element.addListener(E,k,function(e){var L=e.getTarget().checked;

if(L){qx.bom.Element.capture(D);
}else{qx.bom.Element.releaseCapture(D);
}},this);
qx.bom.Element.addListener(D,q,function(e){E.checked=false;
},this);
},__Lq:function(e){var J=e.getTarget().id.split(x)[1];
...
this._log([K.getTarget().id,K.getType(),K.getButton(),K.getDocumentLeft(),K.getDocumentTop(),K.getScreenLeft(),K.getScreenTop(),K.getViewportLeft(),K.getViewportTop(),K.getRelatedTarget()?K.getRelatedTarget().id:y]);
}}});
})();
