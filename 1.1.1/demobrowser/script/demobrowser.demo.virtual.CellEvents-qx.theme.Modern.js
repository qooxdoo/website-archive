...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.CellEvents","qx.theme":"qx.theme.Modern"};
...
(function(){var o='</p>',n=' / ',m="logger",l='<p style="color:green;">You clicked on cell ',k="",j="cellClick",i='<p style="color:yellow;">You rightclicked cell ',h='<p style="color:red;">You double clicked cell ',g="demobrowser.demo.virtual.CellEvents",f="main",b="cellDblclick",d="cellContextmenu",c="layer";
...
var t=new qx.ui.virtual.core.Scroller(20,20,40,40).set({width:400,height:300});
this.layer=new qx.test.ui.virtual.layer.LayerSimple(this);
var s=t.getPane();
s.addListener(j,this._onCellClick,this);
s.addListener(d,this._onContextMenu,this);
s.addListener(b,this._onDblclickPane,this);
s.addLayer(this.layer);
this.logger=new qx.ui.embed.Html().set({width:400,height:300,html:k,decorator:f});
this.getRoot().add(t,{left:20,top:10});
this.getRoot().add(this.logger,{left:450,top:10});
},_onCellClick:function(e){var p=l+e.getRow()+n+e.getColumn()+o;
this.__Mb(p);
},_onContextMenu:function(e){var r=i+e.getRow()+n+e.getColumn()+o;
this.__Mb(r);
},_onDblclickPane:function(e){var a=h+e.getRow()+n+e.getColumn()+o;
this.__Mb(a);
},__Mb:function(q){this.logger.setHtml(this.logger.getHtml()+q);
}},destruct:function(){this._disposeObjects(c,m);
}});
})();
...
qx.Class.define(d,{extend:qx.ui.virtual.layer.Abstract,members:{getCellHtml:function(w,z,A,top,B,C){var content=w+j+z;
return [h,a,A,l,i,top,l,g,B,l,f,C,l,e,content,c].join(k);
},_fullUpdate:function(m,n,o,p){var s=[];
var t=0;
var top=0;
var v=m;
var u=n;

for(var x=0;x<o.length;x++){var t=0;
var u=n;
var q=o[x];

for(var y=0;y<p.length;y++){var r=p[y];
s[s.length]=this.getCellHtml(v,u,t,top,r,q);
u++;
t+=r;
}top+=q;
v++;
}this.getContentElement().setAttribute(b,s.join(k));
}}});
})();
