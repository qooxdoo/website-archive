...
var U={converter:function(a){return n+a+h;
}};
var Q=new qx.data.controller.List(T,L,A);
Q.setIconOptions(U);
Q.setIconPath(e);
var O={converter:function(W){if(W){return d;
}else{return w;
}}};
var J={bindItem:function(X,Y,ba){X.bindDefaultProperties(Y,ba);
X.bindProperty(C,s,O,Y,ba);
}};
Q.setDelegate(J);
