...
(function(){var h="main",g="green",f="yellow",e="top",d="bottom",c="middle",b="demobrowser.demo.layout.Spacer_HBox";
...
var a=this.getRoot();
a.add(this.getSpacerWithoutFlex(),{left:10,top:10});
a.add(this.getSpacerWithFlex(),{left:10,top:70});
a.add(this.getAddRemoveSpacer(),{left:10,top:200});
},getSpacerWithoutFlex:function(){var k=new qx.ui.container.Composite().set({decorator:h,backgroundColor:f,allowGrowX:false});
var l=new qx.ui.layout.HBox();
l.setSpacing(5);
k.setLayout(l);
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
k.add(new qx.ui.core.Spacer(30,40));
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
k.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return k;
},getSpacerWithFlex:function(){var i=new qx.ui.container.Composite().set({decorator:h,backgroundColor:f,height:100,width:400});
var j=new qx.ui.layout.HBox();
j.setSpacing(5);
i.setLayout(j);
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:e}));
i.add(new qx.ui.core.Spacer(30,40),{flex:1});
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:c}));
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:d}));
return i;
},getAddRemoveSpacer:function(){var m=new qx.ui.container.Composite().set({decorator:h,backgroundColor:f});
var o=new qx.ui.layout.HBox();
o.setSpacing(5);
m.setLayout(o);
m.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:e}));
m.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:c}));
var n=new qx.ui.core.Spacer(30,40);
m.add(n,{flex:1});
m.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:d}));
m.remove(n);
return m;
}}});
})();
