...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.ListController","qx.theme":"qx.theme.Modern"};
...
(function(){var G="execute",F="multi",E="Bound to the selection of the list to the left.",D="Item ",C="Remove an item",B="Write data to log",A="Add an item",z="",y="selection[0]",x="<b>Multi selection List</b><br/>",s="value",w="<b>Selection Label</b><br/>",v="white",r="<b>Selection List</b><br/>",q="main",u="demobrowser.demo.data.ListController",t="Bound to the same data and share the selection.";
...
for(var i=0;i<10;i++){l.push(D+i);
}var o=new qx.data.Array(l);
var c=new qx.ui.form.List();
c.setSelectionMode(F);
var f=new qx.ui.form.List();
f.setSelectionMode(F);
var e=new qx.ui.form.List();
this.getRoot().add(c,{left:10,top:80});
this.getRoot().add(f,{left:130,top:80});
this.getRoot().add(e,{left:250,top:80});
var j=new qx.data.controller.List(o,c);
var h=new qx.data.controller.List(o,f);
var g=new qx.data.controller.List(j.getSelection(),e);
h.setSelection(j.getSelection());
var m=new qx.ui.basic.Label(z);
this.getRoot().add(m,{left:370,top:80});
g.bind(y,m,s);
m.setWidth(120);
m.setDecorator(q);
...
p.setWidth(120);
this.getRoot().add(p,{left:370,top:110});
p.addListener(G,function(){o.push(D+o.length);
},this);
var d=new qx.ui.form.Button(C);
d.setWidth(120);
this.getRoot().add(d,{left:370,top:145});
d.addListener(G,function(){o.pop();
},this);
var k=new qx.ui.form.Button(B);
k.setWidth(120);
this.getRoot().add(k,{left:370,top:180});
k.addListener(G,function(){qx.log.appender.Console.show();
...
n.setWidth(200);
n.setValue(x+t);
this.getRoot().add(n,{left:20,top:10});
...
b.setWidth(100);
b.setValue(w+E);
this.getRoot().add(b,{left:380,top:10});
}}});
})();
