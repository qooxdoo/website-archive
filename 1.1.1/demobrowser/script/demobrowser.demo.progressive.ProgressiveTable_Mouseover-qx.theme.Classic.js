...
(function(){var u="row",t="",s="rgb(255, 0, 0)",r="celldata",q="onmouseover='demobrowser.demo.progressive.DateCellRenderer.onmouseover(this);' ",p="Number",o="red",n="1*",m="celldata='",l="' ",f="<br>",k="demobrowser.demo.progressive.ProgressiveTable_Mouseover",i="end",e="Date",d="Move your mouse over the Date field",h="demobrowser.demo.progressive.DateCellRenderer",g="color",j="Id",c="onmouseout='demobrowser.demo.progressive.DateCellRenderer.onmouseout(this);' ";
...
var N=0;
var J=function(y){var B=[];
var A=new Date().getTime();
var C=400*24*60*60*1000;

for(var D=0;D<y;D++){var z=new Date(A+Math.random()*C-C/2);
B.push({renderer:u,location:i,data:[N++,Math.random()*10000,z]});
}return B;
};
var M=new qx.ui.progressive.renderer.table.Widths(3);
M.setWidth(0,100);
M.setWidth(1,n);
M.setWidth(2,300);
var G=[j,p,e];
var I=new qx.ui.progressive.headfoot.TableHeading(M,G);
var F=new qx.ui.progressive.headfoot.Progress(M,G);
var P=new qx.ui.progressive.structure.Default(I,F);
var E=new qx.ui.progressive.Progressive(P);
var O=new qx.ui.basic.Atom(d);
O.setTextColor(o);
O.setHeight(16);
O.setRich(true);
E.add(O);
var L=new qx.ui.progressive.model.Default();
var K=J(500);
L.addElements(K);
E.setDataModel(L);
var H=new qx.ui.progressive.renderer.table.Row(M);
E.addRenderer(u,H);
H.addRenderer(2,new demobrowser.demo.progressive.DateCellRenderer());
this.getRoot().add(E,{edge:50});
E.render();
}}});
qx.Class.define(h,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(v){v.__Mw=qx.bom.element.Style.get(v,g);
v.style.color=s;
v.parentNode.style.height=32;
v.__Mx=v.innerHTML;
var x=Date.parse(v.attributes.getNamedItem(r).nodeValue);
var w=new Date(x);
v.innerHTML=w.toUTCString()+f+w.toString();
},onmouseout:function(Q){Q.style.color=Q.__Mw;
Q.parentNode.style.height=16;
Q.innerHTML=Q.__Mx;
}},members:{_getCellExtras:function(a){var b=[];
b.push(qx.ui.progressive.renderer.table.cell.Default.prototype._getCellExtras.call(this));
b.push(m+a.cellData.toUTCString()+l);
b.push(q,c);
return b.join(t);
}}});
})();
