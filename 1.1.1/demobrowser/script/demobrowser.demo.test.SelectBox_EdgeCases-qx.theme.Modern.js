...
n.setMaxListHeight(null);

for(var i=0;i<300;i++){var o=new qx.ui.form.ListItem(j+i);
n.add(o);
}this.container.add(n,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(h),{left:25,bottom:45});
var v=new qx.ui.form.SelectBox();
var q=new qx.bom.Font(12,[e]);
var r=new qx.bom.Font(15,[a]);
var p=new qx.bom.Font(18,[d]);
var t=new qx.bom.Font(21,[m]);
var s=[q,r,p,t];

for(var i=0;i<s.length;i++){var u=new qx.ui.form.ListItem(f+(i+1));
u.setFont(s[i]);
v.add(u);
}this.container.add(v,{left:20,bottom:20});
