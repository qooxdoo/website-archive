...
this.__MC=i;
this.filter=qx.lang.Function.bind(function(e){return e.search(this.getSearchString())!=-1;
},this);
this.__MD=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__MD:null,__MC:null,_applySearchString:function(f,g){var h=qx.util.TimerManager.getInstance();
if(this.__MD!=null){h.stop(this.__MD);
this.__MD=null;
}this.__MD=h.start(function(){this.__MC.update();
this.__MD=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__MC=null;
}});
})();
