...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.ListControllerWithFilter","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ListControllerWithFilter-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"bbc921918149"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var x={};
x.filter=function(r){return parseInt(r)%2==1;
};
var z={};
z.filter=function(t){return parseInt(t)%2==0;
};
var D=new qx.ui.basic.Label(b);
this.getRoot().add(D,{left:10,top:290});
var H={converter:function(s){if(s==z){return l;
}else if(s==x){return f;
}return p;
}};
B.bind(a,D,e,H);
var A=new qx.ui.form.Button(n);
A.setWidth(120);
this.getRoot().add(A,{left:130,top:80});
A.addListener(q,function(){G.push(G.length);
},this);
var F=new qx.ui.form.Button(m);
F.setWidth(120);
this.getRoot().add(F,{left:130,top:115});
F.addListener(q,function(){G.pop();
},this);
var C=new qx.ui.form.Button(o);
C.setWidth(120);
this.getRoot().add(C,{left:130,top:150});
C.addListener(q,function(){qx.log.appender.Console.show();
this.info(G.toString());
},this);
var v=new qx.ui.form.Button(k);
v.setWidth(120);
this.getRoot().add(v,{left:130,top:185});
v.addListener(q,function(){B.getDelegate()==x?B.setDelegate(z):B.setDelegate(x);
},this);
var u=new qx.ui.form.Button(j);
u.setWidth(120);
this.getRoot().add(u,{left:130,top:220});
u.addListener(q,function(){B.setDelegate(null);
},this);
var I=new qx.ui.form.Button(g);
I.setWidth(120);
this.getRoot().add(I,{left:130,top:255});
I.addListener(q,function(){G.reverse();
},this);
