...
},_createVerticalLayout:function(){var r=[];
...
t.slider.setOrientation(k);
q.add(t.slider,{row:0,column:u,rowSpan:3,colSpan:1});
q.add(t.minimum,{row:0,column:u+1});
q.add(t.value,{row:1,column:u+1});
q.add(t.maximum,{row:2,column:u+1});
s.setColumnMinWidth(u+1,80);
s.setColumnWidth(u+2,20);
u+=3;
}return q;
},_createHorizontalLayout:function(){var w=[];
...
x.setColumnFlex(1,1);
x.setColumnFlex(2,1);
x.setColumnAlign(0,n,m);
x.setColumnAlign(1,l,m);
x.setColumnAlign(2,b,m);
var z=0;

for(var i=0;i<w.length;i++){var y=w[i];
y.slider.setOrientation(g);
y.value.setWidth(100);
y.value.setTextAlign(l);
v.add(y.minimum,{row:z,column:0});
v.add(y.value,{row:z,column:1});
v.add(y.maximum,{row:z,column:2});
v.add(y.slider,{row:z+1,column:0,colSpan:3,rowSpan:1});
x.setRowHeight(z+2,20);
z+=3;
}return v;
