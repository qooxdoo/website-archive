...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.ScrollContainer_ResizeMatch.b344ee22b13e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="brown",b="Toggle size",c="white",d="demobrowser.demo.test.ScrollContainer_ResizeMatch",e="execute",f="Content size: 300x300";qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.container.Scroll();h.set({width:200,height:200});this.getRoot().add(h,{left:10,top:10});h.add(this.generateBox());var g=new qx.ui.form.Button(b);var i=true;g.addListener(e,function(){h.setWidth(i?300:200);h.setHeight(i?300:200);i=!i;}
);this.getRoot().add(g,{left:10,top:400});}
,generateBox:function(){var j=new qx.ui.basic.Label(f).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:a,textColor:c,padding:10});return j;}
}});}
)();
