...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_NegativeMargin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_NegativeMargin.e17c344ead0c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,properties:{sort:{check:[m,o,A],init:m,apply:r},separatorX:{check:p,nullable:true,apply:h},separatorY:{check:p,nullable:true,apply:h},connectSeparators:{check:a,init:false,apply:h},spacingX:{check:f,init:0,apply:h},spacingY:{check:f,init:0,apply:h}},members:{__fn:null,__JU:null,verifyLayoutProperty:qx.core.Environment.select(j,{"true":function(F,name,G){this.assertInArray(name,[y,w,c,k],g+name+l);if(name===w){this.assertInArray(G,[s,x,d,v,n]);}
...
,__JV:{north:1,south:2,west:3,east:4,center:5},__JW:{'1':t,'2':e,'3':z,'4':u},__lL:function(){var H=this._getLayoutChildren();var P,J;var length=H.length;var L=[];var O=[];var K=[];var I=this.getSort()===o;var N=this.getSort()===A;for(var i=0;i<length;i++ ){P=H[i];K=P.getLayoutProperties().edge;if(K===n){if(J){throw new Error(b);}
;J=P;}
...
;this.__fn=Q;var M=[];for(var i=0;i<length;i++ ){K=Q[i].getLayoutProperties().edge;M[i]=this.__JV[K]||5;}
;this.__JU=M;delete this._invalidChildrenCache;}
,renderLayout:function(bl,bb,bt){if(this._invalidChildrenCache){this.__lL();}
;var bk=qx.ui.layout.Util;var W=this.__fn;var bm=this.__JU;var length=W.length;var ba,bu,Y,bf,bg,br,bd,T,S;var bx=[];var bc=[];var bs=this._getSeparatorWidths();var bB=this.getSpacingX();var bA=this.getSpacingY();var X=-bB;var bn=-bA;if(bs.x){X-=bs.x+bB;}
;if(bs.y){bn-=bs.y+bA;}
...
,_computeSizeHint:function(){if(this._invalidChildrenCache){this.__lL();}
;var bS=this.__fn;var cd=this.__JU;var length=bS.length;var bW,ce;var bY,bX;var ca=0,cl=0;var bP=0,cg=0;var cb=0,ck=0;var bQ=0,cf=0;var ch=this._getSeparatorWidths();var cj=this.getSpacingX(),ci=this.getSpacingY();var bU=-cj,bT=-ci;if(ch.x){bU-=ch.x+cj;}
;if(ch.y){bT-=ch.y+ci;}
...
},destruct:function(){this.__JU=this.__fn=null;}
});}
)();
...
(function(){var a="yellow",b="gray",c="demobrowser.demo.layout.HBox_NegativeMargin",d="green",e="top",f="bottom",g="middle",h="main",i="blue";qx.Class.define(c,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(j);j.add(this.getBox1());j.add(this.getBox2());j.add(this.getBox3());j.add(this.getBox4());j.add(this.getBox5());j.add(this.getBox6());j.add(this.getBox7());}
,getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:h,backgroundColor:a,height:80,allowGrowX:false});var n=new qx.ui.core.Widget().set({decorator:h,backgroundColor:i,maxHeight:50,alignY:e});var m=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:50,alignY:g});var l=new qx.ui.core.Widget().set({decorator:h,backgroundColor:b,maxHeight:50,alignY:f});k.add(n);k.add(m);k.add(l);m.setMarginLeft(-10);l.setMarginLeft(-10);return k;}
,getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:h,backgroundColor:a,height:80,allowGrowX:false});var r=new qx.ui.core.Widget().set({decorator:h,backgroundColor:i,maxHeight:50,alignY:e});var q=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:50,alignY:g});var p=new qx.ui.core.Widget().set({decorator:h,backgroundColor:b,maxHeight:50,alignY:f});o.add(r);o.add(q);o.add(p);q.setMarginLeft(-10);q.setMarginRight(20);p.setMarginLeft(-10);return o;}
,getBox3:function(){var s=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:h,backgroundColor:a,height:80,width:500,allowGrowX:false});var v=new qx.ui.core.Widget().set({decorator:h,backgroundColor:i,maxHeight:50,alignY:e});var u=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:50,alignY:g});var t=new qx.ui.core.Widget().set({decorator:h,backgroundColor:b,maxHeight:50,alignY:f});s.add(v,{flex:1});s.add(u,{flex:1});s.add(t,{flex:1});u.setMarginLeft(-10);t.setMarginLeft(-10);return s;}
,getBox4:function(){var w=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:h,backgroundColor:a,height:80,width:500,allowGrowX:false});var z=new qx.ui.core.Widget().set({decorator:h,backgroundColor:i,maxHeight:50,alignY:e});var y=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:50,alignY:g});var x=new qx.ui.core.Widget().set({decorator:h,backgroundColor:b,maxHeight:50,alignY:f});w.add(z,{flex:1});w.add(y,{flex:2});w.add(x,{flex:3});y.setMarginLeft(-10);x.setMarginLeft(-10);return w;}
,getBox5:function(){var A=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:h,backgroundColor:a,height:80,width:500,allowGrowX:false});var D=new qx.ui.core.Widget().set({decorator:h,backgroundColor:i,maxHeight:50,alignY:e});var C=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:50,alignY:g});var B=new qx.ui.core.Widget().set({decorator:h,backgroundColor:b,maxHeight:50,alignY:f});A.add(D,{flex:1});A.add(C,{flex:2});A.add(B,{flex:3});C.setMarginLeft(-10);B.setMarginLeft(-10);D.setWidth(0);C.setWidth(0);B.setWidth(0);return A;}
,getBox6:function(){var E=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:h,backgroundColor:a,height:80,width:200,allowGrowX:false});var H=new qx.ui.core.Widget().set({decorator:h,backgroundColor:i,maxHeight:50,alignY:e});var G=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:50,alignY:g});var F=new qx.ui.core.Widget().set({decorator:h,backgroundColor:b,maxHeight:50,alignY:f});E.add(H,{flex:1});E.add(G,{flex:1});E.add(F,{flex:1});G.setMarginLeft(-10);F.setMarginLeft(-10);return E;}
,getBox7:function(){var I=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:h,backgroundColor:a,height:80,width:200,allowGrowX:false});var L=new qx.ui.core.Widget().set({decorator:h,backgroundColor:i,maxHeight:50,alignY:e});var K=new qx.ui.core.Widget().set({decorator:h,backgroundColor:d,maxHeight:50,alignY:g});var J=new qx.ui.core.Widget().set({decorator:h,backgroundColor:b,maxHeight:50,alignY:f});I.add(L,{flex:1});I.add(K,{flex:2});I.add(J,{flex:3});K.setMarginLeft(-10);J.setMarginLeft(-10);return I;}
}});}
)();
