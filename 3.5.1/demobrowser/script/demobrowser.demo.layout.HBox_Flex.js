...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Flex.fb516882fe32.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="green",b="demobrowser.demo.layout.HBox_Flex",c="main",d="yellow";qx.Class.define(b,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var e=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(e);e.add(this.getBox1());e.add(this.getBox2());e.add(this.getBox3());e.add(this.getBox4());e.add(this.getBox5());e.add(this.getBox6());}
,getBox1:function(){var f=new qx.ui.layout.HBox();var g=new qx.ui.container.Composite(f).set({width:500,decorator:c,backgroundColor:d,allowGrowX:false});f.setSpacing(5);g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a}),{flex:1});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a}),{flex:2});g.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a}),{flex:3});return g;}
,getBox2:function(){var h=new qx.ui.layout.HBox();var j=new qx.ui.container.Composite(h).set({width:500,decorator:c,backgroundColor:d,allowGrowX:false});h.setSpacing(5);j.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,maxWidth:30}),{flex:1});j.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a}),{flex:2});j.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,maxWidth:150}),{flex:3});return j;}
,getBox3:function(){var k=new qx.ui.layout.HBox();var m=new qx.ui.container.Composite(k).set({width:500,decorator:c,backgroundColor:d,allowGrowX:false});k.setSpacing(5);for(var i=0;i<25;i++ ){var l=new qx.ui.core.Widget();l.set({decorator:c,backgroundColor:a,width:5});m.add(l,{flex:1});}
;return m;}
,getBox4:function(){var n=new qx.ui.layout.HBox();var o=new qx.ui.container.Composite(n).set({width:600,minWidth:600,decorator:c,backgroundColor:d,allowGrowX:false});n.setSpacing(5);o.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,maxWidth:120}),{flex:1});o.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,maxWidth:120}),{flex:2});o.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,maxWidth:120}),{flex:3});return o;}
,getBox5:function(){var p=new qx.ui.layout.HBox();var q=new qx.ui.container.Composite(p).set({width:300,minWidth:0,decorator:c,backgroundColor:d,allowGrowX:false});p.setSpacing(5);q.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,minWidth:120}),{flex:1});q.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,minWidth:120}),{flex:2});q.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,minWidth:120}),{flex:3});return q;}
,getBox6:function(){var r=new qx.ui.layout.HBox();var s=new qx.ui.container.Composite(r).set({width:300,decorator:c,backgroundColor:d,allowGrowX:false});r.setSpacing(5);s.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,minWidth:120}),{flex:1});s.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,minWidth:120}),{flex:2});s.add(new qx.ui.core.Widget().set({decorator:c,backgroundColor:a,minWidth:120}),{flex:3});return s;}
}});}
)();
