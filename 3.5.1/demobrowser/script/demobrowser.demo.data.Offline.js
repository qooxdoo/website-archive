...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Offline.86f0a3d3ed20.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.data.store.Offline",b="session",c="qx.debug",d="changeModel",f="changeBubble",g="_applyModel";qx.Class.define(a,{extend:qx.core.Object,construct:function(i,h){qx.core.Object.call(this);try{if(qx.core.Environment.get(c)){this.assertNotUndefined(i);}
;}
catch(e){this.dispose();throw e;}
;if(h==b){this._storage=qx.bom.Storage.getSession();}
else {this._storage=qx.bom.Storage.getLocal();}
;this._marshaler=new qx.data.marshal.Json();this._key=i;this._initializeModel();}
,properties:{model:{nullable:true,event:d,apply:g}},members:{_storage:null,__Gq:null,_applyModel:function(k,j){if(j){j.removeListenerById(this.__Gq);j.dispose();this.__Gq=null;}
;if(k){this.__Gq=k.addListener(f,this.__Gr,this);this.__Gr();}
else {this._storage.removeItem(this._key);}
;}
,__Gr:function(){var l=qx.util.Serializer.toNativeObject(this.getModel());this._storage.setItem(this._key,l);}
,_initializeModel:function(){this._setModel(this._storage.getItem(this._key));}
,_setModel:function(n){this._marshaler.toClass(n,true);if(this.getModel()){this.getModel().dispose();}
;var m=this._marshaler.toModel(n,true);if(m===undefined){m=null;}
;this.setModel(m);}
...
(function(){var a="html.storage.local",b="html.storage.userdata",c="qx.bom.Storage";qx.Bootstrap.define(c,{statics:{__Gs:null,getLocal:function(){if(qx.core.Environment.get(a)){return qx.bom.storage.Web.getLocal();}
...
(function(){var a="local",b="session",c="Storage",d="qx.bom.storage.Web",f="Storage full.";qx.Bootstrap.define(d,{statics:{__Gt:null,__Gu:null,getLocal:function(){if(this.__Gt){return this.__Gt;}
;return this.__Gt=new qx.bom.storage.Web(a);}
,getSession:function(){if(this.__Gu){return this.__Gu;}
;return this.__Gu=new qx.bom.storage.Web(b);}
},construct:function(g){this.__nJ=g;}
,members:{__nJ:null,getStorage:function(){return window[this.__nJ+c];}
,getLength:function(){return this.getStorage(this.__nJ).length;}
,setItem:function(h,j){j=qx.lang.Json.stringify(j);try{this.getStorage(this.__nJ).setItem(h,j);}
catch(e){throw new Error(f);}
;}
,getItem:function(l){var k=this.getStorage(this.__nJ).getItem(l);if(qx.lang.Type.isString(k)){k=qx.lang.Json.parse(k);}
else if(k&&k.value&&qx.lang.Type.isString(k.value)){k=qx.lang.Json.parse(k.value);}
;return k;}
,removeItem:function(m){this.getStorage(this.__nJ).removeItem(m);}
,clear:function(){var n=this.getStorage(this.__nJ);if(!n.clear){for(var i=n.length-1;i>=0;i-- ){n.removeItem(n.key(i));}
;}
else {n.clear();}
;}
,getKey:function(o){return this.getStorage(this.__nJ).key(o);}
,forEach:function(p,r){var length=this.getLength();for(var i=0;i<length;i++ ){var q=this.getKey(i);p.call(r,q,this.getItem(q));}
;}
}});}
)();
(function(){var a="session",b="head",c="none",d="qx",e="qx.bom.storage.UserData",f="div",g="local",h="qxtest",j="#default#userdata",k="display";qx.Bootstrap.define(e,{statics:{__Gt:null,__Gu:null,__ci:0,getLocal:function(){if(this.__Gt){return this.__Gt;}
;return this.__Gt=new qx.bom.storage.UserData(g);}
,getSession:function(){if(this.__Gu){return this.__Gu;}
;return this.__Gu=new qx.bom.storage.UserData(a);}
},construct:function(m){this.__Gv=document.createElement(f);this.__Gv.style[k]=c;document.getElementsByTagName(b)[0].appendChild(this.__Gv);this.__Gv.addBehavior(j);this.__Gw=m;this.__Gv.load(this.__Gw);this.__eb={};this.__Gx={};var l=this.__Gv.getAttribute(d+qx.bom.storage.UserData.__ci);while(l!=undefined){l=qx.lang.Json.parse(l);this.__eb[l.key]=l.value;this.__Gx[l.key]=d+qx.bom.storage.UserData.__ci;qx.bom.storage.UserData.__ci++ ;l=this.__Gv.getAttribute(d+qx.bom.storage.UserData.__ci);}
;}
,members:{__Gv:null,__Gw:h,__eb:null,__Gx:null,getStorage:function(){return this.__eb;}
,getLength:function(){return Object.keys(this.__eb).length;}
,setItem:function(n,p){if(this.__Gx[n]){var o=this.__Gx[n];}
else {var o=d+qx.bom.storage.UserData.__ci;qx.bom.storage.UserData.__ci++ ;}
;var q=qx.lang.Json.stringify({key:n,value:p});this.__Gv.setAttribute(o,q);this.__Gv.save(this.__Gw);this.__eb[n]=p;this.__Gx[n]=o;}
,getItem:function(r){return this.__eb[r]||null;}
,removeItem:function(v){var u=this.__Gx[v];if(u==undefined){return;}
;this.__Gv.removeAttribute(u);qx.bom.storage.UserData.__ci-- ;delete this.__eb[v];delete this.__Gx[v];var t=d+qx.bom.storage.UserData.__ci;if(this.__Gv.getAttribute(t)){var w=this.__Gv.getAttribute(d+qx.bom.storage.UserData.__ci);this.__Gv.removeAttribute(t);this.__Gv.setAttribute(u,w);var s=qx.lang.Json.parse(w).key;this.__Gx[s]=u;}
;this.__Gv.save(this.__Gw);}
,clear:function(){for(var x in this.__Gx){this.__Gv.removeAttribute(this.__Gx[x]);}
;this.__Gv.save(this.__Gw);this.__eb={};this.__Gx={};}
,getKey:function(y){return Object.keys(this.__eb)[y];}
,forEach:function(z,B){var length=this.getLength();for(var i=0;i<length;i++ ){var A=this.getKey(i);z.call(B,A,this.getItem(A));}
;}
}});}
)();
(function(){var a="qx.bom.storage.Memory";qx.Bootstrap.define(a,{statics:{__Gt:null,__Gu:null,getLocal:function(){if(this.__Gt){return this.__Gt;}
;return this.__Gt=new qx.bom.storage.Memory();}
,getSession:function(){if(this.__Gu){return this.__Gu;}
;return this.__Gu=new qx.bom.storage.Memory();}
},construct:function(){this.__eb={};}
,members:{__eb:null,getStorage:function(){return this.__eb;}
,getLength:function(){return Object.keys(this.__eb).length;}
,setItem:function(b,c){c=qx.lang.Json.stringify(c);this.__eb[b]=c;}
,getItem:function(e){var d=this.__eb[e];if(qx.lang.Type.isString(d)){d=qx.lang.Json.parse(d);}
;return d;}
,removeItem:function(f){delete this.__eb[f];}
,clear:function(){this.__eb={};}
,getKey:function(h){var g=Object.keys(this.__eb);return g[h];}
