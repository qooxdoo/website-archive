...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.CheckBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.CheckBox.7a8aeec83df7.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="",b=", ",c="demobrowser.demo.widget.CheckBox",d="Bathing togs",f="Are you sure you need nothing for the beach?",g="_checkBoxes",h="OK",j="Towel",k="You need these things for the beach: ",l="Sun Oil",m="Beer",n="What do you need for the beach?",o="execute";qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var t=new qx.ui.basic.Label(n);var s=new qx.ui.layout.VBox();s.setSpacing(10);var v=new qx.ui.container.Composite(s);v.setPadding(20);this.getRoot().add(v,{left:0,top:0});v.add(t);var p=new qx.ui.form.CheckBox(l);var w=new qx.ui.form.CheckBox(j);var u=new qx.ui.form.CheckBox(m);var q=new qx.ui.form.CheckBox(d);this._checkBoxes=[p,w,u,q];v.add(p);v.add(w);v.add(u);v.add(q);var r=new qx.ui.form.Button(h);r.addListener(o,this._onExecute,this);r.setAllowGrowX(false);v.add(r);}
,_onExecute:function(e){var z=this._checkBoxes;var x=0;var y=a;for(var i=0;i<z.length;i++ ){if(z[i].getValue()){x++ ;y+=(z[i].getLabel()+b);}
;}
;if(x>0){y=y.substring(0,y.length-2);alert(k+y);}
else {alert(f);}
;}
