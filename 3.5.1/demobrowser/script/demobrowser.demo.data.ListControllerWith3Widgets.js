...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListControllerWith3Widgets.1aa884bdff7b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Write data to log",b="Add an item",c="<b>SelectBox</b>",d="Remove an item",e="<b>List</b><br/>",f="multi",g="All 3 widgets share the same data model. The List and the SelectBox ",h="demobrowser.demo.data.ListControllerWith3Widgets",j="Item ",k="<b>ComboBox</b><br/>",l="execute",m="also share the same selection.";qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var w=[];for(var i=0;i<30;i++ ){w.push(j+i);}
;var y=new qx.data.Array(w);var q=new qx.ui.form.List();var n=new qx.ui.form.SelectBox();var o=new qx.ui.form.ComboBox();this.getRoot().add(q,{left:10,top:80});q.setSelectionMode(f);this.getRoot().add(n,{left:120,top:80});this.getRoot().add(o,{left:250,top:80});var u=new qx.data.controller.List(y,q);var t=new qx.data.controller.List(y,n);new qx.data.controller.List(y,o);t.setSelection(u.getSelection());var z=new qx.ui.form.Button(b);z.setWidth(120);this.getRoot().add(z,{left:380,top:80});z.addListener(l,function(){y.push(j+y.length);}
,this);var r=new qx.ui.form.Button(d);r.setWidth(120);this.getRoot().add(r,{left:380,top:115});r.addListener(l,function(){y.pop();}
,this);var p=new qx.ui.form.Button(a);p.setWidth(120);this.getRoot().add(p,{left:380,top:150});p.addListener(l,function(){qx.log.appender.Console.show();this.info(y.toString());}
,this);var x=new qx.ui.basic.Label();x.setRich(true);x.setWidth(100);x.setValue(e);this.getRoot().add(x,{left:20,top:10});var v=new qx.ui.basic.Label();v.setRich(true);v.setWidth(100);v.setValue(c);this.getRoot().add(v,{left:130,top:10});var A=new qx.ui.basic.Label();A.setRich(true);A.setWidth(100);A.setValue(k);this.getRoot().add(A,{left:260,top:10});var s=new qx.ui.basic.Label();s.setRich(true);s.setWidth(360);s.setValue(g+m);this.getRoot().add(s,{left:20,top:30});}
}});}
)();
...
(function(){var a="hovered",b="Enter",c="pressed",d="one",f="changeLabel",g="mouseout",h="changeIcon",i="Space",j="abandoned",k="key",l="list",m="mousewheel",n="keyinput",o="arrow",p="changeSelection",q="y",r="",s="qx.ui.form.SelectBox",t="spacer",u="mouseover",v="selectbox",w="click",x="popup",y="quick",z=" ",A="atom";qx.Class.define(s,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],include:[qx.ui.core.MSingleSelectionHandling,qx.ui.form.MModelSelection],construct:function(){qx.ui.form.AbstractSelectBox.call(this);this._createChildControl(A);this._createChildControl(t);this._createChildControl(o);this.addListener(u,this._onMouseOver,this);this.addListener(g,this._onMouseOut,this);this.addListener(w,this._onClick,this);if(!(qx.event.handler.MouseEmulation.ON)){this.addListener(m,this._onMouseWheel,this);}
;this.addListener(n,this._onKeyInput,this);this.addListener(p,this.__nT,this);}
,properties:{appearance:{refine:true,init:v}},members:{__Am:null,_createChildControlImpl:function(D,C){var B;switch(D){case t:B=new qx.ui.core.Spacer();this._add(B,{flex:1});break;case A:B=new qx.ui.basic.Atom(z);B.setCenter(false);B.setAnonymous(true);this._add(B,{flex:1});break;case o:B=new qx.ui.basic.Image();B.setAnonymous(true);this._add(B);break;};return B||qx.ui.form.AbstractSelectBox.prototype._createChildControlImpl.call(this,D);}
...
,__nT:function(e){var F=e.getData()[0];var E=this.getChildControl(l);if(E.getSelection()[0]!=F){if(F){E.setSelection([F]);}
else {E.resetSelection();}
;}
;this.__AC();this.__AD();}
,__AC:function(){var H=this.getChildControl(l).getSelection()[0];var G=this.getChildControl(A);var I=H?H.getIcon():r;I==null?G.resetIcon():G.setIcon(I);}
,__AD:function(){var L=this.getChildControl(l).getSelection()[0];var J=this.getChildControl(A);var K=L?L.getLabel():r;var M=this.getFormat();if(M!=null){K=M.call(this,L);}
;if(K&&K.translate){K=K.translate();}
;K==null?J.resetLabel():J.setLabel(K);}
,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
...
,_onMouseWheel:function(e){if(this.getChildControl(x).isVisible()){return;}
;var O=e.getWheelDelta(q)>0?1:-1;var R=this.getSelectables();var Q=this.getSelection()[0];if(!Q){if(!R[0]){return;}
;Q=R[0];}
;var N=R.indexOf(Q)+O;var P=R.length-1;if(N<0){N=0;}
else if(N>=P){N=P;}
;this.setSelection([R[N]]);e.stopPropagation();e.preventDefault();}
,_onKeyPress:function(e){var S=e.getKeyIdentifier();if(S==b||S==i){if(this.__Am){this.setSelection([this.__Am]);this.__Am=null;}
;this.toggle();}
else {qx.ui.form.AbstractSelectBox.prototype._onKeyPress.call(this,e);}
;}
,_onKeyInput:function(e){var T=e.clone();T.setTarget(this._list);T.setBubbles(false);this.getChildControl(l).dispatchEvent(T);}
,_onListMouseDown:function(e){if(this.__Am){this.setSelection([this.__Am]);this.__Am=null;}
;}
,_onListChangeSelection:function(e){var X=e.getData();var V=e.getOldData();if(V&&V.length>0){V[0].removeListener(h,this.__AC,this);V[0].removeListener(f,this.__AD,this);}
;if(X.length>0){var U=this.getChildControl(x);var W=this.getChildControl(l);var Y=W.getSelectionContext();if(U.isVisible()&&(Y==y||Y==k)){this.__Am=X[0];}
else {this.setSelection([X[0]]);this.__Am=null;}
;X[0].addListener(h,this.__AC,this);X[0].addListener(f,this.__AD,this);}
else {this.resetSelection();}
;}
,_onPopupChangeVisibility:function(e){qx.ui.form.AbstractSelectBox.prototype._onPopupChangeVisibility.call(this,e);var bb=this.getChildControl(x);if(!bb.isVisible()){var bd=this.getChildControl(l);if(bd.hasChildren()){bd.setSelection(this.getSelection());}
;}
else {var ba=bb.getLayoutLocation(this);var bf=qx.bom.Viewport.getHeight();var be=ba.top;var bg=bf-ba.bottom;var bc=be>bg?be:bg;var bh=this.getMaxListHeight();var bd=this.getChildControl(l);if(bh==null||bh>bc){bd.setMaxHeight(bc);}
...
,this);}
,properties:{appearance:{refine:true,init:t},placeholder:{check:n,nullable:true,apply:x}},events:{"changeValue":j},members:{__Am:null,__An:null,_applyPlaceholder:function(A,z){this.getChildControl(p).setPlaceholder(A);}
...
,_setPreselectedItem:function(){if(this.__Am){var J=this.__Am.getLabel();if(this.getFormat()!=null){J=this.getFormat().call(this,this.__Am);}
;if(J&&J.translate){J=J.translate();}
;this.setValue(J);this.__Am=null;}
;}
,_onListChangeSelection:function(e){var K=e.getData();if(K.length>0){var M=this.getChildControl(o);var L=M.getSelectionContext();if(L==m||L==f){this.__Am=K[0];}
else {var N=K[0].getLabel();if(this.getFormat()!=null){N=this.getFormat().call(this,K[0]);}
;if(N&&N.translate){N=N.translate();}
;this.setValue(N);this.__Am=null;}
;}
;}
...
;var cn=this.getContentElement();if(ci&&this.__nF){if(this.__nF){var ck=this.getInsets();this._getPlaceholderElement().setStyles({paddingTop:ck.top+cp,paddingRight:ck.right+cp,paddingBottom:ck.bottom+cp,paddingLeft:ck.left+cp});}
;}
;if(cm||co.margin){if(this.__nF){var ck=this.getInsets();this._getPlaceholderElement().setStyles({"width":(innerWidth-ck.left-ck.right)+cp,"height":(innerHeight-ck.top-ck.bottom)+cp});}
;cn.setStyles({"width":innerWidth+cp,"height":innerHeight+cp});this._renderContentElement(innerHeight,cn);}
;if(co.position){if(this.__nF){this._getPlaceholderElement().setStyles({"left":cq+cp,"top":top+cp});}
;}
;}
...
;return cs;}
,_applyEnabled:function(cv,cu){qx.ui.core.Widget.prototype._applyEnabled.call(this,cv,cu);this.getContentElement().setEnabled(cv);if(this.__nF){if(cv){this._showPlaceholder();}
...
;if(this.__nF){delete cw[r];this._getPlaceholderElement().setStyles(cw);}
;if(cy){this.__nH=qx.bom.Label.getTextSize(m,cw);}
...
,_onHtmlInput:function(e){var cF=e.getData();var cE=true;this.__nG=false;if(this.__hH&&this.__hH===cF){cE=false;}
...
;}
;if(cE){this.fireDataEvent(q,cF,this.__hH);this.__hH=cF;if(this.getLiveUpdate()){this.__nI(cF);}
;}
;}
,_onWebFontStatusChange:function(cJ){if(cJ.getData().valid===true){var cI=this.__mr.getStyles();this.__nH=qx.bom.Label.getTextSize(m,cI);qx.ui.core.queue.Layout.add(this);}
;}
,__nI:function(cL){var cK=this.__hG;this.__hG=cL;if(cK!=cL){this.fireNonBubblingEvent(bR,qx.event.type.Data,[cL,cK]);}
;}
,setValue:function(cP){if(cP===null){if(this.__nG){return cP;}
;cP=P;this.__nG=true;}
else {this.__nG=false;if(this.__nF){this._removePlaceholder();}
;}
;if(qx.lang.Type.isString(cP)){var cO=this.getContentElement();if(cO.getValue()!=cP){var cM=cO.getValue();cO.setValue(cP);var cN=this.__nG?null:cP;this.__hG=cM;this.__nI(cN);this.__hH=this.__hG;}
;if(this.__nF){this._showPlaceholder();}
;return cP;}
;throw new Error(l+cP);}
,getValue:function(){var cQ=this.getContentElement().getValue();return this.__nG?null:cQ;}
...
,setLayoutParent:function(parent){qx.ui.core.Widget.prototype.setLayoutParent.call(this,parent);if(this.__nF){if(parent){this.getLayoutParent().getContentElement().add(this._getPlaceholderElement());}
...
.bind(this),0);}
,_removePlaceholder:function(){if(this.hasState(v)){if(this.__nF){this._getPlaceholderElement().setStyle(R,bY);}
;this.removeState(v);}
;}
,_syncPlaceholder:function(){if(this.hasState(v)&&this.__nF){this._getPlaceholderElement().setStyle(R,E);}
;}
...
;if(!this.__nF&&qx.ui.form.AbstractField.__dT){qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__dT);qx.ui.form.AbstractField.__dT=null;qx.ui.form.AbstractField.__nE();}
;}
,_applyPlaceholder:function(cY,cX){if(this.__nF){this._getPlaceholderElement().setValue(cY);if(cY!=null){this.addListener(u,this._removePlaceholder,this);this.addListener(bK,this._showPlaceholder,this);this._showPlaceholder();}
...
;qx.html.Element.call(this,t,q,r);this.__nJ=s;}
,members:{__nJ:null,__nK:null,__nL:null,_createDomElement:function(){return qx.bom.Input.create(this.__nJ);}
...
;}
,setEnabled:function(w){this.__nL=w;this.setAttribute(l,w===false);if(qx.core.Environment.get(a)==g){if(!w){this.setStyles({"userModify":m,"userSelect":d});}
else {this.setStyles({"userModify":null,"userSelect":this.__nK?null:d});}
;}
;}
,setSelectable:qx.core.Environment.select(a,{"webkit":function(x){this.__nK=x;qx.html.Element.prototype.setSelectable.call(this,this.__nL&&x);}
...
,setWrap:function(C,D){if(this.__nJ===n){this._setProperty(c,C,D);}
else {throw new Error(e);}
;return this;}
,getWrap:function(){if(this.__nJ===n){return this._getProperty(c);}
else {throw new Error(e);}
;}
}});}
)();
...
;if(this.getSelection()==null){this.__Bj=new qx.data.Array();this.setSelection(this.__Bj);}
;}
,properties:{selection:{check:b,event:f,apply:d,init:null}},events:{"changeSelection":h},members:{_modifingSelection:0,__Bk:null,__Bl:null,__Bj:null,_applySelection:function(k,j){if(this.__Bl!=undefined&&j!=undefined){j.removeListenerById(this.__Bl);}
;this.__Bl=k.addListener(a,this.__Bm,this);this._updateSelection();}
...
;var m=this.getTarget().getSelection();var l=this.getSelection();if(l==null){l=new qx.data.Array();this.__Bj=l;this.setSelection(l);}
...
,_addChangeTargetListener:function(p,o){if(this.__Bk!=undefined&&o!=undefined){o.removeListenerById(this.__Bk);}
;if(p!=null){if(this.__Bn()||this.__Bo()){this.__Bk=p.addListener(f,this._changeTargetSelection,this);}
;}
;}
,_updateSelection:function(){if(!this.getTarget()){return;}
;this._startSelectionModification();if(this.__Bn()){var s=[];for(var i=0;i<this.getSelection().length;i++ ){var t=this.getSelection().getItem(i);var u=this.__Bp(t);if(u!=null){s.push(u);}
;}
...
;}
;}
else if(this.__Bo()){var r=this.getSelection().getItem(this.getSelection().length-1);if(r!==undefined){this.__sV(r);this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();}
else {this.getTarget().resetSelection();}
;}
;this._endSelectionModification();}
,__Bn:function(){var v=this.getTarget().constructor;return qx.Class.implementsInterface(v,qx.ui.core.IMultiSelection);}
,__Bo:function(){var w=this.getTarget().constructor;return qx.Class.implementsInterface(w,qx.ui.core.ISingleSelection);}
,__sV:function(x){var y=this.__Bp(x);if(y==null){return;}
;if(this.__Bn()){this.getTarget().addToSelection(y);}
else if(this.__Bo()){this.getTarget().setSelection([y]);}
;}
,__Bp:function(z){var A=this.getTarget().getSelectables(true);for(var i=0;i<A.length;i++ ){if(A[i].getModel()==z){return A[i];}
;}
;return null;}
...
},destruct:function(){if(this.__Bj){this.__Bj.dispose();}
;}
});}
)();
...
(function(){var a="changeModel",b="_applyLabelOptions",c="_applyLabelPath",d="changeTarget",e="_applyModel",f="change",g="icon",h="ReverseBindingId",k="qx.data.controller.List",m="_applyIconPath",n="BindingId",o="_applyDelegate",p="",q="changeDelegate",r="_applyTarget",s="]",t="qx.data.IListData",u="model[",v="model",w="label",x="String",y="_applyIconOptions",z=".";qx.Class.define(k,{extend:qx.core.Object,include:qx.data.controller.MSelection,implement:qx.data.controller.ISelection,construct:function(A,B,C){qx.core.Object.call(this);this.__zG=[];this.__Bq=[];this.__Br=[];this.__Bs={};if(C!=null){this.setLabelPath(C);}
;if(A!=null){this.setModel(A);}
;if(B!=null){this.setTarget(B);}
;}
,properties:{model:{check:t,apply:e,event:a,nullable:true,dereference:true},target:{apply:r,event:d,nullable:true,init:null,dereference:true},labelPath:{check:x,apply:c,nullable:true},iconPath:{check:x,apply:m,nullable:true},labelOptions:{apply:b,nullable:true},iconOptions:{apply:y,nullable:true},delegate:{apply:o,event:q,init:null,nullable:true}},members:{__Bt:null,__zG:null,__Bs:null,__Bq:null,__Br:null,__Bu:null,__Bv:null,update:function(){this.__Bx();this.__BB();this._updateSelection();}
,_applyDelegate:function(E,D){this._setConfigureItem(E,D);this._setFilter(E,D);this._setCreateItem(E,D);this._setBindItem(E,D);}
,_applyIconOptions:function(G,F){this.__BB();}
,_applyLabelOptions:function(I,H){this.__BB();}
,_applyIconPath:function(K,J){this.__BB();}
,_applyLabelPath:function(M,L){this.__BB();}
,_applyModel:function(P,N){if(N!=undefined){if(this.__Bt!=undefined){N.removeListenerById(this.__Bt);}
;}
;if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length).dispose();}
;if(P!=null){this.__Bt=P.addListener(f,this.__Bw,this);this.__zN();this.__Bx();if(N==null){this._changeTargetSelection();}
else {this.__Bu=true;qx.ui.core.queue.Widget.add(this);}
;}
else {var O=this.getTarget();if(O!=null){var length=O.getChildren().length;for(var i=0;i<length;i++ ){this.__BA();}
;}
;}
;}
...
;if(S!=null){if(this.getModel()!=null){for(var i=0;i<this.__zG.length;i++ ){this.__Bz(this.__BD(i));}
;}
;}
;}
,__Bw:function(){this.__Bv=true;qx.ui.core.queue.Widget.add(this);if(this.__zG.length!=this.getModel().getLength()){this.update();}
;}
,syncWidget:function(){if(this.__Bu){this._changeTargetSelection();}
;if(this.__Bv){this._updateSelection();}
;this.__Bv=this.__Bu=null;}
,__Bx:function(){if(this.getTarget()==null){return;}
;this.__zN();var U=this.__zG.length;var T=this.getTarget().getChildren().length;if(U>T){for(var j=T;j<U;j++ ){this.__Bz(this.__BD(j));}
;}
else if(U<T){for(var j=T;j>U;j-- ){this.__BA();}
;}
;this.__Bu=true;qx.ui.core.queue.Widget.add(this);}
,__By:function(){var V=this.getModel();if(V!=null){V.removeListenerById(this.__Bt);this.__Bt=V.addListener(f,this.__Bw,this);}
;}
...
;return W;}
,__Bz:function(Y){var ba=this._createItem();this._bindListItem(ba,Y);this.getTarget().add(ba);}
,__BA:function(){this._startSelectionModification();var bc=this.getTarget().getChildren();var bb=bc.length-1;var bd=bc[bb];this._removeBindingsFrom(bd);this.getTarget().removeAt(bb);bd.destroy();this._endSelectionModification();}
...
;}
,bindProperty:function(bo,br,bp,bn,bm){if(bp!=null){var bp=qx.lang.Object.clone(bp);this.__Bs[br]=bp.onUpdate;delete bp.onUpdate;}
else {bp={};this.__Bs[br]=null;}
;bp.onUpdate=qx.lang.Function.bind(this._onBindingSet,this,bm);bp.ignoreConverter=v;var bq=u+bm+s;if(bo!=null&&bo!=p){bq+=z+bo;}
;var bs=this.bind(bq,bn,br,bp);bn.setUserData(br+n,bs);if(!qx.lang.Array.contains(this.__Bq,br)){this.__Bq.push(br);}
;}
,bindPropertyReverse:function(by,bv,bw,bx,bt){var bu=u+bt+s;if(by!=null&&by!=p){bu+=z+by;}
;var bz=bx.bind(bv,this,bu,bw);bx.setUserData(by+h,bz);if(!qx.lang.Array.contains(this.__Br,by)){this.__Br.push(by);}
;}
,_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;}
;for(var i=0;i<this.__Bq.length;i++ ){if(this.__Bs[this.__Bq[i]]!=null){this.__Bs[this.__Bq[i]]();}
;}
;}
,_removeBindingsFrom:function(bD){for(var i=0;i<this.__Bq.length;i++ ){var bE=bD.getUserData(this.__Bq[i]+n);if(bE!=null){this.removeBinding(bE);}
;}
;for(var i=0;i<this.__Br.length;i++ ){var bE=bD.getUserData(this.__Br[i]+h);if(bE!=null){bD.removeBinding(bE);}
;}
;}
,__BB:function(){if(this.getTarget()==null||this.getModel()==null){return;}
;var bF=this.getTarget().getChildren();for(var i=0;i<bF.length;i++ ){this._removeBindingsFrom(bF[i]);this._bindListItem(bF[i],this.__BD(i));}
;this.__By();}
...
,_setFilter:function(bR,bP){if((bR==null||bR.filter==null)&&(bP!=null&&bP.filter!=null)){this.__BC();}
...
;var bQ=this.__zG;this.__zN();if(bQ.length>this.__zG.length){for(var j=bQ.length;j>this.__zG.length;j-- ){this.getTarget().removeAt(j-1).destroy();}
;}
else if(bQ.length<this.__zG.length){for(var j=bQ.length;j<this.__zG.length;j++ ){var bT=this._createItem();this.getTarget().add(bT);}
;}
;var bS=this.getTarget().getChildren();for(var i=0;i<bS.length;i++ ){this._bindListItem(bS[i],this.__BD(i));}
;this.__By();this._endSelectionModification();this._updateSelection();}
,__BC:function(){this.__zN();this.__Bx();this.__BB();this.__Bv=true;qx.ui.core.queue.Widget.add(this);}
,__zN:function(){var bW=this.getModel();if(bW==null){return;}
;var bX=this.getDelegate();if(bX!=null){var bV=bX.filter;}
;this.__zG=[];for(var i=0;i<bW.getLength();i++ ){if(bV==null||bV(bW.getItem(i))){this.__zG.push(i);}
;}
;}
,__BD:function(bY){return this.__zG[bY];}
},destruct:function(){this.__zG=this.__Bs=this.__Bq=null;this.__Br=null;qx.ui.core.queue.Widget.remove(this);}
});}
)();
