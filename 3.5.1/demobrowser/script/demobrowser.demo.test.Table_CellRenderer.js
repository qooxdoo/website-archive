...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellRenderer.877ab1e148ed.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,__Kg:function(X,top,W,Y,U){var V=[q,W,r,top,y];Y.createDataCellHtml(U,V);V.push(a);X.innerHTML+=V.join(v);}
,testDefaultRenderer:function(bc){var bd=100;var ba={value:[null,K,32,new Date()],styleLeft:[0],styleWidth:[bd],styleHeight:[20],style:[v]};var bb=this._getNewTableDiv(bd);var top=0;qx.util.Permutation.permute(ba,function(be){this.__Kg(bb,top,bd,bc,be);top+=20;}
,this);}
,testBooleanRenderer:function(){var bi=70;var bh=30;var bj=new qx.ui.table.cellrenderer.Boolean();var bf={value:[null,true,false],styleLeft:[0],styleWidth:[bi],styleHeight:[bh],style:[v]};var bg=this._getNewTableDiv(bi);var top=0;qx.util.Permutation.permute(bf,function(bk){this.__Kg(bg,top,bi,bj,bk);top+=bh;}
,this);bj.setIconFalse(M);bj.setIconTrue(N);qx.util.Permutation.permute(bf,function(bl){this.__Kg(bg,top,bi,bj,bl);top+=bh;}
,this);}
,testDateRenderer:function(){var bn=180;var bq=new qx.ui.table.cellrenderer.Date();var bm={value:new Date(),styleLeft:[0],styleWidth:[bn],styleHeight:[20],style:[v]};var bp=qx.util.format.DateFormat;var br=[bp.getDateTimeInstance(),bp.getDateInstance()];var bs=this._getNewTableDiv(bn);var top=0;for(var i=0;i<br.length;i++ ){var bo=br[i];bq.setDateFormat(bo);this.__Kg(bs,top,bn,bq,bm);top+=20;}
;}
,testNumberRenderer:function(){var bx=new qx.ui.table.cellrenderer.Number();var bw=100;var bt={value:Math.PI,styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[v]};var bv=qx.util.format.NumberFormat;var by=[new bv().set({maximumFractionDigits:0}),new bv().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:g})];var bz=this._getNewTableDiv(bw);var top=0;for(var i=0;i<by.length;i++ ){var bu=by[i];bx.setNumberFormat(bu);this.__Kg(bz,top,bw,bx,bt);top+=20;}
;}
,testImageRenderer:function(){var bC=new qx.ui.table.cellrenderer.Image();var bD=50;var bA={value:[null,s,E,u,d,f],styleLeft:[0],styleWidth:[bD],styleHeight:[20],style:[v],tooltip:[v,J]};var bB=this._getNewTableDiv(bD);var top=0;qx.util.Permutation.permute(bA,function(bE){this.__Kg(bB,top,bD,bC,bE);top+=20;}
,this);}
,testStringRenderer:function(){var bJ=new qx.ui.table.cellrenderer.String();var bI=100;var bH=20;var bF={value:[null,l,t],styleLeft:[0],styleWidth:[bI],styleHeight:[bH],style:[v]};var bG=this._getNewTableDiv(bI);var top=0;qx.util.Permutation.permute(bF,function(bK){this.__Kg(bG,top,bI,bJ,bK);top+=20;}
,this);}
,testPasswordRenderer:function(){var bP=new qx.ui.table.cellrenderer.Password();var bO=100;var bN=20;var bL={value:[null,l,t],styleLeft:[0],styleWidth:[bO],styleHeight:[bN],style:[v]};var bM=this._getNewTableDiv(bO);var top=0;qx.util.Permutation.permute(bL,function(bQ){this.__Kg(bM,top,bO,bP,bQ);top+=20;}
,this);}
,testHtmlRenderer:function(){var bV=new qx.ui.table.cellrenderer.Html();var bU=100;var bT=50;var bR={value:[null,D,A,n],styleLeft:[0],styleWidth:[bU],styleHeight:[bT],style:[v]};var bS=this._getNewTableDiv(bU);var top=0;qx.util.Permutation.permute(bR,function(bW){this.__Kg(bS,top,bU,bV,bW);top+=20;}
,this);}
,testConditionalRenderer:function(){var cc=new qx.ui.table.cellrenderer.Conditional();cc.addNumericCondition(p,0,null,L,null,null);cc.addNumericCondition(P,100,O,null,null,null);cc.addBetweenCondition(o,0,2,null,null,null,I,null);cc.addRegex(B,null,null,I,j);var cb=100;var ca=20;var bX={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[cb],table:[this.tableMock],styleHeight:[ca],style:[v]};var bY=this._getNewTableDiv(cb);var top=0;qx.util.Permutation.permute(bX,function(cd){this.__Kg(bY,top,cb,cc,cd);top+=20;}
,this);}
...
);var ch=100;var cg=20;var ce={value:[null,K,new Date(),30,s,false],styleLeft:[0],styleWidth:[ch],styleHeight:[cg],table:[this.tableMock],style:[v]};var cf=this._getNewTableDiv(ch);var top=0;qx.util.Permutation.permute(ce,function(cm){this.__Kg(cf,top,ch,ci,cm);top+=20;}
,this);}
,testReplaceRenderer:function(){var cs=new qx.ui.table.cellrenderer.Replace();cs.setReplaceMap({'1':Q,'2':k,'3':c});cs.addReversedReplaceMap();var cq=100;var cp=20;var cn={value:[1,2,3],styleLeft:[0],styleWidth:[cq],table:[this.tableMock],styleHeight:[cp],style:[v]};var co=this._getNewTableDiv(cq);var top=0;qx.util.Permutation.permute(cn,function(ct){this.__Kg(co,top,cq,cs,ct);top+=20;}
,this);}
...
,init:t}},members:{__ro:16,__rp:16,__rq:null,_insetY:2,_identifyImage:function(B){throw new Error(e);}
,_getImageInfos:function(C){var D=this._identifyImage(C);if(D==null||typeof D==f){D={url:D,tooltip:null};}
;if(!D.imageWidth||!D.imageHeight){var E=this.__rr(D.url);D.imageWidth=E.width;D.imageHeight=E.height;}
;D.width=D.imageWidth;D.height=D.imageHeight;return D;}
,__rr:function(H){var I=qx.util.ResourceManager.getInstance();var G=qx.io.ImageLoader;var F,J;if(I.has(H)){F=I.getImageWidth(H);J=I.getImageHeight(H);}
else if(G.isLoaded(H)){F=G.getWidth(H);J=G.getHeight(H);}
else {F=this.__ro;J=this.__rp;}
;return {width:F,height:J};}
,createDataCellHtml:function(K,L){this.__rq=this._getImageInfos(K);return qx.ui.table.cellrenderer.Abstract.prototype.createDataCellHtml.call(this,K,L);}
,_getCellClass:function(M){return qx.ui.table.cellrenderer.Abstract.prototype._getCellClass.call(this)+s;}
,_getContentHtml:function(N){var content=p;if(this.__rq.url){content=qx.bom.element.Decoration.create(this.__rq.url,this.getRepeat(),{width:this.__rq.width+c,height:this.__rq.height+c,display:qx.core.Environment.get(a),verticalAlign:q,position:g});}
;return content;}
,_getCellAttributes:function(O){var P=this.__rq.tooltip;if(P){return w+P+h;}
else {return o;}
;}
},destruct:function(){this.__rq=null;}
});}
)();
(function(){var a="qx.dyntheme",b="_applyIconTrue",c="decoration/table/boolean-true.png",d="qx.ui.table.cellrenderer.Boolean",e=";padding-top:4px;",f="decoration/table/boolean-false.png",g="_applyIconFalse",h="changeTheme",i="String";qx.Class.define(d,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(){qx.ui.table.cellrenderer.AbstractImage.call(this);this.__HK=qx.util.AliasManager.getInstance();this.initIconTrue();this.initIconFalse();if(qx.core.Environment.get(a)){qx.theme.manager.Appearance.getInstance().addListener(h,this._onChangeTheme,this);}
;}
,properties:{iconTrue:{check:i,init:c,apply:b},iconFalse:{check:i,init:f,apply:g}},members:{__JR:null,__JS:false,__HK:null,_onChangeTheme:qx.core.Environment.select(a,{"true":function(){this._applyIconTrue(this.getIconTrue());this._applyIconFalse(this.getIconFalse());}
,"false":null}),_applyIconTrue:function(j){this.__JR=this.__HK.resolve(j);}
,_applyIconFalse:function(k){this.__JS=this.__HK.resolve(k);}
,_insetY:5,_getCellStyle:function(l){return qx.ui.table.cellrenderer.AbstractImage.prototype._getCellStyle.call(this,l)+e;}
,_identifyImage:function(m){var n={imageWidth:11,imageHeight:11};switch(m.value){case true:n.url=this.__JR;break;case false:n.url=this.__JS;break;default:n.url=null;break;};return n;}
},destruct:function(){this.__HK=null;if(qx.core.Environment.get(a)){qx.theme.manager.Appearance.getInstance().removeListener(h,this._onChangeTheme,this);}
;}
});}
)();
(function(){var a="regex cannot be null!",b="font-weight",c="==",d="Condition not recognized or value1/value2 is null!",e="Condition not recognized or value is null!",f="",g=">",h="text-align",j="between",k="<",l=";",m='g',n="regex",o=":",p="qx.ui.table.cellrenderer.Conditional",q="!between",r=">=",s="color",t="font-style",u="!=",v="<=";qx.Class.define(p,{extend:qx.ui.table.cellrenderer.Default,construct:function(y,w,x,z){qx.ui.table.cellrenderer.Default.call(this);this.numericAllowed=[c,u,g,k,r,v];this.betweenAllowed=[j,q];this.conditions=[];this.__yR=y||f;this.__yS=w||f;this.__yT=x||f;this.__yU=z||f;}
,members:{__yR:null,__yS:null,__yT:null,__yU:null,__yV:function(B,A){if(B[1]!=null){A[h]=B[1];}
;if(B[2]!=null){A[s]=B[2];}
;if(B[3]!=null){A[t]=B[3];}
;if(B[4]!=null){A[b]=B[4];}
;}
...
;}
,_getCellStyle:function(bi){var bf=bi.table.getTableModel();var i;var be;var bb;var bd={"text-align":this.__yR,"color":this.__yS,"font-style":this.__yT,"font-weight":this.__yU};for(i in this.conditions){be=false;if(qx.lang.Array.contains(this.numericAllowed,this.conditions[i][0])){if(this.conditions[i][6]==null){bb=bi.value;}
...
;if(be==true){this.__yV(this.conditions[i],bd);}
;}
...
(function(){var a="qx.ui.table.cellrenderer.Image",b="";qx.Class.define(a,{extend:qx.ui.table.cellrenderer.AbstractImage,construct:function(c,d){qx.ui.table.cellrenderer.AbstractImage.call(this);if(c){this.__rs=c;}
;if(d){this.__rt=d;}
;this.__ru=qx.util.AliasManager.getInstance();}
,members:{__ru:null,__rt:16,__rs:16,_identifyImage:function(e){var f={imageWidth:this.__rs,imageHeight:this.__rt};if(e.value==b){f.url=null;}
else {f.url=this.__ru.resolve(e.value);}
