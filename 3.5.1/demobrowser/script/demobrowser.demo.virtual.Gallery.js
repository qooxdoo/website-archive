...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Gallery.4711703437d5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_generateItems:function(bg){var bj=[];var bm=[t,z,y,P,m];var bk=qx.util.AliasManager.getInstance();var bi=qx.util.ResourceManager.getInstance();for(var i=0;i<bg;i++ ){var bn=D+bm[Math.floor(Math.random()*bm.length)];var bh=bk.resolve(bn);var bl=bi.toUri(bh);bj[i]={label:O+(i+1),icon:bn,resolvedIcon:bl};}
;return bj;}
...
,updateStates:function(bs,br){var bt=bs.getChildControl(K);var bu=bs.getChildControl(w);if(br.selected){bt.setBackgroundColor(j);bt.setTextColor(Q);bu.setDecorator(B);bu.setBackgroundColor(c);}
else {bt.resetBackgroundColor();bt.resetTextColor();bu.resetDecorator();bu.resetBackgroundColor();}
;}
}});qx.Class.define(f,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bv){demobrowser.demo.virtual.AbstractGallery.call(this,bv);this.__SX=new demobrowser.demo.virtual.GalleryCell();}
,members:{__SX:null,_createScroller:function(){var bw=new qx.ui.virtual.core.Scroller(1,this.itemPerLine,this.itemHeight,this.itemWidth);this.layer=new qx.ui.virtual.layer.WidgetCell(this);bw.getPane().addLayer(this.layer);new qx.ui.virtual.behavior.Prefetch(bw,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:200,maxAbove:300,minBelow:600,maxBelow:800}).set({interval:500});return bw;}
...
;if(by){this.__SX.updateStates(bx,{selected:1});}
else {this.__SX.updateStates(bx,{});}
;}
;}
...
;var bE=this.__SX.getCellWidget(bF,bD);bE.setUserData(n,bH);return bE;}
,poolCellWidget:function(bJ){this.__SX.pool(bJ);}
},destruct:function(){this._disposeObjects(q,r);}
...
;var bS=this.manager.isItemSelected({row:bV,column:bR});var bU=bS?l:v;return {style:[J,h,this._fontCss,bU].join(v),content:[o,bT.resolvedIcon,p,N,bT.label].join(v)};}
...
(function(){var a="_applyInterval",b="__ij",c="appear",d="qx.debug",e="interval",f="qx.ui.virtual.behavior.Prefetch",g="scroll",h="_applyScroller",i="qx.ui.virtual.core.Scroller",j="scrollbar-x",k="Integer",l="scrollbar-y";qx.Class.define(f,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(d)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__ij=new qx.event.Timer(this.getInterval());this.__ij.addListener(e,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:i,nullable:true,init:null,apply:h},interval:{check:k,init:200,apply:a}},members:{__uW:null,__uX:null,__ij:null,__uY:null,__va:null,setPrefetchX:function(o,r,p,q){this.__uW=[o,r,p,q];}
,setPrefetchY:function(v,u,t,s){this.__uX=[v,u,t,s];}
,_onInterval:function(){var w=this.__uW;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__uX;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(z,y){if(y){if(this.__uY){y.getChildControl(j).removeListenerById(this.__uY);}
;if(this.__va){y.getChildControl(l).removeListenerById(this.__va);}
;}
;if(z){if(!z.getContentElement().getDomElement()){this.__ij.stop();z.addListenerOnce(c,this.__ij.start,this.__ij);}
else {this.__ij.restart();}
;this.__uY=z.getChildControl(j).addListener(g,this.__ij.restart,this.__ij);this.__va=z.getChildControl(l).addListener(g,this.__ij.restart,this.__ij);}
else {this.__ij.stop();}
;}
,_applyInterval:function(B,A){this.__ij.setInterval(B);}
},destruct:function(){this.setScroller(null);this.__uW=this.__uX=null;this._disposeObjects(b);}
});}
)();
