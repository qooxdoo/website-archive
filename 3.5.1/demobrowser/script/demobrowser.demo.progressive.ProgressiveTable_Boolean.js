...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Boolean.0aa924bf1037.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,_getContentHtml:function(C){var D=[];var E=this.__FO(C);D.push(f);if(qx.core.Environment.get(h)&&/\.png$/i.test(E.url)){D.push(n,this.__FN,q,e,E.url,v,a);}
...
,__FO:function(F){var G=this._identifyImage(F);if(G==null||typeof G==c){G={url:G,tooltip:null};}
;if(G.url==null){G.url=this.__FN;}
;return G;}
}});}
)();
(function(){var a="\"",b="  var filters = this.filters.item(loader); ",c="Boolean",d="  this.attributes.setNamedItem(namedItem); ",e="} catch (e) { ",f="var node = this.attributes.getNamedItem('celldata'); ",g="changeTheme",h="qx.ui.progressive.renderer.table.cell.Boolean",i="decoration/table/boolean-true.png",j="var value = node.nodeValue; ",k="}",l="css.alphaimageloaderneeded",m="decoration/table/boolean-false.png",n="{",o="celldata='1' ",p="  node.nodeValue='0'; ",q="'; ",r="qx.dyntheme",s="  this.attributes.setNamedItem(node); ",t="  var loader = 'DXImageTransform.Microsoft.AlphaImageLoader'; ",u="if (value == '0') ",v="celldata='0' ",w="  node.nodeValue='1'; ",x="  this.src='",y="onclick=\"",z="  filters.sizingMethod = 'scale'; ",A="  namedItem.value = node.nodeValue; ",B="var src; ",C="try { ",D="  filters.src='",E="  var namedItem = document.createAttribute('celldata'); ",F="} ",G="else ";qx.Class.define(h,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(){qx.ui.progressive.renderer.table.cell.Icon.call(this);this.__JT();if(qx.core.Environment.get(r)){qx.theme.manager.Decoration.getInstance().addListener(g,this.__JT,this);}
;}
,properties:{allowToggle:{check:c,init:false}},members:{__JR:null,__JS:null,__Fo:null,__Fq:null,__yR:null,__yS:null,__yT:null,__yU:null,__JT:function(){var J=qx.util.AliasManager.getInstance();var K=qx.util.ResourceManager.getInstance();var I=J.resolve(i);var H=J.resolve(m);this.__JR=K.toUri(I);this.__JS=K.toUri(H);}
,_identifyImage:function(L){var M={imageWidth:11,imageHeight:11};switch(L.cellData){case true:M.url=this.__JR;M.extras=o;break;case false:M.url=this.__JS;M.extras=v;break;default:M.url=null;break;};if(this.getAllowToggle()){M.extras+=y+f+j+B+u+n;if(qx.core.Environment.get(l)&&/\.png$/i.test(this.__JR)){M.extras+=x+this.getBlankImage()+q+t+b+D+this.__JR+q+z;}
else {M.extras+=x+this.__JR+q;}
;M.extras+=w+F+G+n;if(qx.core.Environment.get(l)&&/\.png$/i.test(this.__JS)){M.extras+=x+this.getBlankImage()+q+t+b+D+this.__JS+q+z;}
else {M.extras+=x+this.__JS+q;}
...
},destruct:function(){this.__JR=this.__JS=null;if(qx.core.Environment.get(r)){qx.theme.manager.Decoration.getInstance().removeListener(g,this.__JT,this);}
;}
});}
)();
