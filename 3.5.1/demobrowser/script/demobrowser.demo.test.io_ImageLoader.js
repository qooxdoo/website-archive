...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.io_ImageLoader.5d0d94cf3235.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="100px",b=")",c="http://resources.qooxdoo.org/images/logo.gif",d="img",e="x",f="demobrowser.demo.test.io_ImageLoader",g="Image loaded (",h="absolute";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);qx.io.ImageLoader.load(c,function(i,j){qx.log.Logger.debug(g+j.width+e+j.height+b);var k=document.createElement(d);k.src=i;k.width=Math.round(j.width*1.5);k.height=Math.round(j.height*1.5);k.style.position=h;k.style.left=a;k.style.top=a;document.body.appendChild(k);}
);}
}});}
)();
