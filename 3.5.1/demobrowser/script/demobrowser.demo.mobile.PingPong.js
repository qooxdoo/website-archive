...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong.c769f98551e1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="touchmove",b="black",c="#333",d="px",f="border-left",g="green",h="div",i="100%",j="demobrowser.demo.mobile.PingPong",k="0",l="200px",m="30px",n="qx.debug",o="interval",p="0px",q="12px",r="<b>This demo is intended for WebKit-based browsers and IE11+.</b>",s="center",t="browser.documentmode",u="100px",v="1px solid white",w='Lucida Grande',z="innerHTML",A="top",B="right",C="Arial",D="50%",E="mshtml",F="engine.name",G="20px",H="webkit",I="15em",J="none",K="border-right",L="white",M="left",N="absolute";qx.Class.define(j,{extend:qx.application.Native,members:{__RV:null,__RW:null,__RX:null,__RY:null,__Sa:5,__Sb:1,__Sc:1,__Sd:null,__Se:null,__Sf:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(n)){qx.log.appender.Native;qx.log.appender.Console;}
;var S={"width":i,"height":i,"backgroundColor":b,"margin":p,"userSelect":J};var V=new qx.html.Element(h,S);V.useElement(document.body);V.setRoot(true);var O=qx.core.Environment.get(F);var Q=O==E&&qx.core.Environment.get(t)>10;if(O!=H&&!Q){var U={"color":g,"position":N,"font-family":w,"font-size":q,"left":m,"top":G};var T=new qx.html.Element(h,U);V.add(T);T.setAttribute(z,r);return;}
;var P=this.__Sj(M);V.add(P);var R=this.__Sj(B);V.add(R);this.__RW=this.__Sk(M);P.add(this.__RW);P.addListener(a,qx.lang.Function.bind(this.__gG,this),this);this.__RV=this.__Sk(B);R.add(this.__RV);R.addListener(a,qx.lang.Function.bind(this.__gG,this),this);this.__RX=this.__Sl();V.add(this.__RX);this.__Se=this.__Sm();P.add(this.__Se);this.__Sf=this.__Sm();R.add(this.__Sf);this.__Sd=[0,0];this.__Sg();}
,__Sg:function(){this.__RX.setStyles({"left":l,"top":l});this.__RY=new qx.event.Timer(40);this.__RY.addListener(o,function(){var x=(parseInt(this.__RX.getStyle(M))+this.__Sa*this.__Sb);var y=(parseInt(this.__RX.getStyle(A))+this.__Sa*this.__Sc);this.__RX.setStyle(M,x+d);this.__RX.setStyle(A,y+d);this.__Si();}
,this);this.__RY.start();}
,__Sh:function(W){this.__RY.stop();this.__RY.dispose();this.__Sa=5;this.__Sd[W]=this.__Sd[W]+1;this.__Se.setAttribute(z,this.__Sd[0]);this.__Sf.setAttribute(z,this.__Sd[1]);this.__Sg();}
,__Si:function(){var Y=this.getBoundsFor(this.__RX);if(Y.top<=0){this.__Sc=1;}
;if(Y.bottom>=window.innerHeight-5){this.__Sc=-1;}
;if(Y.left<=0||Y.right>=window.innerWidth){this.__Sh(Y.left<=0?1:0);}
;var ba=this.getBoundsFor(this.__RW);if(Y.left<=ba.right&&Y.bottom>=ba.top&&Y.top<=ba.bottom){this.__Sb=1;this.__Sa=Math.min(this.__Sa+1,20);}
;var X=this.getBoundsFor(this.__RV);if(Y.right>=X.left&&Y.bottom>=X.top&&Y.top<=X.bottom){this.__Sb=-1;this.__Sa=Math.min(this.__Sa+1,20);}
;}
,__gG:function(e){var bd=e.getAllTouches().length;var bb=e.getAllTouches()[0];var be=bb.pageY;var bc=0;if(bd>1){var bf=e.getAllTouches()[1];if(bb.pageX<bf.pageX){be=bb.pageY;bc=bf.pageY;}
else {be=bf.pageY;bc=bb.pageY;}
;}
;this.__RW.setStyles({"top":(be-50)+d});if(bd>1){this.__RV.setStyles({"top":(bc-50)+d});}
;e.preventDefault();}
,getBoundsFor:function(bg){return qx.bom.element.Location.get(bg.getDomElement());}
,__Sj:function(bi){var bh={"width":D,"height":i,"position":N,"backgroundColor":b};if(bi==M){bh[K]=v;}
else {bh[M]=D;bh[f]=v;}
;return new qx.html.Element(h,bh);}
,__Sk:function(bk){var bj={"width":m,"height":u,"top":u,"position":N,"backgroundColor":L};bj[bk]=G;return new qx.html.Element(h,bj);}
,__Sl:function(){var bl={"width":G,"height":G,"position":N,"backgroundColor":L,"userSelect":J};return new qx.html.Element(h,bl);}
,__Sm:function(){var bm={"width":i,"height":i,"textAlign":s,"fontSize":I,"color":c,"fontFamily":C};var bn=new qx.html.Element(h,bm);bn.setAttribute(z,k);return bn;}
}});}
)();
