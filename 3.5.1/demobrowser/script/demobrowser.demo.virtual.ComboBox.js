...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.ComboBox.48b48a1d626c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},destruct:function(){if(this.__yW){this.__yW.dispose();}
;}
});}
)();
...
(function(){var a="changeModel",b="click",c="one",d="Enter",e="list",f="changeDelegate",g="change",h="qx.data.Array",j="changeVisibility",k="qx.ui.form.core.VirtualDropDownList",l="_applySelection",m="changeSelection",n="Invalid parameter 'target'!",o="qx.event.type.Data";qx.Class.define(k,{extend:qx.ui.popup.Popup,construct:function(p){qx.core.Assert.assertNotNull(p,n);qx.core.Assert.assertNotUndefined(p,n);qx.core.Assert.assertInterface(p,qx.ui.form.core.AbstractVirtualBox,n);qx.ui.popup.Popup.call(this,new qx.ui.layout.VBox());this._target=p;this._createChildControl(e);this.addListener(j,this.__zb,this);this.__yX=new qx.data.Array();this.initSelection(this.__yX);}
,properties:{autoHide:{refine:true,init:false},keepActive:{refine:true,init:true},selection:{check:h,event:m,apply:l,nullable:false,deferredInit:true}},events:{"changeSelection":o},members:{_target:null,_preselected:null,__yY:false,__za:false,__yX:null,open:function(){this.placeToWidget(this._target,true);this.show();}
,close:function(){this.hide();}
,setPreselected:function(q){this._preselected=q;this.__za=true;var s=this.getChildControl(e).getSelection();var r=new qx.data.Array([q]);this.__zd(r,s);r.dispose();this.__za=false;}
...
,_handleKeyboard:function(event){if(this.isVisible()&&event.getKeyIdentifier()===d){this.__zc();return;}
;var w=event.clone();w.setTarget(this.getChildControl(e));w.setBubbles(false);this.getChildControl(e).dispatchEvent(w);}
,_handleMouse:function(event){this.__zc();}
,__nT:function(event){if(this.__yY){return;}
;var x=this.getSelection();var y=this.getChildControl(e).getSelection();this.__za=true;this.__zd(x,y);this.__za=false;this.__yY=true;this.__zd(y,x);this.__yY=false;}
,_onListChangeSelection:function(event){if(this.__za){return;}
;var z=this.getChildControl(e).getSelection();if(this.isVisible()){this.setPreselected(z.getItem(0));}
else {this.__yY=true;this.__zd(z,this.getSelection());this.__yY=false;}
;}
,__zb:function(event){if(this.isVisible()){if(this._preselected==null){var A=this.getSelection();var B=this.getChildControl(e).getSelection();this.__zd(A,B);}
;this.__ze();}
...
,_applySelection:function(D,C){D.addListener(g,this.__nT,this);if(C!=null){C.removeListener(g,this.__nT,this);}
;this.__zd(D,this.getChildControl(e).getSelection(D));}
,__zc:function(){if(this._preselected!=null){var E=this.getSelection();E.splice(0,1,this._preselected);this._preselected=null;this.close();}
;}
,__zd:function(F,H){if(F.equals(H)){return;}
...
;}
,__ze:function(){this.__zf();this.__zg();}
,__zf:function(){var I=this._target.getBounds().width;this.setWidth(I);}
,__zg:function(){var J=this.__zh();var L=this._target.getMaxListHeight();var K=this.getChildControl(e);var M=K.getPane().getRowConfig().getTotalSize();if(L==null||M<L){L=M;}
;if(L>J){K.setMaxHeight(J);}
else if(L<J){K.setMaxHeight(L);}
;}
,__zh:function(){var N=this.getLayoutLocation(this._target);var Q=qx.bom.Viewport.getHeight();var P=N.top;var O=Q-N.bottom;return P>O?P:O;}
},destruct:function(){if(this.__yX){this.__yX.dispose();}
;}
});}
)();
...
,_beforeOpen:function(){this.__Al();}
...
;this.close();}
,__Ak:function(event){if(this.__zB==true){return;}
;var N=this.__eU.getItem(0);if(N){N=this.__bn(N);this.setValue(N);}
;}
,_applyPlaceholder:function(P,O){this.getChildControl(r).setPlaceholder(P);}
,__Al:function(){var S=this.getValue();var R=this.getChildControl(s);var Q=R.getSelection();if(this.__bn(Q.getItem(0))!==S){this.__zB=true;Q.removeAll();this.__zB=false;if(S==null||S==q){return;}
...
;return bb;}
},destruct:function(){var be=this.getChildControl(r);this.removeAllBindings();be.removeAllBindings();this.__eU.removeListener(k,this.__Ak,this);this.__eU=null;}
});}
)();
