...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Cookie","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Cookie.10069ead3886.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.bom.Cookie",b="",c="Save",d="Restore",f="TextFieldContent",g="Delete",h="execute";qx.Class.define(a,{extend:qx.application.Standalone,statics:{COOKIE_KEY:f},members:{main:function(){qx.application.Standalone.prototype.main.call(this);var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));this.getRoot().add(l,{left:20,top:20});var j=new qx.ui.form.TextField();l.add(j);var i=new qx.ui.form.Button(c);l.add(i);i.addListener(h,function(e){if(j.getValue()!=b){qx.bom.Cookie.set(demobrowser.demo.bom.Cookie.COOKIE_KEY,j.getValue());j.setValue(b);}
;}
,this);var k=new qx.ui.form.Button(d);l.add(k);k.addListener(h,function(e){var n=qx.bom.Cookie.get(demobrowser.demo.bom.Cookie.COOKIE_KEY);j.setValue(n!=null?n:b);}
,this);var m=new qx.ui.form.Button(g);l.add(m);m.addListener(h,function(e){qx.bom.Cookie.del(demobrowser.demo.bom.Cookie.COOKIE_KEY);j.setValue(b);}
,this);}
}});}
)();
