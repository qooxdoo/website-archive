...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.PageVisibility.d4bacbb18964.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;return this.$$instance;}
},construct:function(document){this.__sN=document||window.document;this.__JQ();var self=this;qx.bom.Event.addNativeListener(this.__sN,this.__JP,function(e){self.emit(a,e);}
);}
,events:{"change":h},members:{__sN:null,__JN:null,__JO:null,__JP:null,__JQ:function(){var l=qx.bom.Style.VENDOR_PREFIXES;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+f;if(this.__sN[m]!=undefined){this.__JN=m;this.__JP=l[i].toLowerCase()+c;break;}
;}
;for(var i=0;i<l.length;i++ ){var m=l[i].toLowerCase()+j;if(this.__sN[m]!=undefined){this.__JO=m;break;}
;}
;if(this.__JN==null){this.__JN=k;this.__JP=c;}
;if(this.__JO==null){this.__JO=b;}
;}
,isHidden:function(){return !!this.__sN[this.__JN];}
,getVisibilityState:function(){return this.__sN[this.__JO]||d;}
}});}
)();
