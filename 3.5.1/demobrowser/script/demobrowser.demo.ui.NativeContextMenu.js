...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.NativeContextMenu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.NativeContextMenu.fa83e16e1070.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="<b>rich</b> label",b="plain label",c="bold",d="Native context menu allowed",e="No native context menu",f="demobrowser.demo.ui.NativeContextMenu",g="text field";qx.Class.define(f,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var i=new qx.ui.container.Composite().set({padding:20});this.getRoot().add(i);var h=new qx.ui.layout.Grid(10,10);i.setLayout(h);i.add(new qx.ui.basic.Label(d).set({font:c}),{row:0,column:0});i.add(new qx.ui.basic.Label(b).set({nativeContextMenu:true,selectable:true}),{row:1,column:0});i.add(new qx.ui.basic.Label(a).set({nativeContextMenu:true,selectable:true,rich:true}),{row:2,column:0});i.add(new qx.ui.form.TextField(g).set({nativeContextMenu:true}),{row:3,column:0});i.add(new qx.ui.basic.Label(e).set({font:c}),{row:0,column:1});i.add(new qx.ui.basic.Label(b).set({selectable:true}),{row:1,column:1});i.add(new qx.ui.basic.Label(a).set({rich:true,selectable:true}),{row:2,column:1});i.add(new qx.ui.form.TextField(g),{row:3,column:1});}
}});}
)();
