...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.Service.bb8cbc91e455.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="qx.core.Object",c="qx.data.controller.Object",d="get",e="[",f="reset",g="_applyModel",h="last";qx.Class.define(c,{extend:qx.core.Object,construct:function(j){qx.core.Object.call(this);this.__bc={};this.__fz=[];if(j!=null){this.setModel(j);}
;}
,properties:{model:{check:b,event:a,apply:g,nullable:true,dereference:true}},members:{__fz:null,__bc:null,_applyModel:function(o,l){for(var i=0;i<this.__fz.length;i++ ){var t=this.__fz[i][0];var q=this.__fz[i][1];var n=this.__fz[i][2];var r=this.__fz[i][3];var p=this.__fz[i][4];var m=this.__fz[i][5];if(l!=undefined&&!l.isDisposed()){this.__AB(t,q,n,l);}
;if(o!=undefined){this.__AA(t,q,n,r,p,m);}
...
;}
;}
,addTarget:function(z,w,u,x,y,v){this.__fz.push([z,w,u,x,y,v]);this.__AA(z,w,u,x,y,v);}
,__AA:function(F,D,B,G,E,A){if(this.getModel()==null){return;}
...
,removeTarget:function(K,J,L){this.__AB(K,J,L,this.getModel());for(var i=0;i<this.__fz.length;i++ ){if(this.__fz[i][0]==K&&this.__fz[i][1]==J&&this.__fz[i][2]==L){this.__fz.splice(i,1);}
;}
;}
,__AB:function(R,O,N,M){if(!(R instanceof qx.core.Object)){return;}
