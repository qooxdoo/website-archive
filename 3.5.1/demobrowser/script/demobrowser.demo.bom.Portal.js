...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Portal.6140c0e8fd50.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="groupBoxes",b="demobrowser.demo.bom.portal.box.Manager",c="boxData",d="qx.event.type.Event",e="boxes",f="demobrowser.demo.bom.portal.box.Box",g="_applyActiveBox",h="loaded",m="singleton";qx.Class.define(b,{type:m,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__QW=[];this.__QX=[];this.__QY={};}
,statics:{dataKeyRoot:c,dataKeyGroupBoxes:a,dataKeyBoxes:e},events:{"loaded":d},properties:{activeBox:{init:null,check:f,apply:g}},members:{__QW:null,__QX:null,__QY:null,_applyActiveBox:function(o,n){if(n!=null){n.setActive(false);}
;o.setActive(true);}
,load:function(){this.__dp(window[demobrowser.demo.bom.portal.box.Manager.dataKeyRoot]);qx.event.Registration.fireEvent(this,h);}
,__dp:function(t){var s,w,u,v,x,t;var p=t[demobrowser.demo.bom.portal.box.Manager.dataKeyGroupBoxes];var r=t[demobrowser.demo.bom.portal.box.Manager.dataKeyBoxes];for(var w in p){s=p[w];u=s.boxes;w=s.id;v={id:w,element:document.getElementById(w)};this.__QX.push(v);this.__QY[w]=[];for(var k=0,l=u.length;k<l;k++ ){t=r[u[k]];var q=document.getElementById(t.id);var x=new demobrowser.demo.bom.portal.box.Box(t,q,null,w);this.__QW.push(x);this.__QY[w].push(x);}
;}
;}
,getBoxes:function(){return this.__QW;}
,getGroupBoxes:function(){return this.__QX;}
,updateGroupBoxMembers:function(A,B,y){var z=qx.dom.Hierarchy.getElementIndex(y.getElement());qx.lang.Array.remove(this.__QY[B],y);qx.lang.Array.insertAt(this.__QY[A],y,z);}
,getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__QX.length,D;i<j;i++ ){D=this.__QY[this.__QX[i].id];for(var k=0,l=D.length;k<l;k++ ){if(D[k].getId()===C){return this.__QX[i];}
;}
;}
;return null;}
},destruct:function(){this.__QW=this.__QX=this.__QY=null;}
});}
)();
(function(){var a="click",b="Boolean",c="1px solid #444444",d="height",f="position",g="zIndex",h="_applyActive",i="width",j="box_content",k=" It does contain no UI widget code at all.",l="<br/><br/>",m="relative",n="demobrowser.demo.bom.portal.box.Box",o="1px solid orange",p="This is a demo application showing the low-level capabilities.",q="div",r="String",s="border";qx.Class.define(n,{extend:qx.core.Object,construct:function(v,x,t,u){qx.core.Object.call(this);this.__Ra=v;this.__ci=v.id;if(x!=null){qx.bom.element.Style.set(x,i,v.width);qx.bom.element.Style.set(x,d,v.height);this.__Rd(x,t);}
;this.setElement(x);this.setGroupBoxId(u);this.__Rb=null;this.__Rc=null;if(v.resizable){this.setResizable(true);var w={minWidth:parseInt(v.minWidth),minHeight:parseInt(v.minHeight),maxWidth:parseInt(v.maxWidth),maxHeight:parseInt(v.maxHeight),handles:v.resizeHandles};this.__Rb=new demobrowser.demo.bom.portal.box.Resizable(this,w);}
;if(v.draggable){this.setDraggable(true);this.__Rc=new demobrowser.demo.bom.portal.box.Draggable(this);}
;this.__Re();}
,properties:{element:{init:null},groupBoxId:{init:null,check:r},active:{check:b,init:false,apply:h},resizable:{check:b,init:false},draggable:{check:b,init:false}},members:{__ci:null,__Ra:null,__Rc:null,__Rb:null,_applyActive:function(z,y){if(z){qx.bom.element.Style.set(this.getElement(),s,o);}
...
,getDraggableComponent:function(){return this.__Rc;}
,getResizableComponent:function(){return this.__Rb;}
,__Rd:function(C,A){if(A){for(var B in A){qx.bom.element.Style.set(B,A[B]);}
;}
;qx.bom.element.Style.set(C,f,m);qx.bom.element.Style.set(C,g,0);qx.bom.Element.addListener(C,a,this.__Rf,this,true);}
,__Re:function(){var E=p+k;E=E+l+E+l+E;var D=qx.dom.Element.create(q,{"class":j});D.innerHTML=E;qx.dom.Element.insertEnd(D,this.getElement());}
,__Rf:function(e){demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this);}
},destruct:function(){this.resetElement();this.__Ra=this.__Rb=this.__Rc=null;}
});}
)();
...
(function(){var a="south",b="mouseup",c="mousedown",d='px',f="width",g="visibility",h="_",i="height",j="mouseover",k="mouseout",l="px",m="east",n="visible",o="hidden",p="mousemove",q="div",r="orientation",s="demobrowser.demo.bom.portal.box.Resizable",t="southeast",u="Handle";qx.Class.define(s,{extend:qx.core.Object,construct:function(v,w){qx.core.Object.call(this);this.__Rg=v;this.__fb=this.__Rg.getElement();this.__Rh={};this.__Ri=false;this.__Rj={orientation:null,lastCoord:{left:null,top:null}};this.__Rk={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};for(var name in this.__Rk){if(w[name]){this.__Rk[name]=w[name];}
;}
;this.__Rd();}
,members:{__Rj:null,__Rg:null,__fb:null,__Rh:null,__Rk:null,__Ri:false,getBox:function(){return this.__Rg;}
,__Rd:function(){switch(this.__Rk.handles){case 1:this.__Rh.east=null;break;case 2:this.__Rh.south=null;break;case 3:this.__Rh.south=null;this.__Rh.southeast=null;this.__Rh.east=null;break;};for(var y in this.__Rh){var x=this.__Rh[y]=qx.dom.Element.create(q);qx.bom.element.Attribute.set(x,r,y);qx.dom.Element.insertEnd(x,this.__fb);if(this.__fb.id){x.id=this.__fb.id+h+y;}
;this.__Rl(y);this.__Rm(y);}
;}
,__Rl:function(z){qx.bom.element.Class.add(this.__Rh[z],z+u);qx.bom.element.Style.set(this.__Rh[z],g,this.__Rk.autoHide?o:n);}
,__Rm:function(B){var C=qx.event.Registration;var A=this.__Rh[B];C.addListener(A,c,this.__Rp,this);C.addListener(document,b,this.__Rq,this);if(this.__Rk.autoHide){C.addListener(this.__Rg.getElement(),j,this.__Rn,this);C.addListener(this.__Rg.getElement(),k,this.__Ro,this);}
;}
,__Rn:function(e){for(var D in this.__Rh){qx.bom.element.Style.set(this.__Rh[D],g,n);}
;}
,__Ro:function(e){if(!this.__Ri){for(var E in this.__Rh){qx.bom.element.Style.set(this.__Rh[E],g,o);}
;}
;}
,__Rp:function(e){e.stopPropagation();if(e.isLeftPressed()){qx.event.Registration.addListener(document,p,this.__Rr,this,true);this.__Ri=true;var F=e.getTarget();this.__Rj.orientation=qx.bom.element.Attribute.get(F,r);this.__Rj.lastCoord.left=e.getDocumentLeft();this.__Rj.lastCoord.top=e.getDocumentTop();demobrowser.demo.bom.portal.box.Util.bringToFront(this.__fb);}
;}
,__Rq:function(e){e.stopPropagation();if(this.__Ri){qx.event.Registration.removeListener(document,p,this.__Rr,this,true);demobrowser.demo.bom.portal.box.Util.sendToBack(this.__fb);if(this.__Rk.autoHide){for(var G in this.__Rh){qx.bom.element.Style.set(this.__Rh[G],g,o);}
;}
;this.__Ri=false;qx.bom.Selection.clear(document.body);}
;}
,__Rr:function(e){e.stopPropagation();if(this.__Ri){var H={left:null,top:null};switch(this.__Rj.orientation){case a:H.top=e.getDocumentTop();break;case t:H.top=e.getDocumentTop();H.left=e.getDocumentLeft();break;case m:H.left=e.getDocumentLeft();break;};this.__Rs(H,this.__Rj.lastCoord);this.__Rj.lastCoord.left=e.getDocumentLeft();this.__Rj.lastCoord.top=e.getDocumentTop();}
;}
,__Rs:function(K,L){var Q=qx.bom.element.Dimension;var N=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Rg.getId());var P=Q.getContentSize(N.element);if(K.left){var M=K.left-L.left;if(M!==0){var J=Q.getContentWidth(this.__fb)+M;var O=Q.getWidth(this.__fb)+M;if((this.__Rk.minWidth==null||J>this.__Rk.minWidth)&&(this.__Rk.maxWidth==null||J<=this.__Rk.maxWidth)){if(P.width>=O){qx.bom.element.Style.set(this.__fb,f,J+d);this.__Rg.getData().width=J;}
;}
;}
;}
;if(K.top){var M=K.top-L.top;if(M!==0){var I=Q.getContentHeight(this.__fb)+M;if((this.__Rk.minHeight==null||I>this.__Rk.minHeight)&&(this.__Rk.maxHeight==null||I<=this.__Rk.maxHeight)){qx.bom.element.Style.set(this.__fb,i,I+l);}
;}
;}
;}
},destruct:function(){if(this.__Rk.autoHide){qx.event.Registration.removeListener(this.__Rg.getElement(),j,this.__Rn,this);qx.event.Registration.removeListener(this.__Rg.getElement(),k,this.__Ro,this);}
;this.__Rg=this.__Rk=this.__fb=this.__Rh=null;this.__Rj=null;}
});}
)();
...
(function(){var a="zIndex",b="auto",c="demobrowser.demo.bom.portal.box.Util";qx.Class.define(c,{statics:{__Rt:1000,bringToFront:function(e){var d=qx.bom.element.Style.get(e,a);d=d==b?0:d;qx.bom.element.Style.set(e,a,d+this.__Rt);}
,sendToBack:function(g){var f=qx.bom.element.Style.get(g,a);qx.bom.element.Style.set(g,a,f-this.__Rt);}
}});}
)();
...
(function(){var a="mousemove",b="engine.name",c="mouseup",d="mousedown",f="dragstart",g="mouseover",h="drag",i="dragend",j="div",k="move",l="dragHandle",m="demobrowser.demo.bom.portal.box.Draggable",n="cursor",o="html";qx.Class.define(m,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);this.__Rg=p;this.__fb=p.getElement();this.__Ru=null;this.__Rv=null;this.__Rd();}
,members:{__Rg:null,__fb:null,__Ru:null,__Rv:null,getBox:function(){return this.__Rg;}
,getElement:function(){return this.__fb;}
,__Rd:function(){this.__Rw();this.__Rm();}
,__Rw:function(){this.__Ru=qx.dom.Element.create(j);qx.bom.element.Class.add(this.__Ru,l);qx.dom.Element.insertBegin(this.__Ru,this.__fb);}
,__Rm:function(){qx.bom.Element.addListener(this.__Ru,d,this.__pu,this);qx.bom.Element.addListener(this.__Ru,g,function(e){qx.bom.element.Style.set(this,n,k);}
,this.__Ru);qx.bom.Element.addListener(this.__Ru,f,this.__tH,this);qx.bom.Element.addListener(this.__Ru,i,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance());qx.bom.Element.addListener(this.__Ru,h,this.__Rz,this);}
,__pu:function(e){if(e.isLeftPressed()){this.__Rv={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__fb),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__fb)};qx.bom.Element.addListener(document.body,c,this.__Ry,this,true);this.__Rx();qx.event.Registration.fireEvent(this.__Ru,f,qx.event.type.Event);}
;}
,__Rx:qx.core.Environment.select(b,{"mshtml":function(){var r=this;var q=qx.lang.Function.bind(this.__Ry,r);document.getElementsByTagName(o)[0].onmouseleave=q;}
,"default":(function(){}
)}),__Ry:function(e){try{e.stopPropagation();}
catch(s){}
;if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,a,this.__Rz,this,true);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().stopSession();}
;qx.bom.Element.removeListener(document.body,c,this.__Ry,this,true);}
,__tH:function(e){if(demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().isSessionActive()){return;}
;demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(this.__Rg);demobrowser.demo.bom.portal.dragdrop.Manager.getInstance().startSession(this.__Rg);qx.event.Registration.addListener(document.body,a,this.__Rz,this,true);}
,__Rz:function(e){e.stopPropagation();var t=e.getDocumentLeft()-this.__Rv.left;var top=e.getDocumentTop()-this.__Rv.top;qx.event.Timer.once(function(){this.checkGroupBox(t,parseInt(this.getActiveBox().getData().width));this.onDragMove(top,t);}
,demobrowser.demo.bom.portal.dragdrop.Manager.getInstance(),0);}
},destruct:function(){this.__Rg=this.__Ru=this.__fb=this.__Rv=null;}
});}
)();
...
(function(){var a="width:",b="top",c="Boolean",d="px",f="border",g="left",h="demobrowser.demo.bom.portal.dragdrop.Manager",k="height:",l="paddingTop",m="opacity:0.5;margin:0;position:absolute;",n="end",o="left:",p="div",q="demobrowser.demo.bom.portal.box.Box",r="px;",s="paddingBottom",t="1px dashed red",u="ease-out",v="singleton",w="top:";qx.Class.define(h,{type:v,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__RA={top:null,height:null};this.__RB={top:0,left:0};}
,properties:{activeBox:{check:q,init:null,nullable:true},sessionActive:{check:c,init:false}},members:{__RA:null,__RC:null,__RD:false,__RB:null,__RE:null,__RF:null,startSession:function(y){this.setSessionActive(true);this.setActiveBox(y);this.__RC=y.getGroupBoxId();this.__RG();if(this.__RE==null){this.__RE={};var x=demobrowser.demo.bom.portal.box.Manager.getInstance().getGroupBoxes();for(var i=0,j=x.length;i<j;i++ ){this.__RE[x[i].element.id]={left:qx.bom.element.Location.getLeft(x[i].element),right:qx.bom.element.Location.getLeft(x[i].element)+qx.bom.element.Dimension.getWidth(x[i].element)};}
;}
;}
,__RG:function(){if(!this.__RF){this.__RF=qx.dom.Element.create(p);}
;var B=this.getActiveBox().getElement();var z=qx.bom.element.Dimension.getContentSize(B);this.__RH(B,this.__RF);qx.bom.element.Class.add(this.__RF,qx.bom.element.Class.get(B));var A=m+w+qx.bom.element.Location.getTop(B)+r+o+qx.bom.element.Location.getLeft(B)+r+a+z.width+r+k+z.height+d;qx.bom.element.Style.setCss(this.__RF,A);qx.bom.element.Style.set(B,f,t);qx.dom.Node.getBodyElement(B).appendChild(this.__RF);demobrowser.demo.bom.portal.box.Util.bringToFront(this.__RF);}
,__RH:function(C,D){while(C.firstChild){D.appendChild(C.firstChild);}
;}
,stopSession:function(e){this.setSessionActive(false);var I=this.getActiveBox();var G=I.getElement();demobrowser.demo.bom.portal.box.Manager.getInstance().updateGroupBoxMembers(I.getGroupBoxId(),this.__RC,I);I.setGroupBoxId(this.__RC);var F={left:qx.bom.element.Location.getLeft(this.__RF)+d,top:qx.bom.element.Location.getTop(this.__RF)+d};var H={left:qx.bom.element.Location.getLeft(G)+d,top:qx.bom.element.Location.getTop(G)+d};var J={timing:u,duration:300,keep:100,keyFrames:{'0':F,'100':H}};var E=qx.bom.element.Animation.animate(this.__RF,J);E.addListener(n,function(){this.__RH(this.__RF,G);qx.bom.element.Style.reset(G,f);this.__RF.parentNode.removeChild(this.__RF);if(I.isActive()){I._applyActive(true);}
else {demobrowser.demo.bom.portal.box.Manager.getInstance().setActiveBox(I);}
;}
,this);}
,onDragMove:function(top,M){if(this.__RB.left!=M){qx.bom.element.Style.set(this.__RF,g,M+d);}
;if(this.__RB.top!=top){qx.bom.element.Style.set(this.__RF,b,top+d);}
;var K=this.getActiveBox().getElement();if(this.__RA.top==null){this.__RA.top=qx.bom.element.Location.getTop(K);}
;if(this.__RA.height==null){this.__RA.height=qx.bom.element.Dimension.getHeight(K);}
;if(this.__RD==false&&top>=this.__RA.top&&top<=(this.__RA.top+this.__RA.height)){return;}
;var L;if(this.__RD){L=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__RC));while(L!=null){if(this.__RI(true,top,K,L)){this.__RD=false;return;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {L=K;}
;if(top-this.__RB.top>0){L=qx.dom.Hierarchy.getNextElementSibling(L);while(L!=null){if(L){if(this.__RI(true,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getNextElementSibling(L);}
;}
else {var L=qx.dom.Hierarchy.getPreviousElementSibling(L);while(L!=null){if(L){if(this.__RI(false,top,K,L)){return;}
;}
;L=qx.dom.Hierarchy.getPreviousElementSibling(L);}
;}
;this.__RB.left=M;this.__RB.top=top;}
,__RI:function(P,top,S,Q){var O=qx.bom.element.Location.getTop(Q);var T=parseInt(qx.bom.element.Style.get(Q,l));var N=parseInt(qx.bom.element.Style.get(Q,s));var U=qx.bom.element.Dimension.getContentHeight(Q)+N+T;var R;if(P){if(top>=(O+(U/3))){R=qx.dom.Hierarchy.getNextElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertAfter(S,Q);this.__RA.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
else {if(top<=(O+U*2/3)){R=qx.dom.Hierarchy.getPreviousElementSibling(Q);if(R!=S||R==null){qx.dom.Element.insertBefore(S,Q);this.__RA.top=qx.bom.element.Location.getTop(S);}
;return true;}
;}
;return false;}
,checkGroupBox:function(X,W){if(this.__RE[this.__RC].left<=X&&this.__RE[this.__RC].right>=X){return;}
;for(var V in this.__RE){if(V!=this.__RC){if(this.__RE[V].left<=X+W&&this.__RE[V].right>=X){this.__RC=V;this.__RD=true;return;}
;}
;}
;}
},destruct:function(){this.__RA=this.__RB=this.__RC=null;this.__RJ=this.__RF=this.__RE=null;}
});}
)();
