...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.FormAndListController.9a8286bce505.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="changeModel",b="modelSelection[0]",c="qx.core.Object",d="qx.debug",e="_applyTarget",f="qx.data.controller.Form",g="changeTarget",h="value",j=" of ",k="Could not bind property ",l=".",m="No target is set.",n="qx.ui.form.Form",o="_applyModel";qx.Class.define(f,{extend:qx.core.Object,construct:function(p,r,q){qx.core.Object.call(this);this._selfUpdate=!!q;this.__Il={};if(p!=null){this.setModel(p);}
;if(r!=null){this.setTarget(r);}
;}
,properties:{model:{check:c,apply:o,event:a,nullable:true,dereference:true},target:{check:n,apply:e,event:g,nullable:true,init:null,dereference:true}},members:{__Im:null,__Il:null,addBindingOptions:function(name,u,v){this.__Il[name]=[u,v];if(this.getModel()==null||this.getTarget()==null){return;}
;var s=this.getTarget().getItems()[name];var t=this.__Ip(s)?b:h;this.__Im.removeTarget(s,t,name);this.__Im.addTarget(s,t,name,!this._selfUpdate,u,v);}
...
;if(this.__Il[name]&&this.__Il[name][1]){A=this.__Il[name][1].converter(A);}
;D[E[i]]=A;}
else {if(!D[E[i]]){D[E[i]]={};}
;D=D[E[i]];}
;}
...
;var F=this.getTarget().getItems();for(var name in F){var I=F[name];var H=this.__Ip(I)?b:h;var G=this.__Il[name];G=G&&this.__Il[name][1];qx.data.SingleValueBinding.updateTarget(I,H,this.getModel(),name,G);}
;}
,_applyTarget:function(K,J){if(J!=null){this.__Io(J);}
;if(this.getModel()==null){return;}
;if(K!=null){this.__In();}
;}
,_applyModel:function(N,L){if(this.__Im!=null&&N==null){this.__Im.setModel(null);}
;if(this.__Im!=null){var M=this.getTarget().getItems();for(var name in M){var O=M[name];var P=this.__Ip(O)?b:h;this.__Im.removeTarget(O,P,name);}
;}
;if(this.__Im!=null){this.__Im.setModel(N);}
;if(this.getTarget()==null){return;}
;if(N!=null){this.__In();}
;}
,__In:function(){if(this.__Im==null){this.__Im=new qx.data.controller.Object(this.getModel());}
;var T=this.getTarget().getItems();for(var name in T){var Q=T[name];var R=this.__Ip(Q)?b:h;var S=this.__Il[name];try{if(S==null){this.__Im.addTarget(Q,R,name,!this._selfUpdate);}
else {this.__Im.addTarget(Q,R,name,!this._selfUpdate,S[0],S[1]);}
;}
catch(U){if(qx.core.Environment.get(d)){this.warn(k+name+j+this.getModel());}
;}
;}
;this.getTarget().redefineResetter();}
,__Io:function(V){if(this.__Im==null){return;}
;var Y=V.getItems();for(var name in Y){var X=Y[name];var W=this.__Ip(X)?b:h;this.__Im.removeTarget(X,W,name);}
;}
,__Ip:function(ba){return qx.Class.hasInterface(ba.constructor,qx.ui.core.ISingleSelection)&&qx.Class.hasInterface(ba.constructor,qx.ui.form.IModelSelection);}
},destruct:function(){if(this.__Im){this.__Im.dispose();}
;}
});}
)();
