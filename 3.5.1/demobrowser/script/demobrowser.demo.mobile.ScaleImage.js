...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage.1556e39ec319.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(x);var D={"width":j,"height":v,"position":C,"left":s,"top":s,"background":d+G+f};this.__Go=new qx.html.Element(h,D);this.__Go.addListener(a,this.__gG,this);this.__Go.addListener(p,this.__gH,this);F.add(this.__Go);}
,__gG:function(e){if(e.isMultiTouch()){this.__Ms=e.getRotation()+this.__Mr;this.__Mt=e.getScale()*this.__Mq;this.__Go.setStyle(o,z+this.__Ms+i+this.__Mt+f);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__Go.getStyle(q))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__Go.getStyle(b))/2);this.__Go.setStyles({"left":I+c,"top":top+c});}
;e.preventDefault();}
,__gH:function(e){if(e.isMultiTouch()){this.__Mr=this.__Ms;this.__Mq=this.__Mt;}
;}
}});}
)();
