...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.9223dc46c3a5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__tz=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__ug=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__ug:null,__tz:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__ug!=null){i.stop(this.__ug);this.__ug=null;}
;this.__ug=i.start(function(){this.__tz.update();this.__ug=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__tz=null;}
});}
)();
