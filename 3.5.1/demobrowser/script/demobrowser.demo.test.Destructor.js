...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Destructor.439f0832515e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="__ij",b="Window: ",c="interval",d=")",e="Done! (Registry: ",f="Label: ",g=" (Registry: ",h="demobrowser.demo.test.Destructor",j="Round: ";qx.Class.define(h,{extend:qx.application.Standalone,members:{__cM:null,__Sz:0,__ij:null,main:function(){qx.application.Standalone.prototype.main.call(this);this.__cM=[];this.currentTest=this.testWindows;this.__ij=new qx.event.Timer(1000);this.__ij.addListener(c,this.runTest,this);this.__ij.start();}
,runTest:function(){this.__Sz++ ;var m=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());this.debug(j+this.__Sz+g+m+d);this.currentTest();qx.ui.core.queue.Manager.flush();var k=this.__cM;for(var i=0,l=k.length;i<l;i++ ){k[i].destroy();}
...
,testLabels:function(){for(var i=0;i<250;i++ ){var n=new qx.ui.basic.Label(f+i);this.getRoot().add(n,{left:50,top:50+i*20});this.__cM.push(n);}
;}
,testWindows:function(){for(var i=0;i<5;i++ ){var o=new qx.ui.window.Window(b+i);o.open();this.__cM.push(o);}
;}
