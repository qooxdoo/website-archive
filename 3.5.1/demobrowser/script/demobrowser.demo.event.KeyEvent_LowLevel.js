...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.KeyEvent_LowLevel.33e595216f84.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="logger",b="keypress",c="",d="char code",e="Ctrl",f="key identifier",g="engine.version",h="Shift",j="demobrowser.demo.event.KeyEvent_LowLevel",k="keydown",l="Event",m="Alt",n="keyup",o="key code";qx.Class.define(j,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this.debug(qx.core.Environment.get(g));this._initLogger([l,o,d,f,h,e,m],document.getElementById(a),50);var p=[k,b,n];for(var i=0;i<p.length;i++ ){qx.bom.Event.addNativeListener(document.documentElement,p[i],qx.lang.Function.bind(this.logKeyEvent,this));}
;}
,logKeyEvent:function(r){var q=r.type;this._log([q,r.keyCode,r.charCode,r.keyIdentifier||c,r.shiftKey,r.ctrlKey,r.altKey]);qx.bom.Event.preventDefault(r);}
}});}
)();
