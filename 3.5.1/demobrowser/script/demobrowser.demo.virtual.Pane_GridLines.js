...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Pane_GridLines","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Pane_GridLines.7904fabe13f5.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.virtual.Pane_GridLines",b="vertical",c="red",d="horizontal",e="blue";qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var l=new qx.ui.layout.Grid(5,5);l.setRowFlex(0,1);l.setColumnFlex(0,1);l.setColumnFlex(1,1);l.setColumnFlex(2,1);var f=new qx.ui.container.Composite(l);this.getRoot().add(f,{edge:5});var g=new qx.ui.virtual.core.Scroller(100,10000,60,100);var h=new qx.ui.virtual.layer.GridLines(d);h.setLineSize(1,3);h.setLineColor(2,c);var i=new qx.ui.virtual.layer.GridLines(b);g.getPane().addLayer(h);g.getPane().addLayer(i);f.add(g,{row:0,column:0});var g=new qx.ui.virtual.core.Scroller(100,10000,60,100);var j=new qx.ui.virtual.layer.GridLines(b);j.setLineSize(1,5);j.setLineColor(1,e);g.getPane().addLayer(j);f.add(g,{row:0,column:1});var g=new qx.ui.virtual.core.Scroller(100,10000,60,100);var k=new qx.ui.virtual.layer.GridLines(d);g.getPane().addLayer(k);f.add(g,{row:0,column:2});}
}});}
)();
...
(function(){var a="scrollY",b="The method 'getItemRight' is not implemented!",c="update",d="scrollX",f="The method 'getItemLeft' is not implemented!",g="The method 'getItemBottom' is not implemented!",h="The method 'getItemTop' is not implemented!",i="pane",j="os.scrollBarOverlayed",k="qx.ui.virtual.core.Scroller";qx.Class.define(k,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(o,l,n,m){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__zi=new qx.ui.virtual.core.Pane(o,l,n,m);this.__zi.addListener(c,this._computeScrollbars,this);this.__zi.addListener(d,this._onScrollPaneX,this);this.__zi.addListener(a,this._onScrollPaneY,this);if(qx.core.Environment.get(j)){this._add(this.__zi,{edge:0});}
else {this._add(this.__zi,{row:0,column:0});}
;}
,properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__zi:null,getPane:function(){return this.__zi;}
,_createChildControlImpl:function(q,p){if(q==i){return this.__zi;}
...
,_onScrollBarX:function(e){this.__zi.setScrollX(e.getData());}
,_onScrollBarY:function(e){this.__zi.setScrollY(e.getData());}
},destruct:function(){this.__zi.dispose();this.__zi=null;}
});}
)();
(function(){var a="scrollY",b="mousedown",c="qx.event.type.Data",d="dblclick",f="change",g="qx.debug",h="__zj",j="__zq",k="qx.event.type.Event",l="cellContextmenu",m="resize",n="scrollX",o="appear",p="qx.ui.virtual.core.CellEvent",q="cellDblclick",r="qx.ui.virtual.core.Pane",s="click",t="__zr",u="update",v="cellClick",w="contextmenu",x="__zk";qx.Class.define(r,{extend:qx.ui.core.Widget,construct:function(B,y,A,z){qx.ui.core.Widget.call(this);this.__zj=new qx.ui.virtual.core.Axis(A,B);this.__zk=new qx.ui.virtual.core.Axis(z,y);this.__zl=0;this.__zm=0;this.__zn=0;this.__zo=0;this.__zp={};this.__iP={};this.__zq=new qx.ui.container.Composite();this.__zq.setUserBounds(0,0,0,0);this._add(this.__zq);this.__zr=[];this.__zj.addListener(f,this.fullUpdate,this);this.__zk.addListener(f,this.fullUpdate,this);this.addListener(m,this._onResize,this);this.addListenerOnce(o,this._onAppear,this);this.addListener(b,this._onMouseDown,this);this.addListener(s,this._onClick,this);this.addListener(d,this._onDblclick,this);this.addListener(w,this._onContextmenu,this);}
,events:{cellClick:p,cellContextmenu:p,cellDblclick:p,update:k,scrollX:c,scrollY:c},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__zj:null,__zk:null,__zl:null,__zm:null,__zn:null,__zo:null,__zp:null,__iP:null,__zq:null,__zr:null,__zs:null,__oD:null,__zt:null,__zu:null,getRowConfig:function(){return this.__zj;}
,getColumnConfig:function(){return this.__zk;}
,getChildren:function(){return [this.__zq];}
,addLayer:function(C){if(qx.core.Environment.get(g)){this.assertInterface(C,qx.ui.virtual.core.ILayer);}
;this.__zr.push(C);C.setUserBounds(0,0,0,0);this.__zq.add(C);}
,getLayers:function(){return this.__zr;}
,getVisibleLayers:function(){var D=[];for(var i=0;i<this.__zr.length;i++ ){var E=this.__zr[i];if(E.isVisible()){D.push(E);}
;}
;return D;}
,getScrollMaxX:function(){var F=this.getInnerSize();if(F){return Math.max(0,this.__zk.getTotalSize()-F.width);}
;return 0;}
,getScrollMaxY:function(){var G=this.getInnerSize();if(G){return Math.max(0,this.__zj.getTotalSize()-G.height);}
;return 0;}
,setScrollY:function(J){var H=this.getScrollMaxY();if(J<0){J=0;}
else if(J>H){J=H;}
;if(this.__zl!==J){var I=this.__zl;this.__zl=J;this._deferredUpdateScrollPosition();this.fireDataEvent(a,J,I);}
;}
,getScrollY:function(){return this.__zl;}
,setScrollX:function(M){var K=this.getScrollMaxX();if(M<0){M=0;}
else if(M>K){M=K;}
;if(M!==this.__zm){var L=this.__zm;this.__zm=M;this._deferredUpdateScrollPosition();this.fireDataEvent(n,M,L);}
;}
,getScrollX:function(){return this.__zm;}
,getScrollSize:function(){return {width:this.__zk.getTotalSize(),height:this.__zj.getTotalSize()};}
...
,this,0);}
,this);return;}
;var R=this.__zj.getItemPosition(P);var O=R+this.__zj.getItemSize(P);var N=this.getScrollY();if(R<N){this.setScrollY(R);}
...
,this,0);}
,this);return;}
;var U=this.__zk.getItemPosition(S);var T=U+this.__zk.getItemSize(S);var W=this.getScrollX();if(U<W){this.setScrollX(U);}
...
;bf=this.__zj.getItemAtPosition(this.getScrollY()+bc-bd.top);be=this.__zk.getItemAtPosition(this.getScrollX()+bb-bd.left);if(!bf||!be){return null;}
...
;var bn=this.__zm+bl.width;var bo=this.__zo-bn;if(this.__zm-this.__zp.left<Math.min(this.__zm,bj)||this.__zp.right-bn<Math.min(bo,bk)){var bp=Math.min(this.__zm,bm);var bh=Math.min(bo,bi);this._setLayerWindow(bg,this.__zm-bp,this.__zl,bl.width+bp+bh,bl.height,false);}
;}
,prefetchY:function(bz,bv,br,bu){var bq=this.getVisibleLayers();if(bq.length==0){return;}
;var bw=this.getBounds();if(!bw){return;}
;var bs=this.__zl+bw.height;var bt=this.__zn-bs;if(this.__zl-this.__zp.top<Math.min(this.__zl,bz)||this.__zp.bottom-bs<Math.min(bt,br)){var by=Math.min(this.__zl,bv);var bx=Math.min(bt,bu);this._setLayerWindow(bq,this.__zm,this.__zl-by,bw.width,bw.height+by+bx,false);}
;}
,_onResize:function(){if(this.getContentElement().getDomElement()){this.__zs=true;this._updateScrollPosition();this.__zs=null;this.fireEvent(u);}
;}
...
,_onClick:function(e){this.__zv(e,v);}
,_onContextmenu:function(e){this.__zv(e,l);}
,_onDblclick:function(e){this.__zv(e,q);}
...
,syncWidget:function(bD){if(this.__iP._fullUpdate){this._fullUpdate();}
else if(this.__iP._updateScrollPosition){this._updateScrollPosition();}
;this.__iP={};}
,_setLayerWindow:function(bE,bT,top,bP,bL,bV){var bK=this.__zj.getItemAtPosition(top);if(bK){var bN=bK.index;var bR=this.__zj.getItemSizes(bN,bL+bK.offset);var bM=qx.lang.Array.sum(bR);var bU=top-bK.offset;var bQ=top-bK.offset+bM;}
else {var bN=0;var bR=[];var bM=0;var bU=0;var bQ=0;}
;var bF=this.__zk.getItemAtPosition(bT);if(bF){var bJ=bF.index;var bH=this.__zk.getItemSizes(bJ,bP+bF.offset);var bO=qx.lang.Array.sum(bH);var bS=bT-bF.offset;var bI=bT-bF.offset+bO;}
else {var bJ=0;var bH=[];var bO=0;var bS=0;var bI=0;}
;this.__zp={top:bU,bottom:bQ,left:bS,right:bI};this.__zq.setUserBounds((this.getPaddingLeft()||0)+(this.__zp.left-this.__zm),(this.getPaddingTop()||0)+(this.__zp.top-this.__zl),bO,bM);this.__oD=bH;this.__zt=bR;for(var i=0;i<this.__zr.length;i++ ){var bG=this.__zr[i];bG.setUserBounds(0,0,bO,bM);if(bV){bG.fullUpdate(bN,bJ,bR,bH);}
else {bG.updateLayerWindow(bN,bJ,bR,bH);}
;}
;}
,__zw:function(){if(this.__zs){return;}
;var bW=this.getScrollSize();if(this.__zn!==bW.height||this.__zo!==bW.width){this.__zn=bW.height;this.__zo=bW.width;this.fireEvent(u);}
;}
,fullUpdate:function(){this.__iP._fullUpdate=1;qx.ui.core.queue.Widget.add(this);}
,isUpdatePending:function(){return !!this.__iP._fullUpdate;}
,_fullUpdate:function(){var bX=this.getVisibleLayers();if(bX.length==0){this.__zw();return;}
;var bY=this.getBounds();if(!bY){return;}
;this._setLayerWindow(bX,this.__zm,this.__zl,bY.width,bY.height,true);this.__zw();}
,_deferredUpdateScrollPosition:function(){this.__iP._updateScrollPosition=1;qx.ui.core.queue.Widget.add(this);}
...
;var cb={top:this.__zl,bottom:this.__zl+cc.height,left:this.__zm,right:this.__zm+cc.width};if(this.__zp.top<=cb.top&&this.__zp.bottom>=cb.bottom&&this.__zp.left<=cb.left&&this.__zp.right>=cb.right){this.__zq.setUserBounds((this.getPaddingLeft()||0)+(this.__zp.left-cb.left),(this.getPaddingTop()||0)+(this.__zp.top-cb.top),this.__zp.right-this.__zp.left,this.__zp.bottom-this.__zp.top);}
else {this._setLayerWindow(ca,this.__zm,this.__zl,cc.width,cc.height,false);}
;this.__zw();}
},destruct:function(){this._disposeArray(t);this._disposeObjects(h,x,j);this.__zp=this.__iP=this.__oD=this.__zt=null;}
});}
)();
...
,events:{"change":e},members:{__zx:null,getDefaultItemSize:function(){return this.defaultItemSize;}
,setDefaultItemSize:function(k){if(this.defaultItemSize!==k){this.defaultItemSize=k;this.__zx=null;this.fireNonBubblingEvent(c);}
;}
,getItemCount:function(){return this.itemCount;}
,setItemCount:function(l){if(this.itemCount!==l){this.itemCount=l;this.__zx=null;this.fireNonBubblingEvent(c);}
;}
...
;this.__zx=null;this.fireNonBubblingEvent(c);}
,getItemSize:function(o){return this.customSizes[o]||this.defaultItemSize;}
,resetItemSizes:function(){this.customSizes={};this.__zx=null;this.fireNonBubblingEvent(c);}
,__zy:function(){if(this.__zx){return this.__zx;}
;var s=this.defaultItemSize;var q=this.itemCount;var y=[];for(var v in this.customSizes){var p=parseInt(v,10);if(p<q){y.push(p);}
;}
;if(y.length==0){var u=[{startIndex:0,endIndex:q-1,firstItemSize:s,rangeStart:0,rangeEnd:q*s-1}];this.__zx=u;return u;}
...
;var z=u[u.length-1];var w=(q-z.startIndex-1)*s;z.rangeEnd=z.rangeStart+z.firstItemSize+w-1;z.endIndex=q-1;this.__zx=u;return u;}
,__zz:function(F){var B=this.__zx||this.__zy();var C=0;var A=B.length-1;while(true){var E=C+((A-C)>>1);var D=B[E];if(D.rangeEnd<F){C=E+1;}
else if(D.rangeStart>F){A=E-1;}
else {return D;}
;}
;}
,getItemAtPosition:function(K){if(K<0||K>=this.getTotalSize()){return null;}
;var J=this.__zz(K);var L=J.rangeStart;var G=J.startIndex;var I=J.firstItemSize;if(L+I>K){return {index:G,offset:K-L};}
else {var H=this.defaultItemSize;return {index:G+1+Math.floor((K-L-I)/H),offset:(K-L-I)%H};}
;}
,__zA:function(M){var O=this.__zx||this.__zy();var P=0;var N=O.length-1;while(true){var R=P+((N-P)>>1);var Q=O[R];if(Q.endIndex<M){P=R+1;}
else if(Q.startIndex>M){N=R-1;}
else {return Q;}
;}
;}
,getItemPosition:function(S){if(S<0||S>=this.itemCount){return null;}
;var T=this.__zA(S);if(T.startIndex==S){return T.rangeStart;}
else {return T.rangeStart+T.firstItemSize+(S-T.startIndex-1)*this.defaultItemSize;}
;}
,getTotalSize:function(){var U=this.__zx||this.__zy();return U[U.length-1].rangeEnd+1;}
...
;}
;return W;}
},destruct:function(){this.customSizes=this.__zx=null;}
});}
)();
...
(function(){var a="qx.ui.virtual.layer.Abstract",b="abstract",c="Abstract method '_fullUpdate' called!";qx.Class.define(a,{extend:qx.ui.core.Widget,type:b,implement:[qx.ui.virtual.core.ILayer],construct:function(){qx.ui.core.Widget.call(this);this.__iP={};}
,properties:{anonymous:{refine:true,init:true}},members:{__iP:null,__bG:null,__zS:null,__zT:null,__zt:null,__oD:null,getFirstRow:function(){return this.__zS;}
,getFirstColumn:function(){return this.__zT;}
,getRowSizes:function(){return this.__zt||[];}
,getColumnSizes:function(){return this.__oD||[];}
,syncWidget:function(e){if(!this.getContentElement().getDomElement()){return;}
;if(this.__iP.fullUpdate||this.__iP.updateLayerWindow&&this.__iP.updateLayerData){this._fullUpdate.apply(this,this.__bG);}
else if(this.__iP.updateLayerWindow){this._updateLayerWindow.apply(this,this.__bG);}
else if(this.__iP.updateLayerData&&this.__zt){this._updateLayerData();}
;if(this.__iP.fullUpdate||this.__iP.updateLayerWindow){var d=this.__bG;this.__zS=d[0];this.__zT=d[1];this.__zt=d[2];this.__oD=d[3];}
;this.__iP={};}
,_updateLayerData:function(){this._fullUpdate(this.__zS,this.__zT,this.__zt,this.__oD);}
,_fullUpdate:function(g,i,h,f){throw new Error(c);}
,_updateLayerWindow:function(k,m,l,j){this._fullUpdate(k,m,l,j);}
,updateLayerData:function(){this.__iP.updateLayerData=true;qx.ui.core.queue.Widget.add(this);}
,fullUpdate:function(p,q,o,n){this.__bG=arguments;this.__iP.fullUpdate=true;qx.ui.core.queue.Widget.add(this);}
,updateLayerWindow:function(t,u,s,r){this.__bG=arguments;this.__iP.updateLayerWindow=true;qx.ui.core.queue.Widget.add(this);}
},destruct:function(){this.__iP=this.__bG=this.__zt=this.__oD=null;}
});}
)();
...
;this.__FC=[];this.__FD=[];this._isHorizontal=(w||c)==c;}
,properties:{defaultLineColor:{init:h,check:s,themeable:true},defaultLineSize:{init:1,check:t,themeable:true}},members:{__FC:null,__FD:null,isHorizontal:function(){return this._isHorizontal;}
...
;this.__FC[B]=A;if(this.__FE(B)){this.updateLayerData();}
;}
...
;this.__FD[C]=D;if(this.__FE(C)){this.updateLayerData();}
;}
,__FE:function(E){if(this._isHorizontal){var I=this.getFirstColumn();var G=I+this.getColumnSizes().length-1;return E>=I&&E<=G;}
else {var H=this.getFirstRow();var F=H+this.getRowSizes().length-1;return E>=H&&E<=F;}
;}
,getLineSize:function(J){return this.__FD[J]||this.getDefaultLineSize();}
,getLineColor:function(K){return this.__FC[K]||this.getDefaultLineColor();}
,__FF:function(P,M,O){var top=0;var L,N;for(var y=0;y<O.length-1;y++ ){L=this.getLineColor(M+y);N=this.getLineSize(M+y);top+=O[y];P.push(m,g,f+N+q,j,d,top-((N>1)?Math.floor(N/2):1),q,b,L,n,a);}
;}
,__FG:function(T,Q,S){var V=0;var R,U;for(var x=0;x<S.length-1;x++ ){R=this.getLineColor(Q+x);U=this.getLineSize(Q+x);V+=S[x];T.push(m,g,k+U+q,l,u,p,V-((U>1)?Math.floor(U/2):1),q,b,R,n,a);}
;}
,_fullUpdate:function(ba,bb,X,W){var Y=[];if(this._isHorizontal){this.__FF(Y,ba,X);}
else {this.__FG(Y,bb,W);}
