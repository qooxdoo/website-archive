...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.HtmlArea.2ac835e46ffe.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,this.__vS);qx.dom.Element.insertBegin(ei,eh);return eh;}
,__wc:function(){var ep=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ep,{"marginRight":cA,"float":di});var er;var eq=qx.dom.Element.create(cN,{title:cQ});if(qx.core.Environment.get(cU)==cD){qx.bom.element.Attribute.set(eq,cx,dT);}
...
;}
,this.__vS);qx.dom.Element.insertBegin(eq,ep);return ep;}
,__we:function(){var ew=[{bold:{text:cO,image:dq,action:this.__vS.setBold},italic:{text:u,image:dz,action:this.__vS.setItalic},underline:{text:dI,image:w,action:this.__vS.setUnderline},strikethrough:{text:dJ,image:cS,action:this.__vS.setStrikeThrough},removeFormat:{text:cX,image:cH,action:this.__vS.removeFormat}},{alignLeft:{text:K,image:dp,action:this.__vS.setJustifyLeft},alignCenter:{text:dw,image:L,action:this.__vS.setJustifyCenter},alignRight:{text:t,image:dl,action:this.__vS.setJustifyRight},alignJustify:{text:O,image:dx,action:this.__vS.setJustifyFull}},{fontFamily:{custom:this.__wb},fontSize:{custom:this.__wc},fontColor:{text:cJ,image:cL,action:this.__vU},textBackgroundColor:{text:V,image:s,action:this.__vV}},{indent:{text:m,image:C,action:this.__vS.insertIndent},outdent:{text:dK,image:dH,action:this.__vS.insertOutdent}},{insertImage:{text:dD,image:dg,action:this.__vW},insertTable:{text:b,image:cF,action:this.__vX},insertLink:{text:X,image:de,action:this.__vY},insertHTML:{text:dR,image:Q,action:this.__wa},insertHR:{text:R,image:S,action:this.__vS.insertHorizontalRuler}},{ol:{text:dm,image:B,action:this.__vS.insertOrderedList},ul:{text:dO,image:T,action:this.__vS.insertUnorderedList}},{undo:{text:dA,image:cG,action:this.__vS.undo},redo:{text:dQ,image:dv,action:this.__vS.redo}}];var ey,eC,ev,ez;for(var i=0,j=ew.length;i<j;i++ ){eC={};eC[cY]=i==j-1?dC:cA;eC[G]=di;ey=qx.dom.Element.create(c);qx.bom.element.Style.setStyles(ey,eC);for(var eA in ew[i]){var eB=ew[i][eA];if(eB.custom){ev=eB.custom.call(this);}
...
;break;case 3:iu.push(iz?iC.data:qx.bom.htmlarea.HtmlArea.__wA(iC.data));break;case 8:iu.push(J,iC.data,fM);break;};return iu.join(fD);}
,closingTags:fn,__wz:function(iD){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(hh+iD.tagName+hh)!=-1);}
,__wA:function(s){s=s.replace(/&/ig,gw);s=s.replace(/</ig,fc);s=s.replace(/>/ig,gf);s=s.replace(/\x22/ig,hK);s=s.replace(/\xA9/ig,R);return s;}
...
},properties:{contentType:{check:hV,init:ha},messengerMode:{check:gY,init:false},insertParagraphOnLinebreak:{check:gY,init:true},insertLinebreakOnCtrlEnter:{check:gY,init:true},postProcess:{check:t,nullable:true,init:null},useUndoRedo:{check:gY,init:true},nativeContextMenu:{check:gY,init:false},defaultFontFamily:{check:hV,init:fQ},defaultFontSize:{check:hW,init:4}},members:{__lH:null,__ea:false,__wB:false,__wC:false,__wD:false,__wE:false,__wv:null,__wF:null,__wG:null,__wH:null,__tb:null,__wt:null,__wI:null,__wJ:null,__wK:false,__wL:false,__wM:function(iH){if(qx.dom.Node.isElement(iH)&&qx.dom.Node.isNodeName(iH,p)){this.__lH=iH;}
;}
,_createAndAddIframe:function(iI){this.__tb=qx.bom.Iframe.create();qx.bom.Iframe.setSource(this.__tb,iI);if((qx.core.Environment.get(eM)==gM)){qx.bom.element.Attribute.set(this.__tb,gR,fm);}
else {qx.bom.element.Style.set(this.__tb,hg,he);}
;qx.bom.element.Style.setStyles(this.__tb,{width:gq,height:gq});qx.dom.Element.insertBegin(this.__tb,this.__lH);}
,_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__tb);}
,_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__tb);}
,_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__tb,C,this._loaded,this);}
,__wN:function(){this.__wI={"xhtml":{doctype:hM+gC+hI+hc+eE+hU,html:hi+M,meta:hj,style:qx.core.Environment.select(eM,{"mshtml":eJ+fW,"default":fL+gK}),contentStyle:fX,body:gP,footer:fs}};}
,__wu:fD,getIframeObject:function(){return this.__tb;}
,getCommandManager:function(){return this.__wv;}
,setValue:function(iK){if(qx.lang.Type.isString(iK)){this.__wu=iK;var iJ=this._getIframeDocument();if(iJ&&iJ.body){iJ.body.innerHTML=this.__wO(iK);}
;}
;}
,__wO:function(iO){var iN=fD;if((qx.core.Environment.get(eM)==hs)){if(qx.core.Environment.get(gF)<=2){iN+=fu;}
;}
;var iP=iO.length==0?hS:fD;var iM=qx.core.Environment.get(eM)==hs||qx.core.Environment.get(eM)==fO?F:fl;var iL=gm+hC+this.getDefaultFontFamily()+gE+E+iM+K+this.getDefaultFontSize()+gE+iN+iO+iP+hk+c+ht;return iL;}
,getValue:function(){return this.__wu;}
,getComputedValue:function(iQ){return this.getHtml(iQ);}
,getCompleteHtml:function(){var iS=this.__wI[this.getContentType()];var iR=iS.html+gn+iS.meta+eH+iS.contentStyle+hL+gl;iR+=fC+this.__wP()+N;iR+=this.getHtml()+fs;return iR;}
,__wP:function(){var iW=[d,hw,gt,H,B,v,hu,gU,gG,hJ,hr,fw,gh,fK];var iU=qx.bom.element.Style;var iT=this.getContentBody();var iY={};var iV,ja;var iX=qx.core.Environment.get(eM)==gM?2:1;for(var i=0,j=iW.length;i<j;i++ ){iV=iW[i];ja=iU.get(iT,iV,iX);if(ja!==undefined&&ja!=fD){iY[iV]=ja;}
;}
;return qx.bom.element.Style.compile(iY);}
,getContentDocument:function(){if(this.__ea){return this._getIframeDocument();}
;}
,getContentBody:function(){if(this.__ea){return this._getIframeDocument().body;}
;}
,getContentWindow:function(){if(this.__ea){return this._getIframeWindow();}
;}
,getWords:function(jb){if(!jb){jb=this.getContentBody();}
;if(!jb){return [];}
;var jd=jb.cloneNode(true);var jf=jd.innerHTML;jf=jf.replace(/>/gi,hB);jf=jf.replace(/\n/gi,hh);jf=jf.replace(/<!--.*-->/gi,fD);jd.innerHTML=jf;var jc=qx.core.Environment.get(eM)==gM||qx.core.Environment.get(eM)==P?jd.innerText:jd.textContent;var je=jc.match(qx.bom.htmlarea.HtmlArea.GetWordsRegExp);return !je?[]:je;}
...
;}
;return jp;}
,__wQ:0,__wR:function(){var jr=this._getIframeDocument();if(!jr){this.__wQ++ ;if(this.__wQ>5){this.error(hF+jr);this.fireDataEvent(fR);}
else {if(qx.core.Environment.get(fb)){this.error(D);}
;qx.event.Timer.once(function(){this.__wR();}
,this,0);}
;}
else {this.__wQ=0;this._onDocumentIsReady();}
;}
,_loaded:function(e){if(this.__wC){return;}
;if(this.__wB){this.__wS();return;}
;if((qx.core.Environment.get(eM)==gM)){this.__wR();}
else {this._onDocumentIsReady();}
;}
,isReady:function(){return this.__ea;}
...
;this.__wC=true;if((qx.core.Environment.get(eM)==gM)){this.setEditable(true);}
;this.__wV();if(!(qx.core.Environment.get(eM)==P)){this.__wW();}
;if(!(qx.core.Environment.get(eM)==gM)){this.setEditable(true);}
;this.__ea=true;this.__wv=js;js.setContentDocument(this._getIframeDocument());this.__xc();if((qx.core.Environment.get(eM)==P)){this.__wW();}
;this.fireEvent(gH);}
,forceEditable:qx.core.Environment.select(eM,{"gecko":function(){var jt=this._getIframeDocument();if(jt){if(parseFloat(qx.core.Environment.get(k))>=fk){jt.designMode=fV;jt.body.contentEditable=false;jt.body.contentEditable=true;}
else {jt.body.contentEditable=true;this.__xd(true);}
;}
;}
,"default":(function(){}
)}),invalidateEditor:qx.core.Environment.select(eM,{"gecko":function(){this.__wC=false;this.__ea=false;this.__wB=true;}
,"default":function(){}
}),__wS:qx.core.Environment.select(eM,{"gecko":function(){this.__wV();this.__wW();this.__wv.setContentDocument(this._getIframeDocument());this.setEditable(true);this.forceEditable();this.__wC=true;this.__ea=true;this.__wB=false;this.fireEvent(gd);}
,"default":function(){}
}),__wT:function(jw){var jv=fD;if(!jw){return jv;}
...
;return jv;}
,__wU:function(jB){var jA=qx.core.Environment.get(eM)==hs?gO:fD;var jz=this.__wI[this.getContentType()];var jy=gn+jz.meta+eH+jA+jz.style+jz.contentStyle+this.__wt+hL+gl;var content=jz.body+jB;return jz.html+jy+content+jz.footer;}
,__wV:function(){var jD=this.__wO(this.getValue());if(qx.lang.Type.isString(jD)){var jC=this._getIframeDocument();try{jC.open(eP,true);jC.write(this.__wU(jD));jC.close();}
catch(e){this.error(x+qx.bom.Iframe.queryCurrentUrl(this.__tb)+fe,e);this.fireDataEvent(fR,e);}
;}
;}
,__wW:function(){this.__wX();this.__xa();this.__wY();}
,__wX:function(){var jF=qx.event.Registration;var jE=this._getIframeDocument();jF.addListener(jE.body,gS,this._handleKeyPress,this);jF.addListener(jE.body,fx,this._handleKeyUp,this);jF.addListener(jE.body,fy,this._handleKeyDown,this);}
,__wY:function(){var jI=qx.event.Registration;var jG=this._getIframeDocument();var jH=qx.core.Environment.get(eM)==fO?this._getIframeWindow():jG.body;jI.addListener(jH,hP,this._handleFocusEvent,this);jI.addListener(jH,eD,this._handleBlurEvent,this);jI.addListener(jG,fS,this._handleFocusOutEvent,this);}
...
,__xb:function(){if(this.__wF==null){this.__wF={execute:function(jM,jN){this.stackedCommands=true;this.commandStack.push({command:jM,value:jN});}
,commandStack:[],stackedCommands:false};}
;this.__wF.stackedCommands=false;return this.__wF;}
,__xc:function(){var jO=this.__wF;if(jO!=null&&jO.stackedCommands){var jP=jO.commandStack;if(jP!=null){for(var i=0,j=jP.length;i<j;i++ ){this.__wv.execute(jP[i].command,jP[i].value);}
;}
;}
;}
,__xd:function(jQ){var jR=this._getIframeDocument();if(this.__wC&&jR){try{if((qx.core.Environment.get(eM)==hs)){jR.designMode=(jQ!==false)?gx:u;}
;jR.designMode=(jQ!==false)?u:gx;}
catch(e){}
;}
;}
,setEditable:function(jT){if(this.__wC){this.__xd(true);if((qx.core.Environment.get(eM)==hs)){try{var jS=this._getIframeDocument();jS.execCommand(ge,false,true);}
catch(jU){try{var jS=this._getIframeDocument();jS.execCommand(eW,false,false);}
catch(jV){if(!this.__ea){this.error(m);this.fireDataEvent(fR,jV);}
...
;this.__wD=jT;}
;}
,getEditable:function(){return this.__wD;}
,isEditable:function(){return this.__wD;}
,__xe:false,_handleKeyUp:function(e){var jW=e.getKeyIdentifier().toLowerCase();this.__wG=e;if((qx.core.Environment.get(fb))&&qx.core.Environment.get(hX)){this.debug(e.getType()+hQ+jW);}
...
else {var jX=this.__xp(this.getSelection());if(jX){jX.collapse(true);jX.pasteHTML(ft);}
;}
;this.__xk();}
;break;case eL:this.__xe=false;return;};}
;}
else if((qx.core.Environment.get(eM)==hs)){switch(jW){case hd:case q:case eV:case gQ:case g:case hD:case hY:case n:case T:this.__wE=(this.getFocusNode()==this.getContentBody().firstChild);break;};}
;}
,__xf:function(){var jY=this.getSelection();var ka=fD;if(jY&&(jY.focusNode.textContent==fD||jY.focusNode.parentElement.tagName==hy)){ka=o;}
;this.__wv.execute(fU,ka+qx.bom.htmlarea.HtmlArea.simpleLinebreak);}
,_handleKeyDown:qx.core.Environment.select(eM,{"mshtml|webkit":function(e){var kb=e.getKeyIdentifier().toLowerCase();if((qx.core.Environment.get(fb))&&qx.core.Environment.get(hX)){}
;if(this.__xe&&(kb==fo||kb==Y||kb==fv||kb==hR||kb==L||kb==gs)){e.preventDefault();e.stopPropagation();}
;if(kb==eL){this.__xe=true;}
;}
,"default":function(e){}
}),_handleKeyPress:function(e){var kg=this.getContentDocument();var kc=e.getKeyIdentifier().toLowerCase();var ke=e.isCtrlPressed();var kf=e.isShiftPressed();this.__wG=e;if((qx.core.Environment.get(fb))&&qx.core.Environment.get(hX)){this.debug(e.getType()+hQ+kc);}
;if(this.__wK){var km=!((qx.core.Environment.get(eM)==gM)&&kc==X)||!((qx.core.Environment.get(eM)==hs)&&kc==X);if(km){this.__xk();this.__wK=false;}
;}
...
;}
;this.__xk();}
;if((qx.core.Environment.get(eM)==gM)){if(!this.getInsertParagraphOnLinebreak()){if(this.__wv.execute(fU,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__xk();e.preventDefault();e.stopPropagation();}
;}
;}
...
;kl=kl.parentNode;}
;}
;this.__wv.insertParagraphOnLinebreak();e.preventDefault();e.stopPropagation();this.__xk();this.__wK=true;}
;}
...
;}
;break;case eV:if(qx.core.Environment.get(eM)==hs&&qx.core.Environment.get(k)<1.9&&kf){var kj=this.getSelection();if(kj&&kj.focusNode==kg.body.firstChild){if(this.__wE){if(kj.focusOffset!=0){kj.extend(kj.focusNode,0);}
;}
;}
;}
...
;}
;}
;this.__xk();break;case hd:case q:case gQ:case g:case hD:case hY:case n:case T:this.__xk();break;case fv:if(ke){this.__xg(Q,true);}
;break;case L:case gs:if(ke){this.__xg(hN,true);}
;break;case hR:if(ke){this.__xg(O,true);}
;break;case fo:if(ke&&!kf){this.__xg(h,true);}
else if(ke&&kf){this.__xg(gB,true);}
;break;case Y:if(ke){this.__xg(gB,true);}
;break;case gv:if(ke){this.selectAll();}
;break;};this.__wG=null;}
,__xg:function(ko,kr){var kq=null;var kp=qx.bom.htmlarea.HtmlArea.hotkeyInfo;if(kp[ko]){kq=kp[ko].method;}
;if(kq!=null&&this[kq]){this[kq]();if(kr){this.__wG.preventDefault();this.__wG.stopPropagation();}
;if(this.isSelectionCollapsed()){this.__wK=true;}
;this.__xk();}
;}
,_handleFocusEvent:function(e){this.__wH=null;if(qx.core.Environment.get(eM)==hs||qx.core.Environment.get(eM)==fO){var ks=this.getContentDocument().getElementById(eN);if(ks){qx.bom.element.Attribute.reset(ks,fI);}
;}
;this.fireEvent(A);}
,_handleBlurEvent:function(e){this.__wu=this.getComputedValue();}
,_handleFocusOutEvent:function(e){this.__xe=false;if(this.__wH==null){this.__wH=this.getSelectedHtml();}
;this.fireEvent(hp);}
,_handleMouseUpOnBody:function(e){if((qx.core.Environment.get(fb))&&qx.core.Environment.get(hX)){this.debug(hm+e.getType());}
;this.__wL=true;this.__xk();}
,_handleMouseUpOnDocument:qx.core.Environment.select(eM,{"mshtml":(function(){}
),"default":function(e){if(!this.__wL){qx.bom.Element.activate(this.getContentBody());}
;this.__wL=false;}
...
,this,0);}
;}
,isLoaded:function(){return this.__wC;}
,insertHtml:function(ky){return this.__wv.execute(fU,ky);}
,removeFormat:function(){var kz=this.__wv.execute(gy);this.__wv.execute(hf,this.getDefaultFontSize());this.__wv.execute(fz,this.getDefaultFontFamily());return kz;}
,setBold:function(){return this.__wv.execute(V);}
,setItalic:function(){return this.__wv.execute(gD);}
,setUnderline:function(){return this.__wv.execute(hq);}
,setStrikeThrough:function(){return this.__wv.execute(eU);}
,setFontSize:function(kA){return this.__wv.execute(hf,kA);}
,setFontFamily:function(kB){return this.__wv.execute(fz,kB);}
,setTextColor:function(kC){return this.__wv.execute(w,kC);}
,setTextBackgroundColor:function(kD){return this.__wv.execute(gk,kD);}
,setJustifyLeft:function(){return this.__wv.execute(hn);}
,setJustifyCenter:function(){return this.__wv.execute(eX);}
,setJustifyRight:function(){return this.__wv.execute(fH);}
,setJustifyFull:function(){return this.__wv.execute(ic);}
,insertIndent:function(){return this.__wv.execute(fj);}
,insertOutdent:function(){return this.__wv.execute(fF);}
,insertOrderedList:function(){return this.__wv.execute(ib);}
,insertUnorderedList:function(){return this.__wv.execute(ff);}
,insertHorizontalRuler:function(){return this.__wv.execute(gr);}
,insertImage:function(kE){return this.__wv.execute(gu,kE);}
,insertHyperLink:function(kF){return this.__wv.execute(ia,kF);}
,removeBackgroundColor:function(){return this.__wv.execute(l,fr);}
,setBackgroundColor:function(kG){return this.__wv.execute(l,kG);}
,removeBackgroundImage:function(){return this.__wv.execute(go);}
,setBackgroundImage:function(kH,kJ,kI){return this.__wv.execute(go,[kH,kJ,kI]);}
,selectAll:function(){return this.__wv.execute(fq);}
,undo:function(){if(this.getUseUndoRedo()){return this.__wv.execute(hb);}
else {return true;}
;}
,redo:function(){if(this.getUseUndoRedo()){return this.__wv.execute(I);}
else {return true;}
;}
...
;}
}),__xj:qx.core.Environment.select(eM,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__wO(fD);var la=this.getContentDocument().getElementById(eN);qx.bom.element.Attribute.reset(la,fI);this._selectElement(la);}
...
;var lk=this._getIframeDocument();var lt=(qx.core.Environment.get(eM)==gM)?lg.currentStyle:lk.defaultView.getComputedStyle(lg,null);var lm=false;var ld=false;var li=false;var lh=false;var ll=false;var ls=false;var lj=false;var lu=false;var lf=false;var lp=false;var lq=null;var lr=null;var ln=null;if(lt!=null){if((qx.core.Environment.get(eM)==gM)){ld=lt.fontStyle==gD;li=lt.textDecoration.indexOf(hq)!==-1;lh=lt.textDecoration.indexOf(fp)!==-1;lq=lt.fontSize;ln=lt.fontFamily;lj=lt.textAlign==hd;lu=lt.textAlign==hv;lf=lt.textAlign==q;lp=lt.textAlign==hx;}
...
}),isSelectionCollapsed:qx.core.Environment.select(eM,{"mshtml":function(){return this.getSelection()&&this.getSelection().type==eR;}
,"default":function(){return this.getSelection()&&this.getSelection().isCollapsed;}
}),getSelectedText:qx.core.Environment.select(eM,{"mshtml":function(){return this.getRange()?this.getRange().text:fD;}
,"default":function(){return this.getRange()?this.getRange().toString():fD;}
}),getSelectedHtml:function(){if(this.__wH!=null){return this.__wH;}
;var lw=this.getRange();if(!lw){return fD;}
else {return this.__xm(lw);}
;}
,__xm:qx.core.Environment.select(eM,{"mshtml":function(lx){if(!lx){return fD;}
...
;}
}),saveRange:qx.core.Environment.select(eM,{"mshtml":function(){this.__wJ=this.getRange();}
,"default":function(){}
}),getSavedRange:qx.core.Environment.select(eM,{"mshtml":function(){return this.__wJ;}
,"default":function(){}
}),resetSavedRange:qx.core.Environment.select(eM,{"mshtml":function(){this.__wJ=null;}
,"default":function(){}
}),getFocusNode:qx.core.Environment.select(eM,{"mshtml":function(){var lM=this.getSelection();var lN;switch(lM.type){case fg:case eR:lN=this.__xp(lM);if(lN){lN.collapse(false);return lN.parentElement();}
else {return null;}
...
})},environment:{"qx.bom.htmlarea.HtmlArea.debug":false},destruct:function(){try{var lR=this._getIframeDocument();var lT=qx.event.Registration;lT.removeListener(lR.body,gS,this._handleKeyPress,this);lT.removeListener(lR.body,fx,this._handleKeyUp,this);lT.removeListener(lR.body,fy,this._handleKeyDown,this);var lS=qx.core.Environment.get(eM)==fO?this._getIframeWindow():lR.body;lT.removeListener(lS,hP,this._handleFocusEvent);lT.removeListener(lS,eD,this._handleBlurEvent);lT.removeListener(lR,fS,this._handleFocusOutEvent);var lQ=qx.core.Environment.get(eM)==gM?eK:W;lT.removeListener(lR.body,lQ,this._handleMouseUpOnBody,this);lT.removeListener(lR.documentElement,lQ,this._handleMouseUpOnDocument,this);lT.removeListener(lR.documentElement,fT,this._handleContextMenuEvent,this);if((qx.core.Environment.get(eM)==gM)){qx.bom.Iframe.setSource(this.__tb,gJ);}
;}
catch(lU){}
;if(this.__wv instanceof qx.core.Object){this._disposeObjects(eS);}
else {this.__wv=null;}
;this.__wI=this.__tb=this.__lH=this.__wF=null;}
});}
)();
...
(function(){var a="backgroundColor",b="_moz",c="top",d="/>",f="formatBlock",g="__ya",h="__xU",m="insertParagraph",n=" succeded",o="li",p='<span style="',q="underline",r="<img ",s="' is not allowed for parameter 'position'. Possible values are '",t="no-repeat",u="</font>",v=' <a href="',w="FONT",x="inserthyperlink failed!",y="backgroundPosition",z="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",A="__placeholder__",B="JustifyCenter",C="transparent",D="Cut",E="__xV",F="outdent",G='</a> ',H="InsertImage",I=';',J="font-size",K="__resetHtml",L="FontName",M="p",N="bold",O="blockquote",P="If an array is provided for parameter 'position' it has to define two elements!",Q="inserthtml",R="span",S='|',T="id",U="style",V="__xH",W="The method '",X="qx.bom.htmlarea.manager.Command",Y="__xW",dM="'><br class='webkit-block-placeholder' />",dH="string",dN="a",dJ='"',dK="<span></span>",dG="__xG",dL="href",dR="background-color",dS="backgroundRepeat",dT="type",dU="font",dO="CreateLink",dP=":",dI="InsertHtml",dQ="__yg",dY="':'",eD="='",ea=" with value ",eb="italic",dV='">',dW="' you calling to execute the command '",fE="font-family",dX="mshtml",ec="qx_link",ed="none",ee='"></span>',ej="Italic",ek="fontStyle",el=" ",ef=";",eg=" failed",eh="InsertUnorderedList",ei="body",eq="__yf",er="OL",es='text-align:',et="Bold",em="ForeColor",en="child",eo="px",ep="url(",ey='" ',ez="repeat repeat-x repeat-y no-repeat",fI='</p>',eA="gecko",eu="<hr />",ev="__xJ",fG="legacy-font-size",ew="backgroundImage",eB="editor not ready! '",eC='<font style="',eO="text-align",eN="Command ",eM="Control",eS='color',eR="IMG",eQ="__ye",eP="__xY",eH="__paragraph__",eG='<p id="',eF="StrikeThrough",eE='text-decoration',eL="LI",eK="__getHtml",eJ="__yd",eI="BackColor",fa='font-family:',eY='" size="',eX="Indent",eW=':',fe="HiliteColor",fd="br",fc="fontWeight",fb="Copy",eV="</span>",eU="engine.name",eT="Paste",fp="The value '",fo="qx.bom.htmlarea.HtmlArea.debug",fn="color",ft="RemoveFormat",fs="text-decoration",fr="JustifyRight",fq="size",fi="__xL",fh="FontSize",fg="' is not allowed for parameter 'repeat'. Possible values are '",ff="' ",fm='',fl="webkit",fk='style="',fj="execCommand ",fz='>',fy="'",fx="' is not available!",fw="_moz_dirty",fD="__xC",fC="qx.debug",fB="JustifyLeft",fA="textDecoration",fv=" is currently not supported!",fu="Underline",dC="SelectAll",dB="<p style='",fJ="line-through",dz="BODY",dA=")",dy="__yb",fH="",dw="__xM",dx='<span id="',dv="__xX",fF="UL",dt="JustifyFull",du="Outdent",ds="indent",dE="selectall",dF="InsertOrderedList",dD="undefined";qx.Class.define(X,{extend:qx.core.Object,construct:function(fK){qx.core.Object.call(this);this.__xq=fK;this.__sN=null;this._commands=null;this.__xx();this.__xr={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};this.__xs=[10,12,16,18,24,32,48];this.__xt=0;}
,statics:{__xu:z,__xv:ez},members:{__sN:null,__xq:null,__xw:false,__xr:null,__xs:null,__xt:null,setContentDocument:function(fL){this.__sN=fL;}
,getCommandObject:function(fM){if(this._commands[fM]){return this._commands[fM];}
else {return null;}
;}
,__xx:function(){this._commands={bold:{useBuiltin:false,identifier:et,method:eJ},italic:{useBuiltin:false,identifier:ej,method:eQ},underline:{useBuiltin:false,identifier:fu,method:eq},strikethrough:{useBuiltin:false,identifier:eF,method:dQ},fontfamily:{useBuiltin:true,identifier:L,method:null},fontsize:{useBuiltin:false,identifier:fh,method:h},textcolor:{useBuiltin:true,identifier:em,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:E},backgroundcolor:{useBuiltin:false,identifier:null,method:Y},backgroundimage:{useBuiltin:false,identifier:null,method:dv},justifyleft:{useBuiltin:false,identifier:fB,method:dG},justifyright:{useBuiltin:false,identifier:fr,method:dG},justifycenter:{useBuiltin:false,identifier:B,method:dG},justifyfull:{useBuiltin:false,identifier:dt,method:dG},indent:{useBuiltin:true,identifier:eX,method:null},outdent:{useBuiltin:true,identifier:du,method:null},copy:{useBuiltin:true,identifier:fb,method:null},cut:{useBuiltin:true,identifier:D,method:null},paste:{useBuiltin:true,identifier:eT,method:null},insertorderedlist:{useBuiltin:false,identifier:dF,method:V},insertunorderedlist:{useBuiltin:false,identifier:eh,method:V},inserthorizontalrule:{useBuiltin:false,identifier:dI,method:dw},insertimage:{useBuiltin:false,identifier:H,method:ev},inserthyperlink:{useBuiltin:false,identifier:dO,method:fi},selectall:{useBuiltin:false,identifier:dC,method:eP},selectedtext:{useBuiltin:false,identifier:null,method:g},selectedhtml:{useBuiltin:false,identifier:null,method:dy},inserthtml:{useBuiltin:false,identifier:dI,method:fD},resethtml:{useBuiltin:false,identifier:null,method:K},gethtml:{useBuiltin:false,identifier:null,method:eK},removeformat:{useBuiltin:true,identifier:ft,method:null}};}
,execute:function(fN,fP){if(!this.__xq.isReady()){this.error(eB+fN+dY+fP+fy);return false;}
;fN=fN.toLowerCase();fP=fP!=null?fP:null;if(this._commands[fN]){var fO;var fQ=this._commands[fN];if(!((qx.core.Environment.get(eU)==fl)&&(fN==ds||fN==F))){if(this.__xy()){this.__xz();}
;}
;if(fQ.useBuiltin){fO=this.__xA(fQ.identifier,false,fP);}
else {if(fQ.method!=null&&this[fQ.method]){fO=this[fQ.method].call(this,fP,fQ);}
else {this.error(W+fQ.method+dW+fN+fx);}
;}
;this.__xq.resetSavedRange();return fO;}
else {this.error(eN+fN+fv);}
;}
,__xy:function(){var Node=qx.dom.Node;var fR=this.__xq.getFocusNode();var fU=false;var fS=false;if(fR){if(Node.isText(fR)){var fT=qx.dom.Hierarchy.getAncestors(fR);for(var i=0,j=fT.length;i<j;i++ ){if(Node.isNodeName(fT[i],M)||qx.bom.htmlarea.HtmlArea.isHeadlineNode(fT[i])){fU=true;break;}
;}
;}
else if(Node.isNodeName(fR,ei)){fS=true;}
;}
;return fS||!fU;}
,__xz:function(){this.__xA(f,false,M);}
,__xA:function(gc,ga,fX){try{var fW=this.__sN;var fV=false;var fY=this.__xq.getRange();this.__sN.body.focus();if((qx.core.Environment.get(eU)==dX)){if(gc!=dE){fY.select();if(((fY.text)&&(fY.text.length>0))||((fY.length==1)&&(fY.item(0))&&(fY.item(0).tagName==eR))){fW=fY;}
else {fW=this.__sN;}
;}
;if(((qx.core.Environment.get(eU)==dX))&&(this.__xr[gc])){if(fY.text==fH){fV=true;}
;}
;}
;var gb=fW.execCommand(gc,ga,fX);if(fV&&fY.text!=fH){fY.collapse();}
;if((qx.core.Environment.get(fC))&&qx.core.Environment.get(fo)){this.debug(fj+gc+ea+fX+n);}
;this.__xw=false;}
catch(gd){if((qx.core.Environment.get(fC))&&qx.core.Environment.get(fo)){this.debug(fj+gc+ea+fX+eg);}
;return false;}
;return gb;}
,__xB:qx.core.Environment.select(eU,{"mshtml":function(){var gf=this.__xq;var ge=gf.getSavedRange()!=null?gf.getSavedRange():gf.getRange();return ge;}
,"default":function(){return this.__xq.getRange();}
}),__xC:qx.core.Environment.select(eU,{"mshtml":function(gj,gk){var gi;if(gj==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__xF();}
else {this.__sN.body.focus();var gh=this.__xq.getSelection();var gg=this.__xB();if(gg&&gh&&gh.type!=eM){try{gg.pasteHTML(gj);gg.collapse(false);gg.select();gi=true;}
catch(e){}
;}
else {gi=false;}
;this.__xq.resetSavedRange();return gi;}
;}
,"default":function(gl,gm){this.__sN.body.focus();return this.__sN.execCommand(gm.identifier,false,gl);}
}),insertParagraphOnLinebreak:qx.core.Environment.select(eU,{"gecko":function(){var gu=this.__xP();var gy=this.__xD(gu);var gq=this.__xN(gu);var gv=A+Date.parse(new Date());var gw=eH+Date.parse(new Date());var go=fm;var gs=dx+gv+ee;go+=gs;go+=eG+gw+ey+gy+fz;go+=gq+fI;this.__xq.getCommandManager().addUndoStep(Q,m,this.getCommandObject(Q));this.execute(Q,go);this.__xE();qx.bom.element.Attribute.reset(this.__sN.getElementById(gv),T);var gt=this.__sN.getElementById(gw);if(gt.previousSibling.innerHTML==gs){var gn=this.__xO();var gr=this.__sN.createElement(fd);var gp=this.__sN.createAttribute(fw);gp.nodeValue=fH;gr.setAttributeNode(gp);var gx=this.__sN.createAttribute(dT);gx.nodeValue=b;gr.setAttributeNode(gx);gt.previousSibling.appendChild(gn);gt.previousSibling.appendChild(gr);}
;qx.bom.element.Attribute.reset(gt,T);return true;}
,"webkit":function(){var gz=this.getCurrentStyles();var gA=fH;var gC={"background-color":true,"text-align":true};for(var gB in gz){if(gC[gB]){gA+=gB+dP+gz[gB]+ef;}
;}
;this.__xq.insertHtml(dB+gA+dM);}
,"default":(function(){}
)}),__xD:qx.core.Environment.select(eU,{"gecko":function(gG){var gI=fk;var gD=gG.child;if(gD[eO]){gI+=es+gD[eO]+I;delete gG.child[eO];}
;if(gD[fE]){gI+=fa+gD[fE]+I;delete gG.child[fE];}
;var gH={"padding-top":true,"padding-bottom":true,"padding-left":true,"padding-right":true};var gF={"margin-top":true,"margin-bottom":true,"margin-left":true,"margin-right":true};for(var gE in gD){if(gH[gE]||gF[gE]){gI+=gE+eW+gD[gE]+I;delete gG.child[gE];}
;}
;gI+=dJ;return gI;}
,"default":function(){return fH;}
}),__xE:qx.core.Environment.select(eU,{"gecko":function(){var gQ=this.__xq.getSelection();if(!gQ||!gQ.focusNode){return;}
;var gJ=gQ.focusNode;var gO=gQ.focusNode;while(!qx.dom.Node.isNodeName(gO,M)){gO=gO.parentNode;}
;var gN=gO.previousSibling.id;var gR=gO.nextSibling?gO.nextSibling.id:null;if(qx.lang.String.startsWith(gN,eH)&&gN==gR){var gP=gO.nextSibling;var gL=this.__xq.getRange();gL.selectNode(gP);gQ.addRange(gL);var gK=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;this.__xq.getCommandManager().addUndoStep(Q,gK,this.getCommandObject(Q));this.execute(Q,gK);var gM=this.__xq.getRange();if(gJ){while(gJ&&gJ.firstChild&&qx.dom.Node.isElement(gJ.firstChild)){gJ=gJ.firstChild;}
;}
;gM.selectNode(gJ);gQ.addRange(gM);gM.collapse(true);}
;}
,"default":(function(){}
)}),__xF:qx.core.Environment.select(eU,{"mshtml":function(){var gS=this.__xq.getRange();if(gS&&!qx.dom.Node.isNodeName(gS.parentElement(),o)){gS.pasteHTML(qx.bom.htmlarea.HtmlArea.simpleLinebreak);gS.collapse(false);gS.select();return true;}
;return false;}
,"default":function(){return false;}
}),__xG:function(gU,gV){var gT=(qx.core.Environment.get(eU)==dX)?this.__xq.getRange():this.__sN;return gT.execCommand(gV.identifier,false,gU);}
,__xH:function(gY,ha){if((qx.core.Environment.get(eU)==dX)){var gX=this.__xq.getFocusNode();this.__xI(gX);}
;this.__sN.body.focus();var gW=this.__sN.execCommand(ha.identifier,false,gY);if((qx.core.Environment.get(eU)==fl)){var gX=this.__xq.getFocusNode();this.__xI(gX.parentNode);}
;return gW;}
,__xI:function(hb){var hc=[];var parent=hb.parentNode;while(qx.dom.Node.isNodeName(parent,O)){hc.push(parent);parent=parent.parentNode;}
;if(hc.length>0){parent.appendChild(hb);parent.removeChild(hc[hc.length-1]);}
;}
,__xJ:qx.core.Environment.select(eU,{"gecko":function(hs,hm){if(hs.src){this.__sN.execCommand(hm.identifier,false,hs.src);delete hs.src;var hf=this.__xq.getSelection();if(hf){var he=hf.anchorNode;var hn=hf.anchorOffset;var hg=he.childNodes[hn-1];var hp;for(var hi in hs){hp=this.__sN.createAttribute(hi);hp.nodeValue=hs[hi];hg.setAttributeNode(hp);}
...
;var hq=this.__sN.createDocumentFragment();var hr;if(hl&&hd!=null){var hh=this.__xK(hd);hq.appendChild(hh.root);hr=hh.inline;}
else {hr=this.__sN.createElement(R);hq.appendChild(hr);}
;var ho=this.__sN.createTextNode(fH);hr.appendChild(ho);var hk=hg.parentNode;if(hg==hk.lastChild){hk.appendChild(hq);}
else {hk.insertBefore(hq,hg.nextSibling);}
;var hj=this.__xq.getRange();hj.selectNodeContents(hr);}
;return true;}
else {return false;}
;}
,"mshtml":function(hx,hu){var hw=false;var ht=r;for(var hv in hx){ht+=hv+eD+hx[hv]+ff;}
;ht+=d;var hy=this.__xq.getSelection();var hz=this.__xB();if(hy&&hy.type!=eM){try{hz.select();hz.pasteHTML(ht);hw=true;}
catch(e){}
;}
;this.__xq.resetSavedRange();return hw;}
,"default":function(hB,hD){if(hB.src){var hC=r;for(var hA in hB){hC+=hA+eD+hB[hA]+ff;}
;hC+=d;return this.__sN.execCommand(dI,false,hC);}
else {return false;}
;}
}),__xK:function(hF){while(hF.firstChild&&hF.firstChild.nodeType==1){hF=hF.firstChild;}
;var hI=this.__xP(hF);var hM,hG,hK;var hE=fH;var parent=null;var hL=null;var hJ=hI.child;while(hJ){hL=this.__sN.createElement(hJ[fG]?dU:R);hG=this.__sN.createAttribute(U);hL.setAttributeNode(hG);for(var hH in hJ){if(hH!=en&&hH!=fG){hE+=hH+dP+hJ[hH]+ef;}
else if(hH==fG){hK=this.__sN.createAttribute(fq);hK.nodeValue=hJ[hH];hL.setAttributeNode(hK);}
;}
;hG.nodeValue=hE;if(parent!=null){parent.appendChild(hL);}
else {hM=hL;}
;parent=hL;hJ=hJ.child;hE=fH;}
;return {root:hM,inline:hL};}
,__xL:qx.core.Environment.select(eU,{"gecko|opera":function(hN,hR){var hU=this.__xq.getSelection();var hP=this.__xq.getRange();if(hU.isCollapsed){var hO=ec+( ++this.__xt);var hV=this.__sN.createElement(dN);var hQ=this.__sN.createAttribute(dL);var hS=this.__sN.createAttribute(T);var hT=this.__sN.createTextNode(hN);hS.nodeValue=hO;hV.setAttributeNode(hS);hQ.nodeValue=hN;hV.setAttributeNode(hQ);hV.appendChild(hT);hP.insertNode(hV);hP.selectNode(hV);hU.collapseToEnd();return true;}
else {return this.__sN.execCommand(hR.identifier,false,hN);}
;}
,"mshtml":function(hW,ib){try{var ia;var hX=this.__xB();var hY=this.__xq;var hX=hY.getSavedRange()!=null?hY.getSavedRange():hY.getRange();if(hX!=null&&hX.text!=fH){ia=hX.execCommand(ib.identifier,false,hW);}
else {ia=this.__xC(v+hW+dV+hW+G,ib);}
;this.__xq.resetSavedRange();return ia;}
catch(e){if(qx.core.Environment.get(fC)){this.error(x);}
;return false;}
;}
,"default":function(ic,id){return this.__sN.execCommand(id.identifier,false,ic);}
}),__xM:function(ig,ih){var ie=eu;if((qx.core.Environment.get(eU)==eA)){ie+=this.__xN();}
;return this.__xC(ie,ih);}
,__xN:function(ij){var im=fH;var il=p;var ik=[];var iq=typeof ij!==dD?ij:this.__xP();var io=iq.child;var ip=false;if(qx.lang.Object.isEmpty(io)){return fH;}
;while(io){ip=io[fG]!=null;im+=ip?eC:il;for(var ii in io){im+=(ii!=en&&ii!=fG)?ii+eW+io[ii]+I:fH;}
;im+=ip?eY+io[fG]+dV:dV;ik.unshift(ip?u:eV);io=io.child;}
;if(ik.length==1&&ik[0]==u){im+=dK;}
;for(var i=0,j=ik.length;i<j;i++ ){im+=ik[i];}
;return im;}
,__xO:function(){var is=this.__sN.createDocumentFragment();var ix=this.__xP();var parent=is;var iv=ix.child;var it;var iw=false;while(iv){iw=iv[fG]!=null;it=this.__sN.createElement(iw?dU:R);parent.appendChild(it);for(var ir in iv){if(ir!=en&&ir!=fG){qx.bom.element.Style.set(it,ir,iv[ir]);}
;}
;if(iw){var iu=this.__sN.createAttribute(fq);iu.nodeValue=iv[fG];it.setAttributeNode(iu);}
;parent=it;iv=iv.child;}
;return is;}
,__xP:function(iz){var iA={};var iB=null;var iC=this.getCurrentStyles(iz);iB=iA.child={};for(var iy in iC){if(iy!=fs){iB[iy]=iC[iy];}
;}
;if(iC[fs]){var iD=iC[fs];for(var i=0,j=iD.length;i<j;i++ ){if(iB==null){iB=iA.child={};}
else {iB=iB.child={};}
;iB[eS]=iD[i][eS];iB[eE]=iD[i][eE];}
;}
;if(iC[eS]&&iC[eE]){iB=iB.child={};iB[eS]=iC[eS];}
;return iA;}
,getCurrentStyles:function(iG){if(iG==null){var iJ=this.__xq.getSelection();if(!iJ||iJ.focusNode==null){return {};}
;iG=(iJ.focusNode.nodeType==3)?iJ.focusNode.parentNode:iJ.focusNode;}
;var iH=qx.dom.Hierarchy.getAncestors(iG);var iE=qx.lang.Array.insertBefore(iH,iG,iH[0]);var iI=this.__xQ(iE);var iF=this.__xR(iI,iE);return iF;}
,__xQ:function(iN){var iM={};var iK,iL;for(var i=0,j=iN.length;i<j;i++ ){iL=iN[i];for(var k=0,l=iL.style.length;k<l;k++ ){iK=iL.style[k];if(iK.length>0&&typeof iM[iK]===dD){iM[iK]=iL.style.getPropertyValue(iK);}
;}
;if(iL.tagName.toUpperCase()==w&&iL.size&&iM[fG]===undefined){iM[fG]=iL.size;}
;}
;if(iM[fG]&&iM[J]){delete iM[J];}
;return iM;}
,__xR:function(iT,iP){var iR=iP[0];var iS=this.__xq.getContentWindow().getComputedStyle(iR,null);var iU;var iQ={};for(var iO in iT){if(iO!=fG){iU=iS.getPropertyValue(iO);}
else {iU=iT[iO];}
;if(iO==dR&&iU==C){iQ[iO]=this.__xT(iP);}
else if(iO==fs){iQ[iO]=this.__xS(iP);}
else {iQ[iO]=iU;}
;}
;return iQ;}
,__xS:function(iX){var iY,jb,iV;var ja=[];var iW=this.__xq.getContentWindow();for(var i=0,j=iX.length;i<j;i++ ){iV=iW.getComputedStyle(iX[i],null);iY=iV.getPropertyValue(fs);jb=iV.getPropertyValue(fn);if(iY!=ed){ja.push({'text-decoration':iY,'color':jb});}
;}
;return ja;}
,__xT:function(jd){var je,jc,jf;for(var i=0;i<jd.length;i++ ){je=jd[i];jc=this.__xq.getContentWindow().getComputedStyle(je,null);jf=jc.getPropertyValue(dR);if(jf!=C){return jf;}
;}
;}
,__xU:function(jm,jn){var jh=this.__xq.getSelection();var jl=((qx.core.Environment.get(eU)==dX))?this.__xq.getRange():jl=jh.getRangeAt(0);var jp=[];var jt;var jk=[er,fF];var jg,i,j,jr;jr=((qx.core.Environment.get(eU)==dX))?jl.parentElement():jl.commonAncestorContainer;if(jr.tagName==dz){for(var i=0;i<jk.length;i++ ){jg=jr.getElementsByTagName(jk[i]);for(var j=0;j<jg.length;j++ ){if(jg[j]){jp.push(jg[j]);}
;}
;}
;}
else if(qx.lang.Array.contains(jk,jr.tagName)){jp.push(jr);}
;if(jp.length>0){for(var i=0;i<jp.length;i++ ){var js=jp[i];jt=((qx.core.Environment.get(eU)==dX))?((js==jr)||(jr.tagName==dz)):jh.containsNode(js,false);for(j=0;j<js.childNodes.length;j++ ){var jj=js.childNodes[j];if(jt||(jh.focusNode.nodeValue&&qx.dom.Hierarchy.contains(jj,jh.focusNode)&&(jh.focusOffset==jh.focusNode.nodeValue.length))||(qx.dom.Hierarchy.contains(jj,jh.anchorNode)&&(jh.anchorOffset==0))||(jh.containsNode(jj,false))){jj.style.fontSize=(this.__xs[jm]||jm)+eo;}
;}
;}
;}
else {var ji=((qx.core.Environment.get(eU)==dX))?jr:jh.focusNode;var jo=qx.dom.Hierarchy.getAncestors(ji);for(i=0;i<jo.length;i++ ){if(jo[i].tagName==eL){if((((qx.core.Environment.get(eU)==eA))&&((jh.anchorOffset==0)&&(jh.focusNode.nodeValue&&(jh.focusOffset==jh.focusNode.nodeValue.length))&&qx.dom.Hierarchy.contains(jo[i].firstChild,jh.anchorNode)&&qx.dom.Hierarchy.contains(jo[i].lastChild,jh.focusNode)))||(((qx.core.Environment.get(eU)==dX))&&(jl.htmlText==jo[i].innerHTML))){jo[i].style.fontSize=(this.__xs[jm]||jm)+eo;}
;break;}
;}
;}
;if((qx.core.Environment.get(eU)==dX)){this.__sN.body.focus();this.__xq.getRange().select();return this.__sN.execCommand(fh,false,jm);}
else if((qx.core.Environment.get(eU)==eA)){var parent=jl.commonAncestorContainer;if(parent.nodeType===1){var jq=parent.getElementsByTagName(R);for(i=0;i<jq.length;i++ ){if(jq[i].style.fontSize){jq[i].style.fontSize=null;}
;}
;}
;}
;return this.__sN.execCommand(fh,false,jm);}
,__xV:qx.core.Environment.select(eU,{"mshtml":function(ju,jv){this.__sN.body.focus();return this.__sN.execCommand(eI,false,ju);}
,"gecko|opera":function(jw,jx){this.__sN.body.focus();return this.__sN.execCommand(fe,false,jw);}
,"webkit":function(jA,jB){var jC=this.__xq.getSelection();var jz=this.__xq.getRange();if(!jC||!jC.isCollapsed){this.__sN.body.focus();this.__sN.execCommand(eI,false,jA);if(jC){jC.collapseToEnd();}
;return true;}
...
;}
;jz.setStart(jC.anchorNode,jC.anchorNode.nodeValue.charAt(jE)==el?jE+1:jE);jz.setEnd(jC.anchorNode,jy);jC.addRange(jz);this.__sN.body.focus();this.__sN.execCommand(eI,false,jA);jC.collapseToEnd();return true;}
;}
}),__xW:function(jF,jG){jF=jF!=null&&typeof jF==dH?jF:C;qx.bom.element.Style.set(this.__sN.body,a,jF);return true;}
,__xX:function(jJ,jK){var jI,jH,jM;var jL=qx.bom.htmlarea.manager.Command;if(jJ==null){jI=null;}
else {jI=jJ[0];jH=jJ[1];jM=jJ[2];}
;if(jI==null||typeof jI!=dH){qx.bom.element.Style.set(this.__sN.body,ew,fH);qx.bom.element.Style.set(this.__sN.body,dS,fH);qx.bom.element.Style.set(this.__sN.body,y,fH);return true;}
else {if(jI.search(/^url.*\(/)==-1){jI=ep+jI+dA;}
;}
;if(jH!=null&&!qx.lang.String.contains(jL.__xv,jH)){if(qx.core.Environment.get(fC)){this.error(fp+jH+fg+jL.__xv+fy);}
;return false;}
else {jH=t;}
;if(jM!=null){if(qx.lang.Type.isString(jM)&&!qx.lang.String.contains(jL.__xu,S+jM+S)){if(qx.core.Environment.get(fC)){this.error(fp+jM+s+jL.__xu+fy);}
;return false;}
else {if(qx.lang.Type.isArray(jM)&&jM.length==2){jM=jM[0]+el+jM[1];}
else {if(qx.core.Environment.get(fC)){this.error(P);}
;return false;}
;}
;}
else {jM=c;}
;qx.bom.element.Style.set(this.__sN.body,ew,jI);qx.bom.element.Style.set(this.__sN.body,dS,jH);qx.bom.element.Style.set(this.__sN.body,y,jM);return true;}
,__xY:qx.core.Environment.select(eU,{"mshtml":function(jO,jP){var jN=this.__sN.body.createTextRange();jN.select();return true;}
,"default":function(jQ,jR){return this.__xA(jR.identifier,false,jQ);}
}),__ya:function(){return this.__xq.getSelectedText();}
,__yb:function(){return this.__xq.getSelectedHtml();}
,__yc:function(jV,jW){var jU=this.__xq.getFocusNode();if(jU.textContent==fH){var jT=qx.dom.Hierarchy.getAncestors(jU);jT.unshift(jU);var Node=qx.dom.Node;var jS=qx.bom.element.Style;var jX=jT.shift();while(jT.length>0){if(Node.getName(jX)==M||Node.getName(jX)==ei){break;}
;if(jS.get(jX,jV,jS.LOCAL_MODE)==jW){jS.reset(jX,jV);return true;}
;jX=jT.shift();}
;}
;return false;}
,__yd:qx.core.Environment.select(eU,{"gecko":function(jY,ka){if(this.__yc(fc,N)){return true;}
else {return this.__xA(ka.identifier,false,jY);}
;}
,"default":function(kb,kc){return this.__xA(kc.identifier,false,kb);}
}),__ye:qx.core.Environment.select(eU,{"gecko":function(kd,ke){if(this.__yc(ek,eb)){return true;}
else {return this.__xA(ke.identifier,false,kd);}
;}
,"default":function(kf,kg){return this.__xA(kg.identifier,false,kf);}
}),__yf:qx.core.Environment.select(eU,{"gecko":function(kh,ki){if(this.__yc(fA,q)){return true;}
else {return this.__xA(ki.identifier,false,kh);}
;}
,"default":function(kj,kk){return this.__xA(kk.identifier,false,kj);}
}),__yg:qx.core.Environment.select(eU,{"gecko":function(kl,km){if(this.__yc(fA,fJ)){return true;}
else {return this.__xA(km.identifier,false,kl);}
;}
,"default":function(kn,ko){return this.__xA(ko.identifier,false,kn);}
})},destruct:function(){this.__sN=this.__xq=this._commands=null;this.__xr=this.__xs=null;}
});}
)();
(function(){var a="undo",b="__wv",c="backgroundColor",d="actionType ",f="mousedown",g="pageup",h="ADD TO UNDO STACK",k="backgroundimage",l="control",m="shift",n="end",o="right",p="qx_link",q="b",r="insertunorderedlist",s="Command",t=" ",u="Undo",v="pagedown",w="k",x="home",y="qx.debug",z="Content",A="Redo",B=" is not managed! Please provide a handler method!",C="table",D="backgroundImage",E="backgroundRepeat",F="p",G="a",H="insertorderedlist",I="y",J="backgroundPosition",K="justifyright",L="redo",M="insertParagraph",N="qx.bom.htmlarea.manager.UndoRedo",O="left",P="i",Q="backgroundcolor",R="td",S="img",T="Internal",U="u",V="inserthyperlink",W="gecko",X="enter",Y="mshtml",bu="engine.name",bv="mouseup",bw="keypress",bq="execCommand failed! Details: ",br="ADD TO REDO STACK",bs="qx.bom.htmlarea.HtmlArea.debug",bt="webkit",bA="insertimage",bB="inserthtml",bC="z",bD="Custom",bx="undoRedoState",by="down",bz="up",bp="body";qx.Class.define(N,{extend:qx.core.Object,construct:function(bF,bE){qx.core.Object.call(this);this.__wv=bF;this.__xq=bE;this.__yh=[];this.__yi=[];this._commands=null;this.__sN=null;this.__yj={};this.__yk={command:true,content:true,custom:true};this.__xx();this.__yl=qx.lang.Function.bind(this._handleKeyPress,this);this.__ym=qx.lang.Function.bind(this._handleMouseUp,this);if((qx.core.Environment.get(bu)==Y)){this.__yn=qx.lang.Function.bind(this._handleMouseDown,this);}
;}
,members:{__yo:false,__yp:false,__yq:false,__yk:null,__yj:null,__wv:null,__sN:null,__yh:null,__yi:null,__xq:null,__yl:null,__ym:null,__yn:null,__yr:null,setContentDocument:function(bG){this.__sN=bG;this.__wv.setContentDocument(bG);qx.event.Registration.addListener(bG.body,bw,this.__yl,this);qx.event.Registration.addListener(bG.body,bv,this.__ym,this);if((qx.core.Environment.get(bu)==Y)){qx.event.Registration.addListener(bG.body,f,this.__yn,this,true);}
;}
,insertParagraphOnLinebreak:function(){return this.__wv.insertParagraphOnLinebreak();}
,execute:function(bH,bJ){var bI;bH=bH.toLowerCase();if(this._commands[bH]){if(this._commands[bH].passthrough){bI=this.__wv.execute(bH,bJ);}
else {bI=this[bH].call(this);}
;}
else {if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){this.__yI(bH,bJ,this.__wv.getCommandObject(bH));bI=this.__wv.execute(bH,bJ);if(!bI){this.__yh.pop();}
;}
else {bI=this.__wv.execute(bH,bJ);if(bI){this.__yI(bH,bJ,this.__wv.getCommandObject(bH));}
;}
;if(bH==a&&this.__yh.length==0){this.__yp=false;this.__yQ();}
else if(bH==L&&this.__yi.length==0){this.__yo=false;this.__yQ();}
;}
;this.__yq=false;return bI;}
,addUndoStep:function(bK,bL,bM){this.__yI(bK,bL,bM);}
,registerHandler:function(bO,bN,bQ,bP){this.__yj[bO]={undo:bN,redo:bQ,context:bP};}
,isUndoPossible:function(){return this.__yp;}
,undo:function(){var bT;if(this.__yq){this.__yK();}
;if(this.__yh.length>0){var bS=this.__yh.pop();if(this.__yk[bS.actionType.toLowerCase()]){switch(bS.actionType){case s:bT=this.__yt(bS);break;case z:bT=this.__yx(bS);break;case T:bT=this.__yw(bS);break;case bD:bT=this.__ys(bS);break;};}
else if(this.__yj[bS.actionType]){var bR=this.__yj[bS.actionType];bT=bR.undo.call(bR.context?bR.context:this,bS);this.__yM(bS);}
else {this.error(d+bS.actionType+B);}
;this.__yo=true;this.__yQ();return bT;}
;}
,__ys:qx.core.Environment.select(bu,{"mshtml|webkit":function(bW){var bU=this.__sN.body.innerHTML;var bX=bW.content;this.__sN.body.innerHTML=bX;var bV=bW;bV.content=bU;this.__yM(bV);return true;}
,"default":function(cc){var cb=cc;var ca=qx.bom.element.Style;switch(cc.command){case Q:cb.parameter=[ca.get(this.__sN.body,c)];break;case k:cb.parameter=[ca.get(this.__sN.body,D),ca.get(this.__sN.body,E),ca.get(this.__sN.body,J)];break;};this.__yM(cb);if(cc.command==V){if((qx.core.Environment.get(bu)==W)){var cd=p+this.__wv.__hyperLinkId;var bY=this.__sN.getElementById(cd);if(bY){bY.parentNode.removeChild(bY);return true;}
else {return false;}
;}
;}
else {return this.__wv.execute(cc.command,cc.value);}
;}
}),__yt:qx.core.Environment.select(bu,{"mshtml|webkit":function(ce){}
,"default":function(cf){this.__yM(cf);if((qx.core.Environment.get(bu)==W)){if(cf.command==bB&&cf.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__yu(bB,M)){this.__yv();}
;}
;return this.__yy();}
}),__yu:function(cg,ch){if(this.__yh.length>0){var ci=this.__yh[this.__yh.length-1];return (ci.command==cg&&ci.value==ch);}
;return false;}
,__yv:function(){this.__yy();if(this.__yh.length>0){var cj=this.__yh.pop();this.__yM(cj);}
;}
,__yw:function(ck){this.__yM(ck);return this.__yy();}
,__yx:qx.core.Environment.select(bu,{"gecko":function(cl){this.__yM(cl);try{return this.__yy();}
catch(cm){if(qx.core.Environment.get(y)){this.error(bq+cm);}
;}
;}
,"mshtml|webkit":function(cn){}
,"default":function(co){this.__yM(co);return this.__yy();}
}),__yy:function(){try{return this.__sN.execCommand(u,false,null);}
catch(e){return false;}
;}
,isRedoPossible:function(){return this.__yo;}
,redo:function(){if(this.__yo){var cq;if(this.__yi.length>0){var cr=this.__yi.pop();if(this.__yk[cr.actionType.toLowerCase()]){switch(cr.actionType){case s:cq=this.__yA(cr);break;case z:cq=this.__yG(cr);break;case T:cq=this.__yF(cr);break;case bD:cq=this.__yz(cr);break;};}
else if(this.__yj[cr.actionType]){var cp=this.__yj[cr.actionType];cq=cp.redo.call(cp.context?cp.context:this,cr);this.__yL(cr);}
else {this.error(d+cr.actionType+B);}
;this.__yp=true;this.__yQ();}
;return cq;}
;}
,__yz:qx.core.Environment.select(bu,{"mshtml|webkit":function(cu){var cs=this.__sN.body.innerHTML;var cv=cu.content;this.__sN.body.innerHTML=cv;var ct=cu;ct.content=cs;this.__yL(ct);return true;}
,"default":function(cw){this.__yL(cw);return this.__yH();}
}),__yA:qx.core.Environment.select(bu,{"mshtml|webkit":function(cx){}
,"default":function(cy){this.__yL(cy);var cz=this.__yH();if((qx.core.Environment.get(bu)==W)){if(this.__yB(bB,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cA=this.__yC();this.__yD();if(cA!=null){this.__yE(cA);}
;}
;}
;return cz;}
}),__yB:function(cC,cD){if(this.__yi.length>0){var cB=this.__yi[this.__yi.length-1];return (cB.command==cC&&cB.value==cD);}
;return false;}
,__yC:function(){if(this.__xq==null){return null;}
;var cE=this.__xq.getSelection();var cF=cE?cE.focusNode:null;if(cF==null){return null;}
;try{while(cF.nodeName.toLowerCase()!=F){cF=cF.parentNode;if(!cF||qx.dom.Node.isNodeName(cF,bp)){return null;}
;}
;}
catch(cG){return null;}
;if(cF!=null&&qx.dom.Node.isNodeName(cF,F)){return cF;}
else {return null;}
;}
,__yD:function(){var cH=this.__yi.pop();this.__yL(cH);this.__yH();}
,__yE:qx.core.Environment.select(bu,{"gecko":function(cK){if(cK==this.__xq.getContentBody().lastChild){return;}
;var cL=cK.firstChild;while(cL.firstChild){cL=cL.firstChild;}
;var cI=this.__xq.getSelection();var cJ=this.__xq.getRange();if(cI&&cJ){cJ.selectNode(cL);cI.addRange(cJ);cJ.collapse(true);}
;}
,"default":(function(){}
)}),__yF:function(cM){this.__yL(cM);return this.__yH();}
,__yG:qx.core.Environment.select(bu,{"mshtml|webkit":function(cN){}
,"default":function(cO){this.__yL(cO);return this.__yH();}
}),__yH:function(){try{return this.__sN.execCommand(A,false,null);}
catch(e){return false;}
;}
,__xx:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};this.__wv.getCommandObject(Q).customUndo=true;this.__wv.getCommandObject(k).customUndo=true;if((qx.core.Environment.get(bu)==W)){}
;}
,__yI:qx.core.Environment.select(bu,{"mshtml|webkit":function(cP,cR,cS){var cQ=this.getUndoRedoObject();cQ.commandObject=cS;cQ.command=cP;cQ.value=cR;cQ.actionType=bD;cQ.content=this.__sN.body.innerHTML;this.__yJ(cQ);}
,"default":function(cX,cV,cW){if(this.__xq==null){return;}
;var cT=this.getUndoRedoObject();cT.commandObject=cW;cT.command=cX;cT.value=cV;cT.actionType=bD;var cY=this.__xq.getSelection();if(cW.customUndo){var cU=[];switch(cX){case Q:cU.push(qx.bom.element.Style.get(this.__sN.body,c));break;case k:cU.push(qx.bom.element.Style.get(this.__sN.body,D),qx.bom.element.Style.get(this.__sN.body,E),qx.bom.element.Style.get(this.__sN.body,J));break;case V:if(cY&&!cY.isCollapsed){cT.actionType=s;}
;break;};cT.parameter=cU;}
else {if((qx.core.Environment.get(bu)==W)){if(cY&&cY.isCollapsed){switch(cX){case H:case r:case K:case bB:case bA:cT.actionType=s;break;default:return;};}
else {cT.actionType=s;}
;}
else {cT.actionType=s;}
;}
;this.__yJ(cT);}
}),__yJ:function(da){if(this.__yq){this.__yK();}
;this.__yL(da);this.__yo=false;this.__yi=[];this.__yQ();}
,__yK:function(){var db=this.__yh[this.__yh.length-1];if(db==null||db.actionType!=z){var dc=this.getUndoRedoObject();dc.actionType=z;if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){dc.content=this.__yr;dc.actionType=bD;this.__yr=null;}
;this.__yL(dc);this.__yq=false;}
;}
...
,__yL:function(dd){if((qx.core.Environment.get(y))&&qx.core.Environment.get(bs)){this.debug(h);this.debug(dd.actionType+t+dd.command+t+dd.value);}
;this.__yh.push(dd);}
,__yM:function(de){if((qx.core.Environment.get(y))&&qx.core.Environment.get(bs)){this.debug(br);this.debug(de.actionType+t+de.command+t+de.value);}
;this.__yi.push(de);}
,_handleKeyPress:function(e){var df=e.getKeyIdentifier().toLowerCase();var dg=e.isCtrlPressed();switch(df){case l:case m:case O:case o:case bz:case by:case g:case v:case x:case n:case X:break;case G:case q:case P:case U:case w:case I:case bC:if(!dg){this.__yN();}
;break;default:this.__yo=false;this.__yi=[];this.__yN();};}
,__yN:function(){if(!this.__yq){this.__yq=true;this.__yp=true;if((qx.core.Environment.get(bu)==Y)||(qx.core.Environment.get(bu)==bt)){this.__yr=this.__sN.body.innerHTML;}
;this.__yQ();}
;}
,__yO:null,_handleMouseDown:qx.core.Environment.select(bu,{"mshtml":function(e){var dh=e.getOriginalTarget();if(qx.dom.Node.isElement(dh)&&(qx.dom.Node.isNodeName(dh,S)||qx.dom.Node.isNodeName(dh,C))){this.__yO={node:dh,content:dh.outerHTML};}
else {this.__yO=null;}
;}
,"default":function(e){return true;}
}),_handleMouseUp:qx.core.Environment.select(bu,{"gecko":function(e){if(this.__xq==null){return;}
;var dj=this.__xq.getSelection();if(!dj){this.__yO=null;return;}
;var dl=dj.anchorNode;var dk=dl.childNodes[dj.anchorOffset];if(qx.dom.Node.isNodeName(dk,S)){if(this.__yO==null){this.__yO=dk.cloneNode(true);}
else {if(this.__yO.style.width!=dk.style.width||this.__yO.style.height!=dk.style.height){this.__yP();this.__yO=dk.cloneNode(true);}
;}
;}
else if(qx.dom.Node.isNodeName(dl,R)||qx.dom.Node.isNodeName(dl.parentNode,R)){var di=dl.parentNode;while(qx.dom.Node.isNodeName(di,C)){di=di.parentNode;}
;if(this.__yO==null){this.__yO=di.cloneNode(true);}
else {qx.event.Timer.once(function(){if(di.style.width!=this.__yO.style.width||di.style.height!=this.__yO.style.height||di.innerHTML!=this.__yO.innerHTML){this.__yP();this.__yO=di.cloneNode(true);}
;}
,this,0);}
;}
else {this.__yO=null;}
;}
,"default":function(e){var dm=qx.bom.Event.getTarget(e);if(this.__yO!=null){if(dm.nodeType==1){if(dm==this.__yO.node){if(dm.outerHTML!=this.__yO.content){this.__yO.content=dm.outerHTML;this.__yP();}
;}
else {for(var i=0,j=dm.childNodes.length;i<j;i++ ){if(dm.childNodes[i]==this.__yO.node){if(dm.childNodes[i].outerHTML!=this.__yO.content){this.__yO.content=dm.childNodes[i].outerHTML;this.__yP();}
;}
;}
;}
;}
...
;}
;}
}),__yP:qx.core.Environment.select(bu,{"mshtml|webkit":function(){this.__yI(T,null,null);}
,"default":function(){var dn=this.getUndoRedoObject();dn.actionType=T;this.__yL(dn);}
}),__yQ:function(){qx.event.Timer.once(function(e){if(this.__xq!=null){var dp={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};this.__xq.fireDataEvent(bx,dp);}
;}
,this,200);}
},destruct:function(){try{qx.event.Registration.removeListener(this.__sN.body,bw,this.__yl);qx.event.Registration.removeListener(this.__sN,bv,this.__ym);if((qx.core.Environment.get(bu)==Y)){qx.event.Registration.removeListener(this.__sN,f,this.__yn);}
;}
catch(e){}
;this._disposeObjects(b);this.__xq=this.__yh=this.__yi=this._commands=this.__sN=null;this.__yk=this.__yj=null;}
});}
)();
