...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable.15a2668d6051.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Last item is intentionally ",b="demobrowser.demo.progressive.ProgressiveTable",c="start",d="</span>",e="Number",f="1*",g="<span style='color:red;'>",h="row",i="inserted at the top to show how ",j="it's done",k="end",l="Date",m="Id";qx.Class.define(b,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var v=0;var r=function(A){var B=[];var D=new Date().getTime();var z=400*24*60*60*1000;for(var E=0;E<A;E++ ){var C=new Date(D+Math.random()*z-z/2);B.push({renderer:h,location:E==A-1?c:k,data:[v++ ,Math.random()*10000,C]});}
;return B;}
;var u=new qx.ui.progressive.renderer.table.Widths(3);u.setWidth(0,100);u.setWidth(1,f);u.setMaxWidth(1,200);u.setWidth(2,300);var p=[m,e,l];var q=new qx.ui.progressive.headfoot.TableHeading(u,p);var o=new qx.ui.progressive.headfoot.Progress(u,p);var t=new qx.ui.progressive.structure.Default(q,o);var n=new qx.ui.progressive.Progressive(t);var w=new qx.ui.basic.Atom(g+a+i+j+d);w.setRich(true);w.setHeight(16);n.add(w);var x=new qx.ui.progressive.model.Default();var s=r(500);x.addElements(s);n.setDataModel(x);var y=new qx.ui.progressive.renderer.table.Row(u);n.addRenderer(h,y);n.set({width:500,maxWidth:500});this.getRoot().add(n,{left:50,top:50,bottom:50});n.render();}
}});}
)();
(function(){var a="Column number out of range",b="Unrecognized key: ",c="qx.ui.progressive.renderer.table.Widths",d="minWidth",e="width",f="maxWidth";qx.Class.define(c,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__JX=[];for(var i=0;i<g;i++ ){this.__JX[i]=new qx.ui.core.ColumnData();}
;}
,members:{__JX:null,getData:function(){return this.__JX;}
...
;}
,setWidth:function(l,m){if(l>this.__JX.length-1||l<0){throw new Error(a);}
;this.__JX[l].setColumnWidth(m);}
,setMinWidth:function(n,o){if(n>this.__JX.length-1||n<0){throw new Error(a);}
;this.__JX[n].setMinWidth(o);}
,setMaxWidth:function(p,q){if(p>this.__JX.length-1||p<0){throw new Error(a);}
;this.__JX[p].setMaxWidth(q);}
}});}
)();
...
,members:{__HG:null,join:function(c){this.__HG=c;}
},destruct:function(){this.__HG=null;}
});}
)();
(function(){var a="progressive-table-header-cell",b="resize",c="progressive-table-header",d="_layout",f="qx.ui.progressive.headfoot.TableHeading";qx.Class.define(f,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(l,k){qx.ui.progressive.headfoot.Abstract.call(this);this.__HN=l;var j=l.getData();this.__HO=[];for(var i=0;i<j.length;i++ ){var g=new qx.ui.basic.Atom(k[i]);g.setAppearance(a);this.add(g);this.__HO[i]=g;}
...
,properties:{appearance:{refine:true,init:c}},members:{__HN:null,__HP:null,__HO:null,__rz:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__HP){return this.__HN.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var p=this.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();this.__HP=true;var n={top:this.getPaddingTop(),right:this.getPaddingRight(),bottom:this.getPaddingBottom(),left:this.getPaddingLeft()};this.__rz.renderLayout(p,100,n);this.__HP=false;var o=this.__HN.getData();for(var i=0;i<o.length;i++ ){this.__HO[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__HN=this.__HO=null;this._disposeObjects(d);}
});}
)();
(function(){var a="progressive-progressbar-indicator-undone",b="__Jt",c="progress",d="%",f="progressive-progressbar-indicator-done",g="progressive-progressbar-percent-text",h="renderStart",i="progressive-progressbar-background",j="0%",k="qx.ui.progressive.headfoot.Progress",l="__Js",m="progressive-progressbar-percent-background",n="renderEnd";qx.Class.define(k,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,q){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__Is={};this.__Iw();this.set({backgroundColor:this.__Is.background});this.__Js=new qx.ui.core.Widget();this.__Js.set({width:0,backgroundColor:this.__Is.indicatorDone});this.add(this.__Js);var p=new qx.ui.core.Widget();p.set({backgroundColor:this.__Is.indicatorUndone});this.add(p,{flex:1});this.__Jt=new qx.ui.basic.Atom(j);this.__Jt.set({width:100,backgroundColor:this.__Is.percentBackground,textColor:this.__Is.percentText});this.add(this.__Jt);this.exclude();}
,members:{__Ju:null,__Is:null,__Js:null,__Jt:null,_onChangeTheme:function(){qx.ui.progressive.headfoot.Abstract.prototype._onChangeTheme.call(this);this.__Iw();}
,__Iw:function(){var r=qx.theme.manager.Color.getInstance();this.__Is.background=r.resolve(i);this.__Is.indicatorDone=r.resolve(f);this.__Is.indicatorUndone=r.resolve(a);this.__Is.percentBackground=r.resolve(m);this.__Is.percentText=r.resolve(g);}
,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(h,function(e){this.__Ju=e.getData().initial;this.show();}
,this);s.addListener(c,function(e){var u=1.0-(e.getData().remaining/this.__Ju);var w=this.getBounds();if(w){var v=Math.floor((w.width-this.__Jt.getBounds().width)*u);var t=Math.floor(u*100)+d;if(!isNaN(v)){this.__Js.setMinWidth(v);this.__Jt.setLabel(t);}
;}
;}
,this);s.addListener(n,function(e){this.exclude();}
,this);}
},destruct:function(){this.__Is=null;this._disposeObjects(l,b);}
});}
)();
(function(){var a="applyStructure() is abstract",b="abstract",c="qx.ui.progressive.structure.Abstract",d="overflowY",e="auto";qx.Class.define(c,{type:b,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__HC=new qx.ui.core.Widget();this.__zi=this.__HC;}
else {this.__HC=null;this.__zi=f;}
;this.__zi.getContentElement().setStyle(d,e);}
,members:{__HC:null,__zi:null,applyStructure:function(g){throw new Error(a);}
,getPane:function(){return this.__zi;}
},destruct:function(){if(this.__HC){this.__HC.dispose();}
;this.__HC=this.__zi=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,d,c){qx.ui.progressive.structure.Abstract.call(this,c);if(!b){this.__HD=new qx.ui.progressive.headfoot.Null();this.__pM=this.__HD;}
else {this.__HD=null;this.__pM=b;}
;if(!d){this.__HE=new qx.ui.progressive.headfoot.Null();this.__HF=this.__HE;}
else {this.__HE=null;this.__HF=d;}
;}
,members:{__pM:null,__HF:null,__HD:null,__HE:null,applyStructure:function(e){this.__pM.join(e);this.__HF.join(e);e.add(this.__pM);e.add(this.getPane(),{flex:1});e.add(this.__HF);}
,getHeader:function(){return this.__pM;}
,getFooter:function(){return this.__HF;}
},destruct:function(){if(this.__HD){this.__HD.dispose();this.__HD=null;}
;if(this.__HE){this.__HE.dispose();this.__HE=null;}
;this.__pM=this.__HF=null;}
});}
)();
...
;this.__Iy=r;r.applyStructure(this);this.__Iz=false;this.__IA=false;this.__IB=0;}
,events:{"renderStart":q,"renderEnd":q,"progress":q,"progressDetail":q},properties:{dataModel:{check:f,apply:b},batchSize:{check:o,init:20},flushWidgetQueueAfterBatch:{check:c,init:false},interElementTimeout:{check:o,init:0}},members:{__Ix:null,__IA:null,__IC:null,__IB:null,__Iz:null,__Iy:null,getStructure:function(){return this.__Iy;}
,addRenderer:function(name,s){this.__Ix[name]=s;s.join(this,name);}
,removeRenderer:function(name){if(!this.__Ix[name]){throw new Error(l+name);}
;delete this.__Ix[name];}
,render:function(){if(this.__IA){return;}
;this.__IA=true;var t=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__Iy.getPane(),batchSize:this.getBatchSize(),rendererData:this.__IE(),userData:{}});this.__IC=new Date();if(this.__Iz){this.__IB=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__IB});this.__ID(t);}
else {qx.event.Timer.once(function(){this.__IB=t.getModel().getElementCount();this.fireDataEvent(g,{state:t,initial:this.__IB});this.__ID(t);this.__Iz=true;}
,this,10);}
;}
,_applyDataModel:function(v,u){if(u){u.removeListener(a,this.__IF,this);u.dispose();}
;v.addListener(a,this.__IF,this);}
,__ID:function(x){var w;var z;var y;for(var i=x.getBatchSize();i>0;i-- ){w=x.getModel().getNextElement();if(!w){this.debug(d+(new Date()-this.__IC)+h);this.__IA=false;this.fireDataEvent(p,x);x.dispose();return;}
;z=w.element;y=this.__Ix[z.renderer];y.render(x,z);this.fireDataEvent(n,{initial:this.__IB,remaining:w.remaining,element:z});}
;this.fireDataEvent(j,{initial:this.__IB,remaining:w.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__ID(x);}
,this,this.getInterElementTimeout());}
,__IE:function(){var A={};for(var name in this.__Ix){A[name]={};}
;return A;}
,__IF:function(e){this.__IB=e.getData();this.render();}
},destruct:function(){for(var name in this.__Ix){this.__Ix[name].dispose();}
;this.__IC=this.__Ix=this.__Iy=null;}
});}
)();
...
(function(){var a="dataAvailable",b="qx.ui.progressive.model.Default";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__Cs=[];}
...
(function(){var a="resize",b="__Ir",c="content",d="px",f="  font-size: 11px;",g=")",h="px ",j=';',k='',l="padding: ",m="end",n="div",o="  position: absolute;",p="qx.tableResizeDebug",q="changeTheme",r="-col-",s="__columnData",t="css.userselect",u="Renderer is already joined to a Progressive.",v="css.boxmodel",w="css.textoverflow",x="  top: 0px;",y="  width : 100%;",z="  overflow:hidden;",A=" {",B="}",C="  border-right:1px solid #f2f2f2;",D="Invalid location: ",E="  cursor:default;",F="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",G="-row {",H="__rz",I="-row",J="qx.debug",K="qx.dyntheme",L="start",M="relative",N="",O=": width=",P=':ellipsis;',Q=':',R="  white-space:nowrap;",S="  padding : 0px 6px 0px 6px;",T="qx.ui.progressive.renderer.table.Row",U="width: ",V=" out of range (max: ",W="px;",X="0px ",Y="progressive-table-row-background-odd",bo=".qx-progressive-",bp="  height: 100%;",bq="qx-progressive-",bk="progressive-table-row-background-even",bl="col ",bm="  border-bottom:1px solid #eeeeee;",bn="left: ",br="No existing renderer for column ",bs="css.userselect.none",bt="Column ";qx.Class.define(T,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bu){qx.ui.progressive.renderer.Abstract.call(this);this.__HN=bu;this.__Iq={};this.__Ir=new qx.ui.progressive.renderer.table.cell.Default();this.__HG=null;this.__Is={};this.__Iw();this.__rz=new qx.ui.layout.HBox();this.__rz.connectToWidget(this);if(qx.core.Environment.get(K)){qx.theme.manager.Color.getInstance().addListener(q,this.__Iw,this);}
;}
,statics:{__oV:null,__It:6,__Iu:o+x+bp+z+(qx.core.Environment.get(w)?qx.bom.Style.getCssName(qx.core.Environment.get(w))+P:N)+R+C+bm+S+E+f+F+(qx.core.Environment.get(t)?qx.bom.Style.getCssName(qx.core.Environment.get(t))+Q+qx.core.Environment.get(bs)+j:k)},properties:{defaultRowHeight:{init:16}},members:{__HG:null,__Cd:null,__Iv:null,__HN:null,__Iq:null,__Ir:null,__Is:null,__rz:null,__Iw:function(){var bv=qx.theme.manager.Color.getInstance();this.__Is.bgcol=[];this.__Is.bgcol[0]=bv.resolve(bk);this.__Is.bgcol[1]=bv.resolve(Y);}
,join:function(bx,name){if(this.__HG){throw new Error(u);}
;this.__HG=bx;this.__Cd=name;var by=qx.ui.progressive.renderer.table.Row;if(!by.__oV){by.__oV={};}
;var bw=bx.toHashCode();if(!by.__oV[bw]){by.__oV[bw]={rowstylesheet:null,cellstylesheet:[]};var bz=bo+bw+G+y+B;by.__oV[bw].rowstylesheet=qx.bom.Stylesheet.createElement(bz);var bA=this.__HN.getData();for(var i=0;i<bA.length;i++ ){var bz=bo+bw+r+i+A+by.__Iu+B;by.__oV[bw].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bz);}
;this.__Iv=bw;var bB=bx.getStructure().getPane();bB.addListener(a,this._resizeColumns,this);}
;}
,addRenderer:function(bC,bE){var bD=this.__HN.getData();if(bC<0||bC>=bD.length){throw new Error(bt+bC+V+(bD.length-1)+g);}
;this.__Iq[bC]=bE;}
,removeRenderer:function(bF){var bG=this.__HN.getData();if(bF<0||bF>=bG.length){throw new Error(bt+bF+V+(bG.length-1)+g);}
;if(!this.__Iq[bF]){throw new Error(br+bF);}
;delete this.__Iq[bF];}
,render:function(bI,bR){var bS=bR.data;var bM=[];var bO;var bN;var bK=0;if(bI.getRendererData()[this.__Cd].end===undefined){bI.getRendererData()[this.__Cd]={end:0,start:1,rows:0,totalHeight:0};}
;var bQ=document.createElement(n);for(var i=0;i<bS.length;i++ ){var bL=bq+this.__Iv+r+i;bN=this.__Iq[i]||this.__Ir;bO={state:bI,rowDiv:bQ,stylesheet:bL,element:bR,dataIndex:i,cellData:bS[i],height:bK};bM.push(bN.render(bO));if(bO.height>bK){bK=bO.height;}
;}
;bK=(bK>0?bK:this.getDefaultRowHeight());var bP=bI.getRendererData()[this.__Cd];bP.totalHeight+=bK;bQ.style.position=M;bQ.style.height=bK+d;bQ.className=bq+this.__Iv+I;bQ.innerHTML=bM.join(N);switch(bR.location){case m:var bH=bP.end||0;bQ.style.backgroundColor=this.__Is.bgcol[bH];bP.end=(bH==0?1:0);bI.getPane().getContentElement().getDomElement().appendChild(bQ);break;case L:var bJ=bI.getPane().getContentElement().getDomElement();var bT=bJ.childNodes;if(bT.length>0){var bH=bP.start;bQ.style.backgroundColor=this.__Is.bgcol[bH];bP.start=(bH==0?1:0);bJ.insertBefore(bQ,bT[0]);break;}
else {bJ.appendChild(bQ);}
;break;default:throw new Error(D+bR.location);}; ++bP.rows;}
,getLayoutChildren:function(){return this.__HN.getData();}
,_resizeColumns:function(e){var cc=this.__HG.getStructure().getPane();var bY=cc.getBounds().width-qx.bom.element.Scroll.getScrollbarWidth();var bW=bo+this.__Iv+I;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__oV[this.__Iv].rowstylesheet,bW);var bX=U+bY+W;qx.bom.Stylesheet.addRule(bV.__oV[this.__Iv].rowstylesheet,bW,bX);this.__rz.renderLayout(bY,100,{top:0,right:0,bottom:0,left:0});var cb=this.__HN.getData();for(var i=0,ce=0;i<cb.length;i++ ,ce+=bY){var bW=bo+this.__Iv+r+i;var bV=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bV.__oV[this.__Iv].cellstylesheet[i],bW);bY=cb[i].getComputedWidth();if(qx.core.Environment.get(J)){if(qx.core.Environment.get(p)){this.debug(bl+i+O+bY);}
;}
;var ca;if(qx.core.Environment.get(v)==c){ca=qx.ui.progressive.renderer.table.Row.__It*2;}
else {ca=-1;}
;var cf=(bY-ca)+W;var cd=X+qx.ui.progressive.renderer.table.Row.__It+h+X+qx.ui.progressive.renderer.table.Row.__It+W;var bU=ce+W;var bX=bV.__Iu+U+cf+bn+bU+l+cd;qx.bom.Stylesheet.addRule(bV.__oV[this.__Iv].cellstylesheet[i],bW,bX);}
;}
},destruct:function(){qx.theme.manager.Color.getInstance().removeListener(q,this.__Iw,this);var name;for(name in this.__Iq){this.__Iq[name]=null;}
;var ch=qx.ui.progressive.renderer.table.Row;var cg=this.__HG.toHashCode();if(ch.__oV&&ch.__oV[cg]){if(ch.__oV[cg].rowstylesheet){var cj=bo+this.__Iv+I;var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ch.__oV[this.__Iv].rowstylesheet,cj);}
;if(ch.__oV[cg].cellstylesheet){for(var i=ch.__oV[cg].cellstylesheet.length-1;i>=0;i-- ){var cj=bo+this.__Iv+r+i;var ci=ch.__oV[this.__Iv].cellstylesheet[i];var ch=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(ci,cj);}
;}
;}
;if(this.__HG&&this.__HG.getRendererData){var ck=this.__HG.getRendererData();if(ck&&ck[this.__Cd]&&ck[this.__Cd].end!==undefined){ck[this.__Cd]=null;}
;}
;this.__Is=this.__Iq=this.__HG=this.__HN=null;this._disposeObjects(H,b,s);}
});}
)();
