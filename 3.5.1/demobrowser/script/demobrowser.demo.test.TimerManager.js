...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.TimerManager.90719a9710f1.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Stopping recurrent 2-second timer",b="Recurrent 2-second timer with limit 3:",c="\n",d="One-shot 1-second timer: ",e=" ",f="demobrowser.demo.test.TimerManager",g="Recurrent 5-second timer: ",h="Start timers",i="execute",j="__Da";qx.Class.define(f,{extend:qx.application.Standalone,members:{__Da:null,startTimers:function(){var k=qx.util.TimerManager.getInstance();k.start(function(l,m){this.__SA(g+m);}
,5000,this,null,0);k.start(function(n,o){this.__SA(d+o);}
,0,this,null,1000);k.start(function(p,q){this.__SA(b+q);if( ++p.count==3){this.__SA(a);k.stop(q);}
;}
,2000,this,{count:0},2000);}
,__SA:function(r){r=Date.parse(new Date)+e+r+c;this.__Da.setValue(this.__Da.getValue()+r);}
...
,this);var v=new qx.ui.form.TextArea();v.set({width:400,height:300});this.__Da=v;t.add(v);t.add(u);this.getRoot().add(t,{left:20,top:10});}
