...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.FormRendererDouble","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.FormRendererDouble.b7b7f962984c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Female",b="Name",c="Registration",d="Male",e="Send",f="send...",g="Bio",h="demobrowser.demo.ui.FormRendererDouble",i="Gender",j="Country",k="Personal Information",l="Save?",m="Password",n="execute",o="Reset",p="Age";qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.form.Form();r.addGroupHeader(c);var q=new qx.ui.form.TextField();q.setRequired(true);r.add(q,b);var w=new qx.ui.form.PasswordField();w.setRequired(true);r.add(w,m);r.add(new qx.ui.form.CheckBox(),l);r.addGroupHeader(k);r.add(new qx.ui.form.Spinner(),p);r.add(new qx.ui.form.TextField(),j);var u=new qx.ui.form.RadioButtonGroup();u.add(new qx.ui.form.RadioButton(d));u.add(new qx.ui.form.RadioButton(a));r.add(u,i);r.add(new qx.ui.form.TextArea(),g);var t=new qx.ui.form.Button(e);t.addListener(n,function(){if(r.validate()){alert(f);}
;}
,this);r.addButton(t);var s=new qx.ui.form.Button(o);s.addListener(n,function(){r.reset();}
,this);r.addButton(s);var v=new qx.ui.form.renderer.Double(r);this.getRoot().add(v,{left:10,top:10});}
}});}
)();
(function(){var a="qx.ui.form.Form",b="";qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__vh=[];this._buttons=[];this._buttonOptions=[];this._validationManager=new qx.ui.form.validation.Manager();this._resetter=this._createResetter();}
,members:{__vh:null,_validationManager:null,_groupCounter:0,_buttons:null,_buttonOptions:null,_resetter:null,add:function(e,d,f,name,c,g){if(this.__vi()){this.__vh.push({title:null,items:[],labels:[],names:[],options:[],headerOptions:{}});}
;this.__vh[this._groupCounter].items.push(e);this.__vh[this._groupCounter].labels.push(d);this.__vh[this._groupCounter].options.push(g);if(name==null){name=d.replace(/\s+|&|-|\+|\*|\/|\||!|\.|,|:|\?|;|~|%|\{|\}|\(|\)|\[|\]|<|>|=|\^|@|\\/g,b);}
;this.__vh[this._groupCounter].names.push(name);this._validationManager.add(e,f,c);this._resetter.add(e);}
,addGroupHeader:function(k,h){if(!this.__vi()){this._groupCounter++ ;}
;this.__vh.push({title:k,items:[],labels:[],names:[],options:[],headerOptions:h});}
,addButton:function(l,m){this._buttons.push(l);this._buttonOptions.push(m||null);}
,__vi:function(){return this.__vh.length===0;}
,reset:function(){this._resetter.reset();this._validationManager.reset();}
,redefineResetter:function(){this._resetter.redefine();}
,redefineResetterItem:function(n){this._resetter.redefineItem(n);}
,validate:function(){return this._validationManager.validate();}
,getValidationManager:function(){return this._validationManager;}
,getGroups:function(){return this.__vh;}
,getButtons:function(){return this._buttons;}
,getButtonOptions:function(){return this._buttonOptions;}
,getItems:function(){var o={};for(var i=0;i<this.__vh.length;i++ ){var p=this.__vh[i];for(var j=0;j<p.names.length;j++ ){var name=p.names[j];o[name]=p.items[j];}
;}
;return o;}
,_createResetter:function(){return new qx.ui.form.Resetter();}
},destruct:function(){this.__vh=this._buttons=this._buttonOptions=null;this._validationManager.dispose();this._resetter.dispose();}
});}
)();
(function(){var a="Widgets supporting selection can only be validated ",b="Added widget not supported.",c="",d="in the form validator",f="changeValid",g="qx.event.type.Event",h="complete",j="value instanceof Function || qx.Class.isSubClassOf(value.constructor, qx.ui.form.validation.AsyncValidator)",k="qx.ui.form.validation.Manager",l="This field is required",m="String",n="qx.event.type.Data";qx.Class.define(k,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__vj=[];this.__vk={};this.setRequiredFieldMessage(qx.locale.Manager.tr(l));}
,events:{"changeValid":n,"complete":g},properties:{validator:{check:j,init:null,nullable:true},invalidMessage:{check:m,init:c},requiredFieldMessage:{check:m,init:c},context:{nullable:true}},members:{__vj:null,__vl:null,__vk:null,__vm:null,add:function(r,o,q){if(!this.__vr(r)){throw new Error(b);}
;if(this.__vs(r)&&!r.getValue){if(o!=null){throw new Error(a+d);}
;}
;var p={item:r,validator:o,valid:null,context:q};this.__vj.push(p);}
,remove:function(u){var s=this.__vj;for(var i=0,t=s.length;i<t;i++ ){if(u===s[i].item){s.splice(i,1);return u;}
;}
;return null;}
,getItems:function(){var v=[];for(var i=0;i<this.__vj.length;i++ ){v.push(this.__vj[i].item);}
;return v;}
,validate:function(){var A=true;this.__vm=true;var x=[];for(var i=0;i<this.__vj.length;i++ ){var y=this.__vj[i].item;var B=this.__vj[i].validator;x.push(y);if(B==null){var w=this.__vn(y);A=A&&w;this.__vm=w&&this.__vm;continue;}
;var w=this.__vo(this.__vj[i],y.getValue());A=w&&A;if(w!=null){this.__vm=w&&this.__vm;}
;}
;var z=this.__vp(x);if(qx.lang.Type.isBoolean(z)){this.__vm=z&&this.__vm;}
;A=z&&A;this.__vt(A);if(qx.lang.Object.isEmpty(this.__vk)){this.fireEvent(h);}
;return A;}
,__vn:function(D){if(D.getRequired()){if(this.__vs(D)){var C=!!D.getSelection()[0];}
else {var F=D.getValue();var C=!!F||F===0;}
;D.setValid(C);var G=D.getRequiredInvalidMessage();var E=G?G:this.getRequiredFieldMessage();D.setInvalidMessage(E);return C;}
;return true;}
,__vo:function(J,K){var L=J.item;var N=J.context;var M=J.validator;if(this.__vq(M)){this.__vk[L.toHashCode()]=null;M.validate(L,L.getValue(),this,N);return null;}
;var H=null;try{var H=M.call(N||this,K,L);if(H===undefined){H=true;}
;}
catch(e){if(e instanceof qx.core.ValidationError){H=false;if(e.message&&e.message!=qx.type.BaseError.DEFAULTMESSAGE){var I=e.message;}
else {var I=e.getComment();}
;L.setInvalidMessage(I);}
else {throw e;}
;}
;L.setValid(H);J.valid=H;return H;}
,__vp:function(P){var Q=this.getValidator();var R=this.getContext()||this;if(Q==null){return true;}
;this.setInvalidMessage(c);if(this.__vq(Q)){this.__vk[this.toHashCode()]=null;Q.validateForm(P,this,R);return null;}
;try{var S=Q.call(R,P,this);if(S===undefined){S=true;}
;}
catch(e){if(e instanceof qx.core.ValidationError){S=false;if(e.message&&e.message!=qx.type.BaseError.DEFAULTMESSAGE){var O=e.message;}
else {var O=e.getComment();}
;this.setInvalidMessage(O);}
else {throw e;}
;}
;return S;}
,__vq:function(U){var T=false;if(!qx.lang.Type.isFunction(U)){T=qx.Class.isSubClassOf(U.constructor,qx.ui.form.validation.AsyncValidator);}
;return T;}
,__vr:function(V){var W=V.constructor;return qx.Class.hasInterface(W,qx.ui.form.IForm);}
,__vs:function(X){var Y=X.constructor;return qx.Class.hasInterface(Y,qx.ui.core.ISingleSelection);}
,__vt:function(ba){var bb=this.__vl;this.__vl=ba;if(bb!=ba){this.fireDataEvent(f,ba,bb);}
;}
,getValid:function(){return this.__vl;}
,isValid:function(){return this.getValid();}
,getInvalidMessages:function(){var bc=[];for(var i=0;i<this.__vj.length;i++ ){var bd=this.__vj[i].item;if(!bd.getValid()){bc.push(bd.getInvalidMessage());}
;}
;if(this.getInvalidMessage()!=c){bc.push(this.getInvalidMessage());}
;return bc;}
,getInvalidFormItems:function(){var be=[];for(var i=0;i<this.__vj.length;i++ ){var bf=this.__vj[i].item;if(!bf.getValid()){be.push(bf);}
;}
;return be;}
,reset:function(){for(var i=0;i<this.__vj.length;i++ ){var bg=this.__vj[i];bg.item.setValid(true);}
;this.__vl=null;}
,setItemValid:function(bi,bh){this.__vk[bi.toHashCode()]=bh;bi.setValid(bh);this.__vu();}
,setFormValid:function(bj){this.__vk[this.toHashCode()]=bj;this.__vu();}
,__vu:function(){var bl=this.__vm;for(var bm in this.__vk){var bk=this.__vk[bm];bl=bk&&bl;if(bk==null){return;}
;}
;this.__vt(bl);this.__vk={};this.fireEvent(h);}
},destruct:function(){this.__vj=null;}
});}
)();
(function(){var a="qx.ui.form.validation.AsyncValidator";qx.Class.define(a,{extend:qx.core.Object,construct:function(b){qx.core.Object.call(this);this.__vv=b;}
,members:{__vv:null,__vw:null,__eQ:null,__vx:null,validate:function(c,e,d,f){this.__vx=false;this.__vw=c;this.__eQ=d;this.__vv.call(f||this,this,e);}
,validateForm:function(g,h,i){this.__vx=true;this.__eQ=h;this.__vv.call(i,g,this);}
,setValid:function(k,j){if(this.__vx){if(j!==undefined){this.__eQ.setInvalidMessage(j);}
;this.__eQ.setFormValid(k);}
else {if(j!==undefined){this.__vw.setInvalidMessage(j);}
;this.__eQ.setItemValid(this.__vw,k);}
;}
},destruct:function(){this.__eQ=this.__vw=null;}
});}
)();
...
(function(){var a="The given item has not been added.",b="qx.ui.form.Resetter",c=" not supported for reseting.",d="Item ";qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__nS=[];}
,members:{__nS:null,add:function(e){if(this._supportsValue(e)){var f=e.getValue();}
else if(this.__vs(e)){var f=e.getSelection();}
else if(this.__vA(e)){var f=e.getSelection().concat();}
else {throw new Error(d+e+c);}
;this.__nS.push({item:e,init:f});}
,reset:function(){for(var i=0;i<this.__nS.length;i++ ){var g=this.__nS[i];this.__vy(g.item,g.init);}
;}
,resetItem:function(h){var j;for(var i=0;i<this.__nS.length;i++ ){var k=this.__nS[i];if(k.item===h){j=k.init;break;}
;}
;if(j===undefined){throw new Error(a);}
;this.__vy(h,j);}
,__vy:function(l,m){if(this._supportsValue(l)){l.setValue(m);}
else if(this.__vs(l)||this.__vA(l)){l.setSelection(m);}
;}
,redefine:function(){for(var i=0;i<this.__nS.length;i++ ){var n=this.__nS[i].item;this.__nS[i].init=this.__vz(n);}
;}
,redefineItem:function(o){var p;for(var i=0;i<this.__nS.length;i++ ){if(this.__nS[i].item===o){p=this.__nS[i];break;}
;}
;if(p===undefined){throw new Error(a);}
;p.init=this.__vz(p.item);}
,__vz:function(q){if(this._supportsValue(q)){return q.getValue();}
else if(this.__vs(q)||this.__vA(q)){return q.getSelection();}
;}
,__vs:function(r){var s=r.constructor;return qx.Class.hasInterface(s,qx.ui.core.ISingleSelection);}
,__vA:function(t){var u=t.constructor;return qx.Class.hasInterface(u,qx.data.controller.ISelection);}
,_supportsValue:function(v){var w=v.constructor;return (qx.Class.hasInterface(w,qx.ui.form.IBooleanForm)||qx.Class.hasInterface(w,qx.ui.form.IColorForm)||qx.Class.hasInterface(w,qx.ui.form.IDateForm)||qx.Class.hasInterface(w,qx.ui.form.INumberForm)||qx.Class.hasInterface(w,qx.ui.form.IStringForm));}
},destruct:function(){this.__nS=null;}
});}
)();
...
(function(){var a="qx.ui.form.IColorForm",b="qx.event.type.Data";qx.Interface.define(a,{events:{"changeValue":b},members:{setValue:function(c){return arguments.length==1;}
,resetValue:function(){}
,getValue:function(){}
}});}
)();
(function(){var a="qx.ui.form.IDateForm",b="qx.event.type.Data";qx.Interface.define(a,{events:{"changeValue":b},members:{setValue:function(c){return arguments.length==1;}
,resetValue:function(){}
,getValue:function(){}
}});}
)();
...
(function(){var a="password",b="qx.ui.form.PasswordField";qx.Class.define(b,{extend:qx.ui.form.TextField,members:{_createInputElement:function(){return new qx.html.Input(a);}
}});}
)();
...
(function(){var a="Boolean",b="_applyValid",c="",d="changeRequired",f="changeValid",g="__rY",h="changeInvalidMessage",j="changeSelection",k="_applyInvalidMessage",l="String",m="qx.ui.form.RadioButtonGroup",n="qx.event.type.Data";qx.Class.define(m,{extend:qx.ui.core.Widget,include:[qx.ui.core.MLayoutHandling,qx.ui.form.MModelSelection],implement:[qx.ui.form.IForm,qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],construct:function(o){qx.ui.core.Widget.call(this);if(o==null){this.setLayout(new qx.ui.layout.VBox(4));}
else {this.setLayout(o);}
;this.__rY=new qx.ui.form.RadioGroup();this.__rY.addListener(j,function(e){this.fireDataEvent(j,e.getData(),e.getOldData());}
,this);}
,properties:{valid:{check:a,init:true,apply:b,event:f},required:{check:a,init:false,event:d},invalidMessage:{check:l,init:c,event:h,apply:k},requiredInvalidMessage:{check:l,nullable:true,event:h}},events:{"changeSelection":n},members:{__rY:null,_applyInvalidMessage:function(r,p){var q=this._getChildren();for(var i=0;i<q.length;i++ ){q[i].setInvalidMessage(r);}
;}
,_applyValid:function(u,s){var t=this._getChildren();for(var i=0;i<t.length;i++ ){t[i].setValid(u);}
;}
,getRadioGroup:function(){return this.__rY;}
,getChildren:function(){return this._getChildren();}
,add:function(w,v){this.__rY.add(w);this._add(w,v);}
,remove:function(x){this.__rY.remove(x);this._remove(x);}
,removeAll:function(){var y=this.__rY.getItems();for(var i=0;i<y.length;i++ ){this.__rY.remove(y[i]);}
;return this._removeAll();}
,getSelection:function(){return this.__rY.getSelection();}
,setSelection:function(z){this.__rY.setSelection(z);}
,resetSelection:function(){this.__rY.resetSelection();}
,isSelected:function(A){return this.__rY.isSelected(A);}
,isSelectionEmpty:function(){return this.__rY.isSelectionEmpty();}
,getSelectables:function(B){return this.__rY.getSelectables(B);}
},destruct:function(){this._disposeObjects(g);}
});}
)();
...
,properties:{wrap:{check:a,init:true,apply:d},appearance:{refine:true,init:i},singleStep:{check:h,init:20},minimalLineHeight:{check:h,apply:g,init:4},autoSize:{check:a,apply:w,init:false}},members:{__vB:null,__vC:null,__vD:null,setValue:function(M){M=qx.ui.form.AbstractField.prototype.setValue.call(this,M);this.__vE();return M;}
...
;}
,__vE:function(){if(this.isAutoSize()){var R=this.__vF();if(R&&this.getBounds()){this.__vD=this.__vD||this._getAreaHeight();var T=this._getScrolledAreaHeight();if(this.getMaxHeight()){var P=this.getInsets();var Q=-P.top+this.getMaxHeight()-P.bottom;if(T>Q){this.getContentElement().setStyle(H,j);}
else {this.getContentElement().setStyle(H,G);}
;}
;var S=Math.max(T,this.__vD);this._setAreaHeight(S);}
else {this.getContentElement().addListenerOnce(x,function(){this.__vE();}
,this);}
;}
;}
,_getAreaHeight:function(){return this.getInnerSize().height;}
,_setAreaHeight:function(U){if(this._getAreaHeight()!==U){this.__vC=U;qx.ui.core.queue.Layout.add(this);qx.ui.core.queue.Manager.flush();this.__vI();}
;}
,_getScrolledAreaHeight:function(){var W=this.__vF();var V=W.getDomElement();if(V){if(!V.parentNode){qx.html.Element.flush();return this._getScrolledAreaHeight();}
...
;this.__vH(W);if(qx.core.Environment.get(C)==B&&qx.core.Environment.get(s)==8){if(!V.scrollTop){qx.html.Element.flush();}
;}
;return V.scrollTop;}
;}
,__vF:function(){this.__vB=this.__vB||this.__vG();return this.__vB;}
,__vG:function(){var ba,Y,bb,X;ba=this.getContentElement();if(!ba.getDomElement()){return null;}
;bb=qx.bom.Element.clone(ba.getDomElement());X=new qx.html.Input(i);X.useElement(bb);Y=X;Y.setStyles({position:K,top:0,left:n,height:0,overflow:G},true);Y.removeAttribute(F);Y.removeAttribute(z);Y.setAttribute(y,f);Y.setValue(ba.getValue()||t);Y.insertBefore(ba);this.__vH(Y);return Y;}
,__vH:function(bc){bc=bc.getDomElement();if(bc){bc.scrollTop=10000;}
;}
...
,_applyAutoSize:function(bh,bg){if(qx.core.Environment.get(J)){this.__vJ();}
;if(bh){this.__vE();this.addListener(o,this.__vE,this);if(!this.getBounds()){this.addListenerOnce(x,function(){this.getContentElement().setStyle(H,G);}
);}
else {this.getContentElement().setStyle(H,G);}
;}
else {this.removeListener(o,this.__vE);this.getContentElement().setStyle(H,j);}
;}
,_applyDimension:function(bi){qx.ui.form.AbstractField.prototype._applyDimension.call(this);if(qx.core.Environment.get(J)){this.__vJ();}
;if(bi===this.getMaxHeight()){this.__vE();}
;}
,__vI:function(){var content=this.getContentElement();var bk=content.getDomElement();var bj=content.getStyle(u);content.setStyle(u,parseInt(bj,10)+1000+b,true);if(bk){qx.bom.element.Dimension.getWidth(bk);}
;content.setStyle(u,bj,true);}
,__vJ:function(){if(this.isAutoSize()&&this.getHeight()){this.warn(m+I+v);}
;}
,_getContentHint:function(){var bl=qx.ui.form.AbstractField.prototype._getContentHint.call(this);bl.height=bl.height*this.getMinimalLineHeight();bl.width=this._getTextSize().width*20;if(this.isAutoSize()){bl.height=this.__vC||bl.height;}
;return bl;}
},destruct:function(){this.setAutoSize(false);if(this.__vB){this.__vB.dispose();}
;}
});}
)();
(function(){var a="qx.ui.form.renderer.IFormRenderer";qx.Interface.define(a,{members:{addItems:function(b,f,d,c,e){}
,addButton:function(g,h){}
}});}
)();
(function(){var a=" <span style='color:red'>*</span> ",b="Abstract method call",c="abstract",d="",f="changeLocale",g="visibility",h="qx.dynlocale",j="qx.ui.form.renderer.AbstractRenderer",k=" :";qx.Class.define(j,{type:c,extend:qx.ui.core.Widget,implement:qx.ui.form.renderer.IFormRenderer,construct:function(n){qx.ui.core.Widget.call(this);this._visibilityBindingIds=[];this._labels=[];if(qx.core.Environment.get(h)){qx.locale.Manager.getInstance().addListener(f,this._onChangeLocale,this);this._names=[];}
;var p=n.getGroups();for(var i=0;i<p.length;i++ ){var m=p[i];this.addItems(m.items,m.labels,m.title,m.options,m.headerOptions);}
;var o=n.getButtons();var l=n.getButtonOptions();for(var i=0;i<o.length;i++ ){this.addButton(o[i],l[i]);}
;}
,members:{_names:null,_visibilityBindingIds:null,_labels:null,_connectVisibility:function(q,s){var r=q.bind(g,s,g);this._visibilityBindingIds.push({id:r,item:q});}
,_onChangeLocale:qx.core.Environment.select(h,{"true":function(e){for(var i=0;i<this._names.length;i++ ){var u=this._names[i];if(u.name&&u.name.translate){u.name=u.name.translate();}
;var t=this._createLabelText(u.name,u.item);u.label.setValue(t);}
;}
,"false":null}),_createLabelText:function(name,v){var w=d;if(v.getRequired()){w=a;}
;var x=name.length>0||v.getRequired()?k:d;return name+w+x;}
,addItems:function(y,z,A){throw new Error(b);}
,addButton:function(B){throw new Error(b);}
},destruct:function(){if(qx.core.Environment.get(h)){qx.locale.Manager.getInstance().removeListener(f,this._onChangeLocale,this);}
;this._names=null;for(var i=0;i<this._labels.length;i++ ){this._labels[i].dispose();}
;for(var i=0;i<this._visibilityBindingIds.length;i++ ){var C=this._visibilityBindingIds[i];C.item.removeBinding(C.id);}
;}
});}
)();
(function(){var a="bold",b="_buttonRow",c="qx.ui.form.renderer.Double",d="qx.dynlocale",e="top",f="left",g="right";qx.Class.define(c,{extend:qx.ui.form.renderer.AbstractRenderer,construct:function(j){var h=new qx.ui.layout.Grid();h.setSpacing(6);h.setColumnAlign(0,g,e);h.setColumnAlign(1,f,e);h.setColumnAlign(2,g,e);h.setColumnAlign(3,f,e);this._setLayout(h);qx.ui.form.renderer.AbstractRenderer.call(this,j);}
,members:{_row:0,_buttonRow:null,addItems:function(l,o,k){if(k!=null){this._add(this._createHeader(k),{row:this._row,column:0,colSpan:4});this._row++ ;}
;for(var i=0;i<l.length;i++ ){var m=this._createLabel(o[i],l[i]);this._add(m,{row:this._row,column:(i*2)%4});var n=l[i];m.setBuddy(n);this._connectVisibility(n,m);this._add(n,{row:this._row,column:((i*2)%4)+1});if(i%2==1){this._row++ ;}
;if(qx.core.Environment.get(d)){this._names.push({name:o[i],label:m,item:l[i]});}
;}
;if(i%2==1){this._row++ ;}
;}
,addButton:function(p){if(this._buttonRow==null){this._buttonRow=new qx.ui.container.Composite();this._buttonRow.setMarginTop(5);var q=new qx.ui.layout.HBox();q.setAlignX(g);q.setSpacing(5);this._buttonRow.setLayout(q);this._add(this._buttonRow,{row:this._row,column:0,colSpan:4});this._row++ ;}
;this._buttonRow.add(p);}
,getLayout:function(){return this._getLayout();}
,_createLabel:function(name,r){var s=new qx.ui.basic.Label(this._createLabelText(name,r));this._labels.push(s);s.setRich(true);return s;}
,_createHeader:function(u){var t=new qx.ui.basic.Label(u);this._labels.push(t);t.setFont(a);if(this._row!=0){t.setMarginTop(10);}
;t.setAlignX(f);return t;}
},destruct:function(){if(this._buttonRow){this._buttonRow.removeAll();this._disposeObjects(b);}
;}
});}
)();
