...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.AttributeStyle_1.46c7c469fe46.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="text",b="test3",c="test5",d="name",e="test1",f="valign: ",g="readonly: ",h="backgroundColor",i="x",j="opacity: ",k="bg: ",l="black",m="checked: ",n="name: ",o="readonly",p="title: ",q="style: ",r="max: ",s="classname: ",t="color",u="href: ",v="value",w="demobrowser.demo.bom.AttributeStyle_1",x="text: ",y="test9",z="fontFamily",A="type",B="class",C="disabled",D="test8",E="maxlength",F="test7",G="html",H="test2",I="Viewport: ",J="title",K="type: ",L="href",M="disabled: ",N="valign",O="css: ",P="color: ",Q="html: ",R="top",S="colspan",T="tabindex",U="value: ",V="td",W="Document: ",X="test4",Y="top: ",bn="tabindex: ",bo="red",bp="family: ",bj="left",bk="left: ",bl="checked",bm="test6",bq="style",br="colspan: ";qx.Class.define(w,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var bs=qx.bom.element.Attribute;var bt=qx.bom.element.Style;var bu=qx.bom.element.Opacity;this.info(e);this.debug(s+bs.get(document.getElementById(e),B));this.debug(p+bs.get(document.getElementById(e),J));this.debug(Y+bt.get(document.getElementById(e),R));this.info(H);this.debug(n+bs.get(document.getElementById(H),d));this.debug(U+bs.get(document.getElementById(H),v));this.debug(K+bs.get(document.getElementById(H),A));this.debug(r+bs.get(document.getElementById(H),E));this.debug(bk+bt.get(document.getElementById(H),bj));this.info(b);this.debug(n+bs.get(document.getElementById(b),d));this.debug(U+bs.get(document.getElementById(b),v));this.debug(K+bs.get(document.getElementById(b),A));this.debug(m+bs.get(document.getElementById(b),bl));this.debug(M+bs.get(document.getElementById(b),C));this.debug(bn+bs.get(document.getElementById(b),T));this.info(X);this.debug(M+bs.get(document.getElementById(X),C));this.debug(g+bs.get(document.getElementById(X),o));this.info(c);this.debug(M+bs.get(document.getElementById(c),C));this.debug(g+bs.get(document.getElementById(c),o));this.info(bm);this.debug(u+bs.get(document.getElementById(bm),L));this.debug(q+bs.get(document.getElementById(bm),bq));this.debug(O+bt.getCss(document.getElementById(bm)));this.debug(P+bt.get(document.getElementById(bm),t));this.debug(k+bt.get(document.getElementById(bm),h));this.debug(bp+bt.get(document.getElementById(bm),z));this.debug(x+bs.get(document.getElementById(bm),a));this.debug(Q+bs.get(document.getElementById(bm),G));this.debug(j+bu.get(document.getElementById(bm)));this.info(F);this.debug(f+bs.get(document.getElementById(F),N));this.debug(br+bs.get(document.getElementById(F).getElementsByTagName(V)[0],S));this.info(D);bt.set(document.getElementById(D),t,bo);bt.set(document.getElementById(D),h,l);bu.set(document.getElementById(D),0.5);this.debug(j+bu.get(document.getElementById(D)));this.info(y);this.debug(W+qx.bom.Document.getWidth()+i+qx.bom.Document.getHeight());this.debug(I+qx.bom.Viewport.getWidth()+i+qx.bom.Viewport.getHeight());}
}});}
)();
