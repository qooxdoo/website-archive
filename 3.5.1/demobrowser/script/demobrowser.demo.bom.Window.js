...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Window.cf4a4ee8b9a4.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Open Native Window",b="click",c="Open Native Modal Window",d="demobrowser.demo.bom.Window",f="Modal Window closed?",g="http://sourceforge.net",h="window1",i="window3",j="http://slashdot.org",k="Window closed?",l="http://qooxdoo.org",m="demobrowser/demo/html/ModalWindow.html",n="Open Faked Native Modal Window",o="window2",p="#eee",q="button";qx.Class.define(d,{extend:qx.application.Native,members:{__BW:null,main:function(){qx.application.Native.prototype.main.call(this);var r=qx.util.ResourceManager.getInstance();this.__BW=[l,g,j,r.toUri(m)];var u=qx.bom.Input.create(q);qx.bom.Input.setValue(u,a);document.body.appendChild(u);qx.event.Registration.addListener(u,b,function(e){var x={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};this.window1=qx.bom.Window.open(this.__BW[0],h,x);}
...
,this);var s=qx.bom.Input.create(q);qx.bom.Input.setValue(s,c);document.body.appendChild(s);qx.event.Registration.addListener(s,b,function(e){var y={width:400,height:200,top:200,left:100,scrollbars:false};this.window2=qx.bom.Window.open(this.__BW[3],o,y,true);}
...
,this);var v=qx.bom.Input.create(q);qx.bom.Input.setValue(v,n);document.body.appendChild(v);qx.event.Registration.addListener(v,b,function(e){var A={width:800,height:600,top:200,left:100,scrollbars:false};var z=qx.bom.Window.getBlocker();z.setBlockerColor(p);z.setBlockerOpacity(0.5);this.window3=qx.bom.Window.open(this.__BW[0],i,A,true,false);}
,this);}
...
;return C;}
,__Lm:function(K,O){var M;var J;var N=[];if(O&&this.__Ll()){for(var L in K){if(qx.bom.Window.__Lj[L]){var I=n;if(L!=u&&L!=h){I=b;}
;J=qx.bom.Window.__Lj[L]+i+K[L]+I;N.push(J);}
else {qx.log.Logger.warn(o+L+s);}
;}
;M=N.join(w);}
else {for(var L in K){if(qx.bom.Window.__Lk[L]){if(qx.lang.Type.isBoolean(K[L])){J=L+v+(K[L]?j:a);}
else {J=L+v+K[L];}
;N.push(J);}
...
;M=N.join(y);}
;return M;}
,__Ln:function(){if(this.isClosed(this.__Li)){this.getBlocker().unblock();this.__ij.stop();}
;}
