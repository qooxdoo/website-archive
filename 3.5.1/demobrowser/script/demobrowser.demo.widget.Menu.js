...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Menu","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Menu.1b54587e664e.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Online Forum",b="__Tn",c="New",d="icon/16/actions/edit-cut.png",f="icon/16/actions/format-justify-fill.png",g="Search in files",h="C",j="changeValue",k="Left aligned",l="Undo",m="__Tp",n="Perl",o="View",p="C Dialect",q="changeSelection",r="Info...",s="Save as...",t="Show line numbers",u="icon/16/actions/document-save.png",v="__To",w="Quickstart",x="icon/16/actions/contact-new.png",y="Ctrl+N",z="icon/16/actions/edit-paste.png",A="Actions",B="Show console",C="Search",D="Help",E="Redo",F="Show status bar",G="icon/16/actions/format-justify-left.png",H="ANSI to OEM",I="Centered",J="Website 3",K="icon/22/apps/preferences-users.png",L="Edit",M="icon/16/actions/format-justify-center.png",N="Ctrl+O",O="icon/16/actions/document-print.png",P="icon/16/actions/go-previous.png",Q="icon/16/actions/document-open.png",R="C Sharp",S="icon/16/actions/edit-undo.png",T="Close",U="Split Button",V="__Tq",W="Website 2",X="icon/16/actions/document-save-as.png",Y="Python",cM="icon/16/apps/utilities-help.png",cN="__yA",cO="Show tree",cI="Options",cJ="Spaces to tabs",cK="Right aligned",cL="Action 1",cT="OEM to ANSI",cU="Line 431",cV="JavaScript",cW="icon",cP="Action 2",cQ="Folder ",cR="__Tr",cS="XML",db="Line 313",dD="Save",er="Paragraph",dc="demobrowser.demo.widget.Menu",cX="icon/16/actions/application-exit.png",cY="C Plus Plus",en="Line 26",da="Item ",dd="ASCII table",de="Option 1",df="Search next...",dk="Line 12",dl="Action 3",dm="Replace in files",dg="Uppercase",dh="Ctrl+P",di="Topics",dj="Panes",dr="Justified",ds="Ctrl+X",dt="icon/16/actions/edit-redo.png",du="Search previous...",dn="Change selection: ",dp="Back",eo="__yt",dq="main",dy="Copy",dz=" = ",eq="Paste",dA="Execute command: ",dv="Show ruler",dw="icon/16/actions/format-justify-right.png",ep="icon/16/actions/go-next.png",dx="Ctrl+Z",dB="command ",dC="Option 3",dO="Next",dN="Ctrl+R",dM="Show macros",dS="Show tags",dR="Capitals",dQ="Execute button: ",dP="Format",dH="File",dG="Change checked: ",dF="Show tabs",dE="Print",dL="execute",dK="icon/16/actions/edit-copy.png",dJ="Cut",dI="Tabs to spaces",ea="Search...",dY="Line 1039",dX="Option 2",dW="Open",ee="Objective C",ed="Exit",ec="move to",eb="icon/16/actions/system-search.png",dV="Ctrl+S",dU="Syntax",dT="Ctrl+C",ei="Website 1",eh="Menu Button",eg="icon/16/actions/document-new.png",em="Line 30",el="Lowercase",ek="Replace",ej="__Tm",ef="HTML";qx.Class.define(dc,{extend:qx.application.Standalone,members:{__Tm:null,__Tn:null,__To:null,__yt:null,__yA:null,__Tp:null,__Tq:null,__Tr:null,main:function(){qx.application.Standalone.prototype.main.call(this);var et=new qx.ui.container.Scroll();var es=new qx.ui.container.Composite(new qx.ui.layout.Canvas);es.setPadding(20);es.setAllowStretchX(false);et.add(es);this.getRoot().add(et,{edge:0});this.createCommands();es.add(this.getMenuButton(),{left:20,top:20});es.add(this.getSplitButton(),{left:150,top:20});es.add(this.getMenuBar(),{left:20,top:100});es.add(this.getList(),{left:20,top:200});this.getRoot().setContextMenu(this.getRootContextMenu());}
,getRootContextMenu:function(){var eu=new qx.ui.menu.Menu();var ev=new qx.ui.menu.Menu();for(var i=0;i<30;i++ ){ev.add(new qx.ui.menu.Button(cQ+(i+1)));}
;eu.add(new qx.ui.menu.Button(ec,null,null,ev));eu.add(new qx.ui.menu.Separator());for(var i=0;i<7;i++ ){eu.add(new qx.ui.menu.Button(dB+(i+1)));}
;return eu;}
,debugRadio:function(e){this.debug(dn+e.getData()[0].getLabel());}
,debugCommand:function(e){this.debug(dA+this.getShortcut());}
,debugButton:function(e){this.debug(dQ+this.getLabel());}
,debugCheckBox:function(e){this.debug(dG+this.getLabel()+dz+e.getData());}
,createCommands:function(){this.__Tm=new qx.ui.core.Command(y);this.__Tm.addListener(dL,this.debugCommand);this.__Tn=new qx.ui.core.Command(N);this.__Tn.addListener(dL,this.debugCommand);this.__To=new qx.ui.core.Command(dV);this.__To.addListener(dL,this.debugCommand);this.__yt=new qx.ui.core.Command(dx);this.__yt.addListener(dL,this.debugCommand);this.__yA=new qx.ui.core.Command(dN);this.__yA.addListener(dL,this.debugCommand);this.__Tp=new qx.ui.core.Command(ds);this.__Tp.addListener(dL,this.debugCommand);this.__Tq=new qx.ui.core.Command(dT);this.__Tq.addListener(dL,this.debugCommand);this.__Tr=new qx.ui.core.Command(dh);this.__Tr.addListener(dL,this.debugCommand);this.__Tr.setEnabled(false);}
,getMenuButton:function(){var ew=new qx.ui.menu.Menu;ew.add(new qx.ui.menu.RadioButton(de));ew.add(new qx.ui.menu.RadioButton(dX));ew.add(new qx.ui.menu.RadioButton(dC));var eE=new qx.ui.menu.Menu;eE.add(new qx.ui.menu.RadioButton(cL));eE.add(new qx.ui.menu.RadioButton(cP));eE.add(new qx.ui.menu.RadioButton(dl));var eD=new qx.ui.form.RadioGroup;eD.add.apply(eD,ew.getChildren());eD.addListener(q,this.debugRadio);var eB=new qx.ui.form.RadioGroup;eB.add.apply(eB,eE.getChildren());eB.addListener(q,this.debugRadio);var ez=new qx.ui.menu.Menu();var eC=new qx.ui.menu.Button(l,S,this.__yt);var eJ=new qx.ui.menu.Button(E,dt,this.__yA);var ey=new qx.ui.menu.Button(dJ,d,this.__Tp);var eG=new qx.ui.menu.Button(dy,dK,this.__Tq);var eA=new qx.ui.menu.Button(eq,z,this.__Tr);var ex=new qx.ui.menu.Button(cI,eb,null,ew);var eH=new qx.ui.menu.Button(A,x,null,eE);var eF=new qx.ui.menu.Button(dE,O);eC.addListener(dL,this.debugButton);eJ.addListener(dL,this.debugButton);ey.addListener(dL,this.debugButton);eG.addListener(dL,this.debugButton);eA.addListener(dL,this.debugButton);ex.addListener(dL,this.debugButton);eH.addListener(dL,this.debugButton);eF.addListener(dL,this.debugButton);ez.add(eC);ez.add(eJ);ez.addSeparator();ez.add(ey);ez.add(eG);ez.add(eA);ez.addSeparator();ez.add(ex);ez.add(eH);ez.addSeparator();ez.add(eF);var eI=new qx.ui.form.MenuButton(eh,K,ez);return eI;}
,getSplitButton:function(){var eK=new qx.ui.menu.Menu;var eO=new qx.ui.menu.Button(ei);var eM=new qx.ui.menu.Button(W);var eN=new qx.ui.menu.Button(J);eK.setMinWidth(120);eO.addListener(dL,this.debugButton);eM.addListener(dL,this.debugButton);eN.addListener(dL,this.debugButton);eK.add(eO);eK.add(eM);eK.add(eN);var eL=new qx.ui.form.SplitButton(U,K,eK);eL.addListener(dL,this.debugButton);return eL;}
,getMenuBar:function(){var eS=new qx.ui.container.Composite(new qx.ui.layout.Grow);eS.setDecorator(dq);var toolbar=new qx.ui.toolbar.ToolBar;toolbar.setWidth(600);eS.add(toolbar);var fc=new qx.ui.toolbar.Part;var eR=new qx.ui.toolbar.Part;var eV=new qx.ui.toolbar.Part;toolbar.add(fc);toolbar.add(eR);toolbar.addSpacer();toolbar.add(eV);var fb=new qx.ui.toolbar.SplitButton(dp,P,this.getBackMenu());var fe=new qx.ui.toolbar.SplitButton(dO,ep,this.getForwardMenu());var eW=new qx.ui.toolbar.Button(c,eg,this.__Tm);var eU=new qx.ui.toolbar.Button(dW,Q,this.__Tn);var fa=new qx.ui.toolbar.Button(dD,u,this.__To);fb.addListener(dL,this.debugButton);fe.addListener(dL,this.debugButton);eW.addListener(dL,this.debugButton);eU.addListener(dL,this.debugButton);fa.addListener(dL,this.debugButton);fc.add(fb);fc.add(fe);fc.addSeparator();fc.add(eW);fc.add(eU);fc.add(fa);fc.setShow(cW);var eT=new qx.ui.toolbar.MenuButton(dH);var eP=new qx.ui.toolbar.MenuButton(L);var eQ=new qx.ui.toolbar.MenuButton(C);var fd=new qx.ui.toolbar.MenuButton(o);var eY=new qx.ui.toolbar.MenuButton(dP);eT.setMenu(this.getFileMenu());eP.setMenu(this.getEditMenu());eQ.setMenu(this.getSearchMenu());fd.setMenu(this.getViewMenu());eY.setMenu(this.getFormatMenu());eR.add(eT);eR.add(eP);eR.add(eQ);eR.add(fd);eR.add(eY);var eX=new qx.ui.toolbar.MenuButton(D);eX.setMenu(this.getHelpMenu());eV.add(eX);return eS;}
,getBackMenu:function(){var fg=new qx.ui.menu.Menu;var fh=new qx.ui.menu.Button(db);var fj=new qx.ui.menu.Button(dY);var ff=new qx.ui.menu.Button(dk);var fi=new qx.ui.menu.Button(en);fh.addListener(dL,this.debugButton);fj.addListener(dL,this.debugButton);ff.addListener(dL,this.debugButton);fi.addListener(dL,this.debugButton);fg.add(fh);fg.add(fj);fg.add(ff);fg.add(fi);return fg;}
,getForwardMenu:function(){var fk=new qx.ui.menu.Menu;var fl=new qx.ui.menu.Button(cU);var fm=new qx.ui.menu.Button(em);fl.addListener(dL,this.debugButton);fm.addListener(dL,this.debugButton);fk.add(fl);fk.add(fm);return fk;}
,getFileMenu:function(){var fp=new qx.ui.menu.Menu;var fn=new qx.ui.menu.Button(c,eg,this.__Tm);var fr=new qx.ui.menu.Button(dW,Q,this.__Tn);var fq=new qx.ui.menu.Button(T);var fu=new qx.ui.menu.Button(dD,u,this.__To);var ft=new qx.ui.menu.Button(s,X);var fo=new qx.ui.menu.Button(dE,O);var fs=new qx.ui.menu.Button(ed,cX);fn.addListener(dL,this.debugButton);fr.addListener(dL,this.debugButton);fq.addListener(dL,this.debugButton);fu.addListener(dL,this.debugButton);ft.addListener(dL,this.debugButton);fo.addListener(dL,this.debugButton);fs.addListener(dL,this.debugButton);fp.add(fn);fp.add(fr);fp.add(fq);fp.add(fu);fp.add(ft);fp.add(fo);fp.add(fs);return fp;}
,getEditMenu:function(){var fw=new qx.ui.menu.Menu;var fz=new qx.ui.menu.Button(l,S,this.__yt);var fy=new qx.ui.menu.Button(E,dt,this.__yA);var fv=new qx.ui.menu.Button(dJ,d,this.__Tp);var fA=new qx.ui.menu.Button(dy,dK,this.__Tq);var fx=new qx.ui.menu.Button(eq,z,this.__Tr);fz.addListener(dL,this.debugButton);fy.addListener(dL,this.debugButton);fv.addListener(dL,this.debugButton);fA.addListener(dL,this.debugButton);fx.addListener(dL,this.debugButton);fw.add(fz);fw.add(fy);fw.addSeparator();fw.add(fv);fw.add(fA);fw.add(fx);return fw;}
,getSearchMenu:function(){var fE=new qx.ui.menu.Menu;var fC=new qx.ui.menu.Button(ea,eb);var fH=new qx.ui.menu.Button(df);var fD=new qx.ui.menu.Button(du);var fG=new qx.ui.menu.Button(ek);var fB=new qx.ui.menu.Button(g,eb);var fF=new qx.ui.menu.Button(dm);fD.setEnabled(false);fC.addListener(dL,this.debugButton);fH.addListener(dL,this.debugButton);fD.addListener(dL,this.debugButton);fG.addListener(dL,this.debugButton);fB.addListener(dL,this.debugButton);fF.addListener(dL,this.debugButton);fE.add(fC);fE.add(fH);fE.add(fD);fE.add(fG);fE.addSeparator();fE.add(fB);fE.add(fF);return fE;}
,getViewMenu:function(){var fI=new qx.ui.menu.Menu;var fK=new qx.ui.menu.Button(dj,null,null,this.getPanesMenu());var fN=new qx.ui.menu.Button(dU,null,null,this.getSyntaxMenu());var fM=new qx.ui.menu.CheckBox(dv);var fL=new qx.ui.menu.CheckBox(t);var fJ=new qx.ui.menu.Button(dd);fM.addListener(j,this.debugCheckBox);fL.addListener(j,this.debugCheckBox);fJ.addListener(dL,this.debugButton);fI.add(fK);fI.add(fN);fI.addSeparator();fI.add(fM);fI.add(fL);fI.addSeparator();fI.add(fJ);return fI;}
,getPanesMenu:function(){var fP=new qx.ui.menu.Menu;var fR=new qx.ui.menu.CheckBox(dF);var fO=new qx.ui.menu.CheckBox(F);var fU=new qx.ui.menu.CheckBox(cO);var fQ=new qx.ui.menu.CheckBox(dM);var fS=new qx.ui.menu.CheckBox(dS);var fT=new qx.ui.menu.CheckBox(B);fR.setValue(true);fO.setValue(true);fQ.setValue(true);fR.addListener(j,this.debugCheckBox);fO.addListener(j,this.debugCheckBox);fU.addListener(j,this.debugCheckBox);fQ.addListener(j,this.debugCheckBox);fS.addListener(j,this.debugCheckBox);fT.addListener(j,this.debugCheckBox);fP.add(fO);fP.add(fR);fP.addSeparator();fP.add(fU);fP.add(fQ);fP.add(fS);fP.add(fT);return fP;}
,getSyntaxMenu:function(){var ga=new qx.ui.menu.Menu;var fV=new qx.ui.menu.RadioButton(ef);var fX=new qx.ui.menu.RadioButton(cS);var fW=new qx.ui.menu.RadioButton(cV);var fY=new qx.ui.menu.Button(p,null,null,this.getSyntaxCMenu());var gd=new qx.ui.menu.RadioButton(n);var gb=new qx.ui.menu.RadioButton(Y);ga.add(fV);ga.add(fX);ga.add(fW);ga.add(fY);ga.add(gd);ga.add(gb);var gc=new qx.ui.form.RadioGroup;gc.add(fV,fX,fW,gd,gb);gc.add.apply(gc,fY.getMenu().getChildren());gc.addListener(q,this.debugRadio);return ga;}
,getSyntaxCMenu:function(){var gf=new qx.ui.menu.Menu;var ge=new qx.ui.menu.RadioButton(h);var gi=new qx.ui.menu.RadioButton(R);var gg=new qx.ui.menu.RadioButton(ee);var gh=new qx.ui.menu.RadioButton(cY);gf.add(ge);gf.add(gi);gf.add(gg);gf.add(gh);return gf;}
,getFormatMenu:function(){var gm=new qx.ui.menu.Menu;var gl=new qx.ui.menu.Button(er,null,null,this.getParagraphMenu());var go=new qx.ui.menu.Button(dI);var gp=new qx.ui.menu.Button(cJ);var gk=new qx.ui.menu.Button(dg);var gn=new qx.ui.menu.Button(el);var gj=new qx.ui.menu.Button(dR);var gr=new qx.ui.menu.Button(cT);var gq=new qx.ui.menu.Button(H);go.addListener(dL,this.debugButton);gp.addListener(dL,this.debugButton);gk.addListener(dL,this.debugButton);gn.addListener(dL,this.debugButton);gj.addListener(dL,this.debugButton);gr.addListener(dL,this.debugButton);gq.addListener(dL,this.debugButton);gm.add(gl);gm.add(go);gm.add(gp);gm.addSeparator();gm.add(gk);gm.add(gn);gm.add(gj);gm.addSeparator();gm.add(gr);gm.add(gq);return gm;}
,getParagraphMenu:function(){var gs=new qx.ui.menu.Menu;var gw=new qx.ui.menu.Button(k,G);var gv=new qx.ui.menu.Button(cK,dw);var gt=new qx.ui.menu.Button(I,M);var gu=new qx.ui.menu.Button(dr,f);gw.addListener(dL,this.debugButton);gv.addListener(dL,this.debugButton);gt.addListener(dL,this.debugButton);gu.addListener(dL,this.debugButton);gs.add(gw);gs.add(gv);gs.add(gt);gs.add(gu);return gs;}
,getHelpMenu:function(){var gx=new qx.ui.menu.Menu;var gz=new qx.ui.menu.Button(di,cM);var gB=new qx.ui.menu.Button(w);var gA=new qx.ui.menu.Button(a);var gy=new qx.ui.menu.Button(r);gz.addListener(dL,this.debugButton);gB.addListener(dL,this.debugButton);gA.addListener(dL,this.debugButton);gy.addListener(dL,this.debugButton);gx.add(gz);gx.add(gB);gx.addSeparator();gx.add(gA);gx.addSeparator();gx.add(gy);return gx;}
,getList:function(){var gC=new qx.ui.form.List;gC.setContextMenu(this.getContextMenu());for(var i=0;i<20;i++ ){gC.add(new qx.ui.form.ListItem(da+i));}
;return gC;}
,getContextMenu:function(){var gD=new qx.ui.menu.Menu;var gF=new qx.ui.menu.Button(dJ,d,this.__Tp);var gG=new qx.ui.menu.Button(dy,dK,this.__Tq);var gE=new qx.ui.menu.Button(eq,z,this.__Tr);gF.addListener(dL,this.debugButton);gG.addListener(dL,this.debugButton);gE.addListener(dL,this.debugButton);gD.add(gF);gD.add(gG);gD.add(gE);return gD;}
},destruct:function(){this._disposeObjects(ej,b,v,eo,cN,m,V,cR);}
});}
)();
...
;this.__oB();}
,__oB:function(){if(this.isVisible()){if(this.getBlockBackground()){var V=this.getZIndex();this._blocker.blockContent(V-1);}
;}
...
,__oC:function(){var bn=this._getMenuBounds();if(!bn){this.addListenerOnce(o,this.__oC,this);return;}
...
;this.__oA=bp;qx.ui.core.queue.Widget.add(this);}
,syncWidget:function(bq){this.getChildControl(h);if(this.__oA){this.__oA.call(this);delete this.__oA;}
;}
...
;this.__oC();}
;}
,_onMouseOver:function(e){var bt=qx.ui.menu.Manager.getInstance();bt.cancelClose(this);var bu=e.getTarget();if(bu.isEnabled()&&bu instanceof qx.ui.menu.AbstractButton){this.setSelectedButton(bu);var bs=bu.getMenu&&bu.getMenu();if(bs){bs.setOpener(bu);bt.scheduleOpen(bs);this.__oz=bs;}
else {var bv=this.getOpenedButton();if(bv){bt.scheduleClose(bv.getMenu());}
;if(this.__oz){bt.cancelOpen(this.__oz);this.__oz=null;}
;}
;}
...
;if(this.__oz){bw.cancelOpen(this.__oz);}
;}
;}
...
(function(){var a="qx.ui.menu.Layout",b="Integer",c="_applyLayoutChange";qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:b,init:0,apply:c},spanColumn:{check:b,init:1,nullable:true,apply:c},iconColumnWidth:{check:b,init:0,themeable:true,apply:c},arrowColumnWidth:{check:b,init:0,themeable:true,apply:c}},members:{__oD:null,_computeSizeHint:function(){var q=this._getLayoutChildren();var o,g,k;var e=this.getSpanColumn();var j=this.__oD=[0,0,0,0];var n=this.getColumnSpacing();var m=0;var f=0;for(var i=0,l=q.length;i<l;i++ ){o=q[i];if(o.isAnonymous()){continue;}
...
,getColumnSizes:function(){return this.__oD||null;}
...
(function(){var a="blur",b="mousedown",c="Enter",d="Escape",f="Space",g="keydown",h="Left",j="__os",k="Up",l="singleton",m="__ot",n="mousewheel",o="interval",p="event.touch",q="Object is no menu: ",r="qx.ui.menu.Manager",s="keyup",t="__ou",u="keypress",v="Right",w="Down",x="qx.debug";qx.Class.define(r,{type:l,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__os=[];var y=document.body;var z=qx.event.Registration;z.addListener(window.document.documentElement,b,this._onMouseDown,this,true);z.addListener(y,n,this._onMouseWheel,this,true);z.addListener(y,g,this._onKeyUpDown,this,true);z.addListener(y,s,this._onKeyUpDown,this,true);z.addListener(y,u,this._onKeyPress,this,true);if(!qx.core.Environment.get(p)){qx.bom.Element.addListener(window,a,this.hideAll,this);}
;this.__ot=new qx.event.Timer;this.__ot.addListener(o,this._onOpenInterval,this);this.__ou=new qx.event.Timer;this.__ou.addListener(o,this._onCloseInterval,this);}
,members:{__ov:null,__ow:null,__ot:null,__ou:null,__os:null,_getChild:function(A,C,B,F){var E=A.getChildren();var length=E.length;var D;for(var i=C;i<length&&i>=0;i+=B){D=E[i];if(D.isEnabled()&&!D.isAnonymous()&&D.isVisible()){return D;}
;}
;if(F){i=i==length?0:length-1;for(;i!=C;i+=B){D=E[i];if(D.isEnabled()&&!D.isAnonymous()&&D.isVisible()){return D;}
;}
;}
;return null;}
,_isInMenu:function(G){while(G){if(G instanceof qx.ui.menu.Menu){return true;}
;G=G.getLayoutParent();}
;return false;}
,_isMenuOpener:function(I){var H=this.__os;for(var i=0;i<H.length;i++ ){if(H[i].getOpener()===I){return true;}
;}
;return false;}
,_getMenuButton:function(J){while(J){if(J instanceof qx.ui.menu.AbstractButton){return J;}
;J=J.getLayoutParent();}
;return null;}
,add:function(K){if(qx.core.Environment.get(x)){if(!(K instanceof qx.ui.menu.Menu)){throw new Error(q+K);}
;}
;var L=this.__os;L.push(K);K.setZIndex(1e6+L.length);}
,remove:function(M){if(qx.core.Environment.get(x)){if(!(M instanceof qx.ui.menu.Menu)){throw new Error(q+M);}
;}
;var N=this.__os;if(N){qx.lang.Array.remove(N,M);}
;}
,hideAll:function(){var O=this.__os;if(O){for(var i=O.length-1;i>=0;i-- ){O[i].exclude();}
;}
;}
,getActiveMenu:function(){var P=this.__os;return P.length>0?P[P.length-1]:null;}
,scheduleOpen:function(Q){this.cancelClose(Q);if(Q.isVisible()){if(this.__ov){this.cancelOpen(this.__ov);}
;}
else if(this.__ov!=Q){this.__ov=Q;this.__ot.restartWith(Q.getOpenInterval());}
;}
,scheduleClose:function(R){this.cancelOpen(R);if(!R.isVisible()){if(this.__ow){this.cancelClose(this.__ow);}
;}
else if(this.__ow!=R){this.__ow=R;this.__ou.restartWith(R.getCloseInterval());}
;}
,cancelOpen:function(S){if(this.__ov==S){this.__ot.stop();this.__ov=null;}
;}
,cancelClose:function(T){if(this.__ow==T){this.__ou.stop();this.__ow=null;}
;}
,_onOpenInterval:function(e){this.__ot.stop();this.__ov.open();this.__ov=null;}
,_onCloseInterval:function(e){this.__ou.stop();this.__ow.exclude();this.__ow=null;}
,_onMouseDown:function(e){var U=e.getTarget();U=qx.ui.core.Widget.getWidgetByElement(U,true);if(U==null){this.hideAll();return;}
;if(U.getMenu&&U.getMenu()&&U.getMenu().isVisible()){return;}
;if(this.__os.length>0&&!this._isInMenu(U)){this.hideAll();}
;}
,__ox:{"Enter":1,"Space":1},__mi:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var V=this.getActiveMenu();if(!V){return;}
;var W=e.getKeyIdentifier();if(this.__mi[W]||(this.__ox[W]&&V.getSelectedButton())){e.stopPropagation();}
;}
,_onKeyPress:function(e){var ba=this.getActiveMenu();if(!ba){return;}
;var X=e.getKeyIdentifier();var bc=this.__mi[X];var Y=this.__ox[X];if(bc){switch(X){case k:this._onKeyPressUp(ba);break;case w:this._onKeyPressDown(ba);break;case h:this._onKeyPressLeft(ba);break;case v:this._onKeyPressRight(ba);break;case d:this.hideAll();break;};e.stopPropagation();e.preventDefault();}
else if(Y){var bb=ba.getSelectedButton();if(bb){switch(X){case c:this._onKeyPressEnter(ba,bb,e);break;case f:this._onKeyPressSpace(ba,bb,e);break;};e.stopPropagation();e.preventDefault();}
;}
;}
,_onKeyPressUp:function(bh){var bd=bh.getSelectedButton();var be=bh.getChildren();var bf=bd?bh.indexOf(bd)-1:be.length-1;var bg=this._getChild(bh,bf,-1,true);if(bg){bh.setSelectedButton(bg);}
else {bh.resetSelectedButton();}
;}
,_onKeyPressDown:function(bi){var bj=bi.getSelectedButton();var bl=bj?bi.indexOf(bj)+1:0;var bk=this._getChild(bi,bl,1,true);if(bk){bi.setSelectedButton(bk);}
else {bi.resetSelectedButton();}
;}
,_onKeyPressLeft:function(bo){var bq=bo.getOpener();if(!bq){return;}
;if(bq instanceof qx.ui.menu.AbstractButton){var bn=bq.getLayoutParent();bn.resetOpenedButton();bn.setSelectedButton(bq);}
else if(bq instanceof qx.ui.menubar.Button){var br=bq.getMenuBar().getMenuButtons();var bm=br.indexOf(bq);if(bm===-1){return;}
;var bs=null;var length=br.length;for(var i=1;i<=length;i++ ){var bp=br[(bm-i+length)%length];if(bp.isEnabled()&&bp.isVisible()){bs=bp;break;}
;}
;if(bs&&bs!=bq){bs.open(true);}
;}
;}
,_onKeyPressRight:function(bw){var bu=bw.getSelectedButton();if(bu){var bt=bu.getMenu();if(bt){bw.setOpenedButton(bu);var bB=this._getChild(bt,0,1);if(bB){bt.setSelectedButton(bB);}
;return;}
;}
else if(!bw.getOpenedButton()){var bB=this._getChild(bw,0,1);if(bB){bw.setSelectedButton(bB);if(bB.getMenu()){bw.setOpenedButton(bB);}
;return;}
;}
;var by=bw.getOpener();if(by instanceof qx.ui.menu.Button&&bu){while(by){by=by.getLayoutParent();if(by instanceof qx.ui.menu.Menu){by=by.getOpener();if(by instanceof qx.ui.menubar.Button){break;}
;}
else {break;}
;}
;if(!by){return;}
;}
;if(by instanceof qx.ui.menubar.Button){var bz=by.getMenuBar().getMenuButtons();var bv=bz.indexOf(by);if(bv===-1){return;}
;var bA=null;var length=bz.length;for(var i=1;i<=length;i++ ){var bx=bz[(bv+i)%length];if(bx.isEnabled()&&bx.isVisible()){bA=bx;break;}
;}
;if(bA&&bA!=by){bA.open(true);}
;}
;}
,_onKeyPressEnter:function(bC,bD,e){if(bD.hasListener(u)){var bE=e.clone();bE.setBubbles(false);bE.setTarget(bD);bD.dispatchEvent(bE);}
;this.hideAll();}
,_onKeyPressSpace:function(bF,bG,e){if(bG.hasListener(u)){var bH=e.clone();bH.setBubbles(false);bH.setTarget(bG);bG.dispatchEvent(bH);}
;}
,_onMouseWheel:function(e){var bI=e.getTarget();bI=qx.ui.core.Widget.getWidgetByElement(bI,true);if(this.__os.length>0&&!this._isInMenu(bI)&&!this._isMenuOpener(bI)){this.hideAll();}
;}
},destruct:function(){var bK=qx.event.Registration;var bJ=document.body;bK.removeListener(window.document.documentElement,b,this._onMouseDown,this,true);bK.removeListener(bJ,g,this._onKeyUpDown,this,true);bK.removeListener(bJ,s,this._onKeyUpDown,this,true);bK.removeListener(bJ,u,this._onKeyPress,this,true);this._disposeObjects(m,t);this._disposeArray(j);}
});}
)();
...
(function(){var a="qx.ui.menu.ButtonLayout",b="qx.debug",c="column",d="left",e="middle",f="' is not supported by the MenuButton layout!",g="The property '";qx.Class.define(a,{extend:qx.ui.layout.Abstract,members:{verifyLayoutProperty:qx.core.Environment.select(b,{"true":function(h,name,j){this.assert(name==c,g+name+f);}
,"false":null}),renderLayout:function(o,r,k){var y=this._getLayoutChildren();var m;var u;var q=[];for(var i=0,l=y.length;i<l;i++ ){m=y[i];u=m.getLayoutProperties().column;q[u]=m;}
;var x=this.__oE(y[0]);var w=x.getColumnSizes();var s=x.getSpacingX();var z=qx.lang.Array.sum(w)+s*(w.length-1);if(z<o){w[1]+=o-z;}
;var A=k.left,top=k.top;var t=qx.ui.layout.Util;for(var i=0,l=w.length;i<l;i++ ){m=q[i];if(m){var p=m.getSizeHint();var n=top+t.computeVerticalAlignOffset(m.getAlignY()||e,p.height,r,0,0);var v=t.computeHorizontalAlignOffset(m.getAlignX()||d,p.width,w[i],m.getMarginLeft(),m.getMarginRight());m.renderLayout(A+v,n,p.width,p.height);}
;if(w[i]>0){A+=w[i]+s;}
;}
;}
,__oE:function(B){while(!(B instanceof qx.ui.menu.Menu)){B=B.getLayoutParent();}
;return B;}
,_computeSizeHint:function(){var E=this._getLayoutChildren();var D=0;var F=0;for(var i=0,l=E.length;i<l;i++ ){var C=E[i].getSizeHint();F+=C.width;D=Math.max(D,C.height);}
...
;return null;}
,open:function(l){qx.ui.form.MenuButton.prototype.open.call(this,l);var menubar=this.getMenuBar();if(menubar){menubar._setAllowMenuOpenHover(true);}
;}
...
;var P=K.getMarginLeft()+K.getMarginRight();P=Math.max(P,this.getSpacing());var J=K.getSizeHint().width+P;this.__oM(K);G-=J;if(E&&E.getVisibility()!=o){E.setVisibility(o);G+=L;var H=E.getMarginLeft()+E.getMarginRight();G+=Math.max(H,this.getSpacing());}
;}
while(G>F);}
else if(this.__oJ.length>0){do {var Q=this.__oJ[0];if(Q){var P=Q.getMarginLeft()+Q.getMarginRight();P=Math.max(P,this.getSpacing());if(Q.getContentElement().getDomElement()==null){Q.syncAppearance();Q.invalidateLayoutCache();}
;var I=Q.getSizeHint().width;var O=false;if(this.__oJ.length==1&&L>0){var N=P-this.getSpacing();var M=G-L+I+N;O=F>M;}
;if(F>G+I+P||O){this.__oL(Q);G+=I;if(E&&this.__oJ.length==0){E.setVisibility(y);}
;}
else {return;}
;}
;}
while(F>=G&&this.__oJ.length>0);}
;}
,__oL:function(R){R.setVisibility(o);this.__oJ.shift();this.fireDataEvent(m,R);}
,__oM:function(S){if(!S){return;}
;this.__oJ.unshift(S);S.setVisibility(y);this.fireDataEvent(A,S);}
,_getNextToHide:function(){for(var i=this.__oK.length-1;i>=0;i-- ){var T=this.__oK[i];if(T&&T.getVisibility&&T.getVisibility()==o){return T;}
;}
...
;}
;}
,setRemovePriority:function(X,W,Y){if(!Y&&this.__oK[W]!=undefined){throw new Error(v);}
;this.__oK[W]=X;}
...
;for(var i=0;i<this.__oJ.length;i++ ){this.__oJ[i].setVisibility(o);}
;this.__oJ=[];}
;}
...
;bf.setVisibility(y);}
;}
,__oN:false,_setAllowMenuOpenHover:function(bg){this.__oN=bg;}
...
,__oO:function(){var y=this.getChildrenContainer().getChildren();y=y.filter(function(z){return z.getVisibility()==k;}
...
(function(){var a="hovered",b="hover-button",c="__ij",d="interval",f="mouseover",g="mouseout",h="qx.ui.form.HoverButton",i="Integer";qx.Class.define(h,{extend:qx.ui.basic.Atom,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(j,k){qx.ui.basic.Atom.call(this,j,k);this.addListener(f,this._onMouseOver,this);this.addListener(g,this._onMouseOut,this);this.__ij=new qx.event.AcceleratingTimer();this.__ij.addListener(d,this._onInterval,this);}
,properties:{appearance:{refine:true,init:b},interval:{check:i,init:80},firstInterval:{check:i,init:200},minTimer:{check:i,init:20},timerDecrease:{check:i,init:2}},members:{__ij:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;}
;this.__ij.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();this.addState(a);}
,_onMouseOut:function(e){this.__ij.stop();this.removeState(a);if(!this.isEnabled()||e.getTarget()!==this){return;}
;}
...
(function(){var b="-",c="PageUp",d="Escape",f="Boolean",g="+",h="qx.event.type.Data",j="_applyShortcut",k="PrintScreen",l="NumLock",m="short",n="keydown",o="5",p="8",q="execute",r="Meta",s="0",t="",u="2",v="Control",w="Shift",x="You can only specify one non modifier key!",y="3",z="Unidentified",A="/",B="Delete",C="String",D="changeEnabled",E="*",F="qx.bom.Shortcut",G="6",H="4",I="1",J="Alt",K="Not a valid key name for a shortcut: ",L="PageDown",M="Whitespaces are not allowed within shortcuts",N="_applyEnabled",O="keypress",P="7",Q="a",R="z",S="9";qx.Class.define(F,{extend:qx.core.Object,construct:function(T){qx.core.Object.call(this);this.__Au={};this.__Av=null;if(T!=null){this.setShortcut(T);}
;this.initEnabled();}
,events:{"execute":h},properties:{enabled:{init:true,check:f,event:D,apply:N},shortcut:{check:C,apply:j,nullable:true},autoRepeat:{check:f,init:false}},members:{__Au:t,__Av:t,execute:function(U){this.fireDataEvent(q,U);}
,__Aw:function(event){if(this.getEnabled()&&this.__Ax(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,__gY:function(event){if(this.getEnabled()&&this.__Ax(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());}
;event.stop();}
;}
,_applyEnabled:function(W,V){if(W){qx.event.Registration.addListener(document.documentElement,n,this.__Aw,this);qx.event.Registration.addListener(document.documentElement,O,this.__gY,this);}
else {qx.event.Registration.removeListener(document.documentElement,n,this.__Aw,this);qx.event.Registration.removeListener(document.documentElement,O,this.__gY,this);}
;}
,_applyShortcut:function(bb,Y){if(bb){if(bb.search(/[\s]+/)!=-1){var bc=M;this.error(bc);throw new Error(bc);}
;this.__Au={"Control":false,"Shift":false,"Meta":false,"Alt":false};this.__Av=null;var X;var a=[];while(bb.length>0&&X!=-1){X=bb.search(/[-+]+/);a.push((bb.length==1||X==-1)?bb:bb.substring(0,X));bb=bb.substring(X+1);}
;var ba=a.length;for(var i=0;i<ba;i++ ){var bd=this.__Az(a[i]);switch(bd){case v:case w:case r:case J:this.__Au[bd]=true;break;case z:var bc=K+a[i];this.error(bc);throw bc;default:if(this.__Av){var bc=x;this.error(bc);throw bc;}
;this.__Av=bd;};}
;}
;return true;}
,__Ax:function(e){var be=this.__Av;if(!be){return false;}
;if((!this.__Au.Shift&&e.isShiftPressed())||(this.__Au.Shift&&!e.isShiftPressed())||(!this.__Au.Control&&e.isCtrlPressed())||(this.__Au.Control&&!e.isCtrlPressed())||(!this.__Au.Meta&&e.isMetaPressed())||(this.__Au.Meta&&!e.isMetaPressed())||(!this.__Au.Alt&&e.isAltPressed())||(this.__Au.Alt&&!e.isAltPressed())){return false;}
;if(be==e.getKeyIdentifier()){return true;}
;return false;}
,__Ay:{esc:d,ctrl:v,print:k,del:B,pageup:c,pagedown:L,numlock:l,numpad_0:s,numpad_1:I,numpad_2:u,numpad_3:y,numpad_4:H,numpad_5:o,numpad_6:G,numpad_7:P,numpad_8:p,numpad_9:S,numpad_divide:A,numpad_multiply:E,numpad_minus:b,numpad_plus:g},__Az:function(bg){var bf=qx.event.util.Keyboard;var bh=z;if(bf.isValidKeyIdentifier(bg)){return bg;}
;if(bg.length==1&&bg>=Q&&bg<=R){return bg.toUpperCase();}
;bg=bg.toLowerCase();var bh=this.__Ay[bg]||qx.lang.String.firstUp(bg);if(bf.isValidKeyIdentifier(bh)){return bh;}
else {return z;}
;}
,toString:function(){var bj=this.__Av;var bk=[];for(var bi in this.__Au){if(this.__Au[bi]){bk.push(qx.locale.Key.getKeyName(m,bi));}
;}
;if(bj){bk.push(qx.locale.Key.getKeyName(m,bj));}
;return bk.join(g);}
},destruct:function(){this.setEnabled(false);this.__Au=this.__Av=null;}
});}
)();
...
(function(){var a=" array contains ",b="__eQ",c="qx.ui.core.MSingleSelectionHandling",d=" items!",f="changeSelection",g="changeSelected",h="Could only select one item, but the selection",i="qx.event.type.Data";qx.Mixin.define(c,{events:{"changeSelection":i},members:{__eQ:null,getSelection:function(){var j=this.__nM().getSelected();if(j){return [j];}
else {return [];}
;}
,setSelection:function(k){switch(k.length){case 0:this.resetSelection();break;case 1:this.__nM().setSelected(k[0]);break;default:throw new Error(h+a+k.length+d);};}
,resetSelection:function(){this.__nM().resetSelected();}
,isSelected:function(l){return this.__nM().isSelected(l);}
,isSelectionEmpty:function(){return this.__nM().isSelectionEmpty();}
,getSelectables:function(m){return this.__nM().getSelectables(m);}
,_onChangeSelected:function(e){var o=e.getData();var n=e.getOldData();o==null?o=[]:o=[o];n==null?n=[]:n=[n];this.fireDataEvent(f,o,n);}
,__nM:function(){if(this.__eQ==null){var p=this;this.__eQ=new qx.ui.core.SingleSelectionManager({getItems:function(){return p._getItems();}
,isItemSelectable:function(q){if(p._isItemSelectable){return p._isItemSelectable(q);}
else {return q.isVisible();}
;}
});this.__eQ.addListener(g,this._onChangeSelected,this);}
;this.__eQ.setAllowEmptySelection(this._isAllowEmptySelection());return this.__eQ;}
},destruct:function(){this._disposeObjects(b);}
});}
)();
(function(){var a=", because it is not a child element!",b="Boolean",c="qx.ui.core.SingleSelectionManager",d="qx.debug",e="__nN",f="Invalid selectionProvider!",g="Could not check if ",h=" is selected,",j="Could not select ",k="__nO",l="__nP",m="changeSelected",n=" because it is not a child element!",o="qx.event.type.Data";qx.Class.define(c,{extend:qx.core.Object,construct:function(p){qx.core.Object.call(this);if(qx.core.Environment.get(d)){qx.core.Assert.assertInterface(p,qx.ui.core.ISingleSelectionProvider,f);}
;this.__nN=p;}
,events:{"changeSelected":o},properties:{allowEmptySelection:{check:b,init:true,apply:l}},members:{__nO:null,__nN:null,getSelected:function(){return this.__nO;}
,setSelected:function(q){if(!this.__nR(q)){throw new Error(j+q+a);}
;this.__nQ(q);}
,resetSelected:function(){this.__nQ(null);}
,isSelected:function(r){if(!this.__nR(r)){throw new Error(g+r+h+n);}
;return this.__nO===r;}
,isSelectionEmpty:function(){return this.__nO==null;}
,getSelectables:function(t){var s=this.__nN.getItems();var u=[];for(var i=0;i<s.length;i++ ){if(this.__nN.isItemSelectable(s[i])){u.push(s[i]);}
;}
;if(!t){for(var i=u.length-1;i>=0;i-- ){if(!u[i].getEnabled()){u.splice(i,1);}
;}
;}
;return u;}
,__nP:function(w,v){if(!w){this.__nQ(this.__nO);}
;}
,__nQ:function(x){var A=this.__nO;var y=x;if(y!=null&&A===y){return;}
;if(!this.isAllowEmptySelection()&&y==null){var z=this.getSelectables(true)[0];if(z){y=z;}
;}
;this.__nO=y;this.fireDataEvent(m,y,A);}
,__nR:function(B){var C=this.__nN.getItems();for(var i=0;i<C.length;i++ ){if(C[i]===B){return true;}
;}
;return false;}
},destruct:function(){if(this.__nN.toHashCode){this._disposeObjects(e);}
else {this.__nN=null;}
...
,pop:function(){var y=this.__mS.pop();this.__mT();this._registerEventChaining(null,y,this.length-1);this.fireDataEvent(r,{value:[],name:this.length+f,old:[y],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:g,removed:[y],added:[]},null);return y;}
,push:function(z){for(var i=0;i<arguments.length;i++ ){this.__mS.push(arguments[i]);this.__mT();this._registerEventChaining(arguments[i],null,this.length-1);this.fireDataEvent(r,{value:[arguments[i]],name:(this.length-1)+f,old:[],item:this});this.fireDataEvent(o,{start:this.length-1,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,reverse:function(){if(this.length==0){return;}
;var A=this.__mS.concat();this.__mS.reverse();this.__mU(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__mS,name:n+(this.__mS.length-1),old:A,item:this});}
,shift:function(){if(this.length==0){return;}
;var B=this.__mS.shift();this.__mT();this._registerEventChaining(null,B,this.length-1);this.__mU(0,this.length);this.fireDataEvent(r,{value:[],name:p,old:[B],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:g,removed:[B],added:[]},null);return B;}
,slice:function(D,C){return new qx.data.Array(this.__mS.slice(D,C));}
,splice:function(I,K,M){var P=this.__mS.length;var L=this.__mS.splice.apply(this.__mS,arguments);if(this.__mS.length!=P){this.__mT();}
...
;this.__mU(I+(arguments.length-2)-K,this.length);var J=[];for(var i=2;i<arguments.length;i++ ){J[i-2]=arguments[i];}
...
;var Q=this.__mS.concat();this.__mS.sort.apply(this.__mS,arguments);if(qx.lang.Array.equals(this.__mS,Q)===true){return;}
;this.__mU(0,this.length);this.fireDataEvent(o,{start:0,end:this.length-1,type:c,added:[],removed:[]},null);this.fireDataEvent(r,{value:this.__mS,name:n+(this.length-1),old:Q,item:this});}
,unshift:function(S){for(var i=arguments.length-1;i>=0;i-- ){this.__mS.unshift(arguments[i]);this.__mT();this.__mU(0,this.length);this.fireDataEvent(r,{value:[this.__mS[0]],name:p,old:[this.__mS[1]],item:this});this.fireDataEvent(o,{start:0,end:this.length-1,type:b,added:[arguments[i]],removed:[]},null);}
;return this.length;}
,toArray:function(){return this.__mS;}
,getItem:function(T){return this.__mS[T];}
,setItem:function(U,W){var V=this.__mS[U];if(V===W){return;}
;this.__mS[U]=W;this._registerEventChaining(W,V,U);if(this.length!=this.__mS.length){this.__mT();}
...
,indexOf:function(X){return this.__mS.indexOf(X);}
,lastIndexOf:function(Y){return this.__mS.lastIndexOf(Y);}
,toString:function(){if(this.__mS!=null){return this.__mS.toString();}
;return f;}
,contains:function(ba){return this.__mS.indexOf(ba)!==-1;}
...
;var bn=this.getLength();var bm=this.__mS.concat();this.__mS.length=0;this.__mT();this.fireDataEvent(r,{value:[],name:n+(bn-1),old:bm,item:this});this.fireDataEvent(o,{start:0,end:bn-1,type:g,removed:bm,added:[]},null);return bm;}
...
;Array.prototype.push.apply(this.__mS,bo);for(var i=0;i<bo.length;i++ ){this._registerEventChaining(bo[i],null,this.__mS.length+i);}
;var bp=this.length;this.__mT();var name=bp==(this.length-1)?bp:bp+a+(this.length-1);this.fireDataEvent(r,{value:bo,name:name+f,old:[],item:this});this.fireDataEvent(o,{start:bp,end:this.length-1,type:b,added:bo,removed:[]},null);}
...
,forEach:function(bw,bx){for(var i=0;i<this.__mS.length;i++ ){bw.call(bx,this.__mS[i],i,this);}
;}
,filter:function(by,self){return new qx.data.Array(this.__mS.filter(by,self));}
,map:function(bz,self){return new qx.data.Array(this.__mS.map(bz,self));}
,some:function(bA,self){return this.__mS.some(bA,self);}
,every:function(bB,self){return this.__mS.every(bB,self);}
,reduce:function(bD,bC){return this.__mS.reduce(bD,bC);}
,reduceRight:function(bF,bE){return this.__mS.reduceRight(bF,bE);}
,__mT:function(){var bG=this.length;this.length=this.__mS.length;this.fireDataEvent(s,this.length,bG);}
,__mU:function(bI,bH){for(var i=bI;i<bH;i++ ){this._registerEventChaining(this.__mS[i],this.__mS[i],i);}
;}
},destruct:function(){for(var i=0;i<this.__mS.length;i++ ){var bJ=this.__mS[i];this._applyEventPropagation(null,bJ,i);if(this.isAutoDisposeItems()&&bJ&&bJ instanceof qx.core.Object){bJ.dispose();}
;}
;this.__mS=null;}
});}
)();
...
;}
,remove:function(w){var x=this.__nS;if(qx.lang.Array.contains(x,w)){qx.lang.Array.remove(x,w);if(w.getGroup()===this){w.resetGroup();}
;w.removeListener(p,this._onItemChangeChecked,this);if(w.getValue()){this.resetSelection();}
;}
;}
,getChildren:function(){return this.__nS;}
...
;}
,_applyInvalidMessage:function(A,z){for(var i=0;i<this.__nS.length;i++ ){this.__nS[i].setInvalidMessage(A);}
;}
,_applyValid:function(C,B){for(var i=0;i<this.__nS.length;i++ ){this.__nS[i].setValid(C);}
;}
,_applyEnabled:function(F,E){var D=this.__nS;if(F==null){for(var i=0,l=D.length;i<l;i++ ){D[i].resetEnabled();}
;}
...
;}
,selectNext:function(){var J=this.getSelection()[0];var K=this.__nS;var I=K.indexOf(J);if(I==-1){return;}
...
,selectPrevious:function(){var M=this.getSelection()[0];var N=this.__nS;var L=N.indexOf(M);if(L==-1){return;}
...
,_isItemSelectable:function(O){return this.__nS.indexOf(O)!=-1;}
,__nT:function(e){var Q=e.getData()[0];var P=e.getOldData()[0];if(P){P.setValue(false);}
...
(function(){var a="splitbutton",b="hovered",c="Enter",d="pressed",f="changeShow",g="mouseout",h="Space",i="keydown",j="abandoned",k="both",l="button",m="execute",n="_applyMenu",o="arrow",p="String",q="icon",r="changeVisibility",s="mouseover",t="keyup",u="qx.ui.menu.Menu",v="_applyIcon",w="label",x="_applyShow",y="changeMenu",z="_applyLabel",A="qx.ui.form.SplitButton";qx.Class.define(A,{extend:qx.ui.core.Widget,include:[qx.ui.core.MExecutable],implement:[qx.ui.form.IExecutable],construct:function(E,C,B,D){qx.ui.core.Widget.call(this);this._setLayout(new qx.ui.layout.HBox);this._createChildControl(o);this.addListener(s,this._onMouseOver,this,true);this.addListener(g,this._onMouseOut,this,true);this.addListener(i,this._onKeyDown);this.addListener(t,this._onKeyUp);if(E!=null){this.setLabel(E);}
;if(C!=null){this.setIcon(C);}
;if(B!=null){this.setMenu(B);}
;if(D!=null){this.setCommand(D);}
;}
,properties:{appearance:{refine:true,init:a},focusable:{refine:true,init:true},label:{apply:z,nullable:true,check:p},icon:{check:p,apply:v,nullable:true,themeable:true},show:{init:k,check:[k,w,q],themeable:true,inheritable:true,apply:x,event:f},menu:{check:u,nullable:true,apply:n,event:y}},members:{__vO:null,_createChildControlImpl:function(H,G){var F;switch(H){case l:F=new qx.ui.form.Button;F.addListener(m,this._onButtonExecute,this);F.setFocusable(false);this._addAt(F,0,{flex:1});break;case o:F=new qx.ui.form.MenuButton();F.setFocusable(false);F.setShow(k);this._addAt(F,1);break;};return F||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
,_forwardStates:{hovered:1,focused:1},_applyLabel:function(K,J){var I=this.getChildControl(l);K==null?I.resetLabel():I.setLabel(K);}
,_applyIcon:function(N,M){var L=this.getChildControl(l);N==null?L.resetIcon():L.setIcon(N);}
,_applyMenu:function(P,O){var Q=this.getChildControl(o);if(P){Q.resetEnabled();Q.setMenu(P);P.setOpener(this);P.addListener(r,this._onChangeMenuVisibility,this);}
else {Q.setEnabled(false);Q.resetMenu();}
;if(O){O.removeListener(r,this._onChangeMenuVisibility,this);O.resetOpener();}
;}
,_applyShow:function(S,R){}
,_onMouseOver:function(e){e.stopPropagation();this.addState(b);delete this.__vO;}
,_onMouseOut:function(e){e.stopPropagation();if(!this.hasState(b)){return;}
;var U=e.getRelatedTarget();if(qx.ui.core.Widget.contains(this,U)){return;}
;var T=this.getMenu();if(T&&T.isVisible()){this.__vO=true;return;}
;this.removeState(b);}
,_onKeyDown:function(e){var V=this.getChildControl(l);switch(e.getKeyIdentifier()){case c:case h:V.removeState(j);V.addState(d);};}
,_onKeyUp:function(e){var W=this.getChildControl(l);switch(e.getKeyIdentifier()){case c:case h:if(W.hasState(d)){W.removeState(j);W.removeState(d);W.execute();}
;};}
,_onButtonExecute:function(e){this.execute();}
,_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__vO){this.removeState(b);}
;}
}});}
)();
(function(){var a="arrow",b="qx.ui.toolbar.SplitButton",c="keydown",d="toolbar-splitbutton",e="button",f="keyup",g="execute";qx.Class.define(b,{extend:qx.ui.form.SplitButton,construct:function(k,i,h,j){qx.ui.form.SplitButton.call(this,k,i,h,j);this.removeListener(c,this._onKeyDown);this.removeListener(f,this._onKeyUp);}
,properties:{appearance:{refine:true,init:d},focusable:{refine:true,init:false}},members:{_forwardStates:{hovered:true,focused:true,left:true,middle:true,right:true},_createChildControlImpl:function(n,m){var l;switch(n){case e:l=new qx.ui.toolbar.Button;l.addListener(g,this._onButtonExecute,this);this._addAt(l,0);break;case a:l=new qx.ui.toolbar.MenuButton;this._addAt(l,1);break;};return l||qx.ui.form.SplitButton.prototype._createChildControlImpl.call(this,n);}
}});}
)();
...
;throw new Error(n);}
,getSelection:function(){return qx.lang.Object.getValues(this.__eU);}
,getSortedSelection:function(){var bS=this.getSelectables();var bR=qx.lang.Object.getValues(this.__eU);bR.sort(function(a,b){return bS.indexOf(a)-bS.indexOf(b);}
);return bR;}
,isItemSelected:function(bT){var bU=this._selectableToHashCode(bT);return this.__eU[bU]!==undefined;}
,isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__eU);}
...
;this.__me=bY;}
,getLeadItem:function(){return this.__me;}
...
;}
,_clearSelection:function(){var dh=this.__eU;for(var di in dh){this._removeFromSelection(dh[di]);}
;this.__eU={};}
,_selectItemRange:function(dj,dn,dl){var dp=this._getSelectableRange(dj,dn);if(!dl){var dm=this.__eU;var dq=this.__mj(dp);for(var dk in dm){if(!dq[dk]){this._removeFromSelection(dm[dk]);}
;}
;}
...
;return dw;}
,_getSelectedItem:function(){for(var dx in this.__eU){return this.__eU[dx];}
;return null;}
,_setSelectedItem:function(dz){if(this._isSelectable(dz)){var dy=this.__eU;var dA=this._selectableToHashCode(dz);if(!dy[dA]||(dy.length>=2)){this._clearSelection();this._addToSelection(dz);}
;}
;}
,_addToSelection:function(dB){var dC=this._selectableToHashCode(dB);if(this.__eU[dC]==null&&this._isSelectable(dB)){this.__eU[dC]=dB;this._styleSelectable(dB,P,true);this.__mc=true;}
;}
,_toggleInSelection:function(dD){var dE=this._selectableToHashCode(dD);if(this.__eU[dE]==null){this.__eU[dE]=dD;this._styleSelectable(dD,P,true);}
else {delete this.__eU[dE];this._styleSelectable(dD,P,false);}
;this.__mc=true;}
,_removeFromSelection:function(dF){var dG=this._selectableToHashCode(dF);if(this.__eU[dG]!=null){delete this.__eU[dG];this._styleSelectable(dF,P,false);this.__mc=true;}
;}
,_replaceMultiSelection:function(dJ){if(dJ.length===0){this.clearSelection();return;}
;var dK=false;var dN,dM;var dI={};for(var i=0,l=dJ.length;i<l;i++ ){dN=dJ[i];if(this._isSelectable(dN)){dM=this._selectableToHashCode(dN);dI[dM]=dN;}
;}
;var dO=dJ[0];var dH=dN;var dL=this.__eU;for(var dM in dL){if(dI[dM]){delete dI[dM];}
...
;return dR;}
;return null;}
},destruct:function(){this._disposeObjects(bt);this.__eU=this.__mg=this.__mf=null;this.__me=null;}
});}
)();
...
(function(){var a="mousedown",b="Boolean",c="one",d="qx.event.type.Data",f=", because it is not a child element!",g="_applyDragSelection",h="Could not add + ",j="mousemove",k="changeSelection",l="Could not test if ",m="Could not remove ",n="addItem",o=" from selection, because it is not a child element!",p="multi",q="_applyQuickSelection",r="single",s="mouseover",t="__eQ",u=" is selected, because it is not a child element!",v="_applySelectionMode",w="additive",x="mouseup",y="keypress",z="losecapture",A="Could not select ",B="removeItem",C=" to selection, because it is not a child element!",D="qx.ui.core.MMultiSelectionHandling";qx.Mixin.define(D,{construct:function(){var F=this.SELECTION_MANAGER;var E=this.__eQ=new F(this);this.addListener(a,E.handleMouseDown,E);this.addListener(x,E.handleMouseUp,E);this.addListener(s,E.handleMouseOver,E);this.addListener(j,E.handleMouseMove,E);this.addListener(z,E.handleLoseCapture,E);this.addListener(y,E.handleKeyPress,E);this.addListener(n,E.handleAddItem,E);this.addListener(B,E.handleRemoveItem,E);E.addListener(k,this._onSelectionChange,this);}
,events:{"changeSelection":d},properties:{selectionMode:{check:[r,p,w,c],init:r,apply:v},dragSelection:{check:b,init:false,apply:g},quickSelection:{check:b,init:false,apply:q}},members:{__eQ:null,selectAll:function(){this.__eQ.selectAll();}
,isSelected:function(G){if(!qx.ui.core.Widget.contains(this,G)){throw new Error(l+G+u);}
;return this.__eQ.isItemSelected(G);}
,addToSelection:function(H){if(!qx.ui.core.Widget.contains(this,H)){throw new Error(h+H+C);}
;this.__eQ.addItem(H);}
,removeFromSelection:function(I){if(!qx.ui.core.Widget.contains(this,I)){throw new Error(m+I+o);}
;this.__eQ.removeItem(I);}
,selectRange:function(J,K){this.__eQ.selectItemRange(J,K);}
,resetSelection:function(){this.__eQ.clearSelection();}
,setSelection:function(L){for(var i=0;i<L.length;i++ ){if(!qx.ui.core.Widget.contains(this,L[i])){throw new Error(A+L[i]+f);}
;}
;if(L.length===0){this.resetSelection();}
else {var M=this.getSelection();if(!qx.lang.Array.equals(M,L)){this.__eQ.replaceSelection(L);}
;}
;}
,getSelection:function(){return this.__eQ.getSelection();}
,getSortedSelection:function(){return this.__eQ.getSortedSelection();}
,isSelectionEmpty:function(){return this.__eQ.isSelectionEmpty();}
,getSelectionContext:function(){return this.__eQ.getSelectionContext();}
,_getManager:function(){return this.__eQ;}
,getSelectables:function(N){return this.__eQ.getSelectables(N);}
,invertSelection:function(){this.__eQ.invertSelection();}
,_getLeadItem:function(){var O=this.__eQ.getMode();if(O===r||O===c){return this.__eQ.getSelectedItem();}
else {return this.__eQ.getLeadItem();}
;}
,_applySelectionMode:function(Q,P){this.__eQ.setMode(Q);}
,_applyDragSelection:function(S,R){this.__eQ.setDrag(S);}
,_applyQuickSelection:function(U,T){this.__eQ.setQuick(U);}
...
(function(){var a="qx.ui.form.List",b="text",c="Boolean",d="one",f="addChildWidget",g="_applySpacing",h="Enter",j="Integer",k="action",m="keyinput",n="qx.event.type.Data",o="addItem",p="__nt",q="vertical",r="removeChildWidget",s="",t="_applyOrientation",u="single",v="keypress",w="list",x="horizontal",y="label",z="pane",A="removeItem";qx.Class.define(a,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(B){qx.ui.core.scroll.AbstractScrollArea.call(this);this.__nt=this._createListItemContainer();this.__nt.addListener(f,this._onAddChild,this);this.__nt.addListener(r,this._onRemoveChild,this);this.getChildControl(z).add(this.__nt);if(B){this.setOrientation(x);}
else {this.initOrientation();}
;this.addListener(v,this._onKeyPress);this.addListener(m,this._onKeyInput);this.__Bh=s;}
,events:{addItem:n,removeItem:n},properties:{appearance:{refine:true,init:w},focusable:{refine:true,init:true},orientation:{check:[x,q],init:q,apply:t},spacing:{check:j,init:0,apply:g,themeable:true},enableInlineFind:{check:c,init:true}},members:{__Bh:null,__Bi:null,__nt:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__nt;}
...
,_applyOrientation:function(F,C){var D=F===x;var E=D?new qx.ui.layout.HBox():new qx.ui.layout.VBox();var content=this.__nt;content.setLayout(E);content.setAllowGrowX(!D);content.setAllowGrowY(D);this._applySpacing(this.getSpacing());}
,_applySpacing:function(H,G){this.__nt.getLayout().setSpacing(H);}
...
;if(((new Date).valueOf()-this.__Bi)>1000){this.__Bh=s;}
;this.__Bh+=e.getChar();var K=this.findItemByLabelFuzzy(this.__Bh);if(K){this.setSelection([K]);}
;this.__Bi=(new Date).valueOf();}
