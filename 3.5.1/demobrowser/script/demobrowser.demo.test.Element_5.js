...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Element_5.5be4d461e610.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="backgroundColor",b="col",c="2px",d="fontSize",e="width",f="red",g="height",h="row",k="marginBottom",l="12px",m="1px",n="demobrowser.demo.test.Element_5",o="marginRight",p="left",q="clear",r="float",s="test",t="2px solid black",u="id",v="border";qx.Class.define(n,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var w=new qx.html.Root(document.getElementById(s));var x=new qx.html.Element;x.setStyle(r,p);x.setStyle(v,t);x.setStyle(d,m);w.add(x);var z,y;for(var i=0;i<40;i++ ){z=new qx.html.Element;z.setAttribute(u,h+i);z.setStyle(k,c);z.setStyle(r,p);z.setStyle(q,p);x.add(z);for(var j=0;j<40;j++ ){y=new qx.html.Element;y.setAttribute(u,h+i+b+j);y.setStyle(o,c);y.setStyle(r,p);y.setStyle(e,l);y.setStyle(g,l);y.setStyle(a,f);z.add(y);}
;}
;}
}});}
)();
