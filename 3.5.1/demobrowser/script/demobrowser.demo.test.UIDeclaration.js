...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.UIDeclaration.05d7f426c16f.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,addFromDefinition:function(F){var G=this.getRoot();this.__Bz(G,F);}
,__Bz:function(M,H){var I=new H.clazz();var L=qx.lang.Object.clone(H);delete L.clazz;delete L.layout;delete L.children;delete L.id;delete L.listeners;I.set(L);if(H.id!=null){this[H.id]=I;}
;if(H.layout!=null){var J=new H.layout.clazz();var L=qx.lang.Object.clone(H.layout);delete L.clazz;J.set(L);I.setLayout(J);}
;var N=H.children;if(N!=null){for(var i=0;i<N.length;i++ ){if(I instanceof qx.ui.form.Form){this.__SH(I,N[i]);}
else {this.__Bz(I,N[i]);}
;}
;}
...
;}
;}
,__SH:function(Q,O){if(O.type===v){Q.addGroupHeader(O.label);return;}
