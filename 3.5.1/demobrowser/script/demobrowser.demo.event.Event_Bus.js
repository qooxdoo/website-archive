...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bus.9f28a6478b60.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__RN=f+p.join(c)+a;this.__RO=o||50;this.__RP=n;this._clearLog();}
,_clearLog:function(){this.__RP.innerHTML=this.__RN+j;this.__RQ=[];}
,_log:function(q){this.__RQ.unshift(q);this.__RQ=this.__RQ.slice(0,this.__RO);var r=[this.__RN];for(var i=0;i<this.__RQ.length;i++ ){r.push(g,this.__RQ[i].join(e),l);}
;r.push(j);this.__RP.innerHTML=r.join(d);this.__RP.scrollTop=0;}
,__RN:null,__RO:null,__RP:null,__RQ:null},destruct:function(){this.__RP=this.__RQ=null;}
});}
)();
...
},construct:function(){this.__DP={};}
,members:{__DP:null,getSubscriptions:function(){return this.__DP;}
...
;}
;return false;}
,dispatch:function(L){var G=this.getSubscriptions();var H=L.getName();var I=false;for(var K in G){var J=K.indexOf(c);if(J>-1){if(J===0||K.substr(0,J)===H.substr(0,J)){this.__DQ(G[K],L);I=true;}
;}
else {if(K===H){this.__DQ(G[H],L);I=true;}
;}
;}
;return I;}
,dispatchByName:function(name,N){var M=new qx.event.message.Message(name,N);return this.dispatch(M);}
,__DQ:function(P,O){for(var i=0;i<P.length;i++ ){var R=P[i].subscriber;var Q=P[i].context;if(Q&&Q.isDisposed){if(Q.isDisposed()){P.splice(i,1);i-- ;}
else {R.call(Q,O);}
;}
else {R.call(Q,O);}
;}
