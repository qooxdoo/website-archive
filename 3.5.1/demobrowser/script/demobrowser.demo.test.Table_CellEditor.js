...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellEditor.4fa0000f4191.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__Kn={};}
,properties:{cellEditorFactoryFunction:{check:a,nullable:true,init:null}},members:{__qj:null,__Kn:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();if(qx.core.Environment.get(c)){this.assertFunction(g,b);}
;this.__qj=g(f);var h=this.__qj.createCellEditor(f);this.__Kn[h.toHashCode()]=f;return h;}
...
;var i=this.__Kn[k.toHashCode()];this.__qj=j(i);var l=this.__qj.getCellEditorValue(k);return l;}
