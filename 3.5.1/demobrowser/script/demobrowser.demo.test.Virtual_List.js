...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Virtual_List.f16ffadec764.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="Boolean",b="one",c="selected",d="_applySpacing",f="qx.event.type.Data",g="Integer",h="_applyDragSelection",k="changeSelection",m="String",n="resize",o="demobrowser.demo.virtual.list.List",p="list",q="multi",r="row",s="_applyQuickSelection",t="single",u="_applyItemHeight",v="_applySelectionMode",w="additive",x="changeName",y="Number",z="addItem",A="removeItem",B="changeHeight",C=",";qx.Class.define(o,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);this.__SJ=new qx.ui.virtual.layer.WidgetCell(this);this.getPane().addLayer(this.__SJ);this.getPane().addListener(n,this._onResize,this);this.__nS=[];this.__cL=[];this.__og=new qx.ui.virtual.selection.Row(this.getPane());this.__og.addListener(k,this._onChangeSelection,this);this.__og.attachMouseEvents();this.__og.attachKeyEvents(this);this.__og.attachListEvents(this);new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});}
,events:{addItem:f,removeItem:f,changeValue:f,changeSelection:f},properties:{appearance:{refine:true,init:p},focusable:{refine:true,init:true},spacing:{check:g,init:0,apply:d,themeable:true},enableInlineFind:{check:a,init:true},name:{check:m,nullable:true,event:x},itemHeight:{init:24,themeable:true,check:y,apply:u},selectionMode:{check:[t,q,w,b],init:t,apply:v},dragSelection:{check:a,init:false,apply:h},quickSelection:{check:a,init:false,apply:s}},members:{__nS:null,__cL:null,__og:null,__SJ:null,syncWidget:function(){this.update();}
,update:function(){var D=this.getPane().getRowConfig();D.setItemCount(this.__nS.length);D.resetItemSizes();for(var i=0;i<this.__nS.length;i++ ){var E=this.__nS[i].getHeight();if(E!==null){D.setItemSize(i,E);}
;}
;}
,updateSelection:function(){var F=this.__SJ.getChildren();for(var i=0;i<F.length;i++ ){var G=F[i];var H=G.getUserData(r);if(this.__og.isItemSelected(H)){G.addState(c);}
...
,_onChangeSelection:function(e){this.updateSelection();this.fireDataEvent(k,this.__SN(e.getData()));}
,getCellWidget:function(L,I){var K=this.__nS[L];if(!K){return null;}
;var J=this.__cL.pop()||new qx.ui.form.ListItem();J.set({label:K.getLabel(),icon:K.getIcon()});if(this.__og.isItemSelected(L)){J.addState(c);}
...
;this.setSelection(S);}
,getChildren:function(){return this.__nS;}
,hasChildren:function(){return this.__nS.length>0;}
...
,add:function(W){this.__nS.push(W);this._addHelper(W);return this;}
,remove:function(X){qx.lang.Array.remove(this.__nS,X);this._removeHelper(X);return this;}
,removeAll:function(){for(var i=0,j=this.__nS.length;i<j;i++ ){this._removeHelper(this.__nS[i]);}
;this.__nS=[];}
,indexOf:function(Y){return this.__nS.indexOf(Y);}
,addAt:function(bb,ba){qx.lang.Array.insertAt(this.__nS,bb,ba);this._addHelper(bb);}
,addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__nS,bc,bd);this._addHelper(bc);}
,addAfter:function(bf,be){qx.lang.Array.insertAfter(this.__nS,bf,be);this._addHelper(bf);}
,removeAt:function(bg){this.__nS.splice(bg,1);this._removeHelper(this.__nS[bg]);}
,__SK:function(bh){var bi=this.__nS.indexOf(bh);if(bi<0){return null;}
else {return bi;}
;}
,__SL:function(bk){var bj=this.__nS[bk];return bj;}
,__SM:function(bl){var bm=[];for(var i=0;i<bl.length;i++ ){bm.push(this.__SK(bl[i]));}
;return bm;}
,__SN:function(bo){var bn=[];for(var i=0;i<bo.length;i++ ){bn.push(this.__nS[bo[i]]);}
;return bn;}
,selectAll:function(){this.__og.selectAll();}
,setSelected:function(bp){this.__og.selectItem(this.__SK(bp));}
,isSelected:function(bq){return this.__og.isItemSelected(this.__SK(bq));}
,addToSelection:function(br){this.__og.addItem(this.__SK(br));}
,removeFromSelection:function(bs){this.__og.removeItem(this.__SK(bs));}
,selectRange:function(bt,bu){this.__og.selectItemRange(this.__SK(bt),this.__SK(bu));}
,resetSelection:function(){this.__og.clearSelection();}
,setSelection:function(bv){this.__og.replaceSelection(this.__SM(bv));}
,getSelectedItem:function(){return this.__nS[this.getSelected()];}
,getSelected:function(){return this.__nS[this.__og.getSelectedItem()];}
,getSelection:function(){return this.__SN(this.__og.getSelection());}
,getSortedSelection:function(){return this.__SN(this.__og.getSortedSelection());}
...
,getSelectables:function(){return this.__SN(this.__og.getSelectables());}
,_applySelectionMode:function(bx,bw){this.__og.setMode(bx);}
,_applyDragSelection:function(bz,by){this.__og.setDrag(bz);}
,_applyQuickSelection:function(bB,bA){this.__og.setQuick(bB);}
}});}
)();
