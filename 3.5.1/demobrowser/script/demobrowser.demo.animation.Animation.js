...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation.58ab6653c426.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="360deg",b="bottom left",c="3deg",d="div",f="3D",g="both",h="button",i="180deg",j="-20deg",k="demobrowser.demo.animation.Animation",l="-50px",m="90deg",n="0px",o="-10px",p="200px",q="10deg",r="h1",s="10px",t="name",u="0deg",v="bottom center",w="Sorry, no CSS transforms supported",x="3d",y="50px",z="click",A="left bottom",B='label',C="Fast Width",D="ease-in",E="css.animation",F="padding-top",G="20px",H="red",I="css.transform",J="not-allowed",K="CSS animations not supported, sorry!",L="ease-out",M="-3deg";qx.Class.define(k,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(E)==null){var S=document.createElement(B);S.innerHTML=K;document.body.appendChild(S);return;}
;var bf={duration:1000,timing:L,keyFrames:{'0':{},'70':{"width":p},'100':{}}};var R={duration:1000,keyFrames:{'0':{"scale":[1,1],"rotate":[u,u],"skew":u,"translate":n},'50':{"scale":[1,0.2],"rotate":[u,m],"skew":q,"translate":l},'100':{"scale":[1,1],"rotate":[u,u],"skew":u,"translate":n}}};var bc={duration:1000,keyFrames:{'0':{"translate":[n,n]},'50':{"translate":[y,G]},'100':{"translate":[n,n]}}};var W={duration:1000,origin:v,keyFrames:{'0':{"scale":[1,1]},'50':{"scale":[2,0.1]},'100':{"scale":[1,1]}}};var O={duration:1000,keep:100,keyFrames:{'0':{"rotate":u},'100':{"rotate":a}}};var T={duration:1000,keyFrames:{'0':{"rotate":[u,u,u]},'50':{"rotate":[i,i,m]},'100':{"rotate":[u,u,u]}}};var P={duration:1000,origin:b,keyFrames:{'0':{"skew":u},'50':{"skew":j},'100':{"skew":u}}};var Q={duration:1000,keyFrames:{'0':{translate:n},'10':{translate:o},'20':{translate:s},'30':{translate:o},'40':{translate:s},'50':{translate:o},'60':{translate:s},'70':{translate:o},'80':{translate:s},'90':{translate:o},'100':{translate:n}}};var bd={duration:1000,keyFrames:{'0':{scale:1,rotate:u},'10':{scale:0.9,rotate:M},'20':{scale:0.9,rotate:M},'30':{scale:1.1,rotate:c},'40':{scale:1.1,rotate:M},'50':{scale:1.1,rotate:c},'60':{scale:1.1,rotate:M},'70':{scale:1.1,rotate:c},'80':{scale:1.1,rotate:M},'90':{scale:1.1,rotate:c},'100':{scale:1,rotate:u}}};var N={duration:500,origin:A,keyFrames:{'0':{opacity:1,rotate:u},'100':{opacity:0,rotate:m}}};var bb={duration:500,origin:A,keyFrames:{'0':{opacity:0,rotate:m},'100':{opacity:1,rotate:u}}};var X={duration:500,timing:L,keyFrames:{'0':{translate:[null,n],opacity:1},'30':{translate:[null,s],opacity:1},'100':{translate:[null,l],opacity:0}}};var Y={duration:1000,keep:100,timing:D,origin:v,keyFrames:{'0':{rotate:[u],skew:[u]},'30':{rotate:[m],skew:[j]},'100':{rotate:[u],skew:[u]}}};var V={"Tada":bd,"Shake":Q,"Skew":P,"Rotate":O,"Scale":W,"translate":bc,"Width":bf,"Fast Width":bf,"Rotate Out":N,"Rotate In":bb,"Up and out":X,"3D Rotate":T,"3D Transform":R,"3D Fall":Y};for(var ba in V){var be=document.createElement(d);be.innerHTML=ba;be.className=h;document.body.appendChild(be);if(!(qx.core.Environment.get(I)[t])){be.style.color=H;be.style.cursor=J;continue;}
;if(ba.indexOf(f)!=-1&&!(qx.core.Environment.get(I)[x])){be.style.color=H;be.style.cursor=J;continue;}
;be.addEventListener(z,(function(bh,bg){return function(e){qx.bom.element.Animation.animate(e.target,bh,bg==C?300:undefined);}
;}
)(V[ba],ba));}
;if(!(qx.core.Environment.get(I)[t])){var U=document.createElement(r);U.style.color=H;U.style.clear=g;U.style[F]=G;U.innerHTML=w;document.body.appendChild(U);}
;}
}});}
)();
