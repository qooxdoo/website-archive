...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Canvas_MinMaxSizes","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.Canvas_MinMaxSizes.14dd12d7badf.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="black",b="12%",c="teal",d="red",e="maxHeight=300",f="3%",g="minWidth=400",h="green",i="9%",j="6%",k="yellow",l="orange",m="20%",n="solid",o="blue",p="demobrowser.demo.layout.Canvas_MinMaxSizes";qx.Class.define(p,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var x=new qx.ui.decoration.Decorator().set({width:3,style:n,color:a});var w=new qx.ui.core.Widget().set({backgroundColor:d,decorator:x});var v=new qx.ui.core.Widget().set({backgroundColor:o,decorator:x});var u=new qx.ui.basic.Label(e).set({backgroundColor:h,decorator:x,padding:5,maxHeight:300,allowStretchX:true,allowStretchY:true});var t=new qx.ui.core.Widget().set({backgroundColor:k,decorator:x});var s=new qx.ui.core.Widget().set({backgroundColor:l,decorator:x});var r=new qx.ui.basic.Label(g).set({backgroundColor:c,decorator:x,padding:5,minWidth:400,allowStretchX:true,allowStretchY:true});var q=new qx.ui.container.Composite(new qx.ui.layout.Canvas());q.add(w,{left:f,top:f,right:f,bottom:f,width:m,height:m});q.add(v,{left:j,top:j,right:j,width:m,height:m});q.add(u,{left:i,top:i,bottom:i,width:m,height:m});q.add(t,{left:b,top:b,width:m,height:m});q.add(s,{top:i,right:i,width:m,height:m});q.add(r,{right:i,bottom:i,width:m,height:m});this.getRoot().add(q,{edge:0});}
}});}
)();
