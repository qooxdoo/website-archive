...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Iframe","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Iframe.59a93bc4fc33.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" (inner): ",b="inner",c="div",d="capture: ",f="juhu",g="contextmenu",h=": ",j="bubble: ",k=" 2: ",l="input",m="load",n="click",o="iframe",p="keydown",q=" ",r="demobrowser.demo.event.Event_Iframe",s=" 1: ",t="scroll",u="data/Event_2_frame.html",v="keydown: ";qx.Class.define(r,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var w=qx.bom.Iframe.create({name:o,src:u});w.id=o;document.body.appendChild(w);qx.event.Registration.addListener(w,m,this.bindIFrameEvents,this);}
,bindIFrameEvents:function(){var z=window.document.getElementById(o);var y=qx.bom.Iframe.getDocument(z);this._juhu=y.getElementById(f);this._inner=y.getElementById(b);qx.event.Registration.addListener(this._juhu,g,this._preventDefault,this);qx.event.Registration.addListener(this._inner,n,this._stopPropagation,this);qx.event.Registration.addListener(this._juhu,n,this._onclick1,this);qx.event.Registration.addListener(this._juhu,n,this._onclick2,this);qx.event.Registration.addListener(y.getElementById(l),p,this._onkeydown,this);for(var i=1;i<10;i++ ){var x=y.getElementById(c+i);qx.event.Registration.addListener(x,n,this._cascadeCapture,this,true);qx.event.Registration.addListener(x,n,this._cascadeBubble,this,false);}
;qx.event.Registration.addListener(y.getElementById(t),t,this._scroll,this);}
,_onkeydown:function(e){this.debug(v+e.getKeyIdentifier());}
,_scroll:function(e){this.debug(t);}
,_cascadeCapture:function(e){var A=e.getCurrentTarget();this.debug(d+A.id+q+e.getEventPhase());}
,_cascadeBubble:function(e){var B=e.getCurrentTarget();this.debug(j+B.id+q+e.getEventPhase());}
,_preventDefault:function(e){this.debug(e.getType()+h+e);e.preventDefault();}
,_stopPropagation:function(e){this.debug(e.getType()+a+e);e.stopPropagation();}
,_onclick1:function(e){this.debug(e.getType()+s+e);qx.event.Registration.removeListener(this._juhu,n,this._onclick1);}
,_onclick2:function(e){this.debug(e.getType()+k+e);}
