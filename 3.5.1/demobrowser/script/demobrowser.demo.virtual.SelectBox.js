...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.SelectBox.53b8a8201990.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_handleKeyboard:function(event){var T=this._getAction(event);switch(T){case q:this.__vL+=this.__vN(event.getKeyIdentifier());this.__vK.restart();break;default:qx.ui.form.core.AbstractVirtualBox.prototype._handleKeyboard.call(this,event);break;};}
...
,__vM:function(){this.__vK.stop();var Y=this.__vL;if(Y==null||Y==s){return;}
...
;}
;this.__vL=s;}
,__vN:function(bi){if(bi===f){return B;}
else {return bi;}
;}
},destruct:function(){this._removeBindings();this.__vK.removeListener(l,this.__vM,this);this.__vK.dispose();this.__vK=null;}
});}
)();
