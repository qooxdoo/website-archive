...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable_Conditional.2aa2252f7f75.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="regex cannot be null!",b="font-weight",c="==",d="Condition not recognized or value1/value2 is null!",e="Condition not recognized or value is null!",f="",g=">",h="text-align",j="between",k="regex",l="<",m='g',n="qx.ui.progressive.renderer.table.cell.Conditional",o=":",p=";",q="!between",r=">=",s="color",t="font-style",u="!=",v="<=";qx.Class.define(n,{extend:qx.ui.progressive.renderer.table.cell.Abstract,construct:function(y,w,x,z){qx.ui.progressive.renderer.table.cell.Abstract.call(this);this.__Fo=[c,u,g,l,r,v];this.__Fp=[j,q];this.__Fq=[];this.__yR=y||f;this.__yS=w||f;this.__yT=x||f;this.__yU=z||f;}
,members:{__Fo:null,__Fp:null,__Fq:null,__yR:null,__yS:null,__yT:null,__yU:null,__yV:function(B,A){if(B.align){A[h]=B.align;}
;if(B.color){A[s]=B.color;}
;if(B.style){A[t]=B.style;}
;if(B.weight){A[b]=B.weight;}
;}
,addNumericCondition:function(I,H,G,F,C,E,D){if(!qx.lang.Array.contains(this.__Fo,I)||H==null){throw new Error(e);}
;this.__Fq.push({condition:I,align:G,color:F,style:C,weight:E,value1:H,target:D});}
,addBetweenCondition:function(Q,P,O,N,M,J,L,K){if(!qx.lang.Array.contains(this.__Fp,Q)||P==null||O==null){throw new Error(d);}
;this.__Fq.push({condition:Q,align:N,color:M,style:J,weight:L,value1:P,value2:O,target:K});}
,addRegex:function(R,W,V,S,U,T){if(!R){throw new Error(a);}
;this.__Fq.push({condition:k,align:W,color:V,style:S,weight:U,regex:R,target:T});}
,_getCellStyle:function(bb){if(this.__Fq.length==0){return bb.style||f;}
;var i;var bc;var X;var ba={"text-align":this.__yR,"color":this.__yS,"font-style":this.__yT,"font-weight":this.__yU};for(i=0;i<this.__Fq.length;i++ ){var bf=this.__Fq[i];bc=false;if(qx.lang.Array.contains(this.__Fo,bf.condition)){if(bf.target==null){X=bb.cellData;}
...
;break;};}
else if(qx.lang.Array.contains(this.__Fp,bf.condition)){if(bf.target==null){X=bb.cellData;}
else {X=bb.element.data[bf.target];}
