...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Flash.5f8c5e06ccf6.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="2) this html page is not loaded from the file system, but a webserver.",b="Flash Player Version",c="right",d="qooxdoo is the best!",f="Message from Flash:",g="execute",h="Simple demo with FlashVars",i="bgcolor",j="__Tj",k="demobrowser.demo.widget.Flash",l="demobrowser/demo/flash/TestFlash.swf",m="1) no pop-up or advertising blocker is activated.\n",n="Send to Flash",o="demobrowser/demo/flash/FlashVersion.swf",p="No message.",q="Flash:",r="<b>qooxdoo:</b>",s="__Ti",t="demobrowser.demo.widget.Flash.sendMessage",u="demobrowser.demo.widget.Flash.flashReady",v="Couldn't connect to Flash Player! Please make sure that:\n",w="__cw",x="demobrowser/demo/flash/fo_tester.swf",y="this is passed in via FlashVars",z="__Ib",A="Two way communication (ActionScript <-> JavaScript)",B="Message to Flash:",C="Show Flash Player version",D="noscale",E="#FF6600",F="__Tk";qx.Class.define(k,{extend:qx.application.Standalone,members:{__cw:null,main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.tabview.TabView();J.setContentPadding([8,8,8,8]);var G=this.getRoot();G.add(J,{edge:0});var H=new qx.ui.tabview.Page(h);H.setLayout(new qx.ui.layout.Canvas());H.add(this.createFlashDemo1(),{edge:0});J.add(H);var I=new qx.ui.tabview.Page(A);I.setLayout(new qx.ui.layout.Canvas());I.add(this.createFlashDemo2(),{edge:0});J.add(I);this.__cw=this.createWindow();G.add(this.__cw,{top:20,left:20});}
...
,createFlashDemo1:function(){var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));var L={flashVarText:y};var M=new qx.ui.embed.Flash(x).set({scale:D,variables:L});M.getContentElement().setParam(i,E);N.add(M,{flex:1});var O=new qx.ui.form.Button(C);O.addListener(g,function(){this.__cw.open();}
,this);N.add(O);return N;}
,__Ib:null,__Ti:null,__Tj:null,__Tk:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);var R=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(Q,{flex:1});Q.add(new qx.ui.basic.Label(r).set({rich:true}));Q.add(new qx.ui.basic.Label(f));this.__Ti=new qx.ui.form.TextArea(p);this.__Ti.setEnabled(false);Q.add(this.__Ti,{flex:1});Q.add(new qx.ui.basic.Label(B));this.__Tj=new qx.ui.form.TextArea(d);Q.add(this.__Tj,{flex:1});var S=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,c));this.__Tk=new qx.ui.form.Button(n);this.__Tk.setEnabled(false);this.__Tk.addListener(g,function(e){this.__Ib.getFlashElement().sendMessage(this.__Tj.getValue());}
,this);S.add(this.__Tk);Q.add(S);var P=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));R.add(P,{flex:1});P.add(new qx.ui.basic.Label(q).set({rich:true}));this.__Ib=new qx.ui.embed.Flash(l);this.__Ib.setVariables({init:u});P.add(this.__Ib,{flex:1});return R;}
,sendMessage:function(T){this.__Ti.setValue(T);}
,initFlash:function(){if(this.__Ib.getFlashElement().setup){this.__Ib.getFlashElement().setup(t);this.__Tk.setEnabled(true);}
else {alert(v+m+a);}
;}
},statics:{__Tl:null,setCallBackInstance:function(U){demobrowser.demo.widget.Flash.__Tl=U;}
,sendMessage:function(V){demobrowser.demo.widget.Flash.__Tl.sendMessage(V);}
,flashReady:function(){demobrowser.demo.widget.Flash.__Tl.initFlash();}
},destruct:function(){this._disposeObjects(s,j,F,z,w);}
});}
)();
...
,_checkLoading:function(){var bo=this.getSource();if(bo!=F&&bo!=null&&bo!=bf){if(!this.isLoaded()){if(!this.__HQ){this.__HQ=new Date().getTime();}
;var bp=new Date().getTime()-this.__HQ;if(this.getLoadTimeout()>bp){var bq=qx.util.TimerManager.getInstance();bq.start(this._checkLoading,0,this,null,10);this.fireEvent(x);}
else {if(qx.core.Environment.get(u)){this.debug(A+bp);}
;this.fireEvent(P);this.__HQ=null;}
;}
else {this.fireEvent(p);this.__HQ=null;}
;}
;}
...
,_applyQuality:function(bB,bA){this.__HR(c,bB);}
,_applyScale:function(bD,bC){this.__HR(h,bD);}
,_applyWmode:function(bF,bE){this.__HR(m,bF);}
,_applyPlay:function(bH,bG){this.__HR(I,bH);}
,_applyLoop:function(bJ,bI){this.__HR(s,bJ);}
,_applyMenu:function(bL,bK){this.__HR(v,bL);}
,_applyAllowScriptAccess:function(bN,bM){this.__HR(t,bN);}
,_applyLiveConnect:function(bP,bO){this.__HR(z,bP);}
,__HR:function(bQ,bR){this.getContentElement().setParam(bQ,bR);qx.ui.core.queue.Layout.add(this);}
}});}
)();
(function(){var a="$$",b="Invalid attribute 'value'.",c="The id cannot be modified after initial creation",d="The variables cannot be modified after initial creation",e="qx.debug",f="$$widget",g="Invalid attribute 'key'.",h="movie",i="div",j="The attributes cannot be modified after initial creation",k="The source cannot be modified after initial creation",l="The params cannot be modified after initial creation",m="Invalid attribute 'value' expected String, Boolean or null.",n="id",o="qx.html.Flash";qx.Class.define(o,{extend:qx.html.Element,construct:function(p,q){qx.html.Element.call(this,i,p,q);this.__HX={};this.__HY={};this.__Ia={};}
,members:{__HX:null,__Ia:null,__HY:null,__Ib:null,_createDomElement:function(){return qx.dom.Element.create(i);}
,createFlash:function(){this.__Ib=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__HY,this.__HX);}
,setSource:function(r){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(r,b);}
;if(this.__Ib){throw new Error(k);}
;this.setAttribute(h,r);}
,setId:function(s){if(qx.core.Environment.get(e)){qx.core.Assert.assertString(s,b);}
;if(this.__Ib){throw new Error(c);}
;this.setAttribute(n,s);}
,getVariables:function(){return this.__HY;}
,setVariables:function(t){if(qx.core.Environment.get(e)){qx.core.Assert.assertMap(t,b);}
;if(this.__Ib){throw new Error(d);}
;this.__HY=t;}
,getAttributes:function(){return this.__Ia;}
...
else if(this.__Ib){throw new Error(j);}
;if(v===null||v===undefined){delete this.__Ia[u];}
else {this.__Ia[u]=v;}
;}
,getParams:function(){return this.__HX;}
...
;}
;}
;if(this.__Ib){throw new Error(l);}
;if(x===null||x===undefined){delete this.__HX[w];}
else {this.__HX[w]=x;}
;}
,getFlashElement:function(){return this.__Ib;}
},destruct:function(){if(this.__Ib){qx.bom.Flash.destroy(this.__Ib);}
;this.__HX=this.__HY=this.__Ia=null;}
});}
)();
...
;}
;}
;var N=this.__Ih(O,Q,P,L);this._flashObjects[Q.id]=N;return N;}
,destroy:qx.core.Environment.select(C,{"mshtml":function(S,R){S=this.__Ic(S);if(S.readyState==4){this.__Id(S);}
else {if(!R){R=window;}
;qx.bom.Event.addNativeListener(R,p,function(){qx.bom.Flash.__Id(S);}
);}
;}
,"default":function(U,T){U=this.__Ic(U);if(U.parentNode){U.parentNode.removeChild(U);}
;delete this._flashObjects[U.id];}
}),__Ic:function(V){if(!V){throw new Error(y);}
;if(V.tagName.toLowerCase()!==K){V=V.firstChild;}
;if(!V||V.tagName.toLowerCase()!==K){throw new Error(z);}
;return V;}
,__Id:qx.core.Environment.select(C,{"mshtml":qx.event.GlobalError.observeMethod(function(W){for(var i in W){if(typeof W[i]==b){W[i]=null;}
;}
;if(W.parentNode){W.parentNode.removeChild(W);}
;delete this._flashObjects[W.id];}
),"default":null}),__Ie:qx.event.GlobalError.observeMethod(function(){for(var X in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[X]);}
;window.__If=function(){}
;window.__Ig=function(){}
;qx.bom.Event.removeNativeListener(window,E,qx.bom.Flash.__Ie);}
),__Ih:qx.core.Environment.select(C,{"mshtml":function(bb,bd,bc,Y){bc.movie=bd.data;delete bd.data;delete bd.classid;var ba=t;for(name in bc){ba+=m+name+I+bc[name]+D;}
...
})},defer:function(bk){if(qx.core.Environment.get(C)==u){qx.bom.Event.addNativeListener(window,E,bk.__Ie);}
;}
});}
)();
(function(){var a="qx.util.TimerManager",b="interval",c="singleton";qx.Class.define(a,{extend:qx.core.Object,type:c,statics:{__HS:[],__HT:{},__ug:0},members:{__HU:false,start:function(g,f,h,d,j){if(!j){j=f||0;}
;var e=(new Date()).getTime()+j;this.self(arguments).__HT[ ++this.self(arguments).__ug]={callback:g,userData:d||null,expireAt:e,recurTime:f,context:h||this};this.__HV(e,this.self(arguments).__ug);return this.self(arguments).__ug;}
,stop:function(k){var l=this.self(arguments).__HS;var length=l.length;for(var i=0;i<length;i++ ){if(l[i]==k){l.splice(i,1);break;}
;}
;delete this.self(arguments).__HT[k];if(l.length==0&&this.__HU){qx.event.Idle.getInstance().removeListener(b,this.__HW,this);this.__HU=false;}
;}
,__HV:function(m,p){var o=this.self(arguments).__HS;var n=this.self(arguments).__HT;var length=o.length;for(var i=0;i<length;i++ ){if(n[o[i]].expireAt>m){o.splice(i,0,p);break;}
;}
;if(o.length==length){o.push(p);}
;if(!this.__HU){qx.event.Idle.getInstance().addListener(b,this.__HW,this);this.__HU=true;}
;}
,__HW:function(){var r=(new Date()).getTime();var t=this.self(arguments).__HS;var s=this.self(arguments).__HT;while(t.length>0&&s[t[0]].expireAt<=r){var v=t.shift();var q=s[v];q.callback.call(q.context,q.userData,v);if(q.recurTime&&s[v]){var u=(new Date()).getTime();q.expireAt=u+q.recurTime;this.__HV(q.expireAt,v);}
else {delete s[v];}
;}
;if(t.length==0&&this.__HU){qx.event.Idle.getInstance().removeListener(b,this.__HW,this);this.__HU=false;}
;}
}});}
)();
