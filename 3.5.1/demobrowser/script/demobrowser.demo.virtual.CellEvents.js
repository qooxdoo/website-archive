...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.CellEvents.df69661be45c.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="logger",b='<p style="color:green;">You clicked on cell ',c="",d="cellClick",f='<p style="color:yellow;">You rightclicked cell ',g='<p style="color:red;">You double clicked cell ',h='</p>',i=' / ',j="demobrowser.demo.virtual.CellEvents",k="main",l="cellDblclick",m="cellContextmenu",n="layer";qx.Class.define(j,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var o=new qx.ui.virtual.core.Scroller(20,20,40,40).set({width:400,height:300});this.layer=new qx.test.ui.virtual.layer.LayerSimple(this);var p=o.getPane();p.addListener(d,this._onCellClick,this);p.addListener(m,this._onContextMenu,this);p.addListener(l,this._onDblclickPane,this);p.addLayer(this.layer);this.logger=new qx.ui.embed.Html().set({width:400,height:300,html:c,decorator:k});this.getRoot().add(o,{left:20,top:10});this.getRoot().add(this.logger,{left:450,top:10});}
,_onCellClick:function(e){var q=b+e.getRow()+i+e.getColumn()+h;this.__ST(q);}
,_onContextMenu:function(e){var r=f+e.getRow()+i+e.getColumn()+h;this.__ST(r);}
,_onDblclickPane:function(e){var s=g+e.getRow()+i+e.getColumn()+h;this.__ST(s);}
,__ST:function(t){this.logger.setHtml(this.logger.getHtml()+t);}
