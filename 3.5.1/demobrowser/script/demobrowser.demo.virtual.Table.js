...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Table.027cbb6d27fb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" / ",b="horizontal",c="demobrowser.demo.virtual.Table",d="__SU",e="white",f="#EEE",g="vertical";qx.Class.define(c,{extend:qx.application.Standalone,members:{__SU:null,main:function(){qx.application.Standalone.prototype.main.call(this);var h=new qx.ui.virtual.core.Scroller(10000,10000,20,100);for(var i=0;i<10000;i++ ){h.getPane().getRowConfig().setItemSize(i,20+Math.round(Math.random()*40));h.getPane().getColumnConfig().setItemSize(i,50+Math.round(Math.random()*80));}
;this.getRoot().add(h,{edge:20});h.getPane().addLayer(new qx.ui.virtual.layer.Row(e,f));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(b));h.getPane().addLayer(new qx.ui.virtual.layer.GridLines(g));h.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));this.__SU=new qx.ui.virtual.cell.Cell();}
,getCellProperties:function(k,j){return this.__SU.getCellProperties(k+a+j);}
...
;this.__dT=qx.bom.Stylesheet.createElement(p);this.__EJ={};this.__mA={};}
,members:{__dT:null,__EJ:null,__mA:null,getStylesheet:function(){return this.__dT;}
,getCssClass:function(q){return this.__EJ[q]||null;}
,computeClassForStyles:function(t,r){var s=this.__mA[r];if(!s){var s=this.__EK();qx.bom.Stylesheet.addRule(this.__dT,k+s,r);this.__mA[r]=s;}
;this.__EJ[t]=s;return s;}
,__EK:function(){return e+this.toHashCode()+a+(this.__EL++ );}
,__EL:0},destruct:function(){this.__dT=this.__EJ=this.__mA=null;}
});}
)();
(function(){var a="-",b="backgroundColor",c="_applyTextAlign",d="px",e="paddingLeft",f="_applyFont",g="Integer",h="_applyBackgroundColor",j="_applyPadding",k="cell",l="center",m="font",n=":",o="shorthand",p="Color",q="String",r="_applyAppearance",s="background-color:",t="",u="textAlign",v="qx-cell ",w="left",x="textColor",y="text-align:",z="Font",A="paddingBottom",B="paddingTop",C="right",D="_applyTextColor",E="justify",F="color:",G="paddingRight",H=" ",I=";",J="qx.ui.virtual.cell.Cell";qx.Class.define(J,{extend:qx.ui.virtual.cell.Abstract,construct:function(){qx.ui.virtual.cell.Abstract.call(this);this.__dT=qx.ui.virtual.cell.CellStylesheet.getInstance();this.__EM={};this.__EN={};this.__EO={};this.__EP={};this.__iH={};this.__EQ={};this.initAppearance();this.__EU();}
,properties:{appearance:{check:q,init:k,apply:r},backgroundColor:{nullable:true,check:p,apply:h,themeable:true},textColor:{nullable:true,check:p,apply:D,themeable:true},textAlign:{check:[w,l,C,E],nullable:true,themeable:true,apply:c},font:{nullable:true,apply:f,check:z,themeable:true},paddingTop:{check:g,init:0,apply:j,themeable:true},paddingRight:{check:g,nullable:true,apply:j,themeable:true},paddingBottom:{check:g,nullable:true,apply:j,themeable:true},paddingLeft:{check:g,nullable:true,apply:j,themeable:true},padding:{group:[B,G,A,e],mode:o,themeable:true}},members:{__ER:null,__ES:null,__iH:null,__EQ:null,__EN:null,__EM:null,__EO:null,__EP:null,__ET:false,__dT:null,__EU:function(){var M=qx.util.PropertyUtil;var K=qx.lang.Object.fromArray(this._getCssProperties());this.__ER=[];var O=this.constructor;while(O){var L=M.getProperties(O);for(var N in L){if(!K[N]){this.__ER.push(N);}
;}
;O=O.superclass;}
;}
,_getCssProperties:function(){return [b,x,m,u,B,G,A,e];}
,_applyAppearance:function(Q,P){if(P){this.__EN={};}
;}
,_getValue:function(R){if(this.__ET){return qx.util.PropertyUtil.getThemeValue(this,R);}
else {return qx.util.PropertyUtil.getUserValue(this,R);}
;}
,_storeStyle:function(T,S){var U;if(this.__ET){U=this.__EN;}
else {U=this.__EM;}
...
;}
,_applyPadding:function(bh,bg,name){var bh=this._getValue(name);if(this.__ET){var bi=this.__EP;}
else {bi=this.__EO;}
...
;}
,getCellProperties:function(bk,bj){this.__EV(bj);return {classes:this.getCssClasses(bk,bj),style:this.getStyles(bk,bj),attributes:this.getAttributes(bk,bj),content:this.getContent(bk,bj),insets:this.getInsets(bk,bj)};}
,getAttributes:function(bm,bl){return t;}
,getContent:function(bo,bn){return bo;}
,getCssClasses:function(br,bp){var bq=this.__dT.getCssClass(this.__ES)||t;return v+bq;}
,__EV:function(bs){if(!bs){bs={};}
;var bu=this.getAppearance();var bt=bu+a+Object.keys(bs).sort().join(H);if(this.__ES==bt){return;}
;this.__ES=bt;var bv=this.__iH[this.__ES];if(!bv){this.__EW();this.__EX(bs);this.__EY(bs);this.__Fa();this.__iH[this.__ES]=1;}
;this.__Fb();}
,__EW:function(){var bw=qx.util.PropertyUtil;var bx=this._getCssProperties();for(var i=0;i<bx.length;i++ ){bw.deleteThemeValue(this,bx[i]);}
;}
,__EX:function(bz){this.__EN={};this.__ET=true;var bB=this.getAppearance();var bA=qx.util.PropertyUtil;var by=qx.theme.manager.Appearance.getInstance().styleFrom(bB,bz);for(var bC in by){if(by[bC]!==undefined){bA.setThemed(this,bC,by[bC]);}
;}
;this.__ET=false;}
,__EY:function(){var bD=qx.lang.Object.getValues(this.__EN).join(I);this.__dT.computeClassForStyles(this.__ES,bD);}
,__Fa:function(){var bI=this.__ER;var bE=qx.util.PropertyUtil;var bG={};for(var i=0;i<bI.length;i++ ){var bH=bI[i];var bF=bE.getThemeValue(this,bH);if(bF!==undefined){bG[bH]=bF;}
;}
;this.__EQ[this.__ES]=bG;}
,__Fb:function(){var bK=qx.util.PropertyUtil;var bJ=this.__EQ[this.__ES]||{};for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);}
;}
,getStyles:function(bN,bM){return qx.lang.Object.getValues(this.__EM).join(I);}
,getInsets:function(bQ,bR){var bT=this.__EO;var bS=this.__EP;var top=(bT.paddingTop!==undefined?bT.paddingTop:bS.paddingTop)||0;var bO=(bT.paddingRight!==undefined?bT.paddingRight:bS.paddingRight)||0;var bP=(bT.paddingBottom!==undefined?bT.paddingBottom:bS.paddingBottom)||0;var bU=(bT.paddingLeft!==undefined?bT.paddingLeft:bS.paddingLeft)||0;return [bU+bO,top+bP];}
},destruct:function(){this.__dT=this.__EM=this.__EN=this.__EO=this.__EP=this.__iH=this.__EQ=this.__ER=null;}
});}
)();
