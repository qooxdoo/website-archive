...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.Iframe.33f7d4670437.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,properties:{appearance:{refine:true,init:r},scrollbarX:{check:[t,q,o],init:t,themeable:true,apply:i},scrollbarY:{check:[t,q,o],init:t,themeable:true,apply:i},scrollbar:{group:[k,l]}},members:{__Fz:null,__FA:null,_getIframeElement:function(){return this.getChildControl(j).getContentElement();}
...
;}
,_startIframeObserver:function(){if(this.__FA){this._stopIframeObserver();}
;var E=qx.event.Idle.getInstance();this.__FA=E.addListener(c,this._onIframeObserverInterval,this);}
,_stopIframeObserver:function(){this.__Fz=null;if(!this.__FA){return;}
;var F=qx.event.Idle.getInstance();F.removeListenerById(this.__FA);}
,_onIframeObserverInterval:function(){var G=this._getIframeSize();if(!G){this._disableScollbars();return;}
;if(this.__Fz&&G.width==this.__Fz.width&&G.height==this.__Fz.height){return;}
;this.__Fz=G;this._preventIframeScrolling();this._updateScrollbars();}
...
;}
,_updateScrollbars:function(){var J=this.__Fz;var M=this.getChildControl(j).getBounds();var K=this.getChildControl(j).getInnerSize();if(!J||!K||!K){return;}
...
;}
},destruct:function(){this._stopIframeObserver();this.__Fz=null;}
});}
)();
