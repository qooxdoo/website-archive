...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation_Compare.ecd3b06e0d76.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="360deg",b="Reverse",c="demobrowser.demo.animation.Animation_Compare",d="1%",f="infinite",g="10%",j="JavaScript Animation",k="0deg",l="#124589",m="end",n="2em",o="div",p="60px",q="auto",r="0",s="20%",t="CSS3 Animation",u="ease",v="30px",w="0px",x="-10px",y="200px",z="Pause",A="h1",B="10px",C="Waiting 2s",D="linear",E="1em",F="0.3",G="start",H="button",I="100px",J="Stop",K="400px",L="5px",M="50px",N="Play",O="iteration",P="2",Q="click",R="1",S="Ended",T="ease-in-out",U="none",V="red",W="#00FF00",X="Running",Y="20px",bf="ease-in",bg="-50px",bh="ease-out",be="40px";qx.Class.define(c,{extend:qx.application.Native,members:{createButton:function(name,bl){var bj=[];for(var i=0;i<this.aniClasses.length;i++ ){var bi=document.createElement(o);bi.innerHTML=name;bi.className=H;bj[i]=bi;}
;var bk=(function(bm,name){return function(e){if(name.indexOf(b)!=-1){qx.bom.element.AnimationCss.animateReverse(bj[0],bm);qx.bom.element.AnimationJs.animateReverse(bj[1],bm);}
else {qx.bom.element.AnimationCss.animate(bj[0],bm);qx.bom.element.AnimationJs.animate(bj[1],bm);}
;}
;}
)(bl,name);qx.bom.Event.addNativeListener(bj[0],Q,bk);qx.bom.Event.addNativeListener(bj[1],Q,bk);return bj;}
,main:function(){qx.application.Native.prototype.main.call(this);this.aniClasses=[qx.bom.element.AnimationCss,qx.bom.element.AnimationJs];var bE={duration:1000,keyFrames:{'0':{"width":I},'70':{"width":y},'100':{"width":I}}};var bu={duration:1000,keyFrames:{'0':{"height":be},'70':{"height":p},'100':{"height":be}}};var bF={duration:500,keyFrames:{'0':{"opacity":1},'50':{"opacity":0},'100':{"opacity":1}}};var bO={duration:500,keep:100,keyFrames:{'0':{"opacity":1},'100':{"opacity":0,display:U}}};var bt={duration:500,keyFrames:{'0':{"left":w,"top":w},'80':{"left":M,"top":I},'100':{"left":w,"top":w}}};var bv={duration:500,keyFrames:{'0':{"left":w},'30':{"left":x},'60':{"left":B},'80':{"left":x},'100':{"left":w}}};var bq={duration:500,keyFrames:{'0':{"left":w,"top":w},'30':{"left":x,"top":x},'60':{"left":B,"top":x},'80':{"left":x,"top":B},'100':{"left":w,"top":w}}};var bY={duration:1000,keep:70,keyFrames:{'0':{"top":w},'70':{"top":L},'100':{"top":v}}};var bH={duration:1000,keyFrames:{'0':{"line-height":R},'88':{"line-height":P},'100':{"line-height":F}}};var bn={duration:2000,keyFrames:{'0':{"font-size":E},'88':{"font-size":n},'100':{"font-size":E}}};var br={duration:1000,keyFrames:{'0':{"width":g},'40':{"width":s},'100':{"width":d}}};var bU={duration:1000,keyFrames:{'0':{"color":V},'50':{"color":l},'100':{"color":W}}};var ca={duration:500,repeat:2,keyFrames:{'0':{"top":w},'50':{"top":x},'100':{"top":w}}};var bB={duration:500,alternate:true,repeat:2,keyFrames:{'0':{"top":w},'100':{"top":bg}}};var bo={duration:1000,timing:bf,keep:100,keyFrames:{'0':{"left":w},'100':{"left":K}}};var bJ=qx.lang.Object.clone(bo);bJ.timing=bh;var bM=qx.lang.Object.clone(bo);bM.timing=D;var bA=qx.lang.Object.clone(bo);bA.timing=u;var bC=qx.lang.Object.clone(bo);bC.timing=T;var bN={duration:1000,keyFrames:{'0':{},'50':{"opacity":0},'100':{}}};var bp={duration:500,alternate:true,repeat:2,keep:100,keyFrames:{'0':{"top":w},'100':{"top":M}}};var bz={duration:1000,keep:100,keyFrames:{'0':{"top":w},'100':{"top":M}}};var bG={duration:500,alternate:true,repeat:3,keep:100,keyFrames:{'0':{"top":w},'100':{"top":Y}}};var bW={duration:1000,keyFrames:{'0':{"rotate":k},'100':{"rotate":a}}};var by={duration:1000,keyFrames:{'0':{"scale":1},'50':{"scale":0},'100':{"scale":1}}};var bI={duration:1000,keyFrames:{'0':{"translate":[w,w]},'50':{"translate":[B,B]},'100':{"translate":[w,w]}}};var bT={duration:1000,keyFrames:{'0':{"skew":k},'100':{"skew":a}}};var bK={"Width":bE,"Height":bu,"Fade":bF,"FadeOut":bO,"Move":bt,"Shake":bv,"Dance":bq,"Dance Reverse":bq,"Keep":bY,"Keep (Alt.)":bp,"Keep (Reverse)":bz,"Keep (Reverse/Alt)":bG,"Font-Size":bn,"Line Height":bH,"Percent Width":br,"Color":bU,"Twice":ca,"Alternate":bB,"Ease In":bo,"Ease Out":bJ,"Linear":bM,"Ease":bA,"Ease In Out":bC,"Missing Values":bN,"Rotate":bW,"Scale":by,"Translate":bI,"Skew":bT};var h=document.createElement(A);h.innerHTML=t;document.body.appendChild(h);var bs=document.createElement(o);document.body.appendChild(bs);h=document.createElement(A);h.innerHTML=j;document.body.appendChild(h);var cd=document.createElement(o);document.body.appendChild(cd);for(var bQ in bK){var bD=this.createButton(bQ,bK[bQ]);bs.appendChild(bD[0]);cd.appendChild(bD[1]);}
;var bS={duration:500,alternate:true,repeat:f,keyFrames:{'0':{left:w},'100':{left:B}}};var bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=J;bX.className=H;bD[i]=bX;}
;var bR=(function(ce){return function(e){for(var i=0;i<bL.length;i++ ){bL[i].stop();}
;}
;}
)(bS);qx.bom.Event.addNativeListener(bD[0],Q,bR);qx.bom.Event.addNativeListener(bD[1],Q,bR);var bL=[];bL.push(qx.bom.element.AnimationCss.animate(bD[0],bS));bL.push(qx.bom.element.AnimationJs.animate(bD[1],bS));bs.appendChild(bD[0]);cd.appendChild(bD[1]);bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=z;bX.className=H;bD[i]=bX;}
;var bR=(function(cf){return function(e){for(var i=0;i<bL.length;i++ ){if(cc[i].el){if(cc[i].isPlaying()){cc[i].pause();cc[i].el.innerHTML=N;}
else {cc[i].play();cc[i].el.innerHTML=z;}
;}
;}
;}
;}
)(bS);qx.bom.Event.addNativeListener(bD[0],Q,bR);qx.bom.Event.addNativeListener(bD[1],Q,bR);var cc=[];cc.push(qx.bom.element.AnimationCss.animate(bD[0],bS));cc.push(qx.bom.element.AnimationJs.animate(bD[1],bS));bs.appendChild(bD[0]);cd.appendChild(bD[1]);bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=r;bX.className=H;bD[i]=bX;bX.style.cursor=q;}
;var bw=function(e){e.innerHTML=parseInt(e.innerHTML)+1;}
;qx.bom.element.AnimationCss.animate(bD[0],bS).on(O,bw);qx.bom.element.AnimationJs.animate(bD[1],bS).on(O,bw);bs.appendChild(bD[0]);cd.appendChild(bD[1]);var bx={duration:500,repeat:10,delay:2000,alternate:true,keyFrames:{'0':{left:w},'100':{left:B}}};bD=[];for(var i=0;i<this.aniClasses.length;i++ ){var bX=document.createElement(o);bX.innerHTML=C;bX.className=H;bD[i]=bX;bX.style.cursor=q;}
;var bP=function(e){e.innerHTML=X;}
;var bV=function(e){e.innerHTML=S;}
;var cb=[];cb.push(qx.bom.element.AnimationCss.animate(bD[0],bx));cb.push(qx.bom.element.AnimationJs.animate(bD[1],bx));for(var i=0;i<cb.length;i++ ){cb[i].on(G,bP);cb[i].on(m,bV);}
;bs.appendChild(bD[0]);cd.appendChild(bD[1]);}
}});}
)();
