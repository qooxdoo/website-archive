...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Blocker","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Blocker.ecedd2278eab.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="300px",b="click",c="Block Document for 5s",d="100px",f="demobrowser.demo.bom.Blocker",g="red",h="Block Element for 5s",i="320px",j="200px",k="green",l="div",m="orange",n="button",o="150px",p="absolute";qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var t=qx.bom.Input.create(n,{value:c});qx.bom.element.Style.setStyles(t,{position:p,left:d,top:d,width:j});var u=new qx.bom.Blocker;u.setBlockerOpacity(0.5);u.setBlockerColor(g);qx.event.Registration.addListener(t,b,function(e){u.block();qx.event.Timer.once(function(e){u.unblock();}
,window,5000);}
);qx.dom.Element.insertEnd(t,document.body);var q=qx.bom.Input.create(n,{value:h});qx.bom.element.Style.setStyles(q,{position:p,left:i,top:d,width:j});var s=qx.dom.Element.create(l);qx.bom.element.Style.setStyles(s,{position:p,left:a,top:o,width:a,height:j,backgroundColor:m,zIndex:500});qx.dom.Element.insertBegin(s,document.body);var r=new qx.bom.Blocker;r.setBlockerOpacity(0.5);r.setBlockerColor(k);qx.event.Registration.addListener(q,b,function(e){r.block(s);qx.event.Timer.once(function(e){r.unblock();}
,window,5000);}
);qx.dom.Element.insertEnd(q,document.body);}
}});}
)();
...
(function(){var a="resize",b="mshtml",c="backgroundColor",d="block",f="transparent",g="px",h="zIndex",i="src",j="engine.name",k="0px",l="allowTransparency",m="div",n="javascript:false;",o="qx.bom.Blocker",p="absolute";qx.Class.define(o,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__dp();}
,members:{__Lo:null,__wi:null,__Lp:null,__Lq:false,__Lr:10000,__Ls:0,__Lt:f,block:function(r){if(!this.__Lq){this.__Lp=r;var q=this.__Lw();this.__Lx(q);this.__Lq=true;}
;}
,unblock:function(){if(this.__Lq){this.__Ly();this.__Lq=false;}
;}
,isBlocked:function(){return this.__Lq;}
,getBlockerElement:function(){return this.__wi;}
,setBlockerColor:function(s){qx.bom.element.Style.set(this.__wi,c,s);}
,getBlockerColor:function(){return qx.bom.element.Style.get(this.__wi,c);}
,setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wi,t);}
,getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wi);}
,setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wi,h,u);}
,getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wi,h);}
,__dp:function(){this.__Lu();if((qx.core.Environment.get(j)==b)){this.__Lv();}
;qx.event.Registration.addListener(window,a,this.__BE,this);}
,__Lu:function(){this.__wi=qx.dom.Element.create(m);qx.bom.element.Style.setStyles(this.__wi,{display:d,opacity:this.__Ls,backgroundColor:this.__Lt});this.setBlockerZIndex(this.__Lr);}
,__Lv:function(){this.__Lo=qx.bom.Iframe.create();qx.bom.element.Attribute.set(this.__Lo,l,false);qx.bom.element.Attribute.set(this.__Lo,i,n);qx.bom.element.Style.setStyles(this.__Lo,{display:d,opacity:this.__Ls});}
,__Lw:function(){var v={position:p};if(this.__LA()){v.left=k;v.top=k;v.right=null;v.bottom=null;v.width=qx.bom.Document.getWidth()+g;v.height=qx.bom.Document.getHeight()+g;}
else {v.width=qx.bom.element.Dimension.getWidth(this.__Lp)+g;v.height=qx.bom.element.Dimension.getHeight(this.__Lp)+g;v.left=qx.bom.element.Location.getLeft(this.__Lp)+g;v.top=qx.bom.element.Location.getTop(this.__Lp)+g;}
;return v;}
,__Lx:function(w){var x=document.body;qx.bom.element.Style.setStyles(this.__wi,w);qx.dom.Element.insertEnd(this.__wi,x);if((qx.core.Environment.get(j)==b)){w.zIndex=this.getBlockerZIndex()-1;qx.bom.element.Style.setStyles(this.__Lo,w);qx.dom.Element.insertEnd(this.__Lo,document.body);}
;}
,__Ly:function(){qx.dom.Element.remove(this.__wi);if((qx.core.Environment.get(j)==b)){qx.dom.Element.remove(this.__Lo);}
;}
,__BE:function(e){if(this.__LA()){this.__Lz({width:k,height:k});qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+g,height:qx.bom.Document.getHeight()+g};this.__Lz(y);}
,this,0);}
;}
,__Lz:function(z){qx.bom.element.Style.setStyles(this.__wi,z);if((qx.core.Environment.get(j)==b)){qx.bom.element.Style.setStyles(this.__Lo,z);}
;}
,__LA:function(){return (this.__Lp==null||qx.dom.Node.isWindow(this.__Lp)||qx.dom.Node.isDocument(this.__Lp));}
},destruct:function(){qx.event.Registration.removeListener(window,a,this.__BE,this);this.__Lo=this.__wi=this.__Lp=null;}
});}
)();
