...
;}
;return name;}
,getVersion:function(){var R=navigator.userAgent;var S=new RegExp(A+qx.bom.client.Browser.__agents+m);var P=R.match(S);if(!P){return y;}
...
;}
,__agents:{"webkit":h,"gecko":o,"mshtml":p,"opera":G}[qx.bom.client.Engine.getName()]},defer:function(T){qx.core.Environment.add(j,T.getName),qx.core.Environment.add(B,T.getVersion),qx.core.Environment.add(I,T.getDocumentMode),qx.core.Environment.add(i,T.getQuirksMode);}
});}
)();
...
;return bJ;}
,__fireLongTap:function(bQ,bR){var bP;if(qx.event&&qx.event.type&&qx.event.type.Tap){bP=qx.event.type.Tap;}
;this._fireEvent(bQ,n,bR,bP);this.__longTapTimer=null;this.__isTapGesture=false;}
