...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.Event_Bubbling-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"2ddd885c2e78"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(c,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
