...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Margin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"3b960e6809c1"},
  boot : "boot",
  bootIsInline : true,
