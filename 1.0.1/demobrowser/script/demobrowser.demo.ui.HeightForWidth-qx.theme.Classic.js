...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.HeightForWidth-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"055470b630e2"},
  boot : "boot",
  bootIsInline : true,
