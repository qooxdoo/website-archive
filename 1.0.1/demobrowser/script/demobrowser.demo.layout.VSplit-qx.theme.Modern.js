...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VSplit-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"3e8f5e256dd1"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var t="vertical",s="main",r="Flex:1",q="Flex:1; Min:250",p="Auto",o="Flex:2",n="Flex:0",m="Flex:2; Max:100",l="Flex:1; Max:100",k="Flex:1; Max:200",h="Flex:2; Min:250",j="Flex:0; Min:350",i="demobrowser.demo.layout.VSplit";
qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var g=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(g);
g.add(this.getSplitPaneTwoFlexSimple(),{left:0});
g.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
g.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
g.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
g.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
g.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
g.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
g.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
g.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var y=new qx.ui.splitpane.Pane(t);
y.setHeight(400);
y.setDecorator(s);
var x=new qx.ui.form.TextArea(r);
x.setDecorator(null);
x.setWrap(true);
y.add(x,1);
var z=new qx.ui.form.TextArea(o);
z.setDecorator(null);
z.setWrap(true);
y.add(z,2);
return y;
},getSplitPaneTwoFlexWithOneMin:function(){var v=new qx.ui.splitpane.Pane(t);
v.setHeight(400);
v.setDecorator(s);
var u=new qx.ui.form.TextArea(q);
u.setDecorator(null);
u.setWrap(true);
u.setMinHeight(250);
v.add(u,1);
var w=new qx.ui.form.TextArea(o);
w.setDecorator(null);
w.setWrap(true);
v.add(w,2);
return v;
},getSplitPaneTwoFlexWithOneMax:function(){var K=new qx.ui.splitpane.Pane(t);
K.setHeight(400);
K.setDecorator(s);
var J=new qx.ui.form.TextArea(r);
J.setDecorator(null);
J.setWrap(true);
K.add(J,1);
...
K.add(L,2);
return K;
},getSplitPaneTwoFlexWithTwoMin:function(){var E=new qx.ui.splitpane.Pane(t);
E.setHeight(400);
E.setDecorator(s);
...
D.setMinHeight(250);
E.add(D,1);
var F=new qx.ui.form.TextArea(h);
F.setDecorator(null);
F.setWrap(true);
F.setMinHeight(250);
E.add(F,2);
return E;
},getSplitPaneTwoFlexWithTwoMax:function(){var H=new qx.ui.splitpane.Pane(t);
H.setHeight(400);
H.setDecorator(s);
var G=new qx.ui.form.TextArea(l);
G.setDecorator(null);
G.setWrap(true);
G.setMaxHeight(100);
H.add(G,1);
var I=new qx.ui.form.TextArea(m);
I.setDecorator(null);
I.setWrap(true);
I.setMaxHeight(100);
H.add(I,2);
return H;
},getSplitPaneOneFlexSimple:function(){var b=new qx.ui.splitpane.Pane(t);
b.setHeight(400);
b.setDecorator(s);
...
a.setWrap(true);
b.add(a,0);
var c=new qx.ui.form.TextArea(r);
c.setDecorator(null);
c.setWrap(true);
b.add(c);
return b;
},getSplitPaneOneFlexSimpleWithMax:function(){var B=new qx.ui.splitpane.Pane(t);
B.setHeight(400);
B.setDecorator(s);
var A=new qx.ui.form.TextArea(n);
A.setDecorator(null);
...
B.add(C);
return B;
},getSplitPaneOneFlexSimpleWithMin:function(){var e=new qx.ui.splitpane.Pane(t);
e.setHeight(400);
e.setDecorator(s);
...
d.setMinHeight(350);
e.add(d,0);
var f=new qx.ui.form.TextArea(r);
f.setDecorator(null);
f.setWrap(true);
e.add(f);
return e;
},getSplitPaneAuto:function(){var N=new qx.ui.splitpane.Pane(t);
N.setDecorator(s);
var M=new qx.ui.form.TextArea(p);
M.setDecorator(null);
M.setWrap(true);
N.add(M,0);
var O=new qx.ui.form.TextArea(p);
O.setDecorator(null);
O.setWrap(true);
N.add(O);
return N;
