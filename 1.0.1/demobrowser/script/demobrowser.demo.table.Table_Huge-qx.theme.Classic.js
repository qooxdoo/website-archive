...
for(var i=0;i<this.COL_COUNT;i++){m.push(h+i+k+o);
}n.push(m);
}return n;
},createTable:function(){var b=this.createRandomRows(this.ROW_COUNT);
var a=this._tableModel=new qx.ui.table.model.Simple();
var d=[];

for(var i=0;i<this.COL_COUNT;i++){d.push(e+i);
}a.setColumns(d);
a.setData(b);
