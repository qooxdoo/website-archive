...
(function(){var O="row",N="small icon",M="This, too, is tall.",L="No attributes specified.",K="1*",J="demobrowser/demo/icons/",I="",H="TALL ICON",G="I am tall.",F="red",z="demobrowser.demo.progressive.ProgressiveTable_VarRowHeight",E="format-justify-left.png",C="I am small.",y="end",x="multimedia-player.png",B="This, too, is small.",A="Id",D="Image",w="Note variable row heights in this table.";
qx.Class.define(z,{extend:qx.application.Standalone,members:{__Bb:null,main:function(){arguments.callee.base.call(this);
var t=J;
this.imageData=[{url:t+E,height:4,tooltip:N},{url:t+x,height:4,tooltip:H},I];
this.__Bb=0;
...
s=p.toUri(o);
this.imageData[i].url=s;
++this.__Bb;
qx.io.ImageLoader.load(s,function(u,v){this.info("Searching for ["+u+"]");
for(var j=0;j<this.imageData.length;j++){if(this.imageData[j].url==u){this.imageData[j].height=v.height;
--this.__Bb;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Bb+", end="+this.imageData.length);
if(this.__Bb==0){this.doLoad();
}return;
}}throw new Error("Image data for "+u+" not found");
},this);
}if(this.__Bb==0){this.doLoad();
}},doLoad:function(){var b=this;
var k=function(P,Q){var R={renderer:O,location:y,data:[Q,b.imageData[P]]};
return R;
};
...
if(j===undefined){this.__Bt=j;
}else{this.__Bt=16;
}
if(k===undefined){this.__Bu=k;
}else{this.__Bu=16;
}},members:{__Bt:null,__Bu:null,_identifyImage:function(d){var h={imageWidth:this.__Bt,imageHeight:this.__Bu};
var i;
