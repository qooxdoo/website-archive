...
(function(){var w="main",v="green",u="yellow",t="center",s="demobrowser.demo.layout.VBox_Margin";
qx.Class.define(s,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
...
C.add(this.getBox4());
C.add(this.getBox5());
},getBox1:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:w,backgroundColor:u,allowGrowY:false});
var i=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var h=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var f=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
g.add(i);
g.add(h);
g.add(f);
...
f.setMarginRight(30);
return g;
},getBox2:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:w,backgroundColor:u,allowGrowY:false});
var r=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var q=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var o=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
p.add(r);
p.add(q);
p.add(o);
r.setMarginLeft(20);
o.setMarginRight(30);
return p;
},getBox3:function(){var x=new qx.ui.layout.VBox();
var z=new qx.ui.container.Composite(x).set({decorator:w,backgroundColor:u,width:150,allowGrowY:false});
x.setSpacing(5);
x.setAlignX(t);
var B=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var A=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var y=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
z.add(B);
z.add(A);
z.add(y);
B.setAllowGrowX(false);
A.setAllowGrowX(false);
y.setAllowGrowX(false);
B.setMarginLeft(20);
y.setMarginRight(30);
return z;
},getBox4:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:w,backgroundColor:u,width:150,allowGrowY:false});
a.setSpacing(5);
a.setAlignX(t);
var e=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var d=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var b=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
c.add(e);
c.add(d);
c.add(b);
...
var l=new qx.ui.container.Composite(j).set({decorator:w,backgroundColor:u,width:150,allowGrowY:false});
j.setSpacing(5);
j.setAlignX(t);
var n=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var m=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
var k=new qx.ui.core.Widget().set({decorator:w,backgroundColor:v});
l.add(n);
l.add(m);
l.add(k);
n.setMarginLeft(20);
