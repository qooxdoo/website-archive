...
(function(){var r="mousedown",q="changeSelection",p="demobrowser.demo.ui.Placement",o="DOM Popup",n="Open Popup",m="Content",l="top-left",k="bottom-right",j="right-top",h="bottom-left",d="left-bottom",g="top-right",f="Open DOM-Popup",c="domanchor",b="DOM align control";
qx.Class.define(p,{extend:qx.application.Standalone,members:{__FE:null,main:function(){arguments.callee.base.call(this);
var a=this.getRoot();
this.__FE=["bottom-left","bottom-right","top-left","top-right","right-top","right-bottom","left-top","left-bottom"];
a.add(this.createTestField(h),{left:20,top:20});
a.add(this.createTestField(k),{right:20,top:20});
a.add(this.createTestField(l),{right:20,bottom:20});
a.add(this.createTestField(g),{left:20,bottom:20});
a.add(this.createTestField(j),{left:20,top:250});
a.add(this.createTestField(d),{right:20,top:250});
...
z.add(new qx.ui.basic.Atom(m));
z.setPadding(20);
var y=new qx.ui.form.SelectBox;
var C=null;

for(var i=0;i<this.__FE.length;i++){var A=new qx.ui.form.ListItem(this.__FE[i]);
y.add(A);

if(this.__FE[i]==x){C=A;
}}B.add(y);
y.addListener(q,function(e){z.setPosition(e.getData()[0].getLabel());
});
y.setSelection([C]);
var D=new qx.ui.form.Button(n);
B.add(D);
D.addListener(r,function(e){z.placeToWidget(D);
z.show();
});
return B;
},createDomClick:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var w=new qx.ui.basic.Label(b);
u.add(w);
var t=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
t.add(new qx.ui.basic.Atom(o));
t.setPadding(20);
var s=new qx.ui.form.SelectBox;

for(var i=0;i<this.__FE.length;i++){s.add(new qx.ui.form.ListItem(this.__FE[i]));
}u.add(s);
s.addListener(q,function(e){t.setPosition(e.getData()[0].getLabel());
});
var v=new qx.ui.form.Button(f);
u.add(v);
v.addListener(r,function(e){t.placeToElement(document.getElementById(c));
t.show();
});
return u;
