...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.ElementResize-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"84656b8d36da"},
  boot : "boot",
  bootIsInline : true,
...
qx.bom.Element.addListener(h,f,this._onResize,this);
this.update(h,h.offsetWidth,h.offsetHeight);
},_onResize:function(e){var g=e.getData();
this.update(e.getTarget(),g.width,g.height);
},update:function(i,j,k){i.innerHTML=c+j+a+k+b;
}}});
})();
...
(function(){var k="resize",j="interval",i="__pb",h="body",g="qx.event.handler.ElementResize";
qx.Class.define(g,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(l){arguments.callee.base.call(this);
this.__oY=l;
this.__pa={};
this.__pb=new qx.event.Timer(200);
this.__pb.addListener(j,this._onInterval,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__pa:null,__oY:null,__pb:null,canHandleEvent:function(y,z){return y.tagName.toLowerCase()!==h;
...
this.__pb.start();
}},unregisterEvent:function(a,b,c){var f=qx.core.ObjectRegistry.toHashCode(a);
var d=this.__pa;

if(d[f]){delete d[f];

if(qx.lang.Object.isEmpty(d)){this.__pb.stop();
}}},_onInterval:function(e){var n=this.__pa;
...
if(r.height!==o||r.width!==p){qx.event.Registration.fireNonBubblingEvent(m,k,qx.event.type.Data,[{width:p,oldWidth:r.width,height:o,oldHeight:r.height}]);
r.width=p;
r.height=o;
}}}},destruct:function(){this.__oY=this.__pa=null;
