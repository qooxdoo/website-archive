...
},_onCellClick:function(e){var t=k+e.getRow()+m+e.getColumn()+n;
this.__Dq(t);
},_onContextMenu:function(e){var o=h+e.getRow()+m+e.getColumn()+n;
this.__Dq(o);
},_onDblclickPane:function(e){var r=g+e.getRow()+m+e.getColumn()+n;
this.__Dq(r);
},__Dq:function(s){this.logger.setHtml(this.logger.getHtml()+s);
