...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.KeyEvent_LowLevel-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"386ebe4fba7d"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var o="logger",n="keypress",m="",l="char code",k="Ctrl",j="key identifier",h="Shift",g="demobrowser.demo.event.KeyEvent_LowLevel",f="keydown",e="Event",b="Alt",d="keyup",c="key code";
...
this._initLogger([e,c,l,j,h,k,b],document.getElementById(o),50);
var a=[f,n,d];

for(var i=0;i<a.length;i++){qx.bom.Event.addNativeListener(document.documentElement,a[i],qx.lang.Function.bind(this.logKeyEvent,this));
}},logKeyEvent:function(p){var q=p.type;
this._log([q,p.keyCode,p.charCode,p.keyIdentifier||m,p.shiftKey,p.ctrlKey,p.altKey]);
