...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Window","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Window-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"adb48c0a9486"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var K="changeValue",J="execute",I="icon/16/apps/office-calendar.png",H="right",G="demobrowser.demo.widget.Window",F="Yes",E="Second Window",D="Page 1",C="bottom",B="Use move frame",bA="Show Statusbar",bz="icon/16/actions/dialog-cancel.png",by="icon/32/status/dialog-error.png",bx="Show Close",bw="Third Window",bv="icon/22/apps/utilities-calculator.png",bu="Show Maximize",bt="Allow Close",bs="Use resize frame",br="No",R="resizable",S="Allow Maximize",P="value",Q="The second window",N="Page 3",O="move",L="Resizable ",M="First Window",V="resize",W="Moveable",bf="Demo loaded",bd="Allow Minimize",bj="Resizable",bh="Open Modal Dialog 2",bn="Open Modal Dialog 1",bl="First Modal Dialog",Y="top",bq="Movable",bp="icon/32/apps/office-address-book.png",bo="Basics",X="Modal",bb="Do you want to fly to Berlin?",bc="Welcome to your first own Window.<br/>Have fun!",be="Application is ready",bg="icon/16/apps/internet-feed-reader.png",bi="Second Modal Dialog",bk="icon/16/actions/dialog-ok.png",bm="Page 2",T="left",U="icon/16/apps/internet-telephony.png",ba="Show Minimize";
qx.Class.define(G,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
this.createWindow1();
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var c=new qx.ui.window.Window(M,I);
c.setLayout(new qx.ui.layout.VBox(10));
c.setShowStatusbar(true);
c.setStatus(bf);
c.open();
this.getRoot().add(c,{left:20,top:20});
c.addListener(O,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
},this);
c.addListener(V,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
},this);
var b=new qx.ui.basic.Atom(bc,bp);
b.setRich(true);
c.add(b);
var a=new qx.ui.tabview.TabView;
c.add(a,{flex:1});
var g=new qx.ui.tabview.Page(D);
a.add(g);
var d=new qx.ui.tabview.Page(bm);
a.add(d);
var f=new qx.ui.tabview.Page(N);
a.add(f);
},createWindow2:function(){var o=new qx.ui.window.Window(E,bg);
o.setLayout(new qx.ui.layout.VBox(10));
o.setStatus(be);
o.open();
this.getRoot().add(o,{left:350,top:120});
var y=new qx.ui.basic.Atom(Q,bv);
o.add(y);
var h=new qx.ui.container.Composite;
h.setLayout(new qx.ui.layout.HBox(10));
o.add(h,{flex:1});
var r=new qx.ui.groupbox.GroupBox(bo);
r.setLayout(new qx.ui.layout.VBox(4));
h.add(r,{flex:1});
var l=new qx.ui.form.CheckBox(bx);
l.setValue(true);
l.addListener(K,function(e){o.setShowClose(e.getData());
});
r.add(l);
var x=new qx.ui.form.CheckBox(bu);
x.setValue(true);
x.addListener(K,function(e){o.setShowMaximize(e.getData());
});
r.add(x);
var q=new qx.ui.form.CheckBox(ba);
q.setValue(true);
q.addListener(K,function(e){o.setShowMinimize(e.getData());
});
r.add(q);
var t=new qx.ui.form.CheckBox(bt);
t.setValue(true);
t.addListener(K,function(e){o.setAllowClose(e.getData());
});
r.add(t);
var z=new qx.ui.form.CheckBox(S);
z.setValue(true);
z.addListener(K,function(e){o.setAllowMaximize(e.getData());
});
r.add(z);
var n=new qx.ui.form.CheckBox(bd);
n.setValue(true);
n.addListener(K,function(e){o.setAllowMinimize(e.getData());
});
r.add(n);
var j=new qx.ui.form.CheckBox(bA);
j.setValue(false);
j.addListener(K,function(e){o.setShowStatusbar(e.getData());
});
r.add(j);
var A=new qx.ui.groupbox.GroupBox(bj);
A.setLayout(new qx.ui.layout.VBox(4));
h.add(A,{flex:1});
var v=new qx.ui.form.CheckBox(bs);
v.setValue(true);
v.addListener(K,function(e){o.setUseResizeFrame(e.getData());
});
A.add(v);
var w=[Y,H,C,T];

for(var i=0;i<w.length;i++){var u=w[i];
var m=new qx.ui.form.CheckBox(L+u).set({value:true});
m.bind(P,o,R+qx.lang.String.firstUp(u));
A.add(m);
}var k=new qx.ui.groupbox.GroupBox(W);
k.setLayout(new qx.ui.layout.VBox(4));
h.add(k,{flex:1});
var s=new qx.ui.form.CheckBox(bq);
s.setValue(true);
s.addListener(K,function(e){o.setMovable(e.getData());
});
k.add(s);
var p=new qx.ui.form.CheckBox(B);
p.addListener(K,function(e){o.setUseMoveFrame(e.getData());
});
k.add(p);
},createWindow3:function(){var bG=new qx.ui.window.Window(bw,U);
bG.setLayout(new qx.ui.layout.VBox);
bG.setMaxWidth(450);
bG.setMaxHeight(400);
bG.setAllowMaximize(false);
bG.open();
this.getRoot().add(bG,{left:100,top:250});
var bH=this.getModalWindow1();
var bI=new qx.ui.form.Button(bn,I);
bI.addListener(J,bH.open,bH);
bG.add(bI);
},getModalWindow1:function(){var bK=new qx.ui.window.Window(bl);
bK.setLayout(new qx.ui.layout.VBox(10));
bK.setModal(true);
bK.moveTo(150,150);
this.getRoot().add(bK);
var bJ=this.getModalWindow2();
var bM=new qx.ui.form.Button(bh,I);
bM.addListener(J,bJ.open,bJ);
bK.add(bM);
var bL=new qx.ui.form.CheckBox(X);
bL.setValue(true);
bK.add(bL);
bL.addListener(K,function(e){bK.setModal(e.getData());
});
return bK;
},getModalWindow2:function(){var bC=new qx.ui.window.Window(bi);
bC.setLayout(new qx.ui.layout.VBox(10));
bC.setModal(true);
bC.setShowClose(false);
bC.moveTo(300,300);
this.getRoot().add(bC);
var bB=new qx.ui.basic.Atom(bb,by);
bC.add(bB);
var bE=new qx.ui.container.Composite;
bE.setLayout(new qx.ui.layout.HBox(10,H));
bC.add(bE);
var bF=new qx.ui.form.Button(F,bk);
bF.addListener(J,function(e){bC.close();
});
bE.add(bF);
var bD=new qx.ui.form.Button(br,bz);
bD.addListener(J,function(e){alert("Sorry, please click 'Yes'!");
});
bE.add(bD);
return bC;
}}});
