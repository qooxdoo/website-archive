...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Label","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Label-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"778c658ba75c"},
  boot : "boot",
  bootIsInline : true,
...
this.getRoot().add(F);
var G=new qx.ui.basic.Label(j).set({decorator:s,width:200});
F.add(G);
this.getRoot().add(this.createConfigureButton(G,e),{left:240,top:20});
var H=new qx.ui.basic.Label(l).set({decorator:s,rich:true});
F.add(H);
this.getRoot().add(this.createConfigureButton(H,g),{left:240,top:60});
var I=new qx.ui.basic.Label(m).set({decorator:s,width:80});
F.add(I);
var J=new qx.ui.basic.Label().set({value:h,decorator:s,rich:true,width:120});
F.add(J);
var K=new qx.ui.basic.Label(a).set({decorator:s,font:new qx.bom.Font(28,[r,q])});
F.add(K);
var L=new qx.ui.basic.Label(n).set({decorator:s,font:new qx.bom.Font(28,[r,q]),width:150});
F.add(L);
...
return E;
},createEditDialog:function(u,v){var w=new qx.ui.window.Window(v).set({allowMinimize:false,showMinimize:false,allowMaximize:false,showMaximize:false});
w.moveTo(350,20);
var y=new qx.ui.layout.Grid(10,10);
y.setColumnFlex(1,1);
y.setColumnAlign(0,f,k);
w.setLayout(y);
var x=new qx.data.controller.Object(u);
w.add(new qx.ui.basic.Label(t).set({paddingTop:5}),{row:0,column:0});
var z=new qx.ui.form.TextArea().set({liveUpdate:true});
x.addTarget(z,t,t,true);
w.add(z,{row:0,column:1});
w.add(new qx.ui.basic.Label(p),{row:1,column:0});
var A=new qx.ui.form.CheckBox();
x.addTarget(A,t,p,true);
w.add(A,{row:1,column:1});
w.add(new qx.ui.basic.Label(d),{row:2,column:0});
var A=new qx.ui.form.CheckBox();
x.addTarget(A,t,b,true);
w.add(A,{row:2,column:1});
w.add(new qx.ui.basic.Label(o),{row:3,column:0});
var A=new qx.ui.form.CheckBox().set({enabled:false});
x.addTarget(A,t,o);
w.add(A,{row:3,column:1});
return w;
}}});
})();
