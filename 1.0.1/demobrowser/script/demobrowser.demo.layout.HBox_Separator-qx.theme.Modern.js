...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_Separator","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Separator-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"fa4cfd00dd9e"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var l="main",k="green",j="yellow",i="separator-horizontal",h="demobrowser.demo.layout.HBox_Separator",g="top",f="bottom",e="middle";
qx.Class.define(h,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var n=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(n);
n.add(this.getBox1());
n.add(this.getBox2());
n.add(this.getBox3());
},getBox1:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,i)).set({decorator:l,backgroundColor:j,allowGrowX:false});
m.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}));
m.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}));
m.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}));
return m;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,i)).set({decorator:l,backgroundColor:j,minHeight:60,allowGrowX:false});
o.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxHeight:40,alignY:g}));
o.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxHeight:40,alignY:e}));
o.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxHeight:40,alignY:f}));
return o;
},getBox3:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,i)).set({decorator:l,backgroundColor:j,allowGrowX:false});
var d=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var c=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var a=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
b.add(d);
b.add(c);
b.add(a);
d.setMarginRight(10);
