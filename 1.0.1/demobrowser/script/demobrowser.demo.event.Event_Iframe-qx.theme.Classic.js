...
(function(){var s="click",r="iframe",q="scroll",p="inner",o="div",n="juhu",m="contextmenu",l="input",k="load",j="keydown",g="demobrowser.demo.event.Event_Iframe",h="data/Event_2_frame.html";
qx.Class.define(g,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var t=qx.bom.Iframe.create({name:r,src:h});
t.id=r;
document.body.appendChild(t);
qx.event.Registration.addListener(t,k,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var d=window.document.getElementById(r);
var c=qx.bom.Iframe.getDocument(d);
this._juhu=c.getElementById(n);
this._inner=c.getElementById(p);
qx.event.Registration.addListener(this._juhu,m,this._preventDefault,this);
qx.event.Registration.addListener(this._inner,s,this._stopPropagation,this);
qx.event.Registration.addListener(this._juhu,s,this._onclick1,this);
qx.event.Registration.addListener(this._juhu,s,this._onclick2,this);
qx.event.Registration.addListener(c.getElementById(l),j,this._onkeydown,this);

for(var i=1;i<10;i++){var b=c.getElementById(o+i);
qx.event.Registration.addListener(b,s,this._cascadeCapture,this,true);
qx.event.Registration.addListener(b,s,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(c.getElementById(q),q,this._scroll,this);
...
},_cascadeBubble:function(e){var f=e.getCurrentTarget();
this.debug("bubble: "+f.id+" "+e.getEventPhase());
...
qx.event.Registration.removeListener(this._juhu,s,this._onclick1);
