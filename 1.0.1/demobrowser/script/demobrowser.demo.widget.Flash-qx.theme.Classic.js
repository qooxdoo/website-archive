...
(function(){var o="execute",n="Flash Player Version",m="__Cz",l="right",k="Message from Flash:",j="__CD",i="Simple demo with FlashVars",h="bgcolor",g="demobrowser.demo.widget.Flash",f="__CB",C="demobrowser/demo/flash/FlashVersion.swf",B="Flash:",A="<b>qooxdoo:</b>",z="demobrowser.demo.widget.Flash.sendMessage",y="demobrowser.demo.widget.Flash.flashReady",x="demobrowser/demo/flash/fo_tester.swf",w="this is passed in via FlashVars",v="Two way communication (ActionScript <-> JavaScript)",u="__CA",t="Message to Flash:",r="Show Flash Player version",s="noscale",p="#FF6600",q="__CC";
qx.Class.define(g,{extend:qx.application.Standalone,members:{__Cz:null,main:function(){arguments.callee.base.call(this);
var K=new qx.ui.tabview.TabView();
K.setContentPadding([8,8,8,8]);
var N=this.getRoot();
N.add(K,{edge:0});
var L=new qx.ui.tabview.Page(i);
L.setLayout(new qx.ui.layout.Canvas());
L.add(this.createFlashDemo1(),{edge:0});
K.add(L);
var M=new qx.ui.tabview.Page(v);
M.setLayout(new qx.ui.layout.Canvas());
M.add(this.createFlashDemo2(),{edge:0});
K.add(M);
this.__Cz=this.createWindow();
N.add(this.__Cz,{top:20,left:20});
},createWindow:function(){var I=new qx.ui.window.Window(n).set({width:300,height:200,contentPadding:[0,0,0,0]});
I.setLayout(new qx.ui.layout.Canvas());
I.add(new qx.ui.embed.Flash(C),{edge:0});
return I;
},createFlashDemo1:function(){var c=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var a={flashVarText:w};
var b=new qx.ui.embed.Flash(x).set({scale:s,variables:a});
b.getContentElement().setParam(h,p);
c.add(b,{flex:1});
var d=new qx.ui.form.Button(r);
d.addListener(o,function(){this.__Cz.open();
},this);
c.add(d);
return c;
},__CA:null,__CB:null,__CC:null,__CD:null,createFlashDemo2:function(){arguments.callee.self.setCallBackInstance(this);
var F=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var E=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
F.add(E,{flex:1});
E.add(new qx.ui.basic.Label(A).set({rich:true}));
E.add(new qx.ui.basic.Label(k));
this.__CB=new qx.ui.form.TextArea("No message.");
this.__CB.setEnabled(false);
E.add(this.__CB,{flex:1});
E.add(new qx.ui.basic.Label(t));
this.__CC=new qx.ui.form.TextArea("qooxdoo is the best!");
E.add(this.__CC,{flex:1});
var G=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,l));
this.__CD=new qx.ui.form.Button("Send to Flash");
this.__CD.setEnabled(false);
this.__CD.addListener(o,function(e){this.__CA.getFlashElement().sendMessage(this.__CC.getValue());
},this);
G.add(this.__CD);
E.add(G);
var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
F.add(D,{flex:1});
D.add(new qx.ui.basic.Label(B).set({rich:true}));
this.__CA=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__CA.setVariables({init:y});
D.add(this.__CA,{flex:1});
return F;
},sendMessage:function(O){this.__CB.setValue(O);
},initFlash:function(){if(this.__CA.getFlashElement().setup){this.__CA.getFlashElement().setup(z);
this.__CD.setEnabled(true);
...
}}},statics:{__CE:null,setCallBackInstance:function(H){demobrowser.demo.widget.Flash.__CE=H;
},sendMessage:function(J){demobrowser.demo.widget.Flash.__CE.sendMessage(J);
},flashReady:function(){demobrowser.demo.widget.Flash.__CE.initFlash();
}},destruct:function(){this._disposeObjects(f,q,j,u,m);
}});
})();
...
(function(){var v="Boolean",u="sameDomain",t="opaque",s="String",r="best",q="quality",p="_applyVariables",o="low",n="_applyLoop",m="scale",be="_applyAllowScriptAccess",bd="showall",bc="Map",bb="wmode",ba="excactfit",Y="_applyMenu",X="menu",W="_applyPlay",V="loop",U="allowScriptAccess",C="_applyWmode",D="noborder",A="swLiveConnect",B="qx.ui.embed.Flash",y="_applyId",z="high",w="",x="transparent",E="play",F="_applyLiveConnect",M="_applySource",K="appear",O="medium",N="flash",Q="_applyMayScript",P="_applyQuality",H="never",T="_applyScale",S="autohigh",R="always",G="window",I="noscale",J="autolow",L="mayscript";
qx.Class.define(B,{extend:qx.ui.core.Widget,construct:function(i,j){arguments.callee.base.call(this);
{};
this.setSource(i);
...
this.addListenerOnce(K,function(){this.getContentElement().createFlash();
},this);
},properties:{source:{check:s,apply:M},id:{check:s,apply:y},quality:{check:[o,J,S,O,z,r],init:r,nullable:true,apply:P},scale:{check:[bd,D,ba,I],nullable:true,apply:T},wmode:{check:[G,t,x],init:t,nullable:true,apply:C},play:{check:v,nullable:true,apply:W},loop:{check:v,nullable:true,apply:n},mayScript:{check:v,nullable:false,apply:Q},menu:{check:v,nullable:true,apply:Y},allowScriptAccess:{check:[u,R,H],init:u,nullable:true,apply:be},liveConnect:{check:v,init:true,nullable:true,apply:F},variables:{init:{},check:bc,apply:p}},members:{getFlashElement:function(){var bq=this.getContentElement();

if(bq){return bq.getFlashElement();
}else{return null;
}},_createContentElement:function(){return new qx.html.Flash();
},_applySource:function(bl,bm){var bn=qx.util.ResourceManager.getInstance().toUri(bl);
this.getContentElement().setSource(bn);
qx.ui.core.queue.Layout.add(this);
},_applyId:function(bh,bi){this.getContentElement().setId(bh);
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(bv,bw){this.getContentElement().setVariables(bv);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(e,f){this.getContentElement().setAttribute(L,e?w:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(br,bs){this.__CF(q,br);
},_applyScale:function(bf,bg){this.__CF(m,bf);
},_applyWmode:function(bt,bu){this.__CF(bb,bt);
},_applyPlay:function(c,d){this.__CF(E,c);
},_applyLoop:function(bo,bp){this.__CF(V,bo);
},_applyMenu:function(k,l){this.__CF(X,k);
},_applyAllowScriptAccess:function(a,b){this.__CF(U,a);
},_applyLiveConnect:function(g,h){this.__CF(A,g);
},__CF:function(bj,bk){this.getContentElement().setParam(bj,bk);
qx.ui.core.queue.Layout.add(this);
}}});
})();
(function(){var f="movie",e="id",d="div",c="qx.html.Flash";
qx.Class.define(c,{extend:qx.html.Element,construct:function(){arguments.callee.base.call(this);
this.__CG={};
this.__CH={};
this.__CI={};
},members:{__CG:null,__CI:null,__CH:null,__CJ:null,_createDomElement:function(){return qx.bom.Element.create(d);
},createFlash:function(){this.__CJ=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__CH,this.__CG);
},setSource:function(g){{};

if(this.__CJ){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(f,g);
},setId:function(a){{};

if(this.__CJ){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(e,a);
},getVariables:function(){return this.__CH;
},setVariables:function(b){{};

if(this.__CJ){throw new Error("The variables cannot be modified after initial creation");
}this.__CH=b;
},getAttributes:function(){return this.__CI;
},setAttribute:function(h,i){{};

if(this.__CJ){throw new Error("The attributes cannot be modified after initial creation");
}
if(i===null||i===undefined){delete this.__CI[h];
}else{this.__CI[h]=i;
}},getParams:function(){return this.__CG;
},setParam:function(j,k){{};

if(this.__CJ){throw new Error("The params cannot be modified after initial creation");
}
if(k===null||k===undefined){delete this.__CG[j];
}else{this.__CG[j]=k;
}},getFlashElement:function(){return this.__CJ;
}},destruct:function(){if(this.__CJ){qx.bom.Flash.destroy(this.__CJ);
}this.__CG=this.__CH=this.__CI=null;
}});
})();
