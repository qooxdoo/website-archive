...
C.add(B,{flex:1});
return C;
},getBox2:function(){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:500,allowGrowX:false});
...
return u;
},getBox5:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:j,backgroundColor:g,width:200,allowGrowX:false});
...
q.add(s,{width:h,flex:1});
q.add(r,{width:h,flex:1});
q.add(p,{width:h,flex:1});
return q;
