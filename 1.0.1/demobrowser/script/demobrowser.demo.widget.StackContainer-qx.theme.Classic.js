...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.StackContainer-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"b93938946599"},
  boot : "boot",
  bootIsInline : true,
...
var D=new qx.ui.form.Button(r,k);
var B=new qx.ui.form.Button(s,p);
y.add(D);
y.add(B);
this.getRoot().add(y,{left:250,top:150});
D.addListener(x,A.previous,A);
B.addListener(x,A.next,A);
var C=[t,u,j,n,v,w,q];
var z;
...
A.add(z);
}A.addListener(o,function(e){var E=e.getData()[0];
this.debug("Selected: "+E.getBackgroundColor()+" ("+E.getWidth()+"x"+E.getHeight()+")");
});
A.addListener(h,function(e){var F=this.getBounds();
