...
(function(){var z="execute",y="smile",x="Jack",w=".png",v="kiss",u="demobrowser.demo.data.ListControllerWithObjects",t="emote",s="green",r="Jim",q="<b>Displaying objects in a list</b><br/>",V="Make all happy",U="sad",T="plain",S="surprise",R="embarrassed",Q="online",P=" a converter by the icon. The font color shows the online status.",O="name",N="Write data to log",M="Jackob",G="textColor",H="have a name and an emotion, which is displayed with the help of ",E="This list display a set of persons in a list. Every person does ",F="Dan",C="Tim",D="Karl",A="Online <> Offline",B="icon/16/emotes/face-",I="Dustin",J="angel",L="Max",K="red";
qx.Class.define(u,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var o=[L,M,C,x,F,I,D,r];
var e=[R,v,T,U,S,J];
var l=[];

for(var i=0;i<20;i++){var h=new demobrowser.demo.data.model.Person();
h.setName(o[i%o.length]);
h.setEmote(e[i%e.length]);
h.setOnline(i%3==0);
l.push(h);
...
var n={converter:function(bb){return B+bb+w;
}};
var j=new qx.data.controller.List(m,d,O);
j.setIconOptions(n);
j.setIconPath(t);
var g={converter:function(p){if(p){return s;
}else{return K;
}}};
var b={bindItem:function(W,X,Y){W.bindDefaultProperties(X,Y);
W.bindProperty(Q,G,g,X,Y);
}};
j.setDelegate(b);
var c=new qx.ui.form.Button(V);
c.setWidth(120);
this.getRoot().add(c,{left:180,top:80});
c.addListener(z,function(){for(var i=0;i<m.length;i++){var ba=m.getItem(i);
ba.setEmote(y);
}},this);
var a=new qx.ui.form.Button(A);
a.setWidth(120);
this.getRoot().add(a,{left:180,top:115});
a.addListener(z,function(){for(var i=0;i<m.length;i++){m.getItem(i).toggleOnline();
}},this);
var k=new qx.ui.form.Button(N);
k.setWidth(120);
this.getRoot().add(k,{left:180,top:150});
k.addListener(z,function(){qx.log.appender.Console.show();
