...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Pane_GridLines-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"0cabe2466bbf"},
  boot : "boot",
  bootIsInline : true,
