...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.Finder","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.Finder-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"56bc2dc118ca"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var p="name",o="model",n="selection[0].files",m="Finder",l="json/finder.json",k="model.files",j="demobrowser.demo.data.Finder";
qx.Class.define(j,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var b=new qx.ui.window.Window(m);
b.setLayout(new qx.ui.layout.HBox());
b.setContentPadding(0);
b.setShowMaximize(false);
b.setShowMinimize(false);
b.setShowClose(false);
b.open();
var c=new qx.ui.form.List();
b.add(c);
var e=new qx.ui.form.List();
b.add(e);
var d=new qx.ui.form.List();
b.add(d);
var h=new qx.data.controller.List(null,c);
h.setLabelPath(p);
var g=new qx.data.controller.List(null,e);
g.setLabelPath(p);
var f=new qx.data.controller.List(null,d);
f.setLabelPath(p);
var a=l;
var i=new qx.data.store.Json(a);
i.bind(k,h,o);
h.bind(n,g,o);
g.bind(n,f,o);
}}});
