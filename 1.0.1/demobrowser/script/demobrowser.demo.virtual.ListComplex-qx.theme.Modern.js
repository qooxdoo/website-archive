...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.ListComplex","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.ListComplex-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c761244695c5"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var h=" / ",g="row",f="foobar!",e="column",d="demobrowser.demo.virtual.DemoLayer",c="mouseover",b="changeValue",a="qx.ui.basic.Atom";
qx.Class.define(d,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){arguments.callee.base.call(this,this);
this._pool={atom:[],checkbox:[]};
this.__FA=[];
},members:{_pool:null,__FA:null,getCellData:function(i,k){if(!this.__FA[i]){this.__FA[i]=[];
}
if(!this.__FA[i][k]){this.__FA[i][k]={label:this.__FB(),icon:this.__FC()};
}return this.__FA[i][k];
},getCellWidget:function(m,n){var o;

if(n%2==0){o=this._pool.atom.pop();

if(!o){o=new qx.ui.basic.Atom();
o.addListener(c,function(){var l=this.__FC();
o.setIcon(l);
this.__FA[m][n].icon=l;
},this);
}o.set(this.getCellData(m,n));
}else{o=this._pool.checkbox.pop();

if(!o){o=new qx.ui.form.CheckBox();
o.addListener(b,function(){this.setLabel(this.getLabel()==f?o.getUserData(g)+h+o.getUserData(e):f);
},o);
}o.set({value:m%2==0,label:m+h+n});
}o.setUserData(g,m);
o.setUserData(e,n);
return o;
},poolCellWidget:function(p){if(p.classname==a){this._pool.atom.push(p);
}else{this._pool.checkbox.push(p);
}},__FB:function(){var name="";

for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);
}return name;
},__FC:function(){var q="icon/";
var s="places/";
var t=["folder.png","user-trash.png","network-server.png","network-workgroup.png","user-desktop.png"];
var r=Math.floor(Math.random()*4);
return (q+16+"/"+s+t[r]);
}},destruct:function(){this._pool=this.__FA=null;
}});
})();
