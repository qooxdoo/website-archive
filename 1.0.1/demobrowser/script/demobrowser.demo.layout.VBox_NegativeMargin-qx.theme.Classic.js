...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e2134cb77057"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var n="main",m="yellow",l="gray",k="blue",j="center",i="green",h="left",g="right",f="demobrowser.demo.layout.VBox_NegativeMargin";
...
I.add(this.getBox6());
I.add(this.getBox7());
},getBox1:function(){var o=new qx.ui.layout.VBox();
var q=new qx.ui.container.Composite(o).set({decorator:n,backgroundColor:m,width:140,allowGrowY:false});
var s=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var r=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var p=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
q.add(s);
q.add(r);
q.add(p);
r.setMarginTop(-10);
p.setMarginTop(-10);
return q;
},getBox2:function(){var t=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(t).set({decorator:n,backgroundColor:m,width:140,allowGrowY:false});
var x=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var w=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var u=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
v.add(x);
v.add(w);
v.add(u);
w.setMarginTop(-10);
...
var A=new qx.ui.container.Composite(y).set({decorator:n,backgroundColor:m,width:140,height:300,allowGrowY:false});
var C=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var B=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var z=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
A.add(C,{flex:1});
A.add(B,{flex:1});
A.add(z,{flex:1});
B.setMarginTop(-10);
...
var L=new qx.ui.container.Composite(J).set({decorator:n,backgroundColor:m,width:140,height:300,allowGrowY:false});
var N=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var M=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var K=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
L.add(N,{flex:1});
L.add(M,{flex:2});
L.add(K,{flex:3});
M.setMarginTop(-10);
K.setMarginTop(-10);
return L;
},getBox5:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:n,backgroundColor:m,width:140,height:300,allowGrowY:false});
var e=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var d=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var b=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
c.add(e,{flex:1});
c.add(d,{flex:2});
c.add(b,{flex:3});
d.setMarginTop(-10);
...
b.setHeight(0);
return c;
},getBox6:function(){var O=new qx.ui.layout.VBox();
var Q=new qx.ui.container.Composite(O).set({decorator:n,backgroundColor:m,width:140,height:100,allowGrowY:false});
var S=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var R=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var P=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
Q.add(S,{flex:1});
...
P.setMarginTop(-10);
return Q;
},getBox7:function(){var D=new qx.ui.layout.VBox();
var F=new qx.ui.container.Composite(D).set({decorator:n,backgroundColor:m,width:140,height:100,allowGrowY:false});
var H=new qx.ui.core.Widget().set({decorator:n,backgroundColor:k,maxWidth:100,alignX:h});
var G=new qx.ui.core.Widget().set({decorator:n,backgroundColor:i,maxWidth:100,alignX:j});
var E=new qx.ui.core.Widget().set({decorator:n,backgroundColor:l,maxWidth:100,alignX:g});
F.add(H,{flex:1});
F.add(G,{flex:2});
F.add(E,{flex:3});
G.setMarginTop(-10);
