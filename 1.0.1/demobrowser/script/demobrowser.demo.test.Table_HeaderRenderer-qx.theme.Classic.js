...
(function(){var m="Name",l="hovered",k="tool tip",j="icon/16/apps/internet-feed-reader.png",i="mouseover",h="demobrowser.demo.test.Table_HeaderRenderer",g="_container",f="mouseout";
...
},testDefaultRenderer:function(){var t=new qx.ui.table.headerrenderer.Default();
t.setToolTip(k);
var r={name:[m],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var s=this._getNewHeaderContainer();
qx.util.Permutation.permute(r,function(n){var o=t.createHeaderCell(n);
s.add(o);
t.updateHeaderCell(n,o);
});
},testIconRenderer:function(){var c=new qx.ui.table.headerrenderer.Icon(j);
c.setToolTip(k);
var a={name:[m],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var b=this._getNewHeaderContainer();
qx.util.Permutation.permute(a,function(p){var q=c.createHeaderCell(p);
b.add(q);
c.updateHeaderCell(p,q);
});
},_getNewHeaderContainer:function(){var d=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
d.addListener(i,function(e){e.getTarget().addState(l);
});
d.addListener(f,function(e){e.getTarget().removeState(l);
});
