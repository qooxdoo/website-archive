...
(function(){var e="Window: ",d="interval",c="__zi",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__zg:null,__zh:0,__zi:null,main:function(){arguments.callee.base.call(this);
this.__zg=[];
this.currentTest=this.testWindows;
this.__zi=new qx.event.Timer(1000);
this.__zi.addListener(d,this.runTest,this);
this.__zi.start();
},runTest:function(){this.__zh++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__zh+" (Registry: "+g+")");
this.currentTest();
...
},testLabels:function(){for(var i=0;i<250;i++){var j=new qx.ui.basic.Label(b+i);
this.getRoot().add(j,{left:50,top:50+i*20});
this.__zg.push(j);
}},testWindows:function(){for(var i=0;i<5;i++){var h=new qx.ui.window.Window(e+i);
h.open();
this.__zg.push(h);
