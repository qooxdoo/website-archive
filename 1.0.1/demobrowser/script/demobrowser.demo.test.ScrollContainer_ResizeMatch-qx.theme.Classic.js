...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"da3eaa9f6885"},
  boot : "boot",
  bootIsInline : true,
