...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Spacer_Grid","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Spacer_Grid-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"030f6ce2ba3e"},
  boot : "boot",
  bootIsInline : true,
...
var g=new qx.ui.layout.VBox();
g.setSpacing(10);
var f=new qx.ui.container.Composite(g);
f.setPadding(20);
this.getRoot().add(f,{edge:0});
f.add(this.getGrid1());
f.add(this.getGrid2());
},getGrid1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:e,backgroundColor:c,allowGrowX:false,allowGrowY:false});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:0,column:0});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:0,column:1});
h.add(new qx.ui.core.Spacer(0,10),{row:1,column:0});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:2,column:0});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:2,column:1});
h.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:4,column:0});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{row:4,column:1});
return h;
