...
qx.Class.define(s,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(d,f){var g=new qx.ui.form.Spinner();
...
g.addListener(i,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(C,D){var E=new qx.ui.form.Spinner(0,50,100);
E.setEditable(false);
C.add(new qx.ui.basic.Label(t),{column:0,row:D});
C.add(new qx.ui.basic.Label(y),{column:1,row:D});
C.add(E,{column:2,row:D});
C.add(new qx.ui.basic.Label(w),{column:3,row:D});
},addWrappingSpinner:function(z,A){var B=new qx.ui.form.Spinner(-30,30,30);
B.setWrap(true);
z.add(new qx.ui.basic.Label(q),{column:0,row:A});
z.add(new qx.ui.basic.Label(h),{column:1,row:A});
z.add(B,{column:2,row:A});
z.add(new qx.ui.basic.Label(j),{column:3,row:A});
},addSteppedSpinner:function(H,I){var J=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
H.add(new qx.ui.basic.Label(r),{column:0,row:I});
H.add(new qx.ui.basic.Label(p),{column:1,row:I});
H.add(J,{column:2,row:I});
H.add(new qx.ui.basic.Label(m),{column:3,row:I});
},addDisabledSpinner:function(a,b){var c=new qx.ui.form.Spinner;
c.setEnabled(false);
a.add(new qx.ui.basic.Label(u),{column:0,row:b});
a.add(new qx.ui.basic.Label(y),{column:1,row:b});
a.add(c,{column:2,row:b});
a.add(new qx.ui.basic.Label(w),{column:3,row:b++});
},addFormattedSpinner:function(K,L){var M=new qx.ui.form.Spinner(0,200,300);
M.setSingleStep(0.5);
M.setWidth(70);
...
M.setNumberFormat(N);
K.add(new qx.ui.basic.Label(k),{column:0,row:L});
K.add(new qx.ui.basic.Label(y),{column:1,row:L});
K.add(M,{column:2,row:L});
K.add(new qx.ui.basic.Label(o),{column:3,row:L++});
},main:function(){arguments.callee.base.call(this);
var G=new qx.ui.layout.Grid(10,8);
G.setColumnAlign(0,v,x);
G.setColumnAlign(1,n,x);
G.setColumnAlign(2,v,x);
G.setColumnAlign(3,v,x);
var F=new qx.ui.container.Composite(G);
F.setPadding(10);
this.getRoot().add(F,{left:0,top:0});
this.addSimpleSpinner(F,0);
this.addNonEditableSpinner(F,1);
this.addWrappingSpinner(F,2);
this.addSteppedSpinner(F,3);
this.addDisabledSpinner(F,4);
this.addFormattedSpinner(F,5);
}}});
})();
