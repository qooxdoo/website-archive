...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.showcase.Dialog-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"43eea7ba9290"},
  boot : "boot",
  bootIsInline : true,
