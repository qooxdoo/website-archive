...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Messenger-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"dc2845a83201"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var w="execute",v="middle",u="",t="away",s="offline",r="value",q="online",p="icon",o="busy",n="selection[0].status",bh="right",bg="selection[0]",bf="separator-vertical",be="Escape",bd="Cancel",bc="qooxdoo",bb="Group: ",ba="Friends",Y="Name:",X="Enter",D="source",E="Group:",B="demobrowser/demo/icons/imicons/user_delete.png",C="center",z="enabled",A="icon/16/actions/list-add.png",x="group",y="Name: ",F="name",G="keypress",N="modelSelection",L="top",R="Contacts",P="Status: ",T="selection",S="Add",I="Contact Details",W="Add user",V="model",U="appear",H="New Group",J="avatar",K="left",M="Avatar: ",O="demobrowser.demo.virtual.Messenger",Q="demobrowser/demo/icons/imicons/user_add.png";
qx.Class.define(O,{extend:qx.application.Standalone,members:{__Fj:null,messenger:null,__Fk:null,main:function(){arguments.callee.base.call(this);
var a=this.getRoot();
var d=new qx.ui.window.Window(R).set({contentPadding:0,showClose:false,showMinimize:false});
...
var b=demobrowser.demo.virtual.messenger.BuddyModel.createBuddies(200);
this.messenger.setModel(b);
d.add(this.createToolbar());
d.add(this.messenger,{flex:1});
a.add(this.createDetailsView(),{left:20,top:20});
},createToolbar:function(){var toolbar=new qx.ui.toolbar.ToolBar();
var bx=new qx.ui.toolbar.Part();
toolbar.add(bx);
var bv=new qx.ui.toolbar.Button(u,Q).set({show:p});
bv.addListener(w,this.showAddContactWindow,this);
bx.add(bv);
var bw=new qx.ui.toolbar.Button(u,B).set({show:p});
this.messenger.bind(bg,bw,z,{converter:function(bi){return !!bi;
}});
bw.addListener(w,function(){this.messenger.getModel().remove(this.messenger.getSelection().getItem(0));
},this);
bx.add(bw);
return bx;
},createDetailsView:function(){var j=new qx.data.controller.Object();
this.messenger.bind(bg,j,V);
var g=new qx.ui.groupbox.GroupBox(I);
var k=new qx.ui.layout.Grid(5,5);
k.setColumnAlign(0,bh,v);
g.setLayout(k);
g.add(new qx.ui.basic.Label(y),{row:0,column:0});
var m=new qx.ui.form.TextField();
j.addTarget(m,r,F,true);
g.add(m,{row:0,column:1});
g.add(new qx.ui.basic.Label(bb),{row:1,column:0});
var h=new qx.ui.form.TextField();
j.addTarget(h,r,x,true);
g.add(h,{row:1,column:1});
g.add(new qx.ui.basic.Label(P),{row:2,column:0});
var l=new qx.ui.form.SelectBox();
l.add(new qx.ui.form.ListItem(q).set({model:q}));
l.add(new qx.ui.form.ListItem(t).set({model:t}));
l.add(new qx.ui.form.ListItem(o).set({model:o}));
l.add(new qx.ui.form.ListItem(s).set({model:s}));
this.messenger.bind(n,l,N,{converter:function(bk){return [bk];
}});
l.bind(T,this.messenger,n,{converter:function(bj){return bj[0].getModel();
}});
g.add(l,{row:2,column:1});
g.add(new qx.ui.basic.Label(M).set({alignY:L}),{row:3,column:0});
var i=new qx.ui.basic.Image().set({alignX:C});
j.addTarget(i,D,J);
g.add(i,{row:3,column:1});
return g;
},showAddContactWindow:function(){if(this.__Fj==null){var bl=new qx.ui.layout.Grid(5,10);
var bn=new qx.ui.window.Window(W,A);
bn.set({width:165,height:100,showMinimize:false,showClose:false,showMaximize:false});
bn.setLayout(bl);
var bq=new qx.ui.basic.Label(Y);
var br=new qx.ui.form.TextField();
var bo=new qx.ui.form.ComboBox(H);
bo.add(new qx.ui.form.ListItem(bc));
bo.add(new qx.ui.form.ListItem(ba));
var bm=new qx.ui.basic.Label(E);
var bt=new qx.ui.form.Button(S);
var bs=new qx.ui.form.Button(bd);
this.__Fk=br;
bt.setAllowGrowX(false);
bs.setAllowGrowX(false);
bn.addListener(U,br.focus,br);
bs.addListener(w,bn.close,bn);
var bp=function(){var bu=new demobrowser.demo.virtual.messenger.BuddyModel();
bu.setName(br.getValue());
bu.setGroup(bo.getValue());
this.messenger.getModel().push(bu);
this.messenger.getSelection().setItem(0,bu);
bn.close();
};
bt.addListener(w,bp,this);
bn.addListener(G,function(e){var f=e.getKeyIdentifier();

if(f==X){bp.call(this);
}else if(f==be){bn.close();
}},this);
bn.add(bq,{row:0,column:0});
bn.add(br,{row:0,column:1,colSpan:2});
bn.add(bm,{row:1,column:0});
bn.add(bo,{row:1,column:1,colSpan:2});
bn.add(bt,{row:2,column:1});
bn.add(bs,{row:2,column:2});
bl.setColumnAlign(0,K,v);
bl.setColumnAlign(1,bh,v);
this.getRoot().add(bn,{left:20,top:20});
this.__Fj=bn;
}this.__Fk.setValue(u);
this.__Fj.center();
this.__Fj.open();
...
(function(){var i="scrollY",h="update",g="scrollX",f="__Dr",d="pane",c="qx.ui.virtual.core.Scroller";
qx.Class.define(c,{extend:qx.ui.core.scroll.AbstractScrollArea,construct:function(l,m,n,o){arguments.callee.base.call(this);
this.__Dr=new qx.ui.virtual.core.Pane(l,m,n,o);
this.__Dr.addListener(h,this._computeScrollbars,this);
this.__Dr.addListener(g,this._onScrollPaneX,this);
this.__Dr.addListener(i,this._onScrollPaneY,this);
this._add(this.__Dr,{row:0,column:0});
},properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__Dr:null,getPane:function(){return this.__Dr;
},_createChildControlImpl:function(k){if(k==d){return this.__Dr;
}else{return arguments.callee.base.call(this,k);
}},getItemTop:function(b){throw new Error("The method 'getItemTop' is not implemented!");
},getItemBottom:function(p){throw new Error("The method 'getItemBottom' is not implemented!");
},getItemLeft:function(j){throw new Error("The method 'getItemLeft' is not implemented!");
},getItemRight:function(a){throw new Error("The method 'getItemRight' is not implemented!");
},_onScrollBarX:function(e){this.__Dr.setScrollX(e.getData());
},_onScrollBarY:function(e){this.__Dr.setScrollY(e.getData());
}},destruct:function(){this._disposeObjects(f);
}});
})();
(function(){var bb="row-layer",ba="selected",Y="grid-lines",X="Boolean",W="Integer",V="cell.row",U="cell.renderer",T="_applyDelegate",S="qx.ui.virtual.form.List",R="Object",bq="_applyCellRenderer",bp="changeRowHeight",bo="_applyRowCount",bn="changeCellRenderer",bm="_applyShowGridLines",bl="resize",bk="changeShowGridLines",bj="__Ei",bi="changeDelegate",bh="_applyUseWidgetCells",bf="changeRowCount",bg="_applyRowHeight",bd="horizontal",be="__Eh",bc="virtual-list";
qx.Class.define(S,{extend:qx.ui.virtual.core.Scroller,construct:function(){arguments.callee.base.call(this,0,1,20,100);
qx.ui.core.queue.Widget.add(this);
this.getPane().addListener(bl,this._onResize,this);
this._initSelectionManager();
this.initRowHeight();
this.initDelegate();
},properties:{appearance:{refine:true,init:bc},rowCount:{check:W,event:bf,init:0,apply:bo},rowHeight:{check:W,event:bp,init:20,apply:bg,themeable:true},showGridLines:{check:X,event:bk,init:false,apply:bm,themeable:true},useWidgetCells:{check:X,init:false,apply:bh,themeable:true},cellRenderer:{event:bn,apply:bq,themeable:true},delegate:{check:R,event:bi,init:null,nullable:true,apply:T}},members:{__Eg:null,__Eh:null,__Ei:null,__Ej:null,_initWidgetLayer:function(){var self=this;
var a={getCellWidget:function(d,f){var k=self._getCellData(d);

if(!k){return null;
}var g={};

if(self.__Eh.isItemSelected(d)){g.selected=true;
}var h=self._getCellRenderer(d);
var j=h.getCellWidget(k,g);
j.setUserData(V,d);
j.setUserData(U,h);
return j;
},poolCellWidget:function(z){var A=z.getUserData(U);
A.pool(z);
}};
this._showChildControl(bb);
this.__Ei=new qx.ui.virtual.layer.WidgetCell(a);
this.getPane().addLayer(this.__Ei);

if(!this.__Eg){this.setCellRenderer(qx.ui.virtual.form.ListItemCell.getInstance());
}},_initHtmlLayer:function(){var self=this;
var M={getCellProperties:function(B,C){var D={};

if(self.__Eh.isItemSelected(B)){D.selected=true;
}return self._getCellRenderer(B).getCellProperties(self._getCellData(B),D);
}};
this._showChildControl(bb);
this.__Ei=new qx.ui.virtual.layer.HtmlCell(M);
this.getPane().addLayer(this.__Ei);

if(!this.__Eg){this.setCellRenderer(new qx.ui.virtual.cell.Cell());
}},_initSelectionManager:function(){var self=this;
var Q={isItemSelectable:function(P){return self._delegate.isRowSelectable?self._delegate.isRowSelectable(P):true;
},styleSelectable:function(u,v,w){if(self.__Ej){self._styleWidgetSelectable(u,v,w);
}else{self._styleHtmlSelectable(u,v,w);
}}};
this.__Eh=new qx.ui.virtual.selection.Row(this.getPane(),Q);
this.__Eh.attachMouseEvents(this.getPane());
this.__Eh.attachKeyEvents(this);
},getSelectionManager:function(){return this.__Eh;
},_createChildControlImpl:function(E){var F;

switch(E){case bb:F=new qx.ui.virtual.layer.Row(null,null);
this.getPane().addLayer(F);
break;
case Y:F=new qx.ui.virtual.layer.GridLines(bd);
this.getPane().addLayer(F);
break;
}return F||arguments.callee.base.call(this,E);
},update:function(){if(this.__Ei){this.__Ei.updateLayerData();
}},_applyRowCount:function(x,y){this.getPane().getRowConfig().setItemCount(x);
},_applyRowHeight:function(bt,bu){this.getPane().getRowConfig().setDefaultItemSize(bt);
},_applyShowGridLines:function(G,H){if(G){this._showChildControl(Y);
}else{this._excludeChildControl(Y);
}},_applyDelegate:function(br,bs){this._delegate=br||{};
},_applyUseWidgetCells:function(s,t){if(this.__Ej!==null){throw new Error("The property 'useWidgetCells' cannot be set after the list has "+"been rendered.");
}},_applyCellRenderer:function(b,c){this.__Eg=b;

if(this.__Ei){this.__Ei.fullUpdate();
}},_getCellData:function(O){return this._delegate.getCellData?this._delegate.getCellData(O):null;
},_getCellRenderer:function(N){return this._delegate.getCellRenderer?this._delegate.getCellRenderer(N):this.__Eg;
},_styleHtmlSelectable:function(I,J,K){if(J!==ba){return;
}var L=this.getChildControl(bb);

if(K){L.setBackground(I,ba);
}else{L.setBackground(I,null);
}this.__Ei.updateLayerData();
},_styleWidgetSelectable:function(l,m,n){if(m!==ba){return;
}var o=this.__Ei.getChildren();

for(var i=0;i<o.length;i++){var p=o[i];
var r=p.getUserData(V);
...
}}},syncWidget:function(){if(this.__Ej!==null){return;
}this.__Ej=this.getUseWidgetCells();

if(this.__Ej){this._initWidgetLayer();
}else{this._initHtmlLayer();
}},_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);
}},destruct:function(){this._delegate=this.__Eg=null;
this._disposeObjects(be,bj);
}});
})();
(function(){var l="model",k="changeModel",j="demobrowser.demo.virtual.messenger.Roster",i="qx.data.Array",h="rgb(238, 243, 255)",g="row-layer",f="off",e="white",d="changeSelection",c="rgb(60, 97, 226)",b="auto";
qx.Class.define(j,{extend:qx.ui.virtual.form.List,construct:function(){arguments.callee.base.call(this);
this.set({scrollbarX:f,scrollbarY:b,width:200,height:300,rowHeight:28,useWidgetCells:true,decorator:null});
var a=new demobrowser.demo.virtual.messenger.Controller(null,this);
this.bind(l,a,l);
this.setSelection(a.getSelection());
this.rowLayer=this.getChildControl(g);
this.rowLayer.set({colorEven:e,colorOdd:h});
this.getPane().addLayer(this.rowLayer);
new qx.ui.virtual.behavior.Prefetch(this,0,0,0,0,600,800,600,800).set({interval:500});
},properties:{model:{event:k,check:i,nullable:true},selection:{event:d}},members:{styleGroup:function(m){var n=c;
...
(function(){var F="appear",E="qx.ui.virtual.core.CellEvent",D="qx.event.type.Data",C="change",B="scrollY",A="full update",z="__Ds",y="dblclick",x="update layer window",w="qx.event.type.Event",U="cellContextmenu",T="__DA",S="resize",R="scrollX",Q="__Dt",P="cellDblclick",O="qx.ui.virtual.core.Pane",N="click",M="update",L="prefetch x",J="contextmenu",K="cellClick",H="prefetch y",I="__DB",G="scroll";
qx.Class.define(O,{extend:qx.ui.core.Widget,construct:function(bW,bX,bY,ca){arguments.callee.base.call(this);
this.__Ds=new qx.ui.virtual.core.Axis(bY,bW);
this.__Dt=new qx.ui.virtual.core.Axis(ca,bX);
this.__Du=0;
this.__Dv=0;
this.__Dw=0;
this.__Dx=0;
this.__Dy={};
this.__Dz={};
this.__DA=new qx.ui.container.Composite();
this.__DA.setUserBounds(0,0,0,0);
this._add(this.__DA);
this.__DB=[];
this.__Ds.addListener(C,this.fullUpdate,this);
this.__Dt.addListener(C,this.fullUpdate,this);
this.addListener(S,this._onResize,this);
this.addListenerOnce(F,this._onAppear,this);
this.addListener(N,this._onClick,this);
this.addListener(y,this._onDblclick,this);
this.addListener(J,this._onContextmenu,this);
},events:{cellClick:E,cellContextmenu:E,cellDblclick:E,update:w,scrollX:D,scrollY:D},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__Ds:null,__Dt:null,__Du:null,__Dv:null,__Dw:null,__Dx:null,__Dy:null,__Dz:null,__DA:null,__DB:null,__DC:null,__DD:null,__DE:null,DEBUG:false,getRowConfig:function(){return this.__Ds;
},getColumnConfig:function(){return this.__Dt;
},getChildren:function(){return [this.__DA];
},addLayer:function(ba){{};
this.__DB.push(ba);
ba.setUserBounds(0,0,0,0);
this.__DA.add(ba);
},getLayers:function(){return this.__DB;
},getVisibleLayers:function(){var cb=[];

for(var i=0;i<this.__DB.length;i++){var cc=this.__DB[i];

if(cc.isVisible()){cb.push(cc);
}}return cb;
},getScrollMaxX:function(){var V=this.getBounds();

if(V){return Math.max(0,this.__Dt.getTotalSize()-V.width);
}return 0;
},getScrollMaxY:function(){var bc=this.getBounds();

if(bc){return Math.max(0,this.__Ds.getTotalSize()-bc.height);
}return 0;
},setScrollY:function(W){var X=this.getScrollMaxY();

if(W<0){W=0;
}else if(W>X){W=X;
}
if(this.__Du!==W){var Y=this.__Du;
this.__Du=W;
this._deferredUpdateScrollPosition();
this.fireDataEvent(B,W,Y);
}},getScrollY:function(){return this.__Du;
},setScrollX:function(a){var b=this.getScrollMaxX();

if(a<0){a=0;
}else if(a>b){a=b;
}
if(a!==this.__Dv){var c=this.__Dv;
this.__Dv=a;
this._deferredUpdateScrollPosition();
this.fireDataEvent(R,a,c);
}},getScrollX:function(){return this.__Dv;
},getScrollSize:function(){return {width:this.__Dt.getTotalSize(),height:this.__Ds.getTotalSize()};
},scrollRowIntoView:function(bd){var bg=this.getBounds();

if(!bg){this.addListenerOnce(F,function(){this.scrollRowIntoView(bd);
},this);
return;
}var bh=this.__Ds.getItemPosition(bd);
var bf=bh+this.__Ds.getItemSize(bd);
var be=this.getScrollY();

if(bh<be){this.setScrollY(bh);
}else if(bf>be+bg.height){this.setScrollY(bf-bg.height);
}},scrollColumnIntoView:function(bR){var bU=this.getBounds();

if(!bU){this.addListenerOnce(F,function(){this.scrollColumnIntoView(bR);
},this);
return;
}var bT=this.__Dt.getItemPosition(bR);
var bS=bT+this.__Dt.getItemSize(bR);
var bV=this.getScrollX();

if(bT<bV){this.setScrollX(bT);
}else if(bS>bV+bU.width){this.setScrollX(bS-bU.width);
}},scrollCellIntoView:function(bO,bP){var bQ=this.getBounds();

if(!bQ){this.addListenerOnce(F,function(){this.scrollCellIntoView(bO,bP);
},this);
return;
}this.scrollColumnIntoView(bO);
this.scrollRowIntoView(bP);
},getCellAtPosition:function(g,h){var j,k;
var l=this.getContentLocation();

if(!l||h<l.top||h>=l.bottom||g<l.left||g>=l.right){return null;
}j=this.__Ds.getItemAtPosition(this.getScrollY()+h-l.top);
k=this.__Dt.getItemAtPosition(this.getScrollX()+g-l.left);

if(!j||!k){return null;
}return {row:j.index,column:k.index};
},prefetchX:function(m,n,o,p){var q=this.getVisibleLayers();

if(q.length==0){return;
}var s=this.getBounds();

if(!s){return;
}var t=this.__Dv+s.width;
var u=this.__Dx-t;

if(this.__Dv-this.__Dy.left<Math.min(this.__Dv,m)||this.__Dy.right-t<Math.min(u,o)){this.DEBUG&&console.log(L);
var v=Math.min(this.__Dv,n);
var r=Math.min(u,p);
this._setLayerWindow(q,this.__Dv-v,this.__Du,s.width+v+r,s.height,false);
}},prefetchY:function(bB,bC,bD,bE){var bF=this.getVisibleLayers();

if(bF.length==0){return;
}var bI=this.getBounds();

if(!bI){return;
}var bG=this.__Du+bI.height;
var bH=this.__Dw-bG;

if(this.__Du-this.__Dy.top<Math.min(this.__Du,bB)||this.__Dy.bottom-bG<Math.min(bH,bD)){this.DEBUG&&console.log(H);
var bK=Math.min(this.__Du,bC);
var bJ=Math.min(bH,bE);
this._setLayerWindow(bF,this.__Dv,this.__Du-bK,bI.width,bI.height+bK+bJ,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__DC=true;
this._updateScrollPosition();
this.__DC=null;
this.fireEvent(M);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__DF(e,K);
},_onContextmenu:function(e){this.__DF(e,U);
},_onDblclick:function(e){this.__DF(e,P);
},__DF:function(e,cd){var ce=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());

if(!ce){return;
}this.fireNonBubblingEvent(cd,qx.ui.virtual.core.CellEvent,[this,e,ce.row,ce.column]);
},syncWidget:function(){if(this.__Dz._fullUpdate){this._fullUpdate();
}else if(this.__Dz._updateScrollPosition){this._updateScrollPosition();
}this.__Dz={};
},_setLayerWindow:function(bi,bj,top,bk,bl,bm){var br=this.__Ds.getItemAtPosition(top);

if(br){var bt=br.index;
var by=this.__Ds.getItemSizes(bt,bl+br.offset);
var bs=qx.lang.Array.sum(by);
var bA=top-br.offset;
var bx=top-br.offset+bs;
}else{var bt=0;
var by=[];
var bs=0;
var bA=0;
var bx=0;
}var bv=this.__Dt.getItemAtPosition(bj);

if(bv){var bp=bv.index;
var bo=this.__Dt.getItemSizes(bp,bk+bv.offset);
var bu=qx.lang.Array.sum(bo);
var bz=bj-bv.offset;
var bq=bj-bv.offset+bu;
}else{var bp=0;
var bo=[];
var bu=0;
var bz=0;
var bq=0;
}this.__Dy={top:bA,bottom:bx,left:bz,right:bq};
this.__DA.setUserBounds(this.__Dy.left-this.__Dv,this.__Dy.top-this.__Du,bu,bs);
this.__DD=bo;
this.__DE=by;
this.DEBUG&&qx.ui.core.queue.Manager.flush();

for(var i=0;i<this.__DB.length;i++){var bw=new Date();
var bn=this.__DB[i];
bn.setUserBounds(0,0,bu,bs);

if(bm){bn.fullUpdate(bt,bp,by,bo);
}else{bn.updateLayerWindow(bt,bp,by,bo);
}if(this.DEBUG){this.debug("layer update ("+bn.classname+"): "+(new Date()-bw)+"ms");
var bw=new Date();
qx.ui.core.queue.Manager.flush();
this.debug("layer flush ("+bn.classname+"): "+(new Date()-bw)+"ms");
}}},__DG:function(){if(this.__DC){return;
}var bb=this.getScrollSize();

if(this.__Dw!==bb.height||this.__Dx!==bb.width){this.__Dw=bb.height;
this.__Dx=bb.width;
this.fireEvent("update");
}},fullUpdate:function(){this.__Dz._fullUpdate=1;
qx.ui.core.queue.Widget.add(this);
},isUpdatePending:function(){return !!this.__Dz._fullUpdate;
},_fullUpdate:function(){var d=this.getVisibleLayers();

if(d.length==0){this.__DG();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var f=this.getBounds();
this.DEBUG&&console.log(A);
this._setLayerWindow(d,this.__Dv,this.__Du,f.width,f.height,true);
this.__DG();
},_deferredUpdateScrollPosition:function(){this.__Dz._updateScrollPosition=1;
qx.ui.core.queue.Widget.add(this);
},_updateScrollPosition:function(){var bL=this.getVisibleLayers();

if(bL.length==0){this.__DG();
return;
}var bN=this.getBounds();

if(!bN){return ;
}var bM={top:this.__Du,bottom:this.__Du+bN.height,left:this.__Dv,right:this.__Dv+bN.width};

if(this.__Dy.top<=bM.top&&this.__Dy.bottom>=bM.bottom&&this.__Dy.left<=bM.left&&this.__Dy.right>=bM.right){this.DEBUG&&console.log(G);
this.__DA.setUserBounds(this.__Dy.left-bM.left,this.__Dy.top-bM.top,this.__Dy.right-this.__Dy.left,this.__Dy.bottom-this.__Dy.top);
}else{this.DEBUG&&console.log(x);
this._setLayerWindow(bL,this.__Dv,this.__Du,bN.width,bN.height,false);
}this.__DG();
}},destruct:function(){this._disposeArray(I);
this._disposeObjects(z,Q,T);
this.__Dy=this.__Dz=this.__DD=this.__DE=null;
}});
})();
(function(){var t="change",s="qx.event.type.Event",r="qx.ui.virtual.core.Axis";
qx.Class.define(r,{extend:qx.core.Object,construct:function(B,C){arguments.callee.base.call(this);
this.itemCount=C;
this.defaultItemSize=B;
this.customSizes={};
},events:{"change":s},members:{__DH:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
},setItemCount:function(A){if(this.itemCount!==A){this.itemCount=A;
this.__DH=null;
this.fireNonBubblingEvent(t);
...
this.fireNonBubblingEvent(t);
},getItemSize:function(e){return this.customSizes[e]||this.defaultItemSize;
},resetItemSizes:function(){this.customSizes={};
this.__DH=null;
this.fireNonBubblingEvent(t);
},__DI:function(){if(this.__DH){return this.__DH;
}var h=this.defaultItemSize;
var p=this.itemCount;
var k=[];

for(var m in this.customSizes){var f=parseInt(m);

if(f<p){k.push(f);
}}
if(k.length==0){var l=[{startIndex:0,endIndex:p-1,firstItemSize:h,rangeStart:0,rangeEnd:p*h-1}];
this.__DH=l;
return l;
...
for(var i=0;i<k.length;i++){var f=k[i];

if(f>=p){break;
}var o=this.customSizes[f];
var j=f*h+g;
g+=o-h;
l[i]={startIndex:f,firstItemSize:o,rangeStart:j};

if(i>0){l[i-1].rangeEnd=j-1;
l[i-1].endIndex=f-1;
}}if(l[0].rangeStart>0){l.unshift({startIndex:0,endIndex:l[0].startIndex-1,firstItemSize:h,rangeStart:0,rangeEnd:l[0].rangeStart-1});
}var q=l[l.length-1];
var n=(p-q.startIndex-1)*h;
q.rangeEnd=q.rangeStart+q.firstItemSize+n-1;
q.endIndex=p-1;
this.__DH=l;
return l;
},__DJ:function(u){var v=this.__DH||this.__DI();
var w=0;
var y=v.length-1;
while(true){var z=w+((y-w)>>1);
var x=v[z];

if(x.rangeEnd<u){w=z+1;
}else if(x.rangeStart>u){y=z-1;
}else{return x;
}}},getItemAtPosition:function(D){if(D<0||D>=this.getTotalSize()){return null;
}var F=this.__DJ(D);
var H=F.rangeStart;
var E=F.startIndex;
var I=F.firstItemSize;

if(H+I>D){return {index:E,offset:D-H};
}else{var G=this.defaultItemSize;
return {index:E+1+Math.floor((D-H-I)/G),offset:(D-H-I)%G};
}},__DK:function(J){var K=this.__DH||this.__DI();
var L=0;
var N=K.length-1;
...
}}},getItemPosition:function(c){if(c<0||c>=this.itemCount){return null;
}var d=this.__DK(c);

if(d.startIndex==c){return d.rangeStart;
}else{return d.rangeStart+d.firstItemSize+(c-d.startIndex-1)*this.defaultItemSize;
}},getTotalSize:function(){var P=this.__DH||this.__DI();
return P[P.length-1].rangeEnd+1;
...
}},destruct:function(){this.customSizes=this.__DH=null;
}});
})();
...
this.__DL={};
},properties:{anonymous:{refine:true,init:true}},members:{__DL:null,__DM:null,__DN:null,__DO:null,__DP:null,__DQ:null,getFirstRow:function(){return this.__DN;
},getFirstColumn:function(){return this.__DO;
},getRowSizes:function(){return this.__DP||[];
},getColumnSizes:function(){return this.__DQ||[];
},syncWidget:function(){if(!this.getContentElement().getDomElement()){return;
}
if(this.__DL.fullUpdate||this.__DL.updateLayerWindow&&this.__DL.updateLayerData){this._fullUpdate.apply(this,this.__DM);
}else if(this.__DL.updateLayerWindow){this._updateLayerWindow.apply(this,this.__DM);
}else if(this.__DL.updateLayerData&&this.__DP){this._updateLayerData();
}
if(this.__DL.fullUpdate||this.__DL.updateLayerWindow){var k=this.__DM;
this.__DN=k[0];
this.__DO=k[1];
this.__DP=k[2];
this.__DQ=k[3];
}this.__DL={};
},_updateLayerData:function(){this._fullUpdate(this.__DN,this.__DO,this.__DP,this.__DQ);
...
},updateLayerData:function(){this.__DL.updateLayerData=true;
qx.ui.core.queue.Widget.add(this);
},fullUpdate:function(a,b,c,d){this.__DM=arguments;
this.__DL.fullUpdate=true;
qx.ui.core.queue.Widget.add(this);
},updateLayerWindow:function(g,h,i,j){this.__DM=arguments;
this.__DL.updateLayerWindow=true;
qx.ui.core.queue.Widget.add(this);
}},destruct:function(){this.__DL=this.__DM=this.__DP=this.__DQ=null;
}});
})();
(function(){var q="cell.empty",p="cell.row",o="cell.column",n="qx.ui.virtual.layer.WidgetCell";
qx.Class.define(n,{extend:qx.ui.virtual.layer.Abstract,include:[qx.ui.core.MChildrenHandling],construct:function(r){arguments.callee.base.call(this);
this.setZIndex(2);
{};
...
if(P.getUserData(q)){return null;
}else{return P;
}},__Ea:null,_getSpacer:function(){var m=this.__Ea.pop();

if(!m){m=new qx.ui.core.Spacer();
m.setUserData(q,1);
}return m;
...
if(h.getUserData(q)){this.__Ea.push(h);
...
l=0;
}},_updateLayerWindow:function(s,t,u,v){var J=s+u.length-1;
var A=t+v.length-1;
var F={firstRow:Math.max(s,this.getFirstRow()),lastRow:Math.min(J,this._lastRow),firstColumn:Math.max(t,this.getFirstColumn()),lastColumn:Math.min(A,this._lastColumn)};
this._lastColumn=A;
this._lastRow=J;

if(F.firstRow>F.lastRow||F.firstColumn>F.lastColumn){return this._fullUpdate(s,t,u,v);
}var K=this._getChildren();
var w=this.getColumnSizes().length;
var H=[];
var E={};

for(var L=s;L<=J;L++){H[L]=[];

for(var D=t;D<=A;D++){if(L>=F.firstRow&&L<=F.lastRow&&D>=F.firstColumn&&D<=F.lastColumn){var x=D-this.getFirstColumn();
var y=L-this.getFirstRow();
var z=y*w+x;
H[L][D]=K[z];
E[z]=true;
...
for(var i=0;i<K.length;i++){if(!E[i]){var I=K[i];

if(I.getUserData(q)){this.__Ea.push(I);
}else{G.poolCellWidget(I);
}}}this._removeAll();
var top=0;
var B=0;

for(var y=0;y<u.length;y++){for(var x=0;x<v.length;x++){var L=s+y;
var D=t+x;
var C=H[L][D]||G.getCellWidget(L,D)||this._getSpacer();
C.setUserBounds(B,top,v[x],u[y]);
C.setUserData(p,L);
C.setUserData(o,D);
this._add(C);
B+=v[x];
...
B=0;
}}},destruct:function(){var U=this._getChildren();

for(var i=0;i<U.length;i++){U[i].dispose();
}this._cellProvider=this.__Ea=null;
}});
})();
...
qx.Interface.define(c,{members:{getCellWidget:function(a,b){},pool:function(f){},updateStates:function(g,h){},updateData:function(d,e){}}});
})();
(function(){var g="cell.states",f="qx.ui.virtual.cell.AbstractWidget";
qx.Class.define(f,{extend:qx.core.Object,implement:[qx.ui.virtual.cell.IWidgetCell],construct:function(){arguments.callee.base.call(this);
this.__Ek=[];
},members:{__Ek:null,_createWidget:function(){throw new Error("abstract method call");
},updateData:function(h,i){throw new Error("abstract method call");
...
},getCellWidget:function(k,l){var m=this.__Ek.pop()||this._createWidget();
this.updateStates(m,l);
this.updateData(m,k);
return m;
},pool:function(j){this.__Ek.push(j);
...
(function(){var bT="one",bS="single",bR="selected",bQ="additive",bP="multi",bO="PageUp",bN="under",bM="Left",bL="lead",bK="Down",cs="Up",cr="Boolean",cq="PageDown",cp="anchor",co="End",cn="Home",cm="Right",cl="right",ck="click",cj="above",cb="left",cc="Escape",bY="A",ca="Space",bW="_applyMode",bX="interval",bU="changeSelection",bV="qx.event.type.Data",cd="quick",ce="key",cg="__mV",cf="abstract",ci="drag",ch="qx.ui.core.selection.Abstract";
qx.Class.define(ch,{type:cf,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__mS={};
},events:{"changeSelection":bV},properties:{mode:{check:[bS,bP,bQ,bT],init:bS,apply:bW},drag:{check:cr,init:false},quick:{check:cr,init:false}},members:{__mT:0,__mU:0,__mV:null,__mW:null,__mX:null,__mY:null,__na:null,__nb:null,__nc:null,__nd:null,__ne:null,__nf:null,__ng:null,__nh:null,__ni:null,__nj:null,__nk:null,__mS:null,__nl:null,__nm:null,getSelectionContext:function(){return this.__nj;
},selectAll:function(){var g=this.getMode();

if(g==bS||g==bT){throw new Error("Can not select all items in selection mode: "+g);
}this._selectAllItems();
this._fireChange();
},selectItem:function(bB){this._setSelectedItem(bB);
var bC=this.getMode();

if(bC!==bS&&bC!==bT){this._setLeadItem(bB);
this._setAnchorItem(bB);
}this._scrollItemIntoView(bB);
this._fireChange();
},addItem:function(cC){var cD=this.getMode();

if(cD===bS||cD===bT){this._setSelectedItem(cC);
}else{if(!this._getAnchorItem()){this._setAnchorItem(cC);
}this._setLeadItem(cC);
this._addToSelection(cC);
}this._scrollItemIntoView(cC);
this._fireChange();
},removeItem:function(bI){this._removeFromSelection(bI);

if(this.getMode()===bT&&this.isSelectionEmpty()){var bJ=this._getFirstSelectable();

if(bJ){this.addItem(bJ);
}if(bJ==bI){return;
}}
if(this.getLeadItem()==bI){this._setLeadItem(null);
}
if(this._getAnchorItem()==bI){this._setAnchorItem(null);
}this._fireChange();
},selectItemRange:function(cE,cF){var cG=this.getMode();

if(cG==bS||cG==bT){throw new Error("Can not select multiple items in selection mode: "+cG);
}this._selectItemRange(cE,cF);
this._setAnchorItem(cE);
this._setLeadItem(cF);
this._scrollItemIntoView(cF);
this._fireChange();
},clearSelection:function(){if(this.getMode()==bT){return;
...
if(m==bT||m===bS){if(k.length>1){throw new Error("Could not select more than one items in mode: "+m+"!");
}
if(k.length==1){this.selectItem(k[0]);
}else{this.clearSelection();
}return;
}else{this._replaceMultiSelection(k);
}},getSelectedItem:function(){var n=this.getMode();

if(n===bS||n===bT){return this._getSelectedItem()||null;
...
var cL=qx.lang.Object.getValues(this.__mS);
cL.sort(function(a,b){return cM.indexOf(a)-cM.indexOf(b);
});
return cL;
},isItemSelected:function(bp){var bq=this._selectableToHashCode(bp);
return this.__mS[bq]!==undefined;
},isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__mS);
},invertSelection:function(){var J=this.getMode();

if(J===bS||J===bT){throw new Error("The method invertSelection() is only supported in 'multi' and 'additive' selection mode!");
}var I=this.getSelectables();

for(var i=0;i<I.length;i++){this._toggleInSelection(I[i]);
}this._fireChange();
},_setLeadItem:function(o){var p=this.__nk;

if(p!==null){this._styleSelectable(p,bL,false);
}
if(o!==null){this._styleSelectable(o,bL,true);
}this.__nk=o;
},_getLeadItem:function(){{};
return this.getLeadItem();
},getLeadItem:function(){return this.__nk!==null?this.__nk:null;
},_setAnchorItem:function(c){var d=this.__nl;

if(d){this._styleSelectable(d,cp,false);
}
if(c){this._styleSelectable(c,cp,true);
}this.__nl=c;
...
},_styleSelectable:function(cN,cO,cP){throw new Error("Abstract method call: _styleSelectable()");
},_capture:function(){throw new Error("Abstract method call: _capture()");
},_releaseCapture:function(){throw new Error("Abstract method call: _releaseCapture()");
},_getLocation:function(){throw new Error("Abstract method call: _getLocation()");
},_getDimension:function(){throw new Error("Abstract method call: _getDimension()");
},_getSelectableLocationX:function(f){throw new Error("Abstract method call: _getSelectableLocationX()");
},_getSelectableLocationY:function(Q){throw new Error("Abstract method call: _getSelectableLocationY()");
},_getScroll:function(){throw new Error("Abstract method call: _getScroll()");
},_scrollBy:function(h,j){throw new Error("Abstract method call: _scrollBy()");
...
},_applyMode:function(bF,bG){this._setLeadItem(null);
this._setAnchorItem(null);
this._clearSelection();
if(bF===bT){var bH=this._getFirstSelectable();

if(bH){this._setSelectedItem(bH);
this._scrollItemIntoView(bH);
}}this._fireChange();
},handleMouseOver:function(event){if(!this.getQuick()){return;
}var cK=this.getMode();

if(cK!==bT&&cK!==bS){return;
}var cJ=this._getSelectableFromMouseEvent(event);

if(cJ===null){return;
}this._setSelectedItem(cJ);
this._fireChange(cd);
...
if(this.isItemSelected(S)&&!R&&!U&&!this.getDrag()){this.__nm=S;
return;
}else{this.__nm=null;
}this._scrollItemIntoView(S);
switch(this.getMode()){case bS:case bT:this._setSelectedItem(S);
break;
case bQ:this._setLeadItem(S);
this._setAnchorItem(S);
this._toggleInSelection(S);
break;
case bP:this._setLeadItem(S);
...
if(this.getDrag()&&V!==bS&&V!==bT&&!R&&!U){this.__na=this._getLocation();
...
},handleMouseUp:function(event){var P=event.isCtrlPressed()||(qx.bom.client.Platform.MAC&&event.isMetaPressed());
var M=event.isShiftPressed();

if(!P&&!M&&this.__nm){var N=this._getSelectableFromMouseEvent(event);

if(N===null||!this.isItemSelected(N)){return;
}var O=this.getMode();

if(O===bQ){this._removeFromSelection(N);
}else{this._setSelectedItem(N);

if(this.getMode()===bP){this._setLeadItem(N);
...
var bn=this.__ne+this.__mW.left;

if(bn>this.__nb){this.__ng=1;
}else if(bn<this.__nb){this.__ng=-1;
}else{this.__ng=0;
}var bm=this.__nf+this.__mW.top;

if(bm>this.__nc){this.__nh=1;
}else if(bm<this.__nc){this.__nh=-1;
}else{this.__nh=0;
...
this.__mV.addListener(bX,this._onInterval,this);
}this.__mV.start();
this._autoSelect();
event.stopPropagation();
},handleAddItem:function(e){var F=e.getData();

if(this.getMode()===bT&&this.isSelectionEmpty()){this.addItem(F);
}},handleRemoveItem:function(e){this.removeItem(e.getData());
},_cleanup:function(){if(!this.getDrag()&&this.__nd){return;
}if(this.__ni){this._fireChange(ck);
}delete this.__nd;
delete this.__mX;
delete this.__mY;
...
var X=Math.max(0,Math.min(this.__ne-this.__na.left,bf.width))+this.__mW.left;
var W=Math.max(0,Math.min(this.__nf-this.__na.top,bf.height))+this.__mW.top;
if(this.__mX===X&&this.__mY===W){return;
}this.__mX=X;
this.__mY=W;
...
while(bd!==0){bg=bd>0?this._getRelatedSelectable(ba,cl):this._getRelatedSelectable(ba,cb);
if(bg!==null){Y=this._getSelectableLocationX(bg);
if((bd>0&&Y.left<=X)||(bd<0&&Y.right>=X)){ba=bg;
continue;
}}break;
}var be=this.__nh;
var bc,bb;

while(be!==0){bc=be>0?this._getRelatedSelectable(ba,bN):this._getRelatedSelectable(ba,cj);
if(bc!==null){bb=this._getSelectableLocationY(bc);
if((be>0&&bb.top<=W)||(be<0&&bb.bottom>=W)){ba=bc;
continue;
}}break;
}var bi=this.getMode();

if(bi===bP){this._selectItemRange(bh,ba);
}else if(bi===bQ){if(this.isItemSelected(bh)){this._selectItemRange(bh,ba,true);
}else{this._deselectItemRange(bh,ba);
}this._setAnchorItem(ba);
}this._fireChange(ci);
},__nn:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){var A,z;
var C=event.getKeyIdentifier();
var B=this.getMode();
var w=event.isCtrlPressed()||(qx.bom.client.Platform.MAC&&event.isMetaPressed());
var x=event.isShiftPressed();
var y=false;

if(C===bY&&w){if(B!==bS&&B!==bT){this._selectAllItems();
y=true;
}}else if(C===cc){if(B!==bS&&B!==bT){this._clearSelection();
y=true;
}}else if(C===ca){var v=this.getLeadItem();

if(v&&!x){if(w||B===bQ){this._toggleInSelection(v);
}else{this._setSelectedItem(v);
}y=true;
}}else if(this.__nn[C]){y=true;

if(B===bS||B==bT){A=this._getSelectedItem();
}else{A=this.getLeadItem();
}
if(A!==null){switch(C){case cn:z=this._getFirstSelectable();
break;
case co:z=this._getLastSelectable();
break;
case cs:z=this._getRelatedSelectable(A,cj);
break;
case bK:z=this._getRelatedSelectable(A,bN);
break;
case bM:z=this._getRelatedSelectable(A,cb);
break;
case cm:z=this._getRelatedSelectable(A,cl);
break;
case bO:z=this._getPage(A,true);
break;
case cq:z=this._getPage(A,false);
break;
}}else{switch(C){case cn:case bK:case cm:case cq:z=this._getFirstSelectable();
break;
case co:case cs:case bM:case bO:z=this._getLastSelectable();
break;
}}if(z!==null){switch(B){case bS:case bT:this._setSelectedItem(z);
break;
case bQ:this._setLeadItem(z);
break;
case bP:if(x){var D=this._getAnchorItem();

if(D===null){this._setAnchorItem(D=this._getFirstSelectable());
}this._setLeadItem(z);
this._selectItemRange(D,z,w);
}else{this._setAnchorItem(z);
this._setLeadItem(z);

if(!w){this._setSelectedItem(z);
}}break;
}this._scrollItemIntoView(z);
}}
if(y){event.stop();
this._fireChange(ce);
}},_selectAllItems:function(){var cz=this.getSelectables();

for(var i=0,l=cz.length;i<l;i++){this._addToSelection(cz[i]);
}},_clearSelection:function(){var bD=this.__mS;

for(var bE in bD){this._removeFromSelection(bD[bE]);
}this.__mS={};
},_selectItemRange:function(cQ,cR,cS){var cV=this._getSelectableRange(cQ,cR);
if(!cS){var cU=this.__mS;
var cW=this.__no(cV);

for(var cT in cU){if(!cW[cT]){this._removeFromSelection(cU[cT]);
...
}},__no:function(cu){var cw={};
var cv;

for(var i=0,l=cu.length;i<l;i++){cv=cu[i];
cw[this._selectableToHashCode(cv)]=cv;
}return cw;
},_getSelectedItem:function(){for(var q in this.__mS){return this.__mS[q];
}return null;
},_setSelectedItem:function(s){if(this._isSelectable(s)){var t=this.__mS;
var u=this._selectableToHashCode(s);

if(!t[u]||qx.lang.Object.hasMinLength(t,2)){this._clearSelection();
this._addToSelection(s);
}}},_addToSelection:function(bk){var bl=this._selectableToHashCode(bk);

if(!this.__mS[bl]&&this._isSelectable(bk)){this.__mS[bl]=bk;
this._styleSelectable(bk,bR,true);
this.__ni=true;
}},_toggleInSelection:function(cH){var cI=this._selectableToHashCode(cH);

if(!this.__mS[cI]){this.__mS[cI]=cH;
this._styleSelectable(cH,bR,true);
}else{delete this.__mS[cI];
this._styleSelectable(cH,bR,false);
}this.__ni=true;
},_removeFromSelection:function(cx){var cy=this._selectableToHashCode(cx);

if(this.__mS[cy]!=null){delete this.__mS[cy];
this._styleSelectable(cx,bR,false);
this.__ni=true;
...
delete bv[bw];
this._styleSelectable(bx,bR,false);
bu=true;
}}for(var bw in bs){bx=bv[bw]=bs[bw];
this._styleSelectable(bx,bR,true);
bu=true;
}if(!bu){return false;
...
this.__ni=true;
this._fireChange();
},_fireChange:function(E){if(this.__ni){this.__nj=E||null;
this.fireDataEvent(bU,this.getSelection());
delete this.__ni;
...
(function(){var l="mouseup",k="mousedown",j="losecapture",i="mouseover",h="mousemove",g="removeItem",f="keypress",e="addItem",d="qx.ui.virtual.selection.Abstract";
qx.Class.define(d,{extend:qx.ui.core.selection.Abstract,construct:function(v,w){arguments.callee.base.call(this);
{};
this._pane=v;
this._delegate=w||{};
},members:{_isSelectable:function(r){return this._delegate.isItemSelectable?this._delegate.isItemSelectable(r):true;
},_styleSelectable:function(a,b,c){if(this._delegate.styleSelectable){this._delegate.styleSelectable(a,b,c);
}},attachMouseEvents:function(){var m=this._pane.getContainerElement();
m.addListener(k,this.handleMouseDown,this);
m.addListener(l,this.handleMouseUp,this);
m.addListener(i,this.handleMouseOver,this);
m.addListener(h,this.handleMouseMove,this);
m.addListener(j,this.handleLoseCapture,this);
},detatchMouseEvents:function(){var s=this._pane.getContainerElement();
s.removeListener(k,this.handleMouseDown,this);
s.removeListener(l,this.handleMouseUp,this);
s.removeListener(i,this.handleMouseOver,this);
s.removeListener(h,this.handleMouseMove,this);
s.removeListener(j,this.handleLoseCapture,this);
},attachKeyEvents:function(q){q.addListener(f,this.handleKeyPress,this);
},detachKeyEvents:function(t){t.removeListener(f,this.handleKeyPress,this);
},attachListEvents:function(p){p.addListener(e,this.handleAddItem,this);
p.addListener(g,this.handleRemoveItem,this);
},detachListEvents:function(x){x.removeListener(e,this.handleAddItem,this);
x.removeListener(g,this.handleRemoveItem,this);
...
},_scrollBy:function(n,o){this._pane.setScrollX(this._pane.getScrollX()+n);
this._pane.setScrollY(this._pane.getScrollY()+o);
...
(function(){var p="qx.ui.virtual.selection.Row",o="above",n="under";
qx.Class.define(p,{extend:qx.ui.virtual.selection.Abstract,members:{_getItemCount:function(){return this._pane.getRowConfig().getItemCount();
...
if(!A){return null;
}return this._isSelectable(A.row)?A.row:null;
},getSelectables:function(){var r=[];

for(var i=0,l=this._getItemCount();i<l;i++){if(this._isSelectable(i)){r.push(i);
}}return r;
...
},_getLastSelectable:function(){var e=this._getItemCount();

for(var i=e-1;i>=0;i--){if(this._isSelectable(i)){return i;
}}return null;
},_getRelatedSelectable:function(g,h){if(h==o){var k=g-1;
var j=0;
var m=-1;
}else if(h==n){var k=g+1;
var j=this._getItemCount()-1;
var m=1;
}else{return null;
}
for(var i=k;i!==j+m;i+=m){if(this._isSelectable(i)){return i;
}}return null;
},_getPage:function(y,z){if(z){return this._getFirstSelectable();
}else{return this._getLastSelectable();
}},_selectableToHashCode:function(f){return f;
},_scrollItemIntoView:function(q){this._pane.scrollRowIntoView(q);
},_getSelectableLocationX:function(s){return {left:0,right:this._pane.getColumnConfig().getTotalSize()-1};
...
qx.Class.define(c,{extend:qx.ui.virtual.layer.Abstract,construct:function(g,h){arguments.callee.base.call(this);
...
this.__EI={};
},properties:{colorEven:{nullable:true,check:f,apply:d,themeable:true},colorOdd:{nullable:true,check:f,apply:e,themeable:true}},members:{__EJ:null,__EK:null,__EH:null,__EI:null,setColor:function(l,m){if(m){this.__EH[l]=qx.theme.manager.Color.getInstance().resolve(m);
}else{delete (this.__EH[l]);
}},clearCustomColors:function(){this.__EH={};
this.updateLayerData();
},getColor:function(a){var b=this.__EH[a];

if(b){return b;
}else{return a%2==0?this.__EJ:this.__EK;
}},_applyColorEven:function(i,j){if(i){this.__EJ=qx.theme.manager.Color.getInstance().resolve(i);
}else{this.__EJ=null;
}this.updateLayerData();
},_applyColorOdd:function(p,q){if(p){this.__EK=qx.theme.manager.Color.getInstance().resolve(p);
}else{this.__EK=null;
}this.updateLayerData();
},setBackground:function(n,o){if(o){this.__EI[n]=qx.theme.manager.Decoration.getInstance().resolve(o);
}else{delete (this.__EI[n]);
}this.updateLayerData();
},getBackground:function(k){return this.__EI[k];
}},destruct:function(){this.__EH=this.__EI=null;
}});
})();
...
this._width=F;
},_updateLayerWindow:function(M,N,O,P){if(M!==this.getFirstRow()||O.length!==this.getRowSizes().length||this._width<qx.lang.Array.sum(P)){this._fullUpdate(M,N,O,P);
}},setColor:function(u,v){arguments.callee.base.call(this,u,v);

if(this.__EL(u)){this.updateLayerData();
}},setBackground:function(K,L){arguments.callee.base.call(this,K,L);

if(this.__EL(K)){this.updateLayerData();
}},__EL:function(a){var c=this.getFirstRow();
var b=c+this.getRowSizes().length-1;
return a>=c&&a<=b;
}}});
})();
(function(){var o="horizontal",n="",m="gray",l="qx.ui.virtual.layer.GridLines",k="Color",j="PositiveInteger",i="html";
qx.Class.define(l,{extend:qx.ui.virtual.layer.Abstract,construct:function(J,K,L){arguments.callee.base.call(this);
this.setZIndex(1);
...
this.__EN=[];
this._isHorizontal=(J||o)==o;
},properties:{defaultLineColor:{init:m,check:k,themeable:true},defaultLineSize:{init:1,check:j,themeable:true}},members:{__EM:null,__EN:null,isHorizontal:function(){return this._isHorizontal;
},setLineColor:function(R,S){{};
this.__EM[R]=S;

if(this.__EO(R)){this.updateLayerData();
}},setLineSize:function(a,b){{};
this.__EN[a]=b;

if(this.__EO(a)){this.updateLayerData();
}},__EO:function(d){if(this._isHorizontal){var h=this.getFirstColumn();
var f=h+this.getColumnSizes().length-1;
return d>=h&&d<=f;
}else{var g=this.getFirstRow();
var e=g+this.getRowSizes().length-1;
return d>=g&&d<=e;
}},getLineSize:function(C){return this.__EN[C]||this.getDefaultLineSize();
},getLineColor:function(c){return this.__EM[c]||this.getDefaultLineColor();
},__EP:function(v,w,z){var top=0;
var A,B;
...
}},_fullUpdate:function(M,N,O,P){var Q=[];

if(this._isHorizontal){this.__EP(Q,M,O);
}else{this.__EQ(Q,N,P);
}this.getContentElement().setAttribute(i,Q.join(n));
},_updateLayerWindow:function(p,q,r,s){var t=p!==this.getFirstRow()||r.length!==this.getRowSizes().length;
var u=q!==this.getFirstColumn()||s.length!==this.getColumnSizes().length;

if((this._isHorizontal&&t)||(!this._isHorizontal&&u)){this._fullUpdate(p,q,r,s);
}}},destruct:function(){this.__EM=this.__EN=null;
}});
})();
(function(){var F="sorter",E="qx.data.IListData",D="filter",C="changeModel",B="_applyDelegate",A="changeDelegate",z="",y="qx.ui.virtual.form.ListController",x="changeSelection",w="_applyTarget",t="qx.ui.virtual.form.List",v="_applySelection",u="changeTarget",s="_applyModel",r="object";
qx.Class.define(y,{extend:qx.core.Object,construct:function(S,T){arguments.callee.base.call(this);
this.setSelection(new qx.data.Array());

if(S!=null){this.setModel(S);
}
if(T!=null){this.setTarget(T);
}},properties:{target:{check:t,event:u,nullable:true,init:null,apply:w},model:{check:E,event:C,nullable:true,init:null,apply:s},selection:{check:E,event:x,apply:v},delegate:{apply:B,event:A,init:null,nullable:true}},members:{__ER:null,__ES:null,__ET:null,__EU:null,__EV:null,__EW:null,__EX:null,_validDelegates:[F,D],_getRowData:function(d){var f=this.getModel();
return f?f.getItem(this.__Fa(d)):null;
},_getModelRow:function(g){return this.getModel().indexOf(g);
},getRowCount:function(){return this.__EX.length;
},update:function(){this.__EY();
this._syncViewSelectionToModel();
},__EY:function(){var Q=this.getModel();

if(Q==null){return;
}this.__EX=[];
this._runDelegateFilter(Q);
this._runDelegateSorter(Q);

if(this.getTarget()!=null){this._syncRowCount();
}},_runDelegateSorter:function(U){if(!this._containsDelegateMethod(this.getDelegate(),F)||qx.lang.Type.isObject(U)){return;
}
if(this.__EX.length==0){return;
}var V=this._getDelegate(F);

if(V!=null){this.__EX.sort(function(a,b){return V(U.getItem(a),U.getItem(b));
});
}},_runDelegateFilter:function(h){if(typeof h!==r){return;
}var j=this._getDelegate(D);

for(var i=0,l=h.length;i<l;++i){if(j==null||j(h.getItem(i))){this.__EX.push(i);
...
},_getDelegate:function(W){var X=this.getDelegate();

if(this._containsDelegateMethod(X,W)){return X[W];
}return null;
},__Fa:function(o){return this.__EX[o];
},_applyDelegate:function(Y,ba){if(this.getTarget()==null||this.getModel()==null){return;
}
if(this._containsDelegateMethod(Y)){this.__EY();
}},_applyTarget:function(O,P){if(O!=null){O.setDelegate(this);
this.__EU=O.getSelectionManager().addListener("changeSelection",this._onChangeSelectionView,this);
}
if(P!=null){P.setDelegate(null);
P.getSelectionManager().removeListenerById(this.__EU);
}
if(this.getModel()==null){return;
}this.__EY();
this._syncRowCount();
},_applyModel:function(p,q){if(q!=null){q.removeListenerById(this.__ER);
q.removeListenerById(this.__ES);
q.removeListenerById(this.__ET);
}
if(p!=null){this.__EY();
this.__ER=p.addListener("changeLength",this._onChangeLengthModel,this);
this.__ES=p.addListener("change",this._onChangeModel,this);
this.__ET=p.addListener("changeBubble",this._onChangeBubbleModel,this);
}
if(this.getTarget()!=null){this._syncRowCount();
}},_applySelection:function(k,m){if(k!=null){this.__EV=k.addListener("change",this._onChangeSelectionModel,this);
this.__EW=k.addListener("changeLength",this._onChangeSelectionModel,this);
this._syncModelSelectionToView();
}
if(m!=null){m.removeListenerById(this.__EV);
m.removeListenerById(this.__EW);
...
},_onChangeLengthModel:function(e){this.__EY();
this._syncRowCount();
},_onChangeModel:function(e){var R=this.getTarget();

if(R!=null){this.__EY();
R.update();
}},_onChangeBubbleModel:function(e){var c=this.getTarget();
...
if(!J){this.getSelection().removaeAll();
return;
}var I=J.getSelectionManager().getSelection();
var H=[];

for(var i=0;i<I.length;i++){var G=this._getRowData(I[i]);
H.push(G);
}H.unshift(this.getSelection().length);
H.unshift(0);
this._ignoreSelectionChange=true;
this.getSelection().splice.apply(this.getSelection(),H);
...
},getCellData:function(n){return this._getRowData(n)||z;
}},destruct:function(){this.__EX=null;
}});
})();
(function(){var q="name",p="changeOpen",o="group",n="demobrowser.demo.virtual.messenger.Controller",m=".",l="cell.row";
qx.Class.define(n,{extend:qx.ui.virtual.form.ListController,construct:function(u,v){arguments.callee.base.call(this,u,v);
this.__Fl=new demobrowser.demo.virtual.messenger.BuddyCell();
this.__Fm=new demobrowser.demo.virtual.messenger.GroupCell();
this.__Fm.addListener(p,this._onChangeOpenGroup,this);
this.__Fn=[];
this.__Fo={};
this.__Fp=[];
this.__Fq=new qx.util.DeferredCall(this._updateGrouping,this);
},members:{__Fp:null,__Fo:null,__Fq:null,__Fn:null,__Fl:null,__Fm:null,_getRowData:function(k){return this.__Fp[k];
},_getModelRow:function(y){return this.__Fp.indexOf(y);
},_getRowCount:function(){return this.__Fp.length;
},_isGroupHeader:function(w){return this.__Fp[w] instanceof demobrowser.demo.virtual.messenger.GroupModel;
},_getGroupModel:function(name,f){var g=this.__Fo[name];

if(!g){var g=new demobrowser.demo.virtual.messenger.GroupModel();
g.setName(name);
this.__Fo[name]=g;
}g.setRow(f);
return g;
},_onChangeOpenGroup:function(e){var z=this.__Fp[e.getData().getUserData(l)];
z.toggleOpen();
this.__Fq.schedule();
},getCellRenderer:function(J){if(this._isGroupHeader(J)){return this.__Fm;
}else{return this.__Fl;
}},isRowSelectable:function(x){return !this._isGroupHeader(x);
},_visualizeGrouping:function(r){var s=this.getTarget();

if(s){for(var i=0;i<this.__Fn.length;i++){var t=this.__Fn[i].getOldRow();

if(t!==null){s.unstyleGroup(t);
}}
for(var i=0;i<r.length;i++){var t=r[i].getRow();
s.styleGroup(t);
}}this.__Fn=r;
},_updateGrouping:function(){var G=this.getModel();
this.__Fp=[];
var H=[];
var D=[];

if(G&&G.length>0){H=qx.lang.Array.clone(G.toArray());
H.sort(function(a,b){var h=a.getGroup();
var j=b.getGroup();

if(h==j){return a.getName()<b.getName()?-1:1;
}return h>j?-1:1;
});
var F=H[0];
var C=this._getGroupModel(F.getGroup(),0);
this.__Fp.push(C);
D.push(C);
var I=0;

for(var i=0;i<H.length;i++){var E=H[i];

if(E.getGroup()!==C.getName()){C.setItemCount(I);
I=0;
var C=this._getGroupModel(E.getGroup(),this.__Fp.length);
this.__Fp.push(C);
D.push(C);
}
if(C.isOpen()){this.__Fp.push(E);
}else{this.getSelection().remove(E);
}I+=1;
}}C.setItemCount(I);
this._visualizeGrouping(D);
this._syncModelSelectionToView();
this._syncRowCount();
},_applyModel:function(A,B){arguments.callee.base.call(this,A,B);
this.__Fq.schedule();
},_onChangeModel:function(e){arguments.callee.base.call(this,e);
this.__Fq.schedule();
},_onChangeBubbleModel:function(e){var c=e.getData();

if(c.name){var d=c.name.toString().split(m)[1];

if(d==q||d==o){this.__Fq.schedule();
}}arguments.callee.base.call(this);
}}});
})();
...
var t=qx.core.Setting.get(k)==g?h:i;
...
qx.Class.define(f,{extend:qx.core.Object,construct:function(name){arguments.callee.base.call(this);

if(name!==undefined){this.setName(name);
}},properties:{name:{init:c,event:g,check:a},row:{event:d,check:j,apply:b},open:{check:h,init:true,event:i},itemCount:{check:j,init:0,event:e}},members:{__Fr:null,_applyRow:function(k,l){this.__Fr=l;
},getOldRow:function(){return this.__Fr;
}}});
})();
(function(){var q="scroll",p="scrollbar-x",o="scrollbar-y",n="_applyInterval",m="appear",l="interval",k="qx.ui.virtual.behavior.Prefetch",j="_applyScroller",i="qx.ui.virtual.core.Scroller",h="Integer",g="__Eb";
qx.Class.define(k,{extend:qx.core.Object,construct:function(z,A,B,C,D,E,F,G,H){arguments.callee.base.call(this);
this.setPrefetchX(A,B,C,D);
this.setPrefetchY(E,F,G,H);
this.__Eb=new qx.event.Timer(this.getInterval());
this.__Eb.addListener(l,this._onInterval,this);

if(z){this.setScroller(z);
}},properties:{scroller:{check:i,nullable:true,init:null,apply:j},interval:{check:h,init:200,apply:n}},members:{__Ec:null,__Ed:null,__Eb:null,__Ee:null,__Ef:null,setPrefetchX:function(a,b,c,d){this.__Ec=[a,b,c,d];
},setPrefetchY:function(r,s,t,u){this.__Ed=[r,s,t,u];
},_onInterval:function(){var x=this.__Ec;

if(x[1]&&x[3]){this.getScroller().getPane().prefetchX(x[0],x[1],x[2],x[3]);
qx.ui.core.queue.Manager.flush();
}var y=this.__Ed;

if(y[1]&&y[3]){this.getScroller().getPane().prefetchY(y[0],y[1],y[2],y[3]);
qx.ui.core.queue.Manager.flush();
}},_applyScroller:function(e,f){if(f){if(this.__Ee){f.getChildControl(p).removeListenerById(this.__Ee);
}
if(this.__Ef){f.getChildControl(o).removeListenerById(this.__Ef);
}}
if(e){if(!e.getContainerElement().getDomElement()){this.__Eb.stop();
e.addListenerOnce(m,this.__Eb.start,this.__Eb);
}else{this.__Eb.restart();
}this.__Ee=e.getChildControl(p).addListener(q,this.__Eb.restart,this.__Eb);
this.__Ef=e.getChildControl(o).addListener(q,this.__Eb.restart,this.__Eb);
}else{this.__Eb.stop();
}},_applyInterval:function(v,w){this.__Eb.setInterval(v);
}},destruct:function(){this.setScroller(null);
this.__Ec=this.__Ed=null;
this._disposeObjects(g);
}});
})();
(function(){var l="_applyEventPropagation",k="offline",j="String",h="Friends",g="away",f="online",e="busy",d="Christian Schmidt",c="User #",b="qooxdoo",P="smile",O="Jonathan Weiß",N=".png",M="kiss",L="changeStatus",K="icon/22/emotes/face-smile.png",J="plain",I="smile-big",H="surprise",G="raspberry",s="sad",t="embarrassed",q="Alexander Back",r="Fabian Jakobs",o="demobrowser/demo/icons/imicons/fabian_jakobs.png",p="Daniel Wagner",m="demobrowser/demo/icons/imicons/christian_schmidt.png",n="(unnamed)",u="Andreas Ecker",v="laugh",y="Thomas Herchenröder",x="changeGroup",A="demobrowser/demo/icons/imicons/martin_wittemann.png",z="changeName",C="angel",B="demobrowser.demo.virtual.messenger.BuddyModel",w="icon/22/emotes/face-",F="demobrowser/demo/icons/imicons/jonathan_weiss.png",E="changeAvatar",D="Martin Wittemann";
qx.Class.define(B,{extend:qx.core.Object,include:qx.data.marshal.MEventBubbling,properties:{name:{init:n,event:z,check:j,apply:l},avatar:{init:K,event:E,check:j,apply:l},status:{init:k,event:L,check:[g,e,f,k],apply:l},group:{init:h,event:x,check:j,apply:l}},statics:{createBuddies:function(Q){var S=[{name:q,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:r,img:o,statusIcon:this.getRandomStatus()},{name:u,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:D,img:A,statusIcon:this.getRandomStatus()},{name:y,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:p,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus()},{name:O,img:F,statusIcon:this.getRandomStatus()},{name:d,img:m,statusIcon:this.getRandomStatus()}];

for(var i=0;i<S.length;i++){S[i].group=b;
}for(var i=S.length;i<Q;i++){S[i]={name:c+i,img:this.getRandomBuddy(),statusIcon:this.getRandomStatus(),group:h};
}var R=[];
...
},getRandomBuddy:function(){var U=[C,t,M,v,J,G,s,I,P,H];
return w+U[Math.floor(Math.random()*U.length)]+N;
},getRandomStatus:function(){var a=[g,e,f,k];
...
qx.Class.define(l,{extend:qx.core.Object,construct:function(p){arguments.callee.base.call(this);
this.__xk={};
this.__xl=[];

if(p!=null){this.setModel(p);
}},properties:{model:{check:n,event:o,apply:k,nullable:true}},members:{__xl:null,__xk:null,_applyModel:function(q,r){for(var i=0;i<this.__xl.length;i++){var x=this.__xl[i][0];
var u=this.__xl[i][1];
var t=this.__xl[i][2];
var v=this.__xl[i][3];
var w=this.__xl[i][4];
var s=this.__xl[i][5];
if(r!=undefined){this.__xn(x,u,t,r);
}if(q!=undefined){this.__xm(x,u,t,v,w,s);
}else{x[m+qx.lang.String.firstUp(u)]();
}}},addTarget:function(y,z,A,B,C,D){this.__xl.push([y,z,A,B,C,D]);
this.__xm(y,z,A,B,C,D);
},__xm:function(a,b,c,d,e,f){if(this.getModel()==null){return;
...
if(this.__xk[j]==undefined){this.__xk[j]=[];
}this.__xk[j].push([g,h,b,c,e,f]);
},removeTarget:function(E,F,G){this.__xn(E,F,G,this.getModel());
for(var i=0;i<this.__xl.length;i++){if(this.__xl[i][0]==E&&this.__xl[i][1]==F&&this.__xl[i][2]==G){this.__xl.splice(i,1);
}}},__xn:function(H,I,J,K){if(!(H instanceof qx.core.Object)){return ;
}var L=this.__xk[H.toHashCode()];
if(L==undefined||L.length==0){return;
}for(var i=0;i<L.length;i++){if(L[i][2]==I&&L[i][3]==J){var M=L[i][0];
K.removeBinding(M);
if(L[i][1]!=null){H.removeBinding(L[i][1]);
}L.splice(i,1);
return;
}}}},destruct:function(){this.__xk=this.__xl=null;
}});
})();
...
(function(){var E="popup",D="list",C="",B="mousewheel",A="resize",z="Function",y="blur",x="abstract",w="keypress",v="Number",o="changeSelection",u="PageUp",r="_applyMaxListHeight",m="PageDown",l="mouseup",q="Escape",p="changeVisibility",s="one",k="middle",t="qx.ui.form.AbstractSelectBox",n="mousedown";
qx.Class.define(t,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.form.MForm],implement:[qx.ui.form.IForm],type:x,construct:function(){arguments.callee.base.call(this);
var d=new qx.ui.layout.HBox();
this._setLayout(d);
d.setAlignY(k);
this.addListener(w,this._onKeyPress);
this.addListener(y,this._onBlur,this);
var c=qx.core.Init.getApplication().getRoot();
c.addListener(B,this._onMousewheel,this,true);
this.addListener(A,this._onResize,this);
},properties:{focusable:{refine:true,init:true},width:{refine:true,init:120},maxListHeight:{check:v,apply:r,nullable:true,init:200},format:{check:z,init:function(M){return this._defaultFormat(M);
},nullable:true}},members:{_createChildControlImpl:function(G){var H;

switch(G){case D:H=new qx.ui.form.List().set({focusable:false,keepFocus:true,height:null,width:null,maxHeight:this.getMaxListHeight(),selectionMode:s,quickSelection:true});
H.addListener(o,this._onListChangeSelection,this);
H.addListener(n,this._onListMouseDown,this);
break;
case E:H=new qx.ui.popup.Popup(new qx.ui.layout.VBox);
H.setAutoHide(false);
H.setKeepActive(true);
H.addListener(l,this.close,this);
H.add(this.getChildControl(D));
H.addListener(p,this._onPopupChangeVisibility,this);
break;
}return H||arguments.callee.base.call(this,G);
},_applyMaxListHeight:function(i,j){this.getChildControl(D).setMaxHeight(i);
},getChildrenContainer:function(){return this.getChildControl(D);
},open:function(){var L=this.getChildControl(E);
L.placeToWidget(this,true);
L.show();
},close:function(){this.getChildControl(E).hide();
},toggle:function(){var F=this.getChildControl(E).isVisible();

if(F){this.close();
}else{this.open();
}},_defaultFormat:function(f){var g=f?f.getLabel():C;
var h=f?f.getRich():false;

if(h){g=g.replace(/<[^>]+?>/g,C);
g=qx.bom.String.unescape(g);
}return g;
},_onBlur:function(e){this.close();
},_onKeyPress:function(e){var a=e.getKeyIdentifier();
var b=this.getChildControl(E);
if(b.isHidden()&&(a==m||a==u)){e.stopPropagation();
}else if(!b.isHidden()&&a==q){this.close();
e.stop();
}else{this.getChildControl(D).handleKeyPress(e);
}},_onMousewheel:function(e){var J=e.getTarget();
var I=this.getChildControl(E);

if(qx.ui.core.Widget.contains(I,J)){e.preventDefault();
}else{this.close();
}},_onResize:function(e){this.getChildControl(E).setMinWidth(e.getData().width);
...
if(K){K.removeListener(B,this._onMousewheel,this,true);
}}});
})();
...
qx.Class.define(r,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.core.ISingleSelection,qx.ui.form.IModelSelection],include:[qx.ui.core.MSingleSelectionHandling,qx.ui.form.MModelSelection],construct:function(){arguments.callee.base.call(this);
...
this.addListener(u,this.__pK,this);
},properties:{appearance:{refine:true,init:p}},members:{__pJ:null,_createChildControlImpl:function(D){var E;

switch(D){case C:E=new qx.ui.core.Spacer();
this._add(E,{flex:1});
break;
case m:E=new qx.ui.basic.Atom(o);
E.setCenter(false);
E.setAnonymous(true);
this._add(E,{flex:1});
break;
case f:E=new qx.ui.basic.Image();
E.setAnonymous(true);
this._add(E);
break;
...
},__pK:function(e){var Y=e.getData()[0];
var X=this.getChildControl(n);

if(X.getSelection()[0]!=Y){if(Y){X.setSelection([Y]);
}else{X.resetSelection();
}}this.__pL();
this.__pM();
},__pL:function(){var b=this.getChildControl(n).getSelection()[0];
var c=this.getChildControl(m);
var a=b?b.getIcon():d;
a==null?c.resetIcon():c.setIcon(a);
},__pM:function(){var V=this.getChildControl(n).getSelection()[0];
var W=this.getChildControl(m);
var U=V?V.getLabel():d;
var T=this.getFormat();

if(T!=null){U=T.call(this,V);
}if(U&&U.translate){U=U.translate();
...
if(F==B||F==y){if(this.__pJ){this.setSelection([this.__pJ]);
this.__pJ=null;
}this.toggle();
...
ba.setBubbles(false);
this.getChildControl(n).dispatchEvent(ba);
},_onListMouseDown:function(e){if(this.__pJ){this.setSelection([this.__pJ]);
this.__pJ=null;
}},_onListChangeSelection:function(e){var bb=e.getData();
var be=e.getOldData();
if(be&&be.length>0){be[0].removeListener(g,this.__pL,this);
be[0].removeListener(h,this.__pM,this);
}
if(bb.length>0){var bd=this.getChildControl(j);
var bc=this.getChildControl(n);
var bf=bc.getSelectionContext();

if(bd.isVisible()&&(bf==t||bf==x)){this.__pJ=bb[0];
}else{this.setSelection([bb[0]]);
this.__pJ=null;
}bb[0].addListener(g,this.__pL,this);
bb[0].addListener(h,this.__pM,this);
}else{this.resetSelection();
}},_onPopupChangeVisibility:function(e){var M=this.getChildControl(j);

if(!M.isVisible()){var O=this.getChildControl(n);
if(O.hasChildren()){O.setSelection(this.getSelection());
}}else{var L=M.getLayoutLocation(this);
var Q=qx.bom.Viewport.getHeight();
var P=L.top;
var R=Q-L.bottom;
var N=P>R?P:R;
var S=this.getMaxListHeight();
var O=this.getChildControl(n);

if(S==null||S>N){O.setMaxHeight(N);
}else if(S<N){O.setMaxHeight(S);
...
(function(){var r="horizontal",q="qx.event.type.Data",p="vertical",o="",n="qx.ui.form.List",m="Enter",k="one",j="addChildWidget",h="_applySpacing",g="Boolean",D="Integer",C="action",B="keyinput",A="__pN",z="addItem",y="removeChildWidget",x="_applyOrientation",w="single",v="keypress",u="list",s="pane",t="removeItem";
qx.Class.define(n,{extend:qx.ui.core.scroll.AbstractScrollArea,implement:[qx.ui.core.IMultiSelection,qx.ui.form.IForm,qx.ui.form.IModelSelection],include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MMultiSelectionHandling,qx.ui.form.MForm,qx.ui.form.MModelSelection],construct:function(E){arguments.callee.base.call(this);
this.__pN=new qx.ui.container.Composite();
this.__pN.addListener(j,this._onAddChild,this);
this.__pN.addListener(y,this._onRemoveChild,this);
this.getChildControl(s).add(this.__pN);
if(E){this.setOrientation(r);
}else{this.initOrientation();
}this.addListener(v,this._onKeyPress);
this.addListener(B,this._onKeyInput);
this.__pO=o;
},events:{addItem:q,removeItem:q},properties:{appearance:{refine:true,init:u},focusable:{refine:true,init:true},orientation:{check:[r,p],init:p,apply:x},spacing:{check:D,init:0,apply:h,themeable:true},enableInlineFind:{check:g,init:true}},members:{__pO:null,__pP:null,__pN:null,SELECTION_MANAGER:qx.ui.core.selection.ScrollArea,getChildrenContainer:function(){return this.__pN;
...
var content=this.__pN;
content.setLayout(Q);
content.setAllowGrowX(!P);
content.setAllowGrowY(P);
this._applySpacing(this.getSpacing());
},_applySpacing:function(b,c){this.__pN.getLayout().setSpacing(b);
},_onKeyPress:function(e){if(e.getKeyIdentifier()==m&&!e.isAltPressed()){var a=this.getSelection();

for(var i=0;i<a.length;i++){a[i].fireEvent(C);
}return true;
}return false;
...
if(!(d===w||d===k)){return;
}if(((new Date).valueOf()-this.__pP)>1000){this.__pO=o;
}this.__pO+=e.getChar();
var f=this.findItemByLabelFuzzy(this.__pO);
if(f){this.setSelection([f]);
}this.__pP=(new Date).valueOf();
...
if(L!=null){if(L.translate){L=L.translate();
}
...
(function(){var G="textfield",F="button",E="list",D="selected",C="focusout",B="inner",A="changeValue",z="popup",y="focusin",x="combobox",q="click",w="blur",t="Enter",p="quick",o="_applyPlaceholder",s="qx.ui.form.ComboBox",r="single",u="Down",n="String",v="qx.event.type.Data";
qx.Class.define(s,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.form.IStringForm],construct:function(){arguments.callee.base.call(this);
...
this.addListener(C,function(e){m.fireNonBubblingEvent(C,qx.event.type.Focus);
},this);
},properties:{appearance:{refine:true,init:x},placeholder:{check:n,nullable:true,apply:o}},events:{"changeValue":v},members:{__wK:null,__wL:null,_applyPlaceholder:function(O,P){this.getChildControl(G).setPlaceholder(O);
},_createChildControlImpl:function(R){var S;

switch(R){case G:S=new qx.ui.form.TextField();
S.setFocusable(false);
S.addState(B);
S.addListener(A,this._onTextFieldChangeValue,this);
S.addListener(w,this.close,this);
this._add(S,{flex:1});
break;
...
this._add(S);
break;
case E:S=arguments.callee.base.call(this,R);
S.setSelectionMode(r);
break;
}return S||arguments.callee.base.call(this,R);
},_forwardStates:{focused:true},tabFocus:function(){var H=this.getChildControl(G);
H.getFocusElement().focus();
H.selectAllText();
},setValue:function(d){var f=this.getChildControl(G);

if(f.getValue()==d){return;
}f.setValue(d);
},getValue:function(){return this.getChildControl(G).getValue();
},resetValue:function(){this.getChildControl(G).setValue(null);
},_onKeyPress:function(e){var c=this.getChildControl(z);
var b=e.getKeyIdentifier();

if(b==u&&e.isAltPressed()){this.getChildControl(F).addState(D);
this.toggle();
e.stopPropagation();
}else if(b==t){if(c.isVisible()){this.close();
e.stop();
}}else if(c.isVisible()){arguments.callee.base.call(this,e);
}},_onClick:function(e){var a=e.getTarget();

if(a==this.getChildControl(F)){this.toggle();
}else{this.close();
}},_onListMouseDown:function(e){if(this.__wK){var Q=this.__wK.getLabel();

if(this.getFormat()!=null){Q=this.getFormat().call(this,this.__wK);
}if(Q&&Q.translate){Q=Q.translate();
}this.setValue(Q);
this.__wK=null;
}},_onListChangeSelection:function(e){var I=e.getData();

if(I.length>0){var J=this.getChildControl(E);

if(J.getSelectionContext()==p){this.__wK=I[0];
...
this.__wK=null;
}}},_onPopupChangeVisibility:function(e){var j=this.getChildControl(z);

if(j.isVisible()){var k=this.getChildControl(E);
var l=this.getValue();
var i=null;
...
}this.getChildControl(F).removeState(D);
},_onTextFieldChangeValue:function(e){var N=e.getData();
var M=this.getChildControl(E);

if(N!=null){var L=M.findItem(N,false);

if(L){M.setSelection([L]);
}else{M.resetSelection();
}}else{M.resetSelection();
}this.fireDataEvent(A,N,e.getOldData());
...
},setTextSelection:function(g,h){this.getChildControl(G).setTextSelection(g,h);
