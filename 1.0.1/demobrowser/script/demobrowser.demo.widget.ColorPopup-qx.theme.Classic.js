...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.ColorPopup-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"c3e6970fb004"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var p="Selected Color",o="changeGreen",n="Open Popup",m="changeBlue",l="en",k="changeValue",j="changeRed",i="main",h="#23F3C1",g="demobrowser.demo.widget.ColorPopup",f="execute";
...
var c=new qx.ui.control.ColorPopup();
c.exclude();
c.setValue(h);
var d=new qx.ui.form.Button(n);
d.addListener(f,function(e){c.placeToWidget(d);
c.show();
});
var b=new qx.ui.basic.Label(p).set({marginLeft:10,padding:[3,6],decorator:i});
a.add(b,{left:100,top:20});
a.add(d,{left:20,top:20});
a.add(c,{left:100,top:100});
c.addListener(k,function(e){this.debug("Value Listener: "+e.getData());
b.setBackgroundColor(e.getData());
});
c.addListener(j,function(e){this.debug("Red Listener: "+e.getData());
});
c.addListener(o,function(e){this.debug("Green Listener: "+e.getData());
});
c.addListener(m,function(e){this.debug("Blue Listener: "+e.getData());
});
}}});
})();
...
(function(){var t="current-preview",s="execute",r="selected-preview",q="Number",p="preview-pane",o="selector-button",n="colorselector-cancelbutton",m="auto-button",l="colorselector-okbutton",k="mousedown",bf="teal",be="maroon",bd="qx.ui.control.ColorPopup",bc="#666",bb="changeValue",ba="#333",Y="#000",X="yellow",W="changeGreen",V="colorpopup",A="_applyValue",B="__Cc",y="blue",z="changeRed",w="field#",x="#CCC",u="Color Selector",v="changeVisibility",C="recent",D="changeBlue",K="mouseover",I="__Cd",O="Cancel",M="#FFF",R="right",Q="Open ColorSelector",F="mouseout",U="#999",T="Automatic",S="Basic Colors",E="Preview (Old/New)",G="visible",H="Recent Colors",J="OK",L="field",N="green",P="red";
qx.Class.define(bd,{extend:qx.ui.popup.Popup,implement:[qx.ui.form.IColorForm],construct:function(){arguments.callee.base.call(this);
...
},properties:{appearance:{refine:true,init:V},value:{nullable:true,apply:A,event:bb},red:{check:q,init:null,nullable:true,event:z},green:{check:q,init:null,nullable:true,event:W},blue:{check:q,init:null,nullable:true,event:D}},members:{__Ca:1e5,__Cb:null,__Cc:null,__Cd:null,__Ce:C,__Cf:12,_createChildControlImpl:function(g){var h;

switch(g){case L:h=new qx.ui.core.Widget;
h.addListener(k,this._onFieldMouseDown,this);
h.addListener(K,this._onFieldMouseOver,this);
h.addListener(F,this._onFieldMouseOut,this);
break;
case m:h=new qx.ui.form.Button(this.tr(T));
h.setAllowStretchX(true);
h.addListener(s,this._onAutomaticBtnExecute,this);
this.add(h);
break;
case o:h=new qx.ui.form.Button(this.tr(Q));
h.addListener(s,this._onSelectorButtonExecute,this);
this.add(h);
break;
case p:h=new qx.ui.groupbox.GroupBox(this.tr(E));
h.setLayout(new qx.ui.layout.HBox);
h.add(this._createChildControl(r,true),{flex:1});
h.add(this._createChildControl(t,true),{flex:1});
this.add(h);
break;
case r:h=new qx.ui.container.Composite(new qx.ui.layout.Basic);
break;
case t:h=new qx.ui.container.Composite(new qx.ui.layout.Basic);
break;
case l:h=new qx.ui.form.Button(this.tr(J));
h.addListener(s,this._onColorSelectorOk,this);
break;
case n:h=new qx.ui.form.Button(this.tr(O));
h.addListener(s,this._onColorSelectorCancel,this);
break;
}return h||arguments.callee.base.call(this,g);
},_createBoxes:function(){this.__Cb={};
var bt=this._tables;
var bw,bs,bu;
var j=0;

for(var bv in bt){bw=bt[bv];
bs=new qx.ui.groupbox.GroupBox(bw.label);
bs.setLayout(new qx.ui.layout.HBox);
this.__Cb[bv]=bs;
this.add(bs);

for(var i=0;i<this.__Cf;i++){bu=this.getChildControl(w+(j++));
bu.setBackgroundColor(bw.values[i]||null);
bs.add(bu);
}}},_createColorSelector:function(){if(this.__Cd){return;
}var bk=new qx.ui.window.Window(this.tr(u));
this.__Cc=bk;
bk.setLayout(new qx.ui.layout.VBox(16));
bk.setResizable(false);
bk.moveTo(20,20);
this.__Cd=new qx.ui.control.ColorSelector;
bk.add(this.__Cd);
var bl=new qx.ui.container.Composite(new qx.ui.layout.HBox(8,R));
bk.add(bl);
var bn=this._createChildControl(n);
var bm=this._createChildControl(l);
bl.add(bn);
bl.add(bm);
...
}var c=this._tables[this.__Ce].values;
var d=this.__Cb[this.__Ce];
...
}else if(c.length==this.__Cf){c.shift();
}c.push(f);
var a=d.getChildren();

for(var i=0;i<a.length;i++){a[i].setBackgroundColor(c[i]||null);
}},_onFieldMouseDown:function(e){var bA=this.getChildControl(t).getBackgroundColor();
this.setValue(bA);

if(bA){this.hide();
}},_onFieldMouseOver:function(e){this.getChildControl(t).setBackgroundColor(e.getTarget().getBackgroundColor());
...
}this.getChildControl(t).setBackgroundColor(bh);
...
this.__Cd.setGreen(bp);
this.__Cd.setBlue(bo);
this.__Cc.open();
},_onColorSelectorOk:function(){var br=this.__Cd;
this.setValue(qx.util.ColorUtil.rgbToRgbString([br.getRed(),br.getGreen(),br.getBlue()]));
this.__Cc.close();
},_onColorSelectorCancel:function(){this.__Cc.close();
},_onChangeVisibility:function(e){if(this.getVisibility()==G){var bE=this.getRed();
var bD=this.getGreen();
var bB=this.getBlue();
var bC=null;

if(bE!==null||bD!==null||bB!==null){var bC=qx.util.ColorUtil.rgbToRgbString([bE,bD,bB]);
}this.getChildControl(r).setBackgroundColor(bC);
this.getChildControl(t).setBackgroundColor(bC);
}},_tables:{core:{label:S,values:[Y,ba,bc,U,x,M,P,N,y,X,bf,be]},recent:{label:H,values:[]}}},destruct:function(){this._disposeObjects(B,I);
this._tables=this.__Cb=null;
}});
})();
...
qx.Class.define(bl,{extend:qx.ui.core.Widget,implement:[qx.ui.form.IColorForm],construct:function(){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.VBox());
this._createChildControl(Y);
this.addListener(bM,this._onAppear,this);
},events:{"dialogok":ch,"dialogcancel":ch,"changeValue":cE},properties:{appearance:{refine:true,init:bq},red:{check:cb,init:255,apply:bv},green:{check:cb,init:255,apply:bf},blue:{check:cb,init:255,apply:bw},hue:{check:cv,init:0,apply:bo},saturation:{check:cv,init:0,apply:cH},brightness:{check:cv,init:100,apply:bz}},members:{__Cg:null,__Ch:[bB,bu,by,bK,bm,bt,bE,bk,bJ,bH,bp,bh,bI,be,bg,bD,bA,cC,bn,bx],__Ci:bG,__Cj:0,__Ck:0,__Cl:0,__Cm:true,__Cn:false,_createChildControlImpl:function(a){var b;

switch(a){case Y:b=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
b.add(this.getChildControl(cd));
b.add(this.getChildControl(bb));
this._add(b);
break;
case bb:b=new qx.ui.groupbox.GroupBox(this.tr(cI));
b.setLayout(new qx.ui.layout.HBox(10));
b.add(this.getChildControl(bQ));
b.add(this.getChildControl(ca));
break;
case cd:b=new qx.ui.container.Composite(new qx.ui.layout.VBox(12));
b.add(this.getChildControl(ce));
b.add(this.getChildControl(bc));
b.add(this.getChildControl(bd),{flex:1});
break;
case bQ:b=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
b.setAllowGrowY(false);
b.addListener(ba,this._onHueSaturationPaneMouseWheel,this);
b.add(this.getChildControl(bT));
b.add(this.getChildControl(cq),{left:0,top:256});
break;
case bT:b=new qx.ui.basic.Image(bi);
b.addListener(cj,this._onHueSaturationFieldMouseDown,this);
break;
case cq:b=new qx.ui.basic.Image(br);
b.addListener(cj,this._onHueSaturationFieldMouseDown,this);
b.addListener(cf,this._onHueSaturationHandleMouseUp,this);
b.addListener(cg,this._onHueSaturationHandleMouseMove,this);
break;
case ca:b=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
b.setAllowGrowY(false);
b.addListener(ba,this._onBrightnessPaneMouseWheel,this);
b.add(this.getChildControl(ck));
b.add(this.getChildControl(cr));
break;
case ck:b=new qx.ui.basic.Image(cK);
b.addListener(cj,this._onBrightnessFieldMouseDown,this);
break;
case cr:b=new qx.ui.basic.Image(cJ);
b.addListener(cj,this._onBrightnessHandleMouseDown,this);
b.addListener(cf,this._onBrightnessHandleMouseUp,this);
b.addListener(cg,this._onBrightnessHandleMouseMove,this);
break;
case ce:b=new qx.ui.groupbox.GroupBox(this.tr(bC));
b.setLayout(new qx.ui.layout.Grow());
b.add(this.getChildControl(cc));
break;
case cF:b=new qx.ui.core.Widget();
b.addListener(cj,this._onColorFieldClick,this);
break;
case cc:h=new qx.ui.layout.Grid(3,3);
b=new qx.ui.container.Composite(h);
var k;
var g;

for(var i=0;i<2;i++){for(var j=0;j<10;j++){g=i*10+j;
k=this.getChildControl(bL+g);
k.setBackgroundColor(this.__Ch[g]);
b.add(k,{column:j,row:i});
}}break;
case bc:b=new qx.ui.groupbox.GroupBox(this.tr(bF));
var h=new qx.ui.layout.VBox();
h.setSpacing(10);
b.setLayout(h);
b.add(this.getChildControl(bY));
b.add(this.getChildControl(bX));
b.add(this.getChildControl(X));
break;
case bd:b=new qx.ui.groupbox.GroupBox(this.tr(cG));
var h=new qx.ui.layout.HBox(10);
b.setLayout(h);
b.add(this.getChildControl(bW),{flex:1});
b.add(this.getChildControl(bR),{flex:1});
break;
case bY:var f=new qx.ui.layout.HBox(4);
f.setAlignY(cu);
b=new qx.ui.container.Composite(f);
var m=new qx.ui.basic.Label(this.tr(cD));
b.add(m);
var l=new qx.ui.basic.Label(cs);
b.add(l);
b.add(this.getChildControl(cy));
break;
case cy:b=new qx.ui.form.TextField(cL);
b.setMaxLength(6);
b.setFilter(/[0-9A-Fa-f]/);
b.setWidth(55);
b.addListener(cn,this._onHexFieldChange,this);
break;
case bX:var f=new qx.ui.layout.HBox(4);
f.setAlignY(cu);
b=new qx.ui.container.Composite(f);
var c=new qx.ui.basic.Label(this.tr(bj));
c.setWidth(25);
b.add(c);
b.add(this.getChildControl(ci));
b.add(this.getChildControl(bV));
b.add(this.getChildControl(bP));
break;
case ci:b=new qx.ui.form.Spinner(0,255,255);
b.setWidth(50);
b.addListener(cn,this._setRedFromSpinner,this);
break;
case bV:b=new qx.ui.form.Spinner(0,255,255);
b.setWidth(50);
b.addListener(cn,this._setGreenFromSpinner,this);
break;
case bP:b=new qx.ui.form.Spinner(0,255,255);
b.setWidth(50);
b.addListener(cn,this._setBlueFromSpinner,this);
break;
case X:var f=new qx.ui.layout.HBox(4);
f.setAlignY(cu);
b=new qx.ui.container.Composite(f);
var d=new qx.ui.basic.Label(this.tr(bs));
d.setWidth(25);
b.add(d);
b.add(this.getChildControl(bO));
b.add(this.getChildControl(bN));
b.add(this.getChildControl(bS));
break;
case bO:b=new qx.ui.form.Spinner(0,0,360);
b.setWidth(50);
b.addListener(cn,this._setHueFromSpinner,this);
break;
case bN:b=new qx.ui.form.Spinner(0,0,100);
b.setWidth(50);
b.addListener(cn,this._setSaturationFromSpinner,this);
break;
case bS:b=new qx.ui.form.Spinner(0,100,100);
b.setWidth(50);
b.addListener(cn,this._setBrightnessFromSpinner,this);
break;
case bW:b=new qx.ui.core.Widget();
break;
case bR:b=new qx.ui.core.Widget();
break;
}return b||arguments.callee.base.call(this,a);
},setValue:function(s){var t;

if(s==null){this.__Cm=true;
t=[255,255,255];
}else{t=qx.util.ColorUtil.stringToRgb(s);
this.__Cm=false;
}this.__Cn=true;
this.setRed(t[0]);
this.setGreen(t[1]);
this.__Cn=false;
this.setBlue(t[2]);
},getValue:function(){return this.__Cm?null:cs+qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);
},resetValue:function(){this.__Cm=true;
this.__Cn=true;
this.setRed(255);
this.setGreen(255);
this.__Cn=false;
this.setBlue(255);
},__Co:function(){if(!this.__Cn){this.__Cm=false;
this.fireDataEvent(cn,this.getValue());
}},_applyRed:function(x,y){if(this.__Cg===null){this.__Cg=ct;
}
if(this.__Cg!==co){this.getChildControl(ci).setValue(x);
}
if(this.__Cg!==cm){this._setHexFromRgb();
}
switch(this.__Cg){case co:case cm:case ct:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__Co();

if(this.__Cg===ct){this.__Cg=null;
}},_applyGreen:function(T,U){if(this.__Cg===null){this.__Cg=cA;
}
if(this.__Cg!==co){this.getChildControl(bV).setValue(T);
}
if(this.__Cg!==cm){this._setHexFromRgb();
}
switch(this.__Cg){case co:case cm:case cA:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__Co();

if(this.__Cg===cA){this.__Cg=null;
}},_applyBlue:function(u,v){if(this.__Cg===null){this.__Cg=cw;
}
if(this.__Cg!==co){this.getChildControl(bP).setValue(u);
}
if(this.__Cg!==cm){this._setHexFromRgb();
}
switch(this.__Cg){case co:case cm:case cw:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__Co();

if(this.__Cg===cw){this.__Cg=null;
}},_applyHue:function(O,P){if(this.__Cg===null){this.__Cg=cB;
}
if(this.__Cg!==cp){this.getChildControl(bO).setValue(O);
}
if(this.__Cg!==cl){if(this.getChildControl(cq).getBounds()){this.getChildControl(cq).setDomLeft(Math.round(O/1.40625)+this.getChildControl(bQ).getPaddingLeft());
}else{this.getChildControl(cq).setLayoutProperties({left:Math.round(O/1.40625)});
}}
switch(this.__Cg){case cp:case cl:case cB:this._setRgbFromHue();
}this._setBrightnessGradiant();

if(this.__Cg===cB){this.__Cg=null;
}},_applySaturation:function(L,M){if(this.__Cg===null){this.__Cg=cx;
}
if(this.__Cg!==cp){this.getChildControl(bN).setValue(L);
}
if(this.__Cg!==cl){this._setBrightnessGradiant();

if(this.getChildControl(cq).getBounds()){this.getChildControl(cq).setDomTop(256-Math.round(L*2.56)+this.getChildControl(bQ).getPaddingTop());
}else{this.getChildControl(cq).setLayoutProperties({top:256-Math.round(L*2.56)});
}}
switch(this.__Cg){case cp:case cl:case cx:this._setRgbFromHue();
}
if(this.__Cg===cx){this.__Cg=null;
}},_applyBrightness:function(z,A){if(this.__Cg===null){this.__Cg=cz;
}
if(this.__Cg!==cp){this.getChildControl(bS).setValue(z);
}
if(this.__Cg!==bU){var B=256-Math.round(z*2.56);

if(this.getChildControl(cr).getBounds()){this.getChildControl(cr).setDomTop(B+this.getChildControl(ca).getPaddingTop());
}else{this.getChildControl(cr).setLayoutProperties({top:B});
}}
switch(this.__Cg){case cp:case bU:case cz:this._setRgbFromHue();
}
if(this.__Cg===cz){this.__Cg=null;
}},_onBrightnessHandleMouseDown:function(e){this.getChildControl(cr).capture();
this.__Ci=cr;
var E=this.getChildControl(ck).getContainerLocation();
var D=this.getChildControl(cr).getContainerLocation();
var C=this.getChildControl(ck).getBounds();
this.__Cj=E.top+(e.getDocumentTop()-D.top)-C.top;
e.stopPropagation();
},_onBrightnessHandleMouseUp:function(e){this.getChildControl(cr).releaseCapture();
this.__Ci=null;
},_onBrightnessHandleMouseMove:function(e){if(this.__Ci===cr){this._setBrightnessOnFieldEvent(e);
e.stopPropagation();
}},_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(ck).getContainerLocation();
var w=this.getChildControl(cr).getBounds();
this.__Cj=location.top+(w.height/2);
...
e.stop();
},_setBrightnessOnFieldEvent:function(e){var H=qx.lang.Number.limit(e.getDocumentTop()-this.__Cj,0,256);
this.__Cg=bU;

if(this.getChildControl(cr).getBounds()){this.getChildControl(cr).setDomTop(H);
}else{this.getChildControl(cr).setLayoutProperties({top:H});
}this.setBrightness(100-Math.round(H/2.56));
this.__Cg=null;
},_onHueSaturationHandleMouseUp:function(e){if(this.__Ci){e.stopPropagation();
this.getChildControl(cq).releaseCapture();
this.__Ci=null;
}},_onHueSaturationHandleMouseMove:function(e){if(this.__Ci===cq){this._setHueSaturationOnFieldEvent(e);
e.stopPropagation();
}},_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(bT).getContainerLocation();
var n=this.getChildControl(cq).getBounds();
var o=this.getChildControl(bT).getBounds();
this.__Ck=location.top+(n.height/2)-o.top;
this.__Cl=location.left+(n.width/2)-o.left;
...
e.stop();
},_setHueSaturationOnFieldEvent:function(e){var W=qx.lang.Number.limit(e.getDocumentTop()-this.__Ck,0,256);
var V=qx.lang.Number.limit(e.getDocumentLeft()-this.__Cl,0,256);
this.getChildControl(cq).setDomPosition(V,W);
this.__Cg=cl;
this.setSaturation(100-Math.round(W/2.56));
this.setHue(Math.round(V*1.40625));
this.__Cg=null;
},_setRedFromSpinner:function(){if(this.__Cg!==null){return;
}this.__Cg=co;
this.setRed(this.getChildControl(ci).getValue());
this.__Cg=null;
},_setGreenFromSpinner:function(){if(this.__Cg!==null){return;
}this.__Cg=co;
this.setGreen(this.getChildControl(bV).getValue());
this.__Cg=null;
},_setBlueFromSpinner:function(){if(this.__Cg!==null){return;
}this.__Cg=co;
this.setBlue(this.getChildControl(bP).getValue());
this.__Cg=null;
},_setHueFromSpinner:function(){if(this.__Cg!==null){return;
}this.__Cg=cp;
this.setHue(this.getChildControl(bO).getValue());
this.__Cg=null;
},_setSaturationFromSpinner:function(){if(this.__Cg!==null){return;
}this.__Cg=cp;
this.setSaturation(this.getChildControl(bN).getValue());
this.__Cg=null;
},_setBrightnessFromSpinner:function(){if(this.__Cg!==null){return;
}this.__Cg=cp;
this.setBrightness(this.getChildControl(bS).getValue());
this.__Cg=null;
},_onHexFieldChange:function(e){if(this.__Cg!==null){return;
}
try{var R=this.getChildControl(cy);
var Q=qx.util.ColorUtil.hexStringToRgb(cs+R.getValue());
}catch(cM){return;
}this.__Cg=cm;
this.setRed(Q[0]);
this.setGreen(Q[1]);
this.setBlue(Q[2]);
this.__Cg=null;
},_setHexFromRgb:function(){var q=qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(cy).setValue(q);
},_onColorFieldClick:function(e){var F=e.getTarget().getBackgroundColor();

if(!F){return this.error("Missing backgroundColor value for field: "+e.getTarget());
}var G=qx.util.ColorUtil.stringToRgb(F);
this.setRed(G[0]);
this.setGreen(G[1]);
this.setBlue(G[2]);
},_setHueFromRgb:function(){switch(this.__Cg){case cp:case cl:case bU:break;
default:var p=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);
this.setHue(p[0]);
this.setSaturation(p[1]);
this.setBrightness(p[2]);
}},_setRgbFromHue:function(){switch(this.__Cg){case co:case cm:break;
default:var S=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);
this.setRed(S[0]);
this.setGreen(S[1]);
this.setBlue(S[2]);
}},_setPreviewFromRgb:function(){var r=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
...
this.getChildControl(bW).setBackgroundColor(cQ);
this.setRed(cN);
this.setGreen(cO);
this.setBlue(cP);
},_setBrightnessGradiant:function(){var I=qx.util.ColorUtil;
var J=I.hsbToRgb([this.getHue(),this.getSaturation(),255]);
var K=I.rgbToRgbString(J);
this.getChildControl(ck).setBackgroundColor(K);
},_onAppear:function(e){var N=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(bW).setBackgroundColor(N);
this.getChildControl(bR).setBackgroundColor(N);
}}});
})();
