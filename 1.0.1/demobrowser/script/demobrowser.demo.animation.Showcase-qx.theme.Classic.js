...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.animation.Showcase-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"6e063b69d511"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var S="setup",R="finish",Q="execute",P="Shrink",O="19,66,117",N="#134275",M="#7CFC00",L="Drop out",K="Fold in",J="backgroundColor",bu="Attention effects",bt="Vanish effects",bs="Grow",br="out",bq="block",bp="in",bo="Base effects",bn="Puff",bm="default",bl="Shake",ba="testImg",bb="Drop in",X="Fold out",Y="ColorFlow",V="Toggle Background",W="Toggle Size",T="Toggle Opacity",U="testDiv",bc="Pulsate",bd="Switch Off",bg="spring",bf="bold",bi="Toggle Position",bh="_vBoxes",bk="demobrowser.demo.animation.Showcase",bj="south",be="display";
qx.Class.define(bk,{extend:qx.application.Standalone,members:{_toggleEnable:function(){var status=(this._vBoxes[0].getEnabled()===false);

for(var i=0,l=this._vBoxes.length;i<l;i++){this._vBoxes[i].setEnabled(status);
}},main:function(){arguments.callee.base.call(this);
this._demoElement=document.getElementById(U);
this._demoImage=document.getElementById(ba);
var A=this.getRoot();
this._vBoxes=[];
var p=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
p.setWidth(150);
var B={gbxBase:new qx.ui.groupbox.GroupBox(bo),gbxAttention:new qx.ui.groupbox.GroupBox(bu),gbxVanish:new qx.ui.groupbox.GroupBox(bt)};
var B={gbxBase:new qx.ui.groupbox.GroupBox(bo),gbxAttention:new qx.ui.groupbox.GroupBox(bu),gbxVanish:new qx.ui.groupbox.GroupBox(bt)};

for(var x in B){B[x].setLayout(new qx.ui.layout.Grow);
}var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
k.set({minWidth:120});
this._vBoxes.push(k);
var v=new qx.ui.form.Button(T);
var s=new qx.ui.form.Button(W);
var F=new qx.ui.form.Button(bi);
var b=new qx.ui.form.Button(V);
k.add(v);
k.add(s);
k.add(F);
k.add(b);
B.gbxBase.add(k);
var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
r.set({minWidth:120});
this._vBoxes.push(r);
var m=new qx.ui.form.Button(bl);
var z=new qx.ui.form.Button(Y);
var d=new qx.ui.form.Button(bc);
r.add(m);
r.add(z);
r.add(d);
B.gbxAttention.add(r);
var t=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
t.set({minWidth:120});
this._vBoxes.push(t);
var f=new qx.ui.form.Button(bn);
var j=new qx.ui.form.Button(L);
var h=new qx.ui.form.Button(bd);
var I=new qx.ui.form.Button(P);
var c=new qx.ui.form.Button(K);
t.add(f);
t.add(j);
t.add(I);
t.add(h);
...
for(var x in B){p.add(B[x]);
}A.add(p);
var E=new qx.fx.effect.core.Fade(this._demoElement);
E.addListener(S,function(){this._toggleEnable();
},this);
E.addListener(R,function(){this._toggleEnable();
},this);
v.addListener(Q,function(){var status=qx.bom.element.Style.get(this._demoElement,be);
E.set({from:(status==bq)?1:0,to:(status==bq)?0:1});
E.start();
},this);
var u=new qx.fx.effect.core.Scale(this._demoImage);
u.addListener(S,function(){this._toggleEnable();
},this);
u.addListener(R,function(){this._toggleEnable();
},this);
s.addListener(Q,function(){var status=qx.bom.element.Dimension.getWidth(this._demoImage);
u.set({scaleTo:((status>240)?80:120),duration:0.5});
u.start();
},this);
var y=new qx.fx.effect.core.Move(this._demoElement);
y.addListener(S,function(){this._toggleEnable();
},this);
y.addListener(R,function(){this._toggleEnable();
},this);
F.addListener(Q,function(){var status=qx.bom.element.Location.getLeft(this._demoElement);
y.set({duration:1,x:(status<300)?300:-300,y:(status<300)?100:-100,transition:bg});
y.start();
},this);
var a=new qx.fx.effect.core.Highlight(this._demoElement);
a.addListener(S,function(){this._toggleEnable();
},this);
a.addListener(R,function(){this._toggleEnable();
},this);
b.addListener(Q,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,J)).toString();
a.set({startColor:(status==O)?N:M,endColor:(status==O)?M:N,restoreBackground:false});
a.start();
},this);
var g=new qx.fx.effect.combination.Shake(this._demoElement);
g.addListener(S,function(){this._toggleEnable();
},this);
g.addListener(R,function(){this._toggleEnable();
},this);
m.addListener(Q,function(){g.start();
});
var n=new qx.fx.effect.combination.ColorFlow(this._demoElement);
n.addListener(S,function(){this._toggleEnable();
},this);
n.addListener(R,function(){this._toggleEnable();
},this);
z.addListener(Q,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,J)).toString();
n.set({restoreBackground:false,startColor:(status==O)?N:M,endColor:(status==O)?M:N});
n.start();
},this);
var G=new qx.fx.effect.combination.Pulsate(this._demoElement);
G.addListener(S,function(){this._toggleEnable();
},this);
G.addListener(R,function(){this._toggleEnable();
},this);
d.addListener(Q,function(){G.start();
});
var H=new qx.fx.effect.combination.Puff(this._demoImage);
H.setModifyDisplay(false);
H.addListener(S,function(){this._toggleEnable();
},this);
H.addListener(R,function(){this._toggleEnable();
},this);
f.addListener(Q,function(){H.start();
});
var q=new qx.fx.effect.combination.Shrink(this._demoImage);
var w=new qx.fx.effect.combination.Grow(this._demoImage);
var o=q;
q.addListener(S,function(){this._toggleEnable();
},this);
q.addListener(R,function(){this._toggleEnable();

if(I.getLabel()==P){I.setLabel(bs);
o=w;
}else{I.setLabel(P);
o=q;
}},this);
w.addListener(S,function(){this._toggleEnable();
},this);
w.addListener(R,function(){this._toggleEnable();
...
I.addListener(Q,function(){o.start();
});
var C=new qx.fx.effect.combination.Drop(this._demoElement);
C.set({direction:bj,yAmount:90});
C.addListener(S,function(){this._toggleEnable();
},this);
C.addListener(R,function(){this._toggleEnable();

if(j.getLabel()==L){j.setLabel(bb);
C.setMode(bp);
}else{j.setLabel(L);
C.setMode(br);
}},this);
j.addListener(Q,function(){C.start();
});
var e=new qx.fx.effect.combination.Fold(this._demoElement);
e.addListener(S,function(){this._toggleEnable();
},this);
e.addListener(R,function(){this._toggleEnable();
qx.lang.Function.delay(function(){if(c.getLabel()==K){c.setLabel(X);
e.setMode(br);
}else{c.setLabel(K);
e.setMode(bp);
}},100,this);
},this);
c.addListener(Q,function(){e.start();
});
var D=new qx.fx.effect.combination.Switch(this._demoElement);
D.setModifyDisplay(false);
D.addListener(S,function(){this._toggleEnable();
},this);
D.addListener(R,function(){this._toggleEnable();
},this);
h.addListener(Q,function(){D.start();
});

for(var x in B){B[x].setFont(bf);
p.add(B[x]);
}
for(var i=0;i<this._vBoxes.length;i++){this._vBoxes[i].setFont(bm);
...
this.__pT=qx.fx.Base.EffectState.IDLE;
this.__pU=C;
},events:{"setup":s,"update":s,"finish":s},properties:{duration:{init:0.5,check:t,apply:g},fps:{init:100,check:t},sync:{init:false,check:o},from:{init:0,check:t},to:{init:1,check:t},delay:{init:0.0,check:t},queue:{check:i},transition:{init:q,check:[q,f,c,k,p,d,h,j,b,m,e]}},statics:{EffectState:{IDLE:'idle',PREPARING:'preparing',FINISHED:'finished',RUNNING:'running'}},members:{__pT:null,__pV:null,__pW:null,__pX:null,__pY:null,__qa:null,__qb:null,__qc:null,__pU:null,_getElement:function(){return this.__pU;
},_setElement:function(z){this.__pU=z;
},_applyDuration:function(x,y){},init:function(){this.__pT=qx.fx.Base.EffectState.PREPARING;
this.__pV=0;
this.__pW=this.getDelay()*1000+(new Date().getTime());
this.__pX=this.__pW+(this.getDuration()*1000);
this.__pY=this.getTo()-this.getFrom();
this.__qa=this.__pX-this.__pW;
this.__qb=this.getFps()*this.getDuration();
...
},start:function(){if(this.__pT!=qx.fx.Base.EffectState.IDLE){return false;
}this.init();
...
this.afterFinish();
},render:function(B){if(this.__pT==qx.fx.Base.EffectState.PREPARING){this.__pT=qx.fx.Base.EffectState.RUNNING;
...
if(this.__pT==qx.fx.Base.EffectState.RUNNING){this.__qc=qx.fx.Transition.get(this.getTransition())(B)*this.__pY+this.getFrom();
this.beforeUpdateInternal();
this.beforeUpdate();
this.update(this.__qc);
this.afterUpdateInternal();
this.afterUpdate();

if(this.hasListener(r)){this.fireEvent(r);
}}},loop:function(u){if(u>=this.__pW){if(u>=this.__pX){this.end();
}var w=(u-this.__pW)/this.__qa;
var v=Math.round(w*this.__qb);
if(v>this.__pV){this.render(w);
this.__pV=v;
}}},cancel:function(){if(!this.getSync()){this.getQueue().remove(this);
}this.__pT=qx.fx.Base.EffectState.IDLE;
},resetState:function(){this.__pT=qx.fx.Base.EffectState.IDLE;
}},destruct:function(){this.__pU=this.__pT=null;
}});
})();
...
(function(){var f="__default",e="qx.fx.queue.Manager",d="__qi",c="singleton",b="object";
qx.Class.define(e,{extend:qx.core.Object,type:c,construct:function(){arguments.callee.base.call(this);
this.__qi={};
},members:{__qi:null,getQueue:function(a){if(typeof (this.__qi[a])==b){return this.__qi[a];
}else{return this.__qi[a]=new qx.fx.queue.Queue;
}},getDefaultQueue:function(){return this.getQueue(f);
}},destruct:function(){this._disposeMap(d);
}});
})();
(function(){var g="qx.fx.queue.Queue",f="Number";
qx.Class.define(g,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__qj=[];
},properties:{limit:{init:Infinity,check:f}},members:{__qk:null,__qj:null,add:function(a){var b=new Date().getTime();
a._startOn+=b;
a._finishOn+=b;

if(this.__qj.length<this.getLimit()){this.__qj.push(a);
}else{a.resetState();
}
if(!this.__qk){this.__qk=qx.lang.Function.periodical(this.loop,15,this);
}},remove:function(e){qx.lang.Array.remove(this.__qj,e);

if(this.__qj.length==0){window.clearInterval(this.__qk);
delete this.__qk;
}},loop:function(){var c=new Date().getTime();

for(var i=0,d=this.__qj.length;i<d;i++){this.__qj[i]&&this.__qj[i].loop(c);
}}},destruct:function(){this.__qj=null;
}});
})();
(function(){var d="Number",c="static",b="qx.fx.Transition";
qx.Class.define(b,{type:c,statics:{get:function(a){return qx.fx.Transition[a]||false;
},linear:function(e){return e;
},easeInQuad:function(n){return Math.pow(2,10*(n-1));
},easeOutQuad:function(k){return (-Math.pow(2,-10*k)+1);
},sinodial:function(i){return (-Math.cos(i*Math.PI)/2)+0.5;
},reverse:function(g){return 1-g;
...
(function(){var t='px',s="Boolean",r="Number",q="fontSize",p="Array",o="qx.fx.effect.core.Scale",n="12px",m='pt',l='em',k="position",h='%',j="100%",i="string",g="absolute";
qx.Class.define(o,{extend:qx.fx.Base,construct:function(u){arguments.callee.base.call(this,u);
this.__qq=qx.fx.effect.core.Scale.originalStyle;
this.__qr=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:s},scaleY:{init:true,check:s},scaleContent:{init:true,check:s},scaleFromCenter:{init:true,check:s},scaleFrom:{init:100.0,check:r},scaleTo:{init:100,check:r},restoreAfterFinish:{init:false,check:s},alternateDimensions:{init:[],check:p}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':l,'px':t,'%':h,'pt':m}},members:{__qs:null,__qt:null,__qu:null,__qv:null,__qw:null,__qx:null,__qy:null,__qq:null,__qr:null,setup:function(){arguments.callee.base.call(this);
var f=this._getElement();
this.__qs=qx.bom.element.Style.get(f,k);

for(var c in this.__qq){this.__qq[c]=f.style[c];
}this.__qt=qx.bom.element.Location.getTop(f);
this.__qu=qx.bom.element.Location.getLeft(f);

try{var e=qx.bom.element.Style.get(f,q);
}catch(B){if(typeof (e)!=i){e=(qx.bom.client.Engine.MSHTML)?n:j;
}}
for(var a in this.__qr){if(e.indexOf(a)>0){this.__qv=parseFloat(e);
this.__qw=a;
break;
}}this.__qx=(this.getScaleTo()-this.getScaleFrom())/100;
var b=this.getAlternateDimensions();

if(b.length==0){this.__qy=[f.offsetWidth,f.offsetHeight];
}else{this.__qy=b;
}},update:function(v){var x=this._getElement();
arguments.callee.base.call(this);
var w=(this.getScaleFrom()/100.0)+(this.__qx*v);

if(this.getScaleContent()&&this.__qv){qx.bom.element.Style.set(x,q,this.__qv*w+this.__qw);
}this._setDimensions(this.__qy[0]*w,this.__qy[1]*w);
},finish:function(){arguments.callee.base.call(this);
var A=this._getElement();

if(this.getRestoreAfterFinish()){for(var y in this.__qq){var z=this.__qq[y];
qx.bom.element.Style.set(A,y,z);
}}},_setDimensions:function(C,D){var d={};
var H=this._getElement();
var F=this.getScaleX();
var G=this.getScaleY();

if(F){d.width=Math.round(C)+t;
}
if(G){d.height=Math.round(D)+t;
}
if(this.getScaleFromCenter()){var I=(C-this.__qy[0])/2;
var J=(D-this.__qy[1])/2;

if(this.__qs==g){if(G){d.top=this.__qt-J+t;
}
if(F){d.left=this.__qu-I+t;
}}else{if(G){d.top=-J+t;
}
if(F){d.left=-I+t;
}}}
for(var E in d){qx.bom.element.Style.set(H,E,d[E]);
}}},destruct:function(){this.__qy=this.__qq=this.__qr=null;
}});
})();
(function(){var i="position",h="px",g="relative",f="Number",e="absolute",d="top",c="left",b='absolute',a="qx.fx.effect.core.Move";
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:g,check:[g,e]},x:{init:0,check:f},y:{init:0,check:f}},members:{__qd:null,__qe:null,__qf:null,__qg:null,__qh:null,setup:function(){var m=this._getElement();
arguments.callee.base.call(this);

if(m.parentNode){this.__qf=qx.bom.element.Location.getLeft(m)-qx.bom.element.Location.getLeft(m.parentNode);
this.__qg=qx.bom.element.Location.getTop(m)-qx.bom.element.Location.getTop(m.parentNode);
}else{this.__qf=qx.bom.element.Location.getLeft(m);
this.__qg=qx.bom.element.Location.getTop(m);
}this.__qh=qx.bom.element.Style.get(m,i);
qx.bom.element.Style.set(m,i,e);

if(this.getMode()==b){this.__qd=this.getX()-this.__qf;
this.__qe=this.getY()-this.__qg;
}else{this.__qd=this.getX();
this.__qe=this.getY();
}},update:function(j){var l=this._getElement();
arguments.callee.base.call(this);
var k=Math.round(this.__qd*j+this.__qf);
var top=Math.round(this.__qe*j+this.__qg);
qx.bom.element.Style.set(l,c,k+h);
qx.bom.element.Style.set(l,d,top+h);
},afterFinishInternal:function(){qx.bom.element.Style.set(this._getElement(),i,this.__qh);
}}});
})();
(function(){var k="backgroundColor",j="Boolean",i="backgroundImage",h="Color",g="none",f="qx.fx.effect.core.Highlight",e="#ffffff",d="#",c="#ffffaa";
qx.Class.define(f,{extend:qx.fx.Base,properties:{startColor:{init:e,check:h},endColor:{init:c,check:h},restoreBackground:{init:true,check:j},keepBackgroundImage:{init:false,check:j}},members:{__qm:null,__qn:null,__qo:null,__qp:null,setup:function(){arguments.callee.base.call(this);
var o=this._getElement();
this.__qm={backgroundImage:qx.bom.element.Style.get(o,i),backgroundColor:qx.bom.element.Style.get(o,k)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(o,i,g);
}this.__qn=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__qo=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__qp=[this.__qo[0]-this.__qn[0],this.__qo[1]-this.__qn[1],this.__qo[2]-this.__qn[2]];
},update:function(l){arguments.callee.base.call(this);
var m=[this.__qn[0]+Math.round(this.__qp[0]*l),this.__qn[1]+Math.round(this.__qp[1]*l),this.__qn[2]+Math.round(this.__qp[2]*l)];
var n=d+qx.util.ColorUtil.rgbToHexString([m[0].toString(16),m[1].toString(16),m[2].toString(16)]);
qx.bom.element.Style.set(this._getElement(),k,n);
},finish:function(){arguments.callee.base.call(this);

if(this.getRestoreBackground()){qx.lang.Function.delay(this._restore,1000,this);
}},_restore:function(){var b=this._getElement();

for(var a in this.__qm){qx.bom.element.Style.set(b,a,this.__qm[a]);
}}},destruct:function(){this.__qn=this.__qo=this.__qp=null;
}});
})();
(function(){var f="horizontal",e="vertical",d="qx.fx.effect.combination.Shake",c="__qz",b="Number";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
this.__qz=[new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a)];
},properties:{direction:{init:f,check:[f,e]},duration:{init:0.5,refine:true},distance:{init:20,check:b}},members:{__qz:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var g=parseFloat(this.getDistance());
var h=parseFloat(this.getDuration())/10.0;

if(this.getDirection()==f){this.__qz[0].set({x:g,y:0,duration:h});
this.__qz[1].set({x:-g*2,y:0,duration:h*2});
this.__qz[2].set({x:g*2,y:0,duration:h*2});
this.__qz[3].set({x:-g*2,y:0,duration:h*2});
this.__qz[4].set({x:g*2,y:0,duration:h*2});
this.__qz[5].set({x:-g,y:0,duration:h*2});
}else if(this.getDirection()==e){this.__qz[0].set({y:g,x:0,duration:h});
this.__qz[1].set({y:-g*2,x:0,duration:h*2});
this.__qz[2].set({y:g*2,x:0,duration:h*2});
this.__qz[3].set({y:-g*2,x:0,duration:h*2});
this.__qz[4].set({y:g*2,x:0,duration:h*2});
this.__qz[5].set({y:-g,x:0,duration:h*2});
}var k=this.__qz;

for(var i=0,j=this.__qz.length;i<j;i++){this.__qz[i].id=i;

if(i<5){this.__qz[i].afterFinishInternal=function(){k[this.id+1].start();
};
}}this.__qz[0].start();
}},destruct:function(){this._disposeArray(c);
}});
})();
(function(){var t="linear",s="Number",r="reverse",q="Boolean",p="none",o="wobble",n="flicker",m="pulse",l="sinodial",k="easeOutQuad",d="spring",j="easeInQuad",g="full",c="Color",b="backgroundColor",f="#ffffff",e="backgroundImage",h="qx.fx.effect.combination.ColorFlow",a="__qA",i="#ffffaa";
qx.Class.define(h,{extend:qx.fx.Base,construct:function(v){arguments.callee.base.call(this,v);
this.__qA=[new qx.fx.effect.core.Highlight(v),new qx.fx.effect.core.Highlight(v)];
},properties:{startColor:{init:f,check:c},endColor:{init:i,check:c},forwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},backwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},forwardDuration:{init:1.0,check:s},backwardDuration:{init:1.0,check:s},delayBetween:{init:0.3,check:s},restoreBackground:{init:true,check:q},keepBackgroundImage:{init:false,check:q}},members:{__qB:null,__qA:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var u=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__qB={backgroundImage:qx.bom.element.Style.get(u,e),backgroundColor:qx.bom.element.Style.get(u,b)};
this.__qA[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__qA[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__qA[0].afterFinishInternal=function(){self.__qA[1].start();
};
this.__qA[0].start();
}},destruct:function(){this._disposeArray(a);
}});
})();
(function(){var d="opacity",c="__qC",b="qx.fx.effect.combination.Pulsate",a="sinodial";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(f){arguments.callee.base.call(this,f);
var g=this.getDuration()/6;
var h=0;
this.__qC=[new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f)];

for(var i=0,l=this.__qC.length;i<l;i++){this.__qC[i].set({duration:g,to:((h%2)!=0)?1:0,from:((h%2)!=0)?0:1,transition:a,modifyDisplay:false});
h++;
}},properties:{duration:{init:2,refine:true}},members:{__qD:null,__qC:null,beforeSetup:function(){this.__qD=qx.bom.element.Style.get(this._getElement(),d);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var e=0;
var self=this;

for(var i=0,l=this.__qC.length;i<l;i++){this.__qC[i].id=e;

if(e<5){this.__qC[i].afterFinishInternal=function(){self.__qC[this.id+1].start();
};
}e++;
}this.__qC[0].start();
},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),d,this.__qD);
}},destruct:function(){this._disposeArray(c);
}});
})();
(function(){var m="__qE",l="opacity",k="Boolean",j="__qF",i="none",h="qx.fx.effect.combination.Puff",g="_effects",f="__qG",e="display";
qx.Class.define(h,{extend:qx.fx.Base,construct:function(n){arguments.callee.base.call(this,n);
this.__qE=new qx.fx.effect.core.Scale(n);
this.__qF=new qx.fx.effect.core.Fade(n);
this.__qG=new qx.fx.effect.core.Parallel(this.__qE,this.__qF);
},properties:{modifyDisplay:{init:true,check:k}},members:{__qF:null,__qE:null,__qG:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),e,i);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var d=this._getElement();
var c={opacity:qx.bom.element.Style.get(d,l)};
this.__qF.afterFinishInternal=function(){var b=this._getElement();

for(var a in c){qx.bom.element.Style.set(b,a,c[a]);
}};
this.__qE.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__qF.set({sync:true,to:0.0,modifyDisplay:false});
this.__qG.start();
}},destruct:function(){this._disposeArray(g);
this._disposeObjects(f,m,j);
}});
})();
(function(){var d="qx.fx.effect.core.Parallel",c="__qH";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(g){arguments.callee.base.call(this);
this.__qH=arguments;
},members:{__qH:null,finish:function(){arguments.callee.base.call(this);
var b=this.__qH;

for(var i=0;i<b.length;i++){b[i].render(1.0);
b[i].cancel();
b[i].beforeFinishInternal();
b[i].beforeFinish();
b[i].finish(1.0);
b[i].afterFinishInternal();
b[i].afterFinish();
...
(function(){var p="sinodial",o="none",n="overflow",m="flicker",l="center",k="pulse",j="spring",i="full",h="wobble",g="easeOutQuad",M="easeInQuad",L="reverse",K="linear",J="scroll",I="__qJ",H="Boolean",G="px",F='bottom-left',E='top-left',D='bottom-right',w="bottom-right",x="opacity",u="bottom-left",v="visible",s="qx.fx.effect.combination.Shrink",t="__qK",q="top-left",r="__qI",y="top-right",z='top-right',B='center',A="hidden",C="display";
qx.Class.define(s,{extend:qx.fx.Base,construct:function(N){arguments.callee.base.call(this,N);
this.__qI=new qx.fx.effect.core.Move(N);
this.__qJ=new qx.fx.effect.core.Scale(N);
this.__qK=new qx.fx.effect.core.Parallel(this.__qI,this.__qJ);
},properties:{direction:{init:l,check:[q,y,u,w,l]},moveTransition:{init:p,check:[K,M,g,p,L,m,h,k,j,o,i]},scaleTransition:{init:p,check:[K,M,g,p,L,m,h,k,j,o,i]},modifyDisplay:{init:true,check:H}},members:{__qL:null,__qI:null,__qJ:null,__qK:null,setup:function(){arguments.callee.base.call(this);
qx.bom.element.Style.set(this._getElement(),n,A);
},afterFinishInternal:function(){arguments.callee.base.call(this);
var f=this._getElement();
qx.bom.element.Style.set(f,n,v);
var e;

for(var d in this.__qL){e=this.__qL[d];

if(d!=n){e+=G;
}qx.bom.element.Style.set(f,d,e);
}
if(this.getModifyDisplay()){qx.bom.element.Style.set(f,C,o);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var c=this._getElement();
var a,b;
this.__qL={top:qx.bom.element.Location.getTop(c,J),left:qx.bom.element.Location.getLeft(c,J),width:qx.bom.element.Dimension.getContentWidth(c),height:qx.bom.element.Dimension.getContentHeight(c),opacity:qx.bom.element.Style.get(c,x)};

switch(this.getDirection()){case E:a=b=0;
break;
case z:a=this.__qL.width;
b=0;
break;
case F:a=0;
b=this.__qL.height;
break;
case D:a=this.__qL.width;
b=this.__qL.height;
break;
case B:a=this.__qL.width/2;
b=this.__qL.height/2;
break;
}this.__qI.set({x:a,y:b,sync:true,transition:this.getMoveTransition()});
this.__qJ.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__qK.start();
}},destruct:function(){this._disposeObjects(r,I,t);
}});
})();
(function(){var k="sinodial",j="px",i="flicker",h="0px",g="center",f="pulse",e="spring",d="full",c="wobble",b="easeOutQuad",K="easeInQuad",J="reverse",I="none",H="overflow",G="linear",F="height",E='bottom-left',D='top-left',C='bottom-right',B="bottom-right",r="qx.fx.effect.combination.Grow",s="bottom-left",p="visible",q="__qN",n="width",o="top-left",l="top",m="top-right",t='top-right',u="block",w='center',v="hidden",y="left",x="__qM",A="__qO",z="display";
qx.Class.define(r,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
this.__qM=new qx.fx.effect.core.Move(a);
this.__qN=new qx.fx.effect.core.Scale(a);
this.__qO=new qx.fx.effect.core.Parallel(this.__qM,this.__qN);
},properties:{direction:{init:g,check:[o,m,s,B,g]},scaleTransition:{init:k,check:[G,K,b,k,J,i,c,f,e,I,d]},moveTransition:{init:k,check:[G,K,b,k,J,i,c,f,e,I,d]}},members:{__qN:null,__qM:null,__qO:null,setup:function(){arguments.callee.base.call(this);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var O=this._getElement();
qx.bom.element.Style.set(O,z,u);
qx.bom.element.Style.set(O,H,v);
var M,L;
var P,Q;
...
this.__qN.afterFinishInternal=function(){var S;
...
switch(this.getDirection()){case D:M=L=P=Q=0;
break;
case t:M=N.width;
L=Q=0;
P=-N.width;
...
Q=-N.height;
break;
case w:M=Math.round(N.width/2);
L=Math.round(N.height/2);
P=-Math.round(N.width/2);
Q=-Math.round(N.height/2);
break;
}this.__qM.set({x:P,y:Q,sync:true,transition:this.getMoveTransition()});
this.__qN.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[N.width,N.height]});
qx.bom.element.Style.set(O,l,(N.top+L)+j);
qx.bom.element.Style.set(O,y,(N.left+M)+j);
qx.bom.element.Style.set(O,F,h);
qx.bom.element.Style.set(O,n,h);
this.__qO.start();
}},destruct:function(){this._disposeObjects(x,q,A);
}});
})();
(function(){var u="out",t="px",s="south",r="Number",q="north-west",p="west",o="in",n="north",m="south-east",l="south-west",e="east",k="north-east",h="display",c="__qP",b="__qR",g="top",f="Boolean",i="block",a="left",j="__qQ",d="qx.fx.effect.combination.Drop";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(v){arguments.callee.base.call(this,v);
this.__qP=new qx.fx.effect.core.Move(v);
this.__qQ=new qx.fx.effect.core.Fade(v);
this.__qR=new qx.fx.effect.core.Parallel(this.__qP,this.__qQ);
},properties:{direction:{init:s,check:[s,p,e,n,l,m,k,q]},xAmount:{init:100,check:r},yAmount:{init:100,check:r},mode:{init:u,check:[o,u]},modifyDisplay:{init:true,check:f}},members:{__qQ:null,__qP:null,__qR:null,start:function(){arguments.callee.base.call(this);
var A=this._getElement();
qx.bom.element.Style.set(A,h,i);
...
if(this.getMode()==o){qx.bom.element.Style.set(A,g,(z.top-w.y)+t);
qx.bom.element.Style.set(A,a,(z.left-w.x)+t);
}this.__qP.set(w);
this.__qQ.afterFinishInternal=function(){for(var B in z){qx.bom.element.Style.set(A,B,z[B]+t);
}};
this.__qQ.set({duration:0.5,sync:true,from:(this.getMode()==u)?1:0,to:(this.getMode()==u)?0:1,modifyDisplay:true});
this.__qR.start();
}},destruct:function(){this._disposeObjects(c,j,b);
}});
})();
(function(){var r="display",q="in",p="overflow",o="block",n="none",m="visible",l="0px",k="hidden",j="visiblity",i="__qT",d="Boolean",h="height",g="width",c="px",b="qx.fx.effect.combination.Fold",f="__qS",e="out";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(s){arguments.callee.base.call(this,s);
},properties:{modifyDisplay:{init:true,check:d},mode:{init:q,check:[q,e]}},members:{__qS:null,__qT:null,__qU:null,afterFinish:function(){var z=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==q)){qx.bom.element.Style.set(z,r,o);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var a=this._getElement();
var self=this;
this.__qS=new qx.fx.effect.core.Scale(a);
this.__qT=new qx.fx.effect.core.Scale(a);
this.__qS.afterFinishInternal=function(){self.__qT.start();
};
this.__qT.afterFinishInternal=function(){self._cleanUp();
};
this.__qU=this._getStyle();
qx.bom.element.Style.set(a,p,k);

if(this.getMode()==q){this.__qS.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__qT.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__qS.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__qU.width,this.__qU.height]});
this.__qT.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__qU.width,this.__qU.height]});
...
for(var t in this.__qU){u=this.__qU[t];
...
(function(){var p="off",o="overflow",n="__qW",m="Boolean",l="qx.fx.effect.combination.Switch",k="none",j="flicker",i="__qV",h="hidden",g="display";
qx.Class.define(l,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
this.setTransition(j);
var b=this.__qV=new qx.fx.effect.core.Scale(a);
this.__qV.beforeSetup=function(){qx.bom.element.Style.set(a,o,h);
};
this.__qW=new qx.fx.effect.core.Fade(a);
this.__qW.afterFinishInternal=function(){b.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:m},mode:{init:p,check:[p]}},members:{__qV:null,__qW:null,setup:function(){arguments.callee.base.call(this);
var f=this._getElement();
var e=qx.bom.element.Style.get(f,o);
this.__qV.afterFinishInternal=function(){qx.bom.element.Style.set(f,o,e);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==p)){qx.bom.element.Style.set(this._getElement(),g,k);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}
if(this.getMode()==p){this.__qV.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__qW.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__qW.start();
},_applyDuration:function(c,d){this.__qV.setDuration(c/2);
this.__qW.setDuration(c/2);
}},destruct:function(){this._disposeObjects(n,i);
}});
})();
