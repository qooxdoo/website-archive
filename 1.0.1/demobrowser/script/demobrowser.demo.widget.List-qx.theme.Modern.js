...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.List-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a10e5985e9fc"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var cl="value",ck="multi",cj="one",ci="bold",ch="changeSelection",cg="additive",cf="single",ce="changeValue",cd="Item No ",cc="Julian",bQ="Show Icon",bP="Kevin",bO="Marvin",bN="Marc",bM="Configurable",bL="icon/16/places/folder.png",bK="computer.png",bJ="Jason",bI="Jakob",bH="Lukas",cs="Julius",ct="network-wired.png",cq="Jan",cr="Tobias",co="Mika",cp="Nils",cm="Noah",cn="Tom",cu="Nico",cv="Multi Selection",bU="battery.png",bT="Felix",bW="Leon",bV="input-keyboard.png",bY="camera-web.png",bX="Enable drag selection",cb="icon",ca="Show Both",bS="48",bR="icon/48/devices/",E="Fabian",F="multimedia-player.png",G="camera-photo.png",H="media-flash.png",I="input-mouse.png",J="Joel",K="Dominic",L="Show Label",M="demobrowser.demo.widget.List",N="Enable quick selection",cz="Finn",cy="One as selection mode",cx="Jannis",cw="audio-card.png",cD="Alexander",cC="Additive Selection",cB="display.png",cA="Erik",cF="addaptive",cE="Johannes",bn="pda.png",bo="16",bl="Jonas",bm="icon/",br="David",bs="Maximilian",bp="Tim",bq="Justin",bj="Single Selection",bk="Linus",V="Daniel",U="Paul",X="Philipp",W="Niclas",R="One Selection",Q="Nick",T="Jonathan",S="Ben",P="on",O="Vincent",bx="/places/folder.png",by="Robin",bz="both",bA="Jannick",bt="Luis",bu="drive-harddisk.png",bv="Lennard",bw="Moritz",bB="Florian",bC="drive-optical.png",bg="media-optical.png",bf="Marlon",be="Luca",bd="network-wireless.png",bc="audio-input-microphone.png",bb="phone.png",ba="Simon",Y="Colin",bi="label",bh="printer.png",bD="Max",bE="Additive selection",bF="Horizontal, Icons only",bG="Elias";
...
var n=new qx.ui.basic.Label(bM);
n.setFont(ci);
t.add(n,{left:20,top:20});
var v=new qx.ui.form.List;
v.setScrollbarX(P);
v.set({height:280,width:150,selectionMode:ck});
var w;

for(var i=1;i<=25;i++){w=new qx.ui.form.ListItem(cd+i,bm+((i%4)?bo:bS)+bx);
v.add(w);
!(i%9)&&(w.setEnabled(false));
if(i==20){v.setSelection([w]);
}}v.addListener(ch,function(e){var D=e.getData();

if(D[0]){this.debug("Value: "+D[0].getLabel());
}});
t.add(v,{left:20,top:40});
var j=new qx.ui.form.RadioButton(bj);
var f=new qx.ui.form.RadioButton(cv);
var g=new qx.ui.form.RadioButton(cC);
var d=new qx.ui.form.RadioButton(R);
j.setUserData(cl,cf);
f.setUserData(cl,ck);
g.setUserData(cl,cg);
d.setUserData(cl,cj);
...
var z=new qx.ui.form.RadioButton(L);
var y=new qx.ui.form.RadioButton(bQ);
var B=new qx.ui.form.RadioButton(ca);
z.setUserData(cl,bi);
y.setUserData(cl,cb);
B.setUserData(cl,bz);
B.setValue(true);
...
u.addListener(ch,function(e){for(var i=0;i<v.getChildren().length;i++){v.getChildren()[i].setShow(e.getData()[0].getUserData(cl));
}});
var r=new qx.ui.form.CheckBox(bX);
var o=new qx.ui.form.CheckBox(N).set({enabled:false});
t.add(r,{left:180,top:220});
t.add(o,{left:180,top:240});
r.addListener(ce,function(e){if(e.getData()){var a=v.getSelectionMode();

if(a==cf||a==cj){this.debug("Drag selection is only available for the modes multi or additive");
}}v.setDragSelection(e.getData());
});
o.addListener(ce,function(e){if(e.getData()){var C=v.getSelectionMode();

if(C==ck||C==cg){this.debug("Quick selection is only available for the modes multi or additive");
}}v.setQuickSelection(e.getData());
});
h.addListener(ch,function(e){var cG=e.getData()[0].getUserData(cl);
v.setSelectionMode(cG);

if(cG==cf||cG==cj){r.setEnabled(false);
o.setEnabled(true);
}else if(cG==ck||cG==cF){r.setEnabled(true);
o.setEnabled(false);
}});
var A=new qx.ui.basic.Label(cy);
A.setFont(ci);
t.add(A,{left:330,top:20});
var m=new qx.ui.form.List();
m.set({height:280,width:150,selectionMode:cj});
var w;

for(var i=1;i<=25;i++){w=new qx.ui.form.ListItem(cd+i,bL);
m.add(w);
...
var k;
c.set({width:150,selectionMode:cg});
var q=[bW,bH,be,cz,bp,bT,bl,bt,bs,cc,bD,U,W,cq,S,bG,bA,X,cm,cn,bw,cu,br,cp,ba,E,cA,bq,cD,bI,bB,Q,bk,co,bJ,V,bv,bO,cx,cr,K,bf,bN,cE,T,cs,Y,J,bP,O,by];
...
var n=new qx.ui.basic.Label(bF);
n.setFont(ci);
t.add(n,{left:20,top:350});
var x=new qx.ui.form.List(true);
var l;
x.set({width:550,selectionMode:ck,height:null});
var p=[cw,bc,bU,G,bY,bK,cB,bu,bC,bV,I,H,bg,F,ct,bd,bn,bb,bh];
var s=bR;
