...
(function(){var F="execute",E="- Use the cursors keys to move the selection.",D="- Double-click or enter/space-key will fire an execute event.",C="bold",B="- Page-keys / shift + page-keys switch months/years.",A="changeDate",z="select a date",y="Show January 1981",x="Set current date",w="Execute: ",r="Change: ",v="center",u="en",q="demobrowser.demo.widget.DateChooser",p="Remove the selection",t="Description",s="- Escape will remove the selection.";
...
j.add(k);
d.addListener(A,function(e){k.setValue(r+e.getData());
},this);
d.addListener(F,function(e){var o=d.getValue();
k.setValue(w+o);
},this);
var f=new qx.ui.form.Button(x);
f.setAlignX(v);
b.add(f);
f.addListener(F,function(e){d.setValue(new Date());
});
var i=new qx.ui.form.Button(y);
b.add(i);
i.addListener(F,function(e){d.showMonth(0,1981);
});
var c=new qx.ui.form.Button(p);
b.add(c);
c.addListener(F,function(e){d.setValue(null);
});
var a=new qx.ui.basic.Label(t);
a.setFont(C);
l.add(a);
l.add(new qx.ui.basic.Label(E));
l.add(new qx.ui.basic.Label(B));
l.add(new qx.ui.basic.Label(D));
l.add(new qx.ui.basic.Label(s));
}}});
})();
