...
(function(){var p="legend",o="frame",n="middle",m="top",l="resize",k="qx.ui.groupbox.GroupBox",j="groupbox",i="_applyLegendPosition";
qx.Class.define(k,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MRemoteLayoutHandling,qx.ui.core.MContentPadding,qx.ui.form.MForm],implement:[qx.ui.form.IForm],construct:function(c,d){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.Canvas);
...
}},properties:{appearance:{refine:true,init:j},legendPosition:{check:[m,n],init:n,apply:i,themeable:true}},members:{_forwardStates:{invalid:true},_createChildControlImpl:function(q){var r;

switch(q){case o:r=new qx.ui.container.Composite();
this._add(r,{left:0,top:6,right:0,bottom:0});
break;
case p:r=new qx.ui.basic.Atom();
r.addListener(l,this._repositionFrame,this);
this._add(r);
break;
}return r||arguments.callee.base.call(this,q);
},_getContentPaddingTarget:function(){return this.getChildControl(o);
},_applyLegendPosition:function(e){if(this.getChildControl(p).getBounds()){this._repositionFrame();
}},_repositionFrame:function(){var g=this.getChildControl(p);
var f=this.getChildControl(o);
var h=g.getBounds().height;
if(this.getLegendPosition()==n){f.setLayoutProperties({"top":Math.round(h/2)});
}else if(this.getLegendPosition()==m){f.setLayoutProperties({"top":h});
}},getChildrenContainer:function(){return this.getChildControl(o);
},setLegend:function(a){var b=this.getChildControl(p);

if(a!==null){b.setLabel(a);
b.show();
}else{b.exclude();
}},getLegend:function(){return this.getChildControl(p).getLabel();
},setIcon:function(s){this.getChildControl(p).setIcon(s);
},getIcon:function(){this.getChildControl(p).getIcon();
}}});
})();
...
qx.Class.define(c,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IExecutable,qx.ui.form.IBooleanForm],properties:{appearance:{refine:true,init:f}},events:{"changeValue":b,"execute":d},members:{_createChildControlImpl:function(l){var m;
...
(function(){var o="legend",n="changeValue",m="execute",l="resize",k="changeName",j="changeChecked",i="qx.ui.groupbox.RadioGroupBox",h="radio-groupbox",g="qx.event.type.Event",f="qx.event.type.Data";
qx.Class.define(i,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IRadioItem,qx.ui.form.IExecutable,qx.ui.form.IBooleanForm],properties:{appearance:{refine:true,init:h}},events:{"changeValue":f,"execute":g},members:{_createChildControlImpl:function(a){var b;

switch(a){case o:b=new qx.ui.form.RadioButton;
b.setValue(true);
b.addListener(n,this._onRadioChangeValue,this);
b.addListener(l,this._repositionFrame,this);
b.addListener(m,this._onExecute,this);
this._add(b);
}return b||arguments.callee.base.call(this,a);
},_onExecute:function(e){this.fireEvent(m);
},_onRadioChangeValue:function(e){var c=e.getData()?true:false;
this.getChildrenContainer().setEnabled(c);
this.fireDataEvent(j,c);
this.fireDataEvent(n,c,e.getOldData());
},_onRadioChangeName:function(e){this.fireDataEvent(k,e.getData());
},execute:function(){this.getChildControl(o).execute();
},setCommand:function(d){this.getChildControl(o).setCommand(d);
},getCommand:function(){return this.getChildControl(o).getCommand();
},getGroup:function(){return this.getChildControl(o).getGroup();
},setGroup:function(p){if(p!=null){p.add(this);
}return;
},getValue:function(){return this.getChildControl(o).getValue();
},setValue:function(q){this.getChildControl(o).setValue(q);
},resetValue:function(){this.getChildControl(o).resetValue();
},getLabel:function(){return this.getChildControl(o).getLabel();
}}});
})();
