...
(function(){var t="execute",s="Show all numbers.",r="Write data to log",q="Add an item",p="Remove an item",o="Show only even numbers.",n="Odd / Even filter",m="Remove filter",l="<b>Filtered List</b><br/>",k="Reverse order",f="demobrowser.demo.data.ListControllerWithFilter",j="Show only odd numbers.",h="value",e="init",d="delegate",g="List showing numbered items, bound to a data array.";
...
var x={};
x.filter=function(a){return parseInt(a)%2==1;
};
var z={};
...
var H={converter:function(c){if(c==z){return o;
}else if(c==x){return j;
}return s;
}};
B.bind(d,D,h,H);
var A=new qx.ui.form.Button(q);
A.setWidth(120);
this.getRoot().add(A,{left:130,top:80});
A.addListener(t,function(){G.push(G.length);
},this);
var F=new qx.ui.form.Button(p);
F.setWidth(120);
this.getRoot().add(F,{left:130,top:115});
F.addListener(t,function(){G.pop();
},this);
var C=new qx.ui.form.Button(r);
C.setWidth(120);
this.getRoot().add(C,{left:130,top:150});
C.addListener(t,function(){qx.log.appender.Console.show();
this.info(G.toString());
},this);
var v=new qx.ui.form.Button(n);
v.setWidth(120);
this.getRoot().add(v,{left:130,top:185});
v.addListener(t,function(){B.getDelegate()==x?B.setDelegate(z):B.setDelegate(x);
},this);
var u=new qx.ui.form.Button(m);
u.setWidth(120);
this.getRoot().add(u,{left:130,top:220});
u.addListener(t,function(){B.setDelegate(null);
},this);
var I=new qx.ui.form.Button(k);
I.setWidth(120);
this.getRoot().add(I,{left:130,top:255});
I.addListener(t,function(){G.reverse();
},this);
