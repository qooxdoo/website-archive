...
(function(){var w="changeValue",v="I am a box",u=" invalidate all shown widgets. Try the invalid focus and tooltip.",t="disable tooltips",s="RadioGroup 2",r=")",q="RadioGroup 1",p="Invalid (",o="demobrowser.demo.ui.FormInvalids",n="disabled",k="<b>Validation</b><br/>Press the button to",m="Item ",l="invalid";
qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var j=[];
j.push(new qx.ui.form.Spinner());
this.getRoot().add(j[0],{left:20,top:70});
j.push(new qx.ui.form.Slider());
j[1].setWidth(200);
this.getRoot().add(j[1],{left:20,top:100});
j.push(new qx.ui.form.TextField());
this.getRoot().add(j[2],{left:20,top:130});
j.push(new qx.ui.form.TextArea());
this.getRoot().add(j[3],{left:20,top:160});
j.push(new qx.ui.form.PasswordField());
this.getRoot().add(j[4],{left:20,top:240});
j.push(new qx.ui.form.ComboBox());
this.getRoot().add(j[5],{left:20,top:270});
j.push(new qx.ui.form.SelectBox());
this.getRoot().add(j[6],{left:20,top:300});
j.push(new qx.ui.form.CheckBox());
this.getRoot().add(j[7],{left:20,top:330});
j.push(new qx.ui.form.RadioButton());
this.getRoot().add(j[8],{left:20,top:350});
j.push(new qx.ui.groupbox.GroupBox(v));
this.getRoot().add(j[9],{left:240,top:70});
j.push(new qx.ui.groupbox.RadioGroupBox(v));
this.getRoot().add(j[10],{left:240,top:170});
j.push(new qx.ui.groupbox.CheckGroupBox(v));
this.getRoot().add(j[11],{left:240,top:270});
j.push(new qx.ui.form.List());
this.getRoot().add(j[12],{left:390,top:70});

for(var i=0;i<10;i++){j[12].add(new qx.ui.form.ListItem(m+(i+1)));
}j.push(new qx.ui.form.DateField());
this.getRoot().add(j[13],{left:390,top:280});
j.push(new qx.ui.control.DateChooser());
this.getRoot().add(j[14],{left:520,top:70});
var f=new qx.ui.form.RadioGroup();
var a=new qx.ui.form.RadioButton(q);
f.add(a);
this.getRoot().add(a,{left:530,top:250});
var b=new qx.ui.form.RadioButton(s);
f.add(b);
this.getRoot().add(b,{left:530,top:270});
j.push(f);
var d=new qx.ui.form.ToggleButton(l);
this.getRoot().add(d,{left:260,top:20});
d.addListener(w,function(e){for(var i=0;i<j.length;i++){j[i].setInvalidMessage(p+i+r);
j[i].setValid(!e.getData());
}},this);
var g=new qx.ui.form.ToggleButton(n);
this.getRoot().add(g,{left:330,top:20});
g.addListener(w,function(e){for(var i=0;i<j.length;i++){j[i].setEnabled(!e.getData());
}},this);
var c=new qx.ui.form.ToggleButton(t);
this.getRoot().add(c,{left:410,top:20});
c.addListener(w,function(e){qx.ui.tooltip.Manager.getInstance().setShowInvalidTooltips(!e.getData());
},this);
