...
(function(){var B="execute",A="Name",z="demobrowser.demo.ui.FormRendererCustom",y="Registration",x="demobrowser.demo.ui.CustomRenderer",w="Bio",v="Send",u="Contact",t="Country",s="Personal Information",p="Password",r="Email",q="Phone",o="right",n="Reset";
...
b.add(f,p);
b.addGroupHeader(u);
b.add(new qx.ui.form.TextField(),r,qx.util.Validate.email());
b.add(new qx.ui.form.TextField(),q);
b.addGroupHeader(s);
b.add(new qx.ui.form.TextField(),t);
b.add(new qx.ui.form.TextArea(),w);
var d=new qx.ui.form.Button(v);
d.addListener(B,function(){if(b.validate()){alert("send...");
}},this);
b.addButton(d);
var c=new qx.ui.form.Button(n);
c.addListener(B,function(){b.reset();
},this);
b.addButton(c);
var e=new demobrowser.demo.ui.CustomRenderer(b);
this.getRoot().add(e,{left:10,top:10});
}}});
qx.Class.define(x,{extend:qx.ui.form.renderer.Single,members:{__FI:0,__FJ:0,addItems:function(g,h,j){var m=0;
if(j!=null){this._add(this._createHeader(j),{row:m,column:this.__FI,colSpan:2});
m++;
}for(var i=0;i<g.length;i++){var l=this._createLabel(h[i],g[i]);
this._add(l,{row:m,column:this.__FI});
var k=g[i];
l.setBuddy(k);

if(k instanceof qx.ui.form.RadioGroup){k=this._createWidgetForRadioGroup(k);
}this._add(k,{row:m,column:this.__FI+1});
m++;
}this.__FI+=2;
this.__FJ<m?this.__FJ=m:null;
...
this._add(this._buttonRow,{row:this.__FJ,column:0,colSpan:this.__FI});
