...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Decorator_Box-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"792d8ed349e7"},
  boot : "boot",
  bootIsInline : true,
...
e.open();
var g=new qx.ui.decoration.HBox(d);
var f=new qx.ui.core.Widget().set({decorator:g,height:12});
e.add(f,{left:20,top:0,right:0});
var g=new qx.ui.decoration.VBox(c);
var f=new qx.ui.core.Widget().set({decorator:g,width:12});
e.add(f,{left:0,top:20,bottom:0});
}}});
})();
...
(function(){var E="px",D="no-repeat",C="0",B="-1px",A="-c",z="mshtml",y="horizontal",x="",w="qx.ui.decoration.AbstractBox",v="-l",o='<div style="position:absolute;top:0;left:0;overflow:hidden;font-size:0;line-height:0;">',u='</div>',r="_applyBaseImage",m="-b",l="-t",q="repeat-x",p="repeat-y",s="abstract",k="-r",t="String",n="qx.client";
qx.Class.define(w,{extend:qx.ui.decoration.Abstract,type:s,construct:function(H,I){arguments.callee.base.call(this);
if(H!=null){this.setBaseImage(H);
}
if(I!=null){this.setInsets(I);
}},properties:{baseImage:{check:t,nullable:true,apply:r}},members:{__zn:null,__zo:null,__zp:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__zn;
},_setOrientation:function(a){this._isHorizontal=a==y;
},getMarkup:function(){if(this.__zn){return this.__zn;
...
if(this._isHorizontal){M.push(J.create(K.l,D,{top:0,left:0}));
M.push(J.create(K.c,q,{top:0,left:L.left+E}));
M.push(J.create(K.r,D,{top:0,right:0}));
}else{M.push(J.create(K.t,D,{top:0,left:0}));
M.push(J.create(K.c,p,{top:L.top+E,left:L.left+E}));
M.push(J.create(K.b,D,{bottom:0,left:0}));
}M.push(u);
return this.__zn=M.join(x);
},resize:function(N,O,P){N.style.width=O+E;
N.style.height=P+E;
var Q=this.__zp;

if(this._isHorizontal){var innerWidth=O-Q.left-Q.right;
N.childNodes[1].style.width=innerWidth+E;
}else{var innerHeight=P-Q.top-Q.bottom;
N.childNodes[1].style.height=innerHeight+E;
}
if(qx.core.Variant.isSet(n,z)){if(qx.bom.client.Engine.VERSION<7||(qx.bom.client.Feature.QUIRKS_MODE&&qx.bom.client.Engine.VERSION<8)){if(this._isHorizontal){N.childNodes[2].style.marginRight=(O%2==1)?B:C;
}else{N.childNodes[2].style.marginBottom=(P%2==1)?B:C;
}}}},tint:function(F,G){},_applyBaseImage:function(b,c){{};
...
var g=i[1];
var e=i[2];
var j=this.__zo={t:g+l+e,b:g+m+e,c:g+A+e,l:g+v+e,r:g+k+e};
this.__zp={top:d.getImageHeight(j.t),bottom:d.getImageHeight(j.b),left:d.getImageWidth(j.l),right:d.getImageWidth(j.r)};
}}},destruct:function(){this.__zn=this.__zo=this.__zp=null;
}});
})();
