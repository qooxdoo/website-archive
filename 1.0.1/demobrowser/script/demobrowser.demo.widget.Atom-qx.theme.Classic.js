...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.Atom-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"c2b9da127403"},
  boot : "boot",
  bootIsInline : true,
