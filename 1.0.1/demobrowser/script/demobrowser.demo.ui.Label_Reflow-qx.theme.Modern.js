...
(function(){var y="main",x="qooxdoo is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed.",w="click",v="#CCC",u="<b>qooxdoo is cool.</b>",t="qooxdoo (pronounced [’ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",s="#FFF",r="It includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",q="demobrowser.demo.ui.Label_Reflow",p="Toggle first paragraph",n="Resize Pane",o="#EEE";
...
f.setRowFlex(0,1);
f.setSpacing(10);
var g=new qx.ui.container.Composite(f).set({backgroundColor:o,decorator:y,padding:10,allowGrowX:false,allowGrowY:false,allowStretchX:false,allowStretchY:false});
h.add(g);
this.getRoot().add(h,{edge:0});
var l=this.getPane();
g.add(l,{row:0,column:0,colSpan:3});
var j=new qx.ui.basic.Label(p).set({backgroundColor:v,decorator:y,padding:[4,8]});
g.add(j,{row:1,column:1});
var i=false;
j.addListener(w,function(){var z=l.getChildren()[0];
z.setValue(i?x:u);
i=!i;
});
var k=new qx.ui.basic.Label(n).set({backgroundColor:v,decorator:y,padding:[4,8]});
g.add(k,{row:1,column:2});
var m=false;
k.addListener(w,function(e){if(m){l.setWidth(600);
}else{l.setWidth(300);
}m=!m;
});
},getPane:function(){var d=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:s,width:600,decorator:y,padding:10});
var a=new qx.ui.basic.Label().set({rich:true,value:x});
d.add(a);
var b=new qx.ui.basic.Label().set({rich:true,value:r});
d.add(b);
var c=new qx.ui.basic.Label().set({rich:true,value:t});
d.add(c);
return d;
}}});
})();
