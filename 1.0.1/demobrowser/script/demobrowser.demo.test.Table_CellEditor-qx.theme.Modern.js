...
(function(){var o="",n="cat",m="Juhu",l="mouse",k="dog",j="execute",i="rat",h="demobrowser.demo.test.Table_CellEditor",g="Add/Remove editor",f="Get value",d="_container",e="boolean";
...
},_addEditor:function(C,D){D=qx.lang.Object.clone(D);
var E=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var I=C.createCellEditor(D);
var J=new qx.ui.container.Composite().set({width:200,height:20});
I.setUserBounds(0,0,200,20);
J.add(I);
E.add(J);
var G=new qx.ui.form.Button(f);
E.add(G);
G.addListener(j,function(){H.setValue(C.getCellEditorValue(I)+o);
});
var F=new qx.ui.form.Button(g);
E.add(F);
F.addListener(j,function(){I.destroy();
qx.ui.core.queue.Manager.flush();
I=C.createCellEditor(D);
I.setUserBounds(0,0,200,20);
J.add(I);
qx.ui.core.queue.Manager.flush();
});
var H=new qx.ui.basic.Label(o);
E.add(H);
this._container.add(E);
G.execute();
},testCheckBoxEditor:function(){var b={value:[true,false]};
qx.util.Permutation.permute(b,function(B){this._addEditor(new qx.ui.table.celleditor.CheckBox(),B);
},this);
},testComboBoxEditor:function(){var x={value:[o,n,i,2],table:[this.getTableMock()]};
var y=new qx.ui.table.celleditor.ComboBox();
y.setListData([k,n,l]);
qx.util.Permutation.permute(x,function(A){this._addEditor(y,A);
},this);
},testSelectBoxEditor:function(){var r={value:[o,n],table:[this.getTableMock()]};
var s=new qx.ui.table.celleditor.SelectBox();
s.setListData([k,n,l]);
qx.util.Permutation.permute(r,function(p){this._addEditor(s,p);
},this);
},testPasswordEditor:function(){var c={value:[null,10,m]};
qx.util.Permutation.permute(c,function(z){this._addEditor(new qx.ui.table.celleditor.PasswordField(),z);
},this);
},testTextfieldEditor:function(){var q={value:[null,10,m]};
qx.util.Permutation.permute(q,function(a){this._addEditor(new qx.ui.table.celleditor.TextField(),a);
},this);
},testTextfieldEditorDynamic:function(){var v={value:[true,m]};
var w=new qx.ui.table.celleditor.Dynamic();
w.setCellEditorFactoryFunction(function(t){if(typeof t.value==e){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(v,function(u){this._addEditor(w,u);
},this);
...
(function(){var l="keypress",k="Enter",j="qx.ui.table.celleditor.CheckBox",i="focus",h="center",g="keydown",f="middle",d="activate";
qx.Class.define(j,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,construct:function(){arguments.callee.base.call(this);
},members:{createCellEditor:function(a){var c=new qx.ui.container.Composite(new qx.ui.layout.HBox().set({alignX:h,alignY:f})).set({focusable:true});
var b=new qx.ui.form.CheckBox().set({value:a.value});
c.add(b);
c.addListener(i,function(){b.focus();
});
c.addListener(d,function(){b.activate();
});
b.addListener(g,function(e){if(e.getKeyIdentifier()==k){var m=qx.event.Pool.getInstance().getObject(qx.event.type.KeySequence);
...
(function(){var e="Function",d="qx.ui.table.celleditor.Dynamic";
qx.Class.define(d,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,construct:function(f){arguments.callee.base.call(this);

if(f){this.setCellEditorFactoryFunction(f);
}},properties:{cellEditorFactoryFunction:{check:e,nullable:true,init:null}},members:{__zI:null,createCellEditor:function(g){var h=this.getCellEditorFactoryFunction();
{};
this.__zI=h(g);
var i=this.__zI.createCellEditor(g);
return i;
},getCellEditorValue:function(a){var b=this.getCellEditorFactoryFunction();
{};
var c=this.__zI.getCellEditorValue(a);
return c;
