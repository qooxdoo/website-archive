...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Flex-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"af809efb4931"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var j="main",h="green",g="yellow",f="demobrowser.demo.layout.HBox_Flex";
...
var q=new qx.ui.container.Composite(p).set({width:500,decorator:j,backgroundColor:g,allowGrowX:false});
p.setSpacing(5);
q.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h}),{flex:1});
q.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h}),{flex:2});
q.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h}),{flex:3});
return q;
},getBox2:function(){var n=new qx.ui.layout.HBox();
var o=new qx.ui.container.Composite(n).set({width:500,decorator:j,backgroundColor:g,allowGrowX:false});
n.setSpacing(5);
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,maxWidth:30}),{flex:1});
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h}),{flex:2});
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,maxWidth:150}),{flex:3});
return o;
},getBox3:function(){var a=new qx.ui.layout.HBox();
var c=new qx.ui.container.Composite(a).set({width:500,decorator:j,backgroundColor:g,allowGrowX:false});
a.setSpacing(5);

for(var i=0;i<25;i++){var b=new qx.ui.core.Widget();
b.set({decorator:j,backgroundColor:h,width:5});
c.add(b,{flex:1});
}return c;
},getBox4:function(){var l=new qx.ui.layout.HBox();
var m=new qx.ui.container.Composite(l).set({width:600,minWidth:600,decorator:j,backgroundColor:g,allowGrowX:false});
l.setSpacing(5);
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,maxWidth:120}),{flex:1});
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,maxWidth:120}),{flex:2});
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,maxWidth:120}),{flex:3});
return m;
},getBox5:function(){var r=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(r).set({width:300,minWidth:0,decorator:j,backgroundColor:g,allowGrowX:false});
r.setSpacing(5);
s.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,minWidth:120}),{flex:1});
s.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,minWidth:120}),{flex:2});
s.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,minWidth:120}),{flex:3});
return s;
},getBox6:function(){var d=new qx.ui.layout.HBox();
var e=new qx.ui.container.Composite(d).set({width:300,decorator:j,backgroundColor:g,allowGrowX:false});
d.setSpacing(5);
e.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,minWidth:120}),{flex:1});
e.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,minWidth:120}),{flex:2});
e.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:h,minWidth:120}),{flex:3});
return e;
}}});
})();
