...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Inline-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"6e1fcf4a5530"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(k,{extend:qx.application.Inline,members:{main:function(){arguments.callee.base.call(this);
