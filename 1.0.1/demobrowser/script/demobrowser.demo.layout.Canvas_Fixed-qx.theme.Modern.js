...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Canvas_Fixed-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"5768e2686727"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var q="black",p="teal",o="red",n="demobrowser.demo.layout.Canvas_Fixed",m="green",l="yellow",k="orange",j="solid",i="blue";
qx.Class.define(n,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var h=new qx.ui.decoration.Single(3,j,q);
var g=new qx.ui.core.Widget().set({backgroundColor:o,decorator:h});
var f=new qx.ui.core.Widget().set({backgroundColor:i,decorator:h});
var e=new qx.ui.core.Widget().set({backgroundColor:m,decorator:h});
var d=new qx.ui.core.Widget().set({backgroundColor:l,decorator:h});
var c=new qx.ui.core.Widget().set({backgroundColor:k,decorator:h});
var b=new qx.ui.core.Widget().set({backgroundColor:p,decorator:h});
var a=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
a.setPadding(10);
a.add(g,{left:10,top:10,right:10,bottom:10});
a.add(f,{left:30,top:30,right:30});
a.add(e,{left:50,top:50,bottom:50});
a.add(d,{left:70,top:70});
a.add(c,{top:50,right:50});
a.add(b,{right:50,bottom:50});
