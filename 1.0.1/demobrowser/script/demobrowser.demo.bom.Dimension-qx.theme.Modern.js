...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Dimension-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d9290427120c"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var h="x",g="Block ",f="demobrowser.demo.bom.Dimension",e="block",d=": Box=",c="; Content=";
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);

for(var i=1;i<1000;i++){var j=document.getElementById(e+i);

if(!j){break;
}var m=g+i+d+k(j)+c+l(j);
this.debug(m);
}function k(n){var o=qx.bom.element.Dimension;
return o.getWidth(n)+h+o.getHeight(n);
}function l(a){var b=qx.bom.element.Dimension;
return b.getContentWidth(a)+h+b.getContentHeight(a);
}}}});
})();
