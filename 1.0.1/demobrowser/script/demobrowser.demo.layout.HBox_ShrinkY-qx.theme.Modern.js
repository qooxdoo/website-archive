...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_ShrinkY-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"3084f6cf7564"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var i="main",h="green",g="demobrowser.demo.layout.HBox_ShrinkY",f="yellow";
...
var c=(new qx.ui.container.Composite(a)).set({decorator:i,backgroundColor:f,maxHeight:100});
a.setSpacing(5);
var e=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var d=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var b=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
e.setHeight(200);
d.setHeight(300);
b.setHeight(400);
c.add(e);
