...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Page-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"fc64ddc9d1e9"},
  boot : "boot",
  bootIsInline : true,
