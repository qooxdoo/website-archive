...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"29afc8eb56af"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var i="brown",h="Toggle size",g="white",f="demobrowser.demo.test.ScrollContainer_ResizeMatch",e="execute",d="Content size: 300x300";
...
b.set({width:200,height:200});
this.getRoot().add(b,{left:10,top:10});
b.add(this.generateBox());
var a=new qx.ui.form.Button(h);
var c=true;
a.addListener(e,function(){b.setWidth(c?300:200);
b.setHeight(c?300:200);
c=!c;
});
this.getRoot().add(a,{left:10,top:400});
},generateBox:function(){var j=new qx.ui.basic.Label(d).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:i,textColor:g,padding:10});
return j;
}}});
})();
