...
(function(){var cl="execute",ck="changeValue",cj="icon/16/actions/edit-cut.png",ci="changeSelection",ch="icon/16/actions/edit-paste.png",cg="Copy",cf="Paste",ce="icon/16/actions/edit-copy.png",cd="Cut",cc="icon/16/actions/system-search.png",bF="New",bE="Undo",bD="icon/16/actions/document-save.png",bC="Redo",bB="icon/22/apps/preferences-users.png",bA="icon/16/actions/document-print.png",bz="icon/16/actions/document-open.png",by="icon/16/actions/edit-undo.png",bx="Save",bw="icon/16/actions/edit-redo.png",cs="Print",ct="Open",cq="icon/16/actions/document-new.png",cr="Online Forum",co="icon/16/actions/format-justify-fill.png",cp="Search in files",cm="C",cn="Left aligned",cu="Perl",cv="View",bU="C Dialect",bT="Info...",bW="Save as...",bV="Show line numbers",bY="Quickstart",bX="icon/16/actions/contact-new.png",cb="Actions",ca="__CL",bS="Show console",bR="Search",n="Help",o="Show status bar",p="icon/16/actions/format-justify-left.png",q="ANSI to OEM",r="Centered",s="Website 3",t="__CM",u="Edit",v="icon/16/actions/format-justify-center.png",w="icon/16/actions/go-previous.png",cz="__CO",cy="C Sharp",cx="Close",cw="Website 2",cD="icon/16/actions/document-save-as.png",cC="Python",cB="icon/16/apps/utilities-help.png",cA="Show tree",cF="Options",cE="Spaces to tabs",V="Right aligned",W="Action 1",T="OEM to ANSI",U="Line 431",ba="JavaScript",bb="icon",X="Action 2",Y="Folder ",R="XML",S="__CN",E="Line 313",D="Paragraph",G="demobrowser.demo.widget.Menu",F="icon/16/actions/application-exit.png",A="C Plus Plus",z="Line 26",C="Item ",B="ASCII table",y="__CQ",x="Option 1",bg="Search next...",bh="Line 12",bi="Action 3",bj="Replace in files",bc="Uppercase",bd="Topics",be="Panes",bf="Justified",bk="Show macros",bl="Search previous...",O="__CP",N="Back",M="main",L="icon/16/actions/format-justify-right.png",K="icon/16/actions/go-next.png",J="command ",I="Option 3",H="Next",Q="Show tags",P="Capitals",bm="Format",bn="File",bo="Show tabs",bp="Split Button",bq="Tabs to spaces",br="Search...",bs="Line 1039",bt="Option 2",bu="Objective C",bv="__CR",bJ="Exit",bI="move to",bH="Syntax",bG="__CK",bN="Show ruler",bM="Website 1",bL="Menu Button",bK="Line 30",bP="Lowercase",bO="Replace",bQ="HTML";
qx.Class.define(G,{extend:qx.application.Standalone,members:{__CK:null,__CL:null,__CM:null,__CN:null,__CO:null,__CP:null,__CQ:null,__CR:null,main:function(){arguments.callee.base.call(this);
var eq=new qx.ui.container.Scroll();
var ep=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
ep.setPadding(20);
ep.setAllowStretchX(false);
eq.add(ep);
this.getRoot().add(eq,{edge:0});
this.createCommands();
ep.add(this.getMenuButton(),{left:20,top:20});
ep.add(this.getSplitButton(),{left:150,top:20});
ep.add(this.getMenuBar(),{left:20,top:100});
ep.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var cG=new qx.ui.menu.Menu();
var cH=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){cH.add(new qx.ui.menu.Button(Y+(i+1)));
}cG.add(new qx.ui.menu.Button(bI,null,null,cH));
cG.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cG.add(new qx.ui.menu.Button(J+(i+1)));
}return cG;
...
},createCommands:function(){this.__CK=new qx.ui.core.Command("Ctrl+N");
this.__CK.addListener(cl,this.debugCommand);
this.__CL=new qx.ui.core.Command("Ctrl+O");
this.__CL.addListener(cl,this.debugCommand);
this.__CM=new qx.ui.core.Command("Ctrl+S");
this.__CM.addListener(cl,this.debugCommand);
this.__CN=new qx.ui.core.Command("Ctrl+Z");
this.__CN.addListener(cl,this.debugCommand);
this.__CO=new qx.ui.core.Command("Ctrl+R");
this.__CO.addListener(cl,this.debugCommand);
this.__CP=new qx.ui.core.Command("Ctrl+X");
this.__CP.addListener(cl,this.debugCommand);
this.__CQ=new qx.ui.core.Command("Ctrl+C");
this.__CQ.addListener(cl,this.debugCommand);
this.__CR=new qx.ui.core.Command("Ctrl+P");
this.__CR.addListener(cl,this.debugCommand);
this.__CR.setEnabled(false);
},getMenuButton:function(){var dp=new qx.ui.menu.Menu;
dp.add(new qx.ui.menu.RadioButton(x));
dp.add(new qx.ui.menu.RadioButton(bt));
dp.add(new qx.ui.menu.RadioButton(I));
var dx=new qx.ui.menu.Menu;
dx.add(new qx.ui.menu.RadioButton(W));
dx.add(new qx.ui.menu.RadioButton(X));
dx.add(new qx.ui.menu.RadioButton(bi));
var dw=new qx.ui.form.RadioGroup;
dw.add.apply(dw,dp.getChildren());
dw.addListener(ci,this.debugRadio);
var du=new qx.ui.form.RadioGroup;
du.add.apply(du,dx.getChildren());
du.addListener(ci,this.debugRadio);
var ds=new qx.ui.menu.Menu();
var dv=new qx.ui.menu.Button(bE,by,this.__CN);
var dC=new qx.ui.menu.Button(bC,bw,this.__CO);
var dr=new qx.ui.menu.Button(cd,cj,this.__CP);
var dz=new qx.ui.menu.Button(cg,ce,this.__CQ);
var dt=new qx.ui.menu.Button(cf,ch,this.__CR);
var dq=new qx.ui.menu.Button(cF,cc,null,dp);
var dA=new qx.ui.menu.Button(cb,bX,null,dx);
var dy=new qx.ui.menu.Button(cs,bA);
dv.addListener(cl,this.debugButton);
dC.addListener(cl,this.debugButton);
dr.addListener(cl,this.debugButton);
dz.addListener(cl,this.debugButton);
dt.addListener(cl,this.debugButton);
dq.addListener(cl,this.debugButton);
dA.addListener(cl,this.debugButton);
...
ds.addSeparator();
ds.add(dy);
var dB=new qx.ui.form.MenuButton(bL,bB,ds);
return dB;
},getSplitButton:function(){var ek=new qx.ui.menu.Menu;
var eo=new qx.ui.menu.Button(bM);
var em=new qx.ui.menu.Button(cw);
var en=new qx.ui.menu.Button(s);
ek.setMinWidth(120);
eo.addListener(cl,this.debugButton);
em.addListener(cl,this.debugButton);
en.addListener(cl,this.debugButton);
ek.add(eo);
ek.add(em);
ek.add(en);
var el=new qx.ui.form.SplitButton(bp,bB,ek);
el.addListener(cl,this.debugButton);
return el;
},getMenuBar:function(){var ev=new qx.ui.container.Composite(new qx.ui.layout.Grow);
ev.setDecorator(M);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
ev.add(toolbar);
var eE=new qx.ui.toolbar.Part;
var eu=new qx.ui.toolbar.Part;
var ey=new qx.ui.toolbar.Part;
toolbar.add(eE);
toolbar.add(eu);
toolbar.addSpacer();
toolbar.add(ey);
var eD=new qx.ui.toolbar.SplitButton(N,w,this.getBackMenu());
var eA=new qx.ui.toolbar.SplitButton(H,K,this.getForwardMenu());
var et=new qx.ui.toolbar.Button(bF,cq,this.__CK);
var ex=new qx.ui.toolbar.Button(ct,bz,this.__CL);
var eC=new qx.ui.toolbar.Button(bx,bD,this.__CM);
eD.addListener(cl,this.debugButton);
eA.addListener(cl,this.debugButton);
et.addListener(cl,this.debugButton);
ex.addListener(cl,this.debugButton);
eC.addListener(cl,this.debugButton);
eE.add(eD);
eE.add(eA);
eE.addSeparator();
eE.add(et);
...
eE.add(eC);
eE.setShow(bb);
var ew=new qx.ui.toolbar.MenuButton(bn);
var es=new qx.ui.toolbar.MenuButton(u);
var er=new qx.ui.toolbar.MenuButton(bR);
var eF=new qx.ui.toolbar.MenuButton(cv);
var eB=new qx.ui.toolbar.MenuButton(bm);
ew.setMenu(this.getFileMenu());
es.setMenu(this.getEditMenu());
er.setMenu(this.getSearchMenu());
eF.setMenu(this.getViewMenu());
eB.setMenu(this.getFormatMenu());
eu.add(ew);
eu.add(es);
eu.add(er);
eu.add(eF);
eu.add(eB);
var ez=new qx.ui.toolbar.MenuButton(n);
ez.setMenu(this.getHelpMenu());
ey.add(ez);
return ev;
},getBackMenu:function(){var dO=new qx.ui.menu.Menu;
var dP=new qx.ui.menu.Button(E);
var dR=new qx.ui.menu.Button(bs);
var dN=new qx.ui.menu.Button(bh);
var dQ=new qx.ui.menu.Button(z);
...
var ea=new qx.ui.menu.Button(U);
var eb=new qx.ui.menu.Button(bK);
ea.addListener(cl,this.debugButton);
...
var ec=new qx.ui.menu.Button(bF,cq,this.__CK);
var eg=new qx.ui.menu.Button(ct,bz,this.__CL);
var ef=new qx.ui.menu.Button(cx);
var ej=new qx.ui.menu.Button(bx,bD,this.__CM);
var ei=new qx.ui.menu.Button(bW,cD);
var eh=new qx.ui.menu.Button(cs,bA);
var ed=new qx.ui.menu.Button(bJ,F);
ec.addListener(cl,this.debugButton);
eg.addListener(cl,this.debugButton);
ef.addListener(cl,this.debugButton);
ej.addListener(cl,this.debugButton);
ei.addListener(cl,this.debugButton);
...
ee.add(ed);
return ee;
},getEditMenu:function(){var cJ=new qx.ui.menu.Menu;
var cM=new qx.ui.menu.Button(bE,by,this.__CN);
var cL=new qx.ui.menu.Button(bC,bw,this.__CO);
var cI=new qx.ui.menu.Button(cd,cj,this.__CP);
var cN=new qx.ui.menu.Button(cg,ce,this.__CQ);
var cK=new qx.ui.menu.Button(cf,ch,this.__CR);
cM.addListener(cl,this.debugButton);
cL.addListener(cl,this.debugButton);
cI.addListener(cl,this.debugButton);
cN.addListener(cl,this.debugButton);
cK.addListener(cl,this.debugButton);
cJ.add(cM);
cJ.add(cL);
cJ.addSeparator();
cJ.add(cI);
...
var b=new qx.ui.menu.Button(br,cc);
var h=new qx.ui.menu.Button(bg);
var c=new qx.ui.menu.Button(bl);
var g=new qx.ui.menu.Button(bO);
var a=new qx.ui.menu.Button(cp,cc);
var f=new qx.ui.menu.Button(bj);
c.setEnabled(false);
b.addListener(cl,this.debugButton);
h.addListener(cl,this.debugButton);
c.addListener(cl,this.debugButton);
g.addListener(cl,this.debugButton);
a.addListener(cl,this.debugButton);
...
d.add(f);
return d;
},getViewMenu:function(){var dS=new qx.ui.menu.Menu;
var dU=new qx.ui.menu.Button(be,null,null,this.getPanesMenu());
var dX=new qx.ui.menu.Button(bH,null,null,this.getSyntaxMenu());
var dW=new qx.ui.menu.CheckBox(bN);
var dV=new qx.ui.menu.CheckBox(bV);
var dT=new qx.ui.menu.Button(B);
dW.addListener(ck,this.debugCheckBox);
dV.addListener(ck,this.debugCheckBox);
dT.addListener(cl,this.debugButton);
dS.add(dU);
dS.add(dX);
dS.addSeparator();
...
dS.add(dT);
return dS;
},getPanesMenu:function(){var di=new qx.ui.menu.Menu;
var dk=new qx.ui.menu.CheckBox(bo);
var dm=new qx.ui.menu.CheckBox(o);
var dn=new qx.ui.menu.CheckBox(cA);
var dj=new qx.ui.menu.CheckBox(bk);
var dl=new qx.ui.menu.CheckBox(Q);
var dh=new qx.ui.menu.CheckBox(bS);
dk.setValue(true);
dm.setValue(true);
dj.setValue(true);
dk.addListener(ck,this.debugCheckBox);
dm.addListener(ck,this.debugCheckBox);
dn.addListener(ck,this.debugCheckBox);
dj.addListener(ck,this.debugCheckBox);
dl.addListener(ck,this.debugCheckBox);
dh.addListener(ck,this.debugCheckBox);
di.add(dm);
di.add(dk);
di.addSeparator();
di.add(dn);
...
di.add(dh);
return di;
},getSyntaxMenu:function(){var dc=new qx.ui.menu.Menu;
var cX=new qx.ui.menu.RadioButton(bQ);
var da=new qx.ui.menu.RadioButton(R);
var cY=new qx.ui.menu.RadioButton(ba);
var db=new qx.ui.menu.Button(bU,null,null,this.getSyntaxCMenu());
var df=new qx.ui.menu.RadioButton(cu);
var dd=new qx.ui.menu.RadioButton(cC);
dc.add(cX);
dc.add(da);
dc.add(cY);
dc.add(db);
dc.add(df);
dc.add(dd);
var de=new qx.ui.form.RadioGroup;
de.add(cX,da,cY,df,dd);
de.add.apply(de,db.getMenu().getChildren());
de.addListener(ci,this.debugRadio);
return dc;
},getSyntaxCMenu:function(){var dJ=new qx.ui.menu.Menu;
var dI=new qx.ui.menu.RadioButton(cm);
var dM=new qx.ui.menu.RadioButton(cy);
var dL=new qx.ui.menu.RadioButton(bu);
var dK=new qx.ui.menu.RadioButton(A);
dJ.add(dI);
dJ.add(dM);
dJ.add(dL);
dJ.add(dK);
return dJ;
},getFormatMenu:function(){var cR=new qx.ui.menu.Menu;
var cQ=new qx.ui.menu.Button(D,null,null,this.getParagraphMenu());
var cT=new qx.ui.menu.Button(bq);
var cU=new qx.ui.menu.Button(cE);
var cP=new qx.ui.menu.Button(bc);
var cS=new qx.ui.menu.Button(bP);
var cO=new qx.ui.menu.Button(P);
var cW=new qx.ui.menu.Button(T);
var cV=new qx.ui.menu.Button(q);
cT.addListener(cl,this.debugButton);
cU.addListener(cl,this.debugButton);
cP.addListener(cl,this.debugButton);
cS.addListener(cl,this.debugButton);
cO.addListener(cl,this.debugButton);
cW.addListener(cl,this.debugButton);
cV.addListener(cl,this.debugButton);
cR.add(cQ);
cR.add(cT);
cR.add(cU);
cR.addSeparator();
...
var dG=new qx.ui.menu.Button(cn,p);
var dH=new qx.ui.menu.Button(V,L);
var dE=new qx.ui.menu.Button(r,v);
var dF=new qx.ui.menu.Button(bf,co);
dG.addListener(cl,this.debugButton);
dH.addListener(cl,this.debugButton);
dE.addListener(cl,this.debugButton);
dF.addListener(cl,this.debugButton);
dD.add(dG);
dD.add(dH);
dD.add(dE);
dD.add(dF);
...
var eI=new qx.ui.menu.Button(bd,cB);
var eK=new qx.ui.menu.Button(bY);
var eJ=new qx.ui.menu.Button(cr);
var eH=new qx.ui.menu.Button(bT);
eI.addListener(cl,this.debugButton);
eK.addListener(cl,this.debugButton);
eJ.addListener(cl,this.debugButton);
eH.addListener(cl,this.debugButton);
eG.add(eI);
eG.add(eK);
...
eG.add(eH);
return eG;
},getList:function(){var dg=new qx.ui.form.List;
dg.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){dg.add(new qx.ui.form.ListItem(C+i));
}return dg;
},getContextMenu:function(){var j=new qx.ui.menu.Menu;
var l=new qx.ui.menu.Button(cd,cj,this.__CP);
var m=new qx.ui.menu.Button(cg,ce,this.__CQ);
var k=new qx.ui.menu.Button(cf,ch,this.__CR);
l.addListener(cl,this.debugButton);
m.addListener(cl,this.debugButton);
k.addListener(cl,this.debugButton);
j.add(l);
j.add(m);
j.add(k);
return j;
}},destruct:function(){this._disposeObjects(bG,ca,t,S,cz,O,y,bv);
}});
})();
...
(function(){var k="arrow",j="qx.ui.toolbar.SplitButton",i="keydown",h="toolbar-splitbutton",g="button",f="keyup",e="execute";
qx.Class.define(j,{extend:qx.ui.form.SplitButton,construct:function(a,b,c,d){arguments.callee.base.call(this,a,b,c,d);
this.removeListener(i,this._onKeyDown);
this.removeListener(f,this._onKeyUp);
},properties:{appearance:{refine:true,init:h},focusable:{refine:true,init:false}},members:{_createChildControlImpl:function(l){var m;

switch(l){case g:m=new qx.ui.toolbar.Button;
m.addListener(e,this._onButtonExecute,this);
this._addAt(m,0);
break;
case k:m=new qx.ui.toolbar.MenuButton;
this._addAt(m,1);
break;
