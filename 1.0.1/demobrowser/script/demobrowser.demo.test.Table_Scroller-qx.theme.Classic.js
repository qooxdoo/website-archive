...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_Scroller","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_Scroller-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e56ea920900c"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var g="demobrowser.demo.test.DummyTable",f="main",e="demobrowser.demo.test.Table_Scroller",d="#FFE",c="table";
qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var h=new demobrowser.demo.test.DummyTable();
this.getRoot().add(h,{left:10,top:10});
}}});
qx.Class.define(g,{extend:qx.ui.container.Composite,include:[demobrowser.demo.table.MUtil],construct:function(){arguments.callee.base.call(this,new qx.ui.layout.Canvas());
this.setAppearance(c);
this.set({decorator:f,backgroundColor:d,width:600,height:400});
var b=new qx.ui.table.pane.Scroller(this.getTableMock());
this.add(b,{edge:0});
var a=new qx.ui.table.pane.Model(this.getColumnModelMock());
b.setTablePaneModel(a);
b._onPaneModelChanged();
b.getTablePane().setVisibleRowCount(20);
b.getTablePane()._updateAllRows();
}});
})();
