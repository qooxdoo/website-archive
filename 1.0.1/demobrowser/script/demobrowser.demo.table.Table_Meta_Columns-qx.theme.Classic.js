...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Meta_Columns-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"a7b5f9b63c5a"},
  boot : "boot",
  bootIsInline : true,
