...
(function(){var h="demobrowser.demo.bom.Iframe",g="http://gmx.com",f="testFrame",d="",c="load",b="dummy";
qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var a=qx.bom.Iframe.create({name:f,src:g});
qx.bom.Element.addListener(a,c,function(e){this.debug("Content loaded.");
},this);
