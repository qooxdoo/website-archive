...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Messenger-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"350d25511b95"},
  boot : "boot",
  bootIsInline : true,
