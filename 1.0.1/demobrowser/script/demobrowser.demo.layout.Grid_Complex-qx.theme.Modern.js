...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Grid_Complex","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Grid_Complex-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"db25d2da0730"},
  boot : "boot",
  bootIsInline : true,
...
a.add(this.getGrid1());
a.add(this.getGrid2());
},getGrid1:function(){var o=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,allowGrowX:false});
o.setLayout(new qx.ui.layout.Grid(5,20));
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:0});
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:1});
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,width:150,maxWidth:150}),{row:1,column:0,rowSpan:1,colSpan:2});
return o;
},getGrid2:function(){var k=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,width:500,allowShrinkX:false,allowShrinkY:false,allowGrowX:false});
...
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:0,column:1,rowSpan:1,colSpan:2});
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:1,column:0});
var m=new qx.ui.container.Composite().set({decorator:j,backgroundColor:c,width:400,padding:5});
k.add(m,{row:1,column:1,rowSpan:2,colSpan:2});
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:2,column:0});
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:3,column:0,rowSpan:1,colSpan:2});
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}),{row:3,column:2});
var l=new qx.ui.layout.Grid();
m.setLayout(l);
l.setColumnAlign(1,f,e);
l.setColumnAlign(0,b,g);
l.setColumnMinWidth(1,40);
l.setSpacing(5);
l.setColumnFlex(1,1);
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,width:150}),{row:0,column:0});
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,height:70,allowGrowX:false}),{row:0,column:1});
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:60,allowGrowX:false}),{row:1,column:0});
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,minWidth:170}),{row:2,column:0});
return k;
}}});
})();
