...
(function(){var j=" / ",h="horizontal",g="demobrowser.demo.virtual.Table",f="__Fi",e="white",d="#EEE",c="vertical";
qx.Class.define(g,{extend:qx.application.Standalone,members:{__Fi:null,main:function(){arguments.callee.base.call(this);
...
k.getPane().addLayer(new qx.ui.virtual.layer.Row(e,d));
k.getPane().addLayer(new qx.ui.virtual.layer.GridLines(h));
k.getPane().addLayer(new qx.ui.virtual.layer.GridLines(c));
k.getPane().addLayer(new qx.ui.virtual.layer.HtmlCell(this));
this.__Fi=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(a,b){return this.__Fi.getCellProperties(a+j+b);
