...
(function(){var u="icon/48/devices/computer.png",t="7th a wide, short button",s="1. First Button",r="Flow Layout with line breaks",q="Number 6",p="demobrowser.demo.layout.Flow",o="Flow Layout",n="center",m="20px Margins around the great big 5th button!",l="top",g="bottom",k="3rd really, really, really long Button",j="middle",f="Number 4",e="item #",h="2. Second longer Button...";
...
},_createGalleryWindow:function(a,top){var b=new qx.ui.window.Window(o).set({contentPadding:0,width:200});
b.setLayout(new qx.ui.layout.Grow());
var d=new qx.ui.container.Scroll();
b.add(d);
var c=new qx.ui.container.Composite(new qx.ui.layout.Flow()).set({allowShrinkY:false});
d.add(c);

for(var i=0;i<30;i++){c.add(new qx.ui.basic.Atom(e+(i+1),u).set({iconPosition:l,width:60,padding:5}));
}b.moveTo(a,top);
b.open();
},_createLineBreakWindow:function(v,top){var E=new qx.ui.layout.Flow();
E.setAlignX(n);
var w=new qx.ui.window.Window(r).set({contentPadding:0,width:500,height:200,layout:E});
var F=u;
var z=new qx.ui.form.Button(s,F);
w.add(z);
var y=new qx.ui.form.Button(h,F);
w.add(y,{lineBreak:true});
var x=new qx.ui.form.Button(k,F);
x.setHeight(100);
w.add(x);
var D=new qx.ui.form.Button(f,F);
D.setAlignY(g);
w.add(D);
...
var B=new qx.ui.form.Button(q,F);
B.setAlignY(j);
w.add(B);
var A=new qx.ui.form.Button(t,F);
A.setMaxHeight(20);
w.add(A);
w.moveTo(v,top);
w.open();
...
(function(){var t="_applyLayoutChange",s="top",r="left",q="Integer",p="middle",o="bottom",n="qx.ui.layout.Flow",m="center",l="right",k="Boolean";
qx.Class.define(n,{extend:qx.ui.layout.Abstract,construct:function(g,h,j){arguments.callee.base.call(this);
...
}},properties:{alignX:{check:[r,m,l],init:r,apply:t},alignY:{check:[s,p,o],init:s,apply:t},spacingX:{check:q,init:0,apply:t},spacingY:{check:q,init:0,apply:t},reversed:{check:k,init:false,apply:t}},members:{verifyLayoutProperty:null,renderLayout:function(a,b){var f=this._getLayoutChildren();
...
}},__BS:function(B,C,D){var F=qx.ui.layout.Util;
var I=0;
...
}},_computeSizeHint:function(){return this.__BT(Infinity);
},hasHeightForWidth:function(){return true;
},getHeightForWidth:function(u){return this.__BT(u).height;
},__BT:function(v){var w=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());
var A=0;
var x=0;
var y=0;
...
qx.Class.define(a,{extend:Object,construct:function(d,e){this.__BU=d;
this.__BV=e;
this.__BW=d.length>0;
this.__BX=0;
},members:{__BU:null,__BV:null,__BW:null,__BX:null,computeNextLine:function(f){var f=f||Infinity;

if(!this.__BW){throw new Error("No more lines to compute");
}var q=this.__BU;
var o=0;
var h=0;
var p=[];
...
for(var i=this.__BX;i<q.length;i++){var n=q[i];
var r=n.getSizeHint();
var k=this.__BY(i);
var j=r.width+k;
var g=i==this.__BX;

if(!g&&h+j>f){this.__BX=i;
break;
...
if(n.getLayoutProperties().lineBreak){this.__BX=i+1;
break;
}}
if(i>=q.length){this.__BW=false;
}return {height:o,width:h,children:p,gapsBefore:l};
},__BY:function(b){var c=b==this.__BX;

if(c){return this.__BU[b].getMarginLeft();
}else{return Math.max(this.__BU[b-1].getMarginRight(),this.__BU[b].getMarginLeft(),this.__BV);
}},hasMoreLines:function(){return this.__BW;
}}});
})();
