...
v.add(this.getBox5());
v.add(this.getBox6());
},getBox1:function(){var w=new qx.ui.layout.VBox();
...
y.add(x,{flex:1});
return y;
},getBox2:function(){var l=new qx.ui.layout.VBox();
...
var s=new qx.ui.container.Composite(q).set({decorator:f,backgroundColor:c,allowGrowY:false});
q.setSpacing(5);
