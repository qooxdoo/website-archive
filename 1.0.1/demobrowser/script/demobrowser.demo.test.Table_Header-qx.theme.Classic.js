...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_Header-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d3dfd280225c"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var i="Show move feedback",h="demobrowser.demo.test.Table_Header",g="Complete update",f="mouseover",d="changeValue",c="Hide move feedback",b="execute";
qx.Class.define(h,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
...
k.addListener(b,function(){j.onPaneModelChanged();
});
}}});
})();
