...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Huge-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cd67b5310b0e"},
  boot : "boot",
  bootIsInline : true,
