...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.ScrollContainer","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.ScrollContainer-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"79c1da1653fd"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var e="demobrowser.demo.ui.ScrollContainer",d="red",c="Toggle size",b="blue",a="execute";
...
g.set({width:300,height:200});
g.add(this.generateBoxes());
this.getRoot().add(g,{left:10,top:10});
var f=new qx.ui.form.Button(c).set({padding:5});
var h=true;
f.addListener(a,function(){g.setWidth(h?800:300);
h=!h;
});
this.getRoot().add(f,{left:10,top:400});
},generateBoxes:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.Grid());

for(var y=0;y<10;y++){for(var x=0;x<10;x++){i.add((new qx.ui.core.Widget()).set({backgroundColor:((x+y)%2==0)?d:b,width:60,allowShrinkY:false,allowShrinkX:false,height:60}),{column:x,row:y});
}}return i;
}}});
})();
