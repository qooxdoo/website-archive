...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HSplit-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ee04c35914a4"},
  boot : "boot",
  bootIsInline : true,
