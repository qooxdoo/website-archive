...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Dock_PercentSize","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.Dock_PercentSize-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a025862079c9"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var p="main",o="50%",n="east",m="yellow",l="center",k="red",j="north",i="south",h="west",g="green",c="fuchsia",f="orange",e="blue",b="x",a="y",d="demobrowser.demo.layout.Dock_PercentSize";
...
var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(r);
var q=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:p,backgroundColor:m,width:450,height:250,allowGrowX:false});
var x=new qx.ui.core.Widget().set({decorator:p,backgroundColor:k});
var w=new qx.ui.core.Widget().set({decorator:p,backgroundColor:e});
var v=new qx.ui.core.Widget().set({decorator:p,backgroundColor:f});
var u=new qx.ui.core.Widget().set({decorator:p,backgroundColor:g});
var t=new qx.ui.core.Widget().set({decorator:p,backgroundColor:c});
q.add(x,{edge:j});
q.add(w,{edge:h,width:o});
q.add(v,{edge:i,height:o});
q.add(u,{edge:n});
q.add(t,{edge:l});
r.add(q);
var s=new qx.ui.layout.Dock();
s.setSort(a);
var q=(new qx.ui.container.Composite(s)).set({decorator:p,backgroundColor:m,width:450,height:250,allowGrowX:false});
var x=new qx.ui.core.Widget().set({decorator:p,backgroundColor:k});
var w=new qx.ui.core.Widget().set({decorator:p,backgroundColor:e});
var v=new qx.ui.core.Widget().set({decorator:p,backgroundColor:f});
var u=new qx.ui.core.Widget().set({decorator:p,backgroundColor:g});
