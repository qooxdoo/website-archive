...
g.add(this.getBox5());
g.add(this.getBox6());
},getBox1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:e,backgroundColor:c,height:300,allowGrowY:false});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:1});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:2});
h.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d}),{flex:3});
return h;
...
return l;
},getBox5:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,minHeight:0,decorator:e,backgroundColor:c,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:1});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:2});
a.add(new qx.ui.core.Widget().set({decorator:e,backgroundColor:d,minHeight:60}),{flex:3});
return a;
