...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"cab5ebe6850e"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var r="main",q="green",p="yellow",o="middle",n="bottom",m="demobrowser.demo.layout.VBox",l="center",k="left",j="right";
...
i.add(this.getBox6());
i.add(this.getBox7());
},getBox1:function(){var z=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:r,backgroundColor:p,allowGrowY:false});
z.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
z.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
z.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
return z;
},getBox2:function(){var c=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:r,backgroundColor:p,minWidth:60,allowGrowY:false});
c.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,maxWidth:40,alignX:k}));
c.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,maxWidth:40,alignX:l}));
c.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,maxWidth:40,alignX:j}));
return c;
},getBox3:function(){var s=new qx.ui.layout.VBox();
var t=new qx.ui.container.Composite(s).set({decorator:r,backgroundColor:p,height:300,allowGrowY:false});
s.setSpacing(5);
s.setAlignY(n);
t.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
t.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
t.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
return t;
},getBox4:function(){var a=new qx.ui.layout.VBox();
var b=new qx.ui.container.Composite(a).set({decorator:r,backgroundColor:p,height:300,allowGrowY:false});
a.setSpacing(5);
a.setAlignY(o);
b.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
b.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
b.add(new qx.ui.core.Widget().set({decorator:r,backgroundColor:q}));
return b;
},getBox5:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:r,backgroundColor:p,allowGrowY:false});
var D=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10});
var C=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10,marginTop:20});
var A=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10});
B.add(D);
B.add(C);
B.add(A);
return B;
},getBox6:function(){var d=new qx.ui.layout.VBox();
var f=new qx.ui.container.Composite(d).set({decorator:r,backgroundColor:p,height:300,allowGrowY:false});
d.setSpacing(5);
d.setAlignY(n);
var h=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10});
var g=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10,marginTop:20});
var e=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10});
f.add(h);
f.add(g);
f.add(e);
return f;
},getBox7:function(){var u=new qx.ui.layout.VBox();
var w=new qx.ui.container.Composite(u).set({decorator:r,backgroundColor:p,height:300,allowGrowY:false});
u.setSpacing(5);
u.setAlignY(o);
var y=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10});
var x=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10,marginTop:20});
var v=new qx.ui.core.Widget().set({decorator:r,backgroundColor:q,marginBottom:10});
w.add(y);
w.add(x);
w.add(v);
return w;
