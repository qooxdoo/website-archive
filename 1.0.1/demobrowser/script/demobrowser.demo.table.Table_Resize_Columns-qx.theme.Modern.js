...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Resize_Columns-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"fb97932d5241"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var A="execute",z="Add 10 rows",y="Remove 10 rows",x="Whether the the first visible row should ",w="demobrowser.demo.table.Table_Resize_Columns",v="A number",u="_tableModel",t="1*",s="icon/22/actions/list-add.png",r="50%",l="A date",q="changeValue",o="Boolean test",k="be rendered completely when scrolling.",j="Table with automatic column sizes",n="Keep first row",m="icon/22/actions/list-remove.png",p="ID";
qx.Class.define(w,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return j;
},createTable:function(){var g=this.createRandomRows(50);
var e=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
e.setColumns([p,v,l,o]);
e.setData(g);
var d={tableColumnModel:function(i){return new qx.ui.table.columnmodel.Resize(i);
}};
var h=this._table=new qx.ui.table.Table(e,d);
h.set({width:600,height:400});
h.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var f=h.getTableColumnModel();
var c=f.getBehavior();
c.set(0,{width:t,minWidth:40,maxWidth:80});
c.setWidth(1,r);
c.setMinWidth(1,100);
c.setMaxWidth(1,320);
var f=h.getTableColumnModel();
...
E.add(D);
C=new qx.ui.toolbar.Button(z,s);
C.addListener(A,function(G){var H=this.createRandomRows(10);
this._tableModel.addRows(H);
this.info("10 rows added");
},this);
D.add(C);
C=new qx.ui.toolbar.Button(y,m);
C.addListener(A,function(a){var b=this._tableModel.getRowCount();
...
E.add(D);
var B=this._table;
F=new qx.ui.toolbar.CheckBox(n);
F.set({value:B.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(x+k)});
F.addListener(q,function(I){B.setKeepFirstVisibleRowComplete(this.getValue());
},F);
D.add(F);
return E;
