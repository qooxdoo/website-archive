...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.OwnCodeInModel-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ac73d0882fb0"},
  boot : "boot",
  bootIsInline : true,
...
z.setLabelPath(p);
z.setIconOptions({converter:function(u){return q+u+l;
}});
z.setIconPath(j);
var A={getModelMixins:function(t){if(t==h){return demobrowser.demo.data.ItemsMixin;
}}};
var v=k;
...
B.addListener(r,function(){C.getModel().sortByType();
},this);
var y=new qx.ui.form.Button(e);
y.setWidth(120);
this.getRoot().add(y,{left:130,top:110});
y.addListener(r,function(){C.getModel().sortByName();
},this);
...
qx.Mixin.define(c,{members:{sortByType:function(){var s=this.getItems();
s.sort(function(a,b){if(a.getType()>b.getType()){return 1;
