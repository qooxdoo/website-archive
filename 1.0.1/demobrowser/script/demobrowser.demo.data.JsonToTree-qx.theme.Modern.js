...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.JsonToTree-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7e8567bef18f"},
  boot : "boot",
  bootIsInline : true,
