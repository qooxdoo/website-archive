...
},__Cw:4,__Cx:0,add:function(E){this.container.add(E,{row:Math.floor(this.__Cx/this.__Cw),column:this.__Cx%this.__Cw});
this.__Cx+=1;
},createSharedToolTip:function(){var N=new qx.ui.tooltip.ToolTip(t);
N.addListener(v,function(e){var J=d;

if(this.getOpener()==M){J+=s;
}else{J+=u;
}N.setLabel(J);
});
...
M.setToolTip(N);
this.add(M);
var L=new qx.ui.form.Button(k);
L.setToolTip(N);
this.add(L);
},createIconToolTip:function(){var C=new qx.ui.form.Button(z).set({toolTip:new qx.ui.tooltip.ToolTip(null,n)});
this.add(C);
},createToolTip:function(){var c=new qx.ui.form.Button(f).set({toolTip:new qx.ui.tooltip.ToolTip(h,n)});
this.add(c);
},createShortTimeoutToolTip:function(){var G=new qx.ui.tooltip.ToolTip(A,l);
G.setShowTimeout(50);
var F=new qx.ui.form.Button(j);
this.add(F);
F.setToolTip(G);
},createRichToolTip:function(){var b=new qx.ui.tooltip.ToolTip(r+w+p,l);
b.setWidth(200);
b.setRich(true);
b.setShowTimeout(50);
var a=new qx.ui.form.Button(B);
this.add(a);
a.setToolTip(b);
},createToolTipText:function(){var D=new qx.ui.form.Button(q).set({toolTipText:m});
this.add(D);
},createToolTipIcon:function(){var O=new qx.ui.form.Button(o).set({toolTipIcon:n});
this.add(O);
