...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ListController-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"a3d91d6f2cf3"},
  boot : "boot",
  bootIsInline : true,
