...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_FocusIndicator-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"fcb52122fc19"},
  boot : "boot",
  bootIsInline : true,
