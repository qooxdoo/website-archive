...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Background-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"35f41d15cd02"},
  boot : "boot",
  bootIsInline : true,
