...
(function(){var v="",u="changeSelection",t="demobrowser.demo.widget.HtmlArea",s="Set Text Color",r="Insert Table",q="qx/icon/Oxygen/16/actions/format-indent-more.png",p="As an application developer you can <b>use the same API.</b></p>",o="Comic Sans MS",n="Insert Ordered List",m="<p>This UI-level widget can be used at RIA (Rich ",bG="qx/icon/Oxygen/16/actions/format-justify-left.png",bF="Tahoma",bE="qx/icon/Oxygen/16/actions/format-text-italic.png",bD="Indent More",bC="qx/icon/Oxygen/16/actions/edit-undo.png",bB="Courier",bA="Courier New",bz="qx/icon/Oxygen/16/actions/format-justify-right.png",by="solid",bx="Arial Black",C="Align Left",D="Insert HTML Code",A="qx/icon/Oxygen/16/actions/format-justify-center.png",B="Impact",y="demobrowser/demo/icons/htmlarea/format-text-color.png",z="Change Font Size",w="<h1>HtmlArea UI-level widget</h1>",x="Align Center",K="Align Justify",L="Undo Last Change",ba="qx/icon/Oxygen/16/actions/insert-link.png",V="Redo Last Undo Step",bi="demobrowser/demo/icons/htmlarea/format-fill-color.png",bd="The UI widget does use the low-level component internally ",bt="<p>You can play around with this widget by hitting the ",bn="demobrowser/demo/icons/htmlarea/insert-text.png",Q="qx/icon/Oxygen/16/actions/format-indent-less.png",bw="Times New Roman",bv="Remove Format",bu="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",O="qx/icon/Oxygen/16/actions/edit-clear.png",S="demobrowser/demo/icons/htmlarea/format-list-unordered.png",U="HTML Code:",X="Set Text Background Color",bb="Format Bold",be="Georgia",bk="qx/icon/Oxygen/16/actions/edit-redo.png",bp="Change Font Family",E="Lucida Console",F="Internet Applications) and inline applications.<br/>",R="Align Right",bh="border-main",bg="Insert Link",bf="Inserted Unordered List",bm="qx/icon/Oxygen/16/actions/format-text-bold.png",bl="execute",bc="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bj="main",h="Arial",bo="12px ",G="Format Italic",H="qx/icon/Oxygen/16/actions/format-justify-fill.png",W="qx/icon/Oxygen/16/actions/format-text-underline.png",k="Verdana",l="Indent Less",N="Insert Image",I="demobrowser/demo/icons/htmlarea/insert-table.png",J='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',M="Format Strikethrough",Y="Format Underline",br="qx/icon/Oxygen/16/actions/insert-image.png",bq="demobrowser/demo/icons/htmlarea/format-list-ordered.png",T="Insert Horizontal Ruler",bs="so code-duplication is avoided.<br/>",P="buttons at the toolbar.</p>";
qx.Class.define(t,{extend:qx.application.Standalone,members:{__CT:null,main:function(){arguments.callee.base.call(this);
var bN=w+m+F+bd+bs+p+bt+P;
var bI=new qx.ui.basic.Label(bN);
bI.set({rich:true,marginBottom:10});
var bM=J;
var bL=this.getRoot();
var bK=new qx.ui.decoration.Single(1,by,bh);
bK.setWidthTop(0);
this.__CT=new qx.ui.embed.HtmlArea(bM,null,"blank.html");
this.__CT.set({width:600,height:400,decorator:bK});
var toolbar=this.__De();
var bH=new qx.ui.layout.VBox(0);
var bJ=new qx.ui.container.Composite(bH);
bJ.add(bI);
bJ.add(toolbar);
bJ.add(this.__CT);
bL.add(bJ,{left:20,top:20});
},__CU:function(e){var bR=window.prompt("Color (Hex): ","#");
this.setTextColor(bR);
},__CV:function(e){var g=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(g);
},__CW:function(e){var bO={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(bO);
},__CX:function(e){var cf="<table border='1'>"+"<tbody>"+"<tr>"+"<td>First Row, First cell</td>"+"<td>First Row, Second cell</td>"+"</tr>"+"<tr>"+"<td>Second Row, First cell</td>"+"<td>Second Row, Second cell</td>"+"</tr>"+"</tbody>"+"</table>";
this.insertHtml(cf);
},__CY:function(e){var bV=new qx.ui.window.Window("Insert Hyperlink");
bV.setLayout(new qx.ui.layout.VBox(20));
bV.set({width:400,showMaximize:false,showMinimize:false});
var ca=new qx.ui.form.TextField("http://");
bV.add(ca);
var bX=new qx.ui.layout.HBox(10);
bX.setAlignX("right");
var bY=new qx.ui.container.Composite(bX);
var bU=new qx.ui.form.Button("OK");
bU.setWidth(60);
bU.addListener("execute",function(e){this.insertHyperLink(ca.getValue());
bV.close();
},this);
bY.add(bU);
var bW=new qx.ui.form.Button("Cancel");
bW.setWidth(60);
bW.addListener("execute",function(e){bV.close();
},this);
bY.add(bW);
bV.add(bY);
bV.center();
bV.open();
this.saveRange();
},__Da:function(e){var bQ=window.prompt(U,v);
this.insertHtml(bQ);
},__Db:function(){var cc=new qx.ui.form.SelectBox;
cc.set({toolTipText:bp,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
cc.add(new qx.ui.form.ListItem(v));
var cd=[bF,k,bw,h,bx,bA,bB,be,B,o,E];
var cb;

for(var i=0,j=cd.length;i<j;i++){cb=new qx.ui.form.ListItem(cd[i]);
cb.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(bo+cd[i])});
cc.add(cb);
}cc.addListener(u,function(e){var ce=e.getData()[0].getLabel();

if(ce!=v){this.setFontFamily(ce);
cc.setSelection([cc.getChildren()[0]]);
}},this.__CT);
return cc;
},__Dc:function(){var bT=new qx.ui.form.SelectBox;
bT.set({toolTipText:z,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
bT.add(new qx.ui.form.ListItem(v));
var bS;

for(var i=1;i<=7;i++){bS=new qx.ui.form.ListItem(i+v);
bS.set({focusable:false,keepFocus:true});
bT.add(bS);
}bT.addListener(u,function(e){var bP=e.getData()[0].getLabel();

if(bP!=v){this.setFontSize(bP);
bT.setSelection([bT.getChildren()[0]]);
}},this.__CT);
return bT;
},__Dd:function(){return [{bold:{text:bb,image:bm,action:this.__CT.setBold},italic:{text:G,image:bE,action:this.__CT.setItalic},underline:{text:Y,image:W,action:this.__CT.setUnderline},strikethrough:{text:M,image:bc,action:this.__CT.setStrikeThrough},removeFormat:{text:bv,image:O,action:this.__CT.removeFormat}},{alignLeft:{text:C,image:bG,action:this.__CT.setJustifyLeft},alignCenter:{text:x,image:A,action:this.__CT.setJustifyCenter},alignRight:{text:R,image:bz,action:this.__CT.setJustifyRight},alignJustify:{text:K,image:H,action:this.__CT.setJustifyFull}},{fontFamily:{custom:this.__Db},fontSize:{custom:this.__Dc},fontColor:{text:s,image:y,action:this.__CU},textBackgroundColor:{text:X,image:bi,action:this.__CV}},{indent:{text:bD,image:q,action:this.__CT.insertIndent},outdent:{text:l,image:Q,action:this.__CT.insertOutdent}},{insertImage:{text:N,image:br,action:this.__CW},insertTable:{text:r,image:I,action:this.__CX},insertLink:{text:bg,image:ba,action:this.__CY},insertHTML:{text:D,image:bn,action:this.__Da},insertHR:{text:T,image:bu,action:this.__CT.insertHorizontalRuler}},{ol:{text:n,image:bq,action:this.__CT.insertOrderedList},ul:{text:bf,image:S,action:this.__CT.insertUnorderedList}},{undo:{text:L,image:bC,action:this.__CT.undo},redo:{text:V,image:bk,action:this.__CT.redo}}];
},__De:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator(bj);
var a;
var b=this.__Dd();

for(var i=0,j=b.length;i<j;i++){var c=new qx.ui.toolbar.Part;
toolbar.add(c);

for(var d in b[i]){var f=b[i][d];

if(f.custom){a=f.custom.call(this);
}else{a=new qx.ui.toolbar.Button(null,f.image);
a.set({focusable:false,keepFocus:true,center:true,toolTipText:f.text?f.text:v});
a.addListener(bl,f.action,this.__CT);
}c.add(a);
}}return toolbar;
}}});
})();
...
(function(){var V="qx.event.type.Data",U="Boolean",T="qx.event.type.Event",S="display",R="mousedown",Q="none",P="qx.client",O="appear",N="mouseup",M="losecapture",bQ="xhtml",bP="_applyUseUndoRedo",bO="focusOut",bN="height",bM="_applyMessengerMode",bL=")",bK="InsertParagraphOnLinebreak",bJ="gecko",bI="repeat",bH="undoRedoState",bd="div",be="messengerContent",bb="focused",bc="Function",Y="_applyInsertParagraphOnLinebreak",ba="__Dg",W="PostProcess",X="width",bh="_applyInsertLinebreakOnCtrlEnter",bi="ContentType",bq="px",bo="url(",bx="DOMNodeRemoved",bs="cursorContext",bD="String",bB="htmlarea",bk="ready",bG="loadingError",bF="MessengerMode",bE="zIndex",bj="left",bm="__Di",bn="UseUndoRedo",bp="top",br="_applyContentType",bt="qx.ui.embed.HtmlArea",by="mshtml",bC="block",bf="position",bg="readyAfterInvalid",bl="InsertLinebreakOnCtrlEnter",bw="contextmenu",bv="set",bu="qx/static/blank.gif",bA="_applyPostProcess",bz="absolute";
qx.Class.define(bt,{extend:qx.ui.core.Widget,construct:function(bU,bV,bW){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.Grow);
this.__Dj();
this.__Df={content:bU,styleInfo:bV,source:bW};
...
this.__Dg=this._createBlockerElement();
this.getContainerElement().add(this.__Dg);
this.__Dh={};
},events:{"loadingError":V,"messengerContent":V,"cursorContext":V,"ready":T,"readyAfterInvalid":T,"focused":T,"focusOut":T,"contextmenu":V,"undoRedoState":V},statics:{isBlockNode:function(n){return qx.bom.htmlarea.HtmlArea.isBlockNode(n);
},isParagraphParent:function(t){return qx.bom.htmlarea.HtmlArea.isParagraphParent(t);
}},properties:{contentType:{check:bD,init:bQ,apply:br},messengerMode:{check:U,init:false,apply:bM},insertParagraphOnLinebreak:{check:U,init:true,apply:Y},insertLinebreakOnCtrlEnter:{check:U,init:true,apply:bh},postProcess:{check:bc,nullable:true,init:null,apply:bA},useUndoRedo:{check:U,init:true,apply:bP},appearance:{refine:true,init:bB}},members:{__Di:null,__Dh:null,__Dg:null,__Df:null,_applyContentType:function(E,F){if(this.__Di!=null){this.__Di.setContentType(E);
}else{this.__Dh[bi]=E;
}},_applyMessengerMode:function(r,s){if(this.__Di!=null){this.__Di.setMessengerMode(r);
}else{this.__Dh[bF]=r;
}},_applyInsertParagraphOnLinebreak:function(w,x){if(this.__Di!=null){this.__Di.setInsertParagraphOnLinebreak(w);
}else{this.__Dh[bK]=w;
}},_applyInsertLinebreakOnCtrlEnter:function(bS,bT){if(this.__Di!=null){this.__Di.setInsertLinebreakOnCtrlEnter(bS);
}else{this.__Dh[bl]=bS;
}},_applyPostProcess:function(o,p){if(this.__Di!=null){this.__Di.setPostProcess(o);
}else{this.__Dh[W]=o;
}},_applyUseUndoRedo:function(J,K){if(this.__Di!=null){this.__Di.setUseUndoRedo(J);
}else{this.__Dh[bn]=J;
}},_createBlockerElement:function(){var d=new qx.html.Element(bd);
d.setStyle(bE,20);
d.setStyle(bf,bz);
d.setStyle(S,Q);
if(qx.core.Variant.isSet(P,by)){d.setStyles({backgroundImage:bo+qx.util.ResourceManager.getInstance().toUri(bu)+bL,backgroundRepeat:bI});
}return d;
},__Dj:function(){this.addListenerOnce(O,this.__Dk);
},__Dk:function(){var a=this.getContentElement().getDomElement();
this.__Di=new qx.bom.htmlarea.HtmlArea(a,this.__Df.content,this.__Df.styleInfo,this.__Df.source);
this.__Dl();
this.__Dm();

if(qx.core.Variant.isSet(P,bJ)){this.__Dp();
}this.addListener(O,this.forceEditable);
},__Dl:function(){for(var l in this.__Dh){this.__Di[bv+l](this.__Dh[l]);
}},__Dm:function(){this.__Di.addListener(bk,this.__Dn,this);
this.__Di.addListener(bg,this.__Dn,this);
this.__Di.addListener(bb,this.__Dn,this);
this.__Di.addListener(bO,this.__Dn,this);
this.__Di.addListener(bG,this.__Do,this);
this.__Di.addListener(bs,this.__Do,this);
this.__Di.addListener(bw,this.__Do,this);
this.__Di.addListener(bH,this.__Do,this);
this.__Di.addListener(be,this.__Do,this);
},__Dn:function(e){var m=e.clone();
this.fireEvent(m.getType());
},__Do:function(e){var bR=e.clone();
this.fireDataEvent(bR.getType(),e.getData());
},__Dp:function(){var self=this;
var c=this.getContainerElement().getDomElement();
qx.bom.Event.addNativeListener(c,bx,qx.event.GlobalError.observeMethod(function(e){self.__Di.invalidateEditor();
}));
},renderLayout:function(y,top,z,A){arguments.callee.base.call(this,y,top,z,A);
var C=bq;
var B=this.getInsets();
this.__Dg.setStyle(bj,B.left+C);
this.__Dg.setStyle(bp,B.top+C);
this.__Dg.setStyle(X,(z-B.left-B.right)+C);
this.__Dg.setStyle(bN,(A-B.top-B.bottom)+C);
},getIframeObject:function(){return this.__Di!=null?this.__Di.getIframeObject():null;
},getCommandManager:function(){return this.__Di!=null?this.__Di.getCommandManager():null;
},setValue:function(i){if(this.__Di!=null){this.__Di.setValue(i);
}},getValue:function(){return this.__Di!=null?this.__Di.getValue():null;
},getComputedValue:function(b){return this.__Di!=null?this.__Di.getHtml(b):null;
},getCompleteHtml:function(){return this.__Di!=null?this.__Di.getCompleteHtml():null;
},getContentDocument:function(){return this.__Di!=null?this.__Di.getContentDocument():null;
},getContentBody:function(){return this.__Di!=null?this.__Di.getContentBody():null;
},getContentWindow:function(){return this.__Di!=null?this.__Di.getContentWindow():null;
},getWords:function(j){return this.__Di!=null?this.__Di.getWords(j):null;
},getWordsWithElement:function(){return this.__Di!=null?this.__Di.getWordsWithElement():null;
},getTextNodes:function(){return this.__Di!=null?this.__Di.getTextNodes():null;
},isReady:function(){return this.__Di!=null?this.__Di.isReady():false;
},forceEditable:function(){if(this.__Di!=null){this.__Di.forceEditable();
}},isLoaded:function(){return this.__Di!=null?this.__Di.isLoaded():false;
},setEditable:function(v){if(this.__Di!=null){this.__Di.setEditable(v);
}},getEditable:function(){return this.__Di!=null?this.__Di.getEditable():false;
},isEditable:function(){return this.__Di!=null?this.__Di.isEditable():false;
},insertHtml:function(D){return this.__Di!=null?this.__Di.insertHtml(D):false;
},removeFormat:function(){return this.__Di!=null?this.__Di.removeFormat():false;
},setBold:function(){return this.__Di!=null?this.__Di.setBold():false;
},setItalic:function(){return this.__Di!=null?this.__Di.setItalic():false;
},setUnderline:function(){return this.__Di!=null?this.__Di.setUnderline():false;
},setStrikeThrough:function(){return this.__Di!=null?this.__Di.setStrikeThrough():false;
},setFontSize:function(L){return this.__Di!=null?this.__Di.setFontSize(L):false;
},setFontFamily:function(bX){return this.__Di!=null?this.__Di.setFontFamily(bX):false;
},setTextColor:function(G){return this.__Di!=null?this.__Di.setTextColor(G):false;
},setTextBackgroundColor:function(q){return this.__Di!=null?this.__Di.setTextBackgroundColor(q):false;
},setJustifyLeft:function(){return this.__Di!=null?this.__Di.setJustifyLeft():false;
},setJustifyCenter:function(){return this.__Di!=null?this.__Di.setJustifyCenter():false;
},setJustifyRight:function(){return this.__Di!=null?this.__Di.setJustifyRight():false;
},setJustifyFull:function(){return this.__Di!=null?this.__Di.setJustifyFull():false;
},insertIndent:function(){return this.__Di!=null?this.__Di.insertIndent():false;
},insertOutdent:function(){return this.__Di!=null?this.__Di.insertOutdent():false;
},insertOrderedList:function(){return this.__Di!=null?this.__Di.insertOrderedList():false;
},insertUnorderedList:function(){return this.__Di!=null?this.__Di.insertUnorderedList():false;
},insertHorizontalRuler:function(){return this.__Di!=null?this.__Di.insertHorizontalRuler():false;
},insertImage:function(I){return this.__Di!=null?this.__Di.insertImage(I):false;
},insertHyperLink:function(u){return this.__Di!=null?this.__Di.insertHyperLink(u):false;
},removeBackgroundColor:function(){return this.__Di!=null?this.__Di.removeBackgroundColor():false;
},setBackgroundColor:function(k){return this.__Di!=null?this.__Di.setBackgroundColor(k):false;
},removeBackgroundImage:function(){return this.__Di!=null?this.__Di.removeBackgroundImage():false;
},setBackgroundImage:function(f,g,h){return this.__Di!=null?this.__Di.setBackgroundImage(f,g,h):false;
},selectAll:function(){return this.__Di!=null?this.__Di.selectAll():false;
},undo:function(){return this.__Di!=null?this.__Di.undo():false;
},redo:function(){return this.__Di!=null?this.__Di.redo():false;
},resetHtml:function(){if(this.__Di!=null){this.__Di.resetHtml();
}},getHtml:function(H){return this.__Di!=null?this.__Di.getHtml(H):null;
},containsOnlyPlaceholder:function(){return this.__Di!=null?this.__Di.containsOnlyPlaceHolder():false;
},getContextInformation:function(){return this.__Di!=null?this.__Di.getContextInformation():null;
},getSelection:function(){return this.__Di!=null?this.__Di.getSelection():null;
},getSelectedText:function(){return this.__Di!=null?this.__Di.getSelectedText():null;
},getSelectedHtml:function(){return this.__Di!=null?this.__Di.getSelectedHtml():null;
},clearSelection:function(){if(this.__Di!=null){this.__Di.clearSelection();
}},getRange:function(){return this.__Di.getRange();
},saveRange:function(){this.__Di.saveRange();
},getSavedRange:function(){return this.__Di.getSavedRange();
},resetSavedRange:function(){this.__Di.resetSavedRange();
},getFocusNode:function(){return this.__Di!=null?this.__Di.getFocusNode():null;
},block:function(){this.__Dg.setStyle(S,bC);
},release:function(){this.__Dg.setStyle(S,Q);
}},destruct:function(){this._disposeObjects(ba,bm);
