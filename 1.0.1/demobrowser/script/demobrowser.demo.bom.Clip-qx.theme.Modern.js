...
},set0:function(){var k=document.getElementById(f);
qx.log.Logger.debug("Setting to: 20,20  120,40");
qx.bom.element.Clip.set(k,{left:20,top:20,width:120,height:40});
...
},set3:function(){var a=document.getElementById(f);
qx.log.Logger.debug("Setting to: null,20  120,40");
qx.bom.element.Clip.set(a,{top:20,width:120,height:40});
var b=qx.bom.element.Clip.get(a)||{};
qx.log.Logger.debug("Clip after: "+b.left+","+b.top+"  "+b.width+","+b.height);
},set4:function(){var i=document.getElementById(f);
...
},reset:function(){var m=document.getElementById(f);
qx.log.Logger.debug("Resetting");
qx.bom.element.Clip.reset(m);
