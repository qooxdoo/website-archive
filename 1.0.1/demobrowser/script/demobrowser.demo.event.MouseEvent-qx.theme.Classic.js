...
(function(){var p="mouse",o="change",n="mousedown",m="mouseout",l="demobrowser.demo.event.MouseEvent",k="clientX",j="dblclick",h="relatedTarget",g="button",f="capture",G="mousemove",F="pageY",E="screenX",D="logger",C="",B="_",A="mouseover",z="check_",y="click",x="Event",v="Target",w="clientY",t="mouseup",u="losecapture",r="contextmenu",s="screenY",q="pageX";
qx.Class.define(l,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){arguments.callee.base.call(this);
this._initLogger([v,x,g,q,F,k,w,E,s,h],document.getElementById(D),50);
var a=document.getElementById(p);
var c=[n,t,y,j,r,G,A,m];
...
}qx.bom.Element.addListener(d,o,this.__xJ,this);
}var b=document.getElementById(f);
b.checked=false;
qx.bom.Element.addListener(b,o,function(e){var H=e.getTarget().checked;

if(H){qx.bom.Element.capture(a);
}else{qx.bom.Element.releaseCapture(a);
}},this);
qx.bom.Element.addListener(a,u,function(e){b.checked=false;
},this);
},__xJ:function(e){var L=e.getTarget().id.split(B)[1];
var J=e.getTarget().checked;
var K=document.getElementById(p);

if(J){qx.bom.Element.addListener(K,L,this.logMouseEvent,this);
}else{qx.bom.Element.removeListener(K,L,this.logMouseEvent,this);
}},logMouseEvent:function(I){I.preventDefault();
this._log([I.getTarget().id,I.getType(),I.getButton(),I.getDocumentLeft(),I.getDocumentTop(),I.getScreenLeft(),I.getScreenTop(),I.getViewportLeft(),I.getViewportTop(),I.getRelatedTarget()?I.getRelatedTarget().id:C]);
}}});
})();
