...
(function(){var bX="execute",bW="changeValue",bV="icon/16/actions/system-search.png",bU="Online Forum",bT="New",bS="icon/16/actions/edit-cut.png",bR="Search in files",bQ="icon/16/actions/format-justify-fill.png",bP="Left aligned",bO="Undo",bD="_openCommand",bC="Uppercase",bB="View",bA="C Dialect",bz="changeSelection",by="Save as...",bx="Show line numbers",bw="Search previous...",bv="Quickstart",bu="Cut",cf="Ctrl+N",cg="C",cd="Show console",ce="Search",cb="Help",cc="_redoCommand",bY="Redo",ca="Show status bar",ch="icon/16/actions/format-justify-left.png",ci="ANSI to OEM",bH="Centered",bG="Paragraph",bJ="Edit",bI="Ctrl+O",bL="icon/16/actions/document-print.png",bK="icon/16/actions/document-open.png",bN="C Sharp",bM="icon/16/actions/edit-undo.png",bF="Close",bE="icon/16/actions/document-save-as.png",x="Python",y="icon/16/apps/utilities-help.png",z="Show tree",A="Spaces to tabs",B="Right aligned",C="OEM to ANSI",D="JavaScript",E="demobrowser.demo.widget.MenuBar",F="_copyCommand",G="Topics",cm="Save",cl="_undoCommand",ck="Capitals",cj="icon/16/actions/application-exit.png",cq="C Plus Plus",cp="_saveCommand",co="Lowercase",cn="Search next...",cs="_newCommand",cr="Replace in files",be="Perl",bf="Ctrl+P",bc="XML",bd="Panes",bi="Justified",bj="Ctrl+X",bg="Show macros",bh="Show ruler",ba="Copy",bb="Paste",O="_pasteCommand",N="icon/16/actions/format-justify-right.png",Q="Ctrl+Z",P="Ctrl+R",K="icon/16/actions/edit-redo.png",J="Show tags",M="Info...",L="Format",I="File",H="Show tabs",bo="Print",bp="icon/16/actions/document-save.png",bq="icon/16/actions/edit-copy.png",br="Search...",bk="icon/16/actions/format-justify-center.png",bl="Open",bm="_cutCommand",bn="Objective C",bs="Exit",bt="Ctrl+S",Y="Syntax",X="Ctrl+C",W="icon/16/actions/document-new.png",V="Tabs to spaces",U="ASCII table",T="Replace",S="HTML",R="icon/16/actions/edit-paste.png";
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(cf);
this._newCommand.addListener(bX,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bI);
this._openCommand.addListener(bX,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(bt);
this._saveCommand.addListener(bX,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(Q);
this._undoCommand.addListener(bX,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(P);
this._redoCommand.addListener(bX,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(bj);
this._cutCommand.addListener(bX,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(X);
this._copyCommand.addListener(bX,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(bf);
this._pasteCommand.addListener(bX,this.debugCommand);
...
cA.add(menubar);
var cz=new qx.ui.menubar.Button(I,null,this.getFileMenu());
var cy=new qx.ui.menubar.Button(bJ,null,this.getEditMenu());
var cB=new qx.ui.menubar.Button(ce,null,this.getSearchMenu());
var cE=new qx.ui.menubar.Button(bB,null,this.getViewMenu());
var cD=new qx.ui.menubar.Button(L,null,this.getFormatMenu());
var cC=new qx.ui.menubar.Button(cb,null,this.getHelpMenu());
menubar.add(cz);
menubar.add(cy);
menubar.add(cB);
menubar.add(cE);
...
menubar.add(cC);
return cA;
},getFileMenu:function(){var dh=new qx.ui.menu.Menu;
var df=new qx.ui.menu.Button(bT,W,this._newCommand);
var dj=new qx.ui.menu.Button(bl,bK,this._openCommand);
var di=new qx.ui.menu.Button(bF);
var dm=new qx.ui.menu.Button(cm,bp,this._saveCommand);
var dl=new qx.ui.menu.Button(by,bE);
var dk=new qx.ui.menu.Button(bo,bL);
var dg=new qx.ui.menu.Button(bs,cj);
df.addListener(bX,this.debugButton);
dj.addListener(bX,this.debugButton);
di.addListener(bX,this.debugButton);
dm.addListener(bX,this.debugButton);
dl.addListener(bX,this.debugButton);
dk.addListener(bX,this.debugButton);
dg.addListener(bX,this.debugButton);
dh.add(df);
dh.add(dj);
dh.add(di);
dh.add(dm);
...
var cX=new qx.ui.menu.Button(bO,bM,this._undoCommand);
var cW=new qx.ui.menu.Button(bY,K,this._redoCommand);
var cT=new qx.ui.menu.Button(bu,bS,this._cutCommand);
var cY=new qx.ui.menu.Button(ba,bq,this._copyCommand);
var cV=new qx.ui.menu.Button(bb,R,this._pasteCommand);
cX.addListener(bX,this.debugButton);
cW.addListener(bX,this.debugButton);
cT.addListener(bX,this.debugButton);
cY.addListener(bX,this.debugButton);
cV.addListener(bX,this.debugButton);
cU.add(cX);
cU.add(cW);
cU.addSeparator();
cU.add(cT);
...
cU.add(cV);
return cU;
},getSearchMenu:function(){var cP=new qx.ui.menu.Menu;
var cN=new qx.ui.menu.Button(br,bV);
var cS=new qx.ui.menu.Button(cn);
var cO=new qx.ui.menu.Button(bw);
var cR=new qx.ui.menu.Button(T);
var cM=new qx.ui.menu.Button(bR,bV);
var cQ=new qx.ui.menu.Button(cr);
cO.setEnabled(false);
cN.addListener(bX,this.debugButton);
cS.addListener(bX,this.debugButton);
cO.addListener(bX,this.debugButton);
cR.addListener(bX,this.debugButton);
cM.addListener(bX,this.debugButton);
cQ.addListener(bX,this.debugButton);
cP.add(cN);
cP.add(cS);
cP.add(cO);
cP.add(cR);
...
var c=new qx.ui.menu.Button(bd,null,null,this.getPanesMenu());
var g=new qx.ui.menu.Button(Y,null,null,this.getSyntaxMenu());
var f=new qx.ui.menu.CheckBox(bh);
var d=new qx.ui.menu.CheckBox(bx);
var b=new qx.ui.menu.Button(U);
f.addListener(bW,this.debugCheckBox);
d.addListener(bW,this.debugCheckBox);
b.addListener(bX,this.debugButton);
a.add(c);
a.add(g);
a.addSeparator();
a.add(f);
...
a.add(b);
return a;
},getPanesMenu:function(){var r=new qx.ui.menu.Menu;
var t=new qx.ui.menu.CheckBox(H);
var v=new qx.ui.menu.CheckBox(ca);
var w=new qx.ui.menu.CheckBox(z);
var s=new qx.ui.menu.CheckBox(bg);
var u=new qx.ui.menu.CheckBox(J);
var q=new qx.ui.menu.CheckBox(cd);
t.setValue(true);
v.setValue(true);
s.setValue(true);
t.addListener(bW,this.debugCheckBox);
v.addListener(bW,this.debugCheckBox);
w.addListener(bW,this.debugCheckBox);
s.addListener(bW,this.debugCheckBox);
u.addListener(bW,this.debugCheckBox);
q.addListener(bW,this.debugCheckBox);
r.add(v);
r.add(t);
r.addSeparator();
r.add(w);
...
r.add(q);
return r;
},getSyntaxMenu:function(){var ds=new qx.ui.menu.Menu;
var dn=new qx.ui.menu.RadioButton(S);
var dq=new qx.ui.menu.RadioButton(bc);
var dp=new qx.ui.menu.RadioButton(D);
var dr=new qx.ui.menu.Button(bA,null,null,this.getSyntaxCMenu());
var dv=new qx.ui.menu.RadioButton(be);
var dt=new qx.ui.menu.RadioButton(x);
ds.add(dn);
ds.add(dq);
ds.add(dp);
ds.add(dr);
...
du.add(dn,dq,dp,dv,dt);
du.add.apply(du,dr.getMenu().getChildren());
du.addListener(bz,this.debugRadio);
return ds;
},getSyntaxCMenu:function(){var db=new qx.ui.menu.Menu;
var da=new qx.ui.menu.RadioButton(cg);
var de=new qx.ui.menu.RadioButton(bN);
var dd=new qx.ui.menu.RadioButton(bn);
var dc=new qx.ui.menu.RadioButton(cq);
db.add(da);
db.add(de);
db.add(dd);
db.add(dc);
return db;
},getFormatMenu:function(){var k=new qx.ui.menu.Menu;
var j=new qx.ui.menu.Button(bG,null,null,this.getParagraphMenu());
var m=new qx.ui.menu.Button(V);
var n=new qx.ui.menu.Button(A);
var i=new qx.ui.menu.Button(bC);
var l=new qx.ui.menu.Button(co);
var h=new qx.ui.menu.Button(ck);
var p=new qx.ui.menu.Button(C);
var o=new qx.ui.menu.Button(ci);
m.addListener(bX,this.debugButton);
n.addListener(bX,this.debugButton);
i.addListener(bX,this.debugButton);
l.addListener(bX,this.debugButton);
h.addListener(bX,this.debugButton);
p.addListener(bX,this.debugButton);
o.addListener(bX,this.debugButton);
k.add(j);
k.add(m);
k.add(n);
k.addSeparator();
...
k.add(o);
return k;
},getParagraphMenu:function(){var cH=new qx.ui.menu.Menu;
var cK=new qx.ui.menu.Button(bP,ch);
var cL=new qx.ui.menu.Button(B,N);
var cI=new qx.ui.menu.Button(bH,bk);
var cJ=new qx.ui.menu.Button(bi,bQ);
cK.addListener(bX,this.debugButton);
cL.addListener(bX,this.debugButton);
cI.addListener(bX,this.debugButton);
cJ.addListener(bX,this.debugButton);
cH.add(cK);
cH.add(cL);
cH.add(cI);
cH.add(cJ);
return cH;
},getHelpMenu:function(){var ct=new qx.ui.menu.Menu;
var cv=new qx.ui.menu.Button(G,y);
var cx=new qx.ui.menu.Button(bv);
var cw=new qx.ui.menu.Button(bU);
var cu=new qx.ui.menu.Button(M);
cv.addListener(bX,this.debugButton);
cx.addListener(bX,this.debugButton);
cw.addListener(bX,this.debugButton);
cu.addListener(bX,this.debugButton);
ct.add(cv);
ct.add(cx);
ct.addSeparator();
ct.add(cw);
...
ct.add(cu);
return ct;
}},destruct:function(){this._disposeObjects(cs,bD,cp,cl,cc,bm,F,O);
}});
})();
