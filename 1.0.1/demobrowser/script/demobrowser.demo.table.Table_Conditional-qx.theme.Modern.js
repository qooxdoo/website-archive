...
(function(){var r=">",q="",p="#3300CC",o="#BB0044",n="#FF0000",m="icon/16/actions/dialog-ok.png",l="Number 1",k="center",j="Table using conditional cell renderer",i="#DD0022",P="#1100EE",O="demobrowser.demo.table.Table_Conditional",N="#880077",M="#660099",L="#CC0033",K="#AA0055",J="#0000FF",I="#0099FF",H="#5500AA",G="right",z="#990066",A="#00CCFF",w="#EE0011",y="bold",u="#770088",v="#4400BB",s="icon/16/actions/dialog-cancel.png",t="#0033FF",B="Number 2",C="#2200DD",E="#0066FF",D="ID",F="Image";
qx.Class.define(O,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return j;
},createTable:function(){var b=new qx.ui.table.model.Simple();
b.setColumns([D,l,B,F]);
var a=[m,s];
var c=[];

for(var h=0;h<100;h++){var x=Math.random()*1000;
c.push([h,x,x,a[Math.floor(x)%2]]);
}b.setData(c);
b.setColumnEditable(1,true);
b.setColumnEditable(2,true);
var e=new qx.ui.table.Table(b);
e.setMetaColumnCounts([1,-1]);
var f=qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION;
e.getSelectionModel().setSelectionMode(f);
var g=new qx.ui.table.cellrenderer.Conditional(G,q,q,q);
g.addNumericCondition(r,0,null,n,null,null);
g.addNumericCondition(r,50,null,w,null,null);
g.addNumericCondition(r,100,null,i,null,null);
g.addNumericCondition(r,150,null,L,null,null);
g.addNumericCondition(r,200,null,o,null,null);
g.addNumericCondition(r,250,null,K,null,null);
g.addNumericCondition(r,300,null,z,null,null);
g.addNumericCondition(r,350,null,N,null,null);
g.addNumericCondition(r,400,null,u,null,null);
g.addNumericCondition(r,450,null,M,null,null);
g.addNumericCondition(r,500,null,H,null,null);
g.addNumericCondition(r,550,null,v,null,null);
g.addNumericCondition(r,600,null,p,null,null);
g.addNumericCondition(r,650,null,C,null,null);
g.addNumericCondition(r,700,null,P,null,null);
g.addNumericCondition(r,750,null,J,null,null);
g.addNumericCondition(r,800,null,t,null,null);
g.addNumericCondition(r,850,null,E,null,null);
g.addNumericCondition(r,900,null,I,null,null);
g.addNumericCondition(r,950,k,A,null,y);
e.getTableColumnModel().setDataCellRenderer(2,g);
var d=new qx.ui.table.cellrenderer.Image(19,16);
e.getTableColumnModel().setDataCellRenderer(3,d);
return e;
}}});
})();
