...
(function(){var k="green",j="sinodial",i="click",h="yellow",g="width",f="height",d="demobrowser.demo.layout.Grid_Animated",c="orange",b="main";
...
},getNewWidget:function(){var a=new qx.ui.core.Widget().set({width:50,height:50,backgroundColor:k});
a.addListener(i,function(e){if(this._active==a){return;
}var r=[];
var p=0.3;

if(this._active){this._active.set({backgroundColor:k,width:50,height:50});
}a.set({backgroundColor:c});
var s=a.getBounds();
r.push(new demobrowser.demo.layout.Grid_Animated_Property(a,g).set({from:s.width,to:200,duration:p,transition:j}));
r.push(new demobrowser.demo.layout.Grid_Animated_Property(a,f).set({from:s.height,to:200,duration:p,transition:j}));
var q=new qx.fx.effect.core.Parallel(r[0],r[1]);
q.start();
this._active=a;
},this);
return a;
},getAnimGrid:function(){var n=new qx.ui.container.Composite().set({decorator:b,backgroundColor:h,width:500,height:500});
