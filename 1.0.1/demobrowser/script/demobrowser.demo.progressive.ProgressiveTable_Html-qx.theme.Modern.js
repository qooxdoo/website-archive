...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.progressive.ProgressiveTable_Html-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"85249b19fd77"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var A="</div>",z="<div style='background-color: cyan; text-align: center;'>",y="row",x="2*",w="1*",v="    I'm red!",u="  </span>",t="end",s="Literal",q="  Hi there.",n="  <span style='color: red;'>",p="demobrowser.demo.progressive.ProgressiveTable_Html",o="  Hello world!",m="    &nbsp;&nbsp;&nbsp;",l="Html";
qx.Class.define(p,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var i=function(B,C){var D={renderer:y,location:t,data:[B,B]};
return D;
};
var h=new qx.ui.progressive.renderer.table.Widths(2);
h.setWidth(0,x);
h.setWidth(1,w);
var c=[s,l];
var e=new qx.ui.progressive.headfoot.TableHeading(h,c);
var b=new qx.ui.progressive.headfoot.Progress(h,c);
var k=new qx.ui.progressive.structure.Default(e,b);
var a=new qx.ui.progressive.Progressive(k);
...
g.addElements(f);
a.setDataModel(g);
var j=new qx.ui.progressive.renderer.table.Row(h);
a.addRenderer(y,j);
...
qx.Class.define(a,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(g,h){arguments.callee.base.call(this);
this.__Bc=g;
var k=g.getData();
this.__Bd=[];
...
},properties:{appearance:{refine:true,init:c}},members:{__Bc:null,__Bf:null,__Bd:null,__Be:null,join:function(o){arguments.callee.base.call(this,o);
},getLayoutChildren:function(){if(this.__Bf){return this.__Bc.getData();
...
this.__Bf=true;
this.__Be.renderLayout(m,100);
this.__Bf=false;
var n=this.__Bc.getData();
for(var i=0;i<n.length;i++){this.__Bd[i].setWidth(n[i].getComputedWidth());
}}},destruct:function(){this.__Bc=this.__Bd=null;
...
(function(){var q=".qx-progressive-",p="-col-",o="px;",n="-row",m="}",l="width: ",k="0px ",j="qx-progressive-",h="px",g="  font-size: 11px;",Y="padding: ",X="px ",W='',V="end",U="qx.client",T="div",S="  position: absolute;",R="  width : 100%;",Q="__columnData",P="  border-bottom:1px solid #eeeeee;",x="",y="  top: 0px;",v="  overflow:hidden;",w=" {",t="  cursor:default;",u="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",r="-row {",s="__Bi",z="resize",A="start",H="relative",F="  -o-text-overflow: ellipsis;",J="mshtml",I="  border-right:1px solid #f2f2f2;",L="  white-space:nowrap;",K=';-moz-user-select:none;',C="  padding : 0px 6px 0px 6px;",O="qx.ui.progressive.renderer.table.Row",N="progressive-table-row-background-odd",M="  text-overflow:ellipsis;",B="__Bl",D="  height: 100%;",E="progressive-table-row-background-even",G="left: ";
qx.Class.define(O,{extend:qx.ui.progressive.renderer.Abstract,construct:function(a){arguments.callee.base.call(this);
this.__Bg=a;
this.__Bh={};
this.__Bi=new qx.ui.progressive.renderer.table.cell.Default();
this.__Bj=null;
this.__Bk={};
var b=qx.theme.manager.Color.getInstance();
this.__Bk.bgcol=[];
this.__Bk.bgcol[0]=b.resolve(E);
this.__Bk.bgcol[1]=b.resolve(N);
this.__Bl=new qx.ui.layout.HBox();
this.__Bl.connectToWidget(this);
},statics:{__Bm:null,__Bn:6,__Bo:S+y+D+v+M+F+L+I+P+C+t+g+u+(qx.core.Variant.isSet(U,J)?W:K)},properties:{defaultRowHeight:{init:16}},members:{__Bj:null,__Bp:null,__Bq:null,__Bg:null,__Bh:null,__Bi:null,__Bk:null,__Bl:null,join:function(bc,name){if(this.__Bj){throw new Error("Renderer is already joined to a Progressive.");
}this.__Bj=bc;
this.__Bp=name;
...
if(!be.__Bm[bd]){be.__Bm[bd]={rowstylesheet:null,cellstylesheet:[]};
var bf=q+bd+r+R+m;
be.__Bm[bd].rowstylesheet=qx.bom.Stylesheet.createElement(bf);
var bg=this.__Bg.getData();

for(var i=0;i<bg.length;i++){var bf=q+bd+p+i+w+be.__Bo+m;
be.__Bm[bd].cellstylesheet[i]=qx.bom.Stylesheet.createElement(bf);
}this.__Bq=bd;
var bh=bc.getStructure().getPane();
bh.addListener(z,this._resizeColumns,this);
}},addRenderer:function(c,d){var f=this.__Bg.getData();

if(c<0||c>=f.length){throw new Error("Column "+c+" out of range (max: "+(f.length-1)+")");
}this.__Bh[c]=d;
},removeRenderer:function(ba){var bb=this.__Bg.getData();

if(ba<0||ba>=bb.length){throw new Error("Column "+ba+" out of range (max: "+(bb.length-1)+")");
}
if(!this.__Bh[ba]){throw new Error("No existing renderer for column "+ba);
}delete this.__Bh[ba];
...
var bp;
var bm=0;
if(bi.getRendererData()[this.__Bp].end===undefined){bi.getRendererData()[this.__Bp]={end:0,start:1,rows:0,totalHeight:0};
}var bs=document.createElement(T);
for(var i=0;i<bt.length;i++){var bn=j+this.__Bq+p+i;
bp=this.__Bh[i]||this.__Bi;
...
var br=bi.getRendererData()[this.__Bp];
br.totalHeight+=bm;
bs.style.position=H;
bs.style.height=bm+h;
bs.className=j+this.__Bq+n;
bs.innerHTML=bo.join(x);
switch(bj.location){case V:var bk=br.end||0;
bs.style.backgroundColor=this.__Bk.bgcol[bk];
br.end=(bk==0?1:0);
bi.getPane().getContentElement().getDomElement().appendChild(bs);
break;
case A:var bl=bi.getPane().getContentElement().getDomElement();
...
},getLayoutChildren:function(){return this.__Bg.getData();
},_resizeColumns:function(e){var bH=this.__Bj.getStructure().getPane();
var bE=bH.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bF=q+this.__Bq+n;
var bB=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bB.__Bm[this.__Bq].rowstylesheet,bF);
var bD=l+bE+o;
qx.bom.Stylesheet.addRule(bB.__Bm[this.__Bq].rowstylesheet,bF,bD);
this.__Bl.renderLayout(bE,100);
var bG=this.__Bg.getData();
for(var i=0,bK=0;i<bG.length;i++,bK+=bE){var bF=q+this.__Bq+p+i;
var bB=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bB.__Bm[this.__Bq].cellstylesheet[i],bF);
bE=bG[i].getComputedWidth();
{};
var bC;

if(qx.bom.client.Feature.CONTENT_BOX){bC=qx.ui.progressive.renderer.table.Row.__Bn*2;
}else{bC=-1;
}var bJ=(bE-bC)+o;
var bI=k+qx.ui.progressive.renderer.table.Row.__Bn+X+k+qx.ui.progressive.renderer.table.Row.__Bn+o;
var bA=bK+o;
var bD=bB.__Bo+l+bJ+G+bA+Y+bI;
qx.bom.Stylesheet.addRule(bB.__Bm[this.__Bq].cellstylesheet[i],bF,bD);
}}},destruct:function(){var name;

for(name in this.__Bh){this.__Bh[name]=null;
}var bw=qx.ui.progressive.renderer.table.Row;
var bv=this.__Bj.toHashCode();

if(bw.__Bm&&bw.__Bm[bv]){if(bw.__Bm[bv].rowstylesheet){var by=q+this.__Bq+n;
var bw=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bw.__Bm[this.__Bq].rowstylesheet,by);
}if(bw.__Bm[bv].cellstylesheet){for(var i=bw.__Bm[bv].cellstylesheet.length-1;i>=0;i--){var by=q+this.__Bq+p+i;
var bx=bw.__Bm[this.__Bq].cellstylesheet[i];
var bw=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bx,by);
}}}
if(this.__Bj&&this.__Bj.getRendererData){var bz=this.__Bj.getRendererData();

if(bz&&bz[this.__Bp]&&bz[this.__Bp].end!==undefined){bz[this.__Bp]=null;
}}this.__Bk=this.__Bh=this.__Bj=this.__Bg=null;
this._disposeObjects(B,s,Q);
}});
})();
...
},_getCellExtras:function(m){return j;
