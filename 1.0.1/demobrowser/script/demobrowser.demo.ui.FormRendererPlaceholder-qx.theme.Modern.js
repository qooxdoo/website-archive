...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.FormRendererPlaceholder-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"4ae0bd75453f"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var d="qx.ui.form.renderer.SinglePlaceholder";
qx.Class.define(d,{extend:qx.ui.form.renderer.Single,implement:qx.ui.form.renderer.IFormRenderer,members:{addItems:function(a,b,c){if(c!=null){this._add(this._createHeader(c),{row:this._row,column:0,colSpan:2});
this._row++;
}for(var i=0;i<a.length;i++){if(a[i].setPlaceholder===undefined){throw new Error("Only widgets with placeholders supported.");
}a[i].setPlaceholder(b[i]);
this._add(a[i],{row:this._row,column:0});
this._row++;
}}}});
})();
