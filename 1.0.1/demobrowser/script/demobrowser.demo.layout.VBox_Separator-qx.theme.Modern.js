...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.VBox_Separator-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f60c2087a6cd"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var i="main",h="green",g="separator-vertical",f="yellow",e="center",d="demobrowser.demo.layout.VBox_Separator",c="left",b="right";
...
j.add(this.getBox2());
j.add(this.getBox3());
},getBox1:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return o;
},getBox2:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,minWidth:60,allowGrowY:false});
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:e}));
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
return a;
},getBox3:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,g)).set({decorator:i,backgroundColor:f,allowGrowY:false});
var n=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var m=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var k=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
l.add(n);
l.add(m);
l.add(k);
return l;
