...
n.setWidth(300);
n.setMaxListHeight(100);

for(var i=0;i<20;i++){var o=new qx.ui.form.ListItem(c+i);
if(i%5==1){o.setEnabled(false);
}n.add(o);
}this.container.add(n,{left:200,top:40});
