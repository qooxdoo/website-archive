...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Table_Pane-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"149fbfdb84d0"},
  boot : "boot",
  bootIsInline : true,
