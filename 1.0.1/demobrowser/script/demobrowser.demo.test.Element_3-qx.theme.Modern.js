...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Element_3","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_3-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"fee9ba323fdc"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var k="text",j="blur",i="demobrowser.demo.test.Element_3",h="focus",g="type",f="test",d="input",c="focusin";
qx.Class.define(i,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var a=new qx.html.Root(document.getElementById(f));
var b=new qx.html.Element(d);
b.setAttribute(g,k);
b.focus();
b.addListener(h,function(e){qx.log.Logger.debug("Element focused");
});
b.addListener(j,function(e){qx.log.Logger.debug("Element blurred");
});
qx.bom.Element.addListener(document.documentElement,c,function(e){qx.log.Logger.debug("FocusIn: ",e.getTarget());
});
a.add(b);
