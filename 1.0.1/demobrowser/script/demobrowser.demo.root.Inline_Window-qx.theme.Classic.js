...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.root.Inline_Window","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.root.Inline_Window-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"553df4c5967b"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(h,{extend:qx.application.Inline,members:{main:function(){arguments.callee.base.call(this);
var p=new qx.ui.root.Inline(document.getElementById(d)).set({decorator:a,padding:10,backgroundColor:b});
p.setLayout(new qx.ui.layout.HBox(10));
var m=new qx.ui.form.Button(g);
var o=1;
m.addListener(j,function(e){var q=new qx.ui.window.Window(f+o++).set({width:200,height:150});
q.moveTo(o*15,o*15);
q.open();
});
p.add(m);
var n=new qx.ui.form.Button(i);
n.addListener(j,this.newModalWindow,this);
p.add(n);
...
qx.Class.define(k,{extend:qx.ui.root.Abstract,construct:function(a){this.__oR=a;
arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.Basic());
this.setZIndex(10000);
qx.ui.core.queue.Layout.add(this);
this.addListener(l,this.__oT,this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
},members:{__oS:null,__oR:null,_createContainerElement:function(){var v=this.__oR.createElement(m);
this.__oR.body.appendChild(v);
...
},__oT:function(e){this.getContainerElement().setStyles({width:0,height:0});
...
(function(){var r="relative",q="resize",p="height",o="mshtml",n="",m="px",l="position",k="qx.ui.root.Inline",h="$$widget",g="hidden",c="qx.client",f="div",d="left";
qx.Class.define(k,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(H,I,J){this.__oU=H;
H.style.overflow=g;
H.style.textAlign=d;
this.__oV=I||false;
this.__oW=J||false;
...
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
},members:{__oV:false,__oW:false,__oU:null,__oX:function(){if(this.__oV||this.__oW){var K=qx.bom.element.Dimension.getSize(this.__oU);

if(this.__oV&&K.width<1){throw new Error("The root element "+this.__oU+" of "+this+" needs a width when its width size should be used!");
}
if(this.__oW){if(K.height<1){throw new Error("The root element "+this.__oU+" of "+this+" needs a height when its height size should be used!");
}if(K.height>=1&&qx.bom.element.Style.get(this.__oU,p,3)==n){qx.bom.element.Style.set(this.__oU,p,K.height+m);
}}qx.event.Registration.addListener(this.__oU,q,this._onResize,this);
}},_createContainerElement:function(){var t=this.__oU;

if(this.__oV||this.__oW){var x=document.createElement(f);
t.appendChild(x);
if(qx.core.Variant.isSet(c,o)&&qx.bom.client.Engine.VERSION==6){var w=qx.dom.Node.getBodyElement(t);
var v;
var z;
var y=false;
...
if(v!=w){z=qx.bom.element.Style.get(v,l);
...
x.style.position=r;
A.setAttribute(h,this.toHashCode());
return A;
},_onResize:function(e){var s=e.getData();

if((s.oldWidth!==s.width)&&this.__oV||(s.oldHeight!==s.height)&&this.__oW){qx.ui.core.queue.Layout.add(this);
}},_computeSizeHint:function(){var F=this.__oV;
var C=this.__oW;

if(!F||!C){var B=arguments.callee.base.call(this);
}else{B={};
}var G=qx.bom.element.Dimension;

if(F){var E=G.getContentWidth(this.__oU);
B.width=E;
B.minWidth=E;
B.maxWidth=E;
}
if(C){var D=G.getContentHeight(this.__oU);
B.height=D;
B.minHeight=D;
B.maxHeight=D;
}return B;
}},defer:function(a,b){qx.ui.core.MLayoutHandling.remap(b);
},destruct:function(){qx.event.Registration.removeListener(this.__oU,q,this._onResize,this);
this.__oU=null;
}});
})();
