...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.ListBinding-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"5ec43a266aba"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var h="Affe ",g="demobrowser.demo.virtual.ListBinding";
...
for(var i=0;i<10000;i++){e.push(h+i);
}e=new qx.data.Array(e);
var c=new qx.ui.virtual.form.ListController(e,b);
c.setDelegate({filter:function(l){var m;
parseInt(l[l.length-1])%2?m=false:m=true;
return m;
},sorter:function(j,k){return j>k;
}});
var f=new qx.ui.virtual.form.List().set({useWidgetCells:true});
this.getRoot().add(f,{left:500,top:10});
new qx.ui.virtual.form.ListController(c.getSelection(),f);
...
var d=demobrowser.demo.virtual.messenger.BuddyModel.createBuddies(200);
new qx.ui.virtual.form.ListController(d,a);
