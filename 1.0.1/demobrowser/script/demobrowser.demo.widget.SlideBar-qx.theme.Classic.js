...
(function(){var v="display.png",u="drive-optical.png",t="computer.png",s="audio-card.png",r="battery.png",q="main",p="Toggle size",o="icon/48/devices/",n="drive-harddisk.png",m="changeValue",g="camera-web.png",l="network-wired.png",k="input-keyboard.png",f="camera-photo.png",d="network-wireless.png",j="audio-input-microphone.png",h="demobrowser.demo.widget.SlideBar";
qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var b=new qx.ui.container.SlideBar();
b.set({width:300});
b.setLayout(new qx.ui.layout.HBox(3));
var c=[s,j,r,f,g,t,v,n,u,k,l,d];

for(var i=0;i<c.length;i++){b.add((new qx.ui.basic.Image(o+c[i])).set({decorator:q,padding:4}));
}var a=new qx.ui.form.ToggleButton(p);
a.addListener(m,function(e){b.setWidth(e.getData()?800:300);
});
this.getRoot().add(a,{left:20,top:100});
