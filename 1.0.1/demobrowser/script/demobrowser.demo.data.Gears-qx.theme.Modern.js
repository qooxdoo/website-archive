...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.Gears","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.Gears-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"3913dd5d460c"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var w="configured",v="completed",u="changeState",t="changeModel",s="__vM",r="qx.data.store.Json",q="GET",p="_marshaler",o="sending",n="application/json",g="changeUrl",m="failed",j="loaded",f="timeout",e="queued",i="String",h="aborted",k="_applyUrl",d="receiving",l="qx.event.type.Data";
...
}},events:{"loaded":l},properties:{model:{nullable:true,event:t},state:{check:[w,e,o,d,v,h,f,m],init:w,event:u},url:{check:i,apply:k,event:g}},members:{__vM:null,_delegate:null,_applyUrl:function(a,b){if(a!=null){this._createRequest(a);
}},_createRequest:function(z){this.__vM=new qx.io.remote.Request(z,q,n);
var A=this._delegate;

if(A&&qx.lang.Type.isFunction(A.configureRequest)){this._delegate.configureRequest(this.__vM);
}this.__vM.addListener(v,this.__vN,this);
this.__vM.addListener(u,function(B){this.setState(B.getData());
},this);
this.__vM.send();
},__vN:function(C){var E=C.getContent();
...
(function(){var m="value",l='undefined',k="",j="model",i="application/x-googlegears",h="demobrowser.demo.data.store.Gears",g="<span style='font-size: 20px'>google Gears</span>",f="loaded",d="Age: ",c="http://code.google.com/apis/gears/install.html",G="lastname",F="firstname",E="age",D="demobrowser.demo.data.Gears",C="First Name: ",B='qooxdoo',A='Gears.Factory',z='select * from Persons',y="delete from Persons",x="LastName: ",t=' (Firstname varchar(255), Lastname varchar(255), Age int)',u="Person",r='ie_mobile',s="none",p='create table if not exists Persons',q="This demo requires Gears to be installed. Install now?",n='insert into Persons values (?, ?, ?)',o='beta.database',v="changeBubble",w="object";
qx.Class.define(D,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var T=new qx.ui.groupbox.GroupBox(u);
this.getRoot().add(T,{left:10,top:50});
T.setLayout(new qx.ui.layout.Grid(0,3));
T.add(new qx.ui.basic.Label(C),{row:0,column:0});
T.add(new qx.ui.basic.Label(x),{row:1,column:0});
T.add(new qx.ui.basic.Label(d),{row:2,column:0});
var N=new qx.ui.form.TextField();
T.add(N,{row:0,column:1});
var P=new qx.ui.form.TextField();
T.add(P,{row:1,column:1});
var Q=new qx.ui.form.Spinner(0,0,1000);
T.add(Q,{row:2,column:1});
var R=new qx.data.controller.Object();
R.addTarget(N,m,F,true);
R.addTarget(P,m,G,true);
R.addTarget(Q,m,E,true);
var S=new demobrowser.demo.data.store.Gears();
S.bind(j,R,j);
...
qx.Class.define(h,{extend:qx.data.store.Json,construct:function(){arguments.callee.base.call(this);
this.initGears();
if(!window.google||!google.gears){if(confirm(q)){location.href=c;
return;
}return;
}this.__xr=this.initDB();
this.__xs();
},members:{__xs:function(I){var J=this.getPerson();
this._marshaler.toClass(J,true);
this.setModel(this._marshaler.toModel(J));
this.getModel().addListener(v,this.__xt,this);
this.fireDataEvent(f,this.getModel());
},__xt:function(a){var b=this.getModel();
this.update(b.getFirstname(),b.getLastname(),b.getAge());
},update:function(K,L,M){if(!google.gears.factory||!this.__xr){return;
}this.__xr.execute(y);
this.__xr.execute(n,[K,L,M]);
},getPerson:function(){var U={};
U.firstname=k;
U.lastname=k;
U.age=0;

if(!google.gears.factory||!this.__xr){return U;
}var V=this.__xr.execute(z);

if(V.isValidRow()){U.firstname=V.field(0);
U.lastname=V.field(1);
U.age=parseInt(V.field(2));
}V.close();
return U;
},initDB:function(){if(window.google&&google.gears){try{var W=google.gears.factory.create(o);

if(W){W.open(B);
W.execute(p+t);
}}catch(X){this.error('Could not create database: '+X.message);
}}return W;
},initGears:function(){if(window.google&&google.gears){return;
}var H=null;
if(typeof GearsFactory!=l){H=new GearsFactory();
}else{try{H=new ActiveXObject(A);
if(H.getBuildInfo().indexOf(r)!=-1){H.privateSetGlobalObject(this);
}}catch(e){if((typeof navigator.mimeTypes!=l)&&navigator.mimeTypes[i]){H=document.createElement(w);
H.style.display=s;
H.width=0;
H.height=0;
H.type=i;
...
if(!google.gears){google.gears={factory:H};
}}}});
})();
...
qx.Class.define(Y,{extend:qx.core.Object,construct:function(r,s,t){arguments.callee.base.call(this);
this.__nX={};
this.__nY={};
this.__oa={};
this.__ob={};
...
},events:{"created":O,"configured":O,"sending":O,"receiving":O,"completed":bt,"aborted":O,"failed":bt,"timeout":bt},statics:{__oc:0},properties:{url:{check:L,init:ba},method:{check:[bp,bs,bg,X,bi],apply:bj,init:bp},asynchronous:{check:N,init:true},data:{check:L,nullable:true},username:{check:L,nullable:true},password:{check:L,nullable:true},state:{check:[br,M,K,J,F,I,bq,H],init:br,apply:bb,event:bd},responseType:{check:[V,be,T,W,U],init:V,apply:bc},timeout:{check:P,nullable:true},prohibitCaching:{check:function(v){return typeof v==bh||v===bn;
},init:true,apply:bf},crossDomain:{check:N,init:false},fileUpload:{check:N,init:false},transport:{check:S,nullable:true},useBasicHttpAuth:{check:N,init:false}},members:{__nX:null,__nY:null,__oa:null,__ob:null,__oc:null,send:function(){qx.io.remote.RequestQueue.getInstance().add(this);
...
return;
}if(x!==bn||this.getMethod()!=bs){this.setParameter(G,new Date().valueOf());
}else{this.removeParameter(G);
}this.setRequestHeader(bo,bm);
this.setRequestHeader(bl,bm);
},_applyMethod:function(B,C){if(B===bs){this.setRequestHeader(bk,R);
}else{this.removeRequestHeader(bk);
}var D=this.getProhibitCaching();
this._applyProhibitCaching(D,D);
},_applyResponseType:function(h,i){this.setRequestHeader(Q,h);
},setRequestHeader:function(p,q){this.__nX[p]=q;
},removeRequestHeader:function(g){delete this.__nX[g];
},getRequestHeader:function(j){return this.__nX[j]||null;
},getRequestHeaders:function(){return this.__nX;
},setParameter:function(c,d,f){if(f){this.__oa[c]=d;
}else{this.__nY[c]=d;
}},removeParameter:function(u,w){if(w){delete this.__oa[u];
}else{delete this.__nY[u];
}},getParameter:function(m,n){if(n){return this.__oa[m]||null;
}else{return this.__nY[m]||null;
}},getParameters:function(b){return (b?this.__oa:this.__nY);
},setFormField:function(z,A){this.__ob[z]=A;
},removeFormField:function(E){delete this.__ob[E];
},getFormField:function(o){return this.__ob[o]||null;
...
(function(){var x="Integer",w="aborted",v="_onaborted",u="_on",t="_applyEnabled",s="Boolean",r="sending",q="interval",p="failed",o="qx.io.remote.RequestQueue",j="timeout",n="completed",m="queued",h="__oh",g="__of",l="receiving",k="singleton";
...
this.__oh.addListener(q,this._oninterval,this);
},properties:{enabled:{init:true,check:s,apply:t},maxTotalRequests:{check:x,nullable:true},maxConcurrentRequests:{check:x,init:qx.bom.client.Transport.getMaxConcurrentRequestCount()},defaultTimeout:{check:x,init:5000}},members:{__oe:null,__of:null,__og:null,__oh:null,getRequestQueue:function(){return this.__oe;
...
}var d=this.__oe.shift();
var f=new qx.io.remote.Exchange(d);
this.__og++;
this.__of.push(f);
this._debug();
f.addListener(r,this._onsending,this);
f.addListener(l,this._onreceiving,this);
f.addListener(n,this._oncompleted,this);
f.addListener(w,this._oncompleted,this);
...
}},_remove:function(F){qx.lang.Array.remove(this.__of,F);
F.dispose();
this._check();
},__oi:0,_onsending:function(e){{};
...
var A=u+e.getType();
try{if(B[A]){B[A](e);
}}catch(a){var z=qx.dev.StackTrace.getStackTraceFromError(a);
this.error("Request "+B+" handler "+A+" threw an error: "+a+"\nStack Trace:\n"+z);
try{if(B[v]){var event=qx.event.Registration.createEvent(w,qx.event.type.Event);
B[v](event);
}}catch(C){}}finally{this._remove(e.getTarget());
}},_oninterval:function(e){var M=this.__of;

if(M.length==0){this.__oh.stop();
return;
...
}this.__oh.setEnabled(D);
},add:function(N){N.setState(m);

if(N.isAsynchronous()){this.__oe.push(N);
}else{this.__oe.unshift(N);
}this._check();
...
}},canHandle:function(o,p,q){if(!qx.lang.Array.contains(o.handles.responseTypes,q)){return false;
}
for(var r in p){if(!o.handles[r]){return false;
}}return true;
},_nativeMap:{0:bA,1:L,2:T,3:R,4:S},wasSuccessful:function(G,H,I){if(I){switch(G){case null:case 0:return true;
case -1:return H<4;
default:return typeof G===br;
}}else{switch(G){case -1:{};
return H<4;
...
return false;
default:if(G>206&&G<300){return true;
}qx.log.Logger.debug(this,"Unknown status code: "+G+" ("+H+")");
return false;
}}},statusCodeToString:function(n){switch(n){case -1:return bN;
case 200:return bl;
case 304:return bs;
case 206:return bd;
case 204:return bC;
...
default:return bw;
}}},properties:{request:{check:bD,nullable:true},implementation:{check:bP,nullable:true,apply:bG},state:{check:[L,T,R,S,Q,P,U],init:L,event:bx,apply:bn}},members:{send:function(){var B=this.getRequest();

if(!B){return this.error("Please attach a request object first");
}qx.io.remote.Exchange.initTypes();
var z=qx.io.remote.Exchange.typesOrder;
var y=qx.io.remote.Exchange.typesSupported;
var D=B.getResponseType();
var E={};

if(B.getAsynchronous()){E.asynchronous=true;
}else{E.synchronous=true;
}
if(B.getCrossDomain()){E.crossDomain=true;
}
if(B.getFileUpload()){E.fileUpload=true;
}for(var C in B.getFormFields()){E.programaticFormFields=true;
break;
}var F,A;

for(var i=0,l=z.length;i<l;i++){F=y[z[i]];

if(F){if(!qx.io.remote.Exchange.canHandle(F,E,D)){continue;
}
try{{};
A=new F;
this.setImplementation(A);
A.setUseBasicHttpAuth(B.getUseBasicHttpAuth());
A.send();
return true;
}catch(t){this.error("Request handler throws error");
this.error(t);
return;
}}}this.error("There is no transport implementation available to handle this request: "+B);
...
this.setState(Q);
}},timeout:function(){var s=this.getImplementation();

if(s){this.warn("Timeout: implementation "+s.toHashCode());
s.timeout();
}else{this.warn("Timeout: forcing state to timeout");
this.setState(P);
}this.__oj();
},__oj:function(){var w=this.getRequest();
...
switch(g){case T:this.fireEvent(T);
break;
case R:this.fireEvent(R);
break;
case S:case Q:case P:case U:var k=this.getImplementation();

if(!k){break;
}this.__oj();

if(this.hasListener(g)){var m=qx.event.Registration.createEvent(g,qx.io.remote.Response);

if(g==S){var j=k.getResponseContent();
m.setContent(j);
if(j===null){{};
g=U;
}}else if(g==U){m.setContent(k.getResponseContent());
}m.setStatusCode(k.getStatusCode());
m.setResponseHeaders(k.getResponseHeaders());
this.dispatchEvent(m);
}this.setImplementation(null);
k.dispose();
break;
}}},settings:{"qx.ioRemoteDebug":false,"qx.ioRemoteDebugData":false},destruct:function(){var d=this.getImplementation();

if(d){this.setImplementation(null);
d.dispose();
...
(function(){var bn="failed",bm="completed",bl="=",bk="aborted",bj="",bi="sending",bh="&",bg="configured",bf="timeout",be="application/xml",bI="qx.io.remote.transport.XmlHttp",bH="application/json",bG="text/html",bF="qx.client",bE="receiving",bD="text/plain",bC="text/javascript",bB="?",bA="created",bz='Referer',bu='Basic ',bv="\n</pre>",bs="string",bt='Authorization',bq="<pre>Could not execute json: \n",br="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",bo=':',bp="parseerror",bw="file:",bx="webkit",by="object";
qx.Class.define(bI,{extend:qx.io.remote.transport.Abstract,statics:{handles:{synchronous:true,asynchronous:true,crossDomain:false,fileUpload:false,programaticFormFields:false,responseTypes:[bD,bC,bH,be,bG]},requestObjects:[],requestObjectCount:0,createRequestObject:qx.core.Variant.select(bF,{"default":function(){return new XMLHttpRequest;
...
var y=this.getRequest();
var u=this.getMethod();
var B=this.getAsynchronous();
var A=this.getUrl();
var w=(window.location.protocol===bw&&!(/^http(s){0,1}\:/.test(A)));
this.__ok=w;
var E=this.getParameters(false);
var C=[];

for(var v in E){var z=E[v];

if(z instanceof Array){for(var i=0;i<z.length;i++){C.push(encodeURIComponent(v)+bl+encodeURIComponent(z[i]));
}}else{C.push(encodeURIComponent(v)+bl+encodeURIComponent(z));
}}
if(C.length>0){A+=(A.indexOf(bB)>=0?bh:bB)+C.join(bh);
}if(this.getData()===null){var E=this.getParameters(true);
var C=[];
...
if(C.length>0){this.setData(C.join(bh));
}}var D=function(F){var K=br;
var O=bj;
var I,H,G;
var L,M,N,J;
var i=0;
...
if(isNaN(H)){N=J=64;
}else if(isNaN(G)){J=64;
}O+=K.charAt(L)+K.charAt(M)+K.charAt(N)+K.charAt(J);
}while(i<F.length);
return O;
};
try{if(this.getUsername()){if(this.getUseBasicHttpAuth()){y.open(u,A,B);
y.setRequestHeader(bt,bu+D(this.getUsername()+bo+this.getPassword()));
}else{y.open(u,A,B,this.getUsername(),this.getPassword());
}}else{y.open(u,A,B);
}}catch(d){this.error("Failed with exception: "+d);
this.failed();
return;
}if(!qx.core.Variant.isSet(bF,bx)){y.setRequestHeader(bz,window.location.href);
}var x=this.getRequestHeaders();

for(var v in x){y.setRequestHeader(v,x[v]);
}try{{};
y.send(this.getData());
}catch(R){if(w){this.failedLocally();
}else{this.error("Failed to send data: "+R,"send");
this.failed();
}return;
}if(!B){this._onreadystatechange();
}},failedLocally:function(){if(this.getState()===bn){return;
}this.warn("Could not load from file: "+this.getUrl());
this.failed();
},_onreadystatechange:qx.event.GlobalError.observeMethod(function(e){switch(this.getState()){case bm:case bk:case bn:case bf:{};
return;
}var U=this.getReadyState();

if(U==4){if(!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(),U,this.__ok)){if(this.getState()===bg){this.setState(bi);
}return this.failed();
}}while(this.__ol<U){this.setState(qx.io.remote.Exchange._nativeMap[++this.__ol]);
}}),getReadyState:function(){var n=null;

try{n=this.getRequest().readyState;
}catch(bP){}return n;
...
},getStatusCode:function(){var o=-1;

try{o=this.getRequest().status;
}catch(h){}return o;
},getStatusText:function(){var ba=bj;
...
var j=this.getStatusCode();
var k=this.getReadyState();

if(qx.io.remote.Exchange.wasSuccessful(j,k,this.__ok)){try{m=this.getRequest().responseXML;
}catch(g){}}if(typeof m==by&&m!=null){if(!m.documentElement){var s=String(this.getRequest().responseText).replace(/<\?xml[^\?]*\?>/,bj);
m.loadXML(s);
}if(!m.documentElement){throw new Error("Missing Document Element!");
}
if(m.documentElement.tagName==bp){throw new Error("XML-File is not well-formed!");
}}else{throw new Error("Response was not a valid xml document ["+this.getRequest().responseText+"]");
}return m;
},getFetchedLength:function(){var f=this.getResponseText();
return typeof f==bs?f.length:0;
...
switch(this.getResponseType()){case bD:case bG:{};
return bO;
case bH:{};
...
}}catch(W){this.error("Could not execute json: ["+bO+"]",W);
return bq+bO+bv;
}case bC:{};
...
}}catch(V){this.error("Could not execute javascript: ["+bO+"]",V);
return null;
}case be:bO=this.getResponseXml();
{};
return (bO===0?0:(bO||null));
default:this.warn("No valid responseType specified ("+this.getResponseType()+")!");
return null;
}},_applyState:function(X,Y){{};

switch(X){case bA:this.fireEvent(bA);
break;
...
break;
case bk:this.getRequest().abort();
this.fireEvent(bk);
break;
case bf:this.getRequest().abort();
this.fireEvent(bf);
break;
}}},defer:function(S,T){qx.io.remote.Exchange.registerType(qx.io.remote.transport.XmlHttp,bI);
},destruct:function(){var Q=this.getRequest();

if(Q){Q.onreadystatechange=qx.lang.Function.empty;
switch(Q.readyState){case 1:case 2:case 3:Q.abort();
}}this.__om=null;
}});
})();
...
var ba=M+Y;
var bb=B+Y;
if(qx.core.Variant.isSet(s,A)){this.__oD=document.createElement(D+ba+y);
}else{this.__oD=document.createElement(z);
}this.__oD.src=I;
this.__oD.id=this.__oD.name=ba;
this.__oD.onload=qx.lang.Function.bind(this._onload,this);
this.__oD.style.display=q;
document.body.appendChild(this.__oD);
this.__oE=document.createElement(F);
this.__oE.target=ba;
this.__oE.id=this.__oE.name=bb;
this.__oE.style.display=q;
document.body.appendChild(this.__oE);
this.__oF=document.createElement(r);
this.__oF.id=this.__oF.name=K;
...
},_numericMap:{"uninitialized":1,"loading":2,"loaded":2,"interactive":3,"complete":4}},members:{__oF:null,__oG:0,__oE:null,__oD:null,send:function(){var g=this.getMethod();
var j=this.getUrl();
...
if(k instanceof Array){for(var i=0;i<k.length;i++){m.push(encodeURIComponent(h)+x+encodeURIComponent(k[i]));
}}else{m.push(encodeURIComponent(h)+x+encodeURIComponent(k));
}}
if(m.length>0){j+=(j.indexOf(P)>=0?w:P)+m.join(w);
...
if(m.length>0){this.setData(m.join(w));
}}var f=this.getFormFields();

for(var h in f){var l=document.createElement(r);
l.name=h;
l.appendChild(document.createTextNode(f[h]));
this.__oE.appendChild(l);
}this.__oE.action=j;
this.__oE.method=g;
...
}),_switchReadyState:function(d){switch(this.getState()){case Q:case L:case C:case G:this.warn("Ignore Ready State Change");
return;
}while(this.__oG<d){this.setState(qx.io.remote.Exchange._nativeMap[++this.__oG]);
}},setRequestHeader:function(a,b){},getResponseHeader:function(X){return null;
...
if(!bd.firstChild){return R;
}if(bd.firstChild.tagName&&bd.firstChild.tagName.toLowerCase()==J){return bd.firstChild.innerHTML;
...
return S;
break;
case u:S=this.getIframeHtmlContent();
{};

try{return S&&S.length>0?qx.util.Json.parse(S,false):null;
}catch(bc){return this.error("Could not execute json: ("+S+")",bc);
}case o:S=this.getIframeHtmlContent();
{};

try{return S&&S.length>0?window.eval(S):null;
}catch(W){return this.error("Could not execute javascript: ("+S+")",W);
}case v:S=this.getIframeDocument();
{};
return S;
default:this.warn("No valid responseType specified ("+this.getResponseType()+")!");
return null;
}}},defer:function(T,U,V){qx.io.remote.Exchange.registerType(qx.io.remote.transport.Iframe,O);
},destruct:function(){if(this.__oD){this.__oD.onload=null;
this.__oD.onreadystatechange=null;
if(qx.core.Variant.isSet(s,N)){this.__oD.src=qx.util.ResourceManager.getInstance().toUri(H);
...
var G=++qx.io.remote.transport.Script.__oH;

if(G>=2000000000){qx.io.remote.transport.Script.__oH=G=1;
}this.__oI=null;
this.__oH=G;
},statics:{__oH:0,_instanceRegistry:{},ScriptTransport_PREFIX:g,ScriptTransport_ID_PARAM:c,ScriptTransport_DATA_PARAM:j,handles:{synchronous:false,asynchronous:true,crossDomain:true,fileUpload:false,programaticFormFields:false,responseTypes:[n,m,p]},isSupported:function(){return true;
...
}})},members:{__oJ:0,__oI:null,__oH:null,send:function(){var v=this.getUrl();
v+=(v.indexOf(q)>=0?s:q)+qx.io.remote.transport.Script.ScriptTransport_ID_PARAM+r+this.__oH;
var y=this.getParameters();
var x=[];

for(var u in y){if(u.indexOf(qx.io.remote.transport.Script.ScriptTransport_PREFIX)==0){this.error("Illegal parameter name. The following prefix is used internally by qooxdoo): "+qx.io.remote.transport.Script.ScriptTransport_PREFIX);
}var w=y[u];

if(w instanceof Array){for(var i=0;i<w.length;i++){x.push(encodeURIComponent(u)+r+encodeURIComponent(w[i]));
}}else{x.push(encodeURIComponent(u)+r+encodeURIComponent(w));
}}
if(x.length>0){v+=s+x.join(s);
}var t=this.getData();

if(t!=null){v+=s+qx.io.remote.transport.Script.ScriptTransport_DATA_PARAM+r+encodeURIComponent(t);
}qx.io.remote.transport.Script._instanceRegistry[this.__oH]=this;
this.__oI=document.createElement(d);
this.__oI.charset=f;
this.__oI.src=v;
{};
document.body.appendChild(this.__oI);
},_switchReadyState:function(F){switch(this.getState()){case o:case b:case e:case h:this.warn("Ignore Ready State Change");
return;
}while(this.__oJ<F){this.setState(qx.io.remote.Exchange._nativeMap[++this.__oJ]);
}},setRequestHeader:function(H,I){},getResponseHeader:function(a){return null;
},getResponseHeaders:function(){return {};
},getStatusCode:function(){return 200;
...
default:this.warn("No valid responseType specified ("+this.getResponseType()+")!");
return null;
}}},defer:function(z,A,B){qx.io.remote.Exchange.registerType(qx.io.remote.transport.Script,l);
