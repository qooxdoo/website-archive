...
c.setColumnFlex(1,1);
c.setColumnFlex(2,1);
c.setColumnAlign(0,u,t);
c.setColumnAlign(1,s,t);
c.setColumnAlign(2,k,t);
var f=0;

for(var i=0;i<b.length;i++){var d=b[i];
d.slider.setOrientation(o);
d.value.setWidth(100);
d.value.setTextAlign(s);
...
},_createSliderGroup:function(g){var h={slider:g,minimum:new qx.ui.basic.Label(j+g.getMinimum().toString()),maximum:new qx.ui.basic.Label(q+g.getMaximum().toString()),value:new qx.ui.basic.Label(g.getValue().toString())};
g.addListener(p,function(e){h.value.setValue(g.getValue().toString());
});
return h;
}}});
})();
