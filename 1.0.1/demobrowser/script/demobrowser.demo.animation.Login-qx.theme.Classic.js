...
(function(){var q="top",p="right",o="resize",n="Name",m="__rh",l="Password",k="Login",j="__rf",h="appear",g="__rg",c="demobrowser.demo.animation.Login",f="50%",d="execute",b="30%";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__rf:null,__rg:null,__rh:null,checkInput:function(){this.__rf.start();
},__ri:function(){this.__rf=new qx.fx.effect.combination.Shake(this.__rg.getContainerElement().getDomElement());
},main:function(){arguments.callee.base.call(this);
var s=new qx.ui.layout.Grid(9,5);
s.setColumnAlign(0,p,q);
s.setColumnAlign(2,p,q);
this.__rg=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__rg.setLayout(s);
this.__rg.addListener(o,function(e){var a=this.__rg.getBounds();
this.__rg.set({marginTop:Math.round(-a.height/2),marginLeft:Math.round(-a.width/2)});
},this);
this.getRoot().add(this.__rg,{left:f,top:b});
var r=[n,l];

for(var i=0;i<r.length;i++){this.__rg.add(new qx.ui.basic.Label(r[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var t=new qx.ui.form.TextField();
var u=new qx.ui.form.PasswordField();
this.__rg.add(t.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__rg.add(u.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var v=this.__rh=new qx.ui.form.Button(k);
v.setAllowStretchX(false);
this.__rg.add(v,{row:3,column:1});
v.addListener(d,this.checkInput,this);
this.__rg.addListener(h,this.__ri,this);
}},destruct:function(){this._disposeObjects(g,m,j);
}});
})();
