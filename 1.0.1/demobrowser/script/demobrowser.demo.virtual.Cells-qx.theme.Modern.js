...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.Cells","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.virtual.Cells-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"852f6ffe1eb8"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var V="",U="' ",T="<b>HTML</b>",S="px;",R="Juhu",Q="testImageCell",P="qx.theme",O="</div>",N="<div ",M="testNumberCell",bq="class='",bp="width:",bo="testHtmlCell",bn="testDateCell",bm=">",bl="height:",bk="testStringCell",bj="testBooleanCellCustomImage",bi="demobrowser.demo.virtual.Cells",bh="testBooleanCell",bd="foobar!",be="qx.theme.Modern",bb="icon/32/apps/utilities-notes.png",bc="medium",Y="main",ba="icon/16/emotes/face-sad.png",W="icon/16/apps/internet-feed-reader.png",X="icon/16/emotes/face-smile.png",bf="This is a feed reader!",bg="style='";
qx.Class.define(bi,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var C=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(C);
this.runTest(bk);
this.runTest(M);
this.runTest(bn);
this.runTest(bo);
if(qx.core.Setting.get(P)==be){this.runTest(Q);
this.runTest(bh);
this.runTest(bj);
}this.getRoot().add(this.topContainer,{edge:5});
},runTest:function(m){this.setUp();
this[m]();
},setUp:function(){this.container=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
this.topContainer.add(this.container);
},tearDown:function(){this.container.destroy();
},testStringCell:function(){var bu={value:[R,T,V,null],states:[{},{selected:1}]};
var bt=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(bu,function(bv){var bw=this.__Fs(bt,bv.value,bv.states);
this.container.add(bw);
},this);
},testNumberCell:function(){var a={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var b=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(a,function(br){if(br.format){b.setNumberFormat(br.format);
}else{b.resetNumberFormat();
}var bs=this.__Fs(b,br.value,br.states);
this.container.add(bs);
},this);
},testDateCell:function(){var e={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(bc))],states:[{},{selected:1}]};
var f=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(e,function(k){if(k.format){f.setDateFormat(k.format);
}else{f.resetDateFormat();
}var l=this.__Fs(f,k.value,k.states);
this.container.add(l);
},this);
},testHtmlCell:function(){var v={value:[R,T,V,null],states:[{},{selected:1}]};
var w=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(v,function(i){var j=this.__Fs(w,i.value,i.states);
this.container.add(j);
},this);
},testImageCell:function(){var g={value:[{url:W,tooltip:bf},{url:bb,tooltip:bd},null],states:[{},{selected:1}]};
var h=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(g,function(c){var d=this.__Fs(h,c.value,c.states);
this.container.add(d);
},this);
},testBooleanCell:function(){var t={value:[true,false,null],states:[{},{selected:1}]};
var u=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(t,function(n){var o=this.__Fs(u,n.value,n.states);
this.container.add(o);
},this);
},testBooleanCellCustomImage:function(){var p={value:[true,false,null],states:[{},{selected:1}]};
var q=new qx.ui.virtual.cell.Boolean;
q.setIconFalse(ba);
q.setIconTrue(X);
qx.util.Permutation.permute(p,function(r){var s=this.__Fs(q,r.value,r.states);
this.container.add(s);
},this);
},__Fs:function(D,E,F){var J=100;
var H=30;
var L=new qx.ui.embed.Html().set({width:J,height:H,decorator:F.selected?null:Y});
var G=D.getCellProperties(E,F);
var I=G.insets;
var K=[N,bg,this._getCellSizeStyle(J,H,I[0],I[1]),G.style,U,bq,G.classes,U,G.attributes,bm,G.content,O].join(V);
L.setHtml(K);
return L;
},_getCellSizeStyle:function(x,y,z,A){var B=V;

if(qx.bom.client.Feature.CONTENT_BOX){x-=z;
y-=A;
}B+=bp+x+S;
B+=bl+y+S;
return B;
...
},members:{getCssClasses:function(o,p){return e;
},getAttributes:function(k,l){return h;
},getStyles:function(i,j){return h;
},getInsets:function(c,d){return [0,0];
...
(function(){var r="Integer",q="_applyPadding",p="paddingLeft",o="Color",n="",m="paddingBottom",l="paddingTop",k="paddingRight",j=";",h="-",Q="backgroundColor",P="_applyTextAlign",O="px",N="_applyFont",M="_applyBackgroundColor",L="cell",K="center",J="font",I=":",H="shorthand",y="String",z="_applyAppearance",w="background-color:",x="textAlign",u="qx-cell ",v="left",s="textColor",t="text-align:",A="Font",B="right",D="_applyTextColor",C="justify",F="color:",E=" ",G="qx.ui.virtual.cell.Cell";
qx.Class.define(G,{extend:qx.ui.virtual.cell.Abstract,construct:function(){arguments.callee.base.call(this);
this.__El=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__Em={};
this.__En={};
this.__Eo={};
this.__Ep={};
...
this.initAppearance();
this.__Ev();
},properties:{appearance:{check:y,init:L,apply:z},backgroundColor:{nullable:true,check:o,apply:M,themeable:true},textColor:{nullable:true,check:o,apply:D,themeable:true},textAlign:{check:[v,K,B,C],nullable:true,themeable:true,apply:P},font:{nullable:true,apply:N,check:A,themeable:true},paddingTop:{check:r,init:0,apply:q,themeable:true},paddingRight:{check:r,nullable:true,apply:q,themeable:true},paddingBottom:{check:r,nullable:true,apply:q,themeable:true},paddingLeft:{check:r,nullable:true,apply:q,themeable:true},padding:{group:[l,k,m,p],mode:H,themeable:true}},members:{__Es:null,__Et:null,__Eq:null,__Er:null,__En:null,__Em:null,__Eo:null,__Ep:null,__Eu:false,__El:null,__Ev:function(){var be=qx.util.PropertyUtil;
var bg=qx.lang.Object.fromArray(this._getCssProperties());
this.__Es=[];
var bd=this.constructor;

while(bd){var bf=be.getProperties(bd);

for(var bc in bf){if(!bg[bc]){this.__Es.push(bc);
}}bd=bd.superclass;
}},_getCssProperties:function(){return [Q,s,J,x,l,k,m,p];
},_applyAppearance:function(bu,bv){if(bv){this.__En={};
}},_getValue:function(bq){if(this.__Eu){return qx.util.PropertyUtil.getThemeValue(this,bq);
}else{return qx.util.PropertyUtil.getUserValue(this,bq);
}},_storeStyle:function(bD,bE){var bF;

if(this.__Eu){bF=this.__En;
}else{bF=this.__Em;
}
if(bE===null){delete bF[bD];
}else{bF[bD]=bE;
}},_applyBackgroundColor:function(bh,bi,name){var bh=this._getValue(name);

if(!bh){this._storeStyle(name,null);
}else{this._storeStyle(name,w+qx.theme.manager.Color.getInstance().resolve(bh));
}},_applyTextColor:function(bB,bC,name){var bB=this._getValue(name);

if(!bB){this._storeStyle(name,null);
}else{this._storeStyle(name,F+qx.theme.manager.Color.getInstance().resolve(bB));
}},_applyTextAlign:function(bR,bS,name){var bR=this._getValue(name);

if(!bR){this._storeStyle(name,null);
}else{this._storeStyle(name,t+bR);
}},_applyFont:function(br,bs,name){var br=this._getValue(name);

if(!br){this._storeStyle(name,null);
}else{var bt=qx.theme.manager.Font.getInstance().resolve(br);
this._storeStyle(name,qx.bom.element.Style.compile(bt.getStyles()));
}},_applyPadding:function(bG,bH,name){var bG=this._getValue(name);

if(this.__Eu){var bJ=this.__Ep;
}else{bJ=this.__Eo;
}
if(bG===null){delete bJ[name];
}else{bJ[name]=bG;
}
if(bG===null){this._storeStyle(name,null);
}else{var bI=qx.lang.String.hyphenate(name);
this._storeStyle(name,bI+I+bG+O);
}},getCellProperties:function(R,S){this.__Ew(S);
return {classes:this.getCssClasses(R,S),style:this.getStyles(R,S),attributes:this.getAttributes(R,S),content:this.getContent(R,S),insets:this.getInsets(R,S)};
},getAttributes:function(f,g){return n;
},getContent:function(bK,bL){return bK;
},getCssClasses:function(c,d){var e=this.__El.getCssClass(this.__Et)||n;
return u+e;
},__Ew:function(bx){if(!bx){bx={};
}var bz=this.getAppearance();
var by=bz+h+qx.lang.Object.getKeys(bx).sort().join(E);

if(this.__Et==by){return;
}this.__Et=by;
var bA=this.__Eq[this.__Et];

if(!bA){this.__Ex();
this.__Ey(bx);
this.__Ez(bx);
this.__EA();
var bA=qx.lang.Object.clone(this.__En);
this.__Eq[this.__Et]=1;
}this.__EB();
},__Ex:function(){var bT=qx.util.PropertyUtil;
var bU=this._getCssProperties();

for(var i=0;i<bU.length;i++){bT.deleteThemeValue(this,bU[i]);
}},__Ey:function(W){this.__En={};
this.__Eu=true;
var ba=this.getAppearance();
var Y=qx.util.PropertyUtil;
var X=qx.theme.manager.Appearance.getInstance().styleFrom(ba,W);

for(var bb in X){if(X[bb]!==undefined){Y.setThemed(this,bb,X[bb]);
}}this.__Eu=false;
},__Ez:function(){var bw=qx.lang.Object.getValues(this.__En).join(j);
this.__El.computeClassForStyles(this.__Et,bw);
},__EA:function(){var bQ=this.__Es;
var bM=qx.util.PropertyUtil;
var bO={};

for(var i=0;i<bQ.length;i++){var bP=bQ[i];
var bN=bM.getThemeValue(this,bP);

if(bN!==undefined){bO[bP]=bN;
}}this.__Er[this.__Et]=bO;
},__EB:function(){var U=qx.util.PropertyUtil;
var T=this.__Er[this.__Et]||{};

for(var V in T){U.setThemed(this,V,T[V]);
}},getStyles:function(a,b){return qx.lang.Object.getValues(this.__Em).join(j);
},getInsets:function(bj,bk){var bo=this.__Eo;
var bn=this.__Ep;
var top=(bo.paddingTop!==undefined?bo.paddingTop:bn.paddingTop)||0;
var bl=(bo.paddingRight!==undefined?bo.paddingRight:bn.paddingRight)||0;
var bm=(bo.paddingBottom!==undefined?bo.paddingBottom:bn.paddingBottom)||0;
var bp=(bo.paddingLeft!==undefined?bo.paddingLeft:bn.paddingLeft)||0;
return [bp+bl,top+bm];
}},destruct:function(){this.__El=this.__Em=this.__En=this.__Eo=this.__Ep=this.__Eq=this.__Er=this.__Es=null;
}});
})();
...
(function(){var o=".qx-cell {",n="mshtml",m="qx.ui.virtual.cell.CellStylesheet",l="none",k="default",j="ellipsis",i="}",h="hidden",g="} ",f=".",c="qx.client",e="content-box",d="singleton",b="absolute";
qx.Class.define(m,{extend:qx.core.Object,type:d,construct:function(){arguments.callee.base.call(this);
var a=o+
qx.bom.element.Style.compile({position:b,overflow:h,cursor:k,textOverflow:j,userSelect:l})+g;

if(!qx.core.Variant.isSet(c,n)){a+=o+qx.bom.element.BoxSizing.compile(e)+i;
}this.__EC=qx.bom.Stylesheet.createElement(a);
this.__ED={};
this.__EE={};
},members:{__EC:null,__ED:null,__EE:null,getStylesheet:function(){return this.__EC;
},getCssClass:function(p){return this.__ED[p]||null;
},computeClassForStyles:function(q,r){var s=this.__EE[r];

if(!s){var s=this.__EF();
qx.bom.Stylesheet.addRule(this.__EC,f+s,r);
this.__EE[r]=s;
}this.__ED[q]=s;
return s;
},__EF:function(){return "qx-cell-"+this.toHashCode()+"-"+(this.__EG++);
},__EG:0},destruct:function(){this.__EC=this.__ED=this.__EE=null;
}});
})();
(function(){var q="$$theme_",p="$$user_",o="$$init_",n="qx.util.PropertyUtil";
qx.Class.define(n,{statics:{getProperties:function(z){return z.$$properties;
...
},setUserValue:function(k,l,m){k[p+l]=m;
},deleteUserValue:function(a,b){delete (a[p+b]);
},getInitValue:function(G,H){return G[o+H];
},setInitValue:function(h,i,j){h[o+i]=j;
},deleteInitValue:function(v,w){delete (v[o+w]);
},getThemeValue:function(r,s){return r[q+s];
},setThemeValue:function(A,B,C){A[q+B]=C;
},deleteThemeValue:function(x,y){delete (x[q+y]);
},setThemed:function(I,J,K){var L=qx.core.Property.$$method.setThemed;
I[L[J]](K);
},resetThemed:function(D,E){var F=qx.core.Property.$$method.resetThemed;
D[F[E]]();
}}});
})();
...
(function(){var e="qx.ui.virtual.cell.Number",d="qx.util.format.NumberFormat",c="",b="cell-number";
qx.Class.define(e,{extend:qx.ui.virtual.cell.Cell,construct:function(a){arguments.callee.base.call(this);

if(a){this.setNumberFormat(a);
}},properties:{numberFormat:{check:d,init:qx.util.format.NumberFormat.getInstance()},appearance:{refine:true,init:b}},members:{getContent:function(f,g){return f!==null?this.getNumberFormat().format(f):c;
}}});
})();
...
(function(){var e="qx.util.format.DateFormat",d="cell-date",c="",b="qx.ui.virtual.cell.Date";
qx.Class.define(b,{extend:qx.ui.virtual.cell.Cell,construct:function(a){arguments.callee.base.call(this);

if(a){this.setDateFormat(a);
}else{this.initDateFormat(qx.util.format.DateFormat.getDateTimeInstance());
}},properties:{appearance:{refine:true,init:d},dateFormat:{check:e,deferredInit:true}},members:{getContent:function(f,g){return f?this.getDateFormat().format(f):c;
}}});
})();
...
(function(){var v="",u="px",t='" ',s="no-repeat",r='"',q='" style="',p='title="',o='<div style="',n='></div>',m="qx.ui.virtual.cell.AbstractImage",g='/>',l="img",j="inline-block",f="static",e="top",i='<img src="',h="abstract",k="string",d="-moz-inline-box";
qx.Class.define(m,{extend:qx.ui.virtual.cell.Cell,type:h,construct:function(){arguments.callee.base.call(this);
this._aliasManager=qx.util.AliasManager.getInstance();
},members:{__Ft:16,__Fu:16,_aliasManager:null,__Fv:function(G){var J=qx.util.ResourceManager.getInstance();
var I=qx.io.ImageLoader;
var H,K;
if(J.has(G)){H=J.getImageWidth(G),K=J.getImageHeight(G);
}else if(I.isLoaded(G)){H=I.getWidth(G);
K=I.getHeight(G);
}else{H=this.__Ft;
K=this.__Fu;
}return {width:H,height:K};
},__Fw:function(a){if(typeof (a)==k){a={url:a};
...
},getContent:function(x,y){if(x===null){return v;
}var content=v;
var A=this.__Fw(this._identifyImage(x));
var E=qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9;
var B=A.tooltip?p+A.tooltip+r:v;
var z={width:A.width+u,height:A.height+u,display:E?d:j,verticalAlign:e,position:f};
var C=qx.bom.element.Decoration.getTagName(s,A.url);
var D=qx.bom.element.Decoration.getAttributes(A.url,s,z);
var F=qx.bom.element.Style.compile(D.style);

if(C===l){content=i+D.src+q+F+t;
content+=B+g;
}else{content=o+F+t;
content+=B+n;
}return content;
...
this.__Fx=qx.util.AliasManager.getInstance();
},properties:{appearance:{refine:true,init:b},iconTrue:{check:f,themeable:true,apply:c},iconFalse:{check:f,themeable:true,apply:e}},members:{__Fy:null,__Fz:null,__Fx:null,_applyIconTrue:function(a){this.__Fy=this.__Fx.resolve(a);
},_applyIconFalse:function(h){this.__Fz=this.__Fx.resolve(h);
},_identifyImage:function(g){return g==true?this.__Fy:this.__Fz;
}}});
})();
