...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Blocker","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.bom.Blocker-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"726ac6a83eef"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var s="100px",r="200px",q="absolute",p="300px",o="click",n="button",m="Block Document for 5s",l="demobrowser.demo.bom.Blocker",k="red",j="Block Element for 5s",g="320px",i="div",h="orange",f="150px";
qx.Class.define(l,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var b=qx.bom.Input.create(n,{value:m});
qx.bom.element.Style.setStyles(b,{position:q,left:s,top:s,width:r});
var d=new qx.bom.Blocker;
d.setBlockerOpacity(0.5);
qx.event.Registration.addListener(b,o,function(e){d.setBlockerColor(k);
d.block();
qx.event.Timer.once(function(e){d.unblock();
},window,5000);
});
qx.dom.Element.insertEnd(b,document.body);
var a=qx.bom.Input.create(n,{value:j});
qx.bom.element.Style.setStyles(a,{position:q,left:g,top:s,width:r});
var c=qx.bom.Element.create(i);
qx.bom.element.Style.setStyles(c,{position:q,left:p,top:f,width:p,height:r,backgroundColor:h,zIndex:500});
qx.dom.Element.insertBegin(c,document.body);
qx.event.Registration.addListener(a,o,function(e){d.block(c);
qx.event.Timer.once(function(e){d.unblock();
},window,5000);
});
qx.dom.Element.insertEnd(a,document.body);
}}});
})();
...
(function(){var D="px",C="mshtml",B="qx.client",A="0px",z="backgroundColor",y="block",x="zIndex",w="resize",v="repeat",u="transparent",o="url(",t="src",r=")",n="allowTransparency",m="div",q="javascript:false;",p="qx/static/blank.gif",s="qx.bom.Blocker",l="absolute";
qx.Class.define(s,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__rD();
},members:{__rw:null,__rx:null,__ry:null,__rz:false,__rA:10000,__rB:0,__rC:u,block:function(c){if(!this.__rz){this.__ry=c;
var d=this.__rG();
this.__rH(d);
this.__rz=true;
}},unblock:function(){if(this.__rz){this.__rI();
this.__rz=false;
}},isBlocked:function(){return this.__rz;
},getBlockerElement:function(){return this.__rx;
},setBlockerColor:function(g){qx.bom.element.Style.set(this.__rx,z,g);
},getBlockerColor:function(){return qx.bom.element.Style.get(this.__rx,z);
},setBlockerOpacity:function(b){qx.bom.element.Opacity.set(this.__rx,b);
},getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__rx);
},setBlockerZIndex:function(h){qx.bom.element.Style.set(this.__rx,x,h);
},getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__rx,x);
},__rD:function(){this.__rE();

if(qx.core.Variant.isSet(B,C)){this.__rF();
}qx.event.Registration.addListener(window,w,this.__rJ,this);
},__rE:function(){this.__rx=qx.bom.Element.create(m);
qx.bom.element.Style.setStyles(this.__rx,{display:y,opacity:this.__rB,backgroundColor:this.__rC});
this.setBlockerZIndex(this.__rA);
if(qx.core.Variant.isSet(B,C)){qx.bom.element.Style.setStyles(this.__rx,{backgroundImage:o+qx.util.ResourceManager.getInstance().toUri(p)+r,backgroundRepeat:v});
}},__rF:function(){this.__rw=qx.bom.Iframe.create();
qx.bom.element.Attribute.set(this.__rw,n,false);
qx.bom.element.Attribute.set(this.__rw,t,q);
qx.bom.element.Style.setStyles(this.__rw,{display:y,opacity:this.__rB});
},__rG:function(){var k={position:l};

if(this.__rL()){k.left=A;
k.top=A;
k.right=null;
k.bottom=null;
k.width=qx.bom.Document.getWidth()+D;
k.height=qx.bom.Document.getHeight()+D;
}else{k.width=qx.bom.element.Dimension.getWidth(this.__ry)+D;
k.height=qx.bom.element.Dimension.getHeight(this.__ry)+D;
k.left=qx.bom.element.Location.getLeft(this.__ry)+D;
k.top=qx.bom.element.Location.getTop(this.__ry)+D;
}return k;
},__rH:function(i){var j=document.body;
qx.bom.element.Style.setStyles(this.__rx,i);
qx.dom.Element.insertEnd(this.__rx,j);

if(qx.core.Variant.isSet(B,C)){i.zIndex=this.getBlockerZIndex()-1;
qx.bom.element.Style.setStyles(this.__rw,i);
qx.dom.Element.insertEnd(this.__rw,document.body);
}},__rI:function(){qx.dom.Element.remove(this.__rx);

if(qx.core.Variant.isSet(B,C)){qx.dom.Element.remove(this.__rw);
}},__rJ:function(e){if(this.__rL()){this.__rK({width:A,height:A});
qx.event.Timer.once(function(){var a={width:qx.bom.Document.getWidth()+D,height:qx.bom.Document.getHeight()+D};
this.__rK(a);
},this,0);
}},__rK:function(f){qx.bom.element.Style.setStyles(this.__rx,f);

if(qx.core.Variant.isSet(B,C)){qx.bom.element.Style.setStyles(this.__rw,f);
}},__rL:function(){return (this.__ry==null||qx.dom.Node.isWindow(this.__ry)||qx.dom.Node.isDocument(this.__ry));
}}});
})();
