...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.table.Table_Window_Editor","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.table.Table_Window_Editor-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"cd1888a09ed3"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var p="execute",o="A boolean",n="A number",m="Table with window cell editor",l="A date",k="Enter",j="1*",i="50%",h="demobrowser.demo.table.Table_Window_Editor",g="appear",c="demobrowser.demo.table.ModalCellEditorFactory",f="Cell Editor",d="ID",b="Save";
qx.Class.define(h,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return m;
},createTable:function(){var u=this.createRandomRows(50);
var s=new qx.ui.table.model.Simple();
s.setColumns([d,n,l,o]);
s.setData(u);
...
var q=t.getBehavior();
q.set(0,{width:j,minWidth:40,maxWidth:80});
q.setWidth(1,i);
q.setMinWidth(1,100);
q.setMaxWidth(1,320);
q.set(3,{width:100});
...
qx.Class.define(c,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,members:{createCellEditor:function(w){var z=new qx.ui.window.Window(f);
z.setLayout(new qx.ui.layout.HBox(4));
z.set({padding:3,modal:true,showClose:false,showMaximize:false,showMinimize:false});
z.moveTo(300,250);
z.addListener(g,function(e){z.__AD.focus();
z.__AD.setTextSelection(0,z.__AD.getValue().length);
});
z.__AD=new qx.ui.form.TextField(w.value+"").set({allowGrowY:true});
z.add(z.__AD);
var x=new qx.ui.form.Button(b);
x.addListener(p,function(e){z.close();
});
z.add(x);
var y=new qx.ui.core.Command(k);
y.addListener(p,function(e){x.execute();
y.dispose();
y=null;
});
return z;
},getCellEditorValue:function(a){return parseFloat(a.__AD.getValue());
}}});
})();
