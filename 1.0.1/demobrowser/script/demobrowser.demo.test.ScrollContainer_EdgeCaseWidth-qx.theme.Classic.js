...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.ScrollContainer_EdgeCaseWidth","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.ScrollContainer_EdgeCaseWidth-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"bb9bd74e135f"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var A="value",z="changeSelection",y="execute",x="ScrollbarX:",w="ScrollbarY:",v="Toggle content",u="blue",t="black",s="auto",r="Off",l="white",q="demobrowser.demo.test.ScrollContainer_EdgeCaseWidth",o="off",k="On",j="Content size: 300x300",n="Toggle pane",m="solid",p="Auto",i="on";
...
C.set({width:300,height:200});
this.getRoot().add(C,{left:10,top:10});
C.add(this.generateBox());
var E=new qx.ui.form.Button(n);
var H=true;
E.addListener(y,function(){C.setHeight(H?300:200);
H=!H;
});
this.getRoot().add(E,{left:330,top:20});
var D=new qx.ui.form.Button(v);
var G=true;
D.addListener(y,function(){C.getChildren()[0].setHeight(G?100:300);
G=!G;
});
this.getRoot().add(D,{left:430,top:20});
var F=this.generateScrollbarConfig(x,100);
var B=this.generateScrollbarConfig(w,120);
F.addListener(z,function(e){C.setScrollbarX(e.getData()[0].getUserData(A));
});
B.addListener(z,function(e){C.setScrollbarY(e.getData()[0].getUserData(A));
});
},generateScrollbarConfig:function(a,top){var f=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));
var a=new qx.ui.basic.Label(a);
a.setMarginRight(20);
var b=new qx.ui.form.RadioButton(p);
var d=new qx.ui.form.RadioButton(k);
var c=new qx.ui.form.RadioButton(r);
b.setUserData(A,s);
d.setUserData(A,i);
c.setUserData(A,o);
b.setValue(true);
var g=new qx.ui.form.RadioGroup(b,d,c);
f.add(a);
f.add(b);
f.add(d);
f.add(c);
...
return g;
},generateBox:function(){var h=new qx.ui.basic.Label(j).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:u,textColor:l,padding:10,decorator:new qx.ui.decoration.Single(4,m,t)});
return h;
},__yV:null}});
})();
