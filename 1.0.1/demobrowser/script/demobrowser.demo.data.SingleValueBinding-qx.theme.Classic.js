...
(function(){var F="value",E="<b>Description</b><br/>",D="",C="changeValue",B="execute",A="Change me...",z="demobrowser.demo.data.SingleValueBinding",y="Reverse",x="Binding a number value (slider value) to a labels string (content).",w="child.names[last]",bk="child.names[0]",bj="First:",bi="Bigger than 50!",bh="of names.<br/>The reverse button reverses the current selected child ",bg=" The default conversion will handle the type conversion.",bf="Binding an data event, containing the change of the textfield to",be="Last:",bd="Binding the textfield to a property with a validation. The validator",bc=" in the object only accepts numbers. On a validation fail, a red ",bb=" the label.",M="No number!",N="With validation",K="10",L="containing ['Bart', 'Lisa'] as names.",I=" above or below 50.",J="Bart",G="number",H="Toggle child",O="from a node containing ['Homer', 'Marge'] as names to a node ",P="Binding of node elements containing a node as child and an array ",S="With own conversion",R="names array.<br/>Toggle child will change the child of the root node ",U="with a self written converter to a string only saying it its ",T="Event binding",W="Array binding",V="Lower than 50!",Q="Lisa",ba="Binding a slider value to a labels text but conversion the number ",Y="With default conversion",X=" border will surround the textfield.";
qx.Class.define(z,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
this.getRoot().add(new qx.ui.basic.Label(T),{top:10,left:10});
var o=new qx.ui.form.TextField(A);
o.setLiveUpdate(true);
this.getRoot().add(o,{top:30,left:10});
var i=new qx.ui.basic.Label(A);
this.getRoot().add(i,{top:32,left:120});
o.bind(C,i,F);
this.getRoot().add(new qx.ui.basic.Label(Y),{top:60,left:10});
var n=new qx.ui.form.Slider();
n.setWidth(100);
this.getRoot().add(n,{top:80,left:10});
var c=new qx.ui.basic.Label(D);
this.getRoot().add(c,{top:80,left:120});
n.bind(F,c,F);
this.getRoot().add(new qx.ui.basic.Label(S),{top:110,left:10});
var f=new qx.ui.form.Slider();
f.setWidth(100);
this.getRoot().add(f,{top:130,left:10});
var t=new qx.ui.basic.Label(D);
this.getRoot().add(t,{top:130,left:120});
var j={converter:function(bl){if(bl<50){return V;
}else{return bi;
}}};
f.bind(F,t,F,j);
this.getRoot().add(new qx.ui.basic.Label(W),{top:180,left:10});
var m=new demobrowser.demo.data.model.Node();
var p=new demobrowser.demo.data.model.Node();
var s=new demobrowser.demo.data.model.Node();
s.setNames(new qx.data.Array(J,Q));
m.setChild(p);
var v=new qx.ui.form.Button(y);
this.getRoot().add(v,{top:200,left:10});
v.addListener(B,function(){m.getChild().getNames().reverse();
},this);
var r=new qx.ui.form.Button(H);
this.getRoot().add(r,{top:200,left:80});
r.addListener(B,function(){if(m.getChild()==p){m.setChild(s);
}else{m.setChild(p);
}},this);
this.getRoot().add(new qx.ui.basic.Label(bj),{left:10,top:235});
this.getRoot().add(new qx.ui.basic.Label(be),{left:60,top:235});
var u=new qx.ui.basic.Label();
this.getRoot().add(u,{top:250,left:10});
var l=new qx.ui.basic.Label();
this.getRoot().add(l,{top:250,left:60});
m.bind(bk,u,F);
m.bind(w,l,F);
this.getRoot().add(new qx.ui.basic.Label(N),{top:310,left:10});
var a=new qx.ui.form.TextField(K);
a.setLiveUpdate(true);
this.getRoot().add(a,{top:330,left:10});
var k=new qx.ui.basic.Label(D);
this.getRoot().add(k,{top:332,left:120});
var j={onUpdate:function(){k.setValue(D);
a.setValid(true);
},onSetFail:function(e){k.setValue(M);
a.setValid(false);
}};
a.bind(C,m,G,j);
...
d.setWidth(350);
d.setValue(E+bf+bb);
this.getRoot().add(d,{left:250,top:10});
var h=new qx.ui.basic.Label();
h.setRich(true);
h.setWidth(350);
h.setValue(E+x+bg);
this.getRoot().add(h,{left:250,top:60});
var b=new qx.ui.basic.Label();
b.setRich(true);
b.setWidth(350);
b.setValue(E+ba+U+I);
this.getRoot().add(b,{left:250,top:110});
var q=new qx.ui.basic.Label();
q.setRich(true);
q.setWidth(350);
q.setValue(E+P+bh+R+O+L);
this.getRoot().add(q,{left:250,top:180});
var g=new qx.ui.basic.Label();
g.setRich(true);
g.setWidth(350);
g.setValue(E+bd+bc+X);
this.getRoot().add(g,{left:250,top:310});
}}});
})();
