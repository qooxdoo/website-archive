...
(function(){var t="value",s="demobrowser.demo.data.Form",r="female",q="Registration",p="male",o="Send",n="gender",m="Ok:",l="selection",k="-please select-",e="execute",j="ok",h="left",d="Name:",c="middle",g="x",f="Gender:",i="name";
qx.Class.define(s,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var H=new qx.ui.groupbox.GroupBox(q);
H.setWidth(200);
this.getRoot().add(H,{left:10,top:10});
var E=new qx.ui.layout.Grid();
E.setSpacing(5);
E.setColumnAlign(0,h,c);
H.setLayout(E);
var u=new qx.ui.basic.Label(d);
...
var G=new qx.ui.form.ListItem(k);
F.add(G);
var C=new qx.ui.form.ListItem(p);
F.add(C);
var A=new qx.ui.form.ListItem(r);
F.add(A);
H.add(F,{row:1,column:1});
var M=new qx.ui.basic.Label(m);
...
var w={name:null,gender:null,ok:0,hidden:g};
var I=qx.data.marshal.Json.createModel(w);
var z=new qx.data.controller.Object(I);
z.addTarget(x,t,i,true);
z.addTarget(F,l,n,true);
var v={converter:function(P){return P===1;
}};
var y={converter:function(N){return N?1:0;
}};
z.addTarget(J,t,j,true,v,y);
x.setRequired(true);
J.setRequired(true);
var L=new qx.ui.form.validation.Manager();
L.add(x,qx.util.Validate.required);
L.add(J);
L.setValidator(function(a){var b=F.getSelection()[0]!==G;
F.setValid(b);
return b;
});
var D=function(O){if(O instanceof qx.ui.form.ListItem){return O.getLabel();
}};
B.addListener(e,function(){if(L.validate()){alert("You are sending: "+qx.util.Serializer.toUriParameter(I,D));
}},this);
}}});
})();
