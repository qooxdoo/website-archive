...
(function(){var t="Integer",s="resize",r="_applyCanvasWidth",q="redraw",p="Boolean",o="__Ct",n="_applyCanvasHeight",m="qx.ui.embed.Canvas",l="qx.event.type.Data";
qx.Class.define(m,{extend:qx.ui.core.Widget,construct:function(w,x){arguments.callee.base.call(this);
this.__Ct=new qx.util.DeferredCall(this.__Cu,this);
this.addListener(s,this._onResize,this);

if(w!==undefined){this.setCanvasWidth(w);
}
if(x!==undefined){this.setCanvasHeight(x);
}},events:{"redraw":l},properties:{syncDimension:{check:p,init:false},canvasWidth:{check:t,init:300,apply:r},canvasHeight:{check:t,init:150,apply:n}},members:{__Ct:null,_createContentElement:function(){return new qx.html.Canvas();
},__Cu:function(){var f=this.getContentElement();
var h=f.getHeight();
var d=f.getWidth();
var g=f.getContext2d();
this._draw(d,h,g);
this.fireNonBubblingEvent(q,qx.event.type.Data,[{width:d,height:h,context:g}]);
...
if(this.getSyncDimension()){this.setCanvasHeight(c.height);
this.setCanvasWidth(c.width);
}},getContext2d:function(){return this.getContentElement().getContext2d();
},_draw:function(i,j,k){}},destruct:function(){this._disposeObjects(o);
}});
})();
...
this.__Cv=document.createElement(e);
},members:{__Cv:null,_createDomElement:function(){return this.__Cv;
},getCanvas:function(){return this.__Cv;
},setWidth:function(a){this.__Cv.width=a;
},getWidth:function(){return this.__Cv.width;
},setHeight:function(b){this.__Cv.height=b;
},getHeight:function(){return this.__Cv.height;
},getContext2d:function(){return this.__Cv.getContext(d);
