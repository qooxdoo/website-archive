...
(function(){var l="value",k="horizontal",j="first",h="both",g="Trash",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",H="Windows (C:)",G="Toggle Splitpane Orientation",F="Inbox",E="Desktop",D="_container1",C="execute",B="Presets",A="Network",z="changeSelection",y="Sent",s="/",t="Files",q="_container2",r="vertical",o="Workspace",p="Junk #",m="Data",n="__Cp",u="Show both panes",v="Show second pane",x="demobrowser.demo.widget.SplitPane",w="Edit";
qx.Class.define(x,{extend:qx.application.Standalone,members:{__Cp:null,main:function(){arguments.callee.base.call(this);
var Y=new qx.ui.container.Scroll();
var X=new qx.ui.container.Composite(new qx.ui.layout.Basic());
X.setAllowStretchX(false);
Y.add(X);
var bf=new qx.ui.splitpane.Pane(k).set({width:450,height:300});
this.__Cp=bf;
var bi=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:d});
var bl=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:d});
var bc=this.__Cq();
var bb=new qx.ui.form.Button(G).set({allowGrowX:false,allowGrowY:false});
bb.addListener(C,this._toggle,this);
var bd=new qx.ui.basic.Label(a);
bd.setRich(true);
bi.add(bc);
bl.add(bb);
bl.add(bd);
...
bf.add(bi,0);
bf.add(bl,1);
X.add(bf,{left:20,top:40});
this.getRoot().add(Y,{edge:0});
var ba=new qx.ui.layout.VBox(5);
var bg=new qx.ui.container.Composite(ba);
var bj=new qx.ui.form.RadioButton(c);
var bk=new qx.ui.form.RadioButton(v);
var bh=new qx.ui.form.RadioButton(u);
bj.setUserData(l,j);
bk.setUserData(l,f);
bh.setUserData(l,h);
bh.setValue(true);
...
bg.add(bk);
bg.add(bh);
var be=new qx.ui.form.RadioGroup(bj,bk,bh);
be.addListener(z,this._changeVisiblity,this);
X.add(bg,{left:490,top:42});
bb.focus();
},_toggle:function(){var bm=this.__Cp.getOrientation();
this.__Cp.setOrientation(bm==k?r:k);
},_changeVisiblity:function(e){var bn=e.getData()[0].getUserData(l);

if(bn==h){this._container1.show();
this._container2.show();
}else if(bn==j){this._container1.show();
this._container2.exclude();
}else if(bn==f){this._container1.exclude();
this._container2.show();
}},__Cq:function(){var R=new qx.ui.tree.Tree();
R.setDecorator(null);
var W=new qx.ui.tree.TreeFolder(s);
W.setOpen(true);
R.setRoot(W);
var U=new qx.ui.tree.TreeFolder(E);
U.setOpen(true);
W.add(U);
var M=new qx.ui.tree.TreeFolder(t);
var K=new qx.ui.tree.TreeFolder(o);
var L=new qx.ui.tree.TreeFolder(A);
var J=new qx.ui.tree.TreeFolder(g);
U.add(M,K,L,J);
var S=new qx.ui.tree.TreeFile(H);
var I=new qx.ui.tree.TreeFile(b);
K.add(S,I);
var V=new qx.ui.tree.TreeFolder(F);
var N=new qx.ui.tree.TreeFolder(B);
var Q=new qx.ui.tree.TreeFolder(y);
var P=new qx.ui.tree.TreeFolder(g);

for(var i=0;i<100;i++){P.add(new qx.ui.tree.TreeFile(p+i));
}var T=new qx.ui.tree.TreeFolder(m);
var O=new qx.ui.tree.TreeFolder(w);
V.add(N,Q,P,T,O);
W.add(V);
return R;
}},destruct:function(){this._disposeObjects(n,D,q);
}});
})();
