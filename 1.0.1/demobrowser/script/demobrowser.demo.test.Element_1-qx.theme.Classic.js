...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Element_1-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"c4cf3f8e15e4"},
  boot : "boot",
  bootIsInline : true,
