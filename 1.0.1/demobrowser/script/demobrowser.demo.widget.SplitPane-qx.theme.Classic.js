...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.SplitPane-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"8e354590e029"},
  boot : "boot",
  bootIsInline : true,
