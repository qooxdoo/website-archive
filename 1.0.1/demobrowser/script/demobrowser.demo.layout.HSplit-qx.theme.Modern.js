...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HSplit-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7379f0bc3afa"},
  boot : "boot",
  bootIsInline : true,
...
},addSplitPaneTwoFlexSimple:function(){var u=new qx.ui.splitpane.Pane(s);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(r);
this.getRoot().add(u,{left:20,top:20});
var t=new qx.ui.form.TextArea(q);
t.setDecorator(null);
t.setWrap(true);
u.add(t,1);
var v=new qx.ui.form.TextArea(n);
v.setDecorator(null);
v.setWrap(true);
u.add(v,2);
...
c.setWrap(true);
b.add(c,2);
},addSplitPaneTwoFlexWithOneMax:function(){var M=new qx.ui.splitpane.Pane(s);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(r);
this.getRoot().add(M,{left:20,top:180});
var L=new qx.ui.form.TextArea(q);
L.setDecorator(null);
L.setWrap(true);
M.add(L,1);
var N=new qx.ui.form.TextArea(l);
N.setDecorator(null);
N.setWrap(true);
N.setMaxWidth(100);
M.add(N,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var A=new qx.ui.splitpane.Pane(s);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(r);
this.getRoot().add(A,{left:20,top:260});
...
E.setMaxWidth(100);
D.add(E,2);
},addSplitPaneOneFlexSimple:function(){var e=new qx.ui.splitpane.Pane(s);
e.setWidth(400);
e.setHeight(60);
e.setDecorator(r);
this.getRoot().add(e,{left:500,top:20});
var d=new qx.ui.form.TextArea(m);
d.setDecorator(null);
d.setWrap(true);
e.add(d,0);
...
f.setWrap(true);
e.add(f);
},addSplitPaneOneFlexSimpleWithMax:function(){var x=new qx.ui.splitpane.Pane(s);
x.setWidth(400);
x.setHeight(60);
x.setDecorator(r);
this.getRoot().add(x,{left:500,top:100});
var w=new qx.ui.form.TextArea(m);
w.setDecorator(null);
w.setWrap(true);
x.add(w,0);
var y=new qx.ui.form.TextArea(j);
y.setDecorator(null);
y.setWrap(true);
y.setMaxWidth(200);
x.add(y);
},addSplitPaneOneFlexSimpleWithMin:function(){var J=new qx.ui.splitpane.Pane(s);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(r);
this.getRoot().add(J,{left:500,top:180});
var I=new qx.ui.form.TextArea(i);
I.setDecorator(null);
I.setWrap(true);
I.setMinWidth(350);
J.add(I,0);
var K=new qx.ui.form.TextArea(q);
K.setDecorator(null);
K.setWrap(true);
J.add(K);
},addSplitPaneAuto:function(){var G=new qx.ui.splitpane.Pane(s);
G.setDecorator(r);
this.getRoot().add(G,{left:500,top:340});
var F=new qx.ui.form.TextArea(o);
F.setDecorator(null);
F.setWrap(true);
G.add(F,0);
var H=new qx.ui.form.TextArea(o);
H.setDecorator(null);
H.setWrap(true);
G.add(H);
}}});
