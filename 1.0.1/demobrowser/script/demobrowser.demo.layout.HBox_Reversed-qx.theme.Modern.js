...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.HBox_Reversed","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Reversed-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"64c963acf370"},
  boot : "boot",
  bootIsInline : true,
...
qx.Class.define(c,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
