...
(function(){var y="searchString",x="Bart",w="<b>Search As You Type List</b><br/>",v="Marge",u="Maggy",t="Skinner",s="Moe",r="Smithers",q="Type a name and the list will show only the matching results (case-sensitive).",p="Lisa",l=" ",o="Homer",n="Nelson",k="Flanders",j="changeValue",m="demobrowser.demo.data.SearchAsYouType";
qx.Class.define(m,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var e=[x,p,o,v,s,r,n,k,u,t];
var h=[];

for(var i=0;i<60;i++){h.push(e[i%10]+l+i);
}var g=new qx.data.Array(h);
var f=new qx.ui.form.TextField();
f.setLiveUpdate(true);
this.getRoot().add(f,{top:70,left:10});
var c=new qx.ui.form.List();
this.getRoot().add(c,{left:10,top:100});
var d=new qx.data.controller.List(g,c);
var b=new demobrowser.demo.data.filter.SearchAsYouTypeFilter(d);
d.setDelegate(b);
f.bind(j,b,y);
...
this.__xv=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__xv:null,__xu:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__xv!=null){i.stop(this.__xv);
this.__xv=null;
}this.__xv=i.start(function(){this.__xu.update();
this.__xv=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__xu=null;
}});
})();
