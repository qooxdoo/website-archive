...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.widget.RadioButtonGroup-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"14dc8b7a1363"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var q="female",p="<strong>Grid:</strong>",o="<strong>Vertical:</strong>",n="2,1",m="1,0",l="demobrowser.demo.widget.RadioButtonGroup",k="male",j="Red",h="Green",g="0,1",d="1,1",f="1,2",e="Blue",c="<strong>Horizontal:</strong>";
qx.Class.define(l,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var u=new qx.ui.basic.Label(o);
u.setRich(true);
this.getRoot().add(u,{left:10,top:10});
var r=new qx.ui.form.RadioButtonGroup();
r.setLayout(new qx.ui.layout.VBox(2));
this.addButtons(r,[j,h,e]);
this.getRoot().add(r,{left:100,top:10});
var w=new qx.ui.basic.Label(c);
w.setRich(true);
this.getRoot().add(w,{left:10,top:70});
var t=new qx.ui.form.RadioButtonGroup();
t.setLayout(new qx.ui.layout.HBox(5));
this.addButtons(t,[q,k]);
this.getRoot().add(t,{left:100,top:70});
var s=new qx.ui.basic.Label(p);
s.setRich(true);
this.getRoot().add(s,{left:10,top:100});
var v=new qx.ui.form.RadioButtonGroup();
v.setLayout(new qx.ui.layout.Grid(10,10));
v.add(new qx.ui.form.RadioButton(g),{row:0,column:1});
v.add(new qx.ui.form.RadioButton(m),{row:1,column:0});
v.add(new qx.ui.form.RadioButton(d),{row:1,column:1});
v.add(new qx.ui.form.RadioButton(f),{row:1,column:2});
v.add(new qx.ui.form.RadioButton(n),{row:2,column:1});
this.getRoot().add(v,{left:100,top:100});
},addButtons:function(a,b){for(var i=0;i<b.length;i++){a.add(new qx.ui.form.RadioButton(b[i]));
}}}});
})();
