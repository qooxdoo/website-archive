...
(function(){var bf="",be="Hello",bd="icon/16/actions/go-down.png",bc="World",bb="bold",ba="Juhu",Y="</div>",X="waiting",W="icon/16/actions/go-next.png",V="http://resources.qooxdoo.org/images/logo.gif",bJ="$ ",bI="string",bH="border: 1px dotted green",bG="inactive",bF="decoration",bE="multi<br>line",bD="between",bC="<",bB="<div style='position:absolute;height:20px;width:",bA="px;top:",bm="qx/decoration/Modern",bn="icon/16/actions/go-previous.png",bk="icon",bl="number",bi="px'>",bj="<i>italic</i>",bg="0$",bh="qx/icon/Tango",bo="<b>bold</b>",bp="icon/16/actions/go-up.png",bs="boolean",br="demobrowser.demo.test.Table_CellRenderer",bu="tooltip",bt="red",bw="icon/16/emotes/face-sad.png",bv="icon/16/emotes/face-smile.png",bq="left",bz=">=",by="active",bx="object";
qx.Class.define(br,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){arguments.callee.base.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(bF,bm);
qx.util.AliasManager.getInstance().add(bk,bh);
},__zq:function(bP,top,bQ,bR,bS){var bT=[bB,bQ,bA,top,bi];
bR.createDataCellHtml(bS,bT);
bT.push(Y);
bP.innerHTML+=bT.join(bf);
},testDefaultRenderer:function(n){var o=100;
var q={value:[null,ba,32,new Date()],styleLeft:[0],styleWidth:[o],styleHeight:[20],style:[bf]};
var p=this._getNewTableDiv(o);
var top=0;
qx.util.Permutation.permute(q,function(v){this.__zq(p,top,o,n,v);
top+=20;
},this);
},testBooleanRenderer:function(){var bN=70;
var bM=30;
var bO=new qx.ui.table.cellrenderer.Boolean();
var bK={value:[null,true,false],styleLeft:[0],styleWidth:[bN],styleHeight:[bM],style:[bf]};
var bL=this._getNewTableDiv(bN);
var top=0;
qx.util.Permutation.permute(bK,function(bU){this.__zq(bL,top,bN,bO,bU);
top+=bM;
},this);
bO.setIconFalse(bw);
bO.setIconTrue(bv);
qx.util.Permutation.permute(bK,function(t){this.__zq(bL,top,bN,bO,t);
top+=bM;
},this);
},testDateRenderer:function(){var M=180;
var N=new qx.ui.table.cellrenderer.Date();
var P={value:new Date(),styleLeft:[0],styleWidth:[M],styleHeight:[20],style:[bf]};
var L=qx.util.format.DateFormat;
var O=[L.getDateTimeInstance(),L.getDateInstance()];
var J=this._getNewTableDiv(M);
var top=0;

for(var i=0;i<O.length;i++){var K=O[i];
N.setDateFormat(K);
this.__zq(J,top,M,N,P);
top+=20;
}},testNumberRenderer:function(){var B=new qx.ui.table.cellrenderer.Number();
var A=100;
var D={value:Math.PI,styleLeft:[0],styleWidth:[A],styleHeight:[20],style:[bf]};
var z=qx.util.format.NumberFormat;
var C=[z.getIntegerInstance(),new z().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:bJ})];
var x=this._getNewTableDiv(A);
var top=0;

for(var i=0;i<C.length;i++){var y=C[i];
B.setNumberFormat(y);
this.__zq(x,top,A,B,D);
top+=20;
}},testImageRenderer:function(){var d=new qx.ui.table.cellrenderer.Image();
var b=50;
var e={value:[null,bd,bp,bn,W,V],styleLeft:[0],styleWidth:[b],styleHeight:[20],style:[bf],tooltip:[bf,bu]};
var c=this._getNewTableDiv(b);
var top=0;
qx.util.Permutation.permute(e,function(u){this.__zq(c,top,b,d,u);
top+=20;
},this);
},testStringRenderer:function(){var m=new qx.ui.table.cellrenderer.String();
var l=100;
var k=20;
var h={value:[null,be,bc],styleLeft:[0],styleWidth:[l],styleHeight:[k],style:[bf]};
var j=this._getNewTableDiv(l);
var top=0;
qx.util.Permutation.permute(h,function(f){this.__zq(j,top,l,m,f);
top+=20;
},this);
},testPasswordRenderer:function(){var U=new qx.ui.table.cellrenderer.Password();
var T=100;
var S=20;
var Q={value:[null,be,bc],styleLeft:[0],styleWidth:[T],styleHeight:[S],style:[bf]};
var R=this._getNewTableDiv(T);
var top=0;
qx.util.Permutation.permute(Q,function(g){this.__zq(R,top,T,U,g);
top+=20;
},this);
},testHtmlRenderer:function(){var ci=new qx.ui.table.cellrenderer.Html();
var ch=100;
var cg=50;
var ce={value:[null,bo,bj,bE],styleLeft:[0],styleWidth:[ch],styleHeight:[cg],style:[bf]};
var cf=this._getNewTableDiv(ch);
var top=0;
qx.util.Permutation.permute(ce,function(a){this.__zq(cf,top,ch,ci,a);
top+=20;
},this);
},testConditionalRenderer:function(){var I=new qx.ui.table.cellrenderer.Conditional();
I.addNumericCondition(bC,0,null,bt,null,null);
I.addNumericCondition(bz,100,bq,null,null,null);
I.addBetweenCondition(bD,0,2,null,null,null,bb,null);
I.addRegex(bg,null,null,bb,bH);
var H=100;
var G=20;
var E={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[H],table:[this.tableMock],styleHeight:[G],style:[bf]};
var F=this._getNewTableDiv(H);
var top=0;
qx.util.Permutation.permute(E,function(r){this.__zq(F,top,H,I,r);
top+=20;
},this);
},testDynamicRenderer:function(){var ca=new qx.ui.table.cellrenderer.Dynamic();
ca.setCellRendererFactoryFunction(function(cb){var cd=cb.value;
var cc=qx.ui.table.cellrenderer;

switch(typeof cd){case bI:if(cd.match(/^icon\//)){return new cc.Image();
}else{return new cc.String();
}case bs:return new cc.Boolean();
case bl:return new cc.Number();
case bx:if(cd instanceof Date){return new cc.Date();
}return new cc.Default();
}});
var bY=100;
var bX=20;
var bV={value:[null,ba,new Date(),30,bd,false],styleLeft:[0],styleWidth:[bY],styleHeight:[bX],table:[this.tableMock],style:[bf]};
var bW=this._getNewTableDiv(bY);
var top=0;
qx.util.Permutation.permute(bV,function(s){this.__zq(bW,top,bY,ca,s);
top+=20;
},this);
},testReplaceRenderer:function(){var cn=new qx.ui.table.cellrenderer.Replace();
cn.setReplaceMap({1:by,2:bG,3:X});
cn.addReversedReplaceMap();
var cm=100;
var cl=20;
var cj={value:[1,2,3],styleLeft:[0],styleWidth:[cm],table:[this.tableMock],styleHeight:[cl],style:[bf]};
var ck=this._getNewTableDiv(cm);
var top=0;
qx.util.Permutation.permute(cj,function(w){this.__zq(ck,top,cm,cn,w);
top+=20;
},this);
...
qx.Class.define(n,{extend:qx.ui.table.cellrenderer.Default,construct:function(U,V,W,X){arguments.callee.base.call(this);
...
this.__zA=W||A;
this.__zB=X||A;
},members:{__zy:null,__zz:null,__zA:null,__zB:null,__zC:function(K,L){if(K[1]!=null){L[o]=K[1];
}
if(K[2]!=null){L[m]=K[2];
}
if(K[3]!=null){L[p]=K[3];
...
}},addBetweenCondition:function(B,C,D,E,F,G,H,I){if(qx.lang.Array.contains(this.betweenAllowed,B)){if(C!=null&&D!=null){var J=[B,E,F,G,H,C,D,I];
}}
if(J!=null){this.conditions.push(J);
}else{throw new Error("Condition not recognized or value1/value2 is null!");
}},addRegex:function(Y,ba,bb,bc,bd,be){if(Y!=null){var bf=[v,ba,bb,bc,bd,Y,be];
}
if(bf!=null){this.conditions.push(bf);
}else{throw new Error("regex cannot be null!");
}},_getCellStyle:function(M){if(!this.conditions.length){return M.style||A;
}var R=M.table.getTableModel();
var i;
var T;
var N;
var P={"text-align":this.__zy,"color":this.__zz,"font-style":this.__zA,"font-weight":this.__zB};
...
switch(this.conditions[i][0]){case z:if(N==this.conditions[i][5]){T=true;
}break;
case s:if(N!=this.conditions[i][5]){T=true;
}break;
case y:if(N>this.conditions[i][5]){T=true;
}break;
case w:if(N<this.conditions[i][5]){T=true;
}break;
case t:if(N>=this.conditions[i][5]){T=true;
}break;
case r:if(N<=this.conditions[i][5]){T=true;
}break;
...
switch(this.conditions[i][0]){case x:if(N>=this.conditions[i][5]&&N<=this.conditions[i][6]){T=true;
}break;
case u:if(N<this.conditions[i][5]&&N>this.conditions[i][6]){T=true;
}break;
}}else if(this.conditions[i][0]==v){if(this.conditions[i][6]==null){N=M.value;
}else{N=R.getValueById(this.conditions[i][6],M.row);
}var O=new RegExp(this.conditions[i][5],k);
T=O.test(N);
}if(T==true){this.__zC(this.conditions[i],P);
}}var S=[];

for(var Q in P){if(P[Q]){S.push(Q,j,P[Q],q);
}}return S.join(A);
...
if(f){this.__zE=f;
}this.__zF=qx.util.AliasManager.getInstance();
},members:{__zF:null,__zE:16,__zD:16,_identifyImage:function(c){var d={imageWidth:this.__zD,imageHeight:this.__zE};

if(c.value==a){d.url=null;
}else{d.url=this.__zF.resolve(c.value);
}d.tooltip=c.tooltip;
return d;
