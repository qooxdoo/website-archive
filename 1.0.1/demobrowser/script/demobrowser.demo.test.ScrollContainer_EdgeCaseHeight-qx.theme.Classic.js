...
(function(){var u="value",t="changeSelection",s="execute",r="ScrollbarX:",q="ScrollbarY:",p="Toggle content",o="blue",n="black",m="auto",l="demobrowser.demo.test.ScrollContainer_EdgeCaseHeight",f="Off",k="white",i="off",d="On",c="Content size: 300x300",h="Toggle pane",g="solid",j="Auto",b="on";
...
var B=true;
y.addListener(s,function(){w.setWidth(B?300:200);
B=!B;
});
this.getRoot().add(y,{left:330,top:20});
var x=new qx.ui.form.Button(p);
var A=true;
x.addListener(s,function(){w.getChildren()[0].setWidth(A?100:300);
A=!A;
});
this.getRoot().add(x,{left:430,top:20});
var z=this.generateScrollbarConfig(r,100);
var v=this.generateScrollbarConfig(q,120);
z.addListener(t,function(e){w.setScrollbarX(e.getData()[0].getUserData(u));
});
v.addListener(t,function(e){w.setScrollbarY(e.getData()[0].getUserData(u));
});
...
var E=new qx.ui.form.RadioButton(f);
D.setUserData(u,m);
F.setUserData(u,b);
E.setUserData(u,i);
D.setValue(true);
...
return H;
},generateBox:function(){var a=new qx.ui.basic.Label(c).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:o,textColor:k,padding:10,decorator:new qx.ui.decoration.Single(4,g,n)});
return a;
}}});
})();
