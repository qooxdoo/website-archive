...
(function(){var j="<br>",i="new name: ",h="new gender: ",g="male",f="female",e="new age: ",d="demobrowser.demo.test.Validation",c="<b>Setting the age ",b="property to 27</b><br>",a="- name: Name is validated to a minimum length of two.<br/>",P="<br>old name: ",O=")",N="age:",M="fmale",L="<br><b>Setting the name to 'Hans'</b><br>",K="property to 'female'</b><br>",J="<br><b>Setting the gender ",I="must be longer than one characters. (",H="<b>Testing the gender ",G="<br>old gender: ",q="__xM",r="<br><b>Setting the age ",o="- age: Age is validated to be a number.<br/>",p="<b>Initial property values</b><br>",m="",n="<b>Setting the name to ''</b><br>",k="demobrowser.demo.test.Person",l="property to 'true'</b><br>",s="- gender: Gender is validated to be either male or female.",t="property to 'fmale'</b><br>",y="<font color='red'>GENDER NOT SET</font>",x="gender:",A="<br>old age: ",z="Hans",C="The demo creates an internal class containing three properties:<br/>",B="Validation Error: Name ",v="<font color='red'>AGE NOT SET</font>",F="My name",E="<font color='red'>NAME NOT SET</font>",D="white",u="name:",w="<b>Description</b><br/>";
...
R.setHtml(R.getHtml()+n);
try{Q.setName(m);
R.setHtml(R.getHtml()+i+Q.getName()+j);
}catch(U){R.setHtml(R.getHtml()+E+P+Q.getName()+j);
}R.setHtml(R.getHtml()+r+b);
Q.setAge(27);
R.setHtml(R.getHtml()+e+Q.getAge()+j);
R.setHtml(R.getHtml()+c+l);
try{Q.setAge(true);
R.setHtml(R.getHtml()+e+Q.getAge()+j);
}catch(W){R.setHtml(R.getHtml()+v+A+Q.getAge()+j);
}R.setHtml(R.getHtml()+J+K);
Q.setGender(f);
R.setHtml(R.getHtml()+h+Q.getGender()+j);
R.setHtml(R.getHtml()+H+t);
try{Q.setAge(M);
R.setHtml(R.getHtml()+h+Q.getGender()+j);
}catch(T){R.setHtml(R.getHtml()+y+G+Q.getGender()+j);
}var S=new qx.ui.basic.Label();
S.setRich(true);
S.setWidth(250);
S.setValue(w+C+a+o+s);
this.getRoot().add(S,{left:280,top:10});
}}});
qx.Class.define(k,{extend:qx.core.Object,properties:{name:{init:F,validate:q},age:{init:18,validate:qx.util.Validate.number()},gender:{init:g,validate:qx.util.Validate.inArray([g,f])}},members:{__xM:function(V){if(V.length<2){throw new qx.core.ValidationError(B+I+V+O);
}}}});
})();
