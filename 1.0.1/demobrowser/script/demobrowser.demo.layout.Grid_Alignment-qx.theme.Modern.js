...
(function(){var s="main",r="yellow",q="bottom",p="top",o="left",n="right",m="center",l="middle",k="orange",j="gray",g="green",h="demobrowser.demo.layout.Grid_Alignment";
...
},getNewWidget:function(){var a=new qx.ui.core.Widget().set({decorator:s,backgroundColor:g,allowGrowX:false,allowGrowY:false,height:Math.round((Math.random()*30)+30),width:Math.round((Math.random()*30)+30)});
return a;
},getColumnAlignGrid:function(){var b=new qx.ui.container.Composite().set({decorator:s,backgroundColor:r,allowGrowX:false,allowGrowY:false});
var c=new qx.ui.layout.Grid();
c.setSpacing(3);
c.setColumnAlign(0,o,p);
c.setColumnAlign(1,m,l);
c.setColumnAlign(2,n,q);
b.setLayout(c);

for(var x=0;x<3;x++){for(var y=0;y<6;y++){b.add(this.getNewWidget(),{row:y,column:x});
}}return b;
},getRowAlignGrid:function(){var z=new qx.ui.container.Composite().set({decorator:s,backgroundColor:r,allowGrowX:false,allowGrowY:false});
...
},getCellAlignGrid:function(){var u=new qx.ui.container.Composite().set({decorator:s,backgroundColor:r,allowGrowX:false,allowGrowY:false});
var w=new qx.ui.layout.Grid();
w.setSpacing(3);
u.setLayout(w);

for(var x=0;x<5;x++){w.setColumnAlign(x,m,l);

for(var y=0;y<5;y++){u.add(this.getNewWidget(),{row:y,column:x});
}}var v=w.getCellWidget(0,0);
v.set({alignX:o,alignY:p});
v.set({backgroundColor:k,width:20,height:20});
var v=w.getCellWidget(4,4);
v.set({alignX:n,alignY:q});
v.set({backgroundColor:k,width:20,height:20});
return u;
},getRowColumnAlignGrid:function(){var d=new qx.ui.container.Composite().set({decorator:s,backgroundColor:r,allowGrowX:false,allowGrowY:false});
var f=new qx.ui.layout.Grid();
f.setSpacing(3);
d.setLayout(f);

for(var x=0;x<5;x++){for(var y=0;y<5;y++){d.add(this.getNewWidget(),{row:y,column:x});
}}f.setColumnAlign(2,o,p);
f.setRowAlign(2,n,q);

for(var i=0;i<5;i++){f.getCellWidget(2,i).setBackgroundColor(j);
f.getCellWidget(i,2).setBackgroundColor(j);
}var e=f.getCellWidget(2,2);
e.set({backgroundColor:k,width:20,height:20});
return d;
}}});
})();
