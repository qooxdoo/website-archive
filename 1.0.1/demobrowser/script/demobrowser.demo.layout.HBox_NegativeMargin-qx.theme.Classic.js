...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_NegativeMargin-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"1861299aeb23"},
  boot : "boot",
  bootIsInline : true,
...
H.add(this.getBox6());
H.add(this.getBox7());
},getBox1:function(){var J=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,allowGrowX:false});
...
I.setMarginLeft(-10);
return J;
},getBox2:function(){var w=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,allowGrowX:false});
...
z.setMarginLeft(-10);
return A;
},getBox4:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:500,allowGrowX:false});
...
a.setMarginLeft(-10);
return b;
},getBox5:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:u,backgroundColor:t,height:80,width:500,allowGrowX:false});
