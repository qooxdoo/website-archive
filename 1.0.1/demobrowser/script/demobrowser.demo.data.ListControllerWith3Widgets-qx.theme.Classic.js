...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.data.ListControllerWith3Widgets-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d7ddb9426faf"},
  boot : "boot",
  bootIsInline : true,
