...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.ElementResize","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.event.ElementResize-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"ddf430c66d70"},
  boot : "boot",
  bootIsInline : true,
