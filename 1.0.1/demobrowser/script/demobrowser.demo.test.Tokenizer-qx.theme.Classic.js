...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Tokenizer","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.test.Tokenizer-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"01ab93458139"},
  boot : "boot",
  bootIsInline : true,
...
document.getElementById(e).onclick=function(){var m=qx.dev.Tokenizer.tokenizeJavaScript(n.value);
q.innerHTML=qx.bom.String.escape(qx.util.Json.stringify(m,true));
};
var p=function(){var a=qx.dev.Tokenizer.tokenizeJavaScript(n.value);
var b=[];

for(var i=0;i<a.length;i++){b[i]=a[i].value;
}q.innerHTML=k+qx.bom.String.escape(b.join(h))+l;
};
document.getElementById(j).onclick=p;
var o=function(){q.innerHTML=k+qx.dev.Tokenizer.javaScriptToHtml(n.value)+l;
};
document.getElementById(d).onclick=o;
o();
}}});
})();
