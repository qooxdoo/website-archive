...
(function(){var q="main",p="green",o="yellow",n="click me",m="click",l="center",k="top",j="middle",i="right",h="demobrowser.demo.layout.Grid_Simple";
...
a.add(this.getGrid2());
a.add(this.getGrid3());
},getGrid1:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:q,backgroundColor:o,allowGrowX:false,allowGrowY:false});
b.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:0,column:0});
b.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:0,column:1});
b.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:1,column:0});
b.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:1,column:1});
return b;
},getGrid2:function(){var f=new qx.ui.layout.Grid();
f.setColumnAlign(1,l,k);
f.setColumnAlign(0,i,j);
f.setSpacing(5);
var d=new qx.ui.container.Composite(f).set({decorator:q,backgroundColor:o,allowGrowX:false});
d.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p,width:150}),{row:0,column:0});
var c=new qx.ui.basic.Label(n).set({decorator:q,backgroundColor:p,allowGrowX:false,width:50,height:50});
d.add(c,{row:0,column:1});
d.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p,maxHeight:60,allowGrowX:false}),{row:1,column:0});
d.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p,height:80}),{row:1,column:1});
d.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:2,column:0});
d.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:2,column:1});
var g=10;
c.addListener(m,function(e){c.setWidth(50+g);
g=-g;
});
return d;
},getGrid3:function(){var s=new qx.ui.container.Composite().set({decorator:q,backgroundColor:o,width:400,height:300,allowShrinkX:false,allowShrinkY:false});
var r=new qx.ui.layout.Grid();
r.setColumnFlex(1,2);
r.setRowFlex(1,3);
r.setSpacing(5);
s.setLayout(r);
s.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:0,column:0});
s.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:0,column:1});
s.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:1,column:0});
s.add(new qx.ui.core.Widget().set({decorator:q,backgroundColor:p}),{row:1,column:1});
return s;
}}});
})();
