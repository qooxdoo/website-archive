...
(function(){var q="execute",p="-",o="+",n="/",m="*",l="=",k=".",j="black",i="Del",h="sans-serif",M="C",L="CE",K="7",J="demobrowser.demo.showcase.Calculator",I="5",H="solid",G="icon/22/apps/utilities-calculator.png",F="3",E="0",D="__FV",x="n",y="8",v="6",w="4",t="Calculator",u="2",r="Verdana",s="1",z="demobrowser.demo.showcase.CalculatorLogic",A="__FU",C="+/-",B="9";
qx.Class.define(J,{extend:qx.application.Standalone,members:{__FU:null,__FV:null,main:function(){arguments.callee.base.call(this);
{};
this.__FV=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var O=new qx.ui.window.Window(t,G);
O.setLayout(new qx.ui.layout.VBox(16));
var Q=new qx.ui.decoration.Single(1,H,j);
var Y=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var bj=new qx.ui.layout.Grid(5,5);
Y.setLayout(bj);
this.__FU=new qx.ui.basic.Label(this.__FV.getCurrentValue().toString()).set({decorator:Q,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__FU.setEnabled(false);
var bk=new qx.bom.Font().set({size:14,family:[r,h],bold:true});
var be=new qx.ui.form.Button(E).set({font:bk,minWidth:40});
var bd=new qx.ui.form.Button(s).set({font:bk,minWidth:40});
var bc=new qx.ui.form.Button(u).set({font:bk,minWidth:40});
var bb=new qx.ui.form.Button(F).set({font:bk,minWidth:40});
var bi=new qx.ui.form.Button(w).set({font:bk,minWidth:40});
var bh=new qx.ui.form.Button(I).set({font:bk,minWidth:40});
var bg=new qx.ui.form.Button(v).set({font:bk,minWidth:40});
var bf=new qx.ui.form.Button(K).set({font:bk,minWidth:40});
var bm=new qx.ui.form.Button(y).set({font:bk,minWidth:40});
var bl=new qx.ui.form.Button(B).set({font:bk,minWidth:40});
var N=new qx.ui.form.Button(M).set({font:bk,minWidth:40});
var P=new qx.ui.form.Button(L).set({font:bk,minWidth:40});
var U=new qx.ui.form.Button(i).set({font:bk,minWidth:40});
var T=new qx.ui.form.Button(C).set({font:bk,minWidth:40});
var W=new qx.ui.form.Button(k).set({font:bk,minWidth:40});
var S=new qx.ui.form.Button(o).set({font:bk,minWidth:40});
var ba=new qx.ui.form.Button(p).set({font:bk,minWidth:40});
var X=new qx.ui.form.Button(m).set({font:bk,minWidth:40});
var V=new qx.ui.form.Button(n).set({font:bk,minWidth:40});
var R=new qx.ui.form.Button(l).set({font:bk,minWidth:40});
bj.setColumnFlex(0,1);
bj.setColumnFlex(1,1);
bj.setColumnFlex(2,1);
bj.setColumnFlex(3,1);
bj.setRowFlex(1,1);
bj.setRowFlex(2,1);
bj.setRowFlex(3,1);
bj.setRowFlex(4,1);
bj.setRowFlex(5,1);
bj.setRowFlex(6,1);
Y.add(this.__FU,{row:0,column:0,rowSpan:0,colSpan:4});
Y.add(N,{row:1,column:2,rowSpan:1,colSpan:2});
Y.add(P,{row:1,column:1});
Y.add(U,{row:1,column:0});
Y.add(bf,{row:2,column:0});
Y.add(bm,{row:2,column:1});
Y.add(bl,{row:2,column:2});
Y.add(V,{row:2,column:3});
Y.add(bi,{row:3,column:0});
Y.add(bh,{row:3,column:1});
Y.add(bg,{row:3,column:2});
Y.add(X,{row:3,column:3});
Y.add(bd,{row:4,column:0});
Y.add(bc,{row:4,column:1});
Y.add(bb,{row:4,column:2});
Y.add(ba,{row:4,column:3});
Y.add(be,{row:5,column:0});
Y.add(T,{row:5,column:1});
Y.add(W,{row:5,column:2});
Y.add(S,{row:5,column:3});
Y.add(R,{row:6,column:0,rowSpan:1,colSpan:4});
O.setWidth(260);
O.setMinWidth(260);
O.setHeight(260);
O.open();
...
O.add(Y,{flex:1});
N.addListener(q,function(e){this.__FV.cleanDisplay();
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
P.addListener(q,function(e){this.__FV.clearEntry();

if(this.__FV.getResult()!=null){this.__FU.setValue(this.__FV.getCurrentValue().toString());
}},this);
U.addListener(q,function(e){this.__FV.deleteNumber();
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
T.addListener(q,function(e){this.__FV.setSign();

if(this.__FV.getResult()!=null){this.__FU.setValue(this.__FV.getResult().toString());
}},this);
be.addListener(q,function(e){this.__FV.setCurrentValue(0);
this.__FU.setValue(this.__FV.getCurrentValue().toFixed(this.__FV.getZeroCounter()).toString());
},this);
bd.addListener(q,function(e){this.__FV.setCurrentValue(1);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bc.addListener(q,function(e){this.__FV.setCurrentValue(2);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bb.addListener(q,function(e){this.__FV.setCurrentValue(3);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bi.addListener(q,function(e){this.__FV.setCurrentValue(4);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bh.addListener(q,function(e){this.__FV.setCurrentValue(5);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bg.addListener(q,function(e){this.__FV.setCurrentValue(6);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bf.addListener(q,function(e){this.__FV.setCurrentValue(7);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bm.addListener(q,function(e){this.__FV.setCurrentValue(8);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
bl.addListener(q,function(e){this.__FV.setCurrentValue(9);
this.__FU.setValue(this.__FV.getCurrentValue().toString());
},this);
S.addListener(q,function(e){this.__FV.calculate(o);

if(this.__FV.getResult()!=null){this.__FU.setValue(this.__FV.getResult().toString());
}this.__FV.resetCurrentValue();
},this);
ba.addListener(q,function(e){this.__FV.calculate(p);

if(this.__FV.getResult()!=null){this.__FU.setValue(this.__FV.getResult().toString());
}this.__FV.resetCurrentValue();
},this);
X.addListener(q,function(e){this.__FV.calculate(m);

if(this.__FV.getResult()!=null){this.__FU.setValue(this.__FV.getResult().toString());
}this.__FV.resetCurrentValue();
},this);
V.addListener(q,function(e){this.__FV.calculate(n);

if(this.__FV.getResult()!=null){this.__FU.setValue(this.__FV.getResult().toString());
}this.__FV.resetCurrentValue();
},this);
R.addListener(q,function(e){this.__FV.calculate(l);

if(this.__FV.getResult()!=null){this.__FU.setValue(this.__FV.getResult().toString());
}this.__FV.resetCurrentValue();
},this);
W.addListener(q,function(e){this.__FV.setComma();
},this);
}},destruct:function(){this._disposeObjects(D,A);
}});
qx.Class.define(z,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
},members:{__FW:0,__FX:0,__FY:"n",__Ga:0,__Gb:0,__Gc:0,__Gd:false,__Ge:1,__Gf:0,__Gg:false,__Gh:0,setCurrentValue:function(a){if(this.__Gd){this.__Ge*=10;
this.__FW=this.__FW+(a/this.__Ge);

if(a==0){this.__Gf++;
}}else{this.__Gd=false;

if(this.__FW<0){this.__FW=this.__FW*10-a;
}else{this.__FW=this.__FW*10+a;
}}},getZeroCounter:function(){return this.__Gf;
},setComma:function(){this.__Gd=true;
},getCurrentValue:function(){return this.__FW;
},resetCurrentValue:function(){this.__FW=null;
},cleanDisplay:function(){this.__Gh=0;
this.__Gb=0;
this.__FY="n";
this.__Gf=0;
this.__Ge=1;
...
this.__FX=0;
this.__Gg=false;
},setResult:function(bn){this.__FX=bn;
},getResult:function(){return Math.round(this.__FX*10000000)/10000000;
},setCurrentOperation:function(bo){this.__FY=bo;
},getCurrentOperation:function(){return this.__FY;
},clearEntry:function(){this.__Gg=false;
this.__Gf=0;
this.__Ge=1;
this.__Gd=false;
this.__Gc++;
...
if(this.__Gc<2){this.__Gb=this.__FX;
}
if(this.__Ga>=2){this.__FX=0;
this.__Ga=0;
}},setSign:function(){this.__Gh++;

if(this.__Gh%2==0){this.__Gg=false;
}else{this.__Gg=true;
}
if(this.__FW==null){this.__FW=this.__FX;
}this.__FW=this.__FW*(-1);

if(this.__FX==0){this.__FX=this.__FW;
}
if(this.__FX!=0){this.__Gb=this.__FX;
this.__FX=this.__FW;
}},deleteNumber:function(){var b=false;
var f=false;

if(this.__FW<0){this.__FW=this.__FW*(-1);
f=true;
}
if(this.__FW!=null){if(this.__FW.toString().lastIndexOf(k)!=-1){this.__FW=this.__FW*this.__Ge;
b=true;
}}var c=this.__FW%10;
var d=c/10;
this.__FW=this.__FW/10;
this.__FW=this.__FW-d;

if(b){this.__Ge/=10;
this.__FW=this.__FW/(this.__Ge);
b=false;
}
if(f){this.__FW=this.__FW*(-1);
f=false;
}},calculate:function(g){if(g==o||g==m||g==n||g==p||g==l){this.__Gd=false;
this.__Ge=1;
this.__Gf=0;

if(this.__FY!=x){if(this.__FY==o){if(this.__FX==null){this.__FX=this.__Gb;
}
if(this.__Gg){this.__FX=this.__Gb+this.__FW;
}else{this.__FX=this.__FX+this.__FW;
}this.__FW=this.__FX;
this.__Gb=this.__FX;
}
if(this.__FY==p){if(this.__FX==0){this.__FX=this.__FW;
this.__FW=0;
}
if(this.__FX==null){this.__FX=this.__Gb;
}
if(this.__Gg){this.__FX=this.__Gb-this.__FW;
}else{this.__FX=this.__FX-this.__FW;
}this.__FW=this.__FX;
...
if(this.__FY==n){if(this.__FX==0){this.__FX=this.__FW;
this.__FW=1;
}
if(this.__FX==null){this.__FX=this.__Gb;
}
if(this.__FW!=null){if(this.__FW!=0){if(this.__Gg){this.__FX=this.__Gb/this.__FW;
}else{this.__FX=this.__FX/this.__FW;
}}else{alert("You can't divide by 0!");
}}this.__FW=this.__FX;
this.__Gb=this.__FX;
}
if(this.__FY==m){if(this.__FX==0){this.__FX=1;
}
if(this.__FW==null){this.__FW=1;
}
if(this.__FX==null){this.__FX=this.__Gb;
}
if(this.__Gg){this.__FX=this.__Gb*this.__FW;
