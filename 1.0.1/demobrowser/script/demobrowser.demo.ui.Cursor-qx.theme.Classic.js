...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.Cursor","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.ui.Cursor-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e7347e795037"},
  boot : "boot",
  bootIsInline : true,
...
(function(){var w="nw-resize",v="main",u="#DDD",t="w-resize",s="text",r="#555",q="se-resize",p="crosshair",o="sw-resize",n="n-resize",g="default",m="s-resize",k="pointer",f="help ",e="demobrowser.demo.ui.Cursor",j="move",h="ne-resize",l="e-resize",d="wait";
qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var z=new qx.ui.container.Scroll();
var x=new qx.ui.layout.HBox();
x.setSpacing(10);
var y=new qx.ui.container.Composite(x);
y.setPadding(20);
z.add(y);
this.getRoot().add(z,{edge:0});
y.add(this.getGrid1());
},getGrid1:function(){var b=new qx.ui.container.Composite().set({textColor:u});
var a=new qx.ui.layout.Grid();
a.setSpacing(20);
b.setLayout(a);
var c=[g,p,k,j,n,h,l,q,m,o,t,w,s,d,f];
var i=0;

for(var i=0;i<15;i++){b.add(new qx.ui.basic.Label(c[i]).set({decorator:v,backgroundColor:r,cursor:c[i],padding:5,height:100,width:100}),{row:Math.floor(i/5),column:i%5});
}return b;
}}});
})();
