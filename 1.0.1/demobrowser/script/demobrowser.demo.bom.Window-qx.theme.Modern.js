...
(function(){var m="click",l="button",k="Open Native Window",j="Open Native Modal Window",i="demobrowser.demo.bom.Window",h="Modal Window closed?",g="http://sourceforge.net",f="window1",d="http://slashdot.org",c="Window closed?",a="http://qooxdoo.org",b="window2";
qx.Class.define(i,{extend:qx.application.Native,members:{__rn:null,main:function(){arguments.callee.base.call(this);
this.__rn=[a,g,d];
var p=qx.bom.Input.create(l);
qx.bom.Input.setValue(p,k);
document.body.appendChild(p);
qx.event.Registration.addListener(p,m,function(e){var s={width:400,height:200,top:200,left:100,scrollbars:false,menubar:true,status:false};
this.window1=qx.bom.Window.open(this.__rn[0],f,s);
},this);
var o=qx.bom.Input.create(l);
qx.bom.Input.setValue(o,c);
document.body.appendChild(o);
qx.event.Registration.addListener(o,m,function(e){alert(qx.bom.Window.isClosed(this.window1));
},this);
var n=qx.bom.Input.create(l);
qx.bom.Input.setValue(n,j);
document.body.appendChild(n);
qx.event.Registration.addListener(n,m,function(e){var r={width:400,height:200,top:200,left:100,scrollbars:false};
this.window2=qx.bom.Window.open(this.__rn[1],b,r,true);
},this);
var q=qx.bom.Input.create(l);
qx.bom.Input.setValue(q,h);
document.body.appendChild(q);
qx.event.Registration.addListener(q,m,function(e){alert(qx.bom.Window.isClosed(this.window2));
},this);
...
(function(){var u="resizable",t="=",s="dialogHeight",r="no",q="yes",p="",o="px",n="qx.bom.Window",m="interval",l="dialogWidth",f="dialogLeft",k="javascript:/",i=":",e=";",d="dialogTop",h="qxNativeWindow",g="scrollbars",j="scroll",c=",";
qx.Class.define(n,{statics:{__ro:null,__rp:null,__rq:null,__rr:{"top":d,left:f,width:l,height:s,scrollbars:j,resizable:u},__rs:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__rt:function(){return window.showModalDialog!=null;
},open:function(v,name,w,x){if(v==null){v=k;
}
if(name==null){name=h+new Date().getTime();
}var y=this.__ru(w,x);

if(x){if(this.__rt()){return window.showModalDialog(v,null,y);
}else{if(this.__ro==null){this.__ro=new qx.bom.Blocker;
}this.__ro.block();

if(this.__rq==null){this.__rq=new qx.event.Timer(200);
this.__rq.addListener(m,this.__rv,this);
this.__rq.start();
}else{this.__rq.restart();
}this.__rp=window.open(v,name,y);
return this.__rp;
}}else{return window.open(v,name,y);
}},__ru:function(z,A){var B;
var E;
var C=[];

if(A&&this.__rt()){for(var D in z){if(qx.bom.Window.__rr[D]){var F=p;

if(D!=g&&D!=u){F=o;
}E=qx.bom.Window.__rr[D]+i+z[D]+F;
C.push(E);
}else{qx.log.Logger.warn("Option '"+D+"' is not supported for modal windows.");
}}B=C.join(e);
}else{for(var D in z){if(qx.bom.Window.__rs[D]){if(qx.lang.Type.isBoolean(z[D])){E=D+t+(z[D]?q:r);
}else{E=D+t+z[D];
}C.push(E);
}else{qx.log.Logger.warn("Option '"+D+"' is not supported for native windows.");
}}B=C.join(c);
}return B;
},__rv:function(){if(this.isClosed(this.__rp)){this.__ro.unblock();
this.__rq.stop();
}},close:function(N){if(N){return N.close();
...
}catch(L){qx.log.Logger.error("Cross-Domain Scripting problem: Could not resize window!",L);
}}}}});
})();
