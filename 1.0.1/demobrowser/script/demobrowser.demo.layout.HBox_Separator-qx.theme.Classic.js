...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["demobrowser:demobrowser.demo.layout.HBox_Separator-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"e1ff31e7a2f7"},
  boot : "boot",
  bootIsInline : true,
