...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane.a49eb9162b8a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="slider",b="splitter",c="px",d="Integer",f="height",g="move",h="maxHeight",i="resize",j="pointerup",k="vertical",l="width",m="_applyOrientation",n="_applyOffset",o="splitpane",p="qx.ui.splitpane.Pane",q="pointerdown",r="top",s="minHeight",t="knob",u="horizontal",v="minWidth",w="appear",z="losecapture",A="left",B="pointermove",C="maxWidth",D="pointerout";qx.Class.define(p,{extend:qx.ui.core.Widget,construct:function(E){qx.ui.core.Widget.call(this);this.__gc=[];if(E){this.setOrientation(E);}
else {this.initOrientation();}
;this.__lO.addListener(q,this._onPointerDown,this);this.__lO.addListener(j,this._onPointerUp,this);this.__lO.addListener(B,this._onPointerMove,this);this.__lO.addListener(D,this._onPointerOut,this);this.__lO.addListener(z,this._onPointerUp,this);}
,properties:{appearance:{refine:true,init:o},offset:{check:d,init:6,apply:n},orientation:{init:u,check:[u,k],apply:m}},members:{__pf:null,__pg:false,__ph:null,__pi:null,__pj:null,__pk:null,__pl:null,__gc:null,__lO:null,_createChildControlImpl:function(H,G){var F;switch(H){case a:F=new qx.ui.splitpane.Slider(this);F.exclude();this._add(F,{type:H});break;case b:F=new qx.ui.splitpane.Splitter(this);this._add(F,{type:H});F.addListener(g,this.__pm,this);break;};return F||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,H);}
,__pm:function(e){this.__po(e.getData());}
,__pn:function(K){this.__lO=new qx.ui.splitpane.Blocker(K);this.getContentElement().add(this.__lO);var I=this.getChildControl(b);var J=I.getWidth();if(!J){I.addListenerOnce(w,function(){this.__po();}
,this);}
;I.addListener(i,function(e){var L=e.getData();if(L.height==0||L.width==0){this.__lO.hide();}
else {this.__lO.show();}
;}
,this);}
,getBlocker:function(){return this.__lO;}
,_applyOrientation:function(Q,N){var R=this.getChildControl(a);var M=this.getChildControl(b);this.__pj=Q===u;if(!this.__lO){this.__pn(Q);}
;this.__lO.setOrientation(Q);var P=this._getLayout();if(P){P.dispose();}
...
;this.__lO.setWidth(ba,X);this.__lO.setLeft(ba,bc);}
;}
...
;this.__lO.setHeight(ba,W);this.__lO.setTop(ba,top);}
;}
;}
,add:function(be,bd){if(bd==null){this._add(be);}
else {this._add(be,{flex:bd});}
;this.__gc.push(be);}
,remove:function(bf){this._remove(bf);qx.lang.Array.remove(this.__gc,bf);}
,getChildren:function(){return this.__gc;}
,_onPointerDown:function(e){if(!e.isLeftPressed()){return;}
;var bg=this.getChildControl(b);var bj=bg.getContentLocation();var bh=this.getContentLocation();this.__pf=this.__pj?e.getDocumentLeft()-bj.left+bh.left:e.getDocumentTop()-bj.top+bh.top;var bi=this.getChildControl(a);var bk=bg.getBounds();bi.setUserBounds(bk.left,bk.top,bk.width,bk.height);bi.setZIndex(bg.getZIndex()+1);bi.show();this.__pg=true;this.__lO.capture();e.stop();}
,_onPointerMove:function(e){this._setLastPointerPosition(e.getDocumentLeft(),e.getDocumentTop());if(this.__pg){this.__pp();var bl=this.getChildControl(a);var bm=this.__pk;if(this.__pj){bl.setDomLeft(bm);this.__lO.setStyle(A,(bm-this.getOffset())+c);}
else {bl.setDomTop(bm);this.__lO.setStyle(r,(bm-this.getOffset())+c);}
;e.stop();}
;}
