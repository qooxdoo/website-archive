...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorSelector.86ca326239ab.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__yC=true;this.setRed(cY[0]);this.setGreen(cY[1]);this.__yC=false;this.setBlue(cY[2]);}
,getValue:function(){return this.__pt?null:qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);}
,resetValue:function(){this.__pt=true;this.__yC=true;this.setRed(255);this.setGreen(255);this.__yC=false;this.setBlue(255);}
,__pv:function(){if(!this.__yC){this.__pt=false;this.fireDataEvent(f,this.getValue());}
;}
,_applyRed:function(dc,db){if(this.__yw===null){this.__yw=bU;}
;if(this.__yw!==cK){this.getChildControl(m).setValue(dc);}
;if(this.__yw!==n){this._setHexFromRgb();}
;switch(this.__yw){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yw===bU){this.__yw=null;}
;}
,_applyGreen:function(de,dd){if(this.__yw===null){this.__yw=cq;}
;if(this.__yw!==cK){this.getChildControl(O).setValue(de);}
;if(this.__yw!==n){this._setHexFromRgb();}
;switch(this.__yw){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yw===cq){this.__yw=null;}
;}
,_applyBlue:function(dg,df){if(this.__yw===null){this.__yw=d;}
;if(this.__yw!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__yw!==n){this._setHexFromRgb();}
;switch(this.__yw){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yw===d){this.__yw=null;}
;}
,_applyHue:function(di,dh){if(this.__yw===null){this.__yw=cr;}
;if(this.__yw!==F){this.getChildControl(cu).setValue(di);}
;if(this.__yw!==R){if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomLeft(Math.round(di/1.40625)+this.getChildControl(cc).getPaddingLeft());}
else {this.getChildControl(V).setLayoutProperties({left:Math.round(di/1.40625)});}
;}
;switch(this.__yw){case F:case R:case cr:this._setRgbFromHue();};this._setBrightnessGradiant();if(this.__yw===cr){this.__yw=null;}
;}
,_applySaturation:function(dk,dj){if(this.__yw===null){this.__yw=s;}
;if(this.__yw!==F){this.getChildControl(cx).setValue(dk);}
;if(this.__yw!==R){this._setBrightnessGradiant();if(this.getChildControl(V).getBounds()){this.getChildControl(V).setDomTop(256-Math.round(dk*2.56)+this.getChildControl(cc).getPaddingTop());}
else {this.getChildControl(V).setLayoutProperties({top:256-Math.round(dk*2.56)});}
;}
;switch(this.__yw){case F:case R:case s:this._setRgbFromHue();};if(this.__yw===s){this.__yw=null;}
;}
,_applyBrightness:function(dn,dm){if(this.__yw===null){this.__yw=c;}
;if(this.__yw!==F){this.getChildControl(bT).setValue(dn);}
;if(this.__yw!==P){var dl=256-Math.round(dn*2.56);if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dl+this.getChildControl(cE).getPaddingTop());}
else {this.getChildControl(cM).setLayoutProperties({top:dl});}
;}
;switch(this.__yw){case F:case P:case c:this._setRgbFromHue();};if(this.__yw===c){this.__yw=null;}
;}
,_onBrightnessHandlePointerDown:function(e){this.getChildControl(cM).capture();this.__yy=cM;var dr=this.getChildControl(cf).getContentLocation();var dq=this.getChildControl(cM).getContentLocation();var dp=this.getChildControl(cf).getBounds();this.__yz=dr.top+(e.getDocumentTop()-dq.top)-dp.top;e.stopPropagation();}
,_onBrightnessHandlePointerUp:function(e){this.getChildControl(cM).releaseCapture();this.__yy=null;}
,_onBrightnessHandlePointerMove:function(e){if(this.__yy===cM){this._setBrightnessOnFieldEvent(e);e.stopPropagation();}
;}
,_onBrightnessFieldPointerDown:function(e){var location=this.getChildControl(cf).getContentLocation();var ds=this.getChildControl(cM).getBounds();this.__yz=location.top+(ds.height/2);this._setBrightnessOnFieldEvent(e);this.getChildControl(cM).capture();this.__yy=cM;}
...
,_setBrightnessOnFieldEvent:function(e){var dt=qx.lang.Number.limit(e.getDocumentTop()-this.__yz,0,256);this.__yw=P;if(this.getChildControl(cM).getBounds()){this.getChildControl(cM).setDomTop(dt);}
else {this.getChildControl(cM).setLayoutProperties({top:dt});}
;this.setBrightness(100-Math.round(dt/2.56));this.__yw=null;}
,_onHueSaturationHandlePointerUp:function(e){if(this.__yy){e.stopPropagation();this.getChildControl(V).releaseCapture();this.__yy=null;}
;}
,_onHueSaturationHandlePointerMove:function(e){if(this.__yy===V){this._setHueSaturationOnFieldEvent(e);e.stopPropagation();}
;}
,_onHueSaturationFieldPointerDown:function(e){var location=this.getChildControl(ca).getContentLocation();var du=this.getChildControl(V).getBounds();var dv=this.getChildControl(ca).getBounds();this.__yA=location.top+(du.height/2)-dv.top;this.__yB=location.left+(du.width/2)-dv.left;this._setHueSaturationOnFieldEvent(e);this.getChildControl(V).capture();this.__yy=V;}
...
,_setHueSaturationOnFieldEvent:function(e){var dy=qx.lang.Number.limit(e.getDocumentTop()-this.__yA,0,256);var dx=qx.lang.Number.limit(e.getDocumentLeft()-this.__yB,0,256);this.getChildControl(V).setDomPosition(dx,dy);this.__yw=R;this.setSaturation(100-Math.round(dy/2.56));this.setHue(Math.round(dx*1.40625));this.__yw=null;}
,_setRedFromSpinner:function(){if(this.__yw!==null){return;}
;this.__yw=cK;this.setRed(this.getChildControl(m).getValue());this.__yw=null;}
,_setGreenFromSpinner:function(){if(this.__yw!==null){return;}
;this.__yw=cK;this.setGreen(this.getChildControl(O).getValue());this.__yw=null;}
,_setBlueFromSpinner:function(){if(this.__yw!==null){return;}
;this.__yw=cK;this.setBlue(this.getChildControl(cG).getValue());this.__yw=null;}
,_setHueFromSpinner:function(){if(this.__yw!==null){return;}
;this.__yw=F;this.setHue(this.getChildControl(cu).getValue());this.__yw=null;}
,_setSaturationFromSpinner:function(){if(this.__yw!==null){return;}
;this.__yw=F;this.setSaturation(this.getChildControl(cx).getValue());this.__yw=null;}
,_setBrightnessFromSpinner:function(){if(this.__yw!==null){return;}
;this.__yw=F;this.setBrightness(this.getChildControl(bT).getValue());this.__yw=null;}
,_onHexFieldChange:function(e){if(this.__yw!==null){return;}
;try{var dA=this.getChildControl(cD);var dz=qx.util.ColorUtil.hexStringToRgb(J+dA.getValue());}
catch(dB){return;}
;this.__yw=n;this.setRed(dz[0]);this.setGreen(dz[1]);this.setBlue(dz[2]);this.__yw=null;}
...
,_setHueFromRgb:function(){switch(this.__yw){case F:case R:case P:break;default:var dF=qx.util.ColorUtil.rgbToHsb([this.getRed(),this.getGreen(),this.getBlue()]);this.setHue(dF[0]);this.setSaturation(dF[1]);this.setBrightness(dF[2]);};}
,_setRgbFromHue:function(){switch(this.__yw){case cK:case n:break;default:var dG=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);this.setRed(dG[0]);this.setGreen(dG[1]);this.setBlue(dG[2]);};}
