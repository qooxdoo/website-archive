...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorSelector.12123dc966ec.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,resetValue:function(){this.__pt=true;this.__yR=true;this.setRed(255);this.setGreen(255);this.__yR=false;this.setBlue(255);}
,__pv:function(){if(!this.__yR){this.__pt=false;this.fireDataEvent(f,this.getValue());}
;}
...
;switch(this.__yL){case cK:case n:case bU:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yL===bU){this.__yL=null;}
;}
,_applyGreen:function(de,dd){if(this.__yL===null){this.__yL=cq;}
;if(this.__yL!==cK){this.getChildControl(O).setValue(de);}
;if(this.__yL!==n){this._setHexFromRgb();}
;switch(this.__yL){case cK:case n:case cq:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yL===cq){this.__yL=null;}
;}
,_applyBlue:function(dg,df){if(this.__yL===null){this.__yL=d;}
;if(this.__yL!==cK){this.getChildControl(cG).setValue(dg);}
;if(this.__yL!==n){this._setHexFromRgb();}
;switch(this.__yL){case cK:case n:case d:this._setHueFromRgb();};this._setPreviewFromRgb();this.__pv();if(this.__yL===d){this.__yL=null;}
;}
