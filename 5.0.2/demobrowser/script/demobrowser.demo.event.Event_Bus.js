...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Bus","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bus.13b08c69a265.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(p,n,o){this.__zW=f+p.join(c)+a;this.__zX=o||50;this.__zY=n;this._clearLog();}
,_clearLog:function(){this.__zY.innerHTML=this.__zW+k;this.__Aa=[];}
,_log:function(q){this.__Aa.unshift(q);this.__Aa=this.__Aa.slice(0,this.__zX);var r=[this.__zW];for(var i=0;i<this.__Aa.length;i++ ){r.push(g,this.__Aa[i].join(e),l);}
;r.push(k);this.__zY.innerHTML=r.join(d);this.__zY.scrollTop=0;}
,__zW:null,__zX:null,__zY:null,__Aa:null},destruct:function(){this.__zY=this.__Aa=null;}
});}
)();
...
(function(){var a="logger",b="Callback",c="start",d="_anotherStartCallback",f="",g="loading",h="Dispatch",i="_finishedCallback",j="Message",k="Receiving",l="finished",m="_startCallback",n="Subscribe",o="_anotherFinishedCallback",p="X",q="demobrowser.demo.event.Event_Bus",r="_loadingCallback";qx.Class.define(q,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([n,h,k,j,b],document.getElementById(a),50);var s=qx.event.message.Bus;s.subscribe(c,this._startCallback,this);this._log([p,f,f,c,m]);s.subscribe(c,this._anotherStartCallback,this);this._log([p,f,f,c,d]);s.subscribe(g,this._loadingCallback,this);this._log([p,f,f,g,r]);s.subscribe(l,this._finishedCallback,this);this._log([p,f,f,l,i]);s.subscribe(l,this._anotherFinishedCallback,this);this._log([p,f,f,l,o]);qx.event.Timer.once(function(e){this._log([f,p,f,c,f]);s.getInstance().dispatchByName(c);}
,this,1000);qx.event.Timer.once(function(e){this._log([f,p,f,g,f]);s.getInstance().dispatchByName(g);}
,this,2500);qx.event.Timer.once(function(e){this._log([f,p,f,g,f]);s.getInstance().dispatchByName(g);}
,this,4000);qx.event.Timer.once(function(e){this._log([f,p,f,l,f]);s.getInstance().dispatchByName(l);}
,this,5000);}
,_startCallback:function(e){this._log([f,f,p,c,m]);}
,_anotherStartCallback:function(e){this._log([f,f,p,c,d]);}
,_loadingCallback:function(e){this._log([f,f,p,g,r]);}
,_finishedCallback:function(e){this._log([f,f,p,l,i]);}
,_anotherFinishedCallback:function(e){this._log([f,f,p,l,o]);}
}});}
)();
...
},construct:function(){this.__xB={};}
,members:{__xB:null,getSubscriptions:function(){return this.__xB;}
...
;}
;return false;}
,dispatch:function(L){var G=this.getSubscriptions();var H=L.getName();var I=false;for(var K in G){var J=K.indexOf(c);if(J>-1){if(J===0||K.substr(0,J)===H.substr(0,J)){this.__xC(G[K],L);I=true;}
;}
else {if(K===H){this.__xC(G[H],L);I=true;}
;}
;}
;return I;}
,dispatchByName:function(name,N){var M=new qx.event.message.Message(name,N);return this.dispatch(M);}
,__xC:function(P,O){for(var i=0;i<P.length;i++ ){var R=P[i].subscriber;var Q=P[i].context;if(Q&&Q.isDisposed){if(Q.isDisposed()){P.splice(i,1);i-- ;}
else {R.call(Q,O);}
;}
else {R.call(Q,O);}
;}
