...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ColorPopup.f325046f6d74.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var bn=this._tables[this.__yu].values;var bo=this.__yq[this.__yu];if(!bn){return;}
;var bp=this.getValue();if(!bp){return;}
;var bm=bn.indexOf(bp);if(bm!=-1){qx.lang.Array.removeAt(bn,bm);}
else if(bn.length==this.__yv){bn.shift();}
...
;this.__ys.setRed(bx);this.__ys.setGreen(bw);this.__ys.setBlue(bv);this.__yr.open();}
,_onColorSelectorOk:function(){var by=this.__ys;this.setValue(qx.util.ColorUtil.rgbToRgbString([by.getRed(),by.getGreen(),by.getBlue()]));this.__yr.close();}
,_onColorSelectorCancel:function(){this.__yr.close();}
...
;}
,_tables:{core:{label:qx.locale.Manager.tr(a),values:[n,k,g,J,w,F,U,T,I,o,b,d]},recent:{label:qx.locale.Manager.tr(Q),values:[]}}},destruct:function(){if(this.__yr){this.__yr.destroy();this.__ys.destroy();this.__yt.destroy();}
;this._tables=this.__yq=null;}
});}
)();
