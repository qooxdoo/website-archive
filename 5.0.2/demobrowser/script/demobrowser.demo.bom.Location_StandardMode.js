...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.Location_StandardMode","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Location_StandardMode.bcc4e1f65d96.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="borderBottomWidth",b="list",c='#',d="css.boxmodel",e="px",f="mode",g="borderTopWidth",h="borderLeftWidth",j="a",k="border",m="div",n="moveable",o="tap",p="borderRightWidth",q="demobrowser.demo.bom.Location_StandardMode";qx.Class.define(q,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);var r=document.getElementById(b).getElementsByTagName(j);for(var i=0,l=r.length;i<l;i++ ){qx.event.Registration.addListener(r[i],o,demobrowser.demo.bom.Location_StandardMode.jump);}
;}
...
;function s(y,x){return parseInt(qx.bom.element.Style.get(y,x,qx.bom.element.Style.COMPUTED_MODE,false),10);}
;var u=this.href;var w=u.substr(u.indexOf(c)+1);var t=document.getElementById(w);var location=qx.bom.element.Location.get(t,document.getElementById(f).value);var v=document.getElementById(n);v.style.left=location.left+e;v.style.top=location.top+e;if(qx.core.Environment.get(d)==k){v.style.width=(location.right-location.left)+e;v.style.height=(location.bottom-location.top)+e;}
else {v.style.width=(location.right-location.left-s(v,h)-s(v,p))+e;v.style.height=(location.bottom-location.top-s(v,g)-s(v,a))+e;}
;return false;}
,randomize:function(){var z=document.body.getElementsByTagName(m);for(var i=0,l=z.length;i<l;i++ ){if(z[i].id&&z[i].id!=n){z[i].style.margin=Math.round(Math.random()*10)+e;z[i].style.padding=Math.round(Math.random()*10)+e;z[i].style.borderWidth=Math.round(Math.random()*10)+e;}
;}
;}
}});}
)();
