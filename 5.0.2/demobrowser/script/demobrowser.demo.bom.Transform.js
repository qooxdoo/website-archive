...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.bom.Transform.87f90da64e79.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="preserve-3d",b="perspective30",c="css.transform.3d",d="CSS transforms not supported, sorry!",e="bottom left",f="origin-rt",g="skew",h="scale",i="3dpart",j="perspective100",k="50% 50%",l="bottom right",m="origin-lb",n="45deg",o="25deg",p="perorig-br",q="rotate",r="center",s="visible",t="10deg",u="perspective1000",v="perorig-bl",w="10px",x="20deg",y="150deg",z="perorig-c",A="15deg",B="combo",C="",D="perspective500",E="50px",F="left bottom",G="demobrowser.demo.bom.Transform",H='label',I="origin-c",J="none",K="css.transform",L="translate",M="<br><br>Your browser does not support 3D CSS transforms, sorry!",N="40deg",O="hidden",P="flat",Q="3d",R="right top",S="display";qx.Class.define(G,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(K)==null){document.body.innerHTML=C;var U=document.createElement(H);U.innerHTML=d;document.body.appendChild(U);return;}
;var T=document.getElementById(h);qx.bom.element.Transform.scale(T,0.8);T=document.getElementById(L);qx.bom.element.Transform.translate(T,[w,w]);T=document.getElementById(q);qx.bom.element.Transform.rotate(T,n);T=document.getElementById(g);qx.bom.element.Transform.skew(T,o);T=document.getElementById(B);qx.bom.element.Transform.transform(T,{rotate:o,scale:[1.2,0.6],skew:[x,t]});T=document.getElementById(I);qx.bom.element.Transform.setOrigin(T,k);qx.bom.element.Transform.transform(T,{rotate:A});T=document.getElementById(m);qx.bom.element.Transform.setOrigin(T,F);qx.bom.element.Transform.transform(T,{rotate:A});T=document.getElementById(f);qx.bom.element.Transform.setOrigin(T,R);qx.bom.element.Transform.transform(T,{rotate:A});if(qx.core.Environment.get(c)){T=document.getElementById(P);qx.bom.element.Transform.setStyle(T,P);qx.bom.element.Transform.transform(T,{rotate:[x,N]});qx.bom.element.Transform.transform(T.children[0],{translate:[null,null,E]});T=document.getElementById(Q);qx.bom.element.Transform.setStyle(T,a);qx.bom.element.Transform.transform(T,{rotate:[x,N]});qx.bom.element.Transform.transform(T.children[0],{translate:[null,null,E]});T=document.getElementById(b);qx.bom.element.Transform.setPerspective(T,30);qx.bom.element.Transform.transform(T.children[0],{rotate:[n]});T=document.getElementById(j);qx.bom.element.Transform.setPerspective(T,100);qx.bom.element.Transform.transform(T.children[0],{rotate:[n]});T=document.getElementById(D);qx.bom.element.Transform.setPerspective(T,500);qx.bom.element.Transform.transform(T.children[0],{rotate:[n]});T=document.getElementById(u);qx.bom.element.Transform.setPerspective(T,1000);qx.bom.element.Transform.transform(T.children[0],{rotate:[n]});T=document.getElementById(z);qx.bom.element.Transform.setPerspective(T,100);qx.bom.element.Transform.setPerspectiveOrigin(T,r);qx.bom.element.Transform.transform(T.children[0],{rotate:[n]});T=document.getElementById(v);qx.bom.element.Transform.setPerspective(T,100);qx.bom.element.Transform.setPerspectiveOrigin(T,e);qx.bom.element.Transform.transform(T.children[0],{rotate:[n]});T=document.getElementById(p);qx.bom.element.Transform.setPerspective(T,100);qx.bom.element.Transform.setPerspectiveOrigin(T,l);qx.bom.element.Transform.transform(T.children[0],{rotate:[n]});T=document.getElementById(s);qx.bom.element.Transform.setPerspective(T,50);qx.bom.element.Transform.setBackfaceVisibility(T,true);qx.bom.element.Transform.transform(T,{rotate:[null,y,t]});T=document.getElementById(O);qx.bom.element.Transform.setPerspective(T,100);qx.bom.element.Transform.setBackfaceVisibility(T,false);qx.bom.element.Transform.transform(T,{rotate:[null,y,t]});}
else {document.getElementById(i).style[S]=J;var U=document.createElement(H);U.innerHTML=M;document.body.appendChild(U);}
;}
}});}
)();
