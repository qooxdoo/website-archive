...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.ComboBox.04f4b0352fad.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a=" = ",b="... &gt; (as literal HTML entity)",c="... &gt; (as Richtext)",d="ChangeValue: ",f="bold",g="Wide, long list",h="<u>Underlined Text</u>",j="<b>Bold Text</b>",k="'s Icon",l="'s Item",m="With icons",n="Default",o="changeValue",p="2^ ",q="<i>Italic Text</i>",r="HTML entities: &laquo; &lt; &amp; &gt; &raquo;",s="icon/16/places/folder.png",t="With HTML (rich) text",u="demobrowser.demo.widget.ComboBox";qx.Class.define(u,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);this._createDefaultExample();this._createIconExample();this._createWideExample();this._createHtmlExample();}
,_createDefaultExample:function(){var w=new qx.ui.basic.Label(n);w.setFont(f);this.getRoot().add(w,{left:20,top:20});var v=new qx.ui.form.ComboBox();for(var i=1;i<31;i++ ){var x=new qx.ui.form.ListItem(p+i+a+Math.pow(2,i));v.add(x);}
;v.addListener(o,function(e){this.debug(d+e.getData());}
);this.getRoot().add(v,{left:20,top:40});}
,_createIconExample:function(){var z=new qx.ui.basic.Label(m);z.setFont(f);this.getRoot().add(z,{left:160,top:20});var y=new qx.ui.form.ComboBox();for(var i=1;i<31;i++ ){var A=new qx.ui.form.ListItem(i+k,s);y.add(A);}
;this.getRoot().add(y,{left:160,top:40});}
,_createHtmlExample:function(){var E=new qx.ui.basic.Label(t);E.setFont(f);this.getRoot().add(E,{left:300,top:20});var B=new qx.ui.form.ComboBox().set({width:200});var C=[b,c,j,h,q,r];for(var i=0;i<C.length;i++ ){var D=new qx.ui.form.ListItem(C[i]);if(i>0){D.setRich(true);}
;B.add(D);}
;this.getRoot().add(B,{left:300,top:40});}
,_createWideExample:function(){var G=new qx.ui.basic.Label(g);G.setFont(f);this.getRoot().add(G,{left:20,top:280});var F=new qx.ui.form.ComboBox();F.setWidth(300);for(var i=1;i<101;i++ ){var H=new qx.ui.form.ListItem(i+l);F.add(H);}
