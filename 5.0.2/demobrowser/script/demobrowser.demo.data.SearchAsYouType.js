...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType.f2abb346d458.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="_applySearchString",b="demobrowser.demo.data.filter.SearchAsYouTypeFilter",c="String",d="";qx.Class.define(b,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__wG=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__sc=null;}
,properties:{searchString:{check:c,apply:a,init:d}},members:{__sc:null,__wG:null,_applySearchString:function(h,g){var i=qx.util.TimerManager.getInstance();if(this.__sc!=null){i.stop(this.__sc);this.__sc=null;}
;this.__sc=i.start(function(){this.__wG.update();this.__sc=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__wG=null;}
});}
)();
