...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Tooltip","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
;E.setLabel(F);}
);var D=new qx.ui.form.Button(l);D.setToolTip(E);this.add(D);var C=new qx.ui.form.Button(a);C.setToolTip(E);this.add(C);}
,createIconToolTip:function(){var G=new qx.ui.form.Button(k).set({toolTip:new qx.ui.tooltip.ToolTip(null,v)});this.add(G);}
,createToolTip:function(){var H=new qx.ui.form.Button(g).set({toolTip:new qx.ui.tooltip.ToolTip(d,v)});this.add(H);}
,createShortTimeoutToolTip:function(){var J=new qx.ui.tooltip.ToolTip(j,y);J.setShowTimeout(50);var I=new qx.ui.form.Button(b);this.add(I);I.setToolTip(J);}
,createRichToolTip:function(){var L=new qx.ui.tooltip.ToolTip(t+n+w,y);L.setWidth(200);L.setRich(true);L.setShowTimeout(50);var K=new qx.ui.form.Button(i);this.add(K);K.setToolTip(L);}
,createToolTipText:function(){var M=new qx.ui.form.Button(s).set({toolTipText:x});this.add(M);}
,createToolTipIcon:function(){var N=new qx.ui.form.Button(u).set({toolTipIcon:v});this.add(N);}
,createToolTipTextIcon:function(){var O=new qx.ui.form.Button(f).set({toolTipText:x,toolTipIcon:v});this.add(O);}
