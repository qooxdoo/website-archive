...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.GroupBox.dfb9110b6840.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="demobrowser.demo.widget.GroupBox",b="Expert Settings",c="",d="Show debugging console",e="Enable code completion",f="Default Settings",g="frame",h="Show debugging content",i="icon/16/apps/utilities-text-editor.png",j="legend",k="Custom Settings",l="Option #1",m="Code Assist",n="Advanced Settings";qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var r=new qx.ui.layout.VBox();r.setSpacing(20);var q=new qx.ui.container.Composite(r);q.setPadding(20);this.getRoot().add(q,{left:0,top:0});var x=new qx.ui.groupbox.GroupBox(m,i);q.add(x);x.setLayout(new qx.ui.layout.VBox());x.add(new qx.ui.form.CheckBox(h));x.add(new qx.ui.form.CheckBox(e));x.add(new qx.ui.form.CheckBox(d));var z=new qx.ui.groupbox.CheckGroupBox(b);q.add(z);z.setLayout(new qx.ui.layout.HBox(12));var s=new qx.ui.basic.Label(l);z.add(s);var p=new qx.ui.form.TextField(c);z.add(p);var u=new qx.ui.container.Composite(new qx.ui.layout.VBox());q.add(u);var w=new qx.ui.form.RadioButton(f);w.setMarginLeft(9);u.add(w);var v=new qx.ui.form.RadioButton(k);v.setMarginLeft(9);u.add(v);var y=new qx.ui.groupbox.RadioGroupBox(n);y.getChildControl(j).setMarginTop(0);y.getChildControl(j).setPaddingTop(0);y.getChildControl(g).setMarginTop(14);y.setLayout(new qx.ui.layout.HBox(12));u.add(y);new qx.ui.form.RadioGroup(w,v,y);var t=new qx.ui.basic.Label(l);y.add(t);var o=new qx.ui.form.TextField(c);y.add(o);}
}});}
)();
...
(function(){var a="resize",b="qx.ui.groupbox.RadioGroupBox",c="changeValue",d="legend",f="radio-groupbox",g="qx.event.type.Event",h="execute",i="qx.event.type.Data";qx.Class.define(b,{extend:qx.ui.groupbox.GroupBox,implement:[qx.ui.form.IRadioItem,qx.ui.form.IExecutable,qx.ui.form.IBooleanForm,qx.ui.form.IModel],include:[qx.ui.form.MModelProperty],properties:{appearance:{refine:true,init:f}},events:{"changeValue":i,"execute":g},members:{_createChildControlImpl:function(l,k){var j;switch(l){case d:j=new qx.ui.form.RadioButton();j.setAllowGrowX(true);j.setValue(true);j.addListener(c,this._onRadioChangeValue,this);j.addListener(a,this._repositionFrame,this);j.addListener(h,this._onExecute,this);this._add(j,{left:0,right:0});};return j||qx.ui.groupbox.GroupBox.prototype._createChildControlImpl.call(this,l);}
...
,getCommand:function(){return this.getChildControl(d).getCommand();}
,getGroup:function(){return this.getChildControl(d).getGroup();}
,setGroup:function(q){if(q!=null){q.add(this);}
;return;}
,getValue:function(){return this.getChildControl(d).getValue();}
,setValue:function(r){this.getChildControl(d).setValue(r);}
,resetValue:function(){this.getChildControl(d).resetValue();}
,getLabel:function(){return this.getChildControl(d).getLabel();}
}});}
)();
