...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Animation","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.animation.Animation.a60ea39d8da0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="function",b="getScreenTop",c="getViewportTop",d="getScreenLeft",e="longtap",f="qx.module.event.Tap",g="getViewportLeft",h="tap",j="getDocumentTop",k="getDocumentLeft",m="dbltap";qx.Bootstrap.define(f,{statics:{TYPES:[h,e,m],BIND_METHODS:[g,c,k,j,d,b],getViewportLeft:function(){return this._original.getViewportLeft();}
,getViewportTop:function(){return this._original.getViewportTop();}
,getDocumentLeft:function(){return this._original.getDocumentLeft();}
,getDocumentTop:function(){return this._original.getDocumentTop();}
,getScreenLeft:function(){return this._original.getScreenLeft();}
,getScreenTop:function(){return this._original.getScreenTop();}
,normalize:function(event,o){if(!event){return event;}
;var n=qx.module.event.Tap.BIND_METHODS;for(var i=0,l=n.length;i<l;i++ ){if(typeof event[n[i]]!=a){event[n[i]]=qx.module.event.Tap[n[i]].bind(event);}
;}
;return event;}
},defer:function(p){qxWeb.$registerEventNormalization(qx.module.event.Tap.TYPES,p.normalize);}
});}
)();
...
,getWindow:function(N){return qx.dom.Node.getWindow(qx.module.Traversing.__wW(N));}
...
,getDocument:function(Q){return qx.dom.Node.getDocument(qx.module.Traversing.__wW(Q));}
,getNodeName:function(R){return qx.dom.Node.getName(qx.module.Traversing.__wW(R));}
,getNodeText:function(S){return qx.dom.Node.getText(qx.module.Traversing.__wW(S));}
,isBlockNode:function(T){return qx.dom.Node.isBlockNode(qx.module.Traversing.__wW(T));}
,equalNodes:function(bd,bf){bd=qx.module.Traversing.__wX(bd);bf=qx.module.Traversing.__wX(bf);if(!bd||!bf){return false;}
...
;}
;if(bc){var U=qx.module.Traversing.__wY(bd);var be=qx.module.Traversing.__wY(bf);for(var W in U){if(U[W]!==be[W]){return false;}
;}
;}
...
;}
;return bq;}
,getAncestors:function(bt){return this.__wV(null,bt);}
,getAncestorsUntil:function(bv,bu){return this.__wV(bv,bu);}
...
;return bO;}
,getNextAll:function(bR){var bQ=qx.module.Traversing.__xa(this,f,bR);return qxWeb.$init(bQ,qxWeb);}
...
;return bX;}
,getPrevAll:function(cb){var ca=qx.module.Traversing.__xa(this,k,cb);return qxWeb.$init(ca,qxWeb);}
...
,getSiblings:function(ci){var ch=qx.module.Traversing.__xa(this,n,ci);return qxWeb.$init(ch,qxWeb);}
...
},defer:function(cp){qxWeb.$attachAll(this);qxWeb.$attach({"__wV":cp.__wV});}
});}
)();
...
(function(){var a="scrollLeft",b="qx.module.Manipulating",c="ease-in",d="scrollTop";qx.Bootstrap.define(b,{statics:{_animationDescription:{scrollLeft:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollLeft:1}}},scrollTop:{duration:700,timing:c,keep:100,keyFrames:{'0':{},'100':{scrollTop:1}}}},__xb:function(f,g,e){var h=qx.lang.Object.clone(qx.module.Manipulating._animationDescription[f],true);h.keyFrames[100][f]=g;return this.animate(h,e);}
,__xc:function(o){var k;if(qx.lang.Type.isArray(o)){k=qxWeb(o);}
else {var n=qx.bom.Html.clean([o]);if(n.length>0&&qx.dom.Node.isElement(n[0])){k=qxWeb(n);}
else {k=qxWeb(o);}
;}
;return k;}
,__xd:function(p){if(p.childNodes.length==0){return p;}
;for(var i=0,l=p.childNodes.length;i<l;i++ ){if(p.childNodes[i].nodeType===1){return this.__xd(p.childNodes[i]);}
;}
;return p;}
,__xe:function(r){if(!qx.lang.Type.isArray(r)){var q=qxWeb(r);r=q.length>0?q:[r];}
...
,appendTo:function(parent){parent=qx.module.Manipulating.__xe(parent);for(var i=0,l=parent.length;i<l;i++ ){this._forEachElement(function(C,j){if(i==0){qx.dom.Element.insertEnd(this[j],parent[i]);}
else {qx.dom.Element.insertEnd(this.eq(j).clone(true)[0],parent[i]);}
;}
);}
;return this;}
,insertBefore:function(D){D=qx.module.Manipulating.__xe(D);for(var i=0,l=D.length;i<l;i++ ){this._forEachElement(function(E,F){if(i==0){qx.dom.Element.insertBefore(E,D[i]);}
else {qx.dom.Element.insertBefore(this.eq(F).clone(true)[0],D[i]);}
;}
);}
;return this;}
,insertAfter:function(G){G=qx.module.Manipulating.__xe(G);for(var i=0,l=G.length;i<l;i++ ){for(var j=this.length-1;j>=0;j-- ){if(!this[j]||this[j].nodeType!==1){continue;}
;if(i==0){qx.dom.Element.insertAfter(this[j],G[i]);}
else {qx.dom.Element.insertAfter(this.eq(j).clone(true)[0],G[i]);}
;}
;}
;return this;}
,wrap:function(H){H=qx.module.Manipulating.__xc(H);if(H.length==0){return this;}
;this._forEachElement(function(I){var J=H.eq(0).clone(true);qx.dom.Element.insertAfter(J[0],I);var K=qx.module.Manipulating.__xd(J[0]);qx.dom.Element.insertEnd(I,K);}
);return this;}
...
;return Y.scrollTop;}
,setScrollLeft:function(bb,bc){var Node=qx.dom.Node;if(bc&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__xb.bind(this,a,bb,bc)();}
...
;}
;return this;}
,setScrollTop:function(be,bf){var Node=qx.dom.Node;if(bf&&qx.bom.element&&qx.bom.element.AnimationJs){qx.module.Manipulating.__xb.bind(this,d,be,bf)();}
...
;}
;var Y,bb=[];for(var i=0,l=X.length;i<l;i++ ){Y=X[i];if(typeof Y===k){Y=this.__xh(Y,bc);}
...
(function(){var a="360deg",b="bottom left",c="3deg",d="div",f="3D",g="both",h="button",i="180deg",j="-20deg",k="demobrowser.demo.animation.Animation",l="-50px",m="90deg",n="0px",o="-10px",p="200px",r="10deg",s="h1",t="10px",u="name",v="0deg",w="bottom center",x="Sorry, no CSS transforms supported",y="3d",z="50px",A="left bottom",B='label',C="Fast Width",D="ease-in",E="css.animation",F="padding-top",G="20px",H="red",I="css.transform",J="not-allowed",K="tap",L="CSS animations not supported, sorry!",M="ease-out",N="-3deg";qx.Class.define(k,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(E)==null){var V=document.createElement(B);V.innerHTML=L;document.body.appendChild(V);return;}
;var bg={duration:1000,timing:M,keyFrames:{'0':{},'70':{"width":p},'100':{}}};var T={duration:1000,keyFrames:{'0':{"scale":[1,1],"rotate":[v,v],"skew":v,"translate":n},'50':{"scale":[1,0.2],"rotate":[v,m],"skew":r,"translate":l},'100':{"scale":[1,1],"rotate":[v,v],"skew":v,"translate":n}}};var bd={duration:1000,keyFrames:{'0':{"translate":[n,n]},'50':{"translate":[z,G]},'100':{"translate":[n,n]}}};var P={duration:1000,origin:w,keyFrames:{'0':{"scale":[1,1]},'50':{"scale":[2,0.1]},'100':{"scale":[1,1]}}};var W={duration:1000,keep:100,keyFrames:{'0':{"rotate":v},'100':{"rotate":a}}};var Q={duration:1000,keyFrames:{'0':{"rotate":[v,v,v]},'50':{"rotate":[i,i,m]},'100':{"rotate":[v,v,v]}}};var R={duration:1000,origin:b,keyFrames:{'0':{"skew":v},'50':{"skew":j},'100':{"skew":v}}};var bb={duration:1000,keyFrames:{'0':{translate:n},'10':{translate:o},'20':{translate:t},'30':{translate:o},'40':{translate:t},'50':{translate:o},'60':{translate:t},'70':{translate:o},'80':{translate:t},'90':{translate:o},'100':{translate:n}}};var be={duration:1000,keyFrames:{'0':{scale:1,rotate:v},'10':{scale:0.9,rotate:N},'20':{scale:0.9,rotate:N},'30':{scale:1.1,rotate:c},'40':{scale:1.1,rotate:N},'50':{scale:1.1,rotate:c},'60':{scale:1.1,rotate:N},'70':{scale:1.1,rotate:c},'80':{scale:1.1,rotate:N},'90':{scale:1.1,rotate:c},'100':{scale:1,rotate:v}}};var O={duration:500,origin:A,keyFrames:{'0':{opacity:1,rotate:v},'100':{opacity:0,rotate:m}}};var Y={duration:500,origin:A,keyFrames:{'0':{opacity:0,rotate:m},'100':{opacity:1,rotate:v}}};var bf={duration:500,timing:M,keyFrames:{'0':{translate:[null,n],opacity:1},'30':{translate:[null,t],opacity:1},'100':{translate:[null,l],opacity:0}}};var S={duration:1000,keep:100,timing:D,origin:w,keyFrames:{'0':{rotate:[v],skew:[v]},'30':{rotate:[m],skew:[j]},'100':{rotate:[v],skew:[v]}}};var U={"Tada":be,"Shake":bb,"Skew":R,"Rotate":W,"Scale":P,"translate":bd,"Width":bg,"Fast Width":bg,"Rotate Out":O,"Rotate In":Y,"Up and out":bf,"3D Rotate":Q,"3D Transform":T,"3D Fall":S};for(var bc in U){var ba=document.createElement(d);ba.innerHTML=bc;ba.className=h;document.body.appendChild(ba);if(!(qx.core.Environment.get(I)[u])){ba.style.color=H;ba.style.cursor=J;continue;}
;if(bc.indexOf(f)!=-1&&!(qx.core.Environment.get(I)[y])){ba.style.color=H;ba.style.cursor=J;continue;}
;q(ba).on(K,(function(bi,bh){return function(e){qx.bom.element.Animation.animate(e.target,bi,bh==C?300:undefined);}
;}
)(U[bc],bc));}
;if(!(qx.core.Environment.get(I)[u])){var X=document.createElement(s);X.style.color=H;X.style.clear=g;X.style[F]=G;X.innerHTML=x;document.body.appendChild(X);}
;}
}});}
)();
