...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.ui.CommandGroupManager.b6a4d98262f3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var a="qx.ui.command.GroupManager",b="Group must be an instance of qx.ui.command.Group",c="qx.debug",d="Group was not added before. Please use ",e="'add()' method to add the group.",f="Given group is not an instance of qx.ui.command.Group",g="Group was not added before! You have to use 'addCommand()' method before activating!",h="Group is already added!";qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);this.__uc=[];}
,members:{__uc:null,__BS:null,add:function(j){if(qx.core.Environment.get(c)){this.assertInstance(j,qx.ui.command.Group,f);}
;if(qx.lang.Array.contains(this.__uc,j)){if(qx.core.Environment.get(c)){this.debug(h);}
;return false;}
;this.__uc.push(j);j.setActive(false);return true;}
...
;var l=this.__uc.indexOf(m);if(l===-1){if(qx.core.Environment.get(c)){this.debug(d+e);}
;}
;if(this.getActive()===m){this.__BS=null;}
;this.__uc.splice(l,1);return m;}
...
;return false;}
;for(var i=0;i<this.__uc.length;i++ ){var n=this.__uc[i];if(n==o){n.setActive(true);this.__BS=n;continue;}
;n.setActive(false);}
;return true;}
,getActive:function(){return this.__BS;}
,block:function(){if(this.__BS){this.__BS.setActive(false);}
;}
,unblock:function(){if(this.__BS){this.__BS.setActive(true);}
;}
,_getGroup:function(q){var p=this.__uc.indexOf(q);if(p===-1){return null;}
;return this.__uc[p];}
},destruct:function(){this.__uc=this.__BS=null;}
});}
)();
