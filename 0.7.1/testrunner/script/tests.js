...
if(qxsettings["qx.version"]==undefined)qxsettings["qx.version"]="0.7.1 (r8893) [release_0_7_1]";
...
old){if(value){if(value=="pointer"&&qx.core.Client.getInstance().isMshtml()){this.setStyleProperty("cursor",
"hand");
}else{this.setStyleProperty("cursor",
value);
...
_visualPropertyCheck:function(){if(!this.isCreated()){throw new Error("Element must be created previously!");
}},
...
members._resetRuntimeWidth=function(){this._style.pixelWidth="";
if(this._innerStyle){this._innerStyle.pixelWidth="";
}};
members._resetRuntimeHeight=function(){this._style.pixelHeight="";
if(this._innerStyle){this._innerStyle.pixelHeight="";
}};
...
stringToRgb:function(str){if(this.isThemedColor(str)){return qx.theme.manager.Color.getInstance().resolveDynamic(str);
}else if(this.isNamedColor(str)){return this.NAMED[str];
