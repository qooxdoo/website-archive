...
B.setMarginRight(20);
var C=new qx.ui.form.RadioButton(p);
var E=new qx.ui.form.RadioButton(k);
var D=new qx.ui.form.RadioButton(l);
C.setUserData(A,s);
E.setUserData(A,i);
D.setUserData(A,o);
C.setValue(true);
...
return G;
},generateBox:function(){var H=new qx.ui.basic.Label(j).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:u,textColor:q,padding:10,decorator:new qx.ui.decoration.Single(4,m,t)});
return H;
}}});
})();
