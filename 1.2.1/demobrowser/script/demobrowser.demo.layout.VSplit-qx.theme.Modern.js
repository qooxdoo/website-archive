...
var L=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(L);
L.add(this.getSplitPaneTwoFlexSimple(),{left:0});
L.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
L.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
L.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
L.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
L.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
L.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
L.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
L.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var u=new qx.ui.splitpane.Pane(p);
u.setHeight(400);
u.setDecorator(o);
...
u.add(v,2);
return u;
},getSplitPaneTwoFlexWithOneMin:function(){var G=new qx.ui.splitpane.Pane(p);
G.setHeight(400);
G.setDecorator(o);
var F=new qx.ui.form.TextArea(m);
F.setDecorator(null);
F.setWrap(true);
F.setMinHeight(250);
G.add(F,1);
var H=new qx.ui.form.TextArea(k);
H.setDecorator(null);
H.setWrap(true);
G.add(H,2);
return G;
},getSplitPaneTwoFlexWithOneMax:function(){var J=new qx.ui.splitpane.Pane(p);
J.setHeight(400);
J.setDecorator(o);
...
I.setWrap(true);
J.add(I,1);
var K=new qx.ui.form.TextArea(i);
K.setDecorator(null);
K.setWrap(true);
K.setMaxHeight(100);
J.add(K,2);
return J;
},getSplitPaneTwoFlexWithTwoMin:function(){var A=new qx.ui.splitpane.Pane(p);
A.setHeight(400);
A.setDecorator(o);
var z=new qx.ui.form.TextArea(m);
z.setDecorator(null);
z.setWrap(true);
z.setMinHeight(250);
A.add(z,1);
var B=new qx.ui.form.TextArea(d);
B.setDecorator(null);
B.setWrap(true);
B.setMinHeight(250);
A.add(B,2);
return A;
},getSplitPaneTwoFlexWithTwoMax:function(){var r=new qx.ui.splitpane.Pane(p);
r.setHeight(400);
r.setDecorator(o);
...
q.setMaxHeight(100);
r.add(q,1);
var s=new qx.ui.form.TextArea(i);
s.setDecorator(null);
s.setWrap(true);
s.setMaxHeight(100);
r.add(s,2);
return r;
},getSplitPaneOneFlexSimple:function(){var D=new qx.ui.splitpane.Pane(p);
D.setHeight(400);
D.setDecorator(o);
...
C.setWrap(true);
D.add(C,0);
var E=new qx.ui.form.TextArea(n);
E.setDecorator(null);
E.setWrap(true);
D.add(E);
return D;
},getSplitPaneOneFlexSimpleWithMax:function(){var N=new qx.ui.splitpane.Pane(p);
N.setHeight(400);
N.setDecorator(o);
...
x.add(y);
return x;
},getSplitPaneAuto:function(){var b=new qx.ui.splitpane.Pane(p);
b.setDecorator(o);
