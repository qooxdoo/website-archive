...
},_addEditor:function(u,v){v=qx.lang.Object.clone(v);
var w=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var A=u.createCellEditor(v);
var B=new qx.ui.container.Composite().set({width:200,height:20});
A.setUserBounds(0,0,200,20);
B.add(A);
w.add(B);
var y=new qx.ui.form.Button(d);
w.add(y);
y.addListener(h,function(){z.setValue(u.getCellEditorValue(A)+m);
});
var x=new qx.ui.form.Button(e);
w.add(x);
x.addListener(h,function(){A.destroy();
qx.ui.core.queue.Manager.flush();
A=u.createCellEditor(v);
A.setUserBounds(0,0,200,20);
B.add(A);
qx.ui.core.queue.Manager.flush();
});
var z=new qx.ui.basic.Label(m);
w.add(z);
this._container.add(w);
y.execute();
},testCheckBoxEditor:function(){var C={value:[true,false]};
qx.util.Permutation.permute(C,function(I){this._addEditor(new qx.ui.table.celleditor.CheckBox(),I);
},this);
},testComboBoxEditor:function(){var F={value:[m,l,g,2],table:[this.getTableMock()]};
var G=new qx.ui.table.celleditor.ComboBox();
G.setListData([i,l,j]);
qx.util.Permutation.permute(F,function(r){this._addEditor(G,r);
},this);
},testSelectBoxEditor:function(){var D={value:[m,l],table:[this.getTableMock()]};
var E=new qx.ui.table.celleditor.SelectBox();
E.setListData([i,l,j]);
qx.util.Permutation.permute(D,function(s){this._addEditor(E,s);
},this);
},testPasswordEditor:function(){var p={value:[null,10,k]};
qx.util.Permutation.permute(p,function(H){this._addEditor(new qx.ui.table.celleditor.PasswordField(),H);
},this);
},testTextfieldEditor:function(){var a={value:[null,10,k]};
qx.util.Permutation.permute(a,function(t){this._addEditor(new qx.ui.table.celleditor.TextField(),t);
},this);
},testTextfieldEditorDynamic:function(){var n={value:[true,k]};
var o=new qx.ui.table.celleditor.Dynamic();
o.setCellEditorFactoryFunction(function(J){if(typeof J.value==c){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
qx.util.Permutation.permute(n,function(q){this._addEditor(o,q);
},this);
