...
var s=new qx.ui.virtual.core.Scroller(20,20,40,40).set({width:400,height:300});
this.layer=new qx.test.ui.virtual.layer.LayerSimple(this);
var r=s.getPane();
r.addListener(j,this._onCellClick,this);
r.addListener(d,this._onContextMenu,this);
r.addListener(b,this._onDblclickPane,this);
r.addLayer(this.layer);
...
},_onCellClick:function(e){var a=l+e.getRow()+n+e.getColumn()+o;
this.__Nm(a);
},_onContextMenu:function(e){var t=i+e.getRow()+n+e.getColumn()+o;
this.__Nm(t);
},_onDblclickPane:function(e){var q=h+e.getRow()+n+e.getColumn()+o;
this.__Nm(q);
},__Nm:function(p){this.logger.setHtml(this.logger.getHtml()+p);
