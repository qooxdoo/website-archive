...
s.add(this.getBox4());
s.add(this.getBox5());
},getBox1:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
...
a.setMarginRight(30);
return b;
},getBox2:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
