...
m.add(this.getGrid2());
m.add(this.getGrid3());
},getGrid1:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.Grid(10,20)).set({decorator:k,backgroundColor:i,allowGrowX:false,allowGrowY:false});
l.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:0});
l.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:0,column:1});
l.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:0});
l.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:1,column:1});
return l;
