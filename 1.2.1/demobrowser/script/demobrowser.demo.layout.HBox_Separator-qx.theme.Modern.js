...
var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(o);
o.add(this.getBox1());
o.add(this.getBox2());
o.add(this.getBox3());
},getBox1:function(){var i=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
i.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g}));
return i;
},getBox2:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,minHeight:60,allowGrowX:false});
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:c}));
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:a}));
n.add(new qx.ui.core.Widget().set({decorator:h,backgroundColor:g,maxHeight:40,alignY:b}));
return n;
},getBox3:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,e)).set({decorator:h,backgroundColor:f,allowGrowX:false});
var m=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
var l=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
var j=new qx.ui.core.Widget().set({decorator:h,backgroundColor:g});
k.add(m);
k.add(l);
k.add(j);
m.setMarginRight(10);
