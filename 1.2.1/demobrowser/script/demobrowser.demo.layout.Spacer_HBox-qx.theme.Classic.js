...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Spacer_HBox","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Spacer_HBox-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"940a6166c191"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},getSpacerWithoutFlex:function(){var m=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,allowGrowX:false});
var n=new qx.ui.layout.HBox();
n.setSpacing(5);
m.setLayout(n);
m.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
m.add(new qx.ui.core.Spacer(30,40));
m.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
m.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return m;
},getSpacerWithFlex:function(){var a=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,height:100,width:400});
var b=new qx.ui.layout.HBox();
b.setSpacing(5);
a.setLayout(b);
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:f}));
a.add(new qx.ui.core.Spacer(30,40),{flex:1});
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:d}));
a.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:e}));
return a;
