...
j.add(this.getBox6());
j.add(this.getBox7());
},getBox1:function(){var J=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,allowGrowX:false});
...
I.setMarginLeft(-10);
return J;
},getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,allowGrowX:false});
...
o.setMarginLeft(-10);
return p;
},getBox4:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({decorator:i,backgroundColor:h,height:80,width:500,allowGrowX:false});
