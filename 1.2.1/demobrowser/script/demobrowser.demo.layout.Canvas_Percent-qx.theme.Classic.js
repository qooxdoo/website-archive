...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Canvas_Percent","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Canvas_Percent-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"84c619627cac"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var n="20%",m="9%",l="3%",k="6%",j="12%",i="black",h="teal",g="red",f="demobrowser.demo.layout.Canvas_Percent",e="green",b="yellow",d="orange",c="solid",a="blue";
qx.Class.define(f,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);
var v=new qx.ui.decoration.Single(3,c,i);
var u=new qx.ui.core.Widget().set({backgroundColor:g,decorator:v});
var t=new qx.ui.core.Widget().set({backgroundColor:a,decorator:v});
var s=new qx.ui.core.Widget().set({backgroundColor:e,decorator:v});
var r=new qx.ui.core.Widget().set({backgroundColor:b,decorator:v});
var q=new qx.ui.core.Widget().set({backgroundColor:d,decorator:v});
var p=new qx.ui.core.Widget().set({backgroundColor:h,decorator:v});
var o=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
o.add(u,{left:l,top:l,right:l,bottom:l,width:n,height:n});
o.add(t,{left:k,top:k,right:k,width:n,height:n});
o.add(s,{left:m,top:m,bottom:m,width:n,height:n});
o.add(r,{left:j,top:j,width:n,height:n});
o.add(q,{top:m,right:m,width:n,height:n});
o.add(p,{right:m,bottom:m,width:n,height:n});
this.getRoot().add(o,{edge:0});
}}});
})();
