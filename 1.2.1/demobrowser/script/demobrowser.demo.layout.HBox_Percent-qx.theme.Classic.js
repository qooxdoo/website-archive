...
E.add(this.getBox5());
E.add(this.getBox6());
},getBox1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
h.add(g,{flex:1});
return h;
},getBox2:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:500,allowGrowX:false});
...
B.add(D,{width:d});
B.add(C,{width:d});
B.add(A,{width:d,flex:1});
return B;
},getBox3:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
t.add(s,{flex:1});
return t;
},getBox4:function(){var x=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,allowGrowX:false});
...
x.add(z,{width:d,flex:1});
x.add(y,{width:d,flex:1});
x.add(w,{width:d,flex:1});
return x;
},getBox5:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:f,backgroundColor:c,width:200,allowGrowX:false});
