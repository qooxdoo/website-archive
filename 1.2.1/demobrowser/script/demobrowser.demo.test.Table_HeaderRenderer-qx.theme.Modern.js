...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Table_HeaderRenderer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"08e70234d22f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var i="Name",h="hovered",g="tool tip",f="icon/16/apps/internet-feed-reader.png",d="mouseover",c="demobrowser.demo.test.Table_HeaderRenderer",b="_container",a="mouseout";
qx.Class.define(c,{extend:qx.application.Standalone,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Standalone.prototype.main.call(this);
this.setUp();
...
},testDefaultRenderer:function(){var m=new qx.ui.table.headerrenderer.Default();
m.setToolTip(g);
var k={name:[i],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var l=this._getNewHeaderContainer();
qx.util.Permutation.permute(k,function(q){var r=m.createHeaderCell(q);
l.add(r);
m.updateHeaderCell(q,r);
});
},testIconRenderer:function(){var p=new qx.ui.table.headerrenderer.Icon(f);
p.setToolTip(g);
var n={name:[i],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var o=this._getNewHeaderContainer();
qx.util.Permutation.permute(n,function(s){var t=p.createHeaderCell(s);
o.add(t);
p.updateHeaderCell(s,t);
});
},_getNewHeaderContainer:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
j.addListener(d,function(e){e.getTarget().addState(h);
});
j.addListener(a,function(e){e.getTarget().removeState(h);
});
this._container.add(j);
return j;
