...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.SelectBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"95852984062f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var U=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
U.setPadding(20);
U.add(this.createBox1());
U.add(this.createBox2());
U.add(this.createBox3());
U.add(this.createBox4());
V.add(U,{left:20,top:20});
this.getRoot().add(V,{edge:0});
},createBox1:function(){var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
L.add(new qx.ui.basic.Label(f));
var K=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var M=new qx.ui.form.ListItem(v+(i+1));
K.add(M);
if(i==5){K.setSelection([M]);
}}K.addListener(B,function(e){this.debug("changeSelection: "+e.getData()[0]);
});
L.add(K);
return L;
...
return Q;
},createBox4:function(){var O=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
O.add(new qx.ui.basic.Label(b));
var N=new qx.ui.form.SelectBox();
N.add(new qx.ui.form.ListItem(D));

for(var i=0;i<10;i++){N.add(new qx.ui.form.ListItem(q+(i+1)));
}O.add(N);
return O;
}}});
})();
