...
d.moveTo(300,250);
d.addListener(j,function(e){d.__NE.focus();
d.__NE.setTextSelection(0,d.__NE.getValue().length);
});
d.__NE=new qx.ui.form.TextField(a.value+"").set({allowGrowY:true});
d.add(d.__NE);
...
return d;
},getCellEditorValue:function(A){return parseFloat(A.__NE.getValue());
}}});
})();
