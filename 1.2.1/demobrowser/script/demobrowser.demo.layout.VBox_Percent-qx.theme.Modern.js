...
var y=new qx.ui.container.Composite(w).set({decorator:f,backgroundColor:c,height:300,allowGrowY:false});
w.setSpacing(5);
...
t.add(s,{flex:1});
return t;
},getBox4:function(){var h=new qx.ui.layout.VBox();
var j=new qx.ui.container.Composite(h).set({decorator:f,backgroundColor:c,allowGrowY:false});
h.setSpacing(5);
...
j.add(l,{height:d,flex:1});
j.add(k,{height:d,flex:1});
j.add(i,{height:d,flex:1});
return j;
