...
var bb=new qx.ui.container.Scroll();
var ba=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
ba.setPadding(20);
ba.setAllowStretchX(false);
bb.add(ba);
this.getRoot().add(bb,{edge:0});
ba.add(this.getTabView1());
ba.add(this.getTabView2());
ba.add(this.getTabView3());
},getTabView1:function(){var H=new qx.ui.tabview.TabView();
H.setWidth(500);
var L=new qx.ui.tabview.Page(a,h);
L.setLayout(new qx.ui.layout.VBox());
L.add(new qx.ui.basic.Label(o));
H.add(L);
var J=new qx.ui.tabview.Page(c,x);
J.setLayout(new qx.ui.layout.VBox());
J.add(new qx.ui.basic.Label(r));
H.add(J);
var K=new qx.ui.tabview.Page(u,g);
K.setLayout(new qx.ui.layout.VBox());
K.add(new qx.ui.basic.Label(y));
H.add(K);
var I=new qx.ui.tabview.Page(s,B);
I.setLayout(new qx.ui.layout.VBox());
I.add(new qx.ui.basic.Label(q));
H.add(I);
return H;
},getTabView2:function(){var C=new qx.ui.tabview.TabView();
C.setWidth(500);

for(var i=1;i<=20;i++){var D=new qx.ui.tabview.Page(l+i,h);
D.setLayout(new qx.ui.layout.VBox());
D.setShowCloseButton(true);
D.add(new qx.ui.basic.Label(l+i+n));
C.add(D);
}return C;
...
Q.add(R);
Q.add(M);
P.addListener(k,function(e){var E=O.getChildren().length+1;
var F=new qx.ui.tabview.Page(l+E,j);
O.add(F);
});
R.addListener(k,function(e){var G=O.getChildren();

if(G.length>0){O.remove(G[0]);
}});
M.addListener(k,function(e){var Y=O.getChildren();

if(Y.length>0){O.remove(Y[Y.length-1]);
}});
return O;
}}});
})();
