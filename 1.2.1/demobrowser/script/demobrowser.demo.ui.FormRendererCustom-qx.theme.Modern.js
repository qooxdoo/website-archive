...
(function(){var v="execute",u="Name",t="demobrowser.demo.ui.FormRendererCustom",s="Registration",r="demobrowser.demo.ui.CustomRenderer",q="Bio",p="Send",o="Contact",n="Country",m="Personal Information",j="Password",l="Email",k="Phone",h="right",g="Reset";
...
z.add(D,j);
z.addGroupHeader(o);
z.add(new qx.ui.form.TextField(),l,qx.util.Validate.email());
z.add(new qx.ui.form.TextField(),k);
z.addGroupHeader(m);
z.add(new qx.ui.form.TextField(),n);
z.add(new qx.ui.form.TextArea(),q);
var B=new qx.ui.form.Button(p);
B.addListener(v,function(){if(z.validate()){alert("send...");
}},this);
z.addButton(B);
var A=new qx.ui.form.Button(g);
A.addListener(v,function(){z.reset();
},this);
z.addButton(A);
var C=new demobrowser.demo.ui.CustomRenderer(z);
this.getRoot().add(C,{left:10,top:10});
}}});
qx.Class.define(r,{extend:qx.ui.form.renderer.Single,members:{__Ox:0,__Oy:0,addItems:function(a,b,c){var f=0;
if(c!=null){this._add(this._createHeader(c),{row:f,column:this.__Ox,colSpan:2});
f++;
}for(var i=0;i<a.length;i++){var e=this._createLabel(b[i],a[i]);
this._add(e,{row:f,column:this.__Ox});
var d=a[i];
e.setBuddy(d);

if(d instanceof qx.ui.form.RadioGroup){d=this._createWidgetForRadioGroup(d);
}this._add(d,{row:f,column:this.__Ox+1});
f++;
}this.__Ox+=2;
this.__Oy<f?this.__Oy=f:null;
...
this._add(this._buttonRow,{row:this.__Oy,column:0,colSpan:this.__Ox});
