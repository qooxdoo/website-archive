...
(function(){var e="Window: ",d="interval",c="__Mx",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__Mv:null,__Mw:0,__Mx:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__Mv=[];
this.currentTest=this.testWindows;
this.__Mx=new qx.event.Timer(1000);
this.__Mx.addListener(d,this.runTest,this);
this.__Mx.start();
},runTest:function(){this.__Mw++;
var h=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__Mw+" (Registry: "+h+")");
this.currentTest();
