...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.ScrollContainer","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.ScrollContainer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"666a5c74c67d"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
h.add(this.generateBoxes());
this.getRoot().add(h,{left:10,top:10});
var g=new qx.ui.form.Button(c).set({padding:5});
var i=true;
g.addListener(a,function(){h.setWidth(i?800:300);
i=!i;
});
this.getRoot().add(g,{left:10,top:400});
},generateBoxes:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.Grid());

for(var y=0;y<10;y++){for(var x=0;x<10;x++){f.add((new qx.ui.core.Widget()).set({backgroundColor:((x+y)%2==0)?d:b,width:60,allowShrinkY:false,allowShrinkX:false,height:60}),{column:x,row:y});
}}return f;
}}});
})();
