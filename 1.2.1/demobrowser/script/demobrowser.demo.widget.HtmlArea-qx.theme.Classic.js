...
(function(){var by="",bx="execute",bw="<tr>",bv="changeSelection",bu="</tr>",bt="qx/icon/Oxygen/16/actions/format-indent-more.png",bs="Georgia",br="http://",bq="Change Font Size",bp="Indent More",be="<p>You can play around with this widget by hitting the ",bd="demobrowser/demo/icons/htmlarea/format-fill-color.png",bc="Align Right",bb="Format Italic",ba="qx/icon/Oxygen/16/actions/format-text-underline.png",Y='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',X="OK",W="buttons at the toolbar.</p>",V="demobrowser.demo.widget.HtmlArea",U="Times New Roman",bF="Comic Sans MS",bG="<p>This UI-level widget can be used at RIA (Rich ",bD="Tahoma",bE="<td>First Row, First cell</td>",bB="solid",bC="qx/icon/Oxygen/16/actions/format-justify-center.png",bz="Align Justify",bA="Inserted Unordered List",bH="demobrowser/demo/icons/htmlarea/insert-text.png",bI="Insert Horizontal Ruler",bi="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",bh="demobrowser/demo/icons/htmlarea/format-list-unordered.png",bk="HTML Code:",bj="Set Text Background Color",bm="Internet Applications) and inline applications.<br/>",bl="Insert Link",bo="<td>Second Row, First cell</td>",bn="</tbody>",bg="Undo Last Change",bf="Set Text Color",d="Insert Table",f="Cancel",g="As an application developer you can <b>use the same API.</b></p>",h="demobrowser/demo/icons/htmlarea/format-text-color.png",k="demobrowser/demo/icons/htmlarea/insert-table.png",l="qx/icon/Oxygen/16/actions/edit-undo.png",m="qx/icon/Oxygen/16/actions/edit-clear.png",n="Arial Black",o="Impact",p="Redo Last Undo Step",bM="Format Bold",bL="Change Font Family",bK="right",bJ="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",bQ="main",bP="Insert Hyperlink",bO="Remove Format",bN="qx/icon/Oxygen/16/actions/insert-image.png",bS="so code-duplication is avoided.<br/>",bR="</table>",E="12px ",F="<td>First Row, Second cell</td>",C="Insert HTML Code",D="qx/icon/Oxygen/16/actions/insert-link.png",I="Insert Ordered List",J="qx/icon/Oxygen/16/actions/format-justify-left.png",G="Courier",H="Courier New",A="qx/icon/Oxygen/16/actions/format-justify-right.png",B="qx/icon/Oxygen/16/actions/format-text-bold.png",x="<td>Second Row, Second cell</td>",w="Insert Image",z="<h1>HtmlArea UI-level widget</h1>",y="Align Left",t="<table border='1'>",s="The UI widget does use the low-level component internally ",v="qx/icon/Oxygen/16/actions/format-indent-less.png",u="<tbody>",r="demobrowser/demo/icons/htmlarea/format-list-ordered.png",q="Align Center",O="qx/icon/Oxygen/16/actions/edit-redo.png",P="Lucida Console",Q="border-main",R="qx/icon/Oxygen/16/actions/format-text-italic.png",K="Arial",L="qx/icon/Oxygen/16/actions/format-justify-fill.png",M="Verdana",N="Indent Less",S="Format Strikethrough",T="Format Underline";
qx.Class.define(V,{extend:qx.application.Standalone,members:{__MV:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cl=z+bG+bm+s+bS+g+be+W;
var cg=new qx.ui.basic.Label(cl);
cg.set({rich:true,marginBottom:10});
var ck=Y;
var cj=this.getRoot();
var ci=new qx.ui.decoration.Single(1,bB,Q);
ci.setWidthTop(0);
this.__MV=new qx.ui.embed.HtmlArea(ck,null,"blank.html");
this.__MV.set({width:600,height:400,decorator:ci});
var toolbar=this.__Ng();
var cf=new qx.ui.layout.VBox(0);
var ch=new qx.ui.container.Composite(cf);
ch.add(cg);
ch.add(toolbar);
ch.add(this.__MV);
cj.add(ch,{left:20,top:20});
},__MW:function(e){var bU=window.prompt("Color (Hex): ","#");
this.setTextColor(bU);
},__MX:function(e){var cd=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(cd);
},__MY:function(e){var cr={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(cr);
},__Na:function(e){var ce=t+u+bw+bE+F+bu+bw+bo+x+bu+bn+bR;
this.insertHtml(ce);
},__Nb:function(e){var bW=new qx.ui.window.Window(bP);
bW.setLayout(new qx.ui.layout.VBox(20));
bW.set({width:400,showMaximize:false,showMinimize:false});
var cb=new qx.ui.form.TextField(br);
bW.add(cb);
var bY=new qx.ui.layout.HBox(10);
bY.setAlignX(bK);
var ca=new qx.ui.container.Composite(bY);
var bV=new qx.ui.form.Button(X);
bV.setWidth(60);
bV.addListener(bx,function(e){this.insertHyperLink(cb.getValue());
bW.close();
},this);
ca.add(bV);
var bX=new qx.ui.form.Button(f);
bX.setWidth(60);
bX.addListener(bx,function(e){bW.close();
},this);
ca.add(bX);
bW.add(ca);
bW.center();
bW.open();
this.saveRange();
},__Nc:function(e){var bT=window.prompt(bk,by);
this.insertHtml(bT);
},__Nd:function(){var b=new qx.ui.form.SelectBox;
b.set({toolTipText:bL,focusable:false,keepFocus:true,width:120,height:16,margin:[4,0]});
b.add(new qx.ui.form.ListItem(by));
var c=[bD,M,U,K,n,H,G,bs,o,bF,P];
var a;

for(var i=0,j=c.length;i<j;i++){a=new qx.ui.form.ListItem(c[i]);
a.set({focusable:false,keepFocus:true,font:qx.bom.Font.fromString(E+c[i])});
b.add(a);
}b.addListener(bv,function(e){var cs=e.getData()[0].getLabel();

if(cs!=by){this.setFontFamily(cs);
b.setSelection([b.getChildren()[0]]);
}},this.__MV);
return b;
},__Ne:function(){var cu=new qx.ui.form.SelectBox;
cu.set({toolTipText:bq,focusable:false,keepFocus:true,width:50,height:16,margin:[4,0]});
cu.add(new qx.ui.form.ListItem(by));
var ct;

for(var i=1;i<=7;i++){ct=new qx.ui.form.ListItem(i+by);
ct.set({focusable:false,keepFocus:true});
cu.add(ct);
}cu.addListener(bv,function(e){var cc=e.getData()[0].getLabel();

if(cc!=by){this.setFontSize(cc);
cu.setSelection([cu.getChildren()[0]]);
}},this.__MV);
return cu;
},__Nf:function(){return [{bold:{text:bM,image:B,action:this.__MV.setBold},italic:{text:bb,image:R,action:this.__MV.setItalic},underline:{text:T,image:ba,action:this.__MV.setUnderline},strikethrough:{text:S,image:bJ,action:this.__MV.setStrikeThrough},removeFormat:{text:bO,image:m,action:this.__MV.removeFormat}},{alignLeft:{text:y,image:J,action:this.__MV.setJustifyLeft},alignCenter:{text:q,image:bC,action:this.__MV.setJustifyCenter},alignRight:{text:bc,image:A,action:this.__MV.setJustifyRight},alignJustify:{text:bz,image:L,action:this.__MV.setJustifyFull}},{fontFamily:{custom:this.__Nd},fontSize:{custom:this.__Ne},fontColor:{text:bf,image:h,action:this.__MW},textBackgroundColor:{text:bj,image:bd,action:this.__MX}},{indent:{text:bp,image:bt,action:this.__MV.insertIndent},outdent:{text:N,image:v,action:this.__MV.insertOutdent}},{insertImage:{text:w,image:bN,action:this.__MY},insertTable:{text:d,image:k,action:this.__Na},insertLink:{text:bl,image:D,action:this.__Nb},insertHTML:{text:C,image:bH,action:this.__Nc},insertHR:{text:bI,image:bi,action:this.__MV.insertHorizontalRuler}},{ol:{text:I,image:r,action:this.__MV.insertOrderedList},ul:{text:bA,image:bh,action:this.__MV.insertUnorderedList}},{undo:{text:bg,image:l,action:this.__MV.undo},redo:{text:p,image:O,action:this.__MV.redo}}];
},__Ng:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setDecorator(bQ);
var cm;
var cn=this.__Nf();
...
cm.set({focusable:false,keepFocus:true,center:true,toolTipText:cq.text?cq.text:by});
cm.addListener(bx,cq.action,this.__MV);
}co.add(cm);
}}return toolbar;
}}});
})();
