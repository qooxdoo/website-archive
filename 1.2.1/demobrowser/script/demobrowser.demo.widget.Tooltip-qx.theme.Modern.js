...
this.container=new qx.ui.container.Composite(J).set({padding:20});
K.add(this.container);
...
},__MF:4,__MG:0,add:function(H){this.container.add(H,{row:Math.floor(this.__MG/this.__MF),column:this.__MG%this.__MF});
this.__MG+=1;
},createSharedToolTip:function(){var G=new qx.ui.tooltip.ToolTip(r);
G.addListener(t,function(e){var a=b;

if(this.getOpener()==F){a+=q;
}else{a+=s;
}G.setLabel(a);
});
var F=new qx.ui.form.Button(w);
F.setToolTip(G);
this.add(F);
var E=new qx.ui.form.Button(i);
E.setToolTip(G);
this.add(E);
},createIconToolTip:function(){var I=new qx.ui.form.Button(x).set({toolTip:new qx.ui.tooltip.ToolTip(null,l)});
this.add(I);
},createToolTip:function(){var O=new qx.ui.form.Button(c).set({toolTip:new qx.ui.tooltip.ToolTip(f,l)});
this.add(O);
},createShortTimeoutToolTip:function(){var C=new qx.ui.tooltip.ToolTip(y,j);
C.setShowTimeout(50);
var B=new qx.ui.form.Button(h);
this.add(B);
B.setToolTip(C);
},createRichToolTip:function(){var M=new qx.ui.tooltip.ToolTip(p+u+n,j);
M.setWidth(200);
M.setRich(true);
M.setShowTimeout(50);
var L=new qx.ui.form.Button(z);
this.add(L);
L.setToolTip(M);
},createToolTipText:function(){var A=new qx.ui.form.Button(o).set({toolTipText:k});
this.add(A);
},createToolTipIcon:function(){var D=new qx.ui.form.Button(m).set({toolTipIcon:l});
this.add(D);
},createToolTipTextIcon:function(){var N=new qx.ui.form.Button(d).set({toolTipText:k,toolTipIcon:l});
this.add(N);
