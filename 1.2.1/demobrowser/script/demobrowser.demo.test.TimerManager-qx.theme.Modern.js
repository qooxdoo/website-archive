...
(function(){var j="Stopping recurrent 2-second timer",i="Recurrent 2-second timer with limit 3:",h="\n",g="One-shot 1-second timer: ",f=" ",e="demobrowser.demo.test.TimerManager",d="Recurrent 5-second timer: ",c="__My",b="Start timers",a="execute";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__My:null,startTimers:function(){var v=qx.util.TimerManager.getInstance();
v.start(function(q,r){this.__Mz(d+r);
},5000,this,null,0);
v.start(function(t,u){this.__Mz(g+u);
},0,this,null,1000);
v.start(function(k,l){this.__Mz(i+l);

if(++k.count==3){this.__Mz(j);
v.stop(l);
}},2000,this,{count:0},2000);
},__Mz:function(s){s=Date.parse(new Date)+f+s+h;
this.__My.setValue(this.__My.getValue()+s);
