...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.ListControllerWithObjects-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"52a8829aef43"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="execute",j="smile",h="Jack",g=".png",f="kiss",e="demobrowser.demo.data.ListControllerWithObjects",d="emote",c="green",b="Jim",a="<b>Displaying objects in a list</b><br/>",G="Make all happy",F="sad",E="plain",D="surprise",C="embarrassed",B="online",A=" a converter by the icon. The font color shows the online status.",z="name",y="Write data to log",x="Jackob",r="textColor",s="have a name and an emotion, which is displayed with the help of ",p="This list display a set of persons in a list. Every person does ",q="Dan",n="Tim",o="Karl",l="Online <> Offline",m="icon/16/emotes/face-",t="Dustin",u="angel",w="Max",v="red";
...
var bb=[w,x,n,h,q,t,o,b];
var R=[C,f,E,F,D,u];
var X=[];

for(var i=0;i<20;i++){var U=new demobrowser.demo.data.model.Person();
U.setName(bb[i%bb.length]);
U.setEmote(R[i%R.length]);
U.setOnline(i%3==0);
X.push(U);
}var Y=new qx.data.Array(X);
var Q=new qx.ui.form.List();
Q.setWidth(150);
this.getRoot().add(Q,{left:10,top:80});
var ba={converter:function(L){return m+L+g;
}};
var V=new qx.data.controller.List(Y,Q,z);
V.setIconOptions(ba);
V.setIconPath(d);
var T={converter:function(H){if(H){return c;
}else{return v;
}}};
var O={bindItem:function(I,J,K){I.bindDefaultProperties(J,K);
I.bindProperty(B,r,T,J,K);
}};
V.setDelegate(O);
var P=new qx.ui.form.Button(G);
P.setWidth(120);
this.getRoot().add(P,{left:180,top:80});
P.addListener(k,function(){for(var i=0;i<Y.length;i++){var M=Y.getItem(i);
M.setEmote(j);
}},this);
var N=new qx.ui.form.Button(l);
N.setWidth(120);
this.getRoot().add(N,{left:180,top:115});
N.addListener(k,function(){for(var i=0;i<Y.length;i++){Y.getItem(i).toggleOnline();
}},this);
var W=new qx.ui.form.Button(y);
W.setWidth(120);
this.getRoot().add(W,{left:180,top:150});
W.addListener(k,function(){qx.log.appender.Console.show();
