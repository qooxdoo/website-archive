...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.Event","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.Event-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"8cc81dc3eb73"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="</table>",h="demobrowser.demo.event.EventDemo",g="</td><td>",f="",e="<tr><td>",d="btnClear",c="click",b="</td></tr>";
qx.Class.define(h,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
var a=document.getElementById(d);

if(a){qx.bom.Element.addListener(a,c,this._clearLog,this);
}},_initLogger:function(m,n,o){this.__MA="<table><tr><th>"+m.join("</th><th>")+"</th></tr>";
this.__MB=o||50;
this.__MC=n;
this._clearLog();
},_clearLog:function(){this.__MC.innerHTML=this.__MA+j;
this.__MD=[];
},_log:function(k){this.__MD.unshift(k);
this.__MD=this.__MD.slice(0,this.__MB);
var l=[this.__MA];

for(var i=0;i<this.__MD.length;i++){l.push(e,this.__MD[i].join(g),b);
}l.push(j);
this.__MC.innerHTML=l.join(f);
this.__MC.scrollTop=0;
},__MA:null,__MB:null,__MC:null,__MD:null},destruct:function(){this.__MC=this.__MD=null;
}});
})();
