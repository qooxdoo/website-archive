...
h.add(this.getBox5());
h.add(this.getBox6());
},getBox1:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,allowGrowY:false});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:3});
return l;
},getBox2:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,allowGrowY:false});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:30}),{flex:1});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{flex:2});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:100}),{flex:3});
return f;
},getBox3:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,allowGrowY:false});

for(var i=0;i<25;i++){j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,height:5}),{flex:1});
}return j;
},getBox4:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,minHeight:300,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:60}),{flex:1});
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:60}),{flex:2});
k.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:60}),{flex:3});
return k;
},getBox5:function(){var e=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,minHeight:0,decorator:d,backgroundColor:b,allowGrowY:false});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:1});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:2});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:3});
return e;
},getBox6:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:d,backgroundColor:b,allowGrowY:false});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:3});
return g;
}}});
})();
