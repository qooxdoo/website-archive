...
},_createSliderGroup:function(t){var u={slider:t,minimum:new qx.ui.basic.Label(a+t.getMinimum().toString()),maximum:new qx.ui.basic.Label(j+t.getMaximum().toString()),value:new qx.ui.basic.Label(t.getValue().toString())};
t.addListener(h,function(e){u.value.setValue(t.getValue().toString());
});
return u;
}}});
})();
