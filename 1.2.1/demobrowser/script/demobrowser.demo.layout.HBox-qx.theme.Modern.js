...
A.add(this.getBox6());
A.add(this.getBox7());
},getBox1:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:m,backgroundColor:k,allowGrowX:false});
n.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
n.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
n.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
return n;
},getBox2:function(){var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:m,backgroundColor:k,minHeight:60,allowGrowX:false});
D.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l,maxHeight:40,alignY:g}));
D.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l,maxHeight:40,alignY:e}));
D.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l,maxHeight:40,alignY:f}));
return D;
},getBox3:function(){var y=new qx.ui.layout.HBox();
var z=new qx.ui.container.Composite(y).set({decorator:m,backgroundColor:k,width:500,allowGrowX:false});
y.setSpacing(5);
y.setAlignX(i);
z.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
z.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
z.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
return z;
},getBox4:function(){var B=new qx.ui.layout.HBox();
var C=new qx.ui.container.Composite(B).set({decorator:m,backgroundColor:k,width:500,allowGrowX:false});
B.setSpacing(5);
B.setAlignX(j);
C.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
C.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
C.add(new qx.ui.core.Widget().set({decorator:m,backgroundColor:l}));
return C;
},getBox5:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:m,backgroundColor:k,allowGrowX:false});
var d=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var c=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var a=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
b.add(d);
b.add(c);
b.add(a);
d.setMarginRight(10);
...
a.setMarginRight(10);
return b;
},getBox6:function(){var o=new qx.ui.layout.HBox();
var q=new qx.ui.container.Composite(o).set({decorator:m,backgroundColor:k,width:500,allowGrowX:false});
o.setSpacing(5);
o.setAlignX(i);
var s=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
var r=new qx.ui.core.Widget().set({decorator:m,backgroundColor:l});
