...
J.add(H);
J.setValidator(function(L){var M=D.getSelection()[0]!==E;
D.setValid(M);
return M;
});
var B=function(N){if(N instanceof qx.ui.form.ListItem){return N.getLabel();
}};
