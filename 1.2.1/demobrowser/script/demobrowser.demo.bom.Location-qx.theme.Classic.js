...
var u=document.getElementById(h).getElementsByTagName(c);

for(var i=0,l=u.length;i<l;i++){u[i].onclick=demobrowser.demo.bom.Location.jump;
...
},randomize:function(){var t=document.body.getElementsByTagName(a);
