...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox_Separator","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_Separator-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"26f27f881089"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="main",k="green",j="separator-vertical",i="yellow",h="center",g="demobrowser.demo.layout.VBox_Separator",f="left",e="right";
qx.Class.define(g,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var m=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(m);
m.add(this.getBox1());
m.add(this.getBox2());
m.add(this.getBox3());
},getBox1:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,j)).set({decorator:l,backgroundColor:i,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}));
o.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}));
o.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k}));
return o;
},getBox2:function(){var n=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,j)).set({decorator:l,backgroundColor:i,minWidth:60,allowGrowY:false});
n.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:40,alignX:f}));
n.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:40,alignX:h}));
n.add(new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,maxWidth:40,alignX:e}));
return n;
},getBox3:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,j)).set({decorator:l,backgroundColor:i,allowGrowY:false});
var d=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,marginBottom:10});
var c=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,marginBottom:10,marginTop:20});
var a=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k,marginBottom:10});
b.add(d);
b.add(c);
b.add(a);
return b;
