...
(function(){var co="execute",cn="changeValue",cm="icon/16/actions/edit-cut.png",cl="changeSelection",ck="icon/16/actions/edit-paste.png",cj="Copy",ci="Paste",ch="icon/16/actions/edit-copy.png",cg="Cut",cf="icon/16/actions/system-search.png",bI="New",bH="Undo",bG="icon/16/actions/document-save.png",bF="Redo",bE="icon/22/apps/preferences-users.png",bD="icon/16/actions/document-print.png",bC="icon/16/actions/document-open.png",bB="icon/16/actions/edit-undo.png",bA="Save",bz="icon/16/actions/edit-redo.png",cv="Print",cw="Open",ct="icon/16/actions/document-new.png",cu="Online Forum",cr="icon/16/actions/format-justify-fill.png",cs="Search in files",cp="C",cq="__MN",cx="__MU",cy="Left aligned",bX="Perl",bW="View",ca="C Dialect",bY="Info...",cc="Save as...",cb="Show line numbers",ce="Quickstart",cd="icon/16/actions/contact-new.png",bV="__MT",bU="Actions",q="Show console",r="Search",s="Help",t="Show status bar",u="icon/16/actions/format-justify-left.png",v="ANSI to OEM",w="Centered",x="Website 3",y="Edit",z="icon/16/actions/format-justify-center.png",cC="icon/16/actions/go-previous.png",cB="C Sharp",cA="Close",cz="Website 2",cG="icon/16/actions/document-save-as.png",cF="Python",cE="icon/16/apps/utilities-help.png",cD="Show tree",cI="Options",cH="Spaces to tabs",Y="Right aligned",ba="Action 1",W="OEM to ANSI",X="__MR",bd="Line 431",be="JavaScript",bb="icon",bc="Action 2",U="Folder ",V="XML",H="Line 313",G="Paragraph",J="demobrowser.demo.widget.Menu",I="icon/16/actions/application-exit.png",D="C Plus Plus",C="Line 26",F="Item ",E="ASCII table",B="__MQ",A="Option 1",bj="Search next...",bk="Line 12",bl="Action 3",bm="Replace in files",bf="__MS",bg="Uppercase",bh="Topics",bi="Panes",bn="Justified",bo="Show macros",R="Search previous...",Q="__MP",P="Back",O="main",N="icon/16/actions/format-justify-right.png",M="icon/16/actions/go-next.png",L="command ",K="Option 3",T="Next",S="Show tags",bp="Capitals",bq="Format",br="File",bs="Show tabs",bt="Split Button",bu="Tabs to spaces",bv="Search...",bw="Line 1039",bx="Option 2",by="Objective C",bM="Exit",bL="__MO",bK="move to",bJ="Syntax",bQ="Show ruler",bP="Website 1",bO="Menu Button",bN="Line 30",bS="Lowercase",bR="Replace",bT="HTML";
qx.Class.define(J,{extend:qx.application.Standalone,members:{__MN:null,__MO:null,__MP:null,__MQ:null,__MR:null,__MS:null,__MT:null,__MU:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var dN=new qx.ui.container.Scroll();
var dM=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
dM.setPadding(20);
dM.setAllowStretchX(false);
dN.add(dM);
this.getRoot().add(dN,{edge:0});
this.createCommands();
dM.add(this.getMenuButton(),{left:20,top:20});
dM.add(this.getSplitButton(),{left:150,top:20});
dM.add(this.getMenuBar(),{left:20,top:100});
dM.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var dO=new qx.ui.menu.Menu();
var dP=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){dP.add(new qx.ui.menu.Button(U+(i+1)));
}dO.add(new qx.ui.menu.Button(bK,null,null,dP));
dO.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){dO.add(new qx.ui.menu.Button(L+(i+1)));
}return dO;
...
},createCommands:function(){this.__MN=new qx.ui.core.Command("Ctrl+N");
this.__MN.addListener(co,this.debugCommand);
this.__MO=new qx.ui.core.Command("Ctrl+O");
this.__MO.addListener(co,this.debugCommand);
this.__MP=new qx.ui.core.Command("Ctrl+S");
this.__MP.addListener(co,this.debugCommand);
this.__MQ=new qx.ui.core.Command("Ctrl+Z");
this.__MQ.addListener(co,this.debugCommand);
this.__MR=new qx.ui.core.Command("Ctrl+R");
this.__MR.addListener(co,this.debugCommand);
this.__MS=new qx.ui.core.Command("Ctrl+X");
this.__MS.addListener(co,this.debugCommand);
this.__MT=new qx.ui.core.Command("Ctrl+C");
this.__MT.addListener(co,this.debugCommand);
this.__MU=new qx.ui.core.Command("Ctrl+P");
this.__MU.addListener(co,this.debugCommand);
this.__MU.setEnabled(false);
},getMenuButton:function(){var ex=new qx.ui.menu.Menu;
ex.add(new qx.ui.menu.RadioButton(A));
ex.add(new qx.ui.menu.RadioButton(bx));
ex.add(new qx.ui.menu.RadioButton(K));
var eF=new qx.ui.menu.Menu;
eF.add(new qx.ui.menu.RadioButton(ba));
eF.add(new qx.ui.menu.RadioButton(bc));
eF.add(new qx.ui.menu.RadioButton(bl));
var eE=new qx.ui.form.RadioGroup;
eE.add.apply(eE,ex.getChildren());
eE.addListener(cl,this.debugRadio);
var eC=new qx.ui.form.RadioGroup;
eC.add.apply(eC,eF.getChildren());
eC.addListener(cl,this.debugRadio);
var eA=new qx.ui.menu.Menu();
var eD=new qx.ui.menu.Button(bH,bB,this.__MQ);
var eK=new qx.ui.menu.Button(bF,bz,this.__MR);
var ez=new qx.ui.menu.Button(cg,cm,this.__MS);
var eH=new qx.ui.menu.Button(cj,ch,this.__MT);
var eB=new qx.ui.menu.Button(ci,ck,this.__MU);
var ey=new qx.ui.menu.Button(cI,cf,null,ex);
var eI=new qx.ui.menu.Button(bU,cd,null,eF);
var eG=new qx.ui.menu.Button(cv,bD);
eD.addListener(co,this.debugButton);
eK.addListener(co,this.debugButton);
ez.addListener(co,this.debugButton);
eH.addListener(co,this.debugButton);
eB.addListener(co,this.debugButton);
ey.addListener(co,this.debugButton);
eI.addListener(co,this.debugButton);
eG.addListener(co,this.debugButton);
eA.add(eD);
eA.add(eK);
eA.addSeparator();
eA.add(ez);
...
eA.addSeparator();
eA.add(eG);
var eJ=new qx.ui.form.MenuButton(bO,bE,eA);
return eJ;
},getSplitButton:function(){var el=new qx.ui.menu.Menu;
var ep=new qx.ui.menu.Button(bP);
var en=new qx.ui.menu.Button(cz);
var eo=new qx.ui.menu.Button(x);
el.setMinWidth(120);
ep.addListener(co,this.debugButton);
en.addListener(co,this.debugButton);
eo.addListener(co,this.debugButton);
el.add(ep);
el.add(en);
el.add(eo);
var em=new qx.ui.form.SplitButton(bt,bE,el);
em.addListener(co,this.debugButton);
return em;
},getMenuBar:function(){var cS=new qx.ui.container.Composite(new qx.ui.layout.Grow);
cS.setDecorator(O);
var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
cS.add(toolbar);
var dc=new qx.ui.toolbar.Part;
var cR=new qx.ui.toolbar.Part;
var cV=new qx.ui.toolbar.Part;
toolbar.add(dc);
toolbar.add(cR);
toolbar.addSpacer();
toolbar.add(cV);
var db=new qx.ui.toolbar.SplitButton(P,cC,this.getBackMenu());
var cX=new qx.ui.toolbar.SplitButton(T,M,this.getForwardMenu());
var cQ=new qx.ui.toolbar.Button(bI,ct,this.__MN);
var cU=new qx.ui.toolbar.Button(cw,bC,this.__MO);
var da=new qx.ui.toolbar.Button(bA,bG,this.__MP);
db.addListener(co,this.debugButton);
cX.addListener(co,this.debugButton);
cQ.addListener(co,this.debugButton);
cU.addListener(co,this.debugButton);
da.addListener(co,this.debugButton);
dc.add(db);
dc.add(cX);
dc.addSeparator();
dc.add(cQ);
...
dc.add(da);
dc.setShow(bb);
var cT=new qx.ui.toolbar.MenuButton(br);
var cP=new qx.ui.toolbar.MenuButton(y);
var cO=new qx.ui.toolbar.MenuButton(r);
var dd=new qx.ui.toolbar.MenuButton(bW);
var cY=new qx.ui.toolbar.MenuButton(bq);
cT.setMenu(this.getFileMenu());
cP.setMenu(this.getEditMenu());
cO.setMenu(this.getSearchMenu());
dd.setMenu(this.getViewMenu());
cY.setMenu(this.getFormatMenu());
cR.add(cT);
cR.add(cP);
cR.add(cO);
cR.add(dd);
cR.add(cY);
var cW=new qx.ui.toolbar.MenuButton(s);
cW.setMenu(this.getHelpMenu());
cV.add(cW);
return cS;
},getBackMenu:function(){var cK=new qx.ui.menu.Menu;
var cL=new qx.ui.menu.Button(H);
var cN=new qx.ui.menu.Button(bw);
var cJ=new qx.ui.menu.Button(bk);
var cM=new qx.ui.menu.Button(C);
cL.addListener(co,this.debugButton);
cN.addListener(co,this.debugButton);
cJ.addListener(co,this.debugButton);
cM.addListener(co,this.debugButton);
cK.add(cL);
cK.add(cN);
cK.add(cJ);
cK.add(cM);
return cK;
},getForwardMenu:function(){var dV=new qx.ui.menu.Menu;
var dW=new qx.ui.menu.Button(bd);
var dX=new qx.ui.menu.Button(bN);
dW.addListener(co,this.debugButton);
dX.addListener(co,this.debugButton);
dV.add(dW);
dV.add(dX);
return dV;
},getFileMenu:function(){var dG=new qx.ui.menu.Menu;
var dE=new qx.ui.menu.Button(bI,ct,this.__MN);
var dI=new qx.ui.menu.Button(cw,bC,this.__MO);
var dH=new qx.ui.menu.Button(cA);
var dL=new qx.ui.menu.Button(bA,bG,this.__MP);
var dK=new qx.ui.menu.Button(cc,cG);
var dJ=new qx.ui.menu.Button(cv,bD);
var dF=new qx.ui.menu.Button(bM,I);
dE.addListener(co,this.debugButton);
dI.addListener(co,this.debugButton);
dH.addListener(co,this.debugButton);
dL.addListener(co,this.debugButton);
dK.addListener(co,this.debugButton);
dJ.addListener(co,this.debugButton);
dF.addListener(co,this.debugButton);
dG.add(dE);
dG.add(dI);
dG.add(dH);
dG.add(dL);
...
dG.add(dF);
return dG;
},getEditMenu:function(){var eg=new qx.ui.menu.Menu;
var ej=new qx.ui.menu.Button(bH,bB,this.__MQ);
var ei=new qx.ui.menu.Button(bF,bz,this.__MR);
var ef=new qx.ui.menu.Button(cg,cm,this.__MS);
var ek=new qx.ui.menu.Button(cj,ch,this.__MT);
var eh=new qx.ui.menu.Button(ci,ck,this.__MU);
ej.addListener(co,this.debugButton);
ei.addListener(co,this.debugButton);
ef.addListener(co,this.debugButton);
ek.addListener(co,this.debugButton);
eh.addListener(co,this.debugButton);
eg.add(ej);
eg.add(ei);
...
eg.add(eh);
return eg;
},getSearchMenu:function(){var dA=new qx.ui.menu.Menu;
var dy=new qx.ui.menu.Button(bv,cf);
var dD=new qx.ui.menu.Button(bj);
var dz=new qx.ui.menu.Button(R);
var dC=new qx.ui.menu.Button(bR);
var dx=new qx.ui.menu.Button(cs,cf);
var dB=new qx.ui.menu.Button(bm);
dz.setEnabled(false);
dy.addListener(co,this.debugButton);
dD.addListener(co,this.debugButton);
dz.addListener(co,this.debugButton);
dC.addListener(co,this.debugButton);
dx.addListener(co,this.debugButton);
dB.addListener(co,this.debugButton);
dA.add(dy);
dA.add(dD);
...
dA.add(dB);
return dA;
},getViewMenu:function(){var dY=new qx.ui.menu.Menu;
var eb=new qx.ui.menu.Button(bi,null,null,this.getPanesMenu());
var ee=new qx.ui.menu.Button(bJ,null,null,this.getSyntaxMenu());
var ed=new qx.ui.menu.CheckBox(bQ);
var ec=new qx.ui.menu.CheckBox(cb);
var ea=new qx.ui.menu.Button(E);
ed.addListener(cn,this.debugCheckBox);
ec.addListener(cn,this.debugCheckBox);
ea.addListener(co,this.debugButton);
dY.add(eb);
dY.add(ee);
dY.addSeparator();
dY.add(ed);
...
dY.add(ea);
return dY;
},getPanesMenu:function(){var er=new qx.ui.menu.Menu;
var et=new qx.ui.menu.CheckBox(bs);
var ev=new qx.ui.menu.CheckBox(t);
var ew=new qx.ui.menu.CheckBox(cD);
var es=new qx.ui.menu.CheckBox(bo);
var eu=new qx.ui.menu.CheckBox(S);
var eq=new qx.ui.menu.CheckBox(q);
et.setValue(true);
ev.setValue(true);
es.setValue(true);
et.addListener(cn,this.debugCheckBox);
ev.addListener(cn,this.debugCheckBox);
ew.addListener(cn,this.debugCheckBox);
es.addListener(cn,this.debugCheckBox);
eu.addListener(cn,this.debugCheckBox);
eq.addListener(cn,this.debugCheckBox);
er.add(ev);
er.add(et);
er.addSeparator();
er.add(ew);
...
er.add(eq);
return er;
},getSyntaxMenu:function(){var m=new qx.ui.menu.Menu;
var h=new qx.ui.menu.RadioButton(bT);
var k=new qx.ui.menu.RadioButton(V);
var j=new qx.ui.menu.RadioButton(be);
var l=new qx.ui.menu.Button(ca,null,null,this.getSyntaxCMenu());
var p=new qx.ui.menu.RadioButton(bX);
var n=new qx.ui.menu.RadioButton(cF);
m.add(h);
m.add(k);
m.add(j);
m.add(l);
...
o.add(h,k,j,p,n);
o.add.apply(o,l.getMenu().getChildren());
o.addListener(cl,this.debugRadio);
return m;
},getSyntaxCMenu:function(){var dR=new qx.ui.menu.Menu;
var dQ=new qx.ui.menu.RadioButton(cp);
var dU=new qx.ui.menu.RadioButton(cB);
var dT=new qx.ui.menu.RadioButton(by);
var dS=new qx.ui.menu.RadioButton(D);
dR.add(dQ);
dR.add(dU);
dR.add(dT);
dR.add(dS);
return dR;
},getFormatMenu:function(){var dl=new qx.ui.menu.Menu;
var dk=new qx.ui.menu.Button(G,null,null,this.getParagraphMenu());
var dn=new qx.ui.menu.Button(bu);
var dp=new qx.ui.menu.Button(cH);
var dj=new qx.ui.menu.Button(bg);
var dm=new qx.ui.menu.Button(bS);
var di=new qx.ui.menu.Button(bp);
var dr=new qx.ui.menu.Button(W);
var dq=new qx.ui.menu.Button(v);
dn.addListener(co,this.debugButton);
dp.addListener(co,this.debugButton);
dj.addListener(co,this.debugButton);
dm.addListener(co,this.debugButton);
di.addListener(co,this.debugButton);
dr.addListener(co,this.debugButton);
dq.addListener(co,this.debugButton);
dl.add(dk);
dl.add(dn);
dl.add(dp);
dl.addSeparator();
...
dl.add(dq);
return dl;
},getParagraphMenu:function(){var a=new qx.ui.menu.Menu;
var d=new qx.ui.menu.Button(cy,u);
var f=new qx.ui.menu.Button(Y,N);
var b=new qx.ui.menu.Button(w,z);
var c=new qx.ui.menu.Button(bn,cr);
d.addListener(co,this.debugButton);
f.addListener(co,this.debugButton);
b.addListener(co,this.debugButton);
c.addListener(co,this.debugButton);
a.add(d);
a.add(f);
a.add(b);
a.add(c);
return a;
},getHelpMenu:function(){var ds=new qx.ui.menu.Menu;
var du=new qx.ui.menu.Button(bh,cE);
var dw=new qx.ui.menu.Button(ce);
var dv=new qx.ui.menu.Button(cu);
var dt=new qx.ui.menu.Button(bY);
du.addListener(co,this.debugButton);
dw.addListener(co,this.debugButton);
dv.addListener(co,this.debugButton);
dt.addListener(co,this.debugButton);
ds.add(du);
ds.add(dw);
ds.addSeparator();
ds.add(dv);
...
ds.add(dt);
return ds;
},getList:function(){var g=new qx.ui.form.List;
g.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){g.add(new qx.ui.form.ListItem(F+i));
}return g;
},getContextMenu:function(){var de=new qx.ui.menu.Menu;
var dg=new qx.ui.menu.Button(cg,cm,this.__MS);
var dh=new qx.ui.menu.Button(cj,ch,this.__MT);
var df=new qx.ui.menu.Button(ci,ck,this.__MU);
dg.addListener(co,this.debugButton);
dh.addListener(co,this.debugButton);
df.addListener(co,this.debugButton);
de.add(dg);
de.add(dh);
de.add(df);
return de;
}},destruct:function(){this._disposeObjects(cq,bL,Q,B,X,bf,bV,cx);
}});
})();
