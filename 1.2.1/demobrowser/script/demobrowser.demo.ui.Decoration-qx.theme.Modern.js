...
j.setPadding(20);
k.add(j);
j.add(this.getDecorations());
},getDecorations:function(){var e=qx.theme.manager.Decoration.getInstance().getTheme();
...
for(var d in f){b.add(new qx.ui.basic.Label(d).set({decorator:d,padding:5,height:80,width:80}),{row:Math.floor(i/g),column:i%g});
i+=1;
}return b;
}}});
})();
