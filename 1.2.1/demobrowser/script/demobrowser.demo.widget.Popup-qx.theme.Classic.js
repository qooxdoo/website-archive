...
(function(){var l="click",k="icon/32/apps/media-photo-album.png",j="Hello World #1",i="#FFFAD3",h="#DFFAD3",g="Open Popup #2",f="top-right",d="Open Popup #1",c="demobrowser.demo.widget.Popup";
...
m.setSpacing(20);
var n=new qx.ui.container.Composite(m).set({padding:20});
this.getRoot().add(n);
n.add(this._getPopupButton1());
n.add(this._getPopupButton2());
},_getPopupButton1:function(){var a=new qx.ui.form.Button(d);
var b=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:i,padding:[2,4],offset:3,offsetBottom:20});
b.add(new qx.ui.basic.Atom(j,k));
a.addListener(l,function(e){b.placeToMouse(e);
b.show();
},this);
return a;
},_getPopupButton2:function(){var o=new qx.ui.form.Button(g);
var p=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:h,padding:[2,4],offset:3,position:f});
p.add(new qx.ui.basic.Atom(j,k));
o.addListener(l,function(e){p.placeToMouse(e);
p.show();
},this);
return o;
}}});
