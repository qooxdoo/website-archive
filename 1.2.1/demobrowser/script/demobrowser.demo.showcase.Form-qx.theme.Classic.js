...
var bg=new qx.ui.groupbox.GroupBox(b);
bg.setLayout(new qx.ui.layout.Grid(8,8));
bg.setWidth(290);
this.getRoot().add(bg,{left:20,top:10});
var bC=new qx.ui.form.TextField();
bC.setPlaceholder(k);
var bo=new qx.ui.basic.Label(x);
bo.setBuddy(bC);
bg.add(bo,{row:0,column:0});
bg.add(bC,{row:0,column:1});
var bm=new qx.ui.form.PasswordField();
bm.setPlaceholder(S);
bo=new qx.ui.basic.Label(r);
bo.setBuddy(bm);
bg.add(bo,{row:1,column:0});
bg.add(bm,{row:1,column:1});
var bh=new qx.ui.form.TextArea();
bh.setPlaceholder(k);
bo=new qx.ui.basic.Label(g);
bo.setBuddy(bh);
bg.add(bo,{row:2,column:0});
bg.add(bh,{row:2,column:1});
var bi=new qx.ui.form.ComboBox();
bi.setPlaceholder(k);
bo=new qx.ui.basic.Label(P);
bo.setBuddy(bi);
bg.add(bo,{row:3,column:0});
bg.add(bi,{row:3,column:1});
this.createItems(bi);
var bv=new qx.ui.form.DateField();
bv.setPlaceholder(o);
bo=new qx.ui.basic.Label(D);
bo.setBuddy(bv);
bg.add(bo,{row:4,column:0});
bg.add(bv,{row:4,column:1});
var bn=new qx.ui.groupbox.GroupBox(z);
bn.setLayout(new qx.ui.layout.Grid(8,8));
bn.setWidth(290);
this.getRoot().add(bn,{left:20,top:250});
var bw=new qx.ui.form.SelectBox();
bo=new qx.ui.basic.Label(w);
bo.setBuddy(bw);
bn.add(bo,{row:0,column:0});
bn.add(bw,{row:0,column:1});
this.createItems(bw);
var bB=new qx.ui.form.List();
bB.setHeight(60);
bB.setWidth(155);
bo=new qx.ui.basic.Label(l);
bo.setBuddy(bB);
bn.add(bo,{row:1,column:0});
bn.add(bB,{row:1,column:1});
this.createItems(bB);
var bu=new qx.ui.form.RadioButtonGroup();
bu.add(new qx.ui.form.RadioButton(u));
bu.add(new qx.ui.form.RadioButton(C));
bu.add(new qx.ui.form.RadioButton(R));
bo=new qx.ui.basic.Label(A);
bo.setBuddy(bu);
bn.add(bo,{row:2,column:0});
bn.add(bu,{row:2,column:1});
var bz=new qx.ui.groupbox.GroupBox(p);
bz.setLayout(new qx.ui.layout.Grid(8,8));
bz.setWidth(210);
this.getRoot().add(bz,{left:330,top:10});
var bA=new qx.ui.form.Button(j);
bo=new qx.ui.basic.Label(Q);
bo.setBuddy(bA);
bz.add(bo,{row:0,column:0});
bz.add(bA,{row:0,column:1});
var bk=new qx.ui.form.ToggleButton(a);
bo=new qx.ui.basic.Label(O);
bo.setBuddy(bk);
bz.add(bo,{row:1,column:0});
bz.add(bk,{row:1,column:1});
var br=new qx.ui.form.RepeatButton(L);
bo=new qx.ui.basic.Label(e);
bo.setBuddy(br);
bz.add(bo,{row:2,column:0});
bz.add(br,{row:2,column:1});
var bs=new qx.ui.form.MenuButton(H,null,this.createMenuForMenuButton());
bo=new qx.ui.basic.Label(K);
bo.setBuddy(bs);
bz.add(bo,{row:3,column:0});
bz.add(bs,{row:3,column:1});
var bl=new qx.ui.form.SplitButton(s,null,this.createMenuForSplitButton());
bo=new qx.ui.basic.Label(m);
bo.setBuddy(bl);
bz.add(bo,{row:4,column:0});
bz.add(bl,{row:4,column:1});
br.addListener(d,function(){var V=parseInt(br.getLabel())+1;
br.setLabel(V.toString());
});
var bj=new qx.ui.groupbox.GroupBox(f);
bj.setLayout(new qx.ui.layout.Grid(8,8));
bj.setWidth(210);
this.getRoot().add(bj,{left:330,top:210});
var bx=new qx.ui.form.CheckBox(E);
bo=new qx.ui.basic.Label(h);
bo.setBuddy(bx);
bj.add(bo,{row:0,column:0});
bj.add(bx,{row:0,column:1});
var bq=new qx.ui.form.RadioButton(M);
bj.add(new qx.ui.basic.Label(n),{row:1,column:0});
bj.add(bq,{row:1,column:1});
var by=new qx.ui.groupbox.GroupBox(F);
by.setLayout(new qx.ui.layout.Grid(8,8));
by.setWidth(210);
this.getRoot().add(by,{left:330,top:310});
var bp=new qx.ui.form.Spinner(0,50,100);
bo=new qx.ui.basic.Label(B);
bo.setBuddy(bp);
by.add(bo,{row:0,column:0});
by.add(bp,{row:0,column:1});
var bt=new qx.ui.form.Slider();
bt.setWidth(130);
bo=new qx.ui.basic.Label(v);
bo.setBuddy(bt);
by.add(bo,{row:1,column:0});
by.add(bt,{row:1,column:1});
},createItems:function(T){for(var i=0;i<this.self(arguments).ITEM_SIZE;i++){var U=new qx.ui.form.ListItem(y+i);
T.add(U);
}},createMenuForMenuButton:function(){var W=new qx.ui.menu.Menu;

for(var i=0;i<3;i++){W.add(new qx.ui.menu.RadioButton(t+i));
}var ba=new qx.ui.form.RadioGroup;
ba.add.apply(ba,W.getChildren());
var Y=new qx.ui.menu.Menu();

for(var i=0;i<3;i++){var bb=new qx.ui.menu.Button(j+i);
Y.add(bb);
}var X=new qx.ui.menu.Button(N,q,null,W);
Y.addSeparator();
Y.add(X);
return Y;
},createMenuForSplitButton:function(){var bc=new qx.ui.menu.Menu;
var bf=new qx.ui.menu.Button(G);
var bd=new qx.ui.menu.Button(c);
var be=new qx.ui.menu.Button(I);
bc.add(bf);
bc.add(bd);
bc.add(be);
return bc;
