...
}}cw.addListener(bE,function(e){var cF=e.getData();
...
cs.addListener(bB,function(e){if(e.getData()){var cD=cw.getSelectionMode();

if(cD==bC||cD==bG){this.debug("Drag selection is only available for the modes multi or additive");
