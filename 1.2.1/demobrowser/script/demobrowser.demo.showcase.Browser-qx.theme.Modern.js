...
},_createBrowser:function(){var s=new qx.ui.window.Window(f,c);
...
s.add(toolbar);
var t=new qx.ui.toolbar.Button(null,j);
t.addListener(o,function(e){this.iframe.getWindow().history.back();
},this);
toolbar.add(t);
var u=new qx.ui.toolbar.Button(null,g);
u.addListener(o,function(e){this.iframe.getWindow().history.forward();
},this);
toolbar.add(u);
u.setEnabled(false);
t.setEnabled(false);
...
var r=new qx.ui.toolbar.Button(null,b);
r.addListener(o,function(e){this.surfTo(this.txtUrl.getValue());
},this);
toolbar.add(r);
...
return s;
},surfTo:function(p){if(p.indexOf(m)!==0){p=m+p;
this.txtUrl.setValue(p);
}this.iframe.setSource(p);
}}});
})();
