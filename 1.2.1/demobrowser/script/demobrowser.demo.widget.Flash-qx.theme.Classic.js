...
(function(){var k="execute",j="Flash Player Version",i="__MJ",h="__MH",g="right",f="__ML",d="Message from Flash:",c="Simple demo with FlashVars",b="bgcolor",a="demobrowser.demo.widget.Flash",y="demobrowser/demo/flash/FlashVersion.swf",x="Flash:",w="<b>qooxdoo:</b>",v="__MI",u="__MK",t="demobrowser.demo.widget.Flash.sendMessage",s="demobrowser.demo.widget.Flash.flashReady",r="demobrowser/demo/flash/fo_tester.swf",q="this is passed in via FlashVars",p="Two way communication (ActionScript <-> JavaScript)",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__MH:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var J=new qx.ui.tabview.TabView();
J.setContentPadding([8,8,8,8]);
var M=this.getRoot();
M.add(J,{edge:0});
var K=new qx.ui.tabview.Page(c);
K.setLayout(new qx.ui.layout.Canvas());
K.add(this.createFlashDemo1(),{edge:0});
J.add(K);
var L=new qx.ui.tabview.Page(p);
L.setLayout(new qx.ui.layout.Canvas());
L.add(this.createFlashDemo2(),{edge:0});
J.add(L);
this.__MH=this.createWindow();
M.add(this.__MH,{top:20,left:20});
},createWindow:function(){var N=new qx.ui.window.Window(j).set({width:300,height:200,contentPadding:[0,0,0,0]});
N.setLayout(new qx.ui.layout.Canvas());
N.add(new qx.ui.embed.Flash(y),{edge:0});
return N;
},createFlashDemo1:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var z={flashVarText:q};
var A=new qx.ui.embed.Flash(r).set({scale:l,variables:z});
A.getContentElement().setParam(b,m);
B.add(A,{flex:1});
var C=new qx.ui.form.Button(o);
C.addListener(k,function(){this.__MH.open();
},this);
B.add(C);
return B;
},__MI:null,__MJ:null,__MK:null,__ML:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var H=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var G=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
H.add(G,{flex:1});
G.add(new qx.ui.basic.Label(w).set({rich:true}));
G.add(new qx.ui.basic.Label(d));
this.__MJ=new qx.ui.form.TextArea("No message.");
this.__MJ.setEnabled(false);
G.add(this.__MJ,{flex:1});
G.add(new qx.ui.basic.Label(n));
this.__MK=new qx.ui.form.TextArea("qooxdoo is the best!");
G.add(this.__MK,{flex:1});
var I=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,g));
this.__ML=new qx.ui.form.Button("Send to Flash");
this.__ML.setEnabled(false);
this.__ML.addListener(k,function(e){this.__MI.getFlashElement().sendMessage(this.__MK.getValue());
},this);
I.add(this.__ML);
G.add(I);
var F=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
H.add(F,{flex:1});
F.add(new qx.ui.basic.Label(x).set({rich:true}));
this.__MI=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__MI.setVariables({init:s});
F.add(this.__MI,{flex:1});
return H;
},sendMessage:function(E){this.__MJ.setValue(E);
},initFlash:function(){if(this.__MI.getFlashElement().setup){this.__MI.getFlashElement().setup(t);
this.__ML.setEnabled(true);
...
}}},statics:{__MM:null,setCallBackInstance:function(D){demobrowser.demo.widget.Flash.__MM=D;
},sendMessage:function(O){demobrowser.demo.widget.Flash.__MM.sendMessage(O);
},flashReady:function(){demobrowser.demo.widget.Flash.__MM.initFlash();
}},destruct:function(){this._disposeObjects(i,u,f,v,h);
}});
})();
...
qx.Class.define(p,{extend:qx.ui.core.Widget,construct:function(U,V){qx.ui.core.Widget.call(this);
{};
this.setSource(U);
...
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bk,bl){this.__Hm(e,bk);
},_applyScale:function(bb,bc){this.__Hm(a,bb);
},_applyWmode:function(Y,ba){this.__Hm(O,Y);
},_applyPlay:function(br,bs){this.__Hm(s,br);
},_applyLoop:function(bt,bu){this.__Hm(J,bt);
},_applyMenu:function(bv,bw){this.__Hm(L,bv);
},_applyAllowScriptAccess:function(bp,bq){this.__Hm(I,bp);
},_applyLiveConnect:function(S,T){this.__Hm(o,S);
},__Hm:function(W,X){this.getContentElement().setParam(W,X);
qx.ui.core.queue.Layout.add(this);
}}});
})();
(function(){var d="div",c="movie",b="id",a="qx.html.Flash";
qx.Class.define(a,{extend:qx.html.Element,construct:function(i,j){qx.html.Element.call(this,d,i,j);
this.__Go={};
this.__Gp={};
this.__Gq={};
},members:{__Go:null,__Gq:null,__Gp:null,__Gr:null,_createDomElement:function(){return qx.bom.Element.create(d);
},createFlash:function(){this.__Gr=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Gp,this.__Go);
},setSource:function(e){{};

if(this.__Gr){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,e);
},setId:function(k){{};

if(this.__Gr){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(b,k);
},getVariables:function(){return this.__Gp;
},setVariables:function(h){{};

if(this.__Gr){throw new Error("The variables cannot be modified after initial creation");
}this.__Gp=h;
},getAttributes:function(){return this.__Gq;
},setAttribute:function(f,g){{};

if(this.__Gr){throw new Error("The attributes cannot be modified after initial creation");
}
if(g===null||g===undefined){delete this.__Gq[f];
}else{this.__Gq[f]=g;
}},getParams:function(){return this.__Go;
},setParam:function(l,m){{};

if(this.__Gr){throw new Error("The params cannot be modified after initial creation");
}
if(m===null||m===undefined){delete this.__Go[l];
}else{this.__Go[l]=m;
}},getFlashElement:function(){return this.__Gr;
}},destruct:function(){if(this.__Gr){qx.bom.Flash.destroy(this.__Gr);
}this.__Go=this.__Gp=this.__Gq=null;
}});
})();
