...
var bd=new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
bd.setPadding(20);
M.add(bd);
this.getRoot().add(M,{edge:0});
toolbar=new qx.ui.toolbar.ToolBar();
bd.add(toolbar);
var bh=new qx.ui.toolbar.Part();
var O=new qx.ui.toolbar.Button(F,D);
var T=new qx.ui.toolbar.Button(q,A);
var P=new qx.ui.toolbar.Button(y,d);
var bf=new qx.ui.toolbar.Button(r,G);
bh.add(O);
bh.add(new qx.ui.toolbar.Separator());
bh.add(T);
bh.add(P);
bh.add(bf);
toolbar.add(bh);
var bi=new qx.ui.toolbar.Part();
var N=new qx.ui.toolbar.CheckBox(u,h);
bi.add(N);
toolbar.add(bi);
var bj=new qx.ui.toolbar.Part();
var ba=new qx.ui.toolbar.RadioButton(f,c);
var Y=new qx.ui.toolbar.RadioButton(s,j);
var X=new qx.ui.toolbar.RadioButton(v,x);
bj.add(ba);
bj.add(Y);
bj.add(X);
toolbar.add(bj);
var bk=new qx.ui.form.RadioGroup(ba,Y,X);
bk.setAllowEmptySelection(true);
toolbar.addSpacer();
var L=new qx.ui.toolbar.Button(t,C);
toolbar.add(L);
var S=[O,T,P,bf,N,ba,Y,X,L];
var U=new qx.ui.layout.Grid();
U.setSpacing(10);
var bb=new qx.ui.container.Composite(U);
bd.add(bb);
var W=new qx.ui.form.RadioButton(k);
W.setValue(true);
var bl=new qx.ui.form.RadioButton(g);
var V=new qx.ui.form.RadioButton(b);
var bc=new qx.ui.form.RadioGroup();
bc.add(W,bl,V);
bb.add(new qx.ui.basic.Label(n),{row:0,column:0});
bb.add(W,{row:0,column:1});
bb.add(bl,{row:0,column:2});
bb.add(V,{row:0,column:3});
bc.addListener(l,function(e){var J=e.getData()[0];
var I,K,H;

for(var i=0;i<S.length;i++){I=S[i];
H=I.getIcon();
...
var R=new qx.ui.form.RadioButton(p);
R.setValue(true);
var bg=new qx.ui.form.RadioButton(w);
var Q=new qx.ui.form.RadioButton(B);
var be=new qx.ui.form.RadioGroup();
be.add(R,bg,Q);
bb.add(new qx.ui.basic.Label(a),{row:1,column:0});
bb.add(R,{row:1,column:1});
bb.add(bg,{row:1,column:2});
bb.add(Q,{row:1,column:3});
be.addListener(l,function(e){if(e.getData()[0]==R){toolbar.setShow(m);
}else if(e.getData()[0]==bg){toolbar.setShow(z);
}else if(e.getData()[0]==Q){toolbar.setShow(o);
}},this);
}}});
})();
