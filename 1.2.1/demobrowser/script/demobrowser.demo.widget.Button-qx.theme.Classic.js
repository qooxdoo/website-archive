...
(function(){var q="0",p="white",o="main",n="execute",m="Button A",l="#AAA",k="icon/22/actions/list-add.png",j="Button B",i="demobrowser.demo.widget.Button",h="icon/22/apps/internet-web-browser.png",d="Hover",g="icon/22/apps/media-video-player.png",f="icon/22/apps/internet-mail.png",c="changeValue",b="Toggle Button";
...
y.setPadding(20);
this.getRoot().add(y,{left:0,top:0});
this.addNormalButtons(y);
this.addToggleButton(y);
this.addRepeatButton(y);
this.addHoverButton(y);
},addNormalButtons:function(r){var s=new qx.ui.form.Button(m,g);
r.add(s);
var t=new qx.ui.form.Button(j,f);
t.setEnabled(false);
r.add(t);
},addToggleButton:function(u){var v=new qx.ui.form.ToggleButton(b,h);
v.focus();
u.add(v);
v.addListener(c,function(e){this.debug("Checked: "+e.getData());
},this);
},addRepeatButton:function(C){var D=new qx.ui.form.RepeatButton(null,k);
C.add(D);
var E=new qx.ui.basic.Label(q);
E.setDecorator(o);
E.setPadding(2,4);
E.setBackgroundColor(p);
C.add(E);
D.addListener(n,function(){var a=parseInt(E.getValue())+1;
E.setValue(a.toString());
});
},addHoverButton:function(z){var A=new qx.ui.form.HoverButton(d).set({padding:10,backgroundColor:l});
z.add(A);
...
z.add(B);
A.addListener(n,function(){var w=parseInt(B.getValue())+1;
B.setValue(w.toString());
});
}}});
})();
