...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Table_Header-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d78c7f2f63cf"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var j=new qx.ui.table.pane.Header(this.getScrollerMock());
this.getRoot().add(j,{left:10,top:10});
j.onPaneModelChanged();
j.setColumnWidth(0,150);
j.addListener(d,function(e){var m=e.getTarget();

if(m instanceof qx.ui.table.headerrenderer.HeaderCell){var n=j._indexOf(m);
j.setMouseOverColumn(n);
}});
var l=new qx.ui.form.ToggleButton(h);
this.getRoot().add(l,{left:20,top:100});
l.addListener(c,function(e){var i=e.getData();

if(i){l.setLabel(b);
j.showColumnMoveFeedback(1,50);
}else{l.setLabel(h);
j.hideColumnMoveFeedback();
}});
var k=new qx.ui.form.Button(f);
this.getRoot().add(k,{left:20,top:140});
k.addListener(a,function(){j.onPaneModelChanged();
});
}}});
})();
