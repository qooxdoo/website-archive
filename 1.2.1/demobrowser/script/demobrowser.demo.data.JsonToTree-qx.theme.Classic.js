...
r.bind(m,q,m);
r.bind(h,status,f);
r.addListener(c,function(s){p.getRoot().setOpen(true);
},this);
var n=new qx.ui.basic.Label();
n.setRich(true);
n.setWidth(260);
n.setValue(a+i+o+d+j);
