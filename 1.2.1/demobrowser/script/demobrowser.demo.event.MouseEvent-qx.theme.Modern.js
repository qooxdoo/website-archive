...
}qx.bom.Element.addListener(J,l,this.__ME,this);
}var H=document.getElementById(a);
H.checked=false;
qx.bom.Element.addListener(H,l,function(e){var C=e.getTarget().checked;

if(C){qx.bom.Element.capture(G);
}else{qx.bom.Element.releaseCapture(G);
}},this);
qx.bom.Element.addListener(G,o,function(e){H.checked=false;
},this);
},__ME:function(e){var F=e.getTarget().id.split("_")[1];
var D=e.getTarget().checked;
var E=document.getElementById("mouse");

if(D){qx.bom.Element.addListener(E,F,this.logMouseEvent,this);
}else{qx.bom.Element.removeListener(E,F,this.logMouseEvent,this);
