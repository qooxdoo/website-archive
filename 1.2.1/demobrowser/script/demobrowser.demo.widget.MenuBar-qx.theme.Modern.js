...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.MenuBar","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.MenuBar-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7fa258bda881"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var bJ="execute",bI="changeValue",bH="icon/16/actions/system-search.png",bG="Online Forum",bF="New",bE="icon/16/actions/edit-cut.png",bD="Search in files",bC="icon/16/actions/format-justify-fill.png",bB="Left aligned",bA="Undo",bp="_openCommand",bo="Uppercase",bn="View",bm="C Dialect",bl="changeSelection",bk="Save as...",bj="Show line numbers",bi="Search previous...",bh="Quickstart",bg="Cut",bQ="Ctrl+N",bR="C",bO="Show console",bP="Search",bM="Help",bN="_redoCommand",bK="Redo",bL="Show status bar",bS="icon/16/actions/format-justify-left.png",bT="ANSI to OEM",bt="Centered",bs="Paragraph",bv="Edit",bu="Ctrl+O",bx="icon/16/actions/document-print.png",bw="icon/16/actions/document-open.png",bz="C Sharp",by="icon/16/actions/edit-undo.png",br="Close",bq="icon/16/actions/document-save-as.png",j="Python",k="icon/16/apps/utilities-help.png",l="Show tree",m="Spaces to tabs",n="Right aligned",o="OEM to ANSI",p="JavaScript",q="demobrowser.demo.widget.MenuBar",r="_copyCommand",s="XML",bX="Save",bW="_undoCommand",bV="Capitals",bU="icon/16/actions/application-exit.png",cc="C Plus Plus",cb="_saveCommand",ca="Lowercase",bY="Search next...",ce="_newCommand",cd="Replace in files",P="Perl",Q="Ctrl+P",N="Topics",O="Panes",T="Justified",U="Ctrl+X",R="Show macros",S="Show ruler",L="Copy",M="Paste",A="_pasteCommand",z="icon/16/actions/format-justify-right.png",C="Ctrl+Z",B="Ctrl+R",w="icon/16/actions/edit-redo.png",v="Show tags",y="Info...",x="Format",u="File",t="Show tabs",ba="Print",bb="icon/16/actions/document-save.png",bc="icon/16/actions/edit-copy.png",bd="Search...",V="icon/16/actions/format-justify-center.png",W="Open",X="_cutCommand",Y="Objective C",be="Exit",bf="Ctrl+S",K="Syntax",J="Ctrl+C",I="icon/16/actions/document-new.png",H="Tabs to spaces",G="ASCII table",F="Replace",E="HTML",D="icon/16/actions/edit-paste.png";
...
var di=new qx.ui.container.Scroll();
var dh=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
dh.setPadding(20);
dh.setAllowStretchX(false);
di.add(dh);
this.getRoot().add(di,{edge:0});
this.createCommands();
dh.add(this.getMenuBar(),{left:20,top:20});
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(bQ);
this._newCommand.addListener(bJ,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bu);
this._openCommand.addListener(bJ,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(bf);
this._saveCommand.addListener(bJ,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(C);
this._undoCommand.addListener(bJ,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(B);
this._redoCommand.addListener(bJ,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(U);
this._cutCommand.addListener(bJ,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(J);
this._copyCommand.addListener(bJ,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(Q);
this._pasteCommand.addListener(bJ,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuBar:function(){var dr=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
dr.add(menubar);
var dq=new qx.ui.menubar.Button(u,null,this.getFileMenu());
var dp=new qx.ui.menubar.Button(bv,null,this.getEditMenu());
var ds=new qx.ui.menubar.Button(bP,null,this.getSearchMenu());
var dv=new qx.ui.menubar.Button(bn,null,this.getViewMenu());
var du=new qx.ui.menubar.Button(x,null,this.getFormatMenu());
var dt=new qx.ui.menubar.Button(bM,null,this.getHelpMenu());
menubar.add(dq);
menubar.add(dp);
menubar.add(ds);
menubar.add(dv);
...
var cp=new qx.ui.menu.Button(bF,I,this._newCommand);
var ct=new qx.ui.menu.Button(W,bw,this._openCommand);
var cs=new qx.ui.menu.Button(br);
var cw=new qx.ui.menu.Button(bX,bb,this._saveCommand);
var cv=new qx.ui.menu.Button(bk,bq);
var cu=new qx.ui.menu.Button(ba,bx);
var cq=new qx.ui.menu.Button(be,bU);
cp.addListener(bJ,this.debugButton);
ct.addListener(bJ,this.debugButton);
cs.addListener(bJ,this.debugButton);
cw.addListener(bJ,this.debugButton);
cv.addListener(bJ,this.debugButton);
cu.addListener(bJ,this.debugButton);
cq.addListener(bJ,this.debugButton);
cr.add(cp);
cr.add(ct);
cr.add(cs);
cr.add(cw);
...
cr.add(cq);
return cr;
},getEditMenu:function(){var cV=new qx.ui.menu.Menu;
var cY=new qx.ui.menu.Button(bA,by,this._undoCommand);
var cX=new qx.ui.menu.Button(bK,w,this._redoCommand);
var cU=new qx.ui.menu.Button(bg,bE,this._cutCommand);
var da=new qx.ui.menu.Button(L,bc,this._copyCommand);
var cW=new qx.ui.menu.Button(M,D,this._pasteCommand);
cY.addListener(bJ,this.debugButton);
cX.addListener(bJ,this.debugButton);
cU.addListener(bJ,this.debugButton);
da.addListener(bJ,this.debugButton);
cW.addListener(bJ,this.debugButton);
cV.add(cY);
cV.add(cX);
cV.addSeparator();
...
cV.add(cW);
return cV;
},getSearchMenu:function(){var cQ=new qx.ui.menu.Menu;
var cO=new qx.ui.menu.Button(bd,bH);
var cT=new qx.ui.menu.Button(bY);
var cP=new qx.ui.menu.Button(bi);
var cS=new qx.ui.menu.Button(F);
var cN=new qx.ui.menu.Button(bD,bH);
var cR=new qx.ui.menu.Button(cd);
cP.setEnabled(false);
cO.addListener(bJ,this.debugButton);
cT.addListener(bJ,this.debugButton);
cP.addListener(bJ,this.debugButton);
cS.addListener(bJ,this.debugButton);
cN.addListener(bJ,this.debugButton);
cR.addListener(bJ,this.debugButton);
cQ.add(cO);
cQ.add(cT);
cQ.add(cP);
cQ.add(cS);
...
cQ.add(cR);
return cQ;
},getViewMenu:function(){var db=new qx.ui.menu.Menu;
var dd=new qx.ui.menu.Button(O,null,null,this.getPanesMenu());
var dg=new qx.ui.menu.Button(K,null,null,this.getSyntaxMenu());
var df=new qx.ui.menu.CheckBox(S);
var de=new qx.ui.menu.CheckBox(bj);
var dc=new qx.ui.menu.Button(G);
df.addListener(bI,this.debugCheckBox);
de.addListener(bI,this.debugCheckBox);
dc.addListener(bJ,this.debugButton);
db.add(dd);
db.add(dg);
db.addSeparator();
db.add(df);
...
var cJ=new qx.ui.menu.CheckBox(t);
var cL=new qx.ui.menu.CheckBox(bL);
var cM=new qx.ui.menu.CheckBox(l);
var cI=new qx.ui.menu.CheckBox(R);
var cK=new qx.ui.menu.CheckBox(v);
var cG=new qx.ui.menu.CheckBox(bO);
cJ.setValue(true);
cL.setValue(true);
cI.setValue(true);
cJ.addListener(bI,this.debugCheckBox);
cL.addListener(bI,this.debugCheckBox);
cM.addListener(bI,this.debugCheckBox);
cI.addListener(bI,this.debugCheckBox);
cK.addListener(bI,this.debugCheckBox);
cG.addListener(bI,this.debugCheckBox);
cH.add(cL);
cH.add(cJ);
cH.addSeparator();
cH.add(cM);
...
var a=new qx.ui.menu.RadioButton(E);
var c=new qx.ui.menu.RadioButton(s);
var b=new qx.ui.menu.RadioButton(p);
var d=new qx.ui.menu.Button(bm,null,null,this.getSyntaxCMenu());
var i=new qx.ui.menu.RadioButton(P);
var g=new qx.ui.menu.RadioButton(j);
f.add(a);
f.add(c);
f.add(b);
f.add(d);
...
h.addListener(bl,this.debugRadio);
return f;
},getSyntaxCMenu:function(){var dk=new qx.ui.menu.Menu;
var dj=new qx.ui.menu.RadioButton(bR);
var dn=new qx.ui.menu.RadioButton(bz);
var dm=new qx.ui.menu.RadioButton(Y);
var dl=new qx.ui.menu.RadioButton(cc);
dk.add(dj);
dk.add(dn);
dk.add(dm);
dk.add(dl);
return dk;
},getFormatMenu:function(){var cA=new qx.ui.menu.Menu;
var cz=new qx.ui.menu.Button(bs,null,null,this.getParagraphMenu());
var cC=new qx.ui.menu.Button(H);
var cD=new qx.ui.menu.Button(m);
var cy=new qx.ui.menu.Button(bo);
var cB=new qx.ui.menu.Button(ca);
var cx=new qx.ui.menu.Button(bV);
var cF=new qx.ui.menu.Button(o);
var cE=new qx.ui.menu.Button(bT);
cC.addListener(bJ,this.debugButton);
cD.addListener(bJ,this.debugButton);
cy.addListener(bJ,this.debugButton);
cB.addListener(bJ,this.debugButton);
cx.addListener(bJ,this.debugButton);
cF.addListener(bJ,this.debugButton);
cE.addListener(bJ,this.debugButton);
cA.add(cz);
cA.add(cC);
cA.add(cD);
cA.addSeparator();
...
cA.add(cE);
return cA;
},getParagraphMenu:function(){var ck=new qx.ui.menu.Menu;
var cn=new qx.ui.menu.Button(bB,bS);
var co=new qx.ui.menu.Button(n,z);
var cl=new qx.ui.menu.Button(bt,V);
var cm=new qx.ui.menu.Button(T,bC);
cn.addListener(bJ,this.debugButton);
co.addListener(bJ,this.debugButton);
cl.addListener(bJ,this.debugButton);
cm.addListener(bJ,this.debugButton);
ck.add(cn);
ck.add(co);
ck.add(cl);
ck.add(cm);
return ck;
},getHelpMenu:function(){var cf=new qx.ui.menu.Menu;
var ch=new qx.ui.menu.Button(N,k);
var cj=new qx.ui.menu.Button(bh);
var ci=new qx.ui.menu.Button(bG);
var cg=new qx.ui.menu.Button(y);
ch.addListener(bJ,this.debugButton);
cj.addListener(bJ,this.debugButton);
ci.addListener(bJ,this.debugButton);
cg.addListener(bJ,this.debugButton);
cf.add(ch);
cf.add(cj);
cf.addSeparator();
cf.add(ci);
...
cf.add(cg);
return cf;
}},destruct:function(){this._disposeObjects(ce,bp,cb,bW,bN,X,r,A);
}});
})();
