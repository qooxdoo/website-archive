...
(function(){var f="main",e="green",d="yellow",c="demobrowser.demo.layout.HBox_Flex";
...
var p=new qx.ui.container.Composite(o).set({width:500,decorator:f,backgroundColor:d,allowGrowX:false});
o.setSpacing(5);
p.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:1});
p.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:2});
p.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:3});
return p;
},getBox2:function(){var a=new qx.ui.layout.HBox();
var b=new qx.ui.container.Composite(a).set({width:500,decorator:f,backgroundColor:d,allowGrowX:false});
a.setSpacing(5);
b.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:30}),{flex:1});
b.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{flex:2});
b.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:150}),{flex:3});
return b;
},getBox3:function(){var q=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(q).set({width:500,decorator:f,backgroundColor:d,allowGrowX:false});
q.setSpacing(5);

for(var i=0;i<25;i++){var r=new qx.ui.core.Widget();
r.set({decorator:f,backgroundColor:e,width:5});
s.add(r,{flex:1});
}return s;
},getBox4:function(){var m=new qx.ui.layout.HBox();
var n=new qx.ui.container.Composite(m).set({width:600,minWidth:600,decorator:f,backgroundColor:d,allowGrowX:false});
m.setSpacing(5);
n.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:120}),{flex:1});
n.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:120}),{flex:2});
n.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,maxWidth:120}),{flex:3});
return n;
},getBox5:function(){var h=new qx.ui.layout.HBox();
var j=new qx.ui.container.Composite(h).set({width:300,minWidth:0,decorator:f,backgroundColor:d,allowGrowX:false});
h.setSpacing(5);
j.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:3});
return j;
},getBox6:function(){var k=new qx.ui.layout.HBox();
var l=new qx.ui.container.Composite(k).set({width:300,decorator:f,backgroundColor:d,allowGrowX:false});
k.setSpacing(5);
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e,minWidth:120}),{flex:3});
return l;
}}});
})();
