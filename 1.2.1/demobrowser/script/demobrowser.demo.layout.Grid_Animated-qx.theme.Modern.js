...
return o;
},getAnimGrid:function(){var m=new qx.ui.container.Composite().set({decorator:a,backgroundColor:g,width:500,height:500});
var n=new qx.ui.layout.Grid();
n.setSpacing(3);
m.setLayout(n);
this._active=null;

for(var x=0;x<7;x++){n.setColumnFlex(x,1);
n.setRowFlex(x,1);

for(var y=0;y<7;y++){m.add(this.getNewWidget(),{row:y,column:x});
}}return m;
}}});
})();
