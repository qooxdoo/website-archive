...
var V=this._eventsWin=new qx.ui.window.Window(l).set({height:400,width:290,showClose:false,showMinimize:false,contentPadding:0});
...
var L=function(e){var W=e.getData();
this._events.addRows([[e.getType(),W.ascending?B:n,W.columnIndex]],0);
};
