...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Spinner","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Spinner-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"1952bdb946ed"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(m,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(x,y){var z=new qx.ui.form.Spinner();
x.add(new qx.ui.basic.Label(f),{column:0,row:y});
x.add(new qx.ui.basic.Label(s),{column:1,row:y});
x.add(z,{column:2,row:y});
x.add(new qx.ui.basic.Label(q),{column:3,row:y});
z.addListener(b,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(A,B){var C=new qx.ui.form.Spinner(0,50,100);
C.setEditable(false);
A.add(new qx.ui.basic.Label(n),{column:0,row:B});
A.add(new qx.ui.basic.Label(s),{column:1,row:B});
A.add(C,{column:2,row:B});
A.add(new qx.ui.basic.Label(q),{column:3,row:B});
},addWrappingSpinner:function(F,G){var H=new qx.ui.form.Spinner(-30,30,30);
H.setWrap(true);
F.add(new qx.ui.basic.Label(k),{column:0,row:G});
F.add(new qx.ui.basic.Label(a),{column:1,row:G});
F.add(H,{column:2,row:G});
F.add(new qx.ui.basic.Label(c),{column:3,row:G});
},addSteppedSpinner:function(L,M){var N=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
L.add(new qx.ui.basic.Label(l),{column:0,row:M});
L.add(new qx.ui.basic.Label(j),{column:1,row:M});
L.add(N,{column:2,row:M});
L.add(new qx.ui.basic.Label(g),{column:3,row:M});
},addDisabledSpinner:function(I,J){var K=new qx.ui.form.Spinner;
K.setEnabled(false);
I.add(new qx.ui.basic.Label(o),{column:0,row:J});
I.add(new qx.ui.basic.Label(s),{column:1,row:J});
I.add(K,{column:2,row:J});
I.add(new qx.ui.basic.Label(q),{column:3,row:J++});
},addFormattedSpinner:function(t,u){var v=new qx.ui.form.Spinner(0,200,300);
v.setSingleStep(0.5);
v.setWidth(70);
var w=new qx.util.format.NumberFormat();
w.setMinimumFractionDigits(2);
w.setMaximumFractionDigits(2);
v.setNumberFormat(w);
t.add(new qx.ui.basic.Label(d),{column:0,row:u});
t.add(new qx.ui.basic.Label(s),{column:1,row:u});
t.add(v,{column:2,row:u});
t.add(new qx.ui.basic.Label(i),{column:3,row:u++});
},main:function(){qx.application.Standalone.prototype.main.call(this);
var E=new qx.ui.layout.Grid(10,8);
E.setColumnAlign(0,p,r);
E.setColumnAlign(1,h,r);
E.setColumnAlign(2,p,r);
E.setColumnAlign(3,p,r);
var D=new qx.ui.container.Composite(E);
D.setPadding(10);
this.getRoot().add(D,{left:0,top:0});
this.addSimpleSpinner(D,0);
this.addNonEditableSpinner(D,1);
this.addWrappingSpinner(D,2);
this.addSteppedSpinner(D,3);
this.addDisabledSpinner(D,4);
this.addFormattedSpinner(D,5);
}}});
})();
