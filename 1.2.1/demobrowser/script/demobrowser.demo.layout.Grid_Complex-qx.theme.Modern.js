...
return o;
},getGrid2:function(){var j=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,width:500,allowShrinkX:false,allowShrinkY:false,allowGrowX:false});
var m=new qx.ui.layout.Grid();
m.setColumnFlex(1,2);
m.setRowFlex(1,3);
m.setColumnMinWidth(0,70);
m.setColumnMinWidth(1,100);
m.setColumnMaxWidth(2,150);
m.setRowMinHeight(0,70);
m.setSpacing(5);
j.setLayout(m);
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:0});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:1,rowSpan:1,colSpan:2});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:1,column:0});
var l=new qx.ui.container.Composite().set({decorator:i,backgroundColor:b,width:400,padding:5});
j.add(l,{row:1,column:1,rowSpan:2,colSpan:2});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:2,column:0});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:3,column:0,rowSpan:1,colSpan:2});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:3,column:2});
var k=new qx.ui.layout.Grid();
l.setLayout(k);
k.setColumnAlign(1,e,d);
k.setColumnAlign(0,a,f);
k.setColumnMinWidth(1,40);
k.setSpacing(5);
k.setColumnFlex(1,1);
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,width:150}),{row:0,column:0});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,height:70,allowGrowX:false}),{row:0,column:1});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:60,allowGrowX:false}),{row:1,column:0});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,minWidth:170}),{row:2,column:0});
return j;
}}});
})();
