...
y.add(this.getGrid1());
},getGrid1:function(){var v=new qx.ui.container.Composite().set({textColor:r});
var u=new qx.ui.layout.Grid();
u.setSpacing(20);
v.setLayout(u);
var w=[d,m,g,f,k,e,h,n,j,l,q,t,p,a,c];
var i=0;

for(var i=0;i<15;i++){v.add(new qx.ui.basic.Label(w[i]).set({decorator:s,backgroundColor:o,cursor:w[i],padding:5,height:100,width:100}),{row:Math.floor(i/5),column:i%5});
}return v;
}}});
})();
