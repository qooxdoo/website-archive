...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox_NegativeMargin","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"9bbc78f54e89"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(o);
o.add(this.getBox1());
o.add(this.getBox2());
o.add(this.getBox3());
...
o.add(this.getBox6());
o.add(this.getBox7());
},getBox1:function(){var z=new qx.ui.layout.VBox();
var B=new qx.ui.container.Composite(z).set({decorator:i,backgroundColor:h,width:140,allowGrowY:false});
...
A.setMarginTop(-10);
return B;
},getBox2:function(){var E=new qx.ui.layout.VBox();
var G=new qx.ui.container.Composite(E).set({decorator:i,backgroundColor:h,width:140,allowGrowY:false});
...
F.setMarginTop(-10);
return G;
},getBox3:function(){var j=new qx.ui.layout.VBox();
var l=new qx.ui.container.Composite(j).set({decorator:i,backgroundColor:h,width:140,height:300,allowGrowY:false});
...
k.setMarginTop(-10);
return l;
},getBox4:function(){var p=new qx.ui.layout.VBox();
var r=new qx.ui.container.Composite(p).set({decorator:i,backgroundColor:h,width:140,height:300,allowGrowY:false});
...
q.setMarginTop(-10);
return r;
},getBox5:function(){var u=new qx.ui.layout.VBox();
...
}},properties:{sort:{check:[l,m,n],init:l,apply:j},separatorX:{check:p,nullable:true,apply:s},separatorY:{check:p,nullable:true,apply:s},connectSeparators:{check:e,init:false,apply:s},spacingX:{check:o,init:0,apply:s},spacingY:{check:o,init:0,apply:s}},members:{__Be:null,__Bf:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__Bg:{north:1,south:2,west:3,east:4,center:5},__Bh:{1:q,2:d,3:r,4:g},__Bi:function(){var x=this._getLayoutChildren();
var F,z;
var length=x.length;
var B=[];
var E=[];
...
},renderLayout:function(bf,bg){if(this._invalidChildrenCache){this.__Bi();
...
bR=bE+bz.computeHorizontalAlignOffset(bi.getAlignX()||r,bs,bf,bt,bl);
...
top=bx+bz.computeVerticalAlignOffset(bi.getAlignY()||q,bj,bg,bP,bq);
...
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__Bi();
}var K=this.__Be;
var U=this.__Bf;
var length=K.length;
var O,V;
...
var S=0,bc=0;
var I=0,W=0;
var Y=this._getSeparatorWidths();
var bb=this.getSpacingX(),ba=this.getSpacingY();
var M=-bb,L=-ba;

if(Y.x){M-=Y.x+bb;
}
if(Y.y){L-=Y.y+ba;
}for(var i=0;i<length;i++){V=K[i];
O=V.getSizeHint();
Q=V.getMarginLeft()+V.getMarginRight();
P=V.getMarginTop()+V.getMarginBottom();
switch(U[i]){case 1:case 2:S=Math.max(S,O.width+R+Q);
bc=Math.max(bc,O.minWidth+bd+Q);
I+=O.height+P;
W+=O.minHeight+P;
L+=ba;
...
case 3:case 4:H=Math.max(H,O.height+I+P);
X=Math.max(X,O.minHeight+W+P);
R+=O.width+Q;
bd+=O.minWidth+Q;
M+=bb;
...
if(Y.y){L+=Y.y+ba;
}}}var N=Math.max(bd,bc)+M;
var be=Math.max(R,S)+M;
var T=Math.max(X,W)+L;
var J=Math.max(H,I)+L;
return {minWidth:N,width:be,minHeight:T,height:J};
}},destruct:function(){this.__Bf=this.__Be=null;
}});
})();
...
this.setWidget(I);
},_createWidgetIndicator:function(){var U=new qx.ui.container.Composite(new qx.ui.layout.VBox().set({spacing:5}));
U.add(this._createLabel(n));
this._widgetIndicator=new qx.ui.basic.Label().set({height:30,allowGrowX:true,allowGrowY:true,padding:5});
U._add(this._widgetIndicator);
return U;
},_createLabel:function(C){return new qx.ui.basic.Label(C).set({font:k,allowGrowX:true,padding:[5,0,5,0]});
...
this._wlpe=G;
},updateLayoutPropertyEditor:function(z){var B=z.getLayout?z.getLayout():null;
var A=this.getLayoutPropertyEditor(B);

if(A){A.getChildren()[1].setSelected(B);
}
if(A===this._lpe){return;
}
...
this._lpe=A;
},getWidgetLayoutPropertyEditor:function(O){if(!O){return null;
}var name=c+O.constructor.classname;
var P;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case w:case u:P=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BOX_PROPERTIES);
break;
case v:P=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.CANVAS_PROPERTIES);
break;
case p:P=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.BASIC_PROPERTIES);
break;
case d:P=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.DOCK_PROPERTIES);
break;
case j:P=new demobrowser.demo.util.LayoutPropertyGroup(demobrowser.demo.util.LayoutPropertyGroup.GRID_PROPERTIES);
break;
}
if(!P){return null;
}this._editorGroups[name]=this._createContainer(O.constructor.classname+t,P);
return this._editorGroups[name];
},getLayoutPropertyEditor:function(D){if(!D){return null;
}var name=a+D.constructor.classname;
var E;

if(this._editorGroups[name]){return this._editorGroups[name];
}
switch(name){case f:E=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.HBOX_PROPERTIES);
break;
case b:E=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.DOCK_PROPERTIES);
break;
case o:E=new demobrowser.demo.util.PropertyGroup(demobrowser.demo.util.PropertyGroup.GRID_PROPERTIES);
break;
}
if(!E){return null;
}this._editorGroups[name]=this._createContainer(D.constructor.classname+q,E);
return this._editorGroups[name];
...
if(O){var N=new qx.ui.form.CheckBox(j);
N.addListener(r,this._createOnNullPropertyChange(P),this);
this._add(N,{row:T,column:2});
this._properties[P].nullWidget=N;
}
if(S==o){var R=new qx.ui.form.Spinner().set({minimum:this._properties[P].min||0,maximum:this._properties[P].max!==undefined?this._properties[P].max:1000});
R.addListener(r,this._createOnIntPropertyChange(P),this);
this._add(R,{row:T++,column:1});
}else if(S==m){var R=new qx.ui.form.CheckBox();
R.addListener(r,this._createOnBoolPropertyChange(P),this);
this._add(R,{row:T++,column:1});
}else if(S==q){var Q=this._properties[P].values;
...
}R.addListener(c,this._createOnEnumPropertyChange(P,R),this);
}else if(S==n){var R=new qx.ui.form.TextField();
R.setLiveUpdate(true);
R.addListener(r,this._createOnIntPropertyChange(P),this);
this._add(R,{row:T++,column:1});
}this._properties[P].formItem=R;
}},statics:{WIDGET_PROPERTIES:{"width":{type:"int",nullable:true},"height":{type:"int",nullable:true},"minWidth":{type:"int",nullable:true},"minHeight":{type:"int",nullable:true},"maxWidth":{type:"int",nullable:true},"maxHeight":{type:"int",nullable:true},"allowGrowX":{type:"bool",nullable:false},"allowGrowY":{type:"bool",nullable:false},"allowShrinkX":{type:"bool",nullable:false},"allowShrinkY":{type:"bool",nullable:false},"marginTop":{type:"int",min:-1000,nullable:false},"marginRight":{type:"int",min:-1000,nullable:false},"marginBottom":{type:"int",min:-1000,nullable:false},"marginLeft":{type:"int",min:-1000,nullable:false},"paddingTop":{type:"int",nullable:false},"paddingRight":{type:"int",nullable:false},"paddingBottom":{type:"int",nullable:false},"paddingLeft":{type:"int",nullable:false},"alignX":{type:"enum",values:["left","center","right"],nullable:true},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:true}},HBOX_PROPERTIES:{"alignX":{type:"enum",values:["left","center","right"],nullable:false},"alignY":{type:"enum",values:["top","middle","bottom","baseline"],nullable:false},"spacing":{type:"int",nullable:false},"reversed":{type:"bool",nullable:false}},DOCK_PROPERTIES:{"sort":{type:"enum",values:["auto","y","x"],nullable:false},"spacingX":{type:"int",nullable:false},"spacingY":{type:"int",nullable:false}},GRID_PROPERTIES:{"horizontalSpacing":{type:"int",nullable:false},"verticalSpacing":{type:"int",nullable:false}}},properties:{selected:{apply:d,nullable:true}},members:{_applySelected:function(z,A){this._updateControls(z);
},_setProperty:function(E,name,F){if(!E){return;
}var H=p+qx.lang.String.firstUp(name);
var G=this._properties[name].convert;

if(G){F=G(F);
}E[H](F);
},_getProperty:function(U,name){var V=g+qx.lang.String.firstUp(name);
return U[V]();
},_hasProperty:function(B,name){var C=p+qx.lang.String.firstUp(name);
return (typeof (B[C])==k);
},_createOnIntPropertyChange:function(D){return function(e){var x=this.getSelected();
this._setProperty(x,D,e.getTarget().getValue());
};
},_createOnBoolPropertyChange:function(bf){return function(e){var w=this.getSelected();
this._setProperty(w,bf,e.getTarget().getValue());
};
},_createOnEnumPropertyChange:function(I,J){return function(e){var a=this.getSelected();
this._setProperty(a,I,J.getSelection()[0].getUserData(s));
};
},_createOnNullPropertyChange:function(y){return function(e){var u=this.getSelected();
var t=e.getTarget();

if(t.getValue()){this._setProperty(u,y,null);
this._properties[y].formItem.setEnabled(false);
}else{var v=null;

if(this._properties[y].type==q){v=this._properties[y].formItem.getSelection()[0].getUserData(s);
}else{v=this._properties[y].formItem.getValue();
}this._setProperty(u,y,v);
this._properties[y].formItem.setEnabled(true);
}};
},_updateControls:function(W){for(var bd in this._properties){var be=this._properties[bd].type;
var ba=this._properties[bd].formItem;
var X=this._properties[bd].nullable;

if(!this._hasProperty(W,bd)){ba.setEnabled(false);

if(X){this._properties[bd].nullWidget.setEnabled(false);
}return;
}ba.setEnabled(true);
var bc=this._getProperty(W,bd);

if(bc!==null){if(be==o){ba.setValue(parseInt(bc));
}else if(be==n){ba.setValue(bc.toString());
}else if(be==m){ba.setValue(!!bc);
}else if(be==q){var Y=ba.getItems();

for(var i=0,l=Y.length;i<l;i++){var bb=Y[i];

if(bb.getUserData(s)==bc){ba.setSelection([bb]);
break;
}}}}
if(X){this._properties[bd].nullWidget.setValue(bc==null);
this._properties[bd].nullWidget.setEnabled(true);
ba.setEnabled(bc!==null);
...
}},"right":{type:"string",nullable:true,convert:function(b){if(parseInt(b).toString()==b){b=parseInt(b);
}return b||null;
...
}},"width":{type:"int",nullable:true,convert:function(c){return c==null?null:c+"%";
...
}},"edge":{type:"enum",values:["north","east","south","west","center"],nullable:false}},GRID_PROPERTIES:{"row":{type:"int",nullable:false},"column":{type:"int",nullable:false},"rowSpan":{type:"int",nullable:true},"colSpan":{type:"int",nullable:true}}},members:{_setProperty:function(g,name,h){var i=this._properties[name].convert;

if(i){h=i(h);
}var j={};
j[name]=h;
g.setLayoutProperties(j);
