...
var A=function(p,q){var r=p!=null&&p.length>2;

if(!r){q.setInvalidMessage(k);
}return r;
};
var D=new qx.ui.form.validation.AsyncValidator(function(v,w){window.setTimeout(function(){if(w==null||w.length==0){v.setValid(false,i);
}else{v.setValid(true);
}},1000);
});
C.add(x,D);
...
C.add(z,A);
C.add(F);
C.setValidator(function(s){var u=y.getValue()==z.getValue();

if(!u){var t=h;
y.setInvalidMessage(t);
z.setInvalidMessage(t);
y.setValid(false);
z.setValid(false);
}return u;
});
