...
var x=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
x.setColumns([g,m,c,f]);
x.setData(z);
var w={tableColumnModel:function(B){return new qx.ui.table.columnmodel.Resize(B);
}};
var A=this._table=new qx.ui.table.Table(x,w);
A.set({width:600,height:400});
A.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var y=A.getTableColumnModel();
var v=y.getBehavior();
v.set(0,{width:k,minWidth:40,maxWidth:80});
v.setWidth(1,i);
v.setMinWidth(1,100);
v.setMaxWidth(1,320);
var y=A.getTableColumnModel();
...
var F,G,I;
G=new qx.ui.toolbar.Part();
H.add(G);
F=new qx.ui.toolbar.Button(q,j);
F.addListener(r,function(s){var t=this.createRandomRows(10);
this._tableModel.addRows(t);
this.info("10 rows added");
},this);
G.add(F);
F=new qx.ui.toolbar.Button(p,d);
F.addListener(r,function(C){var D=this._tableModel.getRowCount();
this._tableModel.removeRows(D-10,10);
...
H.add(G);
var E=this._table;
I=new qx.ui.toolbar.CheckBox(e);
I.set({value:E.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(o+b)});
I.addListener(h,function(u){E.setKeepFirstVisibleRowComplete(this.getValue());
},I);
G.add(I);
return H;
