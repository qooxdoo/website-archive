...
},set2:function(){var g=document.getElementById(b);
...
},set3:function(){var c=document.getElementById(b);
qx.log.Logger.debug("Setting to: null,20  120,40");
qx.bom.element.Clip.set(c,{top:20,width:120,height:40});
var d=qx.bom.element.Clip.get(c)||{};
qx.log.Logger.debug("Clip after: "+d.left+","+d.top+"  "+d.width+","+d.height);
},set4:function(){var k=document.getElementById(b);
qx.log.Logger.debug("Setting to: 20,null  120,40");
qx.bom.element.Clip.set(k,{left:20,width:120,height:40});
