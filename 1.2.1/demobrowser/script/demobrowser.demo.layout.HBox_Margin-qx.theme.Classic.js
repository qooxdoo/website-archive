...
(function(){var f="main",e="green",d="yellow",c="middle",b="demobrowser.demo.layout.HBox_Margin";
...
var s=new qx.ui.container.Composite(q).set({decorator:f,backgroundColor:d,allowGrowX:false});
q.setSpacing(5);
...
return s;
},getBox2:function(){var v=new qx.ui.layout.HBox();
var x=new qx.ui.container.Composite(v).set({decorator:f,backgroundColor:d,allowGrowX:false});
v.setSpacing(5);
...
var C=new qx.ui.container.Composite(A).set({decorator:f,backgroundColor:d,height:100,allowGrowX:false});
A.setSpacing(5);
A.setAlignY(c);
...
return C;
},getBox4:function(){var g=new qx.ui.layout.HBox();
var i=new qx.ui.container.Composite(g).set({decorator:f,backgroundColor:d,height:100,allowGrowX:false});
g.setSpacing(5);
g.setAlignY(c);
...
var n=new qx.ui.container.Composite(l).set({decorator:f,backgroundColor:d,height:100,allowGrowX:false});
l.setSpacing(5);
l.setAlignY(c);
