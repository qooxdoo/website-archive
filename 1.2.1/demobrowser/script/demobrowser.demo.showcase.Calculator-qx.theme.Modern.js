...
(function(){var R="execute",Q="-",P="+",O="/",N="*",M="=",L=".",K="black",J="Del",I="sans-serif",bo="__NU",bn="C",bm="5",bl="7",bk="demobrowser.demo.showcase.Calculator",bj="CE",bi="solid",bh="icon/22/apps/utilities-calculator.png",bg="3",bf="0",Y="n",ba="8",W="__NT",X="6",U="4",V="Calculator",S="2",T="Verdana",bb="1",bc="demobrowser.demo.showcase.CalculatorLogic",be="+/-",bd="9";
qx.Class.define(bk,{extend:qx.application.Standalone,members:{__NT:null,__NU:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__NU=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var c=new qx.ui.window.Window(V,bh);
c.setLayout(new qx.ui.layout.VBox(16));
var f=new qx.ui.decoration.Single(1,bi,K);
var n=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var x=new qx.ui.layout.Grid(5,5);
n.setLayout(x);
this.__NT=new qx.ui.basic.Label(this.__NU.getCurrentValue().toString()).set({decorator:f,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__NT.setEnabled(false);
var y=new qx.bom.Font().set({size:14,family:[T,I],bold:true});
var s=new qx.ui.form.Button(bf).set({font:y,minWidth:40});
var r=new qx.ui.form.Button(bb).set({font:y,minWidth:40});
var q=new qx.ui.form.Button(S).set({font:y,minWidth:40});
var p=new qx.ui.form.Button(bg).set({font:y,minWidth:40});
var w=new qx.ui.form.Button(U).set({font:y,minWidth:40});
var v=new qx.ui.form.Button(bm).set({font:y,minWidth:40});
var u=new qx.ui.form.Button(X).set({font:y,minWidth:40});
var t=new qx.ui.form.Button(bl).set({font:y,minWidth:40});
var A=new qx.ui.form.Button(ba).set({font:y,minWidth:40});
var z=new qx.ui.form.Button(bd).set({font:y,minWidth:40});
var b=new qx.ui.form.Button(bn).set({font:y,minWidth:40});
var d=new qx.ui.form.Button(bj).set({font:y,minWidth:40});
var j=new qx.ui.form.Button(J).set({font:y,minWidth:40});
var i=new qx.ui.form.Button(be).set({font:y,minWidth:40});
var l=new qx.ui.form.Button(L).set({font:y,minWidth:40});
var h=new qx.ui.form.Button(P).set({font:y,minWidth:40});
var o=new qx.ui.form.Button(Q).set({font:y,minWidth:40});
var m=new qx.ui.form.Button(N).set({font:y,minWidth:40});
var k=new qx.ui.form.Button(O).set({font:y,minWidth:40});
var g=new qx.ui.form.Button(M).set({font:y,minWidth:40});
x.setColumnFlex(0,1);
x.setColumnFlex(1,1);
x.setColumnFlex(2,1);
x.setColumnFlex(3,1);
...
x.setRowFlex(5,1);
x.setRowFlex(6,1);
n.add(this.__NT,{row:0,column:0,rowSpan:0,colSpan:4});
n.add(b,{row:1,column:2,rowSpan:1,colSpan:2});
n.add(d,{row:1,column:1});
n.add(j,{row:1,column:0});
n.add(t,{row:2,column:0});
n.add(A,{row:2,column:1});
n.add(z,{row:2,column:2});
n.add(k,{row:2,column:3});
n.add(w,{row:3,column:0});
n.add(v,{row:3,column:1});
n.add(u,{row:3,column:2});
n.add(m,{row:3,column:3});
n.add(r,{row:4,column:0});
n.add(q,{row:4,column:1});
n.add(p,{row:4,column:2});
n.add(o,{row:4,column:3});
n.add(s,{row:5,column:0});
n.add(i,{row:5,column:1});
n.add(l,{row:5,column:2});
n.add(h,{row:5,column:3});
n.add(g,{row:6,column:0,rowSpan:1,colSpan:4});
c.setWidth(260);
c.setMinWidth(260);
c.setHeight(260);
c.open();
...
c.add(n,{flex:1});
b.addListener(R,function(e){this.__NU.cleanDisplay();
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
d.addListener(R,function(e){this.__NU.clearEntry();

if(this.__NU.getResult()!=null){this.__NT.setValue(this.__NU.getCurrentValue().toString());
}},this);
j.addListener(R,function(e){this.__NU.deleteNumber();
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
i.addListener(R,function(e){this.__NU.setSign();

if(this.__NU.getResult()!=null){this.__NT.setValue(this.__NU.getResult().toString());
}},this);
s.addListener(R,function(e){this.__NU.setCurrentValue(0);
this.__NT.setValue(this.__NU.getCurrentValue().toFixed(this.__NU.getZeroCounter()).toString());
},this);
r.addListener(R,function(e){this.__NU.setCurrentValue(1);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
q.addListener(R,function(e){this.__NU.setCurrentValue(2);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
p.addListener(R,function(e){this.__NU.setCurrentValue(3);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
w.addListener(R,function(e){this.__NU.setCurrentValue(4);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
v.addListener(R,function(e){this.__NU.setCurrentValue(5);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
u.addListener(R,function(e){this.__NU.setCurrentValue(6);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
t.addListener(R,function(e){this.__NU.setCurrentValue(7);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
A.addListener(R,function(e){this.__NU.setCurrentValue(8);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
z.addListener(R,function(e){this.__NU.setCurrentValue(9);
this.__NT.setValue(this.__NU.getCurrentValue().toString());
},this);
h.addListener(R,function(e){this.__NU.calculate(P);

if(this.__NU.getResult()!=null){this.__NT.setValue(this.__NU.getResult().toString());
}this.__NU.resetCurrentValue();
},this);
o.addListener(R,function(e){this.__NU.calculate(Q);

if(this.__NU.getResult()!=null){this.__NT.setValue(this.__NU.getResult().toString());
}this.__NU.resetCurrentValue();
},this);
m.addListener(R,function(e){this.__NU.calculate(N);

if(this.__NU.getResult()!=null){this.__NT.setValue(this.__NU.getResult().toString());
}this.__NU.resetCurrentValue();
},this);
k.addListener(R,function(e){this.__NU.calculate(O);

if(this.__NU.getResult()!=null){this.__NT.setValue(this.__NU.getResult().toString());
}this.__NU.resetCurrentValue();
},this);
g.addListener(R,function(e){this.__NU.calculate(M);

if(this.__NU.getResult()!=null){this.__NT.setValue(this.__NU.getResult().toString());
}this.__NU.resetCurrentValue();
},this);
l.addListener(R,function(e){this.__NU.setComma();
},this);
}},destruct:function(){this._disposeObjects(bo,W);
}});
qx.Class.define(bc,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__NV:0,__NW:0,__NX:"n",__NY:0,__Oa:0,__Ob:0,__Oc:false,__Od:1,__Oe:0,__Of:false,__Og:0,setCurrentValue:function(B){if(this.__Oc){this.__Od*=10;
this.__NV=this.__NV+(B/this.__Od);

if(B==0){this.__Oe++;
}}else{this.__Oc=false;

if(this.__NV<0){this.__NV=this.__NV*10-B;
}else{this.__NV=this.__NV*10+B;
}}},getZeroCounter:function(){return this.__Oe;
},setComma:function(){this.__Oc=true;
},getCurrentValue:function(){return this.__NV;
},resetCurrentValue:function(){this.__NV=null;
},cleanDisplay:function(){this.__Og=0;
this.__Oa=0;
this.__NX="n";
this.__Oe=0;
this.__Od=1;
...
this.__NW=0;
this.__Of=false;
},setResult:function(H){this.__NW=H;
},getResult:function(){return Math.round(this.__NW*10000000)/10000000;
},setCurrentOperation:function(C){this.__NX=C;
},getCurrentOperation:function(){return this.__NX;
},clearEntry:function(){this.__Of=false;
this.__Oe=0;
this.__Od=1;
this.__Oc=false;
this.__Ob++;
...
if(this.__Ob<2){this.__Oa=this.__NW;
}
if(this.__NY>=2){this.__NW=0;
this.__NY=0;
}},setSign:function(){this.__Og++;

if(this.__Og%2==0){this.__Of=false;
}else{this.__Of=true;
}
if(this.__NV==null){this.__NV=this.__NW;
}this.__NV=this.__NV*(-1);

if(this.__NW==0){this.__NW=this.__NV;
}
if(this.__NW!=0){this.__Oa=this.__NW;
this.__NW=this.__NV;
}},deleteNumber:function(){var D=false;
var G=false;

if(this.__NV<0){this.__NV=this.__NV*(-1);
G=true;
}
if(this.__NV!=null){if(this.__NV.toString().lastIndexOf(L)!=-1){this.__NV=this.__NV*this.__Od;
D=true;
}}var E=this.__NV%10;
var F=E/10;
this.__NV=this.__NV/10;
this.__NV=this.__NV-F;

if(D){this.__Od/=10;
this.__NV=this.__NV/(this.__Od);
D=false;
}
if(G){this.__NV=this.__NV*(-1);
G=false;
}},calculate:function(a){if(a==P||a==N||a==O||a==Q||a==M){this.__Oc=false;
this.__Od=1;
this.__Oe=0;

if(this.__NX!=Y){if(this.__NX==P){if(this.__NW==null){this.__NW=this.__Oa;
}
if(this.__Of){this.__NW=this.__Oa+this.__NV;
}else{this.__NW=this.__NW+this.__NV;
}this.__NV=this.__NW;
this.__Oa=this.__NW;
}
if(this.__NX==Q){if(this.__NW==0){this.__NW=this.__NV;
this.__NV=0;
}
if(this.__NW==null){this.__NW=this.__Oa;
}
if(this.__Of){this.__NW=this.__Oa-this.__NV;
}else{this.__NW=this.__NW-this.__NV;
}this.__NV=this.__NW;
...
if(this.__NX==O){if(this.__NW==0){this.__NW=this.__NV;
this.__NV=1;
}
if(this.__NW==null){this.__NW=this.__Oa;
}
if(this.__NV!=null){if(this.__NV!=0){if(this.__Of){this.__NW=this.__Oa/this.__NV;
}else{this.__NW=this.__NW/this.__NV;
}}else{alert("You can't divide by 0!");
}}this.__NV=this.__NW;
this.__Oa=this.__NW;
}
if(this.__NX==N){if(this.__NW==0){this.__NW=1;
}
if(this.__NV==null){this.__NV=1;
}
if(this.__NW==null){this.__NW=this.__Oa;
}
if(this.__Of){this.__NW=this.__Oa*this.__NV;
