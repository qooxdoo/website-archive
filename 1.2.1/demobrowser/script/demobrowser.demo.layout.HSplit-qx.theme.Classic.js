...
},addSplitPaneTwoFlexSimple:function(){var u=new qx.ui.splitpane.Pane(m);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(l);
...
t.setWrap(true);
u.add(t,1);
var v=new qx.ui.form.TextArea(h);
v.setDecorator(null);
v.setWrap(true);
u.add(v,2);
},addSplitPaneTwoFlexWithOneMin:function(){var J=new qx.ui.splitpane.Pane(m);
J.setWidth(400);
J.setHeight(60);
J.setDecorator(l);
...
I.setMinWidth(250);
J.add(I,1);
var K=new qx.ui.form.TextArea(h);
K.setDecorator(null);
K.setWrap(true);
J.add(K,2);
...
N.setMaxWidth(100);
M.add(N,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var r=new qx.ui.splitpane.Pane(m);
r.setWidth(400);
r.setHeight(60);
r.setDecorator(l);
...
s.setMinWidth(250);
r.add(s,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var D=new qx.ui.splitpane.Pane(m);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(l);
this.getRoot().add(D,{left:20,top:340});
var C=new qx.ui.form.TextArea(e);
C.setDecorator(null);
C.setWrap(true);
C.setMaxWidth(100);
D.add(C,1);
var E=new qx.ui.form.TextArea(f);
E.setDecorator(null);
E.setWrap(true);
E.setMaxWidth(100);
D.add(E,2);
},addSplitPaneOneFlexSimple:function(){var o=new qx.ui.splitpane.Pane(m);
o.setWidth(400);
o.setHeight(60);
o.setDecorator(l);
this.getRoot().add(o,{left:500,top:20});
var n=new qx.ui.form.TextArea(g);
n.setDecorator(null);
n.setWrap(true);
o.add(n,0);
var p=new qx.ui.form.TextArea(k);
p.setDecorator(null);
p.setWrap(true);
o.add(p);
},addSplitPaneOneFlexSimpleWithMax:function(){var x=new qx.ui.splitpane.Pane(m);
x.setWidth(400);
x.setHeight(60);
x.setDecorator(l);
...
w.setWrap(true);
x.add(w,0);
var y=new qx.ui.form.TextArea(d);
y.setDecorator(null);
y.setWrap(true);
y.setMaxWidth(200);
x.add(y);
},addSplitPaneOneFlexSimpleWithMin:function(){var A=new qx.ui.splitpane.Pane(m);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(l);
this.getRoot().add(A,{left:500,top:180});
var z=new qx.ui.form.TextArea(c);
z.setDecorator(null);
z.setWrap(true);
z.setMinWidth(350);
A.add(z,0);
...
B.setWrap(true);
A.add(B);
},addSplitPaneAuto:function(){var G=new qx.ui.splitpane.Pane(m);
G.setDecorator(l);
this.getRoot().add(G,{left:500,top:340});
var F=new qx.ui.form.TextArea(i);
F.setDecorator(null);
F.setWrap(true);
G.add(F,0);
