...
var s=qx.bom.Iframe.create({name:m,src:b});
s.id=m;
document.body.appendChild(s);
qx.event.Registration.addListener(s,d,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var q=window.document.getElementById(m);
var p=qx.bom.Iframe.getDocument(q);
this._juhu=p.getElementById(h);
this._inner=p.getElementById(k);
...
qx.event.Registration.addListener(p.getElementById(f),c,this._onkeydown,this);

for(var i=1;i<10;i++){var o=p.getElementById(j+i);
qx.event.Registration.addListener(o,n,this._cascadeCapture,this,true);
qx.event.Registration.addListener(o,n,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(p.getElementById(l),l,this._scroll,this);
