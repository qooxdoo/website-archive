...
(function(){var n="execute",m="appear",l="changeSelection",k="Trash",j="mode",h="Windows (C:)",g="Documents (D:)",f="Add before",e="Add after",d="Add at begin",N="Inbox",M="Desktop",L="Show open button:",K="New tree item name: ",J="auto",I="Hello",H="Presets",G="Data 123213234325345234523453453245",F="demobrowser.demo.animation.Tree_Highlight",E="Network",u="Control",v="Sent",s="Files",t="Remove tree item",q="Add file",r="Workspace",o="Junk #",p="Tree",w="never",x="Add folder",z="Root",y="always",B="Move to parent",A="Reset tree",D="Edit",C="Remove all children";
...
var b=new qx.ui.groupbox.GroupBox(p).set({contentPadding:[4,4,4,4]});
b.setLayout(new qx.ui.layout.Canvas());
this._container.add(b);
this._treeGroup=b;
var c=this.getTree();
b.add(c,{edge:0});
this._tree=c;
...
var bm=new qx.ui.tree.TreeFolder(z);
bm.setOpen(true);
bh.setRoot(bm);
var bk=new qx.ui.tree.TreeFolder(M);
bk.setOpen(true);
bm.add(bk);
var bc=new qx.ui.tree.TreeFolder(s);
var ba=new qx.ui.tree.TreeFolder(r);
var bb=new qx.ui.tree.TreeFolder(E);
var Y=new qx.ui.tree.TreeFolder(k);
bk.add(bc,ba,bb,Y);
var bi=new qx.ui.tree.TreeFile(h);
var X=new qx.ui.tree.TreeFile(g);
ba.add(bi,X);
var bl=new qx.ui.tree.TreeFolder(N);
var bd=new qx.ui.tree.TreeFolder(H);
var bg=new qx.ui.tree.TreeFolder(v);
var bf=new qx.ui.tree.TreeFolder(k);

for(var i=0;i<100;i++){bf.add(new qx.ui.tree.TreeFile(o+i));
}var bj=new qx.ui.tree.TreeFolder(G);
var be=new qx.ui.tree.TreeFolder(D);
bl.add(bd,bg,bf,bj,be);
bm.add(bl);
return bh;
},getCommandFrame:function(){var bq=new qx.ui.groupbox.GroupBox(u);
bq.setLayout(new qx.ui.layout.Grid(3,5));
var bs=0;
bq.add(new qx.ui.basic.Label(K).set({paddingTop:4}),{row:bs,column:0});
this.inputItemName=new qx.ui.form.TextField(I);
bq.add(this.inputItemName,{row:bs++,column:1});
this.btnAddFolder=new qx.ui.form.Button(x);
this.btnAddFolder.addListener(n,this._addFolder,this);
bq.add(this.btnAddFolder,{row:bs++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(q);
this.btnAddFile.addListener(n,this._addFile,this);
bq.add(this.btnAddFile,{row:bs++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(e);
this.btnAddAfter.addListener(n,this._addAfter,this);
bq.add(this.btnAddAfter,{row:bs++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(f);
this.btnAddBefore.addListener(n,this._addBefore,this);
bq.add(this.btnAddBefore,{row:bs++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(d);
this.btnAddBegin.addListener(n,this._addBegin,this);
bq.add(this.btnAddBegin,{row:bs++,column:0,colSpan:2});
bq.add(new qx.ui.core.Spacer(5,5),{row:bs++,column:0});
this.btnRemove=new qx.ui.form.Button(t);
this.btnRemove.addListener(n,this._removeTreeItem,this);
bq.add(this.btnRemove,{row:bs++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(C);
this.btnRemoveAll.addListener(n,this._removeAll,this);
bq.add(this.btnRemoveAll,{row:bs++,column:0,colSpan:2});
bq.add(new qx.ui.core.Spacer(5,5),{row:bs++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(B);
this.btnMoveToParent.addListener(n,this._moveToParent,this);
bq.add(this.btnMoveToParent,{row:bs++,column:0,colSpan:2});
bq.add(new qx.ui.core.Spacer(5,5),{row:bs++,column:0});
bq.add(new qx.ui.basic.Label(L),{row:bs,column:0});
var bo=[y,w,J];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<bo.length;i++){var br=bo[i];
var bp=new qx.ui.form.RadioButton(br).set({value:br==this._tree.getRootOpenClose()});
bp.setUserData(j,br);
this.showOpenButtons[br]=bp;
this.mgrShowRootOpen.add(bp);
bq.add(bp,{row:bs++,column:1});
}this.mgrShowRootOpen.addListener(l,this._onChangeShowOpen,this);
bq.add(new qx.ui.core.Spacer(5,5),{row:bs++,column:0});
this.btnReset=new qx.ui.form.Button(A);
this.btnReset.addListener(n,this._resetTree,this);
bq.add(this.btnReset,{row:bs++,column:0,colSpan:2});
this._tree.addListener(l,this._updateControls,this);
this._updateControls();
return bq;
},_addFolder:function(){var S=this._tree.getSelection()[0];
var T=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
T.addListenerOnce(m,function(){var bx=new qx.fx.effect.core.Highlight(T.getContainerElement().getDomElement());
bx.start();
},this);
S.setOpen(true);
S.add(T);
},_addFile:function(){var bC=this._tree.getSelection()[0];
var bD=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bD.addListenerOnce(m,function(){var bw=new qx.fx.effect.core.Highlight(bD.getContainerElement().getDomElement());
bw.start();
},this);
bC.setOpen(true);
bC.add(bD);
},_addBefore:function(){var by=this._tree.getSelection()[0];
var bz=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bz.addListenerOnce(m,function(){var a=new qx.fx.effect.core.Highlight(bz.getContainerElement().getDomElement());
a.start();
},this);
by.getParent().addBefore(bz,by);
},_addAfter:function(){var V=this._tree.getSelection()[0];
var W=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
W.addListenerOnce(m,function(){var bB=new qx.fx.effect.core.Highlight(W.getContainerElement().getDomElement());
bB.start();
},this);
V.getParent().addAfter(W,V);
},_addBegin:function(){var bE=this._tree.getSelection()[0];
var bF=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bF.addListenerOnce(m,function(){var bv=new qx.fx.effect.core.Highlight(bF.getContainerElement().getDomElement());
bv.start();
},this);
bE.getParent().addAtBegin(bF);
},_removeTreeItem:function(){var bn=this._tree.getSelection()[0];
var parent=bn.getParent();
parent.remove(bn);
},_removeAll:function(){var U=this._tree.getSelection()[0];
U.removeAll();
},_moveToParent:function(){var bA=this._tree.getSelection()[0];
var parent=bA.getParent();
parent.remove(bA);
parent.getParent().add(bA);
this._updateControls();
},_onChangeShowOpen:function(){var bt=this._tree.getSelection()[0];

if(bt!=null){var bu=this.mgrShowRootOpen.getSelection()[0].getUserData(j);
bt.setOpenSymbolMode(bu);
}},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(m,function(){this._tree.addListener(l,this._updateControls,this);
},this);
},_updateControls:function(){var O=this._tree.getSelection()[0];

if(!O){this.btnAddFolder.setEnabled(false);
...
var P=R==-1;
var Q=O instanceof qx.ui.tree.TreeFolder;
this.btnAddFolder.setEnabled(Q);
this.btnAddFile.setEnabled(Q);
this.btnAddBefore.setEnabled(!P);
this.btnAddAfter.setEnabled(!P);
this.btnAddBegin.setEnabled(!P);
this.btnRemove.setEnabled(!P);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(Q);
this.showOpenButtons[O.getOpenSymbolMode()].setValue(true);
this.btnMoveToParent.setEnabled(R>0);
