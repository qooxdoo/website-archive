...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Destructor_Flash","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Destructor_Flash-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"b88456b59a6f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="demobrowser.demo.test.Destructor_Flash",j="300px",h="interval",g="height",f="TestFlash.swf",e="400px",d="width",c="div",b="FlashMovie";
qx.Class.define(k,{extend:qx.application.Native,members:{__Mi:null,__Mj:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__Mi=[];
var a=new qx.event.Timer(5000);
a.addListener(h,this.runTest,this);
a.start();
this.runTest();
},runTest:function(){for(var i=0;i<5;i++){var o=qx.bom.Element.create(c);
qx.bom.element.Style.set(o,d,e);
qx.bom.element.Style.set(o,g,j);
document.body.appendChild(o);
var p=b+this.__Mj;
this.__Mj++;
qx.bom.Flash.create(o,{movie:f,id:p});
this.debug("created: "+p);
this.__Mi.push(o);
}var q=qx.event.Timer.once(this.clear,this,2500);
q.start();
},clear:function(){var m=this.__Mi;

for(var i=0,l=m.length;i<l;i++){var n=m[i].firstChild.id;
qx.bom.Flash.destroy(m[i]);
this.debug("cleaned: "+n);
