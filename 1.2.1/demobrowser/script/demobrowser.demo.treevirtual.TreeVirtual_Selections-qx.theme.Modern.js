...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.treevirtual.TreeVirtual_Selections","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.treevirtual.TreeVirtual_Selections-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"af68fa9ea75a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="No Selection",k="Trash",j="Single Interval Selection",h="Single Selection",g="Multiple Interval Selection",f="Windows (C:)",d="Documents (D:)",c="Inbox",b="Desktop",a="Network",z="Control",y="Selection Mode: ",w="changeSelection",v="Sent",u="Files",t="Workspace",s="demobrowser.demo.treevirtual.TreeVirtual_Selections",r="Tree",q="Spam",p="Data",m="Spam Message #",n="Edit";
...
var A=new qx.ui.treevirtual.TreeVirtual(r);
A.set({width:400});
A.setColumnWidth(0,400);
A.setAlwaysShowOpenCloseSymbol(true);
A.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.MULTIPLE_INTERVAL);
H.add(A);
var G=A.getDataModel();
var D=G.addBranch(null,b,true);
var x;
var F;
G.addBranch(D,u,true);
F=G.addBranch(D,t,true);
x=G.addLeaf(F,f);
A.nodeSetSelected(x,true);
x=G.addLeaf(F,d);
A.nodeSetSelected(x,true);
G.addBranch(D,a,true);
G.addBranch(D,k,true);
var E=G.addBranch(null,c,true);
F=G.addBranch(E,q,false);

for(var i=1;i<3000;i++){G.addLeaf(F,m+i);
}G.addBranch(E,v,false);
G.addBranch(E,k,false);
G.addBranch(E,p,false);
G.addBranch(E,n,false);
G.setData();
var C=new qx.ui.groupbox.GroupBox(z);
C.setLayout(new qx.ui.layout.VBox(2));
H.add(C);
var o=new qx.ui.basic.Atom(y);
C.add(o);
o=new qx.ui.form.SelectBox();
var B=new qx.ui.form.ListItem(l);
o.add(B);
var B=new qx.ui.form.ListItem(h);
o.add(B);
var B=new qx.ui.form.ListItem(j);
o.add(B);
var B=new qx.ui.form.ListItem(g);
o.add(B);
o.setSelection([B]);
o.addListener(w,function(e){switch(e.getData()[0].getLabel()){case l:A.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.NONE);
break;
case h:A.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.SINGLE);
break;
case j:A.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.SINGLE_INTERVAL);
break;
case g:A.setSelectionMode(qx.ui.treevirtual.TreeVirtual.SelectionMode.MULTIPLE_INTERVAL);
break;
}});
C.add(o);
}}});
