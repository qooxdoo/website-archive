...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.Pane_Row","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Pane_Row-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"27be16de6ad7"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var h="bold",g="table-scroller-header",f="white",e="#EEE",d="demobrowser.demo.virtual.Pane_Row",c="Even/Odd Colors",b="Custom Colors",a="Even/Odd & Custom Colors";
...
var l=new qx.ui.layout.Grid(5,0);
l.setRowFlex(1,1);
l.setColumnFlex(0,1);
l.setColumnFlex(1,1);
l.setColumnFlex(2,1);
var j=new qx.ui.container.Composite(l);
this.getRoot().add(j,{edge:0});
j.add(new qx.ui.basic.Label(c).set({font:h,decorator:g,padding:3,allowGrowX:true}),{row:0,column:0});
var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);
m.getPane().addLayer(new qx.ui.virtual.layer.Row(f,e));
j.add(m,{row:1,column:0});
j.add(new qx.ui.basic.Label(b).set({font:h,decorator:g,padding:3,allowGrowX:true}),{row:0,column:1});
var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var k=new qx.ui.virtual.layer.Row();

for(var i=0;i<10000;i++){k.setColor(i,qx.util.ColorUtil.randomColor());
}m.getPane().addLayer(k);
j.add(m,{row:1,column:1});
j.add(new qx.ui.basic.Label(a).set({font:h,decorator:g,padding:3,allowGrowX:true}),{row:0,column:2});
var m=new qx.ui.virtual.core.Scroller(100,10000,60,100);
var k=new qx.ui.virtual.layer.Row(f,e);

for(var i=0;i<10000;i++){if(Math.random()>0.7){k.setColor(i,qx.util.ColorUtil.randomColor());
}}m.getPane().addLayer(k);
