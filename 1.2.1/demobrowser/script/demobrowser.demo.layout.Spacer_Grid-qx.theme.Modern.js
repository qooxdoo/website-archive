...
g.add(this.getGrid1());
g.add(this.getGrid2());
},getGrid1:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:d,backgroundColor:b,allowGrowX:false,allowGrowY:false});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:0});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:1});
f.add(new qx.ui.core.Spacer(0,10),{row:1,column:0});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:0});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:1});
f.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:4,column:0});
f.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:4,column:1});
return f;
},getGrid2:function(){var e=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:d,backgroundColor:b,allowGrowX:false,allowGrowY:false});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:0});
e.add(new qx.ui.core.Spacer(10,0),{row:0,column:2});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:3});
e.add(new qx.ui.core.Spacer(30,0),{row:1,column:4});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:5});
e.add(new qx.ui.core.Spacer(0,5),{row:1,column:0});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:0});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:3});
e.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:5});
return e;
}}});
})();
