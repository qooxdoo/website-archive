...
}},properties:{model:{check:p,apply:d,event:r,nullable:true,dereference:true},target:{apply:k,event:c,init:null,dereference:true},childPath:{check:t,apply:b,nullable:true},labelPath:{check:t,apply:o,nullable:true},iconPath:{check:t,apply:h,nullable:true},labelOptions:{apply:g,nullable:true},iconOptions:{apply:a,nullable:true},delegate:{apply:q,init:null,nullable:true}},members:{__Cu:null,__Cs:null,__Ct:null,_applyDelegate:function(y,z){this._setConfigureItem(y,z);
this._setCreateItem(y,z);
this._setBindItem(y,z);
},_applyIconOptions:function(A,B){this.__CC();
},_applyLabelOptions:function(C,D){this.__CC();
},_applyTarget:function(E,F){if(F!=undefined){var G=F.getRoot();
F.setRoot(null);
G.destroy();
}if(this.getModel()!=null){this.__Cx();
}this._addChangeTargetListener(E,F);
},_applyModel:function(H,I){this.__Cx();
},_applyChildPath:function(J,K){this.__Cx();
},_applyIconPath:function(L,M){this.__CC();
},_applyLabelPath:function(N,O){this.__CC();
},__Cv:function(P){var R=P.getTarget();
var Q=this.__Cu[R.toHashCode()].treeNode;
var S=this.__Cu[R.toHashCode()].modelNode;
this.__Cy(Q,S);
this._updateSelection();
},__Cw:function(e){var ba=e.getData();
var V=e.getOldData();
var W=this.__Cu[V.toHashCode()];
V.removeListenerById(W.changeListenerId);
delete this.__Cu[V.toHashCode()];
...
var T=Y.event;
var X=bb.addListener(T,this.__Cw,this);
var U=W.treeNode;
this.__Cu[ba.toHashCode()]={modelNode:bb,treeNode:U,changeListenerId:W.changeListenerId,changeChildernListenerId:X};
this.__Cy(U,bb);
this._updateSelection();
...
},__Cx:function(){if(this.getTarget()==null||this.getChildPath()==null){return;
...
this.__CD(this.getModel(),bf);
this.__Cy(bf,this.getModel());
}},__Cy:function(bg,bh){if(bh[s+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;
}var bq=bh[s+qx.lang.String.firstUp(this.getChildPath())]();
if(this.__Cu[bq.toHashCode()]==undefined){var bl=bq.addListener(m,this.__Cv,this);
var bp=qx.Class.getPropertyDefinition(bh.constructor,this.getChildPath());
var bm=bp.event;
var bn=bh.addListener(bm,this.__Cw,this);
this.__Cu[bq.toHashCode()]={modelNode:bh,treeNode:bg,changeListenerId:bl,changeChildernListenerId:bn};
...
}},__CC:function(){var bS;

for(var bU in this.__Cs){bS=bU;
break;
}for(var bR in this.__Cs[bS]){var bV=this.__Cs[bS][bR].treeNode;
var bT=qx.core.ObjectRegistry.fromHashCode(bR);
this.__CE(bT);
this.__CD(bT,bV);
}},__CD:function(bW,bX){var bY=this.getDelegate();
if(bY!=null&&bY.bindItem!=null){bY.bindItem(this,bX,bW);
}else{this.bindDefaultProperties(bX,bW);
}},__CE:function(ca){for(var i=0;i<this.__Ct.length;i++){var cc=this.__Ct[i];
var cb=this.__Cs[cc][ca.toHashCode()];

if(cb!=null){if(cb.id){ca.removeBinding(cb.id);
}
if(cb.reverseId){cb.treeNode.removeBinding(cb.reverseId);
}delete this.__Cs[cc][ca.toHashCode()];
...
}}},destruct:function(){this.__Cs=this.__Cu=this.__Ct=null;
}});
})();
