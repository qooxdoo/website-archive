...
qx.Class.define(f,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(L){L.__Qs=qx.bom.element.Style.get(L,e);
L.style.color=q;
...
},onmouseout:function(O){O.style.color=O.__Qs;
