...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.ComboBox","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.ComboBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"e90c4efc3f48"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var t="bold",s=" = ",r="... &gt; (as literal HTML entity)",q="... &gt; (as Richtext)",p="HTML entities: &laquo; &lt; &amp; &gt; &raquo;",o="Wide, long list",n="<u>Underlined Text</u>",m="<b>Bold Text</b>",l="'s Icon",k="With icons",c="Default",j="changeValue",g="2^ ",b="<i>Italic Text</i>",a="'s Item",f="icon/16/places/folder.png",d="With HTML (rich) text",h="demobrowser.demo.widget.ComboBox";
...
},_createDefaultExample:function(){var w=new qx.ui.basic.Label(c);
w.setFont(t);
this.getRoot().add(w,{left:20,top:25});
var u=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var v=new qx.ui.form.ListItem(g+i+s+Math.pow(2,i));
u.add(v);
}u.addListener(j,function(e){this.debug("ChangeValue: "+e.getData());
});
this.getRoot().add(u,{left:20,top:40});
},_createIconExample:function(){var z=new qx.ui.basic.Label(k);
z.setFont(t);
this.getRoot().add(z,{left:160,top:25});
var x=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var y=new qx.ui.form.ListItem(i+l,f);
x.add(y);
}this.getRoot().add(x,{left:160,top:40});
},_createHtmlExample:function(){var D=new qx.ui.basic.Label(d);
D.setFont(t);
this.getRoot().add(D,{left:300,top:25});
var A=new qx.ui.form.ComboBox().set({width:200});
var B=[r,q,m,n,b,p];
for(var i=0;i<B.length;i++){var C=new qx.ui.form.ListItem(B[i]);

if(i>0){C.setRich(true);
}A.add(C);
}this.getRoot().add(A,{left:300,top:40});
},_createWideExample:function(){var G=new qx.ui.basic.Label(o);
G.setFont(t);
this.getRoot().add(G,{left:20,top:285});
var E=new qx.ui.form.ComboBox();
E.setWidth(300);
for(var i=1;i<101;i++){var F=new qx.ui.form.ListItem(i+a);
E.add(F);
}E.setValue(E.getChildrenContainer().getSelectables()[0].getLabel());
this.getRoot().add(E,{left:20,top:300});
}}});
})();
