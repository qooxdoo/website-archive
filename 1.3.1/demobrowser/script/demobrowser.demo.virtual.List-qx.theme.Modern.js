...
(function(){var q="value",p="label",o="one",n="icon",m="both",l="multi",k="single",j="additive",h="bold",g="changeValue",bI="changeSelection",bH="Item No ",bG="Marc",bF="Julian",bE="Moritz",bD="Show Icon",bC="Jannis",bB="Kevin",bA="Robin",bz="showMode",x="Felix",y="Vincent",v="demobrowser.demo.virtual.List",w="Additive Selection",t="Nils",u="Nick",r="Leon",s="Jannick",F="Linus",G="Configurable",ba="Julius",V="Alexander",bi="icon/16/places/folder.png",bd="Jason",bu="change",bo="Erik",N="addaptive",by="Colin",bw="Lennard",bv="enabled",L="Tobias",R="Florian",T="show",X="Jonas",bb="Maximilian",be="Jakob",bk="",bq="David",z="Finn",A="48",P="Marlon",bh="Lukas",bg="Luca",bf="changeShowMode",bm="Fabian",bl="Tim",bc="Justin",bj="Single Selection",a="Simon",bp="Luis",B="Johannes",C="Elias",W="Jan",b="Dominic",f="Show Label",K="Noah",D="Daniel",E="Paul",I="Philipp",Y="Niclas",bs="Max",br="One Selection",S="Additive selection",bt="Jonathan",M="Tom",bn="Joel",H="Show Both",J="Ben",d="Nico",U="One as selection mode",O="16",bx="Mika",Q="Multi Selection",c="Marvin";
qx.Class.define(v,{extend:qx.application.Standalone,properties:{showMode:{init:m,check:[p,n,m],event:bf}},members:{__PL:null,__PM:null,__PN:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bJ=this.getRoot();
bJ.add(this.createConfigurableList(),{left:20,top:20});
bJ.add(this.createOneSelectionList(),{left:330,top:20});
bJ.add(this.createAdditiveSelectionList(),{left:520,top:20});
},createConfigurableList:function(){var bM=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var bO=new qx.ui.basic.Label(G).set({font:h});
bM.add(bO);
var bW=[];

for(var i=0;i<2500;i++){bW[i]={label:bH+i,icon:(i%4)?O:A};
}var ca=qx.data.marshal.Json.createModel(bW);
var bR=this.__PL=new qx.ui.list.List(ca).set({scrollbarX:"on",selectionMode:"multi",height:280,width:150,labelPath:"label",iconPath:"icon",iconOptions:{converter:function(ce){return "icon/"+ce+"/places/folder.png";
}}});
bM.add(bR,{top:20});
var bQ=this;
var cd={configureItem:function(cf){bQ.bind(bz,cf,T);
},bindItem:function(cg,ch,ci){cg.bindDefaultProperties(ch,ci);
cg.bindProperty(p,bv,{converter:function(cj){return parseInt(cj.replace(/Item No /g,bk))%9!=0;
}},ch,ci);
}};
bR.setDelegate(cd);
bR.getSelection().push(ca.getItem(20));
bR.getSelection().addListener(bu,function(e){var ck=bR.getSelection();

for(var i=0;i<ck.getLength();i++){this.debug("Selection: "+ck.getItem(i).getLabel());
}},this);
var bU=bR.getPane().getRowConfig();

for(var i=0;i<2500;i++){if(i%4==0){bU.setItemSize(i,56);
}else{bU.setItemSize(i,25);
}}var bV=new qx.ui.form.RadioButton(bj);
var bL=new qx.ui.form.RadioButton(Q);
var bY=new qx.ui.form.RadioButton(w);
var cb=new qx.ui.form.RadioButton(br);
bV.setUserData(q,k);
bL.setUserData(q,l);
bY.setUserData(q,j);
cb.setUserData(q,o);
bM.add(bV,{left:160,top:20});
bM.add(bL,{left:160,top:40});
bM.add(bY,{left:160,top:60});
bM.add(cb,{left:160,top:80});
var bS=new qx.ui.form.RadioButton(f);
var bN=new qx.ui.form.RadioButton(bD);
var bK=new qx.ui.form.RadioButton(H);
bS.setUserData(q,p);
bN.setUserData(q,n);
bK.setUserData(q,m);
bM.add(bS,{left:160,top:120});
bM.add(bN,{left:160,top:140});
bM.add(bK,{left:160,top:160});
var bT=this.__PM=new qx.ui.form.CheckBox("Enable drag selection");
var bX=this.__PN=new qx.ui.form.CheckBox("Enable quick selection").set({enabled:false});
bM.add(bT,{left:160,top:200});
bM.add(bX,{left:160,top:220});
var cc=new qx.ui.form.RadioGroup(bV,bL,bY,cb);
cc.setSelection([bL]);
cc.addListener(bI,this.onSelectionModeChange,this);
var bP=new qx.ui.form.RadioGroup(bS,bN,bK);
bP.setSelection([bK]);
bP.addListener(bI,this.onShowModeChange,this);
bT.addListener(g,this.onDragCheckChange,this);
bX.addListener(g,this.onQuickCheckChange,this);
return bM;
},createOneSelectionList:function(){var cl=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var cm=new qx.ui.basic.Label(U).set({font:h});
cl.add(cm);
var cp=new qx.data.Array();

for(var i=0;i<250;i++){var co=new demobrowser.demo.virtual.model.Item(bH+i,bi);
cp.push(co);
}var cn=new qx.ui.list.List(cp).set({selectionMode:o,height:280,width:150,labelPath:p,iconPath:n});
cl.add(cn,{top:20});
cn.getSelection().push(cp.getItem(16));
return cl;
},createAdditiveSelectionList:function(){var cr=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var cs=new qx.ui.basic.Label(S).set({font:h});
cr.add(cs);
var ct=[r,bh,bg,z,bl,x,X,bp,bb,bF,bs,E,Y,W,J,C,s,I,K,M,bE,d,bq,t,a,bm,bo,bc,V,be,R,u,F,bx,bd,D,bw,c,bC,L,b,P,bG,B,bt,ba,by,bn,bB,y,bA];
var cw=new qx.data.Array();
var cq=new qx.data.Array();

for(var i=0;i<ct.length;i++){var cv=new demobrowser.demo.virtual.model.Item(ct[i]);
cw.push(cv);

if(i==10||i==12||i==16){cq.push(cv);
}}var cu=new qx.ui.list.List(cw).set({selectionMode:j,height:200,width:150,labelPath:p,iconPath:n});
cr.add(cu,{top:20});
cu.setSelection(cq);
return cr;
},onSelectionModeChange:function(e){var cx=e.getData()[0].getUserData(q);
this.__PL.setSelectionMode(cx);

if(cx==k||cx==o){this.__PM.setEnabled(false);
this.__PN.setEnabled(true);
}else if(cx==l||cx==N){this.__PM.setEnabled(true);
this.__PN.setEnabled(false);
}},onShowModeChange:function(e){var cy=e.getData()[0].getUserData(q);
this.setShowMode(cy);
},onDragCheckChange:function(e){if(e.getData()){var cz=this.__PL.getSelectionMode();

if(cz==k||cz==o){this.debug("Drag selection is only available for the modes multi or additive");
}}this.__PL.setDragSelection(e.getData());
},onQuickCheckChange:function(e){if(e.getData()){var cA=this.__PL.getSelectionMode();

if(cA==l||cA==j){this.debug("Quick selection is only available for the modes multi or additive");
}}this.__PL.setQuickSelection(e.getData());
}}});
})();
...
},properties:{selection:{check:j,apply:f,nullable:false,deferredInit:true},selectionMode:{check:[n,h,a,d],init:n,apply:c},dragSelection:{check:p,init:false,apply:k},quickSelection:{check:p,init:false,apply:b}},members:{_manager:null,__Ho:false,__Hp:false,_initSelectionManager:function(){var self=this;
...
},_onChangeSelection:function(e){if(this.__Hp==true){return;
}this.__Ho=true;
...
this.__Ho=false;
},_onManagerChangeSelection:function(e){if(this.__Ho==true){return;
...
},__Hq:function(){var M=this.getSelection();
var L=M.toArray();
...
}},_lookup:function(G){return this.__Hr[G];
},_lookupGroup:function(H){return this.__Hs.indexOf(H);
},_reverseLookup:function(I){return this.__Hr.indexOf(I);
...
},_onModelChange:function(e){this.__Hv();
this._applyDefaultSelection();
},__Hu:function(){this.getPane().getRowConfig().setItemCount(this.__Hr.length);
this.getPane().fullUpdate();
},__Hv:function(){this.__Hr=[];
this.__Hs=[];
this.__Ht={};
...
for(var i=0,l=ba.length;i<l;++i){if(bb==null||bb(ba.getItem(i))){this.__Hr.push(i);
}}},_runDelegateSorter:function(bc){if(this.__Hr.length==0){return;
}var bd=qx.util.Delegate.getMethod(this.getDelegate(),q);

if(bd!=null){this.__Hr.sort(function(a,b){return bd(bc.getItem(a),bc.getItem(b));
});
}},_runDelegateGroup:function(be){var bi=qx.util.Delegate.getMethod(this.getDelegate(),c);

if(bi!=null){for(var i=0,l=this.__Hr.length;i<l;++i){var bf=this.__Hr[i];
var bh=this.getModel().getItem(bf);
var bg=bi(bh);
this.__Hw(bg,bf);
}this.__Hr=this.__Hx();
}},__Hw:function(name,bj){if(name==null){name=m;
}
if(this.__Ht[name]==null){this.__Ht[name]=[];
}this.__Ht[name].push(bj);
},__Hx:function(){var bm=[];
var bn=0;

for(var bk in this.__Ht){bm.push(-1);
this.__Hs.push(bn);
...
this._background=this._provider=this._layer=this._groups=this.__Hr=this.__Hs=this.__Ht=null;
}});
})();
...
(function(){var l="cell.type",k="BindingIds",j="group",i="String",h="model",g="",f="changeDelegate",d="label",c="qx.ui.list.core.MWidgetController",b="icon",a="value";
qx.Mixin.define(c,{construct:function(){this.__GX=[];
},properties:{labelPath:{check:i,nullable:true},iconPath:{check:i,nullable:true},labelOptions:{nullable:true},iconOptions:{nullable:true},delegate:{event:f,init:null,nullable:true}},members:{__GX:null,bindDefaultProperties:function(m,n){if(m.getUserData(l)!=j){this.bindProperty(g,h,null,m,n);
this.bindProperty(this.getLabelPath(),d,this.getLabelOptions(),m,n);

if(this.getIconPath()!=null){this.bindProperty(this.getIconPath(),b,this.getIconOptions(),m,n);
}}else{this.bindProperty(null,a,null,m,n);
}},bindProperty:function(o,p,q,r,s){var v=r.getUserData(l);
var t=this.__GY(s,o,v);
var u=this._list;

if(v==j){u=this._list._groups;
}var w=u.bind(t,r,p,q);
this.__Ha(r,w);
},bindPropertyReverse:function(x,y,z,A,B){var D=A.getUserData(l);
var C=this.__GY(B,x,D);
var E=A.bind(y,this._list,C,z);
this.__Ha(A,E);
},removeBindings:function(){while(this.__GX.length>0){var F=this.__GX.pop();
...
}},_removeBindingsFrom:function(Q){var R=this.__Hb(Q);
...
if(qx.lang.Array.contains(this.__GX,Q)){qx.lang.Array.remove(this.__GX,Q);
}},__GY:function(T,U,V){var W="model["+T+"]";

if(V=="group"){W="["+T+"]";
}
if(U!=null&&U!=""){W+="."+U;
}return W;
},__Ha:function(X,Y){var ba=this.__Hb(X);

if(!qx.lang.Array.contains(ba,Y)){ba.push(Y);
}
if(!qx.lang.Array.contains(this.__GX,X)){this.__GX.push(X);
}},__Hb:function(bb){var bc=bb.getUserData(k);
...
return r;
},styleSelectabled:function(t){var u=this.__Hc(t);
this._styleSelectabled(u);
},styleUnselectabled:function(v){var w=this.__Hc(v);
...
}},_styleSelectabled:function(z){this.__Hd(z,{selected:1});
},_styleUnselectabled:function(A){this.__Hd(A,{});
...
},__Hc:function(D){return this._list._layer.getRenderedCellWidget(D,0);
},__Hd:function(E,F){if(E==null){return;
...
this.__Hk=[];
},properties:{anonymous:{refine:true,init:false}},members:{__Hk:null,getRenderedCellWidget:function(f,g){var h=this.getColumnSizes().length;
...
}},_getSpacer:function(){var o=this.__Hk.pop();
...
if(B.getUserData(d)){this.__Hk.push(B);
...
if(T.getUserData(d)){this.__Hk.push(T);
...
}this._cellProvider=this.__Hk=null;
}});
})();
...
this.__Hl=[];
},events:{"created":a},members:{__Hl:null,_createWidget:function(){throw new Error("abstract method call");
...
},getCellWidget:function(l,m){var n=this.__Hm();
this.updateStates(n,m);
this.updateData(n,l);
return n;
},pool:function(o){this.__Hl.push(o);
},_cleanupPool:function(){var p=this.__Hl.pop();

while(p){p.destroy();
p=this.__Hl.pop();
}},__Hm:function(){var q=this.__Hl.pop();
