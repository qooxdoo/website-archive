...
this.__Ln=J.toUri(H);
this.__Lo=J.toUri(G);
},properties:{allowToggle:{check:E,init:false}},members:{__Ln:null,__Lo:null,__Lp:null,__Lq:null,__Lr:null,__Ls:null,__Lt:null,__Lu:null,_identifyImage:function(K){var L={imageWidth:11,imageHeight:11};

switch(K.cellData){case true:L.url=this.__Ln;
L.extras=w;
break;
case false:L.url=this.__Lo;
L.extras=p;
break;
default:L.url=null;
break;
...
if(qx.core.Variant.isSet(g,c)&&/\.png$/i.test(this.__Ln)){L.extras+=i+this.getBlankImage()+j+d+h+a+this.__Ln+j+b;
}else{L.extras+=i+this.__Ln+j;
}L.extras+=m+v+u+e;

if(qx.core.Variant.isSet(g,c)&&/\.png$/i.test(this.__Lo)){L.extras+=i+this.getBlankImage()+j+d+h+a+this.__Lo+j+b;
}else{L.extras+=i+this.__Lo+j;
}L.extras+=q+f;
...
return N;
}},destruct:function(){this.__Ln=this.__Lo=null;
}});
})();
