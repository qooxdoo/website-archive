...
qx.Class.define(j,{extend:qx.application.Native,members:{__Oi:null,__Oj:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__Oi=[];
...
o.start();
},clear:function(){var p=this.__Oi;
