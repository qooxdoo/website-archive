...
(function(){var j="yellow",i="bold",h="table-scroller-header",g="green",f=" / ",e="Widget Cells",d="demobrowser.demo.virtual.CellSpan",c="HTML Cells",b="__PC",a="x";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__PC:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__PC=new qx.ui.virtual.cell.Cell();
...
this.__PC.setBackgroundColor(s);
return this.__PC.getCellProperties(q+f+r);
...
this.__Fv=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__Fw={};
this.__Fx={};
this.__Fy={};
this.__Fz={};
...
for(var I in L){if(!M[I]){this.__FC.push(I);
}}J=J.superclass;
}},_getCssProperties:function(){return [b,n,C,s,d,c,e,h];
},_applyAppearance:function(N,O){if(O){this.__Fx={};
}},_getValue:function(P){if(this.__FE){return qx.util.PropertyUtil.getThemeValue(this,P);
}else{return qx.util.PropertyUtil.getUserValue(this,P);
}},_storeStyle:function(Q,R){var S;

if(this.__FE){S=this.__Fx;
}else{S=this.__Fw;
}
...
}},getCellProperties:function(bh,bi){this.__FG(bi);
...
},getCssClasses:function(bn,bo){var bp=this.__Fv.getCssClass(this.__FD)||f;
return p+bp;
},__FG:function(bq){if(!bq){bq={};
}var bs=this.getAppearance();
var br=bs+"-"+qx.lang.Object.getKeys(bq).sort().join(" ");

if(this.__FD==br){return;
}this.__FD=br;
var bt=this.__FA[this.__FD];

if(!bt){this.__FH();
this.__FI(bq);
this.__FJ(bq);
this.__FK();
this.__FA[this.__FD]=1;
}this.__FL();
},__FH:function(){var bu=qx.util.PropertyUtil;
var bv=this._getCssProperties();

for(var i=0;i<bv.length;i++){bu.deleteThemeValue(this,bv[i]);
}},__FI:function(bw){this.__Fx={};
this.__FE=true;
...
},__FJ:function(){var bB=qx.lang.Object.getValues(this.__Fx).join(";");
this.__Fv.computeClassForStyles(this.__FD,bB);
},__FK:function(){var bG=this.__FC;
...
}}this.__FB[this.__FD]=bE;
},__FL:function(){var bI=qx.util.PropertyUtil;
var bH=this.__FB[this.__FD]||{};

for(var bJ in bH){bI.setThemed(this,bJ,bH[bJ]);
}},getStyles:function(bK,bL){return qx.lang.Object.getValues(this.__Fw).join(v);
},getInsets:function(bM,bN){var bR=this.__Fy;
var bQ=this.__Fz;
...
return [bS+bO,top+bP];
}},destruct:function(){this.__Fv=this.__Fw=this.__Fx=this.__Fy=this.__Fz=this.__FA=this.__FB=this.__FC=null;
}});
})();
...
}this.__FQ=qx.bom.Stylesheet.createElement(o);
this.__FR={};
this.__FS={};
},members:{__FQ:null,__FR:null,__FS:null,getStylesheet:function(){return this.__FQ;
},getCssClass:function(p){return this.__FR[p]||null;
},computeClassForStyles:function(q,r){var s=this.__FS[r];

if(!s){var s=this.__FT();
qx.bom.Stylesheet.addRule(this.__FQ,e+s,r);
this.__FS[r]=s;
}this.__FR[q]=s;
return s;
},__FT:function(){return "qx-cell-"+this.toHashCode()+"-"+(this.__FU++);
},__FU:0},destruct:function(){this.__FQ=this.__FR=this.__FS=null;
}});
})();
...
},__Kf:function(A,B,C,D,top,E,F){var H=this._cellProvider.getCellProperties(B,C);
var G=H.insets||[0,0];
...
var W=R[i];
this.__Kf(U,S.firstRow,S.firstColumn,W.left,W.top,W.width,W.height);
}}else{O=[];
...
if(!O[N][T]){this.__Kf(U,N,T,V,top,P,M);
}T++;
V+=P;
}top+=M;
N++;
...
}return this.__HQ(I,L);
},__HQ:function(M,N){var O=[];
...
this.__Md=[];
this._cellLayer=new qx.ui.virtual.layer.WidgetCell(this.__Me());
...
},__Md:null,setCellSpan:function(u,v,w,x){var y=u+d+v;
this._spanManager.removeCell(y);

if(w>1||x>1){this._spanManager.addCell(y,u,v,w,x);
}qx.ui.core.queue.Widget.add(this);
},__Me:function(){var self=this;
...
return z;
},__Mf:function(G,H,I,J){this._cells=this._spanManager.findCellsInWindow(G,H,I,J);
...
}}},__Mg:function(){var O=this.getChildren();
...
this._add(L);
}}},_fullUpdate:function(P,Q,R,S){this.__Mf(P,Q,R.length,S.length);
this.__Mg();
this._cellLayer.fullUpdate(P,Q,R,S);
},_updateLayerWindow:function(T,U,V,W){this.__Mf(T,U,V.length,W.length);
this.__Mg();
...
this._cellProvider=this.__Md=this._cells=this._bounds=this._spanMap=null;
}});
})();
