...
qx.Class.define(f,{extend:qx.data.store.Json,statics:{saveResult:function(t){this.__Qv=t;
...
w+=l;
x.load(w,function(y){this.__Qw();
},this);
},__Qw:function(){var z=demobrowser.demo.data.store.Twitter.__Qv;
