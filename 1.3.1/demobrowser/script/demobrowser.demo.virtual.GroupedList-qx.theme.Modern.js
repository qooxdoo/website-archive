...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.GroupedList","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.GroupedList-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"521293dab0c8"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="model.persons",k="bold",j="model",i="persons.json</a> and binds the created model to all list widgets. ",h="demobrowser.demo.virtual.GroupedList",g="Friends",f="json/persons.json",e="by first name and groups it by the 'group' model property. The ",d="third list is configured  to use a customized group item for rendering.",c="Grouped by last name:",B="<b>Grouped List</b><br/>",A="Raw List:",z="The second list sorts the items by last name and groups the items ",y="Colleagues",x="icon",w="#005E00",v="Loads the json file <a href='json/persons.json' target='_blank'>",u="The first list shows only the row data and uses a converter for the ",t="Grouped by group:",s="icon/16/emotes/face-laugh.png",q="by the first letter of the last name. The third list sorts the items ",r="label",o="icon/16/categories/system.png",p="icon/16/categories/office.png",m="white",n="label that concatenates the first and last name. ";
qx.Class.define(h,{extend:qx.application.Standalone,members:{__PD:null,__PE:null,__PF:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var F=this.createFirstExample();
var H=this.createSecondExample();
var G=this.createThirdExample();
this.loadData();
var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
this.getRoot().add(C,{edge:20});
var D=new qx.ui.basic.Label();
D.setRich(true);
D.setWidth(470);
D.setValue(B+v+i+u+n+z+q+e+d);
C.add(D);
...
E.add(H);
E.add(G);
},loadData:function(){var I=f;
var J=new qx.data.store.Json(I);
J.bind(l,this.__PD,j);
J.bind(l,this.__PE,j);
J.bind(l,this.__PF,j);
},createFirstExample:function(){var L=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var M=new qx.ui.basic.Label(A).set({font:k});
L.add(M);
var K=this.__PD=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(N,O){return O?N+" "+O.getLastname():"no model...";
}}});
L.add(K,{top:20});
return L;
},createSecondExample:function(){var Q=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var S=new qx.ui.basic.Label(c).set({font:k});
Q.add(S);
var P=this.__PE=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(T,U){return U?U.getLastname()+", "+T:"no model...";
}}});
Q.add(P,{top:20});
var R={sorter:function(a,b){a=a.getLastname();
b=b.getLastname();
return a>b?1:a<b?-1:0;
},group:function(V){return V.getLastname().charAt(0).toUpperCase();
}};
P.setDelegate(R);
P.setSelection(this.__PD.getSelection());
return Q;
},createThirdExample:function(){var X=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var ba=new qx.ui.basic.Label(t).set({font:k});
X.add(ba);
var W=this.__PF=new qx.ui.list.List().set({height:280,width:150,labelPath:"firstname",labelOptions:{converter:function(bb,bc){return bc?bb+" "+bc.getLastname():"no model...";
}}});
X.add(W,{top:20});
var Y={sorter:function(a,b){a=a.getLastname();
b=b.getLastname();
return a>b?1:a<b?-1:0;
},group:function(bd){return bd.getGroup?bd.getGroup():null;
},createGroupItem:function(){return new qx.ui.form.ListItem();
},configureGroupItem:function(be){be.setBackgroundColor(w);
be.setTextColor(m);
},bindGroupItem:function(bf,bg,bh){bf.bindProperty(null,r,null,bg,bh);
bf.bindProperty(null,x,{converter:function(bi){switch(bi){case g:return s;
case y:return p;
default:return o;
}}},bg,bh);
}};
W.setDelegate(Y);
W.setSelection(this.__PD.getSelection());
return X;
}},destruct:function(){this.__PD.dispose();
this.__PE.dispose();
this.__PF.dispose();
this.__PD=this.__PE=this.__PF=null;
}});
})();
