...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Multimedia-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"ef34b4d163d9"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(k,{statics:{__Nf:{quicktime:{plugin:f,control:j},wmv:{plugin:n,control:l},divx:{plugin:c,control:d},silverlight:{plugin:o,control:a}},has:function(p,q){if(this.__Nf[p]){var r=this.__Nf[p];
if(r.installed){if(q==null||(r.version>=parseFloat(q))){return true;
}}}return false;
},__Ng:qx.core.Variant.select(h,{"mshtml":function(){var s=window.ActiveXObject;
