...
z.moveTo(300,250);
z.addListener(f,function(e){z.__PP.focus();
z.__PP.setTextSelection(0,z.__PP.getValue().length);
});
z.__PP=new qx.ui.form.TextField(w.value+"").set({allowGrowY:true});
z.add(z.__PP);
...
return z;
},getCellEditorValue:function(A){return parseFloat(A.__PP.getValue());
}}});
})();
