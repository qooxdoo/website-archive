...
qx.Class.define(s,{extend:qx.application.Standalone,members:{__QS:null,__QT:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var L=this.getRoot();
...
var B=this.__QS=new qx.ui.form.List;
B.setDraggable(true);
B.setDroppable(true);
...
if(U instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__QT=U;
}
...
B.addListener(m,function(e){this.__QU(e.getOriginalTarget());
},this);
C.addListener(m,function(e){this.__QU(this.__QT);
},this);
},__QU:function(V){if(V.classname!="qx.ui.form.ListItem"){return;
}var W=this.__QS.getSortedSelection();

for(var i=0,l=W.length;i<l;i++){this.__QS.addBefore(W[i],V);
this.__QS.addToSelection(W[i]);
