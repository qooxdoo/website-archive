...
qx.Class.define(z,{extend:qx.data.store.Json,statics:{saveResult:function(T){this.__QA=T;
...
W+=p;
X.load(W,function(Y){this.__QB();
},this);
},__QB:function(){var ba=demobrowser.demo.data.store.Twitter.__QA;
