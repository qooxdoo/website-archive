...
(function(){var g="scrollY",f="update",d="scrollX",c="__Hn",b="pane",a="qx.ui.virtual.core.Scroller";
...
this.__Hn=new qx.ui.virtual.core.Pane(h,i,j,k);
this.__Hn.addListener(f,this._computeScrollbars,this);
this.__Hn.addListener(d,this._onScrollPaneX,this);
this.__Hn.addListener(g,this._onScrollPaneY,this);
this._add(this.__Hn,{row:0,column:0});
},properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__Hn:null,getPane:function(){return this.__Hn;
},_createChildControlImpl:function(l,m){if(l==b){return this.__Hn;
...
},_onScrollBarX:function(e){this.__Hn.setScrollX(e.getData());
},_onScrollBarY:function(e){this.__Hn.setScrollY(e.getData());
...
(function(){var l="appear",k="qx.ui.virtual.core.CellEvent",j="qx.event.type.Data",h="change",g="scrollY",f="full update",d="__Gp",c="dblclick",b="cellDblclick",a="update layer window",A="qx.event.type.Event",z="__Gx",y="cellContextmenu",x="resize",w="__Gq",v="scrollX",u="__Gy",t="qx.ui.virtual.core.Pane",s="click",r="update",p="prefetch x",q="contextmenu",n="cellClick",o="prefetch y",m="scroll";
qx.Class.define(t,{extend:qx.ui.core.Widget,construct:function(B,C,D,E){qx.ui.core.Widget.call(this);
this.__Gp=new qx.ui.virtual.core.Axis(D,B);
this.__Gq=new qx.ui.virtual.core.Axis(E,C);
this.__Gr=0;
this.__Gs=0;
this.__Gt=0;
this.__Gu=0;
this.__Gv={};
this.__Gw={};
this.__Gx=new qx.ui.container.Composite();
this.__Gx.setUserBounds(0,0,0,0);
this._add(this.__Gx);
this.__Gy=[];
this.__Gp.addListener(h,this.fullUpdate,this);
this.__Gq.addListener(h,this.fullUpdate,this);
...
},events:{cellClick:k,cellContextmenu:k,cellDblclick:k,update:A,scrollX:j,scrollY:j},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__Gp:null,__Gq:null,__Gr:null,__Gs:null,__Gt:null,__Gu:null,__Gv:null,__Gw:null,__Gx:null,__Gy:null,__Gz:null,__GA:null,__GB:null,DEBUG:false,getRowConfig:function(){return this.__Gp;
},getColumnConfig:function(){return this.__Gq;
},getChildren:function(){return [this.__Gx];
},addLayer:function(F){{};
this.__Gy.push(F);
F.setUserBounds(0,0,0,0);
this.__Gx.add(F);
},getLayers:function(){return this.__Gy;
},getVisibleLayers:function(){var G=[];

for(var i=0;i<this.__Gy.length;i++){var H=this.__Gy[i];

if(H.isVisible()){G.push(H);
}}return G;
},getScrollMaxX:function(){var I=this.getBounds();

if(I){return Math.max(0,this.__Gq.getTotalSize()-I.width);
}return 0;
},getScrollMaxY:function(){var J=this.getBounds();

if(J){return Math.max(0,this.__Gp.getTotalSize()-J.height);
}return 0;
...
if(this.__Gr!==K){var M=this.__Gr;
this.__Gr=K;
this._deferredUpdateScrollPosition();
this.fireDataEvent(g,K,M);
}},getScrollY:function(){return this.__Gr;
},setScrollX:function(N){var O=this.getScrollMaxX();

if(N<0){N=0;
}else if(N>O){N=O;
}
if(N!==this.__Gs){var P=this.__Gs;
this.__Gs=N;
this._deferredUpdateScrollPosition();
this.fireDataEvent(v,N,P);
}},getScrollX:function(){return this.__Gs;
},getScrollSize:function(){return {width:this.__Gq.getTotalSize(),height:this.__Gp.getTotalSize()};
...
return;
}var U=this.__Gp.getItemPosition(Q);
var S=U+this.__Gp.getItemSize(Q);
...
return;
}var X=this.__Gq.getItemPosition(V);
var W=X+this.__Gq.getItemSize(V);
...
}bg=this.__Gp.getItemAtPosition(this.getScrollY()+bf-bi.top);
bh=this.__Gq.getItemAtPosition(this.getScrollX()+be-bi.left);
...
if(!bp){return;
}var bq=this.__Gs+bp.width;
var br=this.__Gu-bq;

if(this.__Gs-this.__Gv.left<Math.min(this.__Gs,bj)||this.__Gv.right-bq<Math.min(br,bl)){this.DEBUG&&console.log(p);
var bs=Math.min(this.__Gs,bk);
var bo=Math.min(br,bm);
this._setLayerWindow(bn,this.__Gs-bs,this.__Gr,bp.width+bs+bo,bp.height,false);
...
if(!bA){return;
}var by=this.__Gr+bA.height;
var bz=this.__Gt-by;

if(this.__Gr-this.__Gv.top<Math.min(this.__Gr,bt)||this.__Gv.bottom-by<Math.min(bz,bv)){this.DEBUG&&console.log(o);
var bC=Math.min(this.__Gr,bu);
var bB=Math.min(bz,bw);
this._setLayerWindow(bx,this.__Gs,this.__Gr-bC,bA.width,bA.height+bC+bB,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__Gz=true;
this._updateScrollPosition();
this.__Gz=null;
this.fireEvent(r);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__GC(e,n);
},_onContextmenu:function(e){this.__GC(e,y);
},_onDblclick:function(e){this.__GC(e,b);
},__GC:function(e,bD){var bE=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());

if(!bE){return;
}this.fireNonBubblingEvent(bD,qx.ui.virtual.core.CellEvent,[this,e,bE.row,bE.column]);
},syncWidget:function(){if(this.__Gw._fullUpdate){this._fullUpdate();
}else if(this.__Gw._updateScrollPosition){this._updateScrollPosition();
}this.__Gw={};
},_setLayerWindow:function(bF,bG,top,bH,bI,bJ){var bO=this.__Gp.getItemAtPosition(top);

if(bO){var bQ=bO.index;
var bV=this.__Gp.getItemSizes(bQ,bI+bO.offset);
...
var bX=0;
var bU=0;
}var bS=this.__Gq.getItemAtPosition(bG);

if(bS){var bM=bS.index;
var bL=this.__Gq.getItemSizes(bM,bH+bS.offset);
...
var bW=0;
var bN=0;
}this.__Gv={top:bX,bottom:bU,left:bW,right:bN};
this.__Gx.setUserBounds(this.__Gv.left-this.__Gs,this.__Gv.top-this.__Gr,bR,bP);
this.__GA=bL;
this.__GB=bV;
this.DEBUG&&qx.ui.core.queue.Manager.flush();

for(var i=0;i<this.__Gy.length;i++){var bT=new Date();
var bK=this.__Gy[i];
...
}}},__GD:function(){if(this.__Gz){return;
}var bY=this.getScrollSize();

if(this.__Gt!==bY.height||this.__Gu!==bY.width){this.__Gt=bY.height;
this.__Gu=bY.width;
this.fireEvent("update");
}},fullUpdate:function(){this.__Gw._fullUpdate=1;
qx.ui.core.queue.Widget.add(this);
},isUpdatePending:function(){return !!this.__Gw._fullUpdate;
},_fullUpdate:function(){var ca=this.getVisibleLayers();

if(ca.length==0){this.__GD();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var cb=this.getBounds();
this.DEBUG&&console.log(f);
this._setLayerWindow(ca,this.__Gs,this.__Gr,cb.width,cb.height,true);
this.__GD();
},_deferredUpdateScrollPosition:function(){this.__Gw._updateScrollPosition=1;
qx.ui.core.queue.Widget.add(this);
},_updateScrollPosition:function(){var cc=this.getVisibleLayers();

if(cc.length==0){this.__GD();
return;
}var ce=this.getBounds();

if(!ce){return ;
}var cd={top:this.__Gr,bottom:this.__Gr+ce.height,left:this.__Gs,right:this.__Gs+ce.width};

if(this.__Gv.top<=cd.top&&this.__Gv.bottom>=cd.bottom&&this.__Gv.left<=cd.left&&this.__Gv.right>=cd.right){this.DEBUG&&console.log(m);
this.__Gx.setUserBounds(this.__Gv.left-cd.left,this.__Gv.top-cd.top,this.__Gv.right-this.__Gv.left,this.__Gv.bottom-this.__Gv.top);
}else{this.DEBUG&&console.log(a);
this._setLayerWindow(cc,this.__Gs,this.__Gr,ce.width,ce.height,false);
}this.__GD();
}},destruct:function(){this._disposeArray(u);
this._disposeObjects(d,w,z);
this.__Gv=this.__Gw=this.__GA=this.__GB=null;
}});
})();
...
this.customSizes={};
},events:{"change":d},members:{__GE:null,getDefaultItemSize:function(){return this.defaultItemSize;
...
this.__GE=null;
this.fireNonBubblingEvent(e);
},__GF:function(){if(this.__GE){return this.__GE;
...
this.__GE=s;
return s;
},__GG:function(y){var z=this.__GE||this.__GF();
var A=0;
var C=z.length-1;
...
}},__GH:function(K){var L=this.__GE||this.__GF();
var M=0;
var O=L.length-1;
...
}},getTotalSize:function(){var S=this.__GE||this.__GF();
...
}},destruct:function(){this.customSizes=this.__GE=null;
}});
})();
...
this.__He={};
},properties:{anonymous:{refine:true,init:true}},members:{__He:null,__Hf:null,__Hg:null,__Hh:null,__Hi:null,__Hj:null,getFirstRow:function(){return this.__Hg;
},getFirstColumn:function(){return this.__Hh;
},getRowSizes:function(){return this.__Hi||[];
},getColumnSizes:function(){return this.__Hj||[];
},syncWidget:function(){if(!this.getContentElement().getDomElement()){return;
}
if(this.__He.fullUpdate||this.__He.updateLayerWindow&&this.__He.updateLayerData){this._fullUpdate.apply(this,this.__Hf);
}else if(this.__He.updateLayerWindow){this._updateLayerWindow.apply(this,this.__Hf);
}else if(this.__He.updateLayerData&&this.__Hi){this._updateLayerData();
}
if(this.__He.fullUpdate||this.__He.updateLayerWindow){var c=this.__Hf;
this.__Hg=c[0];
this.__Hh=c[1];
this.__Hi=c[2];
this.__Hj=c[3];
}this.__He={};
},_updateLayerData:function(){this._fullUpdate(this.__Hg,this.__Hh,this.__Hi,this.__Hj);
...
},updateLayerData:function(){this.__He.updateLayerData=true;
qx.ui.core.queue.Widget.add(this);
},fullUpdate:function(l,m,n,o){this.__Hf=arguments;
this.__He.fullUpdate=true;
qx.ui.core.queue.Widget.add(this);
},updateLayerWindow:function(p,q,r,s){this.__Hf=arguments;
this.__He.updateLayerWindow=true;
qx.ui.core.queue.Widget.add(this);
}},destruct:function(){this.__He=this.__Hf=this.__Hi=this.__Hj=null;
}});
})();
...
this.__Hz={};
},properties:{colorEven:{nullable:true,check:d,apply:b,themeable:true},colorOdd:{nullable:true,check:d,apply:c,themeable:true}},members:{__HA:null,__HB:null,__Hy:null,__Hz:null,setColor:function(g,h){if(h){this.__Hy[g]=qx.theme.manager.Color.getInstance().resolve(h);
}else{delete (this.__Hy[g]);
}},clearCustomColors:function(){this.__Hy={};
this.updateLayerData();
},getColor:function(i){var j=this.__Hy[i];

if(j){return j;
}else{return i%2==0?this.__HA:this.__HB;
}},_applyColorEven:function(k,l){if(k){this.__HA=qx.theme.manager.Color.getInstance().resolve(k);
}else{this.__HA=null;
}this.updateLayerData();
},_applyColorOdd:function(m,n){if(m){this.__HB=qx.theme.manager.Color.getInstance().resolve(m);
}else{this.__HB=null;
}this.updateLayerData();
},setBackground:function(o,p){if(p){this.__Hz[o]=qx.theme.manager.Decoration.getInstance().resolve(p);
}else{delete (this.__Hz[o]);
}this.updateLayerData();
},getBackground:function(q){return this.__Hz[q];
...
if(this.__HC(J)){this.updateLayerData();
}},setBackground:function(L,M){qx.ui.virtual.layer.AbstractBackground.prototype.setBackground.call(this,L,M);

if(this.__HC(L)){this.updateLayerData();
}},__HC:function(N){var P=this.getFirstRow();
