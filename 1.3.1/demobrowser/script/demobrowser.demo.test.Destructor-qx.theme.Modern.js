...
(function(){var e="Window: ",d="interval",c="__OD",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__OB:null,__OC:0,__OD:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__OB=[];
this.currentTest=this.testWindows;
this.__OD=new qx.event.Timer(1000);
this.__OD.addListener(d,this.runTest,this);
this.__OD.start();
},runTest:function(){this.__OC++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__OC+" (Registry: "+g+")");
this.currentTest();
