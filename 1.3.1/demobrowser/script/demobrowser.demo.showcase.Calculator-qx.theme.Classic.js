...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.showcase.Calculator","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.showcase.Calculator-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"433346f804f6"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="execute",j="-",i="+",h="/",g="*",f="=",d=".",c="__QE",b="black",a="Del",G="sans-serif",F="C",E="5",D="7",C="demobrowser.demo.showcase.Calculator",B="CE",A="solid",z="icon/22/apps/utilities-calculator.png",y="3",x="0",r="n",s="8",p="__QD",q="6",n="4",o="Calculator",l="2",m="Verdana",t="1",u="demobrowser.demo.showcase.CalculatorLogic",w="+/-",v="9";
qx.Class.define(C,{extend:qx.application.Standalone,members:{__QD:null,__QE:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__QE=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var I=new qx.ui.window.Window(o,z);
I.setLayout(new qx.ui.layout.VBox(16));
var K=new qx.ui.decoration.Single(1,A,b);
...
S.setLayout(bd);
this.__QD=new qx.ui.basic.Label(this.__QE.getCurrentValue().toString()).set({decorator:K,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__QD.setEnabled(false);
var be=new qx.bom.Font().set({size:14,family:[m,G],bold:true});
var X=new qx.ui.form.Button(x).set({font:be,minWidth:40});
var W=new qx.ui.form.Button(t).set({font:be,minWidth:40});
var V=new qx.ui.form.Button(l).set({font:be,minWidth:40});
var U=new qx.ui.form.Button(y).set({font:be,minWidth:40});
var bc=new qx.ui.form.Button(n).set({font:be,minWidth:40});
var bb=new qx.ui.form.Button(E).set({font:be,minWidth:40});
var ba=new qx.ui.form.Button(q).set({font:be,minWidth:40});
var Y=new qx.ui.form.Button(D).set({font:be,minWidth:40});
var bg=new qx.ui.form.Button(s).set({font:be,minWidth:40});
var bf=new qx.ui.form.Button(v).set({font:be,minWidth:40});
var H=new qx.ui.form.Button(F).set({font:be,minWidth:40});
var J=new qx.ui.form.Button(B).set({font:be,minWidth:40});
var O=new qx.ui.form.Button(a).set({font:be,minWidth:40});
...
bd.setRowFlex(5,1);
bd.setRowFlex(6,1);
S.add(this.__QD,{row:0,column:0,rowSpan:0,colSpan:4});
...
I.add(S,{flex:1});
H.addListener(k,function(e){this.__QE.cleanDisplay();
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
J.addListener(k,function(e){this.__QE.clearEntry();

if(this.__QE.getResult()!=null){this.__QD.setValue(this.__QE.getCurrentValue().toString());
}},this);
O.addListener(k,function(e){this.__QE.deleteNumber();
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
N.addListener(k,function(e){this.__QE.setSign();

if(this.__QE.getResult()!=null){this.__QD.setValue(this.__QE.getResult().toString());
}},this);
X.addListener(k,function(e){this.__QE.setCurrentValue(0);
this.__QD.setValue(this.__QE.getCurrentValue().toFixed(this.__QE.getZeroCounter()).toString());
},this);
W.addListener(k,function(e){this.__QE.setCurrentValue(1);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
V.addListener(k,function(e){this.__QE.setCurrentValue(2);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
U.addListener(k,function(e){this.__QE.setCurrentValue(3);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__QE.setCurrentValue(4);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
bb.addListener(k,function(e){this.__QE.setCurrentValue(5);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
ba.addListener(k,function(e){this.__QE.setCurrentValue(6);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
Y.addListener(k,function(e){this.__QE.setCurrentValue(7);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
bg.addListener(k,function(e){this.__QE.setCurrentValue(8);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
bf.addListener(k,function(e){this.__QE.setCurrentValue(9);
this.__QD.setValue(this.__QE.getCurrentValue().toString());
},this);
M.addListener(k,function(e){this.__QE.calculate(i);

if(this.__QE.getResult()!=null){this.__QD.setValue(this.__QE.getResult().toString());
}this.__QE.resetCurrentValue();
},this);
T.addListener(k,function(e){this.__QE.calculate(j);

if(this.__QE.getResult()!=null){this.__QD.setValue(this.__QE.getResult().toString());
}this.__QE.resetCurrentValue();
},this);
R.addListener(k,function(e){this.__QE.calculate(g);

if(this.__QE.getResult()!=null){this.__QD.setValue(this.__QE.getResult().toString());
}this.__QE.resetCurrentValue();
},this);
P.addListener(k,function(e){this.__QE.calculate(h);

if(this.__QE.getResult()!=null){this.__QD.setValue(this.__QE.getResult().toString());
}this.__QE.resetCurrentValue();
},this);
L.addListener(k,function(e){this.__QE.calculate(f);

if(this.__QE.getResult()!=null){this.__QD.setValue(this.__QE.getResult().toString());
}this.__QE.resetCurrentValue();
},this);
Q.addListener(k,function(e){this.__QE.setComma();
},this);
}},destruct:function(){this._disposeObjects(c,p);
}});
qx.Class.define(u,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__QF:0,__QG:0,__QH:"n",__QI:0,__QJ:0,__QK:0,__QL:false,__QM:1,__QN:0,__QO:false,__QP:0,setCurrentValue:function(bh){if(this.__QL){this.__QM*=10;
this.__QF=this.__QF+(bh/this.__QM);

if(bh==0){this.__QN++;
}}else{this.__QL=false;

if(this.__QF<0){this.__QF=this.__QF*10-bh;
}else{this.__QF=this.__QF*10+bh;
}}},getZeroCounter:function(){return this.__QN;
},setComma:function(){this.__QL=true;
},getCurrentValue:function(){return this.__QF;
},resetCurrentValue:function(){this.__QF=null;
},cleanDisplay:function(){this.__QP=0;
this.__QJ=0;
this.__QH="n";
this.__QN=0;
this.__QM=1;
...
this.__QG=0;
this.__QO=false;
},setResult:function(bi){this.__QG=bi;
},getResult:function(){return Math.round(this.__QG*10000000)/10000000;
},setCurrentOperation:function(bj){this.__QH=bj;
},getCurrentOperation:function(){return this.__QH;
},clearEntry:function(){this.__QO=false;
this.__QN=0;
this.__QM=1;
this.__QL=false;
this.__QK++;
...
if(this.__QK<2){this.__QJ=this.__QG;
}
if(this.__QI>=2){this.__QG=0;
this.__QI=0;
}},setSign:function(){this.__QP++;

if(this.__QP%2==0){this.__QO=false;
}else{this.__QO=true;
}
if(this.__QF==null){this.__QF=this.__QG;
}this.__QF=this.__QF*(-1);

if(this.__QG==0){this.__QG=this.__QF;
}
if(this.__QG!=0){this.__QJ=this.__QG;
this.__QG=this.__QF;
}},deleteNumber:function(){var bk=false;
var bn=false;

if(this.__QF<0){this.__QF=this.__QF*(-1);
bn=true;
}
if(this.__QF!=null){if(this.__QF.toString().lastIndexOf(d)!=-1){this.__QF=this.__QF*this.__QM;
bk=true;
}}var bl=this.__QF%10;
var bm=bl/10;
this.__QF=this.__QF/10;
this.__QF=this.__QF-bm;

if(bk){this.__QM/=10;
this.__QF=this.__QF/(this.__QM);
bk=false;
}
if(bn){this.__QF=this.__QF*(-1);
bn=false;
}},calculate:function(bo){if(bo==i||bo==g||bo==h||bo==j||bo==f){this.__QL=false;
this.__QM=1;
this.__QN=0;

if(this.__QH!=r){if(this.__QH==i){if(this.__QG==null){this.__QG=this.__QJ;
}
if(this.__QO){this.__QG=this.__QJ+this.__QF;
}else{this.__QG=this.__QG+this.__QF;
}this.__QF=this.__QG;
this.__QJ=this.__QG;
}
if(this.__QH==j){if(this.__QG==0){this.__QG=this.__QF;
this.__QF=0;
}
if(this.__QG==null){this.__QG=this.__QJ;
}
if(this.__QO){this.__QG=this.__QJ-this.__QF;
}else{this.__QG=this.__QG-this.__QF;
}this.__QF=this.__QG;
...
if(this.__QH==h){if(this.__QG==0){this.__QG=this.__QF;
this.__QF=1;
}
if(this.__QG==null){this.__QG=this.__QJ;
}
if(this.__QF!=null){if(this.__QF!=0){if(this.__QO){this.__QG=this.__QJ/this.__QF;
}else{this.__QG=this.__QG/this.__QF;
}}else{alert("You can't divide by 0!");
}}this.__QF=this.__QG;
this.__QJ=this.__QG;
}
if(this.__QH==g){if(this.__QG==0){this.__QG=1;
}
if(this.__QF==null){this.__QF=1;
}
if(this.__QG==null){this.__QG=this.__QJ;
}
if(this.__QO){this.__QG=this.__QJ*this.__QF;
...
this.__QJ=this.__QG;
}}else{this.__QG=this.__QF;
}
if(bo!=f){this.__QH=bo;
}else{this.__QI++;
this.__QG=this.__QJ;
this.__QH="n";
}this.__QO=false;
