...
(function(){var l="",k="selected",j="cell",h="layer",g="icon",f="#f3f3f3",d="label",c="Gallery (HTML - divs)",b="__PB",a="manager",P="default",O="demobrowser.demo.virtual.Gallery",N="demobrowser.demo.virtual.WidgetGallery",M="text-align: center;",L="auto",K="color: white; background-color: #00398D;",J="user-desktop.png",I="<img src='",H="'></img>",G="group",s="resize",t="folder.png",q="vertical",r="multi",o="network-server.png",p="user-trash.png",m="off",n="top",u="icon/32/places/",v="horizontal",y="demobrowser.demo.virtual.AbstractGallery",x="abstract",A="position: absolute;",z="demobrowser.demo.virtual.HtmlGallery",C="Gallery (widgets)",B="<br>",w="Icon #",F="network-workgroup.png",E="text-selected",D="demobrowser.demo.virtual.GalleryCell";
...
qx.Class.define(N,{extend:demobrowser.demo.virtual.AbstractGallery,construct:function(bt){demobrowser.demo.virtual.AbstractGallery.call(this,bt);
this.__PB=new demobrowser.demo.virtual.GalleryCell();
...
if(bx){this.__PB.updateStates(bz,{selected:1});
}else{this.__PB.updateStates(bz,{});
...
}var bF=this.__PB.getCellWidget(bG,bE);
bF.setUserData(j,bD);
return bF;
},poolCellWidget:function(bH){this.__PB.pool(bH);
}},destruct:function(){this._disposeObjects(b,h);
}});
...
var bJ=qx.theme.manager.Font.getInstance().resolve(P).getStyles();
...
var bR=bS?K:l;
return {style:[A,M,this._fontCss,bR].join(l),content:[I,bT.resolvedIcon,H,B,bT.label].join(l)};
