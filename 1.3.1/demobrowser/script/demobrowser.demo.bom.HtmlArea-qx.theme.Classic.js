...
qx.Class.define(B,{extend:qx.application.Native,members:{__Rk:null,__Rl:null,__Rm:null,__Rn:null,__Ro:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__Rk=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(this.__Rk,{margin:f});
var cy=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(cy,{width:bR,padding:ca,margin:ca});
var cx=h+cd+N+bG+U+M+bH;
qx.bom.element.Attribute.set(cy,bk,cx);
this.__Rl=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(this.__Rl,{width:bR,padding:ca,margin:ca,lineHeight:ca,border:bs});
this.__Rm=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(this.__Rm,{width:bR,height:bQ,border:bs,borderTop:ca,backgroundColor:bI});
qx.dom.Element.insertEnd(this.__Rm,this.__Rk);
var cw=bP;
this.__Rn=new qx.bom.htmlarea.HtmlArea(this.__Rm,cw,null,S);
this.__Ry();
qx.dom.Element.insertBegin(this.__Rl,this.__Rk);
qx.dom.Element.insertBegin(cy,this.__Rk);
qx.dom.Element.insertBegin(this.__Rk,document.body);
},__Rp:function(e){var cz=window.prompt(bE,cg);
this.setFontSize(parseInt(cz));
},__Rq:function(e){var cA=window.prompt(cf,bp);
this.setTextColor(cA);
},__Rr:function(e){var cB=window.prompt(cl,bp);
this.setTextBackgroundColor(cB);
},__Rs:function(e){var cC={src:qx.util.ResourceManager.getInstance().toUri(l),border:0,title:bn,alt:bn};
this.insertImage(cC);
},__Rt:function(e){var cD=bA+bf+bu+k+bb+cj+bu+J+bc+cj+K+ba;
this.insertHtml(cD);
},__Ru:function(e){var cE=window.prompt(v,ck);
this.insertHyperLink(cE);
},__Rv:function(e){var cF=window.prompt(cq,cg);
this.insertHtml(cF);
},__Rw:function(){var cH=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(cH,{"float":bv});
var cJ;
var cI=qx.bom.Element.create(ci,{title:bJ});

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cI,bW,bU);
}else{qx.bom.element.Style.set(cI,bY,bV);
}cJ=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cJ[0],cI);
var cK=[d,bw,bg,by,u,y,z,cc,t,c,bj];
var cG;
var cL;

for(var i=0,j=cK.length;i<j;i++){cG=W+bq+cK[i]+br+cK[i]+bo;
cL=qx.bom.Collection.html(cG);

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cL[0],bW,bU);
}else{qx.bom.element.Style.set(cL[0],bY,bV);
}qx.dom.Element.insertEnd(cL[0],cI);
}qx.event.Registration.addListener(cI,bm,function(e){var cM=e.getTarget();
var cN=cM.selectedIndex;

if(cN!=0){this.setFontFamily(cM.options[cN].value);
cM.options[0].selected=true;
}},this.__Rn);
qx.dom.Element.insertBegin(cI,cH);
return cH;
},__Rx:function(){var cP=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(cP,{"marginRight":bS,"float":bv});
var cR;
var cQ=qx.bom.Element.create(ci,{title:w});

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cQ,bW,bU);
}else{qx.bom.element.Style.set(cQ,bY,bV);
}cR=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cR[0],cQ);
var cS;
var cO;

for(var i=1;i<=7;i++){cO=Y+bq+i+br+i+bo;
cS=qx.bom.Collection.html(cO);

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cS[0],bW,bU);
}else{qx.bom.element.Style.set(cS[0],bY,bV);
}qx.dom.Element.insertEnd(cS[0],cQ);
}qx.event.Registration.addListener(cQ,bm,function(e){var cT=e.getTarget();
var cU=cT.selectedIndex;

if(cU!=0){this.setFontSize(cT.options[cU].value);
cT.options[0].selected=true;
}},this.__Rn);
qx.dom.Element.insertBegin(cQ,cP);
return cP;
},__Ry:function(){var cW=[{bold:{text:p,image:F,action:this.__Rn.setBold},italic:{text:bO,image:bz,action:this.__Rn.setItalic},underline:{text:bB,image:bN,action:this.__Rn.setUnderline},strikethrough:{text:bC,image:r,action:this.__Rn.setStrikeThrough},removeFormat:{text:R,image:I,action:this.__Rn.removeFormat}},{alignLeft:{text:m,image:A,action:this.__Rn.setJustifyLeft},alignCenter:{text:bh,image:cp,action:this.__Rn.setJustifyCenter},alignRight:{text:bL,image:G,action:this.__Rn.setJustifyRight},alignJustify:{text:cn,image:bx,action:this.__Rn.setJustifyFull}},{fontFamily:{custom:this.__Rw},fontSize:{custom:this.__Rx},fontColor:{text:P,image:Q,action:this.__Rq},textBackgroundColor:{text:cv,image:bM,action:this.__Rr}},{indent:{text:bK,image:b,action:this.__Rn.insertIndent},outdent:{text:bD,image:be,action:this.__Rn.insertOutdent}},{insertImage:{text:bd,image:T,action:this.__Rs},insertTable:{text:ce,image:O,action:this.__Rt},insertLink:{text:cu,image:D,action:this.__Ru},insertHTML:{text:E,image:cm,action:this.__Rv},insertHR:{text:ct,image:cs,action:this.__Rn.insertHorizontalRuler}},{ol:{text:C,image:a,action:this.__Rn.insertOrderedList},ul:{text:bF,image:cr,action:this.__Rn.insertUnorderedList}},{undo:{text:bl,image:H,action:this.__Rn.undo},redo:{text:q,image:bi,action:this.__Rn.redo}}];
var cY,dd,cV,db;

for(var i=0,j=cW.length;i<j;i++){dd={};
dd[n]=i==j-1?ca:bS;
dd[g]=bv;
cY=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(cY,dd);

for(var da in cW[i]){var dc=cW[i][da];

if(dc.custom){cV=dc.custom.call(this);
}else{var cX=qx.util.AliasManager.getInstance().resolve(dc.image);
db={type:V,src:qx.util.ResourceManager.getInstance().toUri(cX),title:dc.text,qxKeepFocus:L,qxSelectable:s};
cV=qx.bom.Element.create(co,db);
qx.bom.element.Style.setStyles(cV,{width:bS,height:bS,padding:x});

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cV,bW,bU);
}else{qx.bom.element.Style.set(cV,bY,bV);
}qx.event.Registration.addListener(cV,X,dc.action,this.__Rn);
}qx.dom.Element.insertEnd(cV,cY);
}qx.dom.Element.insertEnd(cY,this.__Rl);
}qx.dom.Element.insertEnd(qx.bom.Element.create(o,{style:ch}),this.__Rl);
}}});
})();
...
(function(){var m="get",k="set",h="reset",g=":not(",f="getValue",e="append",d=")",c="getPreviousSiblings",b="#",a="qx.bom.Collection",J="setValue",I="prepend",H="string",G="getAncestors",F="getOffsetParent",E="remove",D=">*",C="add",B="*",A="addListener",t="has",u="toggle",r="getSiblings",s="replace",p="after",q="replaceWith",n="setCss",o="setStyles",v="before",w="getNextSiblings",y="getPosition",x="getCss",z="removeListener";
(function(){var L=function(M,N){return function(O,P,Q,R,S,T){var length=this.length;

if(length>0){var U=M[N];

for(var i=0;i<length;i++){if(this[i].nodeType===1){U.call(M,this[i],O,P,Q,R,S,T);
}}}return this;
};
};
var K=function(V,W){return function(X,Y,ba,bb,bc,bd){if(this.length>0){var be=this[0].nodeType===1?V[W](this[0],X,Y,ba,bb,bc,bd):null;

if(be&&be.nodeType){return this.__LT([be]);
}else{return be;
}}return null;
};
};
qx.Class.define(a,{extend:qx.type.BaseArray,statics:{query:function(bf,bg){var bh=qx.bom.Selector.query(bf,bg);
return qx.lang.Array.cast(bh,qx.bom.Collection);
},id:function(bi){var bj=document.getElementById(bi);
if(bj&&bj.id!=bi){return qx.bom.Collection.query(b+bi);
}if(bj){return new qx.bom.Collection(bj);
...
},__LP:/^[^<]*(<(.|\s)+>)[^>]*$|^#([\w-]+)$/,create:function(bn,bo){var bq=qx.bom.Collection;
if(bn.nodeType){return new bq(bn);
}else if(typeof bn===H){var bp=bq.__LP.exec(bn);

if(bp){return bp[1]?bq.html(bp[1],bo):bq.id(bp[3].substring(1));
}else{return bq.query(bn,bo);
}}else{return qx.lang.Array.cast(bn,qx.bom.Collection);
}}},members:{__LQ:null,setAttribute:L(qx.bom.element.Attribute,k),resetAttribute:L(qx.bom.element.Attribute,h),getAttribute:K(qx.bom.element.Attribute,m),addClass:L(qx.bom.element.Class,C),getClass:K(qx.bom.element.Class,m),hasClass:K(qx.bom.element.Class,t),removeClass:L(qx.bom.element.Class,E),replaceClass:L(qx.bom.element.Class,s),toggleClass:L(qx.bom.element.Class,u),setValue:L(qx.bom.Input,J),getValue:K(qx.bom.Input,f),setStyle:L(qx.bom.element.Style,k),setStyles:L(qx.bom.element.Style,o),resetStyle:L(qx.bom.element.Style,h),getStyle:K(qx.bom.element.Style,m),setCss:L(qx.bom.element.Style,n),getCss:L(qx.bom.element.Style,x),getOffset:K(qx.bom.element.Location,m),getPosition:K(qx.bom.element.Location,y),getOffsetParent:K(qx.bom.element.Location,F),setScrollLeft:function(br){var Node=qx.dom.Node;

for(var i=0,l=this.length,bs;i<l;i++){bs=this[i];

if(Node.isElement(bs)){bs.scrollLeft=br;
}else if(Node.isWindow(bs)){bs.scrollTo(br,this.getScrollTop(bs));
}else if(Node.isDocument(bs)){Node.getWindow(bs).scrollTo(br,this.getScrollTop(bs));
}}return this;
...
},getScrollLeft:function(){var bv=this[0];

if(!bv){return null;
}var Node=qx.dom.Node;

if(Node.isWindow(bv)||Node.isDocument(bv)){return qx.bom.Viewport.getScrollLeft();
}return bv.scrollLeft;
},getScrollTop:function(){var bw=this[0];

if(!bw){return null;
}var Node=qx.dom.Node;

if(Node.isWindow(bw)||Node.isDocument(bw)){return qx.bom.Viewport.getScrollTop();
}return bw.scrollTop;
...
},getContentHeight:function(){var bA=this[0];

if(qx.dom.Node.isElement(bA)){return qx.bom.element.Dimension.getContentHeight(bA);
}return null;
},addListener:L(qx.bom.Element,A),removeListener:L(qx.bom.Element,z),eq:function(bB){return this.slice(bB,+bB+1);
},filter:function(bC,bD){var bE;

if(qx.lang.Type.isFunction(bC)){bE=qx.type.BaseArray.prototype.filter.call(this,bC,bD);
}else{bE=qx.bom.Selector.matches(bC,this);
}return this.__LT(bE);
},is:function(bF){return !!bF&&qx.bom.Selector.matches(bF,this).length>0;
},__LR:/^.[^:#\[\.,]*$/,not:function(bG){if(this.__LR.test(bG)){var bH=qx.bom.Selector.matches(g+bG+d,this);
return this.__LT(bH);
}var bH=qx.bom.Selector.matches(bG,this);
return this.filter(function(bI){return bH.indexOf(bI)===-1;
});
},add:function(bJ,bK){var bL=qx.bom.Selector.query(bJ,bK);
var bM=qx.lang.Array.unique(this.concat(bL));
return this.__LT(bM);
},children:function(bN){var bO=[];

for(var i=0,l=this.length;i<l;i++){bO.push.apply(bO,qx.dom.Hierarchy.getChildElements(this[i]));
}
if(bN){bO=qx.bom.Selector.matches(bN,bO);
}return this.__LT(bO);
...
return this.__LT(qx.lang.Array.unique(bR));
},contents:function(){var bV=[];
var bU=qx.lang.Array;

for(var i=0,l=this.length;i<l;i++){bV.push.apply(bV,bU.fromCollection(this[i].childNodes));
}return this.__LT(bV);
},find:function(bW){var bY=qx.bom.Selector;
if(this.length===1){return this.__LT(bY.query(bW,this[0]));
}else{var bX=[];

for(var i=0,l=this.length;i<l;i++){bX.push.apply(bX,bY.query(bW,this[i]));
}return this.__LT(qx.lang.Array.unique(bX));
...
},nextAll:function(cd){return this.__LS(w,cd);
},prev:function(ce){var cf=qx.dom.Hierarchy;
var cg=this.map(cf.getPreviousElementSibling,cf);
if(ce){cg=qx.bom.Selector.matches(ce,cg);
}return this.__LT(cg);
},prevAll:function(ch){return this.__LS(c,ch);
},parent:function(ci){var Element=qx.dom.Element;
var cj=qx.lang.Array.unique(this.map(Element.getParentElement,Element));
if(ci){cj=qx.bom.Selector.matches(ci,cj);
}return this.__LT(cj);
},parents:function(ck){return this.__LS(G,ck);
},siblings:function(cl){return this.__LS(r,cl);
},__LS:function(cm,cn){var cp=[];
var co=qx.dom.Hierarchy;

for(var i=0,l=this.length;i<l;i++){cp.push.apply(cp,co[cm](this[i]));
}var cq=qx.lang.Array.unique(cp);
if(cn){cq=qx.bom.Selector.matches(cn,cq);
}return this.__LT(cq);
},__LT:function(cr){var cs=new qx.bom.Collection;
cs.__LQ=this;
cr=Array.prototype.slice.call(cr,0);
cs.push.apply(cs,cr);
return cs;
},andSelf:function(){return this.add(this.__LQ);
},end:function(){return this.__LQ||new qx.bom.Collection();
},__LU:function(ct,cu){var cz=this[0];
var cy=cz.ownerDocument||cz;
var cx=cy.createDocumentFragment();
var cB=qx.bom.Html.clean(ct,cy,cx);
var cD=cx.firstChild;
if(cD){var cv=this.length-1;

for(var i=0,l=cv;i<l;i++){cu.call(this,this[i],cx.cloneNode(true));
}cu.call(this,this[cv],cx);
}if(cB){var cw;
var cC=qx.io.ScriptLoader;
var cA=qx.lang.Function;

for(var i=0,l=cB.length;i<l;i++){cw=cB[i];
if(cw.src){cC.get().load(cw.src);
}else{cA.globalEval(cw.text||cw.textContent||cw.innerHTML||"");
}if(cw.parentNode){cw.parentNode.removeChild(cw);
}}}return this;
},__LV:function(cE,cF){var cH=qx.bom.Selector;
var cG=qx.lang.Array;
var cJ=[];

for(var i=0,l=cE.length;i<l;i++){{};
cJ.push.apply(cJ,cH.query(cE[i]));
}cJ=cG.cast(cG.unique(cJ),qx.bom.Collection);
for(var i=0,cI=this.length;i<cI;i++){cJ[cF](this[i]);
}return this;
},append:function(cK){return this.__LU(arguments,this.__LW);
},prepend:function(cL){return this.__LU(arguments,this.__LX);
},__LW:function(cM,cN){cM.appendChild(cN);
},__LX:function(cO,cP){cO.insertBefore(cP,cO.firstChild);
},appendTo:function(cQ){return this.__LV(arguments,e);
},prependTo:function(cR){return this.__LV(arguments,I);
},before:function(cS){return this.__LU(arguments,this.__LY);
},after:function(cT){return this.__LU(arguments,this.__Ma);
},__LY:function(cU,cV){cU.parentNode.insertBefore(cV,cU);
},__Ma:function(cW,cX){cW.parentNode.insertBefore(cX,cW.nextSibling);
},insertBefore:function(cY){return this.__LV(arguments,v);
},insertAfter:function(da){return this.__LV(arguments,p);
},wrapAll:function(content){var dc=this[0];

if(dc){var db=qx.bom.Collection.create(content,dc.ownerDocument).clone();
if(dc.parentNode){dc.parentNode.insertBefore(db[0],dc);
}db.map(this.__Mb).append(this);
}return this;
},__Mb:function(dd){while(dd.firstChild){dd=dd.firstChild;
}return dd;
},wrapInner:function(content){var de=new qx.bom.Collection(1);

for(var i=0,l=this.length;i<l;i++){de[0]=this[i];
de.contents().wrapAll(content);
}return this;
...
},replaceAll:function(dg){return this.__LV(arguments,q);
...
},destroy:function(dl){if(this.length==0){return this;
}var dn=qx.bom.Selector;
var dr=this;

if(dl){dr=this.filter(dl);

if(dr.length==0){return this;
}}var dq=qx.event.Registration.getManager(this[0]);

for(var i=0,l=dr.length,dp,ds;i<l;i++){dp=dr[i];
dq.removeAllListeners(dp);
ds=dn.query(B,dp);

for(var j=0,dm=ds.length;j<dm;j++){dq.removeAllListeners(ds[j]);
}if(dp.parentNode){dp.parentNode.removeChild(dp);
}}if(dl){dr.end();
qx.lang.Array.exclude(this,dr);
}else{this.length=0;
}return this;
},empty:function(){var dt=qx.bom.Collection;

for(var i=0,l=this.length;i<l;i++){dt.query(D,this[i]).destroy();
while(this.firstChild){this.removeChild(this.firstChild);
}}return this;
},clone:function(du){var Element=qx.bom.Element;
return du?
this.map(function(dv){return Element.clone(dv,true);
}):this.map(Element.clone,Element);
}},defer:function(dw){if(window.$==null){window.$=dw.create;
}}});
})();
})();
(function(){var e="script",d="string",c="undefined",b="qx.bom.Html",a="text/javascript";
qx.Class.define(b,{statics:{__IV:function(f,g,h){return h.match(/^(abbr|br|col|img|input|link|meta|param|hr|area|embed)$/i)?f:g+"></"+h+">";
},__IW:{opt:[1,"<select multiple='multiple'>","</select>"],leg:[1,"<fieldset>","</fieldset>"],table:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],def:qx.core.Variant.select("qx.client",{"mshtml":[1,"div<div>","</div>"],"default":null})},__IX:function(k,m){var s=m.createElement("div");
k=k.replace(/(<(\w+)[^>]*?)\/>/g,this.__IV);
