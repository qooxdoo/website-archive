...
qx.Class.define(o,{extend:qx.application.Standalone,members:{__QV:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var r=this.getRoot();
this.__QV=["bottom-left","bottom-right","top-left","top-right","right-top","right-bottom","left-top","left-bottom"];
...
for(var i=0;i<this.__QV.length;i++){var v=new qx.ui.form.ListItem(this.__QV[i]);
t.add(v);

if(this.__QV[i]==s){x=v;
}}w.add(t);
...
for(var i=0;i<this.__QV.length;i++){z.add(new qx.ui.form.ListItem(this.__QV[i]));
}B.add(z);
