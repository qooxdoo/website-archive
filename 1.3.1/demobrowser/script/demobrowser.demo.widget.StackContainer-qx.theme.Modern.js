...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.StackContainer","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.StackContainer-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"5dd7b7800fce"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var r="execute",q="yellow",p="teal",o="gray",n="red",m="Next",l="Previous",k="green",j="icon/22/actions/go-next.png",h="changeSelection",c="icon/22/actions/go-previous.png",g="orange",f="main",b="blue",a="resize",d="demobrowser.demo.widget.StackContainer";
...
},addSimpleStack:function(){var u=new qx.ui.container.Stack();
u.setDecorator(f);
u.setWidth(200);
u.setHeight(120);
this.getRoot().add(u,{left:20,top:20});
var s=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));
var x=new qx.ui.form.Button(l,c);
var v=new qx.ui.form.Button(m,j);
s.add(x);
s.add(v);
this.getRoot().add(s,{left:20,top:150});
x.addListener(r,u.previous,u);
v.addListener(r,u.next,u);
var w=[n,o,b,g,p,q,k];
var t;

for(var i=0;i<w.length;i++){t=new qx.ui.core.Widget;
t.setBackgroundColor(w[i]);
u.add(t);
}u.addListener(h,function(e){this.debug("Selected: "+e.getData()[0].getBackgroundColor());
});
},addDynamicStack:function(){var A=new qx.ui.container.Stack();
A.setDecorator(f);
A.setDynamic(true);
this.getRoot().add(A,{left:250,top:20});
var y=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));
var D=new qx.ui.form.Button(l,c);
var B=new qx.ui.form.Button(m,j);
y.add(D);
y.add(B);
this.getRoot().add(y,{left:250,top:150});
D.addListener(r,A.previous,A);
B.addListener(r,A.next,A);
var C=[n,o,b,g,p,q,k];
var z;

for(var i=0;i<C.length;i++){z=new qx.ui.core.Widget;
z.setBackgroundColor(C[i]);
z.setWidth((Math.round(i/2)+1)*50);
z.setHeight((Math.round(i/3)+1)*40);
A.add(z);
}A.addListener(h,function(e){var E=e.getData()[0];
this.debug("Selected: "+E.getBackgroundColor()+" ("+E.getWidth()+"x"+E.getHeight()+")");
});
A.addListener(a,function(e){var F=this.getBounds();
this.debug("Resize to: "+F.width+"x"+F.height);
});
}}});
})();
