...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.showcase.Maps","qx.theme":"qx.theme.Modern"};
...
(function(){var h="appear",g="Google Maps",f="center_changed",e="Karlsruhe",d="Yahoo Maps",c="demobrowser.demo.showcase.Maps",b="main",a='zIndex';
...
var i=this._createYahooMap();
var j=this._createGoogleMap();
this.getRoot().add(this._createWindow(d,i),{left:10,top:10});
this.getRoot().add(this._createWindow(g,j),{left:100,top:100});
},_createWindow:function(k,l){var m=new qx.ui.window.Window(k);
...
m.setContentPadding(0);
m.add(l);
m.open();
return m;
},_createYahooMap:function(){var n=new qx.ui.core.Widget().set({width:450,height:400});
n.addListenerOnce(h,function(){var o=new YMap(n.getContentElement().getDomElement());
o.addTypeControl();
o.setMapType(YAHOO_MAP_REG);
o.drawZoomAndCenter(e,5);
});
return n;
},_createGoogleMap:function(){var p=new qx.ui.core.Widget().set({width:450,height:400});
p.setDecorator(b);
p.addListenerOnce(h,function(){var q=new google.maps.Map(p.getContentElement().getDomElement(),{zoom:13,mapTypeId:google.maps.MapTypeId.ROADMAP});
google.maps.event.addListenerOnce(q,f,function(){window.setTimeout(function(){var r=p.getContentElement().getStyle(a);
p.getContentElement().getDomElement().style.zIndex=r;
},500);
});
q.setCenter(new google.maps.LatLng(49.011899,8.403311));
});
return p;
}}});
})();
