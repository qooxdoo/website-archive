...
(function(){var g=" / ",f="horizontal",e="__Pr",d="demobrowser.demo.virtual.Table",c="white",b="#EEE",a="vertical";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Pr:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__Pr=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__Pr.getCellProperties(j+g+k);
