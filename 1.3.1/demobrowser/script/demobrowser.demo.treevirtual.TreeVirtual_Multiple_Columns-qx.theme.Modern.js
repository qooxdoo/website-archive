...
var Y=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
this.getRoot().add(Y,{edge:30});
var S=new qx.ui.treevirtual.TreeVirtual([m,g,I]);
S.set({width:400});
S.setAlwaysShowOpenCloseSymbol(true);
var R=S.getTableColumnModel().getBehavior();
R.set(0,{width:L,minWidth:180});
Y.add(S);
var X=S.getDataModel();
var U=X.addBranch(null,b,true);
S.nodeSetLabelStyle(U,u+O+N);
var Q;
X.addBranch(U,F,true);
Q=X.addBranch(U,r,true);
var W=X.addLeaf(Q,d);
X.setColumnData(W,1,h);
X.setColumnData(W,2,k);
W=X.addLeaf(Q,f);
X.setColumnData(W,1,h);
X.setColumnData(W,2,k);
X.addBranch(U,K,true);
W=X.addBranch(U,j,true);
S.nodeSetCellStyle(W,v);
var V=X.addBranch(null,c,true);
W=X.addBranch(V,n,false);

for(var i=1;i<3000;i++){X.addLeaf(W,C+i);
}X.addBranch(V,G,false);
X.addBranch(V,j,false);
X.addBranch(V,w,false);
X.addBranch(V,E,false);
X.setData();
var T=new qx.ui.groupbox.GroupBox(J);
T.setLayout(new qx.ui.layout.Canvas());
Y.add(T);
var o=new qx.ui.basic.Atom(y);
T.add(o,{left:0,top:6});
o=new qx.ui.form.TextField();
o.set({readOnly:true});
T.add(o,{left:4,right:0,top:20});
S.addListener(H,function(e){var ba=e.getData();
this.setValue(S.getHierarchy(ba[0].nodeId).join(B));
P.setEnabled(true);
},o);
var P=new qx.ui.form.Button(p);
P.set({enabled:false});
T.add(P,{top:50,left:0});
P.addListener(a,function(e){var bb=S.getSelectedNodes();

for(var i=0;i<bb.length;i++){X.prune(bb[i].nodeId,true);
X.setData();
}});
o=new qx.ui.form.CheckBox(x);
o.set({value:true});
T.add(o,{top:80,left:0});
o.addListener(l,function(e){S.setUseTreeLines(e.getData());
});
o=new qx.ui.form.CheckBox(D);
o.set({value:false});
T.add(o,{top:100,left:0});
o.addListener(l,function(e){S.setExcludeFirstLevelTreeLines(e.getData());
});
o=new qx.ui.form.CheckBox(z);
o.set({value:true});
T.add(o,{top:120,left:0});
o.addListener(l,function(e){S.setAlwaysShowOpenCloseSymbol(e.getData());
});
o=new qx.ui.form.CheckBox(A);
o.set({value:true});
T.add(o,{top:140,left:0});
S.addListener(q,function(e){if(this.getValue()){var bc=e.getData();
S.nodeSetHideOpenClose(bc,true);
}},o);
o=new qx.ui.form.CheckBox(s);
o.set({value:false});
T.add(o,{top:160,left:0});
o.addListener(l,function(e){S.setOpenCloseClickSelectsRow(e.getData());
});
o=new qx.ui.form.CheckBox(M);
o.set({value:false});
T.add(o,{top:180,left:0});
o.addListener(l,function(e){S.setEnabled(!e.getData());
});
}}});
})();
...
this.__Fj=null;
},members:{__Fk:null,__Fj:null,_rowArr:null,_nodeArr:null,_nodeRowMap:null,_treeColumn:null,_selections:null,setTree:function(m){this.__Fk=m;
},getTree:function(){return this.__Fk;
},setEditable:function(n){this.__Fj=[];

for(var o=0;o<this.getColumnCount();o++){this.__Fj[o]=n;
}this.fireEvent(g);
},setColumnEditable:function(p,q){if(q!=this.isColumnEditable(p)){if(this.__Fj==null){this.__Fj=[];
}this.__Fj[p]=q;
this.fireEvent(g);
}},isColumnEditable:function(r){if(r==this._treeColumn){return false;
}return (this.__Fj?this.__Fj[r]==true:false);
...
}},destruct:function(){this._rowArr=this._nodeArr=this._nodeRowMap=this._selections=this.__Fk=null;
...
this.__Fn=qx.util.AliasManager.getInstance();
this.__Fo=qx.util.ResourceManager.getInstance();
this.__Fp=qx.theme.manager.Appearance.getInstance();
this.BLANK=this.__Fo.toUri(this.__Fn.resolve("static/blank.gif"));
},statics:{__Fq:{},__Fm:true,__Fr:function(){qx.theme.manager.Meta.getInstance().initialize();
...
bd.__Fq.line=bf.styleFrom(M);
bi(bd.__Fq.line.icon);
bd.__Fq.contract=bf.styleFrom(L);
bi(bd.__Fq.contract.icon);
bd.__Fq.expand=bf.styleFrom(I);
bi(bd.__Fq.expand.icon);
bd.__Fq.onlyContract=bf.styleFrom(H);
bi(bd.__Fq.onlyContract.icon);
bd.__Fq.onlyExpand=bf.styleFrom(T);
bi(bd.__Fq.onlyExpand.icon);
bd.__Fq.startContract=bf.styleFrom(Y);
bi(bd.__Fq.startContract.icon);
bd.__Fq.startExpand=bf.styleFrom(O);
bi(bd.__Fq.startExpand.icon);
bd.__Fq.endContract=bf.styleFrom(y);
bi(bd.__Fq.endContract.icon);
bd.__Fq.endExpand=bf.styleFrom(J);
bi(bd.__Fq.endExpand.icon);
bd.__Fq.crossContract=bf.styleFrom(C);
bi(bd.__Fq.crossContract.icon);
bd.__Fq.crossExpand=bf.styleFrom(K);
bi(bd.__Fq.crossExpand.icon);
bd.__Fq.end=bf.styleFrom(q);
bi(bd.__Fq.end.icon);
bd.__Fq.cross=bf.styleFrom(m);
bi(bd.__Fq.cross.icon);
}},properties:{useTreeLines:{check:j,init:true},excludeFirstLevelTreeLines:{check:j,init:false},alwaysShowOpenCloseSymbol:{check:j,init:false}},members:{__Fn:null,__Fp:null,__Fo:null,_getCellStyle:function(bj){var bk=bj.value;
...
var bt=this.__Fo.toUri(this.__Fn.resolve(bs.url));
...
if(!bK){if(bI.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF){var o=this.__Fp.styleFrom(W);
}else{var bL={opened:bI.bOpened};
var o=this.__Fp.styleFrom(E,bL);
}bK=o.icon;
...
if(bY==0&&cd){cb=false;
}if(bY<ca.level-1){return (cb&&!ca.lastChild[bY]?ce.__Fq.line:{icon:this.BLANK});
}var cf=ca.lastChild[ca.lastChild.length-1];
if(ca.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH&&!ca.bHideOpenClose){if(ca.children.length>0||cc){if(!cb){return (ca.bOpened?ce.__Fq.contract:ce.__Fq.expand);
}if(bY==0&&ca.bFirstChild){if(cf){return (ca.bOpened?ce.__Fq.onlyContract:ce.__Fq.onlyExpand);
}else{return (ca.bOpened?ce.__Fq.startContract:ce.__Fq.startExpand);
}}if(cf){return (ca.bOpened?ce.__Fq.endContract:ce.__Fq.endExpand);
}return (ca.bOpened?ce.__Fq.crossContract:ce.__Fq.crossExpand);
}}if(cb){if(ca.parentNodeId==0){if(cf&&ca.bFirstChild){return {icon:this.BLANK};
}if(cf){return ce.__Fq.end;
}if(ca.bFirstChild){return (ca.bOpened?ce.__Fq.startContract:ce.__Fq.startExpand);
}}return (cf?ce.__Fq.end:ce.__Fq.cross);
...
this.__Fs=d;
},members:{__Fs:null,getTable:function(){return this.__Fs;
