...
},properties:{defaultLineColor:{init:e,check:c,themeable:true},defaultLineSize:{init:1,check:b,themeable:true}},members:{__IE:null,__IF:null,isHorizontal:function(){return this._isHorizontal;
},setLineColor:function(k,l){{};
this.__IE[k]=l;

if(this.__IG(k)){this.updateLayerData();
}},setLineSize:function(m,n){{};
this.__IF[m]=n;

if(this.__IG(m)){this.updateLayerData();
}},__IG:function(o){if(this._isHorizontal){var s=this.getFirstColumn();
var q=s+this.getColumnSizes().length-1;
return o>=s&&o<=q;
}else{var r=this.getFirstRow();
var p=r+this.getRowSizes().length-1;
return o>=r&&o<=p;
}},getLineSize:function(t){return this.__IF[t]||this.getDefaultLineSize();
},getLineColor:function(u){return this.__IE[u]||this.getDefaultLineColor();
},__IH:function(v,w,z){var top=0;
var A,B;
...
if(this._isHorizontal){this.__IH(M,I,K);
}else{this.__II(M,J,L);
