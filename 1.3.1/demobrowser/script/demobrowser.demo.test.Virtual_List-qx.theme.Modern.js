...
this.__Ol=new qx.ui.virtual.layer.WidgetCell(this);
this.getPane().addLayer(this.__Ol);
this.getPane().addListener(z,this._onResize,this);
this.__Om=[];
this.__On=[];
this.__Oo=new qx.ui.virtual.selection.Row(this.getPane());
this.__Oo.addListener(h,this._onChangeSelection,this);
this.__Oo.attachMouseEvents();
this.__Oo.attachKeyEvents(this);
this.__Oo.attachListEvents(this);
...
this.fireDataEvent(h,this.__Os(e.getData()));
},getCellWidget:function(I,J){var L=this.__Om[I];

if(!L){return null;
}var K=this.__On.pop()||new qx.ui.form.ListItem();
K.set({label:L.getLabel(),icon:L.getIcon()});

if(this.__Oo.isItemSelected(I)){K.addState(n);
}else{K.removeState(n);
}K.setUserData(g,I);
return K;
},poolCellWidget:function(M){this.__On.push(M);
...
},hasChildren:function(){return this.__Om.length>0;
...
qx.ui.core.queue.Widget.add(this);
},add:function(W){this.__Om.push(W);
this._addHelper(W);
return this;
},remove:function(X){qx.lang.Array.remove(this.__Om,X);
this._removeHelper(X);
return this;
},removeAll:function(){for(var i=0,j=this.__Om.length;i<j;i++){this._removeHelper(this.__Om[i]);
}this.__Om=[];
},indexOf:function(Y){return this.__Om.indexOf(Y);
},addAt:function(ba,bb){qx.lang.Array.insertAt(this.__Om,ba,bb);
this._addHelper(ba);
},addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__Om,bc,bd);
this._addHelper(bc);
},addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__Om,be,bf);
this._addHelper(be);
},removeAt:function(bg){this.__Om.splice(bg,1);
this._removeHelper(this.__Om[bg]);
},__Op:function(bh){var bi=this.__Om.indexOf(bh);

if(bi<0){return null;
}else{return bi;
}},__Oq:function(bj){var bk=this.__Om[bj];
return bk;
},__Or:function(bl){var bm=[];

for(var i=0;i<bl.length;i++){bm.push(this.__Op(bl[i]));
}return bm;
},__Os:function(bn){var bo=[];

for(var i=0;i<bn.length;i++){bo.push(this.__Om[bn[i]]);
}return bo;
},selectAll:function(){this.__Oo.selectAll();
},setSelected:function(bp){this.__Oo.selectItem(this.__Op(bp));
},isSelected:function(bq){return this.__Oo.isItemSelected(this.__Op(bq));
},addToSelection:function(br){this.__Oo.addItem(this.__Op(br));
},removeFromSelection:function(bs){this.__Oo.removeItem(this.__Op(bs));
},selectRange:function(bt,bu){this.__Oo.selectItemRange(this.__Op(bt),this.__Op(bu));
},resetSelection:function(){this.__Oo.clearSelection();
},setSelection:function(bv){this.__Oo.replaceSelection(this.__Or(bv));
},getSelectedItem:function(){return this.__Om[this.getSelected()];
},getSelected:function(){return this.__Om[this.__Oo.getSelectedItem()];
},getSelection:function(){return this.__Os(this.__Oo.getSelection());
},getSortedSelection:function(){return this.__Os(this.__Oo.getSortedSelection());
...
},getSelectables:function(){return this.__Os(this.__Oo.getSelectables());
