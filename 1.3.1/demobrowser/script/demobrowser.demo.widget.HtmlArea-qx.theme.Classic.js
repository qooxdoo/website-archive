...
qx.Class.define(bG,{extend:qx.application.Standalone,members:{__Pe:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
ca.setWidthTop(0);
this.__Pe=new qx.ui.embed.HtmlArea(cc,null,F);
this.__Pe.set({width:600,height:400,decorator:ca});
var toolbar=this.__Po();
...
},__Pf:function(e){var ce=window.prompt(bt,bx);
this.setTextColor(ce);
},__Pg:function(e){var cf=window.prompt(bf,bx);
this.setTextBackgroundColor(cf);
},__Ph:function(e){var cg={src:qx.util.ResourceManager.getInstance().toUri(bL),border:0,title:bw,alt:bw};
this.insertImage(cg);
},__Pi:function(e){var ch=R+U+bz+bD+K+bv+bz+b+s+bv+c+M;
this.insertHtml(ch);
},__Pj:function(e){var cj=new qx.ui.window.Window(H);
...
cj.open();
this.saveRange();
},__Pk:function(e){var co=window.prompt(bq,bB);
this.insertHtml(co);
},__Pl:function(){var cq=new qx.ui.form.SelectBox;
...
return cq;
},__Pm:function(){var cu=new qx.ui.form.SelectBox;
...
return cu;
},__Pn:function(){return [{bold:{text:bS,image:p,action:this.__Pe.setBold},italic:{text:ba,image:W,action:this.__Pe.setItalic},underline:{text:x,image:Y,action:this.__Pe.setUnderline},strikethrough:{text:y,image:bV,action:this.__Pe.setStrikeThrough},removeFormat:{text:I,image:bP,action:this.__Pe.removeFormat}},{alignLeft:{text:n,image:t,action:this.__Pe.setJustifyLeft},alignCenter:{text:O,image:bl,action:this.__Pe.setJustifyCenter},alignRight:{text:bb,image:q,action:this.__Pe.setJustifyRight},alignJustify:{text:bk,image:B,action:this.__Pe.setJustifyFull}},{fontFamily:{custom:this.__Pl},fontSize:{custom:this.__Pm},fontColor:{text:d,image:k,action:this.__Pf},textBackgroundColor:{text:bj,image:bn,action:this.__Pg}},{indent:{text:be,image:bu,action:this.__Pe.insertIndent},outdent:{text:z,image:T,action:this.__Pe.insertOutdent}},{insertImage:{text:r,image:G,action:this.__Ph},insertTable:{text:f,image:l,action:this.__Pi},insertLink:{text:a,image:E,action:this.__Pj},insertHTML:{text:D,image:bm,action:this.__Pk},insertHR:{text:bp,image:bo,action:this.__Pe.insertHorizontalRuler}},{ol:{text:u,image:bH,action:this.__Pe.insertOrderedList},ul:{text:bc,image:br,action:this.__Pe.insertUnorderedList}},{undo:{text:bM,image:m,action:this.__Pe.undo},redo:{text:bT,image:P,action:this.__Pe.redo}}];
},__Po:function(){var toolbar=new qx.ui.toolbar.ToolBar;
...
cw.addListener(bA,cA.action,this.__Pe);
}cy.add(cw);
}}return toolbar;
}}});
})();
