...
(function(){var k="div",j="px",i=")",h="50px",g="absolute",f="touchmove",d="height",c="url(",b="green",a="deg) scale(",A="200px",z="30px",y="12px",x="-webkit-transform",w="touchend",v="width",u='Lucida Grande',t="innerHTML",s="qx.mobile.emulatetouch",r="off",p="59px",q="demobrowser/demo/mobile/qooxdoo-logo.png",n="20px",o="rotate(",l="demobrowser.demo.mobile.ScaleImage",m="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(l,{extend:qx.application.Native,members:{__Ql:null,__Qm:1,__Qn:0,__Qo:0,__Qp:0,main:function(){qx.application.Native.prototype.main.call(this);
{};
var D=new qx.html.Element(k);
D.useElement(document.body);
D.setRoot(true);

if(!qx.bom.client.Engine.WEBKIT||(!qx.bom.client.Feature.TOUCH&&qx.core.Variant.isSet(s,r))){var C={"color":b,"position":g,"font-family":u,"font-size":y,"left":z,"top":n};
var F=new qx.html.Element(k,C);
D.add(F);
F.setAttribute(t,m);
return;
}var E=qx.util.ResourceManager.getInstance().toUri(q);
var B={"width":A,"height":p,"position":g,"left":h,"top":h,"background":c+E+i};
this.__Ql=new qx.html.Element(k,B);
this.__Ql.addListener(f,this.__Qq,this);
this.__Ql.addListener(w,this.__Qr,this);
D.add(this.__Ql);
},__Qq:function(e){if(e.isMultiTouch()){this.__Qo=e.getRotation()+this.__Qn;
this.__Qp=e.getScale()*this.__Qm;
this.__Ql.setStyle(x,o+this.__Qo+a+this.__Qp+i);
}else{var G=parseInt(e.getDocumentLeft())-(parseInt(this.__Ql.getStyle(v))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__Ql.getStyle(d))/2);
this.__Ql.setStyles({"left":G+j,"top":top+j});
}},__Qr:function(e){if(e.isMultiTouch()){this.__Qn=this.__Qo;
this.__Qm=this.__Qp;
}}}});
})();
