...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.showcase.Form","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.showcase.Form-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"95386701fb8a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="placeholder",j="Button",h="CheckBox:",g="TextArea:",f="Boolean",e="RepeatButton:",d="execute",c="Website 2",b="Text",a="ToggleButton",S="password",R="RadioButton 3",Q="Button:",P="ComboBox:",O="ToggleButton:",N="Options",M="RadioButton",L="0",K="MenuButton:",J="demobrowser.demo.showcase.Form",r="PasswordField:",s="SplitButton",p="Buttons",q="",n="RadioButtons:",o="dd.mm.YYYY",l="List:",m="SplitButton:",t="Option",u="RadioButton 1",B="Spinner:",z="Selection",D="DateField:",C="RadioButton 2",F="Number",E="CheckBox",w="SelectBox:",I="Website 3",H="MenuButton",G="Website 1",v="Slider:",x="TextField:",y="Item ",A="RadioButtonGroup:";
qx.Class.define(J,{extend:qx.application.Standalone,statics:{ITEM_SIZE:5},members:{main:function(){qx.application.Standalone.prototype.main.call(this);
var T=new qx.ui.groupbox.GroupBox(b);
T.setLayout(new qx.ui.layout.Grid(8,8));
T.setWidth(290);
this.getRoot().add(T,{left:20,top:10});
var bq=new qx.ui.form.TextField();
bq.setPlaceholder(k);
var bc=new qx.ui.basic.Label(x);
bc.setBuddy(bq);
T.add(bc,{row:0,column:0});
T.add(bq,{row:0,column:1});
var ba=new qx.ui.form.PasswordField();
ba.setPlaceholder(S);
bc=new qx.ui.basic.Label(r);
bc.setBuddy(ba);
T.add(bc,{row:1,column:0});
T.add(ba,{row:1,column:1});
var U=new qx.ui.form.TextArea();
U.setPlaceholder(k);
bc=new qx.ui.basic.Label(g);
bc.setBuddy(U);
T.add(bc,{row:2,column:0});
T.add(U,{row:2,column:1});
var V=new qx.ui.form.ComboBox();
V.setPlaceholder(k);
bc=new qx.ui.basic.Label(P);
bc.setBuddy(V);
T.add(bc,{row:3,column:0});
T.add(V,{row:3,column:1});
this.createItems(V);
var bj=new qx.ui.form.DateField();
bj.setPlaceholder(o);
bc=new qx.ui.basic.Label(D);
bc.setBuddy(bj);
T.add(bc,{row:4,column:0});
T.add(bj,{row:4,column:1});
var bb=new qx.ui.groupbox.GroupBox(z);
bb.setLayout(new qx.ui.layout.Grid(8,8));
bb.setWidth(290);
this.getRoot().add(bb,{left:20,top:250});
var bk=new qx.ui.form.SelectBox();
bc=new qx.ui.basic.Label(w);
bc.setBuddy(bk);
bb.add(bc,{row:0,column:0});
bb.add(bk,{row:0,column:1});
this.createItems(bk);
var bp=new qx.ui.form.List();
bp.setHeight(60);
bp.setWidth(155);
bc=new qx.ui.basic.Label(l);
bc.setBuddy(bp);
bb.add(bc,{row:1,column:0});
bb.add(bp,{row:1,column:1});
this.createItems(bp);
var bi=new qx.ui.form.RadioButtonGroup();
bi.add(new qx.ui.form.RadioButton(u));
bi.add(new qx.ui.form.RadioButton(C));
bi.add(new qx.ui.form.RadioButton(R));
bc=new qx.ui.basic.Label(A);
bc.setBuddy(bi);
bb.add(bc,{row:2,column:0});
bb.add(bi,{row:2,column:1});
var bn=new qx.ui.groupbox.GroupBox(p);
bn.setLayout(new qx.ui.layout.Grid(8,8));
bn.setWidth(210);
this.getRoot().add(bn,{left:330,top:10});
var bo=new qx.ui.form.Button(j);
bc=new qx.ui.basic.Label(Q);
bc.setBuddy(bo);
bn.add(bc,{row:0,column:0});
bn.add(bo,{row:0,column:1});
var X=new qx.ui.form.ToggleButton(a);
bc=new qx.ui.basic.Label(O);
bc.setBuddy(X);
bn.add(bc,{row:1,column:0});
bn.add(X,{row:1,column:1});
var bf=new qx.ui.form.RepeatButton(L);
bc=new qx.ui.basic.Label(e);
bc.setBuddy(bf);
bn.add(bc,{row:2,column:0});
bn.add(bf,{row:2,column:1});
var bg=new qx.ui.form.MenuButton(H,null,this.createMenuForMenuButton());
bc=new qx.ui.basic.Label(K);
bc.setBuddy(bg);
bn.add(bc,{row:3,column:0});
bn.add(bg,{row:3,column:1});
var Y=new qx.ui.form.SplitButton(s,null,this.createMenuForSplitButton());
bc=new qx.ui.basic.Label(m);
bc.setBuddy(Y);
bn.add(bc,{row:4,column:0});
bn.add(Y,{row:4,column:1});
bf.addListener(d,function(){var br=parseInt(bf.getLabel())+1;
bf.setLabel(br.toString());
});
var W=new qx.ui.groupbox.GroupBox(f);
W.setLayout(new qx.ui.layout.Grid(8,8));
W.setWidth(210);
this.getRoot().add(W,{left:330,top:210});
var bl=new qx.ui.form.CheckBox(E);
bc=new qx.ui.basic.Label(h);
bc.setBuddy(bl);
W.add(bc,{row:0,column:0});
W.add(bl,{row:0,column:1});
var be=new qx.ui.form.RadioButton(M);
W.add(new qx.ui.basic.Label(n),{row:1,column:0});
W.add(be,{row:1,column:1});
var bm=new qx.ui.groupbox.GroupBox(F);
bm.setLayout(new qx.ui.layout.Grid(8,8));
bm.setWidth(210);
this.getRoot().add(bm,{left:330,top:310});
var bd=new qx.ui.form.Spinner(0,50,100);
bc=new qx.ui.basic.Label(B);
bc.setBuddy(bd);
bm.add(bc,{row:0,column:0});
bm.add(bd,{row:0,column:1});
var bh=new qx.ui.form.Slider();
bh.setWidth(130);
bc=new qx.ui.basic.Label(v);
bc.setBuddy(bh);
bm.add(bc,{row:1,column:0});
bm.add(bh,{row:1,column:1});
},createItems:function(bs){for(var i=0;i<this.self(arguments).ITEM_SIZE;i++){var bt=new qx.ui.form.ListItem(y+i);
bs.add(bt);
}},createMenuForMenuButton:function(){var bu=new qx.ui.menu.Menu;

for(var i=0;i<3;i++){bu.add(new qx.ui.menu.RadioButton(t+i));
}var bx=new qx.ui.form.RadioGroup;
bx.add.apply(bx,bu.getChildren());
var bw=new qx.ui.menu.Menu();

for(var i=0;i<3;i++){var by=new qx.ui.menu.Button(j+i);
bw.add(by);
}var bv=new qx.ui.menu.Button(N,q,null,bu);
bw.addSeparator();
bw.add(bv);
return bw;
},createMenuForSplitButton:function(){var bz=new qx.ui.menu.Menu;
var bC=new qx.ui.menu.Button(G);
var bA=new qx.ui.menu.Button(c);
var bB=new qx.ui.menu.Button(I);
bz.add(bC);
bz.add(bA);
bz.add(bB);
return bz;
