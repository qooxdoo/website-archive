...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Touch","qx.theme":"qx.theme.Modern"};
...
qx.Class.define(t,{extend:qx.application.Native,members:{__Ot:null,__Ou:null,main:function(){qx.application.Native.prototype.main.call(this);
{};
...
K.setAttribute(j,n);
return;
}J.add(this.__Ov(10,10,c,u));
J.add(this.__Ov(110,10,D,H));
this.__Ot=this.__Ow(10,110);
J.add(this.__Ot);
this.__Ou=this.__Ow(110,110);
J.add(this.__Ou);
J.add(this.__Ox(210,10));
},__Ov:function(x,y,L,M){var N={"position":h,"left":x+l,"top":y+l,"width":d,"height":d,"backgroundColor":L,"fontFamily":f,"fontSize":g};
var O=new qx.html.Element(k,N,{"id":M});
O.setAttribute(j,v+M+A);
O.addListener(w,this.__Oy,this);
O.addListener(a,this.__Oy,this);
O.addListener(F,this.__Oy,this);
O.addListener(m,this.__Oy,this);
return O;
},__Ow:function(x,y){var P={"position":h,"left":x+l,"top":y+l,"width":d,"fontFamily":f,"fontSize":q};
return new qx.html.Element(k,P);
},__Ox:function(x,y){var Q={"position":h,"left":x+l,"top":y+l,"width":b,"height":b,"backgroundColor":p,"fontFamily":f,"fontSize":g};
