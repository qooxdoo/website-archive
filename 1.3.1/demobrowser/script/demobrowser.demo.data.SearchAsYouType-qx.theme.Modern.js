...
this.__Qz=null;
},properties:{searchString:{check:b,apply:d,init:a}},members:{__Qz:null,__Qy:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__Qz!=null){i.stop(this.__Qz);
this.__Qz=null;
}this.__Qz=i.start(function(){this.__Qy.update();
this.__Qz=null;
},0,this,null,200);
},filter:null},destruct:function(){this.__Qy=null;
}});
})();
