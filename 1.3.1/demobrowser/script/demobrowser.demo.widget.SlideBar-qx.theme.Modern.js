...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.SlideBar","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.SlideBar-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d221eef70a80"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var u=new qx.ui.container.SlideBar();
u.set({width:300});
u.setLayout(new qx.ui.layout.HBox(3));
var v=[p,f,o,b,c,q,s,k,r,g,h,a];

for(var i=0;i<v.length;i++){u.add((new qx.ui.basic.Image(l+v[i])).set({decorator:n,padding:4}));
}var t=new qx.ui.form.ToggleButton(m);
t.addListener(j,function(e){u.setWidth(e.getData()?800:300);
});
this.getRoot().add(t,{left:20,top:100});
this.getRoot().add(u,{left:20,top:20});
}}});
})();
