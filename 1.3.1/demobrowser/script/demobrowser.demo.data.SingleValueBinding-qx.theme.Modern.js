...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.data.SingleValueBinding","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.data.SingleValueBinding-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f5a4bb009d7f"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="qx.data.Array",r="demobrowser.demo.data.model.Node",q="String",p="changeNames",o="changeName",n="Validation Error: ",m="- ",l="",k="changeChild",j="changeColor",c="Marge",h="AFFE",f="is no number (parseFloat says so!).",b="Homer",a="\n",e="__Qx",d="changeName2",g="changeChildren";
qx.Class.define(r,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:s,event:g},child:{check:r,event:k,nullable:true},names:{check:s,event:p,init:new qx.data.Array(b,c)},name:{check:q,init:h,event:o},name2:{check:q,event:d},number:{init:10,validate:e},color:{event:j,nullable:true}},members:{__Qx:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
...
for(var i=0;i<this.getChildren().length;i++){v+=a+this.getChildren().getItem(i).toString(u+1);
}return v;
}}});
})();
