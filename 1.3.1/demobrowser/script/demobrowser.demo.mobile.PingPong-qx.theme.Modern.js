...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.mobile.PingPong","qx.theme":"qx.theme.Modern"};
...
(function(){var k="div",j="100%",i="left",h="innerHTML",g="20px",f="absolute",d="px",c="touchmove",b="black",a="30px",K="200px",J="100px",I="1px solid white",H="top",G="50%",F="none",E="white",D="#333",C="border-left",B="green",r="demobrowser.demo.mobile.PingPong",s="0",p="12px",q="interval",n="0px",o="15em",l="center",m='Lucida Grande',t="qx.mobile.emulatetouch",u="off",w="right",v="Arial",A="border-right",z="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(r,{extend:qx.application.Native,members:{__PS:null,__PT:null,__PU:null,__PV:null,__PW:5,__PX:1,__PY:1,__Qa:null,__Qb:null,__Qc:null,main:function(){qx.application.Native.prototype.main.call(this);
{};
var N={"width":j,"height":j,"backgroundColor":b,"margin":n,"userSelect":F};
var Q=new qx.html.Element(k,N);
Q.useElement(document.body);
Q.setRoot(true);

if(!qx.bom.client.Engine.WEBKIT||(!qx.bom.client.Feature.TOUCH&&qx.core.Variant.isSet(t,u))){var P={"color":B,"font-family":m,"font-size":p,"position":f,"left":a,"top":g};
var O=new qx.html.Element(k,P);
Q.add(O);
O.setAttribute(h,z);
return;
}var L=this.__Qh(i);
...
var M=this.__Qh(w);
Q.add(M);
this.__PT=this.__Qi("left");
L.add(this.__PT);
L.addListener(c,qx.lang.Function.bind(this.__Qg,this,this.__PT),this);
this.__PS=this.__Qi("right");
M.add(this.__PS);
M.addListener(c,qx.lang.Function.bind(this.__Qg,this,this.__PS),this);
this.__PU=this.__Qj();
Q.add(this.__PU);
this.__Qb=this.__Qk();
L.add(this.__Qb);
...
this.__Qa=[0,0];
this.__Qd();
},__Qd:function(){this.__PU.setStyles({"left":K,"top":K});
this.__PV=new qx.event.Timer(40);
this.__PV.addListener(q,function(){var x=(parseInt(this.__PU.getStyle(i))+this.__PW*this.__PX);
var y=(parseInt(this.__PU.getStyle(H))+this.__PW*this.__PY);
this.__PU.setStyle(i,x+d);
this.__PU.setStyle(H,y+d);
this.__Qf();
},this);
this.__PV.start();
},__Qe:function(R){this.__PV.stop();
this.__PV.dispose();
this.__PW=5;
this.__Qa[R]=this.__Qa[R]+1;
this.__Qb.setAttribute(h,this.__Qa[0]);
this.__Qc.setAttribute(h,this.__Qa[1]);
this.__Qd();
},__Qf:function(){var T=this.getBoundsFor(this.__PU);
if(T.top<=0){this.__PY=1;
}if(T.bottom>=window.innerHeight-5){this.__PY=-1;
}if(T.left<=0||T.right>=window.innerWidth){this.__Qe(T.left<=0?1:0);
}var U=this.getBoundsFor(this.__PT);

if(T.left<=U.right&&T.bottom>=U.top&&T.top<=U.bottom){this.__PX=1;
this.__PW=Math.min(this.__PW+1,20);
}var S=this.getBoundsFor(this.__PS);

if(T.right>=S.left&&T.bottom>=S.top&&T.top<=S.bottom){this.__PX=-1;
this.__PW=Math.min(this.__PW+1,20);
}},__Qg:function(V,e){V.setStyles({"top":(e.getDocumentTop()-50)+d});
},getBoundsFor:function(W){return qx.bom.element.Location.get(W.getDomElement());
},__Qh:function(X){var Y={"width":G,"height":j,"position":f,"backgroundColor":b};

if(X==i){Y[A]=I;
}else{Y[i]=G;
Y[C]=I;
}return new qx.html.Element(k,Y);
},__Qi:function(ba){var bb={"width":a,"height":J,"top":J,"position":f,"backgroundColor":E};
bb[ba]=g;
return new qx.html.Element(k,bb);
},__Qj:function(){var bc={"width":g,"height":g,"position":f,"backgroundColor":E,"userSelect":F};
return new qx.html.Element(k,bc);
},__Qk:function(){var bd={"width":j,"height":j,"textAlign":l,"fontSize":o,"color":D,"fontFamily":v};
var be=new qx.html.Element(k,bd);
be.setAttribute(h,s);
return be;
}}});
})();
