...
(function(){var k="execute",j="Flash Player Version",i="right",h="__OS",g="__OQ",f="Message from Flash:",d="__OT",c="__OR",b="Simple demo with FlashVars",a="bgcolor",y="demobrowser.demo.widget.Flash",x="demobrowser/demo/flash/FlashVersion.swf",w="Flash:",v="<b>qooxdoo:</b>",u="demobrowser.demo.widget.Flash.sendMessage",t="demobrowser.demo.widget.Flash.flashReady",s="__OP",r="demobrowser/demo/flash/fo_tester.swf",q="this is passed in via FlashVars",p="Two way communication (ActionScript <-> JavaScript)",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__OP:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var z=new qx.ui.tabview.TabView();
z.setContentPadding([8,8,8,8]);
var C=this.getRoot();
C.add(z,{edge:0});
var A=new qx.ui.tabview.Page(b);
...
z.add(B);
this.__OP=this.createWindow();
C.add(this.__OP,{top:20,left:20});
...
D.add(new qx.ui.embed.Flash(x),{edge:0});
return D;
...
F.getContentElement().setParam(a,m);
G.add(F,{flex:1});
var H=new qx.ui.form.Button(o);
H.addListener(k,function(){this.__OP.open();
},this);
G.add(H);
return G;
},__OQ:null,__OR:null,__OS:null,__OT:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
...
J.add(new qx.ui.basic.Label(f));
this.__OR=new qx.ui.form.TextArea("No message.");
this.__OR.setEnabled(false);
J.add(this.__OR,{flex:1});
J.add(new qx.ui.basic.Label(n));
this.__OS=new qx.ui.form.TextArea("qooxdoo is the best!");
J.add(this.__OS,{flex:1});
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,i));
this.__OT=new qx.ui.form.Button("Send to Flash");
this.__OT.setEnabled(false);
this.__OT.addListener(k,function(e){this.__OQ.getFlashElement().sendMessage(this.__OS.getValue());
},this);
L.add(this.__OT);
J.add(L);
var I=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
K.add(I,{flex:1});
I.add(new qx.ui.basic.Label(w).set({rich:true}));
this.__OQ=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__OQ.setVariables({init:t});
I.add(this.__OQ,{flex:1});
return K;
},sendMessage:function(M){this.__OR.setValue(M);
},initFlash:function(){if(this.__OQ.getFlashElement().setup){this.__OQ.getFlashElement().setup(u);
this.__OT.setEnabled(true);
...
}}},statics:{__OU:null,setCallBackInstance:function(N){demobrowser.demo.widget.Flash.__OU=N;
},sendMessage:function(O){demobrowser.demo.widget.Flash.__OU.sendMessage(O);
},flashReady:function(){demobrowser.demo.widget.Flash.__OU.initFlash();
}},destruct:function(){this._disposeObjects(c,h,d,g,s);
}});
})();
