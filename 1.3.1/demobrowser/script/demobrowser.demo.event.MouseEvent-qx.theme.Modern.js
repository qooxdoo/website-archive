...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.MouseEvent","qx.theme":"qx.theme.Modern"};
for (var k in settings) qxsettings[k] = settings[k];

if (!window.qxvariants) qxvariants = {};
var variants = {"qx.aspects":"off","qx.debug":"off","qx.event":"on"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.MouseEvent-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"88b6ce3c9554"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
}},_initLogger:function(k,l,m){this.__OG="<table><tr><th>"+k.join("</th><th>")+"</th></tr>";
this.__OH=m||50;
this.__OI=l;
this._clearLog();
},_clearLog:function(){this.__OI.innerHTML=this.__OG+h;
this.__OJ=[];
},_log:function(n){this.__OJ.unshift(n);
this.__OJ=this.__OJ.slice(0,this.__OH);
var o=[this.__OG];

for(var i=0;i<this.__OJ.length;i++){o.push(d,this.__OJ[i].join(f),a);
}o.push(h);
this.__OI.innerHTML=o.join(e);
this.__OI.scrollTop=0;
},__OG:null,__OH:null,__OI:null,__OJ:null},destruct:function(){this.__OI=this.__OJ=null;
}});
})();
(function(){var l="change",k="mousedown",j="mouseout",h="demobrowser.demo.event.MouseEvent",g="clientX",f="dblclick",d="relatedTarget",c="mouse",b="button",a="capture",B="mousemove",A="pageY",z="screenX",y="logger",x="",w="mouseover",v="check_",u="click",t="Event",s="Target",q="clientY",r="mouseup",o="losecapture",p="contextmenu",m="screenY",n="pageX";
qx.Class.define(h,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this._initLogger([s,t,b,n,A,g,q,z,m,d],document.getElementById(y),50);
var C=document.getElementById(c);
var E=[k,r,u,f,p,B,w,j];

for(var i=0;i<E.length;i++){var F=document.getElementById(v+E[i]);

if(F.checked){qx.bom.Element.addListener(C,E[i],this.logMouseEvent,this);
}qx.bom.Element.addListener(F,l,this.__OM,this);
}var D=document.getElementById(a);
D.checked=false;
qx.bom.Element.addListener(D,l,function(e){var G=e.getTarget().checked;

if(G){qx.bom.Element.capture(C);
}else{qx.bom.Element.releaseCapture(C);
}},this);
qx.bom.Element.addListener(C,o,function(e){D.checked=false;
},this);
},__OM:function(e){var J=e.getTarget().id.split("_")[1];
var H=e.getTarget().checked;
var I=document.getElementById("mouse");

if(H){qx.bom.Element.addListener(I,J,this.logMouseEvent,this);
}else{qx.bom.Element.removeListener(I,J,this.logMouseEvent,this);
}},logMouseEvent:function(K){K.preventDefault();
this._log([K.getTarget().id,K.getType(),K.getButton(),K.getDocumentLeft(),K.getDocumentTop(),K.getScreenLeft(),K.getScreenTop(),K.getViewportLeft(),K.getViewportTop(),K.getRelatedTarget()?K.getRelatedTarget().id:x]);
}}});
})();
