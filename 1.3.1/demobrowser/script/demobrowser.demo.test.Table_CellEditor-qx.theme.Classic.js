...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Table_CellEditor","qx.theme":"qx.theme.Classic"};
...
},properties:{cellEditorFactoryFunction:{check:b,nullable:true,init:null}},members:{__Mn:null,__Mm:null,createCellEditor:function(d){var e=this.getCellEditorFactoryFunction();
{};
this.__Mn=e(d);
var f=this.__Mn.createCellEditor(d);
this.__Mm[f.toHashCode()]=d;
return f;
},getCellEditorValue:function(g){var i=this.getCellEditorFactoryFunction();
{};
var h=this.__Mm[g.toHashCode()];
this.__Mn=i(h);
var j=this.__Mn.getCellEditorValue(g);
return j;
