...
}},properties:{appearance:{refine:true,init:d}},events:{complete:b,change:a},members:{__Jy:0,__Jz:100,getValue:function(){return this.__Jy;
...
this.__JA(i/j);
return i;
},getMaximum:function(){return this.__Jz;
...
},__JA:function(q){var s=this.getChildControl("progress");
