...
(function(){var k="_applyLayoutChange",j="top",h="left",g="Integer",f="middle",e="bottom",d="qx.ui.layout.Flow",c="center",b="right",a="Boolean";
qx.Class.define(d,{extend:qx.ui.layout.Abstract,construct:function(l,m,n){qx.ui.layout.Abstract.call(this);
...
}},properties:{alignX:{check:[h,c,b],init:h,apply:k},alignY:{check:[j,f,e],init:j,apply:k},spacingX:{check:g,init:0,apply:k},spacingY:{check:g,init:0,apply:k},reversed:{check:a,init:false,apply:k}},members:{verifyLayoutProperty:null,connectToWidget:function(o){qx.ui.layout.Abstract.prototype.connectToWidget.call(this,o);
...
}},__JQ:function(v,w,x){var z=qx.ui.layout.Util;
var C=0;

if(this.getAlignX()!="left"){C=x-v.width;

if(this.getAlignX()=="center"){C=Math.round(C/2);
}}
...
}},_computeSizeHint:function(){return this.__JR(Infinity);
},hasHeightForWidth:function(){return true;
},getHeightForWidth:function(E){return this.__JR(E).height;
},__JR:function(F){var G=new qx.ui.layout.LineSizeIterator(this._getLayoutChildren(),this.getSpacingX());
var K=0;
var H=0;
var I=0;
...
qx.Class.define(a,{extend:Object,construct:function(b,c){this.__HR=b;
this.__HS=c;
this.__HT=b.length>0;
this.__HU=0;
},members:{__HR:null,__HS:null,__HT:null,__HU:null,computeNextLine:function(d){var d=d||Infinity;

if(!this.__HT){throw new Error("No more lines to compute");
}var o=this.__HR;
var m=0;
var f=0;
var n=[];
...
for(var i=this.__HU;i<o.length;i++){var l=o[i];
var p=l.getSizeHint();
var h=this.__HV(i);
var g=p.width+h;
var e=i==this.__HU;

if(!e&&f+g>d){this.__HU=i;
break;
...
if(l.getLayoutProperties().lineBreak){this.__HU=i+1;
break;
}}
if(i>=o.length){this.__HT=false;
}return {height:m,width:f,children:n,gapsBefore:j};
},__HV:function(q){var r=q==this.__HU;

if(r){return this.__HR[q].getMarginLeft();
}else{return Math.max(this.__HR[q-1].getMarginRight(),this.__HR[q].getMarginLeft(),this.__HS);
}},hasMoreLines:function(){return this.__HT;
}}});
})();
