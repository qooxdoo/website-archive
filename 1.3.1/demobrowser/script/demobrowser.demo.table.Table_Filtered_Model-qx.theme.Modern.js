...
qx.Class.define(c,{extend:qx.application.Standalone,include:demobrowser.demo.table.MUtil,members:{__PO:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},members:{__HE:null,__HD:null,_js_in_array:function(q,r){var s=r.toString();
...
if(!this.__HD){this.__HE=Y.slice(0);
this.__HD=true;
}
if(W==null||W<1){W=1;
}
...
}},resetHiddenRows:function(){if(!this.__HE){return ;
}this.Filters=[];
this.setData(qx.lang.Array.clone(this.__HE));
},setData:function(bb,bc){this.__HE=qx.lang.Array.clone(bb);
this.Filters=[];
qx.ui.table.model.Simple.prototype.setData.call(this,bb,bc);
}},destruct:function(){this.__HE=this.numericAllowed=this.betweenAllowed=this.Filters=null;
}});
})();
