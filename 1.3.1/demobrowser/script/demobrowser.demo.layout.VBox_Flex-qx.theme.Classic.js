...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox_Flex-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"f9352b553af3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var e=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(e);
e.add(this.getBox1());
e.add(this.getBox2());
e.add(this.getBox3());
...
return g;
},getBox3:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,allowGrowY:false});

for(var i=0;i<25;i++){h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,height:5}),{flex:1});
}return h;
},getBox4:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:d,backgroundColor:b,height:300,minHeight:300,allowGrowY:false});
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:60}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:60}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,maxHeight:60}),{flex:3});
return j;
...
return k;
},getBox6:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({height:150,decorator:d,backgroundColor:b,allowGrowY:false});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:1});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:2});
l.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c,minHeight:60}),{flex:3});
return l;
}}});
})();
...
}},properties:{sort:{check:[f,a,b],init:f,apply:d},separatorX:{check:k,nullable:true,apply:l},separatorY:{check:k,nullable:true,apply:l},connectSeparators:{check:c,init:false,apply:l},spacingX:{check:j,init:0,apply:l},spacingY:{check:j,init:0,apply:l}},members:{__CH:null,__CI:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__CJ:{north:1,south:2,west:3,east:4,center:5},__CK:{1:"top",2:"bottom",3:"left",4:"right"},__CL:function(){var q=this._getLayoutChildren();
var y,s;
var length=q.length;
var u=[];
var x=[];
...
},renderLayout:function(A,B){if(this._invalidChildrenCache){this.__CL();
...
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__CL();
}var bA=this.__CH;
var bK=this.__CI;
...
}},destruct:function(){this.__CI=this.__CH=null;
}});
})();
