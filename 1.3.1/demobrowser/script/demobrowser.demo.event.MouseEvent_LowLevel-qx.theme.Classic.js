...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.event.MouseEvent_LowLevel","qx.theme":"qx.theme.Classic"};
...
qx.Class.define(l,{extend:demobrowser.demo.event.EventDemo,members:{__OK:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__OK=qx.lang.Function.bind(this.logMouseEvent,this);
...
if(A.checked){qx.bom.Event.addNativeListener(y,z[i],this.__OK);
}qx.bom.Event.addNativeListener(A,m,qx.lang.Function.bind(this.__OL,this));
}},__OL:function(e){var E=qx.bom.Event.getTarget(e);
var D=E.id.split("_")[1];
var B=E.checked;
var C=document.getElementById("mouse");

if(B){qx.bom.Event.addNativeListener(C,D,this.__OK);
}else{qx.bom.Event.removeNativeListener(C,D,this.__OK);
