...
(function(){var p="top",o="right",n="resize",m="Name",l="Password",k="Login",j="__Oc",h="__Oe",g="appear",f="__Od",b="demobrowser.demo.animation.Login",d="50%",c="execute",a="30%";
qx.Class.define(b,{extend:qx.application.Standalone,members:{__Oc:null,__Od:null,__Oe:null,checkInput:function(){this.__Oc.start();
},__Of:function(){this.__Oc=new qx.fx.effect.combination.Shake(this.__Od.getContainerElement().getDomElement());
...
this.__Od=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__Od.setLayout(r);
this.__Od.addListener(n,function(e){var v=this.__Od.getBounds();
this.__Od.set({marginTop:Math.round(-v.height/2),marginLeft:Math.round(-v.width/2)});
},this);
this.getRoot().add(this.__Od,{left:d,top:a});
var q=[m,l];

for(var i=0;i<q.length;i++){this.__Od.add(new qx.ui.basic.Label(q[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var s=new qx.ui.form.TextField();
var t=new qx.ui.form.PasswordField();
this.__Od.add(s.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__Od.add(t.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var u=this.__Oe=new qx.ui.form.Button(k);
u.setAllowStretchX(false);
this.__Od.add(u,{row:3,column:1});
u.addListener(c,this.checkInput,this);
this.__Od.addListener(g,this.__Of,this);
}},destruct:function(){this._disposeObjects(f,h,j);
}});
})();
