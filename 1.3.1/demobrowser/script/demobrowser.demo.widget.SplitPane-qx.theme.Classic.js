...
(function(){var l="value",k="horizontal",j="first",h="Trash",g="both",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",K="Windows (C:)",J="Toggle Splitpane Orientation",I="Inbox",H="Desktop",G="__Pp",F="_container1",E="execute",D="):",C="Presets",B="Network",s="changeSelection",t="Sent",q="Offset (",r="/",o="offset",p="Files",m="_container2",n="vertical",u="Workspace",v="Junk #",x="Data",w="Show both panes",z="Show second pane",y="demobrowser.demo.widget.SplitPane",A="Edit";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__Pp:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
var P=this.__Pq();
var O=new qx.ui.form.Button(J).set({allowGrowX:false,allowGrowY:false});
...
},_toggle:function(){var bd=this.__Pp.getOrientation();
this.__Pp.setOrientation(bd==k?n:k);
...
this._container2.show();
}},__Pq:function(){var bo=new qx.ui.tree.Tree();
bo.setDecorator(null);
var bt=new qx.ui.tree.TreeFolder(r);
bt.setOpen(true);
bo.setRoot(bt);
var br=new qx.ui.tree.TreeFolder(H);
br.setOpen(true);
bt.add(br);
...
bh.add(bp,bf);
var bs=new qx.ui.tree.TreeFolder(I);
...
bt.add(bs);
return bo;
}},destruct:function(){this._disposeObjects(G,F,m);
}});
})();
