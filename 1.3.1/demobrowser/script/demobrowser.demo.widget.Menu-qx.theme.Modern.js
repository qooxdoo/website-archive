...
(function(){var ce="execute",cd="changeValue",cc="icon/16/actions/edit-cut.png",cb="changeSelection",ca="icon/16/actions/edit-paste.png",bY="Copy",bX="Paste",bW="icon/16/actions/edit-copy.png",bV="Cut",bU="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",cl="Print",cm="Open",cj="icon/16/actions/document-new.png",ck="Online Forum",ch="icon/16/actions/format-justify-fill.png",ci="Search in files",cf="C",cg="__OY",cn="Left aligned",co="__OV",bN="Perl",bM="View",bP="C Dialect",bO="Info...",bR="Save as...",bQ="Show line numbers",bT="Quickstart",bS="__OX",bL="icon/16/actions/contact-new.png",bK="Actions",a="Show console",b="Search",c="Help",d="Show status bar",f="icon/16/actions/format-justify-left.png",g="ANSI to OEM",h="__Pa",j="Centered",k="Website 3",l="Edit",cs="icon/16/actions/format-justify-center.png",cr="icon/16/actions/go-previous.png",cq="C Sharp",cp="Close",cw="Split Button",cv="Website 2",cu="icon/16/actions/document-save-as.png",ct="Python",cy="icon/16/apps/utilities-help.png",cx="Show tree",K="Options",L="Spaces to tabs",I="Right aligned",J="__Pb",O="Action 1",P="OEM to ANSI",M="Line 431",N="JavaScript",G="icon",H="Action 2",t="Folder ",s="XML",v="Line 313",u="Paragraph",p="demobrowser.demo.widget.Menu",o="icon/16/actions/application-exit.png",r="__Pc",q="C Plus Plus",n="Line 26",m="Item ",U="ASCII table",V="Option 1",W="Search next...",X="Line 12",Q="Action 3",R="Replace in files",S="Uppercase",T="Ctrl+P",Y="__Pd",ba="Topics",D="Panes",C="Justified",B="Ctrl+X",A="Show macros",z="Search previous...",y="Back",x="main",w="Show ruler",F="icon/16/actions/format-justify-right.png",E="icon/16/actions/go-next.png",bb="command ",bc="Option 3",bd="Next",be="Ctrl+R",bf="Show tags",bg="Capitals",bh="Format",bi="File",bj="Show tabs",bk="Tabs to spaces",by="Search...",bx="Line 1039",bw="Option 2",bv="Objective C",bC="Exit",bB="move to",bA="Syntax",bz="Ctrl+C",bE="Website 1",bD="Menu Button",bI="__OW",bJ="Line 30",bG="Lowercase",bH="Replace",bF="HTML";
qx.Class.define(p,{extend:qx.application.Standalone,members:{__OV:null,__OW:null,__OX:null,__OY:null,__Pa:null,__Pb:null,__Pc:null,__Pd:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var cA=new qx.ui.container.Scroll();
var cz=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
cz.setPadding(20);
cz.setAllowStretchX(false);
cA.add(cz);
this.getRoot().add(cA,{edge:0});
this.createCommands();
cz.add(this.getMenuButton(),{left:20,top:20});
cz.add(this.getSplitButton(),{left:150,top:20});
cz.add(this.getMenuBar(),{left:20,top:100});
cz.add(this.getList(),{left:20,top:200});
this.getRoot().setContextMenu(this.getRootContextMenu());
},getRootContextMenu:function(){var cB=new qx.ui.menu.Menu();
var cC=new qx.ui.menu.Menu();

for(var i=0;i<30;i++){cC.add(new qx.ui.menu.Button(t+(i+1)));
}cB.add(new qx.ui.menu.Button(bB,null,null,cC));
cB.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cB.add(new qx.ui.menu.Button(bb+(i+1)));
}return cB;
...
},createCommands:function(){this.__OV=new qx.ui.core.Command("Ctrl+N");
this.__OV.addListener(ce,this.debugCommand);
this.__OW=new qx.ui.core.Command("Ctrl+O");
this.__OW.addListener(ce,this.debugCommand);
this.__OX=new qx.ui.core.Command("Ctrl+S");
this.__OX.addListener(ce,this.debugCommand);
this.__OY=new qx.ui.core.Command("Ctrl+Z");
this.__OY.addListener(ce,this.debugCommand);
this.__Pa=new qx.ui.core.Command(be);
this.__Pa.addListener(ce,this.debugCommand);
this.__Pb=new qx.ui.core.Command(B);
this.__Pb.addListener(ce,this.debugCommand);
this.__Pc=new qx.ui.core.Command(bz);
this.__Pc.addListener(ce,this.debugCommand);
this.__Pd=new qx.ui.core.Command(T);
this.__Pd.addListener(ce,this.debugCommand);
this.__Pd.setEnabled(false);
},getMenuButton:function(){var cD=new qx.ui.menu.Menu;
cD.add(new qx.ui.menu.RadioButton(V));
cD.add(new qx.ui.menu.RadioButton(bw));
cD.add(new qx.ui.menu.RadioButton(bc));
var cL=new qx.ui.menu.Menu;
cL.add(new qx.ui.menu.RadioButton(O));
cL.add(new qx.ui.menu.RadioButton(H));
cL.add(new qx.ui.menu.RadioButton(Q));
var cK=new qx.ui.form.RadioGroup;
cK.add.apply(cK,cD.getChildren());
cK.addListener(cb,this.debugRadio);
var cI=new qx.ui.form.RadioGroup;
cI.add.apply(cI,cL.getChildren());
cI.addListener(cb,this.debugRadio);
var cG=new qx.ui.menu.Menu();
var cJ=new qx.ui.menu.Button(bt,bn,this.__OY);
var cQ=new qx.ui.menu.Button(br,bl,this.__Pa);
var cF=new qx.ui.menu.Button(bV,cc,this.__Pb);
var cN=new qx.ui.menu.Button(bY,bW,this.__Pc);
var cH=new qx.ui.menu.Button(bX,ca,this.__Pd);
var cE=new qx.ui.menu.Button(K,bU,null,cD);
var cO=new qx.ui.menu.Button(bK,bL,null,cL);
var cM=new qx.ui.menu.Button(cl,bp);
cJ.addListener(ce,this.debugButton);
cQ.addListener(ce,this.debugButton);
cF.addListener(ce,this.debugButton);
cN.addListener(ce,this.debugButton);
cH.addListener(ce,this.debugButton);
cE.addListener(ce,this.debugButton);
cO.addListener(ce,this.debugButton);
cM.addListener(ce,this.debugButton);
cG.add(cJ);
cG.add(cQ);
cG.addSeparator();
cG.add(cF);
...
cG.addSeparator();
cG.add(cM);
var cP=new qx.ui.form.MenuButton(bD,bq,cG);
return cP;
},getSplitButton:function(){var cR=new qx.ui.menu.Menu;
var cV=new qx.ui.menu.Button(bE);
var cT=new qx.ui.menu.Button(cv);
var cU=new qx.ui.menu.Button(k);
cR.setMinWidth(120);
cV.addListener(ce,this.debugButton);
cT.addListener(ce,this.debugButton);
cU.addListener(ce,this.debugButton);
cR.add(cV);
cR.add(cT);
cR.add(cU);
var cS=new qx.ui.form.SplitButton(cw,bq,cR);
cS.addListener(ce,this.debugButton);
return cS;
...
db.add(toolbar);
var dk=new qx.ui.toolbar.Part;
var da=new qx.ui.toolbar.Part;
var de=new qx.ui.toolbar.Part;
toolbar.add(dk);
toolbar.add(da);
toolbar.addSpacer();
toolbar.add(de);
var dj=new qx.ui.toolbar.SplitButton(y,cr,this.getBackMenu());
var dg=new qx.ui.toolbar.SplitButton(bd,E,this.getForwardMenu());
var cY=new qx.ui.toolbar.Button(bu,cj,this.__OV);
var dd=new qx.ui.toolbar.Button(cm,bo,this.__OW);
var di=new qx.ui.toolbar.Button(bm,bs,this.__OX);
dj.addListener(ce,this.debugButton);
dg.addListener(ce,this.debugButton);
cY.addListener(ce,this.debugButton);
dd.addListener(ce,this.debugButton);
di.addListener(ce,this.debugButton);
dk.add(dj);
dk.add(dg);
dk.addSeparator();
dk.add(cY);
...
dk.add(di);
dk.setShow(G);
var dc=new qx.ui.toolbar.MenuButton(bi);
var cX=new qx.ui.toolbar.MenuButton(l);
var cW=new qx.ui.toolbar.MenuButton(b);
var dl=new qx.ui.toolbar.MenuButton(bM);
var dh=new qx.ui.toolbar.MenuButton(bh);
dc.setMenu(this.getFileMenu());
cX.setMenu(this.getEditMenu());
cW.setMenu(this.getSearchMenu());
dl.setMenu(this.getViewMenu());
dh.setMenu(this.getFormatMenu());
da.add(dc);
da.add(cX);
da.add(cW);
da.add(dl);
da.add(dh);
var df=new qx.ui.toolbar.MenuButton(c);
df.setMenu(this.getHelpMenu());
de.add(df);
return db;
},getBackMenu:function(){var dn=new qx.ui.menu.Menu;
var dp=new qx.ui.menu.Button(v);
var dr=new qx.ui.menu.Button(bx);
var dm=new qx.ui.menu.Button(X);
var dq=new qx.ui.menu.Button(n);
dp.addListener(ce,this.debugButton);
dr.addListener(ce,this.debugButton);
dm.addListener(ce,this.debugButton);
dq.addListener(ce,this.debugButton);
dn.add(dp);
dn.add(dr);
dn.add(dm);
dn.add(dq);
return dn;
},getForwardMenu:function(){var ds=new qx.ui.menu.Menu;
var dt=new qx.ui.menu.Button(M);
var du=new qx.ui.menu.Button(bJ);
dt.addListener(ce,this.debugButton);
du.addListener(ce,this.debugButton);
ds.add(dt);
ds.add(du);
return ds;
},getFileMenu:function(){var dx=new qx.ui.menu.Menu;
var dv=new qx.ui.menu.Button(bu,cj,this.__OV);
var dz=new qx.ui.menu.Button(cm,bo,this.__OW);
var dy=new qx.ui.menu.Button(cp);
var dC=new qx.ui.menu.Button(bm,bs,this.__OX);
var dB=new qx.ui.menu.Button(bR,cu);
var dA=new qx.ui.menu.Button(cl,bp);
var dw=new qx.ui.menu.Button(bC,o);
dv.addListener(ce,this.debugButton);
dz.addListener(ce,this.debugButton);
dy.addListener(ce,this.debugButton);
dC.addListener(ce,this.debugButton);
dB.addListener(ce,this.debugButton);
dA.addListener(ce,this.debugButton);
dw.addListener(ce,this.debugButton);
dx.add(dv);
dx.add(dz);
dx.add(dy);
dx.add(dC);
...
dx.add(dw);
return dx;
},getEditMenu:function(){var dE=new qx.ui.menu.Menu;
var dH=new qx.ui.menu.Button(bt,bn,this.__OY);
var dG=new qx.ui.menu.Button(br,bl,this.__Pa);
var dD=new qx.ui.menu.Button(bV,cc,this.__Pb);
var dI=new qx.ui.menu.Button(bY,bW,this.__Pc);
var dF=new qx.ui.menu.Button(bX,ca,this.__Pd);
dH.addListener(ce,this.debugButton);
dG.addListener(ce,this.debugButton);
dD.addListener(ce,this.debugButton);
dI.addListener(ce,this.debugButton);
dF.addListener(ce,this.debugButton);
dE.add(dH);
dE.add(dG);
dE.addSeparator();
dE.add(dD);
...
var dK=new qx.ui.menu.Button(by,bU);
var dP=new qx.ui.menu.Button(W);
var dL=new qx.ui.menu.Button(z);
var dO=new qx.ui.menu.Button(bH);
var dJ=new qx.ui.menu.Button(ci,bU);
var dN=new qx.ui.menu.Button(R);
dL.setEnabled(false);
dK.addListener(ce,this.debugButton);
dP.addListener(ce,this.debugButton);
dL.addListener(ce,this.debugButton);
dO.addListener(ce,this.debugButton);
dJ.addListener(ce,this.debugButton);
dN.addListener(ce,this.debugButton);
dM.add(dK);
dM.add(dP);
dM.add(dL);
dM.add(dO);
...
dM.add(dN);
return dM;
},getViewMenu:function(){var dQ=new qx.ui.menu.Menu;
var dS=new qx.ui.menu.Button(D,null,null,this.getPanesMenu());
var dV=new qx.ui.menu.Button(bA,null,null,this.getSyntaxMenu());
var dU=new qx.ui.menu.CheckBox(w);
var dT=new qx.ui.menu.CheckBox(bQ);
var dR=new qx.ui.menu.Button(U);
dU.addListener(cd,this.debugCheckBox);
dT.addListener(cd,this.debugCheckBox);
dR.addListener(ce,this.debugButton);
dQ.add(dS);
dQ.add(dV);
dQ.addSeparator();
...
dQ.add(dR);
return dQ;
},getPanesMenu:function(){var dX=new qx.ui.menu.Menu;
var ea=new qx.ui.menu.CheckBox(bj);
var ec=new qx.ui.menu.CheckBox(d);
var ed=new qx.ui.menu.CheckBox(cx);
var dY=new qx.ui.menu.CheckBox(A);
var eb=new qx.ui.menu.CheckBox(bf);
var dW=new qx.ui.menu.CheckBox(a);
ea.setValue(true);
ec.setValue(true);
dY.setValue(true);
ea.addListener(cd,this.debugCheckBox);
ec.addListener(cd,this.debugCheckBox);
ed.addListener(cd,this.debugCheckBox);
dY.addListener(cd,this.debugCheckBox);
eb.addListener(cd,this.debugCheckBox);
dW.addListener(cd,this.debugCheckBox);
dX.add(ec);
dX.add(ea);
dX.addSeparator();
dX.add(ed);
...
dX.add(dW);
return dX;
},getSyntaxMenu:function(){var ei=new qx.ui.menu.Menu;
var ee=new qx.ui.menu.RadioButton(bF);
var eg=new qx.ui.menu.RadioButton(s);
var ef=new qx.ui.menu.RadioButton(N);
var eh=new qx.ui.menu.Button(bP,null,null,this.getSyntaxCMenu());
var el=new qx.ui.menu.RadioButton(bN);
var ej=new qx.ui.menu.RadioButton(ct);
ei.add(ee);
ei.add(eg);
ei.add(ef);
ei.add(eh);
ei.add(el);
ei.add(ej);
var ek=new qx.ui.form.RadioGroup;
ek.add(ee,eg,ef,el,ej);
ek.add.apply(ek,eh.getMenu().getChildren());
ek.addListener(cb,this.debugRadio);
return ei;
},getSyntaxCMenu:function(){var en=new qx.ui.menu.Menu;
var em=new qx.ui.menu.RadioButton(cf);
var eq=new qx.ui.menu.RadioButton(cq);
var ep=new qx.ui.menu.RadioButton(bv);
var eo=new qx.ui.menu.RadioButton(q);
en.add(em);
en.add(eq);
en.add(ep);
en.add(eo);
return en;
},getFormatMenu:function(){var eu=new qx.ui.menu.Menu;
var et=new qx.ui.menu.Button(u,null,null,this.getParagraphMenu());
var ew=new qx.ui.menu.Button(bk);
var ex=new qx.ui.menu.Button(L);
var es=new qx.ui.menu.Button(S);
var ev=new qx.ui.menu.Button(bG);
var er=new qx.ui.menu.Button(bg);
var ez=new qx.ui.menu.Button(P);
var ey=new qx.ui.menu.Button(g);
ew.addListener(ce,this.debugButton);
ex.addListener(ce,this.debugButton);
es.addListener(ce,this.debugButton);
ev.addListener(ce,this.debugButton);
er.addListener(ce,this.debugButton);
ez.addListener(ce,this.debugButton);
ey.addListener(ce,this.debugButton);
eu.add(et);
eu.add(ew);
eu.add(ex);
eu.addSeparator();
...
eu.add(ey);
return eu;
},getParagraphMenu:function(){var eA=new qx.ui.menu.Menu;
var eD=new qx.ui.menu.Button(cn,f);
var eE=new qx.ui.menu.Button(I,F);
var eB=new qx.ui.menu.Button(j,cs);
var eC=new qx.ui.menu.Button(C,ch);
eD.addListener(ce,this.debugButton);
eE.addListener(ce,this.debugButton);
eB.addListener(ce,this.debugButton);
eC.addListener(ce,this.debugButton);
eA.add(eD);
eA.add(eE);
eA.add(eB);
eA.add(eC);
return eA;
},getHelpMenu:function(){var eF=new qx.ui.menu.Menu;
var eH=new qx.ui.menu.Button(ba,cy);
var eJ=new qx.ui.menu.Button(bT);
var eI=new qx.ui.menu.Button(ck);
var eG=new qx.ui.menu.Button(bO);
eH.addListener(ce,this.debugButton);
eJ.addListener(ce,this.debugButton);
eI.addListener(ce,this.debugButton);
eG.addListener(ce,this.debugButton);
eF.add(eH);
eF.add(eJ);
eF.addSeparator();
eF.add(eI);
...
eF.add(eG);
return eF;
},getList:function(){var eK=new qx.ui.form.List;
eK.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){eK.add(new qx.ui.form.ListItem(m+i));
}return eK;
},getContextMenu:function(){var eL=new qx.ui.menu.Menu;
var eN=new qx.ui.menu.Button(bV,cc,this.__Pb);
var eO=new qx.ui.menu.Button(bY,bW,this.__Pc);
var eM=new qx.ui.menu.Button(bX,ca,this.__Pd);
eN.addListener(ce,this.debugButton);
eO.addListener(ce,this.debugButton);
eM.addListener(ce,this.debugButton);
eL.add(eN);
eL.add(eO);
eL.add(eM);
return eL;
}},destruct:function(){this._disposeObjects(co,bI,bS,cg,h,J,r,Y);
}});
})();
