...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.animation.Showcase","qx.theme":"qx.theme.Modern"};
for (var k in settings) qxsettings[k] = settings[k];

if (!window.qxvariants) qxvariants = {};
var variants = {"qx.animation":"on","qx.aspects":"off","qx.debug":"off"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.animation.Showcase-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"966104651f7a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.__FY=qx.fx.effect.core.Scale.originalStyle;
this.__Ga=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:n},scaleY:{init:true,check:n},scaleContent:{init:true,check:n},scaleFromCenter:{init:true,check:n},scaleFrom:{init:100.0,check:m},scaleTo:{init:100,check:m},restoreAfterFinish:{init:false,check:n},alternateDimensions:{init:[],check:k}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':g,'px':o,'%':b,'pt':h}},members:{__Gb:null,__Gc:null,__Gd:null,__Ge:null,__Gf:null,__Gg:null,__Gh:null,__FY:null,__Ga:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var u=this._getElement();
this.__Gb=qx.bom.element.Style.get(u,f);

for(var s in this.__FY){this.__FY[s]=u.style[s];
}this.__Gc=qx.bom.element.Location.getTop(u);
this.__Gd=qx.bom.element.Location.getLeft(u);

try{var t=qx.bom.element.Style.get(u,l);
}catch(v){if(typeof (t)!=c){t=(qx.bom.client.Engine.MSHTML)?i:e;
}}
for(var q in this.__Ga){if(t.indexOf(q)>0){this.__Ge=parseFloat(t);
this.__Gf=q;
break;
}}this.__Gg=(this.getScaleTo()-this.getScaleFrom())/100;
var r=this.getAlternateDimensions();

if(r.length==0){this.__Gh=[u.offsetWidth,u.offsetHeight];
}else{this.__Gh=r;
}},update:function(w){var y=this._getElement();
qx.fx.Base.prototype.update.call(this);
var x=(this.getScaleFrom()/100.0)+(this.__Gg*w);

if(this.getScaleContent()&&this.__Ge){qx.bom.element.Style.set(y,l,this.__Ge*x+this.__Gf);
}this._setDimensions(this.__Gh[0]*x,this.__Gh[1]*x);
},finish:function(){qx.fx.Base.prototype.finish.call(this);
var B=this._getElement();

if(this.getRestoreAfterFinish()){for(var z in this.__FY){var A=this.__FY[z];
...
if(this.getScaleFromCenter()){var I=(C-this.__Gh[0])/2;
var J=(D-this.__Gh[1])/2;

if(this.__Gb==a){if(G){d.top=this.__Gc-J+o;
}
if(F){d.left=this.__Gd-I+o;
}}else{if(G){d.top=-J+o;
}
if(F){d.left=-I+o;
}}}
for(var E in d){qx.bom.element.Style.set(H,E,d[E]);
}}},destruct:function(){this.__Gh=this.__FY=this.__Ga=null;
}});
})();
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{startColor:{init:c,check:f},endColor:{init:a,check:f},restoreBackground:{init:true,check:h},keepBackgroundImage:{init:false,check:h}},members:{__Gl:null,__Gm:null,__Gn:null,__Go:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var j=this._getElement();
this.__Gl={backgroundImage:qx.bom.element.Style.get(j,g),backgroundColor:qx.bom.element.Style.get(j,i)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,g,e);
}this.__Gm=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__Gn=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__Go=[this.__Gn[0]-this.__Gm[0],this.__Gn[1]-this.__Gm[1],this.__Gn[2]-this.__Gm[2]];
},update:function(k){qx.fx.Base.prototype.update.call(this);
var l=[this.__Gm[0]+Math.round(this.__Go[0]*k),this.__Gm[1]+Math.round(this.__Go[1]*k),this.__Gm[2]+Math.round(this.__Go[2]*k)];
...
for(var n in this.__Gl){qx.bom.element.Style.set(o,n,this.__Gl[n]);
}}},destruct:function(){this.__Gm=this.__Gn=this.__Go=null;
}});
})();
(function(){var e="horizontal",d="vertical",c="qx.fx.effect.combination.Shake",b="__IR",a="Number";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
this.__IR=[new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f)];
},properties:{direction:{init:e,check:[e,d]},duration:{init:0.5,refine:true},distance:{init:20,check:a}},members:{__IR:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var g=parseFloat(this.getDistance());
var h=parseFloat(this.getDuration())/10.0;

if(this.getDirection()==e){this.__IR[0].set({x:g,y:0,duration:h});
this.__IR[1].set({x:-g*2,y:0,duration:h*2});
this.__IR[2].set({x:g*2,y:0,duration:h*2});
this.__IR[3].set({x:-g*2,y:0,duration:h*2});
this.__IR[4].set({x:g*2,y:0,duration:h*2});
this.__IR[5].set({x:-g,y:0,duration:h*2});
}else if(this.getDirection()==d){this.__IR[0].set({y:g,x:0,duration:h});
this.__IR[1].set({y:-g*2,x:0,duration:h*2});
this.__IR[2].set({y:g*2,x:0,duration:h*2});
this.__IR[3].set({y:-g*2,x:0,duration:h*2});
this.__IR[4].set({y:g*2,x:0,duration:h*2});
this.__IR[5].set({y:-g,x:0,duration:h*2});
}var k=this.__IR;

for(var i=0,j=this.__IR.length;i<j;i++){this.__IR[i].id=i;

if(i<5){this.__IR[i].afterFinishInternal=function(){k[this.id+1].start();
};
}}this.__IR[0].start();
}},destruct:function(){this._disposeArray(b);
}});
})();
(function(){var t="linear",s="Number",r="reverse",q="Boolean",p="none",o="wobble",n="flicker",m="pulse",l="sinodial",k="easeOutQuad",d="spring",j="easeInQuad",g="full",c="Color",b="backgroundColor",f="#ffffff",e="backgroundImage",h="qx.fx.effect.combination.ColorFlow",a="#ffffaa",i="__Gj";
qx.Class.define(h,{extend:qx.fx.Base,construct:function(u){qx.fx.Base.call(this,u);
this.__Gj=[new qx.fx.effect.core.Highlight(u),new qx.fx.effect.core.Highlight(u)];
},properties:{startColor:{init:f,check:c},endColor:{init:a,check:c},forwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},backwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},forwardDuration:{init:1.0,check:s},backwardDuration:{init:1.0,check:s},delayBetween:{init:0.3,check:s},restoreBackground:{init:true,check:q},keepBackgroundImage:{init:false,check:q}},members:{__Gk:null,__Gj:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var v=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__Gk={backgroundImage:qx.bom.element.Style.get(v,e),backgroundColor:qx.bom.element.Style.get(v,b)};
this.__Gj[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__Gj[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__Gj[0].afterFinishInternal=function(){self.__Gj[1].start();
};
this.__Gj[0].start();
}},destruct:function(){this._disposeArray(i);
}});
})();
(function(){var e="opacity",d="qx.fx.effect.combination.Pulsate",c="__Ip",b="__In",a="sinodial";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
var g=this.getDuration()/6;
var h=0;
this.__In=[new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f)];

for(var i=0,l=this.__In.length;i<l;i++){this.__In[i].set({duration:g,to:((h%2)!=0)?1:0,from:((h%2)!=0)?0:1,transition:a,modifyDisplay:false});
h++;
}},properties:{duration:{init:2,refine:true}},members:{__Io:null,__In:null,__Ip:null,beforeSetup:function(){this.__Io=qx.bom.element.Style.get(this._getElement(),e);
},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}this.__Ip=[];
var j=0;
var self=this;

for(var i=0,l=this.__In.length;i<l;i++){this.__In[i].id=j;
this.__Ip.push(this.__In[i]);

if(j<5){this.__In[i].afterFinishInternal=function(){qx.lang.Array.remove(self.__Ip,this);
self.__In[this.id+1].start();
};
}j++;
}this.__In[0].start();
},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),e,this.__Io);
},_applyDuration:function(k,m){var n=k/6;

for(var i=0,l=this.__In.length;i<l;i++){this.__In[i].set({duration:n});
}},cancel:function(){for(var i=0,l=this.__Ip.length;i<l;i++){this.__Ip[i].cancel();
}qx.fx.Base.prototype.cancel.call(this);
}},destruct:function(){this._disposeArray(b);
this._disposeArray(c);
}});
})();
(function(){var i="opacity",h="Boolean",g="none",f="qx.fx.effect.combination.Puff",e="_effects",d="__KN",c="__KL",b="__KM",a="display";
qx.Class.define(f,{extend:qx.fx.Base,construct:function(j){qx.fx.Base.call(this,j);
this.__KL=new qx.fx.effect.core.Scale(j);
this.__KM=new qx.fx.effect.core.Fade(j);
this.__KN=new qx.fx.effect.core.Parallel(this.__KL,this.__KM);
},properties:{modifyDisplay:{init:true,check:h}},members:{__KM:null,__KL:null,__KN:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),a,g);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var l=this._getElement();
var k={opacity:qx.bom.element.Style.get(l,i)};
this.__KM.afterFinishInternal=function(){var n=this._getElement();

for(var m in k){qx.bom.element.Style.set(n,m,k[m]);
}};
this.__KL.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__KM.set({sync:true,to:0.0,modifyDisplay:false});
this.__KN.start();
}},destruct:function(){this._disposeArray(e);
this._disposeObjects(d,c,b);
}});
})();
(function(){var b="qx.fx.effect.core.Parallel",a="__Gi";
qx.Class.define(b,{extend:qx.fx.Base,construct:function(c){qx.fx.Base.call(this);
this.__Gi=arguments;
},members:{__Gi:null,finish:function(){qx.fx.Base.prototype.finish.call(this);
var d=this.__Gi;
...
(function(){var j="sinodial",i="none",h="overflow",g="flicker",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",E="easeInQuad",D="reverse",C="linear",B="Boolean",A="px",z='bottom-left',y='top-left',x='bottom-right',w="bottom-right",v="__IJ",q="bottom-left",r="visible",o="__IL",p="qx.fx.effect.combination.Shrink",m="top-left",n="top-right",k='top-right',l='center',s="hidden",t="__IK",u="display";
qx.Class.define(p,{extend:qx.fx.Base,construct:function(F){qx.fx.Base.call(this,F);
this.__IJ=new qx.fx.effect.core.Move(F);
this.__IK=new qx.fx.effect.core.Scale(F);
this.__IL=new qx.fx.effect.core.Parallel(this.__IJ,this.__IK);
},properties:{direction:{init:f,check:[m,n,q,w,f]},moveTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},scaleTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},modifyDisplay:{init:true,check:B}},members:{__IM:null,__IJ:null,__IK:null,__IL:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
qx.bom.element.Style.set(this._getElement(),h,s);
...
for(var G in this.__IM){H=this.__IM[G];
...
var J,K;
this.__IM={top:qx.bom.element.Location.getTop(L,"scroll"),left:qx.bom.element.Location.getLeft(L,"scroll"),width:qx.bom.element.Dimension.getContentWidth(L),height:qx.bom.element.Dimension.getContentHeight(L),opacity:qx.bom.element.Style.get(L,"opacity")};

switch(this.getDirection()){case y:J=K=0;
break;
case k:J=this.__IM.width;
K=0;
break;
case z:J=0;
K=this.__IM.height;
break;
case x:J=this.__IM.width;
K=this.__IM.height;
break;
case l:J=this.__IM.width/2;
K=this.__IM.height/2;
break;
}this.__IJ.set({x:J,y:K,sync:true,transition:this.getMoveTransition()});
this.__IK.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__IL.start();
}},destruct:function(){this._disposeObjects(v,t,o);
}});
})();
(function(){var j="sinodial",i="px",h="flicker",g="0px",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",J="easeInQuad",I="reverse",H="none",G="overflow",F="linear",E="height",D='bottom-left',C='top-left',B='bottom-right',A="bottom-right",q="qx.fx.effect.combination.Grow",r="__FX",o="__FV",p="bottom-left",m="visible",n="width",k="top-left",l="top",s="top-right",t='top-right',v="block",u='center',x="__FW",w="hidden",z="left",y="display";
qx.Class.define(q,{extend:qx.fx.Base,construct:function(K){qx.fx.Base.call(this,K);
this.__FV=new qx.fx.effect.core.Move(K);
this.__FW=new qx.fx.effect.core.Scale(K);
this.__FX=new qx.fx.effect.core.Parallel(this.__FV,this.__FW);
},properties:{direction:{init:f,check:[k,s,p,A,f]},scaleTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]},moveTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]}},members:{__FW:null,__FV:null,__FX:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var O=this._getElement();
qx.bom.element.Style.set(O,y,v);
...
this.__FW.afterFinishInternal=function(){var S;
...
Q=-N.height;
break;
case u:M=Math.round(N.width/2);
L=Math.round(N.height/2);
P=-Math.round(N.width/2);
Q=-Math.round(N.height/2);
break;
}this.__FV.set({x:P,y:Q,sync:true,transition:this.getMoveTransition()});
this.__FW.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[N.width,N.height]});
qx.bom.element.Style.set(O,l,(N.top+L)+i);
qx.bom.element.Style.set(O,z,(N.left+M)+i);
qx.bom.element.Style.set(O,E,g);
qx.bom.element.Style.set(O,n,g);
this.__FX.start();
}},destruct:function(){this._disposeObjects(o,x,r);
}});
})();
(function(){var u="out",t="px",s="south",r="Number",q="north-west",p="west",o="in",n="north",m="south-east",l="south-west",e="east",k="north-east",h="display",c="top",b="Boolean",g="block",f="left",i="__Jm",a="__Jk",j="__Jl",d="qx.fx.effect.combination.Drop";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(v){qx.fx.Base.call(this,v);
this.__Jk=new qx.fx.effect.core.Move(v);
this.__Jl=new qx.fx.effect.core.Fade(v);
this.__Jm=new qx.fx.effect.core.Parallel(this.__Jk,this.__Jl);
},properties:{direction:{init:s,check:[s,p,e,n,l,m,k,q]},xAmount:{init:100,check:r},yAmount:{init:100,check:r},mode:{init:u,check:[o,u]},modifyDisplay:{init:true,check:b}},members:{__Jl:null,__Jk:null,__Jm:null,start:function(){qx.fx.Base.prototype.start.call(this);
...
this.__Jl.afterFinishInternal=function(){for(var B in z){qx.bom.element.Style.set(A,B,z[B]+t);
}};
this.__Jl.set({duration:0.5,sync:true,from:(this.getMode()==u)?1:0,to:(this.getMode()==u)?0:1,modifyDisplay:true});
this.__Jm.start();
}},destruct:function(){this._disposeObjects(a,j,i);
}});
})();
(function(){var q="display",p="in",o="overflow",n="block",m="none",l="visible",k="0px",j="hidden",i="visiblity",h="__KI",c="Boolean",g="height",f="__KJ",b="width",a="px",e="qx.fx.effect.combination.Fold",d="out";
qx.Class.define(e,{extend:qx.fx.Base,construct:function(r){qx.fx.Base.call(this,r);
},properties:{modifyDisplay:{init:true,check:c},mode:{init:p,check:[p,d]}},members:{__KI:null,__KJ:null,__KK:null,afterFinish:function(){var s=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==p)){qx.bom.element.Style.set(s,q,n);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var t=this._getElement();
var self=this;
this.__KI=new qx.fx.effect.core.Scale(t);
this.__KJ=new qx.fx.effect.core.Scale(t);
this.__KI.afterFinishInternal=function(){self.__KJ.start();
};
this.__KJ.afterFinishInternal=function(){self._cleanUp();
};
this.__KK=this._getStyle();
qx.bom.element.Style.set(t,o,j);

if(this.getMode()==p){this.__KI.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__KJ.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__KI.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__KK.width,this.__KK.height]});
this.__KJ.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__KK.width,this.__KK.height]});
qx.bom.element.Style.set(t,q,n);
qx.bom.element.Style.set(t,g,k);
qx.bom.element.Style.set(t,b,k);
}this.__KI.start();
...
for(var u in this.__KK){v=this.__KK[u];
...
(function(){var j="off",i="overflow",h="Boolean",g="qx.fx.effect.combination.Switch",f="none",e="flicker",d="__IT",c="hidden",b="__IU",a="display";
qx.Class.define(g,{extend:qx.fx.Base,construct:function(k){qx.fx.Base.call(this,k);
this.setTransition(e);
var l=this.__IT=new qx.fx.effect.core.Scale(k);
this.__IT.beforeSetup=function(){qx.bom.element.Style.set(k,i,c);
};
this.__IU=new qx.fx.effect.core.Fade(k);
this.__IU.afterFinishInternal=function(){l.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:h},mode:{init:j,check:[j]}},members:{__IT:null,__IU:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var n=this._getElement();
var m=qx.bom.element.Style.get(n,i);
this.__IT.afterFinishInternal=function(){qx.bom.element.Style.set(n,i,m);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==j)){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}
if(this.getMode()==j){this.__IT.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__IU.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__IU.start();
},_applyDuration:function(o,p){this.__IT.setDuration(o/2);
this.__IU.setDuration(o/2);
