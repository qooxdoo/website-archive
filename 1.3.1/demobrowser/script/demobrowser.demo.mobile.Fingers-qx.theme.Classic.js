...
var variants = {"qx.aspects":"off","qx.debug":"off","qx.mobile":"on"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.Fingers-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"fb4d8445b75c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var l="px",k="div",j="50px",h="absolute",g="green",f="100%",d="30px",c="100px",b="innerHTML",a="20px",A="white",z="touchmove",y="black",x="yellow",w="blue",v="0px",u="12px",t="demobrowser.demo.mobile.Fingers",s='Lucida Grande',r="qx.mobile.emulatetouch",p="off",q="touchstart",n="red",o="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",m="<b>Use your fingers to move the dots</b>";
qx.Class.define(t,{extend:qx.application.Native,members:{__PQ:null,__PR:null,main:function(){qx.application.Native.prototype.main.call(this);
{};
var D={"width":f,"height":f,"backgroundColor":y,"margin":v};
var I=new qx.html.Element(k,D);
I.useElement(document.body);
I.setRoot(true);

if(!qx.bom.client.Engine.WEBKIT||(!qx.bom.client.Feature.TOUCH&&qx.core.Variant.isSet(r,p))){var G={"color":g,"position":h,"font-family":s,"font-size":u,"left":d,"top":a};
var E=new qx.html.Element(k,G);
I.add(E);
E.setAttribute(b,o);
return;
}var C={"color":A,"position":h,"left":d,"top":a};
var E=new qx.html.Element(k,C);
I.add(E);
E.setAttribute(b,m);
var F=[w,n,g,A,x];

for(var i=0;i<F.length;i++){var B={"backgroundColor":F[i],"width":c,"height":c,"position":h,"-moz-border-radius":j,"-webkit-border-radius":j,"border-radius":j,"top":((i+5)*30)+l,"left":((i+1)*150)+l};
var H=new qx.html.Element(k,B);
I.add(H);
}this.__PQ=[];
this.__PR=[];
I.addListener(q,this._onTouchStart,this);
I.addListener(z,this._onTouchMove,this);
},_onTouchStart:function(e){var K=e.getAllTouches();

for(var i=0;i<K.length;i++){var J=K[i];
this.__PQ[i]=parseInt(J.target.style.left)-J.pageX;
this.__PR[i]=parseInt(J.target.style.top)-J.pageY;
}},_onTouchMove:function(e){var M=e.getAllTouches();

for(var i=0;i<M.length;i++){var L=M[i];

if(M.target==document.body){continue;
}qx.bom.element.Style.setStyles(L.target,{"left":(L.pageX+this.__PQ[i])+l,"top":(L.pageY+this.__PR[i])+l});
}e.stop();
}}});
})();
