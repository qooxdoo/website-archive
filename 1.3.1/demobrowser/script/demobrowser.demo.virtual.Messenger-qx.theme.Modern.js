...
qx.Class.define(C,{extend:qx.application.Standalone,members:{__Ps:null,messenger:null,__Pt:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var V=this.getRoot();
...
return be;
},showAddContactWindow:function(){if(this.__Ps==null){var bn=new qx.ui.layout.Grid(5,10);
...
this.__Pu=new demobrowser.demo.virtual.messenger.BuddyCell();
this.__Pv=new demobrowser.demo.virtual.messenger.GroupCell();
this.__Pv.addListener(h,this._onChangeOpenGroup,this);
this.__Pw=[];
this.__Px={};
this.__Py=[];
this.__Pz=new qx.util.DeferredCall(this._updateGrouping,this);
},members:{__Py:null,__Px:null,__Pz:null,__Pw:null,__Pu:null,__Pv:null,_getRowData:function(m){return this.__Py[m];
},_getModelRow:function(n){return this.__Py.indexOf(n);
},_getRowCount:function(){return this.__Py.length;
},_isGroupHeader:function(o){return this.__Py[o] instanceof demobrowser.demo.virtual.messenger.GroupModel;
},_getGroupModel:function(name,p){var q=this.__Px[name];
...
return q;
},_onChangeOpenGroup:function(e){var r=this.__Py[e.getData().getUserData(c)];
r.toggleOpen();
this.__Pz.schedule();
},getCellRenderer:function(s){if(this._isGroupHeader(s)){return this.__Pv;
}else{return this.__Pu;
}},isRowSelectable:function(t){return !this._isGroupHeader(t);
},_visualizeGrouping:function(u){var v=this.getTarget();

if(v){for(var i=0;i<this.__Pw.length;i++){var w=this.__Pw[i].getOldRow();
...
D=0;
var x=this._getGroupModel(z.getGroup(),this.__Py.length);
this.__Py.push(x);
y.push(x);
}
if(x.isOpen()){this.__Py.push(z);
...
}},properties:{name:{init:c,event:g,check:a},row:{event:d,check:j,apply:b},open:{check:h,init:true,event:i},itemCount:{check:j,init:0,event:e}},members:{__PA:null,_applyRow:function(k,l){this.__PA=l;
},getOldRow:function(){return this.__PA;
}}});
})();
