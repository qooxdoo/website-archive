...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.mobile.PingPong","qx.theme":"qx.theme.Classic"};
...
(function(){var k="div",j="100%",i="innerHTML",h="20px",g="absolute",f="left",d="touchmove",c="black",b="30px",a="100px",H="1px solid white",G="50%",F="none",E="white",D="#333",C="px",B="border-left",A="green",z="demobrowser.demo.mobile.PingPong",w="0",r="center",s="0px",p="12px",q="15em",n='Lucida Grande',o="qx.mobile.emulatetouch",l="off",m="right",t="Arial",u="border-right",v="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>";
qx.Class.define(z,{extend:qx.application.Native,members:{__PO:null,__PP:null,__PQ:null,__PR:null,__PS:5,__PT:1,__PU:1,__PV:null,__PW:null,__PX:null,main:function(){qx.application.Native.prototype.main.call(this);
{};
var K={"width":j,"height":j,"backgroundColor":c,"margin":s,"userSelect":F};
var N=new qx.html.Element(k,K);
N.useElement(document.body);
N.setRoot(true);

if(!qx.bom.client.Engine.WEBKIT||(!qx.bom.client.Feature.TOUCH&&qx.core.Variant.isSet(o,l))){var M={"color":A,"font-family":n,"font-size":p,"position":g,"left":b,"top":h};
var L=new qx.html.Element(k,M);
N.add(L);
L.setAttribute(i,v);
return;
}var I=this.__Qd(f);
...
var J=this.__Qd(m);
N.add(J);
this.__PP=this.__Qe("left");
I.add(this.__PP);
I.addListener(d,qx.lang.Function.bind(this.__Qc,this,this.__PP),this);
this.__PO=this.__Qe("right");
J.add(this.__PO);
J.addListener(d,qx.lang.Function.bind(this.__Qc,this,this.__PO),this);
this.__PQ=this.__Qf();
N.add(this.__PQ);
this.__PW=this.__Qg();
I.add(this.__PW);
...
this.__PV=[0,0];
this.__PY();
},__PY:function(){this.__PQ.setStyles({"left":"200px","top":"200px"});
this.__PR=new qx.event.Timer(40);
this.__PR.addListener("interval",function(){var x=(parseInt(this.__PQ.getStyle("left"))+this.__PS*this.__PT);
var y=(parseInt(this.__PQ.getStyle("top"))+this.__PS*this.__PU);
this.__PQ.setStyle("left",x+"px");
this.__PQ.setStyle("top",y+"px");
this.__Qb();
},this);
this.__PR.start();
},__Qa:function(O){this.__PR.stop();
this.__PR.dispose();
this.__PS=5;
this.__PV[O]=this.__PV[O]+1;
this.__PW.setAttribute(i,this.__PV[0]);
this.__PX.setAttribute(i,this.__PV[1]);
this.__PY();
},__Qb:function(){var Q=this.getBoundsFor(this.__PQ);
if(Q.top<=0){this.__PU=1;
}if(Q.bottom>=window.innerHeight-5){this.__PU=-1;
}if(Q.left<=0||Q.right>=window.innerWidth){this.__Qa(Q.left<=0?1:0);
}var R=this.getBoundsFor(this.__PP);

if(Q.left<=R.right&&Q.bottom>=R.top&&Q.top<=R.bottom){this.__PT=1;
this.__PS=Math.min(this.__PS+1,20);
}var P=this.getBoundsFor(this.__PO);

if(Q.right>=P.left&&Q.bottom>=P.top&&Q.top<=P.bottom){this.__PT=-1;
this.__PS=Math.min(this.__PS+1,20);
}},__Qc:function(S,e){S.setStyles({"top":(e.getDocumentTop()-50)+C});
},getBoundsFor:function(T){return qx.bom.element.Location.get(T.getDomElement());
},__Qd:function(U){var V={"width":G,"height":j,"position":g,"backgroundColor":c};

if(U==f){V[u]=H;
}else{V[f]=G;
V[B]=H;
}return new qx.html.Element(k,V);
},__Qe:function(W){var X={"width":b,"height":a,"top":a,"position":g,"backgroundColor":E};
X[W]=h;
return new qx.html.Element(k,X);
},__Qf:function(){var Y={"width":h,"height":h,"position":g,"backgroundColor":E,"userSelect":F};
return new qx.html.Element(k,Y);
},__Qg:function(){var ba={"width":j,"height":j,"textAlign":r,"fontSize":q,"color":D,"fontFamily":t};
var bb=new qx.html.Element(k,ba);
bb.setAttribute(i,w);
return bb;
}}});
})();
