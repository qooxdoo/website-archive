...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Flash","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Flash-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"54bb3985c3ba"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="execute",j="Flash Player Version",i="__Nx",h="right",g="qooxdoo is the best!",f="Message from Flash:",d="__Nt",c="__Nv",b="Simple demo with FlashVars",a="bgcolor",C="demobrowser.demo.widget.Flash",B="demobrowser/demo/flash/TestFlash.swf",A="Send to Flash",z="demobrowser/demo/flash/FlashVersion.swf",y="No message.",x="Flash:",w="<b>qooxdoo:</b>",v="demobrowser.demo.widget.Flash.sendMessage",u="demobrowser.demo.widget.Flash.flashReady",t="demobrowser/demo/flash/fo_tester.swf",r="this is passed in via FlashVars",s="Two way communication (ActionScript <-> JavaScript)",p="__Nw",q="__Nu",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(C,{extend:qx.application.Standalone,members:{__Nt:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var D=new qx.ui.tabview.TabView();
D.setContentPadding([8,8,8,8]);
var G=this.getRoot();
G.add(D,{edge:0});
var E=new qx.ui.tabview.Page(b);
E.setLayout(new qx.ui.layout.Canvas());
E.add(this.createFlashDemo1(),{edge:0});
D.add(E);
var F=new qx.ui.tabview.Page(s);
F.setLayout(new qx.ui.layout.Canvas());
F.add(this.createFlashDemo2(),{edge:0});
D.add(F);
this.__Nt=this.createWindow();
G.add(this.__Nt,{top:20,left:20});
},createWindow:function(){var H=new qx.ui.window.Window(j).set({width:300,height:200,contentPadding:[0,0,0,0]});
H.setLayout(new qx.ui.layout.Canvas());
H.add(new qx.ui.embed.Flash(z),{edge:0});
return H;
},createFlashDemo1:function(){var K=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var I={flashVarText:r};
var J=new qx.ui.embed.Flash(t).set({scale:l,variables:I});
J.getContentElement().setParam(a,m);
K.add(J,{flex:1});
var L=new qx.ui.form.Button(o);
L.addListener(k,function(){this.__Nt.open();
},this);
K.add(L);
return K;
},__Nu:null,__Nv:null,__Nw:null,__Nx:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var O=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var N=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
O.add(N,{flex:1});
N.add(new qx.ui.basic.Label(w).set({rich:true}));
N.add(new qx.ui.basic.Label(f));
this.__Nv=new qx.ui.form.TextArea(y);
this.__Nv.setEnabled(false);
N.add(this.__Nv,{flex:1});
N.add(new qx.ui.basic.Label(n));
this.__Nw=new qx.ui.form.TextArea(g);
N.add(this.__Nw,{flex:1});
var P=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));
this.__Nx=new qx.ui.form.Button(A);
this.__Nx.setEnabled(false);
this.__Nx.addListener(k,function(e){this.__Nu.getFlashElement().sendMessage(this.__Nw.getValue());
},this);
P.add(this.__Nx);
N.add(P);
var M=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
O.add(M,{flex:1});
M.add(new qx.ui.basic.Label(x).set({rich:true}));
this.__Nu=new qx.ui.embed.Flash(B);
this.__Nu.setVariables({init:u});
M.add(this.__Nu,{flex:1});
return O;
},sendMessage:function(Q){this.__Nv.setValue(Q);
},initFlash:function(){if(this.__Nu.getFlashElement().setup){this.__Nu.getFlashElement().setup(v);
this.__Nx.setEnabled(true);
...
}}},statics:{__Ny:null,setCallBackInstance:function(R){demobrowser.demo.widget.Flash.__Ny=R;
},sendMessage:function(S){demobrowser.demo.widget.Flash.__Ny.sendMessage(S);
},flashReady:function(){demobrowser.demo.widget.Flash.__Ny.initFlash();
}},destruct:function(){this._disposeObjects(c,p,i,q,d);
}});
})();
...
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bf,bg){this.__Fx(e,bf);
},_applyScale:function(bh,bi){this.__Fx(a,bh);
},_applyWmode:function(bj,bk){this.__Fx(O,bj);
},_applyPlay:function(bl,bm){this.__Fx(s,bl);
},_applyLoop:function(bn,bo){this.__Fx(J,bn);
},_applyMenu:function(bp,bq){this.__Fx(L,bp);
},_applyAllowScriptAccess:function(br,bs){this.__Fx(I,br);
},_applyLiveConnect:function(bt,bu){this.__Fx(o,bt);
},__Fx:function(bv,bw){this.getContentElement().setParam(bv,bw);
qx.ui.core.queue.Layout.add(this);
}}});
})();
...
this.__Ex={};
this.__Ey={};
},members:{__Ew:null,__Ey:null,__Ex:null,__Ez:null,_createDomElement:function(){return qx.bom.Element.create(d);
},createFlash:function(){this.__Ez=qx.bom.Flash.create(this.getDomElement(),this.getAttributes(),this.__Ex,this.__Ew);
},setSource:function(g){{};

if(this.__Ez){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,g);
},setId:function(h){{};

if(this.__Ez){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(b,h);
},getVariables:function(){return this.__Ex;
},setVariables:function(i){{};

if(this.__Ez){throw new Error("The variables cannot be modified after initial creation");
}this.__Ex=i;
},getAttributes:function(){return this.__Ey;
},setAttribute:function(j,k){{};

if(this.__Ez){throw new Error("The attributes cannot be modified after initial creation");
}
if(k===null||k===undefined){delete this.__Ey[j];
}else{this.__Ey[j]=k;
}},getParams:function(){return this.__Ew;
},setParam:function(l,m){{};

if(this.__Ez){throw new Error("The params cannot be modified after initial creation");
}
if(m===null||m===undefined){delete this.__Ew[l];
}else{this.__Ew[l]=m;
}},getFlashElement:function(){return this.__Ez;
}},destruct:function(){if(this.__Ez){qx.bom.Flash.destroy(this.__Ez);
}this.__Ew=this.__Ex=this.__Ey=null;
}});
})();
(function(){var l="=",k="movie",j="qx.client",h="100%",g="&",f="data",e="undefined",d="mshtml",c="beforeunload",b="load",a="qx.bom.Flash";
...
delete n.movie;
if(o){for(var name in o){if(typeof p.flashvars!=e){p.flashvars+=g+name+l+o[name];
}else{p.flashvars=name+l+o[name];
}}}var r=this.__EF(m,n,p,q);
this._flashObjects[n.id]=r;
return r;
},destroy:qx.core.Variant.select(j,{"mshtml":function(s,t){s=this.__EA(s);

if(s.readyState==4){this.__EB(s);
}else{if(!t){t=window;
}qx.bom.Event.addNativeListener(t,b,function(){qx.bom.Flash.__EB(s);
});
}},"default":function(u,v){u=this.__EA(u);
u.parentNode.removeChild(u);
delete this._flashObjects[u.id];
}}),__EA:function(w){if(!w){throw new Error("DOM element is null or undefined!");
}
...
},__EB:qx.core.Variant.select("qx.client",{"mshtml":qx.event.GlobalError.observeMethod(function(x){for(var i in x){if(typeof x[i]=="function"){x[i]=null;
}}x.parentNode.removeChild(x);
delete this._flashObjects[x.id];
}),"default":null}),__EC:qx.event.GlobalError.observeMethod(function(){for(var y in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[y]);
}window.__ED=function(){};
window.__EE=function(){};
window.detachEvent("onbeforeunload",qx.bom.Flash.__EC);
}),__EF:qx.core.Variant.select("qx.client",{"mshtml":function(z,A,B,C){B.movie=A.data;
delete A.data;
delete A.classid;
var D="";
...
return J;
}})},defer:function(K){if(qx.core.Variant.isSet(j,d)){qx.bom.Event.addNativeListener(window,c,K.__EC);
}}});
})();
