...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.table.Table_Resize_Columns","qx.theme":"qx.theme.Modern"};
for (var k in settings) qxsettings[k] = settings[k];

if (!window.qxvariants) qxvariants = {};
var variants = {"qx.aspects":"off","qx.debug":"off","qx.table":"on"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Resize_Columns-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"83340c8ff237"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(c,{extend:qx.application.Standalone,include:demobrowser.demo.table.MUtil,members:{__Os:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
},showDialog:function(s){if(!this.__Os){var v=this.__Os=new qx.ui.window.Window().set({modal:true,showMinimize:false,showMaximize:false,width:180,contentPadding:[10,10,10,10]});
v.moveTo(315,100);
...
}this.__Os.getChildren()[1].setValue(s);
this.__Os.open();
this.__Os.getChildren()[2].focus();
}},destruct:function(){this._disposeObjects(i,l,b);
}});
})();
(function(){var r="execute",q="Add 10 rows",p="Remove 10 rows",o="Whether the the first visible row should ",n="demobrowser.demo.table.Table_Resize_Columns",m="A number",l="_tableModel",k="1*",j="icon/22/actions/list-add.png",i="50%",c="A date",h="changeValue",f="Boolean test",b="be rendered completely when scrolling.",a="Table with automatic column sizes",e="Keep first row",d="icon/22/actions/list-remove.png",g="ID";
qx.Class.define(n,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return a;
},createTable:function(){var w=this.createRandomRows(50);
var u=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
u.setColumns([g,m,c,f]);
u.setData(w);
var t={tableColumnModel:function(y){return new qx.ui.table.columnmodel.Resize(y);
}};
var x=this._table=new qx.ui.table.Table(u,t);
x.set({width:600,height:400});
x.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var v=x.getTableColumnModel();
var s=v.getBehavior();
s.set(0,{width:k,minWidth:40,maxWidth:80});
s.setWidth(1,i);
s.setMinWidth(1,100);
s.setMaxWidth(1,320);
var v=x.getTableColumnModel();
v.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
return x;
},createControls:function(){var C=new qx.ui.toolbar.ToolBar();
var A,B,D;
B=new qx.ui.toolbar.Part();
C.add(B);
A=new qx.ui.toolbar.Button(q,j);
A.addListener(r,function(E){var F=this.createRandomRows(10);
this._tableModel.addRows(F);
this.info("10 rows added");
},this);
B.add(A);
A=new qx.ui.toolbar.Button(p,d);
A.addListener(r,function(G){var H=this._tableModel.getRowCount();
this._tableModel.removeRows(H-10,10);
...
C.add(B);
var z=this._table;
D=new qx.ui.toolbar.CheckBox(e);
D.set({value:z.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(o+b)});
D.addListener(h,function(I){z.setKeepFirstVisibleRowComplete(this.getValue());
},D);
B.add(D);
return C;
