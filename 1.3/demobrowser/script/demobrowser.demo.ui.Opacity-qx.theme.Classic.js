...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.ui.Opacity","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.Opacity-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"088482527edb"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
g.add(this.getGrid1());
},getGrid1:function(){var o=new qx.ui.decoration.Single(1,b,a);
var p=30;
var m=30;
var l=15;
var j=new qx.ui.container.Composite(new qx.ui.layout.Grid());
var k=new qx.ui.basic.Label().set({rich:true,value:e,decorator:o,backgroundColor:f});
k.setUserBounds(0,0,l*p+100,l*m);
j.add(k);
var n=Math.sqrt((p-1)*(p-1)+(m-1)*(m-1));

for(var x=0;x<p;x++){for(var y=0;y<m;y++){j.add(new qx.ui.core.Widget().set({backgroundColor:d,height:l,width:l,opacity:Math.sqrt(x*x+y*y)/n}),{row:x,column:y});
}}return j;
}}});
})();
