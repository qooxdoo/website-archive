...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.Canvas_Fixed","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Canvas_Fixed-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"f6ad4170e30d"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var i="black",h="teal",g="red",f="demobrowser.demo.layout.Canvas_Fixed",e="green",d="yellow",c="orange",b="solid",a="blue";
...
var q=new qx.ui.decoration.Single(3,b,i);
var p=new qx.ui.core.Widget().set({backgroundColor:g,decorator:q});
var o=new qx.ui.core.Widget().set({backgroundColor:a,decorator:q});
var n=new qx.ui.core.Widget().set({backgroundColor:e,decorator:q});
var m=new qx.ui.core.Widget().set({backgroundColor:d,decorator:q});
var l=new qx.ui.core.Widget().set({backgroundColor:c,decorator:q});
var k=new qx.ui.core.Widget().set({backgroundColor:h,decorator:q});
var j=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
j.setPadding(10);
j.add(p,{left:10,top:10,right:10,bottom:10});
j.add(o,{left:30,top:30,right:30});
j.add(n,{left:50,top:50,bottom:50});
j.add(m,{left:70,top:70});
j.add(l,{top:50,right:50});
j.add(k,{right:50,bottom:50});
