...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Virtual_List","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Virtual_List-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"9c6841319ad7"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var o="value",n="one",m="multi",l="changeValue",k="single",j="additive",h="bold",g="Item No ",f="Julian",d="Moritz",bB="Jannis",bA="Kevin",bz="Robin",by="Felix",bx="Vincent",bw="Erik",bv="Additive Selection",bu="/places/folder.png",bt="Nils",bs="Nick",v="Leon",w="Jannick",t="Linus",u="Configurable",r="Marc",s="icon/16/places/folder.png",p="demobrowser.demo.test.Virtual_List",q="addaptive",D="Colin",E="Lennard",T="changeSelection",P="Jason",bc="Tobias",W="Florian",bo="16",bi="Jonas",K="icon/",br="Jakob",bq="Enable drag selection",bp="Joel",I="David",M="Maximilian",O="48",R="Marlon",U="Lukas",X="Luca",be="Julius",bk="Fabian",x="Tim",y="Justin",L="Single Selection",bb="Simon",ba="Luis",Y="Johannes",bg="Nico",bf="Alexander",V="Jan",bd="Dominic",a="Noah",bj="Enable quick selection",z="Daniel",A="Paul",Q="Philipp",b="Niclas",c="Max",H="One Selection",B="Additive selection",C="Jonathan",G="Tom",S="Finn",bm="Ben",bl="on",N="One as selection mode",bn="Elias",J="Mika",bh="Multi Selection",F="Marvin";
...
var bN=new qx.ui.basic.Label(u);
bN.setFont(h);
this.getRoot().add(bN,{left:20,top:20});
var bO=new demobrowser.demo.virtual.list.List();
bO.setScrollbarX(bl);
bO.set({height:280,width:150,selectionMode:m});
var bK;

for(var i=1;i<=2500;i++){bK=new demobrowser.demo.virtual.list.ListItem(g+i,K+((i%4)?bo:O)+bu);

if(i%4==0){bK.setHeight(56);
}bO.add(bK);
if(i==20){bO.setSelected(bK);
}}bO.addListener(l,function(e){this.debug("Value: "+e.getData());
});
this.getRoot().add(bO,{left:20,top:40});
var bG=new qx.ui.form.RadioButton(L);
var bD=new qx.ui.form.RadioButton(bh);
var bE=new qx.ui.form.RadioButton(bv);
var bC=new qx.ui.form.RadioButton(H);
bG.setUserData(o,k);
bD.setUserData(o,m);
bE.setUserData(o,j);
bC.setUserData(o,n);
bD.setValue(true);
this.getRoot().add(bG,{left:180,top:40});
this.getRoot().add(bD,{left:180,top:60});
this.getRoot().add(bE,{left:180,top:80});
this.getRoot().add(bC,{left:180,top:100});
var bF=new qx.ui.form.RadioGroup(bG,bD,bE,bC);
var bJ=new qx.ui.form.CheckBox(bq);
var bM=new qx.ui.form.CheckBox(bj).set({enabled:false});
this.getRoot().add(bJ,{left:180,top:220});
this.getRoot().add(bM,{left:180,top:240});
bJ.addListener(l,function(e){if(e.getData()){var bR=bO.getSelectionMode();

if(bR==k||bR==n){this.debug("Drag selection is only available for the modes multi or additive");
}}bO.setDragSelection(e.getData());
});
bM.addListener(l,function(e){if(e.getData()){var bS=bO.getSelectionMode();

if(bS==m||bS==j){this.debug("Quick selection is only available for the modes multi or additive");
}}bO.setQuickSelection(e.getData());
});
bF.addListener(T,function(e){var bT=e.getData()[0].getUserData(o);
bO.setSelectionMode(bT);

if(bT==k||bT==n){bJ.setEnabled(false);
bM.setEnabled(true);
}else if(bT==m||bT==q){bJ.setEnabled(true);
bM.setEnabled(false);
}});
var bQ=new qx.ui.basic.Label(N);
bQ.setFont(h);
this.getRoot().add(bQ,{left:330,top:20});
var bL=new demobrowser.demo.virtual.list.List();
bL.set({height:280,width:150,selectionMode:n});
var bK;

for(var i=1;i<=25;i++){bK=new demobrowser.demo.virtual.list.ListItem(g+i,s);
bL.add(bK);
if(i==16){bL.setSelected(bK);
}}this.getRoot().add(bL,{left:330,top:40});
var bN=new qx.ui.basic.Label(B);
bN.setFont(h);
this.getRoot().add(bN,{left:520,top:20});
var bP=new demobrowser.demo.virtual.list.List;
var bH;
bP.set({width:150,selectionMode:j});
var bI=[v,U,X,S,x,by,bi,ba,M,f,c,A,b,V,bm,bn,w,Q,a,G,d,bg,I,bt,bb,bk,bw,y,bf,br,W,bs,t,J,P,z,E,F,bB,bc,bd,R,r,Y,C,be,D,bp,bA,bx,bz];

for(var i=0;i<bI.length;i++){bH=new demobrowser.demo.virtual.list.ListItem(bI[i]);
bP.add(bH);

if(i==10||i==12||i==16){bP.addToSelection(bH);
}}this.getRoot().add(bP,{left:520,top:40});
}}});
})();
...
(function(){var g="scrollY",f="update",d="scrollX",c="pane",b="__Ah",a="qx.ui.virtual.core.Scroller";
...
this.__Ah=new qx.ui.virtual.core.Pane(h,i,j,k);
this.__Ah.addListener(f,this._computeScrollbars,this);
this.__Ah.addListener(d,this._onScrollPaneX,this);
this.__Ah.addListener(g,this._onScrollPaneY,this);
this._add(this.__Ah,{row:0,column:0});
},properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{__Ah:null,getPane:function(){return this.__Ah;
},_createChildControlImpl:function(l,m){if(l==c){return this.__Ah;
...
},_onScrollBarX:function(e){this.__Ah.setScrollX(e.getData());
},_onScrollBarY:function(e){this.__Ah.setScrollY(e.getData());
...
(function(){var n="selected",m="qx.event.type.Data",k="Boolean",h="changeSelection",g="row",f="single",d="changeHeight",c=",",b="one",a="_applySpacing",C="Integer",B="_applyDragSelection",A="String",z="resize",y="demobrowser.demo.virtual.list.List",x="list",w="multi",v="_applyQuickSelection",u="_applyItemHeight",t="_applySelectionMode",r="additive",s="changeName",p="Number",q="addItem",o="removeItem";
qx.Class.define(y,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider],construct:function(){qx.ui.virtual.core.Scroller.call(this,0,1,this.getItemHeight(),10);
this.__MV=new qx.ui.virtual.layer.WidgetCell(this);
this.getPane().addLayer(this.__MV);
this.getPane().addListener(z,this._onResize,this);
this.__MW=[];
this.__MX=[];
this.__MY=new qx.ui.virtual.selection.Row(this.getPane());
this.__MY.addListener(h,this._onChangeSelection,this);
this.__MY.attachMouseEvents();
this.__MY.attachKeyEvents(this);
this.__MY.attachListEvents(this);
new qx.ui.virtual.behavior.Prefetch(this,{minLeft:0,maxLeft:0,minRight:0,maxRight:0,minAbove:400,maxAbove:600,minBelow:400,maxBelow:600}).set({interval:500});
},events:{addItem:m,removeItem:m,changeValue:m,changeSelection:m},properties:{appearance:{refine:true,init:x},focusable:{refine:true,init:true},spacing:{check:C,init:0,apply:a,themeable:true},enableInlineFind:{check:k,init:true},name:{check:A,nullable:true,event:s},itemHeight:{init:24,themeable:true,check:p,apply:u},selectionMode:{check:[f,w,r,b],init:f,apply:t},dragSelection:{check:k,init:false,apply:B},quickSelection:{check:k,init:false,apply:v}},members:{__MW:null,__MX:null,__MY:null,__MV:null,syncWidget:function(){this.update();
},update:function(){var E=this.getPane().getRowConfig();
E.setItemCount(this.__MW.length);
E.resetItemSizes();

for(var i=0;i<this.__MW.length;i++){var D=this.__MW[i].getHeight();

if(D!==null){E.setItemSize(i,D);
}}},updateSelection:function(){var F=this.__MV.getChildren();

for(var i=0;i<F.length;i++){var G=F[i];
var H=G.getUserData(g);

if(this.__MY.isItemSelected(H)){G.addState(n);
}else{G.removeState(n);
...
this.fireDataEvent(h,this.__Nd(e.getData()));
},getCellWidget:function(I,J){var L=this.__MW[I];

if(!L){return null;
}var K=this.__MX.pop()||new qx.ui.form.ListItem();
K.set({label:L.getLabel(),icon:L.getIcon()});

if(this.__MY.isItemSelected(I)){K.addState(n);
}else{K.removeState(n);
}K.setUserData(g,I);
return K;
},poolCellWidget:function(M){this.__MX.push(M);
},getValue:function(){var N=this.getSelection();
var O=[];
var P;

for(var i=0,l=N.length;i<l;i++){P=N[i].getValue();
if(P==null){P=N[i].getLabel();
}O.push(P);
}return O.join(c);
},setValue:function(Q){var T=Q.split(c);
var S=[];
var R;

for(var i=0,l=T.length;i<l;i++){R=this.findItem(T[i]);

if(R){S.push(R);
}}this.setSelection(S);
},getChildren:function(){return this.__MW;
},hasChildren:function(){return this.__MW.length>0;
},_addHelper:function(U){this.fireDataEvent(q,U);
U.addListener(d,this._onChangeItemHeight,this);
qx.ui.core.queue.Widget.add(this);
},_removeHelper:function(V){this.fireDataEvent(o,V);
V.removeListener(d,this._onChangeItemHeight,this);
qx.ui.core.queue.Widget.add(this);
},add:function(W){this.__MW.push(W);
this._addHelper(W);
return this;
},remove:function(X){qx.lang.Array.remove(this.__MW,X);
this._removeHelper(X);
return this;
},removeAll:function(){for(var i=0,j=this.__MW.length;i<j;i++){this._removeHelper(this.__MW[i]);
}this.__MW=[];
},indexOf:function(Y){return this.__MW.indexOf(Y);
},addAt:function(ba,bb){qx.lang.Array.insertAt(this.__MW,ba,bb);
this._addHelper(ba);
},addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__MW,bc,bd);
this._addHelper(bc);
},addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__MW,be,bf);
this._addHelper(be);
},removeAt:function(bg){this.__MW.splice(bg,1);
this._removeHelper(this.__MW[bg]);
},__Na:function(bh){var bi=this.__MW.indexOf(bh);

if(bi<0){return null;
}else{return bi;
}},__Nb:function(bj){var bk=this.__MW[bj];
return bk;
},__Nc:function(bl){var bm=[];

for(var i=0;i<bl.length;i++){bm.push(this.__Na(bl[i]));
}return bm;
},__Nd:function(bn){var bo=[];

for(var i=0;i<bn.length;i++){bo.push(this.__MW[bn[i]]);
}return bo;
},selectAll:function(){this.__MY.selectAll();
},setSelected:function(bp){this.__MY.selectItem(this.__Na(bp));
},isSelected:function(bq){return this.__MY.isItemSelected(this.__Na(bq));
},addToSelection:function(br){this.__MY.addItem(this.__Na(br));
},removeFromSelection:function(bs){this.__MY.removeItem(this.__Na(bs));
},selectRange:function(bt,bu){this.__MY.selectItemRange(this.__Na(bt),this.__Na(bu));
},resetSelection:function(){this.__MY.clearSelection();
},setSelection:function(bv){this.__MY.replaceSelection(this.__Nc(bv));
},getSelectedItem:function(){return this.__MW[this.getSelected()];
},getSelected:function(){return this.__MW[this.__MY.getSelectedItem()];
},getSelection:function(){return this.__Nd(this.__MY.getSelection());
},getSortedSelection:function(){return this.__Nd(this.__MY.getSortedSelection());
},isSelectionEmpty:function(){return this.__MY.isSelectionEmpty();
},getSelectionContext:function(){return this.__MY.getSelectionContext();
},getSelectables:function(){return this.__Nd(this.__MY.getSelectables());
},_applySelectionMode:function(bw,bx){this.__MY.setMode(bw);
},_applyDragSelection:function(by,bz){this.__MY.setDrag(by);
},_applyQuickSelection:function(bA,bB){this.__MY.setQuick(bA);
}}});
})();
...
(function(){var l="appear",k="qx.ui.virtual.core.CellEvent",j="qx.event.type.Data",h="change",g="update",f="scrollY",d="full update",c="__yN",b="__yU",a="dblclick",A="update layer window",z="qx.event.type.Event",y="cellContextmenu",x="resize",w="__yM",v="scrollX",u="__yV",t="cellDblclick",s="qx.ui.virtual.core.Pane",r="click",p="prefetch x",q="contextmenu",n="cellClick",o="prefetch y",m="scroll";
qx.Class.define(s,{extend:qx.ui.core.Widget,construct:function(B,C,D,E){qx.ui.core.Widget.call(this);
this.__yM=new qx.ui.virtual.core.Axis(D,B);
this.__yN=new qx.ui.virtual.core.Axis(E,C);
this.__yO=0;
this.__yP=0;
this.__yQ=0;
this.__yR=0;
this.__yS={};
this.__yT={};
this.__yU=new qx.ui.container.Composite();
this.__yU.setUserBounds(0,0,0,0);
this._add(this.__yU);
this.__yV=[];
this.__yM.addListener(h,this.fullUpdate,this);
this.__yN.addListener(h,this.fullUpdate,this);
this.addListener(x,this._onResize,this);
this.addListenerOnce(l,this._onAppear,this);
this.addListener(r,this._onClick,this);
this.addListener(a,this._onDblclick,this);
this.addListener(q,this._onContextmenu,this);
},events:{cellClick:k,cellContextmenu:k,cellDblclick:k,update:z,scrollX:j,scrollY:j},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{__yM:null,__yN:null,__yO:null,__yP:null,__yQ:null,__yR:null,__yS:null,__yT:null,__yU:null,__yV:null,__yW:null,__yX:null,__yY:null,DEBUG:false,getRowConfig:function(){return this.__yM;
},getColumnConfig:function(){return this.__yN;
},getChildren:function(){return [this.__yU];
},addLayer:function(F){{};
this.__yV.push(F);
F.setUserBounds(0,0,0,0);
this.__yU.add(F);
},getLayers:function(){return this.__yV;
},getVisibleLayers:function(){var G=[];

for(var i=0;i<this.__yV.length;i++){var H=this.__yV[i];

if(H.isVisible()){G.push(H);
}}return G;
},getScrollMaxX:function(){var I=this.getBounds();

if(I){return Math.max(0,this.__yN.getTotalSize()-I.width);
}return 0;
},getScrollMaxY:function(){var J=this.getBounds();

if(J){return Math.max(0,this.__yM.getTotalSize()-J.height);
}return 0;
...
if(this.__yO!==K){var M=this.__yO;
this.__yO=K;
this._deferredUpdateScrollPosition();
this.fireDataEvent(f,K,M);
}},getScrollY:function(){return this.__yO;
},setScrollX:function(N){var O=this.getScrollMaxX();

if(N<0){N=0;
}else if(N>O){N=O;
}
if(N!==this.__yP){var P=this.__yP;
this.__yP=N;
this._deferredUpdateScrollPosition();
this.fireDataEvent(v,N,P);
}},getScrollX:function(){return this.__yP;
},getScrollSize:function(){return {width:this.__yN.getTotalSize(),height:this.__yM.getTotalSize()};
...
return;
}var U=this.__yM.getItemPosition(Q);
var S=U+this.__yM.getItemSize(Q);
...
return;
}var X=this.__yN.getItemPosition(V);
var W=X+this.__yN.getItemSize(V);
...
}bg=this.__yM.getItemAtPosition(this.getScrollY()+bf-bi.top);
bh=this.__yN.getItemAtPosition(this.getScrollX()+be-bi.left);
...
if(!bp){return;
}var bq=this.__yP+bp.width;
var br=this.__yR-bq;

if(this.__yP-this.__yS.left<Math.min(this.__yP,bj)||this.__yS.right-bq<Math.min(br,bl)){this.DEBUG&&console.log(p);
var bs=Math.min(this.__yP,bk);
var bo=Math.min(br,bm);
this._setLayerWindow(bn,this.__yP-bs,this.__yO,bp.width+bs+bo,bp.height,false);
...
if(!bA){return;
}var by=this.__yO+bA.height;
var bz=this.__yQ-by;

if(this.__yO-this.__yS.top<Math.min(this.__yO,bt)||this.__yS.bottom-by<Math.min(bz,bv)){this.DEBUG&&console.log(o);
var bC=Math.min(this.__yO,bu);
var bB=Math.min(bz,bw);
this._setLayerWindow(bx,this.__yP,this.__yO-bC,bA.width,bA.height+bC+bB,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__yW=true;
this._updateScrollPosition();
this.__yW=null;
this.fireEvent(g);
}},_onAppear:function(){this.fullUpdate();
},_onClick:function(e){this.__za(e,n);
},_onContextmenu:function(e){this.__za(e,y);
},_onDblclick:function(e){this.__za(e,t);
},__za:function(e,bD){var bE=this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());

if(!bE){return;
}this.fireNonBubblingEvent(bD,qx.ui.virtual.core.CellEvent,[this,e,bE.row,bE.column]);
},syncWidget:function(){if(this.__yT._fullUpdate){this._fullUpdate();
}else if(this.__yT._updateScrollPosition){this._updateScrollPosition();
}this.__yT={};
},_setLayerWindow:function(bF,bG,top,bH,bI,bJ){var bO=this.__yM.getItemAtPosition(top);

if(bO){var bQ=bO.index;
var bV=this.__yM.getItemSizes(bQ,bI+bO.offset);
...
var bX=0;
var bU=0;
}var bS=this.__yN.getItemAtPosition(bG);

if(bS){var bM=bS.index;
var bL=this.__yN.getItemSizes(bM,bH+bS.offset);
...
var bW=0;
var bN=0;
}this.__yS={top:bX,bottom:bU,left:bW,right:bN};
this.__yU.setUserBounds(this.__yS.left-this.__yP,this.__yS.top-this.__yO,bR,bP);
this.__yX=bL;
this.__yY=bV;
this.DEBUG&&qx.ui.core.queue.Manager.flush();

for(var i=0;i<this.__yV.length;i++){var bT=new Date();
var bK=this.__yV[i];
...
}}},__zb:function(){if(this.__yW){return;
}var bY=this.getScrollSize();

if(this.__yQ!==bY.height||this.__yR!==bY.width){this.__yQ=bY.height;
this.__yR=bY.width;
this.fireEvent(g);
}},fullUpdate:function(){this.__yT._fullUpdate=1;
qx.ui.core.queue.Widget.add(this);
},isUpdatePending:function(){return !!this.__yT._fullUpdate;
},_fullUpdate:function(){var ca=this.getVisibleLayers();

if(ca.length==0){this.__zb();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var cb=this.getBounds();
this.DEBUG&&console.log(d);
this._setLayerWindow(ca,this.__yP,this.__yO,cb.width,cb.height,true);
this.__zb();
},_deferredUpdateScrollPosition:function(){this.__yT._updateScrollPosition=1;
qx.ui.core.queue.Widget.add(this);
},_updateScrollPosition:function(){var cc=this.getVisibleLayers();

if(cc.length==0){this.__zb();
return;
}var ce=this.getBounds();

if(!ce){return ;
}var cd={top:this.__yO,bottom:this.__yO+ce.height,left:this.__yP,right:this.__yP+ce.width};

if(this.__yS.top<=cd.top&&this.__yS.bottom>=cd.bottom&&this.__yS.left<=cd.left&&this.__yS.right>=cd.right){this.DEBUG&&console.log(m);
this.__yU.setUserBounds(this.__yS.left-cd.left,this.__yS.top-cd.top,this.__yS.right-this.__yS.left,this.__yS.bottom-this.__yS.top);
}else{this.DEBUG&&console.log(A);
this._setLayerWindow(cc,this.__yP,this.__yO,ce.width,ce.height,false);
}this.__zb();
}},destruct:function(){this._disposeArray(u);
this._disposeObjects(w,c,b);
this.__yS=this.__yT=this.__yX=this.__yY=null;
}});
})();
...
this.__zX={};
},properties:{anonymous:{refine:true,init:true}},members:{__zX:null,__zY:null,__Aa:null,__Ab:null,__Ac:null,__Ad:null,getFirstRow:function(){return this.__Aa;
},getFirstColumn:function(){return this.__Ab;
},getRowSizes:function(){return this.__Ac||[];
},getColumnSizes:function(){return this.__Ad||[];
},syncWidget:function(){if(!this.getContentElement().getDomElement()){return;
}
if(this.__zX.fullUpdate||this.__zX.updateLayerWindow&&this.__zX.updateLayerData){this._fullUpdate.apply(this,this.__zY);
}else if(this.__zX.updateLayerWindow){this._updateLayerWindow.apply(this,this.__zY);
}else if(this.__zX.updateLayerData&&this.__Ac){this._updateLayerData();
}
if(this.__zX.fullUpdate||this.__zX.updateLayerWindow){var c=this.__zY;
this.__Aa=c[0];
this.__Ab=c[1];
this.__Ac=c[2];
this.__Ad=c[3];
}this.__zX={};
},_updateLayerData:function(){this._fullUpdate(this.__Aa,this.__Ab,this.__Ac,this.__Ad);
...
},updateLayerData:function(){this.__zX.updateLayerData=true;
qx.ui.core.queue.Widget.add(this);
},fullUpdate:function(l,m,n,o){this.__zY=arguments;
this.__zX.fullUpdate=true;
qx.ui.core.queue.Widget.add(this);
},updateLayerWindow:function(p,q,r,s){this.__zY=arguments;
this.__zX.updateLayerWindow=true;
qx.ui.core.queue.Widget.add(this);
}},destruct:function(){this.__zX=this.__zY=this.__Ac=this.__Ad=null;
}});
})();
...
this.__Ae=[];
},properties:{anonymous:{refine:true,init:false}},members:{__Ae:null,getRenderedCellWidget:function(f,g){var h=this.getColumnSizes().length;
...
}},_getSpacer:function(){var o=this.__Ae.pop();
...
if(B.getUserData(d)){this.__Ae.push(B);
...
if(T.getUserData(d)){this.__Ae.push(T);
...
}this._cellProvider=this.__Ae=null;
}});
})();
...
(function(){var j="_applyInterval",i="appear",h="interval",g="__IG",f="qx.ui.virtual.behavior.Prefetch",e="_applyScroller",d="qx.ui.virtual.core.Scroller",c="scrollbar-x",b="Integer",a="scrollbar-y";
qx.Class.define(f,{extend:qx.core.Object,construct:function(k,l){{};
...
this.__IG=new qx.event.Timer(this.getInterval());
this.__IG.addListener(h,this._onInterval,this);

if(k){this.setScroller(k);
}},properties:{scroller:{check:d,nullable:true,init:null,apply:e},interval:{check:b,init:200,apply:j}},members:{__IH:null,__II:null,__IG:null,__IJ:null,__IK:null,setPrefetchX:function(m,n,o,p){this.__IH=[m,n,o,p];
},setPrefetchY:function(q,r,s,t){this.__II=[q,r,s,t];
},_onInterval:function(){var u=this.__IH;
...
qx.ui.core.queue.Manager.flush();
}},_applyScroller:function(w,x){if(x){if(this.__IJ){x.getChildControl(c).removeListenerById(this.__IJ);
}
if(this.__IK){x.getChildControl(a).removeListenerById(this.__IK);
}}
if(w){if(!w.getContainerElement().getDomElement()){this.__IG.stop();
w.addListenerOnce(i,this.__IG.start,this.__IG);
}else{this.__IG.restart();
}this.__IJ=w.getChildControl("scrollbar-x").addListener("scroll",this.__IG.restart,this.__IG);
this.__IK=w.getChildControl("scrollbar-y").addListener("scroll",this.__IG.restart,this.__IG);
}else{this.__IG.stop();
}},_applyInterval:function(y,z){this.__IG.setInterval(y);
}},destruct:function(){this.setScroller(null);
this.__IH=this.__II=null;
...
qx.Class.define(a,{extend:qx.core.Object,construct:function(j,k,l){qx.core.Object.call(this);
