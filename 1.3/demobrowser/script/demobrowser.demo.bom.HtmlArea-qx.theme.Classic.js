...
(function(){var ca="0px",bY="outline",bX="mshtml",bW="hideFocus",bV="none",bU="true",bT="qx.client",bS="div",bR="16px",bQ="840px",bv="left",bu="<tr>",bt="<option value=''></option>",bs="1px solid #AAA",br="'>",bq="value='",bp="#",bo="</option>",bn="qooxdoo logo",bm="change",ch="select",ci="</tr>",cf="",cg="clear:both",cd="Insert Table",ce="Color (Hex): ",cb="Georgia",cc="<p>This low-level widget can be used separately at ",cj="http://",ck="BgColor (Hex): ",bJ="Indent More",bI="Change font family",bL="demobrowser/demo/icons/htmlarea/format-fill-color.png",bK="Align Right",bN="Format Italic",bM="qx/icon/Oxygen/16/actions/format-text-underline.png",bP="350px",bO='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bH="white",bG="buttons at the toolbar.</p>",a="demobrowser/demo/icons/htmlarea/format-list-ordered.png",b="qx/icon/Oxygen/16/actions/format-indent-more.png",c="Comic Sans MS",d="Tahoma",f="20px 20px",g="float",h="<h1>HtmlArea low-level widget</h1>",k="<td>First Row, First cell</td>",l="demobrowser/demo/icons/htmlarea/qooxdoo_logo.png",m="Align Left",co="qx/icon/Oxygen/16/actions/format-justify-center.png",cn="input",cm="Align Justify",cl="demobrowser/demo/icons/htmlarea/insert-text.png",cs="Insert Horizontal Ruler",cr="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",cq="demobrowser/demo/icons/htmlarea/format-list-unordered.png",cp="HTML Code:",cu="Set Text Background Color",ct="Insert Link",L="on",M="You can play around with this widget by hitting the ",J="<td>Second Row, First cell</td>",K="</tbody>",P="Set Text Color",Q="demobrowser/demo/icons/htmlarea/format-text-color.png",N="traditional web pages / single-page applications.<br/> ",O="demobrowser/demo/icons/htmlarea/insert-table.png",H="qx/icon/Oxygen/16/actions/edit-undo.png",I="qx/icon/Oxygen/16/actions/edit-clear.png",u="Arial Black",t="Impact",w="Change font size",v="Link: ",q="Redo Last Undo Step",p="Format Bold",s="off",r="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",o="br",n="marginRight",V="image",W="<option qxKeepFocus='on' qxSelectable='off'",X="click",Y="<option qxKeepFocus='on' qxSelectable='off' ",R="Remove Format",S="qx/icon/Oxygen/16/actions/insert-image.png",T="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",U="</table>",ba="<td>First Row, Second cell</td>",bb="Insert HTML Code",E="qx/icon/Oxygen/16/actions/insert-link.png",D="Insert Ordered List",C="demobrowser.demo.bom.HtmlArea",B="qx/icon/Oxygen/16/actions/format-justify-left.png",A="Courier",z="Courier New",y="4px",x="qx/icon/Oxygen/16/actions/format-justify-right.png",G="qx/icon/Oxygen/16/actions/format-text-bold.png",F="<td>Second Row, Second cell</td>",bc="Insert Image",bd="qx/icon/Oxygen/16/actions/format-indent-less.png",be="<tbody>",bf="Times New Roman",bg="Align Center",bh="qx/icon/Oxygen/16/actions/edit-redo.png",bi="Lucida Console",bj="innerHTML",bk="Undo Last Change",bl="qx/icon/Oxygen/16/actions/format-text-italic.png",bz="Arial",by="qx/icon/Oxygen/16/actions/format-justify-fill.png",bx="Verdana",bw="Indent Less",bD="Format Strikethrough",bC="Format Underline",bB="<table border='1'>",bA="Inserted Unordered List",bF="FontSize: ",bE="It is the foundation for the UI widget component.</p>";
qx.Class.define(C,{extend:qx.application.Native,members:{__OV:null,__OW:null,__OX:null,__OY:null,__Pa:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__OV=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__OV,{margin:f});
var cx=qx.bom.Element.create(bS);
qx.bom.element.Style.setStyles(cx,{width:bQ,padding:ca,margin:ca});
var cw=h+cc+N+bE+T+M+bG;
qx.bom.element.Attribute.set(cx,bj,cw);
this.__OW=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__OW,{width:bQ,padding:ca,margin:ca,lineHeight:ca,border:bs});
this.__OX=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__OX,{width:bQ,height:bP,border:bs,borderTop:ca,backgroundColor:bH});
qx.dom.Element.insertEnd(this.__OX,this.__OV);
var cv=bO;
this.__OY=new qx.bom.htmlarea.HtmlArea(this.__OX,cv,null,"blank.html");
this.__Pk();
qx.dom.Element.insertBegin(this.__OW,this.__OV);
qx.dom.Element.insertBegin(cx,this.__OV);
qx.dom.Element.insertBegin(this.__OV,document.body);
},__Pb:function(e){var cy=window.prompt(bF,cf);
this.setFontSize(parseInt(cy));
},__Pc:function(e){var cz=window.prompt(ce,bp);
this.setTextColor(cz);
},__Pd:function(e){var cA=window.prompt(ck,bp);
this.setTextBackgroundColor(cA);
},__Pe:function(e){var cB={src:qx.util.ResourceManager.getInstance().toUri(l),border:0,title:bn,alt:bn};
this.insertImage(cB);
},__Pf:function(e){var cC=bB+be+bu+k+ba+ci+bu+J+F+ci+K+U;
this.insertHtml(cC);
},__Pg:function(e){var cD=window.prompt(v,cj);
this.insertHyperLink(cD);
},__Ph:function(e){var cE=window.prompt(cp,cf);
this.insertHtml(cE);
},__Pi:function(){var cG=qx.bom.Element.create(bS);
qx.bom.element.Style.setStyles(cG,{"float":bv});
var cI;
var cH=qx.bom.Element.create(ch,{title:bI});

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cH,bW,bU);
}else{qx.bom.element.Style.set(cH,bY,bV);
}cI=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cI[0],cH);
var cJ=[d,bx,bf,bz,u,z,A,cb,t,c,bi];
var cF;
var cK;

for(var i=0,j=cJ.length;i<j;i++){cF=W+bq+cJ[i]+br+cJ[i]+bo;
cK=qx.bom.Collection.html(cF);

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cK[0],bW,bU);
}else{qx.bom.element.Style.set(cK[0],bY,bV);
}qx.dom.Element.insertEnd(cK[0],cH);
}qx.event.Registration.addListener(cH,bm,function(e){var cL=e.getTarget();
var cM=cL.selectedIndex;

if(cM!=0){this.setFontFamily(cL.options[cM].value);
cL.options[0].selected=true;
}},this.__OY);
qx.dom.Element.insertBegin(cH,cG);
return cG;
},__Pj:function(){var cO=qx.bom.Element.create(bS);
qx.bom.element.Style.setStyles(cO,{"marginRight":bR,"float":bv});
var cQ;
var cP=qx.bom.Element.create(ch,{title:w});

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cP,bW,bU);
}else{qx.bom.element.Style.set(cP,bY,bV);
}cQ=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cQ[0],cP);
var cR;
var cN;

for(var i=1;i<=7;i++){cN=Y+bq+i+br+i+bo;
cR=qx.bom.Collection.html(cN);

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cR[0],bW,bU);
}else{qx.bom.element.Style.set(cR[0],bY,bV);
}qx.dom.Element.insertEnd(cR[0],cP);
}qx.event.Registration.addListener(cP,bm,function(e){var cS=e.getTarget();
var cT=cS.selectedIndex;

if(cT!=0){this.setFontSize(cS.options[cT].value);
cS.options[0].selected=true;
}},this.__OY);
qx.dom.Element.insertBegin(cP,cO);
return cO;
},__Pk:function(){var cV=[{bold:{text:p,image:G,action:this.__OY.setBold},italic:{text:bN,image:bl,action:this.__OY.setItalic},underline:{text:bC,image:bM,action:this.__OY.setUnderline},strikethrough:{text:bD,image:r,action:this.__OY.setStrikeThrough},removeFormat:{text:R,image:I,action:this.__OY.removeFormat}},{alignLeft:{text:m,image:B,action:this.__OY.setJustifyLeft},alignCenter:{text:bg,image:co,action:this.__OY.setJustifyCenter},alignRight:{text:bK,image:x,action:this.__OY.setJustifyRight},alignJustify:{text:cm,image:by,action:this.__OY.setJustifyFull}},{fontFamily:{custom:this.__Pi},fontSize:{custom:this.__Pj},fontColor:{text:P,image:Q,action:this.__Pc},textBackgroundColor:{text:cu,image:bL,action:this.__Pd}},{indent:{text:bJ,image:b,action:this.__OY.insertIndent},outdent:{text:bw,image:bd,action:this.__OY.insertOutdent}},{insertImage:{text:bc,image:S,action:this.__Pe},insertTable:{text:cd,image:O,action:this.__Pf},insertLink:{text:ct,image:E,action:this.__Pg},insertHTML:{text:bb,image:cl,action:this.__Ph},insertHR:{text:cs,image:cr,action:this.__OY.insertHorizontalRuler}},{ol:{text:D,image:a,action:this.__OY.insertOrderedList},ul:{text:bA,image:cq,action:this.__OY.insertUnorderedList}},{undo:{text:bk,image:H,action:this.__OY.undo},redo:{text:q,image:bh,action:this.__OY.redo}}];
var cX,dc,cU,da;

for(var i=0,j=cV.length;i<j;i++){dc={};
dc[n]=i==j-1?ca:bR;
dc[g]=bv;
cX=qx.bom.Element.create(bS);
qx.bom.element.Style.setStyles(cX,dc);

for(var cY in cV[i]){var db=cV[i][cY];

if(db.custom){cU=db.custom.call(this);
}else{var cW=qx.util.AliasManager.getInstance().resolve(db.image);
da={type:V,src:qx.util.ResourceManager.getInstance().toUri(cW),title:db.text,qxKeepFocus:L,qxSelectable:s};
cU=qx.bom.Element.create(cn,da);
qx.bom.element.Style.setStyles(cU,{width:bR,height:bR,padding:y});

if(qx.core.Variant.isSet(bT,bX)){qx.bom.element.Attribute.set(cU,bW,bU);
}else{qx.bom.element.Style.set(cU,bY,bV);
}qx.event.Registration.addListener(cU,X,db.action,this.__OY);
}qx.dom.Element.insertEnd(cU,cX);
}qx.dom.Element.insertEnd(cX,this.__OW);
}qx.dom.Element.insertEnd(qx.bom.Element.create(o,{style:cg}),this.__OW);
}}});
})();
