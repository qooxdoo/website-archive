...
var B=this.__NT();
var A=new qx.ui.form.Button(j).set({allowGrowX:false,allowGrowY:false});
...
H.bind(w,F,q);
H.bind(w,C,w,{converter:function(N){return c+N+k;
}});
},_toggle:function(){var O=this.__NS.getOrientation();
this.__NS.setOrientation(O==v?g:v);
...
this._container2.show();
}},__NT:function(){var ba=new qx.ui.tree.Tree();
...
bf.add(be);
return ba;
}},destruct:function(){this._disposeObjects(m,l,h);
}});
})();
