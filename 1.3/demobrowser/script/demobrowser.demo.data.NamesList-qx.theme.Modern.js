...
(function(){var p="persons.json</a> and bind the items to the list widget. In the ",o="converter for the label, the names will be set to both, the first ",n="model.persons",m="Loading...",l="' target='_blank'>",k="model",j="no model...",i="state",h="and last name.",g="value",c="demobrowser.demo.data.NamesList",f="firstname",e="<b>List bound to data in a json file</b><br/>",b="json/persons.json",a=", ",d="Loading the json file <a href='";
...
t.setLabelPath(f);
t.setLabelOptions({converter:function(v,w){return w?w.getLastname()+a+v:j;
}});
var r=b;
