...
}},properties:{appearance:{refine:true,init:f}},events:{complete:c,change:a},members:{__Jh:0,__Ji:100,getValue:function(){return this.__Jh;
...
this.__Jj(l/m);
return l;
},getMaximum:function(){return this.__Ji;
...
},__Jj:function(t){var v=this.getChildControl(i);
...
this.__HS=X;
this.__HT=X.childNodes[1];
this.__HU=X.childNodes[2].firstChild;
this.__Ia();
qx.log.Logger.register(this);
qx.core.ObjectRegistry.register(this);
},dispose:function(){qx.event.Registration.removeListener(document.documentElement,h,this.__Ib,this);
qx.log.Logger.unregister(this);
},clear:function(){this.__HT.innerHTML=k;
},process:function(bb){this.__HT.appendChild(qx.log.appender.Util.toHtml(bb));
this.__HV();
},__HV:function(){this.__HT.scrollTop=this.__HT.scrollHeight;
},__HW:true,toggle:function(){if(!this.__HS){this.init();
}else if(this.__HS.style.display==i){this.show();
}else{this.__HS.style.display=i;
}},show:function(){if(!this.__HS){this.init();
}else{this.__HS.style.display=K;
this.__HT.scrollTop=this.__HT.scrollHeight;
}},__HX:[],execute:function(){var be=this.__HU.value;
...
bc.className=V;
this.__HX.push(be);
this.__HY=this.__HX.length;
this.__HT.appendChild(bc);
this.__HV();
...
}},__Ia:function(e){this.__HT.style.height=(this.__HS.clientHeight-this.__HS.firstChild.offsetHeight-this.__HS.lastChild.offsetHeight)+d;
},__Ib:function(e){var bh=e.getKeyIdentifier();
if((bh==H)||(bh==p&&e.isCtrlPressed())){this.toggle();
e.preventDefault();
}if(!this.__HS){return;
}if(!qx.dom.Hierarchy.contains(this.__HS,e.getTarget())){return;
}if(bh==f&&this.__HU.value!=k){this.execute();
this.__HU.value=k;
}if(bh==T||bh==E){this.__HY+=bh=="Up"?-1:1;
this.__HY=Math.min(Math.max(0,this.__HY),this.__HX.length);
var bg=this.__HX[this.__HY];
this.__HU.value=bg||k;
this.__HU.select();
}}},defer:function(bi){qx.event.Registration.addListener(document.documentElement,h,bi.__Ib,bi);
}});
})();
