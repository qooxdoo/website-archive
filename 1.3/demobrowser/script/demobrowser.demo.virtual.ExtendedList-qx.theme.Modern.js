...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.virtual.ExtendedList","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.ExtendedList-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7678ea104123"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
var J=[n,v,t,g,u,p,s,d];
var D=[y,f,a,c,z,m];
var H=[];

for(var i=0;i<20;i++){var F=new demobrowser.demo.data.model.Person();
F.setName(J[i%J.length]);
F.setEmote(D[i%D.length]);
F.setOnline(i%3==0);
H.push(F);
}var I=new qx.data.Array(H);
var C=new qx.ui.list.List();
C.setWidth(150);
this.getRoot().add(C,{left:10,top:80});
var B={configureItem:function(K){K.setPadding(3);
...
A.addListener(k,function(){for(var i=0;i<I.length;i++){I.getItem(i).toggleOnline();
}},this);
var G=new qx.ui.form.Button(w);
G.setWidth(120);
this.getRoot().add(G,{left:180,top:115});
G.addListener(k,function(){qx.log.appender.Console.show();
