...
(function(){var cb="execute",ca="changeValue",bY="icon/16/actions/edit-cut.png",bX="changeSelection",bW="icon/16/actions/edit-paste.png",bV="Copy",bU="Paste",bT="icon/16/actions/edit-copy.png",bS="Cut",bR="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",ci="Print",cj="Open",cg="icon/16/actions/document-new.png",ch="Online Forum",ce="icon/16/actions/format-justify-fill.png",cf="Search in files",cc="C",cd="Left aligned",ck="Perl",cl="View",bK="C Dialect",bJ="Info...",bM="Save as...",bL="Show line numbers",bO="Quickstart",bN="icon/16/actions/contact-new.png",bQ="Ctrl+N",bP="Actions",bI="Show console",bH="Search",a="Help",b="Show status bar",c="icon/16/actions/format-justify-left.png",d="ANSI to OEM",f="Centered",g="Website 3",h="__NG",j="Edit",k="__Nz",l="icon/16/actions/format-justify-center.png",cp="__NA",co="icon/16/actions/go-previous.png",cn="C Sharp",cm="Close",ct="Website 2",cs="icon/16/actions/document-save-as.png",cr="Python",cq="icon/16/apps/utilities-help.png",cv="Show tree",cu="__ND",K="Options",L="Spaces to tabs",I="Right aligned",J="Action 1",O="OEM to ANSI",P="Line 431",M="JavaScript",N="icon",G="Action 2",H="Folder ",t="XML",s="Line 313",v="Paragraph",u="demobrowser.demo.widget.Menu",p="icon/16/actions/application-exit.png",o="C Plus Plus",r="Line 26",q="Item ",n="__NE",m="ASCII table",U="Option 1",V="Search next...",W="Line 12",X="Action 3",Q="Replace in files",R="Uppercase",S="Topics",T="Panes",Y="Justified",ba="__NB",D="__NF",C="Show macros",B="Search previous...",A="Back",z="main",y="__NC",x="icon/16/actions/format-justify-right.png",w="icon/16/actions/go-next.png",F="command ",E="Option 3",bb="Next",bc="Show tags",bd="Capitals",be="Format",bf="File",bg="Show tabs",bh="Split Button",bi="Tabs to spaces",bj="Search...",bk="Line 1039",by="Option 2",bx="Objective C",bw="Exit",bv="move to",bC="Syntax",bB="Show ruler",bA="Website 1",bz="Menu Button",bE="Line 30",bD="Lowercase",bF="Replace",bG="HTML";
qx.Class.define(u,{extend:qx.application.Standalone,members:{__Nz:null,__NA:null,__NB:null,__NC:null,__ND:null,__NE:null,__NF:null,__NG:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
for(var i=0;i<30;i++){cz.add(new qx.ui.menu.Button(H+(i+1)));
}cy.add(new qx.ui.menu.Button(bv,null,null,cz));
cy.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cy.add(new qx.ui.menu.Button(F+(i+1)));
}return cy;
...
},createCommands:function(){this.__Nz=new qx.ui.core.Command(bQ);
this.__Nz.addListener(cb,this.debugCommand);
this.__NA=new qx.ui.core.Command("Ctrl+O");
this.__NA.addListener(cb,this.debugCommand);
this.__NB=new qx.ui.core.Command("Ctrl+S");
this.__NB.addListener(cb,this.debugCommand);
this.__NC=new qx.ui.core.Command("Ctrl+Z");
this.__NC.addListener(cb,this.debugCommand);
this.__ND=new qx.ui.core.Command("Ctrl+R");
this.__ND.addListener(cb,this.debugCommand);
this.__NE=new qx.ui.core.Command("Ctrl+X");
this.__NE.addListener(cb,this.debugCommand);
this.__NF=new qx.ui.core.Command("Ctrl+C");
this.__NF.addListener(cb,this.debugCommand);
this.__NG=new qx.ui.core.Command("Ctrl+P");
this.__NG.addListener(cb,this.debugCommand);
this.__NG.setEnabled(false);
},getMenuButton:function(){var cA=new qx.ui.menu.Menu;
cA.add(new qx.ui.menu.RadioButton(U));
cA.add(new qx.ui.menu.RadioButton(by));
cA.add(new qx.ui.menu.RadioButton(E));
var cI=new qx.ui.menu.Menu;
cI.add(new qx.ui.menu.RadioButton(J));
cI.add(new qx.ui.menu.RadioButton(G));
cI.add(new qx.ui.menu.RadioButton(X));
...
var cG=new qx.ui.menu.Button(bt,bn,this.__NC);
var cN=new qx.ui.menu.Button(br,bl,this.__ND);
var cC=new qx.ui.menu.Button(bS,bY,this.__NE);
var cK=new qx.ui.menu.Button(bV,bT,this.__NF);
var cE=new qx.ui.menu.Button(bU,bW,this.__NG);
var cB=new qx.ui.menu.Button(K,bR,null,cA);
var cL=new qx.ui.menu.Button(bP,bN,null,cI);
...
var cQ=new qx.ui.menu.Button(ct);
...
toolbar.addSpacer();
toolbar.add(db);
var dg=new qx.ui.toolbar.SplitButton(A,co,this.getBackMenu());
var dd=new qx.ui.toolbar.SplitButton(bb,w,this.getForwardMenu());
var cV=new qx.ui.toolbar.Button(bu,cg,this.__Nz);
var da=new qx.ui.toolbar.Button(cj,bo,this.__NA);
var df=new qx.ui.toolbar.Button(bm,bs,this.__NB);
...
var cU=new qx.ui.toolbar.MenuButton(j);
...
var dl=new qx.ui.menu.Button(s);
var dn=new qx.ui.menu.Button(bk);
var dj=new qx.ui.menu.Button(W);
...
var dq=new qx.ui.menu.Button(P);
...
var ds=new qx.ui.menu.Button(bu,cg,this.__Nz);
var dw=new qx.ui.menu.Button(cj,bo,this.__NA);
var dv=new qx.ui.menu.Button(cm);
var dz=new qx.ui.menu.Button(bm,bs,this.__NB);
var dy=new qx.ui.menu.Button(bM,cs);
var dx=new qx.ui.menu.Button(ci,bp);
var dt=new qx.ui.menu.Button(bw,p);
...
var dE=new qx.ui.menu.Button(bt,bn,this.__NC);
var dD=new qx.ui.menu.Button(br,bl,this.__ND);
var dA=new qx.ui.menu.Button(bS,bY,this.__NE);
var dF=new qx.ui.menu.Button(bV,bT,this.__NF);
var dC=new qx.ui.menu.Button(bU,bW,this.__NG);
...
var dP=new qx.ui.menu.Button(T,null,null,this.getPanesMenu());
...
var dO=new qx.ui.menu.Button(m);
...
var ea=new qx.ui.menu.CheckBox(cv);
var dV=new qx.ui.menu.CheckBox(C);
...
var en=new qx.ui.menu.RadioButton(cn);
...
var eq=new qx.ui.menu.Button(v,null,null,this.getParagraphMenu());
var et=new qx.ui.menu.Button(bi);
var eu=new qx.ui.menu.Button(L);
var ep=new qx.ui.menu.Button(R);
var es=new qx.ui.menu.Button(bD);
var eo=new qx.ui.menu.Button(bd);
var ew=new qx.ui.menu.Button(O);
...
var eB=new qx.ui.menu.Button(I,x);
var ey=new qx.ui.menu.Button(f,l);
var ez=new qx.ui.menu.Button(Y,ce);
...
var eE=new qx.ui.menu.Button(S,cq);
...
for(var i=0;i<20;i++){eH.add(new qx.ui.form.ListItem(q+i));
}return eH;
},getContextMenu:function(){var eI=new qx.ui.menu.Menu;
var eK=new qx.ui.menu.Button(bS,bY,this.__NE);
var eL=new qx.ui.menu.Button(bV,bT,this.__NF);
var eJ=new qx.ui.menu.Button(bU,bW,this.__NG);
...
eI.add(eJ);
return eI;
}},destruct:function(){this._disposeObjects(k,cp,ba,y,cu,n,D,h);
}});
})();
