...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Window_Editor-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"0187cf65c3c9"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
A.moveTo(300,250);
A.addListener(c,function(e){A.__Ot.focus();
A.__Ot.setTextSelection(0,A.__Ot.getValue().length);
});
A.__Ot=new qx.ui.form.TextField(x.value+j).set({allowGrowY:true});
A.add(A.__Ot);
...
return A;
},getCellEditorValue:function(B){return parseFloat(B.__Ot.getValue());
}}});
})();
