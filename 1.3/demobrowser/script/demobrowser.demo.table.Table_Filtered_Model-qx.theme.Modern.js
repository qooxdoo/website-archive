...
},members:{__Ay:null,__Ax:null,_js_in_array:function(q,r){var s=r.toString();
...
if(!this.__Ax){this.__Ay=Y.slice(0);
this.__Ax=true;
}
if(W==null||W<1){W=1;
}
...
}},resetHiddenRows:function(){if(!this.__Ay){return ;
}this.Filters=[];
this.setData(qx.lang.Array.clone(this.__Ay));
},setData:function(bb,bc){this.__Ay=qx.lang.Array.clone(bb);
this.Filters=[];
qx.ui.table.model.Simple.prototype.setData.call(this,bb,bc);
}},destruct:function(){this.__Ay=this.numericAllowed=this.betweenAllowed=this.Filters=null;
}});
})();
