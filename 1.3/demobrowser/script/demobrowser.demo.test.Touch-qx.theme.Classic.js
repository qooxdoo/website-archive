...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.test.Touch","qx.theme":"qx.theme.Classic"};
...
(function(){var l="px",k="div",j="innerHTML",h="absolute",g="12px",f="Arial",d="90px",c="green",b="55px",a="touchmove",H="Two",G="<b>Cancel Touch</b>",F="touchend",E="30px",D="blue",C="qx.mobile.emulatetouch",B='Lucida Grande',A="</b>",z="off",w="touchstart",s="__infoArea",t="demobrowser.demo.test.Touch",q="9px",r="click",o="20px",p="red",m="touchcancel",n="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",u="One",v="<b>Touch me:<br>";
qx.Class.define(t,{extend:qx.application.Native,members:{__Ne:null,__Nf:null,main:function(){qx.application.Native.prototype.main.call(this);
{};
var J=new qx.html.Element(k);
J.useElement(document.body);
J.setRoot(true);

if(!qx.bom.client.Engine.WEBKIT||(!qx.bom.client.Feature.TOUCH&&qx.core.Variant.isSet(C,z))){var I={"color":c,"position":h,"font-family":B,"font-size":g,"left":E,"top":o};
var K=new qx.html.Element(k,I);
J.add(K);
K.setAttribute(j,n);
return;
}J.add(this.__Ng(10,10,c,u));
J.add(this.__Ng(110,10,D,H));
this.__Ne=this.__Nh(10,110);
J.add(this.__Ne);
this.__Nf=this.__Nh(110,110);
J.add(this.__Nf);
J.add(this.__Ni(210,10));
},__Ng:function(x,y,L,M){var N={"position":h,"left":x+l,"top":y+l,"width":d,"height":d,"backgroundColor":L,"fontFamily":f,"fontSize":g};
var O=new qx.html.Element(k,N,{"id":M});
O.setAttribute(j,v+M+A);
O.addListener(w,this.__Nj,this);
O.addListener(a,this.__Nj,this);
O.addListener(F,this.__Nj,this);
O.addListener(m,this.__Nj,this);
return O;
},__Nh:function(x,y){var P={"position":h,"left":x+l,"top":y+l,"width":d,"fontFamily":f,"fontSize":q};
return new qx.html.Element(k,P);
},__Ni:function(x,y){var Q={"position":h,"left":x+l,"top":y+l,"width":b,"height":b,"backgroundColor":p,"fontFamily":f,"fontSize":g};
var R=new qx.html.Element(k,Q);
R.setAttribute(j,G);
R.addListener(r,function(){window.setTimeout(function(){alert("Touch canceled");
},0);
},this);
return R;
},__Nj:function(e){var S=[];
S.push("Type: "+e.getType());
S.push("==============");
S.push("Is Multi-Touch: "+e.isMultiTouch());
S.push("All Touches: "+e.getAllTouches().length);
S.push("Target Touches: "+e.getTargetTouches().length);
S.push("Changed Target Touches: "+e.getChangedTargetTouches().length);
S.push("==============");
S.push("Document: Left = "+e.getDocumentLeft()+" / Top = "+e.getDocumentTop());
S.push("Screen: Left = "+e.getScreenLeft()+" / Top = "+e.getScreenTop());
S.push("Viewport: Left = "+e.getViewportLeft()+" / Top = "+e.getViewportTop());
S.push("Identifier: "+e.getIdentifier());
var U=e.getTarget();
var T=false;
var W=e.getTargetTouches().length>0?e.getTargetTouches():e.getChangedTargetTouches();

for(var i=0;i<W.length;i++){T=W[0].target==U;

if(!T){break;
}}S.push("Are all touch targets div "+U.id+":"+T);
var V=this[s+U.id];

if(V){V.setAttribute(j,S.join("<br>"));
}}}});
})();
