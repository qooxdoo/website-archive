...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.root.Inline_Dynamic_Resize","qx.theme":"qx.theme.Classic"};
for (var k in settings) qxsettings[k] = settings[k];

if (!window.qxvariants) qxvariants = {};
var variants = {"qx.aspects":"off","qx.debug":"off","qx.root":"on"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.root.Inline_Dynamic_Resize-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"49d2e49deba8"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
