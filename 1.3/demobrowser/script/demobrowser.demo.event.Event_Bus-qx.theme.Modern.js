...
}},_initLogger:function(n,o,p){this.__Nk=e+n.join(h)+k;
this.__Nl=p||50;
this.__Nm=o;
this._clearLog();
},_clearLog:function(){this.__Nm.innerHTML=this.__Nk+l;
this.__Nn=[];
},_log:function(q){this.__Nn.unshift(q);
this.__Nn=this.__Nn.slice(0,this.__Nl);
var r=[this.__Nk];

for(var i=0;i<this.__Nn.length;i++){r.push(d,this.__Nn[i].join(f),a);
}r.push(l);
this.__Nm.innerHTML=r.join(g);
this.__Nm.scrollTop=0;
},__Nk:null,__Nl:null,__Nm:null,__Nn:null},destruct:function(){this.__Nm=this.__Nn=null;
}});
})();
...
}},construct:function(){this.__yl={};
},members:{__yl:null,getSubscriptions:function(){return this.__yl;
...
if(J>-1){if(J===0||I.substr(0,J)===F.substr(0,J)){this.__ym(H[I],E);
G=true;
}}else{if(I===F){this.__ym(H[F],E);
G=true;
}}}return G;
},dispatchByName:function(name,K){var L=new qx.event.message.Message(name,K);
return this.dispatch(L);
},__ym:function(M,N){for(var i=0;i<M.length;i++){var O=M[i].subscriber;
var P=M[i].context;
