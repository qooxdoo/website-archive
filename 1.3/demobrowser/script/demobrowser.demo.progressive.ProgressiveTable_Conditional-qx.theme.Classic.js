...
this.__Ik=v||s;
this.__Il=w||s;
},members:{__If:null,__Ig:null,__Ih:null,__Ii:null,__Ij:null,__Ik:null,__Il:null,__Im:function(x,y){if(x.align){y[h]=x.align;
}
...
}},addNumericCondition:function(z,A,B,C,D,E,F){if(!qx.lang.Array.contains(this.__If,z)||A==null){throw new Error("Condition not recognized or value is null!");
}this.__Ih.push({condition:z,align:B,color:C,style:D,weight:E,value1:A,target:F});
},addBetweenCondition:function(G,H,I,J,K,L,M,N){if(!qx.lang.Array.contains(this.__Ig,G)||H==null||I==null){throw new Error("Condition not recognized or value1/value2 is null!");
}this.__Ih.push({condition:G,align:J,color:K,style:L,weight:M,value1:H,value2:I,target:N});
},addRegex:function(O,P,Q,R,S,T){if(!O){throw new Error("regex cannot be null!");
}this.__Ih.push({condition:o,align:P,color:Q,style:R,weight:S,regex:O,target:T});
},_getCellStyle:function(U){if(this.__Ih.length==0){return U.style||s;
}var i;
var Y;
var V;
var X={"text-align":this.__Ii,"color":this.__Ij,"font-style":this.__Ik,"font-weight":this.__Il};

for(i=0;i<this.__Ih.length;i++){var bc=this.__Ih[i];
Y=false;

if(qx.lang.Array.contains(this.__If,bc.condition)){if(bc.target==null){V=U.cellData;
...
}}else if(qx.lang.Array.contains(this.__Ig,bc.condition)){if(bc.target==null){V=U.cellData;
}else{V=U.element.data[bc.target];
}
