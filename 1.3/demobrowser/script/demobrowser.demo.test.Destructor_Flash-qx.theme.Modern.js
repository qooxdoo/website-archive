...
qx.Class.define(j,{extend:qx.application.Native,members:{__MR:null,__MS:0,main:function(){qx.application.Native.prototype.main.call(this);
this.__MR=[];
...
o.start();
},clear:function(){var p=this.__MR;
