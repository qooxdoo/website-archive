...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="One-shot 1-second timer: ",e="__MT",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__MT:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();
i.start(function(j,k){this.__MU(c+k);
},5000,this,null,0);
i.start(function(l,m){this.__MU(f+m);
},0,this,null,1000);
i.start(function(n,o){this.__MU(g+o);

if(++n.count==3){this.__MU(h);
i.stop(o);
}},2000,this,{count:0},2000);
},__MU:function(p){p=Date.parse(new Date)+" "+p+"\n";
this.__MT.setValue(this.__MT.getValue()+p);
