...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.bom.Viewport","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.bom.Viewport-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"743f4fc08bfe"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var b="click",a="demobrowser.demo.bom.Viewport";
qx.Class.define(a,{extend:qx.application.Native,members:{main:function(){qx.application.Native.prototype.main.call(this);
qx.bom.Element.addListener(document.body,b,function(){this.debug("Document Dimension: "+qx.bom.Document.getWidth()+"x"+qx.bom.Document.getHeight());
