...
qx.Class.define(C,{extend:qx.application.Standalone,members:{__Oa:null,messenger:null,__Ob:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var V=this.getRoot();
...
return be;
},showAddContactWindow:function(){if(this.__Oa==null){var bn=new qx.ui.layout.Grid(5,10);
...
this.__Oc=new demobrowser.demo.virtual.messenger.BuddyCell();
this.__Od=new demobrowser.demo.virtual.messenger.GroupCell();
this.__Od.addListener(h,this._onChangeOpenGroup,this);
this.__Oe=[];
this.__Of={};
this.__Og=[];
this.__Oh=new qx.util.DeferredCall(this._updateGrouping,this);
},members:{__Og:null,__Of:null,__Oh:null,__Oe:null,__Oc:null,__Od:null,_getRowData:function(m){return this.__Og[m];
},_getModelRow:function(n){return this.__Og.indexOf(n);
},_getRowCount:function(){return this.__Og.length;
},_isGroupHeader:function(o){return this.__Og[o] instanceof demobrowser.demo.virtual.messenger.GroupModel;
},_getGroupModel:function(name,p){var q=this.__Of[name];
...
return q;
},_onChangeOpenGroup:function(e){var r=this.__Og[e.getData().getUserData(c)];
r.toggleOpen();
this.__Oh.schedule();
},getCellRenderer:function(s){if(this._isGroupHeader(s)){return this.__Od;
}else{return this.__Oc;
}},isRowSelectable:function(t){return !this._isGroupHeader(t);
},_visualizeGrouping:function(u){var v=this.getTarget();

if(v){for(var i=0;i<this.__Oe.length;i++){var w=this.__Oe[i].getOldRow();
...
D=0;
var x=this._getGroupModel(z.getGroup(),this.__Og.length);
this.__Og.push(x);
y.push(x);
}
if(x.isOpen()){this.__Og.push(z);
...
}},properties:{name:{init:c,event:g,check:a},row:{event:d,check:j,apply:b},open:{check:h,init:true,event:i},itemCount:{check:j,init:0,event:e}},members:{__Oi:null,_applyRow:function(k,l){this.__Oi=l;
},getOldRow:function(){return this.__Oi;
}}});
})();
