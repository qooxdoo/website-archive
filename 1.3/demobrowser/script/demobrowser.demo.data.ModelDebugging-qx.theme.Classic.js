...
qx.Class.define(f,{extend:qx.data.store.Json,statics:{saveResult:function(t){this.__Ox=t;
...
w+=l;
x.load(w,function(y){this.__Oy();
},this);
},__Oy:function(){var z=demobrowser.demo.data.store.Twitter.__Ox;
