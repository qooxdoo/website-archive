...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.mobile.ScaleImage","qx.theme":"qx.theme.Classic"};
...
(function(){var u="div",t="50px",s="absolute",r="touchmove",q="touchend",p="demobrowser/demo/mobile/qooxdoo-logo.png",o="20px",n="30px",m=")",l='Lucida Grande',d="12px",k="innerHTML",h="qx.mobile.emulatetouch",c="green",b="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",g="demobrowser.demo.mobile.ScaleImage",f="url(",i="off",a="59px",j="200px";
qx.Class.define(g,{extend:qx.application.Native,members:{__PH:null,__PI:1,__PJ:0,__PK:0,__PL:0,main:function(){qx.application.Native.prototype.main.call(this);
{};
var x=new qx.html.Element(u);
x.useElement(document.body);
x.setRoot(true);

if(!qx.bom.client.Engine.WEBKIT||(!qx.bom.client.Feature.TOUCH&&qx.core.Variant.isSet(h,i))){var w={"color":c,"position":s,"font-family":l,"font-size":d,"left":n,"top":o};
var z=new qx.html.Element(u,w);
x.add(z);
z.setAttribute(k,b);
return;
}var y=qx.util.ResourceManager.getInstance().toUri(p);
var v={"width":j,"height":a,"position":s,"left":t,"top":t,"background":f+y+m};
this.__PH=new qx.html.Element("div",v);
this.__PH.addListener(r,this.__PM,this);
this.__PH.addListener(q,this.__PN,this);
x.add(this.__PH);
},__PM:function(e){if(e.isMultiTouch()){this.__PK=e.getRotation()+this.__PJ;
this.__PL=e.getScale()*this.__PI;
this.__PH.setStyle("-webkit-transform","rotate("+this.__PK+"deg) scale("+this.__PL+")");
}else{var A=parseInt(e.getDocumentLeft())-(parseInt(this.__PH.getStyle("width"))/2);
var top=parseInt(e.getDocumentTop())-(parseInt(this.__PH.getStyle("height"))/2);
this.__PH.setStyles({"left":A+"px","top":top+"px"});
}},__PN:function(e){if(e.isMultiTouch()){this.__PJ=this.__PK;
this.__PI=this.__PL;
}}}});
})();
