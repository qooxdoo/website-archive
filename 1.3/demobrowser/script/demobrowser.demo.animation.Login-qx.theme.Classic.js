...
(function(){var o="top",n="right",m="resize",l="Name",k="Password",j="__MF",h="appear",g="__MH",f="__MG",d="demobrowser.demo.animation.Login",a="50%",c="execute",b="30%";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__MF:null,__MG:null,__MH:null,checkInput:function(){this.__MF.start();
},__MI:function(){this.__MF=new qx.fx.effect.combination.Shake(this.__MG.getContainerElement().getDomElement());
...
this.__MG=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__MG.setLayout(q);
this.__MG.addListener(m,function(e){var u=this.__MG.getBounds();
this.__MG.set({marginTop:Math.round(-u.height/2),marginLeft:Math.round(-u.width/2)});
},this);
this.getRoot().add(this.__MG,{left:a,top:b});
var p=[l,k];

for(var i=0;i<p.length;i++){this.__MG.add(new qx.ui.basic.Label(p[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var r=new qx.ui.form.TextField();
var s=new qx.ui.form.PasswordField();
this.__MG.add(r.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__MG.add(s.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var t=this.__MH=new qx.ui.form.Button("Login");
t.setAllowStretchX(false);
this.__MG.add(t,{row:3,column:1});
t.addListener(c,this.checkInput,this);
this.__MG.addListener(h,this.__MI,this);
}},destruct:function(){this._disposeObjects(f,g,j);
}});
})();
