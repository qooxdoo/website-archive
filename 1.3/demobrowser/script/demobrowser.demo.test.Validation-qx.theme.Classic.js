...
qx.Class.define(p,{extend:qx.core.Object,properties:{name:{init:x,validate:z},age:{init:18,validate:qx.util.Validate.number()},gender:{init:g,validate:qx.util.Validate.inArray([g,f])}},members:{__MN:function(T){if(T.length<2){throw new qx.core.ValidationError("Validation Error: Name "+"must be longer than one characters. ("+T+")");
}}}});
})();
