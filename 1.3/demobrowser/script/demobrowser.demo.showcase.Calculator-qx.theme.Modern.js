...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.showcase.Calculator-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"8279a3aa1f9e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="execute",j="-",i="+",h="/",g="*",f="=",d=".",c="black",b="Del",a="sans-serif",G="C",F="5",E="7",D="demobrowser.demo.showcase.Calculator",C="CE",B="solid",A="icon/22/apps/utilities-calculator.png",z="3",y="0",x="n",r="8",s="__OJ",p="6",q="4",n="Calculator",o="2",l="Verdana",m="1",t="demobrowser.demo.showcase.CalculatorLogic",u="__OI",w="+/-",v="9";
qx.Class.define(D,{extend:qx.application.Standalone,members:{__OI:null,__OJ:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
this.__OJ=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var I=new qx.ui.window.Window(n,A);
I.setLayout(new qx.ui.layout.VBox(16));
var K=new qx.ui.decoration.Single(1,B,c);
var S=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var bd=new qx.ui.layout.Grid(5,5);
S.setLayout(bd);
this.__OI=new qx.ui.basic.Label(this.__OJ.getCurrentValue().toString()).set({decorator:K,backgroundColor:"white",allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:["Verdana","sans-serif"],bold:true}),textAlign:"right"});
this.__OI.setEnabled(false);
var be=new qx.bom.Font().set({size:14,family:[l,a],bold:true});
var X=new qx.ui.form.Button(y).set({font:be,minWidth:40});
var W=new qx.ui.form.Button(m).set({font:be,minWidth:40});
var V=new qx.ui.form.Button(o).set({font:be,minWidth:40});
var U=new qx.ui.form.Button(z).set({font:be,minWidth:40});
var bc=new qx.ui.form.Button(q).set({font:be,minWidth:40});
var bb=new qx.ui.form.Button(F).set({font:be,minWidth:40});
var ba=new qx.ui.form.Button(p).set({font:be,minWidth:40});
var Y=new qx.ui.form.Button(E).set({font:be,minWidth:40});
var bg=new qx.ui.form.Button(r).set({font:be,minWidth:40});
var bf=new qx.ui.form.Button(v).set({font:be,minWidth:40});
var H=new qx.ui.form.Button(G).set({font:be,minWidth:40});
var J=new qx.ui.form.Button(C).set({font:be,minWidth:40});
var O=new qx.ui.form.Button(b).set({font:be,minWidth:40});
var N=new qx.ui.form.Button(w).set({font:be,minWidth:40});
var Q=new qx.ui.form.Button(d).set({font:be,minWidth:40});
var M=new qx.ui.form.Button(i).set({font:be,minWidth:40});
var T=new qx.ui.form.Button(j).set({font:be,minWidth:40});
var R=new qx.ui.form.Button(g).set({font:be,minWidth:40});
var P=new qx.ui.form.Button(h).set({font:be,minWidth:40});
var L=new qx.ui.form.Button(f).set({font:be,minWidth:40});
...
bd.setRowFlex(5,1);
bd.setRowFlex(6,1);
S.add(this.__OI,{row:0,column:0,rowSpan:0,colSpan:4});
S.add(H,{row:1,column:2,rowSpan:1,colSpan:2});
S.add(J,{row:1,column:1});
S.add(O,{row:1,column:0});
S.add(Y,{row:2,column:0});
S.add(bg,{row:2,column:1});
S.add(bf,{row:2,column:2});
S.add(P,{row:2,column:3});
S.add(bc,{row:3,column:0});
S.add(bb,{row:3,column:1});
S.add(ba,{row:3,column:2});
S.add(R,{row:3,column:3});
S.add(W,{row:4,column:0});
S.add(V,{row:4,column:1});
S.add(U,{row:4,column:2});
S.add(T,{row:4,column:3});
S.add(X,{row:5,column:0});
S.add(N,{row:5,column:1});
S.add(Q,{row:5,column:2});
S.add(M,{row:5,column:3});
S.add(L,{row:6,column:0,rowSpan:1,colSpan:4});
I.setWidth(260);
I.setMinWidth(260);
I.setHeight(260);
I.open();
...
I.add(S,{flex:1});
H.addListener(k,function(e){this.__OJ.cleanDisplay();
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
J.addListener(k,function(e){this.__OJ.clearEntry();

if(this.__OJ.getResult()!=null){this.__OI.setValue(this.__OJ.getCurrentValue().toString());
}},this);
O.addListener(k,function(e){this.__OJ.deleteNumber();
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
N.addListener(k,function(e){this.__OJ.setSign();

if(this.__OJ.getResult()!=null){this.__OI.setValue(this.__OJ.getResult().toString());
}},this);
X.addListener(k,function(e){this.__OJ.setCurrentValue(0);
this.__OI.setValue(this.__OJ.getCurrentValue().toFixed(this.__OJ.getZeroCounter()).toString());
},this);
W.addListener(k,function(e){this.__OJ.setCurrentValue(1);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
V.addListener(k,function(e){this.__OJ.setCurrentValue(2);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
U.addListener(k,function(e){this.__OJ.setCurrentValue(3);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__OJ.setCurrentValue(4);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
bb.addListener(k,function(e){this.__OJ.setCurrentValue(5);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
ba.addListener(k,function(e){this.__OJ.setCurrentValue(6);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
Y.addListener(k,function(e){this.__OJ.setCurrentValue(7);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
bg.addListener(k,function(e){this.__OJ.setCurrentValue(8);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
bf.addListener(k,function(e){this.__OJ.setCurrentValue(9);
this.__OI.setValue(this.__OJ.getCurrentValue().toString());
},this);
M.addListener(k,function(e){this.__OJ.calculate(i);

if(this.__OJ.getResult()!=null){this.__OI.setValue(this.__OJ.getResult().toString());
}this.__OJ.resetCurrentValue();
},this);
T.addListener(k,function(e){this.__OJ.calculate(j);

if(this.__OJ.getResult()!=null){this.__OI.setValue(this.__OJ.getResult().toString());
}this.__OJ.resetCurrentValue();
},this);
R.addListener(k,function(e){this.__OJ.calculate(g);

if(this.__OJ.getResult()!=null){this.__OI.setValue(this.__OJ.getResult().toString());
}this.__OJ.resetCurrentValue();
},this);
P.addListener(k,function(e){this.__OJ.calculate(h);

if(this.__OJ.getResult()!=null){this.__OI.setValue(this.__OJ.getResult().toString());
}this.__OJ.resetCurrentValue();
},this);
L.addListener(k,function(e){this.__OJ.calculate(f);

if(this.__OJ.getResult()!=null){this.__OI.setValue(this.__OJ.getResult().toString());
}this.__OJ.resetCurrentValue();
},this);
Q.addListener(k,function(e){this.__OJ.setComma();
},this);
}},destruct:function(){this._disposeObjects(s,u);
}});
qx.Class.define(t,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__OK:0,__OL:0,__OM:"n",__ON:0,__OO:0,__OP:0,__OQ:false,__OR:1,__OS:0,__OT:false,__OU:0,setCurrentValue:function(bh){if(this.__OQ){this.__OR*=10;
this.__OK=this.__OK+(bh/this.__OR);

if(bh==0){this.__OS++;
}}else{this.__OQ=false;

if(this.__OK<0){this.__OK=this.__OK*10-bh;
}else{this.__OK=this.__OK*10+bh;
}}},getZeroCounter:function(){return this.__OS;
},setComma:function(){this.__OQ=true;
},getCurrentValue:function(){return this.__OK;
},resetCurrentValue:function(){this.__OK=null;
},cleanDisplay:function(){this.__OU=0;
this.__OO=0;
this.__OM="n";
this.__OS=0;
this.__OR=1;
...
this.__OL=0;
this.__OT=false;
},setResult:function(bi){this.__OL=bi;
},getResult:function(){return Math.round(this.__OL*10000000)/10000000;
},setCurrentOperation:function(bj){this.__OM=bj;
},getCurrentOperation:function(){return this.__OM;
},clearEntry:function(){this.__OT=false;
this.__OS=0;
this.__OR=1;
this.__OQ=false;
this.__OP++;
...
if(this.__OP<2){this.__OO=this.__OL;
}
if(this.__ON>=2){this.__OL=0;
this.__ON=0;
}},setSign:function(){this.__OU++;

if(this.__OU%2==0){this.__OT=false;
}else{this.__OT=true;
}
if(this.__OK==null){this.__OK=this.__OL;
}this.__OK=this.__OK*(-1);

if(this.__OL==0){this.__OL=this.__OK;
}
if(this.__OL!=0){this.__OO=this.__OL;
this.__OL=this.__OK;
}},deleteNumber:function(){var bk=false;
var bn=false;

if(this.__OK<0){this.__OK=this.__OK*(-1);
bn=true;
}
if(this.__OK!=null){if(this.__OK.toString().lastIndexOf(d)!=-1){this.__OK=this.__OK*this.__OR;
bk=true;
}}var bl=this.__OK%10;
var bm=bl/10;
this.__OK=this.__OK/10;
this.__OK=this.__OK-bm;

if(bk){this.__OR/=10;
this.__OK=this.__OK/(this.__OR);
bk=false;
}
if(bn){this.__OK=this.__OK*(-1);
bn=false;
}},calculate:function(bo){if(bo==i||bo==g||bo==h||bo==j||bo==f){this.__OQ=false;
this.__OR=1;
this.__OS=0;

if(this.__OM!=x){if(this.__OM==i){if(this.__OL==null){this.__OL=this.__OO;
}
if(this.__OT){this.__OL=this.__OO+this.__OK;
}else{this.__OL=this.__OL+this.__OK;
}this.__OK=this.__OL;
this.__OO=this.__OL;
}
if(this.__OM==j){if(this.__OL==0){this.__OL=this.__OK;
this.__OK=0;
}
if(this.__OL==null){this.__OL=this.__OO;
}
if(this.__OT){this.__OL=this.__OO-this.__OK;
}else{this.__OL=this.__OL-this.__OK;
}this.__OK=this.__OL;
...
if(this.__OM==h){if(this.__OL==0){this.__OL=this.__OK;
this.__OK=1;
}
if(this.__OL==null){this.__OL=this.__OO;
}
if(this.__OK!=null){if(this.__OK!=0){if(this.__OT){this.__OL=this.__OO/this.__OK;
}else{this.__OL=this.__OL/this.__OK;
}}else{alert("You can't divide by 0!");
}}this.__OK=this.__OL;
this.__OO=this.__OL;
}
if(this.__OM==g){if(this.__OL==0){this.__OL=1;
}
if(this.__OK==null){this.__OK=1;
}
if(this.__OL==null){this.__OL=this.__OO;
}
if(this.__OT){this.__OL=this.__OO*this.__OK;
...
this.__OO=this.__OL;
}}else{this.__OL=this.__OK;
}
if(bo!=f){this.__OM=bo;
}else{this.__ON++;
this.__OL=this.__OO;
this.__OM="n";
}this.__OT=false;
