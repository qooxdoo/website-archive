...
qx.Class.define(T,{extend:qx.application.Standalone,properties:{showMode:{init:bm,check:[bs,br,bm],event:bb}},members:{__Om:null,__On:null,__Oo:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var bO=this.getRoot();
...
var bW=this.__Om=new qx.ui.list.List(cf).set({scrollbarX:s,selectionMode:bp,height:280,width:150,labelPath:bs,iconPath:br,iconOptions:{converter:function(cj){return bK+cj+p;
}}});
bR.add(bW,{top:20});
var bV=this;
...
var bY=this.__On=new qx.ui.form.CheckBox(bg);
var cd=this.__Oo=new qx.ui.form.CheckBox(d).set({enabled:false});
...
this.__Om.setSelectionMode(cC);

if(cC==bl||cC==bq){this.__On.setEnabled(false);
this.__Oo.setEnabled(true);
}else if(cC==bp||cC==bG){this.__On.setEnabled(true);
this.__Oo.setEnabled(false);
}},onShowModeChange:function(e){var cD=e.getData()[0].getUserData(bt);
this.setShowMode(cD);
},onDragCheckChange:function(e){if(e.getData()){var cE=this.__Om.getSelectionMode();
...
},onQuickCheckChange:function(e){if(e.getData()){var cF=this.__Om.getSelectionMode();
