...
(function(){var m="drop",k="value",j="items",h="move",g="multi",f="dragover",d="icon/16/places/folder.png",c="dragstart",b="Item ",a="copy",A="drag",z="TextArea Target",y="solid",x="Reorderable",w="qx.ui.form.ListItem",v="droprequest",u="#33508D",t="Source",s="demobrowser.demo.ui.DragDrop",r="Simple Target",p="Enable drag",q="__Po",n="\n",o="dragend";
qx.Class.define(s,{extend:qx.application.Standalone,members:{__Po:null,__Pp:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var M=this.getRoot();
...
var C=this.__Po=new qx.ui.form.List;
C.setDraggable(true);
C.setDroppable(true);
...
if(V instanceof qx.ui.form.ListItem){qx.core.Init.getApplication().__Pp=V;
}
...
C.addListener(m,function(e){this.__Pq(e.getOriginalTarget());
},this);
D.addListener(m,function(e){this.__Pq(this.__Pp);
},this);
},__Pq:function(W){if(W.classname!=w){return;
}var X=this.__Po.getSortedSelection();

for(var i=0,l=X.length;i<l;i++){this.__Po.addBefore(X[i],W);
this.__Po.addToSelection(X[i]);
