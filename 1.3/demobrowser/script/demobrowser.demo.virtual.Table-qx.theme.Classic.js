...
(function(){var g=" / ",f="horizontal",e="demobrowser.demo.virtual.Table",d="white",c="__NY",b="#EEE",a="vertical";
qx.Class.define(e,{extend:qx.application.Standalone,members:{__NY:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
h.getPane().addLayer(new qx.ui.virtual.layer.Row(d,b));
...
this.__NY=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__NY.getCellProperties(j+g+k);
