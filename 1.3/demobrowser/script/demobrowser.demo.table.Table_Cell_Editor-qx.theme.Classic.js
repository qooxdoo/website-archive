...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.table.Table_Cell_Editor","qx.theme":"qx.theme.Classic"};
...
},properties:{cellEditorFactoryFunction:{check:b,nullable:true,init:null}},members:{__IM:null,__IL:null,createCellEditor:function(d){var e=this.getCellEditorFactoryFunction();
{};
this.__IM=e(d);
var f=this.__IM.createCellEditor(d);
this.__IL[f.toHashCode()]=d;
return f;
},getCellEditorValue:function(g){var i=this.getCellEditorFactoryFunction();
{};
var h=this.__IL[g.toHashCode()];
this.__IM=i(h);
var j=this.__IM.getCellEditorValue(g);
return j;
