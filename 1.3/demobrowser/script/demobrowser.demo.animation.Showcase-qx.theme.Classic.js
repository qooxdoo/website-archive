...
this.__yr=qx.fx.effect.core.Scale.originalStyle;
this.__ys=qx.fx.effect.core.Scale.fontTypes;
},properties:{scaleX:{init:true,check:n},scaleY:{init:true,check:n},scaleContent:{init:true,check:n},scaleFromCenter:{init:true,check:n},scaleFrom:{init:100.0,check:m},scaleTo:{init:100,check:m},restoreAfterFinish:{init:false,check:n},alternateDimensions:{init:[],check:k}},statics:{originalStyle:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},fontTypes:{'em':g,'px':o,'%':b,'pt':h}},members:{__yt:null,__yu:null,__yv:null,__yw:null,__yx:null,__yy:null,__yz:null,__yr:null,__ys:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var u=this._getElement();
this.__yt=qx.bom.element.Style.get(u,f);

for(var s in this.__yr){this.__yr[s]=u.style[s];
}this.__yu=qx.bom.element.Location.getTop(u);
this.__yv=qx.bom.element.Location.getLeft(u);

try{var t=qx.bom.element.Style.get(u,l);
}catch(v){if(typeof (t)!=c){t=(qx.bom.client.Engine.MSHTML)?i:e;
}}
for(var q in this.__ys){if(t.indexOf(q)>0){this.__yw=parseFloat(t);
this.__yx=q;
break;
}}this.__yy=(this.getScaleTo()-this.getScaleFrom())/100;
var r=this.getAlternateDimensions();

if(r.length==0){this.__yz=[u.offsetWidth,u.offsetHeight];
}else{this.__yz=r;
}},update:function(w){var y=this._getElement();
qx.fx.Base.prototype.update.call(this);
var x=(this.getScaleFrom()/100.0)+(this.__yy*w);

if(this.getScaleContent()&&this.__yw){qx.bom.element.Style.set(y,l,this.__yw*x+this.__yx);
}this._setDimensions(this.__yz[0]*x,this.__yz[1]*x);
},finish:function(){qx.fx.Base.prototype.finish.call(this);
var B=this._getElement();

if(this.getRestoreAfterFinish()){for(var z in this.__yr){var A=this.__yr[z];
...
if(this.getScaleFromCenter()){var I=(C-this.__yz[0])/2;
var J=(D-this.__yz[1])/2;

if(this.__yt==a){if(G){d.top=this.__yu-J+o;
}
if(F){d.left=this.__yv-I+o;
}}else{if(G){d.top=-J+o;
}
if(F){d.left=-I+o;
}}}
for(var E in d){qx.bom.element.Style.set(H,E,d[E]);
}}},destruct:function(){this.__yz=this.__yr=this.__ys=null;
}});
})();
(function(){var i="position",h="px",g="relative",f="Number",e="absolute",d="top",c="left",b='absolute',a="qx.fx.effect.core.Move";
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:g,check:[g,e]},x:{init:0,check:f},y:{init:0,check:f}},members:{__tF:null,__tG:null,__tH:null,__tI:null,__tJ:null,setup:function(){var j=this._getElement();
qx.fx.Base.prototype.setup.call(this);

if(j.parentNode){this.__tH=qx.bom.element.Location.getLeft(j)-qx.bom.element.Location.getLeft(j.parentNode);
this.__tI=qx.bom.element.Location.getTop(j)-qx.bom.element.Location.getTop(j.parentNode);
}else{this.__tH=qx.bom.element.Location.getLeft(j);
this.__tI=qx.bom.element.Location.getTop(j);
}this.__tJ=qx.bom.element.Style.get(j,i);
qx.bom.element.Style.set(j,i,e);

if(this.getMode()==b){this.__tF=this.getX()-this.__tH;
this.__tG=this.getY()-this.__tI;
}else{this.__tF=this.getX();
this.__tG=this.getY();
}},update:function(k){var m=this._getElement();
qx.fx.Base.prototype.update.call(this);
var l=Math.round(this.__tF*k+this.__tH);
var top=Math.round(this.__tG*k+this.__tI);
qx.bom.element.Style.set(m,c,l+h);
qx.bom.element.Style.set(m,d,top+h);
},afterFinishInternal:function(){qx.bom.element.Style.set(this._getElement(),i,this.__tJ);
}}});
})();
...
qx.Class.define(d,{extend:qx.fx.Base,properties:{startColor:{init:c,check:f},endColor:{init:a,check:f},restoreBackground:{init:true,check:h},keepBackgroundImage:{init:false,check:h}},members:{__yI:null,__yJ:null,__yK:null,__yL:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var j=this._getElement();
this.__yI={backgroundImage:qx.bom.element.Style.get(j,g),backgroundColor:qx.bom.element.Style.get(j,i)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(j,g,e);
}this.__yJ=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__yK=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__yL=[this.__yK[0]-this.__yJ[0],this.__yK[1]-this.__yJ[1],this.__yK[2]-this.__yJ[2]];
},update:function(k){qx.fx.Base.prototype.update.call(this);
var l=[this.__yJ[0]+Math.round(this.__yL[0]*k),this.__yJ[1]+Math.round(this.__yL[1]*k),this.__yJ[2]+Math.round(this.__yL[2]*k)];
...
for(var n in this.__yI){qx.bom.element.Style.set(o,n,this.__yI[n]);
}}},destruct:function(){this.__yJ=this.__yK=this.__yL=null;
}});
})();
(function(){var e="horizontal",d="vertical",c="qx.fx.effect.combination.Shake",b="__EX",a="Number";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(f){qx.fx.Base.call(this,f);
this.__EX=[new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f),new qx.fx.effect.core.Move(f)];
},properties:{direction:{init:e,check:[e,d]},duration:{init:0.5,refine:true},distance:{init:20,check:a}},members:{__EX:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var g=parseFloat(this.getDistance());
var h=parseFloat(this.getDuration())/10.0;

if(this.getDirection()==e){this.__EX[0].set({x:g,y:0,duration:h});
this.__EX[1].set({x:-g*2,y:0,duration:h*2});
this.__EX[2].set({x:g*2,y:0,duration:h*2});
this.__EX[3].set({x:-g*2,y:0,duration:h*2});
this.__EX[4].set({x:g*2,y:0,duration:h*2});
this.__EX[5].set({x:-g,y:0,duration:h*2});
}else if(this.getDirection()==d){this.__EX[0].set({y:g,x:0,duration:h});
this.__EX[1].set({y:-g*2,x:0,duration:h*2});
this.__EX[2].set({y:g*2,x:0,duration:h*2});
this.__EX[3].set({y:-g*2,x:0,duration:h*2});
this.__EX[4].set({y:g*2,x:0,duration:h*2});
this.__EX[5].set({y:-g,x:0,duration:h*2});
}var k=this.__EX;

for(var i=0,j=this.__EX.length;i<j;i++){this.__EX[i].id=i;

if(i<5){this.__EX[i].afterFinishInternal=function(){k[this.id+1].start();
};
}}this.__EX[0].start();
}},destruct:function(){this._disposeArray(b);
}});
})();
(function(){var t="linear",s="Number",r="reverse",q="Boolean",p="none",o="wobble",n="flicker",m="pulse",l="sinodial",k="easeOutQuad",d="spring",j="easeInQuad",g="full",c="Color",b="backgroundColor",f="__yG",e="#ffffff",h="backgroundImage",a="qx.fx.effect.combination.ColorFlow",i="#ffffaa";
qx.Class.define(a,{extend:qx.fx.Base,construct:function(u){qx.fx.Base.call(this,u);
this.__yG=[new qx.fx.effect.core.Highlight(u),new qx.fx.effect.core.Highlight(u)];
},properties:{startColor:{init:e,check:c},endColor:{init:i,check:c},forwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},backwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},forwardDuration:{init:1.0,check:s},backwardDuration:{init:1.0,check:s},delayBetween:{init:0.3,check:s},restoreBackground:{init:true,check:q},keepBackgroundImage:{init:false,check:q}},members:{__yH:null,__yG:null,start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var v=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__yH={backgroundImage:qx.bom.element.Style.get(v,h),backgroundColor:qx.bom.element.Style.get(v,b)};
this.__yG[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__yG[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__yG[0].afterFinishInternal=function(){self.__yG[1].start();
};
this.__yG[0].start();
}},destruct:function(){this._disposeArray(f);
}});
})();
(function(){var d="opacity",c="qx.fx.effect.combination.Pulsate",b="__Eu",a="sinodial";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(e){qx.fx.Base.call(this,e);
var f=this.getDuration()/6;
var g=0;
this.__Eu=[new qx.fx.effect.core.Fade(e),new qx.fx.effect.core.Fade(e),new qx.fx.effect.core.Fade(e),new qx.fx.effect.core.Fade(e),new qx.fx.effect.core.Fade(e),new qx.fx.effect.core.Fade(e)];

for(var i=0,l=this.__Eu.length;i<l;i++){this.__Eu[i].set({duration:f,to:((g%2)!=0)?1:0,from:((g%2)!=0)?0:1,transition:a,modifyDisplay:false});
g++;
}},properties:{duration:{init:2,refine:true}},members:{__Ev:null,__Eu:null,beforeSetup:function(){this.__Ev=qx.bom.element.Style.get(this._getElement(),d);
},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var h=0;
var self=this;

for(var i=0,l=this.__Eu.length;i<l;i++){this.__Eu[i].id=h;

if(h<5){this.__Eu[i].afterFinishInternal=function(){self.__Eu[this.id+1].start();
};
}h++;
}this.__Eu[0].start();
},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),d,this.__Ev);
},_applyDuration:function(j,k){var m=j/6;

for(var i=0,l=this.__Eu.length;i<l;i++){this.__Eu[i].set({duration:m});
}}},destruct:function(){this._disposeArray(b);
}});
})();
(function(){var i="opacity",h="Boolean",g="__GV",f="none",e="qx.fx.effect.combination.Puff",d="_effects",c="__GU",b="__GW",a="display";
qx.Class.define(e,{extend:qx.fx.Base,construct:function(j){qx.fx.Base.call(this,j);
this.__GU=new qx.fx.effect.core.Scale(j);
this.__GV=new qx.fx.effect.core.Fade(j);
this.__GW=new qx.fx.effect.core.Parallel(this.__GU,this.__GV);
},properties:{modifyDisplay:{init:true,check:h}},members:{__GV:null,__GU:null,__GW:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),a,f);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var l=this._getElement();
var k={opacity:qx.bom.element.Style.get(l,i)};
this.__GV.afterFinishInternal=function(){var n=this._getElement();

for(var m in k){qx.bom.element.Style.set(n,m,k[m]);
}};
this.__GU.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__GV.set({sync:true,to:0.0,modifyDisplay:false});
this.__GW.start();
}},destruct:function(){this._disposeArray(d);
this._disposeObjects(b,c,g);
}});
})();
...
(function(){var j="sinodial",i="none",h="overflow",g="flicker",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",E="easeInQuad",D="reverse",C="linear",B="Boolean",A="px",z='bottom-left',y='top-left',x='bottom-right',w="bottom-right",v="bottom-left",q="__ER",r="visible",o="__EP",p="qx.fx.effect.combination.Shrink",m="top-left",n="top-right",k='top-right',l="__EQ",s='center',t="hidden",u="display";
qx.Class.define(p,{extend:qx.fx.Base,construct:function(F){qx.fx.Base.call(this,F);
this.__EP=new qx.fx.effect.core.Move(F);
this.__EQ=new qx.fx.effect.core.Scale(F);
this.__ER=new qx.fx.effect.core.Parallel(this.__EP,this.__EQ);
},properties:{direction:{init:f,check:[m,n,v,w,f]},moveTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},scaleTransition:{init:j,check:[C,E,a,j,D,g,b,e,d,i,c]},modifyDisplay:{init:true,check:B}},members:{__ES:null,__EP:null,__EQ:null,__ER:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
...
for(var G in this.__ES){H=this.__ES[G];
...
var J,K;
this.__ES={top:qx.bom.element.Location.getTop(L,"scroll"),left:qx.bom.element.Location.getLeft(L,"scroll"),width:qx.bom.element.Dimension.getContentWidth(L),height:qx.bom.element.Dimension.getContentHeight(L),opacity:qx.bom.element.Style.get(L,"opacity")};

switch(this.getDirection()){case y:J=K=0;
break;
case k:J=this.__ES.width;
K=0;
break;
case z:J=0;
K=this.__ES.height;
break;
case x:J=this.__ES.width;
K=this.__ES.height;
break;
case s:J=this.__ES.width/2;
K=this.__ES.height/2;
break;
}this.__EP.set({x:J,y:K,sync:true,transition:this.getMoveTransition()});
this.__EQ.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__ER.start();
}},destruct:function(){this._disposeObjects(o,l,q);
}});
})();
(function(){var j="sinodial",i="px",h="flicker",g="0px",f="center",e="pulse",d="spring",c="full",b="wobble",a="easeOutQuad",J="easeInQuad",I="reverse",H="none",G="overflow",F="linear",E="height",D='bottom-left',C='top-left',B='bottom-right',A="bottom-right",q="qx.fx.effect.combination.Grow",r="__yo",o="__yp",p="bottom-left",m="visible",n="width",k="top-left",l="top",s="top-right",t='top-right',v="block",u='center',x="hidden",w="left",z="__yq",y="display";
qx.Class.define(q,{extend:qx.fx.Base,construct:function(K){qx.fx.Base.call(this,K);
this.__yo=new qx.fx.effect.core.Move(K);
this.__yp=new qx.fx.effect.core.Scale(K);
this.__yq=new qx.fx.effect.core.Parallel(this.__yo,this.__yp);
},properties:{direction:{init:f,check:[k,s,p,A,f]},scaleTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]},moveTransition:{init:j,check:[F,J,a,j,I,h,b,e,d,H,c]}},members:{__yp:null,__yo:null,__yq:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var O=this._getElement();
qx.bom.element.Style.set(O,y,v);
qx.bom.element.Style.set(O,G,x);
var M,L;
var P,Q;
...
this.__yp.afterFinishInternal=function(){var S;
...
break;
}this.__yo.set({x:P,y:Q,sync:true,transition:this.getMoveTransition()});
this.__yp.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[N.width,N.height]});
qx.bom.element.Style.set(O,l,(N.top+L)+i);
qx.bom.element.Style.set(O,w,(N.left+M)+i);
qx.bom.element.Style.set(O,E,g);
qx.bom.element.Style.set(O,n,g);
this.__yq.start();
}},destruct:function(){this._disposeObjects(r,o,z);
}});
})();
(function(){var u="out",t="px",s="south",r="Number",q="north-west",p="west",o="in",n="north",m="south-east",l="south-west",e="east",k="north-east",h="display",c="__Fu",b="top",g="Boolean",f="block",i="__Ft",a="left",j="__Fv",d="qx.fx.effect.combination.Drop";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(v){qx.fx.Base.call(this,v);
this.__Ft=new qx.fx.effect.core.Move(v);
this.__Fu=new qx.fx.effect.core.Fade(v);
this.__Fv=new qx.fx.effect.core.Parallel(this.__Ft,this.__Fu);
},properties:{direction:{init:s,check:[s,p,e,n,l,m,k,q]},xAmount:{init:100,check:r},yAmount:{init:100,check:r},mode:{init:u,check:[o,u]},modifyDisplay:{init:true,check:g}},members:{__Fu:null,__Ft:null,__Fv:null,start:function(){qx.fx.Base.prototype.start.call(this);
...
this.__Fu.afterFinishInternal=function(){for(var B in z){qx.bom.element.Style.set(A,B,z[B]+t);
}};
this.__Fu.set({duration:0.5,sync:true,from:(this.getMode()==u)?1:0,to:(this.getMode()==u)?0:1,modifyDisplay:true});
this.__Fv.start();
}},destruct:function(){this._disposeObjects(i,c,j);
}});
})();
(function(){var q="display",p="in",o="overflow",n="block",m="none",l="visible",k="0px",j="hidden",i="visiblity",h="__GS",c="Boolean",g="height",f="width",b="px",a="qx.fx.effect.combination.Fold",e="__GR",d="out";
qx.Class.define(a,{extend:qx.fx.Base,construct:function(r){qx.fx.Base.call(this,r);
},properties:{modifyDisplay:{init:true,check:c},mode:{init:p,check:[p,d]}},members:{__GR:null,__GS:null,__GT:null,afterFinish:function(){var s=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==p)){qx.bom.element.Style.set(s,q,n);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}var t=this._getElement();
var self=this;
this.__GR=new qx.fx.effect.core.Scale(t);
this.__GS=new qx.fx.effect.core.Scale(t);
this.__GR.afterFinishInternal=function(){self.__GS.start();
};
this.__GS.afterFinishInternal=function(){self._cleanUp();
};
this.__GT=this._getStyle();
qx.bom.element.Style.set(t,o,j);

if(this.getMode()==p){this.__GR.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__GS.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__GR.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__GT.width,this.__GT.height]});
this.__GS.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__GT.width,this.__GT.height]});
...
for(var u in this.__GT){v=this.__GT[u];
...
(function(){var j="off",i="overflow",h="__Fb",g="Boolean",f="qx.fx.effect.combination.Switch",e="none",d="__Fa",c="flicker",b="hidden",a="display";
qx.Class.define(f,{extend:qx.fx.Base,construct:function(k){qx.fx.Base.call(this,k);
this.setTransition(c);
var l=this.__Fa=new qx.fx.effect.core.Scale(k);
this.__Fa.beforeSetup=function(){qx.bom.element.Style.set(k,i,b);
};
this.__Fb=new qx.fx.effect.core.Fade(k);
this.__Fb.afterFinishInternal=function(){l.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:g},mode:{init:j,check:[j]}},members:{__Fa:null,__Fb:null,setup:function(){qx.fx.Base.prototype.setup.call(this);
var n=this._getElement();
var m=qx.bom.element.Style.get(n,i);
this.__Fa.afterFinishInternal=function(){qx.bom.element.Style.set(n,i,m);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==j)){qx.bom.element.Style.set(this._getElement(),a,e);
}},start:function(){if(!qx.fx.Base.prototype.start.call(this)){return;
}
if(this.getMode()==j){this.__Fa.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__Fb.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__Fb.start();
},_applyDuration:function(o,p){this.__Fa.setDuration(o/2);
this.__Fb.setDuration(o/2);
