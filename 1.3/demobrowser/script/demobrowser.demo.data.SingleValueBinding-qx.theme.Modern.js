...
(function(){var s="qx.data.Array",r="demobrowser.demo.data.model.Node",q="String",p="changeNames",o="changeName",n="Validation Error: ",m="",l="is no number (parseFloat says so!).",k="changeChild",j="- ",c="changeColor",h="Marge",f="AFFE",b="__Oz",a="Homer",e="\n",d="changeName2",g="changeChildren";
qx.Class.define(r,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.setChildren(new qx.data.Array());
},properties:{children:{check:s,event:g},child:{check:r,event:k,nullable:true},names:{check:s,event:p,init:new qx.data.Array(a,h)},name:{check:q,init:f,event:o},name2:{check:q,event:d},number:{init:10,validate:b},color:{event:c,nullable:true}},members:{__Oz:function(t){if(!isNaN(parseFloat(t))){if(/^\d+$/.test(t)){return;
