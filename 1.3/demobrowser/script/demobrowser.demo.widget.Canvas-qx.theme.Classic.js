...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.Canvas","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Canvas-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d70bfcc81886"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="redraw",j="center",i="Canvas is not support by this browser!",h="middle",g="Window containing a Canvas - synced coordinates",f="Window containing a Canvas - static coordinates",d="Resize the windows to see the effect.",c="rgba(0, 0, 200, 0.5)",b="demobrowser.demo.widget.Canvas",a="rgb(200,0,0)";
...
var p=new qx.ui.basic.Label(d);
this.getRoot().add(p,{left:10,top:10});
var o=new qx.ui.window.Window(f).set({width:200,height:200});
o.setLayout(new qx.ui.layout.Canvas());

if(!qx.bom.client.Feature.CANVAS){var n=new qx.ui.container.Composite(new qx.ui.layout.HBox());
n.add(new qx.ui.basic.Label(i).set({rich:true,alignX:j,alignY:h}));
}else{var n=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:false});
n.addListener(k,this.draw,this);
}o.add(n,{edge:0});
this.getRoot().add(o,{left:30,top:40});
o.open();
var l=new qx.ui.window.Window(g).set({width:200,height:200});
l.setLayout(new qx.ui.layout.Canvas());

if(!qx.bom.client.Feature.CANVAS){var m=new qx.ui.container.Composite(new qx.ui.layout.HBox());
m.add(new qx.ui.basic.Label(i).set({rich:true,alignX:j,alignY:h}));
}else{var m=new qx.ui.embed.Canvas().set({canvasWidth:200,canvasHeight:200,syncDimension:true});
m.addListener(k,this.draw,this);
}l.add(m,{edge:0});
this.getRoot().add(l,{left:30,top:250});
l.open();
},draw:function(e){var r=e.getData();
var q=r.context;
q.fillStyle=a;
...
(function(){var j="Integer",i="resize",h="_applyCanvasWidth",g="redraw",f="Boolean",d="_applyCanvasHeight",c="qx.ui.embed.Canvas",b="__Ff",a="qx.event.type.Data";
qx.Class.define(c,{extend:qx.ui.core.Widget,construct:function(k,l){qx.ui.core.Widget.call(this);
this.__Ff=new qx.util.DeferredCall(this.__Fg,this);
this.addListener(i,this._onResize,this);

if(k!==undefined){this.setCanvasWidth(k);
}
if(l!==undefined){this.setCanvasHeight(l);
}},events:{"redraw":a},properties:{syncDimension:{check:f,init:false},canvasWidth:{check:j,init:300,apply:h},canvasHeight:{check:j,init:150,apply:d}},members:{__Ff:null,_createContentElement:function(){return new qx.html.Canvas();
},__Fg:function(){var n=this.getContentElement();
var p=n.getHeight();
var m=n.getWidth();
...
this.__Ff.schedule();
},update:function(){this.__Ff.schedule();
...
this.__Fh=document.createElement(c);
},members:{__Fh:null,_createDomElement:function(){return this.__Fh;
},getCanvas:function(){return this.__Fh;
},setWidth:function(f){this.__Fh.width=f;
},getWidth:function(){return this.__Fh.width;
},setHeight:function(g){this.__Fh.height=g;
},getHeight:function(){return this.__Fh.height;
},getContext2d:function(){return this.__Fh.getContext(b);
