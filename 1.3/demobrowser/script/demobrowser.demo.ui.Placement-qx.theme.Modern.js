...
qx.Class.define(k,{extend:qx.application.Standalone,members:{__Pr:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var t=this.getRoot();
this.__Pr=[n,p,q,l,o,b,d,m];
...
for(var i=0;i<this.__Pr.length;i++){var x=new qx.ui.form.ListItem(this.__Pr[i]);
v.add(x);

if(this.__Pr[i]==u){z=x;
}}y.add(v);
...
for(var i=0;i<this.__Pr.length;i++){B.add(new qx.ui.form.ListItem(this.__Pr[i]));
}D.add(B);
