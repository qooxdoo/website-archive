...
qx.Class.define(k,{extend:demobrowser.demo.event.EventDemo,members:{__Np:null,main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);
this.__Np=qx.lang.Function.bind(this.logMouseEvent,this);
...
if(B.checked){qx.bom.Event.addNativeListener(z,A[i],this.__Np);
}qx.bom.Event.addNativeListener(B,o,qx.lang.Function.bind(this.__Nq,this));
}},__Nq:function(e){var F=qx.bom.Event.getTarget(e);
var E=F.id.split(w)[1];
var C=F.checked;
var D=document.getElementById(l);

if(C){qx.bom.Event.addNativeListener(D,E,this.__Np);
}else{qx.bom.Event.removeNativeListener(D,E,this.__Np);
