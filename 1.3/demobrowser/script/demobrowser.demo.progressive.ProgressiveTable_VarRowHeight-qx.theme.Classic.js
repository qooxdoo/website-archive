...
qx.Class.define(d,{extend:qx.application.Standalone,members:{__Ow:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var A=p;
...
--this.__Ow;
this.debug("Found ["+this.imageData[j].url+"].  loadCount="+this.__Ow+", end="+this.imageData.length);
if(this.__Ow==0){this.doLoad();
}return;
...
if(d===undefined){this.__EV=d;
}else{this.__EV=16;
}
if(e===undefined){this.__EW=e;
}else{this.__EW=16;
}},members:{__EV:null,__EW:null,_identifyImage:function(f){var j={imageWidth:this.__EV,imageHeight:this.__EW};
var k;
