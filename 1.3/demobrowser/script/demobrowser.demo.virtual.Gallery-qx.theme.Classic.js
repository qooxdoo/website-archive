...
this.__NU=new demobrowser.demo.virtual.GalleryCell();
...
if(bx){this.__NU.updateStates(bz,{selected:1});
}else{this.__NU.updateStates(bz,{});
...
}var bF=this.__NU.getCellWidget(bG,bE);
bF.setUserData(j,bD);
return bF;
},poolCellWidget:function(bH){this.__NU.pool(bH);
