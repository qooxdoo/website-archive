...
(function(){var e="Window: ",d="__MQ",c="interval",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__MO:null,__MP:0,__MQ:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__MO=[];
this.currentTest=this.testWindows;
this.__MQ=new qx.event.Timer(1000);
this.__MQ.addListener(c,this.runTest,this);
this.__MQ.start();
},runTest:function(){this.__MP++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__MP+" (Registry: "+g+")");
this.currentTest();
