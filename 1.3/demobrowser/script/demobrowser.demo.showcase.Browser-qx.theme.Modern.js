...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.showcase.Browser","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.showcase.Browser-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"04f95401f274"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var o="execute",n="This feature is currently not supported.",m="http://",l="demobrowser.demo.showcase.Browser",k="separator-vertical",j="icon/16/actions/go-previous.png",i="keypress",h="Enter",g="icon/16/actions/go-next.png",f="Web Browser",b="icon/16/actions/media-playback-start.png",d="http://web.de",c="icon/16/categories/internet.png",a="middle";
