...
(function(){var k="",j="Hello",h="icon/16/actions/go-down.png",g="World",f="bold",e="Juhu",d="waiting",c="icon/16/actions/go-next.png",b="http://resources.qooxdoo.org/images/logo.gif",a="$ ",K="string",J="border: 1px dotted green",I="decoration",H="multi<br>line",G="between",F="<",E="inactive",D="qx/decoration/Modern",C="icon/16/actions/go-previous.png",B="icon",r="number",s="<i>italic</i>",p="0$",q="qx/icon/Tango",n="<b>bold</b>",o="icon/16/actions/go-up.png",l="boolean",m="demobrowser.demo.test.Table_CellRenderer",t="tooltip",u="red",w="icon/16/emotes/face-sad.png",v="icon/16/emotes/face-smile.png",y="left",x=">=",A="active",z="object";
qx.Class.define(m,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
qx.util.AliasManager.getInstance().add(I,D);
qx.util.AliasManager.getInstance().add(B,q);
},__MJ:function(L,top,M,N,O){var P=["<div style='position:absolute;height:20px;width:",M,"px;top:",top,"px'>"];
N.createDataCellHtml(O,P);
P.push("</div>");
L.innerHTML+=P.join("");
},testDefaultRenderer:function(Q){var R=100;
var T={value:[null,e,32,new Date()],styleLeft:[0],styleWidth:[R],styleHeight:[20],style:[k]};
var S=this._getNewTableDiv(R);
var top=0;
qx.util.Permutation.permute(T,function(U){this.__MJ(S,top,R,Q,U);
top+=20;
},this);
},testBooleanRenderer:function(){var Y=70;
var X=30;
var ba=new qx.ui.table.cellrenderer.Boolean();
var V={value:[null,true,false],styleLeft:[0],styleWidth:[Y],styleHeight:[X],style:[k]};
var W=this._getNewTableDiv(Y);
var top=0;
qx.util.Permutation.permute(V,function(bb){this.__MJ(W,top,Y,ba,bb);
top+=X;
},this);
ba.setIconFalse(w);
ba.setIconTrue(v);
qx.util.Permutation.permute(V,function(bc){this.__MJ(W,top,Y,ba,bc);
top+=X;
},this);
},testDateRenderer:function(){var bg=180;
var bh=new qx.ui.table.cellrenderer.Date();
var bj={value:new Date(),styleLeft:[0],styleWidth:[bg],styleHeight:[20],style:[k]};
var bf=qx.util.format.DateFormat;
var bi=[bf.getDateTimeInstance(),bf.getDateInstance()];
var bd=this._getNewTableDiv(bg);
var top=0;

for(var i=0;i<bi.length;i++){var be=bi[i];
bh.setDateFormat(be);
this.__MJ(bd,top,bg,bh,bj);
top+=20;
}},testNumberRenderer:function(){var bo=new qx.ui.table.cellrenderer.Number();
var bn=100;
var bq={value:Math.PI,styleLeft:[0],styleWidth:[bn],styleHeight:[20],style:[k]};
var bm=qx.util.format.NumberFormat;
var bp=[bm.getIntegerInstance(),new bm().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:a})];
var bk=this._getNewTableDiv(bn);
var top=0;

for(var i=0;i<bp.length;i++){var bl=bp[i];
bo.setNumberFormat(bl);
this.__MJ(bk,top,bn,bo,bq);
top+=20;
}},testImageRenderer:function(){var bt=new qx.ui.table.cellrenderer.Image();
var br=50;
var bu={value:[null,h,o,C,c,b],styleLeft:[0],styleWidth:[br],styleHeight:[20],style:[k],tooltip:[k,t]};
var bs=this._getNewTableDiv(br);
var top=0;
qx.util.Permutation.permute(bu,function(bv){this.__MJ(bs,top,br,bt,bv);
top+=20;
},this);
},testStringRenderer:function(){var bA=new qx.ui.table.cellrenderer.String();
var bz=100;
var by=20;
var bw={value:[null,j,g],styleLeft:[0],styleWidth:[bz],styleHeight:[by],style:[k]};
var bx=this._getNewTableDiv(bz);
var top=0;
qx.util.Permutation.permute(bw,function(bB){this.__MJ(bx,top,bz,bA,bB);
top+=20;
},this);
},testPasswordRenderer:function(){var bG=new qx.ui.table.cellrenderer.Password();
var bF=100;
var bE=20;
var bC={value:[null,j,g],styleLeft:[0],styleWidth:[bF],styleHeight:[bE],style:[k]};
var bD=this._getNewTableDiv(bF);
var top=0;
qx.util.Permutation.permute(bC,function(bH){this.__MJ(bD,top,bF,bG,bH);
top+=20;
},this);
},testHtmlRenderer:function(){var bM=new qx.ui.table.cellrenderer.Html();
var bL=100;
var bK=50;
var bI={value:[null,n,s,H],styleLeft:[0],styleWidth:[bL],styleHeight:[bK],style:[k]};
var bJ=this._getNewTableDiv(bL);
var top=0;
qx.util.Permutation.permute(bI,function(bN){this.__MJ(bJ,top,bL,bM,bN);
top+=20;
},this);
},testConditionalRenderer:function(){var bS=new qx.ui.table.cellrenderer.Conditional();
bS.addNumericCondition(F,0,null,u,null,null);
bS.addNumericCondition(x,100,y,null,null,null);
bS.addBetweenCondition(G,0,2,null,null,null,f,null);
bS.addRegex(p,null,null,f,J);
var bR=100;
var bQ=20;
var bO={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bR],table:[this.tableMock],styleHeight:[bQ],style:[k]};
var bP=this._getNewTableDiv(bR);
var top=0;
qx.util.Permutation.permute(bO,function(bT){this.__MJ(bP,top,bR,bS,bT);
top+=20;
},this);
},testDynamicRenderer:function(){var bY=new qx.ui.table.cellrenderer.Dynamic();
bY.setCellRendererFactoryFunction(function(ca){var cc=ca.value;
var cb=qx.ui.table.cellrenderer;

switch(typeof cc){case K:if(cc.match(/^icon\//)){return new cb.Image();
}else{return new cb.String();
}case l:return new cb.Boolean();
case r:return new cb.Number();
case z:if(cc instanceof Date){return new cb.Date();
}return new cb.Default();
}});
var bX=100;
var bW=20;
var bU={value:[null,e,new Date(),30,h,false],styleLeft:[0],styleWidth:[bX],styleHeight:[bW],table:[this.tableMock],style:[k]};
var bV=this._getNewTableDiv(bX);
var top=0;
qx.util.Permutation.permute(bU,function(cd){this.__MJ(bV,top,bX,bY,cd);
top+=20;
},this);
},testReplaceRenderer:function(){var ci=new qx.ui.table.cellrenderer.Replace();
ci.setReplaceMap({1:A,2:E,3:d});
ci.addReversedReplaceMap();
var ch=100;
var cg=20;
var ce={value:[1,2,3],styleLeft:[0],styleWidth:[ch],table:[this.tableMock],styleHeight:[cg],style:[k]};
var cf=this._getNewTableDiv(ch);
var top=0;
qx.util.Permutation.permute(ce,function(cj){this.__MJ(cf,top,ch,ci,cj);
top+=20;
},this);
...
if(d){this.__HB=d;
}this.__HC=qx.util.AliasManager.getInstance();
},members:{__HC:null,__HB:16,__HA:16,_identifyImage:function(e){var f={imageWidth:this.__HA,imageHeight:this.__HB};

if(e.value==a){f.url=null;
}else{f.url=this.__HC.resolve(e.value);
}f.tooltip=e.tooltip;
return f;
