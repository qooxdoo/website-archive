...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.layout.VBox","qx.theme":"qx.theme.Modern"};
for (var k in settings) qxsettings[k] = settings[k];

if (!window.qxvariants) qxvariants = {};
var variants = {"qx.aspects":"off","qx.debug":"off","qx.layout":"on"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.VBox-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"852dacd5ca33"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var i="main",h="green",g="yellow",f="middle",e="bottom",d="demobrowser.demo.layout.VBox",c="center",b="left",a="right";
...
j.add(this.getBox6());
j.add(this.getBox7());
},getBox1:function(){var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
k.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return k;
},getBox2:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,minWidth:60,allowGrowY:false});
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:b}));
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:c}));
l.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxWidth:40,alignX:a}));
return l;
},getBox3:function(){var m=new qx.ui.layout.VBox();
var n=new qx.ui.container.Composite(m).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
m.setSpacing(5);
m.setAlignY(e);
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return n;
},getBox4:function(){var o=new qx.ui.layout.VBox();
var p=new qx.ui.container.Composite(o).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
o.setSpacing(5);
o.setAlignY(f);
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
p.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return p;
},getBox5:function(){var r=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:i,backgroundColor:g,allowGrowY:false});
var t=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var s=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var q=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
r.add(t);
r.add(s);
r.add(q);
return r;
},getBox6:function(){var u=new qx.ui.layout.VBox();
var w=new qx.ui.container.Composite(u).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
u.setSpacing(5);
u.setAlignY(e);
var y=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var x=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var v=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
w.add(y);
w.add(x);
w.add(v);
return w;
},getBox7:function(){var z=new qx.ui.layout.VBox();
var B=new qx.ui.container.Composite(z).set({decorator:i,backgroundColor:g,height:300,allowGrowY:false});
z.setSpacing(5);
z.setAlignY(f);
var D=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
var C=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10,marginTop:20});
var A=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,marginBottom:10});
B.add(D);
B.add(C);
B.add(A);
return B;
...
}},properties:{sort:{check:[l,m,n],init:l,apply:j},separatorX:{check:p,nullable:true,apply:s},separatorY:{check:p,nullable:true,apply:s},connectSeparators:{check:e,init:false,apply:s},spacingX:{check:o,init:0,apply:s},spacingY:{check:o,init:0,apply:s}},members:{__rT:null,__rU:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__rV:{north:1,south:2,west:3,east:4,center:5},__rW:{1:q,2:d,3:r,4:g},__rX:function(){var x=this._getLayoutChildren();
var F,z;
var length=x.length;
var B=[];
var E=[];
...
},renderLayout:function(H,I){if(this._invalidChildrenCache){this.__rX();
...
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__rX();
}var bH=this.__rT;
var bR=this.__rU;
...
}},destruct:function(){this.__rU=this.__rT=null;
}});
})();
