...
(function(){var bB="execute",bA="changeValue",bz="icon/16/actions/system-search.png",by="Online Forum",bx="New",bw="icon/16/actions/edit-cut.png",bv="Search in files",bu="icon/16/actions/format-justify-fill.png",bt="Left aligned",bs="Undo",bh="_openCommand",bg="Uppercase",bf="View",be="C Dialect",bd="changeSelection",bc="Save as...",bb="Show line numbers",ba="Search previous...",Y="Quickstart",X="Cut",bI="Ctrl+N",bJ="C",bG="Show console",bH="Search",bE="Help",bF="_redoCommand",bC="Redo",bD="Show status bar",bK="icon/16/actions/format-justify-left.png",bL="ANSI to OEM",bl="Centered",bk="Paragraph",bn="Edit",bm="Ctrl+O",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",br="C Sharp",bq="icon/16/actions/edit-undo.png",bj="Close",bi="icon/16/actions/document-save-as.png",a="Python",b="icon/16/apps/utilities-help.png",c="Show tree",d="Spaces to tabs",f="Right aligned",g="OEM to ANSI",h="JavaScript",i="demobrowser.demo.widget.MenuBar",j="_copyCommand",k="XML",bP="Save",bO="_undoCommand",bN="Capitals",bM="icon/16/actions/application-exit.png",bT="C Plus Plus",bS="_saveCommand",bR="Lowercase",bQ="Search next...",bV="_newCommand",bU="Replace in files",H="Perl",I="Ctrl+P",F="Topics",G="Panes",L="Justified",M="Ctrl+X",J="Show macros",K="Show ruler",D="Copy",E="Paste",s="_pasteCommand",r="icon/16/actions/format-justify-right.png",u="Ctrl+Z",t="Ctrl+R",o="icon/16/actions/edit-redo.png",n="Show tags",q="Info...",p="Format",m="File",l="Show tabs",R="Print",S="icon/16/actions/document-save.png",T="icon/16/actions/edit-copy.png",U="Search...",N="icon/16/actions/format-justify-center.png",O="Open",P="_cutCommand",Q="Objective C",V="Exit",W="Ctrl+S",C="Syntax",B="Ctrl+C",A="icon/16/actions/document-new.png",z="Tabs to spaces",y="ASCII table",x="Replace",w="HTML",v="icon/16/actions/edit-paste.png";
...
var bX=new qx.ui.container.Scroll();
var bW=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
bW.setPadding(20);
bW.setAllowStretchX(false);
bX.add(bW);
this.getRoot().add(bX,{edge:0});
this.createCommands();
bW.add(this.getMenuBar(),{left:20,top:20});
...
},createCommands:function(){this._newCommand=new qx.ui.core.Command(bI);
this._newCommand.addListener(bB,this.debugCommand);
this._openCommand=new qx.ui.core.Command(bm);
this._openCommand.addListener(bB,this.debugCommand);
this._saveCommand=new qx.ui.core.Command(W);
this._saveCommand.addListener(bB,this.debugCommand);
this._undoCommand=new qx.ui.core.Command(u);
this._undoCommand.addListener(bB,this.debugCommand);
this._redoCommand=new qx.ui.core.Command(t);
this._redoCommand.addListener(bB,this.debugCommand);
this._cutCommand=new qx.ui.core.Command(M);
this._cutCommand.addListener(bB,this.debugCommand);
this._copyCommand=new qx.ui.core.Command(B);
this._copyCommand.addListener(bB,this.debugCommand);
this._pasteCommand=new qx.ui.core.Command(I);
this._pasteCommand.addListener(bB,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuBar:function(){var cb=new qx.ui.container.Composite(new qx.ui.layout.Grow);
var menubar=new qx.ui.menubar.MenuBar;
menubar.setWidth(600);
cb.add(menubar);
var ca=new qx.ui.menubar.Button(m,null,this.getFileMenu());
var bY=new qx.ui.menubar.Button(bn,null,this.getEditMenu());
var cc=new qx.ui.menubar.Button(bH,null,this.getSearchMenu());
var cf=new qx.ui.menubar.Button(bf,null,this.getViewMenu());
var ce=new qx.ui.menubar.Button(p,null,this.getFormatMenu());
var cd=new qx.ui.menubar.Button(bE,null,this.getHelpMenu());
menubar.add(ca);
menubar.add(bY);
menubar.add(cc);
menubar.add(cf);
...
menubar.add(cd);
return cb;
},getFileMenu:function(){var ci=new qx.ui.menu.Menu;
var cg=new qx.ui.menu.Button(bx,A,this._newCommand);
var ck=new qx.ui.menu.Button(O,bo,this._openCommand);
var cj=new qx.ui.menu.Button(bj);
var cn=new qx.ui.menu.Button(bP,S,this._saveCommand);
var cm=new qx.ui.menu.Button(bc,bi);
var cl=new qx.ui.menu.Button(R,bp);
var ch=new qx.ui.menu.Button(V,bM);
cg.addListener(bB,this.debugButton);
ck.addListener(bB,this.debugButton);
cj.addListener(bB,this.debugButton);
cn.addListener(bB,this.debugButton);
cm.addListener(bB,this.debugButton);
cl.addListener(bB,this.debugButton);
ch.addListener(bB,this.debugButton);
ci.add(cg);
ci.add(ck);
ci.add(cj);
ci.add(cn);
...
ci.add(ch);
return ci;
},getEditMenu:function(){var cp=new qx.ui.menu.Menu;
var cs=new qx.ui.menu.Button(bs,bq,this._undoCommand);
var cr=new qx.ui.menu.Button(bC,o,this._redoCommand);
var co=new qx.ui.menu.Button(X,bw,this._cutCommand);
var ct=new qx.ui.menu.Button(D,T,this._copyCommand);
var cq=new qx.ui.menu.Button(E,v,this._pasteCommand);
cs.addListener(bB,this.debugButton);
cr.addListener(bB,this.debugButton);
co.addListener(bB,this.debugButton);
ct.addListener(bB,this.debugButton);
cq.addListener(bB,this.debugButton);
cp.add(cs);
cp.add(cr);
cp.addSeparator();
cp.add(co);
...
cp.add(cq);
return cp;
},getSearchMenu:function(){var cx=new qx.ui.menu.Menu;
var cv=new qx.ui.menu.Button(U,bz);
var cA=new qx.ui.menu.Button(bQ);
var cw=new qx.ui.menu.Button(ba);
var cz=new qx.ui.menu.Button(x);
var cu=new qx.ui.menu.Button(bv,bz);
var cy=new qx.ui.menu.Button(bU);
cw.setEnabled(false);
cv.addListener(bB,this.debugButton);
cA.addListener(bB,this.debugButton);
cw.addListener(bB,this.debugButton);
cz.addListener(bB,this.debugButton);
cu.addListener(bB,this.debugButton);
cy.addListener(bB,this.debugButton);
cx.add(cv);
cx.add(cA);
cx.add(cw);
cx.add(cz);
...
cx.add(cy);
return cx;
},getViewMenu:function(){var cB=new qx.ui.menu.Menu;
var cD=new qx.ui.menu.Button(G,null,null,this.getPanesMenu());
var cG=new qx.ui.menu.Button(C,null,null,this.getSyntaxMenu());
var cF=new qx.ui.menu.CheckBox(K);
var cE=new qx.ui.menu.CheckBox(bb);
var cC=new qx.ui.menu.Button(y);
cF.addListener(bA,this.debugCheckBox);
cE.addListener(bA,this.debugCheckBox);
cC.addListener(bB,this.debugButton);
cB.add(cD);
cB.add(cG);
cB.addSeparator();
cB.add(cF);
...
cB.add(cC);
return cB;
},getPanesMenu:function(){var cI=new qx.ui.menu.Menu;
var cK=new qx.ui.menu.CheckBox(l);
var cM=new qx.ui.menu.CheckBox(bD);
var cN=new qx.ui.menu.CheckBox(c);
var cJ=new qx.ui.menu.CheckBox(J);
var cL=new qx.ui.menu.CheckBox(n);
var cH=new qx.ui.menu.CheckBox(bG);
cK.setValue(true);
cM.setValue(true);
cJ.setValue(true);
cK.addListener(bA,this.debugCheckBox);
cM.addListener(bA,this.debugCheckBox);
cN.addListener(bA,this.debugCheckBox);
cJ.addListener(bA,this.debugCheckBox);
cL.addListener(bA,this.debugCheckBox);
cH.addListener(bA,this.debugCheckBox);
cI.add(cM);
cI.add(cK);
cI.addSeparator();
cI.add(cN);
...
var cQ=new qx.ui.menu.RadioButton(k);
var cP=new qx.ui.menu.RadioButton(h);
var cR=new qx.ui.menu.Button(be,null,null,this.getSyntaxCMenu());
var cV=new qx.ui.menu.RadioButton(H);
var cT=new qx.ui.menu.RadioButton(a);
cS.add(cO);
cS.add(cQ);
cS.add(cP);
cS.add(cR);
...
cU.addListener(bd,this.debugRadio);
return cS;
},getSyntaxCMenu:function(){var cX=new qx.ui.menu.Menu;
var cW=new qx.ui.menu.RadioButton(bJ);
var db=new qx.ui.menu.RadioButton(br);
var da=new qx.ui.menu.RadioButton(Q);
var cY=new qx.ui.menu.RadioButton(bT);
cX.add(cW);
cX.add(db);
cX.add(da);
cX.add(cY);
return cX;
},getFormatMenu:function(){var df=new qx.ui.menu.Menu;
var de=new qx.ui.menu.Button(bk,null,null,this.getParagraphMenu());
var dh=new qx.ui.menu.Button(z);
var di=new qx.ui.menu.Button(d);
var dd=new qx.ui.menu.Button(bg);
var dg=new qx.ui.menu.Button(bR);
var dc=new qx.ui.menu.Button(bN);
var dk=new qx.ui.menu.Button(g);
var dj=new qx.ui.menu.Button(bL);
dh.addListener(bB,this.debugButton);
di.addListener(bB,this.debugButton);
dd.addListener(bB,this.debugButton);
dg.addListener(bB,this.debugButton);
dc.addListener(bB,this.debugButton);
dk.addListener(bB,this.debugButton);
dj.addListener(bB,this.debugButton);
df.add(de);
df.add(dh);
df.add(di);
df.addSeparator();
...
df.add(dj);
return df;
},getParagraphMenu:function(){var dl=new qx.ui.menu.Menu;
var dp=new qx.ui.menu.Button(bt,bK);
var dq=new qx.ui.menu.Button(f,r);
var dm=new qx.ui.menu.Button(bl,N);
var dn=new qx.ui.menu.Button(L,bu);
dp.addListener(bB,this.debugButton);
dq.addListener(bB,this.debugButton);
dm.addListener(bB,this.debugButton);
dn.addListener(bB,this.debugButton);
dl.add(dp);
dl.add(dq);
dl.add(dm);
dl.add(dn);
return dl;
},getHelpMenu:function(){var dr=new qx.ui.menu.Menu;
var dt=new qx.ui.menu.Button(F,b);
var dv=new qx.ui.menu.Button(Y);
var du=new qx.ui.menu.Button(by);
var ds=new qx.ui.menu.Button(q);
dt.addListener(bB,this.debugButton);
dv.addListener(bB,this.debugButton);
du.addListener(bB,this.debugButton);
ds.addListener(bB,this.debugButton);
dr.add(dt);
dr.add(dv);
dr.addSeparator();
dr.add(du);
...
dr.add(ds);
return dr;
}},destruct:function(){this._disposeObjects(bV,bh,bS,bO,bF,P,j,s);
}});
})();
