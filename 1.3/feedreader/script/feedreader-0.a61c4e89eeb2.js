...
},__ie:[r,G,E,m,y,I],getKeys:({"ES5":Object.keys,"BROKEN_IE":function(bs){var bt=[];
var bv=Object.prototype.hasOwnProperty;

for(var bw in bs){if(bv.call(bs,bw)){bt.push(bw);
}}var bu=qx.Bootstrap.__ie;
...
},__if:{"[object String]":d,"[object Array]":f,"[object Object]":h,"[object RegExp]":D,"[object Number]":x,"[object Boolean]":K,"[object Date]":s,"[object Function]":c,"[object Error]":J},bind:function(bE,self,bF){var bG=Array.prototype.slice.call(arguments,2,arguments.length);
...
return (qx.Bootstrap.__if[bL]||bL.slice(8,-1));
...
qx.Bootstrap.define(d,{statics:{__kH:[],wrap:function(e,f,g){var m=[];
var h=[];
var l=this.__kH;
var k;
...
j.original=f;
return j;
},addAdvice:function(o,p,q,name){this.__kH.push({fcn:o,pos:p===c?-1:1,type:q,name:name});
}}});
})();
...
qx.Bootstrap.define(a,{statics:{__kY:{},__la:{},compilerIsSet:function(){return true;
},define:function(y,z,A){{};

if(!this.__kY[y]){this.__kY[y]={};
}else{}this.__kY[y].allowedValues=z;
this.__kY[y].defaultValue=A;
},get:function(B){var C=this.__kY[B];
{};

if(C.value!==undefined){return C.value;
}return C.defaultValue;
},__lb:function(){if(window.qxvariants){for(var D in qxvariants){{};

if(!this.__kY[D]){this.__kY[D]={};
}this.__kY[D].value=qxvariants[D];
}window.qxvariants=undefined;

try{delete window.qxvariants;
}catch(E){}this.__lc(this.__kY);
}},__lc:function(){if(qx.core.Setting.get(e)!=true){return;
...
if(!this.__kY[H]){this.__kY[H]={};
}this.__kY[H].value=decodeURIComponent(G[2]);
}},select:function(I,J){{};
...
if(this.__la[N]!==undefined){return this.__la[N];
}var P=false;
...
},__le:function(v){return typeof v===s&&v!==null&&!(v instanceof Array);
},__lf:function(Q,R){for(var i=0,l=Q.length;i<l;i++){if(Q[i]==R){return true;
}}return false;
...
qx.Bootstrap.define(d,{statics:{__lG:{"Boolean":cM,"String":bG,"Number":ci,"Integer":cm,"PositiveNumber":D,"PositiveInteger":v,"Error":cY,"RegExp":cg,"Object":bI,"Array":F,"Map":bU,"Function":bR,"Date":cU,"Node":z,"Element":p,"Document":j,"Window":cR,"Event":cQ,"Class":bJ,"Mixin":m,"Interface":s,"Theme":bE,"Color":g,"Decorator":B,"Font":h},__lH:{"Node":true,"Element":true,"Document":true,"Window":true,"Event":true},$$inherit:P,$$store:{runtime:{},user:{},theme:{},inherit:{},init:{},useinit:{}},$$method:{get:{},set:{},reset:{},init:{},refresh:{},setRuntime:{},resetRuntime:{},setThemed:{},resetThemed:{}},$$allowedKeys:{name:bw,dereference:bt,inheritable:bt,nullable:bt,themeable:bt,refine:bt,init:null,apply:bw,event:bw,check:null,transform:bw,deferredInit:bt,validate:null},$$allowedGroupKeys:{name:bw,group:bO,mode:bw,themeable:bt},$$inheritable:{},__lI:function(df){var dg=this.__lJ(df);

if(!dg.length){var dh=qx.lang.Function.empty;
}else{dh=this.__lK(dg);
}df.prototype.$$refreshInheritables=dh;
},__lJ:function(di){var dk=[];
...
},__lK:function(dl){var dq=this.$$store.inherit;
...
},attachRefreshInheritables:function(dr){dr.prototype.$$refreshInheritables=function(){qx.core.Property.__lI(dr);
return this.$$refreshInheritables();
};
},attachMethods:function(ds,name,dt){dt.group?this.__lL(ds,dt,name):this.__lM(ds,dt,name);
},__lL:function(du,dv,name){var dC=qx.Bootstrap.firstUp(name);
var dB=du.prototype;
...
}},__lM:function(dF,dG,name){var dI=qx.Bootstrap.firstUp(name);
var dK=dF.prototype;
{};
if(dG.dereference===undefined&&typeof dG.check===bw){dG.dereference=this.__lN(dG.check);
}var dJ=this.$$method;
var dH=this.$$store;
...
}},__lN:function(dQ){return !!this.__lH[dQ];
},__lO:function(dR){return this.__lH[dR]||qx.Bootstrap.classIsDefined(dR)||(qx.Interface&&qx.Interface.isDefined(dR));
},__lP:{0:b,1:Y,2:dd,3:bm,4:cn,5:U},error:function(dS,dT,dU,dV,dW){var dX=dS.constructor.classname;
var dY=r+dU+N+dX+da+this.$$method[dV][dU]+cL+dW+M;
throw new Error(dY+(this.__lP[dT]||"Unknown reason: "+dT));
},__lQ:function(ea,eb,name,ec,ed,ee){var ef=this.$$method[ec][name];
...
}return this.__lQ(eg,em,name,ei,ej);
...
var ew=this.__lR(ep,name);
this.__lS(es,ev,name,ep,er);

if(er){this.__lT(es,eo,ev,name);
}
if(et){this.__lU(es,er,ew,ep);
}
if(ev.inheritable){es.push(bb);
}{};

if(!et){this.__lW(es,name,ep,er);
}else{this.__lX(es,ev,name,ep,er);
}
if(ev.inheritable){this.__lY(es,ev,name,ep);
}else if(et){this.__ma(es,ev,name,ep);
}
if(et){this.__mb(es,ev,name);
if(ev.inheritable&&eu._getChildren){this.__mc(es,name);
}}if(er){es.push(bi);
}return this.__lQ(en,eu,name,ep,es,eq);
},__lR:function(ex,name){if(ex===ct||ex===bs){var ey=this.$$store.runtime[name];
}else if(ex===cu||ex===by){ey=this.$$store.theme[name];
}else if(ex===cs){ey=this.$$store.init[name];
}else{ey=this.$$store.user[name];
}return ey;
},__lS:function(ez,eA,name,eB,eC){{if(!eA.nullable||eA.check||eA.inheritable){ez.push(cK);
}if(eB===cv){ez.push(V,name,w,eB,ba);
}};
},__lT:function(eD,eE,eF,name){if(eF.transform){eD.push(x,eF.transform,cb);
...
eD.push(cV);
}}},__lU:function(eG,eH,eI,eJ){var eK=(eJ===bu||eJ===by||eJ===bs);

if(eH){eG.push(cr,eI,k);
}else if(eK){eG.push(cr,eI,y);
}},__lV:undefined,__lW:function(eL,name,eM,eN){if(eM===ct){eL.push(cw,this.$$store.runtime[name],cx);
...
}},__lX:function(eO,eP,name,eQ,eR){if(eP.inheritable){eO.push(S,this.$$store.inherit[name],cz);
}else{eO.push(bP);
...
}},__lY:function(eS,eT,name,eU){eS.push(E);
...
},__ma:function(eV,eW,name,eX){if(eX!==cv&&eX!==ct&&eX!==cu){eV.push(bT);
}eV.push(cd);
if(eW.init!==undefined&&eX!==cs){eV.push(cI,this.$$store.init[name],cC);
}else{eV.push(cc);
}},__mb:function(eY,fa,name){if(fa.apply){eY.push(cw,fa.apply,bh,name,bH);
}if(fa.event){eY.push(bD,bl,fa.event,A,ck,fa.event,bc,K);
}},__mc:function(fb,name){fb.push(cX);
...
},members:{__ir:0,__is:0,__it:false,__iu:0,__iv:null,__iw:null,setMaxEntries:function(c){this.__iw=c;
this.clear();
},getMaxEntries:function(){return this.__iw;
},addEntry:function(d){this.__iv[this.__ir]=d;
this.__ir=this.__ix(this.__ir,1);
var e=this.getMaxEntries();

if(this.__is<e){this.__is++;
}if(this.__it&&(this.__iu<e)){this.__iu++;
}},mark:function(){this.__it=true;
this.__iu=0;
},clearMark:function(){this.__it=false;
},getAllEntries:function(){return this.getEntries(this.getMaxEntries(),false);
},getEntries:function(f,g){if(f>this.__is){f=this.__is;
}if(g&&this.__it&&(f>this.__iu)){f=this.__iu;
}
if(f>0){var i=this.__ix(this.__ir,-1);
var h=this.__ix(i,-f+1);
var j;

if(h<=i){j=this.__iv.slice(h,i+1);
}else{j=this.__iv.slice(h,this.__is).concat(this.__iv.slice(0,i+1));
}}else{j=[];
}return j;
},clear:function(){this.__iv=new Array(this.getMaxEntries());
this.__is=0;
this.__iu=0;
this.__ir=0;
},__ix:function(k,l){var m=this.getMaxEntries();
var n=(k+l)%m;
if(n<0){n+=m;
}return n;
}}});
...
},"webkit":function(Q){if(Q.sourceURL&&Q.line){return [this.__kS(Q.sourceURL)+j+Q.line];
}else{return [];
...
},__lx:qx.event.Registration,addListener:function(H,I,self,J){if(!this.$$disposed){return this.__lx.addListener(this,H,I,self,J);
}return null;
},addListenerOnce:function(K,L,self,M){var N=function(e){this.removeListener(K,N,this,M);
L.call(self||this,e);
};
return this.addListener(K,N,this,M);
},removeListener:function(O,P,self,Q){if(!this.$$disposed){return this.__lx.removeListener(this,O,P,self,Q);
}return false;
},removeListenerById:function(R){if(!this.$$disposed){return this.__lx.removeListenerById(this,R);
}return false;
},hasListener:function(S,T){return this.__lx.hasListener(this,S,T);
},dispatchEvent:function(U){if(!this.$$disposed){return this.__lx.dispatchEvent(this,U);
}return true;
},fireEvent:function(V,W,X){if(!this.$$disposed){return this.__lx.fireEvent(this,V,W,X);
}return true;
},fireNonBubblingEvent:function(Y,ba,bb){if(!this.$$disposed){return this.__lx.fireNonBubblingEvent(this,Y,ba,bb);
}return true;
},fireDataEvent:function(bc,bd,be,bf){if(!this.$$disposed){if(be===undefined){be=null;
}return this.__lx.fireNonBubblingEvent(this,bc,qx.event.type.Data,[bd,be,!!bf]);
}return true;
},__ly:null,setUserData:function(bg,bh){if(!this.__ly){this.__ly={};
}this.__ly[bg]=bh;
},getUserData:function(bi){if(!this.__ly){return null;
}var bj=this.__ly[bi];
return bj===undefined?null:bj;
},__lz:qx.log.Logger,debug:function(bk){this.__lA(f,arguments);
},info:function(bl){this.__lA(m,arguments);
},warn:function(bm){this.__lA(h,arguments);
},error:function(bn){this.__lA(j,arguments);
},trace:function(){this.__lz.trace(this);
},__lA:function(bo,bp){var bq=qx.lang.Array.fromArguments(bp);
bq.unshift(this);
this.__lz[bo].apply(this.__lz,bq);
...
}if(this.__lB){this.__lB();
}{};
},__lB:null,__lC:function(){var bx=qx.Class.getProperties(this.constructor);
...
qx.Bootstrap.define(g,{statics:{STANDARD_MODE:false,QUIRKS_MODE:false,CONTENT_BOX:false,BORDER_BOX:false,SVG:false,CANVAS:!!window.CanvasRenderingContext2D,VML:false,XPATH:!!document.evaluate,AIR:navigator.userAgent.indexOf("adobeair")!==-1,GEARS:!!(window.google&&window.google.gears),SSL:window.location.protocol==="https:",ECMA_OBJECT_COUNT:(({}).__count__==0),CSS_POINTER_EVENTS:false,XUL:false,CSS_TEXT_OVERFLOW:("textOverflow" in document.documentElement.style||"OTextOverflow" in document.documentElement.style),HTML5_CLASSLIST:(document.documentElement.classList&&qx.Bootstrap.getClass(document.documentElement.classList)==="DOMTokenList"),TOUCH:("ontouchstart" in window),PLACEHOLDER:false,__gH:function(){this.QUIRKS_MODE=this.__gI();
...
}}},__gI:function(){if(qx.bom.client.Engine.MSHTML&&qx.bom.client.Engine.VERSION>=8){return qx.bom.client.Engine.DOCUMENT_MODE===5;
}else{return document.compatMode!==f;
}}},defer:function(h){h.__gH();
}});
})();
...
qx.Class.define(a,{type:b,extend:qx.core.Object,members:{__gA:null,_invalidChildrenCache:null,__gB:null,invalidateLayoutCache:function(){this.__gA=null;
},renderLayout:function(c,d){this.warn("Missing renderLayout() implementation!");
},getSizeHint:function(){if(this.__gA){return this.__gA;
}return this.__gA=this._computeSizeHint();
},hasHeightForWidth:function(){return false;
},getHeightForWidth:function(e){this.warn("Missing getHeightForWidth() implementation!");
return null;
},_computeSizeHint:function(){return null;
},invalidateChildrenCache:function(){this._invalidChildrenCache=true;
},verifyLayoutProperty:null,_clearSeparators:function(){var f=this.__gB;

if(f instanceof qx.ui.core.LayoutItem){f.clearSeparators();
}},_renderSeparator:function(g,h){this.__gB.renderSeparator(g,h);
},connectToWidget:function(i){if(i&&this.__gB){throw new Error("It is not possible to manually set the connected widget.");
}this.__gB=i;
this.invalidateChildrenCache();
},_getWidget:function(){return this.__gB;
},_applyLayoutChange:function(){if(this.__gB){this.__gB.scheduleLayoutUpdate();
}},_getLayoutChildren:function(){return this.__gB.getLayoutChildren();
}},destruct:function(){this.__gB=this.__gA=null;
}});
})();
...
qx.Bootstrap.define(a,{statics:{setErrorHandler:function(d,f){this.__ky=d||null;
this.__kz=f||window;

if(qx.core.Setting.get(c)===b){if(d&&window.onerror){var g=qx.Bootstrap.bind(this.__kB,this);

if(this.__kA==null){this.__kA=window.onerror;
}var self=this;
window.onerror=function(e){self.__kA(e);
g(e);
};
}
if(d&&!window.onerror){window.onerror=qx.Bootstrap.bind(this.__kB,this);
}if(this.__ky==null){if(this.__kA!=null){window.onerror=this.__kA;
this.__kA=null;
}else{window.onerror=null;
}}}},__kB:function(h,i,j){if(this.__ky){this.handleError(new qx.core.WindowError(h,i,j));
return true;
}},observeMethod:function(k){if(qx.core.Setting.get(c)===b){var self=this;
return function(){if(!self.__ky){return k.apply(this,arguments);
}
try{return k.apply(this,arguments);
}catch(l){self.handleError(new qx.core.GlobalError(l,arguments));
}};
}else{return k;
}},handleError:function(m){if(this.__ky){this.__ky.call(this.__kz,m);
...
qx.Class.define(l,{statics:{__kM:null,getScrollbarWidth:function(){if(this.__kM!==null){return this.__kM;
}var z=qx.bom.element.Style;
var B=function(F,G){return parseInt(z.get(F,G))||0;
};
...
this.__kT=b+(c&&c.message?c.message:c);
Error.call(this,this.__kT);
this.__kU=d;
this.__kV=c;
},members:{__kV:null,__kU:null,__kT:null,toString:function(){return this.__kT;
},getArguments:function(){return this.__kU;
},getSourceException:function(){return this.__kV;
...
return this.__cG()[n];
},__cG:function(){var p=this.getType()==a||this.getType()==c;
var o=(p?this.getChangedTargetTouches():this.getTargetTouches());
return o;
}}});
})();
...
j.target=i.target;
return j;
},__kE:{0:h,2:g,1:f},__kF:{1:h,2:g,4:f},stop:function(){this.stopPropagation();
},getButton:function(){switch(this._type){case c:return g;
case d:if(this.__kG){return this.__kG();
}default:if(this._native.target!==undefined){return this.__kE[this._native.button]||e;
}else{return this.__kF[this._native.button]||e;
}}},__kG:qx.core.Variant.select(a,{"mshtml":function(){return h;
...
this.__ib=b;
this.__ic=c||null;
this.__id=qx.util.DeferredCallManager.getInstance();
},members:{__ib:null,__ic:null,__id:null,cancel:function(){this.__id.cancel(this);
},schedule:function(){this.__id.schedule(this);
},call:function(){this.__ic?this.__ib.apply(this.__ic):this.__ib();
}},destruct:function(d,e){this.cancel();
this.__ic=this.__ib=this.__id=null;
}});
})();
...
this.__dL={};
this.__dM={};
},properties:{theme:{check:d,nullable:true,event:c,apply:g}},members:{__dN:{},__dL:null,__dM:null,_applyTheme:function(i,j){this.__dM={};
this.__dL={};
},__dO:function(k,l,m){var q=l.appearances;
var t=q[k];
...
return this.__dO(p,l,m);
}}}if(m!=null){return this.__dO(m,l);
}return null;
}else if(typeof t===h){return this.__dO(t,l,m);
}else if(t.include&&!t.style){return this.__dO(t.include,l,m);
}return k;
},styleFrom:function(v,w,x,y){if(!x){x=this.getTheme();
}var E=this.__dM;
var z=E[v];

if(!z){z=E[v]=this.__dO(v,x,y);
...
this.__dY=eG.addListener(bA,function(){if(eE&&eE.translate){this.setToolTipText(eE.translate());
}},this);
}},_applyTextColor:function(eH,eI){},_applyZIndex:function(eJ,eK){this.getContainerElement().setStyle(bI,eJ==null?0:eJ);
},_applyVisibility:function(eL,eM){var eN=this.getContainerElement();

if(eL===bR){eN.show();
}else{eN.hide();
}var parent=this.$$parent;

if(parent&&(eM==null||eL==null||eM===bM||eL===bM)){parent.invalidateLayoutChildren();
}qx.ui.core.queue.Visibility.add(this);
},_applyOpacity:function(eO,eP){this.getContainerElement().setStyle(bL,eO==1?null:eO);
if(qx.core.Variant.isSet(cb,bo)&&qx.bom.element.Decoration.isAlphaImageLoaderEnabled()){if(!qx.Class.isSubClassOf(this.getContentElement().constructor,qx.html.Image)){var eQ=(eO==1||eO==null)?null:0.99;
this.getContentElement().setStyle(bL,eQ);
}}},_applyCursor:function(eR,eS){if(eR==null&&!this.isSelectable()){eR=bK;
}this.getContainerElement().setStyle(Y,eR,qx.bom.client.Engine.OPERA);
},_applyBackgroundColor:function(eT,eU){var eV=this.getBackgroundColor();
var eX=this.getContainerElement();

if(this.__dU){this.__dU.tint(eV);
eX.setStyle(bY,null);
}else{var eW=qx.theme.manager.Color.getInstance().resolve(eV);
eX.setStyle(bY,eW);
}},_applyFont:function(eY,fa){},__ei:null,$$stateChanges:null,_forwardStates:null,hasState:function(fb){var fc=this.__ei;
return !!fc&&!!fc[fb];
},addState:function(fd){var fe=this.__ei;

if(!fe){fe=this.__ei={};
}
if(fe[fd]){return;
}this.__ei[fd]=true;
if(fd===cd){this.syncAppearance();
...
}}}},removeState:function(fi){var fj=this.__ei;

if(!fj||!fj[fi]){return;
}delete this.__ei[fi];
if(fi===cd){this.syncAppearance();
}else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;
}else{qx.ui.core.queue.Appearance.add(this);
}var forward=this._forwardStates;
var fm=this.__el;
...
}}}},replaceState:function(fn,fo){var fp=this.__ei;
...
}}}},__ej:null,__ek:null,syncAppearance:function(){var fx=this.__ei;
var fw=this.__ej;
...
do{fB.push(fv.$$subcontrol||fv.getAppearance());
}while(fv=fv.$$subparent);
fw=this.__ej=fB.reverse().join(be).replace(/#[0-9]+/g,bf);
}var fz=fy.styleFrom(fw,fx,null,this.getAppearance());

if(fz){var fA;

if(ft){for(var fA in ft){if(fz[fA]===undefined){this[fC[fA]]();
}}}{};
for(var fA in fz){fz[fA]===undefined?this[fC[fA]]():this[fu[fA]](fz[fA]);
}}else if(ft){for(var fA in ft){this[fC[fA]]();
}}this.fireDataEvent(cp,this.__ei);
},_applyAppearance:function(fD,fE){this.updateAppearance();
...
if(fF instanceof qx.ui.core.Widget){fF.updateAppearance();
...
if(fN==null){fN=1;
}fM.setAttribute(br,fN);
if(qx.core.Variant.isSet(cb,bo)){fM.setAttribute(y,D);
}else{fM.setStyle(s,x);
}}else{if(fM.isNativelyFocusable()){fM.setAttribute(br,-1);
}else if(fL){fM.setAttribute(br,null);
}}},_applyKeepFocus:function(fO){var fP=this.getFocusElement();
fP.setAttribute(bz,fO?bP:null);
},_applyKeepActive:function(fQ){var fR=this.getContainerElement();
fR.setAttribute(bl,fQ?bP:null);
},_applyTabIndex:function(fS){if(fS==null){fS=1;
}else if(fS<1||fS>32000){throw new Error("TabIndex property must be between 1 and 32000");
}
if(this.getFocusable()&&fS!=null){this.getFocusElement().setAttribute(br,fS);
}},_applySelectable:function(fT,fU){if(fU!==null){this._applyCursor(this.getCursor());
}this.getContentElement().setSelectable(fT);
},_applyEnabled:function(fV,fW){if(fV===false){this.addState(bX);
this.removeState(cd);
...
}}},_applyNativeContextMenu:function(fX,fY,name){},_applyContextMenu:function(ga,gb){if(gb){gb.removeState(bt);

if(gb.getOpener()==this){gb.resetOpener();
}
if(!ga){this.removeListener(bt,this._onContextMenuOpen);
gb.removeListener(bp,this._onBeforeContextMenuOpen,this);
}}
if(ga){ga.setOpener(this);
ga.addState(bt);

if(!gb){this.addListener(bt,this._onContextMenuOpen);
ga.addListener(bp,this._onBeforeContextMenuOpen,this);
...
if(gc){this.addListener(cg,this._onDragStart);
...
}this.getContainerElement().setAttribute(cl,gc?bP:null);
},_applyDroppable:function(ge,gf){if(!this.isEnabled()&&ge===true){ge=false;
}this.getContainerElement().setAttribute(ba,ge?bP:null);
...
},scrollChildIntoView:function(gi,gj,gk,gl){this.scrollChildIntoViewX(gi,gj,gl);
...
},hasChildControl:function(gs){if(!this.__el){return false;
}return !!this.__el[gs];
},__el:null,_getCreatedChildControls:function(){return this.__el;
},getChildControl:function(gt,gu){if(!this.__el){if(gu){return null;
}this.__el={};
}var gv=this.__el[gt];
...
gx.show();
return gx;
},_excludeChildControl:function(gy){var gz=this.getChildControl(gy,true);
...
},_createChildControl:function(gC){if(!this.__el){this.__el={};
}else if(this.__el[gC]){throw new Error("Child control '"+gC+"' already created!");
}var gG=gC.indexOf(M);
...
}}}this.fireDataEvent(k,gD);
return this.__el[gC]=gD;
},_createChildControlImpl:function(gH){return null;
},_disposeChildControls:function(){var gL=this.__el;

if(!gL){return;
}var gJ=qx.ui.core.Widget;

for(var gK in gL){var gI=gL[gK];

if(!gJ.contains(this,gI)){gI.destroy();
}else{gI.dispose();
}}delete this.__el;
},_findTopControl:function(){var gM=this;

while(gM){if(!gM.$$subparent){return gM;
}gM=gM.$$subparent;
}return null;
},getContainerLocation:function(gN){var gO=this.getContainerElement().getDomElement();
return gO?qx.bom.element.Location.get(gO,gN):null;
...
if(gS){gS.style.left=gR+bV;
}else{throw new Error("DOM element is not yet created!");
}},setDomTop:function(gT){var gU=this.getContainerElement().getDomElement();

if(gU){gU.style.top=gT+bV;
}else{throw new Error("DOM element is not yet created!");
}},setDomPosition:function(gV,top){var gW=this.getContainerElement().getDomElement();

if(gW){gW.style.left=gV+bV;
gW.style.top=top+bV;
}else{throw new Error("DOM element is not yet created!");
...
if(this.__dU){ha.remove(this.__dU);
hb.__dS.poolDecorator(this.__dU);
}
if(this.__dV){ha.remove(this.__dV);
hb.__dT.poolDecorator(this.__dV);
...
},members:{$$isString:true,length:0,__md:null,toString:function(){return this.__md;
...
qx.Class.define(e,{statics:{NAME:"",WIN:false,MAC:false,UNIX:false,UNKNOWN_PLATFORM:false,__kI:function(){var o=navigator.platform;
...
qx.Bootstrap.define(w,{statics:{NAME:"",SP1:false,SP2:false,WIN95:false,WIN98:false,WINME:false,WINNT4:false,WIN2000:false,WINXP:false,WIN2003:false,WINVISTA:false,WIN7:false,WINCE:false,LINUX:false,SUNOS:false,FREEBSD:false,NETBSD:false,OPENBSD:false,OSX:false,OS9:false,SYMBIAN:false,NINTENDODS:false,PSP:false,IPHONE:false,IPAD:false,UNKNOWN_SYSTEM:false,__lv:{"Windows NT 6.1":u,"Windows NT 6.0":n,"Windows NT 5.2":s,"Windows NT 5.1":H,"Windows NT 5.0":e,"Windows 2000":e,"Windows NT 4.0":B,"Win 9x 4.90":z,"Windows CE":A,"Windows 98":j,"Win98":j,"Windows 95":f,"Win95":f,"Linux":p,"FreeBSD":G,"NetBSD":m,"OpenBSD":k,"SunOS":F,"Symbian System":v,"Nitro":C,"PSP":"sonypsp","Mac OS X 10_5":c,"Mac OS X 10.5":c,"Mac OS X 10_4":g,"Mac OS X 10.4":g,"Mac OS X 10_3":b,"Mac OS X 10.3":b,"Mac OS X 10_2":i,"Mac OS X 10.2":i,"Mac OS X 10_1":d,"Mac OS X 10.1":d,"Mac OS X 10_0":h,"Mac OS X 10.0":h,"Mac OS X":o,"Mac OS 9":q},__lw:function(){var L=navigator.userAgent;
var K=[];

for(var J in this.__lv){K.push(J);
...
this.NAME="iphone";
}}else{this.NAME=this.__lv[RegExp.$1];
...
}}}}},defer:function(N){N.__lw();
}});
})();
(function(){var a="qx.event.handler.UserAction";
qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(b){qx.core.Object.call(this);
this.__kC=b;
this.__kD=b.getWindow();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{useraction:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__kC:null,__kD:null,canHandleEvent:function(c,d){},registerEvent:function(e,f,g){},unregisterEvent:function(h,i,j){}},destruct:function(){this.__kC=this.__kD=null;
...
qx.Mixin.define(w,{statics:{__iS:null,setVisibleElement:function(y){this.__iS=y;
},getVisibleElement:function(){return this.__iS;
}},properties:{position:{check:[r,o,d,a,v,l,k,n],init:d,themeable:true},placeMethod:{check:[x,e],init:e,themeable:true},domMove:{check:b,init:false},placementModeX:{check:[c,h,f],init:h,themeable:true},placementModeY:{check:[c,h,f],init:h,themeable:true},offsetLeft:{check:j,init:0,themeable:true},offsetTop:{check:j,init:0,themeable:true},offsetRight:{check:j,init:0,themeable:true},offsetBottom:{check:j,init:0,themeable:true},offset:{group:[m,u,p,s],mode:t,themeable:true}},members:{__iT:null,__iU:null,__iV:null,getLayoutLocation:function(z){var C,B,D,top;
B=z.getBounds();
D=B.left;
top=B.top;
var E=B;
...
}},placeToWidget:function(L,M){if(M){this.__iW();
this.__iT=qx.lang.Function.bind(this.placeToWidget,this,L,false);
qx.event.Idle.getInstance().addListener(i,this.__iT);
this.__iV=function(){this.__iW();
};
this.addListener(g,this.__iV,this);
}var N=L.getContainerLocation()||this.getLayoutLocation(L);
this.__iY(N);
},__iW:function(){if(this.__iT){qx.event.Idle.getInstance().removeListener(i,this.__iT);
this.__iT=null;
}
if(this.__iV){this.removeListener(g,this.__iV,this);
this.__iV=null;
...
if(R){this.__iT=qx.lang.Function.bind(this.placeToElement,this,Q,false);
qx.event.Idle.getInstance().addListener(i,this.__iT);
this.addListener(g,function(){if(this.__iT){qx.event.Idle.getInstance().removeListener(i,this.__iT);
this.__iT=null;
}},this);
}this.__iY(S);
...
},__iX:function(V){var W=null;

if(this._computePlacementSize){var W=this._computePlacementSize();
}else if(this.isVisible()){var W=this.getBounds();
}
if(W==null){this.addListenerOnce(q,function(){this.__iX(V);
},this);
}else{V.call(this,W);
}},__iY:function(X){this.__iX(function(Y){var ba=qx.util.placement.Placement.compute(Y,this.getLayoutParent().getBounds(),X,this._getPlacementOffsets(),this.getPosition(),this.getPlacementModeX(),this.getPlacementModeY());
this.moveTo(ba.left,ba.top);
});
}},destruct:function(){this.__iW();
}});
})();
...
if(!bb){this.__gq(W.targetObject,W.targetPropertyChain);
break;
...
var Y=bb.getItem(bc);
this.__gt(Y,W.targetObject,W.targetPropertyChain,W.options,W.sources[W.index]);
W.listenerIds[j]=this.__gv(bb,g,W.targetObject,W.targetPropertyChain,W.options,W.arrayIndexValues[j]);
...
this.__gt(Y,W.targetObject,W.targetPropertyChain,W.options,W.sources[W.index]);
}var ba=this.__gp(bb,W.propertyNames[j]);
W.listenerIds[j]=this.__gv(bb,ba,W.targetObject,W.targetPropertyChain,W.options);
...
}else{var ba=this.__gp(bb,W.propertyNames[j]);
...
}else{try{bm.push(this.__gp(bk,bl[i]));
}catch(e){break;
}}bq[i]=bk;
...
}else{try{var bs=qx.data.SingleValueBinding.__gp(bt,bl[j]);
}catch(e){break;
}}bn[j]=bt.addListener(bs,bp[j]);
}qx.data.SingleValueBinding.__go(bd,be,bf,bg,bh);
};
bp.push(bo);
...
},__go:function(bv,bw,bx,by,bz){var bD=this.__gs(bv,bw);
...
}}bB=qx.data.SingleValueBinding.__gx(bB,bx,by,bz);
this.__gr(bx,by,bB);
},__gp:function(bG,bH){var bI=this.__gy(bG,bH);
...
}}},__gs:function(bV,bW){var ca=bW.split(d);
var cb=bV;
...
},__gt:function(cd,ce,cf,cg,ch){cd=this.__gx(cd,ce,cf,cg);
if(cd===undefined){this.__gq(ce,cf);
}if(cd!==undefined){try{this.__gr(ce,cf,cd);
...
if(ck!==h){if(ck==l||isNaN(parseInt(ck))){throw new Error("No number or 'last' value hast been given"+" in a array binding: "+name+" does not work.");
...
},__gv:function(cl,cm,cn,co,cp,cq){var cr;
{};
var ct=function(cu,e){if(cu!==l){if(cu===h){cu=cl.length-1;
}var cx=cl.getItem(cu);
if(cx===undefined){qx.data.SingleValueBinding.__gq(cn,co);
...
}cx=qx.data.SingleValueBinding.__gx(cx,cn,co,cp);
if(qx.data.SingleValueBinding.DEBUG_ON){qx.log.Logger.debug("Data after conversion: "+cx);
}try{if(cx!==undefined){qx.data.SingleValueBinding.__gr(cn,co,cx);
}else{qx.data.SingleValueBinding.__gq(cn,co);
...
return cs;
},__gw:function(cy,cz,cA,cB,cC){if(this.__gl[cz.toHashCode()]===undefined){this.__gl[cz.toHashCode()]=[];
}this.__gl[cz.toHashCode()].push([cy,cz,cA,cB,cC]);
},__gx:function(cD,cE,cF,cG){if(cG&&cG.converter){var cI;

if(cE.getModel){cI=cE.getModel();
}return cG.converter(cD,cI);
}else{var cK=this.__gs(cE,cF);
...
return this.__gz(cD,cH);
}},__gy:function(cM,cN){var cO=qx.Class.getPropertyDefinition(cM.constructor,cN);

if(cO==null){return null;
}return cO.event;
},__gz:function(cP,cQ){var cR=qx.lang.Type.getClass(cP);
if((cR==c||cR==b)&&(cQ==x||cQ==q)){cP=parseInt(cP);
...
}else if(this.isRgbString(m)){return this.__gC();
}else if(this.isHex3String(m)){return this.__gE();
}else if(this.isHex6String(m)){return this.__gF();
}throw new Error("Could not parse color: "+m);
},cssStringToRgb:function(n){if(this.isNamedColor(n)){return this.NAMED[n];
}else if(this.isSystemColor(n)){throw new Error("Could not convert system colors to RGB: "+n);
}else if(this.isRgbString(n)){return this.__gC();
}else if(this.isRgbaString(n)){return this.__gD();
}else if(this.isHex3String(n)){return this.__gE();
}else if(this.isHex6String(n)){return this.__gF();
...
},__gC:function(){var D=parseInt(RegExp.$1,10);
var C=parseInt(RegExp.$2,10);
var B=parseInt(RegExp.$3,10);
return [D,C,B];
},__gD:function(){var G=parseInt(RegExp.$1,10);
var F=parseInt(RegExp.$2,10);
var E=parseInt(RegExp.$3,10);
return [G,F,E];
},__gE:function(){var J=parseInt(RegExp.$1,16)*17;
var I=parseInt(RegExp.$2,16)*17;
var H=parseInt(RegExp.$3,16)*17;
return [J,I,H];
},__gF:function(){var M=(parseInt(RegExp.$1,16)*16)+parseInt(RegExp.$2,16);
var L=(parseInt(RegExp.$3,16)*16)+parseInt(RegExp.$4,16);
var K=(parseInt(RegExp.$5,16)*16)+parseInt(RegExp.$6,16);
return [M,L,K];
},hex3StringToRgb:function(N){if(this.isHex3String(N)){return this.__gE(N);
}throw new Error("Invalid hex3 value: "+N);
},hex6StringToRgb:function(O){if(this.isHex6String(O)){return this.__gF(O);
}throw new Error("Invalid hex6 value: "+O);
},hexStringToRgb:function(P){if(this.isHex3String(P)){return this.__gE(P);
}
if(this.isHex6String(P)){return this.__gF(P);
...
this.__gG={};
this.add(a,h);
},members:{__gG:null,_preprocess:function(k){var n=this._getDynamic();

if(n[k]===false){return k;
}else if(n[k]===undefined){if(k.charAt(0)===j||k.charAt(0)===b||k.indexOf(g)===0||k.indexOf(f)===i||k.indexOf(e)===0){n[k]=false;
return k;
}
if(this.__gG[k]){return this.__gG[k];
}var m=k.substring(0,k.indexOf(j));
var l=this.__gG[m];

if(l!==undefined){n[k]=l+k.substring(m.length);
}}return k;
},add:function(o,p){this.__gG[o]=p;
var r=this._getDynamic();
for(var q in r){if(q.substring(0,q.indexOf(j))===o){r[q]=p+q.substring(o.length);
}}},remove:function(s){delete this.__gG[s];
...
}},properties:{rich:{check:j,init:false,event:s,apply:q},wrap:{check:j,init:true,apply:C},value:{check:u,apply:x,event:m,nullable:true},buddy:{check:c,apply:v,nullable:true,init:null,dereference:true},textAlign:{check:[l,w,r],nullable:true,themeable:true,apply:d,event:a},appearance:{refine:true,init:o},selectable:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},allowShrinkY:{refine:true,init:false}},members:{__gJ:null,__gK:null,__gL:null,__gM:null,_getContentHint:function(){if(this.__gK){this.__gN=this.__gO();
delete this.__gK;
}return {width:this.__gN.width,height:this.__gN.height};
...
}},__gN:{width:0,height:0},_applyFont:function(K,L){var M;

if(K){this.__gJ=qx.theme.manager.Font.getInstance().resolve(K);
M=this.__gJ.getStyles();
}else{this.__gJ=null;
M=qx.bom.Font.getDefaultStyles();
}this.getContentElement().setStyles(M);
this.__gK=true;
qx.ui.core.queue.Layout.add(this);
},__gO:function(N){var R=qx.bom.Label;
var P=this.getFont();
var O=P?this.__gJ.getStyles():qx.bom.Font.getDefaultStyles();
var content=this.getValue()||B;
var Q=this.getRich();
return Q?R.getHtmlSize(content,O,N):R.getTextSize(content,O);
},_applyBuddy:function(S,T){if(T!=null){T.removeBinding(this.__gL);
this.__gL=null;
this.removeListenerById(this.__gM);
this.__gM=null;
}
if(S!=null){this.__gL=S.bind(g,this,g);
this.__gM=this.addListener(n,function(){if(S.isFocusable()){S.focus.apply(S);
}},this);
...
}if(this.__gL!=null){var bb=this.getBuddy();

if(bb!=null&&!bb.isDisposed()){bb.removeBinding(this.__gL);
}}this.__gJ=this.__gL=null;
}});
})();
...
this.__gP=bv;
this.__gQ=bv.getWindow();
if(qx.core.Variant.isSet(l,bs)){this.__gR=this.__gQ;
}else{this.__gR=this.__gQ.document.documentElement;
}this.__gS={};
...
}}},members:{__gT:null,__gP:null,__gQ:null,__gR:null,__gS:null,__gU:null,__gV:null,__gW:null,canHandleEvent:function(bx,by){},registerEvent:function(bz,bA,bB){},unregisterEvent:function(bC,bD,bE){},_fireInputEvent:function(bF,bG){var bH=this.__gX();
if(bH&&bH.offsetWidth!=0){var event=qx.event.Registration.createEvent(s,qx.event.type.KeyInput,[bF,bH,bG]);
this.__gP.dispatchEvent(bH,event);
}if(this.__gQ){qx.event.Registration.fireEvent(this.__gQ,u,qx.event.type.Data,[s]);
}},_fireSequenceEvent:function(bI,bJ,bK){var bL=this.__gX();
var bM=bI.keyCode;
var event=qx.event.Registration.createEvent(bJ,qx.event.type.KeySequence,[bI,bL,bK]);
this.__gP.dispatchEvent(bL,event);
...
}}}if(this.__gQ){qx.event.Registration.fireEvent(this.__gQ,u,qx.event.type.Data,[bJ]);
}},__gX:function(){var bN=this.__gP.getHandler(qx.event.handler.Focus);
var bO=bN.getActive();
if(!bO||bO.offsetWidth==0){bO=bN.getFocus();
}if(!bO||bO.offsetWidth==0){bO=this.__gP.getWindow().document.body;
}return bO;
},_initKeyObserver:function(){this.__gT=qx.lang.Function.listener(this.__gY,this);
this.__gW=qx.lang.Function.listener(this.__hb,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__gR,i,this.__gT);
Event.addNativeListener(this.__gR,m,this.__gT);
Event.addNativeListener(this.__gR,k,this.__gW);
},_stopKeyObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__gR,i,this.__gT);
Event.removeNativeListener(this.__gR,m,this.__gT);
Event.removeNativeListener(this.__gR,k,this.__gW);

for(var bQ in (this.__gV||{})){var bP=this.__gV[bQ];
Event.removeNativeListener(bP.target,k,bP.callback);
}delete (this.__gV);
},__gY:qx.event.GlobalError.observeMethod(qx.core.Variant.select(l,{"mshtml":function(bR){bR=window.event||bR;
var bU=bR.keyCode;
var bS=0;
var bT=bR.type;
if(!(this.__gS[bU]==m&&bT==m)){this._idealKeyHandler(bU,bS,bT,bR);
...
if(!(this.__gS[bW]==m&&bY==m)){this._idealKeyHandler(ca,bX,bY,bV);
}this.__gS[bW]=bY;
}else{this._idealKeyHandler(ca,bX,bY,bV);
}this.__ha(bV.target,bY,ca);
...
}},"opera":function(cf){this.__gU=cf.keyCode;
this._idealKeyHandler(cf.keyCode,0,cf.type,cf);
}})),__ha:qx.core.Variant.select(l,{"gecko":function(cg,ch,ci){if(ch===m&&(ci==33||ci==34||ci==38||ci==40)&&cg.type==J&&cg.tagName.toLowerCase()===H&&cg.getAttribute(N)!==x){if(!this.__gV){this.__gV={};
}var ck=qx.core.ObjectRegistry.toHashCode(cg);

if(this.__gV[ck]){return;
}var self=this;
this.__gV[ck]={target:cg,callback:function(cl){qx.bom.Event.stopPropagation(cl);
self.__hb(cl);
}};
var cj=qx.event.GlobalError.observeMethod(this.__gV[ck].callback);
qx.bom.Event.addNativeListener(cg,k,cj);
}},"default":null}),__hb:qx.event.GlobalError.observeMethod(qx.core.Variant.select(l,{"mshtml":function(cm){cm=window.event||cm;
...
var cw=cv.type;
if(cx!=this.__gU){this._idealKeyHandler(0,this.__gU,cw,cv);
...
this.__gU=this.__gP=this.__gQ=this.__gR=this.__gS=null;
...
qx.Class.define(e,{statics:{__hc:{names:{"class":b,"for":x,html:q,text:qx.core.Variant.isSet(h,l)?r:a,colspan:k,rowspan:d,valign:c,datetime:n,accesskey:f,tabindex:p,maxlength:o,readonly:g,longdesc:w,cellpadding:m,cellspacing:v,frameborder:u,usemap:s},runtime:{"html":1,"text":1},bools:{compact:1,nowrap:1,ismap:1,declare:1,noshade:1,checked:1,disabled:1,readOnly:1,multiple:1,selected:1,noresize:1,defer:1,allowTransparency:1},property:{$$html:1,$$widget:1,disabled:1,checked:1,readOnly:1,multiple:1,selected:1,value:1,maxLength:1,className:1,innerHTML:1,innerText:1,textContent:1,htmlFor:1,tabIndex:1},qxProperties:{$$widget:1,$$html:1},propertyDefault:{disabled:false,checked:false,readOnly:false,multiple:false,selected:false,value:j,className:j,innerHTML:j,innerText:j,textContent:j,htmlFor:j,tabIndex:0,maxLength:qx.core.Variant.select(h,{"mshtml":2147483647,"webkit":524288,"default":-1})},removeableProperties:{disabled:1,multiple:1,maxLength:1},original:{href:1,src:1,type:1}},compile:function(z){var A=[];
var C=this.__hc.runtime;

for(var B in z){if(!C[B]){A.push(B,t,z[B],y);
}}return A.join(j);
},get:qx.core.Variant.select(h,{"mshtml":function(D,name){var F=this.__hc;
var E;
...
},"default":function(G,name){var I=this.__hc;
var H;
...
this.__hV=f;
this.__hW=f.getWindow();
this._initObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{orientationchange:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__hV:null,__hW:null,__hX:null,__hY:null,__ia:null,canHandleEvent:function(g,h){},registerEvent:function(i,j,k){},unregisterEvent:function(l,m,n){},_initObserver:function(){this.__ia=qx.lang.Function.listener(this._onNative,this);
this.__hX=qx.bom.Event.supportsEvent(this.__hW,e)?e:d;
var Event=qx.bom.Event;
Event.addNativeListener(this.__hW,this.__hX,this.__ia);
},_stopObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__hW,this.__hX,this.__ia);
},_onNative:qx.event.GlobalError.observeMethod(function(o){var q=qx.bom.Viewport;
var p=q.getOrientation();

if(this.__hY!=p){this.__hY=p;
var r=q.isLandscape()?c:b;
qx.event.Registration.fireEvent(this.__hW,e,qx.event.type.Orientation,[p,r]);
}})},destruct:function(){this._stopObserver();
this.__hV=this.__hW=null;
...
this.__hd=u;
this.__he=u.getWindow();
this.__hf=this.__he.document;
this._initTouchObserver();
this._initMouseObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{touchstart:1,touchmove:1,touchend:1,touchcancel:1,tap:1,swipe:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT,IGNORE_CAN_HANDLE:true,MOUSE_TO_TOUCH_MAPPING:{"mousedown":"touchstart","mousemove":"touchmove","mouseup":"touchend"},SWIPE_DIRECTION:{x:["left","right"],y:["up","down"]},TAP_MAX_DISTANCE:10,SWIPE_MIN_DISTANCE:11,SWIPE_MIN_VELOCITY:0},members:{__hg:null,__hh:null,__hd:null,__he:null,__hf:null,__hi:null,__hj:null,__hk:null,__hl:null,__hm:false,__hn:null,canHandleEvent:function(v,w){},registerEvent:function(x,y,z){},unregisterEvent:function(A,B,C){},__ho:function(D){var E=qx.bom.Event.getTarget(D);
if(qx.core.Variant.isSet(l,b)){if(E&&E.nodeType==3){E=E.parentNode;
}}return E;
},__hp:function(F,G,H,I){if(!H){H=this.__ho(F);
}var G=G||F.type;

if(H&&H.nodeType){qx.event.Registration.fireEvent(H,G,I||qx.event.type.Touch,[F,H,null,true,true]);
}qx.event.Registration.fireEvent(this.__he,j,qx.event.type.Data,[G]);
},__hq:function(J,K,L){if(!L){L=this.__ho(J);
}var K=K||J.type;

if(K==r){this.__hr(J,L);
}else if(K==q){this.__hs(J,L);
}else if(K==s){this.__ht(J,L);
}},__hr:function(M,N){var O=M.changedTouches[0];
this.__hi=O.screenX;
this.__hj=O.screenY;
this.__hk=new Date().getTime();
this.__hl=M.changedTouches.length===1;
},__hs:function(P,Q){if(this.__hl&&P.changedTouches.length>1){this.__hl=false;
}},__ht:function(R,S){if(this.__hl){var T=R.changedTouches[0];
var V={x:T.screenX-this.__hi,y:T.screenY-this.__hj};
var W=qx.event.handler.Touch;

if(this.__hn==S&&Math.abs(V.x)<=W.TAP_MAX_DISTANCE&&Math.abs(V.y)<=W.TAP_MAX_DISTANCE){this.__hp(R,f,S,qx.event.type.Tap);
}else{var U=this.__hu(R,S,V);

if(U){R.swipe=U;
this.__hp(R,h,S,qx.event.type.Swipe);
}}}},__hu:function(X,Y,ba){var be=qx.event.handler.Touch;
var bf=new Date().getTime()-this.__hk;
...
if(Math.abs(bg)>=be.SWIPE_MIN_VELOCITY&&Math.abs(bb)>=be.SWIPE_MIN_DISTANCE){bd={startTime:this.__hk,duration:bf,axis:bh,direction:bc,distance:bb,velocity:bg};
}return bd;
},__hv:qx.core.Variant.select(t,{"on":function(bi){var bj=bi.type;
var bl=qx.event.handler.Touch.MOUSE_TO_TOUCH_MAPPING;

if(bl[bj]){bj=bl[bj];
if(bj==r&&this.__hw(bi)){this.__hm=true;
}else if(bj==s){this.__hm=false;
}var bm=this.__hx(bi);
var bk=(bj==s?[]:[bm]);
bi.touches=bk;
bi.targetTouches=bk;
...
},"default":qx.lang.Function.empty}),__hw:qx.core.Variant.select(t,{"on":function(bn){if(qx.core.Variant.isSet(l,k)){var bo=1;
}else{var bo=0;
}return bn.button==bo;
},"default":qx.lang.Function.empty}),__hx:qx.core.Variant.select(t,{"on":function(bp){var bq=this.__ho(bp);
...
},"default":qx.lang.Function.empty}),_initTouchObserver:function(){this.__hg=qx.lang.Function.listener(this._onTouchEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__hf,r,this.__hg);
Event.addNativeListener(this.__hf,q,this.__hg);
Event.addNativeListener(this.__hf,s,this.__hg);
Event.addNativeListener(this.__hf,o,this.__hg);
},_initMouseObserver:qx.core.Variant.select(t,{"on":function(){if(!qx.bom.client.Feature.TOUCH){this.__hh=qx.lang.Function.listener(this._onMouseEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__hf,m,this.__hh);
Event.addNativeListener(this.__hf,p,this.__hh);
Event.addNativeListener(this.__hf,n,this.__hh);
}},"default":qx.lang.Function.empty}),_stopTouchObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__hf,r,this.__hg);
Event.removeNativeListener(this.__hf,q,this.__hg);
Event.removeNativeListener(this.__hf,s,this.__hg);
Event.removeNativeListener(this.__hf,o,this.__hg);
},_stopMouseObserver:qx.core.Variant.select(t,{"on":function(){if(!qx.bom.client.Feature.TOUCH){var Event=qx.bom.Event;
Event.removeNativeListener(this.__hf,m,this.__hh);
Event.removeNativeListener(this.__hf,p,this.__hh);
Event.removeNativeListener(this.__hf,n,this.__hh);
...
}),_onMouseEvent:qx.core.Variant.select(t,{"on":qx.event.GlobalError.observeMethod(function(bs){if(!qx.bom.client.Feature.TOUCH){if(bs.type==p&&!this.__hm){return;
}var bt=this.__hv(bs);
...
if(bv==r){this.__hn=this.__ho(bu);
}this.__hp(bu,bv);
this.__hq(bu,bv);
}},destruct:function(){this._stopTouchObserver();
this._stopMouseObserver();
this.__hd=this.__he=this.__hf=this.__hn=null;
...
qx.Class.define(y,{statics:{DEBUG:false,__hy:{},__hz:qx.core.Variant.isSet(j,c)&&qx.bom.client.Engine.VERSION<9,__hA:qx.core.Variant.select(j,{"mshtml":{"scale-x":true,"scale-y":true,"scale":true,"no-repeat":true},"default":null}),__hB:{"scale-x":h,"scale-y":h,"scale":h,"repeat":i,"no-repeat":i,"repeat-x":i,"repeat-y":i},update:function(H,I,J,K){var M=this.getTagName(J,I);
...
if(this.__hz){try{H.filters[u].apply();
...
}},getTagName:function(U,V){if(qx.core.Variant.isSet(j,c)){if(V&&this.__hz&&this.__hA[U]&&qx.lang.String.endsWith(V,E)){return i;
}}return this.__hB[U];
...
{};
var ba;
if(this.__hz&&this.__hA[X]&&bb===r){ba=this.__hE(Y,X,W);
}else{if(X===b){ba=this.__hF(Y,X,W);
}else if(X===d||X===a){ba=this.__hG(Y,X,W);
}else{ba=this.__hJ(Y,X,W);
}}return ba;
},__hC:function(bc,bd,be){if(bc.width==null&&bd!=null){bc.width=bd+k;
}
if(bc.height==null&&be!=null){bc.height=be+k;
}return bc;
},__hD:function(bf){var bh=qx.util.ResourceManager.getInstance().getImageWidth(bf)||qx.io.ImageLoader.getWidth(bf);
var bi=qx.util.ResourceManager.getInstance().getImageHeight(bf)||qx.io.ImageLoader.getHeight(bf);
return {width:bh,height:bi};
},__hE:function(bj,bk,bl){var bo=this.__hD(bl);
bj=this.__hC(bj,bo.width,bo.height);
var bn=bk==f?D:b;
var bm=C+qx.util.ResourceManager.getInstance().toUri(bl)+x+bn+s;
bj.filter=bm;
bj.backgroundImage=bj.backgroundRepeat=g;
return {style:bj};
},__hF:function(bp,bq,br){var bs=qx.util.ResourceManager.getInstance().toUri(br);
var bt=this.__hD(br);
bp=this.__hC(bp,bt.width,bt.height);
return {src:bs,style:bp};
},__hG:function(bu,bv,bw){var bA=qx.util.ResourceManager.getInstance();
...
if(bv===d){bu=this.__hH(bu,by,bB.height);
}else{bu=this.__hI(bu,by,bB.width);
...
return {src:bx,style:bu};
}},__hH:function(bC,bD,bE){var bF=qx.util.ResourceManager.getInstance().getImageHeight(bD[4]);
...
},__hI:function(bG,bH,bI){var bJ=qx.util.ResourceManager.getInstance().getImageWidth(bH[4]);
...
},__hJ:function(bK,bL,bM){var bR=qx.util.ResourceManager.getInstance().isClippedImage(bM);
var bQ=this.__hD(bM);
...
bK=this.__hC(bK,bQ.width,bQ.height);
bK=this.__hK(bK,bM,bL);
return {style:bK};
}},__hK:function(bS,bT,bU){var top=null;
var bY=null;
...
},__hL:function(ca){if(this.DEBUG&&qx.util.ResourceManager.getInstance().has(ca)&&ca.indexOf(G)==-1){if(!this.__hy[ca]){qx.log.Logger.debug("Potential clipped image candidate: "+ca);
this.__hy[ca]=true;
}}},isAlphaImageLoaderEnabled:qx.core.Variant.select(j,{"mshtml":function(){return qx.bom.element.Decoration.__hz;
},"default":function(){return false;
}})}});
})();
(function(){var b="appearance",a="qx.ui.core.queue.Appearance";
qx.Class.define(a,{statics:{__hM:{},remove:function(c){delete this.__hM[c.$$hash];
},add:function(d){var e=this.__hM;

if(e[d.$$hash]){return;
}e[d.$$hash]=d;
qx.ui.core.queue.Manager.scheduleFlush(b);
},has:function(f){return !!this.__hM[f.$$hash];
...
(function(){var o="top",n="right",m="bottom",l="left",k="align-start",j="qx.util.placement.AbstractAxis",i="edge-start",h="align-end",g="edge-end",f="-",c="best-fit",e="qx.util.placement.Placement",d='__hN',b="keep-align",a="direct";
qx.Class.define(e,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__hN=new qx.util.placement.DirectAxis();
},properties:{axisX:{check:j},axisY:{check:j},edge:{check:[o,n,m,l],init:o},align:{check:[o,n,m,l],init:n}},statics:{__hO:null,compute:function(p,q,r,s,t,u,v){this.__hO=this.__hO||new qx.util.placement.Placement();
var y=t.split(f);
var x=y[0];
var w=y[1];
this.__hO.set({axisX:this.__hS(u),axisY:this.__hS(v),edge:x,align:w});
return this.__hO.compute(p,q,r,s);
},__hP:null,__hQ:null,__hR:null,__hS:function(z){switch(z){case a:this.__hP=this.__hP||new qx.util.placement.DirectAxis();
return this.__hP;
case b:this.__hQ=this.__hQ||new qx.util.placement.KeepAlignAxis();
return this.__hQ;
case c:this.__hR=this.__hR||new qx.util.placement.BestFitAxis();
return this.__hR;
default:throw new Error("Invalid 'mode' argument!'");
}}},members:{__hN:null,compute:function(A,B,C,D){{};
var E=this.getAxisX()||this.__hN;
var G=E.computeStart(A.width,{start:C.left,end:C.right},{start:D.left,end:D.right},B.width,this.__hT());
var F=this.getAxisY()||this.__hN;
var top=F.computeStart(A.height,{start:C.top,end:C.bottom},{start:D.top,end:D.bottom},B.height,this.__hU());
return {left:G,top:top};
},__hT:function(){var I=this.getEdge();
var H=this.getAlign();
...
}},__hU:function(){var K=this.getEdge();
var J=this.getAlign();
...
qx.Class.define(b,{statics:{__ig:{},remove:function(c){delete this.__ig[c.$$hash];
},add:function(d){this.__ig[d.$$hash]=d;
qx.ui.core.queue.Manager.scheduleFlush(a);
},flush:function(){var e=this.__ij();
...
}}},getNestingLevel:function(j){var k=this.__ii;
var m=0;
var parent=j;
...
},__ih:function(){var s=qx.ui.core.queue.Visibility;
this.__ii={};
var r=[];
var q=this.__ig;
var n,p;
...
if(o){o.__io();
}}},members:{canHandleEvent:function(p,q){},registerEvent:function(r,s,t){},unregisterEvent:function(u,v,w){},__im:null,__ik:null,__il:null,__in:null,__io:function(){if(!this.__im&&this.__ik&&qx.$$loader.scriptLoaded){try{var x=qx.core.Setting.get(f);

if(!qx.Class.getByName(x)){return;
}}catch(e){}if(qx.core.Variant.isSet(l,k)){if(qx.event.Registration.hasListener(this._window,m)){this.__im=true;
qx.event.Registration.fireEvent(this._window,m);
}}else{this.__im=true;
qx.event.Registration.fireEvent(this._window,m);
}}},isApplicationReady:function(){return this.__im;
},_initObserver:function(){if(qx.$$domReady||document.readyState==g||document.readyState==m){this.__ik=true;
this.__io();
...
},_onNativeLoad:qx.event.GlobalError.observeMethod(function(){this.__ik=true;
this.__io();
}),_onNativeUnload:qx.event.GlobalError.observeMethod(function(){if(!this.__in){this.__in=true;
...
},__ip:function(o,p){if(o[p].include){var q=o[o[p].include];
o[p].include=null;
delete o[p].include;
...
for(var v in t){if(t[v].include&&t[t[v].include]){this.__ip(t,v);
}s[v]=(new u).set(t[v]);
s[v].themed=true;
}}this._setDynamic(s);
}}});
...
},__iq:{visible:true,hidden:true},getContentWidth:function(q){var s=qx.bom.element.Style;
var t=qx.bom.element.Overflow.getX(q);
var u=parseInt(s.get(q,d)||i,10);
var x=parseInt(s.get(q,e)||i,10);

if(this.__iq[t]){var w=q.clientWidth;
...
if(this.__iq[C]){return y.clientHeight-D-B;
...
this.__iy=i.getWindow();
this.__iz=j;
i.addListener(this.__iy,f,this.releaseCapture,this);
i.addListener(this.__iy,e,this.releaseCapture,this);
i.addListener(this.__iy,a,this.releaseCapture,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST},members:{__iz:null,__iA:null,__iB:true,__iy:null,_getParent:function(k){return k.parentNode;
},canDispatchEvent:function(l,event,m){return (this.__iA&&this.__iC[m]);
},dispatchEvent:function(n,event,o){if(o==d){event.stopPropagation();
this.releaseCapture();
return;
}
if(this.__iB||!qx.dom.Hierarchy.contains(this.__iA,n)){n=this.__iA;
}qx.event.dispatch.AbstractBubbling.prototype.dispatchEvent.call(this,n,event,o);
},__iC:{"mouseup":1,"mousedown":1,"click":1,"dblclick":1,"mousemove":1,"mouseout":1,"mouseover":1},activateCapture:function(p,q){var q=q!==false;

if(this.__iA===p&&this.__iB==q){return;
}
if(this.__iA){this.releaseCapture();
...
this.__iA=p;
this.__iz.fireEvent(p,b,qx.event.type.Event,[true,false]);
},getCaptureElement:function(){return this.__iA;
},releaseCapture:function(){var r=this.__iA;

if(!r){return;
}this.__iA=null;
this.__iz.fireEvent(r,h,qx.event.type.Event,[true,false]);
...
},"default":qx.lang.Function.empty})},destruct:function(){this.__iA=this.__iy=this.__iz=null;
...
qx.Class.define(b,{statics:{__iD:{},__iE:{},remove:function(c){var d=c.$$hash;
delete this.__iE[d];
delete this.__iD[d];
},isVisible:function(e){return this.__iE[e.$$hash]||false;
},__iF:function(f){var h=this.__iE;
var g=f.$$hash;
var i;
if(f.isExcluded()){i=false;
}else{var parent=f.$$parent;

if(parent){i=this.__iF(parent);
}else{i=f.isRootWidget();
}}return h[g]=i;
},add:function(j){var k=this.__iD;

if(k[j.$$hash]){return;
}k[j.$$hash]=j;
qx.ui.core.queue.Manager.scheduleFlush(a);
},flush:function(){var l=this.__iD;
var p=this.__iE;
...
}},properties:{spacingX:{check:h,init:0,apply:p},spacingY:{check:h,init:0,apply:p}},members:{__iI:null,__iG:null,__iH:null,__iJ:null,__iK:null,__iL:null,__iM:null,__iN:null,__iO:null,verifyLayoutProperty:null,__iP:function(){var B=[];
var A=[];
var C=[];
var w=-1;
var v=-1;
...
this.__iO=null;
delete this._invalidChildrenCache;
},_setRowData:function(G,H,I){var J=this.__iG[G];

if(!J){this.__iG[G]={};
this.__iG[G][H]=I;
}else{J[H]=I;
}},_setColumnData:function(K,L,M){var N=this.__iH[K];
...
this._applyLayoutChange();
return this;
},getColumnAlign:function(S){var T=this.__iH[S]||{};
...
this._applyLayoutChange();
return this;
},getRowAlign:function(X){var Y=this.__iG[X]||{};
return {vAlign:Y.vAlign||q,hAlign:Y.hAlign||r};
},getCellWidget:function(ba,bb){if(this._invalidChildrenCache){this.__iP();
}var ba=this.__iI[ba]||{};
return ba[bb]||null;
},getRowCount:function(){if(this._invalidChildrenCache){this.__iP();
}return this.__iL+1;
},getColumnCount:function(){if(this._invalidChildrenCache){this.__iP();
}return this.__iM+1;
},getCellAlign:function(bc,bd){var bj=q;
var bh=r;
var bi=this.__iG[bc];
var bf=this.__iH[bd];
var be=this.__iI[bc][bd];
...
for(var i=0,l=this.__iK.length;i<l;i++){var ca=this.__iK[i];
var cc=this.__iQ(ca);
...
for(var j=0;j<ct.colSpan;j++){cw=cv[cp+j]?cv[cp+j].offset:0;
cn[cp+j].minWidth+=cw;
}}}},_getRowHeights:function(){if(this.__iN!=null){return this.__iN;
}var cK=[];
var cD=this.__iL;
var cC=this.__iM;
...
for(var cJ=0;cJ<=cC;cJ++){var cB=this.__iI[cL][cJ];
...
if(this.__iK.length>0){this._fixHeightsRowSpan(cK);
}this.__iN=cK;
return cK;
},_getColWidths:function(){if(this.__iO!=null){return this.__iO;
}var cQ=[];
var cN=this.__iM;
var cP=this.__iL;
...
for(var cW=0;cW<=cP;cW++){var cM=this.__iI[cW][cV];
...
if(this.__iJ.length>0){this._fixWidthsColSpan(cQ);
}this.__iO=cQ;
return cQ;
...
},renderLayout:function(dm,dn){if(this._invalidChildrenCache){this.__iP();
...
for(var dx=0;dx<=dp;dx++){var dE=this.__iI[dx][dK];
if(!dE){top+=dQ[dx]+dw;
continue;
...
this.__iO=null;
this.__iN=null;
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__iP();
...
return dV;
}},destruct:function(){this.__iI=this.__iG=this.__iH=this.__iJ=this.__iK=this.__iO=this.__iN=null;
}});
})();
(function(){var b="qx.ui.core.queue.Widget",a="widget";
qx.Class.define(b,{statics:{__iR:{},remove:function(c){delete this.__iR[c.$$hash];
...
qx.Class.define(x,{statics:{__ja:function(z,A){return qx.bom.element.Style.get(z,A,qx.bom.element.Style.COMPUTED_MODE,false);
},__jb:function(B,C){return parseInt(qx.bom.element.Style.get(B,C,qx.bom.element.Style.COMPUTED_MODE,false),10)||0;
},__jc:function(D){var G=0,top=0;
...
},__jd:qx.core.Variant.select(e,{"mshtml":function(H){var J=qx.dom.Node.getDocument(H);
var I=J.body;
var K=0;
var top=0;
...
if(qx.bom.client.Feature.STANDARD_MODE){K+=this.__jb(I,i);
top+=this.__jb(I,j);
...
var O=M.offsetLeft;
var top=M.offsetTop;
if(qx.bom.client.Engine.VERSION<530.17){O+=this.__jb(M,i);
top+=this.__jb(M,j);
}return {left:O,top:top};
},"gecko":function(P){var Q=qx.dom.Node.getDocument(P).body;
var R=Q.offsetLeft;
var top=Q.offsetTop;
if(qx.bom.client.Engine.VERSION<1.9){R+=this.__jb(Q,g);
top+=this.__jb(Q,h);
}if(qx.bom.element.BoxSizing.get(Q)!==d){R+=this.__jb(Q,i);
top+=this.__jb(Q,j);
...
}}),__je:qx.core.Variant.select(e,{"mshtml|webkit":function(V){var X=qx.dom.Node.getDocument(V);
...
if(bd.get(bb)!==d){bf-=this.__jb(bb,i);
top-=this.__jb(bb,j);
}
...
if(bd.get(bb)!==d){bf+=this.__jb(bb,i);
top+=this.__jb(bb,j);
}if(bb.parentNode&&this.__ja(bb.parentNode,l)!=t){bf+=this.__jb(bb.parentNode,i);
top+=this.__jb(bb.parentNode,j);
}bb=bb.offsetParent;
...
}}),get:function(bj,bk){if(bj.tagName==s){var location=this.__jf(bj);
var br=location.left;
var top=location.top;
}else{var bl=this.__jd(bj);
var bq=this.__je(bj);
var scroll=this.__jc(bj);
...
if(bo==f||bo==a){bm+=bj.scrollWidth-bj.offsetWidth+this.__jb(bj,i)+this.__jb(bj,b);
}var bp=qx.bom.element.Overflow.getY(bj);

if(bp==f||bp==a){bn+=bj.scrollHeight-bj.offsetHeight+this.__jb(bj,j)+this.__jb(bj,c);
}}
switch(bk){case y:br+=this.__jb(bj,w);
top+=this.__jb(bj,q);
bm-=this.__jb(bj,m);
bn-=this.__jb(bj,r);
...
bm-=bj.scrollLeft;
bn-=bj.scrollTop;
case k:br+=this.__jb(bj,i);
top+=this.__jb(bj,j);
bm-=this.__jb(bj,b);
bn-=this.__jb(bj,c);
break;
case o:br-=this.__jb(bj,g);
top-=this.__jb(bj,h);
bm+=this.__jb(bj,p);
bn+=this.__jb(bj,u);
break;
}}return {left:br,top:top,right:bm,bottom:bn};
},__jf:qx.core.Variant.select(e,{"default":function(bs){var top=bs.offsetTop+this.__jb(bs,h);
var bt=bs.offsetLeft+this.__jb(bs,g);
return {left:bt,top:top};
},"mshtml":function(bu){var top=bu.offsetTop;
var bv=bu.offsetLeft;

if(!((qx.bom.client.Engine.VERSION<8||qx.bom.client.Engine.DOCUMENT_MODE<8)&&!qx.bom.client.Feature.QUIRKS_MODE)){top+=this.__jb(bu,h);
bv+=this.__jb(bu,g);
}return {left:bv,top:top};
},"gecko":function(bw){var top=bw.offsetTop+this.__jb(bw,h)+this.__jb(bw,i);
var bx=bw.offsetLeft+this.__jb(bw,g)+this.__jb(bw,j);
...
qx.Class.define(c,{statics:{LOCALE:"",VARIANT:"",__lE:function(){var d=(navigator.userLanguage||navigator.language).toLowerCase();
var f=a;
var e=d.indexOf(b);
...
qx.Class.define(o,{statics:{__jo:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__jp:function(){var A=this.__jr(false);
document.body.insertBefore(A,document.body.firstChild);
return this._textElement=A;
},__jq:function(){var B=this.__jr(true);
...
M.maxWidth=r;
M.padding=z;
for(var O in this.__jo){N.style[O]=i;
}N.setAttribute(u,s);
L.appendChild(N);
}else{var L=K.document.createElement(j);
qx.bom.element.Style.setStyles(L,this.__js(J));
}
...
}},getHtmlSize:function(content,S,T){var U=this._htmlElement||this.__jq();
U.style.width=T!==undefined?T+v:a;
U.innerHTML=content;
return this.__jt(U,S);
},getTextSize:function(V,W){var X=this._textElement||this.__jp();
...
this.__ju=B;
this.__jv=B.getWindow().document.documentElement;
this.__ju.addListener(this.__jv,v,this._onMouseDown,this);
this.__jH();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1},IGNORE_CAN_HANDLE:true},members:{__ju:null,__jv:null,__jw:null,__jx:null,__jy:null,__jz:null,__jA:null,__jB:null,__jC:null,__jD:null,__jE:false,__jF:0,__jG:0,canHandleEvent:function(C,D){},registerEvent:function(E,F,G){},unregisterEvent:function(H,I,J){},addType:function(K){this.__jy[K]=true;
},addAction:function(L){this.__jz[L]=true;
},supportsType:function(M){return !!this.__jy[M];
},supportsAction:function(N){return !!this.__jz[N];
},getData:function(O){if(!this.__jO||!this.__jw){throw new Error("This method must not be used outside the drop event listener!");
}
if(!this.__jy[O]){throw new Error("Unsupported data type: "+O+"!");
}
if(!this.__jB[O]){this.__jC=O;
this.__jJ(q,this.__jx,this.__jw,false);
}
if(!this.__jB[O]){throw new Error("Please use a droprequest listener to the drag source to fill the manager with data!");
}return this.__jB[O]||null;
},getCurrentAction:function(){return this.__jD;
},addData:function(P,Q){this.__jB[P]=Q;
},getCurrentType:function(){return this.__jC;
},isSessionActive:function(){return this.__jE;
},__jH:function(){this.__jy={};
this.__jz={};
this.__jA={};
this.__jB={};
},__jI:function(){if(this.__jx==null){return;
}var T=this.__jz;
var R=this.__jA;
var S=null;

if(this.__jO){if(R.Shift&&R.Ctrl&&T.alias){S=k;
...
if(S!=this.__jD){this.__jD=S;
this.__jJ(o,this.__jx,this.__jw,false);
}},__jJ:function(U,V,W,X,Y){var bb=qx.event.Registration;
var ba=bb.createEvent(U,qx.event.type.Drag,[X,Y]);

if(V!==W){ba.setRelatedTarget(W);
}return bb.dispatchEvent(V,ba);
},__jK:function(bc){while(bc&&bc.nodeType==1){if(bc.getAttribute(u)==w){return bc;
}bc=bc.parentNode;
}return null;
},__jL:function(bd){while(bd&&bd.nodeType==1){if(bd.getAttribute(r)==w){return bd;
}bd=bd.parentNode;
}return null;
},__jM:function(){this.__jx=null;
this.__ju.removeListener(this.__jv,c,this._onMouseMove,this,true);
this.__ju.removeListener(this.__jv,y,this._onMouseUp,this,true);
qx.event.Registration.removeListener(window,i,this._onWindowBlur,this);
this.__jH();
},__jN:function(){if(this.__jE){this.__ju.removeListener(this.__jv,a,this._onMouseOver,this,true);
this.__ju.removeListener(this.__jv,h,this._onMouseOut,this,true);
this.__ju.removeListener(this.__jv,g,this._onKeyDown,this,true);
this.__ju.removeListener(this.__jv,z,this._onKeyUp,this,true);
this.__jJ(x,this.__jx,this.__jw,false);
this.__jE=false;
}this.__jO=false;
this.__jw=null;
this.__jM();
},__jO:false,_onWindowBlur:function(e){this.__jN();
},_onKeyDown:function(e){var be=e.getKeyIdentifier();

switch(be){case A:case f:case d:if(!this.__jA[be]){this.__jA[be]=true;
this.__jI();
}}},_onKeyUp:function(e){var bf=e.getKeyIdentifier();

switch(bf){case A:case f:case d:if(this.__jA[bf]){this.__jA[bf]=false;
this.__jI();
}}},_onMouseDown:function(e){if(this.__jE){return;
}var bg=this.__jK(e.getTarget());

if(bg){this.__jF=e.getDocumentLeft();
this.__jG=e.getDocumentTop();
this.__jx=bg;
this.__ju.addListener(this.__jv,c,this._onMouseMove,this,true);
this.__ju.addListener(this.__jv,y,this._onMouseUp,this,true);
qx.event.Registration.addListener(window,i,this._onWindowBlur,this);
}},_onMouseUp:function(e){if(this.__jO){this.__jJ(s,this.__jw,this.__jx,false,e);
}if(this.__jE){e.stopPropagation();
}this.__jN();
},_onMouseMove:function(e){if(this.__jE){if(!this.__jJ(t,this.__jx,this.__jw,true,e)){this.__jN();
}}else{if(Math.abs(e.getDocumentLeft()-this.__jF)>3||Math.abs(e.getDocumentTop()-this.__jG)>3){if(this.__jJ(n,this.__jx,this.__jw,true,e)){this.__jE=true;
this.__ju.addListener(this.__jv,a,this._onMouseOver,this,true);
this.__ju.addListener(this.__jv,h,this._onMouseOut,this,true);
this.__ju.addListener(this.__jv,g,this._onKeyDown,this,true);
this.__ju.addListener(this.__jv,z,this._onKeyUp,this,true);
var bh=this.__jA;
bh.Ctrl=e.isCtrlPressed();
bh.Shift=e.isShiftPressed();
bh.Alt=e.isAltPressed();
this.__jI();
}else{this.__jJ(x,this.__jx,this.__jw,false);
this.__jM();
}}}},_onMouseOver:function(e){var bi=e.getTarget();
var bj=this.__jL(bi);

if(bj&&bj!=this.__jw){this.__jO=this.__jJ(m,bj,this.__jx,true,e);
this.__jw=bj;
this.__jI();
}},_onMouseOut:function(e){var bl=this.__jL(e.getTarget());
var bk=this.__jL(e.getRelatedTarget());

if(bl&&bl!==bk&&bl==this.__jw){this.__jJ(l,this.__jw,bk,false,e);
this.__jw=null;
this.__jO=false;
qx.event.Timer.once(this.__jI,this,0);
}}},destruct:function(){this.__jx=this.__jw=this.__ju=this.__jv=this.__jy=this.__jz=this.__jA=this.__jB=null;
},defer:function(bm){qx.event.Registration.addHandler(bm);
}});
})();
(function(){var a="qx.event.type.Data";
qx.Class.define(a,{extend:qx.event.type.Event,members:{__jP:null,__jQ:null,init:function(b,c,d){qx.event.type.Event.prototype.init.call(this,false,d);
this.__jP=b;
this.__jQ=c;
return this;
...
f.__jQ=this.__jQ;
return f;
},getData:function(){return this.__jP;
},getOldData:function(){return this.__jQ;
...
this._initObserver();
},properties:{active:{apply:t,nullable:true},focus:{apply:w,nullable:true}},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{focus:1,blur:1,focusin:1,focusout:1,activate:1,deactivate:1},IGNORE_CAN_HANDLE:true,FOCUSABLE_ELEMENTS:qx.core.Variant.select("qx.client",{"mshtml|gecko":{a:1,body:1,button:1,frame:1,iframe:1,img:1,input:1,object:1,select:1,textarea:1},"opera|webkit":{button:1,input:1,select:1,textarea:1}})},members:{__jR:null,__jS:null,__jT:null,__jU:null,__jV:null,__jW:null,__jX:null,__jY:null,__ka:null,__kb:null,canHandleEvent:function(B,C){},registerEvent:function(D,E,F){},unregisterEvent:function(G,H,I){},focus:function(J){if(qx.core.Variant.isSet(j,n)){window.setTimeout(function(){try{J.focus();
...
}},tryActivate:function(S){var T=this.__kq(S);

if(T){this.setActive(T);
}},__kc:function(U,V,W,X){var ba=qx.event.Registration;
var Y=ba.createEvent(W,qx.event.type.Focus,[U,V,X]);
ba.dispatchEvent(U,Y);
},_windowFocused:true,__kd:function(){if(this._windowFocused){this._windowFocused=false;
this.__kc(this._window,null,g,false);
}},__ke:function(){if(!this._windowFocused){this._windowFocused=true;
this.__kc(this._window,null,f,false);
}},_initObserver:qx.core.Variant.select(j,{"gecko":function(){this.__jR=qx.lang.Function.listener(this.__kk,this);
this.__jS=qx.lang.Function.listener(this.__kl,this);
this.__jT=qx.lang.Function.listener(this.__kj,this);
this.__jU=qx.lang.Function.listener(this.__ki,this);
this.__jV=qx.lang.Function.listener(this.__kf,this);
qx.bom.Event.addNativeListener(this._document,i,this.__jR,true);
qx.bom.Event.addNativeListener(this._document,h,this.__jS,true);
qx.bom.Event.addNativeListener(this._window,f,this.__jT,true);
qx.bom.Event.addNativeListener(this._window,g,this.__jU,true);
qx.bom.Event.addNativeListener(this._window,y,this.__jV,true);
},"mshtml":function(){this.__jR=qx.lang.Function.listener(this.__kk,this);
this.__jS=qx.lang.Function.listener(this.__kl,this);
this.__jX=qx.lang.Function.listener(this.__kg,this);
this.__jY=qx.lang.Function.listener(this.__kh,this);
this.__jW=qx.lang.Function.listener(this.__kn,this);
qx.bom.Event.addNativeListener(this._document,i,this.__jR);
qx.bom.Event.addNativeListener(this._document,h,this.__jS);
qx.bom.Event.addNativeListener(this._document,b,this.__jX);
qx.bom.Event.addNativeListener(this._document,a,this.__jY);
qx.bom.Event.addNativeListener(this._document,d,this.__jW);
},"webkit":function(){this.__jR=qx.lang.Function.listener(this.__kk,this);
this.__jS=qx.lang.Function.listener(this.__kl,this);
this.__jY=qx.lang.Function.listener(this.__kh,this);
this.__jT=qx.lang.Function.listener(this.__kj,this);
this.__jU=qx.lang.Function.listener(this.__ki,this);
...
qx.bom.Event.addNativeListener(this._document,i,this.__jR,true);
qx.bom.Event.addNativeListener(this._document,h,this.__jS,true);
qx.bom.Event.addNativeListener(this._document,d,this.__jW,false);
qx.bom.Event.addNativeListener(this._window,c,this.__jY,true);
qx.bom.Event.addNativeListener(this._window,f,this.__jT,true);
qx.bom.Event.addNativeListener(this._window,g,this.__jU,true);
},"opera":function(){this.__jR=qx.lang.Function.listener(this.__kk,this);
this.__jS=qx.lang.Function.listener(this.__kl,this);
this.__jX=qx.lang.Function.listener(this.__kg,this);
this.__jY=qx.lang.Function.listener(this.__kh,this);
qx.bom.Event.addNativeListener(this._document,i,this.__jR,true);
qx.bom.Event.addNativeListener(this._document,h,this.__jS,true);
qx.bom.Event.addNativeListener(this._window,z,this.__jX,true);
qx.bom.Event.addNativeListener(this._window,c,this.__jY,true);
}}),_stopObserver:qx.core.Variant.select(j,{"gecko":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jR,true);
qx.bom.Event.removeNativeListener(this._document,h,this.__jS,true);
qx.bom.Event.removeNativeListener(this._window,f,this.__jT,true);
qx.bom.Event.removeNativeListener(this._window,g,this.__jU,true);
qx.bom.Event.removeNativeListener(this._window,y,this.__jV,true);
},"mshtml":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jR);
qx.bom.Event.removeNativeListener(this._document,h,this.__jS);
qx.bom.Event.removeNativeListener(this._document,b,this.__jX);
qx.bom.Event.removeNativeListener(this._document,a,this.__jY);
qx.bom.Event.removeNativeListener(this._document,d,this.__jW);
},"webkit":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jR,true);
qx.bom.Event.removeNativeListener(this._document,h,this.__jS,true);
qx.bom.Event.removeNativeListener(this._document,d,this.__jW,false);
qx.bom.Event.removeNativeListener(this._window,c,this.__jY,true);
qx.bom.Event.removeNativeListener(this._window,f,this.__jT,true);
qx.bom.Event.removeNativeListener(this._window,g,this.__jU,true);
},"opera":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jR,true);
qx.bom.Event.removeNativeListener(this._document,h,this.__jS,true);
qx.bom.Event.removeNativeListener(this._window,z,this.__jX,true);
qx.bom.Event.removeNativeListener(this._window,c,this.__jY,true);
}}),__kf:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(bb){var bc=qx.bom.Event.getTarget(bb);

if(!this.__kr(bc)){qx.bom.Event.preventDefault(bb);
}},"default":null})),__kg:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(bd){this.__ke();
...
if(bh==this._document||bh==this._window){this.__ke();

if(this.__ka){this.setFocus(this.__ka);
delete this.__ka;
}
if(this.__kb){this.setActive(this.__kb);
delete this.__kb;
}}else{this.setFocus(bh);
this.tryActivate(bh);
if(!this.__kr(bh)){bh.selectionStart=0;
bh.selectionEnd=0;
}}},"default":null})),__kh:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(bi){if(!bi.toElement){this.__kd();
this.resetFocus();
this.resetActive();
...
if(bm==this._document){this.__kd();
this.__ka=this.getFocus();
this.__kb=this.getActive();
this.resetFocus();
this.resetActive();
}else{if(bm===this.getFocus()){this.resetFocus();
}
if(bm===this.getActive()){this.resetActive();
}}},"default":null})),__ki:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(bn){var bo=qx.bom.Event.getTarget(bn);

if(bo===this._window||bo===this._document){this.__kd();
this.resetActive();
this.resetFocus();
}},"webkit":function(bp){var bq=qx.bom.Event.getTarget(bp);

if(bq===this._window||bq===this._document){this.__kd();
this.__ka=this.getFocus();
this.__kb=this.getActive();
this.resetActive();
this.resetFocus();
}},"default":null})),__kj:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(br){var bs=qx.bom.Event.getTarget(br);

if(bs===this._window||bs===this._document){this.__ke();
bs=this._body;
}this.setFocus(bs);
this.tryActivate(bs);
},"webkit":function(bt){var bu=qx.bom.Event.getTarget(bt);

if(bu===this._window||bu===this._document){this.__ke();
...
this.tryActivate(bu);
}},"default":null})),__kk:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(bv){var bx=qx.bom.Event.getTarget(bv);
var bw=this.__kp(bx);
...
if(bz){if(!this.__kr(bA)){bA.unselectable=e;
try{document.selection.empty();
}catch(bB){}try{bz.focus();
}catch(bC){}}}else{qx.bom.Event.preventDefault(by);
if(!this.__kr(bA)){bA.unselectable=e;
...
if(!this.__kr(bJ)){qx.bom.Event.preventDefault(bG);
...
}},"default":null})),__kl:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(bK){var bL=qx.bom.Event.getTarget(bK);

if(bL.unselectable){bL.unselectable=p;
}this.tryActivate(this.__km(bL));
...
this.tryActivate(this.__km(bP));
},"default":null})),__km:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml|webkit":function(bQ){var bR=this.getFocus();

if(bR&&bQ!=bR&&(bR.nodeName.toLowerCase()===r||bR.nodeName.toLowerCase()===u)){bQ=bR;
}return bQ;
},"default":function(bS){return bS;
}})),__kn:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml|webkit":function(bT){var bU=qx.bom.Event.getTarget(bT);

if(!this.__kr(bU)){qx.bom.Event.preventDefault(bT);
}},"default":null})),__ko:function(bV){var bW=qx.bom.element.Attribute.get(bV,o);
...
},__kp:function(bY){while(bY&&bY.nodeType===1){if(bY.getAttribute(k)==e){return null;
}
if(this.__ko(bY)){return bY;
}bY=bY.parentNode;
}return this._body;
},__kq:function(ca){var cb=ca;

while(ca&&ca.nodeType===1){if(ca.getAttribute(l)==e){return null;
}ca=ca.parentNode;
}return cb;
},__kr:function(cc){while(cc&&cc.nodeType===1){var cd=cc.getAttribute(q);

if(cd!=null){return cd===e;
}cc=cc.parentNode;
}return true;
},_applyActive:function(ce,cf){if(cf){this.__kc(cf,ce,v,true);
}
if(ce){this.__kc(ce,cf,m,true);
}},_applyFocus:function(cg,ch){if(ch){this.__kc(ch,cg,a,true);
}
if(cg){this.__kc(cg,ch,b,true);
}if(ch){this.__kc(ch,cg,g,false);
}
if(cg){this.__kc(cg,ch,f,false);
}}},destruct:function(){this._stopObserver();
this._manager=this._window=this._document=this._root=this._body=this.__ks=null;
...
this.__kt=d;
this.__ku=e||d.toHashCode();
this.useMarkup(d.getMarkup());
},members:{__ku:null,__kt:null,getId:function(){return this.__ku;
},getDecorator:function(){return this.__kt;
},resize:function(g,h){this.__kt.resize(this.getDomElement(),g,h);
},tint:function(i){this.__kt.tint(this.getDomElement(),i);
},getInsets:function(){return this.__kt.getInsets();
}},destruct:function(){this.__kt=null;
}});
})();
...
qx.Class.define(b,{statics:{getApplication:function(){return this.__kv||null;
},ready:function(){if(this.__kv){return;
}
...
}},__kw:function(e){var j=this.__kv;

if(j){e.setReturnValue(j.close());
}},__kx:function(){var k=this.__kv;

if(k){k.terminate();
}}},defer:function(l){qx.event.Registration.addListener(window,f,l.ready,l);
qx.event.Registration.addListener(window,a,l.__kx,l);
qx.event.Registration.addListener(window,c,l.__kw,l);
}});
})();
...
qx.Class.define(d,{statics:{__kJ:{"onload":true,"onpropertychange":true,"oninput":true,"onchange":true,"name":true,"type":true,"checked":true,"disabled":true},__kK:{},__kL:{},allowCreationWithMarkup:function(r){if(!r){r=window;
}var s=r.location.href;

if(qx.bom.Element.__kL[s]==undefined){try{r.document.createElement(f);
qx.bom.Element.__kL[s]=true;
}catch(e){qx.bom.Element.__kL[s]=false;
}}return qx.bom.Element.__kL[s];
},getHelperElement:function(t){if(!t){t=window;
}var v=t.location.href;

if(!qx.bom.Element.__kK[v]){var u=qx.bom.Element.__kK[v]=t.document.createElement(c);
if(qx.bom.client.Engine.WEBKIT){u.style.display=g;
t.document.body.appendChild(u);
}}return qx.bom.Element.__kK[v];
...
},clone:function(Y,ba){var bd;

if(ba||(qx.core.Variant.isSet(o,q)&&!qx.xml.Document.isXmlDocument(Y))){var bh=qx.event.Registration.getManager(Y);
var bb=qx.dom.Hierarchy.getDescendants(Y);
bb.push(Y);
}if(qx.core.Variant.isSet(o,q)){for(var i=0,l=bb.length;i<l;i++){bh.toggleAttachedEvents(bb[i],false);
}}var bd=Y.cloneNode(true);
if(qx.core.Variant.isSet(o,q)){for(var i=0,l=bb.length;i<l;i++){bh.toggleAttachedEvents(bb[i],true);
...
g.start();
this.__kN=g;
},events:{"interval":c},properties:{timeoutInterval:{check:e,init:100,apply:d}},members:{__kN:null,_applyTimeoutInterval:function(h){this.__kN.setInterval(h);
},_onInterval:function(){this.fireEvent(f);
}},destruct:function(){if(this.__kN){this.__kN.stop();
}this.__kN=null;
}});
})();
(function(){var n="execute",m="toolTipText",l="icon",k="label",j="qx.ui.core.MExecutable",h="value",g="qx.event.type.Event",f="_applyCommand",d="enabled",c="menu",a="changeCommand",b="qx.ui.core.Command";
qx.Mixin.define(j,{events:{"execute":g},properties:{command:{check:b,apply:f,event:a,nullable:true}},members:{__kO:null,__kP:false,__kQ:null,_bindableProperties:[d,k,l,m,h,c],execute:function(){var o=this.getCommand();

if(o){if(this.__kP){this.__kP=false;
}else{this.__kP=true;
o.execute(this);
}}this.fireEvent(n);
},__kR:function(e){if(this.__kP){this.__kP=false;
return;
}this.__kP=true;
this.execute();
},_applyCommand:function(p,q){if(q!=null){q.removeListenerById(this.__kQ);
}
if(p!=null){this.__kQ=p.addListener(n,this.__kR,this);
}var t=this.__kO;

if(t==null){this.__kO=t={};
}
...
qx.Mixin.define(k,{properties:{contentPaddingTop:{check:p,init:0,apply:o,themeable:true},contentPaddingRight:{check:p,init:0,apply:o,themeable:true},contentPaddingBottom:{check:p,init:0,apply:o,themeable:true},contentPaddingLeft:{check:p,init:0,apply:o,themeable:true},contentPadding:{group:[e,a,d,c],mode:b,themeable:true}},members:{__kW:{contentPaddingTop:i,contentPaddingRight:h,contentPaddingBottom:m,contentPaddingLeft:f},__kX:{contentPaddingTop:l,contentPaddingRight:n,contentPaddingBottom:g,contentPaddingLeft:j},_applyContentPadding:function(q,r,name){var s=this._getContentPaddingTarget();

if(q==null){var t=this.__kX[name];
s[t]();
}else{var u=this.__kW[name];
s[u](q);
}}}});
})();
...
return o.text;
},"default":function(p){if(this.__lg(p)){return p.value.substring(p.selectionStart,p.selectionEnd);
...
if(this.__lg(t)){var x=t.selectionStart;
...
return w-(u.length-1);
},"default":function(z){if(this.__lg(z)){return z.selectionEnd-z.selectionStart;
}else{return this.get(z).length;
}}}),getStart:qx.core.Variant.select(k,{"mshtml":function(A){if(this.__lg(A)){var F=qx.bom.Range.get();
...
}},"gecko|webkit":function(J){if(this.__lg(J)){return J.selectionStart;
...
}}},"default":function(M){if(this.__lg(M)){return M.selectionStart;
}else{return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(M)).anchorOffset;
}}}),getEnd:qx.core.Variant.select(k,{"mshtml":function(N){if(this.__lg(N)){var S=qx.bom.Range.get();
...
}},"gecko|webkit":function(W){if(this.__lg(W)){return W.selectionEnd;
...
}}},"default":function(ba){if(this.__lg(ba)){return ba.selectionEnd;
}else{return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(ba)).focusOffset;
}}}),__lg:function(bb){return qx.dom.Node.isElement(bb)&&(bb.nodeName.toLowerCase()==h||bb.nodeName.toLowerCase()==g);
...
(function(){var c="qx.ui.core.queue.Manager",b="useraction",a="touchend";
qx.Class.define(c,{statics:{__lh:false,__li:{},__lj:0,MAX_RETRIES:10,scheduleFlush:function(d){var self=qx.ui.core.queue.Manager;
self.__li[d]=true;

if(!self.__lh){self.__lo.schedule();
self.__lh=true;
...
self.__lo.cancel();
var f=self.__li;
self.__ll(function(){while(f.visibility||f.widget||f.appearance||f.layout||f.element){if(f.widget){delete f.widget;
...
}}},function(){self.__lh=false;
});
self.__ll(function(){if(f.dispose){delete f.dispose;
qx.ui.core.queue.Dispose.flush();
}},function(){self.__lk=false;
});
self.__lj=0;
},__ll:function(g,h){var self=qx.ui.core.queue.Manager;
...
if(self.__lj<=self.MAX_RETRIES){self.scheduleFlush();
}else{throw new Error("Fatal Error: Flush terminated "+(self.__lj-1)+" times in a row"+" due to exceptions in user code. The application has to be reloaded!");
}throw e;
}finally{h();
}},__lm:function(e){var i=qx.ui.core.queue.Manager;
if(e.getData()==a){i.PAUSE=true;

if(i.__ln){window.clearTimeout(i.__ln);
}i.__ln=window.setTimeout(function(){i.PAUSE=false;
i.__ln=null;
i.flush();
},500);
}else{i.flush();
}}},defer:function(j){j.__lo=new qx.util.DeferredCall(j.flush);
qx.html.Element._scheduleFlush=j.scheduleFlush;
qx.event.Registration.addListener(window,b,qx.bom.client.Feature.TOUCH?j.__lm:j.flush);
}});
})();
(function(){var c="qx.client",b="load",a="qx.io.ImageLoader";
qx.Bootstrap.define(a,{statics:{__lp:{},__lq:{width:null,height:null},__lr:/\.(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(d){var e=this.__lp[d];
return !!(e&&e.loaded);
},isFailed:function(f){var g=this.__lp[f];
return !!(g&&g.failed);
},isLoading:function(h){var j=this.__lp[h];
return !!(j&&j.loading);
},getFormat:function(k){var m=this.__lp[k];
return m?m.format:null;
},getSize:function(n){var o=this.__lp[n];
return o?
{width:o.width,height:o.height}:this.__lq;
},getWidth:function(p){var q=this.__lp[p];
return q?q.width:null;
},getHeight:function(r){var s=this.__lp[r];
return s?s.height:null;
},load:function(t,u,v){var w=this.__lp[t];
...
var x=qx.lang.Function.listener(this.__ls,this,y,t);
y.onload=x;
y.onerror=x;
y.src=t;
w.element=y;
}},abort:function(z){var A=this.__lp[z];
...
},__ls:qx.event.GlobalError.observeMethod(function(event,D,E){var F=this.__lp[E];
if(event.type===b){F.loaded=true;
F.width=this.__lt(D);
F.height=this.__lu(D);
var G=this.__lr.exec(E);
...
}}),__lt:qx.core.Variant.select(c,{"gecko":function(I){return I.naturalWidth;
},"default":function(J){return J.width;
}}),__lu:qx.core.Variant.select(c,{"gecko":function(K){return K.naturalHeight;
...
this.__lD=qx.dev.StackTrace.getStackTrace();
},members:{__lD:null,getStackTrace:function(){return this.__lD;
}}});
})();
...
qx.Bootstrap.define(u,{statics:{UNKNOWN:true,NAME:"unknown",TITLE:"unknown 0.0",VERSION:0.0,FULLVERSION:"0.0.0",__lF:function(y){var z=navigator.userAgent;
...
this.UNKNOWN=false;
}},defer:qx.core.Variant.select(j,{"webkit":function(D){D.__lF(o);
},"gecko":function(E){E.__lF(k);
},"mshtml":function(F){F.__lF(v);
},"opera":function(G){G.__lF(p);
}})});
})();
(function(){var i="error",h="initialized",g="loading",f="complete",e="webkit",d="qx.client",c="success",b="qx.io.part.Package",a="cached";
qx.Bootstrap.define(b,{construct:function(j,k,l){this.__me=l?f:h;
this.__mf=j;
this.__mg=k;
},members:{__me:null,__mf:null,__mg:null,__mh:null,__mi:null,__mj:null,__mk:null,getId:function(){return this.__mg;
},getReadyState:function(){return this.__me;
},getUrls:function(){return this.__mf;
},saveClosure:function(m){if(this.__me==i){return;
}this.__mh=m;

if(!this.__mi){this.execute();
}else{clearTimeout(this.__mj);
this.__me=a;
this.__mk(this);
}},execute:function(){if(this.__mh){this.__mh();
delete this.__mh;
}
if(qx.$$packageData[this.__mg]){this.__mm(qx.$$packageData[this.__mg]);
delete qx.$$packageData[this.__mg];
}this.__me=f;
},loadClosure:function(n,self){if(this.__me!==h){return;
}this.__mi=true;
this.__me=g;
this.__mk=qx.Bootstrap.bind(n,self);
this.__ml(this.__mf,function(){},function(){this.__me=i;
n.call(self,this);
},this);
var o=this;
this.__mj=setTimeout(function(){o.__me=i;
n.call(self,o);
},qx.Part.TIMEOUT);
},load:function(p,self){if(this.__me!==h){return;
}this.__mi=false;
this.__me=g;
this.__ml(this.__mf,function(){this.__me=f;
this.execute();
p.call(self,this);
},function(){this.__me=i;
p.call(self,this);
},this);
},__ml:function(q,r,s,self){if(q.length==0){r.call(self);
return;
}var u=0;
var self=this;
...
if(status!==c){if(self.__me==g){clearTimeout(self.__mj);
return s.call(self);
}}
...
t(q.concat());
},__mm:qx.$$loader.importPackageData}});
})();
...
if(m==undefined){this.__mn=[];
}else if(arguments.length>1){this.__mn=[];

for(var i=0;i<arguments.length;i++){this.__mn.push(arguments[i]);
}}else if(typeof m==b){this.__mn=new Array(m);
}else if(m instanceof Array){this.__mn=qx.lang.Array.clone(m);
}else{this.__mn=[];
throw new Error("Type of the parameter not supported!");
}for(var i=0;i<this.__mn.length;i++){this._applyEventPropagation(this.__mn[i],null,i);
}this.__mo();
},events:{"change":g,"changeLength":g},members:{__mn:null,concat:function(n){if(n){var o=this.__mn.concat(n);
}else{var o=this.__mn.concat();
}return new qx.data.Array(o);
},join:function(p){return this.__mn.join(p);
},pop:function(){var q=this.__mn.pop();
this.__mo();
...
return q;
},push:function(r){for(var i=0;i<arguments.length;i++){this.__mn.push(arguments[i]);
this.__mo();
this._applyEventPropagation(arguments[i],null,this.length-1);
this.fireDataEvent(l,{start:this.length-1,end:this.length-1,type:k,items:[arguments[i]]},null);
}return this.length;
},reverse:function(){this.__mn.reverse();
this.fireDataEvent(l,{start:0,end:this.length-1,type:h,items:null},null);
},shift:function(){var s=this.__mn.shift();
this.__mo();
this._applyEventPropagation(null,s,this.length-1);
this.fireDataEvent(l,{start:0,end:this.length-1,type:j,items:[s]},null);
return s;
},slice:function(t,u){return new qx.data.Array(this.__mn.slice(t,u));
},splice:function(v,w,x){var D=this.__mn.length;
var A=this.__mn.splice.apply(this.__mn,arguments);
if(this.__mn.length!=D){this.__mo();
}var B=w>0;
var y=arguments.length>2;
var z=null;

if(B||y){if(this.__mn.length>D){var C=k;
}else if(this.__mn.length<D){var C=j;
z=A;
}else{var C=h;
...
},sort:function(E){this.__mn.sort.apply(this.__mn,arguments);
this.fireDataEvent(l,{start:0,end:this.length-1,type:h,items:null},null);
},unshift:function(F){for(var i=arguments.length-1;i>=0;i--){this.__mn.unshift(arguments[i]);
this.__mo();
this._applyEventPropagation(arguments[i],null,0);
this.fireDataEvent(l,{start:0,end:this.length-1,type:k,items:[arguments[i]]},null);
}return this.length;
},toArray:function(){return this.__mn;
},getItem:function(G){return this.__mn[G];
},setItem:function(H,I){var J=this.__mn[H];
if(J===I){return;
}this.__mn[H]=I;
this._applyEventPropagation(I,J,H);
if(this.length!=this.__mn.length){this.__mo();
}this.fireDataEvent(l,{start:H,end:H,type:k,items:[I]},null);
},getLength:function(){return this.length;
},indexOf:function(K){return this.__mn.indexOf(K);
},toString:function(){if(this.__mn!=null){return this.__mn.toString();
}return f;
},contains:function(L){return this.__mn.indexOf(L)!==-1;
...
},removeAll:function(){for(var i=0;i<this.__mn.length;i++){this._applyEventPropagation(null,this.__mn[i],i);
}var W=this.getLength();
var V=this.__mn.concat();
this.__mn.length=0;
this.__mo();
this.fireDataEvent(l,{start:0,end:W-1,type:j,items:V},null);
},append:function(X){if(X instanceof qx.data.Array){X=X.toArray();
}{};
for(var i=0;i<X.length;i++){this._applyEventPropagation(X[i],null,this.__mn.length+i);
}Array.prototype.push.apply(this.__mn,X);
var Y=this.length;
this.__mo();
...
},forEach:function(bg,bh){for(var i=0;i<this.__mn.length;i++){bg.call(bh,this.__mn[i]);
}},__mo:function(){var bi=this.length;
this.length=this.__mn.length;
this.fireDataEvent(a,this.length,bi);
}},destruct:function(){for(var i=0;i<this.__mn.length;i++){this._applyEventPropagation(null,this.__mn[i],i);
}this.__mn=null;
}});
})();
...
qx.Bootstrap.define(a,{construct:function(name,f,g){this.__mp=name;
this._readyState=e;
this._packages=f;
this._loader=g;
...
break;
}}},members:{_readyState:null,_loader:null,_packages:null,__mp:null,getReadyState:function(){return this._readyState;
},getName:function(){return this.__mp;
...
(function(){var e="change",d="__mq",c="qx.event.type.Data",b="qx.ui.form.MModelSelection",a="changeSelection";
qx.Mixin.define(b,{construct:function(){this.__mq=new qx.data.Array();
this.__mq.addListener(e,this.__mt,this);
this.addListener(a,this.__ms,this);
},events:{changeModelSelection:c},members:{__mq:null,__mr:false,__ms:function(){if(this.__mr){return;
...
}},__mt:function(){this.__mr=true;
var m=this.getSelectables(true);
var o=[];
var n=this.__mq.toArray();
...
if(!qx.lang.Array.equals(p,o)){this.__ms();
}},getModelSelection:function(){return this.__mq;
},setModelSelection:function(s){if(!s){this.__mq.removeAll();
return;
}{};
s.unshift(this.__mq.getLength());
s.unshift(0);
var t=this.__mq.splice.apply(this.__mq,s);
t.dispose();
}},destruct:function(){this._disposeObjects(d);
}});
})();
(function(){var g="Boolean",f="qx.ui.core.SingleSelectionManager",e="__mv",d="__mw",c="__mu",b="changeSelected",a="qx.event.type.Data";
qx.Class.define(f,{extend:qx.core.Object,construct:function(h){qx.core.Object.call(this);
{};
this.__mu=h;
},events:{"changeSelected":a},properties:{allowEmptySelection:{check:g,init:true,apply:d}},members:{__mv:null,__mu:null,getSelected:function(){return this.__mv;
},setSelected:function(j){if(!this.__my(j)){throw new Error("Could not select "+j+", because it is not a child element!");
}this.__mx(j);
},resetSelected:function(){this.__mx(null);
},isSelected:function(k){if(!this.__my(k)){throw new Error("Could not check if "+k+" is selected,"+" because it is not a child element!");
}return this.__mv===k;
},isSelectionEmpty:function(){return this.__mv==null;
},getSelectables:function(l){var m=this.__mu.getItems();
var n=[];

for(var i=0;i<m.length;i++){if(this.__mu.isItemSelectable(m[i])){n.push(m[i]);
}}if(!l){for(var i=n.length-1;i>=0;i--){if(!n[i].getEnabled()){n.splice(i,1);
}}}return n;
},__mw:function(o,p){if(!o){this.__mx(this.__mv);
}},__mx:function(q){var t=this.__mv;
var s=q;
...
},__my:function(u){var v=this.__mu.getItems();

for(var i=0;i<v.length;i++){if(v[i]===u){return true;
}}return false;
}},destruct:function(){if(this.__mu.toHashCode){this._disposeObjects(c);
}else{this.__mu=null;
}this._disposeObjects(e);
}});
})();
(function(){var f="qx.ui.core.MSingleSelectionHandling",d="__mz",c="changeSelection",b="changeSelected",a="qx.event.type.Data";
qx.Mixin.define(f,{events:{"changeSelection":a},members:{__mz:null,getSelection:function(){var g=this.__mA().getSelected();

if(g){return [g];
}else{return [];
}},setSelection:function(h){switch(h.length){case 0:this.resetSelection();
break;
case 1:this.__mA().setSelected(h[0]);
break;
default:throw new Error("Could only select one item, but the selection "+" array contains "+h.length+" items!");
}},resetSelection:function(){this.__mA().resetSelected();
},isSelected:function(i){return this.__mA().isSelected(i);
},isSelectionEmpty:function(){return this.__mA().isSelectionEmpty();
},getSelectables:function(j){return this.__mA().getSelectables(j);
},_onChangeSelected:function(e){var l=e.getData();
var k=e.getOldData();
l==null?l=[]:l=[l];
k==null?k=[]:k=[k];
this.fireDataEvent(c,l,k);
},__mA:function(){if(this.__mz==null){var m=this;
this.__mz=new qx.ui.core.SingleSelectionManager({getItems:function(){return m._getItems();
},isItemSelectable:function(n){if(m._isItemSelectable){return m._isItemSelectable(n);
}else{return n.isVisible();
}}});
this.__mz.addListener(b,this._onChangeSelected,this);
}this.__mz.setAllowEmptySelection(this._isAllowEmptySelection());
return this.__mz;
}},destruct:function(){this._disposeObjects(d);
}});
})();
...
qx.Bootstrap.define(f,{construct:function(){this.__mC=qx.Bootstrap.bind(this.__mI,this);
this.__mD=document.createElement(d);
},members:{__mE:null,__mF:null,__mG:null,__mH:null,__mC:null,__mD:null,load:function(p,q,r){if(this.__mE){throw new Error("Another request is still running!");
}this.__mE=true;
this.__mF=false;
...
this.__mH=r||window;
t.type=c;
t.onerror=t.onload=t.onreadystatechange=this.__mC;
t.src=p;
setTimeout(function(){s.appendChild(t);
},0);
},abort:function(){if(this.__mE){this.dispose(a);
}},dispose:function(status){if(this.__mF){return;
}this.__mF=true;
var v=this.__mD;
...
if(this.__mG){if(qx.core.Variant.isSet(j,b)){var self=this;
setTimeout(qx.event.GlobalError.observeMethod(function(){self.__mG.call(self.__mH,status);
delete self.__mG;
}),0);
}else{this.__mG.call(this.__mH,status);
delete this.__mG;
}}},__mI:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(e){var w=this.__mD.readyState;
...
for(var i=0;i<g.length;i++){l.push(this.__mN[g[i]]);
...
}},members:{__mJ:null,__mN:null,__mO:null,__mM:null,addToPackage:function(t){this.__mN.push(t);
},addClosurePackageListener:function(u,v){var w=u.getId();

if(!this.__mM[w]){this.__mM[w]=[];
}this.__mM[w].push(v);
},saveClosure:function(x,y){var A;

for(var i=0;i<this.__mN.length;i++){if(this.__mN[i].getId()==x){A=this.__mN[i];
break;
...
},getParts:function(){return this.__mO;
...
for(var i=0;i<B.length;i++){F.push(this.__mO[B[i]]);
}var E=0;
var D=function(){E+=1;
if(E>=F.length){var G=[];
...
for(var i=0;i<H.length;i++){this.__mO[H[i]].preload(function(){J++;

if(J>=H.length){var K=[];

for(var i=0;i<H.length;i++){K.push(this.__mO[H[i]].getReadyState());
}
if(I){I.call(self,K);
}}},this);
}},__mP:function(){var L=this.__mJ.uris;
var M=[];

for(var i=0;i<L.length;i++){M.push(this.__mQ(L[i]));
}return M;
},__mQ:qx.$$loader.decodeUris,__mK:null,addPartListener:function(N,O){var P=N.getName();

if(!this.__mK[P]){this.__mK[P]=[];
}this.__mK[P].push(O);
...
}},__mL:null,addPackageListener:function(T,U){var V=T.getId();

if(!this.__mL[V]){this.__mL[V]=[];
}this.__mL[V].push(U);
...
},members:{__mR:0,preload:function(h,self){var j=0;
var l=this;
...
}this.__mR=this._packages.length;
...
}}if(this.__mR<=0){this.__mS();
}},__mS:function(){for(var i=0;i<this._packages.length;i++){this._packages[i].execute();
...
(function(){var i="qx.ui.window.Window",h="changeModal",g="changeVisibility",f="changeActive",d="_applyActiveWindow",c="__oi",b="__oh",a="qx.ui.window.MDesktop";
qx.Mixin.define(a,{properties:{activeWindow:{check:i,apply:d,init:null,nullable:true}},members:{__oh:null,__oi:null,getWindowManager:function(){if(!this.__oi){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());
}return this.__oi;
},supportsMaximize:function(){return true;
},setWindowManager:function(j){if(this.__oi){this.__oi.setDesktop(null);
}j.setDesktop(this);
this.__oi=j;
...
(function(){var f="_applyBlockerColor",e="Number",d="__rP",c="qx.ui.core.MBlocker",b="_applyBlockerOpacity",a="Color";
qx.Mixin.define(c,{construct:function(){this.__rP=new qx.ui.core.Blocker(this);
},properties:{blockerColor:{check:a,init:null,nullable:true,apply:f,themeable:true},blockerOpacity:{check:e,init:1,apply:b,themeable:true}},members:{__rP:null,_applyBlockerColor:function(g,h){this.__rP.setColor(g);
},_applyBlockerOpacity:function(i,j){this.__rP.setOpacity(i);
},block:function(){this.__rP.block();
},isBlocked:function(){return this.__rP.isBlocked();
},unblock:function(){this.__rP.unblock();
},forceUnblock:function(){this.__rP.forceUnblock();
},blockContent:function(k){this.__rP.blockContent(k);
},isContentBlocked:function(){return this.__rP.isContentBlocked();
},unblockContent:function(){this.__rP.unblockContent();
},forceUnblockContent:function(){this.__rP.forceUnblockContent();
},getBlocker:function(){return this.__rP;
}},destruct:function(){this._disposeObjects(d);
}});
})();
...
qx.ui.core.queue.Visibility.add(this);
this.initNativeHelp();
},properties:{appearance:{refine:true,init:j},enabled:{refine:true,init:true},focusable:{refine:true,init:true},globalCursor:{check:b,nullable:true,themeable:true,apply:g,event:m},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:k,init:false,apply:c}},members:{__mT:null,isRootWidget:function(){return true;
},getLayout:function(){return this._getLayout();
},_applyGlobalCursor:qx.core.Variant.select(n,{"mshtml":function(q,r){},"default":function(s,t){var u=qx.bom.Stylesheet;
var v=this.__mT;

if(!v){this.__mT=v=u.createElement();
}u.removeAllRules(v);
...
}},"default":function(){}})},destruct:function(){this.__mT=null;
...
}this.__nd.addListener(d,this._onMouseDown,this);
this.__nd.addListener(r,this._onMouseUp,this);
this.__nd.addListener(D,this._onMouseMove,this);
this.__nd.addListener(c,this._onMouseOut,this);
this.__nd.addListener(m,this._onMouseUp,this);
},properties:{appearance:{refine:true,init:u},offset:{check:b,init:6,apply:v},orientation:{init:i,check:[i,g],apply:w}},members:{__mV:null,__mW:false,__mX:null,__mY:null,__na:null,__nb:null,__nc:null,__mU:null,__nd:null,_createChildControlImpl:function(F){var G;

switch(F){case k:G=new qx.ui.splitpane.Slider(this);
G.exclude();
this._add(G,{type:F});
break;
case j:G=new qx.ui.splitpane.Splitter(this);
this._add(G,{type:F});
G.addListener(C,this.__ne,this);
break;
}return G||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,F);
},__ne:function(e){this.__ng(e.getData());
},__nf:function(H){this.__nd=new qx.ui.splitpane.Blocker(H);
this.getContentElement().add(this.__nd);
var I=this.getChildControl(j);
var J=I.getWidth();

if(!J){I.addListenerOnce(p,function(){this.__ng();
},this);
}I.addListener(A,function(e){var K=e.getData();

if(K.height==0||K.width==0){this.__nd.hide();
}else{this.__nd.show();
}},this);
},getBlocker:function(){return this.__nd;
},_applyOrientation:function(L,M){var N=this.getChildControl(k);
var Q=this.getChildControl(j);
this.__na=L===i;

if(!this.__nd){this.__nf(L);
}this.__nd.setOrientation(L);
var P=this._getLayout();

if(P){P.dispose();
}var O=L===g?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;
this._setLayout(O);
Q.removeState(M);
Q.addState(L);
Q.getChildControl(f).removeState(M);
Q.getChildControl(f).addState(L);
N.removeState(M);
N.addState(L);
qx.ui.core.queue.Manager.flush();
this.__ng();
},_applyOffset:function(R,S){this.__ng();
},__ng:function(T){var U=this.getChildControl(j);
var Y=this.getOffset();
var ba=U.getBounds();
var X=U.getContainerElement().getDomElement();
if(!X){return;
}if(this.__na){var W=null;

if(T){W=T.width;
}else if(ba){W=ba.width;
}var bb=T&&T.left;

if(W){if(!bb){bb=qx.bom.element.Location.getPosition(X).left;
}this.__nd.setWidth(Y,W);
this.__nd.setLeft(Y,bb);
}}else{var V=null;

if(T){V=T.height;
}else if(ba){V=ba.height;
}var top=T&&T.top;

if(V){if(!top){top=qx.bom.element.Location.getPosition(X).top;
}this.__nd.setHeight(Y,V);
this.__nd.setTop(Y,top);
}}},add:function(bc,bd){if(bd==null){this._add(bc);
}else{this._add(bc,{flex:bd});
}this.__mU.push(bc);
},remove:function(be){this._remove(be);
qx.lang.Array.remove(this.__mU,be);
},getChildren:function(){return this.__mU;
},_onMouseDown:function(e){if(!e.isLeftPressed()){return;
}var bf=this.getChildControl(j);
var bh=bf.getContainerLocation();
var bg=this.getContentLocation();
this.__mV=this.__na?e.getDocumentLeft()-bh.left+bg.left:e.getDocumentTop()-bh.top+bg.top;
var bj=this.getChildControl(k);
var bi=bf.getBounds();
bj.setUserBounds(bi.left,bi.top,bi.width,bi.height);
bj.setZIndex(bf.getZIndex()+1);
bj.show();
this.__mW=true;
this.__nd.capture();
e.stop();
},_onMouseMove:function(e){this._setLastMousePosition(e.getDocumentLeft(),e.getDocumentTop());
if(this.__mW){this.__nh();
var bk=this.getChildControl(k);
var bl=this.__nb;

if(this.__na){bk.setDomLeft(bl);
this.__nd.setStyle(n,(bl-this.getOffset())+h);
}else{bk.setDomTop(bl);
this.__nd.setStyle(s,(bl-this.getOffset())+h);
}e.stop();
...
var bm=this.getChildControl(k);
bm.exclude();
this.__mW=false;
this.releaseCapture();
e.stop();
},_finalizeSizes:function(){var bq=this.__nb;
var bn=this.__nc;
...
var br=bs[2];
var bo=bs[3];
var bp=br.getLayoutProperties().flex;
var bt=bo.getLayoutProperties().flex;
if((bp!=0)&&(bt!=0)){br.setLayoutProperties({flex:bq});
bo.setLayoutProperties({flex:bn});
}else{if(this.__na){br.setWidth(bq);
bo.setWidth(bn);
}else{br.setHeight(bq);
bo.setHeight(bn);
}}},__nh:function(){if(this.__na){var bw=o,bD=z,bx=l,bB=this.__mX;
}else{var bw=q,bD=a,bx=B,bB=this.__mY;
}var bC=this._getChildren();
var bu=bC[2].getSizeHint();
var bz=bC[3].getSizeHint();
var bA=bC[2].getBounds()[bD]+bC[3].getBounds()[bD];
var by=bB-this.__mV;
var bv=bA-by;
if(by<bu[bw]){bv-=bu[bw]-by;
by=bu[bw];
}else if(bv<bz[bw]){by-=bz[bw]-bv;
bv=bz[bw];
}if(by>bu[bx]){bv+=by-bu[bx];
by=bu[bx];
}else if(bv>bz[bx]){by+=bv-bz[bx];
bv=bz[bx];
}this.__nb=by;
this.__nc=bv;
...
},__rw:function(){var bR=this.getRequest();
...
}},properties:{parseJson:{check:A,init:true}},members:{__ni:false,__nj:0,__nk:null,getRequest:function(){if(this.__nk===null){this.__nk=qx.io.remote.transport.XmlHttp.createRequestObject();
this.__nk.onreadystatechange=qx.lang.Function.bind(this._onreadystatechange,this);
}return this.__nk;
...
if(bi==4){if(!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(),bi,this.__ni)){if(this.getState()===c){this.setState(f);
}this.failed();
return;
}}while(this.__nj<bi){this.setState(qx.io.remote.Exchange._nativeMap[++this.__nj]);
...
if(qx.io.remote.Exchange.wasSuccessful(bD,bE,this.__ni)){try{bF=this.getRequest().responseXML;
...
(function(){var i="Integer",h="hovered",g="hover-button",f="__nl",d="interval",c="mouseover",b="mouseout",a="qx.ui.form.HoverButton";
...
this.__nl=new qx.event.AcceleratingTimer();
this.__nl.addListener(d,this._onInterval,this);
},properties:{appearance:{refine:true,init:g},interval:{check:i,init:80},firstInterval:{check:i,init:200},minTimer:{check:i,init:20},timerDecrease:{check:i,init:2}},members:{__nl:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;
}this.__nl.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();
this.addState(h);
},_onMouseOut:function(e){this.__nl.stop();
this.removeState(h);
...
this.__nm=j;
},statics:{__nn:null,createModel:function(k,l){if(this.__nn===null){this.__nn=new qx.data.marshal.Json();
}this.__nn.toClass(k,l);
return this.__nn.toModel(k);
}},members:{__nm:null,__no:function(m){var n=[];
...
if(this.__nm&&this.__nm.getModelClass&&this.__nm.getModelClass(s)!=null){return;
}for(var t in p){this.toClass(p[t],q);
}if(qx.Class.isDefined(h+s)){return;
}var z={};
var y={__np:this.__np};
...
if(q){z[t].apply=a;
}if(this.__nm&&this.__nm.getValidationRule){var v=this.__nm.getValidationRule(s,t);

if(v){z[t].validate=f+t;
y[f+t]=v;
}}}if(this.__nm&&this.__nm.getModelSuperClass){var x=this.__nm.getModelSuperClass(s)||qx.core.Object;
}else{var x=qx.core.Object;
}var u=[];

if(this.__nm&&this.__nm.getModelMixins){var w=this.__nm.getModelMixins(s);
if(!qx.lang.Type.isArray(w)){if(w!=null){u=[w];
}}}if(q){u.push(qx.data.marshal.MEventBubbling);
}var r={extend:x,include:u,properties:z,members:y,destruct:this.__nq};
qx.Class.define(h+s,r);
},__nq:function(){var A=qx.util.PropertyUtil.getAllProperties(this.constructor);

for(var B in A){this.__np(this.get(A[B].name));
}},__np:function(C){if(!(C instanceof qx.core.Object)){return ;
}if(C.isDisposed()){return;
}if(qx.Class.implementsInterface(C,qx.data.IListData)){for(var i=0;i<C.getLength();i++){this.__np(C.getItem(i));
}}C.dispose();
},__nr:function(D){var E;
if(this.__nm&&this.__nm.getModelClass){E=this.__nm.getModelClass(D);
}
...
}else if(qx.lang.Type.isObject(G)){var H=this.__no(G);
var L=this.__nr(H);
...
s.addListener(k,this.__nt(q),this);
s.addListener(c,qx.lang.Function.bind(this.__ns,this,q),this);
},__ns:function(u,e){if(e.getData()==b||e.getData()==g||e.getData()==m){u.setState(l);
}},__nt:function(v){return function(e){var w=e.getData();
if(w==m){v.setState(l);
return;
}v.setArticles(w);
v.setState(k);
...
(function(){var v="single",u="Boolean",t="one",s="changeSelection",r="mouseup",q="mousedown",p="losecapture",o="multi",n="_applyQuickSelection",m="__nu",d="mouseover",l="_applySelectionMode",h="_applyDragSelection",c="qx.ui.core.MMultiSelectionHandling",b="removeItem",g="keypress",f="qx.event.type.Data",j="addItem",a="additive",k="mousemove";
qx.Mixin.define(c,{construct:function(){var x=this.SELECTION_MANAGER;
var w=this.__nu=new x(this);
...
},events:{"changeSelection":f},properties:{selectionMode:{check:[v,o,a,t],init:v,apply:l},dragSelection:{check:u,init:false,apply:h},quickSelection:{check:u,init:false,apply:n}},members:{__nu:null,selectAll:function(){this.__nu.selectAll();
...
}return this.__nu.isItemSelected(y);
...
}this.__nu.removeItem(A);
},selectRange:function(B,C){this.__nu.selectItemRange(B,C);
...
if(!qx.lang.Array.equals(E,D)){this.__nu.replaceSelection(D);
}}},getSelection:function(){return this.__nu.getSelection();
},getSortedSelection:function(){return this.__nu.getSortedSelection();
...
},_getManager:function(){return this.__nu;
},getSelectables:function(F){return this.__nu.getSelectables(F);
},invertSelection:function(){this.__nu.invertSelection();
},_getLeadItem:function(){var G=this.__nu.getMode();

if(G===v||G===t){return this.__nu.getSelectedItem();
}else{return this.__nu.getLeadItem();
}},_applySelectionMode:function(H,I){this.__nu.setMode(H);
},_applyDragSelection:function(J,K){this.__nu.setDrag(J);
},_applyQuickSelection:function(L,M){this.__nu.setQuick(L);
...
this.addListener(c,this.__nv,this);
...
},__nv:function(e){var m=e.getOldData()[0];
var n=e.getData()[0];
...
qx.Class.define(a,{type:b,extend:qx.core.Object,implement:[qx.application.IApplication],include:qx.locale.MTranslation,members:{__nw:null,_createRootWidget:function(){throw new Error("Abstract method call");
},getRoot:function(){return this.__nw;
},main:function(){qx.theme.manager.Meta.getInstance().initialize();
qx.ui.tooltip.Manager.getInstance();
this.__nw=this._createRootWidget();
},finalize:function(){this.render();
},render:function(){qx.ui.core.queue.Manager.flush();
},close:function(c){},terminate:function(){}},destruct:function(){this.__nw=null;
}});
})();
(function(){var i="Number",h="_applyInsets",g="abstract",f="insetRight",e="insetTop",d="insetBottom",c="qx.ui.decoration.Abstract",b="shorthand",a="insetLeft";
qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.decoration.IDecorator],type:g,properties:{insetLeft:{check:i,nullable:true,apply:h},insetRight:{check:i,nullable:true,apply:h},insetBottom:{check:i,nullable:true,apply:h},insetTop:{check:i,nullable:true,apply:h},insets:{group:[e,f,d,a],mode:b}},members:{__oc:null,_getDefaultInsets:function(){throw new Error("Abstract method called.");
},_isInitialized:function(){throw new Error("Abstract method called.");
},_resetInsets:function(){this.__oc=null;
},getInsets:function(){if(this.__oc){return this.__oc;
}var j=this._getDefaultInsets();
return this.__oc={left:this.getInsetLeft()==null?j.left:this.getInsetLeft(),right:this.getInsetRight()==null?j.right:this.getInsetRight(),bottom:this.getInsetBottom()==null?j.bottom:this.getInsetBottom(),top:this.getInsetTop()==null?j.top:this.getInsetTop()};
...
(function(){var k="knob",j="horizontal",i="vertical",h="Integer",g="hovered",f="left",d="top",c="mouseup",b="pressed",a="px",W="changeValue",V="interval",U="mousemove",T="resize",S="slider",R="mousedown",Q="PageUp",P="mouseout",O='qx.event.type.Data',N="Left",r="Down",s="Up",p="dblclick",q="qx.ui.form.Slider",n="PageDown",o="mousewheel",l="_applyValue",m="_applyKnobFactor",t="End",u="height",B="Right",z="width",F="_applyOrientation",D="Home",J="mouseover",H="floor",w="_applyMinimum",M="click",L="typeof value==='number'&&value>=this.getMinimum()&&value<=this.getMaximum()",K="keypress",v="ceil",x="slider/knob",y="losecapture",A="contextmenu",C="_applyMaximum",E="Number",G="changeMaximum",I="changeMinimum";
qx.Class.define(q,{extend:qx.ui.core.Widget,implement:[qx.ui.form.IForm,qx.ui.form.INumberForm,qx.ui.form.IRange],include:[qx.ui.form.MForm],construct:function(X){qx.ui.core.Widget.call(this);
...
},events:{changeValue:O},properties:{appearance:{refine:true,init:S},focusable:{refine:true,init:true},orientation:{check:[j,i],init:j,apply:F},value:{check:L,init:0,apply:l,nullable:true},minimum:{check:h,init:0,apply:w,event:I},maximum:{check:h,init:100,apply:C,event:G},singleStep:{check:h,init:1},pageStep:{check:h,init:10},knobFactor:{check:E,apply:m,nullable:true}},members:{__nB:null,__nC:null,__nD:null,__nE:null,__nF:null,__nG:null,__nH:null,__nI:null,__nJ:null,__nK:null,__nL:null,__nM:null,_forwardStates:{invalid:true},_createChildControlImpl:function(Y){var ba;

switch(Y){case k:ba=new qx.ui.core.Widget();
ba.setAppearance(x);
ba.addListener(T,this._onUpdate,this);
ba.addListener(J,this._onMouseOver);
ba.addListener(P,this._onMouseOut);
this._add(ba);
break;
...
var bj=this.__nB=qx.bom.element.Location.get(this.getContentElement().getDomElement())[bf];
var bh=this.__nC=qx.bom.element.Location.get(be.getContainerElement().getDomElement())[bf];

if(e.getTarget()===be){this.__nE=true;

if(!this.__nK){this.__nK=new qx.event.Timer(100);
this.__nK.addListener(V,this._fireValue,this);
}this.__nK.start();
this.__nF=bi+bj-bh;
be.addState(b);
}else{this.__nG=true;
...
this.__nJ.addListener(V,this._onInterval,this);
}this.__nJ.start();
...
if(this.__nO){bl=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__nB);
...
}else{bl=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__nB);
...
if(bm<0||bm>this.__nD||bl<0||bl>this.__nD){this.getChildControl(k).removeState(g);
...
}},_onMouseMove:function(e){if(this.__nE){var bo=this.__nO?e.getDocumentLeft():e.getDocumentTop();
var bn=bo-this.__nF;
this.slideTo(this._positionToValue(bn));
}else if(this.__nG){this.__nP(e);
}e.stopPropagation();
},_onInterval:function(e){var bp=this.getValue()+(this.__nH*this.getPageStep());
if(bp<this.getMinimum()){bp=this.getMinimum();
}else if(bp>this.getMaximum()){bp=this.getMaximum();
}var bq=this.__nH==-1;

if((bq&&bp<=this.__nI)||(!bq&&bp>=this.__nI)){bp=this.__nI;
}this.slideTo(bp);
},_onUpdate:function(e){var bs=this.getInnerSize();
var bt=this.getChildControl(k).getBounds();
var br=this.__nO?z:u;
this._updateKnobSize();
this.__nN=bs[br]-bt[br];
this.__nD=bt[br];
this._updateKnobPosition();
},__nO:false,__nN:0,__nP:function(e){var bu=this.__nO;
...
var bE=this.__nH<0?H:v;
bz=bA+(Math[bE]((bz-bA)/by)*by);
}if(this.__nI==null||(this.__nH==-1&&bz<=this.__nI)||(this.__nH==1&&bz>=this.__nI)){this.__nI=bz;
}},_positionToValue:function(bG){var bH=this.__nN;
...
},_valueToPosition:function(bK){var bL=this.__nN;
...
if(this.__nO){bP.setStyle(f,bO+a,true);
...
if(bQ==null){return;
}if(this.__nO){this.getChildControl(k).setWidth(Math.round(bR*bQ.width));
...
this.__nO=bU===j;
if(this.__nO){this.removeState(i);
bW.removeState(i);
this.addState(j);
bW.addState(j);
...
}else{if(this.__nO){this.getChildControl(k).resetWidth();
}else{this.getChildControl(k).resetHeight();
}}},_applyValue:function(ca,cb){if(ca!=null){this._updateKnobPosition();

if(this.__nE){this.__nM=[ca,cb];
}else{this.fireEvent(W,qx.event.type.Data,[ca,cb]);
}}else{this.resetValue();
}},_fireValue:function(){if(!this.__nM){return;
}var cc=this.__nM;
this.__nM=null;
this.fireEvent(W,qx.event.type.Data,cc);
...
},__nQ:function(ch){this.__nO?this.setWidth(ch):this.setHeight(ch);
}}});
})();
...
}},properties:{baseImage:{check:p,nullable:true,apply:r}},members:{__ny:null,__nz:null,__nA:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__ny;
},getMarkup:function(){if(this.__ny){return this.__ny;
...
D.push(b);
return this.__ny=D.join(o);
},resize:function(E,F,G){var H=this.__nA;
...
var O=Q[1];
var N=Q[2];
var M=this.__nz={tl:O+u+N,t:O+v+N,tr:O+d+N,bl:O+m+N,b:O+q+N,br:O+w+N,l:O+c+N,c:O+k+N,r:O+t+N};
this.__nA=this._computeEdgeSizes(M);
...
}},destruct:function(){this.__ny=this.__nz=this.__nA=null;
}});
})();
...
this.addListener(p,function(){this.__qO={"x":0,"y":0};
},this);
this.__qO={};
this.__qP={};
}},properties:{appearance:{refine:true,init:v},width:{refine:true,init:100},height:{refine:true,init:200},scrollbarX:{check:[h,d,D],init:h,themeable:true,apply:c},scrollbarY:{check:[h,d,D],init:h,themeable:true,apply:c},scrollbar:{group:[w,m]}},members:{__qO:null,__qP:null,_createChildControlImpl:function(F){var G;

switch(F){case i:G=new qx.ui.core.scroll.ScrollPane();
G.addListener(l,this._computeScrollbars,this);
G.addListener(s,this._onScrollPaneX,this);
G.addListener(z,this._onScrollPaneY,this);
this._add(G,{row:0,column:0});
break;
case j:G=this._createScrollBar(q);
G.setMinWidth(0);
G.exclude();
G.addListener(B,this._onScrollBarX,this);
G.addListener(a,this._onChangeScrollbarXVisibility,this);
this._add(G,{row:1,column:0});
break;
case k:G=this._createScrollBar(r);
G.setMinHeight(0);
G.exclude();
G.addListener(B,this._onScrollBarY,this);
G.addListener(a,this._onChangeScrollbarYVisibility,this);
this._add(G,{row:0,column:1});
break;
case g:G=new qx.ui.core.Widget();
G.setWidth(0);
G.setHeight(0);
G.exclude();
...
},getItemTop:function(H){return this.getChildControl(i).getItemTop(H);
},getItemBottom:function(I){return this.getChildControl(i).getItemBottom(I);
},getItemLeft:function(J){return this.getChildControl(i).getItemLeft(J);
},getItemRight:function(K){return this.getChildControl(i).getItemRight(K);
},scrollToX:function(L){qx.ui.core.queue.Manager.flush();
this.getChildControl(j).scrollTo(L);
},scrollByX:function(M){qx.ui.core.queue.Manager.flush();
this.getChildControl(j).scrollBy(M);
},getScrollX:function(){var N=this.getChildControl(j,true);
...
this.getChildControl(k).scrollBy(P);
},getScrollY:function(){var Q=this.getChildControl(k,true);
...
},_onMouseWheel:function(e){var S=this._isChildControlVisible(j);
var T=this._isChildControlVisible(k);
var R=(T)?this.getChildControl(k,true):(S?this.getChildControl(j,true):null);
...
e.stop();
},_onTouchMoveDirectional:function(U,e){var V=(U==C?y:t);
var X=this.getChildControl(f+U,true);
var Y=this._isChildControlVisible(f+U);

if(Y&&X){if(this.__qO[U]==0){var W=0;
}else{var W=-(e[b+V]()-this.__qO[U]);
}this.__qO[U]=e[b+V]();
X.scrollBy(W);
if(this.__qP[U]){clearTimeout(this.__qP[U]);
this.__qP[U]=null;
}this.__qP[U]=setTimeout(qx.lang.Function.bind(function(ba){this.__qQ(ba,U);
},this,W),100);
}},__qQ:function(bb,bc){this.__qP[bc]=null;
var be=this._isChildControlVisible(f+bc);

if(bb==0||!be){return;
}if(bb>0){bb=Math.max(0,bb-3);
}else{bb=Math.min(0,bb+3);
}this.__qP[bc]=setTimeout(qx.lang.Function.bind(function(bf,bg){this.__qQ(bf,bg);
},this,bb,bc),20);
var bd=this.getChildControl(f+bc,true);
bd.scrollBy(bb);
...
(function(){var o="one",n="single",m="selected",k="additive",j="multi",h="PageUp",g="under",f="Left",d="lead",c="Down",M="Up",L="Boolean",K="PageDown",J="anchor",I="End",H="Home",G="Right",F="right",E="click",D="above",v="left",w="Escape",t="A",u="Space",r="_applyMode",s="interval",p="changeSelection",q="qx.event.type.Data",x="quick",y="key",A="__oI",z="abstract",C="drag",B="qx.ui.core.selection.Abstract";
qx.Class.define(B,{type:z,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__oF={};
},events:{"changeSelection":q},properties:{mode:{check:[n,j,k,o],init:n,apply:r},drag:{check:L,init:false},quick:{check:L,init:false}},members:{__oG:0,__oH:0,__oI:null,__oJ:null,__oK:null,__oL:null,__oM:null,__oN:null,__oO:null,__oP:null,__oQ:null,__oR:null,__oS:null,__oT:null,__oU:null,__oV:null,__oW:null,__oF:null,__oX:null,__oY:null,_userInteraction:false,getSelectionContext:function(){return this.__oV;
...
},getSelection:function(){return qx.lang.Object.getValues(this.__oF);
},getSortedSelection:function(){var bc=this.getSelectables();
var bb=qx.lang.Object.getValues(this.__oF);
bb.sort(function(a,b){return bc.indexOf(a)-bc.indexOf(b);
});
return bb;
},isItemSelected:function(bd){var be=this._selectableToHashCode(bd);
return this.__oF[be]!==undefined;
},isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__oF);
...
},_setLeadItem:function(bh){var bi=this.__oW;

if(bi!==null){this._styleSelectable(bi,d,false);
}
if(bh!==null){this._styleSelectable(bh,d,true);
}this.__oW=bh;
},getLeadItem:function(){return this.__oW!==null?this.__oW:null;
},_setAnchorItem:function(bj){var bk=this.__oX;

if(bk){this._styleSelectable(bk,J,false);
}
if(bj){this._styleSelectable(bj,J,true);
}this.__oX=bj;
},_getAnchorItem:function(){return this.__oX!==null?this.__oX:null;
...
if(this.isItemSelected(bJ)&&!bI&&!bL&&!this.getDrag()){this.__oY=bJ;
this._userInteraction=false;
return;
}else{this.__oY=null;
...
if(this.getDrag()&&bM!==n&&bM!==o&&!bI&&!bL){this.__oM=this._getLocation();
this.__oJ=this._getScroll();
this.__oN=event.getDocumentLeft()+this.__oJ.left;
this.__oO=event.getDocumentTop()+this.__oJ.top;
this.__oP=true;
this._capture();
}this._fireChange(E);
this._userInteraction=false;
...
if(!bQ&&!bN&&this.__oY){var bO=this._getSelectableFromMouseEvent(event);
...
},handleMouseMove:function(event){if(!this.__oP){return;
}this.__oQ=event.getDocumentLeft();
this.__oR=event.getDocumentTop();
this._userInteraction=true;
var bS=this.__oQ+this.__oJ.left;

if(bS>this.__oN){this.__oS=1;
}else if(bS<this.__oN){this.__oS=-1;
}else{this.__oS=0;
}var bR=this.__oR+this.__oJ.top;

if(bR>this.__oO){this.__oT=1;
}else if(bR<this.__oO){this.__oT=-1;
}else{this.__oT=0;
}var location=this.__oM;

if(this.__oQ<location.left){this.__oG=this.__oQ-location.left;
}else if(this.__oQ>location.right){this.__oG=this.__oQ-location.right;
}else{this.__oG=0;
}
if(this.__oR<location.top){this.__oH=this.__oR-location.top;
}else if(this.__oR>location.bottom){this.__oH=this.__oR-location.bottom;
}else{this.__oH=0;
...
},_cleanup:function(){if(!this.getDrag()&&this.__oP){return;
}if(this.__oU){this._fireChange(E);
}delete this.__oP;
delete this.__oK;
delete this.__oL;
this._releaseCapture();
if(this.__oI){this.__oI.stop();
}},_onInterval:function(e){this._scrollBy(this.__oG,this.__oH);
this.__oJ=this._getScroll();
this._autoSelect();
},_autoSelect:function(){var cd=this._getDimension();
var bV=Math.max(0,Math.min(this.__oQ-this.__oM.left,cd.width))+this.__oJ.left;
var bU=Math.max(0,Math.min(this.__oR-this.__oM.top,cd.height))+this.__oJ.top;
if(this.__oK===bV&&this.__oL===bU){return;
}this.__oK=bV;
this.__oL=bU;
...
},__pa:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;
var cm,cl;
...
}},__pb:function(cD){var cF={};
var cE;

for(var i=0,l=cD.length;i<l;i++){cE=cD[i];
cF[this._selectableToHashCode(cE)]=cE;
}return cF;
},_getSelectedItem:function(){for(var cG in this.__oF){return this.__oF[cG];
}return null;
},_setSelectedItem:function(cH){if(this._isSelectable(cH)){var cI=this.__oF;
...
this.__oU=true;
this._fireChange();
},_fireChange:function(cY){if(this.__oU){this.__oV=cY||null;
this.fireDataEvent(p,this.getSelection());
delete this.__oU;
}}},destruct:function(){this._disposeObjects(A);
this.__oF=this.__oY=this.__oX=null;
this.__oW=null;
}});
})();
...
(function(){var m="horizontal",k="qx.event.type.Data",j="vertical",h="",g="qx.ui.form.List",f="Boolean",d="one",c="addChildWidget",b="_applySpacing",a="Enter",y="Integer",x="action",w="__nR",v="keyinput",u="addItem",t="removeChildWidget",s="_applyOrientation",r="single",q="keypress",p="list",n="pane",o="removeItem";
...
var content=this.__nR;
content.setLayout(D);
content.setAllowGrowX(!C);
content.setAllowGrowY(C);
this._applySpacing(this.getSpacing());
},_applySpacing:function(E,F){this.__nR.getLayout().setSpacing(E);
...
if(!(H===r||H===d)){return;
}if(((new Date).valueOf()-this.__nT)>1000){this.__nS=h;
}this.__nS+=e.getChar();
var I=this.findItemByLabelFuzzy(this.__nS);
if(I){this.setSelection([I]);
}this.__nT=(new Date).valueOf();
...
(function(){var m="open",k="icon",j="auto",h="middle",g="String",f="label",d="changeOpen",c="excluded",b="visible",a="opened",H="always",G="qx.ui.tree.AbstractTreeItem",F="_applyIconOpened",E="Boolean",D="Integer",C="_applyIndent",B="changeOpenSymbolMode",A="_applyOpenSymbolMode",z="__pt",y="resize",t="__ps",u="",r="removeItem",s="addItem",p="iconOpened",q="abstract",n="never",o="_applyIcon",v="_applyOpen",w="_applyLabel",x="__pw";
qx.Class.define(G,{extend:qx.ui.core.Widget,type:q,include:[qx.ui.form.MModelProperty],implement:[qx.ui.form.IModel],construct:function(){qx.ui.core.Widget.call(this);
this.__ps=[];
this._setLayout(new qx.ui.layout.HBox());
this._addWidgets();
this.initOpen();
},properties:{open:{check:E,init:false,event:d,apply:v},openSymbolMode:{check:[H,n,j],init:j,event:B,apply:A},indent:{check:D,init:19,apply:C,themeable:true},parent:{check:G,nullable:true},icon:{check:g,apply:o,nullable:true,themeable:true},iconOpened:{check:g,apply:F,nullable:true,themeable:true},label:{check:g,apply:w,init:u}},members:{__ps:null,__pt:null,__pu:null,__pv:null,__pw:null,__px:null,_addWidgets:function(){throw new Error("Abstract method call.");
},_createChildControlImpl:function(I){var J;

switch(I){case f:J=new qx.ui.basic.Label().set({alignY:h,value:this.getLabel()});
break;
case k:J=new qx.ui.basic.Image().set({alignY:h,source:this.getIcon()});
break;
case m:J=new qx.ui.tree.FolderOpenButton().set({alignY:h});
J.addListener(d,this._onChangeOpen,this);
J.addListener(y,this._updateIndent,this);
break;
...
},addWidget:function(M,N){this._add(M,N);
...
}},addIcon:function(){var O=this.getChildControl(k);

if(this.__pv){this._remove(O);
}this._add(O);
this.__pv=true;
},addLabel:function(P){var Q=this.getChildControl(f);

if(this.__pu){this._remove(Q);
}
if(P){this.setLabel(P);
}else{Q.setValue(this.getLabel());
}this._add(Q);
this.__pu=true;
},addState:function(R){qx.ui.core.Widget.prototype.addState.call(this,R);
var T=this._getChildren();

for(var i=0,l=T.length;i<l;i++){var S=T[i];

if(S.addState){T[i].addState(R);
}}},removeState:function(U){qx.ui.core.Widget.prototype.removeState.call(this,U);
var W=this._getChildren();

for(var i=0,l=W.length;i<l;i++){var V=W[i];

if(V.addState){W[i].removeState(U);
}}},_applyIcon:function(X,Y){if(!this.__pz()){this.__pA(X);
}else if(!this.isOpen()){this.__pA(X);
}},_applyIconOpened:function(ba,bb){if(this.isOpen()){if(this.__py()&&this.__pz()){this.__pA(ba);
}else if(!this.__py()&&this.__pz()){this.__pA(ba);
}}},_applyLabel:function(bc,bd){var be=this.getChildControl(f,true);

if(be){be.setValue(bc);
}},_applyOpen:function(bf,bg){if(this.hasChildren()){this.getChildrenContainer().setVisibility(bf?b:c);
}var open=this.getChildControl(m,true);

if(open){open.setOpen(bf);
}var bh;
if(bf){bh=this.__pz()?this.getIconOpened():null;
}else{bh=this.getIcon();
}
if(bh){this.__pA(bh);
}bf?this.addState(a):this.removeState(a);
},__py:function(){return qx.util.PropertyUtil.getUserValue(this,k);
},__pz:function(){return qx.util.PropertyUtil.getUserValue(this,p);
},__pA:function(bi){var bj=this.getChildControl(k,true);

if(bj){bj.setSource(bi);
}},isOpenable:function(){var bk=this.getOpenSymbolMode();
return (bk===H||bk===j&&this.hasChildren());
...
var bo=open.getBounds();

if(bo){bp=bo.width;
}else{return;
}}else{open.exclude();
}}
if(this.__pw){this.__pw.setWidth((this.getLevel()+1)*this.getIndent()-bp);
...
},getChildrenContainer:function(){if(!this.__pt){this.__pt=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?b:c});
}return this.__pt;
...
},getItems:function(bv,bw,bx){if(bx!==false){var by=[];
}else{var by=[this];
}var bB=this.hasChildren()&&(bw!==false||this.isOpen());

if(bB){var bA=this.getChildren();

if(bv===false){by=by.concat(bA);
}else{for(var i=0,bz=bA.length;i<bz;i++){by=by.concat(bA[i].getItems(bv,bw,false));
}}}return by;
...
}},__pB:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);
...
bH.fireNonBubblingEvent(s,qx.event.type.Data,[bI]);
}}
...
if(bR){bR.remove(bP);
}this.addAt(bP,this.__ps.indexOf(bQ));
},addAfter:function(bS,bT){{};
var bU=bS.getParent();

if(bU){bU.remove(bS);
}this.addAt(bS,this.__ps.indexOf(bT)+1);
},addAtBegin:function(bV){this.addAt(bV,0);
},remove:function(bW){for(var i=0,l=arguments.length;i<l;i++){var cb=arguments[i];

if(this.__ps.indexOf(cb)==-1){this.warn("Cannot remove treeitem '"+cb+"'. It is not a child of this tree item.");
return;
}var bX=this.getChildrenContainer();

if(cb.hasChildrenContainer()){var ca=cb.getChildrenContainer();

if(bX.getChildren().indexOf(ca)>=0){bX.remove(ca);
}}qx.lang.Array.remove(this.__ps,cb);
cb.setParent(null);
bX.remove(cb);
}var bY=this.getTree();

if(bY){bY.fireNonBubblingEvent(r,qx.event.type.Data,[cb]);
}qx.ui.core.queue.Widget.add(this);
},removeAt:function(cc){var cd=this.__ps[cc];

if(cd){this.remove(cd);
}},removeAll:function(){for(var i=this.__ps.length-1;i>=0;i--){this.remove(this.__ps[i]);
}}},destruct:function(){this._disposeArray(t);
this._disposeObjects(x,z);
}});
})();
...
(function(){var n="pressed",m="abandoned",l="Integer",k="hovered",j="qx.event.type.Event",i="Enter",h="Space",g="press",f="qx.ui.form.RepeatButton",d="release",a="interval",c="__nU",b="execute";
qx.Class.define(f,{extend:qx.ui.form.Button,construct:function(o,p){qx.ui.form.Button.call(this,o,p);
this.__nU=new qx.event.AcceleratingTimer();
this.__nU.addListener(a,this._onInterval,this);
},events:{"execute":j,"press":j,"release":j},properties:{interval:{check:l,init:100},firstInterval:{check:l,init:500},minTimer:{check:l,init:20},timerDecrease:{check:l,init:2}},members:{__nV:null,__nU:null,press:function(){if(this.isEnabled()){if(!this.hasState(n)){this.__nW();
}this.removeState(m);
this.addState(n);
}},release:function(q){if(!this.isEnabled()){return;
}if(this.hasState(n)){if(!this.__nV){this.execute();
}}this.removeState(n);
this.removeState(m);
this.__nX();
...
if(this.hasState(n)&&!this.__nV){this.execute();
}}this.__nX();
e.stopPropagation();
},_onKeyUp:function(e){switch(e.getKeyIdentifier()){case i:case h:if(this.hasState(n)){if(!this.__nV){this.execute();
}this.removeState(n);
this.removeState(m);
e.stopPropagation();
this.__nX();
...
e.stopPropagation();
this.__nW();
}},_onInterval:function(e){this.__nV=true;
this.fireEvent(b);
},__nW:function(){this.fireEvent(g);
this.__nV=false;
this.__nU.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();
this.removeState(m);
this.addState(n);
},__nX:function(){this.fireEvent(d);
this.__nU.stop();
this.removeState(m);
this.removeState(n);
...
(function(){var t="configured",s="completed",r="changeState",q="changeModel",p="qx.data.store.Json",o="GET",n="_marshaler",m="sending",l="application/json",k="__oa",d="changeUrl",j="failed",g="loaded",c="timeout",b="queued",f="String",e="aborted",h="_applyUrl",a="receiving",i="qx.event.type.Data";
...
}},events:{"loaded":i},properties:{model:{nullable:true,event:q},state:{check:[t,b,m,a,s,e,c,j],init:t,event:r},url:{check:f,apply:h,event:d,nullable:true}},members:{__oa:null,_delegate:null,_applyUrl:function(w,x){if(w!=null){this._createRequest(w);
}},_createRequest:function(y){this.__oa=new qx.io.remote.Request(y,o,l);
this.__oa.addListener(s,this.__ob,this);
var z=this._delegate;

if(z&&qx.lang.Type.isFunction(z.configureRequest)){this._delegate.configureRequest(this.__oa);
}this.__oa.addListener(r,function(A){this.setState(A.getData());
},this);
this.__oa.send();
},__ob:function(B){var D=B.getContent();
...
}}},destruct:function(){this._disposeObjects(n,k);
this._delegate=null;
}});
})();
...
}},__od:function(t){while(!(t instanceof qx.ui.menu.Menu)){t=t.getLayoutParent();
}return t;
...
},properties:{callbackParam:{check:a,nullable:false}},members:{__oe:null,_createRequest:function(m){if(this.__oe){this.__oe.dispose();
}this.__oe=new qx.io.ScriptLoader();
var o=this._delegate;

if(o&&qx.lang.Type.isFunction(o.configureRequest)){this._delegate.configureRequest(this.__oe);
}var n=m.indexOf(i)==-1?i:h;
m+=n+this.getCallbackParam()+c;
var p=parseInt(this.toHashCode());
qx.data.store.Jsonp[p]=this;
m+=f+p+e;
this.__oe.load(m,function(q){delete this[p];
},this);
},callback:function(r){if(this.isDisposed()){return;
}this.__of(r);
},__of:function(s){if(s==undefined){this.setState(d);
return;
...
this.fireDataEvent(g,this.getModel());
}},destruct:function(){if(this.__oe){this.__oe.dispose();
}this.__oe=null;
}});
})();
...
}},properties:{backgroundColor:{check:b,nullable:true,apply:c}},members:{__og:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__og;
},getMarkup:function(){if(this.__og){return this.__og;
...
if(qx.core.Variant.isSet(o,m)){var E=e.getOldData();

if(!E){qx.locale.Manager.getInstance().addListener(p,this._onChangeLocale,this);
}
if(!G){qx.locale.Manager.getInstance().removeListener(p,this._onChangeLocale,this);
}}var F=G!=null?G.toString():h;
this.getChildControl(q).setValue(F);
},_onChangeLocale:qx.core.Variant.select(o,{"on":function(e){var H=this.getCommand();

if(H!=null){this.getChildControl(q).setValue(H.toString());
}},"off":null}),_applyIcon:function(I,J){if(I){this._showChildControl(t).setSource(I);
}else{this._excludeChildControl(t);
}},_applyLabel:function(K,L){if(K){this._showChildControl(s).setValue(K);
...
}this.__oj=qx.bom.Iframe.create({id:I,name:I,src:K});
qx.bom.element.Style.set(this.__oj,z,A);
this.__ok=qx.bom.Element.create(o,{id:J,name:J,target:I});
qx.bom.element.Style.set(this.__ok,z,A);
qx.dom.Element.insertEnd(this.__ok,qx.dom.Node.getBodyElement(document));
this.__ol=qx.bom.Element.create(c,{id:b,name:b});
qx.dom.Element.insertEnd(this.__ol,this.__ok);
qx.dom.Element.insertEnd(this.__oj,qx.dom.Node.getBodyElement(document));
qx.event.Registration.addListener(this.__oj,a,this._onload,this);
this.__om=qx.lang.Function.listener(this._onreadystatechange,this);
qx.bom.Event.addNativeListener(this.__oj,D,this.__om);
...
},_numericMap:{"uninitialized":1,"loading":2,"loaded":2,"interactive":3,"complete":4}},members:{__ol:null,__on:0,__ok:null,__oj:null,__om:null,send:function(){var M=this.getMethod();
var O=this.getUrl();
...
this.__ok.appendChild(Q);
}this.__ok.action=O;
this.__ok.method=M;
this.__ol.appendChild(document.createTextNode(this.getData()));
this.__ok.submit();
this.setState(r);
},_onload:qx.event.GlobalError.observeMethod(function(e){if(qx.bom.client.Engine.NAME==u&&this.getIframeHtmlContent()==k){return;
}
if(this.__ok.src){return;
}this._switchReadyState(qx.io.remote.transport.Iframe._numericMap.complete);
}),_onreadystatechange:qx.event.GlobalError.observeMethod(function(e){this._switchReadyState(qx.io.remote.transport.Iframe._numericMap[this.__oj.readyState]);
}),_switchReadyState:function(T){switch(this.getState()){case E:case s:case p:case v:this.warn("Ignore Ready State Change");
return;
}while(this.__on<T){this.setState(qx.io.remote.Exchange._nativeMap[++this.__on]);
}},setRequestHeader:function(U,V){},getResponseHeader:function(W){return null;
},getResponseHeaders:function(){return {};
},getStatusCode:function(){return 200;
},getStatusText:function(){return k;
},getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__oj);
},getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__oj);
},getIframeBody:function(){return qx.bom.Iframe.getBody(this.__oj);
...
},destruct:function(){if(this.__oj){qx.event.Registration.removeListener(this.__oj,a,this._onload,this);
qx.bom.Event.removeNativeListener(this.__oj,D,this.__om);
if(qx.core.Variant.isSet(d,y)){this.__oj.src=qx.util.ResourceManager.getInstance().toUri(w);
}qx.dom.Element.remove(this.__oj);
}
if(this.__ok){qx.dom.Element.remove(this.__ok);
}this.__oj=this.__ok=this.__ol=null;
}});
})();
(function(){var t="keypress",s="interval",r="keydown",q="mousedown",p="keyup",o="blur",n="Enter",m="__oo",l="Up",k="Escape",c="qx.ui.menu.Manager",j="Left",g="__op",b="Down",a="Right",f="__oq",d="singleton",h="Space";
...
}this.__op=new qx.event.Timer;
this.__op.addListener(s,this._onOpenInterval,this);
this.__oq=new qx.event.Timer;
this.__oq.addListener(s,this._onCloseInterval,this);
},members:{__or:null,__os:null,__op:null,__oq:null,__oo:null,_getChild:function(w,x,y,z){var A=w.getChildren();
var length=A.length;
var B;
...
}},hideAll:function(){var I=this.__oo;

if(I){for(var i=I.length-1;i>=0;i--){I[i].exclude();
}}},getActiveMenu:function(){var J=this.__oo;
return J.length>0?J[J.length-1]:null;
},scheduleOpen:function(K){this.cancelClose(K);
if(K.isVisible()){if(this.__or){this.cancelOpen(this.__or);
}}else if(this.__or!=K){this.__or=K;
this.__op.restartWith(K.getOpenInterval());
}},scheduleClose:function(L){this.cancelOpen(L);
if(!L.isVisible()){if(this.__os){this.cancelClose(this.__os);
}}else if(this.__os!=L){this.__os=L;
this.__oq.restartWith(L.getCloseInterval());
}},cancelOpen:function(M){if(this.__or==M){this.__op.stop();
this.__or=null;
}},cancelClose:function(N){if(this.__os==N){this.__oq.stop();
this.__os=null;
}},_onOpenInterval:function(e){this.__op.stop();
this.__or.open();
this.__or=null;
},_onCloseInterval:function(e){this.__oq.stop();
this.__os.exclude();
this.__os=null;
...
}if(this.__oo.length>0&&!this._isInMenu(O)){this.hideAll();
}},__ot:{"Enter":1,"Space":1},__ou:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var P=this.getActiveMenu();

if(!P){return;
}var Q=e.getKeyIdentifier();

if(this.__ou[Q]||(this.__ot[Q]&&P.getSelectedButton())){e.stopPropagation();
...
}},properties:{selection:{check:d,event:f,apply:b,init:null}},members:{_modifingSelection:0,__ov:null,__ow:null,_applySelection:function(g,h){if(this.__ow!=undefined&&h!=undefined){h.removeListenerById(this.__ow);
}this.__ow=g.addListener(e,this.__ox,this);
this._updateSelection();
},__ox:function(){this._updateSelection();
},_changeTargetSelection:function(){if(this.getTarget()==null){return;
}if(!this.__oy()&&!this.__oz()){return;
...
},_addChangeTargetListener:function(m,n){if(this.__ov!=undefined&&n!=undefined){n.removeListenerById(this.__ov);
}
if(m!=null){if(this.__oy()||this.__oz()){this.__ov=m.addListener(f,this._changeTargetSelection,this);
}}},_updateSelection:function(){if(!this.getTarget()){return;
}this._startSelectionModification();
if(this.__oy()){var p=[];
for(var i=0;i<this.getSelection().length;i++){var o=this.getSelection().getItem(i);
var q=this.__oB(o);
...
for(var i=0;i<p.length;i++){r[i]=p[i].getModel();
}for(var i=this.getSelection().length-1;i>=0;i--){if(!qx.lang.Array.contains(r,this.getSelection().getItem(i))){this.getSelection().splice(i,1).dispose();
}}}else if(this.__oz()){this.__oA(this.getSelection().getItem(this.getSelection().length-1));
this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();
}this._endSelectionModification();
},__oy:function(){var s=this.getTarget().constructor;
return qx.Class.implementsInterface(s,qx.ui.core.IMultiSelection);
},__oz:function(){var t=this.getTarget().constructor;
return qx.Class.implementsInterface(t,qx.ui.core.ISingleSelection);
},__oA:function(u){var v=this.__oB(u);
if(v==null){return;
}if(this.__oy()){this.getTarget().addToSelection(v);
}else if(this.__oz()){this.getTarget().setSelection([v]);
}},__oB:function(w){var x=this.getTarget().getSelectables(true);
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__oC=new qx.ui.decoration.css3.BorderImage();

if(n){this.__oD(n);
}}else{this.__oC=new qx.ui.decoration.GridDiv(n);
}
if(o!=null){this.__oC.setInsets(o);
}},properties:{baseImage:{check:c,nullable:true,apply:h},insetLeft:{check:m,nullable:true,apply:l},insetRight:{check:m,nullable:true,apply:l},insetBottom:{check:m,nullable:true,apply:l},insetTop:{check:m,nullable:true,apply:l},insets:{group:[i,j,g,a],mode:e}},members:{__oC:null,getMarkup:function(){return this.__oC.getMarkup();
},resize:function(p,q,r){this.__oC.resize(p,q,r);
},tint:function(s,t){},getInsets:function(){return this.__oC.getInsets();
},_applyInsets:function(u,v,name){var w=f+qx.lang.String.firstUp(name);
this.__oC[w](u);
},_applyBaseImage:function(x,y){if(this.__oC instanceof qx.ui.decoration.GridDiv){this.__oC.setBaseImage(x);
}else{this.__oD(x);
}},__oD:function(z){var B,D;
this.__oC.setBorderImage(z);
...
}q.include=this.__rf(q.include);
q.patch=this.__rf(q.patch);
{};
...
}},__rf:function(s){if(!s){return [];
}
if(qx.Bootstrap.isArray(s)){return s;
}else{return [s];
}},__rg:function(t,u){var v=u.aliases||{};
...
},__rh:function(w){for(var i=0,x=this.__rj,l=x.length;i<l;i++){if(w[x[i]]){return x[i];
}}},__ri:function(y,z){var C=this.__rh(z);
...
y[C]=new E;
},$$registry:{},__rj:[g,d,f,n,c,o,m,b],__rk:null,__rl:null,__rm:function(){},patch:function(F,G){var I=this.__rh(G);

if(I!==this.__rh(F)){throw new Error("The mixins '"+F.name+"' are not compatible '"+G.name+"'!");
}var H=G[I];
...
}},properties:{appearance:{refine:true,init:n},orientation:{check:[j,h],init:j,apply:r},maximum:{check:o,apply:l,init:100},position:{check:w,init:0,apply:m,event:p},singleStep:{check:f,init:20},pageStep:{check:f,init:10,apply:q},knobFactor:{check:y,apply:v,nullable:true}},members:{__oE:2,_createChildControlImpl:function(B){var C;

switch(B){case k:C=new qx.ui.core.scroll.ScrollSlider();
C.setPageStep(100);
C.setFocusable(false);
C.addListener(x,this._onChangeSliderValue,this);
this._add(C,{flex:1});
break;
case i:C=new qx.ui.form.RepeatButton();
C.setFocusable(false);
C.addListener(d,this._onExecuteBegin,this);
this._add(C);
break;
case g:C=new qx.ui.form.RepeatButton();
C.setFocusable(false);
C.addListener(d,this._onExecuteEnd,this);
this._add(C);
break;
}return C||qx.ui.core.Widget.prototype._createChildControlImpl.call(this,B);
},_applyMaximum:function(D){this.getChildControl(k).setMaximum(D);
...
},_applyPageStep:function(G){this.getChildControl(k).setPageStep(G);
...
},scrollTo:function(K){this.getChildControl(k).slideTo(K);
...
if(this.getOrientation()==h){if(Q.height<R.minHeight+this.__oE){P=true;
}}else{if(Q.width<R.minWidth+this.__oE){P=true;
}}
if(P){O.exclude();
}else{O.show();
}}}});
...
(function(){var s="Integer",r="aborted",q="_onaborted",p="_on",o="__pf",n="_applyEnabled",m="__pd",l="Boolean",k="sending",j="interval",c="failed",h="qx.io.remote.RequestQueue",g="timeout",b="completed",a="queued",f="receiving",d="singleton";
qx.Class.define(h,{type:d,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__pc=[];
this.__pd=[];
this.__pe=0;
this.__pf=new qx.event.Timer(500);
this.__pf.addListener(j,this._oninterval,this);
},properties:{enabled:{init:true,check:l,apply:n},maxTotalRequests:{check:s,nullable:true},maxConcurrentRequests:{check:s,init:qx.bom.client.Transport.getMaxConcurrentRequestCount()},defaultTimeout:{check:s,init:5000}},members:{__pc:null,__pd:null,__pe:null,__pf:null,getRequestQueue:function(){return this.__pc;
},getActiveQueue:function(){return this.__pd;
},_debug:function(){var t;
{};
},_check:function(){this._debug();
if(this.__pd.length==0&&this.__pc.length==0){this.__pf.stop();
}if(!this.getEnabled()){return;
}if(this.__pc.length==0||(this.__pc[0].isAsynchronous()&&this.__pd.length>=this.getMaxConcurrentRequests())){return;
}if(this.getMaxTotalRequests()!=null&&this.__pe>=this.getMaxTotalRequests()){return;
}var u=this.__pc.shift();
var v=new qx.io.remote.Exchange(u);
this.__pe++;
this.__pd.push(v);
this._debug();
v.addListener(k,this._onsending,this);
...
v.send();
if(this.__pc.length>0){this._check();
}},_remove:function(w){qx.lang.Array.remove(this.__pd,w);
w.dispose();
this._check();
},__pg:0,_onsending:function(e){{};
...
}},_oninterval:function(e){var H=this.__pd;

if(H.length==0){this.__pf.stop();
return;
...
}this.__pf.setEnabled(I);
},add:function(K){K.setState(a);

if(K.isAsynchronous()){this.__pc.push(K);
}else{this.__pc.unshift(K);
}this._check();

if(this.getEnabled()){this.__pf.start();
}},abort:function(L){var M=L.getTransport();

if(M){M.abort();
}else if(qx.lang.Array.contains(this.__pc,L)){qx.lang.Array.remove(this.__pc,L);
...
var s=++qx.io.remote.transport.Script.__ph;

if(s>=2000000000){qx.io.remote.transport.Script.__ph=s=1;
}this.__pi=null;
this.__ph=s;
},statics:{__ph:0,_instanceRegistry:{},ScriptTransport_PREFIX:f,ScriptTransport_ID_PARAM:b,ScriptTransport_DATA_PARAM:h,handles:{synchronous:false,asynchronous:true,crossDomain:true,fileUpload:false,programaticFormFields:false,responseTypes:[m,l,o]},isSupported:function(){return true;
...
}})},members:{__pj:0,__pi:null,__ph:null,send:function(){var x=this.getUrl();
x+=(x.indexOf(p)>=0?r:p)+qx.io.remote.transport.Script.ScriptTransport_ID_PARAM+q+this.__ph;
...
}qx.io.remote.transport.Script._instanceRegistry[this.__ph]=this;
this.__pi=document.createElement(c);
this.__pi.charset=e;
this.__pi.src=x;
{};
document.body.appendChild(this.__pi);
},_switchReadyState:function(B){switch(this.getState()){case n:case a:case d:case g:this.warn("Ignore Ready State Change");
return;
}while(this.__pj<B){this.setState(qx.io.remote.Exchange._nativeMap[++this.__pj]);
...
},destruct:function(){if(this.__pi){delete qx.io.remote.transport.Script._instanceRegistry[this.__ph];
document.body.removeChild(this.__pi);
}this.__pi=this._responseContent=null;
}});
})();
...
},getMarkup:function(I){if(this.__pk){return this.__pk;
...
N.style.height=P+e;
N.style.left=(parseInt(N.style.left)+Q.left-this.getWidthLeft())+e;
N.style.top=(parseInt(N.style.top)+Q.top-this.getWidthTop())+e;
...
}},_applyEnabled:function(V,W){if(V){qx.event.Registration.addListener(document.documentElement,h,this.__pn,this);
...
for(var i=0;i<bb;i++){var bd=this.__pr(a[i]);

switch(bd){case f:case u:case K:case C:this.__pl[bd]=true;
break;
case m:var bc=F+a[i];
this.error(bc);
throw bc;
default:if(this.__pm){var bc=r;
this.error(bc);
throw bc;
}this.__pm=bd;
}}}return true;
},__pp:function(e){var be=this.__pm;
...
},__pq:{esc:S,ctrl:f,print:P,del:q,pageup:b,pagedown:E,numlock:O,numpad_0:J,numpad_1:D,numpad_2:t,numpad_3:s,numpad_4:A,numpad_5:N,numpad_6:B,numpad_7:H,numpad_8:M,numpad_9:z,numpad_divide:p,numpad_multiply:v,numpad_minus:c,numpad_plus:k},__pr:function(bf){var bg=qx.event.handler.Keyboard;
var bh=m;
...
var bh=this.__pq[bf]||qx.lang.String.firstUp(bf);

if(bg.isValidKeyIdentifier(bh)){return bh;
}else{return m;
}},toString:function(){var bk=this.__pm;
var bj=[];

for(var bi in this.__pl){if(this.__pl[bi]){bj.push(qx.locale.Key.getKeyName(j,bi));
}}
...
(function(){var o="static",n="execute",m="user",l="settings",k="loading",j="addfeed",h="selection[0]",g="title",f="north",d="main",bw="new",bv="Surfin' Safari",bu="changeModel",bt="__pD",bs="selection[0].state",br="Heise",bq="__pJ",bp="__pG",bo="__pP",bn="F1",v="article",w="partLoaded",t="Control+A",u="http://blogs.msdn.com/ie/rss.xml",r="__pO",s="http://my.opera.com/desktopteam/xml/rss/blog/",p="feedreader/images/loading22.gif",q="error",D="change",E="http://blogs.msdn.com/jscript/rss.xml",Q="loaded",M="feeds",Y="__pH",T="icon/22/places/folder.png",bj="The Mozilla Blog",be="enabled",I="__pN",bm="http://webkit.org/blog/feed/",bl="__pL",bk="separator-vertical",H="http://feeds2.feedburner.com/qooxdoo/news/content",K="http://blog.mozilla.com/feed/",L="__pI",O="vertical",R="http://www.heise.de/newsticker/heise-atom.xml",U="__pF",bb="state",bg="JScript Team Blog",x="Feeds",y="http://feeds2.feedburner.com/ajaxian",J="Control+D",X="icon/22/actions/process-stop.png",W="selection[0].articles",V="white",bd="IEBlog",bc="Ajaxian",S="User Feeds",ba="icon/22/apps/internet-feed-reader.png",a="model",bf="feedreader.Application",z="http://daringfireball.net/index.xml",A="Control+P",N="Static Feeds",b="__pQ",c="Control+R",G="qooxdoo News",B="__pC",C="Opera Desktop Blog",F="feedreader.model.Feed",P="Daring Fireball",bi="__pK",bh="__pM";
qx.Class.define(bf,{extend:qx.application.Standalone,members:{__pC:null,__pD:null,__pE:null,__pF:null,__pG:null,__pH:null,__pI:null,__pJ:null,__pK:null,__pL:null,__pM:null,__pN:null,__pO:null,__pP:null,__pQ:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
...
this._setUpBinding();
this.__pF.getRoot().setOpen(true);
this.__pF.getRoot().getChildren()[0].setOpen(true);
this.__pF.getRoot().getChildren()[1].setOpen(true);
this.__pF.setHideRoot(true);
this.__pC.getSelection().push(this.__pQ.getFeeds().getItem(0));
this.reload();
},_initializeModel:function(){this.__pO=new feedreader.model.FeedFolder(x);
this.__pQ=new feedreader.model.FeedFolder(this.tr(N));
this.__pO.getFeeds().push(this.__pQ);
this.__pQ.getFeeds().push(new feedreader.model.Feed(G,H,o));
this.__pQ.getFeeds().push(new feedreader.model.Feed(bg,E,o));
this.__pQ.getFeeds().push(new feedreader.model.Feed(P,z,o));
this.__pQ.getFeeds().push(new feedreader.model.Feed(bv,bm,o));
this.__pQ.getFeeds().push(new feedreader.model.Feed(bc,y,o));
this.__pP=new feedreader.model.FeedFolder(this.tr(S));
this.__pO.getFeeds().push(this.__pP);
this.__pP.getFeeds().push(new feedreader.model.Feed(br,R,m));
this.__pP.getFeeds().push(new feedreader.model.Feed(bd,u,m));
this.__pP.getFeeds().push(new feedreader.model.Feed(bj,K,m));
this.__pP.getFeeds().push(new feedreader.model.Feed(C,s,m));
},_setUpBinding:function(){var bz={converter:this._state2iconConverter};
this.__pC=new qx.data.controller.Tree(this.__pO,this.__pF,M,g);
this.__pC.setIconOptions(bz);
this.__pC.setIconPath(bb);
this.__pD=new qx.data.controller.List(null,this.__pI.getList(),g);
this.__pC.bind(W,this.__pD,a);
this.__pD.bind(h,this.__pM,v);
this.__pD.getSelection().addListener(D,this._listControllerChange,this);
this.__pD.addListener(bu,this._treeControllerChange,this);
var bA={converter:this._state2loadingConverter};
this.__pC.bind(bs,this.__pI,k,bA);
bA={converter:this._category2enabledConverter};
this.__pC.bind(h,this.__pH.getRemoveButton(),be,bA);
},_category2enabledConverter:function(bB){return !!bB&&bB.getCategory()==m;
},_state2iconConverter:function(bC){if(bC==bw||bC==k){return p;
}else if(bC==Q){return ba;
}else if(bC==q){return X;
}return T;
},_state2loadingConverter:function(bD){if(bD==bw||bD==k){return true;
}return false;
},_listControllerChange:function(bE){var bF=this.__pC.getSelection().getItem(0);
var bG=this.__pD.getSelection().getItem(0);
if(bG!=undefined){bF.setSelectedArticle(bG);
}},_treeControllerChange:function(bH){var bI=this.__pC.getSelection().getItem(0);
if(bI!=null&&bI.classname==F&&bI.getSelectedArticle()!=null&&bI.getArticles().contains(bI.getSelectedArticle())){qx.event.Timer.once(function(){this.__pD.getSelection().push(bI.getSelectedArticle());
},this,0);
}else{this.__pI.getList().scrollToY(0);
}},_createLayout:function(){var bJ=new qx.ui.layout.Dock();
bJ.setSeparatorY(bk);
var bK=new qx.ui.container.Composite(bJ);
this.getRoot().add(bK,{edge:0});
this.__pG=new feedreader.view.Header();
bK.add(this.__pG,{edge:f});
this.__pH=new feedreader.view.ToolBar(this);
bK.add(this.__pH,{edge:f});
this.__pJ=new qx.ui.splitpane.Pane();
bK.add(this.__pJ);
this.__pF=new qx.ui.tree.Tree();
this.__pF.setWidth(250);
this.__pF.setBackgroundColor(V);
this.__pJ.add(this.__pF,0);
this.__pK=new qx.ui.splitpane.Pane(O);
this.__pK.setDecorator(null);
this.__pJ.add(this.__pK,1);
this.__pI=new feedreader.view.List(this.__pO);
this.__pI.setHeight(200);
this.__pI.setDecorator(d);
this.__pK.add(this.__pI,0);
this.__pM=new feedreader.view.Article();
this.__pM.setDecorator(d);
this.__pK.add(this.__pM,1);
},_initializeCommands:function(){var bL={};
bL.reload=new qx.ui.core.Command(c);
bL.reload.addListener(n,this.reload,this);
bL.about=new qx.ui.core.Command(bn);
bL.about.addListener(n,this.showAbout,this);
bL.preferences=new qx.ui.core.Command(A);
...
bL.removeFeed=new qx.ui.core.Command(J);
bL.removeFeed.addListener(n,this.removeFeed,this);
this.__pE=bL;
},getCommand:function(bM){return this.__pE[bM];
},addFeed:function(bN,bO,bP){var bQ=new feedreader.model.Feed(bN,bO,bP);
this.__pP.getFeeds().push(bQ);
var bR=feedreader.io.FeedLoader.getInstance();
bR.load(bQ);
},removeFeed:function(){var bS=this.__pC.getSelection().getItem(0);
if(bS&&bS.getCategory&&bS.getCategory()!==o){var bT=this.__pP.getFeeds();
for(var i=0;i<bT.length;i++){if(bS===bT.getItem(i)){bT.splice(i,1);
return;
}}}},reload:function(){var bU=feedreader.io.FeedLoader.getInstance();
bU.loadAll(this.__pO);
},showPreferences:function(){this.__pH.singalLoading(l,true);
qx.io.PartLoader.require([l],function(){if(!this.__pL){this.__pL=new feedreader.view.PreferenceWindow();
this.getRoot().add(this.__pL);
}this.__pL.center();
this.__pL.open();
this.__pH.singalLoading(l,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){this.__pH.singalLoading(j,true);
qx.io.PartLoader.require([j],function(){if(!this.__pN){this.__pN=new feedreader.view.AddFeedWindow(this);
this.getRoot().add(this.__pN);
}this.__pN.center();
this.__pN.open();
this.__pH.singalLoading(j,false);
},this);
}},destruct:function(){this.__pE=null;
this._disposeObjects(Y,L,bh,U,r,bq,bi,bp,b,bo,B,bt,bl,I);
}});
})();
(function(){var k="horizontal",j="px",i="scroll",h="vertical",g="-1px",f="qx.client",d="0",c="hidden",b="mousedown",a="qx.ui.core.scroll.NativeScrollBar",z="PositiveNumber",y="Integer",x="__pS",w="mousemove",v="_applyMaximum",u="_applyOrientation",t="appear",s="opera",r="PositiveInteger",q="mshtml",o="mouseup",p="Number",m="_applyPosition",n="scrollbar",l="native";
...
return {width:this.__pR?100:F,maxWidth:this.__pR?null:F,minWidth:this.__pR?null:F,height:this.__pR?F:100,maxHeight:this.__pR?F:null,minHeight:this.__pR?F:null};
...
if(this.__pR){content.scrollToX(J);
}else{content.scrollToY(J);
}},_applyOrientation:function(K,L){var M=this.__pR=K===k;
...
qx.ui.core.queue.Layout.add(this);
},_updateScrollBar:function(){var O=this.__pR;
...
var V=this.__pR?W.getScrollX():W.getScrollY();
this.setPosition(V);
...
},_applyIconOptions:function(G,H){this.__qh();
},_applyLabelOptions:function(I,J){this.__qh();
},_applyIconPath:function(K,L){this.__qh();
},_applyLabelPath:function(M,N){this.__qh();
},_applyModel:function(O,P){if(P!=undefined){if(this.__pX!=undefined){P.removeListenerById(this.__pX);
}
if(this.__pY!=undefined){P.removeListenerById(this.__pY);
}}if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length);
}if(O!=null){this.__pX=O.addListener(y,this.__qd,this);
this.__pY=O.addListener(k,this.__qc,this);
this.__qj();
this.__qd();
...
for(var i=0;i<length;i++){this.__qg();
}}}},_applyTarget:function(R,S){this._addChangeTargetListener(R,S);
if(S!=undefined){S.removeAll();
this.removeAllBindings();
}
if(R!=null){if(this.getModel()!=null){for(var i=0;i<this.__pT.length;i++){this.__qf(this.__qk(i));
}}}},__qc:function(){this.__qb=true;
qx.ui.core.queue.Widget.add(this);
if(this.__pT.length!=this.getModel().getLength()){this.update();
}},syncWidget:function(){if(this.__qa){this._changeTargetSelection();
}
if(this.__qb){this._updateSelection();
}this.__qb=this.__qa=null;
},__qd:function(){if(this.getTarget()==null){return;
}this.__qj();
var U=this.__pT.length;
var T=this.getTarget().getChildren().length;
if(U>T){for(var j=T;j<U;j++){this.__qf(this.__qk(j));
}}else if(U<T){for(var j=T;j>U;j--){this.__qg();
}}},__qe:function(){var V=this.getModel();
if(V!=null){V.removeListenerById(this.__pY);
this.__pY=V.addListener(k,this.__qc,this);
...
},__qf:function(Y){var ba=this._createItem();
this._bindListItem(ba,Y);
this.getTarget().add(ba);
},__qg:function(){this._startSelectionModification();
...
if(!qx.lang.Array.contains(this.__pU,bn)){this.__pU.push(bn);
...
if(!qx.lang.Array.contains(this.__pV,bt)){this.__pV.push(bt);
}},_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;
}for(var i=0;i<this.__pU.length;i++){if(this.__pW[this.__pU[i]]!=null){this.__pW[this.__pU[i]]();
}}},_removeBindingsFrom:function(bD){for(var i=0;i<this.__pU.length;i++){var bE=bD.getUserData(this.__pU[i]+g);

if(bE!=null){this.removeBinding(bE);
}}for(var i=0;i<this.__pV.length;i++){var bE=bD.getUserData(this.__pV[i]+h);

if(bE!=null){bD.removeBinding(bE);
}}},__qh:function(){if(this.getTarget()==null||this.getModel()==null){return;
}var bF=this.getTarget().getChildren();
for(var i=0;i<bF.length;i++){this._removeBindingsFrom(bF[i]);
this._bindListItem(bF[i],this.__qk(i));
}this.__qe();
...
this._endSelectionModification();
this._updateSelection();
},_setFilter:function(bO,bP){if((bO==null||bO.filter==null)&&(bP!=null&&bP.filter!=null)){this.__qi();
...
this.__qj();
if(bR.length>this.__pT.length){for(var j=bR.length;j>this.__pT.length;j--){this.getTarget().removeAt(j-1);
}}else if(bR.length<this.__pT.length){for(var j=bR.length;j<this.__pT.length;j++){var bS=this._createItem();
this.getTarget().add(bS);
}}var bQ=this.getTarget().getChildren();

for(var i=0;i<bQ.length;i++){this._bindListItem(bQ[i],this.__qk(i));
}this.__qe();
this._endSelectionModification();
this._updateSelection();
},__qi:function(){this.__qj();
this.__qd();
this.__qh();
this.__qb=true;
qx.ui.core.queue.Widget.add(this);
},__qj:function(){var bV=this.getModel();
...
for(var i=0;i<bV.getLength();i++){if(bU==null||bU(bV.getItem(i))){this.__pT.push(i);
}}},__qk:function(bX){return this.__pT[bX];
}},destruct:function(){this.__pT=this.__pW=this.__pU=null;
this.__pV=null;
qx.ui.core.queue.Widget.remove(this);
}});
})();
(function(){var c="Integer",b="_applyLayoutChange",a="qx.ui.menu.Layout";
qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:c,init:0,apply:b},spanColumn:{check:c,init:1,nullable:true,apply:b},iconColumnWidth:{check:c,init:0,themeable:true,apply:b},arrowColumnWidth:{check:c,init:0,themeable:true,apply:b}},members:{__ql:null,_computeSizeHint:function(){var q=this._getLayoutChildren();
var o,g,j;
var e=this.getSpanColumn();
var h=this.__ql=[0,0,0,0];
...
},getColumnSizes:function(){return this.__ql||null;
...
(function(){var e="Integer",d="interval",c="__qm",b="qx.event.type.Event",a="qx.event.AcceleratingTimer";
qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__qm=new qx.event.Timer(this.getInterval());
this.__qm.addListener(d,this._onInterval,this);
},events:{"interval":b},properties:{interval:{check:e,init:100},firstInterval:{check:e,init:500},minimum:{check:e,init:20},decrease:{check:e,init:2}},members:{__qm:null,__qn:null,start:function(){this.__qm.setInterval(this.getFirstInterval());
this.__qm.start();
},stop:function(){this.__qm.stop();
this.__qn=null;
},_onInterval:function(){this.__qm.stop();

if(this.__qn==null){this.__qn=this.getInterval();
}this.__qn=Math.max(this.getMinimum(),this.__qn-this.getDecrease());
this.__qm.setInterval(this.__qn);
this.__qm.start();
this.fireEvent(d);
}},destruct:function(){this._disposeObjects(c);
}});
...
this.addListener(w,this._stopPropagation,this);
this.addListener(o,this._stopPropagation,this);
this.addListener(s,this.__qo,this);
this.addListener(n,this.__qo,this);
},members:{_stopPropagation:function(e){e.stopPropagation();
},__qo:function(){var A=this.getStyle(k);
...
}else{do{var I=this.__ro[0];
if(I){var H=I.getMarginLeft()+I.getMarginRight();
var D=I.getSizeHint().width+H;
if(A>C+D+this.getSpacing()||(this.__ro.length==1&&A>C+D-F+this.getSpacing())){this.__rq(I);
A+=D;
if(B&&this.__ro.length==0){B.setVisibility(v);
}}else{return;
}}}while(A>=C&&this.__ro.length>0);
}},__rq:function(J){J.setVisibility(w);
this.__ro.shift();
this.fireDataEvent(p,J);
},__rr:function(K){if(!K){return;
}this.__ro.unshift(K);
K.setVisibility(v);
this.fireDataEvent(j,K);
},_getNextToHide:function(){for(var i=this.__rp.length-1;i>=0;i--){var L=this.__rp[i];
...
}}},setRemovePriority:function(O,P,Q){if(!Q&&this.__rp[P]!=undefined){throw new Error("Priority already in use!");
}this.__rp[P]=O;
...
}for(var i=0;i<this.__ro.length;i++){this.__ro[i].setVisibility(w);
}this.__ro=[];
...
}},__rs:false,_setAllowMenuOpenHover:function(X){this.__rs=X;
},_isAllowMenuOpenHover:function(){return this.__rs;
...
this.add(K);
this.addSeparator();
this.__qs=new qx.ui.toolbar.Button(this.tr(g),t);
this.__qs.setCommand(H.getCommand(l));
this.__qs.setToolTipText(this.tr(w));
this.add(this.__qs);
this.addSpacer();
...
this.__qt=new qx.ui.menu.Menu();
M.setMenu(this.__qt);
this.addListener(u,this._onHideItem,this);
this.addListener(s,this._onShowItem,this);
},members:{__qr:null,__qt:null,__qp:null,__qq:null,__qs:null,getRemoveButton:function(){return this.__qr;
...
P.setVisibility(f);
},_getMenuItem:function(R){var S=this.__qp[R.toHashCode()];
...
this.__qp[R.toHashCode()]=S;
}return S;
},singalLoading:function(T,U){if(T==z){var V=this.__qq;
}else if(T==p){var V=this.__qs;
}else{return ;
...
switch(bc){case l:var bd=new qx.ui.menu.MenuSlideBar();
...
bd.getChildrenContainer().addListener(j,this._onResize,this);
this._add(bd);
break;
...
},__qx:function(){var bi=this._getMenuBounds();

if(!bi){this.addListenerOnce(j,this.__qx,this);
return;
}var bh=this.getLayoutParent().getBounds().height;
var top=this.getLayoutProperties().top;
var bj=this.getLayoutProperties().left;
if(top<0){this._assertSlideBar(function(){this.setHeight(bi.height+top);
this.moveTo(bj,0);
});
}else if(top+bi.height>bh){this._assertSlideBar(function(){this.setHeight(bh-top);
});
...
delete this.__qv;
}},_onResize:function(){if(this.isVisible()){var bl=this._placementTarget;

if(!bl){return;
}else if(bl instanceof qx.ui.core.Widget){this.placeToWidget(bl);
}else if(bl.top!==undefined){this.placeToPoint(bl);
}else{throw new Error("Unknown target: "+bl);
}this.__qx();
...
if(this.__qu){bn.cancelOpen(this.__qu);
this.__qu=null;
...
}if(this.__qu){bq.cancelOpen(this.__qu);
...
(function(){var n=",",m="",k="string",j="null",h='"',g=':',f="qx.jsonDebugging",e='-',d='\\u00',c="__qL",N="new Date(Date.UTC(",M='\\\\',L='\\f',K='\\"',J='Z',I="))",H="__qB",G="__qD",F="}",E='(',u='.',v="{",s='\\r',t=":",q="__qK",r='\\t',o="]",p="[",w="qx.jsonEncodeUndefined",x='T',z='\\b',y="__qC",B="qx.util.Json",A=')',D='\\n',C="__qA";
qx.Class.define(B,{statics:{__qy:null,BEAUTIFYING_INDENT:"  ",BEAUTIFYING_LINE_END:"\n",CONVERT_DATES:null,__qz:{"function":C,"boolean":H,"number":y,"string":G,"object":q,"undefined":c},__qA:function(O,P){return String(O);
},__qB:function(Q,R){return String(Q);
},__qC:function(S,T){return isFinite(S)?String(S):j;
},__qD:function(U,V){var W;

if(/["\\\x00-\x1f]/.test(U)){W=U.replace(/([\x00-\x1f\\"])/g,qx.util.Json.__qF);
}else{W=U;
}return h+W+h;
},__qE:{'\b':z,'\t':r,'\n':D,'\f':L,'\r':s,'"':K,'\\':M},__qF:function(a,b){var X=qx.util.Json.__qE[b];

if(X){return X;
}X=b.charCodeAt();
return d+Math.floor(X/16).toString(16)+(X%16).toString(16);
},__qG:function(Y,ba){var bc=[],bf=true,be,bb;
var bd=qx.util.Json.__qN;
bc.push(p);

if(bd){qx.util.Json.__qH+=qx.util.Json.BEAUTIFYING_INDENT;
bc.push(qx.util.Json.__qH);
}
for(var i=0,l=Y.length;i<l;i++){bb=Y[i];
be=this.__qz[typeof bb];

if(be){bb=this[be](bb,i+m);

if(typeof bb==k){if(!bf){bc.push(n);

if(bd){bc.push(qx.util.Json.__qH);
}}bc.push(bb);
bf=false;
}}}
if(bd){qx.util.Json.__qH=qx.util.Json.__qH.substring(0,qx.util.Json.__qH.length-qx.util.Json.BEAUTIFYING_INDENT.length);
bc.push(qx.util.Json.__qH);
}bc.push(o);
return bc.join(m);
},__qI:function(bg,bh){if(!qx.util.Json.CONVERT_DATES){if(bg.toJSON&&!qx.bom.client.Engine.OPERA){return bg.toJSON();
...
return N+bj+I;
}},__qJ:function(bl,bm){var bp=[],br=true,bo,bn;
var bq=qx.util.Json.__qN;
bp.push(v);

if(bq){qx.util.Json.__qH+=qx.util.Json.BEAUTIFYING_INDENT;
bp.push(qx.util.Json.__qH);
}
for(var bm in bl){bn=bl[bm];
bo=this.__qz[typeof bn];

if(bo){bn=this[bo](bn,bm);

if(typeof bn==k){if(!br){bp.push(n);

if(bq){bp.push(qx.util.Json.__qH);
}}bp.push(this.__qD(bm),t,bn);
br=false;
}}}
if(bq){qx.util.Json.__qH=qx.util.Json.__qH.substring(0,qx.util.Json.__qH.length-qx.util.Json.BEAUTIFYING_INDENT.length);
bp.push(qx.util.Json.__qH);
}bp.push(F);
return bp.join(m);
},__qK:function(bs,bt){if(bs){if(qx.lang.Type.isFunction(bs.toJSON)&&bs.toJSON!==this.__qy){return this.__qM(bs.toJSON(bt),bt);
}else if(qx.lang.Type.isDate(bs)){return this.__qI(bs,bt);
}else if(qx.lang.Type.isArray(bs)){return this.__qG(bs,bt);
}else if(qx.lang.Type.isObject(bs)){return this.__qJ(bs,bt);
}return m;
}return j;
},__qL:function(bu,bv){if(qx.core.Setting.get(w)){return j;
}},__qM:function(bw,bx){return this[this.__qz[typeof bw]](bw,bx);
},stringify:function(by,bz){this.__qN=bz;
this.__qH=this.BEAUTIFYING_LINE_END;
var bA=this.__qM(by,m);
...
}}},settings:{"qx.jsonEncodeUndefined":true,"qx.jsonDebugging":false},defer:function(bF){bF.__qy=Date.prototype.toJSON;
}});
})();
...
}},properties:{innerColor:{check:h,nullable:true,apply:j},innerOpacity:{check:o,init:1,apply:j},outerColor:{check:h,nullable:true,apply:j},backgroundColor:{check:h,nullable:true,apply:j}},members:{__rx:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
...
}},properties:{width:{check:b,init:0,apply:g},style:{nullable:true,check:[k,j,h,i],init:k,apply:o},color:{nullable:true,check:m,apply:o},backgroundColor:{check:m,nullable:true,apply:o}},members:{__rO:null,_getDefaultInsets:function(){var s=this.getWidth();
return {top:s,right:s,bottom:s,left:s};
},_isInitialized:function(){return !!this.__rO;
},getMarkup:function(){if(this.__rO){return this.__rO;
...
(function(){var m="solid",l="scale",k="border-main",j="white",i="repeat-x",h="border-separator",g="background-light",f="invalid",e="border-focused-invalid",d="border-input",bs="border-disabled",br="decoration/table/header-cell.png",bq="decoration/form/input.png",bp="#f8f8f8",bo="decoration/scrollbar/scrollbar-button-bg-horizontal.png",bn="#b6b6b6",bm="background-pane",bl="repeat-y",bk="decoration/form/input-focused.png",bj="#33508D",t="decoration/selection.png",u="decoration/scrollbar/scrollbar-button-bg-vertical.png",r="decoration/tabview/tab-button-top-active.png",s="black",p="decoration/form/button-c.png",q="decoration/scrollbar/scrollbar-bg-vertical.png",n="decoration/form/button.png",o="decoration/form/button-checked.png",B="decoration/tabview/tab-button-left-inactive.png",C="decoration/groupbox/groupbox.png",O="#FAFAFA",K="decoration/pane/pane.png",W="dotted",R="decoration/toolbar/toolbar-part.gif",bf="decoration/tabview/tab-button-top-inactive.png",bc="decoration/menu/bar-background.png",G="center",bi="decoration/tabview/tab-button-bottom-active.png",bh="decoration/form/button-hovered.png",bg="decoration/form/tooltip-error-arrow.png",F="decoration/window/captionbar-inactive.png",I="qx/decoration/Modern",J="decoration/menu/background.png",M="decoration/window/statusbar.png",P="border-focused",S="table-focus-indicator",Y="#F2F2F2",be="decoration/form/button-checked-c.png",v="decoration/scrollbar/scrollbar-bg-horizontal.png",w="qx.theme.modern.Decoration",H="#f4f4f4",V="decoration/shadow/shadow-small.png",U="decoration/app-header.png",T="decoration/tabview/tabview-pane.png",bb="decoration/form/tooltip-error.png",ba="decoration/form/button-focused.png",Q="decoration/tabview/tab-button-bottom-inactive.png",X="decoration/form/button-disabled.png",a="decoration/tabview/tab-button-right-active.png",bd="decoration/form/button-pressed.png",x="no-repeat",y="decoration/window/captionbar-active.png",L="decoration/tabview/tab-button-left-active.png",b="background-splitpane",c="decoration/form/button-checked-focused.png",E="#C5C5C5",z="decoration/toolbar/toolbar-gradient.png",A="decoration/tabview/tab-button-right-inactive.png",D="#b8b8b8",N="decoration/shadow/shadow.png";
qx.Theme.define(w,{aliases:{decoration:I},decorations:{"main":{decorator:qx.ui.decoration.Uniform,style:{width:1,color:k}},"selected":{decorator:qx.ui.decoration.Background,style:{backgroundImage:t,backgroundRepeat:l}},"selected-dragover":{decorator:qx.ui.decoration.Single,style:{backgroundImage:t,backgroundRepeat:l,bottom:[2,m,bj]}},"dragover":{decorator:qx.ui.decoration.Single,style:{bottom:[2,m,bj]}},"pane":{decorator:qx.ui.decoration.Grid,style:{baseImage:K,insets:[0,2,3,0]}},"group":{decorator:qx.ui.decoration.Grid,style:{baseImage:C}},"border-invalid":{decorator:qx.ui.decoration.Beveled,style:{outerColor:f,innerColor:j,innerOpacity:0.5,backgroundImage:bq,backgroundRepeat:i,backgroundColor:g}},"keyboard-focus":{decorator:qx.ui.decoration.Single,style:{width:1,color:s,style:W}},"separator-horizontal":{decorator:qx.ui.decoration.Single,style:{widthLeft:1,colorLeft:h}},"separator-vertical":{decorator:qx.ui.decoration.Single,style:{widthTop:1,colorTop:h}},"tooltip-error":{decorator:qx.ui.decoration.Grid,style:{baseImage:bb,insets:[2,5,5,2]}},"tooltip-error-arrow":{decorator:qx.ui.decoration.Background,style:{backgroundImage:bg,backgroundPositionY:G,backgroundRepeat:x,insets:[0,0,0,10]}},"shadow-window":{decorator:qx.ui.decoration.Grid,style:{baseImage:N,insets:[4,8,8,4]}},"shadow-popup":{decorator:qx.ui.decoration.Grid,style:{baseImage:V,insets:[0,3,3,0]}},"scrollbar-horizontal":{decorator:qx.ui.decoration.Background,style:{backgroundImage:v,backgroundRepeat:i}},"scrollbar-vertical":{decorator:qx.ui.decoration.Background,style:{backgroundImage:q,backgroundRepeat:bl}},"scrollbar-slider-horizontal":{decorator:qx.ui.decoration.Beveled,style:{backgroundImage:bo,backgroundRepeat:l,outerColor:k,innerColor:j,innerOpacity:0.5}},"scrollbar-slider-horizontal-disabled":{decorator:qx.ui.decoration.Beveled,style:{backgroundImage:bo,backgroundRepeat:l,outerColor:bs,innerColor:j,innerOpacity:0.3}},"scrollbar-slider-vertical":{decorator:qx.ui.decoration.Beveled,style:{backgroundImage:u,backgroundRepeat:l,outerColor:k,innerColor:j,innerOpacity:0.5}},"scrollbar-slider-vertical-disabled":{decorator:qx.ui.decoration.Beveled,style:{backgroundImage:u,backgroundRepeat:l,outerColor:bs,innerColor:j,innerOpacity:0.3}},"button":{decorator:qx.ui.decoration.Grid,style:{baseImage:n,insets:2}},"button-disabled":{decorator:qx.ui.decoration.Grid,style:{baseImage:X,insets:2}},"button-focused":{decorator:qx.ui.decoration.Grid,style:{baseImage:ba,insets:2}},"button-hovered":{decorator:qx.ui.decoration.Grid,style:{baseImage:bh,insets:2}},"button-pressed":{decorator:qx.ui.decoration.Grid,style:{baseImage:bd,insets:2}},"button-checked":{decorator:qx.ui.decoration.Grid,style:{baseImage:o,insets:2}},"button-checked-focused":{decorator:qx.ui.decoration.Grid,style:{baseImage:c,insets:2}},"button-invalid-shadow":{decorator:qx.ui.decoration.Beveled,style:{outerColor:f,innerColor:e,insets:[1]}},"checkbox-invalid-shadow":{decorator:qx.ui.decoration.Beveled,style:{outerColor:f,innerColor:e,insets:[0]}},"input":{decorator:qx.ui.decoration.Beveled,style:{outerColor:d,innerColor:j,innerOpacity:0.5,backgroundImage:bq,backgroundRepeat:i,backgroundColor:g}},"input-focused":{decorator:qx.ui.decoration.Beveled,style:{outerColor:d,innerColor:P,backgroundImage:bk,backgroundRepeat:i,backgroundColor:g}},"input-focused-invalid":{decorator:qx.ui.decoration.Beveled,style:{outerColor:f,innerColor:e,backgroundImage:bk,backgroundRepeat:i,backgroundColor:g,insets:[2]}},"input-disabled":{decorator:qx.ui.decoration.Beveled,style:{outerColor:bs,innerColor:j,innerOpacity:0.5,backgroundImage:bq,backgroundRepeat:i,backgroundColor:g}},"toolbar":{decorator:qx.ui.decoration.Background,style:{backgroundImage:z,backgroundRepeat:l}},"toolbar-button-hovered":{decorator:qx.ui.decoration.Beveled,style:{outerColor:bn,innerColor:bp,backgroundImage:p,backgroundRepeat:l}},"toolbar-button-checked":{decorator:qx.ui.decoration.Beveled,style:{outerColor:bn,innerColor:bp,backgroundImage:be,backgroundRepeat:l}},"toolbar-separator":{decorator:qx.ui.decoration.Single,style:{widthLeft:1,widthRight:1,colorLeft:D,colorRight:H,styleLeft:m,styleRight:m}},"toolbar-part":{decorator:qx.ui.decoration.Background,style:{backgroundImage:R,backgroundRepeat:bl}},"tabview-pane":{decorator:qx.ui.decoration.Grid,style:{baseImage:T,insets:[4,6,7,4]}},"tabview-page-button-top-active":{decorator:qx.ui.decoration.Grid,style:{baseImage:r}},"tabview-page-button-top-inactive":{decorator:qx.ui.decoration.Grid,style:{baseImage:bf}},"tabview-page-button-bottom-active":{decorator:qx.ui.decoration.Grid,style:{baseImage:bi}},"tabview-page-button-bottom-inactive":{decorator:qx.ui.decoration.Grid,style:{baseImage:Q}},"tabview-page-button-left-active":{decorator:qx.ui.decoration.Grid,style:{baseImage:L}},"tabview-page-button-left-inactive":{decorator:qx.ui.decoration.Grid,style:{baseImage:B}},"tabview-page-button-right-active":{decorator:qx.ui.decoration.Grid,style:{baseImage:a}},"tabview-page-button-right-inactive":{decorator:qx.ui.decoration.Grid,style:{baseImage:A}},"splitpane":{decorator:qx.ui.decoration.Uniform,style:{backgroundColor:bm,width:3,color:b,style:m}},"window":{decorator:qx.ui.decoration.Single,style:{backgroundColor:bm,width:1,color:k,widthTop:0}},"window-captionbar-active":{decorator:qx.ui.decoration.Grid,style:{baseImage:y}},"window-captionbar-inactive":{decorator:qx.ui.decoration.Grid,style:{baseImage:F}},"window-statusbar":{decorator:qx.ui.decoration.Grid,style:{baseImage:M}},"table":{decorator:qx.ui.decoration.Single,style:{width:1,color:k,style:m}},"table-statusbar":{decorator:qx.ui.decoration.Single,style:{widthTop:1,colorTop:k,style:m}},"table-scroller-header":{decorator:qx.ui.decoration.Single,style:{backgroundImage:br,backgroundRepeat:l,widthBottom:1,colorBottom:k,style:m}},"table-header-cell":{decorator:qx.ui.decoration.Single,style:{widthRight:1,colorRight:h,styleRight:m}},"table-header-cell-hovered":{decorator:qx.ui.decoration.Single,style:{widthRight:1,colorRight:h,styleRight:m,widthBottom:1,colorBottom:j,styleBottom:m}},"table-column-button":{decorator:qx.ui.decoration.Single,style:{backgroundImage:br,backgroundRepeat:l,widthBottom:1,colorBottom:k,style:m}},"table-scroller-focus-indicator":{decorator:qx.ui.decoration.Single,style:{width:2,color:S,style:m}},"progressive-table-header":{decorator:qx.ui.decoration.Single,style:{width:1,color:k,style:m}},"progressive-table-header-cell":{decorator:qx.ui.decoration.Single,style:{backgroundImage:br,backgroundRepeat:l,widthRight:1,colorRight:Y,style:m}},"menu":{decorator:qx.ui.decoration.Single,style:{backgroundImage:J,backgroundRepeat:l,width:1,color:k,style:m}},"menu-separator":{decorator:qx.ui.decoration.Single,style:{widthTop:1,colorTop:E,widthBottom:1,colorBottom:O}},"menubar":{decorator:qx.ui.decoration.Single,style:{backgroundImage:bc,backgroundRepeat:l,width:1,color:h,style:m}},"app-header":{decorator:qx.ui.decoration.Background,style:{backgroundImage:U,backgroundRepeat:l}},"progressbar":{decorator:qx.ui.decoration.Single,style:{width:1,color:d}}}});
})();
(function(){var dK="button-frame",dJ="atom",dI="widget",dH="main",dG="button",dF="text-selected",dE="image",dD="bold",dC="middle",dB="selected",cn="background-light",cm="text-disabled",cl="groupbox",ck="decoration/arrows/down.png",cj="cell",ci="border-invalid",ch="input",cg="input-disabled",cf="menu-button",ce="input-focused-invalid",dR="toolbar-button",dS="spinner",dP="input-focused",dQ="white",dN="popup",dO="tooltip",dL="label",dM="list",dT="tree-item",dU="treevirtual-contract",dj="scrollbar",di="datechooser/nav-button",dl="text-hovered",dk="center",dn="treevirtual-expand",dm="textfield",dq="decoration/arrows/right.png",dp="background-application",dh="radiobutton",dg="invalid",k="combobox",l="right-top",m="checkbox",n="text-title",o="icon/16/places/folder-open.png",p="qx/static/blank.gif",q="scrollbar/button",r="right",s="combobox/button",t="icon/16/places/folder.png",ej="text-label",ei="decoration/tree/closed.png",eh="scrollbar-slider-horizontal",eg="decoration/arrows/left.png",en="button-focused",em="text-light",el="menu-slidebar-button",ek="text-input",ep="slidebar/button-forward",eo="background-splitpane",bm=".png",bn="decoration/tree/open.png",bk="default",bl="decoration/arrows/down-small.png",bq="datechooser",br="slidebar/button-backward",bo="selectbox",bp="treevirtual-folder",bi="shadow-popup",bj="icon/16/mimetypes/office-document.png",N="background-medium",M="icon/32/places/folder-open.png",P="icon/22/places/folder-open.png",O="table",J="decoration/arrows/up.png",I="decoration/form/",L="",K="-invalid",H="button-checked",G="decoration/window/maximize-active-hovered.png",bx="radiobutton-hovered",by="keyboard-focus",bz="decoration/cursors/",bA="slidebar",bt="tooltip-error-arrow",bu="table-scroller-focus-indicator",bv="move-frame",bw="nodrop",bB="decoration/table/boolean-true.png",bC="table-header-cell",bb="menu",ba="app-header",Y="row-layer",X="text-inactive",W="move",V="radiobutton-checked-focused",U="decoration/window/restore-active-hovered.png",T="shadow-window",bf="table-column-button",be="right.png",bD="tabview-page-button-bottom-inactive",bE="tooltip-error",bF="window-statusbar",bG="button-hovered",bH="decoration/scrollbar/scrollbar-",bI="background-tip",bJ="scrollbar-slider-horizontal-disabled",bK="table-scroller-header",bL="button-pressed",bM="table-pane",cv="decoration/window/close-active.png",cu="native",ct="checkbox-hovered",cs="button-invalid-shadow",cz="checkbox-checked",cy="decoration/window/minimize-active-hovered.png",cx="menubar",cw="icon/16/actions/dialog-cancel.png",cD="tabview-page-button-top-inactive",cC="tabview-page-button-left-inactive",db="menu-slidebar",dc="toolbar-button-checked",cY="decoration/tree/open-selected.png",da="radiobutton-checked",cW="decoration/window/minimize-inactive.png",cX="icon/16/apps/office-calendar.png",cU="group",cV="tabview-page-button-right-inactive",dd="decoration/window/minimize-active.png",de="decoration/window/restore-inactive.png",du="checkbox-checked-focused",dt="splitpane",dw="combobox/textfield",dv="button-preselected-focused",dy="decoration/window/close-active-hovered.png",dx="qx/icon/Tango/16/actions/window-close.png",dA="checkbox-pressed",dz="button-disabled",ds="selected-dragover",dr="border-separator",ec="decoration/window/maximize-inactive.png",ed="dragover",ee="scrollarea",ef="scrollbar-vertical",dX="decoration/menu/checkbox-invert.gif",dY="decoration/toolbar/toolbar-handle-knob.gif",ea="icon/22/mimetypes/office-document.png",eb="button-preselected",dV="button-checked-focused",dW="up.png",j="best-fit",i="decoration/tree/closed-selected.png",h="qx.theme.modern.Appearance",g="text-active",f="toolbar-button-hovered",e="progressive-table-header",d="decoration/table/select-column-order.png",c="decoration/menu/radiobutton.gif",b="decoration/arrows/forward.png",a="decoration/table/descending.png",w="progressbar",x="window-captionbar-active",u="checkbox-checked-hovered",v="scrollbar-slider-vertical",A="toolbar",B="alias",y="decoration/window/restore-active.png",z="decoration/table/boolean-false.png",D="checkbox-checked-disabled",E="icon/32/mimetypes/office-document.png",cH="radiobutton-checked-disabled",cB="tabview-pane",cO="decoration/arrows/rewind.png",cK="checkbox-focused",cq="top",co="icon/16/actions/dialog-ok.png",R="radiobutton-checked-hovered",cr="table-header-cell-hovered",bd="window",bc="text-gray",bV="decoration/menu/radiobutton-invert.gif",bW="text-placeholder",bX="slider",bY="keep-align",ca="down.png",cb="tabview-page-button-top-active",cc="icon/22/places/folder.png",cd="decoration/window/maximize-active.png",bT="checkbox-checked-pressed",bU="decoration/window/close-inactive.png",cp="tabview-page-button-left-active",cN="toolbar-part",cM="decoration/splitpane/knob-vertical.png",cL=".gif",cS="radiobutton-checked-pressed",cR="table-statusbar",cQ="radiobutton-pressed",cP="window-captionbar-inactive",cJ="copy",cI="radiobutton-focused",C="decoration/arrows/down-invert.png",bh="decoration/menu/checkbox.gif",bg="decoration/splitpane/knob-horizontal.png",cA="icon/32/places/folder.png",bs="toolbar-separator",cG="tabview-page-button-bottom-active",cF="decoration/arrows/up-small.png",cE="decoration/table/ascending.png",Q="decoration/arrows/up-invert.png",cT="small",F="tabview-page-button-right-active",S="-disabled",bN="scrollbar-horizontal",bO="progressive-table-header-cell",bP="menu-separator",bQ="pane",bR="decoration/arrows/right-invert.png",bS="left.png",df="icon/16/actions/view-refresh.png";
qx.Theme.define(h,{appearances:{"widget":{},"root":{style:function(eq){return {backgroundColor:dp,textColor:ej,font:bk};
}},"label":{style:function(er){return {textColor:er.disabled?cm:undefined};
}},"move-frame":{style:function(es){return {decorator:dH};
}},"resize-frame":bv,"dragdrop-cursor":{style:function(et){var eu=bw;

if(et.copy){eu=cJ;
}else if(et.move){eu=W;
}else if(et.alias){eu=B;
}return {source:bz+eu+cL,position:l,offset:[2,16,2,6]};
}},"image":{style:function(ev){return {opacity:!ev.replacement&&ev.disabled?0.3:1};
}},"atom":{},"atom/label":dL,"atom/icon":dE,"popup":{style:function(ew){return {decorator:dH,backgroundColor:cn,shadow:bi};
}},"button-frame":{alias:dJ,style:function(ex){var ez,ey;

if(ex.checked&&ex.focused&&!ex.inner){ez=dV;
ey=undefined;
}else if(ex.disabled){ez=dz;
ey=undefined;
}else if(ex.pressed){ez=bL;
ey=dl;
}else if(ex.checked){ez=H;
ey=undefined;
}else if(ex.hovered){ez=bG;
ey=dl;
}else if(ex.preselected&&ex.focused&&!ex.inner){ez=dv;
ey=dl;
}else if(ex.preselected){ez=eb;
ey=dl;
}else if(ex.focused&&!ex.inner){ez=en;
ey=undefined;
}else{ez=dG;
ey=undefined;
}return {decorator:ez,textColor:ey,shadow:ex.invalid&&!ex.disabled?cs:undefined};
}},"button-frame/image":{style:function(eA){return {opacity:!eA.replacement&&eA.disabled?0.5:1};
}},"button":{alias:dK,include:dK,style:function(eB){return {padding:[2,8],center:true};
}},"hover-button":{alias:dJ,include:dJ,style:function(eC){return {decorator:eC.hovered?dB:undefined,textColor:eC.hovered?dF:undefined};
}},"splitbutton":{},"splitbutton/button":dG,"splitbutton/arrow":{alias:dG,include:dG,style:function(eD){return {icon:ck,padding:2,marginLeft:1};
}},"checkbox":{alias:dJ,style:function(eE){var eG;

if(eE.checked&&eE.focused){eG=du;
}else if(eE.checked&&eE.disabled){eG=D;
}else if(eE.checked&&eE.pressed){eG=bT;
}else if(eE.checked&&eE.hovered){eG=u;
}else if(eE.checked){eG=cz;
}else if(eE.focused){eG=cK;
}else if(eE.pressed){eG=dA;
}else if(eE.hovered){eG=ct;
}else{eG=m;
}var eF=eE.invalid&&!eE.disabled?K:L;
return {icon:I+eG+eF+bm,gap:6};
}},"radiobutton":{alias:dJ,style:function(eH){var eJ;

if(eH.checked&&eH.focused){eJ=V;
}else if(eH.checked&&eH.disabled){eJ=cH;
}else if(eH.checked&&eH.pressed){eJ=cS;
}else if(eH.checked&&eH.hovered){eJ=R;
}else if(eH.checked){eJ=da;
}else if(eH.focused){eJ=cI;
}else if(eH.pressed){eJ=cQ;
}else if(eH.hovered){eJ=bx;
}else{eJ=dh;
}var eI=eH.invalid&&!eH.disabled?K:L;
return {icon:I+eJ+eI+bm,gap:6};
...
if(eN&&eO&&!eL){eP=ce;
}else if(eN&&!eO&&!eL){eP=dP;
}else if(eL){eP=cg;
}else if(!eN&&eO&&!eL){eP=ci;
}else{eP=ch;
}var eM;

if(eK.disabled){eM=cm;
}else if(eK.showingPlaceholder){eM=bW;
}else{eM=ek;
}return {decorator:eP,padding:[2,4,1],textColor:eM};
}},"textarea":{include:dm,style:function(eQ){return {padding:4};
}},"spinner":{style:function(eR){var eV;
var eT=!!eR.focused;
var eU=!!eR.invalid;
var eS=!!eR.disabled;

if(eT&&eU&&!eS){eV=ce;
}else if(eT&&!eU&&!eS){eV=dP;
}else if(eS){eV=cg;
}else if(!eT&&eU&&!eS){eV=ci;
}else{eV=ch;
}return {decorator:eV};
}},"spinner/textfield":{style:function(eW){return {marginRight:2,padding:[2,4,1],textColor:eW.disabled?cm:ek};
}},"spinner/upbutton":{alias:dK,include:dK,style:function(eX){return {icon:cF,padding:eX.pressed?[2,2,0,4]:[1,3,1,3],shadow:undefined};
}},"spinner/downbutton":{alias:dK,include:dK,style:function(eY){return {icon:bl,padding:eY.pressed?[2,2,0,4]:[1,3,1,3],shadow:undefined};
}},"datefield":k,"datefield/button":{alias:s,include:s,style:function(fa){return {icon:cX,padding:[0,3],decorator:undefined};
}},"datefield/textfield":dw,"datefield/list":{alias:bq,include:bq,style:function(fb){return {decorator:undefined};
}},"groupbox":{style:function(fc){return {legendPosition:cq};
}},"groupbox/legend":{alias:dJ,style:function(fd){return {padding:[1,0,1,4],textColor:fd.invalid?dg:n,font:dD};
}},"groupbox/frame":{style:function(fe){return {padding:12,decorator:cU};
}},"check-groupbox":cl,"check-groupbox/legend":{alias:m,include:m,style:function(ff){return {padding:[1,0,1,4],textColor:ff.invalid?dg:n,font:dD};
}},"radio-groupbox":cl,"radio-groupbox/legend":{alias:dh,include:dh,style:function(fg){return {padding:[1,0,1,4],textColor:fg.invalid?dg:n,font:dD};
}},"scrollarea":{style:function(fh){return {minWidth:50,minHeight:50};
}},"scrollarea/corner":{style:function(fi){return {backgroundColor:dp};
}},"scrollarea/pane":dI,"scrollarea/scrollbar-x":dj,"scrollarea/scrollbar-y":dj,"scrollbar":{style:function(fj){if(fj[cu]){return {};
}return {width:fj.horizontal?undefined:16,height:fj.horizontal?16:undefined,decorator:fj.horizontal?bN:ef,padding:1};
}},"scrollbar/slider":{alias:bX,style:function(fk){return {padding:fk.horizontal?[0,1,0,1]:[1,0,1,0]};
}},"scrollbar/slider/knob":{include:dK,style:function(fl){var fm=fl.horizontal?eh:v;

if(fl.disabled){fm+=S;
}return {decorator:fm,minHeight:fl.horizontal?undefined:9,minWidth:fl.horizontal?9:undefined};
}},"scrollbar/button":{alias:dK,include:dK,style:function(fn){var fo=bH;

if(fn.left){fo+=bS;
}else if(fn.right){fo+=be;
}else if(fn.up){fo+=dW;
}else{fo+=ca;
}
...
}}},"scrollbar/button-begin":q,"scrollbar/button-end":q,"slider":{style:function(fp){var ft;
var fr=!!fp.focused;
var fs=!!fp.invalid;
var fq=!!fp.disabled;

if(fr&&fs&&!fq){ft=ce;
}else if(fr&&!fs&&!fq){ft=dP;
}else if(fq){ft=cg;
}else if(!fr&&fs&&!fq){ft=ci;
}else{ft=ch;
}return {decorator:ft};
}},"slider/knob":{include:dK,style:function(fu){return {decorator:fu.disabled?bJ:eh,shadow:undefined,height:14,width:14};
}},"list":{alias:ee,style:function(fv){var fz;
var fx=!!fv.focused;
var fy=!!fv.invalid;
var fw=!!fv.disabled;

if(fx&&fy&&!fw){fz=ce;
}else if(fx&&!fy&&!fw){fz=dP;
}else if(fw){fz=cg;
}else if(!fx&&fy&&!fw){fz=ci;
}else{fz=ch;
}return {backgroundColor:cn,decorator:fz};
}},"list/pane":dI,"listitem":{alias:dJ,style:function(fA){var fB;

if(fA.dragover){fB=fA.selected?ds:ed;
}else{fB=fA.selected?dB:undefined;
}return {padding:fA.dragover?[4,4,2,4]:4,textColor:fA.selected?dF:undefined,decorator:fB};
}},"slidebar":{},"slidebar/scrollpane":{},"slidebar/content":{},"slidebar/button-forward":{alias:dK,include:dK,style:function(fC){return {padding:5,center:true,icon:fC.vertical?ck:dq};
}},"slidebar/button-backward":{alias:dK,include:dK,style:function(fD){return {padding:5,center:true,icon:fD.vertical?J:eg};
}},"tabview":{style:function(fE){return {contentPadding:16};
}},"tabview/bar":{alias:bA,style:function(fF){var fG={marginBottom:fF.barTop?-1:0,marginTop:fF.barBottom?-4:0,marginLeft:fF.barRight?-3:0,marginRight:fF.barLeft?-1:0,paddingTop:0,paddingRight:0,paddingBottom:0,paddingLeft:0};

if(fF.barTop||fF.barBottom){fG.paddingLeft=5;
fG.paddingRight=7;
}else{fG.paddingTop=5;
fG.paddingBottom=7;
}return fG;
}},"tabview/bar/button-forward":{include:ep,alias:ep,style:function(fH){if(fH.barTop||fH.barBottom){return {marginTop:2,marginBottom:2};
}else{return {marginLeft:2,marginRight:2};
}}},"tabview/bar/button-backward":{include:br,alias:br,style:function(fI){if(fI.barTop||fI.barBottom){return {marginTop:2,marginBottom:2};
}else{return {marginLeft:2,marginRight:2};
}}},"tabview/bar/scrollpane":{},"tabview/pane":{style:function(fJ){return {decorator:cB,minHeight:100,marginBottom:fJ.barBottom?-1:0,marginTop:fJ.barTop?-1:0,marginLeft:fJ.barLeft?-1:0,marginRight:fJ.barRight?-1:0};
}},"tabview-page":dI,"tabview-page/button":{alias:dJ,style:function(fK){var fQ,fM=0;
var fP=0,fL=0,fN=0,fO=0;

if(fK.checked){if(fK.barTop){fQ=cb;
fM=[6,14];
fN=fK.firstTab?0:-5;
fO=fK.lastTab?0:-5;
}else if(fK.barBottom){fQ=cG;
fM=[6,14];
fN=fK.firstTab?0:-5;
fO=fK.lastTab?0:-5;
}else if(fK.barRight){fQ=F;
fM=[6,13];
fP=fK.firstTab?0:-5;
fL=fK.lastTab?0:-5;
}else{fQ=cp;
...
fP=fK.firstTab?0:-5;
fL=fK.lastTab?0:-5;
}}else{if(fK.barTop){fQ=cD;
fM=[4,10];
fP=4;
fN=fK.firstTab?5:1;
fO=1;
}else if(fK.barBottom){fQ=bD;
fM=[4,10];
fL=4;
fN=fK.firstTab?5:1;
fO=1;
}else if(fK.barRight){fQ=cV;
fM=[4,10];
fO=5;
fP=fK.firstTab?5:1;
fL=1;
...
fL=1;
fO=1;
}}return {zIndex:fK.checked?10:5,decorator:fQ,padding:fM,marginTop:fP,marginBottom:fL,marginLeft:fN,marginRight:fO,textColor:fK.checked?g:X};
}},"tabview-page/button/label":{alias:dL,style:function(fR){return {padding:[0,1,0,1],margin:fR.focused?0:1,decorator:fR.focused?by:undefined};
}},"tabview-page/button/close-button":{alias:dJ,style:function(fS){return {icon:dx};
}},"toolbar":{style:function(fT){return {decorator:A,spacing:2};
}},"toolbar/part":{style:function(fU){return {decorator:cN,spacing:2};
}},"toolbar/part/container":{style:function(fV){return {paddingLeft:2,paddingRight:2};
}},"toolbar/part/handle":{style:function(fW){return {source:dY,marginLeft:3,marginRight:3};
}},"toolbar-button":{alias:dJ,style:function(fX){return {marginTop:2,marginBottom:2,padding:(fX.pressed||fX.checked||fX.hovered)&&!fX.disabled||(fX.disabled&&fX.checked)?3:5,decorator:fX.pressed||(fX.checked&&!fX.hovered)||(fX.checked&&fX.disabled)?dc:fX.hovered&&!fX.disabled?f:undefined};
}},"toolbar-menubutton":{alias:dR,include:dR,style:function(fY){return {showArrow:true};
}},"toolbar-menubutton/arrow":{alias:dE,include:dE,style:function(ga){return {source:bl};
}},"toolbar-splitbutton":{style:function(gb){return {marginTop:2,marginBottom:2};
}},"toolbar-splitbutton/button":{alias:dR,include:dR,style:function(gc){return {icon:ck,marginTop:undefined,marginBottom:undefined};
}},"toolbar-splitbutton/arrow":{alias:dR,include:dR,style:function(gd){if(gd.pressed||gd.checked||(gd.hovered&&!gd.disabled)){var ge=1;
}else{var ge=3;
}return {padding:ge,icon:ck,marginTop:undefined,marginBottom:undefined};
}},"toolbar-separator":{style:function(gf){return {decorator:bs,margin:7};
}},"tree":dM,"tree-item":{style:function(gg){return {padding:[2,6],textColor:gg.selected?dF:undefined,decorator:gg.selected?dB:undefined};
}},"tree-item/icon":{include:dE,style:function(gh){return {paddingRight:5};
}},"tree-item/label":dL,"tree-item/open":{include:dE,style:function(gi){var gj;

if(gi.selected&&gi.opened){gj=cY;
}else if(gi.selected&&!gi.opened){gj=i;
}else if(gi.opened){gj=bn;
}else{gj=ei;
}return {padding:[0,5,0,2],source:gj};
}},"tree-folder":{include:dT,alias:dT,style:function(gk){var gm,gl;

if(gk.small){gm=gk.opened?o:t;
gl=o;
}else if(gk.large){gm=gk.opened?M:cA;
gl=M;
}else{gm=gk.opened?P:cc;
gl=P;
}return {icon:gm,iconOpened:gl};
}},"tree-file":{include:dT,alias:dT,style:function(gn){return {icon:gn.small?bj:gn.large?E:ea};
}},"treevirtual":O,"treevirtual-folder":{style:function(go){return {icon:go.opened?o:t};
}},"treevirtual-file":{include:bp,alias:bp,style:function(gp){return {icon:bj};
}},"treevirtual-line":{style:function(gq){return {icon:p};
}},"treevirtual-contract":{style:function(gr){return {icon:bn,paddingLeft:5,paddingTop:2};
}},"treevirtual-expand":{style:function(gs){return {icon:ei,paddingLeft:5,paddingTop:2};
}},"treevirtual-only-contract":dU,"treevirtual-only-expand":dn,"treevirtual-start-contract":dU,"treevirtual-start-expand":dn,"treevirtual-end-contract":dU,"treevirtual-end-expand":dn,"treevirtual-cross-contract":dU,"treevirtual-cross-expand":dn,"treevirtual-end":{style:function(gt){return {icon:p};
}},"treevirtual-cross":{style:function(gu){return {icon:p};
}},"tooltip":{include:dN,style:function(gv){return {backgroundColor:bI,padding:[1,3,2,3],offset:[15,5,5,5]};
}},"tooltip/atom":dJ,"tooltip-error":{include:dO,style:function(gw){return {textColor:dF,placeMethod:dI,offset:[0,0,0,14],marginTop:-2,position:l,showTimeout:100,hideTimeout:10000,decorator:bE,shadow:bt,font:dD};
}},"tooltip-error/atom":dJ,"window":{style:function(gx){return {shadow:T,contentPadding:[10,10,10,10]};
}},"window/pane":{style:function(gy){return {decorator:bd};
}},"window/captionbar":{style:function(gz){return {decorator:gz.active?x:cP,textColor:gz.active?dQ:bc,minHeight:26,paddingRight:2};
}},"window/icon":{style:function(gA){return {margin:[5,0,3,6]};
}},"window/title":{style:function(gB){return {alignY:dC,font:dD,marginLeft:6,marginRight:12};
}},"window/minimize-button":{alias:dJ,style:function(gC){return {icon:gC.active?gC.hovered?cy:dd:cW,margin:[4,8,2,0]};
}},"window/restore-button":{alias:dJ,style:function(gD){return {icon:gD.active?gD.hovered?U:y:de,margin:[5,8,2,0]};
}},"window/maximize-button":{alias:dJ,style:function(gE){return {icon:gE.active?gE.hovered?G:cd:ec,margin:[4,8,2,0]};
}},"window/close-button":{alias:dJ,style:function(gF){return {icon:gF.active?gF.hovered?dy:cv:bU,margin:[4,8,2,0]};
}},"window/statusbar":{style:function(gG){return {padding:[2,6],decorator:bF,minHeight:18};
}},"window/statusbar-text":{style:function(gH){return {font:cT};
}},"iframe":{style:function(gI){return {decorator:dH};
}},"resizer":{style:function(gJ){return {decorator:bQ};
}},"splitpane":{style:function(gK){return {decorator:dt};
}},"splitpane/splitter":{style:function(gL){return {width:gL.horizontal?3:undefined,height:gL.vertical?3:undefined,backgroundColor:eo};
}},"splitpane/splitter/knob":{style:function(gM){return {source:gM.horizontal?bg:cM};
}},"splitpane/slider":{style:function(gN){return {width:gN.horizontal?3:undefined,height:gN.vertical?3:undefined,backgroundColor:eo};
}},"selectbox":{alias:dK,include:dK,style:function(gO){return {padding:[2,8]};
}},"selectbox/atom":dJ,"selectbox/popup":dN,"selectbox/list":{alias:dM},"selectbox/arrow":{include:dE,style:function(gP){return {source:ck,paddingLeft:5};
}},"datechooser":{style:function(gQ){var gU;
var gS=!!gQ.focused;
var gT=!!gQ.invalid;
var gR=!!gQ.disabled;

if(gS&&gT&&!gR){gU=ce;
}else if(gS&&!gT&&!gR){gU=dP;
}else if(gR){gU=cg;
}else if(!gS&&gT&&!gR){gU=ci;
}else{gU=ch;
}return {padding:2,decorator:gU,backgroundColor:cn};
}},"datechooser/navigation-bar":{},"datechooser/nav-button":{include:dK,alias:dK,style:function(gV){var gW={padding:[2,4],shadow:undefined};

if(gV.lastYear){gW.icon=cO;
gW.marginRight=1;
}else if(gV.lastMonth){gW.icon=eg;
}else if(gV.nextYear){gW.icon=b;
gW.marginLeft=1;
}else if(gV.nextMonth){gW.icon=dq;
}return gW;
}},"datechooser/last-year-button-tooltip":dO,"datechooser/last-month-button-tooltip":dO,"datechooser/next-year-button-tooltip":dO,"datechooser/next-month-button-tooltip":dO,"datechooser/last-year-button":di,"datechooser/last-month-button":di,"datechooser/next-month-button":di,"datechooser/next-year-button":di,"datechooser/month-year-label":{style:function(gX){return {font:dD,textAlign:dk,textColor:gX.disabled?cm:undefined};
}},"datechooser/date-pane":{style:function(gY){return {textColor:gY.disabled?cm:undefined,marginTop:2};
}},"datechooser/weekday":{style:function(ha){return {textColor:ha.disabled?cm:ha.weekend?em:undefined,textAlign:dk,paddingTop:2,backgroundColor:N};
}},"datechooser/week":{style:function(hb){return {textAlign:dk,padding:[2,4],backgroundColor:N};
}},"datechooser/day":{style:function(hc){return {textAlign:dk,decorator:hc.disabled?undefined:hc.selected?dB:undefined,textColor:hc.disabled?cm:hc.selected?dF:hc.otherMonth?em:undefined,font:hc.today?dD:undefined,padding:[2,4]};
}},"combobox":{style:function(hd){var hh;
var hf=!!hd.focused;
var hg=!!hd.invalid;
var he=!!hd.disabled;

if(hf&&hg&&!he){hh=ce;
}else if(hf&&!hg&&!he){hh=dP;
}else if(he){hh=cg;
}else if(!hf&&hg&&!he){hh=ci;
}else{hh=ch;
}return {decorator:hh};
}},"combobox/popup":dN,"combobox/list":{alias:dM},"combobox/button":{include:dK,alias:dK,style:function(hi){var hj={icon:ck,padding:2};

if(hi.selected){hj.decorator=en;
}return hj;
}},"combobox/textfield":{include:dm,style:function(hk){return {decorator:undefined};
}},"menu":{style:function(hl){var hm={decorator:bb,shadow:bi,spacingX:6,spacingY:1,iconColumnWidth:16,arrowColumnWidth:4,placementModeY:hl.submenu||hl.contextmenu?j:bY};

if(hl.submenu){hm.position=l;
hm.offset=[-2,-3];
}return hm;
}},"menu/slidebar":db,"menu-slidebar":dI,"menu-slidebar-button":{style:function(hn){return {decorator:hn.hovered?dB:undefined,padding:7,center:true};
}},"menu-slidebar/button-backward":{include:el,style:function(ho){return {icon:ho.hovered?Q:J};
}},"menu-slidebar/button-forward":{include:el,style:function(hp){return {icon:hp.hovered?C:ck};
}},"menu-separator":{style:function(hq){return {height:0,decorator:bP,margin:[4,2]};
}},"menu-button":{alias:dJ,style:function(hr){return {decorator:hr.selected?dB:undefined,textColor:hr.selected?dF:undefined,padding:[4,6]};
}},"menu-button/icon":{include:dE,style:function(hs){return {alignY:dC};
}},"menu-button/label":{include:dL,style:function(ht){return {alignY:dC,padding:1};
}},"menu-button/shortcut":{include:dL,style:function(hu){return {alignY:dC,marginLeft:14,padding:1};
}},"menu-button/arrow":{include:dE,style:function(hv){return {source:hv.selected?bR:dq,alignY:dC};
}},"menu-checkbox":{alias:cf,include:cf,style:function(hw){return {icon:!hw.checked?undefined:hw.selected?dX:bh};
}},"menu-radiobutton":{alias:cf,include:cf,style:function(hx){return {icon:!hx.checked?undefined:hx.selected?bV:c};
}},"menubar":{style:function(hy){return {decorator:cx};
}},"menubar-button":{alias:dJ,style:function(hz){return {decorator:(hz.pressed||hz.hovered)&&!hz.disabled?dB:undefined,textColor:hz.pressed||hz.hovered?dF:undefined,padding:[3,8]};
}},"colorselector":dI,"colorselector/control-bar":dI,"colorselector/control-pane":dI,"colorselector/visual-pane":cl,"colorselector/preset-grid":dI,"colorselector/colorbucket":{style:function(hA){return {decorator:dH,width:16,height:16};
}},"colorselector/preset-field-set":cl,"colorselector/input-field-set":cl,"colorselector/preview-field-set":cl,"colorselector/hex-field-composite":dI,"colorselector/hex-field":dm,"colorselector/rgb-spinner-composite":dI,"colorselector/rgb-spinner-red":dS,"colorselector/rgb-spinner-green":dS,"colorselector/rgb-spinner-blue":dS,"colorselector/hsb-spinner-composite":dI,"colorselector/hsb-spinner-hue":dS,"colorselector/hsb-spinner-saturation":dS,"colorselector/hsb-spinner-brightness":dS,"colorselector/preview-content-old":{style:function(hB){return {decorator:dH,width:50,height:10};
}},"colorselector/preview-content-new":{style:function(hC){return {decorator:dH,backgroundColor:cn,width:50,height:10};
}},"colorselector/hue-saturation-field":{style:function(hD){return {decorator:dH,margin:5};
}},"colorselector/brightness-field":{style:function(hE){return {decorator:dH,margin:[5,7]};
}},"colorselector/hue-saturation-pane":dI,"colorselector/hue-saturation-handle":dI,"colorselector/brightness-pane":dI,"colorselector/brightness-handle":dI,"colorpopup":{alias:dN,include:dN,style:function(hF){return {padding:5,backgroundColor:dp};
}},"colorpopup/field":{style:function(hG){return {decorator:dH,margin:2,width:14,height:14,backgroundColor:cn};
}},"colorpopup/selector-button":dG,"colorpopup/auto-button":dG,"colorpopup/preview-pane":cl,"colorpopup/current-preview":{style:function(hH){return {height:20,padding:4,marginLeft:4,decorator:dH,allowGrowX:true};
}},"colorpopup/selected-preview":{style:function(hI){return {height:20,padding:4,marginRight:4,decorator:dH,allowGrowX:true};
}},"colorpopup/colorselector-okbutton":{alias:dG,include:dG,style:function(hJ){return {icon:co};
}},"colorpopup/colorselector-cancelbutton":{alias:dG,include:dG,style:function(hK){return {icon:cw};
}},"table":{alias:dI,style:function(hL){return {decorator:O};
}},"table-header":{},"table/statusbar":{style:function(hM){return {decorator:cR,padding:[0,2]};
}},"table/column-button":{alias:dK,style:function(hN){return {decorator:bf,padding:3,icon:d};
}},"table-column-reset-button":{include:cf,alias:cf,style:function(){return {icon:df};
}},"table-scroller":dI,"table-scroller/scrollbar-x":dj,"table-scroller/scrollbar-y":dj,"table-scroller/header":{style:function(hO){return {decorator:bK};
}},"table-scroller/pane":{style:function(hP){return {backgroundColor:bM};
}},"table-scroller/focus-indicator":{style:function(hQ){return {decorator:bu};
}},"table-scroller/resize-line":{style:function(hR){return {backgroundColor:dr,width:2};
}},"table-header-cell":{alias:dJ,style:function(hS){return {minWidth:13,minHeight:20,padding:hS.hovered?[3,4,2,4]:[3,4],decorator:hS.hovered?cr:bC,sortIcon:hS.sorted?(hS.sortedAscending?cE:a):undefined};
}},"table-header-cell/label":{style:function(hT){return {minWidth:0,alignY:dC,paddingRight:5};
}},"table-header-cell/sort-icon":{style:function(hU){return {alignY:dC,alignX:r};
}},"table-header-cell/icon":{style:function(hV){return {minWidth:0,alignY:dC,paddingRight:5};
}},"table-editor-textfield":{include:dm,style:function(hW){return {decorator:undefined,padding:[2,2],backgroundColor:cn};
}},"table-editor-selectbox":{include:bo,alias:bo,style:function(hX){return {padding:[0,2],backgroundColor:cn};
}},"table-editor-combobox":{include:k,alias:k,style:function(hY){return {decorator:undefined,backgroundColor:cn};
}},"progressive-table-header":{alias:dI,style:function(ia){return {decorator:e};
}},"progressive-table-header-cell":{alias:dJ,style:function(ib){return {minWidth:40,minHeight:25,paddingLeft:6,decorator:bO};
}},"app-header":{style:function(ic){return {font:dD,textColor:dF,padding:[8,12],decorator:ba};
}},"virtual-list":dM,"virtual-list/row-layer":Y,"row-layer":{style:function(id){return {colorEven:dQ,colorOdd:dQ};
}},"column-layer":dI,"cell":{style:function(ie){return {textColor:ie.selected?dF:ej,padding:[3,6],font:bk};
}},"cell-string":cj,"cell-number":{include:cj,style:function(ig){return {textAlign:r};
}},"cell-image":cj,"cell-boolean":{include:cj,style:function(ih){return {iconTrue:bB,iconFalse:z};
}},"cell-atom":cj,"cell-date":cj,"cell-html":cj,"htmlarea":{"include":dI,style:function(ii){return {backgroundColor:dQ};
}},"progressbar":{style:function(ij){return {decorator:w,padding:[1],backgroundColor:dQ};
}},"progressbar/progress":{style:function(ik){return {decorator:dB};
}}}});
})();
...
(function(){var p="Boolean",o="focusout",n="interval",m="mouseover",l="mouseout",k="mousemove",j="widget",i="__qR",h="qx.ui.tooltip.ToolTip",g="_applyCurrent",c="__qU",f="qx.ui.tooltip.Manager",d="__qS",b="tooltip-error",a="singleton";
qx.Class.define(f,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
qx.event.Registration.addListener(document.body,m,this.__rc,this,true);
this.__qR=new qx.event.Timer();
this.__qR.addListener(n,this.__qY,this);
this.__qS=new qx.event.Timer();
this.__qS.addListener(n,this.__ra,this);
this.__qT={left:0,top:0};
},properties:{current:{check:h,nullable:true,apply:g},showInvalidToolTips:{check:p,init:true},showToolTips:{check:p,init:true}},members:{__qT:null,__qS:null,__qR:null,__qU:null,__qV:null,__qW:function(){if(!this.__qU){this.__qU=new qx.ui.tooltip.ToolTip().set({rich:true});
}return this.__qU;
},__qX:function(){if(!this.__qV){this.__qV=new qx.ui.tooltip.ToolTip().set({appearance:b});
this.__qV.syncAppearance();
}return this.__qV;
...
var s=document.body;
if(q){this.__qR.startWith(q.getShowTimeout());
t.addListener(s,l,this.__rd,this,true);
t.addListener(s,o,this.__re,this,true);
t.addListener(s,k,this.__rb,this,true);
}else{t.removeListener(s,l,this.__rd,this,true);
t.removeListener(s,o,this.__re,this,true);
t.removeListener(s,k,this.__rb,this,true);
}},__qY:function(e){var u=this.getCurrent();

if(u&&!u.isDisposed()){this.__qS.startWith(u.getHideTimeout());

if(u.getPlaceMethod()==j){u.placeToWidget(u.getOpener());
}else{u.placeToPoint(this.__qT);
}u.show();
}this.__qR.stop();
},__ra:function(e){var v=this.getCurrent();

if(v&&!v.isDisposed()){v.exclude();
}this.__qS.stop();
this.resetCurrent();
},__rb:function(e){var w=this.__qT;
...
if(x){A=this.__qX().set({label:x});
}
if(!A){A=this.__qW().set({label:B,icon:y});
}this.setCurrent(A);
A.setOpener(z);
},__rd:function(e){var C=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
...
}},__re:function(e){var F=qx.ui.core.Widget.getWidgetByElement(e.getTarget());

if(!F){return;
}var G=this.getCurrent();
if(G&&G==F.getToolTip()){this.setCurrent(null);
}}},destruct:function(){qx.event.Registration.removeListener(document.body,m,this.__rc,this,true);
this._disposeObjects(i,d,c);
this.__qT=null;
}});
})();
...
for(F=z.length;F>3;F-=3){D=t+qx.locale.Number.getGroupSeparator(this.__rn)+z.substring(F-3,F)+D;
}D=z.substring(0,F)+D;
}var B=this.getPrefix()?this.getPrefix():t;
var y=this.getPostfix()?this.getPostfix():t;
var E=B+(A?r:t)+D;

if(C.length>0){E+=t+qx.locale.Number.getDecimalSeparator(this.__rn)+C;
}E+=y;
return E;
},parse:function(I){var N=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__rn)+t);
var L=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__rn)+t);
...
(function(){var n="separator-vertical",m="background-medium",l="Posts",k="bold",j="_applyLoading",i="__rv",h="center",g="feedreader.view.List",f="single",e="__ru",b="middle",d="feedreader/images/loading66.gif",c="__rt",a="Boolean";
...
q.setFont(k);
this._add(q);
this.__rt=new qx.ui.container.Stack();
this._add(this.__rt,{flex:1});
this.__ru=new qx.ui.form.List();
this.__ru.setDecorator(null);
this.__ru.setSelectionMode(f);
this.__rt.add(this.__ru);
this.__rv=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,h));
var o=new qx.ui.basic.Image(d);
o.setAlignY(b);
this.__rv.add(o);
this.__rt.add(this.__rv);
},properties:{loading:{check:a,init:false,apply:j}},members:{__rt:null,__ru:null,__rv:null,_applyLoading:function(r,s){if(r){this.__rt.setSelection([this.__rv]);
}else{this.__rt.setSelection([this.__ru]);
}},getList:function(){return this.__ru;
}},destruct:function(){this._disposeObjects(e,c,i);
}});
})();
...
},_forwardStates:{barLeft:true,barTop:true,barRight:true,barBottom:true},scrollBy:function(v){var w=this.getChildControl(p);

if(this.getOrientation()===q){w.scrollByX(v);
}else{w.scrollByY(v);
}},scrollTo:function(x){var y=this.getChildControl(p);

if(this.getOrientation()===q){y.scrollToX(x);
}else{y.scrollToY(x);
}},_applyOrientation:function(z,A){var D=[this.getLayout(),this._getLayout()];
var C=this.getChildControl(m);
var B=this.getChildControl(n);
if(A==o){C.removeState(o);
B.removeState(o);
C.addState(q);
B.addState(q);
}else if(A==q){C.removeState(q);
B.removeState(q);
C.addState(o);
B.addState(o);
}
if(z==q){this._setLayout(new qx.ui.layout.HBox());
this.setLayout(new qx.ui.layout.HBox());
}else{this._setLayout(new qx.ui.layout.VBox());
...
var G=content.getBounds();
var F=(this.getOrientation()===q)?G.width>E.width:G.height>E.height;

if(F){this._showArrows();
...
(function(){var f="mousedown",d="blur",c="__ry",b="singleton",a="qx.ui.popup.Manager";
qx.Class.define(a,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__ry=[];
qx.event.Registration.addListener(document.documentElement,f,this.__rA,this,true);
qx.bom.Element.addListener(window,d,this.hideAll,this);
},members:{__ry:null,add:function(g){{};
this.__ry.push(g);
this.__rz();
},remove:function(h){{};

if(this.__ry){qx.lang.Array.remove(this.__ry,h);
this.__rz();
}},hideAll:function(){if(this.__ry){for(var i=0;i<this.__ry.length;i++){this.__ry[i].exclude();
}}},__rz:function(){var j=1e7;

for(var i=0;i<this.__ry.length;i++){this.__ry[i].setZIndex(j++);
}},__rA:function(e){var l=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
var m=this.__ry;
...
}}},destruct:function(){qx.event.Registration.removeListener(document.documentElement,f,this.__rA,this,true);
...
}},properties:{model:{check:p,apply:d,event:r,nullable:true},target:{apply:k,event:c,init:null},childPath:{check:t,apply:b,nullable:true},labelPath:{check:t,apply:o,nullable:true},iconPath:{check:t,apply:h,nullable:true},labelOptions:{apply:g,nullable:true},iconOptions:{apply:a,nullable:true},delegate:{apply:q,init:null,nullable:true}},members:{__rD:null,__rB:null,__rC:null,_applyDelegate:function(y,z){this._setConfigureItem(y,z);
this._setCreateItem(y,z);
this._setBindItem(y,z);
},_applyIconOptions:function(A,B){this.__rL();
},_applyLabelOptions:function(C,D){this.__rL();
},_applyTarget:function(E,F){if(F!=undefined){var G=F.getRoot();
F.setRoot(null);
G.destroy();
}if(this.getModel()!=null){this.__rG();
}this._addChangeTargetListener(E,F);
},_applyModel:function(H,I){this.__rG();
},_applyChildPath:function(J,K){this.__rG();
},_applyIconPath:function(L,M){this.__rL();
},_applyLabelPath:function(N,O){this.__rL();
},__rE:function(P){var R=P.getTarget();
var Q=this.__rD[R.toHashCode()].treeNode;
var S=this.__rD[R.toHashCode()].modelNode;
this.__rH(Q,S);
this._updateSelection();
},__rF:function(e){var ba=e.getData();
var V=e.getOldData();
var W=this.__rD[V.toHashCode()];
V.removeListenerById(W.changeListenerId);
delete this.__rD[V.toHashCode()];
...
var T=Y.event;
var X=bb.addListener(T,this.__rF,this);
var U=W.treeNode;
this.__rD[ba.toHashCode()]={modelNode:bb,treeNode:U,changeListenerId:W.changeListenerId,changeChildernListenerId:X};
this.__rH(U,bb);
this._updateSelection();
...
},__rG:function(){if(this.getTarget()==null||this.getChildPath()==null){return;
...
this.__rM(this.getModel(),bf);
this.__rH(bf,this.getModel());
}},__rH:function(bg,bh){if(bh[s+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;
}var bq=bh[s+qx.lang.String.firstUp(this.getChildPath())]();
if(this.__rD[bq.toHashCode()]==undefined){var bl=bq.addListener(m,this.__rE,this);
var bp=qx.Class.getPropertyDefinition(bh.constructor,this.getChildPath());
var bm=bp.event;
var bn=bh.addListener(bm,this.__rF,this);
this.__rD[bq.toHashCode()]={modelNode:bh,treeNode:bg,changeListenerId:bl,changeChildernListenerId:bn};
...
}},__rL:function(){var bS;

for(var bU in this.__rB){bS=bU;
break;
}for(var bR in this.__rB[bS]){var bV=this.__rB[bS][bR].treeNode;
var bT=qx.core.ObjectRegistry.fromHashCode(bR);
this.__rN(bT);
this.__rM(bT,bV);
}},__rM:function(bW,bX){var bY=this.getDelegate();
if(bY!=null&&bY.bindItem!=null){bY.bindItem(this,bX,bW);
}else{this.bindDefaultProperties(bX,bW);
}},__rN:function(ca){for(var i=0;i<this.__rC.length;i++){var cc=this.__rC[i];
var cb=this.__rB[cc][ca.toHashCode()];

if(cb!=null){if(cb.id){ca.removeBinding(cb.id);
}
if(cb.reverseId){cb.treeNode.removeBinding(cb.reverseId);
}delete this.__rB[cc][ca.toHashCode()];
...
}}},destruct:function(){this.__rB=this.__rD=this.__rC=null;
}});
})();
...
qx.Class.define(h,{extend:qx.ui.root.Abstract,construct:function(o){this.__rQ=qx.dom.Node.getWindow(o);
this.__rR=o;
qx.ui.root.Abstract.call(this);
qx.event.Registration.addListener(this.__rQ,n,this._onResize,this);
this._setLayout(new qx.ui.layout.Canvas());
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
this.getContentElement().disableScrolling();
},members:{__rQ:null,__rR:null,_createContainerElement:function(){var p=this.__rR;
...
},_computeSizeHint:function(){var u=qx.bom.Viewport.getWidth(this.__rQ);
var v=qx.bom.Viewport.getHeight(this.__rQ);
...
if(!feedreader.view.Article.__rS){feedreader.view.Article.__rS=true;
...
w.setLineHeight(1.8);
this.setFont(w);
},properties:{article:{apply:e,nullable:true,check:d}},members:{_applyArticle:function(x,y){var z=this.__rT();
this.setHtml(z);
qx.html.Element.flush();
var B=this.getContentElement().getDomElement();
var A=B.getElementsByTagName(b);
for(var i=0;i<A.length;i++){A[i].target=t;
}},__rT:function(){var D=this.getArticle();
if(!D){return v;
...
}},properties:{sort:{check:[l,m,n],init:l,apply:j},separatorX:{check:p,nullable:true,apply:s},separatorY:{check:p,nullable:true,apply:s},connectSeparators:{check:e,init:false,apply:s},spacingX:{check:o,init:0,apply:s},spacingY:{check:o,init:0,apply:s}},members:{__rU:null,__rV:null,verifyLayoutProperty:null,_applySort:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__rW:{north:1,south:2,west:3,east:4,center:5},__rX:{1:q,2:d,3:r,4:g},__rY:function(){var x=this._getLayoutChildren();
var F,z;
var length=x.length;
var B=[];
var E=[];
...
delete this._invalidChildrenCache;
},renderLayout:function(H,I){if(this._invalidChildrenCache){this.__rY();
}var bc=qx.ui.layout.Util;
var O=this.__rU;
var bd=this.__rV;
var length=O.length;
...
}},destruct:function(){this.__rV=this.__rU=null;
}});
})();
(function(){var l="zIndex",k="px",j="keydown",h="deactivate",g="resize",f="keyup",d="keypress",c="backgroundColor",b="_applyOpacity",a="Boolean",x="opacity",w="__sf",v="interval",u="Tab",t="Color",s="qx.ui.root.Page",r="__sh",q="__sd",p="Number",o="qx.ui.core.Blocker",m="qx.ui.root.Application",n="_applyColor";
...
if(this._isPageRoot){y.addListener(g,this.__si,this);
}
if(qx.Class.isDefined(m)&&y instanceof qx.ui.root.Application){this.setKeepBlockerActive(true);
}this.__sa=[];
this.__sb=[];
this.__sc=[];
},properties:{color:{check:t,init:null,nullable:true,apply:n,themeable:true},opacity:{check:p,init:1,apply:b,themeable:true},keepBlockerActive:{check:a,init:false}},members:{__sd:null,__se:0,__sf:null,__sc:null,__sa:null,__sb:null,__sg:null,__sh:null,_isPageRoot:false,_widget:null,__si:function(e){var z=e.getData();
...
this.__sj(c,C);
},_applyOpacity:function(D,E){this.__sj(x,D);
},__sj:function(F,G){var H=[];
this.__sd&&H.push(this.__sd);
this.__sf&&H.push(this.__sf);
...
this.__sa.push(I.getActive());
this.__sb.push(I.getFocus());

if(this._widget.isFocusable()){this._widget.focus();
}},_restoreActiveWidget:function(){var L=this.__sa.length;

if(L>0){var K=this.__sa[L-1];

if(K){qx.bom.Element.activate(K);
}this.__sa.pop();
}var J=this.__sb.length;

if(J>0){var K=this.__sb[J-1];

if(K){qx.bom.Element.focus(this.__sb[J-1]);
}this.__sb.pop();
}},__sk:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());
},getBlockerElement:function(){if(!this.__sd){this.__sd=this.__sk();
this.__sd.setStyle(l,15);
...
M.include();
M.activate();
M.addListener(h,this.__sp,this);
M.addListener(d,this.__so,this);
M.addListener(j,this.__so,this);
M.addListener(f,this.__so,this);
}},isBlocked:function(){return this.__se>0;
},unblock:function(){if(!this.isBlocked()){return;
}this.__se--;

if(this.__se<1){this.__sl();
this.__se=0;
}},forceUnblock:function(){if(!this.isBlocked()){return;
}this.__se=0;
this.__sl();
},__sl:function(){this._restoreActiveWidget();
var N=this.getBlockerElement();
N.removeListener(h,this.__sp,this);
N.removeListener(d,this.__so,this);
N.removeListener(j,this.__so,this);
N.removeListener(f,this.__so,this);
N.exclude();
},getContentBlockerElement:function(){if(!this.__sf){this.__sf=this.__sk();
...
if(this.__sc.length<2){P.include();

if(this._isPageRoot){if(!this.__sh){this.__sh=new qx.event.Timer(300);
this.__sh.addListener(v,this.__sn,this);
}this.__sh.start();
this.__sn();
}}},isContentBlocked:function(){return this.__sc.length>0;
},unblockContent:function(){if(!this.isContentBlocked()){return;
}this.__sc.pop();
var Q=this.__sc[this.__sc.length-1];
var R=this.getContentBlockerElement();
R.setStyle(l,Q);

if(this.__sc.length<1){this.__sm();
this.__sc=[];
...
S.setStyle(l,null);
this.__sm();
},__sm:function(){this.getContentBlockerElement().exclude();

if(this._isPageRoot){this.__sh.stop();
}},__sn:function(){var T=this._widget.getContainerElement().getDomElement();
...
},__so:function(e){if(e.getKeyIdentifier()==u){e.stop();
}},__sp:function(){if(this.getKeepBlockerActive()){this.getBlockerElement().activate();
}}},destruct:function(){if(this._isPageRoot){this._widget.removeListener(g,this.__si,this);
}this._disposeObjects(w,q,r);
...
this.__sw=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({allowShrinkY:false,allowGrowX:true});
this.getChildControl(p).add(this.__sw);
this.initOpenMode();
this.initRootOpenClose();
this.addListener(x,this._onChangeSelection,this);
this.addListener(q,this._onKeyPress,this);
},events:{addItem:f,removeItem:f},properties:{openMode:{check:[k,l,o],init:l,apply:d,event:z,themeable:true},root:{check:n,init:null,nullable:true,event:t,apply:r},hideRoot:{check:j,init:false,apply:u},rootOpenClose:{check:j,init:false,apply:y},appearance:{refine:true,init:v},focusable:{refine:true,init:true}},members:{__sw:null,SELECTION_MANAGER:qx.ui.tree.SelectionManager,getChildrenContainer:function(){return this.__sw;
...
},_getContentPaddingTarget:function(){return this.__sw;
