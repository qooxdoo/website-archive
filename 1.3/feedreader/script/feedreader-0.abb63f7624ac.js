...
},__hW:[r,G,E,m,y,I],getKeys:({"ES5":Object.keys,"BROKEN_IE":function(bs){var bt=[];
var bv=Object.prototype.hasOwnProperty;

for(var bw in bs){if(bv.call(bs,bw)){bt.push(bw);
}}var bu=qx.Bootstrap.__hW;
...
},__hX:{"[object String]":d,"[object Array]":f,"[object Object]":h,"[object RegExp]":D,"[object Number]":x,"[object Boolean]":K,"[object Date]":s,"[object Function]":c,"[object Error]":J},bind:function(bE,self,bF){var bG=Array.prototype.slice.call(arguments,2,arguments.length);
...
return (qx.Bootstrap.__hX[bL]||bL.slice(8,-1));
...
},$$registry:{},__es:null,__et:function(){}}});
})();
(function(){var h="qx.allowUrlSettings",g="&",f="qx.core.Setting",e="qx.allowUrlVariants",d="qx.propertyDebugLevel",c="qxsetting",b=":",a=".";
qx.Bootstrap.define(f,{statics:{__ev:{},define:function(j,k){if(k===undefined){throw new Error('Default value of setting "'+j+'" must be defined!');
}
if(!this.__ev[j]){this.__ev[j]={};
}else if(this.__ev[j].defaultValue!==undefined){throw new Error('Setting "'+j+'" is already defined!');
}this.__ev[j].defaultValue=k;
},get:function(l){var m=this.__ev[l];
...
if(!this.__ev[n]){this.__ev[n]={};
}this.__ev[n].value=o;
},__ew:function(){if(window.qxsettings){for(var p in window.qxsettings){this.set(p,window.qxsettings[p]);
}window.qxsettings=undefined;

try{delete window.qxsettings;
}catch(q){}this.__ex();
}},__ex:function(){if(this.get(h)!=true){return;
...
},__fH:function(o,p,q,r){var v=q.$$members;

if(v){for(var u in v){if(qx.Bootstrap.isFunction(v[u])){var t=this.__fI(p,u);
...
if(w){o[u]=this.__fL(q,o[u],u,v[u]);
...
}}}}}},__fI:function(x,y){var C=y.match(/^(is|toggle|get|set|reset)(.*)$/);
...
},__fJ:function(D,E){if(E.$$properties){for(var F in E.$$properties){if(!qx.Bootstrap.getPropertyDefinition(D,F)){throw new Error('The property "'+F+'" is not supported by Class "'+D.classname+'"!');
}}}},__fK:function(G,H){if(H.$$events){for(var I in H.$$events){if(!qx.Bootstrap.supportsEvent(G,I)){throw new Error('The event "'+I+'" is not supported by Class "'+G.classname+'"!');
}}}},assertObject:function(J,K){var M=J.constructor;
this.__fH(J,M,K,false);
this.__fJ(M,K);
this.__fK(M,K);
var L=K.$$extends;

if(L){for(var i=0,l=L.length;i<l;i++){this.assertObject(J,L[i]);
}}},assert:function(N,O,P){this.__fH(N.prototype,N,O,P);
this.__fJ(N,O);
this.__fK(N,O);
var Q=O.$$extends;
...
},$$registry:{},__fL:function(){},__fM:null,__fN:function(){}}});
})();
(function(){var d="qx.core.Aspect",c="before",b="*",a="static";
qx.Bootstrap.define(d,{statics:{__kA:[],wrap:function(e,f,g){var m=[];
var h=[];
var l=this.__kA;
var k;
...
qx.Bootstrap.define(a,{statics:{NAME:"",FULLVERSION:"0.0.0",VERSION:0.0,OPERA:false,WEBKIT:false,GECKO:false,MSHTML:false,UNKNOWN_ENGINE:false,UNKNOWN_VERSION:false,DOCUMENT_MODE:null,__eu:function(){var t=d;
var x=e;
...
}},defer:function(A){A.__eu();
}});
})();
(function(){var w="off",u="on",t="|",s="default",r="object",q="&",p="qx.aspects",o="qx.mobile",n="$",m="qx.allowUrlVariants",d="qx.debug",k="qx.client",g="qx.dynlocale",c="webkit",b="qxvariant",f="opera",e=":",h="qx.core.Variant",a="mshtml",j="gecko";
qx.Bootstrap.define(h,{statics:{__kR:{},__kS:{},compilerIsSet:function(){return true;
},define:function(x,y,z){{};

if(!this.__kR[x]){this.__kR[x]={};
}else{}this.__kR[x].allowedValues=y;
this.__kR[x].defaultValue=z;
},get:function(A){var B=this.__kR[A];
{};

if(B.value!==undefined){return B.value;
}return B.defaultValue;
},__kT:function(){if(window.qxvariants){for(var C in qxvariants){{};

if(!this.__kR[C]){this.__kR[C]={};
}this.__kR[C].value=qxvariants[C];
}window.qxvariants=undefined;

try{delete window.qxvariants;
}catch(D){}this.__kU(this.__kR);
}},__kU:function(){if(qx.core.Setting.get(m)!=true){return;
}var E=document.location.search.slice(1).split(q);

for(var i=0;i<E.length;i++){var F=E[i].split(e);

if(F.length!=3||F[0]!=b){continue;
}var G=F[1];

if(!this.__kR[G]){this.__kR[G]={};
}this.__kR[G].value=decodeURIComponent(F[2]);
}},select:function(H,I){{};
...
if(this.__kS[M]!==undefined){return this.__kS[M];
}var O=false;
if(L.indexOf(t)<0){O=this.get(K)===L;
}else{var N=L.split(t);

for(var i=0,l=N.length;i<l;i++){if(this.get(K)===N[i]){O=true;
break;
}}}this.__kS[M]=O;
return O;
},__kV:function(v){return typeof v===r&&v!==null&&v instanceof Array;
},__kW:function(v){return typeof v===r&&v!==null&&!(v instanceof Array);
},__kX:function(P,Q){for(var i=0,l=P.length;i<l;i++){if(P[i]==Q){return true;
}}return false;
}},defer:function(R){R.define(k,[j,a,f,c],qx.bom.client.Engine.NAME);
R.define(d,[u,w],u);
R.define(p,[u,w],w);
R.define(g,[u,w],u);
R.define(o,[u,w],w);
...
qx.Bootstrap.define(d,{statics:{__ly:{"Boolean":cM,"String":bG,"Number":ci,"Integer":cm,"PositiveNumber":D,"PositiveInteger":v,"Error":cY,"RegExp":cg,"Object":bI,"Array":F,"Map":bU,"Function":bR,"Date":cU,"Node":z,"Element":p,"Document":j,"Window":cR,"Event":cQ,"Class":bJ,"Mixin":m,"Interface":s,"Theme":bE,"Color":g,"Decorator":B,"Font":h},__lz:{"Node":true,"Element":true,"Document":true,"Window":true,"Event":true},$$inherit:P,$$store:{runtime:{},user:{},theme:{},inherit:{},init:{},useinit:{}},$$method:{get:{},set:{},reset:{},init:{},refresh:{},setRuntime:{},resetRuntime:{},setThemed:{},resetThemed:{}},$$allowedKeys:{name:bw,dereference:bt,inheritable:bt,nullable:bt,themeable:bt,refine:bt,init:null,apply:bw,event:bw,check:null,transform:bw,deferredInit:bt,validate:null},$$allowedGroupKeys:{name:bw,group:bO,mode:bw,themeable:bt},$$inheritable:{},__lA:function(df){var dg=this.__lB(df);

if(!dg.length){var dh=qx.lang.Function.empty;
}else{dh=this.__lC(dg);
}df.prototype.$$refreshInheritables=dh;
},__lB:function(di){var dk=[];
...
},__lC:function(dl){var dq=this.$$store.inherit;
...
},attachRefreshInheritables:function(dr){dr.prototype.$$refreshInheritables=function(){qx.core.Property.__lA(dr);
return this.$$refreshInheritables();
};
},attachMethods:function(ds,name,dt){dt.group?this.__lD(ds,dt,name):this.__lE(ds,dt,name);
},__lD:function(du,dv,name){var dC=qx.Bootstrap.firstUp(name);
var dB=du.prototype;
...
}},__lE:function(dF,dG,name){var dI=qx.Bootstrap.firstUp(name);
var dK=dF.prototype;
{};
if(dG.dereference===undefined&&typeof dG.check===bw){dG.dereference=this.__lF(dG.check);
}var dJ=this.$$method;
var dH=this.$$store;
...
}},__lF:function(dQ){return !!this.__lz[dQ];
},__lG:function(dR){return this.__lz[dR]||qx.Bootstrap.classIsDefined(dR)||(qx.Interface&&qx.Interface.isDefined(dR));
},__lH:{0:b,1:Y,2:dd,3:bm,4:cn,5:U},error:function(dS,dT,dU,dV,dW){var dX=dS.constructor.classname;
var dY=r+dU+N+dX+da+this.$$method[dV][dU]+cL+dW+M;
throw new Error(dY+(this.__lH[dT]||"Unknown reason: "+dT));
},__lI:function(ea,eb,name,ec,ed,ee){var ef=this.$$method[ec][name];
...
}return this.__lI(eg,em,name,ei,ej);
...
var ew=this.__lJ(ep,name);
this.__lK(es,ev,name,ep,er);

if(er){this.__lL(es,eo,ev,name);
}
if(et){this.__lM(es,er,ew,ep);
}
if(ev.inheritable){es.push(bb);
}{};

if(!et){this.__lO(es,name,ep,er);
}else{this.__lP(es,ev,name,ep,er);
}
if(ev.inheritable){this.__lQ(es,ev,name,ep);
}else if(et){this.__lR(es,ev,name,ep);
}
if(et){this.__lS(es,ev,name);
if(ev.inheritable&&eu._getChildren){this.__lT(es,name);
}}if(er){es.push(bi);
}return this.__lI(en,eu,name,ep,es,eq);
},__lJ:function(ex,name){if(ex===ct||ex===bs){var ey=this.$$store.runtime[name];
}else if(ex===cu||ex===by){ey=this.$$store.theme[name];
}else if(ex===cs){ey=this.$$store.init[name];
}else{ey=this.$$store.user[name];
}return ey;
},__lK:function(ez,eA,name,eB,eC){{if(!eA.nullable||eA.check||eA.inheritable){ez.push(cK);
}if(eB===cv){ez.push(V,name,w,eB,ba);
}};
},__lL:function(eD,eE,eF,name){if(eF.transform){eD.push(x,eF.transform,cb);
...
eD.push(cV);
}}},__lM:function(eG,eH,eI,eJ){var eK=(eJ===bu||eJ===by||eJ===bs);

if(eH){eG.push(cr,eI,k);
}else if(eK){eG.push(cr,eI,y);
}},__lN:undefined,__lO:function(eL,name,eM,eN){if(eM===ct){eL.push(cw,this.$$store.runtime[name],cx);
...
}},__lP:function(eO,eP,name,eQ,eR){if(eP.inheritable){eO.push(S,this.$$store.inherit[name],cz);
}else{eO.push(bP);
...
}},__lQ:function(eS,eT,name,eU){eS.push(E);
...
},__lR:function(eV,eW,name,eX){if(eX!==cv&&eX!==ct&&eX!==cu){eV.push(bT);
}eV.push(cd);
if(eW.init!==undefined&&eX!==cs){eV.push(cI,this.$$store.init[name],cC);
}else{eV.push(cc);
}},__lS:function(eY,fa,name){if(fa.apply){eY.push(cw,fa.apply,bh,name,bH);
}if(fa.event){eY.push(bD,bl,fa.event,A,ck,fa.event,bc,K);
}},__lT:function(fb,name){fb.push(cX);
...
(function(){var r="|bubble",q="|capture",p="|",o="",n="_",m="unload",k="UNKNOWN_",j="__fs",h="c",g="__fr",c="DOM_",f="WIN_",e="QX_",b="qx.event.Manager",a="capture",d="DOCUMENT_";
qx.Class.define(b,{extend:Object,construct:function(s,t){this.__fn=s;
this.__fo=qx.core.ObjectRegistry.toHashCode(s);
this.__fp=t;
...
this.__fs={};
this.__ft={};
},statics:{__fu:0,getNextUniqueId:function(){return (this.__fu++)+o;
}},members:{__fp:null,__fq:null,__fs:null,__fv:null,__fr:null,__ft:null,__fn:null,__fo:null,getWindow:function(){return this.__fn;
},getWindowId:function(){return this.__fo;
},getHandler:function(u){var v=this.__fr[u.classname];

if(v){return v;
}return this.__fr[u.classname]=new u(this);
},getDispatcher:function(w){var x=this.__fs[w.classname];

if(x){return x;
}return this.__fs[w.classname]=new w(this,this.__fp);
...
if(Q){this.__fw(P,W,R);
}else{this.__fx(P,W,R);
...
if(!bj){bj=bo[bm]=[];
this.__fw(bg,bl.type,bl.capture);
}bj.push({handler:bl.listener,context:bl.self,unique:bl.unique||(bk.__fu++)+o});
}},addListener:function(bp,bq,br,self,bs){var bw;
{};
var bx=bp.$$hash||qx.core.ObjectRegistry.toHashCode(bp);
var bz=this.__fq[bx];

if(!bz){bz=this.__fq[bx]={};
}var bv=bq+(bs?q:r);
var bu=bz[bv];

if(!bu){bu=bz[bv]=[];
}if(bu.length===0){this.__fw(bp,bq,bs);
}var by=(qx.event.Manager.__fu++)+o;
...
},__fw:function(bP,bQ,bR){var bS=this.findHandler(bP,bQ);
...
if(bY.length==0){this.__fx(bT,bU,bW);
}return true;
}}return false;
...
if(ci.length==0){this.__fx(ce,co,cg);
}return true;
}}return false;
...
return true;
},deleteAllListeners:function(cx){delete this.__fq[cx];
},__fx:function(cy,cz,cA){var cB=this.findHandler(cy,cz);
...
}var cG=this.__fp.getDispatchers();
var cF;
var cE=false;
...
return !cD;
},dispose:function(){this.__fp.removeManager(this);
qx.util.DisposeUtil.disposeMap(this,g);
qx.util.DisposeUtil.disposeMap(this,j);
this.__fq=this.__fn=this.__fv=null;
this.__fp=this.__ft=null;
}}});
})();
...
qx.Class.define(c,{statics:{__fb:{},getManager:function(d){if(d==null){{};
d=window;
...
},PRIORITY_FIRST:-32000,PRIORITY_NORMAL:0,PRIORITY_LAST:32000,__fc:[],addHandler:function(Q){{};
this.__fc.push(Q);
this.__fc.sort(function(a,b){return a.PRIORITY-b.PRIORITY;
});
},getHandlers:function(){return this.__fc;
},__fd:[],addDispatcher:function(R,S){{};
this.__fd.push(R);
this.__fd.sort(function(a,b){return a.PRIORITY-b.PRIORITY;
});
},getDispatchers:function(){return this.__fd;
}}});
})();
(function(){var e="$$hash",d="",c="qx.core.ObjectRegistry";
qx.Class.define(c,{statics:{inShutDown:false,__cN:{},__cO:0,__cP:[],register:function(f){var j=this.__cN;

if(!j){return;
}var h=f.$$hash;

if(h==null){var g=this.__cP;
...
if(t!=null){this.__cP.push(t);
try{delete s.$$hash;
}catch(u){if(s.removeAttribute){s.removeAttribute(e);
}}}},fromHashCode:function(v){return this.__cN[v]||null;
...
delete this.__cN;
},getRegistry:function(){return this.__cN;
}}});
})();
...
},members:{__ik:0,__il:0,__im:false,__in:0,__io:null,__ip:null,setMaxEntries:function(c){this.__ip=c;
this.clear();
},getMaxEntries:function(){return this.__ip;
},addEntry:function(d){this.__io[this.__ik]=d;
this.__ik=this.__iq(this.__ik,1);
var e=this.getMaxEntries();

if(this.__il<e){this.__il++;
}if(this.__im&&(this.__in<e)){this.__in++;
}},mark:function(){this.__im=true;
this.__in=0;
},clearMark:function(){this.__im=false;
},getAllEntries:function(){return this.getEntries(this.getMaxEntries(),false);
},getEntries:function(f,g){if(f>this.__il){f=this.__il;
}if(g&&this.__im&&(f>this.__in)){f=this.__in;
}
if(f>0){var i=this.__iq(this.__ik,-1);
var h=this.__iq(i,-f+1);
var j;

if(h<=i){j=this.__io.slice(h,i+1);
}else{j=this.__io.slice(h,this.__il).concat(this.__io.slice(0,i+1));
}}else{j=[];
}return j;
},clear:function(){this.__io=new Array(this.getMaxEntries());
this.__il=0;
this.__in=0;
this.__ik=0;
},__iq:function(k,l){var m=this.getMaxEntries();
var n=(k+l)%m;
if(n<0){n+=m;
}return n;
}}});
...
},"webkit":function(Q){if(Q.sourceURL&&Q.line){return [this.__kL(Q.sourceURL)+j+Q.line];
}else{return [];
...
qx.Class.define(s,{statics:{__fe:A,setLevel:function(I){this.__fe=I;
},getLevel:function(){return this.__fe;
},setTreshold:function(J){this.__fh.setMaxMessages(J);
},getTreshold:function(){return this.__fh.getMaxMessages();
},__ff:{},__fg:0,register:function(K){if(K.$$id){return;
}var L=this.__fg++;
this.__ff[L]=K;
K.$$id=L;
var M=this.__fh.getAllLogEvents();
...
delete N.$$id;
},debug:function(P,Q){qx.log.Logger.__fj(A,arguments);
},info:function(R,S){qx.log.Logger.__fj(e,arguments);
},warn:function(T,U){qx.log.Logger.__fj(r,arguments);
},error:function(V,W){qx.log.Logger.__fj(j,arguments);
},trace:function(X){qx.log.Logger.__fj(e,[X,qx.dev.StackTrace.getStackTrace().join(u)]);
...
{};
},clear:function(){this.__fh.clearHistory();
},__fh:new qx.log.appender.RingBuffer(50),__fi:{debug:0,info:1,warn:2,error:3},__fj:function(bu,bv){var bA=this.__fi;

if(bA[bu]<bA[this.__fe]){return;
}var bx=bv.length<2?null:bv[0];
var bz=bx?1:0;
var bw=[];

for(var i=bz,l=bv.length;i<l;i++){bw.push(this.__fl(bv[i],true));
}var bB=new Date;
...
}}this.__fh.process(bC);
var bD=this.__ff;

for(var by in bD){bD[by].process(bC);
}},__fk:function(bE){if(bE===undefined){return y;
...
},__fl:function(bG,bH){var bO=this.__fk(bG);
var bK=D;
var bJ=[];
...
for(var i=0;i<bQ.length;i++){bP.__fj(bQ[i][0],bQ[i][1]);
...
},__lq:qx.event.Registration,addListener:function(H,I,self,J){if(!this.$$disposed){return this.__lq.addListener(this,H,I,self,J);
}return null;
},addListenerOnce:function(K,L,self,M){var N=function(e){this.removeListener(K,N,this,M);
L.call(self||this,e);
};
return this.addListener(K,N,this,M);
},removeListener:function(O,P,self,Q){if(!this.$$disposed){return this.__lq.removeListener(this,O,P,self,Q);
}return false;
},removeListenerById:function(R){if(!this.$$disposed){return this.__lq.removeListenerById(this,R);
}return false;
},hasListener:function(S,T){return this.__lq.hasListener(this,S,T);
},dispatchEvent:function(U){if(!this.$$disposed){return this.__lq.dispatchEvent(this,U);
}return true;
},fireEvent:function(V,W,X){if(!this.$$disposed){return this.__lq.fireEvent(this,V,W,X);
}return true;
},fireNonBubblingEvent:function(Y,ba,bb){if(!this.$$disposed){return this.__lq.fireNonBubblingEvent(this,Y,ba,bb);
}return true;
},fireDataEvent:function(bc,bd,be,bf){if(!this.$$disposed){if(be===undefined){be=null;
}return this.__lq.fireNonBubblingEvent(this,bc,qx.event.type.Data,[bd,be,!!bf]);
}return true;
},__lr:null,setUserData:function(bg,bh){if(!this.__lr){this.__lr={};
}this.__lr[bg]=bh;
},getUserData:function(bi){if(!this.__lr){return null;
}var bj=this.__lr[bi];
return bj===undefined?null:bj;
},__ls:qx.log.Logger,debug:function(bk){this.__lt(f,arguments);
},info:function(bl){this.__lt(m,arguments);
},warn:function(bm){this.__lt(h,arguments);
},error:function(bn){this.__lt(j,arguments);
},trace:function(){this.__ls.trace(this);
},__lt:function(bo,bp){var bq=qx.lang.Array.fromArguments(bp);
bq.unshift(this);
this.__ls[bo].apply(this.__ls,bq);
...
}if(this.__lu){this.__lu();
}{};
},__lu:null,__lv:function(){var bx=qx.Class.getProperties(this.constructor);
...
qx.Bootstrap.define(a,{statics:{setErrorHandler:function(d,f){this.__kr=d||null;
this.__ks=f||window;

if(qx.core.Setting.get(c)===b){if(d&&window.onerror){var g=qx.Bootstrap.bind(this.__ku,this);

if(this.__kt==null){this.__kt=window.onerror;
}var self=this;
window.onerror=function(e){self.__kt(e);
g(e);
};
}
if(d&&!window.onerror){window.onerror=qx.Bootstrap.bind(this.__ku,this);
}if(this.__kr==null){if(this.__kt!=null){window.onerror=this.__kt;
this.__kt=null;
}else{window.onerror=null;
}}}},__ku:function(h,i,j){if(this.__kr){this.handleError(new qx.core.WindowError(h,i,j));
return true;
}},observeMethod:function(k){if(qx.core.Setting.get(c)===b){var self=this;
return function(){if(!self.__kr){return k.apply(this,arguments);
}
try{return k.apply(this,arguments);
}catch(l){self.handleError(new qx.core.GlobalError(l,arguments));
}};
}else{return k;
}},handleError:function(m){if(this.__kr){this.__kr.call(this.__ks,m);
...
qx.Class.define(l,{statics:{__kF:null,getScrollbarWidth:function(){if(this.__kF!==null){return this.__kF;
...
qx.Class.define(c,{statics:{__eQ:qx.core.Variant.select(e,{"mshtml":{"cursor":a,"ew-resize":j,"ns-resize":k,"nesw-resize":h,"nwse-resize":i},"opera":{"col-resize":j,"row-resize":k,"ew-resize":j,"ns-resize":k,"nesw-resize":h,"nwse-resize":i},"default":{}}),compile:function(l){return f+(this.__eQ[l]||l)+d;
},get:function(m,n){return qx.bom.element.Style.get(m,b,n,false);
},set:function(o,p){o.style.cursor=this.__eQ[p]||p;
...
this.__kM=b+(c&&c.message?c.message:c);
Error.call(this,this.__kM);
this.__kN=d;
this.__kO=c;
},members:{__kO:null,__kN:null,__kM:null,toString:function(){return this.__kM;
},getArguments:function(){return this.__kN;
},getSourceException:function(){return this.__kO;
...
j.target=i.target;
return j;
},__kx:{0:h,2:g,1:f},__ky:{1:h,2:g,4:f},stop:function(){this.stopPropagation();
},getButton:function(){switch(this._type){case c:return g;
case d:if(this.__kz){return this.__kz();
}default:if(this._native.target!==undefined){return this.__kx[this._native.button]||e;
}else{return this.__ky[this._native.button]||e;
}}},__kz:qx.core.Variant.select(a,{"mshtml":function(){return h;
...
(function(){var a="qx.event.type.MouseWheel";
qx.Class.define(a,{extend:qx.event.type.Mouse,statics:{MAXSCROLL:1,BROWSER_FACTOR:{"gecko":1}},members:{stop:function(){this.stopPropagation();
this.preventDefault();
},__cM:function(b){var d=qx.bom.client.Engine.NAME;

if(qx.event.type.MouseWheel.BROWSER_FACTOR[d]){return qx.event.type.MouseWheel.BROWSER_FACTOR[d]*b;
}var c=Math.abs(b);

if(qx.event.type.MouseWheel.MAXSCROLL<c){qx.event.type.MouseWheel.MAXSCROLL=c;
}if(qx.event.type.MouseWheel.MAXSCROLL===c){return 2*(b/c);
}var e=(b/qx.event.type.MouseWheel.MAXSCROLL)*Math.log(qx.event.type.MouseWheel.MAXSCROLL)/1.75;
return e;
},getWheelDelta:function(){if(this._native.detail){return this.__cM(this._native.detail);
}return this.__cM(-this._native.wheelDelta);
}}});
})();
...
}},properties:{alignX:{check:[m,k,c],init:m,apply:n},alignY:{check:[j,g,e],init:j,apply:n},spacing:{check:a,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:d,init:false,apply:f}},members:{__cQ:null,__cR:null,__cS:null,__cT:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__cU:function(){var w=this._getLayoutChildren();
var length=w.length;
var t=false;
var r=this.__cQ&&this.__cQ.length!=length&&this.__cR&&this.__cQ;
var u;
var s=r?this.__cQ:new Array(length);
var v=r?this.__cR:new Array(length);
...
},verifyLayoutProperty:null,renderLayout:function(x,y){if(this._invalidChildrenCache){this.__cU();
}var E=this.__cT;
var length=E.length;
...
for(i=0;i<length;i+=1){J=this.__cQ[i];
K=J!=null?Math.floor((x-B)*J):E[i].getSizeHint().width;
P.push(K);
F+=K;
}if(this.__cS&&F!=x){var H={};
var L,O;

for(i=0;i<length;i+=1){L=this.__cR[i];
...
U+=K;
D=z.getMarginRight();
}},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__cU();
...
}},destruct:function(){this.__cQ=this.__cR=this.__cT=null;
}});
})();
(function(){var b="qx.ui.core.DecoratorFactory",a="$$nopool$$";
qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__cV={};
},statics:{MAX_SIZE:15,__cW:a},members:{__cV:null,getDecoratorElement:function(c){var h=qx.ui.core.DecoratorFactory;
...
}},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){var q=this.__cV;
...
this.__cX=c;
this.__cY=d||b;
this.__da=e===undefined?-1:e;
},members:{__cX:null,__cY:null,__da:null,toString:function(){return this.__cX;
},getUri:function(){return this.__cY;
},getLineNumber:function(){return this.__da;
}}});
})();
...
},compile:function(r,s,t,top){var u=this.__dd(t,top);
...
w[7]=s;
return w.join(g);
},getStyles:function(x,y,z,top){if(!x){return this.__dc;
}var A=this.__dd(z,top);
...
qx.Class.define(b,{extend:qx.core.Object,type:a,construct:function(){this.__ge={};
this.__gf=qx.lang.Function.bind(this.__gj,this);
this.__gg=false;
},members:{__gh:null,__gi:null,__ge:null,__gg:null,__gf:null,schedule:function(c){if(this.__gh==null){this.__gh=window.setTimeout(this.__gf,0);
}var d=c.toHashCode();
if(this.__gi&&this.__gi[d]){return;
}this.__ge[d]=c;
this.__gg=true;
},cancel:function(e){var f=e.toHashCode();
if(this.__gi&&this.__gi[f]){this.__gi[f]=null;
return;
}delete this.__ge[f];
if(qx.lang.Object.isEmpty(this.__ge)&&this.__gh!=null){window.clearTimeout(this.__gh);
this.__gh=null;
}},__gj:qx.event.GlobalError.observeMethod(function(){this.__gh=null;
while(this.__gg){this.__gi=qx.lang.Object.clone(this.__ge);
this.__ge={};
this.__gg=false;

for(var h in this.__gi){var g=this.__gi[h];

if(g){this.__gi[h]=null;
g.call();
}}}this.__gi=null;
})},destruct:function(){if(this.__gh!=null){window.clearTimeout(this.__gh);
}this.__gf=this.__ge=null;
}});
})();
...
this.__hT=b;
this.__hU=c||null;
this.__hV=qx.util.DeferredCallManager.getInstance();
},members:{__hT:null,__hU:null,__hV:null,cancel:function(){this.__hV.cancel(this);
},schedule:function(){this.__hV.schedule(this);
},call:function(){this.__hU?this.__hT.apply(this.__hU):this.__hT();
}},destruct:function(d,e){this.cancel();
this.__hU=this.__hT=this.__hV=null;
}});
})();
(function(){var m="element",k="qx.client",j="qxSelectable",h="off",g="on",f="text",d="div",c="",b="mshtml",a="none",F="scroll",E="qx.html.Element",D="|capture|",C="activate",B="blur",A="deactivate",z="capture",w="userSelect",v="-moz-none",u="visible",s="releaseCapture",t="|bubble|",q="__dA",r="tabIndex",o="focus",p="MozUserSelect",n="hidden";
qx.Class.define(E,{extend:qx.core.Object,construct:function(G,H,I){qx.core.Object.call(this);
this.__de=G||d;
this.__df=H||null;
this.__dg=I||null;
},statics:{DEBUG:false,_modified:{},_visibility:{},_scroll:{},_actions:[],__dh:{},_scheduleFlush:function(J){qx.html.Element.__dL.schedule();
},flush:function(){var U;
{};
var M=this.__di();
var L=M.getFocus();

if(L&&this.__dm(L)){M.blur(L);
}var bc=M.getActive();

if(bc&&this.__dm(bc)){qx.bom.Element.deactivate(bc);
}var P=this.__dk();

if(P&&this.__dm(P)){qx.bom.Element.releaseCapture(P);
}var V=[];
var W=this._modified;

for(var T in W){U=W[T];
if(U.__dE()){if(U.__dn&&qx.dom.Hierarchy.isRendered(U.__dn)){V.push(U);
}else{{};
U.__dD();
}delete W[T];
}}
...
if(!U.$$disposed){X.style.display=U.__dq?c:a;
if(qx.core.Variant.isSet(k,b)){if(!(document.documentMode>=8)){X.style.visibility=U.__dq?u:n;
}}}delete R[T];
...
if(U.__dt!=null){U.__dn.scrollLeft=U.__dt;
delete U.__dt;
}if(U.__du!=null){U.__dn.scrollTop=U.__du;
delete U.__du;
}var Y=U.__dr;
...
var X=bb.element.__dn;

if(!X||!N[bb.type]&&!bb.element.__dE()){continue;
}var Q=bb.args;
Q.unshift(X);
qx.bom.Element[bb.type].apply(qx.bom.Element,Q);
}this._actions=[];
for(var T in this.__dh){var K=this.__dh[T];
var bd=K.element.__dn;

if(bd){qx.bom.Selection.set(bd,K.start,K.end);
delete this.__dh[T];
}}qx.event.handler.Appear.refresh();
},__di:function(){if(!this.__dj){var be=qx.event.Registration.getManager(window);
this.__dj=be.getHandler(qx.event.handler.Focus);
}return this.__dj;
},__dk:function(){if(!this.__dl){var bf=qx.event.Registration.getManager(window);
this.__dl=bf.getDispatcher(qx.event.dispatch.MouseCapture);
}return this.__dl.getCaptureElement();
},__dm:function(bg){var bh=qx.core.ObjectRegistry.fromHashCode(bg.$$element);
return bh&&!bh.__dE();
}},members:{__de:null,__dn:null,__do:false,__dp:true,__dq:true,__dr:null,__ds:null,__dt:null,__du:null,__dv:null,__dw:null,__dx:null,__df:null,__dg:null,__dy:null,__dz:null,__dA:null,__dB:null,__dC:null,_scheduleChildrenUpdate:function(){if(this.__dB){return;
}this.__dB=true;
...
if(bj.__dq&&bj.__dp&&!bj.__dn){bj.__dD();
}}}
...
if(this.__dB){this._syncChildren();
}}delete this.__dB;
},_insertChildren:function(){var bk=this.__dA;
...
if(bm.__dn&&bm.__dp){bl.appendChild(bm.__dn);
}}this.__dn.appendChild(bl);
}else{var bl=this.__dn;
...
if(!bs||!bs.__dp||bs.__dC!==this){bq.removeChild(bv);
{};
}}for(var i=0;i<bu;i++){bo=bn[i];
if(bo.__dp){bs=bo.__dn;
bv=bt[bp];
...
},_copyData:function(bx){var bB=this.__dn;
var bA=this.__dg;
...
}},__dE:function(){var bL=this;
while(bL){if(bL.__do){return true;
}
if(!bL.__dp||!bL.__dq){return false;
}bL=bL.__dC;
}return false;
},__dF:function(bM){if(bM.__dC===this){throw new Error("Child is already in: "+bM);
}
if(bM.__do){throw new Error("Root elements could not be inserted into other ones.");
}if(bM.__dC){bM.__dC.remove(bM);
}bM.__dC=this;
if(!this.__dA){this.__dA=[];
}if(this.__dn){this._scheduleChildrenUpdate();
}},__dG:function(bN){if(bN.__dC!==this){throw new Error("Has no child: "+bN);
}if(this.__dn){this._scheduleChildrenUpdate();
}delete bN.__dC;
},__dH:function(bO){if(bO.__dC!==this){throw new Error("Has no child: "+bO);
}if(this.__dn){this._scheduleChildrenUpdate();
}},getChildren:function(){return this.__dA||null;
},getChild:function(bP){var bQ=this.__dA;
return bQ&&bQ[bP]||null;
},hasChildren:function(){var bR=this.__dA;
return bR&&bR[0]!==undefined;
},indexOf:function(bS){var bT=this.__dA;
return bT?bT.indexOf(bS):-1;
},hasChild:function(bU){var bV=this.__dA;
return bV&&bV.indexOf(bU)!==-1;
},add:function(bW){if(arguments[1]){for(var i=0,l=arguments.length;i<l;i++){this.__dF(arguments[i]);
}this.__dA.push.apply(this.__dA,arguments);
}else{this.__dF(bW);
this.__dA.push(bW);
}return this;
},addAt:function(bX,bY){this.__dF(bX);
qx.lang.Array.insertAt(this.__dA,bX,bY);
return this;
},remove:function(ca){var cb=this.__dA;
...
},removeAt:function(cd){var ce=this.__dA;
...
qx.lang.Array.removeAt(this.__dA,cd);
return this;
},removeAll:function(){var cg=this.__dA;

if(cg){for(var i=0,l=cg.length;i<l;i++){this.__dG(cg[i]);
}cg.length=0;
}return this;
},getParent:function(){return this.__dC||null;
},insertInto:function(parent,ch){parent.__dF(this);

if(ch==null){parent.__dA.push(this);
}else{qx.lang.Array.insertAt(this.__dA,this,ch);
}return this;
},insertBefore:function(ci){var parent=ci.__dC;
parent.__dF(this);
qx.lang.Array.insertBefore(parent.__dA,this,ci);
return this;
},insertAfter:function(cj){var parent=cj.__dC;
parent.__dF(this);
qx.lang.Array.insertAfter(parent.__dA,this,cj);
return this;
},moveTo:function(ck){var parent=this.__dC;
parent.__dH(this);
var cl=parent.__dA.indexOf(this);

if(cl===ck){throw new Error("Could not move to same index!");
}else if(cl<ck){ck--;
}qx.lang.Array.removeAt(parent.__dA,cl);
qx.lang.Array.insertAt(parent.__dA,this,ck);
return this;
},moveBefore:function(cm){var parent=this.__dC;
return this.moveTo(parent.__dA.indexOf(cm));
},moveAfter:function(cn){var parent=this.__dC;
return this.moveTo(parent.__dA.indexOf(cn)+1);
},free:function(){var parent=this.__dC;

if(!parent){throw new Error("Has no parent to remove from.");
}
if(!parent.__dA){return;
}parent.__dG(this);
qx.lang.Array.remove(parent.__dA,this);
return this;
...
},setRoot:function(co){this.__do=co;
},useMarkup:function(cp){if(this.__dn){throw new Error("Could not overwrite existing element!");
...
return this.__dn;
},useElement:function(cr){if(this.__dn){throw new Error("Could not overwrite existing element!");
}this.__dn=cr;
this.__dn.$$element=this.$$hash;
this._copyData(true);
...
if(ct>=0&&cs[this.__de]){return true;
}return false;
...
if(this.__dC){this.__dC._scheduleChildrenUpdate();
}return this;
...
},getScrollX:function(){var cJ=this.__dn;

if(cJ){return cJ.scrollLeft;
}return this.__dt||0;
},scrollToY:function(y,cK){var cL=this.__dn;
...
},getScrollY:function(){var cM=this.__dn;
...
this.scrollToX(0);
this.scrollToY(0);
this.addListener(F,this.__dJ,this);
},enableScrolling:function(){this.removeListener(F,this.__dJ,this);
},__dI:null,__dJ:function(e){if(!this.__dI){this.__dI=true;
this.__dn.scrollTop=0;
this.__dn.scrollLeft=0;
delete this.__dI;
}},getTextSelection:function(){var cN=this.__dn;

if(cN){return qx.bom.Selection.get(cN);
}return null;
},getTextSelectionLength:function(){var cO=this.__dn;

if(cO){return qx.bom.Selection.getLength(cO);
}return null;
},getTextSelectionStart:function(){var cP=this.__dn;

if(cP){return qx.bom.Selection.getStart(cP);
}return null;
},getTextSelectionEnd:function(){var cQ=this.__dn;

if(cQ){return qx.bom.Selection.getEnd(cQ);
}return null;
},setTextSelection:function(cR,cS){var cT=this.__dn;

if(cT){qx.bom.Selection.set(cT,cR,cS);
return;
}qx.html.Element.__dh[this.toHashCode()]={element:this,start:cR,end:cS};
qx.html.Element._scheduleFlush(m);
},clearTextSelection:function(){var cU=this.__dn;

if(cU){qx.bom.Selection.clear(cU);
}delete qx.html.Element.__dh[this.toHashCode()];
},__dK:function(cV,cW){var cX=qx.html.Element._actions;
cX.push({type:cV,element:this,args:cW||[]});
qx.html.Element._scheduleFlush(m);
},focus:function(){this.__dK(o);
},blur:function(){this.__dK(B);
},activate:function(){this.__dK(C);
},deactivate:function(){this.__dK(A);
},capture:function(cY){this.__dK(z,[cY!==false]);
},releaseCapture:function(){this.__dK(s);
},setStyle:function(da,dc,dd){if(!this.__df){this.__df={};
}
if(this.__df[da]==dc){return;
}
if(dc==null){delete this.__df[da];
}else{this.__df[da]=dc;
}if(this.__dn){if(dd){qx.bom.element.Style.set(this.__dn,da,dc);
return this;
...
if(this.__df[di]==dh){continue;
}
if(dh==null){delete this.__df[di];
}else{this.__df[di]=dh;
}if(df){dg.set(this.__dn,di,dh);
continue;
}this.__dv[di]=true;
}qx.html.Element._modified[this.$$hash]=this;
qx.html.Element._scheduleFlush(m);
...
},getStyle:function(dl){return this.__df?this.__df[dl]:null;
},getAllStyles:function(){return this.__df||null;
},setAttribute:function(dm,dn,dp){if(!this.__dg){this.__dg={};
}
if(this.__dg[dm]==dn){return;
}
if(dn==null){delete this.__dg[dm];
}else{this.__dg[dm]=dn;
}if(this.__dn){if(dp){qx.bom.element.Attribute.set(this.__dn,dm,dn);
return this;
...
},getAttribute:function(dv){return this.__dg?this.__dg[dv]:null;
},_applyProperty:function(name,dw){},_setProperty:function(dx,dy,dz){if(!this.__dy){this.__dy={};
}
if(this.__dy[dx]==dy){return;
}
if(dy==null){delete this.__dy[dx];
}else{this.__dy[dx]=dy;
}if(this.__dn){if(dz){this._applyProperty(dx,dy);
return this;
...
},_getProperty:function(dC){var dD=this.__dy;
...
if(this.__dn){return qx.event.Registration.addListener(this.__dn,dF,dG,self,dH);
}
...
var dK=dF+(dH?D:t)+dJ;
this.__dz[dK]={type:dF,listener:dG,self:self,capture:dH,unique:dJ};
return dK;
...
if(this.__dn){qx.event.Registration.removeListener(this.__dn,dL,dM,self,dN);
}else{var dQ=this.__dz;
var dP;
...
if(this.__dn){qx.event.Registration.removeListenerById(this.__dn,dS);
}else{delete this.__dz[dS];
}return this;
},hasListener:function(dT,dU){if(this.$$disposed){return false;
}
if(this.__dn){return qx.event.Registration.hasListener(this.__dn,dT,dU);
}var dW=this.__dz;
var dV;
...
}},defer:function(dY){dY.__dL=new qx.util.DeferredCall(dY.flush,dY);
},destruct:function(){var ea=this.__dn;

if(ea){qx.event.Registration.getManager(ea).removeAllListeners(ea);
ea.$$element=c;
}
if(!qx.core.ObjectRegistry.inShutDown){var parent=this.__dC;

if(parent&&!parent.$$disposed){parent.remove(this);
}}this._disposeArray(q);
this.__dg=this.__df=this.__dz=this.__dy=this.__dw=this.__dv=this.__dx=this.__dn=this.__dC=this.__dr=this.__ds=null;
}});
})();
...
this.__dM={};
this.__dN={};
},properties:{theme:{check:d,nullable:true,event:c,apply:g}},members:{__dO:{},__dM:null,__dN:null,_applyTheme:function(i,j){this.__dN={};
this.__dM={};
},__dP:function(k,l,m){var q=l.appearances;
var t=q[k];
...
return this.__dP(p,l,m);
}}}if(m!=null){return this.__dP(m,l);
}return null;
}else if(typeof t===h){return this.__dP(t,l,m);
}else if(t.include&&!t.style){return this.__dP(t.include,l,m);
}return k;
},styleFrom:function(v,w,x,y){if(!x){x=this.getTheme();
}var E=this.__dN;
var z=E[v];

if(!z){z=E[v]=this.__dP(v,x,y);
...
qx.Class.define(a,{extend:qx.html.Element,members:{__dQ:null,_applyProperty:function(name,c){qx.html.Element.prototype._applyProperty.call(this,name,c);

if(name==b){var d=this.getDomElement();
qx.bom.Label.setValue(d,c);
}},_createDomElement:function(){var f=this.__dQ;
...
if(E!=null&&E!==this.__fy){this.__fy=E;
...
G.width=B;
G.height=C;
}if(this.__fA){F.local=true;
delete this.__fA;
}
if(this.__fC){F.margin=true;
delete this.__fC;
}return F;
},isExcluded:function(){return false;
},hasValidLayout:function(){return !this.__fA;
},scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);
},invalidateLayoutCache:function(){this.__fA=true;
this.__fB=null;
},getSizeHint:function(H){var I=this.__fB;

if(I){return I;
}
if(H===false){return null;
}I=this.__fB=this._computeSizeHint();
if(this._hasHeightForWidth()&&this.__fy&&this.getHeight()==null){I.height=this.__fy;
...
},_applyMargin:function(){this.__fC=true;
...
},setUserBounds:function(S,top,T,U){this.__fD={left:S,top:top,width:T,height:U};
qx.ui.core.queue.Layout.add(this);
},resetUserBounds:function(){delete this.__fD;
qx.ui.core.queue.Layout.add(this);
},__fF:{},setLayoutProperties:function(V){if(V==null){return;
}var W=this.__fE;
...
if(bd){bc.__fE=qx.lang.Object.clone(bd);
}return bc;
}},destruct:function(){this.$$parent=this.$$subparent=this.__fE=this.__fz=this.__fD=this.__fB=null;
}});
})();
...
(function(){var bV="px",bU="Boolean",bT="qx.event.type.Drag",bS="qx.event.type.Mouse",bR="visible",bQ="qx.event.type.Focus",bP="on",bO="Integer",bN="qx.event.type.Touch",bM="excluded",bx="qx.event.type.Data",bw="_applyPadding",bv="qx.event.type.Event",bu="hidden",bt="contextmenu",bs="String",br="tabIndex",bq="focused",bp="changeVisibility",bo="mshtml",cd="hovered",ce="qx.event.type.KeySequence",cb="qx.client",cc="absolute",bY="backgroundColor",ca="drag",bW="div",bX="disabled",cf="move",cg="dragstart",bF="qx.dynlocale",bE="dragchange",bH="dragend",bG="resize",bJ="Decorator",bI="zIndex",bL="opacity",bK="default",bD="Color",bC="changeToolTipText",c="beforeContextmenuOpen",d="_applyNativeContextMenu",f="__ef",g="_applyBackgroundColor",h="_applyFocusable",j="changeShadow",k="qx.event.type.KeyInput",m="__dX",n="createChildControl",o="__eb",ck="Font",cj="_applyShadow",ci="_applyEnabled",ch="_applySelectable",co="Number",cn="_applyKeepActive",cm="_applyVisibility",cl="repeat",cq="qxDraggable",cp="__dR",N="syncAppearance",O="paddingLeft",L="_applyDroppable",M="#",R="qx.event.type.MouseWheel",S="_applyCursor",P="_applyDraggable",Q="changeTextColor",J="$$widget",K="changeContextMenu",w="__dS",v="paddingTop",y="changeSelectable",x="hideFocus",s="none",r="outline",u="_applyAppearance",t="_applyOpacity",q="url(",p=")",X="qx.ui.core.Widget",Y="_applyFont",ba="cursor",bb="qxDroppable",T="changeZIndex",U="changeEnabled",V="changeFont",W="_applyDecorator",bc="_applyZIndex",bd="_applyTextColor",G="qx.ui.menu.Menu",F="_applyToolTipText",E="__ed",D="true",C="widget",B="changeDecorator",A="__dV",z="_applyTabIndex",I="changeAppearance",H="shorthand",be="/",bf="",bg="_applyContextMenu",bh="paddingBottom",bi="__dW",bj="changeNativeContextMenu",bk="qx.ui.tooltip.ToolTip",bl="qxKeepActive",bm="_applyKeepFocus",bn="paddingRight",bB="changeBackgroundColor",bA="changeLocale",bz="qxKeepFocus",by="qx/static/blank.gif";
...
},events:{appear:bv,disappear:bv,createChildControl:bx,resize:bx,move:bx,syncAppearance:bx,mousemove:bS,mouseover:bS,mouseout:bS,mousedown:bS,mouseup:bS,click:bS,dblclick:bS,contextmenu:bS,beforeContextmenuOpen:bx,mousewheel:R,touchstart:bN,touchend:bN,touchmove:bN,touchcancel:bN,tap:bN,swipe:bN,keyup:ce,keydown:ce,keypress:ce,keyinput:k,focus:bQ,blur:bQ,focusin:bQ,focusout:bQ,activate:bQ,deactivate:bQ,capture:bv,losecapture:bv,drop:bT,dragleave:bT,dragover:bT,drag:bT,dragstart:bT,dragend:bT,dragchange:bT,droprequest:bT},properties:{paddingTop:{check:bO,init:0,apply:bw,themeable:true},paddingRight:{check:bO,init:0,apply:bw,themeable:true},paddingBottom:{check:bO,init:0,apply:bw,themeable:true},paddingLeft:{check:bO,init:0,apply:bw,themeable:true},padding:{group:[v,bn,bh,O],mode:H,themeable:true},zIndex:{nullable:true,init:null,apply:bc,event:T,check:bO,themeable:true},decorator:{nullable:true,init:null,apply:W,event:B,check:bJ,themeable:true},shadow:{nullable:true,init:null,apply:cj,event:j,check:bJ,themeable:true},backgroundColor:{nullable:true,check:bD,apply:g,event:bB,themeable:true},textColor:{nullable:true,check:bD,apply:bd,event:Q,themeable:true,inheritable:true},font:{nullable:true,apply:Y,check:ck,event:V,themeable:true,inheritable:true,dereference:true},opacity:{check:co,apply:t,themeable:true,nullable:true,init:null},cursor:{check:bs,apply:S,themeable:true,inheritable:true,nullable:true,init:null},toolTip:{check:bk,nullable:true},toolTipText:{check:bs,nullable:true,event:bC,apply:F},toolTipIcon:{check:bs,nullable:true,event:bC},blockToolTip:{check:bU,init:false},visibility:{check:[bR,bu,bM],init:bR,apply:cm,event:bp},enabled:{init:true,check:bU,inheritable:true,apply:ci,event:U},anonymous:{init:false,check:bU},tabIndex:{check:bO,nullable:true,apply:z},focusable:{check:bU,init:false,apply:h},keepFocus:{check:bU,init:false,apply:bm},keepActive:{check:bU,init:false,apply:cn},draggable:{check:bU,init:false,apply:P},droppable:{check:bU,init:false,apply:L},selectable:{check:bU,init:false,event:y,apply:ch},contextMenu:{check:G,apply:bg,nullable:true,event:K},nativeContextMenu:{check:bU,init:false,themeable:true,event:bj,apply:d},appearance:{check:bs,init:C,apply:u,event:I}},statics:{DEBUG:false,getWidgetByElement:function(cr,cs){while(cr){var ct=cr.$$widget;
...
if(cM.size){var cL=this.__dX;

if(cL){cL.setStyles({width:cC+bV,height:cD+bV});
}}
if(cM.size||this._updateInsets){if(this.__dV){this.__dV.resize(cC,cD);
}}
if(cM.size){if(this.__dW){var cE=this.__dW.getInsets();
var cI=cC+cE.left+cE.right;
var cG=cD+cE.top+cE.bottom;
this.__dW.resize(cI,cG);
}}
if(cJ||cM.local||cM.margin){if(this.__eb&&this.hasLayoutChildren()){this.__eb.renderLayout(innerWidth,innerHeight);
...
return cM;
},__ed:null,clearSeparators:function(){var cP=this.__ed;

if(!cP){return;
}var cQ=qx.ui.core.Widget.__dT;
var content=this.getContentElement();
var cO;
...
},renderSeparator:function(cR,cS){var cT=qx.ui.core.Widget.__dT.getDecoratorElement(cR);
this.getContentElement().add(cT);
cT.resize(cS.width,cS.height);
cT.setStyles({left:cS.left+bV,top:cS.top+bV});
if(!this.__ed){this.__ed=[cT];
}else{this.__ed.push(cT);
...
}},_getContentHint:function(){var dg=this.__eb;
...
if(this.__dV){var ds=this.__dV.getInsets();
{};
top+=ds.top;
dt+=ds.right;
dv+=ds.bottom;
...
},__ee:function(){var dC=this._createContentElement();
{};
...
},__ef:null,getLayoutChildren:function(){var dE=this.__ef;

if(!dE){return this.__eg;
}var dF;
...
},invalidateLayoutChildren:function(){var dG=this.__eb;

if(dG){dG.invalidateChildrenCache();
}qx.ui.core.queue.Layout.add(this);
},hasLayoutChildren:function(){var dH=this.__ef;
...
},_indexOf:function(dJ){var dK=this.__ef;

if(!dK){return -1;
}return dK.indexOf(dJ);
},_hasChildren:function(){var dL=this.__ef;
return dL!=null&&(!!dL[0]);
},addChildrenToQueue:function(dM){var dN=this.__ef;
...
}},_add:function(dP,dQ){if(dP.getLayoutParent()==this){qx.lang.Array.remove(this.__ef,dP);
}
if(this.__ef){this.__ef.push(dP);
}else{this.__ef=[dP];
}this.__eh(dP,dQ);
},_addAt:function(dR,dS,dT){if(!this.__ef){this.__ef=[];
}if(dR.getLayoutParent()==this){qx.lang.Array.remove(this.__ef,dR);
}var dU=this.__ef[dS];

if(dU===dR){dR.setLayoutProperties(dT);
}
if(dU){qx.lang.Array.insertBefore(this.__ef,dR,dU);
}else{this.__ef.push(dR);
}this.__eh(dR,dT);
...
}if(dV.getLayoutParent()==this){qx.lang.Array.remove(this.__ef,dV);
}qx.lang.Array.insertBefore(this.__ef,dV,dW);
this.__eh(dV,dX);
...
if(!this.__ef){this.__ef=[];
}if(dY.getLayoutParent()==this){qx.lang.Array.remove(this.__ef,dY);
}qx.lang.Array.insertAfter(this.__ef,dY,ea);
this.__eh(dY,eb);
},_remove:function(ec){if(!this.__ef){throw new Error("This widget has no children!");
}qx.lang.Array.remove(this.__ef,ec);
this.__ei(ec);
},_removeAt:function(ed){if(!this.__ef){throw new Error("This widget has no children!");
}var ee=this.__ef[ed];
qx.lang.Array.removeAt(this.__ef,ed);
this.__ei(ee);
return ee;
},_removeAll:function(){if(!this.__ef){return;
}var ef=this.__ef.concat();
this.__ef.length=0;

for(var i=ef.length-1;i>=0;i--){this.__ei(ef[i]);
}qx.ui.core.queue.Layout.add(this);
},_afterAddChild:null,_afterRemoveChild:null,__eh:function(eg,eh){{};
...
}var en=this.__dX=new qx.html.Element;
{};
en.setStyles({position:cc,top:0,left:0,zIndex:7});
var eo=this.getBounds();

if(eo){this.__dX.setStyles({width:eo.width+bV,height:eo.height+bV});
...
var et=qx.ui.core.Widget.__dT;
var er=this.getContainerElement();
if(!this.__dX&&!qx.bom.client.Feature.CSS_POINTER_EVENTS){this._createProtectorElement();
}if(eq){er.remove(this.__dV);
et.poolDecorator(this.__dV);
}if(ep){var es=this.__dV=et.getDecoratorElement(ep);
es.setStyle(bI,5);
er.add(es);
}else{delete this.__dV;
}this._applyBackgroundColor(this.getBackgroundColor());
if(this.__ec(eq,ep)){this._updateInsets=true;
qx.ui.core.queue.Layout.add(this);
}else if(ep){var eu=this.getBounds();

if(eu){es.resize(eu.width,eu.height);
this.__dX&&
this.__dX.setStyles({width:eu.width+bV,height:eu.height+bV});
}}},_applyShadow:function(ev,ew){var eD=qx.ui.core.Widget.__dU;
var ey=this.getContainerElement();
if(ew){ey.remove(this.__dW);
eD.poolDecorator(this.__dW);
}if(ev){var eA=this.__dW=eD.getDecoratorElement(ev);
ey.add(eA);
var eC=eA.getInsets();
...
}},_applyToolTipText:function(eE,eF){if(qx.core.Variant.isSet(bF,bP)){if(this.__ea){return;
}var eG=qx.locale.Manager.getInstance();
this.__ea=eG.addListener(bA,function(){if(eE&&eE.translate){this.setToolTipText(eE.translate());
}},this);
...
}this.getContainerElement().setStyle(ba,eR,qx.bom.client.Engine.OPERA);
},_applyBackgroundColor:function(eT,eU){var eV=this.getBackgroundColor();
var eX=this.getContainerElement();

if(this.__dV){this.__dV.tint(eV);
eX.setStyle(bY,null);
}else{var eW=qx.theme.manager.Color.getInstance().resolve(eV);
eX.setStyle(bY,eW);
}},_applyFont:function(eY,fa){},__ej:null,$$stateChanges:null,_forwardStates:null,hasState:function(fb){var fc=this.__ej;
return !!fc&&!!fc[fb];
},addState:function(fd){var fe=this.__ej;
...
}}}},removeState:function(fi){var fj=this.__ej;
...
}}}},replaceState:function(fn,fo){var fp=this.__ej;
...
}}}},__ek:null,__el:null,syncAppearance:function(){var fx=this.__ej;
var fw=this.__ek;
...
fw=this.__ek=fB.reverse().join(be).replace(/#[0-9]+/g,bf);
...
}}this.fireDataEvent(N,this.__ej);
...
if(qx.core.Variant.isSet(cb,bo)){fM.setAttribute(x,D);
}else{fM.setStyle(r,s);
...
}this.getContainerElement().setAttribute(cq,gc?bP:null);
},_applyDroppable:function(ge,gf){if(!this.isEnabled()&&ge===true){ge=false;
}this.getContainerElement().setAttribute(bb,ge?bP:null);
...
},hasChildControl:function(gs){if(!this.__em){return false;
}return !!this.__em[gs];
},__em:null,_getCreatedChildControls:function(){return this.__em;
},getChildControl:function(gt,gu){if(!this.__em){if(gu){return null;
}this.__em={};
}var gv=this.__em[gt];
...
},_createChildControl:function(gC){if(!this.__em){this.__em={};
}else if(this.__em[gC]){throw new Error("Child control '"+gC+"' already created!");
}var gG=gC.indexOf(M);
...
}}}this.fireDataEvent(n,gD);
return this.__em[gC]=gD;
},_createChildControlImpl:function(gH){return null;
},_disposeChildControls:function(){var gL=this.__em;
...
}},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Variant.isSet(bF,bP)){if(this.__ea){qx.locale.Manager.getInstance().removeListenerById(this.__ea);
...
if(this.__dW){ha.remove(this.__dW);
hb.__dU.poolDecorator(this.__dW);
}this.clearSeparators();
this.__dV=this.__dW=this.__ed=null;
}else{this._disposeArray(E);
this._disposeObjects(A,bi);
}this._disposeArray(f);
this.__ej=this.__em=null;
this._disposeObjects(o,cp,w,m);
}});
})();
...
this.__en=qx.event.Registration.getManager(window);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1,keyup:1,keydown:1,keypress:1,keyinput:1,capture:1,losecapture:1,focusin:1,focusout:1,focus:1,blur:1,activate:1,deactivate:1,appear:1,disappear:1,dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1,touchstart:1,touchend:1,touchmove:1,touchcancel:1,tap:1,swipe:1},IGNORE_CAN_HANDLE:false},members:{__en:null,__eo:{focusin:1,focusout:1,focus:1,blur:1},__ep:{mouseover:1,mouseout:1,appear:1,disappear:1},canHandleEvent:function(g,h){return g instanceof qx.ui.core.Widget;
...
}if(this.__eo[j.getType()]){o=o&&o.getFocusTarget();
if(!o){return;
...
if(w){if(this.__eo[j.getType()]){w=w.getFocusTarget();
}if(w===o){return;
}}}var s=j.getCurrentTarget();
var u=qx.ui.core.Widget.getWidgetByElement(s);

if(!u||u.isAnonymous()){return;
}if(this.__eo[j.getType()]){u=u.getFocusTarget();
}var v=j.getType();

if(!u||!(u.isEnabled()||this.__ep[v])){return;
}var k=j.getEventPhase()==qx.event.type.Event.CAPTURING_PHASE;
var r=this.__en.getListeners(u,v,k);
...
},members:{$$isString:true,length:0,__lU:null,toString:function(){return this.__lU;
...
this.__eq=c;
this.__er=d;
},members:{__eq:null,__er:null,translate:function(){return qx.locale.Manager.getInstance().translate(this.__eq,this.__er);
}}});
})();
...
qx.Mixin.define(b,{members:{__ey:function(m,n,o,p){var q=this.getChildrenContainer();

if(q===this){m=h+m;
}return (q[m])(n,o,p);
},getChildren:function(){return this.__ey(c);
},hasChildren:function(){return this.__ey(f);
},add:function(r,s){return this.__ey(j,r,s);
},remove:function(t){return this.__ey(a,t);
},removeAll:function(){return this.__ey(d);
},indexOf:function(u){return this.__ey(l,u);
},addAt:function(v,w,x){this.__ey(g,v,w,x);
},addBefore:function(y,z,A){this.__ey(i,y,z,A);
},addAfter:function(B,C,D){this.__ey(k,B,C,D);
},removeAt:function(E){this.__ey(e,E);
}}});
})();
...
this.__ez=function(){self._oninterval.call(self);
};
...
m.start();
return m;
}},properties:{enabled:{init:true,check:c,apply:d},interval:{check:a,init:1000,apply:f}},members:{__eB:null,__ez:null,_applyInterval:function(n,o){if(this.getEnabled()){this.restart();
}},_applyEnabled:function(p,q){if(q){window.clearInterval(this.__eB);
this.__eB=null;
}else if(p){this.__eB=window.setInterval(this.__ez,this.getInterval());
...
(function(){var r="qx.mobile",q="touchend",p="touchmove",o="touchstart",n="mousemove",m="touchcancel",l="mouseup",k="mousedown",j="qx.client",i="mshtml",c="qx.event.handler.Touch",h="useraction",g="swipe",b="tap",a="gecko|webkit",f="x",d="y";
qx.Class.define(c,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(s){qx.core.Object.call(this);
this.__hc=s;
this.__hd=s.getWindow();
this.__he=this.__hd.document;
this._initTouchObserver();
this._initMouseObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{touchstart:1,touchmove:1,touchend:1,touchcancel:1,tap:1,swipe:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE+qx.event.IEventHandler.TARGET_DOCUMENT,IGNORE_CAN_HANDLE:true,MOUSE_TO_TOUCH_MAPPING:{"mousedown":"touchstart","mousemove":"touchmove","mouseup":"touchend"},SWIPE_DIRECTION:{x:["left","right"],y:["up","down"]},SWIPE_MIN_DISTANCE:1,SWIPE_MIN_VELOCITY:0},members:{__hf:null,__hg:null,__hc:null,__hd:null,__he:null,__hh:null,__hi:null,__hj:null,__hk:null,__hl:false,canHandleEvent:function(t,u){},registerEvent:function(v,w,x){},unregisterEvent:function(y,z,A){},__hm:function(B){var C=qx.bom.Event.getTarget(B);
if(qx.core.Variant.isSet(j,a)){if(C&&C.nodeType==3){C=C.parentNode;
}}return C;
},__hn:function(D,E,F,G){if(!F){F=this.__hm(D);
}var E=E||D.type;

if(F&&F.nodeType){qx.event.Registration.fireEvent(F,E,G||qx.event.type.Touch,[D,F,null,true,true]);
}qx.event.Registration.fireEvent(this.__hd,h,qx.event.type.Data,[E]);
},__ho:function(H,I,J){if(!J){J=this.__hm(H);
}var I=I||H.type;

if(I==o){this.__hp(H,J);
}else if(I==p){this.__hq(H,J);
}else if(I==q){this.__hr(H,J);
}},__hp:function(K,L){var M=K.changedTouches[0];
this.__hh=M.pageX;
this.__hi=M.pageY;
this.__hj=new Date().getTime();
this.__hk=K.changedTouches.length===1;
},__hq:function(N,O){if(this.__hk&&N.changedTouches.length>1){this.__hk=false;
}},__hr:function(P,Q){if(this.__hk){var R=P.changedTouches[0];
var T={x:R.pageX-this.__hh,y:R.pageY-this.__hi};

if(T.x===0&&T.y===0){this.__hn(P,b,Q,qx.event.type.Tap);
}else{var S=this.__hs(P,Q,T);

if(S){P.swipe=S;
this.__hn(P,g,Q,qx.event.type.Swipe);
}}}},__hs:function(U,V,W){var bb=qx.event.handler.Touch;
var bc=new Date().getTime()-this.__hj;
var be=(Math.abs(W.x)>=Math.abs(W.y))?f:d;
var X=W[be];
var Y=bb.SWIPE_DIRECTION[be][X<0?0:1];
var bd=(bc!==0)?X/bc:0;
var ba=null;

if(Math.abs(bd)>=bb.SWIPE_MIN_VELOCITY&&Math.abs(X)>=bb.SWIPE_MIN_DISTANCE){ba={startTime:this.__hj,duration:bc,axis:be,direction:Y,distance:X,velocity:bd};
}return ba;
},__ht:qx.core.Variant.select(r,{"on":function(bf){var bg=bf.type;
var bi=qx.event.handler.Touch.MOUSE_TO_TOUCH_MAPPING;

if(bi[bg]){bg=bi[bg];
if(bg==o&&this.__hu(bf)){this.__hl=true;
}else if(bg==q){this.__hl=false;
}var bj=this.__hv(bf);
var bh=(bg==q?[]:[bj]);
bf.touches=bh;
bf.targetTouches=bh;
bf.changedTouches=[bj];
}return bg;
},"default":qx.lang.Function.empty}),__hu:qx.core.Variant.select(r,{"on":function(bk){if(qx.core.Variant.isSet(j,i)){var bl=1;
}else{var bl=0;
}return bk.button==bl;
},"default":qx.lang.Function.empty}),__hv:qx.core.Variant.select(r,{"on":function(bm){var bn=this.__hm(bm);
return {clientX:bm.clientX,clientY:bm.clientY,screenX:bm.screenX,screenY:bm.screenY,pageX:bm.pageX,pageY:bm.pageY,identifier:1,target:bn};
...
Event.addNativeListener(this.__he,p,this.__hf);
Event.addNativeListener(this.__he,q,this.__hf);
Event.addNativeListener(this.__he,m,this.__hf);
},_initMouseObserver:qx.core.Variant.select(r,{"on":function(){if(!qx.bom.client.Feature.TOUCH){this.__hg=qx.lang.Function.listener(this._onMouseEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__he,k,this.__hg);
Event.addNativeListener(this.__he,n,this.__hg);
Event.addNativeListener(this.__he,l,this.__hg);
}},"default":qx.lang.Function.empty}),_stopTouchObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__he,o,this.__hf);
Event.removeNativeListener(this.__he,p,this.__hf);
Event.removeNativeListener(this.__he,q,this.__hf);
Event.removeNativeListener(this.__he,m,this.__hf);
},_stopMouseObserver:qx.core.Variant.select(r,{"on":function(){if(!qx.bom.client.Feature.TOUCH){var Event=qx.bom.Event;
Event.removeNativeListener(this.__he,k,this.__hg);
Event.removeNativeListener(this.__he,n,this.__hg);
Event.removeNativeListener(this.__he,l,this.__hg);
}},"default":qx.lang.Function.empty}),_onTouchEvent:qx.event.GlobalError.observeMethod(function(bo){this._commonTouchEventHandler(bo);
}),_onMouseEvent:qx.core.Variant.select(r,{"on":qx.event.GlobalError.observeMethod(function(bp){if(!qx.bom.client.Feature.TOUCH){if(bp.type==n&&!this.__hl){return;
}var bq=this.__ht(bp);
this._commonTouchEventHandler(bp,bq);
}}),"default":qx.lang.Function.empty}),_commonTouchEventHandler:function(br,bs){this.__hn(br,bs);
this.__ho(br,bs);
}},destruct:function(){this._stopTouchObserver();
this._stopMouseObserver();
this.__hc=this.__hd=this.__he=null;
},defer:function(bt){qx.event.Registration.addHandler(bt);
if(qx.bom.client.Feature.TOUCH){document.addEventListener(p,function(e){e.preventDefault();
});
...
qx.Bootstrap.define(w,{statics:{NAME:"",SP1:false,SP2:false,WIN95:false,WIN98:false,WINME:false,WINNT4:false,WIN2000:false,WINXP:false,WIN2003:false,WINVISTA:false,WIN7:false,WINCE:false,LINUX:false,SUNOS:false,FREEBSD:false,NETBSD:false,OPENBSD:false,OSX:false,OS9:false,SYMBIAN:false,NINTENDODS:false,PSP:false,IPHONE:false,IPAD:false,UNKNOWN_SYSTEM:false,__lo:{"Windows NT 6.1":u,"Windows NT 6.0":n,"Windows NT 5.2":s,"Windows NT 5.1":H,"Windows NT 5.0":e,"Windows 2000":e,"Windows NT 4.0":B,"Win 9x 4.90":z,"Windows CE":A,"Windows 98":j,"Win98":j,"Windows 95":f,"Win95":f,"Linux":p,"FreeBSD":G,"NetBSD":m,"OpenBSD":k,"SunOS":F,"Symbian System":v,"Nitro":C,"PSP":"sonypsp","Mac OS X 10_5":c,"Mac OS X 10.5":c,"Mac OS X 10_4":g,"Mac OS X 10.4":g,"Mac OS X 10_3":b,"Mac OS X 10.3":b,"Mac OS X 10_2":i,"Mac OS X 10.2":i,"Mac OS X 10_1":d,"Mac OS X 10.1":d,"Mac OS X 10_0":h,"Mac OS X 10.0":h,"Mac OS X":o,"Mac OS 9":q},__lp:function(){var L=navigator.userAgent;
var K=[];

for(var J in this.__lo){K.push(J);
...
this.NAME="iphone";
}}else{this.NAME=this.__lo[RegExp.$1];
...
}}}}},defer:function(N){N.__lp();
}});
})();
(function(){var a="qx.event.handler.UserAction";
qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(b){qx.core.Object.call(this);
this.__kv=b;
this.__kw=b.getWindow();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{useraction:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__kv:null,__kw:null,canHandleEvent:function(c,d){},registerEvent:function(e,f,g){},unregisterEvent:function(h,i,j){}},destruct:function(){this.__kv=this.__kw=null;
...
this.__eC=q;
this.__eD=q.getWindow();
this.__eE=this.__eD.document;
this._initButtonObserver();
this._initMoveObserver();
this._initWheelObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{mousemove:1,mouseover:1,mouseout:1,mousedown:1,mouseup:1,click:1,dblclick:1,contextmenu:1,mousewheel:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:true},members:{__eF:null,__eG:null,__eH:null,__eI:null,__eJ:null,__eC:null,__eD:null,__eE:null,canHandleEvent:function(r,s){},registerEvent:qx.bom.client.System.IPHONE?
function(t,u,v){t[c+u]=qx.lang.Function.returnNull;
}:qx.lang.Function.returnNull,unregisterEvent:qx.bom.client.System.IPHONE?
function(w,x,y){w[c+x]=undefined;
}:qx.lang.Function.returnNull,__eK:function(z,A,B){if(!B){B=qx.bom.Event.getTarget(z);
...
}qx.event.Registration.fireEvent(this.__eD,e,qx.event.type.Data,[A||z.type]);
},__eL:function(){var D=[this.__eD,this.__eE,this.__eE.body];
var E=this.__eD;
var C=d;
...
},_initButtonObserver:function(){this.__eF=qx.lang.Function.listener(this._onButtonEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__eE,m,this.__eF);
Event.addNativeListener(this.__eE,p,this.__eF);
Event.addNativeListener(this.__eE,o,this.__eF);
Event.addNativeListener(this.__eE,j,this.__eF);
Event.addNativeListener(this.__eE,l,this.__eF);
},_initMoveObserver:function(){this.__eG=qx.lang.Function.listener(this._onMoveEvent,this);
var Event=qx.bom.Event;
Event.addNativeListener(this.__eE,f,this.__eG);
Event.addNativeListener(this.__eE,h,this.__eG);
Event.addNativeListener(this.__eE,g,this.__eG);
},_initWheelObserver:function(){this.__eH=qx.lang.Function.listener(this._onWheelEvent,this);
var F=this.__eL();
qx.bom.Event.addNativeListener(F.target,F.type,this.__eH);
},_stopButtonObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__eE,m,this.__eF);
Event.removeNativeListener(this.__eE,p,this.__eF);
Event.removeNativeListener(this.__eE,o,this.__eF);
Event.removeNativeListener(this.__eE,j,this.__eF);
Event.removeNativeListener(this.__eE,l,this.__eF);
},_stopMoveObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__eE,f,this.__eG);
Event.removeNativeListener(this.__eE,h,this.__eG);
Event.removeNativeListener(this.__eE,g,this.__eG);
},_stopWheelObserver:function(){var G=this.__eL();
qx.bom.Event.removeNativeListener(G.target,G.type,this.__eH);
},_onMoveEvent:qx.event.GlobalError.observeMethod(function(H){this.__eK(H);
...
}),_onWheelEvent:qx.event.GlobalError.observeMethod(function(L){this.__eK(L,k);
}),__eM:qx.core.Variant.select(n,{"webkit":function(M,N,O){if(qx.bom.client.Engine.VERSION<530){if(N==l){this.__eK(M,p,O);
}}},"default":null}),__eN:qx.core.Variant.select(n,{"opera":function(P,Q,R){if(Q==p&&P.button==2){this.__eK(P,l,R);
}},"default":null}),__eO:qx.core.Variant.select(n,{"mshtml":function(S,T,U){if(S.target!==undefined){return;
}
if(T==p&&this.__eI==o){this.__eK(S,m,U);
}else if(T==j){this.__eK(S,o,U);
}},"default":null}),__eP:qx.core.Variant.select(n,{"mshtml":null,"default":function(V,W,X){switch(W){case m:this.__eJ=X;
break;
case p:if(X!==this.__eJ){var Y=qx.dom.Hierarchy.getCommonParent(X,this.__eJ);
this.__eK(V,o,Y);
}}}})},destruct:function(){this._stopButtonObserver();
this._stopMoveObserver();
this._stopWheelObserver();
this.__eC=this.__eD=this.__eE=this.__eJ=null;
...
if(q){this.setSeparator(q);
}},properties:{alignY:{check:[m,j,e],init:m,apply:n},alignX:{check:[k,g,a],init:k,apply:n},spacing:{check:c,init:0,apply:n},separator:{check:h,nullable:true,apply:n},reversed:{check:b,init:false,apply:f}},members:{__eR:null,__eS:null,__eT:null,__eU:null,_applyReversed:function(){this._invalidChildrenCache=true;
this._applyLayoutChange();
},__eV:function(){var w=this._getLayoutChildren();
var length=w.length;
var s=false;
var r=this.__eR&&this.__eR.length!=length&&this.__eS&&this.__eR;
var u;
var t=r?this.__eR:new Array(length);
var v=r?this.__eS:new Array(length);
if(this.getReversed()){w=w.concat().reverse();
}for(var i=0;i<length;i++){u=w[i].getLayoutProperties();
...
this.__eU=w;
delete this._invalidChildrenCache;
},verifyLayoutProperty:null,renderLayout:function(x,y){if(this._invalidChildrenCache){this.__eV();
}var F=this.__eU;
var length=F.length;
...
for(i=0;i<length;i+=1){J=this.__eR[i];
B=J!=null?Math.floor((y-C)*J):F[i].getSizeHint().height;
K.push(B);
Q+=B;
}if(this.__eT&&Q!=y){var H={};
var N,R;

for(i=0;i<length;i+=1){N=this.__eS[i];
...
top+=B;
I=A.getMarginBottom();
}},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__eV();
}var bc=qx.ui.layout.Util;
var bk=this.__eU;
var X=0,bb=0,ba=0;
var V=0,bd=0;
...
}},destruct:function(){this.__eR=this.__eS=this.__eU=null;
}});
})();
...
qx.Class.define(a,{statics:{__eW:{},add:function(c){var d=this.__eW;

if(d[c.$$hash]){return;
}d[c.$$hash]=c;
qx.ui.core.queue.Manager.scheduleFlush(b);
},flush:function(){var e=this.__eW;
...
(function(){var j="nonScaled",i="scaled",h="alphaScaled",g=".png",f="qx.client",e="div",d="replacement",c="qx.event.type.Event",b="hidden",a="Boolean",y="__fO",x="px",w="scale",v="changeSource",u="qx.ui.basic.Image",t="loaded",s="-disabled.$1",r="loadingFailed",q="String",p="_applySource",n="img",o="image",l="mshtml",m="_applyScale",k="no-repeat";
qx.Class.define(u,{extend:qx.ui.core.Widget,construct:function(z){this.__fO={};
qx.ui.core.Widget.call(this);

if(z){this.setSource(z);
}},properties:{source:{check:q,init:null,nullable:true,event:v,apply:p,themeable:true},scale:{check:a,init:false,themeable:true,apply:m},appearance:{refine:true,init:o},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},events:{loadingFailed:c,loaded:c},members:{__fP:null,__fQ:null,__fR:null,__fO:null,getContentElement:function(){return this.__fV();
},_createContentElement:function(){return this.__fV();
},_getContentHint:function(){return {width:this.__fP||0,height:this.__fQ||0};
...
},__fS:function(E){this.__fR=E;
},__fT:function(){if(this.__fR==null){var G=this.getSource();
var F=false;

if(G!=null){F=qx.lang.String.endsWith(G,g);
}
if(this.getScale()&&F&&qx.bom.element.Decoration.isAlphaImageLoaderEnabled()){this.__fR=h;
}else if(this.getScale()){this.__fR=i;
}else{this.__fR=j;
}}return this.__fR;
},__fU:function(H){var I;
var J;
...
return K;
},__fV:function(){var L=this.__fT();

if(this.__fO[L]==null){this.__fO[L]=this.__fU(L);
}return this.__fO[L];
...
}if(qx.util.ResourceManager.getInstance().has(M)){this.__fY(this.getContentElement(),M);
}else if(qx.io.ImageLoader.isLoaded(M)){this.__ga(this.getContentElement(),M);
}else{this.__gb(this.getContentElement(),M);
}},__fW:qx.core.Variant.select(f,{"mshtml":function(O){var Q=qx.bom.element.Decoration.isAlphaImageLoaderEnabled();
var P=qx.lang.String.endsWith(O,g);

if(Q&&P){if(this.getScale()&&this.__fT()!=h){this.__fS(h);
}else if(!this.getScale()&&this.__fT()!=j){this.__fS(j);
}}else{if(this.getScale()&&this.__fT()!=i){this.__fS(i);
}else if(!this.getScale()&&this.__fT()!=j){this.__fS(j);
}}this.__fX(this.__fV());
},"default":function(R){if(this.getScale()&&this.__fT()!=i){this.__fS(i);
}else if(!this.getScale()&&this.__fT(j)){this.__fS(j);
}this.__fX(this.__fV());
}}),__fX:function(S){var V=this.getContainerElement();
var W=V.getChild(0);
...
V.addAt(S,0);
}},__fY:function(ba,bb){var bd=qx.util.ResourceManager.getInstance();
...
this.__gd(bd.getImageWidth(bb),bd.getImageHeight(bb));
},__ga:function(be,bf){var bh=qx.io.ImageLoader;
be.setSource(bf);
var bg=bh.getWidth(bf);
var bi=bh.getHeight(bf);
this.__gd(bg,bi);
},__gb:function(bj,bk){var self;
var bl=qx.io.ImageLoader;
{};
if(!bl.isFailed(bk)){bl.load(bk,this.__gc,this);
}else{if(bj!=null){bj.resetSource();
}}},__gc:function(bm,bn){if(this.$$disposed===true){return;
...
},__gd:function(bo,bp){if(bo!==this.__fP||bp!==this.__fQ){this.__fP=bo;
this.__fQ=bp;
qx.ui.core.queue.Layout.add(this);
...
qx.Mixin.define(w,{statics:{__iL:null,setVisibleElement:function(y){this.__iL=y;
},getVisibleElement:function(){return this.__iL;
}},properties:{position:{check:[r,o,d,a,v,l,k,n],init:d,themeable:true},placeMethod:{check:[x,e],init:e,themeable:true},domMove:{check:b,init:false},placementModeX:{check:[c,h,f],init:h,themeable:true},placementModeY:{check:[c,h,f],init:h,themeable:true},offsetLeft:{check:j,init:0,themeable:true},offsetTop:{check:j,init:0,themeable:true},offsetRight:{check:j,init:0,themeable:true},offsetBottom:{check:j,init:0,themeable:true},offset:{group:[m,u,p,s],mode:t,themeable:true}},members:{__iM:null,__iN:null,__iO:null,getLayoutLocation:function(z){var C,B,D,top;
B=z.getBounds();
D=B.left;
top=B.top;
var E=B;
...
}},placeToWidget:function(L,M){if(M){this.__iP();
this.__iM=qx.lang.Function.bind(this.placeToWidget,this,L,false);
...
if(R){this.__iM=qx.lang.Function.bind(this.placeToElement,this,Q,false);
qx.event.Idle.getInstance().addListener(i,this.__iM);
...
},__iQ:function(V){var W=null;

if(this._computePlacementSize){var W=this._computePlacementSize();
}else if(this.isVisible()){var W=this.getBounds();
}
if(W==null){this.addListenerOnce(q,function(){this.__iQ(V);
},this);
}else{V.call(this,W);
}},__iR:function(X){this.__iQ(function(Y){var ba=qx.util.placement.Placement.compute(Y,this.getLayoutParent().getBounds(),X,this._getPlacementOffsets(),this.getPosition(),this.getPlacementModeX(),this.getPlacementModeY());
...
qx.Class.define(G,{statics:{__eX:{"Array":[f,p,E,q,z,d,a,y,g,h,k,j,n,v,b,D,o],"String":[H,A,w,t,C,r,k,j,x,e,F,I,m,u,B,c,g,h]},__eY:function(J,K){return function(s){return J.prototype[K].apply(s,Array.prototype.slice.call(arguments,1));
};
},__fa:function(){var L=qx.lang.Generics.__eX;
...
if(!N[O]){N[O]=qx.lang.Generics.__eY(N,O);
}}}}},defer:function(Q){Q.__fa();
}});
})();
...
qx.Mixin.define(d,{construct:function(){if(qx.core.Variant.isSet(m,i)){qx.locale.Manager.getInstance().addListener(k,this.__fm,this);
...
},__fm:qx.core.Variant.select(m,{"on":function(e){var p=this.getInvalidMessage();
...
}},"off":null})},destruct:function(){if(qx.core.Variant.isSet(m,i)){qx.locale.Manager.getInstance().removeListener(k,this.__fm,this);
}}});
})();
...
}},properties:{size:{check:a,init:Infinity}},members:{__fG:null,getObject:function(d){if(this.$$disposed){return new d;
}
if(!d){throw new Error("Class needs to be defined!");
}var e=null;
var f=this.__fG[d.classname];
...
},poolObject:function(g){if(!this.__fG){return;
}var h=g.classname;
var j=this.__fG[h];
...
j.push(g);
}},destruct:function(){var n=this.__fG;
var k,m,i,l;
...
qx.Class.define(v,{statics:{DEBUG_ON:false,__gk:{},bind:function(E,F,G,H,I){var S=this.__gm(E,F,G,H,I);
var N=F.split(d);
var K=this.__gt(N);
var R=[];
var O=[];
...
var Q=qx.lang.Function.bind(this.__gl,this,T);
O.push(Q);
...
this.__gv(U,E,F,G,H);
return U;
},__gl:function(W){if(W.options&&W.options.onUpdate){W.options.onUpdate(W.sources[W.index],W.targetObject);
...
}}else{if(W.listeners[j]==null){var X=qx.lang.Function.bind(this.__gl,this,W);
W.listeners.push(X);
...
}}},__gm:function(bd,be,bf,bg,bh){var bl=bg.split(d);
var bj=this.__gt(bl);
var bq=[];
var bp=[];
var bn=[];
...
}qx.data.SingleValueBinding.__gn(bd,be,bf,bg,bh);
};
bp.push(bo);
...
},__gn:function(bv,bw,bx,by,bz){var bD=this.__gr(bv,bw);
...
return cs;
},__gv:function(cy,cz,cA,cB,cC){if(this.__gk[cz.toHashCode()]===undefined){this.__gk[cz.toHashCode()]=[];
}this.__gk[cz.toHashCode()].push([cy,cz,cA,cB,cC]);
...
}var cU=this.__gk[cS.toHashCode()];
...
var cW=this.__gk[cV.toHashCode()];

if(cW!=undefined){for(var i=cW.length-1;i>=0;i--){this.removeBindingFromObject(cV,cW[i][0]);
}}},getAllBindingsForObject:function(cX){if(this.__gk[cX.toHashCode()]===undefined){this.__gk[cX.toHashCode()]=[];
}return this.__gk[cX.toHashCode()];
},removeAllBindings:function(){for(var da in this.__gk){var cY=qx.core.ObjectRegistry.fromHashCode(da);
if(cY==null){delete this.__gk[da];
continue;
}this.removeAllBindingsForObject(cY);
}this.__gk={};
},getAllBindings:function(){return this.__gk;
},showBindingInLog:function(db,dc){var de;
for(var i=0;i<this.__gk[db.toHashCode()].length;i++){if(this.__gk[db.toHashCode()][i][0]==dc){de=this.__gk[db.toHashCode()][i];
break;
}}
if(de===undefined){var dd=r;
}else{var dd=s+de[1]+A+de[2]+y+de[3]+A+de[4]+o;
}qx.log.Logger.debug(dd);
},showAllBindingsInLog:function(){for(var dg in this.__gk){var df=qx.core.ObjectRegistry.fromHashCode(dg);

for(var i=0;i<this.__gk[dg].length;i++){this.showBindingInLog(df,this.__gk[dg][i][0]);
}}}}});
})();
...
qx.Class.define(y,{statics:{DEBUG:false,__hw:{},__hx:qx.core.Variant.isSet(j,c),__hy:qx.core.Variant.select(j,{"mshtml":{"scale-x":true,"scale-y":true,"scale":true,"no-repeat":true},"default":null}),__hz:{"scale-x":h,"scale-y":h,"scale":h,"repeat":i,"no-repeat":i,"repeat-x":i,"repeat-y":i},update:function(H,I,J,K){var M=this.getTagName(J,I);
...
if(this.__hx){try{H.filters[u].apply();
...
}},getTagName:function(U,V){if(qx.core.Variant.isSet(j,c)){if(V&&this.__hx&&this.__hy[U]&&qx.lang.String.endsWith(V,E)){return i;
}}return this.__hz[U];
...
{};
var ba;
if(this.__hx&&this.__hy[X]&&bb===r){ba=this.__hC(Y,X,W);
}else{if(X===b){ba=this.__hD(Y,X,W);
}else if(X===d||X===a){ba=this.__hE(Y,X,W);
}else{ba=this.__hH(Y,X,W);
}}return ba;
},__hA:function(bc,bd,be){if(bc.width==null&&bd!=null){bc.width=bd+k;
}
if(bc.height==null&&be!=null){bc.height=be+k;
}return bc;
},__hB:function(bf){var bh=qx.util.ResourceManager.getInstance().getImageWidth(bf)||qx.io.ImageLoader.getWidth(bf);
var bi=qx.util.ResourceManager.getInstance().getImageHeight(bf)||qx.io.ImageLoader.getHeight(bf);
return {width:bh,height:bi};
},__hC:function(bj,bk,bl){var bo=this.__hB(bl);
bj=this.__hA(bj,bo.width,bo.height);
var bn=bk==f?D:b;
var bm=C+qx.util.ResourceManager.getInstance().toUri(bl)+x+bn+s;
bj.filter=bm;
bj.backgroundImage=bj.backgroundRepeat=g;
return {style:bj};
},__hD:function(bp,bq,br){var bs=qx.util.ResourceManager.getInstance().toUri(br);
var bt=this.__hB(br);
bp=this.__hA(bp,bt.width,bt.height);
return {src:bs,style:bp};
},__hE:function(bu,bv,bw){var bA=qx.util.ResourceManager.getInstance();
...
if(bv===d){bu=this.__hF(bu,by,bB.height);
}else{bu=this.__hG(bu,by,bB.width);
...
return {src:bx,style:bu};
}},__hF:function(bC,bD,bE){var bF=qx.util.ResourceManager.getInstance().getImageHeight(bD[4]);
...
},__hG:function(bG,bH,bI){var bJ=qx.util.ResourceManager.getInstance().getImageWidth(bH[4]);
...
},__hH:function(bK,bL,bM){var bR=qx.util.ResourceManager.getInstance().isClippedImage(bM);
var bQ=this.__hB(bM);
...
bK=this.__hA(bK,bQ.width,bQ.height);
bK=this.__hI(bK,bM,bL);
return {style:bK};
}},__hI:function(bS,bT,bU){var top=null;
var bY=null;
...
},__hJ:function(ca){if(this.DEBUG&&qx.util.ResourceManager.getInstance().has(ca)&&ca.indexOf(G)==-1){if(!this.__hw[ca]){qx.log.Logger.debug("Potential clipped image candidate: "+ca);
this.__hw[ca]=true;
}}},isAlphaImageLoaderEnabled:qx.core.Variant.select(j,{"mshtml":function(){return qx.bom.element.Decoration.__hx;
},"default":function(){return false;
}})}});
})();
(function(){var b="appearance",a="qx.ui.core.queue.Appearance";
qx.Class.define(a,{statics:{__hK:{},remove:function(c){delete this.__hK[c.$$hash];
},add:function(d){var e=this.__hK;

if(e[d.$$hash]){return;
}e[d.$$hash]=d;
qx.ui.core.queue.Manager.scheduleFlush(b);
},has:function(f){return !!this.__hK[f.$$hash];
...
(function(){var o="top",n="right",m="bottom",l="left",k="align-start",j="qx.util.placement.AbstractAxis",i="edge-start",h="align-end",g="edge-end",f="-",c="best-fit",e="qx.util.placement.Placement",d='__hL',b="keep-align",a="direct";
qx.Class.define(e,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__hL=new qx.util.placement.DirectAxis();
},properties:{axisX:{check:j},axisY:{check:j},edge:{check:[o,n,m,l],init:o},align:{check:[o,n,m,l],init:n}},statics:{__hM:null,compute:function(p,q,r,s,t,u,v){this.__hM=this.__hM||new qx.util.placement.Placement();
var y=t.split(f);
var x=y[0];
var w=y[1];
this.__hM.set({axisX:this.__hQ(u),axisY:this.__hQ(v),edge:x,align:w});
return this.__hM.compute(p,q,r,s);
},__hN:null,__hO:null,__hP:null,__hQ:function(z){switch(z){case a:this.__hN=this.__hN||new qx.util.placement.DirectAxis();
return this.__hN;
case b:this.__hO=this.__hO||new qx.util.placement.KeepAlignAxis();
return this.__hO;
case c:this.__hP=this.__hP||new qx.util.placement.BestFitAxis();
return this.__hP;
default:throw new Error("Invalid 'mode' argument!'");
}}},members:{__hL:null,compute:function(A,B,C,D){{};
var E=this.getAxisX()||this.__hL;
var G=E.computeStart(A.width,{start:C.left,end:C.right},{start:D.left,end:D.right},B.width,this.__hR());
var F=this.getAxisY()||this.__hL;
var top=F.computeStart(A.height,{start:C.top,end:C.bottom},{start:D.top,end:D.bottom},B.height,this.__hS());
return {left:G,top:top};
},__hR:function(){var I=this.getEdge();
var H=this.getAlign();
...
}},__hS:function(){var K=this.getEdge();
var J=this.getAlign();
...
qx.Class.define(b,{statics:{__hY:{},remove:function(c){delete this.__hY[c.$$hash];
},add:function(d){this.__hY[d.$$hash]=d;
qx.ui.core.queue.Manager.scheduleFlush(a);
},flush:function(){var e=this.__ic();
...
}}},getNestingLevel:function(j){var k=this.__ib;
var m=0;
var parent=j;
...
},__ia:function(){var s=qx.ui.core.queue.Visibility;
this.__ib={};
var r=[];
var q=this.__hY;
var n,p;
...
if(o){o.__ih();
}}},members:{canHandleEvent:function(p,q){},registerEvent:function(r,s,t){},unregisterEvent:function(u,v,w){},__if:null,__id:null,__ie:null,__ig:null,__ih:function(){if(!this.__if&&this.__id&&qx.$$loader.scriptLoaded){try{var x=qx.core.Setting.get(f);

if(!qx.Class.getByName(x)){return;
}}catch(e){}if(qx.core.Variant.isSet(l,k)){if(qx.event.Registration.hasListener(this._window,m)){this.__if=true;
qx.event.Registration.fireEvent(this._window,m);
}}else{this.__if=true;
qx.event.Registration.fireEvent(this._window,m);
}}},isApplicationReady:function(){return this.__if;
},_initObserver:function(){if(qx.$$domReady||document.readyState==g||document.readyState==m){this.__id=true;
this.__ih();
...
},_onNativeLoad:qx.event.GlobalError.observeMethod(function(){this.__id=true;
this.__ih();
}),_onNativeUnload:qx.event.GlobalError.observeMethod(function(){if(!this.__ig){this.__ig=true;
...
},__ii:function(o,p){if(o[p].include){var q=o[o[p].include];
o[p].include=null;
delete o[p].include;
...
for(var v in t){if(t[v].include&&t[t[v].include]){this.__ii(t,v);
}s[v]=(new u).set(t[v]);
s[v].themed=true;
}}this._setDynamic(s);
}}});
...
},__ij:{visible:true,hidden:true},getContentWidth:function(q){var s=qx.bom.element.Style;
var t=qx.bom.element.Overflow.getX(q);
var u=parseInt(s.get(q,d)||i,10);
var x=parseInt(s.get(q,e)||i,10);

if(this.__ij[t]){var w=q.clientWidth;
...
if(this.__ij[C]){return y.clientHeight-D-B;
...
this.__ir=i.getWindow();
this.__is=j;
i.addListener(this.__ir,f,this.releaseCapture,this);
i.addListener(this.__ir,e,this.releaseCapture,this);
i.addListener(this.__ir,a,this.releaseCapture,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST},members:{__is:null,__it:null,__iu:true,__ir:null,_getParent:function(k){return k.parentNode;
},canDispatchEvent:function(l,event,m){return (this.__it&&this.__iv[m]);
},dispatchEvent:function(n,event,o){if(o==d){event.stopPropagation();
this.releaseCapture();
return;
}
if(this.__iu||!qx.dom.Hierarchy.contains(this.__it,n)){n=this.__it;
}qx.event.dispatch.AbstractBubbling.prototype.dispatchEvent.call(this,n,event,o);
},__iv:{"mouseup":1,"mousedown":1,"click":1,"dblclick":1,"mousemove":1,"mouseout":1,"mouseover":1},activateCapture:function(p,q){var q=q!==false;

if(this.__it===p&&this.__iu==q){return;
}
if(this.__it){this.releaseCapture();
...
this.__it=p;
this.__is.fireEvent(p,b,qx.event.type.Event,[true,false]);
},getCaptureElement:function(){return this.__it;
},releaseCapture:function(){var r=this.__it;

if(!r){return;
}this.__it=null;
this.__is.fireEvent(r,h,qx.event.type.Event,[true,false]);
...
},"default":qx.lang.Function.empty})},destruct:function(){this.__it=this.__ir=this.__is=null;
...
qx.Class.define(b,{statics:{__iw:{},__ix:{},remove:function(c){var d=c.$$hash;
delete this.__ix[d];
delete this.__iw[d];
},isVisible:function(e){return this.__ix[e.$$hash]||false;
},__iy:function(f){var h=this.__ix;
var g=f.$$hash;
var i;
if(f.isExcluded()){i=false;
}else{var parent=f.$$parent;

if(parent){i=this.__iy(parent);
}else{i=f.isRootWidget();
}}return h[g]=i;
},add:function(j){var k=this.__iw;

if(k[j.$$hash]){return;
}k[j.$$hash]=j;
qx.ui.core.queue.Manager.scheduleFlush(a);
},flush:function(){var l=this.__iw;
var p=this.__ix;
...
delete l[m];
if(p[m]==null){this.__iy(n);
}if(p[m]&&p[m]!=o[m]){n.checkAppearanceNeeds();
}}this.__iw={};
}}});
})();
(function(){var q="left",p="top",o="_applyLayoutChange",n="hAlign",m="flex",k="vAlign",h="Integer",g="minWidth",f="width",e="minHeight",b="qx.ui.layout.Grid",d="height",c="maxHeight",a="maxWidth";
qx.Class.define(b,{extend:qx.ui.layout.Abstract,construct:function(r,s){qx.ui.layout.Abstract.call(this);
this.__iz=[];
this.__iA=[];
...
}},properties:{spacingX:{check:h,init:0,apply:o},spacingY:{check:h,init:0,apply:o}},members:{__iB:null,__iz:null,__iA:null,__iC:null,__iD:null,__iE:null,__iF:null,__iG:null,__iH:null,verifyLayoutProperty:null,__iI:function(){var A=[];
var z=[];
var B=[];
var v=-1;
var u=-1;
...
this.__iH=null;
delete this._invalidChildrenCache;
},_setRowData:function(F,G,H){var I=this.__iz[F];

if(!I){this.__iz[F]={};
this.__iz[F][G]=H;
}else{I[G]=H;
}},_setColumnData:function(J,K,L){var M=this.__iA[J];

if(!M){this.__iA[J]={};
this.__iA[J][K]=L;
}else{M[K]=L;
}},setSpacing:function(N){this.setSpacingY(N);
this.setSpacingX(N);
return this;
},setColumnAlign:function(O,P,Q){{};
this._setColumnData(O,n,P);
this._setColumnData(O,k,Q);
this._applyLayoutChange();
return this;
},getColumnAlign:function(R){var S=this.__iA[R]||{};
return {vAlign:S.vAlign||p,hAlign:S.hAlign||q};
},setRowAlign:function(T,U,V){{};
this._setRowData(T,n,U);
this._setRowData(T,k,V);
this._applyLayoutChange();
return this;
},getRowAlign:function(W){var X=this.__iz[W]||{};
return {vAlign:X.vAlign||p,hAlign:X.hAlign||q};
},getCellWidget:function(Y,ba){if(this._invalidChildrenCache){this.__iI();
}var Y=this.__iB[Y]||{};
return Y[ba]||null;
},getRowCount:function(){if(this._invalidChildrenCache){this.__iI();
}return this.__iE+1;
},getColumnCount:function(){if(this._invalidChildrenCache){this.__iI();
}return this.__iF+1;
},getCellAlign:function(bb,bc){var bi=p;
var bg=q;
var bh=this.__iz[bb];
var be=this.__iA[bc];
var bd=this.__iB[bb][bc];
...
},setColumnFlex:function(bj,bk){this._setColumnData(bj,m,bk);
this._applyLayoutChange();
return this;
},getColumnFlex:function(bl){var bm=this.__iA[bl]||{};
return bm.flex!==undefined?bm.flex:0;
},setRowFlex:function(bn,bo){this._setRowData(bn,m,bo);
this._applyLayoutChange();
return this;
},getRowFlex:function(bp){var bq=this.__iz[bp]||{};
var br=bq.flex!==undefined?bq.flex:0;
return br;
},setColumnMaxWidth:function(bs,bt){this._setColumnData(bs,a,bt);
this._applyLayoutChange();
return this;
},getColumnMaxWidth:function(bu){var bv=this.__iA[bu]||{};
return bv.maxWidth!==undefined?bv.maxWidth:Infinity;
},setColumnWidth:function(bw,bx){this._setColumnData(bw,f,bx);
this._applyLayoutChange();
return this;
},getColumnWidth:function(by){var bz=this.__iA[by]||{};
return bz.width!==undefined?bz.width:null;
},setColumnMinWidth:function(bA,bB){this._setColumnData(bA,g,bB);
this._applyLayoutChange();
return this;
},getColumnMinWidth:function(bC){var bD=this.__iA[bC]||{};
return bD.minWidth||0;
},setRowMaxHeight:function(bE,bF){this._setRowData(bE,c,bF);
this._applyLayoutChange();
return this;
},getRowMaxHeight:function(bG){var bH=this.__iz[bG]||{};
return bH.maxHeight||Infinity;
},setRowHeight:function(bI,bJ){this._setRowData(bI,d,bJ);
this._applyLayoutChange();
return this;
},getRowHeight:function(bK){var bL=this.__iz[bK]||{};
return bL.height!==undefined?bL.height:null;
},setRowMinHeight:function(bM,bN){this._setRowData(bM,e,bN);
this._applyLayoutChange();
return this;
},getRowMinHeight:function(bO){var bP=this.__iz[bO]||{};
return bP.minHeight||0;
},__iJ:function(bQ){var bU=bQ.getSizeHint();
var bT=bQ.getMarginLeft()+bQ.getMarginRight();
var bS=bQ.getMarginTop()+bQ.getMarginBottom();
var bR={height:bU.height+bS,width:bU.width+bT,minHeight:bU.minHeight+bS,minWidth:bU.minWidth+bT,maxHeight:bU.maxHeight+bS,maxWidth:bU.maxWidth+bT};
return bR;
},_fixHeightsRowSpan:function(bV){var ch=this.getSpacingY();

for(var i=0,l=this.__iD.length;i<l;i++){var bY=this.__iD[i];
var cb=this.__iJ(bY);
var cc=bY.getLayoutProperties();
var bX=cc.row;
var cf=ch*(cc.rowSpan-1);
var bW=cf;
var ce={};

for(var j=0;j<cc.rowSpan;j++){var cj=cc.row+j;
var ca=bV[cj];
var ci=this.getRowFlex(cj);

if(ci>0){ce[cj]={min:ca.minHeight,value:ca.height,max:ca.maxHeight,flex:ci};
}cf+=ca.height;
bW+=ca.minHeight;
}if(cf<cb.height){var cg=qx.ui.layout.Util.computeFlexOffsets(ce,cb.height,cf);

for(var j=0;j<cc.rowSpan;j++){var cd=cg[bX+j]?cg[bX+j].offset:0;
bV[bX+j].height+=cd;
}}if(bW<cb.minHeight){var cg=qx.ui.layout.Util.computeFlexOffsets(ce,cb.minHeight,bW);

for(var j=0;j<cc.rowSpan;j++){var cd=cg[bX+j]?cg[bX+j].offset:0;
bV[bX+j].minHeight+=cd;
}}}},_fixWidthsColSpan:function(ck){var co=this.getSpacingX();

for(var i=0,l=this.__iC.length;i<l;i++){var cl=this.__iC[i];
var cn=this.__iJ(cl);
var cq=cl.getLayoutProperties();
var cm=cq.column;
var cw=co*(cq.colSpan-1);
var cp=cw;
var cr={};
var ct;

for(var j=0;j<cq.colSpan;j++){var cx=cq.column+j;
var cv=ck[cx];
var cu=this.getColumnFlex(cx);
if(cu>0){cr[cx]={min:cv.minWidth,value:cv.width,max:cv.maxWidth,flex:cu};
}cw+=cv.width;
cp+=cv.minWidth;
}if(cw<cn.width){var cs=qx.ui.layout.Util.computeFlexOffsets(cr,cn.width,cw);

for(var j=0;j<cq.colSpan;j++){ct=cs[cm+j]?cs[cm+j].offset:0;
ck[cm+j].width+=ct;
}}if(cp<cn.minWidth){var cs=qx.ui.layout.Util.computeFlexOffsets(cr,cn.minWidth,cp);

for(var j=0;j<cq.colSpan;j++){ct=cs[cm+j]?cs[cm+j].offset:0;
ck[cm+j].minWidth+=ct;
}}}},_getRowHeights:function(){if(this.__iG!=null){return this.__iG;
}var cH=[];
var cA=this.__iE;
var cz=this.__iF;

for(var cI=0;cI<=cA;cI++){var cB=0;
var cD=0;
var cC=0;

for(var cG=0;cG<=cz;cG++){var cy=this.__iB[cI][cG];

if(!cy){continue;
}var cE=cy.getLayoutProperties().rowSpan||0;

if(cE>1){continue;
}var cF=this.__iJ(cy);

if(this.getRowFlex(cI)>0){cB=Math.max(cB,cF.minHeight);
}else{cB=Math.max(cB,cF.height);
}cD=Math.max(cD,cF.height);
}var cB=Math.max(cB,this.getRowMinHeight(cI));
var cC=this.getRowMaxHeight(cI);

if(this.getRowHeight(cI)!==null){var cD=this.getRowHeight(cI);
}else{var cD=Math.max(cB,Math.min(cD,cC));
}cH[cI]={minHeight:cB,height:cD,maxHeight:cC};
}
if(this.__iD.length>0){this._fixHeightsRowSpan(cH);
}this.__iG=cH;
return cH;
},_getColWidths:function(){if(this.__iH!=null){return this.__iH;
}var cN=[];
var cK=this.__iF;
var cM=this.__iE;

for(var cS=0;cS<=cK;cS++){var cQ=0;
var cP=0;
var cL=Infinity;

for(var cT=0;cT<=cM;cT++){var cJ=this.__iB[cT][cS];

if(!cJ){continue;
}var cO=cJ.getLayoutProperties().colSpan||0;

if(cO>1){continue;
}var cR=this.__iJ(cJ);

if(this.getColumnFlex(cS)>0){cP=Math.max(cP,cR.minWidth);
}else{cP=Math.max(cP,cR.width);
}cQ=Math.max(cQ,cR.width);
}var cP=Math.max(cP,this.getColumnMinWidth(cS));
var cL=this.getColumnMaxWidth(cS);

if(this.getColumnWidth(cS)!==null){var cQ=this.getColumnWidth(cS);
}else{var cQ=Math.max(cP,Math.min(cQ,cL));
}cN[cS]={minWidth:cP,width:cQ,maxWidth:cL};
}
if(this.__iC.length>0){this._fixWidthsColSpan(cN);
}this.__iH=cN;
return cN;
...
},renderLayout:function(dj,dk){if(this._invalidChildrenCache){this.__iI();
}var dz=qx.ui.layout.Util;
var dm=this.getSpacingX();
var dt=this.getSpacingY();
var dE=this._getColWidths();
var dD=this._getColumnFlexOffsets(dj);
var dn=[];
var dG=this.__iF;
var dl=this.__iE;
var dF;
...
dn[dH]=dE[dH].width+dF;
}var dw=this._getRowHeights();
var dy=this._getRowFlexOffsets(dk);
var dN=[];

for(var du=0;du<=dl;du++){dF=dy[du]?dy[du].offset:0;
dN[du]=dw[du].height+dF;
}var dO=0;

for(var dH=0;dH<=dG;dH++){var top=0;

for(var du=0;du<=dl;du++){var dB=this.__iB[du][dH];
if(!dB){top+=dN[du]+dt;
continue;
}var dp=dB.getLayoutProperties();
if(dp.row!==du||dp.column!==dH){top+=dN[du]+dt;
continue;
}var dM=dm*(dp.colSpan-1);

for(var i=0;i<dp.colSpan;i++){dM+=dn[dH+i];
}var dC=dt*(dp.rowSpan-1);

for(var i=0;i<dp.rowSpan;i++){dC+=dN[du+i];
}var dq=dB.getSizeHint();
var dK=dB.getMarginTop();
var dA=dB.getMarginLeft();
var dx=dB.getMarginBottom();
var ds=dB.getMarginRight();
var dv=Math.max(dq.minWidth,Math.min(dM-dA-ds,dq.maxWidth));
var dL=Math.max(dq.minHeight,Math.min(dC-dK-dx,dq.maxHeight));
var dI=this.getCellAlign(du,dH);
var dJ=dO+dz.computeHorizontalAlignOffset(dI.hAlign,dv,dM,dA,ds);
var dr=top+dz.computeVerticalAlignOffset(dI.vAlign,dL,dC,dK,dx);
dB.renderLayout(dJ,dr,dv,dL);
top+=dN[du]+dt;
}dO+=dn[dH]+dm;
}},invalidateLayoutCache:function(){qx.ui.layout.Abstract.prototype.invalidateLayoutCache.call(this);
this.__iH=null;
this.__iG=null;
},_computeSizeHint:function(){if(this._invalidChildrenCache){this.__iI();
...
return dS;
}},destruct:function(){this.__iB=this.__iz=this.__iA=this.__iC=this.__iD=this.__iH=this.__iG=null;
}});
})();
...
qx.Class.define(x,{statics:{__iS:function(z,A){return qx.bom.element.Style.get(z,A,qx.bom.element.Style.COMPUTED_MODE,false);
},__iT:function(B,C){return parseInt(qx.bom.element.Style.get(B,C,qx.bom.element.Style.COMPUTED_MODE,false),10)||0;
},__iU:function(D){var G=0,top=0;
...
},__iV:qx.core.Variant.select(e,{"mshtml":function(H){var J=qx.dom.Node.getDocument(H);
var I=J.body;
var K=0;
var top=0;
...
if(qx.bom.client.Feature.STANDARD_MODE){K+=this.__iT(I,i);
top+=this.__iT(I,j);
...
var O=M.offsetLeft;
var top=M.offsetTop;
if(qx.bom.client.Engine.VERSION<530.17){O+=this.__iT(M,i);
top+=this.__iT(M,j);
}return {left:O,top:top};
},"gecko":function(P){var Q=qx.dom.Node.getDocument(P).body;
var R=Q.offsetLeft;
var top=Q.offsetTop;
if(qx.bom.client.Engine.VERSION<1.9){R+=this.__iT(Q,g);
top+=this.__iT(Q,h);
}if(qx.bom.element.BoxSizing.get(Q)!==d){R+=this.__iT(Q,i);
top+=this.__iT(Q,j);
...
}}),__iW:qx.core.Variant.select(e,{"mshtml|webkit":function(V){var X=qx.dom.Node.getDocument(V);
...
if(bd.get(bb)!==d){bf-=this.__iT(bb,i);
top-=this.__iT(bb,j);
}
...
if(bd.get(bb)!==d){bf+=this.__iT(bb,i);
top+=this.__iT(bb,j);
}if(bb.parentNode&&this.__iS(bb.parentNode,l)!=t){bf+=this.__iT(bb.parentNode,i);
top+=this.__iT(bb.parentNode,j);
}bb=bb.offsetParent;
...
}}),get:function(bj,bk){if(bj.tagName==s){var location=this.__iX(bj);
var br=location.left;
var top=location.top;
}else{var bl=this.__iV(bj);
var bq=this.__iW(bj);
var scroll=this.__iU(bj);
...
if(bo==f||bo==a){bm+=bj.scrollWidth-bj.offsetWidth+this.__iT(bj,i)+this.__iT(bj,b);
}var bp=qx.bom.element.Overflow.getY(bj);

if(bp==f||bp==a){bn+=bj.scrollHeight-bj.offsetHeight+this.__iT(bj,j)+this.__iT(bj,c);
}}
switch(bk){case y:br+=this.__iT(bj,w);
top+=this.__iT(bj,q);
bm-=this.__iT(bj,m);
bn-=this.__iT(bj,r);
...
bm-=bj.scrollLeft;
bn-=bj.scrollTop;
case k:br+=this.__iT(bj,i);
top+=this.__iT(bj,j);
bm-=this.__iT(bj,b);
bn-=this.__iT(bj,c);
break;
case o:br-=this.__iT(bj,g);
top-=this.__iT(bj,h);
bm+=this.__iT(bj,p);
bn+=this.__iT(bj,u);
break;
}}return {left:br,top:top,right:bm,bottom:bn};
},__iX:qx.core.Variant.select(e,{"default":function(bs){var top=bs.offsetTop+this.__iT(bs,h);
var bt=bs.offsetLeft+this.__iT(bs,g);
return {left:bt,top:top};
},"mshtml":function(bu){var top=bu.offsetTop;
var bv=bu.offsetLeft;

if(!((qx.bom.client.Engine.VERSION<8||qx.bom.client.Engine.DOCUMENT_MODE<8)&&!qx.bom.client.Feature.QUIRKS_MODE)){top+=this.__iT(bu,h);
bv+=this.__iT(bu,g);
}return {left:bv,top:top};
},"gecko":function(bw){var top=bw.offsetTop+this.__iT(bw,h)+this.__iT(bw,i);
var bx=bw.offsetLeft+this.__iT(bw,g)+this.__iT(bw,j);
...
qx.Class.define(c,{statics:{LOCALE:"",VARIANT:"",__lx:function(){var d=(navigator.userLanguage||navigator.language).toLowerCase();
var f=a;
var e=d.indexOf(b);
...
qx.Class.define(o,{statics:{__jh:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__ji:function(){var A=this.__jk(false);
document.body.insertBefore(A,document.body.firstChild);
return this._textElement=A;
},__jj:function(){var B=this.__jk(true);
document.body.insertBefore(B,document.body.firstChild);
return this._htmlElement=B;
},__jk:function(C){var D=qx.bom.Element.create(j);
var E=D.style;
E.width=E.height=a;
E.left=E.top=k;
E.visibility=d;
...
for(var G in this.__jh){E[G]=i;
}D.appendChild(F);
}}return D;
},__jl:function(H){var I={};
...
M.maxWidth=r;
M.padding=z;
for(var O in this.__jh){N.style[O]=i;
}N.setAttribute(u,s);
L.appendChild(N);
}else{var L=K.document.createElement(j);
qx.bom.element.Style.setStyles(L,this.__jl(J));
}
...
}},getHtmlSize:function(content,S,T){var U=this._htmlElement||this.__jj();
U.style.width=T!==undefined?T+v:a;
U.innerHTML=content;
return this.__jm(U,S);
},getTextSize:function(V,W){var X=this._textElement||this.__ji();
...
}return this.__jm(X,W);
},__jm:function(Y,ba){var bb=this.__jh;
...
this.__jn=B;
this.__jo=B.getWindow().document.documentElement;
this.__jn.addListener(this.__jo,v,this._onMouseDown,this);
this.__jA();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{dragstart:1,dragend:1,dragover:1,dragleave:1,drop:1,drag:1,dragchange:1,droprequest:1},IGNORE_CAN_HANDLE:true},members:{__jn:null,__jo:null,__jp:null,__jq:null,__jr:null,__js:null,__jt:null,__ju:null,__jv:null,__jw:null,__jx:false,__jy:0,__jz:0,canHandleEvent:function(C,D){},registerEvent:function(E,F,G){},unregisterEvent:function(H,I,J){},addType:function(K){this.__jr[K]=true;
},addAction:function(L){this.__js[L]=true;
},supportsType:function(M){return !!this.__jr[M];
},supportsAction:function(N){return !!this.__js[N];
},getData:function(O){if(!this.__jH||!this.__jp){throw new Error("This method must not be used outside the drop event listener!");
}
if(!this.__jr[O]){throw new Error("Unsupported data type: "+O+"!");
}
if(!this.__ju[O]){this.__jv=O;
this.__jC(q,this.__jq,this.__jp,false);
}
if(!this.__ju[O]){throw new Error("Please use a droprequest listener to the drag source to fill the manager with data!");
}return this.__ju[O]||null;
},getCurrentAction:function(){return this.__jw;
},addData:function(P,Q){this.__ju[P]=Q;
},getCurrentType:function(){return this.__jv;
},isSessionActive:function(){return this.__jx;
},__jA:function(){this.__jr={};
this.__js={};
this.__jt={};
this.__ju={};
},__jB:function(){if(this.__jq==null){return;
}var T=this.__js;
var R=this.__jt;
var S=null;

if(this.__jH){if(R.Shift&&R.Ctrl&&T.alias){S=k;
...
if(S!=this.__jw){this.__jw=S;
this.__jC(o,this.__jq,this.__jp,false);
}},__jC:function(U,V,W,X,Y){var bb=qx.event.Registration;
var ba=bb.createEvent(U,qx.event.type.Drag,[X,Y]);

if(V!==W){ba.setRelatedTarget(W);
}return bb.dispatchEvent(V,ba);
},__jD:function(bc){while(bc&&bc.nodeType==1){if(bc.getAttribute(u)==w){return bc;
}bc=bc.parentNode;
}return null;
},__jE:function(bd){while(bd&&bd.nodeType==1){if(bd.getAttribute(r)==w){return bd;
}bd=bd.parentNode;
}return null;
},__jF:function(){this.__jq=null;
this.__jn.removeListener(this.__jo,c,this._onMouseMove,this,true);
this.__jn.removeListener(this.__jo,y,this._onMouseUp,this,true);
qx.event.Registration.removeListener(window,i,this._onWindowBlur,this);
this.__jA();
},__jG:function(){if(this.__jx){this.__jn.removeListener(this.__jo,a,this._onMouseOver,this,true);
this.__jn.removeListener(this.__jo,h,this._onMouseOut,this,true);
this.__jn.removeListener(this.__jo,g,this._onKeyDown,this,true);
this.__jn.removeListener(this.__jo,z,this._onKeyUp,this,true);
this.__jC(x,this.__jq,this.__jp,false);
this.__jx=false;
}this.__jH=false;
this.__jp=null;
this.__jF();
},__jH:false,_onWindowBlur:function(e){this.__jG();
},_onKeyDown:function(e){var be=e.getKeyIdentifier();

switch(be){case A:case f:case d:if(!this.__jt[be]){this.__jt[be]=true;
this.__jB();
}}},_onKeyUp:function(e){var bf=e.getKeyIdentifier();

switch(bf){case A:case f:case d:if(this.__jt[bf]){this.__jt[bf]=false;
this.__jB();
}}},_onMouseDown:function(e){if(this.__jx){return;
}var bg=this.__jD(e.getTarget());

if(bg){this.__jy=e.getDocumentLeft();
this.__jz=e.getDocumentTop();
this.__jq=bg;
this.__jn.addListener(this.__jo,c,this._onMouseMove,this,true);
this.__jn.addListener(this.__jo,y,this._onMouseUp,this,true);
qx.event.Registration.addListener(window,i,this._onWindowBlur,this);
}},_onMouseUp:function(e){if(this.__jH){this.__jC(s,this.__jp,this.__jq,false,e);
}if(this.__jx){e.stopPropagation();
}this.__jG();
},_onMouseMove:function(e){if(this.__jx){if(!this.__jC(t,this.__jq,this.__jp,true,e)){this.__jG();
}}else{if(Math.abs(e.getDocumentLeft()-this.__jy)>3||Math.abs(e.getDocumentTop()-this.__jz)>3){if(this.__jC(n,this.__jq,this.__jp,true,e)){this.__jx=true;
this.__jn.addListener(this.__jo,a,this._onMouseOver,this,true);
this.__jn.addListener(this.__jo,h,this._onMouseOut,this,true);
this.__jn.addListener(this.__jo,g,this._onKeyDown,this,true);
this.__jn.addListener(this.__jo,z,this._onKeyUp,this,true);
var bh=this.__jt;
bh.Ctrl=e.isCtrlPressed();
bh.Shift=e.isShiftPressed();
bh.Alt=e.isAltPressed();
this.__jB();
}else{this.__jC(x,this.__jq,this.__jp,false);
this.__jF();
}}}},_onMouseOver:function(e){var bi=e.getTarget();
var bj=this.__jE(bi);

if(bj&&bj!=this.__jp){this.__jH=this.__jC(m,bj,this.__jq,true,e);
this.__jp=bj;
this.__jB();
}},_onMouseOut:function(e){var bl=this.__jE(e.getTarget());
var bk=this.__jE(e.getRelatedTarget());

if(bl&&bl!==bk&&bl==this.__jp){this.__jC(l,this.__jp,bk,false,e);
this.__jp=null;
this.__jH=false;
qx.event.Timer.once(this.__jB,this,0);
}}},destruct:function(){this.__jq=this.__jp=this.__jn=this.__jo=this.__jr=this.__js=this.__jt=this.__ju=null;
},defer:function(bm){qx.event.Registration.addHandler(bm);
}});
})();
(function(){var a="qx.event.type.Data";
qx.Class.define(a,{extend:qx.event.type.Event,members:{__jI:null,__jJ:null,init:function(b,c,d){qx.event.type.Event.prototype.init.call(this,false,d);
this.__jI=b;
this.__jJ=c;
return this;
...
f.__jJ=this.__jJ;
return f;
},getData:function(){return this.__jI;
},getOldData:function(){return this.__jJ;
...
this._initObserver();
},properties:{active:{apply:t,nullable:true},focus:{apply:w,nullable:true}},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{focus:1,blur:1,focusin:1,focusout:1,activate:1,deactivate:1},IGNORE_CAN_HANDLE:true,FOCUSABLE_ELEMENTS:qx.core.Variant.select("qx.client",{"mshtml|gecko":{a:1,body:1,button:1,frame:1,iframe:1,img:1,input:1,object:1,select:1,textarea:1},"opera|webkit":{button:1,input:1,select:1,textarea:1}})},members:{__jK:null,__jL:null,__jM:null,__jN:null,__jO:null,__jP:null,__jQ:null,__jR:null,__jS:null,__jT:null,canHandleEvent:function(B,C){},registerEvent:function(D,E,F){},unregisterEvent:function(G,H,I){},focus:function(J){if(qx.core.Variant.isSet(j,n)){window.setTimeout(function(){try{J.focus();
...
}},tryActivate:function(S){var T=this.__kj(S);

if(T){this.setActive(T);
}},__jU:function(U,V,W,X){var ba=qx.event.Registration;
var Y=ba.createEvent(W,qx.event.type.Focus,[U,V,X]);
ba.dispatchEvent(U,Y);
},_windowFocused:true,__jV:function(){if(this._windowFocused){this._windowFocused=false;
this.__jU(this._window,null,g,false);
}},__jW:function(){if(!this._windowFocused){this._windowFocused=true;
this.__jU(this._window,null,f,false);
}},_initObserver:qx.core.Variant.select(j,{"gecko":function(){this.__jK=qx.lang.Function.listener(this.__kd,this);
this.__jL=qx.lang.Function.listener(this.__ke,this);
this.__jM=qx.lang.Function.listener(this.__kc,this);
this.__jN=qx.lang.Function.listener(this.__kb,this);
this.__jO=qx.lang.Function.listener(this.__jX,this);
qx.bom.Event.addNativeListener(this._document,i,this.__jK,true);
qx.bom.Event.addNativeListener(this._document,h,this.__jL,true);
qx.bom.Event.addNativeListener(this._window,f,this.__jM,true);
qx.bom.Event.addNativeListener(this._window,g,this.__jN,true);
qx.bom.Event.addNativeListener(this._window,y,this.__jO,true);
},"mshtml":function(){this.__jK=qx.lang.Function.listener(this.__kd,this);
this.__jL=qx.lang.Function.listener(this.__ke,this);
this.__jQ=qx.lang.Function.listener(this.__jY,this);
this.__jR=qx.lang.Function.listener(this.__ka,this);
this.__jP=qx.lang.Function.listener(this.__kg,this);
qx.bom.Event.addNativeListener(this._document,i,this.__jK);
qx.bom.Event.addNativeListener(this._document,h,this.__jL);
qx.bom.Event.addNativeListener(this._document,b,this.__jQ);
qx.bom.Event.addNativeListener(this._document,a,this.__jR);
qx.bom.Event.addNativeListener(this._document,d,this.__jP);
},"webkit":function(){this.__jK=qx.lang.Function.listener(this.__kd,this);
this.__jL=qx.lang.Function.listener(this.__ke,this);
this.__jR=qx.lang.Function.listener(this.__ka,this);
this.__jM=qx.lang.Function.listener(this.__kc,this);
this.__jN=qx.lang.Function.listener(this.__kb,this);
...
qx.bom.Event.addNativeListener(this._document,i,this.__jK,true);
qx.bom.Event.addNativeListener(this._document,h,this.__jL,true);
qx.bom.Event.addNativeListener(this._document,d,this.__jP,false);
qx.bom.Event.addNativeListener(this._window,c,this.__jR,true);
qx.bom.Event.addNativeListener(this._window,f,this.__jM,true);
qx.bom.Event.addNativeListener(this._window,g,this.__jN,true);
},"opera":function(){this.__jK=qx.lang.Function.listener(this.__kd,this);
this.__jL=qx.lang.Function.listener(this.__ke,this);
this.__jQ=qx.lang.Function.listener(this.__jY,this);
this.__jR=qx.lang.Function.listener(this.__ka,this);
qx.bom.Event.addNativeListener(this._document,i,this.__jK,true);
qx.bom.Event.addNativeListener(this._document,h,this.__jL,true);
qx.bom.Event.addNativeListener(this._window,z,this.__jQ,true);
qx.bom.Event.addNativeListener(this._window,c,this.__jR,true);
}}),_stopObserver:qx.core.Variant.select(j,{"gecko":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jK,true);
qx.bom.Event.removeNativeListener(this._document,h,this.__jL,true);
qx.bom.Event.removeNativeListener(this._window,f,this.__jM,true);
qx.bom.Event.removeNativeListener(this._window,g,this.__jN,true);
qx.bom.Event.removeNativeListener(this._window,y,this.__jO,true);
},"mshtml":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jK);
qx.bom.Event.removeNativeListener(this._document,h,this.__jL);
qx.bom.Event.removeNativeListener(this._document,b,this.__jQ);
qx.bom.Event.removeNativeListener(this._document,a,this.__jR);
qx.bom.Event.removeNativeListener(this._document,d,this.__jP);
},"webkit":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jK,true);
qx.bom.Event.removeNativeListener(this._document,h,this.__jL,true);
qx.bom.Event.removeNativeListener(this._document,d,this.__jP,false);
qx.bom.Event.removeNativeListener(this._window,c,this.__jR,true);
qx.bom.Event.removeNativeListener(this._window,f,this.__jM,true);
qx.bom.Event.removeNativeListener(this._window,g,this.__jN,true);
},"opera":function(){qx.bom.Event.removeNativeListener(this._document,i,this.__jK,true);
qx.bom.Event.removeNativeListener(this._document,h,this.__jL,true);
qx.bom.Event.removeNativeListener(this._window,z,this.__jQ,true);
qx.bom.Event.removeNativeListener(this._window,c,this.__jR,true);
}}),__jX:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(bb){var bc=qx.bom.Event.getTarget(bb);

if(!this.__kk(bc)){qx.bom.Event.preventDefault(bb);
}},"default":null})),__jY:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(bd){this.__jW();
...
if(bh==this._document||bh==this._window){this.__jW();

if(this.__jS){this.setFocus(this.__jS);
delete this.__jS;
}
if(this.__jT){this.setActive(this.__jT);
delete this.__jT;
}}else{this.setFocus(bh);
this.tryActivate(bh);
if(!this.__kk(bh)){bh.selectionStart=0;
bh.selectionEnd=0;
}}},"default":null})),__ka:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(bi){if(!bi.toElement){this.__jV();
this.resetFocus();
this.resetActive();
...
if(bm==this._document){this.__jV();
this.__jS=this.getFocus();
this.__jT=this.getActive();
this.resetFocus();
this.resetActive();
}else{if(bm===this.getFocus()){this.resetFocus();
}
if(bm===this.getActive()){this.resetActive();
}}},"default":null})),__kb:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(bn){var bo=qx.bom.Event.getTarget(bn);

if(bo===this._window||bo===this._document){this.__jV();
this.resetActive();
this.resetFocus();
}},"webkit":function(bp){var bq=qx.bom.Event.getTarget(bp);

if(bq===this._window||bq===this._document){this.__jV();
this.__jS=this.getFocus();
this.__jT=this.getActive();
this.resetActive();
this.resetFocus();
}},"default":null})),__kc:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(br){var bs=qx.bom.Event.getTarget(br);

if(bs===this._window||bs===this._document){this.__jW();
bs=this._body;
}this.setFocus(bs);
this.tryActivate(bs);
},"webkit":function(bt){var bu=qx.bom.Event.getTarget(bt);

if(bu===this._window||bu===this._document){this.__jW();
...
this.tryActivate(bu);
}},"default":null})),__kd:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"gecko":function(bv){var bx=qx.bom.Event.getTarget(bv);
var bw=this.__ki(bx);
...
if(bz){if(!this.__kk(bA)){bA.unselectable=e;
try{document.selection.empty();
}catch(bB){}try{bz.focus();
}catch(bC){}}}else{qx.bom.Event.preventDefault(by);
if(!this.__kk(bA)){bA.unselectable=e;
...
if(!this.__kk(bJ)){qx.bom.Event.preventDefault(bG);
...
}},"default":null})),__ke:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(bK){var bL=qx.bom.Event.getTarget(bK);

if(bL.unselectable){bL.unselectable=p;
}this.tryActivate(this.__kf(bL));
...
this.tryActivate(this.__kf(bP));
},"default":null})),__kf:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml|webkit":function(bQ){var bR=this.getFocus();

if(bR&&bQ!=bR&&(bR.nodeName.toLowerCase()===r||bR.nodeName.toLowerCase()===u)){bQ=bR;
}return bQ;
},"default":function(bS){return bS;
}})),__kg:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml|webkit":function(bT){var bU=qx.bom.Event.getTarget(bT);

if(!this.__kk(bU)){qx.bom.Event.preventDefault(bT);
}},"default":null})),__kh:function(bV){var bW=qx.bom.element.Attribute.get(bV,o);
...
},__ki:function(bY){while(bY&&bY.nodeType===1){if(bY.getAttribute(k)==e){return null;
}
if(this.__kh(bY)){return bY;
}bY=bY.parentNode;
}return this._body;
},__kj:function(ca){var cb=ca;

while(ca&&ca.nodeType===1){if(ca.getAttribute(l)==e){return null;
}ca=ca.parentNode;
}return cb;
},__kk:function(cc){while(cc&&cc.nodeType===1){var cd=cc.getAttribute(q);

if(cd!=null){return cd===e;
}cc=cc.parentNode;
}return true;
},_applyActive:function(ce,cf){if(cf){this.__jU(cf,ce,v,true);
}
if(ce){this.__jU(ce,cf,m,true);
}},_applyFocus:function(cg,ch){if(ch){this.__jU(ch,cg,a,true);
}
if(cg){this.__jU(cg,ch,b,true);
}if(ch){this.__jU(ch,cg,g,false);
}
if(cg){this.__jU(cg,ch,f,false);
}}},destruct:function(){this._stopObserver();
this._manager=this._window=this._document=this._root=this._body=this.__kl=null;
...
this.__km=d;
this.__kn=e||d.toHashCode();
this.useMarkup(d.getMarkup());
},members:{__kn:null,__km:null,getId:function(){return this.__kn;
},getDecorator:function(){return this.__km;
},resize:function(g,h){this.__km.resize(this.getDomElement(),g,h);
},tint:function(i){this.__km.tint(this.getDomElement(),i);
},getInsets:function(){return this.__km.getInsets();
...
qx.Class.define(b,{statics:{getApplication:function(){return this.__ko||null;
},ready:function(){if(this.__ko){return;
}
...
}},__kp:function(e){var j=this.__ko;

if(j){e.setReturnValue(j.close());
}},__kq:function(){var k=this.__ko;

if(k){k.terminate();
}}},defer:function(l){qx.event.Registration.addListener(window,f,l.ready,l);
qx.event.Registration.addListener(window,a,l.__kq,l);
qx.event.Registration.addListener(window,c,l.__kp,l);
}});
})();
...
qx.Class.define(d,{statics:{__kC:{"onload":true,"onpropertychange":true,"oninput":true,"onchange":true,"name":true,"type":true,"checked":true,"disabled":true},__kD:{},__kE:{},allowCreationWithMarkup:function(r){if(!r){r=window;
}var s=r.location.href;

if(qx.bom.Element.__kE[s]==undefined){try{r.document.createElement(f);
qx.bom.Element.__kE[s]=true;
}catch(e){qx.bom.Element.__kE[s]=false;
}}return qx.bom.Element.__kE[s];
},getHelperElement:function(t){if(!t){t=window;
}var v=t.location.href;

if(!qx.bom.Element.__kD[v]){var u=qx.bom.Element.__kD[v]=t.document.createElement(c);
if(qx.bom.client.Engine.WEBKIT){u.style.display=g;
t.document.body.appendChild(u);
}}return qx.bom.Element.__kD[v];
...
g.start();
this.__kG=g;
},events:{"interval":c},properties:{timeoutInterval:{check:e,init:100,apply:d}},members:{__kG:null,_applyTimeoutInterval:function(h){this.__kG.setInterval(h);
},_onInterval:function(){this.fireEvent(f);
}},destruct:function(){if(this.__kG){this.__kG.stop();
}this.__kG=null;
}});
})();
...
qx.Mixin.define(k,{properties:{contentPaddingTop:{check:p,init:0,apply:o,themeable:true},contentPaddingRight:{check:p,init:0,apply:o,themeable:true},contentPaddingBottom:{check:p,init:0,apply:o,themeable:true},contentPaddingLeft:{check:p,init:0,apply:o,themeable:true},contentPadding:{group:[e,a,d,c],mode:b,themeable:true}},members:{__kP:{contentPaddingTop:i,contentPaddingRight:h,contentPaddingBottom:m,contentPaddingLeft:f},__kQ:{contentPaddingTop:l,contentPaddingRight:n,contentPaddingBottom:g,contentPaddingLeft:j},_applyContentPadding:function(q,r,name){var s=this._getContentPaddingTarget();

if(q==null){var t=this.__kQ[name];
s[t]();
}else{var u=this.__kP[name];
s[u](q);
}}}});
})();
...
return o.text;
},"default":function(p){if(this.__kY(p)){return p.value.substring(p.selectionStart,p.selectionEnd);
...
if(this.__kY(t)){var x=t.selectionStart;
...
return w-(u.length-1);
},"default":function(z){if(this.__kY(z)){return z.selectionEnd-z.selectionStart;
}else{return this.get(z).length;
}}}),getStart:qx.core.Variant.select(k,{"mshtml":function(A){if(this.__kY(A)){var F=qx.bom.Range.get();
...
}},"gecko|webkit":function(J){if(this.__kY(J)){return J.selectionStart;
...
}}},"default":function(M){if(this.__kY(M)){return M.selectionStart;
}else{return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(M)).anchorOffset;
}}}),getEnd:qx.core.Variant.select(k,{"mshtml":function(N){if(this.__kY(N)){var S=qx.bom.Range.get();
...
}},"gecko|webkit":function(W){if(this.__kY(W)){return W.selectionEnd;
...
}}},"default":function(ba){if(this.__kY(ba)){return ba.selectionEnd;
}else{return qx.bom.Selection.getSelectionObject(qx.dom.Node.getDocument(ba)).focusOffset;
}}}),__kY:function(bb){return qx.dom.Node.isElement(bb)&&(bb.nodeName.toLowerCase()==h||bb.nodeName.toLowerCase()==g);
...
qx.Class.define(c,{statics:{__la:false,__lb:{},__lc:0,MAX_RETRIES:10,scheduleFlush:function(d){var self=qx.ui.core.queue.Manager;
self.__lb[d]=true;

if(!self.__la){self.__lh.schedule();
self.__la=true;
...
self.__lh.cancel();
var f=self.__lb;
self.__le(function(){while(f.visibility||f.widget||f.appearance||f.layout||f.element){if(f.widget){delete f.widget;
...
}}},function(){self.__la=false;
});
self.__le(function(){if(f.dispose){delete f.dispose;
qx.ui.core.queue.Dispose.flush();
}},function(){self.__ld=false;
});
self.__lc=0;
},__le:function(g,h){var self=qx.ui.core.queue.Manager;
...
if(self.__lc<=self.MAX_RETRIES){self.scheduleFlush();
}else{throw new Error("Fatal Error: Flush terminated "+(self.__lc-1)+" times in a row"+" due to exceptions in user code. The application has to be reloaded!");
}throw e;
}finally{h();
}},__lf:function(e){var i=qx.ui.core.queue.Manager;
if(e.getData()==a){i.PAUSE=true;

if(i.__lg){window.clearTimeout(i.__lg);
}i.__lg=window.setTimeout(function(){i.PAUSE=false;
i.__lg=null;
i.flush();
},500);
}else{i.flush();
}}},defer:function(j){j.__lh=new qx.util.DeferredCall(j.flush);
qx.html.Element._scheduleFlush=j.scheduleFlush;
qx.event.Registration.addListener(window,b,qx.bom.client.Feature.TOUCH?j.__lf:j.flush);
}});
})();
(function(){var c="qx.client",b="load",a="qx.io.ImageLoader";
qx.Bootstrap.define(a,{statics:{__li:{},__lj:{width:null,height:null},__lk:/\.(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(d){var e=this.__li[d];
return !!(e&&e.loaded);
},isFailed:function(f){var g=this.__li[f];
return !!(g&&g.failed);
},isLoading:function(h){var j=this.__li[h];
return !!(j&&j.loading);
},getFormat:function(k){var m=this.__li[k];
return m?m.format:null;
},getSize:function(n){var o=this.__li[n];
return o?
{width:o.width,height:o.height}:this.__lj;
},getWidth:function(p){var q=this.__li[p];
return q?q.width:null;
},getHeight:function(r){var s=this.__li[r];
return s?s.height:null;
},load:function(t,u,v){var w=this.__li[t];
...
var x=qx.lang.Function.listener(this.__ll,this,y,t);
y.onload=x;
y.onerror=x;
y.src=t;
w.element=y;
}},abort:function(z){var A=this.__li[z];
...
},__ll:qx.event.GlobalError.observeMethod(function(event,D,E){var F=this.__li[E];
if(event.type===b){F.loaded=true;
F.width=this.__lm(D);
F.height=this.__ln(D);
var G=this.__lk.exec(E);
...
}}),__lm:qx.core.Variant.select(c,{"gecko":function(I){return I.naturalWidth;
},"default":function(J){return J.width;
}}),__ln:qx.core.Variant.select(c,{"gecko":function(K){return K.naturalHeight;
...
this.__lw=qx.dev.StackTrace.getStackTrace();
},members:{__lw:null,getStackTrace:function(){return this.__lw;
}}});
})();
(function(){var i="error",h="initialized",g="loading",f="complete",e="webkit",d="qx.client",c="success",b="qx.io.part.Package",a="cached";
qx.Bootstrap.define(b,{construct:function(j,k,l){this.__lV=l?f:h;
this.__lW=j;
this.__lX=k;
},members:{__lV:null,__lW:null,__lX:null,__lY:null,__ma:null,__mb:null,__mc:null,getId:function(){return this.__lX;
},getReadyState:function(){return this.__lV;
},getUrls:function(){return this.__lW;
},saveClosure:function(m){if(this.__lV==i){return;
}this.__lY=m;

if(!this.__ma){this.execute();
}else{clearTimeout(this.__mb);
this.__lV=a;
this.__mc(this);
}},execute:function(){if(this.__lY){this.__lY();
delete this.__lY;
}
if(qx.$$packageData[this.__lX]){this.__me(qx.$$packageData[this.__lX]);
delete qx.$$packageData[this.__lX];
}this.__lV=f;
},loadClosure:function(n,self){if(this.__lV!==h){return;
}this.__ma=true;
this.__lV=g;
this.__mc=qx.Bootstrap.bind(n,self);
this.__md(this.__lW,function(){},function(){this.__lV=i;
n.call(self,this);
},this);
var o=this;
this.__mb=setTimeout(function(){o.__lV=i;
n.call(self,o);
},qx.Part.TIMEOUT);
},load:function(p,self){if(this.__lV!==h){return;
}this.__ma=false;
this.__lV=g;
this.__md(this.__lW,function(){this.__lV=f;
this.execute();
p.call(self,this);
},function(){this.__lV=i;
p.call(self,this);
},this);
},__md:function(q,r,s,self){if(q.length==0){r.call(self);
return;
}var u=0;
var self=this;
...
if(status!==c){if(self.__lV==g){clearTimeout(self.__mb);
return s.call(self);
}}
...
t(q.concat());
},__me:qx.$$loader.importPackageData}});
})();
...
},_registerEventChaining:function(k,l,name){if((k instanceof qx.core.Object)&&qx.Class.hasMixin(k.constructor,qx.data.marshal.MEventBubbling)){var m=qx.lang.Function.bind(this.__mt,this,name);
var n=k.addListener(c,m,this);
k.setUserData(d,n);
}if(l!=null&&l.getUserData&&l.getUserData(d)!=null){l.removeListenerById(l.getUserData(d));
}},__mt:function(name,e){var v=e.getData();
var r=v.value;
var p=v.old;
...
qx.Bootstrap.define(a,{construct:function(name,f,g){this.__mh=name;
this._readyState=e;
this._packages=f;
this._loader=g;
...
break;
}}},members:{_readyState:null,_loader:null,_packages:null,__mh:null,getReadyState:function(){return this._readyState;
},getName:function(){return this.__mh;
...
(function(){var e="change",d="__mi",c="qx.event.type.Data",b="qx.ui.form.MModelSelection",a="changeSelection";
qx.Mixin.define(b,{construct:function(){this.__mi=new qx.data.Array();
this.__mi.addListener(e,this.__ml,this);
this.addListener(a,this.__mk,this);
},events:{changeModelSelection:c},members:{__mi:null,__mj:false,__mk:function(){if(this.__mj){return;
...
}},__ml:function(){this.__mj=true;
var m=this.getSelectables(true);
var o=[];
var n=this.__mi.toArray();
...
if(!qx.lang.Array.equals(p,o)){this.__mk();
}},getModelSelection:function(){return this.__mi;
},setModelSelection:function(s){if(!s){this.__mi.removeAll();
return;
}{};
s.unshift(this.__mi.getLength());
s.unshift(0);
var t=this.__mi.splice.apply(this.__mi,s);
t.dispose();
}},destruct:function(){this._disposeObjects(d);
}});
})();
(function(){var g="Boolean",f="qx.ui.core.SingleSelectionManager",e="__mo",d="__mn",c="changeSelected",b="__mm",a="qx.event.type.Data";
qx.Class.define(f,{extend:qx.core.Object,construct:function(h){qx.core.Object.call(this);
{};
this.__mm=h;
},events:{"changeSelected":a},properties:{allowEmptySelection:{check:g,init:true,apply:e}},members:{__mn:null,__mm:null,getSelected:function(){return this.__mn;
},setSelected:function(j){if(!this.__mq(j)){throw new Error("Could not select "+j+", because it is not a child element!");
}this.__mp(j);
},resetSelected:function(){this.__mp(null);
},isSelected:function(k){if(!this.__mq(k)){throw new Error("Could not check if "+k+" is selected,"+" because it is not a child element!");
}return this.__mn===k;
},isSelectionEmpty:function(){return this.__mn==null;
},getSelectables:function(l){var m=this.__mm.getItems();
var n=[];

for(var i=0;i<m.length;i++){if(this.__mm.isItemSelectable(m[i])){n.push(m[i]);
}}if(!l){for(var i=n.length-1;i>=0;i--){if(!n[i].getEnabled()){n.splice(i,1);
}}}return n;
},__mo:function(o,p){if(!o){this.__mp(this.__mn);
}},__mp:function(q){var t=this.__mn;
var s=q;
...
},__mq:function(u){var v=this.__mm.getItems();

for(var i=0;i<v.length;i++){if(v[i]===u){return true;
}}return false;
}},destruct:function(){if(this.__mm.toHashCode){this._disposeObjects(b);
}else{this.__mm=null;
...
qx.Bootstrap.define(f,{construct:function(){this.__mu=qx.Bootstrap.bind(this.__mA,this);
this.__mv=document.createElement(d);
},members:{__mw:null,__mx:null,__my:null,__mz:null,__mu:null,__mv:null,load:function(p,q,r){if(this.__mw){throw new Error("Another request is still running!");
}this.__mw=true;
this.__mx=false;
...
this.__mz=r||window;
t.type=c;
t.onerror=t.onload=t.onreadystatechange=this.__mu;
t.src=p;
setTimeout(function(){s.appendChild(t);
},0);
},abort:function(){if(this.__mw){this.dispose(a);
}},dispose:function(status){if(this.__mx){return;
}this.__mx=true;
var v=this.__mv;
...
if(this.__my){if(qx.core.Variant.isSet(j,b)){var self=this;
setTimeout(qx.event.GlobalError.observeMethod(function(){self.__my.call(self.__mz,status);
delete self.__my;
}),0);
}else{this.__my.call(this.__mz,status);
delete this.__my;
}}},__mA:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(e){var w=this.__mv.readyState;
...
for(var i=0;i<g.length;i++){l.push(this.__mF[g[i]]);
...
}},members:{__mB:null,__mF:null,__mG:null,__mE:null,addToPackage:function(t){this.__mF.push(t);
},addClosurePackageListener:function(u,v){var w=u.getId();

if(!this.__mE[w]){this.__mE[w]=[];
}this.__mE[w].push(v);
},saveClosure:function(x,y){var A;

for(var i=0;i<this.__mF.length;i++){if(this.__mF[i].getId()==x){A=this.__mF[i];
break;
...
for(var i=0;i<B.length;i++){F.push(this.__mG[B[i]]);
}var E=0;
var D=function(){E+=1;
if(E>=F.length){var G=[];
...
for(var i=0;i<H.length;i++){this.__mG[H[i]].preload(function(){J++;

if(J>=H.length){var K=[];

for(var i=0;i<H.length;i++){K.push(this.__mG[H[i]].getReadyState());
}
if(I){I.call(self,K);
}}},this);
}},__mH:function(){var L=this.__mB.uris;
var M=[];

for(var i=0;i<L.length;i++){M.push(this.__mI(L[i]));
}return M;
...
},members:{__mJ:0,preload:function(h,self){var j=0;
var l=this;
...
}this.__mJ=this._packages.length;
...
}}if(this.__mJ<=0){this.__mK();
}},__mK:function(){for(var i=0;i<this._packages.length;i++){this._packages[i].execute();
...
(function(){var i="Integer",h="hovered",g="hover-button",f="interval",d="mouseover",c="mouseout",b="__mL",a="qx.ui.form.HoverButton";
...
this.__mL=new qx.event.AcceleratingTimer();
this.__mL.addListener(f,this._onInterval,this);
},properties:{appearance:{refine:true,init:g},interval:{check:i,init:80},firstInterval:{check:i,init:200},minTimer:{check:i,init:20},timerDecrease:{check:i,init:2}},members:{__mL:null,_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;
}this.__mL.set({interval:this.getInterval(),firstInterval:this.getFirstInterval(),minimum:this.getMinTimer(),decrease:this.getTimerDecrease()}).start();
this.addState(h);
},_onMouseOut:function(e){this.__mL.stop();
this.removeState(h);
...
},properties:{appearance:{refine:true,init:u},offset:{check:b,init:6,apply:v},orientation:{init:i,check:[i,g],apply:w}},members:{__mN:null,__mO:false,__mP:null,__mQ:null,__mR:null,__mS:null,__mT:null,__mM:null,__mU:null,_createChildControlImpl:function(F){var G;
...
if(!this.__mU){this.__mW(L);
}this.__mU.setOrientation(L);
...
this.__mX();
},_applyOffset:function(R,S){this.__mX();
},__mX:function(T){var U=this.getChildControl(j);
var Y=this.getOffset();
var ba=U.getBounds();
var X=U.getContainerElement().getDomElement();
if(!X){return;
}if(this.__mR){var W=null;
...
}this.__mU.setWidth(Y,W);
this.__mU.setLeft(Y,bb);
}}else{var V=null;
...
this.__mN=this.__mR?e.getDocumentLeft()-bh.left+bg.left:e.getDocumentTop()-bh.top+bg.top;
...
if(this.__mR){bk.setDomLeft(bl);
this.__mU.setStyle(n,(bl-this.getOffset())+h);
}else{bk.setDomTop(bl);
this.__mU.setStyle(s,(bl-this.getOffset())+h);
}e.stop();
...
this.releaseCapture();
e.stop();
},_finalizeSizes:function(){var bq=this.__mS;
var bn=this.__mT;
...
}else{if(this.__mR){br.setWidth(bq);
bo.setWidth(bn);
}else{br.setHeight(bq);
bo.setHeight(bn);
}}},__mY:function(){if(this.__mR){var bw=o,bD=z,bx=l,bB=this.__mP;
}else{var bw=q,bD=a,bx=B,bB=this.__mQ;
...
},__rk:function(){var bR=this.getRequest();
...
}},properties:{parseJson:{check:A,init:true}},members:{__na:false,__nb:0,__nc:null,getRequest:function(){if(this.__nc===null){this.__nc=qx.io.remote.transport.XmlHttp.createRequestObject();
this.__nc.onreadystatechange=qx.lang.Function.bind(this._onreadystatechange,this);
}return this.__nc;
},send:function(){this.__nb=0;
...
if(bi==4){if(!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(),bi,this.__na)){if(this.getState()===c){this.setState(f);
}this.failed();
return;
}}while(this.__nb<bi){this.setState(qx.io.remote.Exchange._nativeMap[++this.__nb]);
...
if(qx.io.remote.Exchange.wasSuccessful(bD,bE,this.__na)){try{bF=this.getRequest().responseXML;
...
this.__nd=j;
},statics:{__ne:null,createModel:function(k,l){if(this.__ne===null){this.__ne=new qx.data.marshal.Json();
}this.__ne.toClass(k,l);
return this.__ne.toModel(k);
}},members:{__nd:null,__nf:function(m){var n=[];
...
if(this.__nd&&this.__nd.getModelClass&&this.__nd.getModelClass(s)!=null){return;
}for(var t in p){this.toClass(p[t],q);
}if(qx.Class.isDefined(h+s)){return;
}var z={};
var y={__ng:this.__ng};
...
if(q){z[t].apply=a;
}if(this.__nd&&this.__nd.getValidationRule){var v=this.__nd.getValidationRule(s,t);

if(v){z[t].validate=f+t;
y[f+t]=v;
}}}if(this.__nd&&this.__nd.getModelSuperClass){var x=this.__nd.getModelSuperClass(s)||qx.core.Object;
}else{var x=qx.core.Object;
}var u=[];

if(this.__nd&&this.__nd.getModelMixins){var w=this.__nd.getModelMixins(s);
if(!qx.lang.Type.isArray(w)){if(w!=null){u=[w];
}}}if(q){u.push(qx.data.marshal.MEventBubbling);
}var r={extend:x,include:u,properties:z,members:y,destruct:this.__nh};
qx.Class.define(h+s,r);
},__nh:function(){var A=qx.util.PropertyUtil.getAllProperties(this.constructor);

for(var B in A){this.__ng(this.get(A[B].name));
}},__ng:function(C){if(!(C instanceof qx.core.Object)){return ;
}if(qx.Class.implementsInterface(C,qx.data.IListData)){for(var i=0;i<C.getLength();i++){this.__ng(C.getItem(i));
}}C.dispose();
},__ni:function(D){var E;
if(this.__nd&&this.__nd.getModelClass){E=this.__nd.getModelClass(D);
}
...
}else if(qx.lang.Type.isObject(G)){var H=this.__nf(G);
var L=this.__ni(H);
...
s.addListener(k,this.__nk(q),this);
s.addListener(c,qx.lang.Function.bind(this.__nj,this,q),this);
},__nj:function(u,e){if(e.getData()==b||e.getData()==g||e.getData()==m){u.setState(l);
}},__nk:function(v){return function(e){var w=e.getData();
if(w==m){v.setState(l);
return;
}v.setArticles(w);
v.setState(k);
...
(function(){var v="single",u="Boolean",t="one",s="changeSelection",r="mouseup",q="mousedown",p="losecapture",o="multi",n="_applyQuickSelection",m="mouseover",d="_applySelectionMode",l="_applyDragSelection",h="__nl",c="qx.ui.core.MMultiSelectionHandling",b="removeItem",g="keypress",f="qx.event.type.Data",j="addItem",a="additive",k="mousemove";
qx.Mixin.define(c,{construct:function(){var x=this.SELECTION_MANAGER;
var w=this.__nl=new x(this);
...
},events:{"changeSelection":f},properties:{selectionMode:{check:[v,o,a,t],init:v,apply:d},dragSelection:{check:u,init:false,apply:l},quickSelection:{check:u,init:false,apply:n}},members:{__nl:null,selectAll:function(){this.__nl.selectAll();
...
}return this.__nl.isItemSelected(y);
...
}this.__nl.removeItem(A);
},selectRange:function(B,C){this.__nl.selectItemRange(B,C);
},resetSelection:function(){this.__nl.clearSelection();
...
if(!qx.lang.Array.equals(E,D)){this.__nl.replaceSelection(D);
}}},getSelection:function(){return this.__nl.getSelection();
},getSortedSelection:function(){return this.__nl.getSortedSelection();
},isSelectionEmpty:function(){return this.__nl.isSelectionEmpty();
},getSelectionContext:function(){return this.__nl.getSelectionContext();
},_getManager:function(){return this.__nl;
},getSelectables:function(F){return this.__nl.getSelectables(F);
},invertSelection:function(){this.__nl.invertSelection();
},_getLeadItem:function(){var G=this.__nl.getMode();

if(G===v||G===t){return this.__nl.getSelectedItem();
}else{return this.__nl.getLeadItem();
}},_applySelectionMode:function(H,I){this.__nl.setMode(H);
},_applyDragSelection:function(J,K){this.__nl.setDrag(J);
},_applyQuickSelection:function(L,M){this.__nl.setQuick(L);
...
this.addListener(c,this.__nm,this);
...
},__nm:function(e){var m=e.getOldData()[0];
var n=e.getData()[0];
...
qx.Class.define(a,{type:b,extend:qx.core.Object,implement:[qx.application.IApplication],include:qx.locale.MTranslation,members:{__nn:null,_createRootWidget:function(){throw new Error("Abstract method call");
},getRoot:function(){return this.__nn;
},main:function(){qx.theme.manager.Meta.getInstance().initialize();
qx.ui.tooltip.Manager.getInstance();
this.__nn=this._createRootWidget();
},finalize:function(){this.render();
},render:function(){qx.ui.core.queue.Manager.flush();
},close:function(c){},terminate:function(){}},destruct:function(){this.__nn=null;
}});
})();
(function(){var i="Number",h="_applyInsets",g="abstract",f="insetRight",e="insetTop",d="insetBottom",c="qx.ui.decoration.Abstract",b="shorthand",a="insetLeft";
qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.decoration.IDecorator],type:g,properties:{insetLeft:{check:i,nullable:true,apply:h},insetRight:{check:i,nullable:true,apply:h},insetBottom:{check:i,nullable:true,apply:h},insetTop:{check:i,nullable:true,apply:h},insets:{group:[e,f,d,a],mode:b}},members:{__nR:null,_getDefaultInsets:function(){throw new Error("Abstract method called.");
},_isInitialized:function(){throw new Error("Abstract method called.");
},_resetInsets:function(){this.__nR=null;
},getInsets:function(){if(this.__nR){return this.__nR;
}var j=this._getDefaultInsets();
return this.__nR={left:this.getInsetLeft()==null?j.left:this.getInsetLeft(),right:this.getInsetRight()==null?j.right:this.getInsetRight(),bottom:this.getInsetBottom()==null?j.bottom:this.getInsetBottom(),top:this.getInsetTop()==null?j.top:this.getInsetTop()};
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__no:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__no;
},getMarkup:function(){if(this.__no){return this.__no;
...
this.__no=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__no;
...
},_onMouseWheel:function(e){var ba=e.getWheelDelta()>0?1:-1;
this.slideBy(ba*this.getSingleStep());
e.stop();
},_onKeyPress:function(e){var bc=this.getOrientation()===j;
var bb=bc?M:s;
var forward=bc?B:r;

switch(e.getKeyIdentifier()){case forward:this.slideForward();
break;
case bb:this.slideBack();
break;
...
},_onMouseDown:function(e){if(this.__nv){return;
}var bf=this.__nF;
var bd=this.getChildControl(k);
var be=bf?f:d;
var bh=bf?e.getDocumentLeft():e.getDocumentTop();
var bi=this.__ns=qx.bom.element.Location.get(this.getContentElement().getDomElement())[be];
var bg=this.__nt=qx.bom.element.Location.get(bd.getContainerElement().getDomElement())[be];

if(e.getTarget()===bd){this.__nv=true;

if(!this.__nB){this.__nB=new qx.event.Timer(100);
this.__nB.addListener(U,this._fireValue,this);
}this.__nB.start();
this.__nw=bh+bi-bg;
bd.addState(b);
}else{this.__nx=true;
...
this.__nG(e);
this._onInterval();
if(!this.__nA){this.__nA=new qx.event.Timer(100);
this.__nA.addListener(U,this._onInterval,this);
}this.__nA.start();
}this.addListener(T,this._onMouseMove);
this.capture();
e.stopPropagation();
},_onMouseUp:function(e){if(this.__nv){this.releaseCapture();
delete this.__nv;
this.__nB.stop();
this._fireValue();
delete this.__nw;
this.getChildControl(k).removeState(b);
if(e.getType()===c){var bk;
var bl;
var bj;

if(this.__nF){bk=e.getDocumentLeft()-(this._valueToPosition(this.getValue())+this.__ns);
bj=qx.bom.element.Location.get(this.getContentElement().getDomElement())[d];
bl=e.getDocumentTop()-(bj+this.getChildControl(k).getBounds().top);
}else{bk=e.getDocumentTop()-(this._valueToPosition(this.getValue())+this.__ns);
bj=qx.bom.element.Location.get(this.getContentElement().getDomElement())[f];
bl=e.getDocumentLeft()-(bj+this.getChildControl(k).getBounds().left);
}
if(bl<0||bl>this.__nu||bk<0||bk>this.__nu){this.getChildControl(k).removeState(g);
}}}else if(this.__nx){this.__nA.stop();
this.releaseCapture();
delete this.__nx;
delete this.__ny;
delete this.__nz;
...
}},_onMouseMove:function(e){if(this.__nv){var bn=this.__nF?e.getDocumentLeft():e.getDocumentTop();
var bm=bn-this.__nw;
this.slideTo(this._positionToValue(bm));
}else if(this.__nx){this.__nG(e);
}e.stopPropagation();
},_onInterval:function(e){var bo=this.getValue()+(this.__ny*this.getPageStep());
if(bo<this.getMinimum()){bo=this.getMinimum();
}else if(bo>this.getMaximum()){bo=this.getMaximum();
}var bp=this.__ny==-1;

if((bp&&bo<=this.__nz)||(!bp&&bo>=this.__nz)){bo=this.__nz;
}this.slideTo(bo);
},_onUpdate:function(e){var br=this.getInnerSize();
var bs=this.getChildControl(k).getBounds();
var bq=this.__nF?z:u;
this._updateKnobSize();
this.__nE=br[bq]-bs[bq];
this.__nu=bs[bq];
this._updateKnobPosition();
},__nF:false,__nE:0,__nG:function(e){var bt=this.__nF;
var bA=bt?e.getDocumentLeft():e.getDocumentTop();
var bC=this.__ns;
var bu=this.__nt;
var bE=this.__nu;
var bB=bA-bC;
...
if(bA>=bu){bB-=bE;
}var by=this._positionToValue(bB);
var bv=this.getMinimum();
var bw=this.getMaximum();

if(by<bv){by=bv;
}else if(by>bw){by=bw;
}else{var bz=this.getValue();
var bx=this.getPageStep();
var bD=this.__ny<0?H:v;
by=bz+(Math[bD]((by-bz)/bx)*bx);
}if(this.__nz==null||(this.__ny==-1&&by<=this.__nz)||(this.__ny==1&&by>=this.__nz)){this.__nz=by;
}},_positionToValue:function(bF){var bG=this.__nE;
if(bG==null||bG==0){return 0;
}var bI=bF/bG;

if(bI<0){bI=0;
}else if(bI>1){bI=1;
}var bH=this.getMaximum()-this.getMinimum();
return this.getMinimum()+Math.round(bH*bI);
},_valueToPosition:function(bJ){var bK=this.__nE;
...
},_setKnobPosition:function(bN){var bO=this.getChildControl(k).getContainerElement();

if(this.__nF){bO.setStyle(f,bN+a,true);
}else{bO.setStyle(d,bN+a,true);
...
if(bP==null){return;
}if(this.__nF){this.getChildControl(k).setWidth(Math.round(bQ*bP.width));
}else{this.getChildControl(k).setHeight(Math.round(bQ*bP.height));
...
},_applyOrientation:function(bT,bU){var bV=this.getChildControl(k);
this.__nF=bT===j;
if(this.__nF){this.removeState(i);
bV.removeState(i);
this.addState(j);
bV.addState(j);
bV.setLayoutProperties({top:0,right:null,bottom:0});
}else{this.removeState(j);
bV.removeState(j);
this.addState(i);
bV.addState(i);
bV.setLayoutProperties({right:0,bottom:null,left:0});
}this._updateKnobPosition();
},_applyKnobFactor:function(bW,bX){if(bW!=null){this._updateKnobSize();
}else{if(this.__nF){this.getChildControl(k).resetWidth();
}else{this.getChildControl(k).resetHeight();
}}},_applyValue:function(bY,ca){if(bY!=null){this._updateKnobPosition();

if(this.__nv){this.__nD=[bY,ca];
}else{this.fireEvent(V,qx.event.type.Data,[bY,ca]);
}}else{this.resetValue();
}},_fireValue:function(){if(!this.__nD){return;
}var cb=this.__nD;
this.__nD=null;
this.fireEvent(V,qx.event.type.Data,cb);
},_applyMinimum:function(cc,cd){if(this.getValue()<cc){this.setValue(cc);
}this._updateKnobPosition();
},_applyMaximum:function(ce,cf){if(this.getValue()>ce){this.setValue(ce);
}this._updateKnobPosition();
}}});
})();
...
}},properties:{baseImage:{check:p,nullable:true,apply:r}},members:{__np:null,__nq:null,__nr:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__np;
},getMarkup:function(){if(this.__np){return this.__np;
...
D.push(b);
return this.__np=D.join(o);
},resize:function(E,F,G){var H=this.__nr;
...
var O=Q[1];
var N=Q[2];
var M=this.__nq={tl:O+u+N,t:O+v+N,tr:O+d+N,bl:O+m+N,b:O+q+N,br:O+w+N,l:O+c+N,c:O+k+N,r:O+t+N};
this.__nr=this._computeEdgeSizes(M);
...
}},destruct:function(){this.__np=this.__nq=this.__nr=null;
}});
})();
...
this.addListener(p,function(){this.__qC={"x":0,"y":0};
},this);
this.__qC={};
this.__qD={};
}},properties:{appearance:{refine:true,init:v},width:{refine:true,init:100},height:{refine:true,init:200},scrollbarX:{check:[h,d,D],init:h,themeable:true,apply:c},scrollbarY:{check:[h,d,D],init:h,themeable:true,apply:c},scrollbar:{group:[w,m]}},members:{__qC:null,__qD:null,_createChildControlImpl:function(F){var G;
...
if(Y&&X){if(this.__qC[U]==0){var W=0;
}else{var W=-(e[b+V]()-this.__qC[U]);
}this.__qC[U]=e[b+V]();
X.scrollBy(W);
if(this.__qD[U]){clearTimeout(this.__qD[U]);
this.__qD[U]=null;
}this.__qD[U]=setTimeout(qx.lang.Function.bind(function(ba){this.__qE(ba,U);
},this,W),100);
}},__qE:function(bb,bc){this.__qD[bc]=null;
var be=this._isChildControlVisible(f+bc);

if(bb==0||!be){return;
}if(bb>0){bb=Math.max(0,bb-3);
}else{bb=Math.min(0,bb+3);
}this.__qD[bc]=setTimeout(qx.lang.Function.bind(function(bf,bg){this.__qE(bf,bg);
},this,bb,bc),20);
...
(function(){var o="one",n="single",m="selected",k="additive",j="multi",h="PageUp",g="under",f="Left",d="lead",c="Down",M="Up",L="Boolean",K="PageDown",J="anchor",I="End",H="Home",G="Right",F="right",E="click",D="above",v="left",w="Escape",t="__oy",u="A",r="Space",s="_applyMode",p="interval",q="changeSelection",x="qx.event.type.Data",y="quick",A="key",z="abstract",C="drag",B="qx.ui.core.selection.Abstract";
qx.Class.define(B,{type:z,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__ov={};
},events:{"changeSelection":x},properties:{mode:{check:[n,j,k,o],init:n,apply:s},drag:{check:L,init:false},quick:{check:L,init:false}},members:{__ow:0,__ox:0,__oy:null,__oz:null,__oA:null,__oB:null,__oC:null,__oD:null,__oE:null,__oF:null,__oG:null,__oH:null,__oI:null,__oJ:null,__oK:null,__oL:null,__oM:null,__ov:null,__oN:null,__oO:null,_userInteraction:false,getSelectionContext:function(){return this.__oL;
...
},getSelection:function(){return qx.lang.Object.getValues(this.__ov);
},getSortedSelection:function(){var bc=this.getSelectables();
var bb=qx.lang.Object.getValues(this.__ov);
bb.sort(function(a,b){return bc.indexOf(a)-bc.indexOf(b);
});
return bb;
},isItemSelected:function(bd){var be=this._selectableToHashCode(bd);
return this.__ov[be]!==undefined;
},isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__ov);
...
},_setLeadItem:function(bh){var bi=this.__oM;
...
},_setAnchorItem:function(bj){var bk=this.__oN;
...
if(this.isItemSelected(bJ)&&!bI&&!bL&&!this.getDrag()){this.__oO=bJ;
this._userInteraction=false;
return;
}else{this.__oO=null;
...
if(this.getDrag()&&bM!==n&&bM!==o&&!bI&&!bL){this.__oC=this._getLocation();
this.__oz=this._getScroll();
this.__oD=event.getDocumentLeft()+this.__oz.left;
this.__oE=event.getDocumentTop()+this.__oz.top;
this.__oF=true;
this._capture();
}this._fireChange(E);
this._userInteraction=false;
...
if(!bQ&&!bN&&this.__oO){var bO=this._getSelectableFromMouseEvent(event);
...
var bS=this.__oG+this.__oz.left;

if(bS>this.__oD){this.__oI=1;
}else if(bS<this.__oD){this.__oI=-1;
}else{this.__oI=0;
}var bR=this.__oH+this.__oz.top;

if(bR>this.__oE){this.__oJ=1;
}else if(bR<this.__oE){this.__oJ=-1;
}else{this.__oJ=0;
}var location=this.__oC;

if(this.__oG<location.left){this.__ow=this.__oG-location.left;
}else if(this.__oG>location.right){this.__ow=this.__oG-location.right;
}else{this.__ow=0;
}
if(this.__oH<location.top){this.__ox=this.__oH-location.top;
}else if(this.__oH>location.bottom){this.__ox=this.__oH-location.bottom;
}else{this.__ox=0;
}if(!this.__oy){this.__oy=new qx.event.Timer(100);
this.__oy.addListener(p,this._onInterval,this);
}this.__oy.start();
this._autoSelect();
...
}if(this.__oK){this._fireChange(E);
}delete this.__oF;
delete this.__oA;
delete this.__oB;
this._releaseCapture();
if(this.__oy){this.__oy.stop();
}},_onInterval:function(e){this._scrollBy(this.__ow,this.__ox);
this.__oz=this._getScroll();
this._autoSelect();
},_autoSelect:function(){var cd=this._getDimension();
var bV=Math.max(0,Math.min(this.__oG-this.__oC.left,cd.width))+this.__oz.left;
var bU=Math.max(0,Math.min(this.__oH-this.__oC.top,cd.height))+this.__oz.top;
if(this.__oA===bV&&this.__oB===bU){return;
}this.__oA=bV;
this.__oB=bU;
...
},__oP:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){this._userInteraction=true;
var cm,cl;
...
}},__oQ:function(cD){var cF={};
var cE;

for(var i=0,l=cD.length;i<l;i++){cE=cD[i];
cF[this._selectableToHashCode(cE)]=cE;
}return cF;
},_getSelectedItem:function(){for(var cG in this.__ov){return this.__ov[cG];
}return null;
},_setSelectedItem:function(cH){if(this._isSelectable(cH)){var cI=this.__ov;
...
this.__oK=true;
this._fireChange();
},_fireChange:function(cY){if(this.__oK){this.__oL=cY||null;
this.fireDataEvent(q,this.getSelection());
delete this.__oK;
}}},destruct:function(){this._disposeObjects(t);
this.__ov=this.__oO=this.__oN=null;
this.__oM=null;
}});
})();
...
this.__nO=g;
},members:{__nO:null,_isSelectable:function(h){return this._isItemSelectable(h)&&h.getLayoutParent()===this.__nO;
},_selectableToHashCode:function(j){return j.$$hash;
},_styleSelectable:function(k,m,n){n?k.addState(m):k.removeState(m);
},_capture:function(){this.__nO.capture();
},_releaseCapture:function(){this.__nO.releaseCapture();
},_isItemSelectable:function(o){if(this._userInteraction){return o.isVisible()&&o.isEnabled();
}else{return o.isVisible();
}},_getWidget:function(){return this.__nO;
},_getLocation:function(){var p=this.__nO.getContentElement().getDomElement();
return p?qx.bom.element.Location.get(p):null;
},_getDimension:function(){return this.__nO.getInnerSize();
...
},_scrollBy:function(u,v){},_scrollItemIntoView:function(w){this.__nO.scrollChildIntoView(w);
},getSelectables:function(x){var y=false;

if(!x){y=this._userInteraction;
this._userInteraction=true;
}var B=this.__nO.getChildren();
var z=[];
var A;
...
},_getFirstSelectable:function(){var I=this.__nO.getChildren();

for(var i=0,l=I.length;i<l;i++){if(this._isItemSelectable(I[i])){return I[i];
}}return null;
},_getLastSelectable:function(){var J=this.__nO.getChildren();

for(var i=J.length-1;i>0;i--){if(this._isItemSelectable(J[i])){return J[i];
}}return null;
},_getRelatedSelectable:function(K,L){var O=this.__nO.getOrientation()===f;
var N=this.__nO.getChildren();
var M=N.indexOf(K);
var P;
...
(function(){var m="horizontal",k="qx.event.type.Data",j="vertical",h="",g="qx.ui.form.List",f="Boolean",d="one",c="addChildWidget",b="_applySpacing",a="Enter",y="Integer",x="action",w="keyinput",v="addItem",u="removeChildWidget",t="_applyOrientation",s="single",r="keypress",q="list",p="pane",n="removeItem",o="__nH";
...
var content=this.__nH;
content.setLayout(D);
content.setAllowGrowX(!C);
content.setAllowGrowY(C);
this._applySpacing(this.getSpacing());
},_applySpacing:function(E,F){this.__nH.getLayout().setSpacing(E);
...
if(!(H===s||H===d)){return;
}if(((new Date).valueOf()-this.__nJ)>1000){this.__nI=h;
}this.__nI+=e.getChar();
var I=this.findItemByLabelFuzzy(this.__nI);
if(I){this.setSelection([I]);
}this.__nJ=(new Date).valueOf();
...
(function(){var m="open",k="auto",j="middle",h="String",g="icon",f="label",d="changeOpen",c="excluded",b="visible",a="opened",G="always",F="qx.ui.tree.AbstractTreeItem",E="_applyIconOpened",D="Boolean",C="Integer",B="_applyIndent",A="changeOpenSymbolMode",z="_applyOpenSymbolMode",y="__pj",x="__pm",t="resize",u="",r="removeItem",s="addItem",p="__pi",q="abstract",n="never",o="_applyIcon",v="_applyOpen",w="_applyLabel";
qx.Class.define(F,{extend:qx.ui.core.Widget,type:q,include:[qx.ui.form.MModelProperty],implement:[qx.ui.form.IModel],construct:function(){qx.ui.core.Widget.call(this);
this.__pi=[];
this._setLayout(new qx.ui.layout.HBox());
this._addWidgets();
this.initOpen();
},properties:{open:{check:D,init:false,event:d,apply:v},openSymbolMode:{check:[G,n,k],init:k,event:A,apply:z},indent:{check:C,init:19,apply:B,themeable:true},parent:{check:F,nullable:true},icon:{check:h,apply:o,nullable:true,themeable:true},iconOpened:{check:h,apply:E,nullable:true,themeable:true},label:{check:h,apply:w,init:u}},members:{__pi:null,__pj:null,__pk:null,__pl:null,__pm:null,__pn:null,_addWidgets:function(){throw new Error("Abstract method call.");
},_createChildControlImpl:function(H){var I;

switch(H){case f:I=new qx.ui.basic.Label().set({alignY:j,value:this.getLabel()});
break;
case g:I=new qx.ui.basic.Image().set({alignY:j,source:this.getIcon()});
break;
case m:I=new qx.ui.tree.FolderOpenButton().set({alignY:j});
I.addListener(d,this._onChangeOpen,this);
I.addListener(t,this._updateIndent,this);
break;
...
},addWidget:function(L,M){this._add(L,M);
},addSpacer:function(){if(!this.__pm){this.__pm=new qx.ui.core.Spacer();
}else{this._remove(this.__pm);
}this._add(this.__pm);
},addOpenButton:function(){this._add(this.getChildControl(m));
},_onChangeOpen:function(e){if(this.isOpenable()){this.setOpen(e.getData());
}},addIcon:function(){var N=this.getChildControl(g);

if(this.__pl){this._remove(N);
}this._add(N);
this.__pl=true;
},addLabel:function(O){var P=this.getChildControl(f);

if(this.__pk){this._remove(P);
}
if(O){this.setLabel(O);
}else{P.setValue(this.getLabel());
}this._add(P);
this.__pk=true;
},addState:function(Q){qx.ui.core.Widget.prototype.addState.call(this,Q);
var S=this._getChildren();

for(var i=0,l=S.length;i<l;i++){var R=S[i];

if(R.addState){S[i].addState(Q);
}}},removeState:function(T){qx.ui.core.Widget.prototype.removeState.call(this,T);
var V=this._getChildren();

for(var i=0,l=V.length;i<l;i++){var U=V[i];

if(U.addState){V[i].removeState(T);
}}},_applyIcon:function(W,X){if(!this.isOpen()){this.__po(W);
}},_applyIconOpened:function(Y,ba){if(this.isOpen()){this.__po(Y);
}},_applyLabel:function(bb,bc){var bd=this.getChildControl(f,true);

if(bd){bd.setValue(bb);
}},_applyOpen:function(be,bf){if(this.hasChildren()){this.getChildrenContainer().setVisibility(be?b:c);
}var open=this.getChildControl(m,true);

if(open){open.setOpen(be);
}var bg;
if(be){bg=this.getIconOpened();
}else{bg=this.getIcon();
}
if(bg){this.__po(bg);
}be?this.addState(a):this.removeState(a);
},__po:function(bh){var bi=this.getChildControl(g,true);

if(bi){bi.setSource(bh);
}},isOpenable:function(){var bj=this.getOpenSymbolMode();
return (bj===G||bj===k&&this.hasChildren());
},_shouldShowOpenSymbol:function(){var open=this.getChildControl(m,true);

if(!open){return false;
}var bk=this.getTree();

if(!bk.getRootOpenClose()){if(bk.getHideRoot()){if(bk.getRoot()==this.getParent()){return false;
}}else{if(bk.getRoot()==this){return false;
}}}return this.isOpenable();
},_applyOpenSymbolMode:function(bl,bm){this._updateIndent();
...
if(this.__pm){this.__pm.setWidth((this.getLevel()+1)*this.getIndent()-bo);
...
},getChildrenContainer:function(){if(!this.__pj){this.__pj=new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({visibility:this.isOpen()?b:c});
}return this.__pj;
},hasChildrenContainer:function(){return this.__pj;
},getParentChildrenContainer:function(){if(this.getParent()){return this.getParent().getChildrenContainer();
}else if(this.getLayoutParent()){return this.getLayoutParent();
}else{return null;
}},getChildren:function(){return this.__pi;
},hasChildren:function(){return this.__pi?this.__pi.length>0:false;
},getItems:function(bu,bv,bw){if(bw!==false){var bx=[];
}else{var bx=[this];
}var bA=this.hasChildren()&&(bv!==false||this.isOpen());

if(bA){var bz=this.getChildren();

if(bu===false){bx=bx.concat(bz);
}else{for(var i=0,by=bz.length;i<by;i++){bx=bx.concat(bz[i].getItems(bu,bv,false));
}}}return bx;
},recursiveAddToWidgetQueue:function(){var bB=this.getItems(true,true,false);

for(var i=0,l=bB.length;i<l;i++){qx.ui.core.queue.Widget.add(bB[i]);
}},__pp:function(){if(this.getParentChildrenContainer()){this.getParentChildrenContainer()._addAfter(this.getChildrenContainer(),this);
...
bG.fireNonBubblingEvent(s,qx.event.type.Data,[bH]);
}}
if(bG){qx.ui.core.queue.Widget.add(this);
}},addAt:function(bI,bJ){{};

if(bJ==this.__pi.length){this.add(bI);
return;
}var bN=bI.getParent();
...
}qx.lang.Array.insertAt(this.__pi,bI,bJ);

if(!bM){this.__pp();
}
if(this.getTree()){bI.recursiveAddToWidgetQueue();
qx.ui.core.queue.Widget.add(this);
}},addBefore:function(bO,bP){{};
var bQ=bO.getParent();

if(bQ){bQ.remove(bO);
}this.addAt(bO,this.__pi.indexOf(bP));
},addAfter:function(bR,bS){{};
var bT=bR.getParent();

if(bT){bT.remove(bR);
}this.addAt(bR,this.__pi.indexOf(bS)+1);
},addAtBegin:function(bU){this.addAt(bU,0);
},remove:function(bV){for(var i=0,l=arguments.length;i<l;i++){var ca=arguments[i];

if(this.__pi.indexOf(ca)==-1){this.warn("Cannot remove treeitem '"+ca+"'. It is not a child of this tree item.");
return;
}var bW=this.getChildrenContainer();

if(ca.hasChildrenContainer()){var bY=ca.getChildrenContainer();

if(bW.getChildren().indexOf(bY)>=0){bW.remove(bY);
}}qx.lang.Array.remove(this.__pi,ca);
ca.setParent(null);
bW.remove(ca);
}var bX=this.getTree();

if(bX){bX.fireNonBubblingEvent(r,qx.event.type.Data,[ca]);
}qx.ui.core.queue.Widget.add(this);
},removeAt:function(cb){var cc=this.__pi[cb];

if(cc){this.remove(cc);
}},removeAll:function(){for(var i=this.__pi.length-1;i>=0;i--){this.remove(this.__pi[i]);
}}},destruct:function(){this._disposeArray(p);
this._disposeObjects(x,y);
}});
})();
...
(function(){var n="pressed",m="abandoned",l="Integer",k="hovered",j="qx.event.type.Event",i="Enter",h="Space",g="press",f="qx.ui.form.RepeatButton",d="release",a="interval",c="__nK",b="execute";
...
this.__nK.addListener(a,this._onInterval,this);
},events:{"execute":j,"press":j,"release":j},properties:{interval:{check:l,init:100},firstInterval:{check:l,init:500},minTimer:{check:l,init:20},timerDecrease:{check:l,init:2}},members:{__nL:null,__nK:null,press:function(){if(this.isEnabled()){if(!this.hasState(n)){this.__nM();
}this.removeState(m);
this.addState(n);
}},release:function(q){if(!this.isEnabled()){return;
}if(this.hasState(n)){if(!this.__nL){this.execute();
}}this.removeState(n);
this.removeState(m);
this.__nN();
...
if(this.hasState(n)&&!this.__nL){this.execute();
}}this.__nN();
e.stopPropagation();
},_onKeyUp:function(e){switch(e.getKeyIdentifier()){case i:case h:if(this.hasState(n)){if(!this.__nL){this.execute();
}this.removeState(n);
this.removeState(m);
e.stopPropagation();
this.__nN();
...
e.stopPropagation();
this.__nM();
}},_onInterval:function(e){this.__nL=true;
this.fireEvent(b);
},__nM:function(){this.fireEvent(g);
this.__nL=false;
...
this.removeState(m);
this.addState(n);
},__nN:function(){this.fireEvent(d);
this.__nK.stop();
this.removeState(m);
this.removeState(n);
...
(function(){var t="configured",s="completed",r="changeState",q="changeModel",p="qx.data.store.Json",o="GET",n="_marshaler",m="sending",l="application/json",k="changeUrl",d="failed",j="loaded",g="timeout",c="queued",b="__nP",f="String",e="aborted",h="_applyUrl",a="receiving",i="qx.event.type.Data";
...
}},events:{"loaded":i},properties:{model:{nullable:true,event:q},state:{check:[t,c,m,a,s,e,g,d],init:t,event:r},url:{check:f,apply:h,event:k,nullable:true}},members:{__nP:null,_delegate:null,_applyUrl:function(w,x){if(w!=null){this._createRequest(w);
}},_createRequest:function(y){this.__nP=new qx.io.remote.Request(y,o,l);
this.__nP.addListener(s,this.__nQ,this);
var z=this._delegate;

if(z&&qx.lang.Type.isFunction(z.configureRequest)){this._delegate.configureRequest(this.__nP);
}this.__nP.addListener(r,function(A){this.setState(A.getData());
},this);
this.__nP.send();
},__nQ:function(B){var D=B.getContent();
...
}},__nS:function(t){while(!(t instanceof qx.ui.menu.Menu)){t=t.getLayoutParent();
}return t;
...
},properties:{callbackParam:{check:a,nullable:false}},members:{__nT:null,_createRequest:function(m){if(this.__nT){this.__nT.dispose();
}this.__nT=new qx.io.ScriptLoader();
var o=this._delegate;

if(o&&qx.lang.Type.isFunction(o.configureRequest)){this._delegate.configureRequest(this.__nT);
}var n=m.indexOf(i)==-1?i:h;
m+=n+this.getCallbackParam()+c;
var p=parseInt(this.toHashCode());
qx.data.store.Jsonp[p]=this;
m+=f+p+e;
this.__nT.load(m,function(q){delete this[p];
},this);
},callback:function(r){if(this.isDisposed()){return;
}this.__nU(r);
},__nU:function(s){if(s==undefined){this.setState(d);
return;
...
}},properties:{backgroundColor:{check:b,nullable:true,apply:c}},members:{__nV:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__nV;
},getMarkup:function(){if(this.__nV){return this.__nV;
...
(function(){var i="qx.ui.window.Window",h="changeModal",g="changeVisibility",f="changeActive",d="_applyActiveWindow",c="__nW",b="__nX",a="qx.ui.window.MDesktop";
qx.Mixin.define(a,{properties:{activeWindow:{check:i,apply:d,init:null,nullable:true}},members:{__nW:null,__nX:null,getWindowManager:function(){if(!this.__nX){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());
}return this.__nX;
},supportsMaximize:function(){return true;
},setWindowManager:function(j){if(this.__nX){this.__nX.setDesktop(null);
}j.setDesktop(this);
this.__nX=j;
...
this.getWindowManager().updateStack();
},getWindows:function(){if(!this.__nW){this.__nW=[];
}return this.__nW;
...
}this.__nY=qx.bom.Iframe.create({id:I,name:I,src:K});
qx.bom.element.Style.set(this.__nY,z,A);
this.__oa=qx.bom.Element.create(o,{id:J,name:J,target:I});
qx.bom.element.Style.set(this.__oa,z,A);
qx.dom.Element.insertEnd(this.__oa,qx.dom.Node.getBodyElement(document));
this.__ob=qx.bom.Element.create(c,{id:b,name:b});
qx.dom.Element.insertEnd(this.__ob,this.__oa);
qx.dom.Element.insertEnd(this.__nY,qx.dom.Node.getBodyElement(document));
qx.event.Registration.addListener(this.__nY,a,this._onload,this);
this.__oc=qx.lang.Function.listener(this._onreadystatechange,this);
qx.bom.Event.addNativeListener(this.__nY,D,this.__oc);
...
},_numericMap:{"uninitialized":1,"loading":2,"loaded":2,"interactive":3,"complete":4}},members:{__ob:null,__od:0,__oa:null,__nY:null,__oc:null,send:function(){var M=this.getMethod();
var O=this.getUrl();
...
this.__oa.appendChild(Q);
}this.__oa.action=O;
this.__oa.method=M;
this.__ob.appendChild(document.createTextNode(this.getData()));
this.__oa.submit();
this.setState(r);
},_onload:qx.event.GlobalError.observeMethod(function(e){if(qx.bom.client.Engine.NAME==u&&this.getIframeHtmlContent()==k){return;
}
if(this.__oa.src){return;
}this._switchReadyState(qx.io.remote.transport.Iframe._numericMap.complete);
}),_onreadystatechange:qx.event.GlobalError.observeMethod(function(e){this._switchReadyState(qx.io.remote.transport.Iframe._numericMap[this.__nY.readyState]);
}),_switchReadyState:function(T){switch(this.getState()){case E:case s:case p:case v:this.warn("Ignore Ready State Change");
return;
}while(this.__od<T){this.setState(qx.io.remote.Exchange._nativeMap[++this.__od]);
}},setRequestHeader:function(U,V){},getResponseHeader:function(W){return null;
},getResponseHeaders:function(){return {};
},getStatusCode:function(){return 200;
},getStatusText:function(){return k;
},getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__nY);
},getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__nY);
},getIframeBody:function(){return qx.bom.Iframe.getBody(this.__nY);
...
},destruct:function(){if(this.__nY){qx.event.Registration.removeListener(this.__nY,a,this._onload,this);
qx.bom.Event.removeNativeListener(this.__nY,D,this.__oc);
if(qx.core.Variant.isSet(d,y)){this.__nY.src=qx.util.ResourceManager.getInstance().toUri(w);
}qx.dom.Element.remove(this.__nY);
}
if(this.__oa){qx.dom.Element.remove(this.__oa);
}this.__nY=this.__oa=this.__ob=null;
}});
})();
(function(){var t="keypress",s="interval",r="keydown",q="mousedown",p="keyup",o="__oe",n="blur",m="Enter",l="Up",k="__of",c="Escape",j="__og",g="qx.ui.menu.Manager",b="Left",a="Down",f="Right",d="singleton",h="Space";
...
this.__of.addListener(s,this._onOpenInterval,this);
this.__og=new qx.event.Timer;
this.__og.addListener(s,this._onCloseInterval,this);
},members:{__oh:null,__oi:null,__of:null,__og:null,__oe:null,_getChild:function(w,x,y,z){var A=w.getChildren();
var length=A.length;
var B;
...
}},hideAll:function(){var I=this.__oe;

if(I){for(var i=I.length-1;i>=0;i--){I[i].exclude();
}}},getActiveMenu:function(){var J=this.__oe;
return J.length>0?J[J.length-1]:null;
},scheduleOpen:function(K){this.cancelClose(K);
if(K.isVisible()){if(this.__oh){this.cancelOpen(this.__oh);
}}else if(this.__oh!=K){this.__oh=K;
this.__of.restartWith(K.getOpenInterval());
}},scheduleClose:function(L){this.cancelOpen(L);
if(!L.isVisible()){if(this.__oi){this.cancelClose(this.__oi);
}}else if(this.__oi!=L){this.__oi=L;
this.__og.restartWith(L.getCloseInterval());
}},cancelOpen:function(M){if(this.__oh==M){this.__of.stop();
this.__oh=null;
}},cancelClose:function(N){if(this.__oi==N){this.__og.stop();
this.__oi=null;
...
}if(this.__oe.length>0&&!this._isInMenu(O)){this.hideAll();
}},__oj:{"Enter":1,"Space":1},__ok:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var P=this.getActiveMenu();

if(!P){return;
}var Q=e.getKeyIdentifier();

if(this.__ok[Q]||(this.__oj[Q]&&P.getSelectedButton())){e.stopPropagation();
...
}},properties:{selection:{check:d,event:f,apply:b,init:null}},members:{_modifingSelection:0,__ol:null,__om:null,_applySelection:function(g,h){if(this.__om!=undefined&&h!=undefined){h.removeListenerById(this.__om);
}this.__om=g.addListener(e,this.__on,this);
this._updateSelection();
},__on:function(){this._updateSelection();
},_changeTargetSelection:function(){if(this.getTarget()==null){return;
}if(!this.__oo()&&!this.__op()){return;
...
},_addChangeTargetListener:function(m,n){if(this.__ol!=undefined&&n!=undefined){n.removeListenerById(this.__ol);
}
if(m!=null){if(this.__oo()||this.__op()){this.__ol=m.addListener(f,this._changeTargetSelection,this);
...
}}}else if(this.__op()){this.__oq(this.getSelection().getItem(this.getSelection().length-1));
this.getSelection().splice(0,this.getSelection().getLength()-1).dispose();
}this._endSelectionModification();
},__oo:function(){var s=this.getTarget().constructor;
return qx.Class.implementsInterface(s,qx.ui.core.IMultiSelection);
},__op:function(){var t=this.getTarget().constructor;
return qx.Class.implementsInterface(t,qx.ui.core.ISingleSelection);
},__oq:function(u){var v=this.__or(u);
if(v==null){return;
}if(this.__oo()){this.getTarget().addToSelection(v);
}else if(this.__op()){this.getTarget().setSelection([v]);
}},__or:function(w){var x=this.getTarget().getSelectables(true);
...
if(n){this.__ot(n);
}}else{this.__os=new qx.ui.decoration.GridDiv(n);
}
if(o!=null){this.__os.setInsets(o);
}},properties:{baseImage:{check:c,nullable:true,apply:h},insetLeft:{check:m,nullable:true,apply:l},insetRight:{check:m,nullable:true,apply:l},insetBottom:{check:m,nullable:true,apply:l},insetTop:{check:m,nullable:true,apply:l},insets:{group:[i,j,g,a],mode:e}},members:{__os:null,getMarkup:function(){return this.__os.getMarkup();
},resize:function(p,q,r){this.__os.resize(p,q,r);
},tint:function(s,t){},getInsets:function(){return this.__os.getInsets();
},_applyInsets:function(u,v,name){var w=f+qx.lang.String.firstUp(name);
this.__os[w](u);
},_applyBaseImage:function(x,y){if(this.__os instanceof qx.ui.decoration.GridDiv){this.__os.setBaseImage(x);
}else{this.__ot(x);
}},__ot:function(z){var B,D;
this.__os.setBorderImage(z);
...
}q.include=this.__qS(q.include);
q.patch=this.__qS(q.patch);
{};
...
}},__qS:function(s){if(!s){return [];
}
if(qx.Bootstrap.isArray(s)){return s;
}else{return [s];
}},__qT:function(t,u){var v=u.aliases||{};
...
},__qU:function(w){for(var i=0,x=this.__qW,l=x.length;i<l;i++){if(w[x[i]]){return x[i];
}}},__qV:function(y,z){var C=this.__qU(z);
...
y[C]=new E;
},$$registry:{},__qW:[g,d,f,n,c,o,m,b],__qX:null,__qY:null,__ra:function(){},patch:function(F,G){var I=this.__qU(G);

if(I!==this.__qU(F)){throw new Error("The mixins '"+F.name+"' are not compatible '"+G.name+"'!");
}var H=G[I];
...
if(this.getOrientation()==h){if(Q.height<R.minHeight+this.__ou){P=true;
}}else{if(Q.width<R.minWidth+this.__ou){P=true;
}}
if(P){O.exclude();
}else{O.show();
}}}});
...
(function(){var s="Integer",r="aborted",q="_onaborted",p="__oU",o="_on",n="_applyEnabled",m="Boolean",l="sending",k="interval",j="failed",c="qx.io.remote.RequestQueue",h="timeout",g="completed",b="__oS",a="queued",f="receiving",d="singleton";
qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__oR=[];
this.__oS=[];
this.__oT=0;
this.__oU=new qx.event.Timer(500);
this.__oU.addListener(k,this._oninterval,this);
},properties:{enabled:{init:true,check:m,apply:n},maxTotalRequests:{check:s,nullable:true},maxConcurrentRequests:{check:s,init:qx.bom.client.Transport.getMaxConcurrentRequestCount()},defaultTimeout:{check:s,init:5000}},members:{__oR:null,__oS:null,__oT:null,__oU:null,getRequestQueue:function(){return this.__oR;
},getActiveQueue:function(){return this.__oS;
},_debug:function(){var t;
{};
},_check:function(){this._debug();
if(this.__oS.length==0&&this.__oR.length==0){this.__oU.stop();
}if(!this.getEnabled()){return;
}if(this.__oR.length==0||(this.__oR[0].isAsynchronous()&&this.__oS.length>=this.getMaxConcurrentRequests())){return;
}if(this.getMaxTotalRequests()!=null&&this.__oT>=this.getMaxTotalRequests()){return;
}var u=this.__oR.shift();
...
v.send();
if(this.__oR.length>0){this._check();
}},_remove:function(w){qx.lang.Array.remove(this.__oS,w);
w.dispose();
this._check();
},__oV:0,_onsending:function(e){{};
...
}},_oninterval:function(e){var H=this.__oS;

if(H.length==0){this.__oU.stop();
return;
...
}this.__oU.setEnabled(I);
},add:function(K){K.setState(a);

if(K.isAsynchronous()){this.__oR.push(K);
}else{this.__oR.unshift(K);
}this._check();

if(this.getEnabled()){this.__oU.start();
}},abort:function(L){var M=L.getTransport();

if(M){M.abort();
}else if(qx.lang.Array.contains(this.__oR,L)){qx.lang.Array.remove(this.__oR,L);
...
var s=++qx.io.remote.transport.Script.__oW;

if(s>=2000000000){qx.io.remote.transport.Script.__oW=s=1;
}this.__oX=null;
this.__oW=s;
},statics:{__oW:0,_instanceRegistry:{},ScriptTransport_PREFIX:f,ScriptTransport_ID_PARAM:b,ScriptTransport_DATA_PARAM:h,handles:{synchronous:false,asynchronous:true,crossDomain:true,fileUpload:false,programaticFormFields:false,responseTypes:[m,l,o]},isSupported:function(){return true;
...
}})},members:{__oY:0,__oX:null,__oW:null,send:function(){var x=this.getUrl();
x+=(x.indexOf(p)>=0?r:p)+qx.io.remote.transport.Script.ScriptTransport_ID_PARAM+q+this.__oW;
...
this.__oX=document.createElement(c);
this.__oX.charset=e;
this.__oX.src=x;
{};
...
return;
}while(this.__oY<B){this.setState(qx.io.remote.Exchange._nativeMap[++this.__oY]);
...
},events:{"execute":R},properties:{enabled:{init:true,check:l,event:o,apply:I},shortcut:{check:n,apply:Q,nullable:true},autoRepeat:{check:l,init:false}},members:{__pb:g,__pc:g,execute:function(U){this.fireDataEvent(L,U);
},__pd:function(event){if(this.getEnabled()&&this.__pf(event)){if(!this.isAutoRepeat()){this.execute(event.getTarget());
}event.stop();
}},__pe:function(event){if(this.getEnabled()&&this.__pf(event)){if(this.isAutoRepeat()){this.execute(event.getTarget());
}event.stop();
}},_applyEnabled:function(V,W){if(V){qx.event.Registration.addListener(document.documentElement,h,this.__pd,this);
qx.event.Registration.addListener(document.documentElement,d,this.__pe,this);
}else{qx.event.Registration.removeListener(document.documentElement,h,this.__pd,this);
qx.event.Registration.removeListener(document.documentElement,d,this.__pe,this);
}},_applyShortcut:function(X,Y){if(X){if(X.search(/[\s]+/)!=-1){var bc=y;
this.error(bc);
throw new Error(bc);
}this.__pb={"Control":false,"Shift":false,"Meta":false,"Alt":false};
this.__pc=null;
var ba;
var a=[];
...
for(var i=0;i<bb;i++){var bd=this.__ph(a[i]);

switch(bd){case f:case u:case K:case C:this.__pb[bd]=true;
break;
case m:var bc=F+a[i];
this.error(bc);
throw bc;
default:if(this.__pc){var bc=r;
this.error(bc);
throw bc;
}this.__pc=bd;
}}}return true;
},__pf:function(e){var be=this.__pc;

if(!be){return ;
}if((!this.__pb.Shift&&e.isShiftPressed())||(this.__pb.Shift&&!e.isShiftPressed())||(!this.__pb.Control&&e.isCtrlPressed())||(this.__pb.Control&&!e.isCtrlPressed())||(!this.__pb.Meta&&e.isMetaPressed())||(this.__pb.Meta&&!e.isMetaPressed())||(!this.__pb.Alt&&e.isAltPressed())||(this.__pb.Alt&&!e.isAltPressed())){return false;
}
if(be==e.getKeyIdentifier()){return true;
}return false;
},__pg:{esc:S,ctrl:f,print:P,del:q,pageup:b,pagedown:E,numlock:O,numpad_0:J,numpad_1:D,numpad_2:t,numpad_3:s,numpad_4:A,numpad_5:N,numpad_6:B,numpad_7:H,numpad_8:M,numpad_9:z,numpad_divide:p,numpad_multiply:v,numpad_minus:c,numpad_plus:k},__ph:function(bf){var bg=qx.event.handler.Keyboard;
var bh=m;
...
var bh=this.__pg[bf]||qx.lang.String.firstUp(bf);

if(bg.isValidKeyIdentifier(bh)){return bh;
}else{return m;
}},toString:function(){var bk=this.__pc;
var bj=[];

for(var bi in this.__pb){if(this.__pb[bi]){bj.push(qx.locale.Key.getKeyName(j,bi));
}}
if(bk){bj.push(qx.locale.Key.getKeyName(j,bk));
}return bj.join(k);
}},destruct:function(){this.setEnabled(false);
this.__pb=this.__pc=null;
}});
})();
...
(function(){var o="static",n="execute",m="user",l="settings",k="loading",j="addfeed",h="selection[0]",g="title",f="north",d="main",bw="new",bv="Surfin' Safari",bu="changeModel",bt="__pA",bs="__pr",br="selection[0].state",bq="Heise",bp="__px",bo="F1",bn="article",v="partLoaded",w="Control+A",t="__pE",u="http://blogs.msdn.com/ie/rss.xml",r="http://my.opera.com/desktopteam/xml/rss/blog/",s="feedreader/images/loading22.gif",p="error",q="change",D="http://blogs.msdn.com/jscript/rss.xml",E="__pz",Q="loaded",M="feeds",Y="__pt",T="icon/22/places/folder.png",bj="__pB",be="The Mozilla Blog",I="enabled",bm="http://webkit.org/blog/feed/",bl="separator-vertical",bk="http://feeds2.feedburner.com/qooxdoo/news/content",H="http://blog.mozilla.com/feed/",K="vertical",L="http://www.heise.de/newsticker/heise-atom.xml",O="__pu",R="state",U="JScript Team Blog",bb="Feeds",bg="http://feeds2.feedburner.com/ajaxian",x="Control+D",y="icon/22/actions/process-stop.png",J="selection[0].articles",X="white",W="IEBlog",V="Ajaxian",bd="__pD",bc="User Feeds",S="icon/22/apps/internet-feed-reader.png",ba="model",a="feedreader.Application",bf="http://daringfireball.net/index.xml",z="Control+P",A="__pv",N="Static Feeds",b="Control+R",c="qooxdoo News",G="__pC",B="__py",C="Opera Desktop Blog",F="feedreader.model.Feed",P="Daring Fireball",bi="__pq",bh="__pw";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__pq:null,__pr:null,__ps:null,__pt:null,__pu:null,__pv:null,__pw:null,__px:null,__py:null,__pz:null,__pA:null,__pB:null,__pC:null,__pD:null,__pE:null,main:function(){qx.application.Standalone.prototype.main.call(this);
{};
qx.io.PartLoader.getInstance().addListener(v,function(e){this.debug("part loaded: "+e.getData().getName());
},this);
...
this._setUpBinding();
this.__pt.getRoot().setOpen(true);
this.__pt.getRoot().getChildren()[0].setOpen(true);
this.__pt.getRoot().getChildren()[1].setOpen(true);
this.__pt.setHideRoot(true);
this.__pq.getSelection().push(this.__pE.getFeeds().getItem(0));
this.reload();
},_initializeModel:function(){this.__pC=new feedreader.model.FeedFolder(bb);
this.__pE=new feedreader.model.FeedFolder(this.tr(N));
this.__pC.getFeeds().push(this.__pE);
this.__pE.getFeeds().push(new feedreader.model.Feed(c,bk,o));
this.__pE.getFeeds().push(new feedreader.model.Feed(U,D,o));
this.__pE.getFeeds().push(new feedreader.model.Feed(P,bf,o));
this.__pE.getFeeds().push(new feedreader.model.Feed(bv,bm,o));
this.__pE.getFeeds().push(new feedreader.model.Feed(V,bg,o));
this.__pD=new feedreader.model.FeedFolder(this.tr(bc));
this.__pC.getFeeds().push(this.__pD);
this.__pD.getFeeds().push(new feedreader.model.Feed(bq,L,m));
this.__pD.getFeeds().push(new feedreader.model.Feed(W,u,m));
this.__pD.getFeeds().push(new feedreader.model.Feed(be,H,m));
this.__pD.getFeeds().push(new feedreader.model.Feed(C,r,m));
},_setUpBinding:function(){var bz={converter:this._state2iconConverter};
this.__pq=new qx.data.controller.Tree(this.__pC,this.__pt,M,g);
this.__pq.setIconOptions(bz);
this.__pq.setIconPath(R);
this.__pr=new qx.data.controller.List(null,this.__pw.getList(),g);
this.__pq.bind(J,this.__pr,ba);
this.__pr.bind(h,this.__pA,bn);
this.__pr.getSelection().addListener(q,this._listControllerChange,this);
this.__pr.addListener(bu,this._treeControllerChange,this);
var bA={converter:this._state2loadingConverter};
this.__pq.bind(br,this.__pw,k,bA);
bA={converter:this._category2enabledConverter};
this.__pq.bind(h,this.__pv.getRemoveButton(),I,bA);
},_category2enabledConverter:function(bB){return !!bB&&bB.getCategory()==m;
},_state2iconConverter:function(bC){if(bC==bw||bC==k){return s;
}else if(bC==Q){return S;
}else if(bC==p){return y;
}return T;
},_state2loadingConverter:function(bD){if(bD==bw||bD==k){return true;
}return false;
},_listControllerChange:function(bE){var bF=this.__pq.getSelection().getItem(0);
var bG=this.__pr.getSelection().getItem(0);
if(bG!=undefined){bF.setSelectedArticle(bG);
}},_treeControllerChange:function(bH){var bI=this.__pq.getSelection().getItem(0);
if(bI!=null&&bI.classname==F&&bI.getSelectedArticle()!=null&&bI.getArticles().contains(bI.getSelectedArticle())){qx.event.Timer.once(function(){this.__pr.getSelection().push(bI.getSelectedArticle());
},this,0);
}else{this.__pw.getList().scrollToY(0);
}},_createLayout:function(){var bJ=new qx.ui.layout.Dock();
bJ.setSeparatorY(bl);
var bK=new qx.ui.container.Composite(bJ);
this.getRoot().add(bK,{edge:0});
this.__pu=new feedreader.view.Header();
bK.add(this.__pu,{edge:f});
this.__pv=new feedreader.view.ToolBar(this);
bK.add(this.__pv,{edge:f});
this.__px=new qx.ui.splitpane.Pane();
bK.add(this.__px);
this.__pt=new qx.ui.tree.Tree();
this.__pt.setWidth(250);
this.__pt.setBackgroundColor(X);
this.__px.add(this.__pt,0);
this.__py=new qx.ui.splitpane.Pane(K);
this.__py.setDecorator(null);
this.__px.add(this.__py,1);
this.__pw=new feedreader.view.List(this.__pC);
this.__pw.setHeight(200);
this.__pw.setDecorator(d);
this.__py.add(this.__pw,0);
this.__pA=new feedreader.view.Article();
this.__pA.setDecorator(d);
this.__py.add(this.__pA,1);
},_initializeCommands:function(){var bL={};
bL.reload=new qx.ui.core.Command(b);
bL.reload.addListener(n,this.reload,this);
bL.about=new qx.ui.core.Command(bo);
bL.about.addListener(n,this.showAbout,this);
bL.preferences=new qx.ui.core.Command(z);
bL.preferences.addListener(n,this.showPreferences,this);
bL.addFeed=new qx.ui.core.Command(w);
...
this.__ps=bL;
},getCommand:function(bM){return this.__ps[bM];
},addFeed:function(bN,bO,bP){var bQ=new feedreader.model.Feed(bN,bO,bP);
this.__pD.getFeeds().push(bQ);
var bR=feedreader.io.FeedLoader.getInstance();
bR.load(bQ);
},removeFeed:function(){var bS=this.__pq.getSelection().getItem(0);
if(bS&&bS.getCategory&&bS.getCategory()!==o){var bT=this.__pD.getFeeds();
for(var i=0;i<bT.length;i++){if(bS===bT.getItem(i)){bT.splice(i,1);
return;
}}}},reload:function(){var bU=feedreader.io.FeedLoader.getInstance();
bU.loadAll(this.__pC);
},showPreferences:function(){this.__pv.singalLoading(l,true);
qx.io.PartLoader.require([l],function(){if(!this.__pz){this.__pz=new feedreader.view.PreferenceWindow();
this.getRoot().add(this.__pz);
}this.__pz.center();
this.__pz.open();
this.__pv.singalLoading(l,false);
},this);
},showAbout:function(){alert(this.tr("FeedReader (qooxdoo powered)"));
},showAddFeed:function(){this.__pv.singalLoading(j,true);
qx.io.PartLoader.require([j],function(){if(!this.__pB){this.__pB=new feedreader.view.AddFeedWindow(this);
this.getRoot().add(this.__pB);
}this.__pB.center();
this.__pB.open();
this.__pv.singalLoading(j,false);
},this);
}},destruct:function(){this.__ps=null;
this._disposeObjects(A,bh,bt,Y,G,bp,B,O,t,bd,bi,bs,E,bj);
}});
})();
(function(){var k="horizontal",j="px",i="scroll",h="vertical",g="-1px",f="qx.client",d="0",c="hidden",b="mousedown",a="qx.ui.core.scroll.NativeScrollBar",z="PositiveNumber",y="Integer",x="mousemove",w="_applyMaximum",v="_applyOrientation",u="appear",t="opera",s="PositiveInteger",r="mshtml",q="mouseup",o="Number",p="__pG",m="_applyPosition",n="scrollbar",l="native";
...
return {width:this.__pF?100:F,maxWidth:this.__pF?null:F,minWidth:this.__pF?null:F,height:this.__pF?F:100,maxHeight:this.__pF?F:null,minHeight:this.__pF?F:null};
...
if(this.__pF){content.scrollToX(J);
}else{content.scrollToY(J);
}},_applyOrientation:function(K,L){var M=this.__pF=K===k;
...
qx.ui.core.queue.Layout.add(this);
},_updateScrollBar:function(){var O=this.__pF;
...
var V=this.__pF?W.getScrollX():W.getScrollY();
this.setPosition(V);
...
},_applyIconOptions:function(G,H){this.__pU();
},_applyLabelOptions:function(I,J){this.__pU();
},_applyIconPath:function(K,L){this.__pU();
},_applyLabelPath:function(M,N){this.__pU();
},_applyModel:function(O,P){if(P!=undefined){if(this.__pL!=undefined){P.removeListenerById(this.__pL);
}
if(this.__pM!=undefined){P.removeListenerById(this.__pM);
}}if(this.getSelection()!=undefined&&this.getSelection().length>0){this.getSelection().splice(0,this.getSelection().length);
}if(O!=null){this.__pL=O.addListener(y,this.__pQ,this);
this.__pM=O.addListener(k,this.__pP,this);
this.__pW();
this.__pQ();
...
for(var i=0;i<length;i++){this.__pT();
}}}},_applyTarget:function(R,S){this._addChangeTargetListener(R,S);
if(S!=undefined){S.removeAll();
this.removeAllBindings();
}
if(R!=null){if(this.getModel()!=null){for(var i=0;i<this.__pH.length;i++){this.__pS(this.__pX(i));
}}}},__pP:function(){this.__pO=true;
qx.ui.core.queue.Widget.add(this);
if(this.__pH.length!=this.getModel().getLength()){this.update();
}},syncWidget:function(){if(this.__pN){this._changeTargetSelection();
}
if(this.__pO){this._updateSelection();
}this.__pO=this.__pN=null;
},__pQ:function(){if(this.getTarget()==null){return;
}this.__pW();
var U=this.__pH.length;
var T=this.getTarget().getChildren().length;
if(U>T){for(var j=T;j<U;j++){this.__pS(this.__pX(j));
}}else if(U<T){for(var j=T;j>U;j--){this.__pT();
}}},__pR:function(){var V=this.getModel();
if(V!=null){V.removeListenerById(this.__pM);
this.__pM=V.addListener(k,this.__pP,this);
...
},__pS:function(Y){var ba=this._createItem();
this._bindListItem(ba,Y);
this.getTarget().add(ba);
},__pT:function(){this._startSelectionModification();
...
if(!qx.lang.Array.contains(this.__pI,bn)){this.__pI.push(bn);
...
if(!qx.lang.Array.contains(this.__pJ,bt)){this.__pJ.push(bt);
}},_onBindingSet:function(bA,bB,bC){if(this.getModel()==null||this._inSelectionModification()){return;
}for(var i=0;i<this.__pI.length;i++){if(this.__pK[this.__pI[i]]!=null){this.__pK[this.__pI[i]]();
}}},_removeBindingsFrom:function(bD){for(var i=0;i<this.__pI.length;i++){var bE=bD.getUserData(this.__pI[i]+g);

if(bE!=null){this.removeBinding(bE);
}}for(var i=0;i<this.__pJ.length;i++){var bE=bD.getUserData(this.__pJ[i]+h);

if(bE!=null){bD.removeBinding(bE);
}}},__pU:function(){if(this.getTarget()==null||this.getModel()==null){return;
}var bF=this.getTarget().getChildren();
for(var i=0;i<bF.length;i++){this._removeBindingsFrom(bF[i]);
this._bindListItem(bF[i],this.__pX(i));
}this.__pR();
...
this._endSelectionModification();
this._updateSelection();
},_setFilter:function(bO,bP){if((bO==null||bO.filter==null)&&(bP!=null&&bP.filter!=null)){this.__pV();
...
this.__pW();
if(bR.length>this.__pH.length){for(var j=bR.length;j>this.__pH.length;j--){this.getTarget().removeAt(j-1);
}}else if(bR.length<this.__pH.length){for(var j=bR.length;j<this.__pH.length;j++){var bS=this._createItem();
this.getTarget().add(bS);
}}var bQ=this.getTarget().getChildren();

for(var i=0;i<bQ.length;i++){this._bindListItem(bQ[i],this.__pX(i));
}this.__pR();
this._endSelectionModification();
this._updateSelection();
},__pV:function(){this.__pW();
this.__pQ();
this.__pU();
this.__pO=true;
qx.ui.core.queue.Widget.add(this);
},__pW:function(){var bV=this.getModel();
...
for(var i=0;i<bV.getLength();i++){if(bU==null||bU(bV.getItem(i))){this.__pH.push(i);
}}},__pX:function(bX){return this.__pH[bX];
}},destruct:function(){this.__pH=this.__pK=this.__pI=null;
this.__pJ=null;
qx.ui.core.queue.Widget.remove(this);
}});
})();
(function(){var c="Integer",b="_applyLayoutChange",a="qx.ui.menu.Layout";
qx.Class.define(a,{extend:qx.ui.layout.VBox,properties:{columnSpacing:{check:c,init:0,apply:b},spanColumn:{check:c,init:1,nullable:true,apply:b},iconColumnWidth:{check:c,init:0,themeable:true,apply:b},arrowColumnWidth:{check:c,init:0,themeable:true,apply:b}},members:{__pY:null,_computeSizeHint:function(){var q=this._getLayoutChildren();
var o,g,j;
var e=this.getSpanColumn();
var h=this.__pY=[0,0,0,0];
...
},getColumnSizes:function(){return this.__pY||null;
...
(function(){var e="Integer",d="interval",c="qx.event.type.Event",b="__qa",a="qx.event.AcceleratingTimer";
qx.Class.define(a,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__qa=new qx.event.Timer(this.getInterval());
this.__qa.addListener(d,this._onInterval,this);
},events:{"interval":c},properties:{interval:{check:e,init:100},firstInterval:{check:e,init:500},minimum:{check:e,init:20},decrease:{check:e,init:2}},members:{__qa:null,__qb:null,start:function(){this.__qa.setInterval(this.getFirstInterval());
this.__qa.start();
},stop:function(){this.__qa.stop();
this.__qb=null;
},_onInterval:function(){this.__qa.stop();

if(this.__qb==null){this.__qb=this.getInterval();
}this.__qb=Math.max(this.getMinimum(),this.__qb-this.getDecrease());
this.__qa.setInterval(this.__qb);
this.__qa.start();
this.fireEvent(d);
}},destruct:function(){this._disposeObjects(b);
}});
...
this.addListener(s,this.__qc,this);
this.addListener(n,this.__qc,this);
},members:{_stopPropagation:function(e){e.stopPropagation();
},__qc:function(){var A=this.getStyle(k);
...
}else{do{var I=this.__rc[0];
if(I){var H=I.getMarginLeft()+I.getMarginRight();
var D=I.getSizeHint().width+H;
if(A>C+D+this.getSpacing()||(this.__rc.length==1&&A>C+D-F+this.getSpacing())){this.__re(I);
A+=D;
if(B&&this.__rc.length==0){B.setVisibility(v);
}}else{return;
}}}while(A>=C&&this.__rc.length>0);
}},__re:function(J){J.setVisibility(w);
this.__rc.shift();
this.fireDataEvent(p,J);
},__rf:function(K){if(!K){return;
}this.__rc.unshift(K);
K.setVisibility(v);
this.fireDataEvent(j,K);
},_getNextToHide:function(){for(var i=this.__rd.length-1;i>=0;i--){var L=this.__rd[i];
...
}}},setRemovePriority:function(O,P,Q){if(!Q&&this.__rd[P]!=undefined){throw new Error("Priority already in use!");
}this.__rd[P]=O;
...
}for(var i=0;i<this.__rc.length;i++){this.__rc[i].setVisibility(w);
}this.__rc=[];
...
}},__rg:false,_setAllowMenuOpenHover:function(X){this.__rg=X;
},_isAllowMenuOpenHover:function(){return this.__rg;
...
this.add(K);
this.addSeparator();
this.__qg=new qx.ui.toolbar.Button(this.tr(g),t);
this.__qg.setCommand(H.getCommand(l));
this.__qg.setToolTipText(this.tr(w));
this.add(this.__qg);
this.addSpacer();
var L=new qx.ui.toolbar.Button(this.tr(F),b);
...
this.__qh=new qx.ui.menu.Menu();
M.setMenu(this.__qh);
this.addListener(u,this._onHideItem,this);
this.addListener(s,this._onShowItem,this);
},members:{__qf:null,__qh:null,__qd:null,__qe:null,__qg:null,getRemoveButton:function(){return this.__qf;
...
P.setVisibility(f);
},_getMenuItem:function(R){var S=this.__qd[R.toHashCode()];
...
this.__qd[R.toHashCode()]=S;
}return S;
},singalLoading:function(T,U){if(T==z){var V=this.__qe;
}else if(T==p){var V=this.__qg;
}else{return ;
...
},__ql:function(){var bi=this._getMenuBounds();

if(!bi){this.addListenerOnce(j,this.__ql,this);
return;
...
if(this.__qi){bn.cancelOpen(this.__qi);
this.__qi=null;
...
}if(this.__qi){bq.cancelOpen(this.__qi);
...
(function(){var n=",",m="",k="string",j="null",h='"',g=':',f="qx.jsonDebugging",e='-',d='\\u00',c="__qp",N="new Date(Date.UTC(",M="__qz",L='\\\\',K='\\f',J="__qo",I="__qq",H='\\"',G='Z',F="))",E='T',u="}",v='(',s='.',t="{",q='\\r',r="__qr",o=":",p='\\t',w="]",x="[",z="__qy",y="qx.jsonEncodeUndefined",B='\\b',A="qx.util.Json",D=')',C='\\n';
qx.Class.define(A,{statics:{__qm:null,BEAUTIFYING_INDENT:"  ",BEAUTIFYING_LINE_END:"\n",CONVERT_DATES:null,__qn:{"function":J,"boolean":c,"number":I,"string":r,"object":z,"undefined":M},__qo:function(O,P){return String(O);
},__qp:function(Q,R){return String(Q);
},__qq:function(S,T){return isFinite(S)?String(S):j;
},__qr:function(U,V){var W;

if(/["\\\x00-\x1f]/.test(U)){W=U.replace(/([\x00-\x1f\\"])/g,qx.util.Json.__qt);
}else{W=U;
}return h+W+h;
},__qs:{'\b':B,'\t':p,'\n':C,'\f':K,'\r':q,'"':H,'\\':L},__qt:function(a,b){var X=qx.util.Json.__qs[b];

if(X){return X;
}X=b.charCodeAt();
return d+Math.floor(X/16).toString(16)+(X%16).toString(16);
},__qu:function(Y,ba){var bc=[],bf=true,be,bb;
var bd=qx.util.Json.__qB;
bc.push(x);

if(bd){qx.util.Json.__qv+=qx.util.Json.BEAUTIFYING_INDENT;
bc.push(qx.util.Json.__qv);
}
for(var i=0,l=Y.length;i<l;i++){bb=Y[i];
be=this.__qn[typeof bb];

if(be){bb=this[be](bb,i+m);

if(typeof bb==k){if(!bf){bc.push(n);

if(bd){bc.push(qx.util.Json.__qv);
}}bc.push(bb);
bf=false;
}}}
if(bd){qx.util.Json.__qv=qx.util.Json.__qv.substring(0,qx.util.Json.__qv.length-qx.util.Json.BEAUTIFYING_INDENT.length);
bc.push(qx.util.Json.__qv);
}bc.push(w);
return bc.join(m);
},__qw:function(bg,bh){if(!qx.util.Json.CONVERT_DATES){if(bg.toJSON&&!qx.bom.client.Engine.OPERA){return bg.toJSON();
...
return N+bj+F;
}},__qx:function(bl,bm){var bp=[],br=true,bo,bn;
var bq=qx.util.Json.__qB;
bp.push(t);

if(bq){qx.util.Json.__qv+=qx.util.Json.BEAUTIFYING_INDENT;
bp.push(qx.util.Json.__qv);
}
for(var bm in bl){bn=bl[bm];
bo=this.__qn[typeof bn];

if(bo){bn=this[bo](bn,bm);

if(typeof bn==k){if(!br){bp.push(n);

if(bq){bp.push(qx.util.Json.__qv);
}}bp.push(this.__qr(bm),o,bn);
br=false;
}}}
if(bq){qx.util.Json.__qv=qx.util.Json.__qv.substring(0,qx.util.Json.__qv.length-qx.util.Json.BEAUTIFYING_INDENT.length);
bp.push(qx.util.Json.__qv);
}bp.push(u);
return bp.join(m);
},__qy:function(bs,bt){if(bs){if(qx.lang.Type.isFunction(bs.toJSON)&&bs.toJSON!==this.__qm){return this.__qA(bs.toJSON(bt),bt);
}else if(qx.lang.Type.isDate(bs)){return this.__qw(bs,bt);
}else if(qx.lang.Type.isArray(bs)){return this.__qu(bs,bt);
}else if(qx.lang.Type.isObject(bs)){return this.__qx(bs,bt);
}return m;
}return j;
},__qz:function(bu,bv){if(qx.core.Setting.get(y)){return j;
}},__qA:function(bw,bx){return this[this.__qn[typeof bw]](bw,bx);
},stringify:function(by,bz){this.__qB=bz;
this.__qv=this.BEAUTIFYING_LINE_END;
var bA=this.__qA(by,m);
...
}}},settings:{"qx.jsonEncodeUndefined":true,"qx.jsonDebugging":false},defer:function(bF){bF.__qm=Date.prototype.toJSON;
}});
})();
...
}},properties:{width:{check:b,init:0,apply:g},style:{nullable:true,check:[k,j,h,i],init:k,apply:o},color:{nullable:true,check:m,apply:o},backgroundColor:{check:m,nullable:true,apply:o}},members:{__rC:null,_getDefaultInsets:function(){var s=this.getWidth();
return {top:s,right:s,bottom:s,left:s};
},_isInitialized:function(){return !!this.__rC;
},getMarkup:function(){if(this.__rC){return this.__rC;
...
(function(){var dK="button-frame",dJ="atom",dI="widget",dH="main",dG="button",dF="text-selected",dE="image",dD="bold",dC="middle",dB="selected",cn="background-light",cm="text-disabled",cl="groupbox",ck="decoration/arrows/down.png",cj="cell",ci="border-invalid",ch="input",cg="input-disabled",cf="menu-button",ce="input-focused-invalid",dR="toolbar-button",dS="spinner",dP="input-focused",dQ="white",dN="popup",dO="tooltip",dL="label",dM="list",dT="tree-item",dU="treevirtual-contract",dj="scrollbar",di="datechooser/nav-button",dl="text-hovered",dk="center",dn="treevirtual-expand",dm="textfield",dq="decoration/arrows/right.png",dp="background-application",dh="radiobutton",dg="invalid",k="combobox",l="right-top",m="checkbox",n="text-title",o="qx/static/blank.gif",p="scrollbar/button",q="right",r="combobox/button",s="icon/16/places/folder.png",t="text-label",ej="decoration/tree/closed.png",ei="scrollbar-slider-horizontal",eh="decoration/arrows/left.png",eg="button-focused",en="text-light",em="menu-slidebar-button",el="text-input",ek="slidebar/button-forward",ep="background-splitpane",eo=".png",bm="decoration/tree/open.png",bn="default",bk="decoration/arrows/down-small.png",bl="datechooser",bq="slidebar/button-backward",br="selectbox",bo="treevirtual-folder",bp="shadow-popup",bi="icon/16/mimetypes/office-document.png",bj="background-medium",N="table",M="decoration/arrows/up.png",P="decoration/form/",O="",J="-invalid",I="icon/16/places/folder-open.png",L="button-checked",K="decoration/window/maximize-active-hovered.png",H="radiobutton-hovered",G="keyboard-focus",bx="decoration/cursors/",by="slidebar",bz="tooltip-error-arrow",bA="table-scroller-focus-indicator",bt="move-frame",bu="nodrop",bv="decoration/table/boolean-true.png",bw="table-header-cell",bB="menu",bC="app-header",bb="row-layer",ba="text-inactive",Y="move",X="radiobutton-checked-focused",W="decoration/window/restore-active-hovered.png",V="shadow-window",U="table-column-button",T="right.png",bf="tabview-page-button-bottom-inactive",be="tooltip-error",bD="window-statusbar",bE="button-hovered",bF="decoration/scrollbar/scrollbar-",bG="background-tip",bH="scrollbar-slider-horizontal-disabled",bI="table-scroller-header",bJ="button-pressed",bK="table-pane",bL="decoration/window/close-active.png",bM="native",cv="checkbox-hovered",cu="button-invalid-shadow",ct="checkbox-checked",cs="decoration/window/minimize-active-hovered.png",cz="menubar",cy="icon/16/actions/dialog-cancel.png",cx="tabview-page-button-top-inactive",cw="tabview-page-button-left-inactive",cD="menu-slidebar",cC="toolbar-button-checked",db="decoration/tree/open-selected.png",dc="radiobutton-checked",cY="decoration/window/minimize-inactive.png",da="icon/16/apps/office-calendar.png",cW="group",cX="tabview-page-button-right-inactive",cU="decoration/window/minimize-active.png",cV="decoration/window/restore-inactive.png",dd="checkbox-checked-focused",de="splitpane",du="combobox/textfield",dt="button-preselected-focused",dw="decoration/window/close-active-hovered.png",dv="qx/icon/Tango/16/actions/window-close.png",dy="checkbox-pressed",dx="button-disabled",dA="selected-dragover",dz="border-separator",ds="decoration/window/maximize-inactive.png",dr="dragover",ec="scrollarea",ed="scrollbar-vertical",ee="decoration/menu/checkbox-invert.gif",ef="decoration/toolbar/toolbar-handle-knob.gif",dX="icon/22/mimetypes/office-document.png",dY="button-preselected",ea="button-checked-focused",eb="up.png",dV="best-fit",dW="decoration/tree/closed-selected.png",j="qx.theme.modern.Appearance",i="text-active",h="toolbar-button-hovered",g="progressive-table-header",f="decoration/table/select-column-order.png",e="decoration/menu/radiobutton.gif",d="decoration/arrows/forward.png",c="decoration/table/descending.png",b="progressbar",a="window-captionbar-active",w="checkbox-checked-hovered",x="scrollbar-slider-vertical",u="toolbar",v="alias",A="decoration/window/restore-active.png",B="decoration/table/boolean-false.png",y="checkbox-checked-disabled",z="icon/32/mimetypes/office-document.png",D="radiobutton-checked-disabled",E="tabview-pane",cH="decoration/arrows/rewind.png",cB="checkbox-focused",cO="top",cK="icon/16/actions/dialog-ok.png",cq="radiobutton-checked-hovered",co="table-header-cell-hovered",R="window",cr="text-gray",bd="decoration/menu/radiobutton-invert.gif",bc="text-placeholder",bV="slider",bW="keep-align",bX="down.png",bY="tabview-page-button-top-active",ca="icon/32/places/folder-open.png",cb="icon/22/places/folder.png",cc="decoration/window/maximize-active.png",cd="checkbox-checked-pressed",bT="decoration/window/close-inactive.png",bU="tabview-page-button-left-active",cp="toolbar-part",cN="decoration/splitpane/knob-vertical.png",cM=".gif",cL="icon/22/places/folder-open.png",cS="radiobutton-checked-pressed",cR="table-statusbar",cQ="radiobutton-pressed",cP="window-captionbar-inactive",cJ="copy",cI="radiobutton-focused",C="decoration/arrows/down-invert.png",bh="decoration/menu/checkbox.gif",bg="decoration/splitpane/knob-horizontal.png",cA="icon/32/places/folder.png",bs="toolbar-separator",cG="tabview-page-button-bottom-active",cF="decoration/arrows/up-small.png",cE="decoration/table/ascending.png",Q="decoration/arrows/up-invert.png",cT="small",F="tabview-page-button-right-active",S="-disabled",bN="scrollbar-horizontal",bO="progressive-table-header-cell",bP="menu-separator",bQ="pane",bR="decoration/arrows/right-invert.png",bS="left.png",df="icon/16/actions/view-refresh.png";
qx.Theme.define(j,{appearances:{"widget":{},"root":{style:function(eq){return {backgroundColor:dp,textColor:t,font:bn};
}},"label":{style:function(er){return {textColor:er.disabled?cm:undefined};
}},"move-frame":{style:function(es){return {decorator:dH};
}},"resize-frame":bt,"dragdrop-cursor":{style:function(et){var eu=bu;

if(et.copy){eu=cJ;
}else if(et.move){eu=Y;
}else if(et.alias){eu=v;
}return {source:bx+eu+cM,position:l,offset:[2,16,2,6]};
}},"image":{style:function(ev){return {opacity:!ev.replacement&&ev.disabled?0.3:1};
}},"atom":{},"atom/label":dL,"atom/icon":dE,"popup":{style:function(ew){return {decorator:dH,backgroundColor:cn,shadow:bp};
}},"button-frame":{alias:dJ,style:function(ex){var ez,ey;

if(ex.checked&&ex.focused&&!ex.inner){ez=ea;
ey=undefined;
}else if(ex.disabled){ez=dx;
ey=undefined;
}else if(ex.pressed){ez=bJ;
ey=dl;
}else if(ex.checked){ez=L;
ey=undefined;
}else if(ex.hovered){ez=bE;
ey=dl;
}else if(ex.preselected&&ex.focused&&!ex.inner){ez=dt;
ey=dl;
}else if(ex.preselected){ez=dY;
ey=dl;
}else if(ex.focused&&!ex.inner){ez=eg;
ey=undefined;
}else{ez=dG;
ey=undefined;
}return {decorator:ez,textColor:ey,shadow:ex.invalid&&!ex.disabled?cu:undefined};
...
if(eE.checked&&eE.focused){eG=dd;
}else if(eE.checked&&eE.disabled){eG=y;
}else if(eE.checked&&eE.pressed){eG=cd;
}else if(eE.checked&&eE.hovered){eG=w;
}else if(eE.checked){eG=ct;
}else if(eE.focused){eG=cB;
}else if(eE.pressed){eG=dy;
}else if(eE.hovered){eG=cv;
}else{eG=m;
}var eF=eE.invalid&&!eE.disabled?J:O;
return {icon:P+eG+eF+eo,gap:6};
}},"radiobutton":{alias:dJ,style:function(eH){var eJ;

if(eH.checked&&eH.focused){eJ=X;
}else if(eH.checked&&eH.disabled){eJ=D;
}else if(eH.checked&&eH.pressed){eJ=cS;
}else if(eH.checked&&eH.hovered){eJ=cq;
}else if(eH.checked){eJ=dc;
}else if(eH.focused){eJ=cI;
}else if(eH.pressed){eJ=cQ;
}else if(eH.hovered){eJ=H;
}else{eJ=dh;
}var eI=eH.invalid&&!eH.disabled?J:O;
return {icon:P+eJ+eI+eo,gap:6};
...
}else if(eK.showingPlaceholder){eM=bc;
}else{eM=el;
...
}},"spinner/textfield":{style:function(eW){return {marginRight:2,padding:[2,4,1],textColor:eW.disabled?cm:el};
...
}},"spinner/downbutton":{alias:dK,include:dK,style:function(eY){return {icon:bk,padding:eY.pressed?[2,2,0,4]:[1,3,1,3],shadow:undefined};
}},"datefield":k,"datefield/button":{alias:r,include:r,style:function(fa){return {icon:da,padding:[0,3],decorator:undefined};
}},"datefield/textfield":du,"datefield/list":{alias:bl,include:bl,style:function(fb){return {decorator:undefined};
}},"groupbox":{style:function(fc){return {legendPosition:cO};
}},"groupbox/legend":{alias:dJ,style:function(fd){return {padding:[1,0,1,4],textColor:fd.invalid?dg:n,font:dD};
}},"groupbox/frame":{style:function(fe){return {padding:12,decorator:cW};
...
}},"scrollarea/pane":dI,"scrollarea/scrollbar-x":dj,"scrollarea/scrollbar-y":dj,"scrollbar":{style:function(fj){if(fj[bM]){return {};
}return {width:fj.horizontal?undefined:16,height:fj.horizontal?16:undefined,decorator:fj.horizontal?bN:ed,padding:1};
}},"scrollbar/slider":{alias:bV,style:function(fk){return {padding:fk.horizontal?[0,1,0,1]:[1,0,1,0]};
}},"scrollbar/slider/knob":{include:dK,style:function(fl){var fm=fl.horizontal?ei:x;

if(fl.disabled){fm+=S;
}return {decorator:fm,minHeight:fl.horizontal?undefined:9,minWidth:fl.horizontal?9:undefined};
}},"scrollbar/button":{alias:dK,include:dK,style:function(fn){var fo=bF;

if(fn.left){fo+=bS;
}else if(fn.right){fo+=T;
}else if(fn.up){fo+=eb;
}else{fo+=bX;
}
...
}}},"scrollbar/button-begin":p,"scrollbar/button-end":p,"slider":{style:function(fp){var ft;
var fr=!!fp.focused;
var fs=!!fp.invalid;
var fq=!!fp.disabled;
...
}},"slider/knob":{include:dK,style:function(fu){return {decorator:fu.disabled?bH:ei,shadow:undefined,height:14,width:14};
}},"list":{alias:ec,style:function(fv){var fz;
var fx=!!fv.focused;
var fy=!!fv.invalid;
var fw=!!fv.disabled;
...
if(fA.dragover){fB=fA.selected?dA:dr;
...
}},"slidebar/button-backward":{alias:dK,include:dK,style:function(fD){return {padding:5,center:true,icon:fD.vertical?M:eh};
}},"tabview":{style:function(fE){return {contentPadding:16};
}},"tabview/bar":{alias:by,style:function(fF){var fG={marginBottom:fF.barTop?-1:0,marginTop:fF.barBottom?-4:0,marginLeft:fF.barRight?-3:0,marginRight:fF.barLeft?-1:0,paddingTop:0,paddingRight:0,paddingBottom:0,paddingLeft:0};
...
}},"tabview/bar/button-forward":{include:ek,alias:ek,style:function(fH){if(fH.barTop||fH.barBottom){return {marginTop:2,marginBottom:2};
}else{return {marginLeft:2,marginRight:2};
}}},"tabview/bar/button-backward":{include:bq,alias:bq,style:function(fI){if(fI.barTop||fI.barBottom){return {marginTop:2,marginBottom:2};
}else{return {marginLeft:2,marginRight:2};
}}},"tabview/bar/scrollpane":{},"tabview/pane":{style:function(fJ){return {decorator:E,minHeight:100,marginBottom:fJ.barBottom?-1:0,marginTop:fJ.barTop?-1:0,marginLeft:fJ.barLeft?-1:0,marginRight:fJ.barRight?-1:0};
}},"tabview-page":dI,"tabview-page/button":{alias:dJ,style:function(fK){var fQ,fM=0;
var fP=0,fL=0,fN=0,fO=0;

if(fK.checked){if(fK.barTop){fQ=bY;
fM=[6,14];
fN=fK.firstTab?0:-5;
fO=fK.lastTab?0:-5;
...
fP=fK.firstTab?0:-5;
fL=fK.lastTab?0:-5;
}}else{if(fK.barTop){fQ=cx;
fM=[4,10];
fP=4;
fN=fK.firstTab?5:1;
fO=1;
}else if(fK.barBottom){fQ=bf;
fM=[4,10];
fL=4;
fN=fK.firstTab?5:1;
fO=1;
}else if(fK.barRight){fQ=cX;
fM=[4,10];
fO=5;
fP=fK.firstTab?5:1;
fL=1;
...
fL=1;
fO=1;
}}return {zIndex:fK.checked?10:5,decorator:fQ,padding:fM,marginTop:fP,marginBottom:fL,marginLeft:fN,marginRight:fO,textColor:fK.checked?i:ba};
}},"tabview-page/button/label":{alias:dL,style:function(fR){return {padding:[0,1,0,1],margin:fR.focused?0:1,decorator:fR.focused?G:undefined};
}},"tabview-page/button/close-button":{alias:dJ,style:function(fS){return {icon:dv};
}},"toolbar":{style:function(fT){return {decorator:u,spacing:2};
}},"toolbar/part":{style:function(fU){return {decorator:cp,spacing:2};
}},"toolbar/part/container":{style:function(fV){return {paddingLeft:2,paddingRight:2};
}},"toolbar/part/handle":{style:function(fW){return {source:ef,marginLeft:3,marginRight:3};
}},"toolbar-button":{alias:dJ,style:function(fX){return {marginTop:2,marginBottom:2,padding:(fX.pressed||fX.checked||fX.hovered)&&!fX.disabled||(fX.disabled&&fX.checked)?3:5,decorator:fX.pressed||(fX.checked&&!fX.hovered)||(fX.checked&&fX.disabled)?cC:fX.hovered&&!fX.disabled?h:undefined};
}},"toolbar-menubutton":{alias:dR,include:dR,style:function(fY){return {showArrow:true};
}},"toolbar-menubutton/arrow":{alias:dE,include:dE,style:function(ga){return {source:bk};
...
if(gi.selected&&gi.opened){gj=db;
}else if(gi.selected&&!gi.opened){gj=dW;
}else if(gi.opened){gj=bm;
}else{gj=ej;
...
if(gk.small){gm=s;
gl=I;
}else if(gk.large){gm=cA;
gl=ca;
}else{gl=cL;
gm=cb;
}return {icon:gm,iconOpened:gl};
}},"tree-file":{include:dT,alias:dT,style:function(gn){return {icon:gn.small?bi:gn.large?z:dX};
}},"treevirtual":N,"treevirtual-folder":{style:function(go){return {icon:go.opened?I:s};
}},"treevirtual-file":{include:bo,alias:bo,style:function(gp){return {icon:bi};
}},"treevirtual-line":{style:function(gq){return {icon:o};
}},"treevirtual-contract":{style:function(gr){return {icon:bm,paddingLeft:5,paddingTop:2};
}},"treevirtual-expand":{style:function(gs){return {icon:ej,paddingLeft:5,paddingTop:2};
}},"treevirtual-only-contract":dU,"treevirtual-only-expand":dn,"treevirtual-start-contract":dU,"treevirtual-start-expand":dn,"treevirtual-end-contract":dU,"treevirtual-end-expand":dn,"treevirtual-cross-contract":dU,"treevirtual-cross-expand":dn,"treevirtual-end":{style:function(gt){return {icon:o};
}},"treevirtual-cross":{style:function(gu){return {icon:o};
}},"tooltip":{include:dN,style:function(gv){return {backgroundColor:bG,padding:[1,3,2,3],offset:[15,5,5,5]};
}},"tooltip/atom":dJ,"tooltip-error":{include:dO,style:function(gw){return {textColor:dF,placeMethod:dI,offset:[0,0,0,14],marginTop:-2,position:l,showTimeout:100,hideTimeout:10000,decorator:be,shadow:bz,font:dD};
}},"tooltip-error/atom":dJ,"window":{style:function(gx){return {shadow:V,contentPadding:[10,10,10,10]};
}},"window/pane":{style:function(gy){return {decorator:R};
}},"window/captionbar":{style:function(gz){return {decorator:gz.active?a:cP,textColor:gz.active?dQ:cr,minHeight:26,paddingRight:2};
...
}},"window/minimize-button":{alias:dJ,style:function(gC){return {icon:gC.active?gC.hovered?cs:cU:cY,margin:[4,8,2,0]};
}},"window/restore-button":{alias:dJ,style:function(gD){return {icon:gD.active?gD.hovered?W:A:cV,margin:[5,8,2,0]};
}},"window/maximize-button":{alias:dJ,style:function(gE){return {icon:gE.active?gE.hovered?K:cc:ds,margin:[4,8,2,0]};
}},"window/close-button":{alias:dJ,style:function(gF){return {icon:gF.active?gF.hovered?dw:bL:bT,margin:[4,8,2,0]};
}},"window/statusbar":{style:function(gG){return {padding:[2,6],decorator:bD,minHeight:18};
...
}},"splitpane":{style:function(gK){return {decorator:de};
}},"splitpane/splitter":{style:function(gL){return {width:gL.horizontal?3:undefined,height:gL.vertical?3:undefined,backgroundColor:ep};
}},"splitpane/splitter/knob":{style:function(gM){return {source:gM.horizontal?bg:cN};
}},"splitpane/slider":{style:function(gN){return {width:gN.horizontal?3:undefined,height:gN.vertical?3:undefined,backgroundColor:ep};
...
if(gV.lastYear){gW.icon=cH;
gW.marginRight=1;
}else if(gV.lastMonth){gW.icon=eh;
}else if(gV.nextYear){gW.icon=d;
gW.marginLeft=1;
...
}},"datechooser/weekday":{style:function(ha){return {textColor:ha.disabled?cm:ha.weekend?en:undefined,textAlign:dk,paddingTop:2,backgroundColor:bj};
}},"datechooser/week":{style:function(hb){return {textAlign:dk,padding:[2,4],backgroundColor:bj};
}},"datechooser/day":{style:function(hc){return {textAlign:dk,decorator:hc.disabled?undefined:hc.selected?dB:undefined,textColor:hc.disabled?cm:hc.selected?dF:hc.otherMonth?en:undefined,font:hc.today?dD:undefined,padding:[2,4]};
...
if(hi.selected){hj.decorator=eg;
}return hj;
}},"combobox/textfield":{include:dm,style:function(hk){return {decorator:undefined};
}},"menu":{style:function(hl){var hm={decorator:bB,shadow:bp,spacingX:6,spacingY:1,iconColumnWidth:16,arrowColumnWidth:4,placementModeY:hl.submenu||hl.contextmenu?dV:bW};

if(hl.submenu){hm.position=l;
hm.offset=[-2,-3];
}return hm;
}},"menu/slidebar":cD,"menu-slidebar":dI,"menu-slidebar-button":{style:function(hn){return {decorator:hn.hovered?dB:undefined,padding:7,center:true};
}},"menu-slidebar/button-backward":{include:em,style:function(ho){return {icon:ho.hovered?Q:M};
}},"menu-slidebar/button-forward":{include:em,style:function(hp){return {icon:hp.hovered?C:ck};
...
}},"menu-checkbox":{alias:cf,include:cf,style:function(hw){return {icon:!hw.checked?undefined:hw.selected?ee:bh};
}},"menu-radiobutton":{alias:cf,include:cf,style:function(hx){return {icon:!hx.checked?undefined:hx.selected?bd:e};
}},"menubar":{style:function(hy){return {decorator:cz};
...
}},"colorpopup/colorselector-okbutton":{alias:dG,include:dG,style:function(hJ){return {icon:cK};
}},"colorpopup/colorselector-cancelbutton":{alias:dG,include:dG,style:function(hK){return {icon:cy};
}},"table":{alias:dI,style:function(hL){return {decorator:N};
}},"table-header":{},"table/statusbar":{style:function(hM){return {decorator:cR,padding:[0,2]};
}},"table/column-button":{alias:dK,style:function(hN){return {decorator:U,padding:3,icon:f};
}},"table-column-reset-button":{include:cf,alias:cf,style:function(){return {icon:df};
}},"table-scroller":dI,"table-scroller/scrollbar-x":dj,"table-scroller/scrollbar-y":dj,"table-scroller/header":{style:function(hO){return {decorator:bI};
}},"table-scroller/pane":{style:function(hP){return {backgroundColor:bK};
}},"table-scroller/focus-indicator":{style:function(hQ){return {decorator:bA};
}},"table-scroller/resize-line":{style:function(hR){return {backgroundColor:dz,width:2};
}},"table-header-cell":{alias:dJ,style:function(hS){return {minWidth:13,minHeight:20,padding:hS.hovered?[3,4,2,4]:[3,4],decorator:hS.hovered?co:bw,sortIcon:hS.sorted?(hS.sortedAscending?cE:c):undefined};
}},"table-header-cell/label":{style:function(hT){return {minWidth:0,alignY:dC,paddingRight:5};
}},"table-header-cell/sort-icon":{style:function(hU){return {alignY:dC,alignX:q};
...
}},"table-editor-selectbox":{include:br,alias:br,style:function(hX){return {padding:[0,2],backgroundColor:cn};
}},"table-editor-combobox":{include:k,alias:k,style:function(hY){return {decorator:undefined,backgroundColor:cn};
}},"progressive-table-header":{alias:dI,style:function(ia){return {decorator:g};
}},"progressive-table-header-cell":{alias:dJ,style:function(ib){return {minWidth:40,minHeight:25,paddingLeft:6,decorator:bO};
}},"app-header":{style:function(ic){return {font:dD,textColor:dF,padding:[8,12],decorator:bC};
}},"virtual-list":dM,"virtual-list/row-layer":bb,"row-layer":{style:function(id){return {colorEven:dQ,colorOdd:dQ};
}},"column-layer":dI,"cell":{style:function(ie){return {textColor:ie.selected?dF:t,padding:[3,6],font:bn};
}},"cell-string":cj,"cell-number":{include:cj,style:function(ig){return {textAlign:q};
}},"cell-image":cj,"cell-boolean":{include:cj,style:function(ih){return {iconTrue:bv,iconFalse:B};
}},"cell-atom":cj,"cell-date":cj,"cell-html":cj,"htmlarea":{"include":dI,style:function(ii){return {backgroundColor:dQ};
}},"progressbar":{style:function(ij){return {decorator:b,padding:[1],backgroundColor:dQ};
...
(function(){var p="Boolean",o="focusout",n="interval",m="mouseover",l="mouseout",k="mousemove",j="widget",i="qx.ui.tooltip.ToolTip",h="__qF",g="__qI",c="_applyCurrent",f="qx.ui.tooltip.Manager",d="__qG",b="tooltip-error",a="singleton";
qx.Class.define(f,{type:a,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
qx.event.Registration.addListener(document.body,m,this.__qP,this,true);
this.__qF=new qx.event.Timer();
this.__qF.addListener(n,this.__qM,this);
this.__qG=new qx.event.Timer();
this.__qG.addListener(n,this.__qN,this);
this.__qH={left:0,top:0};
},properties:{current:{check:i,nullable:true,apply:c},showInvalidToolTips:{check:p,init:true},showToolTips:{check:p,init:true}},members:{__qH:null,__qG:null,__qF:null,__qI:null,__qJ:null,__qK:function(){if(!this.__qI){this.__qI=new qx.ui.tooltip.ToolTip().set({rich:true});
}return this.__qI;
},__qL:function(){if(!this.__qJ){this.__qJ=new qx.ui.tooltip.ToolTip().set({appearance:b});
this.__qJ.syncAppearance();
}return this.__qJ;
...
var s=document.body;
if(q){this.__qF.startWith(q.getShowTimeout());
t.addListener(s,l,this.__qQ,this,true);
t.addListener(s,o,this.__qR,this,true);
t.addListener(s,k,this.__qO,this,true);
}else{t.removeListener(s,l,this.__qQ,this,true);
t.removeListener(s,o,this.__qR,this,true);
t.removeListener(s,k,this.__qO,this,true);
}},__qM:function(e){var u=this.getCurrent();

if(u&&!u.isDisposed()){this.__qG.startWith(u.getHideTimeout());

if(u.getPlaceMethod()==j){u.placeToWidget(u.getOpener());
}else{u.placeToPoint(this.__qH);
}u.show();
}this.__qF.stop();
},__qN:function(e){var v=this.getCurrent();

if(v&&!v.isDisposed()){v.exclude();
}this.__qG.stop();
this.resetCurrent();
},__qO:function(e){var w=this.__qH;
w.left=e.getDocumentLeft();
w.top=e.getDocumentTop();
},__qP:function(e){var z=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
...
if(x){A=this.__qL().set({label:x});
}
if(!A){A=this.__qK().set({label:B,icon:y});
}this.setCurrent(A);
A.setOpener(z);
},__qQ:function(e){var C=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
...
}},__qR:function(e){var F=qx.ui.core.Widget.getWidgetByElement(e.getTarget());

if(!F){return;
}var G=this.getCurrent();
if(G&&G==F.getToolTip()){this.setCurrent(null);
}}},destruct:function(){qx.event.Registration.removeListener(document.body,m,this.__qP,this,true);
this._disposeObjects(h,d,g);
this.__qH=null;
}});
})();
...
for(F=z.length;F>3;F-=3){D=t+qx.locale.Number.getGroupSeparator(this.__rb)+z.substring(F-3,F)+D;
}D=z.substring(0,F)+D;
}var B=this.getPrefix()?this.getPrefix():t;
var y=this.getPostfix()?this.getPostfix():t;
var E=B+(A?r:t)+D;

if(C.length>0){E+=t+qx.locale.Number.getDecimalSeparator(this.__rb)+C;
}E+=y;
return E;
},parse:function(I){var N=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__rb)+t);
var L=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__rb)+t);
...
(function(){var n="separator-vertical",m="__rh",l="background-medium",k="Posts",j="bold",i="_applyLoading",h="__ri",g="__rj",f="center",e="feedreader.view.List",b="single",d="middle",c="feedreader/images/loading66.gif",a="Boolean";
...
q.setFont(j);
this._add(q);
this.__rh=new qx.ui.container.Stack();
this._add(this.__rh,{flex:1});
this.__ri=new qx.ui.form.List();
this.__ri.setDecorator(null);
this.__ri.setSelectionMode(b);
this.__rh.add(this.__ri);
this.__rj=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));
var o=new qx.ui.basic.Image(c);
o.setAlignY(d);
this.__rj.add(o);
this.__rh.add(this.__rj);
},properties:{loading:{check:a,init:false,apply:i}},members:{__rh:null,__ri:null,__rj:null,_applyLoading:function(r,s){if(r){this.__rh.setSelection([this.__rj]);
}else{this.__rh.setSelection([this.__ri]);
}},getList:function(){return this.__ri;
}},destruct:function(){this._disposeObjects(h,m,g);
}});
})();
...
(function(){var f="mousedown",d="__rm",c="blur",b="singleton",a="qx.ui.popup.Manager";
qx.Class.define(a,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__rm={};
qx.event.Registration.addListener(document.documentElement,f,this.__ro,this,true);
qx.bom.Element.addListener(window,c,this.hideAll,this);
},members:{__rm:null,add:function(g){{};
this.__rm[g.$$hash]=g;
this.__rn();
},remove:function(h){{};
var i=this.__rm;
...
this.__rn();
}},hideAll:function(){var k=this.__rm;

if(k){for(var j in k){k[j].exclude();
}}},__rn:function(){var n=1e7;
var m=this.__rm;

for(var l in m){m[l].setZIndex(n++);
}},__ro:function(e){var q=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
var r=this.__rm;
...
}}},destruct:function(){qx.event.Registration.removeListener(document.documentElement,f,this.__ro,this,true);
this._disposeMap(d);
}});
})();
...
var T=Y.event;
var X=bb.addListener(T,this.__rt,this);
var U=W.treeNode;
this.__rr[ba.toHashCode()]={modelNode:bb,treeNode:U,changeListenerId:W.changeListenerId,changeChildernListenerId:X};
this.__rv(U,bb);
this._updateSelection();
...
},__ru:function(){if(this.getTarget()==null||this.getChildPath()==null){return;
...
this.__rA(this.getModel(),bf);
this.__rv(bf,this.getModel());
}},__rv:function(bg,bh){if(bh[s+qx.lang.String.firstUp(this.getChildPath())]==undefined){return;
}var bq=bh[s+qx.lang.String.firstUp(this.getChildPath())]();
if(this.__rr[bq.toHashCode()]==undefined){var bl=bq.addListener(m,this.__rs,this);
var bp=qx.Class.getPropertyDefinition(bh.constructor,this.getChildPath());
var bm=bp.event;
var bn=bh.addListener(bm,this.__rt,this);
this.__rr[bq.toHashCode()]={modelNode:bh,treeNode:bg,changeListenerId:bl,changeChildernListenerId:bn};
...
}},__rz:function(){var bS;

for(var bU in this.__rp){bS=bU;
break;
}for(var bR in this.__rp[bS]){var bV=this.__rp[bS][bR].treeNode;
var bT=qx.core.ObjectRegistry.fromHashCode(bR);
this.__rB(bT);
this.__rA(bT,bV);
}},__rA:function(bW,bX){var bY=this.getDelegate();
if(bY!=null&&bY.bindItem!=null){bY.bindItem(this,bX,bW);
}else{this.bindDefaultProperties(bX,bW);
}},__rB:function(ca){for(var i=0;i<this.__rq.length;i++){var cc=this.__rq[i];
var cb=this.__rp[cc][ca.toHashCode()];

if(cb!=null){if(cb.id){ca.removeBinding(cb.id);
}
if(cb.reverseId){cb.treeNode.removeBinding(cb.reverseId);
}delete this.__rp[cc][ca.toHashCode()];
...
}}},destruct:function(){this.__rp=this.__rr=this.__rq=null;
}});
})();
...
(function(){var f="_applyBlockerColor",e="Number",d="__rD",c="qx.ui.core.MBlocker",b="_applyBlockerOpacity",a="Color";
qx.Mixin.define(c,{construct:function(){this.__rD=new qx.ui.core.Blocker(this);
},properties:{blockerColor:{check:a,init:null,nullable:true,apply:f,themeable:true},blockerOpacity:{check:e,init:1,apply:b,themeable:true}},members:{__rD:null,_applyBlockerColor:function(g,h){this.__rD.setColor(g);
},_applyBlockerOpacity:function(i,j){this.__rD.setOpacity(i);
},block:function(){this.__rD.block();
},isBlocked:function(){return this.__rD.isBlocked();
},unblock:function(){this.__rD.unblock();
},forceUnblock:function(){this.__rD.forceUnblock();
},blockContent:function(k){this.__rD.blockContent(k);
},isContentBlocked:function(){return this.__rD.isContentBlocked();
},unblockContent:function(){this.__rD.unblockContent();
},forceUnblockContent:function(){this.__rD.forceUnblockContent();
},getBlocker:function(){return this.__rD;
}},destruct:function(){this._disposeObjects(d);
}});
})();
...
qx.ui.core.queue.Visibility.add(this);
this.initNativeHelp();
},properties:{appearance:{refine:true,init:j},enabled:{refine:true,init:true},focusable:{refine:true,init:true},globalCursor:{check:b,nullable:true,themeable:true,apply:g,event:m},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:k,init:false,apply:c}},members:{__rI:null,isRootWidget:function(){return true;
},getLayout:function(){return this._getLayout();
},_applyGlobalCursor:qx.core.Variant.select(n,{"mshtml":function(q,r){},"default":function(s,t){var u=qx.bom.Stylesheet;
var v=this.__rI;

if(!v){this.__rI=v=u.createElement();
}u.removeAllRules(v);
...
}},"default":function(){}})},destruct:function(){this.__rI=null;
...
qx.Class.define(h,{extend:qx.ui.root.Abstract,construct:function(o){this.__rE=qx.dom.Node.getWindow(o);
this.__rF=o;
qx.ui.root.Abstract.call(this);
qx.event.Registration.addListener(this.__rE,n,this._onResize,this);
this._setLayout(new qx.ui.layout.Canvas());
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
this.getContentElement().disableScrolling();
},members:{__rE:null,__rF:null,_createContainerElement:function(){var p=this.__rF;
...
},_computeSizeHint:function(){var u=qx.bom.Viewport.getWidth(this.__rE);
var v=qx.bom.Viewport.getHeight(this.__rE);
...
}}},destruct:function(){this.__rE=this.__rF=null;
}});
})();
...
if(!feedreader.view.Article.__rG){feedreader.view.Article.__rG=true;
...
w.setLineHeight(1.8);
this.setFont(w);
},properties:{article:{apply:e,nullable:true,check:d}},members:{_applyArticle:function(x,y){var z=this.__rH();
this.setHtml(z);
qx.html.Element.flush();
var B=this.getContentElement().getDomElement();
var A=B.getElementsByTagName(b);
for(var i=0;i<A.length;i++){A[i].target=t;
}},__rH:function(){var D=this.getArticle();
if(!D){return v;
...
this._applyLayoutChange();
},__rL:{north:1,south:2,west:3,east:4,center:5},__rM:{1:q,2:d,3:r,4:g},__rN:function(){var x=this._getLayoutChildren();
var F,z;
var length=x.length;
var B=[];
var E=[];
...
delete this._invalidChildrenCache;
},renderLayout:function(H,I){if(this._invalidChildrenCache){this.__rN();
}var bc=qx.ui.layout.Util;
var O=this.__rJ;
var bd=this.__rK;
var length=O.length;
...
(function(){var l="zIndex",k="px",j="keydown",h="deactivate",g="resize",f="keyup",d="keypress",c="backgroundColor",b="_applyOpacity",a="Boolean",x="__rR",w="opacity",v="interval",u="Tab",t="Color",s="qx.ui.root.Page",r="Number",q="qx.ui.core.Blocker",p="__rV",o="qx.ui.root.Application",m="__rT",n="_applyColor";
...
if(this._isPageRoot){y.addListener(g,this.__rW,this);
}
if(qx.Class.isDefined(o)&&y instanceof qx.ui.root.Application){this.setKeepBlockerActive(true);
}this.__rO=[];
this.__rP=[];
this.__rQ=[];
},properties:{color:{check:t,init:null,nullable:true,apply:n,themeable:true},opacity:{check:r,init:1,apply:b,themeable:true},keepBlockerActive:{check:a,init:false}},members:{__rR:null,__rS:0,__rT:null,__rQ:null,__rO:null,__rP:null,__rU:null,__rV:null,_isPageRoot:false,_widget:null,__rW:function(e){var z=e.getData();
...
this.__rX(c,C);
},_applyOpacity:function(D,E){this.__rX(w,D);
},__rX:function(F,G){var H=[];
this.__rR&&H.push(this.__rR);
this.__rT&&H.push(this.__rT);
...
this.__rO.push(I.getActive());
this.__rP.push(I.getFocus());

if(this._widget.isFocusable()){this._widget.focus();
}},_restoreActiveWidget:function(){var L=this.__rO.length;

if(L>0){var K=this.__rO[L-1];

if(K){qx.bom.Element.activate(K);
}this.__rO.pop();
}var J=this.__rP.length;

if(J>0){var K=this.__rP[J-1];

if(K){qx.bom.Element.focus(this.__rP[J-1]);
}this.__rP.pop();
}},__rY:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());
},getBlockerElement:function(){if(!this.__rR){this.__rR=this.__rY();
this.__rR.setStyle(l,15);
this._widget.getContainerElement().add(this.__rR);
this.__rR.exclude();
}return this.__rR;
},block:function(){this.__rS++;

if(this.__rS<2){this._backupActiveWidget();
var M=this.getBlockerElement();
M.include();
M.activate();
M.addListener(h,this.__se,this);
M.addListener(d,this.__sd,this);
M.addListener(j,this.__sd,this);
M.addListener(f,this.__sd,this);
}},isBlocked:function(){return this.__rS>0;
},unblock:function(){if(!this.isBlocked()){return;
}this.__rS--;

if(this.__rS<1){this.__sa();
this.__rS=0;
}},forceUnblock:function(){if(!this.isBlocked()){return;
}this.__rS=0;
this.__sa();
},__sa:function(){this._restoreActiveWidget();
var N=this.getBlockerElement();
N.removeListener(h,this.__se,this);
N.removeListener(d,this.__sd,this);
N.removeListener(j,this.__sd,this);
N.removeListener(f,this.__sd,this);
N.exclude();
},getContentBlockerElement:function(){if(!this.__rT){this.__rT=this.__rY();
this._widget.getContentElement().add(this.__rT);
this.__rT.exclude();
}return this.__rT;
...
if(this.__rQ.length<2){P.include();

if(this._isPageRoot){if(!this.__rV){this.__rV=new qx.event.Timer(300);
this.__rV.addListener(v,this.__sc,this);
}this.__rV.start();
this.__sc();
}}},isContentBlocked:function(){return this.__rQ.length>0;
},unblockContent:function(){if(!this.isContentBlocked()){return;
}this.__rQ.pop();
var Q=this.__rQ[this.__rQ.length-1];
var R=this.getContentBlockerElement();
R.setStyle(l,Q);

if(this.__rQ.length<1){this.__sb();
this.__rQ=[];
...
S.setStyle(l,null);
this.__sb();
},__sb:function(){this.getContentBlockerElement().exclude();

if(this._isPageRoot){this.__rV.stop();
}},__sc:function(){var T=this._widget.getContainerElement().getDomElement();
...
},__sd:function(e){if(e.getKeyIdentifier()==u){e.stop();
}},__se:function(){if(this.getKeepBlockerActive()){this.getBlockerElement().activate();
}}},destruct:function(){if(this._isPageRoot){this._widget.removeListener(g,this.__rW,this);
}this._disposeObjects(m,x,p);
this.__rU=this.__rO=this.__rP=this._widget=this.__rQ=null;
}});
})();
...
this.__sj=++qx.io.remote.Request.__sj;
},events:{"created":j,"configured":j,"sending":j,"receiving":j,"completed":P,"aborted":j,"failed":P,"timeout":P},statics:{__sj:0,methodAllowsRequestBody:function(T){return (T==O)||(T==I);
...
},init:true,apply:B},crossDomain:{check:k,init:false},fileUpload:{check:k,init:false},transport:{check:l,nullable:true},useBasicHttpAuth:{check:k,init:false},parseJson:{check:k,init:true}},members:{__sf:null,__sg:null,__sh:null,__si:null,__sj:null,send:function(){qx.io.remote.RequestQueue.getInstance().add(this);
...
},setRequestHeader:function(bf,bg){this.__sf[bf]=bg;
},removeRequestHeader:function(bh){delete this.__sf[bh];
},getRequestHeader:function(bi){return this.__sf[bi]||null;
},getRequestHeaders:function(){return this.__sf;
},setParameter:function(bj,bk,bl){if(bl){this.__sh[bj]=bk;
}else{this.__sg[bj]=bk;
}},removeParameter:function(bm,bn){if(bn){delete this.__sh[bm];
}else{delete this.__sg[bm];
}},getParameter:function(bo,bp){if(bp){return this.__sh[bo]||null;
}else{return this.__sg[bo]||null;
}},getParameters:function(bq){return (bq?this.__sh:this.__sg);
},setFormField:function(br,bs){this.__si[br]=bs;
},removeFormField:function(bt){delete this.__si[bt];
},getFormField:function(bu){return this.__si[bu]||null;
},getFormFields:function(){return this.__si;
},getSequenceNumber:function(){return this.__sj;
}},destruct:function(){this.setTransport(null);
this.__sf=this.__sg=this.__sh=this.__si=null;
}});
})();
(function(){var l="dblclick",k="click",j="Boolean",h="excluded",g="visible",f="qx.event.type.Data",d="_applyOpenMode",c="Space",b="Left",a="Enter",z="changeOpenMode",y="_applyRootOpenClose",x="__sl",w="changeSelection",v="qx.ui.tree.Tree",u="tree",t="_applyHideRoot",s="changeRoot",r="_applyRoot",q="keypress",o="none",p="pane",m="Right",n="qx.ui.tree.AbstractTreeItem";
...
},_getContentPaddingTarget:function(){return this.__sl;
