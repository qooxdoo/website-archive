qx.$$packageData['08b06a7952f8']={"locales":{},"resources":{"feedreader/images/combined/icons16.png":[16,96,"png","feedreader"],"qx/icon/Tango/16/actions/dialog-apply.png":[16,16,"png","qx","feedreader/images/combined/icons16.png",0,-80],"qx/icon/Tango/16/actions/document-new.png":[16,16,"png","qx","feedreader/images/combined/icons16.png",0,-16]},"translations":{}};

qx.Part.$$notifyLoad("08b06a7952f8", function() {
...
this.__J.setStyles({"visibility":"hidden","zIndex":6,"position":"absolute"});
...
}},"off":null}),_applyPlaceholder:function(bM,bN){if(this.__H){this.__O().setValue(bM);

if(bM!=null){this.addListener(X,this._removePlaceholder,this);
...
}}else{if(this.getEnabled()){this.getContentElement().setAttribute(a,bM);
}}},_applyTextAlign:function(bO,bP){this.getContentElement().setStyle(n,bO);
...
}}else if(D===p&&qx.core.Variant.isSet(r,o)){A.$$inValueSet=true;
A.value=B;
A.$$inValueSet=null;
}else{A.value=B;
