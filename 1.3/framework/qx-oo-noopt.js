...
qx.$$packageData['8eead72e36d4']={"locales":{},"resources":{},"translations":{}};
if(!window.qx){window.qx={};
...
},updateTarget:function(sourceObject,sourcePropertyChain,targetObject,targetPropertyChain,options){var source=this.__getTargetFromChain(sourceObject,sourcePropertyChain);
...
if(arrayIndex!=="last"){if(arrayIndex==""||isNaN(parseInt(arrayIndex,10))){throw new Error("No number or 'last' value hast been given"+" in a array binding: "+name+" does not work.");
