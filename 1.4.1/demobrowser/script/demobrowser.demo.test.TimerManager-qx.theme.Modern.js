...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.TimerManager","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.TimerManager-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"bab68fce9f4a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var h="Stopping recurrent 2-second timer",g="Recurrent 2-second timer with limit 3:",f="One-shot 1-second timer: ",e="__UI",d="demobrowser.demo.test.TimerManager",c="Recurrent 5-second timer: ",b="Start timers",a="execute";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__UI:null,startTimers:function(){var i=qx.util.TimerManager.getInstance();
i.start(function(j,k){this.__UJ(c+k);
},5000,this,null,0);
i.start(function(l,m){this.__UJ(f+m);
},0,this,null,1000);
i.start(function(n,o){this.__UJ(g+o);

if(++n.count==3){this.__UJ(h);
i.stop(o);
}},2000,this,{count:0},2000);
},__UJ:function(p){p=Date.parse(new Date)+" "+p+"\n";
this.__UI.setValue(this.__UI.getValue()+p);
