...
}},construct:function(){this.__JJ={};
},members:{__JJ:null,getSubscriptions:function(){return this.__JJ;
...
if(J>-1){if(J===0||I.substr(0,J)===F.substr(0,J)){this.__JK(H[I],E);
G=true;
}}else{if(I===F){this.__JK(H[F],E);
G=true;
}}}return G;
},dispatchByName:function(name,K){var L=new qx.event.message.Message(name,K);
return this.dispatch(L);
},__JK:function(M,N){for(var i=0;i<M.length;i++){var O=M[i].subscriber;
var P=M[i].context;
