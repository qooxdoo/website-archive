...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Tree_Columns","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Tree_Columns-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"9a60f956892a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.addIcon();
this.setIcon(g);
var r=this.__VJ=new qx.ui.form.CheckBox();
this.bind(n,r,p);
r.bind(p,this,n);
...
var s=this.__VK=new qx.ui.basic.Label();
this.bind(c,s,p);
s.setWidth(50);
this.addWidget(s);
s=this.__VL=new qx.ui.basic.Label();
this.bind(e,s,p);
s.setWidth(150);
this.addWidget(s);
s=this.__VM=new qx.ui.basic.Label();
this.bind(b,s,p);
s.setWidth(80);
this.addWidget(s);
}}});
