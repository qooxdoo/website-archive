...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Flash","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Flash-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"2d1e8ca7caf0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="execute",j="__VR",i="Flash Player Version",h="__VP",g="__VN",f="right",d="Message from Flash:",c="Simple demo with FlashVars",b="bgcolor",a="demobrowser.demo.widget.Flash",y="demobrowser/demo/flash/FlashVersion.swf",x="Flash:",w="<b>qooxdoo:</b>",v="__VQ",u="demobrowser.demo.widget.Flash.sendMessage",t="__VO",s="demobrowser.demo.widget.Flash.flashReady",r="demobrowser/demo/flash/fo_tester.swf",q="this is passed in via FlashVars",p="Two way communication (ActionScript <-> JavaScript)",n="Message to Flash:",o="Show Flash Player version",l="noscale",m="#FF6600";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__VN:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var z=new qx.ui.tabview.TabView();
z.setContentPadding([8,8,8,8]);
var C=this.getRoot();
C.add(z,{edge:0});
var A=new qx.ui.tabview.Page(c);
A.setLayout(new qx.ui.layout.Canvas());
A.add(this.createFlashDemo1(),{edge:0});
z.add(A);
var B=new qx.ui.tabview.Page(p);
B.setLayout(new qx.ui.layout.Canvas());
B.add(this.createFlashDemo2(),{edge:0});
z.add(B);
this.__VN=this.createWindow();
C.add(this.__VN,{top:20,left:20});
},createWindow:function(){var D=new qx.ui.window.Window(i).set({width:300,height:200,contentPadding:[0,0,0,0]});
D.setLayout(new qx.ui.layout.Canvas());
D.add(new qx.ui.embed.Flash(y),{edge:0});
return D;
},createFlashDemo1:function(){var G=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var E={flashVarText:q};
var F=new qx.ui.embed.Flash(r).set({scale:l,variables:E});
F.getContentElement().setParam(b,m);
G.add(F,{flex:1});
var H=new qx.ui.form.Button(o);
H.addListener(k,function(){this.__VN.open();
},this);
G.add(H);
return G;
},__VO:null,__VP:null,__VQ:null,__VR:null,createFlashDemo2:function(){this.self(arguments).setCallBackInstance(this);
var K=new qx.ui.container.Composite(new qx.ui.layout.HBox(8));
var J=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
K.add(J,{flex:1});
J.add(new qx.ui.basic.Label(w).set({rich:true}));
J.add(new qx.ui.basic.Label(d));
this.__VP=new qx.ui.form.TextArea("No message.");
this.__VP.setEnabled(false);
J.add(this.__VP,{flex:1});
J.add(new qx.ui.basic.Label(n));
this.__VQ=new qx.ui.form.TextArea("qooxdoo is the best!");
J.add(this.__VQ,{flex:1});
var L=new qx.ui.container.Composite(new qx.ui.layout.HBox(0,f));
this.__VR=new qx.ui.form.Button("Send to Flash");
this.__VR.setEnabled(false);
this.__VR.addListener(k,function(e){this.__VO.getFlashElement().sendMessage(this.__VQ.getValue());
},this);
L.add(this.__VR);
J.add(L);
var I=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
K.add(I,{flex:1});
I.add(new qx.ui.basic.Label(x).set({rich:true}));
this.__VO=new qx.ui.embed.Flash("demobrowser/demo/flash/TestFlash.swf");
this.__VO.setVariables({init:s});
I.add(this.__VO,{flex:1});
return K;
},sendMessage:function(M){this.__VP.setValue(M);
},initFlash:function(){if(this.__VO.getFlashElement().setup){this.__VO.getFlashElement().setup(u);
this.__VR.setEnabled(true);
...
}}},statics:{__VS:null,setCallBackInstance:function(N){demobrowser.demo.widget.Flash.__VS=N;
},sendMessage:function(O){demobrowser.demo.widget.Flash.__VS.sendMessage(O);
},flashReady:function(){demobrowser.demo.widget.Flash.__VS.initFlash();
}},destruct:function(){this._disposeObjects(h,v,j,t,g);
}});
})();
...
(function(){var j="Boolean",i="qx.event.type.Event",h="sameDomain",g="opaque",f="qx.debug",e="String",d="",c="best",b="undefined",a="quality",bb="_applyVariables",ba="low",Y="_applyLoop",X="scale",W="_applyAllowScriptAccess",V="showall",U="Map",T="_applyLiveConnect",S="wmode",R="excactfit",q="Integer",r="_applyMenu",o="loaded",p="window",m="_applyPlay",n="loop",k="allowScriptAccess",l="menu",u="noborder",v="loading",D="swLiveConnect",B="qx.ui.embed.Flash",J="_applyId",F="high",N="transparent",L="play",x="autohigh",Q="_applySource",P="appear",O="medium",w="Invalid parameter 'source'.",z="timeout",A="_applyMayScript",C="_applyQuality",E="never",G="_applyScale",K="flash",M="always",s="Invalid parameter 'id'.",t="noscale",y="_applyWmode",I="autolow",H="mayscript";
qx.Class.define(B,{extend:qx.ui.core.Widget,construct:function(bc,bd){qx.ui.core.Widget.call(this);

if(qx.core.Environment.get(f)){qx.core.Assert.assertString(bc,w);

if(bd){qx.core.Assert.assertString(bd,s);
}}this.setSource(bc);

if(bd){this.setId(bd);
}else{this.setId(K+this.toHashCode());
}this.initQuality();
this.initWmode();
...
},events:{"loading":i,"loaded":i,"timeout":i},properties:{source:{check:e,apply:Q},id:{check:e,apply:J},quality:{check:[ba,I,x,O,F,c],init:c,nullable:true,apply:C},scale:{check:[V,u,R,t],nullable:true,apply:G},wmode:{check:[p,g,N],init:g,nullable:true,apply:y},play:{check:j,nullable:true,apply:m},loop:{check:j,nullable:true,apply:Y},mayScript:{check:j,nullable:false,apply:A},menu:{check:j,nullable:true,apply:r},allowScriptAccess:{check:[h,M,E],init:h,nullable:true,apply:W},liveConnect:{check:j,init:true,nullable:true,apply:T},variables:{init:{},check:U,apply:bb},loadTimeout:{check:q,init:10000}},members:{__MT:null,getFlashElement:function(){var be=this.getContentElement();

if(be){return be.getFlashElement();
}else{return null;
}},isLoaded:function(){return this.getPercentLoaded()===100;
},getPercentLoaded:function(){var bf=this.getFlashElement();
if(typeof (bf)!=b&&bf!=null){try{return bf.PercentLoaded();
}catch(bg){return 0;
}}else{return 0;
}},_createContentElement:function(){return new qx.html.Flash();
},_checkLoading:function(){var bh=this.getSource();

if(bh!=d&&bh!=null&&bh!=b){if(!this.isLoaded()){if(!this.__MT){this.__MT=new Date().getTime();
}var bi=new Date().getTime()-this.__MT;

if(this.getLoadTimeout()>bi){var bj=qx.util.TimerManager.getInstance();
bj.start(this._checkLoading,0,this,null,10);
this.fireEvent(v);
}else{if(qx.core.Environment.get(f)){this.debug("Timeout after: "+bi);
}this.fireEvent(z);
this.__MT=null;
}}else{this.fireEvent(o);
this.__MT=null;
}}},_applySource:function(bk,bl){var bm=qx.util.ResourceManager.getInstance().toUri(bk);
this.getContentElement().setSource(bm);
qx.ui.core.queue.Layout.add(this);
},_applyId:function(bn,bo){this.getContentElement().setId(bn);
qx.ui.core.queue.Layout.add(this);
},_applyVariables:function(bp,bq){this.getContentElement().setVariables(bp);
qx.ui.core.queue.Layout.add(this);
},_applyMayScript:function(br,bs){this.getContentElement().setAttribute(H,br?d:false);
qx.ui.core.queue.Layout.add(this);
},_applyQuality:function(bt,bu){this.__MU(a,bt);
},_applyScale:function(bv,bw){this.__MU(X,bv);
},_applyWmode:function(bx,by){this.__MU(S,bx);
},_applyPlay:function(bz,bA){this.__MU(L,bz);
},_applyLoop:function(bB,bC){this.__MU(n,bB);
},_applyMenu:function(bD,bE){this.__MU(l,bD);
},_applyAllowScriptAccess:function(bF,bG){this.__MU(k,bF);
},_applyLiveConnect:function(bH,bI){this.__MU(D,bH);
},__MU:function(bJ,bK){this.getContentElement().setParam(bJ,bK);
qx.ui.core.queue.Layout.add(this);
}}});
})();
(function(){var g="qx.debug",f="Invalid attribute 'value'.",e="Invalid attribute 'key'.",d="div",c="movie",b="id",a="qx.html.Flash";
...
},setSource:function(j){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(j,f);
}
if(this.__LU){throw new Error("The source cannot be modified after initial creation");
}this.setAttribute(c,j);
},setId:function(k){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(k,f);
}
if(this.__LU){throw new Error("The id cannot be modified after initial creation");
}this.setAttribute(b,k);
},getVariables:function(){return this.__LS;
},setVariables:function(l){if(qx.core.Environment.get(g)){qx.core.Assert.assertMap(l,f);
}
if(this.__LU){throw new Error("The variables cannot be modified after initial creation");
}this.__LS=l;
},getAttributes:function(){return this.__LT;
},setAttribute:function(m,n){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(m,e);

if(arguments.length>1&&n!==null){if(!qx.lang.Type.isBoolean(n)&&!qx.lang.Type.isString(n)){throw new Error("Invalid attribute 'value' expected String, Boolean or null.");
}}}
if(this.__LU){throw new Error("The attributes cannot be modified after initial creation");
}
if(n===null||n===undefined){delete this.__LT[m];
}else{this.__LT[m]=n;
}},getParams:function(){return this.__LR;
},setParam:function(o,p){if(qx.core.Environment.get(g)){qx.core.Assert.assertString(o,e);

if(arguments.length>1&&p!==null){if(!qx.lang.Type.isBoolean(p)&&!qx.lang.Type.isString(p)){throw new Error("Invalid attribute 'value' expected String, Boolean or null.");
}}}
if(this.__LU){throw new Error("The params cannot be modified after initial creation");
}
if(p===null||p===undefined){delete this.__LR[o];
}else{this.__LR[o]=p;
...
(function(){var k="engine.name",j='</object>',h="100%",g="movie",f="=",e="Invalid parameter 'element'.",d="application/x-shockwave-flash",c='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">',b="param",a="Invalid parameter 'attributes'.",E='" />',D="Invalid attribute 'movie'.",C="qx.bom.Flash",B='<param name="',A="qx.debug",z="type",y="load",x="name",w="data",v="Invalid attribute 'id'.",r="",s="mshtml",p="value",q="&",n="beforeunload",o='<object id="',l='" value="',m='" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">',t="undefined",u="object";
qx.Class.define(C,{statics:{_flashObjects:{},create:function(F,G,H,I,J){if(!J){J=window;
}if(qx.core.Environment.get(A)){qx.core.Assert.assertElement(F,e);
qx.core.Assert.assertMap(G,a);
qx.core.Assert.assertString(G.movie,D);
qx.core.Assert.assertString(G.id,v);

if(!qx.dom.Element.isInDom(F,J)){qx.log.Logger.warn(this,"The parent DOM element isn't in DOM! The External Interface doesn't work in IE!");
}}
if(!G.width){G.width=h;
}
if(!G.height){G.height=h;
}I=I?qx.lang.Object.clone(I):{};

if(!I[g]){I[g]=G.movie;
}G[w]=G.movie;
delete G.movie;
if(H){for(var name in H){if(typeof I.flashvars!=t){I.flashvars+=q+name+f+H[name];
}else{I.flashvars=name+f+H[name];
}}}var K=this.__Mb(F,G,I,J);
this._flashObjects[G.id]=K;
return K;
},destroy:qx.core.Environment.select(k,{"mshtml":function(L,M){L=this.__LV(L);

if(L.readyState==4){this.__LW(L);
}else{if(!M){M=window;
}qx.bom.Event.addNativeListener(M,y,function(){qx.bom.Flash.__LW(L);
});
}},"default":function(N,O){N=this.__LV(N);

if(N.parentNode){N.parentNode.removeChild(N);
}delete this._flashObjects[N.id];
}}),__LV:function(P){if(!P){throw new Error("DOM element is null or undefined!");
}
if(P.tagName.toLowerCase()!=="object"){P=P.firstChild;
}
if(!P||P.tagName.toLowerCase()!=="object"){throw new Error("DOM element has or is not a flash object!");
}return P;
},__LW:qx.core.Environment.select("engine.name",{"mshtml":qx.event.GlobalError.observeMethod(function(Q){for(var i in Q){if(typeof Q[i]=="function"){Q[i]=null;
}}
if(Q.parentNode){Q.parentNode.removeChild(Q);
}delete this._flashObjects[Q.id];
}),"default":null}),__LX:qx.event.GlobalError.observeMethod(function(){for(var R in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[R]);
}window.__LY=function(){};
window.__Ma=function(){};
qx.bom.Event.removeNativeListener(window,"beforeunload",qx.bom.Flash.__LX);
}),__Mb:qx.core.Environment.select(k,{"mshtml":function(S,T,U,V){U.movie=T.data;
delete T.data;
delete T.classid;
var W=r;

for(name in U){W+=B+name+l+U[name]+E;
}if(T.id){S.innerHTML=o+T.id+m+W+j;
delete T.id;
}else{S.innerHTML=c+W+j;
}for(var name in T){S.firstChild.setAttribute(name,T[name]);
}return S.firstChild;
},"default":function(X,Y,ba,bb){delete Y.classid;
delete ba.movie;
var bd=qx.bom.Element.create(u,Y,bb);
bd.setAttribute(z,d);
var bc;

for(var name in ba){bc=qx.bom.Element.create(b,{},bb);
bc.setAttribute(x,name);
bc.setAttribute(p,ba[name]);
bd.appendChild(bc);
}X.appendChild(bd);
return bd;
}})},defer:function(be){if((qx.core.Environment.get(k)==s)){qx.bom.Event.addNativeListener(window,n,be.__LX);
}}});
})();
