...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.ListWithFilter","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.ListWithFilter-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"d523c1658963"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var q="execute",p="Show all numbers.",o="Write data to log",n="Add an item",m="Remove an item",l="demobrowser.demo.virtual.ListWithFilter",k="Odd / Even filter",j="Remove filter",h="<b>Filtered List</b><br/>",g="Reverse order",c="Show only even numbers.",f="value",e="Show only odd numbers.",b="init",a="delegate",d="List showing numbered items, bound to a data array.";
...
}var C=new qx.data.Array(A);
var v=new qx.ui.list.List(C);
this.getRoot().add(v,{left:10,top:80});
var u={};
u.filter=function(F){return parseInt(F)%2==1;
};
var w={};
w.filter=function(G){return parseInt(G)%2==0;
};
var z=new qx.ui.basic.Label(b);
this.getRoot().add(z,{left:10,top:290});
var D={converter:function(H){if(H==w){return c;
}else if(H==u){return e;
}return p;
}};
v.bind(a,z,f,D);
...
x.addListener(q,function(){C.push(C.length);
},this);
var B=new qx.ui.form.Button(m);
B.setWidth(120);
this.getRoot().add(B,{left:130,top:115});
B.addListener(q,function(){C.pop();
},this);
var y=new qx.ui.form.Button(o);
y.setWidth(120);
this.getRoot().add(y,{left:130,top:150});
y.addListener(q,function(){qx.log.appender.Console.show();
this.info(C.toString());
},this);
var s=new qx.ui.form.Button(k);
s.setWidth(120);
this.getRoot().add(s,{left:130,top:185});
s.addListener(q,function(){v.getDelegate()==u?v.setDelegate(w):v.setDelegate(u);
},this);
var r=new qx.ui.form.Button(j);
r.setWidth(120);
this.getRoot().add(r,{left:130,top:220});
r.addListener(q,function(){v.setDelegate(null);
},this);
var E=new qx.ui.form.Button(g);
E.setWidth(120);
this.getRoot().add(E,{left:130,top:255});
E.addListener(q,function(){C.reverse();
},this);
