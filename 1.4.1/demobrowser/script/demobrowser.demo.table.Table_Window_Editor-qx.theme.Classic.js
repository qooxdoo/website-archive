...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Window_Editor","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Window_Editor-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"98946f98ddff"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},createTable:function(){var t=this.createRandomRows(50);
var r=new qx.ui.table.model.Simple();
r.setColumns([c,m,k,n]);
r.setData(t);
r.setColumnEditable(1,true);
var q={tableColumnModel:function(v){return new qx.ui.table.columnmodel.Resize(v);
}};
var u=new qx.ui.table.Table(r,q);
u.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var s=u.getTableColumnModel();
var p=s.getBehavior();
p.set(0,{width:i,minWidth:40,maxWidth:80});
p.setWidth(1,h);
p.setMinWidth(1,100);
p.setMaxWidth(1,320);
p.set(3,{width:100});
s.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
u.setShowCellFocusIndicator(false);
s.setCellEditorFactory(1,new demobrowser.demo.table.ModalCellEditorFactory());
return u;
}}});
...
z.moveTo(300,250);
z.addListener(f,function(e){z.__UA.focus();
z.__UA.setTextSelection(0,z.__UA.getValue().length);
});
z.__UA=new qx.ui.form.TextField(w.value+"").set({allowGrowY:true});
z.add(z.__UA);
...
return z;
},getCellEditorValue:function(A){return parseFloat(A.__UA.getValue());
}}});
})();
