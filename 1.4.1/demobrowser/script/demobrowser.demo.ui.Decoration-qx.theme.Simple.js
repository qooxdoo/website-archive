...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.ui.Decoration","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.ui.Decoration-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"b932992ac58e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
for(var g in j){e.add(new qx.ui.basic.Label(g).set({rich:true,wrap:true,decorator:g,padding:5,height:80,width:80}),{row:Math.floor(i/k),column:i%k});
i+=1;
}return e;
}}});
})();
