...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.DateChooser","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.DateChooser-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"05df8ddbbb30"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
