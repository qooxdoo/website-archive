...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Spinner","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Spinner-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"15d5483a4b9c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var s="0",r="middle",q="100",p="left",o="Disabled",n="Not Editable",m="demobrowser.demo.widget.Spinner",l="Stepped",k="Wrap",j="-3000",c="30",i="300",g="3000",b="changeValue",a="-30",f="Simple",d="Number format",h="right";
qx.Class.define(m,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(t,u){var v=new qx.ui.form.Spinner();
t.add(new qx.ui.basic.Label(f),{column:0,row:u});
t.add(new qx.ui.basic.Label(s),{column:1,row:u});
t.add(v,{column:2,row:u});
t.add(new qx.ui.basic.Label(q),{column:3,row:u});
v.addListener(b,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(w,x){var y=new qx.ui.form.Spinner(0,50,100);
y.setEditable(false);
w.add(new qx.ui.basic.Label(n),{column:0,row:x});
w.add(new qx.ui.basic.Label(s),{column:1,row:x});
w.add(y,{column:2,row:x});
w.add(new qx.ui.basic.Label(q),{column:3,row:x});
},addWrappingSpinner:function(z,A){var B=new qx.ui.form.Spinner(-30,30,30);
B.setWrap(true);
z.add(new qx.ui.basic.Label(k),{column:0,row:A});
z.add(new qx.ui.basic.Label(a),{column:1,row:A});
z.add(B,{column:2,row:A});
z.add(new qx.ui.basic.Label(c),{column:3,row:A});
},addSteppedSpinner:function(C,D){var E=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
C.add(new qx.ui.basic.Label(l),{column:0,row:D});
C.add(new qx.ui.basic.Label(j),{column:1,row:D});
C.add(E,{column:2,row:D});
C.add(new qx.ui.basic.Label(g),{column:3,row:D});
},addDisabledSpinner:function(F,G){var H=new qx.ui.form.Spinner;
H.setEnabled(false);
F.add(new qx.ui.basic.Label(o),{column:0,row:G});
F.add(new qx.ui.basic.Label(s),{column:1,row:G});
F.add(H,{column:2,row:G});
F.add(new qx.ui.basic.Label(q),{column:3,row:G++});
},addFormattedSpinner:function(I,J){var K=new qx.ui.form.Spinner(0,200,300);
K.setSingleStep(0.5);
K.setWidth(70);
var L=new qx.util.format.NumberFormat();
L.setMinimumFractionDigits(2);
L.setMaximumFractionDigits(2);
K.setNumberFormat(L);
I.add(new qx.ui.basic.Label(d),{column:0,row:J});
I.add(new qx.ui.basic.Label(s),{column:1,row:J});
I.add(K,{column:2,row:J});
I.add(new qx.ui.basic.Label(i),{column:3,row:J++});
},main:function(){qx.application.Standalone.prototype.main.call(this);
var N=new qx.ui.layout.Grid(10,8);
N.setColumnAlign(0,p,r);
N.setColumnAlign(1,h,r);
N.setColumnAlign(2,p,r);
N.setColumnAlign(3,p,r);
var M=new qx.ui.container.Composite(N);
M.setPadding(10);
this.getRoot().add(M,{left:0,top:0});
this.addSimpleSpinner(M,0);
this.addNonEditableSpinner(M,1);
this.addWrappingSpinner(M,2);
this.addSteppedSpinner(M,3);
this.addDisabledSpinner(M,4);
this.addFormattedSpinner(M,5);
}}});
})();
