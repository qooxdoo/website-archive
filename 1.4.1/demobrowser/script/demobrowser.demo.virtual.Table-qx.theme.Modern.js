...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Table","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Table-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"94880be16137"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var g=" / ",f="horizontal",e="__VH",d="demobrowser.demo.virtual.Table",c="white",b="#EEE",a="vertical";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__VH:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
this.__VH=new qx.ui.virtual.cell.Cell();
},getCellProperties:function(j,k){return this.__VH.getCellProperties(j+g+k);
...
},properties:{defaultLineColor:{init:e,check:c,themeable:true},defaultLineSize:{init:1,check:b,themeable:true}},members:{__MJ:null,__MK:null,isHorizontal:function(){return this._isHorizontal;
...
if(this.__ML(l)){this.updateLayerData();
...
if(this.__ML(n)){this.updateLayerData();
}},__ML:function(p){if(this._isHorizontal){var t=this.getFirstColumn();
var r=t+this.getColumnSizes().length-1;
return p>=t&&p<=r;
}else{var s=this.getFirstRow();
var q=s+this.getRowSizes().length-1;
return p>=s&&p<=q;
}},getLineSize:function(u){return this.__MK[u]||this.getDefaultLineSize();
},getLineColor:function(v){return this.__MJ[v]||this.getDefaultLineColor();
},__MM:function(w,z,A){var top=0;
var B,C;
...
if(this._isHorizontal){this.__MM(N,J,L);
}else{this.__MN(N,K,M);
...
}}},destruct:function(){this.__MJ=this.__MK=null;
}});
})();
