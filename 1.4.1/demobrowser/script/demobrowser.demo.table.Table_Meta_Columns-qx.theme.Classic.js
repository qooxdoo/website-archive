...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.table.Table_Meta_Columns","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.table.Table_Meta_Columns-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"ff5139d80c22"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var f="A number",e="ID",d="A date",c="Boolean test",b="Table with meta columns",a="demobrowser.demo.table.Table_Meta_Columns";
qx.Class.define(a,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return b;
},createTable:function(){var h=new qx.ui.table.model.Simple();
h.setColumns([e,f,d,c]);
var i=[];
var l=new Date().getTime();
var g=400*24*60*60*1000;

for(var m=0;m<100;m++){var j=new Date(l+Math.random()*g-g/2);
i.push([m,Math.random()*10000,j,(Math.random()>0.5)]);
}h.setData(i);
h.setColumnEditable(1,true);
h.setColumnEditable(2,true);
var k=new qx.ui.table.Table(h);
k.setMetaColumnCounts([1,-1]);
k.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
k.getTableColumnModel().setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
k.getTableColumnModel().setColumnWidth(1,250);
k.getTableColumnModel().setColumnWidth(2,200);
return k;
}}});
})();
