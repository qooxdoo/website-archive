...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Flex","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.HBox_Flex-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c14c37e5cc9c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
}},properties:{sort:{check:[h,r,l],init:h,apply:p},separatorX:{check:g,nullable:true,apply:k},separatorY:{check:g,nullable:true,apply:k},connectSeparators:{check:b,init:false,apply:k},spacingX:{check:j,init:0,apply:k},spacingY:{check:j,init:0,apply:k}},members:{__Cz:null,__CA:null,verifyLayoutProperty:qx.core.Environment.select(v,{"true":function(C,name,D){this.assertInArray(name,[d,e,a,u],w+name+t);
...
},__CB:{north:1,south:2,west:3,east:4,center:5},__CC:{1:"top",2:"bottom",3:"left",4:"right"},__CD:function(){var E=this._getLayoutChildren();
var M,G;
var length=E.length;
var I=[];
var L=[];
...
},renderLayout:function(O,P){if(this._invalidChildrenCache){this.__CD();
