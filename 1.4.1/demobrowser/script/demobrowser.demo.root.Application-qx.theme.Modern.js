...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.root.Application","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.root.Application-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"f65174d94ff3"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var f="main",e="yellow",d="red",c="demobrowser.demo.root.Application",b="green",a="blue";
...
var k=new qx.ui.core.Widget().set({backgroundColor:d,decorator:f,padding:10});
...
var h=new qx.ui.core.Widget().set({backgroundColor:e,decorator:f});
