...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.CellEvents","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.CellEvents-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"d418e156dfec"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.__Vk(s);
},__Vk:function(t){this.logger.setHtml(this.logger.getHtml()+t);
