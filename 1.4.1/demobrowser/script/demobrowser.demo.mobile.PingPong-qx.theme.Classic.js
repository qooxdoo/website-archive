...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.PingPong","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"351c53e4fd8a"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="touchmove",j="div",i="100%",h="right",g="left",f="black",d="green",c="demobrowser.demo.mobile.PingPong",b="30px",a="qx.debug",w="0px",v="12px",u="event.touch",t='Lucida Grande',s="innerHTML",r="qx.mobile.emulatetouch",q="engine.name",p="20px",o="webkit",n="none",l="<b>This demo is supposed to be run in a WebKit-based browser on a touch-enabled device.</b>",m="absolute";
qx.Class.define(c,{extend:qx.application.Native,members:{__Ty:null,__Tz:null,__TA:null,__TB:null,__TC:5,__TD:1,__TE:1,__TF:null,__TG:null,__TH:null,main:function(){qx.application.Native.prototype.main.call(this);
if(qx.core.Environment.get(a)){qx.log.appender.Native;
qx.log.appender.Console;
}var B={"width":i,"height":i,"backgroundColor":f,"margin":w,"userSelect":n};
var E=new qx.html.Element(j,B);
E.useElement(document.body);
E.setRoot(true);

if(qx.core.Environment.get(q)!=o||(!qx.core.Environment.get(u)&&qx.core.Environment.get(r)==false)){var D={"color":d,"font-family":t,"font-size":v,"position":m,"left":b,"top":p};
var C=new qx.html.Element(j,D);
E.add(C);
C.setAttribute(s,l);
return;
}var z=this.__TM(g);
...
var A=this.__TM(h);
E.add(A);
this.__Tz=this.__TN(g);
z.add(this.__Tz);
z.addListener(k,qx.lang.Function.bind(this.__TL,this,this.__Tz),this);
this.__Ty=this.__TN(h);
A.add(this.__Ty);
A.addListener(k,qx.lang.Function.bind(this.__TL,this,this.__Ty),this);
this.__TA=this.__TO();
E.add(this.__TA);
this.__TG=this.__TP();
z.add(this.__TG);
...
this.__TF=[0,0];
this.__TI();
},__TI:function(){this.__TA.setStyles({"left":"200px","top":"200px"});
this.__TB=new qx.event.Timer(40);
this.__TB.addListener("interval",function(){var x=(parseInt(this.__TA.getStyle("left"))+this.__TC*this.__TD);
var y=(parseInt(this.__TA.getStyle("top"))+this.__TC*this.__TE);
this.__TA.setStyle("left",x+"px");
this.__TA.setStyle("top",y+"px");
this.__TK();
},this);
this.__TB.start();
},__TJ:function(F){this.__TB.stop();
this.__TB.dispose();
this.__TC=5;
this.__TF[F]=this.__TF[F]+1;
this.__TG.setAttribute("innerHTML",this.__TF[0]);
this.__TH.setAttribute("innerHTML",this.__TF[1]);
this.__TI();
},__TK:function(){var H=this.getBoundsFor(this.__TA);
if(H.top<=0){this.__TE=1;
}if(H.bottom>=window.innerHeight-5){this.__TE=-1;
}if(H.left<=0||H.right>=window.innerWidth){this.__TJ(H.left<=0?1:0);
}var I=this.getBoundsFor(this.__Tz);

if(H.left<=I.right&&H.bottom>=I.top&&H.top<=I.bottom){this.__TD=1;
this.__TC=Math.min(this.__TC+1,20);
}var G=this.getBoundsFor(this.__Ty);

if(H.right>=G.left&&H.bottom>=G.top&&H.top<=G.bottom){this.__TD=-1;
this.__TC=Math.min(this.__TC+1,20);
}},__TL:function(J,e){J.setStyles({"top":(e.getDocumentTop()-50)+"px"});
},getBoundsFor:function(K){return qx.bom.element.Location.get(K.getDomElement());
},__TM:function(L){var M={"width":"50%","height":"100%","position":"absolute","backgroundColor":"black"};

if(L=="left"){M["border-right"]="1px solid white";
}else{M["left"]="50%";
M["border-left"]="1px solid white";
}return new qx.html.Element("div",M);
},__TN:function(N){var O={"width":"30px","height":"100px","top":"100px","position":"absolute","backgroundColor":"white"};
O[N]="20px";
return new qx.html.Element("div",O);
},__TO:function(){var P={"width":"20px","height":"20px","position":"absolute","backgroundColor":"white","userSelect":"none"};
return new qx.html.Element("div",P);
},__TP:function(){var Q={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};
var R=new qx.html.Element("div",Q);
R.setAttribute("innerHTML","0");
return R;
}}});
})();
