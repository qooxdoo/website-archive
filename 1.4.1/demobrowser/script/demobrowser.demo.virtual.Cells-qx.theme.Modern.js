...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.virtual.Cells","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.virtual.Cells-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"79cdd617b796"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="",i="' ",h="<b>HTML</b>",g="px;",f="Juhu",e="testImageCell",d="content",c="</div>",b="<div ",a="testNumberCell",D="class='",C="width:",B="testHtmlCell",A="testDateCell",z="css.boxmodel",y=">",x="height:",w="testStringCell",v="testBooleanCellCustomImage",u="demobrowser.demo.virtual.Cells",q="testBooleanCell",r="foobar!",o="style='",p="medium",m="main",n="icon/16/emotes/face-sad.png",k="icon/16/apps/internet-feed-reader.png",l="icon/16/emotes/face-smile.png",s="This is a feed reader!",t="icon/32/apps/utilities-notes.png";
...
var E=new qx.ui.layout.HBox(5);
this.topContainer=new qx.ui.container.Composite(E);
this.runTest(w);
this.runTest(a);
this.runTest(A);
this.runTest(B);
...
},testStringCell:function(){var H={value:[f,h,j,null],states:[{},{selected:1}]};
var G=new qx.ui.virtual.cell.String;
qx.util.Permutation.permute(H,function(I){var J=this.__Vm(G,I.value,I.states);
this.container.add(J);
},this);
},testNumberCell:function(){var K={value:[-1.666666,0,null],format:[null,new qx.util.format.NumberFormat().set({maximumFractionDigits:2})],states:[{},{selected:1}]};
var L=new qx.ui.virtual.cell.Number();
qx.util.Permutation.permute(K,function(M){if(M.format){L.setNumberFormat(M.format);
}else{L.resetNumberFormat();
}var N=this.__Vm(L,M.value,M.states);
this.container.add(N);
},this);
},testDateCell:function(){var O={value:[new Date(),null],format:[null,new qx.util.format.DateFormat(qx.locale.Date.getDateFormat(p))],states:[{},{selected:1}]};
var P=new qx.ui.virtual.cell.Date();
qx.util.Permutation.permute(O,function(Q){if(Q.format){P.setDateFormat(Q.format);
}else{P.resetDateFormat();
}var R=this.__Vm(P,Q.value,Q.states);
this.container.add(R);
},this);
},testHtmlCell:function(){var S={value:[f,h,j,null],states:[{},{selected:1}]};
var T=new qx.ui.virtual.cell.Html;
qx.util.Permutation.permute(S,function(U){var V=this.__Vm(T,U.value,U.states);
this.container.add(V);
},this);
},testImageCell:function(){var W={value:[{url:k,tooltip:s},{url:t,tooltip:r},null],states:[{},{selected:1}]};
var X=new qx.ui.virtual.cell.Image;
qx.util.Permutation.permute(W,function(Y){var ba=this.__Vm(X,Y.value,Y.states);
this.container.add(ba);
},this);
},testBooleanCell:function(){var bb={value:[true,false,null],states:[{},{selected:1}]};
var bc=new qx.ui.virtual.cell.Boolean;
qx.util.Permutation.permute(bb,function(bd){var be=this.__Vm(bc,bd.value,bd.states);
this.container.add(be);
},this);
},testBooleanCellCustomImage:function(){var bf={value:[true,false,null],states:[{},{selected:1}]};
var bg=new qx.ui.virtual.cell.Boolean;
bg.setIconFalse(n);
bg.setIconTrue(l);
qx.util.Permutation.permute(bf,function(bh){var bi=this.__Vm(bg,bh.value,bh.states);
this.container.add(bi);
},this);
},__Vm:function(bj,bk,bl){var bp=100;
var bn=30;
var br=new qx.ui.embed.Html().set({width:bp,height:bn,decorator:bl.selected?null:m});
var bm=bj.getCellProperties(bk,bl);
var bo=bm.insets;
var bq=[b,o,this._getCellSizeStyle(bp,bn,bo[0],bo[1]),bm.style,i,D,bm.classes,i,bm.attributes,y,bm.content,c].join(j);
br.setHtml(bq);
return br;
},_getCellSizeStyle:function(bs,bt,bu,bv){var bw=j;

if(qx.core.Environment.get(z)==d){bs-=bu;
bt-=bv;
}bw+=C+bs+g;
bw+=x+bt+g;
return bw;
...
this.__Ik=qx.ui.virtual.cell.CellStylesheet.getInstance();
this.__Il={};
this.__Im={};
this.__In={};
this.__Io={};
...
for(var K in N){if(!O[K]){this.__Ir.push(K);
}}L=L.superclass;
}},_getCssProperties:function(){return [J,l,C,q,d,c,e,h];
},_applyAppearance:function(P,Q){if(Q){this.__Im={};
}},_getValue:function(R){if(this.__It){return qx.util.PropertyUtil.getThemeValue(this,R);
}else{return qx.util.PropertyUtil.getUserValue(this,R);
}},_storeStyle:function(S,T){var U;

if(this.__It){U=this.__Im;
}else{U=this.__Il;
}
...
}},getCellProperties:function(bj,bk){this.__Iv(bk);
...
},getCssClasses:function(bp,bq){var br=this.__Ik.getCssClass(this.__Is)||f;
return n+br;
},__Iv:function(bs){if(!bs){bs={};
}var bu=this.getAppearance();
var bt=bu+a+qx.lang.Object.getKeys(bs).sort().join(x);

if(this.__Is==bt){return;
}this.__Is=bt;
var bv=this.__Ip[this.__Is];

if(!bv){this.__Iw();
this.__Ix(bs);
this.__Iy(bs);
this.__Iz();
this.__Ip[this.__Is]=1;
}this.__IA();
},__Iw:function(){var bw=qx.util.PropertyUtil;
var bx=this._getCssProperties();

for(var i=0;i<bx.length;i++){bw.deleteThemeValue(this,bx[i]);
}},__Ix:function(by){this.__Im={};
this.__It=true;
...
},__Iy:function(){var bD=qx.lang.Object.getValues(this.__Im).join(b);
this.__Ik.computeClassForStyles(this.__Is,bD);
},__Iz:function(){var bI=this.__Ir;
...
}}this.__Iq[this.__Is]=bG;
},__IA:function(){var bK=qx.util.PropertyUtil;
var bJ=this.__Iq[this.__Is]||{};

for(var bL in bJ){bK.setThemed(this,bL,bJ[bL]);
}},getStyles:function(bM,bN){return qx.lang.Object.getValues(this.__Il).join(b);
},getInsets:function(bO,bP){var bT=this.__In;
var bS=this.__Io;
...
return [bU+bQ,top+bR];
}},destruct:function(){this.__Ik=this.__Il=this.__Im=this.__In=this.__Io=this.__Ip=this.__Iq=this.__Ir=null;
}});
})();
...
}this.__IF=qx.bom.Stylesheet.createElement(o);
this.__IG={};
this.__IH={};
},members:{__IF:null,__IG:null,__IH:null,getStylesheet:function(){return this.__IF;
},getCssClass:function(p){return this.__IG[p]||null;
},computeClassForStyles:function(q,r){var s=this.__IH[r];

if(!s){var s=this.__II();
qx.bom.Stylesheet.addRule(this.__IF,b+s,r);
this.__IH[r]=s;
}this.__IG[q]=s;
return s;
},__II:function(){return "qx-cell-"+this.toHashCode()+"-"+(this.__IJ++);
},__IJ:0},destruct:function(){this.__IF=this.__IG=this.__IH=null;
}});
})();
...
(function(){var u="",t="px",s='" ',r="no-repeat",q="engine.version",p="engine.name",o='" style="',n="abstract",m='<div style="',l='"',e='></div>',k="qx.ui.virtual.cell.AbstractImage",h="gecko",c="img",b="inline-block",g='/>',f="static",i="top",a='<img src="',j='title="',d="-moz-inline-box";
...
},members:{__IB:16,__IC:16,_aliasManager:null,__ID:function(v){var y=qx.util.ResourceManager.getInstance();
...
},__IE:function(A){if(typeof (A)=="string"){A={url:A};
...
var H=this.__IE(this._identifyImage(E));
var L=qx.core.Environment.get(p)==h&&qx.core.Environment.get(q)<1.9;
var I=H.tooltip?j+H.tooltip+l:u;
var G={width:H.width+t,height:H.height+t,display:L?d:b,verticalAlign:i,position:f};
...
this.__NE=qx.util.AliasManager.getInstance();
},properties:{appearance:{refine:true,init:a},iconTrue:{check:e,themeable:true,apply:b},iconFalse:{check:e,themeable:true,apply:d}},members:{__NF:null,__NG:null,__NE:null,_applyIconTrue:function(f){this.__NF=this.__NE.resolve(f);
},_applyIconFalse:function(g){this.__NG=this.__NE.resolve(g);
},_identifyImage:function(h){return h==true?this.__NF:this.__NG;
}}});
})();
