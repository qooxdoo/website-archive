...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.Atom","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Atom-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"c0a5841d517b"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var j="main",i="#E6EDFA",h="#E6FAED",g="icon/32/apps/internet-feed-reader.png",f="Atom With Long Label",e="top",d="Wider Atom",c="icon/32/apps/utilities-notes.png",b="#FAF8E6",a="Icon Top",A="Icon Bottom",z="bottom",y="icon/32/actions/go-previous.png",x="Atom Without Label",w="icon/32/actions/go-next.png",v="icon/32/actions/go-up.png",u="Icon Left",t="demobrowser.demo.widget.Atom",s="icon",r="icon/32/actions/go-down.png",p="left",q="right",n="Atom Without Icon",o="Higher Atom",l="#EAE6FA",m="label",k="Icon Right";
...
var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
this.getRoot().add(B,{left:20,top:20});
B.add(new qx.ui.basic.Atom(u,y).set({backgroundColor:h,decorator:j,iconPosition:p,padding:5,allowGrowY:false}));
B.add(new qx.ui.basic.Atom(a,v).set({backgroundColor:h,decorator:j,iconPosition:e,padding:5,allowGrowY:false}));
B.add(new qx.ui.basic.Atom(k,w).set({backgroundColor:h,decorator:j,iconPosition:q,padding:5,allowGrowY:false}));
B.add(new qx.ui.basic.Atom(A,r).set({backgroundColor:h,decorator:j,iconPosition:z,padding:5,allowGrowY:false}));
B.add(new qx.ui.core.Spacer().set({width:40}));
B.add(new qx.ui.basic.Atom(x,g).set({backgroundColor:b,decorator:j,show:s,padding:5,allowGrowY:false}));
B.add(new qx.ui.basic.Atom(n,g).set({backgroundColor:b,decorator:j,show:m,padding:5,allowGrowY:false}));
var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
this.getRoot().add(D,{left:20,top:150});
D.add(new qx.ui.basic.Atom(f).set({backgroundColor:i,decorator:j,padding:5,width:100,allowGrowY:false}));
D.add(new qx.ui.basic.Atom(f,g).set({backgroundColor:i,decorator:j,padding:5,width:150,allowGrowY:false}));
D.add(new qx.ui.basic.Atom(f,g).set({backgroundColor:l,decorator:j,iconPosition:e,padding:5,width:100,allowGrowY:false}));
var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
this.getRoot().add(C,{left:20,top:250});
C.add(new qx.ui.basic.Atom(d).set({backgroundColor:i,decorator:j,center:true,padding:5,width:100,allowGrowY:false}));
C.add(new qx.ui.basic.Atom(d,c).set({backgroundColor:i,decorator:j,center:true,padding:5,width:140,allowGrowY:false}));
C.add(new qx.ui.basic.Atom(o,c).set({backgroundColor:i,decorator:j,iconPosition:e,center:true,padding:5,height:100,allowGrowY:false}));
}}});
})();
