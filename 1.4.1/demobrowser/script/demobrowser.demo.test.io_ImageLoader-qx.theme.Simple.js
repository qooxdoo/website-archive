...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.io_ImageLoader","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.io_ImageLoader-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"288a1ae25b1c"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
