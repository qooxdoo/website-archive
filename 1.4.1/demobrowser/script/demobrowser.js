...
var envinfo = {"qx.application":"demobrowser.Application","qx.contrib":false,"qx.revision":"27304","qx.theme":"demobrowser.Theme","qx.version":"1.4.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"demobrowser":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.4.1"}};
...
(function(){var j="qx.debug",h="qx.allowUrlSettings",g="&",f="qx.core.Setting",e="qx.allowUrlVariants",d="qx.propertyDebugLevel",c="qxsetting",b=":",a=".";
qx.Bootstrap.define(f,{statics:{__v:{},define:function(k,l){if(qx.core.Environment.get(j)){qx.Bootstrap.warn("The method 'qx.core.Setting.define' is deprecated: "+"Please use qx.core.Environment.add() instead.");
...
},setDeprecated:function(s,t){if((s.split(a)).length<2){throw new Error('Malformed settings key "'+s+'". Must be following the schema "namespace.key".');
}
...
}var x=document.location.search.slice(1).split(g);

for(var i=0;i<x.length;i++){var w=x[i].split(b);

if(w.length!=3||w[0]!=c){continue;
}
...
}}},defer:function(y){y.defineDeprecated(h,false);
y.defineDeprecated(e,false);
y.defineDeprecated(d,0);
y.__w();
}});
})();
...
(function(){var dv="execute",du="visible",dt="excluded",ds="/",dr="current",dq="",dp="value",dn="auto",dm=" ",dl="modelLink",cj="qx.version",ci="tags",ch="category",cg="~",cf=".",ce="changeSelection",cd="completed",cc="failed",cb="white",ca="html",dC="qooxdoo ",dD="all",dA="interval",dB="monospace",dy="Demos",dz="div",dw="id",dx="node",dE=".src.js",dF="_blank",cT=" Demo Browser ",cS=".html",cV="#",cU="noPlayground",cX="<script",cW="horizontal",da="_",cY="enabled",cR="right",cQ="main",o="qx_srcview",p="js",q="Unable to access application.",v="outputviews.sourcepage.html.page",x="widget",y="icon/22/mimetypes/text-html.png",z="outputviews.sourcepage.js.page",A="visibility",B="http://demo.qooxdoo.org/",C="log",dT="separator-vertical",dS="request",dR="src",dQ="icon/22/actions/edit-clear.png",dX="Simple Theme",dW="^.*",dV="filled",dU="Clear log",ea="changeValue",dY="Display HTML source",bp="browser.name",bq="dblclick",bn="icon/22/actions/media-playback-start.png",bo="Open the qooxdoo Manual",bt="demobrowser.DemoBrowser",bu="HTML Code",br="load",bs="Run previous demo",bl="http://manual.qooxdoo.org/",bm="//",U="_history",T="ie",W="icon/22/actions/help-contents.png",V='_cmdNamespacePollution',Q="_leftComposite",P="icon/22/apps/utilities-color-chooser.png",S="_status",R="Ctrl+N",O="__Sc",N="Previous",bz='.html',bA="Run",bB="__RV",bC="<div class='script'>The sample source will be displayed here.</div>",bv="_searchTextField",bw="Open demo in the playground",bx="tree1",by="icon/22/actions/help-about.png",bD="<div class='script'>The sample JS source will be displayed here.</div>",bE="f1",bg="Debug",bf="Display log file",be="script/demobrowser.demo",bd="icon/22/actions/media-playback-stop.png",bc="icon/22/apps/utilities-log-viewer.png",bb="Ctrl+O",ba="Log File",Y="Stop playback after current demo",bk="qx.theme.Classic",bj="_nextButton",bF='"',bG="Get Demo Link",bH="logappender",bI="_runbutton",bJ="Choose theme",bK="icon/22/apps/internet-web-browser.png",bL="f2",bM="Ctrl+Right",bN="_stopbutton",bO="JS Code",cr="icon/22/mimetypes/executable.png",cq="ig",cp="middle",co="Unable to access namespace. Maybe no demo loaded.",cv="Stop",cu='"}',ct="_urlWindow",cs="icon/22/actions/edit-redo.png",cz='_cmdDisposeSample',cy="qx.theme.Modern",cM="__RU",cN="toolbar",cK="icon/22/apps/office-spreadsheet.png",cL="To Playground",cI="/demo/",cJ="demo/welcome.html",cG='_cmdSampleInOwnWindow',cH=".*",cO="background-splitpane",cP='demo/',de="__Se",dd="Open the qooxdoo API Viewer",dg="javascript",df="Debugging options",di="Ctrl+P",dh="Filter...",dk="Manual",dj="app-header",dc="/playground/",db="Dispose Demo",dM='{"code": ',dN="Classic Theme",dO="/apiviewer/",dP="__Sd",dI="Global Namespace Pollution",dJ="viewGroup",dK="icon/16/actions/edit-find.png",dL="treeview.flat",dG="Own Window",dH='_cmdObjectSummary',n="_prevButton",l='/',k='_cmdNextSample',h="Demo has been disposed.",g="Run next demo",f='_cmdPrevSample',d=" Start",c="\"",b="background-medium",a="Ctrl+Left",F="demo-tree",G="Display JavaScript source",D='_cmdRunSample',E="Next",J="F5",K="_demoView",H="icon/22/actions/application-exit.png",I="Modern Theme",L="Open demo in new window",M="string",cA="API Viewer",cx="_infosplit",cF="runbutton",cB="8px",cm="_navPart",ck="?qx.theme=",X="textfield",cn="Ctrl+D",bi="mainsplit",bh="Could not open the Playground.",bR="icon/22/actions/go-previous.png",bS="Object Summary",bT="_tree",bU="Demo Browser",bV="-",bW="?",bX="Run the selected demo(s)",bY="__RW",bP="left",bQ="icon/22/actions/go-next.png",cl="Demo Link",cE="qx.theme.Simple",cD="Theme",cC="_iframe";
qx.Class.define(bt,{extend:qx.ui.container.Composite,construct:function(){qx.ui.container.Composite.call(this);
var ee=new qx.ui.layout.VBox;
ee.setSeparator(dT);
this.setLayout(ee);
this.add(this._createHeader());
this.widgets={};
this.tests={};
this.__RT="qx.theme.Modern";
this.__Sh();
this.__RU=this.__Sq();
this.add(this.__RU);
var ei=new qx.ui.splitpane.Pane(cW);
this.mainsplit=ei;
var ef=new qx.ui.splitpane.Pane(cW);
ef.setDecorator(null);
this._infosplit=ef;
this.add(ei,{flex:1});
var ek=this._leftComposite=new qx.ui.container.Composite();
ek.setLayout(new qx.ui.layout.VBox(3));
ek.setBackgroundColor(cO);
ei.add(ek,0);
var ed=new qx.ui.container.Composite();
ed.setLayout(new qx.ui.layout.HBox(3));
ed.setAppearance(X);
ek.add(ed);
var el=new qx.ui.basic.Image(dK);
ed.add(el);
...
this._searchTextField.setPlaceholder(dh);
var ej=new qx.event.Timer(500);
ej.addListener(dA,function(em){this.filter(this._searchTextField.getValue());
ej.stop();
},this);
this._searchTextField.addListener(ea,function(en){ej.restart();
},this);
ed.add(this._searchTextField,{flex:1});
this._status=new qx.ui.basic.Label(dq);
this._status.setAppearance(x);
this._status.setWidth(80);
this._status.setTextAlign(cR);
ed.add(this._status);
ei.add(ef,1);
this._tree=this.__Sv();
ek.add(this._tree,{flex:1});
this.__Sw();
this._demoView=this.__Sr();
{ef.add(this._demoView,2);
};
var eb=this.__St();
var ec=this.__Su();
var eg=this.__Ss();
var eh=new qx.ui.container.Stack;
eh.setDecorator(cQ);
eh.add(eb);
eh.add(ec);
eh.add(eg);
this.viewGroup.addListener(ce,function(e){var eo=e.getData()[0];
var ep=eo!=null?eo.getUserData(dp):dq;

switch(ep){case ca:this.setSelection([eb]);
eh.show();
break;
case p:this.setSelection([ec]);
eh.show();
break;
case C:this.setSelection([eg]);
eh.show();
break;
...
this._history.addListener(dS,function(e){var eq=e.getData().replace(cg,ds);

if(this._currentSample!=eq){this.setCurrentSample(eq);
}},this);
this.__RV=[this.__Sc,this.__Sd,this.__Se];
{this.__RV.push(this.__Sa);
};
this.__RW=new qx.event.Timer(250);
this.__RW.addListener(dA,this.__Sy,this);
this.__RW.start();
this.__RX=new demobrowser.InfoWindow(this.tr("Info"));
this.__RX.setAutoCenter(true);
},properties:{playDemos:{check:[dD,ch,dr],init:dr}},members:{_iframe:null,__RT:null,__RW:null,__RY:null,_tree:null,_status:null,_searchTextField:null,__Sa:null,__Sb:null,__RV:null,_versionFilter:null,__Sc:null,__Sd:null,__Se:null,__Sf:null,__RU:null,_leftComposite:null,_infosplit:null,_demoView:null,__Sg:null,_urlWindow:null,__RX:null,defaultUrl:cJ,playgroundUrl:B+qx.core.Environment.get(cj)+dc,__Sh:function(){this._cmdObjectSummary=new qx.ui.core.Command(bb);
this._cmdObjectSummary.addListener(dv,this.__Si,this);
this._cmdRunSample=new qx.ui.core.Command(J);
this._cmdRunSample.addListener(dv,this.runSample,this);
this._cmdPrevSample=new qx.ui.core.Command(a);
this._cmdPrevSample.addListener(dv,this.playPrev,this);
this._cmdNextSample=new qx.ui.core.Command(bM);
this._cmdNextSample.addListener(dv,this.playNext,this);
this._cmdSampleInOwnWindow=new qx.ui.core.Command(R);
this._cmdSampleInOwnWindow.addListener(dv,this.__Sj,this);
this._cmdDisposeSample=new qx.ui.core.Command(cn);
this._cmdDisposeSample.addListener(dv,this.__So,this);
this._cmdNamespacePollution=new qx.ui.core.Command(di);
this._cmdNamespacePollution.addListener(dv,this.__Sp,this);
},__Si:function(){var es=this._iframe.getWindow();
var er;

if(es&&es.qx){er=es.qx.dev.ObjectSummary.getInfo();
}else{er=co;
}var et=new qx.ui.form.TextArea(er);
et.setDecorator(null);
et.setAutoSize(true);
et.setMaxHeight(qx.bom.Viewport.getHeight()-100);
this.__RX.setContent(et);
this.__RX.setWidth(400);
this.__RX.show();
},__Sj:function(){var eu=this._iframe.getSource();
window.open(eu,dF);
},__Sk:function(ew){var ey=!!ew;
var ez=this._tree.getSelection()[0].getUserData(ci);

if(ez){ey=ey&&!qx.lang.Array.contains(ez,cU);
}this.__Sa.setEnabled(ey);
this.__Sb=ew;
},__Sl:function(){if(this.__Sb){var eC=this.__Sb;
var eB=dM+bF+encodeURIComponent(eC)+cu;
var eA=this.playgroundUrl+cV+encodeURIComponent(eB);
window.open(eA,dF);
}else{var eD=new qx.ui.basic.Label(this.tr(bh));
this.__RX.setContent(eD);
this.__RX.setWidth(200);
this.__RX.show();
}},__Sm:function(){window.open(B+qx.core.Environment.get(cj)+dO);
},__Sn:function(){var eE=(qx.core.Environment.get(cj).split(bV)[0]);
window.open(bl+eE);
},__So:function(e){var eG=this._iframe.getWindow();
var eF;
...
eH.setRich(true);
eH.setWrap(true);
this.__RX.setContent(eH);
this.__RX.setWidth(350);
this.__RX.show();
},__Sp:function(e){var eJ=this._iframe.getWindow();
var eI;
...
eK.setRich(true);
eK.setWrap(true);
this.__RX.setContent(eK);
this.__RX.setWidth(350);
this.__RX.show();
},__Sq:function(){var fe=new qx.ui.toolbar.ToolBar();
this._navPart=new qx.ui.toolbar.Part();
fe.add(this._navPart);
this._runbutton=new qx.ui.toolbar.Button(this.tr(bA),bn);
this._runbutton.addListener(dv,this.runSample,this);
this._runbutton.setToolTipText(bX);
this._navPart.add(this._runbutton);
this._stopbutton=new qx.ui.toolbar.Button(this.tr(cv),bd);
this._stopbutton.addListener(dv,this.stopSample,this);
this._stopbutton.setToolTipText(Y);
this._navPart.add(this._stopbutton);
this._stopbutton.setVisibility(dt);
this._runbutton.setMinWidth(60);
this._stopbutton.setMinWidth(60);
var eR=new qx.ui.toolbar.Button(this.tr(N),bR);
eR.addListener(dv,this.playPrev,this);
eR.setToolTipText(bs);
this._navPart.add(eR);
this._prevButton=eR;
var fc=new qx.ui.toolbar.Button(this.tr(E),bQ);
fc.addListener(dv,this.playNext,this);
fc.setToolTipText(g);
this._navPart.add(fc);
this._nextButton=fc;
var eT={converter:function(fl){return fl==du;
}};
qx.data.SingleValueBinding.bind(this._runbutton,A,eR,cY,eT);
qx.data.SingleValueBinding.bind(this._runbutton,A,fc,cY,eT);
var fj=new qx.ui.toolbar.Button(this.tr(dG),cs);
fj.addListener(dv,this.__Sj,this);
fj.setToolTipText(L);
this.__Sc=fj;
this._navPart.add(fj);
{var fa=new qx.ui.toolbar.Button(this.tr(cL),H);
fa.addListener(dv,this.__Sl,this);
fa.setToolTipText(bw);
fa.setEnabled(false);
if(qx.core.Environment.get(bp)==T){fa.exclude();
}this.__Sa=fa;
this._navPart.add(fa);
var eX=new qx.ui.toolbar.Button(this.tr(cA),W);
this._navPart.add(eX);
eX.setToolTipText(this.tr(dd));
eX.addListener(dv,this.__Sm,this);
var eM=new qx.ui.toolbar.Button(this.tr(dk),by);
this._navPart.add(eM);
eM.setToolTipText(this.tr(bo));
eM.addListener(dv,this.__Sn,this);
};
var ff=new qx.ui.toolbar.Part;
this.__Se=ff;
fe.add(ff);
{var fb=new qx.ui.menu.Menu;
this.__Sf=fb;
var fi=new qx.ui.menu.RadioButton(I);
var fg=new qx.ui.menu.RadioButton(dN);
var fh=new qx.ui.menu.RadioButton(dX);
fi.setUserData(dp,cy);
fi.setValue(true);
fg.setUserData(dp,bk);
fh.setUserData(dp,cE);
var eU=new qx.ui.form.RadioGroup(fi,fg,fh);
eU.addListener(ce,this.__SD,this);
fb.add(fi);
fb.add(fg);
fb.add(fh);
var eS=new qx.ui.toolbar.MenuButton(this.tr(cD),P,fb);
eS.setToolTipText(bJ);
ff.add(eS);
};
var eV=new qx.ui.menu.Menu;
{var eW=new qx.ui.menu.Button(this.tr(bS));
eW.setCommand(this._cmdObjectSummary);
eV.add(eW);
var fk=new qx.ui.menu.Button(this.tr(dI));
fk.setCommand(this._cmdNamespacePollution);
eV.add(fk);
};
var eP=new qx.ui.menu.Button(this.tr(db));
eP.setCommand(this._cmdDisposeSample);
eV.add(eP);
var eQ=new qx.ui.toolbar.MenuButton(this.tr(bg),cK,eV);
eQ.setToolTipText(df);
ff.add(eQ);
var eY=new qx.ui.toolbar.Part;
this.__Sd=eY;
fe.addSpacer();
fe.add(eY);
{var fd=new qx.ui.toolbar.RadioButton(bu,bK);
fd.setToolTipText(dY);
var eO=new qx.ui.toolbar.RadioButton(bO,cr);
eO.setToolTipText(G);
fd.setUserData(dp,ca);
eO.setUserData(dp,p);
eY.add(fd);
eY.add(eO);
};
var eN=new qx.ui.toolbar.RadioButton(ba,bc);
...
return fe;
},__Sr:function(){var fm=new qx.ui.embed.Iframe().set({nativeContextMenu:true});
fm.addListener(br,this.__Sx,this);
this._iframe=fm;
return fm;
},__Ss:function(){var fp=new qx.ui.layout.VBox(0,cp,cQ);
fp.setAlignX(cR);
var fr=new qx.ui.container.Composite(fp);
var fn=new qx.ui.decoration.Background().set({backgroundColor:b});
fr.setDecorator(fn);
var fq=new qx.ui.form.Button(this.tr(dU),dQ);
fq.setAllowGrowX(false);
fq.setMargin(5);
fq.addListener(dv,function(){this.logappender.clear();
},this);
fr.add(fq,{flex:0});
this.f2=new qx.ui.embed.Html();
this.f2.setOverflow(dn,dn);
this.f2.setFont(dB);
this.f2.setBackgroundColor(cb);
this.logappender=new qx.log.appender.Element();
qx.log.Logger.unregister(this.logappender);
var fo=document.createElement(dz);
this.logelem=document.createElement(dz);
this.logelem.style.padding=cB;
this.logappender.setElement(this.logelem);
fo.appendChild(this.logelem);
this.f2.getContentElement().useElement(fo);
fr.add(this.f2,{flex:1});
return fr;
},__St:function(){var fs=new qx.ui.embed.Html(bC);
fs.setOverflow(dn,dn);
fs.setFont(dB);
fs.setBackgroundColor(cb);
this.widgets[v]=fs;
fs.getContentElement().setAttribute(dw,o);
return fs;
},__Su:function(){var ft=new qx.ui.embed.Html(bD);
ft.setOverflow(dn,dn);
ft.setFont(dB);
ft.setBackgroundColor(cb);
this.widgets[z]=ft;
ft.getContentElement().setAttribute(dw,o);
return ft;
},__Sv:function(){var fv=new qx.ui.tree.Tree();
var fu=new qx.ui.tree.TreeFolder(dy);
fv.setAppearance(F);
fv.setRoot(fu);
fv.setSelection([fu]);
this.tree=this.widgets[dL]=fv;
fv.addListener(ce,this.treeGetSelection,this);
fv.addListener(bq,function(e){qx.event.Timer.once(this.runSample,this,50);
},this);
return fv;
},__Sw:function(){var fw=new qx.ui.window.Window(this.tr(cl),y);
fw.setLayout(new qx.ui.layout.VBox(10));
fw.setAllowMaximize(false);
fw.setAllowMinimize(false);
var fz=new qx.ui.basic.Label(dq);
fz.setSelectable(true);
fz.setNativeContextMenu(true);
fw.add(fz);
this._urlWindow=fw;
var fA=Math.ceil((qx.bom.Viewport.getWidth()/2)-250);
...
this.getApplicationRoot().add(fw);
var fx=new qx.ui.menu.Menu();
var fy=new qx.ui.menu.Button(this.tr(bG),y);
fy.addListener(dv,function(e){var fC=this.tree.getSelection()[0];
var fE=fC.getUserData(dl);
var fB=this.tests.handler.getFullName(fE);
fB=fB.replace(cf,cg);
var fD=location.protocol+bm+location.host+location.pathname+cV+fB;
this._urlWindow.getChildren()[0].setValue(fD);
this._urlWindow.open();
},this);
fx.add(fy);
this._tree.setContextMenu(fx);
},treeGetSelection:function(e){var fF=this.tree.getSelection()[0];
var fG=fF.getUserData(dl);
this.tests.selected=this.tests.handler.getFullName(fG);
},leftReloadTree:function(e){this._sampleToTreeNodeMap={};
var fH=this._sampleToTreeNodeMap;
var fN=null;
var fQ=null;
var fP;
{fP=/\?autorun=true/.test(location.href);
};
var fM=this._history.getState();
var fK=fM.match(/([^~]+)~/);

if(fK){fN=fK[1];
}else{var fI=fM.match(/([^~][\w]*)/);

if(fI){fN=fI[1];

if(fP){this.setPlayDemos(ch);
}}else{fN=dy;

if(fP){this.setPlayDemos(dD);
}}}function fO(fR,fS){var fW=fS.getChildren();
var t;

for(var i=0;i<fW.length;i++){var fT=fW[i];

if(fT.hasChildren()){t=new qx.ui.tree.TreeFolder(fJ.polish(fT.label));
t.setUserData(dV,false);
t.setUserData(dx,fT);
fO(t,t.getUserData(dx));

if(fT.label==fN){fQ=t;
t.setOpen(true);
}}else{t=new qx.ui.tree.TreeFile(fJ.polish(fT.label));
var fV=fT.pwd().slice(1).join(ds)+ds+fT.label;

if(fT.tags){var j,m,fU;
t.setUserData(ci,fT.tags);
}fH[fV]=t;
}fR.add(t);
t.setUserData(dl,fT);
fT.widgetLinkFull=t;
}}var fL=this.tests.handler.ttree;
var fJ=this;
this.tree.setUserData(dl,fL);
this.tree.getRoot().setOpen(true);
fO(this.tree.getRoot(),fL);

if(fQ!=null){this.tree.setSelection([fQ]);
}},runSample:function(e){if(e&&(e.getType()===dv||e.getType()===dA)){if(this.tests.selected===dq){this.setPlayDemos(dD);
}else if(this.tests.selected.indexOf(ca)>0){if(this.__Sg){this.__Sg.stop();
}this.setPlayDemos(dr);
}else{this.setPlayDemos(ch);
}}this._runbutton.setVisibility(dt);
this._stopbutton.setVisibility(du);

if(this.tests.selected!=dq){var fX=this.tests.selected.replace(cf,ds);
this.setCurrentSample(fX);
}else{this.playNext();
}},stopSample:function(e){this.setPlayDemos(dr);
this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
},setCurrentSample:function(fY){if(!fY){return;
}
if(!this._sampleToTreeNodeMap){return;
}var ga;
var gc=this._sampleToTreeNodeMap[fY];

if(gc){gc.getTree().setSelection([gc]);
ga=cP+fY;
{ga+=ck+this.__RT;
};
var gb=gc.getUserData(ci);

if(gb){this.__Sa.setEnabled(!qx.lang.Array.contains(gb,cU));
}}else{ga=this.defaultUrl;
}
if(this._iframe.getSource()==ga){this._iframe.reload();
}else{this.__RY=false;
this._iframe.setSource(ga);
}if(ga==this.defaultUrl){this.disableMenuButtons();
}else{this.enableMenuButtons();
}this._currentSample=fY;
this._currentSampleUrl=ga;
},__Sx:function(){var gg=this._iframe.getWindow();
var gm=this._iframe.getSource();

if(gm!=null&&gm!=this.defaultUrl){var gf;

try{gf=gg.location.href;
}catch(go){gf=window.location.href;
var gn=gf.lastIndexOf(ds);

if(gn!=-1){gf=gf.substring(0,gn+1);
}gf+=gm;
}var gk=gf.indexOf(cI)+6;
var gh=gf.indexOf(bW);
gh=gh==-1?gf.length:gh;
var gi=gf.substring(gk,gh).split(ds);
var gl=String.fromCharCode(187);

if(gi.length==2){var gd=gi[0];
gd=gd.charAt(0).toUpperCase()+gd.substring(1);
var gj=gi[1].replace(cS,dq).replace(da,dm);
gj=gj.charAt(0).toUpperCase()+gj.substring(1);
var ge=dC+gl+cT+gl+dm+gd+dm+gl+dm+gj;
}else{var ge=dC+gl+cT+gl+d;
}document.title=ge;
}if(this.getPlayDemos()!=dr){if(!gj){this.playNext();
}else{var self=this;
this.__Sg=qx.event.Timer.once(this.playNext,self,5000);
this._nextButton.setEnabled(false);
this._prevButton.setEnabled(false);
}}else{this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
}},__Sy:function(e){var gp=this._iframe.getWindow();

try{if(gp&&gp.qx&&gp.qx.log&&gp.qx.log.appender){if(!this.__RY){this.__RY=true;
this.debug("Demo loaded: "+this._currentSample);
this.logappender.$$id=null;
this.logappender.clear();

try{gp.qx.log.Logger.register(this.logappender);
}catch(e){return ;
}this._history.addToHistory(this._currentSample.replace(ds,cg),document.title);
if(this._currentSampleUrl!=this.defaultUrl){this.__Sz(this._currentSampleUrl);
}}}else{this.__RY=false;
}}catch(gq){this.__RY=false;
}},filter:function(gr){var gz=new RegExp(dW+gr+cH,cq);
var gx=this._tree.getRoot().getItems(true,true);
var gy=0;
var gs=0;

for(var i=0;i<gx.length;i++){var gA=gx[i];
var parent=gA.getParent();
var gw=gA.getUserData(ci);
var gt=false;

if(gw!=null){for(var j=0;j<gw.length;j++){gt=!!gw[j].match(gz);

if(gt){break;
}}}
if(gA.getChildren().length==0){gs++;
}
if((gt||(gA.getLabel().search(gz)!=-1)||(parent.getLabel().search(gz)!=-1))){if(gA.getChildren().length==0){gy++;
}gA.show();
gA.getParent().setOpen(true);
gA.getParent().show();
}else{gA.exclude();
}}if(gr==dq){var gv=this._tree.getRoot().getItems(false,true);
var gu=this._tree.getSelection();
for(var i=0;i<gv.length;i++){if(gv[i]==gu[0]||gv[i]==gu[0].getParent()){continue;
}gv[i].setOpen(false);
}}this._status.setValue(gy+ds+gs);
},__Sz:function(gB){if(typeof (gB)!=M){return;
}var gC=new qx.io.remote.Request(gB);
gC.setTimeout(180000);
gC.setProhibitCaching(false);
gC.addListener(cd,function(gD){var content=gD.getContent();
if(content){{var gG=content.indexOf(cX,content.indexOf(cX)+7);
var gM=content.indexOf(dR,gG);
var gF=content.indexOf(c,gM+5);
var gH=content.substring(gM+5,gF);
var gK=gH.substring(4,gH.length-3)+dE;
var u=be;
var gJ=gB.split(l);
var gI=gJ[1];
var gL=gJ[2];
gL=gL.substr(0,gL.indexOf(bz));
u+=cf+gI+cf+gL+dE;
gK=u;
var gE=new qx.io.remote.Request(gK);
gE.setTimeout(180000);
gE.setProhibitCaching(false);
gE.addListener(cd,function(gN){var gO=gN.getContent();
this.__Sk(gO);

if(gO){this.widgets[z].setHtml(this.__SA(gO,dg));
}},this);
gE.addListener(cc,function(gP){this.error("Couldn't load file: "+gB);
},this);
gE.send();
this.widgets[v].setHtml(this.__SA(content));
};
}},this);
gC.addListener(cc,function(gQ){this.error("Couldn't load file: "+gB);
},this);
gC.send();
},dataLoader:function(gR){var gS=new qx.io.remote.Request(gR);
gS.setTimeout(180000);
gS.setProhibitCaching(false);
gS.addListener(cd,function(gT){var content=gT.getContent();
var gU=eval(content);
qx.event.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler(gU);
this.leftReloadTree();
var gV=this._history.getState();

if(gV){this.setCurrentSample(gV.replace(cg,ds));
}else{this.setCurrentSample(this.defaultUrl);
}},this,0);
},this);
gS.addListener(cc,function(gW){this.error("Couldn't load file: "+gR);
},this);
gS.send();
},playPrev:function(e){this.setPlayDemos(dr);
var hb=this.tree.getSelection()[0];

if(hb){var gX=this.tree.getPreviousNodeOf(hb,false);

if(!gX||gX==this.tree.getRoot()){return;
}
while(gX.isVisible&&!gX.isVisible()){gX=this.tree.getPreviousNodeOf(gX,false);
}
if(gX.getParent()==this.tree.getRoot()){var ha=this.tree.getPreviousNodeOf(gX,false);

while(ha.isVisible&&!ha.isVisible()){ha=this.tree.getPreviousNodeOf(ha,false);
}
if(ha.getParent()==this.tree.getRoot()){ha.setOpen(true);
var gY=this.tree.getPreviousNodeOf(gX,false);

while(gY.isVisible&&!gY.isVisible()){gY=this.tree.getPreviousNodeOf(gY,false);
}
if(ha!==gY){gX=gY;
}}else{gX=ha;
}}
if(!gX||gX===hb){this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
return;
}else{this.tree.setSelection([gX]);
this.runSample();
}}},playNext:function(e){this._nextButton.setEnabled(true);
this._prevButton.setEnabled(true);
var he=this.tree.getSelection()[0];

if(he){var hc=this.tree.getNextNodeOf(he);

if(!hc){this.setPlayDemos(dr);
this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
return;
}
if(hc.getParent()==this.tree.getRoot()){if(this.getPlayDemos()==ch){if(hc!=he&&hc!=he.getParent()){this.setPlayDemos(dr);
this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
return;
}}hc.setOpen(true);
hc=this.tree.getNextNodeOf(hc);
}
if(!hc){this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
return;
}
while(!hc.isVisible()){var hd=this.tree.getNextNodeOf(hc);

if(!hd){this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
return;
}
if(hd.getParent()==this.tree.getRoot()){hc.setOpen(true);
var hd=this.tree.getNextNodeOf(hd);
}hc=hd;
}
if(hc){this.tree.setSelection([hc]);
this.runSample();
}else{this._stopbutton.setVisibility(dt);
this._runbutton.setVisibility(du);
}}},__SA:function(hf,hg){var hh=new qx.util.StringBuilder("<pre class='script'>");
var hj=[];
var hk=new qx.util.StringBuilder();
var hl=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;
var hi=/^\s*<\/script>\s*$/i;
hf=hf.replace(/\r\n/g,"\n").replace(/\r/g,"\n");
var hj=hf.split('\n');
if(hg=="javascript"){return "<pre ><div class='script'>"+qx.dev.Tokenizer.javaScriptToHtml(hf)+"</div></pre>";
}
for(var i=0;i<hj.length;i++){if(hl.exec(hj[i])){hh.add(this.__SB(qx.bom.String.escape(hk.get()+hj[i])));
hk.clear();
}else if(hi.exec(hj[i])){var hm=qx.dev.Tokenizer.javaScriptToHtml(hk.get());
hh.add('<div class="script">',hm,'</div>');
hk.clear();
hk.add(hj[i],'\n');
}else{hk.add(hj[i],'\n');
}}hh.add(this.__SB(qx.bom.String.escape(hk.get())),"</pre>");
return hh.get();
},disableMenuButtons:function(){var hn=this.__RV;

for(var i=0;i<hn.length;i++){hn[i].setEnabled(false);
}},enableMenuButtons:function(){var ho=this.__RV;

for(var i=0;i<ho.length;i++){ho[i].setEnabled(true);
}},__SB:function(hp){var hr=hp;
function hq(hs){var s=new qx.util.StringBuilder(arguments[1],'<span class="html-tag-name">',arguments[2],'</span>');
var ht;
var hu=false;
if(arguments.length-2>3){for(var i=3;i<arguments.length-2;i++){ht=arguments[i];
...
while((r=m.exec(ht))!=null){s.add(' <span class="keyword">',r[1],'</span>=<span class="string">',r[2].replace(/\s*$/,""),'</span>');
}}}s.add((hu?"/":""));
}s.add('&gt;');
return s.get();
}hr=hr.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,hq);
return hr;
},polish:function(hv){return hv.replace(cS,dq).replace(da,dm);
},__SC:function(){var w=this._iframe.getWindow();
var hw;

if(w.qx&&w.qx.log&&w.qx.log.Logger){hw=w.qx.log.Logger;
hw.register(this.logappender);
hw.clear();
hw.unregister(this.logappender);
}},__SD:function(e){this.__RT=e.getData()[0].getUserData("value");
this.runSample();
},_createHeader:function(){var hz=new qx.ui.layout.HBox();
var hx=new qx.ui.container.Composite(hz);
hx.setAppearance(dj);
var hA=new qx.ui.basic.Label(bU);
var hy=new qx.ui.basic.Label(dC+qx.core.Environment.get(cj));
hx.add(hA);
hx.add(new qx.ui.core.Spacer,{flex:1});
hx.add(hy);
return hx;
}},destruct:function(){this.widgets=this.tests=this._sampleToTreeNodeMap=this.tree=this.logelem=null;
this._disposeObjects(bi,bx,bP,cF,cN,bE,bL,U,bH,dH,D,f,k,cG,cz,V,cm,bI,bN,O,de,dP,dJ,cM,cx,bv,S,bT,cC,K,bB,bY,Q,ct,bj,n);
}});
})();
...
this.addListener(g,this.__SF,this);
},properties:{content:{apply:d},autoCenter:{check:e,init:false}},members:{__SE:null,_getContentContainer:function(){if(!this.__SE){this.__SE=new qx.ui.container.Composite(new qx.ui.layout.VBox());
this.__SE.setMinHeight(20);
}return this.__SE;
...
y=y>=0?y:0;
this.moveTo(x,y);
},__SF:function(){if(this.getAutoCenter()){this.center();
}}}});
})();
...
qx.log.Logger.register(this);
},members:{__Ij:null,setElement:function(t){this.clear();
if(t){qx.bom.element.Class.add(t,j);
}this.__Ij=t;
},clear:function(){var u=this.__Ij;
if(u){u.innerHTML=q;
}},process:function(v){var w=this.__Ij;
...
this.tmap=n;
this.ttree=this.__SG(n);
},members:{__SG:function(o){var q=o;
