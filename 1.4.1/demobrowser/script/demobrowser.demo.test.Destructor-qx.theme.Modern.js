...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Destructor","qx.theme":"qx.theme.Modern"};
...
(function(){var e="Window: ",d="__UD",c="interval",b="Label: ",a="demobrowser.demo.test.Destructor";
qx.Class.define(a,{extend:qx.application.Standalone,members:{__UB:null,__UC:0,__UD:null,main:function(){qx.application.Standalone.prototype.main.call(this);
this.__UB=[];
this.currentTest=this.testWindows;
this.__UD=new qx.event.Timer(1000);
this.__UD.addListener(c,this.runTest,this);
this.__UD.start();
},runTest:function(){this.__UC++;
var g=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__UC+" (Registry: "+g+")");
this.currentTest();
