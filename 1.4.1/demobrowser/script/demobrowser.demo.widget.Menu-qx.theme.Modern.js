...
(function(){var ci="execute",ch="changeValue",cg="icon/16/actions/edit-cut.png",cf="changeSelection",ce="icon/16/actions/edit-paste.png",cd="Copy",cc="Paste",cb="icon/16/actions/edit-copy.png",ca="Cut",bY="icon/16/actions/system-search.png",bu="New",bt="Undo",bs="icon/16/actions/document-save.png",br="Redo",bq="icon/22/apps/preferences-users.png",bp="icon/16/actions/document-print.png",bo="icon/16/actions/document-open.png",bn="icon/16/actions/edit-undo.png",bm="Save",bl="icon/16/actions/edit-redo.png",cp="Print",cq="Open",cn="icon/16/actions/document-new.png",co="Online Forum",cl="icon/16/actions/format-justify-fill.png",cm="Search in files",cj="C",ck="Left aligned",cr="__Wm",cs="Perl",bR="View",bQ="C Dialect",bT="Info...",bS="Save as...",bV="Show line numbers",bU="Quickstart",bX="icon/16/actions/contact-new.png",bW="Ctrl+N",bP="Actions",bO="Show console",a="Search",b="Help",c="Show status bar",d="icon/16/actions/format-justify-left.png",f="ANSI to OEM",g="Centered",h="Website 3",j="__Wk",k="Edit",l="icon/16/actions/format-justify-center.png",cw="Ctrl+O",cv="__Wj",cu="icon/16/actions/go-previous.png",ct="C Sharp",cA="Close",cz="Split Button",cy="Website 2",cx="icon/16/actions/document-save-as.png",cC="Python",cB="icon/16/apps/utilities-help.png",K="Show tree",L="Options",I="Spaces to tabs",J="Right aligned",O="Action 1",P="OEM to ANSI",M="Line 431",N="JavaScript",G="icon",H="Action 2",t="Folder ",s="XML",v="Line 313",u="Paragraph",p="demobrowser.demo.widget.Menu",o="icon/16/actions/application-exit.png",r="C Plus Plus",q="Line 26",n="Item ",m="ASCII table",U="__Wl",V="Option 1",W="Search next...",X="Line 12",Q="Action 3",R="Replace in files",S="Uppercase",T="Ctrl+P",Y="Topics",ba="Panes",D="Justified",C="Ctrl+X",B="Search previous...",A="Back",z="main",y="Show ruler",x="__Wg",w="__Wh",F="icon/16/actions/format-justify-right.png",E="icon/16/actions/go-next.png",bb="Ctrl+Z",bc="command ",bd="Option 3",be="Next",bf="Ctrl+R",bg="Show macros",bh="Show tags",bi="Capitals",bj="Format",bk="File",by="Show tabs",bx="__Wf",bw="Tabs to spaces",bv="Search...",bC="Line 1039",bB="Option 2",bA="Objective C",bz="Exit",bE="move to",bD="Ctrl+S",bL="Syntax",bM="Ctrl+C",bJ="Website 1",bK="Menu Button",bH="Line 30",bI="Lowercase",bF="Replace",bG="__Wi",bN="HTML";
qx.Class.define(p,{extend:qx.application.Standalone,members:{__Wf:null,__Wg:null,__Wh:null,__Wi:null,__Wj:null,__Wk:null,__Wl:null,__Wm:null,main:function(){qx.application.Standalone.prototype.main.call(this);
...
for(var i=0;i<30;i++){cG.add(new qx.ui.menu.Button(t+(i+1)));
}cF.add(new qx.ui.menu.Button(bE,null,null,cG));
cF.add(new qx.ui.menu.Separator());

for(var i=0;i<7;i++){cF.add(new qx.ui.menu.Button(bc+(i+1)));
}return cF;
...
},createCommands:function(){this.__Wf=new qx.ui.core.Command(bW);
this.__Wf.addListener(ci,this.debugCommand);
this.__Wg=new qx.ui.core.Command(cw);
this.__Wg.addListener(ci,this.debugCommand);
this.__Wh=new qx.ui.core.Command(bD);
this.__Wh.addListener(ci,this.debugCommand);
this.__Wi=new qx.ui.core.Command(bb);
this.__Wi.addListener(ci,this.debugCommand);
this.__Wj=new qx.ui.core.Command(bf);
this.__Wj.addListener(ci,this.debugCommand);
this.__Wk=new qx.ui.core.Command(C);
this.__Wk.addListener(ci,this.debugCommand);
this.__Wl=new qx.ui.core.Command(bM);
this.__Wl.addListener(ci,this.debugCommand);
this.__Wm=new qx.ui.core.Command(T);
this.__Wm.addListener(ci,this.debugCommand);
this.__Wm.setEnabled(false);
},getMenuButton:function(){var cH=new qx.ui.menu.Menu;
cH.add(new qx.ui.menu.RadioButton(V));
cH.add(new qx.ui.menu.RadioButton(bB));
cH.add(new qx.ui.menu.RadioButton(bd));
var cP=new qx.ui.menu.Menu;
cP.add(new qx.ui.menu.RadioButton(O));
cP.add(new qx.ui.menu.RadioButton(H));
cP.add(new qx.ui.menu.RadioButton(Q));
...
var cN=new qx.ui.menu.Button(bt,bn,this.__Wi);
var cU=new qx.ui.menu.Button(br,bl,this.__Wj);
var cJ=new qx.ui.menu.Button(ca,cg,this.__Wk);
var cR=new qx.ui.menu.Button(cd,cb,this.__Wl);
var cL=new qx.ui.menu.Button(cc,ce,this.__Wm);
var cI=new qx.ui.menu.Button(L,bY,null,cH);
var cS=new qx.ui.menu.Button(bP,bX,null,cP);
...
cK.addSeparator();
cK.add(cQ);
var cT=new qx.ui.form.MenuButton(bK,bq,cK);
return cT;
},getSplitButton:function(){var cV=new qx.ui.menu.Menu;
var da=new qx.ui.menu.Button(bJ);
var cX=new qx.ui.menu.Button(cy);
var cY=new qx.ui.menu.Button(h);
cV.setMinWidth(120);
...
cV.add(cX);
cV.add(cY);
var cW=new qx.ui.form.SplitButton(cz,bq,cV);
...
toolbar.addSpacer();
toolbar.add(di);
var dn=new qx.ui.toolbar.SplitButton(A,cu,this.getBackMenu());
var dk=new qx.ui.toolbar.SplitButton(be,E,this.getForwardMenu());
var dd=new qx.ui.toolbar.Button(bu,cn,this.__Wf);
var dh=new qx.ui.toolbar.Button(cq,bo,this.__Wg);
var dm=new qx.ui.toolbar.Button(bm,bs,this.__Wh);
...
dp.add(dm);
dp.setShow(G);
var dg=new qx.ui.toolbar.MenuButton(bk);
var dc=new qx.ui.toolbar.MenuButton(k);
var db=new qx.ui.toolbar.MenuButton(a);
var dq=new qx.ui.toolbar.MenuButton(bR);
var dl=new qx.ui.toolbar.MenuButton(bj);
...
de.add(dq);
de.add(dl);
var dj=new qx.ui.toolbar.MenuButton(b);
dj.setMenu(this.getHelpMenu());
di.add(dj);
return df;
},getBackMenu:function(){var ds=new qx.ui.menu.Menu;
var dt=new qx.ui.menu.Button(v);
var dv=new qx.ui.menu.Button(bC);
var dr=new qx.ui.menu.Button(X);
var du=new qx.ui.menu.Button(q);
...
var dx=new qx.ui.menu.Button(M);
var dy=new qx.ui.menu.Button(bH);
...
var dz=new qx.ui.menu.Button(bu,cn,this.__Wf);
var dD=new qx.ui.menu.Button(cq,bo,this.__Wg);
var dC=new qx.ui.menu.Button(cA);
var dG=new qx.ui.menu.Button(bm,bs,this.__Wh);
var dF=new qx.ui.menu.Button(bS,cx);
var dE=new qx.ui.menu.Button(cp,bp);
var dA=new qx.ui.menu.Button(bz,o);
...
var dL=new qx.ui.menu.Button(bt,bn,this.__Wi);
var dK=new qx.ui.menu.Button(br,bl,this.__Wj);
var dH=new qx.ui.menu.Button(ca,cg,this.__Wk);
var dM=new qx.ui.menu.Button(cd,cb,this.__Wl);
var dJ=new qx.ui.menu.Button(cc,ce,this.__Wm);
...
var dO=new qx.ui.menu.Button(bv,bY);
var dT=new qx.ui.menu.Button(W);
var dP=new qx.ui.menu.Button(B);
var dS=new qx.ui.menu.Button(bF);
...
var dW=new qx.ui.menu.Button(ba,null,null,this.getPanesMenu());
var ea=new qx.ui.menu.Button(bL,null,null,this.getSyntaxMenu());
var dY=new qx.ui.menu.CheckBox(y);
var dX=new qx.ui.menu.CheckBox(bV);
var dV=new qx.ui.menu.Button(m);
...
var ee=new qx.ui.menu.CheckBox(by);
var eg=new qx.ui.menu.CheckBox(c);
var eh=new qx.ui.menu.CheckBox(K);
var ed=new qx.ui.menu.CheckBox(bg);
var ef=new qx.ui.menu.CheckBox(bh);
var eb=new qx.ui.menu.CheckBox(bO);
ee.setValue(true);
eg.setValue(true);
ed.setValue(true);
...
var ek=new qx.ui.menu.RadioButton(s);
var ej=new qx.ui.menu.RadioButton(N);
var el=new qx.ui.menu.Button(bQ,null,null,this.getSyntaxCMenu());
var ep=new qx.ui.menu.RadioButton(cs);
var en=new qx.ui.menu.RadioButton(cC);
em.add(ei);
em.add(ek);
em.add(ej);
em.add(el);
...
var et=new qx.ui.menu.RadioButton(bA);
var es=new qx.ui.menu.RadioButton(r);
er.add(eq);
er.add(eu);
er.add(et);
er.add(es);
...
var ex=new qx.ui.menu.Button(u,null,null,this.getParagraphMenu());
var eA=new qx.ui.menu.Button(bw);
var eB=new qx.ui.menu.Button(I);
var ew=new qx.ui.menu.Button(S);
var ez=new qx.ui.menu.Button(bI);
var ev=new qx.ui.menu.Button(bi);
var eD=new qx.ui.menu.Button(P);
var eC=new qx.ui.menu.Button(f);
...
var eH=new qx.ui.menu.Button(ck,d);
var eI=new qx.ui.menu.Button(J,F);
var eF=new qx.ui.menu.Button(g,l);
var eG=new qx.ui.menu.Button(D,cl);
...
var eL=new qx.ui.menu.Button(Y,cB);
var eN=new qx.ui.menu.Button(bU);
var eM=new qx.ui.menu.Button(co);
var eK=new qx.ui.menu.Button(bT);
...
for(var i=0;i<20;i++){eO.add(new qx.ui.form.ListItem(n+i));
}return eO;
},getContextMenu:function(){var eP=new qx.ui.menu.Menu;
var eR=new qx.ui.menu.Button(ca,cg,this.__Wk);
var eS=new qx.ui.menu.Button(cd,cb,this.__Wl);
var eQ=new qx.ui.menu.Button(cc,ce,this.__Wm);
...
eP.add(eQ);
return eP;
}},destruct:function(){this._disposeObjects(bx,x,w,bG,cv,j,U,cr);
}});
})();
