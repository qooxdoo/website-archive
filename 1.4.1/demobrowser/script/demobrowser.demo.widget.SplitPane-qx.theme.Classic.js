...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SplitPane","qx.theme":"qx.theme.Classic"};
...
(function(){var l="value",k="horizontal",j="first",h="Trash",g="both",f="second",d="main",c="Show first pane",b="Documents (D:)",a="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",K="Windows (C:)",J="__Wn",I="Toggle Splitpane Orientation",H="Inbox",G="Desktop",F="_container1",E="execute",D="):",C="Presets",B="Network",s="changeSelection",t="Sent",q="Offset (",r="/",o="offset",p="Files",m="_container2",n="vertical",u="Workspace",v="Junk #",x="Data",w="Show both panes",z="Show second pane",y="demobrowser.demo.widget.SplitPane",A="Edit";
qx.Class.define(y,{extend:qx.application.Standalone,members:{__Wn:null,main:function(){qx.application.Standalone.prototype.main.call(this);
var M=new qx.ui.container.Scroll();
var L=new qx.ui.container.Composite(new qx.ui.layout.Basic());
L.setAllowStretchX(false);
M.add(L);
var T=new qx.ui.splitpane.Pane(k).set({width:450,height:300});
this.__Wn=T;
var X=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:d});
var bb=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:d});
var P=this.__Wo();
var O=new qx.ui.form.Button(I).set({allowGrowX:false,allowGrowY:false});
O.addListener(E,this._toggle,this);
var R=new qx.ui.basic.Label(a);
R.setRich(true);
X.add(P);
bb.add(O);
bb.add(R);
...
T.add(X,0);
T.add(bb,1);
L.add(T,{left:20,top:40});
this.getRoot().add(M,{edge:0});
var N=new qx.ui.layout.VBox(5);
var U=new qx.ui.container.Composite(N);
var Y=new qx.ui.form.RadioButton(c);
var ba=new qx.ui.form.RadioButton(z);
...
U.add(ba);
U.add(W);
var S=new qx.ui.form.RadioGroup(Y,ba,W);
S.addListener(s,this._changeVisiblity,this);
L.add(U,{left:490,top:42});
O.focus();
var Q=new qx.ui.basic.Label();
this.getRoot().add(Q,{left:490,top:120});
var V=new qx.ui.form.Slider().set({minimum:0,maximum:30,value:6,width:100});
this.getRoot().add(V,{left:490,top:140});
V.bind(l,T,o);
V.bind(l,Q,l,{converter:function(bc){return q+bc+D;
}});
},_toggle:function(){var bd=this.__Wn.getOrientation();
this.__Wn.setOrientation(bd==k?n:k);
},_changeVisiblity:function(e){var be=e.getData()[0].getUserData(l);

if(be==g){this._container1.show();
this._container2.show();
}else if(be==j){this._container1.show();
this._container2.exclude();
}else if(be==f){this._container1.exclude();
this._container2.show();
}},__Wo:function(){var bo=new qx.ui.tree.Tree();
bo.setDecorator(null);
var bt=new qx.ui.tree.TreeFolder(r);
bt.setOpen(true);
bo.setRoot(bt);
var br=new qx.ui.tree.TreeFolder(G);
br.setOpen(true);
bt.add(br);
var bj=new qx.ui.tree.TreeFolder(p);
var bh=new qx.ui.tree.TreeFolder(u);
var bi=new qx.ui.tree.TreeFolder(B);
var bg=new qx.ui.tree.TreeFolder(h);
br.add(bj,bh,bi,bg);
var bp=new qx.ui.tree.TreeFile(K);
var bf=new qx.ui.tree.TreeFile(b);
bh.add(bp,bf);
var bs=new qx.ui.tree.TreeFolder(H);
var bk=new qx.ui.tree.TreeFolder(C);
var bn=new qx.ui.tree.TreeFolder(t);
var bm=new qx.ui.tree.TreeFolder(h);

for(var i=0;i<100;i++){bm.add(new qx.ui.tree.TreeFile(v+i));
}var bq=new qx.ui.tree.TreeFolder(x);
var bl=new qx.ui.tree.TreeFolder(A);
bs.add(bk,bn,bm,bq,bl);
bt.add(bs);
return bo;
}},destruct:function(){this._disposeObjects(J,F,m);
}});
})();
