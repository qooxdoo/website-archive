...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Touch","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Touch-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"242d9c9ef1c5"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(f,{extend:qx.application.Native,members:{__UK:null,__UL:null,main:function(){qx.application.Native.prototype.main.call(this);
...
w.setAttribute(c,m);
return;
}v.add(this.__UM(10,10,s,a));
v.add(this.__UM(110,10,d,q));
this.__UK=this.__UN(10,110);
v.add(this.__UK);
this.__UL=this.__UN(110,110);
v.add(this.__UL);
v.add(this.__UO(210,10));
},__UM:function(x,y,z,A){var B={"position":"absolute","left":x+"px","top":y+"px","width":"90px","height":"90px","backgroundColor":z,"fontFamily":"Arial","fontSize":"12px"};
var C=new qx.html.Element("div",B,{"id":A});
C.setAttribute("innerHTML","<b>Touch me:<br>"+A+"</b>");
C.addListener("touchstart",this.__UP,this);
C.addListener("touchmove",this.__UP,this);
C.addListener("touchend",this.__UP,this);
C.addListener("touchcancel",this.__UP,this);
return C;
},__UN:function(x,y){var D={"position":"absolute","left":x+"px","top":y+"px","width":"90px","fontFamily":"Arial","fontSize":"9px"};
return new qx.html.Element("div",D);
},__UO:function(x,y){var E={"position":"absolute","left":x+"px","top":y+"px","width":"55px","height":"55px","backgroundColor":"red","fontFamily":"Arial","fontSize":"12px"};
