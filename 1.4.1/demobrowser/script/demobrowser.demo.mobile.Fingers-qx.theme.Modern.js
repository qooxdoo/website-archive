...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.mobile.Fingers","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.mobile.Fingers-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c8808451325d"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
qx.Class.define(v,{extend:qx.application.Native,members:{__Tw:null,__Tx:null,main:function(){qx.application.Native.prototype.main.call(this);
...
this.__Tw[i]=parseInt(M.target.style.left)-M.pageX;
this.__Tx[i]=parseInt(M.target.style.top)-M.pageY;
}},_onTouchMove:function(e){var P=e.getAllTouches();

for(var i=0;i<P.length;i++){var O=P[i];

if(P.target==document.body){continue;
}qx.bom.element.Style.setStyles(O.target,{"left":(O.pageX+this.__Tw[i])+l,"top":(O.pageY+this.__Tx[i])+l});
}e.stop();
}}});
})();
