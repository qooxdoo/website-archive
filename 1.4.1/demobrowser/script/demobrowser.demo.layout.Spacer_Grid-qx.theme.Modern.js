...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Spacer_Grid","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Spacer_Grid-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"34349077a1f2"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var d="main",c="green",b="yellow",a="demobrowser.demo.layout.Spacer_Grid";
...
e.setPadding(20);
this.getRoot().add(e,{edge:0});
e.add(this.getGrid1());
e.add(this.getGrid2());
},getGrid1:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:d,backgroundColor:b,allowGrowX:false,allowGrowY:false});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:0});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:1});
g.add(new qx.ui.core.Spacer(0,10),{row:1,column:0});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:0});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:1});
g.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:4,column:0});
g.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:4,column:1});
return g;
},getGrid2:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:d,backgroundColor:b,allowGrowX:false,allowGrowY:false});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:0});
h.add(new qx.ui.core.Spacer(10,0),{row:0,column:2});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:3});
h.add(new qx.ui.core.Spacer(30,0),{row:1,column:4});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:0,column:5});
h.add(new qx.ui.core.Spacer(0,5),{row:1,column:0});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:0});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:3});
h.add(new qx.ui.core.Widget().set({decorator:d,backgroundColor:c}),{row:2,column:5});
return h;
}}});
})();
