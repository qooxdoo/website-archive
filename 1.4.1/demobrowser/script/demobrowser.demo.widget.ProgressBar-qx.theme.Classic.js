...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ProgressBar","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.ProgressBar-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"b90ac7e07cd2"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
