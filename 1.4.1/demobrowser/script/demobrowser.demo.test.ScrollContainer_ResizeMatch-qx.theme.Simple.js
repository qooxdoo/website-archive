...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.ScrollContainer_ResizeMatch","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"e43eb9faf554"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
