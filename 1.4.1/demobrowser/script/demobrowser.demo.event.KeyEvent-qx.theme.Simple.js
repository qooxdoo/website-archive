...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.KeyEvent","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.event.KeyEvent-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"046c18a42207"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
for(var i=0;i<o.length;i++){qx.bom.Element.addListener(document.documentElement,o[i],this.logKeyEvent,this);
}},logKeyEvent:function(p){var q=p.getType();
this._log([q,q!==n?p.getKeyIdentifier():m,q==n?p.getCharCode():m,p.isShiftPressed(),p.isCtrlPressed(),p.isAltPressed()]);
p.preventDefault();
}}});
})();
