...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.treevirtual.TreeVirtual_Events","qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.treevirtual.TreeVirtual_Events-qx.theme.Classic.js"]],
  urisBefore : [],
  packageHashes : {"0":"f1d807d088f0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var w="Trash",v="Windows (C:)",u="Data",t="Documents (D:)",s="\n  ",r="treeOpenWithContent",q="treeOpenWhileEmpty",p="demobrowser.demo.treevirtual.TreeVirtual_Events",o="Edit",n="Workspace",f="Network",m="Spam Message #",j="Selected labels:",c="Inbox",b="Desktop",h="changeSelection",g="Sent",k="treeClose",a="Files",l="Tree",d="Spam";
...
var x=new qx.ui.treevirtual.TreeVirtual(l);
x.setColumnWidth(0,400);
x.setAlwaysShowOpenCloseSymbol(true);
this.getRoot().add(x,{edge:30});
var C=x.getDataModel();
var z=C.addBranch(null,b,true);
var B;
C.addBranch(z,a,true);
B=C.addBranch(z,n,true);
C.addLeaf(B,v);
C.addLeaf(B,t);
C.addBranch(z,f,true);
C.addBranch(z,w,true);
var A=C.addBranch(null,c,true);
B=C.addBranch(A,d,false);

for(var i=1;i<3000;i++){C.addLeaf(B,m+i);
}C.addBranch(A,g,false);
C.addBranch(A,w,false);
C.addBranch(A,u,false);
C.addBranch(A,o,false);
C.setData();
var y=1;
x.addListener(r,function(e){alert('treeOpenWithContent ');
var D=e.getData();
C.addLeaf(D.nodeId,y.toString());
y++;
});
x.addListener(k,function(e){alert('treeClose ');
});
x.addListener(q,function(e){alert('treeOpenWhileEmpty');
var E=e.getData();
x.nodeSetHideOpenClose(E,true);
});
x.addListener(h,function(e){var F=j;
var G=e.getData();

for(i=0;i<G.length;i++){F+=s+G[i].label;
...
this.__Jf=null;
},properties:{filter:{check:h,nullable:true,apply:d}},members:{__Jg:null,__Jf:null,__Jh:null,__Ji:null,_rowArr:null,_nodeArr:null,_nodeRowMap:null,_treeColumn:null,_selections:null,setTree:function(o){this.__Jg=o;
},getTree:function(){return this.__Jg;
},setEditable:function(p){this.__Jf=[];

for(var q=0;q<this.getColumnCount();q++){this.__Jf[q]=p;
}this.fireEvent(k);
},setColumnEditable:function(r,s){if(s!=this.isColumnEditable(r)){if(this.__Jf==null){this.__Jf=[];
}this.__Jf[r]=s;
this.fireEvent(k);
}},isColumnEditable:function(t){if(t==this._treeColumn){return false;
}return (this.__Jf?this.__Jf[t]==true:false);
...
},__Jj:function(bd,be){var bh=this.getFilter();
var bk=null;
var bj;
...
bk=this._nodeArr[bj];
if(bk==null||(bh&&!bh.call(this,bk))){this.__Ji=true;
continue;
}bl.push(bk);
bk.level=be;
bk.bFirstChild=(bf==0);
if(!this.__Ji){this.__Jl(bk,i==bg-1);
...
}if(bk.bOpened){this.__Jj(bj,be+1);
}bf++;
}},__Jk:function(bm){var bn=this.__Jh;
var br=bn[bm];
var bp=br.length;
...
if(bo){this.__Jk(bq.nodeId);
}}},__Jl:function(bs,bt){bs.lastChild=[bt];
...
}},__Jm:function(){this.__Jh=[];
this.__Ji=false;
this._rowArr=[];
this._nodeRowMap=[];
this._selections={};
this.__Jj(0,1);
if(this.__Ji){this.__Jk(0);
}this.__Jh=null;
...
}},destruct:function(){this._rowArr=this._nodeArr=this._nodeRowMap=this._selections=this.__Jg=this.__Jh=null;
...
this.__Jp=qx.util.AliasManager.getInstance();
this.__Jq=qx.util.ResourceManager.getInstance();
this.__Jr=qx.theme.manager.Appearance.getInstance();
this.BLANK=this.__Jq.toUri(this.__Jp.resolve("static/blank.gif"));
},statics:{__Js:{},__Jo:true,__Jt:function(){qx.theme.manager.Meta.getInstance().initialize();
...
bc.__Js.line=be.styleFrom(J);
bh(bc.__Js.line.icon);
bc.__Js.contract=be.styleFrom(M);
bh(bc.__Js.contract.icon);
bc.__Js.expand=be.styleFrom(F);
bh(bc.__Js.expand.icon);
bc.__Js.onlyContract=be.styleFrom(I);
bh(bc.__Js.onlyContract.icon);
bc.__Js.onlyExpand=be.styleFrom(T);
bh(bc.__Js.onlyExpand.icon);
bc.__Js.startContract=be.styleFrom(X);
bh(bc.__Js.startContract.icon);
bc.__Js.startExpand=be.styleFrom(O);
bh(bc.__Js.startExpand.icon);
bc.__Js.endContract=be.styleFrom(w);
bh(bc.__Js.endContract.icon);
bc.__Js.endExpand=be.styleFrom(C);
bh(bc.__Js.endExpand.icon);
bc.__Js.crossContract=be.styleFrom(A);
bh(bc.__Js.crossContract.icon);
bc.__Js.crossExpand=be.styleFrom(H);
bh(bc.__Js.crossExpand.icon);
bc.__Js.end=be.styleFrom(p);
bh(bc.__Js.end.icon);
bc.__Js.cross=be.styleFrom(q);
bh(bc.__Js.cross.icon);
}},properties:{useTreeLines:{check:j,init:true},excludeFirstLevelTreeLines:{check:j,init:false},alwaysShowOpenCloseSymbol:{check:j,init:false}},members:{__Jp:null,__Jr:null,__Jq:null,_getCellStyle:function(bi){var bj=bi.value;
...
var bs=this.__Jq.toUri(this.__Jp.resolve(br.url));
...
if(!bJ){if(bH.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF){var o=this.__Jr.styleFrom(V);
}else{var bK={opened:bH.bOpened};
var o=this.__Jr.styleFrom(B,bK);
}bJ=o.icon;
...
if(bX==0&&cc){ca=false;
}if(bX<bY.level-1){return (ca&&!bY.lastChild[bX]?cd.__Js.line:{icon:this.BLANK});
}var ce=bY.lastChild[bY.lastChild.length-1];
if(bY.type==qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH&&!bY.bHideOpenClose){if(bY.children.length>0||cb){if(!ca){return (bY.bOpened?cd.__Js.contract:cd.__Js.expand);
}if(bX==0&&bY.bFirstChild){if(ce){return (bY.bOpened?cd.__Js.onlyContract:cd.__Js.onlyExpand);
}else{return (bY.bOpened?cd.__Js.startContract:cd.__Js.startExpand);
}}if(ce){return (bY.bOpened?cd.__Js.endContract:cd.__Js.endExpand);
}return (bY.bOpened?cd.__Js.crossContract:cd.__Js.crossExpand);
}}if(ca){if(bY.parentNodeId==0){if(ce&&bY.bFirstChild){return {icon:this.BLANK};
}if(ce){return cd.__Js.end;
}if(bY.bFirstChild){return (bY.bOpened?cd.__Js.startContract:cd.__Js.startExpand);
}}return (ce?cd.__Js.end:cd.__Js.cross);
}return {icon:this.BLANK};
}},destruct:function(){this.__Jp=this.__Jq=this.__Jr=null;
}});
})();
...
this.__Je=d;
},members:{__Je:null,getTable:function(){return this.__Je;
