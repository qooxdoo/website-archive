...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_HeaderRenderer","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Table_HeaderRenderer-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"f26676023bfe"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
},testDefaultRenderer:function(){var l=new qx.ui.table.headerrenderer.Default();
l.setToolTip(g);
var j={name:[i],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var k=this._getNewHeaderContainer();
qx.util.Permutation.permute(j,function(m){var n=l.createHeaderCell(m);
k.add(n);
l.updateHeaderCell(m,n);
});
},testIconRenderer:function(){var q=new qx.ui.table.headerrenderer.Icon(f);
q.setToolTip(g);
var o={name:[i],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var p=this._getNewHeaderContainer();
qx.util.Permutation.permute(o,function(r){var s=q.createHeaderCell(r);
p.add(s);
q.updateHeaderCell(r,s);
});
},_getNewHeaderContainer:function(){var t=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
t.addListener(d,function(e){e.getTarget().addState(h);
});
t.addListener(a,function(e){e.getTarget().removeState(h);
});
