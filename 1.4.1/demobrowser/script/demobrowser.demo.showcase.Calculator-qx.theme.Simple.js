...
(function(){var k="execute",j="-",i="+",h="n",g="/",f="*",d="=",c="sans-serif",b="Verdana",a=".",J="black",I="Del",H="C",G="__Ub",F="5",E="7",D="demobrowser.demo.showcase.Calculator",C="CE",B="solid",A="icon/22/apps/utilities-calculator.png",r="3",s="0",p="qx.debug",q="8",n="__Uc",o="6",l="4",m="Calculator",t="right",u="2",w="1",v="demobrowser.demo.showcase.CalculatorLogic",y="white",x="+/-",z="9";
qx.Class.define(D,{extend:qx.application.Standalone,members:{__Ub:null,__Uc:null,main:function(){qx.application.Standalone.prototype.main.call(this);
if(qx.core.Environment.get(p)){qx.log.appender.Native;
qx.log.appender.Console;
}this.__Uc=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var L=new qx.ui.window.Window(m,A);
L.setLayout(new qx.ui.layout.VBox(16));
var N=new qx.ui.decoration.Single(1,B,J);
...
V.setLayout(bg);
this.__Ub=new qx.ui.basic.Label(this.__Uc.getCurrentValue().toString()).set({decorator:N,backgroundColor:y,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[b,c],bold:true}),textAlign:t});
this.__Ub.setEnabled(false);
var bh=new qx.bom.Font().set({size:14,family:[b,c],bold:true});
var bb=new qx.ui.form.Button(s).set({font:bh,minWidth:40});
var ba=new qx.ui.form.Button(w).set({font:bh,minWidth:40});
var Y=new qx.ui.form.Button(u).set({font:bh,minWidth:40});
var X=new qx.ui.form.Button(r).set({font:bh,minWidth:40});
var bf=new qx.ui.form.Button(l).set({font:bh,minWidth:40});
var be=new qx.ui.form.Button(F).set({font:bh,minWidth:40});
var bd=new qx.ui.form.Button(o).set({font:bh,minWidth:40});
var bc=new qx.ui.form.Button(E).set({font:bh,minWidth:40});
...
var M=new qx.ui.form.Button(C).set({font:bh,minWidth:40});
...
bg.setRowFlex(5,1);
bg.setRowFlex(6,1);
V.add(this.__Ub,{row:0,column:0,rowSpan:0,colSpan:4});
...
L.add(V,{flex:1});
K.addListener(k,function(e){this.__Uc.cleanDisplay();
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
M.addListener(k,function(e){this.__Uc.clearEntry();

if(this.__Uc.getResult()!=null){this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
}},this);
R.addListener(k,function(e){this.__Uc.deleteNumber();
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
Q.addListener(k,function(e){this.__Uc.setSign();

if(this.__Uc.getResult()!=null){this.__Ub.setValue(this.__Uc.getResult().toString());
}},this);
bb.addListener(k,function(e){this.__Uc.setCurrentValue(0);
this.__Ub.setValue(this.__Uc.getCurrentValue().toFixed(this.__Uc.getZeroCounter()).toString());
},this);
ba.addListener(k,function(e){this.__Uc.setCurrentValue(1);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
Y.addListener(k,function(e){this.__Uc.setCurrentValue(2);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
X.addListener(k,function(e){this.__Uc.setCurrentValue(3);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
bf.addListener(k,function(e){this.__Uc.setCurrentValue(4);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
be.addListener(k,function(e){this.__Uc.setCurrentValue(5);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
bd.addListener(k,function(e){this.__Uc.setCurrentValue(6);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__Uc.setCurrentValue(7);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
bj.addListener(k,function(e){this.__Uc.setCurrentValue(8);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
bi.addListener(k,function(e){this.__Uc.setCurrentValue(9);
this.__Ub.setValue(this.__Uc.getCurrentValue().toString());
},this);
P.addListener(k,function(e){this.__Uc.calculate(i);

if(this.__Uc.getResult()!=null){this.__Ub.setValue(this.__Uc.getResult().toString());
}this.__Uc.resetCurrentValue();
},this);
W.addListener(k,function(e){this.__Uc.calculate(j);

if(this.__Uc.getResult()!=null){this.__Ub.setValue(this.__Uc.getResult().toString());
}this.__Uc.resetCurrentValue();
},this);
U.addListener(k,function(e){this.__Uc.calculate(f);

if(this.__Uc.getResult()!=null){this.__Ub.setValue(this.__Uc.getResult().toString());
}this.__Uc.resetCurrentValue();
},this);
S.addListener(k,function(e){this.__Uc.calculate(g);

if(this.__Uc.getResult()!=null){this.__Ub.setValue(this.__Uc.getResult().toString());
}this.__Uc.resetCurrentValue();
},this);
O.addListener(k,function(e){this.__Uc.calculate(d);

if(this.__Uc.getResult()!=null){this.__Ub.setValue(this.__Uc.getResult().toString());
}this.__Uc.resetCurrentValue();
},this);
T.addListener(k,function(e){this.__Uc.setComma();
},this);
}},destruct:function(){this._disposeObjects(n,G);
}});
qx.Class.define(v,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
},members:{__Ud:0,__Ue:0,__Uf:h,__Ug:0,__Uh:0,__Ui:0,__Uj:false,__Uk:1,__Ul:0,__Um:false,__Un:0,setCurrentValue:function(bk){if(this.__Uj){this.__Uk*=10;
this.__Ud=this.__Ud+(bk/this.__Uk);

if(bk==0){this.__Ul++;
}}else{this.__Uj=false;

if(this.__Ud<0){this.__Ud=this.__Ud*10-bk;
}else{this.__Ud=this.__Ud*10+bk;
}}},getZeroCounter:function(){return this.__Ul;
},setComma:function(){this.__Uj=true;
},getCurrentValue:function(){return this.__Ud;
},resetCurrentValue:function(){this.__Ud=null;
},cleanDisplay:function(){this.__Un=0;
this.__Uh=0;
this.__Uf=h;
this.__Ul=0;
this.__Uk=1;
...
this.__Ue=0;
this.__Um=false;
},setResult:function(bl){this.__Ue=bl;
},getResult:function(){return Math.round(this.__Ue*10000000)/10000000;
},setCurrentOperation:function(bm){this.__Uf=bm;
},getCurrentOperation:function(){return this.__Uf;
},clearEntry:function(){this.__Um=false;
this.__Ul=0;
this.__Uk=1;
this.__Uj=false;
this.__Ui++;
...
if(this.__Ui<2){this.__Uh=this.__Ue;
}
if(this.__Ug>=2){this.__Ue=0;
this.__Ug=0;
}},setSign:function(){this.__Un++;

if(this.__Un%2==0){this.__Um=false;
}else{this.__Um=true;
}
if(this.__Ud==null){this.__Ud=this.__Ue;
}this.__Ud=this.__Ud*(-1);

if(this.__Ue==0){this.__Ue=this.__Ud;
}
if(this.__Ue!=0){this.__Uh=this.__Ue;
this.__Ue=this.__Ud;
}},deleteNumber:function(){var bn=false;
var bq=false;

if(this.__Ud<0){this.__Ud=this.__Ud*(-1);
bq=true;
}
if(this.__Ud!=null){if(this.__Ud.toString().lastIndexOf(a)!=-1){this.__Ud=this.__Ud*this.__Uk;
bn=true;
}}var bo=this.__Ud%10;
var bp=bo/10;
this.__Ud=this.__Ud/10;
this.__Ud=this.__Ud-bp;

if(bn){this.__Uk/=10;
this.__Ud=this.__Ud/(this.__Uk);
bn=false;
}
if(bq){this.__Ud=this.__Ud*(-1);
bq=false;
}},calculate:function(br){if(br==i||br==f||br==g||br==j||br==d){this.__Uj=false;
this.__Uk=1;
this.__Ul=0;

if(this.__Uf!=h){if(this.__Uf==i){if(this.__Ue==null){this.__Ue=this.__Uh;
}
if(this.__Um){this.__Ue=this.__Uh+this.__Ud;
}else{this.__Ue=this.__Ue+this.__Ud;
}this.__Ud=this.__Ue;
this.__Uh=this.__Ue;
}
if(this.__Uf==j){if(this.__Ue==0){this.__Ue=this.__Ud;
this.__Ud=0;
}
if(this.__Ue==null){this.__Ue=this.__Uh;
}
if(this.__Um){this.__Ue=this.__Uh-this.__Ud;
}else{this.__Ue=this.__Ue-this.__Ud;
}this.__Ud=this.__Ue;
...
if(this.__Uf==g){if(this.__Ue==0){this.__Ue=this.__Ud;
this.__Ud=1;
}
if(this.__Ue==null){this.__Ue=this.__Uh;
}
if(this.__Ud!=null){if(this.__Ud!=0){if(this.__Um){this.__Ue=this.__Uh/this.__Ud;
}else{this.__Ue=this.__Ue/this.__Ud;
}}else{alert("You can't divide by 0!");
}}this.__Ud=this.__Ue;
this.__Uh=this.__Ue;
}
if(this.__Uf==f){if(this.__Ue==0){this.__Ue=1;
}
if(this.__Ud==null){this.__Ud=1;
}
if(this.__Ue==null){this.__Ue=this.__Uh;
}
if(this.__Um){this.__Ue=this.__Uh*this.__Ud;
...
this.__Uh=this.__Ue;
}}else{this.__Ue=this.__Ud;
}
if(br!=d){this.__Uf=br;
}else{this.__Ug++;
this.__Ue=this.__Uh;
this.__Uf=h;
}this.__Um=false;
