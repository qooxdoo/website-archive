...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Table_CellRenderer","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Table_CellRenderer-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"21057ad61fa0"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var k="",j="Hello",h="icon/16/actions/go-down.png",g="World",f="icon",e="bold",d="Juhu",c="qx/icon/Oxygen",b="waiting",a="icon/16/actions/go-next.png",N="qx.theme",M="http://resources.qooxdoo.org/images/logo.gif",L="$ ",K="string",J="border: 1px dotted green",I="decoration",H="multi<br>line",G="between",F="<",E="inactive",r="icon/16/actions/go-previous.png",s="number",p="Classic",q="<i>italic</i>",n="0$",o="qx/icon/Tango",l="<b>bold</b>",m="icon/16/actions/go-up.png",t="qx/decoration/",u="boolean",x="demobrowser.demo.test.Table_CellRenderer",w="tooltip",z="red",y="icon/16/emotes/face-sad.png",B="icon/16/emotes/face-smile.png",A="left",v=">=",D="active",C="object";
qx.Class.define(x,{extend:qx.application.Native,include:[demobrowser.demo.table.MUtil],members:{main:function(){qx.application.Native.prototype.main.call(this);
this.setUp();
...
var P=qx.core.Environment.get(N);
var O=/\.([a-z]+)$/i.exec(P)[1];
qx.util.AliasManager.getInstance().add(I,t+O);

if(O==p){qx.util.AliasManager.getInstance().add(f,c);
}else{qx.util.AliasManager.getInstance().add(f,o);
}},__UH:function(Q,top,R,S,T){var U=["<div style='position:absolute;height:20px;width:",R,"px;top:",top,"px'>"];
S.createDataCellHtml(T,U);
U.push("</div>");
Q.innerHTML+=U.join("");
},testDefaultRenderer:function(V){var W=100;
var Y={value:[null,d,32,new Date()],styleLeft:[0],styleWidth:[W],styleHeight:[20],style:[k]};
var X=this._getNewTableDiv(W);
var top=0;
qx.util.Permutation.permute(Y,function(ba){this.__UH(X,top,W,V,ba);
top+=20;
},this);
},testBooleanRenderer:function(){var be=70;
var bd=30;
var bf=new qx.ui.table.cellrenderer.Boolean();
var bb={value:[null,true,false],styleLeft:[0],styleWidth:[be],styleHeight:[bd],style:[k]};
var bc=this._getNewTableDiv(be);
var top=0;
qx.util.Permutation.permute(bb,function(bg){this.__UH(bc,top,be,bf,bg);
top+=bd;
},this);
bf.setIconFalse(y);
bf.setIconTrue(B);
qx.util.Permutation.permute(bb,function(bh){this.__UH(bc,top,be,bf,bh);
top+=bd;
},this);
},testDateRenderer:function(){var bl=180;
var bm=new qx.ui.table.cellrenderer.Date();
var bo={value:new Date(),styleLeft:[0],styleWidth:[bl],styleHeight:[20],style:[k]};
var bk=qx.util.format.DateFormat;
var bn=[bk.getDateTimeInstance(),bk.getDateInstance()];
var bi=this._getNewTableDiv(bl);
var top=0;

for(var i=0;i<bn.length;i++){var bj=bn[i];
bm.setDateFormat(bj);
this.__UH(bi,top,bl,bm,bo);
top+=20;
}},testNumberRenderer:function(){var bt=new qx.ui.table.cellrenderer.Number();
var bs=100;
var bv={value:Math.PI,styleLeft:[0],styleWidth:[bs],styleHeight:[20],style:[k]};
var br=qx.util.format.NumberFormat;
var bu=[new br().set({maximumFractionDigits:0}),new br().set({minimumFractionDigits:3,maximumFractionDigits:5,prefix:L})];
var bp=this._getNewTableDiv(bs);
var top=0;

for(var i=0;i<bu.length;i++){var bq=bu[i];
bt.setNumberFormat(bq);
this.__UH(bp,top,bs,bt,bv);
top+=20;
}},testImageRenderer:function(){var by=new qx.ui.table.cellrenderer.Image();
var bw=50;
var bz={value:[null,h,m,r,a,M],styleLeft:[0],styleWidth:[bw],styleHeight:[20],style:[k],tooltip:[k,w]};
var bx=this._getNewTableDiv(bw);
var top=0;
qx.util.Permutation.permute(bz,function(bA){this.__UH(bx,top,bw,by,bA);
top+=20;
},this);
},testStringRenderer:function(){var bF=new qx.ui.table.cellrenderer.String();
var bE=100;
var bD=20;
var bB={value:[null,j,g],styleLeft:[0],styleWidth:[bE],styleHeight:[bD],style:[k]};
var bC=this._getNewTableDiv(bE);
var top=0;
qx.util.Permutation.permute(bB,function(bG){this.__UH(bC,top,bE,bF,bG);
top+=20;
},this);
},testPasswordRenderer:function(){var bL=new qx.ui.table.cellrenderer.Password();
var bK=100;
var bJ=20;
var bH={value:[null,j,g],styleLeft:[0],styleWidth:[bK],styleHeight:[bJ],style:[k]};
var bI=this._getNewTableDiv(bK);
var top=0;
qx.util.Permutation.permute(bH,function(bM){this.__UH(bI,top,bK,bL,bM);
top+=20;
},this);
},testHtmlRenderer:function(){var bR=new qx.ui.table.cellrenderer.Html();
var bQ=100;
var bP=50;
var bN={value:[null,l,q,H],styleLeft:[0],styleWidth:[bQ],styleHeight:[bP],style:[k]};
var bO=this._getNewTableDiv(bQ);
var top=0;
qx.util.Permutation.permute(bN,function(bS){this.__UH(bO,top,bQ,bR,bS);
top+=20;
},this);
},testConditionalRenderer:function(){var bX=new qx.ui.table.cellrenderer.Conditional();
bX.addNumericCondition(F,0,null,z,null,null);
bX.addNumericCondition(v,100,A,null,null,null);
bX.addBetweenCondition(G,0,2,null,null,null,e,null);
bX.addRegex(n,null,null,e,J);
var bW=100;
var bV=20;
var bT={value:[null,1,2,100,200,-100,0],styleLeft:[0],styleWidth:[bW],table:[this.tableMock],styleHeight:[bV],style:[k]};
var bU=this._getNewTableDiv(bW);
var top=0;
qx.util.Permutation.permute(bT,function(bY){this.__UH(bU,top,bW,bX,bY);
top+=20;
},this);
},testDynamicRenderer:function(){var ce=new qx.ui.table.cellrenderer.Dynamic();
ce.setCellRendererFactoryFunction(function(cf){var ch=cf.value;
var cg=qx.ui.table.cellrenderer;

switch(typeof ch){case K:if(ch.match(/^icon\//)){return new cg.Image();
}else{return new cg.String();
}case u:return new cg.Boolean();
case s:return new cg.Number();
case C:if(ch instanceof Date){return new cg.Date();
}return new cg.Default();
}});
var cd=100;
var cc=20;
var ca={value:[null,d,new Date(),30,h,false],styleLeft:[0],styleWidth:[cd],styleHeight:[cc],table:[this.tableMock],style:[k]};
var cb=this._getNewTableDiv(cd);
var top=0;
qx.util.Permutation.permute(ca,function(ci){this.__UH(cb,top,cd,ce,ci);
top+=20;
},this);
},testReplaceRenderer:function(){var cn=new qx.ui.table.cellrenderer.Replace();
cn.setReplaceMap({1:D,2:E,3:b});
cn.addReversedReplaceMap();
var cm=100;
var cl=20;
var cj={value:[1,2,3],styleLeft:[0],styleWidth:[cm],table:[this.tableMock],styleHeight:[cl],style:[k]};
var ck=this._getNewTableDiv(cm);
var top=0;
qx.util.Permutation.permute(cj,function(co){this.__UH(ck,top,cm,cn,co);
top+=20;
},this);
...
if(d){this.__rf=d;
}this.__rg=qx.util.AliasManager.getInstance();
},members:{__rg:null,__rf:16,__re:16,_identifyImage:function(e){var f={imageWidth:this.__re,imageHeight:this.__rf};

if(e.value==a){f.url=null;
}else{f.url=this.__rg.resolve(e.value);
}f.tooltip=e.tooltip;
return f;
