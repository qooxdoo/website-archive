...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.bom.HtmlArea","qx.theme":"qx.theme.Classic"};
...
(function(){var bT="0px",bS="outline",bR="mshtml",bQ="hideFocus",bP="none",bO="engine.name",bN="true",bM="div",bL="16px",bK="840px",bv="left",bu="<tr>",bt="<option value=''></option>",bs="1px solid #AAA",br="'>",bq="</option>",bp="value='",bo="change",bn="select",bm="</tr>",cb="clear:both",cc="Insert Table",bY="Georgia",ca="<p>This low-level widget can be used separately at ",bW="http://",bX="Indent More",bU="Change font family",bV="Align Right",cd="Format Italic",ce="qx/icon/Oxygen/16/actions/format-text-underline.png",bD="350px",bC='<h1>About</h1><p>qooxdoo (pronounced [ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No <acronym title="HyperText Markup Language">HTML</acronym>, <acronym title="Cascading Style Sheets">CSS</acronym> nor <acronym title="Document Object Model">DOM</acronym> knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art <acronym title="Graphical User Interface">GUI</acronym> toolkit and an advanced client-server communication layer. It is Open Source under an <acronym title="GNU Lesser General Public License">LGPL</acronym>/<acronym title="Eclipse Public License">EPL</acronym> dual <a href="http://qooxdoo.org/license" class="wikilink1" title="license">license</a>.</p>',bF="white",bE="buttons at the toolbar.</p>",bH="demobrowser/demo/icons/htmlarea/format-list-ordered.png",bG="qx/icon/Oxygen/16/actions/format-indent-more.png",bJ="Comic Sans MS",bI="Tahoma",bB="20px 20px",bA="float",a="<h1>HtmlArea low-level widget</h1>",b="<td>First Row, First cell</td>",c="Align Left",d="qx/icon/Oxygen/16/actions/format-justify-center.png",f="input",g="Align Justify",h="demobrowser/demo/icons/htmlarea/format-fill-color.png",k="demobrowser/demo/icons/htmlarea/insert-text.png",l="Insert Horizontal Ruler",m="demobrowser/demo/icons/htmlarea/insert-horizontal-rule.png",ci="demobrowser/demo/icons/htmlarea/format-list-unordered.png",ch="HTML Code:",cg="Set Text Background Color",cf="Insert Link",cm="on",cl="You can play around with this widget by hitting the ",ck="<td>Second Row, First cell</td>",cj="</tbody>",co="Undo Last Change",cn="Set Text Color",L="demobrowser/demo/icons/htmlarea/format-text-color.png",M="traditional web pages / single-page applications.<br/> ",J="demobrowser/demo/icons/htmlarea/insert-table.png",K="qx/icon/Oxygen/16/actions/edit-undo.png",P="qx/icon/Oxygen/16/actions/edit-clear.png",Q="Arial Black",N="Impact",O="Change font size",H="Link: ",I="Redo Last Undo Step",u="Format Bold",t="off",w="qx/icon/Oxygen/16/actions/format-text-strikethrough.png",v="br",q="marginRight",p="image",s="<option qxKeepFocus='on' qxSelectable='off'",r="click",o="<option qxKeepFocus='on' qxSelectable='off' ",n="Remove Format",V="qx/icon/Oxygen/16/actions/insert-image.png",W="<p style='margin-bottom:10px'><b>No UI-level code</b> is included in this demo.",X="</table>",Y="<td>First Row, Second cell</td>",R="Insert HTML Code",S="qx/icon/Oxygen/16/actions/insert-link.png",T="Insert Ordered List",U="demobrowser.demo.bom.HtmlArea",ba="qx/icon/Oxygen/16/actions/format-justify-left.png",bb="Courier",E="Courier New",D="4px",C="qx/icon/Oxygen/16/actions/format-justify-right.png",B="qx/icon/Oxygen/16/actions/format-text-bold.png",A="<td>Second Row, Second cell</td>",z="Insert Image",y="<table border='1'>",x="qx/icon/Oxygen/16/actions/format-indent-less.png",G="<tbody>",F="Times New Roman",bc="",bd="Align Center",be="qx/icon/Oxygen/16/actions/edit-redo.png",bf="Lucida Console",bg="innerHTML",bh="qx/icon/Oxygen/16/actions/format-text-italic.png",bi="Arial",bj="qx/icon/Oxygen/16/actions/format-justify-fill.png",bk="Verdana",bl="Indent Less",bz="Format Strikethrough",by="Format Underline",bx="Inserted Unordered List",bw="It is the foundation for the UI widget component.</p>";
qx.Class.define(U,{extend:qx.application.Native,members:{__SQ:null,__SR:null,__SS:null,__ST:null,__SU:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__SQ=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__SQ,{margin:bB});
var cr=qx.bom.Element.create(bM);
qx.bom.element.Style.setStyles(cr,{width:bK,padding:bT,margin:bT});
var cq=a+ca+M+bw+W+cl+bE;
qx.bom.element.Attribute.set(cr,bg,cq);
this.__SR=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__SR,{width:bK,padding:bT,margin:bT,lineHeight:bT,border:bs});
this.__SS=qx.bom.Element.create("div");
qx.bom.element.Style.setStyles(this.__SS,{width:bK,height:bD,border:bs,borderTop:bT,backgroundColor:bF});
qx.dom.Element.insertEnd(this.__SS,this.__SQ);
var cp=bC;
this.__ST=new qx.bom.htmlarea.HtmlArea(this.__SS,cp,null,"blank.html");
this.__Tf();
qx.dom.Element.insertBegin(this.__SR,this.__SQ);
qx.dom.Element.insertBegin(cr,this.__SQ);
qx.dom.Element.insertBegin(this.__SQ,document.body);
},__SV:function(e){var cs=window.prompt("FontSize: ","");
this.setFontSize(parseInt(cs));
},__SW:function(e){var ct=window.prompt("Color (Hex): ","#");
this.setTextColor(ct);
},__SX:function(e){var cu=window.prompt("BgColor (Hex): ","#");
this.setTextBackgroundColor(cu);
},__SY:function(e){var cv={src:qx.util.ResourceManager.getInstance().toUri("demobrowser/demo/icons/htmlarea/qooxdoo_logo.png"),border:0,title:"qooxdoo logo",alt:"qooxdoo logo"};
this.insertImage(cv);
},__Ta:function(e){var cw=y+G+bu+b+Y+bm+bu+ck+A+bm+cj+X;
this.insertHtml(cw);
},__Tb:function(e){var cx=window.prompt(H,bW);
this.insertHyperLink(cx);
},__Tc:function(e){var cy=window.prompt(ch,bc);
this.insertHtml(cy);
},__Td:function(){var cA=qx.bom.Element.create(bM);
qx.bom.element.Style.setStyles(cA,{"float":bv});
var cC;
var cB=qx.bom.Element.create(bn,{title:bU});

if(qx.core.Environment.get(bO)==bR){qx.bom.element.Attribute.set(cB,bQ,bN);
}else{qx.bom.element.Style.set(cB,bS,bP);
}cC=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cC[0],cB);
var cD=[bI,bk,F,bi,Q,E,bb,bY,N,bJ,bf];
var cz;
var cE;

for(var i=0,j=cD.length;i<j;i++){cz=s+bp+cD[i]+br+cD[i]+bq;
cE=qx.bom.Collection.html(cz);

if(qx.core.Environment.get(bO)==bR){qx.bom.element.Attribute.set(cE[0],bQ,bN);
}else{qx.bom.element.Style.set(cE[0],bS,bP);
}qx.dom.Element.insertEnd(cE[0],cB);
}qx.event.Registration.addListener(cB,bo,function(e){var cF=e.getTarget();
var cG=cF.selectedIndex;

if(cG!=0){this.setFontFamily(cF.options[cG].value);
cF.options[0].selected=true;
}},this.__ST);
qx.dom.Element.insertBegin(cB,cA);
return cA;
},__Te:function(){var cI=qx.bom.Element.create(bM);
qx.bom.element.Style.setStyles(cI,{"marginRight":bL,"float":bv});
var cK;
var cJ=qx.bom.Element.create(bn,{title:O});

if(qx.core.Environment.get(bO)==bR){qx.bom.element.Attribute.set(cJ,bQ,bN);
}else{qx.bom.element.Style.set(cJ,bS,bP);
}cK=qx.bom.Collection.html(bt);
qx.dom.Element.insertEnd(cK[0],cJ);
var cL;
var cH;

for(var i=1;i<=7;i++){cH=o+bp+i+br+i+bq;
cL=qx.bom.Collection.html(cH);

if(qx.core.Environment.get(bO)==bR){qx.bom.element.Attribute.set(cL[0],bQ,bN);
}else{qx.bom.element.Style.set(cL[0],bS,bP);
}qx.dom.Element.insertEnd(cL[0],cJ);
}qx.event.Registration.addListener(cJ,bo,function(e){var cM=e.getTarget();
var cN=cM.selectedIndex;

if(cN!=0){this.setFontSize(cM.options[cN].value);
cM.options[0].selected=true;
}},this.__ST);
qx.dom.Element.insertBegin(cJ,cI);
return cI;
},__Tf:function(){var cP=[{bold:{text:u,image:B,action:this.__ST.setBold},italic:{text:cd,image:bh,action:this.__ST.setItalic},underline:{text:by,image:ce,action:this.__ST.setUnderline},strikethrough:{text:bz,image:w,action:this.__ST.setStrikeThrough},removeFormat:{text:n,image:P,action:this.__ST.removeFormat}},{alignLeft:{text:c,image:ba,action:this.__ST.setJustifyLeft},alignCenter:{text:bd,image:d,action:this.__ST.setJustifyCenter},alignRight:{text:bV,image:C,action:this.__ST.setJustifyRight},alignJustify:{text:g,image:bj,action:this.__ST.setJustifyFull}},{fontFamily:{custom:this.__Td},fontSize:{custom:this.__Te},fontColor:{text:cn,image:L,action:this.__SW},textBackgroundColor:{text:cg,image:h,action:this.__SX}},{indent:{text:bX,image:bG,action:this.__ST.insertIndent},outdent:{text:bl,image:x,action:this.__ST.insertOutdent}},{insertImage:{text:z,image:V,action:this.__SY},insertTable:{text:cc,image:J,action:this.__Ta},insertLink:{text:cf,image:S,action:this.__Tb},insertHTML:{text:R,image:k,action:this.__Tc},insertHR:{text:l,image:m,action:this.__ST.insertHorizontalRuler}},{ol:{text:T,image:bH,action:this.__ST.insertOrderedList},ul:{text:bx,image:ci,action:this.__ST.insertUnorderedList}},{undo:{text:co,image:K,action:this.__ST.undo},redo:{text:I,image:be,action:this.__ST.redo}}];
var cR,cV,cO,cT;

for(var i=0,j=cP.length;i<j;i++){cV={};
cV[q]=i==j-1?bT:bL;
cV[bA]=bv;
cR=qx.bom.Element.create(bM);
qx.bom.element.Style.setStyles(cR,cV);

for(var cS in cP[i]){var cU=cP[i][cS];

if(cU.custom){cO=cU.custom.call(this);
}else{var cQ=qx.util.AliasManager.getInstance().resolve(cU.image);
cT={type:p,src:qx.util.ResourceManager.getInstance().toUri(cQ),title:cU.text,qxKeepFocus:cm,qxSelectable:t};
cO=qx.bom.Element.create(f,cT);
qx.bom.element.Style.setStyles(cO,{width:bL,height:bL,padding:D});

if(qx.core.Environment.get(bO)==bR){qx.bom.element.Attribute.set(cO,bQ,bN);
}else{qx.bom.element.Style.set(cO,bS,bP);
}qx.event.Registration.addListener(cO,r,cU.action,this.__ST);
}qx.dom.Element.insertEnd(cO,cR);
}qx.dom.Element.insertEnd(cR,this.__SR);
}qx.dom.Element.insertEnd(qx.bom.Element.create(v,{style:cb}),this.__SR);
}}});
})();
...
}qx.event.Timer.once(function(){this.__AP();
},this,0);
}}else{this.__AO=0;
...
}}if(fQ!=null&&!qx.lang.String.contains(fR.__Bu,fQ)){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+fQ+"' is not allowed for parameter 'repeat'. Possible values are '"+fR.__Bu+"'");
}return false;
}else{fQ="no-repeat";
}
if(fP!=null){if(qx.lang.Type.isString(fP)&&!qx.lang.String.contains(fR.__Bt,'|'+fP+'|')){if(qx.core.Environment.get("qx.debug")){this.error("The value '"+fP+"' is not allowed for parameter 'position'. Possible values are '"+fR.__Bt+"'");
}return false;
...
if((qx.core.Environment.get(m)==k)){qx.event.Registration.addListener(bl.body,bf,this.__zI,this,true);
...
}}else{if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){this.__Af(bm,bn,this.__zz.getCommandObject(bm));
...
switch(bD.command){case bi:bH.parameter=[bG.get(this.__zD.body,bg)];
break;
...
}catch(bQ){if(qx.core.Environment.get(a)){this.error("execCommand failed! Details: "+bQ);
}}},"mshtml|webkit":function(bR){},"default":function(bS){this.__Aj(bS);
return this.__zT();
...
this.__zz.getCommandObject(bi).customUndo=true;
...
switch(cy){case bi:cD.push(qx.bom.element.Style.get(this.__zD.body,bg));
break;
...
if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){cG.content=this.__zM;
cG.actionType=g;
this.__zM=null;
}this.__Ai(cG);
this.__zL=false;
...
},__Ai:function(cH){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO UNDO STACK");
this.debug(cH.actionType+" "+cH.command+" "+cH.value);
}this.__zB.push(cH);
},__Aj:function(cI){if((qx.core.Environment.get(a))&&qx.core.Environment.get(p)){this.debug("ADD TO REDO STACK");
...
this.__zK=true;
if((qx.core.Environment.get(m)==k)||(qx.core.Environment.get(m)==bh)){this.__zM=this.__zD.body.innerHTML;
}this.__An();
...
if((qx.core.Environment.get(m)==k)){qx.event.Registration.removeListener(this.__zD,bf,this.__zI);
