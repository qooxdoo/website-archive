...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable_Mouseover","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"e39f2af03df8"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var r="row",q="rgb(255, 0, 0)",p="celldata",o="",n="Number",m="red",l="1*",k="celldata='",j="' ",i="<br>",c="demobrowser.demo.progressive.ProgressiveTable_Mouseover",h="end",f="Date",b="Move your mouse over the Date field",a="demobrowser.demo.progressive.DateCellRenderer",e="onmouseover='demobrowser.demo.progressive.DateCellRenderer.onmouseover(this);' ",d="Id",g="onmouseout='demobrowser.demo.progressive.DateCellRenderer.onmouseout(this);' ";
...
var B=0;
var x=function(E){var H=[];
var G=new Date().getTime();
var I=400*24*60*60*1000;

for(var J=0;J<E;J++){var F=new Date(G+Math.random()*I-I/2);
H.push({renderer:r,location:h,data:[B++,Math.random()*10000,F]});
}return H;
};
var A=new qx.ui.progressive.renderer.table.Widths(3);
A.setWidth(0,100);
A.setWidth(1,l);
A.setWidth(2,300);
var u=[d,n,f];
var w=new qx.ui.progressive.headfoot.TableHeading(A,u);
var t=new qx.ui.progressive.headfoot.Progress(A,u);
var D=new qx.ui.progressive.structure.Default(w,t);
var s=new qx.ui.progressive.Progressive(D);
var C=new qx.ui.basic.Atom(b);
C.setTextColor(m);
C.setHeight(16);
C.setRich(true);
s.add(C);
var z=new qx.ui.progressive.model.Default();
var y=x(500);
z.addElements(y);
s.setDataModel(z);
var v=new qx.ui.progressive.renderer.table.Row(A);
s.addRenderer(r,v);
v.addRenderer(2,new demobrowser.demo.progressive.DateCellRenderer());
this.getRoot().add(s,{edge:50});
s.render();
}}});
qx.Class.define(a,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(K){K.__TX=qx.bom.element.Style.get(K,"color");
K.style.color=q;
K.parentNode.style.height=32;
K.__TY=K.innerHTML;
var M=Date.parse(K.attributes.getNamedItem(p).nodeValue);
var L=new Date(M);
K.innerHTML=L.toUTCString()+i+L.toString();
},onmouseout:function(N){N.style.color=N.__TX;
N.parentNode.style.height=16;
N.innerHTML=N.__TY;
}},members:{_getCellExtras:function(O){var P=[];
P.push(qx.ui.progressive.renderer.table.cell.Default.prototype._getCellExtras.call(this));
P.push(k+O.cellData.toUTCString()+j);
P.push(e,g);
return P.join(o);
}}});
})();
...
(function(){var l=".qx-progressive-",k="-col-",j="px;",h="-row",g="}",f="width: ",d="0px ",c="qx-progressive-",b="px",a="content",G="px ",F="end",E="div",D="qx.tableResizeDebug",C="  width : 100%;",B=" {",A="__columnData",z="css.boxmodel",y="qx.debug",x="__Oz",s="relative",t="-row {",q="resize",r="start",o="",p="padding: ",m="__Ow",n="qx.ui.progressive.renderer.table.Row",u="progressive-table-row-background-odd",v="progressive-table-row-background-even",w="left: ";
qx.Class.define(n,{extend:qx.ui.progressive.renderer.Abstract,construct:function(H){qx.ui.progressive.renderer.Abstract.call(this);
this.__Ou=H;
this.__Ov={};
this.__Ow=new qx.ui.progressive.renderer.table.cell.Default();
this.__Ox=null;
this.__Oy={};
var I=qx.theme.manager.Color.getInstance();
this.__Oy.bgcol=[];
this.__Oy.bgcol[0]=I.resolve(v);
this.__Oy.bgcol[1]=I.resolve(u);
this.__Oz=new qx.ui.layout.HBox();
this.__Oz.connectToWidget(this);
},statics:{__OA:null,__OB:6,__OC:"  position: absolute;"+"  top: 0px;"+"  height: 100%;"+"  overflow:hidden;"+"  text-overflow:ellipsis;"+"  -o-text-overflow: ellipsis;"+"  white-space:nowrap;"+"  border-right:1px solid #f2f2f2;"+"  border-bottom:1px solid #eeeeee;"+"  padding : 0px 6px 0px 6px;"+"  cursor:default;"+"  font-size: 11px;"+"  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;"+((qx.core.Environment.get("engine.name")=="mshtml")?'':';-moz-user-select:none;')},properties:{defaultRowHeight:{init:16}},members:{__Ox:null,__OD:null,__OE:null,__Ou:null,__Ov:null,__Ow:null,__Oy:null,__Oz:null,join:function(J,name){if(this.__Ox){throw new Error("Renderer is already joined to a Progressive.");
}this.__Ox=J;
this.__OD=name;
var L=qx.ui.progressive.renderer.table.Row;

if(!L.__OA){L.__OA={};
}var K=J.toHashCode();

if(!L.__OA[K]){L.__OA[K]={rowstylesheet:null,cellstylesheet:[]};
var M=l+K+t+C+g;
L.__OA[K].rowstylesheet=qx.bom.Stylesheet.createElement(M);
var N=this.__Ou.getData();

for(var i=0;i<N.length;i++){var M=l+K+k+i+B+L.__OC+g;
L.__OA[K].cellstylesheet[i]=qx.bom.Stylesheet.createElement(M);
}this.__OE=K;
var O=J.getStructure().getPane();
O.addListener(q,this._resizeColumns,this);
}},addRenderer:function(P,Q){var R=this.__Ou.getData();

if(P<0||P>=R.length){throw new Error("Column "+P+" out of range (max: "+(R.length-1)+")");
}this.__Ov[P]=Q;
},removeRenderer:function(S){var T=this.__Ou.getData();

if(S<0||S>=T.length){throw new Error("Column "+S+" out of range (max: "+(T.length-1)+")");
}
if(!this.__Ov[S]){throw new Error("No existing renderer for column "+S);
}delete this.__Ov[S];
},render:function(U,V){var bg=V.data;
var bb=[];
var bd;
var bc;
var Y=0;
if(U.getRendererData()[this.__OD].end===undefined){U.getRendererData()[this.__OD]={end:0,start:1,rows:0,totalHeight:0};
}var bf=document.createElement(E);
for(var i=0;i<bg.length;i++){var ba=c+this.__OE+k+i;
bc=this.__Ov[i]||this.__Ow;
bd={state:U,rowDiv:bf,stylesheet:ba,element:V,dataIndex:i,cellData:bg[i],height:Y};
bb.push(bc.render(bd));
if(bd.height>Y){Y=bd.height;
}}Y=(Y>0?Y:this.getDefaultRowHeight());
var be=U.getRendererData()[this.__OD];
be.totalHeight+=Y;
bf.style.position=s;
bf.style.height=Y+b;
bf.className=c+this.__OE+h;
bf.innerHTML=bb.join(o);
switch(V.location){case F:var W=be.end||0;
bf.style.backgroundColor=this.__Oy.bgcol[W];
be.end=(W==0?1:0);
U.getPane().getContentElement().getDomElement().appendChild(bf);
break;
case r:var X=U.getPane().getContentElement().getDomElement();
var bh=X.childNodes;
if(bh.length>0){var W=be.start;
bf.style.backgroundColor=this.__Oy.bgcol[W];
be.start=(W==0?1:0);
X.insertBefore(bf,bh[0]);
break;
}else{X.appendChild(bf);
}break;
default:throw new Error("Invalid location: "+V.location);
}++be.rows;
},getLayoutChildren:function(){return this.__Ou.getData();
},_resizeColumns:function(e){var bp=this.__Ox.getStructure().getPane();
var bm=bp.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bn=l+this.__OE+h;
var bj=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bj.__OA[this.__OE].rowstylesheet,bn);
var bl=f+bm+j;
qx.bom.Stylesheet.addRule(bj.__OA[this.__OE].rowstylesheet,bn,bl);
this.__Oz.renderLayout(bm,100);
var bo=this.__Ou.getData();
for(var i=0,bs=0;i<bo.length;i++,bs+=bm){var bn=l+this.__OE+k+i;
var bj=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bj.__OA[this.__OE].cellstylesheet[i],bn);
bm=bo[i].getComputedWidth();

if(qx.core.Environment.get(y)){if(qx.core.Environment.get(D)){this.debug("col "+i+": width="+bm);
}}var bk;

if(qx.core.Environment.get(z)==a){bk=qx.ui.progressive.renderer.table.Row.__OB*2;
}else{bk=-1;
}var br=(bm-bk)+j;
var bq=d+qx.ui.progressive.renderer.table.Row.__OB+G+d+qx.ui.progressive.renderer.table.Row.__OB+j;
var bi=bs+j;
var bl=bj.__OC+f+br+w+bi+p+bq;
qx.bom.Stylesheet.addRule(bj.__OA[this.__OE].cellstylesheet[i],bn,bl);
}}},destruct:function(){var name;

for(name in this.__Ov){this.__Ov[name]=null;
}var bu=qx.ui.progressive.renderer.table.Row;
var bt=this.__Ox.toHashCode();

if(bu.__OA&&bu.__OA[bt]){if(bu.__OA[bt].rowstylesheet){var bw=l+this.__OE+h;
var bu=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bu.__OA[this.__OE].rowstylesheet,bw);
}if(bu.__OA[bt].cellstylesheet){for(var i=bu.__OA[bt].cellstylesheet.length-1;i>=0;i--){var bw=l+this.__OE+k+i;
var bv=bu.__OA[this.__OE].cellstylesheet[i];
var bu=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bv,bw);
}}}
if(this.__Ox&&this.__Ox.getRendererData){var bx=this.__Ox.getRendererData();

if(bx&&bx[this.__OD]&&bx[this.__OD].end!==undefined){bx[this.__OD]=null;
}}this.__Oy=this.__Ov=this.__Ox=this.__Ou=null;
this._disposeObjects(x,m,A);
}});
})();
...
for(var i=0;i<e;i++){this.__Qn[i]=new qx.ui.core.ColumnData();
}},members:{__Qn:null,getData:function(){return this.__Qn;
...
}}},setWidth:function(j,k){if(j>this.__Qn.length-1||j<0){throw new Error("Column number out of range");
}this.__Qn[j].setColumnWidth(k);
},setMinWidth:function(l,m){if(l>this.__Qn.length-1||l<0){throw new Error("Column number out of range");
}this.__Qn[l].setMinWidth(m);
},setMaxWidth:function(n,o){if(n>this.__Qn.length-1||n<0){throw new Error("Column number out of range");
}this.__Qn[n].setMaxWidth(o);
}}});
})();
...
},members:{__NH:null,join:function(c){this.__NH=c;
...
this.__NK=new qx.ui.layout.HBox();
this.__NK.connectToWidget(this);
},properties:{appearance:{refine:true,init:c}},members:{__NI:null,__NL:null,__NJ:null,__NK:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);
},getLayoutChildren:function(){if(this.__NL){return this.__NI.getData();
...
this.__NL=true;
this.__NK.renderLayout(n,100);
this.__NL=false;
var o=this.__NI.getData();
for(var i=0;i<o.length;i++){this.__NJ[i].setWidth(o[i].getComputedWidth());
}}},destruct:function(){this.__NI=this.__NJ=null;
this._disposeObjects(b);
}});
})();
(function(){var n="progressive-progressbar-indicator-undone",m="__Rh",l="progress",k="%",j="progressive-progressbar-indicator-done",i="progressive-progressbar-percent-text",h="renderStart",g="__Ri",f="progressive-progressbar-background",d="0%",a="qx.ui.progressive.headfoot.Progress",c="progressive-progressbar-percent-background",b="renderEnd";
...
this.__Rg.background=q.resolve(f);
this.__Rg.indicatorDone=q.resolve(j);
this.__Rg.indicatorUndone=q.resolve(n);
this.__Rg.percentBackground=q.resolve(c);
this.__Rg.percentText=q.resolve(i);
this.set({backgroundColor:this.__Rg.background});
this.__Rh=new qx.ui.core.Widget();
this.__Rh.set({width:0,backgroundColor:this.__Rg.indicatorDone});
this.add(this.__Rh);
var r=new qx.ui.core.Widget();
r.set({backgroundColor:this.__Rg.indicatorUndone});
this.add(r,{flex:1});
this.__Ri=new qx.ui.basic.Atom(d);
this.__Ri.set({width:100,backgroundColor:this.__Rg.percentBackground,textColor:this.__Rg.percentText});
this.add(this.__Ri);
this.exclude();
},members:{__Rj:null,__Rg:null,__Rh:null,__Ri:null,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);
s.addListener(h,function(e){this.__Rj=e.getData().initial;
this.show();
},this);
s.addListener(l,function(e){var v=1.0-(e.getData().remaining/this.__Rj);
var w=this.getBounds();

if(w){var t=Math.floor((w.width-this.__Ri.getBounds().width)*v);
var u=Math.floor(v*100)+k;

if(!isNaN(t)){this.__Rh.setMinWidth(t);
this.__Ri.setLabel(u);
}}},this);
s.addListener(b,function(e){this.exclude();
},this);
}},destruct:function(){this.__Rg=null;
this._disposeObjects(m,g);
}});
})();
...
if(!e){this.__Pl=new qx.ui.core.Widget();
this.__Pm=this.__Pl;
}else{this.__Pl=null;
this.__Pm=e;
}this.__Pm.getContentElement().setStyle(b,a);
},members:{__Pl:null,__Pm:null,applyStructure:function(f){throw new Error("applyStructure() is abstract");
},getPane:function(){return this.__Pm;
}},destruct:function(){if(this.__Pl){this.__Pl.dispose();
...
if(!b){this.__Pv=new qx.ui.progressive.headfoot.Null();
this.__Pw=this.__Pv;
}else{this.__Pv=null;
this.__Pw=b;
}if(!c){this.__Px=new qx.ui.progressive.headfoot.Null();
this.__Py=this.__Px;
}else{this.__Px=null;
this.__Py=c;
}},members:{__Pw:null,__Py:null,__Pv:null,__Px:null,applyStructure:function(e){this.__Pw.join(e);
this.__Py.join(e);
e.add(this.__Pw);
e.add(this.getPane(),{flex:1});
e.add(this.__Py);
},getHeader:function(){return this.__Pw;
},getFooter:function(){return this.__Py;
}},destruct:function(){if(this.__Pv){this.__Pv.dispose();
this.__Pv=null;
}
if(this.__Px){this.__Px.dispose();
this.__Px=null;
}this.__Pw=this.__Py=null;
}});
})();
...
this.__PC=false;
this.__PD=0;
},events:{"renderStart":k,"renderEnd":k,"progress":k,"progressDetail":k},properties:{dataModel:{check:c,apply:f},batchSize:{check:g,init:20},flushWidgetQueueAfterBatch:{check:d,init:false},interElementTimeout:{check:g,init:0}},members:{__Pz:null,__PC:null,__PE:null,__PD:null,__PB:null,__PA:null,getStructure:function(){return this.__PA;
},addRenderer:function(name,m){this.__Pz[name]=m;
m.join(this,name);
},removeRenderer:function(name){if(!this.__Pz[name]){throw new Error("No existing renderer named "+name);
}delete this.__Pz[name];
},render:function(){if(this.__PC){return;
}this.__PC=true;
var n=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__PA.getPane(),batchSize:this.getBatchSize(),rendererData:this.__PG(),userData:{}});
this.__PE=new Date();
if(this.__PB){this.__PD=n.getModel().getElementCount();
this.fireDataEvent(h,{state:n,initial:this.__PD});
this.__PF(n);
}else{qx.event.Timer.once(function(){this.__PD=n.getModel().getElementCount();
this.fireDataEvent(h,{state:n,initial:this.__PD});
this.__PF(n);
this.__PB=true;
},this,10);
}},_applyDataModel:function(o,p){if(p){p.removeListener(j,this.__PH,this);
p.dispose();
}o.addListener(j,this.__PH,this);
},__PF:function(q){var r;
var t;
var s;

for(var i=q.getBatchSize();i>0;i--){r=q.getModel().getNextElement();

if(!r){this.debug("Render time: "+(new Date()-this.__PE)+"ms");
this.__PC=false;
this.fireDataEvent("renderEnd",q);
q.dispose();
return ;
}t=r.element;
s=this.__Pz[t.renderer];
s.render(q,t);
this.fireDataEvent("progressDetail",{initial:this.__PD,remaining:r.remaining,element:t});
}this.fireDataEvent("progress",{initial:this.__PD,remaining:r.remaining});
if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();
}qx.event.Timer.once(function(){this.__PF(q);
},this,this.getInterElementTimeout());
},__PG:function(){var u={};

for(var name in this.__Pz){u[name]={};
}return u;
},__PH:function(e){this.__PD=e.getData();
this.render();
}},destruct:function(){for(var name in this.__Pz){this.__Pz[name].dispose();
}this.__PE=this.__Pz=this.__PA=null;
}});
})();
...
this.__PV=[];
},members:{__PV:null,addElements:function(c){this.__PV=this.__PV.concat(c);
this.fireDataEvent(b,this.__PV.length);
},addElement:function(d){this.__PV.push(d);
this.fireDataEvent(b,this.__PV.length);
},getElementCount:function(){return this.__PV.length;
},getNextElement:function(){if(this.__PV.length>0){return ({element:this.__PV.shift(),remaining:this.__PV.length});
}return null;
