...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.ColorPopup","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.ColorPopup-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"b0248cbaf886"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
ca.setBackgroundColor(this.__Jv[bX]);
...
bT.setWidth(55);
bT.addListener(br,this._onHexFieldChange,this);
break;
...
bT.setWidth(50);
bT.addListener(br,this._setRedFromSpinner,this);
break;
case bb:bT=new qx.ui.form.Spinner(0,255,255);
bT.setWidth(50);
bT.addListener(br,this._setGreenFromSpinner,this);
break;
case U:bT=new qx.ui.form.Spinner(0,255,255);
bT.setWidth(50);
bT.addListener(br,this._setBlueFromSpinner,this);
break;
...
bT.setWidth(50);
bT.addListener(br,this._setHueFromSpinner,this);
break;
case S:bT=new qx.ui.form.Spinner(0,0,100);
bT.setWidth(50);
bT.addListener(br,this._setSaturationFromSpinner,this);
break;
case X:bT=new qx.ui.form.Spinner(0,100,100);
bT.setWidth(50);
bT.addListener(br,this._setBrightnessFromSpinner,this);
break;
...
this.__JB=false;
this.setBlue(ce[2]);
},getValue:function(){return this.__JA?null:bx+qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]);
},resetValue:function(){this.__JA=true;
this.__JB=true;
this.setRed(255);
this.setGreen(255);
this.__JB=false;
this.setBlue(255);
},__JC:function(){if(!this.__JB){this.__JA=false;
this.fireDataEvent("changeValue",this.getValue());
}},_applyRed:function(cf,cg){if(this.__Ju===null){this.__Ju=by;
}
if(this.__Ju!==bt){this.getChildControl(bn).setValue(cf);
}
if(this.__Ju!==bs){this._setHexFromRgb();
}
switch(this.__Ju){case bt:case bs:case by:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__JC();

if(this.__Ju===by){this.__Ju=null;
}},_applyGreen:function(ch,ci){if(this.__Ju===null){this.__Ju=bF;
}
if(this.__Ju!==bt){this.getChildControl(bb).setValue(ch);
}
if(this.__Ju!==bs){this._setHexFromRgb();
}
switch(this.__Ju){case bt:case bs:case bF:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__JC();

if(this.__Ju===bF){this.__Ju=null;
}},_applyBlue:function(cj,ck){if(this.__Ju===null){this.__Ju=bB;
}
if(this.__Ju!==bt){this.getChildControl(U).setValue(cj);
}
if(this.__Ju!==bs){this._setHexFromRgb();
}
switch(this.__Ju){case bt:case bs:case bB:this._setHueFromRgb();
}this._setPreviewFromRgb();
this.__JC();

if(this.__Ju===bB){this.__Ju=null;
}},_applyHue:function(cl,cm){if(this.__Ju===null){this.__Ju=bG;
}
if(this.__Ju!==bu){this.getChildControl(T).setValue(cl);
}
if(this.__Ju!==bq){if(this.getChildControl(bv).getBounds()){this.getChildControl(bv).setDomLeft(Math.round(cl/1.40625)+this.getChildControl(V).getPaddingLeft());
}else{this.getChildControl(bv).setLayoutProperties({left:Math.round(cl/1.40625)});
}}
switch(this.__Ju){case bu:case bq:case bG:this._setRgbFromHue();
}this._setBrightnessGradiant();

if(this.__Ju===bG){this.__Ju=null;
}},_applySaturation:function(cn,co){if(this.__Ju===null){this.__Ju=bC;
}
if(this.__Ju!==bu){this.getChildControl(S).setValue(cn);
}
if(this.__Ju!==bq){this._setBrightnessGradiant();
...
switch(this.__Ju){case bu:case bq:case bC:this._setRgbFromHue();
}
if(this.__Ju===bC){this.__Ju=null;
}},_applyBrightness:function(cp,cq){if(this.__Ju===null){this.__Ju=bE;
}
if(this.__Ju!==bu){this.getChildControl(X).setValue(cp);
}
if(this.__Ju!==ba){var cr=256-Math.round(cp*2.56);
...
switch(this.__Ju){case bu:case ba:case bE:this._setRgbFromHue();
}
if(this.__Ju===bE){this.__Ju=null;
...
this.__Jx=cu.top+(e.getDocumentTop()-ct.top)-cs.top;
e.stopPropagation();
},_onBrightnessHandleMouseUp:function(e){this.getChildControl(bw).releaseCapture();
this.__Jw=null;
},_onBrightnessHandleMouseMove:function(e){if(this.__Jw===bw){this._setBrightnessOnFieldEvent(e);
e.stopPropagation();
...
this.__Jx=location.top+(cv.height/2);
...
e.stop();
},_setBrightnessOnFieldEvent:function(e){var cw=qx.lang.Number.limit(e.getDocumentTop()-this.__Jx,0,256);
this.__Ju=ba;
...
this.__Ju=null;
},_onHueSaturationHandleMouseUp:function(e){if(this.__Jw){e.stopPropagation();
this.getChildControl(bv).releaseCapture();
this.__Jw=null;
}},_onHueSaturationHandleMouseMove:function(e){if(this.__Jw===bv){this._setHueSaturationOnFieldEvent(e);
e.stopPropagation();
...
this.__Jy=location.top+(cx.height/2)-cy.top;
this.__Jz=location.left+(cx.width/2)-cy.left;
...
e.stop();
},_setHueSaturationOnFieldEvent:function(e){var cA=qx.lang.Number.limit(e.getDocumentTop()-this.__Jy,0,256);
var cz=qx.lang.Number.limit(e.getDocumentLeft()-this.__Jz,0,256);
this.getChildControl(bv).setDomPosition(cz,cA);
this.__Ju=bq;
this.setSaturation(100-Math.round(cA/2.56));
this.setHue(Math.round(cz*1.40625));
this.__Ju=null;
},_setRedFromSpinner:function(){if(this.__Ju!==null){return;
}this.__Ju=bt;
this.setRed(this.getChildControl(bn).getValue());
this.__Ju=null;
},_setGreenFromSpinner:function(){if(this.__Ju!==null){return;
}this.__Ju=bt;
this.setGreen(this.getChildControl(bb).getValue());
this.__Ju=null;
},_setBlueFromSpinner:function(){if(this.__Ju!==null){return;
}this.__Ju=bt;
this.setBlue(this.getChildControl(U).getValue());
this.__Ju=null;
},_setHueFromSpinner:function(){if(this.__Ju!==null){return;
}this.__Ju=bu;
this.setHue(this.getChildControl(T).getValue());
this.__Ju=null;
},_setSaturationFromSpinner:function(){if(this.__Ju!==null){return;
}this.__Ju=bu;
this.setSaturation(this.getChildControl(S).getValue());
this.__Ju=null;
},_setBrightnessFromSpinner:function(){if(this.__Ju!==null){return;
}this.__Ju=bu;
this.setBrightness(this.getChildControl(X).getValue());
this.__Ju=null;
},_onHexFieldChange:function(e){if(this.__Ju!==null){return;
}
...
this.setGreen(cG[1]);
this.setBlue(cG[2]);
},_setHueFromRgb:function(){switch(this.__Ju){case bu:case bq:case ba:break;
...
}},_setRgbFromHue:function(){switch(this.__Ju){case bt:case bs:break;
