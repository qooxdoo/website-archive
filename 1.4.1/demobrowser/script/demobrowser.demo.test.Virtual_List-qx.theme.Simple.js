...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Virtual_List","qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.test.Virtual_List-qx.theme.Simple.js"]],
  urisBefore : [],
  packageHashes : {"0":"5cd80ddb0ed7"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
this.__UT=new qx.ui.virtual.layer.WidgetCell(this);
this.getPane().addLayer(this.__UT);
this.getPane().addListener(z,this._onResize,this);
this.__UU=[];
this.__UV=[];
this.__UW=new qx.ui.virtual.selection.Row(this.getPane());
this.__UW.addListener(h,this._onChangeSelection,this);
this.__UW.attachMouseEvents();
this.__UW.attachKeyEvents(this);
this.__UW.attachListEvents(this);
...
this.fireDataEvent(h,this.__Vb(e.getData()));
},getCellWidget:function(I,J){var L=this.__UU[I];

if(!L){return null;
}var K=this.__UV.pop()||new qx.ui.form.ListItem();
K.set({label:L.getLabel(),icon:L.getIcon()});

if(this.__UW.isItemSelected(I)){K.addState(n);
}else{K.removeState(n);
}K.setUserData(g,I);
return K;
},poolCellWidget:function(M){this.__UV.push(M);
...
},getChildren:function(){return this.__UU;
},hasChildren:function(){return this.__UU.length>0;
...
qx.ui.core.queue.Widget.add(this);
},add:function(W){this.__UU.push(W);
this._addHelper(W);
return this;
},remove:function(X){qx.lang.Array.remove(this.__UU,X);
this._removeHelper(X);
return this;
},removeAll:function(){for(var i=0,j=this.__UU.length;i<j;i++){this._removeHelper(this.__UU[i]);
}this.__UU=[];
},indexOf:function(Y){return this.__UU.indexOf(Y);
},addAt:function(ba,bb){qx.lang.Array.insertAt(this.__UU,ba,bb);
this._addHelper(ba);
},addBefore:function(bc,bd){qx.lang.Array.insertBefore(this.__UU,bc,bd);
this._addHelper(bc);
},addAfter:function(be,bf){qx.lang.Array.insertAfter(this.__UU,be,bf);
this._addHelper(be);
},removeAt:function(bg){this.__UU.splice(bg,1);
this._removeHelper(this.__UU[bg]);
},__UX:function(bh){var bi=this.__UU.indexOf(bh);

if(bi<0){return null;
}else{return bi;
}},__UY:function(bj){var bk=this.__UU[bj];
return bk;
},__Va:function(bl){var bm=[];

for(var i=0;i<bl.length;i++){bm.push(this.__UX(bl[i]));
}return bm;
},__Vb:function(bn){var bo=[];

for(var i=0;i<bn.length;i++){bo.push(this.__UU[bn[i]]);
}return bo;
},selectAll:function(){this.__UW.selectAll();
},setSelected:function(bp){this.__UW.selectItem(this.__UX(bp));
},isSelected:function(bq){return this.__UW.isItemSelected(this.__UX(bq));
},addToSelection:function(br){this.__UW.addItem(this.__UX(br));
},removeFromSelection:function(bs){this.__UW.removeItem(this.__UX(bs));
},selectRange:function(bt,bu){this.__UW.selectItemRange(this.__UX(bt),this.__UX(bu));
},resetSelection:function(){this.__UW.clearSelection();
},setSelection:function(bv){this.__UW.replaceSelection(this.__Va(bv));
},getSelectedItem:function(){return this.__UU[this.getSelected()];
},getSelected:function(){return this.__UU[this.__UW.getSelectedItem()];
},getSelection:function(){return this.__Vb(this.__UW.getSelection());
},getSortedSelection:function(){return this.__Vb(this.__UW.getSortedSelection());
},isSelectionEmpty:function(){return this.__UW.isSelectionEmpty();
},getSelectionContext:function(){return this.__UW.getSelectionContext();
},getSelectables:function(){return this.__Vb(this.__UW.getSelectables());
},_applySelectionMode:function(bw,bx){this.__UW.setMode(bw);
},_applyDragSelection:function(by,bz){this.__UW.setDrag(by);
},_applyQuickSelection:function(bA,bB){this.__UW.setQuick(bA);
}}});
})();
