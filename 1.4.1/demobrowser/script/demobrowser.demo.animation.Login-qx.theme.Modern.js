...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.animation.Login","qx.theme":"qx.theme.Modern"};
...
(function(){var o="top",n="right",m="resize",l="Name",k="Password",j="__SJ",h="__SI",g="__SH",f="appear",d="demobrowser.demo.animation.Login",a="50%",c="execute",b="30%";
qx.Class.define(d,{extend:qx.application.Standalone,members:{__SH:null,__SI:null,__SJ:null,checkInput:function(){this.__SH.start();
},__SK:function(){this.__SH=new qx.fx.effect.combination.Shake(this.__SI.getContainerElement().getDomElement());
...
this.__SI=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__SI.setLayout(q);
this.__SI.addListener(m,function(e){var u=this.__SI.getBounds();
this.__SI.set({marginTop:Math.round(-u.height/2),marginLeft:Math.round(-u.width/2)});
},this);
this.getRoot().add(this.__SI,{left:a,top:b});
var p=[l,k];

for(var i=0;i<p.length;i++){this.__SI.add(new qx.ui.basic.Label(p[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var r=new qx.ui.form.TextField();
var s=new qx.ui.form.PasswordField();
this.__SI.add(r.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__SI.add(s.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var t=this.__SJ=new qx.ui.form.Button("Login");
t.setAllowStretchX(false);
this.__SI.add(t,{row:3,column:1});
t.addListener(c,this.checkInput,this);
this.__SI.addListener(f,this.__SK,this);
