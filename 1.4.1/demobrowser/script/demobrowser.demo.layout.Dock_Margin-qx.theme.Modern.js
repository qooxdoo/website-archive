...
var envinfo = {"qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.Dock_Margin","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.layout.Dock_Margin-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"7eebab1bd0e6"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var p="main",o="east",n="yellow",m="center",l="red",k="bottom",j="north",i="south",h="west",g="green",c="fuchsia",f="orange",e="blue",b="x",a="demobrowser.demo.layout.Dock_Margin",d="y";
...
scroll.add(r);
var q=new qx.ui.container.Composite(new qx.ui.layout.Dock(3,10)).set({decorator:p,backgroundColor:n,allowGrowX:false});
var x=new qx.ui.core.Widget().set({decorator:p,backgroundColor:l});
var w=new qx.ui.core.Widget().set({decorator:p,backgroundColor:e,marginLeft:20});
var v=new qx.ui.core.Widget().set({decorator:p,backgroundColor:f,marginTop:20});
var u=new qx.ui.core.Widget().set({decorator:p,backgroundColor:g,maxHeight:20,alignY:k});
...
q.add(t,{edge:m});
r.add(q);
var s=new qx.ui.layout.Dock(3,10);
s.setSort(d);
var q=(new qx.ui.container.Composite(s)).set({decorator:p,backgroundColor:n,allowGrowX:false});
var x=new qx.ui.core.Widget().set({decorator:p,backgroundColor:l});
var w=new qx.ui.core.Widget().set({decorator:p,backgroundColor:e,marginLeft:20});
var v=new qx.ui.core.Widget().set({decorator:p,backgroundColor:f,marginTop:20});
var u=new qx.ui.core.Widget().set({decorator:p,backgroundColor:g,maxHeight:20,alignY:k});
