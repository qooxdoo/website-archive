...
(function(){var s="",r="URL",q="Add",p="keypress",o="Title",n="__DI",m="Add a feed",l="feedreader.view.AddFeedWindow",k="user",j="__DK",c="__DJ",i="icon/16/actions/document-new.png",g="icon/16/actions/dialog-apply.png",b="right",a="this.__form",f="Feed Information",d="execute",h="Enter";
...
this._addContent();
},members:{__DJ:null,__DK:null,__DI:null,__DL:null,_addContent:function(){this.setLayout(new qx.ui.layout.VBox(10));
this.__DL=new qx.ui.form.Form();
this.__DL.addGroupHeader(this.tr(f));
this.__DK=new qx.ui.form.TextField().set({required:true,width:250});
this.__DL.add(this.__DK,this.tr(o));
this.__DJ=new qx.ui.form.TextField().set({required:true});
this.__DL.add(this.__DJ,this.tr(r),qx.util.Validate.checkUrl);
var u=new qx.ui.form.Button(this.tr(q),g);
u.set({alignX:b,allowGrowX:false});
u.addListener(d,this._addFeed,this);
this.__DL.addButton(u);
this.addListener(p,function(e){if(e.getTarget() instanceof qx.ui.form.TextField&&e.getKeyIdentifier()===h){this._addFeed();
}});
this.add(new qx.ui.form.renderer.SinglePlaceholder(this.__DL));
},_addFeed:function(e){if(this.__DL.validate()){var w=this.__DK.getValue();
var v=this.__DJ.getValue();
this.__DI.addFeed(w,v,k);
this.__DK.setValue(s);
this.__DJ.setValue(s);
this.close();
}}},destruct:function(){this.__DM=null;
this._disposeObjects(n,j,c,a);
}});
})();
...
qx.Class.define(h,{statics:{__mq:{text:1,textarea:1,select:1,checkbox:1,radio:1,password:1,hidden:1,submit:1,image:1,file:1,search:1,reset:1,button:1},create:function(w,x,y){var x=x?qx.lang.Object.clone(x):{};
var z;
