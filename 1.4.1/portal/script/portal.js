...
var settings = {"qx.application":"portal.Application","qx.revision":"27304","qx.theme":"qx.theme.Modern","qx.version":"1.4.1"};
...
var envinfo = {"qx.application":"portal.Application","qx.debug":false,"qx.revision":"27304","qx.theme":"qx.theme.Modern","qx.version":"1.4.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"portal":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.4.1"}};
...
this.__Fo=[];
this.__Fp={};
},statics:{dataKeyRoot:h,dataKeyGroupBoxes:m,dataKeyBoxes:d},events:{"loaded":e},properties:{activeBox:{init:null,check:g,apply:c}},members:{__Fn:null,__Fo:null,__Fp:null,_applyActiveBox:function(n,o){if(o!=null){o.setActive(false);
}n.setActive(true);
},load:function(){this.__Fq(window[portal.box.Manager.dataKeyRoot]);
qx.event.Registration.fireEvent(this,b);
},__Fq:function(p){var t,w,u,v,x,p;
...
this.__Fn.push(x);
this.__Fp[w].push(x);
}}},getBoxes:function(){return this.__Fn;
},getGroupBoxes:function(){return this.__Fo;
},updateGroupBoxMembers:function(y,z,A){var B=qx.dom.Hierarchy.getElementIndex(A.getElement());
qx.lang.Array.remove(this.__Fp[z],A);
qx.lang.Array.insertAt(this.__Fp[y],A,B);
},getGroupBoxDataOfBox:function(C){for(var i=0,j=this.__Fo.length,D;i<j;i++){D=this.__Fp[this.__Fo[i].id];

for(var k=0,l=D.length;k<l;k++){if(D[k].getId()===C){return this.__Fo[i];
}}}return null;
}},destruct:function(){this.__Fn=this.__Fo=this.__Fp=null;
}});
})();
...
qx.Class.define(p,{extend:qx.core.Object,construct:function(t,u,v,w){qx.core.Object.call(this);
this.__Fr=t;
this.__Fs=t.id;
...
this.__Ft=new portal.box.Resizable(this,x);
}if(t.draggable){this.setDraggable(true);
this.__Fu=new portal.box.Draggable(this);
}this.__Fw();
},properties:{element:{init:null},groupBoxId:{init:null,check:h},active:{check:s,init:false,apply:j},resizable:{check:s,init:false},draggable:{check:s,init:false}},members:{__Fs:null,__Fr:null,__Fu:null,__Ft:null,_applyActive:function(y,z){if(y){qx.bom.element.Style.set(this.getElement(),q,a);
}else{qx.bom.element.Style.set(this.getElement(),q,n);
}},getId:function(){return this.getElement()?this.getElement().id:null;
},getData:function(){return this.__Fr;
},getDraggableComponent:function(){return this.__Fu;
},getResizableComponent:function(){return this.__Ft;
},__Fv:function(A,B){if(B){for(var C in B){qx.bom.element.Style.set(C,B[C]);
}}qx.bom.element.Style.set(A,l,b);
qx.bom.element.Style.set(A,k,0);
qx.bom.Element.addListener(A,o,this.__Fx,this,true);
},__Fw:function(){var E=f+g;
E=E+r+E+r+E;
var D=qx.bom.Element.create(d,{"class":i});
D.innerHTML=E;
qx.dom.Element.insertEnd(D,this.getElement());
},__Fx:function(e){portal.box.Manager.getInstance().setActiveBox(this);
}},destruct:function(){this.resetElement();
this.__Fr=this.__Ft=this.__Fu=null;
}});
})();
...
qx.Class.define(c,{extend:qx.core.Object,construct:function(d,f){qx.core.Object.call(this);
this.__Fy=d;
this.__Fz=this.__Fy.getElement();
this.__FA={};
this.__FB=false;
this.__FC={orientation:null,lastCoord:{left:null,top:null}};
this.__FD={minWidth:10,minHeight:10,maxWidth:null,maxHeight:null,autoHide:true,handles:3};

for(var name in this.__FD){if(f[name]){this.__FD[name]=f[name];
}}this.__FE();
},members:{__FC:null,__Fy:null,__Fz:null,__FA:null,__FD:null,__FB:false,getBox:function(){return this.__Fy;
},__FE:function(){switch(this.__FD.handles){case 1:this.__FA.east=null;
break;
case 2:this.__FA.south=null;
break;
case 3:this.__FA.south=null;
this.__FA.southeast=null;
this.__FA.east=null;
break;
}for(var h in this.__FA){var g=this.__FA[h]=qx.bom.Element.create("div");
qx.bom.element.Attribute.set(g,"orientation",h);
qx.dom.Element.insertEnd(g,this.__Fz);

if(this.__Fz.id){g.id=this.__Fz.id+"_"+h;
}this.__FF(h);
this.__FG(h);
}},__FF:function(i){qx.bom.element.Class.add(this.__FA[i],i+"Handle");
qx.bom.element.Style.set(this.__FA[i],"visibility",this.__FD.autoHide?"hidden":"visible");
},__FG:function(j){var l=qx.event.Registration;
var k=this.__FA[j];
l.addListener(k,"mousedown",this.__FJ,this);
l.addListener(document,"mouseup",this.__FK,this);

if(this.__FD.autoHide){l.addListener(this.__Fy.getElement(),"mouseover",this.__FH,this);
l.addListener(this.__Fy.getElement(),"mouseout",this.__FI,this);
}},__FH:function(e){for(var m in this.__FA){qx.bom.element.Style.set(this.__FA[m],"visibility","visible");
}},__FI:function(e){if(!this.__FB){for(var n in this.__FA){qx.bom.element.Style.set(this.__FA[n],"visibility","hidden");
}}},__FJ:function(e){e.stopPropagation();
if(e.isLeftPressed()){qx.event.Registration.addListener(document,"mousemove",this.__FL,this,true);
this.__FB=true;
var o=e.getTarget();
this.__FC.orientation=qx.bom.element.Attribute.get(o,"orientation");
this.__FC.lastCoord.left=e.getDocumentLeft();
this.__FC.lastCoord.top=e.getDocumentTop();
portal.box.Util.bringToFront(this.__Fz);
}},__FK:function(e){e.stopPropagation();

if(this.__FB){qx.event.Registration.removeListener(document,"mousemove",this.__FL,this,true);
portal.box.Util.sendToBack(this.__Fz);

if(this.__FD.autoHide){for(var p in this.__FA){qx.bom.element.Style.set(this.__FA[p],"visibility","hidden");
}}this.__FB=false;
qx.bom.Selection.clear(document.body);
}},__FL:function(e){e.stopPropagation();

if(this.__FB){var q={left:null,top:null};

switch(this.__FC.orientation){case "south":q.top=e.getDocumentTop();
break;
case "southeast":q.top=e.getDocumentTop();
q.left=e.getDocumentLeft();
break;
case "east":q.left=e.getDocumentLeft();
break;
}this.__FM(q,this.__FC.lastCoord);
this.__FC.lastCoord.left=e.getDocumentLeft();
this.__FC.lastCoord.top=e.getDocumentTop();
}},__FM:function(r,s){var z=qx.bom.element.Dimension;
var w=portal.box.Manager.getInstance().getGroupBoxDataOfBox(this.__Fy.getId());
var y=z.getContentSize(w.element);

if(r.left){var v=r.left-s.left;

if(v!==0){var u=z.getContentWidth(this.__Fz)+v;
var x=z.getWidth(this.__Fz)+v;

if((this.__FD.minWidth==null||u>this.__FD.minWidth)&&(this.__FD.maxWidth==null||u<=this.__FD.maxWidth)){if(y.width>=x){qx.bom.element.Style.set(this.__Fz,"width",u+'px');
this.__Fy.getData().width=u;
}}}}
if(r.top){var v=r.top-s.top;

if(v!==0){var t=z.getContentHeight(this.__Fz)+v;

if((this.__FD.minHeight==null||t>this.__FD.minHeight)&&(this.__FD.maxHeight==null||t<=this.__FD.maxHeight)){qx.bom.element.Style.set(this.__Fz,"height",t+"px");
}}}}},destruct:function(){if(this.__FD.autoHide){qx.event.Registration.removeListener(this.__Fy.getElement(),b,this.__FH,this);
qx.event.Registration.removeListener(this.__Fy.getElement(),a,this.__FI,this);
}this.__Fy=this.__FD=this.__Fz=this.__FA=null;
this.__FC=null;
}});
})();
...
qx.Class.define(b,{statics:{__FN:1000,bringToFront:function(d){var e=qx.bom.element.Style.get(d,c);
e=e==a?0:e;
qx.bom.element.Style.set(d,c,e+this.__FN);
},sendToBack:function(f){var g=qx.bom.element.Style.get(f,c);
qx.bom.element.Style.set(f,c,g-this.__FN);
}}});
})();
...
this.__FO=b;
this.__FP=b.getElement();
this.__FQ=null;
this.__FR=null;
this.__FS();
},members:{__FO:null,__FP:null,__FQ:null,__FR:null,getBox:function(){return this.__FO;
},getElement:function(){return this.__FP;
},__FS:function(){this.__FT();
this.__FU();
},__FT:function(){this.__FQ=qx.bom.Element.create("div");
qx.bom.element.Class.add(this.__FQ,"dragHandle");
qx.dom.Element.insertBegin(this.__FQ,this.__FP);
},__FU:function(){qx.bom.Element.addListener(this.__FQ,"mousedown",this.__FV,this);
qx.bom.Element.addListener(this.__FQ,"mouseover",function(e){qx.bom.element.Style.set(this,"cursor","move");
},this.__FQ);
qx.bom.Element.addListener(this.__FQ,"dragstart",this.__FY,this);
qx.bom.Element.addListener(this.__FQ,"dragend",portal.dragdrop.Manager.getInstance().stopSession,portal.dragdrop.Manager.getInstance());
qx.bom.Element.addListener(this.__FQ,"drag",this.__Ga,this);
},__FV:function(e){if(e.isLeftPressed()){this.__FR={left:e.getDocumentLeft()-qx.bom.element.Location.getLeft(this.__FP),top:e.getDocumentTop()-qx.bom.element.Location.getTop(this.__FP)};
qx.bom.Element.addListener(document.body,"mouseup",this.__FX,this,true);
this.__FW();
qx.event.Registration.fireEvent(this.__FQ,"dragstart",qx.event.type.Event);
}},__FW:qx.core.Environment.select("engine.name",{"mshtml":function(){var d=this;
var c=qx.lang.Function.bind(this.__FX,d);
document.getElementsByTagName("html")[0].onmouseleave=c;
},"default":qx.lang.Function.empty}),__FX:function(e){try{e.stopPropagation();
}catch(f){}
if(portal.dragdrop.Manager.getInstance().isSessionActive()){qx.event.Registration.removeListener(document.body,"mousemove",this.__Ga,this,true);
portal.dragdrop.Manager.getInstance().stopSession();
}qx.bom.Element.removeListener(document.body,"mouseup",this.__FX,this,true);
},__FY:function(e){portal.box.Manager.getInstance().setActiveBox(this.__FO);
portal.dragdrop.Manager.getInstance().startSession(this.__FO);
qx.event.Registration.addListener(document.body,"mousemove",this.__Ga,this,true);
},__Ga:function(e){e.stopPropagation();
var g=e.getDocumentLeft()-this.__FR.left;
var top=e.getDocumentTop()-this.__FR.top;
qx.event.Timer.once(function(){this.checkGroupBox(g,parseInt(this.getActiveBox().getData().width));
this.onDragMove(top,g);
},portal.dragdrop.Manager.getInstance(),0);
}},destruct:function(){this.__FO=this.__FQ=this.__FP=this.__FR=null;
}});
})();
...
this.__Gb={top:null,height:null};
this.__Gc={top:0,left:0};
},properties:{activeBox:{check:u,init:null,nullable:true},sessionActive:{check:r,init:false}},members:{__Gb:null,__Gd:null,__Ge:false,__Gc:null,__Gf:null,__Gg:null,startSession:function(y){this.setSessionActive(true);
this.setActiveBox(y);
this.__Gd=y.getGroupBoxId();
this.__Gh();
if(this.__Gf==null){this.__Gf={};
var z=portal.box.Manager.getInstance().getGroupBoxes();

for(var i=0,j=z.length;i<j;i++){this.__Gf[z[i].element.id]={left:qx.bom.element.Location.getLeft(z[i].element),right:qx.bom.element.Location.getLeft(z[i].element)+qx.bom.element.Dimension.getWidth(z[i].element)};
}}},__Gh:function(){if(!this.__Gg){this.__Gg=qx.bom.Element.create(b);
}var C=this.getActiveBox().getElement();
var A=qx.bom.element.Dimension.getContentSize(C);
this.__Gi(C,this.__Gg);
qx.bom.element.Class.add(this.__Gg,qx.bom.element.Class.get(C));
var B=k+d+qx.bom.element.Location.getTop(C)+w+c+qx.bom.element.Location.getLeft(C)+w+o+A.width+w+f+A.height+x;
qx.bom.element.Style.setCss(this.__Gg,B);
qx.bom.element.Style.set(C,v,t);
qx.dom.Node.getBodyElement(C).appendChild(this.__Gg);
portal.box.Util.bringToFront(this.__Gg);
},__Gi:function(D,E){while(D.firstChild){E.appendChild(D.firstChild);
}},stopSession:function(e){this.setSessionActive(false);
var G=this.getActiveBox();
var H=G.getElement();
portal.box.Manager.getInstance().updateGroupBoxMembers(G.getGroupBoxId(),this.__Gd,G);
G.setGroupBoxId(this.__Gd);
var F=new qx.fx.effect.core.Move(this.__Gg);
F.set({x:qx.bom.element.Location.getLeft(H),y:qx.bom.element.Location.getTop(H),mode:h,duration:0.5,transition:g});
F.start();
F.addListener(n,function(){this.__Gi(this.__Gg,H);
qx.bom.element.Style.reset(H,v);
this.__Gg.parentNode.removeChild(this.__Gg);

if(G.isActive()){G._applyActive(true);
}else{portal.box.Manager.getInstance().setActiveBox(G);
}},this);
},onDragMove:function(top,I){if(this.__Gc.left!=I){qx.bom.element.Style.set(this.__Gg,q,I+x);
}
if(this.__Gc.top!=top){qx.bom.element.Style.set(this.__Gg,s,top+x);
}var J=this.getActiveBox().getElement();

if(this.__Gb.top==null){this.__Gb.top=qx.bom.element.Location.getTop(J);
}
if(this.__Gb.height==null){this.__Gb.height=qx.bom.element.Dimension.getHeight(J);
}if(this.__Ge==false&&top>=this.__Gb.top&&top<=(this.__Gb.top+this.__Gb.height)){return;
}var K;
if(this.__Ge){K=qx.dom.Hierarchy.getFirstDescendant(document.getElementById(this.__Gd));
while(K!=null){if(this.__Gj(true,top,J,K)){this.__Ge=false;
return;
}K=qx.dom.Hierarchy.getNextElementSibling(K);
}}else{K=J;
}if(top-this.__Gc.top>0){K=qx.dom.Hierarchy.getNextElementSibling(K);

while(K!=null){if(K){if(this.__Gj(true,top,J,K)){return;
}}K=qx.dom.Hierarchy.getNextElementSibling(K);
}}else{var K=qx.dom.Hierarchy.getPreviousElementSibling(K);

while(K!=null){if(K){if(this.__Gj(false,top,J,K)){return;
}}K=qx.dom.Hierarchy.getPreviousElementSibling(K);
}}this.__Gc.left=I;
this.__Gc.top=top;
},__Gj:function(L,top,M,N){var O=qx.bom.element.Location.getTop(N);
var Q=parseInt(qx.bom.element.Style.get(N,p));
var R=parseInt(qx.bom.element.Style.get(N,l));
var P=qx.bom.element.Dimension.getContentHeight(N)+R+Q;
var S;

if(L){if(top>=(O+(P/3))){S=qx.dom.Hierarchy.getNextElementSibling(N);

if(S!=M||S==null){qx.dom.Element.insertAfter(M,N);
this.__Gb.top=qx.bom.element.Location.getTop(M);
}return true;
}}else{if(top<=(O+P*2/3)){S=qx.dom.Hierarchy.getPreviousElementSibling(N);

if(S!=M||S==null){qx.dom.Element.insertBefore(M,N);
this.__Gb.top=qx.bom.element.Location.getTop(M);
}return true;
}}return false;
},checkGroupBox:function(T,U){if(this.__Gf[this.__Gd].left<=T&&this.__Gf[this.__Gd].right>=T){return;
}
for(var V in this.__Gf){if(V!=this.__Gd){if(this.__Gf[V].left<=T+U&&this.__Gf[V].right>=T){this.__Gd=V;
this.__Ge=true;
return;
}}}}},destruct:function(){this.__Gb=this.__Gc=this.__Gd=null;
this.__Gk=this.__Gg=this.__Gf=null;
}});
})();
...
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:g,check:[g,e]},x:{init:0,check:f},y:{init:0,check:f}},members:{__Gl:null,__Gm:null,__Gn:null,__Go:null,__Gp:null,setup:function(){var j=this._getElement();
qx.fx.Base.prototype.setup.call(this);

if(j.parentNode){this.__Gn=qx.bom.element.Location.getLeft(j)-qx.bom.element.Location.getLeft(j.parentNode);
this.__Go=qx.bom.element.Location.getTop(j)-qx.bom.element.Location.getTop(j.parentNode);
}else{this.__Gn=qx.bom.element.Location.getLeft(j);
this.__Go=qx.bom.element.Location.getTop(j);
}this.__Gp=qx.bom.element.Style.get(j,i);
...
var l=Math.round(this.__Gl*k+this.__Gn);
var top=Math.round(this.__Gm*k+this.__Go);
