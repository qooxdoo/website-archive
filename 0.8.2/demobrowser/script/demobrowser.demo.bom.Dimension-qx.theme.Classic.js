...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Dimension", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Dimension-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
var m=qx.bom.element.Overflow;

for(var i=1;i<1000;i++){var j=document.getElementById(c+i);

if(!j){break;
}var l=e+i+b+k(j)+a+n(j);
this.debug(l);
}function k(g){var h=qx.bom.element.Dimension;
return h.getWidth(g)+f+h.getHeight(g);
}function n(o){var p=qx.bom.element.Dimension;
return p.getContentWidth(o)+f+p.getContentHeight(o);
}}}});
})();
