...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Transition_Color", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.animation.Transition_Color-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var I="Name",H="Alternates between start and end. Looks only nice on color effects.",G="EaseInQuad will accelerate exponentially.",F="#7CFC00",E="Description",D="Linear is the default transition for many effects.",C="Wobble will bounce the element forwards and backwards.",B="demobrowser.demo.animation.Transition_Color",A="execute",z="appear",s="Duration",y="Alternates rapidly between start end target. Looks only nice on color effects.",v="changeValue",q="Spring will overshoot the target and then move back.",p="Show it!",u="EaseOutQuad will slow down exponentially.",t="test",w="sinodial transition will accelerate sinusoidal.",o="Reverse behaves like linear, but in the opposite direction.",x="#134275",r='<span style="color:white;">Welcome to <br><b style="color:#F3FFB3;">qooxdoo</b> animations!</span>';
...
n.setCssClass(t);
c.add(n);
var k={linear:D,easeInQuad:G,easeOutQuad:u,sinodial:w,reverse:o,wobble:C,spring:q,flicker:y,pulse:H};
var d=new qx.ui.form.ComboBox;
var m=new qx.ui.form.Button(p);
var f=new qx.ui.basic.Label(I);
var g=new qx.ui.basic.Label(E);
var l=new qx.ui.basic.Label(s);
var g=new qx.ui.basic.Label(k.linear);
var h=new qx.ui.form.Spinner;

for(var a in k){d.add(new qx.ui.form.ListItem(a));
}d.addListener(v,function(e){g.setContent(k[g.setContent(e.getData())]);
});
h.set({max:10.0,min:0.1,value:1.0});
var b;
n.addListenerOnce(z,function(){b=new qx.fx.effect.core.Highlight(n.getContentElement().getDomElement());
b.set({startColor:x,endColor:F});
},this);
var j=false;
var i=new qx.util.format.NumberFormat();
i.setMaximumFractionDigits(2);
h.setNumberFormat(i);
m.addListener(A,function(){var J=d.getValue();
b.set({transition:J,duration:h.getValue()});
b.start();
});
c.add(f,{left:25,top:50});
c.add(g,{left:25,top:75});
c.add(l,{left:25,top:25});
c.add(d,{left:90,top:50});
c.add(g,{left:90,top:75});
c.add(h,{left:90,top:25});
c.add(m,{left:23,top:100});
}}});
})();
