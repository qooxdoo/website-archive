...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Canvas_MinMaxSizes", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Canvas_MinMaxSizes-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var r="20%",q="9%",p="3%",o="6%",n="12%",m="black",l="teal",k="red",j="maxHeight=300",i="minWidth=400",e="green",h="yellow",g="orange",d="solid",c="blue",f="demobrowser.demo.layout.Canvas_MinMaxSizes";
qx.Class.define(f,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var b=new qx.ui.decoration.Single(3,d,m);
w1=new qx.ui.core.Widget().set({backgroundColor:k,decorator:b});
w2=new qx.ui.core.Widget().set({backgroundColor:c,decorator:b});
w3=new qx.ui.basic.Label(j).set({backgroundColor:e,decorator:b,padding:5,maxHeight:300,allowStretchX:true,allowStretchY:true});
w4=new qx.ui.core.Widget().set({backgroundColor:h,decorator:b});
w5=new qx.ui.core.Widget().set({backgroundColor:g,decorator:b});
w6=new qx.ui.basic.Label(i).set({backgroundColor:l,decorator:b,padding:5,minWidth:400,allowStretchX:true,allowStretchY:true});
var a=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
a.add(w1,{left:p,top:p,right:p,bottom:p,width:r,height:r});
a.add(w2,{left:o,top:o,right:o,width:r,height:r});
a.add(w3,{left:q,top:q,bottom:q,width:r,height:r});
a.add(w4,{left:n,top:n,width:r,height:r});
a.add(w5,{top:q,right:q,width:r,height:r});
a.add(w6,{right:q,bottom:q,width:r,height:r});
