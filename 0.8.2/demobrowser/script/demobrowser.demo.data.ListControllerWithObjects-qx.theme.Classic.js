...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.ListControllerWithObjects", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.ListControllerWithObjects-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var k="execute",j="emote",h="name",g="smile",f="Jack",e=".png",d="kiss",c="demobrowser.demo.data.ListControllerWithObjects",b="green",a="Jim",I="<b>Displaying objects in a list</b><br/>",H="Make all happy",G="sad",F="plain",E="surprise",D="embarrassed",C="online",B=" a converter by the icon. The font color shows the online status.",A="Write data to log",z="Jackob",r="icon",s="textColor",p="have a name and an emotion, which is displayed with the help of ",q="This list display a set of persons in a list. Every person does ",n="Dan",o="Tim",l="Karl",m="Online <> Offline",t="label",u="icon/16/emotes/face-",w="Dustin",v="angel",y="Max",x="red";
qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var W=[y,z,o,f,n,w,l,a];
var N=[D,d,F,G,E,v];
var T=[];

for(var i=0;i<20;i++){var Q=new demobrowser.demo.data.model.Person();
Q.setName(W[i%W.length]);
Q.setEmote(N[i%N.length]);
Q.setOnline(i%3==0);
T.push(Q);
}var U=new qx.data.Array(T);
var M=new qx.ui.form.List();
M.setWidth(150);
this.getRoot().add(M,{left:10,top:80});
var V={converter:function(Y){return u+Y+e;
}};
var R=new qx.data.controller.List(U,M,h,j,null,V);
var P={converter:function(X){if(X){return b;
}else{return x;
}}};
var K={bindItem:function(bb,bc,bd){bb.bindProperty(h,t,null,bc,bd);
bb.bindProperty(j,r,V,bc,bd);
bb.bindProperty(C,s,P,bc,bd);
}};
R.setDelegate(K);
var L=new qx.ui.form.Button(H);
L.setWidth(120);
this.getRoot().add(L,{left:180,top:80});
L.addListener(k,function(){for(var i=0;i<U.length;i++){var ba=U.getItem(i);
ba.setEmote(g);
}},this);
var J=new qx.ui.form.Button(m);
J.setWidth(120);
this.getRoot().add(J,{left:180,top:115});
J.addListener(k,function(){for(var i=0;i<U.length;i++){U.getItem(i).toggleOnline();
}},this);
var S=new qx.ui.form.Button(A);
S.setWidth(120);
this.getRoot().add(S,{left:180,top:150});
S.addListener(k,function(){qx.log.appender.Console.show();
this.info(U.toString());
},this);
var O=new qx.ui.basic.Label();
O.setRich(true);
O.setWidth(410);
O.setContent(I+q+p+B);
