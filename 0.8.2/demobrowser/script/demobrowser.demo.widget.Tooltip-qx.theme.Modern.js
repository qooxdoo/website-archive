...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Tooltip", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Tooltip-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var B="icon/32/actions/help-about.png",A="icon/16/actions/help-about.png",z="Shared ToolTip",y="Such a great tooltip with a (show) timeout of 50ms.",x="ToolTip with icon and label",w="Icon only ToolTip",v="This also may contain <b style='color:red'>rich HTML</b> markup ",u="A long label text with auto-wrapping. ",t="Short timeout ToolTip",s="ToolTip with icon and rich text",p="demobrowser.demo.widget.Tooltip",r="and with a (show) timeout of 50ms.",q="Hello World #3",o="Hello World #1";
...
var a=new qx.ui.layout.HBox(20);
var b=new qx.ui.container.Composite(a).set({padding:20,allowStretchY:false});
c.add(b);
...
b.add(n);
var m=new qx.ui.form.Button(t);
b.add(m);
var l=new qx.ui.form.Button(s);
b.add(l);
var f=new qx.ui.tooltip.ToolTip(o);
k.setToolTip(f);
j.setToolTip(f);
var e=new qx.ui.tooltip.ToolTip(null,A);
i.setToolTip(e);
var d=new qx.ui.tooltip.ToolTip(q,A);
n.setToolTip(d);
var h=new qx.ui.tooltip.ToolTip(y,B);
m.setToolTip(h);
h.setShowTimeout(50);
var g=new qx.ui.tooltip.ToolTip(u+v+r,B);
g.setWidth(200);
g.setRich(true);
g.setShowTimeout(50);
l.setToolTip(g);
