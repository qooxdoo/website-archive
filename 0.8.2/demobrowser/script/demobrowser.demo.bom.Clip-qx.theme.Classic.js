...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Clip", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
},set0:function(){var m=document.getElementById(f);
...
},set2:function(){var a=document.getElementById(f);
...
},set3:function(){var i=document.getElementById(f);
qx.log.Logger.debug("Setting to: null,20  120,40");
qx.bom.element.Clip.set(i,{top:20,width:120,height:40});
var j=qx.bom.element.Clip.get(i)||{};
qx.log.Logger.debug("Clip after: "+j.left+","+j.top+"  "+j.width+","+j.height);
},set4:function(){var k=document.getElementById(f);
