...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.JsonToTree-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var m="model",l="name",k="json/tree.json",j="tree.json</a> and bind the items to the tree widget.",i="content",h="state",g="kids",f="Loading the json file <a href='",e="demobrowser.demo.data.JsonToTree",d="' target='_blank'>",a="<b>Tree bound to data in a json file</b><br/>",c="loaded",b="Loading...";
