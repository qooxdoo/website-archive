...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Dock_Margin", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Dock_Margin-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var x="main",w="east",v="yellow",u="center",t="red",s="bottom",r="north",q="south",p="west",o="green",k="fuchsia",n="orange",m="blue",j="x",i="demobrowser.demo.layout.Dock_Margin",l="y";
qx.Class.define(i,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(b);
var a=new qx.ui.container.Composite(new qx.ui.layout.Dock(3,10)).set({decorator:x,backgroundColor:v,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:x,backgroundColor:t});
var g=new qx.ui.core.Widget().set({decorator:x,backgroundColor:m,marginLeft:20});
var f=new qx.ui.core.Widget().set({decorator:x,backgroundColor:n,marginTop:20});
var e=new qx.ui.core.Widget().set({decorator:x,backgroundColor:o,maxHeight:20,alignY:s});
var d=new qx.ui.core.Widget().set({decorator:x,backgroundColor:k});
a.add(h,{edge:r});
a.add(g,{edge:p});
a.add(f,{edge:q});
a.add(e,{edge:w});
a.add(d,{edge:u});
b.add(a);
var c=new qx.ui.layout.Dock(3,10);
c.setSort(l);
var a=(new qx.ui.container.Composite(c)).set({decorator:x,backgroundColor:v,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:x,backgroundColor:t});
var g=new qx.ui.core.Widget().set({decorator:x,backgroundColor:m,marginLeft:20});
var f=new qx.ui.core.Widget().set({decorator:x,backgroundColor:n,marginTop:20});
var e=new qx.ui.core.Widget().set({decorator:x,backgroundColor:o,maxHeight:20,alignY:s});
