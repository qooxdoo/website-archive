...
(function(){var o="click",n="iframe",m="scroll",l="inner",k="div",j="juhu",h="contextmenu",g="input",f="load",d="keydown",b="demobrowser.demo.event.Event_Iframe",c="data/Event_2_frame.html";
qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var p=qx.bom.Iframe.create({name:n,src:c});
p.id=n;
document.body.appendChild(p);
qx.event.Registration.addListener(p,f,this.bindIFrameEvents,this);
},bindIFrameEvents:function(){var t=window.document.getElementById(n);
var s=qx.bom.Iframe.getDocument(t);
this._juhu=s.getElementById(j);
this._inner=s.getElementById(l);
qx.event.Registration.addListener(this._juhu,h,this._preventDefault,this);
qx.event.Registration.addListener(this._inner,o,this._stopPropagation,this);
qx.event.Registration.addListener(this._juhu,o,this._onclick1,this);
qx.event.Registration.addListener(this._juhu,o,this._onclick2,this);
qx.event.Registration.addListener(s.getElementById(g),d,this._onkeydown,this);

for(var i=1;i<10;i++){var r=s.getElementById(k+i);
qx.event.Registration.addListener(r,o,this._cascadeCapture,this,true);
qx.event.Registration.addListener(r,o,this._cascadeBubble,this,false);
}qx.event.Registration.addListener(s.getElementById(m),m,this._scroll,this);
...
},_cascadeBubble:function(e){var q=e.getCurrentTarget();
this.debug("bubble: "+q.id+" "+e.getEventPhase());
...
qx.event.Registration.removeListener(this._juhu,o,this._onclick1);
