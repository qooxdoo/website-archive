...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Transition_Position", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.animation.Transition_Position-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var G="Name",F="Wobble will bounce the element forwards and backwards.",E="EaseInQuad will accelerate exponentially.",D="finish",C="Description",B="Linear is the default transition for many effects.",A="demobrowser.demo.animation.Transition_Position",z="execute",y="appear",x="Duration",r="changeValue",w="Spring will overshoot the target and then move back.",u="Show it!",q="EaseOutQuad will slow down exponentially.",p="test",t="Sinodial transition will accelerate sinusoidal.",s="Reverse behaves like linear, but in the opposite direction.",v='<span style="color:white;">Welcome to <br><b style="color:#F3FFB3;">qooxdoo</b> animations!</span>',o="absolute";
...
n.setCssClass(p);
c.add(n);
var k={linear:B,easeInQuad:E,easeOutQuad:q,sinodial:t,reverse:s,wobble:F,spring:w};
var d=new qx.ui.form.ComboBox;
var m=new qx.ui.form.Button(u);
var f=new qx.ui.basic.Label(G);
var g=new qx.ui.basic.Label(C);
var l=new qx.ui.basic.Label(x);
var g=new qx.ui.basic.Label(k.linear);
var h=new qx.ui.form.Spinner;

for(var a in k){d.add(new qx.ui.form.ListItem(a));
}d.addListener(r,function(e){g.setContent(k[g.setContent(e.getData())]);
});
h.set({max:10.0,min:0.1,value:1.0});
var b;
var j=false;
n.addListenerOnce(y,function(){b=new qx.fx.effect.core.Move(n.getContentElement().getDomElement());
b.set({x:600,y:300,mode:o});
b.addListener(D,function(){b.set({x:j?90:600,y:j?90:300});
j=!j;
});
},this);
...
h.setNumberFormat(i);
m.addListener(z,function(){var H=d.getValue();
b.set({transition:H,duration:h.getValue()});
b.start();
});
