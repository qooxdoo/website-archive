...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Resizer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Resizer-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
},_getResizerList:function(){var d=new qx.ui.form.List().set({width:100,height:200,minWidth:50,minHeight:100});
...
f.setValue(a);
var g=new qx.ui.container.Resizer().set({minWidth:100,minHeight:50,width:200,height:100,resizeAllEdges:false});
