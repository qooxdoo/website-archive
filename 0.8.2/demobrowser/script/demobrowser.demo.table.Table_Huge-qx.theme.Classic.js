...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.table.Table_Huge-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var e="Column ",d="demobrowser.demo.table.Table_Huge",c="x",b="Cell ",a="Table";
qx.Class.define(d,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return a;
},COL_COUNT:50,ROW_COUNT:10000,createRandomRows:function(k){var m=[];

for(var n=0;n<k;n++){var l=[];

for(var i=0;i<this.COL_COUNT;i++){l.push(b+i+c+n);
}m.push(l);
}return m;
},createTable:function(){var g=this.createRandomRows(this.ROW_COUNT);
var f=this._tableModel=new qx.ui.table.model.Simple();
var j=[];

for(var i=0;i<this.COL_COUNT;i++){j.push(e+i);
}f.setColumns(j);
f.setData(g);
