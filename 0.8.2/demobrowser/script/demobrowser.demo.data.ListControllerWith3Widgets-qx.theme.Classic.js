...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.ListControllerWith3Widgets", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.ListControllerWith3Widgets-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
for(var i=0;i<30;i++){x.push(l+i);
}var z=new qx.data.Array(x);
...
var v=new qx.data.controller.List(z,q);
var u=new qx.data.controller.List(z,n);
var t=new qx.data.controller.List(z,p);
u.setSelection(v.getSelection());
var A=new qx.ui.form.Button(j);
A.setWidth(120);
this.getRoot().add(A,{left:380,top:80});
A.addListener(m,function(){z.push(l+z.length);
},this);
var r=new qx.ui.form.Button(g);
r.setWidth(120);
this.getRoot().add(r,{left:380,top:115});
r.addListener(m,function(){z.pop();
},this);
var w=new qx.ui.form.Button(k);
w.setWidth(120);
this.getRoot().add(w,{left:380,top:150});
w.addListener(m,function(){qx.log.appender.Console.show();
this.info(z.toString());
},this);
...
B.setWidth(100);
B.setContent(a);
this.getRoot().add(B,{left:260,top:10});
