...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_NegativeMargin", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.VBox_NegativeMargin-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var s="main",r="yellow",q="gray",p="blue",o="center",n="green",m="left",l="right",k="demobrowser.demo.layout.VBox_NegativeMargin";
...
var N=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(N);
N.add(this.getBox1());
N.add(this.getBox2());
N.add(this.getBox3());
...
N.add(this.getBox6());
N.add(this.getBox7());
},getBox1:function(){var I=new qx.ui.layout.VBox();
var K=new qx.ui.container.Composite(I).set({decorator:s,backgroundColor:r,width:140,allowGrowY:false});
var M=new qx.ui.core.Widget().set({decorator:s,backgroundColor:p,maxWidth:100,alignX:m});
var L=new qx.ui.core.Widget().set({decorator:s,backgroundColor:n,maxWidth:100,alignX:o});
var J=new qx.ui.core.Widget().set({decorator:s,backgroundColor:q,maxWidth:100,alignX:l});
K.add(M);
K.add(L);
K.add(J);
L.setMarginTop(-10);
J.setMarginTop(-10);
return K;
},getBox2:function(){var D=new qx.ui.layout.VBox();
var F=new qx.ui.container.Composite(D).set({decorator:s,backgroundColor:r,width:140,allowGrowY:false});
var H=new qx.ui.core.Widget().set({decorator:s,backgroundColor:p,maxWidth:100,alignX:m});
var G=new qx.ui.core.Widget().set({decorator:s,backgroundColor:n,maxWidth:100,alignX:o});
var E=new qx.ui.core.Widget().set({decorator:s,backgroundColor:q,maxWidth:100,alignX:l});
F.add(H);
F.add(G);
F.add(E);
G.setMarginTop(-10);
G.setMarginBottom(20);
E.setMarginTop(-10);
return F;
},getBox3:function(){var t=new qx.ui.layout.VBox();
var v=new qx.ui.container.Composite(t).set({decorator:s,backgroundColor:r,width:140,height:300,allowGrowY:false});
var x=new qx.ui.core.Widget().set({decorator:s,backgroundColor:p,maxWidth:100,alignX:m});
var w=new qx.ui.core.Widget().set({decorator:s,backgroundColor:n,maxWidth:100,alignX:o});
var u=new qx.ui.core.Widget().set({decorator:s,backgroundColor:q,maxWidth:100,alignX:l});
v.add(x,{flex:1});
v.add(w,{flex:1});
v.add(u,{flex:1});
w.setMarginTop(-10);
...
var c=new qx.ui.container.Composite(a).set({decorator:s,backgroundColor:r,width:140,height:300,allowGrowY:false});
var e=new qx.ui.core.Widget().set({decorator:s,backgroundColor:p,maxWidth:100,alignX:m});
var d=new qx.ui.core.Widget().set({decorator:s,backgroundColor:n,maxWidth:100,alignX:o});
var b=new qx.ui.core.Widget().set({decorator:s,backgroundColor:q,maxWidth:100,alignX:l});
c.add(e,{flex:1});
c.add(d,{flex:2});
c.add(b,{flex:3});
d.setMarginTop(-10);
...
var A=new qx.ui.container.Composite(y).set({decorator:s,backgroundColor:r,width:140,height:300,allowGrowY:false});
var C=new qx.ui.core.Widget().set({decorator:s,backgroundColor:p,maxWidth:100,alignX:m});
var B=new qx.ui.core.Widget().set({decorator:s,backgroundColor:n,maxWidth:100,alignX:o});
var z=new qx.ui.core.Widget().set({decorator:s,backgroundColor:q,maxWidth:100,alignX:l});
A.add(C,{flex:1});
A.add(B,{flex:2});
A.add(z,{flex:3});
B.setMarginTop(-10);
...
z.setHeight(0);
return A;
},getBox6:function(){var f=new qx.ui.layout.VBox();
var h=new qx.ui.container.Composite(f).set({decorator:s,backgroundColor:r,width:140,height:100,allowGrowY:false});
var j=new qx.ui.core.Widget().set({decorator:s,backgroundColor:p,maxWidth:100,alignX:m});
var i=new qx.ui.core.Widget().set({decorator:s,backgroundColor:n,maxWidth:100,alignX:o});
var g=new qx.ui.core.Widget().set({decorator:s,backgroundColor:q,maxWidth:100,alignX:l});
h.add(j,{flex:1});
h.add(i,{flex:1});
h.add(g,{flex:1});
i.setMarginTop(-10);
...
var Q=new qx.ui.container.Composite(O).set({decorator:s,backgroundColor:r,width:140,height:100,allowGrowY:false});
var S=new qx.ui.core.Widget().set({decorator:s,backgroundColor:p,maxWidth:100,alignX:m});
var R=new qx.ui.core.Widget().set({decorator:s,backgroundColor:n,maxWidth:100,alignX:o});
var P=new qx.ui.core.Widget().set({decorator:s,backgroundColor:q,maxWidth:100,alignX:l});
Q.add(S,{flex:1});
Q.add(R,{flex:2});
Q.add(P,{flex:3});
R.setMarginTop(-10);
