...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Canvas_Percent", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Canvas_Percent-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
var p=new qx.ui.decoration.Single(3,c,i);
w1=new qx.ui.core.Widget().set({backgroundColor:g,decorator:p});
w2=new qx.ui.core.Widget().set({backgroundColor:a,decorator:p});
w3=new qx.ui.core.Widget().set({backgroundColor:e,decorator:p});
w4=new qx.ui.core.Widget().set({backgroundColor:b,decorator:p});
w5=new qx.ui.core.Widget().set({backgroundColor:d,decorator:p});
w6=new qx.ui.core.Widget().set({backgroundColor:h,decorator:p});
var o=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
o.add(w1,{left:l,top:l,right:l,bottom:l,width:n,height:n});
o.add(w2,{left:k,top:k,right:k,width:n,height:n});
o.add(w3,{left:m,top:m,bottom:m,width:n,height:n});
o.add(w4,{left:j,top:j,width:n,height:n});
o.add(w5,{top:m,right:m,width:n,height:n});
o.add(w6,{right:m,bottom:m,width:n,height:n});
