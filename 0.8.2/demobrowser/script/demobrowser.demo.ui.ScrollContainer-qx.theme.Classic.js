...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.ScrollContainer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.ui.ScrollContainer-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var f="demobrowser.demo.ui.ScrollContainer",e="red",d="Toggle size",c="blue",b="execute";
...
scrollContainer.set({width:300,height:200});
scrollContainer.add(this.generateBoxes());
this.getRoot().add(scrollContainer,{left:10,top:10});
var g=new qx.ui.form.Button(d).set({padding:5});
var h=true;
g.addListener(b,function(){scrollContainer.setWidth(h?800:300);
h=!h;
});
this.getRoot().add(g,{left:10,top:400});
},generateBoxes:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.Grid());

for(var y=0;y<10;y++){for(var x=0;x<10;x++){a.add((new qx.ui.core.Widget()).set({backgroundColor:((x+y)%2==0)?e:c,width:60,allowShrinkY:false,allowShrinkX:false,height:60}),{column:x,row:y});
}}return a;
}}});
})();
