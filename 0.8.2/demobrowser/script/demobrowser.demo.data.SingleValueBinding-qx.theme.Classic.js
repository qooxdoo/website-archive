...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.SingleValueBinding", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.SingleValueBinding-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var G="content",F="<b>Description</b><br/>",E="",D="execute",C="input",B="value",A="Change me...",z="demobrowser.demo.data.SingleValueBinding",y="Reverse",x="Binding a number value (slider value) to a labels string (content).",bo="child.names[last]",bn="child.names[0]",bm="First:",bl="Bigger than 50!",bk="of names.<br/>The reverse button reverses the current selected child ",bj="solid",bi=" The default conversion will handle the type conversion.",bh="Binding an data event, containing the change of the textfield to",bg="Last:",bf="Binding the textfield to a property with a validation. The validator",N=" in the object only accepts numbers. On a validation fail, a red ",O=" the label.",L="No number!",M="With validation",J="10",K="containing ['Bart', 'Lisa'] as names.",H=" above or below 50.",I="Bart",P="number",Q="Toggle child",W="from a node containing ['Homer', 'Marge'] as names to a node ",V="Binding of node elements containing a node as child and an array ",Y="With own conversion",X="names array.<br/>Toggle child will change the child of the root node ",bb="with a self written converter to a string only saying it its ",ba="Event binding",S="Array binding",be="Lower than 50!",bd="red",bc="Lisa",R="Binding a slider value to a labels text but conversion the number ",T="With default conversion",U=" border will surround the textfield.";
qx.Class.define(z,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
this.getRoot().add(new qx.ui.basic.Label(ba),{top:10,left:10});
var e=new qx.ui.form.TextField(A);
this.getRoot().add(e,{top:30,left:10});
var k=new qx.ui.basic.Label(A);
this.getRoot().add(k,{top:32,left:120});
e.bind(C,k,G);
this.getRoot().add(new qx.ui.basic.Label(T),{top:60,left:10});
var i=new qx.ui.form.Slider();
i.setWidth(100);
this.getRoot().add(i,{top:80,left:10});
var g=new qx.ui.basic.Label(E);
this.getRoot().add(g,{top:80,left:120});
i.bind(B,g,G);
this.getRoot().add(new qx.ui.basic.Label(Y),{top:110,left:10});
var h=new qx.ui.form.Slider();
h.setWidth(100);
this.getRoot().add(h,{top:130,left:10});
var j=new qx.ui.basic.Label(E);
this.getRoot().add(j,{top:130,left:120});
var v={converter:function(a){if(a<50){return be;
}else{return bl;
}}};
h.bind(B,j,G,v);
this.getRoot().add(new qx.ui.basic.Label(S),{top:180,left:10});
var s=new demobrowser.demo.data.model.Node();
var t=new demobrowser.demo.data.model.Node();
var u=new demobrowser.demo.data.model.Node();
u.setNames(new qx.data.Array(I,bc));
s.setChild(t);
var w=new qx.ui.form.Button(y);
this.getRoot().add(w,{top:200,left:10});
w.addListener(D,function(){s.getChild().getNames().reverse();
},this);
var n=new qx.ui.form.Button(Q);
this.getRoot().add(n,{top:200,left:80});
n.addListener(D,function(){if(s.getChild()==t){s.setChild(u);
}else{s.setChild(t);
}},this);
this.getRoot().add(new qx.ui.basic.Label(bm),{left:10,top:235});
this.getRoot().add(new qx.ui.basic.Label(bg),{left:60,top:235});
var o=new qx.ui.basic.Label();
this.getRoot().add(o,{top:250,left:10});
var b=new qx.ui.basic.Label();
this.getRoot().add(b,{top:250,left:60});
s.bind(bn,o,G);
s.bind(bo,b,G);
this.getRoot().add(new qx.ui.basic.Label(M),{top:310,left:10});
var q=new qx.ui.form.TextField(J);
this.getRoot().add(q,{top:330,left:10});
var d=new qx.ui.basic.Label(E);
this.getRoot().add(d,{top:332,left:120});
var p=new qx.ui.decoration.Single(1,bj,bd);
var v={onSetOk:function(){d.setContent(E);
q.resetShadow();
},onSetFail:function(e){d.setContent(L);
q.setShadow(p);
}};
q.bind(C,s,P,v);
...
c.setWidth(350);
c.setContent(F+bh+O);
this.getRoot().add(c,{left:250,top:10});
var m=new qx.ui.basic.Label();
m.setRich(true);
m.setWidth(350);
m.setContent(F+x+bi);
this.getRoot().add(m,{left:250,top:60});
var f=new qx.ui.basic.Label();
f.setRich(true);
f.setWidth(350);
f.setContent(F+R+bb+H);
this.getRoot().add(f,{left:250,top:110});
var r=new qx.ui.basic.Label();
r.setRich(true);
r.setWidth(350);
r.setContent(F+V+bk+X+W+K);
this.getRoot().add(r,{left:250,top:180});
var l=new qx.ui.basic.Label();
l.setRich(true);
l.setWidth(350);
l.setContent(F+bf+N+U);
this.getRoot().add(l,{left:250,top:310});
}}});
})();
...
(function(){var t="qx.data.Array",s="demobrowser.demo.data.model.Node",r="String",q="changeNames",p="changeName",o="Validation Error: ",n="",m="is no number (parseFloat says so!).",l="changeChild",k="- ",d="changeColor",j="Marge",g="AFFE",c="__oi",b="Homer",f="\n",e="changeName2",h="changeChildren";
...
},properties:{children:{check:t,event:h},child:{check:s,event:l,nullable:true},names:{check:t,event:q,init:new qx.data.Array(b,j)},name:{check:r,init:g,event:p},name2:{check:r,event:e},number:{init:10,validate:c},color:{event:d,nullable:true}},members:{__oi:function(a){if(!isNaN(parseFloat(a))){return;
}throw new qx.core.ValidationError(o+a+m);
