...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.ElementResize", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.event.ElementResize-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var i="resize",h="demobrowser.demo.event.ElementResize",g="width: ",f="px",d="px<br>height: ";
...
qx.bom.Element.addListener(j,i,this._onResize,this);
this.update(j,j.offsetWidth,j.offsetHeight);
},_onResize:function(e){var k=e.getData();
this.update(e.getTarget(),k.width,k.height);
},update:function(a,b,c){a.innerHTML=g+b+d+c+f;
}}});
})();
...
(function(){var h="resize",g="__nv",f="qx.event.handler.ElementResize",e="__nw",d="interval",c="__nx",b="body";
...
this.__nv=a;
this.__nw={};
this.__nx=new qx.event.Timer(200);
this.__nx.addListener(d,this._onInterval,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{resize:true},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__nw:null,__nx:null,canHandleEvent:function(z,A){return z.tagName.toLowerCase()!==b;
...
if(qx.lang.Object.isEmpty(m)){this.__nx.stop();
}}},_onInterval:function(e){var u=this.__nw;
...
if(y.height!==v||y.width!==w){qx.event.Registration.fireNonBubblingEvent(t,h,qx.event.type.Data,[{width:w,oldWidth:y.width,height:v,oldHeight:y.height}]);
y.width=w;
y.height=v;
