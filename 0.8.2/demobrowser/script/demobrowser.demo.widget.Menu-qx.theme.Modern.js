...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Menu", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Menu-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var dP="execute",dO="changeChecked",dN="icon/16/actions/edit-cut.png",dM="changeSelected",dL="icon/16/actions/edit-paste.png",dK="Copy",dJ="Paste",dI="icon/16/actions/edit-copy.png",dH="Cut",dG="icon/16/actions/system-search.png",dm="New",dl="Undo",dk="icon/16/actions/document-save.png",dj="Redo",di="icon/22/apps/preferences-users.png",dh="icon/16/actions/document-print.png",dg="icon/16/actions/document-open.png",df="icon/16/actions/edit-undo.png",de="Save",dd="icon/16/actions/edit-redo.png",dW="Print",dX="Open",dU="icon/16/actions/document-new.png",dV="Online Forum",dS="icon/16/actions/format-justify-fill.png",dT="Search in files",dQ="C",dR="Left aligned",dY="Perl",ea="View",dz="C Dialect",dy="Info...",dB="Save as...",dA="Show line numbers",dD="Quickstart",dC="icon/16/actions/contact-new.png",dF="Ctrl+N",dE="Actions",dx="Show console",dw="Search",bT="Help",bU="Show status bar",bV="icon/16/actions/format-justify-left.png",bW="ANSI to OEM",bX="Centered",bY="Website 3",ca="Edit",cb="icon/16/actions/format-justify-center.png",cc="Ctrl+O",cd="icon/16/actions/go-previous.png",ee="C Sharp",ed="Close",ec="Split Button",eb="Website 2",ei="icon/16/actions/document-save-as.png",eh="Python",eg="icon/16/apps/utilities-help.png",ef="Show tree",ek="Options",ej="Spaces to tabs",cC="Right aligned",cD="Action 1",cA="OEM to ANSI",cB="Line 431",cG="JavaScript",cH="icon",cE="Action 2",cF="XML",cy="Line 313",cz="Paragraph",cl="demobrowser.demo.widget.Menu",ck="icon/16/actions/application-exit.png",cn="C Plus Plus",cm="Line 26",ch="Item ",cg="ASCII table",cj="Option 1",ci="Search next...",cf="Line 12",ce="Action 3",cM="Replace in files",cN="Uppercase",cO="Ctrl+P",cP="Topics",cI="Panes",cJ="Justified",cK="Ctrl+X",cL="Show macros",cQ="Search previous...",cR="Back",cv="main",cu="Show ruler",ct="icon/16/actions/format-justify-right.png",cs="icon/16/actions/go-next.png",cr="Ctrl+Z",cq="Option 3",cp="Next",co="Ctrl+R",cx="Show tags",cw="Capitals",cS="Format",cT="File",cU="Show tabs",cV="Tabs to spaces",cW="Search...",cX="Line 1039",cY="Option 2",da="Objective C",db="Exit",dc="Ctrl+S",dr="Syntax",dq="Ctrl+C",dp="Website 1",dn="Menu Button",dv="Line 30",du="Lowercase",dt="Replace",ds="HTML";
qx.Class.define(cl,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var bh=new qx.ui.container.Scroll();
var bg=new qx.ui.container.Composite(new qx.ui.layout.Canvas);
bg.setPadding(20);
bg.setAllowStretchX(false);
bh.add(bg);
this.getRoot().add(bh,{edge:0});
this.createCommands();
bg.add(this.getMenuButton(),{left:20,top:20});
bg.add(this.getSplitButton(),{left:150,top:20});
bg.add(this.getMenuBar(),{left:20,top:100});
bg.add(this.getList(),{left:20,top:200});
...
},createCommands:function(){this._newCommand=new qx.event.Command(dF);
this._newCommand.addListener(dP,this.debugCommand);
this._openCommand=new qx.event.Command(cc);
this._openCommand.addListener(dP,this.debugCommand);
this._saveCommand=new qx.event.Command(dc);
this._saveCommand.addListener(dP,this.debugCommand);
this._undoCommand=new qx.event.Command(cr);
this._undoCommand.addListener(dP,this.debugCommand);
this._redoCommand=new qx.event.Command(co);
this._redoCommand.addListener(dP,this.debugCommand);
this._cutCommand=new qx.event.Command(cK);
this._cutCommand.addListener(dP,this.debugCommand);
this._copyCommand=new qx.event.Command(dq);
this._copyCommand.addListener(dP,this.debugCommand);
this._pasteCommand=new qx.event.Command(cO);
this._pasteCommand.addListener(dP,this.debugCommand);
this._pasteCommand.setEnabled(false);
},getMenuButton:function(){var es=new qx.ui.menu.Menu;
es.add(new qx.ui.menu.RadioButton(cj));
es.add(new qx.ui.menu.RadioButton(cY));
es.add(new qx.ui.menu.RadioButton(cq));
var eA=new qx.ui.menu.Menu;
eA.add(new qx.ui.menu.RadioButton(cD));
eA.add(new qx.ui.menu.RadioButton(cE));
eA.add(new qx.ui.menu.RadioButton(ce));
var ez=new qx.ui.form.RadioGroup;
ez.add.apply(ez,es.getChildren());
ez.addListener(dM,this.debugRadio);
var ex=new qx.ui.form.RadioGroup;
ex.add.apply(ex,eA.getChildren());
ex.addListener(dM,this.debugRadio);
var ev=new qx.ui.menu.Menu();
var ey=new qx.ui.menu.Button(dl,df,this._undoCommand);
var eF=new qx.ui.menu.Button(dj,dd,this._redoCommand);
var eu=new qx.ui.menu.Button(dH,dN,this._cutCommand);
var eC=new qx.ui.menu.Button(dK,dI,this._copyCommand);
var ew=new qx.ui.menu.Button(dJ,dL,this._pasteCommand);
var et=new qx.ui.menu.Button(ek,dG,null,es);
var eD=new qx.ui.menu.Button(dE,dC,null,eA);
var eB=new qx.ui.menu.Button(dW,dh);
ey.addListener(dP,this.debugButton);
eF.addListener(dP,this.debugButton);
eu.addListener(dP,this.debugButton);
eC.addListener(dP,this.debugButton);
ew.addListener(dP,this.debugButton);
et.addListener(dP,this.debugButton);
eD.addListener(dP,this.debugButton);
eB.addListener(dP,this.debugButton);
ev.add(ey);
ev.add(eF);
ev.addSeparator();
ev.add(eu);
...
ev.addSeparator();
ev.add(eB);
var eE=new qx.ui.form.MenuButton(dn,di,ev);
return eE;
},getSplitButton:function(){var r=new qx.ui.menu.Menu;
var v=new qx.ui.menu.Button(dp);
var t=new qx.ui.menu.Button(eb);
var u=new qx.ui.menu.Button(bY);
r.setMinWidth(120);
v.addListener(dP,this.debugButton);
t.addListener(dP,this.debugButton);
u.addListener(dP,this.debugButton);
r.add(v);
r.add(t);
r.add(u);
var s=new qx.ui.form.SplitButton(ec,di,r);
s.addListener(dP,this.debugButton);
return s;
},getMenuBar:function(){var A=new qx.ui.container.Composite(new qx.ui.layout.Grow);
A.setDecorator(cv);
...
toolbar.addSpacer();
toolbar.add(D);
var I=new qx.ui.toolbar.SplitButton(cR,cd,this.getBackMenu());
var F=new qx.ui.toolbar.SplitButton(cp,cs,this.getForwardMenu());
var y=new qx.ui.toolbar.Button(dm,dU,this._newCommand);
var C=new qx.ui.toolbar.Button(dX,dg,this._openCommand);
var H=new qx.ui.toolbar.Button(de,dk,this._saveCommand);
I.addListener(dP,this.debugButton);
F.addListener(dP,this.debugButton);
y.addListener(dP,this.debugButton);
C.addListener(dP,this.debugButton);
H.addListener(dP,this.debugButton);
J.add(I);
J.add(F);
J.addSeparator();
J.add(y);
...
J.add(H);
J.setShow(cH);
var B=new qx.ui.toolbar.MenuButton(cT);
var x=new qx.ui.toolbar.MenuButton(ca);
var w=new qx.ui.toolbar.MenuButton(dw);
var K=new qx.ui.toolbar.MenuButton(ea);
var G=new qx.ui.toolbar.MenuButton(cS);
B.setMenu(this.getFileMenu());
x.setMenu(this.getEditMenu());
w.setMenu(this.getSearchMenu());
K.setMenu(this.getViewMenu());
G.setMenu(this.getFormatMenu());
z.add(B);
z.add(x);
z.add(w);
z.add(K);
z.add(G);
var E=new qx.ui.toolbar.MenuButton(bT);
E.setMenu(this.getHelpMenu());
D.add(E);
return A;
},getBackMenu:function(){var bA=new qx.ui.menu.Menu;
var bB=new qx.ui.menu.Button(cy);
var bD=new qx.ui.menu.Button(cX);
var bz=new qx.ui.menu.Button(cf);
var bC=new qx.ui.menu.Button(cm);
bB.addListener(dP,this.debugButton);
bD.addListener(dP,this.debugButton);
bz.addListener(dP,this.debugButton);
bC.addListener(dP,this.debugButton);
bA.add(bB);
bA.add(bD);
bA.add(bz);
bA.add(bC);
return bA;
},getForwardMenu:function(){var o=new qx.ui.menu.Menu;
var p=new qx.ui.menu.Button(cB);
var q=new qx.ui.menu.Button(dv);
p.addListener(dP,this.debugButton);
q.addListener(dP,this.debugButton);
o.add(p);
o.add(q);
return o;
},getFileMenu:function(){var bk=new qx.ui.menu.Menu;
var bi=new qx.ui.menu.Button(dm,dU,this._newCommand);
var bm=new qx.ui.menu.Button(dX,dg,this._openCommand);
var bl=new qx.ui.menu.Button(ed);
var bp=new qx.ui.menu.Button(de,dk,this._saveCommand);
var bo=new qx.ui.menu.Button(dB,ei);
var bn=new qx.ui.menu.Button(dW,dh);
var bj=new qx.ui.menu.Button(db,ck);
bi.addListener(dP,this.debugButton);
bm.addListener(dP,this.debugButton);
bl.addListener(dP,this.debugButton);
bp.addListener(dP,this.debugButton);
bo.addListener(dP,this.debugButton);
bn.addListener(dP,this.debugButton);
bj.addListener(dP,this.debugButton);
bk.add(bi);
bk.add(bm);
bk.add(bl);
bk.add(bp);
...
bk.add(bj);
return bk;
},getEditMenu:function(){var S=new qx.ui.menu.Menu;
var V=new qx.ui.menu.Button(dl,df,this._undoCommand);
var U=new qx.ui.menu.Button(dj,dd,this._redoCommand);
var R=new qx.ui.menu.Button(dH,dN,this._cutCommand);
var W=new qx.ui.menu.Button(dK,dI,this._copyCommand);
var T=new qx.ui.menu.Button(dJ,dL,this._pasteCommand);
V.addListener(dP,this.debugButton);
U.addListener(dP,this.debugButton);
R.addListener(dP,this.debugButton);
W.addListener(dP,this.debugButton);
T.addListener(dP,this.debugButton);
S.add(V);
S.add(U);
S.addSeparator();
...
S.add(T);
return S;
},getSearchMenu:function(){var eo=new qx.ui.menu.Menu;
var em=new qx.ui.menu.Button(cW,dG);
var er=new qx.ui.menu.Button(ci);
var en=new qx.ui.menu.Button(cQ);
var eq=new qx.ui.menu.Button(dt);
var el=new qx.ui.menu.Button(dT,dG);
var ep=new qx.ui.menu.Button(cM);
en.setEnabled(false);
em.addListener(dP,this.debugButton);
er.addListener(dP,this.debugButton);
en.addListener(dP,this.debugButton);
eq.addListener(dP,this.debugButton);
el.addListener(dP,this.debugButton);
ep.addListener(dP,this.debugButton);
eo.add(em);
eo.add(er);
eo.add(en);
eo.add(eq);
...
eo.add(ep);
return eo;
},getViewMenu:function(){var L=new qx.ui.menu.Menu;
var N=new qx.ui.menu.Button(cI,null,null,this.getPanesMenu());
var Q=new qx.ui.menu.Button(dr,null,null,this.getSyntaxMenu());
var P=new qx.ui.menu.CheckBox(cu);
var O=new qx.ui.menu.CheckBox(dA);
var M=new qx.ui.menu.Button(cg);
P.addListener(dO,this.debugCheckBox);
O.addListener(dO,this.debugCheckBox);
...
L.add(M);
return L;
},getPanesMenu:function(){var h=new qx.ui.menu.Menu;
var k=new qx.ui.menu.CheckBox(cU);
var m=new qx.ui.menu.CheckBox(bU);
var n=new qx.ui.menu.CheckBox(ef);
var j=new qx.ui.menu.CheckBox(cL);
var l=new qx.ui.menu.CheckBox(cx);
var g=new qx.ui.menu.CheckBox(dx);
k.setChecked(true);
m.setChecked(true);
j.setChecked(true);
...
g.addListener(dO,this.debugCheckBox);
h.add(m);
h.add(k);
h.addSeparator();
h.add(n);
...
h.add(g);
return h;
},getSyntaxMenu:function(){var bc=new qx.ui.menu.Menu;
var X=new qx.ui.menu.RadioButton(ds);
var ba=new qx.ui.menu.RadioButton(cF);
var Y=new qx.ui.menu.RadioButton(cG);
var bb=new qx.ui.menu.Button(dz,null,null,this.getSyntaxCMenu());
var bf=new qx.ui.menu.RadioButton(dY);
var bd=new qx.ui.menu.RadioButton(eh);
bc.add(X);
bc.add(ba);
bc.add(Y);
bc.add(bb);
...
be.add(X,ba,Y,bf,bd);
be.add.apply(be,bb.getMenu().getChildren());
be.addListener(dM,this.debugRadio);
return bc;
},getSyntaxCMenu:function(){var bF=new qx.ui.menu.Menu;
var bE=new qx.ui.menu.RadioButton(dQ);
var bI=new qx.ui.menu.RadioButton(ee);
var bH=new qx.ui.menu.RadioButton(da);
var bG=new qx.ui.menu.RadioButton(cn);
bF.add(bE);
bF.add(bI);
bF.add(bH);
bF.add(bG);
return bF;
},getFormatMenu:function(){var bM=new qx.ui.menu.Menu;
var bL=new qx.ui.menu.Button(cz,null,null,this.getParagraphMenu());
var bO=new qx.ui.menu.Button(cV);
var bP=new qx.ui.menu.Button(ej);
var bK=new qx.ui.menu.Button(cN);
var bN=new qx.ui.menu.Button(du);
var bJ=new qx.ui.menu.Button(cw);
var bR=new qx.ui.menu.Button(cA);
var bQ=new qx.ui.menu.Button(bW);
bO.addListener(dP,this.debugButton);
bP.addListener(dP,this.debugButton);
bK.addListener(dP,this.debugButton);
bN.addListener(dP,this.debugButton);
bJ.addListener(dP,this.debugButton);
bR.addListener(dP,this.debugButton);
bQ.addListener(dP,this.debugButton);
bM.add(bL);
bM.add(bO);
bM.add(bP);
bM.addSeparator();
...
bM.add(bQ);
return bM;
},getParagraphMenu:function(){var bq=new qx.ui.menu.Menu;
var bt=new qx.ui.menu.Button(dR,bV);
var bu=new qx.ui.menu.Button(cC,ct);
var br=new qx.ui.menu.Button(bX,cb);
var bs=new qx.ui.menu.Button(cJ,dS);
bt.addListener(dP,this.debugButton);
bu.addListener(dP,this.debugButton);
br.addListener(dP,this.debugButton);
bs.addListener(dP,this.debugButton);
bq.add(bt);
bq.add(bu);
bq.add(br);
bq.add(bs);
...
var c=new qx.ui.menu.Button(cP,eg);
var f=new qx.ui.menu.Button(dD);
var d=new qx.ui.menu.Button(dV);
var b=new qx.ui.menu.Button(dy);
c.addListener(dP,this.debugButton);
f.addListener(dP,this.debugButton);
d.addListener(dP,this.debugButton);
b.addListener(dP,this.debugButton);
a.add(c);
a.add(f);
a.addSeparator();
a.add(d);
...
a.add(b);
return a;
},getList:function(){var bS=new qx.ui.form.List;
bS.setContextMenu(this.getContextMenu());

for(var i=0;i<20;i++){bS.add(new qx.ui.form.ListItem(ch+i));
}return bS;
},getContextMenu:function(){var bv=new qx.ui.menu.Menu;
var bx=new qx.ui.menu.Button(dH,dN,this._cutCommand);
var by=new qx.ui.menu.Button(dK,dI,this._copyCommand);
var bw=new qx.ui.menu.Button(dJ,dL,this._pasteCommand);
bx.addListener(dP,this.debugButton);
by.addListener(dP,this.debugButton);
bw.addListener(dP,this.debugButton);
bv.add(bx);
bv.add(by);
bv.add(bw);
return bv;
...
qx.Class.define(f,{extend:qx.ui.menubar.Button,properties:{appearance:{refine:true,init:c},showArrow:{check:e,init:false,themeable:true,apply:d}},members:{_createChildControlImpl:function(a){var b;

switch(a){case g:b=new qx.ui.basic.Image();
b.setAnonymous(true);
this._addAt(b,10);
break;
}return b||arguments.callee.base.call(this,a);
},_applyShowArrow:function(h,i){if(h){this._showChildControl(g);
