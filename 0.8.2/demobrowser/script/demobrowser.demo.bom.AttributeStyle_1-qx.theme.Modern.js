...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.AttributeStyle_1", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.AttributeStyle_1-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var j="test8",i="backgroundColor",h="black",g="red",f="demobrowser.demo.bom.AttributeStyle_1",e="color";
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var a=qx.bom.element.Visibility;
var b=qx.bom.element.Attribute;
var c=qx.bom.element.Style;
var d=qx.bom.element.Opacity;
this.info("test1");
this.debug("classname: "+b.get(document.getElementById("test1"),"class"));
this.debug("title: "+b.get(document.getElementById("test1"),"title"));
this.debug("top: "+c.get(document.getElementById("test1"),"top"));
this.info("test2");
this.debug("name: "+b.get(document.getElementById("test2"),"name"));
this.debug("value: "+b.get(document.getElementById("test2"),"value"));
this.debug("type: "+b.get(document.getElementById("test2"),"type"));
this.debug("max: "+b.get(document.getElementById("test2"),"maxlength"));
this.debug("left: "+c.get(document.getElementById("test2"),"left"));
this.info("test3");
this.debug("name: "+b.get(document.getElementById("test3"),"name"));
this.debug("value: "+b.get(document.getElementById("test3"),"value"));
this.debug("type: "+b.get(document.getElementById("test3"),"type"));
this.debug("checked: "+b.get(document.getElementById("test3"),"checked"));
this.debug("disabled: "+b.get(document.getElementById("test3"),"disabled"));
this.debug("tabindex: "+b.get(document.getElementById("test3"),"tabindex"));
this.info("test4");
this.debug("disabled: "+b.get(document.getElementById("test4"),"disabled"));
this.debug("readonly: "+b.get(document.getElementById("test4"),"readonly"));
this.info("test5");
this.debug("disabled: "+b.get(document.getElementById("test5"),"disabled"));
this.debug("readonly: "+b.get(document.getElementById("test5"),"readonly"));
this.info("test6");
this.debug("href: "+b.get(document.getElementById("test6"),"href"));
this.debug("style: "+b.get(document.getElementById("test6"),"style"));
this.debug("css: "+c.getCss(document.getElementById("test6")));
this.debug("color: "+c.get(document.getElementById("test6"),"color"));
this.debug("bg: "+c.get(document.getElementById("test6"),"backgroundColor"));
this.debug("family: "+c.get(document.getElementById("test6"),"fontFamily"));
this.debug("text: "+b.get(document.getElementById("test6"),"text"));
this.debug("html: "+b.get(document.getElementById("test6"),"html"));
this.debug("opacity: "+d.get(document.getElementById("test6")));
this.info("test7");
this.debug("valign: "+b.get(document.getElementById("test7"),"valign"));
this.debug("colspan: "+b.get(document.getElementById("test7").getElementsByTagName("td")[0],"colspan"));
this.info("test8");
c.set(document.getElementById(j),e,g);
c.set(document.getElementById(j),i,h);
d.set(document.getElementById(j),0.5);
this.debug("opacity: "+d.get(document.getElementById("test8")));
this.info("test9");
