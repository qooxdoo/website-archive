...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Destructor_Flash", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Destructor_Flash-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
qx.Class.define(j,{extend:qx.application.Native,members:{__wL:[],__wM:0,main:function(){arguments.callee.base.call(this);
