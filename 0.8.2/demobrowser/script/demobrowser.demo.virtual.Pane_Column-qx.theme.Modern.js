...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.virtual.Pane_Column-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var w="px;",v="<div style='",u="</div>",t="position: absolute;",s="top: 0;",r="'>",q="left:",p="qx.ui.virtual.layer.Column",o="block",n="",j="height:",m="column-layer",k="background-color:",h="width:",g="none";
qx.Class.define(p,{extend:qx.ui.virtual.layer.AbstractBackground,properties:{appearance:{refine:true,init:m}},members:{_fullUpdate:function(y,z,A,B,C,D){var K=[];
...
K.push(v,t,s,q,N,w,r,M.getMarkup(),u);
G++;
}else{var J=this.getColor(H);

if(J){K.push(v,t,s,q,N,w,h,D[x],w,j,I,w,k,J,r,u);
G++;
}}N+=D[x];
H+=1;
}var E=this.getContentElement().getDomElement();
E.style.display=g;
E.innerHTML=K.join(n);
for(var i=0,l=L.length;i<l;i++){var F=L[i];
F.decorator.resize(E.childNodes[F.childIndex].firstChild,F.width,F.height);
}E.style.display=o;
this._height=I;
},updateLayerWindow:function(a,b,c,d,e,f){if(c!==this.getFirstColumn()||d!==this.getLastColumn()||this._height<qx.lang.Array.sum(e)){this._fullUpdate(a,b,c,d,e,f);
}},setColor:function(O,P){arguments.callee.base.call(this,O,P);

if(O>=this.getFirstColumn()&&O<=this.getLastColumn()){this.updateLayerData();
}}}});
})();
