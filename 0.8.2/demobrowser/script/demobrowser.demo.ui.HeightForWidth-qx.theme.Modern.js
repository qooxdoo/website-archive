...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.HeightForWidth", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.ui.HeightForWidth-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
a.setSpacing(20);
var d=new qx.ui.container.Composite(a).set({decorator:j,width:300});
this.getRoot().add(d,{left:20,top:20});
var e=new qx.ui.basic.Label().set({decorator:j,rich:true,content:i});
d.add(e);
var b=new qx.ui.basic.Label().set({decorator:j,rich:true,content:h});
d.add(b);
var c=new qx.ui.basic.Label().set({decorator:j,rich:true,content:f});
d.add(c);
}}});
})();
