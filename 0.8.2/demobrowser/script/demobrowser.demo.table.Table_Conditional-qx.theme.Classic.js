...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.table.Table_Conditional", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.table.Table_Conditional-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
},members:{__vQ:null,__vP:16,__vO:16,_identifyImage:function(e){var f={imageWidth:this.__vO,imageHeight:this.__vP};

if(e.value==a){f.url=null;
}else{f.url=this.__vQ.resolve(e.value);
}return f;
}}});
})();
