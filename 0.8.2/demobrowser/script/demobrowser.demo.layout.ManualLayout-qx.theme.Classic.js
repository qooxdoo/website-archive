...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.ManualLayout-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var j="black",i="red",h="green",g="demobrowser.demo.layout.ManualLayout",f="yellow",e="solid",d="blue";
qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var a=j;
var c=new qx.ui.decoration.Single(3,e,a);
w1=new qx.ui.core.Widget().set({backgroundColor:i,decorator:c,paddingLeft:10,paddingRight:10});
w1.setUserBounds(10,10,100,30);
w2=new qx.ui.core.Widget().set({backgroundColor:d,decorator:c});
w2.setUserBounds(200,20,150,100);
w3=new qx.ui.core.Widget().set({backgroundColor:h,decorator:c,padding:3});
w3.setUserBounds(380,50,150,100);
w4=new qx.ui.core.Widget().set({backgroundColor:f,decorator:c,padding:10});
