...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.SearchAsYouType-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var q="searchString",p="Bart",o="<b>Search As You Type List</b><br/>",n="Marge",m="Maggy",l="Skinner",k="Moe",j="Smithers",h="Lisa",g="input",c=" ",f="Homer",e="Nelson",b="Flanders",a="demobrowser.demo.data.SearchAsYouType",d="Type a name and the list will show only the fitting results.";
qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var v=[p,h,f,n,k,j,e,b,m,l];
var y=[];
...
qx.Class.define(d,{extend:qx.core.Object,construct:function(a){arguments.callee.base.call(this);
this.__ow=a;
this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;
},this);
this.__ox=null;
},properties:{searchString:{check:c,apply:e,init:b}},members:{_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();
if(this.__ox!=null){i.stop(this.__ox);
this.__ox=null;
}this.__ox=i.start(function(){this.__ow.update();
this.__ox=null;
},0,this,null,200);
},filter:null}});
})();
