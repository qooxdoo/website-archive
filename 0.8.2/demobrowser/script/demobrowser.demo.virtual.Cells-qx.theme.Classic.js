...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.Cells", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.virtual.Cells-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var M="",L="selected",K="' ",J="px;",I="width:",H="test<br/>lala",G=">",F="icon/16/apps/internet-feed-reader.png",E="height:",D="foobar!",x="class='",C="icon/32/apps/utilities-notes.png",A="<b>html</b><i>cell</i>",w="<div ",v="This is a feed reader!",z="style='",y="main",B="demobrowser.demo.virtual.Cells",u="</div>";
qx.Class.define(B,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var e=new qx.ui.layout.Grid(5,5);
var d=new qx.ui.container.Composite(e);
d.add(this.createStringCell(),{row:0,column:0});
d.add(this.createNumberCell(),{row:0,column:1});
d.add(this.createDateCell(),{row:0,column:2});
d.add(this.createHtmlCell(),{row:1,column:0});
d.add(this.createSelectedCell(),{row:1,column:1});
d.add(this.createImageCell(),{row:1,column:2});
d.add(this.createImageCellSmall(),{row:2,column:0});
d.add(this.createBooleanCellTrue(),{row:2,column:1});
d.add(this.createBooleanCellFalse(),{row:2,column:2});
this.getRoot().add(d,{edge:5});
},createStringCell:function(N){var O={};
var P=new qx.ui.virtual.cell.String;
return this.__tP(P,H,O);
},createNumberCell:function(ba){var bb={};
var bd=qx.util.format.NumberFormat.getInstance();
bd.setMaximumFractionDigits(2);
var bc=new qx.ui.virtual.cell.Number(bd);
return this.__tP(bc,1.2345678,bb);
},createDateCell:function(q){var r={};
var t=qx.util.format.DateFormat.getDateInstance();
var s=new qx.ui.virtual.cell.Date(t);
return this.__tP(s,new Date(),r);
},createHtmlCell:function(Q){var R={};
var S=new qx.ui.virtual.cell.Html;
return this.__tP(S,A,R);
},createSelectedCell:function(k){var l={selected:1};
var m=new qx.ui.virtual.cell.Html;
return this.__tP(m,L,l);
},createImageCell:function(T){var U={};
var T={url:F,tooltip:v};
var V=new qx.ui.virtual.cell.Image;
return this.__tP(V,T,U);
},createImageCellSmall:function(n){var o={};
var n={url:C,tooltip:D};
var p=new qx.ui.virtual.cell.Image;
return this.__tP(p,n,o);
},createBooleanCellTrue:function(W){var X={};
var W=true;
var Y=new qx.ui.virtual.cell.Boolean;
return this.__tP(Y,W,X);
},createBooleanCellFalse:function(a){var b={};
var a=false;
var c=new qx.ui.virtual.cell.Boolean;
return this.__tP(c,a,b);
},_getCellSizeStyle:function(f,g,h,i){var j=M;
...
j+=E+g+J;
return j;
},__tP:function(be,bf,bg){var bk=100;
var bi=40;
var bm=new qx.ui.embed.Html().set({width:bk,height:bi,decorator:bg.selected?L:y});
var bh=be.getCellProperties(bf,bg);
var bj=bh.insets;
var bl=[w,z,this._getCellSizeStyle(bk,bi,bj[0],bj[1]),bh.style,K,x,bh.classes,K,bh.attributes,G,bh.content,u].join(M);
bm.setHtml(bl);
return bm;
}}});
})();
...
(function(){var b="qx.ui.virtual.cell.String",a="cell-string";
qx.Class.define(b,{extend:qx.ui.virtual.cell.Cell,construct:function(){arguments.callee.base.call(this);
},properties:{appearance:{refine:true,init:a}},members:{getContent:function(c,d){return qx.bom.String.escape(c);
}}});
})();
...
(function(){var c="qx.ui.virtual.cell.Number",b="qx.util.format.NumberFormat",a="cell-number";
qx.Class.define(c,{extend:qx.ui.virtual.cell.Cell,construct:function(d){arguments.callee.base.call(this);

if(d){this.setNumberFormat(d);
}else{this.setNumberFormat(qx.util.format.NumberFormat.getInstance());
}},properties:{numberFormat:{check:b},appearance:{refine:true,init:a}},members:{getContent:function(e,f){return this.getNumberFormat().format(e);
}}});
})();
...
(function(){var e="qx.util.format.DateFormat",d="cell-date",c="qx.ui.virtual.cell.Date";
qx.Class.define(c,{extend:qx.ui.virtual.cell.Cell,construct:function(f){arguments.callee.base.call(this);

if(f){this.setDateFormat(f);
}else{this.setDateFormat(qx.util.format.DateFormat.getDateInstance());
}},properties:{appearance:{refine:true,init:d},dateFormat:{check:e}},members:{getContent:function(a,b){return this.getDateFormat().format(a);
}}});
})();
...
qx.Class.define(j,{extend:qx.ui.virtual.cell.Cell,type:e,construct:function(){arguments.callee.base.call(this);
this.__tQ=16;
this.__tR=16;
this._aliasManager=qx.util.AliasManager.getInstance();
},members:{__tQ:null,__tR:null,_aliasManager:null,__tS:function(D){var G=qx.util.ResourceManager;
var F=qx.io2.ImageLoader;
var E,H;
if(G.has(D)){E=G.getImageWidth(D),H=G.getImageHeight(D)}else if(F.isLoaded(D)){E=F.getWidth(D);
H=F.getHeight(D);
}else{E=this.__tQ;
H=this.__tR;
}return {width:E,height:H};
},__tT:function(I){if(typeof (I)==h){I={url:I};
...
},getContent:function(u,v){var content=s;
var x=this.__tT(this._identifyImage(u));
var B=qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9;
var y=x.tooltip?m+x.tooltip+o:s;
var w={width:x.width+r,height:x.height+r,display:B?a:g,verticalAlign:b,position:c};
var z=qx.bom.element.Decoration.getTagName(p,x.url);
var A=qx.bom.element.Decoration.getAttributes(x.url,p,w);
var C=qx.bom.element.Style.compile(A.style);

if(z===i){content=f+A.src+n+C+q;
content+=y+d;
}else{content=l+C+q;
content+=y+k;
}return content;
...
(function(){var d="qx.ui.virtual.cell.Boolean",c="cell-boolean",b="decoration/table/boolean-false.png",a="decoration/table/boolean-true.png";
qx.Class.define(d,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){arguments.callee.base.call(this);
this.__tU=this._aliasManager.resolve(a);
this.__tV=this._aliasManager.resolve(b);
},properties:{appearance:{refine:true,init:c}},members:{__tU:null,__tV:null,_identifyImage:function(e){return e==true?this.__tU:this.__tV;
}}});
})();
