...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.VBox_Margin-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var n="main",m="green",l="yellow",k="center",j="demobrowser.demo.layout.VBox_Margin";
...
var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(C);
C.add(this.getBox1());
C.add(this.getBox2());
C.add(this.getBox3());
C.add(this.getBox4());
C.add(this.getBox5());
},getBox1:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:n,backgroundColor:l,allowGrowY:false});
var i=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var h=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var f=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
g.add(i);
g.add(h);
g.add(f);
i.setAllowGrowX(false);
h.setAllowGrowX(false);
f.setAllowGrowX(false);
i.setMarginLeft(20);
f.setMarginRight(30);
return g;
},getBox2:function(){var p=new qx.ui.container.Composite(new qx.ui.layout.VBox(5)).set({decorator:n,backgroundColor:l,allowGrowY:false});
var r=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var q=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var o=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
p.add(r);
p.add(q);
p.add(o);
r.setMarginLeft(20);
...
var u=new qx.ui.container.Composite(s).set({decorator:n,backgroundColor:l,width:150,allowGrowY:false});
s.setSpacing(5);
s.setAlignX(k);
...
v.setAllowGrowX(false);
t.setAllowGrowX(false);
w.setMarginLeft(20);
t.setMarginRight(30);
return u;
},getBox4:function(){var a=new qx.ui.layout.VBox();
var c=new qx.ui.container.Composite(a).set({decorator:n,backgroundColor:l,width:150,allowGrowY:false});
a.setSpacing(5);
a.setAlignX(k);
...
b.setMarginRight(20);
return c;
},getBox5:function(){var x=new qx.ui.layout.VBox();
var z=new qx.ui.container.Composite(x).set({decorator:n,backgroundColor:l,width:150,allowGrowY:false});
x.setSpacing(5);
x.setAlignX(k);
var B=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
