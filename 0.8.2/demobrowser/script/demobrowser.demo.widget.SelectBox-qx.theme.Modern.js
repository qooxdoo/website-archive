...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.SelectBox", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.SelectBox-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var s="icon/16/devices/",r="phone.png",q="audio-card.png",p="battery.png",o="changeValue",n="Simple",m="changeSelected",l="display.png",k="audio-input-microphone.png",j="Empty Item",O="computer.png",N="Random Value ",M="input-keyboard.png",L="drive-optical.png",K="",J="media-optical.png",I="pda.png",H="printer.png",G="network-wired.png",F=".",z="camera-photo.png",A="network-wireless.png",x="media-flash.png",y="Option ",v="input-mouse.png",w="demobrowser.demo.widget.SelectBox",t="With icons",u="drive-harddisk.png",B="camera-web.png",C="multimedia-player.png",E="Item ",D="Long text";
...
var d=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));
d.setPadding(20);
d.add(this.createBox1());
d.add(this.createBox2());
d.add(this.createBox3());
d.add(this.createBox4());
f.add(d,{left:20,top:20});
this.getRoot().add(f,{edge:0});
},createBox1:function(){var V=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
V.add(new qx.ui.basic.Label(n));
var U=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var W=new qx.ui.form.ListItem(E+(i+1));
U.add(W);
if(i==5){U.setSelected(W);
}}U.addListener(o,function(e){this.debug("ChangeValue: "+e.getData());
});
U.addListener(m,function(e){this.debug("ChangeSelected: "+e.getData());
});
V.add(U);
return V;
},createBox2:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
b.add(new qx.ui.basic.Label(D));
var a=new qx.ui.form.SelectBox();

for(var i=0;i<30;i++){var c=new qx.ui.form.ListItem(N+Math.round(Math.random()*100000000));
a.add(c);
}b.add(a);
return b;
},createBox3:function(){var Q=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
Q.add(new qx.ui.basic.Label(t));
var S=[q,k,p,z,B,O,l,u,L,M,v,x,J,C,G,A,I,r,H];
var T=s;
var P=new qx.ui.form.SelectBox();

for(var i=0;i<S.length;i++){var R=new qx.ui.form.ListItem(S[i].substr(0,S[i].indexOf(F)),T+S[i]);
P.add(R);
}Q.add(P);
return Q;
},createBox4:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
h.add(new qx.ui.basic.Label(j));
var g=new qx.ui.form.SelectBox();
g.add(new qx.ui.form.ListItem(K));

for(var i=0;i<10;i++){g.add(new qx.ui.form.ListItem(y+(i+1)));
}h.add(g);
return h;
}}});
})();
...
(function(){var x="list",w="pressed",v="abandoned",u="popup",t="atom",s="hovered",r="changeValue",q="arrow",p="",o="spacer",N="Enter",M="mouseout",L="Space",K="changeSelected",J="key",I="mousewheel",H="keyinput",G="qx.ui.form.ListItem",F="quick",E="qx.ui.form.SelectBox",C="mouseover",D="selectbox",A="_applySelected",B="click",y="__mN",z=" ";
qx.Class.define(E,{extend:qx.ui.form.AbstractSelectBox,implement:[qx.ui.form.IFormElement],construct:function(){arguments.callee.base.call(this);
this._createChildControl(t);
this._createChildControl(o);
this._createChildControl(q);
this.addListener(C,this._onMouseOver,this);
this.addListener(M,this._onMouseOut,this);
this.addListener(B,this._onClick,this);
this.addListener(I,this._onMouseWheel,this);
this.addListener(H,this._onKeyInput,this);
},properties:{appearance:{refine:true,init:D},selected:{check:G,apply:A,event:K}},members:{__mN:null,_createChildControlImpl:function(P){var Q;

switch(P){case o:Q=new qx.ui.core.Spacer();
this._add(Q,{flex:1});
break;
case t:Q=new qx.ui.basic.Atom(z);
Q.setCenter(false);
Q.setAnonymous(true);
this._add(Q,{flex:1});
break;
case q:Q=new qx.ui.basic.Image();
Q.setAnonymous(true);
this._add(Q);
break;
}return Q||arguments.callee.base.call(this,P);
},_forwardStates:{focused:true},_applySelected:function(a,b){var d=this.getChildControl(x);

if(d.getSelected()!=a){d.setSelected(a);
}var g=this.getChildControl(t);
var c=a?a.getLabel():p;
c==null?g.resetLabel():g.setLabel(c);
var f=a?a.getIcon():p;
f==null?g.resetIcon():g.setIcon(f);
if(this.hasListener(r)){this.fireDataEvent(r,d.getValue());
}},setValue:function(U){this.getChildControl(x).setValue(U);
},getValue:function(){var W=this.getSelected();
return W?W.getFormValue():null;
},resetSelection:function(){var V=this.getChildControl(x).getChildren()[0];

if(V){this.setSelected(V);
}},isSelected:function(h){var i=this.getChildControl(x).getChildren();

if(i.length>0){return this.getSelected()===h;
}else{return false;
}},isSelectionEmpty:function(){var O=this.getChildControl(x).getChildren();

if(O.length>0){return this.getSelected()?false:true;
}else{return true;
}},getSelectables:function(){return this.getChildControl(x).getChildren();
},_onMouseOver:function(e){if(!this.isEnabled()||e.getTarget()!==this){return;
}
...
},_onMouseWheel:function(e){if(this.getChildControl(u).isVisible()){return;
}var Y=e.getWheelDelta()>0?1:-1;
var bb=this.getChildren();
var ba=this.getSelected();

if(!ba){ba=bb[0];
}var X=bb.indexOf(ba)+Y;
var bc=bb.length-1;
if(X<0){X=0;
}else if(X>=bc){X=bc;
}this.setSelected(bb[X]);
e.stopPropagation();
},_onKeyPress:function(e){var R=e.getKeyIdentifier();

if(R==N||R==L){if(this.__mN){this.setSelected(this.__mN);
this.__mN=null;
}this.toggle();
...
n.setBubbles(false);
this.getChildControl(x).dispatchEvent(n);
},_onListMouseDown:function(e){if(this.__mN){this.setSelected(this.__mN);
this.__mN=null;
}},_onListChangeSelection:function(e){var j=e.getData();

if(j.length>0){var k=this.getChildControl(u);
var l=this.getChildControl(x);
var m=l.getSelectionContext();

if(k.isVisible()&&(m==F||m==J)){this.__mN=j[0];
}else{this.setSelected(j[0]);
this.__mN=null;
}}else{this.resetSelected();
}},_onPopupChangeVisibility:function(e){var S=this.getChildControl(u);

if(!S.isVisible()){var T=this.getChildControl(x);
if(T.hasChildren()){T.setSelected(this.getSelected());
