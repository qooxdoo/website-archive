...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.event.MouseEvent-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
}qx.bom.Element.addListener(K,k,this.__ny,this);
...
},__ny:function(e){var G=e.getTarget().id.split(x)[1];
