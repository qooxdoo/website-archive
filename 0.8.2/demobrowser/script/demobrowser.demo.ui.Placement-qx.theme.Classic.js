...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.Placement", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.ui.Placement-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var B="top-left",A="bottom-right",z="right-top",y="bottom-left",x="left-bottom",w="top-right",v="mousedown",u="right-bottom",t="changeValue",s="left-top",n="demobrowser.demo.ui.Placement",r="Open DOM-Popup",q="DOM Popup",m="Open Popup",l="Content",p="DOM align control",o="domanchor";
qx.Class.define(n,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var C=this.getRoot();
C.add(this.createTestField(y),{left:20,top:20});
C.add(this.createTestField(A),{right:20,top:20});
C.add(this.createTestField(B),{right:20,bottom:20});
C.add(this.createTestField(w),{left:20,bottom:20});
C.add(this.createTestField(z),{left:20,top:250});
C.add(this.createTestField(x),{right:20,top:250});
C.add(this.createDomClick(),{left:200,top:100});
},createTestField:function(g){var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var j=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
j.add(new qx.ui.basic.Atom(l));
j.setPadding(20);
var i=new qx.ui.form.SelectBox;
i.add(new qx.ui.form.ListItem(y));
i.add(new qx.ui.form.ListItem(A));
i.add(new qx.ui.form.ListItem(B));
i.add(new qx.ui.form.ListItem(w));
i.add(new qx.ui.form.ListItem(z));
i.add(new qx.ui.form.ListItem(u));
i.add(new qx.ui.form.ListItem(s));
i.add(new qx.ui.form.ListItem(x));
h.add(i);
i.addListener(t,function(e){j.setPosition(e.getData());
});
i.setValue(g);
var k=new qx.ui.form.Button(m);
h.add(k);
k.addListener(v,function(e){j.placeToWidget(k);
j.show();
});
return h;
},createDomClick:function(){var a=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
var f=new qx.ui.basic.Label(p);
a.add(f);
var c=new qx.ui.popup.Popup(new qx.ui.layout.Grow);
c.add(new qx.ui.basic.Atom(q));
c.setPadding(20);
var b=new qx.ui.form.SelectBox;
b.add(new qx.ui.form.ListItem(y));
b.add(new qx.ui.form.ListItem(A));
b.add(new qx.ui.form.ListItem(B));
b.add(new qx.ui.form.ListItem(w));
b.add(new qx.ui.form.ListItem(z));
b.add(new qx.ui.form.ListItem(u));
b.add(new qx.ui.form.ListItem(s));
b.add(new qx.ui.form.ListItem(x));
a.add(b);
b.addListener(t,function(e){c.setPosition(e.getData());
});
var d=new qx.ui.form.Button(r);
a.add(d);
d.addListener(v,function(e){c.placeToElement(document.getElementById(o));
c.show();
});
return a;
}}});
