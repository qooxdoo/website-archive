...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Overflow", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Overflow-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var b="demobrowser.demo.bom.Overflow";
qx.Class.define(b,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var a=qx.bom.element.Overflow;
this.info("#0");
this.debug("1: "+a.getX(document.getElementById("test1"))+", "+a.getY(document.getElementById("test1")));
this.debug("2: "+a.getX(document.getElementById("test2"))+", "+a.getY(document.getElementById("test2")));
this.debug("3: "+a.getX(document.getElementById("test3"))+", "+a.getY(document.getElementById("test3")));
this.info("#1");
this.debug("9a: "+a.getX(document.getElementById("test9a"))+", "+a.getY(document.getElementById("test9a")));
this.debug("9b: "+a.getX(document.getElementById("test9b"))+", "+a.getY(document.getElementById("test9b")));
this.debug("9c: "+a.getX(document.getElementById("test9c"))+", "+a.getY(document.getElementById("test9c")));
this.debug("9d: "+a.getX(document.getElementById("test9d"))+", "+a.getY(document.getElementById("test9d")));
this.info("#2");
this.debug("9e: "+a.getX(document.getElementById("test9e"))+", "+a.getY(document.getElementById("test9e")));
this.debug("9f: "+a.getX(document.getElementById("test9f"))+", "+a.getY(document.getElementById("test9f")));
this.debug("9g: "+a.getX(document.getElementById("test9g"))+", "+a.getY(document.getElementById("test9g")));
this.debug("9h: "+a.getX(document.getElementById("test9h"))+", "+a.getY(document.getElementById("test9h")));
this.info("#3");
this.debug("9i: "+a.getX(document.getElementById("test9i"))+", "+a.getY(document.getElementById("test9i")));
this.debug("9j: "+a.getX(document.getElementById("test9j"))+", "+a.getY(document.getElementById("test9j")));
this.debug("9k: "+a.getX(document.getElementById("test9k"))+", "+a.getY(document.getElementById("test9k")));
this.debug("9l: "+a.getX(document.getElementById("test9l"))+", "+a.getY(document.getElementById("test9l")));
this.info("#4");
this.debug("9m: "+a.getX(document.getElementById("test9m"))+", "+a.getY(document.getElementById("test9m")));
this.debug("9n: "+a.getX(document.getElementById("test9n"))+", "+a.getY(document.getElementById("test9n")));
this.debug("9o: "+a.getX(document.getElementById("test9o"))+", "+a.getY(document.getElementById("test9o")));
this.debug("9p: "+a.getX(document.getElementById("test9p"))+", "+a.getY(document.getElementById("test9p")));
}}});
})();
