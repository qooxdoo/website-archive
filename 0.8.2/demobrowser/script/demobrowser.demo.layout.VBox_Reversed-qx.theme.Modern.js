...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.VBox_Reversed-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var k="main",j="demobrowser.demo.layout.VBox_Reversed",i="yellow",h="gray",g="blue",f="green",e="click to reverse",d="top",c="bottom",b="middle",a="mousedown";
...
var n=new qx.ui.container.Composite(l).set({decorator:k,backgroundColor:i,width:120});
l.setSpacing(5);
l.setReversed(true);
var p=new qx.ui.core.Widget().set({decorator:k,backgroundColor:g,maxHeight:60,alignY:d});
var o=new qx.ui.basic.Label(e).set({decorator:k,rich:true,backgroundColor:f,padding:5,height:60,maxHeight:60,alignY:b,allowGrowX:true,allowGrowY:true});
var m=new qx.ui.core.Widget().set({decorator:k,backgroundColor:h,maxHeight:60,alignY:c});
n.add(p);
n.add(o);
n.add(m);
