...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.TextField", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.TextField-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var C="execute",B="monospace",A="Web 2.0",z="Toggle enabled",y="Send content",x="Send selection",w="text\narea\nmonospace",v="input",u="20px sans-serif",t="changeValue",q="read only",s="demobrowser.demo.widget.TextField",r="text\narea",p="text\narea\nnowrap",o="max15";
...
a.setSpacing(10);
var n=new qx.ui.container.Composite(a);
n.setPadding(20);
this.getRoot().add(n,{left:0,top:0});
var b=new qx.ui.form.TextField(o).set({maxLength:15});
b.focus();
b.addListener(v,function(e){this.debug("Input: "+e.getData());
},this);
b.addListener(t,function(e){this.debug("ChangeValue: "+e.getData());
},this);
n.add(b);
var d=new qx.ui.form.TextField(A).set({font:qx.bom.Font.fromString(u),padding:6});
n.add(d);
var c=new qx.ui.form.TextField(q).set({readOnly:true});
n.add(c);
...
m.setWrap(false);
n.add(m);
var l=new qx.ui.form.TextArea(w);
l.setFont(B);
n.add(l);
var h=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
h.setPadding(20);
var j=new qx.ui.form.Button(z);
var k=false;
j.addListener(C,function(){n.setEnabled(k);
k=!k;
});
h.add(j);
var i=new qx.ui.form.Button(y);
i.addListener(C,function(){this.debug("Sending content: "+b.getValue());
});
h.add(i);
var g=new qx.ui.form.Button(x);
g.setFocusable(false);
g.setKeepFocus(true);
g.addListener(C,function(){this.debug("Sending selection: "+b.getSelection());
});
h.add(g);
this.getRoot().add(h,{left:200,top:0});
}}});
})();
