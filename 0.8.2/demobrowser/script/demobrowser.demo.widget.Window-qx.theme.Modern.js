...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Window-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var O="changeChecked",N="execute",M="icon/16/apps/office-calendar.png",L="demobrowser.demo.widget.Window",K="Resize all edges",J="Second Window",I="Page 1",H="Use move frame",G="Show Statusbar",F="icon/16/actions/dialog-cancel.png",bz="icon/32/status/dialog-error.png",by="Show Close",bx="Second Modal Dialog",bw="right",bv="Third Window",bu="icon/22/apps/utilities-calculator.png",bt="Show Maximize",bs="Allow Close",br="Use resize frame",bq="No",V="Allow Maximize",W="Resizable/Moveable",T="The second window",U="Page 3",R="move",S="First Window",P="resize",Q="Demo loaded",X="Allow Minimize",Y="Resizable",bg="Open Modal Dialog 2",be="Open Modal Dialog 1",bk="First Modal Dialog",bi="Yes",bm="Movable",bl="icon/32/apps/office-address-book.png",bb="Basics",bp="Modal",bo="Do you want to fly to Berlin?",bn="Welcome to your first own Window.<br/>Have fun!",ba="Application is ready",bc="icon/16/apps/internet-feed-reader.png",bd="icon/16/actions/dialog-ok.png",bf="Page 2",bh="icon/16/apps/internet-telephony.png",bj="Show Minimize";
qx.Class.define(L,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
this.createWindow1();
this.createWindow2();
this.createWindow3();
},createWindow1:function(){var c=new qx.ui.window.Window(S,M);
c.setLayout(new qx.ui.layout.VBox(10));
c.setShowStatusbar(true);
c.setStatus(Q);
c.open();
this.getRoot().add(c,{left:20,top:20});
c.addListener(R,function(e){this.debug("Moved to: "+e.getData().left+"x"+e.getData().top);
});
c.addListener(P,function(e){this.debug("Resized to: "+e.getData().width+"x"+e.getData().height);
});
var b=new qx.ui.basic.Atom(bn,bl);
b.setRich(true);
c.add(b);
var a=new qx.ui.tabview.TabView;
c.add(a,{flex:1});
var g=new qx.ui.tabview.Page(I);
a.add(g);
var d=new qx.ui.tabview.Page(bf);
a.add(d);
var f=new qx.ui.tabview.Page(U);
a.add(f);
},createWindow2:function(){var n=new qx.ui.window.Window(J,bc);
n.setLayout(new qx.ui.layout.VBox(10));
n.setStatus(ba);
n.open();
this.getRoot().add(n,{left:350,top:120});
var v=new qx.ui.basic.Atom(T,bu);
n.add(v);
var h=new qx.ui.container.Composite;
h.setLayout(new qx.ui.layout.HBox(10));
n.add(h,{flex:1});
var p=new qx.ui.groupbox.GroupBox(bb);
p.setLayout(new qx.ui.layout.VBox(4));
h.add(p,{flex:1});
var k=new qx.ui.form.CheckBox(by);
k.setChecked(true);
k.addListener(O,function(e){n.setShowClose(e.getData());
});
p.add(k);
var u=new qx.ui.form.CheckBox(bt);
u.setChecked(true);
u.addListener(O,function(e){n.setShowMaximize(e.getData());
});
p.add(u);
var o=new qx.ui.form.CheckBox(bj);
o.setChecked(true);
o.addListener(O,function(e){n.setShowMinimize(e.getData());
});
p.add(o);
var r=new qx.ui.form.CheckBox(bs);
r.setChecked(true);
r.addListener(O,function(e){n.setAllowClose(e.getData());
});
p.add(r);
var x=new qx.ui.form.CheckBox(V);
x.setChecked(true);
x.addListener(O,function(e){n.setAllowMaximize(e.getData());
});
p.add(x);
var m=new qx.ui.form.CheckBox(X);
m.setChecked(true);
m.addListener(O,function(e){n.setAllowMinimize(e.getData());
});
p.add(m);
var i=new qx.ui.form.CheckBox(G);
i.setChecked(false);
i.addListener(O,function(e){n.setShowStatusbar(e.getData());
});
p.add(i);
var q=new qx.ui.groupbox.GroupBox(W);
q.setLayout(new qx.ui.layout.VBox(4));
h.add(q,{flex:1});
var l=new qx.ui.form.CheckBox(Y);
l.setChecked(true);
l.addListener(O,function(e){n.setResizable(e.getData());
});
q.add(l);
var t=new qx.ui.form.CheckBox(br);
t.setChecked(true);
t.addListener(O,function(e){n.setUseResizeFrame(e.getData());
});
q.add(t);
var w=new qx.ui.form.CheckBox(K);
w.setChecked(true);
w.addListener(O,function(e){n.setResizeAllEdges(e.getData());
});
q.add(w);
var s=new qx.ui.form.CheckBox(bm);
s.setChecked(true);
s.addListener(O,function(e){n.setMovable(e.getData());
});
q.add(s);
var j=new qx.ui.form.CheckBox(H);
j.addListener(O,function(e){n.setUseMoveFrame(e.getData());
});
q.add(j);
},createWindow3:function(){var C=new qx.ui.window.Window(bv,bh);
C.setLayout(new qx.ui.layout.VBox);
C.setMaxWidth(450);
C.setMaxHeight(400);
C.setAllowMaximize(false);
C.open();
this.getRoot().add(C,{left:100,top:250});
var D=this.getModalWindow1();
var E=new qx.ui.form.Button(be,M);
E.addListener(N,D.open,D);
C.add(E);
},getModalWindow1:function(){var z=new qx.ui.window.Window(bk);
z.setLayout(new qx.ui.layout.VBox(10));
z.setModal(true);
z.moveTo(150,150);
this.getRoot().add(z);
var y=this.getModalWindow2();
var B=new qx.ui.form.Button(bg,M);
B.addListener(N,y.open,y);
z.add(B);
var A=new qx.ui.form.CheckBox(bp);
A.setChecked(true);
z.add(A);
A.addListener(O,function(e){z.setModal(e.getData());
});
return z;
},getModalWindow2:function(){var bB=new qx.ui.window.Window(bx);
bB.setLayout(new qx.ui.layout.VBox(10));
bB.setModal(true);
bB.setShowClose(false);
bB.moveTo(300,300);
this.getRoot().add(bB);
var bA=new qx.ui.basic.Atom(bo,bz);
bB.add(bA);
var bD=new qx.ui.container.Composite;
bD.setLayout(new qx.ui.layout.HBox(10,bw));
bB.add(bD);
var bE=new qx.ui.form.Button(bi,bd);
bE.addListener(N,function(e){bB.close();
});
bD.add(bE);
var bC=new qx.ui.form.Button(bq,F);
bC.addListener(N,function(e){alert("Sorry, please click 'Yes'!");
});
bD.add(bC);
return bB;
}}});
