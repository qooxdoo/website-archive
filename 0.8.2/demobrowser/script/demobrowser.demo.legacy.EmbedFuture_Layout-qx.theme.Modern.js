...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.legacy.EmbedFuture_Layout", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.legacy.EmbedFuture_Layout-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var g="auto",f="black",e="gray",d="demobrowser.demo.legacy.EmbedFuture_Layout",c="Resize HBox",b="100%",a="execute";
qx.Class.define(d,{extend:qx.legacy.application.Gui,members:{main:function(){arguments.callee.base.call(this);
qx.theme.manager.Meta.getInstance().initialize();
var h=new qx.legacy.ui.form.Button(c);
var i=new qx.legacy.ui.embed.Future().set({width:g,height:b,content:this.getGrid()});
var k=new qx.legacy.ui.layout.HorizontalBoxLayout();
k.set({top:10,left:10,height:g,width:g,backgroundColor:e,border:f,spacing:10,padding:5});
k.add(h,i);
k.addToDocument();
var j=true;
h.addListener(a,function(e){k.setHeight(j?300:g);
j=!j;
},this);
},getGrid:function(){return new qx.ui.control.DateChooser();
}}});
})();
...
(function(){var j="yellow",i="qx.legacy.ui.embed.Future",h="_applyContent",g="qx.ui.core.Widget",f="_root",e="hidden",d="div";
qx.Class.define(i,{extend:qx.legacy.ui.basic.Terminator,construct:function(){arguments.callee.base.call(this);
this.set({backgroundColor:j,overflow:e});
},properties:{content:{check:g,apply:h,init:null,nullable:true}},members:{_applyContent:function(m,n){if(this._root){if(n){this._root.remove(n);
}
if(m){this._root.add(m);
}}},_computePreferredInnerWidth:function(){var content=this.getContent();

if(content){return content.getSizeHint().width;
}else{return 100;
}},_computePreferredInnerHeight:function(){var content=this.getContent();

if(content){return content.getSizeHint().height;
}else{return 50;
}},_changeInnerWidth:function(k,l){arguments.callee.base.call(this,k,l);
this._setPaneWidth(this.getBoxWidth());
},_changeInnerHeight:function(o,p){arguments.callee.base.call(this,o,p);
this._setPaneHeight(this.getBoxHeight());
},_setPaneWidth:function(q){this._root.setWidth(q);
},_setPaneHeight:function(c){this._root.setHeight(c);
},_afterAppear:function(){var a=this.getElement();
var b=document.createElement(d);
a.appendChild(b);
this._root=new qx.ui.root.Inline(b);
this._root.setLayout(new qx.ui.layout.Canvas());
var content=this.getContent();

if(content){this._root.add(content,{top:0,right:0,bottom:0,left:0});
}this._setPaneWidth(this.getBoxWidth());
this._setPaneHeight(this.getBoxHeight());
}},destruct:function(){this._disposeObjects(f);
}});
...
(function(){var l="resize",k="div",j="qx.ui.root.Inline",i="$$widget",h="hidden",g="relative",f="__oQ";
qx.Class.define(j,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(a,b,c){this.__oQ=a;
a.style.overflow=h;
this.__oR=b||false;
this.__oS=c||false;
this.__oT();
...
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
},members:{__oR:false,__oS:false,__oQ:null,__oT:function(){if(this.__oR||this.__oS){qx.event.Registration.addListener(this.__oQ,l,this._onResize,this);
}},_createContainerElement:function(){var m=this.__oQ;

if(this.__oR||this.__oS){var o=document.createElement(k);
m.appendChild(o);
}else{o=m;
}var n=new qx.html.Root(o);
o.style.position=g;
n.setAttribute(i,this.toHashCode());
return n;
},_onResize:function(e){var d=e.getData();

if((d.oldWidth!==d.width)&&this.__oR||(d.oldHeight!==d.height)&&this.__oS){qx.ui.core.queue.Layout.add(this);
}},_computeSizeHint:function(){var t=this.__oR;
var q=this.__oS;
...
if(t){var s=u.getContentWidth(this.__oQ);
p.width=s;
p.minWidth=s;
p.maxWidth=s;
}
if(q){var r=u.getContentHeight(this.__oQ);
p.height=r;
p.minHeight=r;
p.maxHeight=r;
}return p;
}},defer:function(v,w){qx.ui.core.MLayoutHandling.remap(w);
},destruct:function(){qx.event.Registration.removeListener(this.__oQ,l,this._onResize,this);
...
(function(){var a="qx.legacy.ui.layout.HorizontalBoxLayout";
qx.Class.define(a,{extend:qx.legacy.ui.layout.BoxLayout});
})();
