...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.treevirtual.TreeVirtual_Events", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.treevirtual.TreeVirtual_Events-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
var z=new qx.ui.treevirtual.TreeVirtual(l);
z.setColumnWidth(0,400);
z.setAlwaysShowOpenCloseSymbol(true);
this.getRoot().add(z,{edge:30});
var E=z.getDataModel();
var B=E.addBranch(null,b,true);
var D;
E.addBranch(B,a,true);
D=E.addBranch(B,n,true);
E.addLeaf(D,v);
E.addLeaf(D,t);
E.addBranch(B,f,true);
E.addBranch(B,w,true);
var C=E.addBranch(null,c,true);
D=E.addBranch(C,d,false);

for(var i=1;i<3000;i++){E.addLeaf(D,m+i);
}E.addBranch(C,g,false);
E.addBranch(C,w,false);
E.addBranch(C,u,false);
E.addBranch(C,o,false);
E.setData();
var A=1;
z.addListener(r,function(e){alert('treeOpenWithContent ');
var x=e.getData();
E.addLeaf(x.nodeId,A.toString());
A++;
});
z.addListener(k,function(e){alert('treeClose ');
});
z.addListener(q,function(e){alert('treeOpenWhileEmpty');
var y=e.getData();
z.nodeSetHideOpenClose(y,true);
});
z.addListener(h,function(e){var F=j;
var G=e.getData();
