...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Tokenizer", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Tokenizer-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
var p=function(bM){return new RegExp(X+bM+ba);
};
var z=br;
var q=bt;
var j=U;
...
switch(bS.type){case bJ:bQ.add(bw,bP,Q);
break;
case bL:bQ.add(bk,bP,Q);
break;
case H:case bG:bQ.add(R,bP,Q);
break;
case I:case K:bQ.add(T,bP,Q);
break;
case bK:case bF:case N:bQ.add(bA,bS.type,bB,bP,Q);
break;
case O:var bO=qx.bom.client.Engine.MSHTML?bq:bx;
bQ.add(bO);
break;
case M:var bT=qx.bom.client.Engine.MSHTML?bd:bp;
bQ.add(bT);
break;
default:bQ.add(bP);
}}return bQ.get();
...
(function(){var q="mshtml",p="pop.push.reverse.shift.sort.splice.unshift.join.slice",o="number",n="qx.type.BaseArray",m="qx.client",k=".";
...
(function(){function x(H){if(qx.core.Variant.isSet(m,q)){w.prototype={length:0,$$isArray:true};
var K=p.split(k);

for(var length=K.length;length;){w.prototype[K[--length]]=Array.prototype[K[length]];
}}var L=Array.prototype.slice;
w.prototype.concat=function(){var B=this.slice(0);

for(var i=0,length=arguments.length;i<length;i++){var A;

if(arguments[i] instanceof w){A=L.call(arguments[i],0);
}else if(arguments[i] instanceof Array){A=arguments[i];
}else{A=[arguments[i]];
}B.push.apply(B,A);
}return B;
};
w.prototype.toString=function(){return L.call(this,0).toString();
};
w.prototype.toLocaleString=function(){return L.call(this,0).toLocaleString();
};
w.prototype.constructor=w;
var I=Array.prototype.filter;
var J=Array.prototype.map;
if(!Array.prototype.indexOf){w.prototype.indexOf=function(f,g){if(g==null){g=0;
...
if(!Array.prototype.lastIndexOf){w.prototype.lastIndexOf=function(h,j){if(j==null){j=this.length-1;
}else if(j<0){j=Math.max(0,this.length+j);
}
for(var i=j;i>=0;i--){if(this[i]===h){return i;
}}return -1;
...
if(!Array.prototype.forEach){w.prototype.forEach=function(F,G){var l=this.length;

for(var i=0;i<l;i++){F.call(G,this[i],i,this);
}};
}
if(!I){I=function(C,D){var l=this.length;
var E=[];
...
if(!J){J=function(a,b){var l=this.length;
var c=[];
...
if(!Array.prototype.some){w.prototype.some=function(d,e){var l=this.length;

for(var i=0;i<l;i++){if(d.call(e,this[i],i,this)){return true;
}}return false;
};
}
if(!Array.prototype.every){w.prototype.every=function(y,z){var l=this.length;

for(var i=0;i<l;i++){if(!y.call(z,this[i],i,this)){return false;
}}return true;
};
}w.prototype.filter=function(){var u=new this.constructor;
u.push.apply(u,I.apply(this,arguments));
return u;
};
w.prototype.map=function(){var r=new this.constructor;
r.push.apply(r,J.apply(this,arguments));
return r;
};
w.prototype.slice=function(){var t=new this.constructor;
t.push.apply(t,Array.prototype.slice.apply(this,arguments));
return t;
};
w.prototype.splice=function(){var s=new this.constructor;
s.push.apply(s,Array.prototype.splice.apply(this,arguments));
return s;
};
w.prototype.toArray=function(){return Array.prototype.slice.call(this,0);
};
w.prototype.valueOf=function(){return this.length;
};
return w;
}function w(length){if(arguments.length===1&&typeof length===o){this.length=-1<length&&length===length>>.5?length:this.push(length);
}else if(arguments.length){this.push.apply(this,arguments);
}}function v(){}v.prototype=[];
w.prototype=new v;
w.prototype.length=0;
qx.type.BaseArray=x(w);
})();
})();
