...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HBox_Flex", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.HBox_Flex-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var n="main",m="green",l="yellow",k="demobrowser.demo.layout.HBox_Flex";
...
o.add(this.getBox5());
o.add(this.getBox6());
},getBox1:function(){var r=new qx.ui.layout.HBox();
var s=new qx.ui.container.Composite(r).set({width:500,decorator:n,backgroundColor:l,allowGrowX:false});
r.setSpacing(5);
s.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}),{flex:1});
s.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}),{flex:2});
s.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}),{flex:3});
return s;
},getBox2:function(){var f=new qx.ui.layout.HBox();
var g=new qx.ui.container.Composite(f).set({width:500,decorator:n,backgroundColor:l,allowGrowX:false});
f.setSpacing(5);
g.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:30}),{flex:1});
g.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m}),{flex:2});
g.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:150}),{flex:3});
return g;
},getBox3:function(){var a=new qx.ui.layout.HBox();
var c=new qx.ui.container.Composite(a).set({width:500,decorator:n,backgroundColor:l,allowGrowX:false});
a.setSpacing(5);

for(var i=0;i<25;i++){var b=new qx.ui.core.Widget();
b.set({decorator:n,backgroundColor:m,width:5});
c.add(b,{flex:1});
}return c;
},getBox4:function(){var p=new qx.ui.layout.HBox();
var q=new qx.ui.container.Composite(p).set({width:600,minWidth:600,decorator:n,backgroundColor:l,allowGrowX:false});
p.setSpacing(5);
q.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:120}),{flex:1});
q.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:120}),{flex:2});
q.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,maxWidth:120}),{flex:3});
return q;
},getBox5:function(){var h=new qx.ui.layout.HBox();
var j=new qx.ui.container.Composite(h).set({width:300,minWidth:0,decorator:n,backgroundColor:l,allowGrowX:false});
h.setSpacing(5);
j.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,minWidth:120}),{flex:1});
j.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,minWidth:120}),{flex:2});
j.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,minWidth:120}),{flex:3});
return j;
},getBox6:function(){var d=new qx.ui.layout.HBox();
var e=new qx.ui.container.Composite(d).set({width:300,decorator:n,backgroundColor:l,allowGrowX:false});
d.setSpacing(5);
e.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,minWidth:120}),{flex:1});
e.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,minWidth:120}),{flex:2});
e.add(new qx.ui.core.Widget().set({decorator:n,backgroundColor:m,minWidth:120}),{flex:3});
return e;
}}});
})();
