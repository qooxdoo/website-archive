...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.HBox_Reversed-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var k="main",j="yellow",i="gray",h="blue",g="bottom",f="green",e="click to reverse",d="top",c="demobrowser.demo.layout.HBox_Reversed",b="middle",a="mousedown";
...
var n=(new qx.ui.container.Composite(l)).set({decorator:k,backgroundColor:j,height:80});
l.setReversed(true);
l.setSpacing(5);
var p=new qx.ui.core.Widget().set({decorator:k,backgroundColor:h,maxHeight:60,alignY:d});
var o=new qx.ui.basic.Label(e).set({decorator:k,rich:true,backgroundColor:f,maxHeight:60,alignY:b,allowGrowX:true,allowGrowY:true});
var m=new qx.ui.core.Widget().set({decorator:k,backgroundColor:i,maxHeight:60,alignY:g});
n.add(p);
n.add(o);
n.add(m);
n.addListener(a,function(e){l.setReversed(!l.getReversed());
});
