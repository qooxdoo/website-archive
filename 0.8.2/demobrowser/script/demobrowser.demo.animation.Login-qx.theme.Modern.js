...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Login", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.animation.Login-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var r="top",q="right",p="resize",o="Name",n="Password",m="Login",l="appear",k="demobrowser.demo.animation.Login",j="50%",h="execute",g="30%";
qx.Class.define(k,{extend:qx.application.Standalone,members:{checkInput:function(){this.__qq.start();
},__qp:function(){this.__qq=new qx.fx.effect.combination.Shake(this.__qr.getContainerElement().getDomElement());
},main:function(){arguments.callee.base.call(this);
var c=new qx.ui.layout.Grid(9,5);
c.setColumnAlign(0,q,r);
c.setColumnAlign(2,q,r);
this.__qr=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__qr.setLayout(c);
this.__qr.addListener(p,function(e){var a=this.__qr.getBounds();
this.__qr.set({marginTop:Math.round(-a.height/2),marginLeft:Math.round(-a.width/2)});
},this);
this.getRoot().add(this.__qr,{left:j,top:g});
var b=[o,n];

for(var i=0;i<b.length;i++){this.__qr.add(new qx.ui.basic.Label(b[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}var d=new qx.ui.form.TextField();
var e=new qx.ui.form.PasswordField();
this.__qr.add(d.set({allowShrinkX:false,paddingTop:3}),{row:0,column:1});
this.__qr.add(e.set({allowShrinkX:false,paddingTop:3}),{row:1,column:1});
var f=this.__qs=new qx.ui.form.Button(m);
f.setAllowStretchX(false);
this.__qr.add(f,{row:3,column:1});
f.addListener(h,this.checkInput,this);
this.__qr.addListener(l,this.__qp,this);
}}});
})();
