...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.progressive.ProgressiveTable_Html", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.progressive.ProgressiveTable_Html-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
z.addElements(y);
t.setDataModel(z);
var D=new qx.ui.progressive.renderer.table.Row(A);
t.addRenderer(m,D);
...
(function(){var h="progressive-table-header-cell",g="resize",f="__xl",e="qx.ui.progressive.headfoot.TableHeading",d="_layout",c="__xi",b="__xj",a="progressive-table-header";
qx.Class.define(e,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(k,l){arguments.callee.base.call(this);
this.__xi=k;
var n=k.getData();
this.__xj=[];
...
m.set({height:16,appearance:h,minWidth:0,width:0});
this.add(m,{flex:1});
this.addListener(g,this._resizeColumns,this);
this.__xk=new qx.ui.layout.HBox();
this.__xk.connectToWidget(this);
},properties:{appearance:{refine:true,init:a}},members:{__xi:null,__xl:null,__xj:null,__xk:null,join:function(j){arguments.callee.base.call(this,j);
},getLayoutChildren:function(){if(this.__xl){return this.__xi.getData();
}else{return arguments.callee.base.call(this);
}},_resizeColumns:function(e){var p=this.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
this.__xl=true;
this.__xk.renderLayout(p,100);
this.__xl=false;
var q=this.__xi.getData();
for(var i=0;i<q.length;i++){this.__xj[i].setWidth(q[i].getComputedWidth());
}}},destruct:function(){this._disposeFields(c,f,b);
...
(function(){var q=".qx-progressive-",p="-col-",o="px;",n="-row",m="}",l="width: ",k="0px ",j="qx-progressive-",h="__xL",g="__xJ",be="__xI",bd="px",bc="  font-size: 11px;",bb="padding: ",ba="px ",Y='',X="end",W="qx.client",V="div",U="  position: absolute;",x="  width : 100%;",y="__columnData",v="  border-bottom:1px solid #eeeeee;",w="",t="  top: 0px;",u="  overflow:hidden;",r=" {",s="__xH",A="  cursor:default;",B="  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;",I="-row {",G="resize",M="start",K="relative",Q="  -o-text-overflow: ellipsis;",O="mshtml",D="  border-right:1px solid #f2f2f2;",T="  white-space:nowrap;",S=';-moz-user-select:none;',R="  padding : 0px 6px 0px 6px;",C="__xP",E="qx.ui.progressive.renderer.table.Row",F="progressive-table-row-background-odd",H="  text-overflow:ellipsis;",J="__xG",L="  height: 100%;",N="__xK",P="progressive-table-row-background-even",z="left: ";
qx.Class.define(E,{extend:qx.ui.progressive.renderer.Abstract,construct:function(bi){arguments.callee.base.call(this);
this.__xG=bi;
this.__xH={};
this.__xI=new qx.ui.progressive.renderer.table.cell.Default();
this.__xJ=null;
this.__xK={};
var bj=qx.theme.manager.Color.getInstance();
this.__xK.bgcol=[];
this.__xK.bgcol[0]=bj.resolve(P);
this.__xK.bgcol[1]=bj.resolve(F);
this.__xL=new qx.ui.layout.HBox();
this.__xL.connectToWidget(this);
},statics:{__xM:null,__xN:6,__xO:U+t+L+u+H+Q+T+D+v+R+A+bc+B+(qx.core.Variant.isSet(W,O)?Y:S)},properties:{defaultRowHeight:{init:16}},members:{__xJ:null,__xP:null,__xQ:null,__xG:null,__xH:null,__xI:null,__xK:null,__xL:null,join:function(a,name){if(this.__xJ){throw new Error("Renderer is already joined to a Progressive.");
}this.__xJ=a;
this.__xP=name;
...
if(!c.__xM[b]){c.__xM[b]={rowstylesheet:null,cellstylesheet:[]};
var d=q+b+I+x+m;
c.__xM[b].rowstylesheet=qx.bom.Stylesheet.createElement(d);
var e=this.__xG.getData();

for(var i=0;i<e.length;i++){var d=q+b+p+i+r+c.__xO+m;
c.__xM[b].cellstylesheet[i]=qx.bom.Stylesheet.createElement(d);
}this.__xQ=b;
var f=a.getStructure().getPane();
f.addListener(G,this._resizeColumns,this);
}},addRenderer:function(bf,bg){var bh=this.__xG.getData();

if(bf<0||bf>=bh.length){throw new Error("Column "+bf+" out of range (max: "+(bh.length-1)+")");
}this.__xH[bf]=bg;
},removeRenderer:function(bC){var bD=this.__xG.getData();

if(bC<0||bC>=bD.length){throw new Error("Column "+bC+" out of range (max: "+(bD.length-1)+")");
}
if(!this.__xH[bC]){throw new Error("No existing renderer for column "+bC);
}delete this.__xH[bC];
...
var br;
var bo=0;
if(bk.getRendererData()[this.__xP].end===undefined){bk.getRendererData()[this.__xP]={end:0,start:1,rows:0,totalHeight:0};
}var bu=document.createElement(V);
for(var i=0;i<bv.length;i++){var bp=j+this.__xQ+p+i;
br=this.__xH[i]||this.__xI;
...
var bt=bk.getRendererData()[this.__xP];
bt.totalHeight+=bo;
bu.style.position=K;
bu.style.height=bo+bd;
bu.className=j+this.__xQ+n;
bu.innerHTML=bq.join(w);
switch(bl.location){case X:var bm=bt.end||0;
bu.style.backgroundColor=this.__xK.bgcol[bm];
bt.end=(bm==0?1:0);
bk.getPane().getContentElement().getDomElement().appendChild(bu);
break;
case M:var bn=bk.getPane().getContentElement().getDomElement();
...
},getLayoutChildren:function(){return this.__xG.getData();
},_resizeColumns:function(e){var bL=this.__xJ.getStructure().getPane();
var bI=bL.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();
var bJ=q+this.__xQ+n;
var bF=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bF.__xM[this.__xQ].rowstylesheet,bJ);
var bH=l+bI+o;
qx.bom.Stylesheet.addRule(bF.__xM[this.__xQ].rowstylesheet,bJ,bH);
this.__xL.renderLayout(bI,100);
var bK=this.__xG.getData();
for(var i=0,bO=0;i<bK.length;i++,bO+=bI){var bJ=q+this.__xQ+p+i;
var bF=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bF.__xM[this.__xQ].cellstylesheet[i],bJ);
bI=bK[i].getComputedWidth();
{};
var bG;

if(qx.bom.client.Feature.CONTENT_BOX){bG=qx.ui.progressive.renderer.table.Row.__xN*2;
}else{bG=-1;
}var bN=(bI-bG)+o;
var bM=k+qx.ui.progressive.renderer.table.Row.__xN+ba+k+qx.ui.progressive.renderer.table.Row.__xN+o;
var bE=bO+o;
var bH=bF.__xO+l+bN+z+bE+bb+bM;
qx.bom.Stylesheet.addRule(bF.__xM[this.__xQ].cellstylesheet[i],bJ,bH);
}}},destruct:function(){var name;

for(name in this.__xH){this.__xH[name]=null;
}var by=qx.ui.progressive.renderer.table.Row;
var bx=this.__xJ.toHashCode();

if(by.__xM&&by.__xM[bx]){if(by.__xM[bx].rowstylesheet){var bA=q+this.__xQ+n;
var by=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(by.__xM[this.__xQ].rowstylesheet,bA);
}if(by.__xM[bx].cellstylesheet){for(var i=by.__xM[bx].cellstylesheet.length-1;i>=0;i--){var bA=q+this.__xQ+p+i;
var bz=by.__xM[this.__xQ].cellstylesheet[i];
var by=qx.ui.progressive.renderer.table.Row;
qx.bom.Stylesheet.removeRule(bz,bA);
}}}
if(this.__xJ&&this.__xJ.getRendererData){var bB=this.__xJ.getRendererData();

if(bB&&bB[this.__xP]&&bB[this.__xP].end!==undefined){bB[this.__xP]=null;
}}this._disposeFields(C,N,s,g,J);
this._disposeObjects(h,be,y);
}});
})();
...
},_getContentHtml:function(m){return m.cellData||k;
