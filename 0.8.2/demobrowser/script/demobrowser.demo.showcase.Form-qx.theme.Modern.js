...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.showcase.Form-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var k="Button",j="CheckBox:",h="TextArea:",g="RepeatButton:",f="TextArea",e="execute",d="Website 2",c="ToggleButton",b="RadioButton 1",a="RadioGroup:",K="Button:",J="ComboBox:",I="ToggleButton:",H="Options",G="MenuButton:",F="demobrowser.demo.showcase.Form",E="PasswordField:",D="SplitButton",C="",B="List:",r="TextField",s="SplitButton:",p="PasswordField",q="0",n="Spinner:",o="DateField:",l="RadioButton 2",m="Option",t="Website 1",u="CheckBox",w="SelectBox:",v="Website 3",y="ListItem ",x="MenuButton",A="Slider:",z="TextField:";
qx.Class.define(F,{extend:qx.application.Standalone,statics:{ITEM_SIZE:5},members:{main:function(){arguments.callee.base.call(this);
var U=new qx.ui.container.Composite(new qx.ui.layout.Grid(8,8));
this.getRoot().add(U,{top:20,left:20});
var bj=new qx.ui.form.TextField(r);
U.add(new qx.ui.basic.Label(z),{row:0,column:0});
U.add(bj,{row:0,column:1});
var bk=new qx.ui.form.PasswordField(p);
U.add(new qx.ui.basic.Label(E),{row:1,column:0});
U.add(bk,{row:1,column:1});
var bc=new qx.ui.form.Spinner(0,50,100);
U.add(new qx.ui.basic.Label(n),{row:2,column:0});
U.add(bc,{row:2,column:1});
var R=new qx.ui.form.DateField();
R.setDate(new Date());
U.add(new qx.ui.basic.Label(o),{row:3,column:0});
U.add(R,{row:3,column:1});
var X=new qx.ui.form.ComboBox();
U.add(new qx.ui.basic.Label(J),{row:4,column:0});
U.add(X,{row:4,column:1});
this.createItems(X);
var S=new qx.ui.form.SelectBox();
U.add(new qx.ui.basic.Label(w),{row:5,column:0});
U.add(S,{row:5,column:1});
this.createItems(S);
var T=new qx.ui.form.CheckBox(u);
U.add(new qx.ui.basic.Label(j),{row:6,column:0});
U.add(T,{row:6,column:1});
var bg=new qx.ui.form.RadioButton(b);
var bf=new qx.ui.form.RadioButton(l);
var be=new qx.ui.form.RadioGroup(bg,bf);
U.add(new qx.ui.basic.Label(a),{row:7,column:0});
U.add(bg,{row:7,column:1});
U.add(bf,{row:8,column:1});
var V=new qx.ui.form.TextArea(f);
U.add(new qx.ui.basic.Label(h),{row:9,column:0});
U.add(V,{row:9,column:1});
var bb=new qx.ui.form.List();
U.add(new qx.ui.basic.Label(B),{row:10,column:0});
U.add(bb,{row:10,column:1});
this.createItems(bb);
bb.setHeight(60);
var bd=new qx.ui.form.Slider();
U.add(new qx.ui.basic.Label(A),{row:11,column:0});
U.add(bd,{row:11,column:1});
var Y=new qx.ui.form.Button(k);
U.add(new qx.ui.basic.Label(K),{row:12,column:0});
U.add(Y,{row:12,column:1});
var bi=new qx.ui.form.ToggleButton(c);
U.add(new qx.ui.basic.Label(I),{row:13,column:0});
U.add(bi,{row:13,column:1});
var bh=new qx.ui.form.RepeatButton(q);
U.add(new qx.ui.basic.Label(g),{row:14,column:0});
U.add(bh,{row:14,column:1});
var ba=new qx.ui.form.MenuButton(x,null,this.createMenuForMenuButton());
U.add(new qx.ui.basic.Label(G),{row:15,column:0});
U.add(ba,{row:15,column:1});
var W=new qx.ui.form.SplitButton(D,null,this.createMenuForSplitButton());
U.add(new qx.ui.basic.Label(s),{row:16,column:0});
U.add(W,{row:16,column:1});
bh.addListener(e,function(){var L=parseInt(bh.getLabel())+1;
bh.setLabel(L.toString());
});
},createItems:function(bl){for(var i=0;i<arguments.callee.self.ITEM_SIZE;i++){var bm=new qx.ui.form.ListItem(y+i);
bl.add(bm);
}},createMenuForMenuButton:function(){var M=new qx.ui.menu.Menu;

for(var i=0;i<3;i++){M.add(new qx.ui.menu.RadioButton(m+i));
}var P=new qx.ui.form.RadioGroup;
P.add.apply(P,M.getChildren());
var O=new qx.ui.menu.Menu();

for(var i=0;i<3;i++){var Q=new qx.ui.menu.Button(k+i);
O.add(Q);
}var N=new qx.ui.menu.Button(H,C,null,M);
O.addSeparator();
O.add(N);
return O;
},createMenuForSplitButton:function(){var bn=new qx.ui.menu.Menu;
var bq=new qx.ui.menu.Button(t);
var bo=new qx.ui.menu.Button(d);
var bp=new qx.ui.menu.Button(v);
bn.add(bq);
bn.add(bo);
bn.add(bp);
return bn;
...
(function(){var o="button",n="hovered",m="String",l="pressed",k="arrow",j="Enter",i="Space",h="abandoned",g="both",f="changeVisibility",G="splitbutton",F="changeShow",E="mouseout",D="changeValue",C="keydown",B="execute",A="_applyMenu",z="icon",y="mouseover",x="keyup",v="qx.ui.menu.Menu",w="_applyIcon",t="changeName",u="label",r="_applyShow",s="changeMenu",p="_applyLabel",q="qx.ui.form.SplitButton";
qx.Class.define(q,{extend:qx.ui.core.Widget,include:qx.ui.core.MExecutable,implement:qx.ui.form.IFormElement,construct:function(H,I,J,K){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.HBox);
this._createChildControl(k);
this.addListener(y,this._onMouseOver,this,true);
this.addListener(E,this._onMouseOut,this,true);
this.addListener(C,this._onKeyDown);
this.addListener(x,this._onKeyUp);
...
}},properties:{appearance:{refine:true,init:G},name:{check:m,nullable:true,event:t},value:{check:m,nullable:true,event:D},focusable:{refine:true,init:true},label:{apply:p,nullable:true,dispose:true,check:m},icon:{check:m,apply:w,nullable:true,themeable:true},show:{init:g,check:[g,u,z],themeable:true,inheritable:true,apply:r,event:F},menu:{check:v,nullable:true,apply:A,event:s}},members:{__mO:null,_createChildControlImpl:function(W){var X;

switch(W){case o:X=new qx.ui.form.Button;
X.addListener(B,this._onButtonExecute,this);
X.setFocusable(false);
this._addAt(X,0,{flex:1});
break;
case k:X=new qx.ui.form.MenuButton;
X.setFocusable(false);
this._addAt(X,1);
break;
...
},_applyIcon:function(T,U){var V=this.getChildControl(o);
T==null?V.resetIcon():V.setIcon(T);
},_applyMenu:function(M,N){var O=this.getChildControl(k);
...
N.resetOpener();
}},_applyShow:function(P,Q){},_onMouseOver:function(e){e.stopPropagation();
this.addState(n);
delete this.__mO;
...
if(R&&R.isVisible()){this.__mO=true;
return;
}this.removeState(n);
},_onKeyDown:function(e){var L=this.getChildControl(o);

switch(e.getKeyIdentifier()){case j:case i:L.removeState(h);
L.addState(l);
}},_onKeyUp:function(e){var d=this.getChildControl(o);

switch(e.getKeyIdentifier()){case j:case i:if(d.hasState(l)){d.removeState(h);
d.removeState(l);
d.execute();
}}},_onButtonExecute:function(e){this.execute();
},_onChangeMenuVisibility:function(e){if(!this.getMenu().isVisible()&&this.__mO){this.removeState(n);
}}}});
})();
