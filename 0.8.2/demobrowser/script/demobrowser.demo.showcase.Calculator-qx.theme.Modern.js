...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.showcase.Calculator", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.showcase.Calculator-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var k="execute",j="-",i="+",h="n",g="/",f="*",e="=",d="sans-serif",c="Verdana",b=".",G="black",F="Del",E="C",D="5",C="7",B="demobrowser.demo.showcase.Calculator",A="CE",z="solid",y="icon/22/apps/utilities-calculator.png",x="3",r="0",s="8",p="6",q="4",n="Calculator",o="right",l="2",m="1",t="demobrowser.demo.showcase.CalculatorLogic",u="white",w="+/-",v="9";
qx.Class.define(B,{extend:qx.application.Standalone,members:{__mP:null,__mQ:null,main:function(){arguments.callee.base.call(this);
{};
this.__mQ=new demobrowser.demo.showcase.CalculatorLogic();
this.createCalculator();
},createCalculator:function(){var P=new qx.ui.window.Window(n,y);
P.setLayout(new qx.ui.layout.VBox(16));
var R=new qx.ui.decoration.Single(1,z,G);
var ba=new qx.ui.container.Composite().set({minWidth:180,minHeight:280,padding:3,allowGrowX:true,allowGrowY:true});
var bk=new qx.ui.layout.Grid(5,5);
ba.setLayout(bk);
this.__mP=new qx.ui.basic.Label(this.__mQ.getCurrentValue().toString()).set({decorator:R,backgroundColor:u,allowGrowX:true,allowGrowY:true,minWidth:160,height:50,font:new qx.bom.Font().set({size:22,family:[c,d],bold:true}),textAlign:o});
this.__mP.setEnabled(false);
var bl=new qx.bom.Font().set({size:14,family:[c,d],bold:true});
var bf=new qx.ui.form.Button(r).set({font:bl,minWidth:40});
var be=new qx.ui.form.Button(m).set({font:bl,minWidth:40});
var bd=new qx.ui.form.Button(l).set({font:bl,minWidth:40});
var bc=new qx.ui.form.Button(x).set({font:bl,minWidth:40});
var bj=new qx.ui.form.Button(q).set({font:bl,minWidth:40});
var bi=new qx.ui.form.Button(D).set({font:bl,minWidth:40});
var bh=new qx.ui.form.Button(p).set({font:bl,minWidth:40});
var bg=new qx.ui.form.Button(C).set({font:bl,minWidth:40});
var bn=new qx.ui.form.Button(s).set({font:bl,minWidth:40});
var bm=new qx.ui.form.Button(v).set({font:bl,minWidth:40});
var O=new qx.ui.form.Button(E).set({font:bl,minWidth:40});
var Q=new qx.ui.form.Button(A).set({font:bl,minWidth:40});
var V=new qx.ui.form.Button(F).set({font:bl,minWidth:40});
var U=new qx.ui.form.Button(w).set({font:bl,minWidth:40});
var X=new qx.ui.form.Button(b).set({font:bl,minWidth:40});
var T=new qx.ui.form.Button(i).set({font:bl,minWidth:40});
var bb=new qx.ui.form.Button(j).set({font:bl,minWidth:40});
var Y=new qx.ui.form.Button(f).set({font:bl,minWidth:40});
var W=new qx.ui.form.Button(g).set({font:bl,minWidth:40});
var S=new qx.ui.form.Button(e).set({font:bl,minWidth:40});
bk.setColumnFlex(0,1);
bk.setColumnFlex(1,1);
bk.setColumnFlex(2,1);
bk.setColumnFlex(3,1);
bk.setRowFlex(1,1);
bk.setRowFlex(2,1);
bk.setRowFlex(3,1);
bk.setRowFlex(4,1);
bk.setRowFlex(5,1);
bk.setRowFlex(6,1);
ba.add(this.__mP,{row:0,column:0,rowSpan:0,colSpan:4});
ba.add(O,{row:1,column:2,rowSpan:1,colSpan:2});
ba.add(Q,{row:1,column:1});
ba.add(V,{row:1,column:0});
ba.add(bg,{row:2,column:0});
ba.add(bn,{row:2,column:1});
ba.add(bm,{row:2,column:2});
ba.add(W,{row:2,column:3});
ba.add(bj,{row:3,column:0});
ba.add(bi,{row:3,column:1});
ba.add(bh,{row:3,column:2});
ba.add(Y,{row:3,column:3});
ba.add(be,{row:4,column:0});
ba.add(bd,{row:4,column:1});
ba.add(bc,{row:4,column:2});
ba.add(bb,{row:4,column:3});
ba.add(bf,{row:5,column:0});
ba.add(U,{row:5,column:1});
ba.add(X,{row:5,column:2});
ba.add(T,{row:5,column:3});
ba.add(S,{row:6,column:0,rowSpan:1,colSpan:4});
P.setWidth(260);
P.setMinWidth(260);
P.setHeight(260);
P.open();
this.getRoot().add(P,{left:20,top:20});
P.add(ba,{flex:1});
O.addListener(k,function(e){this.__mQ.cleanDisplay();
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
Q.addListener(k,function(e){this.__mQ.clearEntry();

if(this.__mQ.getResult()!=null){this.__mP.setContent(this.__mQ.getCurrentValue().toString());
}},this);
V.addListener(k,function(e){this.__mQ.deleteNumber();
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
U.addListener(k,function(e){this.__mQ.setSign();

if(this.__mQ.getResult()!=null){this.__mP.setContent(this.__mQ.getResult().toString());
}},this);
bf.addListener(k,function(e){this.__mQ.setCurrentValue(0);
this.__mP.setContent(this.__mQ.getCurrentValue().toFixed(this.__mQ.getZeroCounter()).toString());
},this);
be.addListener(k,function(e){this.__mQ.setCurrentValue(1);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bd.addListener(k,function(e){this.__mQ.setCurrentValue(2);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bc.addListener(k,function(e){this.__mQ.setCurrentValue(3);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bj.addListener(k,function(e){this.__mQ.setCurrentValue(4);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bi.addListener(k,function(e){this.__mQ.setCurrentValue(5);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bh.addListener(k,function(e){this.__mQ.setCurrentValue(6);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bg.addListener(k,function(e){this.__mQ.setCurrentValue(7);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bn.addListener(k,function(e){this.__mQ.setCurrentValue(8);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
bm.addListener(k,function(e){this.__mQ.setCurrentValue(9);
this.__mP.setContent(this.__mQ.getCurrentValue().toString());
},this);
T.addListener(k,function(e){this.__mQ.calculate(i);

if(this.__mQ.getResult()!=null){this.__mP.setContent(this.__mQ.getResult().toString());
}this.__mQ.resetCurrentValue();
},this);
bb.addListener(k,function(e){this.__mQ.calculate(j);

if(this.__mQ.getResult()!=null){this.__mP.setContent(this.__mQ.getResult().toString());
}this.__mQ.resetCurrentValue();
},this);
Y.addListener(k,function(e){this.__mQ.calculate(f);

if(this.__mQ.getResult()!=null){this.__mP.setContent(this.__mQ.getResult().toString());
}this.__mQ.resetCurrentValue();
},this);
W.addListener(k,function(e){this.__mQ.calculate(g);

if(this.__mQ.getResult()!=null){this.__mP.setContent(this.__mQ.getResult().toString());
}this.__mQ.resetCurrentValue();
},this);
S.addListener(k,function(e){this.__mQ.calculate(e);

if(this.__mQ.getResult()!=null){this.__mP.setContent(this.__mQ.getResult().toString());
}this.__mQ.resetCurrentValue();
},this);
X.addListener(k,function(e){this.__mQ.setComma();
},this);
}}});
qx.Class.define(t,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
},members:{__mR:0,__mS:0,__mT:h,__mU:0,__mV:0,__mW:0,__mX:false,__mY:1,__na:0,__nb:false,__nc:0,setCurrentValue:function(a){if(this.__mX){this.__mY*=10;
this.__mR=this.__mR+(a/this.__mY);

if(a==0){this.__na++;
}}else{this.__mX=false;

if(this.__mR<0){this.__mR=this.__mR*10-a;
}else{this.__mR=this.__mR*10+a;
}}},getZeroCounter:function(){return this.__na;
},setComma:function(){this.__mX=true;
},getCurrentValue:function(){return this.__mR;
},resetCurrentValue:function(){this.__mR=null;
},cleanDisplay:function(){this.__nc=0;
this.__mV=0;
this.__mT=h;
this.__na=0;
this.__mY=1;
...
this.__mS=0;
this.__nb=false;
},setResult:function(N){this.__mS=N;
},getResult:function(){return Math.round(this.__mS*10000000)/10000000;
},setCurrentOperation:function(H){this.__mT=H;
},getCurrentOperation:function(){return this.__mT;
},clearEntry:function(){this.__nb=false;
this.__na=0;
this.__mY=1;
this.__mX=false;
this.__mW++;
...
if(this.__mW<2){this.__mV=this.__mS;
}
if(this.__mU>=2){this.__mS=0;
this.__mU=0;
}},setSign:function(){this.__nc++;

if(this.__nc%2==0){this.__nb=false;
}else{this.__nb=true;
}
if(this.__mR==null){this.__mR=this.__mS;
}this.__mR=this.__mR*(-1);

if(this.__mS==0){this.__mS=this.__mR;
}
if(this.__mS!=0){this.__mV=this.__mS;
this.__mS=this.__mR;
}},deleteNumber:function(){var I=false;
var L=false;

if(this.__mR<0){this.__mR=this.__mR*(-1);
L=true;
}
if(this.__mR!=null){if(this.__mR.toString().lastIndexOf(b)!=-1){this.__mR=this.__mR*this.__mY;
I=true;
}}var J=this.__mR%10;
var K=J/10;
this.__mR=this.__mR/10;
this.__mR=this.__mR-K;

if(I){this.__mY/=10;
this.__mR=this.__mR/(this.__mY);
I=false;
}
if(L){this.__mR=this.__mR*(-1);
L=false;
}},calculate:function(M){if(M==i||M==f||M==g||M==j||M==e){this.__mX=false;
this.__mY=1;
this.__na=0;

if(this.__mT!=h){if(this.__mT==i){if(this.__mS==null){this.__mS=this.__mV;
}
if(this.__nb){this.__mS=this.__mV+this.__mR;
}else{this.__mS=this.__mS+this.__mR;
}this.__mR=this.__mS;
this.__mV=this.__mS;
}
if(this.__mT==j){if(this.__mS==0){this.__mS=this.__mR;
this.__mR=0;
}
if(this.__mS==null){this.__mS=this.__mV;
}
if(this.__nb){this.__mS=this.__mV-this.__mR;
}else{this.__mS=this.__mS-this.__mR;
}this.__mR=this.__mS;
...
if(this.__mT==g){if(this.__mS==0){this.__mS=this.__mR;
this.__mR=1;
}
if(this.__mS==null){this.__mS=this.__mV;
}
if(this.__mR!=null){if(this.__mR!=0){if(this.__nb){this.__mS=this.__mV/this.__mR;
}else{this.__mS=this.__mS/this.__mR;
}}else{alert("You can't divide by 0!");
}}this.__mR=this.__mS;
this.__mV=this.__mS;
}
if(this.__mT==f){if(this.__mS==0){this.__mS=1;
}
if(this.__mR==null){this.__mR=1;
}
if(this.__mS==null){this.__mS=this.__mV;
}
if(this.__nb){this.__mS=this.__mV*this.__mR;
