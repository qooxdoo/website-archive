...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Canvas", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Canvas-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
var u=t.context;
u.fillStyle=b;
u.fillRect(20,20,105,100);
u.fillStyle=c;
u.fillRect(70,70,105,100);
}}});
})();
...
(function(){var n="Integer",m="resize",l="_applyCanvasWidth",k="redraw",j="Boolean",i="__oW",h="_applyCanvasHeight",g="qx.ui.embed.Canvas",f="qx.event.type.Data";
qx.Class.define(g,{extend:qx.ui.core.Widget,construct:function(a,b){arguments.callee.base.call(this);
this.__oW=new qx.util.DeferredCall(this.__oX,this);
this.addListener(m,this._onResize,this);

if(a!==undefined){this.setCanvasWidth(a);
}
if(b!==undefined){this.setCanvasHeight(b);
}},events:{"redraw":f},properties:{syncDimension:{check:j,init:false},canvasWidth:{check:n,init:300,apply:l},canvasHeight:{check:n,init:150,apply:h}},members:{__oW:null,_createContentElement:function(){return new qx.html.Canvas();
},__oX:function(){var u=this.getContentElement();
var w=u.getHeight();
var t=u.getWidth();
var v=u.getContext2d();
this._draw(t,w,v);
this.fireNonBubblingEvent(k,qx.event.type.Data,[{width:t,height:w,context:v}]);
},_applyCanvasWidth:function(c,d){this.getContentElement().setWidth(c);
this.__oW.schedule();
},_applyCanvasHeight:function(o,p){this.getContentElement().setHeight(o);
this.__oW.schedule();
},update:function(){this.__oW.schedule();
},_onResize:function(e){var x=e.getData();

if(this.getSyncDimension()){this.setCanvasHeight(x.height);
this.setCanvasWidth(x.width);
}},getContext2d:function(){return this.getContentElement().getContext2d();
},_draw:function(q,r,s){}},destruct:function(){this._disposeObjects(i);
}});
})();
(function(){var d="canvas",c="__oY",b="2d",a="qx.html.Canvas";
qx.Class.define(a,{extend:qx.html.Element,construct:function(){arguments.callee.base.call(this,d);
this.__oY=document.createElement(d);
},members:{__oY:null,_createDomElement:function(){return this.__oY;
},getCanvas:function(){return this.__oY;
},setWidth:function(e){this.__oY.width=e;
},getWidth:function(){return this.__oY.width;
},setHeight:function(f){this.__oY.height=f;
},getHeight:function(){return this.__oY.height;
},getContext2d:function(){return this.__oY.getContext(b);
