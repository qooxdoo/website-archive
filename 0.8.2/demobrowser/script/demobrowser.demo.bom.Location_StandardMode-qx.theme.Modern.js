...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Location_StandardMode", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Location_StandardMode-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var o="px",n="moveable",m="borderBottomWidth",k="list",j='#',h="mode",g="borderTopWidth",f="borderLeftWidth",e="a",d="div",b="borderRightWidth",c="demobrowser.demo.bom.Location_StandardMode";
qx.Class.define(c,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var p=document.getElementById(k).getElementsByTagName(e);

for(var i=0,l=p.length;i<l;i++){p[i].onclick=demobrowser.demo.bom.Location_StandardMode.jump;
}}},statics:{jump:function(event){if(!event){event=window.event;
}event.returnValue=false;

if(event.preventDefault){event.preventDefault();
}function s(q,r){return parseInt(qx.bom.element.Style.get(q,r,qx.bom.element.Style.COMPUTED_MODE,false),10);
}var v=this.href;
var x=v.substr(v.indexOf(j)+1);
var t=document.getElementById(x);
var location=qx.bom.element.Location.get(t,document.getElementById(h).value);
var w=document.getElementById(n);
w.style.left=location.left+o;
w.style.top=location.top+o;

if(qx.bom.client.Feature.BORDER_BOX){w.style.width=(location.right-location.left)+o;
w.style.height=(location.bottom-location.top)+o;
}else{var u=qx.bom.element.Location;
w.style.width=(location.right-location.left-s(w,f)-s(w,b))+o;
w.style.height=(location.bottom-location.top-s(w,g)-s(w,m))+o;
}return false;
},randomize:function(){var a=document.body.getElementsByTagName(d);

for(var i=0,l=a.length;i<l;i++){if(a[i].id&&a[i].id!=n){a[i].style.margin=Math.round(Math.random()*10)+o;
a[i].style.padding=Math.round(Math.random()*10)+o;
a[i].style.borderWidth=Math.round(Math.random()*10)+o;
}}}}});
})();
