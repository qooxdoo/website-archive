...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Image-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var k="http://resources.qooxdoo.org/images/logo.gif",j="icon/32/actions/format-justify-left.png",i="Toggle enabled",h="icon/32/actions/go-home.png",g="changeChecked",f="demobrowser/demo/icons/multimedia-player.png",d="icon/32/actions/format-justify-right.png",c="icon/32/actions/format-justify-fill.png",b="demobrowser.demo.widget.Image",a="icon/32/actions/format-justify-center.png";
