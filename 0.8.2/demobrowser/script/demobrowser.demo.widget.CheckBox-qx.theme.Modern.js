...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.CheckBox", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.CheckBox-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var k="",j=", ",h="demobrowser.demo.widget.CheckBox",g="Bathing togs",f="OK",e="Towel",d="Sun Oil",c="Beer",b="What do you need for the beach?",a="execute";
qx.Class.define(h,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var p=new qx.ui.basic.Label(b);
...
m.add(p);
var l=new qx.ui.form.CheckBox(d);
var s=new qx.ui.form.CheckBox(e);
var q=new qx.ui.form.CheckBox(c);
var r=new qx.ui.form.CheckBox(g);
this._checkBoxes=[l,s,q,r];
m.add(l);
m.add(s);
m.add(q);
m.add(r);
var o=new qx.ui.form.Button(f);
o.addListener(a,this._onExecute,this);
o.setAllowGrowX(false);
m.add(o);
},_onExecute:function(e){var u=this._checkBoxes;
var t=0;
var v=k;

for(var i=0;i<u.length;i++){if(u[i].getChecked()){t++;
v+=(u[i].getLabel()+j);
}}
if(t>0){v=v.substring(0,v.length-2);
alert("You need these things for the beach: "+v);
