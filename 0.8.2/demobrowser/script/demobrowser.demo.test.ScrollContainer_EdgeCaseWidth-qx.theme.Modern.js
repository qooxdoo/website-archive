...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.ScrollContainer_EdgeCaseWidth", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.ScrollContainer_EdgeCaseWidth-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var z="changeValue",y="execute",x="ScrollbarX:",w="ScrollbarY:",v="Toggle content",u="blue",t="black",s="Off",r="auto",q="white",k="demobrowser.demo.test.ScrollContainer_EdgeCaseWidth",p="off",n="On",j="Content size: 300x300",i="Toggle pane",m="solid",l="Auto",o="on";
...
var F=true;
D.addListener(y,function(){scrollContainer.setHeight(F?300:200);
F=!F;
});
this.getRoot().add(D,{left:330,top:20});
var C=new qx.ui.form.Button(v);
var E=true;
C.addListener(y,function(){scrollContainer.getChild().setHeight(E?100:300);
E=!E;
});
this.getRoot().add(C,{left:430,top:20});
var B=this.generateScrollbarConfig(x,100);
var A=this.generateScrollbarConfig(w,120);
B.addListener(z,function(e){scrollContainer.setScrollbarX(e.getData());
});
A.addListener(z,function(e){scrollContainer.setScrollbarY(e.getData());
});
},generateScrollbarConfig:function(b,top){var g=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));
var b=new qx.ui.basic.Label(b);
b.setMarginRight(20);
var c=new qx.ui.form.RadioButton(l);
var f=new qx.ui.form.RadioButton(n);
var d=new qx.ui.form.RadioButton(s);
c.setValue(r);
f.setValue(o);
d.setValue(p);
c.setChecked(true);
var h=new qx.ui.form.RadioGroup(c,f,d);
g.add(b);
g.add(c);
g.add(f);
g.add(d);
...
return h;
},generateBox:function(){var a=new qx.ui.basic.Label(j).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:u,textColor:q,padding:10,decorator:new qx.ui.decoration.Single(4,m,t)});
return a;
}}});
})();
