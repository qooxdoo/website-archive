...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Slider-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var r="left",q="bottom",p="center",o="vertical",n="Max: ",m="changeValue",l="horizontal",k="top",j="middle",h="demobrowser.demo.widget.Slider",f="Min: ",g="right";
...
},_createVerticalLayout:function(){var t=[];
t.push(this._createSliderGroup(new qx.ui.form.Slider().set({maximum:1000,value:100})));
t.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-100,maximum:100,singleStep:5,pageStep:20,value:0})));
t.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:-600,maximum:-200,singleStep:10,pageStep:50,value:-300})));
t.push(this._createSliderGroup(new qx.ui.form.Slider().set({minimum:25,maximum:75,singleStep:5,pageStep:10,value:25})));
var u=new qx.ui.layout.Grid();
var s=new qx.ui.container.Composite(u);
s.setPadding(20);
s.setWidth(530);
s.setHeight(300);
u.setSpacing(5);
...
v.slider.setOrientation(o);
s.add(v.slider,{row:0,column:w,rowSpan:3,colSpan:1});
s.add(v.min,{row:0,column:w+1});
s.add(v.value,{row:1,column:w+1});
s.add(v.max,{row:2,column:w+1});
u.setColumnMinWidth(w+1,80);
u.setColumnWidth(w+2,20);
w+=3;
}return s;
...
c.setColumnFlex(1,1);
c.setColumnFlex(2,1);
c.setColumnAlign(0,r,q);
c.setColumnAlign(1,p,q);
c.setColumnAlign(2,g,q);
var e=0;

for(var i=0;i<b.length;i++){var d=b[i];
d.slider.setOrientation(l);
d.value.setWidth(100);
d.value.setTextAlign(p);
a.add(d.min,{row:e,column:0});
a.add(d.value,{row:e,column:1});
a.add(d.max,{row:e,column:2});
a.add(d.slider,{row:e+1,column:0,colSpan:3,rowSpan:1});
c.setRowHeight(e+2,20);
e+=3;
}return a;
},_createSliderGroup:function(x){var y={slider:x,min:new qx.ui.basic.Label(f+x.getMinimum().toString()),max:new qx.ui.basic.Label(n+x.getMaximum().toString()),value:new qx.ui.basic.Label(x.getValue().toString())};
x.addListener(m,function(e){y.value.setContent(x.getValue().toString());
});
return y;
}}});
})();
