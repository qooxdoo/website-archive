...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.TabView", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.TabView-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var G="Page #",F="execute",E="icon/32/apps/utilities-terminal.png",D="icon/16/apps/utilities-terminal.png",C="icon/16/apps/utilities-calculator.png",B="demobrowser.demo.widget.TabView",A="changeValue",z="bottom",y="Notes",x="Remove first page",V="Layout",U="icon/16/apps/utilities-help.png",T="Add new page",S="Calculator...",R="icon/16/apps/utilities-notes.png",Q="Bar Position",P="top",O="Calculator",N="right",M="Help",K="Help...",L="Notes...",I="Layout-Settings",J="Remove last page",H="left";
...
v.setPadding(20);
v.setAllowStretchX(false);
w.add(v);
this.getRoot().add(w,{edge:0});
v.add(this.getTabView1());
v.add(this.getTabView2());
v.add(this.getTabView3());
},getTabView1:function(){var q=new qx.ui.tabview.TabView();
q.setWidth(500);
var u=new qx.ui.tabview.Page(V,D);
u.setLayout(new qx.ui.layout.VBox());
u.add(new qx.ui.basic.Label(I));
q.add(u);
var s=new qx.ui.tabview.Page(y,R);
s.setLayout(new qx.ui.layout.VBox());
s.add(new qx.ui.basic.Label(L));
q.add(s);
var t=new qx.ui.tabview.Page(O,C);
t.setLayout(new qx.ui.layout.VBox());
t.add(new qx.ui.basic.Label(S));
q.add(t);
var r=new qx.ui.tabview.Page(M,U);
r.setLayout(new qx.ui.layout.VBox());
r.add(new qx.ui.basic.Label(K));
q.add(r);
return q;
},getTabView2:function(){tabView=new qx.ui.tabview.TabView();
tabView.setWidth(500);

for(var i=1;i<=20;i++){var n=new qx.ui.tabview.Page(G+i,D);
n.setLayout(new qx.ui.layout.VBox());
n.add(new qx.ui.basic.Label(G+i));
tabView.add(n);
}return tabView;
},getTabView3:function(){tabView=new qx.ui.tabview.TabView();
tabView.setWidth(500);
tabView.setHeight(300);

for(var i=1;i<=3;i++){var m=new qx.ui.tabview.Page(G+i,E);
m.setLayout(new qx.ui.layout.VBox(4));
tabView.add(m);
m.add(new qx.ui.basic.Label(G+i));
}var f=tabView.getChildren()[0];
var l=new qx.ui.basic.Label(Q);
var j=new qx.ui.form.RadioButton(P);
var c=new qx.ui.form.RadioButton(z);
var h=new qx.ui.form.RadioButton(H);
var k=new qx.ui.form.RadioButton(N);
f.add(new qx.ui.core.Spacer(10,10));
f.add(l);
f.add(j);
f.add(c);
f.add(h);
f.add(k);
var b=new qx.ui.form.RadioGroup(j,c,h,k);
b.addListener(A,function(e){this.setBarPosition(e.getData());
},tabView);
h.setChecked(true);
var d=new qx.ui.form.Button(T);
var g=new qx.ui.form.Button(x);
var a=new qx.ui.form.Button(J);
f.add(new qx.ui.core.Spacer(10,10));
f.add(d);
f.add(g);
f.add(a);
d.addListener(F,function(e){var o=tabView.getChildren().length+1;
var p=new qx.ui.tabview.Page(G+o,E);
tabView.add(p);
});
g.addListener(F,function(e){var X=tabView.getChildren();

if(X.length>0){tabView.remove(X[0]);
}});
a.addListener(F,function(e){var W=tabView.getChildren();

if(W.length>0){tabView.remove(W[W.length-1]);
}});
return tabView;
}}});
})();
