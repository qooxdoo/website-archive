...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Save_Dialog", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.animation.Save_Dialog-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var v="execute",u="middle",t="demobrowser.demo.animation.Save_Dialog",s="appear",r='<b "font-size:12pt;">Do you want to save the changes you made in the document "Untitled"?</b>',q="close",p="center",o="Save...",n="Cancel",m="Lorem ipsum dolor sit amet, consectetuer sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.\n\nDuis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.\n\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi",j="right",l="Your changes will be lost if you don't save them.",k="Don't save";
var e;
qx.Class.define(t,{extend:qx.application.Standalone,members:{__qi:function(){if(qx.bom.client.Engine.MSHTML){this.__qj=new qx.fx.effect.core.Fade(this.__qm.getContainerElement().getDomElement()).set({from:0,to:1});
this.__qk=new qx.fx.effect.core.Fade(this.__qm.getContainerElement().getDomElement()).set({from:1,to:0});
}else{this.__qj=new qx.fx.effect.combination.Grow(this.__qm.getContainerElement().getDomElement());
this.__qk=new qx.fx.effect.combination.Shrink(this.__qm.getContainerElement().getDomElement());
}},showDialog:function(){this.__qm.setZIndex(1);
this.__qj.start();
},hideDialog:function(){this.__qk.start();
},main:function(){arguments.callee.base.call(this);
var document=this.getRoot();
this.__ql=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16]});
this.__ql.setLayout(new qx.ui.layout.VBox());
document.add(this.__ql,{left:40,top:40});
var f=new qx.ui.form.Button(q);
f.set({allowStretchX:false,alignX:j,marginBottom:15});
f.addListener(v,this.showDialog,this);
this.__ql.add(f);
var b=m;
var d=new qx.ui.form.TextArea(b);
...
g.setRowHeight(2,10);
g.setRowAlign(3,p,u);
this.__qm=new qx.ui.groupbox.GroupBox().set({contentPadding:[16,16,16,16],zIndex:-1});
this.__qm.setLayout(g);
document.add(this.__qm,{left:65,top:125});
this.__qm.addListenerOnce(s,this.__qi,this);
var h=new qx.ui.basic.Label(r);
var c=new qx.ui.basic.Label(l);
h.setRich(true);
this.__qm.add(h,{row:0,column:0,colSpan:3});
this.__qm.add(c,{row:1,column:0,colSpan:3});
var e=[k,n,o];

for(var i=0;i<e.length;i++){var a=new qx.ui.form.Button(e[i]);
a.setAllowStretchX(false);
this.__qm.add(a,{row:3,column:i});
a.addListener(v,this.hideDialog,this);
}}}});
})();
