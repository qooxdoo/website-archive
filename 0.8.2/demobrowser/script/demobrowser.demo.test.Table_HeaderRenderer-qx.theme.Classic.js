...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Table_HeaderRenderer-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var m="Name",l="hovered",k="tool tip",j="icon/16/apps/internet-feed-reader.png",i="mouseover",h="demobrowser.demo.test.Table_HeaderRenderer",g="mouseout";
...
var p={name:[m],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var q=this._getNewHeaderContainer();
this.permute(p,function(w){var x=r.createHeaderCell(w);
q.add(x);
r.updateHeaderCell(w,x);
});
},testDefaultRenderer:function(){var u=new qx.ui.table.headerrenderer.Default();
u.setToolTip(k);
var s={name:[m],col:[1],xPos:[2],editable:[true,false],sorted:[true,false],sortedAscending:[true,false]};
var t=this._getNewHeaderContainer();
this.permute(s,function(d){var f=u.createHeaderCell(d);
t.add(f);
u.updateHeaderCell(d,f);
});
...
this.permute(a,function(n){var o=c.createHeaderCell(n);
b.add(o);
c.updateHeaderCell(n,o);
});
},_getNewHeaderContainer:function(){var v=new qx.ui.container.Composite(new qx.ui.layout.HBox(5));
v.addListener(i,function(e){e.getTarget().addState(l);
});
v.addListener(g,function(e){e.getTarget().removeState(l);
});
this._container.add(v);
return v;
}}});
})();
