...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HSplit", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.HSplit-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var s="horizontal",r="main",q="Flex:1",p="Flex:1; Min:250",o="Auto",n="Flex:2",m="Flex:0",l="Flex:2; Max:100",k="Flex:1; Max:100",j="Flex:1; Max:200",g="Flex:2; Min:250",i="Flex:0; Min:350",h="demobrowser.demo.layout.HSplit";
...
},addSplitPaneTwoFlexSimple:function(){var e=new qx.ui.splitpane.Pane(s);
e.setWidth(400);
e.setHeight(60);
e.setDecorator(r);
this.getRoot().add(e,{left:20,top:20});
var d=new qx.ui.form.TextArea(q);
d.setDecorator(null);
d.setWrap(true);
e.add(d,1);
var f=new qx.ui.form.TextArea(n);
f.setDecorator(null);
f.setWrap(true);
e.add(f,2);
},addSplitPaneTwoFlexWithOneMin:function(){var b=new qx.ui.splitpane.Pane(s);
b.setWidth(400);
b.setHeight(60);
b.setDecorator(r);
this.getRoot().add(b,{left:20,top:100});
var a=new qx.ui.form.TextArea(p);
a.setDecorator(null);
a.setWrap(true);
a.setMinWidth(250);
b.add(a,1);
var c=new qx.ui.form.TextArea(n);
c.setDecorator(null);
c.setWrap(true);
b.add(c,2);
},addSplitPaneTwoFlexWithOneMax:function(){var G=new qx.ui.splitpane.Pane(s);
G.setWidth(400);
G.setHeight(60);
G.setDecorator(r);
this.getRoot().add(G,{left:20,top:180});
var F=new qx.ui.form.TextArea(q);
F.setDecorator(null);
F.setWrap(true);
G.add(F,1);
var H=new qx.ui.form.TextArea(l);
H.setDecorator(null);
H.setWrap(true);
H.setMaxWidth(100);
G.add(H,2);
},addSplitPaneTwoFlexWithTwoMin:function(){var M=new qx.ui.splitpane.Pane(s);
M.setWidth(400);
M.setHeight(60);
M.setDecorator(r);
this.getRoot().add(M,{left:20,top:260});
var L=new qx.ui.form.TextArea(p);
L.setDecorator(null);
L.setWrap(true);
L.setMinWidth(250);
M.add(L,1);
var N=new qx.ui.form.TextArea(g);
N.setDecorator(null);
N.setWrap(true);
N.setMinWidth(250);
M.add(N,2);
},addSplitPaneTwoFlexWithTwoMax:function(){var D=new qx.ui.splitpane.Pane(s);
D.setWidth(400);
D.setHeight(60);
D.setDecorator(r);
this.getRoot().add(D,{left:20,top:340});
var C=new qx.ui.form.TextArea(k);
C.setDecorator(null);
C.setWrap(true);
C.setMaxWidth(100);
D.add(C,1);
var E=new qx.ui.form.TextArea(l);
E.setDecorator(null);
E.setWrap(true);
E.setMaxWidth(100);
D.add(E,2);
},addSplitPaneOneFlexSimple:function(){var x=new qx.ui.splitpane.Pane(s);
x.setWidth(400);
x.setHeight(60);
x.setDecorator(r);
this.getRoot().add(x,{left:500,top:20});
var w=new qx.ui.form.TextArea(m);
w.setDecorator(null);
w.setWrap(true);
x.add(w,0);
var y=new qx.ui.form.TextArea(q);
y.setDecorator(null);
y.setWrap(true);
x.add(y);
},addSplitPaneOneFlexSimpleWithMax:function(){var u=new qx.ui.splitpane.Pane(s);
u.setWidth(400);
u.setHeight(60);
u.setDecorator(r);
this.getRoot().add(u,{left:500,top:100});
var t=new qx.ui.form.TextArea(m);
t.setDecorator(null);
t.setWrap(true);
u.add(t,0);
var v=new qx.ui.form.TextArea(j);
v.setDecorator(null);
v.setWrap(true);
v.setMaxWidth(200);
u.add(v);
},addSplitPaneOneFlexSimpleWithMin:function(){var A=new qx.ui.splitpane.Pane(s);
A.setWidth(400);
A.setHeight(60);
A.setDecorator(r);
this.getRoot().add(A,{left:500,top:180});
var z=new qx.ui.form.TextArea(i);
z.setDecorator(null);
z.setWrap(true);
z.setMinWidth(350);
A.add(z,0);
var B=new qx.ui.form.TextArea(q);
B.setDecorator(null);
B.setWrap(true);
A.add(B);
},addSplitPaneAuto:function(){var J=new qx.ui.splitpane.Pane(s);
J.setDecorator(r);
this.getRoot().add(J,{left:500,top:340});
var I=new qx.ui.form.TextArea(o);
I.setDecorator(null);
I.setWrap(true);
J.add(I,0);
var K=new qx.ui.form.TextArea(o);
K.setDecorator(null);
K.setWrap(true);
J.add(K);
}}});
...
(function(){var t="active",s="splitter",r="slider",q="horizontal",p="vertical",o="mousedown",n="mouseout",m="qx.client",l="height",k="row-resize",H="mousemove",G="move",F="maxHeight",E="width",D="_applyOrientation",C="splitpane",B="qx.ui.splitpane.Pane",A="minHeight",z="knob",y="mouseup",w="minWidth",x="losecapture",u="col-resize",v="maxWidth";
qx.Class.define(B,{extend:qx.ui.core.Widget,construct:function(a){arguments.callee.base.call(this);
...
},properties:{appearance:{refine:true,init:C},orientation:{init:q,check:[q,p],apply:D}},members:{__ig:null,__ih:null,__ii:null,__ij:null,__ik:null,__il:null,__im:null,_createChildControlImpl:function(bu){var bv;

switch(bu){case r:bv=new qx.ui.splitpane.Slider(this);
bv.exclude();
this._add(bv,{type:bu});
break;
case s:bv=new qx.ui.splitpane.Splitter(this);
this._add(bv,{type:bu});
bv.addListener(G,this._onSplitterMove,this);
break;
}return bv||arguments.callee.base.call(this,bu);
},_applyOrientation:function(I,J){var K=this.getChildControl(r);
var N=this.getChildControl(s);
this.__ik=I===q;
var M=this._getLayout();

if(M){M.dispose();
}var L=I===p?new qx.ui.splitpane.VLayout:new qx.ui.splitpane.HLayout;
this._setLayout(L);
N.replaceState(J,I);
N.getChildControl(z).replaceState(J,I);
K.replaceState(J,I);
...
var bc=this.getChildControl(r);
var bd=this.__il;

if(this.__ik){bc.setDomLeft(bd);
...
var T=U[2];
var Q=U[3];
var R=T.getLayoutProperties().flex;
var V=Q.getLayoutProperties().flex;
if((R!=0)&&(V!=0)){T.setLayoutProperties({flex:S});
Q.setLayoutProperties({flex:P});
}else{if(this.__ik){T.setWidth(S);
Q.setWidth(P);
}else{T.setHeight(S);
Q.setHeight(P);
}}},__io:function(){var c=this.getChildControl(s);
var f=c.getBounds();
...
},__ip:qx.core.Variant.select(m,{"opera":function(){var bt=this.getChildControl(s);

if(this.__ih||this.__io()){bt.addState(t);
}else if(bt.hasState(t)){bt.removeState(t);
}},"default":function(){var bf=this.getChildControl(s);
var bg=this.getApplicationRoot();
if(this.__ih||this.__io()){var be=this.__ik?u:k;
this.setCursor(be);
bg.setGlobalCursor(be);
bf.addState(t);
}else if(bf.hasState(t)){this.resetCursor();
bg.resetGlobalCursor();
bf.removeState(t);
}}}),__iq:function(){if(this.__ik){var bj=w,bq=E,bk=v,bo=this.__ii;
}else{var bj=A,bq=l,bk=F,bo=this.__ij;
}var bp=this._getChildren();
var bh=bp[2].getSizeHint();
var bm=bp[3].getSizeHint();
var bn=bp[2].getBounds()[bq]+bp[3].getBounds()[bq];
var bl=bo-this.__ig;
var bi=bn-bl;
if(bl<bh[bj]){bi-=bh[bj]-bl;
bl=bh[bj];
}else if(bi<bm[bj]){bl-=bm[bj]-bi;
bi=bm[bj];
}if(bl>bh[bk]){bi+=bl-bh[bk];
bl=bh[bk];
}else if(bi>bm[bk]){bl+=bi-bm[bk];
bi=bm[bk];
}this.__il=bl;
this.__im=bi;
}}});
