...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_Separator", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.VBox_Separator-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var j="main",i="green",h="separator-vertical",g="yellow",f="center",e="demobrowser.demo.layout.VBox_Separator",d="left",c="right";
...
a.add(this.getBox2());
a.add(this.getBox3());
},getBox1:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,h)).set({decorator:j,backgroundColor:g,allowGrowY:false});
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return b;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,h)).set({decorator:j,backgroundColor:g,minWidth:60,allowGrowY:false});
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxWidth:40,alignX:d}));
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxWidth:40,alignX:f}));
o.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxWidth:40,alignX:c}));
return o;
},getBox3:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.VBox(5,null,h)).set({decorator:j,backgroundColor:g,allowGrowY:false});
var n=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,marginBottom:10});
var m=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,marginBottom:10,marginTop:20});
var k=new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,marginBottom:10});
l.add(n);
l.add(m);
l.add(k);
return l;
