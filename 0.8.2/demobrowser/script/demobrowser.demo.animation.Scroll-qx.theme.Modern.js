...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.animation.Scroll-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
qx.Class.define(a,{extend:qx.fx.Base,properties:{mode:{init:d,check:[d,b]},x:{init:0,check:c},y:{init:0,check:c}},members:{__qn:null,__qo:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var e=this._getElement();
this.__qn={x:e.scrollLeft,y:e.scrollTop};
if(this._atEndPosition(this.__qn.x,this.__qn.y)){return;
}
if(this.getMode()==b){this.__qo={left:this.getX()-this.__qn.x,top:this.getY()-this.__qn.y};
}},update:function(h){arguments.callee.base.call(this);
var i=this._getElement();

if(this.getMode()==d){if(this.getX()!=0){i.scrollLeft=this.__qn.x+(this.getX()*h);
}
if(this.getY()!=0){i.scrollTop=this.__qn.y+(this.getY()*h);
}}else{i.scrollLeft=this.__qn.x+(this.__qo.left*h);
i.scrollTop=this.__qn.y+(this.__qo.top*h);
