...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HBox_Separator", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.HBox_Separator-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var i="main",h="green",g="yellow",f="separator-horizontal",e="demobrowser.demo.layout.HBox_Separator",d="top",c="bottom",b="middle";
...
a.add(this.getBox2());
a.add(this.getBox3());
},getBox1:function(){var j=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,f)).set({decorator:i,backgroundColor:g,allowGrowX:false});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}));
return j;
},getBox2:function(){var o=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,f)).set({decorator:i,backgroundColor:g,minHeight:60,allowGrowX:false});
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:d}));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:b}));
o.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,maxHeight:40,alignY:c}));
return o;
},getBox3:function(){var l=new qx.ui.container.Composite(new qx.ui.layout.HBox(5,null,f)).set({decorator:i,backgroundColor:g,allowGrowX:false});
var n=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var m=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
var k=new qx.ui.core.Widget().set({decorator:i,backgroundColor:h});
l.add(n);
l.add(m);
l.add(k);
n.setMarginRight(10);
