...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.ScrollBar", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.ScrollBar-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var j="scroll",i="Value: ",h="horizontal",g="demobrowser.demo.widget.ScrollBar",f="vertical";
qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var b=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({padding:20});
this.getRoot().add(b,{edge:0});
var d=new qx.ui.basic.Label(i).set({padding:30});
b.add(d,{row:0,column:0});
var c=new qx.ui.core.ScrollBar(f).set({height:200,maximum:500});
c.addListener(j,function(e){a.setPosition(e.getData());
});
b.add(c,{row:0,column:1});
var a=new qx.ui.core.ScrollBar(h).set({width:300,maximum:500});
a.addListener(j,function(e){c.setPosition(e.getData());
d.setContent(i+e.getData());
});
b.add(a,{row:1,column:0});
a.setPosition(170);
}}});
})();
