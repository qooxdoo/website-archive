...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.DateField", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$translations = {"C": {}, "en": {}, "fr_FR": {}, "de": {"Last month": "Vorheriger Monat", "Last year": "Vorheriges Jahr", "Next year": "Nächstes Jahr", "Next month": "Nächster Monat"}, "fr": {"Last month": "Mois dernier", "Last year": "Année dernière", "Next year": "Année prochaine", "Next month": "Mois prochain"}, "en_US": {}, "de_DE": {}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.DateField-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var G="execute",F="dd.MM.yyyy",E="MM/dd/yyyy",D="MM-yyyy",C="With date formater",B="Set 'TEST'",A="Set '01.01.08'",z="demobrowser.demo.widget.DateField",y="01.01.08",x="Set current date",s="Get value",w="Default",v="Set data",r="changeValue",q="Get data",u="TEST",t="Get date";
qx.Class.define(z,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
this.getRoot().add(new qx.ui.basic.Label(w),{top:20,left:20});
var b=new qx.ui.form.DateField();
this.getRoot().add(b,{top:35,left:20});
b.setDate(new Date());
b.addListener(r,function(e){this.debug("Change Value: "+e.getData());
});
this.getRoot().add(new qx.ui.basic.Label(C),{top:20,left:150});
var d=new qx.ui.form.DateField();
this.getRoot().add(d,{top:35,left:150});
d.setDate(new Date());
var k=new qx.util.format.DateFormat(D);
var l=new qx.util.format.DateFormat(E);
var m=new qx.util.format.DateFormat(F);
d.setDateFormat(l);
var j=new qx.ui.form.Button(D);
j.setWidth(120);
this.getRoot().add(j,{top:60,left:150});
j.addListener(G,function(e){d.setDateFormat(k);
});
var g=new qx.ui.form.Button(E);
g.setWidth(120);
this.getRoot().add(g,{top:88,left:150});
g.addListener(G,function(e){d.setDateFormat(l);
});
var h=new qx.ui.form.Button(F);
h.setWidth(120);
this.getRoot().add(h,{top:116,left:150});
h.addListener(G,function(e){d.setDateFormat(m);
});
this.getRoot().add(new qx.ui.basic.Label(v),{top:20,left:280});
var c=new qx.ui.form.DateField();
this.getRoot().add(c,{top:35,left:280});
var n=new qx.ui.form.Button(x);
n.setWidth(120);
this.getRoot().add(n,{top:60,left:280});
n.addListener(G,function(e){c.setDate(new Date());
});
var o=new qx.ui.form.Button(B);
o.setWidth(120);
this.getRoot().add(o,{top:88,left:280});
o.addListener(G,function(e){c.setValue(u);
});
var f=new qx.ui.form.Button(A);
f.setWidth(120);
this.getRoot().add(f,{top:116,left:280});
f.addListener(G,function(e){c.setValue(y);
});
this.getRoot().add(new qx.ui.basic.Label(q),{top:20,left:410});
var i=new qx.ui.form.DateField();
this.getRoot().add(i,{top:35,left:410});
var p=new qx.ui.form.Button(s);
p.setWidth(120);
this.getRoot().add(p,{left:410,top:60});
p.addListener(G,function(e){alert(i.getValue());
});
var a=new qx.ui.form.Button(t);
a.setWidth(120);
this.getRoot().add(a,{left:410,top:88});
a.addListener(G,function(e){alert(i.getDate());
});
}}});
})();
...
(function(){var n="popup",m="list",l="mousewheel",k="qx.ui.form.AbstractSelectBox",j="PageUp",i="blur",h="mousedown",g="one",f="Escape",d="_applyMaxListHeight",z="qx.event.type.Data",y="PageDown",x="changeSelection",w="middle",v="String",u="resize",t="changeVisibility",s="keypress",r="mouseup",q="abstract",o="changeName",p="Number";
qx.Class.define(k,{extend:qx.ui.core.Widget,include:qx.ui.core.MRemoteChildrenHandling,type:q,construct:function(){arguments.callee.base.call(this);
var J=new qx.ui.layout.HBox();
this._setLayout(J);
J.setAlignY(w);
this.addListener(s,this._onKeyPress);
this.addListener(i,this.close,this);
var I=qx.core.Init.getApplication().getRoot();
I.addListener(l,this._onMousewheel,this,true);
this.addListener(u,this._onResize,this);
},properties:{focusable:{refine:true,init:true},width:{refine:true,init:120},name:{check:v,nullable:true,event:o},maxListHeight:{check:p,apply:d,nullable:true,init:200}},events:{"changeValue":z},members:{_createChildControlImpl:function(A){var B;

switch(A){case m:B=new qx.ui.form.List().set({focusable:false,keepFocus:true,height:null,width:null,maxHeight:this.getMaxListHeight(),selectionMode:g,quickSelection:true});
B.addListener(x,this._onListChangeSelection,this);
B.addListener(h,this._onListMouseDown,this);
break;
case n:B=new qx.ui.popup.Popup(new qx.ui.layout.VBox);
B.setAutoHide(false);
B.setKeepActive(true);
B.addListener(r,this.close,this);
B.add(this.getChildControl(m));
B.addListener(t,this._onPopupChangeVisibility,this);
break;
}return B||arguments.callee.base.call(this,A);
},_applyMaxListHeight:function(a,b){this.getChildControl(m).setMaxHeight(a);
},getChildrenContainer:function(){return this.getChildControl(m);
},open:function(){var c=this.getChildControl(n);
c.placeToWidget(this,true);
c.show();
},close:function(){this.getChildControl(n).hide();
},toggle:function(){var C=this.getChildControl(n).isVisible();

if(C){this.close();
}else{this.open();
}},_onKeyPress:function(e){var G=e.getKeyIdentifier();
var H=this.getChildControl(n);
if(H.isHidden()&&(G==y||G==j)){e.stopPropagation();
}else if(!H.isHidden()&&G==f){this.close();
e.stop();
}else{this.getChildControl(m).handleKeyPress(e);
}},_onMousewheel:function(e){var E=e.getTarget();
var D=this.getChildControl(n);

if(qx.ui.core.Widget.contains(D,E)){return;
}this.close();
},_onResize:function(e){this.getChildControl(n).setMinWidth(e.getData().width);
...
if(F){F.removeListener(l,this._onMousewheel,this,true);
}}});
})();
...
(function(){var w="textfield",v="button",u="list",t="popup",s="input",r="changeValue",q="selected",p="inner",o="qx.event.type.Data",n="",h="combobox",m="Function",k="click",g="blur",f="Enter",j="quick",i="qx.ui.form.ComboBox",l="keydown",d="Down";
qx.Class.define(i,{extend:qx.ui.form.AbstractSelectBox,implement:qx.ui.form.IFormElement,construct:function(){arguments.callee.base.call(this);
this._createChildControl(w);
this._createChildControl(v);
this.addListener(k,this._onClick);
this.addListener(l,this._onKeyDown);
},properties:{appearance:{refine:true,init:h},format:{check:m,init:function(z){return this.__mt(z);
},nullable:true}},events:{"input":o,"changeValue":o},members:{__ms:null,_createChildControlImpl:function(F){var G;

switch(F){case w:G=new qx.ui.form.TextField();
G.setFocusable(false);
G.addState(p);
G.addListener(r,this._onTextFieldChangeValue,this);
G.addListener(s,this._onTextFieldInput,this);
G.addListener(g,this.close,this);
this._add(G,{flex:1});
break;
case v:G=new qx.ui.form.Button();
G.setFocusable(false);
...
},_forwardStates:{focused:true},tabFocus:function(){var a=this.getChildControl(w);
a.getFocusElement().focus();
a.selectAll();
},setValue:function(O){var Q=this.getChildControl(w);

if(Q.getValue()==O){return;
}Q.setValue(O);
var R=this.getChildControl(u);
var P=R.findItem(O);

if(P){R.setSelected(P);
}else{R.resetSelection();
}},getValue:function(){return this.getChildControl(w).getValue();
},_onKeyDown:function(e){if(e.isAltPressed()){this.getChildControl(v).addState(q);
this.focus();
}},_onKeyPress:function(e){var L=this.getChildControl(t);
var K=e.getKeyIdentifier();

if(K==d&&e.isAltPressed()){this.toggle();
e.stopPropagation();
}else if(K==f){if(L.isVisible()){this.close();
e.stop();
}}else if(L.isVisible()){arguments.callee.base.call(this,e);
}},_onClick:function(e){var b=e.getTarget();

if(b==this.getChildControl(v)){this.toggle();
}else{this.close();
}},_onListMouseDown:function(e){if(this.__ms){var c=this.__ms.getLabel();

if(this.getFormat()!=null){c=this.getFormat().call(this,this.__ms);
}this.setValue(c);
this.__ms=null;
}},_onListChangeSelection:function(e){var H=e.getData();

if(H.length>0){var I=this.getChildControl(u);

if(I.getSelectionContext()==j){this.__ms=H[0];
}else{var J=H[0].getLabel();

if(this.getFormat()!=null){J=this.getFormat().call(this,H[0]);
}this.setValue(J);
this.__ms=null;
}}},_onPopupChangeVisibility:function(e){var A=this.getChildControl(t);

if(A.isVisible()){var B=this.getChildControl(u);
B.setValue(this.getValue());
}else{this.tabFocus();
}this.getChildControl(v).removeState(q);
},_onTextFieldInput:function(e){this.fireDataEvent(s,e.getData());
},_onTextFieldChangeValue:function(e){var E=e.getData();
var D=this.getChildControl(u);
var C=D.findItem(E);

if(C){D.setSelected(C);
}else{D.resetSelection();
}this.fireDataEvent(r,E);
},__mt:function(M){var N=M.getLabel();

if(M.getRich()){N=N.replace(/<[^>]+?>/g,n);
N=qx.bom.String.unescape(N);
}return N;
},getSelection:function(){return this.getChildControl(w).getSelection();
},getSelectionLength:function(){return this.getChildControl(w).getSelectionLength();
},setSelection:function(x,y){this.getChildControl(w).setSelection(x,y);
},clearSelection:function(){this.getChildControl(w).clearSelection();
},selectAll:function(){this.getChildControl(w).selectAll();
}}});
})();
(function(){var z="list",y="textfield",x="popup",w="Down",v="mouseup",u="qx.ui.form.DateField",t="qx.util.format.DateFormat",s="changeVisibility",r="datefield",q="changeValue",k="Escape",p="hidden",n="short",j="Left",i="execute",m="Right",l="Up",o="_applyDateFormat";
qx.Class.define(u,{extend:qx.ui.form.ComboBox,construct:function(){arguments.callee.base.call(this);
var Q=qx.locale.Date.getDateFormat(n).toString();
this.setDateFormat(new qx.util.format.DateFormat(Q));
},properties:{appearance:{refine:true,init:r},dateFormat:{check:t,apply:o,dispose:true}},members:{setDate:function(K){var L=this.getChildControl(y);
L.setValue(this.getDateFormat().format(K));
var M=this.getChildControl(z);
M.setDate(K);
},getDate:function(){var D=this.getChildControl(y).getValue();
try{return this.getDateFormat().parse(D);
}catch(C){return null;
}},setValue:function(f){var h=this.getChildControl(y);

if(h.getValue()==f){return;
}h.setValue(f);

try{var g=this.getDateFormat().parse(f);
this.getChildControl(z).setDate(g);
}catch(E){this.getChildControl(z).resetDate();
}},getValue:function(){return this.getChildControl(y).getValue();
},_applyDateFormat:function(G,H){try{var J=this.getChildControl(y);
var I=H.parse(J.getValue());
J.setValue(G.format(I));
}catch(F){}},_createChildControlImpl:function(a){var b;

switch(a){case z:b=new qx.ui.control.DateChooser();
b.setFocusable(false);
b.setKeepFocus(true);
b.addListener(i,this._onChangeDate,this);
break;
case x:b=new qx.ui.popup.Popup(new qx.ui.layout.VBox);
b.setAutoHide(false);
b.add(this.getChildControl(z));
b.addListener(v,this._onChangeDate,this);
b.addListener(s,this._onPopupChangeVisibility,this);
break;
}return b||arguments.callee.base.call(this,a);
},_onChangeDate:function(e){var c=this.getChildControl(y);
var d=this.getChildControl(z).getDate();
c.setValue(this.getDateFormat().format(d));
this.close();
},_onKeyPress:function(e){var R=e.getKeyIdentifier();

if(R==w&&e.isAltPressed()){this.toggle();
e.stopPropagation();
return;
}var S=this.getChildControl(x);

if(S.getVisibility()==p){return;
}if(R==k){this.close();
e.stopPropagation();
return;
}if(R===j||R===m||R===w||R===l){e.preventDefault();
...
var N=this.getDate();
P.setDate(N);
}},_onTextFieldChangeValue:function(e){var A=this.getDate();

if(A!=null){var B=this.getChildControl(z);
B.setDate(A);
}this.fireDataEvent(q,e.getData());
}}});
})();
...
(function(){var bh="selected",bg="click",bf="default",be="last-month-button",bd="next-month-button",bc="otherMonth",bb="month-year-label",ba="last-year-button",Y="next-year-button",X="navigation-bar",ck="date-pane",cj="PageUp",ci="mousedown",ch="today",cg="Integer",cf="",ce="changeLocale",cd="next-month-button-tooltip",cc="last-month-button-tooltip",cb="qx.dynlocale",bo="PageDown",bp="last-year-button-tooltip",bm="next-year-button-tooltip",bn="on",bk="weekend",bl="day",bi="lastMonth",bj="Next month",bv="Escape",bw="weekday",bG="changeValue",bD="Space",bO="week#0",bJ="Down",bW="qx.ui.control.DateChooser",bT="Up",bz="qx.event.type.Data",ca="dblclick",bY="day#",bX="Next year",by="ww",bB="__mK",bC="weekday#",bF="datechooser",bH="String",bK="week",bQ="lastYear",bV="__mL",bq="nextYear",br="changeDate",bA="changeShownYear",bN="week#",bM="Last month",bL="Right",bS="Last year",bR="EE",bI="mouseup",bP="keypress",U="changeName",bU="Enter",bs="header",bt="nextMonth",bE="__mM",V="Date",W="Left",bx="_applyDate",bu="changeShownMonth";
qx.Class.define(bW,{extend:qx.ui.core.Widget,include:qx.ui.core.MExecutable,implement:qx.ui.form.IFormElement,construct:function(Q){arguments.callee.base.call(this);
var S=new qx.ui.layout.VBox();
this._setLayout(S);
this._createChildControl(X);
this._createChildControl(ck);
this.addListener(bP,this._onKeyPress);
var R=(Q!=null)?Q:new Date();
this.showMonth(R.getMonth(),R.getFullYear());
if(qx.core.Variant.isSet(cb,bn)){qx.locale.Manager.getInstance().addListener(ce,this._updateDatePane,this);
}this.addListener(ci,this._onMouseUpDown,this);
this.addListener(bI,this._onMouseUpDown,this);
},statics:{MONTH_YEAR_FORMAT:qx.locale.Date.getDateTimeFormat("yyyyMMMM","MMMM yyyy")},events:{changeValue:bz},properties:{appearance:{refine:true,init:bF},width:{refine:true,init:200},height:{refine:true,init:150},shownMonth:{check:cg,init:null,nullable:true,event:bu},shownYear:{check:cg,init:null,nullable:true,event:bA},date:{check:V,init:null,nullable:true,apply:bx,event:br},name:{check:bH,nullable:true,event:U}},members:{__mK:null,__mL:null,__mM:null,setValue:function(cv){{};
this.setDate(new Date(cv));
return cv;
},getValue:function(){return this.getDate().toString();
},_createChildControlImpl:function(K){var L;

switch(K){case X:L=new qx.ui.container.Composite(new qx.ui.layout.HBox());
L.add(this.getChildControl(ba));
L.add(this.getChildControl(be));
L.add(this.getChildControl(bb),{flex:1});
L.add(this.getChildControl(bd));
L.add(this.getChildControl(Y));
this._add(L);
break;
case bp:L=new qx.ui.tooltip.ToolTip(this.tr(bS));
break;
case ba:L=new qx.ui.form.Button();
L.addState(bQ);
L.setFocusable(false);
L.setToolTip(this.getChildControl(bp));
L.addListener(bg,this._onNavButtonClicked,this);
break;
case cc:L=new qx.ui.tooltip.ToolTip(this.tr(bM));
break;
case be:L=new qx.ui.toolbar.Button();
L.addState(bi);
L.setFocusable(false);
L.setToolTip(this.getChildControl(cc));
L.addListener(bg,this._onNavButtonClicked,this);
break;
case cd:L=new qx.ui.tooltip.ToolTip(this.tr(bj));
break;
case bd:L=new qx.ui.toolbar.Button();
L.addState(bt);
L.setFocusable(false);
L.setToolTip(this.getChildControl(cd));
L.addListener(bg,this._onNavButtonClicked,this);
break;
case bm:L=new qx.ui.tooltip.ToolTip(this.tr(bX));
break;
case Y:L=new qx.ui.toolbar.Button();
L.addState(bq);
L.setFocusable(false);
L.setToolTip(this.getChildControl(bm));
L.addListener(bg,this._onNavButtonClicked,this);
break;
case bb:L=new qx.ui.basic.Label();
L.setAllowGrowX(true);
L.setAnonymous(true);
break;
case bK:L=new qx.ui.basic.Label();
L.setAllowGrowX(true);
L.setAllowGrowY(true);
L.setSelectable(false);
L.setAnonymous(true);
L.setCursor(bf);
break;
case bw:L=new qx.ui.basic.Label();
L.setAllowGrowX(true);
L.setAllowGrowY(true);
L.setSelectable(false);
L.setAnonymous(true);
L.setCursor(bf);
break;
case bl:L=new qx.ui.basic.Label();
L.setAllowGrowX(true);
L.setAllowGrowY(true);
L.setCursor(bf);
L.addListener(ci,this._onDayClicked,this);
L.addListener(ca,this._onDayDblClicked,this);
break;
case ck:var M=new qx.ui.layout.Grid();
L=new qx.ui.container.Composite(M);

for(var i=0;i<8;i++){M.setColumnFlex(i,1);
}
for(var i=0;i<7;i++){M.setRowFlex(i,1);
}var N=this.getChildControl(bO);
N.addState(bs);
L.add(N,{column:0,row:0});
this.__mK=[];

for(var i=0;i<7;i++){N=this.getChildControl(bC+i);
L.add(N,{column:i+1,row:0});
this.__mK.push(N);
}this.__mL=[];
this.__mM=[];

for(var y=0;y<6;y++){var N=this.getChildControl(bN+(y+1));
L.add(N,{column:0,row:y+1});
this.__mM.push(N);
for(var x=0;x<7;x++){var N=this.getChildControl(bY+((y*7)+x));
L.add(N,{column:x+1,row:y+1});
this.__mL.push(N);
}}this._add(L);
break;
}return L||arguments.callee.base.call(this,K);
},_applyDate:function(F,G){this.fireDataEvent(bG,F==null?cf:F.toString());

if((F!=null)&&(this.getShownMonth()!=F.getMonth()||this.getShownYear()!=F.getFullYear())){this.showMonth(F.getMonth(),F.getFullYear());
}else{var I=(F==null)?-1:F.getDate();

for(var i=0;i<6*7;i++){var H=this.__mL[i];

if(H.hasState(bc)){if(H.hasState(bh)){H.removeState(bh);
}}else{var J=parseInt(H.getContent());

if(J==I){H.addState(bh);
}else if(H.hasState(bh)){H.removeState(bh);
}}}}},_onMouseUpDown:function(e){var T=e.getTarget();

if(T==this.getChildControl(X)||T==this.getChildControl(ck)){e.stopPropagation();
return;
}},_onNavButtonClicked:function(cn){var cp=this.getShownYear();
var co=this.getShownMonth();

switch(cn.getCurrentTarget()){case this.getChildControl(ba):cp--;
break;
case this.getChildControl(be):co--;

if(co<0){co=11;
cp--;
}break;
case this.getChildControl(bd):co++;

if(co>=12){co=0;
cp++;
}break;
case this.getChildControl(Y):cp++;
break;
}this.showMonth(co,cp);
},_onDayClicked:function(cl){var cm=cl.getCurrentTarget().dateTime;
this.setDate(new Date(cm));
},_onDayDblClicked:function(){this.execute();
},_onKeyPress:function(cq){var cu=null;
var cs=null;
var ct=null;

if(cq.getModifiers()==0){switch(cq.getKeyIdentifier()){case W:cu=-1;
break;
case bL:cu=1;
break;
case bT:cu=-7;
...
case bo:cs=1;
break;
case bv:if(this.getDate()!=null){this.setDate(null);
return true;
}break;
case bU:case bD:if(this.getDate()!=null){this.execute();
}return;
}}else if(cq.isShiftPressed()){switch(cq.getKeyIdentifier()){case cj:ct=-1;
break;
case bo:ct=1;
break;
}}
if(cu!=null||cs!=null||ct!=null){var cr=this.getDate();
...
}},showMonth:function(O,P){if((O!=null&&O!=this.getShownMonth())||(P!=null&&P!=this.getShownYear())){if(O!=null){this.setShownMonth(O);
}
if(P!=null){this.setShownYear(P);
...
this.getChildControl(bb).setContent(q.format(t));
var D=t.getDay();
var n=1+((7-D)%7);
var u=new qx.util.format.DateFormat(bR);

for(var i=0;i<7;i++){var w=(i+h)%7;
var A=this.__mK[i];
t.setDate(n+w);
A.setContent(u.format(t));

if(qx.locale.Date.isWeekend(w)){A.addState(bk);
}else{A.removeState(bk);
}}t=new Date(B,l,1,12,0,0);
var b=(7+D-h)%7;
t.setDate(t.getDate()-b);
var z=new qx.util.format.DateFormat(by);

for(var a=0;a<6;a++){this.__mM[a].setContent(z.format(t));

for(var i=0;i<7;i++){var A=this.__mL[a*7+i];
var f=t.getFullYear();
var d=t.getMonth();
var j=t.getDate();
var c=(v==f&&E==d&&p==j);
...
if(c){A.addState(bh);
}else{A.removeState(bh);
}
if(d!=l){A.addState(bc);
}else{A.removeState(bc);
}var C=(f==g&&d==m&&j==k);

if(C){A.addState(ch);
}else{A.removeState(ch);
}A.setContent(cf+j);
...
u.dispose();
z.dispose();
}},destruct:function(){if(qx.core.Variant.isSet(cb,bn)){qx.locale.Manager.getInstance().removeListener(ce,this._updateDatePane,this);
}this._disposeFields(bB,bV,bE);
}});
})();
