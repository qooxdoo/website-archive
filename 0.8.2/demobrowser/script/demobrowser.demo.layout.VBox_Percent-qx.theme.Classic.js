...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VBox_Percent", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.VBox_Percent-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var l="main",k="green",j="33%",i="yellow",h="50%",g="demobrowser.demo.layout.VBox_Percent";
qx.Class.define(g,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var a=new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({padding:20});
scroll.add(a);
a.add(this.getBox1());
a.add(this.getBox2());
a.add(this.getBox3());
...
a.add(this.getBox5());
a.add(this.getBox6());
},getBox1:function(){var m=new qx.ui.layout.VBox();
var o=new qx.ui.container.Composite(m).set({decorator:l,backgroundColor:i,height:300,allowGrowY:false});
m.setSpacing(5);
var q=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var p=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var n=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
o.add(q,{height:h});
o.add(p,{flex:1});
o.add(n,{flex:1});
return o;
},getBox2:function(){var G=new qx.ui.layout.VBox();
var I=new qx.ui.container.Composite(G).set({decorator:l,backgroundColor:i,height:300,allowGrowY:false});
G.setSpacing(5);
var K=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var J=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var H=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
I.add(K,{height:j});
I.add(J,{height:j});
I.add(H,{height:j,flex:1});
return I;
},getBox3:function(){var B=new qx.ui.layout.VBox();
var D=new qx.ui.container.Composite(B).set({decorator:l,backgroundColor:i,allowGrowY:false});
B.setSpacing(5);
var F=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var E=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var C=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
D.add(F,{height:h});
D.add(E,{flex:1});
D.add(C,{flex:1});
return D;
},getBox4:function(){var r=new qx.ui.layout.VBox();
var t=new qx.ui.container.Composite(r).set({decorator:l,backgroundColor:i,allowGrowY:false});
r.setSpacing(5);
var v=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var u=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var s=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
t.add(v,{height:j,flex:1});
t.add(u,{height:j,flex:1});
t.add(s,{height:j,flex:1});
return t;
},getBox5:function(){var w=new qx.ui.layout.VBox();
var y=new qx.ui.container.Composite(w).set({decorator:l,backgroundColor:i,height:100,allowGrowY:false});
w.setSpacing(5);
var A=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var z=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var x=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
y.add(A,{height:j,flex:1});
y.add(z,{height:j,flex:1});
y.add(x,{height:j,flex:1});
return y;
},getBox6:function(){var b=new qx.ui.layout.VBox();
var d=new qx.ui.container.Composite(b).set({decorator:l,backgroundColor:i,height:300,allowGrowY:false});
b.setSpacing(5);
var f=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var e=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
var c=new qx.ui.core.Widget().set({decorator:l,backgroundColor:k});
d.add(f,{height:j,flex:1});
d.add(e,{height:j,flex:1});
d.add(c,{height:j,flex:1});
return d;
}}});
})();
