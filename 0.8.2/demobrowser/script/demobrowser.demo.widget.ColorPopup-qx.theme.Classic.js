...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.ColorPopup", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$translations = {"C": {}, "en": {}, "fr_FR": {}, "de": {"Open ColorSelector": "Öffne Farbauswahl", "HSB": "HSB", "Preview (Old/New)": "Vorschau (alt/neu)", "Color Selector": "Farbauswahl", "Presets": "Voreinstellungen", "Hex": "Hex", "RGB": "RGB", "Details": "Details", "Cancel": "Abbruch", "Automatic": "Automatisch"}, "fr": {"Open ColorSelector": "Ouvrir le sélecteur de couleurs", "HSB": "TSV", "Preview (Old/New)": "Aperçu (Ancien/Nouveau)", "Color Selector": "Sélecteur de couleurs", "Presets": "Pré-réglages", "Hex": "Hex", "RGB": "RVB", "Details": "Détails", "Cancel": "Annuler", "Automatic": "Automatique"}, "en_US": {}, "de_DE": {}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.ColorPopup-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var k="Selected Color",j="mousedown",i="changeGreen",h="Open Popup",g="changeBlue",f="changeValue",d="changeRed",c="main",b="#23F3C1",a="demobrowser.demo.widget.ColorPopup";
qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var l=this.getRoot();
var n=new qx.ui.control.ColorPopup();
n.exclude();
n.setValue(b);
var o=new qx.ui.form.Button(h);
o.addListener(j,function(e){n.placeToMouse(e);
n.show();
});
var m=new qx.ui.basic.Label(k).set({marginLeft:10,padding:[3,6],decorator:c});
l.add(m,{left:100,top:20});
l.add(o,{left:20,top:20});
l.add(n,{left:100,top:100});
n.addListener(f,function(e){this.debug("Value Listener: "+e.getData());
m.setBackgroundColor(e.getData());
});
n.addListener(d,function(e){this.debug("Red Listener: "+e.getData());
});
n.addListener(i,function(e){this.debug("Green Listener: "+e.getData());
});
n.addListener(g,function(e){this.debug("Blue Listener: "+e.getData());
});
}}});
})();
