...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Atom-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var m="main",l="#E6EDFA",k="#E6FAED",j="icon/32/apps/internet-feed-reader.png",i="Atom With Long Label",h="top",g="Wider Atom",f="icon/32/apps/utilities-notes.png",e="#FAF8E6",d="Icon Top",D="Icon Bottom",C="bottom",B="icon/32/actions/go-previous.png",A="Atom Without Label",z="icon/32/actions/go-next.png",y="icon/32/actions/go-up.png",x="Icon Left",w="demobrowser.demo.widget.Atom",v="icon",u="icon/32/actions/go-down.png",s="left",t="right",q="Atom Without Icon",r="Higher Atom",o="#EAE6FA",p="label",n="Icon Right";
...
a.add(new qx.ui.basic.Atom(x,B).set({backgroundColor:k,decorator:m,iconPosition:s,padding:5,allowGrowY:false}));
a.add(new qx.ui.basic.Atom(d,y).set({backgroundColor:k,decorator:m,iconPosition:h,padding:5,allowGrowY:false}));
a.add(new qx.ui.basic.Atom(n,z).set({backgroundColor:k,decorator:m,iconPosition:t,padding:5,allowGrowY:false}));
a.add(new qx.ui.basic.Atom(D,u).set({backgroundColor:k,decorator:m,iconPosition:C,padding:5,allowGrowY:false}));
a.add(new qx.ui.core.Spacer().set({width:40}));
a.add(new qx.ui.basic.Atom(A,j).set({backgroundColor:e,decorator:m,show:v,padding:5,allowGrowY:false}));
a.add(new qx.ui.basic.Atom(q,j).set({backgroundColor:e,decorator:m,show:p,padding:5,allowGrowY:false}));
var c=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
this.getRoot().add(c,{left:20,top:150});
c.add(new qx.ui.basic.Atom(i).set({backgroundColor:l,decorator:m,padding:5,width:100,allowGrowY:false}));
c.add(new qx.ui.basic.Atom(i,j).set({backgroundColor:l,decorator:m,padding:5,width:150,allowGrowY:false}));
c.add(new qx.ui.basic.Atom(i,j).set({backgroundColor:o,decorator:m,iconPosition:h,padding:5,width:100,allowGrowY:false}));
var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
this.getRoot().add(b,{left:20,top:250});
b.add(new qx.ui.basic.Atom(g).set({backgroundColor:l,decorator:m,center:true,padding:5,width:100,allowGrowY:false}));
b.add(new qx.ui.basic.Atom(g,f).set({backgroundColor:l,decorator:m,center:true,padding:5,width:140,allowGrowY:false}));
b.add(new qx.ui.basic.Atom(r,f).set({backgroundColor:l,decorator:m,iconPosition:h,center:true,padding:5,height:100,allowGrowY:false}));
}}});
})();
