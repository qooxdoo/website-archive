...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Label", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Label-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var j="main",i="Verdana",h="sans-serif",g="Big Long Label Cutted",f="My First Long Label Cutted",e="A long label text with auto-wrapping. This also may contain <b style='color:red'>rich HTML</b> markup.",d="My First Long Label",c="Big Long Label",b="My Label",a="demobrowser.demo.widget.Label";
qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var k=new qx.ui.basic.Label(b).set({decorator:j});
this.getRoot().add(k,{left:20,top:20});
var l=new qx.ui.basic.Label(d).set({decorator:j});
this.getRoot().add(l,{left:20,top:60});
var m=new qx.ui.basic.Label(f).set({decorator:j,width:80});
this.getRoot().add(m,{left:20,top:100});
var n=new qx.ui.basic.Label().set({content:e,decorator:j,rich:true,width:120});
this.getRoot().add(n,{left:20,top:140});
var o=new qx.ui.basic.Label(c).set({decorator:j,font:new qx.bom.Font(28,[i,h])});
this.getRoot().add(o,{left:20,top:220});
var p=new qx.ui.basic.Label(g).set({decorator:j,font:new qx.bom.Font(28,[i,h]),width:150});
this.getRoot().add(p,{left:20,top:280});
}}});
})();
