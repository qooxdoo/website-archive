...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Canvas_LeftRight", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Canvas_LeftRight-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
var i=new qx.ui.decoration.Single(3,b,g);
w1=new qx.ui.core.Widget().set({backgroundColor:f,decorator:i,width:400});
w2=new qx.ui.core.Widget().set({backgroundColor:a,decorator:i,minWidth:400});
w3=new qx.ui.core.Widget().set({backgroundColor:d,decorator:i,width:400});
w4=new qx.ui.core.Widget().set({backgroundColor:c,decorator:i,minWidth:400});
var h=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({decorator:i});
this.getRoot().setPadding(20);
h.add(w1,{left:10,top:10});
h.add(w2,{left:10,top:80});
h.add(w3,{top:150,right:10});
h.add(w4,{top:220,right:10});
