...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.animation.Tree_Highlight-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var k="execute",j="appear",h="Trash",g="changeSelection",f="Windows (C:)",e="Documents (D:)",d="Add before",c="Add after",b="Add at begin",a="Inbox",K="changeValue",J="Desktop",I="Show open button:",H="New tree item name: ",G="auto",F="Hello",E="Presets",D="Data 123213234325345234523453453245",C="demobrowser.demo.animation.Tree_Highlight",B="Network",r="Control",s="Sent",p="Files",q="Remove tree item",n="Add file",o="Workspace",l="Junk #",m="Tree",t="never",u="Add folder",w="Root",v="always",y="Move to parent",x="Reset tree",A="Edit",z="Remove all children";
...
var bz=new qx.ui.groupbox.GroupBox(m).set({contentPadding:[4,4,4,4]});
bz.setLayout(new qx.ui.layout.Canvas());
this._container.add(bz);
this._treeGroup=bz;
var bA=this.getTree();
bz.add(bA,{edge:0});
this._tree=bA;
...
var O=new qx.ui.tree.TreeFolder(h);
ba.add(R,P,Q,O);
var X=new qx.ui.tree.TreeFile(f);
var N=new qx.ui.tree.TreeFile(e);
P.add(X,N);
arbeitsplatz=P;
...
var U=new qx.ui.tree.TreeFolder(h);
...
bc.add(bb);
return W;
},getCommandFrame:function(){var bn=new qx.ui.groupbox.GroupBox(r);
bn.setLayout(new qx.ui.layout.Grid(3,5));
var bp=0;
bn.add(new qx.ui.basic.Label(H).set({paddingTop:4}),{row:bp,column:0});
this.inputItemName=new qx.ui.form.TextField(F);
bn.add(this.inputItemName,{row:bp++,column:1});
this.btnAddFolder=new qx.ui.form.Button(u);
this.btnAddFolder.addListener(k,this._addFolder,this);
bn.add(this.btnAddFolder,{row:bp++,column:0,colSpan:2});
this.btnAddFile=new qx.ui.form.Button(n);
this.btnAddFile.addListener(k,this._addFile,this);
bn.add(this.btnAddFile,{row:bp++,column:0,colSpan:2});
this.btnAddAfter=new qx.ui.form.Button(c);
this.btnAddAfter.addListener(k,this._addAfter,this);
bn.add(this.btnAddAfter,{row:bp++,column:0,colSpan:2});
this.btnAddBefore=new qx.ui.form.Button(d);
this.btnAddBefore.addListener(k,this._addBefore,this);
bn.add(this.btnAddBefore,{row:bp++,column:0,colSpan:2});
this.btnAddBegin=new qx.ui.form.Button(b);
this.btnAddBegin.addListener(k,this._addBegin,this);
bn.add(this.btnAddBegin,{row:bp++,column:0,colSpan:2});
bn.add(new qx.ui.core.Spacer(5,5),{row:bp++,column:0});
this.btnRemove=new qx.ui.form.Button(q);
this.btnRemove.addListener(k,this._removeTreeItem,this);
bn.add(this.btnRemove,{row:bp++,column:0,colSpan:2});
this.btnRemoveAll=new qx.ui.form.Button(z);
this.btnRemoveAll.addListener(k,this._removeAll,this);
bn.add(this.btnRemoveAll,{row:bp++,column:0,colSpan:2});
bn.add(new qx.ui.core.Spacer(5,5),{row:bp++,column:0});
this.btnMoveToParent=new qx.ui.form.Button(y);
this.btnMoveToParent.addListener(k,this._moveToParent,this);
bn.add(this.btnMoveToParent,{row:bp++,column:0,colSpan:2});
bn.add(new qx.ui.core.Spacer(5,5),{row:bp++,column:0});
bn.add(new qx.ui.basic.Label(I),{row:bp,column:0});
var bl=[v,t,G];
this.showOpenButtons={};
this.mgrShowRootOpen=new qx.ui.form.RadioGroup();

for(var i=0;i<bl.length;i++){var bo=bl[i];
var bm=new qx.ui.form.RadioButton(bo).set({value:bo,checked:bo==this._tree.getRootOpenClose()});
this.showOpenButtons[bo]=bm;
this.mgrShowRootOpen.add(bm);
bn.add(bm,{row:bp++,column:1});
...
bn.add(this.btnReset,{row:bp++,column:0,colSpan:2});
this._tree.addListener(g,this._updateControls,this);
this._updateControls();
return bn;
},_addFolder:function(){var bj=this._tree.getSelected();
var bk=new qx.ui.tree.TreeFolder(this.inputItemName.getValue());
bk.addListenerOnce(j,function(){effect=new qx.fx.effect.core.Highlight(bk.getContainerElement().getDomElement());
effect.start();
},this);
bj.setOpen(true);
bj.add(bk);
},_addFile:function(){var bd=this._tree.getSelected();
var be=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
be.addListenerOnce(j,function(){effect=new qx.fx.effect.core.Highlight(be.getContainerElement().getDomElement());
effect.start();
},this);
bd.setOpen(true);
bd.add(be);
},_addBefore:function(){var bB=this._tree.getSelected();
var bC=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bC.addListenerOnce(j,function(){effect=new qx.fx.effect.core.Highlight(bC.getContainerElement().getDomElement());
effect.start();
},this);
bB.getParent().addBefore(bC,bB);
},_addAfter:function(){var bw=this._tree.getSelected();
var bx=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bx.addListenerOnce(j,function(){effect=new qx.fx.effect.core.Highlight(bx.getContainerElement().getDomElement());
effect.start();
},this);
bw.getParent().addAfter(bx,bw);
},_addBegin:function(){var bh=this._tree.getSelected();
var bi=new qx.ui.tree.TreeFile(this.inputItemName.getValue());
bi.addListenerOnce(j,function(){effect=new qx.fx.effect.core.Highlight(bi.getContainerElement().getDomElement());
effect.start();
},this);
bh.getParent().addAtBegin(bi);
},_removeTreeItem:function(){var L=this._tree.getSelected();
var parent=L.getParent();
parent.remove(L);
},_removeAll:function(){var by=this._tree.getSelected();
by.removeAll();
},_moveToParent:function(){var M=this._tree.getSelected();
var parent=M.getParent();
parent.remove(M);
parent.getParent().add(M);
this._updateControls();
},_onChangeShowOpen:function(){var bf=this._tree.getSelected();
var bg=this.mgrShowRootOpen.getSelected().getValue();
bf.setOpenSymbolMode(bg);
},_resetTree:function(){this._treeGroup.remove(this._tree);
this._tree=this.getTree();
this._treeGroup.add(this._tree,{edge:0});
this._tree.addListenerOnce(j,function(){this._tree.addListener(g,this._updateControls,this);
},this);
},_updateControls:function(){var bu=this._tree.getSelection()[0];

if(!bu){this.btnAddFolder.setEnabled(false);
...
var bs=bu.getLevel();
var bv=bs==-1;
var bt=bu instanceof qx.ui.tree.TreeFolder;
var bq=this._tree.getNextSiblingOf(bu)==null;
var br=this._tree.getPreviousSiblingOf(bu)==null;
this.btnAddFolder.setEnabled(bt);
this.btnAddFile.setEnabled(bt);
this.btnAddBefore.setEnabled(!bv);
this.btnAddAfter.setEnabled(!bv);
this.btnAddBegin.setEnabled(!bv);
this.btnRemove.setEnabled(!bv);
this.btnRemoveAll.setEnabled(true);
this.mgrShowRootOpen.setEnabled(bt);
this.showOpenButtons[bu.getOpenSymbolMode()].setChecked(true);
