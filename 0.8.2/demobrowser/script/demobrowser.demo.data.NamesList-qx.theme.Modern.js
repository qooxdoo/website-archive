...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.NamesList", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.NamesList-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var o="persons.json</a> and bind the items to the list widget. In the ",n="converter for the label, the names will be set to both, the first ",m="Loading...",l="model.persons",k="' target='_blank'>",j="content",i="model",h="state",g="and last name.",f="<b>List bound to data in a json file</b><br/>",c="demobrowser.demo.data.NamesList",e="firstname",d="json/persons.json",b=", ",a="Loading the json file <a href='";
...
var s=new qx.data.controller.List(null,r);
s.setLabelPath(e);
s.setLabelOptions({converter:function(u,v){return v.getLastname()+b+u;
}});
var q=d;
var t=new qx.data.store.Json(q);
