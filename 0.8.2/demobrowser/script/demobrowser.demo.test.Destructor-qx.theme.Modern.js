...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Destructor-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var f="Window: ",e="interval",d="Label: ",c="demobrowser.demo.test.Destructor";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__xc:[],main:function(){arguments.callee.base.call(this);
this.currentTest=this.testWindows;
this.__xd=0;
this.__xe=new qx.event.Timer(1000);
this.__xe.addListener(e,this.runTest,this);
this.__xe.start();
timer=this.__xe;
},runTest:function(){this.__xd++;
var b=qx.lang.Object.getLength(qx.core.ObjectRegistry.getRegistry());
this.debug("Round: "+this.__xd+" (Registry: "+b+")");
this.currentTest();
...
},testLabels:function(){for(var i=0;i<250;i++){var g=new qx.ui.basic.Label(d+i);
this.getRoot().add(g,{left:50,top:50+i*20});
this.__xc.push(g);
}},testWindows:function(){for(var i=0;i<5;i++){var h=new qx.ui.window.Window(f+i);
h.open();
this.__xc.push(h);
}}}});
})();
