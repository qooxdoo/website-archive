...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.Opacity", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.ui.Opacity-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
k.add(this.getGrid1());
},getGrid1:function(){var d=new qx.ui.decoration.Single(1,f,e);
columns=30;
rows=30;
boxSize=15;
var a=new qx.ui.container.Composite(new qx.ui.layout.Grid());
var b=new qx.ui.basic.Label().set({rich:true,content:i,decorator:d,backgroundColor:j});
b.setUserBounds(0,0,boxSize*columns+100,boxSize*rows);
a.add(b);
var c=Math.sqrt((columns-1)*(columns-1)+(rows-1)*(rows-1));

for(var x=0;x<columns;x++){for(var y=0;y<rows;y++){a.add(new qx.ui.core.Widget().set({backgroundColor:h,height:boxSize,width:boxSize,opacity:Math.sqrt(x*x+y*y)/c}),{row:x,column:y});
}}return a;
}}});
})();
