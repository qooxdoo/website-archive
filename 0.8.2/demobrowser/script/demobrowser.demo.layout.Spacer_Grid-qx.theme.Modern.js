...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Spacer_Grid", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Spacer_Grid-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
a.add(this.getGrid1());
a.add(this.getGrid2());
},getGrid1:function(){var h=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:f,backgroundColor:d,allowGrowX:false,allowGrowY:false});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:0,column:0});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:0,column:1});
...
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:2,column:1});
h.add(new qx.ui.core.Spacer(0,20),{row:3,column:0});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:4,column:0});
h.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:4,column:1});
return h;
},getGrid2:function(){var g=new qx.ui.container.Composite(new qx.ui.layout.Grid()).set({decorator:f,backgroundColor:d,allowGrowX:false,allowGrowY:false});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:0,column:0});
g.add(new qx.ui.core.Spacer(10,0),{row:0,column:2});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:0,column:3});
g.add(new qx.ui.core.Spacer(30,0),{row:1,column:4});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:0,column:5});
g.add(new qx.ui.core.Spacer(0,5),{row:1,column:0});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:2,column:0});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:2,column:3});
g.add(new qx.ui.core.Widget().set({decorator:f,backgroundColor:e}),{row:2,column:5});
return g;
}}});
})();
