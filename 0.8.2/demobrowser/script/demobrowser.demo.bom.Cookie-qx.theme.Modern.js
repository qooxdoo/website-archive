...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Cookie", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Cookie-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var g="",f="execute",e="demobrowser.demo.bom.Cookie",d="Save",c="Restore",b="Delete";
qx.Class.define(e,{extend:qx.application.Standalone,statics:{COOKIE_KEY:"TextFieldContent"},members:{main:function(){arguments.callee.base.call(this);
...
k.add(j);
j.addListener(f,function(e){var a=qx.bom.Cookie.get(demobrowser.demo.bom.Cookie.COOKIE_KEY);
i.setValue(a!=null?a:g);
},this);
var l=new qx.ui.form.Button(b);
k.add(l);
