...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Dock_FlexShrinking-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var w="main",v="east",u="yellow",t="center",s="north",r="south",q="west",p="green",o="blue",n="fuchsia",k="orange",m="red",l="demobrowser.demo.layout.Dock_FlexShrinking",j="x",i="y";
qx.Class.define(l,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var b=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(b);
var a=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:w,backgroundColor:u,width:150,height:100,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:w,backgroundColor:m});
var g=new qx.ui.core.Widget().set({decorator:w,backgroundColor:o});
var f=new qx.ui.core.Widget().set({decorator:w,backgroundColor:k});
var e=new qx.ui.core.Widget().set({decorator:w,backgroundColor:p});
var d=new qx.ui.core.Widget().set({decorator:w,backgroundColor:n});
a.add(h,{edge:s,flex:1});
a.add(g,{edge:q,flex:1});
a.add(f,{edge:r,flex:1});
a.add(e,{edge:v,flex:1});
a.add(d,{edge:t});
b.add(a);
var c=new qx.ui.layout.Dock();
c.setSort(i);
var a=(new qx.ui.container.Composite(c)).set({decorator:w,backgroundColor:u,width:150,height:100,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:w,backgroundColor:m});
var g=new qx.ui.core.Widget().set({decorator:w,backgroundColor:o});
var f=new qx.ui.core.Widget().set({decorator:w,backgroundColor:k});
var e=new qx.ui.core.Widget().set({decorator:w,backgroundColor:p});
