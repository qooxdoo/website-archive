...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Grid_Complex-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
var k=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(k);
k.add(this.getGrid1());
k.add(this.getGrid2());
},getGrid1:function(){var j=new qx.ui.container.Composite().set({decorator:i,backgroundColor:g,allowGrowX:false});
j.setLayout(new qx.ui.layout.Grid(5,20));
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:0});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h}),{row:0,column:1});
j.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,width:150,maxWidth:150}),{row:1,column:0,rowSpan:1,colSpan:2});
return j;
...
n.add(new qx.ui.core.Widget().set({decorator:i,backgroundColor:h,allowGrowX:false,height:70,allowGrowX:false}),{row:0,column:1});
