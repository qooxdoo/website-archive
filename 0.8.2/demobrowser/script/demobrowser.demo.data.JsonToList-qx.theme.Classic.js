...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.JsonToList-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var u="icon/16/mimetypes/",t="name",s="model.items",r="Loading...",q=" will be created by a converter which converts the type to an icon url.",p=".png",o="content",n="model",m="state",l="json/list.json",h="type",k="list.json</a> and bind the items to the list widget. The icons ",j="' target='_blank'>",g="demobrowser.demo.data.JsonToList",f="<b>List bound to data in a json file</b><br/>",i="Loading the json file <a href='";
...
var d=new qx.data.controller.List(null,c);
d.setLabelPath(t);
d.setIconOptions({converter:function(v){return u+v+p;
}});
d.setIconPath(h);
var b=l;
var e=new qx.data.store.Json(b);
var status=new qx.ui.basic.Label(r);
