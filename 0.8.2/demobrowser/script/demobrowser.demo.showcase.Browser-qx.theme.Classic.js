...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.showcase.Browser-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var o="execute",n="http://",m="demobrowser.demo.showcase.Browser",l="separator-vertical",k="icon/16/actions/go-previous.png",j="keypress",i="Enter",h="icon/16/actions/go-next.png",g="Web Browser",f="This feature is currently not supported.",b="icon/16/actions/media-playback-start.png",d="http://web.de",c="icon/16/categories/internet.png",a="middle";
...
},_createBrowser:function(){var q=new qx.ui.window.Window(g,c);
var p=new qx.ui.layout.VBox();
p.setSeparator(l);
q.setLayout(p);
q.setAllowClose(false);
q.setContentPadding(0);
q.open();
var toolbar=new qx.ui.toolbar.ToolBar();
q.add(toolbar);
var s=new qx.ui.toolbar.Button(null,k);
s.addListener(o,function(e){this.iframe.getWindow().history.back();
},this);
toolbar.add(s);
var t=new qx.ui.toolbar.Button(null,h);
t.addListener(o,function(e){this.iframe.getWindow().history.forward();
},this);
toolbar.add(t);
var r=new qx.ui.tooltip.ToolTip(f);
t.setEnabled(false);
s.setEnabled(false);
t.setToolTip(r);
s.setToolTip(r);
...
btnGo=new qx.ui.toolbar.Button(null,b);
btnGo.addListener(o,function(e){this.surfTo(this.txtUrl.getValue());
},this);
toolbar.add(btnGo);
...
q.add(this.iframe,{flex:1});
return q;
},surfTo:function(u){if(u.indexOf(n)!==0){u=n+u;
