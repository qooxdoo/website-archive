...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.animation.Showcase", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.animation.Showcase-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var k="setup",j="finish",h="execute",g="Shrink",f="19,66,117",e="#134275",d="#7CFC00",c="Drop out",b="Fold in",a="backgroundColor",L="Attention effects",K="Vanish effects",J="Grow",I="out",H="block",G="in",F="Base effects",E="Puff",D="default",C="Shake",s="testImg",t="Drop in",q="Fold out",r="ColorFlow",o="Toggle Background",p="Toggle Size",m="Toggle Opacity",n="testDiv",u="Pulsate",v="Switch Off",x="spring",w="bold",z="Toggle Position",y="demobrowser.demo.animation.Showcase",B="south",A="display";
qx.Class.define(y,{extend:qx.application.Standalone,members:{_toggleEnable:function(){var status=(this._vBoxes[0].getEnabled()===false);

for(var i=0,l=this._vBoxes.length;i<l;i++){this._vBoxes[i].setEnabled(status);
}},main:function(){arguments.callee.base.call(this);
this._demoElement=document.getElementById(n);
this._demoImage=document.getElementById(s);
var bl=this.getRoot();
this._vBoxes=[];
var ba=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
ba.setWidth(150);
var bm={gbxBase:new qx.ui.groupbox.GroupBox(F),gbxAttention:new qx.ui.groupbox.GroupBox(L),gbxVanish:new qx.ui.groupbox.GroupBox(K)};
var bm={gbxBase:new qx.ui.groupbox.GroupBox(F),gbxAttention:new qx.ui.groupbox.GroupBox(L),gbxVanish:new qx.ui.groupbox.GroupBox(K)};

for(var bi in bm){bm[bi].setLayout(new qx.ui.layout.Grow);
}var V=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
V.set({minWidth:120});
this._vBoxes.push(V);
var bg=new qx.ui.form.Button(m);
var bd=new qx.ui.form.Button(p);
var bq=new qx.ui.form.Button(z);
var N=new qx.ui.form.Button(o);
V.add(bg);
V.add(bd);
V.add(bq);
V.add(N);
bm.gbxBase.add(V);
var bc=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
bc.set({minWidth:120});
this._vBoxes.push(bc);
var W=new qx.ui.form.Button(C);
var bk=new qx.ui.form.Button(r);
var P=new qx.ui.form.Button(u);
bc.add(W);
bc.add(bk);
bc.add(P);
bm.gbxAttention.add(bc);
var be=new qx.ui.container.Composite(new qx.ui.layout.VBox(5));
be.set({minWidth:120});
this._vBoxes.push(be);
var R=new qx.ui.form.Button(E);
var U=new qx.ui.form.Button(c);
var T=new qx.ui.form.Button(v);
var bt=new qx.ui.form.Button(g);
var O=new qx.ui.form.Button(b);
be.add(R);
be.add(U);
be.add(bt);
be.add(T);
...
for(var bi in bm){ba.add(bm[bi]);
}bl.add(ba);
var bp=new qx.fx.effect.core.Fade(this._demoElement);
bp.addListener(k,function(){this._toggleEnable();
},this);
bp.addListener(j,function(){this._toggleEnable();
},this);
bg.addListener(h,function(){var status=qx.bom.element.Style.get(this._demoElement,A);
bp.set({from:(status==H)?1:0,to:(status==H)?0:1});
bp.start();
},this);
var bf=new qx.fx.effect.core.Scale(this._demoImage);
bf.addListener(k,function(){this._toggleEnable();
},this);
bf.addListener(j,function(){this._toggleEnable();
},this);
bd.addListener(h,function(){var status=qx.bom.element.Dimension.getWidth(this._demoImage);
bf.set({scaleTo:((status>240)?80:120),duration:0.5});
bf.start();
},this);
var bj=new qx.fx.effect.core.Move(this._demoElement);
bj.addListener(k,function(){this._toggleEnable();
},this);
bj.addListener(j,function(){this._toggleEnable();
},this);
bq.addListener(h,function(){var status=qx.bom.element.Location.getLeft(this._demoElement);
bj.set({duration:1,x:(status<300)?300:-300,y:(status<300)?100:-100,transition:x});
bj.start();
},this);
var M=new qx.fx.effect.core.Highlight(this._demoElement);
M.addListener(k,function(){this._toggleEnable();
},this);
M.addListener(j,function(){this._toggleEnable();
},this);
N.addListener(h,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,a)).toString();
M.set({startColor:(status==f)?e:d,endColor:(status==f)?d:e,restoreBackground:false});
M.start();
},this);
var S=new qx.fx.effect.combination.Shake(this._demoElement);
S.addListener(k,function(){this._toggleEnable();
},this);
S.addListener(j,function(){this._toggleEnable();
},this);
W.addListener(h,function(){S.start();
});
var X=new qx.fx.effect.combination.ColorFlow(this._demoElement);
X.addListener(k,function(){this._toggleEnable();
},this);
X.addListener(j,function(){this._toggleEnable();
},this);
bk.addListener(h,function(){var status=qx.util.ColorUtil.cssStringToRgb(qx.bom.element.Style.get(this._demoElement,a)).toString();
X.set({restoreBackground:false,startColor:(status==f)?e:d,endColor:(status==f)?d:e});
X.start();
},this);
var br=new qx.fx.effect.combination.Pulsate(this._demoElement);
br.addListener(k,function(){this._toggleEnable();
},this);
br.addListener(j,function(){this._toggleEnable();
},this);
P.addListener(h,function(){br.start();
});
var bs=new qx.fx.effect.combination.Puff(this._demoImage);
bs.setModifyDisplay(false);
bs.addListener(k,function(){this._toggleEnable();
},this);
bs.addListener(j,function(){this._toggleEnable();
},this);
R.addListener(h,function(){bs.start();
});
var bb=new qx.fx.effect.combination.Shrink(this._demoImage);
var bh=new qx.fx.effect.combination.Grow(this._demoImage);
var Y=bb;
bb.addListener(k,function(){this._toggleEnable();
},this);
bb.addListener(j,function(){this._toggleEnable();

if(bt.getLabel()==g){bt.setLabel(J);
Y=bh;
}else{bt.setLabel(g);
Y=bb;
}},this);
bh.addListener(k,function(){this._toggleEnable();
},this);
bh.addListener(j,function(){this._toggleEnable();
...
bt.addListener(h,function(){Y.start();
});
var bn=new qx.fx.effect.combination.Drop(this._demoElement);
bn.set({direction:B,yAmount:90});
bn.addListener(k,function(){this._toggleEnable();
},this);
bn.addListener(j,function(){this._toggleEnable();

if(U.getLabel()==c){U.setLabel(t);
bn.setMode(G);
}else{U.setLabel(c);
bn.setMode(I);
}},this);
U.addListener(h,function(){bn.start();
});
var Q=new qx.fx.effect.combination.Fold(this._demoElement);
Q.addListener(k,function(){this._toggleEnable();
},this);
Q.addListener(j,function(){this._toggleEnable();
qx.lang.Function.delay(function(){if(O.getLabel()==b){O.setLabel(q);
Q.setMode(I);
}else{O.setLabel(b);
Q.setMode(G);
}},100,this);
},this);
O.addListener(h,function(){Q.start();
});
var bo=new qx.fx.effect.combination.Switch(this._demoElement);
bo.setModifyDisplay(false);
bo.addListener(k,function(){this._toggleEnable();
},this);
bo.addListener(j,function(){this._toggleEnable();
},this);
T.addListener(h,function(){bo.start();
});

for(var bi in bm){bm[bi].setFont(w);
ba.add(bm[bi]);
}
for(var i=0;i<this._vBoxes.length;i++){this._vBoxes[i].setFont(D);
}}}});
})();
...
(function(){var j="legend",i="frame",h="middle",g="top",f="resize",e="qx.ui.groupbox.GroupBox",d="groupbox",c="_applyLegendPosition";
qx.Class.define(e,{extend:qx.ui.core.Widget,include:[qx.ui.core.MRemoteChildrenHandling,qx.ui.core.MRemoteLayoutHandling,qx.ui.core.MContentPadding],construct:function(k,l){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.Canvas);
this._createChildControl(i);
this._createChildControl(j);
if(k!=null){this.setLegend(k);
}
if(l!=null){this.setIcon(l);
}},properties:{appearance:{refine:true,init:d},legendPosition:{check:[g,h],init:h,apply:c,themeable:true}},members:{_createChildControlImpl:function(m){var n;

switch(m){case i:n=new qx.ui.container.Composite();
this._add(n,{left:0,top:6,right:0,bottom:0});
break;
case j:n=new qx.ui.basic.Atom();
n.addListener(f,this._repositionFrame,this);
this._add(n);
break;
...
}},_repositionFrame:function(){var p=this.getChildControl(j);
var o=this.getChildControl(i);
var q=p.getBounds().height;
if(this.getLegendPosition()==h){o.setLayoutProperties({"top":Math.round(q/2)});
}else if(this.getLegendPosition()==g){o.setLayoutProperties({"top":q});
}},getChildrenContainer:function(){return this.getChildControl(i);
},setLegend:function(a){var b=this.getChildControl(j);

if(a!==null){b.setLabel(a);
b.show();
}else{b.exclude();
}},getLegend:function(){return this.getChildControl(j).getLabel();
},setIcon:function(r){this.getChildControl(j).setIcon(r);
...
(function(){var w="Number",v="qx.event.type.Event",u="update",t="linear",s="reverse",r="Boolean",q="setup",p="none",o="qx.fx.Base",n="sinodial",g="flicker",m="__pg",j="pulse",e="_applyDuration",d="easeOutQuad",i="spring",h="easeInQuad",k="full",c="wobble",l="finish",f="Object";
qx.Class.define(o,{extend:qx.core.Object,construct:function(y){arguments.callee.base.call(this);
this.setQueue(qx.fx.queue.Manager.getInstance().getDefaultQueue());
this.__pf=qx.fx.Base.EffectState.IDLE;
this.__pg=y;
},events:{"setup":v,"update":v,"finish":v},properties:{duration:{init:0.5,check:w,apply:e},fps:{init:100,check:w},sync:{init:false,check:r},from:{init:0,check:w},to:{init:1,check:w},delay:{init:0.0,check:w},queue:{check:f},transition:{init:t,check:[t,h,d,n,s,g,c,j,i,p,k]}},statics:{EffectState:{IDLE:'idle',PREPARING:'preparing',FINISHED:'finished',RUNNING:'running'}},members:{__pf:null,__ph:null,__pi:null,__pj:null,__pk:null,__pl:null,__pm:null,__pn:null,__pg:null,_getElement:function(){return this.__pg;
},_setElement:function(A){this.__pg=A;
},_applyDuration:function(a,b){},init:function(){this.__pf=qx.fx.Base.EffectState.PREPARING;
this.__ph=0;
...
},update:function(x){},finish:function(){this.fireEvent(l);
...
this.afterFinish();
},render:function(z){if(this.__pf==qx.fx.Base.EffectState.PREPARING){this.__pf=qx.fx.Base.EffectState.RUNNING;
...
if(this.__pf==qx.fx.Base.EffectState.RUNNING){this.__pn=qx.fx.Transition.get(this.getTransition())(z)*this.__pk+this.getFrom();
...
}}},loop:function(B){if(B>=this.__pi){if(B>=this.__pj){this.end();
}var D=(B-this.__pi)/this.__pl;
var C=Math.round(D*this.__pm);
if(C>this.__ph){this.render(D);
this.__ph=C;
...
(function(){var f="__default",e="qx.fx.queue.Manager",d="__po",c="singleton",b="object";
qx.Class.define(e,{extend:qx.core.Object,type:c,members:{__po:{},getQueue:function(a){if(typeof (this.__po[a])==b){return this.__po[a];
}else{return this.__po[a]=new qx.fx.queue.Queue;
}},getDefaultQueue:function(){return this.getQueue(f);
}},destruct:function(){this._disposeMap(d);
}});
})();
(function(){var e="qx.fx.queue.Queue",d="Number",c="__pq";
qx.Class.define(e,{extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
},properties:{limit:{init:Infinity,check:d}},members:{__pp:null,__pq:[],add:function(g){var h=new Date().getTime();
g._startOn+=h;
g._finishOn+=h;

if(this.__pq.length<this.getLimit()){this.__pq.push(g);
}
if(!this.__pp){this.__pp=qx.lang.Function.periodical(this.loop,15,this);
}},remove:function(f){qx.lang.Array.remove(this.__pq,f);

if(this.__pq.length==0){window.clearInterval(this.__pp);
delete this.__pp;
}},loop:function(){var a=new Date().getTime();

for(var i=0,b=this.__pq.length;i<b;i++){this.__pq[i]&&this.__pq[i].loop(a);
}}},destruct:function(){this._disposeFields(c);
}});
})();
(function(){var i="Number",h="static",g="qx.fx.Transition";
qx.Class.define(g,{type:h,statics:{get:function(k){return qx.fx.Transition[k]||false;
...
},pulse:function(l,m){m=(typeof (m)==i)?m:5;
...
},full:function(j){return 1;
}}});
})();
(function(){var p='px',o="Boolean",n="Number",m="fontSize",l="Array",k="qx.fx.effect.core.Scale",j="12px",i='pt',h="__py",g='em',c="position",f='%',e="100%",b="string",a="absolute";
qx.Class.define(k,{extend:qx.fx.Base,properties:{scaleX:{init:true,check:o},scaleY:{init:true,check:o},scaleContent:{init:true,check:o},scaleFromCenter:{init:true,check:o},scaleFrom:{init:100.0,check:n},scaleTo:{init:100,check:n},restoreAfterFinish:{init:false,check:o},alternateDimensions:{init:[],check:l}},members:{__ps:null,__pt:null,__pu:null,__pv:null,__pw:null,__px:null,__py:null,__pz:{'top':null,'left':null,'width':null,'height':null,'fontSize':null},__pA:{'em':g,'px':p,'%':f,'pt':i},setup:function(){arguments.callee.base.call(this);
var J=this._getElement();
this.__ps=qx.bom.element.Style.get(J,c);

for(var H in this.__pz){this.__pz[H]=J.style[H];
}this.__pt=qx.bom.element.Location.getTop(J);
this.__pu=qx.bom.element.Location.getLeft(J);

try{var I=qx.bom.element.Style.get(J,m);
}catch(q){if(typeof (I)!=b){I=(qx.bom.client.Engine.MSHTML)?j:e;
}}
for(var F in this.__pA){if(I.indexOf(F)>0){this.__pv=parseFloat(I);
this.__pw=F;
break;
}}this.__px=(this.getScaleTo()-this.getScaleFrom())/100;
var G=this.getAlternateDimensions();

if(G.length==0){this.__py=[J.offsetWidth,J.offsetHeight];
}else{this.__py=G;
}},update:function(r){var t=this._getElement();
arguments.callee.base.call(this);
var s=(this.getScaleFrom()/100.0)+(this.__px*r);

if(this.getScaleContent()&&this.__pv){qx.bom.element.Style.set(t,m,this.__pv*s+this.__pw);
}this._setDimensions(this.__py[0]*s,this.__py[1]*s);
},finish:function(){arguments.callee.base.call(this);
var E=this._getElement();

if(this.getRestoreAfterFinish()){for(var C in this.__pz){var D=this.__pz[C];
qx.bom.element.Style.set(E,C,D);
}}},_setDimensions:function(u,v){var d={};
var z=this._getElement();
var x=this.getScaleX();
var y=this.getScaleY();

if(x){d.width=Math.round(u)+p;
}
if(y){d.height=Math.round(v)+p;
}
if(this.getScaleFromCenter()){var A=(u-this.__py[0])/2;
var B=(v-this.__py[1])/2;

if(this.__ps==a){if(y){d.top=this.__pt-B+p;
}
if(x){d.left=this.__pu-A+p;
}}else{if(y){d.top=-B+p;
}
if(x){d.left=-A+p;
}}}
...
(function(){var j="position",i="px",h="relative",g="Number",f="absolute",e="top",d="left",c='absolute',b="qx.fx.effect.core.Move";
qx.Class.define(b,{extend:qx.fx.Base,properties:{mode:{init:h,check:[h,f]},x:{init:0,check:g},y:{init:0,check:g}},members:{__pB:null,__pC:null,__pD:null,__pE:null,__pF:null,setup:function(){var a=this._getElement();
arguments.callee.base.call(this);

if(a.parentNode){this.__pD=qx.bom.element.Location.getLeft(a)-qx.bom.element.Location.getLeft(a.parentNode);
this.__pE=qx.bom.element.Location.getTop(a)-qx.bom.element.Location.getTop(a.parentNode);
}else{this.__pD=qx.bom.element.Location.getLeft(a);
this.__pE=qx.bom.element.Location.getTop(a);
}this.__pF=qx.bom.element.Style.get(a,j);
qx.bom.element.Style.set(a,j,f);

if(this.getMode()==c){this.__pB=this.getX()-this.__pD;
...
qx.bom.element.Style.set(m,d,l+i);
qx.bom.element.Style.set(m,e,top+i);
},afterFinishInternal:function(){qx.bom.element.Style.set(this._getElement(),j,this.__pF);
}}});
})();
(function(){var q="backgroundColor",p="Boolean",o="backgroundImage",n="Color",m="__pH",l="__pI",k="none",j="qx.fx.effect.core.Highlight",i="#ffffff",h="#",f="__pJ",g="#ffffaa";
qx.Class.define(j,{extend:qx.fx.Base,properties:{startColor:{init:i,check:n},endColor:{init:g,check:n},restoreBackground:{init:true,check:p},keepBackgroundImage:{init:false,check:p}},members:{__pG:null,__pH:null,__pI:null,__pJ:null,setup:function(){arguments.callee.base.call(this);
var r=this._getElement();
this.__pG={backgroundImage:qx.bom.element.Style.get(r,o),backgroundColor:qx.bom.element.Style.get(r,q)};

if(!this.getKeepBackgroundImage()){qx.bom.element.Style.set(r,o,k);
}this.__pH=qx.util.ColorUtil.cssStringToRgb(this.getStartColor());
this.__pI=qx.util.ColorUtil.cssStringToRgb(this.getEndColor());
this.__pJ=[this.__pI[0]-this.__pH[0],this.__pI[1]-this.__pH[1],this.__pI[2]-this.__pH[2]];
},update:function(a){arguments.callee.base.call(this);
var b=[this.__pH[0]+Math.round(this.__pJ[0]*a),this.__pH[1]+Math.round(this.__pJ[1]*a),this.__pH[2]+Math.round(this.__pJ[2]*a)];
var c=h+qx.util.ColorUtil.rgbToHexString([b[0].toString(16),b[1].toString(16),b[2].toString(16)]);
qx.bom.element.Style.set(this._getElement(),q,c);
},finish:function(){arguments.callee.base.call(this);

if(this.getRestoreBackground()){qx.lang.Function.delay(this._restore,1000,this);
}},_restore:function(){var e=this._getElement();

for(var d in this.__pG){qx.bom.element.Style.set(e,d,this.__pG[d]);
}}},destruct:function(){this._disposeFields(m,l,f);
}});
})();
(function(){var f="horizontal",e="vertical",d="qx.fx.effect.combination.Shake",c="__pK",b="Number";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
this.__pK=[new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a),new qx.fx.effect.core.Move(a)];
},properties:{direction:{init:f,check:[f,e]},duration:{init:0.5,refine:true},distance:{init:20,check:b}},members:{__pK:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var g=parseFloat(this.getDistance());
var h=parseFloat(this.getDuration())/10.0;

if(this.getDirection()==f){this.__pK[0].set({x:g,y:0,duration:h});
this.__pK[1].set({x:-g*2,y:0,duration:h*2});
this.__pK[2].set({x:g*2,y:0,duration:h*2});
this.__pK[3].set({x:-g*2,y:0,duration:h*2});
this.__pK[4].set({x:g*2,y:0,duration:h*2});
this.__pK[5].set({x:-g,y:0,duration:h*2});
}else if(this.getDirection()==e){this.__pK[0].set({y:g,x:0,duration:h});
this.__pK[1].set({y:-g*2,x:0,duration:h*2});
this.__pK[2].set({y:g*2,x:0,duration:h*2});
this.__pK[3].set({y:-g*2,x:0,duration:h*2});
this.__pK[4].set({y:g*2,x:0,duration:h*2});
this.__pK[5].set({y:-g,x:0,duration:h*2});
}var k=this.__pK;

for(var i=0,j=this.__pK.length;i<j;i++){this.__pK[i].id=i;

if(i<5){this.__pK[i].afterFinishInternal=function(){k[this.id+1].start();
};
}}this.__pK[0].start();
}},destruct:function(){this._disposeArray(c);
}});
})();
(function(){var t="linear",s="Number",r="reverse",q="Boolean",p="none",o="wobble",n="flicker",m="pulse",l="sinodial",k="easeOutQuad",d="spring",j="easeInQuad",g="full",c="Color",b="backgroundColor",f="#ffffff",e="backgroundImage",h="qx.fx.effect.combination.ColorFlow",a="__pL",i="#ffffaa";
qx.Class.define(h,{extend:qx.fx.Base,construct:function(u){arguments.callee.base.call(this,u);
this.__pL=[new qx.fx.effect.core.Highlight(u),new qx.fx.effect.core.Highlight(u)];
},properties:{startColor:{init:f,check:c},endColor:{init:i,check:c},forwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},backwardTransition:{init:t,check:[t,j,k,l,r,n,o,m,d,p,g]},forwardDuration:{init:1.0,check:s},backwardDuration:{init:1.0,check:s},delayBetween:{init:0.3,check:s},restoreBackground:{init:true,check:q},keepBackgroundImage:{init:false,check:q}},members:{__pM:null,__pL:null,start:function(){if(!arguments.callee.base.call(this)){return;
}var v=this._getElement();
this.setDuration(this.getForwardDuration()+this.getDelayBetween()+this.getBackwardDuration());
this.__pM={backgroundImage:qx.bom.element.Style.get(v,e),backgroundColor:qx.bom.element.Style.get(v,b)};
this.__pL[0].set({startColor:this.getStartColor(),endColor:this.getEndColor(),duration:this.getForwardDuration(),transition:this.getForwardTransition(),restoreBackground:false,keepBackgroundImage:this.getKeepBackgroundImage()});
this.__pL[1].set({startColor:this.getEndColor(),endColor:this.getStartColor(),duration:this.getBackwardDuration(),transition:this.getBackwardTransition(),restoreBackground:this.getRestoreBackground(),keepBackgroundImage:this.getKeepBackgroundImage(),delay:this.getDelayBetween()});
var self=this;
this.__pL[0].afterFinishInternal=function(){self.__pL[1].start();
};
this.__pL[0].start();
}},destruct:function(){this._disposeArray(a);
}});
})();
(function(){var e="opacity",d="qx.fx.effect.combination.Pulsate",c="__pN",b="sinodial";
qx.Class.define(d,{extend:qx.fx.Base,construct:function(f){arguments.callee.base.call(this,f);
var g=this.getDuration()/6;
var h=0;
this.__pN=[new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f),new qx.fx.effect.core.Fade(f)];

for(var i=0,l=this.__pN.length;i<l;i++){this.__pN[i].set({duration:g,to:((h%2)!=0)?1:0,from:((h%2)!=0)?0:1,transition:b,modifyDisplay:false});
h++;
}},properties:{duration:{init:2,refine:true}},members:{__pO:null,__pN:null,beforeSetup:function(){this.__pO=qx.bom.element.Style.get(this._getElement(),e);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var a=0;
var self=this;

for(var i=0,l=this.__pN.length;i<l;i++){this.__pN[i].id=a;

if(a<5){this.__pN[i].afterFinishInternal=function(){self.__pN[this.id+1].start();
};
}a++;
}this.__pN[0].start();
},afterFinish:function(){qx.bom.element.Style.set(this._getElement(),e,this.__pO);
}},destruct:function(){this._disposeArray(c);
}});
})();
(function(){var g="opacity",f="Boolean",e="__pR",d="none",c="qx.fx.effect.combination.Puff",b="_effects",a="display";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(l){arguments.callee.base.call(this,l);
this.__pP=new qx.fx.effect.core.Scale(l);
this.__pQ=new qx.fx.effect.core.Fade(l);
this.__pR=new qx.fx.effect.core.Parallel(this.__pP,this.__pQ);
},properties:{modifyDisplay:{init:true,check:f}},members:{__pQ:null,__pP:null,__pR:null,afterFinishInternal:function(){if(this.getModifyDisplay()){qx.bom.element.Style.set(this._getElement(),a,d);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var i=this._getElement();
var h={opacity:qx.bom.element.Style.get(i,g)};
this.__pQ.afterFinishInternal=function(){var k=this._getElement();

for(var j in h){qx.bom.element.Style.set(k,j,h[j]);
}};
this.__pP.set({scaleTo:200,sync:true,scaleFromCenter:true,scaleContent:true,restoreAfterFinish:true});
this.__pQ.set({sync:true,to:0.0,modifyDisplay:false});
this.__pR.start();
}},destruct:function(){this._disposeArray(b);
this._disposeObjects(e);
}});
})();
(function(){var c="qx.fx.effect.core.Parallel",b="__pr";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(d){arguments.callee.base.call(this);
this.__pr=arguments;
},members:{__pr:null,finish:function(){arguments.callee.base.call(this);
var g=this.__pr;

for(var i=0;i<g.length;i++){g[i].render(1.0);
g[i].cancel();
g[i].beforeFinishInternal();
g[i].beforeFinish();
g[i].finish(1.0);
g[i].afterFinishInternal();
g[i].afterFinish();
}},update:function(e){arguments.callee.base.call(this);
var f=this.__pr;
...
(function(){var m="sinodial",l="none",k="overflow",j="flicker",i="center",h="pulse",g="spring",f="full",e="wobble",d="easeOutQuad",J="easeInQuad",I="reverse",H="linear",G="scroll",F="__pU",E="Boolean",D="px",C='bottom-left',B='top-left',A='bottom-right',t="bottom-right",u="__pT",r="__pS",s="opacity",p="bottom-left",q="visible",n="qx.fx.effect.combination.Shrink",o="top-left",v="top-right",w='top-right',y='center',x="hidden",z="display";
qx.Class.define(n,{extend:qx.fx.Base,construct:function(N){arguments.callee.base.call(this,N);
this.__pS=new qx.fx.effect.core.Move(N);
this.__pT=new qx.fx.effect.core.Scale(N);
this.__pU=new qx.fx.effect.core.Parallel(this.__pS,this.__pT);
},properties:{direction:{init:i,check:[o,v,p,t,i]},moveTransition:{init:m,check:[H,J,d,m,I,j,e,h,g,l,f]},scaleTransition:{init:m,check:[H,J,d,m,I,j,e,h,g,l,f]},modifyDisplay:{init:true,check:E}},members:{__pV:null,__pS:null,__pT:null,__pU:null,setup:function(){arguments.callee.base.call(this);
qx.bom.element.Style.set(this._getElement(),k,x);
},afterFinishInternal:function(){arguments.callee.base.call(this);
var M=this._getElement();
qx.bom.element.Style.set(M,k,q);
var L;

for(var K in this.__pV){L=this.__pV[K];

if(K!=k){L+=D;
}qx.bom.element.Style.set(M,K,L);
}
if(this.getModifyDisplay()){qx.bom.element.Style.set(M,z,l);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var c=this._getElement();
var a,b;
this.__pV={top:qx.bom.element.Location.getTop(c,G),left:qx.bom.element.Location.getLeft(c,G),width:qx.bom.element.Dimension.getContentWidth(c),height:qx.bom.element.Dimension.getContentHeight(c),opacity:qx.bom.element.Style.get(c,s)};

switch(this.getDirection()){case B:a=b=0;
break;
case w:a=this.__pV.width;
b=0;
break;
case C:a=0;
b=this.__pV.height;
break;
case A:a=this.__pV.width;
b=this.__pV.height;
break;
case y:a=this.__pV.width/2;
b=this.__pV.height/2;
break;
}this.__pS.set({x:a,y:b,sync:true,transition:this.getMoveTransition()});
this.__pT.set({scaleTo:0,sync:true,transition:this.getScaleTransition(),restoreAfterFinish:true});
this.__pU.start();
}},destruct:function(){this._disposeObjects(r,u,F);
}});
})();
(function(){var p="sinodial",o="px",n="flicker",m="0px",l="center",k="pulse",j="spring",i="full",h="wobble",g="easeOutQuad",P="easeInQuad",O="reverse",N="none",M="overflow",L="linear",K="height",J='bottom-left',I='top-left',H='bottom-right',G="bottom-right",w="qx.fx.effect.combination.Grow",x="bottom-left",u="visible",v="width",s="top-left",t="__pY",q="top",r="top-right",y='top-right',z="__pW",B="block",A='center',D="__pX",C="hidden",F="left",E="display";
qx.Class.define(w,{extend:qx.fx.Base,construct:function(T){arguments.callee.base.call(this,T);
this.__pW=new qx.fx.effect.core.Move(T);
this.__pX=new qx.fx.effect.core.Scale(T);
this.__pY=new qx.fx.effect.core.Parallel(this.__pW,this.__pX);
},properties:{direction:{init:l,check:[s,r,x,G,l]},scaleTransition:{init:p,check:[L,P,g,p,O,n,h,k,j,N,i]},moveTransition:{init:p,check:[L,P,g,p,O,n,h,k,j,N,i]}},members:{__pX:null,__pW:null,__pY:null,setup:function(){arguments.callee.base.call(this);
},start:function(){if(!arguments.callee.base.call(this)){return;
}var d=this._getElement();
qx.bom.element.Style.set(d,E,B);
qx.bom.element.Style.set(d,M,C);
var b,a;
var e,f;
var c={top:qx.bom.element.Location.getTop(d),left:qx.bom.element.Location.getLeft(d),width:qx.bom.element.Dimension.getContentWidth(d),height:qx.bom.element.Dimension.getContentHeight(d),overflow:u};
this.__pX.afterFinishInternal=function(){var R;
var S=this._getElement();

for(var Q in c){R=c[Q];

if(Q!=M){R+=o;
}qx.bom.element.Style.set(S,Q,R);
}};

switch(this.getDirection()){case I:b=a=e=f=0;
break;
case y:b=c.width;
a=f=0;
e=-c.width;
...
f=-c.height;
break;
case A:b=Math.round(c.width/2);
a=Math.round(c.height/2);
e=-Math.round(c.width/2);
f=-Math.round(c.height/2);
break;
}this.__pW.set({x:e,y:f,sync:true,transition:this.getMoveTransition()});
this.__pX.set({scaleTo:100,sync:true,scaleFrom:0,scaleFromCenter:false,transition:this.getScaleTransition(),alternateDimensions:[c.width,c.height]});
qx.bom.element.Style.set(d,q,(c.top+a)+o);
qx.bom.element.Style.set(d,F,(c.left+b)+o);
qx.bom.element.Style.set(d,K,m);
qx.bom.element.Style.set(d,v,m);
this.__pY.start();
}},destruct:function(){this._disposeObjects(z,D,t);
}});
})();
(function(){var w="out",v="px",u="south",t="Number",s="north-west",r="west",q="in",p="north",o="south-east",n="south-west",g="east",m="north-east",j="display",e="__qb",d="top",i="Boolean",h="block",k="left",c="__qc",l="__qa",f="qx.fx.effect.combination.Drop";
qx.Class.define(f,{extend:qx.fx.Base,construct:function(b){arguments.callee.base.call(this,b);
this.__qa=new qx.fx.effect.core.Move(b);
this.__qb=new qx.fx.effect.core.Fade(b);
this.__qc=new qx.fx.effect.core.Parallel(this.__qa,this.__qb);
},properties:{direction:{init:u,check:[u,r,g,p,n,o,m,s]},xAmount:{init:100,check:t},yAmount:{init:100,check:t},mode:{init:w,check:[q,w]},modifyDisplay:{init:true,check:i}},members:{__qb:null,__qa:null,__qc:null,start:function(){arguments.callee.base.call(this);
var B=this._getElement();
qx.bom.element.Style.set(B,j,h);
...
switch(this.getDirection()){case u:x.x=0;
x.y=y;
break;
case p:x.x=0;
x.y=-y;
...
if(this.getMode()==q){qx.bom.element.Style.set(B,d,(A.top-x.y)+v);
qx.bom.element.Style.set(B,k,(A.left-x.x)+v);
}this.__qa.set(x);
this.__qb.afterFinishInternal=function(){for(var a in A){qx.bom.element.Style.set(B,a,A[a]+v);
}};
this.__qb.set({duration:0.5,sync:true,from:(this.getMode()==w)?1:0,to:(this.getMode()==w)?0:1,modifyDisplay:true});
this.__qc.start();
}},destruct:function(){this._disposeObjects(l,e,c);
}});
})();
(function(){var t="display",s="in",r="overflow",q="block",p="none",o="visible",n="0px",m="hidden",l="visiblity",k="__qe",f="Boolean",j="height",i="__qd",e="width",d="px",h="qx.fx.effect.combination.Fold",g="out";
qx.Class.define(h,{extend:qx.fx.Base,construct:function(v){arguments.callee.base.call(this,v);
},properties:{modifyDisplay:{init:true,check:f},mode:{init:s,check:[s,g]}},members:{__qd:null,__qe:null,__qf:null,afterFinish:function(){var w=this._getElement();

if((this.getModifyDisplay())&&(this.getMode()==s)){qx.bom.element.Style.set(w,t,q);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}var u=this._getElement();
var self=this;
this.__qd=new qx.fx.effect.core.Scale(u);
this.__qe=new qx.fx.effect.core.Scale(u);
this.__qd.afterFinishInternal=function(){self.__qe.start();
};
this.__qe.afterFinishInternal=function(){self._cleanUp();
};
this.__qf=this._getStyle();
qx.bom.element.Style.set(u,r,m);

if(this.getMode()==s){this.__qd.set({scaleTo:5,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
this.__qe.set({scaleTo:5,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:100,scaleFromCenter:true,alternateDimensions:[]});
}else{this.__qd.set({scaleTo:100,scaleContent:false,scaleY:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:true,alternateDimensions:[this.__qf.width,this.__qf.height]});
this.__qe.set({scaleTo:100,scaleContent:false,scaleX:false,duration:this.getDuration()/2,scaleFrom:0,scaleFromCenter:false,alternateDimensions:[this.__qf.width,this.__qf.height]});
qx.bom.element.Style.set(u,t,q);
qx.bom.element.Style.set(u,j,n);
qx.bom.element.Style.set(u,e,n);
}this.__qd.start();
},_cleanUp:function(){var y;
var z=this._getElement();

if((this.getMode()==s)&&(this.getModifyDisplay())){qx.bom.element.Style.set(z,t,p);
}
for(var x in this.__qf){y=this.__qf[x];

if(x!=r){y+=d;
}qx.bom.element.Style.set(z,x,y);
}qx.bom.element.Style.set(z,r,o);
...
}},destruct:function(){this._disposeObjects(i,k);
}});
})();
(function(){var n="off",m="overflow",l="__qg",k="Boolean",j="qx.fx.effect.combination.Switch",i="none",h="__qh",g="flicker",f="hidden",e="display";
qx.Class.define(j,{extend:qx.fx.Base,construct:function(a){arguments.callee.base.call(this,a);
this.setTransition(g);
var b=this.__qg=new qx.fx.effect.core.Scale(a);
this.__qg.beforeSetup=function(){qx.bom.element.Style.set(a,m,f);
};
this.__qh=new qx.fx.effect.core.Fade(a);
this.__qh.afterFinishInternal=function(){b.start();
};
},properties:{duration:{init:0.5,refine:true},from:{init:0.0,refine:true},to:{init:1.0,refine:true},modifyDisplay:{init:true,check:k},mode:{init:n,check:[n]}},members:{__qg:null,__qh:null,setup:function(){arguments.callee.base.call(this);
var p=this._getElement();
var o=qx.bom.element.Style.get(p,m);
this.__qg.afterFinishInternal=function(){qx.bom.element.Style.set(p,m,o);
};
},afterFinish:function(){if(this.getModifyDisplay()&&(this.getMode()==n)){qx.bom.element.Style.set(this._getElement(),e,i);
}},start:function(){if(!arguments.callee.base.call(this)){return;
}
if(this.getMode()==n){this.__qg.set({scaleTo:1.0,duration:this.getDuration()/2,scaleFromCenter:true,scaleX:false,scaleContent:false,restoreAfterFinish:true});
this.__qh.set({duration:this.getDuration()/2,from:this.getFrom(),to:1});
}else{}this.__qh.start();
},_applyDuration:function(c,d){this.__qg.setDuration(c/2);
this.__qh.setDuration(c/2);
