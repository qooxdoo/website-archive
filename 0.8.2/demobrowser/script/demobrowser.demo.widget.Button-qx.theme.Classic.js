...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Button", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Button-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var o="Button A",n="0",m="icon/22/actions/list-add.png",l="Button B",k="demobrowser.demo.widget.Button",j="icon/22/apps/internet-web-browser.png",i="changeChecked",h="icon/22/apps/media-video-player.png",g="icon/22/apps/internet-mail.png",f="white",b="main",d="execute",c="Toggle Button";
qx.Class.define(k,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var p=new qx.ui.layout.HBox();
p.setSpacing(10);
var q=new qx.ui.container.Composite(p);
q.setPadding(20);
this.getRoot().add(q,{left:0,top:0});
var u=new qx.ui.form.Button(o,h);
q.add(u);
var v=new qx.ui.form.Button(l,g);
v.setEnabled(false);
q.add(v);
var w=new qx.ui.form.ToggleButton(c,j);
w.focus();
q.add(w);
w.addListener(i,function(e){this.debug("Checked: "+e.getData());
},this);
var t=m;
var r=new qx.ui.form.RepeatButton(null,t);
q.add(r);
var s=new qx.ui.basic.Label(n);
s.setDecorator(b);
s.setPadding(2,4);
s.setBackgroundColor(f);
q.add(s);
r.addListener(d,function(){var a=parseInt(s.getContent())+1;
s.setContent(a.toString());
});
}}});
})();
