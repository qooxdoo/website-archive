...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HBox_Percent", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.HBox_Percent-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var n="main",m="green",l="33%",k="yellow",j="50%",i="demobrowser.demo.layout.HBox_Percent";
...
o.add(this.getBox5());
o.add(this.getBox6());
},getBox1:function(){var q=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:k,width:500,allowGrowX:false});
var s=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var r=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var p=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
q.add(s,{width:j});
q.add(r,{flex:1});
q.add(p,{flex:1});
return q;
},getBox2:function(){var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:k,width:500,allowGrowX:false});
var w=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var v=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var t=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
u.add(w,{width:l});
u.add(v,{width:l});
u.add(t,{width:l,flex:1});
return u;
},getBox3:function(){var f=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:k,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var g=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var e=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
f.add(h,{width:j});
f.add(g,{flex:1});
f.add(e,{flex:1});
return f;
},getBox4:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:k,allowGrowX:false});
...
b.add(d,{width:l,flex:1});
b.add(c,{width:l,flex:1});
b.add(a,{width:l,flex:1});
return b;
},getBox5:function(){var y=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:k,width:200,allowGrowX:false});
var A=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var z=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var x=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
y.add(A,{width:l,flex:1});
y.add(z,{width:l,flex:1});
y.add(x,{width:l,flex:1});
return y;
},getBox6:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:n,backgroundColor:k,width:500,allowGrowX:false});
var E=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var D=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
var B=new qx.ui.core.Widget().set({decorator:n,backgroundColor:m});
C.add(E,{width:l,flex:1});
C.add(D,{width:l,flex:1});
C.add(B,{width:l,flex:1});
return C;
}}});
})();
