...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Flash", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Flash-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var h="300px",g="height",f="demobrowser.demo.bom.Flash",e="width",d="div",c="120px",b="Flash.swf",a="flashMovie";
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var i=new qx.bom.Element.create(d);
qx.bom.element.Style.set(i,e,h);
qx.bom.element.Style.set(i,g,c);
document.body.appendChild(i);
qx.bom.Flash.create(i,b,a);
}}});
})();
...
(function(){var u="qx.client",t="object",s="100%",r="onbeforeunload",q="=",p="function",o="application/x-shockwave-flash",n='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">',m="param",l='" />',G="qx.bom.Flash",F='<param name="',E="onload",D="type",C="name",B='</object>',A="",z="mshtml",y="&",x='" value="',v="undefined",w="value";
qx.Class.define(G,{statics:{_flashObjects:{},create:function(H,I,J,K,L,M){if(!M){M=window;
}{};
var N={data:I,id:J,width:s,height:s};
var L=L?qx.lang.Object.clone(L):{};
if(K){for(var name in K){if(typeof L.flashvars!=v){L.flashvars+=y+name+q+K[name];
}else{L.flashvars=name+q+K[name];
}}}this.__wI(H,N,L,M);
},destroy:qx.core.Variant.select(u,{"mshtml":function(a,b){a=this.__wD(a);

if(a.readyState==4){this.__wE(a);
}else{if(!b){b=window;
}b.attachEvent(E,function(){qx.bom.Flash.__wE(a);
});
}},"default":function(j,k){j=this.__wD(j);
j.parentNode.removeChild(j);
}}),__wD:function(V){if(!V){throw new Error("DOM element is null or undefined!");
}
if(V.tagName.toLowerCase()!==t){V=V.firstChild;
}
if(!V||V.tagName.toLowerCase()!==t){throw new Error("DOM element has or is not a flash object!");
}return V;
},__wE:qx.core.Variant.select(u,{"mshtml":function(W){for(var i in W){if(typeof W[i]==p){W[i]=null;
}}W.parentNode.removeChild(W);
delete this._flashObjects[W.id];
},"default":null}),__wF:function(){for(var U in qx.bom.Flash._flashObjects){qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[U]);
}window.__wG=function(){};
window.__wH=function(){};
window.detachEvent(r,qx.bom.Flash.__wF);
},__wI:qx.core.Variant.select(u,{"mshtml":function(P,Q,R,S){R.movie=Q.data;
delete Q.data;
delete Q.classid;
var T=A;

for(name in R){T+=F+name+x+R[name]+l;
}P.innerHTML=n+T+B;
for(var name in Q){P.firstChild.setAttribute(name,Q[name]);
}this._flashObjects[Q.id]=P.firstChild;
},"default":function(c,d,e,f){delete d.classid;
delete e.movie;
var h=qx.bom.Element.create(t,d,f);
h.setAttribute(D,o);
var g;

for(var name in e){g=document.createElement(m);
g.setAttribute(C,name);
g.setAttribute(w,e[name]);
h.appendChild(g);
}c.appendChild(h);
}})},defer:function(O){if(qx.core.Variant.isSet(u,z)){window.attachEvent(r,O.__wF);
}}});
})();
