...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.GroupBox", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.GroupBox-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
var w=new qx.ui.groupbox.GroupBox(a,d);
o.add(w);
w.setLayout(new qx.ui.layout.VBox());
w.add(new qx.ui.form.CheckBox(e));
w.add(new qx.ui.form.CheckBox(g));
w.add(new qx.ui.form.CheckBox(h));
box2=new qx.ui.groupbox.CheckGroupBox(i);
o.add(box2);
...
box2.add(n);
var t=new qx.ui.container.Composite(new qx.ui.layout.VBox(4));
o.add(t);
var v=new qx.ui.form.RadioButton(f);
v.setMarginLeft(4);
t.add(v);
var u=new qx.ui.form.RadioButton(c);
u.setMarginLeft(4);
t.add(u);
box3=new qx.ui.groupbox.RadioGroupBox(b);
box3.setLayout(new qx.ui.layout.HBox(12));
t.add(box3);
var s=new qx.ui.form.RadioGroup(v,u,box3);
...
(function(){var i="legend",h="qx.event.type.Data",g="changeName",f="changeChecked",d="changeValue",c="resize",b="check-groupbox",a="qx.ui.groupbox.CheckGroupBox";
qx.Class.define(a,{extend:qx.ui.groupbox.GroupBox,properties:{appearance:{refine:true,init:b}},events:{"changeChecked":h,"changeName":h,"changeValue":h},members:{_createChildControlImpl:function(j){var k;

switch(j){case i:k=new qx.ui.form.CheckBox;
k.setChecked(true);
k.addListener(f,this._onRadioChangeChecked,this);
k.addListener(g,this._onRadioChangeName,this);
k.addListener(d,this._onRadioChangeValue,this);
k.addListener(c,this._repositionFrame,this);
this._add(k);
}return k||arguments.callee.base.call(this,j);
},_onRadioChangeChecked:function(e){var l=e.getData();
this.getChildrenContainer().setEnabled(l);
this.fireDataEvent(f,l);
},_onRadioChangeName:function(e){this.fireDataEvent(g,e.getData());
},_onRadioChangeValue:function(e){this.fireDataEvent(d,e.getData());
},getName:function(){return this.getChildControl(i).getName();
},setName:function(q){var r=this.getChildControl(i);
return q?r.setName(q):r.resetName();
},getValue:function(){return this.getChildControl(i).getValue();
},setValue:function(m){var n=this.getChildControl(i);
return m?n.setValue(m):n.resetValue();
},getChecked:function(){return this.getChildControl(i).getChecked();
},setChecked:function(o){var p=this.getChildControl(i);
return o?p.setChecked(o):p.resetChecked();
}}});
})();
...
(function(){var o="legend",n="qx.event.type.Data",m="changeName",l="changeChecked",k="changeValue",j="resize",i="qx.ui.groupbox.RadioGroupBox",h="radio-groupbox";
qx.Class.define(i,{extend:qx.ui.groupbox.GroupBox,implement:qx.ui.form.IRadioItem,properties:{appearance:{refine:true,init:h}},events:{"changeChecked":n,"changeName":n,"changeValue":n},members:{_createChildControlImpl:function(s){var t;

switch(s){case o:t=new qx.ui.form.RadioButton;
t.setChecked(true);
t.addListener(l,this._onRadioChangeChecked,this);
t.addListener(m,this._onRadioChangeName,this);
t.addListener(k,this._onRadioChangeValue,this);
t.addListener(j,this._repositionFrame,this);
this._add(t);
}return t||arguments.callee.base.call(this,s);
},_onRadioChangeChecked:function(e){var r=e.getData();
this.getChildrenContainer().setEnabled(r);
this.fireDataEvent(l,r);
},_onRadioChangeName:function(e){this.fireDataEvent(m,e.getData());
},_onRadioChangeValue:function(e){this.fireDataEvent(k,e.getData());
},getGroup:function(){return this.getChildControl(o).getGroup();
},setGroup:function(a){var b=this.getChildControl(o);
return a?b.setGroup(a):b.resetGroup();
},getName:function(){return this.getChildControl(o).getName();
},setName:function(c){var d=this.getChildControl(o);
return c?d.setName(c):d.resetName();
},getValue:function(){return this.getChildControl(o).getValue();
},setValue:function(f){var g=this.getChildControl(o);
return f?g.setValue(f):g.resetValue();
},getChecked:function(){return this.getChildControl(o).getChecked();
},setChecked:function(p){var q=this.getChildControl(o);
return p?q.setChecked(p):q.resetChecked();
