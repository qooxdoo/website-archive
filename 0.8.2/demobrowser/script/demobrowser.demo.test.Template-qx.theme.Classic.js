...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Template-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var k="values",j="_applyContent",i="),'",h="',(values.",g="qx.util.Template",f=" === undefined ? '' : values.",e="return ['",d="String",c="'].join('')";
qx.Class.define(g,{extend:qx.core.Object,construct:function(content){arguments.callee.base.call(this);

if(content!=null){this.setContent(content);
}},properties:{content:{check:d,nullable:true,apply:j}},members:{_applyContent:function(a,b){this.run=new Function(k,e+a.replace(this.__wO,this.__wN)+c);
},run:function(m){throw new Error("Please define any content first!");
},__wN:function(l,name){return h+name+f+name+i;
},__wO:/\{([\w-]+)}/g}});
})();
