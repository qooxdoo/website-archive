...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.Decoration", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.ui.Decoration-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var g="demobrowser.demo.ui.Decoration";
...
},getDecorations:function(){var d=qx.theme.manager.Decoration.getInstance().getTheme();
...
for(var c in e){a.add(new qx.ui.basic.Label(c).set({decorator:c,padding:5,height:80,width:80}),{row:Math.floor(i/f),column:i%f});
i+=1;
}return a;
}}});
})();
