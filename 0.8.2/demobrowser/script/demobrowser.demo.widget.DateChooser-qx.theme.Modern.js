...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.DateChooser", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.DateChooser-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var r="execute",q="- Use the cursors keys to move the selection.",p="- Double-click or enter/space-key will fire an execute event.",o="bold",n="- Page-keys / shift + page-keys switch months/years.",m="changeDate",l="select a date",k="Show January 1981",j="Set current date",i="Execute: ",c="Change: ",h="center",g="demobrowser.demo.widget.DateChooser",b="Remove the selection",a="Description",f="- Escape will remove the selection.",d="Set Value";
qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(8));
var G=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
...
var F=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
H.add(u);
H.add(F);
y.add(H);
y.add(z);
...
G.addBefore(w,y);
var E=new qx.ui.basic.Label(l);
C.add(E);
w.addListener(m,function(e){E.setContent(c+e.getData());
},this);
...
x.setAlignX(h);
u.add(x);
x.addListener(r,function(e){w.setDate(new Date());
});
var A=new qx.ui.form.Button(k);
u.add(A);
A.addListener(r,function(e){w.showMonth(0,1981);
});
var v=new qx.ui.form.Button(b);
u.add(v);
v.addListener(r,function(e){w.setDate(null);
});
var D=new qx.ui.form.TextField(new Date().toString());
D.setWidth(200);
z.add(D);
var B=new qx.ui.form.Button(d);
z.add(B);
B.addListener(r,function(e){w.setValue(D.getValue());
},this);
var t=new qx.ui.basic.Label(a);
t.setFont(o);
F.add(t);
F.add(new qx.ui.basic.Label(q));
F.add(new qx.ui.basic.Label(n));
F.add(new qx.ui.basic.Label(p));
F.add(new qx.ui.basic.Label(f));
}}});
})();
