...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.root.Inline_Dynamic_Resize", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.root.Inline_Dynamic_Resize-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
var w=new qx.ui.root.Inline(document.getElementById(o),false,true);
w.setLayout(new qx.ui.layout.Canvas());
w.add(new qx.ui.form.Button(null,c),{edge:0});
...
v.add(slideBar,{edge:0});
var u=[q,e,p,b,j,r,a,d,s,n,g,f];

for(var i=0;i<u.length;i++){slideBar.add((new qx.ui.basic.Image(m+u[i])).set({decorator:h,padding:4}));
}}}});
})();
