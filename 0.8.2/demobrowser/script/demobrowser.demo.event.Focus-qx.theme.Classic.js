...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.Focus", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.event.Focus-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var l="1px dotted red",k="",j="demobrowser.demo.event.Focus",i="blur",h="focusout",g="focus",f="#E8ECF6",d="deactivate",c="activate",b="1px solid black",a="focusin";
qx.Class.define(j,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
qx.event.Registration.addListener(document.documentElement,c,this._onActivate,this,true);
qx.event.Registration.addListener(document.documentElement,d,this._onDeactivate,this,true);
qx.event.Registration.addListener(document.documentElement,a,this._onFocusIn,this);
qx.event.Registration.addListener(document.documentElement,h,this._onFocusOut,this);
...
e.getTarget().style.background=k;
},_onFocusIn:function(e){this.debug("FocusIn: "+e.getTarget());

if(qx.bom.client.Engine.MSHTML){e.getTarget().style.border=l;
}else{e.getTarget().style.outline=l;
}},_onFocusOut:function(e){this.debug("FocusOut: "+e.getTarget());

if(qx.bom.client.Engine.MSHTML){e.getTarget().style.border=b;
