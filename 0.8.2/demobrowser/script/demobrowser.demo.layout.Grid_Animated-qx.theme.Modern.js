...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Grid_Animated", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Grid_Animated-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var o="green",n="sinodial",m="click",l="yellow",k="width",j="height",i="demobrowser.demo.layout.Grid_Animated",h="orange",g="main";
...
q.add(this.getAnimGrid(),{row:0,column:0});
},getNewWidget:function(){var p=new qx.ui.core.Widget().set({width:50,height:50,backgroundColor:o});
p.addListener(m,function(e){if(this._active==p){return;
}var e=[];
var c=0.3;

if(this._active){this._active.set({backgroundColor:o,width:50,height:50});
}p.set({backgroundColor:h});
var f=p.getBounds();
e.push(new demobrowser.demo.layout.Grid_Animated_Property(p,k).set({from:f.width,to:200,duration:c,transition:n}));
e.push(new demobrowser.demo.layout.Grid_Animated_Property(p,j).set({from:f.height,to:200,duration:c,transition:n}));
var d=new qx.fx.effect.core.Parallel(e[0],e[1]);
d.start();
this._active=p;
},this);
return p;
},getAnimGrid:function(){var a=new qx.ui.container.Composite().set({decorator:g,backgroundColor:l,width:500,height:500});
...
(function(){var c="demobrowser.demo.layout.Grid_Animated_Property";
qx.Class.define(c,{extend:qx.fx.Base,construct:function(a,b){this._propName=b;
