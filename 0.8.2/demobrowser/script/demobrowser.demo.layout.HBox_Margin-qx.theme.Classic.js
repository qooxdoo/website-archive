...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.HBox_Margin-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var o="main",n="green",m="yellow",l="middle",k="demobrowser.demo.layout.HBox_Margin";
...
var w=new qx.ui.container.Composite(u).set({decorator:o,backgroundColor:m,allowGrowX:false});
u.setSpacing(5);
...
return w;
},getBox2:function(){var z=new qx.ui.layout.HBox();
var B=new qx.ui.container.Composite(z).set({decorator:o,backgroundColor:m,allowGrowX:false});
z.setSpacing(5);
...
B.add(A);
D.setMarginTop(20);
A.setMarginBottom(30);
return B;
},getBox3:function(){var f=new qx.ui.layout.HBox();
var h=new qx.ui.container.Composite(f).set({decorator:o,backgroundColor:m,height:100,allowGrowX:false});
f.setSpacing(5);
f.setAlignY(l);
...
var r=new qx.ui.container.Composite(p).set({decorator:o,backgroundColor:m,height:100,allowGrowX:false});
p.setSpacing(5);
p.setAlignY(l);
...
q.setMarginTop(5);
q.setMinHeight(50);
q.setMarginBottom(20);
return r;
},getBox5:function(){var a=new qx.ui.layout.HBox();
var c=new qx.ui.container.Composite(a).set({decorator:o,backgroundColor:m,height:100,allowGrowX:false});
a.setSpacing(5);
a.setAlignY(l);
