...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.progressive.ProgressiveTable_Boolean", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.progressive.ProgressiveTable_Boolean-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
var o=0;
var k=function(r){var u=[];
var t=new Date().getTime();
var v=400*24*60*60*1000;

for(var w=0;w<r;w++){var s=new Date(t+Math.random()*v-v/2);
u.push({renderer:e,location:c,data:[o++,(Math.floor(Math.random()*2)==0?false:true)]});
}return u;
};
...
(function(){var j="'; ",i="  this.src='",h="  var filters = this.filters.item(loader); ",g="qx.client",f="}",e="{",d="  var loader = 'DXImageTransform.Microsoft.AlphaImageLoader'; ",c="mshtml",b="  filters.sizingMethod = 'scale'; ",a="  filters.src='",G="\"",F="  this.attributes.setNamedItem(namedItem); ",E="} catch (e) { ",D="var node = this.attributes.getNamedItem('celldata'); ",C="qx.ui.progressive.renderer.table.cell.Boolean",B="decoration/table/boolean-true.png",A="var value = node.nodeValue; ",z="decoration/table/boolean-false.png",y="celldata='1' ",x="  node.nodeValue='0'; ",q="  this.attributes.setNamedItem(node); ",r="if (value == '0') ",o="celldata='0' ",p="__xV",m="  node.nodeValue='1'; ",n="onclick=\"",k="  namedItem.value = node.nodeValue; ",l="var src; ",s="try { ",t="  var namedItem = document.createAttribute('celldata'); ",v="} ",u="else ",w="__xW";
qx.Class.define(C,{extend:qx.ui.progressive.renderer.table.cell.Icon,construct:function(){arguments.callee.base.call(this);
var N=qx.util.AliasManager.getInstance();
var O=qx.util.ResourceManager;
var M=N.resolve(B);
var L=N.resolve(z);
this.__xV=O.toUri(M);
this.__xW=O.toUri(L);
},properties:{allowToggle:{init:false}},members:{__xV:null,__xW:null,__xX:null,__xY:null,__ya:null,__yb:null,__yc:null,__yd:null,_identifyImage:function(J){var K={imageWidth:11,imageHeight:11};

switch(J.cellData){case true:K.url=this.__xV;
K.extras=y;
break;
case false:K.url=this.__xW;
K.extras=o;
break;
default:K.url=null;
break;
}
if(this.getAllowToggle()){K.extras+=n+D+A+l+r+e;

if(qx.core.Variant.isSet(g,c)&&/\.png$/i.test(this.__xV)){K.extras+=i+this.__imageBlank+j+d+h+a+this.__xV+j+b;
}else{K.extras+=i+this.__xV+j;
}K.extras+=m+v+u+e;

if(qx.core.Variant.isSet(g,c)&&/\.png$/i.test(this.__xW)){K.extras+=i+this.__imageBlank+j+d+h+a+this.__xW+j+b;
}else{K.extras+=i+this.__xW+j;
}K.extras+=x+f;
K.extras+=s+q+E+t+k+F+f+G;
}return K;
},_getCellStyle:function(H){var I=arguments.callee.base.call(this,H);
return I;
}},destruct:function(){this._disposeFields(p,w);
}});
})();
