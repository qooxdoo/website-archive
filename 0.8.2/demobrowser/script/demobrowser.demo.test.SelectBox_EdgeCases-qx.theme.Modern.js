...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.SelectBox_EdgeCases", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.SelectBox_EdgeCases-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var n="Times New Roman",m="Long list",l="Long button, short text",k="",j="Fonts",h="Font ",g="Tahoma",f="Courier New",e="Item ",d="Arial",c="demobrowser.demo.test.SelectBox_EdgeCases";
qx.Class.define(c,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var x=new qx.ui.container.Scroll();
...
x.add(this.container);
this.getRoot().add(x,{edge:0});
this.addBox1();
this.addBox2();
this.addBox3();
},addBox1:function(){this.container.add(new qx.ui.basic.Label(m),{left:25,top:20});
var v=new qx.ui.form.SelectBox();
v.setMaxListHeight(null);

for(var i=0;i<300;i++){var w=new qx.ui.form.ListItem(k+i);
v.add(w);
}this.container.add(v,{left:20,top:40});
},addBox2:function(){this.container.add(new qx.ui.basic.Label(j),{left:25,bottom:45});
var u=new qx.ui.form.SelectBox();
var p=new qx.bom.Font(12,[g]);
var q=new qx.bom.Font(15,[d]);
var o=new qx.bom.Font(18,[f]);
var s=new qx.bom.Font(21,[n]);
var r=[p,q,o,s];

for(var i=0;i<r.length;i++){var t=new qx.ui.form.ListItem(h+(i+1));
t.setFont(r[i]);
u.add(t);
}this.container.add(u,{left:20,bottom:20});
},addBox3:function(){this.container.add(new qx.ui.basic.Label(l),{left:205,top:20});
var a=new qx.ui.form.SelectBox();
a.setWidth(300);
a.setMaxListHeight(100);

for(var i=0;i<20;i++){var b=new qx.ui.form.ListItem(e+i);
if(i%5==1){b.setEnabled(false);
}a.add(b);
}this.container.add(a,{left:200,top:40});
}}});
})();
