...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.ScrollContainer_EdgeCaseHeight", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.ScrollContainer_EdgeCaseHeight-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var y="changeValue",x="execute",w="ScrollbarX:",v="ScrollbarY:",u="Toggle content",t="blue",s="black",r="Off",q="auto",p="demobrowser.demo.test.ScrollContainer_EdgeCaseHeight",j="white",o="on",m="off",i="On",h="Toggle pane",l="solid",k="Auto",n="Content size: 300x300";
...
scrollContainer.set({width:200,height:300});
this.getRoot().add(scrollContainer,{left:10,top:10});
scrollContainer.add(this.generateBox());
var d=new qx.ui.form.Button(h);
var g=true;
d.addListener(x,function(){scrollContainer.setWidth(g?300:200);
g=!g;
});
this.getRoot().add(d,{left:330,top:20});
var c=new qx.ui.form.Button(u);
var f=true;
c.addListener(x,function(){scrollContainer.getChild().setWidth(f?100:300);
f=!f;
});
this.getRoot().add(c,{left:430,top:20});
var b=this.generateScrollbarConfig(w,100);
var a=this.generateScrollbarConfig(v,120);
b.addListener(y,function(e){scrollContainer.setScrollbarX(e.getData());
});
a.addListener(y,function(e){scrollContainer.setScrollbarY(e.getData());
});
},generateScrollbarConfig:function(z,top){var D=new qx.ui.container.Composite(new qx.ui.layout.HBox(6));
var z=new qx.ui.basic.Label(z);
z.setMarginRight(20);
var A=new qx.ui.form.RadioButton(k);
var C=new qx.ui.form.RadioButton(i);
var B=new qx.ui.form.RadioButton(r);
A.setValue(q);
C.setValue(o);
B.setValue(m);
A.setChecked(true);
var E=new qx.ui.form.RadioGroup(A,C,B);
D.add(z);
D.add(A);
D.add(C);
D.add(B);
this.getRoot().add(D,{left:330,top:top});
return E;
},generateBox:function(){var F=new qx.ui.basic.Label(n).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:t,textColor:j,padding:10,decorator:new qx.ui.decoration.Single(4,l,s)});
return F;
}}});
})();
