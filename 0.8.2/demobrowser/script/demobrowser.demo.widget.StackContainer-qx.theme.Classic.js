...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.StackContainer-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var t="execute",s="yellow",r="teal",q="gray",p="red",o="change",n="Next",m="Previous",l="green",k="icon/22/actions/go-next.png",f="icon/22/actions/go-previous.png",j="orange",h="main",d="blue",c="resize",g="demobrowser.demo.widget.StackContainer";
...
},addSimpleStack:function(){var w=new qx.ui.container.Stack();
w.setDecorator(h);
w.setWidth(200);
w.setHeight(120);
this.getRoot().add(w,{left:20,top:20});
var u=new qx.ui.container.Composite((new qx.ui.layout.HBox).set({spacing:4}));
var z=new qx.ui.form.Button(m,f);
var x=new qx.ui.form.Button(n,k);
u.add(z);
u.add(x);
this.getRoot().add(u,{left:20,top:150});
z.addListener(t,w.previous,w);
x.addListener(t,w.next,w);
var y=[p,q,d,j,r,s,l];
var v;

for(var i=0;i<y.length;i++){v=new qx.ui.core.Widget;
v.setBackgroundColor(y[i]);
w.add(v);
}w.addListener(o,function(e){this.debug("Selected: "+e.getData().getBackgroundColor());
});
...
var F=new qx.ui.form.Button(m,f);
var D=new qx.ui.form.Button(n,k);
A.add(F);
A.add(D);
this.getRoot().add(A,{left:250,top:150});
F.addListener(t,C.previous,C);
D.addListener(t,C.next,C);
var E=[p,q,d,j,r,s,l];
var B;
...
C.add(B);
}C.addListener(o,function(e){var b=e.getData();
this.debug("Selected: "+b.getBackgroundColor()+" ("+b.getWidth()+"x"+b.getHeight()+")");
});
C.addListener(c,function(e){var a=this.getBounds();
