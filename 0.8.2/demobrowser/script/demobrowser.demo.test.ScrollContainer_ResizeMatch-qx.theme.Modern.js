...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.ScrollContainer_ResizeMatch", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.ScrollContainer_ResizeMatch-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
scrollContainer.set({width:200,height:200});
this.getRoot().add(scrollContainer,{left:10,top:10});
scrollContainer.add(this.generateBox());
var g=new qx.ui.form.Button(e);
var h=true;
g.addListener(b,function(){scrollContainer.setWidth(h?300:200);
scrollContainer.setHeight(h?300:200);
h=!h;
});
this.getRoot().add(g,{left:10,top:400});
},generateBox:function(){var i=new qx.ui.basic.Label(a).set({width:300,height:300,allowShrinkX:false,allowShrinkY:false,backgroundColor:f,textColor:d,padding:10});
return i;
}}});
})();
