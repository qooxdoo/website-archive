...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.CellEvents", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.virtual.CellEvents-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var m='</p>',l=' / ',k='<p style="color:green;">You clicked on cell ',j="",i="cellClick",h='<p style="color:yellow;">You rightclicked cell ',g='<p style="color:red;">You double clicked cell ',f="demobrowser.demo.virtual.CellEvents",d="main",c="cellDblclick",b="cellContextmenu";
...
p.addListener(b,this._onContextMenu,this);
p.addListener(c,this._onDblclickPane,this);
...
},_onCellClick:function(e){var o=k+e.getRow()+l+e.getColumn()+m;
this.__uh(o);
},_onContextMenu:function(e){var n=h+e.getRow()+l+e.getColumn()+m;
this.__uh(n);
},_onDblclickPane:function(e){var r=g+e.getRow()+l+e.getColumn()+m;
this.__uh(r);
},__uh:function(a){this.logger.setHtml(this.logger.getHtml()+a);
}}});
})();
...
},_fullUpdate:function(r,s,t,u,v,w){var B=[];
var C=0;
var top=0;
var E=r;
var D=t;

for(var x=0;x<v.length;x++){var C=0;
var D=t;
var z=v[x];

for(var y=0;y<w.length;y++){var A=w[y];
B[B.length]=this.getCellHtml(E,D,C,top,A,z);
D++;
C+=A;
}top+=z;
E++;
}this.getContentElement().setAttribute(b,B.join(k));
}}});
})();
