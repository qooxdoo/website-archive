...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.virtual.Messenger-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var q="execute",p="middle",o="Add",n="Group:",m="Add user",l="",k="New Group",j="left",i="appear",h="right",c="demobrowser.demo.virtual.Messenger",g="Cancel",f="Contacts",b="Name:",a="Remove last contact",e="Add a contact...",d="icon/16/actions/list-add.png";
qx.Class.define(c,{extend:qx.application.Standalone,members:{__sq:null,messenger:null,__sr:null,main:function(){arguments.callee.base.call(this);
var A=this.getRoot();
var D=new qx.ui.window.Window(f).set({contentPadding:0,showClose:false,showMinimize:false});
...
D.add(this.messenger);
var C=new qx.ui.form.Button(e);
var B=new qx.ui.form.Button(a);
C.addListener(q,this.showAddContactWindow,this);
B.addListener(q,this.removeContact,this);
A.add(C,{left:20,top:10});
A.add(B,{left:20,top:40});
},showAddContactWindow:function(){if(this.__sq==null){var r=new qx.ui.layout.Grid(5,10);
var t=new qx.ui.window.Window(m,d);
t.set({width:165,height:100,showMinimize:false,showClose:false,showMaximize:false});
t.setLayout(r);
var v=new qx.ui.basic.Label(b);
var w=new qx.ui.form.TextField();
var u=new qx.ui.form.TextField(k);
...
t.addListener(i,w.focus,w);
x.addListener(q,t.close,t);
y.addListener(q,function(){var z=new demobrowser.demo.virtual.messenger.BuddyModel();
z.setName(w.getValue());
z.setGroup(u.getValue());
this.messenger.getModel().push(z);
t.close();
},this);
t.add(v,{row:0,column:0});
t.add(w,{row:0,column:1,colSpan:2});
t.add(s,{row:1,column:0});
t.add(u,{row:1,column:1,colSpan:2});
t.add(y,{row:2,column:1});
t.add(x,{row:2,column:2});
r.setColumnAlign(0,j,p);
r.setColumnAlign(1,h,p);
this.getRoot().add(t,{left:20,top:20});
this.__sq=t;
}this.__sr.setValue(l);
this.__sq.open();
...
(function(){var j="model",i="changeModel",h="demobrowser.demo.virtual.messenger.Roster",g="qx.data.Array",f="rgb(238, 243, 255)",e="row-layer",d="off",c="white",b="rgb(60, 97, 226)",a="auto";
qx.Class.define(h,{extend:qx.ui.virtual.form.List,construct:function(){arguments.callee.base.call(this);
this.set({scrollbarX:d,scrollbarY:a,width:200,height:300,rowHeight:28,useWidgetCells:true,decorator:null});
var m=new demobrowser.demo.virtual.messenger.Controller(null,this);
this.bind(j,m,j);
this.rowLayer=this.getChildControl(e);
this.rowLayer.set({colorEven:c,colorOdd:f});
this.getPane().addLayer(this.rowLayer);
},properties:{model:{event:i,check:g,nullable:true}},members:{styleGroup:function(k){var l=b;
this.getPane().getRowConfig().setItemSize(k,15);
this.rowLayer.setColor(k,l);
...
(function(){var r="cell.row",q="changeOpen",p="",o="demobrowser.demo.virtual.messenger.Controller";
qx.Class.define(o,{extend:qx.ui.virtual.form.ListController,construct:function(v,w){arguments.callee.base.call(this,v,w);
this.__ty=new demobrowser.demo.virtual.messenger.BuddyCell();
this.__tz=new demobrowser.demo.virtual.messenger.GroupCell();
this.__tz.addListener(q,this._onChangeOpenGroup,this);
this.__tA={};
this.__tB=[];
},members:{_onChangeOpenGroup:function(e){var l=this.__tA[e.getData().getUserData(r)];
this.debug("open "+l.getName());
},getCellRenderer:function(n){if(this.__tA[n]){return this.__tz;
}else{return this.__ty;
}},isRowSelectable:function(z){return this.__tA[z]?false:true;
},_visualizeGrouping:function(s){var t=this.getTarget();

if(t){for(var u in this.__tA){var u=parseInt(u);

if(!s[u]){t.unstyleGroup(u);
}}
for(var u in s){var u=parseInt(u);

if(!this.__tA[u]){t.styleGroup(u);
}}}this.__tA=s;
},_updateGrouping:function(){var h=this.getModel();
this.__tB=[];
var d={};

if(h&&h.length>0){this.__tB=qx.lang.Array.clone(h.toArray());
this.__tB.sort(function(a,b){var x=a.getGroup();
var y=b.getGroup();

if(x==y){return a.getName()<b.getName()?-1:1;
}return x>y?-1:1;
});
var g=this.__tB[0];
var c=new demobrowser.demo.virtual.messenger.GroupSeparator().set({name:g.getGroup(),index:0});
this.__tB.unshift(c);
d[0]=c;
var i=1;

do{var f=this.__tB[i];

if(f.getGroup()!==c.getName()){var c=new demobrowser.demo.virtual.messenger.GroupSeparator().set({name:f.getGroup(),index:i});
qx.lang.Array.insertAt(this.__tB,c,i);
d[i]=c;
i++;
}i++;
}while(i<this.__tB.length);
...
this._updateGrouping();
this._syncRowCount();
},_syncRowCount:function(){this.getTarget().setRowCount(this.__tB.length);
},getCellData:function(m){return this.__tB[m]||p;
}}});
})();
...
(function(){var l="decoration/arrows/down-invert.png",k="changeOpen",j="bold",i="click",h="white",g="demobrowser.demo.virtual.messenger.GroupCell",f="decoration/arrows/right-invert.png",d="qx.event.type.Data";
qx.Class.define(g,{extend:qx.ui.virtual.cell.AbstractWidget,events:{changeOpen:d},members:{_createWidget:function(){var c=new qx.ui.basic.Atom().set({icon:l,textColor:h,font:j,padding:[0,3]});
c.addListener(i,function(e){this.fireDataEvent(k,e.getCurrentTarget());
},this);
return c;
},updateData:function(a,b){a.setLabel(b.getName());
},updateStates:function(m,n){if(n.closed){m.setIcon(f);
}else{m.setIcon(l);
}}}});
})();
(function(){var f="changeName",e="changeIndex",d="demobrowser.demo.virtual.messenger.GroupSeparator",c="Friends",b="Integer",a="String";
qx.Class.define(d,{extend:qx.core.Object,construct:function(name){arguments.callee.base.call(this);

if(name!==undefined){this.setName(name);
}},properties:{name:{init:c,event:f,check:a},index:{event:e,check:b}}});
})();
