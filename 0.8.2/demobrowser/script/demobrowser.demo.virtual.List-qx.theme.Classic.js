...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.virtual.List", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$resources = {"qx/decoration/Classic/arrows/down-small-invert.gif": [5, 3, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -7, 0], "qx/decoration/Classic/menu/checkbox-invert.gif": [16, 7, "gif", "qx", "qx/decoration/Classic/menu-combined.gif", 0, 0], "qx/decoration/Classic/arrows-combined.gif": [124, 7, "gif", "qx"], "qx/decoration/Classic/colorselector-combined.gif": [46, 11, "gif", "qx"], "qx/decoration/Classic/datechooser/last-month.png": [16, 16, "png", "qx"], "qx/decoration/Classic/treevirtual/start_minus.gif": [19, 16, "gif", "qx"], "qx/icon/Oxygen/48/devices/input-mouse.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/left.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -50, 0], "qx/icon/Tango/48/devices/printer.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/previous-invert.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -62, 0], "qx/decoration/Classic/shadow/shadow-small-tr.png": [5, 5, "png", "qx", "qx/decoration/Classic/shadow-small-tb-combined.png", 0, -25], "qx/decoration/Classic/datechooser/next-year.png": [16, 16, "png", "qx"], "qx/icon/Tango/48/devices/pda.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/left-small.gif": [3, 5, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -47, 0], "qx/decoration/Classic/datechooser/last-month-invert.png": [16, 16, "png", "qx"], "qx/icon/Oxygen/48/places/folder.png": [48, 48, "png", "qx"], "qx/decoration/Classic/cursors-combined.gif": [71, 20, "gif", "qx"], "qx/decoration/Classic/treevirtual/end_plus.gif": [19, 16, "gif", "qx"], "qx/icon/Oxygen/48/devices/drive-optical.png": [48, 48, "png", "qx"], "qx/decoration/Classic/table/descending.png": [10, 10, "png", "qx", "qx/decoration/Classic/table-combined.png", -52, 0], "qx/decoration/Classic/menu/checkbox.gif": [16, 7, "gif", "qx", "qx/decoration/Classic/menu-combined.gif", -16, 0], "qx/decoration/Classic/shadow/shadow-small-c.png": [40, 136, "png", "qx"], "qx/icon/Tango/48/devices/audio-input-microphone.png": [48, 48, "png", "qx"], "qx/decoration/Classic/splitpane/knob-vertical.png": [15, 4, "png", "qx"], "qx/decoration/Classic/table/descending-invert.png": [10, 10, "png", "qx", "qx/decoration/Classic/table-combined.png", -42, 0], "qx/decoration/Classic/tree/minus.gif": [19, 16, "gif", "qx"], "qx/icon/Tango/48/devices/network-wired.png": [48, 48, "png", "qx"], "qx/decoration/Classic/splitpane/knob-horizontal.png": [4, 15, "png", "qx"], "qx/decoration/Classic/table-combined.png": [72, 11, "png", "qx"], "qx/decoration/Classic/shadow/shadow-small-br.png": [5, 5, "png", "qx", "qx/decoration/Classic/shadow-small-tb-combined.png", 0, -10], "qx/decoration/Classic/table/ascending-invert.png": [10, 10, "png", "qx", "qx/decoration/Classic/table-combined.png", 0, 0], "qx/icon/Oxygen/48/devices/phone.png": [48, 48, "png", "qx"], "qx/decoration/Classic/form/checkbox-checked-hovered.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -28, 0], "qx/icon/Oxygen/16/places/folder.png": [16, 16, "png", "qx"], "qx/decoration/Classic/shadow-tb-combined.png": [15, 90, "png", "qx"], "qx/icon/Tango/48/devices/media-optical.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/forward.gif": [8, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -32, 0], "qx/decoration/Classic/shadow/shadow-small-tl.png": [5, 5, "png", "qx", "qx/decoration/Classic/shadow-small-tb-combined.png", 0, -20], "qx/decoration/Classic/treevirtual/start.gif": [19, 16, "gif", "qx"], "qx/decoration/Classic/shadow/shadow-br.png": [15, 15, "png", "qx", "qx/decoration/Classic/shadow-tb-combined.png", 0, -30], "qx/icon/Tango/48/devices/audio-card.png": [48, 48, "png", "qx"], "qx/decoration/Classic/menu/radiobutton.gif": [16, 5, "gif", "qx", "qx/decoration/Classic/menu-combined.gif", -48, 0], "qx/icon/Oxygen/48/devices/network-wireless.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/up-small.gif": [5, 3, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -112, 0], "qx/decoration/Classic/arrows/down.gif": [7, 4, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -17, 0], "qx/decoration/Classic/treevirtual/start_plus.gif": [19, 16, "gif", "qx"], "qx/icon/Tango/48/devices/network-wireless.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/right-invert.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -86, 0], "qx/decoration/Classic/treevirtual/cross_minus.gif": [19, 16, "gif", "qx"], "qx/decoration/Classic/shadow/shadow-small-b.png": [5, 5, "png", "qx", "qx/decoration/Classic/shadow-small-tb-combined.png", 0, 0], "qx/decoration/Classic/cursors/copy.gif": [19, 15, "gif", "qx", "qx/decoration/Classic/cursors-combined.gif", -19, 0], "qx/decoration/Classic/arrows/rewind-invert.gif": [8, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -70, 0], "qx/decoration/Classic/shadow/shadow-b.png": [15, 15, "png", "qx", "qx/decoration/Classic/shadow-tb-combined.png", 0, 0], "qx/decoration/Classic/arrows/right-small.gif": [3, 5, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -93, 0], "qx/icon/Oxygen/16/places/folder-open.png": [16, 16, "png", "qx"], "qx/decoration/Classic/menu/radiobutton-invert.gif": [16, 5, "gif", "qx", "qx/decoration/Classic/menu-combined.gif", -32, 0], "qx/icon/Oxygen/48/devices/audio-input-microphone.png": [48, 48, "png", "qx"], "qx/icon/Tango/48/devices/drive-optical.png": [48, 48, "png", "qx"], "qx/icon/Oxygen/48/devices/scanner.png": [48, 48, "png", "qx"], "qx/icon/Oxygen/48/devices/computer.png": [48, 48, "png", "qx"], "qx/icon/Oxygen/16/apps/office-calendar.png": [16, 16, "png", "qx"], "qx/decoration/Classic/datechooser/next-month.png": [16, 16, "png", "qx"], "qx/decoration/Classic/datechooser/last-year.png": [16, 16, "png", "qx"], "qx/decoration/Classic/cursors/move.gif": [13, 9, "gif", "qx", "qx/decoration/Classic/cursors-combined.gif", -38, 0], "qx/decoration/Classic/arrows/up-small-invert.gif": [5, 3, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -107, 0], "qx/decoration/Classic/shadow/shadow-l.png": [15, 382, "png", "qx", "qx/decoration/Classic/shadow-lr-combined.png", 0, 0], "qx/icon/Oxygen/48/devices/pda.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/up-invert.gif": [7, 4, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -100, 0], "qx/icon/Tango/48/devices/camera-web.png": [48, 48, "png", "qx"], "qx/decoration/Classic/table/select-column-order.png": [10, 9, "png", "qx", "qx/decoration/Classic/table-combined.png", -62, 0], "qx/icon/Oxygen/48/devices/network-wired.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/previous.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -66, 0], "qx/decoration/Classic/form/checkbox-hovered.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -98, 0], "qx/decoration/Classic/window/minimize.gif": [9, 9, "gif", "qx", "qx/decoration/Classic/window-captionbar-buttons-combined.gif", -19, 0], "qx/decoration/Classic/shadow/shadow-small-bl.png": [5, 5, "png", "qx", "qx/decoration/Classic/shadow-small-tb-combined.png", 0, -5], "qx/decoration/Classic/cursors/alias.gif": [19, 15, "gif", "qx", "qx/decoration/Classic/cursors-combined.gif", 0, 0], "qx/decoration/Classic/treevirtual/end_minus.gif": [19, 16, "gif", "qx"], "qx/decoration/Classic/arrows/down-invert.gif": [7, 4, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", 0, 0], "qx/decoration/Classic/form/radiobutton-checked-hovered.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -168, 0], "qx/decoration/Classic/shadow/shadow-small-l.png": [5, 136, "png", "qx", "qx/decoration/Classic/shadow-small-lr-combined.png", 0, 0], "qx/decoration/Classic/colorselector/brightness-field.png": [19, 256, "png", "qx"], "qx/icon/Tango/48/devices/phone.png": [48, 48, "png", "qx"], "qx/decoration/Classic/form/radiobutton-focused.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -224, 0], "qx/decoration/Classic/datechooser/last-year-invert.png": [16, 16, "png", "qx"], "qx/decoration/Classic/datechooser/next-year-invert.png": [16, 16, "png", "qx"], "qx/icon/Tango/48/devices/computer.png": [48, 48, "png", "qx"], "qx/decoration/Classic/window/restore.gif": [8, 9, "gif", "qx", "qx/decoration/Classic/window-captionbar-buttons-combined.gif", -28, 0], "qx/decoration/Classic/colorselector/brightness-handle.gif": [35, 11, "gif", "qx", "qx/decoration/Classic/colorselector-combined.gif", 0, 0], "qx/icon/Tango/48/devices/media-flash.png": [48, 48, "png", "qx"], "qx/decoration/Classic/treevirtual/end.gif": [19, 16, "gif", "qx"], "qx/icon/Tango/48/devices/battery.png": [48, 48, "png", "qx"], "qx/decoration/Classic/checkbox-radiobutton-combined.png": [280, 14, "png", "qx"], "qx/icon/Tango/48/devices/input-mouse.png": [48, 48, "png", "qx"], "qx/icon/Tango/48/devices/multimedia-player.png": [48, 48, "png", "qx"], "qx/icon/Oxygen/16/actions/view-refresh.png": [16, 16, "png", "qx"], "qx/decoration/Classic/arrows/next-invert.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -54, 0], "qx/icon/Tango/48/devices/display.png": [48, 48, "png", "qx"], "qx/decoration/Classic/window/maximize.gif": [9, 9, "gif", "qx", "qx/decoration/Classic/window-captionbar-buttons-combined.gif", -10, 0], "qx/decoration/Classic/shadow-small-tb-combined.png": [5, 30, "png", "qx"], "qx/decoration/Classic/arrows/left-invert.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -40, 0], "qx/icon/Oxygen/48/devices/media-optical.png": [48, 48, "png", "qx"], "qx/icon/Oxygen/16/actions/dialog-cancel.png": [16, 16, "png", "qx"], "qx/decoration/Classic/form/radiobutton-checked-pressed.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -182, 0], "qx/decoration/Classic/form/radiobutton-hovered.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -238, 0], "qx/decoration/Classic/shadow-lr-combined.png": [30, 382, "png", "qx"], "qx/decoration/Classic/arrows/forward-invert.gif": [8, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -24, 0], "qx/decoration/Classic/form/checkbox-pressed.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -112, 0], "qx/icon/Tango/48/devices/camera-photo.png": [48, 48, "png", "qx"], "qx/decoration/Classic/colorselector/huesaturation-field.jpg": [256, 256, "jpeg", "qx"], "qx/icon/Tango/48/places/folder.png": [48, 48, "png", "qx"], "qx/decoration/Classic/menu-combined.gif": [64, 7, "gif", "qx"], "qx/decoration/Classic/shadow/shadow-bl.png": [15, 15, "png", "qx", "qx/decoration/Classic/shadow-tb-combined.png", 0, -15], "qx/icon/Tango/48/devices/input-keyboard.png": [48, 48, "png", "qx"], "qx/decoration/Classic/form/checkbox-checked.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -56, 0], "qx/decoration/Classic/arrows/down-small.gif": [5, 3, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -12, 0], "qx/decoration/Classic/arrows/right-small-invert.gif": [3, 5, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -90, 0], "qx/decoration/Classic/treevirtual/cross_plus.gif": [19, 16, "gif", "qx"], "qx/decoration/Classic/form/radiobutton-checked-focused.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -154, 0], "qx/decoration/Classic/form/checkbox.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -126, 0], "qx/icon/Oxygen/48/devices/input-keyboard.png": [48, 48, "png", "qx"], "qx/decoration/Classic/cursors/nodrop.gif": [20, 20, "gif", "qx", "qx/decoration/Classic/cursors-combined.gif", -51, 0], "qx/decoration/Classic/form/radiobutton-disabled.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -210, 0], "qx/icon/Oxygen/48/devices/media-flash.png": [48, 48, "png", "qx"], "qx/decoration/Classic/form/radiobutton-checked.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -196, 0], "qx/decoration/Classic/form/checkbox-focused.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -84, 0], "qx/icon/Tango/16/places/folder.png": [16, 16, "png", "qx"], "qx/decoration/Classic/form/checkbox-checked-disabled.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", 0, 0], "qx/decoration/Classic/shadow/shadow-c.png": [40, 382, "png", "qx"], "qx/decoration/Classic/table/boolean-false.png": [11, 11, "png", "qx", "qx/decoration/Classic/table-combined.png", -20, 0], "qx/decoration/Classic/form/checkbox-checked-focused.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -14, 0], "qx/icon/Tango/48/devices/drive-harddisk.png": [48, 48, "png", "qx"], "qx/icon/Oxygen/48/devices/multimedia-player.png": [48, 48, "png", "qx"], "qx/decoration/Classic/shadow/shadow-r.png": [15, 382, "png", "qx", "qx/decoration/Classic/shadow-lr-combined.png", -15, 0], "qx/decoration/Classic/arrows/rewind.gif": [8, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -78, 0], "qx/decoration/Classic/window-captionbar-buttons-combined.gif": [36, 9, "gif", "qx"], "qx/decoration/Classic/arrows/right.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -96, 0], "qx/decoration/Classic/form/radiobutton-checked-disabled.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -140, 0], "qx/icon/Oxygen/16/mimetypes/text-plain.png": [16, 16, "png", "qx"], "qx/icon/Oxygen/48/devices/camera-web.png": [48, 48, "png", "qx"], "qx/decoration/Classic/arrows/up.gif": [7, 4, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -117, 0], "qx/decoration/Classic/form/checkbox-disabled.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -70, 0], "qx/decoration/Classic/table/boolean-true.png": [11, 11, "png", "qx", "qx/decoration/Classic/table-combined.png", -31, 0], "qx/decoration/Classic/shadow/shadow-t.png": [15, 15, "png", "qx", "qx/decoration/Classic/shadow-tb-combined.png", 0, -45], "qx/icon/Oxygen/48/devices/printer.png": [48, 48, "png", "qx"], "qx/decoration/Classic/form/checkbox-checked-pressed.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -42, 0], "qx/icon/Oxygen/48/devices/audio-card.png": [48, 48, "png", "qx"], "qx/decoration/Classic/treevirtual/cross.gif": [19, 16, "gif", "qx"], "qx/decoration/Classic/form/radiobutton-pressed.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -252, 0], "qx/decoration/Classic/form/radiobutton.png": [14, 14, "png", "qx", "qx/decoration/Classic/checkbox-radiobutton-combined.png", -266, 0], "qx/decoration/Classic/arrows/next.gif": [4, 7, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -58, 0], "qx/decoration/Classic/table/ascending.png": [10, 10, "png", "qx", "qx/decoration/Classic/table-combined.png", -10, 0], "qx/decoration/Classic/shadow/shadow-tl.png": [15, 15, "png", "qx", "qx/decoration/Classic/shadow-tb-combined.png", 0, -60], "qx/static/blank.gif": [1, 1, "gif", "qx"], "qx/decoration/Classic/treevirtual/only_minus.gif": [19, 16, "gif", "qx"], "qx/decoration/Classic/treevirtual/line.gif": [19, 16, "gif", "qx"], "qx/decoration/Classic/shadow-small-lr-combined.png": [10, 136, "png", "qx"], "qx/icon/Oxygen/48/devices/drive-harddisk.png": [48, 48, "png", "qx"], "qx/decoration/Classic/shadow/shadow-small-t.png": [5, 5, "png", "qx", "qx/decoration/Classic/shadow-small-tb-combined.png", 0, -15], "qx/decoration/Classic/shadow/shadow-small-r.png": [5, 136, "png", "qx", "qx/decoration/Classic/shadow-small-lr-combined.png", -5, 0], "qx/decoration/Classic/treevirtual/only_plus.gif": [19, 16, "gif", "qx"], "qx/icon/Oxygen/48/devices/battery.png": [48, 48, "png", "qx"], "qx/decoration/Classic/colorselector/huesaturation-handle.gif": [11, 11, "gif", "qx", "qx/decoration/Classic/colorselector-combined.gif", -35, 0], "qx/icon/Oxygen/48/devices/camera-photo.png": [48, 48, "png", "qx"], "qx/decoration/Classic/tree/plus.gif": [19, 16, "gif", "qx"], "qx/icon/Tango/48/devices/scanner.png": [48, 48, "png", "qx"], "qx/decoration/Classic/window/close.gif": [10, 9, "gif", "qx", "qx/decoration/Classic/window-captionbar-buttons-combined.gif", 0, 0], "qx/icon/Oxygen/16/actions/dialog-ok.png": [16, 16, "png", "qx"], "qx/decoration/Classic/shadow/shadow-tr.png": [15, 15, "png", "qx", "qx/decoration/Classic/shadow-tb-combined.png", 0, -75], "qx/decoration/Classic/arrows/left-small-invert.gif": [3, 5, "gif", "qx", "qx/decoration/Classic/arrows-combined.gif", -44, 0], "qx/decoration/Classic/datechooser/next-month-invert.png": [16, 16, "png", "qx"], "qx/icon/Oxygen/48/devices/display.png": [48, 48, "png", "qx"]};
qx.$$translations = {};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.virtual.List-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var E="one",D="multi",C="single",B="additive",A="bold",z="changeValue",y="changeChecked",x="Item No ",w="Julian",v="Jannis",bQ="Marlon",bP="Robin",bO="Felix",bN="Vincent",bM="demobrowser.demo.virtual.List",bL="Additive Selection",bK="/places/folder.png",bJ="Niclas",bI="Nick",bH="Leon",L="Jannick",M="Linus",J="Configurable",K="Marc",H="icon/16/places/folder.png",I="Erik",F="addaptive",G="Johannes",T="Colin",U="Lennard",bj="Moritz",bf="Jason",br="Tobias",bm="Florian",bD="Kevin",bx="16",ba="Jonas",bG="icon/",bF="Jakob",bE="Enable drag selection",X="Joel",bc="David",be="Maximilian",bh="48",bk="Nils",bn="Lukas",bt="Luca",bz="Julius",N="Fabian",O="Tim",bb="Justin",bq="Single Selection",bp="Simon",bo="Luis",bv="Nico",bu="Alexander",bl="Jan",bs="Dominic",s="Noah",by="Enable quick selection",P="Daniel",Q="Paul",bg="Philipp",t="Max",u="One Selection",W="Additive selection",R="Jonathan",S="Tom",V="Finn",bi="Ben",bB="on",bA="One as selection mode",bd="Elias",bC="Mika",Y="Multi Selection",bw="Marvin";
qx.Class.define(bM,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var o=new qx.ui.basic.Label(J);
o.setFont(A);
this.getRoot().add(o,{left:20,top:20});
var p=new demobrowser.demo.virtual.list.List();
p.setScrollbarX(bB);
p.set({height:280,width:150,selectionMode:D});
var l;

for(var i=1;i<=2500;i++){l=new demobrowser.demo.virtual.list.ListItem(x+i,bG+((i%4)?bx:bh)+bK);

if(i%4==0){l.setHeight(56);
}p.add(l);
if(i==20){p.setSelected(l);
}}p.addListener(z,function(e){this.debug("Value: "+e.getData());
});
this.getRoot().add(p,{left:20,top:40});
var g=new qx.ui.form.RadioButton(bq);
var c=new qx.ui.form.RadioButton(Y);
var d=new qx.ui.form.RadioButton(bL);
var b=new qx.ui.form.RadioButton(u);
g.setValue(C);
c.setValue(D);
d.setValue(B);
b.setValue(E);
c.setChecked(true);
this.getRoot().add(g,{left:180,top:40});
this.getRoot().add(c,{left:180,top:60});
this.getRoot().add(d,{left:180,top:80});
this.getRoot().add(b,{left:180,top:100});
var f=new qx.ui.form.RadioGroup(g,c,d,b);
var k=new qx.ui.form.CheckBox(bE);
var n=new qx.ui.form.CheckBox(by).set({enabled:false});
this.getRoot().add(k,{left:180,top:220});
this.getRoot().add(n,{left:180,top:240});
k.addListener(y,function(e){if(e.getData()){var bS=p.getSelectionMode();

if(bS==C||bS==E){this.debug("Drag selection is only available for the modes multi or additive");
}}p.setDragSelection(e.getData());
});
n.addListener(y,function(e){if(e.getData()){var bR=p.getSelectionMode();

if(bR==D||bR==B){this.debug("Quick selection is only available for the modes multi or additive");
}}p.setQuickSelection(e.getData());
});
f.addListener(z,function(e){var a=e.getData();
p.setSelectionMode(a);

if(a==C||a==E){k.setEnabled(false);
n.setEnabled(true);
}else if(a==D||a==F){k.setEnabled(true);
n.setEnabled(false);
}});
var r=new qx.ui.basic.Label(bA);
r.setFont(A);
this.getRoot().add(r,{left:330,top:20});
var m=new demobrowser.demo.virtual.list.List();
m.set({height:280,width:150,selectionMode:E});
var l;

for(var i=1;i<=25;i++){l=new demobrowser.demo.virtual.list.ListItem(x+i,H);
m.add(l);
if(i==16){m.setSelected(l);
}}this.getRoot().add(m,{left:330,top:40});
var o=new qx.ui.basic.Label(W);
o.setFont(A);
this.getRoot().add(o,{left:520,top:20});
var q=new demobrowser.demo.virtual.list.List;
var h;
q.set({width:150,selectionMode:B});
var j=[bH,bn,bt,V,O,bO,ba,bo,be,w,t,Q,bJ,bl,bi,bd,L,bg,s,S,bj,bv,bc,bk,bp,N,I,bb,bu,bF,bm,bI,M,bC,bf,P,U,bw,v,br,bs,bQ,K,G,R,bz,T,X,bD,bN,bP];

for(var i=0;i<j.length;i++){h=new demobrowser.demo.virtual.list.ListItem(j[i]);
q.add(h);

if(i==10||i==12||i==16){q.addToSelection(h);
}}this.getRoot().add(q,{left:520,top:40});
}}});
})();
...
(function(){var k="pane",j="scrollY",i="qx.ui.virtual.core.Scroller",h="update",g="scrollX";
qx.Class.define(i,{extend:qx.ui.core.AbstractScrollArea,construct:function(a,b,c,d){arguments.callee.base.call(this);
this.__ss=new qx.ui.virtual.core.Pane(a,b,c,d);
this.__ss.addListener(h,this._computeScrollbars,this);
this.__ss.addListener(g,this._onScrollPaneX,this);
this.__ss.addListener(j,this._onScrollPaneY,this);
this._add(this.__ss,{row:0,column:0});
},properties:{width:{refine:true,init:null},height:{refine:true,init:null}},members:{getPane:function(){return this.__ss;
},_createChildControlImpl:function(o){if(o==k){return this.__ss;
...
},getItemBottom:function(l){throw new Error("The method 'getItemBottom' is not implemented!");
},getItemLeft:function(f){throw new Error("The method 'getItemLeft' is not implemented!");
},getItemRight:function(m){throw new Error("The method 'getItemRight' is not implemented!");
},_onScrollBarX:function(e){this.__ss.setScrollX(e.getData());
},_onScrollBarY:function(e){this.__ss.setScrollY(e.getData());
}}});
})();
...
(function(){var bc="selected",bb="qx.event.type.Data",ba="Boolean",Y="changeSelection",X="row",W="single",V="changeHeight",U=",",T="one",S="_applySpacing",br="Integer",bq="_applyDragSelection",bp="String",bo="resize",bn="demobrowser.demo.virtual.list.List",bm="list",bl="multi",bk="_applyQuickSelection",bj="_applyItemHeight",bi="_applySelectionMode",bg="additive",bh="changeName",be="Number",bf="addItem",bd="removeItem";
qx.Class.define(bn,{extend:qx.ui.virtual.core.Scroller,implement:[qx.ui.virtual.core.IWidgetCellProvider,qx.ui.form.IFormElement,qx.ui.core.ISingleSelection,qx.ui.core.IMultiSelection],construct:function(){arguments.callee.base.call(this,0,1,this.getItemHeight(),10);
this.__tX=new qx.ui.virtual.layer.WidgetCell(this);
this.getPane().addLayer(this.__tX);
this.getPane().addListener(bo,this._onResize,this);
this.__tY=[];
this.__ua=[];
this.__ub=new qx.ui.virtual.selection.Row(this.getPane());
this.__ub.addListener(Y,this._onChangeSelection,this);
this.__ub.attachMouseEvents();
this.__ub.attachKeyEvents(this);
this.__ub.attachListEvents(this);
var bz=new qx.ui.virtual.behavior.Prefetch(this,0,0,0,0,400,600,400,600).set({interval:500});
},events:{addItem:bb,removeItem:bb,changeValue:bb,changeSelection:bb},properties:{appearance:{refine:true,init:bm},focusable:{refine:true,init:true},spacing:{check:br,init:0,apply:S,themeable:true},enableInlineFind:{check:ba,init:true},name:{check:bp,nullable:true,event:bh},itemHeight:{init:24,themeable:true,check:be,apply:bj},selectionMode:{check:[W,bl,bg,T],init:W,apply:bi},dragSelection:{check:ba,init:false,apply:bq},quickSelection:{check:ba,init:false,apply:bk}},members:{syncWidget:function(){this.update();
},update:function(){var bv=this.getPane().getRowConfig();
bv.setItemCount(this.__tY.length);
bv.resetItemSizes();

for(var i=0;i<this.__tY.length;i++){var bu=this.__tY[i].getHeight();

if(bu!==null){bv.setItemSize(i,bu);
}}},updateSelection:function(){var y=this.__tX.getChildren();

for(var i=0;i<y.length;i++){var z=y[i];
var A=z.getUserData(X);

if(this.__ub.isItemSelected(A)){z.addState(bc);
}else{z.removeState(bc);
}}},_onResize:function(e){this.getPane().getColumnConfig().setItemSize(0,e.getData().width);
qx.ui.core.queue.Widget.add(this);
},_onChangeItemHeight:function(e){qx.ui.core.queue.Widget.add(this);
},_onChangeSelection:function(e){this.updateSelection();
this.fireDataEvent(Y,this.__uf(e.getData()));
},getCellWidget:function(h,k){var n=this.__tY[h];

if(!n){return null;
}var m=this.__ua.pop()||new qx.ui.form.ListItem();
m.set({label:n.getLabel(),icon:n.getIcon()});

if(this.__ub.isItemSelected(h)){m.addState(bc);
}else{m.removeState(bc);
}m.setUserData(X,h);
return m;
},poolCellWidget:function(by){this.__ua.push(by);
},getValue:function(){var P=this.getSelection();
var Q=[];
var R;
...
},setValue:function(c){var g=c.split(U);
var f=[];
var d;

for(var i=0,l=g.length;i<l;i++){d=this.findItem(g[i]);

if(d){f.push(d);
}}this.setSelection(f);
},getChildren:function(){return this.__tY;
},hasChildren:function(){return this.__tY.length>0;
},_addHelper:function(s){this.fireDataEvent(bf,s);
s.addListener(V,this._onChangeItemHeight,this);
qx.ui.core.queue.Widget.add(this);
},_removeHelper:function(bA){this.fireDataEvent(bd,bA);
bA.removeListener(V,this._onChangeItemHeight,this);
qx.ui.core.queue.Widget.add(this);
},add:function(o){this.__tY.push(o);
this._addHelper(o);
return this;
},remove:function(O){qx.lang.Array.remove(this.__tY,O);
this._removeHelper(O);
return this;
},removeAll:function(){for(var i=0,j=this.__tY.lenth;i<j;i++){this._removeHelper(child);
}this.__tY=[];
},indexOf:function(bB){return this.__tY.indexOf(bB);
},addAt:function(p,q){qx.lang.Array.insertAt(this.__tY,p,q);
this._addHelper(p);
},addBefore:function(bs,bt){qx.lang.Array.insertBefore(this.__tY,bs,bt);
this._addHelper(bs);
},addAfter:function(C,D){qx.lang.Array.insertAfter(this.__tY,C,D);
this._addHelper(C);
},removeAt:function(a){this.__tY.splice(a,1);
this._removeHelper(child);
},__uc:function(w){var x=this.__tY.indexOf(w);

if(x<0){return null;
}else{return x;
}},__ud:function(I){var J=this.__tY[I];
return J;
},__ue:function(u){var v=[];

for(var i=0;i<u.length;i++){v.push(this.__uc(u[i]));
}return v;
},__uf:function(M){var N=[];

for(var i=0;i<M.length;i++){N.push(this.__tY[M[i]]);
}return N;
},selectAll:function(){this.__ub.selectAll();
},setSelected:function(bC){this.__ub.selectItem(this.__uc(bC));
},isSelected:function(t){return this.__ub.isItemSelected(this.__uc(t));
},addToSelection:function(B){this.__ub.addItem(this.__uc(B));
},removeFromSelection:function(r){this.__ub.removeItem(this.__uc(r));
},selectRange:function(bw,bx){this.__ub.selectItemRange(this.__uc(bw),this.__uc(bx));
},resetSelection:function(){this.__ub.clearSelection();
},setSelection:function(b){this.__ub.replaceSelection(this.__ue(b));
},getSelectedItem:function(){return this.__tY[this.getSelected()];
},getSelected:function(){return this.__tY[this.__ub.getSelectedItem()];
},getSelection:function(){return this.__uf(this.__ub.getSelection());
},getSortedSelection:function(){return this.__uf(this.__ub.getSortedSelection());
},isSelectionEmpty:function(){return this.__ub.isSelectionEmpty();
},getSelectionContext:function(){return this.__ub.getSelectionContext();
},getSelectables:function(){return this.__uf(this.__ub.getSelectables());
},_applySelectionMode:function(K,L){this.__ub.setMode(K);
},_applyDragSelection:function(G,H){this.__ub.setDrag(G);
},_applyQuickSelection:function(E,F){this.__ub.setQuick(E);
}}});
})();
...
(function(){var B="appear",A="qx.ui.virtual.core.CellEvent",z="qx.event.type.Data",y="change",x="update",w="scrollY",v="full update",u="dblclick",t="update layer window",s="qx.event.type.Event",P="__sx",O="cellContextmenu",N="resize",M="scrollX",L="cellDblclick",K="qx.ui.virtual.core.Pane",J="click",I="prefetch x",H="contextmenu",G="cellClick",E="prefetch y",F="__sy",C="__sG",D="scroll";
qx.Class.define(K,{extend:qx.ui.core.Widget,construct:function(bm,bn,bo,bp){arguments.callee.base.call(this);
this.__sx=new qx.ui.virtual.core.Axis(bo,bm);
this.__sy=new qx.ui.virtual.core.Axis(bp,bn);
this.__sz=0;
this.__sA=0;
this.__sB=0;
this.__sC=0;
this.__sD={};
this.__sE={};
this.__sF=new qx.ui.container.Composite();
this.__sF.setUserBounds(0,0,0,0);
this._add(this.__sF);
this.__sG=[];
this.__sx.addListener(y,this.fullUpdate,this);
this.__sy.addListener(y,this.fullUpdate,this);
this.addListener(N,this._onResize,this);
this.addListenerOnce(B,this._onAppear,this);
this.addListener(J,this._onCellClick,this);
this.addListener(u,this._onDblclickPane,this);
this.addListener(H,this._onContextMenu,this);
},events:{cellClick:A,cellContextmenu:A,cellDblclick:A,update:s,scrollX:z,scrollY:z},properties:{width:{refine:true,init:400},height:{refine:true,init:300}},members:{DEBUG:false,getRowConfig:function(){return this.__sx;
},getColumnConfig:function(){return this.__sy;
},getChild:function(){return this.__sF;
},addLayer:function(bI){{};
this.__sG.push(bI);
bI.setUserBounds(0,0,0,0);
this.__sF.add(bI);
},getLayers:function(){return this.__sG;
},getVisibleLayers:function(){var bO=[];

for(var i=0;i<this.__sG.length;i++){var bP=this.__sG[i];

if(bP.isVisible()){bO.push(bP);
}}return bO;
},getScrollMaxX:function(){var Q=this.getBounds();

if(Q){return Math.max(0,this.__sy.getTotalSize()-Q.width);
}return 0;
},getScrollMaxY:function(){var bw=this.getBounds();

if(bw){return Math.max(0,this.__sx.getTotalSize()-bw.height);
}return 0;
},setScrollY:function(bA){var bB=this.getScrollMaxY();

if(bA<0){bA=0;
}else if(bA>bB){bA=bB;
}
if(this.__sz!==bA){var bC=this.__sz;
this.__sz=bA;
this._deferredUpdateScrollPosition();
this.fireDataEvent(w,bA,bC);
}},getScrollY:function(){return this.__sz;
},setScrollX:function(bt){var bu=this.getScrollMaxX();

if(bt<0){bt=0;
}else if(bt>bu){bt=bu;
}
if(bt!==this.__sA){var bv=this.__sA;
this.__sA=bt;
this._deferredUpdateScrollPosition();
this.fireDataEvent(M,bt,bv);
}},getScrollX:function(){return this.__sA;
},getScrollSize:function(){return {width:this.__sy.getTotalSize(),height:this.__sx.getTotalSize()};
},scrollRowIntoView:function(n){var q=this.getBounds();

if(!q){this.addListenerOnce(B,function(){this.scrollRowIntoView(n);
},this);
return;
}var r=this.__sx.getItemPosition(n);
var p=r+this.__sx.getItemSize(n);
var o=this.getScrollY();

if(r<o){this.setScrollY(r);
}else if(p>o+q.height){this.setScrollY(p-q.height);
}},scrollColumnIntoView:function(bJ){var bM=this.getBounds();

if(!bM){this.addListenerOnce(B,function(){this.scrollColumnIntoView(bJ);
},this);
return;
}var bL=this.__sy.getItemPosition(bJ);
var bK=bL+this.__sy.getItemSize(bJ);
var bN=this.getScrollX();

if(bL<bN){this.setScrollX(bL);
}else if(bK>bN+bM.width){this.setScrollX(bK-bM.width);
}},scrollCellIntoView:function(bx,by){var bz=this.getBounds();

if(!bz){this.addListenerOnce(B,function(){this.scrollCellIntoView(bx,by);
},this);
return;
}this.scrollColumnIntoView(bx);
this.scrollRowIntoView(by);
},getCellAtPosition:function(bD,bE){var bH,bF;
var bG=this.getContentLocation();

if(bE<bG.top||bE>=bG.bottom||bD<bG.left||bD>=bG.right){return {row:null,column:null};
}bH=this.__sx.getItemAtPosition(this.getScrollY()+bE-bG.top).index;
bF=this.__sy.getItemAtPosition(this.getScrollX()+bD-bG.left).index;
return {row:bH,column:bF};
...
if(!h){return;
}var j=this.__sA+h.width;
var k=this.__sC-j;

if(this.__sA-this.__sD.left<Math.min(this.__sA,a)||this.__sD.right-j<Math.min(k,c)){this.DEBUG&&console.log(I);
var l=Math.min(this.__sA,b);
var g=Math.min(k,d);
this._setLayerWindow(f,this.__sA-l,this.__sz,h.width+l+g,h.height,false);
}},prefetchY:function(bS,bT,bU,bV){var bW=this.getVisibleLayers();

if(bW.length==0){return;
}var ca=this.getBounds();

if(!ca){return;
}var bX=this.__sz+ca.height;
var bY=this.__sB-bX;

if(this.__sz-this.__sD.top<Math.min(this.__sz,bS)||this.__sD.bottom-bX<Math.min(bY,bU)){this.DEBUG&&console.log(E);
var cc=Math.min(this.__sz,bT);
var cb=Math.min(bY,bV);
this._setLayerWindow(bW,this.__sA,this.__sz-cc,ca.width,ca.height+cc+cb,false);
}},_onResize:function(){if(this.getContainerElement().getDomElement()){this.__sH=true;
this._updateScrollPosition();
this.__sH=null;
this.fireEvent(x);
}},_onAppear:function(){this.fullUpdate();
},_onCellClick:function(e){var m=this.__sI(e);
this.fireEvent(G,qx.ui.virtual.core.CellEvent,[this,e,m.row,m.column],true);
},_onContextMenu:function(e){var bs=this.__sI(e);
this.fireEvent(O,qx.ui.virtual.core.CellEvent,[this,e,bs.row,bs.column],true);
},_onDblclickPane:function(e){var bR=this.__sI(e);
this.fireEvent(L,qx.ui.virtual.core.CellEvent,[this,e,bR.row,bR.column],true);
},__sI:function(e){return this.getCellAtPosition(e.getDocumentLeft(),e.getDocumentTop());
},syncWidget:function(){if(this.__sE._fullUpdate){this._fullUpdate();
}else if(this.__sE._updateScrollPosition){this._updateScrollPosition();
}this.__sE={};
},_setLayerWindow:function(R,S,top,T,U,V){var bb=this.__sx.getItemAtPosition(top);
var bf=this.__sy.getItemAtPosition(S);
var bd=bb.index;
var ba=bf.index;
var bh=this.__sx.getItemSizes(bd,U+bb.offset);
var X=this.__sy.getItemSizes(ba,T+bf.offset);
var bi=bd+bh.length-1;
var Y=ba+X.length-1;
var be=qx.lang.Array.sum(X);
var bc=qx.lang.Array.sum(bh);
this.__sD={top:top-bb.offset,bottom:top-bb.offset+bc,left:S-bf.offset,right:S-bf.offset+be};
this.__sF.setUserBounds(this.__sD.left-this.__sA,this.__sD.top-this.__sz,be,bc);
this.__sJ=X;
this.__sK=bh;
this.DEBUG&&qx.ui.core.queue.Manager.flush();

for(var i=0;i<this.__sG.length;i++){var bg=new Date();
var W=this.__sG[i];
W.setUserBounds(0,0,be,bc);

if(V){W.fullUpdate(bd,bi,ba,Y,bh,X);
}else{W.updateLayerWindow(bd,bi,ba,Y,bh,X);
}if(this.DEBUG){this.debug("layer update ("+W.classname+"): "+(new Date()-bg)+"ms");
var bg=new Date();
qx.ui.core.queue.Manager.flush();
this.debug("layer flush ("+W.classname+"): "+(new Date()-bg)+"ms");
}}},__sL:function(){if(this.__sH){return;
}var bQ=this.getScrollSize();

if(this.__sB!==bQ.height||this.__sC!==bQ.width){this.__sB=bQ.height;
this.__sC=bQ.width;
this.fireEvent(x);
}},fullUpdate:function(){this.__sE._fullUpdate=1;
qx.ui.core.queue.Widget.add(this);
},_fullUpdate:function(){var bq=this.getVisibleLayers();

if(bq.length==0){this.__sL();
return;
}
if(!this.getContainerElement().getDomElement()){return ;
}var br=this.getBounds();
this.DEBUG&&console.log(v);
this._setLayerWindow(bq,this.__sA,this.__sz,br.width,br.height,true);
this.__sL();
},_deferredUpdateScrollPosition:function(){this.__sE._updateScrollPosition=1;
qx.ui.core.queue.Widget.add(this);
},_updateScrollPosition:function(){var bj=this.getVisibleLayers();

if(bj.length==0){this.__sL();
return;
}var bl=this.getBounds();

if(!bl){return ;
}var bk={top:this.__sz,bottom:this.__sz+bl.height,left:this.__sA,right:this.__sA+bl.width};

if(this.__sD.top<=bk.top&&this.__sD.bottom>=bk.bottom&&this.__sD.left<=bk.left&&this.__sD.right>=bk.right){this.DEBUG&&console.log(D);
this.__sF.setUserBounds(this.__sD.left-bk.left,this.__sD.top-bk.top,this.__sD.right-this.__sD.left,this.__sD.bottom-this.__sD.top);
}else{this.DEBUG&&console.log(t);
this._setLayerWindow(bj,this.__sA,this.__sz,bl.width,bl.height,false);
}this.__sL();
}},destruct:function(){this._disposeArray(C);
this._disposeObjects(P,F);
}});
})();
(function(){var y="change",x="qx.event.type.Event",w="qx.ui.virtual.core.Axis";
qx.Class.define(w,{extend:qx.core.Object,construct:function(P,Q){arguments.callee.base.call(this);
this.itemCount=Q;
this.defaultItemSize=P;
this.customSizes={};
},events:{"change":x},members:{getDefaultItemSize:function(){return this.defaultItemSize;
},setDefaultItemSize:function(X){if(this.defaultItemSize!==X){this.defaultItemSize=X;
this.__sM=null;
this.fireNonBubblingEvent(y);
}},getItemCount:function(){return this.itemCount;
},setItemCount:function(z){if(this.itemCount!==z){this.itemCount=z;
this.__sM=null;
this.fireNonBubblingEvent(y);
...
if(Y===null){delete this.customSizes[Y];
...
this.__sM=null;
this.fireNonBubblingEvent(y);
},__sN:function(){if(this.__sM){return this.__sM;
}var g=this.defaultItemSize;
var o=this.itemCount;
var j=[];

for(var l in this.customSizes){j.push(parseInt(l));
}
if(j.length==0){var k=[{startIndex:0,endIndex:o-1,firstItemSize:g,rangeStart:0,rangeEnd:o*g-1}];
this.__sM=k;
return k;
...
if(e>=o){break;
}var n=this.customSizes[e];
var h=e*g+f;
f+=n-g;
k[i]={startIndex:e,firstItemSize:n,rangeStart:h};

if(i>0){k[i-1].rangeEnd=h-1;
k[i-1].endIndex=e-1;
}}if(k[0].rangeStart>0){k.unshift({startIndex:0,endIndex:k[0].startIndex-1,firstItemSize:g,rangeStart:0,rangeEnd:k[0].rangeStart-1});
}var p=k[k.length-1];
var m=(o-p.startIndex-1)*g;
p.rangeEnd=p.rangeStart+p.firstItemSize+m-1;
p.endIndex=o-1;
this.__sM=k;
return k;
},__sO:function(H){var I=this.__sM||this.__sN();
var J=0;
var L=I.length-1;
while(true){var M=J+((L-J)>>1);
var K=I[M];

if(K.rangeEnd<H){J=M+1;
}else if(K.rangeStart>H){L=M-1;
}else{return K;
}}},getItemAtPosition:function(R){if(R<0||R>=this.getTotalSize()){return {index:null,offset:null};
}var T=this.__sO(R);
var V=T.rangeStart;
var S=T.startIndex;
var W=T.firstItemSize;

if(V+W>R){return {index:S,offset:R-V};
}else{var U=this.defaultItemSize;
return {index:S+1+Math.floor((R-V-W)/U),offset:(R-V-W)%U};
}},__sP:function(q){var r=this.__sM||this.__sN();
var s=0;
var u=r.length-1;
while(true){var v=s+((u-s)>>1);
var t=r[v];

if(t.endIndex<q){s=v+1;
}else if(t.startIndex>q){u=v-1;
}else{return t;
...
}},getTotalSize:function(){var d=this.__sM||this.__sN();
return d[d.length-1].rangeEnd+1;
},getItemSizes:function(A,B){var C=this.customSizes;
var F=this.defaultItemSize;
var E=0;
var D=[];
var i=0;

while(E<B){var G=C[A++]||F;
E+=G;
D[i++]=G;

if(A>=this.itemCount){break;
}}return D;
}}});
})();
...
qx.Interface.define(a,{members:{fullUpdate:function(b,c,d,e,f,g){this.assertArgumentsCount(arguments,6,6);
this.assertPositiveInteger(b);
this.assertPositiveInteger(c);
this.assertPositiveInteger(d);
this.assertPositiveInteger(e);
this.assertArray(f);
this.assertArray(g);
},updateLayerWindow:function(h,i,j,k,l,m){this.assertArgumentsCount(arguments,6,6);
this.assertPositiveInteger(h);
this.assertPositiveInteger(i);
this.assertPositiveInteger(j);
this.assertPositiveInteger(k);
this.assertArray(l);
this.assertArray(m);
},updateLayerData:function(){}}});
})();
(function(){var b="qx.ui.virtual.layer.Abstract",a="abstract";
qx.Class.define(b,{extend:qx.ui.core.Widget,type:a,implement:[qx.ui.virtual.core.ILayer],construct:function(){arguments.callee.base.call(this);
this.__sQ={};
this.__sR=null;
},properties:{anonymous:{refine:true,init:true}},members:{getFirstRow:function(){return this.__sS;
},getLastRow:function(){return this.__sT;
},getFirstColumn:function(){return this.__sU;
},getLastColumn:function(){return this.__sV;
},getRowSizes:function(){return this.__sW;
},getColumnSizes:function(){return this.__sX;
},syncWidget:function(){if(!this.getContentElement().getDomElement()){return;
}
if(this.__sQ.fullUpdate||this.__sQ.updateLayerWindow&&this.__sQ.updateLayerData){this._fullUpdate.apply(this,this.__sR);
}else if(this.__sQ.updateLayerWindow){this._updateLayerWindow.apply(this,this.__sR);
}else if(this.__sQ.updateLayerData){this._updateLayerData();
}
if(this.__sQ.fullUpdate||this.__sQ.updateLayerWindow){var u=this.__sR;
this.__sS=u[0];
this.__sT=u[1];
this.__sU=u[2];
this.__sV=u[3];
...
},_updateLayerData:function(){this._fullUpdate(this.__sS,this.__sT,this.__sU,this.__sV,this.__sW,this.__sX);
},_fullUpdate:function(o,p,q,r,s,t){throw new Error("Abstract method '_fullUpdate' called!");
},_updateLayerWindow:function(c,d,e,f,g,h){this._fullUpdate(c,d,e,f,g,h);
},updateLayerData:function(){this.__sQ.updateLayerData=true;
qx.ui.core.queue.Widget.add(this);
},fullUpdate:function(i,j,k,l,m,n){this.__sR=arguments;
this.__sQ.fullUpdate=true;
qx.ui.core.queue.Widget.add(this);
},updateLayerWindow:function(v,w,x,y,z,A){this.__sR=arguments;
this.__sQ.updateLayerWindow=true;
qx.ui.core.queue.Widget.add(this);
}}});
})();
(function(){var u="emptycell",t="qx.ui.virtual.layer.WidgetCell";
qx.Class.define(t,{extend:qx.ui.virtual.layer.Abstract,include:[qx.ui.core.MChildrenHandling],construct:function(M){arguments.callee.base.call(this);
this.setZIndex(2);
{};
this._cellProvider=M;
this.__sY=[];
},properties:{anonymous:{refine:true,init:false}},members:{__sY:null,_getSpacer:function(){var L=this.__sY.pop();

if(!L){L=new qx.ui.core.Spacer();
L.setUserData(u,1);
}return L;
},_fullUpdate:function(v,w,z,A,B,C){var E=this._cellProvider;
var I=this._getChildren();

for(var i=0;i<I.length;i++){var G=I[i];

if(G.getUserData(u)){this.__sY.push(G);
}else{E.poolCellWidget(G);
}}this._removeAll();
var top=0;
var J=0;

for(var y=0;y<B.length;y++){for(var x=0;x<C.length;x++){var H=v+y;
var F=z+x;
...
J=0;
}},_updateLayerWindow:function(a,b,c,d,e,f){var o={firstRow:Math.max(a,this.getFirstRow()),lastRow:Math.min(b,this._lastRow),firstColumn:Math.max(c,this.getFirstColumn()),lastColumn:Math.min(d,this.getLastColumn())};

if(o.firstRow>o.lastRow||o.firstColumn>o.lastColumn){return this._fullUpdate(a,b,c,d,e,f);
}var r=this._getChildren();
var g=this.getLastColumn()-this.getFirstColumn()+1;
var m=[];
var l={};

for(var s=a;s<=b;s++){m[s]=[];

for(var k=c;k<=d;k++){if(s>=o.firstRow&&s<=o.lastRow&&k>=o.firstColumn&&k<=o.lastColumn){var x=k-this.getFirstColumn();
var y=s-this.getFirstRow();
var h=y*g+x;
m[s][k]=r[h];
l[h]=true;
...
for(var i=0;i<r.length;i++){if(!l[i]){var p=r[i];

if(p.getUserData(u)){this.__sY.push(p);
}else{n.poolCellWidget(p);
}}}this._removeAll();
var top=0;
var q=0;

for(var y=0;y<e.length;y++){for(var x=0;x<f.length;x++){var s=a+y;
var k=c+x;
var j=m[s][k]||n.getCellWidget(s,k)||this._getSpacer();
j.setUserBounds(q,top,f[x],e[y]);
this._add(j);
q+=f[x];
}top+=e[y];
q=0;
}}},destruct:function(){var K=this._getChildren();

for(var i=0;i<K.length;i++){K[i].dispose();
}}});
})();
...
(function(){var bX="one",bW="single",bV="selected",bU="additive",bT="multi",bS="PageUp",bR="under",bQ="Left",bP="lead",bO="Down",cA="Up",cz="Boolean",cy="PageDown",cx="anchor",cw="End",cv="Home",cu="Right",ct="right",cs="click",cr="above",cf="left",cg="Escape",cd="A",ce="Space",cb="_applyMode",cc="__kd",bY="interval",ca="__kb",ch="changeSelection",ci="qx.event.type.Data",cl="quick",ck="key",cn="__jJ",cm="abstract",cp="__jM",co="__kc",cj="drag",cq="qx.ui.core.selection.Abstract";
qx.Class.define(cq,{type:cm,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__jJ={};
},events:{"changeSelection":ci},properties:{mode:{check:[bW,bT,bU,bX],init:bW,apply:cb},drag:{check:cz,init:false},quick:{check:cz,init:false}},members:{__jK:0,__jL:0,__jM:null,__jN:null,__jO:null,__jP:null,__jQ:null,__jR:null,__jS:null,__jT:null,__jU:null,__jV:null,__jW:null,__jX:null,__jY:null,__ka:null,__kb:null,__jJ:null,__kc:null,__kd:null,getSelectionContext:function(){return this.__ka;
},selectAll:function(){var cV=this.getMode();

if(cV==bW||cV==bX){throw new Error("Can not select all items in selection mode: "+cV);
}this._selectAllItems();
this._fireChange();
},selectItem:function(bl){this._setSelectedItem(bl);
var bm=this.getMode();

if(bm!==bW&&bm!==bX){this._setLeadItem(bl);
this._setAnchorItem(bl);
}this._scrollItemIntoView(bl);
this._fireChange();
},addItem:function(cR){var cS=this.getMode();

if(cS===bW||cS===bX){this._setSelectedItem(cR);
}else{if(!this._getAnchorItem()){this._setAnchorItem(cR);
}this._setLeadItem(cR);
this._addToSelection(cR);
}this._scrollItemIntoView(cR);
this._fireChange();
},removeItem:function(cT){this._removeFromSelection(cT);

if(this.getMode()===bX&&this.isSelectionEmpty()){var cU=this._getFirstSelectable();

if(cU){this.addItem(cU);
}if(cU==cT){return;
}}
if(this._getLeadItem()==cT){this._setLeadItem(null);
}
if(this._getAnchorItem()==cT){this._setAnchorItem(null);
}this._fireChange();
},selectItemRange:function(cJ,cK){var cL=this.getMode();

if(cL==bW||cL==bX){throw new Error("Can not select multiple items in selection mode: "+cL);
}this._selectItemRange(cJ,cK);
this._setAnchorItem(cJ);
this._setLeadItem(cK);
this._scrollItemIntoView(cK);
this._fireChange();
},clearSelection:function(){if(this.getMode()==bX){return;
}this._clearSelection();
this._setLeadItem(null);
this._setAnchorItem(null);
this._fireChange();
},replaceSelection:function(cB){var cC=this.getMode();

if(cC==bX||cC===bW){if(cB.length>1){throw new Error("Could not select more than one items in mode: "+cC+"!");
}
if(cB.length==1){this.selectItem(cB[0]);
}else{this.clearSelection();
}return;
}else{this._replaceMultiSelection(cB);
}},getSelectedItem:function(){var O=this.getMode();

if(O===bW||O===bX){return this._getSelectedItem()||null;
}throw new Error("The method getSelectedItem() is only supported in 'single' and 'one' selection mode!");
},getSelection:function(){return qx.lang.Object.getValues(this.__jJ);
},getSortedSelection:function(){var cG=this.getSelectables();
var cF=qx.lang.Object.getValues(this.__jJ);
cF.sort(function(a,b){return cG.indexOf(a)-cG.indexOf(b);
});
return cF;
},isItemSelected:function(y){var z=this._selectableToHashCode(y);
return this.__jJ[z]!==undefined;
},isSelectionEmpty:function(){return qx.lang.Object.isEmpty(this.__jJ);
},_setLeadItem:function(bu){var bv=this.__kb;

if(bv!==null){this._styleSelectable(bv,bP,false);
}
if(bu!==null){this._styleSelectable(bu,bP,true);
}this.__kb=bu;
},_getLeadItem:function(){return this.__kb!==null?this.__kb:null;
},_setAnchorItem:function(cY){var da=this.__kc;

if(da){this._styleSelectable(da,cx,false);
}
if(cY){this._styleSelectable(cY,cx,true);
}this.__kc=cY;
...
},_selectableToHashCode:function(D){throw new Error("Abstract method call: _selectableToHashCode()");
},_styleSelectable:function(A,B,C){throw new Error("Abstract method call: _styleSelectable()");
...
},_getSelectableLocationY:function(E){throw new Error("Abstract method call: _getSelectableLocationY()");
},_getScroll:function(){throw new Error("Abstract method call: _getScroll()");
},_scrollBy:function(bJ,bK){throw new Error("Abstract method call: _scrollBy()");
},_scrollItemIntoView:function(o){throw new Error("Abstract method call: _scrollItemIntoView()");
},getSelectables:function(){throw new Error("Abstract method call: getSelectables()");
},_getSelectableRange:function(cH,cI){throw new Error("Abstract method call: _getSelectableRange()");
},_getFirstSelectable:function(){throw new Error("Abstract method call: _getFirstSelectable()");
},_getLastSelectable:function(){throw new Error("Abstract method call: _getLastSelectable()");
},_getRelatedSelectable:function(F,G){throw new Error("Abstract method call: _getRelatedSelectable()");
},_getPage:function(be,bf){throw new Error("Abstract method call: _getPage()");
},_applyMode:function(L,M){this._setLeadItem(null);
this._setAnchorItem(null);
this._clearSelection();
if(L===bX){var N=this._getFirstSelectable();

if(N){this._setSelectedItem(N);
...
if(J!==bX&&J!==bW){return;
}var I=this._getSelectableFromMouseEvent(event);
...
if(this.isItemSelected(bh)&&!bg&&!bj&&!this.getDrag()){this.__kd=bh;
return;
}else{this.__kd=null;
}this._scrollItemIntoView(bh);
switch(this.getMode()){case bW:case bX:this._setSelectedItem(bh);
break;
case bU:this._setLeadItem(bh);
this._setAnchorItem(bh);
this._toggleInSelection(bh);
break;
case bT:this._setLeadItem(bh);
...
if(this.getDrag()&&bk!==bW&&bk!==bX&&!bg&&!bj){this.__jQ=this._getLocation();
...
if(!s&&!p&&this.__kd){var q=this._getSelectableFromMouseEvent(event);

if(q===null||!this.isItemSelected(q)){return;
}var r=this.getMode();

if(r===bU){this._removeFromSelection(q);
}else{this._setSelectedItem(q);

if(this.getMode()===bT){this._setLeadItem(q);
...
var cE=this.__jU+this.__jN.left;

if(cE>this.__jR){this.__jW=1;
}else if(cE<this.__jR){this.__jW=-1;
}else{this.__jW=0;
}var cD=this.__jV+this.__jN.top;

if(cD>this.__jS){this.__jX=1;
}else if(cD<this.__jS){this.__jX=-1;
}else{this.__jX=0;
...
this.__jM.addListener(bY,this._onInterval,this);
}this.__jM.start();
this._autoSelect();
},handleAddItem:function(e){var P=e.getData();

if(this.getMode()===bX&&this.isSelectionEmpty()){this.addItem(P);
}},handleRemoveItem:function(e){this.removeItem(e.getData());
},_cleanup:function(){if(!this.getDrag()&&this.__jT){return;
}if(this.__jY){this._fireChange(cs);
}delete this.__jT;
delete this.__jO;
delete this.__jP;
...
this.__jN=this._getScroll();
this._autoSelect();
},_autoSelect:function(){var bF=this._getDimension();
var by=Math.max(0,Math.min(this.__jU-this.__jQ.left,bF.width))+this.__jN.left;
var bx=Math.max(0,Math.min(this.__jV-this.__jQ.top,bF.height))+this.__jN.top;
if(this.__jO===by&&this.__jP===bx){return;
}this.__jO=by;
this.__jP=bx;
var bH=this._getAnchorItem();
var bA=bH;
var bD=this.__jW;
var bG,bz;

while(bD!==0){bG=bD>0?this._getRelatedSelectable(bA,ct):this._getRelatedSelectable(bA,cf);
if(bG!==null){bz=this._getSelectableLocationX(bG);
if((bD>0&&bz.left<=by)||(bD<0&&bz.right>=by)){bA=bG;
continue;
}}break;
}var bE=this.__jX;
var bC,bB;

while(bE!==0){bC=bE>0?this._getRelatedSelectable(bA,bR):this._getRelatedSelectable(bA,cr);
if(bC!==null){bB=this._getSelectableLocationY(bC);
if((bE>0&&bB.top<=bx)||(bE<0&&bB.bottom>=bx)){bA=bC;
continue;
}}break;
}var bI=this.getMode();

if(bI===bT){this._selectItemRange(bH,bA);
}else if(bI===bU){if(this.isItemSelected(bH)){this._selectItemRange(bH,bA,true);
}else{this._deselectItemRange(bH,bA);
}this._setAnchorItem(bA);
}this._fireChange(cj);
},__ke:{Home:1,Down:1,Right:1,PageDown:1,End:1,Up:1,Left:1,PageUp:1},handleKeyPress:function(event){var W,V;
var Y=event.getKeyIdentifier();
var X=this.getMode();
var S=event.isCtrlPressed()||(qx.bom.client.Platform.MAC&&event.isMetaPressed());
var T=event.isShiftPressed();
var U=false;

if(Y===cd&&S){if(X!==bW&&X!==bX){this._selectAllItems();
U=true;
}}else if(Y===cg){if(X!==bW&&X!==bX){this._clearSelection();
U=true;
}}else if(Y===ce){var R=this._getLeadItem();

if(R&&!T){if(S||X===bU){this._toggleInSelection(R);
}else{this._setSelectedItem(R);
}U=true;
}}else if(this.__ke[Y]){U=true;

if(X===bW||X==bX){W=this._getSelectedItem();
}else{W=this._getLeadItem();
}var bb=this._getFirstSelectable();
var Q=this._getLastSelectable();

if(W!==null){switch(Y){case cv:V=bb;
break;
case cw:V=Q;
break;
case cA:V=this._getRelatedSelectable(W,cr);
break;
case bO:V=this._getRelatedSelectable(W,bR);
break;
case bQ:V=this._getRelatedSelectable(W,cf);
break;
case cu:V=this._getRelatedSelectable(W,ct);
break;
case bS:V=this._getPage(W,true);
break;
case cy:V=this._getPage(W,false);
break;
}}else{switch(Y){case cv:case bO:case cu:case cy:V=bb;
break;
case cw:case cA:case bQ:case bS:V=Q;
break;
}}if(V!==null){switch(X){case bW:case bX:this._setSelectedItem(V);
break;
case bU:this._setLeadItem(V);
break;
case bT:if(T){var ba=this._getAnchorItem();

if(ba===null){this._setAnchorItem(ba=this._getFirstSelectable());
}this._setLeadItem(V);
this._selectItemRange(ba,V,S);
}else{this._setAnchorItem(V);
this._setLeadItem(V);

if(!S){this._setSelectedItem(V);
}}break;
}this._scrollItemIntoView(V);
}}
if(U){event.stop();
this._fireChange(ck);
}},_selectAllItems:function(){var K=this.getSelectables();

for(var i=0,l=K.length;i<l;i++){this._addToSelection(K[i]);
}},_clearSelection:function(){var cO=this.__jJ;

for(var cP in cO){this._removeFromSelection(cO[cP]);
}this.__jJ={};
},_selectItemRange:function(f,g,h){var m=this._getSelectableRange(f,g);
if(!h){var k=this.__jJ;
var n=this.__kf(m);

for(var j in k){if(!n[j]){this._removeFromSelection(k[j]);
}}}for(var i=0,l=m.length;i<l;i++){this._addToSelection(m[i]);
}},_deselectItemRange:function(t,u){var v=this._getSelectableRange(t,u);

for(var i=0,l=v.length;i<l;i++){this._removeFromSelection(v[i]);
}},__kf:function(bL){var bN={};
var bM;

for(var i=0,l=bL.length;i<l;i++){bM=bL[i];
bN[this._selectableToHashCode(bM)]=bM;
}return bN;
},_getSelectedItem:function(){for(var x in this.__jJ){return this.__jJ[x];
}return null;
},_setSelectedItem:function(bc){if(this._isSelectable(bc)){var bd=this.__jJ;

if(!bd[bc.$$hash]||qx.lang.Object.hasMinLength(bd,2)){this._clearSelection();
this._addToSelection(bc);
}}},_addToSelection:function(cW){var cX=this._selectableToHashCode(cW);

if(!this.__jJ[cX]&&this._isSelectable(cW)){this.__jJ[cX]=cW;
this._styleSelectable(cW,bV,true);
this.__jY=true;
}},_toggleInSelection:function(c){var d=this._selectableToHashCode(c);

if(!this.__jJ[d]){this.__jJ[d]=c;
this._styleSelectable(c,bV,true);
}else{delete this.__jJ[d];
this._styleSelectable(c,bV,false);
}this.__jY=true;
},_removeFromSelection:function(cM){var cN=this._selectableToHashCode(cM);

if(this.__jJ[cN]!==null){delete this.__jJ[cN];
this._styleSelectable(cM,bV,false);
this.__jY=true;
}},_replaceMultiSelection:function(bn){var bq=false;
var bt,bs;
var bo={};

for(var i=0,l=bn.length;i<l;i++){bt=bn[i];

if(this._isSelectable(bt)){bs=this._selectableToHashCode(bt);
bo[bs]=bt;
}}var bp=bt;
var br=this.__jJ;

for(var bs in br){if(bo[bs]){delete bo[bs];
}else{bt=br[bs];
delete br[bs];
this._styleSelectable(bt,bV,false);
bq=true;
}}for(var bs in bo){bt=br[bs]=bo[bs];
this._styleSelectable(bt,bV,true);
bq=true;
}if(!bq){return false;
...
this.__jY=true;
this._fireChange();
},_fireChange:function(bw){if(this.__jY){this.__ka=bw||null;
this.fireDataEvent(ch,this.getSelection());
delete this.__jY;
}}},destruct:function(){this._disposeObjects(cp);
this._disposeFields(cn,cc,co,ca);
}});
})();
(function(){var k="mouseup",j="mousedown",i="losecapture",h="mouseover",g="mousemove",f="removeItem",e="keypress",d="addItem",c="qx.ui.virtual.selection.Abstract";
qx.Class.define(c,{extend:qx.ui.core.selection.Abstract,construct:function(o,p){arguments.callee.base.call(this);
{};
this._pane=o;
this._delegate=p||{};
},members:{_isSelectable:function(u){return this._delegate.isItemSelectable?this._delegate.isItemSelectable(u):true;
},_styleSelectable:function(q,r,s){if(this._delegate.styleSelectable){this._delegate.styleSelectable(q,r,s);
}},attachMouseEvents:function(){var l=this._pane;
l.addListener(j,this.handleMouseDown,this);
l.addListener(k,this.handleMouseUp,this);
l.addListener(h,this.handleMouseOver,this);
l.addListener(g,this.handleMouseMove,this);
l.addListener(i,this.handleLoseCapture,this);
},detatchMouseEvents:function(){var t=this._pane;
t.removeListener(j,this.handleMouseDown,this);
t.removeListener(k,this.handleMouseUp,this);
t.removeListener(h,this.handleMouseOver,this);
t.removeListener(g,this.handleMouseMove,this);
t.removeListener(i,this.handleLoseCapture,this);
},attachKeyEvents:function(n){n.addListener(e,this.handleKeyPress,this);
},detachKeyEvents:function(v){v.removeListener(e,this.handleKeyPress,this);
},attachListEvents:function(a){a.addListener(d,this.handleAddItem,this);
a.addListener(f,this.handleRemoveItem,this);
},detachListEvents:function(m){m.removeListener(d,this.handleAddItem,this);
m.removeListener(f,this.handleRemoveItem,this);
...
},_getLocation:function(){var b=this._pane.getContentElement().getDomElement();
return b?qx.bom.element.Location.get(b):null;
},_getDimension:function(){return this._pane.getInnerSize();
}}});
})();
(function(){var t="qx.ui.virtual.selection.Row",s="above",r="under";
qx.Class.define(t,{extend:qx.ui.virtual.selection.Abstract,members:{_getItemCount:function(){return this._pane.getRowConfig().getItemCount();
},_getSelectableFromMouseEvent:function(event){var w=this._pane.getCellAtPosition(event.getDocumentLeft(),event.getDocumentTop());
return this._isSelectable(w.row)?w.row:null;
},getSelectables:function(){var u=[];

for(var i=0,l=this._getItemCount();i<l;i++){if(this._isSelectable(i)){u.push(i);
}}return u;
},_getSelectableRange:function(m,n){var o=[];
var q=Math.min(m,n);
var p=Math.max(m,n);

for(var i=q;i<=p;i++){if(this._isSelectable(i)){o.push(i);
}}return o;
},_getFirstSelectable:function(){var y=this._getItemCount();

for(var i=0;i<y;i++){if(this._isSelectable(i)){return i;
}}return null;
},_getLastSelectable:function(){var B=this._getItemCount();

for(var i=B-1;i>=0;i--){if(this._isSelectable(i)){return i;
}}return null;
},_getRelatedSelectable:function(f,g){if(g==s){var j=f-1;
var h=0;
var k=-1;
}else if(g==r){var j=f+1;
...
},_scrollItemIntoView:function(e){this._pane.scrollRowIntoView(e);
},_getSelectableLocationX:function(v){return {left:0,right:this._pane.getColumnConfig().getTotalSize()-1};
...
(function(){var s="scroll",r="scrollbar-x",q="scrollbar-y",p="_applyInterval",o="appear",n="interval",m="qx.ui.virtual.behavior.Prefetch",l="_applyScroller",k="qx.ui.virtual.core.Scroller",j="__tK",i="Integer";
qx.Class.define(m,{extend:qx.core.Object,construct:function(v,w,x,y,z,A,B,C,D){arguments.callee.base.call(this);
this.setPrefetchX(w,x,y,z);
this.setPrefetchY(A,B,C,D);
this.__tK=new qx.event.Timer(this.getInterval());
this.__tK.addListener(n,this._onInterval,this);

if(v){this.setScroller(v);
}},properties:{scroller:{check:k,nullable:true,init:null,apply:l},interval:{check:i,init:200,apply:p}},members:{setPrefetchX:function(E,F,G,H){this.__tL=[E,F,G,H];
},setPrefetchY:function(c,d,e,f){this.__tM=[c,d,e,f];
},_onInterval:function(){var t=this.__tL;

if(t[1]&&t[3]){this.getScroller().getPane().prefetchX(t[0],t[1],t[2],t[3]);
qx.ui.core.queue.Manager.flush();
}var u=this.__tM;

if(u[1]&&u[3]){this.getScroller().getPane().prefetchY(u[0],u[1],u[2],u[3]);
qx.ui.core.queue.Manager.flush();
}},_applyScroller:function(a,b){if(b){if(this.__tN){b.getChildControl(r).removeListenerById(this.__tN);
}
if(this.__tO){b.getChildControl(q).removeListenerById(this.__tO);
}}
if(a){if(!a.getContainerElement().getDomElement()){this.__tK.stop();
a.addListenerOnce(o,this.__tK.start,this.__tK);
}else{this.__tK.restart();
}this.__tN=a.getChildControl(r).addListener(s,this.__tK.restart,this.__tK);
this.__tO=a.getChildControl(q).addListener(s,this.__tK.restart,this.__tK);
}else{this.__tK.stop();
}},_applyInterval:function(g,h){this.__tK.setInterval(g);
}},destruct:function(){this.setScroller(null);
this._disposeObjects(j);
}});
})();
(function(){var i="listitem",h="qx.ui.form.RadioGroup",g="_applyManager",f="qx.ui.form.ListItem",e="qx.event.type.Event",d="changeValue",c="String";
qx.Class.define(f,{extend:qx.ui.basic.Atom,construct:function(j,k,l){arguments.callee.base.call(this,j,k);

if(l!=null){this.setValue(l);
}},events:{"action":e},properties:{appearance:{refine:true,init:i},manager:{check:h,nullable:true,apply:g},value:{check:c,nullable:true,event:d}},members:{_applyManager:function(a,b){if(b){b.remove(this);
}
if(a){a.add(this);
}},getFormValue:function(){var m=this.getValue();

if(m==null){m=this.getLabel();
}return m;
}}});
})();
(function(){var i="String",h="Integer",g="changeWidth",f="qx.ui.form.RadioGroup",e="_applyManager",d="changeHeight",c="qx.event.type.Event",b="changeValue",a="demobrowser.demo.virtual.list.ListItem";
qx.Class.define(a,{extend:qx.core.Object,construct:function(j,k,l){arguments.callee.base.call(this);
...
if(l!=null){this.setValue(l);
}},events:{"action":c},properties:{label:{nullable:true,dispose:true,check:i},icon:{check:i,nullable:true},manager:{check:f,nullable:true,apply:e},value:{check:i,nullable:true,event:b},width:{check:h,nullable:true,event:g,init:null},height:{check:h,nullable:true,event:d,init:null}},members:{_applyManager:function(m,n){if(n){n.remove(this);
}
if(m){m.add(this);
}},getFormValue:function(){var o=this.getValue();

if(o==null){o=this.getLabel();
}return o;
}}});
})();
