...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.VSplit", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.VSplit-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var z="vertical",y="main",x="Flex:1",w="Flex:1; Min:250",v="Auto",u="Flex:2",t="Flex:0",s="Flex:2; Max:100",r="Flex:1; Max:100",q="Flex:1; Max:200",n="Flex:2; Min:250",p="Flex:0; Min:350",o="demobrowser.demo.layout.VSplit";
...
var m=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});
scroll.add(m);
m.add(this.getSplitPaneTwoFlexSimple(),{left:0});
m.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});
m.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});
m.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});
m.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});
m.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});
m.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});
m.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});
m.add(this.getSplitPaneAuto(),{top:550,left:630});
},getSplitPaneTwoFlexSimple:function(){var h=new qx.ui.splitpane.Pane(z);
h.setHeight(400);
h.setDecorator(y);
var g=new qx.ui.form.TextArea(x);
g.setDecorator(null);
g.setWrap(true);
h.add(g,1);
var i=new qx.ui.form.TextArea(u);
i.setDecorator(null);
i.setWrap(true);
h.add(i,2);
return h;
},getSplitPaneTwoFlexWithOneMin:function(){var e=new qx.ui.splitpane.Pane(z);
e.setHeight(400);
e.setDecorator(y);
var d=new qx.ui.form.TextArea(w);
d.setDecorator(null);
d.setWrap(true);
d.setMinHeight(250);
e.add(d,1);
...
e.add(f,2);
return e;
},getSplitPaneTwoFlexWithOneMax:function(){var B=new qx.ui.splitpane.Pane(z);
B.setHeight(400);
B.setDecorator(y);
...
B.add(C,2);
return B;
},getSplitPaneTwoFlexWithTwoMin:function(){var H=new qx.ui.splitpane.Pane(z);
H.setHeight(400);
H.setDecorator(y);
var G=new qx.ui.form.TextArea(w);
G.setDecorator(null);
G.setWrap(true);
G.setMinHeight(250);
H.add(G,1);
...
H.add(I,2);
return H;
},getSplitPaneTwoFlexWithTwoMax:function(){var K=new qx.ui.splitpane.Pane(z);
K.setHeight(400);
K.setDecorator(y);
...
K.add(L,2);
return K;
},getSplitPaneOneFlexSimple:function(){var k=new qx.ui.splitpane.Pane(z);
k.setHeight(400);
k.setDecorator(y);
var j=new qx.ui.form.TextArea(t);
j.setDecorator(null);
j.setWrap(true);
k.add(j,0);
var l=new qx.ui.form.TextArea(x);
l.setDecorator(null);
l.setWrap(true);
k.add(l);
return k;
},getSplitPaneOneFlexSimpleWithMax:function(){var b=new qx.ui.splitpane.Pane(z);
b.setHeight(400);
b.setDecorator(y);
var a=new qx.ui.form.TextArea(t);
a.setDecorator(null);
a.setWrap(true);
b.add(a,0);
var c=new qx.ui.form.TextArea(q);
c.setDecorator(null);
c.setWrap(true);
c.setMaxHeight(200);
b.add(c);
return b;
},getSplitPaneOneFlexSimpleWithMin:function(){var E=new qx.ui.splitpane.Pane(z);
E.setHeight(400);
E.setDecorator(y);
...
D.setMinHeight(350);
E.add(D,0);
var F=new qx.ui.form.TextArea(x);
F.setDecorator(null);
F.setWrap(true);
E.add(F);
return E;
},getSplitPaneAuto:function(){var N=new qx.ui.splitpane.Pane(z);
N.setDecorator(y);
var M=new qx.ui.form.TextArea(v);
M.setDecorator(null);
M.setWrap(true);
N.add(M,0);
var O=new qx.ui.form.TextArea(v);
O.setDecorator(null);
O.setWrap(true);
N.add(O);
return N;
