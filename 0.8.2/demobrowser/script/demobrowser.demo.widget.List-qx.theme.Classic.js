...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.List", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.List-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var bI="multi",bH="one",bG="bold",bF="changeValue",bE="additive",bD="single",bC="Item No ",bB="changeChecked",bA="Julian",bz="Show Icon",bo="Kevin",bn="Marvin",bm="Marc",bl="Configurable",bk="icon/16/places/folder.png",bj="computer.png",bi="Jason",bh="Jakob",bg="Lukas",bf="Julius",bP="printer.png",bQ="network-wired.png",bN="Jan",bO="Tobias",bL="Mika",bM="Nils",bJ="Noah",bK="Tom",bR="Nico",bS="Multi Selection",bs="battery.png",br="Felix",bu="Leon",bt="input-keyboard.png",bw="camera-web.png",bv="Enable drag selection",by="icon",bx="Show Both",bq="48",bp="icon/48/devices/",b="Fabian",c="multimedia-player.png",d="camera-photo.png",f="media-flash.png",g="input-mouse.png",h="Joel",j="Dominic",k="Show Label",l="demobrowser.demo.widget.List",m="Enable quick selection",bW="Finn",bV="One as selection mode",bU="Jannis",bT="audio-card.png",cb="Alexander",ca="Additive Selection",bY="display.png",bX="Erik",cd="addaptive",cc="Johannes",L="pda.png",M="16",J="Jonas",K="icon/",P="David",Q="Maximilian",N="Tim",O="Justin",H="Single Selection",I="Linus",u="Daniel",t="Paul",w="Philipp",v="Niclas",q="One Selection",p="Nick",s="Jonathan",r="Ben",o="on",n="Vincent",V="/places/folder.png",W="Robin",X="both",Y="Jannick",R="Luis",S="drive-harddisk.png",T="Lennard",U="Moritz",ba="Florian",bb="drive-optical.png",E="media-optical.png",D="Marlon",C="Luca",B="network-wireless.png",A="audio-input-microphone.png",z="phone.png",y="Simon",x="Colin",G="label",F="Max",bc="Additive selection",bd="Horizontal, Icons only",be="Elias";
...
var co=new qx.ui.basic.Label(bl);
co.setFont(bG);
cu.add(co,{left:20,top:20});
var cw=new qx.ui.form.List;
cw.setScrollbarX(o);
cw.set({height:280,width:150,selectionMode:bI});
var cx;

for(var i=1;i<=25;i++){cx=new qx.ui.form.ListItem(bC+i,K+((i%4)?M:bq)+V);
!(i%9)&&(cx.setEnabled(false));
if(i==20){cw.setSelected(cx);
}cw.add(cx);
}cw.addListener(bF,function(e){this.debug("Value: "+e.getData());
});
cu.add(cw,{left:20,top:40});
var ck=new qx.ui.form.RadioButton(H);
var ch=new qx.ui.form.RadioButton(bS);
var ci=new qx.ui.form.RadioButton(ca);
var cg=new qx.ui.form.RadioButton(q);
ck.setValue(bD);
ch.setValue(bI);
ci.setValue(bE);
cg.setValue(bH);
...
var cA=new qx.ui.form.RadioButton(k);
var cz=new qx.ui.form.RadioButton(bz);
...
cv.addListener(bF,function(e){for(var i=0;i<cw.getChildren().length;i++){cw.getChildren()[i].setShow(e.getData());
}});
var cs=new qx.ui.form.CheckBox(bv);
var cp=new qx.ui.form.CheckBox(m).set({enabled:false});
cu.add(cs,{left:180,top:220});
cu.add(cp,{left:180,top:240});
cs.addListener(bB,function(e){if(e.getData()){var a=cw.getSelectionMode();

if(a==bD||a==bH){this.debug("Drag selection is only available for the modes multi or additive");
}}cw.setDragSelection(e.getData());
});
cp.addListener(bB,function(e){if(e.getData()){var cD=cw.getSelectionMode();

if(cD==bI||cD==bE){this.debug("Quick selection is only available for the modes multi or additive");
}}cw.setQuickSelection(e.getData());
});
cj.addListener(bF,function(e){var cE=e.getData();
cw.setSelectionMode(cE);

if(cE==bD||cE==bH){cs.setEnabled(false);
cp.setEnabled(true);
}else if(cE==bI||cE==cd){cs.setEnabled(true);
cp.setEnabled(false);
}});
...
cn.set({height:280,width:150,selectionMode:bH});
var cx;

for(var i=1;i<=25;i++){cx=new qx.ui.form.ListItem(bC+i,bk);
if(i==16){cn.setSelected(cx);
}cn.add(cx);
...
var cl;
cf.set({width:150,selectionMode:bE});
var cr=[bu,bg,C,bW,N,br,J,R,Q,bA,F,t,v,bN,r,be,Y,w,bJ,bK,U,bR,P,bM,y,b,bX,O,cb,bh,ba,p,I,bL,bi,u,T,bn,bU,bO,j,D,bm,cc,s,bf,x,h,bo,n,W];
...
var cm;
cy.set({width:550,selectionMode:bI,height:null});
var cq=[bT,A,bs,d,bw,bj,bY,S,bb,bt,g,f,E,c,bQ,B,L,z,bP];
var ct=bp;

for(var i=0;i<cq.length;i++){cm=new qx.ui.form.ListItem(null,ct+cq[i]);
cy.add(cm);

if(i==12){cy.setSelected(cm);
