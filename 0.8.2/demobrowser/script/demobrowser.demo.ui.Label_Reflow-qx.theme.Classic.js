...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.ui.Label_Reflow", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.ui.Label_Reflow-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var p="main",o="qooxdoo is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed.",n="click",m="#CCC",l="<b>qooxdoo is cool.</b>",k="qooxdoo (pronounced [’ku:ksdu:]) is a comprehensive and innovative Ajax application framework. Leveraging object-oriented JavaScript allows developers to build impressive cross-browser applications. No HTML, CSS nor DOM knowledge is needed. qooxdoo includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",j="#FFF",i="It includes a platform-independent development tool chain, a state-of-the-art GUI toolkit and an advanced client-server communication layer. It is Open Source under an LGPL/EPL dual license.",h="demobrowser.demo.ui.Label_Reflow",g="Toggle first paragraph",e="Resize Pane",f="#EEE";
...
r.setRowFlex(0,1);
r.setSpacing(10);
var s=new qx.ui.container.Composite(r).set({backgroundColor:f,decorator:p,padding:10,allowGrowX:false,allowGrowY:false,allowStretchX:false,allowStretchY:false});
t.add(s);
this.getRoot().add(t,{edge:0});
var x=this.getPane();
s.add(x,{row:0,column:0,colSpan:3});
var v=new qx.ui.basic.Label(g).set({backgroundColor:m,decorator:p,padding:[4,8]});
s.add(v,{row:1,column:1});
var u=false;
v.addListener(n,function(){var q=x.getChildren()[0];
q.setContent(u?o:l);
u=!u;
});
var w=new qx.ui.basic.Label(e).set({backgroundColor:m,decorator:p,padding:[4,8]});
s.add(w,{row:1,column:2});
var y=false;
w.addListener(n,function(e){if(y){x.setWidth(600);
}else{x.setWidth(300);
}y=!y;
});
},getPane:function(){var d=new qx.ui.container.Composite(new qx.ui.layout.VBox(14)).set({backgroundColor:j,width:600,decorator:p,padding:10});
var a=new qx.ui.basic.Label().set({rich:true,content:o});
d.add(a);
var b=new qx.ui.basic.Label().set({rich:true,content:i});
d.add(b);
var c=new qx.ui.basic.Label().set({rich:true,content:k});
d.add(c);
return d;
}}});
})();
