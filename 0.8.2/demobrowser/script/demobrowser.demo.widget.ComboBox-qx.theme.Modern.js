...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.ComboBox", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.ComboBox-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var A="bold",z=" = ",y="... &gt; (as literal HTML entity)",x="... &gt; (as Richtext)",w="HTML entities: &laquo; &lt; &amp; &gt; &raquo;",v="Wide, long list",u="<u>Underlined Text</u>",t="<b>Bold Text</b>",s="'s Icon",r="With icons",l="input",q="Default",o="changeValue",k="2^ ",j="<i>Italic Text</i>",n="'s Item",m="icon/16/places/folder.png",p="With HTML (rich) text",h="demobrowser.demo.widget.ComboBox";
...
},_createDefaultExample:function(){var H=new qx.ui.basic.Label(q);
H.setFont(A);
this.getRoot().add(H,{left:20,top:25});
var F=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var G=new qx.ui.form.ListItem(k+i+z+Math.pow(2,i));
F.add(G);
}F.addListener(l,function(e){this.debug("Input: "+e.getData());
});
F.addListener(o,function(e){this.debug("ChangeValue: "+e.getData());
});
this.getRoot().add(F,{left:20,top:40});
},_createIconExample:function(){var c=new qx.ui.basic.Label(r);
c.setFont(A);
this.getRoot().add(c,{left:160,top:25});
var a=new qx.ui.form.ComboBox();
for(var i=1;i<31;i++){var b=new qx.ui.form.ListItem(i+s,m);
a.add(b);
}this.getRoot().add(a,{left:160,top:40});
},_createHtmlExample:function(){var E=new qx.ui.basic.Label(p);
E.setFont(A);
this.getRoot().add(E,{left:300,top:25});
var B=new qx.ui.form.ComboBox().set({width:200});
var C=[y,x,t,u,j,w];
for(var i=0;i<C.length;i++){var D=new qx.ui.form.ListItem(C[i]);

if(i>0){D.setRich(true);
}B.add(D);
}this.getRoot().add(B,{left:300,top:40});
},_createWideExample:function(){var g=new qx.ui.basic.Label(v);
g.setFont(A);
this.getRoot().add(g,{left:20,top:285});
var d=new qx.ui.form.ComboBox();
d.setWidth(300);
for(var i=1;i<101;i++){var f=new qx.ui.form.ListItem(i+n);
d.add(f);
}this.getRoot().add(d,{left:20,top:300});
}}});
})();
