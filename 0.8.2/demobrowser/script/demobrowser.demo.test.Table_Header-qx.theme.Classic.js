...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Table_Header-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var k="Show move feedback",j="demobrowser.demo.test.Table_Header",i="Complete update",h="changeChecked",g="mouseover",f="Hide move feedback",d="execute";
...
var a=new qx.ui.table.pane.Header(this.getScrollerMock());
this.getRoot().add(a,{left:10,top:10});
a.onPaneModelChanged();
a.setColumnWidth(0,150);
a.addListener(g,function(e){var l=e.getTarget();

if(l instanceof qx.ui.table.headerrenderer.HeaderCell){var m=a._indexOf(l);
a.setMouseOverColumn(m);
}});
var c=new qx.ui.form.ToggleButton(k);
this.getRoot().add(c,{left:20,top:100});
c.addListener(h,function(e){var n=e.getData();

if(n){c.setLabel(f);
a.showColumnMoveFeedback(1,50);
}else{c.setLabel(k);
a.hideColumnMoveFeedback();
}});
var b=new qx.ui.form.Button(i);
this.getRoot().add(b,{left:20,top:140});
b.addListener(d,function(){a.onPaneModelChanged();
});
}}});
})();
