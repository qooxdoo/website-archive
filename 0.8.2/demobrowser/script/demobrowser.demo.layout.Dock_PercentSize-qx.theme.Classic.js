...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Dock_PercentSize", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Dock_PercentSize-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var x="main",w="50%",v="east",u="yellow",t="center",s="red",r="north",q="south",p="west",o="green",k="fuchsia",n="orange",m="blue",j="x",i="y",l="demobrowser.demo.layout.Dock_PercentSize";
...
scroll.add(b);
var a=new qx.ui.container.Composite(new qx.ui.layout.Dock()).set({decorator:x,backgroundColor:u,width:450,height:250,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s});
var g=new qx.ui.core.Widget().set({decorator:x,backgroundColor:m});
var f=new qx.ui.core.Widget().set({decorator:x,backgroundColor:n});
var e=new qx.ui.core.Widget().set({decorator:x,backgroundColor:o});
var d=new qx.ui.core.Widget().set({decorator:x,backgroundColor:k});
a.add(h,{edge:r});
a.add(g,{edge:p,width:w});
a.add(f,{edge:q,height:w});
a.add(e,{edge:v});
a.add(d,{edge:t});
b.add(a);
var c=new qx.ui.layout.Dock();
c.setSort(i);
var a=(new qx.ui.container.Composite(c)).set({decorator:x,backgroundColor:u,width:450,height:250,allowGrowX:false});
var h=new qx.ui.core.Widget().set({decorator:x,backgroundColor:s});
var g=new qx.ui.core.Widget().set({decorator:x,backgroundColor:m});
var f=new qx.ui.core.Widget().set({decorator:x,backgroundColor:n});
var e=new qx.ui.core.Widget().set({decorator:x,backgroundColor:o});
