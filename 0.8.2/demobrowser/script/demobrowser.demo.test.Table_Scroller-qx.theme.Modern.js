...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Table_Scroller", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Table_Scroller-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var f="main",e="demobrowser.demo.test.Table_Scroller",d="#FFE",c="demobrowser.demo.table.Scroller.DummyTable",b="table";
qx.Class.define(e,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var g=new demobrowser.demo.table.Scroller.DummyTable();
this.getRoot().add(g,{left:10,top:10});
}}});
qx.Class.define(c,{extend:qx.ui.container.Composite,include:[demobrowser.demo.table.MUtil],construct:function(){arguments.callee.base.call(this,new qx.ui.layout.Canvas());
