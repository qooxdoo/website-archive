...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.SlideBar", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.SlideBar-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var s="display.png",r="drive-optical.png",q="computer.png",p="audio-card.png",o="battery.png",n="main",m="Toggle size",l="icon/48/devices/",k="changeChecked",j="drive-harddisk.png",c="camera-web.png",h="network-wired.png",g="input-keyboard.png",b="camera-photo.png",a="network-wireless.png",f="audio-input-microphone.png",d="demobrowser.demo.widget.SlideBar";
...
slideBar.set({width:300});
slideBar.setLayout(new qx.ui.layout.HBox(3));
var u=[p,f,o,b,c,q,s,j,r,g,h,a];

for(var i=0;i<u.length;i++){slideBar.add((new qx.ui.basic.Image(l+u[i])).set({decorator:n,padding:4}));
}var t=new qx.ui.form.ToggleButton(m);
t.addListener(k,function(e){slideBar.setWidth(e.getData()?800:300);
});
