...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.Table_CellEditor", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Table_CellEditor-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var p="",o="cat",n="Juhu",m="mouse",l="dog",k="execute",j="rat",i="demobrowser.demo.test.Table_CellEditor",h="Add/Remove editor",g="Get value",f="boolean";
...
},_addEditor:function(s,t){t=qx.lang.Object.clone(t);
var u=new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
var y=s.createCellEditor(t);
var z=new qx.ui.container.Composite().set({width:200,height:20});
y.setUserBounds(0,0,200,20);
z.add(y);
u.add(z);
var w=new qx.ui.form.Button(g);
u.add(w);
w.addListener(k,function(){x.setContent(s.getCellEditorValue(y)+p);
});
var v=new qx.ui.form.Button(h);
u.add(v);
v.addListener(k,function(){y.destroy();
qx.ui.core.queue.Manager.flush();
y=s.createCellEditor(t);
y.setUserBounds(0,0,200,20);
z.add(y);
qx.ui.core.queue.Manager.flush();
});
var x=new qx.ui.basic.Label(p);
u.add(x);
this._container.add(u);
w.execute();
},testCheckBoxEditor:function(){var C={value:[true,false]};
this.permute(C,function(A){this._addEditor(new qx.ui.table.celleditor.CheckBox(),A);
},this);
},testComboBoxEditor:function(){var c={value:[p,o,j,2],table:[this.getTableMock()]};
var d=new qx.ui.table.celleditor.ComboBox();
d.setListData([l,o,m]);
this.permute(c,function(H){this._addEditor(d,H);
},this);
},testSelectBoxEditor:function(){var D={value:[p,o],table:[this.getTableMock()]};
var E=new qx.ui.table.celleditor.SelectBox();
E.setListData([l,o,m]);
this.permute(D,function(e){this._addEditor(E,e);
},this);
},testPasswordEditor:function(){var G={value:[null,10,n]};
this.permute(G,function(I){this._addEditor(new qx.ui.table.celleditor.PasswordField(),I);
},this);
},testTextfieldEditor:function(){var r={value:[null,10,n]};
this.permute(r,function(F){this._addEditor(new qx.ui.table.celleditor.TextField(),F);
},this);
},testTextfieldEditor:function(){var a={value:[true,n]};
var b=new qx.ui.table.celleditor.Dynamic();
b.setCellEditorFactoryFunction(function(q){if(typeof q.value==f){return new qx.ui.table.celleditor.CheckBox();
}else{return new qx.ui.table.celleditor.TextField();
}});
this.permute(a,function(B){this._addEditor(b,B);
},this);
}}});
})();
