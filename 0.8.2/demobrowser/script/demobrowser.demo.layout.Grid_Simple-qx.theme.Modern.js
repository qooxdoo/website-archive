...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Grid_Simple", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Grid_Simple-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var k="main",j="green",i="yellow",h="click me",g="click",f="center",e="top",d="middle",c="right",b="demobrowser.demo.layout.Grid_Simple";
...
return l;
},getGrid2:function(){var q=new qx.ui.layout.Grid();
q.setColumnAlign(1,f,e);
q.setColumnAlign(0,c,d);
q.setSpacing(5);
var p=new qx.ui.container.Composite(q).set({decorator:k,backgroundColor:i,allowGrowX:false});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,width:150}),{row:0,column:0});
var o=new qx.ui.basic.Label(h).set({decorator:k,backgroundColor:j,allowGrowX:false,width:50,height:50});
p.add(o,{row:0,column:1});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,maxHeight:60,allowGrowX:false}),{row:1,column:0});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j,height:80}),{row:1,column:1});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:0});
p.add(new qx.ui.core.Widget().set({decorator:k,backgroundColor:j}),{row:2,column:1});
var r=10;
o.addListener(g,function(e){o.setWidth(50+r);
r=-r;
});
return p;
