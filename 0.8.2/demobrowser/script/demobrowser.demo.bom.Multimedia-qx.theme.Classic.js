...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Multimedia-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var E="Silverlight",D="Windows Media",C="wmv",B="WMPlayer.OCX.7",A="qx.bom.client.Multimedia",z="QuickTimeCheckObject.QuickTimeCheck.1",y="qx.client",x="quicktime",w="QuickTime",v="silverlight",s="divx",u="npdivx.DivXBrowserPlugin.1",t="DivX Web Player",r="AgControl.AgControl";
qx.Bootstrap.define(A,{statics:{__wk:{quicktime:{plugin:w,control:z},wmv:{plugin:D,control:B},divx:{plugin:t,control:u},silverlight:{plugin:E,control:r}},has:function(j,k){if(this.__wk[j]){var l=this.__wk[j];
if(l.installed){if(k==null||(l.version>=parseFloat(k))){return true;
}}}return false;
},__wl:qx.core.Variant.select(y,{"mshtml":function(){var m=window.ActiveXObject;

if(!m){return;
}var o=this.__wk;
var n,p;

for(var q in o){n=o[q];

try{p=new ActiveXObject(n.control);
}catch(a){continue;
}switch(q){case x:n.version=0;
break;
case C:n.version=p.versionInfo;
break;
case s:n.version=0;
break;
case v:try{n.version=p.version===undefined?0:p.version;
}catch(H){try{n.version=p.settings.version===undefined?0:p.settings.version;
}catch(F){n.version=0;
}}break;
}n.installed=true;
