...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.root.Inline_Window-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var i="execute",h="Add modal window",g="demobrowser.demo.root.Inline_Window",f="Add window",e="Window #",d="isle",c="Modal Window #",b="white",a="main";
qx.Class.define(g,{extend:qx.application.Inline,members:{main:function(){arguments.callee.base.call(this);
...
var o=1;
m.addListener(i,function(e){var j=new qx.ui.window.Window(e+o++).set({width:200,height:150});
j.moveTo(o*15,o*15);
j.open();
});
p.add(m);
var n=new qx.ui.form.Button(h);
n.addListener(i,this.newModalWindow,this);
p.add(n);
...
l.addListener(i,this.newModalWindow,this);
k.add(l);
k.open();
}}});
})();
