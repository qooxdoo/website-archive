...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.table.Table_Events", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.table.Table_Events-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var o="",n="columnVisibilityMenuCreateEnd",m="Boolean",l="icon/16/actions/edit-cut.png",k="A number",j="Column",i="tableWidthChanged",h="verticalScrollBarChanged",g="icon/16/actions/edit-copy.png",f="icon/22/actions/media-record.png",F="cellContextmenu",E="Cut",D="Table",C="icon/16/actions/edit-paste.png",B="columnVisibilityMenuCreateStart",A="cellDblclick",z="Copy",y="Name",x="Paste",w="Event log",u="cellClick",v="demobrowser.demo.table.Table_Events",s="Row",t="changeChecked",q="A date",r="Capture events",p="ID";
qx.Class.define(v,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return D;
},main:function(){arguments.callee.base.call(this);
var N=this._eventsWin=new qx.ui.window.Window(w).set({height:400,width:290,showClose:false,showMinimize:false,contentPadding:0});
N.setLayout(new qx.ui.layout.Canvas());
N.open();
this.getRoot().add(N,{left:670,top:10});
this._events=new qx.ui.table.model.Simple();
this._events.setColumns([y,s,j]);
this._events.setData([]);
var M=new qx.ui.table.Table(this._events);
M.getTableColumnModel().setColumnWidth(0,150);
M.getTableColumnModel().setColumnWidth(1,60);
M.getTableColumnModel().setColumnWidth(2,60);
N.add(M,{edge:0});
},createTable:function(){var J=this.createRandomRows(50);
var G=this._tableModel=new qx.ui.table.model.Simple();
G.setColumns([p,k,q,m]);
G.setData(J);
G.setColumnEditable(1,true);
G.setColumnEditable(2,true);
var K=new qx.ui.table.Table(G);
K.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var H=K.getTableColumnModel();
H.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
var L=function(e){this._events.addRows([[e.getType(),o,o,o]],0);
};
var I=function(e){this._events.addRows([[e.getType(),e.getRow(),e.getColumn()]],0);
};
K.addListener(B,L,this);
K.addListener(n,L,this);
K.addListener(i,L,this);
K.addListener(h,L,this);
K.addListener(u,I,this);
K.addListener(A,I,this);
K.addListener(F,I,this);
K.setContextMenu(this.getContextMenu());
return K;
},createControls:function(){var Q=new qx.ui.toolbar.ToolBar();
var O,P,R;
P=new qx.ui.toolbar.Part();
Q.add(P);
O=new qx.ui.toolbar.CheckBox(r,f).set({checked:true});
P.add(O);
O.addListener(t,function(e){if(O.isChecked()){this._events.setData([]);
this._eventsWin.open();
}else{this._eventsWin.close();
}},this);
return Q;
},getContextMenu:function(){var a=new qx.ui.menu.Menu();
var c=new qx.ui.menu.Button(E,l);
var d=new qx.ui.menu.Button(z,g);
var b=new qx.ui.menu.Button(x,C);
a.add(c);
a.add(d);
a.add(b);
return a;
