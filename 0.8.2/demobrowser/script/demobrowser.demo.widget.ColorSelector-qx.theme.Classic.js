...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.ColorSelector", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$translations = {"C": {}, "en": {}, "fr_FR": {}, "de": {"HSB": "HSB", "RGB": "RGB", "Details": "Details", "Hex": "Hex", "Presets": "Voreinstellungen", "Preview (Old/New)": "Vorschau (alt/neu)"}, "fr": {"HSB": "TSV", "RGB": "RVB", "Details": "Détails", "Hex": "Hex", "Presets": "Pré-réglages", "Preview (Old/New)": "Aperçu (Ancien/Nouveau)"}, "en_US": {}, "de_DE": {}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.ColorSelector-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var a="demobrowser.demo.widget.ColorSelector";
qx.Class.define(a,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var b=new qx.ui.control.ColorSelector();
this.getRoot().add(b,{left:20,top:20});
}}});
})();
...
(function(){var cm="brightness-handle",cl="hue-saturation-handle",ck="hsbSpinner",cj="rgbSpinner",ci="hexField",ch="changeValue",cg="hueSaturationField",cf="brightness-field",ce="mousedown",cd="rgb-spinner-red",bR="rgb-spinner-green",bQ="brightnessField",bP="hue-saturation-field",bO="hsb-spinner-brightness",bN="preview-content-new",bM="hue-saturation-pane",bL="rgb-spinner-blue",bK="hsb-spinner-hue",bJ="hsb-spinner-saturation",bI="hex-field",ct="brightnessModifier",cu="blueModifier",cr="saturationModifier",cs="middle",cp="mouseup",cq="Number",cn="preview-content-old",co="redModifier",cv="greenModifier",cw="hueModifier",bV="Integer",bU="brightness-pane",bX="control-pane",bW="preset-grid",ca="preset-field-set",bY="#",cc="qx.event.type.Event",cb="mousemove",bT="hex-field-composite",bS="rgb-spinner-composite",T="hsb-spinner-composite",U="control-bar",V="visual-pane",W="input-field-set",X="preview-field-set",Y="black",ba="_applyGreen",bb="#333",bc="aqua",bd="colorbucket",cA="Hex",cz="#BBB",cy="decoration/colorselector/brightness-handle.gif",cx="Visual",cE="_applySaturation",cD="Preview (Old/New)",cC="FFFFFF",cB="decoration/colorselector/brightness-field.png",cG="white",cF="orange",bs="_applyRed",bt="_applyBlue",bq="maroon",br="Presets",bw="_applyBrightness",bx="#999",bu="purple",bv="red",bo="mousewheel",bp="blue",bl="_applyHue",bk="decoration/colorselector/huesaturation-handle.gif",bn="colorselector",bm="qx.ui.control.ColorSelector",bh="lime",bg="#EEE",bj="olive",bi="RGB",bf="decoration/colorselector/huesaturation-field.jpg",be="navy",bC="teal",bD="green",bE="yellow",bF="#666",by="fuchsia",bz="Details",bA="",bB="colorbucket#",bG="appear",bH="HSB";
qx.Class.define(bm,{extend:qx.ui.core.Widget,construct:function(){arguments.callee.base.call(this);
this._setLayout(new qx.ui.layout.VBox());
this._createChildControl(U);
this.addListener(bG,this._onAppear,this);
},events:{"dialogok":cc,"dialogcancel":cc},properties:{appearance:{refine:true,init:bn},red:{check:bV,init:255,apply:bs},green:{check:bV,init:255,apply:ba},blue:{check:bV,init:255,apply:bt},hue:{check:cq,init:0,apply:bl},saturation:{check:cq,init:0,apply:cE},brightness:{check:cq,init:100,apply:bw}},members:{__nj:null,__nk:[bq,bv,cF,bE,bj,bu,by,bh,bD,be,bp,bc,bC,Y,bb,bF,bx,cz,bg,cG],__nl:bA,__nm:0,__nn:0,__no:0,_createChildControlImpl:function(E){var F;

switch(E){case U:F=new qx.ui.container.Composite(new qx.ui.layout.HBox(10));
F.add(this.getChildControl(bX));
F.add(this.getChildControl(V));
this._add(F);
break;
case V:F=new qx.ui.groupbox.GroupBox(this.tr(cx));
F.setLayout(new qx.ui.layout.HBox(10));
F.add(this.getChildControl(bM));
F.add(this.getChildControl(bU));
break;
case bX:F=new qx.ui.container.Composite(new qx.ui.layout.VBox(12));
F.add(this.getChildControl(ca));
F.add(this.getChildControl(W));
F.add(this.getChildControl(X),{flex:1});
break;
case bM:F=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
F.setAllowGrowY(false);
F.addListener(cp,this._onHueSaturationPaneMouseWheel,this);
F.add(this.getChildControl(bP));
F.add(this.getChildControl(cl),{left:0,top:256});
break;
case bP:F=new qx.ui.basic.Image(bf);
F.addListener(ce,this._onHueSaturationFieldMouseDown,this);
break;
case cl:F=new qx.ui.basic.Image(bk);
F.addListener(ce,this._onHueSaturationFieldMouseDown,this);
F.addListener(cp,this._onHueSaturationHandleMouseUp,this);
F.addListener(cb,this._onHueSaturationHandleMouseMove,this);
break;
case bU:F=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
F.setAllowGrowY(false);
F.addListener(bo,this._onBrightnessPaneMouseWheel,this);
F.add(this.getChildControl(cf));
F.add(this.getChildControl(cm));
break;
case cf:F=new qx.ui.basic.Image(cB);
F.addListener(ce,this._onBrightnessFieldMouseDown,this);
break;
case cm:F=new qx.ui.basic.Image(cy);
F.addListener(ce,this._onBrightnessHandleMouseDown,this);
F.addListener(cp,this._onBrightnessHandleMouseUp,this);
F.addListener(cb,this._onBrightnessHandleMouseMove,this);
break;
case ca:F=new qx.ui.groupbox.GroupBox(this.tr(br));
F.setLayout(new qx.ui.layout.Grow());
F.add(this.getChildControl(bW));
break;
case bd:F=new qx.ui.core.Widget();
F.addListener(ce,this._onColorFieldClick,this);
break;
case bW:K=new qx.ui.layout.Grid(3,3);
F=new qx.ui.container.Composite(K);
var L;
var J;

for(var i=0;i<2;i++){for(var j=0;j<10;j++){J=i*10+j;
L=this.getChildControl(bB+J);
L.setBackgroundColor(this.__nk[J]);
F.add(L,{column:j,row:i});
}}break;
case W:F=new qx.ui.groupbox.GroupBox(this.tr(bz));
var K=new qx.ui.layout.VBox();
K.setSpacing(10);
F.setLayout(K);
F.add(this.getChildControl(bT));
F.add(this.getChildControl(bS));
F.add(this.getChildControl(T));
break;
case X:F=new qx.ui.groupbox.GroupBox(this.tr(cD));
var K=new qx.ui.layout.HBox(10);
F.setLayout(K);
F.add(this.getChildControl(cn),{flex:1});
F.add(this.getChildControl(bN),{flex:1});
break;
case bT:var I=new qx.ui.layout.HBox(4);
I.setAlignY(cs);
F=new qx.ui.container.Composite(I);
var N=new qx.ui.basic.Label(this.tr(cA));
F.add(N);
var M=new qx.ui.basic.Label(bY);
F.add(M);
F.add(this.getChildControl(bI));
break;
case bI:F=new qx.ui.form.TextField(cC);
F.setWidth(55);
F.addListener(ch,this._onHexFieldChange,this);
break;
case bS:var I=new qx.ui.layout.HBox(4);
I.setAlignY(cs);
F=new qx.ui.container.Composite(I);
var G=new qx.ui.basic.Label(this.tr(bi));
G.setWidth(25);
F.add(G);
F.add(this.getChildControl(cd));
F.add(this.getChildControl(bR));
F.add(this.getChildControl(bL));
break;
case cd:F=new qx.ui.form.Spinner(0,255,255);
F.setWidth(50);
F.addListener(ch,this._setRedFromSpinner,this);
break;
case bR:F=new qx.ui.form.Spinner(0,255,255);
F.setWidth(50);
F.addListener(ch,this._setGreenFromSpinner,this);
break;
case bL:F=new qx.ui.form.Spinner(0,255,255);
F.setWidth(50);
F.addListener(ch,this._setBlueFromSpinner,this);
break;
case T:var I=new qx.ui.layout.HBox(4);
I.setAlignY(cs);
F=new qx.ui.container.Composite(I);
var H=new qx.ui.basic.Label(this.tr(bH));
H.setWidth(25);
F.add(H);
F.add(this.getChildControl(bK));
F.add(this.getChildControl(bJ));
F.add(this.getChildControl(bO));
break;
case bK:F=new qx.ui.form.Spinner(0,0,360);
F.setWidth(50);
F.addListener(ch,this._setHueFromSpinner,this);
break;
case bJ:F=new qx.ui.form.Spinner(0,0,100);
F.setWidth(50);
F.addListener(ch,this._setSaturationFromSpinner,this);
break;
case bO:F=new qx.ui.form.Spinner(0,100,100);
F.setWidth(50);
F.addListener(ch,this._setBrightnessFromSpinner,this);
break;
case cn:F=new qx.ui.core.Widget();
break;
case bN:F=new qx.ui.core.Widget();
break;
}return F||arguments.callee.base.call(this,E);
},_applyRed:function(o,p){if(this.__nj===null){this.__nj=co;
}
if(this.__nj!==cj){this.getChildControl(cd).setValue(o);
}
if(this.__nj!==ci){this._setHexFromRgb();
}
switch(this.__nj){case cj:case ci:case co:this._setHueFromRgb();
}this._setPreviewFromRgb();

if(this.__nj===co){this.__nj=null;
}},_applyGreen:function(b,c){if(this.__nj===null){this.__nj=cv;
}
if(this.__nj!==cj){this.getChildControl(bR).setValue(b);
}
if(this.__nj!==ci){this._setHexFromRgb();
}
switch(this.__nj){case cj:case ci:case cv:this._setHueFromRgb();
}this._setPreviewFromRgb();

if(this.__nj===cv){this.__nj=null;
}},_applyBlue:function(O,P){if(this.__nj===null){this.__nj=cu;
}
if(this.__nj!==cj){this.getChildControl(bL).setValue(O);
}
if(this.__nj!==ci){this._setHexFromRgb();
}
switch(this.__nj){case cj:case ci:case cu:this._setHueFromRgb();
}this._setPreviewFromRgb();

if(this.__nj===cu){this.__nj=null;
}},_applyHue:function(d,f){if(this.__nj===null){this.__nj=cw;
}
if(this.__nj!==ck){this.getChildControl(bK).setValue(d);
}
if(this.__nj!==cg){if(this.getChildControl(cl).getBounds()){this.getChildControl(cl).setDomLeft(Math.round(d/1.40625)+this.getChildControl(bM).getPaddingLeft());
}else{this.getChildControl(cl).setLayoutProperties({left:Math.round(d/1.40625)});
}}
switch(this.__nj){case ck:case cg:case cw:this._setRgbFromHue();
}this._setBrightnessGradiant();

if(this.__nj===cw){this.__nj=null;
}},_applySaturation:function(g,h){if(this.__nj===null){this.__nj=cr;
}
if(this.__nj!==ck){this.getChildControl(bJ).setValue(g);
}
if(this.__nj!==cg){this._setBrightnessGradiant();

if(this.getChildControl(cl).getBounds()){this.getChildControl(cl).setDomTop(256-Math.round(g*2.56)+this.getChildControl(bM).getPaddingTop());
}else{this.getChildControl(cl).setLayoutProperties({top:256-Math.round(g*2.56)});
}}
switch(this.__nj){case ck:case cg:case cr:this._setRgbFromHue();
}
if(this.__nj===cr){this.__nj=null;
}},_applyBrightness:function(B,C){if(this.__nj===null){this.__nj=ct;
}
if(this.__nj!==ck){this.getChildControl(bO).setValue(B);
}
if(this.__nj!==bQ){var D=256-Math.round(B*2.56);

if(this.getChildControl(cm).getBounds()){this.getChildControl(cm).setDomTop(D+this.getChildControl(bU).getPaddingTop());
}else{this.getChildControl(cm).setLayoutProperties({top:D});
}}
switch(this.__nj){case ck:case bQ:case ct:this._setRgbFromHue();
}
if(this.__nj===ct){this.__nj=null;
}},_onBrightnessHandleMouseDown:function(e){this.getChildControl(cm).capture();
this.__nl=cm;
var S=this.getChildControl(cf).getContainerLocation();
var R=this.getChildControl(cm).getContainerLocation();
var Q=this.getChildControl(cf).getBounds();
this.__nm=S.top+(e.getDocumentTop()-R.top)-Q.top;
e.stopPropagation();
},_onBrightnessHandleMouseUp:function(e){this.getChildControl(cm).releaseCapture();
this.__nl=null;
},_onBrightnessHandleMouseMove:function(e){if(this.__nl===cm){this._setBrightnessOnFieldEvent(e);
}},_onBrightnessFieldMouseDown:function(e){var location=this.getChildControl(cf).getContainerLocation();
var cK=this.getChildControl(cm).getBounds();
this.__nm=location.top+(cK.height/2);
this._setBrightnessOnFieldEvent(e);
this.getChildControl(cm).capture();
this.__nl=cm;
},_onBrightnessPaneMouseWheel:function(e){this.setBrightness(qx.lang.Number.limit(this.getBrightness()+e.getWheelDelta(),0,100));
},_setBrightnessOnFieldEvent:function(e){var n=qx.lang.Number.limit(e.getDocumentTop()-this.__nm,0,256);
this.__nj=bQ;

if(this.getChildControl(cm).getBounds()){this.getChildControl(cm).setDomTop(n);
}else{this.getChildControl(cm).setLayoutProperties({top:n});
}this.setBrightness(100-Math.round(n/2.56));
this.__nj=null;
},_onHueSaturationHandleMouseUp:function(e){this.getChildControl(cl).releaseCapture();
this.__nl=null;
},_onHueSaturationHandleMouseMove:function(e){if(this.__nl===cl){this._setHueSaturationOnFieldEvent(e);
}},_onHueSaturationFieldMouseDown:function(e){var location=this.getChildControl(bP).getContainerLocation();
var z=this.getChildControl(cl).getBounds();
var A=this.getChildControl(bP).getBounds();
this.__nn=location.top+(z.height/2)-A.top;
this.__no=location.left+(z.width/2)-A.left;
this._setHueSaturationOnFieldEvent(e);
this.getChildControl(cl).capture();
this.__nl=cl;
...
},_setHueSaturationOnFieldEvent:function(e){var t=qx.lang.Number.limit(e.getDocumentTop()-this.__nn,0,256);
var s=qx.lang.Number.limit(e.getDocumentLeft()-this.__no,0,256);
this.getChildControl(cl).setDomPosition(s,t);
this.__nj=cg;
this.setSaturation(100-Math.round(t/2.56));
this.setHue(Math.round(s*1.40625));
this.__nj=null;
},_setRedFromSpinner:function(){if(this.__nj!==null){return;
}this.__nj=cj;
this.setRed(this.getChildControl(cd).getValue());
this.__nj=null;
...
this.setBlue(this.getChildControl(bL).getValue());
this.__nj=null;
},_setHueFromSpinner:function(){if(this.__nj!==null){return;
}this.__nj=ck;
this.setHue(this.getChildControl(bK).getValue());
this.__nj=null;
},_setSaturationFromSpinner:function(){if(this.__nj!==null){return;
}this.__nj=ck;
this.setSaturation(this.getChildControl(bJ).getValue());
this.__nj=null;
},_setBrightnessFromSpinner:function(){if(this.__nj!==null){return;
}this.__nj=ck;
this.setBrightness(this.getChildControl(bO).getValue());
this.__nj=null;
},_onHexFieldChange:function(e){if(this.__nj!==null){return;
}
try{var l=this.getChildControl(bI);
var k=qx.util.ColorUtil.hexStringToRgb(bY+l.getValue());
}catch(r){return;
}this.__nj=ci;
this.setRed(k[0]);
this.setGreen(k[1]);
this.setBlue(k[2]);
this.__nj=null;
},_setHexFromRgb:function(){this.getChildControl(bI).setValue(qx.util.ColorUtil.rgbToHexString([this.getRed(),this.getGreen(),this.getBlue()]));
},_onColorFieldClick:function(e){var u=e.getTarget().getBackgroundColor();

if(!u){return this.error("Missing backgroundColor value for field: "+e.getTarget());
}var v=qx.util.ColorUtil.stringToRgb(u);
this.setRed(v[0]);
this.setGreen(v[1]);
this.setBlue(v[2]);
},_setHueFromRgb:function(){switch(this.__nj){case ck:case cg:case bQ:break;
...
}},_setRgbFromHue:function(){switch(this.__nj){case cj:case ci:break;
default:var q=qx.util.ColorUtil.hsbToRgb([this.getHue(),this.getSaturation(),this.getBrightness()]);
this.setRed(q.red);
this.setGreen(q.green);
this.setBlue(q.blue);
}},_setPreviewFromRgb:function(){var cL=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(bN).setBackgroundColor(cL);
...
var cJ=cH.rgbToRgbString([cI.red,cI.green,cI.blue]);
this.getChildControl(cf).setBackgroundColor(cJ);
},_onAppear:function(e){var m=qx.util.ColorUtil.rgbToRgbString([this.getRed(),this.getGreen(),this.getBlue()]);
this.getChildControl(cn).setBackgroundColor(m);
this.getChildControl(bN).setBackgroundColor(m);
}}});
})();
