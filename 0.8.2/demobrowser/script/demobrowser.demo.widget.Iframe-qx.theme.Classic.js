...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Iframe", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Iframe-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var k="http://www.gmx.net",j="web.de",i="qx.event.type.DataEvent",h="http://www.web.de",g="GMX",f="load",c="changeValue",b="demobrowser.demo.widget.Iframe";
var a;
qx.Class.define(b,{extend:qx.application.Standalone,events:{"surfTo":i},members:{main:function(){arguments.callee.base.call(this);
a=new qx.ui.embed.Iframe();
var d=this.getRoot();
a.addListener(f,function(e){this.debug("Loaded: "+this.getSource());
});
a.setSource(k);
d.add(a,{top:100,right:20,bottom:20,left:20});
var m=new qx.ui.form.RadioButton(g).set({value:k});
var n=new qx.ui.form.RadioButton(j).set({value:h});
m.setChecked(true);
var l=new qx.ui.form.RadioGroup(m,n);
l.addListener(c,function(e){this.setSource(e.getData());
},a);
d.add(m,{left:20,top:48});
d.add(n,{left:120,top:48});
}}});
})();
...
(function(){var p="display",o="mousedown",n="load",m="String",l="mouseup",k="losecapture",j="none",i="repeat",h="height",g="px",K="url(",J=")",I="__jE",H="qx.client",G="div",F="_applyFrameName",E="qx.event.type.Event",D="name",C="",B="width",w="zIndex",x="_applySource",u="top",v="mshtml",s="block",t="qx.ui.embed.Iframe",q="position",r="iframe",y="left",z="absolute",A="qx/static/blank.gif";
qx.Class.define(t,{extend:qx.ui.core.Widget,include:qx.ui.core.MNativeOverflow,construct:function(a){if(a!=null){this.__jD=a;
}arguments.callee.base.call(this);
...
},events:{"load":E},properties:{appearance:{refine:true,init:r},source:{check:m,apply:x,nullable:true},frameName:{check:m,init:C,apply:F}},members:{__jD:null,__jE:null,renderLayout:function(b,top,c,d){arguments.callee.base.call(this,b,top,c,d);
var f=g;
var e=this.getInsets();
this.__jE.setStyle(y,e.left+f);
this.__jE.setStyle(u,e.top+f);
this.__jE.setStyle(B,(c-e.left-e.right)+f);
this.__jE.setStyle(h,(d-e.top-e.bottom)+f);
},_createContentElement:function(){var Q=new qx.html.Iframe(this.__jD);
Q.addListener(n,this._onIframeLoad,this);
return Q;
},_createBlockerElement:function(){var L=new qx.html.Element(G);
L.setStyle(w,20);
L.setStyle(q,z);
L.setStyle(p,j);
if(qx.core.Variant.isSet(H,v)){L.setStyles({backgroundImage:K+qx.util.ResourceManager.toUri(A)+J,backgroundRepeat:i});
}return L;
},_onIframeLoad:function(e){this.fireNonBubblingEvent(n);
...
},block:function(){this.__jE.setStyle(p,s);
},release:function(){this.__jE.setStyle(p,j);
},reload:function(){this.getContentElement().reload();
},_applySource:function(M,N){this.getContentElement().setSource(M);
},_applyFrameName:function(O,P){this.getContentElement().setAttribute(D,O);
...
},events:{"load":h},members:{_applyProperty:function(name,c){arguments.callee.base.call(this,name,c);

if(name==k){var d=this.getDomElement();
qx.bom.Iframe.setSource(d,c);
