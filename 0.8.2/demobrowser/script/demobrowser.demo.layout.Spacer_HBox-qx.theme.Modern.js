...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Spacer_HBox", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Spacer_HBox-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
k.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i}));
return k;
},getSpacerWithFlex:function(){var b=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h,height:100,width:400});
var c=new qx.ui.layout.HBox();
c.setSpacing(5);
b.setLayout(c);
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:g}));
b.add(new qx.ui.core.Spacer(30,40),{flex:1});
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:e}));
b.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:f}));
return b;
},getAddRemoveSpacer:function(){var m=new qx.ui.container.Composite().set({decorator:j,backgroundColor:h});
var o=new qx.ui.layout.HBox();
o.setSpacing(5);
m.setLayout(o);
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:g}));
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:e}));
var n=new qx.ui.core.Spacer(30,40);
m.add(n,{flex:1});
m.add(new qx.ui.core.Widget().set({decorator:j,backgroundColor:i,maxHeight:40,alignY:f}));
m.remove(n);
return m;
}}});
})();
