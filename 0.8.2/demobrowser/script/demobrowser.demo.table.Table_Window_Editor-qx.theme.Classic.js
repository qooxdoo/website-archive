...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.table.Table_Window_Editor", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.table.Table_Window_Editor-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
},properties:{selectionModel:{check:r}},members:{__qL:null,handleMouseDown:function(l,m){if(m.isLeftPressed()){var n=this.getSelectionModel();
...
}}else{if(!(d==c&&d==a&&e.getSelectedCount()==1)){e.setSelectionInterval(a,a);
}}}}});
})();
(function(){var O="px",N="Cell ",M="x",L="demobrowser.demo.table.MUtil",K="500px",J="Column #",I="#FFE",H="div",G="absolute";
...
},updateContent:function(){},setFocusedCell:function(y,z){},getKeepFirstVisibleRowComplete:function(){return true;
},_updateScrollBarVisibility:function(){},getSelectionManager:function(){return T;
},getNewTablePaneHeader:function(U){return function(E){var F=new qx.ui.table.pane.Header(E);
return F;
};
},getNewTablePane:function(a){return function(W){return new qx.ui.table.pane.Pane(W);
};
},getEnabled:function(){return true;
}};
return P;
},getSelectionMock:function(){return {isSelectedIndex:function(V){return V==0;
...
},getColumnWidth:function(bc){return 100;
},setColumnWidth:function(u,v){},getVisibleX:function(x){return x;
},getHeaderCellRenderer:function(bb){return new qx.ui.table.headerrenderer.Default();
},getDataCellRenderer:function(){return new qx.ui.table.cellrenderer.Default();
},addListener:function(){}};
},getPaneModelMock:function(){var X={getColumnAtX:function(x){return x;
},getColumnCount:function(){return 4;
},getX:function(w){return w;
},getColumnLeft:function(t){return t*100;
},getTotalWidth:function(){return 4*100;
}};
return X;
},getModelMock:function(){return {getSortColumnIndex:function(){return 0;
},isSortAscending:function(){return true;
},isColumnSortable:function(e){return true;
},getColumnName:function(q){return J+q;
},isColumnEditable:function(bf){return false;
},sortByColumn:function(r,s){},getRowCount:function(){return 500;
},prefetchRows:function(){},getRowData:function(bd){var be=[];

for(var i=0;i<4;i++){be.push(N+i+M+bd);
}return be;
},getValue:function(f,g){return N+f+M+g;
}};
},getPaneMock:function(){return {getFirstVisibleRow:function(){return 0;
}};
},getScrollerMock:function(){var c=this.getTableMock();
var b=this.getPaneModelMock();
var d=this.getPaneMock();
return {getTable:function(){return c;
},getTablePaneModel:function(){return b;
},getTablePane:function(){return d;
}};
},_getNewTableDiv:function(Y){var ba=qx.bom.Element.create(H);
qx.bom.element.Style.setStyles(ba,{position:G,left:this._tableLeft+O,width:(Y||150)+O,top:20+O,height:K,backgroundColor:I});
this._tableLeft+=(Y||150)+20;
document.body.appendChild(ba);
return ba;
},permute:function(h,j,k){var m=qx.lang.Object.getKeys(h);
var l={};
var p=[];

for(var i=0;i<m.length;i++){p[i]=0;
var o=m[i];
l[o]=h[o][0];
}var n=function(A,B){if(A>=m.length){return;
}var D=m[A];
var C=h[D];

for(var i=0;i<C.length;i++){if(B!==i){p[A]=i;
l[D]=C[i];
j.call(k||window,l);
}n(A+1,p[A+1]);
}};
...
(function(){var n="_controls",m="icon/32/status/dialog-information.png",l="",k="_table",j="center",i="icon/16/apps/office-spreadsheet.png",h="OK",g="demobrowser.demo.table.TableDemo",f="_container",e="execute";
...
this._container=new qx.ui.window.Window(this.getCaption(),i).set({width:600,height:400,contentPadding:[0,0,0,0],showClose:false,showMinimize:false});
...
},nextId:0,createRandomRows:function(o){var r=[];
var q=new Date().getTime();
var s=400*24*60*60*1000;

for(var t=0;t<o;t++){var p=new Date(q+Math.random()*s-s/2);
r.push([this.nextId++,Math.random()*10000,p,(Math.random()>0.5)]);
}return r;
},getCaption:function(){return l;
},createTable:function(){throw new Error("abstract method call");
},createControls:function(){return null;
},showDialog:function(a){if(!this.__vv){var d=this.__vv=new qx.ui.window.Window().set({modal:true,showMinimize:false,showMaximize:false,width:180,contentPadding:[10,10,10,10]});
d.moveTo(315,100);
var b=new qx.ui.layout.Grid(15,15);
b.setRowFlex(0,1);
b.setColumnFlex(1,1);
d.setLayout(b);
d.add(new qx.ui.basic.Image(m),{row:0,column:0});
d.add(new qx.ui.basic.Label().set({rich:true,allowGrowY:true}),{row:0,column:1});
var c=new qx.ui.form.Button(h).set({alignX:j,allowGrowX:false,padding:[2,10]});
c.addListener(e,function(e){d.close();
},this);
d.add(c,{row:1,column:0,colSpan:2});
}this.__vv.getChildren()[1].setContent(a);
this.__vv.open();
this.__vv.getChildren()[2].focus();
}},destruct:function(){this._disposeFields(k,n,f);
}});
})();
...
(function(){var v="execute",u="Enter",t="A boolean",s="A number",r="Table with window cell editor",q="A date",p="",o="ModalCellEditorFactory",n="1*",m="50%",j="demobrowser.demo.table.Table_Window_Editor",l="appear",k="Cell Editor",i="ID",h="Save";
qx.Class.define(j,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return r;
},createTable:function(){var f=this.createRandomRows(50);
var d=new qx.ui.table.model.Simple();
d.setColumns([i,s,q,t]);
d.setData(f);
d.setColumnEditable(1,true);
var c={tableColumnModel:function(A){return new qx.ui.table.columnmodel.Resize(A);
}};
...
var b=e.getBehavior();
b.set(0,{width:n,minWidth:40,maxWidth:80});
b.setWidth(1,m);
b.setMinWidth(1,100);
b.setMaxWidth(1,320);
b.set(3,{width:100});
e.setDataCellRenderer(3,new qx.ui.table.cellrenderer.Boolean());
g.setShowCellFocusIndicator(false);
e.setCellEditorFactory(1,new ModalCellEditorFactory());
return g;
}}});
qx.Class.define(o,{extend:qx.core.Object,implement:qx.ui.table.ICellEditorFactory,members:{createCellEditor:function(w){var z=new qx.ui.window.Window(k);
z.setLayout(new qx.ui.layout.HBox(4));
z.set({padding:3,modal:true,showClose:false,showMaximize:false,showMinimize:false});
z.moveTo(300,250);
z.addListener(l,function(e){z.__vR.focus();
z.__vR.setSelection(0,z.__vR.getValue().length);
});
z.__vR=new qx.ui.form.TextField(w.value+p).set({allowGrowY:true});
z.add(z.__vR);
var x=new qx.ui.form.Button(h);
x.addListener(v,function(e){z.close();
});
z.add(x);
var y=new qx.event.Command(u);
y.addListener(v,function(e){x.execute();
y.dispose();
y=null;
});
return z;
},getCellEditorValue:function(a){return parseFloat(a.__vR.getValue());
}}});
})();
...
(function(){var M="..",L="__qC",K="changeSelection",J="_applySelectionMode",I="]",H="qx.event.type.Event",G="Ranges:",F="qx.ui.table.selection.Model",E=" [";
...
this.__qF=false;
},events:{"changeSelection":H},statics:{NO_SELECTION:1,SINGLE_SELECTION:2,SINGLE_INTERVAL_SELECTION:3,MULTIPLE_INTERVAL_SELECTION:4,MULTIPLE_INTERVAL_SELECTION_TOGGLE:5},properties:{selectionMode:{init:2,check:[1,2,3,4,5],apply:J}},members:{__qF:null,__qD:null,__qE:null,__qC:null,_applySelectionMode:function(Q){this.clearSelection();
...
for(var i=0;i<this.__qC.length;i++){var C=this.__qC[i];
D+=C.maxIndex-C.minIndex+1;
}return D;
},isSelectedIndex:function(e){for(var i=0;i<this.__qC.length;i++){var f=this.__qC[i];

if(e>=f.minIndex&&e<=f.maxIndex){return true;
}}return false;
},getSelectedRanges:function(){var l=[];

for(var i=0;i<this.__qC.length;i++){l.push({minIndex:this.__qC[i].minIndex,maxIndex:this.__qC[i].maxIndex});
}return l;
},iterateSelection:function(c,d){for(var i=0;i<this.__qC.length;i++){for(var j=this.__qC[i].minIndex;j<=this.__qC[i].maxIndex;j++){c.call(d,j);
}}},setSelectionInterval:function(N,O){var P=arguments.callee.self;

switch(this.getSelectionMode()){case P.NO_SELECTION:return;
case P.SINGLE_SELECTION:N=O;
break;
...
break;
}},removeSelectionInterval:function(u,v){this.__qD=u;
this.__qE=v;
var w=Math.min(u,v);
var y=Math.max(u,v);
for(var i=0;i<this.__qC.length;i++){var A=this.__qC[i];

if(A.minIndex>y){break;
}else if(A.maxIndex>=w){var B=(A.minIndex>=w)&&(A.minIndex<=y);
var z=(A.maxIndex>=w)&&(A.maxIndex<=y);

if(B&&z){this.__qC.splice(i,1);
i--;
}else if(B){A.minIndex=y+1;
}else if(z){A.maxIndex=w-1;
}else{var x={minIndex:y+1,maxIndex:A.maxIndex};
this.__qC.splice(i+1,0,x);
A.maxIndex=w-1;
break;
}}}this._fireChangeSelection();
...
this.__qD=-1;
this.__qE=-1;
},_addSelectionInterval:function(n,o){this.__qD=n;
this.__qE=o;
var p=Math.min(n,o);
var r=Math.max(n,o);
var q=0;

for(;q<this.__qC.length;q++){var s=this.__qC[q];

if(s.minIndex>p){break;
}}this.__qC.splice(q,0,{minIndex:p,maxIndex:r});
var t=this.__qC[0];

for(var i=1;i<this.__qC.length;i++){var s=this.__qC[i];

if(t.maxIndex+1>=s.minIndex){t.maxIndex=Math.max(t.maxIndex,s.maxIndex);
this.__qC.splice(i,1);
i--;
}else{t=s;
}}},_dumpRanges:function(){var a=G;

for(var i=0;i<this.__qC.length;i++){var b=this.__qC[i];
a+=E+b.minIndex+M+b.maxIndex+I;
}this.debug(a);
...
qx.Interface.define(e,{members:{updateDataRowElement:function(a,b){},getRowHeightStyle:function(c){},createRowStyle:function(d){},getRowClass:function(f){}}});
})();
(function(){var l="",k="table-row-background-even",j="Boolean",i="__qH",h="default",g="height:",f="'",e="table-row",d="table-row-background-focused",c=';color:',y="table-row-background-odd",x="1px solid ",w="table-row-line",v="table-row-background-selected",u="background-color:",t=';border-bottom: 1px solid ',s="table-row-selected",r="__qI",q="table-row-background-focused-selected",p="px;",n="__qG",o="qx.ui.table.rowrenderer.Default",m=";";
...
var b=qx.theme.manager.Color.getInstance();
this.__qH.bgcolFocusedSelected=b.resolve(q);
this.__qH.bgcolFocused=b.resolve(d);
this.__qH.bgcolSelected=b.resolve(v);
this.__qH.bgcolEven=b.resolve(k);
this.__qH.bgcolOdd=b.resolve(y);
this.__qH.colSelected=b.resolve(s);
this.__qH.colNormal=b.resolve(e);
this.__qH.horLine=b.resolve(w);
},properties:{highlightFocusRow:{check:j,init:true}},members:{__qH:null,__qI:null,__qG:null,_insetY:1,_renderFont:function(G){if(G){this.__qI=G.getStyles();
this.__qG=qx.bom.element.Style.compile(this.__qI);
this.__qG=this.__qG.replace(/"/g,f);
}else{this.__qG=l;
this.__qI=qx.bom.Font.getDefaultStyles();
}},updateDataRowElement:function(A,B){var D=this.__qI;
var C=B.style;
qx.bom.element.Style.setStyles(B,D);

if(A.focusedRow&&this.getHighlightFocusRow()){C.backgroundColor=A.selected?this.__qH.bgcolFocusedSelected:this.__qH.bgcolFocused;
}else{if(A.selected){C.backgroundColor=this.__qH.bgcolSelected;
}else{C.backgroundColor=(A.row%2==0)?this.__qH.bgcolEven:this.__qH.bgcolOdd;
}}C.color=A.selected?this.__qH.colSelected:this.__qH.colNormal;
C.borderBottom=x+this.__qH.horLine;
...
if(E.focusedRow&&this.getHighlightFocusRow()){F.push(E.selected?this.__qH.bgcolFocusedSelected:this.__qH.bgcolFocused);
}else{if(E.selected){F.push(this.__qH.bgcolSelected);
}else{F.push((E.row%2==0)?this.__qH.bgcolEven:this.__qH.bgcolOdd);
}}F.push(c);
F.push(E.selected?this.__qH.colSelected:this.__qH.colNormal);
F.push(t,this.__qH.horLine);
return F.join(l);
},getRowClass:function(z){return l;
}},destruct:function(){this._disposeFields(i,r,n);
}});
})();
(function(){var h="hovered",g="__ri",f="qx.ui.table.pane.Header";
qx.Class.define(f,{extend:qx.ui.core.Widget,construct:function(i){arguments.callee.base.call(this);
...
}},setMouseOverColumn:function(j){if(j!=this.__rk){if(this.__rk!=null){var k=this.getHeaderWidgetAtColumn(this.__rk);

if(k!=null){k.removeState(h);
}}
if(j!=null){this.getHeaderWidgetAtColumn(j).addState(h);
}this.__rk=j;
...
if(this.__rj==null){var z=this.getPaneScroller().getTablePaneModel().getX(y);
...
this.__rj=A;
}this.__rj.setLayoutProperties({left:C.left+x});
this.__rj.show();
...
},_updateContent:function(l){var q=this.getTable().getTableModel();
var t=this.getTable().getTableColumnModel();
var u=this.getPaneScroller().getTablePaneModel();
var w=this._getChildren();
var r=u.getColumnCount();
var m=0;

if(q!=null){m=q.getSortColumnIndex();
}if(l){this._cleanUpCells();
}var n={};
n.sortedAscending=false;

if(q!=null){n.sortedAscending=q.isSortAscending();
}
for(var x=0;x<r;x++){var p=u.getColumnAtX(x);
var v=t.getColumnWidth(p);
var s=t.getHeaderCellRenderer(p);
n.xPos=x;
n.col=p;
n.name=q.getColumnName(p);
n.editable=q.isColumnEditable(p);
n.sorted=(p==m);
var o=w[x];
if(o==null){o=s.createHeaderCell(n);
o.set({width:v});
this._add(o);
}else{s.updateHeaderCell(n,o);
...
(function(){var I="",H="Number",G='</div>',F='" ',E='<div>',D="</div>",C="div",B="overflow: hidden;",A='style="',z="_applyMaxCacheLines",ba="qx.ui.table.pane.Pane",Y="width: 100%;",X="_applyVisibleRowCount",W='>',V="line-height: ",U="appear",T='class="',S="width:100%;",R="px;",Q='<div ',O="__rb",P="__ra",M="'>",N="_applyFirstVisibleRow",K="<div style='",L=";position:relative;",J="__qW";
qx.Class.define(ba,{extend:qx.ui.core.Widget,construct:function(bJ){arguments.callee.base.call(this);
this.__qW=bJ;
this.__qX=0;
this.__qY=0;
this.__ra=[];
},properties:{firstVisibleRow:{check:H,init:0,apply:N},visibleRowCount:{check:H,init:0,apply:X},maxCacheLines:{check:H,init:1000,apply:z},allowShrinkX:{refine:true,init:false}},members:{__qY:null,__qX:null,__qW:null,__rb:null,__rc:null,__rd:null,__ra:null,__re:0,_applyFirstVisibleRow:function(cg,ch){this.updateContent(false,cg-ch);
},_applyVisibleRowCount:function(j,k){this.updateContent(true);
},_getContentHint:function(){return {width:this.getPaneScroller().getTablePaneModel().getTotalWidth(),height:400};
},getPaneScroller:function(){return this.__qW;
},getTable:function(){return this.__qW.getTable();
},setFocusedCell:function(ca,cb,cc){if(ca!=this.__rd||cb!=this.__rc){var cd=this.__rc;
this.__rd=ca;
this.__rc=cb;
if(cb!=cd&&!cc){if(cb!==null&&cd!==null){this.updateContent(false,null,cd,true);
this.updateContent(false,null,cb,true);
}else{this.updateContent();
}}}},onSelectionChanged:function(){this.updateContent(false,null,null,true);
},onFocusChanged:function(){this.updateContent(false,null,null,true);
},setColumnWidth:function(ce,cf){this.updateContent(true);
},onColOrderChanged:function(){this.updateContent(true);
},onPaneModelChanged:function(){this.updateContent(true);
},onTableModelDataChanged:function(bD,bE,bF,bG){this.__rf();
var bI=this.getFirstVisibleRow();
var bH=this.getVisibleRowCount();

if(bE==-1||bE>=bI&&bD<bI+bH){this.updateContent();
}},onTableModelMetaDataChanged:function(){this.updateContent(true);
},_applyMaxCacheLines:function(cv,cw){if(this.__re>=cv&&cv!==-1){this.__rf();
}},__rf:function(){this.__ra=[];
this.__re=0;
},__rg:function(a,b,c){if(!b&&!c&&this.__ra[a]){return this.__ra[a];
}else{return null;
}},__rh:function(d,e,f,g){var h=this.getMaxCacheLines();

if(!f&&!g&&!this.__ra[d]&&h>0){this._applyMaxCacheLines(h);
this.__ra[d]=e;
this.__re+=1;
}},updateContent:function(bV,bW,bX,bY){if(bV){this.__rf();
}if(bW&&Math.abs(bW)<=Math.min(10,this.getVisibleRowCount())){this._scrollContent(bW);
}else if(bY&&!this.getTable().getAlwaysUpdateCells()){this._updateRowStyles(bX);
}else{this._updateAllRows();
}},_updateRowStyles:function(bK){var bO=this.getContentElement().getDomElement();

if(!bO||!bO.firstChild){this._updateAllRows();
return;
}var bS=this.getTable();
var bM=bS.getSelectionModel();
var bP=bS.getTableModel();
var bT=bS.getDataRowRenderer();
var bN=bO.firstChild.childNodes;
var bR={table:bS};
var bU=this.getFirstVisibleRow();
var y=0;
var bL=bN.length;

if(bK!=null){var bQ=bK-bU;
...
for(;y<bL;y++,bU++){bR.row=bU;
bR.selected=bM.isSelectedIndex(bU);
bR.focusedRow=(this.__rc==bU);
bR.rowData=bP.getRowData(bU);
bT.updateDataRowElement(bR,bN[y]);
}},_getRowsHtml:function(bb,bc){var bh=this.getTable();
var bk=bh.getSelectionModel();
var bf=bh.getTableModel();
var bg=bh.getTableColumnModel();
var by=this.getPaneScroller().getTablePaneModel();
var bp=bh.getDataRowRenderer();
bf.prefetchRows(bb,bb+bc-1);
var bv=bh.getRowHeight();
var bx=by.getColumnCount();
var bz=0;
var be=[];
for(var x=0;x<bx;x++){var bA=by.getColumnAtX(x);
var bj=bg.getColumnWidth(bA);
be.push({col:bA,xPos:x,editable:bf.isColumnEditable(bA),focusedCol:this.__rd==bA,styleLeft:bz,styleWidth:bj});
bz+=bj;
}var bB=[];

for(var bi=bb;bi<bb+bc;bi++){var bl=bk.isSelectedIndex(bi);
var bo=(this.__rc==bi);
var bs=this.__rg(bi,bl,bo);
...
bu.selected=bl;
bu.focusedRow=bo;
bu.rowData=bf.getRowData(bi);
br.push(Q);
var bd=bp.getRowClass(bu);

if(bd){br.push(T,bd,F);
}var bq=bp.createRowStyle(bu);
bq+=L+bp.getRowHeightStyle(bv)+S;

if(bq){br.push(A,bq,F);
}br.push(W);

for(var x=0;x<bx;x++){var bm=be[x];

for(var bw in bm){bu[bw]=bm[bw];
}var bA=bu.col;
bu.value=bf.getValue(bA,bi);
var bn=bg.getDataCellRenderer(bA);
bn.createDataCellHtml(bu,br);
}br.push(G);
var bt=br.join(I);
this.__rh(bi,bt,bl,bo);
bB.push(bt);
}return bB.join(I);
},_scrollContent:function(ci){var cj=this.getContentElement().getDomElement();

if(!(cj&&cj.firstChild)){this._updateAllRows();
return;
}var cs=cj.firstChild;
var ck=cs.childNodes;
var cq=this.getVisibleRowCount();
var cp=this.getFirstVisibleRow();
var cn=this.getTable().getTableModel();
var ct=0;

if(cn!=null){ct=cn.getRowCount();
}if(cp+cq>ct){this._updateAllRows();
return;
}var cu=ci<0?cq+ci:0;
var cl=ci<0?0:cq-ci;

for(i=Math.abs(ci)-1;i>=0;i--){var co=ck[cu];

try{cs.removeChild(co);
}catch(bC){break;
}}if(!this.__rb){this.__rb=document.createElement(C);
}var cr=E;
cr+=this._getRowsHtml(cp+cl,Math.abs(ci));
cr+=G;
this.__rb.innerHTML=cr;
var cm=this.__rb.firstChild.childNodes;
if(ci>0){for(var i=cm.length-1;i>=0;i--){var co=cm[0];
cs.appendChild(co);
}}else{for(var i=cm.length-1;i>=0;i--){var co=cm[cm.length-1];
cs.insertBefore(co,cs.firstChild);
}}if(this.__rc!==null){this._updateRowStyles(this.__rc-ci);
this._updateRowStyles(this.__rc);
}},_updateAllRows:function(){var o=this.getContentElement().getDomElement();

if(!o){this.addListenerOnce(U,arguments.callee,this);
return;
}var u=this.getTable();
var r=u.getTableModel();
var t=this.getPaneScroller().getTablePaneModel();
var s=t.getColumnCount();
var l=u.getRowHeight();
var p=this.getFirstVisibleRow();
var m=this.getVisibleRowCount();
var v=0;

if(r!=null){v=r.getRowCount();
}
if(p+m>v){m=Math.max(0,v-p);
}var n=t.getTotalWidth();
var q;
if(m>0){q=[K,Y,(u.getForceLineHeight()?V+l+R:I),B,M,this._getRowsHtml(p,m),D];
}else{q=[];
}var w=q.join(I);
o.innerHTML=w;
this.setWidth(n);
this.__qX=s;
this.__qY=m;
}},destruct:function(){this._disposeFields(O,J,P);
}});
})();
...
j.setColumnFlex(2,1);
this.setLayout(j);
},properties:{appearance:{refine:true,init:c},label:{check:g,init:null,nullable:true,apply:a},sortIcon:{check:g,init:null,nullable:true,apply:e,themeable:true},icon:{check:g,init:null,nullable:true,apply:d}},members:{_applyLabel:function(q,r){if(q){this._showChildControl(h).setContent(q);
}else{this._excludeChildControl(h);
}},_applySortIcon:function(m,n){if(m){this._showChildControl(f).setSource(m);
}else{this._excludeChildControl(f);
}},_applyIcon:function(k,l){if(k){this._showChildControl(i).setSource(k);
}else{this._excludeChildControl(i);
}},_createChildControlImpl:function(o){var p;

switch(o){case h:p=new qx.ui.basic.Label(this.getLabel()).set({anonymous:true,allowShrinkX:true});
this._add(p,{row:0,column:1});
break;
case f:p=new qx.ui.basic.Image(this.getSortIcon());
p.setAnonymous(true);
this._add(p,{row:0,column:2});
break;
case i:p=new qx.ui.basic.Image(this.getIcon()).set({anonymous:true,allowShrinkX:true});
...
(function(){var q="atom",p="Integer",o="String",n="_applyRich",m="qx.ui.tooltip.ToolTip",l="_applyIcon",k="tooltip",j="Boolean",i="_applyLabel";
qx.Class.define(m,{extend:qx.ui.popup.Popup,construct:function(u,v){arguments.callee.base.call(this);
...
}},properties:{appearance:{refine:true,init:k},showTimeout:{check:p,init:1000,themeable:true},hideTimeout:{check:p,init:4000,themeable:true},label:{check:o,nullable:true,apply:i},icon:{check:o,nullable:true,apply:l,themeable:true},rich:{check:j,init:false,apply:n}},members:{_createChildControlImpl:function(g){var h;

switch(g){case q:h=new qx.ui.basic.Atom;
this._add(h);
break;
...
},_applyLabel:function(d,e){var f=this.getChildControl(q);
...
(function(){var o="focusout",n="interval",m="mouseover",l="mousemove",k="mouseout",j="__ju",i="qx.ui.tooltip.ToolTip",h="__jt",g="_applyCurrent",f="qx.ui.tooltip.Manager",c="__jv",d="singleton";
qx.Class.define(f,{type:d,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
qx.event.Registration.addListener(document.body,m,this.__jz,this,true);
this.__jt=new qx.event.Timer();
this.__jt.addListener(n,this.__jw,this);
this.__ju=new qx.event.Timer();
this.__ju.addListener(n,this.__jx,this);
this.__jv={left:0,top:0};
},properties:{current:{check:i,nullable:true,apply:g}},members:{__jv:null,__ju:null,__jt:null,_applyCurrent:function(q,r){if(r&&qx.ui.core.Widget.contains(r,q)){return;
}if(r){r.exclude();
this.__jt.stop();
this.__ju.stop();
}var t=qx.event.Registration;
var s=document.body;
if(q){this.__jt.startWith(q.getShowTimeout());
t.addListener(s,k,this.__jA,this,true);
t.addListener(s,o,this.__jB,this,true);
t.addListener(s,l,this.__jy,this,true);
}else{t.removeListener(s,k,this.__jA,this,true);
t.removeListener(s,o,this.__jB,this,true);
t.removeListener(s,l,this.__jy,this,true);
}},__jw:function(e){var b=this.getCurrent();

if(b){this.__ju.startWith(b.getHideTimeout());
b.placeToPoint(this.__jv);
b.show();
}this.__jt.stop();
},__jx:function(e){var p=this.getCurrent();
...
},__jz:function(e){var z=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
...
}},__jA:function(e){var w=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
...
}},__jB:function(e){var u=qx.ui.core.Widget.getWidgetByElement(e.getTarget());

if(!u){return;
}var v=this.getCurrent();
if(v&&v==u.getToolTip()){this.setCurrent(null);
}}},destruct:function(){qx.event.Registration.removeListener(document.body,m,this.__jz,this,true);
this._disposeObjects(h,j);
...
if(!S.__qM){var U=qx.theme.manager.Color.getInstance();
S.__qM=arguments.callee.self;
var T=i+
qx.bom.element.Style.compile({position:x,top:E,overflow:t,whiteSpace:f,borderRight:C+U.resolve(A),padding:G,cursor:e,textOverflow:s,userSelect:m})+u+H+v+B;

if(!qx.core.Variant.isSet(d,y)){T+=i+qx.bom.element.BoxSizing.compile(p)+c;
}S.__qM.stylesheet=qx.bom.Stylesheet.createElement(T);
}},members:{_insetX:6+6+1,_insetY:0,_getCellClass:function(I){return h;
},_getCellStyle:function(R){return R.style||k;
},_getCellAttributes:function(a){return k;
},_getContentHtml:function(O){return O.value||k;
},_getCellSizeStyle:function(J,K,L,M){var N=k;

if(qx.bom.client.Feature.CONTENT_BOX){J-=L;
K-=M;
}N+=b+J+j;
N+=D+K+j;
return N;
},createDataCellHtml:function(P,Q){Q.push(F,this._getCellClass(P),o,q,P.styleLeft,w,this._getCellSizeStyle(P.styleWidth,P.styleHeight,this._insetX,this._insetY),this._getCellStyle(P),g,this._getCellAttributes(P),z+this._getContentHtml(P),r);
}}});
})();
...
(function(){var O="",N="Number",M="-",L="0",K="String",J='(',I="g",H="Boolean",G="$",F="NaN",z='([0-9]{1,3}(?:',E='{0,1}[0-9]{3}){0,})',C="qx.util.format.NumberFormat",y='\\d+){0,1}',x="^",B=".",A="-Infinity",D="Infinity",w='([-+]){0,1}';
qx.Class.define(C,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(P){arguments.callee.base.call(this);
this.__np=P;
},statics:{getIntegerInstance:function(){var j=qx.util.format.NumberFormat;

if(j._integerInstance==null){j._integerInstance=new j();
j._integerInstance.setMaximumFractionDigits(0);
}return j._integerInstance;
},getInstance:function(){if(!this._instance){this._instance=new this;
}return this._instance;
}},properties:{minimumIntegerDigits:{check:N,init:0},maximumIntegerDigits:{check:N,nullable:true},minimumFractionDigits:{check:N,init:0},maximumFractionDigits:{check:N,nullable:true},groupingUsed:{check:H,init:true},prefix:{check:K,init:O},postfix:{check:K,init:O}},members:{__np:null,format:function(k){switch(k){case Infinity:return D;
...
if(this.getMaximumFractionDigits()!=null){var v=Math.pow(10,this.getMaximumFractionDigits());
k=Math.round(k*v)/v;
}var u=String(Math.floor(k)).length;
var l=O+k;
var r=l.substring(0,u);

while(r.length<this.getMinimumIntegerDigits()){r=L+r;
}
if(this.getMaximumIntegerDigits()!=null&&r.length>this.getMaximumIntegerDigits()){r=r.substring(r.length-this.getMaximumIntegerDigits());
}var q=l.substring(u+1);

while(q.length<this.getMinimumFractionDigits()){q+=L;
}
if(this.getMaximumFractionDigits()!=null&&q.length>this.getMaximumFractionDigits()){q=q.substring(0,this.getMaximumFractionDigits());
}if(this.getGroupingUsed()){var n=r;
r=O;
var t;

for(t=n.length;t>3;t-=3){r=O+qx.locale.Number.getGroupSeparator(this.__np)+n.substring(t-3,t)+r;
}r=n.substring(0,t)+r;
}var p=this.getPrefix()?this.getPrefix():O;
var m=this.getPostfix()?this.getPostfix():O;
var s=p+(o?M:O)+r;

if(q.length>0){s+=O+qx.locale.Number.getDecimalSeparator(this.__np)+q;
}s+=m;
return s;
},parse:function(a){var f=qx.lang.String.escapeRegexpChars(qx.locale.Number.getGroupSeparator(this.__np)+O);
var d=qx.lang.String.escapeRegexpChars(qx.locale.Number.getDecimalSeparator(this.__np)+O);
var b=new RegExp(x+qx.lang.String.escapeRegexpChars(this.getPrefix())+w+z+f+E+J+d+y+qx.lang.String.escapeRegexpChars(this.getPostfix())+G);
var e=b.exec(a);
...
(function(){var bM="(\\d\\d?)",bL="",bK="(",bJ=")",bI="|",bH="abbreviated",bG="wide",bF="wildcard",bE="default",bD="literal",bs="'",br="hour",bq="(\\d\\d?\\d?)",bp="ms",bo="-",bn="quoted_literal",bm='a',bl="+",bk="HHmmss",bj="long",bT="sec",bU="HH:mm:ss",bR='z',bS="day",bP="narrow",bQ='Z',bN="min",bO=" ",bV="SSS",bW="h",bw="SS",bv="Z",by="__mB",bx="00",bA='K',bz="EEEE",bC="^",bB='y',bu="(\\d\\d(\\d\\d)?)",bt="__mA",q="__mz",r="(\\d\\d)",s="K",t="((\\+|\\-)\\d\\d:?\\d\\d)",u="a",v="GMT",w="S",x="dd",y="qx.util.format.DateFormat",z="__my",cb="H",ca="YYYY",bY="EE",bX="mm",cf='h',ce='s',cd='A',cc="KK",ch="ss",cg='H',S='S',T="0",Q="MMMM",R="d",W="([a-zA-Z]+)",X="HH",U='k',V="m",O='Y',P='D',H="kk",G="hh",J="MM",I="yy",D="yyyy-MM-dd HH:mm:ss",C="short",F='d',E="unkown",B='m',A=":00",bd="(\\d\\d\\d\\d)",be="k",bf='M',bg="__mC",Y="MMM",ba="s",bb="M",bc='w',bh="EEE",bi="$",N="?",M='E',L="z",K="yyyy";
qx.Class.define(y,{extend:qx.core.Object,implement:qx.util.format.IFormat,construct:function(dw,dx){arguments.callee.base.call(this);

if(!dx){this.__my=qx.locale.Manager.getInstance().getLocale();
}else{this.__my=dx;
}
if(dw!=null){this.__mz=dw.toString();
}else{this.__mz=qx.locale.Date.getDateFormat(bj,this.__my)+bO+qx.locale.Date.getDateTimeFormat(bk,bU,this.__my);
}},statics:{getDateTimeInstance:function(){var cO=qx.util.format.DateFormat;
var cN=qx.locale.Date.getDateFormat(bj)+bO+qx.locale.Date.getDateTimeFormat(bk,bU);

if(cO._dateInstance==null||cO.__mz!=cN){cO._dateTimeInstance=new cO();
}return cO._dateTimeInstance;
},getDateInstance:function(){var co=qx.util.format.DateFormat;
var cn=qx.locale.Date.getDateFormat(C)+bL;

if(co._dateInstance==null||co.__mz!=cn){co._dateInstance=new co(cn);
}return co._dateInstance;
},ASSUME_YEAR_2000_THRESHOLD:30,LOGGING_DATE_TIME__format:D,AM_MARKER:"am",PM_MARKER:"pm",MEDIUM_TIMEZONE_NAMES:["GMT"],FULL_TIMEZONE_NAMES:["Greenwich Mean Time"]},members:{__my:null,__mz:null,__mA:null,__mB:null,__mC:null,__mD:function(ci,cj){var ck=bL+ci;

while(ck.length<cj){ck=T+ck;
}return ck;
},__mE:function(cK){var cL=new Date(cK.getTime());
var cM=cL.getDate();

while(cL.getMonth()!=0){cL.setDate(-1);
cM+=cL.getDate()+1;
}return cM;
},__mF:function(dQ){return new Date(dQ.getTime()+(3-((dQ.getDay()+6)%7))*86400000);
},__mG:function(a){var c=this.__mF(a);
var d=c.getFullYear();
var b=this.__mF(new Date(d,0,4));
return Math.floor(1.5+(c.getTime()-b.getTime())/86400000/7);
},format:function(cr){var cu=qx.util.format.DateFormat;
var cv=this.__my;
var cF=cr.getFullYear();
var cy=cr.getMonth();
var cH=cr.getDate();
var cs=cr.getDay();
var cz=cr.getHours();
var cw=cr.getMinutes();
var cA=cr.getSeconds();
var cB=cr.getMilliseconds();
var cD=cr.getTimezoneOffset()/60;
this.__mH();
var cC=bL;

for(var i=0;i<this.__mC.length;i++){var cE=this.__mC[i];

if(cE.type==bD){cC+=cE.text;
}else{var ct=cE.character;
var cx=cE.size;
var cG=N;

switch(ct){case bB:case O:if(cx==2){cG=this.__mD(cF%100,2);
}else if(cx==4){cG=cF;
}break;
case P:cG=this.__mD(this.__mE(cr),cx);
break;
case F:cG=this.__mD(cH,cx);
break;
case bc:cG=this.__mD(this.__mG(cr),cx);
break;
case M:if(cx==2){cG=qx.locale.Date.getDayName(bP,cs,cv);
}else if(cx==3){cG=qx.locale.Date.getDayName(bH,cs,cv);
}else if(cx==4){cG=qx.locale.Date.getDayName(bG,cs,cv);
}break;
case bf:if(cx==1||cx==2){cG=this.__mD(cy+1,cx);
}else if(cx==3){cG=qx.locale.Date.getMonthName(bH,cy,cv);
}else if(cx==4){cG=qx.locale.Date.getMonthName(bG,cy,cv);
}break;
case bm:cG=(cz<12)?qx.locale.Date.getAmMarker(cv):qx.locale.Date.getPmMarker(cv);
break;
case cg:cG=this.__mD(cz,cx);
break;
case U:cG=this.__mD((cz==0)?24:cz,cx);
break;
case bA:cG=this.__mD(cz%12,cx);
break;
case cf:cG=this.__mD(((cz%12)==0)?12:(cz%12),cx);
break;
case B:cG=this.__mD(cw,cx);
break;
case ce:cG=this.__mD(cA,cx);
break;
case S:cG=this.__mD(cB,cx);
break;
case bR:if(cx==1){cG=v+((cD<0)?bo:bl)+this.__mD(cD)+A;
}else if(cx==2){cG=cu.MEDIUM_TIMEZONE_NAMES[cD];
}else if(cx==3){cG=cu.FULL_TIMEZONE_NAMES[cD];
}break;
case bQ:cG=((cD<0)?bo:bl)+this.__mD(cD,2)+bx;
}cC+=cG;
}}return cC;
},parse:function(j){this.__mI();
var p=this.__mA.regex.exec(j);

if(p==null){throw new Error("Date string '"+j+"' does not match the date format: "+this.__mz);
}var k={year:1970,month:0,day:1,hour:0,ispm:false,min:0,sec:0,ms:0};
var l=1;

for(var i=0;i<this.__mA.usedRules.length;i++){var n=this.__mA.usedRules[i];
var m=p[l];

if(n.field!=null){k[n.field]=parseInt(m,10);
}else{n.manipulator(k,m);
}l+=(n.groups==null)?1:n.groups;
}var o=new Date(k.year,k.month,k.day,(k.ispm)?(k.hour+12):k.hour,k.min,k.sec,k.ms);

if(k.month!=o.getMonth()||k.year!=o.getFullYear()){throw new Error("Error parsing date '"+j+"': the value for day or month is too large");
}return o;
...
while(i<dk.length){var dq=dk.charAt(i);

switch(dn){case bn:if(dq==bs){if(i+1>=dk.length){i++;
break;
}var dl=dk.charAt(i+1);
...
case bF:if(dq==dp){dm++;
i++;
}else{this.__mC.push({type:bF,character:dp,size:dm});
dp=null;
dm=0;
dn=bE;
}break;
default:if((dq>=bm&&dq<=bR)||(dq>=cd&&dq<=bQ)){dp=dq;
dn=bF;
}else if(dq==bs){if(i+1>=dk.length){dr+=dq;
i++;
break;
}var dl=dk.charAt(i+1);
...
if(dn!=bE){if(dr.length>0){this.__mC.push({type:bD,text:dr});
dr=bL;
}}else{dr+=dq;
i++;
}break;
}}if(dp!=null){this.__mC.push({type:bF,character:dp,size:dm});
}else if(dr.length>0){this.__mC.push({type:bD,text:dr});
...
for(var cY=0;cY<this.__mC.length;cY++){var di=this.__mC[cY];

if(di.type==bD){dd+=qx.lang.String.escapeRegexpChars(di.text);
}else{var da=di.character;
var de=di.size;
var dc;

for(var dj=0;dj<this.__mB.length;dj++){var df=this.__mB[dj];

if(da==df.pattern.charAt(0)&&de==df.pattern.length){dc=df;
break;
}}if(dc==null){var dg=bL;
...
}catch(dy){throw new Error("Malformed date format: "+db);
}this.__mA={regex:cX,"usedRules":dh,pattern:dd};
},__mJ:function(){var dD=qx.util.format.DateFormat;

if(this.__mB!=null){return ;
}this.__mB=[];
var dP=function(cp,cq){cq=parseInt(cq,10);

if(cq<dD.ASSUME_YEAR_2000_THRESHOLD){cq+=2000;
}else if(cq<100){cq+=1900;
}cp.year=cq;
};
var dF=function(g,h){g.month=parseInt(h,10)-1;
};
var dG=function(cP,cQ){cP.ispm=(cQ==dD.PM_MARKER);
};
var dK=function(e,f){e.hour=parseInt(f,10)%24;
};
var dE=function(ds,dt){ds.hour=parseInt(dt,10)%12;
};
var dN=function(cI,cJ){return;
};
var dL=qx.locale.Date.getMonthNames(bH,this.__my);

for(var i=0;i<dL.length;i++){dL[i]=qx.lang.String.escapeRegexpChars(dL[i].toString());
}var dM=function(cV,cW){cW=qx.lang.String.escapeRegexpChars(cW);
cV.month=dL.indexOf(cW);
};
var dA=qx.locale.Date.getMonthNames(bG,this.__my);

for(var i=0;i<dA.length;i++){dA[i]=qx.lang.String.escapeRegexpChars(dA[i].toString());
}var dz=function(cT,cU){cU=qx.lang.String.escapeRegexpChars(cU);
cT.month=dA.indexOf(cU);
};
var dC=qx.locale.Date.getDayNames(bP,this.__my);

for(var i=0;i<dC.length;i++){dC[i]=qx.lang.String.escapeRegexpChars(dC[i].toString());
}var dI=function(cR,cS){cS=qx.lang.String.escapeRegexpChars(cS);
cR.month=dC.indexOf(cS);
};
var dO=qx.locale.Date.getDayNames(bH,this.__my);

for(var i=0;i<dO.length;i++){dO[i]=qx.lang.String.escapeRegexpChars(dO[i].toString());
}var dH=function(du,dv){dv=qx.lang.String.escapeRegexpChars(dv);
du.month=dO.indexOf(dv);
};
var dJ=qx.locale.Date.getDayNames(bG,this.__my);

for(var i=0;i<dJ.length;i++){dJ[i]=qx.lang.String.escapeRegexpChars(dJ[i].toString());
}var dB=function(cl,cm){cm=qx.lang.String.escapeRegexpChars(cm);
cl.month=dJ.indexOf(cm);
};
this.__mB.push({pattern:ca,regex:bd,manipulator:dP});
this.__mB.push({pattern:K,regex:bu,groups:2,manipulator:dP});
this.__mB.push({pattern:I,regex:r,manipulator:dP});
this.__mB.push({pattern:bb,regex:bM,manipulator:dF});
this.__mB.push({pattern:J,regex:bM,manipulator:dF});
this.__mB.push({pattern:Y,regex:bK+dL.join(bI)+bJ,manipulator:dM});
this.__mB.push({pattern:Q,regex:bK+dA.join(bI)+bJ,manipulator:dz});
this.__mB.push({pattern:x,regex:bM,field:bS});
this.__mB.push({pattern:R,regex:bM,field:bS});
this.__mB.push({pattern:bY,regex:bK+dC.join(bI)+bJ,manipulator:dI});
this.__mB.push({pattern:bh,regex:bK+dO.join(bI)+bJ,manipulator:dH});
this.__mB.push({pattern:bz,regex:bK+dJ.join(bI)+bJ,manipulator:dB});
this.__mB.push({pattern:u,regex:bK+dD.AM_MARKER+bI+dD.PM_MARKER+bJ,manipulator:dG});
this.__mB.push({pattern:X,regex:bM,field:br});
this.__mB.push({pattern:cb,regex:bM,field:br});
this.__mB.push({pattern:H,regex:bM,manipulator:dK});
this.__mB.push({pattern:be,regex:bM,manipulator:dK});
this.__mB.push({pattern:cc,regex:bM,field:br});
this.__mB.push({pattern:s,regex:bM,field:br});
this.__mB.push({pattern:G,regex:bM,manipulator:dE});
this.__mB.push({pattern:bW,regex:bM,manipulator:dE});
this.__mB.push({pattern:bX,regex:bM,field:bN});
this.__mB.push({pattern:V,regex:bM,field:bN});
this.__mB.push({pattern:ch,regex:bM,field:bT});
this.__mB.push({pattern:ba,regex:bM,field:bT});
this.__mB.push({pattern:bV,regex:bq,field:bp});
this.__mB.push({pattern:bw,regex:bq,field:bp});
this.__mB.push({pattern:w,regex:bq,field:bp});
this.__mB.push({pattern:bv,regex:t,manipulator:dN});
this.__mB.push({pattern:L,regex:W,manipulator:dN});
}},destruct:function(){this._disposeFields(q,z,bg,bt,by);
}});
})();
(function(){var A="_",z="thu",y="sat",x="cldr_day_",w="cldr_month_",v="wed",u="fri",t="tue",s="mon",r="sun",Q="short",P="HH:mm",O="HHmmsszz",N="HHmm",M="HHmmss",L="cldr_date_format_",K="HH:mm:ss zz",J="full",I="cldr_pm",H="long",F="medium",G="cldr_am",D="qx.locale.Date",E="cldr_date_time_format_",B="cldr_time_format_",C="HH:mm:ss";
qx.Class.define(D,{statics:{__mx:qx.locale.Manager.getInstance(),getAmMarker:function(U){return this.__mx.localize(G,[],U);
},getPmMarker:function(bo){return this.__mx.localize(I,[],bo);
},getDayNames:function(length,d){{};
var e=[r,s,t,v,z,u,y];
var g=[];

for(var i=0;i<e.length;i++){var f=x+length+A+e[i];
g.push(this.__mx.localize(f,[],d));
}return g;
},getDayName:function(length,bp,bq){{};
var br=[r,s,t,v,z,u,y];
var bs=x+length+A+br[bp];
return this.__mx.localize(bs,[],bq);
},getMonthNames:function(length,Y){{};
var ba=[];

for(var i=0;i<12;i++){var bb=w+length+A+(i+1);
ba.push(this.__mx.localize(bb,[],Y));
}return ba;
},getMonthName:function(length,a,b){{};
var c=w+length+A+(a+1);
return this.__mx.localize(c,[],b);
},getDateFormat:function(V,W){{};
var X=L+V;
return this.__mx.localize(X,[],W);
},getDateTimeFormat:function(bc,bd,be){var bg=E+bc;
var bf=this.__mx.localize(bg,[],be);

if(bf==bg){bf=bd;
}return bf;
},getTimeFormat:function(n,o){{};
var q=B+n;
var p=this.__mx.localize(q,[],o);

if(p!=q){return p;
}
switch(n){case Q:case F:return qx.locale.Date.getDateTimeFormat(N,P);
case H:return qx.locale.Date.getDateTimeFormat(M,C);
...
},getWeekendStart:function(h){var k={"EG":5,"IL":5,"SY":5,"IN":0,"AE":4,"BH":4,"DZ":4,"IQ":4,"JO":4,"KW":4,"LB":4,"LY":4,"MA":4,"OM":4,"QA":4,"SA":4,"SD":4,"TN":4,"YE":4};
var j=qx.locale.Date._getTerritory(h);
return k[j]!=null?k[j]:6;
...
}},_getTerritory:function(l){if(l){var m=l.split(A)[1]||l;
}else{m=this.__mx.getTerritory()||this.__mx.getLanguage();
...
(function(){var i="qx.event.type.Data",h="qx.ui.table.ITableModel";
qx.Interface.define(h,{events:{"dataChanged":i,"metaDataChanged":i},statics:{EVENT_TYPE_DATA_CHANGED:"dataChanged",EVENT_TYPE_META_DATA_CHANGED:"metaDataChanged"},members:{getRowCount:function(){},getRowData:function(s){},getColumnCount:function(){},getColumnId:function(u){},getColumnIndexById:function(r){},getColumnName:function(v){},isColumnEditable:function(t){},isColumnSortable:function(n){},sortByColumn:function(j,k){},getSortColumnIndex:function(){},isSortAscending:function(){},prefetchRows:function(f,g){},getValue:function(a,b){},getValueById:function(l,m){},setValue:function(o,p,q){},setValueById:function(c,d,e){}}});
})();
(function(){var g="qx.event.type.Data",f="abstract",e="qx.ui.table.model.Abstract",d="__rV",c="__rX",b="__rW";
qx.Class.define(e,{type:f,extend:qx.core.Object,implement:qx.ui.table.ITableModel,events:{"dataChanged":g,"metaDataChanged":g},construct:function(){arguments.callee.base.call(this);
this.__rV=[];
this.__rW=[];
this.__rX={};
...
},isColumnEditable:function(F){return false;
},isColumnSortable:function(o){return false;
},sortByColumn:function(t,u){},getSortColumnIndex:function(){return -1;
},isSortAscending:function(){return true;
},prefetchRows:function(l,m){},getValue:function(h,j){throw new Error("getValue is abstract");
},getValueById:function(p,q){return this.getValue(this.getColumnIndexById(p),q);
},setValue:function(y,z,A){throw new Error("setValue is abstract");
},setValueById:function(C,D,E){return this.setValue(this.getColumnIndexById(C),D,E);
},getColumnCount:function(){return this.__rV.length;
},getColumnIndexById:function(k){return this.__rX[k];
},getColumnId:function(n){return this.__rV[n];
},getColumnName:function(s){return this.__rW[s];
},setColumnIds:function(B){this.__rV=B;
this.__rX={};

for(var i=0;i<B.length;i++){this.__rX[B[i]]=i;
}this.__rW=new Array(B.length);
if(!this.__rY){this.fireEvent(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED);
}},setColumnNamesByIndex:function(G){if(this.__rV.length!=G.length){throw new Error("this.__columnIdArr and columnNameArr have different length: "+this.__rV.length+" != "+G.length);
}this.__rW=G;
this.fireEvent(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED);
},setColumnNamesById:function(a){this.__rW=new Array(this.__rV.length);

for(var i=0;i<this.__rV.length;++i){this.__rW[i]=a[this.__rV[i]];
}},setColumns:function(v,w){var x=this.__rV.length==0||w;

if(w==null){if(this.__rV.length==0){w=v;
}else{w=this.__rV;
}}
...
}},destruct:function(){this._disposeFields(d,b,c);
}});
})();
(function(){var bt="qx.ui.table.model.Simple",bs="Boolean",br="__vz",bq="__vy",bp="__vA",bo="__vw";
qx.Class.define(bt,{extend:qx.ui.table.model.Abstract,construct:function(){arguments.callee.base.call(this);
this.__vw=[];
this.__vx=-1;
this.__vB;
this.__vy=[];
this.__vz=null;
},properties:{caseSensitiveSorting:{check:bs,init:true}},statics:{_defaultSortComparatorAscending:function(by,bz){var bA=by[arguments.callee.columnIndex];
var bB=bz[arguments.callee.columnIndex];
return (bA>bB)?1:((bA==bB)?0:-1);
},_defaultSortComparatorInsensitiveAscending:function(bk,bl){var bm=(isNaN(bk[arguments.callee.columnIndex])?bk[arguments.callee.columnIndex].toLowerCase():bk[arguments.callee.columnIndex]);
...
}},members:{__vw:null,__vz:null,__vA:null,__vy:null,__vx:null,__vB:null,getRowData:function(g){var h=this.__vw[g];

if(h==null||h.originalData==null){return h;
}else{return h.originalData;
}},getRowDataAsMap:function(X){var ba=this.__vw[X];
var Y={};
...
},setEditable:function(L){this.__vz=[];

for(var M=0;M<this.getColumnCount();M++){this.__vz[M]=L;
}this.fireEvent(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED);
},setColumnEditable:function(v,w){if(w!=this.isColumnEditable(v)){if(this.__vz==null){this.__vz=[];
}this.__vz[v]=w;
this.fireEvent(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED);
}},isColumnEditable:function(bG){return this.__vz?(this.__vz[bG]==true):false;
},setColumnSortable:function(z,A){if(A!=this.isColumnSortable(z)){if(this.__vA==null){this.__vA=[];
}this.__vA[z]=A;
this.fireEvent(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED);
}},isColumnSortable:function(u){return (this.__vA?(this.__vA[u]!==false):true);
},sortByColumn:function(bc,bd){var bf;
var be=this.__vy[bc];

if(be){bf=(bd?be.ascending:be.descending);
}else{if(this.getCaseSensitiveSorting()){bf=(bd?qx.ui.table.model.Simple._defaultSortComparatorAscending:qx.ui.table.model.Simple._defaultSortComparatorDescending);
}else{bf=(bd?qx.ui.table.model.Simple._defaultSortComparatorInsensitiveAscending:qx.ui.table.model.Simple._defaultSortComparatorInsensitiveDescending);
}}bf.columnIndex=bc;
this.__vw.sort(bf);
this.__vx=bc;
this.__vB=bd;
...
},getValue:function(F,G){if(G<0||G>=this.__vw.length){throw new Error("this.__rowArr out of bounds: "+G+" (0.."+this.__vw.length+")");
}return this.__vw[G][F];
},setValue:function(bg,bh,bi){if(this.__vw[bh][bg]!=bi){this.__vw[bh][bg]=bi;
if(this.hasListener(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED)){var bj={firstRow:bh,lastRow:bh,firstColumn:bg,lastColumn:bg};
this.fireDataEvent(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED,bj);
}
if(bg==this.__vx){this.clearSorting();
}}},setData:function(r,s){this.__vw=r;
if(this.hasListener(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED)){var t={firstRow:0,lastRow:r.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
this.fireDataEvent(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED,t);
}
...
},addRows:function(k,l,m){if(l==null){l=this.__vw.length;
}k.splice(0,0,l,0);
Array.prototype.splice.apply(this.__vw,k);
var n={firstRow:l,lastRow:this.__vw.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
...
Array.prototype.splice.apply(this.__vw,c);
var f={firstRow:d,lastRow:this.__vw.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1};
this.fireDataEvent(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED,f);

if(e!==false){this.clearSorting();
}},setRowsAsMapArray:function(B,C,D,E){this.setRows(this._mapArray2RowArr(B,D),C,E);
},removeRows:function(T,U,V){this.__vw.splice(T,U);
var W={firstRow:T,lastRow:this.__vw.length-1,firstColumn:0,lastColumn:this.getColumnCount()-1,removeStart:T,removeCount:U};
this.fireDataEvent(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED,W);
...
}},destruct:function(){this._disposeFields(bo,br,bq,bp);
}});
})();
...
},properties:{validationFunction:{check:e,nullable:true,init:null}},members:{__qN:null,createCellEditor:function(j){var k=new qx.ui.form.TextField;
k.setAppearance(b);
k.originalValue=j.value;

if(j.value===null){j.value=f;
}k.setValue(f+j.value);
k.addListener(a,function(){k.selectAll();
});
return k;
},getCellEditorValue:function(g){var i=g.getValue();
var h=this.getValidationFunction();

if(!this.__qN&&h){i=h(i,g.originalValue);
this.__qN=true;
}
...
(function(){var n="qx.event.type.Data",m="visibilityChanged",l="visibilityChangedPre",k="__qP",j="__qQ",h="orderChanged",g="widthChanged",f="qx.ui.table.columnmodel.Basic",e="__qR",d="__qU",a="__qV",c="__qS",b="__qT";
qx.Class.define(f,{extend:qx.core.Object,events:{"widthChanged":n,"visibilityChangedPre":n,"visibilityChanged":n,"orderChanged":n},statics:{DEFAULT_WIDTH:100,DEFAULT_HEADER_RENDERER:qx.ui.table.headerrenderer.Default,DEFAULT_DATA_RENDERER:qx.ui.table.cellrenderer.Default,DEFAULT_EDITOR_FACTORY:qx.ui.table.celleditor.TextField},members:{__qO:null,__qP:null,__qQ:null,__qR:null,__qS:null,__qT:null,__qU:null,__qV:null,init:function(D){this.__qS=[];
var G=qx.ui.table.columnmodel.Basic.DEFAULT_WIDTH;
var H=this.__qT=new qx.ui.table.columnmodel.Basic.DEFAULT_HEADER_RENDERER();
var F=this.__qU=new qx.ui.table.columnmodel.Basic.DEFAULT_DATA_RENDERER();
var E=this.__qV=new qx.ui.table.columnmodel.Basic.DEFAULT_EDITOR_FACTORY();
this.__qR=[];
this.__qQ=[];

for(var J=0;J<D;J++){this.__qS[J]={width:G,headerRenderer:H,dataRenderer:F,editorFactory:E};
this.__qR[J]=J;
this.__qQ[J]=J;
}this.__qP=null;
...
this.fireDataEvent(m,I);
}},getVisibleColumns:function(){return this.__qQ!=null?this.__qQ:[];
},setColumnWidth:function(bg,bh){var bj=this.__qS[bg].width;

if(bj!=bh){this.__qS[bg].width=bh;
var bi={col:bg,newWidth:bh,oldWidth:bj};
this.fireDataEvent(g,bi);
}},getColumnWidth:function(R){return this.__qS[R].width;
},setHeaderCellRenderer:function(u,v){var w=this.__qS[u].headerRenderer;

if(w!==this.__qT){w.dispose();
}this.__qS[u].headerRenderer=v;
},getHeaderCellRenderer:function(N){return this.__qS[N].headerRenderer;
},setDataCellRenderer:function(K,L){var M=this.__qS[K].headerRenderer;

if(M!==this.__qU){M.dispose();
}this.__qS[K].dataRenderer=L;
},getDataCellRenderer:function(o){return this.__qS[o].dataRenderer;
},setCellEditorFactory:function(A,B){var C=this.__qS[A].headerRenderer;

if(C!==this.__qV){C.dispose();
}this.__qS[A].editorFactory=B;
},getCellEditorFactory:function(S){return this.__qS[S].editorFactory;
},_getColToXPosMap:function(){if(this.__qP==null){this.__qP={};

for(var Q=0;Q<this.__qR.length;Q++){var P=this.__qR[Q];
this.__qP[P]={overX:Q};
}
for(var O=0;O<this.__qQ.length;O++){var P=this.__qQ[O];
this.__qP[P].visX=O;
}}return this.__qP;
},getVisibleColumnCount:function(){return this.__qQ!=null?this.__qQ.length:0;
},getVisibleColumnAtX:function(z){return this.__qQ[z];
},getVisibleX:function(U){return this._getColToXPosMap()[U].visX;
},getOverallColumnCount:function(){return this.__qR.length;
},getOverallColumnAtX:function(V){return this.__qR[V];
...
if(Y!=null){bc=Y;
break;
}}if(bc==null){bc=this.__qQ.length;
}this.__qQ.splice(bc,0,W);
}else{var ba=this.getVisibleX(W);
this.__qQ.splice(ba,1);
}this.__qP=null;
if(!this.__qO){var bf={col:W,visible:X};
this.fireDataEvent(l,bf);
this.fireDataEvent(m,bf);
}}},moveColumn:function(p,q){this.__qO=true;
var t=this.__qR[p];
var r=this.isColumnVisible(t);

if(r){this.setColumnVisible(t,false);
}this.__qR.splice(p,1);
this.__qR.splice(q,0,t);
this.__qP=null;

if(r){this.setColumnVisible(t,true);
}this.__qO=false;
var s={col:t,fromOverXPos:p,toOverXPos:q};
this.fireDataEvent(h,s);
...
}this._disposeFields(e,j,c,k);
this._disposeObjects(b,d,a);
}});
})();
(function(){var p="appear",n="columnVisibilityMenuCreateEnd",m="tableWidthChanged",l="__sk",k="verticalScrollBarChanged",j="qx.ui.table.columnmodel.resizebehavior.Abstract",i="qx.ui.table.columnmodel.Resize",h="_applyBehavior",g="separator",f="visibilityChanged",c="Reset column widths",e="changeBehavior",d="user-button",b="widthChanged",a="execute";
...
this.__si=false;
this.__sj=false;
},properties:{behavior:{check:j,init:null,nullable:true,apply:h,event:e}},members:{__sj:null,__si:null,__sk:null,_applyBehavior:function(v,w){if(w!=null){w.dispose();
w=null;
...
u.addListener(m,this._onTableWidthChanged,this);
...
this.__sk.addListener(n,this._addResetColumnWidthButton,this);
this.getBehavior()._setNumColumns(t);
},getTable:function(){return this.__sk;
...
},_onappear:function(event){if(this.__si){return ;
}this.__si=true;
{};
this.getBehavior().onAppear(this,event,event.getType()!==p);
this.__sk._updateScrollerWidths();
this.__sk._updateScrollBarVisibility();
this.__si=false;
this.__sj=true;
},_onTableWidthChanged:function(event){if(this.__si||!this.__sj){return ;
}this.__si=true;
{};
this.getBehavior().onTableWidthChanged(this,event);
this.__si=false;
},_onverticalscrollbarchanged:function(event){if(this.__si||!this.__sj){return ;
}this.__si=true;
{};
this.getBehavior().onVerticalScrollBarChanged(this,event);
qx.event.Timer.once(function(){if(this.__sk&&!this.__sk.isDisposed()){this.__sk._updateScrollerWidths();
this.__sk._updateScrollBarVisibility();
}},this,0);
this.__si=false;
},_oncolumnwidthchanged:function(event){if(this.__si||!this.__sj){return ;
}this.__si=true;
{};
this.getBehavior().onColumnWidthChanged(this,event);
this.__si=false;
},_onvisibilitychanged:function(event){if(this.__si||!this.__sj){return ;
}this.__si=true;
{};
...
qx.Class.define(c,{type:b,extend:qx.core.Object,members:{_setNumColumns:function(o){throw new Error("_setNumColumns is abstract");
},onAppear:function(p,event,q){throw new Error("onAppear is abstract");
},onTableWidthChanged:function(d,event){throw new Error("onTableWidthChanged is abstract");
},onVerticalScrollBarChanged:function(a,event){throw new Error("onVerticalScrollBarChanged is abstract");
},onColumnWidthChanged:function(f,event){throw new Error("onColumnWidthChanged is abstract");
},onVisibilityChanged:function(e,event){throw new Error("onVisibilityChanged is abstract");
},_getAvailableWidth:function(g){var n=g.getTable();
var h=n._getPaneScrollerArr();
var m=h[0].getLayoutParent().getBounds().width;
var i=h[h.length-1];

if(i.getVerticalScrollBarVisible()){var k=i.getTopRightWidget();
var j=k&&k.getBounds()?k.getBounds().width:0;
var l=i.getVerticalScrollBarWidth();
m-=Math.max(j,l);
}return m;
}}});
})();
(function(){var p="Function",o="__sm",n="Boolean",m="minWidth",k="width",j="qx.ui.table.columnmodel.resizebehavior.Default",h="__sn",g="maxWidth";
qx.Class.define(j,{extend:qx.ui.table.columnmodel.resizebehavior.Abstract,construct:function(){arguments.callee.base.call(this);
this.__sm=[];
this.__sn=new qx.ui.layout.HBox();
this.__sn.connectToWidget(this);
},properties:{newResizeBehaviorColumnData:{check:p,init:function(b){return new qx.ui.core.ColumnData();
}},initializeWidthsOnEveryAppear:{check:n,init:false}},members:{__sn:null,__so:null,__sm:null,__sp:false,setWidth:function(c,d){if(c>=this.__sm.length){throw new Error("Column number out of range");
}this.__sm[c].setColumnWidth(d);
},setMinWidth:function(v,w){if(v>=this.__sm.length){throw new Error("Column number out of range");
}this.__sm[v].setMinWidth(w);
},setMaxWidth:function(E,F){if(E>=this.__sm.length){throw new Error("Column number out of range");
}this.__sm[E].setMaxWidth(F);
},set:function(s,t){for(var u in t){switch(u){case k:this.setWidth(s,t[u]);
break;
case m:this.setMinWidth(s,t[u]);
break;
case g:this.setMaxWidth(s,t[u]);
break;
default:throw new Error("Unknown property: "+u);
}}},onAppear:function(X,event,Y){if(Y===true||!this.__sp||this.getInitializeWidthsOnEveryAppear()){this._computeColumnsFlexWidth(X,event);
this.__sp=true;
}},onTableWidthChanged:function(a,event){this._computeColumnsFlexWidth(a,event);
},onVerticalScrollBarChanged:function(W,event){this._computeColumnsFlexWidth(W,event);
},onColumnWidthChanged:function(ba,event){this._extendNextColumn(ba,event);
},onVisibilityChanged:function(q,event){var r=event.getData();
if(r.visible){this._computeColumnsFlexWidth(q,event);
return;
}this._extendLastColumn(q,event);
},_setNumColumns:function(e){var f=this.__sm;
if(e<=f.length){f.splice(e,f.length);
return;
}for(var i=f.length;i<e;i++){f[i]=this.getNewResizeBehaviorColumnData()();
f[i].columnNumber=i;
}},getLayoutChildren:function(){return this.__so;
},_computeColumnsFlexWidth:function(x,event){{};
...
for(i=0;i<C;i++){D.push(y[z[i]]);
}this.__so=D;
this.__sn.invalidateChildrenCache();
var A=this._getAvailableWidth(x);
this.__sn.renderLayout(A,100);
for(i=0,l=D.length;i<l;i++){var B=D[i].getComputedWidth();
x.setColumnWidth(z[i],B);
{};
}},_extendNextColumn:function(G,event){var N=event.getData();
var I=G.getVisibleColumns();
var K=this._getAvailableWidth(G);
var H=I.length;
...
for(i=0;i<H;i++){M+=G.getColumnWidth(I[i]);
}if(M<K){for(i=0;i<I.length;i++){if(I[i]==N.col){J=I[i+1];
break;
}}
if(J){var L=(K-(M-G.getColumnWidth(J)));
G.setColumnWidth(J,L);
}}},_extendLastColumn:function(O,event){var V=event.getData();
if(V.visible){return;
}var Q=O.getVisibleColumns();
if(Q.length==0){return;
}var R=this._getAvailableWidth(O);
var P=Q.length;
var i;
var T;
var U=0;

for(i=0;i<P;i++){U+=O.getColumnWidth(Q[i]);
}if(U<R){T=Q[Q.length-1];
var S=(R-(U-O.getColumnWidth(T)));
O.setColumnWidth(T,S);
}}},destruct:function(){this._disposeFields(o);
this._disposeObjects(h);
}});
})();
(function(){var bq="Function",bp="Boolean",bo="column-button",bn="qx.event.type.Data",bm="statusbar",bl="qx.ui.table.pane.CellEvent",bk="PageUp",bj="changeLocale",bi="changeSelection",bh="qx.dynlocale",cA="Enter",cz="on",cy="_applyTableColumnModel",cx="_applyStatusBarVisible",cw="blur",cv="qx.ui.table.Table",cu="columnVisibilityMenuCreateEnd",ct="changeVisible",cs="verticalScrollBarChanged",cr="_applyMetaColumnCounts",bx="one of one row",by="focus",bv="changeDataRowRenderer",bw="changeHeaderCellHeight",bt="Escape",bu="A",br="changeSelectionModel",bs="Left",bF="_tableModel",bG="Down",bT="Integer",bP="_applyHeaderCellHeight",cc="visibilityChanged",bW="qx.ui.table.ITableModel",cn="orderChanged",ch="_applySelectionModel",bK="_columnVisibilityMenu",cq="menu",cp="_applyAdditionalStatusBarText",co="_applyFocusCellOnMouseMove",bJ="table",bM="_applyColumnVisibilityButtonVisible",bO="changeTableModel",bR="qx.event.type.Event",bU="End",bX="Object",ce="_applyShowCellFocusIndicator",cj="resize",bz="changeScrollY",bA="_applyTableModel",bL="menu-button",cb="_applyKeepFirstVisibleRowComplete",ca="qx.ui.table.columnmodel.Basic",bY="Home",cg="_applyRowHeight",cf="F2",bV="Up",cd="tableWidthChanged",be="columnVisibilityMenuCreateStart",ci="%1 rows",bB="qx.ui.table.selection.Model",bC="one row",bQ="PageDown",bf="%1 of %2 rows",bg="changeTableColumnModel",bI="keypress",bD="changeRowHeight",bE="Number",bH="widthChanged",bS="__qt",cl="__qu",ck="qx.ui.table.IRowRenderer",bN="Right",cm="Space";
qx.Class.define(cv,{extend:qx.ui.core.Widget,construct:function(dI,dJ){arguments.callee.base.call(this);
if(!dJ){dJ={};
}
if(dJ.selectionManager){this.setNewSelectionManager(dJ.selectionManager);
}
if(dJ.selectionModel){this.setNewSelectionModel(dJ.selectionModel);
}
if(dJ.tableColumnModel){this.setNewTableColumnModel(dJ.tableColumnModel);
}
if(dJ.tablePane){this.setNewTablePane(dJ.tablePane);
}
if(dJ.tablePaneHeader){this.setNewTablePaneHeader(dJ.tablePaneHeader);
}
if(dJ.tablePaneScroller){this.setNewTablePaneScroller(dJ.tablePaneScroller);
}
if(dJ.tablePaneModel){this.setNewTablePaneModel(dJ.tablePaneModel);
}
if(dJ.columnMenu){this.setNewColumnMenu(dJ.columnMenu);
}this._setLayout(new qx.ui.layout.VBox());
...
if(dI!=null){this.setTableModel(dI);
}this.setMetaColumnCounts([-1]);
this.setTabIndex(1);
this.addListener(bI,this._onKeyPress);
this.addListener(by,this._onFocusChanged);
this.addListener(cw,this._onFocusChanged);
var dK=new qx.ui.core.Widget().set({height:0});
this._add(dK);
dK.addListener(cj,this._onResize,this);
this.__qv=null;
this.__qw=null;
if(qx.core.Variant.isSet(bh,cz)){qx.locale.Manager.getInstance().addListener(bj,this._onChangeLocale,this);
}this.initStatusBarVisible();
},events:{"columnVisibilityMenuCreateStart":bn,"columnVisibilityMenuCreateEnd":bn,"tableWidthChanged":bR,"verticalScrollBarChanged":bn,"cellClick":bl,"cellDblclick":bl,"cellContextmenu":bl,"dataEdited":bn},statics:{__qx:{cellClick:1,cellDblclick:1,cellContextmenu:1}},properties:{appearance:{refine:true,init:bJ},focusable:{refine:true,init:true},selectionModel:{check:bB,apply:ch,event:br},tableModel:{check:bW,apply:bA,event:bO,nullable:true},tableColumnModel:{check:ca,apply:cy,event:bg},rowHeight:{check:bE,init:20,apply:cg,event:bD},forceLineHeight:{check:bp,init:true},headerCellHeight:{check:bT,init:16,apply:bP,event:bw},statusBarVisible:{check:bp,init:true,apply:cx},additionalStatusBarText:{nullable:true,init:null,apply:cp},columnVisibilityButtonVisible:{check:bp,init:true,apply:bM},metaColumnCounts:{check:bX,apply:cr},focusCellOnMouseMove:{check:bp,init:false,apply:co},showCellFocusIndicator:{check:bp,init:true,apply:ce},keepFirstVisibleRowComplete:{check:bp,init:true,apply:cb},alwaysUpdateCells:{check:bp,init:false},dataRowRenderer:{check:ck,init:null,nullable:true,event:bv},modalCellEditorPreOpenFunction:{check:bq,init:null,nullable:true},newColumnMenu:{check:bq,init:function(){return new qx.ui.table.columnmenu.Button();
}},newSelectionManager:{check:bq,init:function(q){return new qx.ui.table.selection.Manager(q);
}},newSelectionModel:{check:bq,init:function(em){return new qx.ui.table.selection.Model(em);
}},newTableColumnModel:{check:bq,init:function(dS){return new qx.ui.table.columnmodel.Basic(dS);
}},newTablePane:{check:bq,init:function(dX){return new qx.ui.table.pane.Pane(dX);
}},newTablePaneHeader:{check:bq,init:function(r){return new qx.ui.table.pane.Header(r);
}},newTablePaneScroller:{check:bq,init:function(bd){return new qx.ui.table.pane.Scroller(bd);
}},newTablePaneModel:{check:bq,init:function(cG){return new qx.ui.table.pane.Model(cG);
}}},members:{__qv:null,__qw:null,__qt:null,__qu:null,__qy:null,__qz:null,__qA:null,__qB:null,_createChildControlImpl:function(dp){var dq;

switch(dp){case bm:dq=new qx.ui.basic.Label();
dq.set({allowGrowX:true});
this._add(dq);
break;
case bo:dq=this.getNewColumnMenu()();
dq.set({focusable:false});
dq.setMenu(dq.factory(cq,{table:this}));
break;
}return dq||arguments.callee.base.call(this,dp);
},_applySelectionModel:function(eK,eL){this.__qu.setSelectionModel(eK);

if(eL!=null){eL.removeListener(bi,this._onSelectionChanged,this);
}eK.addListener(bi,this._onSelectionChanged,this);
},_applyRowHeight:function(ep,eq){if(!this.getTableModel()){return;
}var er=this._getPaneScrollerArr();

for(var i=0;i<er.length;i++){er[i].updateVerScrollBarMaximum();
...
}},_applyTableModel:function(ei,ej){this.getTableColumnModel().init(ei.getColumnCount(),this);

if(ej!=null){ej.removeListener(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED,this._onTableModelMetaDataChanged,this);
ej.removeListener(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED,this._onTableModelDataChanged,this);
}ei.addListener(qx.ui.table.ITableModel.EVENT_TYPE_META_DATA_CHANGED,this._onTableModelMetaDataChanged,this);
ei.addListener(qx.ui.table.ITableModel.EVENT_TYPE_DATA_CHANGED,this._onTableModelDataChanged,this);
this._updateStatusBar();
this._initColumnMenu();
this._updateTableData(0,ei.getRowCount(),0,ei.getColumnCount());
this._onTableModelMetaDataChanged();
},_applyTableColumnModel:function(eu,ev){if(ev!=null){throw new Error("The table column model can only be set once per table.");
}eu.addListener(cc,this._onColVisibilityChanged,this);
eu.addListener(bH,this._onColWidthChanged,this);
eu.addListener(cn,this._onColOrderChanged,this);
var ex=this.getTableModel();
if(ex){eu.init(ex.getColumnCount(),this);
}var ew=this._getPaneScrollerArr();

for(var i=0;i<ew.length;i++){var ey=ew[i];
var ez=ey.getTablePaneModel();
ez.setTableColumnModel(eu);
}},_applyStatusBarVisible:function(s,t){if(s){this._showChildControl(bm);
}else{this._excludeChildControl(bm);
}
if(s){this._updateStatusBar();
}},_applyAdditionalStatusBarText:function(dg,dh){this.__qy=dg;
this._updateStatusBar();
},_applyColumnVisibilityButtonVisible:function(dL,dM){if(dL){this._showChildControl(bo);
...
for(var cS in qx.ui.table.Table.__qx){cN[cS]={};
...
cT.addListener(bz,this._onScrollY,this);
for(cS in qx.ui.table.Table.__qx){if(!cN[cS]){break;
}
...
this.__qt.add(cT,{flex:cU});
cJ=this._getPaneScrollerArr();
}}for(var i=0;i<cJ.length;i++){var cT=cJ[i];
var cW=(i==(cJ.length-1));
cT.getHeader().setHeight(this.getHeaderCellHeight());
cT.setTopRightWidget(cW?this.getChildControl(bo):null);
}
if(!this.isColumnVisibilityButtonVisible()){this._excludeChildControl(bo);
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
},_applyFocusCellOnMouseMove:function(dl,dm){var dn=this._getPaneScrollerArr();

for(var i=0;i<dn.length;i++){dn[i].setFocusCellOnMouseMove(dl);
}},_applyShowCellFocusIndicator:function(n,o){var p=this._getPaneScrollerArr();

for(var i=0;i<p.length;i++){p[i].setShowCellFocusIndicator(n);
}},_applyKeepFirstVisibleRowComplete:function(cB,cC){var cD=this._getPaneScrollerArr();

for(var i=0;i<cD.length;i++){cD[i].onKeepFirstVisibleRowCompleteChanged();
}},getSelectionManager:function(){return this.__qu;
},_getPaneScrollerArr:function(){return this.__qt.getChildren();
},getPaneScroller:function(eh){return this._getPaneScrollerArr()[eh];
},_cleanUpMetaColumns:function(dQ){var dR=this._getPaneScrollerArr();

if(dR!=null){for(var i=dR.length-1;i>=dQ;i--){dR[i].destroy();
}}},_onChangeLocale:function(eo){this.updateContent();
this._updateStatusBar();
},_onSelectionChanged:function(ek){var el=this._getPaneScrollerArr();

for(var i=0;i<el.length;i++){el[i].onSelectionChanged();
}this._updateStatusBar();
},_onTableModelMetaDataChanged:function(V){var W=this._getPaneScrollerArr();

for(var i=0;i<W.length;i++){W[i].onTableModelMetaDataChanged();
}this._updateStatusBar();
...
},_updateTableData:function(cX,cY,da,db,dc,dd){var de=this._getPaneScrollerArr();
if(dd){this.getSelectionModel().removeSelectionInterval(dc,dc+dd);
}
for(var i=0;i<de.length;i++){de[i].onTableModelDataChanged(cX,cY,da,db);
}var df=this.getTableModel().getRowCount();

if(df!=this.__qz){this.__qz=df;
this._updateScrollBarVisibility();
this._updateStatusBar();
}},_onScrollY:function(eO){if(!this.__qA){this.__qA=true;
var eP=this._getPaneScrollerArr();

for(var i=0;i<eP.length;i++){eP[i].setScrollY(eO.getData());
}this.__qA=false;
...
if(this.isEditing()){if(dx.getModifiers()==0){switch(dF){case cA:this.stopEditing();
var dE=this.__qw;
this.moveFocusedCell(0,1);

if(this.__qw!=dE){dB=this.startEditing();
}break;
...
switch(dF){case bu:var dC=this.getTableModel().getRowCount();

if(dC>0){this.getSelectionModel().setSelectionInterval(0,dC-1);
}break;
default:dB=false;
break;
}}else{switch(dF){case cm:this.__qu.handleSelectKeyDown(this.__qw,dx);
break;
case cf:case cA:dB=this.startEditing();
break;
case bY:this.setFocusedCell(this.__qv,0,true);
break;
case bU:var dC=this.getTableModel().getRowCount();
this.setFocusedCell(this.__qv,dC-1,true);
break;
case bs:this.moveFocusedCell(-1,0);
break;
case bN:this.moveFocusedCell(1,0);
break;
case bV:this.moveFocusedCell(0,-1);
break;
case bG:this.moveFocusedCell(0,1);
break;
case bk:case bQ:var dA=this.getPaneScroller(0);
...
if(dE!=this.__qw){this.__qu.handleMoveKeyDown(this.__qw,dx);
}
if(dB){dx.preventDefault();
dx.stopPropagation();
}},_onFocusChanged:function(dv){var dw=this._getPaneScrollerArr();

for(var i=0;i<dw.length;i++){dw[i].onFocusChanged();
}},_onColVisibilityChanged:function(dN){var dO=this._getPaneScrollerArr();

for(var i=0;i<dO.length;i++){dO[i].onColVisibilityChanged();
}var dP=dN.getData();

if(this.__qB!=null&&dP.col!=null&&dP.visible!=null){this.__qB[dP.col].setVisible(dP.visible);
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
},_onColWidthChanged:function(eA){var eB=this._getPaneScrollerArr();

for(var i=0;i<eB.length;i++){var eC=eA.getData();
eB[i].setColumnWidth(eC.col,eC.newWidth);
}this._updateScrollerWidths();
this._updateScrollBarVisibility();
...
this._updateScrollBarVisibility();
},getTablePaneScrollerAtPageX:function(eH){var eI=this._getMetaColumnAtPageX(eH);
return (eI!=-1)?this.getPaneScroller(eI):null;
},setFocusedCell:function(dr,ds,dt){if(!this.isEditing()&&(dr!=this.__qv||ds!=this.__qw)){this.__qv=dr;
this.__qw=ds;
...
},highlightFocusedRow:function(eJ){this.getDataRowRenderer().setHighlightFocusRow(eJ);
},clearFocusedRowHighlight:function(){this.resetCellFocus();
var et=this._getPaneScrollerArr();

for(var i=0;i<et.length;i++){et[i].onFocusChanged();
}},moveFocusedCell:function(e,f){var k=this.__qv;
var m=this.__qw;

if(k===null||m===null){return;
}
if(e!=0){var j=this.getTableColumnModel();
var x=j.getVisibleX(k);
var h=j.getVisibleColumnCount();
x=qx.lang.Number.limit(x+e,0,h-1);
k=j.getVisibleColumnAtX(x);
}
if(f!=0){var g=this.getTableModel();
m=qx.lang.Number.limit(m+f,0,g.getRowCount()-1);
}this.setFocusedCell(k,m,true);
},scrollCellVisible:function(dT,dU){var dV=this.getTableColumnModel();
var x=dV.getVisibleX(dT);
var dW=this._getMetaColumnAtColumnX(x);

if(dW!=-1){this.getPaneScroller(dW).scrollCellVisible(dT,dU);
...
var E=this.getPaneScroller(F).startEditing();
return E;
}return false;
...
this.getPaneScroller(en).stopEditing();
}},cancelEditing:function(){if(this.__qv!=null){var x=this.getTableColumnModel().getVisibleX(this.__qv);
var dk=this._getMetaColumnAtColumnX(x);
this.getPaneScroller(dk).cancelEditing();
}},updateContent:function(){var es=this._getPaneScrollerArr();

for(var i=0;i<es.length;i++){es[i].getTablePane().updateContent();
}},_getMetaColumnAtPageX:function(G){var H=this._getPaneScrollerArr();

for(var i=0;i<H.length;i++){var I=H[i].getContainerLocation();

if(G>=I.left&&G<=I.right){return i;
}}return -1;
...
},_updateStatusBar:function(){var dY=this.getTableModel();

if(this.getStatusBarVisible()&&dY){var ea=this.getSelectionModel().getSelectedCount();
var ec=dY.getRowCount();
var eb;

if(ec>0){if(ea==0){eb=this.trn(bC,ci,ec,ec);
}else{eb=this.trn(bx,bf,ec,ea,ec);
}}
if(this.__qy){if(eb){eb+=this.__qy;
}else{eb=this.__qy;
}}
if(eb){this.getChildControl(bm).setContent(eb);
}}},_updateScrollerWidths:function(){var X=this._getPaneScrollerArr();

for(var i=0;i<X.length;i++){var ba=(i==(X.length-1));
var bb=X[i].getTablePaneModel().getTotalWidth();
X[i].setWidth(bb);
var Y=ba?1:0;
X[i].setLayoutProperties({flex:Y});
}},_updateScrollBarVisibility:function(){if(!this.getBounds()){return;
}var Q=qx.ui.table.pane.Scroller.HORIZONTAL_SCROLLBAR;
var T=qx.ui.table.pane.Scroller.VERTICAL_SCROLLBAR;
var N=this._getPaneScrollerArr();
var P=false;
var S=false;

for(var i=0;i<N.length;i++){var U=(i==(N.length-1));
var O=N[i].getNeededScrollBars(P,!U);
...
var R;
N[i].setHorizontalScrollBarVisible(P);
if(U){R=N[i].getVerticalScrollBarVisible();
}N[i].setVerticalScrollBarVisible(U&&S);
if(U&&S!=R){this.fireDataEvent(cs,S);
}}},_initColumnMenu:function(){var w=this.getTableModel();
var y=this.getTableColumnModel();
var z=this.getChildControl(bo);
z.empty();
var v=z.getMenu();
var A={table:this,menu:v,columnButton:z};
this.fireDataEvent(be,A);
this.__qB={};

for(var B=0,l=w.getColumnCount();B<l;B++){var u=z.factory(bL,{text:w.getColumnName(B),column:B,bVisible:y.isColumnVisible(B)});
qx.core.Assert.assertInterface(u,qx.ui.table.IColumnMenuItem);
u.addListener(ct,this._createColumnVisibilityCheckBoxHandler(B),this);
this.__qB[B]=u;
}var A={table:this,menu:v,columnButton:z};
this.fireDataEvent(cu,A);
},_createColumnVisibilityCheckBoxHandler:function(bc){return function(eM){var eN=this.getTableColumnModel();
eN.setColumnVisible(bc,eM.getData());
};
},setColumnWidth:function(di,dj){this.getTableColumnModel().setColumnWidth(di,dj);
},_onResize:function(){this.fireEvent(cd);
this._updateScrollerWidths();
this._updateScrollBarVisibility();
},addListener:function(a,b,self,c){if(arguments.callee.self.__qx[a]){for(var i=0,d=this._getPaneScrollerArr();i<d.length;i++){d[i].addListener.apply(d[i],arguments);
}}else{return arguments.callee.base.call(this,a,b,self,c);
}},removeListener:function(J,K,self,L){if(arguments.callee.self.__qx[J]){for(var i=0,M=this._getPaneScrollerArr();i<M.length;i++){M[i].removeListener.apply(M[i],arguments);
}}else{arguments.callee.base.call(this,J,K,self,L);
}},destroy:function(){this.getChildControl(bo).getMenu().destroy();
arguments.callee.base.call(this);
}},destruct:function(){if(qx.core.Variant.isSet(bh,cz)){qx.locale.Manager.getInstance().removeListener(bj,this._onChangeLocale,this);
...
this._disposeObjects(cl,bK,bF,bS);
}});
})();
...
},members:{__qK:false,_applyVisible:function(g,h){if(!this.bInListener){this.setChecked(g);
}}}});
})();
(function(){var M="Boolean",L="resize-line",K="mousedown",J="mouseup",I="qx.ui.table.pane.CellEvent",H="scroll",G="focus-indicator",F="excluded",E="scrollbar-y",D="visible",bK="mousemove",bJ="header",bI="editing",bH="click",bG="modelChanged",bF="scrollbar-x",bE="cellClick",bD="qx.event.type.ChangeEvent",bC="pane",bB="__rp",T="__rr",U="mouseout",R="__rm",S="changeHorizontalScrollBarVisible",P="bottom",Q="_applyScrollTimeout",N="changeScrollX",O="_applyTablePaneModel",X="Integer",Y="__ro",bh="__rt",bf="dblclick",bp="dataEdited",bk="mousewheel",bx="qx.ui.table.pane.Scroller",bu="_applyShowCellFocusIndicator",bb="__rP",bA="__rq",bz="resize",by="__rG",ba="vertical",bd="__rn",be="changeScrollY",bg="appear",bi="__rl",bl="table-scroller",br="__rs",bw="cellDblclick",V="horizontal",W="losecapture",bc="contextmenu",bo="col-resize",bn="disappear",bm="_applyVerticalScrollBarVisible",bt="_applyHorizontalScrollBarVisible",bs="cellContextmenu",bj="close",bq="changeTablePaneModel",C="qx.ui.table.pane.Model",bv="changeVerticalScrollBarVisible";
qx.Class.define(bx,{extend:qx.ui.core.Widget,construct:function(r){arguments.callee.base.call(this);
this.__rl=r;
var s=new qx.ui.layout.Grid();
s.setColumnFlex(0,1);
s.setRowFlex(1,1);
this._setLayout(s);
this.__rm=this._showChildControl(bF);
this.__rn=this._showChildControl(E);
this.__ro=this._showChildControl(bJ);
this.__rp=this._showChildControl(bC);
...
this.__rr.addListener(W,this._onChangeCaptureHeader,this);
this.__rr.addListener(bK,this._onMousemoveHeader,this);
this.__rr.addListener(K,this._onMousedownHeader,this);
this.__rr.addListener(J,this._onMouseupHeader,this);
this.__rr.addListener(bH,this._onClickHeader,this);
this.__rq.add(this.__rr,{flex:1});
this.__rs=new qx.ui.table.pane.Clipper();
this.__rs.add(this.__rp);
this.__rs.addListener(bk,this._onMousewheel,this);
this.__rs.addListener(bK,this._onMousemovePane,this);
this.__rs.addListener(K,this._onMousedownPane,this);
this.__rs.addListener(J,this._onMouseupPane,this);
this.__rs.addListener(bH,this._onClickPane,this);
this.__rs.addListener(bc,this._onContextMenu,this);
this.__rs.addListener(bf,this._onDblclickPane,this);
this.__rs.addListener(bz,this._onResizePane,this);
this._add(this.__rs,{row:1,column:0});
this.__rt=this.getChildControl(G);
...
},statics:{MIN_COLUMN_WIDTH:10,RESIZE_REGION_RADIUS:5,CLICK_TOLERANCE:5,HORIZONTAL_SCROLLBAR:1,VERTICAL_SCROLLBAR:2},events:{"changeScrollY":bD,"changeScrollX":bD,"cellClick":I,"cellDblclick":I,"cellContextmenu":I},properties:{horizontalScrollBarVisible:{check:M,init:true,apply:bt,event:S},verticalScrollBarVisible:{check:M,init:true,apply:bm,event:bv},tablePaneModel:{check:C,apply:O,event:bq},liveResize:{check:M,init:false},focusCellOnMouseMove:{check:M,init:false},selectBeforeFocus:{check:M,init:false},showCellFocusIndicator:{check:M,init:true,apply:bu},scrollTimeout:{check:X,init:100,apply:Q},appearance:{refine:true,init:bl}},members:{__rv:null,__rl:null,__rw:null,__rx:null,__ru:null,__ry:null,__rz:null,__rA:null,__rB:null,__rC:null,__rD:null,__rE:null,__rF:null,__rG:null,__rH:null,__rI:null,__rJ:null,__rK:null,__rL:null,__rM:null,__rN:null,__rO:null,__rP:null,__rm:null,__rn:null,__ro:null,__rr:null,__rp:null,__rs:null,__rt:null,__rq:null,_createChildControlImpl:function(p){var q;

switch(p){case bJ:q=(this.getTable().getNewTablePaneHeader())(this);
break;
case bC:q=(this.getTable().getNewTablePane())(this);
break;
case G:q=new qx.ui.table.pane.FocusIndicator(this);
q.setUserBounds(0,0,0,0);
q.setZIndex(1000);
q.addListener(J,this._onMouseupFocusIndicator,this);
this.__rs.add(q);
q.exclude();
break;
...
this.__rs.add(q);
break;
case bF:q=new qx.ui.core.ScrollBar(V).set({minWidth:0,alignY:P});
q.addListener(H,this._onScrollX,this);
this._add(q,{row:2,column:0});
break;
case E:q=new qx.ui.core.ScrollBar(ba);
q.addListener(H,this._onScrollY,this);
this._add(q,{row:1,column:1});
break;
}return q||arguments.callee.base.call(this,p);
},_applyHorizontalScrollBarVisible:function(cy,cz){this.__rm.setVisibility(cy?D:F);

if(!cy){this.setScrollY(0,true);
}},_applyVerticalScrollBarVisible:function(n,o){this.__rn.setVisibility(n?D:F);

if(!n){this.setScrollX(0);
}},_applyTablePaneModel:function(db,dc){if(dc!=null){dc.removeListener(bG,this._onPaneModelChanged,this);
}db.addListener(bG,this._onPaneModelChanged,this);
},_applyShowCellFocusIndicator:function(w,y){if(w){this._updateFocusIndicator();
}else{if(this.__rt){this.__rt.hide();
}}},getScrollY:function(){return this.__rn.getPosition();
},setScrollY:function(scrollY,eA){this.__rK=eA;
this.__rn.scrollTo(scrollY);

if(eA){this._updateContent();
}this.__rK=false;
...
},setColumnWidth:function(t,u){this.__ro.setColumnWidth(t,u);
this.__rp.setColumnWidth(t,u);
...
},onTableModelDataChanged:function(fk,fl,fm,fn){this.__rp.onTableModelDataChanged(fk,fl,fm,fn);
var fo=this.getTable().getTableModel().getRowCount();

if(fo!=this.__rv){this.updateVerScrollBarMaximum();

if(this.getFocusedRow()>=fo){if(fo==0){this.setFocusedCell(null,null);
}else{this.setFocusedCell(this.getFocusedColumn(),fo-1);
}}this.__rv=fo;
...
},updateHorScrollBarMaximum:function(){var eL=this.__rs.getInnerSize();
...
eK.setKnobFactor(1);
eK.setPosition(0);
}},updateVerScrollBarMaximum:function(){var cx=this.__rs.getInnerSize();

if(!cx){return ;
}var cv=this.getTable().getTableModel();
var cr=0;

if(cv!=null){cr=cv.getRowCount();
}
if(this.getTable().getKeepFirstVisibleRowComplete()){cr+=1;
}var cq=this.getTable().getRowHeight();
var ct=cr*cq;
var cw=this.__rn;

if(cx.height<ct){var cs=Math.max(0,ct-cx.height);
cw.setMaximum(cs);
cw.setKnobFactor(cx.height/ct);
var cu=cw.getPosition();
cw.setPosition(Math.min(cu,cs));
}else{cw.setMaximum(0);
cw.setKnobFactor(1);
cw.setPosition(0);
...
this.fireDataEvent(N,eP,e.getOldData());
this.__rr.scrollToX(eP);
this.__rs.scrollToX(eP);
},_onScrollY:function(e){this.fireDataEvent(be,e.getData(),e.getOldData());
this._postponedUpdateContent();
},_onMousewheel:function(e){var dr=this.getTable();

if(!dr.getEnabled()){return;
}this.__rn.scrollTo(this.__rn.getPosition()+((e.getWheelDelta()*3)*dr.getRowHeight()));
if(this.__rI&&this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(this.__rI,this.__rJ);
}},__rQ:function(dH){var dM=this.getTable();
var dN=this.__ro.getHeaderWidgetAtColumn(this.__rD);
var dI=dN.getSizeHint().minWidth;
var dK=Math.max(dI,this.__rF+dH-this.__rE);

if(this.getLiveResize()){var dJ=dM.getTableColumnModel();
dJ.setColumnWidth(this.__rD,dK);
}else{this.__ro.setColumnWidth(this.__rD,dK);
var dL=this.getTablePaneModel();
this._showResizeLine(dL.getColumnLeft(this.__rD)+dK);
}this.__rE+=dK-this.__rF;
this.__rF=dK;
},__rR:function(eY){var fa=qx.ui.table.pane.Scroller.CLICK_TOLERANCE;

if(this.__ro.isShowingColumnMoveFeedback()||eY>this.__rC+fa||eY<this.__rC-fa){this.__rz+=eY-this.__rC;
this.__ro.showColumnMoveFeedback(this.__ry,this.__rz);
var fb=this.__rl.getTablePaneScrollerAtPageX(eY);

if(this.__rB&&this.__rB!=fb){this.__rB.hideColumnMoveFeedback();
}
if(fb!=null){this.__rA=fb.showColumnMoveFeedback(eY);
}else{this.__rA=null;
}this.__rB=fb;
this.__rC=eY;
}},_onMousemoveHeader:function(e){var k=this.getTable();
...
if(this.__rD!=null){this.__rQ(i);
l=true;
}else if(this.__ry!=null){this.__rR(i);
}else{var d=this._getResizeColumnForPageX(i);

if(d!=-1){l=true;
}else{var h=k.getTableModel();
var m=this._getColumnForPageX(i);

if(m!=null&&h.isColumnSortable(m)){c=m;
}}}var g=l?bo:null;
this.getApplicationRoot().setGlobalCursor(g);
this.setCursor(g);
this.__ro.setMouseOverColumn(c);
...
var B=this._getResizeColumnForPageX(A);

if(B!=-1){this._startResizeHeader(B,A);
}else{var z=this._getColumnForPageX(A);

if(z!=null){this._startMoveHeader(z,A);
}}},_startResizeHeader:function(de,df){var dg=this.getTable().getTableColumnModel();
this.__rD=de;
this.__rE=df;
this.__rF=dg.getColumnWidth(this.__rD);
this.__rr.capture();
},_startMoveHeader:function(dx,dy){this.__ry=dx;
this.__rC=dy;
this.__rz=this.getTablePaneModel().getColumnLeft(dx);
this.__rr.capture();
},_onMousedownPane:function(e){var dR=this.getTable();
...
var dT=this._getRowForPagePos(dO,dQ);
var dS=this._getColumnForPageX(dO);

if(dT!==null){this.__rG={row:dT,col:dS};
var dP=this.getSelectBeforeFocus();

if(dP){dR.getSelectionManager().handleMouseDown(dT,e);
}if(!this.getFocusCellOnMouseMove()){this._focusCellAtPagePos(dO,dQ);
}
if(!dP){dR.getSelectionManager().handleMouseDown(dT,e);
...
this.fireEvent(bE,qx.ui.table.pane.CellEvent,[this,e,this.__rG.row,this.__rG.col],true);
}},_onChangeCaptureHeader:function(e){if(this.__rD!=null){this._stopResizeHeader();
}
if(this.__ry!=null){this._stopMoveHeader();
}},_stopResizeHeader:function(){var dd=this.getTable().getTableColumnModel();
if(!this.getLiveResize()){this._hideResizeLine();
dd.setColumnWidth(this.__rD,this.__rF);
}this.__rD=null;
this.__rr.releaseCapture();
this.getApplicationRoot().setGlobalCursor(null);
this.setCursor(null);
},_stopMoveHeader:function(){var fg=this.getTable().getTableColumnModel();
var fh=this.getTablePaneModel();
this.__ro.hideColumnMoveFeedback();

if(this.__rB){this.__rB.hideColumnMoveFeedback();
}
if(this.__rA!=null){var fj=fh.getFirstColumnX()+fh.getX(this.__ry);
var ff=this.__rA;

if(ff!=fj&&ff!=fj+1){var fi=fg.getVisibleColumnAtX(fj);
var fe=fg.getVisibleColumnAtX(ff);
var fd=fg.getOverallX(fi);
var fc=(fe!=null)?fg.getOverallX(fe):fg.getOverallColumnCount();
...
if(cC==-1){var cH=this._getColumnForPageX(cE);

if(cH!=null&&cD.isColumnSortable(cH)){var cB=cD.getSortColumnIndex();
var cG=(cH!=cB)?true:!cD.isSortAscending();
cD.sortByColumn(cH,cG);
cF.getSelectionModel().clearSelection();
...
if(this.__rt.isHidden()||(this.__rG&&bM==this.__rG.row&&bN==this.__rG.col)){this.__rG={};
this.fireEvent(bE,qx.ui.table.pane.CellEvent,[this,e,bM,bN],true);
}}},_onContextMenu:function(e){var bT=e.getDocumentLeft();
var bU=e.getDocumentTop();
var bR=this._getRowForPagePos(bT,bU);
var bS=this._getColumnForPageX(bT);

if(this.__rt.isHidden()||(this.__rG&&bR==this.__rG.row&&bS==this.__rG.col)){this.__rG={};
this.fireEvent(bs,qx.ui.table.pane.CellEvent,[this,e,bR,bS],true);
var bQ=this.getTable().getContextMenu();

if(bQ){if(bQ.getChildren().length>0){bQ.placeToMouse(e);
bQ.show();
}else{bQ.exclude();
}e.preventDefault();
...
if(cb!=-1&&cb!=null){this.fireEvent(bw,qx.ui.table.pane.CellEvent,[this,e,cb],true);
}},_onMouseout:function(e){var dX=this.getTable();

if(!dX.getEnabled()){return;
}if(this.__rD==null){this.setCursor(null);
this.getApplicationRoot().setGlobalCursor(null);
}this.__ro.setMouseOverColumn(null);
},_showResizeLine:function(x){var bW=this._showChildControl(L);
var bV=bW.getWidth();
var bX=this.__rs.getBounds();
bW.setUserBounds(x-Math.round(bV/2),0,bV,bX.height);
},_hideResizeLine:function(){this._excludeChildControl(L);
},showColumnMoveFeedback:function(dY){var ei=this.getTablePaneModel();
var eh=this.getTable().getTableColumnModel();
var ec=this.__rp.getContainerLocation().left;
var eg=ei.getColumnCount();
var ed=0;
var eb=0;
var el=ec;

for(var ea=0;ea<eg;ea++){var ee=ei.getColumnAtX(ea);
var ej=eh.getColumnWidth(ee);

if(dY<el+ej/2){break;
}el+=ej;
ed=ea+1;
eb=el-ec;
}var ef=this.__rs.getContainerLocation().left;
var ek=this.__rs.getBounds().width;
var scrollX=ef-ec;
eb=qx.lang.Number.limit(eb,scrollX+2,scrollX+ek-1);
this._showResizeLine(eb);
return ei.getFirstColumnX()+ed;
...
this.__rl.setFocusedCell(du,dv);
}},setFocusedCell:function(cY,da){if(!this.isEditing()){this.__rp.setFocusedCell(cY,da,this.__rx);
this.__rL=cY;
this.__rM=da;
this._updateFocusIndicator();
}},getFocusedColumn:function(){return this.__rL;
},getFocusedRow:function(){return this.__rM;
},scrollCellVisible:function(cK,cL){var cV=this.getTablePaneModel();
var cM=cV.getX(cK);

if(cM!=-1){var cS=this.__rs.getInnerSize();

if(!cS){return;
}var cT=this.getTable().getTableColumnModel();
var cP=cV.getColumnLeft(cK);
var cW=cT.getColumnWidth(cK);
var cN=this.getTable().getRowHeight();
var cX=cL*cN;
var scrollX=this.getScrollX();
var scrollY=this.getScrollY();
var cU=Math.min(cP,cP+cW-cS.width);
var cR=cP;
this.setScrollX(Math.max(cU,Math.min(cR,scrollX)));
var cO=cX+cN-cS.height;

if(this.getTable().getKeepFirstVisibleRowComplete()){cO+=cN;
}var cQ=cX;
this.setScrollY(Math.max(cO,Math.min(cQ,scrollY)),true);
}},isEditing:function(){return this.__rN!=null;
},startEditing:function(){var dD=this.getTable();
var dB=dD.getTableModel();
var dF=this.__rL;

if(!this.isEditing()&&(dF!=null)&&dB.isColumnEditable(dF)){var dG=this.__rM;
var dz=this.getTablePaneModel().getX(dF);
var dA=dB.getValue(dF,dG);
this.__rO=dD.getTableColumnModel().getCellEditorFactory(dF);
var dC={col:dF,row:dG,xPos:dz,value:dA,table:dD};
this.__rN=this.__rO.createCellEditor(dC);
...
this.__rN.addListener(bj,this._onCellEditorModalWindowClose,this);
var f=dD.getModalCellEditorPreOpenFunction();

if(f!=null){f(this.__rN,dC);
}this.__rN.open();
}else{var dE=this.__rt.getInnerSize();
this.__rN.setUserBounds(0,0,dE.width,dE.height);
this.__rt.addListener(K,function(e){e.stopPropagation();
});
this.__rt.add(this.__rN);
this.__rt.addState(bI);
...
this.cancelEditing();
},flushEditor:function(){if(this.isEditing()){var b=this.__rO.getCellEditorValue(this.__rN);
var a=this.getTable().getTableModel().getValue(this.__rL,this.__rM);
this.getTable().getTableModel().setValue(this.__rL,this.__rM,b);
this.__rl.focus();
this.__rl.fireDataEvent(bp,{row:this.__rM,col:this.__rL,oldValue:a,value:b});
...
}else{this.__rt.removeState(bI);
this.__rt.setKeepActive(true);
this.__rN.destroy();
this.__rN=null;
this.__rO=null;
}}},_onCellEditorModalWindowClose:function(e){this.stopEditing();
},_getColumnForPageX:function(eB){var eE=this.getTable().getTableColumnModel();
var eF=this.getTablePaneModel();
var eD=eF.getColumnCount();
var eH=this.__ro.getContainerLocation().left;

for(var x=0;x<eD;x++){var eC=eF.getColumnAtX(x);
var eG=eE.getColumnWidth(eC);
eH+=eG;

if(eB<eH){return eC;
}}return null;
},_getResizeColumnForPageX:function(eQ){var eU=this.getTable().getTableColumnModel();
var eV=this.getTablePaneModel();
var eT=eV.getColumnCount();
var eX=this.__ro.getContainerLocation().left;
var eR=qx.ui.table.pane.Scroller.RESIZE_REGION_RADIUS;

for(var x=0;x<eT;x++){var eS=eV.getColumnAtX(x);
var eW=eU.getColumnWidth(eS);
eX+=eW;

if(eQ>=(eX-eR)&&eQ<=(eX+eR)){return eS;
}}return -1;
},_getRowForPagePos:function(dh,di){var dj=this.__rp.getContentLocation();

if(dh<dj.left||dh>dj.right){return null;
}
if(di>=dj.top&&di<=dj.bottom){var dk=this.getTable().getRowHeight();
var scrollY=this.__rn.getPosition();

if(this.getTable().getKeepFirstVisibleRowComplete()){scrollY=Math.floor(scrollY/dk)*dk;
}var dn=scrollY+di-dj.top;
var dq=Math.floor(dn/dk);
var dp=this.getTable().getTableModel();
var dl=0;

if(dp!=null){dl=dp.getRowCount();
}return (dq<dl)?dq:null;
}var dm=this.__ro.getContainerLocation();

if(di>=dm.top&&di<=dm.bottom&&dh<=dm.right){return -1;
}return null;
},setTopRightWidget:function(eN){var eO=this.__rP;

if(eO!=null){this.__rq.remove(eO);
}
if(eN!=null){this.__rq.add(eN);
}this.__rP=eN;
},getTopRightWidget:function(){return this.__rP;
},getHeader:function(){return this.__ro;
},getTablePane:function(){return this.__rp;
},getVerticalScrollBarWidth:function(){var dU=this.__rn;
return dU.isVisible()?(dU.getSizeHint().width||0):0;
},getNeededScrollBars:function(em,en){var et=this.__rn.getSizeHint().width;
var eu=this.__rs.getInnerSize();
var eo=eu?eu.width:0;

if(this.getVerticalScrollBarVisible()){eo+=et;
}var ex=eu?eu.height:0;

if(this.getHorizontalScrollBarVisible()){ex+=et;
}var er=this.getTable().getTableModel();
var ev=0;

if(er!=null){ev=er.getRowCount();
}var ey=this.getTablePaneModel().getTotalWidth();
var ew=this.getTable().getRowHeight()*ev;
var eq=false;
var ez=false;
...
if(ew>ex-et){ez=true;
}}else if(ew>ex){ez=true;

if(!en&&(ey>eo-et)){eq=true;
}}var es=qx.ui.table.pane.Scroller.HORIZONTAL_SCROLLBAR;
var ep=qx.ui.table.pane.Scroller.VERTICAL_SCROLLBAR;
return ((em||eq)?es:0)|((en||!ez)?0:ep);
},_applyScrollTimeout:function(bY,ca){this._startInterval(bY);
},_startInterval:function(cA){this._stopInterval();
if(cA){this.__rw=window.setInterval(this.__ru,cA);
...
this._updateContent();
}},_updateContent:function(){var cm=this.__rs.getInnerSize();

if(!cm){return;
}var cp=cm.height;
var scrollX=this.__rm.getPosition();
var scrollY=this.__rn.getPosition();
var cj=this.getTable().getRowHeight();
var ck=Math.floor(scrollY/cj);
var co=this.__rp.getFirstVisibleRow();
this.__rp.setFirstVisibleRow(ck);
var cl=Math.ceil(cp/cj);
var ci=0;
var cn=this.getTable().getKeepFirstVisibleRowComplete();

if(!cn){cl++;
ci=scrollY%cj;
}this.__rp.setVisibleRowCount(cl);

if(ck!=co){this._updateFocusIndicator();
}this.__rs.scrollToX(scrollX);
if(!cn){this.__rs.scrollToY(ci);
...
if(dW){dW.dispose();
}this._disposeFields(by,bb,bi);
this._disposeObjects(R,bd,T,br,bh,Y,bB,bA);
}});
})();
...
(function(){var i="Integer",h="Escape",g="keypress",f="Enter",d="__rS",c="excluded",b="qx.ui.table.pane.FocusIndicator";
qx.Class.define(b,{extend:qx.ui.container.Composite,construct:function(r){arguments.callee.base.call(this);
this.__rS=r;
this.setKeepActive(true);
this.addListener(g,this._onKeyPress,this);
},properties:{visibility:{refine:true,init:c},row:{check:i,nullable:true},column:{check:i,nullable:true}},members:{__rS:null,_onKeyPress:function(e){var a=e.getKeyIdentifier();

if(a!==h&&a!==f){e.stopPropagation();
}},moveToCell:function(j,k){if(j==null){this.hide();
this.setRow(null);
this.setColumn(null);
}else{var l=this.__rS.getTablePaneModel().getX(j);

if(l==-1){this.hide();
this.setRow(null);
this.setColumn(null);
}else{var q=this.__rS.getTable();
var o=q.getTableColumnModel();
var p=this.__rS.getTablePaneModel();
var n=this.__rS.getTablePane().getFirstVisibleRow();
...
(function(){var r="Number",q="qx.event.type.Event",p="__rT",o="_applyFirstColumnX",n="Integer",m="qx.ui.table.pane.Model",l="_applyMaxColumnCount",k="visibilityChangedPre";
qx.Class.define(m,{extend:qx.core.Object,construct:function(u){arguments.callee.base.call(this);
u.addListener(k,this._onColVisibilityChanged,this);
this.__rT=u;
},events:{"modelChanged":q},statics:{EVENT_TYPE_MODEL_CHANGED:"modelChanged"},properties:{firstColumnX:{check:n,init:0,apply:o},maxColumnCount:{check:r,init:-1,apply:l}},members:{__rU:null,__rT:null,_applyFirstColumnX:function(v,w){this.__rU=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},_applyMaxColumnCount:function(f,g){this.__rU=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},setTableColumnModel:function(e){this.__rT=e;
this.__rU=null;
},_onColVisibilityChanged:function(a){this.__rU=null;
this.fireEvent(qx.ui.table.pane.Model.EVENT_TYPE_MODEL_CHANGED);
},getColumnCount:function(){if(this.__rU==null){var C=this.getFirstColumnX();
var E=this.getMaxColumnCount();
var D=this.__rT.getVisibleColumnCount();

if(E==-1||(C+E)>D){this.__rU=D-C;
}else{this.__rU=E;
}}return this.__rU;
},getColumnAtX:function(s){var t=this.getFirstColumnX();
return this.__rT.getVisibleColumnAtX(t+s);
},getX:function(h){var i=this.getFirstColumnX();
var j=this.getMaxColumnCount();
var x=this.__rT.getVisibleX(h)-i;
...
if(z==y){return B;
}B+=this.__rT.getColumnWidth(z);
}return -1;
},getTotalWidth:function(){var b=0;
var c=this.getColumnCount();

for(var x=0;x<c;x++){var d=this.getColumnAtX(x);
b+=this.__rT.getColumnWidth(d);
}return b;
}},destruct:function(){this._disposeFields(p);
}});
})();
(function(){var V="",U="!",T="'!",S="Expected '",R="number",Q=",",P="'",O="Event (",N="' but found ",M="The value '",bU="function",bT="Expected value to be an array but found ",bS="' to implement the interface '",bR=") was fired.",bQ="Expected value to be an integer >= 0 but found ",bP="' to be not equal with '",bO="' to '",bN="Expected value to be the CSS color '%1' (rgb(%2)), but found value '%3', which cannot be converted to a CSS color!",bM="Expected value to be a map but found ",bL="The function did not raise an exception!",bd="Expected value to be undefined but found ",be="Called assertFalse with 'true'",bb="Expected value to be null but found ",bc="Expected object '",Y="string",ba="Called assert with 'false'",W="Expected value to be a string but found ",X="' but found '",bi="Called assertTrue with 'false'",bj="' must must be a key of the map '",br="The String '",bp="Expected value not to be undefined but found ",bz="The raised exception does not have the expected type! ",bu=") not fired.",bH="qx.core.Assert",bE="Expected value to be typeof object but found ",bl="' (identical) but found '",bK="' must have any of the values defined in the array '",bJ="Expected value to be a number but found ",bI="Expected value to be the CSS color '%1' (rgb(%2)), but found value '%3' (rgb(%4))!",bk="Expected value not to be null but found ",bn="Expected value to be a qooxdoo widget but found ",bo="Expected value to be a qooxdoo object but found ",bq="' arguments.",bs="Expected value '%1' to be in the range '%2'..'%3'!",bv="' does not match the regular expression '",bB="' to be not identical with '",bG="' arguments but found '",bf=", ",bg="Expected value to be a boolean but found ",bm="boolean",by="Expected value to be typeof '",bx="Expected value to be typeof function but found ",bw="Expected value to be an integer but found ",bD="Called fail().",bC="Expected value to be a DOM element but found  '%1'!",bt="function Array(",bA="Expected value to be a number >= 0 but found ",L="Expected value to be instanceof '",bF="Wrong number of arguments given. Expected '",bh="object";
qx.Class.define(bH,{statics:{__X:function(o,p,q){if(!o){var r="Assertion error! "+p+": "+q;
qx.log.Logger.error(r);

if(qx.Class.isDefined("qx.core.AssertionError")){var s=new qx.core.AssertionError(p,q);
qx.log.Logger.error("Stack trace: \n"+s.getStackTrace());
throw s;
}else{throw new Error(r);
}}},assert:function(J,K){this.__X(J==true,K||V,ba);
},fail:function(cX){this.__X(false,cX||V,bD);
},assertTrue:function(A,B){this.__X(A===true,B||V,bi);
},assertFalse:function(dh,di){this.__X(dh===false,di||V,be);
},assertEquals:function(l,m,n){this.__X(l==m,n||V,S+l+X+m+T);
},assertNotEquals:function(dj,dk,dl){this.__X(dj!=dk,dl||V,S+dj+bP+dk+T);
},assertIdentical:function(d,f,g){this.__X(d===f,g||V,S+d+bl+f+T);
},assertNotIdentical:function(cU,cV,cW){this.__X(cU!==cV,cW||V,S+cU+bB+cV+T);
},assertNotUndefined:function(ch,ci){this.__X(ch!==undefined,ci||V,bp+ch+U);
},assertUndefined:function(cL,cM){this.__X(cL===undefined,cM||V,bd+cL+U);
},assertNotNull:function(C,D){this.__X(C!==null,D||V,bk+C+U);
},assertNull:function(cv,cw){this.__X(cv===null,cw||V,bb+cv+U);
},assertJsonEquals:function(h,j,k){this.assertEquals(qx.util.Json.stringify(h),qx.util.Json.stringify(j),k);
},assertMatch:function(bX,bY,ca){this.assertString(bX);
this.__X(bX.search(bY)>=0?true:false,ca||V,br+bX+bv+bY.toString()+T);
},assertArgumentsCount:function(dv,dw,dx,dy){var dz=dv.length;
this.__X((dz>=dw&&dz<=dx),dy||V,bF+dw+bO+dx+bG+arguments.length+bq);
},assertEventFired:function(cx,event,cy,cz,cA){var cC=false;
var cB=function(e){if(cz){cz.call(cx,e);
}cC=true;
};
var cD=cx.addListener(event,cB,cx);
cy.call();
this.__X(cC===true,cA||V,O+event+bu);
...
dc.call();
this.__X(df===false,dd||V,O+event+bR);
db.removeListenerById(dg);
},assertException:function(co,cp,cq,cr){var cp=cp||Error;
var cs;
qx.log.Logger.warn("This exception is expected: "+cp.classname);

try{co();
}catch(dA){cs=dA;
}
if(cs==null){this.__X(false,cr||V,bL);
}this.__X(cs instanceof cp,cr||V,bz+cp);

if(cq){this.assertMatch(cs.toString(),cq,cr);
}},assertInArray:function(cE,cF,cG){this.__X(cF.indexOf(cE)!==-1,cG||V,M+cE+bK+cF.join(bf)+P);
...
}},assertKeyInMap:function(x,y,z){this.__X(y[x]!==undefined,z||V,M+x+bj+qx.util.Json.stringify(y)+P);
},assertFunction:function(cj,ck){this.__X(typeof cj===bU,ck||V,bx+cj+U);
},assertString:function(cf,cg){this.__X(typeof cf===Y||cf instanceof String,cg||V,W+cf+U);
},assertBoolean:function(ct,cu){this.__X(typeof ct===bm||ct instanceof Boolean,cu||V,bg+ct+U);
},assertNumber:function(bV,bW){this.__X((typeof bV===R||bV instanceof Number)&&isFinite(bV),bW||V,bJ+bV+U);
},assertPositiveNumber:function(cS,cT){this.__X((typeof cS===R||cS instanceof Number)&&isFinite(cS)&&cS>=0,cT||V,bA+cS+U);
},assertInteger:function(cY,da){this.__X(((typeof cY===R||cY instanceof Number)&&isFinite(cY)&&cY%1===0),da||V,bw+cY+U);
},assertPositiveInteger:function(v,w){this.__X(((typeof v===R||v instanceof Number)&&isFinite(v)&&v%1===0&&v>=0),w||V,bQ+v+U);
},assertInRange:function(cO,cP,cQ,cR){this.__X(cO>=cP&&cO<=cQ,cR||V,qx.lang.String.format(bs,[cO,cP,cQ]));
},assertObject:function(t,u){this.__X(typeof t===bh&&t!==null,u||V,bE+t+U);
},assertArray:function(cb,cc){this.__X(cb instanceof Array||cb.constructor.toString().indexOf(bt)===0||cb.$$isArray,cc||V,bT+cb+U);
},assertMap:function(dB,dC){var dD=({}).constructor;
this.__X(dB&&dB.constructor===dD,dC||V,bM+dB+U);
},assertType:function(G,H,I){this.__X(typeof (G)===H,I||V,by+H+N+G+U);
},assertInstance:function(cH,cI,cJ){var cK=cI.classname||cI+V;
this.__X(cH instanceof cI,cJ||V,L+cK+N+cH+U);
},assertInterface:function(cl,cm,cn){this.__X(qx.Class.implementsInterface(cl,cm),cn||V,bc+cl+bS+cm+T);
},assertCssColor:function(dp,dq,dr){var ds=qx.util.ColorUtil;
var du=ds.stringToRgb(dp);

try{var dt=ds.stringToRgb(dq);
}catch(cN){this.__X(false,dr||V,qx.lang.String.format(bN,[dp,du.join(Q),dq]));
}this.__X(du[0]==dt[0]&&du[1]==dt[1]&&du[2]==dt[2],dr||V,qx.lang.String.format(bI,[dp,du.join(Q),dq,dt.join(Q)]));
},assertElement:function(E,F){this.__X(qx.dom.Node.isElement(E),F||V,qx.lang.String.format(bC,[E]));
},assertQxObject:function(dm,dn){this.__X(dm instanceof qx.core.Object,dn||V,bo+dm+U);
},assertQxWidget:function(cd,ce){this.__X(cd instanceof qx.ui.core.Widget,ce||V,bn+cd+U);
}}});
})();
...
(function(){var z="px",y="'></div>",x=".qooxdoo-table-cell-icon {",w="abstract",v="></div>",u="qx.ui.table.cellrenderer.AbstractImage",t=" qooxdoo-table-cell-icon",s="<div></div>",r="no-repeat",q="}",k="  text-align:center;",p="inline-block",n="static",j="top",i="  padding-top:1px;",m="title='",l="string",o="-moz-inline-box";
qx.Class.define(u,{extend:qx.ui.table.cellrenderer.Abstract,type:w,construct:function(){arguments.callee.base.call(this);
var f=arguments.callee.self;

if(!f.stylesheet){f.stylesheet=qx.bom.Stylesheet.createElement(x+k+i+q);
}},members:{_insetY:2,_identifyImage:function(h){throw new Error("_identifyImage is abstract");
},_getImageInfos:function(a){var b=this._identifyImage(a);
if(b==null||typeof b==l){b={url:b,tooltip:null};
}return b;
},_getCellClass:function(g){return arguments.callee.base.call(this)+t;
},_getContentHtml:function(c){var e=this._getImageInfos(c);
var content=s;
if(e.url){var content=qx.bom.element.Decoration.create(e.url,r,{width:e.imageWidth?e.imageWidth+z:null,height:e.imageHeight?e.imageHeight+z:null,display:qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.VERSION<1.9?o:p,verticalAlign:j,position:n});
}var d=e.tooltip;

if(d!=null){var content=content.replace(v,m+d+y);
}return content;
}}});
})();
(function(){var e="qx.ui.table.cellrenderer.Boolean",d=";padding-top:4px;",c="decoration/table/boolean-false.png",b="decoration/table/boolean-true.png";
...
this.__vC=a.resolve(b);
this.__vD=a.resolve(c);
},members:{__vC:null,__vD:false,_insetY:5,_getCellStyle:function(h){return arguments.callee.base.call(this,h)+d;
},_identifyImage:function(f){var g={imageWidth:11,imageHeight:11};

switch(f.value){case true:g.url=this.__vC;
break;
case false:g.url=this.__vD;
break;
default:g.url=null;
break;
}return g;
