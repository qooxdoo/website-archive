...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.progressive.ProgressiveTable_Mouseover", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.progressive.ProgressiveTable_Mouseover-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var s="row",r="onmouseout='DateCellRenderer.onmouseout(this);' ",q="DateCellRenderer",p="rgb(255, 0, 0)",o="celldata",n="",m="Number",l="red",k="1*",j="celldata='",d="' ",i="<br>",g="demobrowser.demo.progressive.ProgressiveTable_Mouseover",c="onmouseover='DateCellRenderer.onmouseover(this);' ",b="end",f="Date",e="Move your mouse over the Date field",h="color",a="Id";
qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var I=0;
var E=function(L){var O=[];
var N=new Date().getTime();
var P=400*24*60*60*1000;

for(var Q=0;Q<L;Q++){var M=new Date(N+Math.random()*P-P/2);
O.push({renderer:s,location:b,data:[I++,Math.random()*10000,M]});
}return O;
};
...
H.setWidth(2,300);
var B=[a,m,f];
var D=new qx.ui.progressive.headfoot.TableHeading(H,B);
var A=new qx.ui.progressive.headfoot.Progress(H,B);
var K=new qx.ui.progressive.structure.Default(D,A);
var z=new qx.ui.progressive.Progressive(K);
var J=new qx.ui.basic.Atom(e);
J.setTextColor(l);
J.setHeight(16);
J.setRich(true);
z.add(J);
...
G.addElements(F);
z.setDataModel(G);
var C=new qx.ui.progressive.renderer.table.Row(H);
z.addRenderer(s,C);
C.addRenderer(2,new DateCellRenderer());
this.getRoot().add(z,{edge:50});
z.render();
}}});
qx.Class.define(q,{extend:qx.ui.progressive.renderer.table.cell.Default,statics:{onmouseover:function(u){u.__ye=qx.bom.element.Style.get(u,h);
u.style.color=p;
u.parentNode.style.height=32;
u.__yf=u.innerHTML;
var w=Date.parse(u.attributes.getNamedItem(o).nodeValue);
var v=new Date(w);
u.innerHTML=v.toUTCString()+i+v.toString();
},onmouseout:function(t){t.style.color=t.__ye;
t.parentNode.style.height=16;
t.innerHTML=t.__yf;
}},members:{_getCellExtras:function(x){var y=[];
y.push(arguments.callee.base.call(this));
y.push(j+x.cellData.toUTCString()+d);
y.push(c,r);
return y.join(n);
}}});
})();
