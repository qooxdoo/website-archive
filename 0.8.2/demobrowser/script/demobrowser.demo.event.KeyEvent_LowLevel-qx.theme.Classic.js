...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.KeyEvent_LowLevel", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.event.KeyEvent_LowLevel-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
if(q){qx.bom.Element.addListener(q,b,this._clearLog,this);
}},_initLogger:function(m,n,o){this.__nq=e+m.join(h)+k;
this.__nr=o||50;
this.__ns=n;
this._clearLog();
},_clearLog:function(){this.__ns.innerHTML=this.__nq+l;
this.__nt=[];
},_log:function(p){this.__nt.unshift(p);
this.__nt=this.__nt.slice(0,this.__nr);
str=[this.__nq];

for(var i=0;i<this.__nt.length;i++){str.push(d,this.__nt[i].join(f),a);
}str.push(l);
this.__ns.innerHTML=str.join(g);
this.__ns.scrollTop=0;
}}});
})();
...
for(var i=0;i<q.length;i++){qx.bom.Event.addNativeListener(document.documentElement,q[i],qx.lang.Function.bind(this.logKeyEvent,this));
}},logKeyEvent:function(o){var p=o.type;
this._log([p,o.keyCode,o.charCode,o.keyIdentifier||l,o.shiftKey,o.ctrlKey,o.altKey]);
qx.bom.Event.preventDefault(o);
}}});
})();
