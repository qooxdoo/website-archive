...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.Table_FocusIndicator-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
qx.Mixin.define(m,{members:{assert:function(k,l){qx.core.Assert.assert(k,l);
},fail:function(br){qx.core.Assert.fail(br);
},assertTrue:function(bP,bQ){qx.core.Assert.assertTrue(bP,bQ);
},assertFalse:function(bE,bF){qx.core.Assert.assertFalse(bE,bF);
},assertEquals:function(by,bz,bA){qx.core.Assert.assertEquals(by,bz,bA);
},assertNotEquals:function(W,X,Y){qx.core.Assert.assertNotEquals(W,X,Y);
},assertIdentical:function(Q,R,S){qx.core.Assert.assertIdentical(Q,R,S);
},assertNotIdentical:function(bg,bh,bi){qx.core.Assert.assertNotIdentical(bg,bh,bi);
},assertNotUndefined:function(ba,bb){qx.core.Assert.assertNotUndefined(ba,bb);
},assertUndefined:function(r,s){qx.core.Assert.assertUndefined(r,s);
},assertNotNull:function(bI,bJ){qx.core.Assert.assertNotNull(bI,bJ);
},assertNull:function(bK,bL){qx.core.Assert.assertNull(bK,bL);
},assertJsonEquals:function(bj,bk,bl){qx.core.Assert.assertJsonEquals(bj,bk,bl);
},assertMatch:function(v,w,x){qx.core.Assert.assertMatch(v,w,x);
},assertArgumentsCount:function(M,N,O,P){qx.core.Assert.assertArgumentsCount(M,N,O,P);
},assertEventFired:function(n,event,o,p,q){qx.core.Assert.assertEventFired(n,event,o,p,q);
},assertEventNotFired:function(y,event,z,A){qx.core.Assert.assertEventNotFired(y,event,z,A);
},assertException:function(bs,bt,bu,bv){qx.core.Assert.assertException(bs,bt,bu,bv);
},assertInArray:function(bB,bC,bD){qx.core.Assert.assertInArray(bB,bC,bD);
...
},assertString:function(K,L){qx.core.Assert.assertString(K,L);
},assertBoolean:function(F,G){qx.core.Assert.assertBoolean(F,G);
},assertNumber:function(bG,bH){qx.core.Assert.assertNumber(bG,bH);
},assertPositiveNumber:function(bp,bq){qx.core.Assert.assertPositiveNumber(bp,bq);
},assertInteger:function(t,u){qx.core.Assert.assertInteger(t,u);
},assertPositiveInteger:function(B,C){qx.core.Assert.assertPositiveInteger(B,C);
...
},assertArray:function(bV,bW){qx.core.Assert.assertArray(bV,bW);
},assertMap:function(bw,bx){qx.core.Assert.assertMap(bw,bx);
},assertType:function(T,U,V){qx.core.Assert.assertType(T,U,V);
},assertInstance:function(H,I,J){qx.core.Assert.assertInstance(H,I,J);
...
},assertQxWidget:function(be,bf){qx.core.Assert.assertQxWidget(be,bf);
}}});
})();
