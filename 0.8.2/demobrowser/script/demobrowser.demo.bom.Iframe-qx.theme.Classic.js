...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Iframe", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Iframe-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var f="demobrowser.demo.bom.Iframe",e="http://gmx.com",d="testFrame",c="",b="load",a="dummy";
qx.Class.define(f,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var g=qx.bom.Iframe.create({name:d,src:e});
qx.bom.Element.addListener(g,b,function(e){this.debug("Content loaded.");
},this);
