...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.table.Table_Resize_Columns", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.table.Table_Resize_Columns-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var x="execute",w="Add 10 rows",v="Remove 10 rows",u="Whether the the first visible row should ",t="demobrowser.demo.table.Table_Resize_Columns",s="A number",r="1*",q="icon/22/actions/list-add.png",p="changeChecked",o="50%",j="A date",n="Boolean test",m="be rendered completely when scrolling.",i="Table with automatic column sizes",h="Keep first row",l="icon/22/actions/list-remove.png",k="ID";
qx.Class.define(t,{extend:demobrowser.demo.table.TableDemo,members:{getCaption:function(){return i;
},createTable:function(){var f=this.createRandomRows(50);
var d=this._tableModel=this._tableModel=new qx.ui.table.model.Simple();
d.setColumns([k,s,j,n]);
d.setData(f);
var c={tableColumnModel:function(y){return new qx.ui.table.columnmodel.Resize(y);
}};
var g=this._table=new qx.ui.table.Table(d,c);
g.set({width:600,height:400});
g.getSelectionModel().setSelectionMode(qx.ui.table.selection.Model.MULTIPLE_INTERVAL_SELECTION);
var e=g.getTableColumnModel();
var b=e.getBehavior();
b.set(0,{width:r,minWidth:40,maxWidth:80});
b.setWidth(1,o);
b.setMinWidth(1,100);
b.setMaxWidth(1,320);
var e=g.getTableColumnModel();
...
return g;
},createControls:function(){var E=new qx.ui.toolbar.ToolBar();
var C,D,F;
D=new qx.ui.toolbar.Part();
E.add(D);
C=new qx.ui.toolbar.Button(w,q);
C.addListener(x,function(G){var H=this.createRandomRows(10);
this._tableModel.addRows(H);
this.info("10 rows added");
},this);
D.add(C);
C=new qx.ui.toolbar.Button(v,l);
C.addListener(x,function(z){var A=this._tableModel.getRowCount();
...
E.add(D);
var B=this._table;
F=new qx.ui.toolbar.CheckBox(h);
F.set({checked:B.getKeepFirstVisibleRowComplete(),toolTip:new qx.ui.tooltip.ToolTip(u+m)});
F.addListener(p,function(a){B.setKeepFirstVisibleRowComplete(this.getChecked());
},F);
D.add(F);
return E;
}}});
