...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.ExtendedList-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var y="execute",x="Jack",w="kiss",v="demobrowser.demo.data.ExtendedList",u="Jim",t="sad",s="<b>Displaying Checkboxes in a list</b><br/>",r="plain",q="surprise",p="embarrassed",N="online",M="name",L="Write data to log",K="Jackob",J="Dan",I="Tim",H="Karl",G="Online <> Offline",F="This list display a set of persons in a list as checkbox. Every ",E="label",C="Dustin",D="angel",A="Max",B="person does have a name as label and an online status as checkbox.",z="checked";
qx.Class.define(v,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var o=[A,K,I,x,J,C,H,u];
var g=[p,w,r,t,q,D];
var m=[];

for(var i=0;i<20;i++){var j=new demobrowser.demo.data.model.Person();
j.setName(o[i%o.length]);
j.setEmote(g[i%g.length]);
j.setOnline(i%3==0);
m.push(j);
...
var k=new qx.data.controller.List(null,f);
var e={configureItem:function(O){O.setPadding(3);
},createItem:function(){return new qx.ui.form.CheckBox();
},bindItem:function(a,b,c){a.bindProperty(M,E,null,b,c);
a.bindProperty(N,z,null,b,c);
}};
k.setDelegate(e);
k.setModel(n);
var d=new qx.ui.form.Button(G);
d.setWidth(120);
this.getRoot().add(d,{left:180,top:80});
d.addListener(y,function(){for(var i=0;i<n.length;i++){n.getItem(i).toggleOnline();
}},this);
var l=new qx.ui.form.Button(L);
l.setWidth(120);
this.getRoot().add(l,{left:180,top:115});
l.addListener(y,function(){qx.log.appender.Console.show();
