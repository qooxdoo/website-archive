...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.event.Event", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
var D=new qx.event.Command(d);
D.addListener(i,function(){this.debug(D.toString());
},this);
var E=new qx.event.Command(a);
...
},_onResize:function(e){this.log([m+e]);
