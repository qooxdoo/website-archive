...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.ListControllerWithFilter", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.ListControllerWithFilter-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var r="execute",q="Show all numbers.",p="Write data to log",o="Add an item",n="Remove an item",m="Show only even numbers.",l="Odd / Even filter",k="content",j="Remove filter",h="Reverse order",d="demobrowser.demo.data.ListControllerWithFilter",g="Show only odd numbers.",f="<b>Filtered List</b><br/>",c="init",b="delegate",e="List showing numbered items, bound to a data array.";
qx.Class.define(d,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var E=[];

for(var i=0;i<8;i++){E.push(i);
}var G=new qx.data.Array(E);
var y=new qx.ui.form.List();
this.getRoot().add(y,{left:10,top:80});
var B=new qx.data.controller.List(G,y);
var x={};
x.filter=function(t){return parseInt(t)%2==1;
};
var z={};
z.filter=function(s){return parseInt(s)%2==0;
};
var D=new qx.ui.basic.Label(c);
this.getRoot().add(D,{left:10,top:290});
var H={converter:function(a){if(a==z){return m;
}else if(a==x){return g;
}return q;
}};
B.bind(b,D,k,H);
var A=new qx.ui.form.Button(o);
A.setWidth(120);
this.getRoot().add(A,{left:130,top:80});
A.addListener(r,function(){G.push(G.length);
},this);
var F=new qx.ui.form.Button(n);
F.setWidth(120);
this.getRoot().add(F,{left:130,top:115});
F.addListener(r,function(){G.pop();
},this);
var C=new qx.ui.form.Button(p);
C.setWidth(120);
this.getRoot().add(C,{left:130,top:150});
C.addListener(r,function(){qx.log.appender.Console.show();
this.info(G.toString());
},this);
var v=new qx.ui.form.Button(l);
v.setWidth(120);
this.getRoot().add(v,{left:130,top:185});
v.addListener(r,function(){B.getDelegate()==x?B.setDelegate(z):B.setDelegate(x);
},this);
var u=new qx.ui.form.Button(j);
u.setWidth(120);
this.getRoot().add(u,{left:130,top:220});
u.addListener(r,function(){B.setDelegate(null);
},this);
var I=new qx.ui.form.Button(h);
I.setWidth(120);
this.getRoot().add(I,{left:130,top:255});
I.addListener(r,function(){G.reverse();
},this);
