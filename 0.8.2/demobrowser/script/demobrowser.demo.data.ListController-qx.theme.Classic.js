...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.data.ListController", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.data.ListController-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var G="execute",F="multi",E="Bound to the selection of the list to the left.",D="Item ",C="Remove an item",B="Write data to log",A="Add an item",z="",y="selection[0]",x="<b>Multi selection List</b><br/>",s="content",w="<b>Selection Label</b><br/>",v="white",r="<b>Selection List</b><br/>",q="main",u="demobrowser.demo.data.ListController",t="Bound to the same data and share the selection.";
