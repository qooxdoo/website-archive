...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Tree_Columns-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var q="icon/16/devices/drive-harddisk.png",p="Trash",o="Windows (C:)",n="Documents (D:)",m="Family",l="TINC",k="Development",j="Inbox",h="Desktop",g="Announce",Y="Personal",X="Products",W="-rw-r--r--",V="Presets",U="Competition",T="Network",S="Questions",R="Sent",Q="Spam",P="Files",x="icon/16/status/dialog-information.png",y="Bugs",v="Projects",w="Company",t="Devel",u="Workspace",r="Holiday",s="icon/16/places/user-trash.png",z="Chat",A=" 2005",H="Big",F="Press",J="Data",I="Internal",L="demobrowser.demo.widget.Tree_Columns",K="May ",C="Root",O="icon/16/places/user-desktop.png",N="kb",M="Pustefix",B="Relations",D="Lists",E="Item ",G="Edit";
...
var bL=this.configureTreeItem(new qx.ui.tree.TreeFolder(),C);
bL.setOpen(true);
bK.setRoot(bL);
var bD=this.configureTreeItem(new qx.ui.tree.TreeFolder(),h);
bL.add(bD);
var bg=this.configureTreeItem(new qx.ui.tree.TreeFolder(),P);
var bd=this.configureTreeItem(new qx.ui.tree.TreeFolder(),u);
var be=this.configureTreeItem(new qx.ui.tree.TreeFolder(),T);
var bc=this.configureTreeItem(new qx.ui.tree.TreeFolder(),p);
bD.add(bg,bd,be,bc);
var bJ=this.configureTreeItem(new qx.ui.tree.TreeFile(),o,q);
var bI=this.configureTreeItem(new qx.ui.tree.TreeFile(),n,q);
bd.add(bJ,bI);
var bE=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),j);
var bh=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),V);
var bk=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),R);
var bj=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),p,s);
var bm=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),J);
var bl=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),G);
var bz=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),z);
var by=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),M);
var bx=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),l);
var bH=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),g);
var bG=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),t);
bx.add(bH,bG);
bl.add(bz,by,bx);
var bo=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),D);
var bu=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),B);
var bv=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),w);
var bw=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),S);
var bq=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),I);
var br=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),X);
var bs=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),F);
var bt=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),k);
var bA=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),U);
bo.add(bu,bv,bw,bq,br,bs,bt,bA);
var bn=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),Y);
var bB=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),y);
var bF=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),m);
var bC=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),v);
var bi=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),r);
bn.add(bB,bF,bC,bi);
var bb=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),H);

for(var i=0;i<50;i++){bb.add(new this.configureTreeItem(new qx.ui.tree.TreeFolder(),E+i));
}var ba=new this.configureTreeItem(new qx.ui.tree.TreeFolder(),Q);
bE.add(bh,bk,bj,bm,bl,bo,bn,bb,ba);
bL.add(bE);
},configureTreeItem:function(a,b,c){if(Math.floor(Math.random()*4)==0){var f=new qx.ui.basic.Image(x);
a.addWidget(f);
}else{a.addWidget(new qx.ui.core.Spacer(16,16));
}a.addSpacer();

if(a instanceof qx.ui.tree.TreeFolder){a.addOpenButton();
}a.addIcon();
a.setIcon(arguments.length>=3?c:O);
var e=new qx.ui.form.CheckBox();
e.setFocusable(false);
a.addWidget(e);
a.addLabel(b);
a.addWidget(new qx.ui.core.Spacer(),{flex:1});
var d=new qx.ui.basic.Label(Math.round(Math.random()*100)+N);
d.setWidth(50);
a.addWidget(d);
d=new qx.ui.basic.Label(K+Math.round(Math.random()*30+1)+A);
d.setWidth(150);
a.addWidget(d);
d=new qx.ui.basic.Label(W);
d.setWidth(80);
a.addWidget(d);
return a;
}}});
