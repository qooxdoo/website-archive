...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.test.ChildrenHandling", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.test.ChildrenHandling-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var q="Remove ",p="yellow",o="demobrowser.demo.test.ChildrenHandling",n="Horizontal box layout:",m="blue",l="Add ",k="green",j="Grid layout:",h="black",g="orange",e="red",f="execute";
...
var c=new qx.ui.form.Button(q+a.getBackgroundColor()).set({width:100});
c.addListener(f,function(){if(d){this._hbox.remove(a);
this._grid.remove(this._gridWidgets[b]);
c.setLabel(l+a.getBackgroundColor());
}else{this._hbox.add(a);
this._grid.add(this._gridWidgets[b],{row:0,column:b});
c.setLabel(q+a.getBackgroundColor());
}d=!d;
},this);
return c;
}}});
