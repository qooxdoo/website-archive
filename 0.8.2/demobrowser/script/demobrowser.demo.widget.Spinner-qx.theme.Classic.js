...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Spinner", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Spinner-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var y="0",x="middle",w="100",v="left",u="Disabled",t="Not Editable",s="demobrowser.demo.widget.Spinner",r="Stepped",q="Wrap",p="-3000",j="30",o="300",m="3000",i="changeValue",h="-30",l="Simple",k="Number format",n="right";
qx.Class.define(s,{extend:qx.application.Standalone,members:{addSimpleSpinner:function(D,E){var F=new qx.ui.form.Spinner();
D.add(new qx.ui.basic.Label(l),{column:0,row:E});
D.add(new qx.ui.basic.Label(y),{column:1,row:E});
D.add(F,{column:2,row:E});
D.add(new qx.ui.basic.Label(w),{column:3,row:E});
F.addListener(i,function(e){this.debug("ChangeValue: "+e.getData());
});
},addNonEditableSpinner:function(d,f){var g=new qx.ui.form.Spinner(0,50,100);
g.setEditable(false);
d.add(new qx.ui.basic.Label(t),{column:0,row:f});
d.add(new qx.ui.basic.Label(y),{column:1,row:f});
d.add(g,{column:2,row:f});
d.add(new qx.ui.basic.Label(w),{column:3,row:f});
},addWrappingSpinner:function(L,M){var N=new qx.ui.form.Spinner(-30,30,30);
N.setWrap(true);
L.add(new qx.ui.basic.Label(q),{column:0,row:M});
L.add(new qx.ui.basic.Label(h),{column:1,row:M});
L.add(N,{column:2,row:M});
L.add(new qx.ui.basic.Label(j),{column:3,row:M});
},addSteppedSpinner:function(a,b){var c=new qx.ui.form.Spinner(-3000,0,3000).set({singleStep:25});
a.add(new qx.ui.basic.Label(r),{column:0,row:b});
a.add(new qx.ui.basic.Label(p),{column:1,row:b});
a.add(c,{column:2,row:b});
a.add(new qx.ui.basic.Label(m),{column:3,row:b});
},addDisabledSpinner:function(I,J){var K=new qx.ui.form.Spinner;
K.setEnabled(false);
I.add(new qx.ui.basic.Label(u),{column:0,row:J});
I.add(new qx.ui.basic.Label(y),{column:1,row:J});
I.add(K,{column:2,row:J});
I.add(new qx.ui.basic.Label(w),{column:3,row:J++});
},addFormattedSpinner:function(z,A){var B=new qx.ui.form.Spinner(0,200,300);
B.setSingleStep(0.5);
B.setWidth(70);
...
z.add(new qx.ui.basic.Label(y),{column:1,row:A});
z.add(B,{column:2,row:A});
z.add(new qx.ui.basic.Label(o),{column:3,row:A++});
},main:function(){arguments.callee.base.call(this);
var H=new qx.ui.layout.Grid(10,8);
H.setColumnAlign(0,v,x);
H.setColumnAlign(1,n,x);
H.setColumnAlign(2,v,x);
H.setColumnAlign(3,v,x);
var G=new qx.ui.container.Composite(H);
G.setPadding(10);
this.getRoot().add(G,{left:0,top:0});
this.addSimpleSpinner(G,0);
this.addNonEditableSpinner(G,1);
this.addWrappingSpinner(G,2);
this.addSteppedSpinner(G,3);
this.addDisabledSpinner(G,4);
this.addFormattedSpinner(G,5);
}}});
})();
