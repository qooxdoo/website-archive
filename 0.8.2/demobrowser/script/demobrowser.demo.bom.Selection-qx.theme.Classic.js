...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.bom.Selection", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.bom.Selection-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var j="div",i="button",h="click",g="margin-right: 8px",f="width:100%;margin-bottom:20px",e="results",d="textarea",c="plaintext",b="margin: 4px",a="text",K="test\ntest2\ntest3\ntest4\ntest5",J="margin: 4px 0px",I="demobrowser.demo.bom.Selection",H="width:20%;margin-right:10px",G="this is a test",F="setSelectionInput",E="width:300px;height:250px",D="setSelectionDocument",C="border:1px solid darkgrey;",B="<strong>Results</strong>",q="background-color: lightgrey",r="test test2 test3 test4 test5 test6",o="container",p="textfield",m="areaContainer",n="position:relative;padding:20px",k="getSelectionInput",l="margin-bottom:20px",s="width:500px;height:200px;",t="textContainer",w="test text",v="setSelectionTextarea",y="inputContainer",x="<br/>",A="getSelectionDocument",z="getSelectionTextarea",u="textBlock";
qx.Class.define(I,{extend:qx.application.Native,members:{main:function(){arguments.callee.base.call(this);
var M=qx.bom.Element.create(j,{id:o,style:n});
var Y=qx.bom.Element.create(j,{id:t,style:f});
qx.dom.Element.insertEnd(Y,M);
var S=qx.bom.Element.create(j,{id:u,style:l});
S.innerHTML=r;
qx.dom.Element.insertEnd(S,Y);
var W=qx.bom.Input.create(i,{value:A,style:b});
qx.bom.Element.addListener(W,h,this._getSelection,document);
qx.dom.Element.insertEnd(W,Y);
var T=qx.bom.Input.create(i,{value:D,style:b});
qx.bom.Element.addListener(T,h,function(e){qx.bom.Selection.set(document.getElementById(c).firstChild,0,4);
this.debug(qx.bom.Selection.getLength(document));
},this);
qx.dom.Element.insertEnd(T,Y);
var O=qx.bom.Element.create(j,{id:y,style:f});
qx.dom.Element.insertEnd(O,M);
this._input=qx.bom.Input.create(a,{id:p,value:w,style:H});
qx.dom.Element.insertEnd(this._input,O);
var R=qx.bom.Input.create(i,{value:k,style:g});
qx.bom.Element.addListener(R,h,this._getSelection,this._input);
qx.dom.Element.insertEnd(R,O);
var X=qx.bom.Input.create(i,{value:F,style:g});
qx.bom.Element.addListener(X,h,this._setSelection,this._input);
qx.dom.Element.insertEnd(X,O);
var P=qx.bom.Element.create(j,{id:m,style:f});
qx.dom.Element.insertEnd(P,M);
this._textArea=qx.bom.Input.create(d,{id:d,rows:7,cols:20,value:K,style:E});
qx.dom.Element.insertEnd(this._textArea,P);
var V=qx.bom.Input.create(i,{value:z,style:g});
qx.bom.Element.addListener(V,h,this._getSelection,this._textArea);
qx.dom.Element.insertEnd(V,P);
var Q=qx.bom.Input.create(i,{value:v,style:g});
qx.bom.Element.addListener(Q,h,this._setSelection,this._textArea);
qx.dom.Element.insertEnd(Q,P);
var L=qx.bom.Element.create(j,{style:J});
L.innerHTML=B;
var N=qx.bom.Element.create(j,{id:e,style:s+C+q});
qx.dom.Element.insertEnd(L,M);
qx.dom.Element.insertEnd(N,M);
var U=qx.bom.Element.create(j,{id:c});
U.innerHTML=G;
qx.dom.Element.insertEnd(U,document.body);
qx.dom.Element.insertEnd(M,document.body);
},_getSelection:function(e){document.getElementById(e).innerHTML=qx.bom.Selection.get(this)+x+qx.bom.Selection.getLength(this);
...
qx.Class.define(o,{statics:{hasChild:function(parent,r){return r.parentNode===parent;
},hasChildren:function(n){return !!n.firstChild;
},hasChildElements:function(f){f=f.firstChild;

while(f){if(f.nodeType===1){return true;
}f=f.nextSibling;
}return false;
},getParentElement:function(w){return w.parentNode;
},isInDom:function(g,h){var j=h.document.getElementsByTagName(g.nodeName);

for(var i=0,l=j.length;i<l;i++){if(j[i]===g){return true;
}}return false;
...
}},insertEnd:function(s,parent){parent.appendChild(s);
...
return true;
},replaceAt:function(y,z,parent){var A=parent.childNodes[z];

if(!A){return false;
}parent.replaceChild(y,A);
return true;
}}});
})();
