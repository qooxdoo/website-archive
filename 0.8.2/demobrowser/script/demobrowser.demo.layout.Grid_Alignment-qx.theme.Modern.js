...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.Grid_Alignment", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Modern", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.Grid_Alignment-qx.theme.Modern-0.js"]],
  boot : "boot"
};  
...
(function(){var p="main",o="yellow",n="bottom",m="top",l="left",k="right",j="center",h="middle",g="orange",f="gray",d="green",e="demobrowser.demo.layout.Grid_Alignment";
...
var c=new qx.ui.container.Composite(new qx.ui.layout.Grid(20)).set({padding:20});
scroll.add(c);
c.add(this.getCellAlignGrid(),{row:0,column:0});
c.add(this.getRowColumnAlignGrid(),{row:0,column:1});
c.add(this.getColumnAlignGrid(),{row:0,column:2});
c.add(this.getRowAlignGrid(),{row:1,column:0});
},getNewWidget:function(){var s=new qx.ui.core.Widget().set({decorator:p,backgroundColor:d,allowGrowX:false,allowGrowY:false,height:Math.round((Math.random()*30)+30),width:Math.round((Math.random()*30)+30)});
return s;
},getColumnAlignGrid:function(){var q=new qx.ui.container.Composite().set({decorator:p,backgroundColor:o,allowGrowX:false,allowGrowY:false});
var r=new qx.ui.layout.Grid();
r.setSpacing(3);
r.setColumnAlign(0,l,m);
r.setColumnAlign(1,j,h);
r.setColumnAlign(2,k,n);
q.setLayout(r);

for(var x=0;x<3;x++){for(var y=0;y<6;y++){q.add(this.getNewWidget(),{row:y,column:x});
}}return q;
},getRowAlignGrid:function(){var a=new qx.ui.container.Composite().set({decorator:p,backgroundColor:o,allowGrowX:false,allowGrowY:false});
...
},getCellAlignGrid:function(){var t=new qx.ui.container.Composite().set({decorator:p,backgroundColor:o,allowGrowX:false,allowGrowY:false});
var v=new qx.ui.layout.Grid();
v.setSpacing(3);
t.setLayout(v);

for(var x=0;x<5;x++){v.setColumnAlign(x,j,h);

for(var y=0;y<5;y++){t.add(this.getNewWidget(),{row:y,column:x});
}}var u=v.getCellWidget(0,0);
u.set({alignX:l,alignY:m});
u.set({backgroundColor:g,width:20,height:20});
var u=v.getCellWidget(4,4);
u.set({alignX:k,alignY:n});
u.set({backgroundColor:g,width:20,height:20});
return t;
},getRowColumnAlignGrid:function(){var w=new qx.ui.container.Composite().set({decorator:p,backgroundColor:o,allowGrowX:false,allowGrowY:false});
var A=new qx.ui.layout.Grid();
A.setSpacing(3);
w.setLayout(A);

for(var x=0;x<5;x++){for(var y=0;y<5;y++){w.add(this.getNewWidget(),{row:y,column:x});
}}A.setColumnAlign(2,l,m);
A.setRowAlign(2,k,n);

for(var i=0;i<5;i++){A.getCellWidget(2,i).setBackgroundColor(f);
A.getCellWidget(i,2).setBackgroundColor(f);
}var z=A.getCellWidget(2,2);
z.set({backgroundColor:g,width:20,height:20});
return w;
}}});
})();
