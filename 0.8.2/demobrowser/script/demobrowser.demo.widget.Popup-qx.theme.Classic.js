...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.widget.Popup", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.widget.Popup-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var n="click",m="icon/32/apps/media-photo-album.png",l="Hello World #1",k="#FFFAD3",j="#DFFAD3",i="Open Popup #2",h="top-right",g="Open Popup #1",f="demobrowser.demo.widget.Popup";
...
a.setSpacing(20);
var b=new qx.ui.container.Composite(a).set({padding:20});
this.getRoot().add(b);
b.add(this._getPopupButton1());
b.add(this._getPopupButton2());
},_getPopupButton1:function(){var o=new qx.ui.form.Button(g);
var p=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:k,padding:[2,4],offset:3,offsetBottom:20});
p.add(new qx.ui.basic.Atom(l,m));
o.addListener(n,function(e){p.placeToMouse(e);
p.show();
},this);
return o;
},_getPopupButton2:function(){var c=new qx.ui.form.Button(i);
var d=new qx.ui.popup.Popup(new qx.ui.layout.Canvas()).set({backgroundColor:j,padding:[2,4],offset:3,position:h});
d.add(new qx.ui.basic.Atom(l,m));
c.addListener(n,function(e){d.placeToMouse(e);
d.show();
},this);
return c;
}}});
...
(function(){var n="mousedown",m="blur",l="__jq",k="singleton",j="qx.ui.popup.Manager";
qx.Class.define(j,{type:k,extend:qx.core.Object,construct:function(){arguments.callee.base.call(this);
this.__jq={};
var i=qx.core.Init.getApplication().getRoot();
i.addListener(n,this.__js,this,true);
qx.bom.Element.addListener(window,m,this.hideAll,this);
},members:{__jq:null,add:function(t){{};
this.__jq[t.$$hash]=t;
this.__jr();
},remove:function(p){{};
var q=this.__jq;
...
this.__jr();
}},hideAll:function(){var s=this.__jq;

if(s){for(var r in s){s[r].exclude();
}}},__jr:function(){var h=1e7;
var g=this.__jq;

for(var f in g){g[f].setZIndex(h++);
}},__js:function(e){var c=e.getTarget();
var d=this.__jq;
...
if(o){o.removeListener(n,this.__js,this,true);
}this._disposeMap(l);
}});
})();
