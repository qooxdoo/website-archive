...
(function(){var s="right",r="top",q="Last Name",p="Notes",o="male",n="First Name",m="default",l="Cancel",k="Sex",j="Reading",G="Smith",F="Swimming",E="City",D="demobrowser.demo.showcase.Dialog",C="Hobbies",B="icon/22/actions/dialog-apply.png",A="John",z="female",y="Page",x="icon/22/actions/dialog-cancel.png",v="Country",w="OK",t="USA",u="New York";
qx.Class.define(D,{extend:qx.application.Standalone,members:{main:function(){arguments.callee.base.call(this);
var e=new qx.ui.layout.Grid(9,5);
e.setColumnAlign(0,s,r);
e.setColumnAlign(2,s,r);
e.setColumnWidth(1,160);
e.setColumnWidth(2,72);
e.setColumnWidth(3,108);
var b=new qx.ui.tabview.TabView;
var h=new qx.ui.tabview.Page(y);
h.setLayout(e);
h.setPadding(10);
b.add(h);
...
for(var i=0;i<labels.length;i++){h.add(new qx.ui.basic.Label(labels[i]).set({allowShrinkX:false,paddingTop:3}),{row:i,column:0});
}inputs=[A,G,u,t];

for(var i=0;i<inputs.length;i++){h.add(new qx.ui.form.TextField(inputs[i]),{row:i,column:1});
}h.add(new qx.ui.form.TextArea().set({height:250}),{row:4,column:1,colSpan:3});
h.add(new qx.ui.basic.Label(k).set({allowShrinkX:false,paddingTop:3}),{row:0,column:2});
var d=new qx.ui.form.RadioButton(z);
var g=new qx.ui.form.RadioButton(o);
var c=new qx.ui.form.RadioGroup();
c.add(d,g);
h.add(d,{row:0,column:3});
h.add(g,{row:1,column:3});
g.setChecked(true);
h.add(new qx.ui.basic.Label(C).set({allowShrinkX:false,paddingTop:3}),{row:2,column:2});
h.add(new qx.ui.form.CheckBox(j),{row:2,column:3});
h.add(new qx.ui.form.CheckBox(F).set({enabled:false}),{row:3,column:3});
var f=new qx.ui.layout.HBox().set({spacing:4,alignX:s});
var a=new qx.ui.container.Composite(f).set({paddingTop:11});
h.add(a,{row:5,column:0,colSpan:4});
okButton=new qx.ui.form.Button(w,B);
okButton.addState(m);
a.add(okButton);
cancelButton=new qx.ui.form.Button(l,x);
a.add(cancelButton);
}}});
})();
