...
var settings = {"qx.legacy.theme": "qx.legacy.theme.ClassicRoyale", "qx.application": "demobrowser.demo.layout.HBox", "qx.allowUrlVariants": "true", "qx.theme": "qx.theme.Classic", "qx.allowUrlSettings": "true"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["../../script/demobrowser.demo.layout.HBox-qx.theme.Classic-0.js"]],
  boot : "boot"
};  
...
(function(){var A="main",z="green",y="yellow",x="center",w="right",v="demobrowser.demo.layout.HBox",u="top",t="bottom",s="middle";
qx.Class.define(v,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){arguments.callee.base.call(this);
var scroll=new qx.ui.container.Scroll();
this.getRoot().add(scroll,{edge:0});
var D=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});
scroll.add(D);
D.add(this.getBox1());
D.add(this.getBox2());
D.add(this.getBox3());
...
D.add(this.getBox6());
D.add(this.getBox7());
},getBox1:function(){var C=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:A,backgroundColor:y,allowGrowX:false});
C.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
C.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
C.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
return C;
},getBox2:function(){var B=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:A,backgroundColor:y,minHeight:60,allowGrowX:false});
B.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z,maxHeight:40,alignY:u}));
B.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z,maxHeight:40,alignY:s}));
B.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z,maxHeight:40,alignY:t}));
return B;
},getBox3:function(){var q=new qx.ui.layout.HBox();
var r=new qx.ui.container.Composite(q).set({decorator:A,backgroundColor:y,width:500,allowGrowX:false});
q.setSpacing(5);
q.setAlignX(w);
r.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
r.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
r.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
return r;
},getBox4:function(){var e=new qx.ui.layout.HBox();
var f=new qx.ui.container.Composite(e).set({decorator:A,backgroundColor:y,width:500,allowGrowX:false});
e.setSpacing(5);
e.setAlignX(x);
f.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
f.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
f.add(new qx.ui.core.Widget().set({decorator:A,backgroundColor:z}));
return f;
},getBox5:function(){var b=new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({decorator:A,backgroundColor:y,allowGrowX:false});
var d=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
var c=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
var a=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
b.add(d);
b.add(c);
b.add(a);
d.setMarginRight(10);
...
a.setMarginRight(10);
return b;
},getBox6:function(){var l=new qx.ui.layout.HBox();
var n=new qx.ui.container.Composite(l).set({decorator:A,backgroundColor:y,width:500,allowGrowX:false});
l.setSpacing(5);
l.setAlignX(w);
var p=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
var o=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
var m=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
n.add(p);
n.add(o);
n.add(m);
p.setMarginRight(10);
...
m.setMarginRight(10);
return n;
},getBox7:function(){var g=new qx.ui.layout.HBox();
var i=new qx.ui.container.Composite(g).set({decorator:A,backgroundColor:y,width:500,allowGrowX:false});
g.setSpacing(5);
g.setAlignX(x);
var k=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
var j=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
var h=new qx.ui.core.Widget().set({decorator:A,backgroundColor:z});
i.add(k);
i.add(j);
i.add(h);
k.setMarginRight(10);
