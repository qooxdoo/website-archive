...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.HBox_Margin","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.HBox_Margin-qx.theme.Simple.320279930949.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var e="demobrowser.demo.layout.HBox_Margin",d="middle",c="yellow",b="green",a="main";qx.Class.define(e,{extend:demobrowser.demo.util.LayoutApplication,members:{main:function(){demobrowser.demo.util.LayoutApplication.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var f=new qx.ui.container.Composite(new qx.ui.layout.VBox(20)).set({padding:20});scroll.add(f);f.add(this.getBox1());f.add(this.getBox2());f.add(this.getBox3());f.add(this.getBox4());f.add(this.getBox5());}
,getBox1:function(){var g=new qx.ui.layout.HBox();var i=new qx.ui.container.Composite(g).set({decorator:a,backgroundColor:c,allowGrowX:false});g.setSpacing(5);var k=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var j=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var h=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});i.add(k);i.add(j);i.add(h);k.setAllowGrowY(false);j.setAllowGrowY(false);h.setAllowGrowY(false);k.setMarginTop(20);h.setMarginBottom(30);return i;}
,getBox2:function(){var l=new qx.ui.layout.HBox();var n=new qx.ui.container.Composite(l).set({decorator:a,backgroundColor:c,allowGrowX:false});l.setSpacing(5);var p=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var o=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var m=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});n.add(p);n.add(o);n.add(m);p.setMarginTop(20);m.setMarginBottom(30);return n;}
,getBox3:function(){var q=new qx.ui.layout.HBox();var s=new qx.ui.container.Composite(q).set({decorator:a,backgroundColor:c,height:100,allowGrowX:false});q.setSpacing(5);q.setAlignY(d);var u=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var t=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var r=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});s.add(u);s.add(t);s.add(r);u.setAllowGrowY(false);t.setAllowGrowY(false);r.setAllowGrowY(false);u.setMarginTop(20);r.setMarginBottom(30);return s;}
,getBox4:function(){var v=new qx.ui.layout.HBox();var x=new qx.ui.container.Composite(v).set({decorator:a,backgroundColor:c,height:100,allowGrowX:false});v.setSpacing(5);v.setAlignY(d);var z=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var y=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var w=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});x.add(z);x.add(y);x.add(w);z.setMarginTop(20);w.setMarginTop(5);w.setMinHeight(50);w.setMarginBottom(20);return x;}
,getBox5:function(){var A=new qx.ui.layout.HBox();var C=new qx.ui.container.Composite(A).set({decorator:a,backgroundColor:c,height:100,allowGrowX:false});A.setSpacing(5);A.setAlignY(d);var E=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var D=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});var B=new qx.ui.core.Widget().set({decorator:a,backgroundColor:b});C.add(E);C.add(D);C.add(B);E.setMarginTop(20);B.setMarginTop(5);B.setMinHeight(50);B.setMarginBottom(200);return C;}
}});}
)();
