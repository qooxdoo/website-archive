...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SelectBox","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SelectBox-qx.theme.Modern.ca643b139c0d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="icon/16/devices/",k="phone.png",j="audio-card.png",h="battery.png",g="printer.png",f="Simple",d="display.png",c="audio-input-microphone.png",b="Empty Item",a="computer.png",H="Random Value ",G="input-keyboard.png",F="drive-optical.png",E="",D="media-optical.png",C="changeSelection",B="pda.png",A="network-wired.png",z=".",y="camera-photo.png",s="network-wireless.png",t="media-flash.png",q="Option ",r="input-mouse.png",o="demobrowser.demo.widget.SelectBox",p="With icons",m="drive-harddisk.png",n="camera-web.png",u="multimedia-player.png",v="Item ",x="Long text",w="changeSelection: ";qx.Class.define(o,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var J=new qx.ui.container.Scroll();var I=new qx.ui.container.Composite(new qx.ui.layout.HBox(50));I.setPadding(20);I.add(this.createBox1());I.add(this.createBox2());I.add(this.createBox3());I.add(this.createBox4());J.add(I,{left:20,top:20});this.getRoot().add(J,{edge:0});}
,createBox1:function(){var L=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));L.add(new qx.ui.basic.Label(f));var K=new qx.ui.form.SelectBox();for(var i=0;i<30;i++){var M=new qx.ui.form.ListItem(v+(i+1));K.add(M);if(i==5){K.setSelection([M]);}
;}
;K.addListener(C,function(e){this.debug(w+e.getData()[0]);}
);L.add(K);return L;}
,createBox2:function(){var O=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));O.add(new qx.ui.basic.Label(x));var N=new qx.ui.form.SelectBox();for(var i=0;i<30;i++){var P=new qx.ui.form.ListItem(H+Math.round(Math.random()*100000000));N.add(P);}
;O.add(N);return O;}
,createBox3:function(){var R=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));R.add(new qx.ui.basic.Label(p));var T=[j,c,h,y,n,a,d,m,F,G,r,t,D,u,A,s,B,k,g];var U=l;var Q=new qx.ui.form.SelectBox();for(var i=0;i<T.length;i++){var S=new qx.ui.form.ListItem(T[i].substr(0,T[i].indexOf(z)),U+T[i]);Q.add(S);}
;R.add(Q);return R;}
,createBox4:function(){var W=new qx.ui.container.Composite(new qx.ui.layout.VBox(2));W.add(new qx.ui.basic.Label(b));var V=new qx.ui.form.SelectBox();V.add(new qx.ui.form.ListItem(E));for(var i=0;i<10;i++){V.add(new qx.ui.form.ListItem(q+(i+1)));}
;W.add(V);return W;}
}});}
)();
