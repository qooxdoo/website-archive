...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Cells-qx.theme.Modern.79e71300f8f0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
,testStringCell:function(){var C={value:[m,o,k,null],states:[{},{selected:1}]};var B=new qx.ui.virtual.cell.String;qx.util.Permutation.permute(C,function(D){var E=this.__IW(B,D.value,D.states);this.container.add(E);}
,this);}
...
;var I=this.__IW(G,H.value,H.states);this.container.add(I);}
,this);}
...
;var M=this.__IW(K,L.value,L.states);this.container.add(M);}
,this);}
,testHtmlCell:function(){var N={value:[m,o,k,null],states:[{},{selected:1}]};var O=new qx.ui.virtual.cell.Html;qx.util.Permutation.permute(N,function(P){var Q=this.__IW(O,P.value,P.states);this.container.add(Q);}
,this);}
,testImageCell:function(){var R={value:[{url:q,tooltip:n},{url:t,tooltip:v},null],states:[{},{selected:1}]};var S=new qx.ui.virtual.cell.Image;qx.util.Permutation.permute(R,function(T){var U=this.__IW(S,T.value,T.states);this.container.add(U);}
,this);}
,testBooleanCell:function(){var V={value:[true,false,null],states:[{},{selected:1}]};var W=new qx.ui.virtual.cell.Boolean;qx.util.Permutation.permute(V,function(X){var Y=this.__IW(W,X.value,X.states);this.container.add(Y);}
,this);}
,testBooleanCellCustomImage:function(){var ba={value:[true,false,null],states:[{},{selected:1}]};var bb=new qx.ui.virtual.cell.Boolean;bb.setIconFalse(r);bb.setIconTrue(p);qx.util.Permutation.permute(ba,function(bc){var bd=this.__IW(bb,bc.value,bc.states);this.container.add(bd);}
,this);}
,__IW:function(be,bf,bg){var bk=100;var bi=30;var bm=new qx.ui.embed.Html().set({width:bk,height:bi,decorator:bg.selected?null:"main"});var bh=be.getCellProperties(bf,bg);var bj=bh.insets;var bl=["<div ","style='",this._getCellSizeStyle(bk,bi,bj[0],bj[1]),bh.style,"' ","class='",bh.classes,"' ",bh.attributes,">",bh.content,"</div>"].join("");bm.setHtml(bl);return bm;}
...
,members:{__Dy:16,__Dz:16,_aliasManager:null,__DB:function(w){var z=qx.util.ResourceManager.getInstance();var y=qx.io.ImageLoader;var x,A;if(z.has(w)){x=z.getImageWidth(w),A=z.getImageHeight(w);}
else if(y.isLoaded(w)){x=y.getWidth(w);A=y.getHeight(w);}
else {x=this.__Dy;A=this.__Dz;}
;return {width:x,height:A};}
,__GN:function(B){if(typeof (B)=="string"){B={url:B};}
...
(function(){var e="_applyIconFalse",d="qx.ui.virtual.cell.Boolean",c="_applyIconTrue",b="cell-boolean",a="String";qx.Class.define(d,{extend:qx.ui.virtual.cell.AbstractImage,construct:function(){qx.ui.virtual.cell.AbstractImage.call(this);this.__HJ=qx.util.AliasManager.getInstance();}
,properties:{appearance:{refine:true,init:b},iconTrue:{check:a,themeable:true,apply:c},iconFalse:{check:a,themeable:true,apply:e}},members:{__HK:null,__HL:null,__HJ:null,_applyIconTrue:function(f){this.__HK=this.__HJ.resolve(f);}
,_applyIconFalse:function(g){this.__HL=this.__HJ.resolve(g);}
,_identifyImage:function(h){return h==true?this.__HK:this.__HL;}
}});}
)();
