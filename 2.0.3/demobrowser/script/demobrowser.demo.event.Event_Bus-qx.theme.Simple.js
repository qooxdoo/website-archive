...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.event.Event_Bus","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.event.Event_Bus-qx.theme.Simple.8dcabe22aa78.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;}
,_initLogger:function(n,o,p){this.__Pj=f+n.join(j)+l;this.__Pk=p||50;this.__Pl=o;this._clearLog();}
,_clearLog:function(){this.__Pl.innerHTML=this.__Pj+a;this.__Pm=[];}
,_log:function(q){this.__Pm.unshift(q);this.__Pm=this.__Pm.slice(0,this.__Pk);var r=[this.__Pj];for(var i=0;i<this.__Pm.length;i++){r.push(e,this.__Pm[i].join(g),b);}
;r.push(a);this.__Pl.innerHTML=r.join(h);this.__Pl.scrollTop=0;}
,__Pj:null,__Pk:null,__Pl:null,__Pm:null},destruct:function(){this.__Pl=this.__Pm=null;}
});}
)();
...
(function(){var r="logger",q="Callback",p="Dispatch",o="Message",n="Receiving",m="Subscribe",l="demobrowser.demo.event.Event_Bus",k="_anotherStartCallback",j="_finishedCallback",i="_startCallback",c="_anotherFinishedCallback",h="_loadingCallback",g="loading",b="start",a="finished",f="X",d="";qx.Class.define(l,{extend:demobrowser.demo.event.EventDemo,members:{main:function(){demobrowser.demo.event.EventDemo.prototype.main.call(this);this._initLogger([m,p,n,o,q],document.getElementById(r),50);var s=qx.event.message.Bus;s.subscribe(b,this._startCallback,this);this._log([f,d,d,b,i]);s.subscribe(b,this._anotherStartCallback,this);this._log([f,d,d,b,k]);s.subscribe(g,this._loadingCallback,this);this._log([f,d,d,g,h]);s.subscribe(a,this._finishedCallback,this);this._log([f,d,d,a,j]);s.subscribe(a,this._anotherFinishedCallback,this);this._log([f,d,d,a,c]);qx.event.Timer.once(function(e){this._log([d,f,d,b,d]);s.getInstance().dispatchByName(b);}
,this,1000);qx.event.Timer.once(function(e){this._log([d,f,d,g,d]);s.getInstance().dispatchByName(g);}
,this,2500);qx.event.Timer.once(function(e){this._log([d,f,d,g,d]);s.getInstance().dispatchByName(g);}
,this,4000);qx.event.Timer.once(function(e){this._log([d,f,d,a,d]);s.getInstance().dispatchByName(a);}
,this,5000);}
,_startCallback:function(e){this._log([d,d,f,b,i]);}
,_anotherStartCallback:function(e){this._log([d,d,f,b,k]);}
,_loadingCallback:function(e){this._log([d,d,f,g,h]);}
,_finishedCallback:function(e){this._log([d,d,f,a,j]);}
,_anotherFinishedCallback:function(e){this._log([d,d,f,a,c]);}
}});}
)();
...
},construct:function(){this.__sI={};}
,members:{__sI:null,getSubscriptions:function(){return this.__sI;}
...
;}
;return false;}
,dispatch:function(G){var J=this.getSubscriptions();var H=G.getName();var I=false;for(var K in J){var L=K.indexOf(d);if(L>-1){if(L===0||K.substr(0,L)===H.substr(0,L)){this.__sJ(J[K],G);I=true;}
;}
else {if(K===H){this.__sJ(J[H],G);I=true;}
;}
;}
;return I;}
,dispatchByName:function(name,M){var N=new qx.event.message.Message(name,M);return this.dispatch(N);}
,__sJ:function(O,P){for(var i=0;i<O.length;i++){var Q=O[i].subscriber;var R=O[i].context;if(R&&R.isDisposed){if(R.isDisposed()){O.splice(i,1);i--;}
else {Q.call(R,P);}
;}
else {Q.call(R,P);}
;}
