...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.SplitPane","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Indigo"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.SplitPane-qx.theme.Indigo.a4c7cb481601.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var w="offset",v="Show first pane",u="demobrowser.demo.widget.SplitPane",t="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",s="Show both panes",r="Toggle Splitpane Orientation",q="Offset (",p="Show second pane",o="_container2",n="vertical",f="__xk",m="):",j="changeSelection",c="_container1",b="execute",h="first",g="second",k="both",a="main",l="horizontal",d="value";qx.Class.define(u,{extend:qx.application.Standalone,members:{__xk:null,main:function(){qx.application.Standalone.prototype.main.call(this);var y=new qx.ui.container.Scroll();var x=new qx.ui.container.Composite(new qx.ui.layout.Basic());x.setAllowStretchX(false);y.add(x);var F=new qx.ui.splitpane.Pane(l).set({width:450,height:300});this.__xk=F;var J=new qx.ui.container.Composite(new qx.ui.layout.Grow).set({width:200,height:100,decorator:a});var M=new qx.ui.container.Composite(new qx.ui.layout.VBox(10)).set({padding:10,maxWidth:450,decorator:a});var B=this.__QR();var A=new qx.ui.form.Button(r).set({allowGrowX:false,allowGrowY:false});A.addListener(b,this._toggle,this);var D=new qx.ui.basic.Label(t);D.setRich(true);J.add(B);M.add(A);M.add(D);this._container1=J;this._container2=M;F.add(J,0);F.add(M,1);x.add(F,{left:20,top:40});this.getRoot().add(y,{edge:0});var z=new qx.ui.layout.VBox(5);var G=new qx.ui.container.Composite(z);var K=new qx.ui.form.RadioButton(v);var L=new qx.ui.form.RadioButton(p);var I=new qx.ui.form.RadioButton(s);K.setUserData(d,h);L.setUserData(d,g);I.setUserData(d,k);I.setValue(true);G.add(K);G.add(L);G.add(I);var E=new qx.ui.form.RadioGroup(K,L,I);E.addListener(j,this._changeVisiblity,this);x.add(G,{left:490,top:42});A.focus();var C=new qx.ui.basic.Label();this.getRoot().add(C,{left:490,top:120});var H=new qx.ui.form.Slider().set({minimum:0,maximum:30,value:6,width:100});this.getRoot().add(H,{left:490,top:140});H.bind(d,F,w);H.bind(d,C,d,{converter:function(N){return q+N+m;}
});}
,_toggle:function(){var O=this.__xk.getOrientation();this.__xk.setOrientation(O==l?n:l);}
,_changeVisiblity:function(e){var P=e.getData()[0].getUserData(d);if(P==k){this._container1.show();this._container2.show();}
else if(P==h){this._container1.show();this._container2.exclude();}
else if(P==g){this._container1.exclude();this._container2.show();}
;;}
,__QR:function(){var ba=new qx.ui.tree.Tree();ba.setDecorator(null);var bf=new qx.ui.tree.TreeFolder("/");bf.setOpen(true);ba.setRoot(bf);var bd=new qx.ui.tree.TreeFolder("Desktop");bd.setOpen(true);bf.add(bd);var U=new qx.ui.tree.TreeFolder("Files");var S=new qx.ui.tree.TreeFolder("Workspace");var T=new qx.ui.tree.TreeFolder("Network");var R=new qx.ui.tree.TreeFolder("Trash");bd.add(U,S,T,R);var bb=new qx.ui.tree.TreeFile("Windows (C:)");var Q=new qx.ui.tree.TreeFile("Documents (D:)");S.add(bb,Q);var be=new qx.ui.tree.TreeFolder("Inbox");var V=new qx.ui.tree.TreeFolder("Presets");var Y=new qx.ui.tree.TreeFolder("Sent");var X=new qx.ui.tree.TreeFolder("Trash");for(var i=0;i<100;i++){X.add(new qx.ui.tree.TreeFile("Junk #"+i));}
;var bc=new qx.ui.tree.TreeFolder("Data");var W=new qx.ui.tree.TreeFolder("Edit");be.add(V,Y,X,bc,W);bf.add(be);return ba;}
},destruct:function(){this._disposeObjects(f,c,o);}
});}
)();
