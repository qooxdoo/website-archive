...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.test.Validation","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Validation-qx.theme.Simple.ebc259af6b53.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var S=new qx.ui.basic.Label();S.setRich(true);S.setWidth(250);S.setValue(B+s+g+K+r);this.getRoot().add(S,{left:280,top:10});}
}});qx.Class.define(G,{extend:qx.core.Object,properties:{name:{init:x,validate:o},age:{init:18,validate:qx.util.Validate.number()},gender:{init:E,validate:qx.util.Validate.inArray([E,D])}},members:{__Qi:function(W){if(W.length<2){throw new qx.core.ValidationError(t+O+W+e);}
;}
}});}
)();
