...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.widget.TabView","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Simple"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.widget.TabView-qx.theme.Simple.c31c8d125f54.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var l="icon/16/apps/utilities-calculator.png",k="demobrowser.demo.widget.TabView",j="bottom",h="Notes",g="Remove first page",f="Layout",d="icon/16/apps/utilities-help.png",c="Add new page",b="changeSelection",a="Calculator...",B="icon/16/apps/utilities-notes.png",A="Bar Position",z="top",y="Calculator",x="right",w="Help",v="Help...",u="Notes...",t="Layout-Settings",s="Remove last page",q="left",r=" with close button.",o="icon/32/apps/utilities-terminal.png",p="icon/16/apps/utilities-terminal.png",m="execute",n="Page #";qx.Class.define(k,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var D=new qx.ui.container.Scroll();var C=new qx.ui.container.Composite(new qx.ui.layout.VBox(10));C.setPadding(20);C.setAllowStretchX(false);D.add(C);this.getRoot().add(D,{edge:0});C.add(this.getTabView1());C.add(this.getTabView2());C.add(this.getTabView3());}
,getTabView1:function(){var E=new qx.ui.tabview.TabView();E.setWidth(500);var I=new qx.ui.tabview.Page(f,p);I.setLayout(new qx.ui.layout.VBox());I.add(new qx.ui.basic.Label(t));E.add(I);var G=new qx.ui.tabview.Page(h,B);G.setLayout(new qx.ui.layout.VBox());G.add(new qx.ui.basic.Label(u));E.add(G);var H=new qx.ui.tabview.Page(y,l);H.setLayout(new qx.ui.layout.VBox());H.add(new qx.ui.basic.Label(a));E.add(H);var F=new qx.ui.tabview.Page(w,d);F.setLayout(new qx.ui.layout.VBox());F.add(new qx.ui.basic.Label(v));E.add(F);return E;}
,getTabView2:function(){var J=new qx.ui.tabview.TabView();J.setWidth(500);for(var i=1;i<=20;i++){var K=new qx.ui.tabview.Page(n+i,p);K.setLayout(new qx.ui.layout.VBox());K.setShowCloseButton(true);K.add(new qx.ui.basic.Label(n+i+r));J.add(K);}
;return J;}
,getTabView3:function(){var N=new qx.ui.tabview.TabView();N.setWidth(500);N.setHeight(300);for(var i=1;i<=3;i++){var W=new qx.ui.tabview.Page(n+i,o);W.setLayout(new qx.ui.layout.VBox(4));N.add(W);W.add(new qx.ui.basic.Label(n+i));}
;var P=N.getChildren()[0];var U=new qx.ui.basic.Label(A);var S=new qx.ui.form.RadioButton(z);var M=new qx.ui.form.RadioButton(j);var R=new qx.ui.form.RadioButton(q);var T=new qx.ui.form.RadioButton(x);P.add(new qx.ui.core.Spacer(10,10));P.add(U);P.add(S);P.add(M);P.add(R);P.add(T);var V=new qx.ui.form.RadioGroup(S,M,R,T);V.addListener(b,function(e){this.setBarPosition(e.getData()[0].getLabel());}
,N);R.setValue(true);var O=new qx.ui.form.Button(c);var Q=new qx.ui.form.Button(g);var L=new qx.ui.form.Button(s);P.add(new qx.ui.core.Spacer(10,10));P.add(O);P.add(Q);P.add(L);O.addListener(m,function(e){var X=N.getChildren().length+1;var Y=new qx.ui.tabview.Page(n+X,o);N.add(Y);}
);Q.addListener(m,function(e){var ba=N.getChildren();if(ba.length>0){N.remove(ba[0]);}
;}
);L.addListener(m,function(e){var bb=N.getChildren();if(bb.length>0){N.remove(bb[bb.length-1]);}
;}
);return N;}
}});}
)();
