...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.ScaleImage-qx.theme.Simple.455634936070.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;var G=qx.util.ResourceManager.getInstance().toUri(u);var D={"width":f,"height":w,"position":l,"left":o,"top":o,"background":i+G+n};this.__sP=new qx.html.Element(m,D);this.__sP.addListener(k,this.__se,this);this.__sP.addListener(B,this.__sd,this);F.add(this.__sP);}
,__se:function(e){if(e.isMultiTouch()){this.__PK=e.getRotation()+this.__PJ;this.__PL=e.getScale()*this.__PI;this.__sP.setStyle(C,r+this.__PK+g+this.__PL+n);}
else {var I=parseInt(e.getDocumentLeft())-(parseInt(this.__sP.getStyle(A))/2);var top=parseInt(e.getDocumentTop())-(parseInt(this.__sP.getStyle(j))/2);this.__sP.setStyles({"left":I+q,"top":top+q});}
;}
,__sd:function(e){if(e.isMultiTouch()){this.__PJ=this.__PK;this.__PI=this.__PL;}
;}
}});}
)();
