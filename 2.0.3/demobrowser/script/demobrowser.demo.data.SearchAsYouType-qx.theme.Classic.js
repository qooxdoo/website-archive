...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.SearchAsYouType-qx.theme.Classic.bb870248ce5a.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var d="_applySearchString",c="demobrowser.demo.data.filter.SearchAsYouTypeFilter",b="String",a="";qx.Class.define(c,{extend:qx.core.Object,construct:function(e){qx.core.Object.call(this);this.__eh=e;this.filter=qx.lang.Function.bind(function(f){return f.search(this.getSearchString())!=-1;}
,this);this.__qW=null;}
,properties:{searchString:{check:b,apply:d,init:a}},members:{__qW:null,__eh:null,_applySearchString:function(g,h){var i=qx.util.TimerManager.getInstance();if(this.__qW!=null){i.stop(this.__qW);this.__qW=null;}
;this.__qW=i.start(function(){this.__eh.update();this.__qW=null;}
,0,this,null,200);}
,filter:null},destruct:function(){this.__eh=null;}
});}
)();
