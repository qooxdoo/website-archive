...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.layout.VSplit","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.layout.VSplit-qx.theme.Classic.f9d251172898.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var m="Flex:1; Max:100",l="Flex:1; Max:200",k="Flex:2; Min:250",j="Flex:0; Min:350",i="demobrowser.demo.layout.VSplit",h="Flex:1; Min:250",g="Auto",f="Flex:2",e="Flex:0",d="Flex:2; Max:100",a="Flex:1",c="vertical",b="main";qx.Class.define(i,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var scroll=new qx.ui.container.Scroll();this.getRoot().add(scroll,{edge:0});var n=new qx.ui.container.Composite(new qx.ui.layout.Canvas()).set({padding:20,allowShrinkX:false,allowShrinkY:false});scroll.add(n);n.add(this.getSplitPaneTwoFlexSimple(),{left:0});n.add(this.getSplitPaneTwoFlexWithOneMin(),{left:210});n.add(this.getSplitPaneTwoFlexWithOneMax(),{left:420});n.add(this.getSplitPaneTwoFlexWithTwoMin(),{left:630});n.add(this.getSplitPaneTwoFlexWithTwoMax(),{left:840});n.add(this.getSplitPaneOneFlexSimple(),{top:550,left:0});n.add(this.getSplitPaneOneFlexSimpleWithMax(),{top:550,left:210});n.add(this.getSplitPaneOneFlexSimpleWithMin(),{top:550,left:420});n.add(this.getSplitPaneAuto(),{top:550,left:630});}
,getSplitPaneTwoFlexSimple:function(){var p=new qx.ui.splitpane.Pane(c);p.setHeight(400);p.setDecorator(b);var o=new qx.ui.form.TextArea(a);o.setDecorator(null);o.setWrap(true);p.add(o,1);var q=new qx.ui.form.TextArea(f);q.setDecorator(null);q.setWrap(true);p.add(q,2);return p;}
,getSplitPaneTwoFlexWithOneMin:function(){var s=new qx.ui.splitpane.Pane(c);s.setHeight(400);s.setDecorator(b);var r=new qx.ui.form.TextArea(h);r.setDecorator(null);r.setWrap(true);r.setMinHeight(250);s.add(r,1);var t=new qx.ui.form.TextArea(f);t.setDecorator(null);t.setWrap(true);s.add(t,2);return s;}
,getSplitPaneTwoFlexWithOneMax:function(){var v=new qx.ui.splitpane.Pane(c);v.setHeight(400);v.setDecorator(b);var u=new qx.ui.form.TextArea(a);u.setDecorator(null);u.setWrap(true);v.add(u,1);var w=new qx.ui.form.TextArea(d);w.setDecorator(null);w.setWrap(true);w.setMaxHeight(100);v.add(w,2);return v;}
,getSplitPaneTwoFlexWithTwoMin:function(){var y=new qx.ui.splitpane.Pane(c);y.setHeight(400);y.setDecorator(b);var x=new qx.ui.form.TextArea(h);x.setDecorator(null);x.setWrap(true);x.setMinHeight(250);y.add(x,1);var z=new qx.ui.form.TextArea(k);z.setDecorator(null);z.setWrap(true);z.setMinHeight(250);y.add(z,2);return y;}
,getSplitPaneTwoFlexWithTwoMax:function(){var B=new qx.ui.splitpane.Pane(c);B.setHeight(400);B.setDecorator(b);var A=new qx.ui.form.TextArea(m);A.setDecorator(null);A.setWrap(true);A.setMaxHeight(100);B.add(A,1);var C=new qx.ui.form.TextArea(d);C.setDecorator(null);C.setWrap(true);C.setMaxHeight(100);B.add(C,2);return B;}
,getSplitPaneOneFlexSimple:function(){var E=new qx.ui.splitpane.Pane(c);E.setHeight(400);E.setDecorator(b);var D=new qx.ui.form.TextArea(e);D.setDecorator(null);D.setWrap(true);E.add(D,0);var F=new qx.ui.form.TextArea(a);F.setDecorator(null);F.setWrap(true);E.add(F);return E;}
,getSplitPaneOneFlexSimpleWithMax:function(){var H=new qx.ui.splitpane.Pane(c);H.setHeight(400);H.setDecorator(b);var G=new qx.ui.form.TextArea(e);G.setDecorator(null);G.setWrap(true);H.add(G,0);var I=new qx.ui.form.TextArea(l);I.setDecorator(null);I.setWrap(true);I.setMaxHeight(200);H.add(I);return H;}
,getSplitPaneOneFlexSimpleWithMin:function(){var K=new qx.ui.splitpane.Pane(c);K.setHeight(400);K.setDecorator(b);var J=new qx.ui.form.TextArea(j);J.setDecorator(null);J.setWrap(true);J.setMinHeight(350);K.add(J,0);var L=new qx.ui.form.TextArea(a);L.setDecorator(null);L.setWrap(true);K.add(L);return K;}
,getSplitPaneAuto:function(){var N=new qx.ui.splitpane.Pane(c);N.setDecorator(b);var M=new qx.ui.form.TextArea(g);M.setDecorator(null);M.setWrap(true);N.add(M,0);var O=new qx.ui.form.TextArea(g);O.setDecorator(null);O.setWrap(true);N.add(O);return N;}
}});}
)();
