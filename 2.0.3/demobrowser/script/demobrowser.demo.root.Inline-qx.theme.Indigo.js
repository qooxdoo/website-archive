...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.root.Inline-qx.theme.Indigo.7d8b8cc98a56.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var o="resize",n="qx.ui.root.Page",m="mshtml",l="The root widget does not support decorators with 'left', or 'top' insets!",k="gecko",j="paddingLeft",i="$$widget",h="The root widget does not support 'left', or 'top' paddings!",g="left",f="paddingTop",b="qxIsRootPage",d="absolute",c="engine.name",a="div";qx.Class.define(n,{extend:qx.ui.root.Abstract,construct:function(p){this.__oc=p;qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());this.setZIndex(10000);qx.ui.core.queue.Layout.add(this);this.addListener(o,this.__qB,this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(c)==m)){this.setKeepFocus(true);}
;}
,members:{__lm:null,__oc:null,_createContainerElement:function(){var r=this.__oc.createElement(a);this.__oc.body.appendChild(r);var q=new qx.html.Root(r);q.setStyles({position:d,textAlign:g});q.setAttribute(i,this.toHashCode());if((qx.core.Environment.get(c)==k)){q.setAttribute(b,1);}
;return q;}
...
,__qB:function(e){this.getContainerElement().setStyles({width:0,height:0});this.getContentElement().setStyles({width:0,height:0});}
...
;this.__yy=y;y.style.overflow=f;y.style.textAlign=k;this.__yz=z||false;this.__yA=A||false;this.__yB();qx.ui.root.Abstract.call(this);this._setLayout(new qx.ui.layout.Basic());qx.ui.core.queue.Layout.add(this);qx.ui.core.FocusHandler.getInstance().connectTo(this);if((qx.core.Environment.get(h)==b)){this.setKeepFocus(true);}
;var window=qx.dom.Node.getWindow(y);qx.event.Registration.addListener(window,m,this._onWindowResize,this);}
,members:{__yz:false,__yA:false,__yy:null,__yB:function(){if(this.__yz||this.__yA){var B=qx.bom.element.Dimension.getSize(this.__yy);if(this.__yz&&B.width<1){throw new Error(l+this.__yy+a+this+s);}
;if(this.__yA){if(B.height<1){throw new Error(l+this.__yy+a+this+w);}
;if(B.height>=1&&qx.bom.element.Style.get(this.__yy,g,3)==x){qx.bom.element.Style.set(this.__yy,g,B.height+v);}
;}
;qx.event.Registration.addListener(this.__yy,m,this._onResize,this);}
;}
,_createContainerElement:function(){var C=this.__yy;if(this.__yz||this.__yA){var G=document.createElement(n);C.appendChild(G);if((qx.core.Environment.get(h)==b)&&qx.core.Environment.get(r)==6){var F=qx.dom.Node.getBodyElement(C);var E;var I;var H=false;var D=qx.dom.Hierarchy.getAncestors(C);for(var i=0,j=D.length;i<j;i++){E=D[i];if(E!=F){I=qx.bom.element.Style.get(E,u);if(I==d){H=true;break;}
;}
else {break;}
;}
...
,this,0);return J;}
,_onResize:function(e){var K=e.getData();if((K.oldWidth!==K.width)&&this.__yz||(K.oldHeight!==K.height)&&this.__yA){qx.ui.core.queue.Layout.add(this);}
;}
,_onWindowResize:function(){if(qx.ui.popup&&qx.ui.popup.Manager){qx.ui.popup.Manager.getInstance().hideAll();}
;if(qx.ui.menu&&qx.ui.menu.Manager){qx.ui.menu.Manager.getInstance().hideAll();}
;}
,_computeSizeHint:function(){var P=this.__yz;var M=this.__yA;if(!P||!M){var L=qx.ui.root.Abstract.prototype._computeSizeHint.call(this);}
else {L={};}
;var Q=qx.bom.element.Dimension;if(P){var O=Q.getContentWidth(this.__yy);L.width=O;L.minWidth=O;L.maxWidth=O;}
;if(M){var N=Q.getContentHeight(this.__yy);L.height=N;L.minHeight=N;L.maxHeight=N;}
;return L;}
},defer:function(R,S){qx.ui.core.MLayoutHandling.remap(S);}
,destruct:function(){qx.event.Registration.removeListener(this.__yy,m,this._onResize,this);this.__yy=null;}
});}
)();
