...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.progressive.ProgressiveTable","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.progressive.ProgressiveTable-qx.theme.Modern.1899cef76de3.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var f="Unrecognized key: ",e="qx.ui.progressive.renderer.table.Widths",d="minWidth",c="width",b="maxWidth",a="Column number out of range";qx.Class.define(e,{extend:qx.core.Object,construct:function(g){qx.core.Object.call(this);this.__Kd=[];for(var i=0;i<g;i++){this.__Kd[i]=new qx.ui.core.ColumnData();}
;}
,members:{__Kd:null,getData:function(){return this.__Kd;}
...
;}
,setWidth:function(l,m){if(l>this.__Kd.length-1||l<0){throw new Error(a);}
;this.__Kd[l].setColumnWidth(m);}
,setMinWidth:function(n,o){if(n>this.__Kd.length-1||n<0){throw new Error(a);}
;this.__Kd[n].setMinWidth(o);}
,setMaxWidth:function(p,q){if(p>this.__Kd.length-1||p<0){throw new Error(a);}
;this.__Kd[p].setMaxWidth(q);}
}});}
)();
...
,members:{__Bb:null,renderLayout:function(f,top,g,h){this.__Bb=g;}
,getComputedWidth:function(){return this.__Bb;}
...
,members:{__DH:null,join:function(c){this.__DH=c;}
...
(function(){var f="resize",d="progressive-table-header",c="_layout",b="qx.ui.progressive.headfoot.TableHeading",a="progressive-table-header-cell";qx.Class.define(b,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(g,h){qx.ui.progressive.headfoot.Abstract.call(this);this.__DE=g;var k=g.getData();this.__uW=[];for(var i=0;i<k.length;i++){var l=new qx.ui.basic.Atom(h[i]);l.setAppearance(a);this.add(l);this.__uW[i]=l;}
;var j=new qx.ui.core.Widget();j.set({height:16,appearance:a,minWidth:0,width:0});this.add(j,{flex:1});this.addListener(f,this._resizeColumns,this);this.__td=new qx.ui.layout.HBox();this.__td.connectToWidget(this);}
,properties:{appearance:{refine:true,init:d}},members:{__DE:null,__HM:null,__uW:null,__td:null,join:function(m){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,m);}
,getLayoutChildren:function(){if(this.__HM){return this.__DE.getData();}
else {return qx.ui.progressive.headfoot.Abstract.prototype.getLayoutChildren.call(this);}
;}
,_resizeColumns:function(e){var n=this.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();this.__HM=true;this.__td.renderLayout(n,100);this.__HM=false;var o=this.__DE.getData();for(var i=0;i<o.length;i++){this.__uW[i].setWidth(o[i].getComputedWidth());}
;}
},destruct:function(){this.__DE=this.__uW=null;this._disposeObjects(c);}
});}
)();
(function(){var n="progressive-progressbar-indicator-undone",m="__JD",l="progress",k="%",j="progressive-progressbar-indicator-done",i="__JE",h="progressive-progressbar-percent-text",g="renderStart",f="progressive-progressbar-background",d="0%",a="qx.ui.progressive.headfoot.Progress",c="progressive-progressbar-percent-background",b="renderEnd";qx.Class.define(a,{extend:qx.ui.progressive.headfoot.Abstract,construct:function(o,p){qx.ui.progressive.headfoot.Abstract.call(this);this.setHeight(16);this.setPadding(0);this.__DI={};var q=qx.theme.manager.Color.getInstance();this.__DI.background=q.resolve(f);this.__DI.indicatorDone=q.resolve(j);this.__DI.indicatorUndone=q.resolve(n);this.__DI.percentBackground=q.resolve(c);this.__DI.percentText=q.resolve(h);this.set({backgroundColor:this.__DI.background});this.__JD=new qx.ui.core.Widget();this.__JD.set({width:0,backgroundColor:this.__DI.indicatorDone});this.add(this.__JD);var r=new qx.ui.core.Widget();r.set({backgroundColor:this.__DI.indicatorUndone});this.add(r,{flex:1});this.__JE=new qx.ui.basic.Atom(d);this.__JE.set({width:100,backgroundColor:this.__DI.percentBackground,textColor:this.__DI.percentText});this.add(this.__JE);this.exclude();}
,members:{__JF:null,__DI:null,__JD:null,__JE:null,join:function(s){qx.ui.progressive.headfoot.Abstract.prototype.join.call(this,s);s.addListener(g,function(e){this.__JF=e.getData().initial;this.show();}
,this);s.addListener(l,function(e){var v=1.0-(e.getData().remaining/this.__JF);var w=this.getBounds();if(w){var t=Math.floor((w.width-this.__JE.getBounds().width)*v);var u=Math.floor(v*100)+k;if(!isNaN(t)){this.__JD.setMinWidth(t);this.__JE.setLabel(u);}
;}
;}
,this);s.addListener(b,function(e){this.exclude();}
,this);}
},destruct:function(){this.__DI=null;this._disposeObjects(m,i);}
});}
)();
(function(){var e="applyStructure() is abstract",d="abstract",c="qx.ui.progressive.structure.Abstract",b="overflowY",a="auto";qx.Class.define(c,{type:d,extend:qx.core.Object,construct:function(f){qx.core.Object.call(this);if(!f){this.__up=new qx.ui.core.Widget();this.__xk=this.__up;}
else {this.__up=null;this.__xk=f;}
;this.__xk.getContentElement().setStyle(b,a);}
,members:{__up:null,__xk:null,applyStructure:function(g){throw new Error(e);}
,getPane:function(){return this.__xk;}
},destruct:function(){if(this.__up){this.__up.dispose();}
;this.__up=this.__xk=null;}
});}
)();
(function(){var a="qx.ui.progressive.structure.Default";qx.Class.define(a,{extend:qx.ui.progressive.structure.Abstract,construct:function(b,c,d){qx.ui.progressive.structure.Abstract.call(this,d);if(!b){this.__Ho=new qx.ui.progressive.headfoot.Null();this.__pJ=this.__Ho;}
else {this.__Ho=null;this.__pJ=b;}
;if(!c){this.__Hp=new qx.ui.progressive.headfoot.Null();this.__Hq=this.__Hp;}
else {this.__Hp=null;this.__Hq=c;}
;}
,members:{__pJ:null,__Hq:null,__Ho:null,__Hp:null,applyStructure:function(e){this.__pJ.join(e);this.__Hq.join(e);e.add(this.__pJ);e.add(this.getPane(),{flex:1});e.add(this.__Hq);}
,getHeader:function(){return this.__pJ;}
,getFooter:function(){return this.__Hq;}
},destruct:function(){if(this.__Ho){this.__Ho.dispose();this.__Ho=null;}
;if(this.__Hp){this.__Hp.dispose();this.__Hp=null;}
;this.__pJ=this.__Hq=null;}
});}
)();
...
(function(){var l="_applyDataModel",k="Boolean",j="qx.ui.progressive.model.Abstract",h="white",g="No existing renderer named ",f="qx.ui.progressive.Progressive",d="dataAvailable",c="renderStart",b="Integer",a="qx.event.type.Data";qx.Class.define(f,{extend:qx.ui.container.Composite,construct:function(m){qx.ui.container.Composite.call(this,new qx.ui.layout.VBox());this.__uX={};this.set({backgroundColor:h});if(!m){m=new qx.ui.progressive.structure.Default();}
;this.__IO=m;m.applyStructure(this);this.__IP=false;this.__IQ=false;this.__IR=0;}
,events:{"renderStart":a,"renderEnd":a,"progress":a,"progressDetail":a},properties:{dataModel:{check:j,apply:l},batchSize:{check:b,init:20},flushWidgetQueueAfterBatch:{check:k,init:false},interElementTimeout:{check:b,init:0}},members:{__uX:null,__IQ:null,__IS:null,__IR:null,__IP:null,__IO:null,getStructure:function(){return this.__IO;}
,addRenderer:function(name,n){this.__uX[name]=n;n.join(this,name);}
,removeRenderer:function(name){if(!this.__uX[name]){throw new Error(g+name);}
;delete this.__uX[name];}
,render:function(){if(this.__IQ){return;}
;this.__IQ=true;var o=new qx.ui.progressive.State({progressive:this,model:this.getDataModel(),pane:this.__IO.getPane(),batchSize:this.getBatchSize(),rendererData:this.__IU(),userData:{}});this.__IS=new Date();if(this.__IP){this.__IR=o.getModel().getElementCount();this.fireDataEvent(c,{state:o,initial:this.__IR});this.__IT(o);}
else {qx.event.Timer.once(function(){this.__IR=o.getModel().getElementCount();this.fireDataEvent(c,{state:o,initial:this.__IR});this.__IT(o);this.__IP=true;}
,this,10);}
;}
,_applyDataModel:function(p,q){if(q){q.removeListener(d,this.__IV,this);q.dispose();}
;p.addListener(d,this.__IV,this);}
,__IT:function(r){var s;var u;var t;for(var i=r.getBatchSize();i>0;i--){s=r.getModel().getNextElement();if(!s){this.debug("Render time: "+(new Date()-this.__IS)+"ms");this.__IQ=false;this.fireDataEvent("renderEnd",r);r.dispose();return;}
;u=s.element;t=this.__uX[u.renderer];t.render(r,u);this.fireDataEvent("progressDetail",{initial:this.__IR,remaining:s.remaining,element:u});}
;this.fireDataEvent("progress",{initial:this.__IR,remaining:s.remaining});if(this.getFlushWidgetQueueAfterBatch()){qx.ui.core.queue.Manager.flush();}
;qx.event.Timer.once(function(){this.__IT(r);}
,this,this.getInterElementTimeout());}
,__IU:function(){var v={};for(var name in this.__uX){v[name]={};}
;return v;}
,__IV:function(e){this.__IR=e.getData();this.render();}
},destruct:function(){for(var name in this.__uX){this.__uX[name].dispose();}
;this.__IS=this.__uX=this.__IO=null;}
});}
)();
...
(function(){var b="qx.ui.progressive.model.Default",a="dataAvailable";qx.Class.define(b,{extend:qx.ui.progressive.model.Abstract,construct:function(){qx.ui.progressive.model.Abstract.call(this);this.__yC=[];}
,members:{__yC:null,addElements:function(c){this.__yC=this.__yC.concat(c);this.fireDataEvent(a,this.__yC.length);}
,addElement:function(d){this.__yC.push(d);this.fireDataEvent(a,this.__yC.length);}
,getElementCount:function(){return this.__yC.length;}
,getNextElement:function(){if(this.__yC.length>0){return ({element:this.__yC.shift(),remaining:this.__yC.length});}
;return null;}
...
(function(){var l="px",k="__DG",j="px ",h="padding: ",g="end",f="div",d="qx.tableResizeDebug",c="  width : 100%;",b=" {",a="__td",O="__columnData",N="Renderer is already joined to a Progressive.",M="css.boxmodel",L="col ",K="qx.debug",J="Invalid location: ",I="relative",H="-row {",G="resize",F="start",s="",t=": width=",q="content",r="qx.ui.progressive.renderer.table.Row",o="progressive-table-row-background-odd",p="progressive-table-row-background-even",m="left: ",n="No existing renderer for column ",u=")",v=" out of range (max: ",y="}",x="width: ",A="0px ",z="qx-progressive-",C="Column ",B="-row",w="-col-",E="px;",D=".qx-progressive-";qx.Class.define(r,{extend:qx.ui.progressive.renderer.Abstract,construct:function(P){qx.ui.progressive.renderer.Abstract.call(this);this.__DE=P;this.__DF={};this.__DG=new qx.ui.progressive.renderer.table.cell.Default();this.__DH=null;this.__DI={};var Q=qx.theme.manager.Color.getInstance();this.__DI.bgcol=[];this.__DI.bgcol[0]=Q.resolve(p);this.__DI.bgcol[1]=Q.resolve(o);this.__td=new qx.ui.layout.HBox();this.__td.connectToWidget(this);}
,statics:{__zo:null,__DJ:6,__DK:"  position: absolute;"+"  top: 0px;"+"  height: 100%;"+"  overflow:hidden;"+(qx.core.Environment.get("css.textoverflow")?qx.lang.String.hyphenate(qx.core.Environment.get("css.textoverflow"))+':ellipsis;':"")+"  white-space:nowrap;"+"  border-right:1px solid #f2f2f2;"+"  border-bottom:1px solid #eeeeee;"+"  padding : 0px 6px 0px 6px;"+"  cursor:default;"+"  font-size: 11px;"+"  font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;"+(qx.core.Environment.get("css.userselect")?qx.lang.String.hyphenate(qx.core.Environment.get("css.userselect"))+':'+qx.core.Environment.get("css.userselect.none")+';':'')},properties:{defaultRowHeight:{init:16}},members:{__DH:null,__mS:null,__DL:null,__DE:null,__DF:null,__DG:null,__DI:null,__td:null,join:function(R,name){if(this.__DH){throw new Error(N);}
;this.__DH=R;this.__mS=name;var T=qx.ui.progressive.renderer.table.Row;if(!T.__zo){T.__zo={};}
;var S=R.toHashCode();if(!T.__zo[S]){T.__zo[S]={rowstylesheet:null,cellstylesheet:[]};var U=D+S+H+c+y;T.__zo[S].rowstylesheet=qx.bom.Stylesheet.createElement(U);var V=this.__DE.getData();for(var i=0;i<V.length;i++){var U=D+S+w+i+b+T.__DK+y;T.__zo[S].cellstylesheet[i]=qx.bom.Stylesheet.createElement(U);}
;this.__DL=S;var W=R.getStructure().getPane();W.addListener(G,this._resizeColumns,this);}
;}
,addRenderer:function(X,Y){var ba=this.__DE.getData();if(X<0||X>=ba.length){throw new Error(C+X+v+(ba.length-1)+u);}
;this.__DF[X]=Y;}
,removeRenderer:function(bb){var bc=this.__DE.getData();if(bb<0||bb>=bc.length){throw new Error(C+bb+v+(bc.length-1)+u);}
;if(!this.__DF[bb]){throw new Error(n+bb);}
;delete this.__DF[bb];}
,render:function(bd,be){var bo=be.data;var bj=[];var bl;var bk;var bh=0;if(bd.getRendererData()[this.__mS].end===undefined){bd.getRendererData()[this.__mS]={end:0,start:1,rows:0,totalHeight:0};}
;var bn=document.createElement(f);for(var i=0;i<bo.length;i++){var bi=z+this.__DL+w+i;bk=this.__DF[i]||this.__DG;bl={state:bd,rowDiv:bn,stylesheet:bi,element:be,dataIndex:i,cellData:bo[i],height:bh};bj.push(bk.render(bl));if(bl.height>bh){bh=bl.height;}
;}
;bh=(bh>0?bh:this.getDefaultRowHeight());var bm=bd.getRendererData()[this.__mS];bm.totalHeight+=bh;bn.style.position=I;bn.style.height=bh+l;bn.className=z+this.__DL+B;bn.innerHTML=bj.join(s);switch(be.location){case g:var bf=bm.end||0;bn.style.backgroundColor=this.__DI.bgcol[bf];bm.end=(bf==0?1:0);bd.getPane().getContentElement().getDomElement().appendChild(bn);break;case F:var bg=bd.getPane().getContentElement().getDomElement();var bp=bg.childNodes;if(bp.length>0){var bf=bm.start;bn.style.backgroundColor=this.__DI.bgcol[bf];bm.start=(bf==0?1:0);bg.insertBefore(bn,bp[0]);break;}
else {bg.appendChild(bn);}
;break;default:throw new Error(J+be.location);};++bm.rows;}
,getLayoutChildren:function(){return this.__DE.getData();}
,_resizeColumns:function(e){var bx=this.__DH.getStructure().getPane();var bu=bx.getBounds().width-qx.bom.element.Overflow.getScrollbarWidth();var bv=D+this.__DL+B;var br=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(br.__zo[this.__DL].rowstylesheet,bv);var bt=x+bu+E;qx.bom.Stylesheet.addRule(br.__zo[this.__DL].rowstylesheet,bv,bt);this.__td.renderLayout(bu,100);var bw=this.__DE.getData();for(var i=0,bA=0;i<bw.length;i++,bA+=bu){var bv=D+this.__DL+w+i;var br=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(br.__zo[this.__DL].cellstylesheet[i],bv);bu=bw[i].getComputedWidth();if(qx.core.Environment.get(K)){if(qx.core.Environment.get(d)){this.debug(L+i+t+bu);}
;}
;var bs;if(qx.core.Environment.get(M)==q){bs=qx.ui.progressive.renderer.table.Row.__DJ*2;}
else {bs=-1;}
;var bz=(bu-bs)+E;var by=A+qx.ui.progressive.renderer.table.Row.__DJ+j+A+qx.ui.progressive.renderer.table.Row.__DJ+E;var bq=bA+E;var bt=br.__DK+x+bz+m+bq+h+by;qx.bom.Stylesheet.addRule(br.__zo[this.__DL].cellstylesheet[i],bv,bt);}
;}
},destruct:function(){var name;for(name in this.__DF){this.__DF[name]=null;}
;var bC=qx.ui.progressive.renderer.table.Row;var bB=this.__DH.toHashCode();if(bC.__zo&&bC.__zo[bB]){if(bC.__zo[bB].rowstylesheet){var bE=D+this.__DL+B;var bC=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bC.__zo[this.__DL].rowstylesheet,bE);}
;if(bC.__zo[bB].cellstylesheet){for(var i=bC.__zo[bB].cellstylesheet.length-1;i>=0;i--){var bE=D+this.__DL+w+i;var bD=bC.__zo[this.__DL].cellstylesheet[i];var bC=qx.ui.progressive.renderer.table.Row;qx.bom.Stylesheet.removeRule(bD,bE);}
;}
;}
;if(this.__DH&&this.__DH.getRendererData){var bF=this.__DH.getRendererData();if(bF&&bF[this.__mS]&&bF[this.__mS].end!==undefined){bF[this.__mS]=null;}
;}
;this.__DI=this.__DF=this.__DH=this.__DE=null;this._disposeObjects(a,k,O);}
});}
)();
