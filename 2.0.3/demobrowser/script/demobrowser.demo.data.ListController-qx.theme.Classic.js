...
var envinfo = {"locale":"en","locale.variant":"US","qx.allowUrlSettings":true,"qx.allowUrlVariants":true,"qx.application":"demobrowser.demo.data.ListController","qx.optimization.basecalls":true,"qx.optimization.privates":true,"qx.optimization.strings":true,"qx.optimization.variables":true,"qx.optimization.whitespace":true,"qx.theme":"qx.theme.Classic"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.data.ListController-qx.theme.Classic.3bf0e05f1c52.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="Remove an item",q="Write data to log",p="Add an item",o="",n="selection[0]",m="<b>Multi selection List</b><br/>",l="value",k="<b>Selection Label</b><br/>",j="white",h="<b>Selection List</b><br/>",c="main",g="demobrowser.demo.data.ListController",f="Bound to the same data and share the selection.",b="multi",a="Bound to the selection of the list to the left.",e="Item ",d="execute";qx.Class.define(g,{extend:qx.application.Standalone,members:{main:function(){qx.application.Standalone.prototype.main.call(this);var C=[];for(var i=0;i<10;i++){C.push(e+i);}
;var F=new qx.data.Array(C);var u=new qx.ui.form.List();u.setSelectionMode(b);var x=new qx.ui.form.List();x.setSelectionMode(b);var w=new qx.ui.form.List();this.getRoot().add(u,{left:10,top:110});this.getRoot().add(x,{left:130,top:110});this.getRoot().add(w,{left:250,top:110});var A=new qx.data.controller.List(F,u);var z=new qx.data.controller.List(F,x);var y=new qx.data.controller.List(A.getSelection(),w);z.setSelection(A.getSelection());var D=new qx.ui.basic.Label(o);this.getRoot().add(D,{left:370,top:110});y.bind(n,D,l);D.setWidth(120);D.setDecorator(c);D.setBackgroundColor(j);var G=new qx.ui.form.Button(p);G.setWidth(120);this.getRoot().add(G,{left:370,top:140});G.addListener(d,function(){F.push(e+F.length);}
,this);var v=new qx.ui.form.Button(r);v.setWidth(120);this.getRoot().add(v,{left:370,top:175});v.addListener(d,function(){F.pop();}
,this);var B=new qx.ui.form.Button(q);B.setWidth(120);this.getRoot().add(B,{left:370,top:210});B.addListener(d,function(){qx.log.appender.Console.show();this.info(F.toString());}
,this);var E=new qx.ui.basic.Label();E.setRich(true);E.setWidth(200);E.setValue(m+f);this.getRoot().add(E,{left:20,top:10});var s=new qx.ui.basic.Label();s.setRich(true);s.setWidth(100);s.setValue(h+a);this.getRoot().add(s,{left:260,top:10});var t=new qx.ui.basic.Label();t.setRich(true);t.setWidth(100);t.setValue(k+a);this.getRoot().add(t,{left:380,top:10});}
}});}
)();
