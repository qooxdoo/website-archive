...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.test.Table_CellEditor-qx.theme.Simple.a8527ba820bb.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
;this.__KA={};}
,properties:{cellEditorFactoryFunction:{check:d,nullable:true,init:null}},members:{__AF:null,__KA:null,createCellEditor:function(f){var g=this.getCellEditorFactoryFunction();if(qx.core.Environment.get(a)){this.assertFunction(g,b);}
;this.__AF=g(f);var h=this.__AF.createCellEditor(f);this.__KA[h.toHashCode()]=f;return h;}
...
;var j=this.__KA[i.toHashCode()];this.__AF=k(j);var l=this.__AF.getCellEditorValue(i);return l;}
