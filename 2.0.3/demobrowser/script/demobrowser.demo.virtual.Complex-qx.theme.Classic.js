...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.virtual.Complex-qx.theme.Classic.e5a44e505578.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var r="icon/",q="",p="folder.png",o="places/",n="demobrowser.demo.virtual.DemoLayer",m="network-server.png",l="mouseover",k="user-trash.png",i="changeValue",h="network-workgroup.png",c="qx.ui.basic.Atom",g="/",f="user-desktop.png",b=" / ",a="row",e="foobar!",d="column";qx.Class.define(n,{extend:qx.ui.virtual.layer.WidgetCell,construct:function(){qx.ui.virtual.layer.WidgetCell.call(this,this);this._pool={atom:[],checkbox:[]};this.__jd=[];}
,members:{_pool:null,__jd:null,getCellData:function(s,t){if(!this.__jd[s]){this.__jd[s]=[];}
;if(!this.__jd[s][t]){this.__jd[s][t]={label:this.__Qv(),icon:this.__Qw()};}
;return this.__jd[s][t];}
,getCellWidget:function(u,v){var w;if(v%2==0){w=this._pool.atom.pop();if(!w){w=new qx.ui.basic.Atom();w.addListener(l,function(){var x=this.__Qw();w.setIcon(x);this.__jd[u][v].icon=x;}
,this);}
...
;}
,__Qv:function(){var name=q;for(var j=0;j<10;j++){name+=String.fromCharCode(Math.floor(Math.random()*25)+65);}
;return name;}
,__Qw:function(){var z=r;var B=o;var C=[p,k,m,h,f];var A=Math.floor(Math.random()*4);return (z+16+g+B+C[A]);}
},destruct:function(){this._pool=this.__jd=null;}
});}
)();
...
(function(){var l="_applyInterval",k="appear",j="qx.debug",i="interval",h="qx.ui.virtual.behavior.Prefetch",g="_applyScroller",f="__lm",e="qx.ui.virtual.core.Scroller",d="Integer",c="scroll",a="scrollbar-x",b="scrollbar-y";qx.Class.define(h,{extend:qx.core.Object,construct:function(m,n){if(qx.core.Environment.get(j)){this.assertObject(n);this.assertPositiveInteger(n.minLeft);this.assertPositiveInteger(n.maxLeft);this.assertPositiveInteger(n.minRight);this.assertPositiveInteger(n.maxRight);this.assertPositiveInteger(n.minAbove);this.assertPositiveInteger(n.maxAbove);this.assertPositiveInteger(n.minBelow);this.assertPositiveInteger(n.maxBelow);}
;qx.core.Object.call(this);this.setPrefetchX(n.minLeft,n.maxLeft,n.minRight,n.maxRight);this.setPrefetchY(n.minAbove,n.maxAbove,n.minBelow,n.maxBelow);this.__lm=new qx.event.Timer(this.getInterval());this.__lm.addListener(i,this._onInterval,this);if(m){this.setScroller(m);}
;}
,properties:{scroller:{check:e,nullable:true,init:null,apply:g},interval:{check:d,init:200,apply:l}},members:{__Kw:null,__Kx:null,__lm:null,__Ky:null,__Kz:null,setPrefetchX:function(o,p,q,r){this.__Kw=[o,p,q,r];}
,setPrefetchY:function(s,t,u,v){this.__Kx=[s,t,u,v];}
,_onInterval:function(){var w=this.__Kw;if(w[1]&&w[3]){this.getScroller().getPane().prefetchX(w[0],w[1],w[2],w[3]);qx.ui.core.queue.Manager.flush();}
;var x=this.__Kx;if(x[1]&&x[3]){this.getScroller().getPane().prefetchY(x[0],x[1],x[2],x[3]);qx.ui.core.queue.Manager.flush();}
;}
,_applyScroller:function(y,z){if(z){if(this.__Ky){z.getChildControl(a).removeListenerById(this.__Ky);}
;if(this.__Kz){z.getChildControl(b).removeListenerById(this.__Kz);}
;}
;if(y){if(!y.getContainerElement().getDomElement()){this.__lm.stop();y.addListenerOnce(k,this.__lm.start,this.__lm);}
else {this.__lm.restart();}
;this.__Ky=y.getChildControl(a).addListener(c,this.__lm.restart,this.__lm);this.__Kz=y.getChildControl(b).addListener(c,this.__lm.restart,this.__lm);}
else {this.__lm.stop();}
;}
,_applyInterval:function(A,B){this.__lm.setInterval(A);}
},destruct:function(){this.setScroller(null);this.__Kw=this.__Kx=null;this._disposeObjects(f);}
});}
)();
