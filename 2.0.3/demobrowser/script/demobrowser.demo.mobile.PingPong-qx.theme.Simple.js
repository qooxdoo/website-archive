...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:demobrowser.demo.mobile.PingPong-qx.theme.Simple.21b510ebf2cc.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){var v="demobrowser.demo.mobile.PingPong",u="<b>This demo is supposed to be run in a WebKit-based browser.</b>",t="engine.name",s="black",r="20px",q="none",p="30px",o="qx.debug",n="0px",m="webkit",f="12px",l="innerHTML",i="green",c='Lucida Grande',b="px",h="absolute",g="touchmove",j="div",a="left",k="right",d="100%";qx.Class.define(v,{extend:qx.application.Native,members:{__Pr:null,__Ps:null,__Pt:null,__Pu:null,__Pv:5,__Pw:1,__Px:1,__Py:null,__Pz:null,__PA:null,main:function(){qx.application.Native.prototype.main.call(this);if(qx.core.Environment.get(o)){qx.log.appender.Native;qx.log.appender.Console;}
;var A={"width":d,"height":d,"backgroundColor":s,"margin":n,"userSelect":q};var D=new qx.html.Element(j,A);D.useElement(document.body);D.setRoot(true);if(qx.core.Environment.get(t)!=m){var C={"color":i,"font-family":c,"font-size":f,"position":h,"left":p,"top":r};var B=new qx.html.Element(j,C);D.add(B);B.setAttribute(l,u);return;}
;var w=this.__PE(a);D.add(w);var z=this.__PE(k);D.add(z);this.__Ps=this.__PF(a);w.add(this.__Ps);w.addListener(g,qx.lang.Function.bind(this.__se,this,this.__Ps),this);this.__Pr=this.__PF(k);z.add(this.__Pr);z.addListener(g,qx.lang.Function.bind(this.__se,this,this.__Pr),this);this.__Pt=this.__PG();D.add(this.__Pt);this.__Pz=this.__PH();w.add(this.__Pz);this.__PA=this.__PH();z.add(this.__PA);this.__Py=[0,0];this.__PB();}
,__PB:function(){this.__Pt.setStyles({"left":"200px","top":"200px"});this.__Pu=new qx.event.Timer(40);this.__Pu.addListener("interval",function(){var x=(parseInt(this.__Pt.getStyle("left"))+this.__Pv*this.__Pw);var y=(parseInt(this.__Pt.getStyle("top"))+this.__Pv*this.__Px);this.__Pt.setStyle("left",x+"px");this.__Pt.setStyle("top",y+"px");this.__PD();}
,this);this.__Pu.start();}
,__PC:function(E){this.__Pu.stop();this.__Pu.dispose();this.__Pv=5;this.__Py[E]=this.__Py[E]+1;this.__Pz.setAttribute("innerHTML",this.__Py[0]);this.__PA.setAttribute("innerHTML",this.__Py[1]);this.__PB();}
,__PD:function(){var G=this.getBoundsFor(this.__Pt);if(G.top<=0){this.__Px=1;}
;if(G.bottom>=window.innerHeight-5){this.__Px=-1;}
;if(G.left<=0||G.right>=window.innerWidth){this.__PC(G.left<=0?1:0);}
;var H=this.getBoundsFor(this.__Ps);if(G.left<=H.right&&G.bottom>=H.top&&G.top<=H.bottom){this.__Pw=1;this.__Pv=Math.min(this.__Pv+1,20);}
;var F=this.getBoundsFor(this.__Pr);if(G.right>=F.left&&G.bottom>=F.top&&G.top<=F.bottom){this.__Pw=-1;this.__Pv=Math.min(this.__Pv+1,20);}
;}
,__se:function(I,e){I.setStyles({"top":(e.getDocumentTop()-50)+b});}
,getBoundsFor:function(J){return qx.bom.element.Location.get(J.getDomElement());}
,__PE:function(K){var L={"width":"50%","height":"100%","position":"absolute","backgroundColor":"black"};if(K=="left"){L["border-right"]="1px solid white";}
else {L["left"]="50%";L["border-left"]="1px solid white";}
;return new qx.html.Element("div",L);}
,__PF:function(M){var N={"width":"30px","height":"100px","top":"100px","position":"absolute","backgroundColor":"white"};N[M]="20px";return new qx.html.Element("div",N);}
,__PG:function(){var O={"width":"20px","height":"20px","position":"absolute","backgroundColor":"white","userSelect":"none"};return new qx.html.Element("div",O);}
,__PH:function(){var P={"width":"100%","height":"100%","textAlign":"center","fontSize":"15em","color":"#333","fontFamily":"Arial"};var Q=new qx.html.Element("div",P);Q.setAttribute("innerHTML","0");return Q;}
}});}
)();
